...
void fillpattern(uint param_1,undefined1 *param_2,ulong param_3)
...
LAB_001000a0:
    ...
    if (uVar3 < param_3) goto LAB_001000a0;
  }
  if ((param_1 & 0x1000) == 0) {
    return;
  }
...
LAB_00100222:
        *__dest = *__src;
        uVar7 = uVar7 - 1;
        __dest = __dest + 1;
        if (uVar7 == 0) goto LAB_00100185;
      }
      else {
        uVar4 = uVar4 - 1;
        uVar6 = randint_genmax(param_3,uVar4);
        if (uVar6 < uVar7) goto LAB_00100222;
      }
      __src = __src + 1;
    } while( true );
  }
...
LAB_00100482:
    ...
    cVar13 = (char)(uVar5 >> 4);
    if (((char)(uVar5 >> 8) == cVar13) && (cVar13 == (char)uVar5)) goto LAB_00100482;
    uVar16 = 0xf000;
    uVar14 = 0xf000;
  }
  ...
  if ((*(uint *)(param_1 + 0x18) & 0xf000) == 0x2000) {
    ...
    if (iVar4 == 0) goto joined_r0x00100abd;
  }
  _Var6 = lseek(1,0,0);
  if (_Var6 < 1) {
    if (_Var6 == 0) {
        ...
        if ((long)local_858 < 0) {
          ...
          do {
            ...
            if (sVar10 < 1) {
              ...
              if (0x7fffffffffffffff - local_860 < uVar9) goto LAB_0010086f;
...
LAB_00100578:
          do {
            ...
            if (sVar10 < 1) {
              ...
              if ((iVar4 != 5) || (uVar16 <= (uVar9 | 0x1ff))) goto LAB_00100b62;
              uVar9 = (uVar9 | 0x1ff) + 1;
...
LAB_0010060e:
      ...
      if (local_860 == local_858) {
        ...
        goto joined_r0x00100538;
        __s2 = (char *)human_readable(local_860,local_568,0x1b2,1,1);
        if (-1 < (long)local_858) goto LAB_0010066d;
LAB_001008ec:
        ...
        if (local_838 < local_840) goto joined_r0x00100538;
        __s2 = (char *)human_readable(local_860,local_568,0x1b2,1,1);
        iVar4 = strcmp(local_848,__s2);
        if (iVar4 == 0) goto joined_r0x00100538;
        if ((long)local_858 < 0) goto LAB_001008ec;
LAB_0010066d:
        uVar15 = 100;
        if (local_858 != 0) {
...
LAB_00100d43:
    ...
    cVar10 = (char)(uVar3 >> 4);
    if (((char)(uVar3 >> 8) == cVar10) && (cVar10 == (char)uVar3)) goto LAB_00100d43;
    uVar12 = 0xf000;
    uVar15 = 0xf000;
  }
...
LAB_00100d5a:
      ...
      local_828 = 0;
joined_r0x00100df8:
      if ((long)local_860 < 0) goto LAB_00101098;
      ...
      if ((uVar15 <= uVar17) || (((long)uVar12 <= (long)local_860 && (uVar1 = uVar17, uVar17 != 0)))
        ...
        do {
          while (sVar7 = write(param_1,__ptr + uVar17,uVar1 - uVar17), 0 < sVar7) {
            uVar17 = uVar17 + sVar7;
LAB_00100e3b:
            if (uVar1 <= uVar17) goto LAB_00100ec1;
          }
          ...
          if (!bVar16) {
            ...
            if ((iVar2 != 5) || (uVar1 <= (uVar17 | 0x1ff))) goto LAB_00101493;
...
LAB_00101098:
  ...
  do {
    ...
    if (sVar7 < 1) {
      ...
      if (0x7fffffffffffffff - uVar12 < uVar17) goto LAB_0010124d;
      uVar12 = uVar17 + uVar12;
      *param_4 = uVar12;
      local_860 = uVar12;
      if (param_8 == 0) goto joined_r0x00100df8;
      goto LAB_0010119c;
    }
    uVar17 = uVar17 + sVar7;
joined_r0x0010112c:
...
LAB_0010119c:
        ...
        goto joined_r0x00100df8;
        __s2 = (char *)human_readable(uVar12,local_568,0x1b2,1,1);
      }
      else {
        local_828 = rpl_time(0);
        if (local_828 < local_830) goto joined_r0x00100df8;
        __s2 = (char *)human_readable(uVar12,local_568,0x1b2,1,1);
        iVar2 = strcmp(local_838,__s2);
        if (iVar2 == 0) goto joined_r0x00100df8;
      }
      if ((long)local_860 < 0) {
...

{
  ...
  if (pcVar4 == (char *)0x0) {
    ...
    if (pcVar6 != (char *)0x0) goto LAB_0010182d;
  ...
  do {
    ...
    if (iVar5 == -1) {
      ...
      if (param_1 != 0) {
        ...
        if (randint_source == 0) {
          randint_source = 0;
          if (local_178 == (char *)0x0) goto LAB_00103556;
          do {
...
LAB_00102acc:
      ...
      error(0,0,uVar12);
switchD_00102613_caseD_67:
      usage(1);
LAB_0010329c:
      uVar6 = (uint)param_2;
      iVar5 = ftruncate(uVar6,0);
      if (iVar5 == 0) goto LAB_00103043;
      if ((local_d8.st_mode & 0xf000) != 0x8000) goto LAB_00103043;
...
LAB_00102aa0:
        ...
        while( true ) {
          ...
          if (local_128 == local_150) goto LAB_00102acc;
LAB_00102860:
...
LAB_0010296e:
              ...
              local_158 = local_148;
              if ((local_d8.st_mode & 0xf000) != 0x8000) goto LAB_0010296e;
              ...
              if (lVar10 <= local_d8.st_size) goto LAB_0010296e;
LAB_00102e4e:
              genpattern(pvVar9,pcVar23,lVar20);
              local_170 = randint_get_source(lVar20);
              if (_Var15 != 0) {
...
LAB_00102bea:
            ...
            local_140 = local_148;
            if ((local_d8.st_mode & 0xf000) != 0x8000) goto LAB_00102bea;
            lVar10 = local_d8.st_blksize;
            if (0x1fffffffffffffff < local_d8.st_blksize - 1U) {
              lVar10 = 0x200;
            }
            ...
            if (lVar10 <= local_d8.st_size) goto LAB_00102bea;
LAB_00102ecd:
            genpattern(local_160,pcVar23,lVar20);
            local_168 = randint_get_source(lVar20);
            if (_Var15 != 0) {
...
LAB_00102c37:
            ...
            if (local_178 != (char *)0x0) {
              ...
              do {
                ...
                if (iVar5 != 0) {
                  if (iVar5 < 0) goto LAB_00102cae;
                  local_158._0_1_ = false;
                }
              } while (local_178 != pcVar16);
            }
          }
          if (local_120 != 0) goto LAB_0010329c;
LAB_00103043:
          free(local_160);
          iVar5 = close(uVar6);
          if (iVar5 != 0) goto LAB_00102cc7;
          if ((byte)local_158 == 0) goto LAB_00102a92;
          if (local_120 != 0) {
              ...
              if (__n != 0) {
                ...
                do {
                  ...
                  while (iVar8 = renameatu(0xffffff9c,local_138,0xffffff9c,pvVar9), iVar8 != 0) {
                    piVar13 = __errno_location();
                    if (*piVar13 != 0x11) goto LAB_001031fa;
...
LAB_001033ef:
              ...
              if (local_120 != 1) goto LAB_001030e1;
            }
    ...
    if (0x80 < iVar5) goto switchD_00102613_caseD_67;
    if (iVar5 < 0x66) {
      if (iVar5 == -0x83) {
      ...
      goto switchD_00102613_caseD_67;
    }
    switch(iVar5) {
    case 0x66:
      bVar2 = true;

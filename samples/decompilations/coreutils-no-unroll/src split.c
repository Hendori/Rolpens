...
LAB_00101365:
    ...
    if ((lVar8 < 1) || (sVar1 < lVar8)) {
      if (sVar1 == 0) break;
      if (bVar9 != 0 || bVar7 != false) goto LAB_001012f0;
      bVar9 = 0;
      bVar6 = 1;
      bVar7 = false;
LAB_0010130f:
...

{
  ...
  if (pcVar4 == (char *)0x0) {
    ...
    if (pcVar6 != (char *)0x0) goto LAB_0010169d;
...
LAB_00102a70:
  ...
  if (iVar7 != -1) {
    if (0x83 < iVar7) {
switchD_00102ace_caseD_a:
      usage(1);
      goto switchD_00103177_caseD_4;
    }
    if (iVar7 < 0x30) {
      if (iVar7 == -0x83) {
      ...
      if (iVar7 != -0x82) goto switchD_00102ace_caseD_a;
      usage(0);
...
LAB_0010440c:
    ...
    case 0x44:
      ...
      if (*_optarg == 0) {
        ...
        if (_optarg[1] != 0) {
          ...
          if (iVar10 != 0) goto LAB_0010440c;
          iVar10 = 0;
        }
        pbVar30 = additional_suffix;
        if ((eolchar < 0) || (eolchar == iVar10)) goto LAB_00102a70;
    ...
    case 0x52:
      ...
      goto LAB_00102a70;
    case 0x53:
      goto switchD_00102ace_caseD_53;
    }
...
LAB_00104293:
  ...
  if (iVar10 != 0) goto LAB_001040b5;
  if (local_90 == 0) {
    uVar25 = 0x40000;
    if (((DAT_00101858 - 1U < 0x2000000000000000) &&
        (auVar3._8_8_ = 0, auVar3._0_8_ = SUB168(SEXT816(0x3ffff),8),
        uVar25 = (0x3ffff - SUB168((auVar3 << 0x40 | ZEXT816(0x3ffff)) % SEXT816(DAT_00101858),0)) +
                 DAT_00101858, (DAT_00101838 & 0xf000) == 0x8000)) && ((uVar25 - 1 & uVar25) != 0))
    {
      lVar32 = 0x3f;
      if (uVar25 != 0) {
...
LAB_001033b0:
    ...
    do {
      ...
      if ((long)sVar14 < 0) goto LAB_001040b5;
      puVar23 = local_88;
      if (sVar14 == 0) {
        if (lVar16 != 0) {
...
LAB_001040b5:
      ...
      do {
        ...
        if ((long)sVar14 < (long)sVar20) {
          ...
          if (lVar16 != 0) goto LAB_0010375f;
LAB_001037f3:
          if (pvVar18 == (void *)0x0) goto LAB_00103cb0;
LAB_001037fc:
          bVar35 = lVar32 == 0;
...
LAB_00103c6c:
            ...
            lVar16 = 0;
LAB_0010383c:
            if (puVar24 == (undefined1 *)0x0) goto LAB_00103c6c;
            if (sVar20 == 0) goto LAB_00103c63;
...
LAB_00103857:
          ...
          if (lVar16 == 0) goto LAB_001037f3;
LAB_0010375f:
          bVar34 = lVar32 == 0;
          if ((pvVar18 != (void *)0x0) || (bVar34)) {
            lVar32 = lVar32 + lVar16;
            cwrite(bVar34,pvVar19,lVar16);
            if (pvVar18 != (void *)0x0) goto LAB_001037fc;
LAB_00103cb0:
            lVar16 = 0;
          }
          puVar29 = puVar23;
          if (bVar35) goto LAB_0010383c;
          bVar34 = lVar32 == 0;
          if (puVar24 == (undefined1 *)0x0) {
  ...
  do {
    ...
    if (lVar32 < 1) {
      if (lVar32 == 0) goto LAB_00103e65;
      goto LAB_0010327d;
    }
    uVar31 = uVar31 + lVar32;
  } while ((long)uVar31 < (long)local_90);
  if (((DAT_00101838 & 0xd000) == 0x8000) && (DAT_00101850 < (long)uVar31)) {
LAB_00103d74:
    _Var21 = 0;
    ...
    if (cVar6 != '\0') {
      do {
        ...
        if (sVar14 != sVar20) goto LAB_00104162;
...
LAB_00104162:
    ...
    if ((lVar32 < (long)uVar25) || (_Var21 = lseek(0,0,2), _Var21 < 0)) goto LAB_00103d74;
LAB_00103e2c:
...
LAB_00103fb2:
  if ((long)(ulong)uVar9 <= (long)uVar25) goto LAB_001034a0;
  if (in_R11 < 0) {
    lVar32 = __read_chk(0,local_88,local_90,local_80);
    if (lVar32 < 0) goto LAB_001040b5;
    if (lVar32 == 0) goto LAB_001034a0;
  }
  else {
    lVar32 = in_R11;
    in_R11 = -1;

      ...
      do {
        *piVar9 = 0;
        ...
        if (*piVar9 == 0x22) {
          ...
          if ((char)uVar5 == '\0') goto LAB_00100876;
...
LAB_00100876:
          ...
          if (((char *)*puVar10 == local_38) || (dVar11 < 0.0)) goto LAB_001008d8;
LAB_001007c5:
          cVar1 = *local_38;
          if (cVar1 != '\0') {
            if (local_38[1] != '\0') goto LAB_001008d8;
            if (cVar1 == 'h') {
              dVar11 = dVar11 * __LC32;
            }
            else if (cVar1 < 'i') {
              if (cVar1 != 'd') goto LAB_001008d8;
              dVar11 = dVar11 * __LC33;
            }
            else if (cVar1 == 'm') {
              dVar11 = dVar11 * __LC31;
            }
            else if (cVar1 != 's') goto LAB_001008d8;
          }

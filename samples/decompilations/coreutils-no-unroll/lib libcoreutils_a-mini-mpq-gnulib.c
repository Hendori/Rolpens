...

{
  ...
  if ((lVar3 == 1) || (lVar3 + 0x40U < uVar2)) {
    ...
    dVar4 = (double)mpz_get_d(local_48);
    mpz_clear(local_48);
  }
  else {
    lVar3 = ((lVar3 + 0x40U) - uVar2 >> 6) + 1;
    mpz_init(local_48);
    mpz_mul_2exp(local_48,param_1,lVar3 * 0x40);
    mpz_tdiv_q(local_48,local_48,lVar1);
    dVar4 = (double)mpz_get_d(local_48);
    mpz_clear(local_48);
    do {
  ...
  if (__s != (char *)0x0) {
    ...
    if (iVar1 != 0) {
      ...
      if (param_1 == 0) {
        ...
        if (__s_00 == (char *)0x0) goto LAB_00100fd0;
...
LAB_00101140:
    ...
    if (iVar2 != 0) {
      ...
      (*local_48)(__s_00,sVar4);
      __s[sVar3] = '/';
      if (__s == (char *)0x0) goto LAB_00101140;
    }
    sVar4 = strlen(__s);

  ...
  while( true ) {
    ...
    if (iVar4 < 0x62) {
      if (iVar4 == -0x83) {
        ...
        version_etc(_stdout,"sha512sum","GNU coreutils",_Version,uVar7,uVar6,uVar14,0);
                    /* WARNING: Subroutine does not return */
        exit(0);
      }
      if (iVar4 == -0x82) {
...
LAB_0010179f:
                ...
                if (local_b3 != 0) goto LAB_00101834;
              }
              ...
              print_filename(__stream,local_b8);
            }
            else {
...
LAB_00101834:
            ...
            do {
              ...
              pFVar29 = pFVar15;
              if (local_110 <= pFVar15) goto LAB_001018b2;
              __stream = *(char **)pFVar15;
              puVar27 = (uint *)((ulong)pFVar12 & 0xffffffff);
LAB_0010175c:
              pFVar12 = (FILE *)digest_file_isra_0(__stream,param_2,local_118);
...
joined_r0x0010188b:
    ...
    if (local_b3 == 0) goto LAB_00101871;
  }
LAB_00101891:
...
LAB_0010201e:
      bVar24 = (byte)pFVar23;
      if ((ignore_missing != '\0') && (local_99 != '\0')) goto LAB_00101ca2;
      if (digest_hex_bytes == local_d8) {
        uVar25 = (ulong)local_d8 >> 1;
        if (uVar25 != 0) {
          uVar18 = 0;
          do {
            ...
            if ((int)(char)bin2hex_0[*(byte *)(local_f0 + uVar18) >> 4] != uVar5) {
LAB_00102168:
            ...
            if ((int)(char)bin2hex_0[*(byte *)(local_f0 + uVar18) & 0xf] != uVar5)
            goto LAB_00102168;
            uVar18 = uVar18 + 1;
          } while (uVar25 != uVar18);
        }
        local_b2 = status_only;
        if ((status_only != 0) || (local_b2 = quiet, quiet != 0)) goto LAB_00101ca2;
        local_b2 = bVar24;
        if ((int)pFVar29 != 0) goto LAB_001021a5;
        local_108 = (FILE *)((ulong)pFVar23 & 0xff);
...
LAB_00101d43:
              if (local_e0 == (FILE *)0x0 && local_e8 == (FILE *)0x0) {
                bVar24 = strict ^ 1 | local_c8 == (FILE *)0x0;
                goto LAB_00101d67;
              }
            }
            else {
LAB_00101d8d:
              if (local_b2 != 0) goto LAB_00101d43;
            }
            bVar24 = 0;
          }
LAB_00101d67:
...
LAB_0010243f:
        ...
        while( true ) {
          ...
          local_f8 = *(FILE **)pFVar15;
LAB_0010190c:
          local_f0 = local_c0 & 0xfffffffffffffff8;
          local_b8 = strcmp((char *)local_f8,"-");
          if (local_b8 == 0) break;
        ...
        while (pFVar17 = (FILE *)__stream,
          ...
          *(undefined1 *)((long)local_98 + (long)pFVar29) = 0;
          ...
          if ((cVar3 == '\t') || (cVar3 == ' ')) {
            ...
            do {
              do {
                ...
                cVar3 = *(char *)((long)&((FILE *)puVar27)->_flags + (long)&local_98->_flags);
              } while (cVar3 == ' ');
            } while (cVar3 == '\t');
            pFVar15 = (FILE *)((long)&((FILE *)puVar27)->_flags + (long)&local_98->_flags);
          }
          else {
            puVar27 = (uint *)0x0;
            pFVar15 = local_98;
          ...
          if (cVar3 == '\\') {
            puVar27 = (uint *)((long)&((FILE *)puVar27)->_flags + 1);
            pFVar15 = (FILE *)((long)&((FILE *)puVar27)->_flags + (long)&local_98->_flags);
            local_108 = (FILE *)(ulong)local_b3;
          }
          iVar4 = strncmp((char *)pFVar15,"SHA512",6);
            ...
            if (pFVar29 != (FILE *)0x0) {
              ...
              if ((*pcVar26 == ')') &&
                 ((bVar30 = (byte)local_108 == '\0', bVar30 ||
                  (lVar9 = filename_unescape(pFVar17,pcVar21), local_108 = pFVar17, lVar9 != 0)))) {
                *pcVar26 = '\0';
...
LAB_00101aa8:
          if (warn != '\0') {
            pFVar15 = (FILE *)quotearg_n_style_colon(0,3,local_f8);
...
LAB_00101acf:
          ...
          pFVar16 = (FILE *)puVar20;
          if (pFVar12 == (FILE *)0x0) {
            pFVar12 = (FILE *)quotearg_n_style_colon(0,3,local_f8);
...
LAB_0010223c:
                    ...
                    if (((local_b8 != 0) || ((char)pFVar17->_flags != '-')) ||
                      ...
                      uVar5 = digest_file_isra_0(pFVar17,local_f0,&local_99);

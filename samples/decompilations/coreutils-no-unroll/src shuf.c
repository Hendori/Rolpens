...

{
  ...
  puVar18 = &switchD_00100b93::switchdataD_00101758;
...
LAB_001016dd:
    ...
    case 0x6f:
      if ((local_148 != (byte *)0x0) &&
         (iVar1 = strcmp((char *)local_148,(char *)_optarg), iVar1 != 0)) goto LAB_001016dd;
      local_148 = pbVar8;
      break;
    case 0x7a:
      local_119 = 0;
...
LAB_00101644:
      ...
      if (((local_138 != (uint *)0x7fffffffffffffff) && (local_11a == 0)) &&
        ...
        if (local_138 != (uint *)0xffffffffffffffff) goto LAB_00101696;
...
LAB_00100fa6:
    ...
    if (puVar14 == (uint *)0x0) goto LAB_00101708;
      ...
      do {
        if (local_11a != 0) {
          if (local_148 != (byte *)0x0) {
            ...
            pbVar8 = local_148;
            if (lVar10 == 0) goto LAB_0010166a;
          }
          if (bVar23 != false) goto LAB_00101092;
          pcVar19 = "no lines to repeat";
          if (local_128 == (uint *)0x0) goto LAB_001016c5;
          if ((byte)local_150 != '\0') {
            pcVar19 = (char *)0x0;
            goto LAB_00101381;
          }
...
LAB_00101133:
        ...
        for (puVar22 = (undefined1 *)0x0; local_118 = puVar18, local_110 = puVar14,
            puVar5 != (uint *)puVar22; puVar22 = (undefined1 *)((long)puVar22 + 1)) {
...
LAB_00100bcb:
  ...
  goto LAB_00100b50;
LAB_001015f4:
  if (puVar7 == puVar5) goto LAB_00101092;
  ...
  goto LAB_001015f4;
LAB_00101381:
  if ((uint *)pcVar19 == puVar5) goto LAB_00101092;
...
LAB_00101586:
  ...
  goto LAB_00101586;
LAB_0010128f:
  if ((uint *)puVar22 == puVar5) goto LAB_00101092;
LAB_0010125b:

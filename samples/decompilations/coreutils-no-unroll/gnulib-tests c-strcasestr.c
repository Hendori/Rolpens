...
LAB_001004da:
    ...
    do {
      ...
      lVar9 = uVar14 - (long)pbVar7;
      pbVar7 = pbVar7 + 1;
      local_848[(int)uVar2] = (ulong)(param_3 + lVar9);
    } while (pbVar7 != param_3 + param_4);
    iVar3 = c_strncasecmp(param_3,param_3 + local_850,local_880);
    if (iVar3 == 0) {
      lVar9 = 0;
      uVar12 = 0;
LAB_001002f4:
      do {
        lVar10 = lVar9 + param_4;
        pvVar5 = memchr((void *)(param_2 + param_1),0,lVar10 - param_2);
        if ((pvVar5 != (void *)0x0) || (lVar10 == 0)) goto LAB_001004d8;
        bVar1 = *(byte *)(param_1 + -1 + lVar10);
        uVar2 = (uint)bVar1;
        if (bVar1 - 0x41 < 0x1a) {
          uVar2 = bVar1 + 0x20;
        }
        uVar11 = local_848[(int)uVar2];
        param_2 = lVar10;
        if (uVar11 == 0) {
          uVar11 = local_880;
          if (local_880 <= uVar12) {
          ...
          if (uVar11 < uVar14) {
            do {
              bVar1 = param_3[uVar11];
              uVar2 = (uint)bVar1;
              if (bVar1 - 0x41 < 0x1a) {
                uVar2 = bVar1 + 0x20;
              }
              bVar1 = *(byte *)(param_1 + lVar9 + uVar11);
              uVar8 = (uint)bVar1;
              if (bVar1 - 0x41 < 0x1a) {
                uVar8 = bVar1 + 0x20;
              }
              if (uVar8 != uVar2) {
                if (uVar11 < uVar14) {
                  uVar12 = 0;
                  lVar9 = (1 - local_880) + lVar9 + uVar11;
                  goto LAB_001002f4;
                }
                break;
              }
          ...
          if (uVar12 < local_880) {
            do {
              ...
              bVar1 = *(byte *)(param_1 + lVar9 + uVar13);
              uVar8 = (uint)bVar1;
              if (bVar1 - 0x41 < 0x1a) {
                uVar8 = bVar1 + 0x20;
              }
            } while ((uVar8 == uVar2) && (uVar11 = uVar13, uVar12 != uVar13));
          }
          if (uVar11 < uVar12 + 1) {
            lVar9 = param_1 + lVar9;
            goto LAB_001004da;
          ...
          lVar9 = lVar9 + uVar6;
          uVar12 = param_4 - uVar6;
        }
        else {
          if ((uVar11 < uVar6) && (uVar12 != 0)) {
            uVar11 = param_4 - uVar6;
          }
          lVar9 = lVar9 + uVar11;
          uVar12 = 0;
        }
...
LAB_00100426:
  do {
    lVar9 = lVar10 + param_4;
    pvVar5 = memchr((void *)(param_2 + param_1),0,lVar9 - param_2);
    if ((pvVar5 != (void *)0x0) || (lVar9 == 0)) goto LAB_001004d8;
    bVar1 = *(byte *)(param_1 + -1 + lVar9);
    uVar2 = (uint)bVar1;
    if (bVar1 - 0x41 < 0x1a) {
      uVar2 = bVar1 + 0x20;
    }
    ...
    if (local_848[(int)uVar2] == 0) {
      ...
      for (uVar12 = local_880; uVar11 = local_880, uVar12 < uVar14; uVar12 = uVar12 + 1) {
        bVar1 = param_3[uVar12];
        uVar2 = (uint)bVar1;
        if (bVar1 - 0x41 < 0x1a) {
          uVar2 = bVar1 + 0x20;
        }
        bVar1 = *(byte *)(lVar9 + uVar12);
        uVar8 = (uint)bVar1;
        if (bVar1 - 0x41 < 0x1a) {
          uVar8 = bVar1 + 0x20;
        }

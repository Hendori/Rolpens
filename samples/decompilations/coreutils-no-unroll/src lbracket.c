...

{
  ...
  lVar12 = argv;
  lVar6 = (long)pos;
  pcVar9 = *(char **)(argv + (lVar6 + 1) * 8);
  lVar1 = (lVar6 + 1) * 8;
  pcVar11 = pcVar9;
  cVar3 = binop();
  __status = (int)pcVar11;
  if (cVar3 != '\0') {
    uVar7 = binary_operator(0);
    return uVar7;
  }
  pcVar11 = *(char **)(lVar12 + -8 + lVar1);
  if ((*pcVar11 == '!') && (pcVar11[1] == '\0')) {
    pos = iVar5 + 1;
    if (pos < argc) {
      if ((*pcVar9 == '!') && (pcVar9[1] == '\0')) {
        pcVar9 = *(char **)(lVar12 + 8 + lVar1);
        pos = iVar5 + 3;
        uVar4 = (uint)CONCAT71((int7)((ulong)pcVar9 >> 8),*pcVar9 == '\0');
      }
      else {
        if ((*pcVar9 != '-') || ((pcVar9[1] == '\0' || (pcVar9[2] != '\0')))) goto LAB_0010182b;
    ...
    if ((((*pcVar11 == '(') && (pcVar11[1] == '\0')) &&
        (pcVar11 = *(char **)(lVar12 + 8 + lVar1), *pcVar11 == ')')) && (pcVar11[1] == '\0')) {
      pos = iVar5 + 3;
      return CONCAT71((int7)((ulong)pcVar11 >> 8),*pcVar9 != '\0');
    }
    if ((((*pcVar9 != '-') ||
         (((pcVar9[1] != 'a' || (pcVar9[2] != '\0')) && ((pcVar9[1] != 'o' || (pcVar9[2] != '\0'))))
         )) && ((*pcVar9 != '>' || (pcVar9[1] != '\0')))) &&
       ((*pcVar9 != '<' || (pcVar9[1] != '\0')))) {
      uVar10 = quote(pcVar9);
      uVar8 = dcgettext(0,"%s: binary operator expected",5);
                    /* WARNING: Subroutine does not return */
      test_syntax_error(uVar8,uVar10);
    }
    if (iVar5 < argc) {
      uVar7 = or();
      return uVar7;
...
LAB_0010182b:
  ...
  if (__status == 0) {
    ...
    pFVar2 = _stdout;
    pcVar9 = (char *)dcgettext(0,"Exit with the status determined by EXPRESSION.\n\n",5);
    fputs_unlocked(pcVar9,pFVar2);
    pFVar2 = _stdout;
    ...
    __printf_chk(2,uVar10,"https://www.gnu.org/software/coreutils/",&_LC49);
    uVar10 = dcgettext(0,"or available locally via: info \'(coreutils) %s%s\'\n",5);
    __printf_chk(2,uVar10,"test invocation",&_LC51);
  }
  else {
    uVar8 = dcgettext(0,"Try \'%s --help\' for more information.\n",5);
    __fprintf_chk(_stderr,2,uVar8,uVar10,in_R8,in_R9,pcVar9,lVar6,lVar12);
  }
                    /* WARNING: Subroutine does not return */
  exit(__status);
}
...

{
  ...
  if (param_1 == 0) {
    ...
    __printf_chk(2,uVar5,"https://www.gnu.org/software/coreutils/",&_LC49);
    uVar5 = dcgettext(0,"or available locally via: info \'(coreutils) %s%s\'\n",5);
    __printf_chk(2,uVar5,"test invocation",&_LC51);
  }
  else {
...

{
  ...
  if (param_1 == 2) {
    ...
    if (iVar2 == 0) {
      uVar4 = proper_name_lite("Matthew Bradburn","Matthew Bradburn");
      uVar3 = proper_name_lite("Kevin Braunsdorf","Kevin Braunsdorf");
      version_etc(_stdout,&_LC59,"GNU coreutils",_Version,uVar3,uVar4,0,uVar3);
      return 0;
    }
    iVar2 = strcmp(pcVar5,"]");
    if (iVar2 == 0) {

...

{
  ...
  if (((pc->dates_seen == 0) || ((pc->year).digits != 0)) || (pc->rels_seen != false)) {
    ...
    if (2 < text_int.digits) {
      iVar1 = (SUB168(SEXT816(-0x5c28f5c28f5c28f5) * SEXT816(text_int.value),8) + text_int.value >>
              6) - (text_int.value >> 0x3f);
...

{
  ...
  _Var1 = false;
  if (-1 < tm1->tm_wday) {
    _Var1 = ((((tm0->tm_sec == tm1->tm_sec && tm0->tm_min == tm1->tm_min) &&
...

{
  ...
  iVar3 = __sprintf_chk(time_zone_buf,2,0xffffffffffffffff,"%c%02d",(time_zone >> 0x1f & 2U) + 0x2b,
                        iVar3);
...

{
  ...
  if (((pc != (parser_control *)0x0) && (iVar2 = (int)sVar3, iVar2 < 100)) && (pc->zones_seen != 0))
  {
...
LAB_00100792:
  ...
  if ((pc->local_zones_seen == 0) || (pc->debug_local_zones_seen != false)) {
    ...
    if ((pc->zones_seen == 0) || (pc->debug_zones_seen != false)) {
      ...
      pcVar6 = " UTC%s";
LAB_00100a0d:
      pcVar8 = time_zone_str(pc->time_zone,tmp);
...

{
  ...
  if (lVar3 == 0) {
    ...
    if (lVar3 != 0) {
      pcVar2 = "%+ld %s";
LAB_00100bea:
      __fprintf_chk(_stderr,2,pcVar2,lVar3,"month(s)");
      goto LAB_00100c00;
    }
    lVar3 = (pc->rel).day;
    if (lVar3 != 0) {
...
LAB_0010133e:
    ...
    if (((bVar21 & 0xfd) == 0x2c) && (uVar28 = (int)(char)pbVar35[2] - 0x30, uVar28 < 10)) {
...
LAB_00101356:
  uVar20 = uVar20 + iVar32;
LAB_00100eed:
  local_618 = lVar34;
  if ((uVar20 < 0x73) &&
     ("\x1b\x05\x06\a\b\t\n\x13\f\x17\x04\x0f\x10g\x1a\x13\x05\x06\a\b\t\n\x1aq\x1c\x13\x13\x14\x15\x16\x13\x05\x06\a\b\t\n\x1a\x14"
      [(int)uVar20] == iVar32)) {
    cVar14 = "PDEFGHIfJ\x01;KLlkM>?@ABCNrO<\x05\x06\a\b]>?@ABCY\x06\f\b0\r\x0e\x0f\x10\x11\x12\x13\x14\x15\x16Y\x17\x18\x19\x1a\x1b\x1c\x1de\x1e\x1f=fQ231TPg456789f:p[\\RSqp>?@ABCoU\x1aVfWX_`bacdZ"
             [(int)uVar20];
    iVar31 = (int)cVar14;
    if ('\0' < cVar14) {
      uVar40 = 0xfffffffe;
...
LAB_00103300:
  lVar21 = localtime_rz(ptVar22,now,&tmp);
  if (lVar21 != 0) goto LAB_00102ee2;
  goto LAB_0010331c;
LAB_00102e45:
  iVar18 = strncmp(pcVar50,"TZ=\"",4);
  if (iVar18 == 0) {
    cVar3 = pcVar50[4];
    pcVar23 = pcVar50 + 4;
    ...
    do {
      if (cVar16 == '\\') {
        ...
        local_490 = pcVar27;
        if (((long)__size < 0x65) ||
           (pcVar27 = (char *)malloc(__size), local_490 = pcVar27, local_498 = pcVar27,
           pcVar27 != (char *)0x0)) goto joined_r0x00103299;
        goto LAB_0010325e;
      }
      cVar16 = pcVar27[1];
      __size = __size + 1;
...
LAB_00103240:
    lVar21 = localtime_rz(tzdefault,now,&tmp);
    if (lVar21 == 0) {
LAB_0010325e:
      local_498 = (char *)0x0;
      _Var35 = false;
  ...
  if (iVar18 == 0) {
    ...
    if (pc.parse_datetime_debug == false) {
      if (pc.timespec_seen == false) {
        ...
        if (1 < (pc.dates_seen | pc.times_seen | pc.days_seen | pc.dsts_seen |
                pc.J_zones_seen + pc.local_zones_seen + pc.zones_seen)) goto LAB_0010331c;
LAB_0010373c:
        iVar15 = pc.zones_seen;
...
LAB_00103768:
          ...
          if (bVar51) {
            ...
            if (_Var35 != false) {
LAB_00103f87:
              pcVar50 = (char *)dcgettext("gnulib","error: out-of-range year %ld\n",5);
              dbg_printf(pcVar50,uVar41);
LAB_00103efc:
              pcVar50 = "error: year, month, or day overflow\n";
LAB_00103f08:
            ...
            if ((pc.month + -1 == (long)tm.tm_mon && !SCARRY8(pc.month,-1)) &&
               (tm.tm_mday = iVar18, pc.day == iVar18)) goto LAB_001037d4;
...
LAB_001048f9:
          ...
          if ((bVar51) ||
             (tm.tm_mon = (int)(pc.month + -1),
             pc.month + -1 != (long)tm.tm_mon || SCARRY8(pc.month,-1))) goto LAB_0010331c;
          tm.tm_mday = iVar18;
          if (pc.day != iVar18) {
            _Var35 = false;
            goto LAB_001031df;
...
LAB_00104394:
                ...
                pcVar50 = dbg_tm;
                __snprintf_chk(pcVar50,100,2,100,"%02d:%02d:%02d",uVar41,pc.minutes,
                               pc.seconds.tv_sec);
                if (iVar37 == 0) {
                  pcVar23 = (char *)dcgettext("gnulib",
              ...
              if ((pc.hour - 1U < 0xb) || (uVar41 = 0xc, pc.hour == 0xc)) goto LAB_00104394;
              puVar42 = &_LC19;
            }
            else {
...
LAB_00103a7e:
                ...
                __snprintf_chk(dbg_ord,100,2,100,
                               "                                 %4s %2s %2s %2s %2s %2s",puVar47,
                               puVar24,puVar43,puVar45,puVar42,puVar31,iVar8);
                lVar28 = 0x34;
                do {
                  lVar21 = lVar28;
                  iVar18 = 0;
...
LAB_00104a40:
              if (_Var35 != false) goto LAB_00104a5d;
              goto LAB_00104717;
            }
                ...
                if (uVar41 == 0) {
                  ...
                  if (iVar15 != 0) {
                    ...
                    if (bVar51 || uVar33 != 0) goto LAB_00104deb;
                        ...
                        (lVar28 = pc.time_zone - tm.tm_gmtoff, bVar51 = SBORROW8(local_470,lVar28),
                        uVar33 = local_470 - lVar28, uVar36 = pc.time_zone, local_470 = uVar33,
                        SBORROW8((long)pc.time_zone,tm.tm_gmtoff) || bVar51)) {
LAB_00104deb:
                  pcVar50 = (char *)dcgettext("gnulib","error: timezone %d caused time_t overflow\n"
                                              ,5);
                  _Var35 = false;
...
LAB_00104a5d:
                ...
                if ((SEXT816(lVar28) == SEXT816(pc.rel.hour) * SEXT416(0xe10)) &&
                   (lVar21 = lVar28 + local_470, !SCARRY8(lVar28,local_470))) {
...
LAB_001049ef:
                pcVar50 = "error: adding relative time caused an overflow\n";
                goto LAB_00103f08;
              }
              if ((iVar15 == 0) ||
                 (lVar28 = pc.time_zone - tm.tm_gmtoff, bVar51 = SBORROW8(local_470,lVar28),
                 local_470 = local_470 - lVar28,
                 !SBORROW8((long)pc.time_zone,tm.tm_gmtoff) && !bVar51)) goto LAB_00104717;
            }
          }
          else {
            if (iVar48 == 0) {
              ...
              lVar28 = iVar29 * 7;
              if ((SEXT816(lVar28) == SEXT816(iVar29) * SEXT816(7)) &&
                 (lVar21 = (long)(((pc.day_number - tm.tm_wday) + 7) % 7), lVar44 = lVar21 + lVar28,
                 !SCARRY8(lVar21,lVar28))) {
...
LAB_001047c4:
                  ...
                  if ((((SEXT816(lVar28) == SEXT816(pc.rel.minutes) * SEXT816(0x3c)) &&
                       (!SCARRY8(lVar28,lVar21))) &&
                      (lVar39 = lVar28 + lVar21 + pc.rel.seconds,
                      !SCARRY8(lVar28 + lVar21,pc.rel.seconds))) &&
                     (lVar28 = lVar39 + iVar19, !SCARRY8(lVar39,(long)iVar19))) {
                    result->tv_sec = lVar28;
                    result->tv_nsec = uVar41;
                    if (_Var35 != false) {
                      if (((pc.rel.minutes != 0 || pc.rel.seconds != 0) || lVar44 != 0) ||
                          pc.rel.hour != 0) {
                        pcVar50 = (char *)dcgettext("gnulib",
                        ...
                        if (((tm.tm_isdst != -1) &&
                            (lVar28 = localtime_rz(ptVar22,result,&probe_tm), lVar28 != 0)) &&
                           (tm.tm_isdst != probe_tm.tm_isdst)) {
                          pcVar50 = (char *)dcgettext("gnulib",
...
LAB_00104a0c:
              ...
              if ((lVar21 == iVar18) && (!SCARRY8((long)tm.tm_year,pc.rel.year))) {
                ...
                if ((lVar28 == iVar19) && (!SCARRY8((long)tm.tm_mon,pc.rel.month))) {
                  ...
                  local_444 = (uint)lVar28;
                  if ((lVar28 == (int)local_444) &&
                     (iVar38 = pc.rel.month, uVar41 = pc.rel.day, iVar29 = pc.rel.year,
                     !SCARRY8((long)tm.tm_mday,pc.rel.day))) goto LAB_00104650;
                }
              }
            }
          }
...
LAB_00103405:
        ...
        iVar37 = pc.times_seen;
        iVar49 = pc.local_zones_seen;
        if ((long)(pc.times_seen | pc.dates_seen | pc.days_seen | pc.dsts_seen | uVar41) < 2)
        goto LAB_0010373c;
        if (1 < pc.times_seen) {
...
LAB_00103ca0:
        pcVar50 = time_zone_str(pc.time_zone,time_zone_buf);
        iVar18 = (int)pcVar50;
...
LAB_00103cd1:
      ...
      result->tv_nsec = pc.seconds.tv_nsec;
LAB_00103d04:
      pcVar50 = "timezone: system default\n";
      if (local_490 == (char *)0x0) {
LAB_00103d3d:
        pcVar50 = (char *)dcgettext("gnulib",pcVar50,5);
        pFVar30 = _stderr;
...
LAB_001036c3:
      pcVar23 = (char *)dcgettext("gnulib",pcVar23,5);
    }
    else {
...
_Bool parse_datetime2(timespec *result,char *p,timespec *now,uint flags,timezone_t tzdefault,
                     char *tzstring)

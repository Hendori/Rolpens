...

{
  ...
  *pcVar5 = '0';
  ...
  while (((iVar3 = __snprintf_chk(buf,bufsize,2,0xffffffffffffffff,format,width,iVar6), -1 < iVar3
          && (iVar6 < 0x15)) &&
         ((lVar7 = in_ST0, bufsize <= (ulong)(long)iVar3 ||
          (lVar7 = in_ST1, in_ST1 = in_ST2, in_ST2 = in_ST3, in_ST3 = in_ST4, in_ST4 = lVar8,
          lVar8 = lVar9, strtold(buf,(char **)0x0), lVar9 = lVar8, in_ST0 != x))))) {
    iVar6 = iVar6 + 1;
    in_ST0 = lVar7;
  }

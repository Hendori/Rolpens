...
void emit_verbose(char *format,char *src,char *dst,char *backup_dst_name)
    ...
    if (cVar6 == '\0') {
      ...
      if (iVar7 != 0) {
        ...
        if ((x->move_mode == false) &&
           (uVar2._0_1_ = x->copy_as_regular, uVar2._1_1_ = x->unlink_dest_before_opening,
           uVar2._2_1_ = x->unlink_dest_after_failed_open, uVar2._3_1_ = x->hard_link,
           (uVar2 & 0xffff00) == 0)) {
...

{
  ...
  if (_Var3 < 0) {
    ...
    if ((punch_holes) && (iVar2 = fallocate(fd,3,_Var3 - size,size), iVar2 < 0)) {
      piVar4 = __errno_location();
  ...
  *total_n_read = 0;
  ...
  if (allow_reflink) {
    ...
    do {
      ...
      if (uVar1 != 4) {
LAB_00100ad5:
        uVar7 = quotearg_n_style(1,4,dst_name);
...
LAB_001008ce:
          uVar11 = full_write(dest_fd,pcVar17,uVar19);
          if (uVar11 != uVar19) {
...

{
  ...
  if (in_stack_00000018 == '\0') {
    ...
    if ((((ushort)(~(ushort)mVar6 | 0xe00) & in_stack_00000020 & 0xfff) == 0) ||
       (iVar2 = qset_acl(dst_name,dest_desc,mVar6 & in_stack_00000020 & 0x1c0), iVar2 == 0))
    goto LAB_00100c35;
    puVar3 = (uint *)__errno_location();
    if (((*puVar3 < 0x17) && ((0x402002UL >> ((ulong)*puVar3 & 0x3f) & 1) != 0)) &&
       (x->owner_privileges == false)) goto LAB_00100cb6;
...
LAB_00101194:
    ...
    iVar22 = local_32c;
LAB_00101002:
    iVar22 = fstatat(iVar22,pcVar55,(stat *)&src_sb,(uint)(x->dereference == DEREF_NEVER) << 8);
    if (iVar22 == 0) {
...
LAB_00104cb4:
    *(undefined8 *)((long)ppcVar53 + -8) = 0x104cbe;
    uVar30 = quotearg_style(4,pcVar28);
    pcVar28 = "cannot stat %s";
    ppcVar50 = ppcVar53;
LAB_00104ccd:
    *(undefined8 *)((long)ppcVar50 + -8) = 0x104cd4;
...
LAB_00100fea:
  if (((int)uVar33 != 0x11) || (1 < x->update - UPDATE_NONE)) {
    pcVar55 = local_320;
    pcVar28 = local_320;
    iVar22 = -100;
    goto LAB_00101002;
...
LAB_001013ec:
    if (((int)uVar33 == 0x11) && (UVar24 = x->update, UVar24 - UPDATE_NONE < 2)) {
...
LAB_00101efe:
      if (x->move_mode != false) {
LAB_00102b10:
        if (1 < UVar24 - UPDATE_NONE) {
LAB_00102b1c:
          if (((x->interactive != I_ASK_USER) &&
              ((((x->interactive != I_UNSPECIFIED || (x->stdin_tty == false)) ||
                ((dst_sb.st_mode & 0xf000) == 0xa000)) ||
               ((cVar19 = can_write_any_file(), cVar19 != '\0' ||
                (iVar22 = faccessat(local_32c,local_340,2,0x200), iVar22 == 0)))))) ||
             (_Var14 = overwrite_ok(x,local_328,local_32c,local_340,&dst_sb), _Var14))
          goto LAB_00102410;
          UVar24 = x->update;
        }
...
LAB_00101f70:
        bVar17 = UVar24 == UPDATE_NONE;
LAB_00101f77:
        if (UVar24 == UPDATE_NONE_FAIL) {
...
LAB_00101f22:
        if (1 < UVar24 - UPDATE_NONE) {
          if ((x->interactive != I_ASK_USER) ||
             (_Var14 = overwrite_ok(x,local_328,local_32c,local_350,&dst_sb), _Var14))
          goto LAB_00102410;
          UVar24 = x->update;
        }
        goto LAB_00101f70;
...
LAB_00102c6b:
          pcVar28 = (char *)last_component(local_320);
          if ((*pcVar28 == '.') &&
             ((pcVar28[(ulong)(pcVar28[1] == '.') + 1] == '\0' ||
              (pcVar28[(ulong)(pcVar28[1] == '.') + 1] == '/')))) goto LAB_00103030;
          ...
          if (bVar59 != numbered_backups) {
            ...
            psVar34 = local_348;
            if (((sVar40 == (long)local_348->__glibc_reserved + (sVar36 - 0x78)) &&
                (iVar22 = memcmp(pcVar28,local_370,(size_t)local_348), psVar57 = local_388,
                iVar22 == 0)) &&
               (iVar22 = strcmp(pcVar28 + (long)(psVar34->__glibc_reserved + -0xf),(char *)local_388
                               ), pcVar28 = local_350, iVar22 == 0)) {
              ...
              free(pcVar28);
              if ((iVar22 == 0) &&
                 (src_sb.st_dev == dst_back_sb.st_dev && src_sb.st_ino == dst_back_sb.st_ino)) {
                if (x->move_mode == false) {
...
LAB_00102c5c:
        if (bVar59 != no_backups) goto LAB_00102c6b;
LAB_00103030:
        if ((dst_sb.st_mode & 0xf000) != 0x4000) goto LAB_00102480;
LAB_00103040:
        local_370 = (stat *)0x0;
        uVar33 = 0x11;
        ppcVar48 = &local_3d8;
...
LAB_00102c18:
        if (((char)local_334 != '\0') && (bVar60)) goto LAB_00102c26;
        goto LAB_00102c6b;
      }
      if (x->exchange == false) {
        uVar30 = quotearg_n_style(1,4,local_320);
...
LAB_00102480:
      if (x->move_mode != false) goto LAB_00103040;
      if (x->unlink_dest_before_opening == false) {
        ...
        if ((x->preserve_links == false) || (dst_sb.st_nlink < 2)) {
          ...
          if ((x->dereference != DEREF_NEVER) ||
             (ppcVar48 = &local_3d8, (src_sb.st_mode & 0xf000) == 0x8000)) goto LAB_00102609;
        }
      }
...
LAB_001018aa:
      cVar15 = x->move_mode;
      if ((((_Bool)cVar15 != false) || (cVar15 = x->symbolic_link, (_Bool)cVar15 != false)) ||
         (cVar15 = x->hard_link, (_Bool)cVar15 != false)) goto LAB_00101bc8;
...
LAB_001038e8:
                if (psVar57->st_dev != psVar34->st_dev || psVar57->st_ino != psVar34->st_ino)
                goto LAB_00103e89;
                cVar20 = x->hard_link;
...
LAB_00103626:
              cVar20 = x->move_mode;
LAB_0010362c:
              if (((cVar20 != '\0') && ((src_sb.st_mode & 0xf000) == 0xa000)) &&
                 (1 < psVar34->st_nlink)) {
            ...
            if ((x->symbolic_link == false) || ((psVar34->st_mode & 0xf000) != 0xa000)) {
              ...
              if ((psVar57->st_mode & 0xf000) == 0xa000) {
                ...
                dst_back_sb.__glibc_reserved[0] = psVar57->__glibc_reserved[0];
                dst_back_sb.__glibc_reserved[1] = psVar57->__glibc_reserved[1];
                dst_back_sb.__glibc_reserved[2] = psVar57->__glibc_reserved[2];
              }
              if ((psVar34->st_mode & 0xf000) == 0xa000) {
                local_370 = (stat *)CONCAT44(local_370._4_4_,uVar43);
                ...
                tmp_dst_sb.__glibc_reserved[0] = psVar34->__glibc_reserved[0];
                tmp_dst_sb.__glibc_reserved[1] = psVar34->__glibc_reserved[1];
                tmp_dst_sb.__glibc_reserved[2] = psVar34->__glibc_reserved[2];
              }
...
LAB_00103ee9:
        ...
        if (((x->dereference != DEREF_NEVER) && ((psVar57->st_mode & 0xf000) == 0xa000)) &&
           ((psVar34->st_mode & 0xf000) != 0xa000)) goto LAB_001015c8;
...
LAB_001015c8:
      uVar30 = quotearg_n_style(1,4,local_328);
    ...
    if ((_Bool)cVar20 == false) {
      ...
      if (iVar22 == 0) {
        ...
        if (iVar22 == 0) {
          bVar60 = dst_back_sb.st_dev == tmp_dst_sb.st_dev &&
                   dst_back_sb.st_ino == tmp_dst_sb.st_ino;
          psVar57 = local_370;
          uVar43 = (uint)local_388;
          if ((((dst_back_sb.st_mode & 0xf000) != 0xa000) ||
              ((tmp_dst_sb.st_mode & 0xf000) != 0xa000)) || (x->unlink_dest_before_opening == false)
             ) goto LAB_00101570;
        }
      }
LAB_001033ef:
...
LAB_00102e1f:
    if (UVar24 != UPDATE_OLDER) goto LAB_00101efe;
    cVar19 = cVar20;
    if (uVar43 == 0x4000) {
...
LAB_00102e35:
    cVar20 = cVar19;
    bVar60 = false;
    if ((x->preserve_timestamps != false) && (bVar60 = true, x->move_mode != false)) {
...
LAB_00102b07:
    ...
    bVar17 = create_hard_link((char *)0x0,local_32c,pcVar28,local_328,local_32c,local_350,true,
                              x->verbose,SUB41(local_338,0));
    if ((bool)bVar17) {
      UVar24 = x->update;
      goto LAB_00101f77;
    }
...
LAB_00103176:
    *(undefined8 *)((long)ppcVar50 + -8) = 0x10317b;
...
LAB_00101088:
      local_338 = (uint)(x->dereference - DEREF_COMMAND_LINE_ARGUMENTS < 2);
...
LAB_00101108:
        ...
        if (x->verbose == false) {
LAB_00101207:
          if ((int)uVar33 != 0) goto LAB_00101630;
          ppcVar50 = ppcVar47;
          ...
          *(undefined8 *)((long)ppcVar48 + -8) = 0x102fba;
          ...
          if (cVar15 != '\0') {
            ...
            *(undefined8 *)((long)ppcVar48 + -8) = 0x102fee;
            ...
            ppcVar46 = ppcVar48;
LAB_00101603:
            *(undefined8 *)((long)ppcVar46 + -8) = 0x10160a;
            uVar35 = dcgettext(0,pcVar28,5);
...
LAB_001012ad:
              ...
              if (x->symbolic_link == false) {
                ...
                if (x->hard_link == false) {
                  if (uVar58 == 0x8000) {
LAB_001026b5:
                    _rename_succeeded_1 = (char *)0x0;
                    local_3a0 = (cp_options *)
                                (CONCAT44(local_3a0._4_4_,uVar43) & 0xffffffff000001ff);
                    ...
                    *(undefined8 *)((long)ppcVar50 + -8) = 0x10273c;
                    ...
                    if (iVar23 == 0) {
                      ...
                      src_sb.__glibc_reserved[0] = dst_back_sb.__glibc_reserved[0];
                      src_sb.__glibc_reserved[1] = dst_back_sb.__glibc_reserved[1];
                      src_sb.__glibc_reserved[2] = dst_back_sb.__glibc_reserved[2];
...
LAB_00103fee:
                        ...
                        if ((x->set_security_context != (selabel_handle *)0x0) ||
                          ...
                          *(undefined8 *)((long)ppcVar50 + -8) = 0x102860;
                          ...
                          if (((bool)bVar18) || (x->require_preserve_context == false))
                          goto LAB_00102873;
                          local_348 = (stat *)((ulong)local_348 & 0xffffffffffffff00);
                          goto LAB_001029cb;
                        }
...
LAB_0010287f:
                        if ((byte)local_360 == '\0') {
LAB_001037f0:
                          uVar54 = x->preserve_ownership | uVar43;
...
LAB_001028c6:
                              local_3c0 = (char *)CONCAT44(local_3c0._4_4_,uVar43);
                            }
                            else {
                              iVar22 = (int)local_358;
                            ...
                            if (tmp_dst_sb.st_blksize - 1U >> 0x3d == 0) {
                              ...
                              local_378 = (dir_list *)
                                          ((0x3ffff -
                                           SUB168((auVar7 << 0x40 | ZEXT816(0x3ffff)) %
                                                  SEXT816(tmp_dst_sb.st_blksize),0)) +
                                          tmp_dst_sb.st_blksize);
                              if (((tmp_dst_sb.st_mode & 0xf000) == 0x8000) &&
                                 (((ulong)local_378 & (ulong)((long)&local_378[-1].dev + 7U)) != 0))
                              {
                                lVar45 = 0x3f;
...
LAB_001029b0:
                              *(undefined8 *)((long)ppcVar50 + -8) = 0x1029b7;
                              uVar31 = dcgettext(0,pcVar28,5);
                              iVar22 = *piVar32;
...
LAB_00103a3c:
                            ...
                            if (((tmp_dst_sb.st_mode & 0xf000) == 0x8000) &&
                               ((x->sparse_mode == SPARSE_ALWAYS ||
                                ((x->sparse_mode == SPARSE_AUTO && (iVar22 != 1)))))) {
...
LAB_00103b24:
                              ...
                              *(undefined8 *)((long)ppcVar50 + -0x38) = 0x103b69;
                              _Var14 = sparse_copy(uVar43,iVar22,(char **)&rename_succeeded_1,
                                                   (size_t)pdVar38,(size_t)p_Var42,
                                                   SVar4 == SPARSE_ALWAYS,
                                                   *(_Bool *)((long)ppcVar50 + -0x30),
                                                   *(char **)((long)ppcVar50 + -0x28),
                                                   *(char **)((long)ppcVar50 + -0x20),
                                                   *(uintmax_t *)((long)ppcVar50 + -0x18),
                                                   *(off_t **)((long)ppcVar50 + -0x10),
                                                   *(_Bool **)((long)ppcVar50 + -8));
                            ...
                            *(undefined8 *)((long)ppcVar50 + -8) = 0x103a62;
                            ...
                            if (dst_back_sb.st_blksize - 1U >> 0x3d == 0) {
                              ...
                              uVar33 = dst_back_sb.st_blksize +
                                       (0x3ffff -
                                       SUB168((auVar6 << 0x40 | ZEXT816(0x3ffff)) %
                                              SEXT816(dst_back_sb.st_blksize),0));
                              ...
                              *(undefined8 *)((long)ppcVar50 + -8) = 0x104c64;
                              pdVar38 = (dir_list *)
                                        buffer_lcm(1L << ((char)lVar45 + 1U & 0x3f),pdVar38,
                                                   0x7fffffffffffffff);
LAB_0010449d:
                              pdVar13 = (dir_list *)(dst_back_sb.st_size + 1);
                              ...
                              if ((dst_back_sb.st_mode & 0xf000) == 0x8000) {
                                uVar33 = 0x40000;
LAB_00104484:
                                *(undefined8 *)((long)ppcVar50 + -8) = 0x10449a;
                                pdVar38 = (dir_list *)buffer_lcm(uVar33,pdVar38,0x7fffffffffffffff);
                                goto LAB_0010449d;
                              }
LAB_00103aa5:
                              *(undefined8 *)((long)ppcVar50 + -8) = 0x103abe;
                              pdVar38 = (dir_list *)buffer_lcm(uVar33,pdVar38,0x7fffffffffffffff);
                              pdVar13 = local_378;
                            }
                            local_378 = pdVar13;
...
LAB_00103b75:
                                  uVar30 = non_command_line_options._0_8_;
...
LAB_00103b82:
                                  if (x->preserve_timestamps != false) goto LAB_00103dc7;
                                  goto LAB_00103b8e;
                                }
                              }
LAB_00104503:
                              ...
                              *(undefined8 *)((long)ppcVar50 + -8) = 0x104514;
                              ...
                              local_368 = (stat *)0x0;
                              local_380 = (stat *)0x0;
                              local_3c8 = (cp_options *)
                                          (CONCAT44(local_3c8._4_4_,uVar27) & 0xffffffff0000f000);
                                ...
                                *(undefined8 *)((long)ppcVar50 + -8) = 0x104620;
                                ...
                                if ((long)psVar34 < 0) {
                                  ...
                                  *(undefined8 *)((long)ppcVar50 + -8) = 0x104887;
                                  ...
                                  local_360 = (stat *)CONCAT71(local_360._1_7_,
                                                               (byte)local_360 | bVar60);
                                  __offset = local_368;
...
LAB_00104646:
                                *(undefined8 *)((long)ppcVar50 + -8) = 0x104653;
...
LAB_001046c1:
                                ...
                                *(undefined8 *)((long)ppcVar50 + -0x38) = 0x104707;
                                _Var14 = sparse_copy(uVar43,iVar22,(char **)&rename_succeeded_1,
                                                     (size_t)pdVar38,(size_t)p_Var42,true,
                                                     *(_Bool *)((long)ppcVar50 + -0x30),
                                                     *(char **)((long)ppcVar50 + -0x28),
                                                     *(char **)((long)ppcVar50 + -0x20),
                                                     *(uintmax_t *)((long)ppcVar50 + -0x18),
                                ...
                                __offset = (stat *)((long)__offset_00->__glibc_reserved +
                                                   non_command_line_options._0_8_ + -0x78);
...
LAB_00104523:
                            *(undefined8 *)((long)ppcVar50 + -8) = 0x10452a;
                            uVar31 = dcgettext(0,pcVar28,5);
...
LAB_00103b8e:
                            ...
                            if (x->preserve_ownership != false) {
                              ...
                              *(undefined8 *)((long)ppcVar50 + -0x28) = 0x103bfb;
                              iVar22 = set_owner(x,pcVar55,iVar23,pcVar28,iVar22,psVar34,
                                                 *(_Bool *)((long)ppcVar50 + -0x20),
                                                 *(stat **)((long)ppcVar50 + -0x18));
...
LAB_00103948:
                          ...
                          *(undefined8 *)((long)ppcVar50 + -8) = 0x1049e8;
                          ...
                          if ((int)uVar54 < 0x1d) {
                            if ((4 < (int)uVar54) &&
                               ((0x10001020UL >> ((ulong)uVar54 & 0x3f) & 1) != 0))
                            goto LAB_00104a0e;
LAB_00104d48:
                            if ((int)local_368 != 2) {
...
LAB_00104a0e:
                            *(undefined8 *)((long)ppcVar50 + -8) = 0x104a24;
                            uVar30 = quotearg_n_style(1,4,pcVar28);
                            pcVar28 = local_328;
...
LAB_00105230:
                      *(undefined8 *)((long)ppcVar50 + -8) = 0x105237;
                      uVar31 = dcgettext(0,pcVar28,5);
                    ...
                    *(undefined8 *)((long)ppcVar50 + -8) = 0x1029e9;
                    ...
                    if (iVar22 < 0) {
                      ...
                      *(undefined8 *)((long)ppcVar50 + -8) = 0x1051f7;
                      ...
                      if ((((x->debug != false) && (x->hard_link == false)) &&
                          (x->symbolic_link == false)) && (x->data_copy_required != false))
                      goto LAB_00103c57;
...
LAB_00103c57:
                    ...
                    /* WARNING: Treating indirect jump as call */
                        uVar21 = (*(code *)((long)&DAT_001069b0 +
                                           (long)(int)(&DAT_001069b0)[copy_debug.sparse_detection]))
                                           ();
                        return (_Bool)uVar21;
                      }
                    ...
                    *(undefined8 *)((long)ppcVar50 + -8) = 0x103997;
                    ...
                    if (iVar22 < 1) {
LAB_001042a5:
                      *(undefined8 *)((long)ppcVar50 + -8) = 0x1042ad;
                      free(pcVar37);
                      iVar22 = local_32c;
                      pcVar28 = local_350;
                        ...
                        *(undefined8 *)((long)ppcVar50 + -8) = 0x10437b;
                        ...
                        if (iVar22 != 0) {
                          *(undefined8 *)((long)ppcVar50 + -8) = 0x104388;
                          puVar29 = (uint *)__errno_location();
                          if (((0x16 < *puVar29) ||
                              ((0x402002UL >> ((ulong)*puVar29 & 0x3f) & 1) == 0)) ||
                             (x->chown_privileges != false)) {
                    ...
                    if (((x->update == UPDATE_OLDER) && ((byte)local_348 == '\0')) &&
                       ((dst_sb.st_mode & 0xf000) == 0xa000)) {
                  ...
                  *(undefined8 *)((long)ppcVar50 + -0x28) = 0x1023df;
                  bVar17 = create_hard_link(pcVar55,-100,pcVar55,pcVar37,iVar22,pcVar28,
                                            *(_Bool *)((long)ppcVar50 + -0x20),
                                            *(_Bool *)((long)ppcVar50 + -0x18),
                                            *(_Bool *)((long)ppcVar50 + -0x10));
                  local_3b5 = '\0';
                    ...
                    *(undefined8 *)((long)ppcVar50 + -8) = 0x101bf3;
                    ...
                    if (iVar23 == 0) {
                      *(undefined8 *)((long)ppcVar50 + -8) = 0x101c12;
                      ...
                      if ((iVar22 == 0) &&
                         (tmp_dst_sb.st_dev != dst_back_sb.st_dev ||
                          tmp_dst_sb.st_ino != dst_back_sb.st_ino)) {
...
LAB_00101858:
                        *(undefined8 *)((long)ppcVar50 + -8) = 0x10185f;
                        uVar31 = dcgettext(0,pcVar28,5);
...
joined_r0x00101818:
            for (; _Var10 = src_sb.st_ino, _Var9 = src_sb.st_dev, pcVar28 = local_320,
                pdVar38 != (dir_list *)0x0; pdVar38 = pdVar38->parent) {
...
LAB_00103483:
            ...
            if ((x->set_security_context != (selabel_handle *)0x0) ||
              ...
              *(undefined8 *)((long)ppcVar50 + -0x28) = 0x10332d;
              ...
              if ((!_Var14) &&
                 (puVar49 = (undefined1 *)((long)ppcVar50 + -0x20),
                 x->require_preserve_context != false)) goto LAB_00102a20;
            }
            local_3b5 = '\0';
            local_3b4 = 0;
LAB_00102130:
            ...
            if ((bVar17 == 0) || (local_380->st_dev == src_sb.st_dev)) {
              ...
              non_command_line_options.unlink_dest_after_failed_open =
                ...
                if (*pcVar28 != '\0') {
                  ...
                  do {
                    ...
                    *(undefined8 *)((long)ppcVar50 + -0x58) = 0x102308;
                    _Var16 = copy_internal(pcVar37,pcVar55,iVar23,pcVar55 + (long)pdVar38,iVar22,
                                           psVar34,*(dir_list **)((long)ppcVar50 + -0x50),
                                           *(cp_options **)((long)ppcVar50 + -0x48),
                                           *(_Bool *)((long)ppcVar50 + -0x40),
                                           *(_Bool **)((long)ppcVar50 + -0x38),
                                           *(_Bool **)((long)ppcVar50 + -0x30),
                                           *(_Bool **)((long)ppcVar50 + -0x28));
...
LAB_00101345:
            ...
            if (((byte)local_348 == '\0') && (x->copy_as_regular == false)) {
              if (uVar58 == 0x4000) {
                if (((char)local_334 != '\0') && (x->dest_info != (Hash_table *)0x0))
                goto LAB_00101c81;
              }
              else {
                if ((x->set_security_context != (selabel_handle *)0x0) ||
                  ...
                  *(undefined8 *)((long)ppcVar53 + -8) = 0x101388;
                  ...
                  if ((!_Var14) &&
                     (puVar49 = (undefined1 *)ppcVar53, x->require_preserve_context != false))
                  goto LAB_00102a20;
                }
...
LAB_00101c81:
            ...
            uVar43 = local_330;
            if ((x->preserve_ownership != false) &&
               ((((byte)local_348 != '\0' || (src_sb.st_uid != dst_sb.st_uid)) ||
              ...
              *(undefined8 *)((long)ppcVar53 + -0x28) = 0x101d93;
              iVar22 = set_owner(x,pcVar55,iVar22,pcVar28,-1,psVar34,
                                 *(_Bool *)((long)ppcVar53 + -0x20),
                                 *(stat **)((long)ppcVar53 + -0x18));
...
LAB_00101dfd:
                ...
                if (((local_330 & 0x7000) == 0x4000) &&
                   (uVar43 = 0x1ff, (local_330 & 0xf000) == 0x4000)) {
              ...
              *(undefined8 *)((long)ppcVar53 + -8) = 0x101ebc;
              ...
              if (iVar22 == 0) goto LAB_00101a0c;
LAB_00101e80:
              if (x->require_preserve == false) goto LAB_00101a0c;
            }
          }
        }
      }
...
LAB_00101630:
        ...
        if (x->exchange != false) {
          if (x->move_mode == false) goto LAB_0010121b;
LAB_00101648:
          if ((int)uVar33 != 0x11) goto LAB_00101651;
          local_388 = (stat *)0x0;
          uVar43 = 1;
LAB_00101980:
          pcVar55 = local_320;
          ...
          *(undefined8 *)((long)ppcVar50 + -8) = 0x101aab;
          ...
          if (cVar15 == '\0') {
            *(undefined8 *)((long)ppcVar50 + -8) = 0x101ace;
            ...
            if (cVar15 == '\0') {
              if ((x->dereference != DEREF_ALWAYS) &&
                 ((x->dereference != DEREF_COMMAND_LINE_ARGUMENTS || ((char)local_334 == '\0')))) {
            ...
            *(undefined8 *)((long)ppcVar50 + -8) = 0x105601;
            error(0,0,uVar31,uVar30);
            if ((x->move_mode == false) || (psVar34 = local_368, local_368 == (stat *)0x0))
            goto LAB_00101a06;
            goto LAB_00104f4d;
          }
...
LAB_00101928:
          if ((1 < src_sb.st_nlink) ||
             ((((char)local_334 != '\0' && (x->dereference == DEREF_COMMAND_LINE_ARGUMENTS)) ||
...
LAB_00103101:
            ...
            if (local_388 != (stat *)0x0) {
              ...
              *(undefined8 *)((long)ppcVar50 + -0x28) = 0x10315e;
              _Var14 = create_hard_link((char *)0x0,iVar22,(char *)psVar34,pcVar55,iVar22,pcVar28,
                                        *(_Bool *)((long)ppcVar50 + -0x20),
                                        *(_Bool *)((long)ppcVar50 + -0x18),
                                        *(_Bool *)((long)ppcVar50 + -0x10));
        ...
        if (iVar23 == 0x12) {
          ...
          if ((uVar43 & 0xffff00) == 0) {
            ...
            *(undefined8 *)((long)ppcVar50 + -8) = 0x1016a9;
            ...
            if (iVar22 == 0) {
LAB_001016be:
              if ((x->verbose != false) && (uVar43 != 0x4000)) {
...
LAB_00102667:
            *(undefined8 *)((long)ppcVar50 + -8) = 0x10266e;
            uVar35 = dcgettext(0,pcVar28,5);
          }
...
LAB_0010256b:
          *(undefined8 *)((long)ppcVar50 + -8) = 0x10257e;
...
LAB_0010107c:
      record_file(pHVar56,local_320,psVar34);
      goto LAB_00101088;
    }
    local_348 = &src_sb;
...

{
  ...
  *(long *)(lVar3 + 0x58) = lVar2;
  ...
  if (in_R9->sparse_mode - SPARSE_NEVER < 3) {
    ...
    copy_internal(src_name,dst_name,dst_dirfd,dst_relname,nonexistent_dst,(stat *)0x0,
                  (dir_list *)0x0,in_R9,true,&_Stack_21,unaff_RBX,unaff_retaddr);
...

{
  ...
  if (in_R9->reflink_mode < (REFLINK_ALWAYS|REFLINK_AUTO)) {
    ...
    top_level_src_name = src_name;
    copy_internal(src_name,dst_name,dst_dirfd,dst_relname,nonexistent_dst,(stat *)0x0,
                  (dir_list *)0x0,in_R9,true,&_Stack_19,unaff_retaddr,in_stack_00000008);
...

{
  ...
  _Var1 = copy_internal((char *)dst,(char *)src,in_EDX,in_RCX,in_R8D,(stat *)0x0,(dir_list *)0x0,
                        in_R9,true,&first_dir_created_per_command_line_arg,in_stack_00000008,
                        in_stack_00000010);

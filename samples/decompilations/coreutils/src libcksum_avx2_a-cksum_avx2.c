...
_Bool cksum_avx2(FILE *fp,uint_fast32_t *crc_out,uintmax_t *length_out)
    ...
    do {
      ...
      *(undefined8 *)(puVar11 + -0x1048) = 0x10009d;
      ...
      if (0xff < sVar5) {
        ...
        vpshufb_avx2(*(undefined1 (*) [32])(puVar11 + -0x1000),__LC0);
        vpshufb_avx2(*(undefined1 (*) [32])(puVar11 + -0xfe0),__LC0);
        vpshufb_avx2(*(undefined1 (*) [32])(puVar11 + -0xfc0),__LC0);

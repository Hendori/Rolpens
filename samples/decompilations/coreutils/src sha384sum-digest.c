...

{
  ...
  *bin_result = '\0';
  ...
  if (uVar1 == 0) {
    ...
    fadvise(_stdin,2);
    iVar2 = sha384_stream(__stream,binary);
    if (iVar2 == 0) {
    ...
    fadvise(lVar5,2);
    iVar2 = sha384_stream(lVar5,binary);
    if (iVar2 == 0) {
  ...
  while( true ) {
    ...
    if (iVar7 < 0x62) {
      if (iVar7 == -0x83) {
        ...
        version_etc(_stdout,"sha384sum","GNU coreutils",_Version,uVar10,uVar9,uVar8,0);
                    /* WARNING: Subroutine does not return */
        exit(0);
      }
      if (iVar7 == -0x82) {
...
joined_r0x0010188a:
  ...
  if ((((ignore_missing != true) ||
       ...
       local_ed != 0)) &&
      ((status_only != true ||
       (pcVar26 = "the --status option is meaningful only when verifying checksums", local_ed != 0))
      )) && ((warn != true ||
             (pcVar26 = "the --warn option is meaningful only when verifying checksums",
             local_ed != 0)))) {
    bVar4 = quiet ^ 1U | local_ed;
    ...
    if (bVar4 == 0) {
      ...
      if (((local_ed ^ 1) & strict) == 0) {
        ...
        if (pFVar12 < pFVar16) {
          local_e8 = *(FILE **)pFVar12;
          if (local_ed != 0) {
            local_b0 = bin_buffer_unaligned + 7;
            local_a1 = local_ed;
            local_a0 = pFVar16;
            goto LAB_0010190b;
          }
          local_108 = (FILE *)&missing;
          puVar31 = (uint *)(ulong)(uint)bVar4;
          puVar24 = &_LC73;
          __stream = (char *)local_e8;
          pFVar33 = pFVar12;
          do {
            _Var5 = digest_file(__stream,(int *)bin_buffer_unaligned,(uchar *)local_108,
...
LAB_0010179f:
                ...
                print_filename(__stream,SUB41(local_ec,0));
              }
              else {
...
LAB_001018b1:
        ...
        if (have_read_stdin != false) {
          local_108 = (FILE *)CONCAT71(local_108._1_7_,(char)uVar29);
...
LAB_0010201b:
            ...
            if (local_c8 == (FILE *)digest_hex_bytes) {
              uVar29 = (ulong)local_c8 >> 1;
              if (uVar29 != 0) {
                uVar21 = 0;
                do {
                  ...
                  if ((int)(char)bin2hex_0[*(byte *)((long)local_e0 + uVar21) >> 4] != uVar23) {
LAB_00102180:
                  ...
                  if ((int)(char)bin2hex_0[*(byte *)((long)local_e0 + uVar21) & 0xf] != uVar23)
                  goto LAB_00102180;
                  uVar21 = uVar21 + 1;
                } while (uVar29 != uVar21);
              }
              local_a2 = status_only;
              if ((status_only != false) || (local_a2 = quiet, quiet != false)) goto LAB_00101caa;
              local_a2 = (char)length;
              if ((int)poVar32 != 0) goto LAB_001021bd;
              local_f8 = (FILE *)((ulong)length & 0xff);
...
LAB_00101cf3:
                if (-1 < iVar7) {
                  puVar24 = (undefined1 *)quotearg_n_style_colon(0,3,local_e8);
                  puVar22 = &_LC4;
...
LAB_00101d4b:
                    if (local_d0 == (FILE *)0x0 && local_d8 == (FILE *)0x0) {
                      bVar28 = strict ^ 1U | local_b8 == (FILE *)0x0;
                      goto LAB_00101d6f;
                    }
                  }
                  else {
...
LAB_0010243d:
              ...
              while( true ) {
                local_a1 = local_a1 & bVar28;
                pFVar33 = (FILE *)&pFVar12->_IO_read_ptr;
                if (local_a0 <= pFVar33) {
                  uVar29 = (ulong)local_a1;
                  goto LAB_001018b1;
                }
                local_e8 = *(FILE **)pFVar33;
                pFVar12 = pFVar33;
LAB_0010190b:
                local_e0 = (int *)((ulong)local_b0 & 0xfffffffffffffff8);
...
LAB_0010195c:
              ...
              local_b8 = (FILE *)0x0;
              pFVar33 = local_108;
              local_100 = (FILE *)puVar31;
              local_c0 = pFVar12;
              while (pFVar16 = (FILE *)__stream,
                    _Var13 = __getdelim((char **)local_108,(size_t *)local_100,10,(FILE *)__stream),
                ...
                iVar7 = strncmp((char *)pFVar12,"SHA384",6);
                ...
                if (cVar6 == '(') {
                  ...
                  if ((FILE *)poVar32 != (FILE *)0x0) {
                    ...
                    if ((*pcVar30 == ')') &&
                       ((bVar34 = (char)local_f8 == '\0', bVar34 ||
                        (pcVar19 = filename_unescape((char *)pFVar16,(size_t)pcVar26),
                        local_f8 = pFVar16, pcVar19 != (char *)0x0)))) {
                      *pcVar30 = '\0';
...
LAB_00101aa3:
                if (warn != false) {
                  poVar32 = (option *)quotearg_n_style_colon(0,3,local_e8);
                  ...
                  if ((cVar6 == '\\') + min_digest_line_length <=
                    ...
                    if ((FILE *)poVar32 != pFVar33) {
                      *(_Bool *)&pFVar27->_flags = false;
                      local_c8 = (FILE *)digest_hex_bytes;
...
LAB_0010223a:
                          ...
                          if (((local_ec != 0) || (SUB41(pFVar16->_flags,0) != true)) ||
                            ...
                            _Var5 = digest_file((char *)pFVar16,local_e0,&missing_1,(_Bool *)pFVar16
                                                ,(uintmax_t *)length);

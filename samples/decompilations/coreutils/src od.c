    ...
    do {
      ...
      if (input_swap == false) {
        ...
        uVar3 = *block;
                    ...
                    /* WARNING: Load size is inaccurate */
        uVar3 = CONCAT31(CONCAT21(CONCAT11(*block,*(undefined1 *)((long)block + 1)),
                                  *(undefined1 *)((long)block + 2)),*(undefined1 *)((long)block + 3)
                        );
      }
...
void print_halffloat(size_t fields,size_t blank,void *block,char *fmt_string,int width,int pad)
...
void print_bfloat(size_t fields,size_t blank,void *block,char *fmt_string,int width,int pad)
...

{
  ...
  if ((((abbreviate_duplicate_blocks) && (!write_block::first)) && (bytes_per_block == n_bytes)) &&
     (iVar5 = memcmp(prev_block,curr_block,n_bytes), iVar5 == 0)) {
  ...
  if (0 < n_specs) {
    ...
    do {
      ...
      (*spec[lVar9].print_function)
                ((long)iVar4,(long)iVar5,curr_block,spec[lVar9].fmt_string,spec[lVar9].field_width,
                 spec[lVar9].pad_width);
      if (spec[lVar9].hexl_mode_trailer != false) {
        __printf_chk(2,&_LC3,(spec[lVar9].pad_width * iVar5) / iVar4 +
                             iVar5 * spec[lVar9].field_width,&_LC16);
...
LAB_00101586:
        if (cVar3 < 'v') {
          if (cVar3 == 'd') {
            ...
            if ((sVar20 != LONG_LONG) && (puVar19 = &_LC20, sVar20 == LONG)) {
              puVar19 = &_LC19;
            }
            ...
            puVar19 = &_LC21;
            if ((sVar20 != LONG_LONG) && (puVar19 = &_LC23, sVar20 == LONG)) {
              puVar19 = &_LC22;
            }
            iVar18 = (int)""[lVar11];
            oVar16 = OCTAL;
          ...
          puVar19 = &_LC27;
          if ((sVar20 != LONG_LONG) && (puVar19 = &_LC29, sVar20 == LONG)) {
            puVar19 = &_LC28;
          }
          iVar18 = (int)""[lVar11];
          oVar16 = HEXADECIMAL;
...
LAB_001016bf:
        puVar19 = &_LC24;
        iVar18 = (int)""[lVar11];
        if ((sVar20 != LONG_LONG) && (puVar19 = &_LC26, sVar20 == LONG)) {
          puVar19 = &_LC25;
        }
...
LAB_0010146b:
      spec = (tspec *)xpalloc(spec,&n_specs_allocated,1,0xffffffffffffffff,0x28);
    }
  } while( true );
}
...
LAB_00101f16:
  uVar8 = dcgettext(0,"cannot skip past end of combined input",5);
  error(1,0,uVar8);
LAB_00101f3a:
  _Var11 = false;
...

{
  ...
  bVar8 = false;
  bVar7 = false;
  fp_type_size[0xc] = NO_SIZE;
  fp_type_size[0xd] = NO_SIZE;
  fp_type_size[0xe] = NO_SIZE;
  fp_type_size[0xf] = NO_SIZE;
LAB_00103ea0:
  oi = -1;
...
LAB_00104d85:
    xstrtol_fatal(iVar12,oi,0x53,long_options,_optarg);
    goto LAB_00104d9f;
  }
  if ((char)puVar23 == '\0') {
    uVar22 = 1;
  ...
  if ((flag_dump_strings != false) &&
     (pcVar24 = "no type may be specified when dumping strings", 0 < n_specs)) goto LAB_00104dd9;
  lVar15 = (long)_optind;
  iVar12 = argc - _optind;
  if (bVar7) {
...
LAB_001042b0:
    if (iVar12 == 3) {
      if (traditional != false) {
        ...
        if ((!_Var10) || (_Var10 = parse_old_offset(argv[(long)_optind + 2],&tmp), !_Var10))
        goto LAB_0010465a;
      ...
      if (((traditional != false) || (*argv[lVar15] == '+')) &&
         (_Var10 = parse_old_offset(argv[lVar15],(uintmax_t *)&oi), _Var10)) {
        n_bytes_to_skip = CONCAT44(uStack_64,oi);
        argv = argv + 1;
        iVar12 = 0;
      }
...
LAB_0010460d:
      _Var10 = parse_old_offset(pcVar24,&tmp);
      if (_Var10) {
        lVar15 = (long)_optind;
        if (traditional != false) {
...
LAB_00104d9f:
    ...
    if (0 < n_specs) {
      ...
      do {
        psVar25 = psVar20 + 10;
        psVar20[7] = uVar22 - (int)((ulong)local_78 / (ulong)(long)width_bytes[*psVar20]) *
                              psVar20[6];
        psVar20 = psVar25;
...
LAB_001044cc:
    do {
      if ((limit_bytes_to_format != false) &&
         ((end_offset < (ulong)string_min || (end_offset - string_min <= uVar29)))) {
        uVar21 = (uint)bVar26;
        free(__ptr);
...
switchD_00103ef0_caseD_81:
  lVar15 = __xargmatch_internal
                     ("--endian",_optarg,endian_args,endian_types,4,_argmatch_die,1,
                      (long)&switchD_00103ef0::switchdataD_001029bc +
                      (long)(int)(&switchD_00103ef0::switchdataD_001029bc)[iVar12 - 0x41U]);
...
LAB_0010456a:
    bVar26 = (byte)uVar22;
    if ((have_read_stdin == false) || (iVar12 = rpl_fclose(_stdin), iVar12 != -1)) break;

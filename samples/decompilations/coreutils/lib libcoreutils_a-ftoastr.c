...

{
  ...
  *pcVar4 = '0';
  ...
  iVar5 = 1;
  if (_LC4 <= (float)(((uint)x ^ __LC1) & -(uint)(x < 0.0) | ~-(uint)(x < 0.0) & (uint)x)) {
    iVar5 = 6;
  }
  while (((iVar2 = __snprintf_chk((double)x,buf,bufsize,2,0xffffffffffffffff,format,width,iVar5),
          -1 < iVar2 && (iVar5 < 9)) &&
         ((bufsize <= (ulong)(long)iVar2 || (fVar6 = strtof(buf,(char **)0x0), fVar6 != x))))) {
    iVar5 = iVar5 + 1;
  }

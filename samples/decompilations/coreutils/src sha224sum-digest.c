...

{
  ...
  *bin_result = '\0';
  ...
  if (uVar1 == 0) {
    ...
    fadvise(_stdin,2);
    iVar2 = sha224_stream(__stream,binary);
    if (iVar2 == 0) {
    ...
    fadvise(lVar5,2);
    iVar2 = sha224_stream(lVar5,binary);
    if (iVar2 == 0) {
  ...
  while( true ) {
    ...
    if (iVar7 < 0x62) {
      if (iVar7 == -0x83) {
        ...
        version_etc(_stdout,"sha224sum","GNU coreutils",_Version,uVar10,uVar9,uVar8,0);
                    /* WARNING: Subroutine does not return */
        exit(0);
      }
      if (iVar7 == -0x82) {
...
LAB_0010195c:
              ...
              while (pFVar16 = (FILE *)__stream,
                ...
                iVar7 = strncmp((char *)pFVar12,"SHA224",6);

...
LAB_00100365:
  ...
  uVar14 = uVar17;
  bVar26 = bVar6;
  if ((uVar21 + local_c0 <= argsize) && (iVar10 = memcmp(__s1,local_90,local_c0), iVar10 == 0)) {
    if (!bVar22) {
      bVar18 = *__s1;
      uVar20 = (ulong)bVar18;
      bVar24 = bVar6;
...
LAB_0010117d:
        if (!bVar4) goto switchD_00100b4a_caseD_21;
        bVar23 = false;
        bVar18 = 0x5c;
        goto LAB_001003d6;
      }
...
LAB_001015f9:
  ...
  goto LAB_00100160;
LAB_00101094:
  bVar27 = local_dc == shell_always_quoting_style;
  bVar23 = uVar17 == 0;
  if (bVar23 && bVar27) {
    if (bVar22) {
LAB_00100629:
...
LAB_0010089a:
  ...
  uVar21 = uVar17;
  if (((local_90 != (char *)0x0) && (bVar22)) && (cVar15 = *local_90, cVar15 != '\0')) {
    do {
...

{
  ...
  if (buffersize <= sVar4) {
    ...
    quotearg_buffer_restyled
              (buffer,sVar4,arg,argsize,quoting_style,flags,options->quote_these_too,
               options->left_quote,options->right_quote);
  }
  *piVar2 = iVar1;
...

{
  ...
  sVar3 = quotearg_buffer_restyled
                    ((char *)0x0,0,arg,argsize,o->style,flags,o->quote_these_too,o->left_quote,
                     o->right_quote);
  buffer = (char *)xcharalloc(sVar3 + 1);
  quotearg_buffer_restyled
            (buffer,sVar3 + 1,arg,argsize,o->style,flags,o->quote_these_too,o->left_quote,
             o->right_quote);
  *piVar2 = iVar1;
  if (size != (size_t *)0x0) {
    *size = sVar3;
...

{
  ...
  options.quote_these_too[(byte)ch >> 5] =
       (uint)((uVar1 >> ((byte)ch & 0x1f) & 1) == 0) << (sbyte)((byte)ch & 0x1f) ^ uVar1;
...
char * quotearg_n_custom_mem(int n,char *left_quote,char *right_quote,char *arg,size_t argsize)

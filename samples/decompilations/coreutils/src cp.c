...
void decode_preserve_arg(char *arg,cp_options *x,_Bool on_off)

{
  ...
  lVar2 = __xargmatch_internal
                    (pcVar3,__s,decode_preserve_arg::preserve_args,
                     decode_preserve_arg::preserve_vals,4,_argmatch_die);
  if (decode_preserve_arg::preserve_vals[lVar2] < (PRESERVE_ALL|PRESERVE_TIMESTAMPS)) {
    ...
    (*(code *)(&DAT_00101d60 +
              *(int *)(&DAT_00101d60 + (ulong)decode_preserve_arg::preserve_vals[lVar2] * 4)))();
    return;
  }
  ...
  *attr_list = (dir_attr *)0x0;
  ...
  if (src_offset < uVar11) {
    ...
    *(undefined8 *)((long)ppcVar22 + lVar5 + -8) = 0x1002b3;
    local_180 = __memcpy_chk((ulong)((long)ppcVar22 + lVar5 + 0xf) & 0xfffffffffffffff0,const_dir,
                             sVar12 + 1,sVar12 + 1);
    puVar21 = (undefined1 *)((long)ppcVar22 + lVar5);
    while (puVar24 !=
           (undefined1 *)((long)ppcVar22 + (lVar5 - (uVar11 + 0x18 & 0xfffffffffffff000)))) {
...
LAB_001007a9:
        *(undefined8 *)(puVar25 + lVar5 + -8) = 0x1007b3;
      ...
      *local_188 = false;
      ...
      while( true ) {
        ...
        *(undefined8 *)(puVar25 + lVar5 + -8) = 0x1003e0;
        iVar8 = fstatat(local_16c,pcVar26,(stat *)local_190,0);
        if (((iVar8 != 0) || (x->preserve_ownership != false)) ||
           (sVar1._0_1_ = x->preserve_mode, sVar1._1_1_ = x->preserve_timestamps, sVar1 != 0)) {
...
LAB_001004cc:
          *(undefined8 *)(puVar25 + lVar5 + -8) = 0x1004d6;
          ...
          (pdVar16->st).__glibc_reserved[0] = src_st.__glibc_reserved[0];
          (pdVar16->st).__glibc_reserved[1] = src_st.__glibc_reserved[1];
          (pdVar16->st).__glibc_reserved[2] = src_st.__glibc_reserved[2];
...
LAB_0010064c:
                  if ((~stats.st_mode & 0x1c0) == 0) goto LAB_00100667;
                }
                else {
...
LAB_00100404:
        *(undefined8 *)(puVar25 + lVar5 + -8) = 0x10041e;
...
_Bool re_protect(char *const_dst_name,char *dst_src_name,int dst_dirfd,char *dst_relname,
                dir_attr *attr_list,cp_options *x)

{
  ...
  *(undefined8 *)((long)pptVar15 + lVar4 + -8) = 0x100937;
  lVar10 = __memcpy_chk((ulong)((long)pptVar15 + lVar4 + 0xf) & 0xfffffffffffffff0,const_dst_name,
                        sVar9 + 1);
...
LAB_00100ac8:
        *(undefined8 *)((long)pptVar15 + lVar4 + -8) = 0x100acf;
...
LAB_0010146e:
        ...
        if (((((local_108->unlink_dest_after_failed_open != false) &&
              (local_108->backup_type != no_backups)) &&
             (iVar7 = strcmp((char *)pEVar3,(char *)pEVar11), iVar7 == 0)) &&
            ((_Var6 == false &&
             ((sb.st_mode != 0 || (iVar7 = stat((char *)pEVar11,(stat *)&sb), iVar7 == 0)))))) &&
           (pcVar21 = local_108, (sb.st_mode & 0xf000) == 0x8000)) {
        ...
        do {
          ...
          if (parents_option == false) {
            ...
            *(undefined8 *)((long)ppcVar18 + -8) = 0x101558;
            ...
            for (puVar17 = (undefined1 *)ppcVar18;
                puVar17 != (undefined1 *)((long)ppcVar18 + -(sVar9 + 0x18 & 0xfffffffffffff000));
            ...
            *(undefined8 *)(puVar17 + lVar5 + -8) = 0x1015b8;
            pbVar12 = (byte *)__memcpy_chk((ulong)(puVar17 + lVar5 + 0xf) & 0xfffffffffffffff0,
                                           pcVar15,sVar9 + 1,sVar9 + 1);
            *(undefined8 *)(puVar17 + lVar5 + -8) = 0x1015c3;
            strip_trailing_slashes(pbVar12);
            uVar8 = *pbVar12 - 0x2e;
            if ((uVar8 == 0) && (uVar8 = pbVar12[1] - 0x2e, uVar8 == 0)) {
...
LAB_001015fc:
            ...
            *(undefined8 *)((long)ppcVar18 + -0x18) = 0x10164a;
            ...
            if (parents_option != false) {
              *(undefined8 *)((long)ppcVar18 + -8) = 0x101686;
              _Var6 = re_protect((char *)pEVar11,arg_in_concat,(int)local_110,local_118,attr_list,
                                 local_108);
              uVar25 = uVar25 & _Var6;
              goto LAB_00101413;
            }
            ...
            *(undefined8 *)(puVar17 + lVar5 + -8) = 0x101396;
            uVar10 = __memcpy_chk((ulong)(puVar17 + lVar5 + 0xf) & 0xfffffffffffffff0,pEVar3,
                                  sVar9 + 1);
            ...
            *(undefined8 *)(puVar17 + lVar5 + -0x18) = 0x1013fd;
            _Var6 = make_dir_parents_private
                              ((char *)pEVar11,(long)arg_in_concat - (long)pEVar11,(int)local_110,
                               pcVar15,&attr_list,&new_dst,*(cp_options **)(puVar17 + lVar5 + -0x10)
                              );
...
LAB_001018ad:
                    /* WARNING: Subroutine does not return */
      *(undefined8 *)((long)ppcVar20 + -8) = 0x1018b2;
      __stack_chk_fail();
    }
    if (target_directory == (char *)0x0) {
...
LAB_00104231:
    if (x.recursive == false) goto LAB_0010423c;
  }
  x.copy_as_regular = local_b1;
LAB_0010423c:
  if (local_c0 == (char *)0x0 && x.set_security_context == (selabel_handle *)0x0) {

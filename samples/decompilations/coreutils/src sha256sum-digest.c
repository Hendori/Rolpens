...

{
  ...
  *bin_result = '\0';
  ...
  if (uVar1 == 0) {
    ...
    fadvise(_stdin,2);
    iVar2 = sha256_stream(__stream,binary);
    if (iVar2 == 0) {
    ...
    fadvise(lVar5,2);
    iVar2 = sha256_stream(lVar5,binary);
    if (iVar2 == 0) {
  ...
  while( true ) {
    ...
    if (iVar7 < 0x62) {
      if (iVar7 == -0x83) {
        ...
        version_etc(_stdout,"sha256sum","GNU coreutils",_Version,uVar10,uVar9,uVar8,0);
                    /* WARNING: Subroutine does not return */
        exit(0);
      }
      if (iVar7 == -0x82) {
...
joined_r0x0010188a:
  ...
  if ((((ignore_missing != true) ||
       ...
       local_dd != 0)) &&
      ((status_only != true ||
       (pcVar26 = "the --status option is meaningful only when verifying checksums", local_dd != 0))
      )) && ((warn != true ||
             (pcVar26 = "the --warn option is meaningful only when verifying checksums",
             local_dd != 0)))) {
    bVar4 = quiet ^ 1U | local_dd;
    ...
    if (bVar4 == 0) {
      ...
      if (((local_dd ^ 1) & strict) == 0) {
        ...
        if (pFVar12 < pFVar16) {
          local_d8 = *(FILE **)pFVar12;
          if (local_dd != 0) {
            local_a0 = bin_buffer_unaligned + 3;
            local_91 = local_dd;
            local_90 = pFVar16;
            goto LAB_0010190b;
          }
          local_f8 = (FILE *)&missing;
          puVar31 = (uint *)(ulong)(uint)bVar4;
          puVar24 = &_LC73;
          __stream = (char *)local_d8;
          pFVar33 = pFVar12;
          do {
            _Var5 = digest_file(__stream,(int *)bin_buffer_unaligned,(uchar *)local_f8,
...
LAB_0010179f:
                ...
                print_filename(__stream,SUB41(local_dc,0));
              }
              else {
...
LAB_001018b1:
        ...
        if (have_read_stdin != false) {
          local_f8 = (FILE *)CONCAT71(local_f8._1_7_,(char)uVar29);
...
LAB_0010201b:
            ...
            if (local_b8 == (FILE *)digest_hex_bytes) {
              uVar29 = (ulong)local_b8 >> 1;
              if (uVar29 != 0) {
                uVar21 = 0;
                do {
                  ...
                  if ((int)(char)bin2hex_0[*(byte *)((long)local_d0 + uVar21) >> 4] != uVar23) {
LAB_00102180:
                  ...
                  if ((int)(char)bin2hex_0[*(byte *)((long)local_d0 + uVar21) & 0xf] != uVar23)
                  goto LAB_00102180;
                  uVar21 = uVar21 + 1;
                } while (uVar29 != uVar21);
              }
              local_92 = status_only;
              if ((status_only != false) || (local_92 = quiet, quiet != false)) goto LAB_00101caa;
              local_92 = (char)length;
              if ((int)poVar32 != 0) goto LAB_001021bd;
              local_e8 = (FILE *)((ulong)length & 0xff);
...
LAB_00101cf3:
                if (-1 < iVar7) {
                  puVar24 = (undefined1 *)quotearg_n_style_colon(0,3,local_d8);
                  puVar22 = &_LC4;
...
LAB_00101d4b:
                    if (local_c0 == (FILE *)0x0 && local_c8 == (FILE *)0x0) {
                      bVar28 = strict ^ 1U | local_a8 == (FILE *)0x0;
                      goto LAB_00101d6f;
                    }
                  }
                  else {
...
LAB_0010243d:
              ...
              while( true ) {
                local_91 = local_91 & bVar28;
                pFVar33 = (FILE *)&pFVar12->_IO_read_ptr;
                if (local_90 <= pFVar33) {
                  uVar29 = (ulong)local_91;
                  goto LAB_001018b1;
                }
                local_d8 = *(FILE **)pFVar33;
                pFVar12 = pFVar33;
LAB_0010190b:
                local_d0 = (int *)((ulong)local_a0 & 0xfffffffffffffffc);
...
LAB_0010195c:
              ...
              local_a8 = (FILE *)0x0;
              pFVar33 = local_f8;
              local_f0 = (FILE *)puVar31;
              local_b0 = pFVar12;
              while (pFVar16 = (FILE *)__stream,
                    _Var13 = __getdelim((char **)local_f8,(size_t *)local_f0,10,(FILE *)__stream),
                ...
                iVar7 = strncmp((char *)pFVar12,"SHA256",6);
                ...
                if (cVar6 == '(') {
                  ...
                  if ((FILE *)poVar32 != (FILE *)0x0) {
                    ...
                    if ((*pcVar30 == ')') &&
                       ((bVar34 = (char)local_e8 == '\0', bVar34 ||
                        (pcVar19 = filename_unescape((char *)pFVar16,(size_t)pcVar26),
                        local_e8 = pFVar16, pcVar19 != (char *)0x0)))) {
                      *pcVar30 = '\0';
...
LAB_00101aa3:
                if (warn != false) {
                  poVar32 = (option *)quotearg_n_style_colon(0,3,local_d8);
                  ...
                  if ((cVar6 == '\\') + min_digest_line_length <=
                    ...
                    if ((FILE *)poVar32 != pFVar33) {
                      *(_Bool *)&pFVar27->_flags = false;
                      local_b8 = (FILE *)digest_hex_bytes;
...
LAB_0010223a:
                          ...
                          if (((local_dc != 0) || (SUB41(pFVar16->_flags,0) != true)) ||
                            ...
                            _Var5 = digest_file((char *)pFVar16,local_d0,&missing_1,(_Bool *)pFVar16
                                                ,(uintmax_t *)length);

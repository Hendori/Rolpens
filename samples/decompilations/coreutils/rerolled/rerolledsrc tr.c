/* WARNING: Unknown calling convention */_Bool star_digits_closebracket(E_string *es, size_t idx) {
   char cVar1;
   _Bool *p_Var2;
   ulong uVar3;
   if (es.s[idx] != '*') {
...
/* WARNING: Unknown calling convention */_Bool is_char_class_member(Char_class char_class, uchar c) {
   undefined1 uVar1;
   undefined3 in_register_00000031;
   /* WARNING: Could not recover jumptable at 0x00100083. Too many branches */
   /* WARNING: Treating indirect jump as call */
   uVar1 = ( *(code*)( &DAT_00103cb0 + *(int*)( &DAT_00103cb0 + (ulong)char_class * 4 ) ) )((ulong)char_class, CONCAT31(in_register_00000031, c));
   return (_Bool)uVar1;
}
/* WARNING: Unknown calling convention */int get_next(Spec_list *s, Upper_Lower_class *class) {
   count cVar1;
   int iVar2;
   List_element *pLVar3;
   cVar1 = s.state;
...
/* WARNING: Unknown calling convention */char *make_printable_char(uchar c) {
   uchar *puVar1;
   ushort **ppuVar2;
...
/* WARNING: Unknown calling convention */char *make_printable_str(char *s, size_t len) {
   byte bVar1;
   long lVar2;
   char *pcVar3;
   char *__dest;
   ...
   if (len != 0) {
      ...
      do {
         ...
         if ((char)bVar1 < '\x0e') {
            if ((char)bVar1 < '\a') {
               LAB_001005f1:ppuVar4 = __ctype_b_loc();
...
/* WARNING: Unknown calling convention */void get_spec_stats(Spec_list *s) {
   List_element *pLVar1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* WARNING: Unknown calling convention -- yet parameter storage is locked */void write_error(void) {
   int iVar1;
   int *piVar2;
   undefined8 uVar3;
...
/* WARNING: Unknown calling convention */void set_initialize(Spec_list *s, _Bool complement_this_set, _Bool *in_set) {
   _Bool *p_Var1;
   int iVar2;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* WARNING: Unknown calling convention */size_t plain_read(char *buf, size_t size) {
   size_t sVar1;
   ulong uVar2;
   ulong uVar3;
   size_t sVar4;
   ...
   do {
      ...
      do {
         if ((int)__n != (int)io_buf[uVar5]) {
            ...
            LAB_00100abf:__ptr = io_buf + uVar5;
            uVar3 = uVar5;
            LAB_00100ac6:do {
 ...
 while ( uVar5 < uVar2 );
            uVar7 = uVar5;
            if (uVar2 != uVar5) {
               LAB_00100b99:__n = uVar2 - uVar3;
               uVar5 = uVar7;
               if (__n != 0) {
                  LAB_00100c00:sVar4 = fwrite_unlocked(__ptr, 1, __n, _stdout);
                  uVar5 = uVar7;
                  if (sVar4 != __n) goto LAB_00100b35;
               }

               if (uVar2 <= uVar5) {
                  LAB_00100bd0:__n = 0x7fffffff;
                  break;
               }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void squeeze_filter(char *buf, size_t size, _func_size_t_char_ptr_size_t *reader) {
   ulong uVar1;
   ulong uVar2;
   size_t sVar3;
   ulong extraout_RAX;
   ...
   do {
      ...
      do {
         if ((int)__n != (int)io_buf[uVar4]) {
            ...
            LAB_00100abf:__ptr = io_buf + uVar4;
            uVar2 = uVar4;
            LAB_00100ac6:do {
 ...
 while ( uVar4 < uVar1 );
            uVar6 = uVar4;
            if (uVar1 != uVar4) {
               LAB_00100b99:__n = uVar1 - uVar2;
               uVar4 = uVar6;
               if (__n != 0) {
                  LAB_00100c00:sVar3 = fwrite_unlocked(__ptr, 1, __n, _stdout);
                  uVar4 = uVar6;
            ...
            LAB_00100b80:bVar5 = in_squeeze_set[uVar6 + 0xff];
            uVar4 = uVar6 - 1;
            if (in_squeeze_set[bVar5] == false) goto LAB_00100b99;
            LAB_00100af5:__n = uVar4 - uVar2;
...
/* WARNING: Unknown calling convention */size_t read_and_xlate(char *buf, size_t size) {
   size_t sVar1;
   ulong uVar2;
   undefined8 uVar3;
   int *piVar4;
...
/* WARNING: Unknown calling convention */size_t read_and_delete(char *buf, size_t size) {
   ulong uVar1;
   undefined8 uVar2;
   int *piVar3;
   ulong uVar4;
...
/* WARNING: Unknown calling convention */_Bool parse_str(char *s, Spec_list *spec_list) {
   uchar uVar1;
   byte c;
   long lVar2;
   List_element *pLVar3;
         ...
         do {
            ...
            if (( bVar21 == 0x5b ) && ( __ptr[uVar25] == false )) {
               if (( ( uVar1 != ':' ) && ( uVar1 != '=' ) ) || ( __ptr[uVar26] != false )) {
                  LAB_00100efe:if (( pcVar10[uVar20] == '*' ) && ( __ptr[uVar20] == false )) {
                     for (uVar22 = uVar25 + 3; ( uVar22 < uVar18 && ( __ptr[uVar22] == false ) ); uVar22 = uVar22 + 1) {
                        if (pcVar10[uVar22] == ']') {
                           len = ( uVar22 - uVar26 ) - 2;
                           if (len == 0) {
                              repeat_count = 0;
                              ...
                              iVar8 = xstrtoumax(pcVar13, &d_end, ( *pcVar13 != '0' ) * '\x02' + '\b', &repeat_count, 0);
                              if (( ( iVar8 != 0 ) || ( repeat_count == 0xffffffffffffffff ) ) || ( d_end != pcVar13 + len )) {
 ...
 while ( ( ( ( pcVar10[uVar4] != uVar1 ) || ( pcVar10[uVar4 + 1] != ']' ) ) || ( __ptr[uVar4] != false ) ) || ( __ptr[uVar4 + 1] != false ) );
               ...
               if (uVar1 == ':') {
                  ...
                  do {
                     ...
                     if (( iVar8 == 0 ) && ( sVar12 = sVar9 == sVar12 )) {
                        pLVar11 = (List_element*)xmalloc(0x20);
                        pLVar11.next = (List_element*)0x0;
                        pLVar3 = spec_list.tail;
 ...
 while ( lVar24 != 0xc );
                  ...
                  if (!_Var6) {
                     ...
                     LAB_0010138b:uVar14 = dcgettext(0, pcVar13, 5);
                     LAB_001011d0:/* WARNING: Subroutine does not return */error(0, 0, uVar14, pcVar10);
                  }
               ...
               LAB_001012a2:uVar26 = uVar4 + 2;
               LAB_00100fea:spec_list.tail = pLVar11;
               LAB_00100ebc:uVar20 = uVar26 + 2;
               uVar25 = uVar26;
            }
 else {
               LAB_00100e78:if (( uVar1 != '-' ) || ( __ptr[uVar26] != false )) {
                  pLVar11 = (List_element*)xmalloc(0x20);
                  pLVar11.next = (List_element*)0x0;
                  pLVar3 = spec_list.tail;
               ...
               if (c < bVar21) {
                  ...
                  uVar14 = dcgettext(0, "range-endpoints of \'%s-%s\' are in reverse collating sequence order", 5);
                  /* WARNING: Subroutine does not return */
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* WARNING: Unknown calling convention */void usage(int status) {
   ...
   pFVar1 = _stdout;
   pcVar4 = (char*)dcgettext(0, "Translate, squeeze, and/or delete characters from standard input,\nwriting to standard output.  STRING1 and STRING2 specify arrays of\ncharacters ARRAY1 and ARRAY2 that control the action.\n\n  -c, -C, --complement    use the complement of ARRAY1\n  -d, --delete            delete characters in ARRAY1, do not translate\n  -s, --squeeze-repeats   replace each sequence of a repeated character\n                            that is listed in the last specified ARRAY,\n                            with a single occurrence of that character\n  -t, --truncate-set1     first truncate ARRAY1 to length of ARRAY2\n", 5);
   ...
   fputs_unlocked(pcVar4, pFVar1);
   pFVar1 = _stdout;
   pcVar4 = (char*)dcgettext(0, "  \\v              vertical tab\n  CHAR1-CHAR2     all characters from CHAR1 to CHAR2 in ascending order\n  [CHAR*]         in ARRAY2, copies of CHAR until length of ARRAY1\n  [CHAR*REPEAT]   REPEAT copies of CHAR, REPEAT octal if starting with 0\n  [:alnum:]       all letters and digits\n  [:alpha:]       all letters\n  [:blank:]       all horizontal whitespace\n  [:cntrl:]       all control characters\n  [:digit:]       all digits\n", 5);
   fputs_unlocked(pcVar4, pFVar1);
   pFVar1 = _stdout;
   pcVar4 = (char*)dcgettext(0, "  [:graph:]       all printable characters, not including space\n  [:lower:]       all lower case letters\n  [:print:]       all printable characters, including space\n  [:punct:]       all punctuation characters\n  [:space:]       all horizontal or vertical whitespace\n  [:upper:]       all upper case letters\n  [:xdigit:]      all hexadecimal digits\n  [=CHAR=]        all characters which are equivalent to CHAR\n", 5);
   fputs_unlocked(pcVar4, pFVar1);
   pFVar1 = _stdout;
 ...
 while ( pcVar4 != (char*)0x0 );
   ...
   if (puVar7 == (undefined1*)0x0) {
      ...
      pcVar4 = setlocale(5, (char*)0x0);
      if (pcVar4 != (char*)0x0) {
         LAB_0010184c:iVar2 = strncmp(pcVar4, "en_", 3);
         pFVar1 = _stdout;
         if (iVar2 != 0) {
   ...
   LAB_001015e9:/* WARNING: Subroutine does not return */exit(status);
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* WARNING: Unknown calling convention */int main(int argc, char **argv) {
      ...
      if (iVar58 != 99) {
         if (99 < iVar58) {
            if (iVar58 == 0x73) {
               ...
               if (iVar58 != 100) {
                  LAB_00105866:/* WARNING: Subroutine does not return */usage(1);
               }
 ...
 while ( true );
   ...
   if (iVar58 == 2) {
      ...
      if (iVar59 < iVar58) {
         LAB_001057fb:uVar61 = quote(argv[iVar59 + _optind]);
         uVar68 = dcgettext(0, "extra operand %s", 5);
         /* WARNING: Subroutine does not return */
         error(0, 0, uVar68, uVar61);
      }

      LAB_001052e6:buf1.head = (List_element*)xmalloc();
      ( buf1.head ).next = (List_element*)0x0;
      buf1.tail = buf1.head;
      _Var57 = parse_str(argv[_optind], &buf1);
      if (_Var57) {
...
;
         ...
         if (( cVar65 < uVar72 ) || ( spec_list.n_indefinite_repeats != 1 )) {
            ...
            if (bVar74) {
               LAB_001053bc:pcVar71 = "the [c*] construct may appear in string2 only when translating";
               buf1.tail = pLVar56;
               goto LAB_001053c8;
            }
         ...
         buf1.tail = pLVar56;
         if (( spec_list.has_equiv_class != false ) || ( pcVar71 = "when translating, the only character classes that may appear in\nstring2 are \'upper\' and \'lower\'" ),spec_list.has_restricted_char_class != false) goto LAB_001053c8;
         ...
         if (_Var57 == false) {
            ...
            if ((_Bool)cVar76 != false) {
               ...
               do {
                  ...
                  lVar147 = lVar147 + ( SUB168(auVar126 & __LC19, 0) - CONCAT44(-(uint)(uVar29 != 0), uVar78) ) + ( SUB168(auVar155 & __LC19, 0) - CONCAT44(-(uint)(uVar27 != 0), uVar159) );
                  lVar148 = lVar148 + ( SUB168(auVar126 & __LC19, 8) - auVar157._8_8_ ) + ( SUB168(auVar155 & __LC19, 8) - auVar125._8_8_ );
                  puVar3 = (ushort*)( (long)*ppuVar66 + lVar73 );
                  lVar73 = lVar73 + 0x10;
                  ...
                  lVar145 = lVar145 + ( SUB168(auVar129 & __LC19, 0) - CONCAT44(-(uint)(uVar29 != 0), uVar78) ) + ( SUB168(auVar156 & __LC19, 0) - CONCAT44(-(uint)(uVar27 != 0), uVar160) );
                  lVar146 = lVar146 + ( SUB168(auVar129 & __LC19, 8) - auVar158._8_8_ ) + ( SUB168(auVar156 & __LC19, 8) - auVar128._8_8_ );
               }
 while ( lVar73 != 0x200 );
               ...
               do {
                  ...
                  if (cVar76 == '\0') {
                     if (class_s2 != UL_NONE) {
                        LAB_00105bd2:buf1.state = 0xffffffffffffffff;
 ...
 while ( ( iVar59 != -1 ) && ( iVar60 != -1 ) );
               if (( cVar65 < buf1.length ) || ( uVar72 < spec_list.length )) {
                  /* WARNING: Subroutine does not return */
                  __assert_fail("old_s1_len >= s1->length && old_s2_len >= s2->length", "src/tr.c", 0x4c0, "validate_case_classes");
               }
            ...
            if (( uVar72 < cVar65 ) && ( truncate_set1 == false )) {
               LAB_00105ced:if (uVar72 != 0) {
                  buf1.tail = pLVar56;
                  /* WARNING: Could not recover jumptable at 0x00105d0c. Too many branches */
                  /* WARNING: Treating indirect jump as call */
                  iVar58 = ( *(code*)( &DAT_00103e3c + *(int*)( &DAT_00103e3c + (ulong)spec_list.tail.type * 4 ) ) )();
                  return iVar58;
               }

               pcVar71 = "when not truncating set1, string2 must be non-empty";
               buf1.tail = pLVar56;
               LAB_001053c8:uVar61 = dcgettext(0, pcVar71, 5);
               /* WARNING: Subroutine does not return */
               error(1, 0, uVar61);
            }
 ...
 while ( iVar59 == iVar60 );
               ...
               pcVar71 = "when translating with complemented character classes,\nstring2 must map all characters in the domain to one";
               goto LAB_001053c8;
            }

         }

         LAB_0010547d:fadvise();
         auVar96 = __LC18;
               ...
               if (complement == false) {
                  ...
                  do {
                     ...
                     *p_Var69 = ( _Bool )(( 0 < sVar111 ) * ( sVar111 < 0x100 ) * auVar123[0] - ( 0xff < sVar111 ));
                     ...
                     p_Var69[0xe] = ( _Bool )(( 0 < sVar18 ) * ( sVar18 < 0x100 ) * auVar95[0xc] - ( 0xff < sVar18 ));
                     p_Var69[0xf] = ( _Bool )(( 0 < sVar19 ) * ( sVar19 < 0x100 ) * auVar95[0xe] - ( 0xff < sVar19 ));
                     p_Var69 = p_Var64;
                     auVar97 = auVar150;
                  }
 ...
 while ( lVar73 != 0x100 );
                        ...
                        LAB_001056bb:if (iVar58 == -1) goto LAB_00105d59;
                        if (iVar59 == -1) {
...
;
 ...
 while ( lVar73 != 0x100 );
                     LAB_00105745:buf1.state = 0xffffffffffffffff;
                     buf1.tail = ( buf1.tail ).next;
                     spec_list.tail = spec_list.tail.next;
 ...
 while ( sVar63 == sVar62 );
         ...
         LAB_001054c8:iVar58 = close(0);
         if (iVar58 != 0) {
            LAB_00106023:uVar61 = dcgettext(0, "standard input", 5);
   ...
   LAB_001057f1:iVar58 = 1;
   LAB_001054d7:if (lVar2 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* WARNING: Unknown calling convention */void sm3_init_ctx(sm3_ctx *ctx) {
   undefined8 uVar1;
   undefined8 uVar2;
   uVar2 = _UNK_00102f68;
   uVar1 = __LC0;
...
/* WARNING: Unknown calling convention */void *sm3_read_ctx(sm3_ctx *ctx, void *resbuf) {
   uint uVar1;
   long lVar2;
   lVar2 = 0;
   do {
      uVar1 = *(uint*)( (long)ctx.state + lVar2 );
      *(uint*)( (long)resbuf + lVar2 ) = uVar1 >> 0x18 | ( uVar1 & 0xff0000 ) >> 8 | ( uVar1 & 0xff00 ) << 8 | uVar1 << 0x18;
      lVar2 = lVar2 + 4;
   }
 while ( lVar2 != 0x20 );
   return resbuf;
}
/* WARNING: Unknown calling convention */void sm3_process_block(void *buffer, size_t len, sm3_ctx *ctx) {
   uint32_t uVar1;
   long lVar2;
   long lVar3;
   uint uVar4;
   ...
   if (buffer < pvVar9) {
      do {
         ...
         do {
            ...
            *(uint*)( (long)x + lVar3 ) = uVar6 >> 0x18 | ( uVar6 & 0xff0000 ) >> 8 | ( uVar6 & 0xff00 ) << 8 | uVar6 << 0x18;
            lVar3 = lVar3 + 4;
         }
 while ( lVar3 != 0x40 );
         ...
         uVar34 = ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( x[3] << 7 | x[3] >> 0x19 ) ^ x[10] ^ uVar6 ^ ( uVar6 >> 9 | uVar6 << 0x17 );
         ...
         uVar27 = ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( x[4] << 7 | x[4] >> 0x19 ) ^ x[0xb] ^ uVar6 ^ ( uVar6 >> 9 | uVar6 << 0x17 );
         ...
         uVar31 = ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( x[5] << 7 | x[5] >> 0x19 ) ^ x[0xc] ^ uVar6 ^ ( uVar6 >> 9 | uVar6 << 0x17 );
         ...
         uVar25 = ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( x[6] << 7 | x[6] >> 0x19 ) ^ x[0xd] ^ uVar6 ^ ( uVar6 >> 9 | uVar6 << 0x17 );
         ...
         uVar32 = ( uVar17 << 0xf | uVar17 >> 0x11 ) ^ ( x[7] << 7 | x[7] >> 0x19 ) ^ x[0xe] ^ uVar17 ^ ( uVar17 >> 9 | uVar17 << 0x17 );
         uVar24 = ( uVar4 ^ uVar6 ) + ( uVar32 ^ uVar34 ) + uVar11 + ( uVar8 & uVar12 | ( uVar8 | uVar12 ) & uVar5 );
         ...
         uVar6 = uVar6 * 0x80 | uVar6 >> 0x19;
         uVar26 = ( uVar11 << 0xf | uVar11 >> 0x11 ) ^ ( x[8] << 7 | x[8] >> 0x19 ) ^ x[0xf] ^ uVar11 ^ ( uVar11 >> 9 | uVar11 << 0x17 );
         uVar14 = ( uVar8 ^ uVar6 ) + ( uVar26 ^ uVar27 ) + uVar12 + ( uVar5 & uVar13 | ( uVar5 | uVar13 ) & uVar24 );
         ...
         uVar15 = ( uVar6 >> 9 | uVar6 << 0x17 ) ^ ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( x[9] << 7 | x[9] >> 0x19 ) ^ uVar34 ^ uVar6;
         uVar7 = ( uVar5 ^ uVar11 ) + ( uVar31 ^ uVar15 ) + uVar13 + ( uVar24 & uVar8 | ( uVar24 | uVar8 ) & uVar14 );
         ...
         uVar24 = ( uVar6 >> 9 | uVar6 << 0x17 ) ^ ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( x[10] << 7 | x[10] >> 0x19 ) ^ uVar27 ^ uVar6;
         uVar22 = ( uVar5 ^ uVar17 ) + ( uVar25 ^ uVar24 ) + uVar8 + ( uVar14 & uVar28 | ( uVar14 | uVar28 ) & uVar7 );
         ...
         uVar21 = ( uVar6 >> 9 | uVar6 << 0x17 ) ^ ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( x[0xb] << 7 | x[0xb] >> 0x19 ) ^ uVar31 ^ uVar6;
         uVar12 = ( uVar10 ^ uVar17 ) + ( uVar32 ^ uVar21 ) + uVar28 + ( uVar7 & uVar23 | ( uVar7 | uVar23 ) & uVar22 );
         ...
         uVar14 = ( uVar6 >> 9 | uVar6 << 0x17 ) ^ ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( x[0xc] << 7 | x[0xc] >> 0x19 ) ^ uVar25 ^ uVar6;
         uVar17 = ( uVar4 ^ uVar28 ) + ( uVar26 ^ uVar14 ) + uVar23 + ( uVar22 & uVar8 | ( uVar22 | uVar8 ) & uVar12 );
         uVar13 = uVar5 >> 0xd | uVar5 << 0x13;
         ...
         uVar22 = ( uVar6 >> 9 | uVar6 << 0x17 ) ^ ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( x[0xd] << 7 | x[0xd] >> 0x19 ) ^ uVar32 ^ uVar6;
         uVar11 = uVar12 * 0x200 | uVar12 >> 0x17;
         uVar18 = ( uVar5 ^ uVar23 ) + ( uVar15 ^ uVar22 ) + uVar8 + ( uVar12 & uVar29 | ( uVar12 | uVar29 ) & uVar17 );
         uVar12 = uVar10 >> 0xd | uVar10 << 0x13;
         ...
         uVar23 = ( uVar6 >> 9 | uVar6 << 0x17 ) ^ ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( x[0xe] << 7 | x[0xe] >> 0x19 ) ^ uVar26 ^ uVar6;
         uVar7 = uVar17 * 0x200 | uVar17 >> 0x17;
         uVar29 = ( uVar10 ^ uVar8 ) + ( uVar24 ^ uVar23 ) + uVar29 + ( uVar17 & uVar11 | ( uVar17 | uVar11 ) & uVar18 );
         ...
         uVar6 = uVar6 * 0x80 | uVar6 >> 0x19;
         uVar28 = ( uVar4 >> 9 | uVar4 << 0x17 ) ^ ( uVar4 << 0xf | uVar4 >> 0x11 ) ^ ( x[0xf] << 7 | x[0xf] >> 0x19 ) ^ uVar15 ^ uVar4;
         uVar8 = uVar5 >> 0xd | uVar5 << 0x13;
         uVar11 = ( uVar13 ^ uVar6 ) + ( uVar21 ^ uVar28 ) + uVar11 + ( uVar18 & uVar7 | ( uVar18 | uVar7 ) & uVar29 );
         ...
         uVar18 = ( uVar6 >> 9 | uVar6 << 0x17 ) ^ ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( uVar34 << 7 | uVar34 >> 0x19 ) ^ uVar24 ^ uVar6;
         uVar16 = uVar29 * 0x200 | uVar29 >> 0x17;
         uVar19 = ( uVar13 ^ uVar5 ) + ( uVar14 ^ uVar18 ) + uVar7 + ( uVar29 & uVar30 | ( uVar29 | uVar30 ) & uVar11 );
         ...
         uVar29 = ( uVar6 >> 9 | uVar6 << 0x17 ) ^ ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( uVar27 << 7 | uVar27 >> 0x19 ) ^ uVar21 ^ uVar6;
         uVar12 = uVar11 * 0x200 | uVar11 >> 0x17;
         uVar13 = uVar4 >> 0xd | uVar4 << 0x13;
         uVar30 = ( uVar10 ^ uVar17 ) + ( uVar22 ^ uVar29 ) + uVar30 + ( uVar11 & uVar16 | ( uVar11 | uVar16 ) & uVar19 );
         ...
         uVar6 = uVar6 * 0x80 | uVar6 >> 0x19;
         uVar33 = ( uVar4 << 0xf | uVar4 >> 0x11 ) ^ ( uVar31 << 7 | uVar31 >> 0x19 ) ^ uVar14 ^ uVar4 ^ ( uVar4 >> 9 | uVar4 << 0x17 );
         uVar20 = uVar19 * 0x200 | uVar19 >> 0x17;
         uVar11 = ( uVar8 ^ uVar6 ) + ( uVar23 ^ uVar33 ) + uVar16 + ( uVar19 & uVar12 | ( uVar19 | uVar12 ) & uVar30 );
         uVar8 = uVar5 >> 0xd | uVar5 << 0x13;
         ...
         uVar6 = uVar6 * 0x80 | uVar6 >> 0x19;
         uVar7 = ( uVar5 >> 9 | uVar5 << 0x17 ) ^ ( uVar5 << 0xf | uVar5 >> 0x11 ) ^ ( uVar25 << 7 | uVar25 >> 0x19 ) ^ uVar22 ^ uVar5;
         uVar19 = uVar30 * 0x200 | uVar30 >> 0x17;
         uVar12 = ( uVar4 ^ uVar6 ) + ( uVar28 ^ uVar7 ) + uVar12 + ( uVar30 & uVar20 | ( uVar30 | uVar20 ) & uVar11 );
         uVar4 = uVar10 >> 0xd | uVar10 << 0x13;
         uVar5 = uVar27 ^ uVar21 ^ ( uVar29 << 0xf | uVar29 >> 0x11 );
         uVar10 = ( ( uVar10 ^ uVar8 ) & uVar17 ^ uVar8 ) + uVar13 + uVar28 + uVar6;
         uVar35 = ( uVar5 >> 9 | uVar5 << 0x17 ) ^ ( uVar5 << 0xf | uVar5 >> 0x11 ) ^ ( uVar32 << 7 | uVar32 >> 0x19 ) ^ uVar23 ^ uVar5;
         uVar10 = uVar10 ^ ( uVar10 * 0x200 | uVar10 >> 0x17 ) ^ ( uVar10 >> 0xf | uVar10 * 0x20000 );
         uVar13 = uVar12 * 0x1000 | uVar12 >> 0x14;
         ...
         uVar11 = ( uVar13 ^ uVar6 ) + ( uVar18 ^ uVar35 ) + uVar20 + ( uVar11 & uVar19 | ( uVar11 | uVar19 ) & uVar12 );
         ...
         uVar31 = ( uVar6 >> 9 | uVar6 << 0x17 ) ^ ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( uVar26 << 7 | uVar26 >> 0x19 ) ^ uVar28 ^ uVar6;
         uVar27 = uVar12 * 0x200 | uVar12 >> 0x17;
         uVar13 = uVar10 >> 0xd | uVar10 << 0x13;
         uVar17 = ( uVar8 ^ uVar20 ) + ( uVar29 ^ uVar31 ) + uVar19 + ( uVar12 & uVar30 | ( uVar12 | uVar30 ) & uVar11 );
         ...
         uVar20 = ( uVar6 >> 9 | uVar6 << 0x17 ) ^ ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( uVar15 << 7 | uVar15 >> 0x19 ) ^ uVar18 ^ uVar6;
         uVar12 = uVar11 * 0x200 | uVar11 >> 0x17;
         uVar8 = uVar5 >> 0xd | uVar5 << 0x13;
         uVar25 = ( uVar4 ^ uVar19 ) + ( uVar20 ^ uVar33 ) + uVar30 + ( uVar11 & uVar27 | ( uVar11 | uVar27 ) & uVar17 );
         ...
         uVar30 = ( uVar6 >> 9 | uVar6 << 0x17 ) ^ ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( uVar24 << 7 | uVar24 >> 0x19 ) ^ uVar29 ^ uVar6;
         uVar11 = uVar17 * 0x200 | uVar17 >> 0x17;
         uVar17 = ( uVar4 ^ uVar16 ) + ( uVar7 ^ uVar30 ) + uVar27 + ( uVar17 & uVar12 | ( uVar17 | uVar12 ) & uVar25 );
         uVar4 = uVar10 >> 0xd | uVar10 << 0x13;
         ...
         uVar19 = ( uVar6 >> 9 | uVar6 << 0x17 ) ^ ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( uVar21 << 7 | uVar21 >> 0x19 ) ^ uVar33 ^ uVar6;
         uVar27 = uVar25 * 0x200 | uVar25 >> 0x17;
         uVar16 = uVar5 >> 0xd | uVar5 << 0x13;
         uVar26 = ( uVar13 ^ uVar32 ) + ( uVar19 ^ uVar35 ) + uVar12 + ( uVar25 & uVar11 | ( uVar25 | uVar11 ) & uVar17 );
         ...
         uVar12 = ( uVar6 >> 9 | uVar6 << 0x17 ) ^ ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( uVar14 << 7 | uVar14 >> 0x19 ) ^ uVar7 ^ uVar6;
         uVar25 = uVar17 * 0x200 | uVar17 >> 0x17;
         uVar11 = ( uVar13 ^ uVar8 ) + ( uVar31 ^ uVar12 ) + uVar11 + ( uVar17 & uVar27 | ( uVar17 | uVar27 ) & uVar26 );
         uVar13 = uVar10 >> 0xd | uVar10 << 0x13;
         ...
         uVar15 = ( uVar6 >> 9 | uVar6 << 0x17 ) ^ ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( uVar22 << 7 | uVar22 >> 0x19 ) ^ uVar35 ^ uVar6;
         uVar32 = uVar26 * 0x200 | uVar26 >> 0x17;
         uVar8 = uVar5 >> 0xd | uVar5 << 0x13;
         uVar17 = ( uVar4 ^ uVar34 ) + ( uVar20 ^ uVar15 ) + uVar27 + ( uVar26 & uVar25 | ( uVar26 | uVar25 ) & uVar11 );
         ...
         uVar21 = ( uVar6 >> 9 | uVar6 << 0x17 ) ^ ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( uVar23 << 7 | uVar23 >> 0x19 ) ^ uVar31 ^ uVar6;
         uVar24 = uVar11 * 0x200 | uVar11 >> 0x17;
         uVar4 = uVar10 >> 0xd | uVar10 << 0x13;
         uVar25 = ( uVar16 ^ uVar27 ) + ( uVar30 ^ uVar21 ) + uVar25 + ( uVar11 & uVar32 | ( uVar11 | uVar32 ) & uVar17 );
         ...
         uVar16 = ( uVar6 >> 9 | uVar6 << 0x17 ) ^ ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( uVar28 << 7 | uVar28 >> 0x19 ) ^ uVar20 ^ uVar6;
         uVar11 = uVar17 * 0x200 | uVar17 >> 0x17;
         uVar14 = ( uVar13 ^ uVar27 ) + ( uVar19 ^ uVar16 ) + uVar32 + ( uVar17 & uVar24 | ( uVar17 | uVar24 ) & uVar25 );
         ...
         uVar36 = ( uVar6 >> 9 | uVar6 << 0x17 ) ^ ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( uVar18 << 7 | uVar18 >> 0x19 ) ^ uVar30 ^ uVar6;
         uVar27 = uVar25 * 0x200 | uVar25 >> 0x17;
         uVar24 = ( uVar13 ^ uVar8 ) + ( uVar12 ^ uVar36 ) + uVar24 + ( uVar25 & uVar11 | ( uVar25 | uVar11 ) & uVar14 );
         uVar13 = uVar10 >> 0xd | uVar10 << 0x13;
         ...
         uVar22 = ( uVar6 >> 9 | uVar6 << 0x17 ) ^ ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( uVar29 << 7 | uVar29 >> 0x19 ) ^ uVar19 ^ uVar6;
         uVar25 = uVar14 * 0x200 | uVar14 >> 0x17;
         uVar11 = ( uVar4 ^ uVar26 ) + ( uVar15 ^ uVar22 ) + uVar11 + ( uVar14 & uVar27 | ( uVar14 | uVar27 ) & uVar24 );
         uVar8 = uVar5 >> 0xd | uVar5 << 0x13;
         ...
         uVar23 = ( uVar6 >> 9 | uVar6 << 0x17 ) ^ ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( uVar33 << 7 | uVar33 >> 0x19 ) ^ uVar12 ^ uVar6;
         uVar26 = uVar24 * 0x200 | uVar24 >> 0x17;
         uVar17 = ( uVar4 ^ uVar14 ) + ( uVar21 ^ uVar23 ) + uVar27 + ( uVar24 & uVar25 | ( uVar24 | uVar25 ) & uVar11 );
         uVar4 = uVar10 >> 0xd | uVar10 << 0x13;
         ...
         uVar28 = ( uVar6 >> 9 | uVar6 << 0x17 ) ^ ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( uVar7 << 7 | uVar7 >> 0x19 ) ^ uVar15 ^ uVar6;
         uVar24 = uVar11 * 0x200 | uVar11 >> 0x17;
         uVar27 = ( uVar13 ^ uVar32 ) + ( uVar16 ^ uVar28 ) + uVar25 + ( uVar11 & uVar26 | ( uVar11 | uVar26 ) & uVar17 );
         ...
         uVar18 = ( uVar6 >> 9 | uVar6 << 0x17 ) ^ ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( uVar35 << 7 | uVar35 >> 0x19 ) ^ uVar21 ^ uVar6;
         uVar11 = uVar17 * 0x200 | uVar17 >> 0x17;
         uVar25 = ( uVar13 ^ uVar8 ) + ( uVar36 ^ uVar18 ) + uVar26 + ( uVar17 & uVar24 | ( uVar17 | uVar24 ) & uVar27 );
         uVar13 = uVar10 >> 0xd | uVar10 << 0x13;
         ...
         uVar6 = uVar6 * 0x80 | uVar6 >> 0x19;
         uVar34 = ( uVar17 >> 9 | uVar17 << 0x17 ) ^ ( uVar17 << 0xf | uVar17 >> 0x11 ) ^ ( uVar31 << 7 | uVar31 >> 0x19 ) ^ uVar16 ^ uVar17;
         uVar26 = uVar27 * 0x200 | uVar27 >> 0x17;
         uVar8 = uVar5 >> 0xd | uVar5 << 0x13;
         uVar17 = ( uVar4 ^ uVar6 ) + ( uVar22 ^ uVar34 ) + uVar24 + ( uVar27 & uVar11 | ( uVar27 | uVar11 ) & uVar25 );
         ...
         uVar29 = ( uVar6 >> 9 | uVar6 << 0x17 ) ^ ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( uVar20 << 7 | uVar20 >> 0x19 ) ^ uVar36 ^ uVar6;
         uVar27 = uVar25 * 0x200 | uVar25 >> 0x17;
         uVar25 = ( uVar4 ^ uVar14 ) + ( uVar23 ^ uVar29 ) + uVar11 + ( uVar25 & uVar26 | ( uVar25 | uVar26 ) & uVar17 );
         uVar4 = uVar10 >> 0xd | uVar10 << 0x13;
         ...
         uVar7 = ( uVar7 >> 9 | uVar7 << 0x17 ) ^ ( uVar7 << 0xf | uVar7 >> 0x11 ) ^ ( uVar30 << 7 | uVar30 >> 0x19 ) ^ uVar22 ^ uVar7;
         uVar14 = uVar17 * 0x200 | uVar17 >> 0x17;
         uVar11 = uVar5 >> 0xd | uVar5 << 0x13;
         uVar24 = ( uVar13 ^ uVar6 ) + ( uVar28 ^ uVar7 ) + uVar26 + ( uVar17 & uVar27 | ( uVar17 | uVar27 ) & uVar25 );
         ...
         uVar31 = ( uVar6 >> 9 | uVar6 << 0x17 ) ^ ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( uVar19 << 7 | uVar19 >> 0x19 ) ^ uVar23 ^ uVar6;
         uVar26 = uVar25 * 0x200 | uVar25 >> 0x17;
         uVar5 = uVar10 >> 0xd | uVar10 << 0x13;
         uVar17 = ( uVar8 ^ uVar32 ) + ( uVar18 ^ uVar31 ) + uVar27 + ( uVar25 & uVar14 | ( uVar25 | uVar14 ) & uVar24 );
         ...
         uVar25 = ( uVar6 >> 9 | uVar6 << 0x17 ) ^ ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( uVar12 << 7 | uVar12 >> 0x19 ) ^ uVar28 ^ uVar6;
         uVar20 = uVar24 * 0x200 | uVar24 >> 0x17;
         uVar6 = ( uVar8 ^ uVar10 ) + ( uVar25 ^ uVar34 ) + uVar14 + ( uVar24 & uVar26 | ( uVar24 | uVar26 ) & uVar17 );
         ...
         x[4] = ( uVar11 >> 9 | uVar11 << 0x17 ) ^ ( uVar11 << 0xf | uVar11 >> 0x11 ) ^ ( uVar15 << 7 | uVar15 >> 0x19 ) ^ uVar18 ^ uVar11;
         uVar11 = uVar17 * 0x200 | uVar17 >> 0x17;
         uVar27 = ( uVar13 ^ uVar10 ) + ( uVar29 ^ x[4] ) + uVar26 + ( uVar17 & uVar20 | ( uVar17 | uVar20 ) & uVar6 );
         uVar17 = uVar19 ^ uVar23 ^ ( uVar31 << 0xf | uVar31 >> 0x11 );
         uVar13 = uVar4 >> 0xd | uVar4 << 0x13;
         uVar4 = ( ( uVar4 ^ uVar8 ) & uVar14 ^ uVar8 ) + uVar5 + uVar29 + uVar10;
         x[5] = ( uVar17 >> 9 | uVar17 << 0x17 ) ^ ( uVar17 << 0xf | uVar17 >> 0x11 ) ^ ( uVar21 << 7 | uVar21 >> 0x19 ) ^ uVar34 ^ uVar17;
         uVar4 = uVar4 ^ ( uVar4 * 0x200 | uVar4 >> 0x17 ) ^ ( uVar4 >> 0xf | uVar4 * 0x20000 );
         uVar5 = uVar27 * 0x1000 | uVar27 >> 0x14;
         uVar10 = uVar5 + 0x3b14f50f + uVar4;
         uVar10 = uVar10 * 0x80 | uVar10 >> 0x19;
         uVar24 = uVar14 >> 0xd | uVar14 << 0x13;
         uVar30 = ( uVar5 ^ uVar10 ) + ( uVar7 ^ x[5] ) + uVar20 + ( uVar6 & uVar11 | ( uVar6 | uVar11 ) & uVar27 );
         ...
         x[6] = ( uVar10 >> 9 | uVar10 << 0x17 ) ^ ( uVar10 << 0xf | uVar10 >> 0x11 ) ^ ( uVar16 << 7 | uVar16 >> 0x19 ) ^ uVar29 ^ uVar10;
         uVar19 = uVar27 * 0x200 | uVar27 >> 0x17;
         uVar14 = ( uVar5 ^ uVar6 ) + ( uVar31 ^ x[6] ) + uVar11 + ( uVar27 & uVar17 | ( uVar27 | uVar17 ) & uVar30 );
         ...
         x[7] = ( uVar13 >> 9 | uVar13 << 0x17 ) ^ ( uVar13 << 0xf | uVar13 >> 0x11 ) ^ ( uVar36 << 7 | uVar36 >> 0x19 ) ^ uVar7 ^ uVar13;
         uVar15 = uVar30 * 0x200 | uVar30 >> 0x17;
         uVar17 = ( uVar4 ^ uVar6 ) + ( uVar25 ^ x[7] ) + uVar17 + ( uVar30 & uVar19 | ( uVar30 | uVar19 ) & uVar14 );
         ...
         x[8] = ( uVar8 >> 9 | uVar8 << 0x17 ) ^ ( uVar8 << 0xf | uVar8 >> 0x11 ) ^ ( uVar22 << 7 | uVar22 >> 0x19 ) ^ uVar31 ^ uVar8;
         uVar12 = uVar14 * 0x200 | uVar14 >> 0x17;
         uVar24 = ( uVar4 ^ uVar6 ) + ( x[4] ^ x[8] ) + uVar19 + ( uVar14 & uVar15 | ( uVar14 | uVar15 ) & uVar17 );
         uVar4 = uVar10 >> 0xd | uVar10 << 0x13;
         ...
         x[9] = ( uVar8 >> 9 | uVar8 << 0x17 ) ^ ( uVar8 << 0xf | uVar8 >> 0x11 ) ^ ( uVar23 << 7 | uVar23 >> 0x19 ) ^ uVar25 ^ uVar8;
         uVar8 = uVar17 * 0x200 | uVar17 >> 0x17;
         uVar14 = ( uVar5 ^ uVar6 ) + ( x[5] ^ x[9] ) + uVar15 + ( uVar17 & uVar12 | ( uVar17 | uVar12 ) & uVar24 );
         ...
         x[10] = ( uVar6 >> 9 | uVar6 << 0x17 ) ^ ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( uVar28 << 7 | uVar28 >> 0x19 ) ^ x[4] ^ uVar6;
         uVar15 = uVar24 * 0x200 | uVar24 >> 0x17;
         uVar13 = uVar10 >> 0xd | uVar10 << 0x13;
         uVar12 = ( uVar11 ^ uVar21 ) + ( x[6] ^ x[10] ) + uVar12 + ( uVar24 & uVar8 | ( uVar24 | uVar8 ) & uVar14 );
         ...
         x[0xb] = ( uVar4 >> 9 | uVar4 << 0x17 ) ^ ( uVar4 << 0xf | uVar4 >> 0x11 ) ^ ( uVar18 << 7 | uVar18 >> 0x19 ) ^ x[5] ^ uVar4;
         uVar22 = uVar14 * 0x200 | uVar14 >> 0x17;
         uVar14 = ( uVar11 ^ uVar6 ) + ( x[0xb] ^ x[7] ) + uVar8 + ( uVar14 & uVar15 | ( uVar14 | uVar15 ) & uVar12 );
         uVar8 = uVar5 >> 0xd | uVar5 << 0x13;
         ...
         x[0xc] = ( uVar4 >> 9 | uVar4 << 0x17 ) ^ ( uVar4 << 0xf | uVar4 >> 0x11 ) ^ ( uVar34 << 7 | uVar34 >> 0x19 ) ^ x[6] ^ uVar4;
         uVar24 = uVar12 * 0x200 | uVar12 >> 0x17;
         uVar4 = uVar10 >> 0xd | uVar10 << 0x13;
         uVar21 = ( uVar5 ^ uVar6 ) + ( x[8] ^ x[0xc] ) + uVar15 + ( uVar12 & uVar22 | ( uVar12 | uVar22 ) & uVar14 );
         ...
         x[0xd] = ( uVar6 >> 9 | uVar6 << 0x17 ) ^ ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( uVar29 << 7 | uVar29 >> 0x19 ) ^ x[7] ^ uVar6;
         uVar15 = uVar14 * 0x200 | uVar14 >> 0x17;
         uVar12 = uVar11 >> 0xd | uVar11 << 0x13;
         uVar17 = ( uVar13 ^ uVar5 ) + ( x[9] ^ x[0xd] ) + uVar22 + ( uVar14 & uVar24 | ( uVar14 | uVar24 ) & uVar21 );
         ...
         x[0xe] = ( uVar6 >> 9 | uVar6 << 0x17 ) ^ ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( uVar7 << 7 | uVar7 >> 0x19 ) ^ x[8] ^ uVar6;
         uVar22 = uVar21 * 0x200 | uVar21 >> 0x17;
         uVar13 = uVar10 >> 0xd | uVar10 << 0x13;
         uVar5 = ( uVar5 ^ uVar8 ) + ( x[10] ^ x[0xe] ) + uVar24 + ( uVar21 & uVar15 | ( uVar21 | uVar15 ) & uVar17 );
         ...
         x[0xf] = ( uVar6 >> 9 | uVar6 << 0x17 ) ^ ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( uVar31 << 7 | uVar31 >> 0x19 ) ^ x[9] ^ uVar6;
         uVar8 = uVar17 * 0x200 | uVar17 >> 0x17;
         uVar14 = uVar11 >> 0xd | uVar11 << 0x13;
         uVar15 = ( uVar10 ^ uVar4 ) + ( x[0xb] ^ x[0xf] ) + uVar15 + ( uVar17 & uVar22 | ( uVar17 | uVar22 ) & uVar5 );
         ...
         x[0] = ( uVar6 >> 9 | uVar6 << 0x17 ) ^ ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( uVar25 << 7 | uVar25 >> 0x19 ) ^ x[10] ^ uVar6;
         uVar4 = uVar5 * 0x200 | uVar5 >> 0x17;
         uVar11 = uVar24 >> 0xd | uVar24 << 0x13;
         uVar12 = ( uVar10 ^ uVar21 ) + ( x[0xc] ^ x[0] ) + uVar22 + ( uVar5 & uVar8 | ( uVar5 | uVar8 ) & uVar15 );
         ...
         uVar24 = uVar15 * 0x200 | uVar15 >> 0x17;
         x[1] = ( uVar6 >> 9 | uVar6 << 0x17 ) ^ ( uVar6 << 0xf | uVar6 >> 0x11 ) ^ ( x[4] << 7 | x[4] >> 0x19 ) ^ x[0xb] ^ uVar6;
         uVar6 = ( uVar10 ^ uVar13 ) + ( x[1] ^ x[0xd] ) + uVar8 + ( uVar15 & uVar4 | ( uVar15 | uVar4 ) & uVar12 );
         uVar7 = uVar17 >> 0xd | uVar17 << 0x13;
         ...
         x[2] = ( uVar10 >> 9 | uVar10 << 0x17 ) ^ ( uVar10 << 0xf | uVar10 >> 0x11 ) ^ ( x[5] << 7 | x[5] >> 0x19 ) ^ x[0xc] ^ uVar10;
         uVar14 = uVar12 * 0x200 | uVar12 >> 0x17;
         uVar8 = uVar5 >> 0xd | uVar5 << 0x13;
         uVar12 = ( uVar17 ^ uVar15 ) + ( x[2] ^ x[0xe] ) + uVar4 + ( uVar12 & uVar24 | ( uVar12 | uVar24 ) & uVar6 );
         ...
         x[3] = ( uVar4 >> 9 | uVar4 << 0x17 ) ^ ( uVar4 << 0xf | uVar4 >> 0x11 ) ^ ( x[6] << 7 | x[6] >> 0x19 ) ^ x[0xd] ^ uVar4;
         local_c8 = local_c8 ^ ( uVar5 ^ uVar17 ) + ( x[3] ^ x[0xf] ) + uVar24 + ( uVar6 & uVar14 | ( uVar6 | uVar14 ) & uVar12 );
         ...
         local_b0 = local_b0 ^ uVar4 ^ ( uVar4 * 0x200 | uVar4 >> 0x17 ) ^ ( uVar4 >> 0xf | uVar4 * 0x20000 );
...
/* WARNING: Unknown calling convention */void sm3_conclude_ctx(sm3_ctx *ctx) {
   ulong uVar1;
   uint uVar2;
   uint uVar3;
   uint uVar4;
   ...
   uVar4 = uVar3 * 8;
   uVar2 = uVar5 << 3;
   ctx.buffer[( -(ulong)(uVar1 < 0x38) & 0xfffffffffffffff0 ) + 0x1e] = uVar2 >> 0x18 | ( uVar2 & 0xff0000 ) >> 8 | ( uVar2 & 0xff00 ) << 8 | ( uVar3 >> 0x1d | uVar2 ) << 0x18;
   ctx.buffer[( -(ulong)(uVar1 < 0x38) & 0xfffffffffffffff0 ) + 0x1f] = uVar4 >> 0x18 | ( uVar4 & 0xff0000 ) >> 8 | ( uVar4 & 0xff00 ) << 8 | uVar3 * 0x8000000;
   memcpy((void*)( (long)ctx.buffer + uVar1 ), fillbuf, ( ( -(ulong)(uVar1 < 0x38) & 0xffffffffffffffc0 ) + 0x78 ) - uVar1);
   sm3_process_block(ctx.buffer, ( -(ulong)(uVar1 < 0x38) & 0xffffffffffffffc0 ) + 0x80, ctx);
   return;
}
/* WARNING: Unknown calling convention */void *sm3_finish_ctx(sm3_ctx *ctx, void *resbuf) {
   uint uVar1;
   long lVar2;
...
/* WARNING: Unknown calling convention */void sm3_process_bytes(void *buffer, size_t len, sm3_ctx *ctx) {
   uint32_t *puVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong uVar4;
         ...
         if (uVar3 < 8) {
            if (( uVar4 & 4 ) == 0) {
               if (( ( uVar4 & 0x3f ) != 0 ) && ( *(char*)ctx.buffer = (char)*puVar1(uVar4 & 2) != 0 )) {
                  *(undefined2*)( (long)ctx.buffer + ( uVar5 - 2 ) ) = *(undefined2*)( ( uVar5 - 2 ) + (long)puVar1 );
               }

            }
 else {
               ctx.buffer[0] = *puVar1;
               *(undefined4*)( (long)ctx.buffer + ( uVar5 - 4 ) ) = *(undefined4*)( ( uVar5 - 4 ) + (long)puVar1 );
            }
         ...
         if (len != 0x40) {
            ...
            do {
               ...
               *(undefined8*)( ctx.buffer + 2 ) = uVar2;
               for (int i = 0; i < 3; i++) {
                  uVar2 = puVar10[( 2*i + 3 )];
                  *(undefined8*)( ctx.buffer + ( 4*i + 4 ) ) = puVar10[( 2*i + 2 )];
                  *(undefined8*)( ctx.buffer + ( 4*i + 6 ) ) = uVar2;
               }
 ...
 while ( puVar8 != (undefined8*)( (long)buffer + ( uVar12 + 1 ) * 8 * 8 ) );
   ...
   LAB_00102c38:puVar11 = ctx.buffer;
   sVar9 = ctx.buflen;
   uVar3 = (uint)len;
   ...
   if (uVar3 < 8) {
      ...
      *puVar8 = *puVar10;
      *(undefined8*)( (long)puVar8 + ( ( len & 0xffffffff ) - 8 ) ) = *(undefined8*)( (long)puVar10 + ( ( len & 0xffffffff ) - 8 ) );
      ...
      if (7 < uVar3) {
         ...
         do {
            uVar6 = (int)uVar12 + 8;
            *(undefined8*)( ( ( ulong )(puVar8 + 1) & 0xfffffffffffffff8 ) + uVar12 ) = *(undefined8*)( (long)puVar10 + ( uVar12 - lVar7 ) );
            uVar12 = (ulong)uVar6;
         }
 while ( uVar6 < uVar3 );
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* WARNING: Unknown calling convention */void *sm3_buffer(char *buffer, size_t len, void *resblock) {
   uint uVar1;
   long lVar2;
   long lVar3;
   long in_FS_OFFSET;
   ...
   do {
      ...
      *(uint*)( (long)resblock + lVar3 ) = uVar1 >> 0x18 | ( uVar1 & 0xff0000 ) >> 8 | ( uVar1 & 0xff00 ) << 8 | uVar1 << 0x18;
      lVar3 = lVar3 + 4;
   }
 while ( lVar3 != 0x20 );
   if (lVar2 == *(long*)( in_FS_OFFSET + 0x28 )) {

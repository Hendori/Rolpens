      ...
      if (pkVar21.month == false) {
         if (pkVar21.random == false) {
            ...
            for (int i = 0; i < 3; i++) {
               ...
               buf[1][( 4*i + 30 )] = random_md5_state.CTX.data[( i + 12 )]._1_1_;
               buf[1][( 4*i + 31 )] = random_md5_state.CTX.data[( i + 12 )]._2_1_;
               buf[1][( 4*i + 32 )] = random_md5_state.CTX.data[( i + 12 )]._3_1_;
            }
   ...
   if (ntemps < local_128) {
      ...
      do {
         while (true) {
            ...
            if (( ( output_file == (char*)0x0 ) || ( iVar3 = iVar3 != 0 ) ) || ( uVar2 == 0 )) break;
...
;
 ...
 while ( pkVar22 != (keyfield*)0x0 );
      ...
      do if (cVar10 == '\0') switch (uVar21 & 0xffffffff) {
         case 1:

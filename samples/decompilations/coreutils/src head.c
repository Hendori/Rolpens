...
void diagnose_copy_fd_failure(Copy_fd_status err,char *filename)
...

{
  ...
  } while ((-1 < (long)n_bytes_00) &&
          (((uVar6 = uVar6 - n_bytes_00, n_bytes_00 != 0 || (uVar6 == 0)) &&
           (xwrite_stdout(acStack_2040,n_bytes_00), uVar6 != 0))));
...

{
  ...
  if (lines_to_write != 0) {
    do {
      ...
      do {
        n_bytes = sVar9 + 1;
        if ((buffer[sVar9] == line_end) &&
           (lines_to_write = lines_to_write - 1, lines_to_write == 0)) {
          lVar4 = n_bytes - lVar4;
          _Var5 = lseek(fd,lVar4,1);
          if ((_Var5 < 0) &&
             (((iVar3 = fstat(fd,(stat *)&st), iVar3 != 0 || ((st.st_mode & 0xf000) == 0x8000)) &&
              (_Var5 = lseek(fd,lVar4,1), _Var5 < 0)))) {
...

{
  ...
  if (_Var3 < 0) {
LAB_001007e8:
    elseek((int)__offset_00,0,(int)local_2050,filename);
    _Var2 = false;
  }
  else {
    ...
    if (-1 < (long)filename) {
      __c = (int)line_end;
      uVar9 = n_lines;
      if (((n_lines != 0) && (filename != (char *)0x0)) &&
         (filename[(long)&local_2050 + 7] != line_end)) {
        uVar9 = n_lines - 1;
      }
      do {
        uVar8 = uVar9;
...
LAB_00101a85:
      iVar3 = (int)pbVar9;
      if ((have_read_stdin == false) || (iVar5 = close(0), -1 < iVar5)) {
        if (lVar1 == *(long *)(in_FS_OFFSET + 0x28)) {
...
LAB_00101820:
  ...
  if ((local_130 == 0) && (local_130 = (uint)__file[1], local_130 == 0)) {
...
LAB_00101c26:
      ...
      if ((presume_input_pipe == false) && ((st.st_mode & 0xd000) == 0x8000)) {
        ...
        if (local_120 < 0) {
          ...
          if ((uVar28 <= local_148) ||
             (err = copy_fd(local_14c,uVar28 - local_148), err == COPY_FD_OK)) goto LAB_00101c26;
          ...
          if (local_120 < st.st_size) {
            _Var2 = elide_tail_lines_seekable
                              ((char *)__file,local_14c,local_148,local_120,st.st_size);
        ...
        *(undefined1 (*) [16])(pcVar11 + 0x2008) = (undefined1  [16])0x0;
            ...
            *(size_t *)(pcVar23 + 0x2008) = sVar7;
            ...
            if (*(size_t *)(pcVar23 + 0x2008) + *(long *)(local_138 + 0x2008) < 0x2000) {
              ...
              *(long *)(local_138 + 0x2008) =
                   *(long *)(pcVar23 + 0x2008) + *(long *)(local_138 + 0x2008);
        ...
        if (sVar7 == 0) {
          if ((*(long *)(local_138 + 0x2008) != 0) &&
             (pbVar9 = (byte *)(ulong)(byte)line_end,
...
LAB_00101991:
  ...
  free(__ptr_00);
LAB_00101c9a:
  if ((local_120 != -1) && (_Var10 = lseek(local_14c,local_128,0), _Var10 < 0)) {
    elseek((int)local_128,0,(int)__file,(char *)pbVar9);
    pbVar22 = (byte *)0x0;
  }
LAB_00101a5c:
  bVar16 = (byte)pbVar22;
  if ((local_130 != 0) && (iVar5 = close(local_14c), iVar5 != 0)) {
    pbVar9 = (byte *)quotearg_style(4,__file);

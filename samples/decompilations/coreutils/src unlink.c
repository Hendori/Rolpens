...

{
  ...
  parse_gnu_standard_options_only(argc,argv,"unlink","GNU coreutils",_Version,1,0x100000,uVar2,0);
  if (argc <= _optind) {
  ...
  lVar5 = (long)_optind;
  if (argc <= _optind + 1) {
    iVar1 = unlink(argv[lVar5]);
    if (iVar1 == 0) {
      return 0;
    }
    uVar2 = quotearg_style(4,argv[_optind]);
    argv = (char **)dcgettext(0,"cannot unlink %s",5);
    piVar3 = __errno_location();
    error(1,*piVar3,argv,uVar2);
    lVar5 = extraout_RDX;
  }
  uVar2 = quote(argv[lVar5 + 1]);

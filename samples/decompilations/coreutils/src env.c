...
void parse_signal_action_params(char *arg,_Bool set_default)
...
void parse_block_signal_params(char *arg,_Bool block)
...
LAB_0010098d:
        sigdelset((sigset_t *)psVar6,__signo);
      }
      else {
...

{
  ...
  for (uVar16 = (ulong)(((int)pSVar7 - (int)(undefined8 *)((ulong)(pSVar7 + 2) & 0xfffffffffffffff8)
                        ) + 0x104U >> 3); uVar16 != 0; uVar16 = uVar16 - 1) {
    *puVar25 = 0;
  ...
  if (((local_140 == (char *)0x0) ||
    ...
    do {
      ...
      if (iVar5 != 0) {
        ...
        if (iVar4 == 0) {
LAB_001023ef:
          act.__sigaction_handler._1_7_ = 0;
...
LAB_0010239d:
          if (dev_debug == false) goto LAB_001023aa;
        }

...
void unreserved__start(generic32_t register_r0 _REG(r0_arm), struct_101 _stack_arguments _STACK) {
  ...
  _stack.offset_0 = 0;
  function_0x10350_Code_arm(segment_0x10000_Generic32_1940.unreserved__text.offset_44);
...
generic64_t register_tm_clones(void) {
  return ((number64_t) ((int32_t) (((uint32_t) (segment_0x10000_Generic32_1940.unreserved__text.offset_176 - segment_0x10000_Generic32_1940.unreserved__text.offset_172) >> 31) + ((int32_t) (segment_0x10000_Generic32_1940.unreserved__text.offset_176 - segment_0x10000_Generic32_1940.unreserved__text.offset_172) >> 2)) >> 1) << 32) | segment_0x10000_Generic32_1940.unreserved__text.offset_172;
}
...
void unreserved___do_global_dtors_aux(void) {
  ...
  _stack.offset_4 = __init_r14();
  if (!*segment_0x10000_Generic32_1940.unreserved__text.offset_220) {
    deregister_tm_clones();
    *segment_0x10000_Generic32_1940.unreserved__text.offset_220 = '\001';
  }
}
...
void it_crowd(void) {
  ...
  function_0x10368_Code_arm((generic32_t) "Well done, Jen.\n");
}

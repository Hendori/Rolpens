...
int32_t all_badges()
{
    uint32_t lr_3 = data_21098 - data_2109c + data_21081 - data_21085 + data_2106a - data_2106e + data_2103c - data_21040 + data_21053 - data_21057;
    return printf("We can open every door with badg…", data_210af - data_210b3 + lr_3);
}

   ...
   if (run != 0) {
      ...
      do {
         if (mode_op != 0x10004) {
            ...
            if (( ( 1 < mode_op - 0x10004U ) && ( mode_op != 6 ) ) && ( iVar2 = EVP_CIPHER_CTX_ctrl(ctx, 0x11, 0x10, (void*)0x0) ),iVar2 == 0) {
...
;
 ...
 while ( ( -1 < (int)uVar74 ) && ( testnum = testnum < uVar58 ) );
   ...
   *(EVP_PKEY_CTX**)( (long)pvVar102 + uVar112 * 8 + 0x108 ) = pEVar80;
   ...
   if (( ( pEVar80 == (EVP_PKEY_CTX*)0x0 ) || ( iVar77 = EVP_PKEY_decrypt_init(pEVar80) ),iVar77 < 1 )) goto LAB_0010ad4b;
   ...
   if (kems_algs_len != 0) {
      ...
      do {
         ...
         if (( local_128[uVar96] != '\0' ) && ( bVar62 )) {
            ...
            local_400 = __s;
            do if (iVar75 < 1) if (( ( iVar77 < 1 ) || ( local_300 != local_310 ) ) || ( iVar77 = memcmp(pvVar102, pvVar93, (size_t)local_310) ),uVar109 = testnum,iVar77 != 0) local_400 = (void*)( (long)local_400 + 0x3560 ); while ( local_400 != pvVar114 );
      ...
      do {
         ...
         if (( local_b8[uVar96] != '\0' ) && ( !(bool)(bVar61 ^ 1) )) {
            ...
            do {
               ...
               if (( ( pEVar90 == (EVP_PKEY_CTX*)0x0 ) || ( iVar75 = EVP_PKEY_sign_init(pEVar90) ),iVar75 < 1 )) {
 ...
 while ( psVar2 != psVar115 );
                        ...
                        while (true) {
                           ...
                           *(EVP_PKEY_CTX**)( (long)pvVar102 + uVar112 * 8 + 0x98 ) = pEVar80;
                           ...
                           if (( ( pEVar80 == (EVP_PKEY_CTX*)0x0 ) || ( iVar77 = EVP_PKEY_verify_init(pEVar80) ),iVar77 < 1 )) ( iVar77 = EVP_PKEY_verify(*(EVP_PKEY_CTX**)( (long)pvVar102 + (ulong)testnum * 8 + 0x98 ), *(uchar**)( (long)pvVar102 + 0x18 ), *(size_t*)( (long)pvVar102 + 0x50 ), *(uchar**)( (long)pvVar102 + 0x10 ), 0x24) ),iVar77;
                           pvVar102 = (void*)( (long)pvVar102 + 0x3560 );
 ...
 while ( psVar115 != psVar2 );
                        ...
                        while (true) {
                           ...
                           *(EVP_PKEY_CTX**)( (long)pvVar102 + uVar96 * 8 + 0x150 ) = pEVar80;
                           ...
                           if (( ( pEVar80 == (EVP_PKEY_CTX*)0x0 ) || ( iVar77 = EVP_PKEY_verify_init(pEVar80) ),iVar77 < 1 )) ( iVar77 = EVP_PKEY_verify(*(EVP_PKEY_CTX**)( (long)pvVar102 + (ulong)testnum * 8 + 0x150 ), *(uchar**)( (long)pvVar102 + 0x18 ), *(size_t*)( (long)pvVar102 + 0x50 ), *(uchar**)( (long)pvVar102 + 0x10 ), 0x24) ),iVar77;
                           pvVar102 = (void*)( (long)pvVar102 + 0x3560 );
                           if (pvVar102 == pvVar114) {
                              pcVar82 = "+DTP:%d:%s:%s:%d\n";
                              if (mr == 0) {
 ...
 while ( psVar2 != psVar115 );
                        ...
                        while (true) {
                           ...
                           *(EVP_PKEY_CTX**)( (long)pvVar102 + uVar112 * 8 + 0x210 ) = pEVar80;
                           ...
                           if (( ( pEVar80 == (EVP_PKEY_CTX*)0x0 ) || ( iVar77 = EVP_PKEY_verify_init(pEVar80) ),iVar77 < 1 )) ( iVar77 = EVP_PKEY_verify(*(EVP_PKEY_CTX**)( (long)pvVar102 + (ulong)testnum * 8 + 0x210 ), *(uchar**)( (long)pvVar102 + 0x18 ), *(size_t*)( (long)pvVar102 + 0x50 ), *(uchar**)( (long)pvVar102 + 0x10 ), 0x14) ),iVar77;
                           pvVar102 = (void*)( (long)pvVar102 + 0x3560 );
                           if (pvVar102 == pvVar114) {
                              pcVar82 = "+DTP:%d:%s:%s:%d\n";
                              if (mr == 0) {
               ...
               do {
                  ...
                  if (local_1f8[uVar112] != '\0') {
                     ...
                     while (( ( ( pEVar89 = (EVP_PKEY*)get_ecdsa(&ec_curves_10 + uVar112 * 3) ),pEVar89 != (EVP_PKEY*)0x0 && ( peer = (EVP_PKEY*)get_ecdsa(&ec_curves_10 + (ulong)testnum * 3) ),peer != (EVP_PKEY*)0x0 ) ) && ( ( pEVar80 = EVP_PKEY_CTX_new(pEVar89, (ENGINE*)0x0) ),pEVar80 != (EVP_PKEY_CTX*)0x0 && ( ( iVar77 = EVP_PKEY_derive_init(pEVar80) ),0 < iVar77 && ( iVar77 = EVP_PKEY_derive_set_peer(pEVar80, peer) ),0 < iVar77 ) )) {
                        ...
                        if (( ( pEVar90 == (EVP_PKEY_CTX*)0x0 ) || ( iVar77 = EVP_PKEY_derive_init(pEVar90) ),iVar77 < 1 )) {
               ...
               if (*(char*)( (long)&local_226 + uVar112 ) != '\0') {
                  ...
                  while (true) {
                     ...
                     *(undefined8*)( (long)pvVar102 + uVar112 * 8 + 0x390 ) = uVar79;
                     ...
                     if (( ( pEVar80 == (EVP_PKEY_CTX*)0x0 ) || ( iVar77 = EVP_PKEY_keygen_init(pEVar80) ),iVar77 < 1 )) {
                        EVP_PKEY_CTX_free(pEVar80);
                        break;
                     }

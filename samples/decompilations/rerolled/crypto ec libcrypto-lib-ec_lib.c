undefined8 *ossl_ec_group_new_ex(undefined8 param_1, char *param_2, byte *param_3) {
   ...
   LAB_001000d0:pBVar3 = (BIGNUM*)ptr[2];
   LAB_001000d4:BN_free(pBVar3);
   ...
   *(undefined8*)( param_1 + 0x38 ) = 0;
   ...
   CRYPTO_clear_free(*(undefined8*)( group + 0x30 ), *(undefined8*)( group + 0x38 ), "crypto/ec/ec_lib.c", 0x9d);
   ...
   if (UNRECOVERED_JUMPTABLE == (code*)0x0) {
      ...
      if (( *(long*)dst == *(long*)src ) && ( ( *(int*)( dst + 8 ) == 0 || *(int*)( dst + 8 ) == *(int*)( src + 8 ) || ( *(int*)( src + 8 ) == 0 ) ) )) {
         if (dst == src) {
            return 1;
         }
         for (int i_743 = 0; i_743 < 2; i_743++) {
   ...
   if (*(long*)( *(long*)dst + 0x20 ) == 0) {
      ...
      *(int*)( dst + 0x98 ) = iVar2;
      ...
      if (( ( **(byte**)src & 2 ) != 0 ) || ( ( pBVar4 = BN_copy(*(BIGNUM**)( dst + 0x10 ), *(BIGNUM**)( src + 0x10 )) ),pBVar4 != (BIGNUM*)0x0 && ( pBVar4 = BN_copy(*(BIGNUM**)( dst + 0x18 ), *(BIGNUM**)( src + 0x18 )) ),pBVar4 != (BIGNUM*)0x0 )) {
   ...
   int iVar1;
   EC_GROUP *dst;
   if (( src != (EC_GROUP*)0x0 ) && ( dst = (EC_GROUP*)ossl_ec_group_new_ex(*(undefined8*)( src + 0xa8 ), *(undefined8*)( src + 0xb0 ), *(undefined8*)src) ),dst != (EC_GROUP*)0x0) {
   ...
   if (( ( *(long*)( group + 0x40 ) == 0 ) || ( iVar1 = iVar1 != 0 ) ) || ( iVar1 = BN_is_negative(*(undefined8*)( group + 0x40 )) ),iVar1 != 0) {
      ERR_new();
      ERR_set_debug("crypto/ec/ec_lib.c", 0x17a, "EC_GROUP_set_generator");
      ERR_set_error(0x10, 0x67, 0);
      return 0;
   }
   if (( ( order == (BIGNUM*)0x0 ) || ( iVar1 = iVar1 != 0 ) ) || ( iVar1 = iVar1 != 0 )) {
      LAB_00100ddd:ERR_new();
   ...
   if (( cofactor != (BIGNUM*)0x0 ) && ( iVar1 = iVar1 != 0 )) {
      ERR_new();
   ...
   if (pBVar3 != (BIGNUM*)0x0) {
      if (*(int*)( *(long*)group + 4 ) == 0x197) {
         ...
         if (pBVar5 != (BIGNUM*)0x0) {
            LAB_00100f48:iVar1 = BN_rshift1(*(BIGNUM**)( group + 0x18 ), *(BIGNUM**)( group + 0x10 ));
            if (( iVar1 != 0 ) && ( iVar1 = BN_add(*(BIGNUM**)( group + 0x18 ), *(BIGNUM**)( group + 0x18 ), pBVar3) ),iVar1 != 0) {
               pBVar3 = BN_value_one();
               iVar1 = BN_add(*(BIGNUM**)( group + 0x18 ), *(BIGNUM**)( group + 0x18 ), pBVar3);
               if (( iVar1 != 0 ) && ( iVar1 = BN_div(*(BIGNUM**)( group + 0x18 ), (BIGNUM*)0x0, *(BIGNUM**)( group + 0x18 ), *(BIGNUM**)( group + 0x10 ), pBVar4) ),iVar1 != 0) {
                  BN_CTX_end(pBVar4);
                  BN_CTX_free(pBVar4);
                  LAB_00100fbd:iVar1 = BN_is_odd(*(undefined8*)( group + 0x10 ));
                  if (iVar1 != 0) {
                     pBVar4 = (BN_CTX*)BN_CTX_new_ex(*(undefined8*)( group + 0xa8 ));
                     BN_MONT_CTX_free(*(BN_MONT_CTX**)( group + 0x90 ));
   ...
   BN_CTX_end(pBVar4);
   BN_CTX_free(pBVar4);
   LAB_00101041:BN_zero_ex(*(undefined8*)( group + 0x18 ));
   return 0;
   ...
   if (( *(long*)group == *(long*)p ) && ( ( ( *(int*)( group + 0x20 ) == 0 || ( *(int*)( p + 8 ) == 0 ) ) || ( *(int*)( group + 0x20 ) == *(int*)( p + 8 ) ) ) )) {
   ...
   if (*(code**)( lVar1 + 0xa0 ) == (code*)0x0) {
      ...
      if (lVar1 == *(long*)r) {
         ...
         } else if (( ( iVar2 == *(int*)( r + 8 ) ) || ( *(int*)( r + 8 ) == 0 ) ) && ( ( lVar1 == *(long*)a && ( ( ( ( *(int*)( a + 8 ) == 0 || ( iVar2 == *(int*)( a + 8 ) ) ) && ( lVar1 == *(long*)b ) ) && ( ( iVar2 == *(int*)( b + 8 ) || ( *(int*)( b + 8 ) == 0 ) ) ) ) ) ) )) {
            LAB_00101452:/* WARNING: Could not recover jumptable at 0x00101456. Too many branches *//* WARNING: Treating indirect jump as call */iVar2 = ( **(code**)( lVar1 + 0xa0 ) )();
            return iVar2;
         }
      }
      ERR_new();
   ...
   if (*(code**)( lVar1 + 0xa8 ) == (code*)0x0) {
      ...
      if (lVar1 == *(long*)r) {
         ...
         } else if (( ( ( *(int*)( r + 8 ) == 0 ) || ( iVar2 == *(int*)( r + 8 ) ) ) && ( lVar1 == *(long*)a ) ) && ( ( iVar2 == *(int*)( a + 8 ) || ( *(int*)( a + 8 ) == 0 ) ) )) {
            LAB_00101538:/* WARNING: Could not recover jumptable at 0x0010153c. Too many branches *//* WARNING: Treating indirect jump as call */iVar2 = ( **(code**)( lVar1 + 0xa8 ) )();
            return iVar2;
         }
      }
      ERR_new();
   ...
   if (UNRECOVERED_JUMPTABLE == (code*)0x0) {
      ...
      if (( *(long*)group == *(long*)a ) && ( ( ( *(int*)( group + 0x20 ) == 0 || ( *(int*)( a + 8 ) == 0 ) ) || ( *(int*)( group + 0x20 ) == *(int*)( a + 8 ) ) ) )) {
         for (int i_746 = 0; i_746 < 2; i_746++) {
   ...
   return 0;
}undefined8 EC_POINT_get_affine_coordinates(EC_GROUP *param_1, EC_POINT *param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5) {
   int iVar1;
   undefined8 uVar2;
   ...
   if (( *(long*)param_1 == *(long*)param_2 ) && ( ( ( *(int*)( param_1 + 0x20 ) == 0 || ( *(int*)( param_2 + 8 ) == 0 ) ) || ( *(int*)( param_1 + 0x20 ) == *(int*)( param_2 + 8 ) ) ) )) {
      iVar1 = EC_POINT_is_at_infinity(param_1, param_2);
      if (iVar1 == 0) {
         for (int i_748 = 0; i_748 < 2; i_748++) {
   ...
   if (UNRECOVERED_JUMPTABLE == (code*)0x0) {
      ...
      if (( *(long*)group == *(long*)point ) && ( ( ( *(int*)( group + 0x20 ) == 0 || ( *(int*)( point + 8 ) == 0 ) ) || ( *(int*)( group + 0x20 ) == *(int*)( point + 8 ) ) ) )) {
         for (int i_749 = 0; i_749 < 2; i_749++) {
   ...
   return 0;
}undefined8 EC_POINT_set_affine_coordinates(EC_GROUP *param_1, EC_POINT *param_2, undefined8 param_3, undefined8 param_4, BN_CTX *param_5) {
   code *pcVar1;
   int iVar2;
   ...
   if (pcVar1 == (code*)0x0) {
      ...
      ERR_set_error(0x10, 0xc0101, 0);
   } else if (( *(long*)param_1 == *(long*)param_2 ) && ( ( ( *(int*)( param_1 + 0x20 ) == 0 || ( *(int*)( param_2 + 8 ) == 0 ) ) || ( *(int*)( param_1 + 0x20 ) == *(int*)( param_2 + 8 ) ) ) )) {
   ...
   if (*(code**)( lVar1 + 200 ) == (code*)0x0) {
      ...
      if (lVar1 == *(long*)a) {
         ...
         } else if (( ( ( *(int*)( a + 8 ) == 0 ) || ( iVar2 == *(int*)( a + 8 ) ) ) && ( lVar1 == *(long*)b ) ) && ( ( iVar2 == *(int*)( b + 8 ) || ( *(int*)( b + 8 ) == 0 ) ) )) {
            LAB_00101aa8:/* WARNING: Could not recover jumptable at 0x00101aac. Too many branches *//* WARNING: Treating indirect jump as call */iVar2 = ( **(code**)( lVar1 + 200 ) )();
            return iVar2;
         }
      }
      ERR_new();
   ...
   if (( ( ( iVar1 != 0 ) && ( iVar1 = ( **(code**)( *(long*)b + 0x30 ) )(b, b_00, b_01, b_02, ctx) ),iVar1 != 0 ) ) && ( iVar1 = iVar1 == 0 )) {
   ...
   if (num != 0) {
      do {
         if (( *(long*)group != *(long*)points[sVar2] ) || ( ( ( *(int*)( group + 0x20 ) != 0 && ( iVar1 = *(int*)( points[sVar2] + 8 ) ),iVar1 != 0 ) ) && ( *(int*)( group + 0x20 ) != iVar1 ) )) {
            ERR_new();
   ...
   if (*(long*)r == lVar3) {
      ...
      if (iVar2 == 0) {
         if (n == (BIGNUM*)0x0 && num == 0) {
            LAB_00102010:iVar2 = EC_POINT_set_to_infinity(group, r);
            return iVar2;
         }
         sVar4 = 0;
         if (num != 0) {
            do {
               if (lVar3 != *(long*)p[sVar4]) goto LAB_00101fa2;
               sVar4 = sVar4 + 1;
            } while ( num != sVar4 );
         }
         LAB_00101fda:c = (BN_CTX*)0x0;
         if (ctx == (BN_CTX*)0x0) {
      ...
      if (( *(int*)( r + 8 ) == 0 ) || ( iVar2 == *(int*)( r + 8 ) )) {
         if (n == (BIGNUM*)0x0 && num == 0) goto LAB_00102010;
         sVar4 = 0;
         if (num != 0) {
            do {
               if (( lVar3 != *(long*)p[sVar4] ) || ( ( iVar1 = *(int*)( p[sVar4] + 8 ) ),iVar1 != 0 && ( iVar2 != iVar1 ) )) goto LAB_00101fa2;
               sVar4 = sVar4 + 1;
            } while ( sVar4 != num );
         }
         goto LAB_00101fda;
   ...
   uVar5 = 0x43a;
   goto LAB_00101f48;
   LAB_00101fa2:ERR_new();
   uVar5 = 0x443;
   LAB_00101f48:ERR_set_debug("crypto/ec/ec_lib.c", uVar5, "EC_POINTs_mul");
   ERR_set_error(0x10, 0x65, 0);
   return 0;
   ...
   if (*(long*)r == lVar2) {
      ...
      if (iVar1 == 0) {
         if (( q == (EC_POINT*)0x0 ) || ( lVar2 == *(long*)q )) goto LAB_00102170;
      } else if (( ( *(int*)( r + 8 ) == 0 ) || ( iVar1 == *(int*)( r + 8 ) ) ) && ( ( q == (EC_POINT*)0x0 || ( ( lVar2 == *(long*)q && ( ( *(int*)( q + 8 ) == 0 || ( iVar1 == *(int*)( q + 8 ) ) ) ) ) ) ) )) {
         LAB_00102170:if (n == (BIGNUM*)0x0 && m == (BIGNUM*)0x0) {
         ...
         if (*(code**)( lVar2 + 0xe0 ) == (code*)0x0) {
            iVar1 = ossl_ec_wNAF_mul(group, r, n, local_18 != (BIGNUM*)0x0 && local_10 != (EC_POINT*)0x0, &local_10, &local_18, ctx);
         } else {
   ...
   if (UNRECOVERED_JUMPTABLE != (code*)0x0) {
      for (int i_752 = 0; i_752 < 2; i_752++) {
         /* WARNING: Could not recover jumptable at 0x001022ad. Too many branches */
      }
      iVar1 = ( *UNRECOVERED_JUMPTABLE )();
      return iVar1;
   }
   ...
   if (UNRECOVERED_JUMPTABLE != (code*)0x0) {
      for (int i_753 = 0; i_753 < 2; i_753++) {
         /* WARNING: Could not recover jumptable at 0x001022ed. Too many branches */
      }
      iVar1 = ( *UNRECOVERED_JUMPTABLE )();
      return iVar1;
   }
   ...
   return 0;
}ulong ossl_ec_group_do_inverse_ord(long *param_1, undefined8 param_2, undefined8 param_3, BN_CTX *param_4) {
   int iVar1;
   ulong uVar2;
   BIGNUM *a;
   BN_CTX *c;
   if (*(code**)( *param_1 + 400 ) == (code*)0x0) {
      if (( param_1[0x12] == 0 ) || ( ( c = (BN_CTX*)0x0 ),param_4 == (BN_CTX*)0x0 && ( param_4 = (BN_CTX*)BN_CTX_secure_new() ),c = param_4,param_4 == (BN_CTX*)0x0 )) {
         uVar2 = 0;
      } else {
         BN_CTX_start(param_4);
         a = BN_CTX_get(param_4);
         if (( ( a == (BIGNUM*)0x0 ) || ( iVar1 = iVar1 == 0 ) ) || ( iVar1 = iVar1 == 0 )) {
            uVar2 = 0;
         } else {
   ...
   for (int i_754 = 0; i_754 < 2; i_754++) {
      /* WARNING: Could not recover jumptable at 0x0010237b. Too many branches */
   }
   ...
   if (*(code**)( *param_1 + 0x198 ) != (code*)0x0) {
      for (int i_755 = 0; i_755 < 2; i_755++) {
         /* WARNING: Could not recover jumptable at 0x00102463. Too many branches */
      }
   ...
   iVar1 = EC_GROUP_get_field_type();
   iVar2 = 0;
   if (( ( ( iVar1 == 0x197 ) && ( *(int*)( param_1 + 0x48 ) != 0 ) ) && ( iVar2 = 0 * (int*)( param_1 + 0x4c ) != 0 ) ) && ( ( iVar2 = 0x2aa * (int*)( param_1 + 0x50 ) != 0 && ( iVar2 = 0 * (int*)( param_1 + 0x54 ) != 0 ) ) )) {
      return -(uint)(*(int *)(param_1 + 0x58) == 0) & 0x2ab;
   }
   return iVar2;
   ...
   if (param_1 != 0) {
      iVar1 = EC_GROUP_get_field_type();
      if (( ( ( iVar1 == 0x197 ) && ( *(int*)( param_1 + 0x48 ) != 0 ) ) && ( *(int*)( param_1 + 0x4c ) != 0 ) ) && ( *(int*)( param_1 + 0x50 ) == 0 )) {
         if (param_2 != (int*)0x0) {
   ...
   return 0;
}undefined8 EC_GROUP_get_pentanomial_basis(long param_1, int *param_2, undefined4 *param_3, undefined4 *param_4) {
   int iVar1;
   undefined8 uVar2;
   if (param_1 != 0) {
      iVar1 = EC_GROUP_get_field_type();
      if (( ( ( iVar1 == 0x197 ) && ( *(int*)( param_1 + 0x48 ) != 0 ) ) && ( *(int*)( param_1 + 0x4c ) != 0 ) ) && ( ( ( *(int*)( param_1 + 0x50 ) != 0 && ( *(int*)( param_1 + 0x54 ) != 0 ) ) && ( *(int*)( param_1 + 0x58 ) == 0 ) ) )) {
         if (param_2 != (int*)0x0) {
   ...
   if (lVar2 != 0) {
      ...
      ERR_new();
      uVar4 = 0x5ea;
      LAB_00102729:ERR_set_debug("crypto/ec/ec_lib.c", uVar4, "ossl_ec_group_set_params");
      ERR_set_error(0x10, 0x68, 0);
      uVar4 = 0;
      goto LAB_001026fa;
   }
   LAB_00102694:lVar2 = OSSL_PARAM_locate_const(param_2, "encoding");
   if (lVar2 != 0) {
   ...
   LAB_001026fa:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar4;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* WARNING: Removing unreachable block (ram,0x001032a3) */EC_GROUP *EC_GROUP_new_from_params(undefined8 param_1, undefined8 param_2, undefined8 param_3) {
   byte *buf;
   int iVar1;
   int iVar2;
   long lVar3;
   ...
   if (lVar3 != 0) {
      ...
      if (*(int*)( lVar3 + 8 ) == 4) {
         ...
         if (local_48 != 0) {
            ...
            if (iVar1 != 0) goto LAB_0010289d;
            LAB_00102a10:ERR_new();
            ERR_set_debug("crypto/ec/ec_lib.c", 0x5d8, "group_new_from_name");
            ERR_set_error(0x10, 0x8d, 0);
         }
      } else if (( *(int*)( lVar3 + 8 ) == 6 ) && ( iVar1 = iVar1 != 0 )) {
         iVar1 = ossl_ec_curve_name2nid(local_48);
         if (iVar1 == 0) goto LAB_00102a10;
         LAB_0010289d:group = (EC_GROUP*)EC_GROUP_new_by_curve_name_ex(param_2, param_3);
         if (group != (EC_GROUP*)0x0) {
   ...
   if (local_58 == (BIGNUM*)0x0) {
      ...
      ERR_set_error(0x10, 0x80003, 0);
      LAB_001029da:p = (EC_POINT*)0x0;
      group_00 = (EC_GROUP*)0x0;
      LAB_001029e0:EC_GROUP_free(group_00);
      group_00 = group;
   } else {
      ...
      if (iVar2 == 0) {
         ERR_new();
         uVar4 = 0x661;
         LAB_00102d67:ERR_set_debug("crypto/ec/ec_lib.c", uVar4, "EC_GROUP_new_from_params");
      ...
      if (iVar1 != 0) {
         ...
         if (group_00 != (EC_GROUP*)0x0) goto LAB_00102cfc;
         LAB_00102b50:ERR_new();
      ...
      if (group_00 == (EC_GROUP*)0x0) goto LAB_00102b50;
      ...
      LAB_00102cfc:lVar3 = OSSL_PARAM_locate_const(param_1, &_LC3);
      if (lVar3 != 0) {
         if (*(int*)( lVar3 + 8 ) == 5) {
            sVar5 = EC_GROUP_set_seed(group_00, *(uchar**)( lVar3 + 0x10 ), *(size_t*)( lVar3 + 0x18 ));
            if (sVar5 != 0) goto LAB_00102dec;
         } else {
            ERR_new();
            ERR_set_debug("crypto/ec/ec_lib.c", 0x68c, "EC_GROUP_new_from_params");
            ERR_set_error(0x10, 0xaf, 0);
         }
         LAB_00102d4e:p = (EC_POINT*)0x0;
         goto LAB_001029e0;
      }
      LAB_00102dec:lVar3 = OSSL_PARAM_locate_const(param_1, "generator");
      ...
      if (( lVar3 != 0 ) && ( ( local_50 = BN_CTX_get(ctx) ),local_50 == (BIGNUM*)0x0 || ( iVar1 = OSSL_PARAM_get_BN(lVar3, &local_50) ),iVar1 == 0 )) {
         ERR_new();
      ...
      if (( ( group_01 == (EC_GROUP*)0x0 ) || ( sVar5 = EC_GROUP_set_seed(group_01, (uchar*)0x0, 0) ),sVar5 != 1 )) {
         LAB_00103327:group_02 = (EC_GROUP*)0x0;
         LAB_001032d6:EC_GROUP_free(group_01);
      ...
      if (iVar1 != 0) {
         ...
         if (group_02 == (EC_GROUP*)0x0) goto LAB_00103327;
         EC_GROUP_set_asn1_flag(group_02, 0);
         if (( puVar6 != (uchar*)0x0 ) || ( sVar5 = sVar5 == 1 )) {
            EC_GROUP_free(group_01);
            if (group_02 == group_00) goto LAB_00103212;
      ...
      EC_GROUP_free(group_01);
      LAB_00103212:lVar3 = OSSL_PARAM_locate_const(param_1);
      if (( lVar3 != 0 ) && ( iVar1 = iVar1 == 0 )) {
         ERR_new();
      ...
      LAB_00103130:*(undefined4*)( group_00 + 0x28 ) = 1;
   }
   EC_POINT_free(p);
   BN_CTX_end(ctx);
   BN_CTX_free(ctx);
   group = group_00;
   LAB_0010284c:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return group;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   if (( param_1 == 0 ) || ( lVar3 = lVar3 == 0 )) {
      ...
      c = (BN_CTX*)0x0;
      pBVar5 = c;
      if (( param_4 == (BN_CTX*)0x0 ) && ( param_4 = (BN_CTX*)BN_CTX_new_ex(param_2) ),pBVar5 = param_4,param_4 == (BN_CTX*)0x0) {
         uVar4 = 0;
      } else {
         BN_CTX_start(param_4);
         uVar4 = 0;

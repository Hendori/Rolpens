void lh_DECODER_CACHE_ENTRY_hfn_thunk(undefined8 param_1, code *UNRECOVERED_JUMPTABLE) {
   for (int i_1903 = 0; i_1903 < 2; i_1903++) {
      /* WARNING: Could not recover jumptable at 0x00100004. Too many branches */
   }
   ( *UNRECOVERED_JUMPTABLE )();
   return;
}void lh_DECODER_CACHE_ENTRY_cfn_thunk(undefined8 param_1, undefined8 param_2, code *UNRECOVERED_JUMPTABLE) {
   for (int i_1904 = 0; i_1904 < 2; i_1904++) {
   ...
   for (int i_1905 = 0; i_1905 < 2; i_1905++) {
      /* WARNING: Could not recover jumptable at 0x00100024. Too many branches */
   }
   ( *UNRECOVERED_JUMPTABLE )();
   return;
}void lh_DECODER_CACHE_ENTRY_doall_arg_thunk(undefined8 param_1, undefined8 param_2, code *UNRECOVERED_JUMPTABLE) {
   for (int i_1906 = 0; i_1906 < 2; i_1906++) {
   ...
   if (lVar8 == 0) {
      LAB_001001b6:lVar8 = OSSL_PARAM_locate_const(param_2, "reference");
      if (( lVar8 != 0 ) && ( *(int*)( lVar8 + 8 ) == 5 )) {
         ...
         LAB_0010025e:bVar11 = *(long*)param_3[5] != 0;
         goto LAB_00100171;
      }
   } else {
      local_58 = 0;
   ...
   LAB_0010016f:bVar11 = false;
   LAB_00100171:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   ...
   undefined4 uVar3;
   undefined8 uVar4;
   if (param_2[2] == 0) goto LAB_00100390;
   ...
   LAB_00100390:iVar1 = EVP_KEYMGMT_up_ref(param_1);
   ...
   if (( *(code**)( param_1 + 0x60 ) == (code*)0x0 ) || ( iVar2 = ( **(code**)( param_1 + 0x60 ) )(uVar4, *(undefined4*)( *(long*)( param_2 + 8 ) + 0x10 )) ),iVar2 != 0) {
      iVar7 = 0;
      iVar2 = OPENSSL_sk_num(uVar1);
      if (0 < iVar2) {
         while (lVar6 = OPENSSL_sk_value(uVar1, iVar7),*(int*)( lVar6 + 4 ) != *(int*)( param_1 + 8 )) {
            LAB_0010051a:if (*(char*)( param_2 + 0x24 ) != '\0') {
               return;
            }
            iVar7 = iVar7 + 1;
            if (iVar7 == iVar2) {
         ...
         if (lVar6 != 0) {
            ...
            if (( *plVar8 != 0 ) && ( *(long*)( lVar5 + 0x10 ) != 0 )) {
               ...
               if (( iVar3 != 0 ) && ( ( iVar3 = OPENSSL_strcasecmp(*(undefined8*)( lVar5 + 0x10 ), &_LC6) ),iVar3 != 0 || ( iVar3 = OPENSSL_strcasecmp(**(undefined8**)( param_2 + 8 ), &_LC7) ),iVar3 != 0 )) {
   ...
   if (param_1[2] == 0) {
      LAB_00100685:if (param_2[2] == 0) goto LAB_00100627;
      LAB_0010068a:uVar1 = 1;
   } else {
      if (param_2[2] == 0) {
         if (param_1[2] != 0) {
            return 0xffffffff;
      ...
      LAB_00100627:if (*param_1 == 0) {
         LAB_001006b8:if (*param_2 != 0) goto LAB_0010068a;
      } else {
         if (*param_2 == 0) {
            if (*param_1 != 0) {
               return 0xffffffff;
      ...
      if (param_1[1] == 0) {
         LAB_001006c5:if (param_2[1] != 0) goto LAB_0010068a;
      } else {
         if (param_2[1] == 0) {
            if (param_1[1] != 0) {
               return 0xffffffff;
   ...
   return uVar1;
}void decoder_clean_pkey_construct_arg(void *param_1) {
   if (param_1 != (void*)0x0) {
   ...
   return;
}void decoder_cache_entry_free(undefined8 *param_1) {
   ...
   if (ptr != (long*)0x0) {
      ...
      *ptr = lVar1;
      if (lVar1 == 0) {
         ...
         lVar1 = OPENSSL_LH_set_thunks(uVar2, 0x100000, lh_DECODER_CACHE_ENTRY_cfn_thunk, lh_DECODER_CACHE_ENTRY_doall_thunk, lh_DECODER_CACHE_ENTRY_doall_arg_thunk);
         ptr[1] = lVar1;
         if (lVar1 != 0) {
            return ptr;
         }
   ...
   return 0;
}long OSSL_DECODER_CTX_new_for_pkey(undefined8 param_1, char *param_2, char *param_3, char *param_4, undefined4 param_5, undefined8 param_6, char *param_7) {
   undefined4 uVar1;
   int iVar2;
   undefined8 *puVar3;
   ulong uVar4;
   ...
   if (puVar3 == (undefined8*)0x0) {
      ERR_new();
      uVar7 = 0x30b;
      LAB_00101049:ERR_set_debug("crypto/encode_decode/decoder_pkey.c", uVar7, "OSSL_DECODER_CTX_new_for_pkey");
      ERR_set_error(0x3c, 0x8003c, 0);
   } else {
      if (param_3 != (char*)0x0) {
      ...
      if (iVar2 == 0) {
         ...
         lVar10 = OPENSSL_LH_retrieve(puVar3[1], &local_118);
         if (lVar10 != 0) {
            lVar10 = *(long*)( lVar10 + 0x28 );
            LAB_00100b32:if (lVar10 == 0) {
               LAB_00100d10:lVar5 = 0;
            } else {
               LAB_00100b3b:lVar5 = OSSL_DECODER_CTX_new();
               if (lVar5 == 0) {
                  ERR_new();
                  ERR_set_debug("crypto/encode_decode/decoder_pkey.c", 0x212, "ossl_decoder_ctx_for_pkey_dup");
                  ERR_set_error(0x3c, 0x8003c, 0);
                  goto LAB_00100d10;
               }
               iVar2 = OSSL_DECODER_CTX_set_input_type(lVar5, param_2);
               if (( iVar2 == 0 ) || ( iVar2 = OSSL_DECODER_CTX_set_input_structure(lVar5, param_3) ),iVar2 == 0) {
                  ERR_new();
                  uVar7 = 0x218;
                  LAB_00100ce9:ERR_set_debug("crypto/encode_decode/decoder_pkey.c", uVar7, "ossl_decoder_ctx_for_pkey_dup");
                  ERR_set_error(0x3c, 0x8003c, 0);
                  LAB_00100d08:OSSL_DECODER_CTX_free(lVar5);
                  goto LAB_00100d10;
               }
               lVar6 = *(long*)( lVar10 + 0x18 );
               *(undefined4*)( lVar5 + 0x10 ) = *(undefined4*)( lVar10 + 0x10 );
               if (lVar6 != 0) {
                  lVar6 = OPENSSL_sk_deep_copy(lVar6, &ossl_decoder_instance_dup, ossl_decoder_instance_free);
               ...
               uVar7 = OSSL_DECODER_CTX_get_construct(lVar10);
               ...
               puVar8 = (undefined8*)OSSL_DECODER_CTX_get_construct_data(lVar10);
               if (puVar8 != (undefined8*)0x0) {
                  ptr = (undefined8*)CRYPTO_zalloc(0x38, "crypto/encode_decode/decoder_pkey.c", 0x230);
                  if (ptr == (undefined8*)0x0) {
                     ERR_new();
                     ERR_set_debug("crypto/encode_decode/decoder_pkey.c", 0x232, "ossl_decoder_ctx_for_pkey_dup");
                     ERR_set_error(0x3c, 0x8000f, 0);
                  } else {
                     if ((char*)puVar8[1] == (char*)0x0) {
                        LAB_00100c22:if (puVar8[3] == 0) {
                           LAB_00100c52:ptr[5] = param_1;
                           *ptr = *puVar8;
                           uVar1 = *(undefined4*)( puVar8 + 2 );
                           ptr[6] = lVar5;
                           *(undefined4*)( ptr + 2 ) = uVar1;
                           iVar2 = OSSL_DECODER_CTX_set_construct_data(lVar5, ptr);
                           if (iVar2 != 0) goto LAB_00100c82;
                           ERR_new();
                           ERR_set_debug("crypto/encode_decode/decoder_pkey.c", 0x24d, "ossl_decoder_ctx_for_pkey_dup");
                           uVar7 = 0x8003c;
                           goto LAB_00100f72;
                        }
                        ...
                        ERR_new();
                        ERR_set_debug("crypto/encode_decode/decoder_pkey.c", 0x243, "ossl_decoder_ctx_for_pkey_dup");
                        ERR_set_error(0x3c, 0x80006, 0);
                     } else {
                        pcVar9 = CRYPTO_strdup((char*)puVar8[1], "crypto/encode_decode/decoder_pkey.c", 0x236);
                        ptr[1] = pcVar9;
                        if (pcVar9 != (char*)0x0) goto LAB_00100c22;
                        ERR_new();
                        ERR_set_debug("crypto/encode_decode/decoder_pkey.c", 0x238, "ossl_decoder_ctx_for_pkey_dup");
                        uVar7 = 0x8000f;
                        LAB_00100f72:ERR_set_error(0x3c, uVar7, 0);
                     }
                     OPENSSL_sk_pop_free(ptr[3], EVP_KEYMGMT_free);
               ...
               LAB_00100c82:uVar7 = OSSL_DECODER_CTX_get_cleanup(lVar10);
         ...
         iVar2 = OSSL_DECODER_CTX_set_input_type(lVar10, param_2);
         if (( ( iVar2 != 0 ) && ( iVar2 = OSSL_DECODER_CTX_set_input_structure(lVar10, param_3) ),iVar2 != 0 )) {
            ...
            if (puVar8 != (undefined8*)0x0) {
               if (param_7 == (char*)0x0) {
                  LAB_00100e14:lVar5 = OPENSSL_sk_new_null();
                  if (lVar5 == 0) {
                     ERR_new();
                     ERR_set_debug("crypto/encode_decode/decoder_pkey.c", 0x1b4, "ossl_decoder_ctx_setup_for_pkey");
                     ERR_set_error(0x3c, 0x8000f, 0);
                  } else {
                     local_c8._8_8_ = lVar5;
                     *(undefined4*)( puVar8 + 2 ) = *(undefined4*)( lVar10 + 0x10 );
                     *puVar8 = param_6;
                     puVar8[3] = lVar5;
                     puVar8[5] = 0;
                     ...
                     if (local_c8[4] == '\0') {
                        ...
                        if (local_c8[4] == '\0') {
                           iVar2 = OSSL_DECODER_CTX_get_num_decoders(lVar10);
                           if (iVar2 == 0) {
                              OPENSSL_sk_pop_free(puVar8[3], EVP_KEYMGMT_free);
                              CRYPTO_free((void*)puVar8[1]);
                              CRYPTO_free((void*)puVar8[4]);
                              CRYPTO_free(puVar8);
                           } else {
                              iVar2 = OSSL_DECODER_CTX_set_construct(lVar10, decoder_construct_pkey);
                              if (( ( iVar2 == 0 ) || ( iVar2 = OSSL_DECODER_CTX_set_construct_data(lVar10, puVar8) ),iVar2 == 0 )) goto LAB_00100e94;
                           }
                           iVar2 = OSSL_DECODER_CTX_add_extra(lVar10, param_6, param_7);
                           if (( iVar2 == 0 ) || ( ( param_7 != (char*)0x0 && ( iVar2 = OSSL_DECODER_CTX_set_params(lVar10, local_b8) ),iVar2 == 0 ) )) goto LAB_00100ee0;
                           puVar8 = (undefined8*)CRYPTO_zalloc(0x30, "crypto/encode_decode/decoder_pkey.c", 0x34c);
                           if (puVar8 == (undefined8*)0x0) {
                              OSSL_DECODER_CTX_free(lVar10);
                              goto LAB_00100d48;
                           }
                           if (param_2 == (char*)0x0) {
                              LAB_00101199:if (param_3 != (char*)0x0) {
                                 pcVar9 = CRYPTO_strdup(param_3, "crypto/encode_decode/decoder_pkey.c", 0x358);
                                 puVar8[1] = pcVar9;
                                 if (pcVar9 == (char*)0x0) goto LAB_00101343;
                              }
                              if (param_4 != (char*)0x0) {
                                 pcVar9 = CRYPTO_strdup(param_4, "crypto/encode_decode/decoder_pkey.c", 0x35d);
                                 puVar8[2] = pcVar9;
                                 if (pcVar9 == (char*)0x0) goto LAB_00101343;
                              }
                              if (param_7 != (char*)0x0) {
                                 pcVar9 = CRYPTO_strdup(param_7, "crypto/encode_decode/decoder_pkey.c", 0x362);
                                 puVar8[4] = pcVar9;
                                 if (pcVar9 == (char*)0x0) goto LAB_00101343;
                              }
                              uVar7 = *puVar3;
                              *(undefined4*)( puVar8 + 3 ) = param_5;
                              ...
                              if (iVar2 == 0) {
                                 ...
                                 if (lVar5 != 0) {
                                    ...
                                    CRYPTO_free((void*)puVar8[1]);
                                    CRYPTO_free((void*)puVar8[2]);
                                    CRYPTO_free((void*)puVar8[4]);
                                    OSSL_DECODER_CTX_free(puVar8[5]);
                                    CRYPTO_free(puVar8);
                              ...
                              pcVar9 = CRYPTO_strdup(param_2, "crypto/encode_decode/decoder_pkey.c", 0x353);
                              *puVar8 = pcVar9;
                              if (pcVar9 != (char*)0x0) goto LAB_00101199;
                           }
                           LAB_00101343:CRYPTO_free((void*)*puVar8);
                           CRYPTO_free((void*)puVar8[1]);
                           CRYPTO_free((void*)puVar8[2]);
                           CRYPTO_free((void*)puVar8[4]);
                           OSSL_DECODER_CTX_free(puVar8[5]);
                  ...
                  pcVar9 = CRYPTO_strdup(param_7, "crypto/encode_decode/decoder_pkey.c", 0x1ae);
                  puVar8[1] = pcVar9;
                  if (pcVar9 != (char*)0x0) goto LAB_00100e14;
               }
               LAB_00100e94:OPENSSL_sk_pop_free(puVar8[3], EVP_KEYMGMT_free);
               CRYPTO_free((void*)puVar8[1]);
               CRYPTO_free((void*)puVar8[4]);
               CRYPTO_free(puVar8);
            }
         }
         LAB_00100ee0:ERR_new();
         ERR_set_debug("crypto/encode_decode/decoder_pkey.c", 0x347, "OSSL_DECODER_CTX_new_for_pkey");
         ERR_set_error(0x3c, 0x8003c, 0);
         OSSL_DECODER_CTX_free(lVar10);
      }
   }
   LAB_00100d48:lVar5 = 0;

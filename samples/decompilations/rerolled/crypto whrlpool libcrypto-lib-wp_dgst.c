int WHIRLPOOL_Init(WHIRLPOOL_CTX *c) {
   ...
   *psVar2 = *psVar2 + bits;
   ...
   if (uVar4 < 0x21) {
      ...
      if (uVar4 < 8) {
         if (( uVar4 & 4 ) == 0) {
            ...
            for (int i_2495 = 0; i_2495 < 4; i_2495++) {
               puVar7[i_2495] = '\0';
            }
            puVar7 = puVar7 + ( uVar6 - 4 );
            for (int i_2496 = 0; i_2496 < 4; i_2496++) {
               puVar7[i_2496] = '\0';
            }
         }
         goto LAB_001005d9;
      ...
      if (uVar4 < 0x40) {
         ...
         if (uVar4 < 8) {
            if (( uVar4 & 4 ) == 0) {
               ...
               for (int i_2497 = 0; i_2497 < 4; i_2497++) {
                  puVar7[i_2497] = '\0';
               }
               puVar7 = puVar7 + ( (ulong)uVar4 - 4 );
               for (int i_2498 = 0; i_2498 < 4; i_2498++) {
                  puVar7[i_2498] = '\0';
               }
            }
         } else {
            for (int i_2499 = 0; i_2499 < 8; i_2499++) {
               puVar7[i_2499] = '\0';
            }
            puVar1 = puVar7 + ( (ulong)uVar4 - 8 );
            for (int i_2500 = 0; i_2500 < 8; i_2500++) {
               puVar1[i_2500] = '\0';
            }
   ...
   for (int i_2493 = 0; i_2493 < 8; i_2493++) {
      puVar7[i_2493] = '\0';
   }
   puVar1 = puVar7 + ( uVar6 - 8 );
   for (int i_2494 = 0; i_2494 < 8; i_2494++) {
      puVar1[i_2494] = '\0';
   }

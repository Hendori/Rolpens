undefined8 test_http_cb(void) {
   ...
   return 1;
}undefined8 test_log_cb(undefined8 param_1, undefined8 param_2, undefined4 param_3, undefined4 param_4, undefined8 param_5) {
   int iVar1;
   iVar1 = test_str_eq("test/cmp_ctx_test.c", 0x108, &_LC3, "\"execute_cmp_ctx_log_cb_test\"", param_1, "execute_cmp_ctx_log_cb_test");
   if (( ( ( ( iVar1 == 0 ) && ( iVar1 = test_str_eq("test/cmp_ctx_test.c", 0x109, &_LC3, "\"(unknown function)\"", param_1, "(unknown function)") ),iVar1 == 0 ) ) || ( ( iVar1 = test_str_eq("test/cmp_ctx_test.c", 0x10b, &_LC6, "OPENSSL_FILE", param_2, "test/cmp_ctx_test.c") ),iVar1 == 0 && ( iVar1 = test_str_eq("test/cmp_ctx_test.c", 0x10c, &_LC6, "\"(no file)\"", param_2, "(no file)") ),iVar1 == 0 ) )) {
      test_log_cb_res = 0;
   } else {
   ...
   if (iVar1 != 0) {
      ...
      if (iVar1 != 0) {
         ...
         iVar1 = test_ptr_eq("test/cmp_ctx_test.c", 0x76, "libctx", "OSSL_CMP_CTX_get0_libctx(cmpctx)", uVar2, uVar4);
         if (iVar1 != 0) {
            uVar4 = OSSL_CMP_CTX_get0_propq(uVar3);
            iVar1 = test_str_eq("test/cmp_ctx_test.c", 0x77, "propq", "OSSL_CMP_CTX_get0_propq(cmpctx)", "?provider=legacy", uVar4);
            bVar5 = iVar1 != 0;
            goto LAB_001002b1;
         }
      }
   ...
   bVar5 = false;
   LAB_001002b1:OSSL_CMP_CTX_free(uVar3);
   ...
   if (lVar1 == 0) {
      ...
      LAB_0010099d:test_error("test/cmp_ctx_test.c", 0x32c, "first set had no effect");
      iVar2 = ossl_cmp_ctx_set1_recipNonce(lVar1, a_00);
      if (iVar2 == 0) {
         test_error("test/cmp_ctx_test.c", 0x32c, "setting second value failed");
      }
      if (lVar1 != 0) {
         LAB_001009cb:uVar8 = 0;
         goto LAB_00100868;
      }
      ERR_new();
      ERR_set_debug("test/cmp_ctx_test.c", 0x32c, "OSSL_CMP_CTX_get0_recipNonce");
      ERR_set_error(0x3a, 0x67, 0);
      LAB_00100aec:uVar8 = 0;
      ...
      if (a == pAVar7) {
         LAB_00100987:test_error("test/cmp_ctx_test.c", 0x32c, "first set did not dup the value");
         goto LAB_0010099d;
      }
      ...
      LAB_00100868:pAVar7 = *(ASN1_OCTET_STRING**)( lVar1 + 0x128 );
   ...
   if (lVar1 == 0) {
      ...
      if (a == pAVar8) {
         LAB_00100e37:test_error("test/cmp_ctx_test.c", 0x32b, "first set did not dup the value");
         goto LAB_00100e4d;
      }
      ...
      LAB_00100cea:pAVar8 = *(ASN1_OCTET_STRING**)( lVar1 + 0x120 );
   ...
   if (lVar1 == 0) {
      ...
      if (a == pAVar8) {
         LAB_001012e7:test_error("test/cmp_ctx_test.c", 0x329, "first set did not dup the value");
         goto LAB_001012fd;
      }
      ...
      LAB_0010119a:pAVar8 = *(ASN1_OCTET_STRING**)( lVar1 + 0x118 );
   ...
   if (lVar1 == 0) {
      ...
      ERR_set_debug("test/cmp_ctx_test.c", 0x31e, "OSSL_CMP_CTX_get_certConf_cb");
      ERR_set_error(0x3a, 0x67, 0);
      LAB_001019a3:test_error("test/cmp_ctx_test.c", 0x31e, "third set reset the value");
   } else {
      ...
      if (iVar2 == 0) {
         ...
         LAB_00101928:test_error("test/cmp_ctx_test.c", 0x31e, "set/get first value did not match");
         iVar2 = OSSL_CMP_CTX_set_certConf_cb(lVar1, test_certConf_cb);
         if (iVar2 == 0) goto LAB_00101b20;
         LAB_00101951:pcVar7 = *(code**)( lVar1 + 0x208 );
         uVar8 = 0;
         if (pcVar7 != (code*)0x0) goto LAB_00101a04;
         LAB_00101968:test_error("test/cmp_ctx_test.c", 0x31e, "second set reset the value");
         test_error("test/cmp_ctx_test.c", 0x31e, "set/get second value did not match");
         if (*(long*)( lVar1 + 0x208 ) == 0) goto LAB_001019a3;
      } else {
         if (*(code**)( lVar1 + 0x208 ) != test_certConf_cb) goto LAB_00101928;
         LAB_001019e0:iVar2 = OSSL_CMP_CTX_set_certConf_cb(lVar1, test_certConf_cb);
         if (iVar2 == 0) {
            LAB_00101b20:test_error("test/cmp_ctx_test.c", 0x31e, "setting second value failed");
            goto LAB_00101951;
         }
         pcVar7 = *(code**)( lVar1 + 0x208 );
         if (pcVar7 == (code*)0x0) goto LAB_00101968;
         LAB_00101a04:if (pcVar7 == test_certConf_cb) goto LAB_00101a60;
         test_error("test/cmp_ctx_test.c", 0x31e, "set/get second value did not match");
   ...
   LAB_00101a55:uVar8 = 0;
   LAB_00101a60:uVar6 = ERR_peek_error();
   ...
   if (lVar1 == 0) {
      ...
      ERR_set_debug("test/cmp_ctx_test.c", 0x2f8, "OSSL_CMP_CTX_get_transfer_cb");
      ERR_set_error(0x3a, 0x67, 0);
      LAB_00102158:test_error("test/cmp_ctx_test.c", 0x2f8, "third set reset the value");
   } else {
      ...
      if (iVar2 == 0) {
         ...
         LAB_001020e2:test_error("test/cmp_ctx_test.c", 0x2f8, "set/get first value did not match");
         iVar2 = OSSL_CMP_CTX_set_transfer_cb(lVar1, test_transfer_cb);
         if (iVar2 == 0) goto LAB_001022d0;
         LAB_0010210b:pcVar7 = *(code**)( lVar1 + 0x20 );
         uVar8 = 0;
         if (pcVar7 != (code*)0x0) goto LAB_001021b9;
         LAB_00102120:test_error("test/cmp_ctx_test.c", 0x2f8, "second set reset the value");
         test_error("test/cmp_ctx_test.c", 0x2f8, "set/get second value did not match");
         if (*(long*)( lVar1 + 0x20 ) == 0) goto LAB_00102158;
      } else {
         if (*(code**)( lVar1 + 0x20 ) != test_transfer_cb) goto LAB_001020e2;
         LAB_00102198:iVar2 = OSSL_CMP_CTX_set_transfer_cb(lVar1, test_transfer_cb);
         if (iVar2 == 0) {
            LAB_001022d0:test_error("test/cmp_ctx_test.c", 0x2f8, "setting second value failed");
            goto LAB_0010210b;
         }
         pcVar7 = *(code**)( lVar1 + 0x20 );
         if (pcVar7 == (code*)0x0) goto LAB_00102120;
         LAB_001021b9:if (pcVar7 == test_transfer_cb) goto LAB_00102210;
         test_error("test/cmp_ctx_test.c", 0x2f8, "set/get second value did not match");
   ...
   LAB_00102207:uVar8 = 0;
   LAB_00102210:uVar6 = ERR_peek_error();
   ...
   if (lVar1 == 0) {
      ...
      ERR_set_debug("test/cmp_ctx_test.c", 0x2f5, "OSSL_CMP_CTX_get_http_cb");
      ERR_set_error(0x3a, 0x67, 0);
      LAB_00102908:test_error("test/cmp_ctx_test.c", 0x2f5, "third set reset the value");
   } else {
      ...
      if (iVar2 == 0) {
         ...
         LAB_00102892:test_error("test/cmp_ctx_test.c", 0x2f5, "set/get first value did not match");
         iVar2 = OSSL_CMP_CTX_set_http_cb(lVar1, 0x100000);
         if (iVar2 == 0) goto LAB_00102a80;
         LAB_001028bb:lVar7 = *(long*)( lVar1 + 0x78 );
         uVar8 = 0;
         if (lVar7 != 0) goto LAB_00102969;
         LAB_001028d0:test_error("test/cmp_ctx_test.c", 0x2f5, "second set reset the value");
         test_error("test/cmp_ctx_test.c", 0x2f5, "set/get second value did not match");
         if (*(long*)( lVar1 + 0x78 ) == 0) goto LAB_00102908;
      } else {
         if (*(long*)( lVar1 + 0x78 ) != 0x100000) goto LAB_00102892;
         LAB_00102948:iVar2 = OSSL_CMP_CTX_set_http_cb(lVar1, 0x100000);
         if (iVar2 == 0) {
            LAB_00102a80:test_error("test/cmp_ctx_test.c", 0x2f5, "setting second value failed");
            goto LAB_001028bb;
         }
         lVar7 = *(long*)( lVar1 + 0x78 );
         if (lVar7 == 0) goto LAB_001028d0;
         LAB_00102969:if (lVar7 == 0x100000) goto LAB_001029c0;
         test_error("test/cmp_ctx_test.c", 0x2f5, "set/get second value did not match");
         if (*(long*)( lVar1 + 0x78 ) == 0) {
   ...
   LAB_001029b7:uVar8 = 0;
   LAB_001029c0:uVar6 = ERR_peek_error();
   ...
   if (lVar1 == 0) {
      ...
      if (*(int*)( lVar1 + 0x48 ) == 0) {
         ...
         if (iVar2 == 0) {
            LAB_00102e97:test_error("test/cmp_ctx_test.c", 0x2f1, "setting first value failed");
            goto LAB_00102ead;
         }
         if (*(int*)( lVar1 + 0x48 ) == 1) goto LAB_00102ebc;
         LAB_00102d2f:test_error("test/cmp_ctx_test.c", 0x2f1, "set/get first value did not match");
         iVar2 = OSSL_CMP_CTX_set_serverPort(lVar1, 1);
         if (iVar2 == 0) {
            LAB_00102ed1:test_error("test/cmp_ctx_test.c", 0x2f1, "setting second value failed");
         }
         uVar7 = 0;
      } else {
         test_error("test/cmp_ctx_test.c", 0x2f1, "did not get default value");
         ...
         LAB_00102ead:uVar7 = 0;
         if (*(int*)( lVar1 + 0x48 ) != 1) goto LAB_00102d2f;
         LAB_00102ebc:iVar2 = OSSL_CMP_CTX_set_serverPort(lVar1, 1);
   ...
   LAB_00102dc2:uVar7 = 0;
   LAB_00102dc8:uVar6 = ERR_peek_error();
   ...
   if (lVar1 == 0) {
      ...
      ERR_set_debug("test/cmp_ctx_test.c", 0x2ed, "OSSL_CMP_CTX_get_log_cb");
      ERR_set_error(0x3a, 0x67, 0);
      LAB_00103248:test_error("test/cmp_ctx_test.c", 0x2ed, "third set reset the value");
   } else {
      ...
      if (iVar2 == 0) {
         ...
         LAB_001031d2:test_error("test/cmp_ctx_test.c", 0x2ed, "set/get first value did not match");
         iVar2 = OSSL_CMP_CTX_set_log_cb(lVar1, test_log_cb);
         if (iVar2 == 0) goto LAB_001033c0;
         LAB_001031fb:pcVar7 = *(code**)( lVar1 + 0x10 );
         uVar8 = 0;
         if (pcVar7 != (code*)0x0) goto LAB_001032a9;
         LAB_00103210:test_error("test/cmp_ctx_test.c", 0x2ed, "second set reset the value");
         test_error("test/cmp_ctx_test.c", 0x2ed, "set/get second value did not match");
         if (*(long*)( lVar1 + 0x10 ) == 0) goto LAB_00103248;
      } else {
         if (*(code**)( lVar1 + 0x10 ) != test_log_cb) goto LAB_001031d2;
         LAB_00103288:iVar2 = OSSL_CMP_CTX_set_log_cb(lVar1, test_log_cb);
         if (iVar2 == 0) {
            LAB_001033c0:test_error("test/cmp_ctx_test.c", 0x2ed, "setting second value failed");
            goto LAB_001031fb;
         }
         pcVar7 = *(code**)( lVar1 + 0x10 );
         if (pcVar7 == (code*)0x0) goto LAB_00103210;
         LAB_001032a9:if (pcVar7 == test_log_cb) goto LAB_00103300;
         test_error("test/cmp_ctx_test.c", 0x2ed, "set/get second value did not match");
   ...
   LAB_001032f7:uVar8 = 0;
   LAB_00103300:uVar6 = ERR_peek_error();
   ...
   LAB_001036ae:iVar3 = OSSL_CMP_CTX_get_option(uVar1, 0x23);
   if (iVar3 == 0) {
      uVar7 = 0;
   ...
   if (lVar1 == 0) {
      ...
      ERR_set_debug("test/cmp_ctx_test.c", 0x317, "OSSL_CMP_CTX_get0_reqExtensions");
      ERR_set_error(0x3a, 0x67, 0);
      LAB_00103b70:test_error("test/cmp_ctx_test.c", 0x317, "third set reset the value");
   } else {
      ...
      if (*(long*)( lVar1 + 0x198 ) == 0) {
         ...
         LAB_00103a04:test_error("test/cmp_ctx_test.c", 0x317, "third get gave different value");
      } else if (lVar6 != *(long*)( lVar1 + 0x198 )) goto LAB_00103a04;
   }
   uVar10 = 0;
   LAB_00103a20:uVar8 = ERR_peek_error();
   uVar4 = test_int_eq("test/cmp_ctx_test.c", 0x317, "ERR_peek_error()", &_LC15, uVar8 & 0xffffffff, 0);
   if (uVar4 != 0) {
      uVar4 = uVar10;
   }
   for (int i_508 = 0; i_508 < 2; i_508++) {
      OPENSSL_sk_free(0);
   }
   ...
   if (lVar8 == 0) {
      ...
      if (lVar5 == lVar9) {
         LAB_00103f77:test_error("test/cmp_ctx_test.c", 0x308, "first set did not dup the value");
         goto LAB_00103f8d;
      }
      ...
      LAB_00103e2a:lVar9 = *(long*)( lVar8 + 0x150 );
   ...
   if (lVar1 == 0) {
      ...
      ERR_set_debug("test/cmp_ctx_test.c", 0x319, "OSSL_CMP_CTX_get0_oldCert");
      ERR_set_error(0x3a, 0x67, 0);
      LAB_0010444c:test_error("test/cmp_ctx_test.c", 0x319, "third set reset the value");
   } else {
      ...
      if (*(long*)( lVar1 + 0x1b0 ) == 0) {
         ...
         LAB_0010440e:lVar7 = *(long*)( lVar1 + 0x1b0 );
         uVar8 = 0;
         if (lVar7 != 0) goto LAB_001042e3;
         LAB_00104422:test_error("test/cmp_ctx_test.c", 0x319, "second set reset the value");
         if (a == a_00) {
            test_error("test/cmp_ctx_test.c", 0x319, "second value is same as first value");
         }
         ...
         iVar2 = OSSL_CMP_CTX_set1_oldCert(lVar1, a_00);
         if (iVar2 == 0) {
            LAB_001043f8:test_error("test/cmp_ctx_test.c", 0x319, "setting second value failed");
            goto LAB_0010440e;
         }
         lVar7 = *(long*)( lVar1 + 0x1b0 );
         if (lVar7 == 0) goto LAB_00104422;
         LAB_001042e3:if (a != a_00) goto LAB_001042ec;
         test_error("test/cmp_ctx_test.c", 0x319, "second value is same as first value");
         if (*(long*)( lVar1 + 0x1b0 ) == 0) {
   ...
   LAB_001044b0:uVar8 = 0;
   LAB_001042ec:uVar6 = ERR_peek_error();
   ...
   if (lVar1 == 0) {
      ...
      ERR_set_debug("test/cmp_ctx_test.c", 0x303, "OSSL_CMP_CTX_get0_cert");
      ERR_set_error(0x3a, 0x67, 0);
      LAB_0010491c:test_error("test/cmp_ctx_test.c", 0x303, "third set reset the value");
   } else {
      if (*(long*)( lVar1 + 200 ) != 0) {
         uVar8 = 0;
      ...
      if (*(long*)( lVar1 + 200 ) == 0) {
         ...
         LAB_001048de:lVar7 = *(long*)( lVar1 + 200 );
         uVar8 = 0;
         if (lVar7 != 0) goto LAB_001047b3;
         LAB_001048f2:test_error("test/cmp_ctx_test.c", 0x303, "second set reset the value");
         if (a == a_00) {
            test_error("test/cmp_ctx_test.c", 0x303, "second value is same as first value");
         }
         ...
         iVar2 = OSSL_CMP_CTX_set1_cert(lVar1, a_00);
         if (iVar2 == 0) {
            LAB_001048c8:test_error("test/cmp_ctx_test.c", 0x303, "setting second value failed");
            goto LAB_001048de;
         }
         lVar7 = *(long*)( lVar1 + 200 );
         if (lVar7 == 0) goto LAB_001048f2;
         LAB_001047b3:if (a != a_00) goto LAB_001047bc;
         test_error("test/cmp_ctx_test.c", 0x303, "second value is same as first value");
         if (*(long*)( lVar1 + 200 ) == 0) {
   ...
   LAB_00104980:uVar8 = 0;
   LAB_001047bc:uVar6 = ERR_peek_error();
   ...
   if (lVar1 == 0) {
      ...
      ERR_set_debug("test/cmp_ctx_test.c", 0x2fb, "OSSL_CMP_CTX_get0_srvCert");
      ERR_set_error(0x3a, 0x67, 0);
      LAB_00104dec:test_error("test/cmp_ctx_test.c", 0x2fb, "third set reset the value");
   } else {
      ...
      if (*(long*)( lVar1 + 0x90 ) == 0) {
         ...
         LAB_00104dae:lVar7 = *(long*)( lVar1 + 0x90 );
         uVar8 = 0;
         if (lVar7 != 0) goto LAB_00104c83;
         LAB_00104dc2:test_error("test/cmp_ctx_test.c", 0x2fb, "second set reset the value");
         if (a == a_00) {
            test_error("test/cmp_ctx_test.c", 0x2fb, "second value is same as first value");
         }
         ...
         iVar2 = OSSL_CMP_CTX_set1_srvCert(lVar1, a_00);
         if (iVar2 == 0) {
            LAB_00104d98:test_error("test/cmp_ctx_test.c", 0x2fb, "setting second value failed");
            goto LAB_00104dae;
         }
         lVar7 = *(long*)( lVar1 + 0x90 );
         if (lVar7 == 0) goto LAB_00104dc2;
         LAB_00104c83:if (a != a_00) goto LAB_00104c8c;
         test_error("test/cmp_ctx_test.c", 0x2fb, "second value is same as first value");
         if (*(long*)( lVar1 + 0x90 ) == 0) {
   ...
   LAB_00104e50:uVar8 = 0;
   LAB_00104c8c:uVar6 = ERR_peek_error();
   ...
   LAB_00105198:iVar2 = ossl_cmp_ctx_set1_extraCertsIn(uVar1, lVar8);
   if (iVar2 == 0) {
      uVar10 = 0;
   ...
   LAB_001055d8:iVar2 = ossl_cmp_ctx_set1_caPubs(uVar1, lVar8);
   if (iVar2 == 0) {
      uVar10 = 0;
   ...
   LAB_00105a18:iVar2 = ossl_cmp_ctx_set1_newChain(uVar1, lVar8);
   if (iVar2 == 0) {
      uVar10 = 0;
   ...
   if (ptr != (void*)0x0) {
      ...
      for (int i_511 = 0; i_511 < 2; i_511++) {
         POLICYINFO_free((POLICYINFO*)0);
      }
   ...
   iVar2 = test_false("test/cmp_ctx_test.c", 0xe0, "OSSL_CMP_CTX_reqExtensions_have_SAN(ctx)", iVar2 != 0);
   if (iVar2 != 0) {
      ...
      if (iVar2 != 0) {
         ...
         if (iVar2 != 0) {
            ...
            iVar2 = test_true("test/cmp_ctx_test.c", 0xe5, "ASN1_OCTET_STRING_set(data, str, len)", iVar2 != 0);
            if (iVar2 != 0) {
               ...
               if (iVar2 == 0) {
                  ...
                  iVar2 = test_ptr("test/cmp_ctx_test.c", 0xe9, "exts = sk_X509_EXTENSION_new_null()", local_60);
                  if (iVar2 != 0) {
                     iVar2 = OPENSSL_sk_push(local_60, pXVar4);
                     iVar2 = test_true("test/cmp_ctx_test.c", 0xea, "sk_X509_EXTENSION_push(exts, ext)", iVar2 != 0);
                     if (iVar2 != 0) {
                        iVar2 = OSSL_CMP_CTX_set0_reqExtensions(uVar1, local_60);
                        iVar2 = test_true("test/cmp_ctx_test.c", 0xeb, "OSSL_CMP_CTX_set0_reqExtensions(ctx, exts)", iVar2 != 0);
                        if (iVar2 != 0) {
                           uVar3 = OSSL_CMP_CTX_reqExtensions_have_SAN(uVar1);
                           iVar2 = test_int_eq("test/cmp_ctx_test.c", 0xf0, "OSSL_CMP_CTX_reqExtensions_have_SAN(ctx)", &_LC56, uVar3, 1);
                           if (iVar2 != 0) {
                              pXVar4 = (X509_EXTENSION*)OPENSSL_sk_pop(local_60);
                              iVar2 = OSSL_CMP_CTX_reqExtensions_have_SAN(uVar1);
                              iVar2 = test_false("test/cmp_ctx_test.c", 0xf2, "OSSL_CMP_CTX_reqExtensions_have_SAN(ctx)", iVar2 != 0);
         ...
         LAB_00106abc:iVar2 = 0;
      }
      LAB_00106a55:ASN1_OCTET_STRING_free(str);
   }
   OSSL_CMP_CTX_free(*(undefined8*)( (long)ptr + 8 ));
   CRYPTO_free(ptr);
   ...
   if (lVar1 == 0) {
      ...
      if (a == pXVar8) {
         LAB_00106eb7:test_error("test/cmp_ctx_test.c", 0x313, "first set did not dup the value");
         goto LAB_00106ecd;
      }
      ...
      LAB_00106d6a:pXVar8 = *(X509_NAME**)( lVar1 + 0x180 );
   ...
   if (lVar1 == 0) {
      ...
      if (a == pXVar8) {
         LAB_00107367:test_error("test/cmp_ctx_test.c", 0x312, "first set did not dup the value");
         goto LAB_0010737d;
      }
      ...
      LAB_0010721a:pXVar8 = *(X509_NAME**)( lVar1 + 0x168 );
   ...
   if (lVar1 == 0) {
      ...
      if (a == pXVar8) {
         LAB_00107817:test_error("test/cmp_ctx_test.c", 0x306, "first set did not dup the value");
         goto LAB_0010782d;
      }
      ...
      LAB_001076ca:pXVar8 = *(X509_NAME**)( lVar1 + 0x108 );
   ...
   if (lVar1 == 0) {
      ...
      if (a == pXVar8) {
         LAB_00107cc7:test_error("test/cmp_ctx_test.c", 0x2fd, "first set did not dup the value");
         goto LAB_00107cdd;
      }
      ...
      LAB_00107b7a:pXVar8 = *(X509_NAME**)( lVar1 + 0xa0 );
   ...
   if (ptr != (void*)0x0) {
      ...
      for (int i_512 = 0; i_512 < 2; i_512++) {
         EVP_PKEY_free((EVP_PKEY*)0);
      }
   ...
   if (lVar1 == 0) {
      ...
      ERR_set_debug("test/cmp_ctx_test.c", 0x304, "OSSL_CMP_CTX_get0_pkey");
      ERR_set_error(0x3a, 0x67, 0);
      LAB_001087bc:test_error("test/cmp_ctx_test.c", 0x304, "third set reset the value");
   } else {
      ...
      if (*(long*)( lVar1 + 0xd8 ) == 0) {
         ...
         LAB_0010877e:lVar7 = *(long*)( lVar1 + 0xd8 );
         uVar8 = 0;
         if (lVar7 != 0) goto LAB_00108653;
         LAB_00108792:test_error("test/cmp_ctx_test.c", 0x304, "second set reset the value");
         if (pkey == pkey_00) {
            test_error("test/cmp_ctx_test.c", 0x304, "second value is same as first value");
         }
         ...
         iVar2 = OSSL_CMP_CTX_set1_pkey(lVar1, pkey_00);
         if (iVar2 == 0) {
            LAB_00108768:test_error("test/cmp_ctx_test.c", 0x304, "setting second value failed");
            goto LAB_0010877e;
         }
         lVar7 = *(long*)( lVar1 + 0xd8 );
         if (lVar7 == 0) goto LAB_00108792;
         LAB_00108653:if (pkey != pkey_00) goto LAB_0010865c;
         test_error("test/cmp_ctx_test.c", 0x304, "second value is same as first value");
         if (*(long*)( lVar1 + 0xd8 ) == 0) {
   ...
   LAB_00108820:uVar8 = 0;
   LAB_0010865c:uVar6 = ERR_peek_error();
   ...
   if (lVar1 == 0) {
      ...
      ERR_set_error(0x3a, 0x67, 0);
      local_48 = (char*)0x0;
      LAB_00108f8f:pcVar9 = "second set reset the value";
      LAB_00108c18:uVar10 = 0;
      test_error("test/cmp_ctx_test.c", 0x311, pcVar9);
      pcVar9 = (char*)0x0;
   } else {
      piVar8 = *(int**)( lVar1 + 0xe8 );
      if (( piVar8 != (int*)0x0 ) && ( piVar8 = (int*)CRYPTO_strndup(*(undefined8*)( piVar8 + 2 ), (long)*piVar8, "test/cmp_ctx_test.c", 0x310) ),piVar8 != (int*)0x0) {
         uVar10 = 0;
      ...
      piVar8 = *(int**)( lVar1 + 0xe8 );
      if (piVar8 == (int*)0x0) {
         LAB_00108b95:test_error("test/cmp_ctx_test.c", 0x311, "first set had no effect");
         sVar7 = strlen(__s_00);
         ...
         local_48 = (char*)CRYPTO_strndup(*(undefined8*)( piVar8 + 2 ), (long)*piVar8, "test/cmp_ctx_test.c", 0x310);
         if (__s == local_48) {
      ...
      piVar8 = *(int**)( lVar1 + 0xe8 );
      if (( piVar8 == (int*)0x0 ) || ( pcVar9 = (char*)CRYPTO_strndup(*(undefined8*)( piVar8 + 2 ), (long)*piVar8, "test/cmp_ctx_test.c", 0x310) ),pcVar9 == (char*)0x0) goto LAB_00108f8f;
      if (__s_00 == pcVar9) {
   ...
   if (lVar1 == 0) {
      ...
      piVar8 = *(int**)( lVar1 + 0xe8 );
      if (( piVar8 != (int*)0x0 ) && ( ptr_00 = (char*)CRYPTO_strndup(*(undefined8*)( piVar8 + 2 ), (long)*piVar8, "test/cmp_ctx_test.c", 0x310) ),ptr_00 != (char*)0x0) goto LAB_00108c98;
   }
   uVar10 = 0;
   test_error("test/cmp_ctx_test.c", 0x311, "third set reset the value");
   ptr_00 = (char*)0x0;
   LAB_00108c98:if (pcVar9 == ptr_00) {
      uVar10 = 0;
   ...
   if (lVar1 == 0) {
      ...
      ERR_set_error(0x3a, 0x67, 0);
      local_48 = (char*)0x0;
      LAB_001095ef:pcVar9 = "second set reset the value";
      LAB_00109278:uVar10 = 0;
      test_error("test/cmp_ctx_test.c", 0x30e, pcVar9);
      pcVar9 = (char*)0x0;
   } else {
      piVar8 = *(int**)( lVar1 + 0xe0 );
      if (( piVar8 != (int*)0x0 ) && ( piVar8 = (int*)CRYPTO_strndup(*(undefined8*)( piVar8 + 2 ), (long)*piVar8, "test/cmp_ctx_test.c", 0x30d) ),piVar8 != (int*)0x0) {
         uVar10 = 0;
      ...
      piVar8 = *(int**)( lVar1 + 0xe0 );
      if (piVar8 == (int*)0x0) {
         LAB_001091f5:test_error("test/cmp_ctx_test.c", 0x30e, "first set had no effect");
         sVar7 = strlen(__s_00);
         ...
         local_48 = (char*)CRYPTO_strndup(*(undefined8*)( piVar8 + 2 ), (long)*piVar8, "test/cmp_ctx_test.c", 0x30d);
         if (__s == local_48) {
      ...
      piVar8 = *(int**)( lVar1 + 0xe0 );
      if (( piVar8 == (int*)0x0 ) || ( pcVar9 = (char*)CRYPTO_strndup(*(undefined8*)( piVar8 + 2 ), (long)*piVar8, "test/cmp_ctx_test.c", 0x30d) ),pcVar9 == (char*)0x0) goto LAB_001095ef;
      if (__s_00 == pcVar9) {
         pcVar9 = "second set did not dup the value";
         goto LAB_00109278;
      }
   ...
   if (lVar1 == 0) {
      ...
      piVar8 = *(int**)( lVar1 + 0xe0 );
      if (( piVar8 != (int*)0x0 ) && ( ptr_00 = (char*)CRYPTO_strndup(*(undefined8*)( piVar8 + 2 ), (long)*piVar8, "test/cmp_ctx_test.c", 0x30d) ),ptr_00 != (char*)0x0) goto LAB_001092f8;
   }
   uVar10 = 0;
   test_error("test/cmp_ctx_test.c", 0x30e, "third set reset the value");
   ptr_00 = (char*)0x0;
   LAB_001092f8:if (pcVar9 == ptr_00) {
      uVar10 = 0;
   ...
   if (lVar1 == 0) {
      ...
      if (ptr_00 == pcVar8) {
         LAB_00109964:test_error("test/cmp_ctx_test.c", 0x2f3, "first set did not dup the value");
         goto LAB_0010997a;
      }
      ...
      LAB_001097f1:pcVar8 = *(char**)( lVar1 + 0x58 );
   ...
   if (lVar1 == 0) {
      ...
      if (ptr_00 == pcVar8) {
         LAB_00109e24:test_error("test/cmp_ctx_test.c", 0x2f2, "first set did not dup the value");
         goto LAB_00109e3a;
      }
      ...
      LAB_00109cb1:pcVar8 = *(char**)( lVar1 + 0x50 );
   ...
   if (lVar1 == 0) {
      ...
      if (ptr_00 == pcVar8) {
         LAB_0010a2e4:test_error("test/cmp_ctx_test.c", 0x2f0, "first set did not dup the value");
         goto LAB_0010a2fa;
      }
      ...
      LAB_0010a171:pcVar8 = *(char**)( lVar1 + 0x40 );
   ...
   if (lVar1 == 0) {
      ...
      if (ptr_00 == pcVar8) {
         LAB_0010a7a4:test_error("test/cmp_ctx_test.c", 0x2ef, "first set did not dup the value");
         goto LAB_0010a7ba;
      }
      ...
      LAB_0010a631:pcVar8 = *(char**)( lVar1 + 0x38 );
   ...
   if (lVar10 == 0) {
      LAB_0010aab9:iVar2 = OSSL_CMP_CTX_set0_trustedStore(uVar1, pXVar6);
      if (iVar2 != 0) goto LAB_0010aacc;
      LAB_0010ac90:uVar12 = 0;
      ...
      LAB_0010aacc:pXVar11 = (X509_STORE*)OSSL_CMP_CTX_get0_trustedStore(uVar1);
   }
   if (pXVar6 != pXVar11) {
      uVar12 = 0;
   ...
   for (int i_514 = 0; i_514 < 2; i_514++) {
      X509_STORE_free((X509_STORE*)0);
   }
   ...
   uVar4 = test_true("test/cmp_ctx_test.c", 0xa8, "OSSL_CMP_CTX_set_log_cb(ctx, msg_total_size_log_cb)", iVar2 != 0);
   if (uVar4 != 0) {
      uVar4 = uVar3;
   }
   iVar2 = test_true("test/cmp_ctx_test.c", 0xaa, "ctx->log_cb == msg_total_size_log_cb", *(code**)( lVar1 + 0x10 ) == msg_total_size_log_cb);
   if (iVar2 != 0) {
      ERR_new();
      ...
      OSSL_CMP_CTX_print_errors(lVar1);
      uVar3 = test_int_eq("test/cmp_ctx_test.c", 0xb9, "msg_total_size", "expected_size", msg_total_size, 0x30);
      if (uVar3 != 0) {
         uVar3 = uVar4;
      }
      ERR_new();
      ...
      ERR_set_error(0x3a, 100, 0);
      do {
         ERR_add_error_txt("<SEP>", "This is a 64 bytes looooooooooooooooooooooooooooooooong string.\nThis is a 64 bytes looooooooooooooooooooooooooooooooong string.\nThis is a 64 bytes looooooooooooooooooooooooooooooooong string.\nThis is a 64 bytes looooooooooooooooooooooooooooooooong string.\nThis is a 64 bytes looooooooooooooooooooooooooooooooong string.\nThis is a 64 bytes looooooooooooooooooooooooooooooooong string.\nThis is a 64 bytes looooooooooooooooooooooooooooooooong string.\nThis is a 61 bytes loooooooooooooooooooooooooooooong string.\n");
         iVar2 = iVar2 + -1;
      } while ( iVar2 != 0 );
      msg_total_size = 0;
      OSSL_CMP_CTX_print_errors(lVar1);
      iVar2 = test_int_eq("test/cmp_ctx_test.c", 0xc6, "msg_total_size", "expected_size", msg_total_size, 0x1020);
      if (iVar2 != 0) goto LAB_0010ae31;
   }
   uVar3 = 0;
   LAB_0010ae31:OSSL_CMP_CTX_free(*(undefined8*)( (long)ptr + 8 ));
   CRYPTO_free(ptr);
   return uVar3;
   ...
   uVar1 = *(undefined8*)( (long)ptr + 8 );
   for (int i_515 = 0; i_515 < 2; i_515++) {
      OSSL_CMP_log_open();
   }
   iVar2 = OSSL_CMP_CTX_set_log_cb(uVar1, 0);
   iVar2 = test_true("test/cmp_ctx_test.c", 0x11d, "OSSL_CMP_CTX_set_log_cb(ctx, NULL)", iVar2 != 0);
   if (iVar2 != 0) {
      ossl_cmp_print_log(3, uVar1, "execute_cmp_ctx_log_cb_test", "test/cmp_ctx_test.c", 0x120, "ERROR", &_LC79, "this should be printed as CMP error message");
      ossl_cmp_print_log(4, uVar1, "execute_cmp_ctx_log_cb_test", "test/cmp_ctx_test.c", 0x121, &_LC80, &_LC79, "this should be printed as CMP warning message");
      ossl_cmp_print_log(7, uVar1, "execute_cmp_ctx_log_cb_test", "test/cmp_ctx_test.c", 0x122, "DEBUG", &_LC79, "this should not be printed");
      iVar2 = OSSL_CMP_CTX_set_option(uVar1, 0, 7);
      test_true("test/cmp_ctx_test.c", 0x123, "OSSL_CMP_CTX_set_log_verbosity(ctx, OSSL_CMP_LOG_DEBUG)", iVar2 != 0);
      iVar2 = 1;
      ossl_cmp_print_log(7, uVar1, "execute_cmp_ctx_log_cb_test", "test/cmp_ctx_test.c", 0x124, "DEBUG", &_LC79, "this should be printed as CMP debug message");
      iVar3 = OSSL_CMP_CTX_set_option(uVar1, 0, 6);
      test_true("test/cmp_ctx_test.c", 0x125, "OSSL_CMP_CTX_set_log_verbosity(ctx, OSSL_CMP_LOG_INFO)", iVar3 != 0);
   }
   iVar3 = OSSL_CMP_CTX_set_log_cb(uVar1, test_log_cb);
   iVar3 = test_true("test/cmp_ctx_test.c", 0x127, "OSSL_CMP_CTX_set_log_cb(ctx, test_log_cb)", iVar3 != 0);
   if (iVar3 != 0) {
      test_log_line = 299;
      ossl_cmp_print_log(6, uVar1, "execute_cmp_ctx_log_cb_test", "test/cmp_ctx_test.c", 299, &_LC88, &_LC90, &_LC89, 0x6b);
      ...
      test_log_line = 0x131;
      ossl_cmp_print_log(6, uVar1, "execute_cmp_ctx_log_cb_test", "test/cmp_ctx_test.c", 0x131, &_LC88, &_LC90, &_LC89, 0x6b);
      iVar2 = test_int_eq("test/cmp_ctx_test.c", 0x132, "test_log_cb_res", &_LC19, test_log_cb_res, 0xffffffff);
      if (iVar2 != 0) goto LAB_0010b073;
   }
   iVar3 = 0;
   LAB_0010b073:OSSL_CMP_log_close();
   OSSL_CMP_log_close();
   OSSL_CMP_CTX_free(*(undefined8*)( (long)ptr + 8 ));
   CRYPTO_free(ptr);
   return iVar3;
   ...
   *(undefined4*)( lVar1 + 0x1e0 ) = 1;
   ...
   if (iVar2 != 0) {
      ...
      if (iVar2 != 0) {
         uVar4 = OPENSSL_sk_new_null();
         pXVar5 = X509_new();
         if (( pXVar5 == (X509*)0x0 ) || ( iVar2 = OPENSSL_sk_push(uVar4, pXVar5) ),uVar7 = uVar4,iVar2 == 0) {
            uVar7 = 0;
            ...
            if (( ( iVar2 != 0 ) && ( iVar2 = ossl_cmp_ctx_set1_extraCertsIn(lVar1, uVar7) ),iVar2 != 0 )) {
               ...
               if (( ( iVar2 != 0 ) && ( iVar2 = OSSL_CMP_CTX_set1_transactionID(lVar1, a_00) ),iVar2 != 0 )) {
                  ...
                  if (iVar2 != 0) {
                     bVar8 = false;
                     bVar6 = false;
                     if (( ( ( *(int*)( lVar1 + 0x1d0 ) == -1 ) && ( *(int*)( lVar1 + 0x1e0 ) == -1 ) ) && ( ( ( *(long*)( lVar1 + 0x1d8 ) == 0 && ( ( ( ( bVar8 = bVar6 * (long*)( lVar1 + 0x1e8 ) == 0 && ( *(long*)( lVar1 + 0x1f0 ) == 0 ) ) && ( *(long*)( lVar1 + 0x1f8 ) == 0 ) ) && ( ( *(long*)( lVar1 + 0x200 ) == 0 && ( *(long*)( lVar1 + 0x98 ) == 0 ) ) ) ) ) ) && ( *(long*)( lVar1 + 0x118 ) == 0 ) ) ) ) && ( *(long*)( lVar1 + 0x120 ) == 0 )) {
                        bVar8 = *(long*)( lVar1 + 0x128 ) == 0;
                     }
                     iVar2 = test_true("test/cmp_ctx_test.c", 0x58, "ctx->status == -1 && ctx->failInfoCode == -1 && ctx->statusString == NULL && ctx->newCert == NULL && ctx->newChain == NULL && ctx->caPubs == NULL && ctx->extraCertsIn == NULL && ctx->validatedSrvCert == NULL && ctx->transactionID == NULL && ctx->senderNonce == NULL && ctx->recipNonce == NULL", bVar8);
                     uVar3 = ( uint )(iVar2 != 0);
                     goto LAB_0010b36b;
                  }
               }
   ...
   *ptr = "test_CTX_set_get_failInfoCode";
   ...
   if (iVar1 == 0) {
      ...
      LAB_0010b85a:test_error("test/cmp_ctx_test.c", 0x323, "second set reset the value");
   } else {
      iVar1 = OSSL_CMP_CTX_get_failInfoCode(uVar5);
      if (iVar1 < 0) goto LAB_0010b85a;
      LAB_0010b6e5:if (iVar1 == 1) {
   ...
   *ptr = "test_CTX_set_get_status";
   ...
   if (iVar1 == 0) {
      ...
      LAB_0010bbaa:test_error("test/cmp_ctx_test.c", 0x321, "second set reset the value");
   } else {
      iVar1 = OSSL_CMP_CTX_get_status(uVar5);
      if (iVar1 < 0) goto LAB_0010bbaa;
      LAB_0010ba35:if (iVar1 == 1) {

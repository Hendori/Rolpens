undefined1 *kdf_argon2_settable_ctx_params(void) {
   ...
   for (int i_2067 = 0; i_2067 < 4; i_2067++) {
      if (param_1[( 2*i_2067 + 2 )] != 0) {
         CRYPTO_clear_free(param_1[( 2*i_2067 + 2 )], *(undefined4*)( param_1 + ( 2*i_2067 + 3 ) ), "providers/implementations/kdfs/argon2.c", ( 3*i_2067 + 1134 ));
      }
   }
   *param_1 = 0;
   uVar4 = __LC3;
   ...
   *(undefined8*)( (long)param_1 + 0x54 ) = uVar4;
   ...
   if (param_1 != (undefined8*)0x0) {
      for (int i_2068 = 0; i_2068 < 4; i_2068++) {
         if (param_1[( 2*i_2068 + 2 )] != 0) {
            CRYPTO_clear_free(param_1[( 2*i_2068 + 2 )], *(undefined4*)( param_1 + ( 2*i_2068 + 3 ) ), "providers/implementations/kdfs/argon2.c", ( 3*i_2068 + 993 ));
         }
      }
      EVP_MD_free(param_1[0x11]);
      EVP_MAC_free(param_1[0x12]);

int EVP_PKEY_encrypt(EVP_PKEY_CTX *ctx, uchar *out, size_t *outlen, uchar *in, size_t inlen) {
   ...
   if (ctx == (EVP_PKEY_CTX*)0x0) {
      ...
      if (*(long*)( ctx + 0x30 ) != 0) {
         for (int i_2425 = 0; i_2425 < 2; i_2425++) {
      ...
      lVar1 = *(long*)( ctx + 0x78 );
      if (( lVar1 != 0 ) && ( UNRECOVERED_JUMPTABLE = *(code**)( lVar1 + 0x98 ) ),UNRECOVERED_JUMPTABLE != (code*)0x0) {
         if (( *(byte*)( lVar1 + 4 ) & 2 ) == 0) {
            LAB_00100073:/* WARNING: Could not recover jumptable at 0x0010007e. Too many branches *//* WARNING: Treating indirect jump as call */iVar2 = ( *UNRECOVERED_JUMPTABLE )(ctx);
            return iVar2;
         }
   ...
   if (ctx == (EVP_PKEY_CTX*)0x0) {
      ...
      if (*(long*)( ctx + 0x30 ) != 0) {
         for (int i_2426 = 0; i_2426 < 2; i_2426++) {
      ...
      lVar1 = *(long*)( ctx + 0x78 );
      if (( lVar1 != 0 ) && ( UNRECOVERED_JUMPTABLE = *(code**)( lVar1 + 0xa8 ) ),UNRECOVERED_JUMPTABLE != (code*)0x0) {
         if (( *(byte*)( lVar1 + 4 ) & 2 ) == 0) {
            LAB_00100253:/* WARNING: Could not recover jumptable at 0x0010025e. Too many branches *//* WARNING: Treating indirect jump as call */iVar2 = ( *UNRECOVERED_JUMPTABLE )(ctx);
            return iVar2;
         }
         iVar2 = EVP_PKEY_get_size(*(undefined8*)( ctx + 0x88 ));
         uVar3 = (ulong)iVar2;
   ...
   ERR_set_error(6, 0x96, 0);
   return -2;
}undefined8 evp_pkey_decrypt_alloc(EVP_PKEY_CTX *param_1, undefined8 *param_2, size_t *param_3, size_t param_4, uchar *param_5, size_t param_6) {
   int iVar1;
   uchar *out;
   ...
   *piVar1 = *piVar1 + -1;
              ...
              if (*(long *)(ptr + 0x1e) == 0) {
                ...
                *(undefined8 *)(ptr + 0x1e) = *(undefined8 *)(piVar4 + 2);
                ...
                goto joined_r0x001007f0;
                  ...
                  iVar1 = piVar4[4];
                  joined_r0x001007f0:piVar4 = piVar4 + 4;
               } while ( iVar1 != 0 );
               if (( iVar6 == 2 ) && ( ( ( uVar3 == 2 && iVar5 == 0 || ( iVar5 == 2 ) ) && ( ( ( uVar3 | uVar8 | uVar7 ) & 0xfffffffd ) == 0 ) ) )) {
                  return ptr;
               }
            }
            ERR_new();
   ...
   ERR_set_error(6, 0x80006, 0);
   LAB_0010068c:EVP_ASYM_CIPHER_free(ptr);
   ...
   *(int*)( param_1 + 0x20 ) = *(int*)( param_1 + 0x20 ) + 1;
   ...
   evp_generic_fetch(param_1, 0xd, param_2, param_3, evp_asym_cipher_from_algorithm, evp_asym_cipher_up_ref, evp_asym_cipher_free);
   return;
}void evp_asym_cipher_fetch_from_prov(undefined8 param_1, undefined8 param_2, undefined8 param_3) {
   evp_generic_fetch_from_prov(param_1, 0xd, param_2, param_3, evp_asym_cipher_from_algorithm, evp_asym_cipher_up_ref, evp_asym_cipher_free);
   return;
   ...
   if (param_1 == (int*)0x0) {
      ...
      *param_1 = param_2;
      ...
      if (lVar10 == 0) {
         ...
         if (*(long*)( param_1 + 0x22 ) == 0) {
            ...
            if (lVar1 == 0 || lVar10 == lVar1) {
               ...
               if (lVar4 != 0) {
                  ...
                  EVP_KEYMGMT_free(local_48);
                  lVar5 = EVP_ASYM_CIPHER_fetch(*(undefined8*)( param_1 + 2 ), lVar4, *(undefined8*)( param_1 + 4 ));
                  ...
                  do {
                     ...
                     LAB_00100b43:EVP_KEYMGMT_free(lVar9);
                     if (1 < uVar12) goto LAB_00100b60;
                     LAB_00100ac8:if (!bVar13) goto LAB_00100b60;
                     LAB_00100ad0:uVar12 = 2;
                     EVP_ASYM_CIPHER_free(lVar5);
                     EVP_KEYMGMT_free(local_48);
         ...
         LAB_00100d08:evp_pkey_ctx_free_old_ops(param_1);
         *param_1 = 0;
      }
      EVP_KEYMGMT_free(local_48);
   }
   LAB_00100ca2:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar3;
   }
   ...
   evp_generic_do_all(param_1, 0xd, param_2, param_3, evp_asym_cipher_from_algorithm, evp_asym_cipher_up_ref, evp_asym_cipher_free);
   return;
   ...
   if (*(long*)( param_1 + 0x68 ) != 0) {
      ...
      for (int i_2427 = 0; i_2427 < 2; i_2427++) {
   ...
   if (*(long*)( param_1 + 0x78 ) != 0) {
      uVar1 = EVP_ASYM_CIPHER_get0_provider();
      uVar1 = ossl_provider_ctx(uVar1);
      for (int i_2428 = 0; i_2428 < 2; i_2428++) {

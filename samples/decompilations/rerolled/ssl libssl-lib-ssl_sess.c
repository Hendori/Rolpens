undefined8 def_generate_session_id(SSL *param_1, uchar *param_2, uint *param_3) {
   ...
   *(undefined8*)( ses[1].krb5_client_princ + 0x98 ) = param_1[0x70];
   ...
   for (int i_1008 = 0; i_1008 < 16; i_1008++) {
      ses[1].session_id[i_1008] = '\0';
   }
   for (int i_1013 = 0; i_1013 < 8; i_1013++) {
      ses[1].krb5_client_princ[( i_1013 + 96 )] = '\0';
   }
   for (int i_1014 = 0; i_1014 < 8; i_1014++) {
      ses[1].sid_ctx[( i_1014 + 4 )] = '\0';
   }
   for (int i_1015 = 0; i_1015 < 8; i_1015++) {
      ses[1].krb5_client_princ[( i_1015 + 168 )] = '\0';
   }
   for (int i_1009 = 0; i_1009 < 16; i_1009++) {
      ses[1].krb5_client_princ[( i_1009 + 56 )] = '\0';
   }
   *(undefined1(*) [16])( ses[1].session_id + 0x18 ) = (undefined1[16])0x0;
   for (int i_1012 = 0; i_1012 < 16; i_1012++) {
      ses[1].krb5_client_princ[( i_1012 + 120 )] = '\0';
   }
   for (int i_1011 = 0; i_1011 < 16; i_1011++) {
      ses[1].krb5_client_princ[( i_1011 + 40 )] = '\0';
   }
   for (int i_1010 = 0; i_1010 < 16; i_1010++) {
      ses[1].krb5_client_princ[( i_1010 + 152 )] = '\0';
   }
   LOCK();
   for (int i_1016 = 0; i_1016 < 4; i_1016++) {
      ses[1].krb5_client_princ[( i_1016 + 176 )] = '\x01';
   }
   UNLOCK();
   ...
   if (iVar1 == 0) {
      ...
      if (param_1[0x58] == 0) {
         ...
         if (( param_2 == 0 ) || ( param_1[0x65] == 0 )) {
            for (int i_1017 = 0; i_1017 < 16; i_1017++) {
               ses[1].krb5_client_princ[( i_1017 + 72 )] = '\0';
            }
         } else {
         ...
         *(long*)( ses[1].krb5_client_princ + 0x80 ) = lVar3;
         ...
         if (iVar1 != 0) {
            ...
            for (int i_1018 = 0; i_1018 < 4; i_1018++) {
               ses[1].sid_ctx[i_1018] = (char)( (ulong)uVar6 >> ( 8*i_1018 + 32 ) );
            }
            goto LAB_001002cc;
         }
         ERR_new();
   ...
   *(long*)( param_1 + 0x2e8 ) = lVar1;
   ...
   if (( iVar1 != 0 ) && ( obj = (SSL_SESSION*)CRYPTO_zalloc(0x3a0, "ssl/ssl_sess.c", 0x6d) ),obj != (SSL_SESSION*)0x0) {
      ...
      for (int i_1019 = 0; i_1019 < 9; i_1019++) {
         obj[1].sid_ctx[( i_1019 + 12 )] = '\x01';
      }
      ...
      *(undefined8*)( obj[1].sid_ctx + 0x1c ) = uVar2;
      ...
      LOCK();
      for (int i_1020 = 0; i_1020 < 4; i_1020++) {
         obj[1].krb5_client_princ[( i_1020 + 176 )] = '\x01';
      }
      UNLOCK();
   ...
   *(undefined8*)( param_1 + 0x900 ) = 0;
   ...
   if (*(ulong*)( param_1 + 0x8d8 ) < 0x21) {
      ...
      *(SSL_SESSION**)( param_1 + 0x900 ) = ses;
      ...
      for (int i_1021 = 0; i_1021 < 8; i_1021++) {
         ses[1].sid_ctx[( i_1021 + 12 )] = '\0';
      }
   ...
   if (( c->tlsext_tick_lifetime_hint != 0 ) && ( uVar1._0_4_ = param_1[1].quiet_shutdown ),uVar1._4_4_ = param_1[1].max_send_fragment,iVar6 = CRYPTO_THREAD_write_lock(uVar1),iVar6 != 0) {
      ...
      if (lVar7 != 0) {
         ...
         if (( puVar2 != (undefined1*)0x0 ) && ( puVar3 = *(undefined1**)( ses[1].krb5_client_princ + 0xa0 ) ),puVar3 != (undefined1*)0x0) {
            ...
            for (int i_1025 = 0; i_1025 < 8; i_1025++) {
               ses[1].krb5_client_princ[( i_1025 + 168 )] = '\0';
            }
            for (int i_1024 = 0; i_1024 < 16; i_1024++) {
               ses[1].krb5_client_princ[( i_1024 + 152 )] = '\0';
            }
         }
         for (int i_1023 = 0; i_1023 < 4; i_1023++) {
            c[1].session_id[( i_1023 + 16 )] = '\x01';
         }
      ...
      for (int i_1022 = 0; i_1022 < 4; i_1022++) {
         c[1].session_id[( i_1022 + 16 )] = '\x01';
      }
   ...
   *piVar1 = *piVar1 + 1;
   ...
   if (pSVar6 == (SSL_SESSION*)0x0) {
      ...
      if (( puVar2 != (undefined1*)0x0 ) && ( puVar3 = *(undefined1**)( pSVar6[1].krb5_client_princ + 0xa0 ) ),puVar3 != (undefined1*)0x0) {
         ...
         for (int i_1027 = 0; i_1027 < 8; i_1027++) {
            pSVar6[1].krb5_client_princ[( i_1027 + 168 )] = '\0';
         }
         for (int i_1026 = 0; i_1026 < 16; i_1026++) {
            pSVar6[1].krb5_client_princ[( i_1026 + 152 )] = '\0';
         }
      }
      SSL_SESSION_free(pSVar6);
            ...
            *(undefined4*)( lVar9 + 0x2b0 ) = 1;
            ...
            if (puVar3 == (undefined1*)0x0) {
               *(undefined4*)( lVar9 + 0x2b0 ) = 1;
               ...
               for (int i_1029 = 0; i_1029 < 8; i_1029++) {
                  pSVar6[1].krb5_client_princ[( i_1029 + 168 )] = '\0';
               }
               for (int i_1028 = 0; i_1028 < 16; i_1028++) {
                  pSVar6[1].krb5_client_princ[( i_1028 + 152 )] = '\0';
               }
               *(undefined4*)( lVar9 + 0x2b0 ) = 1;
            }
            if (pcVar4 != (code*)0x0) {
   ...
   *(void**)&s[4].rwstate = arg;
      ...
      if (param_2 == 0) {
         do {
            ...
            if (( lVar1 != 0 ) && ( lVar2 = lVar2 != 0 )) {
               ...
               for (int i_1032 = 0; i_1032 < 8; i_1032++) {
                  ses[1].krb5_client_princ[( i_1032 + 168 )] = '\0';
               }
               for (int i_1031 = 0; i_1031 < 16; i_1031++) {
                  ses[1].krb5_client_princ[( i_1031 + 152 )] = '\0';
               }
            }
            for (int i_1030 = 0; i_1030 < 4; i_1030++) {
               ses[1].session_id[( i_1030 + 16 )] = '\x01';
            }
         ...
         do {
            ...
            if (( lVar1 != 0 ) && ( lVar2 = lVar2 != 0 )) {
               ...
               for (int i_1035 = 0; i_1035 < 8; i_1035++) {
                  ses[1].krb5_client_princ[( i_1035 + 168 )] = '\0';
               }
               for (int i_1034 = 0; i_1034 < 16; i_1034++) {
                  ses[1].krb5_client_princ[( i_1034 + 152 )] = '\0';
               }
            }
            for (int i_1033 = 0; i_1033 < 4; i_1033++) {
               ses[1].session_id[( i_1033 + 16 )] = '\x01';
            }
            if (*(code**)( param_1 + 0x68 ) != (code*)0x0) {
               ( **(code**)( param_1 + 0x68 ) )(param_1, ses);
            }
         ...
         do {
            while (true) {
               ...
               if (( lVar1 != 0 ) && ( lVar2 = lVar2 != 0 )) {
                  ...
                  for (int i_1038 = 0; i_1038 < 8; i_1038++) {
                     ses[1].krb5_client_princ[( i_1038 + 168 )] = '\0';
                  }
                  for (int i_1037 = 0; i_1037 < 16; i_1037++) {
                     ses[1].krb5_client_princ[( i_1037 + 152 )] = '\0';
                  }
               }
               for (int i_1036 = 0; i_1036 < 4; i_1036++) {
                  ses[1].session_id[( i_1036 + 16 )] = '\x01';
               }
               if (*(code**)( param_1 + 0x68 ) != (code*)0x0) {
                  ( **(code**)( param_1 + 0x68 ) )(param_1, ses);
               }
   ...
   if (( to->version == 0 ) || ( ( ( to->version & 0x80U ) != 0 && ( pSVar2 = (SSL*)ossl_quic_obj_get0_handshake_layer() ),pSVar2 != (SSL*)0x0 ) )) {
      if (session == (SSL_SESSION*)0x0) {
         ...
         if (( (SSL_METHOD*)to->rbio != (SSL_METHOD*)to->wbio ) && ( iVar1 = SSL_set_ssl_method(to, (SSL_METHOD*)to->rbio) ),iVar1 == 0) {
         ...
         ssl_clear_bad_session(pSVar2);
         if (( (SSL_METHOD*)to->rbio != (SSL_METHOD*)to->wbio ) && ( iVar1 = SSL_set_ssl_method(to, (SSL_METHOD*)to->rbio) ),iVar1 == 0) goto LAB_001026a4;

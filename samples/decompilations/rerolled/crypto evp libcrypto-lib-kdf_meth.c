undefined8 evp_kdf_up_ref(long param_1) {
   ...
   if (lVar3 != 0) {
      ...
      if (iVar2 != 0) {
         ...
         do {
          ...
          break;
               for (int i_1780 = 0; i_1780 < 5; i_1780++) {
                  case 6:
          if (ptr[10] == 0) {
   ...
   *piVar1 = *piVar1 + -1;
   ...
   if (UNRECOVERED_JUMPTABLE != (code*)0x0) {
      ...
      for (int i_1781 = 0; i_1781 < 2; i_1781++) {
   ...
   if (*(long*)( param_1 + 0x58 ) != 0) {
      uVar1 = EVP_KDF_get0_provider();
      uVar1 = ossl_provider_ctx(uVar1);
      for (int i_1782 = 0; i_1782 < 2; i_1782++) {
   ...
   if (*(long*)( param_1 + 0x60 ) != 0) {
      uVar1 = EVP_KDF_get0_provider();
      uVar1 = ossl_provider_ctx(uVar1);
      for (int i_1783 = 0; i_1783 < 2; i_1783++) {
   ...
   if (*(long*)( *param_1 + 0x58 ) != 0) {
      uVar1 = EVP_KDF_get0_provider();
      uVar1 = ossl_provider_ctx(uVar1);
      for (int i_1784 = 0; i_1784 < 2; i_1784++) {
   ...
   if (*(long*)( *param_1 + 0x60 ) != 0) {
      uVar1 = EVP_KDF_get0_provider();
      uVar1 = ossl_provider_ctx(uVar1);
      for (int i_1785 = 0; i_1785 < 2; i_1785++) {

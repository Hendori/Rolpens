/* icu_76_godot::RBBIRuleBuilder::RBBIRuleBuilder(icu_76_godot::UnicodeString const&, UParseError*,
   UErrorCode&) */void icu_76_godot::RBBIRuleBuilder::RBBIRuleBuilder(RBBIRuleBuilder *this, UnicodeString *param_1, UParseError *param_2, UErrorCode *param_3) {
   int iVar1;
   UVector *pUVar2;
   ...
   *(undefined1(*) [16])( this + 0xb0 ) = (undefined1[16])0x0;
   if (param_2 != (UParseError*)0x0) {
      ...
      *(undefined1(*) [16])param_2 = (undefined1[16])0x0;
      for (int i = 0; i < 3; i++) {
         *(undefined1(*) [16])( param_2 + ( 16*i + 16 ) ) = (undefined1[16])0;
      }
      ...
      *(RBBIRuleScanner**)( this + 0x68 ) = this_00;
      ...
      if (this_01 == (RBBISetBuilder*)0x0) {
         ...
         *(RBBISetBuilder**)( this + 0xa0 ) = this_01;
         if (( iVar1 < 1 ) && ( ( ( *(long*)( this + 0x68 ) == 0 || ( *(long*)( this + 0xa8 ) == 0 ) ) || ( *(long*)( this + 0xb8 ) == 0 ) ) )) {
            LAB_00100158:*(undefined4*)param_3 = 7;
            return;
         }
...
/* icu_76_godot::RBBIRuleBuilder::optimizeTables() */void icu_76_godot::RBBIRuleBuilder::optimizeTables(RBBIRuleBuilder *this) {
   long lVar1;
   char cVar2;
   int iVar3;
   char cVar4;
...
/* icu_76_godot::RBBIRuleBuilder::~RBBIRuleBuilder() */void icu_76_godot::RBBIRuleBuilder::~RBBIRuleBuilder(RBBIRuleBuilder *this) {
...
;
   ...
   for (int i = 0; i < 4; i++) {
      pRVar1 = *(RBBINode**)( this + ( 8*i + 112 ) );
      if (pRVar1 != (RBBINode*)0) {
         icu_76_godot::RBBINode::~RBBINode(pRVar1);
         icu_76_godot::UMemory::operator_delete((UMemory*)pRVar1, pvVar3);
      }
...
/* icu_76_godot::RBBIRuleBuilder::flattenData() [clone .part.0] */undefined8 * __thiscall icu_76_godot::RBBIRuleBuilder::flattenData(RBBIRuleBuilder *this){
   ushort uVar1;
   int iVar2;
   uint uVar3;
   uint uVar4;
   ...
   if ((short)uVar1 < 0) {
      ...
      LAB_001006bd:pRVar9 = (RBBIRuleBuilder*)0x0;
   }
 ...
 while ( (int)lVar11 < *(int*)( lVar14 + 8 ) );
   ...
   if ((short)uVar1 < 0) {
      ...
      LAB_001006d5:pRVar9 = (RBBIRuleBuilder*)0x0;
   }

   u_strToUTF8WithSub_76_godot(( ulong ) * (uint*)( puVar7 + 5 ) + (long)puVar7, uVar4, &local_8c, pRVar9, iVar2, 0xfffd, 0, *(undefined8*)( this + 0x10 ));
   puVar12 = (undefined8*)0x0;
   if (**(int**)( this + 0x10 ) < 1) {
      puVar12 = puVar7;
   ...
   LAB_00100668:uprv_free_76_godot(puVar7);
...
/* icu_76_godot::RBBIRuleBuilder::flattenData() */undefined8 icu_76_godot::RBBIRuleBuilder::flattenData(RBBIRuleBuilder *this) {
   undefined8 uVar1;
   if (**(int**)( this + 0x10 ) < 1) {
...
/* icu_76_godot::RBBIRuleBuilder::build(UErrorCode&) */undefined8 icu_76_godot::RBBIRuleBuilder::build(RBBIRuleBuilder *this, UErrorCode *param_1) {
   ...
   if (*(int*)param_1 < 1) {
      ...
      if (this_00 == (RBBITableBuilder*)0x0) {
         ...
         *(undefined4*)param_1 = 7;
         ...
         icu_76_godot::RBBITableBuilder::RBBITableBuilder(this_00, this, (RBBINode**)( this + 0x70 ), param_1);
...
/* icu_76_godot::RBBIRuleBuilder::createRuleBasedBreakIterator(icu_76_godot::UnicodeString const&,
   UParseError*, UErrorCode&) */RuleBasedBreakIterator *icu_76_godot::RBBIRuleBuilder::createRuleBasedBreakIterator(UnicodeString *param_1, UParseError *param_2, UErrorCode *param_3) {
   ...
   if (*(int*)param_3 < 1) {
      ...
      if (*(int*)param_3 < 1) {
         this(RuleBasedBreakIterator * icu_76_godot::UMemory::operator_new((UMemory*)0x2f0, (ulong)pUVar2));
   ...
   LAB_0010087b:~RBBIRuleBuilder(aRStack_f8);

undefined8 transfer_cb(undefined8 param_1, undefined4 *param_2) {
   ...
   *(undefined8*)( param_2 + 4 ) = uVar1;
   ...
   undefined4 *ptr;
   long lVar1;
   if (( param_1 != 0 ) && ( ptr = (undefined4*)CRYPTO_zalloc(0x20, "crypto/evp/s_lib.c", 0x27) ),ptr != (undefined4*)0x0) {
      LOCK();
      *ptr = 1;
      UNLOCK();
   ...
   undefined8 uVar1;
   if (param_1 != 0) {
      uVar1 = evp_skeymgmt_export(*(undefined8*)( param_1 + 0x18 ), *(undefined8*)( param_1 + 0x10 ), param_2, param_3, param_4);
      return uVar1;
   }
   ERR_new();
   ...
   if (( param_2 == 0 || param_3 == 0 ) || ( param_1 == 0 )) {
      ...
      local_28 = param_2;
      local_20 = param_3;
      uVar1 = evp_skeymgmt_export(*(undefined8*)( param_1 + 0x18 ), *(undefined8*)( param_1 + 0x10 ), 2, get_secret_key, &local_28);
   }
   ...
   *param_1 = *param_1 + -1;
   ...
   CRYPTO_free(param_1);
   return;
}long EVP_SKEY_import(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined4 param_4, undefined8 param_5) {
   long lVar1;
   long lVar2;
   long lVar3;
   ...
   if (lVar2 == 0) {
      ...
      lVar1 = evp_skeymgmt_import(*(undefined8*)( lVar2 + 0x18 ), param_4, param_5);
   ...
   return lVar3;
}void EVP_SKEY_import_raw_key(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5) {
   long in_FS_OFFSET;
   undefined8 local_b8;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}long EVP_SKEY_generate(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4) {
   long lVar1;
   long lVar2;
   long lVar3;
   lVar1 = EVP_SKEYMGMT_fetch();
   ...
   if (lVar2 == 0) {
      ...
      lVar1 = evp_skeymgmt_generate(*(undefined8*)( lVar2 + 0x18 ), param_4);
      *(long*)( lVar2 + 0x10 ) = lVar1;
      lVar3 = lVar2;
      if (lVar1 == 0) {
         lVar3 = 0;
   ...
   undefined8 uVar1;
   if (( param_1 != 0 ) && ( UNRECOVERED_JUMPTABLE = *(code**)( *(long*)( param_1 + 0x18 ) + 0x50 ) ),UNRECOVERED_JUMPTABLE != (code*)0x0) {
      for (int i_2283 = 0; i_2283 < 2; i_2283++) {
   ...
   if (param_3 == 0) {
      ...
      LAB_00100630:if (piVar2 == (int*)0x0) {
         ERR_new();
      ...
      if (( **(int**)( param_1 + 0x18 ) == *piVar2 ) && ( *(long*)( *(int**)( param_1 + 0x18 ) + 6 ) == *(long*)( piVar2 + 6 ) )) goto LAB_001006b0;
      ...
      LAB_001006b0:iVar1 = EVP_SKEY_up_ref(param_1);
      if (iVar1 != 0) {
   ...
   EVP_SKEY_free(0);
   param_1 = 0;
   LAB_00100693:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();

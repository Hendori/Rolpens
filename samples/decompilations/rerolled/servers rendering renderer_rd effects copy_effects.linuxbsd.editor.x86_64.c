/* CowData<char32_t>::_ref(CowData<char32_t> const&) [clone .part.0] */void CowData<char32_t>::_ref(CowData<char32_t> *this, CowData *param_1) {
   ...
   _err_print_error("_copy_on_write", "./core/templates/cowdata.h", 0x13a, "Parameter \"mem_new\" is null.", 0, 0);
   return;
}/* RendererRD::CopyEffects::get_singleton() */undefined8 RendererRD::CopyEffects::get_singleton(void) {
   return singleton;
}/* RendererRD::CopyEffects::~CopyEffects() */void RendererRD::CopyEffects::~CopyEffects(CopyEffects *this) {
   char cVar1;
   undefined8 uVar2;
   ShaderRD *this_00;
   ...
   *(undefined***)( this + 0x48 ) = &PTR__BlurRasterShaderRD_00119ae0;
   ...
   return;
}/* RendererRD::CopyEffects::set_color_raster(RID, Color const&, Rect2i const&) */void RendererRD::CopyEffects::set_color_raster(undefined8 param_1, undefined8 param_2, char *param_3, undefined8 param_4, undefined4 *param_5, Rect2i *param_6) {
   long *plVar1;
   Version *pVVar2;
   char cVar3;
   code *pcVar4;
   ...
   if (*param_3 == '\0') {
      _err_print_error("set_color_raster", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x3ca, "Condition \"!prefer_raster_effects\" is true.", "Can\'t use the raster version of the set_color shader with the clustered renderer.", 0, 0);
   ...
   for (int i = 0; i < 3; i++) {
      *(undefined1(*) [16])( param_3 + ( 16*i + 2912 ) ) = (undefined1[16])0;
   }
   *(undefined4*)( param_3 + 0xb80 ) = *param_5;
   for (int i = 0; i < 3; i++) {
      *(undefined4*)( param_3 + ( 4*i + 2948 ) ) = param_5[( i + 1 )];
   }
   uVar7 = FramebufferCacheRD::get_cache<RID>(pFVar5, param_4);
   uVar13 = *(ulong*)( param_3 + 0xd08 );
   if (*(long*)( param_3 + 0xba8 ) == 0) {
      lVar17 = 0;
      LAB_00100cb3:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 3, lVar17, "p_variant", "variant_defines.size()", "", false, false);
   } else {
      lVar17 = *(long*)( *(long*)( param_3 + 0xba8 ) + -8 );
      if (lVar17 < 4) goto LAB_00100cb3;
      lVar17 = *(long*)( param_3 + 3000 );
      if (lVar17 == 0) {
         LAB_00100ecc:lVar16 = 0;
         LAB_00100ecf:uVar13 = 3;
         LAB_00100eef:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar13, lVar16, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar4 = (code*)invalidInstructionException();
         ( *pcVar4 )();
      ...
      if (( uVar13 == 0 ) || ( *(uint*)( param_3 + 0xc64 ) <= (uint)uVar13 )) {
         LAB_00100d75:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
      } else {
         lVar17 = ( ( uVar13 & 0xffffffff ) % ( ulong ) * (uint*)( param_3 + 0xc60 ) ) * 0xa0 + *(long*)( *(long*)( param_3 + 0xc50 ) + ( ( uVar13 & 0xffffffff ) / ( ulong ) * (uint*)( param_3 + 0xc60 ) ) * 8 );
            ...
            if (*(long*)( lVar17 + 0x18 ) != 0) {
               ...
               if (*(long*)( param_3 + 0x10f8 ) == 0) {
                  ...
                  if (*(uint*)( param_3 + 0x11e8 ) != 0) {
                     ...
                     do {
                        if (( ( ( *plVar11 == -1 ) && ( lVar17 == plVar11[1] ) ) && ( param_3[0x1106] == *(byte*)( (long)plVar11 + 0x14 ) ) ) && ( ( (int)plVar11[2] == 0 && ( (int)plVar11[3] == 0 ) ) )) {
                           lVar17 = plVar11[4];
                           param_3[0x10b8] = '\0';
                           goto LAB_00100de1;
                        }
                  ...
                  lVar17 = PipelineCacheRD::_generate_version((long)pcVar12, -1, SUB81(lVar17, 0), (uint)(byte)param_3[0x1106], 0);
                  param_3[0x10b8] = '\0';
               }
               LAB_00100de1:RenderingDevice::draw_list_bind_render_pipeline(uVar8, pvVar9, lVar17);
   ...
   LAB_00100cf0:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      uVar7 = 0x3dd;
      pcVar12 = "Condition \"shader.is_null()\" is true.";
      LAB_00100d16:_err_print_error("set_color_raster", "servers/rendering/renderer_rd/effects/copy_effects.cpp", uVar7, pcVar12, 0, 0);
      return;
   }
   LAB_0010105d:/* WARNING: Subroutine does not return */__stack_chk_fail();
   ...
   _err_print_error("push_back", "./core/templates/vector.h", 0x142, "Condition \"err\" is true. Returning: true", 0, 0);
   return;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RendererRD::CopyEffects::CopyEffects(bool) */void RendererRD::CopyEffects::CopyEffects(CopyEffects *this, bool param_1) {
   ShaderRD *this_00;
   long *plVar1;
   ...
   *(undefined8*)( this + 0xaf0 ) = 0;
   ...
   for (uVar43 = ( ulong )(( (int)this - (int)(undefined8*)( ( ulong )(this + 0xb00) & 0xfffffffffffffff8 ) ) + 0xb60U >> 3); uVar43 != 0; uVar43 = uVar43 - 1) {
      *puVar55 = 0;
   ...
   if (param_1) {
      ...
      *(undefined8*)( this + 0x1c0 ) = uVar41;
      ...
      do {
         ...
         if (*(long*)( this + 0x60 ) == 0) {
            lVar45 = 0;
            LAB_0010381a:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, uVar43, lVar45, "p_variant", "variant_defines.size()", "", false, false);
            LAB_00103850:uVar41 = 0;
         } else {
            ...
            if (( uVar44 == 0 ) || ( *(uint*)( this + 0x11c ) <= (uint)uVar44 )) {
               LAB_001055f0:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
               goto LAB_00103850;
            }
            lVar45 = ( ( uVar44 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x118 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x108 ) + ( ( uVar44 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x118 ) ) * 8 );
   ...
   *(undefined8*)( this + 0x970 ) = 0;
   ...
   for (uVar44 = ( ulong )(( (int)pPVar2 - (int)(undefined8*)( ( ulong )(this + 0x920) & 0xfffffffffffffff8 ) ) + 0x60U >> 3); uVar44 != 0; uVar44 = uVar44 - 1) {
      *puVar55 = 0;
      puVar55 = puVar55 + (ulong)bVar62 * -2 + 1;
   }
   uVar40 = ShaderRD::version_create();
   *(undefined8*)( this + 0xaf0 ) = uVar40;
   LAB_00101ece:cVar38 = ShaderRD::is_variant_enabled((int)this_01);
   ...
   if (*(long*)( this + 0x990 ) == 0) {
      lVar45 = 0;
      LAB_00103c63:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, uVar43, lVar45, "p_variant", "variant_defines.size()", "", false, false);
      uVar53 = 0;
   } else {
      ...
      if (*(char*)( lVar45 + uVar43 ) == '\0') {
         ...
         if (( uVar44 != 0 ) && ( (uint)uVar44 < *(uint*)( this + 0xa4c ) )) {
            lVar45 = ( ( uVar44 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0xa48 ) ) * 0xa0 + *(long*)( *(long*)( this + 0xa38 ) + ( ( uVar44 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0xa48 ) ) * 8 );
            if (*(int*)( lVar45 + 0x98 ) == (int)( uVar44 >> 0x20 )) {
               iVar54 = (int)lVar45;
               if (*(char*)( lVar45 + 0x91 ) != '\0') {
   ...
   LAB_0010200d:uVar40 = RenderingDevice::compute_pipeline_create(uVar40, uVar53, (StringName*)&local_118);
   *(undefined8*)( this + ( (long)(int)uVar43 + 0x15e ) * 8 + 8 ) = uVar40;
   ...
   joined_r0x0010206c:uVar43 = uVar43 + 1;
   if (uVar43 == 0xd) goto LAB_00102078;
   goto LAB_00101ece;
   LAB_00102e70:lVar56 = 0;
   LAB_00102e73:Var63 = SUB169(ZEXT816(1), 0) << 0x40;
   goto LAB_00102e8d;
   LAB_00102078:CowData<String>::_unref((CowData<String>*)( local_178 + 8 ));
   local_1a0 = 0;
   local_118 = 0x638b;
   uStack_116 = 0x11;
   uStack_114 = 0;
   ...
   do {
      ...
      if (cVar38 == '\0') {
         ...
         if (*(long*)( this + 0xba8 ) == 0) {
            lVar45 = 0;
            LAB_00103989:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, uVar43, lVar45, "p_variant", "variant_defines.size()", "", false, false);
            LAB_001039bf:uVar40 = 0;
         } else {
            ...
            if (*(char*)( lVar45 + uVar43 ) != '\0') {
               if (( uVar44 == 0 ) || ( *(uint*)( this + 0xc64 ) <= (uint)uVar44 )) {
                  LAB_00105688:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
                  uVar40 = 0;
                  goto LAB_001025d4;
               }
               lVar45 = ( ( uVar44 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0xc60 ) ) * 0xa0 + *(long*)( *(long*)( this + 0xc50 ) + ( ( uVar44 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0xc60 ) ) * 8 );
               if (*(int*)( lVar45 + 0x98 ) != (int)( uVar44 >> 0x20 )) {
                  if (*(int*)( lVar45 + 0x98 ) + 0x80000000U < 0x7fffffff) {
                     _err_print_error("get_or_null", "./core/templates/rid_owner.h", 0x103, "Method/function failed. Returning: nullptr", "Attempting to use an uninitialized RID", 0, 0);
                  }
               ...
               LAB_00103d78:lVar56 = 0;
               LAB_00103d7b:Var63 = SUB169(ZEXT816(1), 0) << 0x40;
               goto LAB_00102e8d;
            }
            _err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa7, "Condition \"!variants_enabled[p_variant]\" is true. Returning: RID()", 0, 0);
            uVar40 = 0;
         }
         LAB_001025d4:PipelineCacheRD::setup(pPVar49, uVar40, 5, local_2b0, local_2b8, (StringName*)&local_118, &local_68, 0, local_280);
         lVar45 = local_130;
         if (local_130 != 0) {
            LOCK();
            plVar1 = (long*)( local_130 + -0x10 );
   ...
   *(ulong*)( this + 0x15d8 ) = uVar43;
   if (*(long*)( this + 0x1478 ) != 0) {
      ...
      if (( uVar43 == 0 ) || ( *(uint*)( this + 0x1534 ) <= (uint)uVar43 )) {
         LAB_001064fb:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
         uVar40 = 0;
         goto LAB_00103126;
      }
      lVar45 = ( ( uVar43 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x1530 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x1520 ) + ( ( uVar43 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x1530 ) ) * 8 );
      ...
      LAB_001037f8:lVar56 = 0;
      LAB_001037fb:Var63 = SUB169(ZEXT816(1), 0) << 0x40;
      uVar43 = uVar44;
      LAB_00102e8d:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar43, lVar56, "p_index", "size()", "", false, SUB91((unkuint9)Var63 >> 0x40, 0));
      _err_flush_stdout();
      /* WARNING: Does not return */
   ...
   lVar45 = 0;
   LAB_001056b7:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 0, lVar45, "p_variant", "variant_defines.size()", "", false, false);
   LAB_001056ec:uVar40 = 0;
   LAB_00103126:uVar41 = _UNK_001329c8;
   uVar27 = _LC46;
   uVar28 = __LC71;
   ...
   local_158 = 1;
   PipelineCacheRD::setup((PipelineCacheRD*)( this + 0x15e0 ), uVar40, 5, local_2b0, local_2b8, (StringName*)&local_118, (StringName*)&local_68, 0, local_280);
   lVar45 = local_130;
   if (local_130 != 0) {
      LOCK();
      plVar1 = (long*)( local_130 + -0x10 );
   ...
   if (*this != (CopyEffects)0x0) {
      ...
      *(undefined8*)( this + 0x1a18 ) = uVar40;
      ...
      if (*(long*)( this + 0x18b8 ) == 0) {
         lVar45 = 0;
         LAB_00105803:uStack_100 = uVar29;
         uStack_fc = uVar33;
         uStack_e4 = uVar29;
         uStack_e0 = uVar33;
         uStack_dc = uVar35;
         local_d8 = uVar37;
         _err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 0, lVar45, "p_variant", "variant_defines.size()", "", false, false);
         LAB_00105838:uVar40 = 0;
         LAB_00103689:PipelineCacheRD::setup((PipelineCacheRD*)( this + 0x1a28 ), uVar40, 5, local_2b0, local_2b8, (StringName*)&local_118, (StringName*)&local_68, 0, local_280);
         lVar45 = local_130;
         if (local_130 != 0) {
            LOCK();
            plVar1 = (long*)( local_130 + -0x10 );
      ...
      if (pcVar3 != (char*)0x0) {
         ...
         if (( uVar43 == 0 ) || ( *(uint*)( this + 0x1974 ) <= (uint)uVar43 )) {
            LAB_0010593f:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
            uVar40 = 0;
            goto LAB_00103689;
         }
         lVar45 = ( ( uVar43 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x1970 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x1960 ) + ( ( uVar43 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x1970 ) ) * 8 );
         if (*(int*)( lVar45 + 0x98 ) != (int)( uVar43 >> 0x20 )) {
            if (*(int*)( lVar45 + 0x98 ) + 0x80000000U < 0x7fffffff) {
               _err_print_error("get_or_null", "./core/templates/rid_owner.h", 0x103, "Method/function failed. Returning: nullptr", "Attempting to use an uninitialized RID", 0, 0);
            }
   ...
   *(undefined8*)( this + 0x1a18 ) = uVar40;
   ...
   if (*(long*)( this + 0x1740 ) == 0) {
      lVar45 = 0;
      LAB_001057c3:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 0, lVar45, "p_variant", "variant_defines.size()", "", false, false);
      LAB_001057f8:uVar46 = 0;
   } else {
      ...
      if (*pcVar3 != '\0') {
         if (( uVar43 == 0 ) || ( *(uint*)( this + 0x17fc ) <= (uint)uVar43 )) {
            LAB_001059ac:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0);
            uVar46 = 0;
            goto LAB_00103f6c;
         }
         lVar45 = ( ( uVar43 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x17f8 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x17e8 ) + ( ( uVar43 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x17f8 ) ) * 8 );
         if (*(int*)( lVar45 + 0x98 ) != (int)( uVar43 >> 0x20 )) {
            if (*(int*)( lVar45 + 0x98 ) + 0x80000000U < 0x7fffffff) {
               _err_print_error("get_or_null", "./core/templates/rid_owner.h", 0x103, "Method/function failed. Returning: nullptr", "Attempting to use an uninitialized RID", 0, 0);
            }
   ...
   LAB_00103f6c:uVar40 = RenderingDevice::compute_pipeline_create(uVar40, uVar46, (StringName*)&local_118);
   *(undefined8*)( this + 0x1a20 ) = uVar40;
   ...
   PipelineCacheRD::clear();
   LAB_00103fbf:CowData<String>::_unref((CowData<String>*)&local_1a0);
   ProjectSettings::get_singleton();
   StringName::StringName((StringName*)&local_118, "rendering/reflections/sky_reflections/fast_filter_high_quality", false);
   ...
   if (*this != (CopyEffects)0x0) {
      ...
      *(undefined8*)( this + 0x1e50 ) = uVar40;
      do {
         ...
         if (cVar38 == '\0') {
            ...
            if (*(long*)( this + 0x1cf0 ) == 0) {
               lVar45 = 0;
               LAB_0010577b:uStack_100 = uVar29;
               uStack_fc = uVar33;
               uStack_e4 = uVar29;
               uStack_e0 = uVar33;
               uStack_dc = uVar35;
               local_d8 = uVar37;
               _err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, uVar43, lVar45, "p_variant", "variant_defines.size()", "", false, false);
               LAB_001057b1:uVar40 = 0;
            } else {
               ...
               if (*(char*)( lVar45 + uVar43 ) != '\0') {
                  if (( uVar44 == 0 ) || ( *(uint*)( this + 0x1dac ) <= (uint)uVar44 )) {
                     LAB_00106993:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
                     uVar40 = 0;
                     goto LAB_001045f6;
                  }
                  lVar45 = ( ( uVar44 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x1da8 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x1d98 ) + ( ( uVar44 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x1da8 ) ) * 8 );
                  if (*(int*)( lVar45 + 0x98 ) != (int)( uVar44 >> 0x20 )) {
                     if (*(int*)( lVar45 + 0x98 ) + 0x80000000U < 0x7fffffff) {
                        _err_print_error("get_or_null", "./core/templates/rid_owner.h", 0x103, "Method/function failed. Returning: nullptr", "Attempting to use an uninitialized RID", 0, 0, uVar40);
                     }
                     goto LAB_00106993;
                  }
                  iVar52 = (int)lVar45;
            ...
            LAB_001045f6:PipelineCacheRD::setup(pCVar50, uVar40, 5, local_2b0, local_2b8, (StringName*)&local_118, (StringName*)&local_68, 0, local_280);
            lVar45 = local_130;
            if (local_130 != 0) {
               LOCK();
               plVar1 = (long*)( local_130 + -0x10 );
      ...
      local_f8 = 0;
      Vector<RenderingDevice::Uniform>::push_back((Vector<RenderingDevice::Uniform>*)local_2b8, (StringName*)&local_118);
      uVar40 = RenderingDevice::get_singleton();
      ...
      lVar45 = ( ( uVar5 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x1da8 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x1d98 ) + ( ( uVar5 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x1da8 ) ) * 8 );
   ...
   *(undefined8*)( this + 0x1e50 ) = uVar40;
   do {
      ...
      if (*(long*)( this + 0x1b78 ) == 0) {
         lVar45 = 0;
         LAB_00105daa:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, uVar43, lVar45, "p_variant", "variant_defines.size()", "", false, false);
         LAB_00105de0:uVar46 = 0;
      } else {
         ...
         if (*(char*)( lVar45 + uVar43 ) != '\0') {
            if (( uVar44 == 0 ) || ( *(uint*)( this + 0x1c34 ) <= (uint)uVar44 )) {
               LAB_00106699:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.");
               uVar46 = 0;
               goto LAB_00105ba1;
            }
            lVar45 = ( ( uVar44 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x1c30 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x1c20 ) + ( ( uVar44 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x1c30 ) ) * 8 );
            if (*(int*)( lVar45 + 0x98 ) != (int)( uVar44 >> 0x20 )) {
               if (*(int*)( lVar45 + 0x98 ) + 0x80000000U < 0x7fffffff) {
                  _err_print_error("get_or_null", "./core/templates/rid_owner.h", 0x103, "Method/function failed. Returning: nullptr", "Attempting to use an uninitialized RID", 0, 0);
               }
      ...
      LAB_00105ba1:uVar40 = RenderingDevice::compute_pipeline_create(uVar40, uVar46, (StringName*)&local_118);
   ...
   if (*(long*)( this + 0x1b78 ) == 0) {
      lVar45 = 0;
      LAB_0010585a:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, uVar43, lVar45, "p_variant", "variant_defines.size()", "", false, false);
      LAB_00105876:uVar46 = 0;
   } else {
      lVar45 = *(long*)( *(long*)( this + 0x1b78 ) + -8 );
      if (lVar45 <= (long)uVar43) goto LAB_0010585a;
      lVar45 = *(long*)( this + 0x1b88 );
      if (lVar45 == 0) {
         LAB_00105e78:lVar56 = 0;
         LAB_00105e7b:Var63 = SUB169(ZEXT816(1), 0) << 0x40;
         goto LAB_00102e8d;
      }
      lVar56 = *(long*)( lVar45 + -8 );
      if (lVar56 <= (long)uVar43) goto LAB_00105e7b;
      if (*(char*)( lVar45 + uVar43 ) != '\0') {
         if (( uVar44 == 0 ) || ( *(uint*)( this + 0x1c34 ) <= (uint)uVar44 )) {
            LAB_00106a57:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.");
            uVar46 = 0;
            goto LAB_00104855;
         }
         lVar45 = ( ( uVar44 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x1c30 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x1c20 ) + ( ( uVar44 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x1c30 ) ) * 8 );
         ...
         if (iVar54 != (int)( uVar44 >> 0x20 )) {
            LAB_00106a17:if (iVar54 + 0x80000000U < 0x7fffffff) {
               _err_print_error("get_or_null", "./core/templates/rid_owner.h", 0x103, "Method/function failed. Returning: nullptr", "Attempting to use an uninitialized RID", 0, 0);
            }
            goto LAB_00106a57;
         }
      ...
      LAB_001069eb:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa7, "Condition \"!variants_enabled[p_variant]\" is true. Returning: RID()");
      uVar46 = 0;
   }
   LAB_00104855:uVar40 = RenderingDevice::uniform_set_create<Vector<RenderingDevice::Uniform>>(uVar40, local_2b8, uVar46, 1);
   ...
   if (*this == (CopyEffects)0x0) {
      ...
      *(undefined8*)( this + 0x2688 ) = uVar40;
      ...
      if (*(long*)( this + 0x23b0 ) == 0) {
         lVar45 = 0;
         LAB_00106210:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 0, lVar45, "p_variant", "variant_defines.size()", "", false, false);
         LAB_00106245:uVar46 = 0;
      } else {
         ...
         if (*pcVar3 != '\0') {
            if (( uVar43 == 0 ) || ( *(uint*)( this + 0x246c ) <= (uint)uVar43 )) {
               LAB_00106c79:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
               uVar46 = 0;
               goto LAB_001061a8;
            }
            lVar45 = ( ( uVar43 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x2468 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x2458 ) + ( ( uVar43 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x2468 ) ) * 8 );
            if (*(int*)( lVar45 + 0x98 ) != (int)( uVar43 >> 0x20 )) {
               if (*(int*)( lVar45 + 0x98 ) + 0x80000000U < 0x7fffffff) {
                  _err_print_error("get_or_null", "./core/templates/rid_owner.h", 0x103, "Method/function failed. Returning: nullptr", "Attempting to use an uninitialized RID", 0, 0);
               }
      ...
      LAB_001061a8:uVar40 = RenderingDevice::compute_pipeline_create(uVar40, uVar46, (StringName*)&local_118);
   ...
   *(undefined8*)( this + 0x2688 ) = uVar40;
   ...
   if (*(long*)( this + 0x2528 ) == 0) {
      lVar45 = 0;
      LAB_001058c3:uStack_100 = uVar29;
      uStack_fc = uVar33;
      uStack_e4 = uVar29;
      uStack_e0 = uVar33;
      uStack_dc = uVar35;
      ...
      if (*pcVar3 != '\0') {
         if (( uVar43 == 0 ) || ( *(uint*)( this + 0x25e4 ) <= (uint)uVar43 )) {
            LAB_00106ba2:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
            uVar40 = 0;
            goto LAB_00104c10;
         }
         lVar45 = ( ( uVar43 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x25e0 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x25d0 ) + ( ( uVar43 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x25e0 ) ) * 8 );
         if (*(int*)( lVar45 + 0x98 ) != (int)( uVar43 >> 0x20 )) {
            if (*(int*)( lVar45 + 0x98 ) + 0x80000000U < 0x7fffffff) {
               _err_print_error("get_or_null", "./core/templates/rid_owner.h", 0x103, "Method/function failed. Returning: nullptr", "Attempting to use an uninitialized RID", 0, 0);
            }
   ...
   LAB_00104c10:PipelineCacheRD::setup((PipelineCacheRD*)( this + 0x2698 ), uVar40, 5, local_2b0, local_2b8, (StringName*)&local_118, (StringName*)&local_68, 0, local_280);
   lVar45 = local_130;
   if (local_130 != 0) {
      LOCK();
      plVar1 = (long*)( local_130 + -0x10 );
   ...
   LAB_00104cdb:CowData<String>::_unref((CowData<String>*)&local_1a0);
   local_118 = 0x6413;
   uStack_116 = 0x11;
   uStack_114 = 0;
   local_1b0 = 0;
   ...
   *(undefined8*)( this + 0x2948 ) = uVar42;
   ...
   do {
      ...
      if (cVar38 != '\0') {
         ...
         if (( (uint)uVar43 & 0xfffffffa ) == 2) {
            ...
            LAB_001052c6:local_80 = local_b0;
            uStack_78 = uStack_a8;
         } else {
            local_118 = 0;
            uStack_116 = 0;
         ...
         if (*(long*)( this + 0x27e8 ) == 0) {
            lVar45 = 0;
            LAB_00105883:uStack_100 = uVar29;
            uStack_fc = uVar33;
            uStack_e4 = uVar29;
            uStack_e0 = uVar33;
            uStack_dc = uVar35;
            ...
            if (*(char*)( lVar45 + uVar43 ) != '\0') {
               if (( uVar44 == 0 ) || ( *(uint*)( this + 0x28a4 ) <= (uint)uVar44 )) {
                  LAB_00106b03:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
                  uVar40 = 0;
                  goto LAB_001054a9;
               }
               lVar45 = ( ( uVar44 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x28a0 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x2890 ) + ( ( uVar44 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x28a0 ) ) * 8 );
               if (*(int*)( lVar45 + 0x98 ) != (int)( uVar44 >> 0x20 )) {
                  if (*(int*)( lVar45 + 0x98 ) + 0x80000000U < 0x7fffffff) {
                     _err_print_error("get_or_null", "./core/templates/rid_owner.h", 0x103, "Method/function failed. Returning: nullptr", "Attempting to use an uninitialized RID", 0, 0);
                  }
         ...
         LAB_001054a9:PipelineCacheRD::setup(pCVar51, uVar40, 5);
         lVar45 = local_130;
         if (local_130 != 0) {
            LOCK();
            plVar1 = (long*)( local_130 + -0x10 );
...
}/* RendererRD::CopyEffects::copy_to_rect(RID, RID, Rect2i const&, bool, bool, bool, bool, bool) */void RendererRD::CopyEffects::copy_to_rect(CopyEffects *this, undefined8 param_2, undefined8 param_3, undefined4 *param_4, char param_5, char param_6, char param_7, uint param_8, char param_9) {
   long *plVar1;
   Version *pVVar2;
   code *pcVar3;
   uint uVar4;
   ...
   if (UniformSetCacheRD::singleton == (UniformSetCacheRD*)0x0) {
      if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
         ...
         LAB_001075b9:_err_print_error("copy_to_rect", "servers/rendering/renderer_rd/effects/copy_effects.cpp", uVar10, pcVar14, 0, 0);
         return;
      }
      goto LAB_001076b3;
   }
   ...
   *(undefined8*)( this + 0x970 ) = 0;
   ...
   for (uVar12 = ( ulong )(( uVar4 - (int)(undefined8*)( ( ulong )(this + 0x920) & 0xfffffffffffffff8 ) ) + 0x60 >> 3); uVar12 != 0; uVar12 = uVar12 - 1) {
      *puVar15 = 0;
   ...
   *(undefined4*)( this + 0x918 ) = *param_4;
   for (int i = 0; i < 3; i++) {
      *(undefined4*)( this + ( 4*i + 2332 ) ) = param_4[( i + 1 )];
   }
   ...
   *(undefined4*)( this + 0x92c ) = param_4[1];
   ...
   if (iVar7 == 0) {
      do {
         if (uVar12 == 0) {
            lVar8 = 0;
            LAB_00107363:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar16, lVar8, "p_index", "size()", "", false, false);
         } else {
            lVar8 = *(long*)( uVar12 - 8 );
   ...
   if (*(long*)( this + 0x990 ) == 0) {
      lVar8 = 0;
      LAB_00107613:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, uVar19, lVar8, "p_variant", "variant_defines.size()", "", false, false);
      LAB_00107008:_err_print_error("copy_to_rect", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x179, "Condition \"shader.is_null()\" is true.", 0, 0);
   } else {
      ...
      uVar13 = uVar19;
      if (lVar8 == 0) {
         LAB_00107420:lVar16 = 0;
         uVar13 = uVar19;
         LAB_00107441:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar13, lVar16, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
      ...
      if (( uVar12 == 0 ) || ( *(uint*)( this + 0xa4c ) <= (uint)uVar12 )) {
         LAB_001073f0:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
         goto LAB_00107008;
      }
      lVar8 = ( ( uVar12 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0xa48 ) ) * 0xa0 + *(long*)( *(long*)( this + 0xa38 ) + ( ( uVar12 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0xa48 ) ) * 8 );
      ...
      uVar10 = RenderingDevice::get_singleton();
      RenderingDevice::compute_list_bind_compute_pipeline(uVar10, pvVar9, *(undefined8*)( this + (long)(int)uVar18 * 8 + 0xaf8 ));
      uVar10 = RenderingDevice::get_singleton();
      local_68[0] = 0;
      local_88 = 1;
      ...
      if (uVar12 == 0) {
         ...
         LAB_0010750a:uVar10 = RenderingDevice::get_singleton();
         local_80 = local_80 & 0xffffffffffffff00;
         local_88 = _LC20;
         LAB_00107542:local_68[0] = 0;
         local_78 = local_a8;
   ...
   LAB_001076b3:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* RendererRD::CopyEffects::copy_cubemap_to_panorama(RID, RID, Vector2i const&, float, bool) */void RendererRD::CopyEffects::copy_cubemap_to_panorama(undefined4 param_1, CopyEffects *this, undefined8 param_3, undefined8 param_4, uint *param_5, uint param_6) {
   long *plVar1;
   Version *pVVar2;
   code *pcVar3;
   uint uVar4;
   ...
   if (UniformSetCacheRD::singleton == (UniformSetCacheRD*)0x0) {
      if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
         uVar10 = 0x186;
         pcVar14 = "Parameter \"uniform_set_cache\" is null.";
         LAB_00107f29:_err_print_error("copy_cubemap_to_panorama", "servers/rendering/renderer_rd/effects/copy_effects.cpp", uVar10, pcVar14, 0, 0);
         return;
      }
      goto LAB_00108023;
   }
   ...
   *(uint*)( this + 0x924 ) = uVar18;
   ...
   if (iVar7 == 0) {
      do {
         if (uVar12 == 0) {
            lVar8 = 0;
            LAB_00107cd3:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar16, lVar8, "p_index", "size()", "", false, false);
         } else {
            lVar8 = *(long*)( uVar12 - 8 );
   ...
   if (*(long*)( this + 0x990 ) == 0) {
      lVar8 = 0;
      LAB_00107f83:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, uVar19, lVar8, "p_variant", "variant_defines.size()", "", false, false);
      LAB_00107973:_err_print_error("copy_cubemap_to_panorama", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x19c, "Condition \"shader.is_null()\" is true.", 0, 0);
   } else {
      lVar8 = *(long*)( *(long*)( this + 0x990 ) + -8 );
      ...
      uVar13 = uVar19;
      if (lVar8 == 0) {
         LAB_00107d90:lVar16 = 0;
         uVar13 = uVar19;
         LAB_00107db1:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar13, lVar16, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
      ...
      if (( uVar12 == 0 ) || ( *(uint*)( this + 0xa4c ) <= (uint)uVar12 )) {
         LAB_00107d60:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
         goto LAB_00107973;
      }
      lVar8 = ( ( uVar12 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0xa48 ) ) * 0xa0 + *(long*)( *(long*)( this + 0xa38 ) + ( ( uVar12 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0xa48 ) ) * 8 );
      if (*(int*)( lVar8 + 0x98 ) != (int)( uVar12 >> 0x20 )) {
      ...
      if (uVar12 == 0) {
         uVar11 = UniformSetCacheRD::get_cache<RenderingDevice::Uniform>(pUVar5, lVar8, 0, &local_88);
         RenderingDevice::compute_list_bind_uniform_set(uVar10, pvVar9, uVar11, 0);
         LAB_00107e7a:uVar10 = RenderingDevice::get_singleton();
         local_80 = local_80 & 0xffffffffffffff00;
         local_88 = _LC20;
         LAB_00107eb2:local_68[0] = 0;
         local_78 = local_a8;
         uVar11 = UniformSetCacheRD::get_cache<RenderingDevice::Uniform>(pUVar5, lVar8, 3, &local_88);
         RenderingDevice::compute_list_bind_uniform_set(uVar10, pvVar9, uVar11, 3);
         lVar16 = 0;
   ...
   LAB_00108023:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* RendererRD::CopyEffects::copy_depth_to_rect(RID, RID, Rect2i const&, bool) */void RendererRD::CopyEffects::copy_depth_to_rect(CopyEffects *this, undefined8 param_2, undefined8 param_3, undefined4 *param_4, char param_5) {
   long *plVar1;
   Version *pVVar2;
   code *pcVar3;
   uint uVar4;
   ...
   if (UniformSetCacheRD::singleton == (UniformSetCacheRD*)0x0) {
      if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
         uVar12 = 0x1a9;
         pcVar14 = "Parameter \"uniform_set_cache\" is null.";
         LAB_00108879:_err_print_error("copy_depth_to_rect", "servers/rendering/renderer_rd/effects/copy_effects.cpp", uVar12, pcVar14, 0, 0);
         return;
      }
      goto LAB_00108973;
   }
   ...
   *(undefined8*)( this + 0x970 ) = 0;
   ...
   for (uVar13 = ( ulong )(( uVar4 - (int)(undefined8*)( ( ulong )(this + 0x920) & 0xfffffffffffffff8 ) ) + 0x60 >> 3); uVar13 != 0; uVar13 = uVar13 - 1) {
      *puVar16 = 0;
   ...
   *(undefined4*)( this + 0x92c ) = param_4[1];
   ...
   if (iVar7 == 0) {
      ...
      do {
         if (uVar13 == 0) {
            lVar17 = 0;
            LAB_0010863b:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar8, lVar17, "p_index", "size()", "", false, false);
         } else {
   ...
   if (*(long*)( this + 0x990 ) == 0) {
      lVar8 = 0;
      LAB_001088d3:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 6, lVar8, "p_variant", "variant_defines.size()", "", false, false);
      LAB_001082de:_err_print_error("copy_depth_to_rect", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x1c1, "Condition \"shader.is_null()\" is true.", 0, 0);
   } else {
      lVar8 = *(long*)( *(long*)( this + 0x990 ) + -8 );
      if (lVar8 < 7) goto LAB_001088d3;
      lVar8 = *(long*)( this + 0x9a0 );
      if (lVar8 == 0) {
         LAB_001086f8:lVar17 = 0;
         LAB_001086fb:uVar13 = 6;
         LAB_0010871b:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar13, lVar17, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
      ...
      if (( uVar13 == 0 ) || ( *(uint*)( this + 0xa4c ) <= (uint)uVar13 )) {
         LAB_001086c8:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
         goto LAB_001082de;
      }
      lVar8 = ( ( uVar13 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0xa48 ) ) * 0xa0 + *(long*)( *(long*)( this + 0xa38 ) + ( ( uVar13 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0xa48 ) ) * 8 );
      ...
      if (uVar13 == 0) {
         uVar11 = UniformSetCacheRD::get_cache<RenderingDevice::Uniform>(pUVar5, lVar8, 0, &local_88);
         RenderingDevice::compute_list_bind_uniform_set(uVar10, pvVar9, uVar11, 0);
         LAB_001087d2:uVar10 = RenderingDevice::get_singleton();
         local_88 = uVar12;
         local_80 = local_80 & 0xffffffffffffff00;
         LAB_00108803:local_68[0] = 0;
         local_78 = local_a8;
   ...
   LAB_00108973:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* RendererRD::CopyEffects::copy_depth_to_rect_and_linearize(RID, RID, Rect2i const&, bool, float,
   float) */void RendererRD::CopyEffects::copy_depth_to_rect_and_linearize(undefined4 param_1, undefined4 param_2, CopyEffects *this, undefined8 param_4, undefined8 param_5, undefined4 *param_6, char param_7) {
   long *plVar1;
   Version *pVVar2;
   undefined4 uVar3;
   code *pcVar4;
   ...
   if (UniformSetCacheRD::singleton == (UniformSetCacheRD*)0x0) {
      if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
         ...
         LAB_001091e9:_err_print_error("copy_depth_to_rect_and_linearize", "servers/rendering/renderer_rd/effects/copy_effects.cpp", uVar13, pcVar15, 0, 0);
         return;
      }
      goto LAB_001092e3;
   }
   ...
   *(undefined8*)( this + 0x970 ) = 0;
   ...
   for (uVar14 = ( ulong )(( uVar5 - (int)(undefined8*)( ( ulong )(this + 0x920) & 0xfffffffffffffff8 ) ) + 0x60 >> 3); uVar14 != 0; uVar14 = uVar14 - 1) {
      *puVar17 = 0;
   ...
   *(undefined4*)( this + 0x92c ) = uVar3;
   ...
   if (iVar8 == 0) {
      ...
      do {
         if (uVar14 == 0) {
            lVar18 = 0;
            LAB_00108fa3:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar9, lVar18, "p_index", "size()", "", false, false);
         } else {
   ...
   if (*(long*)( this + 0x990 ) == 0) {
      lVar9 = 0;
      LAB_00109243:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 10, lVar9, "p_variant", "variant_defines.size()", "", false, false);
      LAB_00108c44:_err_print_error("copy_depth_to_rect_and_linearize", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x1e8, "Condition \"shader.is_null()\" is true.", 0, 0);
   } else {
      lVar9 = *(long*)( *(long*)( this + 0x990 ) + -8 );
      if (lVar9 < 0xb) goto LAB_00109243;
      lVar9 = *(long*)( this + 0x9a0 );
      if (lVar9 == 0) {
         LAB_00109060:lVar18 = 0;
         LAB_00109063:uVar14 = 10;
         LAB_00109083:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar14, lVar18, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar4 = (code*)invalidInstructionException();
         ( *pcVar4 )();
      ...
      if (( uVar14 == 0 ) || ( *(uint*)( this + 0xa4c ) <= (uint)uVar14 )) {
         LAB_00109030:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
         goto LAB_00108c44;
      }
      lVar9 = ( ( uVar14 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0xa48 ) ) * 0xa0 + *(long*)( *(long*)( this + 0xa38 ) + ( ( uVar14 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0xa48 ) ) * 8 );
      ...
      RenderingDevice::compute_list_bind_compute_pipeline(uVar11, pvVar10, *(undefined8*)( this + 0xb48 ));
      uVar11 = RenderingDevice::get_singleton();
      local_68[0] = 0;
      local_88 = 1;
      local_80 = local_80 & 0xffffffffffffff00;
      ...
      if (uVar14 == 0) {
         ...
         LAB_00109142:uVar11 = RenderingDevice::get_singleton();
         local_88 = uVar13;
         local_80 = local_80 & 0xffffffffffffff00;
         LAB_00109173:local_68[0] = 0;
         local_78 = local_a8;
   ...
   LAB_001092e3:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* RendererRD::CopyEffects::copy_to_atlas_fb(RID, RID, Rect2 const&, long, bool, bool) */void RendererRD::CopyEffects::copy_to_atlas_fb(CopyEffects *this, undefined8 param_2, undefined8 param_3, undefined4 *param_4, void *param_5, uint param_6, uint param_7) {
   long *plVar1;
   Version *pVVar2;
   CopyEffects *pCVar3;
   CopyEffects CVar4;
   ...
   if (UniformSetCacheRD::singleton == (UniformSetCacheRD*)0x0) {
      if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
         ...
         LAB_00109a7c:_err_print_error("copy_to_atlas_fb", "servers/rendering/renderer_rd/effects/copy_effects.cpp", uVar10, pcVar16, 0, 0);
         return;
      }
      goto LAB_00109ba6;
   }
   ...
   for (int i = 0; i < 3; i++) {
      *(undefined1(*) [16])( this + ( 16*i + 2912 ) ) = (undefined1[16])0;
   }
   ...
   *(undefined4*)( this + 0xb6c ) = uVar5;
   ...
   if (iVar8 == 0) {
      do {
         if (uVar13 == 0) {
            lVar12 = 0;
            LAB_00109632:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar19, lVar12, "p_index", "size()", "", false, false);
         } else {
   ...
   if (*(long*)( this + 0xba8 ) == 0) {
      lVar19 = 0;
      LAB_00109ace:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, uVar17, lVar19, "p_variant", "variant_defines.size()", "", false, false);
      LAB_0010958a:_err_print_error("copy_to_atlas_fb", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x20e, "Condition \"shader.is_null()\" is true.", 0, 0);
      if (local_98[0] != 0) {
         LOCK();
         ...
         *plVar1 = *plVar1 + -1;
         UNLOCK();
         if (*plVar1 == 0) {
            LAB_00109970:if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
               Memory::free_static((void*)( local_98[0] - 0x10 ), false);
               return;
            }
            goto LAB_00109ba6;
      ...
      uVar15 = uVar17;
      if (lVar19 == 0) {
         LAB_001097d5:lVar12 = 0;
         uVar15 = uVar17;
         LAB_001097f6:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar15, lVar12, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
      ...
      if (( uVar13 == 0 ) || ( *(uint*)( this + 0xc64 ) <= (uint)uVar13 )) {
         LAB_001097ab:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
         goto LAB_0010958a;
      }
      lVar19 = ( ( uVar13 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0xc60 ) ) * 0xa0 + *(long*)( *(long*)( this + 0xc50 ) + ( ( uVar13 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0xc60 ) ) * 8 );
      ...
      if (*(long*)( pCVar3 + 0x40 ) == 0) {
         ...
         while (true) {
            ...
            local_88 = uVar13 << 8;
            do {} while ( *pCVar3 != (CopyEffects)0x0 );
         };
         ...
         if (*(uint*)( this + uVar13 * 0x138 + 0xe40 ) != 0) {
            ...
            do {
               if (( ( ( *plVar14 == -1 ) && ( lVar12 == plVar14[1] ) ) && ( this[uVar13 * 0x138 + 0xd5e] == *(CopyEffects*)( (long)plVar14 + 0x14 ) ) ) && ( ( (int)plVar14[2] == 0 && ( (int)plVar14[3] == 0 ) ) )) {
                  lVar12 = plVar14[4];
         ...
         lVar12 = PipelineCacheRD::_generate_version((long)pCVar3, -1, SUB81(lVar12, 0), (uint)(byte)this[uVar13 * 0x138 + 0xd5e], 0);
         *pCVar3 = (CopyEffects)0x0;
      }
      LAB_0010985c:RenderingDevice::draw_list_bind_render_pipeline(uVar10, param_5, lVar12);
      uVar10 = RenderingDevice::get_singleton();
      uVar13 = local_98[0];
      local_68[0] = 0;
      local_88 = 1;
   ...
   LAB_001095c8:if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   LAB_00109ba6:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* RendererRD::CopyEffects::copy_to_fb_rect(RID, RID, Rect2i const&, bool, bool, bool, bool, RID,
   bool, bool, bool, bool, Rect2 const&) */void RendererRD::CopyEffects::copy_to_fb_rect(CopyEffects *this, undefined8 param_2, undefined8 param_3, Rect2i *param_4, char param_5, char param_6, char param_7, char param_8, long param_9, char param_10, char param_11, char param_12, char param_13, float *param_14) {
   long *plVar1;
   Version *pVVar2;
   CopyEffects *pCVar3;
   CopyEffects CVar4;
   ...
   if (UniformSetCacheRD::singleton == (UniformSetCacheRD*)0x0) {
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         ...
         LAB_0010a773:_err_print_error("copy_to_fb_rect", "servers/rendering/renderer_rd/effects/copy_effects.cpp", uVar13, pcVar22, 0, 0);
         return;
      }
      goto LAB_0010a954;
   }
   ...
   *(undefined1(*) [16])( this + 0xb80 ) = (undefined1[16])0x0;
   ...
   if (iVar11 == 0) {
      do {
         if (uVar25 == 0) {
            lVar17 = 0;
            LAB_0010a206:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar24, lVar17, "p_index", "size()", "", false, false);
         } else {
   ...
   if (*(long*)( this + 0xba8 ) == 0) {
      lVar24 = 0;
      LAB_0010a7c5:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, uVar25, lVar24, "p_variant", "variant_defines.size()", "", false, false);
      LAB_00109f8d:_err_print_error("copy_to_fb_rect", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x250, "Condition \"shader.is_null()\" is true.", 0, 0);
   } else {
      ...
      uVar21 = uVar25;
      if (lVar24 == 0) {
         LAB_0010a3f0:lVar17 = 0;
         uVar21 = uVar25;
         LAB_0010a411:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar21, lVar17, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar7 = (code*)invalidInstructionException();
         ( *pcVar7 )();
      ...
      if (( uVar6 == 0 ) || ( *(uint*)( this + 0xc64 ) <= (uint)uVar6 )) {
         LAB_0010a86b:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
         goto LAB_00109f8d;
      }
      lVar24 = ( ( uVar6 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0xc60 ) ) * 0xa0 + *(long*)( *(long*)( this + 0xc50 ) + ( ( uVar6 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0xc60 ) ) * 8 );
      ...
      if (*(long*)( pCVar3 + 0x40 ) == 0) {
         ...
         if (*(uint*)( this + lVar20 * 0x138 + 0xe40 ) != 0) {
            ...
            do {
               if (( ( *plVar18 == -1 ) && ( lVar17 == plVar18[1] ) ) && ( ( this[lVar20 * 0x138 + 0xd5e] == *(CopyEffects*)( (long)plVar18 + 0x14 ) && ( ( (int)plVar18[2] == 0 && ( (int)plVar18[3] == 0 ) ) ) ) )) {
                  lVar17 = plVar18[4];
                  *pCVar3 = (CopyEffects)0x0;
                  goto LAB_0010a0ac;
               }
         ...
         lVar17 = PipelineCacheRD::_generate_version((long)pCVar3, -1, SUB81(lVar17, 0), (uint)(byte)this[lVar20 * 0x138 + 0xd5e], 0);
         *pCVar3 = (CopyEffects)0x0;
      }
      LAB_0010a0ac:RenderingDevice::draw_list_bind_render_pipeline(uVar14, pvVar15, lVar17);
      uVar14 = RenderingDevice::get_singleton();
      local_68[0] = 0;
      local_88 = uVar8;
      local_80 = local_80 & 0xffffffffffffff00;
      ...
      if (param_9 != 0) {
         ...
         if (iVar11 == 0) {
            do {
               if (uVar25 == 0) {
                  lVar20 = 0;
                  LAB_0010a648:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar17, lVar20, "p_index", "size()", "", false, false);
               } else {
      ...
      LAB_0010a16c:uVar13 = RenderingDevice::get_singleton();
   ...
   LAB_0010a954:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* RendererRD::CopyEffects::copy_to_drawlist(long, long, RID, bool) */void RendererRD::CopyEffects::copy_to_drawlist(CopyEffects *this, void *param_1, long param_2, undefined8 param_4, char param_5) {
   long *plVar1;
   Version *pVVar2;
   CopyEffects *pCVar3;
   CopyEffects CVar4;
   ...
   if (UniformSetCacheRD::singleton == (UniformSetCacheRD*)0x0) {
      if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
         uVar10 = 0x262;
         pcVar15 = "Parameter \"uniform_set_cache\" is null.";
         LAB_0010b07c:_err_print_error("copy_to_drawlist", "servers/rendering/renderer_rd/effects/copy_effects.cpp", uVar10, pcVar15, 0, 0);
         return;
      }
      goto LAB_0010b1a5;
   }
   ...
   *(undefined4*)( this + 0xb78 ) = _LC46;
   ...
   if (iVar8 == 0) {
      do {
         if (uVar13 == 0) {
            lVar16 = 0;
            LAB_0010ac62:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar17, lVar16, "p_index", "size()", "", false, false);
         } else {
   ...
   if (*(long*)( this + 0xba8 ) == 0) {
      lVar17 = 0;
      LAB_0010b0ce:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 0, lVar17, "p_variant", "variant_defines.size()", "", false, false);
      LAB_0010abb9:_err_print_error("copy_to_drawlist", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x279, "Condition \"shader.is_null()\" is true.", 0, 0);
      if (local_98[0] != 0) {
         LOCK();
         plVar1 = (long*)( local_98[0] - 0x10 );
         *plVar1 = *plVar1 + -1;
         UNLOCK();
         if (*plVar1 == 0) {
            LAB_0010af72:if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
               Memory::free_static((void*)( local_98[0] - 0x10 ), false);
               return;
            }
            goto LAB_0010b1a5;
      ...
      if (pcVar15 == (char*)0x0) {
         LAB_0010ade8:lVar17 = 0;
         LAB_0010adeb:uVar13 = 0;
         LAB_0010ae08:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar13, lVar17, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar6 = (code*)invalidInstructionException();
         ( *pcVar6 )();
      ...
      if (( uVar13 == 0 ) || ( *(uint*)( this + 0xc64 ) <= (uint)uVar13 )) {
         LAB_0010adbe:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
         goto LAB_0010abb9;
      }
      lVar16 = ( ( uVar13 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0xc60 ) ) * 0xa0 + *(long*)( *(long*)( this + 0xc50 ) + ( ( uVar13 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0xc60 ) ) * 8 );
      ...
      if (*(long*)( this + 0xd50 ) == 0) {
         ...
         if (*(uint*)( this + 0xe40 ) != 0) {
            ...
            do {
               if (( ( ( *plVar11 == -1 ) && ( param_2 == plVar11[1] ) ) && ( this[0xd5e] == *(CopyEffects*)( (long)plVar11 + 0x14 ) ) ) && ( ( (int)plVar11[2] == 0 && ( (int)plVar11[3] == 0 ) ) )) {
                  lVar16 = plVar11[4];
         ...
         lVar16 = PipelineCacheRD::_generate_version((long)pCVar3, -1, SUB81(param_2, 0), (uint)(byte)this[0xd5e], 0);
         this[0xd10] = (CopyEffects)0x0;
      }
      LAB_0010ae6c:RenderingDevice::draw_list_bind_render_pipeline(uVar10, param_1, lVar16);
      uVar10 = RenderingDevice::get_singleton();
      uVar13 = local_98[0];
      local_68[0] = 0;
      local_88 = 1;
   ...
   LAB_0010abf8:if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   LAB_0010b1a5:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* RendererRD::CopyEffects::copy_raster(RID, RID) */void RendererRD::CopyEffects::copy_raster(CopyEffects *this, undefined8 param_2, undefined8 param_3) {
   long *plVar1;
   Version *pVVar2;
   CopyEffects *pCVar3;
   CopyEffects CVar4;
   ...
   local_58[3] = *(long*)( in_FS_OFFSET + 0x28 );
   if (*this == (CopyEffects)0x0) {
      _err_print_error("copy_raster", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x283, "Condition \"!prefer_raster_effects\" is true.", "Can\'t use the raster version of the copy with the clustered renderer.", 0, 0);
      goto LAB_0010b660;
   }
   if (UniformSetCacheRD::singleton == (UniformSetCacheRD*)0x0) {
      if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
         uVar9 = 0x286;
         pcVar15 = "Parameter \"uniform_set_cache\" is null.";
         LAB_0010b9b5:_err_print_error("copy_raster", "servers/rendering/renderer_rd/effects/copy_effects.cpp", uVar9, pcVar15, 0, 0);
         return;
      }
      goto LAB_0010ba9d;
   }
   ...
   if (iVar7 == 0) {
      ...
      do {
         if (uVar14 == 0) {
            lVar12 = 0;
            LAB_0010b592:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar8, lVar12, "p_index", "size()", "", false, false);
         } else {
   ...
   if (*(long*)( this + 0x60 ) == 0) {
      lVar8 = 0;
      LAB_0010b5db:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 4, lVar8, "p_variant", "variant_defines.size()", "", false, false);
      LAB_0010b620:_err_print_error("copy_raster", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x292, "Condition \"shader.is_null()\" is true.", 0, 0);
      if (local_98[0] != 0) {
         LOCK();
         plVar1 = (long*)( local_98[0] - 0x10 );
         *plVar1 = *plVar1 + -1;
      ...
      LAB_0010b660:if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   } else {
      ...
      if (lVar8 == 0) {
         LAB_0010b8fd:lVar12 = 0;
         LAB_0010b900:uVar14 = 4;
         LAB_0010b920:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar14, lVar12, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
      ...
      if (( uVar14 == 0 ) || ( *(uint*)( this + 0x11c ) <= (uint)uVar14 )) {
         LAB_0010b6c8:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
         goto LAB_0010b620;
      }
      lVar8 = ( ( uVar14 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x118 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x108 ) + ( ( uVar14 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x118 ) ) * 8 );
      ...
      if (*(long*)( this + 0x6e8 ) == 0) {
         ...
         if (*(uint*)( this + 0x7d8 ) != 0) {
            ...
            do {
               if (( ( ( *plVar13 == -1 ) && ( lVar12 == plVar13[1] ) ) && ( this[0x6f6] == *(CopyEffects*)( (long)plVar13 + 0x14 ) ) ) && ( ( (int)plVar13[2] == 0 && ( (int)plVar13[3] == 0 ) ) )) {
                  lVar12 = plVar13[4];
         ...
         lVar12 = PipelineCacheRD::_generate_version((long)pCVar3, -1, SUB81(lVar12, 0), (uint)(byte)this[0x6f6], 0);
         this[0x6a8] = (CopyEffects)0x0;
      }
      LAB_0010b730:RenderingDevice::draw_list_bind_render_pipeline(uVar9, pvVar10, lVar12);
      uVar9 = RenderingDevice::get_singleton();
      uVar14 = local_98[0];
      local_68[0] = 0;
      local_88 = 1;
      ...
      if (local_98[0] == 0) {
         ...
         LAB_0010b7e2:lVar8 = RenderingDevice::get_singleton();
      ...
      *plVar1 = *plVar1 + -1;
      ...
      LAB_0010b839:if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
         Memory::free_static((void*)( local_98[0] - 0x10 ), false);
         return;
      }
   }
   LAB_0010ba9d:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* RendererRD::CopyEffects::gaussian_blur(RID, RID, Rect2i const&, Vector2i const&, bool) */void RendererRD::CopyEffects::gaussian_blur(CopyEffects *this, undefined8 param_2, undefined8 param_3, undefined4 *param_4, undefined4 *param_5, ulong param_6) {
   long *plVar1;
   Version *pVVar2;
   code *pcVar3;
   uint uVar4;
   ...
   if (*this == (CopyEffects)0x0) {
      if (UniformSetCacheRD::singleton == (UniformSetCacheRD*)0x0) {
         if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
            uVar10 = 0x2a2;
            pcVar14 = "Parameter \"uniform_set_cache\" is null.";
            LAB_0010c3e9:_err_print_error("gaussian_blur", "servers/rendering/renderer_rd/effects/copy_effects.cpp", uVar10, pcVar14, 0, 0);
            return;
         }
         goto LAB_0010c4a3;
      }
      ...
      *(undefined4*)( this + 0x924 ) = param_5[1];
      ...
      if (iVar7 == 0) {
         do {
            if (uVar12 == 0) {
               lVar8 = 0;
               LAB_0010c0a3:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar17, lVar8, "p_index", "size()", "", false, false);
            } else {
               lVar8 = *(long*)( uVar12 - 8 );
      ...
      if (*(long*)( this + 0x990 ) == 0) {
         lVar8 = 0;
         LAB_0010c0f3:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, uVar18, lVar8, "p_variant", "variant_defines.size()", "", false, false);
         LAB_0010c130:_err_print_error("gaussian_blur", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x2b7, "Condition \"shader.is_null()\" is true.", 0, 0);
      } else {
         lVar8 = *(long*)( *(long*)( this + 0x990 ) + -8 );
         ...
         uVar13 = uVar18;
         if (lVar8 == 0) {
            LAB_0010c320:lVar17 = 0;
            uVar13 = uVar18;
            LAB_0010c341:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar13, lVar17, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar3 = (code*)invalidInstructionException();
            ( *pcVar3 )();
         ...
         if (( uVar12 == 0 ) || ( *(uint*)( this + 0xa4c ) <= (uint)uVar12 )) {
            LAB_0010c1e0:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
            goto LAB_0010c130;
         }
         lVar8 = ( ( uVar12 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0xa48 ) ) * 0xa0 + *(long*)( *(long*)( this + 0xa38 ) + ( ( uVar12 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0xa48 ) ) * 8 );
         if (*(int*)( lVar8 + 0x98 ) != (int)( uVar12 >> 0x20 )) {
         ...
         pvVar9 = (void*)RenderingDevice::compute_list_begin();
         uVar10 = RenderingDevice::get_singleton();
         RenderingDevice::compute_list_bind_compute_pipeline(uVar10, pvVar9, *(undefined8*)( this + ( param_6 & 0xff ) * 8 + 0xaf8 ));
         uVar10 = RenderingDevice::get_singleton();
         local_68[0] = 0;
         local_88 = 1;
         local_80 = local_80 & 0xffffffffffffff00;
         ...
         if (uVar12 == 0) {
            uVar11 = UniformSetCacheRD::get_cache<RenderingDevice::Uniform>(pUVar5, lVar8, 0, &local_88);
            RenderingDevice::compute_list_bind_uniform_set(uVar10, pvVar9, uVar11, 0);
            LAB_0010c2b2:uVar10 = RenderingDevice::get_singleton();
            local_80 = local_80 & 0xffffffffffffff00;
            local_88 = _LC20;
            LAB_0010c2ea:local_68[0] = 0;
            local_78 = local_a8;
            uVar11 = UniformSetCacheRD::get_cache<RenderingDevice::Uniform>(pUVar5, lVar8, 3, &local_88);
            RenderingDevice::compute_list_bind_uniform_set(uVar10, pvVar9, uVar11, 3);
            lVar17 = 0;
      ...
      _err_print_error("gaussian_blur", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x29f, "Condition \"prefer_raster_effects\" is true.", "Can\'t use the compute version of the gaussian blur with the mobile renderer.", 0, 0);
   }
   if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   LAB_0010c4a3:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* RendererRD::CopyEffects::gaussian_blur_raster(RID, RID, Rect2i const&, Vector2i const&) */void RendererRD::CopyEffects::gaussian_blur_raster(CopyEffects *this, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined8 *param_5) {
   long *plVar1;
   Version *pVVar2;
   CopyEffects *pCVar3;
   CopyEffects CVar4;
   ...
   local_58[3] = *(long*)( in_FS_OFFSET + 0x28 );
   if (*this == (CopyEffects)0x0) {
      _err_print_error("gaussian_blur_raster", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x2c6, "Condition \"!prefer_raster_effects\" is true.", "Can\'t use the raster version of the gaussian blur with the clustered renderer.", 0, 0);
      goto LAB_0010c980;
   }
   if (UniformSetCacheRD::singleton == (UniformSetCacheRD*)0x0) {
      if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
         uVar9 = 0x2c9;
         pcVar16 = "Parameter \"uniform_set_cache\" is null.";
         LAB_0010ccc8:_err_print_error("gaussian_blur_raster", "servers/rendering/renderer_rd/effects/copy_effects.cpp", uVar9, pcVar16, 0, 0);
         return;
      }
      goto LAB_0010cdb0;
   }
   ...
   *(long*)( this + 8 ) = auVar20._0_8_;
   ...
   if (iVar7 == 0) {
      ...
      do {
         if (uVar15 == 0) {
            lVar13 = 0;
            LAB_0010c8b1:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar8, lVar13, "p_index", "size()", "", false, false);
         } else {
   ...
   if (*(long*)( this + 0x60 ) == 0) {
      lVar8 = 0;
      LAB_0010c8fa:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 1, lVar8, "p_variant", "variant_defines.size()", "", false, false);
      LAB_0010c940:_err_print_error("gaussian_blur_raster", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x2dc, "Condition \"shader.is_null()\" is true.", 0, 0);
      if (local_98[0] != 0) {
         LOCK();
         plVar1 = (long*)( local_98[0] - 0x10 );
         *plVar1 = *plVar1 + -1;
      ...
      LAB_0010c980:if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   } else {
      lVar8 = *(long*)( *(long*)( this + 0x60 ) + -8 );
      ...
      lVar8 = *(long*)( this + 0x70 );
      if (lVar8 == 0) {
         LAB_0010cc13:lVar13 = 0;
         LAB_0010cc16:uVar15 = 1;
         LAB_0010cc36:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar15, lVar13, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar5 = (code*)invalidInstructionException();
         ( *pcVar5 )();
      ...
      if (( uVar15 == 0 ) || ( *(uint*)( this + 0x11c ) <= (uint)uVar15 )) {
         LAB_0010c9e9:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
         goto LAB_0010c940;
      }
      lVar8 = ( ( uVar15 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x118 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x108 ) + ( ( uVar15 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x118 ) ) * 8 );
      ...
      if (*(long*)( this + 0x340 ) == 0) {
         ...
         if (*(uint*)( this + 0x430 ) != 0) {
            ...
            do {
               if (( ( ( *plVar14 == -1 ) && ( lVar13 == plVar14[1] ) ) && ( this[0x34e] == *(CopyEffects*)( (long)plVar14 + 0x14 ) ) ) && ( ( (int)plVar14[2] == 0 && ( (int)plVar14[3] == 0 ) ) )) {
                  lVar13 = plVar14[4];
         ...
         lVar13 = PipelineCacheRD::_generate_version((long)pCVar3, -1, SUB81(lVar13, 0), (uint)(byte)this[0x34e], 0);
         this[0x300] = (CopyEffects)0x0;
      }
      LAB_0010ca50:RenderingDevice::draw_list_bind_render_pipeline(uVar10, pvVar11, lVar13);
      uVar9 = RenderingDevice::get_singleton();
      uVar15 = local_98[0];
      local_68[0] = 0;
      local_88 = 1;
      ...
      if (local_98[0] == 0) {
         ...
         LAB_0010cb00:lVar8 = RenderingDevice::get_singleton();
      ...
      *plVar1 = *plVar1 + -1;
      ...
      LAB_0010cb57:if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
         Memory::free_static((void*)( local_98[0] - 0x10 ), false);
         return;
      }
   }
   LAB_0010cdb0:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* RendererRD::CopyEffects::gaussian_glow(RID, RID, Vector2i const&, float, bool, float, float,
   float, float, float, RID, float) */void RendererRD::CopyEffects::gaussian_glow(undefined4 param_1, undefined4 param_2, undefined4 param_3, undefined4 param_4, undefined4 param_5, undefined4 param_6, undefined4 param_7, CopyEffects *this, long param_9, undefined8 param_10, uint *param_11, uint param_12, long param_13) {
   long *plVar1;
   Version *pVVar2;
   uint uVar3;
   code *pcVar4;
   ...
   if (*this == (CopyEffects)0x0) {
      if (UniformSetCacheRD::singleton == (UniformSetCacheRD*)0x0) {
         if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
            uVar12 = 0x2ec;
            pcVar16 = "Parameter \"uniform_set_cache\" is null.";
            LAB_0010d7c9:_err_print_error("gaussian_glow", "servers/rendering/renderer_rd/effects/copy_effects.cpp", uVar12, pcVar16, 0, 0);
            return;
         }
         goto LAB_0010db1e;
      }
      ...
      *(ulong*)( this + 0x950 ) = CONCAT44(param_7, param_2);
      ...
      if (iVar8 == 0) {
         do {
            if (uVar14 == 0) {
               lVar20 = 0;
               LAB_0010d463:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar21, lVar20, "p_index", "size()", "", false, false);
            } else {
      ...
      if (*(long*)( this + 0x990 ) == 0) {
         lVar21 = 0;
         LAB_0010d4a3:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, uVar22, lVar21, "p_variant", "variant_defines.size()", "", false, false);
         LAB_0010d4e0:_err_print_error("gaussian_glow", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x309, "Condition \"shader.is_null()\" is true.", 0, 0);
      } else {
         ...
         uVar15 = uVar22;
         if (lVar21 == 0) {
            LAB_0010d708:lVar20 = 0;
            uVar15 = uVar22;
            LAB_0010d729:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar15, lVar20, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar4 = (code*)invalidInstructionException();
            ( *pcVar4 )();
         ...
         if (( uVar14 == 0 ) || ( *(uint*)( this + 0xa4c ) <= (uint)uVar14 )) {
            LAB_0010d590:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
            goto LAB_0010d4e0;
         }
         lVar21 = ( ( uVar14 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0xa48 ) ) * 0xa0 + *(long*)( *(long*)( this + 0xa38 ) + ( ( uVar14 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0xa48 ) ) * 8 );
         ...
         pvVar10 = (void*)RenderingDevice::compute_list_begin();
         uVar11 = RenderingDevice::get_singleton();
         RenderingDevice::compute_list_bind_compute_pipeline(uVar11, pvVar10, *(undefined8*)( this + (long)(int)uVar19 * 8 + 0xaf8 ));
         uVar11 = RenderingDevice::get_singleton();
         local_68[0] = 0;
         local_88 = uVar12;
         local_80 = local_80 & 0xffffffffffffff00;
         ...
         if (uVar14 == 0) {
            ...
            RenderingDevice::compute_list_bind_uniform_set(uVar11, pvVar10, uVar12, 0);
            LAB_0010d681:uVar12 = RenderingDevice::get_singleton();
            local_88 = uVar13;
            local_80 = local_80 & 0xffffffffffffff00;
            LAB_0010d6b5:local_150 = &local_88;
            local_68[0] = 0;
            local_78 = local_d8;
            ...
            if (local_15c != '\0') {
               ...
               if (iVar8 == 0) {
                  do {
                     if (uVar14 == 0) {
                        lVar9 = 0;
                        LAB_0010daae:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar20, lVar9, "p_index", "size()", "", false, false);
                     } else {
                        lVar9 = *(long*)( uVar14 + -8 );
               ...
               if (uVar14 != 0) {
                  ...
                  LAB_0010d898:uVar14 = local_98[0];
                  if (local_80 != 0) {
                     LOCK();
                     plVar1 = (long*)( local_80 + -0x10 );
                     *plVar1 = *plVar1 + -1;
               ...
               local_88 = uVar12;
               if (uVar14 == 0) {
                  uVar12 = UniformSetCacheRD::get_cache<RenderingDevice::Uniform>(pUVar6, lVar21, 1, local_150);
      ...
      _err_print_error("gaussian_glow", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x2e9, "Condition \"prefer_raster_effects\" is true.", "Can\'t use the compute version of the gaussian glow with the mobile renderer.", 0, 0);
   }
   if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   LAB_0010db1e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* RendererRD::CopyEffects::gaussian_glow_raster(RID, RID, RID, float, Vector2i const&, float, bool,
   float, float, float, float, float, RID, float) */void RendererRD::CopyEffects::gaussian_glow_raster(undefined4 param_1, undefined4 param_2, undefined4 param_3, undefined4 param_4, undefined4 param_5, undefined4 param_6, undefined4 param_7, undefined4 param_8, CopyEffects *this, undefined8 param_10, long param_11, undefined8 param_12, undefined8 *param_13, uint param_14, long param_15) {
   long *plVar1;
   Version *pVVar2;
   CopyEffects *pCVar3;
   CopyEffects CVar4;
   ...
   if (*this == (CopyEffects)0x0) {
      if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
         _err_print_error("gaussian_glow_raster", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x31c, "Condition \"!prefer_raster_effects\" is true.", "Can\'t use the raster version of the gaussian glow with the clustered renderer.", 0);
         return;
      }
      goto LAB_0010efd4;
   }
   if (UniformSetCacheRD::singleton == (UniformSetCacheRD*)0x0) {
      if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
         ...
         LAB_0010eafe:_err_print_error("gaussian_glow_raster", "servers/rendering/renderer_rd/effects/copy_effects.cpp", uVar13, pcVar21, 0, 0);
         return;
      }
      goto LAB_0010efd4;
   }
   ...
   *(ulong*)( this + 0x30 ) = CONCAT44(param_8, param_3);
   ...
   if (iVar11 == 0) {
      do {
         if (uVar24 == 0) {
            lVar18 = 0;
            LAB_0010e14d:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar25, lVar18, "p_index", "size()", "", false, false);
         } else {
   ...
   if (iVar11 == 0) {
      do {
         if (uVar24 == 0) {
            lVar18 = 0;
            LAB_0010e18f:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar25, lVar18, "p_index", "size()", "", false, false);
         } else {
            lVar18 = *(long*)( uVar24 - 8 );
   ...
   if (*(long*)( this + 0x60 ) == 0) {
      lVar25 = 0;
      LAB_0010e1d1:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, uVar6, lVar25, "p_variant", "variant_defines.size()", "", false, false);
      LAB_0010e210:_err_print_error("gaussian_glow_raster", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x341, "Condition \"shader.is_null()\" is true.", 0, 0);
      LAB_0010e235:if (local_c8[0] != 0) {
         LOCK();
         plVar1 = (long*)( local_c8[0] - 0x10 );
         *plVar1 = *plVar1 + -1;
         lVar12 = *plVar1;
         UNLOCK();
         joined_r0x0010e45e:if (lVar12 == 0) {
            Memory::free_static((void*)( local_c8[0] - 0x10 ), false);
         }
      }
   } else {
      ...
      if (( uVar24 == 0 ) || ( *(uint*)( this + 0x11c ) <= (uint)uVar24 )) {
         LAB_0010e2e3:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
         goto LAB_0010e210;
      }
      lVar25 = ( ( uVar24 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x118 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x108 ) + ( ( uVar24 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x118 ) ) * 8 );
      ...
      if (*(long*)( pCVar3 + 0x40 ) == 0) {
         ...
         if (*(uint*)( this + (long)(int)uVar10 * 0x138 + 0x2f8 ) != 0) {
            ...
            do {
               if (( ( ( *plVar19 == -1 ) && ( lVar18 == plVar19[1] ) ) && ( this[(long)(int)uVar10 * 0x138 + 0x216] == *(CopyEffects*)( (long)plVar19 + 0x14 ) ) ) && ( ( (int)plVar19[2] == 0 && ( (int)plVar19[3] == 0 ) ) )) {
                  lVar18 = plVar19[4];
                  *pCVar3 = (CopyEffects)0x0;
                  goto LAB_0010e4ed;
               }
         ...
         lVar18 = PipelineCacheRD::_generate_version((long)pCVar3, -1, SUB81(lVar18, 0), (uint)(byte)this[(long)(int)uVar10 * 0x138 + 0x216], 0);
         *pCVar3 = (CopyEffects)0x0;
      }
      LAB_0010e4ed:RenderingDevice::draw_list_bind_render_pipeline(uVar15, pvVar16, lVar18);
      uVar13 = RenderingDevice::get_singleton();
      local_68[0] = 0;
      local_88 = uVar7;
      local_80 = local_80 & 0xffffffffffffff00;
         ...
         if (local_178 != '\0') {
            ...
            if (iVar11 == 0) {
               ...
               do {
                  if (uVar24 == 0) {
                     lVar18 = 0;
                     LAB_0010ef0b:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar12, lVar18, "p_index", "size()", "", false, false);
                  } else {
                     lVar18 = *(long*)( uVar24 + -8 );
      ...
      *(int*)( this + 0x10 ) = iVar11;
      ...
      if (*(long*)( this + 0x60 ) == 0) {
         lVar12 = 0;
         LAB_0010edf3:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 2, lVar12, "p_variant", "variant_defines.size()", "", false, false);
         LAB_0010e70e:_err_print_error("gaussian_glow_raster", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x355, "Condition \"shader.is_null()\" is true.", 0, 0);
         goto LAB_0010e235;
      }
      ...
      if (lVar12 == 0) {
         LAB_0010eaad:lVar18 = 0;
         LAB_0010eab0:uVar20 = 2;
         LAB_0010e802:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar20, lVar18, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar5 = (code*)invalidInstructionException();
         ( *pcVar5 )();
      ...
      if (( uVar24 == 0 ) || ( *(uint*)( this + 0x11c ) <= (uint)uVar24 )) {
         LAB_0010eede:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
         goto LAB_0010e70e;
      }
      lVar12 = ( ( uVar24 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x118 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x108 ) + ( ( uVar24 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x118 ) ) * 8 );
      ...
      if (*(long*)( this + 0x478 ) == 0) {
         ...
         if (*(uint*)( this + 0x568 ) != 0) {
            ...
            do {
               if (( ( ( *plVar19 == -1 ) && ( lVar25 == plVar19[1] ) ) && ( this[0x486] == *(CopyEffects*)( (long)plVar19 + 0x14 ) ) ) && ( ( (int)plVar19[2] == 0 && ( (int)plVar19[3] == 0 ) ) )) {
                  lVar25 = plVar19[4];
         ...
         lVar25 = PipelineCacheRD::_generate_version((long)pCVar3, -1, SUB81(lVar25, 0), (uint)(byte)this[0x486], 0);
         this[0x438] = (CopyEffects)0x0;
      }
      LAB_0010e32d:RenderingDevice::draw_list_bind_render_pipeline(uVar13, pvVar16, lVar25);
      uVar13 = RenderingDevice::get_singleton();
      uVar24 = local_c8[0];
      local_68[0] = 0;
      local_88 = local_e8;
      ...
      uVar14 = UniformSetCacheRD::get_cache<RenderingDevice::Uniform>(pUVar8, lVar12, 0, &local_88);
      RenderingDevice::draw_list_bind_uniform_set(uVar13, pvVar16, uVar14, 0);
      LAB_0010e406:*(undefined4*)( this + 0x10 ) = 0;
      lVar12 = RenderingDevice::get_singleton();
      RenderingDevice::draw_list_set_push_constant(lVar12, pvVar16, uVar22);
      lVar12 = RenderingDevice::get_singleton();
      RenderingDevice::draw_list_draw(lVar12, SUB81(pvVar16, 0), 0, 1);
   ...
   LAB_0010efd4:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* RendererRD::CopyEffects::make_mipmap(RID, RID, Vector2i const&) */void RendererRD::CopyEffects::make_mipmap(CopyEffects *this, undefined8 param_2, undefined8 param_3, uint *param_4) {
   long *plVar1;
   Version *pVVar2;
   code *pcVar3;
   uint uVar4;
   ...
   if (*this == (CopyEffects)0x0) {
      if (UniformSetCacheRD::singleton == (UniformSetCacheRD*)0x0) {
         if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
            uVar12 = 0x367;
            pcVar14 = "Parameter \"uniform_set_cache\" is null.";
            LAB_0010f8d9:_err_print_error("make_mipmap", "servers/rendering/renderer_rd/effects/copy_effects.cpp", uVar12, pcVar14, 0, 0);
            return;
         }
         goto LAB_0010f993;
      }
      ...
      *(uint*)( this + 0x924 ) = param_4[1];
      ...
      if (iVar7 == 0) {
         ...
         do {
            if (uVar13 == 0) {
               lVar17 = 0;
               LAB_0010f5b3:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar8, lVar17, "p_index", "size()", "", false, false);
            } else {
               lVar17 = *(long*)( uVar13 - 8 );
      ...
      if (*(long*)( this + 0x990 ) == 0) {
         lVar8 = 0;
         LAB_0010f603:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 9, lVar8, "p_variant", "variant_defines.size()", "", false, false);
         LAB_0010f640:_err_print_error("make_mipmap", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x37a, "Condition \"shader.is_null()\" is true.", 0, 0);
      } else {
         lVar8 = *(long*)( *(long*)( this + 0x990 ) + -8 );
         if (lVar8 < 10) goto LAB_0010f603;
         lVar8 = *(long*)( this + 0x9a0 );
         if (lVar8 == 0) {
            LAB_0010f818:lVar17 = 0;
            LAB_0010f81b:uVar13 = 9;
            LAB_0010f83b:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar13, lVar17, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar3 = (code*)invalidInstructionException();
            ( *pcVar3 )();
         ...
         if (( uVar13 == 0 ) || ( *(uint*)( this + 0xa4c ) <= (uint)uVar13 )) {
            LAB_0010f6f0:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
            goto LAB_0010f640;
         }
         lVar8 = ( ( uVar13 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0xa48 ) ) * 0xa0 + *(long*)( *(long*)( this + 0xa38 ) + ( ( uVar13 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0xa48 ) ) * 8 );
         if (*(int*)( lVar8 + 0x98 ) != (int)( uVar13 >> 0x20 )) {
         ...
         pvVar9 = (void*)RenderingDevice::compute_list_begin();
         uVar10 = RenderingDevice::get_singleton();
         RenderingDevice::compute_list_bind_compute_pipeline(uVar10, pvVar9, *(undefined8*)( this + 0xb40 ));
         uVar10 = RenderingDevice::get_singleton();
         local_68[0] = 0;
         local_88 = 1;
         local_80 = local_80 & 0xffffffffffffff00;
         ...
         if (uVar13 == 0) {
            uVar11 = UniformSetCacheRD::get_cache<RenderingDevice::Uniform>(pUVar5, lVar8, 0, &local_88);
            RenderingDevice::compute_list_bind_uniform_set(uVar10, pvVar9, uVar11, 0);
            LAB_0010f7b2:uVar10 = RenderingDevice::get_singleton();
            local_88 = uVar12;
            local_80 = local_80 & 0xffffffffffffff00;
            LAB_0010f7e3:local_68[0] = 0;
            local_78 = local_a8;
            uVar12 = UniformSetCacheRD::get_cache<RenderingDevice::Uniform>(pUVar5, lVar8, 3, &local_88);
            RenderingDevice::compute_list_bind_uniform_set(uVar10, pvVar9, uVar12, 3);
            lVar17 = 0;
      ...
      _err_print_error("make_mipmap", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x364, "Condition \"prefer_raster_effects\" is true.", "Can\'t use the compute version of the make_mipmap shader with the mobile renderer.", 0, 0);
   }
   if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   LAB_0010f993:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* RendererRD::CopyEffects::make_mipmap_raster(RID, RID, Vector2i const&) */void RendererRD::CopyEffects::make_mipmap_raster(CopyEffects *this, undefined8 param_2, undefined8 param_3, undefined8 *param_4) {
   long *plVar1;
   Version *pVVar2;
   CopyEffects *pCVar3;
   CopyEffects CVar4;
   ...
   local_58[3] = *(long*)( in_FS_OFFSET + 0x28 );
   if (*this == (CopyEffects)0x0) {
      _err_print_error("make_mipmap_raster", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x386, "Condition \"!prefer_raster_effects\" is true.", "Can\'t use the raster version of mipmap with the clustered renderer.", 0, 0);
      goto LAB_0010fe68;
   }
   uVar9 = FramebufferCacheRD::get_cache<RID>(FramebufferCacheRD::singleton, param_3);
   pUVar7 = UniformSetCacheRD::singleton;
   if (UniformSetCacheRD::singleton == (UniformSetCacheRD*)0x0) {
      if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
         uVar9 = 0x38b;
         pcVar16 = "Parameter \"uniform_set_cache\" is null.";
         LAB_001101c2:_err_print_error("make_mipmap_raster", "servers/rendering/renderer_rd/effects/copy_effects.cpp", uVar9, pcVar16, 0, 0);
         return;
      }
      goto LAB_001102aa;
   }
   ...
   *(long*)( this + 8 ) = auVar21._0_8_;
   ...
   if (iVar8 == 0) {
      ...
      do {
         if (uVar15 == 0) {
            lVar18 = 0;
            LAB_0010fda2:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar10, lVar18, "p_index", "size()", "", false, false);
         } else {
   ...
   if (*(long*)( this + 0x60 ) == 0) {
      lVar10 = 0;
      LAB_0010fdeb:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 0, lVar10, "p_variant", "variant_defines.size()", "", false, false);
      LAB_0010fe28:_err_print_error("make_mipmap_raster", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x39c, "Condition \"shader.is_null()\" is true.", 0, 0);
      if (local_98[0] != 0) {
         LOCK();
         plVar1 = (long*)( local_98[0] - 0x10 );
         *plVar1 = *plVar1 + -1;
      ...
      LAB_0010fe68:if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   } else {
      ...
      if (pcVar16 == (char*)0x0) {
         LAB_0011010d:lVar10 = 0;
         LAB_00110110:uVar15 = 0;
         LAB_0011012d:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar15, lVar10, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar6 = (code*)invalidInstructionException();
         ( *pcVar6 )();
      ...
      if (( uVar15 == 0 ) || ( *(uint*)( this + 0x11c ) <= (uint)uVar15 )) {
         LAB_0010fed0:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
         goto LAB_0010fe28;
      }
      lVar18 = ( ( uVar15 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x118 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x108 ) + ( ( uVar15 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x118 ) ) * 8 );
      ...
      if (*(long*)( this + 0x208 ) == 0) {
         ...
         if (*(uint*)( this + 0x2f8 ) != 0) {
            ...
            do {
               if (( ( ( *plVar14 == -1 ) && ( lVar18 == plVar14[1] ) ) && ( this[0x216] == *(CopyEffects*)( (long)plVar14 + 0x14 ) ) ) && ( ( (int)plVar14[2] == 0 && ( (int)plVar14[3] == 0 ) ) )) {
                  lVar18 = plVar14[4];
         ...
         lVar18 = PipelineCacheRD::_generate_version((long)pCVar3, -1, SUB81(lVar18, 0), (uint)(byte)this[0x216], 0);
         this[0x1c8] = (CopyEffects)0x0;
      }
      LAB_0010ff40:RenderingDevice::draw_list_bind_render_pipeline(uVar11, pvVar12, lVar18);
      uVar9 = RenderingDevice::get_singleton();
      uVar15 = local_98[0];
      local_68[0] = 0;
      local_88 = 1;
      ...
      if (local_98[0] == 0) {
         ...
         LAB_0010fff2:lVar10 = RenderingDevice::get_singleton();
      ...
      *plVar1 = *plVar1 + -1;
      ...
      LAB_00110049:if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
         Memory::free_static((void*)( local_98[0] - 0x10 ), false);
         return;
      }
   }
   LAB_001102aa:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* RendererRD::CopyEffects::set_color(RID, Color const&, Rect2i const&, bool) */void RendererRD::CopyEffects::set_color(CopyEffects *this, undefined8 param_2, undefined4 *param_3, undefined4 *param_4, uint param_5) {
   Version *pVVar1;
   undefined4 uVar2;
   undefined4 uVar3;
   code *pcVar4;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (*this != (CopyEffects)0x0) {
      _err_print_error("set_color", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x3a8, "Condition \"prefer_raster_effects\" is true.", "Can\'t use the compute version of the set_color shader with the mobile renderer.", 0, 0);
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
      goto LAB_001108bb;
   ...
   *(undefined8*)( this + 0x970 ) = 0;
   puVar16 = (undefined8*)( ( ulong )(this + 0x920) & 0xfffffffffffffff8 );
   for (uVar10 = ( ulong )(( uVar5 - (int)(undefined8*)( ( ulong )(this + 0x920) & 0xfffffffffffffff8 ) ) + 0x60 >> 3); uVar10 != 0; uVar10 = uVar10 - 1) {
      *puVar16 = 0;
      puVar16 = puVar16 + 1;
   }
   uVar2 = *param_3;
   ...
   *(undefined4*)( this + 0x974 ) = param_3[3];
   if (*(long*)( this + 0x990 ) == 0) {
      lVar11 = 0;
      LAB_00110823:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, uVar19, lVar11, "p_variant", "variant_defines.size()", "", false, false);
   } else {
      ...
      uVar12 = uVar19;
      if (lVar11 == 0) {
         LAB_001106c0:lVar17 = 0;
         uVar12 = uVar19;
         LAB_001106e1:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar12, lVar17, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar4 = (code*)invalidInstructionException();
         ( *pcVar4 )();
      ...
      if (( uVar10 == 0 ) || ( *(uint*)( this + 0xa4c ) <= (uint)uVar10 )) {
         LAB_00110690:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
      } else {
         lVar11 = ( ( uVar10 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0xa48 ) ) * 0xa0 + *(long*)( *(long*)( this + 0xa38 ) + ( ( uVar10 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0xa48 ) ) * 8 );
         ...
         if (*(char*)( lVar11 + 0x90 ) != '\0') {
            ...
            if (lVar11 != 0) {
               ...
               uVar14 = RenderingDevice::get_singleton();
               RenderingDevice::compute_list_bind_compute_pipeline(uVar14, pvVar7, *(undefined8*)( this + (long)(int)uVar18 * 8 + 0xaf8 ));
               uVar14 = RenderingDevice::get_singleton();
               local_68 = 3;
               local_60 = 0;
               local_48 = 0;
   ...
   LAB_001104f0:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      uVar14 = 0x3bf;
      pcVar13 = "Condition \"shader.is_null()\" is true.";
      LAB_00110516:_err_print_error("set_color", "servers/rendering/renderer_rd/effects/copy_effects.cpp", uVar14, pcVar13, 0, 0);
      return;
   }
   LAB_001108bb:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RendererRD::CopyEffects::copy_cubemap_to_dp(RID, RID, Rect2 const&, Vector2 const&, float, float,
   bool) */void RendererRD::CopyEffects::copy_cubemap_to_dp(undefined4 param_1, undefined4 param_2, CopyEffects *this, undefined8 param_4, undefined8 param_5, float *param_6, float *param_7, char param_8) {
   long *plVar1;
   Version *pVVar2;
   CopyEffects *pCVar3;
   CopyEffects CVar4;
   ...
   if (UniformSetCacheRD::singleton == (UniformSetCacheRD*)0x0) {
      if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
         uVar11 = 0x3e9;
         pcVar15 = "Parameter \"uniform_set_cache\" is null.";
         LAB_0011111c:_err_print_error("copy_cubemap_to_dp", "servers/rendering/renderer_rd/effects/copy_effects.cpp", uVar11, pcVar15, 0, 0);
         return;
      }
      goto LAB_00111243;
   }
   ...
   if (iVar8 == 0) {
      ...
      do {
         if (uVar10 == 0) {
            lVar17 = 0;
            LAB_00110c62:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar16, lVar17, "p_index", "size()", "", false, false);
         } else {
   ...
   if (*(long*)( this + 0x1478 ) == 0) {
      lVar16 = 0;
      LAB_0011116e:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 0, lVar16, "p_variant", "variant_defines.size()", "", false, false);
      LAB_00110bb3:_err_print_error("copy_cubemap_to_dp", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x402, "Condition \"shader.is_null()\" is true.", 0, 0);
      if (local_b8[0] != 0) {
         LOCK();
         ...
         *plVar1 = *plVar1 + -1;
         UNLOCK();
         if (*plVar1 == 0) {
            LAB_00111049:Memory::free_static((void*)( local_b8[0] - 0x10 ), false);
         }
      }
   } else {
      ...
      if (pcVar15 == (char*)0x0) {
         LAB_00110e9a:lVar16 = 0;
         LAB_00110e9d:uVar10 = 0;
         LAB_00110eba:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar10, lVar16, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar6 = (code*)invalidInstructionException();
         ( *pcVar6 )();
      ...
      if (( uVar10 == 0 ) || ( *(uint*)( this + 0x1534 ) <= (uint)uVar10 )) {
         LAB_00110e70:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
         goto LAB_00110bb3;
      }
      lVar17 = ( ( uVar10 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x1530 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x1520 ) + ( ( uVar10 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x1530 ) ) * 8 );
      ...
      local_a0[0] = 0;
      pvVar12 = (void*)RenderingDevice::draw_list_begin(_LC46, uVar11, param_5, 0, &local_a8, 0, local_58, 0);
      uVar10 = local_a0[0];
      if (local_a0[0] != 0) {
         LOCK();
         plVar1 = (long*)( local_a0[0] - 0x10 );
      ...
      if (*(long*)( this + 0x1620 ) == 0) {
         ...
         if (*(uint*)( this + 0x1710 ) != 0) {
            ...
            do {
               if (( ( ( *plVar14 == -1 ) && ( lVar17 == plVar14[1] ) ) && ( this[0x162e] == *(CopyEffects*)( (long)plVar14 + 0x14 ) ) ) && ( ( (int)plVar14[2] == 0 && ( (int)plVar14[3] == 0 ) ) )) {
                  lVar17 = plVar14[4];
         ...
         lVar17 = PipelineCacheRD::_generate_version((long)pCVar3, -1, SUB81(lVar17, 0), (uint)(byte)this[0x162e], 0);
         this[0x15e0] = (CopyEffects)0x0;
      }
      LAB_00110f20:RenderingDevice::draw_list_bind_render_pipeline(uVar11, pvVar12, lVar17);
      uVar11 = RenderingDevice::get_singleton();
      uVar10 = local_b8[0];
      local_88[0] = 0;
      local_a8 = 1;
   ...
   LAB_00110bf0:if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   LAB_00111243:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* RendererRD::CopyEffects::cubemap_downsample(RID, RID, Vector2i const&) */void RendererRD::CopyEffects::cubemap_downsample(CopyEffects *this, undefined8 param_2, undefined8 param_3, int *param_4) {
   long *plVar1;
   Version *pVVar2;
   uint *puVar3;
   code *pcVar4;
   ...
   if (*this == (CopyEffects)0x0) {
      if (UniformSetCacheRD::singleton == (UniformSetCacheRD*)0x0) {
         if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
            uVar11 = 0x412;
            pcVar15 = "Parameter \"uniform_set_cache\" is null.";
            LAB_00111af9:_err_print_error("cubemap_downsample", "servers/rendering/renderer_rd/effects/copy_effects.cpp", uVar11, pcVar15, 0, 0);
            return;
         }
         goto LAB_00111c71;
      }
      ...
      *(int*)( this + 0x1718 ) = iVar6;
      ...
      if (iVar6 == 0) {
         ...
         do {
            if (puVar13 == (undefined8*)0x0) {
               lVar16 = 0;
               LAB_00111863:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar9, lVar16, "p_index", "size()", "", false, false);
            } else {
      ...
      if (puVar13 != (undefined8*)0x0) {
         ...
         LAB_00111356:if (local_80 != (undefined8*)0x0) {
            LOCK();
      ...
      if (iVar6 == 0) {
         if (local_80 == (undefined8*)0x0) {
            lVar9 = 0;
            LAB_00111c26:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, 0, lVar9, "p_index", "size()", "", false, false);
            goto LAB_0011139f;
         }
         lVar9 = local_80[-1];
         ...
         *local_80 = param_3;
         puVar13 = local_80;
         LAB_001117fb:local_98[0] = (undefined8*)0x0;
         local_a8 = 0;
         local_b0 = 0;
         local_b8 = 3;
         plVar1 = puVar13 + -2;
         ...
         LAB_0011182a:if (local_80 != (undefined8*)0x0) {
            LOCK();
            plVar1 = local_80 + -2;
            *plVar1 = *plVar1 + -1;
            UNLOCK();
      ...
      if (*(long*)( this + 0x1740 ) == 0) {
         lVar9 = 0;
         LAB_001118b3:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 0, lVar9, "p_variant", "variant_defines.size()", "", false, false);
         LAB_001118f0:_err_print_error("cubemap_downsample", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x420, "Condition \"shader.is_null()\" is true.", 0, 0);
         if (local_98[0] != (undefined8*)0x0) {
            ...
            *plVar1 = *plVar1 + -1;
            UNLOCK();
            if (*plVar1 == 0) {
               LAB_001116fd:Memory::free_static(local_98[0] + -2, false);
            }
         }
      } else {
         ...
         if (pcVar15 == (char*)0x0) {
            LAB_00111a70:lVar9 = 0;
            LAB_00111a73:uVar14 = 0;
            LAB_00111a90:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar14, lVar9, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar4 = (code*)invalidInstructionException();
            ( *pcVar4 )();
         ...
         if (( uVar14 == 0 ) || ( *(uint*)( this + 0x17fc ) <= (uint)uVar14 )) {
            LAB_00111bc0:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
            goto LAB_001118f0;
         }
         lVar16 = ( ( uVar14 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x17f8 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x17e8 ) + ( ( uVar14 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x17f8 ) ) * 8 );
         ...
         pvVar10 = (void*)RenderingDevice::compute_list_begin();
         uVar11 = RenderingDevice::get_singleton();
         RenderingDevice::compute_list_bind_compute_pipeline(uVar11, pvVar10, *(undefined8*)( this + 0x1a20 ));
         uVar11 = RenderingDevice::get_singleton();
         local_68[0] = 0;
         local_88 = 1;
      ...
      _err_print_error("cubemap_downsample", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x40f, "Condition \"prefer_raster_effects\" is true.", "Can\'t use compute based cubemap downsample with the mobile renderer.", 0, 0);
   }
   if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   LAB_00111c71:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* RendererRD::CopyEffects::cubemap_downsample_raster(RID, RID, unsigned int, Vector2i const&) */void RendererRD::CopyEffects::cubemap_downsample_raster(CopyEffects *this, undefined8 param_2, undefined8 param_3, uint param_4, undefined4 *param_5) {
   long *plVar1;
   Version *pVVar2;
   CopyEffects *pCVar3;
   CopyEffects CVar4;
   ...
   local_58[3] = *(long*)( in_FS_OFFSET + 0x28 );
   if (*this == (CopyEffects)0x0) {
      _err_print_error("cubemap_downsample_raster", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x432, "Condition \"!prefer_raster_effects\" is true.", "Can\'t use raster based cubemap downsample with the clustered renderer.", 0, 0);
   } else if (param_4 < 6) {
      if (UniformSetCacheRD::singleton == (UniformSetCacheRD*)0x0) {
         if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
            uVar10 = 0x436;
            pcVar15 = "Parameter \"uniform_set_cache\" is null.";
            LAB_0011242a:_err_print_error("cubemap_downsample_raster", "servers/rendering/renderer_rd/effects/copy_effects.cpp", uVar10, pcVar15, 0, 0);
            return;
         }
         goto LAB_001125d9;
      }
      ...
      *(ulong*)( this + 0x1718 ) = CONCAT44(param_4, *param_5);
      ...
      if (iVar8 == 0) {
         do {
            if (uVar14 == 0) {
               lVar17 = 0;
               LAB_0011205b:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar9, lVar17, "p_index", "size()", "", false, false);
            } else {
      ...
      if (*(long*)( this + 0x18b8 ) != 0) {
         ...
         if (pcVar15 == (char*)0x0) {
            LAB_00112341:lVar9 = 0;
            LAB_00112344:uVar14 = 0;
            LAB_00112361:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar14, lVar9, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar6 = (code*)invalidInstructionException();
            ( *pcVar6 )();
         ...
         if (( uVar14 == 0 ) || ( *(uint*)( this + 0x1974 ) <= (uint)uVar14 )) {
            LAB_001124f9:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
            goto LAB_001120c0;
         }
         lVar17 = ( ( uVar14 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x1970 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x1960 ) + ( ( uVar14 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x1970 ) ) * 8 );
         ...
         if (*(long*)( this + 0x1a68 ) == 0) {
            ...
            if (*(uint*)( this + 7000 ) != 0) {
               ...
               do {
                  if (( ( ( *plVar13 == -1 ) && ( lVar17 == plVar13[1] ) ) && ( this[0x1a76] == *(CopyEffects*)( (long)plVar13 + 0x14 ) ) ) && ( ( (int)plVar13[2] == 0 && ( (int)plVar13[3] == 0 ) ) )) {
                     lVar17 = plVar13[4];
            ...
            lVar17 = PipelineCacheRD::_generate_version((long)pCVar3, -1, SUB81(lVar17, 0), (uint)(byte)this[0x1a76], 0);
            this[0x1a28] = (CopyEffects)0x0;
         }
         LAB_00112170:uVar16 = (int)this + 0x1718;
         ...
         if (local_98[0] == 0) {
            ...
            LAB_00112229:lVar9 = RenderingDevice::get_singleton();
         ...
         *plVar1 = *plVar1 + -1;
         ...
         LAB_00112280:if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
            Memory::free_static((void*)( local_98[0] - 0x10 ), false);
            return;
         }
         goto LAB_001125d9;
      ...
      lVar9 = 0;
      LAB_0011247c:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 0, lVar9, "p_variant", "variant_defines.size()", "", false, false);
      LAB_001120c0:_err_print_error("cubemap_downsample_raster", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x443, "Condition \"shader.is_null()\" is true.", 0, 0);
      if (local_98[0] != 0) {
         LOCK();
         plVar1 = (long*)( local_98[0] - 0x10 );
         *plVar1 = *plVar1 + -1;
      ...
      _err_print_error("cubemap_downsample_raster", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x433, "Condition \"p_face_id >= 6\" is true.", "Raster implementation of cubemap downsample must process one side at a time.", 0, 0);
   }
   LAB_00112100:if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   LAB_001125d9:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* RendererRD::CopyEffects::cubemap_filter_raster(RID, RID, unsigned int, unsigned int) */void RendererRD::CopyEffects::cubemap_filter_raster(CopyEffects *this, undefined8 param_2, undefined8 param_3, uint param_4, undefined4 param_5) {
   long *plVar1;
   Version *pVVar2;
   CopyEffects *pCVar3;
   CopyEffects CVar4;
   ...
   local_58[3] = *(long*)( in_FS_OFFSET + 0x28 );
   if (*this == (CopyEffects)0x0) {
      _err_print_error("cubemap_filter_raster", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x47d, "Condition \"!prefer_raster_effects\" is true.", "Can\'t use raster based cubemap filter with the clustered renderer.", 0, 0);
   } else if (param_4 < 6) {
      if (UniformSetCacheRD::singleton == (UniformSetCacheRD*)0x0) {
         if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
            uVar10 = 0x481;
            pcVar16 = "Parameter \"uniform_set_cache\" is null.";
            LAB_00112da3:_err_print_error("cubemap_filter_raster", "servers/rendering/renderer_rd/effects/copy_effects.cpp", uVar10, pcVar16, 0, 0);
            return;
         }
         goto LAB_00112f0c;
      }
      ...
      if (iVar8 == 0) {
         do {
            if (uVar18 == 0) {
               lVar13 = 0;
               LAB_001129da:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar9, lVar13, "p_index", "size()", "", false, false);
            } else {
      ...
      if (*(long*)( this + 0x1cf0 ) == 0) {
         lVar9 = 0;
         LAB_00112df5:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, uVar17, lVar9, "p_variant", "variant_defines.size()", "", false, false);
         LAB_00112a40:_err_print_error("cubemap_filter_raster", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x492, "Condition \"shader.is_null()\" is true.", 0, 0);
         if (local_a8[0] != 0) {
            LOCK();
         ...
         uVar15 = uVar17;
         if (lVar9 == 0) {
            LAB_00112cb5:lVar13 = 0;
            uVar15 = uVar17;
            LAB_00112cd6:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar15, lVar13, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar5 = (code*)invalidInstructionException();
            ( *pcVar5 )();
         ...
         if (( uVar18 == 0 ) || ( *(uint*)( this + 0x1dac ) <= (uint)uVar18 )) {
            LAB_00112e73:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
            goto LAB_00112a40;
         }
         lVar9 = ( ( uVar18 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x1da8 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x1d98 ) + ( ( uVar18 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x1da8 ) ) * 8 );
         ...
         local_58[0] = 0;
         local_58[1] = 0;
         pvVar11 = (void*)RenderingDevice::draw_list_begin(_LC46, uVar10, param_3, 0, &local_98, 0, local_58, 0);
         uVar18 = local_90[0];
         if (local_90[0] != 0) {
            LOCK();
            plVar1 = (long*)( local_90[0] - 0x10 );
         ...
         if (*(long*)( pCVar3 + 0x40 ) == 0) {
            ...
            if (*(uint*)( this + local_d8 * 0x138 + 0x1fa8 ) != 0) {
               ...
               do {
                  if (( ( ( *plVar14 == -1 ) && ( lVar13 == plVar14[1] ) ) && ( this[local_d8 * 0x138 + 0x1ec6] == *(CopyEffects*)( (long)plVar14 + 0x14 ) ) ) && ( ( (int)plVar14[2] == 0 && ( (int)plVar14[3] == 0 ) ) )) {
                     lVar13 = plVar14[4];
                     *pCVar3 = (CopyEffects)0x0;
                     goto LAB_00112aed;
                  }
            ...
            lVar13 = PipelineCacheRD::_generate_version((long)pCVar3, -1, SUB81(lVar13, 0), (uint)(byte)this[local_d8 * 0x138 + 0x1ec6], 0);
            *pCVar3 = (CopyEffects)0x0;
         }
         LAB_00112aed:RenderingDevice::draw_list_bind_render_pipeline(uVar10, pvVar11, lVar13);
         uVar10 = RenderingDevice::get_singleton();
         uVar18 = local_a8[0];
         local_78[0] = 0;
         local_98 = 1;
         ...
         *plVar1 = *plVar1 + -1;
         ...
         LAB_00112c14:Memory::free_static((void*)( local_a8[0] - 0x10 ), false);
      }
   } else {
      _err_print_error("cubemap_filter_raster", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x47e, "Condition \"p_face_id >= 6\" is true.", "Raster implementation of cubemap filter must process one side at a time.", 0, 0);
   }
   LAB_00112a80:if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   LAB_00112f0c:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* RendererRD::CopyEffects::cubemap_roughness(RID, RID, unsigned int, unsigned int, float, float) */void RendererRD::CopyEffects::cubemap_roughness(float param_1, float param_2, CopyEffects *this, undefined8 param_4, undefined8 param_5, uint param_6, undefined4 param_7) {
   long *plVar1;
   Version *pVVar2;
   uint *puVar3;
   code *pcVar4;
   ...
   if (*this == (CopyEffects)0x0) {
      if (UniformSetCacheRD::singleton == (UniformSetCacheRD*)0x0) {
         if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
            uVar10 = 0x4a3;
            pcVar14 = "Parameter \"uniform_set_cache\" is null.";
            LAB_00113819:_err_print_error("cubemap_roughness", "servers/rendering/renderer_rd/effects/copy_effects.cpp", uVar10, pcVar14, 0, 0);
            return;
         }
         goto LAB_00113991;
      }
      ...
      *(uint*)( this + 0x2384 ) = uVar15;
      ...
      if (iVar6 == 0) {
         ...
         do {
            if (puVar12 == (undefined8*)0x0) {
               lVar16 = 0;
               LAB_0011358b:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar8, lVar16, "p_index", "size()", "", false, false);
            } else {
      ...
      if (puVar12 != (undefined8*)0x0) {
         ...
         LAB_00113088:if (local_80 != (undefined8*)0x0) {
            LOCK();
            plVar1 = (long*)( (long)local_80 + -0x10 );
            *plVar1 = *plVar1 + -1;
            UNLOCK();
      ...
      if (iVar6 == 0) {
         if (local_80 == (undefined8*)0x0) {
            lVar8 = 0;
            LAB_00113946:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, 0, lVar8, "p_index", "size()", "", false, false);
            goto LAB_001130d1;
         }
         lVar8 = local_80[-1];
         ...
         *local_80 = param_5;
         puVar12 = local_80;
         LAB_00113529:local_98[0] = (undefined8*)0x0;
         local_a8 = 0;
         local_b0 = 0;
         local_b8 = 3;
         plVar1 = puVar12 + -2;
         ...
         LAB_00113557:if (local_80 != (undefined8*)0x0) {
            LOCK();
            plVar1 = local_80 + -2;
            *plVar1 = *plVar1 + -1;
            UNLOCK();
      ...
      if (*(long*)( this + 0x23b0 ) == 0) {
         lVar8 = 0;
         LAB_001135db:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 0, lVar8, "p_variant", "variant_defines.size()", "", false, false);
         LAB_00113618:_err_print_error("cubemap_roughness", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x4b7, "Condition \"shader.is_null()\" is true.", 0, 0);
         if (local_98[0] != (undefined8*)0x0) {
            LOCK();
            plVar1 = local_98[0] + -2;
            *plVar1 = *plVar1 + -1;
            UNLOCK();
            if (*plVar1 == 0) {
               LAB_00113427:Memory::free_static(local_98[0] + -2, false);
            }
         }
      } else {
         ...
         if (pcVar14 == (char*)0x0) {
            LAB_00113790:lVar8 = 0;
            LAB_00113793:uVar13 = 0;
            LAB_001137b0:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar13, lVar8, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar4 = (code*)invalidInstructionException();
            ( *pcVar4 )();
         ...
         if (( uVar13 == 0 ) || ( *(uint*)( this + 0x246c ) <= (uint)uVar13 )) {
            LAB_001138e0:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
            goto LAB_00113618;
         }
         lVar16 = ( ( uVar13 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x2468 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x2458 ) + ( ( uVar13 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x2468 ) ) * 8 );
         if (*(int*)( lVar16 + 0x98 ) != (int)( uVar13 >> 0x20 )) {
            if (*(int*)( lVar16 + 0x98 ) + 0x80000000U < 0x7fffffff) {
               _err_print_error("get_or_null", "./core/templates/rid_owner.h", 0x103, "Method/function failed. Returning: nullptr", "Attempting to use an uninitialized RID", 0, 0);
            }
         ...
         pvVar9 = (void*)RenderingDevice::compute_list_begin();
         uVar10 = RenderingDevice::get_singleton();
         RenderingDevice::compute_list_bind_compute_pipeline(uVar10, pvVar9, *(undefined8*)( this + 0x2690 ));
         uVar10 = RenderingDevice::get_singleton();
         local_68[0] = 0;
         local_88 = 1;
         local_80 = (undefined8*)( (ulong)local_80 & 0xffffffffffffff00 );
      ...
      _err_print_error("cubemap_roughness", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x4a0, "Condition \"prefer_raster_effects\" is true.", "Can\'t use compute based cubemap roughness with the mobile renderer.", 0, 0);
   }
   if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   LAB_00113991:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* RendererRD::CopyEffects::cubemap_roughness_raster(RID, RID, unsigned int, unsigned int, float,
   float) */void RendererRD::CopyEffects::cubemap_roughness_raster(float param_1, undefined4 param_2, CopyEffects *this, undefined8 param_4, undefined8 param_5, uint param_6, undefined4 param_7) {
   long *plVar1;
   Version *pVVar2;
   CopyEffects *pCVar3;
   CopyEffects CVar4;
   ...
   local_58[3] = *(long*)( in_FS_OFFSET + 0x28 );
   if (*this == (CopyEffects)0x0) {
      _err_print_error("cubemap_roughness_raster", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x4ca, "Condition \"!prefer_raster_effects\" is true.", "Can\'t use raster based cubemap roughness with the clustered renderer.", 0, 0);
   } else if (param_6 < 6) {
      if (UniformSetCacheRD::singleton == (UniformSetCacheRD*)0x0) {
         if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
            uVar10 = 0x4ce;
            pcVar15 = "Parameter \"uniform_set_cache\" is null.";
            LAB_00114192:_err_print_error("cubemap_roughness_raster", "servers/rendering/renderer_rd/effects/copy_effects.cpp", uVar10, pcVar15, 0, 0);
            return;
         }
         goto LAB_00114345;
      }
      ...
      *(uint*)( this + 0x2384 ) = uVar16;
      ...
      if (iVar8 == 0) {
         do {
            if (uVar14 == 0) {
               lVar17 = 0;
               LAB_00113dcb:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar9, lVar17, "p_index", "size()", "", false, false);
            } else {
               lVar17 = *(long*)( uVar14 - 8 );
      ...
      if (*(long*)( this + 0x2528 ) != 0) {
         ...
         if (pcVar15 == (char*)0x0) {
            LAB_001140a9:lVar9 = 0;
            LAB_001140ac:uVar14 = 0;
            LAB_001140c9:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar14, lVar9, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar6 = (code*)invalidInstructionException();
            ( *pcVar6 )();
         ...
         if (( uVar14 == 0 ) || ( *(uint*)( this + 0x25e4 ) <= (uint)uVar14 )) {
            LAB_00114261:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
            goto LAB_00113e30;
         }
         lVar17 = ( ( uVar14 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x25e0 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x25d0 ) + ( ( uVar14 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x25e0 ) ) * 8 );
         if (*(int*)( lVar17 + 0x98 ) != (int)( uVar14 >> 0x20 )) {
            if (*(int*)( lVar17 + 0x98 ) + 0x80000000U < 0x7fffffff) {
               _err_print_error("get_or_null", "./core/templates/rid_owner.h", 0x103, "Method/function failed. Returning: nullptr", "Attempting to use an uninitialized RID", 0, 0);
            }
         ...
         local_58[0] = 0;
         local_58[1] = 0;
         pvVar11 = (void*)RenderingDevice::draw_list_begin(_LC46, uVar10, param_5, 0, &local_88, 0, local_58, 0);
         uVar14 = local_80[0];
         if (local_80[0] != 0) {
            LOCK();
            plVar1 = (long*)( local_80[0] - 0x10 );
         ...
         if (*(long*)( this + 0x26d8 ) == 0) {
            ...
            if (*(uint*)( this + 0x27c8 ) != 0) {
               ...
               do {
                  if (( ( ( *plVar13 == -1 ) && ( lVar17 == plVar13[1] ) ) && ( this[0x26e6] == *(CopyEffects*)( (long)plVar13 + 0x14 ) ) ) && ( ( (int)plVar13[2] == 0 && ( (int)plVar13[3] == 0 ) ) )) {
                     lVar17 = plVar13[4];
            ...
            lVar17 = PipelineCacheRD::_generate_version((long)pCVar3, -1, SUB81(lVar17, 0), (uint)(byte)this[0x26e6], 0);
            this[0x2698] = (CopyEffects)0x0;
         }
         LAB_00113ee0:RenderingDevice::draw_list_bind_render_pipeline(uVar10, pvVar11, lVar17);
         uVar10 = RenderingDevice::get_singleton();
         uVar14 = local_98[0];
         local_68[0] = 0;
         local_88 = 1;
         ...
         if (local_98[0] == 0) {
            uVar12 = UniformSetCacheRD::get_cache<RenderingDevice::Uniform>(pUVar7, lVar9, 0, &local_88);
            RenderingDevice::draw_list_bind_uniform_set(uVar10, pvVar11, uVar12, 0);
            LAB_00113f92:lVar9 = RenderingDevice::get_singleton();
         ...
         *plVar1 = *plVar1 + -1;
         ...
         LAB_00113fed:if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
            Memory::free_static((void*)( local_98[0] - 0x10 ), false);
            return;
         }
         goto LAB_00114345;
      ...
      lVar9 = 0;
      LAB_001141e4:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 0, lVar9, "p_variant", "variant_defines.size()", "", false, false);
      LAB_00113e30:_err_print_error("cubemap_roughness_raster", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x4e0, "Condition \"shader.is_null()\" is true.", 0, 0);
      if (local_98[0] != 0) {
         LOCK();
         plVar1 = (long*)( local_98[0] - 0x10 );
         *plVar1 = *plVar1 + -1;
      ...
      _err_print_error("cubemap_roughness_raster", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x4cb, "Condition \"p_face_id >= 6\" is true.", "Raster implementation of cubemap roughness must process one side at a time.", 0, 0);
   }
   LAB_00113e70:if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   LAB_00114345:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* RendererRD::CopyEffects::merge_specular(RID, RID, RID, RID, unsigned int) */void RendererRD::CopyEffects::merge_specular(CopyEffects *this, undefined8 param_2, long param_3, long param_4, long param_5, uint param_6) {
   long *plVar1;
   Version *pVVar2;
   CopyEffects *pCVar3;
   CopyEffects CVar4;
   ...
   if (UniformSetCacheRD::singleton == (UniformSetCacheRD*)0x0) {
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         ...
         LAB_0011502c:_err_print_error("merge_specular", "servers/rendering/renderer_rd/effects/copy_effects.cpp", uVar15, pcVar17, 0, 0);
         return;
      }
      goto LAB_0011523b;
   }
   ...
   uVar21 = local_80;
   if (local_80 == 0) {
      LAB_001144b0:if (param_5 == 0) goto LAB_001144bc;
      LAB_0011460f:iVar9 = ( -(uint)(param_4 == 0) & 2 ) + 1;
   } else {
      LOCK();
      plVar1 = (long*)( local_80 + -0x10 );
      *plVar1 = *plVar1 + -1;
      ...
      LAB_001144bc:iVar9 = ( uint )(param_4 == 0) * 2;
   }
   ...
   if (*(long*)( this + 0x27e8 ) == 0) {
      lVar10 = 0;
      LAB_0011507e:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, uVar20, lVar10, "p_variant", "variant_defines.size()", "", false, false);
      local_f0 = 0;
   } else {
      ...
      if (*(char*)( lVar10 + uVar20 ) == '\0') {
         ...
         if (( uVar21 == 0 ) || ( *(uint*)( this + 0x28a4 ) <= (uint)uVar21 )) {
            LAB_001146af:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
         } else {
            lVar10 = ( ( uVar21 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x28a0 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x2890 ) + ( ( uVar21 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x28a0 ) ) * 8 );
            ...
            if (lVar18 == 0) {
               LAB_00114ee3:lVar19 = 0;
               uVar16 = uVar20;
               LAB_00114f04:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar16, lVar19, "p_index", "size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
               pcVar5 = (code*)invalidInstructionException();
               ( *pcVar5 )();
   ...
   LAB_001146dd:uVar12 = RenderingDevice::get_singleton();
   ...
   if (*(long*)( pCVar3 + 0x40 ) == 0) {
      ...
      if (*(uint*)( this + uVar20 * 0x138 + 0x2a80 ) != 0) {
         ...
         do {
            if (( ( ( *plVar14 == -1 ) && ( lVar10 == plVar14[1] ) ) && ( this[uVar20 * 0x138 + 0x299e] == *(CopyEffects*)( (long)plVar14 + 0x14 ) ) ) && ( ( (int)plVar14[2] == 0 && ( (int)plVar14[3] == 0 ) ) )) {
               lVar10 = plVar14[4];
               *pCVar3 = (CopyEffects)0x0;
               goto LAB_001147dd;
            }
      ...
      lVar10 = PipelineCacheRD::_generate_version((long)pCVar3, -1, SUB81(lVar10, 0), (uint)(byte)this[uVar20 * 0x138 + 0x299e], 0);
      *pCVar3 = (CopyEffects)0x0;
   }
   LAB_001147dd:RenderingDevice::draw_list_bind_render_pipeline(uVar12, uVar11, lVar10);
   pcVar17 = _LC110;
   if (param_4 != 0) {
      lVar10 = 0;
      local_80 = 0;
      ...
      if (iVar9 == 0) {
         do {
            if (uVar21 == 0) {
               lVar19 = 0;
               LAB_001150c9:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar10, lVar19, "p_index", "size()", "", false, false);
            } else {
   ...
   if (iVar9 == 0) {
      do {
         if (uVar21 == 0) {
            lVar19 = 0;
            LAB_00114a48:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar10, lVar19, "p_index", "size()", "", false, false);
         } else {
            lVar19 = *(long*)( uVar21 - 8 );
   ...
   if (param_5 != 0) {
      ...
      if (iVar9 == 0) {
         do {
            if (uVar21 == 0) {
               lVar19 = 0;
               LAB_0011510b:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar10, lVar19, "p_index", "size()", "", false, false);
            } else {
               lVar19 = *(long*)( uVar21 + -8 );
      ...
      if (uVar21 != 0) {
         ...
         LAB_00114b4b:uVar21 = local_98[0];
         if (local_80 != 0) {
            LOCK();
            plVar1 = (long*)( local_80 + -0x10 );
            *plVar1 = *plVar1 + -1;
   ...
   LAB_00114986:lVar10 = RenderingDevice::get_singleton();
   ...
   LAB_0011523b:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* RendererRD::CopyEffects::cubemap_filter(RID, Vector<RID>, bool) */void RendererRD::CopyEffects::cubemap_filter(CopyEffects *this, undefined8 param_2, long param_3, byte param_4) {
   long *plVar1;
   Version *pVVar2;
   uint *puVar3;
   undefined8 *puVar4;
   ...
   if (*this == (CopyEffects)0x0) {
      if (UniformSetCacheRD::singleton == (UniformSetCacheRD*)0x0) {
         if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
            uVar10 = 0x453;
            pcVar14 = "Parameter \"uniform_set_cache\" is null.";
            LAB_00115769:_err_print_error("cubemap_filter", "servers/rendering/renderer_rd/effects/copy_effects.cpp", uVar10, pcVar14, 0, 0);
            return;
         }
         goto LAB_00115d2c;
      }
      ...
      if (*(long*)( this + 0x1b78 ) != 0) {
         ...
         if (pcVar14 == (char*)0x0) {
            LAB_00115ae0:lVar16 = 0;
            LAB_00115ae3:uVar11 = 0;
            goto LAB_00115abd;
         }
         ...
         if (( uVar11 == 0 ) || ( *(uint*)( this + 0x1c34 ) <= (uint)uVar11 )) {
            LAB_00115c60:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
            uVar12 = 0;
            goto LAB_00115449;
         }
         lVar19 = ( ( uVar11 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x1c30 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x1c20 ) + ( ( uVar11 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x1c30 ) ) * 8 );
         ...
         LAB_00115bb8:lVar16 = 0;
         goto LAB_00115abd;
      }
      lVar16 = 0;
      LAB_00115a2d:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 0, lVar16, "p_variant", "variant_defines.size()", "", false, false);
      LAB_00115a66:uVar12 = 0;
      LAB_00115449:uVar10 = RenderingDevice::uniform_set_create<Vector<RenderingDevice::Uniform>>(uVar10, local_c8, uVar12, 2);
      local_80 = 0;
      *(undefined8*)( this + 0x2360 ) = uVar10;
      ...
      if (iVar8 == 0) {
         ...
         do {
            if (uVar11 == 0) {
               lVar16 = 0;
               LAB_001157c3:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar9, lVar16, "p_index", "size()", "", false, false);
            } else {
      ...
      if (*(long*)( this + 0x1b78 ) == 0) {
         lVar9 = 0;
         LAB_00115bde:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, uVar18, lVar9, "p_variant", "variant_defines.size()", "", false, false);
         LAB_0011566a:_err_print_error("cubemap_filter", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x46d, "Condition \"shader.is_null()\" is true.", 0, 0);
         if (local_98[0] != 0) {
            LOCK();
            plVar1 = (long*)( local_98[0] - 0x10 );
            *plVar1 = *plVar1 + -1;
            UNLOCK();
            if (*plVar1 == 0) {
               LAB_00115a15:Memory::free_static((void*)( local_98[0] - 0x10 ), false);
            }
         }
      } else {
         ...
         uVar11 = uVar18;
         if (lVar9 == 0) {
            LAB_00115a9c:lVar16 = 0;
            uVar11 = uVar18;
            LAB_00115abd:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar11, lVar16, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar5 = (code*)invalidInstructionException();
            ( *pcVar5 )();
         ...
         if (( uVar17 == 0 ) || ( *(uint*)( this + 0x1c34 ) <= (uint)uVar17 )) {
            LAB_00115cf8:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
            goto LAB_0011566a;
         }
         lVar9 = ( ( uVar17 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x1c30 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x1c20 ) + ( ( uVar17 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x1c30 ) ) * 8 );
         ...
         uVar12 = RenderingDevice::get_singleton();
         RenderingDevice::compute_list_bind_compute_pipeline(uVar12, uVar10, *(undefined8*)( this + uVar18 * 8 + 0x1e58 ));
         uVar12 = RenderingDevice::get_singleton();
         local_68[0] = 0;
         local_88 = local_b8;
         ...
         lVar9 = RenderingDevice::get_singleton();
         RenderingDevice::compute_list_dispatch(lVar9, (uint)uVar10, ( -(uint)(param_4 == 0) & 0xfffffa56 ) + 0x700, 6);
         RenderingDevice::get_singleton();
         RenderingDevice::compute_list_end();
         if (uVar17 != 0) {
            LOCK();
      ...
      LAB_001156a8:CowData<RenderingDevice::Uniform>::_unref((CowData<RenderingDevice::Uniform>*)&local_c0);
   } else {
      _err_print_error("cubemap_filter", "servers/rendering/renderer_rd/effects/copy_effects.cpp", 0x450, "Condition \"prefer_raster_effects\" is true.", "Can\'t use compute based cubemap filter with the mobile renderer.", 0, 0);
   }
   if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   LAB_00115d2c:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* BlurRasterShaderRD::~BlurRasterShaderRD() */void BlurRasterShaderRD::~BlurRasterShaderRD(BlurRasterShaderRD *this) {
   ...
   *(undefined***)this = &PTR__BlurRasterShaderRD_00119ae0;
   ...
   return;
}/* CopyShaderRD::~CopyShaderRD() */void CopyShaderRD::~CopyShaderRD(CopyShaderRD *this) {
   ...
   *(undefined***)this = &PTR__CopyShaderRD_00119b00;
   ...
   operator_delete(this, 0x178);
   return;
}/* CopyToFbShaderRD::~CopyToFbShaderRD() */void CopyToFbShaderRD::~CopyToFbShaderRD(CopyToFbShaderRD *this) {
   ...
   *(undefined***)this = &PTR__CopyToFbShaderRD_00119b20;
   ...
   operator_delete(this, 0x178);
   return;
}/* CubeToDpShaderRD::~CubeToDpShaderRD() */void CubeToDpShaderRD::~CubeToDpShaderRD(CubeToDpShaderRD *this) {
   ...
   *(undefined***)this = &PTR__CubeToDpShaderRD_00119b40;
   ...
   operator_delete(this, 0x178);
   return;
}/* CubemapDownsamplerShaderRD::~CubemapDownsamplerShaderRD() */void CubemapDownsamplerShaderRD::~CubemapDownsamplerShaderRD(CubemapDownsamplerShaderRD *this) {
   ...
   *(undefined***)this = &PTR__CubemapDownsamplerShaderRD_00119b60;
   ...
   operator_delete(this, 0x178);
   return;
}/* CubemapDownsamplerRasterShaderRD::~CubemapDownsamplerRasterShaderRD() */void CubemapDownsamplerRasterShaderRD::~CubemapDownsamplerRasterShaderRD(CubemapDownsamplerRasterShaderRD *this) {
   ...
   *(undefined***)this = &PTR__CubemapDownsamplerRasterShaderRD_00119b80;
   ...
   operator_delete(this, 0x178);
   return;
}/* CubemapFilterShaderRD::~CubemapFilterShaderRD() */void CubemapFilterShaderRD::~CubemapFilterShaderRD(CubemapFilterShaderRD *this) {
   ...
   *(undefined***)this = &PTR__CubemapFilterShaderRD_00119ba0;
   ...
   operator_delete(this, 0x178);
   return;
}/* CubemapFilterRasterShaderRD::~CubemapFilterRasterShaderRD() */void CubemapFilterRasterShaderRD::~CubemapFilterRasterShaderRD(CubemapFilterRasterShaderRD *this) {
   ...
   *(undefined***)this = &PTR__CubemapFilterRasterShaderRD_00119bc0;
   ...
   operator_delete(this, 0x178);
   return;
}/* CubemapRoughnessShaderRD::~CubemapRoughnessShaderRD() */void CubemapRoughnessShaderRD::~CubemapRoughnessShaderRD(CubemapRoughnessShaderRD *this) {
   ...
   *(undefined***)this = &PTR__CubemapRoughnessShaderRD_00119be0;
   ...
   operator_delete(this, 0x178);
   return;
}/* CubemapRoughnessRasterShaderRD::~CubemapRoughnessRasterShaderRD() */void CubemapRoughnessRasterShaderRD::~CubemapRoughnessRasterShaderRD(CubemapRoughnessRasterShaderRD *this) {
   ...
   *(undefined***)this = &PTR__CubemapRoughnessRasterShaderRD_00119c00;
   ...
   operator_delete(this, 0x178);
   return;
}/* SpecularMergeShaderRD::~SpecularMergeShaderRD() */void SpecularMergeShaderRD::~SpecularMergeShaderRD(SpecularMergeShaderRD *this) {
   ...
   *(undefined***)this = &PTR__SpecularMergeShaderRD_00119c20;
   ...
   if (lVar10 == 0) {
      _err_print_error("_allocate_from_data", "./servers/rendering/renderer_rd/framebuffer_cache_rd.h", 0xab, "Condition \"rid.is_null()\" is true. Returning: rid", 0, 0);
      return 0;
   }
   ...
   *pauVar1 = (undefined1[16])0x0;
   ...
   if (lVar11 == 0) {
      LAB_001169b8:lVar11 = *(long*)( param_5 + 8 );
      if (( lVar11 == 0 ) || ( local_48 = local_48 == 0 )) {
         LAB_00116ba0:*(undefined8*)*pauVar1 = 0;
      ...
      if (*(uint*)( pauVar1[3] + 4 ) < local_48) {
         ...
         *(long*)( pauVar1[3] + 8 ) = lVar11;
         if (lVar11 == 0) {
            LAB_00116da1:_err_print_error("resize", "./core/templates/local_vector.h", 0xa3, "FATAL: Condition \"!data\" is true.", "Out of memory", 0, 0);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar5 = (code*)invalidInstructionException();
            ( *pcVar5 )();
      ...
      *(uint*)pauVar1[2] = uVar6;
      ...
      local_48 = 0;
      LAB_001168be:uVar21 = (ulong)local_48;
      lVar11 = uVar21 * 0x48;
      do {
      ...
      *(uint*)pauVar1[3] = local_48;
      uVar6 = local_48;
      LAB_0011699d:if (uVar6 == 0) goto LAB_00116ba0;
      lVar11 = *(long*)( param_5 + 8 );
   }
   uVar12 = 0;
   while (lVar11 != 0) {
   ...
   lVar15 = 0;
   LAB_00116b1e:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar12, lVar15, "p_index", "size()", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar5 = (code*)invalidInstructionException();
   ( *pcVar5 )();
      ...
      if (( lVar9 != 0 ) && ( uVar4 = uVar4 != 0 )) {
         ...
         *(uint*)pauVar1[3] = uVar4;
         ...
         do {
            ...
            if (lVar2 == 0) {
               lVar15 = 0;
               LAB_00117023:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar9, lVar15, "p_index", "size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
               pcVar3 = (code*)invalidInstructionException();
               ( *pcVar3 )();
   ...
   *(undefined8*)this = 0;
   ...
   if (param_1 * 8 == 0) {
      LAB_00117670:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   uVar8 = param_1 * 8 - 1;
   uVar8 = uVar8 >> 1 | uVar8;
   ...
   if (lVar10 == lVar7) {
      LAB_001175ef:puVar9 = *(undefined8**)this;
      if (puVar9 == (undefined8*)0x0) {
         LAB_001176c6:/* WARNING: Does not return */pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
      }
      lVar6 = puVar9[-1];
   ...
   if (param_1 * 8 == 0) {
      LAB_00118600:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   uVar4 = param_1 * 8 - 1;
   uVar4 = uVar4 >> 1 | uVar4;
   ...
   if (lVar7 == lVar3) {
      LAB_0011856c:puVar9 = *(undefined8**)this;
      if (puVar9 == (undefined8*)0x0) {
         /* WARNING: Does not return */
         pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
   ...
   LAB_00118501:puVar9[-1] = param_1;
   return 0;
}/* RID FramebufferCacheRD::get_cache<RID>(RID) */undefined8 FramebufferCacheRD::get_cache<RID>(FramebufferCacheRD *this, long param_2) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   uint uVar4;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   uVar4 = ( (int)param_2 * 0x16a88000 | ( uint )((int)param_2 * -0x3361d2af) >> 0x11 ) * 0x1b873593 ^ 0xb3e1e8c0;
   uVar4 = ( iVar5 * 0x16a88000 | ( uint )(iVar5 * -0x3361d2af) >> 0x11 ) * 0x1b873593 ^ ( uVar4 << 0xd | uVar4 >> 0x13 ) * 5 + 0xe6546b64;
   ...
   for (lVar8 = *(long*)( this + ( ulong )(uVar4 % 0x3ffd) * 8 + 0x1e0 ); lVar8 != 0; lVar8 = *(long*)( lVar8 + 8 )) {
      if (( ( ( *(uint*)( lVar8 + 0x10 ) == uVar4 ) && ( *(int*)( lVar8 + 0x30 ) == 0 ) ) && ( *(int*)( lVar8 + 0x20 ) == 1 ) ) && ( ( *(int*)( lVar8 + 0x40 ) == 1 && ( param_2 == **(long**)( lVar8 + 0x28 ) ) ) )) {
   ...
   LAB_00118770:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar6;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   *(undefined8*)this = 0;
   ...
   if (param_1 * 0x20 == 0) {
      LAB_00118d70:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (lVar11 == lVar4) {
      LAB_00118cdc:puVar9 = *(undefined8**)this;
      if (puVar9 == (undefined8*)0x0) {
         /* WARNING: Does not return */
         pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
   ...
   if (param_1 * 0x28 == 0) {
      LAB_00119110:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (lVar11 == lVar9) {
      LAB_00119083:puVar7 = *(undefined8**)this;
      if (puVar7 == (undefined8*)0x0) {
         LAB_00119166:/* WARNING: Does not return */pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
      }
      lVar8 = puVar7[-1];
   ...
   if (uVar11 != 0) {
      uVar14 = 1;
      LAB_00119576:uVar15 = 0;
      do {
         if (uVar11 == 0) {
            uVar11 = param_4[4];
            if (uVar11 == 0) {
               lVar12 = 0;
               LAB_00119681:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar15, lVar12, "p_index", "size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
               pcVar5 = (code*)invalidInstructionException();
               ( *pcVar5 )();
            ...
            LAB_00119599:iVar8 = (int)( uVar11 >> 0x20 );
   ...
   if (( param_4[4] != 0 ) && ( uVar15 = *(ulong*)( param_4[4] - 8 ) ),uVar14 = uVar15 & 0xffffffff,(int)uVar15 != 0) goto LAB_00119576;
   goto LAB_001192e0;
   LAB_00119600:auVar16._8_8_ = 0;
   auVar16._0_8_ = *param_4;
   LAB_001192e0:uVar7 = ( uVar7 >> 0x10 ^ uVar7 ) * -0x7a143595;
   uVar7 = ( uVar7 ^ uVar7 >> 0xd ) * -0x3d4d51cb;
   uVar7 = uVar7 ^ uVar7 >> 0x10;
   lVar2 = *(long*)( this + ( ulong )(uVar7 % 0x3ffd) * 8 + 0x1e0 );
   uVar6 = auVar16._0_8_;
   uVar10 = local_68;
   joined_r0x00119343:local_68 = uVar6;
   if (lVar2 == 0) {
      ...
      LAB_00119543:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Subroutine does not return */
         __stack_chk_fail();
      }
      return uVar10;
         ...
         if (*(long*)( piVar3 + 4 ) == 0) {
            if (*(long*)( piVar3 + 8 ) == 0) {
               ...
               if (param_4[4] != 0) {
                  ...
                  joined_r0x00119809:if (uVar9 != 0) goto LAB_00119350;
               }
               LAB_0011972d:uVar10 = *(undefined8*)( lVar2 + 0x28 );
               goto LAB_00119543;
            }
            ...
            if (uVar11 != 0) {
               ...
               do {
                  ...
                  if (uVar11 == 0) {
                     ...
                     uVar15 = 0;
                     if (uVar13 == 0) {
                        LAB_00119403:lVar4 = *(long*)( piVar3 + 8 );
                        if (lVar4 == 0) {
                           lVar12 = 0;
                           goto LAB_00119681;
                        }
                     ...
                     uVar11 = 0;
                     LAB_00119484:_err_print_error("get_id", "./servers/rendering/rendering_device.h", 0x3ca, "Condition \"p_idx != 0\" is true. Returning: RID()", 0, 0);
                     uVar13 = 0;
                  }
   ...
   LAB_00119350:lVar2 = *(long*)( lVar2 + 8 );
   uVar6 = auVar16._0_8_;
   uVar10 = local_68;
   goto joined_r0x00119343;
   LAB_0011982b:auVar16._8_8_ = 0;
   auVar16._0_8_ = *param_4;
   goto LAB_00119350;
}/* WARNING: Control flow encountered bad instruction data *//* SpecularMergeShaderRD::~SpecularMergeShaderRD() */void SpecularMergeShaderRD::~SpecularMergeShaderRD(SpecularMergeShaderRD *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}/* WARNING: Control flow encountered bad instruction data *//* CubemapRoughnessRasterShaderRD::~CubemapRoughnessRasterShaderRD() */void CubemapRoughnessRasterShaderRD::~CubemapRoughnessRasterShaderRD(CubemapRoughnessRasterShaderRD *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}/* WARNING: Control flow encountered bad instruction data *//* CubemapRoughnessShaderRD::~CubemapRoughnessShaderRD() */void CubemapRoughnessShaderRD::~CubemapRoughnessShaderRD(CubemapRoughnessShaderRD *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}/* WARNING: Control flow encountered bad instruction data *//* CubemapFilterRasterShaderRD::~CubemapFilterRasterShaderRD() */void CubemapFilterRasterShaderRD::~CubemapFilterRasterShaderRD(CubemapFilterRasterShaderRD *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}/* WARNING: Control flow encountered bad instruction data *//* CubemapFilterShaderRD::~CubemapFilterShaderRD() */void CubemapFilterShaderRD::~CubemapFilterShaderRD(CubemapFilterShaderRD *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}/* WARNING: Control flow encountered bad instruction data *//* CubemapDownsamplerRasterShaderRD::~CubemapDownsamplerRasterShaderRD() */void CubemapDownsamplerRasterShaderRD::~CubemapDownsamplerRasterShaderRD(CubemapDownsamplerRasterShaderRD *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}/* WARNING: Control flow encountered bad instruction data *//* CubemapDownsamplerShaderRD::~CubemapDownsamplerShaderRD() */void CubemapDownsamplerShaderRD::~CubemapDownsamplerShaderRD(CubemapDownsamplerShaderRD *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}/* WARNING: Control flow encountered bad instruction data *//* CubeToDpShaderRD::~CubeToDpShaderRD() */void CubeToDpShaderRD::~CubeToDpShaderRD(CubeToDpShaderRD *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}/* WARNING: Control flow encountered bad instruction data *//* CopyToFbShaderRD::~CopyToFbShaderRD() */void CopyToFbShaderRD::~CopyToFbShaderRD(CopyToFbShaderRD *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}/* WARNING: Control flow encountered bad instruction data *//* CopyShaderRD::~CopyShaderRD() */void CopyShaderRD::~CopyShaderRD(CopyShaderRD *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}/* WARNING: Control flow encountered bad instruction data *//* BlurRasterShaderRD::~BlurRasterShaderRD() */void BlurRasterShaderRD::~BlurRasterShaderRD(BlurRasterShaderRD *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* double built_in_strtod<char32_t>(char32_t const*, char32_t**) */double built_in_strtod<char32_t>(wchar32 *param_1, wchar32 **param_2) {
   ...
   do {
      ...
      do {
         ...
         do {
            ...
            TranslationServer::tool_translate_plural((StringName*)&local_60, pSVar3, iVar6, (StringName*)&local_70);
            if (local_60 == 0) {
               local_80 = 0;
               lVar8 = 0;
               if (StringName::configured != '\0') goto LAB_0010898c;
               LAB_00108b70:lVar8 = 0;
            }
 else {
 ...
 while ( !bVar9 );
                  ...
                  LAB_00108968:lVar8 = local_80;
                  if (StringName::configured != '\0') {
                     if (local_60 != 0) {
                        LAB_00108979:lVar8 = local_80;
                        StringName::unref();
                        if (StringName::configured == '\0') goto LAB_001089ce;
                     }

                     LAB_0010898c:if (( ( ( local_78 == 0 ) || ( StringName::unref(),StringName::configured != '\0' ) ) && ( ( local_70 == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) ) ) && ( local_68 != 0 )) {
                        StringName::unref();
                     }

                  }

                  LAB_001089ce:if (lVar8 == 0) goto LAB_00108b70;
                  if (1 < *(uint*)( lVar8 + -8 )) {
                     cVar4 = String::operator ==((String*)&local_80, param_2);
                     if (( cVar4 == '\0' ) && ( cVar4 = String::operator ==((String*)&local_80, (String*)pCVar7) ),cVar4 == '\0') {
                        *(long*)param_1 = lVar8;
                        goto LAB_00108af0;
                     }
            ...
            if (local_60 == 0) {
               *(undefined8*)param_1 = 0;
               LAB_00108a98:if (StringName::configured != '\0') {
                  LAB_00108a9c:if (( ( ( local_78 == 0 ) || ( StringName::unref(),StringName::configured != '\0' ) ) && ( ( local_70 == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) ) ) && ( local_68 != 0 )) {
                     StringName::unref();
                  }
               ...
               *(undefined8*)param_1 = 0;
               if (pcVar2 == (char*)0x0) {
                  ...
                  LAB_00108a76:if (StringName::configured != '\0') {
                     if (local_60 != 0) {
                        LAB_00108a87:StringName::unref();
                        goto LAB_00108a98;
                     }
            ...
            LAB_00108af0:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
 ...
 while ( *pwVar2 != L'\0' );
         ...
         if (lVar4 != 0) {
            ...
            _err_print_error("copy_from", "core/string/ustring.cpp", 0x90, "Condition \"err != OK\" is true.", "Failed to copy char16_t string.", 0);
            return (void*)0x0;
         }
 ...
 while ( true );
   {
      ...
      if (0x12 < bVar8) {
         if (0xccccccccccccccc < uVar7) {
            if (bVar2) {
               LAB_001096ee:local_58 = "too large.";
               bVar2 = true;
            }
 else {
               LAB_00109506:local_58 = "too small.";
               bVar2 = false;
            }
            ...
            _err_print_error("_to_int", "core/string/ustring.cpp", 0x9a7, "Condition \"overflow\" is true. Returning: positive ? (9223372036854775807L) : (-9223372036854775807L-1)", (CowData<char32_t>*)&local_58, 0, 0);
...
while (param_1 + param_2 != pcVar6) ;;;LAB_001094a3:uVar4 = -uVar7;if (bVar2) {
   uVar4 = uVar7;
}
goto LAB_001094b0;}
  }uVar4 = 0;LAB_001094b0:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return uVar4;}/* String::to_int() const */ulong String::to_int(String *this) {
   uint uVar1;
   long lVar2;
   long lVar3;
   code *pcVar4;
         ...
         LAB_00109791:if (0 < iVar9) {
            ...
            do {
               if (lVar8 != lVar3) {
                ...
                operator+((String *)&
                        local_58,local_68;
                        _err_print_error("_to_int", "core/string/ustring.cpp", 0x9a7, "Condition \"overflow\" is true. Returning: positive ? (9223372036854775807L) : (-9223372036854775807L-1)", (String*)&local_58, 0, 0);
                        CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
                        CowData<char32_t>::_unref((CowData<char32_t>*)local_68);
                        CowData<char32_t>::_unref((CowData<char32_t>*)&local_78);
                        CowData<char32_t>::_unref((CowData<char32_t>*)&local_80);
 ...
 while ( lVar8 != iVar9 );
   ...
   while (lVar8 = lVar8 + 1,lVar3 != lVar8) {
      LAB_00109789:if (*(int*)( lVar2 + lVar8 * 4 ) == 0x2e) {
         iVar9 = (int)lVar8;
         goto LAB_00109791;
      }
...
;
   LAB_001097f8:uVar7 = 0;
   LAB_001097fa:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* String::num_int64(long, int, bool) */String * __thiscall String::num_int64(String *this,long param_1,int param_2,bool param_3){
   long *plVar1;
   long lVar2;
   long lVar3;
   int *piVar4;
 ...
 while ( lVar3 != 0 );
      ...
      *(char**)this = local_58;
      ...
      if (local_78 == 0) {
         ...
         operator+=((String *)&
         local_58,(String*)&local_60;
         _err_print_error("num_int64", "core/string/ustring.cpp", 0x6a2, "Condition \"base < 2 || base > 36\" is true. Returning: \"\"", (CowData<char32_t>*)&local_58, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
      }
 else {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* String::num_real(double, bool) */String * __thiscall String::num_real(String *this,double param_1,bool param_2){
   long *plVar1;
   undefined *puVar2;
   long lVar3;
   long in_FS_OFFSET;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* String::num_real(float, bool) */String * __thiscall String::num_real(String *this,float param_1,bool param_2){
   long *plVar1;
   undefined *puVar2;
   long lVar3;
   long in_FS_OFFSET;
...
/* itos(long) */long itos(long param_1) {
   long lVar1;
   long in_RSI;
   long in_FS_OFFSET;
...
/* String::num_uint64(unsigned long, int, bool) */String * __thiscall String::num_uint64(String *this,ulong param_1,int param_2,bool param_3){
   long *plVar1;
 ...
 while ( bVar10 );
      *(char**)this = local_58;
      ...
      operator+=((String *)&
      local_58,(String*)&local_60;
      _err_print_error("num_uint64", "core/string/ustring.cpp", 0x6ca, "Condition \"base < 2 || base > 36\" is true. Returning: \"\"", (CowData<char32_t>*)&local_58, 0, 0);
      pcVar4 = local_58;
...
/* uitos(unsigned long) */ulong uitos(ulong param_1) {
   long lVar1;
   ulong in_RSI;
   long in_FS_OFFSET;
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
...
/* String::replace(char const*, char const*) const */char *String::replace(char *param_1, char *param_2) {
   long lVar1;
   bool in_CL;
   char *in_RDX;
   long in_FS_OFFSET;
...
/* String::c_unescape() const */void String::c_unescape(void) {
   long *plVar1;
   long lVar2;
   CowData *in_RSI;
...
/* String::c_escape() const */void String::c_escape(void) {
   long *plVar1;
   long lVar2;
   CowData *in_RSI;
   CowData<char32_t> *in_RDI;
...
/* String::c_escape_multiline() const */void String::c_escape_multiline(void) {
   long *plVar1;
   long lVar2;
   CowData *in_RSI;
   CowData<char32_t> *in_RDI;
...
/* String::property_name_encode() const */void String::property_name_encode(void) {
   long *plVar1;
   int iVar2;
   long lVar3;
   int *piVar4;
   ...
   do {
      if (iVar2 == 0) {
         *(undefined8*)in_RDI = 0;
         ...
         LAB_0010b7fa:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            return;
         }
      ...
      piVar4 = piVar4 + 1;
      if (( 0x5d < iVar2 - 0x21U ) || ( iVar2 - 0x22U < 0x3c && ( 0xf5fffffff5fffffeU >> ( ( ulong )(iVar2 - 0x22U) & 0x3f ) & 1 ) == 0 )) {
         local_60 = 0;
         local_58 = &_LC51;
         local_50 = 1;
         parse_latin1((String*)&local_60, (StrRange*)&local_58);
...
/* String::json_escape() const */void String::json_escape(void) {
   long *plVar1;
   long lVar2;
   CowData *in_RSI;
   CowData<char32_t> *in_RDI;
...
/* String::xml_escape(bool) const */CowData<char32_t> *String::xml_escape(bool param_1) {
   long *plVar1;
   long lVar2;
   char in_DL;
   CowData *in_RSI;
...
/* String::replacen(char const*, char const*) const */char *String::replacen(char *param_1, char *param_2) {
   long lVar1;
   bool in_CL;
   char *in_RDX;
   long in_FS_OFFSET;
...
/* String::pad_zeros(int) const */long *String::pad_zeros(int param_1) {
   long *plVar1;
   code *pcVar2;
   long lVar3;
   long lVar4;
            ...
            LAB_0010c106:if (iVar7 != 0) {
               if (0 < iVar7) {
                  ...
                  do {
                     ...
                     if (lVar4 != lVar3) {
                        if (lVar3 <= lVar4) {
                           _err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar4, lVar3, "p_index", "size()", "", false, true);
                           _err_flush_stdout();
                           /* WARNING: Does not return */
 ...
 while ( lVar4 != iVar7 );
               ...
               LAB_0010c14b:if (0 < in_EDX - iVar7) {
                  local_60 = 0;
                  local_50 = 1;
                  local_58 = &_LC124;
                  parse_latin1((String*)&local_60, (StrRange*)&local_58);
   ...
   *(long*)CONCAT44(in_register_0000003c, param_1) = lVar6;
   LAB_0010c1ee:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* String::validate_ascii_identifier() const */void String::validate_ascii_identifier(void) {
   long *plVar1;
   uint uVar2;
   int *piVar3;
   long lVar4;
   ...
   if (*piVar3 - 0x30U < 10) {
      ...
      if (local_40 != (uint*)0x0) {
         ...
         local_48 = puVar7;
         LAB_0010c37a:iVar8 = (int)*(undefined8*)( local_48 + -2 );
         if (iVar8 != 0) {
            ...
            if (1 < iVar8) {
               ...
               do {
                  while (uVar2 = *puVar7,0x39 < uVar2) {
                     if (( 0x39 < uVar2 - 0x41 ) || ( ( 0x3ffffff43ffffffU >> ( ( ulong )(uVar2 - 0x41) & 0x3f ) & 1 ) == 0 )) goto LAB_0010c3d3;
                     LAB_0010c3be:puVar7 = puVar7 + 1;
                     if (local_48 + ( ulong )(iVar8 - 2) + 1 == puVar7) goto LAB_0010c3e2;
                  }
;
                  if (0x2f < uVar2) goto LAB_0010c3be;
                  LAB_0010c3d3:*puVar7 = 0x5f;
                  puVar7 = puVar7 + 1;
               }
 while ( local_48 + ( ulong )(iVar8 - 2) + 1 != puVar7 );
            }

            LAB_0010c3e2:*(uint**)in_RDI = local_48;
            goto LAB_0010c2d8;
         }
 ...
 while ( !bVar9 );
      ...
      LAB_0010c415:if (local_48 != (uint*)0x0) goto LAB_0010c37a;
   }

   CowData<char32_t>::_copy_on_write((CowData<char32_t>*)&local_48);
   *(uint**)in_RDI = local_48;
   LAB_0010c2d8:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* String::validate_unicode_identifier() const */void String::validate_unicode_identifier(void) {
   long lVar1;
   code *pcVar2;
   int iVar3;
   long lVar4;
 ...
 while ( true );
   ...
   *(undefined8*)in_RDI = 0;
   ...
   parse_latin1(in_RDI, (StrRange*)&local_38);
   goto LAB_0010c4fa;
   LAB_0010c597:local_40 = (uint*)0x0;
   local_38 = &_LC125;
   local_30 = 1;
   parse_latin1((String*)&local_40, (StrRange*)&local_38);
   operator+=((String *)&
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_48);
   local_48 = puVar9;
   LAB_0010c5ef:iVar8 = (int)*(undefined8*)( local_48 + -2 );
   if (iVar8 == 0) goto LAB_0010c6c4;
   CowData<char32_t>::_copy_on_write((CowData<char32_t>*)&local_48);
   if (1 < iVar8) {
      puVar9 = local_48;
      LAB_0010c620:uVar6 = 0xf900;
      iVar5 = 799;
      iVar7 = 0;
      iVar3 = 399;
      do {
 ...
 while ( true );
   ...
   goto LAB_0010c68b;
   LAB_0010c67b:*puVar9 = 0x5f;
   LAB_0010c682:puVar9 = puVar9 + 1;
 ...
 while ( !bVar10 );
   ...
   LAB_0010c6b8:if (local_48 != (uint*)0x0) goto LAB_0010c5ef;
   LAB_0010c6c4:CowData<char32_t>::_copy_on_write((CowData<char32_t>*)&local_48);
   LAB_0010c68b:*(uint**)in_RDI = local_48;
   LAB_0010c4fa:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* String::sprintf(Array const&, bool*) const */Array *String::sprintf(Array *param_1, bool *param_2) {
   long *plVar1;
   float fVar2;
   bool bVar3;
   bool bVar4;
...
/* String::print_unicode_error(String const&, bool) const [clone .part.0] */void String::print_unicode_error(String *param_1, bool param_2) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long lVar4;
...
/* String::print_unicode_error(String const&, bool) const [clone .constprop.0] */void String::print_unicode_error(String *param_1, bool param_2) {
   long *plVar1;
   long lVar2;
   undefined *puVar3;
   long lVar4;
...
/* String::utf16() const */void String::utf16(void) {
   long *plVar1;
   uint *puVar2;
   uint uVar3;
   long lVar4;
...
/* String::to_ascii_buffer() const */void String::to_ascii_buffer(void) {
   ...
   if (( *in_RSI == 0 ) || ( *(uint*)( *in_RSI + -8 ) < 2 )) {
      *(undefined8*)( in_RDI + 8 ) = 0;
      ...
      __src = local_50[0];
      local_40[0] = (void*)0x0;
      if (( local_50[0] == (void*)0x0 ) || ( iVar3 = (int)*(undefined8*)( (long)local_50[0] + -8 ) ),iVar3 == 0) {
         __n = 0;
      }
 else {
         __n = (size_t)( iVar3 + -1 );
...
LAB_00111e9e:
 ...
 while ( lVar3 != lVar4 );
   ...
   String * __thiscallString::humanize_size(String * this, ulong, param_1);
   {
      long *plVar1;
      undefined8 *puVar2;
      ulong uVar3;
 ...
 while ( iVar5 != 6 );
   ...
   String * __thiscallString::get_invalid_node_name_characters(String * this, bool, param_1);
   {
      long *plVar1;
      long lVar2;
      wchar32 wVar3;
               ...
               do {
                  ...
                  if (*piVar10 == 0x1c) {
                     ...
                     if (iVar6 == 2) {
                        ...
                        _replace_common((String*)&local_90, in_RCX, (String*)&local_98, SUB81((Variant*)&local_a8, 0));
                        _replace_common((String*)&local_88, (String*)param_1, (String*)&local_90, SUB81((Variant*)&local_a0, 0));
                        pcVar5 = local_88;
                        ...
                        do {
                           if (*(int*)( lVar4 + lVar12 * 4 ) == 0x5f) {
                              if ((int)lVar12 != -1) {
                                 ...
                                 local_80 = 1;
                                 parse_latin1((String*)&local_98, (StrRange*)&local_88);
                                 _replace_common((String*)&local_90, in_RCX, (String*)&local_98, SUB81((String*)&local_b8, 0));
                                 _replace_common((String*)&local_88, (String*)param_1, (String*)&local_90, SUB81((Variant*)&local_a0, 0));
                                 pcVar5 = local_88;
                                 if (*(char**)param_1 == local_88) {
                                    if (local_88 != (char*)0x0) {
 ...
 while ( (int)lVar13 < iVar6 );
            ...
            if (( local_b0 != (long*)0x0 ) && ( lVar13 = lVar13 != 0 )) {
               do {
                  ...
                  _replace_common((String*)&local_88, (String*)param_1, (String*)&local_98, SUB81((Variant*)&local_90, 0));
                  pcVar5 = *(char**)param_1;
                  if (pcVar5 == local_88) {
                     if (pcVar5 != (char*)0x0) {
                        LOCK();
            ...
            if (pLVar9 == (List*)0x0) {
               ...
               if (( local_b0 != (long*)0x0 ) && ( lVar13 = lVar13 != 0 )) {
                  do {
                     ...
                     local_80 = 1;
                     parse_latin1((String*)&local_a8, (StrRange*)&local_88);
                     _replace_common((String*)&local_a0, in_RCX, (String*)&local_a8, SUB81((String*)( lVar13 + 8 ), 0));
                     _replace_common((String*)&local_88, (String*)param_1, (String*)&local_a0, SUB81((Variant*)&local_90, 0));
                     pcVar5 = *(char**)param_1;
                     if (pcVar5 == local_88) {
                        if (pcVar5 != (char*)0x0) {
                           LOCK();
...
else{LAB_0011465d:if (param_2 != 0){bVar3 = true;
      bVar8 = 0;
      uVar7 = 0;
      pwVar4 = param_1;
      do{while( true ){wVar2 = *pwVar4;
...
LAB_0011472f:
              ...
              gotoLAB_001146d3;}if (uVar7 == 0xccccccccccccccc) {
              if ((L'7' < wVar2) && (bVar3)) goto LAB_0011492d;
              if ((!bVar3) && (L'8' < wVar2)) goto LAB_0011472f;}}bVar8 = bVar8 + 1;
          uVar7 = (long)(wVar2 + L'\xffffffd0') + uVar7 * 10;
LAB_0011469c:
          pwVar4 = pwVar4 + 1;
          if (pwVar4 == param_1 + param_2) goto LAB_001146c6;};if (uVar7 != 0) goto LAB_0011469c;pwVar4 = pwVar4 + 1;bVar3 = (bool)( bVar3 ^ wVar2 == L'-' );}while (pwVar4 != param_1 + param_2) ;;;LAB_001146c6:uVar5 = -uVar7;if (bVar3) {
   uVar5 = uVar7;
}
goto LAB_001146d3;}
  }uVar5 = 0;LAB_001146d3:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return uVar5;}/* String::parse_utf32(char32_t const&) */void String::parse_utf32(String *this, wchar32 *param_1) {
   long *plVar1;
   wchar32 *pwVar2;
   wchar32 wVar3;
   long in_FS_OFFSET;
   ...
   LAB_00114b23:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* String::TEMPNAMEPLACEHOLDERVALUE(char32_t) */String * __thiscall String::operator+=(String *this,wchar32 param_1){
   long *plVar1;
   int iVar2;
   long lVar3;
   long lVar4;
...
/* String::TEMPNAMEPLACEHOLDERVALUE(char32_t) const */String * __thiscall String::operator+(String *this,wchar32 param_1){
   wchar32 in_EDX;
   undefined4 in_register_00000034;
   *(undefined8*)this = 0;
   if (*(long*)CONCAT44(in_register_00000034, param_1) != 0) {
      CowData<char32_t>::_ref((CowData<char32_t>*)this, (CowData*)CONCAT44(in_register_00000034, param_1));
   }
...
/* String::to_int(char32_t const*, int, bool) [clone .part.0] */long String::to_int(wchar32 *param_1, int param_2, bool param_3) {
   uint uVar1;
   long *plVar2;
   wchar32 *pwVar3;
   long lVar4;
   ...
   if (wVar5 != L'\0') {
      ...
      do {
         ...
         if (bVar8) {
            ...
            LAB_00114eb8:if (0xccccccccccccccc < lVar4) {
               local_80 = 0;
               local_50 = 0;
               local_58 = "";
               parse_latin1((String*)&local_80, (StrRange*)&local_58);
 ...
 while ( true );
   ...
   lVar4 = 0;
   goto LAB_00114e60;
   LAB_00114e5c:lVar4 = lVar4 * lVar7;
   goto LAB_00114e60;
   while (pwVar3 != param_1) {
      LAB_00114f25:param_1 = param_1 + 1;
      operator+=((String *)&
      local_80,wVar5;
      wVar5 = *param_1;
      if (wVar5 == L'\0') break;
...
;
   LAB_00114f39:if (!param_3) {
      ...
      operator+=((String *)&
      local_58,(String*)&local_60;
      _err_print_error("to_int", "core/string/ustring.cpp", 0xb23, "Method/function failed. Returning: sign == 1 ? (9223372036854775807L) : (-9223372036854775807L-1)", (CowData<char32_t>*)&local_58, 0, 0);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_78);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_70);
   ...
   LAB_00114e60:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* String::to_int(char32_t const*, int, bool) */undefined8 String::to_int(wchar32 *param_1, int param_2, bool param_3) {
   undefined8 uVar1;
...
/* String::xml_unescape() const */undefined8 *String::xml_unescape(void) {
   int *piVar1;
   int *piVar2;
   ulong uVar3;
   ulong uVar4;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   local_48 = (int*)0x0;
   if (( *(long*)in_RSI == 0 ) || ( iVar16 = iVar16 == 0 )) {
      get_data(in_RSI);
   }
 else {
      iVar16 = iVar16 + -1;
...
;
 ...
 while ( ( ulong )(iVar8 + 1) != uVar4 + 1 );
                     ...
                     lVar15 = (long)iVar11;
                     piVar9 = piVar1 + lVar15 + -1;
                     if (( ( ( *piVar9 == 0x3b ) && ( iVar11 + -3 != 0 ) ) && ( piVar1[2] != 0 ) ) && ( lVar5 = to_int(piVar1 + 2, iVar11 + -3, false) ),lVar5 - 1U < 0xffffffff) goto LAB_00115568;
                  }
 ...
 else if (( ( ( iVar8 != 5 ) && ( piVar1[2] == 0x70 ) ) && ( piVar1[3] == 0x6f ) ) && ( piVar1[4] == 0x73 )) goto LAB_001155e0;
                     }
 else if (( ( iVar8 != 5 ) && ( iVar11 == 0x71 ) ) && ( ( piVar1[2] == 0x75 && ( ( piVar1[3] == 0x6f && ( piVar1[4] == 0x74 ) ) ) ) )) {
                        LAB_001155e0:if (piVar1[5] == 0x3b) {
                           lVar15 = 0x18;
                           iVar11 = 6;
                           goto LAB_00115204;
                        }
            ...
            LAB_00115204:iVar8 = iVar8 - iVar11;
            piVar1 = (int*)( (long)piVar1 + lVar15 );
         }
 while ( iVar8 != 0 );
         LAB_0011520e:CowData<char32_t>::resize<false>((CowData<char32_t>*)&local_48, (long)( iVar10 + 2 ));
         CowData<char32_t>::_copy_on_write((CowData<char32_t>*)&local_48);
         piVar1 = local_48;
...
;
 ...
 while ( iVar16 != 0 );
   ...
   *in_RDI = 0;
   LAB_00115313:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* String::indent(String const&) const */String *String::indent(String *param_1) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   long lVar4;

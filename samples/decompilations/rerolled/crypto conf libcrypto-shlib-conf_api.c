void lh_CONF_VALUE_hash_thunk(undefined8 param_1, code *UNRECOVERED_JUMPTABLE) {
   for (int i_2346 = 0; i_2346 < 2; i_2346++) {
   ...
   for (int i_2347 = 0; i_2347 < 2; i_2347++) {
   ...
   for (int i_2348 = 0; i_2348 < 2; i_2348++) {
   ...
   for (int i_2349 = 0; i_2349 < 2; i_2349++) {
   ...
   for (int i_2350 = 0; i_2350 < 2; i_2350++) {

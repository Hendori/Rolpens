int x509_object_cmp(undefined8 *param_1, undefined8 *param_2) {
   ...
   LAB_00100096:if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar1;
   }
   ...
   _func_1835 *p_Var1;
   if (ctx != (X509_LOOKUP*)0x0) {
      if (( ctx->method != (X509_LOOKUP_METHOD*)0x0 ) && ( p_Var1 = ctx->method->free ),p_Var1 != (_func_1835*)0x0) {
         ( *p_Var1 )(ctx);
      }
      CRYPTO_free(ctx);
      return;
   ...
   if (UNRECOVERED_JUMPTABLE != (_func_1836*)0x0) {
      for (int i_1670 = 0; i_1670 < 2; i_1670++) {
   ...
   if (UNRECOVERED_JUMPTABLE != (_func_1837*)0x0) {
      for (int i_1671 = 0; i_1671 < 2; i_1671++) {
   ...
   if (*(code**)( lVar1 + 0x58 ) != (code*)0x0) {
      for (int i_1672 = 0; i_1672 < 2; i_1672++) {
   ...
   if (*(code**)( lVar1 + 0x28 ) != (code*)0x0) {
      for (int i_1673 = 0; i_1673 < 2; i_1673++) {
   ...
   undefined8 uVar2;
   if (( *(int*)( param_1 + 4 ) == 0 ) && ( lVar1 = lVar1 != 0 )) {
   ...
   int iVar1;
   if (( ctx->method != (X509_LOOKUP_METHOD*)0x0 ) && ( UNRECOVERED_JUMPTABLE = ctx->method->get_by_issuer_serial ),UNRECOVERED_JUMPTABLE != (_func_1840*)0x0) {
      for (int i_1676 = 0; i_1676 < 2; i_1676++) {
   ...
   int iVar1;
   if (( ctx->method != (X509_LOOKUP_METHOD*)0x0 ) && ( UNRECOVERED_JUMPTABLE = ctx->method->get_by_fingerprint ),UNRECOVERED_JUMPTABLE != (_func_1841*)0x0) {
      for (int i_1677 = 0; i_1677 < 2; i_1677++) {
   ...
   int iVar1;
   if (( ctx->method != (X509_LOOKUP_METHOD*)0x0 ) && ( UNRECOVERED_JUMPTABLE = ctx->method->get_by_alias ),UNRECOVERED_JUMPTABLE != (_func_1842*)0x0) {
      for (int i_1678 = 0; i_1678 < 2; i_1678++) {
   ...
   *(undefined8*)( param_1 + 0x10 ) = param_2;
...
}/* WARNING: Unknown calling convention -- yet parameter storage is locked */X509_STORE *X509_STORE_new(void) {
   int iVar1;
   X509_STORE *obj;
   ...
   LAB_00100514:X509_VERIFY_PARAM_free(obj->param);
   ...
   *(undefined8*)( param_1 + 2 ) = param_2;
...
}undefined8 ossl_x509_store_ctx_get_by_subject(long *param_1, int param_2, X509_NAME *param_3, int *param_4) {
   long lVar1;
   int iVar2;
   int extraout_EAX;
   int iVar3;
   ...
   if (lVar1 != 0) {
      ...
      if (iVar2 != 0) {
         ...
         pXVar4 = X509_OBJECT_retrieve_by_subject(*(stack_st_X509_OBJECT**)( lVar1 + 8 ), param_2, param_3);
         X509_STORE_unlock(lVar1);
         if (( pXVar4 == (X509_OBJECT*)0x0 ) || ( local_60 = param_2 == 2 )) {
            local_60 = &local_58;
            for (iVar2 = 0; iVar3 = OPENSSL_sk_num(*(undefined8*)( lVar1 + 0x10 )),iVar2 < iVar3; iVar2 = iVar2 + 1) {
               lVar6 = OPENSSL_sk_value(*(undefined8*)( lVar1 + 0x10 ), iVar2);
               if (*(int*)( lVar6 + 4 ) == 0) {
                  if (*(long*)( lVar6 + 8 ) == 0) goto LAB_00100bb8;
                  iVar3 = X509_LOOKUP_by_subject_ex(lVar6, param_2, param_3, local_60, param_1[0x21], param_1[0x22]);
         ...
         LAB_00100b04:if (param_4 != (int*)0x0) {
            X509_OBJECT_up_ref_count(local_60);
            if (extraout_EAX == 0) {
               LAB_00100bb8:uVar5 = 0xffffffff;
               goto LAB_00100a89;
            }
   ...
   if (iVar1 < 0) {
      ...
      LAB_00100ee0:lVar3 = 0;
   } else {
      LAB_00100e6f:lVar3 = OPENSSL_sk_new_null();
   ...
   LAB_00100ee3:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return lVar3;
   }
   LAB_00100fa9:/* WARNING: Subroutine does not return */__stack_chk_fail();
   ...
   LAB_001010b8:uVar4 = 0;
   LAB_00100ffb:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return uVar4;

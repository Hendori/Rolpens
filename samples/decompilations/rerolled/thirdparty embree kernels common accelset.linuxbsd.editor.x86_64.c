/* embree::AccelSet::AccelSet(embree::Device*, embree::Geometry::GType, unsigned long, unsigned
   long) */void embree::AccelSet::AccelSet(AccelSet *this) {
   embree::Geometry::Geometry();
   *(undefined8*)( this + 0x58 ) = 0;
   *(undefined**)this = &DAT_00100440;
   for (int i = 0; i < 3; i++) {
      *(undefined8*)( this + ( 8*i + 96 ) ) = 0;
   }

   return;
}
/* embree::AccelSet::IntersectorN::IntersectorN(void (*)()) */void embree::AccelSet::IntersectorN::IntersectorN(IntersectorN *this, _func_void *param_1) {
...
/* embree::AccelSet::IntersectorN::IntersectorN(void (*)(RTCIntersectFunctionNArguments const*),
   void (*)(RTCOccludedFunctionNArguments const*), char const*) */void embree::AccelSet::IntersectorN::IntersectorN(IntersectorN *this, _func_void_RTCIntersectFunctionNArguments_ptr *param_1, _func_void_RTCOccludedFunctionNArguments_ptr *param_2, char *param_3) {
...
/* embree::AccelSet::immutable() */void embree::AccelSet::immutable(void) {
   return;
}
...
/* embree::Geometry::updateBuffer(RTCBufferType, unsigned int) */void embree::Geometry::updateBuffer(void) {

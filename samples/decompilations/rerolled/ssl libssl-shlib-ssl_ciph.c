undefined4 ciphersuite_cb(undefined8 param_1, int param_2, undefined8 param_3) {
   ...
   uVar4 = 1;
   LAB_00100024:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar4;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}void ssl_cipher_apply_rule_constprop_0(uint param_1, uint param_2, uint param_3, uint param_4, int param_5, ulong param_6, int param_7, long *param_8, long *param_9) {
   long *plVar1;
   long lVar2;
   long *plVar3;
   long *plVar4;
   ...
   if (( plVar3 != (long*)0x0 ) && ( plVar4 != (long*)0x0 )) {
      ...
      if (param_7 < 0) {
         do {
            ...
            if (( ( ( ( ( param_1 == 0 ) || ( ( param_1 & *(uint*)( lVar2 + 0x1c ) ) != 0 ) ) && ( ( param_2 == 0 || ( ( param_2 & *(uint*)( lVar2 + 0x20 ) ) != 0 ) ) ) ) && ( ( param_3 == 0 || ( ( param_3 & *(uint*)( lVar2 + 0x24 ) ) != 0 ) ) ) ) && ( ( param_4 == 0 || ( ( param_4 & *(uint*)( lVar2 + 0x28 ) ) != 0 ) ) ) ) && ( ( param_5 == 0 || ( param_5 == *(int*)( lVar2 + 0x2c ) ) ) )) {
...
LAB_0010036f:
               ...
               if (iVar8 == 3) {
                  ...
                  if (plVar3 == plVar10) {
                     *(undefined4*)( plVar3 + 1 ) = 0;
                     ...
                     LAB_0010019f:if (plVar7 != (long*)0x0) goto LAB_001001a4;
                  } else {
                     plVar7[2] = (long)plVar1;
                     *(undefined4*)( plVar3 + 1 ) = 0;
                     plVar9 = plVar7;
                     ...
                     plVar9 = plVar10;
                     if (plVar1 != (long*)0x0) {
                        LAB_00100197:plVar1[3] = (long)plVar7;
                        plVar7 = (long*)plVar3[3];
                        plVar10 = plVar9;
                        goto LAB_0010019f;
                     }
                     LAB_001001a4:plVar7[2] = (long)plVar1;
                  }
                  *(undefined1(*) [16])( plVar3 + 2 ) = (undefined1[16])0x0;
               }
            }
   ...
   *param_9 = (long)plVar6;
   ...
   if (lVar2 != 0) {
      while (( iVar1 = OPENSSL_sk_num(lVar2) ),0 < iVar1 && ( lVar3 = OPENSSL_sk_value(lVar2, 0) * (int*)( lVar3 + 0x2c ) == 0x304 )) {
      ...
      if (-1 < iVar1) {
         do {
            while (( lVar3 = OPENSSL_sk_value(param_4, iVar1)(*(uint*)( lVar3 + 0x24 ) & *(uint*)( param_1 + 0x6a0 )) == 0 && ( ( ( &ssl_cipher_table_mac )[( ulong ) * (byte*)( lVar3 + 0x40 ) * 2] & *(uint*)( param_1 + 0x6a4 ) ) == 0 ) )) {
      ...
      LAB_001006c0:lVar3 = OPENSSL_sk_dup(lVar2);
      if (lVar3 != 0) {
   ...
   if (ptr == (void*)0x0) {
      ...
      while (-1 < iVar7) {
         ...
         if (( plVar5 != (long*)0x0 ) && ( plVar8 = plVar5 ),plVar2 != (long*)0x0) {
            do {
               ...
               if (( *(int*)( *plVar8 + 0x44 ) == (int)lVar9 ) && ( ( (int)plVar8[1] != 0 && ( plVar10 != plVar8 ) ) )) {
                  lVar4 = plVar8[3];
                  if (plVar8 == plVar5) {
                     plVar5 = plVar3;
                  }
      ...
      LAB_00100888:CRYPTO_free(ptr);
      uVar6 = 1;
   }
   return uVar6;
}undefined4 ssl_cipher_process_rulestr(byte *param_1, long *param_2, long *param_3, undefined8 *param_4, long param_5) {
   byte *pbVar1;
   uint uVar2;
   int iVar3;
   int iVar4;
   ...
   uVar15 = 1;
   bVar11 = *param_1;
   LAB_00100917:uVar13 = (ulong)bVar11;
   ...
   do {
      ...
      if (iVar9 == 0) {
         LAB_00100f31:ERR_new();
         ERR_set_debug("ssl/ssl_ciph.c", 0x40c, "ssl_cipher_process_rulestr");
         ERR_set_error(0x14, 0x118, 0);
         return 0;
      }
      if (local_70 == 5) goto LAB_00100ee3;
      LAB_00100b13:bVar24 = false;
      piVar17 = (int*)*param_4;
      joined_r0x00100b21:if (piVar17 == (int*)0x0) {
         LAB_00100a61:bVar11 = *param_1;
         while (true) {
            if (bVar11 == 0) {
               return uVar15;
            }
      ...
      while (true) {
         ...
         if (( ( iVar8 == 0 ) && ( pcVar5[__n] == '\0' ) ) || ( ( pcVar5 = *(char**)( piVar17 + 4 ) ),pcVar5 != (char*)0x0 && ( ( iVar8 = strncmp((char*)__s1, pcVar5, __n) ),iVar8 == 0 && ( pcVar5[__n] == '\0' ) ) )) break;
         piVar17 = (int*)*puVar21;
         if (piVar17 == (int*)0x0) goto LAB_00100ba4;
      };
      uVar2 = piVar17[7];
      uVar20 = local_6c;
      if (( ( ( uVar2 != 0 ) && ( ( uVar20 = uVar2 ),local_6c != 0 && ( uVar20 = local_6c & uVar2(local_6c & uVar2) == 0 ) ) ) ) || ( ( local_6c = uVar20 ),uVar2 = piVar17[8],uVar20 = local_68,uVar2 != 0 && ( ( uVar20 = uVar2 ),local_68 != 0 && ( uVar20 = local_68 & uVar2(local_68 & uVar2) == 0 ) ) )) {
         LAB_00100ba4:if (local_70 != 5) goto LAB_00100a61;
         goto LAB_00100ee3;
      }
      local_58 = uVar20;
      uVar2 = piVar17[0xf];
      ...
      if (uVar20 == 0) {
         ...
         uVar14 = uVar20;
         if (( uVar2 & 0x20 ) != 0) {
            LAB_00100c6e:uVar14 = uVar20 | 0x20;
         }
      }
      iVar8 = local_54;
      if (*piVar17 == 0) {
         iVar4 = piVar17[0xb];
         iVar3 = 0;
         if (( ( iVar4 != 0 ) && ( iVar8 = iVar4 ),iVar4 != local_54 )) goto LAB_00100ba4;
      } else {
         iVar3 = piVar17[6];
      }
      local_54 = iVar8;
      ...
      if (local_70 == 5) {
         LAB_00100ee3:if (iVar9 == 8) {
            ...
            LAB_0010113e:uVar15 = 0;
         } else {
            if (( iVar9 != 10 ) || ( iVar9 = iVar9 != 0 )) {
               LAB_0010110e:ERR_new();
               uVar19 = 0x4b3;
               LAB_0010111f:ERR_set_debug("ssl/ssl_ciph.c", uVar19, "ssl_cipher_process_rulestr");
               ERR_set_error(0x14, 0x118, 0);
               goto LAB_0010113e;
            }
         ...
         if (local_70 == 3) {
            if (( plVar18 != (long*)0x0 ) && ( plVar22 != (long*)0x0 )) {
               ...
               do {
                  ...
                  lVar7 = *plVar10;
                  if (( ( ( ( ( iVar3 == 0 ) || ( iVar3 == *(int*)( lVar7 + 0x18 ) ) ) && ( ( local_6c == 0 || ( ( local_6c & *(uint*)( lVar7 + 0x1c ) ) != 0 ) ) ) ) && ( ( ( local_68 == 0 || ( ( local_68 & *(uint*)( lVar7 + 0x20 ) ) != 0 ) ) && ( ( local_64 == 0 || ( ( local_64 & *(uint*)( lVar7 + 0x24 ) ) != 0 ) ) ) ) ) ) && ( ( ( ( ( local_58 == 0 || ( ( local_58 & *(uint*)( lVar7 + 0x28 ) ) != 0 ) ) && ( ( local_54 == 0 || ( local_54 == *(int*)( lVar7 + 0x2c ) ) ) ) ) && ( ( ( uVar14 & 0x1f ) == 0 || ( ( *(uint*)( lVar7 + 0x3c ) & uVar14 & 0x1f ) != 0 ) ) ) ) && ( ( ( uVar14 & 0x20 ) == 0 || ( ( *(uint*)( lVar7 + 0x3c ) & uVar14 & 0x20 ) != 0 ) ) ) ) ) ) && ( (int)plVar10[1] != 0 )) {
                     if (plVar10 != plVar16) {
                        lVar7 = plVar10[2];
                        if (plVar10 == plVar22) {
                           plVar22 = plVar6;
            ...
            do {
               ...
               lVar7 = *plVar10;
               if (( ( ( ( ( iVar3 == 0 ) || ( iVar3 == *(int*)( lVar7 + 0x18 ) ) ) && ( ( local_6c == 0 || ( ( local_6c & *(uint*)( lVar7 + 0x1c ) ) != 0 ) ) ) ) && ( ( local_68 == 0 || ( ( local_68 & *(uint*)( lVar7 + 0x20 ) ) != 0 ) ) ) ) && ( ( local_64 == 0 || ( ( local_64 & *(uint*)( lVar7 + 0x24 ) ) != 0 ) ) ) ) && ( ( ( ( ( local_58 == 0 || ( ( local_58 & *(uint*)( lVar7 + 0x28 ) ) != 0 ) ) && ( ( local_54 == 0 || ( local_54 == *(int*)( lVar7 + 0x2c ) ) ) ) ) && ( ( ( uVar14 & 0x1f ) == 0 || ( ( *(uint*)( lVar7 + 0x3c ) & uVar14 & 0x1f ) != 0 ) ) ) ) && ( ( ( uVar14 & 0x20 ) == 0 || ( ( *(uint*)( lVar7 + 0x3c ) & uVar14 & 0x20 ) != 0 ) ) ) ) )) {
                  ...
                  if (local_70 == 4) {
                     ...
                     if (plVar10 == plVar18) {
                        *(undefined4*)( plVar10 + 1 ) = 0;
                        ...
                        LAB_00101082:if (plVar16 != (long*)0x0) goto LAB_00101087;
                     } else {
                        plVar16[2] = (long)plVar6;
                        *(undefined4*)( plVar10 + 1 ) = 0;
                        if (plVar10 == plVar23) {
                        ...
                        if (plVar6 != (long*)0x0) {
                           LAB_0010107a:plVar6[3] = (long)plVar16;
                           plVar16 = (long*)plVar10[3];
                           goto LAB_00101082;
                        }
                        LAB_00101087:plVar16[2] = (long)plVar6;
                     }
      ...
      cVar12 = bVar11 - 0x2b;
      bVar24 = bVar11 == 0x2b;
      joined_r0x00100aa0:if (bVar24) {
         LAB_00100aa6:local_70 = 4;
         uVar13 = (ulong)param_1[1];
         param_1 = param_1 + 1;
         goto LAB_001009ab;
      }
   } while ( bVar24 || SBORROW1(bVar11, '+') != cVar12 < '\0' );
   LAB_00100e92:if ((char)uVar13 == '-') {
      local_70 = 3;
      uVar13 = (ulong)param_1[1];
      param_1 = param_1 + 1;
   } else if ((char)uVar13 == '@') {
      ...
      LAB_00100abe:if (( (byte)uVar13 < 0x3c ) && ( ( 0xc00100100000000U >> ( uVar13 & 0x3f ) & 1 ) != 0 )) {
         bVar11 = param_1[1];
         param_1 = param_1 + 1;
         goto LAB_00100917;
      }
   ...
   goto LAB_001009ab;
   LAB_00100c86:uVar13 = ( ulong ) * param_1;
   __s1 = param_1;
   goto LAB_001009e0;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 ssl_load_ciphers(undefined8 *param_1) {
   uint uVar1;
   undefined8 uVar2;
   int iVar3;
   long lVar4;
   ...
   *(undefined4*)( (long)param_1 + 0x6a4 ) = 0;
   ...
   if (pEVar5 != (EVP_PKEY_ASN1_METHOD*)0x0) {
      iVar3 = EVP_PKEY_asn1_get0_info(&local_3c, (int*)0x0, (int*)0x0, (char**)0x0, (char**)0x0, pEVar5);
      if (iVar3 < 1) {
         local_3c = 0;
      }
   }
   ...
   *(uint*)( param_1 + 0xd5 ) = *(uint*)( param_1 + 0xd5 ) | 0x200;
   LAB_0010172f:uVar6 = 1;
   LAB_00101734:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar6;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   return false;
}undefined8 ssl_cipher_get_evp_md_mac(long param_1, long param_2, long *param_3, undefined4 *param_4, undefined8 *param_5) {
   long lVar1;
   int iVar2;
   long lVar3;
   ...
   if (arg != (void*)0x0) {
      if (*param_2 == '\0') {
         LAB_00101ba1:OPENSSL_sk_free(*(undefined8*)( param_1 + 0x20 ));
   ...
   if (( param_1->version == 0 ) || ( ( ( param_1->version & 0x80U ) != 0 && ( pSVar4 = (SSL*)ossl_quic_obj_get0_handshake_layer() ),pSVar4 != (SSL*)0x0 ) )) {
      ...
      if (arg != (BIO*)0x0) {
         if (( *param_2 == '\0' ) || ( ( iVar3 = CONF_parse_list(param_2, 0x3a, 1, ciphersuite_cb, arg) ),0 < iVar3 && ( iVar3 = OPENSSL_sk_num(arg) ),iVar3 != 0 )) {
   ...
   switch (uVar1) {
    ...
    break;
      ...
      case 6:
      case 7:
      for (int i_2524 = 0; i_2524 < 7; i_2524++) {
         case 9:
      }
      for (int i_2523 = 0; i_2523 < 14; i_2523++) {
         case 0x11:
      }
      case 0x1f:
    pcVar9 = "unknown";
   ...
   switch (iVar2) {
    ...
    break;
      ...
      case 6:
      case 7:
      for (int i_2526 = 0; i_2526 < 7; i_2526++) {
         case 9:
      }
      for (int i_2525 = 0; i_2525 < 14; i_2525++) {
         case 0x11:
      }
      case 0x1f:
    pcVar7 = "unknown";
      ...
      if (uVar3 < 0x1001) {
         if (uVar3 < 0x21) {
            ...
            if (uVar3 != 0x100) {
               if (uVar3 < 0x101) {
                  pcVar6 = "AES(128)";
                  if (( uVar3 != 0x40 ) && ( pcVar6 = uVar3 == 0x80 )) {
                     pcVar6 = "AES(256)";
                  }
               } else {
                  pcVar6 = "GOST89(256)";
         ...
         if (uVar3 != 0x40000) {
            if (uVar3 < 0x40001) {
               ...
               if (uVar3 != 0x8000) {
                  if (uVar3 < 0x8001) {
                     pcVar6 = "AESGCM(256)";
                     if (( uVar3 != 0x2000 ) && ( pcVar6 = uVar3 == 0x4000 )) {
                        pcVar6 = "AESCCM(128)";
                     }
                  } else {
                     pcVar6 = "AESCCM8(128)";
                     if (( uVar3 != 0x10000 ) && ( pcVar6 = uVar3 == 0x20000 )) {
                        pcVar6 = "AESCCM8(256)";
                     }
                  }
               }
               ...
               if (uVar3 != 0x200000) {
                  if (uVar3 < 0x200001) {
                     ...
                     if (( uVar3 != 0x80000 ) && ( pcVar6 = uVar3 == 0x100000 )) {
                        pcVar6 = "ARIAGCM(128)";
                     }
                  } else {
                     pcVar6 = "MAGMA";
                     if (( uVar3 != 0x400000 ) && ( pcVar6 = uVar3 == 0x800000 )) {
                        pcVar6 = "KUZNYECHIK";
                     }
                  }
               }
   ...
   if (uVar4 < 0x21) {
      ...
      if (uVar4 != 0x80) {
         if (uVar4 < 0x81) {
            ...
            pcVar8 = "GOST89";
            if (( uVar4 != 0x100 ) && ( pcVar8 = uVar4 == 0x200 )) {
               pcVar8 = "GOST2012";
            }
         }
      }
   }
   BIO_snprintf(buf, local_40, "%-30s %-7s Kx=%-8s Au=%-5s Enc=%-22s Mac=%-4s\n", param_1->name, uVar5, pcVar9, pcVar7, pcVar6, pcVar8);
   return buf;
   ...
   uVar2 = 0;
   LAB_00102522:if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar2;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* WARNING: Unknown calling convention -- yet parameter storage is locked */stack_st_SSL_COMP *SSL_COMP_get_compression_methods(void) {
   ...
   return psVar1;
}undefined8 ssl_cipher_get_evp(undefined8 *param_1, int *param_2, long *param_3, long *param_4, int *param_5, undefined8 param_6, undefined8 *param_7, int param_8) {
   int iVar1;
   int iVar2;
   ...
   if (lVar4 != 0) {
      if (param_7 != (undefined8*)0x0) {
         *param_7 = 0;
         ...
         if (( psVar3 != (stack_st_SSL_COMP*)0x0 ) && ( iVar2 = -1 < iVar2 )) {
      ...
      LAB_00102603:if (( ( param_3 != (long*)0x0 ) && ( param_4 != (long*)0x0 ) ) && ( iVar2 = ssl_cipher_get_evp_cipher(param_1, lVar4, param_3) ),iVar2 != 0) {
         iVar2 = ssl_cipher_get_evp_md_mac(param_1, lVar4, param_4, param_5, param_6);
         if (iVar2 == 0) {
            ssl_evp_cipher_free();
         } else if (( ( *param_3 != 0 ) && ( ( *param_4 != 0 || ( uVar6 = EVP_CIPHER_get_flags()(uVar6 & 0x200000) != 0 ) ) ) ) && ( ( iVar2 = *(int*)( lVar4 + 0x28 ) ),param_5 == (int*)0x0 || ( ( iVar2 == 0x40 || ( *param_5 != 0 ) ) ) )) {
            ...
            LAB_00102718:uVar5 = 1;
            goto LAB_00102621;
         }
      }
   }
   uVar5 = 0;
   LAB_00102621:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return uVar5;
   ...
   if (( ( psVar2 != (stack_st_SSL_COMP*)0x0 ) && ( cm != (COMP_METHOD*)0x0 ) ) && ( iVar1 = iVar1 != 0 )) {
      if (id - 0xc1U < 0x3f) {
   ...
   for (int i_2527 = 0; i_2527 < 2; i_2527++) {
...
}undefined8 ssl_cipher_get_overhead(long param_1, long *param_2, undefined8 *param_3, long *param_4, long *param_5) {
   int iVar1;
   int iVar2;
   int iVar3;
   char *pcVar4;
   ...
   *param_5 = lVar8;
...
}long ssl_create_cipher_list(long param_1, undefined8 param_2, long *param_3, long *param_4, char *param_5, long param_6) {
   uint uVar1;
   uint uVar2;
   uint uVar3;
   int iVar4;
   ...
   if (( param_5 != (char*)0x0 && param_4 != (long*)0x0 ) && ( param_3 != (long*)0x0 )) {
      ...
      if (iVar6 == 0) {
         bVar5 = false;
         uVar7 = 0x10000;
         LAB_00102fe1:*(uint*)( param_6 + 0x1c ) = uVar1 & 0xfffcffff | uVar7;
         LAB_00102fef:if (( *(byte*)( *(long*)( lVar12 + 0xd8 ) + 0x50 ) & 0x10 ) == 0) {
            ERR_new();
      ...
      if (iVar6 < 1) {
         ...
         do {
            ...
            if (( ( ( ( piVar8 != (int*)0x0 ) && ( *piVar8 != 0 ) ) && ( ( uVar7 & piVar8[7] ) == 0 ) ) && ( ( ( uVar1 & piVar8[8] ) == 0 && ( ( uVar2 & piVar8[9] ) == 0 ) ) ) ) && ( ( uVar3 & piVar8[10] ) == 0 )) {
      ...
      if (iVar16 == 0) {
         ...
         if (plVar10 == (long*)0x0) {
            ...
            do {
               if (( ( ( *(uint*)( puVar11 + 0x1c ) == 0 ) || ( ( ~uVar7 & *(uint*)( puVar11 + 0x1c ) ) != 0 ) ) && ( ( *(uint*)( puVar11 + 0x20 ) == 0 || ( ( ~uVar1 & *(uint*)( puVar11 + 0x20 ) ) != 0 ) ) ) ) && ( ( ( *(uint*)( puVar11 + 0x24 ) == 0 || ( ( ~uVar2 & *(uint*)( puVar11 + 0x24 ) ) != 0 ) ) && ( ( *(uint*)( puVar11 + 0x28 ) == 0 || ( ( ~uVar3 & *(uint*)( puVar11 + 0x28 ) ) != 0 ) ) ) ) )) {
            ...
            *plVar15 = 0;
            ...
            if (iVar6 == 0) {
               ...
               CRYPTO_free(plVar10);
               LAB_001037a3:CRYPTO_free(local_98);
            } else {
               LAB_001034fb:if (*local_a8 == '\0') {
                  CRYPTO_free(plVar10);
               } else {
               ...
               if (lVar12 != 0) {
                  while (iVar16 = OPENSSL_sk_num(param_2),plVar10 = local_50,iVar6 < iVar16) {
                     while (( lVar14 = OPENSSL_sk_value(param_2, iVar6)(uVar2 & *(uint*)( lVar14 + 0x24 )) == 0 && ( ( ( &ssl_cipher_table_mac )[( ulong ) * (byte*)( lVar14 + 0x40 ) * 2] & *(uint*)( param_1 + 0x6a4 ) ) == 0 ) )) {
                  ...
                  joined_r0x0010359a:do {
                     if (plVar10 == (long*)0x0) goto LAB_001036f0;
                     if (( (int)plVar10[1] != 0 ) && ( iVar6 = iVar6 == 0 )) goto LAB_001035d0;
   ...
   goto LAB_001035e7;
   LAB_001035d0:CRYPTO_free(local_98);
   goto LAB_001035df;
   LAB_001036f0:CRYPTO_free(local_98);
   ...
   LAB_001035df:OPENSSL_sk_free(lVar12);
   LAB_001035e7:lVar12 = 0;
   LAB_001035ea:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return lVar12;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();

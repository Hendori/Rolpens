ulong determine_len(ulong param_1, ulong param_2, long param_3, ulong *param_4, ulong *param_5) {
   ...
   if (param_2 == 0) {
      ...
      LAB_00100085:if (bVar7) {
         LAB_001001e5:local_28 = param_3 + 4;
         param_2 = local_48;
         goto LAB_00100189;
      }
      if ((int)( uVar5 >> 0x20 ) != 0) goto LAB_001000a2;
      ...
      if (( param_1 < param_2 + local_28 ) && ( ( param_1 < local_28 || ( param_2 = param_2 == 0 ) ) )) goto LAB_00100085;
      if (( bVar7 ) && ( param_2 <= local_48 )) goto LAB_001001e5;
      LAB_00100189:if (( (int)( uVar5 >> 0x20 ) != 0 ) && ( param_2 <= local_50 )) {
         LAB_001000a2:local_28 = uVar3;
         param_2 = local_50;
      }
      LAB_001001a2:uVar3 = 1;
      if (( (int)uVar5 == 0 ) || ( local_58 < param_2 )) goto LAB_001001b4;
   }
   uVar3 = 1;
   local_28 = uVar1;
   param_2 = local_58;
   LAB_001001b4:*param_4 = local_28;
   *param_5 = param_2;
    ...
    *(byte *)(param_4 + 0x1e8) =
    ...
    break;
      for (int i_169 = 0; i_169 < 10; i_169++) {
         case 6:
      }
      for (int i_168 = 0; i_168 < 9; i_168++) {
         case 0x14:
      }
      case 0x1d:
    break;
   ...
   return;
}undefined8 txp_plan_stream_chunk_isra_0(undefined8 param_1, undefined8 param_2, undefined8 param_3, long param_4, undefined8 param_5) {
   ulong uVar1;
   int iVar2;
   long lVar3;
   long lVar4;
   ...
   if (iVar2 != 0) {
      ...
      if (iVar2 != 0) {
         if (( *(long*)( *param_1 + 0x2a8 ) == 0 ) || ( local_48 == 0 )) {
            LAB_001008e8:param_1[3] = param_1[3] + local_48;
         ...
         if (-1 < local_48) {
            ...
            if (iVar2 != 0) {
               ...
               ( **(code**)( *param_1 + 0x2a8 ) )(1, 1, iVar2, param_1[7], local_48, *(undefined8*)( *param_1 + 0x2b8 ));
               goto LAB_001008e8;
            }
         }
      }
   ...
   *(byte*)( param_1 + 0xf ) = *(byte*)( param_1 + 0xf ) & 0xfe;
   uVar3 = 0;
   param_1[7] = 0;
   LAB_00100905:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar3;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 txp_generate_pre_token(long param_1, long param_2, ulong param_3, undefined4 *param_4) {
   uint uVar1;
   long lVar2;
   int iVar3;
   long *plVar4;
   ...
   *(undefined8*)( lVar2 + 0x18 ) = 0xffffffffffffffff;
   if (( *(byte*)( param_2 + 0x114 ) & 1 ) == 0) {
      LAB_00100ac0:if (( ( ( *(byte*)( param_2 + 0x115 ) & 4 ) != 0 ) && ( ( *(byte*)( param_1 + 0x1e9 ) & 4 ) != 0 ) ) && ( ( param_3 & 1 ) != 0 )) {
         ...
         LAB_00100b9f:if (( *(byte*)( param_2 + 0x78 ) & 1 ) != 0) {
            WPACKET_cleanup(param_2 + 0x40);
            *(byte*)( param_2 + 0x78 ) = *(byte*)( param_2 + 0x78 ) & 0xfe;
            *(undefined8*)( param_2 + 0x38 ) = 0;
         }
      }
      LAB_00100ad8:uVar9 = 1;
   } else {
      lVar5 = 0;
      if (( *(byte*)( param_2 + 0x34 ) & 1 ) == 0) {
         lVar5 = *(long*)( param_2 + 0x20 );
      }
      if (( ulong )(( *(long*)( param_2 + 8 ) - *(long*)( param_2 + 0x10 ) ) - lVar5) < 5) goto LAB_00100ac0;
   ...
   *(undefined8*)( param_1 + 0x1e0 ) = 0xffffffffffffffff;
   ...
   byte bVar5;
   bVar5 = 0;
   if (( ( ( ( ( param_1 == (undefined8*)0x0 ) || ( param_1[0x14] == 0 ) ) || ( param_1[0x15] == 0 ) ) || ( ( param_1[0x16] == 0 || ( param_1[0x17] == 0 ) ) ) ) || ( ( param_1[0x18] == 0 || ( ( param_1[0x19] == 0 || ( param_1[0x1a] == 0 ) ) ) ) ) ) || ( ( param_1[0x1b] == 0 || ( ( param_1[0x1c] == 0 || ( *(int*)( param_1 + 0x23 ) == 0 ) ) ) ) )) {
      ERR_new();
      ...
      if (ptr != (undefined8*)0x0) {
         ...
         ptr[0x3b] = 0;
         iVar1 = ossl_quic_fifd_init(ptr + 0x2b, ptr[0x16], ptr[0x17], ptr[0x15], get_sstream_by_id, ptr, on_regen_notify, ptr, on_confirm_notify, ptr, on_sstream_updated, ptr, param_1[0x21], param_1[0x22]);
         if (iVar1 != 0) {
            return ptr;
         }
         CRYPTO_free(ptr);
...
}undefined8 ossl_quic_tx_packetiser_set_initial_token(long param_1, undefined8 param_2, ulong param_3, undefined8 param_4, undefined8 param_5) {
   ulong uVar1;
   ulong uVar2;
   ...
   if (( *(long*)( param_1 + 0x138 ) != 0 ) && ( *(code**)( param_1 + 0x148 ) != (code*)0x0 )) {
      ( **(code**)( param_1 + 0x148 ) )(*(long*)( param_1 + 0x138 ), *(undefined8*)( param_1 + 0x140 ), *(undefined8*)( param_1 + 0x150 ));
   }
   ...
   *(ushort*)( param_1 + 0x1e8 ) = *(ushort*)( param_1 + 0x1e8 ) & 0xfc7f | ( ushort )(( ( ( uint )(*(ushort*)( param_1 + 0x1e8 ) >> 7) | ( uint )(1L << ( param_2 & 0x3f )) ) & 7 ) << 7);
   return;
}void ossl_quic_tx_packetiser_schedule_ack(long param_1, byte param_2) {
   *(byte*)( param_1 + 0x1e8 ) = *(byte*)( param_1 + 0x1e8 ) & 0x8f | ( byte )(( ( ( uint )(*(byte*)( param_1 + 0x1e8 ) >> 4) | ( uint )(1L << ( param_2 & 0x3f )) ) & 7 ) << 4);
   return;
}/* WARNING: Type propagation algorithm not settling */undefined4 ossl_quic_tx_packetiser_generate(undefined8 *param_1, undefined1 (*param_2)[16]) {
   byte *pbVar1;
   byte bVar2;
   undefined8 uVar3;
   ulong uVar4;
   ...
   *param_2 = (undefined1[16])0x0;
   ...
   uVar24 = 1;
   if (( ( ( *piVar15 == 0 ) && ( piVar15[1] == 0 ) ) && ( piVar15[2] == 0 ) ) && ( ( piVar15[3] == 0 && ( piVar15[4] == 0 ) ) )) {
   ...
   do {
      ...
      if (( iVar12 == 0 ) || ( uVar35 = *local_748(~(byte)(uVar35 >> 0x10) & lVar14 == 0) != 0 )) goto LAB_00101afe;
      ...
      if (( uVar35 & 0x2000 ) == 0) {
         if (( uVar35 & 4 ) == 0) {
            ...
            LAB_00102211:iVar12 = ossl_ackm_is_ack_desired(param_1[0x17], uVar25);
            if (( iVar12 == 0 ) && ( ( ( *(byte*)( param_1 + 0x3d ) >> 4 & 7 ) >> uVar25 & 1 ) == 0 )) goto LAB_0010223f;
            LAB_00101450:if (uVar41 == 0) {
               sVar37 = 0;
               puVar32 = local_430;
               puVar27 = local_3d8;
         ...
         LAB_001021d0:local_5e8._0_8_ = 2;
         iVar12 = ossl_quic_sstream_get_stream_frame(param_1[uVar25 + 0x24], 0, local_5c8, local_588, local_5e8);
         if (iVar12 != 0) goto LAB_00101450;
         if (( uVar35 & 1 ) != 0) goto LAB_00102211;
         LAB_0010223f:if (( uVar35 & 0x2000 ) != 0) {
            LAB_00102248:if (( ( *(ushort*)( param_1 + 0x3d ) >> 7 & 7 ) >> uVar25 & 1 ) != 0) goto LAB_00101450;
         }
         joined_r0x00101438:if (( ( ( uVar35 & 0x200 ) != 0 ) && ( ( ( ( ( *(byte*)( param_1 + 0x3d ) & 2 ) != 0 || ( iVar12 = ossl_quic_rxfc_has_cwm_changed(param_1[0x1a], 0) ),iVar12 != 0 ) ) || ( ( *(byte*)( param_1 + 0x3d ) & 4 ) != 0 ) ) || ( ( ( iVar12 = ossl_quic_rxfc_has_cwm_changed(param_1[0x1b], 0) ),iVar12 != 0 || ( ( *(byte*)( param_1 + 0x3d ) & 8 ) != 0 ) ) || ( iVar12 = ossl_quic_rxfc_has_cwm_changed(param_1[0x1c], 0) ),iVar12 != 0 ) ) )) goto LAB_00101450;
         if (uVar41 != 1) {
               ...
               if ((char)uVar35 < '\0') {
                  do {
                     ...
                     if (uVar16 < 0x1a) {
                        ...
                        if (( uVar16 != 7 ) && ( uVar13 = uVar16 != 0x18 )) goto LAB_00104550;
                     } else {
                        uVar13 = uVar35 & 0x20;
                        if (uVar16 != 0x1b) {
                           LAB_00104550:uVar13 = uVar35 & 0x800;
                        }
                     }
                  ...
                  do {
                     ...
                     if (uVar16 != 0x19) {
                        if (uVar16 < 0x1a) {
                           uVar13 = uVar35 & 0x1000;
                           if (( uVar16 != 7 ) && ( uVar13 = uVar16 != 0x18 )) goto LAB_00103afc;
                        } else {
                           if (uVar16 == 0x1b) goto LAB_00103ad0;
                           LAB_00103afc:uVar13 = uVar35 & 0x800;
                        }
                        if (uVar13 != 0) goto LAB_00101450;
                     }
                     LAB_00103ad0:lVar18 = ossl_quic_cfq_item_get_priority_next(lVar18, uVar25);
                  } while ( lVar18 != 0 );
               } else {
                  do {
                     uVar16 = ossl_quic_cfq_item_get_frame_type(lVar18);
                     if (uVar16 != 0x19) {
                        if (uVar16 < 0x1a) {
                           uVar13 = uVar35 & 0x1000;
                           if (( uVar16 != 7 ) && ( uVar13 = uVar16 == 0x18 )) {
                     ...
                     LAB_00103e9b:lVar18 = ossl_quic_cfq_item_get_priority_next(lVar18, uVar25);
                  } while ( lVar18 != 0 );
               }
            }
            if (( uVar35 & 0x100 ) == 0) goto LAB_00101afe;
            LAB_00102167:if (( *(byte*)( (long)param_1 + 0x1e9 ) & 8 ) != 0) {
         ...
         if (uVar41 == 0) {
            ...
            if (piVar15[uVar25 + 2] == 0) {
               LAB_0010257f:if (( uVar35 & 4 ) != 0) goto LAB_001021d0;
               if (( uVar35 & 1 ) != 0) goto LAB_00102211;
               goto LAB_00102248;
            }
            LAB_00102470:sVar37 = 2;
            puVar27 = local_750 + 0xb0;
            puVar32 = (uint*)( local_750 + 0x58 );
            plVar31 = (long*)( local_750 + -0x40 );
         }
         LAB_00101490:uVar19 = *(undefined8*)( (long)param_1 + 0x15 );
         ...
         *(undefined8*)( local_750 + 0x82 ) = uVar19;
         ...
         uVar25 = (ulong)iVar12;
         if (( ( uVar25 == 0 ) || ( uVar16 = ossl_qtx_get_mdpl(param_1[0x14]) ),uVar16 < local_738 )) break;
         ...
         *(int*)( local_750 + 0xd0 ) = (int)uVar24;
         if (( *(byte*)( (long)plVar31 + 0x114 ) & 2 ) == 0) {
            ...
            uVar25 = *(ulong*)( local_750 + 0xb8 );
            if (( (char)local_750[0xd5] < '\0' ) || ( uVar35 = ( *(ushort*)( param_1 + 0x3d ) >> 7 & 7 ) >> sVar37 & 1 ),uVar16 = (ulong)uVar35,uVar35 != 0) {
               if (uVar25 == 0) break;
               uVar16 = 1;
            }
         }
         ...
         *(undefined8**)( local_750 + 0x48 ) = puVar17;
         ...
         LAB_00101720:bVar11 = false;
         LAB_00101728:if (( uVar13 & 0x200 ) == 0) goto LAB_001017d0;
         if (( ( *(byte*)( param_1 + 0x3d ) & 2 ) != 0 ) || ( iVar12 = ossl_quic_rxfc_has_cwm_changed(param_1[0x1a], 0) ),iVar12 != 0) {
            if (( *(byte*)( (long)plVar31 + 0x34 ) & 1 ) == 0) {
               if (1 < ( ulong )(( plVar31[1] - plVar31[2] ) - plVar31[4])) goto LAB_00102880;
               goto LAB_00101770;
            }
            if (( ulong )(plVar31[1] - plVar31[2]) < 2) goto LAB_00101770;
            LAB_00102880:lVar18 = tx_helper_begin(plVar31);
         ...
         LAB_00101770:if (( ( *(byte*)( param_1 + 0x3d ) & 4 ) != 0 ) || ( iVar12 = ossl_quic_rxfc_has_cwm_changed(param_1[0x1b], 0) ),iVar12 != 0) {
            if (( *(byte*)( (long)plVar31 + 0x34 ) & 1 ) == 0) {
               if (1 < ( ulong )(( plVar31[1] - plVar31[2] ) - plVar31[4])) goto LAB_00102938;
               goto LAB_0010179f;
            }
            if (( ulong )(plVar31[1] - plVar31[2]) < 2) goto LAB_0010179f;
            LAB_00102938:lVar18 = tx_helper_begin(plVar31);
         ...
         LAB_0010179f:if (( ( *(byte*)( param_1 + 0x3d ) & 8 ) != 0 ) || ( iVar12 = ossl_quic_rxfc_has_cwm_changed(param_1[0x1c], 0) ),iVar12 != 0) {
            if (( *(byte*)( (long)plVar31 + 0x34 ) & 1 ) == 0) {
               if (1 < ( ulong )(( plVar31[1] - plVar31[2] ) - plVar31[4])) goto LAB_0010276d;
               goto LAB_001017d0;
            }
            if (( ulong )(plVar31[1] - plVar31[2]) < 2) goto LAB_001017d0;
            LAB_0010276d:lVar18 = tx_helper_begin(plVar31);
            ...
            LAB_001032c0:ossl_quic_txpim_pkt_release(param_1[0x15], puVar17);
            local_440[uVar28 * 0x24] = 0;
            goto LAB_001032ed;
         }
         LAB_001017d0:bVar42 = local_6e0 == uVar41;
         lVar18 = ossl_quic_cfq_get_priority_head(param_1[0x16], uVar35);
         if (lVar18 == 0) {
            LAB_001034e0:txp_generate_pre_token(param_1, plVar31, bVar42, &local_624);
         } else {
            bVar43 = false;
            if (( uVar13 & 0x40 ) == 0) {
               do {
                  ...
                  if (uVar25 == 0x19) {
                     ...
                     LAB_001024c8:if (( uVar13 & 0x800 ) != 0) goto LAB_0010230f;
                  }
               ...
               do {
                  ...
                  if (uVar25 == 0x19) {
                     ...
                     LAB_0010192c:if (( *(byte*)( (long)plVar31 + 0x34 ) & 1 ) == 0) {
                     ...
                     LAB_001023d8:if (( uVar13 & 0x800 ) != 0) goto LAB_0010192c;
                  }
                  LAB_001018d4:lVar18 = ossl_quic_cfq_item_get_priority_next(lVar18, uVar35);
               } while ( lVar18 != 0 );
            }
         ...
         if (( uVar13 & 4 ) != 0) {
            ...
            while (true) {
               ...
               local_618 = 2;
               iVar12 = ossl_quic_sstream_get_stream_frame(param_1[(ulong)uVar30 + 0x24], lVar18, local_5c8, local_588, &local_618);
               ...
               if (( lVar18 == 0 ) || ( iVar12 = determine_len(uVar25, uVar23, lVar18 + -1, local_610, local_608 + 8) ),iVar12 == 0) goto LAB_00101987;
               ...
               if (uVar25 < plVar31[5] + 3U) {
                  ...
                  pvVar21 = CRYPTO_realloc((void*)param_1[(ulong)uVar36 * 4 + 0x47], iVar12, "ssl/quic/quic_txp.c", 0xc5b);
         ...
         LAB_00101987:if (( ( uVar13 >> 8 & 1 ) != 0 ) && ( ( *(byte*)( (long)param_1 + 0x1e9 ) & 8 ) != 0 )) {
               ...
               do {
                  ...
                  *(undefined8*)( lVar18 + 0x60 ) = 0;
                  if (( uVar25 & 4 ) != 0) {
                     ...
                     LAB_001043fa:if (( *(byte*)( plVar31 + 0xf ) & 1 ) != 0) {
                        WPACKET_cleanup(local_750);
                        LAB_0010445b:local_450[uVar28 * 0x120] = local_450[uVar28 * 0x120] & 0xfe;
                        *(undefined8*)( local_750 + -8 ) = 0;
                     }
                     LAB_0010327e:*(undefined8*)( lVar18 + 0x30 ) = *(undefined8*)( local_750 + 0x50 );
                     *(long*)( local_750 + 0x50 ) = lVar18;
                     break;
                  }
                  LAB_00102b89:if (( uVar25 & 8 ) != 0) {
                     if (( *(char*)( lVar18 + 0x101 ) == '\x05' ) && ( lVar38 = lVar38 != 0 )) {
                        local_5c8._8_8_ = *(undefined8*)( lVar18 + 0x48 );
                        local_5c8._0_8_ = *(undefined8*)( lVar18 + 0x38 );
                        if (*(char*)( lVar18 + 0x101 ) == '\x02') {
                           iVar12 = ossl_quic_sstream_get_final_size(*(undefined8*)( lVar18 + 0x70 ), local_5b8);
                           if (iVar12 == 0) goto LAB_001032c0;
                        } else {
                  ...
                  LAB_00102c95:if (( *(char*)( lVar18 + 0x102 ) == '\x01' ) && ( ( ( *(byte*)( lVar18 + 0x104 ) & 2 ) != 0 || ( iVar12 = ossl_quic_rxfc_has_cwm_changed(lVar18 + 0xa0, 0) ),iVar12 != 0 ) )) {
                     lVar38 = tx_helper_begin(plVar31);
                     if (lVar38 == 0) goto LAB_001032c0;
                     uVar23 = ossl_quic_rxfc_get_cwm(lVar18 + 0xa0);
                     iVar12 = ossl_quic_wire_encode_frame_max_stream_data(lVar38, *(undefined8*)( lVar18 + 0x38 ), uVar23);
                  ...
                  if (*(byte*)( lVar18 + 0x101 ) - 1 < 3) {
                     ...
                     if (iVar12 == 0) {
                        LAB_001043e8:lVar14 = 0;
                        LAB_00103c2a:*(long*)( lVar18 + 0x60 ) = lVar14;
                        ...
                        *(undefined8*)( lVar18 + 0x60 ) = 0;
                        ...
                        do {
                           ...
                           if (( *(byte*)( (long)plVar31 + 0x34 ) & 2 ) != 0) {
                              LAB_00103bfa:lVar14 = local_6c0 - uVar16;
                              goto LAB_00103c2a;
                           }
                           ...
                           uVar30 = (uint)lVar26;
                           if (( lVar26 + -1 != 0 ) && ( iVar12 = txp_plan_stream_chunk_isra_0(uVar23, lVar38, lVar26, ( ulong )(-(uVar30 & 1) & 0x60) + (long)local_588, local_688) ),iVar12 == 0) goto LAB_00103bfa;
                           ...
                           if (( lVar20 == 0 ) || ( iVar12 = determine_len(uVar40, uVar5, lVar20 + -1 + ( ulong )(( local_568[uVar25 * 0x60] & 1 ) == 0), &local_620, &local_618) ),iVar12 == 0) {
                              LAB_001034bb:*(ulong*)( lVar18 + 0x60 ) = local_6c0 - uVar16;
                              goto LAB_0010327e;
                           }
                           if (( ( ( uVar19 == 0 ) && ( *(int*)( &local_530 + ( ulong )(uVar30 & 1) * 0xc ) == 0 ) ) || ( uVar40 <= local_620 + local_618 ) ) && ( *(int*)( local_750 + 0xd8 ) == 0 )) {
                              bVar42 = true;
                              local_568[uVar25 * 0x60] = local_568[uVar25 * 0x60] & 0xfe;
                              uVar40 = local_618;
                           } else {
                              ...
                              lVar20 = ossl_quic_wire_get_encoded_frame_len_stream_hdr(lVar33);
                              local_588[uVar25 * 0xc + 2] = uVar5;
                              if (( lVar20 == 0 ) || ( iVar12 = determine_len(uVar40, uVar5, lVar20 + -1 + ( ulong )(( local_568[uVar25 * 0x60] & 1 ) == 0), local_610, local_608) ),iVar12 == 0) goto LAB_001034bb;
                           ...
                           ossl_quic_sstream_adjust_iov(uVar40, (long)auStack_558 + uVar22, ( &local_530 )[uVar25 * 0xc + -1]);
                           ...
                           if (( &local_530 )[uVar25 * 0xc + -1] != 0) {
                              tx_helper_append_iovec(plVar31, auStack_558[uVar25 * 0xc], auStack_558[uVar25 * 0xc + 1]);
                              if (1 < ( &local_530 )[uVar25 * 0xc + -1]) {
                                 tx_helper_append_iovec(plVar31, auStack_558[uVar25 * 0xc + 2], ( &local_530 )[uVar25 * 0xc + -2]);
                              }
                           }
         ...
         *(byte*)( (long)plVar31 + 0x34 ) = *(byte*)( (long)plVar31 + 0x34 ) | 1;
         if (bVar11) {
            LAB_00101a40:cVar8 = '\x01';
            uVar13 = 1;
         } else {
            if (( ( uVar13 & 2 ) != 0 ) && ( ( (char)( uVar13 >> 8 ) < '\0' || ( ( ( *(ushort*)( param_1 + 0x3d ) >> 7 & 7 ) >> ( (ulong)uVar35 & 0x3f ) & 1 ) != 0 ) ) )) {
               lVar18 = tx_helper_begin(plVar31);
               if (( lVar18 == 0 ) || ( ( iVar12 = ossl_quic_wire_encode_frame_ping(lVar18) ),iVar12 == 0 || ( iVar12 = tx_helper_commit(plVar31) ),iVar12 == 0 )) goto LAB_001032c0;
               goto LAB_00101a40;
            }
         ...
         *(byte*)( puVar17 + 4 ) = ( byte )(uVar13 << 2) | (byte)uVar35 & 0x3f | cVar8 << 3 | *(byte*)( puVar17 + 4 ) & 0xc0;
         ...
         *(char*)( puVar17 + 0xf ) = (char)local_430[uVar28 * 0x48];
         ...
         bVar9 = bVar11;
         *(ulong*)( local_750 + 0xc0 ) = *(long*)( local_750 + 200 ) + *(long*)( local_750 + -0x30 ) + local_738;
         LAB_00101afe:uVar28 = ( ulong )(uVar41 + 1);
         if (uVar41 + 1 == 4) break;
      }
   ...
   if (( local_448[0] == 0 ) || ( local_4c8[2] == 0 )) {
      ...
      if (( local_498 != 0 ) && ( iVar12 = ossl_qtx_calculate_ciphertext_payload_len(param_1[0x14], local_498, local_4c8[2], local_5c8) ),iVar12 != 0) {
      ...
      if (( local_328 != 0 ) && ( local_398 != 0 )) {
         ...
         if (( local_378 != 0 ) && ( iVar12 = ossl_qtx_calculate_ciphertext_payload_len(param_1[0x14], local_378, local_398, local_5c8) ),iVar12 != 0) {
      ...
      if (( local_208 != 0 ) && ( local_278 != 0 )) {
         if ((int)uVar28 == 4) {
            LAB_00103956:uVar28 = 4;
            if (( bStack_173 & 0x40 ) != 0) {
               uVar28 = ( ulong )(( -(uint)((local_254 >> 1 & 1) == 0) & 0xfffffffe ) + 4);
            }
         }
         if (( local_258 != 0 ) && ( iVar12 = ossl_qtx_calculate_ciphertext_payload_len(param_1[0x14], local_258, local_278, local_5c8) ),iVar12 != 0) {
      ...
      LAB_00101fe9:if (( local_e8 != 0 ) && ( local_158 != 0 )) {
         if (( (int)uVar28 == 4 ) && ( ( local_53 & 0x40 ) != 0 )) {
            uVar28 = ( ulong )(( local_134 >> 1 & 1 ) + 3);
         }
         if (( local_138 != 0 ) && ( iVar12 = ossl_qtx_calculate_ciphertext_payload_len(param_1[0x14], local_138, local_158, local_5c8) ),iVar12 != 0) {
      ...
      if ((int)uVar28 == 4) {
         ...
         LAB_001032ed:lVar14 = 0;
         uVar29 = 0;
         goto LAB_00101e42;
      }
   }
   LAB_00101bbd:puVar32 = local_430;
   lVar14 = 0;
   uVar41 = 0;
   LAB_00101bcd:do {
      if (( puVar32[-6] != 0 ) && ( *(long*)( puVar32 + -0x22 ) != 0 )) {
                  ...
                  if (iVar12 != 0) {
                     ...
                     if (lVar38 != 0) {
                        ...
                        do {
                           ...
                           if (( ( *(byte*)( lVar38 + 0x101 ) - 1 < 3 ) && ( iVar12 = ossl_quic_sstream_has_pending(*(undefined8*)( lVar38 + 0x70 )) ),iVar12 == 0 )) {
                     ...
                     if (( *(byte*)( lVar18 + 0x20 ) & 8 ) != 0) {
                        *(ushort*)( param_1 + 0x3d ) = *(ushort*)( param_1 + 0x3d ) & 0xfc7f | ( ushort )(( ( uint )(*(ushort*)( param_1 + 0x3d ) >> 7) & ~(uint)(1L << (sbyte)local_750) & 7 ) << 7);
                     }
                     ...
                     if (( bVar44 & 0x10 ) != 0) {
                        *(byte*)( param_1 + 0x3d ) = *(byte*)( param_1 + 0x3d ) & 0x8f | ( byte )(( ~(uint)(1L << (sbyte)local_750) & *(byte*)( param_1 + 0x3d ) >> 4 & 7 ) << 4);
                     }
                     if (( bVar44 & 0x20 ) != 0) {
         ...
         } else if (( *(long*)( puVar32 + -0x22 ) != 0 ) && ( lVar18 = uVar35 < 4 )) {
            local_750 = (undefined1*)0x2;
            goto LAB_00101c3e;
         }
         LAB_00101d80:uVar29 = 0;
         goto LAB_00101e42;
      }
      LAB_00101e28:uVar41 = uVar41 + 1;
      puVar32 = puVar32 + 0x48;
   } while ( uVar41 != 4 );
   uVar29 = 1;
   LAB_00101e42:uVar41 = 0;
   ossl_qtx_finish_dgram(param_1[0x14]);
   do {
   ...
   *(long*)( param_1 + 0x218 ) = *(long*)( param_1 + 0x218 ) + param_2;
   ...
   lVar4 = 0;
   if (( uVar5 != 0 ) && ( lVar4 = CRYPTO_memdup(param_2[3], uVar5, "ssl/quic/quic_txp.c", 0xc76) ),lVar4 == 0) {
      return 0;
   }
   uVar1 = param_2[1];

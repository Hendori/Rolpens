undefined8 ssl_print_random_constprop_0(BIO *param_1, long *param_2, ulong *param_3) {
   ...
   *param_1 = pcVar2;
   return uVar3;
}undefined8 ssl_print_hexbuf(BIO *param_1, int param_2, undefined8 param_3, ulong param_4, long *param_5, ulong *param_6) {
   ulong uVar1;
   byte *pbVar2;
   byte bVar3;
   ushort *puVar4;
   ...
   if (( *(byte*)( *(long*)( *(long*)( param_2 + 0x18 ) + 0xd8 ) + 0x50 ) & 2 ) != 0) {
      ...
      pcVar6 = "UNKNOWN";
      LAB_00100472:BIO_printf(param_1, "Signature Algorithm: %s (0x%04x)\n", pcVar6, (ulong)uVar8);
   ...
   *param_4 = *param_4 - uVar1;
   return 1;
}undefined8 ssl_print_extensions(BIO *param_1, int param_2, int param_3, char param_4, long *param_5, ulong *param_6) {
   ushort *bytes;
   byte bVar1;
   ulong uVar2;
   uint *puVar3;
   ...
   if (uVar8 != 1) {
      ...
      if (( uVar6 <= uVar8 ) && ( BIO_printf(param_1, "extensions, length = %d\n", (ulong)uVar9),3 < uVar9 )) {
         local_a8 = uVar6;
         while (true) {
            ...
            pcVar7 = "UNKNOWN";
            LAB_0010060a:BIO_printf(param_1, "extension_type=%s(%d), length=%d\n", pcVar7, (ulong)uVar15, uVar14);
            if (uVar15 < 0x34) {
               switch (uVar15) {
                  case 1:
            if (uVar9 == 0) {
...
LAB_00100935:
            ...
            LAB_00100830:puVar11 = (ushort*)( (long)bytes + uVar2 );
   ...
   return 0;
}void SSL_trace(uint param_1, ulong param_2, int param_3, byte *param_4, X509 *param_5, SSL *param_6, BIO *param_7) {
   byte bVar1;
   char cVar2;
   byte bVar3;
   byte bVar4;
   ...
   if (uVar27 != 0) {
      if (( uVar27 & 0x80 ) == 0) {
         ...
         pSVar9 = (SSL*)0x0;
         LAB_001017e3:iVar8 = ossl_quic_trace(param_1, param_2, param_3, param_4, param_5, param_6, param_7);
   ...
   if (param_3 != 0x16) {
      if (param_3 < 0x17) {
         if (param_3 == 0x14) {
            ...
            if (param_5 == (X509*)0x2) {
               ...
               BIO_printf(param_7, "    Level=%s(%d), description=%s(%d)\n", pcVar12, (ulong)(uint)bVar4, pcVar14, (ulong)bVar1);
            } else {
      ...
      if (param_3 != 0x100) {
         ...
         if (bVar1 == 0x14) {
            ...
            LAB_00101ada:pcVar14 = *(char**)( puVar10 + 8 );
         } else {
            if (bVar1 == 0x15) {
      ...
      if (uVar26 == 0x300) {
         ...
         LAB_00101b40:pcVar14 = *(char**)( puVar10 + 8 );
      } else {
         if (uVar26 == 0x301) {
      ...
      if (( *(byte*)( *(long*)&param_6->wbio[1].ex_data.dummy + 0x50 ) & 8 ) != 0) {
         BIO_printf(param_7, "  epoch=%d, sequence_number=%04x%04x%04x\n", ( ulong )(ushort)(*(ushort*)( param_4 + 3 ) << 8 | *(ushort*)( param_4 + 3 ) >> 8), ( ulong )(ushort)(*(ushort*)( param_4 + 5 ) << 8 | *(ushort*)( param_4 + 5 ) >> 8), ( ulong )(ushort)(*(ushort*)( param_4 + 7 ) << 8 | *(ushort*)( param_4 + 7 ) >> 8), ( ulong )(ushort)(*(ushort*)( param_4 + 9 ) << 8 | *(ushort*)( param_4 + 9 ) >> 8));
      }
      bVar1 = *param_4;
      if (bVar1 == 0x14) {
         puVar10 = ssl_content_tbl;
         LAB_00102fed:pcVar14 = *(char**)( puVar10 + 8 );
      } else {
         if (bVar1 == 0x15) {
            puVar10 = (undefined1*)0x10a990;
            goto LAB_00102fed;
      ...
      BIO_printf(param_7, "  Content Type = %s (%d)\n  Length = %d", pcVar14, (ulong)bVar1, (ulong)CONCAT11(( param_4 + -2 )[(long)param_5], ( param_4 + -1 )[(long)param_5]));
      goto LAB_00101630;
   }
   if (*(int*)&param_6->s2 == 0) {
   ...
   pcVar14 = "UNKNOWN";
   LAB_001019b5:BIO_printf(param_7, "%s, Length=%d\n", pcVar14, (ulong)uVar27);
   ...
   if (( *(byte*)( *(long*)&param_6->wbio[1].ex_data.dummy + 0x50 ) & 8 ) != 0) {
      ...
      BIO_indent(param_7, 4, 0x50);
      BIO_printf(param_7, "message_seq=%d, fragment_offset=%d, fragment_length=%d\n", ( ulong )(ushort)(*(ushort*)( param_4 + 4 ) << 8 | *(ushort*)( param_4 + 4 ) >> 8), ( ulong )((uint)param_4[6] << 0x10 | (uint)param_4[7] << 8 | (uint)param_4[8]), ( ulong )((uint)param_4[0xb] | (uint)param_4[9] << 0x10 | (uint)param_4[10] << 8));
...
LAB_00103dd8:
   ...
   LAB_001017c5:local_60 = pXVar18;
   BIO_printf(param_7, "Message length parse error!\n");
   LAB_00101630:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      BIO_puts(param_7, "\n");
      return;
   }
   LAB_00103a5c:/* WARNING: Subroutine does not return */__stack_chk_fail();
}

void tls1_md5_final_raw(undefined4 *param_1, undefined1 *param_2) {
   ...
   *param_2 = (char)( ( uint ) * param_1 >> 0x18 );
   ...
   for (int i_761 = 0; i_761 < 4; i_761++) {
      param_2[( 4*i_761 + 4 )] = *(undefined1*)( (long)param_1 + ( 4*i_761 + 7 ) );
      param_2[( 4*i_761 + 5 )] = (char)*(undefined2*)( (long)param_1 + ( 4*i_761 + 6 ) );
      param_2[( 4*i_761 + 6 )] = (char)( (uint)param_1[( i_761 + 1 )] >> 8 );
      param_2[( 4*i_761 + 7 )] = (char)param_1[( i_761 + 1 )];
   }
   return;
   ...
   *param_2 = (char)( ( ulong ) * param_1 >> 0x38 );
   for (int i_763 = 0; i_763 < 6; i_763++) {
      param_2[( i_763 + 1 )] = (char)( ( ulong ) * param_1 >> ( -8*i_763 + 48 ) );
   }
   param_2[7] = (char)*param_1;
   for (int i_762 = 0; i_762 < 7; i_762++) {
      param_2[( 8*i_762 + 8 )] = *(undefined1*)( (long)param_1 + ( 8*i_762 + 15 ) );
      param_2[( 8*i_762 + 9 )] = (char)*(undefined2*)( (long)param_1 + ( 8*i_762 + 14 ) );
      param_2[( 8*i_762 + 10 )] = (char)( (ulong)param_1[( i_762 + 1 )] >> 40 );
      param_2[( 8*i_762 + 11 )] = (char)*(undefined4*)( (long)param_1 + ( 8*i_762 + 12 ) );
      param_2[( 8*i_762 + 12 )] = (char)( (ulong)param_1[( i_762 + 1 )] >> 24 );
      param_2[( 8*i_762 + 13 )] = (char)( (ulong)param_1[( i_762 + 1 )] >> 16 );
      param_2[( 8*i_762 + 14 )] = (char)( (ulong)param_1[( i_762 + 1 )] >> 8 );
      param_2[( 8*i_762 + 15 )] = (char)param_1[( i_762 + 1 )];
   }
   return;

/* EditorSceneFormatImporterUFBX::get_option_visibility(String const&, String const&, String const&,
   ...
   *plVar2 = (long)puVar4;
   ...
   void EditorSceneFormatImporterUFBX::handle_compatibility_options(EditorSceneFormatImporterUFBX *this, HashMap *param_1) {
      char cVar1;
      Variant *pVVar2;
      long in_FS_OFFSET;
      uint local_54;
   ...
   undefined8 EditorSceneFormatImporterUFBX::import_scene(EditorSceneFormatImporterUFBX *this, String *param_1, uint param_2, HashMap *param_3, List *param_4, Error *param_5) {
      code *pcVar1;
      char cVar2;
      int iVar3;
      Resource *this_00;
   ...
   *(undefined4*)param_5 = 1;
   uVar6 = 0;
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_78);
}cVar2 = RefCounted::unreference();if (( cVar2 != '\0' ) && ( cVar2 = predelete_handler(pOVar8) ),cVar2 != '\0') {
   ( **(code**)( *(long*)pOVar8 + 0x140 ) )(pOVar8);
   Memory::free_static(pOVar8, false);

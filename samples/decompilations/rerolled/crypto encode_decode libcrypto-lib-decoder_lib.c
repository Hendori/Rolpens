void collect_all_decoders(undefined8 param_1, undefined8 param_2) {
         ...
         if (lVar4 == 0) {
            ...
            *(undefined4*)( plVar2 + 4 ) = 0;
            ...
            if (lVar6 == 0) {
               ...
               ERR_set_error(0x3c, 0x8010e, "the mandatory \'input\' property is missing for decoder %s (properties: %s)", uVar5, uVar3);
            } else {
   ...
   LAB_001004d0:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 0;
   }
   LAB_00100500:/* WARNING: Subroutine does not return */__stack_chk_fail();
   ...
   *(undefined4*)( param_1 + 0x68 ) = 1;
   ...
   return 0;
}undefined8 OSSL_DECODER_export(long param_1, long param_2, undefined8 param_3, long param_4, long param_5) {
   long lVar1;
   undefined8 uVar2;
   ...
   if (*(long*)( param_1 + 0x18 ) != 0) {
      ...
      if (lVar2 != 0) {
         ...
         LAB_00100b42:local_d0._12_4_ = 0;
         uVar8 = 0;
                  ...
                  if (uVar10 != 0) {
                     do {
                        while (true) {
                           ...
                           if (iVar1 != 0) break;
                           joined_r0x00100d7d:uVar9 = uVar9 + 1;
                           if (uVar10 == uVar9) goto LAB_00100c29;
                        };
                        uVar11 = local_c0._0_8_;
                        if ((ulong)local_c0._0_8_ < (ulong)local_b0._8_8_) {
                           do {
                              plVar5 = (long*)OPENSSL_sk_value(*(undefined8*)( local_d8 + 0x18 ), uVar11 & 0xffffffff);
                              if (*(long*)( lVar4 + 0x18 ) == *(long*)( *plVar5 + 0x18 )) goto joined_r0x00100d7d;
                              uVar11 = uVar11 + 1;
                        ...
                        if (( *(long*)( lVar4 + 0x50 ) != 0 ) && ( *(long*)( local_d8 + 8 ) != 0 )) {
                           ...
                           local_68 = (undefined1[16])0x0;
                           local_58 = (undefined1[16])0x0;
                           OSSL_PARAM_construct_utf8_string(local_108, "data-structure", *(long*)( local_d8 + 8 ), 0);
                           local_78._0_8_ = local_e8;
                           iVar1 = ( **(code**)( lVar4 + 0x50 ) )(lVar6, local_98);
                           if (iVar1 != 0) goto LAB_00100d09;
                           LAB_00100d70:( **(code**)( lVar4 + 0x38 ) )(lVar6);
                           goto joined_r0x00100d7d;
                        }
                        LAB_00100d09:lVar7 = ossl_decoder_instance_new(lVar4, lVar6);
                        ...
                        if (local_d0._12_4_ == 0) {
                           ...
                           joined_r0x00100da9:if (iVar1 != 0) goto LAB_00100d44;
                           LAB_00100dab:ossl_decoder_instance_free(lVar7);
                           goto joined_r0x00100d7d;
                        }
                        ...
                        LAB_00100d44:iVar1 = ossl_decoder_ctx_add_decoder_inst(local_d8, lVar7);
                        if (iVar1 == 0) goto LAB_00100dab;
                        local_b0._8_8_ = local_b0._8_8_ + 1;
                        uVar9 = uVar9 + 1;
                     } while ( uVar10 != uVar9 );
                  }
                  LAB_00100c29:local_120 = local_120 + 1;
   ...
   goto LAB_00100e0a;
   LAB_00100dc5:local_120 = local_b0._0_8_;
   local_110 = local_110 + 1;
   local_c0 = local_b0;
   if (( local_b0._8_8_ == local_b0._0_8_ ) || ( 10 < local_110 )) goto LAB_00100dfb;
   goto LAB_00100b42;
   LAB_00100dfb:OPENSSL_sk_pop_free(lVar2, OSSL_DECODER_free);
   LAB_00100e0a:uVar3 = 1;
   LAB_00100e0f:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   ...
   *(byte*)( param_2 + 4 ) = *(byte*)( param_2 + 4 ) | 1;
   ...
   if (param_1 == 0) {
                        ...
                        if (( ( *plVar1 == 0 ) || ( iVar4 = OPENSSL_strcasecmp(*plVar1, uVar11) ),iVar4 == 0 )) {
                           if (local_70 == 0) {
                              if (( ( *(byte*)( param_2 + 4 ) & 4 ) == 0 ) && ( lVar10 = lVar8 ),plVar1[1] != 0) {
                                 joined_r0x001013c7:if (lVar10 != 0) {
                              ...
                              if (( lVar8 == 0 ) || ( iVar4 = iVar4 != 0 )) goto LAB_001014b5;
                           ...
                           local_a8 = ( **(code**)( lVar7 + 0x68 ) )(uVar9, lVar6, (int)local_68[2], decoder_process, &local_68, &ossl_pw_passphrase_callback_dec);
                           *(byte*)( param_2 + 4 ) = *(byte*)( param_2 + 4 ) & 0xfd | local_50[8] & 2;
                           if (local_a8 == 0) goto LAB_001015ec;
                           if (( local_50 & (undefined1[16])0x2 ) != (undefined1[16])0x0) goto LAB_001015f4;
                           ERR_pop_to_mark();
                           if (( local_50 & (undefined1[16])0x1 ) != (undefined1[16])0x0) break;
                        }
                        LAB_001014b5:bVar13 = uVar12 != 0;
                        uVar12 = uVar12 - 1;
                     } while ( bVar13 );
                  } else {
                     do {
                        ...
                        if (( iVar4 != 0 ) && ( ( local_78 == 0 || ( iVar4 = OSSL_DECODER_is_a(lVar8) ),iVar4 != 0 ) )) {
                           if (local_70 == 0) {
                              if (( ( *(byte*)( param_2 + 4 ) & 4 ) == 0 ) && ( lVar7 = lVar10 != 0 )) {
                                 LAB_001010e4:if (lVar7 != 0) {
                                    *(byte*)( param_2 + 4 ) = *(byte*)( param_2 + 4 ) | 4;
                              ...
                              if (( lVar10 == 0 ) || ( iVar4 = iVar4 != 0 )) goto LAB_001011db;
                              if (( *(byte*)( param_2 + 4 ) & 4 ) == 0) {
                                 lVar7 = plVar1[1];
                                 goto LAB_001010e4;
                              }
                           ...
                           local_60._8_8_ = uVar12;
                           local_50[8] = local_50[8] & 0xfb | *(byte*)( param_2 + 4 ) & 4;
                           local_a8 = ( **(code**)( lVar8 + 0x68 ) )(uVar5, lVar6, (int)local_68[2], decoder_process, &local_68, &ossl_pw_passphrase_callback_dec, local_68 + 7);
                           *(byte*)( param_2 + 4 ) = *(byte*)( param_2 + 4 ) & 0xfd | local_50[8] & 2;
                           if (local_a8 == 0) goto LAB_001015ec;
                           if (( local_50 & (undefined1[16])0x2 ) != (undefined1[16])0x0) goto LAB_001015f4;
                           ERR_pop_to_mark();
      ...
      *(byte*)( param_2 + 4 ) = *(byte*)( param_2 + 4 ) & 0xfd;
      if (( (code*)plVar1[4] != (code*)0x0 ) && ( iVar3 = ( *(code*)plVar1[4] )(uVar5, param_1, plVar1[6]) ),0 < iVar3) {
      ...
      if (( lVar6 != 0 ) && ( *(int*)( lVar6 + 8 ) == 5 )) {
         ...
         if (( ( local_b0 != (BIO*)0x0 ) && ( ( lVar6 = OSSL_PARAM_locate_const(param_1, "data-type") ),lVar6 == 0 || ( iVar3 = OSSL_PARAM_get_utf8_string_ptr(lVar6, &local_78) ),iVar3 != 0 ) )) {
            ...
            if (lVar6 != 0) {
               ...
               if (( plVar1[1] != 0 ) && ( ( ( iVar3 = OPENSSL_strcasecmp(plVar1[1], "SubjectPublicKeyInfo") ),iVar3 == 0 || ( iVar3 = OPENSSL_strcasecmp(local_70, "PrivateKeyInfo") ),iVar3 == 0 ) ) || ( iVar3 = OPENSSL_strcasecmp(plVar1[1], "PrivateKeyInfo") ),iVar3 == 0) {
                  *(byte*)( param_2 + 4 ) = *(byte*)( param_2 + 4 ) | 4;
               }
            }
            if (( ( local_78 != 0 ) && ( local_70 != 0 ) ) && ( iVar3 = OPENSSL_strcasecmp(local_70, "type-specific") ),iVar3 == 0) {
               local_70 = 0;
            }
            lVar6 = param_2[2];
            goto LAB_00101037;
   ...
   LAB_00100fb6:local_a8 = 0;
   lVar6 = 0;
   LAB_00100fd7:ossl_core_bio_free(lVar6);
   ...
   *plVar1 = lVar2;
   ...
   return local_a8;
   LAB_001015ec:local_a8 = 0;
   LAB_001015f4:ERR_clear_last_mark();
   goto LAB_00100fd7;
   ...
   if (param_2 == (BIO*)0x0) {
      ...
      if (iVar1 != 0) {
         ...
         if ((int)lVar4 < 0) {
            ...
            b = (BIO*)0x0;
            LAB_00101726:puVar7 = (undefined*)*param_1;
            ...
            if (uVar5 == uVar3) {
               LAB_0010177f:ERR_new();
               ERR_set_debug("crypto/encode_decode/decoder_lib.c", 0x66, "OSSL_DECODER_from_bio");
               ERR_set_error(0x3c, 0x8010c, "No supported data to decode. %s%s%s%s%s%s", puVar6, local_80, puVar7, local_70, local_78, puVar8);
            } else {
      ...
      ERR_set_error(0x3c, 0x66, "No decoders were found. For standard decoders you need at least one of the default or base providers available. Did you forget to load them?");
   }
   LAB_001018b5:uVar2 = 0;
   LAB_001018b8:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar2;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   BIO *bp;
   long lVar2;
   if (( ( param_2 != (undefined8*)0x0 ) && ( param_3 != (long*)0x0 ) ) && ( (void*)*param_2 != (void*)0x0 )) {

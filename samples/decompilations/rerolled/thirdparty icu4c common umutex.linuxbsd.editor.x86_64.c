void umtx_init(void) {
  ...
  umtx_init::{lambda()
   ...
   std::condition_variable::condition_variable
            ((condition_variable *)umtx_init::{lambda()
   #2
   icu_76_godot::
   (anonymous_namespace)::initCondition = umtx_init::{lambda();
   #2
   ...
   icu_76_godot::
   (anonymous_namespace)::pInitFlag = (undefined*)&icu_76_godot::(anonymous_namespace)::initFlag;
   icu_76_godot::
   (anonymous_namespace)::initFlag = 0;
   return 1;
}/* icu_76_godot::UMutex::getMutex() */long icu_76_godot::UMutex::getMutex(UMutex *this) {
   long lVar1;
   long lVar2;
   ...
   *(code**)( in_FS_OFFSET + lVar2 ) = std::once_flag::_Prepare_execution::_Prepare_execution<std::call_once<void(&)()>(std::once_flag&,void(&)())::{lambda()#1}()#1} > (void(&)())::_FUN;
...
}/* icu_76_godot::UMutex::cleanup() */void icu_76_godot::UMutex::cleanup(void) {
   long lVar1;
   if (gListHead != 0) {
      do {
         LOCK();
   ...
   if ((UMutex*)param_1 == (UMutex*)0x0) {
      param_1 = (anonymous_namespace)::globalMutex;
   }
   ...
   return;
}/* icu_76_godot::umtx_initImplPreInit(icu_76_godot::UInitOnce&) */undefined8 icu_76_godot::umtx_initImplPreInit(UInitOnce *param_1) {
   long lVar1;
   long lVar2;
   undefined *__once_control;
   int iVar3;
   ...
   *(code**)( in_FS_OFFSET + lVar2 ) = std::once_flag::_Prepare_execution::_Prepare_execution<std::call_once<void(&)()>(std::once_flag&,void(&)())::{lambda()#1}()#1} > (void(&)())::_FUN;
   ...
   if (iVar3 != 0) {
      LAB_001003d2:/* WARNING: Subroutine does not return */std::__throw_system_error(iVar3);
   }
   *(undefined8*)( in_FS_OFFSET + lVar1 ) = 0;
   *(undefined8*)( in_FS_OFFSET + lVar2 ) = 0;
   local_40 = 0;
   ...
   LAB_0010038f:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return uVar4;
}/* icu_76_godot::umtx_initImplPostInit(icu_76_godot::UInitOnce&) */void icu_76_godot::umtx_initImplPostInit(UInitOnce *param_1) {
   pthread_mutex_t *__mutex;
   int iVar1;
   __mutex = (anonymous_namespace)::initMutex;
   if ((anonymous_namespace)::initMutex == (pthread_mutex_t*)0x0) {
   ...
   *in_RCX = 0x10;
   return;
}/* _FUN() */void std::once_flag::_Prepare_execution::_Prepare_execution {
   lambda()#1}()#1}>(void(&)())
     ::{lambda()
   #1
   {
      long in_FS_OFFSET;
      for (int i_1152 = 0; i_1152 < 2; i_1152++) {

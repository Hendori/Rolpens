/* WARNING: Unknown calling convention */void append_quoted(char *str) {
   byte bVar1;
   bool bVar2;
   byte *pbVar3;
   char *pcVar4;
   ...
   do {
      if (print_ls_colors == false) {
         ...
         LAB_00100050:if (lsc_obstack.chunk_limit == lsc_obstack.next_free) {
            LAB_001000b8:rpl_obstack_newchunk(&lsc_obstack, 1);
         }
...
/* WARNING: Unknown calling convention */void append_entry(char prefix, char *item, char *arg) {
   char *pcVar1;
   char cVar2;
   if (print_ls_colors) {
      append_quoted("\x1b[");
   ...
   *lsc_obstack.next_free = ( -(print_ls_colors == false) & 0x34U ) + 9;
   ...
   if (print_ls_colors == false) {
      ...
      LAB_00100340:rpl_obstack_newchunk(&lsc_obstack, 1);
   }
 else {
   ...
   LAB_001002ad:pcVar1 = lsc_obstack.next_free + 1;
   *lsc_obstack.next_free = cVar2;
   lsc_obstack.next_free = pcVar1;
   return;
}
/* WARNING: Unknown calling convention */_Bool dc_parse_stream(FILE *fp, char *filename) {
   ...
   lVar19 = 0;
   LAB_00100470:lVar19 = lVar19 + 1;
   pNVar18 = (NoteGnuProperty_4*)pcVar6;
   if (fp == (FILE*)0x0) goto LAB_001005c0;
   LAB_0010047d:_Var9 = __getdelim(&input_line, &input_line_size, 10, (FILE*)fp);
   ...
   if (_Var9 < 1) {
      ...
      free(input_line);
      LAB_0010075a:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return local_71;
      }
         ...
         do {
            ...
            while (( cVar2 < '\t' && ( cVar2 != '\0' ) )) {
               while (true) {
                  ...
                  if (cVar2 < '\x0e') break;
                  LAB_001004e1:if (cVar2 == ' ') goto LAB_001004e5;
               }
;
            }
;
            LAB_001004e5:pcVar7 = (char*)ximemdup0(pNVar18, (long)pNVar14 - (long)pNVar18);
            if ((char)pNVar14->namesz == '\0') {
               LAB_00100813:uVar11 = quotearg_n_style_colon(0, 3, filename);
...
;
 ...
 while ( cVar2 == ' ' );
            LAB_00100518:if (( cVar2 == '\0' ) || ( pNVar1 = cVar2 == '#' )) goto LAB_00100813;
            do {
               pNVar16 = pNVar1;
 ...
 while ( cVar2 != '\0' && cVar2 != '#' );
            ...
            while ('\b' < cVar2) {
               while (true) {
                  ...
                  if (cVar2 < '\x0e') break;
                  LAB_0010055c:if (cVar2 != ' ') goto LAB_00100560;
               }
;
            }
;
            LAB_00100560:arg = (char*)ximemdup0(pNVar14, (long)pNVar16 - (long)pNVar18);
 ...
 while ( pcVar17 != (char*)0x0 );
            ...
            LAB_001005a3:lVar19 = lVar19 + 1;
            free(pcVar7);
            free(arg);
            pNVar18 = (NoteGnuProperty_4*)pcVar6;
            if (fp != (FILE*)0x0) goto LAB_0010047d;
            LAB_001005c0:if (pNVar18 == &NoteGnuProperty_4_001033b0) goto LAB_0010075a;
            sVar10 = strlen((char*)pNVar18);
            pcVar6 = pNVar18->name + ( sVar10 - 0xb );
            cVar2 = (char)pNVar18->namesz;
            if (cVar2 < '\x0e') goto LAB_001004ac;
            LAB_001005eb:if (cVar2 == ' ') break;
         }
 while ( true );
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* WARNING: Unknown calling convention */void usage(int status) {
   ...
   pFVar1 = _stdout;
   pcVar4 = (char*)dcgettext(0, "Output commands to set the LS_COLORS environment variable.\n\nDetermine format of output:\n  -b, --sh, --bourne-shell    output Bourne shell code to set LS_COLORS\n  -c, --csh, --c-shell        output C shell code to set LS_COLORS\n  -p, --print-database        output defaults\n      --print-ls-colors       output fully escaped colors for display\n", 5);
 ...
 while ( pcVar4 != (char*)0x0 );
   ...
   if (pcVar4 == (char*)0x0) {
      ...
      pcVar6 = setlocale(5, (char*)0x0);
      if (pcVar6 != (char*)0x0) {
         LAB_00100b0d:iVar2 = strncmp(pcVar6, "en_", 3);
         pFVar1 = _stdout;
         if (iVar2 != 0) {
   ...
   LAB_0010092a:/* WARNING: Subroutine does not return */exit(status);
}
/* WARNING: Control flow encountered bad instruction data *//* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* WARNING: Unknown calling convention */int main(int argc, char **argv) {
   char **ppcVar1;
   _Bool _Var2;
   int iVar3;
   int iVar4;
...
;
   ...
   if (( print_ls_colors != false ) || ( bVar12 != 0 )) {
      if (cVar13 == '\x02') {
         if (( print_ls_colors == false ) || ( pcVar7 = "options --print-database and --print-ls-colors are mutually exclusive" ),bVar12 == 0) {
         ...
         pcVar7 = "the options to output non shell syntax,\nand to select a shell syntax are mutually exclusive";
      }

      uVar6 = dcgettext(0, pcVar7, 5);
      error(0, 0, uVar6);
      LAB_00101855:/* WARNING: Subroutine does not return */usage(1);
   }
   ...
   if (cVar13 == '\x02') {
      LAB_0010165f:pcVar7 = getenv("SHELL");
   ...
   LAB_001016b7:rpl_obstack_begin(&lsc_obstack, 0, 0, &malloc, free);
   if (argc == iVar4) {
      _Var2 = dc_parse_stream((FILE*)0x0, (char*)0x0);
      LAB_0010173b:pcVar7 = lsc_obstack.object_base;
      if (_Var2 != false) {
         ...
         lsc_obstack.object_base = lsc_obstack.next_free + ( -(long)lsc_obstack.next_free & lsc_obstack.alignment_mask );
         if (( ulong )((long)lsc_obstack.chunk_limit - (long)lsc_obstack.chunk) < ( ulong )((long)( lsc_obstack.next_free + ( -(long)lsc_obstack.next_free & lsc_obstack.alignment_mask ) ) - (long)lsc_obstack.chunk)) {

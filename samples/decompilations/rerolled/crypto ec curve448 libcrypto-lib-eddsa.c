undefined8 hash_init_with_dom_constprop_0(undefined8 param_1, EVP_MD_CTX *param_2, char param_3, void *param_4, ulong param_5, undefined8 param_6) {
   int iVar1;
   EVP_MD *type;
   undefined8 uVar2;
   long in_FS_OFFSET;
   ...
   uVar2 = 0;
   LAB_00100092:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar2;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}int ossl_c448_ed448_convert_private_key_to_x448(undefined8 param_1, undefined8 param_2, void *param_3, undefined8 param_4) {
   int iVar1;
   EVP_MD_CTX *ctx;
   EVP_MD *type;
   ...
   return 0;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 ossl_c448_ed448_derive_public_key(undefined8 param_1, undefined8 param_2, void *param_3, undefined8 param_4) {
   int iVar1;
   EVP_MD_CTX *ctx;
   EVP_MD *type;
   undefined8 uVar2;
      ...
      if (type == (EVP_MD*)0x0) {
         ...
         if (( iVar1 != 0 ) && ( iVar1 = iVar1 != 0 )) {
            ...
            if (iVar1 != 0) {
               ...
               for (int i_2568 = 0; i_2568 < 2; i_2568++) {
   ...
   uVar2 = 0;
   LAB_00100230:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return uVar2;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 ossl_c448_ed448_sign(undefined8 param_1, undefined1 *param_2, void *param_3, void *param_4, void *param_5, size_t param_6, undefined1 param_7, undefined8 param_8, undefined8 param_9, undefined8 param_10) {
   int iVar1;
   EVP_MD_CTX *ctx;
   EVP_MD_CTX *ctx_00;
   EVP_MD *type;
   ...
   if (ctx_00 == (EVP_MD_CTX*)0x0) {
      ...
      if (( iVar1 == 0 ) || ( iVar1 = iVar1 == 0 )) {
         LAB_00100415:EVP_MD_CTX_free(ctx_00);
         EVP_MD_free(type);
         goto LAB_00100422;
      }
      ...
      iVar1 = hash_init_with_dom_constprop_0(param_1, ctx, param_7, param_8, param_9, param_10);
      if (( ( iVar1 == 0 ) || ( iVar1 = EVP_DigestUpdate(ctx, local_f8, 0x39) ),iVar1 == 0 )) goto LAB_00100422;
   ...
   EVP_MD_CTX_free(ctx);
   LAB_0010042d:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return uVar4;
   ...
   return;
}undefined8 ossl_c448_ed448_verify(undefined8 param_1, void *param_2, void *param_3, void *param_4, size_t param_5, undefined1 param_6, undefined8 param_7, undefined1 param_8, undefined8 param_9) {
   byte bVar1;
   int iVar2;
   long lVar3;
   undefined8 uVar4;
                  ...
                  if (iVar2 != 0) {
                     ...
                     if (iVar2 != 0) {
                        ...
                        if (iVar2 != 0) {
                           ...
                           ossl_curve448_base_double_scalarmul_non_secret(local_2b8, local_2f8, local_2b8, local_338);
   ...
   uVar4 = 0;
   LAB_0010082d:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar4;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   return;
}bool ossl_ed448_sign(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6, undefined8 param_7, undefined8 param_8, undefined1 param_9, undefined8 param_10) {
   int iVar1;
   iVar1 = ossl_c448_ed448_sign(param_1, param_2, param_6, param_5, param_3, param_4, param_9, param_7, param_8, param_10);
   return iVar1 == -1;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}bool ossl_ed448_verify(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6, undefined1 param_7, undefined1 param_8, undefined8 param_9) {
   int iVar1;
   iVar1 = ossl_c448_ed448_verify(param_1, param_4, param_5, param_2, param_3, param_8, param_6, param_7, param_9);
   return iVar1 == -1;

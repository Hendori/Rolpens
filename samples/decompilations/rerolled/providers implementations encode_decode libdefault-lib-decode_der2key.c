undefined1 *BARE_ALGOR_it(void) {
   ...
   undefined8 uVar2;
   UNRECOVERED_JUMPTABLE = (code*)ossl_prov_get_keymgmt_export(*(undefined8*)( *(long*)( param_1 + 0x108 ) + 8 ));
   if (( param_3 == 8 ) && ( UNRECOVERED_JUMPTABLE != (code*)0x0 )) {
      iVar1 = *(int*)( param_1 + 0x110 );
      if (*(int*)( param_1 + 0x110 ) == 0) {
         iVar1 = 0x87;
      }
      for (int i_2388 = 0; i_2388 < 2; i_2388++) {
   ...
   CRYPTO_free(param_1);
   return;
}undefined4 der2key_decode(undefined8 *param_1, undefined8 param_2, uint param_3, code *param_4, undefined8 param_5) {
   code *pcVar1;
   int iVar2;
   undefined4 uVar3;
   long lVar4;
   ...
   *(uint*)( param_1 + 0x22 ) = param_3;
   ...
   if (iVar2 == 0) {
         ...
         if (local_e0 == (EC_KEY*)0x0) {
            LAB_0010060a:if (( uVar7 & 2 ) != 0) {
               ...
               if (pcVar1 == (code*)0x0) {
                  ...
                  LAB_00100641:if (local_e0 != (EC_KEY*)0x0) goto LAB_0010052b;
               }
               if (*(int*)( param_1 + 0x22 ) != 0) goto LAB_00100660;
            }
            if (( uVar7 & 0x84 ) != 0) {
               local_f0 = local_f8;
               if (( *(code**)( param_1[0x21] + 0x30 ) != (code*)0x0 ) && ( local_e0 = (EC_KEY*)( **(code**)( param_1[0x21] + 0x30 ) )(0, &local_f0, local_e8) ),local_e0 != (EC_KEY*)0x0) goto LAB_0010052b;
               if (*(int*)( param_1 + 0x22 ) != 0) goto LAB_00100660;
            }
            ERR_clear_last_mark();
         } else {
            LAB_0010052b:ERR_pop_to_mark();
         }
         if (local_e0 != (EC_KEY*)0x0) {
            lVar4 = param_1[0x21];
            if (*(code**)( lVar4 + 0x48 ) == (code*)0x0) {
               LAB_00100685:if (*(code**)( lVar4 + 0x50 ) != (code*)0x0) {
      ...
      if (pcVar1 == (code*)0x0) {
         ...
         LAB_001005f7:if (local_e0 != (EC_KEY*)0x0) goto LAB_0010052b;
         if (*(int*)( param_1 + 0x22 ) == 0) goto LAB_0010060a;
         LAB_00100660:ERR_clear_last_mark();
         goto LAB_00100359;
      }
      local_e0 = (EC_KEY*)( *pcVar1 )(&local_f0, local_e8, param_1);
   ...
   ( **(code**)( param_1[0x21] + 0x58 ) )(local_e0);
   CRYPTO_free(local_f8);
   LAB_001004e3:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return uVar3;
   ...
   undefined8 *puVar1;
   puVar1 = (undefined8*)CRYPTO_zalloc(0x118, "providers/implementations/encode_decode/decode_der2key.c", 0xa3);
   ...
   long lVar1;
   lVar1 = ossl_ml_kem_d2i_PKCS8(*param_1, param_2, *(undefined4*)( param_3[0x21] + 0x18 ), *param_3, param_3 + 1);
   if (lVar1 != 0) {
   ...
   long lVar1;
   lVar1 = ossl_ml_kem_d2i_PUBKEY(*param_1, param_2, *(undefined4*)( param_3[0x21] + 0x18 ), *param_3, param_3 + 1);
   if (lVar1 != 0) {
      *param_1 = *param_1 + param_2;
   }
   return;
   ...
   if (p8 == (PKCS8_PRIV_KEY_INFO*)0x0) {
      ...
      if (local_44 != -1) {
         ...
         ERR_set_error(0x39, 0xf9, "unexpected parameters with a PKCS#8 %s private key", **(undefined8**)( param_3 + 0x108 ));
         goto LAB_00101be7;
      }
   ...
   LAB_00101bfb:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return lVar4;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   if (lVar3 != 0) {
      ...
      lVar4 = lVar4 + 0x12;
      if (lVar4 == param_2) {
         local_50 = (undefined8*)CRYPTO_zalloc(0x10, "providers/implementations/encode_decode/decode_der2key.c", 0x2d0);
         if (local_50 != (undefined8*)0x0) {
            lVar5 = ASN1_item_d2i_ex(&local_50, &local_48, lVar4, local_it_1, 0, 0);
            if (lVar5 == 0) {
               ERR_new();
               uVar2 = 0x2d6;
               LAB_00101d3a:ERR_set_debug("providers/implementations/encode_decode/decode_der2key.c", uVar2, "slh_dsa_d2i_PUBKEY");
               ...
               iVar1 = OBJ_cmp(a, b);
               if (iVar1 == 0) {
                  iVar1 = ossl_slh_dsa_set_pub(lVar3, *(undefined8*)( (int*)local_50[1] + 2 ), (long)*(int*)local_50[1]);
                  if (iVar1 != 0) {
                     if (local_50 != (undefined8*)0x0) {
                  ...
                  ERR_new();
                  ERR_set_debug("providers/implementations/encode_decode/decode_der2key.c", 0x2eb, "slh_dsa_d2i_PUBKEY");
                  uVar2 = ossl_slh_dsa_key_get_name(lVar3);
                  pcVar6 = "failed to parse %s public key from the input data";
               } else {
                  ERR_new();
                  ERR_set_debug("providers/implementations/encode_decode/decode_der2key.c", 0x2e4, "slh_dsa_d2i_PUBKEY");
                  uVar2 = ossl_slh_dsa_key_get_name(lVar3);
         ...
         ERR_new();
         ERR_set_debug("providers/implementations/encode_decode/decode_der2key.c", 0x2c9, "slh_dsa_d2i_PUBKEY");
         ERR_set_error(0x39, 0x8d, "unexpected %s public key length: %ld != %ld", *(undefined8*)param_3[0x21], param_2, lVar4);
         if (local_50 == (undefined8*)0x0) goto LAB_00101da0;
         LAB_00101d6f:ASN1_OBJECT_free((ASN1_OBJECT*)*local_50);
         ASN1_BIT_STRING_free((ASN1_BIT_STRING*)local_50[1]);
         CRYPTO_free(local_50);
      }
      LAB_00101da0:ossl_slh_dsa_key_free(lVar3);
   }
   lVar3 = 0;
   LAB_00101daa:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return lVar3;
   ...
   if ((int)uVar2 == 0) {
      ...
      if (*(int*)( *(long*)( param_2 + 0x108 ) + 0x18 ) == 0x390) {
         LAB_00101fbd:iVar1 = ossl_rsa_check_factors(param_1);
   ...
   long lVar1;
   lVar1 = ossl_ml_dsa_d2i_PKCS8(*param_1, param_2, *(undefined4*)( param_3[0x21] + 0x18 ), *param_3, param_3 + 1);
   if (lVar1 != 0) {
      *param_1 = *param_1 + param_2;
   }
   return;
   ...
   long lVar1;
   lVar1 = ossl_ml_dsa_d2i_PUBKEY(*param_1, param_2, *(undefined4*)( param_3[0x21] + 0x18 ), *param_3, param_3 + 1);
   if (lVar1 != 0) {
      *param_1 = *param_1 + param_2;
   }
   return;
   ...
   LAB_00102200:uVar2 = 0;
   LAB_00102202:PKCS8_PRIV_KEY_INFO_free(p8);
   ...
   LAB_00103280:uVar2 = 0;
   LAB_00103282:PKCS8_PRIV_KEY_INFO_free(p8);
   if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar2;
   }
   /* WARNING: Subroutine does not return */
   ...
   LAB_00103360:uVar2 = 0;
   LAB_00103362:PKCS8_PRIV_KEY_INFO_free(p8);
   if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar2;
   }
   /* WARNING: Subroutine does not return */
   ...
   LAB_00103440:uVar2 = 0;
   LAB_00103442:PKCS8_PRIV_KEY_INFO_free(p8);
   if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar2;
   }
   /* WARNING: Subroutine does not return */
   ...
   LAB_00103520:uVar2 = 0;
   LAB_00103522:PKCS8_PRIV_KEY_INFO_free(p8);
   if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar2;
   }
   /* WARNING: Subroutine does not return */
   ...
   LAB_00103600:uVar2 = 0;
   LAB_00103602:PKCS8_PRIV_KEY_INFO_free(p8);
   if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar2;
   }
   /* WARNING: Subroutine does not return */

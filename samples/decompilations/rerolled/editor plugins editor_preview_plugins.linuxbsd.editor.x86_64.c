/* EditorImagePreviewPlugin::generate_small_preview_automatically() const */undefined8 EditorImagePreviewPlugin::generate_small_preview_automatically(void) {
   return 1;
}
/* EditorTexturePreviewPlugin::handles(String const&) const */undefined4 EditorTexturePreviewPlugin::handles(EditorTexturePreviewPlugin *this, String *param_1) {
   undefined4 uVar1;
   long in_FS_OFFSET;
   long local_30;
   long local_28;
   ...
   LAB_00100096:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar1;
   }
...
/* EditorBitmapPreviewPlugin::handles(String const&) const */undefined4 EditorBitmapPreviewPlugin::handles(EditorBitmapPreviewPlugin *this, String *param_1) {
   undefined4 uVar1;
   long in_FS_OFFSET;
   long local_30;
   long local_28;
   ...
   LAB_00100146:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar1;
   }
...
/* EditorPackedScenePreviewPlugin::handles(String const&) const */undefined4 EditorPackedScenePreviewPlugin::handles(EditorPackedScenePreviewPlugin *this, String *param_1) {
   undefined4 uVar1;
   long in_FS_OFFSET;
   long local_30;
   long local_28;
   ...
   LAB_001001f6:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar1;
   }
...
/* EditorMaterialPreviewPlugin::handles(String const&) const */undefined4 EditorMaterialPreviewPlugin::handles(EditorMaterialPreviewPlugin *this, String *param_1) {
   undefined4 uVar1;
   long in_FS_OFFSET;
   long local_30;
   long local_28;
   ...
   LAB_001002a6:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar1;
   }
...
/* EditorScriptPreviewPlugin::handles(String const&) const */undefined4 EditorScriptPreviewPlugin::handles(EditorScriptPreviewPlugin *this, String *param_1) {
   undefined4 uVar1;
   long in_FS_OFFSET;
   long local_30;
   long local_28;
   ...
   LAB_00100356:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar1;
   }
...
/* EditorAudioStreamPreviewPlugin::handles(String const&) const */undefined4 EditorAudioStreamPreviewPlugin::handles(EditorAudioStreamPreviewPlugin *this, String *param_1) {
   undefined4 uVar1;
   long in_FS_OFFSET;
   long local_30;
   long local_28;
   ...
   LAB_00100406:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar1;
   }
...
/* EditorMeshPreviewPlugin::handles(String const&) const */undefined4 EditorMeshPreviewPlugin::handles(EditorMeshPreviewPlugin *this, String *param_1) {
   undefined4 uVar1;
   long in_FS_OFFSET;
   long local_30;
   long local_28;
   ...
   LAB_001004b6:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar1;
   }
...
/* EditorFontPreviewPlugin::handles(String const&) const */undefined4 EditorFontPreviewPlugin::handles(EditorFontPreviewPlugin *this, String *param_1) {
   undefined4 uVar1;
   long in_FS_OFFSET;
   long local_30;
   long local_28;
   ...
   LAB_00100566:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar1;
   }
...
/* EditorGradientPreviewPlugin::handles(String const&) const */undefined4 EditorGradientPreviewPlugin::handles(EditorGradientPreviewPlugin *this, String *param_1) {
   undefined4 uVar1;
   long in_FS_OFFSET;
   long local_30;
   long local_28;
   ...
   LAB_00100616:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar1;
   }
...
/* EditorImagePreviewPlugin::handles(String const&) const */void EditorImagePreviewPlugin::handles(EditorImagePreviewPlugin *this, String *param_1) {
   String::operator ==(param_1, "Image");
   return;
}
/* EditorMaterialPreviewPlugin::abort() */void EditorMaterialPreviewPlugin::abort(void) {
   EditorResourcePreviewGenerator::DrawRequester::abort();
   return;
}
/* EditorMeshPreviewPlugin::abort() */void EditorMeshPreviewPlugin::abort(void) {
   EditorResourcePreviewGenerator::DrawRequester::abort();
   return;
}
/* EditorFontPreviewPlugin::abort() */void EditorFontPreviewPlugin::abort(void) {
   EditorResourcePreviewGenerator::DrawRequester::abort();
   return;
}
...
/* void Ref<Texture2D>::TEMPNAMEPLACEHOLDERVALUE(Ref<ImageTexture> const&) [clone .isra.0] */void Ref<Texture2D>::operator =(Ref<Texture2D> *this, Ref *param_1) {
   Object *pOVar1;
   char cVar2;
   Object *pOVar3;
   pOVar1 = *(Object**)this;
...
/* EditorFontPreviewPlugin::generate(Ref<Resource> const&, Vector2 const&, Dictionary&) const */Ref *EditorFontPreviewPlugin::generate(Ref *param_1, Vector2 *param_2, Dictionary *param_3) {
   long *plVar1;
   long lVar2;
   char cVar3;
   long in_FS_OFFSET;
...
/* post_process_preview(Ref<Image>) */void post_process_preview(undefined8 *param_1) {
   long lVar1;
   int iVar2;
   int iVar3;
   int iVar4;
 ...
 while ( iVar8 * iVar8 < (int)( ( uVar6 - iVar8 ) * ( uVar6 - iVar8 ) + ( iVar2 - iVar8 ) * ( iVar2 - iVar8 ) ) );
         iVar2 = iVar2 + 1;
      }
 while ( iVar2 < iVar8 );
   }
...
/* EditorMaterialPreviewPlugin::~EditorMaterialPreviewPlugin() */void EditorMaterialPreviewPlugin::~EditorMaterialPreviewPlugin(EditorMaterialPreviewPlugin *this) {
   int iVar1;
   long lVar2;
   long *plVar3;
   *(undefined***)this = &PTR__initialize_classv_00111da8;
   ...
   if (lVar2 == 0) {
      _err_print_error("~EditorMaterialPreviewPlugin", "editor/plugins/editor_preview_plugins.cpp", 0x1e1, "Parameter \"RenderingServer::get_singleton()\" is null.", 0, 0);
   }
 else {
...
/* EditorMeshPreviewPlugin::~EditorMeshPreviewPlugin() */void EditorMeshPreviewPlugin::~EditorMeshPreviewPlugin(EditorMeshPreviewPlugin *this) {
   int iVar1;
   long lVar2;
   long *plVar3;
   *(undefined***)this = &PTR__initialize_classv_00112258;
   lVar2 = RenderingServer::get_singleton();
   if (lVar2 == 0) {
      _err_print_error("~EditorMeshPreviewPlugin", "editor/plugins/editor_preview_plugins.cpp", 0x341, "Parameter \"RenderingServer::get_singleton()\" is null.", 0, 0);
   }
 else {
      plVar3 = (long*)RenderingServer::get_singleton();
      ( **(code**)( *plVar3 + 0x11b0 ) )(plVar3, *(undefined8*)( this + 0x200 ));
...
/* EditorFontPreviewPlugin::~EditorFontPreviewPlugin() */void EditorFontPreviewPlugin::~EditorFontPreviewPlugin(EditorFontPreviewPlugin *this) {
   int iVar1;
   long lVar2;
   long *plVar3;
   *(undefined***)this = &PTR__initialize_classv_001123e8;
   lVar2 = RenderingServer::get_singleton();
   if (lVar2 == 0) {
      _err_print_error("~EditorFontPreviewPlugin", "editor/plugins/editor_preview_plugins.cpp", 0x39e, "Parameter \"RenderingServer::get_singleton()\" is null.", 0, 0);
   }
 else {
      plVar3 = (long*)RenderingServer::get_singleton();
      ( **(code**)( *plVar3 + 0x11b0 ) )(plVar3, *(undefined8*)( this + 0x210 ));
...
/* EditorTexturePreviewPlugin::EditorTexturePreviewPlugin() */void EditorTexturePreviewPlugin::EditorTexturePreviewPlugin(EditorTexturePreviewPlugin *this) {
   EditorResourcePreviewGenerator::EditorResourcePreviewGenerator((EditorResourcePreviewGenerator*)this);
   *(undefined***)this = &PTR__initialize_classv_00111768;
   return;
}
/* EditorImagePreviewPlugin::EditorImagePreviewPlugin() */void EditorImagePreviewPlugin::EditorImagePreviewPlugin(EditorImagePreviewPlugin *this) {
   EditorResourcePreviewGenerator::EditorResourcePreviewGenerator((EditorResourcePreviewGenerator*)this);
   *(undefined***)this = &PTR__initialize_classv_001118f8;
   return;
}
/* EditorBitmapPreviewPlugin::EditorBitmapPreviewPlugin() */void EditorBitmapPreviewPlugin::EditorBitmapPreviewPlugin(EditorBitmapPreviewPlugin *this) {
   EditorResourcePreviewGenerator::EditorResourcePreviewGenerator((EditorResourcePreviewGenerator*)this);
   *(undefined***)this = &PTR__initialize_classv_00111a88;
   return;
}
/* EditorPackedScenePreviewPlugin::EditorPackedScenePreviewPlugin() */void EditorPackedScenePreviewPlugin::EditorPackedScenePreviewPlugin(EditorPackedScenePreviewPlugin *this) {
   EditorResourcePreviewGenerator::EditorResourcePreviewGenerator((EditorResourcePreviewGenerator*)this);
   *(undefined***)this = &PTR__initialize_classv_00111c18;
   return;
}
/* EditorScriptPreviewPlugin::EditorScriptPreviewPlugin() */void EditorScriptPreviewPlugin::EditorScriptPreviewPlugin(EditorScriptPreviewPlugin *this) {
   EditorResourcePreviewGenerator::EditorResourcePreviewGenerator((EditorResourcePreviewGenerator*)this);
   *(undefined***)this = &PTR__initialize_classv_00111f38;
   return;
}
/* EditorAudioStreamPreviewPlugin::EditorAudioStreamPreviewPlugin() */void EditorAudioStreamPreviewPlugin::EditorAudioStreamPreviewPlugin(EditorAudioStreamPreviewPlugin *this) {
   EditorResourcePreviewGenerator::EditorResourcePreviewGenerator((EditorResourcePreviewGenerator*)this);
   *(undefined***)this = &PTR__initialize_classv_001120c8;
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* EditorMeshPreviewPlugin::EditorMeshPreviewPlugin() */void EditorMeshPreviewPlugin::EditorMeshPreviewPlugin(EditorMeshPreviewPlugin *this) {
   code *pcVar1;
   bool bVar2;
   long *plVar3;
   undefined8 uVar4;
   ...
   *(undefined***)this = &PTR__initialize_classv_00112258;
   for (int i = 0; i < 5; i++) {
      *(undefined1(*) [16])( this + ( 16*i + 504 ) ) = (undefined1[16])0;
   }
   ...
   *(undefined8*)( this + 0x238 ) = uVar4;
   ...
   StringName::StringName((StringName*)&local_d0, "rendering/lights_and_shadows/use_physical_light_units", false);
   ...
   if (bVar2) {
      ...
      *(undefined8*)( this + 0x240 ) = uVar4;
      ...
      plVar3 = (long*)RenderingServer::get_singleton();
      ( **(code**)( *plVar3 + 0x978 ) )(plVar3, *(undefined8*)( this + 0x238 ), *(undefined8*)( this + 0x240 ));
   }
   ...
   *(undefined8*)( this + 0x218 ) = uVar4;
   plVar3 = (long*)RenderingServer::get_singleton();
   uVar4 = ( **(code**)( *plVar3 + 0xd10 ) )(plVar3, *(undefined8*)( this + 0x218 ), *(undefined8*)( this + 0x1f8 ));
   ...
   *(undefined8*)( this + 0x228 ) = uVar4;
   ...
   plVar3 = (long*)RenderingServer::get_singleton();
   uVar4 = ( **(code**)( *plVar3 + 0xd10 ) )(plVar3, *(undefined8*)( this + 0x228 ), *(undefined8*)( this + 0x1f8 ));
   ...
   *(undefined8*)( this + 0x200 ) = uVar4;
   ...
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      ...
      ( **(code**)( *plVar3 + 0xd28 ) )(plVar3, *(undefined8*)( this + 0x200 ), *(undefined8*)( this + 0x1f8 ));
      return;
   }
...
/* EditorGradientPreviewPlugin::EditorGradientPreviewPlugin() */void EditorGradientPreviewPlugin::EditorGradientPreviewPlugin(EditorGradientPreviewPlugin *this) {
   EditorResourcePreviewGenerator::EditorResourcePreviewGenerator((EditorResourcePreviewGenerator*)this);
   *(undefined***)this = &PTR__initialize_classv_00112578;
   return;
}
/* EditorResourcePreviewGenerator::initialize_class() [clone .part.0] */void EditorResourcePreviewGenerator::initialize_class(void) {
   long in_FS_OFFSET;
   undefined8 local_70;
   undefined8 local_68;
   long local_60;
   ...
   void Ref<Image>::operator =(Ref<Image> *this, Ref *param_1) {
      Image *pIVar1;
      char cVar2;
      pIVar1 = *(Image**)this;
   ...
   EditorScriptPreviewPlugin * EditorScriptPreviewPlugin::_generate_from_source_code(EditorScriptPreviewPlugin * this, ScriptLanguage * param_1, String * param_2, Vector2 * param_3, Dictionary * param_4);
   {
      uint uVar1;
      uint uVar2;
      long lVar3;
      ...
      if (param_2 == (String*)0x0) {
         ...
         local_a8 = (undefined1[16])0x0;
         local_98 = (undefined1[16])0x0;
         if (( local_f8 != (long*)0x0 ) && ( lVar16 = lVar16 != 0 )) {
            do {
               while (cVar12 = ( **(code**)( *(long*)param_2 + 0x180 ) )(param_2, lVar16),cVar12 == '\0') {
                  HashSet<String,HashMapHasherDefault,HashMapComparatorDefault<String>>::insert((String*)local_e8);
...
;
 ...
 while ( lVar16 != 0 );
      ...
      LAB_00102393:fVar29 = *(float*)param_4;
      ...
      CowData<char32_t>::_unref((CowData<char32_t>*)local_e8);
      local_e8[0] = (Ref*)0x0;
      String::parse_latin1((String*)local_e8, "text_editor/theme/highlighting/control_flow_keyword_color");
      _EDITOR_GET((String*)&local_58);
      ...
      if (local_70._4_4_ == 0.0) {
         ...
         LAB_0010266a:local_70._4_4_ = _LC73;
      }
      ...
      iVar13 = iVar13 >> 3;
      if (lVar16 == 0) {
         LAB_0010290f:local_e8[0] = (Ref*)0x0;
 ...
 while ( pCVar22 != (CowData<char32_t>*)( uVar10 + uVar15 * 8 ) );
         ...
         LAB_0010221f:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            return this;
         }
      ...
      bVar7 = false;
      iVar24 = iVar13;
      LAB_001028f9:lVar3 = *(long*)( lVar16 + -8 );
      iVar18 = (int)lVar3;
      ...
      if (0x20 < uVar1) {
         if (iVar24 < iVar25) {
            ...
            if (uVar1 != 0x23) {
               ...
               if (bVar28) {
                  LAB_00102e1d:uVar15 = ( ulong )(uVar1 - 0x41);
                  if (uVar1 - 0x41 < 0x3a) goto LAB_00102e2b;
               }
 else {
                  LAB_00102eae:uVar15 = ( ulong )(uVar1 - 0x41);
                  if (uVar1 - 0x41 < 0x3a) {
                     if (( 0x3ffffff43ffffffU >> ( uVar15 & 0x3f ) & 1 ) != 0) {
                        LAB_00102ca1:puVar23 = (uint*)( lVar16 + lVar27 * 4 );
                        do {
                           if (lVar3 == lVar21) {
 ...
 else if (( 0x39 < uVar2 - 0x41 ) || ( ( 0x3ffffff43ffffffU >> ( ( ulong )(uVar2 - 0x41) & 0x3f ) & 1 ) == 0 )) goto LAB_00102cec;
                           lVar21 = lVar21 + 1;
                           puVar23 = puVar23 + 1;
                        }
 while ( true );
                     ...
                     LAB_00102e2b:_local_68 = auVar34;
                     if (( 0x3ffffff43ffffffU >> ( uVar15 & 0x3f ) & 1 ) != 0) goto LAB_00102e3f;
                  }

               }

               LAB_00102c59:_local_68 = auVar34;
            ...
            if ((int)lVar27 < iVar18 + -2) {
               if (lVar3 == lVar26) {
                  ...
                  lVar21 = lVar26;
                  if (lVar3 <= lVar26) {
                     LAB_00102bb9:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar21, lVar3, "p_index", "size()", "", false, true);
                     _err_flush_stdout();
                     /* WARNING: Does not return */
               ...
               if (( *piVar19 != 0x23 ) || ( bVar6 = bVar5 )) goto LAB_00102b48;
               LAB_00102794:bVar6 = true;
               bVar5 = false;
               _local_68 = auVar37;
            }
 else {
               LAB_00102b48:bVar5 = true;
               _local_68 = auVar36;
            }
      ...
      bVar7 = false;
      iVar24 = iVar13;
      LAB_001028ec:lVar27 = lVar27 + 1;
      lVar26 = lVar26 + 1;
      if (lVar16 == 0) goto LAB_0010290f;
      goto LAB_001028f9;
      LAB_00102cec:_local_68 = auVar34;
      String::substr((int)(String*)local_e8, (int)param_3);
      local_fc = 0;
      cVar12 = HashSet<String,HashMapHasherDefault,HashMapComparatorDefault<String>>::_lookup_pos((HashSet<String,HashMapHasherDefault,HashMapComparatorDefault<String>>*)local_d8, (String*)local_e8, &local_fc);
      if (cVar12 == '\0') {
         local_fc = 0;
         cVar12 = HashSet<String,HashMapHasherDefault,HashMapComparatorDefault<String>>::_lookup_pos((HashSet<String,HashMapHasherDefault,HashMapComparatorDefault<String>>*)local_a8, (String*)local_e8, &local_fc);
         if (cVar12 == '\0') {
            CowData<char32_t>::_unref((CowData<char32_t>*)local_e8);
            LAB_00102e3f:if (bVar7) goto LAB_00102c69;
         ...
         CowData<char32_t>::_unref((CowData<char32_t>*)local_e8);
         LAB_00102c69:bVar7 = true;
         bVar5 = false;
         _local_68 = auVar33;
      }

      LAB_001027b8:fVar29 = _LC84 * local_60._4_4_;
      fVar31 = _LC38 - fVar29;
      fVar30 = fVar31 * local_70._4_4_ + fVar29;
      local_58 = 0;
      uStack_50 = 0;
      if (fVar30 != 0.0) {
         local_58 = CONCAT44(( (float)local_78._4_4_ * local_70._4_4_ * fVar31 + (float)local_68._4_4_ * fVar29 ) / fVar30, ( (float)local_78._0_4_ * local_70._4_4_ * fVar31 + (float)local_68._0_4_ * fVar29 ) / fVar30);
         uStack_50 = CONCAT44(fVar30, ( local_70._4_4_ * (float)local_70 * fVar31 + fVar29 * (float)local_60 ) / fVar30);
      }
      ...
      LAB_001028e8:iVar24 = iVar24 + 1;
      goto LAB_001028ec;
   }

   /* EditorScriptPreviewPlugin::generate_from_path(String const&, Vector2 const&, Dictionary&) const
    */
   EditorScriptPreviewPlugin * EditorScriptPreviewPlugin::generate_from_path(EditorScriptPreviewPlugin * this, String * param_1, Vector2 * param_2, Dictionary * param_3);
   {
      long *plVar1;
      long lVar2;
      String *pSVar3;
   ...
   EditorScriptPreviewPlugin * EditorScriptPreviewPlugin::generate(EditorScriptPreviewPlugin * this, Ref * param_1, Vector2 * param_2, Dictionary * param_3);
   {
      char cVar1;
      Object *pOVar2;
      String *pSVar3;
      ...
      *(undefined8*)this = 0;
      LAB_00103118:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return this;
      }
   ...
   EditorMaterialPreviewPlugin * EditorMaterialPreviewPlugin::generate(EditorMaterialPreviewPlugin * this, Ref * param_1, Vector2 * param_2, Dictionary * param_3);
   {
      code *pcVar1;
      Ref *pRVar2;
      char cVar3;
         ...
         if (pOVar5 != (Object*)0x0) {
            ...
            if (cVar3 != '\0') {
               ...
               if (iVar4 == 0) {
                  ...
                  EditorResourcePreviewGenerator::DrawRequester::request_and_wait(param_1 + 0x250, *(undefined8*)( param_1 + 0x210 ));
                  plVar6 = (long*)RenderingServer::get_singleton();
                  ( **(code**)( *plVar6 + 0x1c0 ) )((Ref<Image>*)&local_50, plVar6, *(undefined8*)( param_1 + 0x218 ));
                  plVar6 = (long*)RenderingServer::get_singleton();
                  ( **(code**)( *plVar6 + 0x358 ) )(plVar6, *(undefined8*)( param_1 + 0x200 ), 0, 0);
                  if (local_50 == (Ref*)0x0) {
                     _err_print_error("generate", "editor/plugins/editor_preview_plugins.cpp", 0x165, "Condition \"img.is_null()\" is true. Returning: Ref<ImageTexture>()", 0, 0);
                     *(undefined8*)this = 0;
      ...
      _err_print_error("generate", "editor/plugins/editor_preview_plugins.cpp", 0x15b, "Condition \"material.is_null()\" is true. Returning: Ref<Texture2D>()", 0, 0);
      *(undefined8*)this = 0;
      LAB_001032f9:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return this;
      }
   ...
   Ref *EditorImagePreviewPlugin::generate(Ref *param_1, Vector2 *param_2, Dictionary *param_3) {
      ...
      long local_40;
      local_40 = *(long*)( in_FS_OFFSET + 0x28 );
      if (( ( ( *(long*)param_3 == 0 ) || ( pIVar4 = (Image*)__dynamic_cast(*(long*)param_3, &Object::typeinfo, &Image::typeinfo, 0, in_R8, in_R9, 0) ),pIVar4 == (Image*)0x0 ) ) || ( cVar2 = RefCounted::reference() ),cVar2 == '\0') {
         *(undefined8*)param_1 = 0;
         goto LAB_0010358f;
      }
      ...
      if (cVar2 == '\0') {
         ...
         if (local_50 == (Image*)0x0) {
            ...
            if (pIVar7 != pIVar5) {
               if (pIVar5 == (Image*)0x0) {
                  ...
                  if (pIVar7 != (Image*)0x0) {
                     LAB_001037e5:cVar2 = RefCounted::unreference();
                     if (cVar2 != '\0') {
         ...
         LAB_0010366e:Image::clear_mipmaps();
         cVar2 = Image::is_compressed();
         if (cVar2 == '\0') {
            iVar3 = Image::get_format();
            if (( iVar3 != 4 ) && ( iVar3 = iVar3 != 5 )) {
               uVar6 = 0;
         ...
         local_50 = (Image*)0x0;
         if (( pIVar4 != (Image*)0x0 ) && ( local_50 = pIVar4 ),cVar2 = RefCounted::reference(),cVar2 == '\0') {
            local_50 = (Image*)0x0;
         }
         ...
         *(undefined8*)param_1 = 0;
         ...
         if (( ( local_50 != (Image*)0x0 ) && ( cVar2 = RefCounted::unreference() ),pIVar7 = local_50,cVar2 != '\0' )) &&( cVar2 = cVar2 != '\0' )(**(code**)( *(long*)pIVar7 + 0x140 ))(pIVar7);
         Memory::free_static(pIVar7, false);
      }

   }

   else{*(undefined8*)param_1 = 0;
}
LAB_001035d5:if (( pIVar4 != (Image*)0x0 ) && ( cVar2 = RefCounted::unreference() ),cVar2 != '\0') {
   memdelete<Image>(pIVar4);
}
LAB_0010358f:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return param_1;}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* EditorMeshPreviewPlugin::generate(Ref<Resource> const&, Vector2 const&, Dictionary&) const */EditorMeshPreviewPlugin * __thiscall
EditorMeshPreviewPlugin::generate
   ...
   long local_40;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (( *(long*)param_2 != 0 ) && ( pOVar6 = (Object*)__dynamic_cast(*(long*)param_2, &Object::typeinfo, &Mesh::typeinfo, 0) ),pOVar6 != (Object*)0x0) {
      ...
      if (cVar5 != '\0') {
         ...
         local_58 = (float)uStack_70 * fStack_90 + (float)local_68._4_4_ * fStack_8c + local_58 * local_88;
         ...
         local_78._4_4_ = (float)local_78._4_4_ * (float)uVar12 + (float)local_68._0_4_ * (float)uVar4 + fVar21 * uStack_60._4_4_;
         local_78._0_4_ = (float)local_78._0_4_ * (float)uVar12 + uStack_70._4_4_ * (float)uVar4 + fVar21 * (float)uStack_60;
         uStack_70._0_4_ = (float)uStack_70 * (float)uVar12 + (float)local_68._4_4_ * (float)uVar4 + fVar21 * fVar17;
         uStack_70._4_4_ = fVar22 + uStack_70._4_4_ * (float)local_98._0_4_ + (float)local_98._4_4_ * (float)uStack_60;
         fVar21 = (float)local_68._0_4_ * fStack_8c;
         local_68._4_4_ = (float)local_68._4_4_ * (float)local_98._0_4_ + fVar18 + (float)local_98._4_4_ * fVar17;
         local_68._0_4_ = (float)local_68._0_4_ * (float)local_98._0_4_ + fVar23 + (float)local_98._4_4_ * uStack_60._4_4_;
 ...
 while ( lVar11 != 0xc );
         ...
         if ((float)local_a8._0_4_ - (float)local_d8._0_4_ <= (float)local_a8._4_4_ - (float)local_d8._4_4_) {
         ...
         if (_LC84 * fVar21 == 0.0) {
            *(undefined8*)this = 0;
            ...
            local_4c = (float)( ( uint )(uStack_60._4_4_ * fVar15 + (float)uStack_60 * fVar13 + local_58 * fVar14) ^ __LC93 ) - ( ( fVar17 - fVar16 ) + ( fVar17 - fVar16 ) );
            local_54 = CONCAT44(( uint )(fVar14 * SUB164(_local_68, 4) + local_f8 * SUB164(_local_78, 0xc) + fStack_f4 * (float)local_68._0_4_) ^ _LC94._4_4_, ( uint )(fVar14 * SUB164(_local_78, 8) + local_f8 * SUB164(_local_78, 0) + fStack_f4 * (float)local_78._4_4_) ^ (uint)_LC94);
            plVar7 = (long*)RenderingServer::get_singleton();
            ( **(code**)( *plVar7 + 0xd40 ) )(plVar7, *(undefined8*)( param_1 + 0x200 ), local_78);
            EditorResourcePreviewGenerator::DrawRequester::request_and_wait(param_1 + 0x248, *(undefined8*)( param_1 + 0x208 ));
            plVar7 = (long*)RenderingServer::get_singleton();
            ( **(code**)( *plVar7 + 0x1c0 ) )((Ref<Image>*)&local_128, plVar7, *(undefined8*)( param_1 + 0x210 ));
            if (local_128 == (Ref*)0x0) {
               _err_print_error("generate", "editor/plugins/editor_preview_plugins.cpp", 0x306, "Condition \"img.is_null()\" is true. Returning: Ref<ImageTexture>()", 0, 0);
               *(undefined8*)this = 0;
               Ref<Texture2D>::operator =((Ref<Texture2D>*)this, (Ref*)0x0);
            }
 else {
               ...
               *(undefined8*)this = 0;
               ...
               if (( ( local_120 != (Ref*)0x0 ) && ( cVar5 = RefCounted::unreference() ),pRVar2 = local_120,cVar5 != '\0' )) &&( cVar5 = cVar5 != '\0' )(**(code**)( *(long*)pRVar2 + 0x140 ))(pRVar2);
               Memory::free_static(pRVar2, false);
            }
...
_err_print_error("generate", "editor/plugins/editor_preview_plugins.cpp", 0x2ed, "Condition \"mesh.is_null()\" is true. Returning: Ref<Texture2D>()", 0, 0);*(undefined8*)this = 0;LAB_00103e05:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return this;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* EditorGradientPreviewPlugin::generate(Ref<Resource> const&, Vector2 const&, Dictionary&) const */Ref *EditorGradientPreviewPlugin::generate(Ref *param_1, Vector2 *param_2, Dictionary *param_3) {
   Object *pOVar1;
   char cVar2;
   Object *pOVar3;
...
/* EditorPackedScenePreviewPlugin::generate_from_path(String const&, Vector2 const&, Dictionary&)
   const */String *EditorPackedScenePreviewPlugin::generate_from_path(String *param_1, Vector2 *param_2, Dictionary *param_3) {
   char cVar1;
   int iVar2;
   Resource *this;
   long lVar3;
   ...
   *(undefined8*)( this + 600 ) = 0;
   ...
   if (cVar1 == '\0') {
      ...
      LAB_00104736:local_58 = (Resource*)0x0;
      ...
      *(undefined8*)param_1 = 0;
      ...
      if (( ( local_58 != (Resource*)0x0 ) && ( cVar1 = RefCounted::unreference() ),pRVar4 = local_58,cVar1 != '\0' )) &&( cVar1 = cVar1 != '\0' )(**(code**)( *(long*)pRVar4 + 0x140 ))(pRVar4);
      Memory::free_static(pRVar4, false);
   }

}
else{Ref<Image>::unref((Ref<Image>*)&local_58);if (this != (Resource*)local_60) {
   local_58 = (Resource*)local_60;
...
cVar1 = RefCounted::unreference();if (cVar1 != '\0') {
   memdelete<Image>((Image*)this);
}
LAB_001046b9:iVar2 = Image::load(local_60);if (iVar2 == 0) goto LAB_00104736;LAB_001046c5:*(undefined8*)param_1 = 0;}if (( local_60 != (String*)0x0 ) && ( cVar1 = RefCounted::unreference() ),cVar1 != '\0') {
   memdelete<Image>((Image*)local_60);
}
LAB_00104596:CowData<char32_t>::_unref((CowData<char32_t>*)local_68);CowData<char32_t>::_unref((CowData<char32_t>*)&local_70);CowData<char32_t>::_unref(local_78);if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return param_1;}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* EditorFontPreviewPlugin::generate_from_path(String const&, Vector2 const&, Dictionary&) const */EditorFontPreviewPlugin * __thiscall
EditorFontPreviewPlugin::generate_from_path
   ...
   if (local_78 == (Ref*)0x0) {
      LAB_00104e30:CowData<char32_t>::_unref((CowData<char32_t>*)&local_80);
   }
 else {
      ...
      if (pOVar6 != (Object*)0x0) {
         ...
         if (( local_78 != (Ref*)0x0 ) && ( cVar4 = RefCounted::unreference() ),cVar4 != '\0') goto LAB_00104d88;
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_80);
         LAB_00104901:local_88 = (Ref*)0x0;
         if (( generate_from_path(String_const&,Vector2_const&,Dictionary&):: ) && ( iVar5 = __cxa_guard_acquire(&generate_from_path(String_const & Vector2_const & Dictionary & ::sample_base), iVar5 != 0) ) {
 ...
 while ( *(int*)( puVar9 + 4 ) != 0 );
            ...
            String::parse_utf32((StrRange*)&generate_from_path(String_const & Vector2_const & Dictionary & ::sample_base));
            __cxa_atexit(String::~String, &generate_from_path(String_const & Vector2_const & Dictionary & ::sample_base, &__dso_handle));
         ...
         if (generate_from_path(String_const & Vector2_const & Dictionary & ::sample_base != 0) {
            ...
            do {
               ...
               if (lVar13 == lVar14) {
                  ...
                  puVar8 = (undefined8*)( generate_from_path(String_const&,Vector2_const&,Dictionary&):: );
               }
               ...
               if (cVar4 != '\0') {
                  if (generate_from_path(String_const & Vector2_const & Dictionary & ::sample_base == 0) {
                     if (lVar14 != 0) {
                        lVar13 = 0;
                        LAB_00104dd4:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar14, lVar13, "p_index", "size()", "", false, true);
                        _err_flush_stdout();
                        /* WARNING: Does not return */
                        pcVar1 = (code*)invalidInstructionException();
                        ( *pcVar1 )();
                     ...
                     LAB_00104ef8:pwVar10 = (wchar32*)&String::_null;
                  }
 else {
                     lVar13 = *(long*)( generate_from_path(String_const&,Vector2_const&,Dictionary&):: );
                     if (lVar13 == lVar14) goto LAB_00104ef8;
                     if (lVar13 <= lVar14) goto LAB_00104dd4;
                     pwVar10 = (wchar32*)( generate_from_path(String_const&,Vector2_const&,Dictionary&):: );
                  }
 ...
 while ( generate_from_path(String_const & Vector2_const & Dictionary & ::sample_base != 0) );
         ...
         lVar11 = *(long*)pOVar6;
         LAB_001049cd:if (( local_88 == (Ref*)0x0 ) || ( *(uint*)( local_88 + -8 ) < 2 )) {
         ...
         fVar15 = (float)( **(code**)( lVar11 + 0x288 ) )(pOVar6, (CowData<char32_t>*)&local_88, 0, 0x32, 3, 0, 0);
         local_60[1] = 80.0;
         local_60[0] = _LC101 - fVar15 * _LC84;
         ProjectSettings::get_singleton();
         StringName::StringName((StringName*)&local_78, "rendering/environment/defaults/default_clear_color", false);
         ...
         ( **(code**)( *(long*)pOVar6 + 0x298 ) )(pOVar6, *(undefined8*)( param_1 + 0x210 ), local_60, (CowData<char32_t>*)&local_88, 0, 0x32, (StringName*)&local_58, 3, 0, 0);
         EditorResourcePreviewGenerator::DrawRequester::request_and_wait(param_1 + 0x218, *(undefined8*)( param_1 + 0x1f8 ));
         plVar7 = (long*)RenderingServer::get_singleton();
         ( **(code**)( *plVar7 + 0xfb8 ) )(plVar7, *(undefined8*)( param_1 + 0x210 ));
         plVar7 = (long*)RenderingServer::get_singleton();
         ( **(code**)( *plVar7 + 0x1c0 ) )((StrRange*)&local_80, plVar7, *(undefined8*)( param_1 + 0x200 ));
         if (local_80 == (Ref*)0x0) {
            _err_print_error("generate_from_path", "editor/plugins/editor_preview_plugins.cpp", 0x376, "Condition \"img.is_null()\" is true. Returning: Ref<ImageTexture>()", 0, 0);
            *(undefined8*)this = 0;
            Ref<Texture2D>::operator =((Ref<Texture2D>*)this, (Ref*)0x0);
         }
 else {
            ...
            *(undefined8*)this = 0;
            ...
            if (( ( local_78 != (Ref*)0x0 ) && ( cVar4 = RefCounted::unreference() ),pRVar2 = local_78,cVar4 != '\0' )) &&( cVar4 = cVar4 != '\0' )(**(code**)( *(long*)pRVar2 + 0x140 ))(pRVar2);
            Memory::free_static(pRVar2, false);
         }
   ...
   LAB_00104d79:cVar4 = RefCounted::unreference();
   if (cVar4 == '\0') goto LAB_00104e30;
   pOVar6 = (Object*)0x0;
   LAB_00104d88:pRVar2 = local_78;
...
_err_print_error("generate_from_path", "editor/plugins/editor_preview_plugins.cpp", 0x35a, "Condition \"sampled_font.is_null()\" is true. Returning: Ref<Texture2D>()", 0, 0);*(undefined8*)this = 0;LAB_00104d40:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return this;}/* EditorTexturePreviewPlugin::generate(Ref<Resource> const&, Vector2 const&, Dictionary&) const */Ref *EditorTexturePreviewPlugin::generate(Ref *param_1, Vector2 *param_2, Dictionary *param_3) {
   float fVar1;
   long *plVar2;
   code *pcVar3;
   char cVar4;
   ...
   if (pOVar14 == (Object*)0x0) {
      LAB_001055b0:pOVar14 = (Object*)0x0;
      LAB_001055b2:local_a0 = (Ref*)0x0;
      if (( pOVar14 != (Object*)0x0 ) && ( pRVar9 = (Ref*)__dynamic_cast(pOVar14, &Object::typeinfo, &Texture2D::typeinfo, 0) ),pRVar9 != (Ref*)0x0) {
         local_98 = (Ref*)0x0;
         local_a0 = pRVar9;
         cVar4 = RefCounted::reference();
         if (cVar4 == '\0') {
      ...
      LAB_001054da:pOVar8 = (Object*)0x0;
      pOVar7 = (Object*)0x0;
      pOVar6 = (Object*)0x0;
      Ref<Texture2D>::unref((Ref<Texture2D>*)&local_a0);
      LAB_001052fa:if (local_b0 != (Image*)0x0) {
      ...
      LAB_00105311:*(undefined8*)param_1 = 0;
      LAB_00105318:if (pOVar8 != (Object*)0x0) {
         LAB_0010531d:cVar4 = RefCounted::unreference();
         if (cVar4 != '\0') {
            LAB_00105520:cVar4 = predelete_handler(pOVar8);
            if (cVar4 != '\0') {
      ...
      if (pOVar6 != (Object*)0x0) {
         ...
         LAB_001051d0:pOVar8 = (Object*)0x0;
         LAB_001050cc:AtlasTexture::get_atlas();
         ...
         if (local_a0 != (Ref*)0x0) {
            ...
            if (cVar4 != '\0') {
               ...
               if (( ( local_98 != (Ref*)0x0 ) && ( cVar4 = RefCounted::unreference() ),pRVar9 = local_98,cVar4 != '\0' )) &&( cVar4 = cVar4 != '\0' )(**(code**)( *(long*)pRVar9 + 0x140 ))();
      ...
      LAB_0010515d:*(undefined8*)param_1 = 0;
      Ref<Image>::unref((Ref<Image>*)&local_a0);
   ...
   LAB_0010504d:pOVar7 = (Object*)__dynamic_cast(pOVar14, &Object::typeinfo, &Texture3D::typeinfo, 0);
   if (pOVar7 != (Object*)0x0) {
      cVar4 = RefCounted::reference();
      if (cVar4 == '\0') {
         pOVar14 = *(Object**)param_3;
   ...
   LAB_0010508f:pOVar8 = (Object*)__dynamic_cast(pOVar14, &Object::typeinfo, &TextureLayered::typeinfo, 0);
   ...
   LAB_001051ee:pOVar8 = (Object*)0x0;
   iVar5 = ( **(code**)( *(long*)pOVar7 + 0x1e0 ) )(pOVar7);
   if (iVar5 != 0) {
      LAB_00105204:( **(code**)( *(long*)pOVar7 + 0x1f0 ) )(&local_98);
      if (local_90[0] == 0) {
         lVar12 = 0;
      }
 else {
      ...
      if (iVar5 == lVar12) {
         ...
         if (local_90[0] != 0) {
            ...
            if (( iVar5 < 0 ) || ( *(long*)( local_90[0] + -8 ) <= lVar12 )) {
               _err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar12, *(long*)( local_90[0] + -8 ), "p_index", "size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
               pcVar3 = (code*)invalidInstructionException();
               ( *pcVar3 )();
      ...
      *(undefined8*)param_1 = 0;
      ...
      CowData<Ref<Image>>::_unref((CowData<Ref<Image>>*)local_90);
      if (pOVar8 == (Object*)0x0) {
         LAB_001053fc:cVar4 = RefCounted::unreference();
         if (cVar4 == '\0') goto LAB_00105347;
         goto LAB_0010539c;
      }
   ...
   *(undefined8*)param_1 = 0;
   ...
   if (cVar4 == '\0') goto LAB_00105347;
   pOVar6 = (Object*)0x0;
   LAB_0010539c:cVar4 = predelete_handler(pOVar7);
   if (cVar4 != '\0') {
...
LAB_00105347:if (local_b0 != (Image*)0x0) {
   cVar4 = RefCounted::unreference();
   if (cVar4 != '\0') {
...
return param_1;}/* Error CowData<unsigned char>::resize<false>(long) [clone .isra.0] */void CowData<unsigned_char>::resize<false>(CowData<unsigned_char> *this, long param_1) {
   ...
   LAB_00105b3c:puVar8[-1] = param_1;
   return;
}
/* EditorBitmapPreviewPlugin::generate(Ref<Resource> const&, Vector2 const&, Dictionary&) const */EditorBitmapPreviewPlugin * __thiscall
EditorBitmapPreviewPlugin::generate
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (( ( pOVar9 != (Object*)0x0 ) && ( pOVar9 = (Object*)__dynamic_cast(pOVar9, &Object::typeinfo, &BitMap::typeinfo, 0) ),pOVar9 != (Object*)0x0 )) {
      pOVar9 = (Object*)0x0;
   }
   ...
   if (cVar5 == '\0') {
      ...
      BitMap::get_size();
      CowData<unsigned_char>::resize<false>((CowData<unsigned_char>*)&local_60, (long)( iVar6 * extraout_var ));
 ...
 while ( iVar13 < iVar6 );
      ...
      if (cVar5 == '\0') {
         ...
         if (( iVar6 != 4 ) && ( iVar6 = iVar6 != 5 )) {
            uVar12 = 0;
            Image::convert(local_78, 5);
         }

         LAB_00105ed8:local_48 = Image::get_size();
         Vector2i::operator_cast_to_Vector2((Vector2i*)&local_48);
         fVar2 = *(float*)param_3;
         ...
         *(undefined8*)this = 0;
         ...
         if (( ( local_70 != (Ref*)0x0 ) && ( cVar5 = RefCounted::unreference() ),pRVar3 = local_70,cVar5 != '\0' )) &&( cVar5 = cVar5 != '\0' )(**(code**)( *(long*)pRVar3 + 0x140 ))(pRVar3);
...
else{*(undefined8*)this = 0;};cVar5 = RefCounted::unreference();joined_r0x00105e84:if (( cVar5 != '\0' ) && ( cVar5 = predelete_handler(pOVar9) ),cVar5 != '\0') {
...
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* EditorAudioStreamPreviewPlugin::generate(Ref<Resource> const&, Vector2 const&, Dictionary&) const
   ...
   long local_40;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (( ( *(long*)param_3 == 0 ) || ( pOVar5 = (Object*)__dynamic_cast(*(long*)param_3, &Object::typeinfo, &AudioStream::typeinfo) ),pOVar5 == (Object*)0x0 )) {
      _err_print_error("generate", "editor/plugins/editor_preview_plugins.cpp", 0x297, "Condition \"stream.is_null()\" is true. Returning: Ref<Texture2D>()", 0, 0);
      *(undefined8*)param_1 = 0;
      goto LAB_00106401;
   }
   ...
   iVar25 = (int)*in_RCX;
   iVar24 = (int)in_RCX[1];
   CowData<unsigned_char>::resize<false>((CowData<unsigned_char>*)&local_80, (long)( iVar25 * iVar24 * 3 ));
   CowData<unsigned_char>::_copy_on_write((CowData<unsigned_char>*)&local_80);
   lVar3 = local_80;
   ( **(code**)( *(long*)pOVar5 + 0x1c8 ) )(&local_a0);
   if (local_a0 == (Object*)0x0) {
      _err_print_error("generate", "editor/plugins/editor_preview_plugins.cpp", 0x2a3, "Condition \"playback.is_null()\" is true. Returning: Ref<Texture2D>()", 0, 0);
      *(undefined8*)param_1 = 0;
   }
 else {
      ...
      if ((long)uVar7 < 0) {
         _err_print_error("resize", "./core/templates/cowdata.h", 0x157, "Condition \"p_size < 0\" is true. Returning: ERR_INVALID_PARAMETER", 0, 0);
         LAB_00106685:puVar16 = (ulong*)0x0;
 ...
 while ( lVar14 != lVar13 + 0x10 );
      ...
      if (0 < iVar25) {
         ...
         do {
            ...
            if (iVar18 == iVar12) {
               iVar12 = iVar18 + 1;
               LAB_00106275:lVar13 = (long)iVar18;
               if (lVar13 < 0) {
...
;
               ...
               uVar20 = 0;
               LAB_0010643d:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar13, uVar20, "p_index", "size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
            ...
            LAB_001062fc:dVar30 = dVar29 * (double)iVar24 * _LC117;
            dVar29 = 0.0;
            if (( 0.0 <= dVar30 ) && ( dVar29 = dVar30 <= dVar29 )) {
               dVar29 = dVar30;
            }
            ...
            dVar31 = 0.0;
            if (( 0.0 <= dVar30 ) && ( dVar31 = dVar30 <= dVar31 )) {
               dVar31 = dVar30;
            }
            ...
            if (0 < iVar24) {
               ...
               do {
                  if (( iVar12 < (int)( dVar29 + (double)( iVar18 >> 2 ) ) ) || ( uVar17 = 0xb4 ),(int)( (double)( iVar18 >> 2 ) + dVar31 ) < iVar12) {
                     uVar17 = 100;
                  }
...
CowData<unsigned_char>::_unref((CowData<unsigned_char>*)&local_80);cVar4 = RefCounted::unreference();if (( cVar4 != '\0' ) && ( cVar4 = predelete_handler(pOVar5) ),cVar4 != '\0') {
   ( **(code**)( *(long*)pOVar5 + 0x140 ) )(pOVar5);
   Memory::free_static(pOVar5, false);
}
LAB_00106401:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return param_1;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* Vector<float>::push_back(float) [clone .isra.0] */void Vector<float>::push_back(Vector<float> *this, float param_1) {
   int iVar1;
   long lVar2;
   long lVar3;
   if (*(long*)( this + 8 ) == 0) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* EditorMaterialPreviewPlugin::EditorMaterialPreviewPlugin() */void EditorMaterialPreviewPlugin::EditorMaterialPreviewPlugin(EditorMaterialPreviewPlugin *this) {
   char cVar1;
   code *pcVar2;
   double dVar3;
   double dVar4;
   ...
   *(undefined8*)( this + 0x240 ) = uVar9;
   ...
   ProjectSettings::get_singleton();
   StringName::StringName((StringName*)&local_118, "rendering/lights_and_shadows/use_physical_light_units", false);
   ProjectSettings::get_setting_with_override((StringName*)&local_78);
   ...
   if (bVar7) {
      ...
      *(undefined8*)( this + 0x248 ) = uVar9;
      ...
      plVar8 = (long*)RenderingServer::get_singleton();
      ( **(code**)( *plVar8 + 0x978 ) )(plVar8, *(undefined8*)( this + 0x240 ), *(undefined8*)( this + 0x248 ));
   }
   ...
   *(undefined8*)( this + 0x220 ) = uVar9;
   plVar8 = (long*)RenderingServer::get_singleton();
   uVar9 = ( **(code**)( *plVar8 + 0xd10 ) )(plVar8, *(undefined8*)( this + 0x220 ), *(undefined8*)( this + 0x1f8 ));
   ...
   *(undefined8*)( this + 0x230 ) = uVar10;
   ...
   plVar8 = (long*)RenderingServer::get_singleton();
   uVar10 = ( **(code**)( *plVar8 + 0xd10 ) )(plVar8, *(undefined8*)( this + 0x230 ), *(undefined8*)( this + 0x1f8 ));
   ...
   *(undefined8*)( this + 0x200 ) = uVar10;
   plVar8 = (long*)RenderingServer::get_singleton();
   uVar10 = ( **(code**)( *plVar8 + 0xd10 ) )(plVar8, *(undefined8*)( this + 0x200 ), *(undefined8*)( this + 0x1f8 ));
   fVar27 = _LC129;
   *(undefined8*)( this + 0x208 ) = uVar10;
   ...
   while (true) {
      ...
      while (true) {
         ...
         Vector<float>::push_back((Vector<float>*)&local_118, __y * (float)local_a8._0_4_ + fVar29 * (float)local_a8._4_4_ + fStack_a0 * __x);
         ...
         Vector<float>::push_back((Vector<float>*)&local_118, fVar26 * fStack_a0 + __y_02 * (float)local_a8._0_4_ + fVar30 * (float)local_a8._4_4_);
         ...
         Vector<float>::push_back((Vector<float>*)&local_118, __y_00 * (float)local_a8._0_4_ + (float)local_a8._4_4_ * fVar30 + fStack_a0 * __x_01);
         ...
         Vector<float>::push_back((Vector<float>*)&local_118, __x_01 * fStack_a0 + __y_00 * (float)local_a8._0_4_ + fVar30 * (float)local_a8._4_4_);
         ...
         Vector<float>::push_back((Vector<float>*)&local_118, __x_00 * fStack_a0 + __y_03 * (float)local_a8._0_4_ + fVar29 * (float)local_a8._4_4_);
         Vector<float>::push_back((Vector<float>*)&local_118, fVar26 + fVar24 + fVar25);
         Vector<float>::push_back((Vector<float>*)&local_118, fVar15 + fVar22 + fVar23);
         Vector<float>::push_back((Vector<float>*)&local_118, _LC38);
         ...
         fVar24 = (float)local_98._0_4_ * fVar29;
         fVar25 = (float)local_98._4_4_ * __x;
         Vector<float>::push_back((Vector<float>*)&local_118, __x * fStack_a0 + __y * (float)local_a8._0_4_ + fVar29 * (float)local_a8._4_4_);
...
/* RefCounted::is_class_ptr(void*) const */uint RefCounted::is_class_ptr(RefCounted *this, void *param_1) {
   return (uint)CONCAT71(0x1128, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1128, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr);
}
...
/* EditorTexturePreviewPlugin::is_class_ptr(void*) const */uint EditorTexturePreviewPlugin::is_class_ptr(EditorTexturePreviewPlugin *this, void *param_1) {
   return (uint)CONCAT71(0x1128, (undefined4*)param_1 == &EditorResourcePreviewGenerator::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1128, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1128, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1128, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* EditorTexturePreviewPlugin::_getv(StringName const&, Variant&) const */undefined8 EditorTexturePreviewPlugin::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorTexturePreviewPlugin::_setv(StringName const&, Variant const&) */undefined8 EditorTexturePreviewPlugin::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorTexturePreviewPlugin::_validate_propertyv(PropertyInfo&) const */void EditorTexturePreviewPlugin::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* EditorTexturePreviewPlugin::_property_can_revertv(StringName const&) const */undefined8 EditorTexturePreviewPlugin::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* EditorTexturePreviewPlugin::_property_get_revertv(StringName const&, Variant&) const */undefined8 EditorTexturePreviewPlugin::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorTexturePreviewPlugin::_notificationv(int, bool) */void EditorTexturePreviewPlugin::_notificationv(int param_1, bool param_2) {
   return;
}
/* EditorImagePreviewPlugin::is_class_ptr(void*) const */uint EditorImagePreviewPlugin::is_class_ptr(EditorImagePreviewPlugin *this, void *param_1) {
   return (uint)CONCAT71(0x1128, (undefined4*)param_1 == &EditorResourcePreviewGenerator::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1128, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1128, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1128, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* EditorImagePreviewPlugin::_getv(StringName const&, Variant&) const */undefined8 EditorImagePreviewPlugin::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorImagePreviewPlugin::_setv(StringName const&, Variant const&) */undefined8 EditorImagePreviewPlugin::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorImagePreviewPlugin::_validate_propertyv(PropertyInfo&) const */void EditorImagePreviewPlugin::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* EditorImagePreviewPlugin::_property_can_revertv(StringName const&) const */undefined8 EditorImagePreviewPlugin::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* EditorImagePreviewPlugin::_property_get_revertv(StringName const&, Variant&) const */undefined8 EditorImagePreviewPlugin::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorImagePreviewPlugin::_notificationv(int, bool) */void EditorImagePreviewPlugin::_notificationv(int param_1, bool param_2) {
   return;
}
/* EditorBitmapPreviewPlugin::is_class_ptr(void*) const */uint EditorBitmapPreviewPlugin::is_class_ptr(EditorBitmapPreviewPlugin *this, void *param_1) {
   return (uint)CONCAT71(0x1128, (undefined4*)param_1 == &EditorResourcePreviewGenerator::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1127, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1128, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1128, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* EditorBitmapPreviewPlugin::_getv(StringName const&, Variant&) const */undefined8 EditorBitmapPreviewPlugin::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorBitmapPreviewPlugin::_setv(StringName const&, Variant const&) */undefined8 EditorBitmapPreviewPlugin::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorBitmapPreviewPlugin::_validate_propertyv(PropertyInfo&) const */void EditorBitmapPreviewPlugin::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* EditorBitmapPreviewPlugin::_property_can_revertv(StringName const&) const */undefined8 EditorBitmapPreviewPlugin::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* EditorBitmapPreviewPlugin::_property_get_revertv(StringName const&, Variant&) const */undefined8 EditorBitmapPreviewPlugin::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorBitmapPreviewPlugin::_notificationv(int, bool) */void EditorBitmapPreviewPlugin::_notificationv(int param_1, bool param_2) {
   return;
}
/* EditorPackedScenePreviewPlugin::is_class_ptr(void*) const */uint EditorPackedScenePreviewPlugin::is_class_ptr(EditorPackedScenePreviewPlugin *this, void *param_1) {
   return (uint)CONCAT71(0x1128, (undefined4*)param_1 == &EditorResourcePreviewGenerator::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1127, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1128, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1128, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* EditorPackedScenePreviewPlugin::_getv(StringName const&, Variant&) const */undefined8 EditorPackedScenePreviewPlugin::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorPackedScenePreviewPlugin::_setv(StringName const&, Variant const&) */undefined8 EditorPackedScenePreviewPlugin::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorPackedScenePreviewPlugin::_validate_propertyv(PropertyInfo&) const */void EditorPackedScenePreviewPlugin::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* EditorPackedScenePreviewPlugin::_property_can_revertv(StringName const&) const */undefined8 EditorPackedScenePreviewPlugin::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* EditorPackedScenePreviewPlugin::_property_get_revertv(StringName const&, Variant&) const */undefined8 EditorPackedScenePreviewPlugin::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorPackedScenePreviewPlugin::_notificationv(int, bool) */void EditorPackedScenePreviewPlugin::_notificationv(int param_1, bool param_2) {
   return;
}
/* EditorMaterialPreviewPlugin::is_class_ptr(void*) const */uint EditorMaterialPreviewPlugin::is_class_ptr(EditorMaterialPreviewPlugin *this, void *param_1) {
   return (uint)CONCAT71(0x1128, (undefined4*)param_1 == &EditorResourcePreviewGenerator::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1127, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1128, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1128, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* EditorMaterialPreviewPlugin::_getv(StringName const&, Variant&) const */undefined8 EditorMaterialPreviewPlugin::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorMaterialPreviewPlugin::_setv(StringName const&, Variant const&) */undefined8 EditorMaterialPreviewPlugin::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorMaterialPreviewPlugin::_validate_propertyv(PropertyInfo&) const */void EditorMaterialPreviewPlugin::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* EditorMaterialPreviewPlugin::_property_can_revertv(StringName const&) const */undefined8 EditorMaterialPreviewPlugin::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* EditorMaterialPreviewPlugin::_property_get_revertv(StringName const&, Variant&) const */undefined8 EditorMaterialPreviewPlugin::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorMaterialPreviewPlugin::_notificationv(int, bool) */void EditorMaterialPreviewPlugin::_notificationv(int param_1, bool param_2) {
   return;
}
/* EditorScriptPreviewPlugin::is_class_ptr(void*) const */uint EditorScriptPreviewPlugin::is_class_ptr(EditorScriptPreviewPlugin *this, void *param_1) {
   return (uint)CONCAT71(0x1128, (undefined4*)param_1 == &EditorResourcePreviewGenerator::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1127, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1128, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1128, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* EditorScriptPreviewPlugin::_getv(StringName const&, Variant&) const */undefined8 EditorScriptPreviewPlugin::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorScriptPreviewPlugin::_setv(StringName const&, Variant const&) */undefined8 EditorScriptPreviewPlugin::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorScriptPreviewPlugin::_validate_propertyv(PropertyInfo&) const */void EditorScriptPreviewPlugin::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* EditorScriptPreviewPlugin::_property_can_revertv(StringName const&) const */undefined8 EditorScriptPreviewPlugin::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* EditorScriptPreviewPlugin::_property_get_revertv(StringName const&, Variant&) const */undefined8 EditorScriptPreviewPlugin::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorScriptPreviewPlugin::_notificationv(int, bool) */void EditorScriptPreviewPlugin::_notificationv(int param_1, bool param_2) {
   return;
}
/* EditorAudioStreamPreviewPlugin::is_class_ptr(void*) const */uint EditorAudioStreamPreviewPlugin::is_class_ptr(EditorAudioStreamPreviewPlugin *this, void *param_1) {
   return (uint)CONCAT71(0x1128, (undefined4*)param_1 == &EditorResourcePreviewGenerator::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1127, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1128, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1128, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* EditorAudioStreamPreviewPlugin::_getv(StringName const&, Variant&) const */undefined8 EditorAudioStreamPreviewPlugin::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorAudioStreamPreviewPlugin::_setv(StringName const&, Variant const&) */undefined8 EditorAudioStreamPreviewPlugin::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorAudioStreamPreviewPlugin::_validate_propertyv(PropertyInfo&) const */void EditorAudioStreamPreviewPlugin::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* EditorAudioStreamPreviewPlugin::_property_can_revertv(StringName const&) const */undefined8 EditorAudioStreamPreviewPlugin::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* EditorAudioStreamPreviewPlugin::_property_get_revertv(StringName const&, Variant&) const */undefined8 EditorAudioStreamPreviewPlugin::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorAudioStreamPreviewPlugin::_notificationv(int, bool) */void EditorAudioStreamPreviewPlugin::_notificationv(int param_1, bool param_2) {
   return;
}
/* EditorMeshPreviewPlugin::is_class_ptr(void*) const */uint EditorMeshPreviewPlugin::is_class_ptr(EditorMeshPreviewPlugin *this, void *param_1) {
   return (uint)CONCAT71(0x1128, (undefined4*)param_1 == &EditorResourcePreviewGenerator::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1127, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1128, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1128, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* EditorMeshPreviewPlugin::_getv(StringName const&, Variant&) const */undefined8 EditorMeshPreviewPlugin::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorMeshPreviewPlugin::_setv(StringName const&, Variant const&) */undefined8 EditorMeshPreviewPlugin::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorMeshPreviewPlugin::_validate_propertyv(PropertyInfo&) const */void EditorMeshPreviewPlugin::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* EditorMeshPreviewPlugin::_property_can_revertv(StringName const&) const */undefined8 EditorMeshPreviewPlugin::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* EditorMeshPreviewPlugin::_property_get_revertv(StringName const&, Variant&) const */undefined8 EditorMeshPreviewPlugin::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorMeshPreviewPlugin::_notificationv(int, bool) */void EditorMeshPreviewPlugin::_notificationv(int param_1, bool param_2) {
   return;
}
/* EditorFontPreviewPlugin::is_class_ptr(void*) const */uint EditorFontPreviewPlugin::is_class_ptr(EditorFontPreviewPlugin *this, void *param_1) {
   return (uint)CONCAT71(0x1128, (undefined4*)param_1 == &EditorResourcePreviewGenerator::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1127, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1128, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1128, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* EditorFontPreviewPlugin::_getv(StringName const&, Variant&) const */undefined8 EditorFontPreviewPlugin::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorFontPreviewPlugin::_setv(StringName const&, Variant const&) */undefined8 EditorFontPreviewPlugin::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorFontPreviewPlugin::_validate_propertyv(PropertyInfo&) const */void EditorFontPreviewPlugin::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* EditorFontPreviewPlugin::_property_can_revertv(StringName const&) const */undefined8 EditorFontPreviewPlugin::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* EditorFontPreviewPlugin::_property_get_revertv(StringName const&, Variant&) const */undefined8 EditorFontPreviewPlugin::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorFontPreviewPlugin::_notificationv(int, bool) */void EditorFontPreviewPlugin::_notificationv(int param_1, bool param_2) {
   return;
}
/* EditorGradientPreviewPlugin::is_class_ptr(void*) const */uint EditorGradientPreviewPlugin::is_class_ptr(EditorGradientPreviewPlugin *this, void *param_1) {
   return (uint)CONCAT71(0x1128, (undefined4*)param_1 == &EditorResourcePreviewGenerator::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1127, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1128, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1128, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* EditorGradientPreviewPlugin::_getv(StringName const&, Variant&) const */undefined8 EditorGradientPreviewPlugin::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorGradientPreviewPlugin::_setv(StringName const&, Variant const&) */undefined8 EditorGradientPreviewPlugin::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorGradientPreviewPlugin::_validate_propertyv(PropertyInfo&) const */void EditorGradientPreviewPlugin::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* EditorGradientPreviewPlugin::_property_can_revertv(StringName const&) const */undefined8 EditorGradientPreviewPlugin::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* EditorGradientPreviewPlugin::_property_get_revertv(StringName const&, Variant&) const */undefined8 EditorGradientPreviewPlugin::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorGradientPreviewPlugin::_notificationv(int, bool) */void EditorGradientPreviewPlugin::_notificationv(int param_1, bool param_2) {
   return;
}
...
/* EditorResourcePreviewGenerator::DrawRequester::~DrawRequester() */void EditorResourcePreviewGenerator::DrawRequester::~DrawRequester(DrawRequester *this) {
   int iVar1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void FUN_00108cf6(void) {
   code *pcVar1;
   _DAT_00000000 = 0;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
...
/* EditorImagePreviewPlugin::_get_class_namev() const */undefined8 *EditorImagePreviewPlugin::_get_class_namev(void) {
   int iVar1;
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00108e63:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00108e63;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorImagePreviewPlugin");
         goto LAB_00108ece;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorImagePreviewPlugin");
   LAB_00108ece:return &_get_class_namev();
}
/* EditorTexturePreviewPlugin::_get_class_namev() const */undefined8 *EditorTexturePreviewPlugin::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00108f53:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00108f53;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorTexturePreviewPlugin");
         goto LAB_00108fbe;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorTexturePreviewPlugin");
   LAB_00108fbe:return &_get_class_namev();
}
/* EditorGradientPreviewPlugin::_get_class_namev() const */undefined8 *EditorGradientPreviewPlugin::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00109043:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00109043;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorGradientPreviewPlugin");
         goto LAB_001090ae;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorGradientPreviewPlugin");
   LAB_001090ae:return &_get_class_namev();
}
...
/* EditorScriptPreviewPlugin::_get_class_namev() const */undefined8 *EditorScriptPreviewPlugin::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001092f3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001092f3;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorScriptPreviewPlugin");
         goto LAB_0010935e;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorScriptPreviewPlugin");
   LAB_0010935e:return &_get_class_namev();
}
/* EditorBitmapPreviewPlugin::_get_class_namev() const */undefined8 *EditorBitmapPreviewPlugin::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001093e3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001093e3;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorBitmapPreviewPlugin");
         goto LAB_0010944e;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorBitmapPreviewPlugin");
   LAB_0010944e:return &_get_class_namev();
}
/* EditorPackedScenePreviewPlugin::_get_class_namev() const */undefined8 *EditorPackedScenePreviewPlugin::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001094e3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001094e3;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorPackedScenePreviewPlugin");
         goto LAB_0010954e;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorPackedScenePreviewPlugin");
   LAB_0010954e:return &_get_class_namev();
}
/* EditorMaterialPreviewPlugin::_get_class_namev() const */undefined8 *EditorMaterialPreviewPlugin::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001095d3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001095d3;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorMaterialPreviewPlugin");
         goto LAB_0010963e;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorMaterialPreviewPlugin");
   LAB_0010963e:return &_get_class_namev();
}
/* EditorFontPreviewPlugin::_get_class_namev() const */undefined8 *EditorFontPreviewPlugin::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001096c3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001096c3;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorFontPreviewPlugin");
         goto LAB_0010972e;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorFontPreviewPlugin");
   LAB_0010972e:return &_get_class_namev();
}
/* EditorAudioStreamPreviewPlugin::_get_class_namev() const */undefined8 *EditorAudioStreamPreviewPlugin::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001097c3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001097c3;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorAudioStreamPreviewPlugin");
         goto LAB_0010982e;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorAudioStreamPreviewPlugin");
   LAB_0010982e:return &_get_class_namev();
}
/* EditorMeshPreviewPlugin::_get_class_namev() const */undefined8 *EditorMeshPreviewPlugin::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001098b3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001098b3;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorMeshPreviewPlugin");
         goto LAB_0010991e;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorMeshPreviewPlugin");
   LAB_0010991e:return &_get_class_namev();
}
/* EditorAudioStreamPreviewPlugin::~EditorAudioStreamPreviewPlugin() */void EditorAudioStreamPreviewPlugin::~EditorAudioStreamPreviewPlugin(EditorAudioStreamPreviewPlugin *this) {
   bool bVar1;
   ...
   *(code**)this = FileAccess::exists;
   ...
   LAB_00109a11:*(undefined***)this = &PTR__initialize_classv_001114a8;
   Object::~Object((Object*)this);
   return;
}
/* EditorScriptPreviewPlugin::~EditorScriptPreviewPlugin() */void EditorScriptPreviewPlugin::~EditorScriptPreviewPlugin(EditorScriptPreviewPlugin *this) {
   ...
   *(code**)this = FileAccess::exists;
   ...
   LAB_00109ae1:*(undefined***)this = &PTR__initialize_classv_001114a8;
   Object::~Object((Object*)this);
   return;
}
/* EditorGradientPreviewPlugin::~EditorGradientPreviewPlugin() */void EditorGradientPreviewPlugin::~EditorGradientPreviewPlugin(EditorGradientPreviewPlugin *this) {
   ...
   *(code**)this = FileAccess::exists;
   ...
   LAB_00109bb1:*(undefined***)this = &PTR__initialize_classv_001114a8;
   Object::~Object((Object*)this);
   return;
}
/* EditorPackedScenePreviewPlugin::~EditorPackedScenePreviewPlugin() */void EditorPackedScenePreviewPlugin::~EditorPackedScenePreviewPlugin(EditorPackedScenePreviewPlugin *this) {
   ...
   *(code**)this = FileAccess::exists;
   ...
   LAB_00109c81:*(undefined***)this = &PTR__initialize_classv_001114a8;
   Object::~Object((Object*)this);
   return;
}
/* EditorBitmapPreviewPlugin::~EditorBitmapPreviewPlugin() */void EditorBitmapPreviewPlugin::~EditorBitmapPreviewPlugin(EditorBitmapPreviewPlugin *this) {
   ...
   *(code**)this = FileAccess::exists;
   ...
   LAB_00109d51:*(undefined***)this = &PTR__initialize_classv_001114a8;
   Object::~Object((Object*)this);
   return;
}
/* EditorImagePreviewPlugin::~EditorImagePreviewPlugin() */void EditorImagePreviewPlugin::~EditorImagePreviewPlugin(EditorImagePreviewPlugin *this) {
   ...
   *(code**)this = FileAccess::exists;
   ...
   LAB_00109e21:*(undefined***)this = &PTR__initialize_classv_001114a8;
   Object::~Object((Object*)this);
   return;
}
/* EditorTexturePreviewPlugin::~EditorTexturePreviewPlugin() */void EditorTexturePreviewPlugin::~EditorTexturePreviewPlugin(EditorTexturePreviewPlugin *this) {
   ...
   *(code**)this = FileAccess::exists;
   ...
   LAB_00109ef1:*(undefined***)this = &PTR__initialize_classv_001114a8;
   Object::~Object((Object*)this);
   return;
}
/* EditorGradientPreviewPlugin::~EditorGradientPreviewPlugin() */void EditorGradientPreviewPlugin::~EditorGradientPreviewPlugin(EditorGradientPreviewPlugin *this) {
   ...
   *(code**)this = FileAccess::exists;
   ...
   LAB_00109fc1:*(undefined***)this = &PTR__initialize_classv_001114a8;
   Object::~Object((Object*)this);
...
/* EditorTexturePreviewPlugin::~EditorTexturePreviewPlugin() */void EditorTexturePreviewPlugin::~EditorTexturePreviewPlugin(EditorTexturePreviewPlugin *this) {
   ...
   *(code**)this = FileAccess::exists;
   ...
   LAB_0010a0a1:*(undefined***)this = &PTR__initialize_classv_001114a8;
   Object::~Object((Object*)this);
   operator_delete(this, 0x1f8);
   return;
}
/* EditorAudioStreamPreviewPlugin::~EditorAudioStreamPreviewPlugin() */void EditorAudioStreamPreviewPlugin::~EditorAudioStreamPreviewPlugin(EditorAudioStreamPreviewPlugin *this) {
   ...
   *(code**)this = FileAccess::exists;
   ...
   LAB_0010a181:*(undefined***)this = &PTR__initialize_classv_001114a8;
   Object::~Object((Object*)this);
   operator_delete(this, 0x1f8);
   return;
}
/* EditorBitmapPreviewPlugin::~EditorBitmapPreviewPlugin() */void EditorBitmapPreviewPlugin::~EditorBitmapPreviewPlugin(EditorBitmapPreviewPlugin *this) {
   ...
   *(code**)this = FileAccess::exists;
   ...
   LAB_0010a261:*(undefined***)this = &PTR__initialize_classv_001114a8;
   Object::~Object((Object*)this);
   operator_delete(this, 0x1f8);
   return;
}
/* EditorImagePreviewPlugin::~EditorImagePreviewPlugin() */void EditorImagePreviewPlugin::~EditorImagePreviewPlugin(EditorImagePreviewPlugin *this) {
   ...
   *(code**)this = FileAccess::exists;
   ...
   LAB_0010a341:*(undefined***)this = &PTR__initialize_classv_001114a8;
   Object::~Object((Object*)this);
   operator_delete(this, 0x1f8);
   return;
}
/* EditorScriptPreviewPlugin::~EditorScriptPreviewPlugin() */void EditorScriptPreviewPlugin::~EditorScriptPreviewPlugin(EditorScriptPreviewPlugin *this) {
   ...
   *(code**)this = FileAccess::exists;
   ...
   LAB_0010a421:*(undefined***)this = &PTR__initialize_classv_001114a8;
   Object::~Object((Object*)this);
   operator_delete(this, 0x1f8);
   return;
}
/* EditorPackedScenePreviewPlugin::~EditorPackedScenePreviewPlugin() */void EditorPackedScenePreviewPlugin::~EditorPackedScenePreviewPlugin(EditorPackedScenePreviewPlugin *this) {
   ...
   *(code**)this = FileAccess::exists;
   ...
   LAB_0010a501:*(undefined***)this = &PTR__initialize_classv_001114a8;
   Object::~Object((Object*)this);
   operator_delete(this, 0x1f8);
   return;
}
...
/* Object::is_class(String const&) const */ulong Object::is_class(Object *this, String *param_1) {
   ...
   do {
      if (lVar2 == 0) {
         ...
         LAB_0010a6bf:/* WARNING: Subroutine does not return */__stack_chk_fail();
      }
 ...
 while ( !bVar8 );
      ...
      LAB_0010a5d3:uVar5 = String::operator ==(param_1, (String*)&local_50);
      lVar3 = local_50;
      if (local_50 != 0) {
         LOCK();
         plVar1 = (long*)( local_50 + -0x10 );
...
/* EditorMeshPreviewPlugin::get_class() const */void EditorMeshPreviewPlugin::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* EditorResourcePreviewGenerator::~EditorResourcePreviewGenerator() */void EditorResourcePreviewGenerator::~EditorResourcePreviewGenerator(EditorResourcePreviewGenerator *this) {
   ...
   *(code**)this = FileAccess::exists;
   ...
   LAB_0010a911:*(undefined***)this = &PTR__initialize_classv_001114a8;
   Object::~Object((Object*)this);
   return;
}
/* EditorResourcePreviewGenerator::~EditorResourcePreviewGenerator() */void EditorResourcePreviewGenerator::~EditorResourcePreviewGenerator(EditorResourcePreviewGenerator *this) {
   ...
   *(code**)this = FileAccess::exists;
   ...
   LAB_0010ae11:*(undefined***)this = &PTR__initialize_classv_001114a8;
   Object::~Object((Object*)this);
   operator_delete(this, 0x1f8);
   return;
}
...
/* EditorGradientPreviewPlugin::get_class() const */void EditorGradientPreviewPlugin::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* EditorFontPreviewPlugin::get_class() const */void EditorFontPreviewPlugin::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* EditorAudioStreamPreviewPlugin::get_class() const */void EditorAudioStreamPreviewPlugin::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* EditorScriptPreviewPlugin::get_class() const */void EditorScriptPreviewPlugin::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* EditorMaterialPreviewPlugin::get_class() const */void EditorMaterialPreviewPlugin::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* EditorPackedScenePreviewPlugin::get_class() const */void EditorPackedScenePreviewPlugin::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* EditorBitmapPreviewPlugin::get_class() const */void EditorBitmapPreviewPlugin::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* EditorImagePreviewPlugin::get_class() const */void EditorImagePreviewPlugin::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* EditorTexturePreviewPlugin::get_class() const */void EditorTexturePreviewPlugin::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* EditorTexturePreviewPlugin::_initialize_classv() */void EditorTexturePreviewPlugin::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_60;
   undefined8 local_58;
   long local_50;
   ...
   local_30 = *(long*)( in_FS_OFFSET + 0x28 );
   if (initialize_class() == '\0') {
      if (EditorResourcePreviewGenerator::initialize_class() == '\0') {
...
/* EditorImagePreviewPlugin::_initialize_classv() */void EditorImagePreviewPlugin::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_60;
   undefined8 local_58;
   long local_50;
...
/* EditorBitmapPreviewPlugin::_initialize_classv() */void EditorBitmapPreviewPlugin::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_60;
   undefined8 local_58;
   long local_50;
...
/* EditorPackedScenePreviewPlugin::_initialize_classv() */void EditorPackedScenePreviewPlugin::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_60;
   undefined8 local_58;
   long local_50;
...
/* EditorMaterialPreviewPlugin::_initialize_classv() */void EditorMaterialPreviewPlugin::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_60;
   undefined8 local_58;
   long local_50;
...
/* EditorScriptPreviewPlugin::_initialize_classv() */void EditorScriptPreviewPlugin::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_60;
   undefined8 local_58;
   long local_50;
...
/* EditorAudioStreamPreviewPlugin::_initialize_classv() */void EditorAudioStreamPreviewPlugin::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_60;
   undefined8 local_58;
   long local_50;
...
/* EditorMeshPreviewPlugin::_initialize_classv() */void EditorMeshPreviewPlugin::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_60;
   undefined8 local_58;
   long local_50;
...
/* EditorFontPreviewPlugin::_initialize_classv() */void EditorFontPreviewPlugin::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_60;
   undefined8 local_58;
   long local_50;
...
/* EditorGradientPreviewPlugin::_initialize_classv() */void EditorGradientPreviewPlugin::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_60;
   undefined8 local_58;
   long local_50;
...
/* PropertyListHelper::~PropertyListHelper() */void PropertyListHelper::~PropertyListHelper(PropertyListHelper *this) {
 ...
 while ( lVar4 != (ulong)uVar2 << 2 );
   ...
   LAB_0010ce46:CowData<char32_t>::_unref((CowData<char32_t>*)this);
   return;
}
/* RefCounted::is_class(String const&) const */undefined8 RefCounted::is_class(RefCounted *this, String *param_1) {
   ...
   if (cVar5 == '\0') {
      ...
      LAB_0010cf9b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* EditorResourcePreviewGenerator::is_class(String const&) const */undefined8 EditorResourcePreviewGenerator::is_class(EditorResourcePreviewGenerator *this, String *param_1) {
 ...
 while ( !bVar8 );
      ...
      LAB_0010d10f:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
...
/* EditorGradientPreviewPlugin::is_class(String const&) const */undefined8 EditorGradientPreviewPlugin::is_class(EditorGradientPreviewPlugin *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *__s;
   long lVar3;
 ...
 while ( !bVar8 );
      ...
      LAB_0010d28f:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         uVar7 = EditorResourcePreviewGenerator::is_class((EditorResourcePreviewGenerator*)this, param_1);
         return uVar7;
      }

   }
 else {
      LAB_0010d343:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* EditorFontPreviewPlugin::is_class(String const&) const */undefined8 EditorFontPreviewPlugin::is_class(EditorFontPreviewPlugin *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *__s;
   long lVar3;
 ...
 while ( !bVar8 );
      ...
      LAB_0010d40f:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
...
/* EditorMeshPreviewPlugin::is_class(String const&) const */undefined8 EditorMeshPreviewPlugin::is_class(EditorMeshPreviewPlugin *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *__s;
   long lVar3;
 ...
 while ( !bVar8 );
      ...
      LAB_0010d58f:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_0010d643:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* EditorAudioStreamPreviewPlugin::is_class(String const&) const */undefined8 EditorAudioStreamPreviewPlugin::is_class(EditorAudioStreamPreviewPlugin *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *__s;
   long lVar3;
   ...
   if (cVar4 == '\0') {
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         uVar5 = EditorResourcePreviewGenerator::is_class((EditorResourcePreviewGenerator*)this, param_1);
         return uVar5;
      }

   }
 else {
      LAB_0010d79b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* EditorScriptPreviewPlugin::is_class(String const&) const */undefined8 EditorScriptPreviewPlugin::is_class(EditorScriptPreviewPlugin *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *__s;
   long lVar3;
 ...
 while ( !bVar8 );
      ...
      LAB_0010d85f:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_0010d913:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* EditorMaterialPreviewPlugin::is_class(String const&) const */undefined8 EditorMaterialPreviewPlugin::is_class(EditorMaterialPreviewPlugin *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *__s;
   long lVar3;
 ...
 while ( !bVar8 );
      ...
      LAB_0010d9df:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_0010da93:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* EditorPackedScenePreviewPlugin::is_class(String const&) const */undefined8 EditorPackedScenePreviewPlugin::is_class(EditorPackedScenePreviewPlugin *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *__s;
   long lVar3;
 ...
 while ( !bVar8 );
      ...
      LAB_0010db5f:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_0010dc13:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* EditorBitmapPreviewPlugin::is_class(String const&) const */undefined8 EditorBitmapPreviewPlugin::is_class(EditorBitmapPreviewPlugin *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *__s;
   long lVar3;
 ...
 while ( !bVar8 );
      ...
      LAB_0010dcdf:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_0010dd93:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* EditorImagePreviewPlugin::is_class(String const&) const */undefined8 EditorImagePreviewPlugin::is_class(EditorImagePreviewPlugin *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *__s;
   long lVar3;
 ...
 while ( !bVar8 );
      ...
      LAB_0010de5f:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_0010df13:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* EditorTexturePreviewPlugin::is_class(String const&) const */undefined8 EditorTexturePreviewPlugin::is_class(EditorTexturePreviewPlugin *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *__s;
   long lVar3;
 ...
 while ( !bVar8 );
      ...
      LAB_0010dfdf:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_0010e093:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* RefCounted::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void RefCounted::_get_property_listv(List *param_1, bool param_2) {
   ...
   LAB_0010e24c:List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)CONCAT71(in_register_00000031, param_2), (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
...
/* EditorResourcePreviewGenerator::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool)
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_0010e4b1:local_b0 = (CowData<char32_t>*)&local_58;
...
/* EditorGradientPreviewPlugin::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool)
   const */void EditorGradientPreviewPlugin::_get_property_listv(EditorGradientPreviewPlugin *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   CowData<char32_t> *local_b0;
   long local_98;
   long local_90;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (!param_2) {
      EditorResourcePreviewGenerator::_get_property_listv((EditorResourcePreviewGenerator*)this, param_1, false);
   }
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_0010e761:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
   ...
   if (param_2) {
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         EditorResourcePreviewGenerator::_get_property_listv((EditorResourcePreviewGenerator*)this, param_1, true);
         return;
      }
...
/* EditorFontPreviewPlugin::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const
    */void EditorFontPreviewPlugin::_get_property_listv(EditorFontPreviewPlugin *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   CowData<char32_t> *local_b0;
   long local_98;
   long local_90;
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_0010ea11:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* EditorAudioStreamPreviewPlugin::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool)
   const */void EditorAudioStreamPreviewPlugin::_get_property_listv(EditorAudioStreamPreviewPlugin *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   CowData<char32_t> *local_b0;
   long local_98;
   long local_90;
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_0010ecc1:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* EditorScriptPreviewPlugin::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const
    */void EditorScriptPreviewPlugin::_get_property_listv(EditorScriptPreviewPlugin *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   CowData<char32_t> *local_b0;
   long local_98;
   long local_90;
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_0010ef71:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* EditorMaterialPreviewPlugin::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool)
   const */void EditorMaterialPreviewPlugin::_get_property_listv(EditorMaterialPreviewPlugin *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   CowData<char32_t> *local_b0;
   long local_98;
   long local_90;
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_0010f221:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* EditorBitmapPreviewPlugin::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const
    */void EditorBitmapPreviewPlugin::_get_property_listv(EditorBitmapPreviewPlugin *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   CowData<char32_t> *local_b0;
   long local_98;
   long local_90;
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_0010f4d1:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* EditorTexturePreviewPlugin::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool)
   const */void EditorTexturePreviewPlugin::_get_property_listv(EditorTexturePreviewPlugin *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   CowData<char32_t> *local_b0;
   long local_98;
   long local_90;
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_0010f781:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* EditorPackedScenePreviewPlugin::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool)
   const */void EditorPackedScenePreviewPlugin::_get_property_listv(EditorPackedScenePreviewPlugin *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   CowData<char32_t> *local_b0;
   long local_98;
   long local_90;
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_0010fa31:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* EditorMeshPreviewPlugin::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const
    */void EditorMeshPreviewPlugin::_get_property_listv(EditorMeshPreviewPlugin *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   CowData<char32_t> *local_b0;
   long local_98;
   long local_90;
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_0010fce1:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* EditorImagePreviewPlugin::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const
    */void EditorImagePreviewPlugin::_get_property_listv(EditorImagePreviewPlugin *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   CowData<char32_t> *local_b0;
   long local_98;
   long local_90;
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_0010ff91:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Vector3>::resize<false>(long) */undefined8 CowData<Vector3>::resize<false>(CowData<Vector3> *this, long param_1) {
   ...
   if (param_1 * 0xc == 0) {
      LAB_001106f0:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (lVar7 == lVar3) {
      LAB_0011065c:puVar9 = *(undefined8**)this;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Vector2>::resize<false>(long) */undefined8 CowData<Vector2>::resize<false>(CowData<Vector2> *this, long param_1) {
   ...
   if (param_1 * 8 == 0) {
      LAB_00110a10:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (lVar7 == lVar3) {
      LAB_0011097c:puVar9 = *(undefined8**)this;
      if (puVar9 == (undefined8*)0x0) {
         /* WARNING: Does not return */
         pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<float>::resize<false>(long) */undefined8 CowData<float>::resize<false>(CowData<float> *this, long param_1) {
   ...
   if (param_1 * 4 == 0) {
      LAB_001110a0:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
/* WARNING: Control flow encountered bad instruction data *//* EditorTexturePreviewPlugin::~EditorTexturePreviewPlugin() */void EditorTexturePreviewPlugin::~EditorTexturePreviewPlugin(EditorTexturePreviewPlugin *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* EditorImagePreviewPlugin::~EditorImagePreviewPlugin() */void EditorImagePreviewPlugin::~EditorImagePreviewPlugin(EditorImagePreviewPlugin *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* EditorBitmapPreviewPlugin::~EditorBitmapPreviewPlugin() */void EditorBitmapPreviewPlugin::~EditorBitmapPreviewPlugin(EditorBitmapPreviewPlugin *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* EditorPackedScenePreviewPlugin::~EditorPackedScenePreviewPlugin() */void EditorPackedScenePreviewPlugin::~EditorPackedScenePreviewPlugin(EditorPackedScenePreviewPlugin *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* EditorGradientPreviewPlugin::~EditorGradientPreviewPlugin() */void EditorGradientPreviewPlugin::~EditorGradientPreviewPlugin(EditorGradientPreviewPlugin *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* EditorScriptPreviewPlugin::~EditorScriptPreviewPlugin() */void EditorScriptPreviewPlugin::~EditorScriptPreviewPlugin(EditorScriptPreviewPlugin *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* EditorAudioStreamPreviewPlugin::~EditorAudioStreamPreviewPlugin() */void EditorAudioStreamPreviewPlugin::~EditorAudioStreamPreviewPlugin(EditorAudioStreamPreviewPlugin *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* EditorResourcePreviewGenerator::DrawRequester::~DrawRequester() */void EditorResourcePreviewGenerator::DrawRequester::~DrawRequester(DrawRequester *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

/* AtlasTexture::get_rid() const */

undefined8 __thiscall AtlasTexture::get_rid(AtlasTexture *this)
...
/* AtlasTexture::has_alpha() const */

undefined8 __thiscall AtlasTexture::has_alpha(AtlasTexture *this)
...
/* AtlasTexture::get_region() const */

undefined1  [16] __thiscall AtlasTexture::get_region(AtlasTexture *this)
...
/* AtlasTexture::get_margin() const */

undefined1  [16] __thiscall AtlasTexture::get_margin(AtlasTexture *this)
...
/* AtlasTexture::has_filter_clip() const */

AtlasTexture __thiscall AtlasTexture::has_filter_clip(AtlasTexture *this)
...

{
  ...
  if (param_1[0x5d] != 0) {
    ...
    if (cVar1 != '\0') {
      (**(code **)(*(long *)param_1[0x5d] + 0x200))
                ((long *)param_1[0x5d],param_2,&local_68,&local_58,param_5,param_6,
                 (char)param_1[0x62]);
    }
  }
...
/* AtlasTexture::is_pixel_opaque(int, int) const */

undefined8 __thiscall AtlasTexture::is_pixel_opaque(AtlasTexture *this,int param_1,int param_2)
  ...
  if (-1 < iVar3) {
    ...
    if ((-1 < iVar4) && (iVar3 < iVar1)) {
      ...
      if (iVar4 < iVar1) {
                    ...
                    /* WARNING: Treating indirect jump as call */
        uVar2 = (**(code **)(**(long **)(this + 0x2e8) + 0x1e0))
                          (*(long **)(this + 0x2e8),iVar3,iVar4);
        return uVar2;
      }
    }
  }
...
/* AtlasTexture::set_filter_clip(bool) */

void __thiscall AtlasTexture::set_filter_clip(AtlasTexture *this,bool param_1)
...
/* AtlasTexture::get_width() const */

int __thiscall AtlasTexture::get_width(AtlasTexture *this)
...
/* AtlasTexture::get_height() const */

int __thiscall AtlasTexture::get_height(AtlasTexture *this)
...
/* AtlasTexture::set_margin(Rect2 const&) */

void __thiscall AtlasTexture::set_margin(AtlasTexture *this,Rect2 *param_1)

{
  undefined8 uVar1;
  
  if ((((*(float *)(this + 0x300) == *(float *)param_1) &&
       (*(float *)(this + 0x304) == *(float *)(param_1 + 4))) &&
      (*(float *)(this + 0x308) == *(float *)(param_1 + 8))) &&
     (*(float *)(this + 0x30c) == *(float *)(param_1 + 0xc))) {
    return;
  }
...
/* AtlasTexture::set_region(Rect2 const&) */

void __thiscall AtlasTexture::set_region(AtlasTexture *this,Rect2 *param_1)

{
  undefined8 uVar1;
  
  if ((((*(float *)(this + 0x2f0) == *(float *)param_1) &&
       (*(float *)(this + 0x2f4) == *(float *)(param_1 + 4))) &&
      (*(float *)(this + 0x2f8) == *(float *)(param_1 + 8))) &&
     (*(float *)(this + 0x2fc) == *(float *)(param_1 + 0xc))) {
    return;
  }
  uVar1 = *(undefined8 *)(param_1 + 8);
...
/* AtlasTexture::draw_rect(RID, Rect2 const&, bool, Color const&, bool) const */

void __thiscall
AtlasTexture::draw_rect
          (AtlasTexture *this,undefined8 param_2,undefined8 param_3,undefined8 param_4,
          undefined8 param_5,undefined1 param_6)

{
  ...
  if (*(long **)(this + 0x2e8) != (long *)0x0) {
    ...
    if (cVar1 != '\0') {
      (**(code **)(**(long **)(this + 0x2e8) + 0x200))
                (*(long **)(this + 0x2e8),param_2,&local_68,&local_58,param_5,param_6,this[0x310]);
    }
  }
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
...
/* AtlasTexture::get_atlas() const */

void AtlasTexture::get_atlas(void)
...
/* AtlasTexture::_get_region_rect() const */

undefined8 __thiscall AtlasTexture::_get_region_rect(AtlasTexture *this)
...
/* AtlasTexture::draw(RID, Vector2 const&, Color const&, bool) const */

void __thiscall
AtlasTexture::draw(AtlasTexture *this,undefined8 param_2,undefined8 *param_3,undefined8 param_4,
                  undefined1 param_5)

{
  ...
  if (*(long *)(this + 0x2e8) != 0) {
    ...
    local_48 = CONCAT44((float)((ulong)*param_3 >> 0x20) +
                        (float)((ulong)*(undefined8 *)(this + 0x300) >> 0x20),
                        (float)*param_3 + (float)*(undefined8 *)(this + 0x300));
    (**(code **)(**(long **)(this + 0x2e8) + 0x200))
              (*(long **)(this + 0x2e8),param_2,&local_48,local_58,param_4,param_5,this[0x310]);
  }
...
/* AtlasTexture::get_rect_region(Rect2 const&, Rect2 const&, Rect2&, Rect2&) const */

undefined8 __thiscall
AtlasTexture::get_rect_region
          (AtlasTexture *this,Rect2 *param_1,Rect2 *param_2,Rect2 *param_3,Rect2 *param_4)

{
  ...
  if (*(long **)(this + 0x2e8) != (long *)0x0) {
    ...
    fVar1 = ((float)*(undefined8 *)(this + 0x2f0) - (float)*(undefined8 *)(this + 0x300)) +
            (float)local_58;
    fVar3 = ((float)((ulong)*(undefined8 *)(this + 0x2f0) >> 0x20) -
            (float)((ulong)*(undefined8 *)(this + 0x300) >> 0x20)) +
    ...
    if ((fVar5 != 0.0) || (fVar4 != 0.0)) {
      ...
      *(ulong *)param_3 =
           CONCAT44(fVar3 * fVar6 + *(float *)(param_1 + 4),fVar1 * fVar7 + *(float *)param_1);
...
/* AtlasTexture::get_image() const */

void AtlasTexture::get_image(void)
...
void __thiscall AtlasTexture::AtlasTexture(AtlasTexture *this)
...
/* AtlasTexture::set_atlas(Ref<Texture2D> const&) */

void __thiscall AtlasTexture::set_atlas(AtlasTexture *this,Ref *param_1)

{
  ...
  if (this == (AtlasTexture *)pOVar5) {
    if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
      _err_print_error("set_atlas","scene/resources/atlas_texture.cpp",0x48,
                       "Condition \"p_atlas == this\" is true.",0,0);
      return;
    }
    goto LAB_00100f52;
  }
...
LAB_00100d50:
      ...
      if (cVar3 != '\0') {
        ...
        create_custom_callable_function_pointer<Resource>
                  (aRStack_48,(char *)this,(_func_void *)"&AtlasTexture::emit_changed");
...
LAB_00100d3b:
        if (pOVar6 == (Object *)0x0) goto LAB_00100d88;
        goto LAB_00100d40;
      }
    }
    if (((pOVar6 != (Object *)0x0) &&
        (pOVar5 = (Object *)__dynamic_cast(pOVar6,&Object::typeinfo,&typeinfo,0),
...
/* AtlasTexture::_bind_methods() */

void AtlasTexture::_bind_methods(void)
...
{
  return (uint)CONCAT71(0x10bb,(undefined4 *)param_1 == &Resource::get_class_ptr_static()::ptr) |
...
/* AtlasTexture::is_class_ptr(void*) const */

uint AtlasTexture::is_class_ptr(void *param_1)

{
  ...
  return (uint)CONCAT71(0x10ba,in_RSI == &Texture2D::get_class_ptr_static()::ptr) |
         ...
         (uint)CONCAT71(0x10bb,in_RSI == &Resource::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x10bb,in_RSI == &RefCounted::get_class_ptr_static()::ptr) |
         CONCAT31((int3)((uint)in_EDX >> 8),in_RSI == &Object::get_class_ptr_static()::ptr);
}



/* AtlasTexture::_getv(StringName const&, Variant&) const */

undefined8 AtlasTexture::_getv(StringName *param_1,Variant *param_2)
...
/* AtlasTexture::_setv(StringName const&, Variant const&) */

undefined8 AtlasTexture::_setv(StringName *param_1,Variant *param_2)
...
/* AtlasTexture::_validate_propertyv(PropertyInfo&) const */

void AtlasTexture::_validate_propertyv(PropertyInfo *param_1)
...
/* AtlasTexture::_property_can_revertv(StringName const&) const */

undefined8 AtlasTexture::_property_can_revertv(StringName *param_1)
...
/* AtlasTexture::_property_get_revertv(StringName const&, Variant&) const */

undefined8 AtlasTexture::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* AtlasTexture::_notificationv(int, bool) */

void AtlasTexture::_notificationv(int param_1,bool param_2)
...
/* CallableCustomMethodPointer<Resource, void>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<Resource,void>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<Resource,void> *this)
...
/* CallableCustomMethodPointer<Resource, void>::get_argument_count(bool&) const */

undefined8 __thiscall
CallableCustomMethodPointer<Resource,void>::get_argument_count
          (CallableCustomMethodPointer<Resource,void> *this,bool *param_1)
...
/* CallableCustomMethodPointer<Resource, void>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<Resource,void>::get_object
          (CallableCustomMethodPointer<Resource,void> *this)
...
/* AtlasTexture::get_base_extension() const */

AtlasTexture * __thiscall AtlasTexture::get_base_extension(AtlasTexture *this)
...
/* AtlasTexture::_get_class_namev() const */

undefined8 * AtlasTexture::_get_class_namev(void)
...
LAB_00103343:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      goto LAB_00103343;
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"AtlasTexture");
      goto LAB_001033ae;
    }
  }
  StringName::assign_static_unique_class_name
...
/* AtlasTexture::get_class() const */

void AtlasTexture::get_class(void)
...
void __thiscall
CallableCustomMethodPointer<Resource,void>::call
          (CallableCustomMethodPointer<Resource,void> *this,Variant **param_1,int param_2,
...
/* AtlasTexture::is_class(String const&) const */

undefined8 __thiscall AtlasTexture::is_class(AtlasTexture *this,String *param_1)
...
/* AtlasTexture::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void __thiscall AtlasTexture::_get_property_listv(AtlasTexture *this,List *param_1,bool param_2)
...
Resource *
create_custom_callable_function_pointer<Resource>
          (Resource *param_1,char *param_2,_func_void *param_3)
...
/* MethodBind* create_method_bind<AtlasTexture, Ref<Texture2D> const&>(void
   (AtlasTexture::*)(Ref<Texture2D> const&)) */

MethodBind * create_method_bind<AtlasTexture,Ref<Texture2D>const&>(_func_void_Ref_ptr *param_1)
...
MethodBind * create_method_bind<AtlasTexture,Ref<Texture2D>>(_func_Ref *param_1)
...
/* MethodBind* create_method_bind<AtlasTexture, Rect2>(Rect2 (AtlasTexture::*)() const) */

MethodBind * create_method_bind<AtlasTexture,Rect2>(_func_Rect2 *param_1)
...
/* MethodBind* create_method_bind<AtlasTexture, bool>(void (AtlasTexture::*)(bool)) */

MethodBind * create_method_bind<AtlasTexture,bool>(_func_void_bool *param_1)
...
/* MethodBind* create_method_bind<AtlasTexture, bool>(bool (AtlasTexture::*)() const) */

MethodBind * create_method_bind<AtlasTexture,bool>(_func_bool *param_1)
...
/* AtlasTexture::_bind_methods() [clone .cold] */
...
/* AtlasTexture::_initialize_classv() */

void AtlasTexture::_initialize_classv(void)
...
/* WARNING: Removing unreachable block (ram,0x00107ba8) */
/* WARNING: Removing unreachable block (ram,0x00107cd8) */
/* WARNING: Removing unreachable block (ram,0x00107ea0) */
/* WARNING: Removing unreachable block (ram,0x00107ce4) */
/* WARNING: Removing unreachable block (ram,0x00107cee) */
/* WARNING: Removing unreachable block (ram,0x00107e80) */
/* WARNING: Removing unreachable block (ram,0x00107cfa) */
/* WARNING: Removing unreachable block (ram,0x00107d04) */
/* WARNING: Removing unreachable block (ram,0x00107e60) */
/* WARNING: Removing unreachable block (ram,0x00107d10) */
/* WARNING: Removing unreachable block (ram,0x00107d1a) */
/* WARNING: Removing unreachable block (ram,0x00107e40) */
/* WARNING: Removing unreachable block (ram,0x00107d26) */
/* WARNING: Removing unreachable block (ram,0x00107d30) */
/* WARNING: Removing unreachable block (ram,0x00107e20) */
/* WARNING: Removing unreachable block (ram,0x00107d3c) */
/* WARNING: Removing unreachable block (ram,0x00107d46) */
...
/* WARNING: Removing unreachable block (ram,0x00107d64) */
/* WARNING: Removing unreachable block (ram,0x00107d7a) */
/* WARNING: Removing unreachable block (ram,0x00107d86) */
  ...
  *(undefined1 (*) [16])(param_1 + 8) = (undefined1  [16])0x0;
  if (((plVar7 != (long *)0x0) && (plVar7[1] != 0)) && (*(char *)(plVar7[1] + 0x2e) != '\0')) {
    ...
    if (local_58 == (char *)*plVar6) {
      ...
      _err_print_error(&_LC18,"./core/object/method_bind.h",0x267,
...

{
  ...
  if (((plVar10 != (long *)0x0) && (plVar10[1] != 0)) && (*(char *)(plVar10[1] + 0x2e) != '\0')) {
    ...
    if (local_58 == (char *)*plVar8) {
      ...
      String::parse_latin1((StrRange *)&local_60);
      vformat<StringName>((StringName *)&local_58,(StrRange *)&local_60,&local_68);
      _err_print_error(&_LC18,"./core/object/method_bind.h",0x154,

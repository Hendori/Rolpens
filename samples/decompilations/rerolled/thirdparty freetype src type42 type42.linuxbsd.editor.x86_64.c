...
void t42_parse_encoding(long param_1, ulong *param_2) {
   ...
   if (pbVar13 < pbVar4) {
      ...
      if (( 9 < ( byte )(bVar2 - 0x30) ) && ( bVar2 != 0x5b )) {
         if (( pbVar13 + 0x11 < pbVar4 ) && ( iVar7 = strncmp((char*)pbVar13, "StandardEncoding", 0x10) ),iVar7 == 0) {
            *(undefined4*)( param_1 + 0x220 ) = 2;
         }
 else if (( pbVar13 + 0xf < pbVar4 ) && ( iVar7 = strncmp((char*)pbVar13, "ExpertEncoding", 0xe) ),iVar7 == 0) {
            *(undefined4*)( param_1 + 0x220 ) = 4;
         }
 else if (( pbVar13 + 0x12 < pbVar4 ) && ( iVar7 = strncmp((char*)pbVar13, "ISOLatin1Encoding", 0x11) ),iVar7 == 0) {
         ...
         *(undefined8*)( param_1 + 0x238 ) = uVar9;
         if (local_44 == 0) {
            ...
            *(undefined8*)( param_1 + 0x240 ) = uVar9;
            if (( local_44 == 0 ) && ( local_44 = ( **(code**)*puVar3 )(puVar1, local_74, uVar10) ),local_44 == 0) {
               if (0 < local_74) {
                  iVar7 = 0;
                  do {
                     iVar11 = iVar7 + 1;

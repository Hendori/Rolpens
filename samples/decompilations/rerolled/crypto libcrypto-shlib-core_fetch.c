undefined8 ossl_method_construct_reserve_store(int param_1, long param_2) {
   ...
   for (int i_1857 = 0; i_1857 < 2; i_1857++) {
   ...
   for (int i_1858 = 0; i_1858 < 2; i_1858++) {
      /* WARNING: Could not recover jumptable at 0x00100077. Too many branches */
   }
   ( **(code**)( *(long*)( param_1 + 0x18 ) + 0x10 ) )(*(undefined8*)( param_1 + 8 ), *(undefined8*)( param_1 + 0x20 ));
   return;
}void ossl_method_construct_this(undefined8 param_1, undefined8 *param_2, int param_3, long param_4) {
   long lVar1;
   undefined8 uVar2;
   lVar1 = ( **(code**)( *(long*)( param_4 + 0x18 ) + 0x28 ) )(param_2, param_1, *(undefined8*)( param_4 + 0x20 ));
   if (lVar1 != 0) {
      uVar2 = 0;
      if (param_3 != 0) {
         uVar2 = *(undefined8*)( param_4 + 8 );
      }
      ( **(code**)( *(long*)( param_4 + 0x18 ) + 0x20 ) )(uVar2, lVar1, param_1, *param_2, param_2[1], *(undefined8*)( param_4 + 0x20 ));
      for (int i_1859 = 0; i_1859 < 2; i_1859++) {
   ...
   return;
}bool ossl_method_construct_postcondition(undefined8 param_1, int param_2, int param_3, long param_4, undefined4 *param_5) {
   int iVar1;
   ...
   *param_5 = 1;
   ...
   return iVar1 != 0;
}undefined8 ossl_method_construct_precondition(undefined8 param_1, int param_2, int param_3, long param_4, uint *param_5) {
   uint uVar1;
   int iVar2;
   if (param_5 == (uint*)0x0) {
      ERR_new();
   ...
   *param_5 = uVar1;
   return 1;
}void ossl_method_construct(undefined8 param_1, undefined8 param_2, undefined8 *param_3, undefined4 param_4, long param_5, undefined8 param_6) {
   long lVar1;
   undefined8 uVar2;
   long in_FS_OFFSET;
   ...
   local_30 = param_5;
   local_28 = param_6;
   ossl_algorithm_do_all(param_1, param_2, uVar2, ossl_method_construct_precondition, 0x100000, ossl_method_construct_this, ossl_method_construct_unreserve_store, ossl_method_construct_postcondition, local_48);
   if (local_40 != 0) {
      lVar1 = ( **(code**)( param_5 + 0x18 ) )(local_40, param_3, param_6);
      if (lVar1 != 0) goto LAB_001002b6;
   }
   ( **(code**)( param_5 + 0x18 ) )(0, param_3, param_6);
   LAB_001002b6:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }

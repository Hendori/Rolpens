...
uint ft_lzwstate_get_code(long param_1) {
   ...
   if (*(char*)( param_1 + 0x20 ) != '\0') {
      ...
      LAB_001001a8:*(undefined4*)( param_1 + 0x3c ) = 9;
      uVar5 = 9;
   ...
   if (uVar2 < *(uint*)( param_1 + 0x1c )) {
      ...
      LAB_00100136:*(uint*)( param_1 + 0x18 ) = uVar1;
      ...
      if (uVar1 < uVar8) {
         LAB_001000da:if (*(int*)( param_1 + 4 ) == 0) {
            lVar10 = param_1 + 8;
            uVar3 = FT_Stream_TryRead(*(undefined8*)( param_1 + 200 ), lVar10, *(undefined4*)( param_1 + 0x3c ));
...
undefined8 ft_lzwstate_stack_grow(long param_1) {
   ...
   if (uVar1 <= *(uint*)( param_1 + 0x78 )) {
      ...
      if (*(long*)( param_1 + 0x70 ) == param_1 + 0x88) {
         ...
         *(undefined8**)( param_1 + 0x70 ) = puVar2;
         ...
         LAB_00100307:uVar3 = *(undefined8*)( param_1 + 0x90 );
         *puVar2 = *(undefined8*)( param_1 + 0x88 );
         puVar2[1] = uVar3;
         for (int i = 0; i < 3; i++) {
            uVar3 = *(undefined8*)( param_1 + ( 16*i + 160 ) );
            puVar2[( 2*i + 2 )] = *(undefined8*)( param_1 + ( 16*i + 152 ) );
            puVar2[( 2*i + 3 )] = uVar3;
         }
         ...
         puVar2 = (undefined8*)ft_mem_qrealloc(*(undefined8*)( param_1 + 0xd0 ), 1, uVar1, uVar4, *(long*)( param_1 + 0x70 ), &local_34);
         *(undefined8**)( param_1 + 0x70 ) = puVar2;
         if (local_34 != 0) {
            LAB_00100335:uVar3 = 0xffffffff;
            goto LAB_001002b2;
         }
   ...
   uVar3 = 0;
   LAB_001002b2:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar3;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int FT_Stream_OpenLZW(undefined1 (*param_1)[16], long param_2) {
   undefined8 uVar1;
   long lVar2;
   undefined8 uVar3;
   int iVar4;
         ...
         *param_1 = (undefined1[16])0x0;
         ...
         if (local_44 == 0) {
            ...
            *plVar5 = param_2;
            ...
            for (uVar6 = ( ulong )(( (int)plVar5 - (int)(undefined8*)( ( ulong )(plVar5 + 4) & 0xfffffffffffffff8 ) ) + 0xf0U >> 3); uVar6 != 0; uVar6 = uVar6 - 1) {
               *puVar7 = 0;
   ...
   LAB_00100416:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar8;
   }
...
void ft_lzwstate_init(undefined8 *param_1, long param_2) {
   ...
   *param_1 = 0;
   ...
   for (uVar2 = ( ulong )(( (int)param_1 - (int)(undefined8*)( ( ulong )(param_1 + 1) & 0xfffffffffffffff8 ) ) + 0xd8U >> 3); uVar2 != 0; uVar2 = uVar2 - 1) {
      *puVar3 = 0;
      puVar3 = puVar3 + 1;
   }
...
long ft_lzwstate_io(int *param_1, undefined1 *param_2, long param_3) {
   ...
   iVar2 = *param_1;
   if (iVar2 == 1) {
      LAB_0010076d:while (uVar3 = ft_lzwstate_get_code(param_1),-1 < (int)uVar3) {
         if (uVar3 == 0x100) {
            if (param_1[0xd] == 0) {
               if (param_1[0x10] == 0) {
                  LAB_00100a40:uVar4 = param_1[0x1e];
                  uVar8 = (ulong)uVar4;
               ...
               LAB_00100943:lVar6 = *(long*)( param_1 + 0x16 );
               do {
                  ...
                  *(undefined1*)( *(long*)( param_1 + 0x1c ) + uVar8 ) = *(undefined1*)( *(long*)( param_1 + 0x18 ) + ( ulong )(uVar3 - 0x100) );
 ...
 while ( 0xff < uVar1 );
            ...
            *param_1 = 2;
            LAB_001007b5:while (param_1[0x1e] != 0) {
...
;
            ...
            if (uVar3 < (uint)param_1[0xe]) {
               ...
               if (uVar4 <= uVar3) {
                  ...
                  lVar6 = ft_mem_realloc(*(undefined8*)( param_1 + 0x34 ), 3, uVar8, uVar10, *(undefined8*)( param_1 + 0x16 ), &local_44);
...
;
   ...
   LAB_00100700:param_1[0x12] = uVar9;

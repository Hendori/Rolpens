                     ...
                     if (cVar6 == '\0') {
                        *(undefined8*)( this + 3000 ) = 0;
                        if (pOVar9 != (Object*)0x0) {
                           cVar6 = RefCounted::unreference();
                           joined_r0x001046bf:if (( cVar6 != '\0' ) && ( cVar6 = predelete_handler(pOVar9) ),cVar6 != '\0') goto LAB_00104773;
                        }
...
LAB_0010a541:
   ...
   if (lVar36 == 0) {
      ...
      if (( pOVar25 == (Object*)0x0 ) || ( cVar15 = RefCounted::reference() ),cVar15 == '\0') goto LAB_0010bc40;
      if (this[0xac8] == (AnimationBezierTrackEdit)0x0) {
         ...
         *(undefined8*)( this + 0xb14 ) = uVar50;
         ...
         CanvasItem::queue_redraw();
         if (( ( ( *(int*)( this + 0xb00 ) + 1U & 0xfffffffd ) != 0 ) || ( local_2d0 == (Object*)0x0 ) ) || ( cVar15 = InputEvent::is_pressed() ),cVar15 != '\0') goto LAB_0010b9a6;

   ...
   *(void**)( param_7 + 0x60 ) = pvVar4;
   if (pvVar4 == (void*)0x0) {
      ...
      *(undefined8*)( param_7 + 8 ) = *param_1;
      for (int i_1279 = 0; i_1279 < 4; i_1279++) {
         *(undefined8*)( param_7 + ( 16*i_1279 + 16 ) ) = uVar6;
         uVar6 = param_1[( 2*i_1279 + 3 )];
         *(undefined8*)( param_7 + ( 16*i_1279 + 24 ) ) = param_1[( 2*i_1279 + 2 )];
      }
         ...
         if (iVar1 != 0) {
            ...
            if (iVar1 != 0) {
               ...
               if (iVar1 == 0) {
                  ...
                  for (int i_1280 = 0; i_1280 < 2; i_1280++) {
                     pBStack_80 = local_b0;
                  }

undefined8 append_buf(undefined8 *param_1, int *param_2, char *param_3) {
      ...
      if (iVar1 < 1) {
         ...
         if (*param_2 < iVar2) {
            ...
            *param_2 = iVar2;
            pcVar4 = (char*)CRYPTO_realloc(pcVar4, iVar2, "apps/engine.c", 0x48);
            if (pcVar4 == (char*)0x0) {
               LAB_001000d6:CRYPTO_free((void*)*param_1);
               *param_1 = 0;
               return 0;
            }
            *param_1 = pcVar4;
   ...
   if (iVar1 < 0) {
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         ...
         LAB_001003b2:BIO_printf(param_3, pcVar3);
         return;
      }
   } else {
      iVar5 = 0;
      if (iVar1 != 0) {
         do {
            while (true) {
               ...
               LAB_00100328:BIO_printf(param_3, "[Success]: %s\n", pcVar3);
               iVar5 = iVar5 + 1;
               if (iVar1 == iVar5) goto LAB_00100349;
            };
            iVar2 = ENGINE_ctrl_cmd_string(param_1, pcVar3, (char*)0x0, 0);
            if (iVar2 != 0) goto LAB_00100328;
            LAB_00100290:BIO_printf(param_3, "[Failure]: %s\n", pcVar3);
            iVar5 = iVar5 + 1;
            ERR_print_errors(param_3);
         } while ( iVar1 != iVar5 );
      }
      LAB_00100349:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   }
   LAB_001003ec:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int engine_main(int param_1, undefined8 *param_2) {
   undefined8 uVar1;
   bool bVar2;
   int iVar3;
   int iVar4;
   ...
   LAB_001005b8:local_cc = 1;
   goto LAB_00100618;
   joined_r0x00100551:if (pcVar14 != (char*)0x0) {
      if (*pcVar14 == '-') {
         BIO_printf(_bio_err, "%s: Cannot mix flags and engine names.\n", uVar1);
         switchD_00100510_caseD_ffffffff:BIO_printf(_bio_err, "%s: Use -help for summary.\n", uVar1);
      } else {
   ...
   goto LAB_00100685;
   LAB_00101039:local_a0 = (void*)0x0;
   LAB_00100e37:OPENSSL_sk_free(lVar17);
   CRYPTO_free(local_b0);
   CRYPTO_free(local_a0);
   goto LAB_00100618;
   code_r0x0010056c:pcVar14 = (char*)puVar12[1];
   puVar12 = puVar12 + 1;
   goto joined_r0x00100551;
   LAB_00100685:iVar4 = OPENSSL_sk_num(lVar9);
   if (iVar4 == 0) {
   ...
   for (iVar4 = 0; iVar5 = OPENSSL_sk_num(lVar9),iVar4 < iVar5; iVar4 = iVar4 + 1) {
      ...
      if (pEVar15 != (ENGINE*)0x0) {
         ...
         if (bVar2) {
            ...
            if (( ( ( ( ( pRVar18 != (RSA_METHOD*)0x0 ) && ( iVar5 = append_buf(&local_78, &local_7c, &_LC13) ),iVar5 == 0 ) ) || ( ( lVar26 = ENGINE_get_EC(pEVar15) ),lVar26 != 0 && ( iVar5 = append_buf(&local_78, &local_7c, &_LC14) ),iVar5 == 0 ) ) )) ( ( pDVar19 = ENGINE_get_DSA(pEVar15) ),pDVar19 != (DSA_METHOD*)0x0 && ( iVar5 = append_buf(&local_78, &local_7c, &_LC15) ),iVar5 == 0 ) || ( ( pDVar20 = ENGINE_get_DH(pEVar15) ),pDVar20 != (DH_METHOD*)0x0 && ( iVar5 = append_buf(&local_78, &local_7c, &_LC16) ),iVar5 == 0 ) || ( ( pRVar21 = ENGINE_get_RAND(pEVar15) ),pRVar21 != (RAND_METHOD*)0x0 && ( iVar5 = append_buf(&local_78, &local_7c, &_LC17) ),iVar5 == 0 );
            pEVar22 = ENGINE_get_ciphers(pEVar15);
            if (( pEVar22 != (ENGINE_CIPHERS_PTR)0x0 ) && ( iVar5 = ( *pEVar22 )(pEVar15, (EVP_CIPHER**)0x0, &local_70, 0) ),0 < iVar5) {
               lVar26 = 0;
               do {
            ...
            if (( pEVar23 != (ENGINE_DIGESTS_PTR)0x0 ) && ( iVar5 = ( *pEVar23 )(pEVar15, (EVP_MD**)0x0, &local_70, 0) ),0 < iVar5) {
               lVar26 = 0;
               do {
                  pcVar14 = OBJ_nid2sn(*(int*)( (long)local_70 + lVar26 ));
                  iVar8 = append_buf(&local_78, &local_7c, pcVar14);
            ...
            if (( pEVar24 != (ENGINE_PKEY_METHS_PTR)0x0 ) && ( iVar5 = ( *pEVar24 )(pEVar15, (EVP_PKEY_METHOD**)0x0, &local_70, 0) ),0 < iVar5) {
               lVar26 = 0;
               do {
                  pcVar14 = OBJ_nid2sn(*(int*)( (long)local_70 + lVar26 ));
                  iVar8 = append_buf(&local_78, &local_7c, pcVar14);
         ...
         if (( iVar28 < 1 ) || ( iVar5 = ENGINE_ctrl(pEVar15, 10, 0, (void*)0x0, (f*)0x0) ),iVar5 == 0) {
            LAB_001009c2:ENGINE_free(pEVar15);
            goto LAB_001009ca;
         }
         ...
         if (lVar17 != 0) {
            if (iVar28 == 1) {
               ...
               do {
                  ...
                  if (( iVar28 < 4 ) && ( ( uVar6 & 8 ) != 0 )) {
                     ...
                     if (iVar5 == 0) {
                        BIO_puts(bio, "     ");
                        LAB_001008d3:local_a0 = (void*)0x0;
                     } else {
                        ...
                        if (uVar6 == 0) {
                           ...
                           if (( uVar6 & 1 ) == 0) {
                              if (( uVar6 & 2 ) == 0) {
                                 ...
                                 LAB_0010108d:if (uVar27 == 0) goto LAB_0010097f;
                                 BIO_printf(bio, "|");
                              }
            ...
            OPENSSL_sk_free();
            for (int i_1620 = 0; i_1620 < 2; i_1620++) {
               CRYPTO_free((void*)0);
            }
            goto LAB_001009c2;
         }
         LAB_00100e2c:local_b0 = (char*)0x0;
         local_a0 = (void*)0x0;
         goto LAB_00100e37;
      }
   ...
   LAB_00100618:ERR_print_errors(_bio_err);

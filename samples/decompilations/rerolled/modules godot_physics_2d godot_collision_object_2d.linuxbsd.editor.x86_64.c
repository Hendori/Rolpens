/* CowData<GodotCollisionObject2D::Shape>::_copy_on_write() [clone .isra.0] */void CowData<GodotCollisionObject2D::Shape>::_copy_on_write(CowData<GodotCollisionObject2D::Shape> *this) {
   ...
   return;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotCollisionObject2D::_update_shapes() [clone .part.0] */void GodotCollisionObject2D::_update_shapes(GodotCollisionObject2D *this) {
   long lVar1;
   undefined4 uVar2;
   long lVar3;
   undefined8 *puVar4;
   ...
   if (lVar3 != 0) {
      ...
      do {
         ...
         CowData<GodotCollisionObject2D::Shape>::_copy_on_write((CowData<GodotCollisionObject2D::Shape>*)( this + 0x38 ));
         lVar3 = *(long*)( this + 0x38 );
         lVar1 = lVar3 + lVar7;
         if (*(char*)( lVar1 + 0x50 ) == '\0') {
            ...
            fVar10 = (float)( (double)( *(float*)( lVar1 + 0x3c ) + *(float*)( lVar1 + 0x40 ) ) * __LC8 * __LC9 );
   ...
   __stack_chk_fail();
}/* GodotCollisionObject2D::_shape_changed() */void GodotCollisionObject2D::_shape_changed(GodotCollisionObject2D *this) {
   if (*(long*)( this + 0x40 ) != 0) {
      _update_shapes(this);
   }
   for (int i_1219 = 0; i_1219 < 2; i_1219++) {
      /* WARNING: Could not recover jumptable at 0x0010054f. Too many branches */
   }
   ( **(code**)( *(long*)this + 0x20 ) )(this);
   return;
}/* GodotCollisionObject2D::set_shape(int, GodotShape2D*) */void GodotCollisionObject2D::set_shape(GodotCollisionObject2D *this, int param_1, GodotShape2D *param_2) {
   ...
   lVar5 = 0;
   LAB_0010060d:_err_print_index_error("set_shape", "modules/godot_physics_2d/godot_collision_object_2d.cpp", 0x35, lVar3, lVar5, "p_index", "shapes.size()", "", false, false);
   return;
}/* GodotCollisionObject2D::set_shape_transform(int, Transform2D const&) */void GodotCollisionObject2D::set_shape_transform(GodotCollisionObject2D *this, int param_1, Transform2D *param_2) {
   GodotCollisionObject2D *pGVar1;
   undefined8 *puVar2;
   long lVar3;
   code *pcVar4;
   ...
   if (param_1 < 0) {
      ...
      if (lVar8 < lVar7) {
         ...
         *(undefined8*)( lVar7 + 0x10 + lVar6 ) = *(undefined8*)( param_2 + 0x10 );
         ...
         if (*(long*)( this + 0x38 ) == 0) {
            lVar7 = 0;
            LAB_001008a3:_err_print_index_error("operator[]", "./core/templates/vector.h", 0x38, lVar8, lVar7, "p_index", "((Vector<T> *)(this))->_cowdata.size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
   ...
   _err_print_index_error("set_shape_transform", "modules/godot_physics_2d/godot_collision_object_2d.cpp", 0x41, lVar8, lVar7, "p_index", "shapes.size()", "", false, false);
   LAB_001007dc:if (lVar3 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* GodotCollisionObject2D::set_shape_disabled(int, bool) */void GodotCollisionObject2D::set_shape_disabled(GodotCollisionObject2D *this, int param_1, bool param_2) {
   GodotCollisionObject2D *pGVar1;
   long *plVar2;
   long lVar3;
   long lVar4;
   ...
   if (param_1 < 0) {
      ...
      if (lVar4 < lVar3) {
         ...
         if (( (bool)*(char*)( lVar3 + 0x50 ) != param_2 ) && ( lVar4 = *(long*)( this + 0x40 ) ),*(bool*)( lVar3 + 0x50 ) = param_2,lVar4 != 0) {
            if (param_2) {
               if (*(int*)( lVar3 + 0x30 ) == 0) {
                  return;
               }
   ...
   lVar3 = 0;
   LAB_00100a11:_err_print_index_error("set_shape_disabled", "modules/godot_physics_2d/godot_collision_object_2d.cpp", 0x4c, lVar4, lVar3, "p_idx", "shapes.size()", "", false, false);
   return;
}/* GodotCollisionObject2D::_set_static(bool) */void GodotCollisionObject2D::_set_static(GodotCollisionObject2D *this, bool param_1) {
   long lVar1;
   code *pcVar2;
   long lVar3;
   long *plVar4;
   ...
   if (( *(long*)( this + 0x40 ) != 0 ) && ( lVar3 = lVar3 != 0 )) {
      lVar6 = 0;
      lVar5 = 0;
      do {
         while (true) {
            ...
            if (lVar1 <= lVar5) {
               _err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar5, lVar1, "p_index", "size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
               pcVar2 = (code*)invalidInstructionException();
               ( *pcVar2 )();
   ...
   return;
}/* GodotCollisionObject2D::_unregister_shapes() */void GodotCollisionObject2D::_unregister_shapes(GodotCollisionObject2D *this) {
   long lVar1;
   long lVar2;
   long *plVar3;
   long lVar4;
   ...
   return;
}/* GodotCollisionObject2D::_update_shapes() */void GodotCollisionObject2D::_update_shapes(GodotCollisionObject2D *this) {
   if (*(long*)( this + 0x40 ) != 0) {
      _update_shapes(this);
      return;
   }
   return;
}/* GodotCollisionObject2D::_update_shapes_with_motion(Vector2 const&) */void GodotCollisionObject2D::_update_shapes_with_motion(GodotCollisionObject2D *this, Vector2 *param_1) {
   long lVar1;
   undefined4 uVar2;
   undefined8 *puVar3;
   long *plVar4;
   ...
   long local_40;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (( *(long*)( this + 0x40 ) != 0 ) && ( lVar5 = lVar5 != 0 )) {
      lVar7 = 0;
      uVar6 = 0;
      do {
   ...
   return;
}/* GodotCollisionObject2D::_set_space(GodotSpace2D*) */void GodotCollisionObject2D::_set_space(GodotCollisionObject2D *this, GodotSpace2D *param_1) {
   long lVar1;
   ...
   *(GodotSpace2D**)( this + 0x40 ) = param_1;
   ...
   if (( param_1 != (GodotSpace2D*)0x0 ) && ( GodotSpace2D::add_object((GodotCollisionObject2D*)param_1),*(long*)( this + 0x40 ) != 0 )) {
      _update_shapes(this);
      return;
   }
   return;
}/* GodotCollisionObject2D::GodotCollisionObject2D(GodotCollisionObject2D::Type) */void GodotCollisionObject2D::GodotCollisionObject2D(GodotCollisionObject2D *this, undefined4 param_2) {
   undefined8 uVar1;
   ...
   *(undefined1(*) [16])( this + 0x38 ) = (undefined1[16])0x0;
   return;
}/* GodotCollisionObject2D::remove_shape(int) */void GodotCollisionObject2D::remove_shape(GodotCollisionObject2D *this, int param_1) {
   GodotCollisionObject2D *pGVar1;
   code *pcVar2;
   long *plVar3;
   long lVar4;
   ...
   if (param_1 < 0) {
      ...
      while (lVar5 < lVar6) {
         if (*(int*)( lVar4 + 0x30 + lVar5 * 0x58 ) != 0) {
            ...
            if (*(long*)( this + 0x38 ) == 0) {
               lVar4 = 0;
               LAB_001013e3:_err_print_index_error("operator[]", "./core/templates/vector.h", 0x38, lVar5, lVar4, "p_index", "((Vector<T> *)(this))->_cowdata.size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
               pcVar2 = (code*)invalidInstructionException();
               ( *pcVar2 )();
      ...
      lVar5 = lVar7;
      if (lVar6 <= lVar7) {
         LAB_00101390:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar5, lVar6, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
      ...
      if (*(long*)( this + 0x38 ) == 0) {
         ...
         if (lVar7 < lVar4) {
            ...
            if (lVar4 == 0) {
               ...
               if (lVar7 < lVar5) {
                  memmove((void*)( lVar4 + lVar6 ), (void*)( lVar4 + 0x58 + lVar6 ), ( *(long*)( lVar4 + -8 ) - lVar7 ) * 0x58 - 0x58);
               }
            }
            CowData<GodotCollisionObject2D::Shape>::resize<false>((CowData<GodotCollisionObject2D::Shape>*)( this + 0x38 ), lVar5);
            goto LAB_00101507;
         }
      }
      _err_print_index_error("remove_at", "./core/templates/cowdata.h", 0xe4, lVar7, lVar4, "p_index", "size()", "", false, false);
      LAB_00101507:lVar4 = GodotPhysicsServer2D::godot_singleton;
      if (*(long*)( this + 0x88 ) != 0) {
         return;
      }
      pGVar1 = this + 0x88;
   ...
   lVar6 = 0;
   LAB_00101435:_err_print_index_error("remove_shape", "modules/godot_physics_2d/godot_collision_object_2d.cpp", 0x72, lVar7, lVar6, "p_index", "shapes.size()", "", false, false);
   return;
}/* GodotCollisionObject2D::remove_shape(GodotShape2D*) */void GodotCollisionObject2D::remove_shape(GodotCollisionObject2D *this, GodotShape2D *param_1) {
   long lVar1;
   long lVar2;
   int iVar3;
   ...
   return;
}/* GodotCollisionObject2D::add_shape(GodotShape2D*, Transform2D const&, bool) */void GodotCollisionObject2D::add_shape(GodotCollisionObject2D *this, GodotShape2D *param_1, Transform2D *param_2, bool param_3) {
   GodotCollisionObject2D *pGVar1;
   undefined8 *puVar2;
   long lVar3;
   undefined8 uVar4;
   ...
   iVar7 = CowData<GodotCollisionObject2D::Shape>::resize<false>((CowData<GodotCollisionObject2D::Shape>*)( this + 0x38 ), lVar8);
   if (iVar7 == 0) {
      if (*(long*)( this + 0x38 ) == 0) {
         lVar9 = -1;
         lVar8 = 0;
   ...
   LAB_00101807:GodotShape2D::add_owner((GodotShapeOwner2D*)param_1);
   ...
   ( *pcVar1 )();
}/* CowData<GodotCollisionObject2D::Shape>::_realloc(long) */undefined8 CowData<GodotCollisionObject2D::Shape>::_realloc(CowData<GodotCollisionObject2D::Shape> *this, long param_1) {
   undefined8 *puVar1;
   ...
   return 6;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<GodotCollisionObject2D::Shape>::resize<false>(long) */undefined8 CowData<GodotCollisionObject2D::Shape>::resize<false>(CowData<GodotCollisionObject2D::Shape> *this, long param_1) {
   long *plVar1;
   code *pcVar2;
   undefined4 uVar3;
   long lVar4;
   ...
   if (param_1 * 0x58 == 0) {
      LAB_00101f50:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (lVar10 == lVar4) {
      LAB_00101ebc:puVar9 = *(undefined8**)this;

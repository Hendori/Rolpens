void lh_QUIC_LCID_hfn_thunk(undefined8 param_1, code *UNRECOVERED_JUMPTABLE) {
   ...
   ulong uVar1;
   if (( ( ( *(byte*)( param_1 + 0x30 ) & 3 ) != 0 ) && ( uVar1 = *(ulong*)( param_1 + 0x18 ) ),uVar1 < (ulong)param_2[2] )) {
      param_2[1] = uVar1;
      *param_2 = param_1;
   }
   return;
   ...
   for (int i_981 = 0; i_981 < 2; i_981++) {
      /* WARNING: Could not recover jumptable at 0x00100264. Too many branches */
   }
   ( *UNRECOVERED_JUMPTABLE )();
   return;
}void lh_QUIC_LCIDM_CONN_doall_arg_thunk(undefined8 param_1, undefined8 param_2, code *UNRECOVERED_JUMPTABLE) {
   for (int i_982 = 0; i_982 < 2; i_982++) {
   ...
   if (ptr != (void*)0x0) {
      ...
      lVar3 = OPENSSL_LH_set_thunks(uVar2, 0x100000, lh_QUIC_LCID_cfn_thunk, lh_QUIC_LCID_doall_thunk, lh_QUIC_LCID_doall_arg_thunk);
   ...
   **(long**)( (long)param_1 + 0x28 ) = **(long**)( (long)param_1 + 0x28 ) + -1;
   ...
   if (iVar1 != 0) {
      ...
      lVar3 = OPENSSL_LH_set_thunks(uVar2, lh_QUIC_LCIDM_CONN_hfn_thunk, lh_QUIC_LCIDM_CONN_cfn_thunk, lh_QUIC_LCIDM_CONN_doall_thunk, lh_QUIC_LCIDM_CONN_doall_arg_thunk);
      ptr[4] = lVar3;
      if (lVar3 != 0) {
         *ptr = param_1;
         ptr[5] = param_2;
   ...
   lVar3 = ptr[3];
   LAB_0010051c:OPENSSL_LH_free(lVar3);
   ...
   if (( ( ( param_3 != (char*)0x0 ) && ( ( byte )(*param_3 - 8U) < 0xd ) ) && ( ( local_88 = param_2 ),lVar1 = OPENSSL_LH_retrieve(*(undefined8*)( param_1 + 0x20 ), auStack_98),lVar1 != 0 || ( lVar1 = lcidm_upsert_conn_part_0(param_1, param_2) ),lVar1 != 0 ) )) {
   ...
   uVar3 = 0;
   LAB_00100652:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return uVar3;
}undefined8 ossl_quic_lcidm_generate_initial(undefined8 *param_1, undefined8 param_2, undefined8 *param_3) {
   int iVar1;
   long lVar2;
   long lVar3;
   undefined8 uVar4;
   ...
   if (( ( lVar2 != 0 ) || ( lVar2 = lcidm_upsert_conn_part_0(param_1, param_2) ),lVar2 != 0 )) {
      ...
      do {
         lVar5 = lVar5 + -1;
         if (( lVar5 == 0 ) || ( iVar1 = ossl_quic_gen_rand_conn_id(*param_1, param_1[5], param_3) ),iVar1 == 0) goto LAB_001007cc;
         local_68 = *param_3;
   ...
   LAB_001007cc:uVar4 = 0;
   LAB_001007ce:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return uVar4;
}undefined8 ossl_quic_lcidm_generate(undefined8 *param_1, undefined8 param_2, undefined1 (*param_3)[16]) {
   undefined8 uVar1;
   int iVar2;
   long lVar3;
   long lVar4;
   ...
   *param_3 = (undefined1[16])0x0;
   ...
   if (( ( lVar3 != 0 ) || ( lVar3 = lcidm_upsert_conn_part_0(param_1, param_2) ),lVar3 != 0 )) {
      ...
      do {
         lVar6 = lVar6 + -1;
         if (( lVar6 == 0 ) || ( iVar2 = ossl_quic_gen_rand_conn_id(*param_1, param_1[5], param_3 + 1) ),iVar2 == 0) goto LAB_00100904;
   ...
   if (lVar1 == 0) {
      ...
      LAB_001009cb:ptr = *(void**)( lVar1 + 0x18 );
      if (ptr != (void*)0x0) {
   ...
   uVar2 = 0;
   LAB_00100a1b:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar2;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}undefined8 ossl_quic_lcidm_retire(long param_1, undefined8 param_2, undefined8 param_3, byte *param_4, undefined8 *param_5, undefined8 *param_6, undefined4 *param_7) {
   byte bVar1;
   undefined8 uVar2;
   int iVar3;
   long lVar4;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}undefined8 ossl_quic_lcidm_lookup(long param_1, byte *param_2, undefined8 *param_3, undefined8 *param_4) {
   long lVar1;
   undefined8 uVar2;
   long in_FS_OFFSET;
   undefined8 local_58;
   ...
   uVar2 = 0;
   LAB_00100cf2:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar2;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   LAB_00100da0:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar4;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}undefined8 ossl_quic_lcidm_debug_add(long param_1, undefined8 param_2, byte *param_3, undefined8 param_4) {
   long lVar1;
   long lVar2;
   undefined8 uVar3;
   long in_FS_OFFSET;
   ...
   long local_30;
   local_30 = *(long*)( in_FS_OFFSET + 0x28 );
   if (( ( param_3 != (byte*)0x0 ) && ( *param_3 < 0x15 ) ) && ( ( local_88 = param_2 ),lVar1 = OPENSSL_LH_retrieve(*(undefined8*)( param_1 + 0x20 ), auStack_98),lVar1 != 0 || ( lVar1 = lcidm_upsert_conn_part_0(param_1, param_2) ),lVar1 != 0 )) {
      local_68 = *(undefined8*)param_3;
      uStack_60 = ( undefined5 ) * (undefined8*)( param_3 + 8 );
      uStack_5b = ( undefined3 ) * (undefined8*)( param_3 + 0xd );
      uStack_58 = ( undefined5 )(( ulong ) * (undefined8*)( param_3 + 0xd ) >> 0x18);
   ...
   uVar3 = 0;
   LAB_00100f1f:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return uVar3;
   ...
   do {
      ...
      LAB_00101020:iVar4 = iVar4 + -1;
   } while ( iVar4 != 0 );
   uVar3 = 0;
   LAB_00101082:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar3;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();

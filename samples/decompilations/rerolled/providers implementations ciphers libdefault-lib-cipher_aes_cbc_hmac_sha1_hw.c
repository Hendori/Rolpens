void sha1_update(SHA_CTX *param_1, void *param_2, ulong param_3) {
   ...
   return;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 aesni_cbc_hmac_sha1_tls1_multiblock_aad(long param_1, long param_2) {
   long lVar1;
   ushort uVar2;
   uint uVar3;
   uint uVar4;
   ...
   *(uint*)( param_1 + 0x1d8 ) = uVar3;
   if (( ( *(byte*)( param_1 + 0x6c ) & 2 ) != 0 ) && ( 0x301 < ( ushort )(*(ushort*)( lVar1 + 9 ) << 8 | *(ushort*)( lVar1 + 9 ) >> 8) )) {
      ...
      for (int i_557 = 0; i_557 < 12; i_557++) {
         *(undefined8*)( param_1 + ( 8*i_557 + 696 ) ) = *(undefined8*)( param_1 + ( 8*i_557 + 504 ) );
      }
      ...
      *(int*)( param_1 + 0x1d8 ) = iVar5;
      ...
      uVar6 = 1;
      *(uint*)( param_1 + 0x1dc ) = ( ( uVar3 + 0x24 & 0xfffffff0 ) + 0x15 + ( iVar5 << ( bVar8 & 0x1f ) ) ) - iVar5;
   }
   return uVar6;
}int aesni_cbc_hmac_sha1_cipher(long param_1, undefined8 *param_2, undefined8 *param_3, ulong param_4, undefined8 param_5) {
   SHA_CTX *c;
   uchar *md;
   byte *pbVar1;
   long lVar2;
   ...
   *(undefined8*)( param_1 + 0x1b8 ) = 0xffffffffffffffff;
   ...
   if (( *(byte*)( param_1 + 0x6c ) & 2 ) == 0) {
      if (uVar19 != 0xffffffffffffffff) {
         if (CONCAT11(*(undefined1*)( param_1 + 0x1bc + uVar19 ), *(undefined1*)( param_1 + 0x1bd + uVar19 )) < 0x302) {
         ...
         *(undefined8*)( param_1 + 0x2d0 ) = uVar11;
         for (int i_559 = 0; i_559 < 4; i_559++) {
            *(undefined8*)( param_1 + ( 8*i_559 + 728 ) ) = *(undefined8*)( param_1 + ( 8*i_559 + 536 ) );
         }
         ...
         *(undefined8*)( param_1 + 0x310 ) = uVar7;
         ...
         if (uVar19 < 0x140) {
            ...
            do {
               while (true) {
                  ...
                  *(byte*)( param_1 + 0x2d4 + (ulong)uVar20 ) = ~((byte)((ulong)-lVar15 >> 0x38) | bVar3) & 0x80 | *(byte*)( (long)local_c8 + lVar15 + local_b8 ) & bVar3;
                  uVar16 = uVar19;
         ...
         uVar14 = (ulong)uVar13;
         if (uVar13 < 0x40) {
            LAB_0010071b:puVar21 = (undefined8*)( param_1 + 0x2d4 + uVar14 );
            uVar24 = 0x40 - uVar14;
            uVar20 = (uint)uVar24;
            if (uVar20 < 8) {
               if (( uVar24 & 4 ) == 0) {
               ...
               *(undefined8*)( (long)puVar21 + ( ( uVar24 & 0xffffffff ) - 8 ) ) = 0;
               uVar20 = uVar20 + ( (int)puVar21 - (int)( ( ulong )(puVar21 + 1) & 0xfffffffffffffff8 ) ) & 0xfffffff8;
               if (7 < uVar20) {
                  uVar17 = 0;
                  do {
                     uVar24 = (ulong)uVar17;
            ...
            LAB_00100c48:uVar13 = ( uint )(( local_b8 + 8 ) - uVar16 >> 0x20);
            *(uint*)( param_1 + 0x310 ) = *(uint*)( param_1 + 0x310 ) | uVar12 & (int)uVar13 >> 0x1f;
            ...
            for (int i_560 = 0; i_560 < 4; i_560++) {
               *(undefined1(*) [16])( param_1 + ( 16*i_560 + 724 ) ) = (undefined1[16])0;
            }
         }
         *(uint*)( param_1 + 0x310 ) = uVar12;
         ...
         local_60._4_4_ = uVar20 >> 0x18 | ( uVar20 & 0xff0000 ) >> 8 | ( uVar20 & 0xff00 ) << 8 | uVar20 << 0x18;
         local_60._0_4_ = uVar13 >> 0x18 | ( uVar13 & 0xff0000 ) >> 8 | ( uVar13 & 0xff00 ) << 8 | uVar13 << 0x18;
         local_60._12_4_ = uVar26 >> 0x18 | ( uVar26 & 0xff0000 ) >> 8 | ( uVar26 & 0xff00 ) << 8 | uVar26 << 0x18;
         ...
         for (int i_558 = 0; i_558 < 12; i_558++) {
            *(undefined8*)( param_1 + ( 8*i_558 + 696 ) ) = *(undefined8*)( param_1 + ( 8*i_558 + 600 ) );
         }
      ...
      if (uVar19 == 0xffffffffffffffff) {
         if (uVar16 < param_4) {
            ...
            uVar19 = param_4;
            puVar21 = param_3;
            LAB_001009b4:uVar24 = uVar19 - uVar14;
            if (0x3f < uVar24) {
               uStack_d0 = 0x100aee;
               sha1_update(param_1 + 0x2b8, puVar21, uVar16);
               aesni_cbc_sha1_enc(param_3, param_2, uVar24 >> 6, param_1 + 0xc0, param_1 + 0x20, param_1 + 0x2b8, uVar14 + (long)param_3);
         ...
         uVar14 = param_1 + 0x20;
         LAB_00100376:local_c0 = (SHA_CTX*)( param_1 + 0x2b8 );
         ...
         if (param_4 != uVar19) {
            ...
            for (int i_561 = 0; i_561 < 12; i_561++) {
               *(undefined8*)( param_1 + ( 8*i_561 + 696 ) ) = *(undefined8*)( param_1 + ( 8*i_561 + 600 ) );
            }
            sha1_update(local_c0, md, 0x14);
            SHA1_Final(md, local_c0);
            uVar25 = uVar19 + 0x14;
            if (uVar25 < param_4) {
               memset((void*)( (long)param_2 + uVar25 ), ( (uint)param_4 - 1 ) - (int)uVar25 & 0xff, ( param_4 - 0x14 ) - uVar19);
            }
   ...
   LAB_00100480:iVar29 = 1;
   LAB_00100488:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   ...
   *(undefined8*)( param_1 + 0x98 ) = 0x24;
   for (int i_563 = 0; i_563 < 12; i_563++) {
      *(undefined8*)( param_1 + ( 8*i_563 + 600 ) ) = *(undefined8*)( param_1 + ( 8*i_563 + 504 ) );
   }
   for (int i_562 = 0; i_562 < 12; i_562++) {
      *(undefined8*)( param_1 + ( 8*i_562 + 696 ) ) = *(undefined8*)( param_1 + ( 8*i_562 + 504 ) );
   }
   return ~uVar1 >> 0x1f;
   ...
   *(ulong*)( param_2 + 0xd ) = local_508[1];
   ...
   if ((int)uVar31 < 2) {
      ...
      LAB_0010208b:sha1_multi_block(local_100, &local_6c8, 0);
      puVar26 = local_508;
      for (lVar14 = 0x80; lVar14 != 0; lVar14 = lVar14 + -1) {
         *puVar26 = 0;
         puVar26 = puVar26 + (ulong)bVar32 * -2 + 1;
      ...
      do {
         ...
         uVar24 = ( uVar27 | uVar16 >> 0x28 | uVar18 >> 0x18 | uVar7 >> 8 | uVar8 << 8 | uVar9 << 0x18 | uVar10 << 0x28 | uVar11 ) + lVar14;
         *(char*)( (long)puVar26 + 0xc ) = (char)uVar6;
         *puVar26 = uVar24 >> 0x38 | ( uVar24 & 0xff000000000000 ) >> 0x28 | ( uVar24 & 0xff0000000000 ) >> 0x18 | ( uVar24 & 0xff00000000 ) >> 8 | ( uVar24 & 0xff000000 ) << 8 | ( uVar24 & 0xff0000 ) << 0x18 | ( uVar24 & 0xff00 ) << 0x28 | uVar24 << 0x38;
         local_e0[lVar14] = uVar28;
         local_c0[lVar14] = uVar30;
         *(uint*)( puVar26 + 1 ) = ( ( uVar6 & 0xff00 | (uint)bVar17 ) << 8 | (uint)bVar1 ) << 8 | (uint)bVar2;
         puVar21 = *ppuVar22;
         uVar24 = puVar21[1];
      ...
      if (uVar19 < 0x840) {
         ...
         LAB_001012e3:local_778 = local_648;
         local_790 = &local_748;
         uVar29 = uVar19 >> 6;
         do {
            sha1_multi_block(local_100, &local_6c8, param_5);
      ...
      while (true) {
         ...
         lVar15 = __memcpy_chk(puVar26, ( ulong )(uint)(*(int*)( (long)local_740 + lVar14 ) * 0x40) + *(long*)( (long)local_740 + lVar14 + -8 ), (ulong)uVar28, lVar14 * -8 + 0x400);
         *(undefined1*)( (long)local_508 + (ulong)uVar28 + (ulong)uVar29 * 0x80 ) = 0x80;
         uVar19 = uVar19 * 8 + 0x268;
         uVar19 = uVar19 >> 0x18 | ( uVar19 & 0xff0000 ) >> 8 | ( uVar19 & 0xff00 ) << 8 | uVar19 * 0x1000000;
         if (uVar28 < 0x38) {
      ...
      local_508[0] = CONCAT44(uVar30 | uVar4 >> 8 | uVar6 << 8 | uVar20, local_100[0] >> 0x18 | ( local_100[0] & 0xff0000 ) >> 8 | ( local_100[0] & 0xff00 ) << 8 | local_100[0] << 0x18);
      ...
      while (true) {
         ...
         *local_778 = local_778[1];
         ...
         uVar29 = puVar23[0x20];
         *(uint*)( puVar25 + 2 ) = uVar29 >> 0x18 | ( uVar29 & 0xff0000 ) >> 8 | ( uVar29 & 0xff00 ) << 8 | uVar29 << 0x18;
         uVar20 = ~(uVar19 + 0x14) & 0xf;
         uVar29 = uVar20 + 1;
         uVar27 = (ulong)uVar29;
         lVar14 = (ulong)uVar20 * 0x101010101010101;
         *puVar25 = CONCAT44(uVar4 >> 0x18 | ( uVar4 & 0xff0000 ) >> 8 | ( uVar4 & 0xff00 ) << 8 | uVar4 << 0x18, uVar28 >> 0x18 | ( uVar28 & 0xff0000 ) >> 8 | ( uVar28 & 0xff00 ) << 8 | uVar28 << 0x18);
         puVar25[1] = CONCAT44(uVar6 >> 0x18 | ( uVar6 & 0xff0000 ) >> 8 | ( uVar6 & 0xff00 ) << 8 | uVar6 << 0x18, uVar3 >> 0x18 | ( uVar3 & 0xff0000 ) >> 8 | ( uVar3 & 0xff00 ) << 8 | uVar3 << 0x18);
         if (uVar29 < 8) {
            if (( uVar29 & 4 ) == 0) {
   ...
   *(long*)( param_1 + 0x1e8 ) = local_798;
   ...
   if (( *(byte*)( param_1 + 0x6c ) & 2 ) == 0) {
      ...
      *(uint*)( param_1 + 0x1c0 ) = (uint)uVar3;
      ...
      for (int i_564 = 0; i_564 < 12; i_564++) {
         *(undefined8*)( param_1 + ( 8*i_564 + 696 ) ) = *(undefined8*)( param_1 + ( 8*i_564 + 504 ) );
      }
      sha1_update(param_1 + 0x2b8, param_2, 0xd);
      *(long*)( param_1 + 0x1f0 ) = (long)(int)( ( uVar4 + 0x24 & 0xfffffff0 ) - uVar4 );
   }
   return 1;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int aesni_cbc_hmac_sha1_tls1_multiblock_max_bufsize(long param_1) {
   SHA_CTX *c;
   size_t __n;
   char *__src;
   char *pcVar1;
   ...
   OPENSSL_die("assertion failed: ctx->multiblock_max_send_fragment != 0", "providers/implementations/ciphers/cipher_aes_cbc_hmac_sha1_hw.c", 0x2c3);
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void aesni_cbc_hmac_sha1_set_mac_key(long param_1, void *param_2, size_t param_3) {
   SHA_CTX *c;
   long in_FS_OFFSET;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */uint ossl_cipher_capable_aes_cbc_hmac_sha1(void) {

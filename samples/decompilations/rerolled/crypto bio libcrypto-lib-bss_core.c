undefined8 bio_core_new(undefined8 param_1) {
   ...
   if (( lVar1 != 0 ) && ( UNRECOVERED_JUMPTABLE = *(code**)( lVar1 + 0x10 ) ),UNRECOVERED_JUMPTABLE != (code*)0x0) {
      uVar2 = BIO_get_data(param_1);
      for (int i_767 = 0; i_767 < 2; i_767++) {
   ...
   undefined8 uVar2;
   lVar1 = ossl_lib_ctx_get_data(*param_1, 0x11);
   if (( lVar1 != 0 ) && ( UNRECOVERED_JUMPTABLE = *(code**)( lVar1 + 0x18 ) ),UNRECOVERED_JUMPTABLE != (code*)0x0) {
      uVar2 = BIO_get_data(param_1);
      for (int i_768 = 0; i_768 < 2; i_768++) {
   ...
   return 0xffffffff;
}undefined8 bio_core_read_ex(undefined8 *param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4) {
   code *UNRECOVERED_JUMPTABLE;
   undefined8 *puVar1;
   undefined8 uVar2;
   puVar1 = (undefined8*)ossl_lib_ctx_get_data(*param_1, 0x11);
   if (( puVar1 != (undefined8*)0x0 ) && ( UNRECOVERED_JUMPTABLE = (code*)*puVar1 ),UNRECOVERED_JUMPTABLE != (code*)0x0) {
      uVar2 = BIO_get_data(param_1);
      for (int i_769 = 0; i_769 < 2; i_769++) {
   ...
   return 0;
}undefined8 bio_core_write_ex(undefined8 *param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4) {
   code *UNRECOVERED_JUMPTABLE;
   long lVar1;
   undefined8 uVar2;
   lVar1 = ossl_lib_ctx_get_data(*param_1, 0x11);
   if (( lVar1 != 0 ) && ( UNRECOVERED_JUMPTABLE = *(code**)( lVar1 + 8 ) ),UNRECOVERED_JUMPTABLE != (code*)0x0) {
      uVar2 = BIO_get_data(param_1);
      for (int i_770 = 0; i_770 < 2; i_770++) {
...
joined_r0x00100407:
   ...
   iVar1 = param_2[4];
   joined_r0x001003e7:param_2 = param_2 + 4;
   goto joined_r0x00100386;
}

void RSA_bits(long param_1) {
   ...
   int iVar1;
   for (int i_1641 = 0; i_1641 < 2; i_1641++) {
   ...
   int iVar1;
   for (int i_1642 = 0; i_1642 < 2; i_1642++) {
   ...
   int iVar1;
   for (int i_1643 = 0; i_1643 < 2; i_1643++) {
   ...
   int iVar1;
   for (int i_1644 = 0; i_1644 < 2; i_1644++) {
   ...
   *(uint*)( (long)&rsa->mt_blinding + 4 ) = uVar1 & 0xfffffff7 | 0x80;
   ...
   undefined8 uVar5;
   ctx_00 = ctx;
   if (( ctx == (BN_CTX*)0x0 ) && ( ctx_00 = (BN_CTX*)BN_CTX_new_ex(rsa->version) ),ctx_00 == (BN_CTX*)0x0) {
   ...
   if (pBVar2 == (BIGNUM*)0x0) {
      ...
      pBVar2 = rsa->d;
      if (pBVar2 != (BIGNUM*)0x0) {
         LAB_0010012a:pBVar3 = BN_new();
         if (pBVar3 == (BIGNUM*)0x0) {
            ERR_new();
            uVar5 = 0x96;
         } else {
            BN_with_flags(pBVar3, rsa->e, 4);
            pBVar4 = BN_BLINDING_create_param((BN_BLINDING*)0x0, pBVar2, pBVar3, ctx_00, *(bn_mod_exp**)( rsa->engine + 0x30 ), *(BN_MONT_CTX**)( rsa + 1 ));
            BN_free(pBVar3);

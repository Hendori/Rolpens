undefined8 ocsp_resp_cb(SSL *param_1, BIO *param_2) {
   ...
   uVar2 = 1;
   LAB_0010009c:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar2;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}undefined8 next_proto_cb(undefined8 param_1, uchar **param_2, uchar *param_3, byte *param_4, uint param_5, undefined8 *param_6) {
   int iVar1;
   uint uVar2;
   if (c_quiet == 0) {
      uVar2 = 0;
   ...
   *(int*)( param_6 + 2 ) = iVar1;
   return 0;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined4 psk_client_cb(undefined8 param_1, long param_2, char *param_3, uint param_4, void *param_5, uint param_6) {
   uint uVar1;
   void *__src;
   long in_FS_OFFSET;
   undefined4 local_38;
   ...
   local_38 = 0;
   LAB_001002da:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return local_38;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 psk_use_session_cb(undefined8 param_1, long param_2, undefined8 *param_3, size_t *param_4, undefined8 *param_5) {
   undefined *__s;
   int iVar1;
   long lVar2;
   size_t sVar3;
   ...
   if (psksess == (SSL_SESSION*)0x0) {
      ...
      if (ptr == (void*)0x0) {
         ...
         if (lVar2 != 0) {
            ses = SSL_SESSION_new();
            if (( ( ( ses != (SSL_SESSION*)0x0 ) && ( iVar1 = SSL_SESSION_set1_master_key(ses, ptr, local_48) ),iVar1 != 0 ) ) && ( iVar1 = iVar1 != 0 )) {
               CRYPTO_free(ptr);
               goto LAB_001004b1;
            }
            CRYPTO_free(ptr);
      ...
      if (iVar1 == 0) {
         ...
         LAB_001004b1:lVar2 = SSL_SESSION_get0_cipher(ses);
         if (lVar2 != 0) {
            if (( param_2 == 0 ) || ( lVar2 = param_2 == lVar2 )) {
               __s = psk_identity;
               *param_5 = ses;
               *param_3 = __s;
               sVar3 = strlen(__s);
      ...
      LAB_001004fb:SSL_SESSION_free(ses);
   }
   uVar4 = 0;
   LAB_00100505:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return uVar4;
   ...
   *piVar5 = 0;
   ...
   iVar3 = *piVar5;
   *piVar5 = iVar2;
   if (( ( ( uVar6 + 0x7fffffffffffffff < 0xfffffffffffffffe ) || ( iVar3 != 0x22 ) ) && ( local_48 != pbVar4 ) ) && ( ( ppuVar7 = __ctype_b_loc()(*(byte*)( (long)*ppuVar7 + ( ulong ) * local_48 * 2 + 1 ) & 0x20) != 0 && ( *param_2 = uVar6 < 0x100 ) ) )) {
      ...
      if (bVar1 == 0) {
         ...
         do {
            while (pbVar10 = __s,( *(byte*)( (long)*ppuVar5 + uVar8 * 2 + 1 ) & 0x20 ) != 0) {
               LAB_001007ea:uVar8 = (ulong)pbVar10[1];
               __s = pbVar10 + 1;
   ...
   if (psVar9 == (stack_st_X509*)0x0) {
      ...
      if (pXVar10 != (X509*)0x0) {
         ...
         LAB_00100f13:PEM_write_bio_X509(param_1, pXVar10);
         goto LAB_00100f1e;
      }
      LAB_0010124a:pXVar10 = (X509*)0x0;
      ...
      for (uVar22 = 0; iVar3 = OPENSSL_sk_num(psVar9),(int)uVar22 < iVar3; uVar22 = uVar22 + 1) {
         ...
         if (lVar20 != 0) {
            ...
            if (( iVar3 == 0x198 ) && ( iVar3 = EVP_PKEY_get_group_name(lVar20, 0, 0, local_90) ),iVar3 != 0) {
               ...
               LAB_00100e09:iVar3 = X509_get_signature_nid(pXVar10);
               pcVar13 = OBJ_nid2ln(iVar3);
      ...
      LAB_00100f1e:dump_cert_text(param_1, pXVar10);
   }
   ...
   if (( ( pXVar10 == (X509*)0x0 ) || ( iVar3 = SSL_session_reused(param_2) ),iVar3 != 0 )) {
      LAB_00100f8f:pBVar15 = SSL_get_wbio(param_2);
      ...
      LAB_00100fee:BIO_printf(param_1, pcVar21);
      pSVar6 = SSL_get_current_cipher(param_2);
      SSL_CIPHER_get_name(pSVar6);
      pcVar21 = SSL_CIPHER_get_version(pSVar6);
      BIO_printf(param_1, "%s, Cipher is %s\n", pcVar21);
   ...
   LAB_00100982:local_90 = &local_48;
   ...
   if (( pSVar8 != (SSL_SESSION*)0x0 ) && ( keymatexportlabel != (char*)0x0 )) {
      ...
      uVar23 = 0;
      iVar2 = SSL_export_keying_material(param_2, out, (long)(int)keymatexportlen, pcVar21, llen, (uchar*)0x0, 0, 0);
      if (iVar2 < 1) {
   ...
   return;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int new_session_cb(ssl_st *ssl, SSL_SESSION *sess) {
   int iVar1;
   BIO *bp;
   ...
   BIO_printf(bio_c_out, "---\n");
   return 0;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 ssl_servername_cb(SSL *param_1, undefined8 param_2, long param_3) {
   int iVar1;
   char *pcVar2;
   ...
   *(uint*)( puVar2 + -0x1018 ) = ( ( ( (uint)param_4 & 0xff ) << 8 | ( uint )(byte)(param_4 >> 8) ) << 8 | param_2 & 0xff ) << 8 | param_2 >> 8 & 0xff;
   ...
   *(undefined**)( puVar2 + -0x1090 ) = &UNK_001017b9;
   __stack_chk_fail();
}/* WARNING: Type propagation algorithm not settling *//* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int user_data_process(undefined8 *param_1, undefined8 *param_2, long *param_3) {
   char cVar1;
   long lVar2;
   int iVar3;
   int iVar4;
   ...
   if (*(int*)( param_1 + 5 ) != 1) {
            ...
            if (__s[1] != '{') {
               ...
               if (pcVar7 != (char*)0x0) {
                  *pcVar7 = '\0';
                  ...
                  if (iVar4 == 0x304) {
                     ...
                     if (pcVar8 == (char*)0x0) {
                        ...
                        switchD_00101c15_caseD_4:}iVar3 = OPENSSL_strcasecmp(pcVar8, &_LC67);
                        if (iVar3 == 0) {
                           iVar3 = 1;
                        } else {
                        ...
                        joined_r0x00101c6b:if (iVar3 != 0) {
                           iVar3 = 4;
                           goto LAB_00101b73;
                        }
                        LAB_00101b4c:BIO_printf(_bio_err, "ERROR\n");
                        ERR_print_errors(_bio_err);
                     }
                     else{iVar4 = OPENSSL_strcasecmp(pcVar6, "reneg");
                     if (iVar4 == 0) {
                        switchD_00101c15_caseD_3:BIO_printf(_bio_err, "RENEGOTIATING\n");
                        iVar3 = SSL_renegotiate((SSL*)*param_1);
                        goto joined_r0x00101c6b;
                     }
                     LAB_00101bf0:if (iVar3 == -1) {
                        BIO_printf(_bio_err, "UNRECOGNISED COMMAND (IGNORED): %s\n", pcVar6);
                        LAB_00101cf0:iVar3 = 3;
                        goto LAB_00101b73;
                     }
                     switch (iVar3) {
                        default:
                ...
                goto LAB_00101b4c;
                  ...
                  iVar3 = 1;
                  LAB_00101b73:lVar9 = ( param_1[4] + param_1[3] ) - (long)( pcVar7 + ( 1 - param_1[1] ) );
      ...
      LAB_00101800:if (*(int*)( (long)param_1 + 0x2c ) == 0) {
         *param_2 = pcVar7;
         lVar9 = param_1[4];
         *param_3 = lVar9;
         lVar2 = param_1[3];
   ...
   *(undefined1(*) [16])( param_1 + 3 ) = (undefined1[16])0x0;
   ...
   BIO_printf(_bio_err, "KEYUPDATE\n");
   iVar3 = SSL_key_update(*param_1, iVar3);
   joined_r0x00101a56:if (iVar3 != 0) {
      return 4;
   }
   BIO_printf(_bio_err, "ERROR\n");
   ERR_print_errors(_bio_err);
   return 1;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */uint s_client_main(undefined4 param_1, undefined8 param_2) {
   uint uVar1;
   byte bVar2;
   char cVar3;
   byte bVar4;
   ...
   if (( vpm != (X509_VERIFY_PARAM*)0x0 && lVar49 != 0 ) && ( local_2c8 != (char*)0x0 )) {
      ...
      local_518 = 0;
      uVar58 = 0;
      switchD_0010264b_caseD_0:uVar62 = uVar58;
      iVar26 = opt_next();
      if (iVar26 == 0) {
         iVar50 = opt_num_rest();
         if (iVar50 == 1) {
         ...
         pcVar56 = (char*)0x0;
         local_4e8 = (char*)0x0;
         LAB_00102db7:if (( local_510 != (char*)0x0 ) && ( iVar27 = BIO_parse_hostserv(local_510, &local_2c0, &local_2b8) ),iVar27 == 0) {
         ...
         if (local_408 == 0) {
            if (local_550 != (X509*)0x0) {
               local_4f0 = (EVP_PKEY*)load_key(local_550, local_304, 0, local_2b0, local_500, "client certificate private key");
               if (local_4f0 != (EVP_PKEY*)0x0) goto LAB_0010462e;
               LAB_001046bf:local_564 = 1;
               local_558 = 0;
               local_550 = (X509*)0x0;
               local_560 = (SSL_CTX*)0x0;
               goto LAB_0010274d;
            ...
            local_4f0 = (EVP_PKEY*)load_key(local_408, local_304, 0, local_2b0, local_500, "client certificate private key");
            if (local_4f0 == (EVP_PKEY*)0x0) goto LAB_00104560;
            if (local_550 != (X509*)0x0) {
               LAB_0010462e:local_550 = (X509*)load_cert_pass(local_550, local_308, 1, local_2b0, "client certificate");
               if (local_550 == (X509*)0x0) goto LAB_001046bf;
            }
         }
         if (( local_418 != 0 ) && ( iVar27 = load_certs(local_418, 0, &local_2e8, local_2b0, "client certificate chain") ),iVar27 == 0) {
            local_564 = 1;
            local_558 = 0;
            local_560 = (SSL_CTX*)0x0;
            goto LAB_0010274d;
         ...
         if (local_558 != 0) {
            ...
            if (( local_558 == 0 ) || ( iVar27 = iVar27 == 0 )) {
         ...
         if (bio_c_out == (BIO*)0x0) {
            if (( c_quiet == 0 ) || ( c_debug != 0 )) {
               ...
               if (( ( local_480 != 0 ) && ( local_508 == (BIO*)0x0 ) ) && ( local_508 = (BIO*)dup_bio_out(0x8001) ),local_508 == (BIO*)0x0) {
         ...
         if (( local_3e8 != 0 ) && ( iVar27 = iVar27 == 0 )) {
            BIO_printf(_bio_err, "Error using configuration \"%s\"\n", local_3e8);
            goto LAB_00104731;
         }
         if (( ( uVar62 != 0 ) && ( lVar64 = SSL_CTX_ctrl(local_560, 0x7b, (long)(int)uVar62, (void*)0x0) ),lVar64 == 0 )) goto LAB_0010473d;
         if (bVar8) {
            SSL_CTX_set_options(local_560, 0x80);
         }
         if (( local_380 != 0 ) && ( iVar27 = iVar27 == 0 )) {
         ...
         if (( local_440 != 0 ) && ( lVar64 = SSL_CTX_ctrl(local_560, 0x34, (ulong)local_440, (void*)0x0) ),lVar64 == 0) {
            BIO_printf(_bio_err, "%s: Max send fragment size %u is out of permitted range\n", prog, (ulong)local_440);
            goto LAB_0010473d;
         }
         if (( local_43c != 0 ) && ( lVar64 = SSL_CTX_ctrl(local_560, 0x7d, (ulong)local_43c, (void*)0x0) ),lVar64 == 0) {
            BIO_printf(_bio_err, "%s: Split send fragment size %u is out of permitted range\n", prog, (ulong)local_43c);
            goto LAB_0010473d;
         }
         if (( local_450 != 0 ) && ( lVar64 = SSL_CTX_ctrl(local_560, 0x7e, (ulong)local_450, (void*)0x0) ),lVar64 == 0) {
         ...
         if (bVar24 != 0) {
            ...
            if (iVar27 == 0) {
               BIO_printf(_bio_err, "%s: Max Fragment Length code %u is out of permitted values\n", prog, (ulong)(uint)bVar24);
               goto LAB_0010473d;
            }
         }
         iVar27 = ssl_load_stores(local_560, local_3b0, local_3b8, local_3a0, local_358, local_388, local_350, local_558, local_33c, in_R11);
         if (iVar27 == 0) {
         ...
         if (local_3f8 != (char*)0x0) {
            ...
            if (( stackCAs != (stack_st_X509_NAME*)0x0 ) && ( iVar27 = SSL_add_file_cert_subjects_to_stack(stackCAs, local_3f8) ),iVar27 != 0) {
               SSL_CTX_set0_CA_list(local_560, stackCAs);
               goto LAB_00103295;
            }
            OPENSSL_sk_pop_free(stackCAs, &X509_NAME_free);
            pcVar57 = "Error loading CA names\n";
            LAB_00104818:BIO_printf(_bio_err, pcVar57);
            goto LAB_00104731;
         }
         LAB_00103295:if (local_468 != (ENGINE*)0x0) {
         ...
         if (_psk_key == (byte*)0x0) {
            ...
            LAB_001047cd:if (psksess != (SSL_SESSION*)0x0) goto LAB_00103397;
         } else {
            if (c_debug != 0) {
            ...
            if (local_488 == (byte*)0x0) {
               ...
               LAB_0010332c:pBVar35 = BIO_new_file((char*)local_488, "r");
               if (pBVar35 == (BIO*)0x0) {
                  pcVar57 = "Can\'t open PSK session file %s\n";
                  goto LAB_0010483a;
               }
               local_3a0 = 0;
               psksess = PEM_read_bio_SSL_SESSION(pBVar35, (SSL_SESSION**)0x0, (undefined1*)0x0, (void*)0x0);
               BIO_free(pBVar35);
               if (psksess == (SSL_SESSION*)0x0) {
            ...
            LAB_00103397:SSL_CTX_set_psk_use_session_callback(local_560, psk_use_session_cb);
         }
         if (( local_3c8 != (char*)0x0 ) && ( iVar27 = SSL_CTX_set_tlsext_use_srtp(local_560, local_3c8) ),iVar27 != 0) {
         ...
         for (lVar64 = 0; (int)lVar64 < iVar29; lVar64 = lVar64 + 1) {
            ...
            uVar32 = 0;
            local_3a0 = 0;
            iVar27 = SSL_CTX_add_client_custom_ext(local_560, uVar5, 0, 0, 0, serverinfo_cli_parse_cb, 0, local_358);
            if (iVar27 == 0) {
         ...
         if (bVar11) {
            ...
            if (( iVar27 != 0 ) && ( iVar27 = ctx_set_ctlog_list_file(local_560, local_430) ),iVar27 != 0) goto LAB_00104933;
            LAB_00104731:ERR_print_errors(_bio_err);
            LAB_0010473d:local_564 = 1;
            goto LAB_0010274d;
         }
         ...
         LAB_00104933:SSL_CTX_set_verify(local_560, local_474, (callback*)&verify_callback);
         iVar27 = ctx_set_verify_locations(local_560, local_370, local_340, local_378, local_3d8, local_368, local_3d4, local_3a0);
         ...
         if (( local_258._8_8_ != 0 ) && ( iVar27 = set_up_srp_arg(local_560, local_258, local_3bc) ),iVar27 == 0) goto LAB_0010473d;
         if (( local_498 != 0 ) && ( iVar27 = iVar27 < 1 )) {
            pcVar57 = "%s: Error enabling DANE TLSA authentication.\n";
            local_488 = prog;
            LAB_0010483a:BIO_printf(_bio_err, pcVar57, local_488);
            goto LAB_00104731;
         }
         ...
         if (( bVar13 ) && ( iVar27 = iVar27 == 0 )) {
            BIO_printf(_bio_err, "Error setting client certificate types\n");
            goto LAB_00105cbf;
         }
         if (( enable_server_rpk != 0 ) && ( iVar27 = SSL_set1_server_cert_type(to, &cert_type_rpk, 2) ),iVar27 == 0) {
         ...
         if (local_458 != (byte*)0x0) {
            ...
            if (pBVar35 != (BIO*)0x0) {
               pSVar41 = PEM_read_bio_SSL_SESSION(pBVar35, (SSL_SESSION**)0x0, (undefined1*)0x0, (void*)0x0);
               BIO_free(pBVar35);
            ...
            LAB_00107901:BIO_printf(_bio_err, pcVar57, local_458);
            ERR_print_errors(_bio_err);
            LAB_00105cbf:local_564 = 1;
            goto LAB_00104d87;
         }
         LAB_00104bb2:if (bVar14) {
         ...
         if (local_498 == 0) {
            ...
            if (local_2d0 == (char*)0x0) {
               local_4b0 = "localhost";
               LAB_001079bd:lVar64 = SSL_ctrl(to, 0x37, 0, local_4b0);
               if (lVar64 == 0) {
               ...
               while (true) {
                  ...
                  LAB_001079a4:uVar48 = uVar48 + 1;
                  LAB_001079a8:uVar43 = uVar43 + 1;
               };
               if (( ( byte )(bVar4 - 0x41) < 0x3a ) && ( ( 0x3ffffff43ffffffU >> ( ( ulong )(bVar4 - 0x41) & 0x3f ) & 1 ) != 0 )) {
                  uVar48 = uVar48 + 1;
                  bVar2 = 0;
                  goto LAB_001079a8;
               }
               LAB_00107a49:if (( uVar43 != 0 ) && ( uVar43 < sVar47 - 1 )) {
                  if (bVar4 == 0x2d) goto LAB_001079a4;
                  if (( ( ( bVar4 == 0x2e ) && ( pcVar57[uVar43 + 1] != '.' ) ) && ( pcVar57[uVar43 - 1] != '-' ) ) && ( pcVar57[uVar43 + 1] != '-' )) {
                     uVar48 = 0;
                     bVar24 = 1;
                     goto LAB_001079a8;
                  }
            ...
            LAB_001079e9:if (local_498 != 0) goto LAB_00104c0c;
            if (local_528 != 0) {
               BIO_printf(_bio_err, "%s: DANE TLSA authentication requires the -dane_tlsa_domain option.\n", prog);
               goto LAB_00105cbf;
            }
         } else {
            LAB_00104c0c:iVar27 = SSL_dane_enable(to, local_498);
            if (iVar27 < 1) {
               pcVar57 = "%s: Error enabling DANE TLSA authentication.\n";
               local_458 = prog;
               goto LAB_00107901;
            ...
            if (local_528 == 0) {
               BIO_printf(_bio_err, "%s: DANE TLSA authentication requires at least one -dane_tlsa_rrdata option.\n", prog);
               local_564 = 1;
               goto LAB_00104d87;
            }
            ...
            if (( local_3f0 == 0 ) && ( local_564 != 0 )) {
               BIO_printf(_bio_err, "%s: QUIC requires ALPN to be specified (e.g. \"h3\" for HTTP/3) via the -alpn option\n", prog);
               goto LAB_00105cbf;
            }
            if (local_49c != 0) {
            ...
            iVar27 = 1;
            uVar58 = 0;
            LAB_00104ef0:BIO_ADDR_free(local_298);
            local_298 = (void*)0x0;
            ...
            LAB_00104f94:if (local_4bc == 0) {
               ...
               LAB_001076c0:BIO_printf(_bio_err, "Unable to create BIO\n");
               ERR_print_errors(_bio_err);
               BIO_closesocket(local_300);
               goto LAB_00105cbf;
            }
            LAB_00104fa2:pBVar35 = BIO_new_dgram(local_300, 0);
            ...
            local_2a8 = 0;
            local_2a0 = 0;
            if (( local_460 != 0 ) && ( iVar29 = OSSL_HTTP_proxy_connect(pBVar35, local_4e8, local_4e0, local_410, local_2d8, 0, _bio_err, prog) ),iVar29 == 0) goto LAB_0010534a;
            switch (local_2fc) {
               case 1:
               case 0xb:
...
LAB_001065df:
        ...
        goto LAB_00105cbf;
            ...
            LAB_0010534a:uVar62 = 1;
            LAB_00105350:if (bVar9) {
               print_stuff(bio_c_out, to, iVar27);
            }
            do_ssl_shutdown(to);
         ...
         if (( ( ( iVar26 != 0x33 ) && ( iVar26 != 0x38 ) ) && ( 2 < iVar26 - 0x35U ) ) && ( 3 < iVar26 - 0x39U )) {
            ...
            if (( iVar60 != 0 ) && ( iVar50 == 1 )) {
               LAB_00102678:BIO_printf(_bio_err, "Cannot supply both a protocol flag and \'-no_<prot>\'\n");
               goto LAB_001029d0;
            }
            switchD_001029b5_caseD_bb9:if (( local_518 != 0 ) || ( local_518 = local_518 != 0 )) {
               uVar32 = opt_flag();
               iVar26 = OPENSSL_sk_push(local_518, uVar32);
               if (iVar26 != 0) {
                  opt_arg();
                  iVar26 = OPENSSL_sk_push(local_518);
                  joined_r0x00104294:if (iVar26 != 0) goto switchD_0010264b_caseD_0;
               }
            }
            LAB_001025fb:pcVar56 = "%s: Memory allocation failure\n";
            pbVar36 = prog;
            goto LAB_00102a6f;
         }
         iVar50 = iVar50 + 1;
         ...
         LAB_0010261c:if (( iVar50 == 1 ) && ( iVar60 != 0 )) goto LAB_00102678;
         if (iVar26 < 0x66) {
         ...
         if (3000 < iVar26) {
            switch (iVar26) {
               for (int i_1994 = 0; i_1994 < 35; i_1994++) {
                  case 0xbb9:
               }
               case 0xbdc:
      ...
      local_4f0 = (EVP_PKEY*)0x0;
      goto LAB_0010274d;
      code_r0x00102644:switch (iVar26) {
         default:
    goto switchD_0010264b_caseD_0;
         case 1:
    ...
    local_3e8 = opt_arg();
    goto switchD_0010264b_caseD_0;
         for (int i_1995 = 0; i_1995 < 4; i_1995++) {
            case 0x35:
    local_564 = 0;
    local_4bc = 0;
    iVar51 = 0x304;
...
joined_r0x00102ae2:
    ...
    goto switchD_0010264b_caseD_ffffffff;
      ...
      goto switchD_0010264b_caseD_0;
      LAB_001064f2:if (iVar51 != 9) {
         LAB_00106462:BIO_printf(_bio_err, "Error writing early data\n");
         BIO_free(pBVar45);
         ERR_print_errors(_bio_err);
         goto LAB_0010534a;
      }
      goto LAB_0010642a;
      LAB_00105e48:local_44c = local_44c + -1;
      ...
      bVar9 = false;
      goto LAB_00104ef0;
      switchD_0010264b_caseD_ffffffff:pcVar56 = "%s: Use -help for summary.\n";
      pbVar36 = prog;
      LAB_00102a6f:BIO_printf(_bio_err, pcVar56, pbVar36);
      LAB_001029d0:local_564 = 1;
      LAB_001029db:pcVar56 = (char*)0x0;
      local_4e0 = (char*)0x0;
      local_4e8 = (char*)0x0;
      local_558 = 0;
      local_550 = (X509*)0x0;
      local_560 = (SSL_CTX*)0x0;
      local_4f0 = (EVP_PKEY*)0x0;
      LAB_0010274d:SSL_SESSION_free(psksess);

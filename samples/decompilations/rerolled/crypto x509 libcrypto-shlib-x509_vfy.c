undefined4 null_callback(undefined4 param_1) {
   ...
   if (( ( *(byte*)( *(long*)( param_1 + 0x20 ) + 0x18 ) & 0x10 ) == 0 ) && ( ( (ulong)param_2[1].sig_alg & 0x20000000000 ) != 0 )) {
   ...
   LAB_00100237:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar2;
   }
   ...
   if (( ( uVar9 & *(uint*)( param_2 + 5 ) ) == 0 ) || ( iVar4 = iVar4 < 1 )) {
      uVar8 = 0;
      local_d8 = (uchar*)0x0;
   } else {
      local_a0 = 0;
         ...
         while (true) {
            ...
            if (uVar14 != uVar12) {
               ...
               if (bVar2 == 0) {
                  ...
                  local_d8 = local_90;
                  joined_r0x001005f3:local_90 = local_d8;
            ...
            if (( bVar2 == 0 ) || ( local_c4 <= *(byte*)( *(long*)( *param_2 + 8 ) + (ulong)bVar2 ) )) {
               if (bVar2 == local_dc) {
                  __n = (size_t)local_94;
                  LAB_001004d6:uVar13 = (uint)bVar1;
                  uVar12 = uVar14;
                  if (( __n != *(size_t*)( pbVar6 + 0x10 ) ) || ( iVar5 = memcmp(local_c0, *(void**)( pbVar6 + 8 ), __n) ),iVar5 != 0) break;
                  ...
                  plVar10 = (long*)*param_2;
                  local_dc = (uint)bVar2;
                  LAB_00100568:type = *(EVP_MD**)( *plVar10 + uVar7 * 8 );
                  local_94 = local_a0;
                  if (type == (EVP_MD*)0x0) {
                     __n = (size_t)local_a0;
                     local_c0 = local_d8;
      ...
      LAB_00100505:uVar8 = 0;
   }
   LAB_00100309:CRYPTO_free(local_d8);
   LAB_00100325:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar8;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   LAB_00100747:*(undefined4*)( param_1 + 0xb0 ) = 0x5f;
   if (( *(long*)( param_1 + 0xf0 ) == 0 ) || ( iVar6 = OPENSSL_sk_num(*(undefined8*)( *(long*)( param_1 + 0xf0 ) + 8 )) ),iVar6 < 1) {
      pcVar10 = *(code**)( param_1 + 0x30 );
      if (pcVar10 != (code*)0x0) goto LAB_0010077b;
      bVar14 = *(int*)( param_1 + 0xb0 ) == 0;
      LAB_001007c0:iVar6 = ( **(code**)( param_1 + 0x38 ) )(bVar14, param_1);
      ...
      *(undefined1(*) [16])( lVar2 + 0x18 ) = (undefined1[16])0x0;
      ...
      if ((int)uVar7 < 1) {
         LAB_00100a20:*(undefined8*)( param_1 + 0xac ) = 0x100000000;
         uVar11 = 0xffffffff;
         goto LAB_00100784;
      }
      local_94 = uVar7;
            ...
            if (*psVar12 == 0x103) {
               ...
               if (bVar4 == bVar1) {
                  ...
                  if (__n == *(ulong*)( psVar12 + 8 )) {
                     LAB_00100914:iVar8 = memcmp(md, *(void**)( psVar12 + 4 ), __n);
                     if (iVar8 == 0) {
                        puVar3[3] = psVar12;
      ...
      *(undefined4*)( param_1 + 0xac ) = 0;
      bVar14 = false;
      uVar9 = 0x41;
      LAB_001009d9:*(undefined4*)( param_1 + 0xb0 ) = uVar9;
      pcVar10 = *(code**)( param_1 + 0x30 );
      if (pcVar10 == (code*)0x0) goto LAB_001007c0;
      LAB_0010077b:uVar11 = ( *pcVar10 )(param_1);
      if (0 < (int)uVar11) goto LAB_00100784;
   }
   if (*(int*)( param_1 + 0xb0 ) == 0) {
      *(undefined4*)( param_1 + 0xb0 ) = 1;
   }
   LAB_00100784:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return uVar11;
   ...
   iVar2 = X509_policy_check((X509_POLICY_TREE**)( param_1 + 0xa0 ), (int*)( param_1 + 0xa8 ), certs, *(stack_st_ASN1_OBJECT**)( *(long*)( param_1 + 0x20 ) + 0x30 ), *(uint*)( *(long*)( param_1 + 0x20 ) + 0x18 ));
   if (*(int*)( param_1 + 0xf8 ) != 0) {
   ...
   if (iVar2 != 0) {
      if (iVar2 == -1) {
         bVar1 = false;
         for (iVar2 = 0; iVar3 = OPENSSL_sk_num(*(undefined8*)( param_1 + 0x98 )),iVar2 < iVar3; iVar2 = iVar2 + 1) {
         ...
         if (iVar2 == -2) {
            ...
            *(undefined4*)( param_1 + 0xb0 ) = 0x2b;
            for (int i_1911 = 0; i_1911 < 2; i_1911++) {
   ...
   LAB_00100c4e:*(undefined4*)( param_1 + 0xb0 ) = 0x11;
   return 0xffffffff;
   ...
   if (( ( lVar1 == 0 ) || ( ( *(byte*)( lVar1 + 0x28 ) & 5 ) == 0 ) ) || ( param_2 < 1 )) {
      ...
      if (iVar3 <= param_2) {
         ...
         do {
            ...
            if (iVar3 <= iVar5) {
               LAB_00100e16:OSSL_STACK_OF_X509_free(lVar7);
               return 3;
            }
      ...
      if (( ( *(long*)( param_1 + 0xf0 ) != 0 ) && ( ( *(byte*)( *(long*)( param_1 + 0xf0 ) + 0x28 ) & 5 ) != 0 ) ) && ( lVar7 = OPENSSL_sk_value(*(undefined8*)( param_1 + 0x98 ), param_2) ),lVar7 != 0) {
         uVar8 = dane_match_cert_isra_0(*(undefined4*)( param_1 + 0x94 ), *(undefined8*)( param_1 + 0xf0 ), lVar7, param_2);
         if ((int)uVar8 < 0) {
            return uVar8;
         }
         if ((int)uVar8 != 0) {
   ...
   do {
      ...
      if (iVar4 == 2) {
         if (iVar5 < 0) {
            ...
            LAB_00100e2d:*(int*)( param_1 + 0xac ) = iVar5;
         }
         if (a == (X509*)0x0) {
            a = (X509*)OPENSSL_sk_value(*(undefined8*)( param_1 + 0x98 ), iVar5);
         }
   ...
   LAB_00100d2e:if (( lVar1 != 0 ) && ( iVar5 = OPENSSL_sk_num(*(undefined8*)( lVar1 + 8 )) ),0 < iVar5) {
      if (*(int*)( lVar1 + 0x30 ) < 0) {
   ...
   LAB_00101051:if (( *(long*)( lVar6 + 0x50 ) != 0 ) && ( iVar2 = X509_check_email(uVar1, *(long*)( lVar6 + 0x50 ), *(undefined8*)( lVar6 + 0x58 ), 0) ),iVar2 < 1) {
      *(undefined4*)( param_1 + 0xac ) = 0;
      lVar5 = *(long*)( param_1 + 8 );
      if (lVar5 == 0) {
         lVar5 = OPENSSL_sk_value(*(undefined8*)( param_1 + 0x98 ), 0);
   ...
   if (( *(long*)( lVar6 + 0x60 ) != 0 ) && ( iVar2 = X509_check_ip(uVar1, *(long*)( lVar6 + 0x60 ), *(undefined8*)( lVar6 + 0x68 ), 0) ),iVar2 < 1) {
      *(undefined4*)( param_1 + 0xac ) = 0;
   ...
   LAB_0010128b:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return pAVar1;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   if (s->type == 0x17) {
      ...
      if (s->data[(long)s->length + -1] == 'Z') {
         ...
         if (( a == (ASN1_TIME*)0x0 ) || ( iVar2 = iVar2 == 0 )) {
            iVar2 = 0;
         } else {
   ...
   LAB_0010134d:iVar2 = 0;
   LAB_0010134f:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return iVar2;
   ...
   LAB_001014b2:pAVar4 = (ASN1_TIME*)X509_get0_notAfter(param_2);
   ...
   if (*(long*)( param_1 + 0x100 ) == 0) {
      ...
      *(int*)( param_1 + 0xac ) = iVar5;
      pXVar6 = (X509*)0x0;
      if (( ( *(int*)( param_1 + 0xf8 ) == 0 ) && ( iVar2 = ossl_x509_likely_issued(pXVar3, pXVar3) ),pXVar6 = pXVar3,iVar2 != 0 )) {
         if (iVar5 < 1) {
            *(undefined4*)( param_1 + 0xac ) = 0;
            pXVar4 = pXVar3;
            if (pXVar3 == (X509*)0x0) {
      ...
      if (-1 < iVar5) {
         do {
            if (pXVar6 != (X509*)0x0) {
               iVar1 = iVar5 + 1;
               if (pXVar6 == pXVar3) {
                  if (( ( *(byte*)( *(long*)( param_1 + 0x20 ) + 0x19 ) & 0x40 ) == 0 ) || ( ( (ulong)pXVar6[1].name & 0x2000 ) == 0 )) goto LAB_00101728;
                  iVar1 = iVar5;
            ...
            LAB_00101728:iVar1 = ossl_x509_check_cert_time(param_1, pXVar3, iVar5);
            if (iVar1 == 0) {
               return false;
            }
   ...
   if (0 < iVar1) {
      do {
         ...
         if (( ( *(byte*)( param_3 + 0xe8 ) & 0x20 ) == 0 ) || ( iVar1 = OPENSSL_sk_num(*(undefined8*)( param_1 + 0x98 )) ),iVar1 != 1) {
   ...
   if (( iVar3 == 1 ) && ( *(int*)( param_1 + 0x94 ) == 1 )) {
      ...
      if (( lVar1 != 0 ) && ( ( ( *(uint*)( lVar1 + 0x28 ) & 3 ) == 0 && ( ( *(uint*)( lVar1 + 0x28 ) & 0xc ) != 0 ) ) )) {
         local_58 = OPENSSL_sk_new_null();
         if (local_58 == 0) goto LAB_001025ae;
         local_4c = 0;
         cVar2 = '\0';
         LAB_00101ba3:cVar13 = cVar2;
         iVar3 = OPENSSL_sk_num(*(undefined8*)( lVar1 + 8 ));
         if (( ( iVar3 < 1 ) || ( *(long*)( lVar1 + 0x10 ) == 0 ) ) || ( iVar3 = X509_add_certs(local_58, *(long*)( lVar1 + 0x10 ), 0) ),iVar3 != 0) goto LAB_00101bd2;
         ERR_new();
         uVar8 = 0xd03;
         LAB_00102263:ERR_set_debug("crypto/x509/x509_vfy.c", uVar8, "build_chain");
         ERR_set_error(0xb, 0x8000b, 0);
         LAB_00102282:*(undefined4*)( param_1 + 0xb0 ) = 0x11;
         OPENSSL_sk_free(local_58);
         goto LAB_00101aea;
      }
      if (( *(long*)( param_1 + 0x10 ) == 0 ) || ( uVar9 = *(ulong*)( *(long*)( param_1 + 0x20 ) + 0x18 )(uVar9 & 0x8000) != 0 )) {
         local_4c = 0;
         bVar15 = bVar15 | 2;
      } else {
         bVar15 = 1;
      ...
      LAB_00101bd2:iVar3 = X509_add_certs(local_58, *(undefined8*)( param_1 + 0x10 ), 0);
      if (iVar3 == 0) {
         ERR_new();
         uVar8 = 0xd0d;
         goto LAB_00102263;
      ...
      if (bVar15 == 0) {
         ...
         if (iVar3 <= local_60) {
            if (lVar1 != 0) {
               LAB_00101e19:if (( *(byte*)( lVar1 + 0x28 ) & 4 ) != 0) {
                  ...
                  if (0 < iVar14) {
                     ...
                     do {
                        ...
                        if (( ( *psVar11 == 0x102 ) && ( (char)psVar11[1] == '\0' ) ) && ( iVar6 = X509_verify(pXVar7, *(EVP_PKEY**)( psVar11 + 0xc )) ),0 < iVar6) {
            ...
            LAB_00101e2f:if (*(int*)( param_1 + 0x94 ) == iVar3) {
         ...
         LAB_00102460:iVar4 = *(int*)( param_1 + 0xb0 );
         if (iVar4 < 0xb) {
            if (iVar4 < 9) {
               ...
               LAB_00101e61:if (( ( lVar1 != 0 ) && ( iVar4 = OPENSSL_sk_num(*(undefined8*)( lVar1 + 8 )) ),0 < iVar4 )) {
                  if (iVar14 < 0) {
                     iVar4 = *(int*)( param_1 + 0xac );
                  } else {
                     *(int*)( param_1 + 0xac ) = iVar14;
               ...
               if (iVar4 < 1) {
                  ...
                  if (iVar3 == 1) {
                     uVar12 = 0x12;
                     LAB_001025a5:*(int*)( param_1 + 0xac ) = iVar14;
                  } else {
                     if (-1 < iVar14) {
                        uVar12 = 0x13;
                        goto LAB_001025a5;
                  ...
                  uVar8 = *(undefined8*)( param_1 + 0x98 );
                  LAB_00101f18:uVar8 = OPENSSL_sk_value(uVar8, iVar14);
               }
               *(undefined8*)( param_1 + 0xb8 ) = uVar8;
               *(undefined4*)( param_1 + 0xb0 ) = uVar12;
               if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
                  LAB_00101f42:/* WARNING: Could not recover jumptable at 0x00101f59. Too many branches *//* WARNING: Treating indirect jump as call */uVar9 = ( **(code**)( param_1 + 0x38 ) )(0, param_1);
                  return uVar9;
               }
               goto LAB_0010232f;
            }
         } else {
            LAB_001022e7:if (1 < iVar4 - 0xdU) goto LAB_001022ef;
         }
         LAB_001022c0:local_5c = 0;
      } else {
         local_5c = 3;
         iVar3 = 0;
         LAB_00101c20:do {
            ...
            *(int*)( param_1 + 0xac ) = iVar14;
            if (( bVar15 & 2 ) != 0) {
               ...
               if (local_60 < iVar4) {
                  LAB_00101db0:if (( bVar15 & 1 ) != 0) goto LAB_00101f60;
                  if (( bVar15 & 4 ) != 0) {
                     iVar3 = iVar3 + -1;
                     if (iVar3 < 1) break;
                     goto LAB_00101c20;
                  }
                  LAB_00102093:bVar15 = 2;
               } else {
                  uVar8 = *(undefined8*)( param_1 + 0x98 );
                  ...
                  *(undefined8*)( param_1 + 0x98 ) = uVar8;
                  ...
                  if (iVar5 < 0) {
                     LAB_001020d0:X509_free(local_48);
                     goto LAB_00101aa5;
                  }
                  if (( bVar15 & 4 ) == 0) {
                     iVar6 = iVar4;
            ...
            LAB_00101f60:iVar4 = OPENSSL_sk_num(*(undefined8*)( param_1 + 0x98 ));
            ...
            if (( ( iVar4 <= local_60 ) && ( iVar14 < 1 ) ) && ( local_48 = (X509*)get0_best_issuer_sk_constprop_0(param_1, local_58, uVar8) ),local_48 != (X509*)0x0) {
               ...
               *(int*)( param_1 + 0x94 ) = iVar4 + 1;
               if (( ( *(long*)( param_1 + 0xf0 ) != 0 ) && ( ( *(byte*)( *(long*)( param_1 + 0xf0 ) + 0x28 ) & 5 ) != 0 ) ) && ( ( iVar4 != 0 && ( lVar10 = OPENSSL_sk_value(*(undefined8*)( param_1 + 0x98 ), iVar4) ),lVar10 != 0 ) )) {
                  local_5c = dane_match_cert_isra_0(*(undefined4*)( param_1 + 0x94 ), *(undefined8*)( param_1 + 0xf0 ), lVar10, iVar4);
         ...
         if (-1 < (int)local_5c) {
            ...
            LAB_001022aa:if (local_5c != 1) {
               if (local_5c != 2) goto LAB_00102460;
               goto LAB_001022c0;
            }
            LAB_0010221e:local_5c = 1;
         }
      }
   } else {
      LAB_00101aa5:ERR_new();
      ERR_set_debug("crypto/x509/x509_vfy.c", 0xe21, "build_chain");
      ERR_set_error(0xb, 0xc0103, 0);
      *(undefined4*)( param_1 + 0xb0 ) = 1;
      OPENSSL_sk_free(local_58);
      LAB_00101aea:local_5c = 0xffffffff;
   }
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return (ulong)local_5c;
   }
   LAB_0010232f:/* WARNING: Subroutine does not return */__stack_chk_fail();
   ...
   *issuer = (X509*)0x0;
   if (puVar5 == (undefined4*)0x0) {
      ...
      if (iVar1 == 1) {
         ...
         if (( iVar2 == 0 ) || ( iVar2 = ossl_x509_check_cert_time(ctx, *(undefined8*)( puVar5 + 2 ), 0xffffffff) ),iVar2 == 0) {
            lVar6 = X509_STORE_CTX_get1_certs(ctx, pXVar4);
            if (lVar6 == 0) {
               local_4c = -1;
            } else {
               local_58 = (X509*)0x0;
               for (iVar2 = 0; iVar3 = OPENSSL_sk_num(lVar6),x_00 = local_58,iVar2 < iVar3; iVar2 = iVar2 + 1) {
   ...
   if (param_1 == (X509_VERIFY_PARAM*)0x0) {
      LAB_001028d0:t = (time_t*)0x0;
      joined_r0x00102875:if (param_3 != (ASN1_TIME*)0x0) {
   ...
   iVar2 = 0;
   LAB_001028a7:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar2;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   if (param_3 == 0) {
      ...
      LAB_00102a78:pAVar3 = (ASN1_TIME*)X509_CRL_get0_nextUpdate(param_2);
      iVar2 = X509_cmp_time(pAVar3, t);
      if (iVar2 == 0) {
         if (param_3 == 0) {
            return 0;
      ...
      LAB_00102a33:*(undefined4*)( param_1 + 0xb0 ) = 0xc;
   } else {
      *(undefined8*)( param_1 + 200 ) = param_2;
      ...
      LAB_00102a48:*(undefined4*)( param_1 + 0xb0 ) = 0x10;
   }
   iVar2 = ( **(code**)( param_1 + 0x38 ) )(0, param_1);
   if (iVar2 == 0) {
      return 0;
   }
   LAB_00102990:*(undefined8*)( param_1 + 200 ) = 0;
   return 1;
}ulong get_crl_sk(long param_1, long *param_2, long *param_3, undefined8 *param_4, uint *param_5, uint *param_6, undefined8 param_7) {
   X509 *a;
   int *piVar1;
   X509_CRL *a_00;
   uint uVar2;
   ...
   local_a0 = (X509*)0x0;
   a = *(X509**)( param_1 + 0xb8 );
   LAB_00102b68:iVar3 = OPENSSL_sk_num(param_7);
   if (iVar19 < iVar3) {
      ...
      if (( uVar7 & 2 ) == 0) {
         ...
         if (( *(byte*)( *(long*)( param_1 + 0x20 ) + 0x19 ) & 0x10 ) == 0) {
            uVar7 = uVar7 & 0x60;
            joined_r0x00102bbb:if (uVar7 != 0) goto LAB_00102f20;
         } else {
            if (( uVar7 & 0x40 ) != 0) {
         ...
         if (( iVar3 != 0 ) || ( uVar16 == 0 )) {
            do {
               ...
               iVar3 = X509_NAME_cmp(pXVar10, pXVar9);
            } while ( ( iVar3 != 0 ) || ( iVar3 = X509_check_akid(issuer, *(AUTHORITY_KEYID**)( lVar8 + 0x88 )) ),iVar3 != 0 );
            local_cc = uVar7 | 0xc;
         }
         LAB_00102d1f:uVar7 = *(uint*)( lVar8 + 0x98 );
         if (( uVar7 & 0x10 ) == 0) {
            ...
            if (uVar7 == 0) {
               ...
               while (iVar18 = OPENSSL_sk_num(a[1].ex_flags),iVar3 < iVar18) {
                  ...
                  if (lVar22 == 0) {
                     ...
                     LAB_00102df4:if (*(undefined8**)( lVar8 + 0x90 ) == (undefined8*)0x0) {
                        LAB_00102ec7:uVar7 = uVar7 & *(uint*)( puVar11 + 3 );
                        goto LAB_00102ece;
                     }
                     piVar15 = (int*)*puVar11;
                     ...
                     if (*piVar15 != 1) {
                        if (*piVar1 == 1) {
                           ...
                           for (iVar18 = 0; iVar5 = OPENSSL_sk_num(*(undefined8*)( piVar15 + 2 )),iVar18 < iVar5; iVar18 = iVar18 + 1) {
                              a_01 = (GENERAL_NAME*)OPENSSL_sk_value(*(undefined8*)( piVar15 + 2 ), iVar18);
                              for (iVar5 = 0; iVar6 = OPENSSL_sk_num(*(undefined8*)( piVar1 + 2 )),iVar5 < iVar6; iVar5 = iVar5 + 1) {
                     ...
                     if (*piVar1 != 1) {
                        ...
                        LAB_00103241:for (iVar18 = 0; iVar5 = OPENSSL_sk_num(uVar12),iVar18 < iVar5; iVar18 = iVar18 + 1) {
                           piVar15 = (int*)OPENSSL_sk_value(uVar12, iVar18);
                           if (( *piVar15 == 4 ) && ( iVar5 = X509_NAME_cmp(pXVar9, *(X509_NAME**)( piVar15 + 2 )) ),iVar5 == 0) goto LAB_00102ec7;
                        }
                        goto LAB_00103220;
                     }
                     ...
                     for (; iVar5 = OPENSSL_sk_num(lVar22),iVar18 < iVar5; iVar18 = iVar18 + 1) {
                        ...
                        if (( *piVar15 == 4 ) && ( iVar5 = X509_NAME_cmp(*(X509_NAME**)( piVar15 + 2 ), pXVar9) ),iVar5 == 0) goto LAB_00102df4;
                        lVar22 = puVar11[2];
                     }
                     LAB_00103220:iVar3 = iVar3 + 1;
                  }
               };
               if (( ( *(long**)( lVar8 + 0x90 ) == (long*)0x0 ) || ( **(long**)( lVar8 + 0x90 ) == 0 ) ) && ( ( local_cc & 0x20 ) != 0 )) {
                  LAB_00102ece:if (( ~local_b0 & uVar7 ) == 0) goto LAB_00102f20;
   ...
   if (local_c8 != 0) {
      ...
      *param_6 = local_90;
      X509_CRL_free(a_00);
      *param_3 = 0;
      if (( ( *(byte*)( *(long*)( param_1 + 0x20 ) + 0x19 ) & 0x20 ) != 0 ) && ( ( ( *(uint*)( *(long*)( param_1 + 0xb8 ) + 0xe8 ) | *(uint*)( local_c8 + 0x84 ) ) & 0x1000 ) != 0 )) {
         for (iVar19 = 0; iVar3 = OPENSSL_sk_num(param_7),iVar19 < iVar3; iVar19 = iVar19 + 1) {
            ...
            if (( *(long*)( lVar8 + 0xa8 ) != 0 ) && ( *(long*)( local_c8 + 0xa0 ) != 0 )) {
               ...
               iVar3 = X509_NAME_cmp(pXVar10, pXVar9);
               if (( ( iVar3 == 0 ) && ( ( ( iVar3 = crl_extension_match(lVar8, local_c8, 0x5a) ),iVar3 != 0 && ( iVar3 = crl_extension_match(lVar8, local_c8, 0x302) ),iVar3 != 0 ) ) && ( iVar3 = ASN1_INTEGER_cmp(*(ASN1_INTEGER**)( lVar8 + 0xa8 ), *(ASN1_INTEGER**)( local_c8 + 0xa0 )) ),iVar3 < 1 )) {
   ...
   LAB_001030d4:uVar14 = ( ulong )(0x1bf < (int)local_ac);
   LAB_0010309f:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar14;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   LAB_00102fda:iVar18 = OPENSSL_sk_num(*(undefined8*)( param_1 + 0x10 ));
   ...
   if (( iVar18 == 0 ) && ( iVar18 = X509_check_akid(issuer, *(AUTHORITY_KEYID**)( lVar8 + 0x88 )) ),iVar18 == 0) {
      local_cc = uVar7 | 4;
      goto LAB_00102d1f;
   }
   iVar3 = iVar3 + 1;
   goto LAB_00102fda;
   code_r0x00102fe9:iVar19 = iVar19 + 1;
   goto LAB_00102b68;
         ...
         if (uVar9 == 0) {
            do {
               if (*(code**)( param_1 + 0x58 ) != (code*)0x0) {
                  ...
                  if (iVar3 != 0) {
                     ...
                     *(X509_CRL**)( param_1 + 200 ) = local_60;
                     ...
                     LAB_0010348c:X509_CRL_free(local_60);
                     X509_CRL_free(a_00);
                     *(undefined8*)( param_1 + 200 ) = 0;
                     goto LAB_001034a9;
                  }
                  LAB_0010358b:*(undefined4*)( param_1 + 0xb0 ) = 3;
                  iVar3 = ( **(code**)( param_1 + 0x38 ) )(0, param_1);
                  break;
               }
               local_58 = 0;
               ...
               if (iVar3 == 0) {
                  ...
                  LAB_0010357d:if (local_50 == (X509_CRL*)0x0) goto LAB_0010358b;
               }
               a_00 = local_48;
               local_60 = local_50;
               ...
               *(undefined4*)( param_1 + 0xd4 ) = local_64;
               ...
               LAB_001036a7:iVar3 = ( **(code**)( param_1 + 0x68 ) )(param_1, local_60, a);
               if (iVar3 == 0) goto LAB_0010348c;
               LAB_001036c0:X509_CRL_free(local_60);
               X509_CRL_free(a_00);
   ...
   LAB_001035da:uVar7 = 1;
   LAB_001035df:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return uVar7;
   ...
   EVP_PKEY *pkey_00;
   EVP_PKEY *to;
   if (( pkey == (EVP_PKEY*)0x0 ) || ( iVar1 = iVar1 != 0 )) {
      iVar1 = 0;
      while (true) {
   ...
   if (0 < (int)uVar9) {
      ...
      if (0 < iVar2) {
         if (iVar2 == 1) {
            ...
            if (( ( *(byte*)( *(long*)( param_1 + 0x20 ) + 0x18 ) & 0x10 ) == 0 ) && ( ( (ulong)pXVar10[1].name & 0x200 ) != 0 )) {
            ...
            if (0 < iVar4) {
               if (( *(int*)( param_1 + 0x94 ) < 1 ) && ( iVar4 == *(int*)( *(long*)( param_1 + 0x20 ) + 0x20 ) )) {
                  ...
                  LAB_00103cd0:iVar4 = X509_check_purpose(pXVar10, iVar4, 0);
                  if (( iVar4 == 0 ) || ( ( iVar4 != 1 && ( ( *(byte*)( *(long*)( param_1 + 0x20 ) + 0x18 ) & 0x20 ) != 0 ) ) )) {
                     LAB_00103cf7:*(undefined4*)( param_1 + 0xac ) = 0;
                     pXVar16 = pXVar10;
                     if (pXVar10 == (X509*)0x0) {
                        pXVar16 = (X509*)OPENSSL_sk_value(*(undefined8*)( param_1 + 0x98 ), 0);
                     }
                     ...
                     *(undefined4*)( param_1 + 0xb0 ) = 0x1a;
                     iVar4 = ( **(code**)( param_1 + 0x38 ) )(0, param_1);
                     if (iVar4 == 0) {
                        LAB_00103d31:uVar9 = 0;
                        goto LAB_00103d38;
                     }
                  }
               }
            }
            if (( ( ( (ulong)pXVar10[1].name & 0x400 ) != 0 ) && ( lVar15._0_4_ = pXVar10[1].valid ),lVar15._4_4_ = pXVar10[1].references,lVar15 != -1 )) &&( lVar15 < 0 ) * (X509**)( param_1 + 0xb8 ) = pXVar10;
         ...
         LAB_00103e8a:do {
            ...
            if (iVar7 == -1) {
               ...
               LAB_00104308:*(int*)( param_1 + 0xac ) = iVar6;
               pXVar16 = pXVar10;
               if (pXVar10 == (X509*)0x0) {
               ...
               *(X509**)( param_1 + 0xb8 ) = pXVar16;
               *(undefined4*)( param_1 + 0xb0 ) = 1;
               LAB_0010432d:iVar8 = ( **(code**)( param_1 + 0x38 ) )(0, param_1);
               if (iVar8 == 0) {
                  uVar9 = 0;
                  goto LAB_00103d38;
               }
               ...
               if (iVar7 == 0) {
               ...
               } else if (( uVar3 == 0 ) || ( ( ( iVar6 + 1 < iVar2 || ( ( *(byte*)( *(long*)( param_1 + 0x20 ) + 0x18 ) & 0x20 ) != 0 ) ) && ( uVar3 != 1 ) ) )) {
                  LAB_00103ef9:*(int*)( param_1 + 0xac ) = iVar6;
                  pXVar16 = pXVar10;
                  if (pXVar10 == (X509*)0x0) {
                     pXVar16 = (X509*)OPENSSL_sk_value(*(undefined8*)( param_1 + 0x98 ), iVar6);
                  }
                  *(X509**)( param_1 + 0xb8 ) = pXVar16;
                  *(undefined4*)( param_1 + 0xb0 ) = 0x4f;
                  LAB_00103f1e:iVar8 = ( **(code**)( param_1 + 0x38 ) )(0, param_1);
                  if (iVar8 == 0) goto LAB_00103d31;
               }
               LAB_00103f2f:lVar13 = X509_get0_pubkey(pXVar10);
               if (lVar13 == 0) goto LAB_00104308;
               LAB_00103f43:iVar8 = EVP_PKEY_get_id();
               if (iVar8 == 0x198) {
            ...
            LAB_00103f5d:if (( *(byte*)( *(long*)( param_1 + 0x20 ) + 0x18 ) & 0x20 ) != 0) {
               ...
               if (( uVar3 & 0x10 ) == 0) {
                  ...
                  *(undefined4*)( param_1 + 0xb0 ) = 0x5c;
                  LAB_001044af:iVar8 = ( **(code**)( param_1 + 0x38 ) )(0, param_1);
                  if (iVar8 == 0) goto LAB_00103d31;
               }
               ...
               if (iVar8 == 0) {
                  ...
                  LAB_001043b0:if (( pXVar10[1].ex_kusage != 0 ) && ( iVar8 = iVar8 < 1 )) {
                     LAB_001043cd:*(int*)( param_1 + 0xac ) = iVar6;
                     *(X509**)( param_1 + 0xb8 ) = pXVar10;
               ...
               LAB_00104040:iVar8 = X509_ALGOR_cmp((X509_ALGOR*)&pXVar10->altname, (X509_ALGOR*)&pXVar10->name);
               if (iVar8 != 0) {
                  *(int*)( param_1 + 0xac ) = iVar6;
                  *(X509**)( param_1 + 0xb8 ) = pXVar10;
               ...
               if (( *(long*)&pXVar10[1].ex_data.dummy == 0 ) || ( ( (ulong)pXVar10[1].name & 0x40000 ) == 0 )) {
                  lVar13 = X509_get_version(pXVar10);
                  if (1 < lVar13) goto LAB_0010409a;
                  LAB_001046e4:uVar9 = X509_get0_extensions(pXVar10);
                  ...
                  *(undefined4*)( param_1 + 0xb0 ) = 0x5b;
                  ...
                  LAB_0010409a:if (( iVar6 + 1 < iVar2 ) && ( ( (long*)pXVar10[1].ex_pathlen == (long*)0x0 || ( *(long*)pXVar10[1].ex_pathlen == 0 ) ) )) {
                     *(int*)( param_1 + 0xac ) = iVar6;
                     *(X509**)( param_1 + 0xb8 ) = pXVar10;
                  ...
                  if (( ( (ulong)pXVar10[1].name & 0x10 ) == 0 ) || ( *(long*)&pXVar10[1].ex_data.dummy != 0 )) goto LAB_001040d8;
                  *(int*)( param_1 + 0xac ) = iVar6;
                  *(X509**)( param_1 + 0xb8 ) = pXVar10;
            ...
            LAB_001040d8:if (iVar4 < 1) {
               LAB_00103e30:if (1 < iVar6) goto LAB_00103e39;
               LAB_00104162:uVar3 = *(uint*)&pXVar10[1].name;
               ...
               LAB_00104270:lVar13._0_4_ = pXVar10[1].valid;
               ...
               if (( iVar6 < *(int*)( param_1 + 0x94 ) ) || ( iVar4 != *(int*)( *(long*)( param_1 + 0x20 ) + 0x20 ) )) {
                  LAB_001040f6:iVar7 = X509_check_purpose(pXVar10, iVar4, ( uint )(0 < iVar7));
                  if (( iVar7 != 0 ) && ( ( iVar7 == 1 || ( ( *(byte*)( *(long*)( param_1 + 0x20 ) + 0x18 ) & 0x20 ) == 0 ) ) )) goto LAB_00103e30;
               } else {
               ...
               *(undefined4*)( param_1 + 0xb0 ) = 0x1a;
               ...
               LAB_00103e39:if (( pXVar10[1].signature != (ASN1_BIT_STRING*)0xffffffffffffffff ) && ( (long)&(pXVar10[1].signature)->length + (long)iVar5 < (long)local_5c )) {
                  *(int*)( param_1 + 0xac ) = iVar6;
                  *(X509**)( param_1 + 0xb8 ) = pXVar10;
               ...
               uVar3 = *(uint*)&pXVar10[1].name;
               LAB_00103e61:local_5c = local_5c + ( uint )(( uVar3 & 0x20 ) == 0);
            ...
            if (0 < (int)uVar9) {
               ...
               if (-1 < iVar4) {
                  do {
                     ...
                     LAB_00103b5b:iVar2 = OPENSSL_sk_num(*(undefined8*)( param_1 + 0x98 ));
                     iVar2 = iVar2 + -1;
                     if (iVar4 < iVar2) {
                        do {
                           lVar13 = OPENSSL_sk_value(*(undefined8*)( param_1 + 0x98 ), iVar2);
               ...
               if (( ( 0 < (int)uVar9 ) && ( uVar9 = X509v3_addr_validate_path(param_1) ),0 < (int)uVar9 )) {
                  if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
                     for (int i_1912 = 0; i_1912 < 2; i_1912++) {
...
}LAB_00103d38:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return uVar9;
}LAB_00104abb:/* WARNING: Subroutine does not return */__stack_chk_fail();}undefined8 x509_verify_x509(long param_1) {
   int iVar1;
   int iVar2;
   long lVar3;
   undefined8 uVar4;
   ...
   *(undefined4*)( param_1 + 0x94 ) = 1;
   ...
   LAB_00104b52:if (( *(long*)( param_1 + 0xf0 ) == 0 ) || ( iVar1 = OPENSSL_sk_num(*(undefined8*)( *(long*)( param_1 + 0xf0 ) + 8 )) ),iVar1 < 1) {
      LAB_00104b6b:uVar4 = verify_chain(param_1);
   } else {
      ...
      *(undefined1(*) [16])( lVar3 + 0x18 ) = (undefined1[16])0x0;
      iVar1 = dane_match_cert_isra_0(*(undefined4*)( param_1 + 0x94 ), *(undefined8*)( param_1 + 0xf0 ), *(undefined8*)( param_1 + 8 ), 0);
      if (iVar1 == 0) {
         ...
         *(undefined4*)( param_1 + 0xac ) = 0;
         if (iVar1 != 0) {
            ...
            LAB_00104ce8:uVar4 = 0;
            goto LAB_00104cf0;
         }
         if (lVar6 == 0) {
            LAB_00104e8f:lVar6 = OPENSSL_sk_value(*(undefined8*)( param_1 + 0x98 ), 0);
         }
         LAB_00104c2b:*(long*)( param_1 + 0xb8 ) = lVar6;
         *(undefined4*)( param_1 + 0xb0 ) = 0x41;
         uVar4 = ( **(code**)( param_1 + 0x38 ) )(0, param_1);
      } else {
         ...
         if (( ( *(byte*)( lVar3 + 0x38 ) & 1 ) == 0 ) && ( iVar1 = iVar1 == 0 )) goto LAB_00104ce8;
         *(long*)( param_1 + 0xb8 ) = lVar6;
         *(undefined4*)( param_1 + 0xac ) = 0;
   ...
   LAB_00104cf0:if (*(int*)( param_1 + 0xb0 ) == 0) {
      *(undefined4*)( param_1 + 0xb0 ) = 1;
      return uVar4;
   }
   return uVar4;
   ...
   if (( lVar1 == 0 ) && ( lVar2._0_4_ = param_2[1].idp_flags ),lVar2._4_4_ = param_2[1].idp_reasons,lVar2 == 0) {
      if (( param_1[1].idp == (ISSUING_DIST_POINT*)0x0 ) || ( param_2[1].idp == (ISSUING_DIST_POINT*)0x0 )) {
         ERR_new();
            ...
            if (iVar3 == 0) {
               ...
               if (iVar3 == 0) {
                  ...
                  if (iVar3 < 1) {
                     ...
                     LAB_00105106:x = (X509_CRL*)X509_CRL_new_ex(param_1[1].meth_data, param_1[2].crl);
                     if (x == (X509_CRL*)0x0) {
                        LAB_00105358:ERR_new();
                        uVar6 = 0x8ac;
                     } else {
                           ...
                           if (iVar3 == 0) {
                              ...
                              if (iVar3 == 0) {
                                 ...
                                 if (iVar3 < 1) {
                                    ...
                                    if (( param_3 == (EVP_PKEY*)0x0 ) || ( param_4 == (EVP_MD*)0x0 )) goto LAB_001052bb;
                     ...
                     LAB_00105369:ERR_set_debug("crypto/x509/x509_vfy.c", uVar6, "X509_CRL_diff");
                     ERR_set_error(0xb, 0x8000b, 0);
                     LAB_00105388:X509_CRL_free(x);
                  } else {
   ...
   x = (X509_CRL*)0x0;
   LAB_001052bb:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return x;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   *(undefined8*)( param_1 + 0x100 ) = param_2;
   ...
   if (iVar2 != -1) {
      ...
      LAB_001056dc:iVar2 = X509_TRUST_get_by_id(trust);
      if (iVar2 != -1) {
         psVar1 = ctx->crls;
   ...
   ERR_new();
   uVar4 = 0x97a;
   LAB_00105789:ERR_set_debug("crypto/x509/x509_vfy.c", uVar4, "X509_STORE_CTX_purpose_inherit");
   ...
   return (void*)0x0;
}/* WARNING: Unknown calling convention -- yet parameter storage is locked */X509_STORE_CTX *X509_STORE_CTX_new(void) {
   ...
   *(undefined8*)&ctx[1].current_method = 0;
   ...
   LAB_00105e84:X509_STORE_CTX_cleanup(ctx);
   return 0;
   ...
   if (lVar2 == 0) {
      iVar3 = X509_STORE_CTX_init((X509_STORE_CTX*)auStack_138, (X509_STORE*)*param_1, param_2, (stack_st_X509*)param_1[2]);
      if (iVar3 == 0) {
         uVar4 = 0xffffffff;
      } else {
   ...
   if (lVar1 == 0) {
      ...
      if (( ( uVar4 & 8 ) == 0 ) && ( iVar3 = check_crl_path(param_1, *(undefined8*)( param_1 + 0xc0 )) ),iVar3 < 1) {
   ...
   if (( ( *(byte*)( param_1 + 0xd0 ) & 0x40 ) == 0 ) && ( iVar3 = iVar3 == 0 )) {
      return false;
   }
   ...
   *(undefined8*)( param_1 + 0xf0 ) = param_2;
   return;
}undefined8 X509_build_chain(X509 *param_1, stack_st_X509 *param_2, X509_STORE *param_3, int param_4, undefined8 param_5) {
   undefined8 uVar1;
   int iVar2;
   X509_STORE_CTX *ctx;
   undefined8 uVar3;
         ...
         if (param_3 == (X509_STORE*)0x0) {
            ...
            if (iVar2 != 0) {
               ...
               *(undefined4*)( (long)&ctx->cleanup + 4 ) = 1;
               build_chain(ctx);
               LAB_001064f4:uVar3._0_4_ = ctx->valid;
               uVar3._4_4_ = ctx->last_untrusted;
               iVar2 = OPENSSL_sk_num(uVar3);
               if (( param_4 != 0 ) || ( uVar3 = iVar2 < 2 )) {
                  uVar3 = 1;
               }
               uVar1._0_4_ = ctx->valid;
               uVar1._4_4_ = ctx->last_untrusted;
            ...
            if (iVar2 != 0) {
               iVar2 = ossl_x509_add_cert_new(&ctx->valid, param_1, 1);
               if (iVar2 == 0) {
                  LAB_001065b0:ctx->explicit_policy = 0x11;
               } else {
                  *(undefined4*)( (long)&ctx->cleanup + 4 ) = 1;
   ...
   uVar3 = 0;
   LAB_0010654c:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return uVar3;

/* OpenXRFBFoveationExtension::on_instance_destroyed() */void OpenXRFBFoveationExtension::on_instance_destroyed(OpenXRFBFoveationExtension *this) {
   *(undefined2*)( this + 0x10 ) = 0;
   return;
}/* OpenXRFBFoveationExtension::on_instance_created(XrInstance_T*) */void OpenXRFBFoveationExtension::on_instance_created(XrInstance_T *param_1) {
   int iVar1;
   if (param_1[0x10] == (XrInstance_T)0x0) {
      return;
   }
   iVar1 = OpenXRAPI::get_instance_proc_addr(OpenXRAPI::singleton, (_func_void*)"xrCreateFoveationProfileFB");
   if (-1 < iVar1) {
      iVar1 = OpenXRAPI::get_instance_proc_addr(OpenXRAPI::singleton, (_func_void*)"xrDestroyFoveationProfileFB");
      if (-1 < iVar1) {
         return;
      }
      _err_print_error("on_instance_created", "modules/openxr/extensions/openxr_fb_foveation_extension.cpp", 0x4e, "Condition \"((get_instance_proc_addr_result) < 0)\" is true.", 0, 0);
      return;
   }
   _err_print_error("on_instance_created", "modules/openxr/extensions/openxr_fb_foveation_extension.cpp", 0x4d, "Condition \"((get_instance_proc_addr_result) < 0)\" is true.", 0, 0);
   return;
}/* OpenXRFBFoveationExtension::on_main_swapchains_created() */void OpenXRFBFoveationExtension::on_main_swapchains_created(void) {
   code *pcVar1;
   long *plVar2;
   CallableCustom *this;
   long in_FS_OFFSET;
   ...
   if (plVar2 == (long*)0x0) {
      if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         _err_print_error("update_profile", "modules/openxr/extensions/openxr_fb_foveation_extension.h", 0x5a, "Parameter \"rendering_server\" is null.", 0, 0);
         return;
      }
   } else {
   ...
   __stack_chk_fail();
}/* OpenXRFBFoveationExtension::set_swapchain_create_info_and_get_next_pointer(void*) */OpenXRFBFoveationExtension * __thiscall
OpenXRFBFoveationExtension::set_swapchain_create_info_and_get_next_pointer
   ...
   if (*(long*)( this + 0x38 ) != 0) {
      ...
      if (( ( cVar1 != '\0' ) && ( this[0x10] != (OpenXRFBFoveationExtension)0x0 ) ) && ( this[0x11] != (OpenXRFBFoveationExtension)0x0 )) {
         *(void**)( this + 0x28 ) = param_1;
         return this + 0x20;
      }
   }
   return (OpenXRFBFoveationExtension*)param_1;
}/* OpenXRFBFoveationExtension::~OpenXRFBFoveationExtension() */void OpenXRFBFoveationExtension::~OpenXRFBFoveationExtension(OpenXRFBFoveationExtension *this) {
   long *plVar1;
   long lVar2;
   ...
   *(undefined8*)( this + 0x38 ) = 0;
   ...
   return;
}/* OpenXRFBFoveationExtension::get_singleton() */undefined8 OpenXRFBFoveationExtension::get_singleton(void) {
   return singleton;
}/* OpenXRFBFoveationExtension::OpenXRFBFoveationExtension(String const&) */void OpenXRFBFoveationExtension::OpenXRFBFoveationExtension(OpenXRFBFoveationExtension *this, String *param_1) {
   long lVar1;
   bool bVar2;
   uint uVar3;
   undefined8 uVar4;
   ...
   *(undefined8*)( this + 0x30 ) = 0;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* OpenXRFBFoveationExtension::is_enabled() const */OpenXRFBFoveationExtension OpenXRFBFoveationExtension::is_enabled(OpenXRFBFoveationExtension *this) {
   char cVar1;
   if (*(long*)( this + 0x38 ) != 0) {
      cVar1 = OpenXRFBUpdateSwapchainExtension::is_enabled();
...
}/* OpenXRFBFoveationExtension::get_foveation_level() const */undefined4 OpenXRFBFoveationExtension::get_foveation_level(OpenXRFBFoveationExtension *this) {
   return *(undefined4*)( this + 0x14 );
}/* OpenXRFBFoveationExtension::set_foveation_level(XrFoveationLevelFB) */void OpenXRFBFoveationExtension::set_foveation_level(OpenXRFBFoveationExtension *this, undefined4 param_2) {
   code *pcVar1;
   long *plVar2;
   ...
   *(undefined4*)( this + 0x14 ) = param_2;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* OpenXRFBFoveationExtension::get_foveation_dynamic() const */undefined4 OpenXRFBFoveationExtension::get_foveation_dynamic(OpenXRFBFoveationExtension *this) {
   return *(undefined4*)( this + 0x18 );
}/* OpenXRFBFoveationExtension::set_foveation_dynamic(XrFoveationDynamicFB) */void OpenXRFBFoveationExtension::set_foveation_dynamic(OpenXRFBFoveationExtension *this, undefined4 param_2) {
   code *pcVar1;
   long *plVar2;
   CallableCustom *this_00;
   long in_FS_OFFSET;
   ...
   *(undefined4*)( this + 0x18 ) = param_2;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* OpenXRFBFoveationExtension::get_requested_extensions() */void OpenXRFBFoveationExtension::get_requested_extensions(void) {
   long lVar1;
   char cVar2;
   long *plVar3;
   long in_RSI;
   ...
   *(undefined1(*) [16])( in_RDI + 0x18 ) = (undefined1[16])0x0;
   ...
   if (cVar2 == '\0') {
      ...
      if (cVar2 != '\0') {
         ...
         plVar3 = (long*)HashMap<String,bool*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,bool*>>>::operator [](in_RDI, (String*)&local_50);
         lVar1 = local_50;
         *plVar3 = in_RSI + 0x10;
         if (local_50 != 0) {
            LOCK();
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* OpenXRFBFoveationExtension::_update_profile() */void OpenXRFBFoveationExtension::_update_profile(void) {
   code *pcVar1;
   long lVar2;
   long lVar3;
   char cVar4;
   ...
   if (plVar6 == (long*)0x0) {
      if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         ...
         LAB_00100be6:_err_print_error("_update_profile", "modules/openxr/extensions/openxr_fb_foveation_extension.cpp", uVar9, pcVar8, 0, 0);
         return;
      }
      goto LAB_00100d84;
   }
   ...
   if (( ( ( *(long*)( singleton + 0x38 ) != 0 ) && ( cVar4 = OpenXRFBUpdateSwapchainExtension::is_enabled() ),lVar3 = OpenXRAPI::singleton,cVar4 != '\0' ) ) && ( *(char*)( lVar2 + 0x10 ) != '\0' )) {
      ...
      if (*(code**)( lVar2 + 0x40 ) == (code*)0x0) {
         ...
         if (-1 < iVar5) {
            ...
            if (pcVar1 == (code*)0x0) {
               iVar5 = -0xc;
               LAB_00100b30:OpenXRAPI::get_error_string(&local_a0, lVar3, iVar5);
   ...
   LAB_00100b08:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   LAB_00100d84:/* WARNING: Subroutine does not return */__stack_chk_fail();
   ...
   return 0;
}/* CallableCustomStaticMethodPointer<void>::~CallableCustomStaticMethodPointer() */void CallableCustomStaticMethodPointer<void>::~CallableCustomStaticMethodPointer(CallableCustomStaticMethodPointer<void> *this) {
   return;
}/* CallableCustomStaticMethodPointer<void>::is_valid() const */undefined8 CallableCustomStaticMethodPointer<void>::is_valid(void) {
   return 1;
}/* CallableCustomStaticMethodPointer<void>::get_object() const */undefined8 CallableCustomStaticMethodPointer<void>::get_object(void) {
   return 0;
}/* CallableCustomStaticMethodPointer<void>::get_argument_count(bool&) const */undefined8 CallableCustomStaticMethodPointer<void>::get_argument_count(CallableCustomStaticMethodPointer<void> *this, bool *param_1) {
   *param_1 = true;
   return 0;
...
OpenXRExtensionWrapper::get_viewport_composition_layer_extension_property_defaults
   ...
   Callable::CallError&) const */void CallableCustomStaticMethodPointer<void>::call(CallableCustomStaticMethodPointer<void> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   code *UNRECOVERED_JUMPTABLE;
   UNRECOVERED_JUMPTABLE = *(code**)( this + 0x28 );
   if (param_2 == 0) {
      *(undefined4*)param_4 = 0;
      for (int i_614 = 0; i_614 < 2; i_614++) {
   ...
   *(void**)( this + 8 ) = pvVar43;
   if (uVar55 != 0) {
      ...
      LAB_001019be:if (iVar45 != 0) {
         LAB_001019c6:uVar37 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
   ...
   LAB_001014ca:uVar55 = *(uint*)( this + 0x28 );
   if (uVar55 == 0x1c) {
   ...
   *(void**)( this + 8 ) = __s_00;
   ...
   if (iVar45 != 0) {
      ...
      LAB_001019ba:iVar45 = *(int*)( this + 0x2c );
      goto LAB_001019be;
   }
   LAB_001014a4:if ((float)uVar39 * __LC12 < (float)( iVar45 + 1 )) goto LAB_001014ca;
}local_58[0] = 0;if (*(long*)param_1 == 0) {
   pauVar41 = (undefined1(*) [16])operator_new(0x20, "");
   *(undefined8*)pauVar41[1] = 0;
   *pauVar41 = (undefined1[16])0x0;
   LAB_00101afb:*(undefined8*)( pauVar41[1] + 8 ) = 0;
   LAB_00101753:puVar42 = *(undefined8**)( this + 0x20 );
   if (puVar42 != (undefined8*)0x0) goto LAB_00101760;
   LAB_00101995:*(undefined1(**) [16])( this + 0x18 ) = pauVar41;
} else {
   ...
   *(undefined8**)( *pauVar41 + 8 ) = puVar42;
...
}*(undefined1(**) [16])( lVar46 + lVar47 * 8 ) = pauVar57;*puVar50 = uVar55;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_0010186b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return pauVar41[1] + 8;
}/* WARNING: Subroutine does not return */__stack_chk_fail();}/* String stringify_variants<char const*>(Variant const&, char const*) */Variant *stringify_variants<char_const*>(Variant *param_1, char *param_2) {
   long *plVar1;
   long lVar2;
   undefined *puVar3;
   char *in_RDX;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* void print_line<String, char const*>(Variant const&, String, char const*) */void print_line<String,char_const*>(undefined8 param_1, long *param_2) {
   long *plVar1;
   long lVar2;
   undefined *puVar3;
   long lVar4;
   ...
   LAB_00101e7e:Variant::Variant((Variant*)local_58, (String*)&local_90);
   ...
   return;
}/* WARNING: Control flow encountered bad instruction data *//* CallableCustomStaticMethodPointer<void>::~CallableCustomStaticMethodPointer() */void CallableCustomStaticMethodPointer<void>::~CallableCustomStaticMethodPointer(CallableCustomStaticMethodPointer<void> *this) {

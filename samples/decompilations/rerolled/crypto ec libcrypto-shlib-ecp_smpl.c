      ...
      if (iVar1 != 0) {
         if (*(code**)( *param_1 + 0x118 ) == (code*)0x0) {
            ...
            if (iVar1 != 0) {
               ...
               if (( iVar1 != 0 ) && ( ( ( *(code**)( *param_1 + 0x118 ) == (code*)0x0 || ( iVar1 = ( **(code**)( *param_1 + 0x118 ) )(param_1, param_1[0xd], param_1[0xd], param_5) ),iVar1 != 0 ) ) && ( iVar1 = BN_add_word(r, 3) ),iVar1 != 0 )) {
                  uVar3 = 1;
...
bool ossl_ec_GFp_simple_dbl(EC_GROUP *param_1, long param_2, EC_POINT *param_3, BN_CTX *param_4) {
   ...
   if (r_01 != (BIGNUM*)0x0) {
      if (*(int*)( param_3 + 0x28 ) == 0) {
         ...
         iVar4 = ( *pcVar2 )(param_1, a, *(undefined8*)( param_3 + 0x10 ), param_4);
         if (( ( iVar4 == 0 ) || ( iVar4 = BN_mod_lshift1_quick(r, a, m) ),iVar4 == 0 )) goto LAB_00100d10;

uint cipher_compare(long param_1, long param_2) {
   ...
   *(ulong*)( param_1 + 0x58 ) = ( ulong )((uint)uVar1 & 0x6000);
   ...
   for (int i_2272 = 0; i_2272 < 4; i_2272++) {
      param_1[( i_2272 + 704 )] = 0;
   }
   return 1;
...
LAB_00101757:
    ...
    ERR_set_error(0x14,0xc0102,0);
      ...
      case 100:
      case 0x67:
      for (int i_2275 = 0; i_2275 < 7; i_2275++) {
         case 0x6c:
      }
      for (int i_2274 = 0; i_2274 < 8; i_2274++) {
         case 0x77:
      }
      for (int i_2273 = 0; i_2273 < 6; i_2273++) {
         case 0x82:
      }
      case 0x88:
    goto switchD_00101083_caseD_5;
   ...
   *(undefined8*)( param_1 + 0x260 ) = param_2;
   ...
   if (*param_1 == 0) {
      ...
      *piVar1 = 0;
      ...
      for (int i_2276 = 0; i_2276 < 2; i_2276++) {

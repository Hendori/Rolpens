/* ProgressDialog::_cancel_pressed() */

void __thiscall ProgressDialog::_cancel_pressed(ProgressDialog *this)
...
/* ProgressDialog::_notification(int) [clone .part.0] */

void ProgressDialog::_notification(int param_1)
...
/* ProgressDialog::_notification(int) */

void __thiscall ProgressDialog::_notification(ProgressDialog *this,int param_1)
...

{
  ...
  if (lVar3 == 0) {
    _err_print_error("_popup","editor/progress_dialog.cpp",0xaa,
                     "Parameter \"current_window\" is null.",0,0);
  }
  else {
...
/* ProgressDialog::add_host_window(Window*) */

void __thiscall ProgressDialog::add_host_window(ProgressDialog *this,Window *param_1)

{
  ...
  if (param_1 == (Window *)0x0) {
    _err_print_error("add_host_window","editor/progress_dialog.cpp",0x102,
                     "Parameter \"p_window\" is null.",0,0);
    return;
  }
...
/* ProgressDialog::remove_host_window(Window*) */

void __thiscall ProgressDialog::remove_host_window(ProgressDialog *this,Window *param_1)

{
  ...
  if (param_1 == (Window *)0x0) {
    _err_print_error("remove_host_window","editor/progress_dialog.cpp",0x107,
                     "Parameter \"p_window\" is null.",0,0);
    return;
  }
  uVar1 = *(uint *)(this + 0xa58);
  ...
  if (uVar1 != 0) {
    ...
    if (uVar1 <= uVar3) {
      _err_print_index_error
                ("remove_at","./core/templates/local_vector.h",0x4c,uVar4,(ulong)uVar1,"p_index",
                 "count","",false,false);
      return;
    }
    *(uint *)(this + 0xa58) = uVar1 - 1;
...
void __thiscall ProgressDialog::ProgressDialog(ProgressDialog *this)
...
/* BackgroundProgress::add_task(String const&, String const&, int) */

void __thiscall
BackgroundProgress::add_task(BackgroundProgress *this,String *param_1,String *param_2,int param_3)
...
/* BackgroundProgress::end_task(String const&) */

void __thiscall BackgroundProgress::end_task(BackgroundProgress *this,String *param_1)
...
/* BackgroundProgress::task_step(String const&, int) */

void __thiscall BackgroundProgress::task_step(BackgroundProgress *this,String *param_1,int param_2)

{
  ...
  if (iVar2 == 0) {
    ...
    iVar2 = pthread_mutex_lock(__mutex);
    if (iVar2 == 0) {
      piVar3 = (int *)HashMap<String,int,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,int>>>
...
/* BackgroundProgress::_add_task(String const&, String const&, int) */

void __thiscall
BackgroundProgress::_add_task(BackgroundProgress *this,String *param_1,String *param_2,int param_3)

{
  ...
  cVar1 = HashMap<String,BackgroundProgress::Task,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,BackgroundProgress::Task>>>
          ::_lookup_pos((HashMap<String,BackgroundProgress::Task,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,BackgroundProgress::Task>>>
                         *)(this + 0xa38),param_1,(uint *)&local_50);
  if (cVar1 == '\0') {
    ...
    *(undefined ***)this_00 = &PTR__initialize_classv_00109780;
    ...
    Node::add_child(this,this_00,0,0);
    puVar3 = (undefined8 *)
             HashMap<String,BackgroundProgress::Task,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,BackgroundProgress::Task>>>
             ::operator[]((HashMap<String,BackgroundProgress::Task,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,BackgroundProgress::Task>>>
                           *)(this + 0xa38),param_1);
    *puVar3 = this_00;
    puVar3[1] = this_02;
    if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
LAB_0010130d:
    ...
    operator+((char *)local_60,(String *)"Task \'");
    String::operator+((String *)&local_50,(String *)local_60);
    _err_print_error("_add_task","editor/progress_dialog.cpp",0x2c,
                     "Condition \"tasks.has(p_task)\" is true.",(CowData<char32_t> *)&local_50,0,0);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_50);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* BackgroundProgress::_task_step(String const&, int) */

void __thiscall BackgroundProgress::_task_step(BackgroundProgress *this,String *param_1,int param_2)

{
  ...
  cVar1 = HashMap<String,BackgroundProgress::Task,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,BackgroundProgress::Task>>>
          ::_lookup_pos((HashMap<String,BackgroundProgress::Task,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,BackgroundProgress::Task>>>
                         *)(this + 0xa38),param_1,&local_34);
  if (cVar1 == '\0') {
    _err_print_error("_task_step","editor/progress_dialog.cpp",0x51,
                     "Condition \"!tasks.has(p_task)\" is true.",0,0);
...
/* BackgroundProgress::_update() */

void __thiscall BackgroundProgress::_update(BackgroundProgress *this)
        ...
        do {
          if (uVar15 == uVar16) {
            cVar13 = String::operator==((String *)
                                        (*(long *)(*(long *)(this + 0xa40) + lVar17 * 8) + 0x10),
                                        (String *)(puVar2 + 2));
            if (cVar13 != '\0') {
          ...
          iVar14 = SUB164(auVar5 * auVar9,8);
                ...
                (auVar6._8_8_ = 0, auVar6._0_8_ = (ulong)uVar15 * lVar18, auVar10._8_8_ = 0,
                auVar10._0_8_ = uVar12, auVar7._8_8_ = 0,
                auVar7._0_8_ = (ulong)((uVar1 + iVar14) - SUB164(auVar6 * auVar10,8)) * lVar18,
...
/* BackgroundProgress::_end_task(String const&) */

void __thiscall BackgroundProgress::_end_task(BackgroundProgress *this,String *param_1)

{
  ...
  *this_00;
  ...
  this_00 = (HashMap<String,BackgroundProgress::Task,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,BackgroundProgress::Task>>>
             *)(this + 0xa38);
  local_44 = 0;
  cVar26 = HashMap<String,BackgroundProgress::Task,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,BackgroundProgress::Task>>>
           ::_lookup_pos(this_00,param_1,&local_44);
  if (cVar26 == '\0') {
    _err_print_error("_end_task","editor/progress_dialog.cpp",0x5e,
                     "Condition \"!tasks.has(p_task)\" is true.",0,0);
...
/* ProgressDialog::add_task(String const&, String const&, int, bool) */

void __thiscall
ProgressDialog::add_task
          (ProgressDialog *this,String *param_1,String *param_2,int param_3,bool param_4)

{
  ...
  if (cVar1 == '\0') {
    ...
    cVar1 = HashMap<String,ProgressDialog::Task,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ProgressDialog::Task>>>
            ::_lookup_pos((HashMap<String,ProgressDialog::Task,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ProgressDialog::Task>>>
                           *)(this + 0xa18),param_1,(uint *)&local_68);
    if (cVar1 == '\0') {
      local_68 = 0;
      local_48 = 0;
      this_00 = (BoxContainer *)operator_new(0xa10,"");
      ...
      *(undefined ***)this_01 = &PTR__initialize_classv_00109af8;
      ...
      this_04 = (CowData<char32_t> *)
                HashMap<String,ProgressDialog::Task,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ProgressDialog::Task>>>
                ::operator[]((HashMap<String,ProgressDialog::Task,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ProgressDialog::Task>>>
                              *)(this + 0xa18),param_1);
      ...
      *(undefined8 *)(this_04 + 0x20) = 0;
      ...
      operator+((char *)local_78,(String *)"Task \'");
      String::operator+((String *)&local_68,(String *)local_78);
      _err_print_error("add_task","editor/progress_dialog.cpp",0xbb,
                       "Condition \"tasks.has(p_task)\" is true.",(CowData<char32_t> *)&local_68,0,0
                      );
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_68);
    ...
    _err_print_error("add_task","editor/progress_dialog.cpp",0xb7,
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ProgressDialog::task_step(String const&, String const&, int, bool) */

ProgressDialog __thiscall
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  local_44 = 0;
  cVar2 = HashMap<String,ProgressDialog::Task,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ProgressDialog::Task>>>
          ::_lookup_pos((HashMap<String,ProgressDialog::Task,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ProgressDialog::Task>>>
                         *)(this + 0xa18),param_1,&local_44);
  if (cVar2 == '\0') {
    _err_print_error("task_step","editor/progress_dialog.cpp",0xd9,
                     "Condition \"!tasks.has(p_task)\" is true. Returning: canceled",0,0);
    PVar1 = this[0xa70];
    goto LAB_00101e6c;
  }
  lVar3 = HashMap<String,ProgressDialog::Task,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ProgressDialog::Task>>>
          ::operator[]((HashMap<String,ProgressDialog::Task,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ProgressDialog::Task>>>
                        *)(this + 0xa18),param_1);
  if (param_4) {
LAB_00101e0c:
...
/* ProgressDialog::end_task(String const&) */

void __thiscall ProgressDialog::end_task(ProgressDialog *this,String *param_1)

{
  ...
  *this_00;
  ...
  this_00 = (HashMap<String,ProgressDialog::Task,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ProgressDialog::Task>>>
             *)(this + 0xa18);
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  local_44 = 0;
  cVar25 = HashMap<String,ProgressDialog::Task,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ProgressDialog::Task>>>
           ::_lookup_pos(this_00,param_1,&local_44);
  if (cVar25 == '\0') {
    if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
      _err_print_error("end_task","editor/progress_dialog.cpp",0xf0,
                       "Condition \"!tasks.has(p_task)\" is true.",0,0);
      return;
    }
    goto LAB_00102280;
  }
  lVar27 = HashMap<String,ProgressDialog::Task,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ProgressDialog::Task>>>
           ::operator[](this_00,param_1);
...
/* CallableCustomMethodPointer<ProgressDialog, void>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<ProgressDialog,void>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<ProgressDialog,void> *this)
...
void __thiscall
CallableCustomMethodPointer<BackgroundProgress,void,String_const&>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<BackgroundProgress,void,String_const&> *this)
...
/* CallableCustomMethodPointer<BackgroundProgress, void>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<BackgroundProgress,void>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<BackgroundProgress,void> *this)
...
void __thiscall
CallableCustomMethodPointer<BackgroundProgress,void,String_const&,String_const&,int>::
...
/* CallableCustomMethodPointer<ProgressDialog, void>::get_argument_count(bool&) const */

undefined8 __thiscall
CallableCustomMethodPointer<ProgressDialog,void>::get_argument_count
          (CallableCustomMethodPointer<ProgressDialog,void> *this,bool *param_1)
...
undefined8 __thiscall
CallableCustomMethodPointer<BackgroundProgress,void,String_const&>::get_argument_count
          (CallableCustomMethodPointer<BackgroundProgress,void,String_const&> *this,bool *param_1)
...
/* CallableCustomMethodPointer<BackgroundProgress, void>::get_argument_count(bool&) const */

undefined8 __thiscall
CallableCustomMethodPointer<BackgroundProgress,void>::get_argument_count
          (CallableCustomMethodPointer<BackgroundProgress,void> *this,bool *param_1)
...
undefined8 __thiscall
CallableCustomMethodPointer<BackgroundProgress,void,String_const&,String_const&,int>::
get_argument_count(CallableCustomMethodPointer<BackgroundProgress,void,String_const&,String_const&,int>
                   *this,bool *param_1)
...
/* ProgressDialog::_property_get_revertv(StringName const&, Variant&) const */

undefined8 ProgressDialog::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* ProgressDialog::_property_can_revertv(StringName const&) const */

undefined8 ProgressDialog::_property_can_revertv(StringName *param_1)
...
/* CallableCustomMethodPointer<BackgroundProgress, void, String const&>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<BackgroundProgress,void,String_const&>::get_object
          (CallableCustomMethodPointer<BackgroundProgress,void,String_const&> *this)
...
/* CallableCustomMethodPointer<ProgressDialog, void>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<ProgressDialog,void>::get_object
          (CallableCustomMethodPointer<ProgressDialog,void> *this)
...
undefined8 __thiscall
CallableCustomMethodPointer<BackgroundProgress,void,String_const&,String_const&,int>::get_object
          (CallableCustomMethodPointer<BackgroundProgress,void,String_const&,String_const&,int>
           *this)
...
/* CallableCustomMethodPointer<BackgroundProgress, void>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<BackgroundProgress,void>::get_object
          (CallableCustomMethodPointer<BackgroundProgress,void> *this)
...
/* ProgressDialog::_validate_propertyv(PropertyInfo&) const */

void ProgressDialog::_validate_propertyv(PropertyInfo *param_1)
...
/* ProgressDialog::is_class_ptr(void*) const */

uint ProgressDialog::is_class_ptr(void *param_1)

{
  ...
  if (in_RSI != &get_class_ptr_static()::ptr) {
    uVar1 = (uint)CONCAT71(0x10a4,in_RSI == &Container::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10a4,in_RSI == &CenterContainer::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10a4,in_RSI == &Control::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10a4,in_RSI == &CanvasItem::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10a4,in_RSI == &Node::get_class_ptr_static()::ptr) |
...
/* ProgressDialog::_setv(StringName const&, Variant const&) */

undefined8 ProgressDialog::_setv(StringName *param_1,Variant *param_2)
...

{
  ...
  if (in_RSI != &get_class_ptr_static()::ptr) {
    uVar1 = (uint)CONCAT71(0x10a4,in_RSI == &Container::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10a4,in_RSI == &BoxContainer::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10a4,in_RSI == &Control::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10a4,in_RSI == &CanvasItem::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10a4,in_RSI == &Node::get_class_ptr_static()::ptr) |
            CONCAT31((int3)((uint)in_EDX >> 8),in_RSI == &Object::get_class_ptr_static()::ptr);
...
/* ProgressDialog::_getv(StringName const&, Variant&) const */

undefined8 ProgressDialog::_getv(StringName *param_1,Variant *param_2)
...
/* ProgressDialog::_get_class_namev() const */

undefined8 * ProgressDialog::_get_class_namev(void)
...
LAB_00103113:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"ProgressDialog");
      goto LAB_0010317e;
    }
  }
  StringName::assign_static_unique_class_name
...
/* ProgressDialog::_notificationv(int, bool) */

void __thiscall ProgressDialog::_notificationv(ProgressDialog *this,int param_1,bool param_2)
...
/* ProgressDialog::get_class() const */

void ProgressDialog::get_class(void)
...
LAB_00103f14:
    if ((float)uVar39 * __LC31 < (float)(iVar44 + 1)) goto LAB_00103f3a;
  }
  local_58 = 0;
  if (*(long *)param_1 == 0) {
    local_50 = 0;
...
void __thiscall
CallableCustomMethodPointer<ProgressDialog,void>::call
          (CallableCustomMethodPointer<ProgressDialog,void> *this,Variant **param_1,int param_2,
...
void __thiscall
CallableCustomMethodPointer<BackgroundProgress,void>::call
          (CallableCustomMethodPointer<BackgroundProgress,void> *this,Variant **param_1,int param_2,
          Variant *param_3,CallError *param_4)
...
void __thiscall
CallableCustomMethodPointer<BackgroundProgress,void,String_const&,String_const&,int>::call
          (CallableCustomMethodPointer<BackgroundProgress,void,String_const&,String_const&,int>
...
void __thiscall
CallableCustomMethodPointer<BackgroundProgress,void,String_const&>::call
          (CallableCustomMethodPointer<BackgroundProgress,void,String_const&> *this,
...
/* ProgressDialog::is_class(String const&) const */

undefined8 __thiscall ProgressDialog::is_class(ProgressDialog *this,String *param_1)
...
/* ProgressDialog::_initialize_classv() */

void ProgressDialog::_initialize_classv(void)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (initialize_class()::initialized == '\0') {
    if (CenterContainer::initialize_class()::initialized == '\0') {
      if (Container::initialize_class()::initialized == '\0') {
        if (Control::initialize_class()::initialized == '\0') {
          if (CanvasItem::initialize_class()::initialized == '\0') {
            if (Node::initialize_class()::initialized == '\0') {
      ...
      CenterContainer::initialize_class()::initialized = '\x01';
    }
    local_50 = 0;
...
/* CenterContainer::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void __thiscall
CenterContainer::_get_property_listv(CenterContainer *this,List *param_1,bool param_2)
...
/* ProgressDialog::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void __thiscall ProgressDialog::_get_property_listv(ProgressDialog *this,List *param_1,bool param_2)
...
/* HashMap<String, ProgressDialog::Task, HashMapHasherDefault, HashMapComparatorDefault<String>,
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  local_c0 = 0;
  cVar21 = _lookup_pos(this,param_1,&local_c0);
  if (cVar21 != '\0') {
  ...
  local_bc = 0;
  cVar21 = _lookup_pos(this,param_1,&local_bc);
  if (cVar21 == '\0') {
    if ((float)uVar31 * __LC31 < (float)(*(int *)(this + 0x2c) + 1)) {
      uVar31 = *(uint *)(this + 0x28);
      if (uVar31 == 0x1c) {
    ...
    if (*(long *)param_1 == 0) {
      ...
      local_70[1] = (CowData<char32_t>)0x0;
      local_70[2] = (CowData<char32_t>)0x0;
      local_70[3] = (CowData<char32_t>)0x0;
      local_70[4] = (CowData<char32_t>)0x0;
      local_70[5] = (CowData<char32_t>)0x0;
      local_70[6] = (CowData<char32_t>)0x0;
      local_70[7] = (CowData<char32_t>)0x0;
      local_70[8] = (CowData<char32_t>)0x0;
      local_70[9] = (CowData<char32_t>)0x0;
      local_70[10] = (CowData<char32_t>)0x0;
      local_70[0xb] = (CowData<char32_t>)0x0;
      local_70[0xc] = (CowData<char32_t>)0x0;
      local_70[0xd] = (CowData<char32_t>)0x0;
      local_70[0xe] = (CowData<char32_t>)0x0;
      local_70[0xf] = (CowData<char32_t>)0x0;

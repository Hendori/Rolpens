...
;
      ...
      *plVar1 = *plVar1 + -1;
      ...
      LAB_00101666:if (param_2 != 0x100) {
         ...
         if (param_2 != 0x10) {
            if (( param_2 != 1 ) || ( cVar3 = is_print_verbose_enabled() ),cVar3 == '\0') goto LAB_00101696;
...
*(undefined1(**) [16])( lVar46 + lVar47 * 8 ) = pauVar57;*puVar50 = uVar55;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_001028fb:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return pauVar41[1] + 8;
}

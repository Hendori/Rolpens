/* CowData<int>::_copy_on_write() [clone .isra.0] */void CowData<int>::_copy_on_write(CowData<int> *this) {
   ...
   *(undefined4*)( this + 0x28 ) = *(undefined4*)( param_1 + 0x28 );
   return;
}/* EditorImportPlugin::EditorImportPlugin() */void EditorImportPlugin::EditorImportPlugin(EditorImportPlugin *this) {
   ...
   *(undefined8*)( this + 0x2c8 ) = 0;
   ...
   DefaultTypedAllocator<HashMapElement<StringName, Variant> > > const&, String const&, Variant) */ulong EditorImportPlugin::append_import_external_resource(undefined8 param_1_00, undefined8 param_1, undefined8 param_2, undefined8 param_3, Variant *param_5) {
   long lVar1;
   ulong uVar2;
   long in_FS_OFFSET;
   int local_48[6];
   ...
   if (*(char*)( EditorFileSystem::singleton + 0x452 ) == '\0') {
      _err_print_error("append_import_external_resource", "editor/import/editor_import_plugin.cpp", 0xd9, "Condition \"!EditorFileSystem::get_singleton()->is_importing()\" is true. Returning: ERR_INVALID_PARAMETER", "Can only append files to import during a current reimport process.", 0, 0);
      uVar2 = 0x1f;
   } else {
   ...
   const&, Variant) */undefined4 EditorImportPlugin::_append_import_external_resource(EditorImportPlugin *this, undefined8 param_1, List *param_2, undefined8 param_3, Variant *param_5) {
   uint uVar1;
   undefined4 uVar2;
   long lVar3;
   void *pvVar4;
   ...
   if (local_a0 != (long*)0x0) {
      for (lVar3 = *local_a0; lVar3 != 0; lVar3 = *(long*)( lVar3 + 0x18 )) {
         ...
         HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>::insert(local_90, local_88, SUB81((Variant*)&local_98, 0));
   ...
   LAB_001008ca:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar2;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   return;
}/* EditorImportPlugin::get_importer_name() const */void EditorImportPlugin::get_importer_name(void) {
   code *pcVar1;
   undefined4 uVar2;
   undefined8 uVar3;
   long lVar4;
   ...
   local_110 = 0;
   if (plVar5 == (long*)0x0) {
      LAB_00100c2b:if (( *(long*)( in_RSI + 8 ) != 0 ) && ( *(char*)( in_RSI + 0x188 ) == '\0' )) {
         local_c8 = 0;
         uStack_c4 = 0;
         ...
         *(undefined8*)( in_RSI + 400 ) = 0;
         ...
         if (( ( pcVar6 == (code*)0x0 ) || ( *(long*)( lVar4 + 0xe0 ) == 0 ) ) && ( pcVar6 = *(code**)( lVar4 + 0xd0 ) ),pcVar6 == (code*)0x0) {
            ...
            if (local_f0[0] == 0) {
               ...
               if (( StringName::configured != '\0' ) && ( lVar4 = local_100 != 0 )) goto LAB_00100fcf;
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_108);
               LAB_00100fe4:lVar4 = *(long*)( in_RSI + 8 );
               pcVar6 = *(code**)( lVar4 + 200 );
               if (( ( pcVar6 == (code*)0x0 ) || ( *(long*)( lVar4 + 0xe0 ) == 0 ) ) && ( pcVar6 = *(code**)( lVar4 + 0xc0 ) ),pcVar6 == (code*)0x0) goto LAB_00100f1f;
         ...
         LAB_00100f1f:if (*(char*)( lVar4 + 0x29 ) != '\0') {
      ...
      if (pcVar6 == (code*)0x0) {
         _err_print_error("get_importer_name", "editor/import/editor_import_plugin.cpp", 0x2c, "Method/function failed. Returning: String()", "Unimplemented _get_importer_name in add-on.", 0, 0);
         *in_RDI = 0;
         goto LAB_00100cd7;
      }
      local_f8 = 0;
      ...
      if (pcVar1 == (code*)0x0) {
         ...
         lVar7 = local_110;
         joined_r0x00100dd8:local_110 = lVar7;
         if (lVar4 != 0) {
         ...
         ( *pcVar1 )(*(undefined8*)( in_RSI + 0x10 ), in_RSI + 0x180, pcVar6, 0, (CowData<char32_t>*)&local_f8);
         local_c8 = 0;
         uStack_c4 = 0;
         lVar7 = local_110;
         if (local_f8 != 0) {
   ...
   *in_RDI = lVar7;
   LAB_00100cd7:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* EditorImportPlugin::get_visible_name() const */void EditorImportPlugin::get_visible_name(void) {
   code *pcVar1;
   undefined4 uVar2;
   undefined8 uVar3;
   long lVar4;
   ...
   local_110 = 0;
   if (plVar5 == (long*)0x0) {
      LAB_0010113b:if (( *(long*)( in_RSI + 8 ) != 0 ) && ( *(char*)( in_RSI + 0x1a0 ) == '\0' )) {
         local_c8 = 0;
         uStack_c4 = 0;
         local_b8 = (undefined1[16])0x0;
         uStack_c0 = 0;
         ...
         *(undefined8*)( in_RSI + 0x1a8 ) = 0;
         ...
         if (( ( pcVar6 == (code*)0x0 ) || ( *(long*)( lVar4 + 0xe0 ) == 0 ) ) && ( pcVar6 = *(code**)( lVar4 + 0xd0 ) ),pcVar6 == (code*)0x0) {
            ...
            if (local_f0[0] == 0) {
               CowData<unsigned_int>::_unref((CowData<unsigned_int>*)local_f0);
               if (( StringName::configured != '\0' ) && ( lVar4 = local_100 != 0 )) goto LAB_001014df;
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_108);
               LAB_001014f4:lVar4 = *(long*)( in_RSI + 8 );
               pcVar6 = *(code**)( lVar4 + 200 );
               if (( ( pcVar6 == (code*)0x0 ) || ( *(long*)( lVar4 + 0xe0 ) == 0 ) ) && ( pcVar6 = *(code**)( lVar4 + 0xc0 ) ),pcVar6 == (code*)0x0) goto LAB_0010142f;
         ...
         LAB_0010142f:if (*(char*)( lVar4 + 0x29 ) != '\0') {
            plVar5 = (long*)operator_new(0x18, "");
            *plVar5 = in_RSI + 0x1a8;
      ...
      if (pcVar6 == (code*)0x0) {
         _err_print_error("get_visible_name", "editor/import/editor_import_plugin.cpp", 0x34, "Method/function failed. Returning: String()", "Unimplemented _get_visible_name in add-on.", 0, 0);
         *in_RDI = 0;
         goto LAB_001011e7;
      }
      local_f8 = 0;
      ...
      if (pcVar1 == (code*)0x0) {
         ...
         lVar4 = CONCAT44(uStack_c4, local_c8);
         lVar7 = local_110;
         joined_r0x001012e8:local_110 = lVar7;
         if (lVar4 != 0) {
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_110);
            local_c8 = 0;
            uStack_c4 = 0;
         ...
         ( *pcVar1 )(*(undefined8*)( in_RSI + 0x10 ), in_RSI + 0x198, pcVar6, 0, (CowData<char32_t>*)&local_f8);
         local_c8 = 0;
         uStack_c4 = 0;
         lVar7 = local_110;
         if (local_f8 != 0) {
   ...
   *in_RDI = lVar7;
   LAB_001011e7:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* EditorImportPlugin::get_recognized_extensions(List<String, DefaultAllocator>*) const */void EditorImportPlugin::get_recognized_extensions(EditorImportPlugin *this, List *param_1) {
   long lVar1;
   undefined4 uVar2;
   CowData<char32_t> *this_00;
   ...
   local_100 = 0;
   if (plVar6 == (long*)0x0) {
      LAB_0010164b:if (( *(long*)( this + 8 ) != 0 ) && ( this[0x1e8] == (EditorImportPlugin)0x0 )) {
         local_c8 = 0;
         local_b8 = (undefined1[16])0x0;
         local_c0 = 0;
         local_a8 = 0;
         ...
         *(undefined8*)( this + 0x1f0 ) = 0;
         ...
         if (( ( pcVar7 == (code*)0x0 ) || ( *(long*)( lVar5 + 0xe0 ) == 0 ) ) && ( pcVar7 = *(code**)( lVar5 + 0xd0 ) ),pcVar7 == (code*)0x0) {
            ...
            if (CONCAT44(uStack_ec, uStack_f0) == 0) {
               ...
               LAB_00101afd:lVar5 = *(long*)( this + 8 );
               pcVar7 = *(code**)( lVar5 + 200 );
               if (( ( pcVar7 == (code*)0x0 ) || ( *(long*)( lVar5 + 0xe0 ) == 0 ) ) && ( pcVar7 = *(code**)( lVar5 + 0xc0 ) ),pcVar7 == (code*)0x0) goto LAB_001019f7;
         ...
         LAB_001019f7:if (*(char*)( lVar5 + 0x29 ) != '\0') {
      ...
      if (pcVar7 == (code*)0x0) {
         _err_print_error("get_recognized_extensions", "editor/import/editor_import_plugin.cpp", 0x40, "Method/function failed.", "Unimplemented _get_recognized_extensions in add-on.", 0, 0);
         goto LAB_001017c6;
      }
      uStack_f0 = 0;
      uStack_ec = 0;
      if (*(code**)( *(long*)( this + 8 ) + 0xe0 ) == (code*)0x0) {
         ...
         ( **(code**)( *(long*)( this + 8 ) + 0xe0 ) )(*(undefined8*)( this + 0x10 ), this + 0x1e0, pcVar7, 0, local_f8);
      }
      local_c0 = 0;
      ...
      LAB_00101842:if (lVar5 == 0) goto LAB_001017c6;
   }
   lVar8 = 0;
   if (0 < *(long*)( lVar5 + -8 )) {
      do {
   ...
   LAB_001017c6:CowData<String>::_unref((CowData<String>*)&local_100);
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return;
}/* EditorImportPlugin::get_preset_count() const */int EditorImportPlugin::get_preset_count(EditorImportPlugin *this) {
   int iVar1;
   undefined4 uVar2;
   undefined8 uVar3;
   long lVar4;
   ...
   if (( *(long*)( this + 8 ) != 0 ) && ( this[0x1b8] == (EditorImportPlugin)0x0 )) {
      ...
      *(undefined8*)( this + 0x1c0 ) = 0;
      ...
      if (( ( pcVar6 == (code*)0x0 ) || ( *(long*)( lVar4 + 0xe0 ) == 0 ) ) && ( pcVar6 = *(code**)( lVar4 + 0xd0 ) ),pcVar6 == (code*)0x0) {
         ...
         if (local_f0[0] == 0) {
            CowData<unsigned_int>::_unref((CowData<unsigned_int>*)local_f0);
            if (( StringName::configured != '\0' ) && ( lVar4 = local_100 != 0 )) goto LAB_00101f18;
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_108);
            LAB_00101f2d:lVar4 = *(long*)( this + 8 );
            pcVar6 = *(code**)( lVar4 + 200 );
            if (( ( pcVar6 == (code*)0x0 ) || ( *(long*)( lVar4 + 0xe0 ) == 0 ) ) && ( pcVar6 = *(code**)( lVar4 + 0xc0 ) ),pcVar6 == (code*)0x0) goto LAB_00101e70;
      ...
      LAB_00101e70:if (*(char*)( lVar4 + 0x29 ) != '\0') {
         plVar5 = (long*)operator_new(0x18, "");
   ...
   if (pcVar6 == (code*)0x0) {
      _err_print_error("get_preset_count", "editor/import/editor_import_plugin.cpp", 0x50, "Method/function failed. Returning: -1", "Unimplemented _get_preset_count in add-on.", 0, 0);
      iVar1 = -1;
   ...
   LAB_00101c96:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return iVar1;
}/* EditorImportPlugin::get_save_extension() const */void EditorImportPlugin::get_save_extension(void) {
   code *pcVar1;
   undefined4 uVar2;
   undefined8 uVar3;
   long lVar4;
   ...
   local_110 = 0;
   if (plVar5 == (long*)0x0) {
      LAB_0010208b:if (( *(long*)( in_RSI + 8 ) != 0 ) && ( *(char*)( in_RSI + 0x218 ) == '\0' )) {
         local_c8 = 0;
         uStack_c4 = 0;
         local_b8 = (undefined1[16])0x0;
         uStack_c0 = 0;
         ...
         *(undefined8*)( in_RSI + 0x220 ) = 0;
         ...
         if (( ( pcVar6 == (code*)0x0 ) || ( *(long*)( lVar4 + 0xe0 ) == 0 ) ) && ( pcVar6 = *(code**)( lVar4 + 0xd0 ) ),pcVar6 == (code*)0x0) {
            ...
            if (local_f0[0] == 0) {
               CowData<unsigned_int>::_unref((CowData<unsigned_int>*)local_f0);
               if (( StringName::configured != '\0' ) && ( lVar4 = local_100 != 0 )) goto LAB_0010242f;
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_108);
               LAB_00102444:lVar4 = *(long*)( in_RSI + 8 );
               pcVar6 = *(code**)( lVar4 + 200 );
               if (( ( pcVar6 == (code*)0x0 ) || ( *(long*)( lVar4 + 0xe0 ) == 0 ) ) && ( pcVar6 = *(code**)( lVar4 + 0xc0 ) ),pcVar6 == (code*)0x0) goto LAB_0010237f;
         ...
         LAB_0010237f:if (*(char*)( lVar4 + 0x29 ) != '\0') {
            plVar5 = (long*)operator_new(0x18, "");
            *plVar5 = in_RSI + 0x220;
      ...
      if (pcVar6 == (code*)0x0) {
         _err_print_error("get_save_extension", "editor/import/editor_import_plugin.cpp", 0x58, "Method/function failed. Returning: String()", "Unimplemented _get_save_extension in add-on.", 0, 0);
         *in_RDI = 0;
         goto LAB_00102137;
      }
      local_f8 = 0;
      ...
      if (pcVar1 == (code*)0x0) {
         ...
         lVar4 = CONCAT44(uStack_c4, local_c8);
         lVar7 = local_110;
         joined_r0x00102238:local_110 = lVar7;
         if (lVar4 != 0) {
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_110);
            local_c8 = 0;
            uStack_c4 = 0;
         ...
         ( *pcVar1 )(*(undefined8*)( in_RSI + 0x10 ), in_RSI + 0x210, pcVar6, 0, (CowData<char32_t>*)&local_f8);
         local_c8 = 0;
         uStack_c4 = 0;
         lVar7 = local_110;
         if (local_f8 != 0) {
   ...
   *in_RDI = lVar7;
   LAB_00102137:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* EditorImportPlugin::get_resource_type() const */void EditorImportPlugin::get_resource_type(void) {
   code *pcVar1;
   undefined4 uVar2;
   undefined8 uVar3;
   long lVar4;
   ...
   local_110 = 0;
   if (plVar5 == (long*)0x0) {
      LAB_0010259b:if (( *(long*)( in_RSI + 8 ) != 0 ) && ( *(char*)( in_RSI + 0x230 ) == '\0' )) {
         local_c8 = 0;
         uStack_c4 = 0;
         local_b8 = (undefined1[16])0x0;
         uStack_c0 = 0;
         ...
         *(undefined8*)( in_RSI + 0x238 ) = 0;
         ...
         if (( ( pcVar6 == (code*)0x0 ) || ( *(long*)( lVar4 + 0xe0 ) == 0 ) ) && ( pcVar6 = *(code**)( lVar4 + 0xd0 ) ),pcVar6 == (code*)0x0) {
            ...
            if (local_f0[0] == 0) {
               CowData<unsigned_int>::_unref((CowData<unsigned_int>*)local_f0);
               if (( StringName::configured != '\0' ) && ( lVar4 = local_100 != 0 )) goto LAB_0010293f;
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_108);
               LAB_00102954:lVar4 = *(long*)( in_RSI + 8 );
               pcVar6 = *(code**)( lVar4 + 200 );
               if (( ( pcVar6 == (code*)0x0 ) || ( *(long*)( lVar4 + 0xe0 ) == 0 ) ) && ( pcVar6 = *(code**)( lVar4 + 0xc0 ) ),pcVar6 == (code*)0x0) goto LAB_0010288f;
         ...
         LAB_0010288f:if (*(char*)( lVar4 + 0x29 ) != '\0') {
            plVar5 = (long*)operator_new(0x18, "");
            *plVar5 = in_RSI + 0x238;
      ...
      if (pcVar6 == (code*)0x0) {
         _err_print_error("get_resource_type", "editor/import/editor_import_plugin.cpp", 0x60, "Method/function failed. Returning: String()", "Unimplemented _get_resource_type in add-on.", 0, 0);
         *in_RDI = 0;
         goto LAB_00102647;
      }
      local_f8 = 0;
      ...
      if (pcVar1 == (code*)0x0) {
         ...
         lVar4 = CONCAT44(uStack_c4, local_c8);
         lVar7 = local_110;
         joined_r0x00102748:local_110 = lVar7;
         if (lVar4 != 0) {
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_110);
            local_c8 = 0;
            uStack_c4 = 0;
         ...
         ( *pcVar1 )(*(undefined8*)( in_RSI + 0x10 ), in_RSI + 0x228, pcVar6, 0, (CowData<char32_t>*)&local_f8);
         local_c8 = 0;
         uStack_c4 = 0;
         lVar7 = local_110;
         if (local_f8 != 0) {
   ...
   *in_RDI = lVar7;
   LAB_00102647:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* EditorImportPlugin::get_priority() const */void EditorImportPlugin::get_priority(EditorImportPlugin *this) {
   undefined4 uVar1;
   undefined8 uVar2;
   long lVar3;
   long *plVar4;
   ...
   if (( *(long*)( this + 8 ) != 0 ) && ( this[0x248] == (EditorImportPlugin)0x0 )) {
      ...
      *(undefined8*)( this + 0x250 ) = 0;
      ...
      if (( ( pcVar5 == (code*)0x0 ) || ( *(long*)( lVar3 + 0xe0 ) == 0 ) ) && ( pcVar5 = *(code**)( lVar3 + 0xd0 ) ),pcVar5 == (code*)0x0) {
         ...
         if (local_f0[0] == 0) {
            CowData<unsigned_int>::_unref((CowData<unsigned_int>*)local_f0);
            if (( StringName::configured != '\0' ) && ( lVar3 = local_100 != 0 )) goto LAB_00102d78;
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_108);
            LAB_00102d8d:lVar3 = *(long*)( this + 8 );
            pcVar5 = *(code**)( lVar3 + 200 );
            if (( ( pcVar5 == (code*)0x0 ) || ( *(long*)( lVar3 + 0xe0 ) == 0 ) ) && ( pcVar5 = *(code**)( lVar3 + 0xc0 ) ),pcVar5 == (code*)0x0) goto LAB_00102cc8;
      ...
      LAB_00102cc8:if (*(char*)( lVar3 + 0x29 ) != '\0') {
   ...
   if (pcVar5 == (code*)0x0) {
      _err_print_error("get_priority", "editor/import/editor_import_plugin.cpp", 0x68, "Method/function failed. Returning: -1", "Unimplemented _get_priority in add-on.", 0, 0);
   } else if (*(code**)( *(long*)( this + 8 ) + 0xe0 ) == (code*)0x0) {
      ( *pcVar5 )(*(undefined8*)( this + 0x10 ), 0, local_c8);
   } else {
      ( **(code**)( *(long*)( this + 8 ) + 0xe0 ) )(*(undefined8*)( this + 0x10 ), this + 0x240, pcVar5, 0, local_c8);
   }
   LAB_00102aec:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return;
}/* EditorImportPlugin::get_import_order() const */int EditorImportPlugin::get_import_order(EditorImportPlugin *this) {
   int iVar1;
   undefined4 uVar2;
   undefined8 uVar3;
   long lVar4;
   ...
   if (( *(long*)( this + 8 ) != 0 ) && ( this[0x260] == (EditorImportPlugin)0x0 )) {
      ...
      *(undefined8*)( this + 0x268 ) = 0;
      ...
      if (( ( pcVar6 == (code*)0x0 ) || ( *(long*)( lVar4 + 0xe0 ) == 0 ) ) && ( pcVar6 = *(code**)( lVar4 + 0xd0 ) ),pcVar6 == (code*)0x0) {
         ...
         if (local_f0[0] == 0) {
            CowData<unsigned_int>::_unref((CowData<unsigned_int>*)local_f0);
            if (( StringName::configured != '\0' ) && ( lVar4 = local_100 != 0 )) goto LAB_001031a8;
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_108);
            LAB_001031bd:lVar4 = *(long*)( this + 8 );
            pcVar6 = *(code**)( lVar4 + 200 );
            if (( ( pcVar6 == (code*)0x0 ) || ( *(long*)( lVar4 + 0xe0 ) == 0 ) ) && ( pcVar6 = *(code**)( lVar4 + 0xc0 ) ),pcVar6 == (code*)0x0) goto LAB_00103100;
      ...
      LAB_00103100:if (*(char*)( lVar4 + 0x29 ) != '\0') {
         plVar5 = (long*)operator_new(0x18, "");
   ...
   if (pcVar6 == (code*)0x0) {
      _err_print_error("get_import_order", "editor/import/editor_import_plugin.cpp", 0x70, "Method/function failed. Returning: -1", "Unimplemented _get_import_order in add-on.", 0, 0);
      iVar1 = -1;
   } else if (*(code**)( *(long*)( this + 8 ) + 0xe0 ) == (code*)0x0) {
      ( *pcVar6 )(*(undefined8*)( this + 0x10 ), 0, local_c8);
      iVar1 = local_c8[0];
   ...
   LAB_00102f26:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return iVar1;
}/* EditorImportPlugin::get_format_version() const */int EditorImportPlugin::get_format_version(EditorImportPlugin *this) {
   int iVar1;
   undefined4 uVar2;
   undefined8 uVar3;
   long lVar4;
   ...
   if (( *(long*)( this + 8 ) != 0 ) && ( this[0x278] == (EditorImportPlugin)0x0 )) {
      ...
      *(undefined8*)( this + 0x280 ) = 0;
      ...
      if (( ( pcVar6 == (code*)0x0 ) || ( *(long*)( lVar4 + 0xe0 ) == 0 ) ) && ( pcVar6 = *(code**)( lVar4 + 0xd0 ) ),pcVar6 == (code*)0x0) {
         ...
         if (local_f0[0] == 0) {
            CowData<unsigned_int>::_unref((CowData<unsigned_int>*)local_f0);
            if (( StringName::configured != '\0' ) && ( lVar4 = local_100 != 0 )) goto LAB_00103588;
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_108);
            LAB_0010359d:lVar4 = *(long*)( this + 8 );
            pcVar6 = *(code**)( lVar4 + 200 );
            if (( ( pcVar6 == (code*)0x0 ) || ( *(long*)( lVar4 + 0xe0 ) == 0 ) ) && ( pcVar6 = *(code**)( lVar4 + 0xc0 ) ),pcVar6 == (code*)0x0) goto LAB_001034d8;
      ...
      LAB_001034d8:if (*(char*)( lVar4 + 0x29 ) != '\0') {
         plVar5 = (long*)operator_new(0x18, "");
   ...
   LAB_00103353:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return iVar1;
}/* EditorImportPlugin::can_import_threaded() const */bool EditorImportPlugin::can_import_threaded(EditorImportPlugin *this) {
   undefined4 uVar1;
   undefined8 uVar2;
   long lVar3;
   long *plVar4;
   ...
   if (( *(long*)( this + 8 ) != 0 ) && ( this[0x2c0] == (EditorImportPlugin)0x0 )) {
      ...
      *(undefined8*)( this + 0x2c8 ) = 0;
      ...
      if (( ( pcVar5 == (code*)0x0 ) || ( *(long*)( lVar3 + 0xe0 ) == 0 ) ) && ( pcVar5 = *(code**)( lVar3 + 0xd0 ) ),pcVar5 == (code*)0x0) {
         ...
         if (local_f0[0] == 0) {
            CowData<unsigned_int>::_unref((CowData<unsigned_int>*)local_f0);
            if (( StringName::configured != '\0' ) && ( lVar3 = local_100 != 0 )) goto LAB_00103968;
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_108);
            LAB_0010397d:lVar3 = *(long*)( this + 8 );
            pcVar5 = *(code**)( lVar3 + 200 );
            if (( ( pcVar5 == (code*)0x0 ) || ( *(long*)( lVar3 + 0xe0 ) == 0 ) ) && ( pcVar5 = *(code**)( lVar3 + 0xc0 ) ),pcVar5 == (code*)0x0) goto LAB_001038c0;
      ...
      LAB_001038c0:if (*(char*)( lVar3 + 0x29 ) != '\0') {
         plVar4 = (long*)operator_new(0x18, "");
   ...
   LAB_00103737:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return bVar6;
   ...
   _err_print_error("push_back", "./core/templates/vector.h", 0x142, "Condition \"err\" is true. Returning: true", 0, 0);
   return;
}/* EditorImportPlugin::_bind_methods() */void EditorImportPlugin::_bind_methods(void) {
   Variant *pVVar1;
   long lVar2;
   code *pcVar3;
   ...
   ClassDB::add_virtual_method((StringName*)&local_1c8, (MethodInfo*)&local_198, true, (Vector*)local_1d8, false);
   ...
   local_1a0 = 6;
   StringName::operator =((StringName*)( local_1c0 + 8 ), local_278);
   LAB_0010626d:CowData<char32_t>::_unref((CowData<char32_t>*)&local_1e8);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_1f0);
   if (( StringName::configured != '\0' ) && ( local_1f8 != 0 )) {
      StringName::unref();
   }
   ...
   pVStack_d0 = local_90;
   local_c8 = local_78;
   pMVar14 = create_method_bind<EditorImportPlugin,Error,String_const&,Dictionary_const&,String_const&,Variant>(_append_import_external_resource);
   ...
   DefaultAllocator>*, List<String, DefaultAllocator>*, Variant*) */int EditorImportPlugin::import(long param_1, String *param_2, String *param_3, HashMap *param_4, List *param_5, List *param_6, Variant *param_7) {
   Variant *pVVar1;
   undefined8 *puVar2;
   long lVar3;
   int iVar4;
   ...
   for (puVar2 = *(undefined8**)( param_5 + 0x18 ); puVar2 != (undefined8*)0x0; puVar2 = (undefined8*)*puVar2) {
   ...
   if (plVar12 == (long*)0x0) {
      LAB_00106b44:if (( *(long*)( param_1 + 8 ) != 0 ) && ( *(char*)( param_1 + 0x2a8 ) == '\0' )) {
         ...
         PropertyInfo::~PropertyInfo((PropertyInfo*)local_1a8);
         Vector<int>::push_back(local_118, 0);
         GetTypeInfo<TypedArray<String>,void>::get_class_info((GetTypeInfo<TypedArray<String>,void>*)local_1a8);
         List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)local_138, (PropertyInfo*)local_1a8);
         PropertyInfo::~PropertyInfo((PropertyInfo*)local_1a8);
         Vector<int>::push_back(local_118, 0);
         GetTypeInfo<TypedArray<String>,void>::get_class_info((GetTypeInfo<TypedArray<String>,void>*)local_1a8);
         ...
         *(undefined8*)( param_1 + 0x2b0 ) = 0;
         ...
         if (( ( pcVar13 == (code*)0x0 ) || ( *(long*)( lVar10 + 0xe0 ) == 0 ) ) && ( pcVar13 = *(code**)( lVar10 + 0xd0 ) ),pcVar13 == (code*)0x0) {
            local_1b8 = 0;
            ...
            if (( ( pcVar13 != (code*)0x0 ) && ( *(long*)( lVar10 + 0xe0 ) != 0 ) ) || ( pcVar13 = *(code**)( lVar10 + 0xc0 ) ),pcVar13 != (code*)0x0) {
         ...
         LAB_001072c1:if (*(char*)( lVar10 + 0x29 ) != '\0') {
      ...
      if (*(long*)( param_1 + 0x2b0 ) == 0) {
         ...
         _err_print_error("import", "editor/import/editor_import_plugin.cpp", 0xc2, "Method/function failed. Returning: ERR_METHOD_NOT_FOUND", "Unimplemented _import in add-on.", 0, 0);
         iVar5 = 0x25;
         goto LAB_00106bd0;
      }
      local_1c8 = 0;
      ...
      local_98 = local_1a8;
      if (pcVar13 == (code*)0x0) {
         ( **(code**)( param_1 + 0x2b0 ) )(*(undefined8*)( param_1 + 0x10 ), (Variant*)&local_b8, (Variant*)&local_178);
      } else {
         ( *pcVar13 )(*(undefined8*)( param_1 + 0x10 ), param_1 + 0x2a0, *(undefined8*)( param_1 + 0x2b0 ), (Variant*)&local_b8, (Variant*)&local_178);
      }
      iVar5 = local_178;
      ...
      pVStack_d0 = local_70;
      local_c8 = local_58;
      ( **(code**)( *plVar12 + 0x60 ) )((Variant*)local_108, plVar12, param_1 + 0x2a0, &local_e8, 5, (Variant*)&local_178);
      if (local_178 != 0) {
   ...
   LAB_00106bd0:Array::~Array(local_1f8);
   Array::~Array(local_200);
   Dictionary::~Dictionary(local_208);
   ...
   DefaultTypedAllocator<HashMapElement<StringName, Variant> > > const&) const */ulong EditorImportPlugin::get_option_visibility(EditorImportPlugin *this, String *param_1, String *param_2, HashMap *param_3) {
   Variant *pVVar1;
   undefined4 uVar2;
   Variant *pVVar3;
   long lVar4;
   ...
   LAB_001075ac:plVar7 = *(long**)( this + 0x98 );
   if (plVar7 == (long*)0x0) {
      LAB_001076c1:if (( *(long*)( this + 8 ) != 0 ) && ( this[0x290] == (EditorImportPlugin)0x0 )) {
         local_138[0] = 0;
         local_138[1] = 0;
         ...
         *(undefined8*)( this + 0x298 ) = 0;
         ...
         if (( ( pcVar8 == (code*)0x0 ) || ( *(long*)( lVar6 + 0xe0 ) == 0 ) ) && ( pcVar8 = *(code**)( lVar6 + 0xd0 ) ),pcVar8 == (code*)0x0) {
            ...
            if (local_160[0] == 0) {
               ...
               LAB_00107bf2:lVar6 = *(long*)( this + 8 );
               pcVar8 = *(code**)( lVar6 + 200 );
               if (( ( pcVar8 == (code*)0x0 ) || ( *(long*)( lVar6 + 0xe0 ) == 0 ) ) && ( pcVar8 = *(code**)( lVar6 + 0xc0 ) ),pcVar8 == (code*)0x0) goto LAB_00107af4;
         ...
         LAB_00107af4:if (*(char*)( lVar6 + 0x29 ) != '\0') {
      ...
      if (*(long*)( this + 0x298 ) == 0) {
         ...
         uVar9 = 0;
         _err_print_error("get_option_visibility", "editor/import/editor_import_plugin.cpp", 0xab, "Method/function failed. Returning: false", "Unimplemented _get_option_visibility in add-on.", 0, 0);
         goto LAB_0010775c;
      }
      local_170 = 0;
      if (local_190 != 0) {
      ...
      if (*(code**)( *(long*)( this + 8 ) + 0xe0 ) == (code*)0x0) {
         ...
         ( **(code**)( *(long*)( this + 8 ) + 0xe0 ) )(*(undefined8*)( this + 0x10 ), this + 0x288, *(undefined8*)( this + 0x298 ), &local_88, &local_178);
      }
   ...
   Dictionary::~Dictionary(local_180);
   LAB_0010775c:Dictionary::~Dictionary(local_198);
   if (local_40[0] != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   ...
   DefaultAllocator>*, int) const */void EditorImportPlugin::get_import_options(EditorImportPlugin *this, String *param_1, List *param_2, int param_3) {
   int iVar1;
   ...
   if (plVar15 == (long*)0x0) {
      LAB_00107ef5:if (( *(long*)( this + 8 ) != 0 ) && ( this[0x200] == (EditorImportPlugin)0x0 )) {
         ...
         GetTypeInfo<TypedArray<Dictionary>,void>::get_class_info((GetTypeInfo<TypedArray<Dictionary>,void>*)&local_178);
         ...
         *(undefined8*)( this + 0x208 ) = 0;
         ...
         if (( ( pcVar16 == (code*)0x0 ) || ( *(long*)( lVar12 + 0xe0 ) == 0 ) ) && ( pcVar16 = *(code**)( lVar12 + 0xd0 ) ),pcVar16 == (code*)0x0) {
            local_188 = 0;
            ...
            if (local_170[0] == 0) {
               ...
               LAB_00108dea:lVar12 = *(long*)( this + 8 );
               pcVar16 = *(code**)( lVar12 + 200 );
               if (( ( pcVar16 == (code*)0x0 ) || ( *(long*)( lVar12 + 0xe0 ) == 0 ) ) && ( pcVar16 = *(code**)( lVar12 + 0xc0 ) ),pcVar16 == (code*)0x0) goto LAB_00108c8a;
         ...
         LAB_00108c8a:if (*(char*)( lVar12 + 0x29 ) != '\0') {
      ...
      if (*(long*)( this + 0x208 ) == 0) {
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_198);
         _err_print_error("get_import_options", "editor/import/editor_import_plugin.cpp", 0x9c, "Method/function failed.", "Unimplemented _get_import_options in add-on.", 0, 0);
         goto LAB_00107f45;
      }
      local_190 = 0;
      ...
      if (*(code**)( *(long*)( this + 8 ) + 0xe0 ) == (code*)0x0) {
         ...
         ( **(code**)( *(long*)( this + 8 ) + 0xe0 ) )(*(undefined8*)( this + 0x10 ), this + 0x1f8, *(undefined8*)( this + 0x208 ), &local_a8, (Array*)&local_180);
      }
   ...
   for (iVar1 = 0; iVar6 = Array::size(),iVar1 < iVar6; iVar1 = iVar1 + 1) {
      ...
      if (cVar5 == '\0') {
         _err_print_error("get_import_options", "editor/import/editor_import_plugin.cpp", 0x83, "Condition \"!d.has_all(needed)\" is true.", 0, 0);
   ...
   LAB_00107f45:Array::~Array(local_1a0);
   Array::~Array(local_1a8);
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   ...
   return;
}/* EditorImportPlugin::get_preset_name(int) const */long *EditorImportPlugin::get_preset_name(int param_1) {
   code *pcVar1;
   undefined4 uVar2;
   undefined8 uVar3;
   long lVar4;
   ...
   local_140 = 0;
   if (plVar5 == (long*)0x0) {
      LAB_00108f9d:if (( *(long*)( in_RSI + 8 ) != 0 ) && ( *(char*)( in_RSI + 0x1d0 ) == '\0' )) {
         local_f8 = 0;
         uStack_f4 = 0;
         ...
         *(undefined8*)( in_RSI + 0x1d8 ) = 0;
         ...
         if (( ( pcVar6 == (code*)0x0 ) || ( *(long*)( lVar4 + 0xe0 ) == 0 ) ) && ( pcVar6 = *(code**)( lVar4 + 0xd0 ) ),pcVar6 == (code*)0x0) {
            ...
            if (local_120[0] == 0) {
               ...
               LAB_001093db:lVar4 = *(long*)( in_RSI + 8 );
               pcVar6 = *(code**)( lVar4 + 200 );
               if (( ( pcVar6 == (code*)0x0 ) || ( *(long*)( lVar4 + 0xe0 ) == 0 ) ) && ( pcVar6 = *(code**)( lVar4 + 0xc0 ) ),pcVar6 == (code*)0x0) goto LAB_001092f1;
         ...
         LAB_001092f1:if (*(char*)( lVar4 + 0x29 ) != '\0') {
            plVar5 = (long*)operator_new(0x18, "");
            *plVar5 = in_RSI + 0x1d8;
      ...
      if (pcVar6 == (code*)0x0) {
         _err_print_error("get_preset_name", "editor/import/editor_import_plugin.cpp", 0x48, "Method/function failed. Returning: String()", "Unimplemented _get_preset_name in add-on.", 0, 0);
         *plVar7 = 0;
         goto LAB_00109064;
      }
      ...
      if (pcVar1 == (code*)0x0) {
         ...
         lVar8 = local_140;
         joined_r0x00109176:local_140 = lVar8;
         if (lVar4 != 0) {
         ...
         ( *pcVar1 )(*(undefined8*)( in_RSI + 0x10 ), in_RSI + 0x1c8, pcVar6, local_58, (CowData<char32_t>*)&local_128);
         local_f8 = 0;
         uStack_f4 = 0;
         lVar8 = local_140;
         if (local_128 != 0) {
   ...
   *plVar7 = lVar8;
   LAB_00109064:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return plVar7;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   return (uint)CONCAT71(0x10fc, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10fc, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr);
   ...
   *(undefined8*)this = 0;
   return this;
}/* EditorImportPlugin::is_class_ptr(void*) const */uint EditorImportPlugin::is_class_ptr(EditorImportPlugin *this, void *param_1) {
   return (uint)CONCAT71(0x10fc, (undefined4*)param_1 == &ResourceImporter::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10fc, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10fc, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10fc, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}/* EditorImportPlugin::_getv(StringName const&, Variant&) const */undefined8 EditorImportPlugin::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}/* EditorImportPlugin::_setv(StringName const&, Variant const&) */undefined8 EditorImportPlugin::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}/* EditorImportPlugin::_validate_propertyv(PropertyInfo&) const */void EditorImportPlugin::_validate_propertyv(PropertyInfo *param_1) {
   return;
}/* EditorImportPlugin::_property_can_revertv(StringName const&) const */undefined8 EditorImportPlugin::_property_can_revertv(StringName *param_1) {
   return 0;
}/* EditorImportPlugin::_property_get_revertv(StringName const&, Variant&) const */undefined8 EditorImportPlugin::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}/* EditorImportPlugin::_notificationv(int, bool) */void EditorImportPlugin::_notificationv(int param_1, bool param_2) {
   return;
}/* MethodBindTR<Error, String const&, Dictionary const&, String const&,
   Variant>::_gen_argument_type(int) const */long MethodBindTR<Error,String_const&,Dictionary_const&,String_const&,Variant>::_gen_argument_type(MethodBindTR<Error,String_const&,Dictionary_const&,String_const&,Variant> *this, int param_1) {
   long lVar1;
   lVar1 = 2;
   if (( ( (uint)param_1 < 4 ) && ( lVar1 = 4 ),param_1 != 0 )) {
      lVar1 = ( ulong )(param_1 == 2) << 2;
   }
   return lVar1;
}/* MethodBindTR<Error, String const&, Dictionary const&, String const&,
   Variant>::get_argument_meta(int) const */undefined8 MethodBindTR<Error,String_const&,Dictionary_const&,String_const&,Variant>::get_argument_meta(int param_1) {
   return 0;
}/* MethodBindTR<Error, String const&, Dictionary const&, String const&, Variant>::~MethodBindTR() */void MethodBindTR<Error,String_const&,Dictionary_const&,String_const&,Variant>::~MethodBindTR(MethodBindTR<Error,String_const&,Dictionary_const&,String_const&,Variant> *this) {
   ...
   *(undefined***)this = &PTR__initialize_classv_0010fa28;
   ...
   LAB_001099bc:*(undefined***)this = &PTR__initialize_classv_0010f8c8;
   Object::~Object((Object*)this);
   return;
}/* EditorImportPlugin::~EditorImportPlugin() */void EditorImportPlugin::~EditorImportPlugin(EditorImportPlugin *this) {
   ...
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}/* EditorImportPlugin::_bind_methods() [clone .cold] */void EditorImportPlugin::_bind_methods(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00109d73:return &_get_class_namev();
      }
      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00109d73;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "RefCounted");
         goto LAB_00109dde;
      }
   }
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "RefCounted");
   LAB_00109dde:return &_get_class_namev();
}/* EditorImportPlugin::_get_class_namev() const */undefined8 *EditorImportPlugin::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00109e63:return &_get_class_namev();
      }
      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00109e63;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorImportPlugin");
         goto LAB_00109ece;
      }
   }
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorImportPlugin");
   LAB_00109ece:return &_get_class_namev();
}/* EditorImportPlugin::get_class() const */void EditorImportPlugin::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
   ...
   *(int*)( plVar1 + 2 ) = (int)plVar1[2] + 1;
   ...
   for (lVar2 = *(long*)( this + 8 ); lVar2 != 0; lVar2 = *(long*)( lVar2 + 8 )) {
      ...
      LAB_0010a6bf:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
   ...
   if (cVar6 == '\0') {
      for (lVar2 = *(long*)( this + 8 ); lVar2 != 0; lVar2 = *(long*)( lVar2 + 8 )) {
         ...
         LAB_0010a823:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
      ...
      LAB_0010a773:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* EditorImportPlugin::is_class(String const&) const */undefined8 EditorImportPlugin::is_class(EditorImportPlugin *this, String *param_1) {
   long *plVar1;
   long lVar2;
   long lVar3;
   char *pcVar4;
   ...
   for (lVar2 = *(long*)( this + 8 ); lVar2 != 0; lVar2 = *(long*)( lVar2 + 8 )) {
      ...
      LAB_0010a95f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar5 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   LAB_0010aa13:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }
   LAB_0010ab58:/* WARNING: Subroutine does not return */__stack_chk_fail();
...
GetTypeInfo<int,void>::get_class_info(GetTypeInfo<int,void> *this){
   ...
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   ...
   StringName::operator =((StringName*)( this + 0x10 ), (StringName*)&local_50);
   lVar2 = local_58;
   joined_r0x0010af0c:local_58 = lVar2;
   if (lVar2 != 0) {
      LOCK();
      plVar1 = (long*)( lVar2 + -0x10 );
      *plVar1 = *plVar1 + -1;
...
GetTypeInfo<float,void>::get_class_info(GetTypeInfo<float,void> *this){
   ...
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   ...
   StringName::operator =((StringName*)( this + 0x10 ), (StringName*)&local_50);
   lVar2 = local_58;
   joined_r0x0010b08c:local_58 = lVar2;
   if (lVar2 != 0) {
      LOCK();
      plVar1 = (long*)( lVar2 + -0x10 );
      *plVar1 = *plVar1 + -1;
...
GetTypeInfo<Vector<String>,void>::get_class_info(GetTypeInfo<Vector<String>,void> *this){
   ...
   *(int*)( plVar1 + 2 ) = (int)plVar1[2] + 1;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* EditorImportPlugin::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void EditorImportPlugin::_get_property_listv(EditorImportPlugin *this, List *param_1, bool param_2) {
   long *plVar1;
   long lVar2;
   long lVar3;
   undefined1(*pauVar4)[16];
...
GetTypeInfo<TypedArray<String>,void>::get_class_info(GetTypeInfo<TypedArray<String>,void> *this){
   ...
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   ...
   lVar2 = local_38;
   joined_r0x0010c08c:local_38 = lVar2;
   if (lVar2 != 0) {
      LOCK();
      plVar1 = (long*)( lVar2 + -0x10 );
      *plVar1 = *plVar1 + -1;
...
GetTypeInfo<TypedArray<Dictionary>,void>::get_class_info
   ...
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   ...
   StringName::operator =((StringName*)( this + 0x10 ), (StringName*)&local_30);
   lVar2 = local_38;
   joined_r0x0010c1ec:local_38 = lVar2;
   if (lVar2 != 0) {
      LOCK();
      plVar1 = (long*)( lVar2 + -0x10 );
      *plVar1 = *plVar1 + -1;
...
::insert(StringName *param_1,Variant *param_2,bool param_3){
   ...
   if (*(long*)( param_2 + 8 ) == 0) {
      ...
      *(void**)( param_2 + 8 ) = pvVar35;
      ...
      LAB_0010cdbd:uVar30 = *(uint*)( param_2 + 0x28 );
      if (uVar30 == 0x1c) {
      ...
      *(void**)( param_2 + 8 ) = __s_00;
      ...
      LAB_0010cc95:iVar36 = *(int*)( param_2 + 0x2c );
      if (iVar36 != 0) {
         LAB_0010cca1:uVar4 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( param_2 + 0x28 ) * 4 );
      ...
      LAB_0010cd97:if ((float)uVar30 * __LC32 < (float)( iVar36 + 1 )) goto LAB_0010cdbd;
   }
   ...
   *local_c0 = 0;
   ...
   if (*(undefined8**)( param_2 + 0x20 ) == (undefined8*)0x0) {
      ...
      *(undefined8**)( param_2 + 0x20 ) = local_c0;
      LAB_0010d076:lVar34 = *(long*)pSVar37;
      if (lVar34 != 0) goto LAB_0010d082;
      LAB_0010d1c4:uVar30 = StringName::get_empty_hash();
   } else {
      if (in_R8B == '\0') {
         **(undefined8**)( param_2 + 0x20 ) = local_c0;
      ...
      *(undefined8**)( param_2 + 0x18 ) = local_c0;
      ...
      LAB_0010d082:uVar30 = *(uint*)( lVar34 + 0x20 );
   }
   lVar34 = *(long*)( param_2 + 0x10 );
   if (uVar30 == 0) {
      uVar30 = 1;
   ...
   *puVar1 = uVar30;
   *(int*)( param_2 + 0x2c ) = *(int*)( param_2 + 0x2c ) + 1;
   LAB_0010d15c:*(undefined8**)param_1 = local_c0;
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   ...
   *(undefined8*)this = 0;
   ...
   const&, Variant)) */MethodBind *create_method_bind<EditorImportPlugin,Error,String_const&,Dictionary_const&,String_const&,Variant>(_func_Error_String_ptr_Dictionary_ptr_String_ptr_Variant *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
GetTypeInfo<Error,void>::get_class_info(GetTypeInfo<Error,void> *this){
   ...
   LAB_0010d676:CowData<String>::_unref((CowData<String>*)&local_50);
   ...
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   ...
   if (param_1 * 8 == 0) {
      LAB_0010dc40:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   uVar8 = param_1 * 8 - 1;
   uVar8 = uVar8 >> 1 | uVar8;
   ...
   if (lVar10 == lVar7) {
      LAB_0010dbbf:puVar9 = *(undefined8**)this;
      if (puVar9 == (undefined8*)0x0) {
         LAB_0010dc96:/* WARNING: Does not return */pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
      }
      lVar6 = puVar9[-1];
   ...
   *(undefined8*)this = 0;
   ...
   if (param_1 * 4 == 0) {
      LAB_0010df60:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   uVar4 = param_1 * 4 - 1;
   uVar4 = uVar4 | uVar4 >> 1;
   ...
   pcVar2 = (code*)invalidInstructionException();
   ( *pcVar2 )();
}/* EditorImportPlugin::_initialize_classv() */void EditorImportPlugin::_initialize_classv(void)

...
joined_r0x00100300:
   ...
   *piVar1 = *piVar1 + -1;
   ...
   if (UNRECOVERED_JUMPTABLE != (code*)0x0) {
      ...
      for (int i_2091 = 0; i_2091 < 2; i_2091++) {
   ...
   if (*(long*)( param_1 + 0x60 ) != 0) {
      uVar1 = EVP_MAC_get0_provider();
      uVar1 = ossl_provider_ctx(uVar1);
      for (int i_2092 = 0; i_2092 < 2; i_2092++) {
   ...
   if (*(long*)( param_1 + 0x68 ) != 0) {
      uVar1 = EVP_MAC_get0_provider();
      uVar1 = ossl_provider_ctx(uVar1);
      for (int i_2093 = 0; i_2093 < 2; i_2093++) {
   ...
   if (*(long*)( *param_1 + 0x60 ) != 0) {
      uVar1 = EVP_MAC_get0_provider();
      uVar1 = ossl_provider_ctx(uVar1);
      for (int i_2094 = 0; i_2094 < 2; i_2094++) {
   ...
   if (*(long*)( *param_1 + 0x68 ) != 0) {
      uVar1 = EVP_MAC_get0_provider();
      uVar1 = ossl_provider_ctx(uVar1);
      for (int i_2095 = 0; i_2095 < 2; i_2095++) {

undefined4 read_number(undefined8 *param_1, int *param_2, int param_3, uint param_4, undefined4 param_5, uint *param_6, undefined4 *param_7) {
   ...
   *param_2 = param_1 + -0x7fe80000;
   ...
   switch (uVar1) {
      case 0x76:
      for (int i_1836 = 0; i_1836 < 5; i_1836++) {
         case 0x91:
      }
      case 0x96:
      ...
      do {
         ...
         if (param_14 == (long*)0x0) {
            ...
            if (uVar32 < 0x21) {
               ...
               puVar39 = puVar24;
               switch (uVar32) {
                  for (int i_1839 = 0; i_1839 < 6; i_1839++) {
                     case 0x6e:
                  }
                  case 0x74:
            puVar42 = puVar24;
...
LAB_00103c48:
            ...
            goto LAB_00103988;
                  ...
                  case 0x88:
                  case 0x8a:
                  for (int i_1837 = 0; i_1837 < 22; i_1837++) {
                     case 0x8c:
                  }
                  case 0xa2:
switchD_001038df_caseD_76:
            ...
            break;
                  case 0x7f:
                  for (int i_1838 = 0; i_1838 < 4; i_1838++) {
                     case 0x80:
                     case 0x81:
                  }
                  case 0x89:
...
LAB_00104a4c:
            ...
            if (uVar32 < 0x80150001) {
               if (uVar32 == 0x80110000) {
                  ...
                  if ((short)param_13[0x16] != 0) {
                     uVar35 = 0;
                     do {
                        if (( uVar19 == *(ushort*)( (long)puVar45 + 0xc ) ) && ( iVar15 = _pcre2_strncmp_32(lVar37, *puVar45, (ulong)uVar19) ),iVar15 == 0) {
   ...
   *(undefined8*)( puVar40 + -0x1368 ) = 0;
   for (int i_1841 = 0; i_1841 < 5; i_1841++) {
      *(undefined1(*) [16])( puVar40 + ( 16*i_1841 + -5120 ) ) = auVar58;
   }

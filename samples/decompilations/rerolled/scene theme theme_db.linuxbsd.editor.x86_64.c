/* ThemeDB::get_fallback_base_scale() */undefined4 ThemeDB::get_fallback_base_scale(ThemeDB *this) {
   return *(undefined4*)( this + 0x188 );
}/* ThemeDB::get_fallback_font_size() */undefined4 ThemeDB::get_fallback_font_size(ThemeDB *this) {
   ...
   unsigned int&) const [clone .isra.0] */undefined8 HashMap<Node*,ThemeContext*,HashMapHasherDefault,HashMapComparatorDefault<Node*>,DefaultTypedAllocator<HashMapElement<Node*,ThemeContext*>>>::_lookup_pos(HashMap<Node*,ThemeContext*,HashMapHasherDefault,HashMapComparatorDefault<Node*>,DefaultTypedAllocator<HashMapElement<Node*,ThemeContext*>>> *this, Node **param_1, uint *param_2) {
   long lVar1;
   ...
   .isra.0] */void HashMap<Node*,ThemeContext*,HashMapHasherDefault,HashMapComparatorDefault<Node*>,DefaultTypedAllocator<HashMapElement<Node*,ThemeContext*>>>::erase(HashMap<Node*,ThemeContext*,HashMapHasherDefault,HashMapComparatorDefault<Node*>,DefaultTypedAllocator<HashMapElement<Node*,ThemeContext*>>> *this, Node **param_1) {
   uint *puVar1;
   uint *puVar2;
   undefined8 *puVar3;
   undefined8 *puVar4;
   ...
   *(undefined4*)( lVar8 + uVar30 * 4 ) = 0;
   ...
   if (*(long**)( this + 0x18 ) == plVar31) {
      *(long*)( this + 0x18 ) = *plVar31;
      ...
      LAB_00100308:*(long*)( this + 0x20 ) = plVar31[1];
      plVar31 = (long*)*plVar5;
      plVar12 = (long*)plVar31[1];
   } else {
      if (*(long**)( this + 0x20 ) == plVar31) goto LAB_00100308;
      LAB_001002a6:plVar12 = (long*)plVar31[1];
   }
   if (plVar12 != (long*)0x0) {
      *plVar12 = *plVar31;
      plVar31 = (long*)*plVar5;
   ...
   *(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + -1;
   LAB_001002e3:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return;
}/* ThemeDB::get_fallback_icon() */void ThemeDB::get_fallback_icon(void) {
   char cVar1;
   long in_RSI;
   long *in_RDI;
   *in_RDI = 0;
   ...
   return;
}/* ThemeDB::get_fallback_stylebox() */void ThemeDB::get_fallback_stylebox(void) {
   char cVar1;
   long in_RSI;
   long *in_RDI;
   *in_RDI = 0;
   ...
   .isra.0] */void List<ThemeDB::ThemeItemBind,DefaultAllocator>::push_back(List<ThemeDB::ThemeItemBind,DefaultAllocator> *this, ThemeItemBind *param_1) {
   long *plVar1;
   undefined1 auVar2[16];
   undefined4 *puVar3;
   code *pcVar4;
   ...
   *puVar3 = *(undefined4*)param_1;
   for (int i = 0; i < 3; i++) {
      StringName::operator =((StringName*)( puVar3 + ( 2*i + 2 ) ), (StringName*)( param_1 + ( 8*i + 8 ) ));
   }
   uVar6 = 0;
   local_30 = 0;
   ...
   *(int*)( plVar1 + 2 ) = (int)plVar1[2] + 1;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* ThemeDB::get_fallback_font() */void ThemeDB::get_fallback_font(void) {
   char cVar1;
   long in_RSI;
   long *in_RDI;
   *in_RDI = 0;
   ...
   return;
}/* ThemeDB::get_project_theme() */void ThemeDB::get_project_theme(void) {
   char cVar1;
   long in_RSI;
   long *in_RDI;
   *in_RDI = 0;
   ...
   return;
}/* ThemeDB::get_default_theme() */void ThemeDB::get_default_theme(void) {
   char cVar1;
   long in_RSI;
   long *in_RDI;
   *in_RDI = 0;
   ...
   return;
}/* ThemeContext::_emit_changed() */void ThemeContext::_emit_changed(ThemeContext *this) {
   long lVar1;
   long in_FS_OFFSET;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* ThemeDB::set_fallback_font_size(int) */void ThemeDB::set_fallback_font_size(ThemeDB *this, int param_1) {
   long lVar1;
   int iVar2;
   long in_FS_OFFSET;
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
   if (*(int*)( this + 0x198 ) != param_1) {
      *(int*)( this + 0x198 ) = param_1;
      if (set_fallback_font_size(int)::{lambda()
      #1
      iVar2 = __cxa_guard_acquire(&set_fallback_font_size(int)::{lambda()
      #1
      if (iVar2 != 0) {
         _scs_create((char *)&set_fallback_font_size(int)::{lambda()
         #1
         __cxa_atexit(StringName::~StringName,
                     &set_fallback_font_size(int)::{lambda()
         #1
         __cxa_guard_release(&set_fallback_font_size(int)::{lambda()
         #1
      }
   }
   (**(code **)(*(long *)this + 0xd0))
              (this,&set_fallback_font_size(int)::{lambda()
   #1
   if (Variant::needs_deinit[0] != '\0') {
      Variant::_clear_internal();
   }
   ...
   return;
}/* WARNING: Subroutine does not return */__stack_chk_fail();}/* ThemeDB::set_fallback_font(Ref<Font> const&) [clone .part.0] [clone .isra.0] */void ThemeDB::set_fallback_font(ThemeDB *this, Ref *param_1) {
   Object *pOVar1;
   long lVar2;
   char cVar3;
   int iVar4;
   ...
   if (set_fallback_font(Ref<Font>const&)::{lambda()
   #1
   iVar4 = __cxa_guard_acquire(&set_fallback_font(Ref < Font > const & ::sname));
   if (iVar4 != 0) {
      _scs_create((char*)&set_fallback_font(Ref < Font > const & ::sname, true));
      __cxa_atexit(StringName::~StringName, &set_fallback_font(Ref < Font > const & ::sname, &__dso_handle));
      __cxa_guard_release(&set_fallback_font(Ref<Font>const&)::{lambda()
      #1
   }
}(**(code **)(*(long *)this + 0xd0))
            (this,&set_fallback_font(Ref<Font>const&)::{lambda()#1if (Variant::needs_deinit[0] != '\0') {
   Variant::_clear_internal();
}if (lVar2 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return;
}/* WARNING: Subroutine does not return */__stack_chk_fail();}/* ThemeDB::set_fallback_font(Ref<Font> const&) */void ThemeDB::set_fallback_font(ThemeDB *this, Ref *param_1) {
   if (*(Ref**)( this + 400 ) != *(Ref**)param_1) {
      set_fallback_font(this, *(Ref**)param_1);
      return;
   }
   return;
}/* ThemeDB::set_fallback_base_scale(float) */void ThemeDB::set_fallback_base_scale(ThemeDB *this, float param_1) {
   long lVar1;
   int iVar2;
   long in_FS_OFFSET;
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
   if (param_1 != *(float*)( this + 0x188 )) {
      *(float*)( this + 0x188 ) = param_1;
      if ((set_fallback_base_scale(float)::{lambda()
      #1
      ( iVar2 = __cxa_guard_acquire(&set_fallback_base_scale(float)::{lambda()#1}::operator()()::sname), iVar2 != 0) );
      {
         _scs_create((char *)&set_fallback_base_scale(float)::{lambda()
         #1
         __cxa_atexit(StringName::~StringName,
                   &set_fallback_base_scale(float)::{lambda()
         #1
         ;;
         __cxa_guard_release(&set_fallback_base_scale(float)::{lambda()
         #1
      }
      (**(code **)(*(long *)this + 0xd0))
              (this,&set_fallback_base_scale(float)::{lambda()
      #1
      if (Variant::needs_deinit[0] != '\0') {
         Variant::_clear_internal();
      }
   ...
   return;
}/* ThemeDB::set_fallback_icon(Ref<Texture2D> const&) */void ThemeDB::set_fallback_icon(ThemeDB *this, Ref *param_1) {
   Object *pOVar1;
   Object *pOVar2;
   long lVar3;
   char cVar4;
   ...
   if (pOVar1 != pOVar2) {
      *(Object**)( this + 0x1a0 ) = pOVar2;
      ...
      if (set_fallback_icon(Ref<Texture2D>const&)::{lambda()
      #1
      iVar5 = __cxa_guard_acquire(&set_fallback_icon(Ref < Texture2D > const & sname));
      if (iVar5 != 0) {
         _scs_create((char*)&set_fallback_icon(Ref < Texture2D > const & ::sname, true));
         __cxa_atexit(StringName::~StringName, &set_fallback_icon(Ref < Texture2D > const & ::sname, &__dso_handle));
         __cxa_guard_release(&set_fallback_icon(Ref<Texture2D>const&)::{lambda()
         #1
         sname;
      }
   }
   (**(code **)(*(long *)this + 0xd0))
              (this,&set_fallback_icon(Ref<Texture2D>const&)::{lambda()
   #1
   ;;
   if (Variant::needs_deinit[0] != '\0') {
      Variant::_clear_internal();
   ...
   return;
}/* WARNING: Subroutine does not return */__stack_chk_fail();}/* ThemeDB::set_fallback_stylebox(Ref<StyleBox> const&) */void ThemeDB::set_fallback_stylebox(ThemeDB *this, Ref *param_1) {
   Object *pOVar1;
   Object *pOVar2;
   long lVar3;
   char cVar4;
   ...
   if (pOVar1 != pOVar2) {
      *(Object**)( this + 0x1a8 ) = pOVar2;
      ...
      if (set_fallback_stylebox(Ref<StyleBox>const&)::{lambda()
      #1
      iVar5 = __cxa_guard_acquire(&set_fallback_stylebox(Ref < StyleBox > const & sname));
      if (iVar5 != 0) {
         _scs_create((char*)&set_fallback_stylebox(Ref < StyleBox > const & ::sname, true));
         __cxa_atexit(StringName::~StringName, &set_fallback_stylebox(Ref < StyleBox > const & ::sname, &__dso_handle));
         __cxa_guard_release(&set_fallback_stylebox(Ref<StyleBox>const&)::{lambda()
         #1
         ::sname
         )
         ;
   ...
   ( **(code**)( *(long*)this + 0xd0 ) )(this, &set_fallback_stylebox(Ref < StyleBox > const & ::sname, 0, 0));
   if (Variant::needs_deinit[0] != '\0') {
      Variant::_clear_internal();
   }
}if (lVar3 == *(long*)( in_FS_OFFSET + 0x28 )) {
   ...
   *plVar1 = (long)puVar3;
   return;
}/* ThemeDB::set_default_theme(Ref<Theme> const&) */void ThemeDB::set_default_theme(ThemeDB *this, Ref *param_1) {
   Object *pOVar1;
   Object *pOVar2;
   char cVar3;
   ...
   return;
}/* ThemeDB::set_project_theme(Ref<Theme> const&) */void ThemeDB::set_project_theme(ThemeDB *this, Ref *param_1) {
   Object *pOVar1;
   Object *pOVar2;
   char cVar3;
   pOVar1 = *(Object**)param_1;
   ...
   return;
}/* ThemeDB::_finalize_theme_contexts() */void ThemeDB::_finalize_theme_contexts(ThemeDB *this) {
   Object *pOVar1;
   long lVar2;
   char cVar3;
   ...
   if (*(int*)( this + 0x1e4 ) != 0) {
      do {
         ...
         HashMap<Node*,ThemeContext*,HashMapHasherDefault,HashMapComparatorDefault<Node*>,DefaultTypedAllocator<HashMapElement<Node*,ThemeContext*>>>::erase((HashMap<Node*,ThemeContext*,HashMapHasherDefault,HashMapComparatorDefault<Node*>,DefaultTypedAllocator<HashMapElement<Node*,ThemeContext*>>>*)( this + 0x1b8 ), (Node**)( lVar2 + 0x10 ));
      } while ( *(int*)( this + 0x1e4 ) != 0 );
   }
   return;
}/* ThemeDB::finalize_theme() */void ThemeDB::finalize_theme(ThemeDB *this) {
   Object *pOVar1;
   char cVar2;
   long lVar3;
   lVar3 = RenderingServer::get_singleton();
   if (lVar3 == 0) {
      _err_print_error("finalize_theme", "scene/theme/theme_db.cpp", 0x69, "Finalizing theme when there is no RenderingServer is an error; check the order of operations.", 0, 1);
   }
   _finalize_theme_contexts(this);
   for (int i = 0; i < 4; i++) {
      if (*(long*)( this + ( -4*i*i + 28*i + 376 ) ) != 0) {
         cVar2 = RefCounted::unreference();
         if (cVar2 != '\0') {
            pOVar1 = *(Object**)( this + ( -4*i*i + 28*i + 376 ) );
      ...
      *(undefined8*)( this + ( -4*i*i + 28*i + 376 ) ) = 0;
   }
   return;
}/* ThemeDB::get_theme_context(Node*) const */long ThemeDB::get_theme_context(ThemeDB *this, Node *param_1) {
   uint uVar1;
   long lVar2;
   long lVar3;
   undefined1 auVar4[16];
         ...
         if (uVar19 != 0) {
            ...
            do {
               if (( uVar21 == uVar27 ) && ( *(Node**)( *(long*)( local_58 + lVar25 * 8 ) + 0x10 ) == param_1 )) {
                  uVar27 = 0;
                  do {
                     if (( uVar21 == uVar19 ) && ( *(Node**)( *(long*)( local_58 + lVar24 * 8 ) + 0x10 ) == param_1 )) {
                  ...
                  } while ( ( uVar19 != 0 ) && ( auVar9._8_8_ = 0 ),auVar9._0_8_ = (ulong)uVar19 * lVar3,auVar16._8_8_ = 0,auVar16._0_8_ = uVar28,auVar10._8_8_ = 0,auVar10._0_8_ = ( ulong )(( uVar1 + uVar22 ) - SUB164(auVar9 * auVar16, 8)) * lVar3,auVar17._8_8_ = 0,auVar17._0_8_ = uVar28,uVar27 <= SUB164(auVar10 * auVar17, 8) );
            ...
            } while ( ( uVar27 != 0 ) && ( auVar6._8_8_ = 0 ),auVar6._0_8_ = (ulong)uVar27 * lVar3,auVar13._8_8_ = 0,auVar13._0_8_ = uVar28,auVar7._8_8_ = 0,auVar7._0_8_ = ( ulong )(( uVar1 + uVar23 ) - SUB164(auVar6 * auVar13, 8)) * lVar3,auVar14._8_8_ = 0,auVar14._0_8_ = uVar28,uVar26 <= SUB164(auVar7 * auVar14, 8) );
         }
      }
      local_58 = 0;
   }
   return local_58;
}/* ThemeDB::get_default_theme_context() const */undefined8 ThemeDB::get_default_theme_context(ThemeDB *this) {
   return *(undefined8*)( this + 0x1b0 );
}/* ThemeDB::get_nearest_theme_context(Node*) const */undefined8 ThemeDB::get_nearest_theme_context(ThemeDB *this, Node *param_1) {
   long lVar1;
   long lVar2;
   undefined1 auVar3[16];
   undefined1 auVar4[16];
   ...
   if (( (byte)param_1[0x2fa] & 0x40 ) == 0) {
      _err_print_error("get_nearest_theme_context", "scene/theme/theme_db.cpp", 0x13a, "Condition \"!p_for_node->is_inside_tree()\" is true. Returning: nullptr", 0, 0);
      uVar15 = 0;
   } else {
      ...
      while (ppNVar13 != (Node**)0x0) {
         ...
         if (( lVar1 != 0 ) && ( *(int*)( this + 0x1e4 ) != 0 )) {
            ...
            if (uVar19 != 0) {
               uVar21 = 0;
               do {
                  if (( uVar19 == (uint)uVar18 ) && ( ppNVar13 == *(Node***)( *(long*)( lVar1 + lVar17 * 8 ) + 0x10 ) )) {
                     local_44 = 0;
                     cVar12 = HashMap<Node*,ThemeContext*,HashMapHasherDefault,HashMapComparatorDefault<Node*>,DefaultTypedAllocator<HashMapElement<Node*,ThemeContext*>>>::_lookup_pos((HashMap<Node*,ThemeContext*,HashMapHasherDefault,HashMapComparatorDefault<Node*>,DefaultTypedAllocator<HashMapElement<Node*,ThemeContext*>>>*)( this + 0x1b8 ), ppNVar13, &local_44);
                     if (cVar12 == '\0') {
                        _err_print_error("operator[]", "./core/templates/hash_map.h", 0x245, "FATAL: Condition \"!exists\" is true.", 0, 0);
                        _err_flush_stdout();
                        /* WARNING: Does not return */
               ...
               } while ( ( uVar19 != 0 ) && ( auVar5._8_8_ = 0 ),auVar5._0_8_ = (ulong)uVar19 * lVar2,auVar9._8_8_ = 0,auVar9._0_8_ = uVar20,auVar6._8_8_ = 0,auVar6._0_8_ = ( ulong )(( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x1e0 ) * 4 ) + iVar16 ) - SUB164(auVar5 * auVar9, 8)) * lVar2,auVar10._8_8_ = 0,auVar10._0_8_ = uVar20,uVar21 <= SUB164(auVar6 * auVar10, 8) );
            }
         }
         ppNVar13 = (Node**)Node::get_parent();
      };
   ...
   LAB_0010163a:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar15;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* ThemeDB::get_singleton() */undefined8 ThemeDB::get_singleton(void) {
   return singleton;
}/* ThemeDB::ThemeDB() */void ThemeDB::ThemeDB(ThemeDB *this) {
   undefined8 uVar1;
   long lVar2;
   long lVar3;
   ...
   *(undefined8*)( this + 0x1b0 ) = 0;
   for (int i = 0; i < 3; i++) {
      *(undefined8*)( this + ( 48*i + 480 ) ) = uVar1;
   }
   singleton = this;
   *(undefined1(*) [16])( this + 0x178 ) = (undefined1[16])0x0;
   for (int i = 0; i < 3; i++) {
      *(undefined1(*) [16])( this + ( 48*i + 416 ) ) = (undefined1[16])0;
      *(undefined1(*) [16])( this + ( 48*i + 448 ) ) = (undefined1[16])0;
   }
   *(undefined1(*) [16])( this + 0x230 ) = (undefined1[16])0x0;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* ThemeContext::get_fallback_theme() const */void ThemeContext::get_fallback_theme(void) {
   long lVar1;
   long lVar2;
   code *pcVar3;
   char cVar4;
   ...
   return;
}/* ThemeDB::_propagate_theme_context(Node*, ThemeContext*) */void ThemeDB::_propagate_theme_context(ThemeDB *this, Node *param_1, ThemeContext *param_2) {
   long lVar1;
   undefined1 auVar2[16];
   undefined1 auVar3[16];
   undefined1 auVar4[16];
   ...
   do {
      ...
      if (( *(long*)( this + 0x1c0 ) != 0 ) && ( *(int*)( this + 0x1e4 ) != 0 )) {
         ...
         if (uVar17 != 0) {
            uVar19 = 0;
            do {
               if (( (uint)uVar16 == uVar17 ) && ( local_48 == *(Node**)( *(long*)( *(long*)( this + 0x1c0 ) + lVar14 * 8 ) + 0x10 ) )) {
                  plVar13 = (long*)HashMap<Node*,ThemeContext*,HashMapHasherDefault,HashMapComparatorDefault<Node*>,DefaultTypedAllocator<HashMapElement<Node*,ThemeContext*>>>::operator []((HashMap<Node*,ThemeContext*,HashMapHasherDefault,HashMapComparatorDefault<Node*>,DefaultTypedAllocator<HashMapElement<Node*,ThemeContext*>>>*)( this + 0x1b8 ), &local_48);
            ...
            } while ( ( uVar17 != 0 ) && ( auVar4._8_8_ = 0 ),auVar4._0_8_ = (ulong)uVar17 * lVar1,auVar8._8_8_ = 0,auVar8._0_8_ = uVar18,auVar5._8_8_ = 0,auVar5._0_8_ = ( ulong )(( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x1e0 ) * 4 ) + iVar10 ) - SUB164(auVar4 * auVar8, 8)) * lVar1,auVar9._8_8_ = 0,auVar9._0_8_ = uVar18,uVar19 <= SUB164(auVar5 * auVar9, 8) );
         }
      }
      _propagate_theme_context(this, local_48, param_2);
      LAB_00101b82:iVar15 = iVar15 + 1;
   } while ( true );
}/* ThemeDB::destroy_theme_context(Node*) */void ThemeDB::destroy_theme_context(ThemeDB *this, Node *param_1) {
   long lVar1;
   code *pcVar2;
   Object *pOVar3;
   undefined1 auVar4[16];
   ...
   if (( *(long*)( this + 0x1c0 ) != 0 ) && ( *(int*)( this + 0x1e4 ) != 0 )) {
      ...
      if (uVar17 != 0) {
         uVar19 = 0;
         do {
            if (( (uint)uVar20 == uVar17 ) && ( param_1 == *(Node**)( *(long*)( *(long*)( this + 0x1c0 ) + lVar16 * 8 ) + 0x10 ) )) {
               pcVar2 = *(code**)( *(long*)param_1 + 0x110 );
               create_custom_callable_function_pointer<ThemeDB,Node*>(local_58, (char*)this, (_func_void_Node_ptr*)"&ThemeDB::destroy_theme_context");
               ( *pcVar2 )(param_1, SceneStringNames::singleton + 0x48, local_58);
               Callable::~Callable((Callable*)local_58);
               puVar14 = (undefined8*)HashMap<Node*,ThemeContext*,HashMapHasherDefault,HashMapComparatorDefault<Node*>,DefaultTypedAllocator<HashMapElement<Node*,ThemeContext*>>>::operator []((HashMap<Node*,ThemeContext*,HashMapHasherDefault,HashMapComparatorDefault<Node*>,DefaultTypedAllocator<HashMapElement<Node*,ThemeContext*>>>*)( this + 0x1b8 ), &local_60);
               pOVar3 = (Object*)*puVar14;
               HashMap<Node*,ThemeContext*,HashMapHasherDefault,HashMapComparatorDefault<Node*>,DefaultTypedAllocator<HashMapElement<Node*,ThemeContext*>>>::erase((HashMap<Node*,ThemeContext*,HashMapHasherDefault,HashMapComparatorDefault<Node*>,DefaultTypedAllocator<HashMapElement<Node*,ThemeContext*>>>*)( this + 0x1b8 ), &local_60);
         ...
         } while ( ( uVar17 != 0 ) && ( auVar6._8_8_ = 0 ),auVar6._0_8_ = (ulong)uVar17 * lVar1,auVar10._8_8_ = 0,auVar10._0_8_ = uVar18,auVar7._8_8_ = 0,auVar7._0_8_ = ( ulong )(( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x1e0 ) * 4 ) + iVar15 ) - SUB164(auVar6 * auVar10, 8)) * lVar1,auVar11._8_8_ = 0,auVar11._0_8_ = uVar18,uVar19 <= SUB164(auVar7 * auVar11, 8) );
      }
   }
   _err_print_error("destroy_theme_context", "scene/theme/theme_db.cpp", 0xea, "Condition \"!theme_contexts.has(p_node)\" is true.", 0, 0);
   LAB_00101df8:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* ThemeDB::get_class_items(StringName const&, List<ThemeDB::ThemeItemBind, DefaultAllocator>*,
   bool, Theme::DataType) */void ThemeDB::get_class_items(ThemeDB *this, StringName *param_1, List<ThemeDB::ThemeItemBind,DefaultAllocator> *param_2, char param_3, int param_5) {
   uint uVar1;
   long lVar2;
   undefined8 *puVar3;
   undefined1 auVar4[16];
      ...
      do {
         while (true) {
            ...
            *(int*)pauVar22[1] = *(int*)pauVar22[1] + 1;
            ...
            joined_r0x00102371:if (local_80 == 0) goto LAB_00101f79;
         };
      ...
      if (plVar26 != (long*)0x0) {
         ...
         do {
            if (( *(long*)( this + 0x220 ) != 0 ) && ( *(int*)( this + 0x244 ) != 0 )) {
               ...
               if (uVar30 != 0) {
                  uVar31 = 0;
                  while (( uVar21 != uVar30 || ( *(long*)( *(long*)( *(long*)( this + 0x220 ) + lVar25 * 8 ) + 0x10 ) != *plVar26 ) )) {
                     uVar31 = uVar31 + 1;
                     auVar5._8_8_ = 0;
                     ...
                     if (( uVar30 == 0 ) || ( auVar6._8_8_ = 0 ),auVar6._0_8_ = (ulong)uVar30 * lVar2,auVar14._8_8_ = 0,auVar14._0_8_ = uVar29,auVar7._8_8_ = 0,auVar7._0_8_ = ( ulong )(( uVar1 + uVar23 ) - SUB164(auVar6 * auVar14, 8)) * lVar2,auVar15._8_8_ = 0,auVar15._0_8_ = uVar29,SUB164(auVar7 * auVar15, 8) < uVar31) goto LAB_001020f3;
                  };
                  lVar2 = *(long*)( *(long*)( this + 0x220 ) + (ulong)uVar23 * 8 );
                  if (( lVar2 != 0 ) && ( puVar3 = *(undefined8**)( lVar2 + 0x18 ) ),puVar3 != (undefined8*)0x0) {
                     for (pTVar27 = (ThemeItemBind*)*puVar3; pTVar27 != (ThemeItemBind*)0x0; pTVar27 = *(ThemeItemBind**)( pTVar27 + 0x48 )) {
                        while (true) {
                           if (param_5 != 6) {
                           ...
                           if (( plVar32 != (long*)0x0 ) && ( local_48._4_4_ != 0 )) {
                              ...
                              if (uVar30 != 0) {
                                 uVar30 = 0;
                                 do {
                                    if (( uVar21 == (uint)uVar28 ) && ( plVar32[*(uint*)( local_68._8_8_ + lVar25 * 4 )] == *(long*)( pTVar27 + 0x10 ) )) goto LAB_001022d2;
                                    uVar30 = uVar30 + 1;
                                    auVar9._8_8_ = 0;
                                 ...
                                 } while ( ( uVar23 != 0 ) && ( auVar10._8_8_ = 0 ),auVar10._0_8_ = uVar28 * lVar2,auVar18._8_8_ = 0,auVar18._0_8_ = uVar29,auVar11._8_8_ = 0,auVar11._0_8_ = ( ulong )(( uVar1 + iVar24 ) - SUB164(auVar10 * auVar18, 8)) * lVar2,auVar19._8_8_ = 0,auVar19._0_8_ = uVar29,uVar30 <= SUB164(auVar11 * auVar19, 8) );
                              }
                           }
                           if (( pTVar27[0x20] == (ThemeItemBind)0x0 ) && ( *(long*)( pTVar27 + 8 ) == *(long*)param_1 )) break;
                           HashSet<StringName,HashMapHasherDefault,HashMapComparatorDefault<StringName>>::insert(local_78);
                           plVar32 = (long*)local_68._0_8_;
                           if (param_3 != '\0') break;
                           LAB_001022d2:pTVar27 = *(ThemeItemBind**)( pTVar27 + 0x48 );
                           if (pTVar27 == (ThemeItemBind*)0x0) goto LAB_001020f3;
                        };
            ...
            LAB_001020f3:plVar26 = (long*)plVar26[1];
   ...
   return;
}/* ThemeDB::_sort_theme_items() */void ThemeDB::_sort_theme_items(ThemeDB *this) {
   undefined8 *puVar1;
   for (puVar1 = *(undefined8**)( this + 0x230 ); puVar1 != (undefined8*)0x0; puVar1 = (undefined8*)*puVar1) {
      List<ThemeDB::ThemeItemBind,DefaultAllocator>::sort_custom<ThemeDB::ThemeItemBind::SortByType>((List<ThemeDB::ThemeItemBind,DefaultAllocator>*)( puVar1 + 3 ));
   }
   return;
}/* ThemeDB::update_class_instance_items(Node*) */void ThemeDB::update_class_instance_items(ThemeDB *this, Node *param_1) {
   long lVar1;
   long lVar2;
   undefined1 auVar3[16];
   undefined1 auVar4[16];
   ...
   if (param_1 == (Node*)0x0) {
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         _err_print_error("update_class_instance_items", "scene/theme/theme_db.cpp", 0x167, "Parameter \"p_instance\" is null.", 0, 0);
         return;
      }
   } else {
      ...
      LAB_0010244c:if (local_50 != (Node*)0x0) {
         LAB_00102455:lVar1 = *(long*)( this + 0x1f0 );
         if (( lVar1 != 0 ) && ( *(int*)( this + 0x214 ) != 0 )) {
            ...
            if (uVar15 != 0) {
               ...
               while (( uVar11 != uVar15 || ( local_50 != *(Node**)( *(long*)( lVar1 + lVar13 * 8 ) + 0x10 ) ) )) {
                  ...
                  if (( uVar15 == 0 ) || ( auVar5._8_8_ = 0 ),auVar5._0_8_ = (ulong)uVar15 * lVar2,auVar9._8_8_ = 0,auVar9._0_8_ = uVar16,auVar6._8_8_ = 0,auVar6._0_8_ = ( ulong )(( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x210 ) * 4 ) + uVar12 ) - SUB164(auVar5 * auVar9, 8)) * lVar2,auVar10._8_8_ = 0,auVar10._0_8_ = uVar16,SUB164(auVar6 * auVar10, 8) < uVar17) goto LAB_0010256b;
               };
               lVar1 = *(long*)( lVar1 + (ulong)uVar12 * 8 );
               if (( lVar1 != 0 ) && ( plVar14 = *(long**)( lVar1 + 0x30 ) ),plVar14 != (long*)0x0) goto LAB_00102540;
            }
         }
         goto LAB_0010256b;
      }
      LAB_001025a1:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   }
   LAB_0010262c:/* WARNING: Subroutine does not return */__stack_chk_fail();
   while (true) {
      ( *(code*)plVar14[0xb] )(plVar14 + 8, (CowData<char32_t>*)&local_48, plVar14 + 5, plVar14 + 6);
      plVar14 = (long*)*plVar14;
      if (plVar14 == (long*)0x0) break;
      LAB_00102540:local_48 = param_1;
      if (plVar14[10] == 0) {
         std::__throw_bad_function_call();
         goto LAB_0010262c;
      }
   };
   LAB_0010256b:ClassDB::get_parent_class_nocheck((StringName*)&local_48);
   if (local_50 == local_48) goto LAB_001025c0;
   StringName::unref();
   local_50 = local_48;
   if (local_48 == (Node*)0x0) goto LAB_001025a1;
   goto LAB_00102455;
   LAB_001025c0:if (StringName::configured != '\0') {
      if (local_50 == (Node*)0x0) goto LAB_001025a1;
      StringName::unref();
   }
   goto LAB_0010244c;
}/* ThemeContext::_bind_methods() */void ThemeContext::_bind_methods(void) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   int *piVar4;
   ...
   *(undefined8*)( this + 0x1a8 ) = 0;
            ...
            do {
               if (*(int*)( *(long*)( this + 0x228 ) + lVar6 ) != 0) {
                  ...
                  *(int*)( *(long*)( this + 0x228 ) + lVar6 ) = 0;
                  List<ThemeDB::ThemeItemBind,DefaultAllocator>::~List((List<ThemeDB::ThemeItemBind,DefaultAllocator>*)( (long)pvVar9 + 0x18 ));
   ...
   LAB_00102a81:pvVar9 = *(void**)( this + 0x1f0 );
   if (pvVar9 != (void*)0x0) {
      if (*(int*)( this + 0x214 ) != 0) {
            ...
            do {
               if (*(int*)( *(long*)( this + 0x1f8 ) + lVar6 ) != 0) {
                  ...
                  *(int*)( *(long*)( this + 0x1f8 ) + lVar6 ) = 0;
                              ...
                              if (*piVar5 != 0) {
                                 ...
                                 *piVar5 = 0;
                                 if (*(code**)( (long)pvVar8 + 0x50 ) != (code*)0x0) {
                                    ( **(code**)( (long)pvVar8 + 0x50 ) )((long)pvVar8 + 0x40, (long)pvVar8 + 0x40, 3);
                                 }
                                 if (StringName::configured != '\0') {
                                    for (int i = 0; i < 3; i++) {
                                       if (*(long*)( (long)pvVar8 + ( -8*i + 48 ) ) != 0) {
                                          StringName::unref();
                                 ...
                                 LAB_00102bd1:Memory::free_static(pvVar8, false);
                                 pvVar8 = *(void**)( (long)pvVar9 + 0x20 );
                  ...
                  LAB_00102c16:if (( StringName::configured != '\0' ) && ( *(long*)( (long)pvVar9 + 0x10 ) != 0 )) {
                     StringName::unref();
                  }
                  Memory::free_static(pvVar9, false);
   ...
   LAB_00102c7c:pvVar9 = *(void**)( this + 0x1c0 );
   if (pvVar9 != (void*)0x0) {
      if (*(int*)( this + 0x1e4 ) != 0) {
         uVar1 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x1e0 ) * 4 );
         if (uVar1 == 0) {
   ...
   LAB_00102d17:if (*(long*)( this + 0x1a8 ) != 0) {
      cVar4 = RefCounted::unreference();
      if (cVar4 != '\0') {
         pOVar3 = *(Object**)( this + 0x1a8 );
         cVar4 = predelete_handler(pOVar3);
   ...
   return;
}/* ThemeDB::_bind_methods() */void ThemeDB::_bind_methods(void) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   int *piVar4;
   ...
   PropertyInfo::PropertyInfo((PropertyInfo*)&local_d8, 3, (StrRange*)&local_110, 1, (StrRange*)&local_108, 6, &local_100);
   local_e8 = "ThemeDB";
   local_118 = 0;
   local_e0 = 7;
   ...
   local_d0 = 0xd;
   String::parse_latin1((StrRange*)&local_110);
   PropertyInfo::PropertyInfo((PropertyInfo*)&local_d8, 0x18, (StrRange*)&local_110, 0x11, (StrRange*)&local_108, 0, &local_100);
   local_e8 = "ThemeDB";
   local_118 = 0;
   local_e0 = 7;
   String::parse_latin1((StrRange*)&local_118);
   ...
   local_d0 = 0x12;
   String::parse_latin1((StrRange*)&local_110);
   PropertyInfo::PropertyInfo((PropertyInfo*)&local_d8, 2, (StrRange*)&local_110, 1, (StrRange*)&local_108, 6, &local_100);
   local_e8 = "ThemeDB";
   local_118 = 0;
   local_e0 = 7;
   String::parse_latin1((StrRange*)&local_118);
   ...
   String::parse_latin1((StrRange*)&local_f0);
   for (int i = 0; i < 16; i++) {
      local_c8[i] = (CowData<StringName>)0;
   }
   local_d8 = (char*)0x0;
   local_d0 = 0;
   local_b8 = 0;
   ...
   return;
}/* ThemeDB::get_native_type_dependencies(StringName const&, Vector<StringName>&) */void ThemeDB::get_native_type_dependencies(ThemeDB *this, StringName *param_1, Vector *param_2) {
   char cVar1;
   int iVar2;
   long lVar3;
   long lVar4;
   ...
   if (iVar2 == 0) {
      if (*(long*)( param_2 + 8 ) == 0) {
         ...
         if (-1 < lVar4) {
            ...
            StringName::operator =((StringName*)( *(long*)( param_2 + 8 ) + lVar4 * 8 ), (StringName*)&local_38);
            goto LAB_00104545;
         }
      }
   ...
   LAB_00104545:if (( StringName::configured != '\0' ) && ( local_38 != 0 )) {
      StringName::unref();
   }
   LAB_001044b9:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* ThemeContext::get_themes() const */void ThemeContext::get_themes(void) {
   long *plVar1;
   long lVar2;
   long lVar3;
   long in_RSI;
   ...
   *(undefined8*)( in_RDI + 8 ) = 0;
   ...
   return;
}/* CowData<Ref<Theme> >::_copy_on_write() [clone .isra.0] */void CowData<Ref<Theme>>::_copy_on_write(CowData<Ref<Theme>> *this) {
   long lVar1;
   long lVar2;
   code *pcVar3;
   char cVar4;
   ...
   *(undefined8**)this = puVar5 + 2;
   return;
}/* Vector<Ref<Theme> >::push_back(Ref<Theme>) [clone .isra.0] */void Vector<Ref<Theme>>::push_back(Vector<Ref<Theme>> *this, long *param_2) {
   long *plVar1;
   Object *pOVar2;
   Object *pOVar3;
   char cVar4;
   ...
   return;
}/* ThemeContext::set_themes(Vector<Ref<Theme> >&) */void ThemeContext::set_themes(ThemeContext *this, Vector *param_1) {
   ...
   if (lVar4 == 0) {
      ...
      LAB_0010497c:do {
         ...
         puVar6 = puVar6 + 1;
         create_custom_callable_function_pointer<ThemeContext>((ThemeContext*)local_68, (char*)this, (_func_void*)"&ThemeContext::_emit_changed");
   ...
   LAB_001049e4:CowData<Ref<Theme>>::_copy_on_write((CowData<Ref<Theme>>*)( param_1 + 8 ));
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* ThemeDB::create_theme_context(Node*, Vector<Ref<Theme> >&) */Object * __thiscall ThemeDB::create_theme_context(ThemeDB *this,Node *param_1,Vector *param_2){
   long lVar1;
   code *pcVar2;
   undefined1 auVar3[16];
   undefined1 auVar4[16];
   ...
   local_b0 = param_1;
   if (( (byte)param_1[0x2fa] & 0x40 ) == 0) {
      _err_print_error("create_theme_context", "scene/theme/theme_db.cpp", 0xd8, "Condition \"!p_node->is_inside_tree()\" is true. Returning: nullptr", 0, 0);
   } else {
      if (( *(long*)( this + 0x1c0 ) != 0 ) && ( *(int*)( this + 0x1e4 ) != 0 )) {
         ...
         if (uVar16 != 0) {
            uVar18 = 0;
            do {
               if (( uVar16 == (uint)uVar19 ) && ( param_1 == *(Node**)( *(long*)( *(long*)( this + 0x1c0 ) + lVar15 * 8 ) + 0x10 ) )) {
                  _err_print_error("create_theme_context", "scene/theme/theme_db.cpp", 0xd9, "Condition \"theme_contexts.has(p_node)\" is true. Returning: nullptr", 0, 0);
                  goto LAB_00104cee;
               }
               uVar18 = uVar18 + 1;
               auVar4._8_8_ = 0;
            ...
            } while ( ( uVar16 != 0 ) && ( auVar5._8_8_ = 0 ),auVar5._0_8_ = (ulong)uVar16 * lVar1,auVar9._8_8_ = 0,auVar9._0_8_ = uVar17,auVar6._8_8_ = 0,auVar6._0_8_ = ( ulong )(( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x1e0 ) * 4 ) + iVar14 ) - SUB164(auVar5 * auVar9, 8)) * lVar1,auVar10._8_8_ = 0,auVar10._0_8_ = uVar17,uVar18 <= SUB164(auVar6 * auVar10, 8) );
         }
      }
      if (*(long*)( param_2 + 8 ) != 0) {
         ...
         *(undefined8*)( this_00 + 0x180 ) = uVar12;
         ...
         puVar13 = (undefined8*)HashMap<Node*,ThemeContext*,HashMapHasherDefault,HashMapComparatorDefault<Node*>,DefaultTypedAllocator<HashMapElement<Node*,ThemeContext*>>>::operator []((HashMap<Node*,ThemeContext*,HashMapHasherDefault,HashMapComparatorDefault<Node*>,DefaultTypedAllocator<HashMapElement<Node*,ThemeContext*>>>*)( this + 0x1b8 ), &local_b0);
         *puVar13 = this_00;
         _propagate_theme_context(this, param_1, (ThemeContext*)this_00);
         pcVar2 = *(code**)( *(long*)param_1 + 0x108 );
         create_custom_callable_function_pointer<ThemeDB,Node*>(local_a8, (char*)this, (_func_void_Node_ptr*)"&ThemeDB::destroy_theme_context");
      ...
      _err_print_error("create_theme_context", "scene/theme/theme_db.cpp", 0xda, "Condition \"p_themes.is_empty()\" is true. Returning: nullptr", 0, 0);
   }
   LAB_00104cee:this_00 = (Object*)0x0;
   LAB_00104e57:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return this_00;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* ThemeDB::_init_default_theme_context() */void ThemeDB::_init_default_theme_context(ThemeDB *this) {
   char cVar1;
   Object *pOVar2;
   long lVar3;
   long in_FS_OFFSET;
   ...
   *(Object**)( this + 0x1b0 ) = pOVar2;
   ...
   if (*(char*)( lVar3 + 0xc0 ) == '\0') {
      pOVar2 = *(Object**)( this + 0x180 );
      if (( pOVar2 == (Object*)0x0 ) || ( local_50 = pOVar2 ),cVar1 = RefCounted::reference(),cVar1 == '\0') {
         local_50 = (Object*)0x0;
   ...
   return;
}/* ThemeDB::initialize_theme() */void ThemeDB::initialize_theme(ThemeDB *this) {
   Object *pOVar1;
   Ref *pRVar2;
   bool bVar3;
   bool bVar4;
   ...
   local_a0 = 0x10;
   String::parse_latin1((StrRange*)&local_c0);
   PropertyInfo::PropertyInfo((PropertyInfo*)&local_a8, 4, (StrRange*)&local_c0, 0xd, (StrRange*)&local_b8, 0x806, (StrRange*)&local_b0);
   ...
   local_a0 = 0x23;
   String::parse_latin1((StrRange*)&local_c0);
   PropertyInfo::PropertyInfo((PropertyInfo*)&local_a8, 2, (StrRange*)&local_c0, 2, (StrRange*)&local_b8, 0x806, (StrRange*)&local_b0);
   ...
   local_a0 = 0x1d;
   String::parse_latin1((StrRange*)&local_c0);
   PropertyInfo::PropertyInfo((PropertyInfo*)&local_a8, 2, (StrRange*)&local_c0, 2, (StrRange*)&local_b8, 6, (StrRange*)&local_b0);
   _GLOBAL_DEF((PropertyInfo*)local_58, (Variant*)&local_a8, bVar13, true, false, false);
   if (Variant::needs_deinit[local_58[0]] != '\0') {
      Variant::_clear_internal();
   }
   ...
   if (( local_d0 != 0 ) && ( 1 < *(uint*)( local_d0 + -8 ) )) {
      ...
      if (local_b0 == (Ref*)0x0) {
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_b8);
         LAB_00105f68:local_b0 = (Ref*)0x0;
         String::parse_latin1((String*)&local_b0, "\'");
         operator+((char *)&
         local_b8,(String*)"Error loading custom project theme \'";
         String::operator +((String*)&local_a8, (String*)&local_b8);
         _err_print_error("initialize_theme", "scene/theme/theme_db.cpp", 0x48, (PropertyInfo*)&local_a8, 0, 0);
         ...
         if (pOVar12 == (Object*)0x0) {
            LAB_00105d77:cVar5 = RefCounted::unreference();
            pRVar11 = local_b0;
            if (cVar5 != '\0') {
   ...
   if (( local_c8 == 0 ) || ( *(uint*)( local_c8 + -8 ) < 2 )) {
      LAB_00105ab9:lVar10 = RenderingServer::get_singleton();
      if (lVar10 == 0) {
      ...
      pRVar11 = (Ref*)0x0;
      local_b0 = (Ref*)0x0;
      LAB_00105b27:make_default_theme(fVar14, (StrRange*)&local_b0, iVar8, iVar7, iVar6, bVar3, bVar4);
      ...
      if (local_b0 == (Ref*)0x0) {
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_b8);
         LAB_00105fe8:local_b0 = (Ref*)0x0;
         String::parse_latin1((String*)&local_b0, "\'");
         operator+((char *)&
         local_b8,(String*)"Error loading custom project font \'";
         String::operator +((String*)&local_a8, (String*)&local_b8);
         _err_print_error("initialize_theme", "scene/theme/theme_db.cpp", 0x52, (PropertyInfo*)&local_a8, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_a8);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_b8);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_b0);
         goto LAB_00105ab9;
      ...
      if (pRVar11 == (Ref*)0x0) {
         LAB_00105c2c:cVar5 = RefCounted::unreference();
         pRVar2 = local_b0;
         if (cVar5 != '\0') {
            cVar5 = predelete_handler((Object*)local_b0);
            if (cVar5 != '\0') {
      ...
      if (*(Ref**)( this + 400 ) == pRVar11) {
         ...
         LAB_00105c99:local_a8 = (char*)0x0;
         local_b0 = pRVar11;
         cVar5 = RefCounted::reference();
         if (cVar5 == '\0') {
            local_b0 = (Ref*)0x0;
      ...
      LAB_00105e2e:_init_default_theme_context(this);
   }
   cVar5 = RefCounted::unreference();
   if (cVar5 != '\0') {
   ...
   LAB_00105acd:CowData<char32_t>::_unref((CowData<char32_t>*)&local_c8);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_d0);
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* ThemeDB::initialize_theme_noproject() */void ThemeDB::initialize_theme_noproject(ThemeDB *this) {
   Object *pOVar1;
   char cVar2;
   long lVar3;
   long in_FS_OFFSET;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}_init_default_theme_context(this);return;}/* ThemeDB::bind_class_item(Theme::DataType, StringName const&, StringName const&, StringName
   const&, std::function<void (Node*, StringName const&, StringName const&)>) */void ThemeDB::bind_class_item(ThemeDB *this, undefined4 param_2, StringName *param_3, StringName *param_4, StringName *param_5, long param_6) {
   uint uVar1;
   long lVar2;
   undefined1 auVar3[16];
   undefined1 auVar4[16];
   ...
   uint uVar12;
   long lVar13;
   HashMap<StringName,ThemeDB::ThemeItemBind,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ThemeDB::ThemeItemBind>>> *this_00;
   undefined4 *puVar14;
   ...
   if (( *(long*)( lVar13 + 8 ) != 0 ) && ( *(int*)( lVar13 + 0x2c ) != 0 )) {
      ...
      if (uVar18 != 0) {
         uVar19 = 0;
         do {
            if (( uVar18 == uVar12 ) && ( *(long*)( *(long*)( *(long*)( lVar13 + 8 ) + lVar16 * 8 ) + 0x10 ) == *(long*)param_4 )) {
               StringName::StringName((StringName*)&local_b8, param_3);
               StringName::StringName((StringName*)&local_c0, param_4);
               local_c8 = 0;
               String::parse_latin1((String*)&local_c8, "Failed to bind theme item \'%s\' in class \'%s\': already bound");
               vformat<StringName,StringName>(local_b0, (String*)&local_c8, (StringName*)&local_c0, (StringName*)&local_b8);
               _err_print_error("bind_class_item", "scene/theme/theme_db.cpp", 0x14b, "Condition \"theme_item_binds[p_class_name].has(p_prop_name)\" is true.", local_b0, 0, 0);
            ...
            uVar18 = *(uint*)( *(long*)( lVar13 + 0x10 ) + lVar16 * 4 );
            iVar15 = SUB164(auVar4 * auVar8, 8);
         } while ( ( uVar18 != 0 ) && ( auVar5._8_8_ = 0 ),auVar5._0_8_ = (ulong)uVar18 * lVar2,auVar9._8_8_ = 0,auVar9._0_8_ = uVar20,auVar6._8_8_ = 0,auVar6._0_8_ = ( ulong )(( uVar1 + iVar15 ) - SUB164(auVar5 * auVar9, 8)) * lVar2,auVar10._8_8_ = 0,auVar10._0_8_ = uVar20,uVar19 <= SUB164(auVar6 * auVar10, 8) );
      }
   }
   ...
   this_00 = (HashMap<StringName,ThemeDB::ThemeItemBind,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ThemeDB::ThemeItemBind>>>*)HashMap<StringName,HashMap<StringName,ThemeDB::ThemeItemBind,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ThemeDB::ThemeItemBind>>>,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,HashMap<StringName,ThemeDB::ThemeItemBind,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ThemeDB::ThemeItemBind>>>>>>::operator []((HashMap<StringName,HashMap<StringName,ThemeDB::ThemeItemBind,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ThemeDB::ThemeItemBind>>>,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,HashMap<StringName,ThemeDB::ThemeItemBind,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ThemeDB::ThemeItemBind>>>>>>*)( this + 0x1e8 ), param_3);
   puVar14 = (undefined4*)HashMap<StringName,ThemeDB::ThemeItemBind,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ThemeDB::ThemeItemBind>>>::operator [](this_00, param_4);
   *puVar14 = local_88[0];
   ...
   *(undefined8*)( puVar14 + 0x10 ) = uVar17;
   ...
   this_01 = (List<ThemeDB::ThemeItemBind,DefaultAllocator>*)HashMap<StringName,List<ThemeDB::ThemeItemBind,DefaultAllocator>,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,List<ThemeDB::ThemeItemBind,DefaultAllocator>>>>::operator []((HashMap<StringName,List<ThemeDB::ThemeItemBind,DefaultAllocator>,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,List<ThemeDB::ThemeItemBind,DefaultAllocator>>>>*)( this + 0x218 ), param_3);
   ...
   LAB_00106350:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   const&)>) */void ThemeDB::bind_class_external_item(ThemeDB *this, undefined4 param_2, StringName *param_3, StringName *param_4, StringName *param_5, StringName *param_6, long param_7) {
   uint uVar1;
   long lVar2;
   undefined1 auVar3[16];
   undefined1 auVar4[16];
      ...
      if (uVar18 != 0) {
         ...
         do {
            if (( uVar18 == uVar12 ) && ( *(long*)( *(long*)( *(long*)( lVar13 + 8 ) + lVar16 * 8 ) + 0x10 ) == *(long*)param_4 )) {
               ...
               String::parse_latin1((String*)&local_c8, "Failed to bind theme item \'%s\' in class \'%s\': already bound");
               vformat<StringName,StringName>(local_b0, (String*)&local_c8, (StringName*)&local_c0, (StringName*)&local_b8);
               _err_print_error("bind_class_external_item", "scene/theme/theme_db.cpp", 0x158, "Condition \"theme_item_binds[p_class_name].has(p_prop_name)\" is true.", local_b0, 0, 0);
               CowData<char32_t>::_unref(local_b0);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_c8);
   ...
   *(undefined8*)( puVar14 + 0x10 ) = uVar17;
   ...
   LAB_00106838:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   return 0;
}/* ThemeDB::is_class_ptr(void*) const */uint ThemeDB::is_class_ptr(ThemeDB *this, void *param_1) {
   return (uint)CONCAT71(0x116f, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x116f, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr);
}/* ThemeDB::_getv(StringName const&, Variant&) const */undefined8 ThemeDB::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}/* ThemeDB::_setv(StringName const&, Variant const&) */undefined8 ThemeDB::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}/* ThemeDB::_validate_propertyv(PropertyInfo&) const */void ThemeDB::_validate_propertyv(PropertyInfo *param_1) {
   return;
}/* ThemeDB::_property_can_revertv(StringName const&) const */undefined8 ThemeDB::_property_can_revertv(StringName *param_1) {
   return 0;
}/* ThemeDB::_property_get_revertv(StringName const&, Variant&) const */undefined8 ThemeDB::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}/* ThemeDB::_notificationv(int, bool) */void ThemeDB::_notificationv(int param_1, bool param_2) {
   return;
}/* ThemeContext::is_class_ptr(void*) const */uint ThemeContext::is_class_ptr(ThemeContext *this, void *param_1) {
   return (uint)CONCAT71(0x116f, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x116f, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr);
}/* ThemeContext::_getv(StringName const&, Variant&) const */undefined8 ThemeContext::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}/* ThemeContext::_setv(StringName const&, Variant const&) */undefined8 ThemeContext::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}/* ThemeContext::_validate_propertyv(PropertyInfo&) const */void ThemeContext::_validate_propertyv(PropertyInfo *param_1) {
   return;
}/* ThemeContext::_property_can_revertv(StringName const&) const */undefined8 ThemeContext::_property_can_revertv(StringName *param_1) {
   return 0;
}/* ThemeContext::_property_get_revertv(StringName const&, Variant&) const */undefined8 ThemeContext::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}/* ThemeContext::_notificationv(int, bool) */void ThemeContext::_notificationv(int param_1, bool param_2) {
   return;
}/* CallableCustomMethodPointer<ThemeContext, void>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<ThemeContext,void>::~CallableCustomMethodPointer(CallableCustomMethodPointer<ThemeContext,void> *this) {
   return;
}/* CallableCustomMethodPointer<ThemeDB, void>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<ThemeDB,void>::~CallableCustomMethodPointer(CallableCustomMethodPointer<ThemeDB,void> *this) {
   return;
}/* CallableCustomMethodPointer<ThemeDB, void, Node*>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<ThemeDB,void,Node*>::~CallableCustomMethodPointer(CallableCustomMethodPointer<ThemeDB,void,Node*> *this) {
   return;
}/* MethodBindTR<Ref<StyleBox>>::_gen_argument_type(int) const */undefined8 MethodBindTR<Ref<StyleBox>>::_gen_argument_type(int param_1) {
   return 0x18;
}/* MethodBindTR<Ref<StyleBox>>::get_argument_meta(int) const */undefined8 MethodBindTR<Ref<StyleBox>>::get_argument_meta(int param_1) {
   return 0;
}/* MethodBindT<Ref<StyleBox> const&>::_gen_argument_type(int) const */byte MethodBindT<Ref<StyleBox>const&>::_gen_argument_type(MethodBindT<Ref<StyleBox>const&> *this, int param_1) {
   return -(param_1 == 0) & 0x18;
}/* MethodBindT<Ref<StyleBox> const&>::get_argument_meta(int) const */undefined8 MethodBindT<Ref<StyleBox>const&>::get_argument_meta(int param_1) {
   return 0;
}/* MethodBindTR<Ref<Texture2D>>::_gen_argument_type(int) const */undefined8 MethodBindTR<Ref<Texture2D>>::_gen_argument_type(int param_1) {
   return 0x18;
}/* MethodBindTR<Ref<Texture2D>>::get_argument_meta(int) const */undefined8 MethodBindTR<Ref<Texture2D>>::get_argument_meta(int param_1) {
   return 0;
   ...
   return -(param_1 == 0) & 3;
}/* MethodBindTR<Ref<Font>>::_gen_argument_type(int) const */undefined8 MethodBindTR<Ref<Font>>::_gen_argument_type(int param_1) {
   return 0x18;
}/* MethodBindTR<Ref<Font>>::get_argument_meta(int) const */undefined8 MethodBindTR<Ref<Font>>::get_argument_meta(int param_1) {
   return 0;
   ...
   return -(param_1 == 0) & 9;
}/* MethodBindTR<Ref<Theme>>::_gen_argument_type(int) const */undefined8 MethodBindTR<Ref<Theme>>::_gen_argument_type(int param_1) {
   return 0x18;
}/* MethodBindTR<Ref<Theme>>::get_argument_meta(int) const */undefined8 MethodBindTR<Ref<Theme>>::get_argument_meta(int param_1) {
   return 0;
}/* CallableCustomMethodPointer<ThemeContext, void>::get_argument_count(bool&) const */undefined8 CallableCustomMethodPointer<ThemeContext,void>::get_argument_count(CallableCustomMethodPointer<ThemeContext,void> *this, bool *param_1) {
   *param_1 = true;
   return 0;
}/* CallableCustomMethodPointer<ThemeDB, void>::get_argument_count(bool&) const */undefined8 CallableCustomMethodPointer<ThemeDB,void>::get_argument_count(CallableCustomMethodPointer<ThemeDB,void> *this, bool *param_1) {
   *param_1 = true;
   return 0;
}/* CallableCustomMethodPointer<ThemeDB, void, Node*>::get_argument_count(bool&) const */undefined8 CallableCustomMethodPointer<ThemeDB,void,Node*>::get_argument_count(CallableCustomMethodPointer<ThemeDB,void,Node*> *this, bool *param_1) {
   *param_1 = true;
   return 1;
}/* CallableCustomMethodPointer<ThemeDB, void, Node*>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<ThemeDB,void,Node*>::~CallableCustomMethodPointer(CallableCustomMethodPointer<ThemeDB,void,Node*> *this) {
   ...
   return;
}/* MethodBindTR<Ref<Theme>>::~MethodBindTR() */void MethodBindTR<Ref<Theme>>::~MethodBindTR(MethodBindTR<Ref<Theme>> *this) {
   ...
   *(undefined***)this = &PTR__gen_argument_type_00116ca0;
   ...
   operator_delete(this, 0x68);
   return;
}/* MethodBindTR<Ref<Font>>::~MethodBindTR() */void MethodBindTR<Ref<Font>>::~MethodBindTR(MethodBindTR<Ref<Font>> *this) {
   ...
   *(undefined***)this = &PTR__gen_argument_type_00116e20;
   ...
   operator_delete(this, 0x68);
   return;
}/* MethodBindTR<Ref<Texture2D>>::~MethodBindTR() */void MethodBindTR<Ref<Texture2D>>::~MethodBindTR(MethodBindTR<Ref<Texture2D>> *this) {
   ...
   *(undefined***)this = &PTR__gen_argument_type_00116e80;
   ...
   operator_delete(this, 0x68);
   return;
}/* MethodBindT<Ref<StyleBox> const&>::~MethodBindT() */void MethodBindT<Ref<StyleBox>const&>::~MethodBindT(MethodBindT<Ref<StyleBox>const&> *this) {
   ...
   *(undefined***)this = &PTR__gen_argument_type_00116ee0;
   ...
   operator_delete(this, 0x68);
   return;
}/* MethodBindTR<Ref<StyleBox>>::~MethodBindTR() */void MethodBindTR<Ref<StyleBox>>::~MethodBindTR(MethodBindTR<Ref<StyleBox>> *this) {
   ...
   *(undefined***)this = &PTR__gen_argument_type_00116f40;
   ...
   operator_delete(this, 0x68);
   return;
}/* CallableCustomMethodPointer<ThemeDB, void, Node*>::get_object() const */undefined8 CallableCustomMethodPointer<ThemeDB,void,Node*>::get_object(CallableCustomMethodPointer<ThemeDB,void,Node*> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
   ...
   uVar2 = 0;
   LAB_001073ad:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return uVar2;
}/* CallableCustomMethodPointer<ThemeContext, void>::get_object() const */undefined8 CallableCustomMethodPointer<ThemeContext,void>::get_object(CallableCustomMethodPointer<ThemeContext,void> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
   ...
   uVar2 = 0;
   LAB_001074ad:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return uVar2;
}/* CallableCustomMethodPointer<ThemeDB, void>::get_object() const */undefined8 CallableCustomMethodPointer<ThemeDB,void>::get_object(CallableCustomMethodPointer<ThemeDB,void> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
   ...
   uVar2 = 0;
   LAB_001075ad:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return uVar2;
   ...
   const [clone .isra.0] */void SortArray<List<ThemeDB::ThemeItemBind,DefaultAllocator>::Element*,List<ThemeDB::ThemeItemBind,DefaultAllocator>::AuxiliaryComparator<ThemeDB::ThemeItemBind::SortByType>,true>::introsort(long param_1, long param_2, Element **param_3, long param_4) {
   int iVar1;
   Element *pEVar2;
   long lVar3;
   int iVar4;
   ...
   if (param_4 == 0) {
      LAB_0010787d:lVar11 = lVar16 + -2 >> 1;
      lVar12 = lVar11 * 2 + 2;
      ...
      do {
         ...
         joined_r0x00107965:if (lVar11 == 0) {
         ...
         while (true) {
            ...
            LAB_00107985:lVar10 = lVar12;
            ppEVar15 = ppEVar9;
            ppEVar7 = ppEVar9;
            if (lVar12 == lVar16) break;
            LAB_00107ac1:*ppEVar7 = pEVar13;
         };
         LAB_0010798b:lVar3 = lVar12 + -1;
   ...
   lVar12 = param_2;
   local_58 = param_4;
   LAB_001076d1:pEVar13 = param_3[lVar12 + -1];
   local_58 = local_58 + -1;
   iVar4 = *(int*)pEVar13;
   ...
   if (iVar8 < iVar1) {
      if (iVar1 < iVar4) {
         LAB_00107850:pEVar13 = param_3[( lVar16 >> 1 ) + param_1];
         iVar4 = iVar1;
         goto LAB_0010770f;
      }
   ...
   do {
      if (iVar8 < iVar4) {
         ...
         LAB_001077b4:if (lVar10 <= param_2) break;
   ...
   goto LAB_001076d1;
   LAB_001079c0:pEVar13 = ppEVar9[lVar16];
   ...
   if (lVar16 < 3) {
      ...
      *ppEVar9 = param_3[lVar12];
      LAB_00107a48:iVar4 = *(int*)pEVar13;
      while (true) {
   ...
   *(undefined8*)in_RDI = 0;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* ThemeDB::_get_class_namev() const */undefined8 *ThemeDB::_get_class_namev(void) {
   int iVar1;
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00107fe3:return &_get_class_namev();
      }
      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00107fe3;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "ThemeDB");
         goto LAB_0010804e;
      }
   }
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "ThemeDB");
   LAB_0010804e:return &_get_class_namev();
}/* ThemeContext::_get_class_namev() const */undefined8 *ThemeContext::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001080d3:return &_get_class_namev();
      }
      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001080d3;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "ThemeContext");
         goto LAB_0010813e;
      }
   }
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "ThemeContext");
   LAB_0010813e:return &_get_class_namev();
   ...
   *(undefined4*)( this + 0x28 ) = param_6;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* ThemeDB::ThemeItemBind::~ThemeItemBind() */void ThemeDB::ThemeItemBind::~ThemeItemBind(ThemeItemBind *this) {
   ...
   return;
}/* ThemeDB::get_class() const */void ThemeDB::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* ThemeContext::get_class() const */void ThemeContext::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
   ...
   return;
}/* Ref<Theme>::unref() */void Ref<Theme>::unref(Ref<Theme> *this) {
   Object *pOVar1;
   char cVar2;
   if (*(long*)this != 0) {
      cVar2 = RefCounted::unreference();
   ...
   *(undefined8*)this = 0;
   return;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<Node*, ThemeContext*, HashMapHasherDefault, HashMapComparatorDefault<Node*>,
   DefaultTypedAllocator<HashMapElement<Node*, ThemeContext*> > >::operator[](Node* const&) */undefined1 * __thiscallHashMap<Node*,ThemeContext*,HashMapHasherDefault,HashMapComparatorDefault<Node*>,DefaultTypedAllocator<HashMapElement<Node*,ThemeContext*>>>::operator [](HashMap<Node*,ThemeContext*,HashMapHasherDefault,HashMapComparatorDefault<Node*>,DefaultTypedAllocator<HashMapElement<Node*,ThemeContext*>>> * this, Node * *param_1) * puVar1 ;undefined8 *puVar2uint uVar3void *pvVar4void *__slong lVar5long lVar6undefined1 auVar7[16]undefined1 auVar8[16]undefined1 auVar9[16]undefined1 auVar10[16]undefined1 auVar11[16]undefined1 auVar12[16]undefined1 auVar13[16]undefined1 auVar14[16]undefined1 auVar15[16]undefined1 auVar16[16]undefined1 auVar17[16]undefined1 auVar18[16]undefined1 auVar19[16]undefined1 auVar20[16]undefined1 auVar21[16]undefined1 auVar22[16]undefined1(*pauVar23)[16];char cVar24ulong uVar25undefined8 uVar26void *__s_00undefined1(*pauVar27)[16];void *pvVar28int iVar29long lVar30long lVar31uint uVar32ulong uVar33Node *pNVar34undefined8 uVar35uint uVar36uint uVar37uint uVar38ulong uVar39undefined1(*pauVar40)[16];long in_FS_OFFSETuint local_98uint local_48uint local_44long local_40pNVar34 = *param_1;local_40 = *(long*)( in_FS_OFFSET + 0x28 );local_48 = 0;cVar24 = _lookup_pos(this, (Node**)pNVar34, &local_48);if (cVar24 == '\0') {
...
}LAB_00109258:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return pauVar27[1] + 8;
}/* WARNING: Subroutine does not return */__stack_chk_fail();}/* Callable create_custom_callable_function_pointer<ThemeDB, Node*>(ThemeDB*, char const*, void
   (ThemeDB::*)(Node*)) */ThemeDB *create_custom_callable_function_pointer<ThemeDB,Node*>(ThemeDB *param_1, char *param_2, _func_void_Node_ptr *param_3) {
   undefined8 uVar1;
   CallableCustom *this;
   undefined8 in_RCX;
   undefined8 in_R8;
   ...
   *(_func_void_Node_ptr**)( this + 0x20 ) = param_3 + 1;
   ...
   if ((float)( iVar44 + 1 ) <= (float)uVar27 * __LC32) {
      ...
      LAB_001099a6:uVar27 = StringName::get_empty_hash();
   } else {
      ...
      *in_RSI = lVar30;
      ...
      LAB_00109845:uVar27 = *(uint*)( lVar30 + 0x20 );
   }
   if (uVar27 == 0) {
      uVar27 = 1;
   }
   ...
   *(int*)( (long)in_RSI + 0x24 ) = iVar44;
   LAB_00109968:*(uint*)( param_1 + 0xc ) = uVar42;
   *(long*)param_1 = lVar36;
   *(int*)( param_1 + 8 ) = iVar44;
   return param_1;
}/* void List<ThemeDB::ThemeItemBind,
   DefaultAllocator>::sort_custom<ThemeDB::ThemeItemBind::SortByType>() */void List<ThemeDB::ThemeItemBind,DefaultAllocator>::sort_custom<ThemeDB::ThemeItemBind::SortByType>(List<ThemeDB::ThemeItemBind,DefaultAllocator> *this) {
   size_t __n;
   int iVar1;
   int iVar2;
   undefined8 *puVar3;
   ...
   if (*(long**)this != (long*)0x0) {
      ppEVar7 = __src;
      for (pEVar13 = (Element*)**(long**)this; pEVar13 != (Element*)0x0; pEVar13 = *(Element**)( pEVar13 + 0x48 )) {
         *ppEVar7 = pEVar13;
         ppEVar7 = ppEVar7 + 1;
      }
   }
   ...
   SortArray<List<ThemeDB::ThemeItemBind,DefaultAllocator>::Element*,List<ThemeDB::ThemeItemBind,DefaultAllocator>::AuxiliaryComparator<ThemeDB::ThemeItemBind::SortByType>,true>::introsort(0, (long)pEVar4, __src, lVar9 * 2);
   if ((long)pEVar4 < 0x11) {
      pEVar13 = (Element*)0x1;
      pEVar8 = *__src;
      do {
         while (true) {
            ...
            LAB_00109ea3:pEVar13 = pEVar13 + 1;
            *ppEVar7 = pEVar6;
            pEVar6 = *__src;
            pEVar8 = pEVar6;
      ...
      LAB_00109cb0:pEVar13 = (Element*)( lVar14 + 1 );
      ppEVar7 = __src + 0x10;
      do {
         pEVar6 = *ppEVar7;
         pEVar10 = ppEVar7[-1];
         ...
         LAB_00109d33:pEVar13 = pEVar13 + 1;
         *ppEVar12 = pEVar6;
         ppEVar7 = ppEVar7 + 1;
      } while ( pEVar4 != pEVar13 );
      pEVar6 = *__src;
   }
   LAB_00109d50:puVar3 = *(undefined8**)this;
   *puVar3 = pEVar6;
   ...
   *(undefined8*)( __src[(long)( pEVar4 + -1 )] + 0x48 ) = 0;
   ...
   (ThemeContext::*)()) */ThemeContext *create_custom_callable_function_pointer<ThemeContext>(ThemeContext *param_1, char *param_2, _func_void *param_3) {
   undefined8 uVar1;
   CallableCustom *this;
   undefined8 in_RCX;
   undefined8 in_R8;
   ...
   *(undefined8*)this = 0;
   ...
   return;
}/* WARNING: Removing unreachable block (ram,0x0010a250) *//* String vformat<StringName, StringName>(String const&, StringName const, StringName const) */undefined8 *vformat<StringName,StringName>(undefined8 *param_1, bool *param_2, StringName *param_3, StringName *param_4) {
   Variant *pVVar1;
   Variant *pVVar2;
   int iVar3;
   long in_FS_OFFSET;
   ...
   *param_1 = local_d0[0];
   ...
   return param_1;
}/* MethodBindTR<Ref<StyleBox>>::_gen_argument_type_info(int) const */undefined4 *MethodBindTR<Ref<StyleBox>>::_gen_argument_type_info(int param_1) {
   ...
   *(undefined1(*) [16])( puVar1 + 2 ) = (undefined1[16])0x0;
   ...
   LAB_0010a475:CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBindTR<Ref<Texture2D>>::_gen_argument_type_info(int) const */undefined4 *MethodBindTR<Ref<Texture2D>>::_gen_argument_type_info(int param_1) {
   undefined4 in_register_0000003c;
   undefined4 *puVar1;
   long in_FS_OFFSET;
   undefined8 local_60;
   ...
   *(undefined1(*) [16])( puVar1 + 2 ) = (undefined1[16])0x0;
   ...
   LAB_0010a5e5:CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
   if (( StringName::configured != '\0' ) && ( local_50 != 0 )) {
      StringName::unref();
   }
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBindTR<Ref<Font>>::_gen_argument_type_info(int) const */undefined4 *MethodBindTR<Ref<Font>>::_gen_argument_type_info(int param_1) {
   undefined4 in_register_0000003c;
   undefined4 *puVar1;
   long in_FS_OFFSET;
   undefined8 local_60;
   ...
   *(undefined1(*) [16])( puVar1 + 2 ) = (undefined1[16])0x0;
   ...
   LAB_0010a755:CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
   if (( StringName::configured != '\0' ) && ( local_50 != 0 )) {
      StringName::unref();
   }
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBindTR<Ref<Theme>>::_gen_argument_type_info(int) const */undefined4 *MethodBindTR<Ref<Theme>>::_gen_argument_type_info(int param_1) {
   undefined4 in_register_0000003c;
   undefined4 *puVar1;
   long in_FS_OFFSET;
   undefined8 local_60;
   ...
   *(undefined1(*) [16])( puVar1 + 2 ) = (undefined1[16])0x0;
   ...
   LAB_0010a8c5:CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
   if (( StringName::configured != '\0' ) && ( local_50 != 0 )) {
      StringName::unref();
   }
   ...
   Callable::CallError&) const */void CallableCustomMethodPointer<ThemeContext,void>::call(CallableCustomMethodPointer<ThemeContext,void> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long lVar1;
   long lVar2;
   uint uVar3;
   ulong *puVar4;
   ...
   if (uVar3 < (uint)ObjectDB::slot_max) {
      ...
      *(undefined4*)( param_4 + 8 ) = 0;
      ...
      _err_print_error(&_LC61, "./core/object/callable_method_pointer.h", 0x67, "Parameter \"ObjectDB::get_instance(ObjectID(data.object_id))\" is null.", (String*)&local_48, 0, 0);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_48);
   ...
   LAB_0010ac21:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* CallableCustomMethodPointer<ThemeDB, void>::call(Variant const**, int, Variant&,
   Callable::CallError&) const */void CallableCustomMethodPointer<ThemeDB,void>::call(CallableCustomMethodPointer<ThemeDB,void> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long lVar1;
   long lVar2;
   uint uVar3;
   ulong *puVar4;
   ...
   LAB_0010ae41:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* CallableCustomMethodPointer<ThemeDB, void, Node*>::call(Variant const**, int, Variant&,
   Callable::CallError&) const */void CallableCustomMethodPointer<ThemeDB,void,Node*>::call(CallableCustomMethodPointer<ThemeDB,void,Node*> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long lVar1;
   long lVar2;
   Variant *this_00;
   undefined8 uVar3;
   ...
   if (uVar8 < (uint)ObjectDB::slot_max) {
            ...
            *(undefined4*)param_4 = 0;
            ...
            if (cVar4 == '\0') {
               ...
               *(undefined8*)( param_4 + 4 ) = uVar3;
               ...
               if (( ( pOVar6 == (Object*)0x0 ) || ( lVar7 = __dynamic_cast(pOVar6, &Object::typeinfo, &Node::typeinfo, 0) ),lVar7 == 0 )) goto LAB_0010af90;
            }
      ...
      _err_print_error("get_instance", "./core/object/object.h", 0x418, "Condition \"slot >= slot_max\" is true. Returning: nullptr", 0, 0);
      LAB_0010b085:local_50 = 0;
      String::parse_latin1((String*)&local_50, "\', can\'t call method.");
      uitos((ulong)local_60);
      operator+((char *)
      local_58,(String*)"Invalid Object id \'";
      String::operator +(local_48, (String*)local_58);
      _err_print_error(&_LC61, "./core/object/callable_method_pointer.h", 0x67, "Parameter \"ObjectDB::get_instance(ObjectID(data.object_id))\" is null.", local_48, 0, 0);
      CowData<char32_t>::_unref((CowData<char32_t>*)local_48);
      CowData<char32_t>::_unref(local_58);
      CowData<char32_t>::_unref(local_60);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_50);
   ...
   LAB_0010b136:/* WARNING: Subroutine does not return */__stack_chk_fail();
   ...
   *(undefined1(*) [16])( puVar1 + 2 ) = (undefined1[16])0x0;
   ...
   StringName::operator =((StringName*)( puVar1 + 4 ), (StringName*)&local_50);
   LAB_0010b3e5:CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
   if (( StringName::configured != '\0' ) && ( local_50 != 0 )) {
      StringName::unref();
   }
   ...
   *(undefined1(*) [16])( puVar1 + 2 ) = (undefined1[16])0x0;
   ...
   StringName::operator =((StringName*)( puVar1 + 4 ), (StringName*)&local_50);
   LAB_0010b545:CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
   if (( StringName::configured != '\0' ) && ( local_50 != 0 )) {
      StringName::unref();
   }
   ...
   *(undefined1(*) [16])( puVar2 + 2 ) = (undefined1[16])0x0;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBindT<Ref<StyleBox> const&>::_gen_argument_type_info(int) const */undefined4 *MethodBindT<Ref<StyleBox>const&>::_gen_argument_type_info(int param_1) {
   long lVar1;
   int in_EDX;
   undefined4 in_register_0000003c;
   undefined4 *puVar2;
   ...
   *(undefined1(*) [16])( puVar2 + 2 ) = (undefined1[16])0x0;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* ThemeContext::is_class(String const&) const */undefined8 ThemeContext::is_class(ThemeContext *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long lVar4;
   ...
   for (lVar2 = *(long*)( this + 8 ); lVar2 != 0; lVar2 = *(long*)( lVar2 + 8 )) {
      ...
      LAB_0010bcdf:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
   ...
   if (cVar6 == '\0') {
      for (lVar2 = *(long*)( this + 8 ); lVar2 != 0; lVar2 = *(long*)( lVar2 + 8 )) {
         ...
         LAB_0010be3f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      ...
      LAB_0010bd93:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* ThemeDB::is_class(String const&) const */undefined8 ThemeDB::is_class(ThemeDB *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long lVar4;
   ...
   for (lVar2 = *(long*)( this + 8 ); lVar2 != 0; lVar2 = *(long*)( lVar2 + 8 )) {
      ...
      LAB_0010bf2f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar6 == '\0') {
      for (lVar2 = *(long*)( this + 8 ); lVar2 != 0; lVar2 = *(long*)( lVar2 + 8 )) {
         ...
         LAB_0010c08f:cVar6 = String::operator ==(param_1, (String*)&local_60);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
         if (cVar6 != '\0') goto LAB_0010bfe3;
      }
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      ...
      LAB_0010bfe3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* ThemeContext::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void ThemeContext::_get_property_listv(List *param_1, bool param_2) {
   ...
   LAB_0010c26c:List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)CONCAT71(in_register_00000031, param_2), (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
   ...
   return;
}/* ThemeDB::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void ThemeDB::_get_property_listv(List *param_1, bool param_2) {
   undefined7 in_register_00000031;
   long in_FS_OFFSET;
   long local_98;
   long local_90;
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_0010c4bc:List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)CONCAT71(in_register_00000031, param_2), (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
   }
   ...
   Memory::free_static(plVar4, false);
   return;
}/* ThemeContext::_bind_methods() [clone .cold] */void ThemeContext::_bind_methods(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   ...
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}/* ThemeDB::_bind_methods() [clone .cold] */void ThemeDB::_bind_methods(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
   ...
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}/* ThemeContext::_initialize_classv() */void ThemeContext::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_60;
   undefined8 local_58;
   long local_50;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* KeyValue<StringName, List<ThemeDB::ThemeItemBind, DefaultAllocator> >::~KeyValue() */void KeyValue<StringName,List<ThemeDB::ThemeItemBind,DefaultAllocator>>::~KeyValue(KeyValue<StringName,List<ThemeDB::ThemeItemBind,DefaultAllocator>> *this) {
   void *pvVar1;
   undefined8 *puVar2;
      ...
      do {
         ...
         if (puVar2 == *(undefined8**)( (long)pvVar1 + 0x58 )) {
            *puVar2 = *(undefined8*)( (long)pvVar1 + 0x48 );
            ...
            LAB_0010c905:Memory::free_static(pvVar1, false);
   ...
   LAB_0010c92d:if (( StringName::configured != '\0' ) && ( *(long*)this != 0 )) {
      StringName::unref();
      return;
   }
   return;
}/* List<ThemeDB::ThemeItemBind, DefaultAllocator>::~List() */void List<ThemeDB::ThemeItemBind,DefaultAllocator>::~List(List<ThemeDB::ThemeItemBind,DefaultAllocator> *this) {
   void *pvVar1;
   undefined8 *puVar2;
   ...
   do {
      ...
      if (puVar2 == *(undefined8**)( (long)pvVar1 + 0x58 )) {
         *puVar2 = *(undefined8*)( (long)pvVar1 + 0x48 );
         ...
         LAB_0010ca94:Memory::free_static(pvVar1, false);
         *(int*)( puVar2 + 2 ) = *(int*)( puVar2 + 2 ) + -1;
      } else {
         _err_print_error("erase", "./core/templates/list.h", 0xe7, "Condition \"p_I->data != this\" is true. Returning: false", 0, 0);
      }
   ...
   Memory::free_static(puVar2, false);
   return;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<StringName, List<ThemeDB::ThemeItemBind, DefaultAllocator>, HashMapHasherDefault,
   HashMapComparatorDefault<StringName>, DefaultTypedAllocator<HashMapElement<StringName,
   List<ThemeDB::ThemeItemBind, DefaultAllocator> > > >::operator[](StringName const&) */List<ThemeDB::ThemeItemBind,DefaultAllocator> * __thiscallHashMap<StringName,List<ThemeDB::ThemeItemBind,DefaultAllocator>,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,List<ThemeDB::ThemeItemBind,DefaultAllocator>>>>::operator [](HashMap<StringName,List<ThemeDB::ThemeItemBind,DefaultAllocator>,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,List<ThemeDB::ThemeItemBind,DefaultAllocator>>>> * this, StringName * param_1) * puVar1 ;undefined8 *puVar2void *pvVar3void *__sThemeItemBind *pTVar4undefined1 auVar5[16]undefined1 auVar6[16]undefined1 auVar7[16]undefined1 auVar8[16]undefined1 auVar9[16]undefined1 auVar10[16]undefined1 auVar11[16]undefined1 auVar12[16]undefined1 auVar13[16]undefined1 auVar14[16]undefined1 auVar15[16]undefined1 auVar16[16]undefined1 auVar17[16]undefined1 auVar18[16]undefined1 auVar19[16]undefined1 auVar20[16]undefined1 auVar21[16]undefined1 auVar22[16]undefined1 auVar23[16]undefined1 auVar24[16]undefined1 auVar25[16]undefined1 auVar26[16]undefined1 auVar27[16]undefined1 auVar28[16]undefined1 auVar29[16]undefined1 auVar30[16]undefined1 auVar31[16]undefined1 auVar32[16]undefined1 auVar33[16]undefined1 auVar34[16]undefined1 auVar35[16]undefined1 auVar36[16]uint uVar37uint uVar38uint uVar39ulong uVar40undefined8 uVar41void *__s_00undefined8 *puVar42long lVar43void *pvVar44ulong uVar45int iVar46long lVar47long lVar48long lVar49ulong uVar50List<ThemeDB::ThemeItemBind,DefaultAllocator> *this_00undefined8 uVar51uint uVar52uint uVar53uint uVar54undefined8 *puVar55long in_FS_OFFSETundefined8 local_70undefined1 local_68[16]StringName local_58[8]undefined8 *local_50long local_40lVar43 = *(long*)( this + 8 );local_40 = *(long*)( in_FS_OFFSET + 0x28 );uVar38 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );uVar40 = CONCAT44(0, uVar38);if (lVar43 == 0) {
   LAB_0010d280:local_70 = 0;
   uVar45 = uVar40 * 4;
   uVar50 = uVar40 * 8;
   ...
   *(void**)( this + 8 ) = pvVar44;
   if ((int)uVar40 != 0) {
      ...
      LAB_0010cc91:iVar46 = *(int*)( this + 0x2c );
      if (iVar46 != 0) {
         LAB_0010cc9d:uVar38 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
         ...
         if (uVar52 != 0) {
            do {
               if (( uVar39 == uVar52 ) && ( lVar47 = *(long*)( this + 8 ) * (long*)( *(long*)( lVar47 + lVar48 * 8 ) + 0x10 ) == *(long*)param_1 )) {
   ...
   LAB_0010ce3a:uVar38 = *(uint*)( this + 0x28 );
   if (uVar38 == 0x1c) {
   ...
   *(void**)( this + 8 ) = __s_00;
      ...
      if (uVar52 != 0) {
         ...
         do {
            if (( uVar39 == uVar52 ) && ( *(long*)( *(long*)( lVar43 + lVar47 * 8 ) + 0x10 ) == *(long*)param_1 )) {
               this_00 = (List<ThemeDB::ThemeItemBind,DefaultAllocator>*)( *(long*)( lVar43 + (ulong)uVar53 * 8 ) + 0x18 );
               goto LAB_0010cc3c;
            }
            uVar54 = uVar54 + 1;
            auVar6._8_8_ = 0;
   ...
   local_70 = 0;
   iVar46 = 0;
   LAB_0010ce14:if ((float)uVar40 * __LC32 < (float)( iVar46 + 1 )) goto LAB_0010ce3a;
}local_68 = (undefined1[16])0x0;StringName::StringName(local_58, param_1);local_50 = (undefined8*)0x0;puVar42 = (undefined8*)operator_new(0x20, "");*puVar42 = local_68._0_8_;puVar42[1] = local_68._8_8_;StringName::StringName((StringName*)( puVar42 + 2 ), local_58);puVar42[3] = 0;this_00 = (List<ThemeDB::ThemeItemBind,DefaultAllocator>*)( puVar42 + 3 );if (local_50 != (undefined8*)0x0) {
   for (pTVar4 = (ThemeItemBind*)*local_50; pTVar4 != (ThemeItemBind*)0x0; pTVar4 = *(ThemeItemBind**)( pTVar4 + 0x48 )) {
      List<ThemeDB::ThemeItemBind,DefaultAllocator>::push_back(this_00, pTVar4);
   }
}KeyValue<StringName,List<ThemeDB::ThemeItemBind,DefaultAllocator>>::~KeyValue((KeyValue<StringName,List<ThemeDB::ThemeItemBind,DefaultAllocator>>*)local_58);puVar55 = *(undefined8**)( this + 0x20 );if (puVar55 == (undefined8*)0x0) {
   lVar43 = *(long*)param_1;
   *(undefined8**)( this + 0x18 ) = puVar42;
   *(undefined8**)( this + 0x20 ) = puVar42;
   if (lVar43 == 0) goto LAB_0010d235;
   LAB_0010d0fc:uVar38 = *(uint*)( lVar43 + 0x20 );
} else {
   *puVar55 = puVar42;
   puVar42[1] = puVar55;
   lVar43 = *(long*)param_1;
   *(undefined8**)( this + 0x20 ) = puVar42;
   ...
   LAB_0010d235:uVar38 = StringName::get_empty_hash();
}if (uVar38 == 0) {
   uVar38 = 1;
}uVar40 = (ulong)uVar38;lVar43 = *(long*)( this + 0x10 );uVar53 = 0;lVar48 = *(long*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( this + 0x28 ) * 8 );uVar39 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );uVar45 = CONCAT44(0, uVar39);auVar17._8_8_ = 0;auVar17._0_8_ = uVar40 * lVar48;auVar33._8_8_ = 0;auVar33._0_8_ = uVar45;lVar49 = SUB168(auVar17 * auVar33, 8);lVar47 = *(long*)( this + 8 );puVar1 = (uint*)( lVar43 + lVar49 * 4 );iVar46 = SUB164(auVar17 * auVar33, 8);uVar52 = *puVar1;while (uVar52 != 0) {
   auVar18._8_8_ = 0;
   ...
   puVar42 = puVar55;
   uVar52 = *puVar1;
};*(undefined8**)( lVar47 + lVar49 * 8 ) = puVar42;*puVar1 = uVar38;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_0010d1e6:List<ThemeDB::ThemeItemBind,DefaultAllocator>::~List((List<ThemeDB::ThemeItemBind,DefaultAllocator>*)&local_70);LAB_0010cc3c:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return this_00;
   ...
   LAB_0010cd75:pTVar4 = (ThemeItemBind*)*puVar42;
   if (pTVar4 == (ThemeItemBind*)0x0) {
      lVar47 = *(long*)( this + 8 );
      goto LAB_0010cdf7;
   }
};Memory::free_static(puVar42, false);*(undefined8*)( lVar43 + 0x18 ) = 0;lVar47 = *(long*)( this + 8 );LAB_0010cdf7:this_00 = (List<ThemeDB::ThemeItemBind,DefaultAllocator>*)( *(long*)( lVar47 + (ulong)uVar53 * 8 ) + 0x18 );goto LAB_0010d1e6;}/* MethodBind* create_method_bind<ThemeDB, Ref<Theme>>(Ref<Theme> (ThemeDB::*)()) */MethodBind *create_method_bind<ThemeDB,Ref<Theme>>(_func_Ref *param_1) {
   MethodBind *this;
   undefined8 in_RSI;
   long in_FS_OFFSET;
   undefined8 local_40;
   ...
   *(undefined4*)( this + 0x34 ) = 0;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBind* create_method_bind<ThemeDB, float>(void (ThemeDB::*)(float)) */MethodBind *create_method_bind<ThemeDB,float>(_func_void_float *param_1) {
   MethodBind *this;
   undefined8 in_RSI;
   long in_FS_OFFSET;
   undefined8 local_40;
   ...
   *(undefined4*)( this + 0x34 ) = 1;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBind* create_method_bind<ThemeDB, float>(float (ThemeDB::*)()) */MethodBind *create_method_bind<ThemeDB,float>(_func_float *param_1) {
   MethodBind *this;
   undefined8 in_RSI;
   long in_FS_OFFSET;
   undefined8 local_40;
   ...
   *(undefined4*)( this + 0x34 ) = 0;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBind* create_method_bind<ThemeDB, Ref<Font> const&>(void (ThemeDB::*)(Ref<Font> const&)) */MethodBind *create_method_bind<ThemeDB,Ref<Font>const&>(_func_void_Ref_ptr *param_1) {
   MethodBind *this;
   undefined8 in_RSI;
   long in_FS_OFFSET;
   undefined8 local_40;
   ...
   *(undefined4*)( this + 0x34 ) = 1;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBind* create_method_bind<ThemeDB, Ref<Font>>(Ref<Font> (ThemeDB::*)()) */MethodBind *create_method_bind<ThemeDB,Ref<Font>>(_func_Ref *param_1) {
   MethodBind *this;
   undefined8 in_RSI;
   long in_FS_OFFSET;
   undefined8 local_40;
   ...
   *(undefined4*)( this + 0x34 ) = 0;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBind* create_method_bind<ThemeDB, int>(void (ThemeDB::*)(int)) */MethodBind *create_method_bind<ThemeDB,int>(_func_void_int *param_1) {
   MethodBind *this;
   undefined8 in_RSI;
   long in_FS_OFFSET;
   undefined8 local_40;
   ...
   *(undefined4*)( this + 0x34 ) = 1;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBind* create_method_bind<ThemeDB, int>(int (ThemeDB::*)()) */MethodBind *create_method_bind<ThemeDB,int>(_func_int *param_1) {
   MethodBind *this;
   undefined8 in_RSI;
   long in_FS_OFFSET;
   undefined8 local_40;
   ...
   *(undefined4*)( this + 0x34 ) = 0;
   ...
   const&)) */MethodBind *create_method_bind<ThemeDB,Ref<Texture2D>const&>(_func_void_Ref_ptr *param_1) {
   MethodBind *this;
   undefined8 in_RSI;
   long in_FS_OFFSET;
   undefined8 local_40;
   ...
   *(undefined4*)( this + 0x34 ) = 1;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBind* create_method_bind<ThemeDB, Ref<Texture2D>>(Ref<Texture2D> (ThemeDB::*)()) */MethodBind *create_method_bind<ThemeDB,Ref<Texture2D>>(_func_Ref *param_1) {
   MethodBind *this;
   undefined8 in_RSI;
   long in_FS_OFFSET;
   undefined8 local_40;
   ...
   *(undefined4*)( this + 0x34 ) = 0;
   ...
   const&)) */MethodBind *create_method_bind<ThemeDB,Ref<StyleBox>const&>(_func_void_Ref_ptr *param_1) {
   MethodBind *this;
   undefined8 in_RSI;
   long in_FS_OFFSET;
   undefined8 local_40;
   ...
   *(undefined4*)( this + 0x34 ) = 1;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBind* create_method_bind<ThemeDB, Ref<StyleBox>>(Ref<StyleBox> (ThemeDB::*)()) */MethodBind *create_method_bind<ThemeDB,Ref<StyleBox>>(_func_Ref *param_1) {
   MethodBind *this;
   undefined8 in_RSI;
   long in_FS_OFFSET;
   undefined8 local_40;
   ...
   *(undefined8*)this = 0;
   return;
}/* ThemeDB::_initialize_classv() */void ThemeDB::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_60;
   undefined8 local_58;
   long local_50;
   ...
   if (param_1 * 8 == 0) {
      LAB_0010e470:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   uVar6 = param_1 * 8 - 1;
   uVar6 = uVar6 >> 1 | uVar6;
   ...
   if (lVar8 == lVar5) {
      LAB_0010e3eb:puVar7 = *(undefined8**)this;
      if (puVar7 == (undefined8*)0x0) {
         LAB_0010e317:/* WARNING: Does not return */pcVar1 = (code*)invalidInstructionException();
         ( *pcVar1 )();
      }
      lVar4 = puVar7[-1];
   ...
   *(undefined8*)this = 0;
   ...
   Memory::free_static(plVar1 + -2, false);
   return;
}/* ThemeContext::~ThemeContext() */void ThemeContext::~ThemeContext(ThemeContext *this) {
   ...
   *(undefined***)this = &PTR__initialize_classv_00116710;
   ...
   HashMapComparatorDefault<StringName>, DefaultTypedAllocator<HashMapElement<StringName,
   ThemeDB::ThemeItemBind> > >::_resize_and_rehash(unsigned int) */void HashMap<StringName,ThemeDB::ThemeItemBind,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ThemeDB::ThemeItemBind>>>::_resize_and_rehash(HashMap<StringName,ThemeDB::ThemeItemBind,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ThemeDB::ThemeItemBind>>> *this, uint param_1) {
   uint *puVar1;
   undefined8 *puVar2;
   uint uVar3;
   uint uVar4;
   ...
   *(void**)( this + 8 ) = __s_00;
   ...
   return;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<StringName, ThemeDB::ThemeItemBind, HashMapHasherDefault,
   HashMapComparatorDefault<StringName>, DefaultTypedAllocator<HashMapElement<StringName,
   ThemeDB::ThemeItemBind> > >::operator[](StringName const&) */undefined8 * __thiscallHashMap<StringName,ThemeDB::ThemeItemBind,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ThemeDB::ThemeItemBind>>>::operator [](HashMap<StringName,ThemeDB::ThemeItemBind,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ThemeDB::ThemeItemBind>>> * this, StringName * param_1) * puVar1 ;undefined8 *puVar2void *__sundefined1 auVar3[16]undefined1 auVar4[16]undefined1 auVar5[16]undefined1 auVar6[16]undefined1 auVar7[16]undefined1 auVar8[16]undefined1 auVar9[16]undefined1 auVar10[16]undefined1 auVar11[16]undefined1 auVar12[16]undefined1 auVar13[16]undefined1 auVar14[16]undefined1 auVar15[16]undefined1 auVar16[16]undefined1 auVar17[16]undefined1 auVar18[16]undefined1 auVar19[16]undefined1 auVar20[16]undefined1 auVar21[16]undefined1 auVar22[16]undefined1 auVar23[16]undefined1 auVar24[16]undefined1 auVar25[16]undefined1 auVar26[16]undefined8 *puVar27uint uVar28uint uVar29uint uVar30long lVar31undefined8 uVar32void *__s_00int iVar33long lVar34long lVar35long lVar36undefined8 *puVar37uint uVar38ulong uVar39uint uVar40uint uVar41ulong uVar42ulong uVar43undefined8 *puVar44long in_FS_OFFSETuint local_118long lStack_f0long local_e8long local_e0undefined8 local_d8undefined1 local_d0[16]code *local_c0undefined8 uStack_b8undefined1 local_a8[16]code *local_98undefined8 local_90long local_88long local_80long local_78undefined1 local_70undefined1 local_68[16]code *local_58undefined8 uStack_50long local_40lVar31 = *(long*)( this + 8 );local_40 = *(long*)( in_FS_OFFSET + 0x28 );uVar29 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );uVar42 = CONCAT44(0, uVar29);if (lVar31 == 0) {
   LAB_0010e9a0:local_d8 = 0;
   ...
   *(void**)( this + 8 ) = __s_00;
   ...
   LAB_0010ebc9:if (*(int*)( this + 0x28 ) == 0x1c) {
   ...
   if (*(int*)( this + 0x2c ) != 0) {
      ...
      if (uVar30 != 0) {
         uVar40 = 0;
         do {
            if (( uVar28 == uVar30 ) && ( *(long*)( *(long*)( lVar31 + lVar34 * 8 ) + 0x10 ) == *(long*)param_1 )) {
         ...
         } while ( ( uVar30 != 0 ) && ( auVar5._8_8_ = 0 ),auVar5._0_8_ = (ulong)uVar30 * lVar35,auVar17._8_8_ = 0,auVar17._0_8_ = uVar42,auVar6._8_8_ = 0,auVar6._0_8_ = ( ulong )(( uVar38 + uVar29 ) - SUB164(auVar5 * auVar17, 8)) * lVar35,auVar18._8_8_ = 0,auVar18._0_8_ = uVar42,uVar40 <= SUB164(auVar6 * auVar18, 8) );
      }
      goto LAB_0010e9a0;
   }
   local_d8 = 0;
   ...
   local_e8 = 0;
   local_d0 = (undefined1[16])0x0;
   LAB_0010e9f2:iVar33 = *(int*)( this + 0x2c );
   if (iVar33 != 0) {
      LAB_0010e9fe:uVar28 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
      ...
      if (uVar38 != 0) {
         do {
            if (( uVar30 == uVar38 ) && ( *(long*)( *(long*)( *(long*)( this + 8 ) + lVar35 * 8 ) + 0x10 ) == *(long*)param_1 )) {
         ...
         } while ( ( uVar38 != 0 ) && ( auVar9._8_8_ = 0 ),auVar9._0_8_ = (ulong)uVar38 * lVar31,auVar21._8_8_ = 0,auVar21._0_8_ = uVar42,auVar10._8_8_ = 0,auVar10._0_8_ = ( ulong )(( uVar28 + uVar40 ) - SUB164(auVar9 * auVar21, 8)) * lVar31,auVar22._8_8_ = 0,auVar22._0_8_ = uVar42,uVar41 <= SUB164(auVar10 * auVar22, 8) );
      }
      iVar33 = *(int*)( this + 0x2c );
   }
   uVar43 = (ulong)uVar29;
   LAB_0010eba7:if ((float)uVar43 * __LC32 < (float)( iVar33 + 1 )) goto LAB_0010ebc9;
}local_a8 = (undefined1[16])0x0;StringName::StringName((StringName*)&local_98, param_1);local_90 = (ulong)local_90._4_4_ << 0x20;StringName::StringName((StringName*)&local_88, (StringName*)&lStack_f0);StringName::StringName((StringName*)&local_80, (StringName*)&local_e8);StringName::StringName((StringName*)&local_78, (StringName*)&local_e0);local_58 = (code*)0x0;uStack_50 = 0;local_70 = (undefined1)local_d8;local_68 = (undefined1[16])0x0;if (local_c0 != (code*)0x0) {
   ( *local_c0 )(local_68, local_d0, 2);
   local_58 = local_c0;
   uStack_50 = uStack_b8;
}puVar37 = (undefined8*)operator_new(0x60, "");*puVar37 = local_a8._0_8_;puVar37[1] = local_a8._8_8_;StringName::StringName((StringName*)( puVar37 + 2 ), (StringName*)&local_98);*(undefined4*)( puVar37 + 3 ) = (undefined4)local_90;StringName::StringName((StringName*)( puVar37 + 4 ), (StringName*)&local_88);StringName::StringName((StringName*)( puVar37 + 5 ), (StringName*)&local_80);StringName::StringName((StringName*)( puVar37 + 6 ), (StringName*)&local_78);puVar37[10] = 0;*(undefined1(*) [16])( puVar37 + 8 ) = (undefined1[16])0x0;*(undefined1*)( puVar37 + 7 ) = local_70;puVar37[0xb] = 0;if (local_58 != (code*)0x0) {
...
}if (( ( ( StringName::configured != '\0' ) && ( ( local_78 == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) ) ) && ( ( local_80 == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) ) ) && ( ( ( local_88 == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) && ( local_98 != (code*)0x0 ) ) )) {
   StringName::unref();
   ...
   *(undefined8**)( this + 0x20 ) = puVar37;
   ...
   LAB_0010ee13:uVar29 = *(uint*)( lVar31 + 0x20 );
} else {
   **(undefined8**)( this + 0x20 ) = puVar37;
   ...
   *(undefined8**)( this + 0x20 ) = puVar37;
   ...
   LAB_0010f004:uVar29 = StringName::get_empty_hash();
}lVar31 = *(long*)( this + 0x10 );if (uVar29 == 0) {
   uVar29 = 1;
}uVar42 = (ulong)uVar29;uVar38 = 0;lVar35 = *(long*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( this + 0x28 ) * 8 );uVar28 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );uVar39 = CONCAT44(0, uVar28);auVar11._8_8_ = 0;auVar11._0_8_ = uVar42 * lVar35;auVar23._8_8_ = 0;auVar23._0_8_ = uVar39;lVar36 = SUB168(auVar11 * auVar23, 8);lVar34 = *(long*)( this + 8 );puVar1 = (uint*)( lVar31 + lVar36 * 4 );iVar33 = SUB164(auVar11 * auVar23, 8);uVar30 = *puVar1;puVar27 = puVar37;while (uVar30 != 0) {
   auVar12._8_8_ = 0;
   ...
   puVar27 = puVar44;
   uVar30 = *puVar1;
};*(undefined8**)( lVar34 + lVar36 * 8 ) = puVar27;*puVar1 = uVar29;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_0010eeff:puVar37 = puVar37 + 3;if (local_c0 != (code*)0x0) {
   ( *local_c0 )(local_d0, local_d0, 3);
}if (( ( StringName::configured != '\0' ) && ( ( local_e0 == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) ) ) && ( ( ( local_e8 == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) && ( lStack_f0 != 0 ) ) )) {
   StringName::unref();
}LAB_0010e96b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return puVar37;
}/* WARNING: Subroutine does not return */__stack_chk_fail();}/* CowData<Ref<Theme> >::_realloc(long) */undefined8 CowData<Ref<Theme>>::_realloc(CowData<Ref<Theme>> *this, long param_1) {
   undefined8 *puVar1;
   puVar1 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), param_1 + 0x10, false);
   if (puVar1 != (undefined8*)0x0) {
      *puVar1 = 1;
   ...
   if (param_1 * 8 == 0) {
      LAB_0010f450:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   uVar9 = param_1 * 8 - 1;
   uVar9 = uVar9 >> 1 | uVar9;
   ...
   if (lVar11 == lVar8) {
      LAB_0010f3cb:puVar10 = *(undefined8**)this;
      if (puVar10 == (undefined8*)0x0) {
         LAB_0010f2c0:/* WARNING: Does not return */pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
      }
      lVar7 = puVar10[-1];
   ...
   LAB_0010f3ab:puVar10[-1] = param_1;
   return 0;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<StringName, ThemeDB::ThemeItemBind, HashMapHasherDefault,
   HashMapComparatorDefault<StringName>, DefaultTypedAllocator<HashMapElement<StringName,
   ThemeDB::ThemeItemBind> > >::insert(StringName const&, ThemeDB::ThemeItemBind const&, bool) */StringName *
...
::insert(StringName *param_1,ThemeItemBind *param_2,bool param_3){
   ...
   if (*(long*)( param_2 + 8 ) == 0) {
      ...
      *(void**)( param_2 + 8 ) = __s_00;
      ...
      LAB_0010f6ca:if (*(int*)( param_2 + 0x28 ) == 0x1c) {
         puVar26 = (undefined8*)0x0;
         _err_print_error("_insert", "./core/templates/hash_map.h", 0xdd, "Condition \"capacity_index + 1 == HASH_TABLE_SIZE_MAX\" is true. Returning: nullptr", "Hash table maximum capacity reached, aborting insertion.", 0, 0);
         goto LAB_0010f9d6;
      }
      _resize_and_rehash((HashMap<StringName,ThemeDB::ThemeItemBind,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ThemeDB::ThemeItemBind>>>*)param_2, *(int*)( param_2 + 0x28 ) + 1);
   } else {
      LAB_0010f506:iVar30 = *(int*)( param_2 + 0x2c );
      if (iVar30 != 0) {
         LAB_0010f512:uVar3 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( param_2 + 0x28 ) * 4 );
         ...
         if (uVar34 != 0) {
            do {
               if (( uVar24 == uVar34 ) && ( *(long*)( *(long*)( *(long*)( param_2 + 8 ) + lVar32 * 8 ) + 0x10 ) == *(long*)pSVar31 )) {
                  lVar27 = *(long*)( *(long*)( param_2 + 8 ) + (ulong)uVar29 * 8 );
                  *(undefined4*)( lVar27 + 0x18 ) = *in_RCX;
                  for (int i = 0; i < 3; i++) {
                     StringName::operator =((StringName*)( lVar27 + ( 8*i + 32 ) ), (StringName*)( in_RCX + ( 2*i + 2 ) ));
                  }
                  uVar28 = 0;
            ...
            } while ( ( uVar34 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = (ulong)uVar34 * lVar27,auVar15._8_8_ = 0,auVar15._0_8_ = uVar37,auVar8._8_8_ = 0,auVar8._0_8_ = ( ulong )(( uVar3 + uVar29 ) - SUB164(auVar7 * auVar15, 8)) * lVar27,auVar16._8_8_ = 0,auVar16._0_8_ = uVar37,uVar36 <= SUB164(auVar8 * auVar16, 8) );
         }
         iVar30 = *(int*)( param_2 + 0x2c );
      }
      LAB_0010f6a8:if ((float)uVar23 * __LC32 < (float)( iVar30 + 1 )) goto LAB_0010f6ca;
   }
   local_a8 = (undefined1[16])0x0;
   ...
   *(undefined1*)( puVar26 + 7 ) = local_70;
   ...
   if (*(undefined8**)( param_2 + 0x20 ) == (undefined8*)0x0) {
      ...
      *(undefined8**)( param_2 + 0x20 ) = puVar26;
      LAB_0010f8d9:lVar27 = *(long*)pSVar31;
      if (lVar27 != 0) goto LAB_0010f8e5;
      LAB_0010fa2f:uVar23 = StringName::get_empty_hash();
   } else {
      if (in_R8B == '\0') {
         **(undefined8**)( param_2 + 0x20 ) = puVar26;
      ...
      *(undefined8**)( param_2 + 0x18 ) = puVar26;
      ...
      LAB_0010f8e5:uVar23 = *(uint*)( lVar27 + 0x20 );
   }
   ...
   *(int*)( param_2 + 0x2c ) = *(int*)( param_2 + 0x2c ) + 1;
   LAB_0010f9d6:*(undefined8**)param_1 = puVar26;
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<StringName, HashMap<StringName, ThemeDB::ThemeItemBind, HashMapHasherDefault,
   HashMapComparatorDefault<StringName>, DefaultTypedAllocator<HashMapElement<StringName,
   ...
   >::operator[](StringName const&) */undefined8 * __thiscallHashMap<StringName,HashMap<StringName,ThemeDB::ThemeItemBind,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ThemeDB::ThemeItemBind>>>,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,HashMap<StringName,ThemeDB::ThemeItemBind,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ThemeDB::ThemeItemBind>>>>>>::operator [](HashMap<StringName,HashMap<StringName,ThemeDB::ThemeItemBind,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ThemeDB::ThemeItemBind>>>,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,HashMap<StringName,ThemeDB::ThemeItemBind,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ThemeDB::ThemeItemBind>>>>>> * this, StringName * param_1) * puVar1 ;undefined8 *puVar2void *pvVar3void *__sundefined1 auVar4[16]undefined1 auVar5[16]undefined1 auVar6[16]undefined1 auVar7[16]undefined1 auVar8[16]undefined1 auVar9[16]undefined1 auVar10[16]undefined1 auVar11[16]undefined1 auVar12[16]undefined1 auVar13[16]undefined1 auVar14[16]undefined1 auVar15[16]undefined1 auVar16[16]undefined1 auVar17[16]undefined1 auVar18[16]undefined1 auVar19[16]undefined1 auVar20[16]undefined1 auVar21[16]undefined1 auVar22[16]undefined1 auVar23[16]undefined1 auVar24[16]undefined1 auVar25[16]undefined1 auVar26[16]undefined1 auVar27[16]undefined1 auVar28[16]undefined1 auVar29[16]undefined1 auVar30[16]undefined1 auVar31[16]undefined1 auVar32[16]undefined1 auVar33[16]undefined1 auVar34[16]undefined1 auVar35[16]uint uVar36uint uVar37uint uVar38ulong uVar39undefined8 uVar40void *__s_00undefined8 *puVar41long lVar42void *pvVar43ulong uVar44int *piVar45int iVar46long lVar47long lVar48long lVar49ulong uVar50undefined8 *puVar51undefined8 uVar52uint uVar53uint uVar54uint uVar55long *plVar56long in_FS_OFFSETundefined8 *local_c0StringName local_90[8]undefined1 local_88[16]long local_78[2]undefined1 local_68[16]undefined1 local_58[16]undefined8 local_48long local_40lVar42 = *(long*)( this + 8 );uVar38 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );uVar39 = CONCAT44(0, uVar38);local_40 = *(long*)( in_FS_OFFSET + 0x28 );if (lVar42 == 0) {
   LAB_001105a8:uVar44 = uVar39 * 4;
   uVar50 = uVar39 * 8;
   ...
   *(void**)( this + 8 ) = pvVar43;
   if ((int)uVar39 != 0) {
      ...
      LAB_0011039c:iVar46 = *(int*)( this + 0x2c );
      if (iVar46 != 0) {
         LAB_001103ac:uVar38 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
         ...
         if (uVar53 != 0) {
            do {
               if (( uVar53 == uVar37 ) && ( *(long*)( *(long*)( *(long*)( this + 8 ) + lVar49 * 8 ) + 0x10 ) == *(long*)param_1 )) {
                  lVar42 = *(long*)( *(long*)( this + 8 ) + (ulong)uVar54 * 8 );
                  uVar38 = *(uint*)( lVar42 + 0x40 );
                  uVar37 = *(uint*)( hash_table_size_primes + (ulong)uVar38 * 4 );
                  if (( *(int*)( lVar42 + 0x44 ) == 0 ) || ( *(long*)( lVar42 + 0x20 ) == 0 )) goto LAB_001104a5;
                  lVar49 = 0;
            ...
            } while ( ( uVar53 != 0 ) && ( auVar18._8_8_ = 0 ),auVar18._0_8_ = (ulong)uVar53 * lVar42,auVar34._8_8_ = 0,auVar34._0_8_ = uVar44,auVar19._8_8_ = 0,auVar19._0_8_ = ( ulong )(( uVar38 + uVar54 ) - SUB164(auVar18 * auVar34, 8)) * lVar42,auVar35._8_8_ = 0,auVar35._0_8_ = uVar44,uVar55 <= SUB164(auVar19 * auVar35, 8) );
         }
         iVar46 = *(int*)( this + 0x2c );
      }
      goto LAB_0010fd0b;
   ...
   LAB_0010fd31:uVar38 = *(uint*)( this + 0x28 );
   if (uVar38 == 0x1c) {
      _err_print_error("_insert", "./core/templates/hash_map.h", 0xdd, "Condition \"capacity_index + 1 == HASH_TABLE_SIZE_MAX\" is true. Returning: nullptr", "Hash table maximum capacity reached, aborting insertion.", 0, 0);
   ...
   *(void**)( this + 8 ) = __s_00;
   ...
   if (iVar46 != 0) {
      ...
      if (uVar53 != 0) {
         uVar55 = 0;
         do {
            if (( uVar53 == uVar37 ) && ( *(long*)( *(long*)( lVar42 + lVar47 * 8 ) + 0x10 ) == *(long*)param_1 )) {
         ...
         } while ( ( uVar53 != 0 ) && ( auVar6._8_8_ = 0 ),auVar6._0_8_ = (ulong)uVar53 * lVar49,auVar22._8_8_ = 0,auVar22._0_8_ = uVar39,auVar7._8_8_ = 0,auVar7._0_8_ = ( ulong )(( uVar54 + uVar38 ) - SUB164(auVar6 * auVar22, 8)) * lVar49,auVar23._8_8_ = 0,auVar23._0_8_ = uVar39,uVar55 <= SUB164(auVar7 * auVar23, 8) );
      }
      uVar39 = ( ulong ) * (uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
      if (lVar42 == 0) goto LAB_001105a8;
      goto LAB_0011039c;
   }
   LAB_0010fd0b:if ((float)uVar39 * __LC32 < (float)( iVar46 + 1 )) goto LAB_0010fd31;
}local_88 = (undefined1[16])0x0;StringName::StringName((StringName*)local_78, param_1);uVar39 = 1;local_48 = 0;local_68 = (undefined1[16])0x0;local_58 = (undefined1[16])0x0;do {
   if (0x16 < *(uint*)( hash_table_size_primes + uVar39 * 4 )) {
      local_48 = uVar39 & 0xffffffff;
      goto LAB_0010ffd8;
   }
   uVar39 = uVar39 + 1;
} while ( uVar39 != 0x1d );_err_print_error("reserve", "./core/templates/hash_map.h", 0x1b7, "Condition \"new_index + 1 == (uint32_t)HASH_TABLE_SIZE_MAX\" is true.", 0, 0, 0);LAB_0010ffd8:puVar41 = (undefined8*)operator_new(0x48, "");*puVar41 = local_88._0_8_;puVar41[1] = local_88._8_8_;StringName::StringName((StringName*)( puVar41 + 2 ), (StringName*)local_78);puVar41[8] = 0;uVar38 = *(uint*)( hash_table_size_primes + ( local_48 & 0xffffffff ) * 4 );*(undefined1(*) [16])( puVar41 + 4 ) = (undefined1[16])0x0;lVar42 = 1;*(undefined1(*) [16])( puVar41 + 6 ) = (undefined1[16])0x0;if (5 < uVar38) {
   do {
...
}LAB_00110079:pvVar43 = (void*)local_68._0_8_;if (local_48._4_4_ == 0) {
   ...
   if ((void*)local_68._0_8_ != (void*)0x0) {
      ...
      LAB_001107c8:local_48 = local_48 & 0xffffffff;
      local_58 = (undefined1[16])0x0;
   ...
   do {
      HashMap<StringName,ThemeDB::ThemeItemBind,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ThemeDB::ThemeItemBind>>>::insert(local_90, (ThemeItemBind*)( puVar41 + 3 ), (bool)( (char)plVar56 + '\x10' ));
   ...
   if ((void*)local_68._0_8_ != (void*)0x0) {
         ...
         do {
            if (*(int*)( local_68._8_8_ + lVar42 ) != 0) {
               ...
               *(int*)( local_68._8_8_ + lVar42 ) = 0;
               ...
               if (( ( ( StringName::configured != '\0' ) && ( ( *(long*)( (long)pvVar43 + 0x30 ) == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) ) ) && ( ( *(long*)( (long)pvVar43 + 0x28 ) == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) ) ) && ( ( ( *(long*)( (long)pvVar43 + 0x20 ) == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) && ( *(long*)( (long)pvVar43 + 0x10 ) != 0 ) ) )) {
                  StringName::unref();
               }
               Memory::free_static(pvVar43, false);
      ...
      LAB_00110362:Memory::free_static(pvVar43, false);
      Memory::free_static((void*)local_68._8_8_, false);
   }
}LAB_0011020a:local_c0 = puVar41 + 3;if (( StringName::configured != '\0' ) && ( local_78[0] != 0 )) {
   StringName::unref();
}puVar51 = *(undefined8**)( this + 0x20 );if (puVar51 == (undefined8*)0x0) {
   ...
   *puVar51 = puVar41;
   ...
   uVar38 = 1;
}uVar39 = (ulong)uVar38;uVar54 = 0;lVar42 = *(long*)( this + 0x10 );uVar37 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );uVar44 = CONCAT44(0, uVar37);lVar49 = *(long*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( this + 0x28 ) * 8 );auVar12._8_8_ = 0;auVar12._0_8_ = uVar39 * lVar49;auVar28._8_8_ = 0;auVar28._0_8_ = uVar44;lVar48 = SUB168(auVar12 * auVar28, 8);lVar47 = *(long*)( this + 8 );puVar1 = (uint*)( lVar42 + lVar48 * 4 );iVar46 = SUB164(auVar12 * auVar28, 8);uVar53 = *puVar1;while (uVar53 != 0) {
   auVar13._8_8_ = 0;
   ...
   puVar41 = puVar51;
   uVar53 = *puVar1;
};*(undefined8**)( lVar47 + lVar48 * 8 ) = puVar41;*puVar1 = uVar38;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_0010fcd4:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return local_c0;
}/* WARNING: Subroutine does not return */__stack_chk_fail();LAB_00110700:do {
   ...
   lVar49 = lVar49 + 4;
} while ( (ulong)uVar37 << 2 != lVar49 );uVar38 = *(uint*)( lVar42 + 0x40 );*(undefined4*)( lVar42 + 0x44 ) = 0;*(undefined1(*) [16])( lVar42 + 0x30 ) = (undefined1[16])0x0;uVar37 = *(uint*)( hash_table_size_primes + (ulong)uVar38 * 4 );LAB_001104a5:if (uVar37 < 0x17) {
   LAB_001104aa:if (uVar38 != 0x1c) {
      uVar39 = (ulong)uVar38;
      do {
         uVar37 = (int)uVar39 + 1;
         uVar39 = (ulong)uVar37;
            ...
            if (uVar37 != uVar38) {
               if (*(long*)( lVar42 + 0x20 ) == 0) {
                  *(uint*)( lVar42 + 0x40 ) = uVar37;
                  ...
                  HashMap<StringName,ThemeDB::ThemeItemBind,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ThemeDB::ThemeItemBind>>>::_resize_and_rehash((HashMap<StringName,ThemeDB::ThemeItemBind,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ThemeDB::ThemeItemBind>>>*)( lVar42 + 0x18 ), uVar37);
               }
            }
            goto LAB_00110503;
         }
   ...
   _err_print_error("reserve", "./core/templates/hash_map.h", 0x1b7, "Condition \"new_index + 1 == (uint32_t)HASH_TABLE_SIZE_MAX\" is true.", 0, 0, 0);
}LAB_00110503:local_c0 = (undefined8*)( *(long*)( *(long*)( this + 8 ) + (ulong)uVar54 * 8 ) + 0x18 );goto LAB_0010fcd4;}/* WARNING: Removing unreachable block (ram,0x00110958) *//* String vformat<StringName>(String const&, StringName const) */undefined8 *vformat<StringName>(undefined8 *param_1, bool *param_2, StringName *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (( ( plVar5 != (long*)0x0 ) && ( plVar5[1] != 0 ) ) && ( *(char*)( plVar5[1] + 0x2e ) != '\0' )) {
      ...
      if (local_58 == (char*)*plVar4) {
         ...
         _err_print_error(&_LC61, "./core/object/method_bind.h", 0x207, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: ret", (StringName*)&local_58, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
         if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
            StringName::unref();
   ...
   LAB_00110cb0:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   *(long*)( param_3 + 8 ) = (long)iVar1;
   LAB_00110f54:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   *(long*)param_3 = (long)iVar1;
   LAB_00111113:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   LAB_00111451:/* WARNING: Subroutine does not return */__stack_chk_fail();
   ...
   LAB_00111631:/* WARNING: Subroutine does not return */__stack_chk_fail();
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   ...
   LAB_00111700:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   *(double*)( param_3 + 8 ) = (double)fVar3;
   LAB_00111918:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   *(double*)param_3 = (double)fVar3;
   LAB_00111ad7:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   LAB_00111e29:/* WARNING: Subroutine does not return */__stack_chk_fail();
   ...
   LAB_00112009:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* MethodBindTR<Ref<StyleBox>>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindTR<Ref<StyleBox>>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   Variant *pVVar1;
   Object *pOVar2;
   char cVar3;
   Variant *pVVar4;
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBindTR<Ref<StyleBox>>::ptrcall(Object*, void const**, void*) const */void MethodBindTR<Ref<StyleBox>>::ptrcall(MethodBindTR<Ref<StyleBox>> *this, Object *param_1, void **param_2, void *param_3) {
   char cVar1;
   code *pcVar2;
   Object *pOVar3;
   long *plVar4;
   ...
   if (pOVar5 != pOVar3) {
      *(Object**)param_3 = pOVar3;
      if (pOVar3 == (Object*)0x0) {
         ...
         if (pOVar5 != (Object*)0x0) {
            LAB_001123e9:cVar1 = RefCounted::unreference();
            if (cVar1 != '\0') {
   ...
   LAB_001123a6:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBindT<Ref<StyleBox> const&>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<Ref<StyleBox>const&>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   long lVar1;
   Object *pOVar2;
   char cVar3;
   Object *pOVar4;
   ...
   if (pOVar4 != local_58) {
      if (pOVar4 == (Object*)0x0) {
         if (local_58 != (Object*)0x0) {
            local_58 = (Object*)0x0;
            LAB_00112666:cVar3 = RefCounted::unreference();
            if (cVar3 != '\0') {
               cVar3 = predelete_handler(pOVar2);
               if (cVar3 != '\0') {
                  ( **(code**)( *(long*)pOVar2 + 0x140 ) )(pOVar2);
   ...
   LAB_001126a8:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBindT<Ref<StyleBox> const&>::ptrcall(Object*, void const**, void*) const */void MethodBindT<Ref<StyleBox>const&>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   long lVar1;
   Object *pOVar2;
   char cVar3;
   long *plVar4;
   ...
   if (( *param_3 == (long*)0x0 ) || ( local_48 = (Object*)**param_3 ),local_48 == (Object*)0x0) {
      LAB_00112948:local_48 = (Object*)0x0;
   } else {
   ...
   LAB_0011296c:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBindTR<Ref<Texture2D>>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindTR<Ref<Texture2D>>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   Variant *pVVar1;
   Object *pOVar2;
   char cVar3;
   Variant *pVVar4;
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   ...
   LAB_00112c30:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBindTR<Ref<Texture2D>>::ptrcall(Object*, void const**, void*) const */void MethodBindTR<Ref<Texture2D>>::ptrcall(MethodBindTR<Ref<Texture2D>> *this, Object *param_1, void **param_2, void *param_3) {
   char cVar1;
   code *pcVar2;
   Object *pOVar3;
   long *plVar4;
   ...
   if (pOVar5 != pOVar3) {
      *(Object**)param_3 = pOVar3;
      if (pOVar3 == (Object*)0x0) {
         ...
         if (pOVar5 != (Object*)0x0) {
            LAB_00112ef9:cVar1 = RefCounted::unreference();
            if (cVar1 != '\0') {
               cVar1 = predelete_handler(pOVar5);
               if (cVar1 != '\0') {
                  ( **(code**)( *(long*)pOVar5 + 0x140 ) )(pOVar5);
   ...
   LAB_00112eb6:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   if (pOVar4 != local_58) {
      if (pOVar4 == (Object*)0x0) {
         if (local_58 != (Object*)0x0) {
            local_58 = (Object*)0x0;
            LAB_00113176:cVar3 = RefCounted::unreference();
            if (cVar3 != '\0') {
               cVar3 = predelete_handler(pOVar2);
               if (cVar3 != '\0') {
                  ( **(code**)( *(long*)pOVar2 + 0x140 ) )(pOVar2);
   ...
   LAB_001131b8:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   if (( *param_3 == (long*)0x0 ) || ( local_48 = (Object*)**param_3 ),local_48 == (Object*)0x0) {
      LAB_00113458:local_48 = (Object*)0x0;
   } else {
      cVar3 = RefCounted::init_ref();
   ...
   LAB_0011347c:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBindTR<Ref<Font>>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindTR<Ref<Font>>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   Variant *pVVar1;
   Object *pOVar2;
   char cVar3;
   Variant *pVVar4;
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   ...
   LAB_00113740:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBindTR<Ref<Font>>::ptrcall(Object*, void const**, void*) const */void MethodBindTR<Ref<Font>>::ptrcall(MethodBindTR<Ref<Font>> *this, Object *param_1, void **param_2, void *param_3) {
   char cVar1;
   code *pcVar2;
   Object *pOVar3;
   long *plVar4;
   ...
   if (pOVar5 != pOVar3) {
      *(Object**)param_3 = pOVar3;
      if (pOVar3 == (Object*)0x0) {
         ...
         if (pOVar5 != (Object*)0x0) {
            LAB_00113a09:cVar1 = RefCounted::unreference();
            if (cVar1 != '\0') {
               cVar1 = predelete_handler(pOVar5);
               if (cVar1 != '\0') {
                  ( **(code**)( *(long*)pOVar5 + 0x140 ) )(pOVar5);
   ...
   LAB_001139c6:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   if (pOVar4 != local_58) {
      if (pOVar4 == (Object*)0x0) {
         if (local_58 != (Object*)0x0) {
            local_58 = (Object*)0x0;
            LAB_00113c86:cVar3 = RefCounted::unreference();
            if (cVar3 != '\0') {
               cVar3 = predelete_handler(pOVar2);
               if (cVar3 != '\0') {
                  ( **(code**)( *(long*)pOVar2 + 0x140 ) )(pOVar2);
   ...
   LAB_00113cc8:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   if (( *param_3 == (long*)0x0 ) || ( local_48 = (Object*)**param_3 ),local_48 == (Object*)0x0) {
      LAB_00113f68:local_48 = (Object*)0x0;
   } else {
      cVar3 = RefCounted::init_ref();
   ...
   LAB_00113f8c:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBindTR<Ref<Theme>>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindTR<Ref<Theme>>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   Variant *pVVar1;
   Object *pOVar2;
   char cVar3;
   Variant *pVVar4;
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   ...
   LAB_00114250:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBindTR<Ref<Theme>>::ptrcall(Object*, void const**, void*) const */void MethodBindTR<Ref<Theme>>::ptrcall(MethodBindTR<Ref<Theme>> *this, Object *param_1, void **param_2, void *param_3) {
   char cVar1;
   code *pcVar2;
   Object *pOVar3;
   long *plVar4;
   ...
   if (pOVar5 != pOVar3) {
      *(Object**)param_3 = pOVar3;
      if (pOVar3 == (Object*)0x0) {
         ...
         if (pOVar5 != (Object*)0x0) {
            LAB_00114519:cVar1 = RefCounted::unreference();
            if (cVar1 != '\0') {
               cVar1 = predelete_handler(pOVar5);
               if (cVar1 != '\0') {
                  ( **(code**)( *(long*)pOVar5 + 0x140 ) )(pOVar5);
   ...
   LAB_001144d6:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBindT<Ref<StyleBox> const&>::call(Object*, Variant const**, int, Callable::CallError&)
   const */Object *MethodBindT<Ref<StyleBox>const&>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   Variant *pVVar1;
   long lVar2;
   char *pcVar3;
   code *pcVar4;
   ...
   if (pVVar12 == (Variant*)0x0) {
      ...
      LAB_00114920:pVVar12 = *(Variant**)param_4;
   } else {
      lVar2 = *(long*)( pVVar12 + -8 );
      if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
         LAB_00114930:uVar7 = 4;
         goto LAB_001148cd;
      }
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   ...
   if (pVVar12 == (Variant*)0x0) {
      ...
      LAB_00114d00:pVVar12 = *(Variant**)param_4;
   } else {
      lVar2 = *(long*)( pVVar12 + -8 );
      if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
         LAB_00114d10:uVar7 = 4;
         goto LAB_00114cad;
      }
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   ...
   if (pVVar12 == (Variant*)0x0) {
      ...
      LAB_001150e0:pVVar12 = *(Variant**)param_4;
   } else {
      lVar2 = *(long*)( pVVar12 + -8 );
      if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
         LAB_001150f0:uVar7 = 4;
         goto LAB_0011508d;
      }
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   ...
   return param_1;
}/* MethodBindTR<Ref<Theme>>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTR<Ref<Theme>>::validated_call(MethodBindTR<Ref<Theme>> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   Object *pOVar1;
   char cVar2;
   code *pcVar3;
   long *plVar4;
   ...
   LAB_00115386:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBindTR<Ref<StyleBox>>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTR<Ref<StyleBox>>::validated_call(MethodBindTR<Ref<StyleBox>> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   Object *pOVar1;
   char cVar2;
   code *pcVar3;
   long *plVar4;
   ...
   LAB_001155b6:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBindTR<Ref<Texture2D>>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTR<Ref<Texture2D>>::validated_call(MethodBindTR<Ref<Texture2D>> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   Object *pOVar1;
   char cVar2;
   code *pcVar3;
   long *plVar4;
   ...
   LAB_001157e6:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBindTR<Ref<Font>>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTR<Ref<Font>>::validated_call(MethodBindTR<Ref<Font>> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   Object *pOVar1;
   char cVar2;
   code *pcVar3;
   long *plVar4;
   ...
   LAB_00115a16:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   if (lVar1 == 0) {
      ...
      if ((int)lVar2 < (int)( uVar8 ^ 1 )) {
         LAB_00115d20:uVar6 = 4;
         LAB_00115cbd:*(undefined4*)param_6 = uVar6;
   ...
   LAB_00115c3b:*(undefined4*)param_6 = 0;
   ...
   *(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   LAB_00115d86:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   if (lVar1 == 0) {
      ...
      lVar2 = *(long*)( lVar1 + -8 );
      if ((int)lVar2 < (int)( uVar8 ^ 1 )) {
         LAB_001160b0:uVar6 = 4;
         LAB_0011604d:*(undefined4*)param_6 = uVar6;
         *(undefined4*)( param_6 + 8 ) = 1;
         return;
      }
      if (uVar8 != 1) {
   ...
   this * (Variant**)CONCAT44(in_register_0000000c, param_4);
   LAB_00115fcb:*(undefined4*)param_6 = 0;
   if (( (ulong)param_2 & 1 ) != 0) {
   ...
   *(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   LAB_00116116:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* WARNING: Control flow encountered bad instruction data *//* ThemeContext::~ThemeContext() */void ThemeContext::~ThemeContext(ThemeContext *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}/* WARNING: Control flow encountered bad instruction data *//* List<ThemeDB::ThemeItemBind, DefaultAllocator>::~List() */void List<ThemeDB::ThemeItemBind,DefaultAllocator>::~List(List<ThemeDB::ThemeItemBind,DefaultAllocator> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}/* WARNING: Control flow encountered bad instruction data *//* KeyValue<StringName, List<ThemeDB::ThemeItemBind, DefaultAllocator> >::~KeyValue() */void KeyValue<StringName,List<ThemeDB::ThemeItemBind,DefaultAllocator>>::~KeyValue(KeyValue<StringName,List<ThemeDB::ThemeItemBind,DefaultAllocator>> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
   ...
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}/* WARNING: Control flow encountered bad instruction data *//* ThemeDB::ThemeItemBind::~ThemeItemBind() */void ThemeDB::ThemeItemBind::~ThemeItemBind(ThemeItemBind *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
   ...
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}/* WARNING: Control flow encountered bad instruction data *//* MethodBindTR<Ref<StyleBox>>::~MethodBindTR() */void MethodBindTR<Ref<StyleBox>>::~MethodBindTR(MethodBindTR<Ref<StyleBox>> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}/* WARNING: Control flow encountered bad instruction data *//* MethodBindT<Ref<StyleBox> const&>::~MethodBindT() */void MethodBindT<Ref<StyleBox>const&>::~MethodBindT(MethodBindT<Ref<StyleBox>const&> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}/* WARNING: Control flow encountered bad instruction data *//* MethodBindTR<Ref<Texture2D>>::~MethodBindTR() */void MethodBindTR<Ref<Texture2D>>::~MethodBindTR(MethodBindTR<Ref<Texture2D>> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
   ...
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}/* WARNING: Control flow encountered bad instruction data *//* MethodBindTR<Ref<Font>>::~MethodBindTR() */void MethodBindTR<Ref<Font>>::~MethodBindTR(MethodBindTR<Ref<Font>> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
   ...
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}/* WARNING: Control flow encountered bad instruction data *//* MethodBindTR<Ref<Theme>>::~MethodBindTR() */void MethodBindTR<Ref<Theme>>::~MethodBindTR(MethodBindTR<Ref<Theme>> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<ThemeDB, void, Node*>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<ThemeDB,void,Node*>::~CallableCustomMethodPointer(CallableCustomMethodPointer<ThemeDB,void,Node*> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<ThemeDB, void>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<ThemeDB,void>::~CallableCustomMethodPointer(CallableCustomMethodPointer<ThemeDB,void> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<ThemeContext, void>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<ThemeContext,void>::~CallableCustomMethodPointer(CallableCustomMethodPointer<ThemeContext,void> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();

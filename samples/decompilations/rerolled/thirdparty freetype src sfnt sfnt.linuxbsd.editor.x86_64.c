...
undefined8 sfnt_table_info(long param_1, uint param_2, undefined8 *param_3, undefined8 *param_4, ulong *param_5) {
   undefined8 *puVar1;
   ...
   if (uVar1 != 0) {
      ...
      LAB_001001ec:do {
         if (( *(short*)( (long)piVar2 + 6 ) == param_2 ) && ( (short)piVar2[2] != 0 )) {
            if (( ( (short)*piVar2 == 3 ) && ( *(ushort*)( (long)piVar2 + 2 ) < 2 ) ) && ( ( (short)piVar2[1] == 0x409 || ( *param_3 == 0xffffffff ) ) )) {
               *param_3 = uVar3;
            }
...
long compute_ULong_sum(long param_1, ulong param_2) {
   ...
   if (uVar6 == 0) {
      ...
      do {
         ...
         uVar5 = uVar5 + 4;
         lVar8 = lVar8 + ( ( ulong ) * pbVar1 << 0x18 | ( ulong ) * pbVar2 << 0x10 | ( ulong ) * pbVar3 | ( ulong ) * pbVar4 << 8 );
      }
 while ( uVar5 < uVar6 );
      if (( param_2 & 3 ) == 0) {
         return lVar8;
...
ushort tt_cmap2_char_next(undefined8 param_1, int *param_2) {
   ...
   uint uVar14;
   uVar10 = *param_2 + 1;
   joined_r0x001004c6:if (0xffff < uVar10) {
      iVar11 = 0;
      uVar3 = 0;
      LAB_0010053c:*param_2 = iVar11;
      return uVar3;
   }
...
;
         if (uVar5 == 0) {
            ...
            LAB_001005f0:uVar14 = uVar14 - uVar8;
            uVar7 = ( ulong )((uint)uVar4 + uVar14 * 2) + 6;
            if (uVar14 < uVar13) {
               LAB_0010059e:puVar9 = (undefined1*)( (long)puVar6 + uVar7 );
               ...
               do {
                  ...
                  puVar1 = puVar9 + 1;
                  puVar9 = puVar9 + 2;
                  if (( CONCAT11(uVar2, *puVar1) != 0 ) && ( uVar3 = CONCAT11(uVar2, *puVar1) + ( puVar6[2] << 8 | puVar6[2] >> 8 ) ),uVar3 != 0) goto LAB_0010053c;
 ...
 while ( iVar11 + 1U != uVar10 );
      ...
      LAB_00100550:if (0xff < uVar10) break;
      uVar10 = uVar10 + 1;
   }
 while ( true );
   LAB_00100527:uVar10 = ( uVar10 & 0xffffff00 ) + 0x100;
...
undefined8 tt_cmap4_init(long param_1, long param_2) {
   ...
   *(uint*)( param_1 + 0x30 ) = ( uint )(( ushort )(*(ushort*)( param_2 + 6 ) << 8 | *(ushort*)( param_2 + 6 ) >> 8) >> 1);
...
;
   if (uVar5 != 0) {
      if ((long)puVar3 + (ulong)uVar5 + 2 <= ( ulong )(*(long*)( *param_1 + 0x330 ) + *(long*)( *param_1 + 0x338 ))) goto LAB_001006b8;
      *(undefined4*)( param_1 + 8 ) = 1;
   }

   LAB_00100750:lVar4 = 0;
   LAB_00100772:param_1[9] = lVar4;
...
void tt_cmap4_next(long *param_1) {
   ...
   do {
      ...
      if (uVar3 < uVar11) {
         LAB_001007b0:iVar7 = tt_cmap4_set_range();
      }
 else {
         if (param_1[9] == 0) {
            do {
 ...
 while ( uVar11 <= uVar3 );
         ...
         if (puVar10 <= (undefined1*)( lVar5 + lVar6 )) {
            do {
               ...
               puVar1 = puVar10 + 1;
               puVar10 = puVar10 + 2;
               if (( CONCAT11(uVar2, *puVar1) != 0 ) && ( uVar8 = (uint)CONCAT11(uVar2, *puVar1) + iVar7 & 0xffff ),uVar8 != 0) {
                  *(uint*)( param_1 + 5 ) = uVar11;
                  *(uint*)( (long)param_1 + 0x2c ) = uVar8;
                  return;
               }
...
uint tt_cmap4_char_map_linear(long *param_1, uint *param_2, byte param_3) {
   ...
   do {
      ...
      if (( uVar10 < CONCAT11(uVar4, uVar5) ) && ( uVar10 = param_3 == 0 )) {
         return 0;
      }
      ...
      if (uVar10 <= uVar18) {
         ...
         do {
            iVar21 = iVar17;
            if (( uVar22 < uVar9 - 1 ) || ( ( ushort )(CONCAT11(uVar3, *puVar1) & CONCAT11(uVar4, uVar5)) != 0xffff )) {
               if (uVar15 == 0xffff) break;
               if (uVar15 == 0) goto LAB_00100ac3;
               LAB_00100a08:bVar20 = (bool)( param_3 & 1 );
               puVar13 = (ushort*)( (long)puVar19 + ( uVar15 + ( uVar10 - CONCAT11(uVar4, uVar5) ) * 2 ) + uVar23 );
               ...
               LAB_00100a58:if (bVar20 == false) goto LAB_00100a9b;
               LAB_00100a61:if (uVar10 == 0xffff) goto LAB_00100a90;
            }
 else {
               if (uVar14 != 0) {
               ...
               LAB_00100ac3:uVar2 = uVar10 + iVar21;
               uVar12 = uVar2 & 0xffff;
               if (param_3 == 0) {
                  return uVar12;
               }
 ...
 while ( uVar10 <= uVar18 );
      ...
      puVar19 = puVar19 + 1;
      if (uVar9 == uVar22) {
         LAB_00100a90:uVar12 = 0;
         LAB_00100a9b:if (param_3 == 0) {
            return uVar12;
         }
...
;
   if (uVar13 + 1 == uVar9) {
      ...
      do {
         ...
         uVar21 = ( uint )(ushort)(*puVar5 << 8 | *puVar5 >> 8);
         local_5c = (int)(short)( *(ushort*)( (long)puVar11 + uVar26 ) << 8 | *(ushort*)( (long)puVar11 + uVar26 ) >> 8 );
         if (uVar21 != 0xffff) {
            uVar9 = uVar24;
         }
 ...
 while ( uVar20 != uVar24 + 1 );
   ...
   LAB_00100dd6:if (uVar23 == 0) {
      LAB_00100f20:uVar21 = uVar12 + local_5c;
   ...
   LAB_00100c2e:if (param_3 == 0) {
      return uVar23;
   }

   LAB_00100e10:if (( uVar14 < uVar12 ) && ( uVar20 == uVar13 + 1 )) {
      return 0;
   }
   ...
   if (iVar4 == 0) {
      *(uint*)( param_1 + 5 ) = uVar12;
      if (uVar23 == 0) {
         LAB_00100ef7:tt_cmap4_next(param_1);
...
uint tt_cmap8_char_index(long param_1, uint param_2) {
   ...
   if (uVar6 != 0) {
      ...
      do {
         ...
         if (param_2 <= ( uVar1 >> 0x18 | ( uVar1 & 0xff0000 ) >> 8 | ( uVar1 & 0xff00 ) << 8 | uVar1 << 0x18 )) {
 ...
 while ( (uint*)( lVar2 + 0x201c + ( ulong )(( uVar6 >> 0x18 | ( uVar6 & 0xff0000 ) >> 8 | ( uVar6 & 0xff00 ) << 8 | uVar6 << 0x18 ) - 1) * 0xc ) != puVar4 );
      uVar6 = 0;
   }
      ...
      if (uVar6 <= uVar8) {
         ...
         if ((ulong)uVar12 <= 0xffffffff - (ulong)uVar9) {
            ...
            if (uVar13 == 0) {
               ...
               while (( uVar6 = uVar6 + 1 ),uVar6 <= uVar8 && ( uVar9 = uVar9 + 1 ),(ulong)uVar12 <= 0xffffffff - (ulong)uVar9) {
...
;
               ...
               LAB_00101520:if (uVar13 < *(uint*)( *param_1 + 0x20 )) {
                  *param_2 = uVar6;
                  return uVar13;
               }
      ...
      puVar10 = puVar11;
      if ((uint*)( lVar1 + 0x201c + ( ulong )(( uVar2 | uVar3 >> 8 | uVar4 << 8 | uVar5 ) - 1) * 0xc ) == puVar11) {
         *param_2 = 0;
         return 0;
      }
...
undefined8 tt_cmap12_init(long param_1, long param_2) {
   ...
   *(ulong*)( param_1 + 0x48 ) = ( ulong )(uVar1 >> 0x18 | ( uVar1 & 0xff0000 ) >> 8 | ( uVar1 & 0xff00 ) << 8 | uVar1 << 0x18);
   return 0;
}
void tt_cmap12_next(long *param_1) {
   ...
   if (uVar10 < (ulong)param_1[9]) {
      ...
      do {
         ...
         uVar8 = (ulong)uVar6;
         uVar3 = ( ulong )(uVar7 >> 0x18 | ( uVar7 & 0xff0000 ) >> 8 | ( uVar7 & 0xff00 ) << 8 | uVar7 << 0x18);
         ...
         if (( uVar2 <= uVar3 ) && ( (ulong)uVar4 <= ( uVar8 + 0xffffffff ) - uVar2 )) {
            ...
            if (uVar7 == 0) {
               ...
               uVar2 = uVar2 + 1;
               uVar7 = iVar5 + (int)uVar2;
               for (; ( uVar2 <= uVar3 && ( (ulong)uVar4 <= ( uVar8 + 0xffffffff ) - uVar2 ) ); uVar2 = uVar2 + 1) {
               ...
               LAB_00101718:if (uVar7 < *(uint*)( *param_1 + 0x20 )) {
 ...
 while ( uVar10 != param_1[9] );
   ...
   LAB_00101709:*(undefined1*)( param_1 + 5 ) = 0;
   return;
}
...
;
 ...
 while ( uVar7 < uVar4 );
   LAB_001017a0:uVar4 = 0;
   if (( param_3 != 0 ) && ( ( uVar8 <= uVar6 || ( uVar5 = uVar5 + 1 ),uVar2 != uVar5 ) )) {
      *(undefined1*)( param_1 + 5 ) = 1;
      param_1[6] = (ulong)uVar8;
      param_1[8] = (ulong)uVar5;
      LAB_001017c5:tt_cmap12_next(param_1);
      if ((char)param_1[5] == '\0') {
...
void tt_cmap13_next(long *param_1) {
   ...
   if (uVar6 < (ulong)param_1[9]) {
      ...
      do {
         ...
         if (( ( uVar5 <= ( uVar1 >> 0x18 | ( uVar1 & 0xff0000 ) >> 8 | ( uVar1 & 0xff00 ) << 8 | uVar1 << 0x18 ) ) && ( uVar2 != 0 ) ) && ( uVar7 = uVar2 >> 0x18 | ( uVar2 & 0xff0000 ) >> 8 | ( uVar2 & 0xff00 ) << 8 | uVar2 << 0x18 ),uVar7 < *(uint*)( *param_1 + 0x20 )) {
            param_1[6] = uVar5;
            *(uint*)( param_1 + 7 ) = uVar7;
            param_1[8] = uVar6;
            return;
...
uint tt_cmap13_char_map_binary(long *param_1, uint *param_2, byte param_3) {
   ...
   do {
      while (true) {
         ...
         uVar5 = puVar1[1];
         uVar5 = uVar5 >> 0x18 | ( uVar5 & 0xff0000 ) >> 8 | ( uVar5 & 0xff00 ) << 8 | uVar5 << 0x18;
         if (( uVar2 >> 0x18 | ( uVar2 & 0xff0000 ) >> 8 | ( uVar2 & 0xff00 ) << 8 | uVar2 << 0x18 ) <= uVar8) break;
         uVar6 = uVar4;
...
;
 ...
 while ( uVar7 < uVar6 );
   LAB_001019a0:uVar7 = 0;
   if (( param_3 != 0 ) && ( ( uVar8 <= uVar5 || ( uVar4 = uVar4 + 1 ),uVar3 != uVar4 ) )) {
      *(undefined1*)( param_1 + 5 ) = 1;
      param_1[6] = (ulong)uVar8;
      param_1[8] = (ulong)uVar4;
      LAB_001019c5:tt_cmap13_next(param_1);
      if ((char)param_1[5] == '\0') {
         uVar8 = *(uint*)( param_1 + 6 );
         uVar7 = 0;
      }
...
undefined8 tt_cmap14_init(long param_1, long param_2) {
   ...
   *(ulong*)( param_1 + 0x28 ) = ( ulong )(uVar1 >> 0x18 | ( uVar1 & 0xff0000 ) >> 8 | ( uVar1 & 0xff00 ) << 8 | uVar1 << 0x18);
   return 0;
}
...
int tt_cmap14_char_var_isdefault(long param_1, uint param_2, undefined4 param_3) {
   ...
   if (( uVar7 != 0 ) && ( iVar4 = tt_cmap14_char_map_def_binary(uVar7 + lVar3, uVar8 & 0xffffffff) ),iVar4 != 0) {
      return 1;
   }
...
undefined8 tt_cmap_unicode_init(long *param_1) {
   ...
   if (UNRECOVERED_JUMPTABLE != (code*)0x0) {
      ...
      /* WARNING: Treating indirect jump as call */
      uVar2 = ( *UNRECOVERED_JUMPTABLE )(*(undefined8*)( lVar1 + 0xb8 ), param_1, *(undefined4*)( lVar1 + 0x20 ), tt_get_glyph_name, 0);
      return uVar2;
   }
...
undefined8 tt_face_get_colr_layer(long param_1, uint param_2, uint *param_3, uint *param_4, uint *param_5) {
   ushort uVar1;
   long lVar2;
   long lVar3;
   ushort uVar4;
 ...
 while ( uVar10 < uVar5 );
      ...
      puVar9 = *(ushort**)( lVar2 + 0x10 );
      LAB_00101dff:if (( puVar9 <= puVar7 ) && ( puVar7 < (ushort*)( *(long*)( lVar2 + 0x88 ) + *(long*)( lVar2 + 0x80 ) ) )) {
...
undefined8 get_child_table_pointer(long param_1, long param_2, long *param_3, ulong *param_4) {
   ...
   ulong uVar4;
   pbVar1 = (byte*)*param_3;
   if (( *(byte**)( param_1 + 0x40 ) <= pbVar1 ) && ( lVar2 = *(long*)( param_1 + 0x88 ) ),pbVar1 <= (byte*)( *(long*)( param_1 + 0x80 ) + -4 + lVar2 )) {
      *param_3 = (long)( pbVar1 + 3 );
      uVar3 = ( uint ) * pbVar1 << 0x10 | (uint)pbVar1[1] << 8 | (uint)pbVar1[2];
      if (( uVar3 != 0 ) && ( ( uVar4 = param_2 + (ulong)uVar3 * (ulong*)( param_1 + 0x40 ) <= uVar4 && ( uVar4 < ( ulong )(lVar2 + *(long*)( param_1 + 0x80 )) ) ) )) {
         *param_4 = uVar4;
         return 1;
      }
...
undefined8 get_deltas_for_var_index_base(long param_1, long param_2, ulong param_3, ulong param_4, undefined8 *param_5) {
   long lVar1;
   long lVar2;
   undefined4 uVar3;
   uint uVar4;
...
void extract_svg_doc(uint *param_1, uint *param_2) {
   ...
   *(ulong*)( param_1 + 4 ) = ( ulong )(uVar3 >> 0x18 | ( uVar3 & 0xff0000 ) >> 8 | ( uVar3 & 0xff00 ) << 8 | uVar3 << 0x18);
   *param_1 = auVar4._0_4_ | CONCAT22(( ushort )(uVar1 >> 0x18), (ushort)uVar1 >> 8);
   *(ulong*)( param_1 + 2 ) = ( ulong )(uVar2 >> 0x18 | ( uVar2 & 0xff0000 ) >> 8 | ( uVar2 & 0xff00 ) << 8 | uVar2 << 0x18);
   return;
}
            ...
            if (( *(uint*)( param_1 + 0x564 ) & uVar14 ) != 0) {
               ...
               if (( uVar7 & 0xff ) == 0) {
                  if (( uVar14 & *(uint*)( param_1 + 0x568 ) ) == 0) {
                     if (uVar11 != 0) {
                        LAB_00102479:uVar4 = *puVar10;
                        if (uVar12 != ( uVar4 >> 0x18 | ( uVar4 & 0xff0000 ) >> 8 | ( uVar4 & 0xff00 ) << 8 | uVar4 << 0x18 )) goto LAB_00102470;
                        uVar3 = (ushort)puVar10[1] << 8 | (ushort)puVar10[1] >> 8;
                        LAB_0010248d:iVar16 = iVar16 + (short)uVar3;
                        if (( uVar7 >> 8 & 8 ) != 0) {
                     ...
                     while (uVar8 = uVar11,uVar4 < uVar8) {
                        ...
                        puVar13 = (uint*)( ( ulong )(( ( uVar8 + uVar4 & 0xfffffffe ) + uVar11 ) * 2) + (long)puVar10 );
                        uVar1 = *puVar13;
...
;
            ...
            LAB_00102497:uVar14 = uVar14 * 2;
            iVar9 = iVar9 + -1;
            if (( iVar9 == 0 ) || ( uVar5 = uVar15 < uVar6 + 6 )) {
               return iVar16;
            }
 ...
 while ( true );
   ...
   return 0;
   LAB_00102470:puVar10 = (uint*)( (long)puVar10 + 6 );
...
undefined8 tt_sbit_decoder_load_byte_aligned(long param_1, byte *param_2, byte *param_3, uint param_4, uint param_5) {
   uint uVar1;
   ushort uVar2;
   uint uVar3;
   uint *puVar4;
         ...
         do {
            *pbVar12 = ( byte )(uVar8 >> sVar7) | bVar15;
            while (true) {
               ...
               LAB_0010278a:uVar8 = 0;
               bVar15 = *pbVar12;
               pbVar5 = pbVar12;
               uVar11 = uVar14;
               if (uVar14 == 0) break;
               LAB_001027a0:uVar8 = ( uint ) * param_2 & 0xff00U >> ( (byte)uVar11 & 0x1f ) | uVar8;
...
undefined4 tt_sbit_decoder_load_bit_aligned(long param_1, byte *param_2, byte *param_3, uint param_4, uint param_5) {
   byte *pbVar1;
   byte bVar2;
   byte bVar3;
   ushort uVar4;
   ...
   if (uVar4 + param_4 <= puVar7[1]) {
      ...
      uVar25 = (uint)uVar5;
      if (( uVar25 + param_5 <= *puVar7 ) && ( uVar24 = ( uint ) * (byte*)( param_1 + 0x22 ) * (uint)uVar4 ),param_2 + ( (int)( uVar25 * uVar24 + 7 ) >> 3 ) <= param_3) {
         if (( uVar24 != 0 ) && ( uVar5 != 0 )) {
            uVar6 = puVar7[2];
            uVar22 = param_4 & 7;
            uVar10 = 8 - uVar22;
            pbVar21 = (byte*)( (long)(int)( ( (int)param_4 >> 3 ) + param_5 * uVar6 ) + *(long*)( puVar7 + 4 ) );
            uVar8 = uVar24;
            ...
            do {
               if (uVar22 == 0) {
                  ...
                  LAB_001029ba:bVar13 = (byte)uVar19;
                  ...
                  *pbVar21 = *pbVar21 | ( byte )((int)( uVar12 & 0xffff ) >> ( (byte)uVar19 & 0x1f )) & local_40;
                  ...
                  uVar12 = uVar11;
                  if (7 < (int)uVar14) {
                     LAB_0010296a:uVar17 = uVar20 - 8 >> 3;
                     uVar11 = uVar17 + 1;
...
int tt_face_load_kern(long param_1, undefined8 param_2) {
      ...
      *(ulong*)( param_1 + 0x558 ) = local_48;
      ...
      if (( uVar7 == 0 ) || ( local_48 < lVar1 + 10U )) {
         ...
         while (true) {
            ...
            if (( ( ( *(ushort*)( uVar9 + 4 ) & 0xff ) == 0 ) && ( ( *(ushort*)( uVar9 + 4 ) >> 8 & 3 ) == 1 ) ) && ( uVar9 + 0xe <= uVar8 )) {
 ...
 while ( uVar5 != 0 );
            ...
            LAB_00102ba8:uVar4 = uVar4 + 1;
            if (( uVar11 <= uVar4 ) || ( uVar13 = 1 << ( (byte)uVar4 & 0x1f ) ),uVar9 = uVar8,uVar14 = uVar6,local_48 < uVar8 + 6) break;
         }
;
      }
...
void tt_face_get_metrics(long param_1, char param_2, uint param_3, short *param_4, ushort *param_5) {
   ...
   if (uVar6 != 0) {
      uVar1 = lVar9 + lVar10;
      if (param_3 < uVar6) {
         if (( ( ulong )(param_3 * 4) + lVar9 + 4 <= uVar1 ) && ( local_4c = local_4c == 0 )) {
         ...
         if (( lVar9 + 2U <= uVar1 ) && ( local_4c = local_4c == 0 )) {
            uVar5 = FT_Stream_ReadUShort(uVar2, &local_4c);
            *param_5 = uVar5;
            if (local_4c == 0) {
               if (( uVar1 < ( ulong )(( param_3 - uVar6 ) * 2 + 4) + lVar9 + 2 ) || ( local_4c = local_4c != 0 )) {
                  *param_4 = 0;
               }
 else {
                  sVar7 = FT_Stream_ReadUShort(uVar2, &local_4c);
   ...
   *param_4 = 0;
   *param_5 = 0;
   LAB_00102dd5:if (( puVar3 != (undefined8*)0x0 ) && ( *(long*)( param_1 + 0x4c0 ) != 0 )) {
...
int tt_face_get_name(long param_1, ushort param_2, undefined8 *param_3) {
   ...
   local_34 = 0;
   if (uVar1 == 0) {
      LAB_0010339a:puVar11 = (ushort*)0x0;
      iVar6 = 0;
      goto LAB_00103284;
   }
   ...
   puVar7 = puVar11;
   do {
      while (( ( uVar5 = uVar10 ),puVar7[3] != param_2 || ( puVar7[4] == 0 ) ) || ( uVar2 = *puVar7 ),uVar5 = uVar9,uVar2 == 2) {
         LAB_00103200:uVar10 = uVar5;
         uVar9 = uVar9 + 1;
         puVar7 = puVar7 + 0x10;
...
;
      if (2 < uVar2) {
         uVar5 = uVar10;
         if (( ( uVar2 == 3 ) && ( ( uVar13 == 0xffffffff || ( ( puVar7[2] & 0x3ff ) == 9 ) ) ) ) && ( ( puVar7[1] < 2 || ( puVar7[1] == 10 ) ) )) {
 ...
 while ( uVar9 != uVar1 );
   LAB_00103258:uVar9 = (uint)lVar12;
   if ((int)uVar9 < 0) {
      if (-1 < (int)uVar13) {
      ...
      LAB_0010327d:puVar11 = (ushort*)( (long)puVar11 + lVar12 );
      iVar6 = 0;
      if (puVar11 == (ushort*)0x0) goto LAB_00103284;
   }
 else {
      if ((int)uVar13 < 0) {
         LAB_0010326e:lVar12 = lVar12 * 0x20;
         pcVar15 = tt_name_ascii_from_other;
         goto LAB_0010327d;
      }

      joined_r0x0010336e:if (( -1 < (int)uVar9 ) && ( !bVar16 )) goto LAB_0010326e;
      pcVar15 = tt_name_ascii_from_utf16;
   ...
   if (*(long*)( puVar11 + 0xc ) == 0) {
      ...
      *(undefined8*)( puVar11 + 0xc ) = uVar8;
      if (local_34 == 0) {
         ...
         if (( local_34 == 0 ) && ( local_34 = FT_Stream_Read(uVar4, *(undefined8*)( puVar11 + 0xc ), puVar11[4]) ),local_34 == 0) goto LAB_001032db;
      ...
      LAB_001032db:puVar11 = (ushort*)( *pcVar15 )(puVar11, uVar3);
      iVar6 = local_34;
   }

   LAB_00103284:local_34 = iVar6;
   *param_3 = puVar11;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int tt_face_load_svg_doc(long param_1, uint param_2) {
   long lVar1;
   uint *puVar2;
   undefined2 uVar3;
   undefined8 *puVar4;
            ...
            do {
               ...
               if ((uint)uVar24 < (uint)local_78) {
                  ...
                  if ((uint)uVar24 <= (uint)local_76) {
                     ...
                     pcVar18 = pcVar19;
                     if (( 6 < local_68 ) && ( ( ( *pcVar19 == '\x1f' && ( pcVar19[1] == -0x75 ) ) && ( pcVar19[2] == '\b' ) ) )) {
                        local_58 = (ulong)(byte)pcVar19[local_68 - 1] << 0x18 | (ulong)(byte)pcVar19[local_68 - 2] << 0x10 | (ulong)(byte)pcVar19[local_68 - 4] | (ulong)(byte)pcVar19[local_68 - 3] << 8;
 ...
 while ( (uint)uVar22 <= (uint)uVar21 );
   ...
   LAB_00103cb5:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar16;
   }
...
int tt_face_load_svg(long param_1, undefined8 param_2) {
   ...
   *(undefined8*)( param_1 + 0x5c8 ) = 0;
   LAB_00103e75:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return local_44;
   }
...
int tt_sbit_decoder_load_image(long *param_1, uint param_2, undefined4 param_3, undefined4 param_4, uint param_5, char param_6) {
   ushort uVar1;
   uint *puVar2;
   bool bVar3;
   int iVar4;
   ...
   for (; lVar16 != 0; lVar16 = lVar16 + -1) {
      ...
      if (( param_2 <= ( ushort )(*(ushort*)( (long)puVar11 + 2 ) << 8 | *(ushort*)( (long)puVar11 + 2 ) >> 8) ) && ( uVar21 <= param_2 )) {
         if (bVar3) {
            local_58 = puVar11;
         }
   ...
   goto switchD_0010406e_caseD_0;
   LAB_00104201:if (param_2 != ( ushort )(( ushort ) * puVar20 << 8 | ( ushort ) * puVar20 >> 8)) goto LAB_001041f0;
   ...
   if (( uVar18 < uVar12 ) && ( uVar8 <= uVar9 )) {
      uVar12 = uVar9 - uVar8;
      LAB_001043e7:lVar16 = param_1[1];
      if (uVar12 == 0) {
         LAB_001043f7:iVar19 = 6;
         goto LAB_001040b9;
      }

      LAB_00104297:if ((ulong)param_1[6] < uVar6 + uVar9) goto LAB_001043f7;
...
switchD_00104377_caseD_9:
      ...
      if (*(char*)( (long)param_1 + 0x21 ) == '\0') {
            ...
            *puVar2 = (uint)uVar21;
            ...
            uVar17 = 0x100;
               ...
               *(undefined2*)( puVar2 + 6 ) = uVar17;
               ...
               if (( param_6 == '\0' ) && ( iVar4 = ft_glyphslot_alloc_bitmap(*(undefined8*)( *param_1 + 0x98 ), lVar14) ),iVar4 == 0) {
               ...
               switchD_001044f1_caseD_3:iVar4 = 3;
            }
         ...
         LAB_00104413:if (param_6 == '\0') {
            LAB_00104418:iVar4 = ( *pcVar22 )(param_1, local_50, uVar12, param_3, param_4, param_5);
         }

      }

      LAB_00104432:iVar19 = iVar4;
      FT_Stream_ReleaseFrame(lVar16, &local_48);
      goto LAB_001040b9;
   }

   goto switchD_0010406e_caseD_0;
   LAB_001041f0:uVar18 = uVar18 + 1;
   puVar20 = puVar20 + 1;
   if (uVar12 == uVar18) goto switchD_0010406e_caseD_0;
   goto LAB_00104201;
   while (uVar8 = uVar8 + 1,uVar9 != uVar8) {
      LAB_0010416e:uVar13 = *puVar20;
      puVar20 = (uint*)( (long)puVar20 + 2 );
      if (param_2 == ( ushort )((ushort)uVar13 << 8 | (ushort)uVar13 >> 8)) {
         local_58 = puVar20;
         if (uVar8 < uVar9) {
            uVar12 = ( ulong )(uVar5 >> 0x18 | ( uVar5 & 0xff0000 ) >> 8 | ( uVar5 & 0xff00 ) << 8 | uVar5 << 0x18);
            uVar8 = uVar8 * uVar12;
            uVar9 = uVar12 + uVar8;
            goto LAB_001043e7;
         }
...
;
   switchD_0010406e_caseD_0:iVar19 = ( -(uint)(param_5 == 0) & 0x88 ) + 0x15;
   LAB_001040b9:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar19;
   }
...
int tt_sbit_decoder_load_compound(long param_1, ushort *param_2, ushort *param_3, int param_4, int param_5, int param_6) {
   byte bVar1;
   byte bVar2;
   ushort uVar3;
   ushort uVar4;
   ...
   iVar10 = 3;
   puVar13 = param_2 + 1;
   if (( puVar13 <= param_3 ) && ( uVar12 = *param_2 << 8 | *param_2 >> 8 ),(ushort*)( ( ulong )((uint)uVar12 * 4) + (long)puVar13 ) <= param_3) {
      ...
      if (uVar12 == 0) {
         ...
         do {
            puVar11 = puVar13 + 2;
            iVar10 = tt_sbit_decoder_load_image(param_1, *puVar13 << 8 | *puVar13 >> 8, (char)puVar13[1] + param_4, *(char*)( (long)puVar13 + 3 ) + param_5, param_6 + 1, 0);
            if (iVar10 != 0) break;
            puVar13 = puVar11;
         }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void premultiply_data(undefined8 param_1, long param_2, long param_3) {
   uint uVar1;
   ulong uVar2;
...
int write_buf(long *param_1, ulong *param_2, long *param_3, void *param_4, size_t param_5, undefined8 param_6) {
   ulong uVar1;
   int iVar2;
   long lVar3;
   long lVar4;
   ...
   LAB_0010490f:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar2;
   }
...
undefined8 pad4(undefined8 *param_1, undefined8 param_2, ulong *param_3, undefined8 param_4) {
   ...
   local_23 = 0;
   local_21 = 0;
   if (( local_30 < 0xfffffffffffffffd ) && ( ( lVar3 = ( local_30 + 3 & 0xfffffffffffffffc ) - local_30 ),lVar3 == 0 || ( iVar1 = write_buf(&local_38, param_2, &local_30, &local_23, lVar3, param_4) ),iVar1 == 0 )) {
      *param_1 = local_38;
      *param_3 = local_30;
      uVar2 = 0;
   }
...
ulong tt_face_colr_blend_layer(long param_1, uint param_2, long param_3, long param_4) {
   ...
   if (lVar6 == 0) {
      ...
      *(undefined8*)( param_3 + 0x98 ) = uVar3;
      ...
      if (( iVar20 < iVar10 || ( iVar28 < local_80 || iVar27 < iVar12 ) ) || ( iVar26 < iVar24 )) {
         ...
         uVar14 = 0;
         pvVar8 = (void*)( (long)(int)( ( iVar5 - *(int*)( param_3 + 0xc4 ) ) * uVar13 ) + (long)( ( *(int*)( param_3 + 0xc0 ) - iVar15 ) * 4 ) + lVar6 );
   ...
   if (param_2 == 0xffff) {
      ...
      if (*(byte*)( param_1 + 0x450 ) == 0) {
         if (*(long*)( param_1 + 0x428 ) == 0) {
            ...
            uVar18 = 0xff;
            uVar19 = *(ushort*)( *(long*)( param_1 + 0x428 ) + ( ulong ) * (ushort*)( param_1 + 0x440 ) * 2 ) & 2;
            bVar9 = -(uVar19 != 0);
            if (uVar19 != 0) {
               uVar14 = 0xff;
            }
      ...
      do {
         ...
         if (*(int*)( param_4 + 0x9c ) != 0) {
            do {
               ...
               *puVar21 = ( ( ( ( ( uint ) * (byte*)( lVar6 + ( ulong )(iVar12 + 3) ) * iVar22 ) / 0xff + uVar11 / 0xff & 0xff ) << 8 | ( (uint)bVar9 * ( uVar11 / 0xff ) ) / 0xff + ( ( uint ) * (byte*)( lVar6 + ( ulong )(iVar12 + 2) ) * iVar22 ) / 0xff & 0xff ) << 8 | ( ( uint ) * (byte*)( lVar6 + ( ulong )(iVar12 + 1) ) * iVar22 ) / 0xff + ( uVar17 * ( uVar11 / 0xff ) ) / 0xff & 0xff ) << 8 | ( ( uint )(byte) * puVar21 * iVar22 ) / 0xff + ( ( uVar11 / 0xff ) * uVar14 ) / 0xff & 0xff;
            }
 ...
 while ( uVar13 < *(uint*)( param_4 + 0x98 ) );
   ...
   uVar7 = 0;
   LAB_00104e14:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
int tt_face_load_colr(long param_1, undefined8 param_2) {
   ...
   if (local_54 == 0) {
      ...
      if (( local_48 < 0xe ) || ( local_54 = FT_Stream_ExtractFrame(param_2, local_48, &local_50) ),puVar5 = local_50,local_54 != 0) goto LAB_00104ff6;
      ...
      if (local_54 == 0) {
         ...
         *puVar9 = uVar6;
         if (uVar6 < 2) {
            ...
            puVar9[1] = uVar6;
            uVar3 = *(uint*)( puVar5 + 2 );
            uVar18 = ( ulong )(uVar3 >> 0x18 | ( uVar3 & 0xff0000 ) >> 8 | ( uVar3 & 0xff00 ) << 8 | uVar3 << 0x18);
            if (( local_48 <= uVar18 ) || ( local_48 - uVar18 < ( ulong )(( (uint)uVar6 + (uint)uVar6 * 2 ) * 2) )) goto LAB_001051b0;
            uVar3 = *(uint*)( puVar5 + 4 );
            uVar10 = ( ulong )(uVar3 >> 0x18 | ( uVar3 & 0xff0000 ) >> 8 | ( uVar3 & 0xff00 ) << 8 | uVar3 << 0x18);
            uVar6 = puVar5[6] << 8 | puVar5[6] >> 8;
            puVar9[2] = uVar6;
            if (( local_48 <= uVar10 ) || ( local_48 - uVar10 < ( ulong )((uint)uVar6 * 4) )) goto LAB_001051b0;
            iVar7 = local_54;
            if (uVar2 != 0x100) goto LAB_00105144;
            if (local_48 < 0x22) goto LAB_001051b0;
            uVar3 = *(uint*)( puVar5 + 7 );
            uVar11 = ( ulong )(uVar3 >> 0x18 | ( uVar3 & 0xff0000 ) >> 8 | ( uVar3 & 0xff00 ) << 8 | uVar3 << 0x18);
            if (local_48 - 4 <= uVar11) goto LAB_001051b0;
            puVar1 = (uint*)( (long)local_50 + uVar11 );
            uVar3 = *puVar1;
            uVar13 = ( ulong )(uVar3 >> 0x18 | ( uVar3 & 0xff0000 ) >> 8 | ( uVar3 & 0xff00 ) << 8 | uVar3 << 0x18);
            uVar14 = uVar13 * 6;
            ...
            *(uint**)( puVar9 + 0x10 ) = puVar1;
            ...
            puVar16 = (uint*)0x0;
            puVar15 = (uint*)( uVar14 + (long)puVar1 );
            LAB_001052ae:*(ulong*)( puVar9 + 0x14 ) = uVar13;
            ...
            *(undefined1(*) [16])( puVar9 + 0x38 ) = (undefined1[16])0x0;
            ...
            if (uVar11 < local_48) {
               ...
               uVar14 = ( ulong )(uVar3 >> 0x18 | ( uVar3 & 0xff0000 ) >> 8 | ( uVar3 & 0xff00 ) << 8 | uVar3 << 0x18);
               if (uVar14 < local_48) {
                  if (uVar14 == 0) goto LAB_00105144;
                  if (( *(long*)( param_1 + 0x4c0 ) == 0 ) && ( iVar7 = iVar7 != 0 )) goto LAB_001051b0;
                  local_54 = ( **(code**)( lVar12 + 0x68 ) )(param_1, lVar8 + uVar14, puVar9 + 0x24);
                  if (local_54 == 0) {
                     iVar7 = 0;
                     if (( puVar9[0x2c] != 0 ) && ( uVar11 != 0 )) {
                        local_54 = ( **(code**)( lVar12 + 0x60 ) )(param_1, lVar8 + uVar11, puVar9 + 0x34, puVar9 + 0x24);
                        if (local_54 != 0) {
                           lVar12 = *(long*)( param_1 + 0x380 );
                           goto LAB_001051c1;
                        }
            ...
            LAB_001051b0:lVar12 = *(long*)( param_1 + 0x380 );
         }

         LAB_001051c1:( **(code**)( lVar12 + 0x80 ) )(param_1, puVar9 + 0x34);
      ...
      LAB_00104ff6:puVar9 = (ushort*)0x0;
   }

   FT_Stream_ReleaseFrame(param_2, &local_50);
   ft_mem_free(uVar4, puVar9);
   iVar17 = local_54;
   LAB_00105014:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
ulong tt_face_load_cpal(long param_1, undefined8 param_2) {
            ...
            *puVar9 = uVar13;
            if (uVar13 < 2) {
               ...
               *(ushort*)( param_1 + 0x418 ) = uVar14;
               ...
               puVar9[1] = uVar18;
               uVar4 = *(uint*)( puVar8 + 4 );
               uVar12 = ( ulong )(uVar4 >> 0x18 | ( uVar4 & 0xff0000 ) >> 8 | ( uVar4 & 0xff00 ) << 8 | uVar4 << 0x18);
               if (( ( ( uVar19 <= local_48 ) && ( uVar12 < local_48 ) ) && ( ( ulong )((uint)uVar18 * 4) <= local_48 - uVar12 ) ) && ( uVar13 <= uVar18 )) {
                  ...
                  *(ulong*)( puVar9 + 4 ) = uVar12 + (long)local_50;
                  if (uVar3 == 0x100) {
                     ...
                     uVar12 = ( ulong )(uVar4 >> 0x18 | ( uVar4 & 0xff0000 ) >> 8 | ( uVar4 & 0xff00 ) << 8 | uVar4 << 0x18);
                     if (uVar12 != 0) {
                        if (( local_48 <= uVar12 ) || ( local_48 - uVar12 < ( ulong )(uVar19 - 0xc) )) goto LAB_0010555a;
                     ...
                     uVar12 = ( ulong )(uVar5 >> 0x18 | ( uVar5 & 0xff0000 ) >> 8 | ( uVar5 & 0xff00 ) << 8 | uVar5 << 0x18);
                     if (uVar12 != 0) {
                        if (( local_48 <= uVar12 ) || ( local_48 - uVar12 < ( ulong )(( uint ) * (ushort*)( param_1 + 0x418 ) * 2) )) goto LAB_0010555a;
                        puVar10 = (undefined2*)ft_mem_qrealloc(uVar7, 2, 0, ( uint ) * (ushort*)( param_1 + 0x418 ), 0, &local_54);
                        if (local_54 != 0) goto LAB_00105562;
                        uVar3 = *(ushort*)( param_1 + 0x418 );
                     ...
                     uVar12 = ( ulong )(uVar6 >> 0x18 | ( uVar6 & 0xff0000 ) >> 8 | ( uVar6 & 0xff00 ) << 8 | uVar6 << 0x18);
                     if (uVar12 == 0) {
                        uVar13 = *(ushort*)( param_1 + 0x430 );
                     }
 else {
                        if (( local_48 <= uVar12 ) || ( local_48 - uVar12 < ( ulong )(( uint ) * (ushort*)( param_1 + 0x430 ) * 2) )) goto LAB_0010555a;
                        puVar10 = (undefined2*)ft_mem_qrealloc(uVar7, 2, 0, ( uint ) * (ushort*)( param_1 + 0x430 ), 0, &local_54);
                        if (local_54 != 0) goto LAB_00105562;
   ...
   LAB_00105562:FT_Stream_ReleaseFrame(param_2, &local_50);
   ft_mem_free(uVar7, puVar9);
   uVar12 = (ulong)local_54;
   *(undefined8*)( param_1 + 0x5b8 ) = 0;
   LAB_00105587:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar12;
   }
...
int tt_face_load_strike_metrics(long param_1, ulong param_2, ushort *param_3) {
   ...
   *(long*)( param_3 + 0x18 ) = (long)(int)( ( (int)*(char*)( lVar14 + 0x16 ) + ( uint ) * (byte*)( lVar14 + 0x12 ) + (int)*(char*)( lVar14 + 0x17 ) ) * 0x40 );
...
int tt_face_load_gasp(long param_1, long param_2) {
 ...
 while ( puVar7 != puVar4 + uVar5 * 2 );
   ...
   LAB_00105d27:ft_mem_free(uVar1, puVar4);
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return local_44;
   }
...
int tt_face_load_sbit(long param_1, undefined8 param_2) {
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   for (int i = 0; i < 3; i++) {
      *(undefined8*)( param_1 + ( 8*i + 1328 ) ) = 0;
   }

   iVar3 = ( **(code**)( param_1 + 0x340 ) )(param_1, 0x43424c43, param_2, &local_50);
   if (iVar3 == 0) {
      uVar5 = 2;
      LAB_00105fa5:*(undefined4*)( param_1 + 0x540 ) = uVar5;
      if (local_50 < 8) goto LAB_00105f3e;
      LAB_00105fb3:uVar7 = FT_Stream_Pos(param_2);
      uVar4 = *(uint*)( param_1 + 0x540 );
      if (2 < uVar4) {
         if (uVar4 != 3) {
            *(undefined1(*) [16])( param_1 + 0x5a8 ) = (undefined1[16])0x0;
            LAB_0010619a:iVar3 = ( **(code**)( param_1 + 0x340 ) )(param_1, 0x43424454, param_2, &local_48);
            if (( ( iVar3 == 0 ) || ( iVar3 = ( **(code**)( param_1 + 0x340 ) )(param_1, 0x45424454, param_2, &local_48) ),iVar3 == 0 )) {
            ...
            LAB_00106279:if (local_50 == 0) goto LAB_0010620b;
            goto LAB_00106215;
         }
         ...
         if (sVar1 == 0) {
            ...
            LAB_00106175:puVar6 = *(uint**)( param_1 + 0x530 );
         }
      ...
      if (uVar4 == 0) {
         *(undefined1(*) [16])( param_1 + 0x5a8 ) = (undefined1[16])0x0;
         LAB_0010620b:*(undefined4*)( param_1 + 0x544 ) = 0;
         LAB_00106215:iVar3 = 0;
         goto LAB_00105f77;
      }
      ...
      *(ulong*)( param_1 + 0x538 ) = local_50;
      ...
      if (uVar11 == 0x20000) {
         ...
         if (( ( uVar4 >> 0x18 | ( uVar4 & 0xff0000 ) >> 8 & 0xfeff ) == 0x200 ) || ( uVar11 == 0x30000 )) {
            ...
            LAB_0010622c:if (local_50 < (ulong)uVar9 * 0x30 + 8) {
               uVar9 = ( uint )(( local_50 - 8 ) / 0x30);
            }

            *(uint*)( param_1 + 0x544 ) = uVar9;
            iVar3 = *(int*)( param_1 + 0x540 );
            LAB_0010624f:*(undefined1(*) [16])( param_1 + 0x5a8 ) = (undefined1[16])0x0;
            if (iVar3 == 3) {
               *(undefined8*)( param_1 + 0x5a8 ) = uVar7;
      ...
      LAB_00105f57:FT_Stream_ReleaseFrame(param_2, param_1 + 0x530);
   }
 else {
      iVar3 = ( **(code**)( param_1 + 0x340 ) )(param_1, 0x45424c43, param_2, &local_50);
      if (( iVar3 != 0 ) && ( iVar3 = ( **(code**)( param_1 + 0x340 ) )(param_1, 0x626c6f63, param_2, &local_50) ),iVar3 != 0) {
      ...
      *(undefined4*)( param_1 + 0x540 ) = 1;
      ...
      LAB_00105f3e:puVar6 = *(uint**)( param_1 + 0x530 );
      iVar3 = 3;
      LAB_00105f4b:if (puVar6 != (uint*)0x0) goto LAB_00105f57;
   }

   *(undefined8*)( param_1 + 0x538 ) = 0;
   *(undefined4*)( param_1 + 0x540 ) = 0;
   LAB_00105f77:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
int tt_face_load_name(long param_1, long param_2) {
            ...
            if (local_4c == 0) {
               ...
               *(uint*)( param_1 + 0x250 ) = (uint)uVar2;
               if (local_4c == 0) {
                  ...
                  if (( local_4c != 0 ) || ( local_4c = FT_Stream_EnterFrame(param_2, *(int*)( param_1 + 0x250 ) * 4) ),local_4c != 0) {
                     lVar6 = 0;
                     goto LAB_001063d4;
                  }
                  ...
                  local_4c = 0;
                  if (( puVar7 != (ushort*)0x0 ) && ( uVar3 = *(uint*)( param_1 + 0x250 ) ),puVar7 < puVar7 + (ulong)uVar3 * 0xc) {
                     local_4c = 0;
                     puVar11 = puVar7;
                     do {
 ...
 while ( puVar11 < puVar7 + (ulong)uVar3 * 0xc );
            ...
            LAB_00106480:lVar6 = ft_mem_qrealloc(uVar1, 0x20, 0, iVar12, 0, &local_4c);
            if (( local_4c != 0 ) || ( local_4c = FT_Stream_EnterFrame(param_2, *(int*)( param_1 + 0x23c ) * 0xc) ),local_4c != 0) {
               puVar7 = (ushort*)0x0;
               goto LAB_001063d4;
            }
               ...
               do {
                  ...
                  if (( local_4c == 0 ) && ( *(ushort*)( lVar10 + 8 ) != 0 )) {
                     ...
                     *(ulong*)( lVar10 + 0x10 ) = uVar8;
                     if (( ( uVar14 <= uVar8 ) && ( *(ushort*)( lVar10 + 8 ) + uVar8 <= uVar5 ) ) && ( ( ( *(short*)( param_1 + 0x238 ) != 1 || ( -1 < (short)*(ushort*)( lVar10 + 4 ) ) ) || ( ( uVar3 = *(ushort*)( lVar10 + 4 ) - 0x8000 ),uVar3 < *(uint*)( param_1 + 0x250 ) && ( *(short*)( *(long*)( param_1 + 600 ) + (ulong)uVar3 * 0x18 ) != 0 ) ) ) )) {
                        local_5c = local_5c + 1;
 ...
 while ( iVar12 != 0 );
   ...
   puVar7 = (ushort*)0x0;
   lVar6 = 0;
   LAB_001063d4:ft_mem_free(uVar1, lVar6);
   ...
   if (iVar1 == 0) {
      ...
      if (iVar2 == 0) {
         ...
         *(undefined1(*) [16])( param_1 + 0x1d2 ) = (undefined1[16])0x0;
         if (( 0xffff < *(long*)( param_1 + 0x1c8 ) ) && ( iVar1 = FT_Stream_ReadFields(param_2, maxp_fields_extra_6, param_1 + 0x1c8) ),iVar1 == 0) {
...
int Load_SBit_Png(long param_1, uint param_2, uint param_3, int param_4, ushort *param_5, undefined8 param_6, undefined8 param_7, undefined4 param_8, char param_9, char param_10) {
   int iVar1;
   __jmp_buf_tag *__env;
   long lVar2;
   long lVar3;
         ...
         if (param_9 == '\0') {
            ...
            *(ulong*)( param_1 + 0x98 ) = CONCAT44(local_94, local_90);
            ...
            if (param_10 == '\0') {
               ...
               if (( param_9 == '\0' ) || ( local_98 = ft_glyphslot_alloc_bitmap(param_1, ( ulong ) * (uint*)( param_1 + 0x98 ) * (long)*(int*)( param_1 + 0xa0 )) ),local_98 == 0) {
 ...
 while ( lVar3 != (ulong)local_90 * 8 );
   ...
   iVar1 = local_98;
   LAB_00106a69:if (local_10 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 tt_sbit_decoder_load_png(long *param_1, uint *param_2, long param_3, undefined4 param_4, undefined4 param_5) {
   undefined8 uVar1;
   uint uVar2;
   if (3 < param_3 - (long)param_2) {
      ...
      if ((ulong)uVar2 <= ( ulong )(param_3 - (long)( param_2 + 1 ))) {
         uVar1 = Load_SBit_Png(*(undefined8*)( *param_1 + 0x98 ), param_4, param_5, *(undefined1*)( (long)param_1 + 0x22 ), param_1[3], *(undefined8*)( param_1[1] + 0x38 ), param_2 + 1, uVar2, 0, 0);
         return uVar1;
      }
...
int ReadBase128(undefined8 param_1, ulong *param_2) {
 ...
 while ( iVar4 != 5 );
   iVar2 = 8;
   LAB_00106f58:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar2;
   }
...
int Read255UShort(undefined8 param_1, ushort *param_2) {
   ...
   *param_2 = uVar2;
   LAB_00106fde:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
 ...
 while ( puVar10 != puVar13 );
   ...
   do {
      ...
      if (uVar7 != 0) {
         uVar5 = puVar13[2];
         uVar6 = puVar13[3];
         if (( 1 < *(uint*)( param_2 + 0xd8 ) ) && ( ( uVar11 = *puVar13 << 8 | *puVar13 >> 8 ),0xff < uVar11 || ( 0x100 - uVar11 < (uint)uVar7 ) )) {
            ft_validator_error(param_2, 8);
         }
         ...
         if (uVar6 != 0) {
            ...
            if (( *(int*)( param_2 + 0xd8 ) != 0 ) && ( puVar9 = (ushort*)( ( ulong )((uint)uVar7 + (uint)uVar7) + (long)puVar10 ) ),puVar10 < puVar9) {
               do {
                  while (true) {
                     uVar7 = *puVar10;
                     ...
                     if (( uVar7 == 0 ) || ( ( (uint)uVar7 + (int)(short)( uVar5 << 8 | uVar5 >> 8 ) & 0xffff ) < *(uint*)( param_2 + 0xe0 ) )) break;
                     ft_validator_error(param_2, 0x10);
...
;
 ...
 while ( puVar10 < puVar9 );
               LAB_0010733c:puVar10 = (ushort*)( (long)puVar13 + ( ( ulong )((long)puVar9 + ( -9 - (long)puVar13 )) & 0xfffffffffffffffe ) + 10 );
            }
...
/* WARNING: Removing unreachable block (ram,0x001077cb) */uint tt_cmap4_validate(long param_1, long param_2) {
   undefined1 *puVar1;
   undefined1 *puVar2;
   long lVar3;
   undefined1 *puVar4;
   ...
   ft_validator_error(param_2, 8);
   LAB_00107444:if (1 < *(uint*)( param_2 + 0xd8 )) {
      ...
      if (( ( ( local_40 < uVar19 ) || ( ( uVar11 & 0xfffffffe ) < local_40 ) ) || ( ( uVar16 >> 1 ) + uVar19 != local_40 ) ) || ( 1 << ( ( byte )((ushort)uVar9 >> 8) & 0x1f ) != uVar19 )) {
         ft_validator_error(param_2, 8);
      }
   ...
   if (( 1 < *(uint*)( param_2 + 0xd8 ) ) && ( *(short*)( param_1 + 0xe + ( ulong )(local_40 * 2 - 2) ) != -1 )) {
      ft_validator_error(param_2, 8);
   }
...
;
         if (uVar10 == 0xffff) {
            if (( ( 1 < *(uint*)( param_2 + 0xd8 ) ) || ( local_40 - 1 != iVar17 ) ) || ( ( uVar11 & uVar16 ) != 0xffff )) {
               ft_validator_error(param_2, 8);
            }
         ...
         if (*(int*)( param_2 + 0xd8 ) == 0) {
            if (( local_40 - 1 != iVar17 ) || ( ( uVar16 & uVar11 ) != 0xffff )) {
               if (( puVar15 < puVar2 ) || ( *(undefined1**)( param_2 + 0xd0 ) < puVar15 + ( ( uVar20 - uVar22 ) * 2 + 2 ) )) goto LAB_001075a2;
         ...
         if (( puVar15 < puVar2 ) || ( (undefined1*)( (ulong)local_68 + param_1 ) < puVar15 + ( ( uVar20 - uVar22 ) * 2 + 2 ) )) {
            LAB_001075a2:ft_validator_error(param_2, 8);
         }

         if (*(int*)( param_2 + 0xd8 ) == 0) goto LAB_001075d8;
         LAB_001076f8:if (uVar20 <= uVar22) goto LAB_001075d8;
         ...
         do {
            while (true) {
               ...
               puVar1 = puVar15 + 1;
               puVar15 = puVar15 + 2;
               if (( CONCAT11(uVar7, *puVar1) == 0 ) || ( ( (uint)CONCAT11(uVar7, *puVar1) + (int)CONCAT11(uVar5, uVar6) & 0xffff ) < *(uint*)( param_2 + 0xe0 ) )) break;
               ft_validator_error(param_2, 0x10);
...
undefined8 tt_cmap6_validate(long param_1, long param_2) {
   ...
   if (( *(ulong*)( param_2 + 0xd0 ) < (ulong)uVar4 + param_1 ) || ( (uint)uVar4 < uVar6 + 10 + (uint)uVar6 )) {
      ft_validator_error(param_2, 8);
   }
   ...
   if (( *(int*)( param_2 + 0xd8 ) != 0 ) && ( uVar6 != 0 )) {
      ...
      do {
         while (uVar3 = *puVar5,puVar1 = puVar5 + 1,puVar5 = puVar5 + 2,*(uint*)( param_2 + 0xe0 ) <= (uint)CONCAT11(uVar3, *puVar1)) {
            ft_validator_error(param_2, 0x10);
            if (puVar2 == puVar5) {
               return 0;
            }
...
undefined8 tt_cmap8_validate(long param_1, long param_2) {
   ...
   do {
      ...
      if (*(int*)( param_2 + 0xd8 ) != 0) {
         uVar2 = uVar3 - uVar4;
         if (( *(uint*)( param_2 + 0xe0 ) < uVar2 ) || ( ( *(uint*)( param_2 + 0xe0 ) + uVar4 ) - uVar3 <= ( uVar1 >> 0x18 | ( uVar1 & 0xff0000 ) >> 8 | ( uVar1 & 0xff00 ) << 8 | uVar1 << 0x18 ) )) {
            ft_validator_error(param_2, 0x10);
         }
         ...
         if (uVar4 < 0x10000) {
            ...
            if (uVar2 != 0xffffffff) {
               do {
                  if (( ( uint ) * (byte*)( param_1 + ( ulong )(uVar4 >> 3 & 0x1fff) ) & 0x80 >> ( (byte)uVar4 & 7 ) ) != 0) {
                     ft_validator_error(param_2, 8);
                  }
 ...
 while ( bVar7 );
            ...
            do {
               if (( ( uint ) * (byte*)( param_1 + ( ulong )(uVar4 >> 0x13) ) & 0x80 >> ( ( byte )(uVar4 >> 0x10) & 7 ) ) == 0) {
                  ft_validator_error(param_2, 8);
               }
...
undefined8 tt_cmap12_validate(long param_1, long param_2) {
   ...
   do {
      ...
      if (( *(int*)( param_2 + 0xd8 ) != 0 ) && ( ( *(uint*)( param_2 + 0xe0 ) < uVar4 - uVar6 || ( ( *(uint*)( param_2 + 0xe0 ) + uVar6 ) - uVar4 <= ( uVar2 >> 0x18 | ( uVar2 & 0xff0000 ) >> 8 | ( uVar2 & 0xff00 ) << 8 | uVar2 << 0x18 ) ) ) )) {
         ft_validator_error(param_2, 0x10);
      }
...
undefined8 tt_cmap13_validate(long param_1, long param_2) {
   ...
   do {
      while (true) {
         ...
         uVar7 = uVar2;
         if (( *(int*)( param_2 + 0xd8 ) == 0 ) || ( ( uVar1 >> 0x18 | ( uVar1 & 0xff0000 ) >> 8 | ( uVar1 & 0xff00 ) << 8 | uVar1 << 0x18 ) < *(uint*)( param_2 + 0xe0 ) )) break;
         uVar5 = uVar5 + 1;
         ft_validator_error(param_2, 0x10);
         puVar4 = puVar4 + 3;
         if (uVar6 <= uVar5) {
...
undefined8 tt_cmap14_validate(long param_1, long param_2) {
   ...
   do {
      ...
      if (uVar12 != 0) {
         ...
         do {
            while (true) {
               uVar9 = (uint)(byte)puVar3[uVar12 + 1] << 0x10 | ( uint ) * (byte*)( (long)puVar3 + uVar12 * 4 + 5 ) << 8 | ( uint ) * (byte*)( (long)puVar3 + uVar12 * 4 + 6 );
               uVar2 = *(byte*)( (long)puVar3 + uVar12 * 4 + 7 ) + uVar9;
               if (uVar2 < 0x110000) break;
               ft_validator_error(param_2, 8);
               if (uVar5 <= uVar9) goto LAB_001083b5;
               LAB_00108408:uVar12 = uVar12 + 1;
               uVar5 = uVar2 + 1;
               ft_validator_error(param_2, 8);
...
;
            ...
            LAB_001083b5:uVar12 = uVar12 + 1;
            uVar5 = uVar2 + 1;
         }
 while ( uVar12 < uVar6 );
      }

      joined_r0x001082a9:if (uVar10 != 0) {
         ...
         do {
            while (true) {
               ...
               uVar2 = ( uint )(byte) * puVar3 << 0x10 | ( uint ) * (byte*)( (long)puVar3 + 1 ) << 8 | ( uint ) * (byte*)( (long)puVar3 + 2 );
               if (0x10ffff < uVar2) {
                  ft_validator_error(param_2, 8);
               }
               ...
               uVar5 = uVar2 + 1;
               if (( *(int*)( param_2 + 0xd8 ) == 0 ) || ( ( uint )(ushort)(uVar1 << 8 | uVar1 >> 8) < *(uint*)( param_2 + 0xe0 ) )) break;
               uVar10 = uVar10 + 1;
               ft_validator_error(param_2, 0x10);
...
undefined8 tt_face_get_ps_name_part_0(long param_1, ulong param_2, undefined8 *param_3) {
   ...
   *param_3 = uVar7;
   if (lVar8 == 0x10000) {
      ...
      LAB_0010884c:uVar7 = ( **(code**)( lVar2 + 0x20 ) )(param_2);
      *param_3 = uVar7;
   }
      ...
      if (*(char*)( param_1 + 0x400 ) == '\0') {
         ...
         if (local_48 < 0x22) {
            LAB_00108899:*(undefined1*)( param_1 + 0x400 ) = 1;
            goto LAB_00108809;
         }
            ...
            if (local_50 == 0) {
               ...
               if (lVar8 == 0x20000) {
                  ...
                  if (local_4c == 0) {
                     ...
                     uVar5 = 0;
                     do {
                        uVar4 = CONCAT11(*(undefined1*)( lVar10 + uVar13 ), *(undefined1*)( lVar10 + 1 + uVar13 ));
 ...
 while ( uVar13 != uVar11 * 2 );
                     ...
                     uVar5 = uVar5 - 0x101;
                     if (uVar5 == 0) {
                        LAB_00108af0:*(ushort*)( param_1 + 0x402 ) = uVar1;
...
;
 ...
 while ( (ushort)uVar6 < uVar5 );
                     ...
                     LAB_00108b1c:lVar10 = 0;
                  }

                  LAB_00108b1f:ft_mem_free(uVar7, lVar10);
                  ft_mem_free(uVar7, lVar8);
               }
 else if (( uVar1 < 0x183 ) && ( uVar11 <= uVar15 )) {
                  lVar8 = ft_mem_qrealloc(uVar7, 2, 0, uVar11, 0, &local_4c);
                  if (( local_4c == 0 ) && ( local_4c = local_4c == 0 )) {
                     lVar10 = *(long*)( lVar3 + 0x40 );
                     lVar9 = 0;
                     do {
 ...
 while ( (ushort)lVar9 < uVar1 );
         ...
         LAB_001089e0:*(undefined1*)( param_1 + 0x400 ) = 1;
      }
 else {
         LAB_00108809:if ((uint)param_2 < ( uint ) * (ushort*)( param_1 + 0x402 )) {
   ...
   LAB_001087d3:uVar7 = 0;
   LAB_001087d5:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
ulong tt_face_load_post(long param_1, undefined8 param_2) {
   ...
   if ((int)uVar2 == 0) {
      ...
      if (( (int)uVar2 == 0 ) && ( uVar1 = *(ulong*)( param_1 + 0x2f0 ) ),uVar1 != 0x25000 && uVar1 != 0x20000) {
...
ulong read_data_from_FT_Stream(long param_1, void *param_2, size_t param_3) {
   ...
   *puVar10 = 0x54;
   ...
   if (uStack_b0 == 0x4f54544f) {
      uVar20 = uStack_a8;
      if (uStack_a8 != 0) {
         LAB_00108fb1:*(ushort*)( lVar16 + 0x120 ) = uVar20;
 ...
 while ( bVar21 );
   ...
   uVar9 = 2;
   LAB_00108f41:if (lStack_68 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
ulong tt_face_load_font_dir(long param_1, long param_2) {
   ...
   if (local_88 == 0x4f54544f) {
      uVar16 = local_80;
      if (local_80 != 0) {
         LAB_00108fb1:*(ushort*)( param_1 + 0x120 ) = uVar16;
 ...
 while ( bVar17 );
   ...
   uVar7 = 2;
   LAB_00108f41:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
int tt_face_load_sbit_image(long param_1, long param_2, uint param_3, ulong param_4, long param_5, long param_6, short *param_7) {
   uint *puVar1;
   ushort uVar2;
   undefined8 uVar3;
   short sVar4;
   ...
   if (uVar8 < 3) {
         ...
         if (*(long*)( param_1 + 0x5b0 ) != 0) {
            ...
            if (iVar7 == 0) {
               ...
               if (lVar11 + 0x37U <= uVar12) {
                  ...
                  uVar8 = *puVar1;
                  local_60 = ( ulong )(uVar8 >> 0x18 | ( uVar8 & 0xff0000 ) >> 8 | ( uVar8 & 0xff00 ) << 8 | uVar8 << 0x18);
                  uVar8 = puVar1[2];
                  local_58 = ( ulong )(uVar8 >> 0x18 | ( uVar8 & 0xff0000 ) >> 8 | ( uVar8 & 0xff00 ) << 8 | uVar8 << 0x18);
                  local_76 = *(undefined1*)( (long)puVar1 + 0x2e );
                  if (( local_60 <= uVar12 ) && ( local_58 <= uVar12 - local_60 >> 3 )) {
                     iVar7 = tt_sbit_decoder_load_image(&local_98, param_3, 0, 0, 0, ( uint )(( param_4 & 0xffffffff ) >> 0x16) & 1);
                     if (iVar7 == 0) {
                        LAB_001096ab:iVar7 = 0;
      ...
      if (param_3 <= *(uint*)( param_1 + 0x20 )) {
         ...
         do {
            ...
            iVar7 = FT_Stream_Seek(param_5, uVar12 + 4 + *(long*)( param_1 + 0x5a8 ) + ( ulong )(param_3 * 4));
            ...
            uVar8 = FT_Stream_GetULong(param_5);
            if (uVar8 == 0x706e6720) {
               iVar7 = Load_SBit_Png(*(undefined8*)( param_1 + 0x98 ), 0, 0, 0x20, param_7, *(undefined8*)( param_5 + 0x38 ), *(undefined8*)( param_5 + 0x40 ), uVar10 - 8, 1, ( uint )(( param_4 & 0xffffffff ) >> 0x16) & 1);
               FT_Stream_ExitFrame(param_5);
               if (iVar7 != 0) goto LAB_00109550;
            ...
            if (0x706e6720 < uVar8) {
               if (( uVar8 != 0x7267626c ) && ( uVar8 != 0x74696666 )) {
                  LAB_0010974e:FT_Stream_ExitFrame(param_5);
                  iVar7 = 7;
                  goto LAB_00109550;
               }

               LAB_0010971f:FT_Stream_ExitFrame(param_5);
               goto LAB_00109730;
            }
 ...
 while ( (uint)uVar6 <= *(uint*)( param_1 + 0x20 ) );
   ...
   LAB_00109730:iVar7 = 2;
   LAB_00109550:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar7;
   }
...
void tt_face_build_cmaps_isra_0(long param_1) {
   ...
   if (( lVar2 != 0 ) && ( 3 < *(ulong*)( param_1 + 0x338 ) )) {
      ...
      while (( uVar5 != 0 && ( puVar4 + 8 <= puVar1 ) )) {
         ...
         uVar6 = (uint)(byte)puVar4[4] << 0x18 | (uint)(byte)puVar4[5] << 0x10 | (uint)(byte)puVar4[7] | (uint)(byte)puVar4[6] << 8;
         local_108 = param_1;
         if (( uVar6 != 0 ) && ( (ulong)uVar6 <= *(long*)( param_1 + 0x338 ) - 2U )) {
            ...
            while (puVar3 != (undefined*)0x0) {
               ...
               if (*(uint*)( puVar3 + 0x50 ) == (uint)CONCAT11(*puVar8, puVar8[1])) {
                  ...
                  if (( local_1c == 0 ) && ( iVar7 = FT_CMap_New(puVar3, puVar8, &local_108, &local_110) ),iVar7 == 0) {
...
char *get_apple_string_isra_0(undefined8 param_1, long param_2, long param_3, code *param_4) {
 ...
 while ( pcVar4 != pcVar3 );
   ...
   pcVar2 = (char*)0x0;
   LAB_00109cd1:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return pcVar2;
   }
...
char *get_win_string_isra_0(undefined8 param_1, long param_2, long param_3, code *param_4) {
 ...
 while ( pcVar5 != pcVar1 );
   ...
   pcVar4 = (char*)0x0;
   LAB_00109e2b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return pcVar4;
   }
...
char *sfnt_get_ps_name(long param_1) {
   ...
   if (( *(long*)( param_1 + 0x4c0 ) == 0 ) || ( ( ( *(ulong*)( param_1 + 8 ) & 0x7fff0000 ) == 0 && ( ( *(byte*)( param_1 + 0x11 ) & 0x80 ) == 0 ) ) )) {
      cVar1 = sfnt_get_name_id(param_1, 6, &local_68, &local_60);
      if (cVar1 == '\0') goto LAB_00109ece;
      if (( ( (int)local_68 == -1 ) || ( pcVar7 = (char*)get_win_string_isra_0(*(undefined8*)( param_1 + 0xb8 ), *(undefined8*)( param_1 + 0x260 ), (long)(int)local_68 * 0x20 + *(long*)( param_1 + 0x248 ), sfnt_is_postscript) ),pcVar7 == (char*)0x0 )) {
         pcVar7 = (char*)get_apple_string_isra_0(*(undefined8*)( param_1 + 0xb8 ), *(undefined8*)( param_1 + 0x260 ), (long)local_60 * 0x20 + *(long*)( param_1 + 0x248 ), sfnt_is_postscript);
      }
      ...
      if (*(long*)( param_1 + 0x4d0 ) == 0) {
         ...
         if (( ( ( cVar1 == '\0' ) && ( cVar1 = sfnt_get_name_id(param_1, 0x10, piVar27) ),cVar1 == '\0' ) ) && ( cVar1 = sfnt_get_name_id(param_1, 1, piVar27) ),cVar1 == '\0') ( ( ( local_80 == -1 || ( pcVar10 = (char*)get_win_string_isra_0(uVar13, *(undefined8*)( param_1 + 0x260 ), (long)local_80 * 0x20 + *(long*)( param_1 + 0x248 ), sfnt_is_alphanumeric) ),pcVar10 == (char*)0x0 ) ) && ( ( local_7c == -1 || ( pcVar10 = (char*)get_apple_string_isra_0(*(undefined8*)( param_1 + 0xb8 ), *(undefined8*)( param_1 + 0x260 ), (long)local_7c * 0x20 + *(long*)( param_1 + 0x248 ), sfnt_is_alphanumeric) ),pcVar10 == (char*)0x0 ) ) );
      ...
      if (( ( *(ulong*)( param_1 + 8 ) & 0x7fff0000 ) == 0 ) || ( ( *(byte*)( param_1 + 0x11 ) & 0x80 ) != 0 )) {
         LAB_0010a128:lVar21 = *(long*)( local_70 + 0x10 );
         pcVar10 = (char*)ft_mem_qalloc(uVar13, local_84 * 0x11 + 1 + *(int*)( param_1 + 0x4d8 ), &local_88);
...
;
                        ...
                        pbVar23 = pbVar19;
                        uVar4 = uVar2;
                        LAB_0010a2c1:cVar1 = (char)uVar5;
                        if (( (long)pbVar12 - (long)pbVar16 == 5 ) && ( (int)uVar4 < 0x542e0 )) {
                           if (cVar1 != '1') {
                              if (uVar4 == 0x2a120) {
                                 if (( uVar5 & 1 ) != 0) {
                                    LAB_0010a7bc:pbVar23[-1] = cVar1 - 1;
                                    goto LAB_0010a2f8;
                                 }
                           ...
                           LAB_0010a2d9:if (cVar1 != '0') goto LAB_0010a2f8;
                        }
 ...
 while ( pbVar23[-1] == 0x30 );
                  ...
                  LAB_0010a2f8:uVar13 = *(undefined8*)( lVar21 + 0x20 );
                  for (int i = 0; i < 3; i++) {
                     bVar17 = ( byte )((ulong)uVar13 >> ( -8*i + 24 ));
                     if (( bVar17 != 32 ) && ( ( (int)(char)bVar17 - 48 < 10 || ( ( byte )(( bVar17 & 223 ) + 191) < 26 ) ) )) {
                        *pbVar23 = bVar17;
                        uVar13 = *(undefined8*)( lVar21 + 32 );
                        pbVar23 = pbVar23 + 1;
                     }
                  ...
                  bVar17 = (byte)uVar13;
                  if (( bVar17 != 0x20 ) && ( ( (int)(char)bVar17 - 0x30U < 10 || ( ( byte )(( bVar17 & 0xdf ) + 0xbf) < 0x1a ) ) )) {
                     *pbVar23 = bVar17;
                     pbVar23 = pbVar23 + 1;
                  }
 ...
 while ( uVar3 < local_84 );
         ...
         *pbVar23 = 0;
         ...
         if (( iVar22 - 0x100U < 0x7f00 ) || ( iVar22 == 6 )) {
            ...
            LAB_0010a061:( *pcVar15 )(param_1, *(undefined2*)( lVar8 + 8 ), &local_60);
            if ((char*)CONCAT44(uStack_5c, local_60) == (char*)0x0) goto LAB_0010a128;
            sVar9 = strlen((char*)CONCAT44(uStack_5c, local_60));
            pcVar10 = (char*)ft_mem_qalloc(uVar13, ( ulong )(*(int*)( param_1 + 0x4d8 ) + 1) + 1 + sVar9, &local_88);
            if (local_88 != 0) goto LAB_00109f75;
            strcpy(pcVar10, *(char**)( param_1 + 0x4d0 ));
...
;
      ...
      if (-iVar22 == 0) {
         ...
         do {
            ...
            uVar3 = ( *(int*)pbVar16 * -0x34f28000 | ( uint )(*(int*)pbVar16 * 0x239b961b) >> 0x11 ) * -0x54f16877 ^ uVar3;
            uVar3 = ( ( uVar3 >> 0xd | uVar3 << 0x13 ) + uVar4 ) * 5 + 0x561ccd1b;
            uVar4 = ( *(int*)( pbVar16 + 4 ) * -0x68770000 | ( uint )(*(int*)( pbVar16 + 4 ) * -0x54f16877) >> 0x10 ) * 0x38b34ae5 ^ uVar4;
            uVar4 = ( ( uVar4 >> 0xf | uVar4 << 0x11 ) + uVar5 ) * 5 + 0xbcaa747;
            uVar5 = ( ( uint )(*(int*)( pbVar16 + 8 ) * 0x38b34ae5) >> 0xf | *(int*)( pbVar16 + 8 ) * -0x6a360000 ) * -0x5e1c746d ^ uVar5;
            uVar5 = ( ( uVar5 << 0xf | uVar5 >> 0x11 ) + uVar6 ) * 5 + 0x96cd1c35;
            uVar6 = ( ( uint )(*(int*)( pbVar16 + 0xc ) * -0x5e1c746d) >> 0xe | *(int*)( pbVar16 + 0xc ) * 0x2e4c0000 ) * 0x239b961b ^ uVar6;
 ...
 while ( pbVar19 != pbVar23 + ( ( ulong )(iVar22 - 1) + (long)-iVar22 ) * 0x10 + 0x10 );
      ...
      LAB_0010a55b:uVar6 = uVar6 ^ ( ( pbVar23[0xc] ^ uVar18 ) * -0x5e1c746d >> 0xe | ( pbVar23[0xc] ^ uVar18 ) * 0x2e4c0000 ) * 0x239b961b;
      switchD_0010a546_caseD_c:uVar18 = (uint)pbVar23[0xb] << 0x18;
      LAB_0010a57c:uVar18 = (uint)pbVar23[10] << 0x10 ^ uVar18;
      LAB_0010a586:uVar18 = (uint)pbVar23[9] << 8 ^ uVar18;
      LAB_0010a590:uVar5 = uVar5 ^ ( ( pbVar23[8] ^ uVar18 ) * 0x38b34ae5 >> 0xf | ( pbVar23[8] ^ uVar18 ) * -0x6a360000 ) * -0x5e1c746d;
      switchD_0010a546_caseD_8:uVar18 = (uint)pbVar23[7] << 0x18;
      LAB_0010a5b1:uVar18 = (uint)pbVar23[6] << 0x10 ^ uVar18;
      LAB_0010a5bb:uVar18 = (uint)pbVar23[5] << 8 ^ uVar18;
      LAB_0010a5c5:uVar4 = uVar4 ^ ( ( pbVar23[4] ^ uVar18 ) * -0x68770000 | ( pbVar23[4] ^ uVar18 ) * -0x54f16877 >> 0x10 ) * 0x38b34ae5;
      switchD_0010a546_caseD_4:uVar18 = (uint)pbVar23[3] << 0x18;
      LAB_0010a5e5:uVar18 = (uint)pbVar23[2] << 0x10 ^ uVar18;
      LAB_0010a5ef:uVar18 = (uint)pbVar23[1] << 8 ^ uVar18;
      LAB_0010a5f9:uVar3 = uVar3 ^ ( ( *pbVar23 ^ uVar18 ) * -0x34f28000 | ( *pbVar23 ^ uVar18 ) * 0x239b961b >> 0x11 ) * -0x54f16877;
      switchD_0010a546_caseD_0:uVar18 = ( uVar3 ^ uVar2 ) + ( uVar4 ^ uVar2 ) + ( uVar5 ^ uVar2 ) + ( uVar6 ^ uVar2 );
 ...
 while ( puVar25 != &uStack_5c );
   ...
   LAB_00109f75:*(char**)( param_1 + 0x4a0 ) = pcVar7;
...
uint sfnt_get_name_index(long param_1, char *param_2) {
   ...
   if (-1 < (long)uVar1) {
      ...
      uVar4 = 0;
      do {
         if (( ( uVar4 < *(ushort*)( param_1 + 0x1d0 ) ) && ( iVar2 = tt_face_get_ps_name_part_0(param_1, uVar4, &local_38) ),iVar2 == 0 )) goto LAB_0010aa3e;
         uVar4 = uVar4 + 1;
      }
 while ( uVar4 != uVar3 );
   }

   LAB_0010aa3c:uVar4 = 0;
   LAB_0010aa3e:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined4 tt_face_find_bdf_prop(long param_1, char *param_2, undefined4 *param_3) {
   ...
   *param_3 = 0;
   if (*(char*)( param_1 + 0x594 ) != '\0') {
      ...
      LAB_0010ad60:if (( lVar3 != 0 ) && ( param_2 != (char*)0x0 )) {
            ...
            if (*(ushort*)( lVar3 + 0x1a ) == ( ushort )(uVar14 << 8 | uVar14 >> 8)) {
               ...
               do {
                  ...
                  if (( (ushort)uVar9 & 0x1000 ) != 0) {
                     ...
                     uVar13 = ( ulong )(uVar2 >> 0x18 | ( uVar2 & 0xff0000 ) >> 8 | ( uVar2 & 0xff00 ) << 8 | uVar2 << 0x18);
...
;
   ...
   *(ulong*)( param_1 + 0x578 ) = (long)psVar6 + uVar4;
   ...
   if (( ( ( *psVar6 == 0x100 ) && ( 7 < uVar13 ) ) && ( (ulong)uVar14 <= uVar13 - 8 >> 2 ) ) && ( uVar13 + 1 <= uVar4 )) {
...
uint *tt_cmap14_variants(long param_1, undefined8 param_2) {
 ...
 while ( puVar3 + uVar7 != puVar6 );
   ...
   *puVar5 = 0;
   LAB_0010b23f:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return puVar3;
   }
...
/* WARNING: Removing unreachable block (ram,0x0010b390) */undefined4 *tt_cmap14_get_nondef_chars(long param_1, uint *param_2, undefined8 param_3) {
   uint uVar1;
   long lVar2;
   undefined4 *puVar3;
   uint *puVar4;
   ...
   if (uVar1 != 0) {
      do {
         puVar3[lVar8] = ( uint )(byte) * puVar4 << 0x10 | ( uint ) * (byte*)( (long)puVar4 + 1 ) << 8 | ( uint ) * (byte*)( (long)puVar4 + 2 );
         lVar8 = lVar8 + 1;
...
uint *tt_cmap14_get_def_chars(long param_1, uint *param_2, undefined8 param_3) {
 ...
 while ( pbVar3 != (byte*)( (long)param_2 + uVar7 * 4 + 0xb ) );
      ...
      do {
         puVar12 = puVar11 + 1;
         uVar5 = ( uint )(byte) * puVar11 << 0x10 | ( uint ) * (byte*)( (long)puVar11 + 1 ) << 8 | ( uint ) * (byte*)( (long)puVar11 + 2 );
 ...
 while ( puVar12 != param_2 + uVar7 + 2 );
   ...
   LAB_0010b463:*puVar10 = 0;
   LAB_0010b469:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
long tt_cmap14_variant_chars(long param_1, undefined8 param_2, undefined4 param_3) {
   ...
   if (puVar4 == (uint*)0x0) {
      ...
      if ((ulong)uVar8 == 0) {
         ...
         joined_r0x0010b73e:if (local_40 == lVar14) {
      ...
      if (uVar13 == 0) {
         LAB_0010b6c0:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      ...
      if (uVar3 == 0) {
         if (uVar18 != 0) {
            LAB_0010b760:lVar14 = *(long*)( in_FS_OFFSET + 0x28 );
 ...
 while ( pbVar5 != (byte*)( (long)puVar4 + ( ulong )(uVar8 - 1) * 4 + 0xb ) );
      ...
      uVar10 = (uint)(byte)puVar4[1] << 0x10 | ( uint ) * (byte*)( (long)puVar4 + 5 ) << 8 | ( uint ) * (byte*)( (long)puVar4 + 6 );
      uVar3 = uVar10 + uVar19;
      uVar11 = 1;
      uVar7 = (uint)(byte)puVar12[1] << 0x10 | ( uint ) * (byte*)( (long)puVar12 + 5 ) << 8 | ( uint ) * (byte*)( (long)puVar12 + 6 );
      iVar9 = 0;
      puVar4 = puVar4 + 2;
      while (true) {
         while (uVar7 <= uVar3) {
 ...
 while ( bVar21 );
                  ...
                  if (uVar20 < uVar8) {
                     ...
                     do {
                        ...
                        uVar3 = ( uint )(byte) * puVar12 << 0x10 | ( uint ) * (byte*)( (long)puVar12 + 1 ) << 8 | ( uint ) * (byte*)( (long)puVar12 + 2 );
                        puVar12 = (uint*)( lVar6 + (long)iVar9 * 4 );
                        iVar1 = uVar3 + 1;
                        do {
                           *puVar12 = uVar3;
...
;
 ...
 while ( bVar21 );
         ...
         uVar10 = ( uint )(byte) * puVar4 << 0x10 | ( uint ) * (byte*)( (long)puVar4 + 1 ) << 8 | ( uint ) * (byte*)( (long)puVar4 + 2 );
         uVar3 = uVar10 + uVar19;
         puVar4 = puVar4 + 1;
      }
;
 ...
 while ( pbVar16 != pbVar5 + ( ulong )(( uVar18 - 1 ) - uVar11) * 5 + 5 );
      ...
      LAB_0010b785:*(undefined4*)( lVar6 + (long)iVar9 * 4 ) = 0;
   }
   ...
   LAB_0010b8b7:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
   ...
   if (iVar3 != 0) {
      ...
      do {
         while (true) {
            ...
            pbVar12 = pbVar11 + 0xb;
            uVar7 = ( ulong )(uVar10 >> 0x18 | ( uVar10 & 0xff0000 ) >> 8 | ( uVar10 & 0xff00 ) << 8 | uVar10 << 0x18);
            uVar9 = ( ulong )(uVar1 >> 0x18 | ( uVar1 & 0xff0000 ) >> 8 | ( uVar1 & 0xff00 ) << 8 | uVar1 << 0x18);
            if (( ( uVar7 == 0 ) || ( iVar3 = tt_cmap14_char_map_def_binary(uVar7 + *(long*)( param_1 + 0x18 ), param_3) ),iVar3 == 0 )) &&( ( uVar9 == 0 || ( iVar3 = tt_cmap14_char_map_nondef_binary(*(long*)( param_1 + 0x18 ) + uVar9, param_3) ),iVar3 == 0 ) );
...
;
 ...
 while ( pbVar8 != pbVar12 );
   ...
   LAB_0010b98d:*puVar6 = 0;
   LAB_0010b993:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
int reconstruct_font(long param_1, ulong param_2, long *param_3, long param_4, long *param_5, ulong *param_6, undefined8 param_7, undefined8 param_8) {
   uint uVar1;
   uint uVar2;
   uint uVar3;
   int iVar4;
 ...
 while ( plVar20 != param_3 + ( ulong )(uVar11 - 1) + 1 );
      ...
      if (lVar38 == 0) {
         ...
         if (local_9c == 0) {
            FT_Stream_OpenMemory(local_1b0, param_1, param_2);
            LAB_0010bb9b:local_1c8 = 0;
            local_fe = 0;
            local_158 = 0;
            bVar56 = false;
            LAB_0010bbe8:lVar23 = param_3[local_1c8];
            ...
            if (local_9c == 0) {
               ...
               if (uVar1 == 0x68686561) {
                  ...
                  if (( (int)local_60 != 0 ) || ( *(ushort*)( (long)param_5 + 10 ) = local_fe(uVar21 & 0x100) != 0 )) goto LAB_0010c08c;
               }
 else {
                  *(ushort*)( (long)param_5 + 10 ) = local_fe;
                  if (( uVar21 & 0x100 ) != 0) {
                     if (uVar1 == 0x676c7966) {
                        ...
                        if (( ( ( local_98 != 0 ) || ( local_98 = FT_Stream_Skip(local_1b0, 2) ),local_98 != 0 ) ) || ( uVar11 = local_98 != 0 )) {
                        ...
                        *(ushort*)( param_5 + 1 ) = uVar14;
                        ...
                        if (( ( uVar21 + 1 ) * lVar38 - *(long*)( param_5[4] + 8 ) != 0 ) || ( *(ulong*)( param_5[3] + 0x10 ) < 0x24 )) {
                           LAB_0010cdb4:local_150 = (uint*)0x0;
                           local_168 = 0;
                           local_180 = (ushort*)0x0;
 ...
 while ( plVar36 != plVar20 + 0x15 );
                        ...
                        local_180 = (ushort*)0x0;
                        if (local_98 != 0) {
                           LAB_0010c305:local_150 = (uint*)0x0;
                           local_168 = 0;
                           local_140 = (ushort*)0x0;
                           local_90 = uVar22;
                           goto LAB_0010c320;
                        ...
                        for (local_108 = 0; (uint)local_108 < local_fc; local_108 = local_108 + 1) {
                           ...
                           if (( local_98 != 0 ) || ( bVar10 = local_98 != 0 )) goto LAB_0010cf20;
                           uVar16 = 0x80 >> ( (byte)local_108 & 7 );
                           uVar17 = bVar10 & uVar16;
                           local_98 = FT_Stream_Seek(local_1b0);
                           if (( local_98 != 0 ) || ( uVar11 = local_98 != 0 )) goto LAB_0010cf20;
...
;
                              ...
                              if ((char)uVar17 != '\0') {
                                 ...
                                 if (( local_98 != 0 ) || ( local_98 = local_98 != 0 )) goto LAB_0010d9f3;
                              ...
                              if (local_120 < local_150) {
                                 local_180 = (ushort*)ft_mem_qrealloc(param_8, 1, local_120, local_150, local_180, &local_98);
                              ...
                              *local_180 = 0xffff;
                              ...
                              if (( ( ( local_98 != 0 ) || ( uVar13 = FT_Stream_ReadUShort(local_1b0, &local_98) ),local_98 != 0 ) ) || ( local_98 = local_98 != 0 )) goto LAB_0010d9f3;
                              plVar20[0x10] = plVar20[0x10] + 8;
                              local_98 = FT_Stream_Seek(local_1b0, plVar20[0xd]);
                              if (( local_98 != 0 ) || ( local_98 = FT_Stream_Read(local_1b0, local_180 + 5, lVar24) ),local_98 != 0) goto LAB_0010d9f3;
                              ...
                              if ((char)uVar17 != '\0') {
                                 *(ushort*)( (long)local_180 + lVar24 + 10 ) = uVar11 | uVar14;
                                 ...
                                 if (( local_98 != 0 ) || ( local_98 = FT_Stream_Read(local_1b0, (long)local_180 + lVar24 + 0xc, uVar22) ),local_98 != 0) goto LAB_0010d9f3;
                                       ...
                                       if (( ulong )(lVar55 - plVar20[9]) <= (ulong)plVar20[0xb]) {
                                          ...
                                          if (( local_98 == 0 ) && ( uVar22 <= uVar26 )) {
                                             ...
                                             while (uVar40 = (ulong)local_ec,uVar40 < uVar22) {
                                                ...
                                                if (bVar29 < 0x54) {
                                                   uVar39 = uVar47 + 1;
                                                   if (( 0xfffffffffffffffe < uVar47 ) || ( uVar26 < uVar39 )) goto LAB_0010d0e9;
                                                   ...
                                                   LAB_0010d254:if ((int)uVar49 < 1) goto LAB_0010d646;
                                                }
 else {
                                                   if (bVar29 < 0x78) {
                                                      uVar39 = uVar47 + 2;
                                                      if (( 0xfffffffffffffffd < uVar47 ) || ( uVar26 < uVar39 )) goto LAB_0010d0e9;
                                                      iVar15 = ( (int)( uVar18 - 0x54 ) / 0xc ) * 0x100 + 1 + ( uint ) * (byte*)( lVar23 + uVar47 );
                                                      if (( bVar10 & 1 ) == 0) {
                                                         iVar15 = -iVar15;
                                                      }

                                                      iVar31 = ( (int)( uVar18 - 0x54 ) % 0xc >> 2 ) * 0x100 + 1 + ( uint ) * (byte*)( lVar23 + 1 + uVar47 );
                                                      if (( bVar10 & 2 ) == 0) {
                                                         iVar31 = -iVar31;
                                                      }
                                                      ...
                                                      uVar39 = uVar47 + 3;
                                                      if (( uVar26 < uVar39 ) || ( 0xfffffffffffffffc < uVar47 )) goto LAB_0010d0e9;
                                                      bVar48 = *(byte*)( lVar23 + 1 + uVar47 );
                                                      iVar15 = ( uint ) * (byte*)( lVar23 + uVar47 ) * 0x10 + ( (int)(uint)bVar48 >> 4 );
                                                      if (( bVar10 & 1 ) == 0) {
                                                         iVar15 = -iVar15;
                                                      }

                                                      iVar31 = ( bVar48 & 0xf ) * 0x100 + ( uint ) * (byte*)( lVar23 + 2 + uVar47 );
                                                      if (bVar29 >> 1 == 0x3c) {
                                                         iVar31 = -iVar31;
                                                      }
                                                      ...
                                                      uVar39 = uVar47 + 4;
                                                      if (( 0xfffffffffffffffb < uVar47 ) || ( uVar26 < uVar39 )) goto LAB_0010d0e9;
                                                      iVar15 = ( uint ) * (byte*)( lVar23 + uVar47 ) * 0x100 + ( uint ) * (byte*)( lVar23 + 1 + uVar47 );
                                                      if (( bVar10 & 1 ) == 0) {
                                                         iVar15 = -iVar15;
                                                      }

                                                      iVar31 = ( uint ) * (byte*)( lVar23 + 2 + uVar47 ) * 0x100 + ( uint ) * (byte*)( lVar23 + 3 + uVar47 );
                                                      if (bVar29 >> 1 == 0x3e) {
                                                         iVar31 = -iVar31;
                                                      }
                                                   ...
                                                   LAB_0010d611:if ((int)uVar49 < 1) {
                                                      LAB_0010d646:if (( uVar49 != 0 ) && ( iVar15 < (int)( -0x80000000 - uVar49 ) )) goto LAB_0010d0e9;
                                                   }
                                                ...
                                                if ((int)uVar16 < 1) {
                                                   if (( uVar16 != 0 ) && ( iVar31 < (int)( -0x80000000 - uVar16 ) )) goto LAB_0010d0e9;
                                                }
...
;
                                             ...
                                             if (( local_98 == 0 ) && ( local_98 = local_98 == 0 )) {
                                                ...
                                                if (uVar22 < 0x8000000) {
                                                   ...
                                                   if (( uVar26 <= local_120 ) || ( local_180 = (ushort*)ft_mem_qrealloc(param_8, 1, local_120, uVar26, local_180) ),local_120 = uVar26,local_98 == 0) {
...
;
                                                         ...
                                                         *(ulong*)( local_180 + 1 ) = ( ( ( ( ( ( ( uVar40 & 0xff ) << 8 | uVar40 >> 8 & 0xff ) << 8 | uVar26 & 0xff ) << 8 | uVar26 >> 8 & 0xff ) << 8 | ( ulong )(uVar16 & 0xff) ) << 8 | ( ulong )(uVar16 >> 8 & 0xff) ) << 8 | ( ulong )(uVar17 & 0xff) ) << 8 | ( ulong )(byte)(uVar17 >> 8);
                                                      }
 else {
                                                         local_98 = FT_Stream_Seek(local_1b0, plVar20[0x10]);
                                                         if (( ( ( local_98 != 0 ) || ( uVar13 = FT_Stream_ReadUShort(local_1b0, &local_98) ),local_98 != 0 ) ) || ( local_98 = local_98 != 0 )) goto LAB_0010d0e9;
                                                         plVar20[0x10] = plVar20[0x10] + 8;
                                                      }
                                                      ...
                                                      while (true) {
                                                         ...
                                                         *(char*)( (long)puVar41 + 1 ) = (char)iVar31;
                                                         ...
                                                         iVar31 = iVar31 + ( uint ) * (ushort*)( (long)local_140 + lVar23 + -8 );
                                                         lVar23 = lVar23 + 2;
                                                         puVar41 = puVar41 + 1;
...
;
                                                      ...
                                                      local_98 = FT_Stream_Seek(local_1b0, plVar20[0x13]);
                                                      if (( local_98 == 0 ) && ( local_98 = FT_Stream_Read(local_1b0, (long)local_180 + lVar23 + 4, uVar47) ),local_98 == 0) {
                                                         ...
                                                         for (iVar15 = 0; iVar15 != local_118; iVar15 = iVar15 + 1) {
                                                            ...
                                                            uVar3 = *puVar45;
                                                            iVar31 = uVar2 - uVar16;
                                                            bVar29 = ( iVar15 == 0 & local_f0 ) << 6 | (char)puVar45[2] != '\0';
                                                            iVar51 = uVar3 - uVar17;
                                                            if (iVar51 == 0) {
                                                               bVar29 = bVar29 | 0x10;
                                                            }
                                                         ...
                                                         if (( ( !CARRY4(uVar54,uVar18) ) && ( !CARRY4(uVar54 + uVar18,uVar49) ) ) && ( uVar54 + uVar18 + uVar49 <= local_120 )) {
                                                               ...
                                                               if (iVar15 != 0) {
                                                                  ...
                                                                  if (iVar15 + 0xffU < 0x1ff) {
                                                                     ...
                                                                     *(char*)( uVar47 + (long)local_180 ) = (char)iVar15;
                                                                     ...
                                                                     uVar49 = uVar49 + 2;
                                                                     *(ushort*)( uVar47 + (long)local_180 ) = (ushort)iVar15 << 8 | (ushort)iVar15 >> 8;
                                                                  }
                                 ...
                                 LAB_0010c8be:local_150 = (uint*)0x0;
                                 goto LAB_0010d0e9;
                              }
                           ...
                           LAB_0010d91f:*(ulong*)( local_148 + local_108 * 8 ) = local_70 - uVar53;
                           iVar15 = write_buf(&local_78, param_7, &local_70, local_180, uVar26, param_8);
                           if (( iVar15 != 0 ) || ( iVar15 = iVar15 != 0 )) goto LAB_0010d9f3;
 ...
 while ( uVar22 < uVar44 );
                           ...
                           LAB_0010dd88:ft_mem_free(param_8, puVar25);
                        }

                        if (local_94 != 0) {
                           LAB_0010d9f3:local_150 = (uint*)0x0;
                           local_140 = (ushort*)0x0;
                           LAB_0010d0e9:uVar22 = local_78;
                           local_90 = local_78;
...
;
 ...
 while ( (ulong)uVar11 * 2 != lVar38 );
                     ...
                     if (( ( (int)local_70 == 0 ) && ( ( byte )(bVar10 - 1) < 3 ) ) && ( ( ushort )(uVar11 - 1) < uVar14 )) {
                        uVar22 = (ulong)uVar11;
                        ...
                        if ((int)local_70 != 0) {
                           LAB_0010cb65:puVar25 = (undefined1*)0x0;
                           goto LAB_0010c1d6;
                        }
 ...
 while ( (int)lVar38 < (int)(uint)uVar14 );
                     ...
                     LAB_0010c1d6:ft_mem_free(param_8, puVar19);
                     ft_mem_free(param_8, lVar23);
                     ft_mem_free(param_8, puVar25);
                     goto LAB_0010c08c;
                  }
               ...
               joined_r0x0010cd8c:if (iVar15 == 0) goto LAB_0010bcd2;
               goto LAB_0010c08c;
            }
         ...
         if (( ( ( byte )(( ulong ) * (undefined8*)( lVar38 + 0x18 ) >> 8) ^ ( byte )(( ulong ) * (undefined8*)( lVar23 + 0x18 ) >> 8) ) & 1 ) != 0) goto LAB_0010bf6c;
         local_1b0 = (long*)ft_mem_alloc(param_8, 0x50, &local_9c);
         if (local_9c == 0) {
            FT_Stream_OpenMemory(local_1b0, param_1, param_2);
            goto LAB_0010bb9b;
   ...
   goto LAB_0010bf48;
   LAB_0010cf20:local_150 = (uint*)0x0;
   local_140 = (ushort*)0x0;
   local_90 = local_78;
   goto LAB_0010c320;
   LAB_0010cf59:local_150 = (uint*)0x0;
   local_140 = (ushort*)0x0;
   uVar22 = local_78;
   LAB_0010cde4:local_98 = 8;
   local_90 = uVar22;
   LAB_0010c320:ft_mem_free(param_8, plVar20);
   ft_mem_free(param_8, local_148);
   ft_mem_free(param_8, local_140);
   ft_mem_free(param_8, local_180);
   ft_mem_free(param_8, local_150);
   LAB_0010c37c:if (local_98 != 0) goto LAB_0010c08c;
   bVar56 = true;
   LAB_0010bcd2:local_58 = ( ( ( ( ( ( ( local_168 & 0xff ) << 8 | local_168 >> 8 & 0xff ) << 8 | local_168 >> 0x10 & 0xff ) << 8 | local_168 >> 0x18 & 0xff ) << 8 | ( ulong )(uVar1 & 0xff) ) << 8 | ( ulong )(uVar1 >> 8 & 0xff) ) << 8 | ( ulong )(uVar1 >> 0x10 & 0xff) ) << 8 | ( ulong )(uVar1 >> 0x18);
   uStack_50 = ( ( ( ( ( ( ( uVar5 & 0xff ) << 8 | uVar5 >> 8 & 0xff ) << 8 | uVar5 >> 0x10 & 0xff ) << 8 | uVar5 >> 0x18 & 0xff ) << 8 | uVar53 & 0xff ) << 8 | uVar53 >> 8 & 0xff ) << 8 | uVar53 >> 0x10 & 0xff ) << 8 | uVar53 >> 0x18 & 0xff;
   write_buf(&local_90, param_7, &local_80, &local_58, 0x10, param_8);
   lVar38 = 0;
   pbVar32 = (byte*)&local_58;
   do {
      pbVar33 = pbVar32 + 4;
      lVar38 = lVar38 + ( ( ulong ) * pbVar32 << 0x18 | (ulong)pbVar32[1] << 0x10 | (ulong)pbVar32[3] | (ulong)pbVar32[2] << 8 );
      pbVar32 = pbVar33;
   }
 while ( local_48 != pbVar33 );
   ...
   goto LAB_0010bbe8;
   code_r0x0010bea3:plVar20 = param_3 + ( ulong )(uVar30 - 1) + 1;
   do {
      lVar38 = *param_3;
      if (*(int*)( lVar38 + 4 ) == 0x68656164) {
         ...
         *(uint*)( local_90 + 8 + *(long*)( lVar38 + 0x30 ) ) = uVar30 >> 0x18 | ( uVar30 & 0xff0000 ) >> 8 | ( uVar30 & 0xff00 ) << 8 | uVar30 * 0x1000000;
 ...
 while ( plVar20 != param_3 );
   LAB_0010c3f3:param_5[5] = 0;
   LAB_0010c08c:uVar22 = local_90;
   if (local_9c == 0) {
      LAB_0010bf35:local_9c = 8;
      uVar22 = local_90;
   }

   LAB_0010bf48:*param_6 = uVar22;
   LAB_0010bf4b:FT_Stream_Close(local_1b0);
   ft_mem_free(param_8, local_1b0);
   iVar15 = local_9c;
   LAB_0010bf6c:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar15;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int sfnt_init_face(ulong param_1, ulong *param_2, uint param_3) {
   ulong uVar1;
   ulong uVar2;
   undefined1 auVar3[16];
   undefined1 auVar4[16];
   ...
   if (param_2[0x70] == 0) {
      ...
      LAB_0010e0c6:uVar14 = param_2[0x72];
   }
 else {
      if (param_2[0x71] != 0) goto LAB_0010e0c6;
      LAB_0010ebc8:uVar19 = FT_Get_Module(uVar19, "truetype");
   ...
   *(undefined1(*) [16])( param_2 + 0x20 ) = (undefined1[16])0x0;
   local_128 = param_3;
   LAB_0010e110:uVar15 = FT_Stream_Pos(param_1);
   ...
   if (iVar9 == 0x774f4646) {
      ...
      if (( ( local_c0 != 0x774f4646 ) && ( local_c0 != 0x74746366 ) ) && ( ( local_b8 == *(ulong*)( param_1 + 8 ) && ( ( ( ( local_b0 != 0 && ( (ulong)local_b0 * 0x14 + 0x2c < local_b8 ) ) && ( (ulong)local_b0 * 0x10 + 0xc < local_a8 ) ) && ( uVar14 = ( ulong )((uint)local_a8 & 3)(local_a8 & 3) == 0 ) ) ) ) )) {
         if (local_98 == 0) {
         ...
         LAB_0010e512:if (( local_80 == 0 ) && ( CONCAT44(uStack_74, local_78) != 0 )) goto LAB_0010e748;
         ...
         if ((int)local_100 == 0) {
            ...
            if ((int)local_100 == 0) {
               ...
               *(uint*)( local_158 + 8 ) = ( ( ( uVar11 & 0xff ) << 8 | uVar11 >> 8 & 0xff ) << 8 | uVar10 ) << 8 | uVar12;
                        ...
                        if (local_b0 != 0) {
                           do {
                              ...
                              *puVar33 = uVar12;
                              for (int i = 0; i < 4; i++) {
                                 uVar12 = FT_Stream_GetULong(param_1);
                                 *(ulong*)( puVar33 + ( 2*i + 2 ) ) = (ulong)uVar12;
                              }
 ...
 while ( (int)uVar14 < (int)(uint)local_b0 );
                        ...
                        if (local_b0 == 0) {
                           ...
                           do {
                              lVar29 = *plVar23;
                              if (( ( *(ulong*)( lVar29 + 8 ) != uVar14 ) || ( uVar1 = *(ulong*)( lVar29 + 0x10 ) ),local_b8 < uVar1 )) goto LAB_0010f5bc;
                              plVar23 = plVar23 + 1;
 ...
 while ( local_180 + uVar20 != plVar23 );
                        ...
                        if (( ( ( local_98 == 0 ) || ( ( local_98 == uVar14 && ( uVar14 = uVar14 + CONCAT44(uStack_8c, local_90) ),uVar14 <= local_b8 ) ) ) ) && ( ( local_80 == 0 || ( ( local_80 == ( (int)uVar14 + 3U & 0xfffffffc ) && ( uVar14 = CONCAT44(uStack_74, local_78) + local_80 ),uVar14 <= local_b8 ) ) ) )) {
                           local_158 = (undefined1*)ft_mem_qrealloc(uVar15, 1, 0xc, uVar27, local_158, &local_100);
                           if ((int)local_100 == 0) {
                              ...
                              for (iVar32 = 0; iVar32 < (int)(uint)local_b0; iVar32 = iVar32 + 1) {
                                 *puVar21 = (char)( *puVar33 >> 0x18 );
                                 ...
                                 for (int i = 0; i < 3; i++) {
                                    puVar21[( i + 4 )] = (char)( ( ulong ) * (undefined8*)( puVar33 + 8 ) >> ( -8*i + 24 ) );
                                 }

                                 puVar21[7] = (char)*(undefined8*)( puVar33 + 8 );
                                 for (int i = 0; i < 3; i++) {
                                    puVar21[( i + 8 )] = (char)( ( ulong ) * (undefined8*)( puVar33 + 10 ) >> ( -8*i + 24 ) );
                                 }

                                 puVar21[0xb] = (char)*(undefined8*)( puVar33 + 10 );
                                 for (int i = 0; i < 3; i++) {
                                    puVar21[( i + 12 )] = (char)( ( ulong ) * (undefined8*)( puVar33 + 6 ) >> ( -8*i + 24 ) );
                                 }
                                 ...
                                 if (*(size_t*)( puVar33 + 4 ) != *(size_t*)( puVar33 + 6 )) {
                                    ...
                                    iVar9 = FT_Gzip_Uncompress(uVar15, local_158 + *(long*)( puVar33 + 10 ), local_f8);
                                    local_100 = CONCAT44(local_100._4_4_, iVar9);
                                    if (iVar9 == 0) {
                                 ...
                                 memcpy(local_158 + *(long*)( puVar33 + 10 ), *(void**)( param_1 + 0x40 ), *(size_t*)( puVar33 + 4 ));
                                 LAB_0010fcee:FT_Stream_ExitFrame(param_1);
                                 for (uVar14 = *(long*)( puVar33 + 6 ) + *(long*)( puVar33 + 10 ); ( uVar14 & 3 ) != 0; uVar14 = uVar14 + 1) {
                                    local_158[uVar14] = 0;
                                 }
                           ...
                           LAB_0010f5bc:local_100 = CONCAT44(local_100._4_4_, 8);
                        }
         ...
         LAB_0010e660:ft_mem_free(uVar15, puVar17);
         ft_mem_free(uVar15, local_180);
         if ((int)local_100 == 0) {
            LAB_0010e880:local_118 = 0;
         }
 else {
         ...
         LAB_0010e888:param_1 = param_2[0x18];
         goto LAB_0010e110;
      }
      ...
      if (iVar9 != 0x774f4632) {
         if (( iVar9 == 0x10000 ) || ( iVar9 == 0x74746366 )) {
            ...
            if (iVar9 == 0x74746366) {
               ...
               param_2[0x22] = uVar14;
               iVar32 = local_118;
               if (( local_118 != 0 ) || ( local_118 = FT_Stream_EnterFrame(param_1, param_2[0x21] * 4) ),iVar32 = local_118,local_118 != 0) goto LAB_0010e6c8;
               lVar29 = 0;
 ...
 while ( lVar29 < (long)param_2[0x21] );
               ...
               if (-1 < (int)local_128) {
                  if ((long)uVar14 < (long)param_2[0x21]) {
                     LAB_0010ec28:lVar29 = uVar14 * 8;
                     goto LAB_0010ea28;
                  }

                  LAB_0010e9c5:iVar32 = 6;
                  goto LAB_0010e6c8;
               }

               lVar29 = 0;
               if (( (int)uVar14 != 0 ) && ( uVar14 = ( ulong )((int)uVar14 + -1) ),(long)uVar14 < (long)param_2[0x21]) goto LAB_0010ec28;
               LAB_0010ea28:uVar14 = param_2[0x18];
               ...
               if (( iVar32 == 0 ) && ( 0x13 < local_c8 )) {
                  ...
                  if (0x3ffd < ( ushort )(uVar6 - 1)) {
                     LAB_0010f198:uVar11 = uVar11 & 1;
                     uVar8 = 0x14;
                     goto LAB_0010eac9;
                  }

                  uVar24 = uVar12 & 0xffff;
                  if (( ( ( uVar24 != (uint)uVar6 * 4 + 4 ) && ( uVar24 != (uint)uVar6 * 4 + 6 ) ) || ( 0x7eff < uVar7 ) ) || ( local_c8 < (long)(int)( ( (uint)uVar6 + (uint)uVar6 * 4 ) * 4 ) + local_188 + (long)(int)( uVar24 * uVar7 ) )) goto LAB_0010f198;
                  uVar8 = 0x14;
                  *(uint*)( param_2 + 0x99 ) = uVar11 | 1;
                  LAB_0010ecc3:local_180 = (long*)local_f8;
                  __s2 = (void*)0x0;
 ...
 while ( (uint)uVar7 != uVar24 + 1 );
                  ...
                  LAB_0010eaaf:uVar12 = 0;
                  uVar8 = 0;
                  uVar6 = 0;
                  local_188 = 0;
                  uVar11 = (uint)param_2[0x99] & 1;
                  LAB_0010eac9:if (uVar11 != 0) {
                     uVar7 = 0;
                     goto LAB_0010ecc3;
                  }
               ...
               LAB_0010eada:ft_mem_free(uVar20, __s1);
               ft_mem_free(uVar20, __s2);
               iVar32 = ( *(code*)param_2[0x68] )(param_2, 0x676c7966, uVar14, 0);
               if (( ( iVar32 == 0 ) || ( iVar32 = ( *(code*)param_2[0x68] )(param_2, 0x43464632, uVar14, 0) ),iVar32 == 0 )) {
                  uVar12 = (uint)uVar7;
               }
 else {
                  uVar7 = 0;
               ...
               *param_2 = local_170;
               ...
               LAB_0010e6c8:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
                  return iVar32;
               }
            ...
            if (( ( ( iVar9 != 0x4f54544f ) && ( iVar9 != 0x74727565 ) ) && ( iVar9 != 0x74797031 ) ) && ( ( ( iVar9 != -0x5a949d9c && ( iVar9 != -0x5a938c8c ) ) && ( iVar32 = iVar9 != 0x20000 ) ) )) goto LAB_0010e6c8;
            param_2[0x1f] = 0x74746366;
         }
      ...
      if (( ( ( local_c0 != 0x774f4632 ) && ( local_b8 == *(ulong*)( param_1 + 8 ) ) ) && ( local_b0 != 0 ) ) && ( (ulong)local_b0 * 0x14 + 0x30 < local_b8 )) {
         ...
         if (uVar14 == 0) {
            if (local_98 < local_b8) {
               joined_r0x0010e736:if (local_80 == 0) {
                  if (CONCAT44(uStack_74, local_78) == 0) {
                     LAB_0010e251:local_48 = 0;
                        ...
                        if (local_b0 == 0) {
                           ...
                           do {
                              ...
                              *pbVar31 = bVar5;
                              if (local_114 != 0) goto LAB_0010e92f;
                              if ((char)( uVar10 & 0x3f ) != '?') {
                                 iVar32 = *(int*)( "pamcdaehaehhxtmhpxameman2/SOtsop tvcmgpffylgacolperp FFCGROVTDBECLBEpsagxmdhnrekHSTLTLCPXMDVaehvxtmvESABFEDGSOPGBUSGCSBEFTSJHTAMTDBCCLBCRLOCLAPC GVSxibstncaravatadbcolbnlsbravccsdftaefxtmfravfravgytshtsujracltromxromdbpoporpkartfpaZfliStalGcolGtaeFlliS" + ( ulong )(uVar10 & 0x3f) * 4 );
                                 *(int*)( pbVar31 + 4 ) = iVar32;
                                 if (iVar32 != 0) goto LAB_0010e382;
                                 LAB_0010f3b2:local_114 = 8;
                                 goto LAB_0010e92f;
                              }
                              ...
                              *(int*)( pbVar31 + 4 ) = iVar32;
                              if (local_114 != 0) goto LAB_0010e92f;
                              bVar5 = *pbVar31;
                              LAB_0010e382:if (( iVar32 == 0x676c7966 ) || ( iVar32 == 0x6c6f6361 )) {
                                 bVar34 = bVar5 >> 6 == 0;
                              }
 else {
                                 bVar34 = bVar5 >> 6 != 0;
                              ...
                              *(ulong*)( pbVar31 + 0x10 ) = uVar20;
                              if (bVar34 == false) {
                                 LAB_0010e300:uVar27 = uVar20 + uVar14;
                        ...
                        if (local_c0 == 0x74746366) {
                           ...
                           if (local_114 == 0) {
                              ...
                              if (local_114 == 0) {
                                 ...
                                 if (local_114 == 0) {
                                    for (local_150 = 0; (int)local_150 < (int)(uint)local_58[0]; local_150 = local_150 + 1) {
 ...
 while ( uVar27 < (ushort)puVar26[1] );
                                          uVar10 = (uint)uVar14;
                                          uVar12 = (uint)uVar20;
                                          if (( uVar10 != 0 || uVar12 != 0 ) && ( ( uVar12 < uVar10 || ( uVar12 - uVar10 != 1 ) ) )) goto LAB_0010f3a5;
                                       }
                        ...
                        local_48 = 0;
                        LAB_0010f284:local_68 = FT_Stream_Pos(param_1);
                        uVar10 = (int)local_a0 + 3 + (int)local_68 & 0xfffffffc;
                        uVar14 = (ulong)uVar10;
                        if (local_b8 < uVar14) {
                           LAB_0010f3a5:local_114 = 8;
                        }
 else {
                           if (local_98 != 0) {
                           ...
                           if (local_60 == 0) {
                              LAB_0010f804:local_108 = (ulong)local_b0 * 0x10 + 0xc;
 ...
 while ( local_160 + ( ulong )(local_b0 - 2) + 2 != plVar23 );
                                    ...
                                    if (local_70 == 0) {
                                       ...
                                       if (local_70 < 0x4000001) {
                                          ...
                                          if (( local_114 == 0 ) && ( local_114 = FT_Stream_EnterFrame(param_1, local_a0) ),uVar14 = local_70,local_114 == 0) {
                                             local_100 = local_70;
                                             iVar32 = BrotliDecoderDecompress(local_a0, *(undefined8*)( param_1 + 0x40 ), &local_100, local_150);
                                             if (iVar32 == 1) {
                                             ...
                                             FT_Stream_ExitFrame(param_1);
                                             if (local_114 == 0) {
                                                local_114 = reconstruct_font(local_150, local_70, local_160, &local_c8, local_f8, &local_110, &local_108, uVar15);
                                                uVar22 = local_e8._0_8_;
                                                if (( local_114 == 0 ) && ( ( local_108 <= uStack_50 || ( local_110 = (undefined1*)ft_mem_qrealloc(uVar15, 1, local_108, uStack_50) ),local_114 == 0 ) )) {
                                                   FT_Stream_OpenMemory(local_148, local_110, uStack_50);
                                                   uVar14 = param_2[2];
                                                   uVar20 = param_2[0x18];
                                                   *(undefined8*)( local_148 + 0x38 ) = *(undefined8*)( param_1 + 0x38 );
                              ...
                              if (local_114 == 0) {
                                 ...
                                 if (uVar6 != 0) {
                                    ...
                                    lVar25 = 0;
                                    do {
                                       *(long*)( lVar29 + lVar25 * 8 ) = local_160[*(ushort*)( lVar28 + lVar25 * 2 )];
                                       lVar25 = lVar25 + 1;
                                    }
 ...
 while ( (int)lVar28 < (int)(uint)uVar6 );
                     ...
                     LAB_0010e7cd:ft_mem_free(uVar15, pbVar16);
 ...
 else if (( local_80 < local_b8 ) && ( CONCAT44(uStack_74, local_78) <= local_b8 - local_80 )) goto LAB_0010e251;
            }

         }
 else if (( ( local_88 != 0 ) && ( local_98 < local_b8 ) ) && ( uVar14 <= local_b8 - local_98 )) goto joined_r0x0010e736;
      }

   }

   LAB_0010e748:iVar32 = 8;
   goto LAB_0010e6c8;
}
...
;
 ...
 while ( plVar21 != param_5 );
   ...
   LAB_001100d8:if (*(long*)( *(long*)( param_2 + 0xf0 ) + 0x68 ) == 0) {
...
;
 ...
 while ( plVar21 < plVar23 );
      ...
      bVar7 = false;
      bVar8 = false;
      LAB_00110ba6:iVar10 = ( **(code**)( param_2 + 0x340 ) )(param_2, 0x43424c43, param_1, 0);
      bVar27 = iVar10 == 0;
      ...
      if (( ( bVar8 ) || ( *(code**)( lVar2 + 0x88 ) == (code*)0x0 ) ) || ( uVar11 = ( **(code**)( lVar2 + 0x88 ) )(param_2, param_1) ),local_7c = uVar11,uVar11 != 0) goto LAB_00110172;
      bVar5 = true;
      local_7c = 0;
      bVar8 = bVar29;
      ...
      LAB_001100ea:iVar10 = ( **(code**)( param_2 + 0x340 ) )(param_2, 0x43424c43, param_1, 0);
      bVar27 = iVar10 == 0;
      iVar10 = ( **(code**)( param_2 + 0x340 ) )(param_2, 0x43424454, param_1, 0);
      bVar28 = iVar10 == 0;
      local_a0 = ( **(code**)( param_2 + 0x340 ) )(param_2, 0x45424c43, param_1, 0);
      ...
      LAB_00110172:uVar11 = local_7c;
      bVar8 = false;
      LAB_00110177:bVar5 = bVar8;
      local_7c = uVar11;
   ...
   if (!bVar5) {
      ...
      if (local_7c == 0) {
         ...
         if ((char)uVar12 == -0x72) {
            ...
            uVar12 = 0x93;
            joined_r0x00110caf:if (( plVar21 == (long*)0x0 ) || ( *(long*)( *plVar21 + 0x10 ) == 0 )) goto LAB_001106b0;
      ...
      if (local_7c == 0) {
         ...
         *(undefined1*)( param_2 + 0x1f0 ) = 1;
         ...
         LAB_00110918:if ((char)uVar12 != -0x72) goto LAB_001106b0;
      }
   ...
   if (( *(code**)( lVar2 + 0xc0 ) != (code*)0x0 ) && ( ( ( local_a0 == 0 || bVar27 ) || local_9c == 0 ) || bVar29 )) {
   ...
   *(ulong*)( param_2 + 0x20 ) = ( ulong ) * (ushort*)( param_2 + 0x1d0 );
   if (( *(short*)( param_2 + 0x268 ) != -1 ) && ( ( *(byte*)( param_2 + 0x2bd ) & 1 ) != 0 )) {
      if (bVar3) {
         LAB_001102e2:uVar12 = tt_face_get_name(param_2, 1, lVar17);
         local_7c = (uint)uVar12;
         if (local_7c != 0) goto LAB_001106b0;
      }
 else {
   ...
   lVar17 = *(long*)( param_2 + 0x30 );
   if (bVar4) {
      joined_r0x001107a0:if (lVar17 == 0) {
   ...
   *(undefined8*)( param_2 + 0x4e0 ) = uVar13;
   ...
   if (( ( *(int*)( param_2 + 0x540 ) - 2U < 2 ) || ( *(long*)( param_2 + 0x5c0 ) != 0 ) ) || ( *(long*)( param_2 + 0x5c8 ) != 0 )) {
   ...
   *(ulong*)( param_2 + 0x18 ) = *(ulong*)( param_2 + 0x18 ) | uVar12;
   ...
   if (*(int*)( param_2 + 0x48 ) < 1) {
      LAB_00110a99:if (( *(byte*)( param_2 + 0x11 ) & 2 ) != 0) {
         local_70 = 0x10003756e6963;
         local_78 = param_2;
         uVar12 = FT_CMap_New(tt_cmap_unicode_class_rec, 0, &local_78, 0);
         if (( ( (uint)uVar12 != 0 ) && ( (char)uVar12 != '\a' ) ) && ( ( (uint)uVar12 & 0xff ) != 0xa3 )) goto LAB_001106b0;
         local_7c = 0;
      }
      ...
      do {
         ...
         do {
            if (( ( uint ) * (ushort*)( lVar17 + 0xc ) == *puVar15 ) && ( ( ( uint ) * (ushort*)( lVar17 + 0xe ) == puVar15[1] || ( puVar15[1] == 0xffffffff ) ) )) {
               uVar11 = puVar15[2];
 ...
 while ( puVar15 != (uint*)&DAT_001128c4 );
         uVar11 = 0;
         LAB_00110494:plVar18 = plVar18 + 1;
 ...
 while ( plVar21 != plVar18 );
   ...
   if (*(uint*)( param_2 + 0x544 ) == 0) {
      LAB_0011093d:uVar12 = *(ulong*)( param_2 + 0x10 );
   }
 else {
      ...
      do {
         ...
         if (local_7c == 0) {
            ...
            *puVar20 = (short)( local_50 >> 6 );
            ...
            puVar20[1] = (short)( (int)( iVar10 * (uint)(ushort)local_78 + ( uint )(uVar26 >> 1) ) / (int)(uint)uVar26 );
 ...
 while ( uVar14 != uVar12 );
   ...
   if (( uVar12 & 0x20001 ) != 0) {
      for (int i = 0; i < 4; i++) {
         *(long*)( param_2 + ( 8*i + 104 ) ) = (long)*(short*)( param_2 + ( 2*i + 376 ) );
      }
      ...
      *(undefined2*)( param_2 + 0x88 ) = *(undefined2*)( param_2 + 0x152 );
      if (*(short*)( param_2 + 0x268 ) == -1) {
         ...
         *(short*)( param_2 + 0x8e ) = ( (short)uVar1 + *(short*)( param_2 + 0x19c ) ) - (short)( (uint)uVar1 >> 0x10 );
      }
         ...
         *(short*)( param_2 + 0x8e ) = ( (short)uVar1 + *(short*)( param_2 + 0x19c ) ) - (short)( (uint)uVar1 >> 0x10 );
         if (( *(ulong*)( param_2 + 0x88 ) & 0xffffffff0000 ) == 0) {
            ...
            *(uint*)( param_2 + 0x8a ) = ( uint ) * (ushort*)( param_2 + 0x2ca ) * -0x10000 | ( uint ) * (ushort*)( param_2 + 0x2c8 );
         }

      }
 else {
         LAB_00110d33:uVar1 = *(undefined4*)( param_2 + 0x2c2 );
         *(undefined4*)( param_2 + 0x8a ) = uVar1;
         *(short*)( param_2 + 0x8e ) = ( (short)uVar1 + *(short*)( param_2 + 0x2c6 ) ) - (short)( (uint)uVar1 >> 0x10 );
      }
   ...
   uVar12 = (ulong)local_7c;
   LAB_001106b0:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar12;
   }
...
undefined8 tt_face_get_colorline_stops(long param_1, long *param_2, uint *param_3) {
   ...
   if (( ( lVar1 == 0 ) || ( *(long*)( lVar1 + 0x80 ) == 0 ) ) || ( param_3 == (uint*)0x0 )) {
      ...
      if (uVar8 < *param_3) {
         ...
         if (( *(ushort**)( lVar1 + 0x40 ) <= local_50 ) && ( ( ulong )(( ( *param_3 - 1 ) - uVar8 ) * uVar9) + (long)local_50 <= ( *(long*)( lVar1 + 0x80 ) - (ulong)uVar9 ) + *(long*)( lVar1 + 0x88 ) )) {
...
undefined8 tt_face_get_color_glyph_clipbox(long param_1, uint param_2, long *param_3) {
         ...
         if (uVar5 <= lVar7 + ( uVar18 - lVar7 >> 1 ) >> 2) {
            if (( pcVar1 + 5 <= (ushort*)( lVar15 + uVar5 * -7 ) ) && ( uVar5 != 0 )) {
               ...
               do {
                  ...
                  if (( ( ushort )(*puVar8 << 8 | *puVar8 >> 8) <= param_2 ) && ( param_2 <= ( ushort )(puVar8[1] << 8 | puVar8[1] >> 8) )) {
                     pbVar4 = (byte*)( pcVar1 + ( (uint)(byte)puVar8[2] << 0x10 | ( uint ) * (byte*)( (long)puVar8 + 5 ) << 8 | (uint)(byte)puVar8[3] ) );
                     if (( pbVar4 <= (byte*)( lVar15 - 1U ) ) && ( ( *pbVar4 < 3 && ( pbVar4 + 1 <= (byte*)( lVar15 - 8U ) ) ) )) {
                        lVar7 = *(long*)( param_1 + 0xa0 );
                        lVar10 = (long)(short)( *(ushort*)( pbVar4 + 1 ) << 8 | *(ushort*)( pbVar4 + 1 ) >> 8 ) * (long)*(int*)( lVar7 + 0x20 );
                        lVar14 = lVar10 + 0x8000 + ( lVar10 >> 0x3f ) >> 0x10;
                        lVar10 = (long)(short)( *(ushort*)( pbVar4 + 3 ) << 8 | *(ushort*)( pbVar4 + 3 ) >> 8 ) * (long)*(int*)( lVar7 + 0x28 );
                        lVar11 = lVar10 + 0x8000 + ( lVar10 >> 0x3f ) >> 0x10;
                        lVar10 = (long)(short)( *(ushort*)( pbVar4 + 5 ) << 8 | *(ushort*)( pbVar4 + 5 ) >> 8 ) * (long)*(int*)( lVar7 + 0x20 );
                        lVar13 = lVar10 + 0x8000 + ( lVar10 >> 0x3f ) >> 0x10;
                        lVar10 = (long)(short)( *(ushort*)( pbVar4 + 7 ) << 8 | *(ushort*)( pbVar4 + 7 ) >> 8 ) * (long)*(int*)( lVar7 + 0x28 );
                        lVar10 = lVar10 + 0x8000 + ( lVar10 >> 0x3f ) >> 0x10;
                        if (*pbVar4 != 2) goto LAB_001111dc;
                        local_88 = (undefined1[16])0x0;
                        if (pbVar4 + 9 <= (byte*)( lVar15 + -4 )) {
                           uVar6 = *(uint*)( pbVar4 + 9 );
                           uVar18 = ( ulong )(uVar6 >> 0x18 | ( uVar6 & 0xff0000 ) >> 8 | ( uVar6 & 0xff00 ) << 8 | uVar6 << 0x18);
 ...
 while ( (ushort*)( pcVar1 + uVar5 * 7 + 5 ) != puVar9 );
   ...
   uVar17 = 0;
   LAB_00111039:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
ulong tt_face_get_paint(long param_1, uint *param_2, ulong param_3, uint *param_4) {
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   puVar1 = local_80;
   if (( ( lVar9 == 0 ) || ( *(long*)( lVar9 + 0x20 ) == 0 ) ) || ( lVar11 = lVar11 == 0 )) {
      uVar15 = 0;
      goto LAB_00111528;
   }
   ...
   if (( param_2 == (uint*)0x0 ) || ( puVar6 = param_2 < puVar6 )) goto LAB_00111528;
   ...
   *param_4 = uVar16;
   ...
   if (bVar4 - 2 < 2) {
      if (( local_80 < puVar6 ) || ( puVar2 = puVar2 < local_80 )) goto LAB_00111528;
      local_80 = (uint*)( (long)param_2 + 5 );
      *(ushort*)( param_4 + 2 ) = *(ushort*)( (long)param_2 + 1 ) << 8 | *(ushort*)( (long)param_2 + 1 ) >> 8;
      *(ushort*)( (long)param_4 + 10 ) = *(ushort*)( (long)param_2 + 3 ) << 8 | *(ushort*)( (long)param_2 + 3 ) >> 8;
      if (uVar16 == 3) {
         puVar1 = local_80;
         if (( puVar2 < local_80 ) || ( local_80 < puVar6 )) goto LAB_00111528;
         uVar16 = *(uint*)( (long)param_2 + 5 );
         uVar15 = ( ulong )(uVar16 >> 0x18 | ( uVar16 & 0xff0000 ) >> 8 | ( uVar16 & 0xff00 ) << 8 | uVar16 << 0x18);
   ...
   if (bVar4 == 0xb) {
      if (( puVar2 < local_80 ) || ( local_80 < puVar6 )) goto LAB_00111528;
      param_4[2] = ( uint )(ushort)(*(ushort*)( (long)param_2 + 1 ) << 8 | *(ushort*)( (long)param_2 + 1 ) >> 8);
      goto LAB_001115f3;
   }
...
LAB_001121f1:
   ...
   LAB_001115f3:uVar15 = 1;
   puVar1 = local_80;
   LAB_00111528:local_80 = puVar1;
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar15;
   }

   ...
   *(undefined8*)( lVar14 + 0x218 ) = 0xffffffffffffffff;
   ...
   if ((int)uVar15 == 0) {
      if (puVar32 != (undefined8*)0xffffffffffffffff) {
         ...
         *(undefined8*)( lVar14 + 0x1cc ) = uVar11;
         for (int i_1978 = 0; i_1978 < 4; i_1978++) {
            *(undefined8*)( lVar14 + ( 8*i_1978 + 468 ) ) = *(undefined8*)( lVar14 + ( 8*i_1978 + 276 ) );
         }
         ...
         *(uint*)( lVar14 + 0x20c ) = uVar12;
         ...
         for (int i_1977 = 0; i_1977 < 12; i_1977++) {
            *(undefined8*)( lVar14 + ( 8*i_1977 + 436 ) ) = *(undefined8*)( lVar14 + ( 8*i_1977 + 340 ) );
         }
      ...
      if (puVar32 == (undefined8*)0xffffffffffffffff) {
         ...
         if (puVar32 != param_4) {
            ...
            for (int i_1979 = 0; i_1979 < 12; i_1979++) {
               *(undefined8*)( lVar14 + ( 8*i_1979 + 436 ) ) = *(undefined8*)( lVar14 + ( 8*i_1979 + 340 ) );
            }
   ...
   if (0 < iVar1 * 8) {
      ...
      *(undefined8*)( lVar3 + 0x218 ) = 0xffffffffffffffff;
      for (int i_1981 = 0; i_1981 < 12; i_1981++) {
         *(undefined8*)( lVar3 + ( 8*i_1981 + 340 ) ) = *(undefined8*)( lVar3 + ( 8*i_1981 + 244 ) );
      }
      for (int i_1980 = 0; i_1980 < 12; i_1980++) {
         *(undefined8*)( lVar3 + ( 8*i_1980 + 436 ) ) = *(undefined8*)( lVar3 + ( 8*i_1980 + 244 ) );
      }
      return ~uVar2 >> 0x1f;
   }
   ERR_new();

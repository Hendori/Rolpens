/* RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::is_animated() const */ShaderData RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::is_animated(ShaderData *this) {
   ShaderData SVar1;
   if (( ( this[0x23f] == (ShaderData)0x0 ) || ( SVar1 = this[0x22e] ),SVar1 == (ShaderData)0x0 )) {
      return this[0x236];
   }
   return SVar1;
}/* RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::casts_shadows() const */uint RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::casts_shadows(ShaderData *this) {
   ShaderData SVar1;
   uint uVar2;
   if (( ( ( this[0x239] == (ShaderData)0x0 ) && ( this[0x23a] == (ShaderData)0x0 ) ) && ( ( this[0x229] == (ShaderData)0x0 || ( ( this[0x22b] != (ShaderData)0x0 && ( this[0x22c] == (ShaderData)0x0 ) ) ) ) ) ) && ( this[0x23b] == (ShaderData)0x0 )) {
    ...
    */void RendererSceneRenderImplementation::SceneShaderForwardMobile::MaterialData::set_render_priority(MaterialData *this, int param_1) {
   this[0xd0] = ( MaterialData )((char)param_1 + -0x80);
   return;
}/* RendererSceneRenderImplementation::SceneShaderForwardMobile::MaterialData::set_next_pass(RID) */void RendererSceneRenderImplementation::SceneShaderForwardMobile::MaterialData::set_next_pass(MaterialData *this, undefined8 param_2) {
   *(undefined8*)( this + 200 ) = param_2;
   return;
}/* RendererSceneRenderImplementation::SceneShaderForwardMobile::MaterialData::~MaterialData() */void RendererSceneRenderImplementation::SceneShaderForwardMobile::MaterialData::~MaterialData(MaterialData *this) {
   ...
   *(undefined***)this = &PTR_set_render_priority_00111da8;
   ...
   const */void RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::get_native_source_code(void) {
   long lVar1;
   int iVar2;
   long in_RSI;
   long in_RDI;
   ...
   bool) const [clone .part.0] */undefined8 RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::get_shader_variant(ShaderData *this, int param_2, uint param_3) {
   Version *pVVar1;
   ulong uVar2;
   long lVar3;
   code *pcVar4;
   ...
   if (singleton == 0) {
      _err_print_error("get_shader_variant", "servers/rendering/renderer_rd/forward_mobile/scene_shader_forward_mobile.cpp", 0x178, "Parameter \"SceneShaderForwardMobile::singleton\" is null.", 0, 0);
      uVar7 = 0;
      goto LAB_00100330;
   }
   ...
   if (param_2 < 0) {
      ...
      lVar8 = *(long*)( lVar8 + -8 );
      LAB_0010049d:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, uVar10, lVar8, "p_variant", "variant_defines.size()", "", false, false);
   } else {
      if (lVar8 == 0) {
         LAB_00100520:lVar8 = 0;
         goto LAB_0010049d;
      }
      lVar8 = *(long*)( lVar8 + -8 );
      ...
      uVar6 = uVar10;
      if (lVar8 == 0) {
         LAB_001003e0:lVar9 = 0;
         uVar6 = uVar10;
         LAB_00100401:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar6, lVar9, "p_index", "size()", "", false, true);
         _err_flush_stdout();
      ...
      if (*(char*)( lVar8 + uVar10 ) == '\0') {
         ...
         if (( uVar2 != 0 ) && ( (uint)uVar2 < *(uint*)( singleton + 0xe4 ) )) {
            lVar8 = ( ( uVar2 & 0xffffffff ) % ( ulong ) * (uint*)( singleton + 0xe0 ) ) * 0xa0 + *(long*)( *(long*)( singleton + 0xd0 ) + ( ( uVar2 & 0xffffffff ) / ( ulong ) * (uint*)( singleton + 0xe0 ) ) * 8 );
   ...
   LAB_0010032e:uVar7 = 0;
   LAB_00100330:pthread_mutex_unlock((pthread_mutex_t*)singleton_mutex);
   return uVar7;
   ...
   DefaultTypedAllocator<HashMapElement<StringName, Variant> > > const&, bool, bool) */undefined4 RendererSceneRenderImplementation::SceneShaderForwardMobile::MaterialData::update_parameters(MaterialData *this, HashMap *param_1, bool param_2, bool param_3) {
   Version *pVVar1;
   char *pcVar2;
   uint *puVar3;
   long lVar4;
   ...
   if (*(long*)( singleton + 0x28 ) == 0) {
      lVar13 = 0;
      LAB_00100853:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 0, lVar13, "p_variant", "variant_defines.size()", "", false, false);
   } else {
      lVar13 = *(long*)( *(long*)( singleton + 0x28 ) + -8 );
      if (lVar13 < 1) goto LAB_00100853;
      pcVar2 = *(char**)( singleton + 0x38 );
      if (pcVar2 == (char*)0x0) {
         LAB_00100808:lVar13 = 0;
         LAB_0010080b:uVar9 = 0;
         LAB_00100828:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar9, lVar13, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
   ...
   uVar11 = 0;
   LAB_00100711:lVar4 = *(long*)( this + 0xa8 );
   uVar8 = RendererRD::MaterialStorage::MaterialData::update_parameters_uniform_set(this, param_1, param_2, param_3, lVar4 + 0x10, *(undefined8*)( lVar4 + 0x1f8 ), lVar4 + 0x1e0, lVar4 + 0x40, *(undefined4*)( lVar4 + 0x200 ), this + 0xb0, uVar11, 3, 1, 1);
   pthread_mutex_unlock((pthread_mutex_t*)singleton_mutex);
   return uVar8;
   ...
   const&) [clone .part.0] */void CowData<RenderingDeviceCommons::PipelineColorBlendState::Attachment>::_ref(CowData<RenderingDeviceCommons::PipelineColorBlendState::Attachment> *this, CowData *param_1) {
   long *plVar1;
   long lVar2;
   long lVar3;
   bool bVar4;
   ...
   _err_print_error("_copy_on_write", "./core/templates/cowdata.h", 0x13a, "Parameter \"mem_new\" is null.", 0, 0);
   return;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::get_cull_mode_from_cull_variant(RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::CullVariant)
    */undefined4 RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::get_cull_mode_from_cull_variant(ShaderData *this, int param_2) {
   long in_FS_OFFSET;
   undefined8 local_38;
    ...
    */void RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::_clear_vertex_input_mask_cache(ShaderData *this) {
   ShaderData *pSVar1;
   pSVar1 = this + 0x160;
   do {
      LOCK();
   ...
   bool) const */undefined8 RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::get_shader_variant(ShaderData *this, undefined8 param_2, undefined1 param_3) {
   undefined8 uVar1;
   ...
   bool) */long RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::get_vertex_input_mask(ShaderData *this, int param_2, byte param_3) {
   long lVar1;
   undefined8 uVar2;
   ...
   _err_print_error("get_vertex_input_mask", "servers/rendering/renderer_rd/forward_mobile/scene_shader_forward_mobile.cpp", 0x185, "Condition \"shader_rid.is_null()\" is true. Returning: 0", 0, 0);
   return 0;
}/* RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::is_valid() const */undefined4 RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::is_valid(ShaderData *this) {
   int iVar1;
   undefined4 uVar2;
   uVar2 = 0;
   if (*(long*)( this + 0x158 ) == 0) {
   ...
   if (iVar1 == 0) {
      if (singleton == 0) {
         _err_print_error("is_valid", "servers/rendering/renderer_rd/forward_mobile/scene_shader_forward_mobile.cpp", 0x191, "Parameter \"SceneShaderForwardMobile::singleton\" is null.", 0, 0);
      } else {
...
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::ShaderData() */void RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::ShaderData(ShaderData *this) {
   undefined8 uVar1;
   undefined8 uVar2;
   long lVar3;
   ShaderData *pSVar4;
   ...
   *(undefined1(*) [16])( this + 0x228 ) = (undefined1[16])0x0;
   return;
}/* RendererSceneRenderImplementation::SceneShaderForwardMobile::_create_shader_func() */ShaderData *RendererSceneRenderImplementation::SceneShaderForwardMobile::_create_shader_func(void) {
   ShaderData *pSVar1;
   long lVar2;
   long *plVar3;
   int iVar4;
    ...
    */void RendererSceneRenderImplementation::SceneShaderForwardMobile::_create_material_func(SceneShaderForwardMobile *this, ShaderData *param_1) {
   undefined8 *puVar1;
   ...
   *(undefined1(*) [16])( this + 0x720 ) = (undefined1[16])0x0;
    ...
    */undefined4 RendererSceneRenderImplementation::SceneShaderForwardMobile::get_pipeline_compilations(SceneShaderForwardMobile *this, int param_2) {
   undefined4 uVar1;
   int iVar2;
   iVar2 = pthread_mutex_lock((pthread_mutex_t*)singleton_mutex);
   if (iVar2 == 0) {
   ...
   /* WARNING: Subroutine does not return */
   std::__throw_system_error(iVar2);
}/* RendererSceneRenderImplementation::SceneShaderForwardMobile::is_multiview_enabled() const */void RendererSceneRenderImplementation::SceneShaderForwardMobile::is_multiview_enabled(SceneShaderForwardMobile *this) {
   ...
   LAB_001016cb:pvVar6 = *(void**)( this + 0x608 );
   if (pvVar6 != (void*)0x0) {
      if (*(int*)( this + 0x62c ) != 0) {
   ...
   LAB_001017bb:pvVar6 = *(void**)( this + 0x5d8 );
   if (pvVar6 != (void*)0x0) {
      if (*(int*)( this + 0x5fc ) != 0) {
   ...
   LAB_001018a9:pvVar6 = *(void**)( this + 0x5a8 );
   if (pvVar6 != (void*)0x0) {
      if (*(int*)( this + 0x5cc ) != 0) {
   ...
   LAB_00101999:pvVar6 = *(void**)( this + 0x578 );
   if (pvVar6 != (void*)0x0) {
      if (*(int*)( this + 0x59c ) != 0) {
   ...
   LAB_00101c06:pvVar6 = *(void**)( this + 0x4d8 );
   if (pvVar6 != (void*)0x0) {
      if (*(int*)( this + 0x4fc ) != 0) {
   ...
   LAB_00101d74:ShaderLanguage::~ShaderLanguage((ShaderLanguage*)( this + 0x188 ));
   *(undefined***)( this + 0x10 ) = &PTR__SceneForwardMobileShaderRD_00111d18;
   ShaderRD::~ShaderRD((ShaderRD*)( this + 0x10 ));
   return;
   ...
   _err_print_error("push_back", "./core/templates/vector.h", 0x142, "Condition \"err\" is true. Returning: true", 0, 0);
   return;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RendererSceneRenderImplementation::SceneShaderForwardMobile::init(String) */void RendererSceneRenderImplementation::SceneShaderForwardMobile::init(SceneShaderForwardMobile *this, Vector *param_2) {
   undefined8 *puVar1;
   code *pcVar2;
   char *pcVar3;
   uint *puVar4;
   ...
   HashMap<StringName,String,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,String>>> local_208[8];
   undefined1 local_200[16];
   undefined1 local_1f0[16];
   undefined8 local_1e0;
   HashMap<StringName,String,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,String>>> local_1d8[8];
   ...
   *(undefined8*)( this + 0x6d8 ) = uVar17;
   ...
   local_130._8_8_ = 0;
   Vector<RenderingDevice::Uniform>::push_back((Vector<RenderingDevice::Uniform>*)&local_238, (String*)&local_148);
   ...
   StringName::StringName((StringName*)&local_248, "NORMAL", false);
   pSVar18 = (StrRange*)HashMap<StringName,String,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,String>>>::operator [](local_1d8, (StringName*)&local_248);
   ...
   pSVar18 = (StrRange*)HashMap<StringName,String,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,String>>>::operator [](local_208, (StringName*)&local_248);
   ...
   StringName::StringName((StringName*)&local_148, "rendering/shading/overrides/force_lambert_over_burley", false);
   ...
   ProjectSettings::get_singleton();
   StringName::StringName((StringName*)&local_148, "rendering/shading/overrides/force_vertex_shading", false);
   ProjectSettings::get_setting_with_override((StringName*)local_58);
   bVar13 = Variant::operator_cast_to_bool((Variant*)local_58);
   if (Variant::needs_deinit[local_58[0]] != '\0') {
      Variant::_clear_internal();
   ...
   if (5 < *(uint*)( hash_table_size_primes + ( local_210 & 0xffffffff ) * 4 )) {
      do {
         if (*(uint*)( hash_table_size_primes + ( local_210 & 0xffffffff ) * 4 ) <= *(uint*)( hash_table_size_primes + uVar19 * 4 )) {
   ...
   LAB_00106453:if (local_210._4_4_ != 0) {
      for (puVar1 = (undefined8*)local_220._0_8_; puVar1 != (undefined8*)0x0; puVar1 = (undefined8*)*puVar1) {
         HashMap<StringName,String,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,String>>>::insert((StringName*)&local_248, (String*)&local_148, (bool)( (char)puVar1 + '\x10' ));
      }
   }
   local_f0 = 0;
   ...
   if (5 < *(uint*)( hash_table_size_primes + ( local_1e0 & 0xffffffff ) * 4 )) {
      do {
         if (*(uint*)( hash_table_size_primes + ( local_1e0 & 0xffffffff ) * 4 ) <= *(uint*)( hash_table_size_primes + uVar19 * 4 )) {
   ...
   LAB_00106509:if (( local_1e0._4_4_ != 0 ) && ( (long*)local_1f0._0_8_ != (long*)0x0 )) {
      plVar23 = (long*)local_1f0._0_8_;
      do {
         HashMap<StringName,String,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,String>>>::insert((StringName*)&local_248, (String*)&local_118, (bool)( (char)plVar23 + '\x10' ));
   ...
   if (5 < *(uint*)( hash_table_size_primes + ( local_1b0 & 0xffffffff ) * 4 )) {
      do {
         if (*(uint*)( hash_table_size_primes + ( local_1b0 & 0xffffffff ) * 4 ) <= *(uint*)( hash_table_size_primes + uVar19 * 4 )) {
   ...
   LAB_001065d9:if (( local_1b0._4_4_ != 0 ) && ( (long*)local_1c0._0_8_ != (long*)0x0 )) {
      plVar23 = (long*)local_1c0._0_8_;
      do {
         HashMap<StringName,String,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,String>>>::insert((StringName*)&local_248, local_e8, (bool)( (char)plVar23 + '\x10' ));
         plVar23 = (long*)*plVar23;
      } while ( plVar23 != (long*)0x0 );
   }
   local_90 = 0;
   ...
   if (5 < *(uint*)( hash_table_size_primes + ( local_180 & 0xffffffff ) * 4 )) {
      do {
         if (*(uint*)( hash_table_size_primes + ( local_180 & 0xffffffff ) * 4 ) <= *(uint*)( hash_table_size_primes + uVar19 * 4 )) {
   ...
   LAB_001066aa:if (( local_180._4_4_ != 0 ) && ( (long*)local_190._0_8_ != (long*)0x0 )) {
      plVar23 = (long*)local_190._0_8_;
      do {
         HashMap<StringName,String,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,String>>>::insert((StringName*)&local_248, local_b8, (bool)( (char)plVar23 + '\x10' ));
         plVar23 = (long*)*plVar23;
      } while ( plVar23 != (long*)0x0 );
   }
   local_78 = 0;
   ...
   ShaderCompiler::DefaultIdentifierActions::~DefaultIdentifierActions((DefaultIdentifierActions*)&local_148);
   ShaderCompiler::DefaultIdentifierActions::~DefaultIdentifierActions((DefaultIdentifierActions*)&local_238);
   ...
   *(undefined8*)( this + 0x698 ) = uVar20;
   ...
   ( **(code**)( *plVar15 + 0xe8 ) )(plVar15, *(undefined8*)( this + 0x698 ), *(undefined8*)( this + 0x690 ));
   uVar19 = *(ulong*)( this + 0x698 );
   if (( uVar19 == 0 ) || ( *(uint*)( (long)plVar15 + 0x26c ) <= (uint)uVar19 )) goto LAB_0010caba;
   lVar21 = ( ( uVar19 & 0xffffffff ) % ( ulong ) * (uint*)( plVar15 + 0x4d ) ) * 0xc0 + *(long*)( plVar15[0x4b] + ( ( uVar19 & 0xffffffff ) / ( ulong ) * (uint*)( plVar15 + 0x4d ) ) * 8 );
   if (*(int*)( lVar21 + 0xb8 ) != (int)( uVar19 >> 0x20 )) {
      if (*(int*)( lVar21 + 0xb8 ) + 0x80000000U < 0x7fffffff) {
         _err_print_error("get_or_null", "./core/templates/rid_owner.h", 0x103, "Method/function failed. Returning: nullptr", "Attempting to use an uninitialized RID", 0, 0, uVar17);
      }
      goto LAB_0010caba;
   }
   ...
   if (*(long*)( this + 0x28 ) == 0) {
      lVar26 = 0;
      LAB_00106f7f:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 0, lVar26, "p_variant", "variant_defines.size()", "", false, false);
      LAB_00106fb8:uVar17 = 0;
   } else {
      lVar26 = *(long*)( *(long*)( this + 0x28 ) + -8 );
      if (lVar26 < 1) goto LAB_00106f7f;
      pcVar3 = *(char**)( this + 0x38 );
      if (pcVar3 == (char*)0x0) {
         LAB_00107030:lVar26 = 0;
         LAB_00107033:uVar19 = 0;
         LAB_00107050:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar19, lVar26, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
      ...
      if (*pcVar3 != '\0') {
         if (( uVar19 == 0 ) || ( *(uint*)( this + 0xe4 ) <= (uint)uVar19 )) {
            LAB_00106ff0:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
            uVar17 = 0;
            goto LAB_00106a03;
         }
         lVar22 = ( ( uVar19 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0xe0 ) ) * 0xa0 + *(long*)( *(long*)( this + 0xd0 ) + ( ( uVar19 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0xe0 ) ) * 8 );
   ...
   LAB_00106a03:*(undefined8*)( this + 0x6c0 ) = uVar17;
   ...
   *(undefined8*)( this + 0x6a8 ) = uVar17;
   ...
   ( **(code**)( *plVar15 + 0xe8 ) )(plVar15, *(undefined8*)( this + 0x6a8 ), *(undefined8*)( this + 0x6a0 ));
      ...
      if (*(int*)( lVar21 + 0xb8 ) == (int)( uVar19 >> 0x20 )) {
         if (*(int*)( lVar21 + 0x18 ) == 1) {
            ...
            *(undefined8*)( this + 0x6b8 ) = uVar17;
            ( **(code**)( *plVar15 + 0xd0 ) )(plVar15, uVar17);
            ( **(code**)( *plVar15 + 0xe8 ) )(plVar15, *(undefined8*)( this + 0x6b8 ), *(undefined8*)( this + 0x6b0 ));
               ...
               if (*(int*)( lVar21 + 0xb8 ) == (int)( uVar19 >> 0x20 )) {
                  if (*(int*)( lVar21 + 0x18 ) == 1) {
                     ...
                     *(undefined8*)( this + 0x6c8 ) = uVar17;
                     ...
                     Vector<RenderingDevice::Uniform>::push_back((Vector<RenderingDevice::Uniform>*)&local_238, (String*)&local_148);
                     uVar17 = RenderingDevice::get_singleton();
                     uVar17 = RenderingDevice::uniform_set_create<Vector<RenderingDevice::Uniform>>(uVar17, (StrRange*)&local_238, *(undefined8*)( this + 0x6c0 ), 2, 0);
                  ...
                  _err_print_error("get_or_null", "./core/templates/rid_owner.h", 0x103, "Method/function failed. Returning: nullptr", "Attempting to use an uninitialized RID", 0, 0, lVar21);
               }
            }
         }
      } else if (*(int*)( lVar21 + 0xb8 ) + 0x80000000U < 0x7fffffff) {
   ...
   LAB_0010caba:/* WARNING: Does not return */pcVar2 = (code*)invalidInstructionException();
   ( *pcVar2 )();
   ...
   _err_print_error("push_back", "./core/templates/vector.h", 0x142, "Condition \"err\" is true. Returning: true", 0, 0);
   return;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::_create_pipeline(RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::PipelineKey)
    */void RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::_create_pipeline(ShaderData *param_1) {
   long *plVar1;
   code *pcVar2;
   uint uVar3;
   undefined8 uVar4;
   ...
   if (( param_1[0x229] == (ShaderData)0x0 ) && ( param_1[0x22a] == (ShaderData)0x0 )) {
      if (uStack0000000000000030 == 4) {
         ...
         if (local_88 == local_58) {
            LAB_00107dc0:local_80 = local_50;
            uStack_78 = uStack_48;
            uVar11 = uStack0000000000000030;
            local_98[0] = local_68;
            local_94 = local_64;
         ...
         if (uVar3 < 2) {
            ...
            local_94 = local_154;
            if (local_148 != 0) {
               CowData<RenderingDeviceCommons::PipelineColorBlendState::Attachment>::_ref((CowData<RenderingDeviceCommons::PipelineColorBlendState::Attachment>*)&local_88, (CowData*)&local_148);
            }
            local_80 = local_140;
      ...
      if (uStack0000000000000030 == 4) {
         ...
         if (uVar3 < 2) {
            ...
            local_94 = local_184;
            if (local_178 != 0) {
               CowData<RenderingDeviceCommons::PipelineColorBlendState::Attachment>::_ref((CowData<RenderingDeviceCommons::PipelineColorBlendState::Attachment>*)&local_88, (CowData*)&local_178);
            }
            local_80 = local_170;
   ...
   uStack_26c = 0;
   uVar5 = 1;
   Vector<RenderingDeviceCommons::PipelineSpecializationConstant>::push_back(&local_278, 1, uStack0000000000000020);
   uVar13 = CONCAT44(1, uVar5);
   Vector<RenderingDeviceCommons::PipelineSpecializationConstant>::push_back(&local_278, uVar13, uStack0000000000000024);
   Vector<RenderingDeviceCommons::PipelineSpecializationConstant>::push_back(&local_278, CONCAT44(2, (int)uVar13), uStack0000000000000028);
   uVar13 = _LC342;
   Vector<RenderingDeviceCommons::PipelineSpecializationConstant>::push_back(&local_278, 0x300000002, uStack000000000000002c);
   if (( *(long*)( param_1 + 0x158 ) == 0 ) || ( lVar6 = get_shader_variant(param_1, uVar11, iStack000000000000003c != 0) ),lVar6 == 0) {
      _err_print_error("_create_pipeline", "servers/rendering/renderer_rd/forward_mobile/scene_shader_forward_mobile.cpp", 0x15d, "Condition \"shader_rid.is_null()\" is true.", 0, 0);
   } else {
      uVar7 = RenderingDevice::get_singleton();
      lVar6 = RenderingDevice::render_pipeline_create(uVar7, lVar6, uVar4, in_stack_00000008, uVar12, &local_258, &local_228, &local_1f8, local_98, 0, uStack0000000000000034, &local_278, uVar13);
      if (lVar6 != 0) {
      ...
      _err_print_error("_create_pipeline", "servers/rendering/renderer_rd/forward_mobile/scene_shader_forward_mobile.cpp", 0x160, "Condition \"pipeline.is_null()\" is true.", 0, 0);
   }
   lVar6 = CONCAT44(uStack_26c, uStack_270);
   joined_r0x00107922:if (lVar6 != 0) {
      LOCK();
            ...
            *(Element**)( pEVar37 + 0x10 ) = pEVar46;
            if (( *(Element**)( this + 0x28 ) == pEVar40 ) || ( *puVar56 < *(uint*)( pEVar40 + 0x30 ) )) {
               ...
               *(Element**)( pEVar40 + 8 ) = pEVar37;
               ...
               LAB_001080bd:if (pEVar50 == pEVar39) {
                  pEVar39 = (Element*)0x0;
               }
            }
            *(Element**)( pEVar37 + 0x20 ) = pEVar39;
            if (pEVar46 == *(Element**)( this + 0x30 )) {
               ...
               *(undefined8*)( pEVar37 + 0x28 ) = 0;
               ...
               LAB_001080ec:*(Element**)( pEVar37 + 0x28 ) = pEVar40;
               if (pEVar39 != (Element*)0x0) {
                  LAB_001080f5:*(Element**)( pEVar39 + 0x28 ) = pEVar37;
                  pEVar40 = *(Element**)( pEVar37 + 0x28 );
                  if (pEVar40 == (Element*)0x0) goto LAB_00108106;
               }
               *(Element**)( pEVar40 + 0x20 ) = pEVar37;
            }
            LAB_00108106:*(int*)( this + 0x38 ) = *(int*)( this + 0x38 ) + 1;
            ...
            uVar54 = *puVar56;
            LAB_00108126:*(undefined8*)( pEVar37 + 0x38 ) = *(undefined8*)( puVar56 + 2 );
            if (in_FS_OFFSET[1] == 0) {
               lVar44 = 1;
            } else {
            ...
            LAB_00108184:puVar56 = puVar56 + 4;
      ...
      if (iVar35 == 0) {
         ...
         if (local_58 != local_50) {
            ...
            do {
               if (( lVar44 != 0 ) && ( *(int*)( this + 0xbc ) != 0 )) {
                  ...
                  if (uVar36 != 0) {
                     ...
                     while (( uVar55 != uVar36 || ( uVar54 != *(uint*)( *(long*)( lVar44 + lVar41 * 8 ) + 0x10 ) ) )) {
                        ...
                        if (( uVar36 == 0 ) || ( auVar10._8_8_ = 0 ),auVar10._0_8_ = uVar36 * uVar6,auVar23._8_8_ = 0,auVar23._0_8_ = uVar45,auVar11._8_8_ = 0,auVar11._0_8_ = ( ( uVar4 + uVar53 ) - SUB164(auVar10 * auVar23, 8) ) * uVar6,auVar24._8_8_ = 0,auVar24._0_8_ = uVar45,SUB164(auVar11 * auVar24, 8) < uVar52) goto LAB_00108539;
                     };
               ...
               LAB_00108539:local_58 = local_58 + 1;
   ...
   *(int*)( this + 0xbc ) = *(int*)( this + 0xbc ) + -1;
   goto LAB_00108539;
   LAB_001083a8:uVar36 = *(uint*)( lVar57 + uVar43 * 4 );
   uVar51 = uVar43 & 0xffffffff;
   uVar53 = uVar53 + 1;
   if (( uVar36 == 0 ) || ( auVar13._8_8_ = 0 ),auVar13._0_8_ = uVar36 * uVar6,auVar26._8_8_ = 0,auVar26._0_8_ = uVar45,auVar14._8_8_ = 0,auVar14._0_8_ = ( ( uVar4 + uVar52 ) - SUB164(auVar13 * auVar26, 8) ) * uVar6,auVar27._8_8_ = 0,auVar27._0_8_ = uVar45,uVar42 = uVar43,SUB164(auVar14 * auVar27, 8) < uVar53) goto LAB_00108539;
   goto LAB_001083e7;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::set_code(String const&)
    */void RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::set_code(ShaderData *this, String *param_1) {
   long *plVar1;
   uint uVar2;
   undefined8 *puVar3;
   ...
   *(undefined4*)( this + 0x200 ) = 0;
   ...
   if (( *(long*)( this + 0x208 ) == 0 ) || ( *(uint*)( *(long*)( this + 0x208 ) + -8 ) < 2 )) goto LAB_00108961;
   local_1d0 = (undefined1[16])0x0;
   local_4c = 0;
   ...
   *puVar9 = 1;
   ...
   plVar10 = (long*)HashMap<StringName,Pair<int*,int>,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Pair<int*,int>>>>::operator [](local_1a8, (StringName*)&local_1e8);
   bVar16 = StringName::configured != '\0';
   *plVar10 = (long)pSVar8;
   ...
   *(undefined4*)( plVar10 + 1 ) = 2;
   ...
   plVar10 = (long*)HashMap<StringName,bool*,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,bool*>>>::operator [](local_178, (StringName*)&local_1e8);
   bVar16 = StringName::configured != '\0';
   ...
   *plVar10 = (long)( this + 0x228 );
   ...
   plVar10 = (long*)HashMap<StringName,bool*,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,bool*>>>::operator [](local_118, (StringName*)&local_1e8);
   bVar16 = StringName::configured != '\0';
   ...
   *plVar10 = (long)( this + 0x236 );
   ...
   iVar7 = pthread_mutex_lock((pthread_mutex_t*)singleton_mutex);
   if (iVar7 != 0) {
      LAB_00109d57:/* WARNING: Subroutine does not return */std::__throw_system_error(iVar7);
   }
   iVar7 = ShaderCompiler::compile(singleton + 0x188, 0, (CowData<char32_t>*)( this + 0x208 ), local_1d8, this + 8, local_d8);
   if (iVar7 == 0) {
      if (*(long*)( this + 0x158 ) == 0) {
      ...
      *(uint*)( this + 0x239 ) = CONCAT31(CONCAT21(CONCAT11(local_50._3_1_, local_4a), local_4c._1_1_), (undefined1)local_4c);
      *(ushort*)( this + 0x230 ) = CONCAT11(this[0x231], this[0x233]) | CONCAT11(this[0x233], this[0x230]);
      if (( this[0x237] != (ShaderData)0x0 ) && ( set_code(String_const&):: )) {
         _err_print_error("set_code", "servers/rendering/renderer_rd/forward_mobile/scene_shader_forward_mobile.cpp", 0xac, "Subsurface scattering is only available when using the Forward+ renderer.", 1, 1);
         set_code(String_const&)::first_print =
         '\0';
      }
      if (( this[0x238] != (ShaderData)0x0 ) && ( set_code(String_const&):: )) {
         _err_print_error("set_code", "servers/rendering/renderer_rd/forward_mobile/scene_shader_forward_mobile.cpp", 0xb0, "Transmittance is only available when using the Forward+ renderer.", 1, 1);
         set_code(String_const&)::first_print =
         '\0';
      }
      ShaderRD::version_set_code(singleton + 0x10, *(undefined8*)( this + 0x158 ), local_80, local_a0, local_a0 + 8, local_90, local_d8);
      *(undefined4*)( this + 0x200 ) = local_a8;
      ...
      LAB_00109770:if (( *(long*)( this + 0x1e8 ) != local_c0[0] ) && ( CowData<ShaderCompiler::GeneratedCode::Texture>::_unref((CowData<ShaderCompiler::GeneratedCode::Texture>*)( this + 0x1e8 )),local_c0[0] != 0 )) {
      ...
      LAB_001097c6:iVar7 = pthread_mutex_lock((pthread_mutex_t*)( this + 0x130 ));
      if (iVar7 != 0) goto LAB_00109d57;
      for (puVar3 = *(undefined8**)( this + 0x118 ); puVar3 != (undefined8*)0x0; puVar3 = (undefined8*)*puVar3) {
      ...
      LAB_001099c6:plVar10 = (long*)( local_90 + 8 );
      do {
         if (*plVar10 != 0) {
            LOCK();
      ...
      _err_print_error("set_code", "servers/rendering/renderer_rd/forward_mobile/scene_shader_forward_mobile.cpp", 0x98, "Method/function failed.", "Shader compilation failed.", 0, 0);
      pthread_mutex_unlock((pthread_mutex_t*)singleton_mutex);
      ShaderCompiler::IdentifierActions::~IdentifierActions((IdentifierActions*)local_1d8);
      if ((void*)local_78._0_8_ != (void*)0x0) {
         pvVar15 = (void*)local_78._0_8_;
      ...
      LAB_00109bc7:this_00 = (CowData<char32_t>*)( local_90 + 8 );
      do {
         if (*(long*)this_00 != 0) {
            LOCK();
   ...
   LAB_00108961:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return;
   ...
   const&) */void RendererSceneRenderImplementation::SceneShaderForwardMobile::set_default_specialization(SceneShaderForwardMobile *this, ShaderSpecialization *param_1) {
   long lVar1;
   long lVar2;
   undefined8 *puVar3;
   long lVar4;
...
}/* RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::~ShaderData() */void RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::~ShaderData(ShaderData *this) {
   undefined8 *puVar1;
   long lVar2;
   long *plVar3;
   int iVar4;
   ...
   *(undefined***)this = &PTR_set_path_hint_00111d38;
   ...
   if (iVar4 != 0) {
      LAB_0010a15e:/* WARNING: Subroutine does not return */std::__throw_system_error(iVar4);
   }
   ...
   if (*(long*)( this + 0x158 ) != 0) {
      ...
      if (singleton == 0) {
         _err_print_error("~ShaderData", "servers/rendering/renderer_rd/forward_mobile/scene_shader_forward_mobile.cpp", 0x1a3, "Parameter \"SceneShaderForwardMobile::singleton\" is null.", 0, 0);
         pthread_mutex_unlock((pthread_mutex_t*)singleton_mutex);
   ...
   LAB_00109fc7:if (*(long*)( this + 0x208 ) != 0) {
      LOCK();
   ...
   CowData<ShaderCompiler::GeneratedCode::Texture>::_unref((CowData<ShaderCompiler::GeneratedCode::Texture>*)( this + 0x1e8 ));
   PipelineHashMapRD<RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::PipelineKey,RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData,void(RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::*)(RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::PipelineKey)>::~PipelineHashMapRD((PipelineHashMapRD<RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::PipelineKey,RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData,void(RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::*)(RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::PipelineKey)>*)( this + 0x70 ));
   ...
   return;
}/* SceneForwardMobileShaderRD::~SceneForwardMobileShaderRD() */void SceneForwardMobileShaderRD::~SceneForwardMobileShaderRD(SceneForwardMobileShaderRD *this) {
   ...
   *(undefined***)this = &PTR__SceneForwardMobileShaderRD_00111d18;
   ...
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}/* RendererSceneRenderImplementation::SceneShaderForwardMobile::init(String) [clone .cold] */void RendererSceneRenderImplementation::SceneShaderForwardMobile::init(undefined8 param_1, undefined8 param_2, int param_3) {
   code *pcVar1;
   ...
   const */uint RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::PipelineKey::hash(PipelineKey *this) {
   float fVar1;
   uint uVar2;
   ...
   LAB_0010ce0c:pvVar3 = *(void**)( this + 0x98 );
   if (pvVar3 != (void*)0x0) {
      if (*(int*)( this + 0xbc ) != 0) {
   ...
   LAB_0010cecc:pvVar3 = *(void**)( this + 0x68 );
   if (pvVar3 != (void*)0x0) {
      if (*(int*)( this + 0x8c ) != 0) {
   ...
   LAB_0010cf83:pvVar3 = *(void**)( this + 0x38 );
   if (pvVar3 != (void*)0x0) {
      if (*(int*)( this + 0x5c ) != 0) {
   ...
   LAB_0010d02e:pvVar3 = *(void**)( this + 8 );
   if (pvVar3 == (void*)0x0) {
      return;
   }
   if (*(int*)( this + 0x2c ) != 0) {
   ...
   return;
}/* RendererSceneRenderImplementation::SceneShaderForwardMobile::_create_shader_funcs() */void RendererSceneRenderImplementation::SceneShaderForwardMobile::_create_shader_funcs(void) {
   _create_shader_func();
   return;
}/* RendererSceneRenderImplementation::SceneShaderForwardMobile::_create_material_funcs(RendererRD::MaterialStorage::ShaderData*)
    */void RendererSceneRenderImplementation::SceneShaderForwardMobile::_create_material_funcs(ShaderData *param_1) {
   ...
   void *pvVar5;
   for (int i = 0; i < 3; i++) {
      if (*(long*)( this + ( -8*i + 224 ) ) != 0) {
         LOCK();
         plVar1 = (long*)( *(long*)( this + ( -8*i + 224 ) ) + -16 );
         *plVar1 = *plVar1 + -1;
         UNLOCK();
         if (*plVar1 == 0) {
            lVar4 = *(long*)( this + ( -8*i + 224 ) );
   ...
   LAB_0010d363:pvVar5 = *(void**)( this + 0x68 );
   if (pvVar5 != (void*)0x0) {
      if (*(int*)( this + 0x8c ) != 0) {
   ...
   LAB_0010d442:pvVar5 = *(void**)( this + 0x38 );
   if (pvVar5 != (void*)0x0) {
      if (*(int*)( this + 0x5c ) != 0) {
   ...
   LAB_0010d51d:pvVar5 = *(void**)( this + 8 );
   if (pvVar5 == (void*)0x0) {
      return;
   }
   if (*(int*)( this + 0x2c ) != 0) {
   ...
   *(void**)( this + 8 ) = pvVar44;
   if ((int)uVar40 != 0) {
      ...
      LAB_0010dd0c:if (iVar46 != 0) {
         LAB_0010dd14:uVar38 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
   ...
   LAB_0010d969:uVar38 = *(uint*)( this + 0x28 );
   if (uVar38 == 0x1c) {
   ...
   *(void**)( this + 8 ) = __s_00;
   ...
   if (iVar46 != 0) {
      ...
      LAB_0010dd08:iVar46 = *(int*)( this + 0x2c );
      goto LAB_0010dd0c;
   }
   LAB_0010d943:if ((float)uVar40 * __LC37 < (float)( iVar46 + 1 )) goto LAB_0010d969;
   ...
   *(undefined8**)( this + 0x20 ) = puVar42;
   ...
   LAB_0010dbf4:uVar38 = *(uint*)( lVar43 + 0x20 );
} else {
   *puVar4 = puVar42;
   puVar42[1] = puVar4;
   lVar43 = *(long*)param_1;
   *(undefined8**)( this + 0x20 ) = puVar42;
   ...
   LAB_0010de1d:uVar38 = StringName::get_empty_hash();
}if (uVar38 == 0) {
   uVar38 = 1;
   ...
   puVar4 = puVar55;
   uVar52 = *puVar1;
};*(undefined8**)( lVar47 + lVar48 * 8 ) = puVar4;*puVar1 = uVar38;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_0010d90c:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return puVar42 + 3;
   ...
   *(void**)( this + 8 ) = pvVar44;
   if ((int)uVar40 != 0) {
      ...
      memset(pvVar44, 0, uVar50);
      iVar46 = *(int*)( this + 0x2c );
      LAB_0010e48c:if (iVar46 != 0) {
         LAB_0010e494:uVar38 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
         uVar45 = CONCAT44(0, uVar38);
         lVar43 = *(long*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( this + 0x28 ) * 8 );
         if (*(long*)param_1 == 0) {
            uVar39 = StringName::get_empty_hash();
   ...
   LAB_0010e0d9:uVar38 = *(uint*)( this + 0x28 );
   if (uVar38 == 0x1c) {
      puVar42 = (undefined8*)0x0;
      _err_print_error("_insert", "./core/templates/hash_map.h", 0xdd, "Condition \"capacity_index + 1 == HASH_TABLE_SIZE_MAX\" is true. Returning: nullptr", "Hash table maximum capacity reached, aborting insertion.", 0, 0);
      goto LAB_0010e07c;
   ...
   *(void**)( this + 8 ) = __s_00;
   ...
   if (iVar46 != 0) {
      ...
      LAB_0010e488:iVar46 = *(int*)( this + 0x2c );
      goto LAB_0010e48c;
   }
   LAB_0010e0b3:if ((float)uVar40 * __LC37 < (float)( iVar46 + 1 )) goto LAB_0010e0d9;
   ...
   *(undefined8**)( this + 0x20 ) = puVar42;
   ...
   LAB_0010e370:uVar38 = *(uint*)( lVar43 + 0x20 );
} else {
   *puVar4 = puVar42;
   puVar42[1] = puVar4;
   lVar43 = *(long*)param_1;
   *(undefined8**)( this + 0x20 ) = puVar42;
   ...
   LAB_0010e59d:uVar38 = StringName::get_empty_hash();
}if (uVar38 == 0) {
   uVar38 = 1;
}uVar40 = (ulong)uVar38;lVar43 = *(long*)( this + 0x10 );uVar53 = 0;lVar49 = *(long*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( this + 0x28 ) * 8 );uVar39 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );uVar45 = CONCAT44(0, uVar39);auVar13._8_8_ = 0;auVar13._0_8_ = uVar40 * lVar49;auVar29._8_8_ = 0;auVar29._0_8_ = uVar45;lVar48 = SUB168(auVar13 * auVar29, 8);lVar47 = *(long*)( this + 8 );puVar1 = (uint*)( lVar43 + lVar48 * 4 );iVar46 = SUB164(auVar13 * auVar29, 8);uVar52 = *puVar1;puVar4 = puVar42;while (uVar52 != 0) {
   auVar14._8_8_ = 0;
   ...
   puVar4 = puVar55;
   uVar52 = *puVar1;
};*(undefined8**)( lVar47 + lVar48 * 8 ) = puVar4;*puVar1 = uVar38;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_0010e07c:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return puVar42 + 3;
   ...
   *(void**)( this + 8 ) = pvVar44;
   if ((int)uVar40 != 0) {
      ...
      memset(pvVar44, 0, uVar50);
      iVar46 = *(int*)( this + 0x2c );
      LAB_0010ebfc:if (iVar46 != 0) {
         LAB_0010ec04:uVar38 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
         uVar45 = CONCAT44(0, uVar38);
         lVar43 = *(long*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( this + 0x28 ) * 8 );
         if (*(long*)param_1 == 0) {
            uVar39 = StringName::get_empty_hash();
   ...
   LAB_0010e859:uVar38 = *(uint*)( this + 0x28 );
   if (uVar38 == 0x1c) {
      puVar42 = (undefined8*)0x0;
      _err_print_error("_insert", "./core/templates/hash_map.h", 0xdd, "Condition \"capacity_index + 1 == HASH_TABLE_SIZE_MAX\" is true. Returning: nullptr", "Hash table maximum capacity reached, aborting insertion.", 0, 0);
      goto LAB_0010e7fc;
   ...
   *(void**)( this + 8 ) = __s_00;
   ...
   if (iVar46 != 0) {
      ...
      LAB_0010ebf8:iVar46 = *(int*)( this + 0x2c );
      goto LAB_0010ebfc;
   }
   LAB_0010e833:if ((float)uVar40 * __LC37 < (float)( iVar46 + 1 )) goto LAB_0010e859;
   ...
   *(undefined8**)( this + 0x20 ) = puVar42;
   ...
   LAB_0010eae7:uVar38 = *(uint*)( lVar43 + 0x20 );
} else {
   *puVar4 = puVar42;
   puVar42[1] = puVar4;
   lVar43 = *(long*)param_1;
   *(undefined8**)( this + 0x20 ) = puVar42;
   ...
   LAB_0010ed0d:uVar38 = StringName::get_empty_hash();
}if (uVar38 == 0) {
   uVar38 = 1;
}uVar40 = (ulong)uVar38;lVar43 = *(long*)( this + 0x10 );uVar53 = 0;lVar49 = *(long*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( this + 0x28 ) * 8 );uVar39 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );uVar45 = CONCAT44(0, uVar39);auVar13._8_8_ = 0;auVar13._0_8_ = uVar40 * lVar49;auVar29._8_8_ = 0;auVar29._0_8_ = uVar45;lVar48 = SUB168(auVar13 * auVar29, 8);lVar47 = *(long*)( this + 8 );puVar1 = (uint*)( lVar43 + lVar48 * 4 );iVar46 = SUB164(auVar13 * auVar29, 8);uVar52 = *puVar1;puVar4 = puVar42;while (uVar52 != 0) {
   auVar14._8_8_ = 0;
   ...
   puVar4 = puVar55;
   uVar52 = *puVar1;
};*(undefined8**)( lVar47 + lVar48 * 8 ) = puVar4;*puVar1 = uVar38;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_0010e7fc:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return puVar42 + 3;
   ...
   *(undefined8*)this = 0;
   ...
   if (param_1 * 8 == 0) {
      LAB_0010f6d0:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   uVar8 = param_1 * 8 - 1;
   uVar8 = uVar8 >> 1 | uVar8;
   ...
   if (lVar10 == lVar7) {
      LAB_0010f64f:puVar9 = *(undefined8**)this;
      if (puVar9 == (undefined8*)0x0) {
         LAB_0010f726:/* WARNING: Does not return */pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
      }
      lVar6 = puVar9[-1];
   ...
   *(void**)( this + 8 ) = __s_00;
   if ((int)uVar43 != 0) {
      ...
      LAB_0010fc21:iVar35 = *(int*)( this + 0x2c );
      if (iVar35 != 0) {
         LAB_0010fc2d:uVar29 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
   ...
   LAB_0010fd4e:if (*(int*)( this + 0x28 ) == 0x1c) {
      _err_print_error("_insert", "./core/templates/hash_map.h", 0xdd, "Condition \"capacity_index + 1 == HASH_TABLE_SIZE_MAX\" is true. Returning: nullptr", "Hash table maximum capacity reached, aborting insertion.", 0, 0);
      lVar34 = 0;
      LAB_0010fbc8:local_88 = (CowData<char32_t>*)( lVar34 + 0x18 );
      goto LAB_0010fbd1;
   }
   ...
   local_70 = 0;
   iVar35 = 0;
   LAB_0010fd2c:if ((float)uVar43 * __LC37 < (float)( iVar35 + 1 )) goto LAB_0010fd4e;
   ...
   *(undefined8**)( this + 0x20 ) = puVar31;
   ...
   LAB_0010fe42:uVar29 = *(uint*)( lVar34 + 0x20 );
} else {
   *puVar39 = puVar31;
   puVar31[1] = puVar39;
   lVar34 = *(long*)param_1;
   *(undefined8**)( this + 0x20 ) = puVar31;
   ...
   LAB_0010ffd5:uVar29 = StringName::get_empty_hash();
...
}LAB_0010fbd1:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return local_88;
...
::insert(StringName *param_1,String *param_2,bool param_3){
   ...
   if (*(long*)( param_2 + 8 ) == 0) {
      ...
      *(void**)( param_2 + 8 ) = __s_00;
      ...
      LAB_0011028b:if (*(int*)( param_2 + 0x28 ) == 0x1c) {
         _err_print_error("_insert", "./core/templates/hash_map.h", 0xdd, "Condition \"capacity_index + 1 == HASH_TABLE_SIZE_MAX\" is true. Returning: nullptr", "Hash table maximum capacity reached, aborting insertion.", 0, 0);
         local_80 = (long*)0x0;
         goto LAB_0011045b;
      }
      ...
      LAB_00110152:iVar28 = *(int*)( param_2 + 0x2c );
      if (iVar28 != 0) {
         LAB_0011015e:uVar3 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( param_2 + 0x28 ) * 4 );
      ...
      LAB_00110269:if ((float)uVar23 * __LC37 < (float)( iVar28 + 1 )) goto LAB_0011028b;
   }
   ...
   *local_80 = 0;
   ...
   if (puVar4 == (undefined8*)0x0) {
      ...
      *(long**)( param_2 + 0x20 ) = local_80;
      LAB_0011037c:lVar25 = *(long*)pSVar29;
      if (lVar25 != 0) goto LAB_00110389;
      LAB_001104b1:uVar23 = StringName::get_empty_hash();
   } else {
      if (in_R8B == '\0') {
         *puVar4 = local_80;
      ...
      *(long**)( param_2 + 0x18 ) = local_80;
      ...
      LAB_00110389:uVar23 = *(uint*)( lVar25 + 0x20 );
   }
   ...
   *(int*)( param_2 + 0x2c ) = *(int*)( param_2 + 0x2c ) + 1;
   LAB_0011045b:*(long**)param_1 = local_80;
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
   /* WARNING: Subroutine does not return */
   ...
   if (param_1 * 0x20 == 0) {
      LAB_001108f0:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (lVar11 == lVar4) {
      LAB_0011085c:puVar9 = *(undefined8**)this;
      if (puVar9 == (undefined8*)0x0) {
         /* WARNING: Does not return */
         pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
   ...
   LAB_001109e7:if (( StringName::configured != '\0' ) && ( *(long*)( param_1 + 0x10 ) != 0 )) {
      StringName::unref();
   }
   Memory::free_static(param_1, false);
   return;
   ...
   *(code**)this = String::parse_latin1;
   ...
   LAB_00110ad9:pvVar5 = *(void**)( this + 0x18 );
   if (pvVar5 != (void*)0x0) {
      if (*(int*)( this + 0x3c ) != 0) {
         uVar2 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x38 ) * 4 );
         if (uVar2 == 0) {
   ...
   if (param_1 * 0x28 == 0) {
      LAB_00111010:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (lVar11 == lVar9) {
      LAB_00110f83:puVar7 = *(undefined8**)this;
      if (puVar7 == (undefined8*)0x0) {
         LAB_00111066:/* WARNING: Does not return */pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
      }
      lVar8 = puVar7[-1];
   ...
   lVar10 = param_1 * 0xc;
   if (lVar10 == 0) {
      LAB_00111340:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (lVar9 == lVar3) {
      LAB_001112ac:puVar8 = *(undefined8**)this;
   ...
   if (param_1 * 4 == 0) {
      LAB_00111630:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   uVar4 = param_1 * 4 - 1;
   uVar4 = uVar4 | uVar4 >> 1;
   ...
   do {
      while (true) {
         ...
         if (*(Element**)( pEVar8 + 0x10 ) == param_1) {
            ...
            *(int*)param_1 = 1;
            ...
            LAB_00111736:*(int*)pEVar5 = 0;
         } else {
            pEVar6 = *(Element**)( this + 8 );
            *(int*)pEVar8 = 1;
            pEVar8 = param_1;
            if (pEVar5 != pEVar6) goto LAB_00111736;
            LAB_001118b0:_err_print_error("_set_color", "./core/templates/rb_map.h", 0xed, "Condition \"p_node == _data._nil && p_color == RED\" is true.", 0, 0);
         }
         lVar2 = *(long*)( pEVar5 + 8 );
         lVar3 = *(long*)( this + 8 );
      ...
      if (*(int*)pEVar6 != 0) {
         if (*(Element**)( pEVar8 + 8 ) == param_1) {
            ...
            *(long*)( pEVar8 + 8 ) = lVar3;
            if (lVar2 == lVar3) {
               *(Element**)( param_1 + 0x18 ) = pEVar5;
               pEVar7 = pEVar5;
               LAB_001119a2:*(Element**)( pEVar7 + 0x10 ) = param_1;
            } else {
               *(Element**)( lVar3 + 0x18 ) = pEVar8;
               pEVar7 = *(Element**)( pEVar8 + 0x18 );
               *(Element**)( param_1 + 0x18 ) = pEVar7;
            ...
            *(int*)param_1 = 1;
            ...
            LAB_00111800:*(int*)pEVar5 = 0;
         } else {
            pEVar6 = *(Element**)( this + 8 );
            *(int*)pEVar8 = 1;
            pEVar8 = param_1;
            if (pEVar5 != pEVar6) goto LAB_00111800;
            LAB_00111970:_err_print_error("_set_color", "./core/templates/rb_map.h", 0xed, "Condition \"p_node == _data._nil && p_color == RED\" is true.", 0, 0);
         }
      ...
      LAB_0011178d:pEVar7 = *(Element**)( this + 8 );
      *(int*)pEVar8 = 1;
      *(int*)pEVar6 = 1;
      if (pEVar5 == pEVar7) {
    ...
    */void PipelineHashMapRD<RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::PipelineKey,RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData,void(RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::*)(RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::PipelineKey)>::~PipelineHashMapRD(PipelineHashMapRD<RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::PipelineKey,RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData,void(RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::*)(RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::PipelineKey)> *this) {
   uint uVar1;
   undefined8 *puVar2;
   int iVar3;
   undefined8 uVar4;
   ...
   LAB_00111b23:RBSet<unsigned_int,Comparator<unsigned_int>,DefaultAllocator>::clear((RBSet<unsigned_int,Comparator<unsigned_int>,DefaultAllocator>*)( this + 0x78 ));
   ...
   return;
}/* WARNING: Control flow encountered bad instruction data *//* PipelineHashMapRD<RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::PipelineKey,
   RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData, void
   (RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::*)(RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::PipelineKey)>::~PipelineHashMapRD()
    */void PipelineHashMapRD<RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::PipelineKey,RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData,void(RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::*)(RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::PipelineKey)>::~PipelineHashMapRD(PipelineHashMapRD<RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::PipelineKey,RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData,void(RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::*)(RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::PipelineKey)> *this) {
   ...
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}/* WARNING: Control flow encountered bad instruction data *//* SceneForwardMobileShaderRD::~SceneForwardMobileShaderRD() */void SceneForwardMobileShaderRD::~SceneForwardMobileShaderRD(SceneForwardMobileShaderRD *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();

void EVP_SIGNATURE_free(void *param_1) {
   ...
   *param_1 = param_3;
   ...
   if (*(long*)( param_1 + 0xe8 ) != 0) {
      ...
      for (int i_1685 = 0; i_1685 < 2; i_1685++) {
   ...
   if (*(long*)( param_1 + 0xf8 ) != 0) {
      uVar1 = EVP_SIGNATURE_get0_provider();
      uVar1 = ossl_provider_ctx(uVar1);
      for (int i_1686 = 0; i_1686 < 2; i_1686++) {
   ...
   if (param_1 == (int*)0x0) {
      ...
      if (*param_1 == 0x4000) {
         ...
         for (int i_1687 = 0; i_1687 < 2; i_1687++) {
   ...
   if (param_1 == (int*)0x0) {
      ...
      if (*param_1 == 0x4000) {
         ...
         for (int i_1688 = 0; i_1688 < 2; i_1688++) {
      ...
      if (( *(int*)ctx == 0x10 ) || ( *(int*)ctx == 0x4000 )) {
         if (*(long*)( ctx + 0x30 ) == 0) {
            ...
            if (*(code**)( *(long*)( ctx + 0x28 ) + 0x38 ) != (code*)0x0) {
               for (int i_1689 = 0; i_1689 < 2; i_1689++) {
   ...
   if (param_1 == (int*)0x0) {
      ...
      if (*param_1 == 0x8000) {
         ...
         for (int i_1690 = 0; i_1690 < 2; i_1690++) {
   ...
   if (param_1 == (int*)0x0) {
      ...
      if (*param_1 == 0x8000) {
         ...
         for (int i_1691 = 0; i_1691 < 2; i_1691++) {
      ...
      if (( *(int*)ctx == 0x20 ) || ( *(int*)ctx == 0x8000 )) {
         if (*(long*)( ctx + 0x30 ) == 0) {
            if (( *(long*)( ctx + 0x78 ) != 0 ) && ( UNRECOVERED_JUMPTABLE = *(code**)( *(long*)( ctx + 0x78 ) + 0x58 ) ),UNRECOVERED_JUMPTABLE != (code*)0x0) {
               for (int i_1692 = 0; i_1692 < 2; i_1692++) {
            ...
            if (*(code**)( *(long*)( ctx + 0x28 ) + 0x60 ) != (code*)0x0) {
               for (int i_1693 = 0; i_1693 < 2; i_1693++) {
      ...
      if (*(int*)ctx == 0x40) {
         if (*(long*)( ctx + 0x30 ) == 0) {
            ...
            if (*(code**)( *(long*)( ctx + 0x28 ) + 0x88 ) != (code*)0x0) {
               for (int i_1694 = 0; i_1694 < 2; i_1694++) {

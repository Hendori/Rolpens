void lh_QUERY_hfn_thunk(undefined8 param_1, code *UNRECOVERED_JUMPTABLE) {
   for (int i_2569 = 0; i_2569 < 2; i_2569++) {
   ...
   for (int i_2570 = 0; i_2570 < 2; i_2570++) {
   ...
   for (int i_2571 = 0; i_2571 < 2; i_2571++) {
   ...
   for (int i_2572 = 0; i_2572 < 2; i_2572++) {
   ...
   *param_3 = uVar1;
   ...
   OPENSSL_LH_doall_arg_thunk(*param_3, lh_QUERY_doall_IMPL_CACHE_FLUSH_thunk, impl_cache_flush_cache, param_3);
   ...
   if (( ( ( iVar3 == 0 ) && ( uVar1 = *param_1 ),uVar1 != 0 ) ) && ( uVar2 = uVar2 != 0 )) {
      iVar3 = -(uint)(uVar2 < uVar1);
   }
   return iVar3;
}void lh_QUERY_doall_IMPL_CACHE_FLUSH_thunk(undefined8 param_1, undefined8 param_2, code *UNRECOVERED_JUMPTABLE) {
   for (int i_2573 = 0; i_2573 < 2; i_2573++) {
   ...
   *(uint*)( param_2 + 2 ) = uVar1;
   ...
   return 0;
}undefined8 ossl_method_store_add(undefined8 *param_1, long param_2, int param_3, undefined *param_4, long param_5, code *param_6, long param_7) {
   int iVar1;
   int iVar2;
   long *ptr;
   long lVar3;
   ...
   *ptr = param_2;
   ...
   if (lVar3 == 0) {
      ...
      LAB_001006bd:ptr_00 = (int*)ossl_sa_get(param_1[1], lVar7);
      if (ptr_00 == (int*)0x0) {
         ...
         if (ptr_00 != (int*)0x0) {
            ...
            *(long*)( ptr_00 + 2 ) = lVar3;
            if (lVar3 != 0) {
               ...
               lVar3 = OPENSSL_LH_set_thunks(uVar6, 0x100000, lh_QUERY_cfn_thunk, lh_QUERY_doall_thunk, lh_QUERY_doall_arg_thunk);
               *(long*)( ptr_00 + 4 ) = lVar3;
               if (lVar3 != 0) {
                  *ptr_00 = param_3;
   ...
   long lVar4;
   void *ptr;
   if (( ( param_3 != 0 && param_1 != 0 ) && ( 0 < param_2 ) ) && ( iVar1 = CRYPTO_THREAD_write_lock(*(undefined8*)( param_1 + 0x10 )) ),iVar1 != 0) {
   ...
   uVar2 = 0;
   LAB_00100a34:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar2;
   }
   ...
   CRYPTO_THREAD_unlock(*(undefined8*)( param_1 + 0x10 ));
   return;
}undefined8 ossl_method_store_fetch(undefined8 *param_1, int param_2, long param_3, long *param_4, long *param_5) {
   bool bVar1;
   int iVar2;
   int iVar3;
   long lVar4;
   ...
   if (( ( ( param_5 == (long*)0x0 || param_1 == (undefined8*)0x0 ) || ( param_2 < 1 ) ) || ( ( iVar2 = ossl_lib_ctx_is_default(*param_1) ),iVar2 != 0 && ( iVar2 = OPENSSL_init_crypto(0x40, 0) ),iVar2 == 0 ) )) {
      return 0;
   }
   ...
   if (param_3 == 0) {
      ...
      LAB_00100d75:for (iVar2 = 0; iVar3 = OPENSSL_sk_num(*(undefined8*)( lVar4 + 8 )),iVar2 < iVar3; iVar2 = iVar2 + 1) {
      ...
      LAB_00100cb7:iVar2 = ossl_property_has_optional(local_50);
      if (iVar2 == 0) {
         for (; iVar3 = OPENSSL_sk_num(*(undefined8*)( lVar4 + 8 )),iVar2 < iVar3; iVar2 = iVar2 + 1) {
            local_48 = (long*)OPENSSL_sk_value(*(undefined8*)( lVar4 + 8 ), iVar2);
            if (( local_48 != (long*)0x0 ) && ( ( ( lVar8 == 0 || ( *local_48 == lVar8 ) ) && ( iVar3 = ossl_property_match_count(local_50, local_48[1]) ),-1 < iVar3 ) )) goto LAB_00100e54;
         }
      } else {
         local_40 = -1;
         bVar1 = false;
         local_48 = (long*)0x0;
         for (iVar2 = 0; iVar3 = OPENSSL_sk_num(*(undefined8*)( lVar4 + 8 )),iVar2 < iVar3; iVar2 = iVar2 + 1) {
            plVar6 = (long*)OPENSSL_sk_value(*(undefined8*)( lVar4 + 8 ), iVar2);
            if (( ( plVar6 != (long*)0x0 ) && ( ( lVar8 == 0 || ( lVar8 == *plVar6 ) ) ) ) && ( iVar3 = ossl_property_match_count(local_50, plVar6[1]) ),local_40 < iVar3) {
               bVar1 = true;
               local_48 = plVar6;
               local_40 = iVar3;
            }
         ...
         if (bVar1) {
            LAB_00100e54:iVar2 = ( *(code*)local_48[3] )(local_48[2]);
            if (iVar2 != 0) {
               *param_5 = local_48[2];
               if (param_4 != (long*)0x0) {
                  *param_4 = *local_48;
   ...
   uVar7 = 0;
   LAB_00100dc2:CRYPTO_THREAD_unlock(param_1[2]);
   ...
   *(undefined8*)( param_1 + 0x20 ) = 0;
   CRYPTO_THREAD_unlock(*(undefined8*)( param_1 + 0x10 ));
   return 1;
}undefined8 ossl_method_store_cache_get(long param_1, undefined8 param_2, int param_3, long param_4, undefined8 *param_5) {
   int iVar1;
   long lVar2;
   undefined8 uVar3;
   long in_FS_OFFSET;
   ...
   uVar3 = 0;
   LAB_00100fda:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar3;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}undefined8 ossl_method_store_cache_set(long param_1, long param_2, int param_3, char *param_4, long param_5, code *param_6, long param_7) {
   int iVar1;
   long lVar2;
   size_t sVar3;
   long *ptr;
   ...
   if (( ( ( param_2 == 0 || param_4 == (char*)0x0 ) || param_1 == 0 ) || ( param_3 < 1 ) ) || ( iVar1 = CRYPTO_THREAD_write_lock(*(undefined8*)( param_1 + 0x10 )) ),iVar1 == 0) {
      uVar6 = 0;
      goto LAB_00101182;
   }
   ...
   lVar2 = ossl_sa_get(*(undefined8*)( param_1 + 8 ), (long)param_3);
   if (lVar2 == 0) {
      LAB_00101204:ptr = (long*)0x0;
      LAB_00101206:uVar6 = 0;
      CRYPTO_free(ptr);
   } else {
      if (param_5 == 0) {
         local_78 = param_2;

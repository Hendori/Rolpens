/* AudioDriverPulseAudio::get_mix_rate() const */undefined4 AudioDriverPulseAudio::get_mix_rate(AudioDriverPulseAudio *this) {
   ...
   *(undefined8*)in_RDI = 0;
   ...
   if (param_3 < 1) {
      if (param_3 == 0) {
         for (int i_380 = 0; i_380 < 8; i_380++) {
            uVar2 = *(undefined8*)( param_2 + ( 16*i_380 + 44 ) );
            *(undefined8*)( (long)param_4 + ( 16*i_380 + 152 ) ) = *(undefined8*)( param_2 + ( 16*i_380 + 36 ) );
            *(undefined8*)( (long)param_4 + ( 16*i_380 + 160 ) ) = uVar2;
         }
   ...
   if (param_3 < 1) {
      if (param_3 == 0) {
         for (int i_381 = 0; i_381 < 8; i_381++) {
            uVar2 = *(undefined8*)( param_2 + ( 16*i_381 + 44 ) );
            *(undefined8*)( (long)param_4 + ( 16*i_381 + 284 ) ) = *(undefined8*)( param_2 + ( 16*i_381 + 36 ) );
            *(undefined8*)( (long)param_4 + ( 16*i_381 + 292 ) ) = uVar2;
         }
         uVar6 = *(undefined4*)( param_2 + 0xa4 );
         *(int*)( (long)param_4 + 0x204 ) = *(int*)( (long)param_4 + 0x204 ) + 1;
   ...
   *(undefined***)this = &PTR_get_name_001069d0;
   ...
   for (int i_383 = 0; i_383 < 6; i_383++) {
      if (*(long*)( this + ( -8*i_383 + 456 ) ) != 0) {
         LOCK();
         plVar1 = (long*)( *(long*)( this + ( -8*i_383 + 456 ) ) + -16 );
         *plVar1 = *plVar1 + -1;
         UNLOCK();
         if (*plVar1 == 0) {
            lVar2 = *(long*)( this + ( -8*i_383 + 456 ) );
            *(undefined8*)( this + ( -8*i_383 + 456 ) ) = 0;
   ...
   *(undefined***)this = &PTR_get_name_001069d0;
   ...
   for (int i_384 = 0; i_384 < 6; i_384++) {
      if (*(long*)( this + ( -8*i_384 + 456 ) ) != 0) {
         LOCK();
         plVar1 = (long*)( *(long*)( this + ( -8*i_384 + 456 ) ) + -16 );
         *plVar1 = *plVar1 + -1;
         UNLOCK();
         if (*plVar1 == 0) {
            lVar2 = *(long*)( this + ( -8*i_384 + 456 ) );
            *(undefined8*)( this + ( -8*i_384 + 456 ) ) = 0;
            Memory::free_static((void*)( lVar2 + -16 ), false);
         }
      }
   }

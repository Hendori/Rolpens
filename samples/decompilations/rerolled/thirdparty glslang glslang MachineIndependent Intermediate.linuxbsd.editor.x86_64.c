...
LAB_001019d9: ) ;puVar5 = (undefined8*)glslang::TPoolAllocator::allocate(uVar4);puVar5[2] = 0;puVar5[1] = 0;*(undefined4*)( puVar5 + 3 ) = 0;puVar5[4] = &PTR__TType_00117c00;*(ushort*)( (long)puVar5 + 0x4c ) = *(ushort*)( (long)puVar5 + 0x4c ) | 0xfff;*(byte*)( puVar5 + 8 ) = *(byte*)( puVar5 + 8 ) & 0xf0;*(undefined1(*) [16])( puVar5 + 0x15 ) = (undefined1[16])0x0;*(uint*)( puVar5 + 5 ) = *(uint*)( puVar5 + 5 ) & 0xf8000000 | 0x101;puVar5[7] = puVar5[7] & 0x8000000400000000;*(undefined1(*) [16])( puVar5 + 0x10 ) = (undefined1[16])0x0;*(undefined1(*) [16])( puVar5 + 0x12 ) = (undefined1[16])0x0;puVar5[6] = 0;*(ulong*)( (long)puVar5 + 0x4d ) = ( ulong )(( uint ) * (undefined8*)( (long)puVar5 + 0x4d ) & 0xffc00f) | 0xffffffffff001fc0;iVar1 = *(int*)( (long)param_5 + 0xc );*(uint*)( puVar5 + 0x14 ) = *(uint*)( puVar5 + 0x14 ) & 0x9fc00000;*(ulong*)( (long)puVar5 + 0x55 ) = *(ulong*)( (long)puVar5 + 0x55 ) & 0xfe000000800000 | 0x1ffffff7fffff;puVar5[0xd] = 0xffffffff00000000;*(undefined2*)( puVar5 + 0xf ) = 0;*(undefined8*)( (long)puVar5 + 0x44 ) = 0xffffffffffffffff;*(undefined4*)( (long)puVar5 + 0x5d ) = 0;*(undefined4*)( (long)puVar5 + 100 ) = 0xfffff800;puVar5[0xe] = 0;*(undefined4*)( puVar5 + 0x17 ) = param_2;*(undefined4*)( (long)puVar5 + 0xbc ) = 0;*puVar5 = &TIntermMethod::vtable;if (iVar1 == 0) {
...
puVar5[0x18] = param_3;LAB_00101fdd:if (*(code**)( puVar7 + 0x188 ) == TIntermBinary::setRight) {
   puVar5[0x19] = param_4;
   return puVar5;
}
( **(code**)( puVar7 + 0x188 ) )(puVar5, param_4);return puVar5;}/* glslang::TIntermediate::addBinaryNode(glslang::TOperator, glslang::TIntermTyped*,
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* glslang::TIntermediate::addSymbolLinkageNodes(glslang::TIntermAggregate*&, EShLanguage,
      ...
      *(undefined1*)( (long)__s2 + (long)local_70 ) = 0;
      ...
      if (pTVar10 == (TIntermediate*)0x0) {
         ...
         do {
            ...
            if (( puVar5 == (undefined1*)0x0 ) || ( iVar3 = memcmp(*(void**)( pTVar10 + 0x20 ), __s2, (size_t)puVar5) ),iVar3 == 0) {
 ...
 while ( pTVar9 != (TIntermediate*)0x0 );
         ...
         if (( puVar5 == (undefined1*)0x0 ) || ( iVar3 = memcmp(__s2, *(void**)( pTVar8 + 0x20 ), (size_t)puVar5) ),iVar3 == 0) {
   ...
   if (pTVar10 == (TIntermediate*)0x0) {
      ...
      do {
         while (true) {
            ...
            if (( uVar8 != 0 ) && ( iVar4 = memcmp(*(void**)( pTVar10 + 0x20 ), __s2, uVar8) ),iVar4 != 0) break;
            lVar6 = uVar2 - uVar3;
            if (lVar6 < 0x80000000) {
               if (-0x80000001 < lVar6) {
                  iVar4 = (int)lVar6;

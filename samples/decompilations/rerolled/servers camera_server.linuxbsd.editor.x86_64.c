/* CameraServer::get_feed_count() */undefined4 CameraServer::get_feed_count(CameraServer *this) {
   if (*(long*)( this + 0x1a8 ) != 0) {
      return *(undefined4*)( *(long*)( this + 0x1a8 ) + -8 );
   }
   return 0;
}/* CameraServer::get_feed(int) */long *CameraServer::get_feed(int param_1) {
   long lVar1;
   char cVar2;
   long lVar3;
   int in_EDX;
   ...
   lVar5 = 0;
   LAB_00100079:_err_print_index_error("get_feed", "servers/camera_server.cpp", 0x84, lVar3, lVar5, "p_index", "feeds.size()", "", false, false);
   *plVar4 = 0;
   return plVar4;
   ...
   return;
}/* CameraServer::get_feeds() */void CameraServer::get_feeds(void) {
   long *plVar1;
   long lVar2;
   Object *pOVar3;
   char cVar4;
   ...
   return;
}/* WARNING: Subroutine does not return */__stack_chk_fail();}/* CameraServer::get_singleton() */undefined8 CameraServer::get_singleton(void) {
   return singleton;
}/* CameraServer::get_free_id() */int CameraServer::get_free_id(CameraServer *this) {
   int iVar1;
   long lVar2;
   long lVar3;
   int iVar4;
...
}/* CameraServer::get_feed_index(int) */ulong CameraServer::get_feed_index(CameraServer *this, int param_1) {
   int iVar1;
   long lVar2;
   ulong uVar3;
   lVar2 = *(long*)( this + 0x1a8 );
...
}/* CameraServer::get_feed_by_id(int) */long *CameraServer::get_feed_by_id(int param_1) {
   long lVar1;
   code *pcVar2;
   char cVar3;
   int iVar4;
   ...
   ( *pcVar2 )();
}/* CameraServer::feed_texture(int, CameraServer::FeedImage) */undefined8 CameraServer::feed_texture(long param_1, int param_2) {
   char cVar1;
   int iVar2;
   long lVar3;
   undefined8 uVar4;
   ...
   uVar4 = 0;
   _err_print_error("feed_texture", "servers/camera_server.cpp", 0x9b, "Condition \"index == -1\" is true. Returning: RID()", 0, 0);
   LAB_00100653:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar4;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* CameraServer::CameraServer() */void CameraServer::CameraServer(CameraServer *this) {
   ...
   *(undefined1(*) [16])( this + 0x178 ) = (undefined1[16])0x0;
   return;
}/* CameraServer::_bind_methods() */void CameraServer::_bind_methods(void) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   char *pcVar4;
   ...
   plStack_c8 = (long*)0x0;
   lStack_c0 = 0;
   if (( local_120 == 0 ) || ( CowData<char32_t>::_ref((CowData<char32_t>*)&local_d8, (CowData*)&local_120),local_98[0] == (undefined1(*) [16])0x0 )) {
   ...
   *(int*)local_98[0][1] = *(int*)local_98[0][1] + 1;
   ...
   ClassDB::bind_integer_constant((StringName*)&local_d8, (StringName*)&local_108, (StringName*)&local_128, 0, false);
   if (( StringName::configured != '\0' ) && ( local_d8 != (char*)0x0 )) {
      StringName::unref();
   }
   pcVar4 = local_118;
   ...
   String::parse_latin1((StrRange*)&local_118);
   StringName::StringName((StringName*)&local_d8, (String*)&local_118, false);
   ClassDB::bind_integer_constant((StringName*)&local_d8, (StringName*)&local_108, (StringName*)&local_128, 1, false);
   if (( StringName::configured != '\0' ) && ( local_d8 != (char*)0x0 )) {
      StringName::unref();
   }
   pcVar4 = local_118;
   ...
   *(undefined***)this = &PTR__initialize_classv_00108e30;
   ...
   Object::~Object((Object*)this);
   return;
}/* CowData<Ref<CameraFeed> >::_copy_on_write() [clone .isra.0] */void CowData<Ref<CameraFeed>>::_copy_on_write(CowData<Ref<CameraFeed>> *this) {
   long lVar1;
   long lVar2;
   code *pcVar3;
   char cVar4;
   ...
   *(undefined***)this = &PTR__initialize_classv_00108e30;
   ...
   return;
}/* CameraServer::remove_feed(Ref<CameraFeed> const&) */void CameraServer::remove_feed(CameraServer *this, Ref *param_1) {
   long *plVar1;
   Object *pOVar2;
   Object *pOVar3;
   char *pcVar4;
   ...
   if (cVar5 != '\0') {
      ...
      CameraFeed::get_name();
      operator+((char *)&
      local_e0,(String*)"CameraServer: Removed camera ";
   ...
   if (*(long*)( this + 0x1a8 ) == 0) {
      lVar9 = 0;
      LAB_0010307f:_err_print_index_error("remove_at", "./core/templates/cowdata.h", 0xe4, lVar10, lVar9, "p_index", "size()", "", false, false);
   } else {
         ...
         if (lVar10 < lVar8) {
            do {
               ...
               *(Object**)( lVar9 + lVar10 * 8 ) = pOVar2;
               ...
               if (( ( pOVar3 == (Object*)0x0 ) || ( cVar5 = RefCounted::unreference() ),cVar5 == '\0' )) goto LAB_00102ba0;
               lVar10 = lVar10 + 1;
      ...
      LAB_00102c10:CowData<Ref<CameraFeed>>::resize<false>((CowData<Ref<CameraFeed>>*)( this + 0x1a8 ), lVar8);
   }
   if ((remove_feed(Ref<CameraFeed>const&)::{lambda()
   #1
   ( iVar7 = __cxa_guard_acquire(&remove_feed(Ref < CameraFeed > const & ::sname), iVar7 != 0) );
   {
      _scs_create((char *)&remove_feed(Ref<CameraFeed>const&)::{lambda()
      #1
      ;;
      __cxa_atexit(StringName::~StringName, &remove_feed(Ref < CameraFeed > const & ::sname, &__dso_handle));
      __cxa_guard_release(&remove_feed(Ref<CameraFeed>const&)::{lambda()
      #1
   }
   ...
   (**(code **)(*(long *)this + 0xd0))
            (this,&remove_feed(Ref<CameraFeed>const&)::{lambda()
   #1
   ;;
   ...
   LAB_00102ca5:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return;
}/* CameraServer::add_feed(Ref<CameraFeed> const&) */void CameraServer::add_feed(CameraServer *this, Ref *param_1) {
   long *plVar1;
   undefined8 *puVar2;
   Object *pOVar3;
   char *pcVar4;
   ...
   if (pOVar8 == (Object*)0x0) {
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         _err_print_error("add_feed", "servers/camera_server.cpp", 0x67, "Condition \"p_feed.is_null()\" is true.", 0, 0);
         return;
      }
      goto LAB_00103a6c;
   }
   ...
   if (iVar6 == 0) {
      if (*(long*)( this + 0x1a8 ) == 0) {
         lVar10 = -1;
         lVar9 = 0;
         LAB_001039fa:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar10, lVar9, "p_index", "size()", "", false, false);
         goto LAB_00103210;
      }
      lVar9 = *(long*)( *(long*)( this + 0x1a8 ) + -8 );
      lVar10 = lVar9 + -1;
      ...
      *puVar2 = pOVar8;
      if (pOVar8 != (Object*)0x0) {
         ...
         if (( ( pOVar3 != (Object*)0x0 ) && ( cVar5 = RefCounted::unreference() ),cVar5 != '\0' )) goto LAB_001031f1;
         goto LAB_00103215;
      }
      if (( ( pOVar3 != (Object*)0x0 ) && ( cVar5 = RefCounted::unreference() ),cVar5 != '\0' )) {
         LAB_001031f1:( **(code**)( *(long*)pOVar3 + 0x140 ) )(pOVar3);
         Memory::free_static(pOVar3, false);
         goto LAB_00103210;
      }
   } else {
      _err_print_error("push_back", "./core/templates/vector.h", 0x142, "Condition \"err\" is true. Returning: true", 0, 0);
      LAB_00103210:if (pOVar8 != (Object*)0x0) {
         LAB_00103215:cVar5 = RefCounted::unreference();
   ...
   if (cVar5 != '\0') {
      ...
      CameraFeed::get_name();
      operator+((char *)&
      local_100,(String*)"CameraServer: Registered camera ";
   ...
   iVar6 = CameraFeed::get_id();
   if ((add_feed(Ref<CameraFeed>const&)::{lambda()
   #1
   ( iVar7 = __cxa_guard_acquire(&add_feed(Ref < CameraFeed > const & ::sname), iVar7 != 0) );
   {
      _scs_create((char *)&add_feed(Ref<CameraFeed>const&)::{lambda()
      #1
      __cxa_atexit(StringName::~StringName,
                 &add_feed(Ref<CameraFeed>const&)::{lambda()
      #1
      __cxa_guard_release(&add_feed(Ref<CameraFeed>const&)::{lambda()
      #1
   }
   Variant::Variant((Variant*)local_78, iVar6);
   local_60 = 0;
   ...
   local_88[0] = (Variant*)local_78;
   (**(code **)(*(long *)this + 0xd0))
            (this,&add_feed(Ref<CameraFeed>const&)::{lambda()
   #1
   if (Variant::needs_deinit[(int)local_60] != '\0') {
      Variant::_clear_internal();
   }
   ...
   LAB_00103a6c:/* WARNING: Subroutine does not return */__stack_chk_fail();
   ...
   return 0;
}/* CameraServer::is_class_ptr(void*) const */uint CameraServer::is_class_ptr(CameraServer *this, void *param_1) {
   return (uint)CONCAT71(0x1091, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1091, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr);
}/* CameraServer::_getv(StringName const&, Variant&) const */undefined8 CameraServer::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}/* CameraServer::_setv(StringName const&, Variant const&) */undefined8 CameraServer::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}/* CameraServer::_validate_propertyv(PropertyInfo&) const */void CameraServer::_validate_propertyv(PropertyInfo *param_1) {
   return;
}/* CameraServer::_property_can_revertv(StringName const&) const */undefined8 CameraServer::_property_can_revertv(StringName *param_1) {
   return 0;
}/* CameraServer::_property_get_revertv(StringName const&, Variant&) const */undefined8 CameraServer::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}/* CameraServer::_notificationv(int, bool) */void CameraServer::_notificationv(int param_1, bool param_2) {
   return;
}/* MethodBindT<Ref<CameraFeed> const&>::_gen_argument_type(int) const */byte MethodBindT<Ref<CameraFeed>const&>::_gen_argument_type(MethodBindT<Ref<CameraFeed>const&> *this, int param_1) {
   return -(param_1 == 0) & 0x18;
}/* MethodBindT<Ref<CameraFeed> const&>::get_argument_meta(int) const */undefined8 MethodBindT<Ref<CameraFeed>const&>::get_argument_meta(int param_1) {
   return 0;
}/* MethodBindTR<TypedArray<CameraFeed>>::_gen_argument_type(int) const */undefined8 MethodBindTR<TypedArray<CameraFeed>>::_gen_argument_type(int param_1) {
   return 0x1c;
}/* MethodBindTR<TypedArray<CameraFeed>>::get_argument_meta(int) const */undefined8 MethodBindTR<TypedArray<CameraFeed>>::get_argument_meta(int param_1) {
   return 0;
...
}/* MethodBindTR<Ref<CameraFeed>, int>::_gen_argument_type(int) const */int MethodBindTR<Ref<CameraFeed>,int>::_gen_argument_type(MethodBindTR<Ref<CameraFeed>,int> *this, int param_1) {
   return ( -(uint)(param_1 == 0) & 0xffffffea ) + 0x18;
}/* MethodBindTR<Ref<CameraFeed>, int>::get_argument_meta(int) const */byte MethodBindTR<Ref<CameraFeed>,int>::get_argument_meta(MethodBindTR<Ref<CameraFeed>,int> *this, int param_1) {
   return -(param_1 == 0) & 3;
}/* MethodBindTR<Ref<CameraFeed>, int>::~MethodBindTR() */void MethodBindTR<Ref<CameraFeed>,int>::~MethodBindTR(MethodBindTR<Ref<CameraFeed>,int> *this) {
   ...
   *(undefined***)this = &PTR__gen_argument_type_00108ff0;
   ...
   operator_delete(this, 0x68);
   return;
}/* MethodBindTR<TypedArray<CameraFeed>>::~MethodBindTR() */void MethodBindTR<TypedArray<CameraFeed>>::~MethodBindTR(MethodBindTR<TypedArray<CameraFeed>> *this) {
   ...
   *(undefined***)this = &PTR__gen_argument_type_00109050;
   ...
   operator_delete(this, 0x68);
   return;
}/* MethodBindT<Ref<CameraFeed> const&>::~MethodBindT() */void MethodBindT<Ref<CameraFeed>const&>::~MethodBindT(MethodBindT<Ref<CameraFeed>const&> *this) {
   ...
   *(undefined***)this = &PTR__gen_argument_type_001090b0;
   ...
   operator_delete(this, 0x68);
   return;
}/* CameraServer::_get_class_namev() const */undefined8 *CameraServer::_get_class_namev(void) {
   int iVar1;
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00103de3:return &_get_class_namev();
      }
      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00103de3;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "CameraServer");
         goto LAB_00103e4e;
      }
   }
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "CameraServer");
   LAB_00103e4e:return &_get_class_namev();
}/* CameraServer::get_class() const */void CameraServer::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* CameraServer::is_class(String const&) const */undefined8 CameraServer::is_class(CameraServer *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long lVar4;
   ...
   for (lVar2 = *(long*)( this + 8 ); lVar2 != 0; lVar2 = *(long*)( lVar2 + 8 )) {
      ...
      LAB_0010416f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
   ...
   if (cVar6 == '\0') {
      for (lVar2 = *(long*)( this + 8 ); lVar2 != 0; lVar2 = *(long*)( lVar2 + 8 )) {
         ...
         LAB_001042d3:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
      ...
      LAB_00104223:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBindTR<TypedArray<CameraFeed>>::_gen_argument_type_info(int) const */undefined4 *MethodBindTR<TypedArray<CameraFeed>>::_gen_argument_type_info(int param_1) {
   long *plVar1;
   long lVar2;
   undefined4 in_register_0000003c;
   undefined4 *puVar3;
   ...
   *(undefined1(*) [16])( puVar3 + 2 ) = (undefined1[16])0x0;
   ...
   lVar2 = local_58;
   joined_r0x001044cc:local_58 = lVar2;
   if (lVar2 != 0) {
      LOCK();
   ...
   *(undefined1(*) [16])( puVar3 + 2 ) = (undefined1[16])0x0;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* CameraServer::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void CameraServer::_get_property_listv(List *param_1, bool param_2) {
   long *plVar1;
   long lVar2;
   long lVar3;
   ...
   *(int*)( plVar1 + 2 ) = (int)plVar1[2] + 1;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBindT<Ref<CameraFeed> const&>::_gen_argument_type_info(int) const */undefined4 *MethodBindT<Ref<CameraFeed>const&>::_gen_argument_type_info(int param_1) {
   long *plVar1;
   long lVar2;
   ...
   *puVar7 = local_58._0_4_;
   ...
   LAB_00104ac7:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return puVar7;
}/* MethodBindTR<Ref<CameraFeed>, int>::_gen_argument_type_info(int) const */undefined4 *MethodBindTR<Ref<CameraFeed>,int>::_gen_argument_type_info(int param_1) {
   long *plVar1;
   ...
   if (in_EDX != 0) {
      ...
      *(undefined1(*) [16])( puVar8 + 2 ) = (undefined1[16])0x0;
      if (local_a0 == 0) {
         puVar8[10] = 6;
         LAB_0010515f:StringName::StringName((StringName*)&local_68, (String*)( puVar8 + 8 ), false);
   ...
   *(long*)( puVar8 + 8 ) = local_78;
   puVar8[10] = local_70;
   LAB_00104f97:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return puVar8;
...
godot::details::enum_qualified_name_to_class_info_name(details *this,String *param_1){
   ...
   lVar8 = local_60;
   joined_r0x0010533a:local_60 = lVar8;
   if (lVar8 != 0) {
      LOCK();
   ...
   (CameraServer::*)(int)) */MethodBind *create_method_bind<CameraServer,Ref<CameraFeed>,int>(_func_Ref_int *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
   ...
   *(undefined4*)( this + 0x34 ) = 1;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBind* create_method_bind<CameraServer, int>(int (CameraServer::*)()) */MethodBind *create_method_bind<CameraServer,int>(_func_int *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
   ...
   *(undefined4*)( this + 0x34 ) = 0;
   ...
   (CameraServer::*)()) */MethodBind *create_method_bind<CameraServer,TypedArray<CameraFeed>>(_func_TypedArray *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
   ...
   *(undefined4*)( this + 0x34 ) = 0;
   ...
   (CameraServer::*)(Ref<CameraFeed> const&)) */MethodBind *create_method_bind<CameraServer,Ref<CameraFeed>const&>(_func_void_Ref_ptr *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
   ...
   *(undefined4*)( this + 0x34 ) = 1;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* CameraServer::_bind_methods() [clone .cold] */void CameraServer::_bind_methods(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}/* CowData<Ref<CameraFeed> >::_copy_on_write() [clone .isra.0] [clone .cold] */void CowData<Ref<CameraFeed>>::_copy_on_write(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}/* CameraServer::_initialize_classv() */void CameraServer::_initialize_classv(void) {
   long *plVar1;
   long lVar2;
   long in_FS_OFFSET;
   long local_50;
   ...
   void CowData<Ref<CameraFeed>>::_unref(CowData<Ref<CameraFeed>> *this) {
      long *plVar1;
      long lVar2;
      Object *pOVar3;
      code *pcVar4;
   ...
   undefined8 CowData<Ref<CameraFeed>>::_realloc(CowData<Ref<CameraFeed>> *this, long param_1) {
      undefined8 *puVar1;
   ...
   undefined8 CowData<Ref<CameraFeed>>::resize<false>(CowData<Ref<CameraFeed>> *this, long param_1) {
      long *plVar1;
      Object *pOVar2;
      code *pcVar3;
      char cVar4;
      ...
      if (param_1 * 8 == 0) {
         LAB_00106340:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
         return 6;
      }
      uVar9 = param_1 * 8 - 1;
      uVar9 = uVar9 >> 1 | uVar9;
      ...
      if (lVar11 == lVar8) {
         LAB_001062bb:puVar10 = *(undefined8**)this;
         if (puVar10 == (undefined8*)0x0) {
            LAB_001061b0:/* WARNING: Does not return */pcVar3 = (code*)invalidInstructionException();
            ( *pcVar3 )();
         }
         lVar7 = puVar10[-1];
      ...
      LAB_0010629b:puVar10[-1] = param_1;
      return 0;
   }
   for (int i = 0; i < 25; i++) {
   ...
   const */
   Object *MethodBindTR<TypedArray<CameraFeed>>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
      Variant *pVVar1;
      long lVar2;
      char *pcVar3;
      Variant *pVVar4;
   ...
   Object *MethodBindTR<int>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
      ...
      *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
      ...
      LAB_00106ce0:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return param_1;
      }
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   ...
   void MethodBindTR<int>::validated_call(MethodBindTR<int> *this, Object *param_1, Variant **param_2, Variant *param_3) {
      ...
      *(long*)( param_3 + 8 ) = (long)iVar3;
      LAB_00106fd4:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   ...
   void MethodBindTR<int>::ptrcall(MethodBindTR<int> *this, Object *param_1, void **param_2, void *param_3) {
      ...
      *(long*)param_3 = (long)iVar3;
      LAB_001071d3:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   ...
   void MethodBindT<Ref<CameraFeed>const&>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
      long *plVar1;
      long lVar2;
      Object *pOVar3;
      char cVar4;
      ...
      if (pOVar5 != local_58) {
         if (pOVar5 == (Object*)0x0) {
            if (local_58 != (Object*)0x0) {
               local_58 = (Object*)0x0;
               LAB_00107446:cVar4 = RefCounted::unreference();
               if (cVar4 != '\0') {
      ...
      LAB_00107488:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   ...
   void MethodBindT<Ref<CameraFeed>const&>::ptrcall(Object *param_1, void **param_2, void *param_3) {
      ...
      if (( *param_3 == (long*)0x0 ) || ( local_48 = (Object*)**param_3 ),local_48 == (Object*)0x0) {
         LAB_00107778:local_48 = (Object*)0x0;
      } else {
      ...
      LAB_0010779c:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   ...
   void MethodBindTR<TypedArray<CameraFeed>>::validated_call(MethodBindTR<TypedArray<CameraFeed>> *this, Object *param_1, Variant **param_2, Variant *param_3) {
      Variant **ppVVar1;
      long lVar2;
      Variant **ppVVar3;
      code *pcVar4;
      ...
      LAB_001079f9:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   ...
   void MethodBindTR<TypedArray<CameraFeed>>::ptrcall(MethodBindTR<TypedArray<CameraFeed>> *this, Object *param_1, void **param_2, void *param_3) {
      void **ppvVar1;
      long lVar2;
      void **ppvVar3;
      code *pcVar4;
      ...
      Array::~Array((Array*)&local_48);
      LAB_00107c0a:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   ...
   void MethodBindTR<Ref<CameraFeed>,int>::ptrcall(MethodBindTR<Ref<CameraFeed>,int> *this, Object *param_1, void **param_2, void *param_3) {
      long lVar1;
      char cVar2;
      code *pcVar3;
      Object *pOVar4;
         ...
         *(Object**)param_3 = pOVar4;
         if (pOVar4 == (Object*)0x0) {
            ...
            if (pOVar6 != (Object*)0x0) {
               LAB_00107ec1:cVar2 = RefCounted::unreference();
               if (cVar2 != '\0') {
      ...
      LAB_00107e7b:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   ...
   const */
   Object *MethodBindT<Ref<CameraFeed>const&>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
      Variant *pVVar1;
      long lVar2;
      code *pcVar3;
      undefined8 uVar4;
      ...
      if (( ( plVar11 != (long*)0x0 ) && ( plVar11[1] != 0 ) ) && ( *(char*)( plVar11[1] + 0x2e ) != '\0' )) {
         ...
         if (local_48 == (Object*)*plVar9) {
            ...
            String::parse_latin1((StrRange*)&local_50);
            vformat<StringName>((StringName*)&local_48, (StrRange*)&local_50, &local_58);
            _err_print_error(&_LC61, "./core/object/method_bind.h", 0x154, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: Variant()", (StringName*)&local_48, 0);
            pOVar5 = local_48;
            if (local_48 != (Object*)0x0) {
               LOCK();
      ...
      if (pVVar12 == (Variant*)0x0) {
         ...
         LAB_00108350:pVVar12 = *(Variant**)param_4;
      } else {
         lVar2 = *(long*)( pVVar12 + -8 );
         if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
            LAB_00108360:uVar7 = 4;
            goto LAB_00108305;
         }
      ...
      *in_R9 = 0;
      ...
      if (pOVar8 != local_48) {
         if (pOVar8 == (Object*)0x0) {
            if (local_48 != (Object*)0x0) {
               local_48 = (Object*)0x0;
               LAB_0010847d:cVar6 = RefCounted::unreference();
               if (cVar6 != '\0') {
      ...
      LAB_00108310:*(undefined4*)param_1 = 0;
      *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
      if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return param_1;
      }
   ...
   const */
   Object *MethodBindTR<Ref<CameraFeed>,int>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
      Object *pOVar1;
      Variant *pVVar2;
      long lVar3;
      code *pcVar4;
      ...
      *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
      if (( ( plVar12 != (long*)0x0 ) && ( plVar12[1] != 0 ) ) && ( *(char*)( plVar12[1] + 0x2e ) != '\0' )) {
         ...
         if (local_58 == (Object*)*plVar10) {
            ...
            String::parse_latin1((StrRange*)&local_60);
            vformat<StringName>((StringName*)&local_58, (StrRange*)&local_60, &local_68);
            _err_print_error(&_LC61, "./core/object/method_bind.h", 0x207, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: ret", (StringName*)&local_58, 0);
            pOVar6 = local_58;
            if (local_58 != (Object*)0x0) {
               LOCK();
      ...
      if (in_R8D < 2) {
         ...
         if (pVVar13 == (Variant*)0x0) {
            ...
            LAB_001087a0:pVVar13 = *(Variant**)param_4;
         } else {
            lVar3 = *(long*)( pVVar13 + -8 );
            if ((int)lVar3 < (int)( in_R8D ^ 1 )) {
               LAB_001087b0:uVar9 = 4;
               goto LAB_00108765;
            }
         ...
         *(undefined8*)( param_1 + 0x10 ) = uStack_38;
         ...
         uVar9 = 3;
         LAB_00108765:*in_R9 = uVar9;
         in_R9[2] = 1;
      }
      LAB_00108770:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return param_1;
      }
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   ...
   void MethodBindTR<Ref<CameraFeed>,int>::validated_call(MethodBindTR<Ref<CameraFeed>,int> *this, Object *param_1, Variant **param_2, Variant *param_3) {
      Object *pOVar1;
      Object *pOVar2;
      char *pcVar3;
      char cVar4;
      ...
      LAB_00108a7c:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   ...
   void MethodBindT<Ref<CameraFeed>const&>::~MethodBindT(MethodBindT<Ref<CameraFeed>const&> *this) {
      /* WARNING: Bad instruction - Truncating control flow here */
      halt_baddata();
   }
   /* WARNING: Control flow encountered bad instruction data */
   /* MethodBindTR<TypedArray<CameraFeed>>::~MethodBindTR() */
   void MethodBindTR<TypedArray<CameraFeed>>::~MethodBindTR(MethodBindTR<TypedArray<CameraFeed>> *this) {
      /* WARNING: Bad instruction - Truncating control flow here */
      halt_baddata();
   }
   /* WARNING: Control flow encountered bad instruction data */
   ...
   void MethodBindTR<Ref<CameraFeed>,int>::~MethodBindTR(MethodBindTR<Ref<CameraFeed>,int> *this) {
      /* WARNING: Bad instruction - Truncating control flow here */
      halt_baddata();
   }
   /* WARNING: Control flow encountered bad instruction data */

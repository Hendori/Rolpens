/* HTTPClientTCP::has_response() const */undefined8 HTTPClientTCP::has_response(HTTPClientTCP *this) {
   ...
   *(undefined8*)( this + 0x17c ) = 0xffffffff00000000;
   ...
   uVar3 = _UNK_00107dd8;
   uVar2 = __LC16;
   for (int i_958 = 0; i_958 < 4; i_958++) {
      *(undefined4*)( this + ( 16*i_958 + 400 ) ) = 4294967295;
      *(undefined8*)( this + ( 16*i_958 + 408 ) ) = 0;
   }
         ...
         *(StreamPeerTCP**)( this + 0x230 ) = this_00;
         ...
         if (cVar4 == '\0') {
            *(undefined8*)( this + 0x230 ) = 0;
            if (pOVar5 != (Object*)0x0) {
               cVar4 = RefCounted::unreference();
               joined_r0x0010094f:if (( cVar4 != '\0' ) && ( cVar4 = predelete_handler(pOVar5) ),cVar4 != '\0') goto LAB_00100972;
            }
...
LAB_00104061:
   ...
   Array::clear();
   uVar11 = 5;
}else{LAB_00103f80:iVar10 = 0x19;( **(code**)( *(long*)this + 0x170 ) )(this);uVar11 = 9;}*(undefined4*)( this + 0x17c ) = uVar11;cVar7 = RefCounted::unreference();if (( cVar7 != '\0' ) && ( cVar7 = predelete_handler(pOVar12) ),cVar7 != '\0') {
   ( **(code**)( *(long*)pOVar12 + 0x140 ) )(pOVar12);
   Memory::free_static(pOVar12, false);

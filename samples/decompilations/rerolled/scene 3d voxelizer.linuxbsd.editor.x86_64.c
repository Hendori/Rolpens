         ...
         *(MultiMesh**)in_RDI = this;
         ...
         if (cVar4 == '\0') {
            *(undefined8*)in_RDI = 0;
            if (pOVar6 != (Object*)0x0) {
               cVar4 = RefCounted::unreference();
               joined_r0x0010930f:if (( cVar4 != '\0' ) && ( cVar4 = predelete_handler(pOVar6) ),cVar4 != '\0') goto LAB_0010935d;
            }
 ...
 while ( iVar15 != 6 );
   ...
   *(undefined***)this_01 = &PTR__initialize_classv_0010eb30;
   ...
   if (cVar4 == '\0') {
      ...
      ( *pcVar16 )(local_f0, 0, (Vector*)&local_98);
      if (( local_98 != (Object*)0x0 ) && ( cVar4 = RefCounted::unreference() ),cVar4 != '\0') goto LAB_0010938d;
...
local_98 = (Object*)( (ulong)local_98 & 0xffffffff00000000 );_debug_mesh(in_RSI, 0, 0, (AABB*)( in_RSI + 100 ), in_RDI, (int*)&local_98);cVar4 = RefCounted::unreference();if (( cVar4 != '\0' ) && ( cVar4 = predelete_handler(local_f0) ),cVar4 != '\0') {

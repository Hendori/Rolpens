undefined8 dasync_init(void) {
   ...
   *param_2 = dasync_rsa;
   ...
   return 1;
}int dasync_aes128_cbc_hmac_sha1_ctrl(undefined8 param_1, undefined4 param_2, int param_3, undefined8 *param_4) {
   int iVar1;
   EVP_CIPHER *pEVar2;
   undefined8 *puVar3;
   undefined8 *puVar4;
   ...
   return 1;
}uint dasync_cipher_helper(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5) {
   int iVar1;
   uint uVar2;
   int iVar3;
   undefined8 *puVar4;
   ...
   if (iVar1 == 0) {
      ...
      while (true) {
         ...
         if (uVar2 != 0) {
            pcVar5 = (code*)EVP_CIPHER_meth_get_do_cipher(param_5);
            iVar3 = ( *pcVar5 )(param_1, *(undefined8*)( puVar4[3] + lVar6 ), *(undefined8*)( puVar4[2] + lVar6 ), *(undefined8*)( puVar4[4] + lVar6 ));
            uVar2 = ( uint )(iVar3 != 0);
         }
   ...
   *(undefined4*)( puVar4 + 0x39 ) = 0;
   EVP_CIPHER_CTX_set_cipher_data(param_1, puVar4);
   return uVar2;
}void dasync_aes128_cbc_hmac_sha1_cipher(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4) {
   EVP_CIPHER *pEVar1;
   pEVar1 = EVP_aes_128_cbc_hmac_sha1();
   dasync_cipher_helper(param_1, param_2, param_3, param_4, pEVar1);
   return;
}void dasync_aes256_ctr_cipher(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4) {
   EVP_CIPHER *pEVar1;
   pEVar1 = EVP_aes_256_ctr();
   dasync_cipher_helper(param_1, param_2, param_3, param_4, pEVar1);
   return;
}undefined4 dasync_aes256_init_key(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined4 param_4) {
   undefined4 uVar1;
   int iVar2;
   EVP_CIPHER *pEVar3;
   long *plVar4;
   ...
   *(undefined4*)( plVar4 + 0x39 ) = 0;
   ...
   return uVar1;
}void dasync_aes128_cbc_cipher(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4) {
   EVP_CIPHER *pEVar1;
   ...
   *param_2 = _hidden_sha1_md;
   ...
   return;
}void dasync_rsa_decrypt(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5) {
   ...
   return uVar1;
}void dasync_rsa_encrypt(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5) {
   ...
   if (( dasync_rsa_orig != (EVP_PKEY_METHOD*)0x0 ) && ( dasync_rsa = EVP_PKEY_meth_new(6, 2) ),dasync_rsa != (EVP_PKEY_METHOD*)0x0) {
      ...
      if (( ( ( iVar1 != 0 ) && ( iVar1 = ENGINE_set_name(param_1, "Dummy Async engine support") ),iVar1 != 0 ) ) && ( iVar1 = iVar1 != 0 )) {
         _hidden_sha1_md = EVP_MD_meth_new(0x40, 0x41);
         if (( _hidden_sha1_md == 0 ) || ( ( ( ( ( iVar1 = EVP_MD_meth_set_result_size(_hidden_sha1_md, 0x14) ),iVar1 == 0 || ( iVar1 = EVP_MD_meth_set_input_blocksize(_hidden_sha1_md, 0x40) ),iVar1 == 0 ) ) || ( iVar1 = EVP_MD_meth_set_app_datasize(_hidden_sha1_md, 0x68) ),iVar1 == 0 ) ) || ( ( iVar1 = EVP_MD_meth_set_flags(_hidden_sha1_md, 8) ),iVar1 == 0 || ( iVar1 = EVP_MD_meth_set_init(_hidden_sha1_md, dasync_sha1_init) ),iVar1 == 0 )) {
            EVP_MD_meth_free(_hidden_sha1_md);
            _hidden_sha1_md = 0;
         }
         _hidden_aes_128_cbc = EVP_CIPHER_meth_new(0x1a3, 0x10, 0x10);
         if (( ( ( _hidden_aes_128_cbc == 0 ) || ( iVar1 = EVP_CIPHER_meth_set_iv_length(_hidden_aes_128_cbc, 0x10) ),iVar1 == 0 ) ) || ( ( iVar1 = EVP_CIPHER_meth_set_flags(_hidden_aes_128_cbc, 0x800402) ),iVar1 == 0 || ( ( ( iVar1 = EVP_CIPHER_meth_set_init(_hidden_aes_128_cbc, dasync_aes128_init_key) ),iVar1 == 0 || ( iVar1 = EVP_CIPHER_meth_set_do_cipher(_hidden_aes_128_cbc, dasync_aes128_cbc_cipher) ),iVar1 == 0 ) ) || ( iVar1 = EVP_CIPHER_meth_set_cleanup(_hidden_aes_128_cbc, dasync_aes128_cbc_cleanup) ),iVar1 == 0 )) {
            EVP_CIPHER_meth_free(_hidden_aes_128_cbc);
            _hidden_aes_128_cbc = 0;
         }
         _hidden_aes_256_ctr = EVP_CIPHER_meth_new(0x38a, 1, 0x20);
         if (( ( ( _hidden_aes_256_ctr == 0 ) || ( iVar1 = EVP_CIPHER_meth_set_iv_length(_hidden_aes_256_ctr, 0x10) ),iVar1 == 0 ) ) || ( ( iVar1 = EVP_CIPHER_meth_set_flags(_hidden_aes_256_ctr, 0x800405) ),iVar1 == 0 || ( ( ( iVar1 = EVP_CIPHER_meth_set_init(_hidden_aes_256_ctr, dasync_aes256_init_key) ),iVar1 == 0 || ( iVar1 = EVP_CIPHER_meth_set_do_cipher(_hidden_aes_256_ctr, dasync_aes256_ctr_cipher) ),iVar1 == 0 ) ) || ( iVar1 = EVP_CIPHER_meth_set_cleanup(_hidden_aes_256_ctr, dasync_aes256_ctr_cleanup) ),iVar1 == 0 )) {
            EVP_CIPHER_meth_free(_hidden_aes_256_ctr);
            _hidden_aes_256_ctr = 0;
         }
         _hidden_aes_128_cbc_hmac_sha1 = EVP_CIPHER_meth_new(0x394, 0x10, 0x10);
         if (( ( _hidden_aes_128_cbc_hmac_sha1 == 0 ) || ( iVar1 = EVP_CIPHER_meth_set_iv_length(_hidden_aes_128_cbc_hmac_sha1, 0x10) ),iVar1 == 0 )) ( ( iVar1 = EVP_CIPHER_meth_set_flags(_hidden_aes_128_cbc_hmac_sha1, 0xa00402) ),iVar1 == 0 || ( ( ( ( iVar1 = EVP_CIPHER_meth_set_init(_hidden_aes_128_cbc_hmac_sha1, dasync_aes128_cbc_hmac_sha1_init_key) ),iVar1 == 0 || ( iVar1 = EVP_CIPHER_meth_set_do_cipher(_hidden_aes_128_cbc_hmac_sha1, dasync_aes128_cbc_hmac_sha1_cipher) ),iVar1 == 0 ) ) || ( iVar1 = EVP_CIPHER_meth_set_cleanup(_hidden_aes_128_cbc_hmac_sha1, dasync_aes128_cbc_hmac_sha1_cleanup) ),iVar1 == 0 ) ) || ( ( iVar1 = EVP_CIPHER_meth_set_ctrl(_hidden_aes_128_cbc_hmac_sha1, dasync_aes128_cbc_hmac_sha1_ctrl) ),iVar1 == 0 || ( iVar1 = EVP_CIPHER_meth_set_impl_ctx_size(_hidden_aes_128_cbc_hmac_sha1, 0x1d0) ),iVar1 == 0 );
         _hidden_aes_128_cbc_hmac_sha1 = 0;
      }
      return 1;
   }
...
}return 0;}undefined8 dasync_aes128_cbc_cleanup(undefined8 param_1) {
   int iVar1;
   EVP_CIPHER *pEVar2;
   undefined8 *puVar3;
      ...
      if (( iVar1 == 0 ) || ( local_50 == (code*)0x0 )) {
         ...
         if (iVar1 == 0) {
            ...
            *local_40 = local_38._4_4_;
            iVar2 = ASYNC_WAIT_CTX_set_wait_fd(uVar4, "dasync", local_38 & 0xffffffff, local_40, wait_cleanup);
            ptr = local_40;
   ...
   LAB_001012e9:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   ...
   return;
}undefined4 dasync_aes128_init_key(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined4 param_4) {
   undefined4 uVar1;
   int iVar2;
   EVP_CIPHER *pEVar3;
   long *plVar4;
   ...
   *(undefined4*)( plVar4 + 0x39 ) = 0;
   ...
   EVP_CIPHER_CTX_set_cipher_data(param_1, plVar4);
   return uVar1;
}undefined4 dasync_aes128_cbc_hmac_sha1_init_key(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined4 param_4) {
   undefined4 uVar1;
   int iVar2;
   EVP_CIPHER *pEVar3;
   long *plVar4;
   ...
   *(undefined4*)( plVar4 + 0x39 ) = 0;
   ...
   EVP_CIPHER_CTX_set_cipher_data(param_1, plVar4);
   return uVar1;
}undefined8 dasync_aes256_ctr_ctrl(undefined8 param_1, undefined4 param_2, undefined4 param_3, undefined8 param_4) {
   int num;
   EVP_CIPHER *pEVar1;
   undefined8 *puVar2;
   void *pvVar3;
   ...
   LAB_001016c2:return 0;
}undefined8 dasync_aes128_cbc_ctrl(undefined8 param_1, undefined4 param_2, undefined4 param_3, undefined8 param_4) {
   int num;
   EVP_CIPHER *pEVar1;
   undefined8 *puVar2;
   void *pvVar3;

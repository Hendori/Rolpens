...
void filter_apply(ulong *param_1, int param_2, long *param_3, long param_4, long *param_5, long param_6) {
   ...
   if (bVar3) {
      LAB_00100080:if (( param_4 != 9 ) && ( bVar5 )) goto joined_r0x00100531;
      LAB_00100140:bVar3 = param_5 != (long*)0x0;
      bVar4 = param_6 != 0xe && bVar3;
      if (param_6 == 0xe || !bVar3) {
         if (( param_3 == (long*)0x0 ) || ( iVar1 = iVar1 == 0 )) {
            if (( param_5 == (long*)0x0 ) || ( ( *param_5 == 0x6574656d61726170 && ( *(long*)( (long)param_5 + 6 ) == 0x7465735f73726574 ) ) )) {
               ...
               *param_1 = uVar2;
               ...
               if (( param_3 != (long*)0x0 ) && ( ( *param_3 != 0x726f70736e617274 || ( (char)param_3[1] != 't' ) ) )) goto joined_r0x00100531;
               if (param_5 == (long*)0x0) goto LAB_001005cc;
               LAB_001001f8:if (( *param_5 == 0x735f74656b636170 ) && ( *(int*)( (long)param_5 + 7 ) == 0x746e6573 )) goto LAB_001005cc;
               if (( param_6 != 0xf ) && ( bVar3 )) goto joined_r0x00100531;
               if (param_3 == (long*)0x0) goto LAB_00100399;
               if (( *param_3 != 0x726f70736e617274 ) || ( (char)param_3[1] != 't' )) goto joined_r0x00100531;
               goto LAB_001004ec;
            }
         ...
         joined_r0x00100531:if (( param_4 != 8 ) && ( bVar5 )) {
            return;
         }
      ...
      if (param_6 != 0xb) {
         LAB_00100498:bVar3 = true;
         LAB_0010049e:if (( param_6 != 0xf ) && ( bVar3 )) goto joined_r0x00100531;
         if (param_3 == (long*)0x0) goto LAB_00100399;
         iVar1 = memcmp(param_3, "transport", 9);
         LAB_001004df:if (iVar1 != 0) goto joined_r0x00100531;
         LAB_001004e7:if (param_5 != (long*)0x0) {
            LAB_001004ec:if (( *param_5 != 0x725f74656b636170 ) || ( *(long*)( (long)param_5 + 7 ) != 0x6465766965636572 )) goto joined_r0x00100531;
         }
      ...
      bVar3 = bVar4;
      if (param_3 != (long*)0x0) {
         if (( ( ( *param_3 != 0x726f70736e617274 ) || ( (char)param_3[1] != 't' ) ) || ( *param_5 != 0x735f74656b636170 ) ) || ( *(int*)( (long)param_5 + 7 ) != 0x746e6573 )) goto joined_r0x00100531;
         LAB_001005cc:uVar2 = *param_1 & 0xffffffffffffffdf;
         if (param_2 != 0) {
            uVar2 = *param_1 | 0x20;
         }
      ...
      LAB_00100670:if (( *param_5 == 0x735f74656b636170 ) && ( *(int*)( (long)param_5 + 7 ) == 0x746e6573 )) goto LAB_001005cc;
      LAB_00100407:if (param_5 == (long*)0x0) goto LAB_0010042c;
   }
 else {
         ...
         if (( param_3 == (long*)0x0 ) || ( iVar1 = iVar1 == 0 )) {
            if (param_5 == (long*)0x0) {
               ...
               *param_1 = uVar2;
               ...
               if (( *param_5 != 0x697463656e6e6f63 || param_5[1] != 0x74726174735f6e6f ) || ( (short)param_5[2] != 0x6465 )) goto LAB_0010005b;
               uVar2 = *param_1 & 0xfffffffffffffffd;
               if (param_2 != 0) {
                  uVar2 = *param_1 | 2;
               }
            ...
            if (( param_3 == (long*)0x0 ) || ( ( *param_3 == 0x697463656e6e6f63 && ( (int)param_3[1] == 0x79746976 ) ) )) {
      ...
      LAB_0010005b:if (param_6 == 0x18) {
         if (param_3 != (long*)0x0) {
            if (( *param_3 == 0x697463656e6e6f63 ) && ( (int)param_3[1] == 0x79746976 )) {
               LAB_001000c3:if (( *param_5 == 0x697463656e6e6f63 && param_5[1] == 0x65746174735f6e6f ) && ( param_5[2] == 0x646574616470755f )) goto LAB_00100711;
               if (param_6 == 0x11) {
                  if (param_3 == (long*)0x0) goto LAB_001000f6;
                  if (( *param_3 == 0x697463656e6e6f63 ) && ( (int)param_3[1] == 0x79746976 )) goto LAB_00100334;
               }
         ...
         if (( *param_5 == 0x697463656e6e6f63 && param_5[1] == 0x65746174735f6e6f ) && ( param_5[2] == 0x646574616470755f )) {
            LAB_00100711:uVar2 = *param_1 & 0xfffffffffffffffb;
            if (param_2 != 0) {
               uVar2 = *param_1 | 4;
            }

            *param_1 = uVar2;
            if (( ( param_6 == 0x11 ) || ( param_5 == (long*)0x0 ) ) && ( ( param_3 == (long*)0x0 || ( iVar1 = memcmp(param_3, "connectivity", 0xc) ),iVar1 == 0 ) )) {
               if (param_5 != (long*)0x0) goto LAB_00100334;
               LAB_00100368:uVar2 = *param_1 & 0xfffffffffffffff7;
               if (param_2 != 0) {
                  uVar2 = *param_1 | 8;
               }
      ...
      LAB_001002f0:if (param_6 != 0x11) goto LAB_00100080;
      if (param_3 != (long*)0x0) {
         iVar1 = memcmp(param_3, "connectivity", 0xc);
         if (iVar1 == 0) {
            LAB_00100334:if (( *param_5 == 0x697463656e6e6f63 && param_5[1] == 0x65736f6c635f6e6f ) && ( (char)param_5[2] == 'd' )) goto LAB_00100368;
         }

         goto LAB_00100080;
      }

      LAB_001000f6:if (( *param_5 == 0x697463656e6e6f63 && param_5[1] == 0x65736f6c635f6e6f ) && ( (char)param_5[2] == 'd' )) {
         uVar2 = *param_1 | 8;
         if (param_2 == 0) {
      ...
      LAB_00100399:if (( *param_5 == 0x725f74656b636170 ) && ( *(long*)( (long)param_5 + 7 ) == 0x6465766965636572 )) {
         if (param_2 != 0) {
            *param_1 = *param_1 | 0x40;
            LAB_001003d8:bVar3 = param_5 != (long*)0x0;
            LAB_001003df:if (( param_6 != 0xb ) && ( bVar3 )) {
               return;
            }
   ...
   LAB_0010042c:uVar2 = *param_1 | 0x80;
   if (param_2 == 0) {
...
undefined8 *ossl_qlog_new(undefined8 *param_1) {
   ...
   *(undefined4*)( ptr + 6 ) = *(undefined4*)( param_1 + 6 );
   ...
   LAB_00100968:CRYPTO_free((void*)ptr[3]);
...
bool ossl_qlog_enabled(long param_1, uint param_2) {
   if (param_1 != 0) {
      return ( *(uint*)( param_1 + 0x60 + ( ulong )(param_2 >> 6) * 8 ) & ( uint )(1L << ( (byte)param_2 & 0x3f )) ) != 0;
   }

   return false;
}
undefined8 ossl_qlog_event_try_begin(long param_1, undefined4 param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5) {
   long lVar1;
   int iVar2;
   __pid_t _Var3;
   undefined8 uVar4;
   ...
   uVar4 = 0;
   LAB_00100f6a:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar4;
   }
...
undefined8 ossl_qlog_set_filter(long param_1, byte *param_2) {
   ...
   LAB_00101348:do {
      bVar1 = *param_2;
      for (pbVar8 = param_2; ( ( bVar1 < 0x21 && ( ( 0x100002600U >> ( (ulong)bVar1 & 0x3f ) & 1 ) != 0 ) ) && ( pbVar8 < pbVar5 ) ); pbVar8 = pbVar8 + 1) {
         bVar1 = pbVar8[1];
      }
      ...
      for (; ( ( 0x20 < *param_2 || ( ( 0x100002600U >> ( ( ulong ) * param_2 & 0x3f ) & 1 ) == 0 ) ) && ( param_2 < pbVar5 ) ); param_2 = param_2 + 1) {}
      if (pbVar8 == param_2) {
         iVar3 = ossl_ctype_check(0xffffffff, 3);
         if (( iVar3 != 0 ) || ( iVar3 = iVar3 == 0 )) goto LAB_001014a0;
         LAB_001015e0:bVar11 = true;
      }
 else {
         if (( bVar1 - 0x2b & 0xfd ) != 0) {
            iVar7 = (int)(char)bVar1;
            iVar3 = ossl_ctype_check(iVar7, 3);
            if (( ( ( iVar3 != 0 ) || ( iVar3 = ossl_isdigit(iVar7) ),iVar3 != 0 ) ) || ( bVar1 == 0x5f )) goto LAB_001015e0;
            goto LAB_001014a0;
         }
         ...
         if (pbVar8 + 1 == param_2) {
            ...
            iVar3 = ossl_ctype_check(iVar7, 3);
            if (( ( iVar3 == 0 ) && ( ( iVar3 = ossl_isdigit(iVar7) ),iVar3 == 0 && ( bVar2 != 0x5f && bVar2 != 0x2d ) ) )) goto LAB_001014a0;
         }
      ...
      pbVar9 = pbVar8;
      if (param_2 <= pbVar8) {
         LAB_001014a0:uVar6 = 0;
         LAB_001014a2:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            return uVar6;
         }
...
;
      ...
      if (local_70 == 1) {
         ...
         LAB_001014d2:uVar10 = 0;
         do {
            while (true) {
               bVar1 = pbVar8[uVar10];
               iVar3 = ossl_ctype_check((int)(char)bVar1, 3);
               if (( ( iVar3 == 0 ) && ( iVar3 = ossl_isdigit((int)(char)bVar1) ),iVar3 == 0 )) &&( bVar1 != 0x5f );
               uVar10 = uVar10 + 1;
...
;
 ...
 while ( uVar10 < local_78 );
      ...
      LAB_001015a3:filter_apply(&local_48, bVar11, pbVar8, local_70, local_60, local_78);
   }
 while ( true );
}
long ossl_qlog_new_from_env(byte *param_1) {
   ...
   if (( ( param_1 != (byte*)0x0 ) && ( pcVar4 != (char*)0x0 ) ) && ( __n = __n != 0 )) {
      bVar1 = *param_1;
      n = (ulong)bVar1 * 2 + 0xf;
      lVar6 = __n + n;

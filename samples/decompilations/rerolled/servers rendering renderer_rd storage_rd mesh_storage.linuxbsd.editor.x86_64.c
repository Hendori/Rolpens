...
/* RendererRD::MeshStorage::mesh_instance_check_for_update(RID) */undefined1[16];RendererRD::MeshStorage::mesh_instance_check_for_update (MeshStorage *this,ulong param_2) {
   long lVar1;
   ulong uVar2;
   long lVar3;
   code *pcVar4;
...
/* RendererRD::MeshStorage::_multimesh_instance_get_color(RID, int) const */undefined1[16];RendererRD::MeshStorage::_multimesh_instance_get_color (MeshStorage *this,ulong param_2,int param_3) {
   long *plVar1;
   int iVar2;
   void *pvVar3;
   long lVar4;
...
/* RendererRD::MeshStorage::_multimesh_instance_get_custom_data(RID, int) const */undefined1[16];RendererRD::MeshStorage::_multimesh_instance_get_custom_data (MeshStorage *this,ulong param_2,int param_3) {
   long *plVar1;
   int iVar2;
   void *pvVar3;
   long lVar4;

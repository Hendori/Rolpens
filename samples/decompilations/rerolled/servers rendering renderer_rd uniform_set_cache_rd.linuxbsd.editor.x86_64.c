/* CowData<RID>::_ref(CowData<RID> const&) [clone .part.0] */void CowData<RID>::_ref(CowData<RID> *this, CowData *param_1) {
   ...
   return;
}/* UniformSetCacheRD::_bind_methods() */void UniformSetCacheRD::_bind_methods(void) {
   long lVar1;
   code *pcVar2;
   long *plVar3;
   MethodBind *this;
   ...
   *(undefined4*)( this + 0x34 ) = 3;
   ...
   __stack_chk_fail();
}/* UniformSetCacheRD::_invalidate(UniformSetCacheRD::Cache*) */void UniformSetCacheRD::_invalidate(UniformSetCacheRD *this, Cache *param_1) {
   long *plVar1;
   uint uVar2;
   long lVar3;
   long lVar4;
   ...
   LAB_001003ca:uVar2 = *(uint*)( this + 0x18c );
   ...
   *(uint*)( this + 0x18c ) = uVar2 + 1;
   return;
}/* UniformSetCacheRD::_uniform_set_invalidation_callback(void*) */void UniformSetCacheRD::_uniform_set_invalidation_callback(void *param_1) {
   _invalidate(singleton, (Cache*)param_1);
   return;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* UniformSetCacheRD::UniformSetCacheRD() */void UniformSetCacheRD::UniformSetCacheRD(UniformSetCacheRD *this) {
   undefined8 uVar1;
   undefined8 uVar2;
   bool bVar3;
   ...
   *(undefined4*)( this + 0x201c8 ) = 0;
   ...
   _err_print_error("UniformSetCacheRD", "servers/rendering/renderer_rd/uniform_set_cache_rd.cpp", 0x4a, "Condition \"singleton != nullptr\" is true.", 0, 0);
   return;
}/* UniformSetCacheRD::~UniformSetCacheRD() */void UniformSetCacheRD::~UniformSetCacheRD(UniformSetCacheRD *this) {
   long lVar1;
   long lVar2;
   long in_FS_OFFSET;
   String local_60[8];
   ...
   *(undefined***)this = &PTR__initialize_classv_00103160;
   if (*(int*)( this + 0x201c8 ) != 0) {
      ...
      _err_print_error("~UniformSetCacheRD", "servers/rendering/renderer_rd/uniform_set_cache_rd.cpp", 0x50, local_60, 0, 0);
   ...
   return;
}/* UniformSetCacheRD::get_cache_array(RID, unsigned int, TypedArray<RDUniform> const&) */void UniformSetCacheRD::get_cache_array(undefined8 param_1, undefined4 param_2, int param_3) {
   long *plVar1;
   undefined8 *puVar2;
   Object OVar3;
   long lVar4;
   ...
   if ((char)*in_FS_OFFSET == '\0') {
      ...
      *(undefined1*)in_FS_OFFSET = 1;
      __cxa_thread_atexit(LocalVector<RenderingDevice::Uniform,unsigned_int,false,false>::~LocalVector, uVar5, &__dso_handle);
   }
   if (*in_FS_OFFSET != 0) {
      lVar16 = 0;
      uVar14 = 0;
   ...
   return 0;
}/* UniformSetCacheRD::is_class_ptr(void*) const */uint UniformSetCacheRD::is_class_ptr(UniformSetCacheRD *this, void *param_1) {
   return (uint)CONCAT71(0x1033, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1033, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr);
}/* UniformSetCacheRD::_getv(StringName const&, Variant&) const */undefined8 UniformSetCacheRD::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}/* UniformSetCacheRD::_setv(StringName const&, Variant const&) */undefined8 UniformSetCacheRD::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}/* UniformSetCacheRD::_validate_propertyv(PropertyInfo&) const */void UniformSetCacheRD::_validate_propertyv(PropertyInfo *param_1) {
   return;
}/* UniformSetCacheRD::_property_can_revertv(StringName const&) const */undefined8 UniformSetCacheRD::_property_can_revertv(StringName *param_1) {
   return 0;
}/* UniformSetCacheRD::_property_get_revertv(StringName const&, Variant&) const */undefined8 UniformSetCacheRD::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}/* UniformSetCacheRD::_notificationv(int, bool) */void UniformSetCacheRD::_notificationv(int param_1, bool param_2) {
   return;
}/* LocalVector<RenderingDevice::Uniform, unsigned int, false, false>::~LocalVector() */void LocalVector<RenderingDevice::Uniform,unsigned_int,false,false>::~LocalVector(LocalVector<RenderingDevice::Uniform,unsigned_int,false,false> *this) {
   long *plVar1;
   long lVar2;
   long lVar3;
   void *pvVar4;
   ...
   const */undefined8 MethodBindTRS<RID,RID,unsigned_int,TypedArray<RDUniform>const&>::_gen_argument_type(MethodBindTRS<RID,RID,unsigned_int,TypedArray<RDUniform>const&> *this, int param_1) {
   undefined8 uVar1;
   uVar1 = 0x17;
    ...
    */undefined8 MethodBindTRS<RID,RID,unsigned_int,TypedArray<RDUniform>const&>::get_argument_meta(MethodBindTRS<RID,RID,unsigned_int,TypedArray<RDUniform>const&> *this, int param_1) {
   undefined8 uVar1;
   uVar1 = 0;
   if (param_1 == 1) {
      uVar1 = 7;
   ...
   return uVar1;
}/* MethodBindTRS<RID, RID, unsigned int, TypedArray<RDUniform> const&>::~MethodBindTRS() */void MethodBindTRS<RID,RID,unsigned_int,TypedArray<RDUniform>const&>::~MethodBindTRS(MethodBindTRS<RID,RID,unsigned_int,TypedArray<RDUniform>const&> *this) {
   *(undefined***)this = &PTR__gen_argument_type_001032c0;
   ...
   *(undefined***)this = &PTR__gen_argument_type_001032c0;
   ...
   return;
}/* UniformSetCacheRD::_get_class_namev() const */undefined8 *UniformSetCacheRD::_get_class_namev(void) {
   int iVar1;
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00100d63:return &_get_class_namev();
      }
      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00100d63;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "UniformSetCacheRD");
         goto LAB_00100dce;
      }
   }
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "UniformSetCacheRD");
   LAB_00100dce:return &_get_class_namev();
}/* UniformSetCacheRD::get_class() const */void UniformSetCacheRD::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
   ...
   const**, void*) const */void MethodBindTRS<RID,RID,unsigned_int,TypedArray<RDUniform>const&>::ptrcall(MethodBindTRS<RID,RID,unsigned_int,TypedArray<RDUniform>const&> *this, Object *param_1, void **param_2, void *param_3) {
   long *plVar1;
   code *pcVar2;
   long lVar3;
   char cVar4;
   ...
   *(undefined8*)param_3 = uVar5;
   ...
   Variant const**, Variant*) const */void MethodBindTRS<RID,RID,unsigned_int,TypedArray<RDUniform>const&>::validated_call(MethodBindTRS<RID,RID,unsigned_int,TypedArray<RDUniform>const&> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   long *plVar1;
   code *pcVar2;
   long lVar3;
   char cVar4;
   ...
   *(undefined8*)( param_3 + 8 ) = uVar5;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* UniformSetCacheRD::is_class(String const&) const */undefined8 UniformSetCacheRD::is_class(UniformSetCacheRD *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long lVar4;
   ...
   for (lVar2 = *(long*)( this + 8 ); lVar2 != 0; lVar2 = *(long*)( lVar2 + 8 )) {
      ...
      LAB_0010129f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
   ...
   if (cVar6 == '\0') {
      for (lVar2 = *(long*)( this + 8 ); lVar2 != 0; lVar2 = *(long*)( lVar2 + 8 )) {
         ...
         LAB_00101403:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
      ...
      LAB_00101353:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
   }
   /* WARNING: Subroutine does not return */
   ...
   const**, int, Callable::CallError&) const */Object *MethodBindTRS<RID,RID,unsigned_int,TypedArray<RDUniform>const&>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   long *plVar1;
   Variant *pVVar2;
   Variant *pVVar3;
   code *pcVar4;
      ...
      if ((int)( 3 - in_R8D ) <= iVar10) {
         ...
         do {
            if ((int)lVar8 < (int)in_R8D) {
               ...
               if (lVar12 <= (int)uVar6) {
                  _err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, (long)(int)uVar6, lVar12, "p_index", "size()", "", false, true);
                  _err_flush_stdout();
                  /* WARNING: Does not return */
   ...
   *in_R9 = uVar7;
   in_R9[2] = 3;
   LAB_00101757:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* UniformSetCacheRD::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void UniformSetCacheRD::_get_property_listv(List *param_1, bool param_2) {
   long *plVar1;
   long lVar2;
   long lVar3;
   ...
   *(int*)( plVar1 + 2 ) = (int)plVar1[2] + 1;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* UniformSetCacheRD::_bind_methods() [clone .cold] */void UniformSetCacheRD::_bind_methods(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}/* UniformSetCacheRD::_initialize_classv() */void UniformSetCacheRD::_initialize_classv(void) {
   long *plVar1;
   long lVar2;
   long in_FS_OFFSET;
   long local_50;
   ...
   long UniformSetCacheRD::_allocate_from_uniforms<LocalVector<RenderingDevice::Uniform,unsigned_int,false,false>>(UniformSetCacheRD *this, undefined8 param_2, undefined4 param_3, undefined4 param_4, uint param_5, uint *param_6) {
      ...
      if (lVar10 == 0) {
         ...
         *(undefined1(**) [16])( this + (ulong)param_5 * 8 + 0x1e0 ) = pauVar2;
         uVar9 = RenderingDevice::get_singleton();
         RenderingDevice::uniform_set_set_invalidation_callback(uVar9, lVar10, _uniform_set_invalidation_callback, pauVar2);
         *(int*)( this + 0x201c8 ) = *(int*)( this + 0x201c8 ) + 1;
      }
      return lVar10;
   }
   ...
   undefined8 UniformSetCacheRD::get_cache_vec<>(UniformSetCacheRD *this, long param_2, int param_3, uint *param_4) {
      ...
      if (*param_4 != 0) {
         ...
         do {
            ...
            if (lVar15 != 0) {
               ...
               do {
                  ...
                  if (lVar15 == 0) {
                     ...
                     if (lVar15 == 0) {
                        lVar6 = 0;
                        LAB_00102851:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar14, lVar6, "p_index", "size()", "", false, true);
                        _err_flush_stdout();
                        /* WARNING: Does not return */
                        pcVar2 = (code*)invalidInstructionException();
                        ( *pcVar2 )();
                     ...
                     LAB_00102609:iVar7 = (int)( (ulong)lVar15 >> 0x20 );
            ...
            if (( *(long*)( piVar11 + 8 ) != 0 ) && ( uVar3 = ( uint ) * (undefined8*)( *(long*)( piVar11 + 8 ) + -8 ) ),uVar3 != 0) goto LAB_001025f2;
            LAB_00102678:lVar10 = lVar10 + 1;
      ...
      while (true) {
         ...
         LAB_00102720:lVar10 = *(long*)( lVar10 + 8 );
      };
      if (*param_4 == 0) {
         LAB_00102abd:return *(undefined8*)( lVar10 + 0x28 );
      }
      lVar15 = 0;
      uVar9 = 0;
      do {
         ...
         if (*(long*)( piVar11 + 4 ) != 0) {
            if (lVar5 == 0) {
               if (( *(long*)( piVar12 + 8 ) == 0 ) || ( uVar8 = ( uint ) * (undefined8*)( *(long*)( piVar12 + 8 ) + -8 ) ),uVar8 != 1) goto LAB_00102720;
            } else {
               uVar8 = 1;
            }
            LAB_0010289b:uVar13 = 0;
            do {
               uVar14 = uVar13;
               if (lVar5 == 0) {
                  ...
                  uVar14 = 0;
                  if (lVar6 == 0) {
                     LAB_001028cd:lVar1 = *(long*)( piVar11 + 8 );
                     if (lVar1 == 0) {
                        lVar6 = 0;
                        goto LAB_00102851;
                     }
                  ...
                  lVar5 = 0;
                  LAB_0010294e:_err_print_error("get_id", "./servers/rendering/rendering_device.h", 0x3ca, "Condition \"p_idx != 0\" is true. Returning: RID()", 0, 0);
                  lVar6 = 0;
               }
         ...
         if (*(long*)( piVar11 + 8 ) == 0) {
            ...
            if (*(long*)( piVar12 + 8 ) != 0) {
               ...
               joined_r0x00102aaf:if (uVar8 != 0) goto LAB_00102720;
            }
         } else {
   ...
   PropertyInfo&) */
   void call_get_argument_type_info<RID,unsigned_int,TypedArray<RDUniform>const&>(int param_1, PropertyInfo *param_2) {
      ...
      if (param_1 == 0) {
         ...
         LAB_00102cc9:local_50 = 0;
         if (local_80 != 0) goto LAB_00102c1f;
         LAB_00102cef:local_48 = 0;
         local_60 = (undefined1[16])0x0;
         local_88 = 0;
         LAB_00102cfc:local_40 = 6;
      ...
      *(undefined4*)( param_2 + 0x28 ) = local_40;
      ...
      CowData<char32_t>::_unref((CowData<char32_t>*)local_60);
      LAB_00102b87:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   ...
   const */
   undefined4 *MethodBindTRS<RID,RID,unsigned_int,TypedArray<RDUniform>const&>::_gen_argument_type_info(int param_1) {
      long *plVar1;
      undefined1 auVar2[16];
      long lVar3;
      uint in_EDX;
      ...
      if (in_EDX < 3) {
         ...
         local_40 = 6;
         local_60 = (undefined1[16])0x0;
         call_get_argument_type_info<RID,unsigned_int,TypedArray<RDUniform>const&>(in_EDX, (PropertyInfo*)&local_68);
      ...
      *(undefined1(*) [16])( puVar4 + 2 ) = (undefined1[16])0x0;
      if (local_78 == 0) {
         puVar4[10] = 6;
         LAB_00103007:StringName::operator =((StringName*)( puVar4 + 4 ), (StringName*)&local_70);
         lVar3 = local_78;
      } else {
      ...
      LAB_00102ef9:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return puVar4;
      }
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   for (int i_819 = 0; i_819 < 2; i_819++) {
      /* WARNING: Control flow encountered bad instruction data */
   }
   void MethodBindTRS<RID,RID,unsigned_int,TypedArray<RDUniform>const&>::~MethodBindTRS(MethodBindTRS<RID,RID,unsigned_int,TypedArray<RDUniform>const&> *this) {
      /* WARNING: Bad instruction - Truncating control flow here */
      halt_baddata();
   }
   for (int i_820 = 0; i_820 < 2; i_820++) {
      /* WARNING: Control flow encountered bad instruction data */
   }

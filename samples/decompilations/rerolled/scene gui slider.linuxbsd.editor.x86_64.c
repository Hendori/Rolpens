...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Slider::gui_input(Ref<InputEvent> const&) */void Slider::gui_input(Slider *this, Ref *param_1) {
   ...
   if (SVar1 != (Slider)0x0) {
      ...
      if (pOVar7 == (Object*)0x0) {
         ...
         pOVar9 = pOVar7;
         joined_r0x00102973:if (( cVar4 != '\0' ) && ( cVar4 = predelete_handler(local_b8) ),cVar4 != '\0') {
...
pOVar10 = (Object*)0x0;if (local_b8 == (Object*)0x0 && pOVar7 == (Object*)0x0) goto LAB_00102d30;LAB_0010268d:cVar4 = RefCounted::unreference();if (( cVar4 != '\0' ) && ( cVar4 = predelete_handler(pOVar9) ),cVar4 != '\0') {

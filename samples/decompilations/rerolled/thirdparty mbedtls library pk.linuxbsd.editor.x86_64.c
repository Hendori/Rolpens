/* WARNING: Type propagation algorithm not settling */undefined8 import_public_into_psa_constprop_0(undefined8 *param_1, short *param_2, undefined8 param_3) {
   short sVar1;
   int iVar2;
   undefined4 *puVar3;
   undefined1 *puVar4;
   ...
   LAB_00100094:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
   ...
   return uVar7;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int copy_from_psa(ulong param_1, long *param_2, int param_3) {
   int iVar1;
   undefined4 uVar2;
   long lVar3;
   uint uVar4;
      ...
      if (iVar1 == 0) {
         if (param_3 == 0) {
            ...
            if (local_9a8._0_2_ == 0x7001) {
               LAB_001004c8:if (*param_2 == 0) {
                  ...
                  *param_2 = (long)&mbedtls_rsa_info;
                  ...
                  if (iVar1 == 0) {
                     ...
                     if (( ( local_9a8 & (undefined1[16])0xff00000000 ) != (undefined1[16])0x0 ) && ( ( uVar4 | 0x2000000 ) == 0x20000ff )) {
                        uVar4 = 0;
                     }
                     lVar3 = 0;
                     if (( ( local_9a8._12_4_ & 0xffffff00 ) == 0x7000300 ) || ( ( local_9a8._12_4_ & 0xffffef00 ) == 0x6000300 )) {
                        if (( (int*)*param_2 != (int*)0x0 ) && ( *(int*)*param_2 == 1 )) {
                           lVar3 = param_2[1];
                        }
                        iVar1 = mbedtls_rsa_set_padding(lVar3, 1, uVar4);
                     } else if (( ( local_9a8._12_4_ & 0xffffff00 ) == 0x6000200 ) || ( local_9a8._12_4_ == 0x7000200 )) {
                        if (( (int*)*param_2 != (int*)0x0 ) && ( *(int*)*param_2 == 1 )) {
                           lVar3 = param_2[1];
                        }
                  ...
                  LAB_00100650:iVar1 = -16000;
               }
            } else {
               LAB_001003bc:if (uVar5 == 0x4001) goto LAB_001004c8;
               uVar6 = uVar5 & 0xff00;
               ...
               LAB_0010040c:*param_2 = (long)&mbedtls_eckey_info;
               ...
               if (iVar1 == 0) {
                  if (uVar6 == 0x7100) {
                     ...
                     if (iVar1 == 0) {
                        iVar1 = mbedtls_pk_ecc_set_pubkey_from_prv(param_2, local_988, local_9b0, &mbedtls_psa_get_random, 0);
                     }
                  } else {
            ...
            LAB_00100620:iVar1 = psa_pk_status_to_mbedtls(iVar1);
         }
         LAB_00100458:psa_reset_key_attributes(local_9a8);
         mbedtls_platform_zeroize(local_988, 0x93b);
         goto LAB_0010046d;
      }
   }
   LAB_00100640:iVar1 = -16000;
   LAB_0010046d:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar1;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   *param_1 = (undefined1[16])0x0;
   ...
   return uVar2;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 mbedtls_pk_setup_rsa_alt(long *param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5) {
   undefined8 *puVar1;
   undefined8 uVar2;
   if (*param_1 == 0) {
   ...
   if (( param_1 == (long*)0x0 ) || ( puVar1 = (uint*)*param_1 ),puVar1 == (uint*)0x0) {
      uVar9 = 0xffffc180;
      if (( param_2 == 0x400 ) || ( ( uVar9 = 0xffffc180 ),param_2 == 0x1000 || ( param_2 == 0x200 ) )) goto LAB_001008a5;
      LAB_00100a7e:uVar9 = 0xffffc180;
      goto LAB_001008a5;
   }
   uVar8 = *puVar1;
   if (param_2 == 0x400) {
      uVar15 = 0xc03;
      uVar14 = 0xc00;
      LAB_001008dc:bVar16 = param_2 != 0x100;
      joined_r0x001008eb:if (4 < uVar8) {
         LAB_00100894:uVar9 = 0xffffc180;
         if (uVar8 == 5) {
            uVar9 = 0xffffc680;
         }
         goto LAB_001008a5;
      ...
      if (param_2 == 0x200) {
         ...
         LAB_0010092b:bVar3 = false;
      }
      lVar11 = 0;
      if (puVar1 != (uint*)0x0) {
         lVar11 = param_1[1];
         LAB_00100af3:if (*puVar1 != 1) {
            lVar11 = 0;
         }
      }
      ...
      uVar14 = 0x300;
      bVar16 = true;
      LAB_00100965:puVar13 = (undefined4*)param_1[1];
      if (puVar1 == (uint*)0x0) goto mbedtls_pk_get_psa_attributes_cold;
      LAB_00100972:if (2 < *puVar1 - 2) {
         mbedtls_pk_get_psa_attributes_cold:/* WARNING: Does not return */pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
      }
      ...
      if (param_2 == 0x2000) {
         LAB_00100aaa:if (uVar8 != 3) {
            uVar12 = 0x60007ff;
            LAB_001009d4:if (( sVar6 != 0 ) || ( !bVar16 )) {
               if (bVar16) {
   ...
   LAB_00100b98:uVar9 = 0xffffc100;
   LAB_001008a5:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar9;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   *param_3 = 0;
   ...
   return;
}undefined8 mbedtls_pk_verify_restartable(long *param_1, int param_2, long param_3, ulong param_4, undefined8 param_5, undefined8 param_6) {
   byte bVar1;
   undefined8 uVar2;
   long lVar3;
   ...
   lVar3 = *param_1;
   LAB_00100d10:if (*(code**)( lVar3 + 0x20 ) != (code*)0x0) {
      for (int i_847 = 0; i_847 < 2; i_847++) {
   ...
   return 0xffffc100;
}undefined8 mbedtls_pk_verify(long *param_1, int param_2, long param_3, ulong param_4, undefined8 param_5, undefined8 param_6) {
   byte bVar1;
   undefined8 uVar2;
   long lVar3;
   if (( param_2 == 0 ) && ( param_4 == 0 )) {
   ...
   lVar3 = *param_1;
   LAB_00100db0:if (*(code**)( lVar3 + 0x20 ) != (code*)0x0) {
      for (int i_848 = 0; i_848 < 2; i_848++) {
   ...
   return 0xffffc100;
}ulong mbedtls_pk_verify_ext(int param_1, undefined4 *param_2, long *param_3, int param_4, long param_5, ulong param_6, undefined8 param_7, ulong param_8) {
   int *piVar1;
   int iVar2;
   uint uVar3;
   ulong uVar4;
   ...
   if (( ( param_4 == 0 && param_6 == 0 ) || ( param_5 != 0 ) ) && ( *param_3 != 0 )) {
      ...
      if (param_1 == 6) {
         ...
         if (( param_4 != 0 || param_6 >> 0x20 == 0 ) && ( param_2 != (undefined4*)0x0 )) {
            ...
            uVar3 = mbedtls_rsa_rsassa_pss_verify_ext(lVar5, param_4, param_6 & 0xffffffff, param_5, *param_2, param_2[1], param_7);
            if (uVar3 != 0) {
               return (ulong)uVar3;
            }
            if (*param_3 == 0) {
   ...
   return 0xffffc180;
}undefined8 mbedtls_pk_sign_restartable(long *param_1, int param_2, long param_3, ulong param_4, undefined8 param_5, undefined8 param_6) {
   byte bVar1;
   undefined8 uVar2;
   long lVar3;
   if (( param_2 == 0 ) && ( param_4 == 0 )) {
   ...
   lVar3 = *param_1;
   LAB_00101015:if (*(code**)( lVar3 + 0x28 ) != (code*)0x0) {
      for (int i_849 = 0; i_849 < 2; i_849++) {
   ...
   return 0xffffc100;
}undefined8 mbedtls_pk_sign(long *param_1, int param_2, long param_3, ulong param_4, undefined8 param_5, undefined8 param_6) {
   byte bVar1;
   undefined8 uVar2;
   long lVar3;
   if (( param_2 == 0 ) && ( param_4 == 0 )) {
   ...
   lVar3 = *param_1;
   LAB_001010e5:if (*(code**)( lVar3 + 0x28 ) != (code*)0x0) {
      for (int i_850 = 0; i_850 < 2; i_850++) {
   ...
   return 0xffffc100;
}undefined8 mbedtls_pk_sign_ext(int param_1, long *param_2, undefined4 param_3, undefined8 param_4, ulong param_5, undefined8 param_6, ulong param_7, undefined8 *param_8, undefined8 param_9, undefined8 param_10) {
   byte bVar1;
   int iVar2;
   long lVar3;
   undefined8 uVar4;
   ...
   if (*param_2 == 0) {
      ...
      LAB_001012a0:uVar4 = mbedtls_md_info_from_type(param_3);
   ...
   LAB_001011fd:uVar4 = mbedtls_rsa_rsassa_pss_sign_no_mode_check(piVar5, param_9, param_10, param_3, param_5 & 0xffffffff, param_4, param_6);
   if ((int)uVar4 == 0) {
   ...
   undefined8 uVar3;
   piVar1 = (int*)*param_1;
   if (( ( piVar1 != (int*)0x0 ) && ( piVar2 = (int*)*param_2 ),param_3 != 0 )) {

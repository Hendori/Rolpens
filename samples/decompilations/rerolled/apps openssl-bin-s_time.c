/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */SSL *doConnection(SSL *param_1, void *param_2, SSL_CTX *param_3) {
   int iVar1;
   BIO_METHOD *type;
   BIO *bp;
   long lVar2;
   ...
   if (bp != (BIO*)0x0) {
      ...
      LAB_00100100:BIO_free(bp);
   }
   LAB_00100108:s = (SSL*)0x0;
   LAB_001000cc:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return s;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */uint s_time_main(undefined4 param_1, undefined8 param_2) {
   bool bVar1;
   bool bVar2;
   int iVar3;
   int iVar4;
   ...
   local_2080 = 0;
   local_2088 = 0;
   switchD_00100292_caseD_0:iVar3 = opt_next();
   do {
      if (iVar3 == 0) {
         iVar3 = opt_check_rest_arg(0);
         if (iVar3 == 0) {
            switchD_00100292_caseD_ffffffff:pcVar10 = "%s: Use -help for summary.\n";
            LAB_0010032a:BIO_printf(_bio_err, pcVar10, uVar5);
         } else {
            if (pcVar10 == (char*)0x0) {
            ...
            if (ctx != (SSL_CTX*)0x0) {
               ...
               if (( lVar6 == 0 ) || ( lVar8 = lVar8 == 0 )) goto LAB_0010030e;
               if (bVar2) {
                  SSL_CTX_set_options(ctx, 0x80000850);
               }
               if (( ( ( pcVar10 != (char*)0x0 ) && ( iVar3 = SSL_CTX_set_cipher_list(ctx, pcVar10) ),iVar3 == 0 ) ) || ( ( local_20a0 != 0 && ( iVar3 = SSL_CTX_set_ciphersuites(ctx, local_20a0) ),iVar3 == 0 ) )) goto LAB_0010030e;
               iVar3 = ctx_set_verify_locations(ctx, local_2080, local_2058, local_2088, local_205c, local_2078, local_2054);
               if (iVar3 == 0) {
                  ERR_print_errors(_bio_err);
                  goto LAB_0010030e;
               }
      ...
      if (iVar3 < 0x19) {
         if (-2 < iVar3) {
          ...
          break;
               for (int i_2282 = 0; i_2282 < 4; i_2282++) {
                  case 0x15:
          lVar8 = 0x301;
          break;
               }
   ...
   LAB_001006cd:tVar9 = time((time_t*)0x0);
   ...
   if (local_2098 != (char*)0x0) {
      ...
      if (( iVar4 < 1 ) || ( iVar4 = iVar4 < 1 )) goto LAB_00100342;
   ...
   LAB_00100845:if (bVar1) {
      ...
      if (ssl != (SSL*)0x0) {
         ...
         while (tVar9 = time((time_t*)0x0),tVar9 <= lVar8) {
            ...
            if (local_2098 != (char*)0x0) {
               iVar4 = BIO_snprintf(local_2048, 0x2000, "GET %s HTTP/1.0\r\n\r\n");
               if (( iVar4 < 1 ) || ( iVar4 = iVar4 < 1 )) goto LAB_00100a5e;
               while (iVar4 = SSL_read(ssl, local_2048, 0x2000),0 < iVar4) {
                  lVar6 = lVar6 + iVar4;
               };
            }
         ...
         if (iVar3 == 0) {
            ...
            tVar9 = time((time_t*)0x0);
            uVar13 = 0;
            __printf_chk(2, "%d connections in %ld real seconds, %ld bytes read per connection\n", iVar3, ( tVar9 - lVar8 ) + lVar11, lVar6 / (long)iVar3);
         }
         goto LAB_00100342;
      }
      BIO_printf(_bio_err, "Unable to get connection\n");
   }
   LAB_0010030e:uVar13 = 1;
   ssl = (SSL*)0x0;
   LAB_00100342:SSL_free(ssl);
   SSL_CTX_free(ctx);

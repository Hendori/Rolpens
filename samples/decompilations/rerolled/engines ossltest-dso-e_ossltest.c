undefined8 ossltest_init(void) {
   return 1;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 ossltest_rand_bytes(undefined1 (*param_1)[16], uint param_2) {
   char cVar1;
   char cVar2;
   char cVar3;
   char cVar4;
   ...
   if (-1 < (int)uVar19) {
      ...
      if (6 < param_2 - 1) {
         ...
         *(ulong*)( *param_1 + uVar22 ) = CONCAT17(auVar24[7] + _LC2._7_1_, CONCAT16(auVar24[6] + _LC2._6_1_, CONCAT15(auVar24[5] + _LC2._5_1_, CONCAT14(auVar24[4] + _LC2._4_1_, CONCAT13(auVar24[3] + _LC2._3_1_, CONCAT12(auVar24[2] + _LC2._2_1_, CONCAT11(auVar24[1] + _LC2._1_1_, auVar24[0] + (char)_LC2)))))));
   ...
   CRYPTO_free(__dest);
   return uVar1;
}void ossltest_aes128_init_key(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined4 param_4) {
   EVP_CIPHER *pEVar1;
   code *UNRECOVERED_JUMPTABLE;
   pEVar1 = EVP_aes_128_cbc();
   UNRECOVERED_JUMPTABLE = (code*)EVP_CIPHER_meth_get_init(pEVar1);
   for (int i_544 = 0; i_544 < 2; i_544++) {
...
}void ossltest_aes128_gcm_init_key(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined4 param_4) {
   EVP_CIPHER *pEVar1;
   code *UNRECOVERED_JUMPTABLE;
   pEVar1 = EVP_aes_128_gcm();
   UNRECOVERED_JUMPTABLE = (code*)EVP_CIPHER_meth_get_init(pEVar1);
   for (int i_545 = 0; i_545 < 2; i_545++) {
      /* WARNING: Could not recover jumptable at 0x001003ad. Too many branches */
   }
   ( *UNRECOVERED_JUMPTABLE )(param_1, param_2, param_3, param_4);
   return;
}undefined8 ossltest_aes128_gcm_ctrl(undefined8 param_1, int param_2, undefined4 param_3, undefined1 (*param_4)[16]) {
   EVP_CIPHER *pEVar1;
   code *pcVar2;
   undefined8 uVar3;
   pEVar1 = EVP_aes_128_gcm();
   ...
   if (param_4 == 0x37f) {
      ...
      if (_hidden_aes_128_gcm == 0) {
         ...
         if (( ( ( ( _hidden_aes_128_gcm != 0 ) && ( iVar4 = EVP_CIPHER_meth_set_iv_length(_hidden_aes_128_gcm, 0xc) ),iVar4 != 0 ) ) && ( iVar4 = EVP_CIPHER_meth_set_flags(_hidden_aes_128_gcm, 0x300476) ),iVar4 != 0 )) {
      ...
      lVar7 = lVar1;
      if (( _hidden_aes_128_cbc_hmac_sha1 == 0 ) && ( ( ( ( ( _hidden_aes_128_cbc_hmac_sha1 = EVP_CIPHER_meth_new(0x394, 0x10, 0x10) ),_hidden_aes_128_cbc_hmac_sha1 == 0 || ( iVar4 = EVP_CIPHER_meth_set_iv_length(_hidden_aes_128_cbc_hmac_sha1, 0x10) ),iVar4 == 0 ) ) || ( ( iVar4 = EVP_CIPHER_meth_set_flags(_hidden_aes_128_cbc_hmac_sha1, 0x200002) ),iVar4 == 0 || ( ( ( iVar4 = EVP_CIPHER_meth_set_init(_hidden_aes_128_cbc_hmac_sha1, ossltest_aes128_cbc_hmac_sha1_init_key) ),iVar4 == 0 || ( iVar4 = EVP_CIPHER_meth_set_do_cipher(_hidden_aes_128_cbc_hmac_sha1, ossltest_aes128_cbc_hmac_sha1_cipher) ),iVar4 == 0 ) ) || ( iVar4 = EVP_CIPHER_meth_set_ctrl(_hidden_aes_128_cbc_hmac_sha1, ossltest_aes128_cbc_hmac_sha1_ctrl) ),iVar4 == 0 ) ) )) {
      ...
      if (_hidden_aes_128_cbc == 0) {
         ...
         if (( ( _hidden_aes_128_cbc != 0 ) && ( iVar4 = EVP_CIPHER_meth_set_iv_length(_hidden_aes_128_cbc, 0x10) ),iVar4 != 0 )) {
   ...
   *puVar1 = 0xffffffffffffffff;
   ...
   if (param_2 == 0x16) {
      if (param_3 == 0xd) {
         ...
         uVar4 = (uint)uVar3;
         *(uint*)( puVar2 + 1 ) = ( uint )(ushort)(*(ushort*)( param_4 + 9 ) << 8 | *(ushort*)( param_4 + 9 ) >> 8);
   ...
   return iVar1;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 ossltest_aes128_cbc_hmac_sha1_cipher(undefined8 param_1, void *param_2, void *param_3, ulong param_4) {
   ulong uVar1;
   byte bVar2;
   size_t __n;
   undefined8 uVar3;
   ...
   *psVar6 = 0xffffffffffffffff;
   ...
   if (iVar5 == 0) {
      ...
      if (__n != uVar8) {
         ...
         *(undefined8*)( (long)param_2 + __n ) = uVar3;
         ...
         if (uVar1 < uVar8) {
            memset((void*)( uVar1 + (long)param_2 ), ( (int)uVar8 + -1 ) - (int)uVar1 & 0xff, ( uVar8 - 0x14 ) - __n);
         }
      }
   }
   return 1;
   ...
   if (_hidden_md5_md == 0) {
      ...
      if (( ( ( ( lVar2 == 0 ) || ( iVar1 = EVP_MD_meth_set_result_size(lVar2, 0x10) ),iVar1 == 0 ) ) || ( iVar1 = EVP_MD_meth_set_input_blocksize(lVar2, 0x40) ),iVar1 == 0 )) {
   ...
   if (_hidden_sha1_md == 0) {
      ...
      if (( ( ( ( lVar2 == 0 ) || ( iVar1 = EVP_MD_meth_set_result_size(lVar2, 0x14) ),iVar1 == 0 ) ) || ( iVar1 = EVP_MD_meth_set_input_blocksize(lVar2, 0x40) ),iVar1 == 0 )) {
         EVP_MD_meth_free(lVar2);
         lVar2 = 0;
      }
   ...
   if (_hidden_sha256_md == 0) {
      ...
      if (( ( ( ( lVar2 == 0 ) || ( iVar1 = EVP_MD_meth_set_result_size(lVar2, 0x20) ),iVar1 == 0 ) ) || ( iVar1 = EVP_MD_meth_set_input_blocksize(lVar2, 0x40) ),iVar1 == 0 )) {
         EVP_MD_meth_free(lVar2);
         lVar2 = 0;
      }
   ...
   if (_hidden_sha384_md == 0) {
      ...
      if (( ( ( ( lVar2 == 0 ) || ( iVar1 = EVP_MD_meth_set_result_size(lVar2, 0x30) ),iVar1 == 0 ) ) || ( iVar1 = EVP_MD_meth_set_input_blocksize(lVar2, 0x80) ),iVar1 == 0 )) {
         EVP_MD_meth_free(lVar2);
         lVar2 = 0;
      }
   ...
   if (_hidden_sha512_md == 0) {
      ...
      if (( ( ( ( lVar2 == 0 ) || ( iVar1 = EVP_MD_meth_set_result_size(lVar2, 0x40) ),iVar1 == 0 ) ) || ( iVar1 = EVP_MD_meth_set_input_blocksize(lVar2, 0x80) ),iVar1 == 0 )) {
         EVP_MD_meth_free(lVar2);
         lVar2 = 0;
      }
   ...
   error_loaded = 0;
   return 1;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void digest_md5_final(undefined8 param_1, undefined8 *param_2) {
   undefined8 uVar1;
   int iVar2;
   EVP_MD *pEVar3;
   code *pcVar4;
   ...
   return;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void digest_sha1_final(undefined8 param_1, undefined8 *param_2) {
   undefined8 uVar1;
   undefined8 uVar2;
   int iVar3;
   EVP_MD *pEVar4;
   ...
   return;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void digest_sha256_final(undefined8 param_1, undefined8 *param_2) {
   undefined8 uVar1;
   int iVar2;
   EVP_MD *pEVar3;
   code *pcVar4;
   ...
   return;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void digest_sha384_final(undefined8 param_1, undefined8 *param_2) {
   undefined8 uVar1;
   int iVar2;
   EVP_MD *pEVar3;
   code *pcVar4;
   ...
   return;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void digest_sha512_final(undefined8 param_1, undefined8 *param_2) {
   undefined8 uVar1;
   int iVar2;
   EVP_MD *pEVar3;
   code *pcVar4;
   ...
   return 0;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */EVP_PKEY *ossltest_load_privkey(undefined8 param_1, long param_2) {
   int iVar1;
   BIO *bp;
   EVP_PKEY *pEVar2;
   ...
   return (EVP_PKEY*)0x0;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */EVP_PKEY *ossltest_load_pubkey(undefined8 param_1, long param_2) {
   int iVar1;
   BIO *bp;
   EVP_PKEY *pEVar2;
   iVar1 = OPENSSL_strncasecmp(param_2, &_LC12, 3);

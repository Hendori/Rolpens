/* DynamicBVH::_recurse_delete_node(DynamicBVH::Node*) */void DynamicBVH::_recurse_delete_node(DynamicBVH *this, Node *param_1) {
   uint uVar1;
   ...
   *(Node**)( *(long*)( *(long*)( this + 8 ) + ( ulong )(uVar1 >> ( ( byte ) * (undefined4*)( this + 0x18 ) & 0x1f )) * 8 ) + ( ulong )(uVar1 & *(uint*)( this + 0x1c )) * 8 ) = param_1;
   *(uint*)( this + 0x14 ) = uVar1 + 1;
   return;
}
/* DynamicBVH::_fetch_leaves(DynamicBVH::Node*, LocalVector<DynamicBVH::Node*, unsigned int, false,
   false>&, int) */void DynamicBVH::_fetch_leaves(DynamicBVH *this, Node *param_1, LocalVector *param_2, int param_3) {
   uint uVar1;
   code *pcVar2;
   void *pvVar3;
   ulong uVar4;
...
/* DynamicBVH::_split(DynamicBVH::Node**, int, Vector3 const&, Vector3 const&) */ulong DynamicBVH::_split(Node **param_1, int param_2, Vector3 *param_3, Vector3 *param_4) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   if (param_2 != 0) {
      ...
      do {
         ...
         if (0.0 < ( ( *(float*)pNVar7 + *(float*)( pNVar7 + 0xc ) ) * fVar9 - fVar1 ) * fVar2 + ( ( *(float*)( pNVar7 + 4 ) + *(float*)( pNVar7 + 0x10 ) ) * fVar9 - fVar3 ) * fVar5 + ( ( *(float*)( pNVar7 + 8 ) + *(float*)( pNVar7 + 0x14 ) ) * fVar9 - fVar4 ) * fVar6) {
            uVar13 = param_2;
            if (param_2 == (uint)uVar11) break;
            lVar10 = (long)(int)( param_2 - 1U );
            while (pNVar8 = param_1[lVar10],0.0 < ( ( *(float*)pNVar8 + *(float*)( pNVar8 + 0xc ) ) * fVar9 - fVar1 ) * fVar2 + ( ( *(float*)( pNVar8 + 4 ) + *(float*)( pNVar8 + 0x10 ) ) * fVar9 - fVar3 ) * fVar5 + ( ( *(float*)( pNVar8 + 8 ) + *(float*)( pNVar8 + 0x14 ) ) * fVar9 - fVar4 ) * fVar6) {
               lVar10 = lVar10 + -1;
...
/* DynamicBVH::_bounds(DynamicBVH::Node**, int) */DynamicBVH * __thiscall DynamicBVH::_bounds(DynamicBVH *this,Node **param_1,int param_2){
   float fVar1;
   Node *pNVar2;
   undefined8 uVar3;
   undefined8 uVar4;
...
/* DynamicBVH::_bottom_up(DynamicBVH::Node**, int) */void DynamicBVH::_bottom_up(DynamicBVH *this, Node **param_1, int param_2) {
   Node *pNVar1;
   Node *pNVar2;
   Node *pNVar3;
   long *plVar4;
 ...
 while ( lVar6 != 0xc );
                  fVar23 = ( afStack_4c[1] - local_58._4_4_ ) * ( afStack_4c[0] - (float)local_58 ) * ( afStack_4c[2] - fStack_50 ) + ( afStack_4c[0] - (float)local_58 ) + ( afStack_4c[1] - local_58._4_4_ ) + ( afStack_4c[2] - fStack_50 );
                  fVar22 = fVar24;
                  if (fVar23 < fVar24) {
 ...
 while ( plVar4 + uVar5 != plVar9 );
         ...
         *(uint*)( this + 0x14 ) = uVar5;
         pNVar3 = *(Node**)( plVar13[uVar5 >> ( ( byte ) * (undefined4*)( this + 0x18 ) & 0x1f )] + ( ulong )(uVar5 & *(uint*)( this + 0x1c )) * 8 );
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* DynamicBVH::_top_down(DynamicBVH::Node**, int, int) */Node * __thiscall DynamicBVH::_top_down(DynamicBVH *this,Node **param_1,int param_2,int param_3){
   float *pfVar1;
   float *pfVar2;
   float fVar3;
   float fVar4;
   ...
   long local_40;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (( _top_down(DynamicBVH::Node**,int,int):: ) && ( iVar18 = __cxa_guard_acquire(&_top_down(DynamicBVH::Node * *,int,int)::axis), iVar18 != 0) ) {
      _axis = ZEXT416(_LC7);
   ...
   if (param_3 < 2) {
      pNVar25 = (Node*)0x0;
      _err_print_error("_top_down", "core/math/dynamic_bvh.cpp", 0xd3, "Condition \"p_bu_threshold <= 1\" is true. Returning: nullptr", 0, 0);
   }
 else if (param_2 < 2) {
      pNVar25 = *param_1;
   }
      ...
      do {
         ...
         do {
            ...
            iVar18 = iVar18 + 1;
            pfVar12 = pfVar12 + 3;
            *(int*)( local_58 + ( ( ulong )(0.0 < fVar9 * ( ( fVar7 + fVar8 ) * (float)_LC4 - fVar27 ) + *pfVar1 * ( ( fVar4 + fVar6 ) * (float)_LC4 - fVar28 ) + *pfVar2 * ( ( fVar3 + fVar5 ) * (float)_LC4 - local_80 )) + lVar24 * 2 ) * 4 ) = *(int*)( local_58 + ( ( ulong )(0.0 < fVar9 * ( ( fVar7 + fVar8 ) * (float)_LC4 - fVar27 ) + *pfVar1 * ( ( fVar4 + fVar6 ) * (float)_LC4 - fVar28 ) + *pfVar2 * ( ( fVar3 + fVar5 ) * (float)_LC4 - local_80 )) + lVar24 * 2 ) * 4 ) + 1;
         }
 while ( iVar18 != 3 );
         ppNVar16 = ppNVar16 + 1;
      }
 while ( ppNVar16 != param_1 + param_2 );
      ...
      iVar18 = param_2;
      do {
         if (( ( 0 < *piVar13 ) && ( 0 < piVar13[1] ) ) && ( iVar15 = iVar15 < iVar18 )) {
            lVar24 = (long)iVar19;
            iVar18 = iVar15;
         }
 ...
 while ( iVar19 != 3 );
      if ((int)lVar24 < 0) {
         ...
         iVar18 = _split(param_1, param_2, (Vector3*)&local_88, (Vector3*)( &_top_down(DynamicBVH::Node * *,int,int)::axis + lVar24 * 3) ));
         if (( iVar18 == 0 ) || ( param_2 == iVar18 )) {
            pNVar25 = (Node*)0x0;
            _err_print_error("_top_down", "core/math/dynamic_bvh.cpp", 0xee, "Condition \"partition == 0 || partition == p_count\" is true. Returning: nullptr", 0, 0);
            goto LAB_001009b4;
         }
 ...
 while ( plVar10 + uVar11 != plVar21 );
      ...
      *(uint*)( this + 0x14 ) = uVar11;
      pNVar25 = *(Node**)( plVar22[uVar11 >> ( ( byte ) * (undefined4*)( this + 0x18 ) & 0x1f )] + ( ulong )(uVar11 & *(uint*)( this + 0x1c )) * 8 );
   ...
   LAB_001009b4:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return pNVar25;
   }
...
/* DynamicBVH::_node_sort(DynamicBVH::Node*, DynamicBVH::Node*&) */Node * __thiscall DynamicBVH::_node_sort(DynamicBVH *this,Node *param_1,Node **param_2){
   long lVar1;
   Node *pNVar2;
   long lVar3;
   long lVar4;
   ...
   if (*(long*)( param_1 + 0x28 ) == 0) {
      _err_print_error("_node_sort", "core/math/dynamic_bvh.cpp", 0x103, "Condition \"!n->is_internal()\" is true. Returning: nullptr", 0, 0);
      param_1 = (Node*)0x0;
   }
      ...
      if (*(Node**)( pNVar2 + uVar12 * 8 + 0x20 ) == param_1) {
         ...
         *(undefined8*)( param_1 + 8 ) = uVar10;
         ...
         _err_print_error("_node_sort", "core/math/dynamic_bvh.cpp", 0x109, "Condition \"n != p->children[i]\" is true. Returning: nullptr", 0, 0);
         param_1 = (Node*)0x0;
      }
...
/* DynamicBVH::clear() */void DynamicBVH::clear(DynamicBVH *this) {
...
/* DynamicBVH::optimize_bottom_up() */void DynamicBVH::optimize_bottom_up(DynamicBVH *this) {
   code *pcVar1;
   long in_FS_OFFSET;
   ulong local_28;
   Node **local_20;
   ...
   local_10 = *(long*)( in_FS_OFFSET + 0x28 );
   if (*(Node**)( this + 0x68 ) == (Node*)0x0) {
      LAB_00100da8:if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
...
/* DynamicBVH::optimize_top_down(int) */void DynamicBVH::optimize_top_down(DynamicBVH *this, int param_1) {
   code *pcVar1;
   undefined8 uVar2;
   long in_FS_OFFSET;
   ulong local_38;
...
/* DynamicBVH::optimize_incremental(int) */void DynamicBVH::optimize_incremental(DynamicBVH *this, int param_1) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   if (0 < param_1) {
      do {
         ...
         if (*(long*)( pNVar29 + 0x28 ) == 0) {
            LAB_001013ac:*(Node**)( this + 0x68 ) = pNVar29;
 ...
 while ( lVar18 != 0xc );
                  ...
                  *(ulong*)pauVar25[1] = CONCAT44(afStack_4c[2], afStack_4c[1]);
                  if (( ( ( fVar1 == *(float*)*pauVar25 ) && ( fVar2 == *(float*)( *pauVar25 + 4 ) ) ) && ( fVar3 == *(float*)( *pauVar25 + 8 ) ) ) && ( ( ( fVar4 == *(float*)( *pauVar25 + 0xc ) && ( fVar5 == *(float*)pauVar25[1] ) ) && ( fVar6 == *(float*)( pauVar25[1] + 4 ) ) ) )) {
 ...
 while ( pauVar25 != (undefined1(*) [16])0x0 );
            ...
            lVar17 = *(long*)( this + 0x68 );
            joined_r0x001010f9:if (lVar17 == 0) goto LAB_001013ac;
            pfVar19 = *(float**)( lVar17 + 0x28 );
            if (pfVar19 != (float*)0x0) {
               do {
                  pfVar10 = *(float**)( lVar17 + 0x20 );
                  lVar17 = *(long*)( lVar17 + 0x20 + ( ulong )(ABS(( *(float*)pNVar29 + *(float*)( pNVar29 + 0xc ) ) - ( *pfVar19 + pfVar19[3] )) + ABS(( *(float*)( pNVar29 + 4 ) + *(float*)( pNVar29 + 0x10 ) ) - ( pfVar19[1] + pfVar19[4] )) + ABS(( *(float*)( pNVar29 + 8 ) + *(float*)( pNVar29 + 0x14 ) ) - ( pfVar19[2] + pfVar19[5] )) <= ABS(( *(float*)pNVar29 + *(float*)( pNVar29 + 0xc ) ) - ( *pfVar10 + pfVar10[3] )) + ABS(( *(float*)( pNVar29 + 4 ) + *(float*)( pNVar29 + 0x10 ) ) - ( pfVar10[1] + pfVar10[4] )) + ABS(( *(float*)( pNVar29 + 8 ) + *(float*)( pNVar29 + 0x14 ) ) - ( pfVar10[2] + pfVar10[5] ))) * 8 );
                  pfVar19 = *(float**)( lVar17 + 0x28 );
               }
 ...
 while ( plVar11 + uVar15 != plVar27 );
            ...
            *(uint*)( this + 0x14 ) = uVar15;
            pauVar33 = *(undefined1(**) [16])( plVar30[uVar15 >> ( bVar23 & 0x1f )] + ( ulong )(uVar15 & *(uint*)( this + 0x1c )) * 8 );
            ...
            if (pauVar25 == (undefined1(*) [16])0x0) {
               ...
               *(undefined1(**) [16])( this + 0x68 ) = pauVar33;
               ...
               if (*(long*)( lVar17 + 0x18 ) == 0) {
                  _err_print_error("get_index_in_parent", "core/math/dynamic_bvh.h", 0xc1, "Parameter \"parent\" is null.", 0, 0);
                  uVar21 = 0;
               }
 else {
               ...
               *(undefined1(**) [16])( pNVar29 + 0x18 ) = pauVar33;
               do {
                  pauVar28 = pauVar25;
                  if (( ( *(float*)*pauVar28 <= *(float*)*pauVar33 ) && ( *(float*)( *pauVar28 + 4 ) <= *(float*)( *pauVar33 + 4 ) ) ) && ( ( *(float*)( *pauVar28 + 8 ) <= *(float*)( *pauVar33 + 8 ) && ( ( ( *(float*)( *pauVar33 + 0xc ) <= *(float*)( *pauVar28 + 0xc ) && ( *(float*)pauVar33[1] <= *(float*)pauVar28[1] ) ) && ( *(float*)( pauVar33[1] + 4 ) <= *(float*)( pauVar28[1] + 4 ) ) ) ) ) )) break;
                  local_58 = 0;
...
/* DynamicBVH::insert(AABB const&, void*) */float *__thiscallDynamicBVH::insert(DynamicBVH *this, AABB *param_1, void *param_2) {
   float fVar1;
   float fVar2;
   undefined8 uVar3;
   undefined4 uVar4;
 ...
 while ( plVar14 != plVar7 + uVar8 );
   ...
   *(ulong*)( pfVar6 + 4 ) = CONCAT44(fVar1 + fVar2, (float)( (ulong)uVar15 >> 0x20 ) + (float)( (ulong)uVar3 >> 0x20 ));
      ...
      *(float**)( this + 0x68 ) = pfVar6;
      ...
      if (pfVar9 != (float*)0x0) {
         do {
            ...
            lVar24 = *(long*)( lVar24 + 0x20 + ( ulong )(ABS(( *pfVar6 + pfVar6[3] ) - ( *pfVar9 + pfVar9[3] )) + ABS(( pfVar6[1] + pfVar6[4] ) - ( pfVar9[1] + pfVar9[4] )) + ABS(( pfVar6[2] + pfVar6[5] ) - ( pfVar9[2] + pfVar9[5] )) <= ABS(( *pfVar6 + pfVar6[3] ) - ( *pfVar25 + pfVar25[3] )) + ABS(( pfVar6[1] + pfVar6[4] ) - ( pfVar25[1] + pfVar25[4] )) + ABS(( pfVar6[2] + pfVar6[5] ) - ( pfVar25[2] + pfVar25[5] ))) * 8 );
            pfVar9 = *(float**)( lVar24 + 0x28 );
         }
      ...
      *(ulong*)( pfVar25 + 2 ) = CONCAT44(afStack_4c[0], uStack_50);
      if (pfVar9 == (float*)0x0) {
         ...
         *(float**)( pfVar6 + 6 ) = pfVar25;
         do {
            pfVar20 = pfVar9;
            if (( ( ( *pfVar20 <= *pfVar25 ) && ( pfVar20[1] <= pfVar25[1] ) ) && ( pfVar20[2] <= pfVar25[2] ) ) && ( ( ( pfVar25[3] <= pfVar20[3] && ( pfVar25[4] <= pfVar20[4] ) ) && ( pfVar25[5] <= pfVar20[5] ) ) )) break;
            local_58 = 0;
...
/* DynamicBVH::update(DynamicBVH::ID const&, AABB const&) */undefined8 DynamicBVH::update(DynamicBVH *this, ID *param_1, AABB *param_2) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   if (pVVar11 == (Vector3*)0x0) {
      _err_print_error("update", "core/math/dynamic_bvh.cpp", 0x16a, "Condition \"!p_id.is_valid()\" is true. Returning: false", 0, 0);
      uVar22 = 0;
      goto LAB_00102107;
   }
   ...
   fVar34 = (float)( ( ulong ) * (undefined8*)( param_2 + 0xc ) >> 0x20 ) + (float)( ( ulong ) * (undefined8*)param_2 >> 0x20 );
   ...
   if (pVVar11 == *(Vector3**)( this + 0x68 )) {
      LAB_001020e0:*(ulong*)( pVVar11 + 0x10 ) = CONCAT44(fVar32, fVar34);
      *(undefined8*)pVVar11 = uVar22;
      *(ulong*)( pVVar11 + 8 ) = CONCAT44(fVar33, uVar9);
      LAB_001020f5:*(Vector3**)( this + 0x68 ) = pVVar11;
 ...
 while ( lVar18 != 0xc );
            ...
            *(ulong*)( pfVar24 + 4 ) = CONCAT44(afStack_4c[2], afStack_4c[1]);
            if (( ( ( fVar1 == *pfVar24 ) && ( fVar2 == pfVar24[1] ) ) && ( fVar3 == pfVar24[2] ) ) && ( ( ( fVar4 == pfVar24[3] && ( fVar5 == pfVar24[4] ) ) && ( fVar6 == pfVar24[5] ) ) )) {
 ...
 while ( iVar15 != iVar17 );
         ...
         LAB_00101d7f:*(undefined8*)pVVar11 = uVar22;
         *(ulong*)( pVVar11 + 8 ) = CONCAT44(fVar33, uVar9);
      ...
      *(undefined8*)pVVar11 = uVar22;
      *(ulong*)( pVVar11 + 8 ) = CONCAT44(fVar33, uVar9);
      LAB_00101d9d:pfVar19 = *(float**)( pfVar24 + 10 );
      if (pfVar19 != (float*)0x0) {
         do {
            pfVar30 = *(float**)( pfVar24 + 8 );
            pfVar24 = *(float**)( pfVar24 + ( ulong )(ABS(( *(float*)pVVar11 + *(float*)( pVVar11 + 0xc ) ) - ( *pfVar19 + pfVar19[3] )) + ABS(( *(float*)( pVVar11 + 4 ) + *(float*)( pVVar11 + 0x10 ) ) - ( pfVar19[1] + pfVar19[4] )) + ABS(( *(float*)( pVVar11 + 8 ) + *(float*)( pVVar11 + 0x14 ) ) - ( pfVar19[2] + pfVar19[5] )) <= ABS(( *(float*)pVVar11 + *(float*)( pVVar11 + 0xc ) ) - ( *pfVar30 + pfVar30[3] )) + ABS(( *(float*)( pVVar11 + 4 ) + *(float*)( pVVar11 + 0x10 ) ) - ( pfVar30[1] + pfVar30[4] )) + ABS(( *(float*)( pVVar11 + 8 ) + *(float*)( pVVar11 + 0x14 ) ) - ( pfVar30[2] + pfVar30[5] ))) * 2 + 8 );
 ...
 while ( plVar13 + uVar16 != plVar26 );
      ...
      *(uint*)( this + 0x14 ) = uVar16;
      pfVar30 = *(float**)( plVar27[uVar16 >> ( bVar23 & 0x1f )] + ( ulong )(uVar16 & *(uint*)( this + 0x1c )) * 8 );
      for (int i = 0; i < 4; i++) {
         pfVar30[( i + 8 )] = 0;
      }
      ...
      *(ulong*)( pfVar30 + 2 ) = CONCAT44(afStack_4c[0], uStack_50);
      if (pfVar19 == (float*)0x0) {
         ...
         *(float**)( pVVar11 + 0x18 ) = pfVar30;
         do {
            pfVar24 = pfVar19;
            if (( ( *pfVar24 <= *pfVar30 ) && ( pfVar24[1] <= pfVar30[1] ) ) && ( ( pfVar24[2] <= pfVar30[2] && ( ( ( pfVar30[3] <= pfVar24[3] && ( pfVar30[4] <= pfVar24[4] ) ) && ( pfVar30[5] <= pfVar24[5] ) ) ) ) )) break;
            local_58 = 0;
            lVar20 = *(long*)( pfVar24 + 8 );
            lVar18 = 0;
            uStack_50 = 0;
 ...
 while ( *(float**)( pfVar24 + 6 ) != (float*)0x0 );
   ...
   uVar22 = 1;
   LAB_00102107:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* DynamicBVH::remove(DynamicBVH::ID const&) */void DynamicBVH::remove(DynamicBVH *this, ID *param_1) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   if (lVar10 == 0) {
      if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
         _err_print_error("remove", "core/math/dynamic_bvh.cpp", 0x186, "Condition \"!p_id.is_valid()\" is true.", 0, 0);
         return;
      }
 ...
 while ( ( ( ( ( fVar1 != *pfVar14 ) || ( fVar2 != pfVar14[1] ) ) || ( fVar3 != pfVar14[2] ) ) || ( ( ( fVar4 != pfVar14[3] || ( fVar5 != pfVar14[4] ) ) || ( fVar6 != pfVar14[5] ) ) ) ) && ( pfVar14 = *(float**)( pfVar14 + 6 ) ),pfVar14 != (float*)0x0 );
         }

         uVar17 = uVar17 + 1;
      }

      *(long*)( *(long*)( lVar15 + ( ulong )(uVar17 >> ( (byte)uVar8 & 0x1f )) * 8 ) + ( ulong )(uVar9 & uVar17) * 8 ) = lVar10;
      *(int*)( this + 0x74 ) = *(int*)( this + 0x74 ) + -1;
...
/* DynamicBVH::_extract_leaves(DynamicBVH::Node*, List<DynamicBVH::ID, DefaultAllocator>*) */void DynamicBVH::_extract_leaves(DynamicBVH *this, Node *param_1, List *param_2) {
   long *plVar1;
   long lVar2;
   long *plVar3;
...
/* DynamicBVH::set_index(unsigned int) */void DynamicBVH::set_index(DynamicBVH *this, uint param_1) {
   if (*(long*)( this + 0x68 ) == 0) {
      *(uint*)( this + 0x7c ) = param_1;
      return;
   }

   _err_print_error("set_index", "core/math/dynamic_bvh.cpp", 0x199, "Condition \"bvh_root != nullptr\" is true.", 0, 0);
   return;
}
/* DynamicBVH::get_index() const */undefined4 DynamicBVH::get_index(DynamicBVH *this) {
   return *(undefined4*)( this + 0x7c );
}
/* DynamicBVH::get_elements(List<DynamicBVH::ID, DefaultAllocator>*) */void DynamicBVH::get_elements(DynamicBVH *this, List *param_1) {
   if (*(Node**)( this + 0x68 ) != (Node*)0x0) {
...
/* DynamicBVH::get_leaf_count() const */undefined4 DynamicBVH::get_leaf_count(DynamicBVH *this) {
   return *(undefined4*)( this + 0x74 );
}
/* DynamicBVH::get_max_depth() const */int DynamicBVH::get_max_depth(DynamicBVH *this) {
   long *plVar1;
   int iVar2;
   long lVar3;
   int iVar4;
...
/* DynamicBVH::~DynamicBVH() */void DynamicBVH::~DynamicBVH(DynamicBVH *this) {
   if (*(Node**)( this + 0x68 ) != (Node*)0x0) {
      _recurse_delete_node(this, *(Node**)( this + 0x68 ));
   }
   ...
   *(undefined4*)( (PagedAllocator<DynamicBVH::Node,false,4096u>*)this + 0x78 ) = 0;
   PagedAllocator<DynamicBVH::Node,false,4096u>::~PagedAllocator((PagedAllocator<DynamicBVH::Node,false,4096u>*)this);
   return;
}
...
/* DynamicBVH::Node::get_max_depth(int, int&) */void DynamicBVH::Node::get_max_depth(Node *this, int param_1, int *param_2) {
   long lVar1;
   Node *pNVar2;
   int iVar3;
   long lVar4;
                                       ...
                                       do {
                                          ...
                                          if (lVar1 == 0) {
                                             ...
                                             do {
                                                ...
                                                iVar9 = iVar13;
                                                for (lVar4 = *(long*)( *(long*)( lVar4 + 0x20 ) + 0x28 ); lVar4 != 0; lVar4 = *(long*)( lVar4 + 0x28 )) {
                                                   iVar9 = iVar9 + 1;
...
;
 ...
 while ( true );
               ...
               iVar19 = *param_2;
               iVar7 = iVar16;
               LAB_00102a64:lVar18 = *(long*)( lVar20 + 0x28 );
               if (iVar19 <= iVar7) {
                  iVar19 = iVar7;
               }
...
/* PagedAllocator<DynamicBVH::Node, false, 4096u>::~PagedAllocator() */void PagedAllocator<DynamicBVH::Node,false,4096u>::~PagedAllocator(PagedAllocator<DynamicBVH::Node,false,4096u> *this) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long lVar4;
   ...
   if (*(uint*)( this + 0x14 ) < ( uint )(*(int*)( this + 0x20 ) * *(int*)( this + 0x10 ))) {
      if ((char)CoreGlobals::leak_reporting_enabled != '\0') {
         ...
         _err_print_error("~PagedAllocator", "./core/templates/paged_allocator.h", 0xaa, (String*)&local_38, 0, 0);
         pcVar3 = local_38;
 ...
 while ( (uint)lVar4 < *(uint*)( this + 0x10 ) );
   ...
   LAB_00102fc3:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* WARNING: Control flow encountered bad instruction data *//* PagedAllocator<DynamicBVH::Node, false, 4096u>::~PagedAllocator() */void PagedAllocator<DynamicBVH::Node,false,4096u>::~PagedAllocator(PagedAllocator<DynamicBVH::Node,false,4096u> *this) {

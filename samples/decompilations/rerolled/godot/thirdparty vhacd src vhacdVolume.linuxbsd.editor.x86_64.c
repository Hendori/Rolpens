/* VHACD::VoxelSet::ComputeBB() */void VHACD::VoxelSet::ComputeBB(VoxelSet *this) {
   VoxelSet *pVVar1;
   double dVar2;
   undefined2 uVar3;
   ulong uVar4;
 ...
 while ( ( &local_20 != pdVar10 ) || ( pVVar12 = pVVar13 + 8 ),pdVar10 = (double*)local_38,pVVar11 = this + 0xa4e,pVVar13 = pVVar12,pVVar1 != pVVar12 );
      dVar14 = (double)uVar4;
      lVar9 = 0;
      auVar6._8_8_ = dVar14;
      auVar6._0_8_ = dVar14;
      ...
      do {
         ...
         *(double*)( this + lVar9 * 4 + 0xa18 ) = (double)(int)*(short*)( this + lVar9 + 0xa48 ) * dVar2 + *(double*)( this + lVar9 * 4 + 0x998 );
         *(double*)( this + lVar9 * 4 + 0xa30 ) = (double)(int)sVar8 * dVar2 + *(double*)( this + lVar9 * 4 + 0x998 );
...
/* VHACD::TetrahedronSet::ComputeBB() */void VHACD::TetrahedronSet::ComputeBB(TetrahedronSet *this) {
   undefined8 uVar1;
   long lVar2;
 ...
 while ( ( pTVar6 != this + 0x9b8 ) || ( pTVar8 = pTVar7 + 0x18 ),pTVar5 = this + 0x9a0,pTVar3 = pTVar8,pTVar8 != pTVar10 );
         lVar11 = lVar11 + 0x68;
         pTVar10 = pTVar7 + 0x80;
      }
...
/* VHACD::TetrahedronSet::Intersect(VHACD::Plane const&, VHACD::SArray<VHACD::Vec3<double>, 64ul>*,
   VHACD::SArray<VHACD::Vec3<double>, 64ul>*, unsigned long) const */void VHACD::TetrahedronSet::Intersect(Plane *param_1, SArray *param_2, SArray *param_3, ulong param_4) {
   return;
}
/* VHACD::TetrahedronSet::ComputeClippedVolumes(VHACD::Plane const&, double&, double&) const */void VHACD::TetrahedronSet::ComputeClippedVolumes(Plane *param_1, double *param_2, double *param_3) {
   return;
}
/* VHACD::TetrahedronSet::RevertAlignToPrincipalAxes() */void VHACD::TetrahedronSet::RevertAlignToPrincipalAxes(TetrahedronSet *this) {
   long lVar1;
   long lVar2;
   TetrahedronSet *pTVar3;
   ...
   if (lVar1 != 0) {
      ...
      do {
         ...
         do {
            ...
            *(double*)pTVar4 = *(double*)( this + 0xd40 ) * dVar8 + *(double*)( this + 0xd48 ) * dVar10 + *(double*)( this + 0xd50 ) * dVar9 + *(double*)( this + 0x9d0 );
            *(double*)( pTVar4 + 8 ) = *(double*)( this + 0xd58 ) * dVar8 + *(double*)( this + 0xd60 ) * dVar10 + *(double*)( this + 0xd68 ) * dVar9 + *(double*)( this + 0x9d8 );
            *(double*)( pTVar4 + 0x10 ) = dVar8 * *(double*)( this + 0xd70 ) + dVar10 * *(double*)( this + 0xd78 ) + dVar9 * *(double*)( this + 0xd80 ) + *(double*)( this + 0x9e0 );
            pTVar4 = pTVar5;
         }
...
/* VHACD::TetrahedronSet::AlignToPrincipalAxes() */void VHACD::TetrahedronSet::AlignToPrincipalAxes(TetrahedronSet *this) {
   long lVar1;
   long lVar2;
   TetrahedronSet *pTVar3;
   TetrahedronSet *pTVar4;
   ...
   if (lVar1 != 0) {
      ...
      do {
         ...
         do {
            ...
            dVar8 = *(double*)pTVar4 - *(double*)( this + 0x9d0 );
            dVar9 = *(double*)( pTVar4 + 0x10 ) - *(double*)( this + 0x9e0 );
            *(double*)pTVar4 = *(double*)( this + 0xd40 ) * dVar8 + *(double*)( this + 0xd58 ) * dVar10 + *(double*)( this + 0xd70 ) * dVar9 + *(double*)( this + 0x9d0 );
            *(double*)( pTVar4 + 8 ) = *(double*)( this + 0xd48 ) * dVar8 + *(double*)( this + 0xd60 ) * dVar10 + *(double*)( this + 0xd78 ) * dVar9 + *(double*)( this + 0x9d8 );
            *(double*)( pTVar4 + 0x10 ) = dVar8 * *(double*)( this + 0xd50 ) + dVar10 * *(double*)( this + 0xd68 ) + dVar9 * *(double*)( this + 0xd80 ) + *(double*)( this + 0x9e0 );
            pTVar4 = pTVar5;
         }
 while ( pTVar3 + lVar7 + 0x60 != pTVar5 );
         lVar6 = lVar6 + 1;
...
/* VHACD::VoxelSet::~VoxelSet() */void VHACD::VoxelSet::~VoxelSet(VoxelSet *this) {
...
/* VHACD::TetrahedronSet::~TetrahedronSet() */void VHACD::TetrahedronSet::~TetrahedronSet(TetrahedronSet *this) {
   long lVar1;
...
/* VHACD::VoxelSet::ComputeClippedVolumes(VHACD::Plane const&, double&, double&) const */void VHACD::VoxelSet::ComputeClippedVolumes(VoxelSet *this, Plane *param_1, double *param_2, double *param_3) {
   double dVar1;
   long lVar2;
   long lVar3;
   ulong uVar4;
   ...
   *param_2 = 0.0;
   ...
   do {
      ...
      uVar4 = ( uVar4 + 1 ) - ( ulong )(( (double)(int)*(short*)pVVar5 * dVar1 + *(double*)( this + 0x998 ) ) * *(double*)param_1 + ( (double)(int)*(short*)( pVVar5 + 2 ) * dVar1 + *(double*)( this + 0x9a0 ) ) * *(double*)( param_1 + 8 ) + ( (double)(int)*(short*)( pVVar5 + 4 ) * dVar1 + *(double*)( this + 0x9a8 ) ) * *(double*)( param_1 + 0x10 ) + *(double*)( param_1 + 0x18 ) < 0.0);
      lVar3 = lVar3 + 1;
   }
 while ( lVar2 != lVar3 );
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* VHACD::TetrahedronSet::ComputeVolume() const */double VHACD::TetrahedronSet::ComputeVolume(TetrahedronSet *this) {
   double dVar1;
   double dVar2;
   double dVar3;
   TetrahedronSet *pTVar4;
   ...
   if (*(long*)( this + 0xd30 ) != 0) {
      ...
      do {
         ...
         dVar7 = dVar7 + (double)( ( ulong )(( ( *(double*)( pTVar4 + 0x28 ) - dVar1 ) * ( *(double*)( pTVar4 + 0x30 ) - dVar3 ) - ( *(double*)( pTVar4 + 0x40 ) - dVar1 ) * ( *(double*)( pTVar4 + 0x18 ) - dVar3 ) ) * ( *(double*)( pTVar4 + 8 ) - dVar2 ) + ( ( *(double*)( pTVar4 + 0x40 ) - dVar1 ) * ( *(double*)( pTVar4 + 0x20 ) - dVar2 ) - ( *(double*)( pTVar4 + 0x38 ) - dVar2 ) * ( *(double*)( pTVar4 + 0x28 ) - dVar1 ) ) * ( *(double*)pTVar4 - dVar3 ) + ( ( *(double*)( pTVar4 + 0x38 ) - dVar2 ) * ( *(double*)( pTVar4 + 0x18 ) - dVar3 ) - ( *(double*)( pTVar4 + 0x30 ) - dVar3 ) * ( *(double*)( pTVar4 + 0x20 ) - dVar2 ) ) * ( *(double*)( pTVar4 + 0x10 ) - dVar1 )) & _LC3 );
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* VHACD::TetrahedronSet::ComputeMaxVolumeError() const */double VHACD::TetrahedronSet::ComputeMaxVolumeError(TetrahedronSet *this) {
   double dVar1;
   double dVar2;
   double dVar3;
   TetrahedronSet *pTVar4;
...
/* VHACD::VoxelSet::SelectOnSurface(VHACD::PrimitiveSet*) const */void VHACD::VoxelSet::SelectOnSurface(VoxelSet *this, PrimitiveSet *param_1) {
   undefined8 uVar1;
   undefined2 uVar2;
   undefined4 uVar3;
   long lVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* VHACD::TetrahedronSet::ComputeConvexHull(VHACD::Mesh&, unsigned long) const */void VHACD::TetrahedronSet::ComputeConvexHull(TetrahedronSet *this, Mesh *param_1, ulong param_2) {
   double *pdVar1;
   float fVar2;
   float fVar3;
   undefined8 uVar4;
      ...
      *plVar10 = 0x10000;
      ...
      do {
         ...
         do {
            ...
            if (( pTVar17[0x60] == (TetrahedronSet)0x3 ) && ( uVar23 = uVar23 == param_2 )) {
               pTVar18 = pTVar17;
 ...
 while ( ( uVar28 < 0x10000 ) && ( uVar11 < uVar26 ) );
         LAB_00100eb0:local_6d8 = local_6b8;
         local_6a0 = '\x01';
         local_6a8 = (void*)0x0;
         local_6b4 = 0;
         local_680 = '\x01';
 ...
 while ( (int)lVar20 < (int)local_6b4 );
      ...
      if (0 < (int)local_674) {
         ...
         do {
            ...
            piVar21 = (int*)( (long)local_688 + (long)*(int*)( (long)local_688 + (long)iVar5 * 0xc + 4 ) * 0xc + (long)iVar5 * 0xc );
            iVar6 = piVar21[2];
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* VHACD::VoxelSet::ComputeConvexHull(VHACD::Mesh&, unsigned long) const */void VHACD::VoxelSet::ComputeConvexHull(VoxelSet *this, Mesh *param_1, ulong param_2) {
   double *pdVar1;
   double *pdVar2;
   float fVar3;
   float fVar4;
      ...
      *plVar14 = 0x10000;
      ...
      do {
         ...
         do {
            ...
            if (( *(short*)( pVVar20 + 6 ) == 3 ) && ( uVar15 = uVar15 == param_2 )) {
               dVar5 = *(double*)( this + 0x9b0 );
               dVar36 = *(double*)( this + 0x998 );
               sVar7 = *(short*)pVVar20;
               pdVar1 = (double*)( plVar14 + 1 + uVar26 * 3 );
               dVar33 = ( (double)(int)*(short*)( pVVar20 + 4 ) + dVar10 ) * dVar5 + *(double*)( this + 0x9a8 );
               dVar38 = ( (double)(int)*(short*)( pVVar20 + 4 ) - dVar10 ) * dVar5 + *(double*)( this + 0x9a8 );
               dVar34 = ( (double)(int)*(short*)( pVVar20 + 2 ) + dVar10 ) * dVar5 + *(double*)( this + 0x9a0 );
               dVar37 = ( (double)(int)*(short*)( pVVar20 + 2 ) - dVar10 ) * dVar5 + *(double*)( this + 0x9a0 );
 ...
 while ( ( uVar26 < 0x10000 ) && ( uVar22 = uVar30 + 1 ),uVar30 = uVar22,uVar22 < uVar27 );
         LAB_00101910:local_6d0 = local_6b8;
         local_6a0 = '\x01';
         local_6a8 = (void*)0x0;
         local_6b4 = 0;
         local_680 = '\x01';
 ...
 while ( (int)lVar21 < (int)local_6b4 );
      ...
      if (0 < (int)local_674) {
         ...
         do {
            ...
            piVar23 = (int*)( (long)local_688 + (long)*(int*)( (long)local_688 + (long)iVar8 * 0xc + 4 ) * 0xc + (long)iVar8 * 0xc );
            iVar9 = piVar23[2];
...
/* VHACD::VoxelSet::Clip(VHACD::Plane const&, VHACD::PrimitiveSet*, VHACD::PrimitiveSet*) const */void VHACD::VoxelSet::Clip(VoxelSet *this, Plane *param_1, PrimitiveSet *param_2, PrimitiveSet *param_3) {
   undefined8 uVar1;
   double dVar2;
   undefined4 uVar3;
   ulong uVar4;
   ...
   if (uVar4 != 0) {
      for (int i = 0; i < 3; i++) {
         uVar1 = *(undefined8*)( this + ( 8*i + 2456 ) );
         *(undefined8*)( param_2 + ( 8*i + 2456 ) ) = uVar1;
         *(undefined8*)( param_3 + ( 8*i + 2456 ) ) = uVar1;
      }
      ...
      *(undefined8*)( param_3 + 0x990 ) = 0;
      ...
      while (true) {
         ...
         dVar14 = ( (double)(int)(short)uVar1 * dVar14 + *(double*)( this + 0x998 ) ) * *(double*)param_1 + ( (double)(int)(short)( (ulong)uVar1 >> 0x10 ) * dVar14 + *(double*)( this + 0x9a0 ) ) * *(double*)( param_1 + 8 ) + ( dVar14 * (double)(int)sVar5 + *(double*)( this + 0x9a8 ) ) * *(double*)( param_1 + 0x10 ) + *(double*)( param_1 + 0x18 );
         if (0.0 <= dVar14) {
...
/* VHACD::TetrahedronSet::SelectOnSurface(VHACD::PrimitiveSet*) const */void VHACD::TetrahedronSet::SelectOnSurface(TetrahedronSet *this, PrimitiveSet *param_1) {
   undefined8 uVar1;
   long lVar2;
   ulong uVar3;
   undefined8 uVar4;
...
/* VHACD::TetrahedronSet::Convert(VHACD::Mesh&, VHACD::VOXEL_VALUE) const */void VHACD::TetrahedronSet::Convert(TetrahedronSet *this, ulong *param_1, uint param_3) {
   undefined8 *puVar1;
   long lVar2;
   undefined8 uVar3;
   ulong uVar4;
...
;
      ...
      if (uVar13 == 0x40) {
         ...
         *puVar10 = uVar21;
         ...
         if (uVar7 == 0x40) {
            uVar13 = 0x80;
            LAB_00103786:lVar11 = uVar13 * 0x18;
            uVar6 = lVar11 + 8;
            goto LAB_00102f9c;
         }
         ...
         uVar6 = uVar6 + 2;
         LAB_0010304e:puVar10 = (ulong*)( lVar11 + (long)param_1 );
         param_1[0xc1] = uVar6;
         *puVar10 = uVar20;
         puVar10[1] = uVar21;
         ...
         if (uVar6 == 0x40) {
            uVar13 = 0x80;
            LAB_00103746:lVar11 = uVar13 * 0x18;
            uVar6 = lVar11 + 8;
            goto LAB_0010363c;
         }
         ...
         lVar11 = uVar6 * 0x18;
         LAB_00103080:puVar10 = (ulong*)( lVar11 + (long)param_1 );
         param_1[0xc1] = uVar7;
         *puVar10 = uVar20;
         puVar10[1] = uVar21;
         puVar10[2] = CONCAT44(uVar19, uVar18);
         if (uVar7 == 0x40) {
            uVar13 = 0x80;
            LAB_0010372e:lVar11 = uVar13 * 0x18;
            uVar6 = lVar11 + 8;
            goto LAB_00103574;
         }

         LAB_0010309c:puVar10 = param_1;
      }
 else {
         puVar10 = (ulong*)param_1[0xc0];
         param_1[0xc1] = uVar7;
         ...
         *puVar12 = uVar21;
         ...
         if (uVar13 == uVar7) {
            ...
            LAB_00102f9c:puVar12 = (ulong*)operator_new__(uVar6);
            puVar10 = puVar12 + 1;
            *puVar12 = uVar13;
            puVar12 = param_1;
            if (param_1[0xc2] != 0x40) {
         ...
         *puVar12 = uVar20;
         ...
         if (uVar6 == uVar13) {
            ...
            LAB_0010363c:puVar12 = (ulong*)operator_new__(uVar6);
            puVar10 = puVar12 + 1;
            *puVar12 = uVar13;
            puVar12 = param_1;
            if (param_1[0xc2] != 0x40) {
         ...
         *puVar12 = uVar20;
         ...
         if (uVar13 == uVar7) {
            ...
            LAB_00103574:puVar12 = (ulong*)operator_new__(uVar6);
            puVar10 = puVar12 + 1;
            *puVar12 = uVar13;
            puVar12 = param_1;
            if (param_1[0xc2] != 0x40) {
      ...
      *puVar10 = uVar6;
      ...
      if (uVar13 == 0x40) {
         ...
         *piVar8 = iVar5;
         ...
         if (uVar6 == 0x40) {
            uVar13 = 0x80;
            LAB_00103766:lVar11 = uVar13 * 0xc;
            uVar6 = lVar11 + 8;
            goto LAB_001034bc;
         }

         LAB_001031c8:uVar7 = uVar6 + 1;
         ...
         *(int*)( puVar1 + 1 ) = iVar22;
         if (uVar7 == 0x40) {
            uVar13 = 0x80;
            LAB_001031fb:lVar11 = uVar13 * 0xc;
            uVar6 = lVar11 + 8;
            goto LAB_00103207;
         }

         LAB_001032ac:puVar10 = param_1 + 0xc3;
         uVar6 = uVar7 + 1;
         ...
         *(int*)( puVar1 + 1 ) = iVar5;
         if (uVar6 == 0x40) {
            uVar13 = 0x80;
            LAB_001032df:lVar11 = uVar13 * 0xc;
            uVar6 = lVar11 + 8;
            goto LAB_001032eb;
         }
         ...
         *piVar8 = iVar5;
         ...
         if (uVar13 == uVar6) {
            ...
            LAB_001034bc:puVar10 = (ulong*)operator_new__(uVar6);
         ...
         *(int*)( puVar1 + 1 ) = iVar22;
         if (uVar7 == uVar13) {
            ...
            lVar11 = -9;
            uVar6 = 0xffffffffffffffff;
            LAB_00103207:puVar9 = (ulong*)operator_new__(uVar6);
            puVar12 = param_1 + 0xc3;
            puVar10 = puVar9 + 1;
            *puVar9 = uVar13;
            if (param_1[0x125] != 0x40) {
         ...
         *(int*)( puVar1 + 1 ) = iVar5;
         if (uVar6 == uVar13) {
            ...
            LAB_001032eb:puVar10 = (ulong*)operator_new__(uVar6);
            puVar12 = param_1 + 0xc3;
            *puVar10 = uVar13;
            puVar10 = puVar10 + 1;
            if (param_1[0x125] != 0x40) {
...
/* VHACD::PlaneBoxOverlap(VHACD::Vec3<double> const&, VHACD::Vec3<double> const&,
   VHACD::Vec3<double> const&) */bool VHACD::PlaneBoxOverlap(Vec3 *param_1, Vec3 *param_2, Vec3 *param_3) {
   bool bVar1;
   long lVar2;
   long in_FS_OFFSET;
   double dVar3;
 ...
 while ( lVar2 != 0x18 );
   bVar1 = false;
   if (local_48[0] * *(double*)param_1 + local_48[1] * *(double*)( param_1 + 8 ) + local_48[2] * *(double*)( param_1 + 0x10 ) <= 0.0) {
      bVar1 = 0.0 <= *(double*)param_1 * local_28[0] + *(double*)( param_1 + 8 ) * local_28[1] + *(double*)( param_1 + 0x10 ) * local_28[2];
   }
...
/* VHACD::TriBoxOverlap(VHACD::Vec3<double> const&, VHACD::Vec3<double> const&, VHACD::Vec3<double>
   const&, VHACD::Vec3<double> const&, VHACD::Vec3<double> const&) */bool VHACD::TriBoxOverlap(Vec3 *param_1, Vec3 *param_2, Vec3 *param_3, Vec3 *param_4, Vec3 *param_5) {
   double dVar1;
   int iVar2;
   long in_FS_OFFSET;
   bool bVar3;
            ...
            if (( dVar23 <= dVar12 ) && ( (double)( (ulong)dVar12 ^ _LC7 ) <= dVar6 )) {
               ...
               if (( dVar6 <= dVar12 ) && ( (double)( (ulong)dVar12 ^ _LC7 ) <= dVar23 )) {
                  ...
                  if (( dVar23 <= dVar12 ) && ( (double)( (ulong)dVar12 ^ _LC7 ) <= dVar6 )) {
                     ...
                     bVar3 = false;
                     dVar9 = dVar8 * (double)( (ulong)dVar13 & _LC3 ) + (double)( (ulong)dVar12 & _LC3 ) * dVar1;
                     if (( dVar6 <= dVar9 ) && ( (double)( (ulong)dVar9 ^ _LC7 ) <= dVar23 )) {
                        ...
                        bVar3 = false;
                        dVar9 = (double)( (ulong)dVar13 & _LC3 ) * dVar4 + dVar1 * (double)( _LC3 & (ulong)dVar22 );
                        if (( dVar6 <= dVar9 ) && ( (double)( (ulong)dVar9 ^ _LC7 ) <= dVar23 )) {
                           ...
                           bVar3 = false;
                           dVar12 = dVar8 * (double)( _LC3 & (ulong)dVar22 ) + (double)( (ulong)dVar12 & _LC3 ) * dVar4;
                           if (( dVar6 <= dVar12 ) && ( (double)( (ulong)dVar12 ^ _LC7 ) <= dVar23 )) {
                              local_98 = local_48;
                              local_80 = dVar10;
                              if (( local_48 <= dVar10 ) && ( local_98 = dVar10 ),local_80 = local_48,dVar10 <= local_48) {
                                 local_98 = local_48;
                              }
                              ...
                              if (( dVar6 <= dVar4 ) && ( (double)( (ulong)dVar4 ^ _LC7 ) <= dVar5 )) {
                                 local_a0 = dVar16;
                                 local_78 = dStack_40;
                                 if (( dStack_40 <= dVar16 ) && ( local_a0 = dStack_40 ),local_78 = dVar16,dVar16 <= dStack_40) {
                                    local_78 = dStack_40;
                                 }
                                 ...
                                 if (( dVar5 <= dVar8 ) && ( (double)( (ulong)dVar8 ^ _LC7 ) <= dVar7 )) {
                                    dVar5 = dVar18;
                                    local_60 = local_38;
                                    if (( local_38 <= dVar18 ) && ( dVar5 = local_38 ),local_60 = dVar18,dVar18 <= local_38) {
                                       local_60 = local_38;
                                    }
   ...
   LAB_00104060:if (local_10 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* VHACD::Diagonalize(double const (&) [3][3], double (&) [3][3], double (&) [3][3]) */void VHACD::Diagonalize(double *param_1, double *param_2, double *param_3) {
   int iVar1;
   ulong uVar2;
   int iVar3;
   long lVar4;
   ...
   do {
      ...
      *param_3 = dVar17 * dVar29 + dVar24 * dVar28 + dVar8 * dVar13;
      ...
      if (( dVar7 <= dVar11 ) || ( dVar7 <= dVar6 )) {
         ...
         dVar9 = (double)( ~-(ulong)(dVar6 < dVar11) & (ulong)dVar8 | (ulong)dVar12 & -(ulong)(dVar6 < dVar11) );
      }
 else {
         uVar2 = 2;
         iVar1 = 1;
      ...
      *(ulong*)( local_48 + lVar4 * 8 ) = (ulong)dVar11 ^ _LC7;
      ...
      dVar10 = ( (double)local_48._0_8_ * dVar5 + dVar10 * dVar9 + local_38 * dVar20 ) - (double)local_48._8_8_ * dVar14;
      dVar20 = dVar20 * dVar9 + ( (double)local_48._8_8_ * dVar5 - local_38 * dVar10 ) + (double)local_48._0_8_ * dVar14;
      dVar14 = ( ( local_38 * dVar5 + (double)local_48._8_8_ * dVar10 ) - (double)local_48._0_8_ * dVar20 ) + dVar14 * dVar9;
      dVar5 = ( ( dVar9 * dVar5 - (double)local_48._0_8_ * dVar10 ) - (double)local_48._8_8_ * dVar20 ) - local_38 * dVar14;
...
/* VHACD::VoxelSet::ComputePrincipalAxes() */void VHACD::VoxelSet::ComputePrincipalAxes(VoxelSet *this) {
   ulong uVar1;
   VoxelSet *pVVar2;
   VoxelSet *pVVar3;
   VoxelSet *pVVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* VHACD::TetrahedronSet::ComputePrincipalAxes() */void VHACD::TetrahedronSet::ComputePrincipalAxes(TetrahedronSet *this) {
   ...
   if (*(ulong*)( this + 0xd30 ) != 0) {
      ...
      do {
         ...
         do {
            ...
            dVar8 = auVar10._8_8_;
            auVar10._0_8_ = auVar10._0_8_ + ( *(double*)( pTVar4 + 8 ) - *(double*)( this + 0x9d8 ) ) * ( *(double*)( pTVar4 + 8 ) - *(double*)( this + 0x9d8 ) );
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* VHACD::VoxelSet::VoxelSet() */void VHACD::VoxelSet::VoxelSet(VoxelSet *this) {
   undefined8 uVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   undefined8 uVar4;
...
/* VHACD::VoxelSet::GetPoints(VHACD::Voxel const&, VHACD::Vec3<double>*) const */void VHACD::VoxelSet::GetPoints(VoxelSet *this, Voxel *param_1, Vec3 *param_2) {
   short sVar1;
   short sVar2;
   double dVar3;
   double dVar4;
   ...
   *(double*)( param_2 + 0xb0 ) = dVar3 * *(double*)( this + 0x9b0 ) + *(double*)( this + 0x9a0 );
   ...
   for (int i = 0; i < 3; i++) {
      *(double*)( param_2 + ( 24*i + 16 ) ) = *(double*)( this + 2480 ) * dVar5 + *(double*)( this + 2472 );
   }

   *(double*)( param_2 + 0x58 ) = dVar5 * *(double*)( this + 0x9b0 ) + *(double*)( this + 0x9a8 );
   for (int i = 0; i < 3; i++) {
      *(double*)( param_2 + ( 24*i + 112 ) ) = *(double*)( this + 2480 ) * dVar3 + *(double*)( this + 2472 );
   }
...
/* VHACD::VoxelSet::Intersect(VHACD::Plane const&, VHACD::SArray<VHACD::Vec3<double>, 64ul>*,
   VHACD::SArray<VHACD::Vec3<double>, 64ul>*, unsigned long) const */void VHACD::VoxelSet::Intersect(VoxelSet *this, Plane *param_1, SArray *param_2, SArray *param_3, ulong param_4) {
   long lVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   ulong *puVar4;
   ...
   if (lVar1 != 0) {
      ...
      while (true) {
         ...
         dVar16 = ( (double)(int)(short)local_110 * dVar16 + *(double*)( this + 0x998 ) ) * *(double*)param_1 + ( (double)( (int)local_110 >> 0x10 ) * dVar16 + *(double*)( this + 0x9a0 ) ) * *(double*)( param_1 + 8 ) + ( dVar16 * (double)(int)(short)( (ulong)local_110 >> 0x20 ) + *(double*)( this + 0x9a8 ) ) * *(double*)( param_1 + 0x10 ) + *(double*)( param_1 + 0x18 );
         if (0.0 <= dVar16) {
            if (dVar16 <= dVar17) {
...
/* VHACD::VoxelSet::ComputeExteriorPoints(VHACD::Plane const&, VHACD::Mesh const&,
   VHACD::SArray<VHACD::Vec3<double>, 64ul>*) const */void VHACD::VoxelSet::ComputeExteriorPoints(VoxelSet *this, Plane *param_1, Mesh *param_2, SArray *param_3) {
   long lVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   char cVar4;
   ...
   if (lVar1 != 0) {
      ...
      do {
         ...
         local_118 = (double)(int)(short)( (ulong)local_130 >> 0x20 ) * *(double*)( this + 0x9b0 ) + *(double*)( this + 0x9a8 );
         local_128 = (double)(int)(short)local_130 * *(double*)( this + 0x9b0 ) + *(double*)( this + 0x998 );
         dStack_120 = (double)( (int)local_130 >> 0x10 ) * *(double*)( this + 0x9b0 ) + *(double*)( this + 0x9a0 );
         if (( 0.0 <= dStack_120 * *(double*)( param_1 + 8 ) + *(double*)param_1 * local_128 + local_118 * *(double*)( param_1 + 0x10 ) + *(double*)( param_1 + 0x18 ) ) && ( cVar4 = VHACD::Mesh::IsInside((Vec3*)param_2) ),cVar4 == '\0') {
...
/* VHACD::VoxelSet::Convert(VHACD::Mesh&, VHACD::VOXEL_VALUE) const */void VHACD::VoxelSet::Convert(VoxelSet *this, long param_1, int param_3) {
   int iVar1;
   undefined8 *puVar2;
   long lVar3;
   undefined8 uVar4;
 ...
 while ( pVVar18 != local_48 );
            ...
            if (uVar20 == 0x40) {
               ...
               *piVar9 = iVar13;
               ...
               if (uVar16 == 0x40) {
                  uVar20 = 0x80;
                  LAB_0010677f:lVar10 = uVar20 * 0xc;
                  uVar16 = lVar10 + 8;
                  goto LAB_00106204;
               }

               LAB_001062aa:piVar9 = (int*)( param_1 + 0x618 + uVar16 * 0xc );
               lVar10 = uVar16 + 1;
               ...
               *piVar9 = iVar13;
               ...
               if (lVar10 == 0x40) {
                  uVar20 = 0x80;
                  LAB_00106f49:lVar10 = uVar20 * 0xc;
                  uVar16 = lVar10 + 8;
                  goto LAB_0010611d;
               }
               ...
               uVar16 = uVar16 + 2;
               lVar10 = lVar10 * 0xc;
               LAB_00106309:local_138 = iVar13 + 4;
               ...
               *piVar9 = local_138;
               piVar9[1] = iVar13 + 5;
               if (uVar16 == 0x40) {
                  LAB_00106336:lVar10 = uVar20 * 0xc;
                  uVar16 = lVar10 + 8;
                  LAB_00106342:puVar12 = (ulong*)operator_new__(uVar16);
                  lVar15 = param_1 + 0x618;
                  puVar8 = puVar12 + 1;
                  *puVar12 = uVar20;
                  if (*(long*)( param_1 + 0x928 ) != 0x40) {
               ...
               *piVar9 = local_138;
               ...
               if (uVar11 == 0x40) {
                  uVar20 = 0x80;
                  LAB_00106e58:lVar10 = uVar20 * 0xc;
                  uVar16 = lVar10 + 8;
                  goto LAB_00106d84;
               }

               LAB_00106437:uVar16 = uVar11 + 1;
               ...
               *piVar9 = iVar13 + 7;
               ...
               if (uVar16 == 0x40) {
                  uVar20 = 0x80;
                  LAB_00106e6f:lVar10 = uVar20 * 0xc;
                  uVar16 = lVar10 + 8;
                  goto LAB_00106c8c;
               }

               LAB_00106466:uVar11 = uVar16 + 1;
               piVar9 = (int*)( param_1 + 0x618 + uVar16 * 0xc );
               *(ulong*)( param_1 + 0x920 ) = uVar11;
               uVar20 = 0x80;
               *piVar9 = iVar13 + 7;
               ...
               piVar9[2] = iVar14;
               if (uVar11 == 0x40) {
                  LAB_0010649e:lVar10 = uVar20 * 0xc;
                  uVar16 = lVar10 + 8;
                  goto LAB_001064aa;
               }

               LAB_00106570:local_138 = iVar13 + 4;
               uVar16 = uVar11 + 1;
               piVar9 = (int*)( param_1 + 0x618 + uVar11 * 0xc );
               *(ulong*)( param_1 + 0x920 ) = uVar16;
               *piVar9 = local_138;
               ...
               if (uVar16 == 0x40) {
                  uVar20 = 0x80;
                  LAB_00106eaf:lVar10 = uVar20 * 0xc;
                  uVar16 = lVar10 + 8;
                  goto LAB_00106b94;
               }

               LAB_001065a2:local_138 = iVar13 + 4;
               uVar11 = uVar16 + 1;
               piVar9 = (int*)( param_1 + 0x618 + uVar16 * 0xc );
               *(ulong*)( param_1 + 0x920 ) = uVar11;
               *piVar9 = local_138;
               ...
               if (uVar11 == 0x40) {
                  uVar20 = 0x80;
                  LAB_00106eef:lVar10 = uVar20 * 0xc;
                  uVar16 = lVar10 + 8;
                  goto LAB_00106a9c;
               }

               LAB_001065d4:uVar16 = uVar11 + 1;
               piVar9 = (int*)( param_1 + 0x618 + uVar11 * 0xc );
               *(ulong*)( param_1 + 0x920 ) = uVar16;
               *piVar9 = iVar13 + 6;
               piVar9[1] = iVar13 + 5;
               ...
               if (uVar16 == 0x40) {
                  uVar20 = 0x80;
                  LAB_00106f06:lVar10 = uVar20 * 0xc;
                  uVar16 = lVar10 + 8;
                  goto LAB_001069a4;
               }

               LAB_00106603:local_138 = iVar13 + 4;
               ...
               *piVar9 = iVar13 + 6;
               ...
               if (lVar10 == 0x40) {
                  uVar20 = 0x80;
                  LAB_00106f1d:lVar10 = uVar20 * 0xc;
                  uVar16 = lVar10 + 8;
                  goto LAB_00106885;
               }
               ...
               *piVar9 = iVar13;
               ...
               if (uVar20 == uVar16) {
                  ...
                  LAB_00106204:puVar8 = (ulong*)operator_new__(uVar16);
                  lVar15 = param_1 + 0x618;
                  *puVar8 = uVar20;
                  puVar8 = puVar8 + 1;
                  if (*(long*)( param_1 + 0x928 ) != 0x40) {
               ...
               *piVar9 = iVar13;
               ...
               if (uVar11 == uVar20) {
                  ...
                  LAB_0010611d:puVar8 = (ulong*)operator_new__(uVar16);
                  lVar15 = param_1 + 0x618;
                  *puVar8 = uVar20;
                  if (*(long*)( param_1 + 0x928 ) != 0x40) {
                     lVar15 = *(long*)( param_1 + 0x918 );
               ...
               *piVar9 = local_138;
               ...
               LAB_00105f13:local_138 = iVar13 + 4;
               uVar11 = uVar16 + 1;
               piVar9 = (int*)( (long)puVar8 + uVar16 * 0xc );
               *(ulong*)( param_1 + 0x920 ) = uVar11;
               *piVar9 = local_138;
               ...
               if (uVar11 == uVar20) {
                  ...
                  LAB_00106d84:puVar8 = (ulong*)operator_new__(uVar16);
                  lVar15 = param_1 + 0x618;
                  *puVar8 = uVar20;
                  puVar8 = puVar8 + 1;
                  if (*(long*)( param_1 + 0x928 ) != 0x40) {
               ...
               *piVar9 = iVar13 + 7;
               ...
               if (uVar16 == uVar20) {
                  ...
                  LAB_00106c8c:puVar8 = (ulong*)operator_new__(uVar16);
                  lVar15 = param_1 + 0x618;
                  *puVar8 = uVar20;
                  puVar8 = puVar8 + 1;
                  if (*(long*)( param_1 + 0x928 ) != 0x40) {
               ...
               *piVar9 = iVar13 + 7;
               ...
               if (uVar11 == uVar20) {
                  ...
                  lVar10 = -9;
                  uVar16 = 0xffffffffffffffff;
                  LAB_001064aa:puVar12 = (ulong*)operator_new__(uVar16);
                  lVar15 = param_1 + 0x618;
                  puVar8 = puVar12 + 1;
                  *puVar12 = uVar20;
                  if (*(long*)( param_1 + 0x928 ) != 0x40) {
               ...
               *piVar9 = local_138;
               ...
               if (uVar16 == uVar20) {
                  ...
                  LAB_00106b94:puVar8 = (ulong*)operator_new__(uVar16);
                  lVar15 = param_1 + 0x618;
                  *puVar8 = uVar20;
                  puVar8 = puVar8 + 1;
                  if (*(long*)( param_1 + 0x928 ) != 0x40) {
               ...
               *piVar9 = local_138;
               ...
               if (uVar11 == uVar20) {
                  ...
                  LAB_00106a9c:puVar8 = (ulong*)operator_new__(uVar16);
                  lVar15 = param_1 + 0x618;
                  *puVar8 = uVar20;
                  puVar8 = puVar8 + 1;
                  if (*(long*)( param_1 + 0x928 ) != 0x40) {
               ...
               *piVar9 = iVar13 + 6;
               ...
               if (uVar16 == uVar20) {
                  ...
                  LAB_001069a4:puVar8 = (ulong*)operator_new__(uVar16);
                  lVar15 = param_1 + 0x618;
                  *puVar8 = uVar20;
                  puVar8 = puVar8 + 1;
                  if (*(long*)( param_1 + 0x928 ) != 0x40) {
               ...
               *piVar9 = iVar13 + 6;
               ...
               if (uVar11 == uVar20) {
                  ...
                  LAB_00106885:local_138 = iVar13 + 4;
                  puVar8 = (ulong*)operator_new__(uVar16);
                  lVar15 = param_1 + 0x618;
                  *puVar8 = uVar20;
                  puVar8 = puVar8 + 1;
                  ...
                  *piVar9 = iVar13 + 7;
                  ...
                  uVar20 = 0x80;
                  LAB_0010696d:lVar10 = uVar20 * 0xc;
                  uVar16 = lVar10 + 8;
               }
 else {
                  uVar20 = *(ulong*)( param_1 + 0x928 );
                  LAB_00106096:local_138 = iVar13 + 4;
                  uVar16 = uVar11 + 1;
                  piVar9 = (int*)( (long)puVar8 + uVar11 * 0xc );
                  *(ulong*)( param_1 + 0x920 ) = uVar16;
                  *piVar9 = iVar13 + 7;
            ...
            LAB_001060c7:piVar9 = (int*)( (long)puVar8 + uVar16 * 0xc );
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* VHACD::Volume::Volume() */void VHACD::Volume::Volume(Volume *this) {
   undefined8 uVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   uVar3 = _LC10;
...
/* VHACD::Volume::~Volume() */void VHACD::Volume::~Volume(Volume *this) {
...
/* VHACD::Volume::Allocate() */void VHACD::Volume::Allocate(Volume *this) {
   void *pvVar1;
   ulong uVar2;
   if (*(void**)( this + 0x68 ) != (void*)0x0) {
      operator_delete__(*(void**)( this + 0x68 ));
...
/* VHACD::Volume::Free() */void VHACD::Volume::Free(Volume *this) {
   if (*(void**)( this + 0x68 ) != (void*)0x0) {
      operator_delete__(*(void**)( this + 0x68 ));
   }
...
/* VHACD::Volume::FillInsideSurface() */void VHACD::Volume::FillInsideSurface(Volume *this) {
   long lVar1;
   long lVar2;
   long lVar3;
   char *pcVar4;
 ...
 while ( lVar1 != lVar7 );
         ...
         do {
            lVar5 = 0;
            do {
               pcVar4 = (char*)( ( *(long*)( this + 0x40 ) * lVar5 + lVar6 ) * *(long*)( this + 0x38 ) + lVar7 + *(long*)( this + 0x68 ) );
               if (*pcVar4 == '\0') {
                  *pcVar4 = '\x02';
...
/* VHACD::Volume::Convert(VHACD::Mesh&, VHACD::VOXEL_VALUE) const */void VHACD::Volume::Convert(Volume *this, long param_1, uint param_3) {
   int iVar1;
   int iVar2;
   ulong *puVar3;
   double *pdVar4;
 ...
 while ( uVar7 != uVar22 );
            ...
            do {
               uVar17 = 0;
               do {
                  while (*(byte*)( uVar22 + *(long*)( this + 0x68 ) + ( *(long*)( this + 0x40 ) * uVar17 + uVar21 ) * *(long*)( this + 0x38 ) ) != param_3) {
                     uVar17 = uVar17 + 1;
                  ...
                  *pdVar4 = dVar9 + dVar25;
                  ...
                  if (uVar23 == 0x40) {
                     ...
                     *piVar15 = iVar11;
                     ...
                     if (uVar19 == 0x40) {
                        uVar23 = 0x80;
                        LAB_00108c96:lVar16 = uVar23 * 0xc;
                        uVar19 = lVar16 + 8;
                        goto LAB_0010867c;
                     }

                     LAB_0010806b:lVar16 = uVar19 + 1;
                     ...
                     *piVar15 = iVar11;
                     ...
                     if (lVar16 == 0x40) {
                        uVar23 = 0x80;
                        LAB_00108c76:lVar16 = uVar23 * 0xc;
                        uVar19 = lVar16 + 8;
                        goto LAB_001085b4;
                     }
                     ...
                     uVar19 = uVar19 + 2;
                     lVar16 = lVar16 * 0xc;
                     LAB_001080cc:*(ulong*)( param_1 + 0x920 ) = uVar19;
                     ...
                     *piVar15 = iVar11 + 4;
                     ...
                     if (uVar19 == 0x40) {
                        uVar23 = 0x80;
                        LAB_001080fe:lVar16 = uVar23 * 0xc;
                        uVar19 = lVar16 + 8;
                        LAB_0010810a:puVar13 = (ulong*)operator_new__(uVar19);
                        puVar14 = puVar13 + 1;
                        *puVar13 = uVar23;
                        puVar13 = puVar3;
                        if (*(long*)( param_1 + 0x928 ) != 0x40) {
                     ...
                     *piVar15 = iVar11 + 4;
                     ...
                     if (uVar20 == 0x40) {
                        uVar23 = 0x80;
                        LAB_00108c56:lVar16 = uVar23 * 0xc;
                        uVar19 = lVar16 + 8;
                        goto LAB_00108b9c;
                     }

                     LAB_001081e6:uVar19 = uVar20 + 1;
                     *(ulong*)( param_1 + 0x920 ) = uVar19;
                     ...
                     *piVar15 = iVar11 + 7;
                     ...
                     if (uVar19 == 0x40) {
                        uVar23 = 0x80;
                        LAB_00108d16:lVar16 = uVar23 * 0xc;
                        uVar19 = lVar16 + 8;
                        goto LAB_00108ac4;
                     }

                     LAB_00108217:uVar20 = uVar19 + 1;
                     *(ulong*)( param_1 + 0x920 ) = uVar20;
                     piVar15 = (int*)( (long)puVar3 + uVar19 * 0xc );
                     *piVar15 = iVar11 + 7;
                     piVar15[1] = iVar2;
                     ...
                     if (uVar20 == 0x40) {
                        uVar23 = 0x80;
                        LAB_00108251:lVar16 = uVar23 * 0xc;
                        uVar19 = lVar16 + 8;
                        goto LAB_0010825d;
                     }

                     LAB_00108305:uVar19 = uVar20 + 1;
                     *(ulong*)( param_1 + 0x920 ) = uVar19;
                     piVar15 = (int*)( (long)puVar3 + uVar20 * 0xc );
                     *piVar15 = iVar11 + 4;
                     piVar15[1] = iVar1;
                     ...
                     if (uVar19 == 0x40) {
                        uVar23 = 0x80;
                        LAB_00108d36:lVar16 = uVar23 * 0xc;
                        uVar19 = lVar16 + 8;
                        goto LAB_001089ec;
                     }

                     LAB_0010833c:uVar20 = uVar19 + 1;
                     *(ulong*)( param_1 + 0x920 ) = uVar20;
                     piVar15 = (int*)( (long)puVar3 + uVar19 * 0xc );
                     *piVar15 = iVar11 + 4;
                     piVar15[1] = iVar11;
                     ...
                     if (uVar20 == 0x40) {
                        uVar23 = 0x80;
                        LAB_00108d9e:lVar16 = uVar23 * 0xc;
                        uVar19 = lVar16 + 8;
                        goto LAB_00108914;
                     }

                     LAB_00108373:uVar19 = uVar20 + 1;
                     *(ulong*)( param_1 + 0x920 ) = uVar19;
                     piVar15 = (int*)( (long)puVar3 + uVar20 * 0xc );
                     *piVar15 = iVar11 + 6;
                     piVar15[1] = iVar11 + 5;
                     ...
                     if (uVar19 == 0x40) {
                        uVar23 = 0x80;
                        LAB_00108de6:lVar16 = uVar23 * 0xc;
                        uVar19 = lVar16 + 8;
                        goto LAB_00108844;
                     }

                     LAB_001083a7:lVar16 = uVar19 + 1;
                     *(long*)( param_1 + 0x920 ) = lVar16;
                     piVar15 = (int*)( (long)puVar3 + uVar19 * 0xc );
                     *piVar15 = iVar11 + 6;
                     piVar15[1] = iVar1;
                     ...
                     if (lVar16 == 0x40) {
                        uVar23 = 0x80;
                        LAB_00108e06:lVar16 = uVar23 * 0xc;
                        uVar19 = lVar16 + 8;
                        goto LAB_00108745;
                     }
                     ...
                     *piVar15 = iVar11;
                     ...
                     if (uVar23 == uVar19) {
                        ...
                        LAB_0010867c:puVar13 = (ulong*)operator_new__(uVar19);
                        puVar14 = puVar13 + 1;
                        *puVar13 = uVar23;
                        puVar13 = puVar3;
                        if (*(long*)( param_1 + 0x928 ) != 0x40) {
                     ...
                     *piVar15 = iVar11;
                     ...
                     if (uVar20 == uVar23) {
                        ...
                        LAB_001085b4:puVar13 = (ulong*)operator_new__(uVar19);
                        *puVar13 = uVar23;
                        puVar14 = puVar3;
                        if (*(long*)( param_1 + 0x928 ) != 0x40) {
                           puVar14 = *(ulong**)( param_1 + 0x918 );
                     ...
                     *piVar15 = iVar11 + 4;
                     ...
                     if (uVar20 == uVar23) {
                        ...
                        LAB_00108b9c:puVar14 = (ulong*)operator_new__(uVar19);
                        *puVar14 = uVar23;
                        puVar14 = puVar14 + 1;
                        puVar13 = puVar3;
                        if (*(long*)( param_1 + 0x928 ) != 0x40) {
                     ...
                     *piVar15 = iVar11 + 7;
                     ...
                     if (uVar19 == uVar23) {
                        ...
                        LAB_00108ac4:puVar14 = (ulong*)operator_new__(uVar19);
                        *puVar14 = uVar23;
                        puVar14 = puVar14 + 1;
                        puVar13 = puVar3;
                        if (*(long*)( param_1 + 0x928 ) != 0x40) {
                     ...
                     *piVar15 = iVar11 + 7;
                     ...
                     if (uVar20 == uVar23) {
                        ...
                        lVar16 = -9;
                        uVar19 = 0xffffffffffffffff;
                        LAB_0010825d:puVar13 = (ulong*)operator_new__(uVar19);
                        puVar14 = puVar13 + 1;
                        *puVar13 = uVar23;
                        puVar13 = puVar3;
                        if (*(long*)( param_1 + 0x928 ) != 0x40) {
                     ...
                     *piVar15 = iVar11 + 4;
                     ...
                     if (uVar19 == uVar23) {
                        ...
                        LAB_001089ec:puVar14 = (ulong*)operator_new__(uVar19);
                        *puVar14 = uVar23;
                        puVar14 = puVar14 + 1;
                        puVar13 = puVar3;
                        if (*(long*)( param_1 + 0x928 ) != 0x40) {
                     ...
                     *piVar15 = iVar11 + 4;
                     ...
                     if (uVar20 == uVar23) {
                        ...
                        LAB_00108914:puVar14 = (ulong*)operator_new__(uVar19);
                        *puVar14 = uVar23;
                        puVar14 = puVar14 + 1;
                        puVar13 = puVar3;
                        if (*(long*)( param_1 + 0x928 ) != 0x40) {
                     ...
                     *piVar15 = iVar11 + 6;
                     ...
                     if (uVar19 == uVar23) {
                        ...
                        LAB_00108844:puVar14 = (ulong*)operator_new__(uVar19);
                        *puVar14 = uVar23;
                        puVar14 = puVar14 + 1;
                        puVar13 = puVar3;
                        if (*(long*)( param_1 + 0x928 ) != 0x40) {
                     ...
                     *piVar15 = iVar11 + 6;
                     ...
                     if (uVar20 == uVar23) {
                        ...
                        LAB_00108745:puVar14 = (ulong*)operator_new__(uVar19);
                        *puVar14 = uVar23;
                        puVar14 = puVar14 + 1;
                        puVar13 = puVar3;
                        if (*(long*)( param_1 + 0x928 ) != 0x40) {
                        ...
                        *piVar15 = iVar11 + 7;
                        ...
                        uVar23 = 0x80;
                        LAB_00108807:lVar16 = uVar23 * 0xc;
                        uVar19 = lVar16 + 8;
                        LAB_00108504:puVar14 = (ulong*)operator_new__(uVar19);
                        *puVar14 = uVar23;
                        puVar14 = puVar14 + 1;
                        puVar13 = puVar3;
                        if (*(long*)( param_1 + 0x928 ) != 0x40) {
...
/* VHACD::Volume::Convert(VHACD::VoxelSet&) const */void VHACD::Volume::Convert(Volume *this, VoxelSet *param_1) {
   double dVar1;
   char cVar2;
   short sVar3;
   short sVar4;
   ...
   *(double*)( param_1 + 0xa10 ) = dVar1 * dVar1 * dVar1;
   ...
   LAB_00108fd8:local_3e = (short)lVar14;
   if (0 < sVar3) {
      do {
         lVar12 = 0;
         do {
   ...
   LAB_00109010:do {
      ...
      do {
         while (true) {
            ...
            cVar2 = *(char*)( *(long*)( this + 0x68 ) + lVar14 + ( *(long*)( this + 0x40 ) * lVar10 + lVar12 ) * *(long*)( this + 0x38 ) );
            if (cVar2 != '\x02') break;
...
;
 ...
 while ( (short)lVar10 < sVar4 );
      LAB_001090cd:lVar12 = lVar12 + 1;
      local_40 = (short)lVar12;
   }
 while ( local_40 < sVar3 );
   LAB_00109306:lVar14 = lVar14 + 1;
...
/* VHACD::Volume::Convert(VHACD::TetrahedronSet&) const */void VHACD::Volume::Convert(Volume *this, TetrahedronSet *param_1) {
   ...
   *(undefined1(*) [16])( param_1 + 0x988 ) = (undefined1[16])0x0;
   if ((short)uVar9 < 1) {
      LAB_00109993:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Subroutine does not return */
         __stack_chk_fail();
      }
   ...
   LAB_00109478:uVar9 = local_108 & 0xffff;
 ...
 while ( (short)uVar9 < (short)uVar16 );
   ...
   LAB_001094b0:do {
      ...
      do {
         while (true) {
            pTVar15 = (TetrahedronSet*)( ( *(long*)( this + 0x40 ) * lVar20 + lVar19 ) * *(long*)( this + 0x38 ) + local_108 + *(long*)( this + 0x68 ) );
            TVar1 = *pTVar15;
            if (( byte )((char)TVar1 - 2U) < 2) break;
            LAB_001094c0:lVar20 = lVar20 + 1;
...
;
 ...
 while ( (short)lVar20 < sVar2 );
      LAB_00109958:lVar19 = lVar19 + 1;
      local_fa = (short)lVar19;
   }
 while ( local_fa < sVar3 );
   uVar16 = uVar16 & 0xffff;
   LAB_0010997f:local_108 = local_108 + 1;
   if ((short)uVar16 <= (short)local_108) goto LAB_00109993;
   goto LAB_00109478;
}
/* VHACD::Volume::AlignToPrincipalAxes(double (&) [3][3]) const */void VHACD::Volume::AlignToPrincipalAxes(Volume *this, double *param_1) {
   short sVar1;
   long lVar2;
   short sVar3;
   bool bVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* VHACD::TetrahedronSet::TetrahedronSet() */void VHACD::TetrahedronSet::TetrahedronSet(TetrahedronSet *this) {
   undefined8 uVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   *(undefined**)this = &DAT_0010d808;
   ...
   *(undefined8*)( this + 0x9a0 ) = 0;
   for (int i = 0; i < 3; i++) {
      *(undefined8*)( this + ( 8*i + 2488 ) ) = uVar3;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* VHACD::TetrahedronSet::AddClippedTetrahedra(VHACD::Vec3<double> const (&) [10], int) */void VHACD::TetrahedronSet::AddClippedTetrahedra(Vec3<double> *param_1, int param_2) {
   double *pdVar1;
      ...
      if (in_EDX == 5) {
         ...
         do {
            while (true) {
               ...
               dVar30 = *pdVar1;
               dVar32 = pdVar1[2];
               dVar27 = ( dVar30 - dVar26 ) * ( ( dVar24 - dVar4 ) * ( dVar25 - dVar5 ) - ( dVar31 - dVar4 ) * ( dVar7 - dVar5 ) ) + ( ( dVar33 - dVar26 ) * ( dVar31 - dVar4 ) - ( dVar29 - dVar26 ) * ( dVar24 - dVar4 ) ) * ( dVar28 - dVar5 ) + ( ( dVar29 - dVar26 ) * ( dVar7 - dVar5 ) - ( dVar25 - dVar5 ) * ( dVar33 - dVar26 ) ) * ( dVar32 - dVar4 );
 ...
 while ( iVar16 != 5 );
         ...
         *(long*)( param_1 + 0x988 ) = *(long*)( param_1 + 0x988 ) + 1;
         ...
         do {
            ...
            dVar31 = dVar29 - dVar5;
            dVar31 = ( *(double*)( (long)*pauVar2 + 8 ) - dVar4 ) * ( dVar30 * dVar28 - dVar31 * dVar25 ) + ( dVar25 * ( local_228[lVar15 * 3 + 1] - dVar4 ) - dVar30 * ( local_228[lVar23 * 3 + 1] - dVar4 ) ) * ( *(double*)*pauVar2 - dVar5 ) + ( dVar31 * ( local_228[lVar23 * 3 + 1] - dVar4 ) - ( local_228[lVar15 * 3 + 1] - dVar4 ) * dVar28 ) * ( (double)puVar22[lVar21 * 3 + 2] - dVar33 );
            if (local_4f8 < dVar31) {
 ...
 while ( iVar19 != 4 );
         ...
         do {
            while (true) {
               ...
               dVar28 = pdVar3[2];
               dVar30 = *pdVar3;
               dVar24 = ( dVar4 - (double)auVar6 ) * ( ( dVar29 - dVar5 ) * ( dVar33 - dVar26 ) - ( dVar32 - dVar5 ) * ( dVar25 - dVar26 ) ) + ( ( dVar32 - dVar5 ) * ( dVar31 - (double)auVar6 ) - ( dVar7 - (double)auVar6 ) * ( dVar29 - dVar5 ) ) * ( dVar30 - dVar26 ) + ( dVar28 - dVar5 ) * ( ( dVar7 - (double)auVar6 ) * ( dVar25 - dVar26 ) - ( dVar31 - (double)auVar6 ) * ( dVar33 - dVar26 ) );
...
;
 ...
 while ( iVar16 != 0xf );
         ...
         *(long*)( param_1 + 0x988 ) = *(long*)( param_1 + 0x988 ) + 1;
         ...
         do {
            ...
            dVar25 = ( local_4f8 - dVar26 ) * ( ( local_308[lVar15 * 3 + 1] - dVar5 ) * dVar32 - dVar28 * ( local_308[lVar21 * 3 + 1] - dVar5 ) ) + ( dVar28 * dVar30 - dVar32 * dVar25 ) * ( local_4f0 - dVar5 ) + ( dVar25 * ( local_308[lVar21 * 3 + 1] - dVar5 ) - ( local_308[lVar15 * 3 + 1] - dVar5 ) * dVar30 ) * ( dVar33 - dVar4 );
 ...
 while ( iVar17 != 4 );
         ...
         do {
            ...
            dVar25 = ( dVar32 * ( local_308[lVar23 * 3 + 1] - dVar5 ) - ( local_308[lVar21 * 3 + 1] - dVar5 ) * dVar28 ) * ( local_4f8 - dVar26 ) + ( local_4f0 - dVar5 ) * ( dVar28 * dVar25 - dVar32 * dVar30 ) + ( ( local_308[lVar21 * 3 + 1] - dVar5 ) * dVar30 - dVar25 * ( local_308[lVar23 * 3 + 1] - dVar5 ) ) * ( dVar33 - dVar4 );
 ...
 while ( iVar18 != 4 );
         ...
         if (iVar19 != -1) {
            ...
            do {
               ...
               dVar26 = ( *pdVar1 - dVar5 ) * ( dVar29 * dVar25 - dVar31 * dVar30 ) + ( dVar31 * dVar28 - dVar26 * dVar29 ) * ( pdVar1[1] - dVar4 ) + ( dVar26 * dVar30 - dVar25 * dVar28 ) * ( pdVar1[2] - dVar33 );
 ...
 while ( iVar19 != 4 );
   ...
   LAB_0010a5cc:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* VHACD::TetrahedronSet::Clip(VHACD::Plane const&, VHACD::PrimitiveSet*, VHACD::PrimitiveSet*)
   const */void VHACD::TetrahedronSet::Clip(TetrahedronSet *this, Plane *param_1, PrimitiveSet *param_2, PrimitiveSet *param_3) {
   undefined8 uVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   double dVar4;
 ...
 while ( pPVar19 != local_238 );
         if (iVar27 == 4) {
            dVar32 = ( ( dStack_270 - local_240 ) * ( local_268 - local_250 ) - ( local_258 - local_240 ) * ( adStack_290[2] - local_250 ) ) * ( adStack_290[0] - local_248 ) + ( local_298 - local_250 ) * ( ( local_258 - local_240 ) * ( adStack_290[3] - local_248 ) - ( local_260 - local_248 ) * ( dStack_270 - local_240 ) ) + ( ( local_260 - local_248 ) * ( adStack_290[2] - local_250 ) - ( local_268 - local_250 ) * ( adStack_290[3] - local_248 ) ) * ( adStack_290[1] - local_240 );
 ...
 while ( pPVar21 != pPVar19 + 0x60 );
            ...
            do {
               ...
               if (local_2d8[lVar15] * local_2d8[lVar29] == -1) {
                  ...
                  lVar29 = (long)iVar27;
                  iVar27 = iVar27 + 1;
                  dVar31 = (double)( ( ulong )(dVar4 * dVar34 + dVar6 * dVar11 + dVar5 * dVar32 + dVar7) ^ _LC7 ) / ( ( dVar33 - dVar34 ) * dVar4 + ( adStack_290[lVar15 * 3] - dVar11 ) * dVar6 + ( adStack_290[lVar15 * 3 + 1] - dVar32 ) * dVar5 );
                  dVar35 = _LC10 - dVar31;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* VHACD::Volume::FillOutsideSurface(unsigned long, unsigned long, unsigned long, unsigned long,
   unsigned long, unsigned long) */void VHACD::Volume::FillOutsideSurface(Volume *this, ulong param_1, ulong param_2, ulong param_3, ulong param_4, ulong param_5, ulong param_6) {
   uint uVar1;
   uint uVar2;
   uint uVar3;
   uint *puVar4;
               ...
               if (param_3 < param_6) {
                  do {
                     while (true) {
                        ...
                        if (*(char*)( lVar7 + local_f0 + ( lVar14 * uVar17 + local_150 ) * lVar9 ) == '\0') break;
                        LAB_0010c960:uVar17 = uVar17 + 1;
...
;
                     ...
                     if (local_88 == (uint*)( local_78 + -3 )) {
                        if (( ( (long)local_148 - (long)local_160 >> 3 ) + -1 + ( ulong )(local_148 == (undefined8*)0x0) ) * 0x55 + ( (long)local_88 - (long)puStack_80 >> 1 ) * -0x5555555555555555 + lVar13 == 0x1555555555555555) {
                           LAB_0010d0fe:std::__throw_length_error("cannot create std::deque larger than max_size()");
                           goto LAB_0010d10a;
                        }

                        if (( ulong )(local_b0 - ( (long)local_148 - (long)local_b8 >> 3 )) < 2) {
                           std::deque<VHACD::Vec3<short>,std::allocator<VHACD::Vec3<short>>>::_M_reallocate_map(( deque<VHACD::Vec3<short>,std::allocator < VHACD::Vec3 < short> >> * ) & local_b8, 1, false);
                     ...
                     *(undefined1*)( lVar7 + ( sVar15 * lVar14 + (long)(short)local_150 ) * lVar9 + (long)(short)(ushort)local_f0 ) = 1;
                     *(long*)( this + 0x60 ) = *(long*)( this + 0x60 ) + 1;
                     if (( ( (long)local_148 - (long)local_160 >> 3 ) + -1 + ( ulong )(local_148 == (undefined8*)0x0) ) * 0x55 + lVar10 + lVar13 == 0) goto LAB_0010c960;
                     local_158 = local_88;
                           ...
                           if (-1 < (short)( (short)uVar2 + *psVar11 )) {
                              ...
                              if ((int)(uint)uVar19 < (int)*(long*)( this + 0x38 )) {
                                 if (-1 < (short)uVar20) {
                                    ...
                                    if (( ( ( (int)(uint)uVar20 < (int)*(long*)( this + 0x40 ) ) && ( -1 < (short)uVar16 ) ) && ( (int)(uint)uVar16 < *(int*)( this + 0x48 ) ) ) && ( pcVar8 = (char*)( ( (ulong)uVar20 + (ulong)uVar16 * *(long*)( this + 0x40 ) ) * *(long*)( this + 0x38 ) + (ulong)uVar19 + *(long*)( this + 0x68 ) ) * pcVar8 == '\0' )) {
                                       *pcVar8 = '\x01';
                                       *(long*)( this + 0x60 ) = *(long*)( this + 0x60 ) + 1;
                                       if (local_158 == (uint*)( local_78 + -3 )) {
                                          if (( ( (long)local_148 - (long)local_160 >> 3 ) + -1 + ( ulong )(local_148 == (undefined8*)0x0) ) * 0x55 + ( (long)local_158 - (long)local_140 >> 1 ) * -0x5555555555555555 + lVar14 == 0x1555555555555555) goto LAB_0010d0fe;
                                          if (( ulong )(local_b0 - ( (long)local_148 - (long)local_b8 >> 3 )) < 2) {
                                             std::deque<VHACD::Vec3<short>,std::allocator<VHACD::Vec3<short>>>::_M_reallocate_map(( deque<VHACD::Vec3<short>,std::allocator < VHACD::Vec3 < short> >> * ) & local_b8, 1, false);
                                             local_148 = puStack_70;
                                             local_158 = local_88;
 ...
 while ( ( ( (long)local_148 - (long)local_160 >> 3 ) + -1 + ( ulong )(local_148 == (undefined8*)0x0) ) * 0x55 + ( (long)local_158 - (long)local_140 >> 1 ) * -0x5555555555555555 + lVar14 != 0 );
                     uVar17 = uVar17 + 1;
                  }
 while ( uVar17 < param_6 );
               }

               LAB_0010cbe0:local_150 = local_150 + 1;
            }
 ...
 while ( local_f0 < param_4 );
   ...
   LAB_0010d10a:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* VHACD::VoxelSet::GetNPrimitives() const */undefined8 VHACD::VoxelSet::GetNPrimitives(VoxelSet *this) {
   return *(undefined8*)( this + 0xa00 );
}
/* VHACD::VoxelSet::GetNPrimitivesOnSurf() const */undefined8 VHACD::VoxelSet::GetNPrimitivesOnSurf(VoxelSet *this) {
   return *(undefined8*)( this + 0x988 );
}
/* VHACD::VoxelSet::GetNPrimitivesInsideSurf() const */undefined8 VHACD::VoxelSet::GetNPrimitivesInsideSurf(VoxelSet *this) {
   return *(undefined8*)( this + 0x990 );
}
/* VHACD::VoxelSet::GetEigenValue(VHACD::AXIS) const */undefined8 VHACD::VoxelSet::GetEigenValue(VoxelSet *this, int param_2) {
   return *(undefined8*)( this + (long)param_2 * 0x20 + 0xaa8 );
}
/* VHACD::VoxelSet::ComputeVolume() const */double VHACD::VoxelSet::ComputeVolume(VoxelSet *this) {
   ulong uVar1;
   uVar1 = *(ulong*)( this + 0xa00 );
   if (-1 < (long)uVar1) {
...
/* VHACD::VoxelSet::ComputeMaxVolumeError() const */double VHACD::VoxelSet::ComputeMaxVolumeError(VoxelSet *this) {
   ulong uVar1;
...
/* VHACD::VoxelSet::AlignToPrincipalAxes() */void VHACD::VoxelSet::AlignToPrincipalAxes(void) {
   return;
}
/* VHACD::VoxelSet::RevertAlignToPrincipalAxes() */void VHACD::VoxelSet::RevertAlignToPrincipalAxes(void) {
   return;
}
/* VHACD::TetrahedronSet::GetNPrimitives() const */undefined8 VHACD::TetrahedronSet::GetNPrimitives(TetrahedronSet *this) {
   return *(undefined8*)( this + 0xd30 );
}
/* VHACD::TetrahedronSet::GetNPrimitivesOnSurf() const */undefined8 VHACD::TetrahedronSet::GetNPrimitivesOnSurf(TetrahedronSet *this) {
   return *(undefined8*)( this + 0x988 );
}
/* VHACD::TetrahedronSet::GetNPrimitivesInsideSurf() const */undefined8 VHACD::TetrahedronSet::GetNPrimitivesInsideSurf(TetrahedronSet *this) {
   return *(undefined8*)( this + 0x990 );
}
/* VHACD::TetrahedronSet::GetEigenValue(VHACD::AXIS) const */undefined8 VHACD::TetrahedronSet::GetEigenValue(TetrahedronSet *this, int param_2) {
   return *(undefined8*)( this + (long)param_2 * 0x20 + 0xd88 );
}
/* VHACD::VoxelSet::Create() const */VoxelSet *VHACD::VoxelSet::Create(void) {
   VoxelSet *this;
   this(VoxelSet * operator_new(0xb08));
   VoxelSet(this);
   return this;
}
/* VHACD::TetrahedronSet::Create() const */TetrahedronSet *VHACD::TetrahedronSet::Create(void) {
   TetrahedronSet *this;
   this(TetrahedronSet * operator_new(0xdd0));
   TetrahedronSet(this);
   return this;
}
/* VHACD::TetrahedronSet::Add(VHACD::Tetrahedron&) */undefined8 VHACD::TetrahedronSet::Add(TetrahedronSet *this, Tetrahedron *param_1) {
   double dVar1;
   double dVar2;
   double dVar3;
   double dVar4;
   ...
   dVar13 = ( dVar12 * ( *(double*)( param_1 + 0x30 ) - dVar1 ) - ( *(double*)( param_1 + 0x40 ) - *(double*)( param_1 + 0x58 ) ) * dVar15 ) * ( dVar3 - dVar13 ) + ( ( *(double*)( param_1 + 0x40 ) - *(double*)( param_1 + 0x58 ) ) * dVar14 - ( *(double*)( param_1 + 0x38 ) - dVar13 ) * dVar12 ) * ( dVar2 - dVar1 ) + ( ( *(double*)( param_1 + 0x38 ) - dVar13 ) * dVar15 - ( *(double*)( param_1 + 0x30 ) - dVar1 ) * dVar14 ) * ( dVar4 - *(double*)( param_1 + 0x58 ) );
...
/* std::deque<VHACD::Vec3<short>, std::allocator<VHACD::Vec3<short> > >::_M_reallocate_map(unsigned
   long, bool) */void std::deque<VHACD::Vec3<short>,std::allocator<VHACD::Vec3<short>>>::_M_reallocate_map(deque<VHACD::Vec3<short>,std::allocator<VHACD::Vec3<short>>> *this, ulong param_1, bool param_2) {
   long *plVar1;
   size_t sVar2;
   long lVar3;
   long *__dest;
   ...
   lVar3 = *__dest;
   LAB_0010d663:*(long*)( this + 0x18 ) = lVar3;

...
/* Resource::initialize_class() [clone .part.0] */void Resource::initialize_class(void) {
   ...
   ulong VideoStreamPlaybackTheora::buffer_data(VideoStreamPlaybackTheora *this) {
      undefined8 uVar1;
      ulong uVar2;
   ...
   undefined8 VideoStreamPlaybackTheora::queue_page(VideoStreamPlaybackTheora *this, ogg_page *param_1) {
      int iVar1;
   ...
   void VideoStreamPlaybackTheora::clear(VideoStreamPlaybackTheora *this) {
      Object *pOVar1;
      char cVar2;
   ...
   void VideoStreamPlaybackTheora::~VideoStreamPlaybackTheora(VideoStreamPlaybackTheora *this) {
      long *plVar1;
      long lVar2;
      Object *pOVar3;
      char cVar4;
   ...
   void VideoStreamPlaybackTheora::video_write(VideoStreamPlaybackTheora *this, th_img_plane *param_1) {
      long *plVar1;
      byte bVar2;
      int iVar3;
      undefined4 uVar4;
 ...
 while ( !bVar28 );
   ...
   void VideoStreamPlaybackTheora::set_file(VideoStreamPlaybackTheora *this, String *param_1) {
      Image *pIVar1;
      long *plVar2;
...
;
 ...
 while ( (int)uVar16 != 0 );
   ...
   else{*(Object**)( this + 0x3b0 ) = local_208;
   ...
   LAB_001025d9:local_210 = (Image*)0x0;
   local_208 = (Object*)&_LC22;
   local_200 = 2;
   String::parse_latin1((StrRange*)&local_210);
   operator+((char *)&
   local_218,(String*)"Cannot open file \'";
   String::operator +((String*)&local_208, (String*)&local_218);
   _err_print_error("set_file", "modules/theora/video_stream_theora.cpp", 0x80, "Condition \"file.is_null()\" is true.", (String*)&local_208, 0, 0);
   pOVar9 = local_208;
   if (local_208 != (Object*)0x0) {
      LOCK();

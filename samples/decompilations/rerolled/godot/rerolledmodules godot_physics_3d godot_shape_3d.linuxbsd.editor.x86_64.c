/* GodotShape3D::get_support(Vector3 const&) const */undefined1  [16] __thiscallGodotShape3D::get_support(GodotShape3D *this, Vector3 *param_1) {
   long in_FS_OFFSET;
...
/* GodotWorldBoundaryShape3D::project_range(Vector3 const&, Transform3D const&, float&, float&)
   const */void GodotWorldBoundaryShape3D::project_range(Vector3 *param_1, Transform3D *param_2, float *param_3, float *param_4) {
   undefined4 *in_R8;
   *param_4 = -1e+07;
   *in_R8 = 0x4b189680;
   return;
}
/* GodotWorldBoundaryShape3D::get_support(Vector3 const&) const */undefined1  [16] __thiscallGodotWorldBoundaryShape3D::get_support(GodotWorldBoundaryShape3D *this, Vector3 *param_1) {
   long in_FS_OFFSET;
   undefined1 auVar1[16];
...
/* GodotWorldBoundaryShape3D::intersect_point(Vector3 const&) const */bool GodotWorldBoundaryShape3D::intersect_point(GodotWorldBoundaryShape3D *this, Vector3 *param_1) {
   return ( *(float*)( this + 0x60 ) * *(float*)param_1 + *(float*)( this + 100 ) * *(float*)( param_1 + 4 ) + *(float*)( this + 0x68 ) * *(float*)( param_1 + 8 ) ) - *(float*)( this + 0x6c ) < 0.0;
}
/* GodotWorldBoundaryShape3D::get_closest_point_to(Vector3 const&) const */undefined1  [16] __thiscallGodotWorldBoundaryShape3D::get_closest_point_to(GodotWorldBoundaryShape3D *this, Vector3 *param_1) {
   long in_FS_OFFSET;
   float fVar1;
   float fVar2;
   float fVar3;
   ...
   fVar1 = *(float*)( this + 0x60 ) * *(float*)param_1 + fVar2 * fVar3 + *(float*)( this + 0x68 ) * *(float*)( param_1 + 8 );
   if (fVar1 <= *(float*)( this + 0x6c )) {
      ...
      local_20 = CONCAT44(fVar2 - fVar1 * fVar3, (float)*(undefined8*)param_1 - fVar1 * (float)*(undefined8*)( this + 0x60 ));
   }
...
/* GodotSeparationRayShape3D::get_moment_of_inertia(float) const */undefined1[16];GodotSeparationRayShape3D::get_moment_of_inertia(float param_1) {
   long in_FS_OFFSET;
   if (*(long*)( in_FS_OFFSET + 0x28 ) == *(long*)( in_FS_OFFSET + 0x28 )) {
      return ZEXT816(0);
   }
...
/* GodotSeparationRayShape3D::project_range(Vector3 const&, Transform3D const&, float&, float&)
   const */void GodotSeparationRayShape3D::project_range(Vector3 *param_1, Transform3D *param_2, float *param_3, float *param_4) {
   undefined4 *in_R8;
   *param_4 = 0.0;
   *in_R8 = 0x3f800000;
   return;
...
/* GodotSeparationRayShape3D::intersect_segment(Vector3 const&, Vector3 const&, Vector3&, Vector3&,
   int&, bool) const */undefined8 GodotSeparationRayShape3D::intersect_segment(Vector3 *param_1, Vector3 *param_2, Vector3 *param_3, Vector3 *param_4, int *param_5, bool param_6) {
   return 0;
}
/* GodotConcavePolygonShape3D::intersect_point(Vector3 const&) const */undefined8 GodotConcavePolygonShape3D::intersect_point(Vector3 *param_1) {
   return 0;
}
/* GodotSphereShape3D::get_support(Vector3 const&) const */void GodotSphereShape3D::get_support(Vector3 *param_1) {
   long in_FS_OFFSET;
   if (*(long*)( in_FS_OFFSET + 0x28 ) == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* GodotSphereShape3D::get_supports(Vector3 const&, int, Vector3*, int&, GodotShape3D::FeatureType&)
   const */void GodotSphereShape3D::get_supports(GodotSphereShape3D *this, Vector3 *param_1, int param_2, Vector3 *param_3, int *param_4, FeatureType *param_5) {
   float fVar1;
   undefined8 uVar2;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotSphereShape3D::get_moment_of_inertia(float) const */undefined1  [16] __thiscallGodotSphereShape3D::get_moment_of_inertia(GodotSphereShape3D *this, float param_1) {
   long in_FS_OFFSET;
   undefined1 auVar1[16];
   auVar1._0_4_ = (float)( (double)param_1 * __LC10 * (double)*(float*)( this + 0x60 ) * (double)*(float*)( this + 0x60 ) );
   if (*(long*)( in_FS_OFFSET + 0x28 ) == *(long*)( in_FS_OFFSET + 0x28 )) {
...
/* GodotBoxShape3D::project_range(Vector3 const&, Transform3D const&, float&, float&) const */void GodotBoxShape3D::project_range(GodotBoxShape3D *this, Vector3 *param_1, Transform3D *param_2, float *param_3, float *param_4) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   fVar4 = fVar3 * *(float*)( param_2 + 0x24 ) + fVar1 * *(float*)( param_2 + 0x28 ) + fVar2 * *(float*)( param_2 + 0x2c );
   fVar3 = ABS(*(float*)param_2 * fVar3 + *(float*)( param_2 + 0xc ) * fVar1 + *(float*)( param_2 + 0x18 ) * fVar2) * *(float*)( this + 0x60 ) + ABS(*(float*)( param_2 + 4 ) * fVar3 + *(float*)( param_2 + 0x10 ) * fVar1 + *(float*)( param_2 + 0x1c ) * fVar2) * *(float*)( this + 100 ) + ABS(*(float*)( param_2 + 8 ) * fVar3 + *(float*)( param_2 + 0x14 ) * fVar1 + *(float*)( param_2 + 0x20 ) * fVar2) * *(float*)( this + 0x68 );
   *param_3 = fVar4 - fVar3;
   *param_4 = fVar4 + fVar3;
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotBoxShape3D::get_support(Vector3 const&) const */void GodotBoxShape3D::get_support(Vector3 *param_1) {
   long in_FS_OFFSET;
   if (*(long*)( in_FS_OFFSET + 0x28 ) == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotBoxShape3D::get_supports(Vector3 const&, int, Vector3*, int&, GodotShape3D::FeatureType&)
   const */void GodotBoxShape3D::get_supports(GodotBoxShape3D *this, Vector3 *param_1, int param_2, Vector3 *param_3, int *param_4, FeatureType *param_5) {
   float fVar1;
   float fVar2;
   float fVar3;
   undefined4 uVar4;
   ...
   do {
      ...
      if (dVar7 < (double)ABS(fVar13)) {
         ...
         *param_4 = 4;
         ...
         uVar15 = (uint)_LC13;
         local_38 = 0;
         pfVar11 = (float*)&get_supports(Vector3_const & Vector3, *,int&, GodotShape3D::FeatureType & ::sign);
         local_30 = 0;
         iVar5 = ( &get_supports(Vector3_const & Vector3, *,int&, GodotShape3D::FeatureType & ::next)[lVar10] );
         *(undefined4*)( (long)&local_38 + lVar10 * 4 ) = *(undefined4*)( this + lVar10 * 4 + 0x60 );
         iVar9 = ( &get_supports(Vector3_const & Vector3, *,int&, GodotShape3D::FeatureType & ::next2)[lVar10] );
         *(undefined4*)param_5 = 2;
         pVVar12 = param_3 + 8;
         do {
            *(float*)( (long)&local_38 + (long)iVar5 * 4 ) = *(float*)( this + (long)iVar5 * 4 + 0x60 ) * *pfVar11;
            *(float*)( (long)&local_38 + (long)iVar9 * 4 ) = pfVar11[1] * *(float*)( this + (long)iVar9 * 4 + 0x60 );
            uVar16 = local_38;
            uVar6 = local_30;
            if (fVar13 < 0.0) {
 ...
 while ( pfVar11 != (float*)&get_supports(Vector3_const & Vector3, *,int&, GodotShape3D::FeatureType & ::next2) );
         if (fVar13 < 0.0) {
 ...
 while ( lVar10 != 3 );
   ...
   do {
      ...
      local_28[lVar10] = fVar8;
      if ((double)ABS(local_28[0] * fVar1 + local_28[1] * fVar2 + local_28[2] * fVar3) < edge_support_threshold_lower) {
         *param_4 = 2;
         iVar9 = (int)lVar10;
         *(undefined4*)param_5 = 1;
         uVar15 = _LC51;
         iVar5 = ( &get_supports(Vector3_const & Vector3, *,int&, GodotShape3D::FeatureType & ::next2)[iVar9] );
         local_1c = *(undefined8*)( this + 0x60 );
         local_14 = *(undefined4*)( this + 0x68 );
         lVar10 = (long)(int)( &get_supports(Vector3_const & Vector3, *,int&, GodotShape3D::FeatureType & ::next)[iVar9] );
         ...
         *(uint*)( (long)&local_1c + (long)iVar9 * 4 ) = *(uint*)( (long)&local_1c + (long)iVar9 * 4 ) ^ uVar15;
 ...
 while ( lVar10 != 3 );
   ...
   *(uint*)( param_3 + 8 ) = uVar15;
   LAB_0010066c:if (local_10 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* GodotBoxShape3D::intersect_point(Vector3 const&) const */undefined4 GodotBoxShape3D::intersect_point(GodotBoxShape3D *this, Vector3 *param_1) {
   if (( ABS(*(float*)param_1) < *(float*)( this + 0x60 ) ) && ( ABS(*(float*)( param_1 + 4 )) < *(float*)( this + 100 ) )) {
      return CONCAT31(( int3 )((uint)ABS(*(float*)( param_1 + 8 )) >> 8), ABS(*(float*)( param_1 + 8 )) < *(float*)( this + 0x68 ));
   }

   return 0;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotBoxShape3D::get_moment_of_inertia(float) const */void GodotBoxShape3D::get_moment_of_inertia(GodotBoxShape3D *this, float param_1) {
   float fVar1;
   long in_FS_OFFSET;
   float fVar2;
   float fVar3;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail(CONCAT44((float)( (double)( fVar3 * fVar3 + fVar2 ) * ( (double)param_1 / __LC14 ) ), (float)( (double)( fVar1 * fVar1 + fVar2 ) * ( (double)param_1 / __LC14 ) )));
}
/* GodotCapsuleShape3D::get_support(Vector3 const&) const */void GodotCapsuleShape3D::get_support(Vector3 *param_1) {
   long in_FS_OFFSET;
   if (*(long*)( in_FS_OFFSET + 0x28 ) == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotCylinderShape3D::get_moment_of_inertia(float) const */void GodotCylinderShape3D::get_moment_of_inertia(float param_1) {
   long in_FS_OFFSET;
   if (*(long*)( in_FS_OFFSET + 0x28 ) == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* GodotConvexPolygonShape3D::intersect_point(Vector3 const&) const */undefined8 GodotConvexPolygonShape3D::intersect_point(GodotConvexPolygonShape3D *this, Vector3 *param_1) {
   float *pfVar1;
   float *pfVar2;
   ...
   if (0 < *(int*)( this + 0x60 )) {
      ...
      do {
         if (0.0 <= ( *pfVar2 * *(float*)param_1 + pfVar2[1] * *(float*)( param_1 + 4 ) + pfVar2[2] * *(float*)( param_1 + 8 ) ) - pfVar2[3]) {
            return 0;
         }
...
/* GodotFaceShape3D::project_range(Vector3 const&, Transform3D const&, float&, float&) const */void GodotFaceShape3D::project_range(GodotFaceShape3D *this, Vector3 *param_1, Transform3D *param_2, float *param_3, float *param_4) {
   float fVar1;
   float fVar2;
   int iVar3;
   ...
   while (true) {
      while (true) {
         ...
         fVar5 = ( *(float*)param_2 * fVar5 + *(float*)( param_2 + 4 ) * fVar1 + *(float*)( param_2 + 8 ) * fVar2 + *(float*)( param_2 + 0x24 ) ) * *(float*)param_1 + ( *(float*)( param_2 + 0xc ) * fVar5 + *(float*)( param_2 + 0x10 ) * fVar1 + *(float*)( param_2 + 0x14 ) * fVar2 + *(float*)( param_2 + 0x28 ) ) * *(float*)( param_1 + 4 ) + ( fVar5 * *(float*)( param_2 + 0x18 ) + fVar1 * *(float*)( param_2 + 0x1c ) + fVar2 * *(float*)( param_2 + 0x20 ) + *(float*)( param_2 + 0x2c ) ) * *(float*)( param_1 + 8 );
         if (iVar3 != 0) break;
         *param_4 = fVar5;
         pGVar4 = pGVar4 + 0xc;
         iVar3 = 1;
...
/* GodotFaceShape3D::get_support(Vector3 const&) const */void GodotFaceShape3D::get_support(GodotFaceShape3D *this, Vector3 *param_1) {
   ...
   fVar4 = 0.0;
   while (true) {
      while (fVar3 = *(float*)pGVar1 * *(float*)param_1 + *(float*)( pGVar1 + 4 ) * *(float*)( param_1 + 4 ) + *(float*)( pGVar1 + 8 ) * *(float*)( param_1 + 8 ),iVar2 == 0) {
         pGVar1 = pGVar1 + 0xc;
         fVar4 = fVar3;
         iVar2 = 1;
      }
...
/* GodotConcavePolygonShape3D::project_range(Vector3 const&, Transform3D const&, float&, float&)
   const */void GodotConcavePolygonShape3D::project_range(GodotConcavePolygonShape3D *this, Vector3 *param_1, Transform3D *param_2, float *param_3, float *param_4) {
   float fVar1;
   float fVar2;
   int iVar3;
   int iVar4;
   ...
   if (( pfVar5 == (float*)0x0 ) || ( iVar3 = iVar3 == 0 )) {
      *param_3 = 0.0;
      *param_4 = 0.0;
      return;
   }
   ...
   do {
      ...
      fVar1 = pfVar5[1];
      fVar2 = pfVar5[2];
      fVar6 = ( *(float*)param_2 * fVar6 + *(float*)( param_2 + 4 ) * fVar1 + *(float*)( param_2 + 8 ) * fVar2 + *(float*)( param_2 + 0x24 ) ) * *(float*)param_1 + ( *(float*)( param_2 + 0xc ) * fVar6 + *(float*)( param_2 + 0x10 ) * fVar1 + *(float*)( param_2 + 0x14 ) * fVar2 + *(float*)( param_2 + 0x28 ) ) * *(float*)( param_1 + 4 ) + ( fVar6 * *(float*)( param_2 + 0x18 ) + fVar1 * *(float*)( param_2 + 0x1c ) + fVar2 * *(float*)( param_2 + 0x20 ) + *(float*)( param_2 + 0x2c ) ) * *(float*)( param_1 + 8 );
      if (iVar4 == 0) {
         *param_4 = fVar6;
         LAB_00100d7c:*param_3 = fVar6;
      }
 else {
...
/* GodotConcavePolygonShape3D::get_support(Vector3 const&) const */undefined1  [16] __thiscallGodotConcavePolygonShape3D::get_support(GodotConcavePolygonShape3D *this, Vector3 *param_1) {
   float *pfVar1;
   int iVar2;
   float *pfVar3;
   long lVar4;
   ...
   if (( pfVar1 == (float*)0x0 ) || ( iVar2 = iVar2 == 0 )) {
      local_1c = 0;
      local_14 = 0;
   }
 else {
      if (iVar2 < 1) {
         ...
         fVar8 = 0.0;
         do {
            while (fVar7 = pfVar3[1] * *(float*)( param_1 + 4 ) + *pfVar3 * *(float*)param_1 + pfVar3[2] * *(float*)( param_1 + 8 ),iVar6 == 0) {
               iVar6 = 1;
               iVar5 = 0;
               pfVar3 = pfVar3 + 3;
               fVar8 = fVar7;
...
;
 ...
 while ( iVar6 != iVar2 );
         LAB_00100efe:lVar4 = (long)iVar5 * 0xc;
      }
...
/* GodotHeightMapShape3D::get_closest_point_to(Vector3 const&) const */undefined1[16];GodotHeightMapShape3D::get_closest_point_to(Vector3 *param_1) {
   long in_FS_OFFSET;
   if (*(long*)( in_FS_OFFSET + 0x28 ) == *(long*)( in_FS_OFFSET + 0x28 )) {
      return ZEXT816(0);
   }
...
/* GodotHeightMapShape3D::project_range(Vector3 const&, Transform3D const&, float&, float&) const */void GodotHeightMapShape3D::project_range(GodotHeightMapShape3D *this, Vector3 *param_1, Transform3D *param_2, float *param_3, float *param_4) {
   long lVar1;
   Transform3D *pTVar2;
   long lVar3;
   long in_FS_OFFSET;
   ...
   local_50 = CONCAT44((float)( ( ulong ) * (undefined8*)( this + 0x1c ) >> 0x20 ) + (float)( ( ulong ) * (undefined8*)( this + 0x10 ) >> 0x20 ), (float)*(undefined8*)( this + 0x1c ) + (float)*(undefined8*)( this + 0x10 ));
 ...
 while ( lVar3 != 0xc );
   ...
   fVar5 = ( fVar7 + local_38[0] ) * *(float*)param_1 + ( local_38[1] + fVar4 ) * *(float*)( param_1 + 4 ) + ( local_38[2] + fVar8 ) * *(float*)( param_1 + 8 );
   fVar7 = ABS(*(float*)param_1) * fVar7 + ABS(*(float*)( param_1 + 4 )) * fVar4 + ABS(*(float*)( param_1 + 8 )) * fVar8;
   *param_3 = fVar5 - fVar7;
   *param_4 = fVar7 + fVar5;
...
/* GodotHeightMapShape3D::get_support(Vector3 const&) const */void GodotHeightMapShape3D::get_support(GodotHeightMapShape3D *this, Vector3 *param_1) {
   long in_FS_OFFSET;
   float fVar1;
...
/* GodotWorldBoundaryShape3D::intersect_segment(Vector3 const&, Vector3 const&, Vector3&, Vector3&,
   int&, bool) const */void GodotWorldBoundaryShape3D::intersect_segment(Vector3 *param_1, Vector3 *param_2, Vector3 *param_3, Vector3 *param_4, int *param_5, bool param_6) {
   char cVar1;
...
/* GodotWorldBoundaryShape3D::get_data() const */void GodotWorldBoundaryShape3D::get_data(void) {
   long in_RSI;
   Variant *in_RDI;
   Variant::Variant(in_RDI, (Plane*)( in_RSI + 0x60 ));
   return;
}
/* GodotSphereShape3D::get_data() const */void GodotSphereShape3D::get_data(void) {
   long in_RSI;
   Variant *in_RDI;
   Variant::Variant(in_RDI, *(float*)( in_RSI + 0x60 ));
   return;
}
/* GodotCylinderShape3D::get_support(Vector3 const&) const */void GodotCylinderShape3D::get_support(Vector3 *param_1) {
   long in_FS_OFFSET;
   if (*(long*)( in_FS_OFFSET + 0x28 ) == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* GodotSphereShape3D::intersect_point(Vector3 const&) const */bool GodotSphereShape3D::intersect_point(GodotSphereShape3D *this, Vector3 *param_1) {
   return SQRT(*(float*)param_1 * *(float*)param_1 + *(float*)( param_1 + 4 ) * *(float*)( param_1 + 4 ) + *(float*)( param_1 + 8 ) * *(float*)( param_1 + 8 )) < *(float*)( this + 0x60 );
}
/* GodotSphereShape3D::get_closest_point_to(Vector3 const&) const */undefined1  [16] __thiscallGodotSphereShape3D::get_closest_point_to(GodotSphereShape3D *this, Vector3 *param_1) {
   float fVar1;
   float fVar2;
   ulong uVar3;
   undefined1 auVar4[16];
...
/* GodotCapsuleShape3D::intersect_point(Vector3 const&) const */undefined4 GodotCapsuleShape3D::intersect_point(GodotCapsuleShape3D *this, Vector3 *param_1) {
   float fVar1;
   undefined3 uVar2;
   float fVar3;
   double dVar4;
...
/* GodotCapsuleShape3D::get_supports(Vector3 const&, int, Vector3*, int&,
   GodotShape3D::FeatureType&) const */void GodotCapsuleShape3D::get_supports(GodotCapsuleShape3D *this, Vector3 *param_1, int param_2, Vector3 *param_3, int *param_4, FeatureType *param_5) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotCylinderShape3D::get_supports(Vector3 const&, int, Vector3*, int&,
   GodotShape3D::FeatureType&) const */void GodotCylinderShape3D::get_supports(GodotCylinderShape3D *this, Vector3 *param_1, int param_2, Vector3 *param_3, int *param_4, FeatureType *param_5) {
   long lVar1;
   float fVar2;
   float fVar3;
   double dVar4;
...
/* GodotSphereShape3D::project_range(Vector3 const&, Transform3D const&, float&, float&) const */void GodotSphereShape3D::project_range(GodotSphereShape3D *this, Vector3 *param_1, Transform3D *param_2, float *param_3, float *param_4) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   fVar1 = *(float*)( param_1 + 4 );
   fVar2 = *(float*)( param_1 + 8 );
   fVar6 = *(float*)( param_2 + 0x24 ) * fVar3 + *(float*)( param_2 + 0x28 ) * fVar1 + *(float*)( param_2 + 0x2c ) * fVar2;
   fVar4 = *(float*)( param_2 + 8 ) * fVar3 + *(float*)( param_2 + 0x14 ) * fVar1 + *(float*)( param_2 + 0x20 ) * fVar2;
   fVar5 = *(float*)( param_2 + 4 ) * fVar3 + *(float*)( param_2 + 0x10 ) * fVar1 + *(float*)( param_2 + 0x1c ) * fVar2;
   fVar3 = fVar3 * *(float*)param_2 + fVar1 * *(float*)( param_2 + 0xc ) + fVar2 * *(float*)( param_2 + 0x18 );
   fVar3 = SQRT(fVar3 * fVar3 + fVar5 * fVar5 + fVar4 * fVar4);
   *param_3 = fVar6 - *(float*)( this + 0x60 ) * fVar3;
   *param_4 = fVar3 * *(float*)( this + 0x60 ) + fVar6;
   return;
}
/* GodotCapsuleShape3D::project_range(Vector3 const&, Transform3D const&, float&, float&) const */void GodotCapsuleShape3D::project_range(GodotCapsuleShape3D *this, Vector3 *param_1, Transform3D *param_2, float *param_3, float *param_4) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   fVar3 = *(float*)( param_1 + 8 );
   fVar6 = *(float*)( this + 100 );
   fVar5 = *(float*)( param_2 + 8 ) * fVar1 + *(float*)( param_2 + 0x14 ) * fVar2 + *(float*)( param_2 + 0x20 ) * fVar3;
   fVar4 = fVar1 * *(float*)( param_2 + 4 ) + fVar2 * *(float*)( param_2 + 0x10 ) + fVar3 * *(float*)( param_2 + 0x1c );
   fVar7 = fVar1 * *(float*)param_2 + fVar2 * *(float*)( param_2 + 0xc ) + fVar3 * *(float*)( param_2 + 0x18 );
   ...
   LAB_00101a45:fVar8 = fVar8 + local_c;
   fVar5 = (float)( (uint)fVar8 ^ _LC51 );
   fVar7 = (float)( (uint)fVar6 ^ _LC51 );
   fVar9 = (float)( _LC51 ^ (uint)fVar4 );
   *param_4 = ( *(float*)param_2 * fVar4 + *(float*)( param_2 + 4 ) * fVar8 + *(float*)( param_2 + 8 ) * fVar6 + *(float*)( param_2 + 0x24 ) ) * fVar1 + ( *(float*)( param_2 + 0xc ) * fVar4 + *(float*)( param_2 + 0x10 ) * fVar8 + *(float*)( param_2 + 0x14 ) * fVar6 + *(float*)( param_2 + 0x28 ) ) * fVar2 + ( *(float*)( param_2 + 0x18 ) * fVar4 + *(float*)( param_2 + 0x1c ) * fVar8 + *(float*)( param_2 + 0x20 ) * fVar6 + *(float*)( param_2 + 0x2c ) ) * fVar3;
   *param_3 = ( *(float*)param_2 * fVar9 + *(float*)( param_2 + 4 ) * fVar5 + *(float*)( param_2 + 8 ) * fVar7 + *(float*)( param_2 + 0x24 ) ) * *(float*)param_1 + ( *(float*)( param_2 + 0xc ) * fVar9 + *(float*)( param_2 + 0x10 ) * fVar5 + *(float*)( param_2 + 0x14 ) * fVar7 + *(float*)( param_2 + 0x28 ) ) * *(float*)( param_1 + 4 ) + ( fVar9 * *(float*)( param_2 + 0x18 ) + fVar5 * *(float*)( param_2 + 0x1c ) + fVar7 * *(float*)( param_2 + 0x20 ) + *(float*)( param_2 + 0x2c ) ) * *(float*)( param_1 + 8 );
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotFaceShape3D::get_supports(Vector3 const&, int, Vector3*, int&, GodotShape3D::FeatureType&)
   const */void GodotFaceShape3D::get_supports(GodotFaceShape3D *this, Vector3 *param_1, int param_2, Vector3 *param_3, int *param_4, FeatureType *param_5) {
   float fVar1;
   float fVar2;
   float fVar3;
   undefined8 uVar4;
   ...
   fVar2 = *(float*)( param_1 + 4 );
   fVar3 = *(float*)( param_1 + 8 );
   if (_LC12 < (double)ABS(*(float*)( this + 0x60 ) * fVar1 + *(float*)( this + 100 ) * fVar2 + *(float*)( this + 0x68 ) * fVar3)) {
   ...
   while (true) {
      while (true) {
         fVar11 = *(float*)pGVar7 * fVar1 + *(float*)( pGVar7 + 4 ) * fVar2 + *(float*)( pGVar7 + 8 ) * fVar3;
...
/* GodotConvexPolygonShape3D::get_supports(Vector3 const&, int, Vector3*, int&,
   GodotShape3D::FeatureType&) const */undefined1  [16] __thiscallGodotConvexPolygonShape3D::get_supports(GodotConvexPolygonShape3D *this, Vector3 *param_1, int param_2, Vector3 *param_3, int *param_4, FeatureType *param_5) {
   int iVar1;
   int iVar2;
   int iVar3;
   float *pfVar4;
   ...
   *param_4 = 0;
   if (iVar1 == 0) {
      _err_print_error("get_supports", "modules/godot_physics_3d/godot_shape_3d.cpp", 0x397, "Condition \"vc == 0\" is true.", "Convex polygon shape has no vertices.", 0);
      auVar6._8_8_ = 0;
   ...
   if (iVar1 < 1) {
      ...
      fVar16 = 0.0;
      do {
         while (fVar15 = pfVar7[1] * *(float*)( param_1 + 4 ) + *pfVar7 * *(float*)param_1 + pfVar7[2] * *(float*)( param_1 + 8 ),iVar13 == 0) {
            iVar13 = 1;
            iVar11 = 0;
            pfVar7 = pfVar7 + 3;
            fVar16 = fVar15;
...
;
 ...
 while ( iVar1 != iVar13 );
   ...
   LAB_00101ebe:if (0 < iVar2) {
      pfVar7 = pfVar12 + ( ulong )(iVar2 - 1) * 8 + 8;
      do {
         if (_LC12 < (double)( *pfVar12 * *(float*)param_1 + pfVar12[1] * *(float*)( param_1 + 4 ) + pfVar12[2] * *(float*)( param_1 + 8 ) )) {
            fVar16 = pfVar12[4];
 ...
 while ( pfVar7 != pfVar12 );
   ...
   if (0 < iVar3) {
      ...
      do {
         ...
         if (fVar15 == 0.0) {
            fVar16 = *(float*)( param_1 + 4 ) * 0.0 + *(float*)param_1 * 0.0 + *(float*)( param_1 + 8 ) * 0.0;
         }
 else {
            fVar15 = SQRT(fVar15);
            fVar16 = ( fVar16 / fVar15 ) * *(float*)param_1 + ( fVar18 / fVar15 ) * *(float*)( param_1 + 4 ) + ( fVar17 / fVar15 ) * *(float*)( param_1 + 8 );
            if (fVar16 < 0.0) {
         ...
         if (( (double)fVar16 < edge_support_threshold_lower ) && ( ( piVar10[1] == iVar11 || ( *piVar10 == iVar11 ) ) )) {
            *param_4 = 2;
            iVar1 = *piVar10;
            iVar2 = piVar10[1];
            *(undefined4*)param_5 = 1;
...
/* GodotBoxShape3D::intersect_segment(Vector3 const&, Vector3 const&, Vector3&, Vector3&, int&,
   bool) const */void GodotBoxShape3D::intersect_segment(Vector3 *param_1, Vector3 *param_2, Vector3 *param_3, Vector3 *param_4, int *param_5, bool param_6) {
   float fVar1;
   long in_FS_OFFSET;
   float fVar2;
   float fVar3;
...
/* GodotBoxShape3D::get_data() const */void GodotBoxShape3D::get_data(void) {
   long in_RSI;
   Variant *in_RDI;
   Variant::Variant(in_RDI, (Vector3*)( in_RSI + 0x60 ));
   return;
}
/* GodotCylinderShape3D::project_range(Vector3 const&, Transform3D const&, float&, float&) const */void GodotCylinderShape3D::project_range(GodotCylinderShape3D *this, Vector3 *param_1, Transform3D *param_2, float *param_3, float *param_4) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   fVar10 = *(float*)( param_2 + 8 ) * fVar2 + *(float*)( param_2 + 0x14 ) * fVar3 + *(float*)( param_2 + 0x20 ) * fVar4;
   fVar8 = fVar8 * fVar2 + fVar5 * fVar3 + fVar1 * fVar4;
   fVar5 = *(float*)param_2 * fVar2 + *(float*)( param_2 + 0xc ) * fVar3 + *(float*)( param_2 + 0x18 ) * fVar4;
   ...
   fVar5 = fVar2 * *(float*)( param_2 + 0x24 ) + fVar3 * *(float*)( param_2 + 0x28 ) + fVar4 * *(float*)( param_2 + 0x2c );
   *param_3 = fVar5 - fVar8;
   *param_4 = fVar8 + fVar5;
   return;
}
/* GodotConvexPolygonShape3D::intersect_segment(Vector3 const&, Vector3 const&, Vector3&, Vector3&,
   int&, bool) const */char GodotConvexPolygonShape3D::intersect_segment(Vector3 *param_1, Vector3 *param_2, Vector3 *param_3, Vector3 *param_4, int *param_5, bool param_6) {
   float *pfVar1;
   undefined8 *puVar2;
   undefined8 *puVar3;
   undefined8 *puVar4;
   ...
   if (*(int*)( param_1 + 0x60 ) < 1) {
      ...
      local_90 = _LC38;
      do {
         if (*pfVar14 * ( fVar7 - fVar10 ) + pfVar14[1] * ( fVar6 - fVar9 ) + pfVar14[2] * ( fVar5 - fVar8 ) <= 0.0) {
            fVar16 = pfVar14[4];
...
/* GodotFaceShape3D::get_closest_point_to(Vector3 const&) const */void GodotFaceShape3D::get_closest_point_to(Vector3 *param_1) {
   long in_FS_OFFSET;
   undefined8 local_38;
   undefined4 local_30;
   undefined8 local_2c;
...
/* GodotSeparationRayShape3D::get_support(Vector3 const&) const */undefined1  [16] __thiscallGodotSeparationRayShape3D::get_support(GodotSeparationRayShape3D *this, Vector3 *param_1) {
   long in_FS_OFFSET;
   uint uVar1;
...
/* GodotCylinderShape3D::intersect_point(Vector3 const&) const */undefined4 GodotCylinderShape3D::intersect_point(GodotCylinderShape3D *this, Vector3 *param_1) {
   if ((double)*(float*)( this + 0x60 ) * _LC15 <= (double)ABS(*(float*)( param_1 + 4 ))) {
      return 0;
   }

   return CONCAT31(( int3 )((uint)ABS(*(float*)( param_1 + 4 )) >> 8), SQRT(*(float*)param_1 * *(float*)param_1 + 0.0 + *(float*)( param_1 + 8 ) * *(float*)( param_1 + 8 )) < *(float*)( this + 100 ));
}
/* GodotSeparationRayShape3D::get_supports(Vector3 const&, int, Vector3*, int&,
   GodotShape3D::FeatureType&) const */void GodotSeparationRayShape3D::get_supports(GodotSeparationRayShape3D *this, Vector3 *param_1, int param_2, Vector3 *param_3, int *param_4, FeatureType *param_5) {
   undefined4 uVar1;
   float fVar2;
   fVar2 = *(float*)( param_1 + 8 );
...
/* CowData<GodotConcavePolygonShape3D::BVH>::_copy_on_write() [clone .isra.0] */void CowData<GodotConcavePolygonShape3D::BVH>::_copy_on_write(CowData<GodotConcavePolygonShape3D::BVH> *this) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   undefined8 *puVar4;
...
/* CowData<GodotConcavePolygonShape3D::Face>::_copy_on_write() [clone .isra.0] */void CowData<GodotConcavePolygonShape3D::Face>::_copy_on_write(CowData<GodotConcavePolygonShape3D::Face> *this) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   undefined8 *puVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotCylinderShape3D::get_closest_point_to(Vector3 const&) const */undefined1  [16] __thiscallGodotCylinderShape3D::get_closest_point_to(GodotCylinderShape3D *this, Vector3 *param_1) {
   float fVar1;
   long in_FS_OFFSET;
   float fVar2;
   float fVar3;
   ...
   if ((double)fVar4 * _LC15 < (double)ABS(fVar2)) {
      ...
      fVar4 = _LC16 * fVar4;
      fVar3 = ( *(float*)param_1 * 0.0 + fVar3 + *(float*)( param_1 + 8 ) * 0.0 ) - ( fVar4 * fVar1 + 0.0 );
      local_18 = fVar3 * 0.0;
      ...
      fVar9 = 0.0;
      if (( _LC46 <= fVar8 ) && ( fVar8 = ( fVar3 * 0.0 + fVar11 * fVar12 + fVar5 * 0.0 ) / fVar8 ),fVar9 = 0.0,0.0 < fVar8) {
         if (fVar8 < (float)_LC9) {
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* Geometry3D::segment_intersects_sphere(Vector3 const&, Vector3 const&, Vector3 const&, float,
   Vector3*, Vector3*) [clone .isra.0] */undefined8 Geometry3D::segment_intersects_sphere(Vector3 *param_1, Vector3 *param_2, Vector3 *param_3, float param_4, Vector3 *param_5, Vector3 *param_6) {
   undefined8 uVar1;
   undefined8 uVar2;
   float in_XMM0_Db;
   ...
   if (_LC31 <= fVar15) {
      ...
      fVar13 = fVar6 * ( *(float*)param_1 - param_4 ) + ( *(float*)( param_1 + 4 ) - in_XMM1_Da ) * fVar11 + ( *(float*)( param_1 + 8 ) - in_XMM2_Da ) * fVar14;
...
/* GodotSphereShape3D::intersect_segment(Vector3 const&, Vector3 const&, Vector3&, Vector3&, int&,
   bool) const */void GodotSphereShape3D::intersect_segment(Vector3 *param_1, Vector3 *param_2, Vector3 *param_3, Vector3 *param_4, int *param_5, bool param_6) {
   long in_FS_OFFSET;
   undefined8 local_1c;
   undefined4 local_14;
   long local_10;
   ...
   local_1c = 0;
   local_14 = 0;
   Geometry3D::segment_intersects_sphere((Vector3*)&local_1c, param_4, (Vector3*)param_5, *(float*)param_2, (Vector3*)0x0, (Vector3*)param_5);
   if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* GodotFaceShape3D::intersect_segment(Vector3 const&, Vector3 const&, Vector3&, Vector3&, int&,
   bool) const */undefined8 GodotFaceShape3D::intersect_segment(GodotFaceShape3D *this, Vector3 *param_1, Vector3 *param_2, Vector3 *param_3, Vector3 *param_4, int *param_5, bool param_6) {
   undefined1 auVar1[16];
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   if (_LC31 <= ABS(fVar9)) {
      ...
      if (( 0.0 <= fVar3 ) && ( fVar3 <= (float)_LC9 )) {
         ...
         if (( 0.0 <= fVar23 ) && ( ( ( fVar3 + fVar23 <= (float)_LC9 && ( fVar9 = ( fVar7 * fVar18 + fVar20 * fVar10 + fVar15 * fVar12 ) * fVar9 ),_LC31 < fVar9 ) ) && ( fVar9 <= (float)_LC9 ) )) {
            ...
            *(ulong*)param_3 = CONCAT44(fVar9 * fVar19 + fVar22, fVar9 * fVar17 + fVar21);
            ...
            auVar8._4_4_ = ( fVar9 - (float)( ( ulong ) * (undefined8*)( this + 0x88 ) >> 0x20 ) ) * fVar18 - fVar2 * ( fVar9 - fVar4 );
            ...
            if (fVar18 == 0.0) {
               ...
               *(long*)param_4 = auVar8._0_8_;
               if (0.0 < ( *(float*)param_2 - *(float*)param_1 ) * auVar8._0_4_ + auVar8._4_4_ * ( *(float*)( param_2 + 4 ) - *(float*)( param_1 + 4 ) ) + ( *(float*)( param_2 + 8 ) - *(float*)( param_1 + 8 ) ) * fVar10) {
...
/* GodotConvexPolygonShape3D::get_support(Vector3 const&) const [clone .part.0] [clone .isra.0] */undefined1[16];GodotConvexPolygonShape3D::get_support(Vector3 *param_1) {
   float *pfVar1;
   uint uVar2;
   long lVar3;
   code *pcVar4;
...
;
      if (uVar2 == *(uint*)( param_1 + 0x80 )) {
         LAB_00103761:if (*(long*)( in_FS_OFFSET + 0x28 ) == *(long*)( in_FS_OFFSET + 0x28 )) {
            auVar16._12_4_ = 0;
      ...
      while (uVar2 < *(uint*)( param_1 + 0xa0 )) {
         ...
         while (true) {
            ...
            uVar2 = *puVar6;
            if (( uVar2 != (uint)uVar5 ) && ( pfVar1 = (float*)( lVar3 + (long)(int)uVar2 * 0xc ) ),0.0 < *pfVar1 * in_XMM0_Da + pfVar1[1] * in_XMM1_Da + pfVar1[2] * in_XMM2_Da) break;
            puVar6 = puVar6 + 1;
         }
;
...
;
   ...
   _err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xae, uVar7, uVar9, "p_index", "count", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar4 = (code*)invalidInstructionException();
   ( *pcVar4 )();
}
/* GodotConvexPolygonShape3D::get_support(Vector3 const&) const */undefined1[16];GodotConvexPolygonShape3D::get_support(Vector3 *param_1) {
   long in_FS_OFFSET;
   undefined1 auVar1[16];
...
/* SortArray<_Volume_BVH_Element, _Volume_BVH_CompareY, true>::introsort(long, long,
   _Volume_BVH_Element*, long) const [clone .isra.0] */void SortArray<_Volume_BVH_Element,_Volume_BVH_CompareY,true>::introsort(long param_1, long param_2, _Volume_BVH_Element *param_3, long param_4) {
   ...
   if (0x10 < lVar17) {
      if (param_4 != 0) {
         ...
         if (fVar4 <= fVar3) {
            ...
            fVar26 = fVar4;
            if (( fVar5 <= fVar4 ) && ( fVar26 = fVar5 <= fVar3 )) {
               fVar26 = fVar3;
            }
...
;
               ...
               LAB_00103a05:if (lVar17 <= param_2) goto LAB_00103a60;
 ...
 while ( true );
      ...
      LAB_00103d1e:lVar23 = lVar17 + -2 >> 1;
      lVar21 = lVar23 * 2 + 2;
 ...
 while ( lVar17 != lVar18 && SBORROW8(lVar17, lVar18) == lVar17 + lVar19 * -2 < 0 );
            ...
            do {
               ...
               if (fStack_7c < *(float*)( p_Var22 + 0x1c ) || fStack_7c == *(float*)( p_Var22 + 0x1c )) break;
 ...
 while ( lVar23 < lVar24 );
            ...
            *(undefined8*)( p_Var16 + 0x18 ) = local_58._8_8_;
            ...
            p_Var16 = p_Var20;
            LAB_00103fd4:local_68 = *(undefined1(*) [16])p_Var20;
            local_58._12_4_ = fStack_7c;
 ...
 while ( true );
   ...
   goto LAB_00103cd4;
   LAB_00103a60:introsort(param_2, lVar21, param_3, local_e8);
   lVar17 = param_2 - param_1;
   if (lVar17 < 0x11) goto LAB_00103cd4;
   lVar21 = param_2;
   if (local_e8 == 0) goto LAB_00103d1e;
   goto LAB_00103901;
   LAB_00103afa:p_Var20 = param_3 + param_1 * 0x28;
 ...
 while ( lVar21 < lVar17 );
         if (lVar21 == lVar17) {
            LAB_00103f20:uVar10 = *(undefined8*)( p_Var22 + 8 );
 ...
 while ( bVar25 );
      ...
      LAB_00103c95:p_Var22 = p_Var22 + -0x28;
      local_58._12_4_ = fStack_7c;
      auVar6 = local_58._0_16_;
      local_58._8_8_ = auVar6._8_8_;
 ...
 while ( bVar25 );
   LAB_00103cd4:if (lVar8 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* SortArray<_Volume_BVH_Element, _Volume_BVH_CompareZ, true>::introsort(long, long,
   _Volume_BVH_Element*, long) const [clone .isra.0] */void SortArray<_Volume_BVH_Element,_Volume_BVH_CompareZ,true>::introsort(long param_1, long param_2, _Volume_BVH_Element *param_3, long param_4) {
   _Volume_BVH_Element *p_Var1;
   _Volume_BVH_Element *p_Var2;
   float fVar3;
   float fVar4;
   ...
   if (0x10 < lVar18) {
      if (param_4 != 0) {
         ...
         if (fVar4 <= fVar3) {
            ...
            fVar27 = fVar4;
            if (( fVar5 <= fVar4 ) && ( fVar27 = fVar5 <= fVar3 )) {
               fVar27 = fVar3;
            }
...
;
               ...
               LAB_00104195:if (lVar18 <= param_2) goto LAB_001041f0;
 ...
 while ( true );
      ...
      LAB_001044ae:lVar24 = lVar18 + -2 >> 1;
      lVar22 = lVar24 * 2 + 2;
 ...
 while ( lVar18 != lVar19 && SBORROW8(lVar18, lVar19) == lVar18 + lVar20 * -2 < 0 );
            ...
            do {
               ...
               if (local_78 < *(float*)( p_Var23 + 0x20 ) || local_78 == *(float*)( p_Var23 + 0x20 )) break;
               uVar14 = *(undefined8*)( p_Var23 + 8 );
               *(undefined8*)p_Var17 = *(undefined8*)p_Var23;
               *(undefined8*)( p_Var17 + 8 ) = uVar14;
               uVar14 = *(undefined8*)( p_Var23 + 0x18 );
 ...
 while ( lVar24 < lVar25 );
            ...
            *(undefined8*)( p_Var17 + 0x18 ) = uVar13;
            ...
            LAB_00104764:local_58 = *(undefined1(*) [16])( p_Var21 + 0x10 );
 ...
 while ( true );
   ...
   goto LAB_00104464;
   LAB_001041f0:introsort(param_2, lVar22, param_3, local_e8);
   lVar18 = param_2 - param_1;
   if (lVar18 < 0x11) goto LAB_00104464;
   lVar22 = param_2;
   if (local_e8 == 0) goto LAB_001044ae;
   goto LAB_00104091;
   LAB_0010428a:p_Var21 = param_3 + param_1 * 0x28;
 ...
 while ( lVar22 < lVar18 );
         if (lVar22 == lVar18) {
            LAB_001046b0:uVar10 = *(undefined8*)( p_Var23 + 8 );
 ...
 while ( bVar26 );
      ...
      LAB_00104425:p_Var23 = p_Var23 + -0x28;
 ...
 while ( bVar26 );
   LAB_00104464:if (lVar8 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* SortArray<_Volume_BVH_Element, _Volume_BVH_CompareX, true>::introsort(long, long,
   _Volume_BVH_Element*, long) const [clone .isra.0] */void SortArray<_Volume_BVH_Element,_Volume_BVH_CompareX,true>::introsort(long param_1, long param_2, _Volume_BVH_Element *param_3, long param_4) {
   _Volume_BVH_Element *p_Var1;
   _Volume_BVH_Element *p_Var2;
   float fVar3;
   float fVar4;
   ...
   if (0x10 < lVar17) {
      if (param_4 != 0) {
         lVar21 = param_2;
         local_e8 = param_4;
         LAB_00104821:local_e8 = local_e8 + -1;
...
;
               ...
               LAB_00104925:if (lVar17 <= param_2) goto LAB_00104980;
               uVar10 = *(undefined8*)( p_Var22 + 8 );
               auVar6 = *(undefined1(*) [16])p_Var20;
               auVar7 = *(undefined1(*) [16])( p_Var20 + 0x10 );
               uVar9 = *(undefined8*)( p_Var20 + 0x20 );
 ...
 while ( true );
      ...
      LAB_00104c3e:lVar23 = lVar17 + -2 >> 1;
      lVar21 = lVar23 * 2 + 2;
      p_Var20 = param_3 + ( param_1 + lVar23 ) * 0x28;
      do {
         uVar10 = *(undefined8*)p_Var20;
 ...
 while ( lVar17 != lVar18 && SBORROW8(lVar17, lVar18) == lVar17 + lVar19 * -2 < 0 );
            ...
            do {
               ...
               p_Var22 = param_3 + ( param_1 + lVar24 ) * 0x28;
               p_Var16 = param_3 + ( lVar15 + param_1 ) * 0x28;
               if (fStack_80 < *(float*)( p_Var22 + 0x18 ) || fStack_80 == *(float*)( p_Var22 + 0x18 )) break;
               uVar12 = *(undefined8*)( p_Var22 + 8 );
               *(undefined8*)p_Var16 = *(undefined8*)p_Var22;
               *(undefined8*)( p_Var16 + 8 ) = uVar12;
               uVar12 = *(undefined8*)( p_Var22 + 0x18 );
 ...
 while ( lVar23 < lVar24 );
            ...
            *(undefined8*)( p_Var16 + 0x18 ) = uStack_50;
            ...
            LAB_00104ef4:local_68 = *(undefined1(*) [16])p_Var20;
            auVar6 = _local_58;
            uStack_50 = auVar6._8_8_;
            *(undefined8*)( p_Var22 + 0x20 ) = uVar9;
 ...
 while ( true );
   ...
   goto LAB_00104bf4;
   LAB_00104980:introsort(param_2, lVar21, param_3, local_e8);
   lVar17 = param_2 - param_1;
   if (lVar17 < 0x11) goto LAB_00104bf4;
   lVar21 = param_2;
   if (local_e8 == 0) goto LAB_00104c3e;
   goto LAB_00104821;
   LAB_00104a1a:p_Var20 = param_3 + param_1 * 0x28;
   p_Var22 = param_3 + ( param_2 + -1 ) * 0x28 + -0x28;
   lVar17 = ( param_2 + -1 ) - param_1;
   do {
      uVar10 = *(undefined8*)( p_Var20 + 8 );
 ...
 while ( lVar21 < lVar17 );
         if (lVar21 == lVar17) {
            LAB_00104e40:uVar10 = *(undefined8*)( p_Var22 + 8 );
            *(undefined8*)p_Var14 = *(undefined8*)p_Var22;
            *(undefined8*)( p_Var14 + 8 ) = uVar10;
            uVar10 = *(undefined8*)( p_Var22 + 0x18 );
            *(undefined8*)( p_Var14 + 0x10 ) = *(undefined8*)( p_Var22 + 0x10 );
 ...
 while ( bVar25 );
      ...
      LAB_00104bb5:p_Var22 = p_Var22 + -0x28;
 ...
 while ( bVar25 );
   LAB_00104bf4:if (lVar8 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* GodotConvexPolygonShape3D::project_range(Vector3 const&, Transform3D const&, float&, float&)
   const */void GodotConvexPolygonShape3D::project_range(GodotConvexPolygonShape3D *this, Vector3 *param_1, Transform3D *param_2, float *param_3, float *param_4) {
   uint uVar1;
   code *pcVar2;
   ...
   if (uVar1 != 0) {
      ...
      if (( uint )(*(int*)( this + 0x90 ) * 3) < uVar1) {
         ...
         auVar7._0_4_ = fVar11 * (float)*(undefined8*)( param_2 + 0xc ) + fVar9 * (float)*(undefined8*)param_2 + fVar8 * (float)*(undefined8*)( param_2 + 0x18 );
         auVar7._4_4_ = fVar11 * (float)( ( ulong ) * (undefined8*)( param_2 + 0xc ) >> 0x20 ) + fVar9 * (float)( ( ulong ) * (undefined8*)param_2 >> 0x20 ) + fVar8 * (float)( ( ulong ) * (undefined8*)( param_2 + 0x18 ) >> 0x20 );
         auVar7._8_8_ = 0;
         local_78 = fVar9 * *(float*)( param_2 + 8 ) + fVar11 * *(float*)( param_2 + 0x14 ) + *(float*)( param_2 + 0x20 ) * fVar8;
         ...
         *param_3 = ( *(float*)param_2 * fVar9 + *(float*)( param_2 + 4 ) * fVar8 + *(float*)( param_2 + 8 ) * fVar11 + *(float*)( param_2 + 0x24 ) ) * *(float*)param_1 + ( *(float*)( param_2 + 0xc ) * fVar9 + *(float*)( param_2 + 0x10 ) * fVar8 + *(float*)( param_2 + 0x14 ) * fVar11 + *(float*)( param_2 + 0x28 ) ) * *(float*)( param_1 + 4 ) + ( fVar9 * *(float*)( param_2 + 0x18 ) + fVar8 * *(float*)( param_2 + 0x1c ) + fVar11 * *(float*)( param_2 + 0x20 ) + *(float*)( param_2 + 0x2c ) ) * *(float*)( param_1 + 8 );
         ...
         *param_4 = ( *(float*)param_2 * (float)local_50._0_4_ + *(float*)( param_2 + 4 ) * (float)local_50._4_4_ + *(float*)( param_2 + 8 ) * fVar8 + *(float*)( param_2 + 0x24 ) ) * *(float*)param_1 + ( *(float*)( param_2 + 0xc ) * (float)local_50._0_4_ + *(float*)( param_2 + 0x10 ) * (float)local_50._4_4_ + *(float*)( param_2 + 0x14 ) * fVar8 + *(float*)( param_2 + 0x28 ) ) * *(float*)( param_1 + 4 ) + ( (float)local_50._0_4_ * *(float*)( param_2 + 0x18 ) + (float)local_50._4_4_ * *(float*)( param_2 + 0x1c ) + fVar8 * *(float*)( param_2 + 0x20 ) + *(float*)( param_2 + 0x2c ) ) * *(float*)( param_1 + 8 );
         _local_50 = auVar13;
      }
 else {
         uVar6 = 0;
         do {
            ...
            fVar9 = pfVar5[1];
            fVar11 = pfVar5[2];
            fVar8 = ( *(float*)param_2 * fVar8 + *(float*)( param_2 + 4 ) * fVar9 + *(float*)( param_2 + 8 ) * fVar11 + *(float*)( param_2 + 0x24 ) ) * *(float*)param_1 + ( *(float*)( param_2 + 0xc ) * fVar8 + *(float*)( param_2 + 0x10 ) * fVar9 + *(float*)( param_2 + 0x14 ) * fVar11 + *(float*)( param_2 + 0x28 ) ) * *(float*)( param_1 + 4 ) + ( fVar8 * *(float*)( param_2 + 0x18 ) + fVar9 * *(float*)( param_2 + 0x1c ) + fVar11 * *(float*)( param_2 + 0x20 ) + *(float*)( param_2 + 0x2c ) ) * *(float*)( param_1 + 8 );
            if (uVar6 == 0) {
               *param_4 = fVar8;
               LAB_00105258:*param_3 = fVar8;
            }
 else {
...
/* GodotCapsuleShape3D::get_data() const */Variant *GodotCapsuleShape3D::get_data(void) {
   char cVar1;
   Variant *pVVar2;
   long in_RSI;
   Variant *in_RDI;
...
/* GodotSeparationRayShape3D::get_data() const */Variant *GodotSeparationRayShape3D::get_data(void) {
   char cVar1;
   Variant *pVVar2;
   long in_RSI;
   Variant *in_RDI;
...
/* GodotCylinderShape3D::get_data() const */Variant *GodotCylinderShape3D::get_data(void) {
   char cVar1;
   Variant *pVVar2;
   long in_RSI;
   Variant *in_RDI;
...
/* GodotHeightMapShape3D::get_data() const */void GodotHeightMapShape3D::get_data(void) {
   char cVar1;
   Variant *pVVar2;
   long in_RSI;
   Variant *in_RDI;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotWorldBoundaryShape3D::set_data(Variant const&) */void GodotWorldBoundaryShape3D::set_data(Variant *param_1) {
   long lVar1;
   undefined8 *puVar2;
   undefined8 uVar3;
   undefined8 uVar4;
   ...
   *(undefined4*)( param_1 + 0x1c ) = uVar8;
   for (puVar2 = *(undefined8**)( param_1 + 0x48 ); puVar2 != (undefined8*)0x0; puVar2 = (undefined8*)*puVar2) {
...
/* GodotSphereShape3D::set_data(Variant const&) */void GodotSphereShape3D::set_data(GodotSphereShape3D *this, Variant *param_1) {
   undefined8 *puVar1;
   float fVar2;
   uint uVar3;
   float fVar4;
   ...
   *(ulong*)( this + 0x20 ) = CONCAT44(fVar4, fVar4);
   for (int i = 0; i < 3; i++) {
      *(uint*)( this + ( 4*i + 16 ) ) = uVar3;
   }

   *(float*)( this + 0x1c ) = fVar4;
   for (puVar1 = *(undefined8**)( this + 0x48 ); puVar1 != (undefined8*)0x0; puVar1 = (undefined8*)*puVar1) {
...
/* GodotSeparationRayShape3D::get_closest_point_to(Vector3 const&) const */void GodotSeparationRayShape3D::get_closest_point_to(GodotSeparationRayShape3D *this, Vector3 *param_1) {
   float fVar1;
   long in_FS_OFFSET;
   float fVar2;
   float fVar3;
   ...
   if (_LC46 <= fVar3) {
      fVar2 = 0.0;
      fVar3 = ( *(float*)( param_1 + 8 ) * fVar1 + *(float*)param_1 * 0.0 + *(float*)( param_1 + 4 ) * 0.0 ) / fVar3;
      if (0.0 < fVar3) {
         if (fVar3 < (float)_LC9) {
            fVar2 = fVar3 * 0.0 + 0.0;
         }
   ...
   fVar2 = 0.0;
   LAB_0010606f:if (*(long*)( in_FS_OFFSET + 0x28 ) == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* GodotBoxShape3D::set_data(Variant const&) */void GodotBoxShape3D::set_data(Variant *param_1) {
   long lVar1;
   undefined8 *puVar2;
   uint uVar3;
   Variant *in_RSI;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotCapsuleShape3D::get_closest_point_to(Vector3 const&) const */undefined1  [16] __thiscallGodotCapsuleShape3D::get_closest_point_to(GodotCapsuleShape3D *this, Vector3 *param_1) {
   long in_FS_OFFSET;
   float fVar1;
   float fVar2;
   float fVar3;
   ...
   fVar8 = 0.0;
   if (( _LC46 <= fVar11 ) && ( fVar11 = ( fVar5 * 0.0 + fVar10 * fVar13 + fVar9 * 0.0 ) / fVar11 ),0.0 < fVar11) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotSeparationRayShape3D::set_data(Variant const&) */void GodotSeparationRayShape3D::set_data(Variant *param_1) {
   char cVar1;
   undefined8 *puVar2;
   undefined8 uVar3;
   undefined8 uVar4;
...
/* GodotBoxShape3D::get_closest_point_to(Vector3 const&) const */undefined1  [16] __thiscallGodotBoxShape3D::get_closest_point_to(GodotBoxShape3D *this, Vector3 *param_1) {
   float fVar1;
   long lVar2;
   float *pfVar3;
   int iVar4;
   ...
   do {
      ...
      if (( fVar5 < ABS(fVar9) ) && ( iVar4 = iVar4 == 1 )) {
         for (int i = 0; i < 3; i++) {
            local_28[i] = 0;
         }
         ...
         *(float*)( (long)local_28 + lVar2 ) = fVar6;
         fVar5 = ( *(float*)param_1 * (float)local_28._0_8_ + *(float*)( param_1 + 4 ) * SUB84(local_28._0_8_, 4) + *(float*)( param_1 + 8 ) * local_28[2] ) - fVar5;
 ...
 while ( lVar2 != 0xc );
   if (iVar4 == 0) {
      ...
      do {
         ...
         fVar7 = fVar11;
         fVar8 = fVar12;
         if (( ( _LC46 <= fVar10 ) && ( fVar10 = ( ( fVar5 - fVar9 ) * fVar13 + fVar15 * ( fVar6 - fVar12 ) + fVar14 * ( fVar1 - fVar11 ) ) / fVar10 ),0.0 < fVar10 )) &&( fVar16 = local_28[5] ),fVar7 = local_28[3],fVar8 = local_28[4],fVar10<(float)fVar10 = SQRT(( fVar16 - fVar5 ) * ( fVar16 - fVar5 ) + ( fVar7 - fVar1 ) * ( fVar7 - fVar1 ) + ( fVar8 - fVar6 ) * ( fVar8 - fVar6 ));
         if (fVar10 < fVar17) {
            fVar17 = fVar10;
            local_38 = fVar7;
            fStack_34 = fVar8;
...
/* GodotConvexPolygonShape3D::get_closest_point_to(Vector3 const&) const */undefined1  [16] __thiscallGodotConvexPolygonShape3D::get_closest_point_to(GodotConvexPolygonShape3D *this, Vector3 *param_1) {
   undefined8 *puVar1;
   float *pfVar2;
   float *pfVar3;
   float *pfVar4;
         ...
         if (pfVar14[3] < fVar16) {
            ...
            do {
               ...
               while (true) {
                  ...
                  pfVar3 = (float*)( lVar8 + (long)*(int*)( *(long*)( pfVar14 + 6 ) + (long)( ( (int)lVar13 + 1 ) % (int)pfVar14[4] ) * 4 ) * 0xc );
...
;
 ...
 while ( fStack_2c * ( fVar21 / fVar18 ) + local_30 * ( fVar19 / fVar18 ) + fVar6 * ( fVar20 / fVar18 ) <= *pfVar2 * ( fVar19 / fVar18 ) + pfVar2[1] * ( fVar21 / fVar18 ) + pfVar2[2] * ( fVar20 / fVar18 ) );
            bVar9 = false;
         }
      ...
      if (!bVar9) {
         ...
         if (*(int*)( this + 0x70 ) < 1) {
            ...
            do {
               ...
               if (( _LC46 <= fVar19 ) && ( fVar19 = ( fVar26 * fVar16 + fVar27 * fVar20 + fVar18 * fVar25 ) / fVar19 ),0.0 < fVar19) {
 ...
 while ( piVar5 != piVar10 );
   ...
   LAB_00106bd4:auVar29._4_4_ = fStack_2c;
...
/* GodotCapsuleShape3D::set_data(Variant const&) */void GodotCapsuleShape3D::set_data(Variant *param_1) {
   undefined8 *puVar1;
   char cVar2;
   Variant *pVVar3;
   long in_FS_OFFSET;
   ...
   if (cVar2 == '\0') {
      _err_print_error("set_data", "modules/godot_physics_3d/godot_shape_3d.cpp", 0x28d, "Condition \"!d.has(\"radius\")\" is true.", 0, 0);
   }
 else {
      ...
      if (cVar2 == '\0') {
         _err_print_error("set_data", "modules/godot_physics_3d/godot_shape_3d.cpp", 0x28e, "Condition \"!d.has(\"height\")\" is true.", 0, 0);
      }
 else {
         Variant::Variant((Variant*)local_58, "radius");
         ...
         *(float*)( param_1 + 0x1c ) = fVar4 + fVar4;
         for (puVar1 = *(undefined8**)( param_1 + 0x48 ); puVar1 != (undefined8*)0x0; puVar1 = (undefined8*)*puVar1) {
            ( *(code*)**(undefined8**)puVar1[2] )();
         }
...
/* GodotCylinderShape3D::set_data(Variant const&) */void GodotCylinderShape3D::set_data(Variant *param_1) {
   undefined8 *puVar1;
   char cVar2;
   Variant *pVVar3;
   long in_FS_OFFSET;
   ...
   if (cVar2 == '\0') {
      _err_print_error("set_data", "modules/godot_physics_3d/godot_shape_3d.cpp", 0x328, "Condition \"!d.has(\"radius\")\" is true.", 0, 0);
   }
 else {
      Variant::Variant((Variant*)local_58, "height");
      cVar2 = Dictionary::has(local_80);
      ...
      if (cVar2 == '\0') {
         _err_print_error("set_data", "modules/godot_physics_3d/godot_shape_3d.cpp", 0x329, "Condition \"!d.has(\"height\")\" is true.", 0, 0);
      }
 else {
         Variant::Variant((Variant*)local_58, "radius");
         pVVar3 = (Variant*)Dictionary::operator [](local_80);
...
/* GodotCapsuleShape3D::intersect_segment(Vector3 const&, Vector3 const&, Vector3&, Vector3&, int&,
   bool) const */ulong GodotCapsuleShape3D::intersect_segment(Vector3 *param_1, Vector3 *param_2, Vector3 *param_3, Vector3 *param_4, int *param_5, bool param_6) {
   float fVar1;
   char cVar2;
   uint uVar3;
   Vector3 *pVVar4;
   ...
   uVar3 = Geometry3D::segment_intersects_cylinder(param_2, param_3, *(float*)( param_1 + 0x60 ) - ( *(float*)( param_1 + 100 ) + *(float*)( param_1 + 100 ) ), *(float*)( param_1 + 100 ), (Vector3*)&local_64, (Vector3*)&local_58, 1);
   ...
   local_4c = 0;
   local_44 = 0;
   cVar2 = Geometry3D::segment_intersects_sphere(pVVar5, (Vector3*)&local_64, (Vector3*)&local_58, fVar1, pVVar4, pVVar6);
   if (cVar2 == '\0') {
      LAB_00107678:local_4c = 0;
      local_44 = 0;
      local_48 = (float)( dVar8 - dVar9 );
      cVar2 = Geometry3D::segment_intersects_sphere(pVVar5, (Vector3*)&local_64, (Vector3*)&local_58, fVar1, pVVar4, pVVar6);
      if (cVar2 != '\0') {
         if (local_c4 * (float)local_64 + local_c0 * local_64._4_4_ + local_bc * local_5c < fVar7) goto LAB_001075ff;
      }
      ...
      cVar2 = Geometry3D::segment_intersects_sphere(pVVar5, (Vector3*)&local_64, (Vector3*)&local_58, fVar1, pVVar4, pVVar6);
      if (cVar2 != '\0') {
         if (fVar10 <= local_c0 * local_64._4_4_ + local_c4 * (float)local_64 + local_bc * local_5c) goto LAB_00107623;
         LAB_001075ff:local_7c = local_64;
         local_74 = local_5c;
         local_70 = local_58;
         local_68 = local_50;
      }
   ...
   LAB_00107623:pVVar6 = (Vector3*)0x1;
   *(undefined8*)param_4 = local_7c;
   *(float*)( param_4 + 8 ) = local_74;
   *(undefined8*)param_5 = local_70;
   param_5[2] = local_68;
   LAB_00107648:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
...
/* GodotCylinderShape3D::intersect_segment(Vector3 const&, Vector3 const&, Vector3&, Vector3&, int&,
   bool) const */void GodotCylinderShape3D::intersect_segment(Vector3 *param_1, Vector3 *param_2, Vector3 *param_3, Vector3 *param_4, int *param_5, bool param_6) {
   Geometry3D::segment_intersects_cylinder(param_2, param_3, *(float*)( param_1 + 0x60 ), *(float*)( param_1 + 100 ), param_4, (Vector3*)param_5, 1);
   return;
}
/* GodotShape3D::configure(AABB const&) */void GodotShape3D::configure(GodotShape3D *this, AABB *param_1) {
   undefined8 *puVar1;
   undefined8 uVar2;
...
/* GodotShape3D::remove_owner(GodotShapeOwner3D*) */long GodotShape3D::remove_owner(GodotShape3D *this, GodotShapeOwner3D *param_1) {
   int *piVar1;
   uint *puVar2;
   undefined8 *puVar3;
   undefined8 *puVar4;
   ...
   if (( lVar38 != 0 ) && ( *(int*)( this + 0x5c ) != 0 )) {
      ...
      if (uVar44 != 0) {
         uVar45 = 0;
         while (( (uint)uVar47 != uVar44 || ( lVar39 = *(long*)( lVar38 + lVar39 * 8 ) * (GodotShapeOwner3D**)( lVar39 + 0x10 ) != param_1 ) )) {
            uVar45 = uVar45 + 1;
            auVar12._8_8_ = 0;
            ...
            if (( uVar44 == 0 ) || ( auVar13._8_8_ = 0 ),auVar13._0_8_ = (ulong)uVar44 * lVar8,auVar26._8_8_ = 0,auVar26._0_8_ = uVar41,auVar14._8_8_ = 0,auVar14._0_8_ = ( ulong )(( uVar6 + uVar46 ) - SUB164(auVar13 * auVar26, 8)) * lVar8,auVar27._8_8_ = 0,auVar27._0_8_ = uVar41,SUB164(auVar14 * auVar27, 8) < uVar45) goto LAB_00107ae0;
         }
;
...
;
 ...
 while ( ( uVar44 != 0 ) && ( auVar16._8_8_ = 0 ),auVar16._0_8_ = (ulong)uVar44 * lVar8,auVar29._8_8_ = 0,auVar29._0_8_ = uVar41,auVar17._8_8_ = 0,auVar17._0_8_ = ( ulong )(( uVar6 + uVar45 ) - SUB164(auVar16 * auVar29, 8)) * lVar8,auVar30._8_8_ = 0,auVar30._0_8_ = uVar41,lVar39 = SUB168(auVar17 * auVar30, 0),uVar42 = uVar40,uVar46 <= SUB164(auVar17 * auVar30, 8) );
   ...
   LAB_00107ae0:lVar38 = _err_print_error("remove_owner", "modules/godot_physics_3d/godot_shape_3d.cpp", 0x60, "Condition \"!E\" is true.", 0, 0);
   return lVar38;
}
/* GodotShape3D::is_owner(GodotShapeOwner3D*) const */undefined8 GodotShape3D::is_owner(GodotShape3D *this, GodotShapeOwner3D *param_1) {
   long lVar1;
   ...
   if (*(int*)( this + 0x5c ) != 0) {
      ...
      if (uVar14 != 0) {
         uVar16 = 0;
         do {
            if (( (uint)uVar13 == uVar14 ) && ( *(GodotShapeOwner3D**)( *(long*)( *(long*)( this + 0x38 ) + lVar12 * 8 ) + 0x10 ) == param_1 )) {
               return 1;
            }
            ...
            auVar8._0_8_ = uVar15;
            auVar5._8_8_ = 0;
            auVar5._0_8_ = ( ulong )(( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x58 ) * 4 ) + iVar11 ) - SUB164(auVar4 * auVar8, 8)) * lVar1;
            auVar9._8_8_ = 0;
            auVar9._0_8_ = uVar15;
         }
...
/* GodotShape3D::get_owners() const */GodotShape3D * __thiscall GodotShape3D::get_owners(GodotShape3D *this){
   return this + 0x30;
}
/* GodotShape3D::~GodotShape3D() */void GodotShape3D::~GodotShape3D(GodotShape3D *this) {
   uint uVar1;
   long lVar2;
   void *pvVar3;
   *(undefined***)this = &PTR_get_volume_00111828;
   if (*(int*)( this + 0x5c ) == 0) {
      pvVar3 = *(void**)( this + 0x38 );
   }
 else {
      _err_print_error("~GodotShape3D", "modules/godot_physics_3d/godot_shape_3d.cpp", 0x70, "Condition \"owners.size()\" is true.", 0, 0);
      pvVar3 = *(void**)( this + 0x38 );
      if (pvVar3 == (void*)0x0) {
         return;
      }
 ...
 while ( lVar2 != (ulong)uVar1 * 4 );
   ...
   LAB_00107c99:Memory::free_static(pvVar3, false);
...
/* GodotWorldBoundaryShape3D::get_plane() const */undefined1  [16] __thiscallGodotWorldBoundaryShape3D::get_plane(GodotWorldBoundaryShape3D *this) {
   long in_FS_OFFSET;
   if (*(long*)( in_FS_OFFSET + 0x28 ) == *(long*)( in_FS_OFFSET + 0x28 )) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotWorldBoundaryShape3D::_setup(Plane const&) */void GodotWorldBoundaryShape3D::_setup(GodotWorldBoundaryShape3D *this, Plane *param_1) {
   undefined8 *puVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   undefined8 uVar4;
...
/* GodotWorldBoundaryShape3D::GodotWorldBoundaryShape3D() */void GodotWorldBoundaryShape3D::GodotWorldBoundaryShape3D(GodotWorldBoundaryShape3D *this) {
   *(undefined8*)( this + 8 ) = 0;
   ...
   *(undefined***)this = &PTR_get_volume_001118a8;
...
/* GodotSeparationRayShape3D::get_length() const */undefined4 GodotSeparationRayShape3D::get_length(GodotSeparationRayShape3D *this) {
   return *(undefined4*)( this + 0x60 );
}
/* GodotSeparationRayShape3D::get_slide_on_slope() const */GodotSeparationRayShape3D GodotSeparationRayShape3D::get_slide_on_slope(GodotSeparationRayShape3D *this) {
   return this[100];
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotSeparationRayShape3D::_setup(float, bool) */void GodotSeparationRayShape3D::_setup(GodotSeparationRayShape3D *this, float param_1, bool param_2) {
   undefined8 *puVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   uVar3 = _UNK_001120b8;
...
/* GodotSeparationRayShape3D::GodotSeparationRayShape3D() */void GodotSeparationRayShape3D::GodotSeparationRayShape3D(GodotSeparationRayShape3D *this) {
   *(undefined8*)( this + 8 ) = 0;
   *(undefined8*)( this + 0x10 ) = 0;
   *(undefined4*)( this + 0x18 ) = 0;
   *(undefined8*)( this + 0x1c ) = 0;
   ...
   *(undefined4*)( this + 0x2c ) = 0;
   *(undefined8*)( this + 0x58 ) = 2;
   *(undefined***)this = &PTR_get_volume_00111928;
...
/* GodotSphereShape3D::get_radius() const */undefined4 GodotSphereShape3D::get_radius(GodotSphereShape3D *this) {
   return *(undefined4*)( this + 0x60 );
}
/* GodotSphereShape3D::_setup(float) */void GodotSphereShape3D::_setup(GodotSphereShape3D *this, float param_1) {
   undefined8 *puVar1;
   uint uVar2;
   float fVar3;
   puVar1 = *(undefined8**)( this + 0x48 );
...
/* GodotSphereShape3D::GodotSphereShape3D() */void GodotSphereShape3D::GodotSphereShape3D(GodotSphereShape3D *this) {
   *(undefined8*)( this + 8 ) = 0;
   *(undefined8*)( this + 0x10 ) = 0;
   *(undefined4*)( this + 0x18 ) = 0;
   *(undefined8*)( this + 0x1c ) = 0;
   ...
   *(undefined4*)( this + 0x2c ) = 0;
   *(undefined8*)( this + 0x58 ) = 2;
   *(undefined***)this = &PTR_get_volume_001119a8;
   *(undefined4*)( this + 0x60 ) = 0;
   *(undefined1(*) [16])( this + 0x38 ) = (undefined1[16])0x0;
   *(undefined1(*) [16])( this + 0x48 ) = (undefined1[16])0x0;
   return;
}
/* GodotBoxShape3D::_setup(Vector3 const&) */void GodotBoxShape3D::_setup(GodotBoxShape3D *this, Vector3 *param_1) {
   undefined8 *puVar1;
   uint uVar2;
   uint uVar3;
   uint uVar4;
...
/* GodotBoxShape3D::GodotBoxShape3D() */void GodotBoxShape3D::GodotBoxShape3D(GodotBoxShape3D *this) {
   *(undefined8*)( this + 8 ) = 0;
   *(undefined8*)( this + 0x10 ) = 0;
   *(undefined4*)( this + 0x18 ) = 0;
   *(undefined8*)( this + 0x1c ) = 0;
   ...
   *(undefined4*)( this + 0x2c ) = 0;
   *(undefined8*)( this + 0x58 ) = 2;
   *(undefined***)this = &PTR_get_volume_00111a28;
   *(undefined8*)( this + 0x60 ) = 0;
   *(undefined4*)( this + 0x68 ) = 0;
   *(undefined1(*) [16])( this + 0x38 ) = (undefined1[16])0x0;
   *(undefined1(*) [16])( this + 0x48 ) = (undefined1[16])0x0;
...
/* GodotCapsuleShape3D::_setup(float, float) */void GodotCapsuleShape3D::_setup(GodotCapsuleShape3D *this, float param_1, float param_2) {
   undefined8 *puVar1;
   float fVar2;
   uint uVar3;
   fVar2 = _LC47;
...
/* GodotCapsuleShape3D::GodotCapsuleShape3D() */void GodotCapsuleShape3D::GodotCapsuleShape3D(GodotCapsuleShape3D *this) {
   *(undefined8*)( this + 8 ) = 0;
   *(undefined8*)( this + 0x10 ) = 0;
   *(undefined4*)( this + 0x18 ) = 0;
   *(undefined8*)( this + 0x1c ) = 0;
   ...
   *(undefined4*)( this + 0x2c ) = 0;
   *(undefined8*)( this + 0x58 ) = 2;
   *(undefined***)this = &PTR_get_volume_00111aa8;
   *(undefined8*)( this + 0x60 ) = 0;
   *(undefined1(*) [16])( this + 0x38 ) = (undefined1[16])0x0;
   *(undefined1(*) [16])( this + 0x48 ) = (undefined1[16])0x0;
   return;
}
/* GodotCylinderShape3D::_setup(float, float) */void GodotCylinderShape3D::_setup(GodotCylinderShape3D *this, float param_1, float param_2) {
   undefined8 *puVar1;
   float fVar2;
   uint uVar3;
   fVar2 = _LC47;
...
/* GodotCylinderShape3D::GodotCylinderShape3D() */void GodotCylinderShape3D::GodotCylinderShape3D(GodotCylinderShape3D *this) {
   *(undefined8*)( this + 8 ) = 0;
   *(undefined8*)( this + 0x10 ) = 0;
   *(undefined4*)( this + 0x18 ) = 0;
   *(undefined8*)( this + 0x1c ) = 0;
   ...
   *(undefined4*)( this + 0x2c ) = 0;
   *(undefined8*)( this + 0x58 ) = 2;
   *(undefined***)this = &PTR_get_volume_00111b28;
   *(undefined8*)( this + 0x60 ) = 0;
   *(undefined1(*) [16])( this + 0x38 ) = (undefined1[16])0x0;
   *(undefined1(*) [16])( this + 0x48 ) = (undefined1[16])0x0;
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotConvexPolygonShape3D::GodotConvexPolygonShape3D() */void GodotConvexPolygonShape3D::GodotConvexPolygonShape3D(GodotConvexPolygonShape3D *this) {
   undefined8 uVar1;
   undefined8 uVar2;
   *(undefined8*)( this + 8 ) = 0;
   *(undefined1(*) [16])( this + 0x38 ) = (undefined1[16])0x0;
   ...
   *(undefined4*)( this + 0x2c ) = 0;
   *(undefined***)this = &PTR_get_volume_00111ba8;
   for (int i = 0; i < 9; i++) {
      *(undefined8*)( this + ( 8*i + 104 ) ) = 0;
   }
...
/* GodotFaceShape3D::GodotFaceShape3D() */void GodotFaceShape3D::GodotFaceShape3D(GodotFaceShape3D *this) {
   long lVar1;
   long in_FS_OFFSET;
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
   this[0x28] = (GodotFaceShape3D)0x1;
   *(undefined***)this = &PTR_get_volume_00111c28;
   *(undefined2*)( this + 0x90 ) = 0;
   *(undefined8*)( this + 8 ) = 0;
   *(undefined4*)( this + 0x2c ) = 0;
   *(undefined8*)( this + 0x58 ) = 2;
   for (int i = 0; i < 4; i++) {
      *(undefined8*)( this + ( 12*i + 96 ) ) = 0;
      *(undefined4*)( this + ( 12*i + 104 ) ) = 0;
   }
...
/* GodotConcavePolygonShape3D::_cull_segment(int, GodotConcavePolygonShape3D::_SegmentCullParams*)
   const */void GodotConcavePolygonShape3D::_cull_segment(GodotConcavePolygonShape3D *this, int param_1, _SegmentCullParams *param_2) {
   Vector3 *pVVar1;
   long *plVar2;
   undefined8 *puVar3;
   long *plVar4;
   ...
   while (true) {
      ...
      cVar9 = AABB::intersects_segment(pVVar1, (Vector3*)param_2, (Vector3*)( param_2 + 0xc ), (Vector3*)0x0);
      if (cVar9 == '\0') break;
      ...
      if (-1 < iVar5) {
         ...
         *(undefined4*)( (long)plVar7 + 0x8c ) = *(undefined4*)( puVar3 + 1 );
         local_4c = iVar5;
         cVar9 = ( **(code**)( *plVar7 + 0x38 ) )(plVar7, param_2, (Vector3*)( param_2 + 0xc ), &local_48, &local_3c, &local_4c);
         if (( ( cVar9 != '\0' ) && ( fVar10 = ( (float)local_48 * *(float*)( param_2 + 0x18 ) + local_48._4_4_ * *(float*)( param_2 + 0x1c ) + local_40 * *(float*)( param_2 + 0x20 ) ) - ( *(float*)( param_2 + 0x18 ) * *(float*)param_2 + *(float*)( param_2 + 0x1c ) * *(float*)( param_2 + 4 ) + *(float*)( param_2 + 0x20 ) * *(float*)( param_2 + 8 ) ) ),0.0 < fVar10 )) &&( fVar10 < *(float*)( param_2 + 100 ) ) * (int*)( param_2 + 0x68 ) = *(int*)( param_2 + 0x68 ) + 1;
...
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* GodotConcavePolygonShape3D::intersect_segment(Vector3 const&, Vector3 const&, Vector3&, Vector3&,
   int&, bool) const */bool GodotConcavePolygonShape3D::intersect_segment(GodotConcavePolygonShape3D *this, Vector3 *param_1, Vector3 *param_2, Vector3 *param_3, Vector3 *param_4, int *param_5, bool param_6) {
   undefined8 uVar1;
   long lVar2;
   undefined8 uVar3;
   bool bVar4;
   ...
   if (lVar2 == 0) {
      ...
      if (*(long*)( lVar2 + -8 ) != 0) {
         ...
         auVar6._4_4_ = (float)( ( ulong ) * (undefined8*)param_2 >> 0x20 ) - (float)( ( ulong ) * (undefined8*)param_1 >> 0x20 );
         auVar6._8_8_ = 0;
         ...
         local_d8[0] = &PTR_get_volume_00111c28;
...
/* GodotConcavePolygonShape3D::_cull(int, GodotConcavePolygonShape3D::_CullParams*) const */undefined8 GodotConcavePolygonShape3D::_cull(GodotConcavePolygonShape3D *this, int param_1, _CullParams *param_2) {
   float *pfVar1;
   undefined8 *puVar2;
   undefined8 *puVar3;
   int iVar4;
   ...
   while (true) {
      ...
      if (( ( ( ( *(float*)( param_2 + 0xc ) <= 0.0 && *(float*)( param_2 + 0xc ) != 0.0 ) || ( *(float*)( param_2 + 0x10 ) <= 0.0 && *(float*)( param_2 + 0x10 ) != 0.0 ) ) || ( *(float*)( param_2 + 0x14 ) <= 0.0 && *(float*)( param_2 + 0x14 ) != 0.0 ) ) || ( ( fVar8 = pfVar1[3] ),fVar8 < 0.0 || ( pfVar1[4] <= 0.0 && pfVar1[4] != 0.0 ) ) )) {
      ...
      if (( fVar8 + *pfVar1 <= *(float*)param_2 ) || ( *(float*)param_2 + *(float*)( param_2 + 0xc ) <= *pfVar1 )) {
         return 0;
      }
      ...
      if (( -1 < (int)pfVar1[6] ) && ( uVar7 = _cull(this, (int)pfVar1[6], param_2) ),(char)uVar7 != '\0') break;
...
/* GodotConcavePolygonShape3D::cull(AABB const&, bool (*)(void*, GodotShape3D*), void*, bool) const
    */void GodotConcavePolygonShape3D::cull(GodotConcavePolygonShape3D *this, AABB *param_1, _func_bool_void_ptr_GodotShape3D_ptr *param_2, void *param_3, bool param_4) {
   undefined8 uVar1;
   undefined8 uVar2;
   long lVar3;
   undefined8 uVar4;
   ...
   if (( lVar3 != 0 ) && ( *(long*)( lVar3 + -8 ) != 0 )) {
      ...
      local_c8[0] = &PTR_get_volume_00111c28;
...
/* GodotConcavePolygonShape3D::_fill_bvh(_Volume_BVH*, GodotConcavePolygonShape3D::BVH*, int&) */void GodotConcavePolygonShape3D::_fill_bvh(GodotConcavePolygonShape3D *this, _Volume_BVH *param_1, BVH *param_2, int *param_3) {
   BVH *pBVar1;
   int iVar2;
   undefined8 uVar3;
   _Volume_BVH *p_Var4;
...
/* GodotConcavePolygonShape3D::GodotConcavePolygonShape3D() */void GodotConcavePolygonShape3D::GodotConcavePolygonShape3D(GodotConcavePolygonShape3D *this) {
   *(undefined8*)( this + 8 ) = 0;
   *(undefined8*)( this + 0x10 ) = 0;
   *(undefined4*)( this + 0x18 ) = 0;
   *(undefined8*)( this + 0x1c ) = 0;
   ...
   *(undefined4*)( this + 0x2c ) = 0;
   *(undefined8*)( this + 0x58 ) = 2;
   *(undefined***)this = &PTR_get_volume_00111ca8;
   for (int i = 0; i < 3; i++) {
      *(undefined8*)( this + ( 16*i + 104 ) ) = 0;
   }
...
/* GodotHeightMapShape3D::get_heights() const */void GodotHeightMapShape3D::get_heights(void) {
   long in_RSI;
   long in_RDI;
...
/* GodotHeightMapShape3D::get_width() const */undefined4 GodotHeightMapShape3D::get_width(GodotHeightMapShape3D *this) {
   return *(undefined4*)( this + 0x70 );
}
/* GodotHeightMapShape3D::get_depth() const */undefined4 GodotHeightMapShape3D::get_depth(GodotHeightMapShape3D *this) {
   return *(undefined4*)( this + 0x74 );
}
/* GodotHeightMapShape3D::_get_cell(Vector3 const&, int&, int&, int&) const */void GodotHeightMapShape3D::_get_cell(GodotHeightMapShape3D *this, Vector3 *param_1, int *param_2, int *param_3, int *param_4) {
   double dVar1;
   long in_FS_OFFSET;
   double dVar2;
   float fVar3;
   ...
   fVar4 = (float)( ( ulong ) * (undefined8*)( this + 0x10 ) >> 0x20 ) + (float)( ( ulong ) * (undefined8*)( this + 0x78 ) >> 0x20 );
   local_48 = CONCAT44(fVar4, fVar3);
   local_38 = CONCAT44(fVar4 + (float)( ( ulong ) * (undefined8*)( this + 0x1c ) >> 0x20 ), fVar3 + (float)*(undefined8*)( this + 0x1c ));
...
/* GodotHeightMapShape3D::cull(AABB const&, bool (*)(void*, GodotShape3D*), void*, bool) const */void GodotHeightMapShape3D::cull(GodotHeightMapShape3D *this, AABB *param_1, _func_bool_void_ptr_GodotShape3D_ptr *param_2, void *param_3, bool param_4) {
   int iVar1;
   long lVar2;
   code *pcVar3;
   int iVar4;
   ...
   if (*(long*)( this + 0x68 ) != 0) {
      ...
      piVar8 = local_110;
      local_f8 = CONCAT44((float)( ( ulong ) * (undefined8*)( this + 0x78 ) >> 0x20 ) + (float)( ( ulong ) * (undefined8*)param_1 >> 0x20 ), (float)*(undefined8*)( this + 0x78 ) + (float)*(undefined8*)param_1);
      ...
      local_d8 = (undefined**)CONCAT44((float)( (ulong)local_f8 >> 0x20 ) + fStack_e8, (float)local_f8 + fStack_ec);
         ...
         do {
            ...
            while (iVar7 < iVar6) {
               ...
               if (lVar9 < 0) {
                  ...
                  LAB_0010a340:fStack_60 = fVar16;
                  lVar14 = 0;
                  LAB_0010a348:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar9, lVar14, "p_index", "size()", "", false, true);
                  _err_flush_stdout();
                  /* WARNING: Does not return */
                  pcVar3 = (code*)invalidInstructionException();
                  ( *pcVar3 )();
               ...
               auVar22._8_4_ = ( (float)( ( ulong )((double)iVar12 - dVar28) >> 0x20 ) - 0.0 ) * 0.0 - fStack_60;
               ...
               if (lVar9 < 0) {
                  if (lVar2 != 0) {
                     LAB_0010a448:lVar14 = *(long*)( lVar2 + -8 );
                     fStack_60 = fVar16;
                     goto LAB_0010a348;
                  }
               ...
               auVar21._4_4_ = ( fStack_58 - fVar23 ) * ( fStack_60 - fVar16 ) - ( fStack_60 - local_54 ) * ( fStack_58 - fVar26 );
               auVar21._8_4_ = ( fVar16 - fVar17 ) * 0.0 - ( fVar16 - 0.0 ) * 0.0;
               auVar21._12_4_ = ( fStack_5c - (float)( (ulong)dVar18 >> 0x20 ) ) * 0.0 - ( fStack_5c - 0.0 ) * ( 0.0 - fVar17 );
...
;
 ...
 while ( iVar12 != iVar4 );
      ...
      LAB_0010a3c8:local_d8 = &PTR_get_volume_00111c28;
      GodotShape3D::~GodotShape3D((GodotShape3D*)&local_d8);
   }
...
/* GodotHeightMapShape3D::_build_accelerator() */void GodotHeightMapShape3D::_build_accelerator(GodotHeightMapShape3D *this) {
   uint uVar1;
   undefined8 *puVar2;
   undefined4 uVar3;
   float fVar4;
   ...
   iVar22 = (int)lVar12;
   iVar25 = (int)( (ulong)lVar12 >> 0x20 );
   iVar27 = (int)( ( -(uint)(iVar22 < 0) & (uint)_LC85 ) + iVar22 ) >> 4;
   iVar29 = (int)( ( -(uint)(lVar12 < 0) & _LC85._4_4_ ) + iVar25 ) >> 4;
   *(ulong*)( this + 0x98 ) = CONCAT44(iVar29, iVar27);
   if (0 < iVar22 % 0x10) {
      iVar27 = iVar27 + 1;
      *(int*)( this + 0x98 ) = iVar27;
   }

   if (0 < iVar25 % 0x10) {
      iVar29 = iVar29 + 1;
      *(int*)( this + 0x9c ) = iVar29;
   }

   uVar14 = iVar27 * iVar29;
   if (uVar14 < 2) {
      return;
   }

   uVar13 = *(uint*)( this + 0x88 );
   if (uVar13 <= uVar14) {
      if (uVar14 <= uVar13) goto LAB_0010a52d;
      uVar1 = uVar14 - 1;
      if (*(uint*)( this + 0x8c ) < uVar14) {
         uVar13 = uVar1 >> 1 | uVar1;
         uVar13 = uVar13 >> 2 | uVar13;
         uVar13 = uVar13 | uVar13 >> 4;
         uVar13 = uVar13 >> 8 | uVar13;
         uVar13 = ( uVar13 >> 0x10 | uVar13 ) + 1;
         *(uint*)( this + 0x8c ) = uVar13;
         lVar12 = Memory::realloc_static(*(void**)( this + 0x90 ), (ulong)uVar13 * 8, false);
         *(long*)( this + 0x90 ) = lVar12;
         ...
         uVar13 = *(uint*)( this + 0x88 );
         iVar29 = *(int*)( this + 0x9c );
         if (uVar14 <= uVar13) goto LAB_0010a526;
      }

      puVar2 = (undefined8*)( *(long*)( this + 0x90 ) + 8 + ( ( ulong )(uVar1 - uVar13) + (ulong)uVar13 ) * 8 );
      puVar11 = (undefined8*)( *(long*)( this + 0x90 ) + (ulong)uVar13 * 8 );
      puVar10 = puVar11;
      if (( (int)puVar2 - (int)puVar11 & 8U ) != 0) {
         *puVar11 = 0;
         puVar10 = puVar11 + 1;
         if (puVar11 + 1 == puVar2) goto LAB_0010a526;
      }
 ...
 while ( puVar11 != puVar2 );
   ...
   LAB_0010a526:*(uint*)( this + 0x88 ) = uVar14;
   LAB_0010a52d:if (0 < iVar29) {
      iVar27 = *(int*)( this + 0x98 );
      iVar22 = 0;
      uVar14 = 0;
      local_68 = 0;
      do {
         if (0 < iVar27) {
            iVar25 = *(int*)( this + 0x70 );
            lVar12 = *(long*)( this + 0x68 );
            lVar16 = (long)( iVar25 * iVar22 );
            if (lVar16 < 0) {
               if (lVar12 != 0) {
               ...
               if (lVar12 != 0) {
                  ...
                  while (true) {
                     lVar16 = lVar18;
                     if (lVar20 <= lVar18) goto LAB_0010a69d;
                     uVar3 = *(undefined4*)( lVar12 + lVar18 * 4 );
                     iVar7 = (int)auVar23._0_8_;
                     auVar23._0_8_ = CONCAT44(uVar3, uVar3);
                     auVar23._8_8_ = 0;
                     iVar8 = *(int*)( this + 0x74 );
                     if (iVar22 + 0x11 <= *(int*)( this + 0x74 )) {
                        iVar8 = iVar22 + 0x11;
                     }

                     iVar9 = iVar7 + 0x11;
                     if (iVar25 < iVar7 + 0x11) {
                        iVar9 = iVar25;
                     }

                     if (iVar22 < iVar8) {
                        iVar21 = local_68 * iVar25 * 0x10;
                        local_64 = iVar22;
                        do {
                           fVar26 = auVar23._4_4_;
                           if ((int)uVar15 < iVar9) {
                              lVar16 = (long)( iVar21 + iVar7 );
                              if (( lVar20 <= lVar16 ) || ( lVar16 < 0 )) goto LAB_0010a69d;
                              lVar19 = (long)iVar21;
                              lVar17 = lVar19 + uVar15 + 1;
                              auVar28 = auVar23;
                              fVar30 = fVar26;
                              while (true) {
                                 fVar4 = *(float*)( lVar12 + ( ( ulong )(uint)(iVar21 + iVar7) - ( lVar19 + uVar15 ) ) * 4 + -4 + lVar17 * 4 );
                                 if (fVar4 < auVar28._0_4_) {
                                    auVar28 = ZEXT416((uint)fVar4);
                                 }
 else {
                                    if (fVar4 <= fVar26) {
                                       fVar4 = fVar26;
                                 ...
                                 if (( ulong )(( iVar9 - iVar7 ) - 1) + uVar15 + 1 + lVar19 == lVar17) break;
                                 lVar16 = lVar17;
                                 if (( lVar17 < 0 ) || ( bVar5 = lVar20 <= lVar17 ),lVar17 = lVar17 + 1,bVar5) goto LAB_0010a69d;
                              }
;
                              auVar24._0_8_ = auVar28._0_8_;
                              auVar24._8_4_ = auVar28._4_4_;
                              auVar24._12_4_ = fVar30;
                              auVar23._8_8_ = auVar24._8_8_;
                              auVar23._0_4_ = auVar28._0_4_;
                              auVar23._4_4_ = fVar26;
                           }

                           local_64 = local_64 + 1;
                           iVar21 = iVar21 + iVar25;
                        }
 while ( local_64 != iVar8 );
                     }

                     if (*(uint*)( this + 0x88 ) <= local_4c) {
                        _err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, (ulong)local_4c, ( ulong ) * (uint*)( this + 0x88 ), "p_index", "count", "", false, true);
                        _err_flush_stdout();
                        /* WARNING: Does not return */
                        pcVar6 = (code*)invalidInstructionException();
                        ( *pcVar6 )();
                     ...
                     *(ulong*)( *(long*)( this + 0x90 ) + local_60 ) = auVar23._0_8_;
                     if (uVar15 == ( ulong )(iVar27 - 1) << 4) break;
                     uVar15 = uVar15 + 0x10;
                     local_60 = local_60 + 8;
                     lVar18 = lVar18 + 0x10;
                     local_4c = local_4c + 1;
                     auVar23._0_8_ = uVar15 & 0xffffffff;
                  }
;
                  goto LAB_0010a73e;
               }
            ...
            lVar20 = 0;
            LAB_0010a69d:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar16, lVar20, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar6 = (code*)invalidInstructionException();
            ( *pcVar6 )();
         ...
         LAB_0010a73e:local_68 = local_68 + 1;
         uVar14 = uVar14 + iVar27;
         iVar22 = iVar22 + 0x10;
      }
 while ( local_68 != iVar29 );
   }

   return;
}
/* GodotHeightMapShape3D::_setup(Vector<float> const&, int, int, float, float) */void GodotHeightMapShape3D::_setup(GodotHeightMapShape3D *this, Vector *param_1, int param_2, int param_3, float param_4, float param_5) {
   undefined8 *puVar1;
   float fVar2;
   float fVar3;
...
/* GodotHeightMapShape3D::GodotHeightMapShape3D() */void GodotHeightMapShape3D::GodotHeightMapShape3D(GodotHeightMapShape3D *this) {
   *(undefined8*)( this + 8 ) = 0;
   *(undefined8*)( this + 0x10 ) = 0;
   *(undefined4*)( this + 0x18 ) = 0;
   *(undefined8*)( this + 0x1c ) = 0;
   ...
   *(undefined4*)( this + 0x2c ) = 0;
   *(undefined8*)( this + 0x58 ) = 2;
   *(undefined***)this = &PTR_get_volume_00111d30;
   for (int i = 0; i < 3; i++) {
      *(undefined8*)( this + ( 8*i + 104 ) ) = 0;
   }
...
/* GodotShape3D::add_owner(GodotShapeOwner3D*) */void GodotShape3D::add_owner(GodotShape3D *this, GodotShapeOwner3D *param_1) {
   int *piVar1;
   long lVar2;
   long lVar3;
   undefined1 auVar4[16];
   ...
   if (( lVar2 != 0 ) && ( *(int*)( this + 0x5c ) != 0 )) {
      ...
      if (uVar17 != 0) {
         uVar19 = 0;
         while (( (uint)uVar16 != uVar17 || ( param_1 != *(GodotShapeOwner3D**)( *(long*)( lVar2 + lVar15 * 8 ) + 0x10 ) ) )) {
            uVar19 = uVar19 + 1;
            auVar5._8_8_ = 0;
            ...
            if (( uVar17 == 0 ) || ( auVar6._8_8_ = 0 ),auVar6._0_8_ = (ulong)uVar17 * lVar3,auVar10._8_8_ = 0,auVar10._0_8_ = uVar18,auVar7._8_8_ = 0,auVar7._0_8_ = ( ulong )(( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x58 ) * 4 ) + uVar14 ) - SUB164(auVar6 * auVar10, 8)) * lVar3,auVar11._8_8_ = 0,auVar11._0_8_ = uVar18,SUB164(auVar7 * auVar11, 8) < uVar19) goto LAB_0010abe0;
         }
;
   ...
   LAB_0010abe0:local_40[0] = param_1;
   puVar13 = (undefined4*)HashMap<GodotShapeOwner3D*,int,HashMapHasherDefault,HashMapComparatorDefault<GodotShapeOwner3D*>,DefaultTypedAllocator<HashMapElement<GodotShapeOwner3D*,int>>>::operator []((HashMap<GodotShapeOwner3D*,int,HashMapHasherDefault,HashMapComparatorDefault<GodotShapeOwner3D*>,DefaultTypedAllocator<HashMapElement<GodotShapeOwner3D*,int>>>*)( this + 0x30 ), local_40);
   *puVar13 = 1;
   return;
}
/* GodotConvexPolygonShape3D::_setup(Vector<Vector3> const&) */void GodotConvexPolygonShape3D::_setup(GodotConvexPolygonShape3D *this, Vector *param_1) {
   undefined8 *puVar1;
   code *pcVar2;
   int iVar3;
   float *pfVar4;
   ...
   if (iVar3 != 0) {
      _err_print_error("_setup", "modules/godot_physics_3d/godot_shape_3d.cpp", 0x44c, "Failed to build convex hull", 0, 0);
   }
   ...
   LocalVector<LocalVector<int,unsigned_int,false,false>,unsigned_int,false,false>::resize((LocalVector<LocalVector<int,unsigned_int,false,false>,unsigned_int,false,false>*)( this + 0xa0 ), 0);
   if (*(int*)( this + 0x80 ) == 0) {
      fVar17 = 0.0;
      fVar20 = 0.0;
      uVar22 = 0;
      ...
      do {
         while ((int)lVar16 != 0) {
            ...
            fVar26 = fVar27;
            fVar18 = fVar21;
            if (*(uint*)( this + 0x80 ) <= (uint)lVar16) goto LAB_0010ad73;
         }
;
         pfVar4 = *(float**)( this + 0x88 );
         lVar16 = lVar16 + 1;
 ...
 while ( (uint)lVar16 < *(uint*)( this + 0x80 ) );
      LAB_0010ad73:uVar23 = CONCAT44(fVar25, fVar27);
      ...
      do {
         ...
         do {
            ...
            if (fVar18 == 0.0) {
               ...
               fVar25 = 0.0;
               fVar26 = fVar25;
               if (uVar12 != 0) goto LAB_0010ae48;
               LAB_0010afe0:uVar13 = 0xffffffff;
            }
 else {
               fVar18 = SQRT(fVar18);
               ...
               if (uVar12 == 0) goto LAB_0010afe0;
               LAB_0010ae48:pfVar4 = *(float**)( this + 0x88 );
               uVar13 = 0xffffffff;
               uVar10 = 0;
               fVar18 = 0.0;
               do {
 ...
 while ( uVar12 != uVar10 );
            ...
            if (iVar9 != 0) {
               puVar5 = puVar6;
               do {
                  if (*puVar5 == uVar13) goto LAB_0010aed2;
                  puVar5 = puVar5 + 1;
               }
 while ( puVar6 + uVar7 != puVar5 );
            ...
            if (*(int*)( this + 0x94 ) == iVar9) {
               ...
               *(uint**)( this + 0x98 ) = puVar6;
               if (puVar6 == (uint*)0x0) goto LAB_0010b1fa;
               uVar7 = ( ulong ) * (uint*)( this + 0x90 );
            }
 ...
 while ( iVar3 != 2 );
   if ((uint)uVar7 < uVar12) {
      LocalVector<LocalVector<int,unsigned_int,false,false>,unsigned_int,false,false>::resize((LocalVector<LocalVector<int,unsigned_int,false,false>,unsigned_int,false,false>*)( this + 0xa0 ), uVar12);
            ...
            do {
               ...
               if (uVar12 == puVar11[1]) {
                  ...
                  *(void**)( puVar11 + 2 ) = pvVar8;
                  if (pvVar8 == (void*)0x0) {
                     LAB_0010b1fa:_err_print_error("push_back", "./core/templates/local_vector.h", 0x41, "FATAL: Condition \"!data\" is true.", "Out of memory", 0, 0);
                     _err_flush_stdout();
                     /* WARNING: Does not return */
               ...
               *(uint*)( (long)pvVar8 + (ulong)uVar12 * 4 ) = uVar13;
               ...
               if (uVar12 == puVar11[1]) {
                  ...
                  pvVar8 = (void*)Memory::realloc_static(pvVar8, uVar7 * 4, false);
                  *(void**)( puVar11 + 2 ) = pvVar8;
                  if (pvVar8 == (void*)0x0) goto LAB_0010b1fa;
                  uVar12 = *puVar11;
               }
 ...
 while ( uVar12 < *(uint*)( this + 0xa0 ) );
         ...
         _err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, (ulong)uVar12, uVar7, "p_index", "count", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
...
/* GodotConvexPolygonShape3D::set_data(Variant const&) */void GodotConvexPolygonShape3D::set_data(Variant *param_1) {
   long *plVar1;
   long lVar2;
   long in_FS_OFFSET;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotHeightMapShape3D::intersect_segment(Vector3 const&, Vector3 const&, Vector3&, Vector3&,
   int&, bool) const */ulong GodotHeightMapShape3D::intersect_segment(GodotHeightMapShape3D *this, Vector3 *param_1, Vector3 *param_2, Vector3 *param_3, Vector3 *param_4, int *param_5, bool param_6) {
   long lVar1;
   code *pcVar2;
   bool bVar3;
   char cVar4;
   ...
   if (lVar1 == 0) {
      ...
      if ((float)( (uint)fVar22 & _LC99 ) < _LC98) {
         fVar22 = (float)( ( uint )((float)(int)fVar22 - (float)( -(uint)(fVar22 < (float)(int)fVar22) & (uint)_LC9 )) | ~_LC99 & (uint)fVar22 );
      }
      ...
      if ((float)( (uint)fVar23 & _LC99 ) < _LC98) {
         fVar23 = (float)( ( uint )((float)(int)fVar23 - (float)( -(uint)(fVar23 < (float)(int)fVar23) & (uint)_LC9 )) | ~_LC99 & (uint)fVar23 );
      }
      ...
      if ((int)fVar22 != iVar10 || (int)fVar23 != iVar8) {
         if (( *(int*)( this + 0x88 ) == 0 ) || ( ( fVar29 - fVar30 ) * ( fVar29 - fVar30 ) + ( fVar26 - fVar17 ) * ( fVar26 - fVar17 ) < _LC102 )) {
            bVar3 = _intersect_grid_segment<bool(_HeightmapSegmentCullParams &, _HeightmapGridCullState_const &)>(this, _heightmap_cell_cull_segment, param_1, param_2, *(int*)( this + 0x70 ), *(int*)( this + 0x74 ), (Vector3*)( this + 0x78 ), param_3, param_4);
            uVar15 = CONCAT71(extraout_var, bVar3) & 0xffffffff;
         }
 else {
            local_138 = CONCAT44(fVar33 * _UNK_00112074, fVar30 * _LC104);
            local_130 = fVar17 * _LC104;
            local_128 = CONCAT44(fVar31 * _UNK_00112074, fVar29 * _LC104);
            local_120 = fVar26 * _LC104;
            local_d8 = (undefined**)CONCAT44((float)( ( ulong ) * (undefined8*)( this + 0x78 ) >> 0x20 ) * _UNK_00112074, (float)*(undefined8*)( this + 0x78 ) * _LC104);
            local_d0 = fVar18 * _LC104;
            bVar3 = _intersect_grid_segment<bool(_HeightmapSegmentCullParams &, _HeightmapGridCullState_const &)>(this, _heightmap_chunk_cull_segment, (Vector3*)&local_138, (Vector3*)&local_128, *(int*)( this + 0x98 ) + 1, *(int*)( this + 0x9c ) + 1, (Vector3*)&local_d8, param_3, param_4);
      ...
      if (( lVar6 < 0 ) || ( lVar13 <= lVar6 )) {
         LAB_0010bb7b:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar6, lVar13, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
      ...
      if (( lVar13 <= lVar6 ) || ( iVar10 + iVar9 < 0 )) goto LAB_0010bb7b;
      fStack_5c = *(float*)( lVar1 + lVar6 * 4 );
      iVar16 = iVar16 + iVar10;
      lVar6 = (long)( iVar16 + iVar5 );
      fStack_58 = fVar18;
      local_54 = fVar17;
      if (( lVar13 <= lVar6 ) || ( lVar6 < 0 )) goto LAB_0010bb7b;
      ...
      auVar19._0_4_ = ( fStack_68 - fVar26 ) * ( fStack_64 - fVar18 ) - ( fVar18 - fVar23 ) * ( fStack_68 - fStack_5c );
      ...
      local_130 = 0.0;
      local_148 = -1;
      cVar4 = GodotFaceShape3D::intersect_segment((GodotFaceShape3D*)&local_d8, pVVar11, (Vector3*)&local_11c, pVVar7, pVVar12, &local_148, true);
      if (cVar4 == '\0') {
         lVar13 = *(long*)( lVar1 + -8 );
         local_6c = local_60;
         fStack_68 = fStack_5c;
         ...
         if (( iVar16 + iVar9 < 0 ) || ( lVar13 <= lVar6 )) goto LAB_0010bb7b;
         ...
         fStack_5c = fVar18;
         fStack_58 = fVar23;
         cVar4 = GodotFaceShape3D::intersect_segment((GodotFaceShape3D*)&local_d8, pVVar11, extraout_RDX, pVVar7, pVVar12, &local_148, true);
         if (cVar4 == '\0') {
            local_d8 = &PTR_get_volume_00111c28;
            GodotShape3D::~GodotShape3D((GodotShape3D*)&local_d8);
            goto LAB_0010ba87;
         }
   ...
   LAB_0010b42d:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar15;
   }
...
/* Error CowData<Vector3>::resize<false>(long) [clone .isra.0] */void CowData<Vector3>::resize<false>(CowData<Vector3> *this, long param_1) {
   ...
   if (param_1 * 0xc != 0) {
      ...
      if (pCVar8 != (CowData<Vector3>*)0x0) {
         ...
         if (pCVar8 == pCVar3) {
            LAB_0010be6c:puVar12 = *(undefined8**)this;
            ...
            lVar10 = puVar12[-1];
            if (param_1 <= lVar10) goto LAB_0010bdf7;
         }
 else {
            if (lVar11 != 0) {
               pCVar9 = this;
         ...
         LAB_0010bdf7:puVar12[-1] = param_1;
         return;
      }
   ...
   LAB_0010bf12:_err_print_error("resize", "./core/templates/cowdata.h", uVar7, pcVar6, 0, 0);
   return;
}
/* GodotConcavePolygonShape3D::get_faces() const */void GodotConcavePolygonShape3D::get_faces(void) {
   undefined8 *puVar1;
   undefined8 *puVar2;
   code *pcVar3;
   long lVar4;
   ...
   *(undefined8*)( in_RDI + 8 ) = 0;
   ...
   do {
      ...
      do {
         ...
         if (lVar4 < 0) {
            if (lVar6 != 0) {
               LAB_0010c0ad:lVar5 = *(long*)( lVar6 + -8 );
               goto LAB_0010c0b1;
            }

            LAB_0010c0f0:lVar5 = 0;
            LAB_0010c0b1:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar4, lVar5, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar3 = (code*)invalidInstructionException();
            ( *pcVar3 )();
         ...
         if (lVar6 == 0) goto LAB_0010c0f0;
         if (*(long*)( lVar6 + -8 ) <= lVar4) goto LAB_0010c0ad;
         puVar1 = (undefined8*)( lVar6 + lVar4 * 0xc );
         if (*(long*)( in_RDI + 8 ) == 0) {
            lVar6 = 0;
            LAB_0010c0fb:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar5, lVar6, "p_index", "size()", "", false, false);
         }
 else {
            lVar6 = *(long*)( *(long*)( in_RDI + 8 ) + -8 );
            if (lVar6 <= lVar5) goto LAB_0010c0fb;
...
/* GodotConcavePolygonShape3D::get_data() const */Variant *GodotConcavePolygonShape3D::get_data(void) {
   long *plVar1;
   char cVar2;
   long lVar3;
   Variant *pVVar4;
...
/* GodotConvexPolygonShape3D::get_data() const */Variant *GodotConvexPolygonShape3D::get_data(void) {
   long *plVar1;
   code *pcVar2;
   long lVar3;
   long lVar4;
   ...
   if (*(int*)( in_RSI + 0x80 ) != 0) {
      ...
      do {
         ...
         if (local_50[0] == 0) {
            lVar3 = 0;
            LAB_0010c440:_err_print_index_error("operator[]", "./core/templates/vector.h", 0x38, lVar4, lVar3, "p_index", "((Vector<T> *)(this))->_cowdata.size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar2 = (code*)invalidInstructionException();
            ( *pcVar2 )();
         ...
         if (lVar3 <= lVar4) goto LAB_0010c440;
         lVar3 = lVar4 + 1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotConcavePolygonShape3D::_setup(Vector<Vector3> const&, bool) */void GodotConcavePolygonShape3D::_setup(GodotConcavePolygonShape3D *this, Vector *param_1, bool param_2) {
   long *plVar1;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (( puVar14 == (undefined8*)0x0 ) || ( iVar5 = iVar5 == 0 )) {
      fStack_5c = 0.0;
      fStack_58 = 0.0;
      ...
      *(undefined8*)( this + 0x18 ) = 0;
      ...
      if (iVar5 % 3 != 0) {
         if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            _err_print_error("_setup", "modules/godot_physics_3d/godot_shape_3d.cpp", 0x653, "Condition \"src_face_count % 3\" is true.", 0, 0);
            return;
         }
      ...
      if (iVar5 < -2) {
         _err_print_error("resize", "./core/templates/cowdata.h", 0x157, "Condition \"p_size < 0\" is true. Returning: ERR_INVALID_PARAMETER", 0, 0);
         _err_print_error("resize", "./core/templates/cowdata.h", 0x157, "Condition \"p_size < 0\" is true. Returning: ERR_INVALID_PARAMETER", 0, 0);
         CowData<GodotConcavePolygonShape3D::Face>::_copy_on_write((CowData<GodotConcavePolygonShape3D::Face>*)( this + 0x68 ));
         ...
         if (puVar8 == (ulong*)0x0) {
            ...
            local_c0 = (_Volume_BVH_Element*)0x0;
            lVar18 = *(long*)( this + 0x68 );
            if (lVar18 != 0) goto LAB_0010c663;
            LAB_0010d247:CowData<GodotConcavePolygonShape3D::Face>::_copy_on_write((CowData<GodotConcavePolygonShape3D::Face>*)( this + 0x68 ));
            uVar7 = uVar23 * 0x18 - 1;
            uVar7 = uVar7 | uVar7 >> 1;
            uVar7 = uVar7 | uVar7 >> 2;
            uVar7 = uVar7 | uVar7 >> 4;
            ...
            LAB_0010d2a4:puVar15 = (undefined8*)Memory::alloc_static(lVar18 + 0x10, false);
            if (puVar15 == (undefined8*)0x0) {
               ...
               *(undefined8**)( this + 0x68 ) = puVar13;
               LAB_0010d05b:puVar15 = puVar13 + lVar18 * 3;
               do {
                  *puVar15 = 0;
                  puVar12 = puVar15 + 3;
 ...
 while ( (_Volume_BVH_Element*)( puVar8 + uVar23 * 5 + 2 ) != p_Var9 );
            ...
            lVar18 = *(long*)( this + 0x68 );
            if (lVar18 == 0) goto LAB_0010d247;
            LAB_0010c663:this_01 = (CowData<GodotConcavePolygonShape3D::Face>*)( this + 0x68 );
            uVar7 = *(ulong*)( lVar18 + -8 );
            if (uVar23 == uVar7) goto LAB_0010c747;
            ...
            if (uVar7 * 0x18 != 0) {
               ...
               if ((long)uVar23 <= (long)uVar7) {
                  if (uVar10 != uVar16) goto LAB_0010cec7;
                  LAB_0010c736:if (*(long*)( this + 0x68 ) == 0) goto GodotConcavePolygonShape3D__setup;
                  *(ulong*)( *(long*)( this + 0x68 ) + -8 ) = uVar23;
                  goto LAB_0010c747;
               }

               if (uVar10 != uVar16) goto LAB_0010cfb3;
               LAB_0010d045:puVar13 = *(undefined8**)( this + 0x68 );
               if (puVar13 == (undefined8*)0x0) {
                  FUN_0010f118();
                  return;
               }
               ...
               lVar18 = puVar13[-1];
               if (lVar18 < (long)uVar23) goto LAB_0010d05b;
               goto LAB_0010d096;
            }
            ...
            LAB_0010cec7:iVar6 = CowData<GodotConcavePolygonShape3D::Face>::_realloc(this_01, lVar18);
            if (iVar6 == 0) goto LAB_0010c736;
         }

         LAB_0010c747:CowData<GodotConcavePolygonShape3D::Face>::_copy_on_write((CowData<GodotConcavePolygonShape3D::Face>*)( this + 0x68 ));
      ...
      if (iVar5 < 0) {
         ...
         if (lVar17 == 0) {
            if (iVar5 != 0) {
               ...
               LAB_0010cdd9:uVar7 = lVar18 * 0x24 - 1;
               uVar7 = uVar7 >> 1 | uVar7;
               uVar7 = uVar7 >> 2 | uVar7;
               uVar7 = uVar7 >> 4 | uVar7;
               uVar7 = uVar7 >> 8 | uVar7;
 ...
 while ( puVar15 != (undefined8*)( (long)puVar13 + ( lVar20 * 9 + 9 ) * 4 ) );
                     ...
                     if (iVar5 == 0) {
                        LAB_0010d0a8:puVar13 = *(undefined8**)( this + 0x88 );
                        if (puVar13 == (undefined8*)0x0) {
                           FUN_0010f118();
                           return;
                        }
                  ...
                  LAB_0010cf94:iVar5 = CowData<GodotConcavePolygonShape3D::BVH>::_realloc(this_00, lVar17);
                  if (iVar5 == 0) goto LAB_0010cc51;
               }
            ...
            if (lVar18 != lVar22) {
               if (iVar5 == 0) {
                  ...
                  *plVar1 = *plVar1 + -1;
                  ...
                  CowData<GodotConcavePolygonShape3D::BVH>::_copy_on_write(this_00);
                  if (lVar22 * 0x24 == 0) goto LAB_0010cdd9;
                  ...
                  if (lVar22 < lVar18) {
                     if (uVar7 != uVar23) goto LAB_0010ce2d;
                     goto LAB_0010d0a8;
                  }

                  if (uVar7 != uVar23) goto LAB_0010cf94;
                  LAB_0010cc51:if (*(long*)( this + 0x88 ) == 0) {
                     GodotConcavePolygonShape3D__setup:_DAT_00000000 = 0;
                     /* WARNING: Does not return */
                     pcVar3 = (code*)invalidInstructionException();
                     ( *pcVar3 )();
                  }
   ...
   LAB_0010d44b:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* GodotConcavePolygonShape3D::set_data(Variant const&) */void GodotConcavePolygonShape3D::set_data(Variant *param_1) {
   long *plVar1;
   long lVar2;
   char cVar3;
   bool bVar4;
   ...
   if (cVar3 == '\0') {
      _err_print_error("set_data", "modules/godot_physics_3d/godot_shape_3d.cpp", 0x68b, "Condition \"!d.has(\"faces\")\" is true.", 0, 0);
...
/* GodotHeightMapShape3D::set_data(Variant const&) */void GodotHeightMapShape3D::set_data(GodotHeightMapShape3D *this, Variant *param_1) {
   long *plVar1;
   float fVar2;
   code *pcVar3;
   float fVar4;
   ...
   if (*(int*)param_1 != 0x1b) {
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         _err_print_error("set_data", "modules/godot_physics_3d/godot_shape_3d.cpp", 0x888, "Condition \"p_data.get_type() != Variant::DICTIONARY\" is true.", 0, 0);
         return;
      }
   ...
   if (cVar5 == '\0') {
      _err_print_error("set_data", "modules/godot_physics_3d/godot_shape_3d.cpp", 0x88b, "Condition \"!d.has(\"width\")\" is true.", 0, 0);
   }
 else {
      ...
      if (cVar5 == '\0') {
         _err_print_error("set_data", "modules/godot_physics_3d/godot_shape_3d.cpp", 0x88c, "Condition \"!d.has(\"depth\")\" is true.", 0, 0);
      }
 else {
         ...
         if (cVar5 == '\0') {
            _err_print_error("set_data", "modules/godot_physics_3d/godot_shape_3d.cpp", 0x88d, "Condition \"!d.has(\"heights\")\" is true.", 0, 0);
         }
 else {
            Variant::Variant((Variant*)local_58, "width");
            ...
            if (iVar6 < 1) {
               _err_print_error("set_data", "modules/godot_physics_3d/godot_shape_3d.cpp", 0x892, "Condition \"width_new <= 0.0\" is true.", 0, 0);
            }
 else if (iVar7 < 1) {
               _err_print_error("set_data", "modules/godot_physics_3d/godot_shape_3d.cpp", 0x893, "Condition \"depth_new <= 0.0\" is true.", 0, 0);
            }
 else {
               Variant::Variant((Variant*)local_58, "heights");
               pVVar10 = (Variant*)Dictionary::operator [](local_c0);
               ...
               if (local_98[0] == 0x20) {
                  ...
                  LAB_0010d8fc:pVVar10 = (Variant*)local_78;
                  ...
                  if (cVar5 == '\0') {
                     ...
                     LAB_0010d93a:lVar11 = *(long*)( this + 0x68 );
                     if (lVar11 != 0) {
                        ...
                        if (0 < (int)lVar15) {
                           if (lVar15 < 1) {
                              ...
                              do {
                                 ...
                                 fVar20 = fVar4;
                                 if (lVar13 == ( ulong )((int)lVar15 - 1) + 1) goto LAB_0010dbf1;
 ...
 while ( bVar18 );
                           ...
                           _err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar16, lVar15, "p_index", "size()", "", false, true);
                           _err_flush_stdout();
                           /* WARNING: Does not return */
                           pcVar3 = (code*)invalidInstructionException();
                           ( *pcVar3 )();
                     ...
                     fVar19 = 0.0;
                     fVar20 = fVar19;
                     LAB_0010dbfb:puVar14 = local_b0;
                     if (local_b0 != (undefined8*)0x0) {
                        if ((long)( iVar6 * iVar7 ) != local_b0[-1]) {
                           _err_print_error("set_data", "modules/godot_physics_3d/godot_shape_3d.cpp", 0x8c9, "Condition \"heights_buffer.size() != (width_new * depth_new)\" is true.", 0, 0, this, pVVar10);
                           goto LAB_0010dc7e;
                        }
                     ...
                     LAB_0010dbf1:puVar14 = local_b0;
                     if (fVar19 <= fVar20) goto LAB_0010dbfb;
                     _err_print_error("set_data", "modules/godot_physics_3d/godot_shape_3d.cpp", 0x8c7, "Condition \"min_height > max_height\" is true.", 0, 0, this, pVVar10);
                     if (puVar14 == (undefined8*)0x0) goto LAB_0010d899;
                     LAB_0010dc7e:LOCK();
                     plVar1 = puVar14 + -2;
                     *plVar1 = *plVar1 + -1;
                     UNLOCK();
                     if (*plVar1 == 0) {
                        LAB_0010dc3a:Memory::free_static(local_b0 + -2, false);
                     }
                  ...
                  if (( ( lVar11 == 0 ) || ( pIVar12 = (Image*)__dynamic_cast(lVar11, &Object::typeinfo, &Image::typeinfo, 0) ),pIVar12 == (Image*)0x0 )) {
                     _err_print_error("set_data", "modules/godot_physics_3d/godot_shape_3d.cpp", 0x8a2, "Condition \"image.is_null()\" is true.", 0, 0);
                  }
 else {
                     ...
                     if (iVar8 == 8) {
                        ...
                        if (lVar11 < 0) {
                           ...
                           puVar14 = (undefined8*)Memory::alloc_static(( uVar17 | uVar17 >> 0x20 ) + 0x11, false);
                           if (puVar14 == (undefined8*)0x0) {
                              _err_print_error("resize", "./core/templates/cowdata.h", 0x171, "Parameter \"mem_new\" is null.", 0, 0);
                           }
 else {
                        ...
                        CowData<float>::_copy_on_write((CowData<float>*)&local_b0);
                        puVar14 = local_a0;
                        if (( local_b0 == (undefined8*)0x0 ) || ( lVar11 = lVar11 < 1 )) {
                           if (local_a0 != (undefined8*)0x0) goto LAB_0010daeb;
                        }
 else {
                           lVar15 = 0;
                           do {
                              *(undefined4*)( (long)local_b0 + lVar15 ) = *(undefined4*)( (long)local_a0 + lVar15 );
                              lVar15 = lVar15 + 4;
                           }
 while ( lVar15 != lVar11 << 2 );
                     ...
                     _err_print_error("set_data", "modules/godot_physics_3d/godot_shape_3d.cpp", 0x8a3, "Condition \"image->get_format() != Image::FORMAT_RF\" is true.", 0, 0);
                     cVar5 = RefCounted::unreference();
                     if (cVar5 != '\0') {
                        memdelete<Image>(pIVar12);
                     }
                  ...
                  _err_print_error("set_data", "modules/godot_physics_3d/godot_shape_3d.cpp", 0x8b1, "Method/function failed.", "Expected PackedFloat32Array or float Image.", 0, 0);
               }

               LAB_0010d899:if (Variant::needs_deinit[local_98[0]] != '\0') {
                  Variant::_clear_internal();
               }
   ...
   LAB_0010e02e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* GodotShape3D::is_concave() const */undefined8 GodotShape3D::is_concave(void) {
   return 0;
}
/* GodotConcaveShape3D::is_concave() const */undefined8 GodotConcaveShape3D::is_concave(void) {
   return 1;
}
/* GodotConcaveShape3D::get_supports(Vector3 const&, int, Vector3*, int&,
   GodotShape3D::FeatureType&) const */void GodotConcaveShape3D::get_supports(Vector3 *param_1, int param_2, Vector3 *param_3, int *param_4, FeatureType *param_5) {
   *(undefined4*)param_5 = 0;
   return;
}
/* GodotWorldBoundaryShape3D::get_volume() const */undefined4 GodotWorldBoundaryShape3D::get_volume(void) {
   return _LC0;
}
/* GodotWorldBoundaryShape3D::get_type() const */undefined8 GodotWorldBoundaryShape3D::get_type(void) {
   return 0;
}
/* GodotWorldBoundaryShape3D::get_supports(Vector3 const&, int, Vector3*, int&,
   GodotShape3D::FeatureType&) const */void GodotWorldBoundaryShape3D::get_supports(Vector3 *param_1, int param_2, Vector3 *param_3, int *param_4, FeatureType *param_5) {
   *(undefined4*)param_5 = 0;
   return;
}
/* GodotSeparationRayShape3D::get_volume() const */undefined8 GodotSeparationRayShape3D::get_volume(void) {
   return 0;
}
/* GodotSeparationRayShape3D::get_type() const */undefined8 GodotSeparationRayShape3D::get_type(void) {
   return 1;
}
/* GodotSphereShape3D::get_volume() const */undefined8 GodotSphereShape3D::get_volume(GodotSphereShape3D *this) {
   double dVar1;
   dVar1 = (double)*(float*)( this + 0x60 );
   dVar1 = _LC2 * dVar1 * dVar1 * dVar1;
   return CONCAT44((int)( (ulong)dVar1 >> 0x20 ), (float)dVar1);
}
/* GodotSphereShape3D::get_type() const */undefined8 GodotSphereShape3D::get_type(void) {
   return 2;
}
/* GodotBoxShape3D::get_volume() const */float GodotBoxShape3D::get_volume(GodotBoxShape3D *this) {
   return _LC3 * *(float*)( this + 0x60 ) * *(float*)( this + 100 ) * *(float*)( this + 0x68 );
}
/* GodotBoxShape3D::get_type() const */undefined8 GodotBoxShape3D::get_type(void) {
   return 3;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotCapsuleShape3D::get_volume() const */undefined8 GodotCapsuleShape3D::get_volume(GodotCapsuleShape3D *this) {
   double dVar1;
   dVar1 = (double)*(float*)( this + 100 );
   dVar1 = ( (double)*(float*)( this + 0x60 ) - ( dVar1 + dVar1 ) ) * __LC4 * dVar1 * dVar1 + dVar1 * _LC2 * dVar1 * dVar1;
   return CONCAT44((int)( (ulong)dVar1 >> 0x20 ), (float)dVar1);
}
/* GodotCapsuleShape3D::get_type() const */undefined8 GodotCapsuleShape3D::get_type(void) {
   return 4;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotCylinderShape3D::get_volume() const */undefined8 GodotCylinderShape3D::get_volume(GodotCylinderShape3D *this) {
   double dVar1;
   dVar1 = (double)*(float*)( this + 0x60 ) * __LC4 * (double)*(float*)( this + 100 ) * (double)*(float*)( this + 100 );
   return CONCAT44((int)( (ulong)dVar1 >> 0x20 ), (float)dVar1);
}
/* GodotCylinderShape3D::get_type() const */undefined8 GodotCylinderShape3D::get_type(void) {
   return 5;
}
/* GodotConvexPolygonShape3D::get_type() const */undefined8 GodotConvexPolygonShape3D::get_type(void) {
   return 6;
}
/* GodotConcavePolygonShape3D::get_type() const */undefined8 GodotConcavePolygonShape3D::get_type(void) {
   return 7;
}
/* GodotHeightMapShape3D::get_type() const */undefined8 GodotHeightMapShape3D::get_type(void) {
   return 8;
}
/* GodotFaceShape3D::get_type() const */undefined8 GodotFaceShape3D::get_type(void) {
   return 7;
}
/* GodotFaceShape3D::set_data(Variant const&) */void GodotFaceShape3D::set_data(Variant *param_1) {
   return;
}
/* GodotFaceShape3D::get_data() const */GodotFaceShape3D * __thiscall GodotFaceShape3D::get_data(GodotFaceShape3D *this){
   *(undefined4*)this = 0;
...
/* CowData<GodotConcavePolygonShape3D::BVH>::_copy_on_write() [clone .isra.0] [clone .cold] */void CowData<GodotConcavePolygonShape3D::BVH>::_copy_on_write(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* CowData<GodotConcavePolygonShape3D::Face>::_copy_on_write() [clone .isra.0] [clone .cold] */void CowData<GodotConcavePolygonShape3D::Face>::_copy_on_write(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void FUN_0010f100(void) {
   code *pcVar1;
   _DAT_00000000 = 0;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotConcavePolygonShape3D::_setup(Vector<Vector3> const&, bool) [clone .cold] */void GodotConcavePolygonShape3D::_setup(Vector *param_1, bool param_2) {
   code *pcVar1;
   _DAT_00000000 = 0;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
...
/* Geometry3D::segment_intersects_cylinder(Vector3 const&, Vector3 const&, float, float, Vector3*,
   Vector3*, int) */undefined8 Geometry3D::segment_intersects_cylinder(Vector3 *param_1, Vector3 *param_2, float param_3, float param_4, Vector3 *param_5, Vector3 *param_6, int param_7) {
   uint uVar1;
   long lVar2;
   undefined8 uVar3;
   long lVar4;
   ...
   if (_LC31 <= fVar9) {
      if (param_7 < 0) {
         _err_print_error("segment_intersects_cylinder", "./core/math/geometry_3d.h", 0xae, "Condition \"p_cylinder_axis < 0\" is true. Returning: false", 0, 0);
      }
 else if (param_7 < 3) {
         lVar4 = (long)param_7;
         for (int i = 0; i < 3; i++) {
         ...
         if (( fVar10 < param_4 ) && ( fVar10 = _LC31 <= fVar10 )) {
            ...
            lVar2 = 0;
            lVar5 = 0xffffffff;
            local_40 = CONCAT44(*(undefined4*)( param_1 + lVar4 * 4 ), fVar17 * fVar9 + fVar18 * fVar12 + fVar6 * fVar14);
            local_38 = CONCAT44(*(undefined4*)( param_2 + lVar4 * 4 ), fVar21 * fVar9 + fVar22 * fVar12 + fVar8 * fVar14);
            fVar8 = 0.0;
            fVar9 = (float)_LC9;
            while (true) {
               ...
               fVar12 = (float)_LC9;
               if (fVar22 <= fVar21) {
                  if (( fVar10 < fVar22 ) || ( fVar21 < fVar14 )) goto LAB_0010f3e7;
                  fVar7 = 0.0;
                  if (fVar10 < fVar21) {
                  ...
                  if (( fVar10 < fVar21 ) || ( fVar22 < fVar14 )) goto LAB_0010f3e7;
                  fVar7 = 0.0;
                  if (fVar21 < fVar14) {
               ...
               if (fVar9 < fVar8) goto LAB_0010f3e7;
               if (lVar2 != 0) break;
               lVar2 = 1;
            }
;
         ...
         _err_print_error("segment_intersects_cylinder", "./core/math/geometry_3d.h", 0xaf, "Condition \"p_cylinder_axis > 2\" is true. Returning: false", 0, 0);
      }

   }

   LAB_0010f3e7:uVar3 = 0;
   LAB_0010f3e9:if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar3;
   }
...
/* GodotHeightMapShape3D::~GodotHeightMapShape3D() */void GodotHeightMapShape3D::~GodotHeightMapShape3D(GodotHeightMapShape3D *this) {
   ...
   *(undefined***)this = &PTR_get_volume_001117a0;
   GodotShape3D::~GodotShape3D((GodotShape3D*)this);
   return;
}
/* GodotConcavePolygonShape3D::~GodotConcavePolygonShape3D() */void GodotConcavePolygonShape3D::~GodotConcavePolygonShape3D(GodotConcavePolygonShape3D *this) {
   ...
   *(undefined***)this = &PTR_get_volume_00111ca8;
   for (int i = 0; i < 3; i++) {
      if (*(long*)( this + ( -16*i + 136 ) ) != 0) {
         LOCK();
         plVar1 = (long*)( *(long*)( this + ( -16*i + 136 ) ) + -16 );
         *plVar1 = *plVar1 + -1;
         UNLOCK();
         if (*plVar1 == 0) {
            lVar2 = *(long*)( this + ( -16*i + 136 ) );
            *(undefined8*)( this + ( -16*i + 136 ) ) = 0;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<GodotShapeOwner3D*, int, HashMapHasherDefault,
   HashMapComparatorDefault<GodotShapeOwner3D*>,
   DefaultTypedAllocator<HashMapElement<GodotShapeOwner3D*, int> > >::operator[](GodotShapeOwner3D*
   const&) */undefined1[16];HashMap<GodotShapeOwner3D*,int,HashMapHasherDefault,HashMapComparatorDefault<GodotShapeOwner3D*>,DefaultTypedAllocator<HashMapElement<GodotShapeOwner3D*,int>>>::operator [](HashMap<GodotShapeOwner3D*,int,HashMapHasherDefault,HashMapComparatorDefault<GodotShapeOwner3D*>,DefaultTypedAllocator<HashMapElement<GodotShapeOwner3D*,int>>>
...

{
   ...
   *(void**)( this + 8 ) = local_70;
   if (uVar47 == 0) {
      ...
      pGVar56 = *param_1;
      if (local_70 == (void*)0x0) goto LAB_0010ff8b;
   }
 else {
 ...
 while ( uVar55 != uVar40 );
   ...
   if (uVar44 != 0) {
      ...
      lVar46 = lVar45;
      do {
         if (( (uint)uVar54 == uVar44 ) && ( pGVar56 == *(GodotShapeOwner3D**)( *(long*)( (long)local_70 + lVar45 * 8 ) + 0x10 ) )) {
 ...
 while ( ( uVar44 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = (ulong)uVar44 * lVar3,auVar23._8_8_ = 0,auVar23._0_8_ = uVar55,auVar8._8_8_ = 0,auVar8._0_8_ = ( ulong )(( uVar53 + uVar47 ) - SUB164(auVar7 * auVar23, 8)) * lVar3,auVar24._8_8_ = 0,auVar24._0_8_ = uVar55,lVar46 = SUB168(auVar8 * auVar24, 8),uVar50 <= SUB164(auVar8 * auVar24, 8) );
   ...
   LAB_00110333:uVar51 = CONCAT44(0, *(uint*)( hash_table_size_primes + uVar40 * 4 ));
   lVar3 = *(long*)( hash_table_size_primes_inv + uVar40 * 8 );
   uVar39 = (long)pGVar56 * 0x3ffff - 1;
   uVar39 = ( uVar39 ^ uVar39 >> 0x1f ) * 0x15;
   uVar39 = ( uVar39 ^ uVar39 >> 0xb ) * 0x41;
   ...
   if (uVar47 != 0) {
      ...
      lVar46 = lVar45;
      do {
         if (( (uint)uVar54 == uVar47 ) && ( *(GodotShapeOwner3D**)( *(long*)( (long)local_70 + lVar45 * 8 ) + 0x10 ) == pGVar56 )) {
...
}LAB_0010ff8b:if ((float)uVar55 * __LC89 < (float)( iVar43 + 1 )) {
...
pGVar56 = *param_1;pauVar42 = (undefined1(*) [16])operator_new(0x20, "");*(GodotShapeOwner3D**)pauVar42[1] = pGVar56;*(undefined4*)( pauVar42[1] + 8 ) = 0;*pauVar42 = (undefined1[16])0x0;puVar2 = *(undefined8**)( this + 0x20 );if (puVar2 == (undefined8*)0x0) {
...
;*(undefined1(**) [16])( lVar45 + lStack_90 * 8 ) = pauVar37;*puVar1 = uVar53;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_00110314:auVar59._8_8_ = lStack_90;auVar59._0_8_ = pauVar42[1] + 8;return auVar59;}/* LocalVector<LocalVector<int, unsigned int, false, false>, unsigned int, false,
   false>::resize(unsigned int) */void LocalVector<LocalVector<int,unsigned_int,false,false>,unsigned_int,false,false>::resize(LocalVector<LocalVector<int,unsigned_int,false,false>,unsigned_int,false,false> *this, uint param_1) {
   code *pcVar1;
   int *piVar2;
   undefined8 *puVar3;
   undefined8 *puVar4;
 ...
 while ( uVar7 < *(uint*)this );
      ...
      if (*(uint*)( this + 4 ) < param_1) {
         ...
         *(long*)( this + 8 ) = lVar6;
         ...
         uVar7 = *(uint*)this;
         if (param_1 <= uVar7) goto LAB_00110609;
      }
 ...
 while ( puVar4 != (undefined8*)( lVar6 + 0x10 + ( ( ulong )(uVar5 - uVar7) + (ulong)uVar7 ) * 0x10 ) );
   ...
   LAB_00110609:*(uint*)this = param_1;
   return;
}
/* GodotConvexPolygonShape3D::~GodotConvexPolygonShape3D() */void GodotConvexPolygonShape3D::~GodotConvexPolygonShape3D(GodotConvexPolygonShape3D *this) {
   void *pvVar1;
   long lVar2;
   void *pvVar3;
   *(undefined***)this = &PTR_get_volume_00111ba8;
   ...
   for (int i = 0; i < 3; i++) {
      if (*(void**)( this + ( -16*i + 152 ) ) != (void*)0) {
         if (*(int*)( this + ( -16*i + 144 ) ) != 0) {
            *(undefined4*)( this + ( -16*i + 144 ) ) = 0;
         }

         Memory::free_static(*(void**)( this + ( -16*i + 152 ) ), false);
      }
 ...
 while ( (uint)lVar2 < *(uint*)( this + 0x60 ) );
         *(undefined4*)( this + 0x60 ) = 0;
         if (pvVar3 == (void*)0x0) goto LAB_00110804;
      }
   ...
   LAB_00110804:GodotShape3D::~GodotShape3D((GodotShape3D*)this);
   return;
}
/* GodotConvexPolygonShape3D::~GodotConvexPolygonShape3D() */void GodotConvexPolygonShape3D::~GodotConvexPolygonShape3D(GodotConvexPolygonShape3D *this) {
...
/* bool GodotHeightMapShape3D::_intersect_grid_segment<bool (_HeightmapSegmentCullParams&,
   ...
   const&), Vector3 const&, Vector3 const&, int, int, Vector3 const&, Vector3&, Vector3&) const */bool GodotHeightMapShape3D::_intersect_grid_segment<bool(_HeightmapSegmentCullParams &, _HeightmapGridCullState_const &)>(GodotHeightMapShape3D *this, _func_bool__HeightmapSegmentCullParams_ptr__HeightmapGridCullState_ptr *param_1, Vector3 *param_2, Vector3 *param_3, int param_4, int param_5, Vector3 *param_6, Vector3 *param_7, Vector3 *param_8) {
   undefined1 auVar1[16];
   bool bVar2;
   uint uVar3;
   uint uVar4;
   ...
   fVar14 = (float)( ( ulong ) * (undefined8*)param_3 >> 0x20 ) - (float)( ( ulong ) * (undefined8*)param_2 >> 0x20 );
   ...
   if ((double)fVar13 < _LC28) goto LAB_0011094a;
   auVar10._8_8_ = 0;
   ...
   if (_LC28 <= (double)local_144) {
      ...
      if ((float)( (uint)fVar11 & _LC99 ) < _LC98) {
         fVar16 = (float)( ( uint )((float)(int)fVar11 - (float)( -(uint)(fVar11 < (float)(int)fVar11) & (uint)(float)_LC9 )) | ~_LC99 & (uint)fVar11 );
      }

      uVar3 = (uint)fVar16;
      if ((float)( (uint)fVar9 & _LC99 ) < _LC98) {
         fVar12 = (float)( ( uint )((float)(int)fVar9 - (float)( -(uint)(fVar9 < (float)(int)fVar9) & (uint)(float)_LC9 )) | ~_LC99 & (uint)fVar9 );
         uVar4 = (uint)fVar12;
         if (_LC28 < dVar17) goto LAB_00110d48;
         LAB_00110e3c:if (dVar18 <= _LC28) goto LAB_00110b1f;
         ...
         uVar4 = (uint)fVar9;
         if (dVar17 <= _LC28) goto LAB_00110e3c;
         LAB_00110d48:if (dVar18 <= _LC28) {
            if (_LC100 <= dVar18) {
               local_174 = 0;
            }
 else {
         ...
         fVar12 = fVar9;
         if ((float)( (uint)fVar9 & _LC99 ) < _LC98) {
            fVar12 = (float)( ( uint )((float)( -(uint)((float)(int)fVar9 < fVar9) & (uint)(float)_LC9 ) + (float)(int)fVar9) | ~_LC99 & (uint)fVar9 );
         }

         local_164 = 1;
         fVar13 = ( fVar12 - fVar9 ) * fVar15;
         local_168 = fVar15;
         LAB_00110dc8:auVar8 = ZEXT416((uint)fVar13);
         fVar13 = ABS(fVar13);
         if (local_174 == 0) {
            fVar12 = fVar19 * 0.0;
            fVar9 = _LC38;
         ...
         fVar12 = fVar19;
         if (local_174 != 1) goto LAB_00111022;
      }

      fVar19 = fVar11;
      if ((float)( (uint)fVar11 & _LC99 ) < _LC98) {
         fVar19 = (float)( ( uint )((float)( -(uint)((float)(int)fVar11 < fVar11) & (uint)(float)_LC9 ) + (float)(int)fVar11) | ~_LC99 & (uint)fVar11 );
      }
   ...
   while (true) {
      ...
      if (bVar2) goto LAB_00110c6d;
      LAB_00110bf3:bVar2 = ( *param_1 )((_HeightmapSegmentCullParams*)&local_128, (_HeightmapGridCullState*)&local_148);
      if (bVar2) goto LAB_00111090;
      if (( ( (int)( uVar5 | uVar6 ) < 0 ) || ( param_4 + -1 <= (int)uVar5 ) ) || ( param_5 + -1 <= (int)uVar6 )) goto LAB_00110c90;
   }
;
   ...
   fVar14 = fVar14 + fVar19;
   if (bVar2) goto LAB_00110bf3;
   LAB_00110c6d:local_140 = CONCAT44(local_140._4_4_, local_144);
   bVar2 = ( *param_1 )((_HeightmapSegmentCullParams*)&local_128, (_HeightmapGridCullState*)&local_148);
   if (bVar2) {
      LAB_00111090:*(undefined8*)param_7 = local_104;
   ...
   LAB_00110c90:bVar2 = false;
   LAB_00110c92:local_d8[0] = &PTR_get_volume_00111c28;
   GodotShape3D::~GodotShape3D((GodotShape3D*)local_d8);
   LAB_0011094a:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* CowData<_Volume_BVH_Element>::_realloc(long) */undefined8 CowData<_Volume_BVH_Element>::_realloc(CowData<_Volume_BVH_Element> *this, long param_1) {
   undefined8 *puVar1;
   puVar1 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), param_1 + 0x10, false);
   if (puVar1 != (undefined8*)0x0) {
      *puVar1 = 1;
...
/* CowData<GodotConcavePolygonShape3D::Face>::_realloc(long) */undefined8 CowData<GodotConcavePolygonShape3D::Face>::_realloc(CowData<GodotConcavePolygonShape3D::Face> *this, long param_1) {
   undefined8 *puVar1;
   puVar1 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), param_1 + 0x10, false);
   if (puVar1 != (undefined8*)0x0) {
      *puVar1 = 1;
...
/* CowData<GodotConcavePolygonShape3D::BVH>::_realloc(long) */undefined8 CowData<GodotConcavePolygonShape3D::BVH>::_realloc(CowData<GodotConcavePolygonShape3D::BVH> *this, long param_1) {
   undefined8 *puVar1;
   puVar1 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), param_1 + 0x10, false);
   if (puVar1 != (undefined8*)0x0) {
      *puVar1 = 1;
...
/* GodotShape3D::configure(AABB const&) */void GodotShape3D::_GLOBAL__sub_I_configure(void) {
   edge_support_threshold_lower = _LC129;
   cylinder_edge_support_threshold_lower = _LC130;
   return;
}
/* WARNING: Control flow encountered bad instruction data *//* GodotConvexPolygonShape3D::~GodotConvexPolygonShape3D() */void GodotConvexPolygonShape3D::~GodotConvexPolygonShape3D(GodotConvexPolygonShape3D *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* GodotWorldBoundaryShape3D::~GodotWorldBoundaryShape3D() */void GodotWorldBoundaryShape3D::~GodotWorldBoundaryShape3D(GodotWorldBoundaryShape3D *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* GodotSeparationRayShape3D::~GodotSeparationRayShape3D() */void GodotSeparationRayShape3D::~GodotSeparationRayShape3D(GodotSeparationRayShape3D *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* GodotSphereShape3D::~GodotSphereShape3D() */void GodotSphereShape3D::~GodotSphereShape3D(GodotSphereShape3D *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* GodotBoxShape3D::~GodotBoxShape3D() */void GodotBoxShape3D::~GodotBoxShape3D(GodotBoxShape3D *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* GodotCapsuleShape3D::~GodotCapsuleShape3D() */void GodotCapsuleShape3D::~GodotCapsuleShape3D(GodotCapsuleShape3D *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* GodotCylinderShape3D::~GodotCylinderShape3D() */void GodotCylinderShape3D::~GodotCylinderShape3D(GodotCylinderShape3D *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* GodotConcavePolygonShape3D::~GodotConcavePolygonShape3D() */void GodotConcavePolygonShape3D::~GodotConcavePolygonShape3D(GodotConcavePolygonShape3D *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* GodotHeightMapShape3D::~GodotHeightMapShape3D() */void GodotHeightMapShape3D::~GodotHeightMapShape3D(GodotHeightMapShape3D *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* GodotFaceShape3D::~GodotFaceShape3D() */void GodotFaceShape3D::~GodotFaceShape3D(GodotFaceShape3D *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

uint hb_ot_math_get_glyph_kernings(hb_font_t *param_1, uint param_2, uint param_3, uint param_4, uint *param_5, long param_6) {
   long *plVar1;
   hb_face_t *phVar2;
   ushort uVar3;
   uint uVar4;
         ...
         if (uVar4 != 0) {
            ...
            while (true) {
               ...
               if ((uint)uVar3 != (uint)uVar14) {
                  uVar5 = OT::MathValueRecord::get_y_value((MathValueRecord*)( puVar13 + uVar14 * 2 + 1 ), param_1, puVar13);
               }

               uVar6 = OT::MathValueRecord::get_x_value((MathValueRecord*)( puVar13 + ( uVar14 + uVar8 ) * 2 + 1 ), param_1, puVar13);
...
;
   ...
   return local_3c;
   code_r0x0010029c:if (lVar9 != 0) {
      LAB_00100210:lVar10 = hb_blob_get_empty();
      if (lVar9 != lVar10) {
...
bool hb_ot_math_has_data(long param_1) {
   ...
   code_r0x00100380:if (lVar2 != 0) {
      LAB_00100341:lVar3 = hb_blob_get_empty();
      if (lVar2 != lVar3) {
...
bool hb_ot_math_is_glyph_extended_shape(long param_1, uint param_2) {
   ...
   return iVar3 != -1;
   code_r0x001004a4:if (lVar4 != 0) {
      LAB_0010044d:lVar5 = hb_blob_get_empty();
      if (lVar4 != lVar5) {
...
long hb_ot_math_get_min_connector_overlap(long param_1, uint param_2) {
   ...
   code_r0x001005b2:if (lVar4 != 0) {
      LAB_00100574:lVar5 = hb_blob_get_empty();
      if (lVar4 != lVar5) {
         hb_blob_destroy(lVar4);
      }
...
void hb_ot_math_get_glyph_italics_correction(hb_font_t *param_1, uint param_2) {
   ...
   return;
   code_r0x0010070c:if (lVar7 != 0) {
      LAB_001006b5:lVar8 = hb_blob_get_empty();
      if (lVar7 != lVar8) {
...
void hb_ot_math_get_glyph_variants(long param_1, uint param_2, uint param_3, undefined4 param_4, undefined8 param_5, undefined8 param_6) {
   long *plVar1;
   ushort uVar2;
   long lVar3;
   hb_face_t *phVar4;
   ...
   return;
   code_r0x00100916:if (lVar7 != 0) {
      LAB_00100880:lVar8 = hb_blob_get_empty();
      if (lVar7 != lVar8) {
         hb_blob_destroy(lVar7);
      }
...
ulong hb_ot_math_get_glyph_top_accent_attachment(hb_font_t *param_1, uint param_2) {
   ...
   if (uVar4 == 0xffffffff) {
      ...
      iVar5 = ( **(code**)( *(long*)( param_1 + 0x90 ) + 0x48 ) )(param_1, *(undefined8*)( param_1 + 0x98 ), param_2, lVar11);
   ...
   return uVar7;
   code_r0x00100ab2:if (lVar8 != 0) {
      LAB_00100a74:lVar9 = hb_blob_get_empty();
      if (lVar8 != lVar9) {
...
void hb_ot_math_get_glyph_assembly(long param_1, uint param_2, uint param_3, undefined4 param_4, undefined8 param_5, undefined8 param_6) {
   long *plVar1;
   ushort uVar2;
   long lVar3;
   hb_face_t *phVar4;
   ...
   return;
   code_r0x00100d13:if (lVar6 != 0) {
      LAB_00100c5a:lVar7 = hb_blob_get_empty();
      if (lVar6 != lVar7) {
...
ulong hb_ot_math_get_constant(hb_font_t *param_1, uint param_2) {
   ...
   if (param_2 < 0x38) {
      if (param_2 < 4) {
         if (1 < param_2) {
            return (long)(short)( *(ushort*)( puVar9 + (long)(int)param_2 * 2 ) << 8 | *(ushort*)( puVar9 + (long)(int)param_2 * 2 ) >> 8 ) * *(long*)( param_1 + 0x60 ) + 0x8000 >> 0x10;
         }

         return (ulong)(uint)(int)(short)( *(ushort*)( puVar9 + (ulong)param_2 * 2 ) << 8 | *(ushort*)( puVar9 + (ulong)param_2 * 2 ) >> 8 );
      }

      uVar5 = 1L << ( (byte)param_2 & 0x3f );
      if (( uVar5 & 0x1ffdfffffdfff0 ) != 0) {
         uVar5 = OT::MathValueRecord::get_y_value((MathValueRecord*)( puVar9 + (long)(int)param_2 * 4 + -8 ), param_1, puVar9);
         return uVar5;
      }

      if (( uVar5 & 0x60020000020000 ) != 0) {
         uVar5 = OT::MathValueRecord::get_x_value((MathValueRecord*)( puVar9 + (long)(int)param_2 * 4 + -8 ), param_1, puVar9);
         return uVar5;
      }

      if (param_2 == 0x37) {
         return (ulong)(uint)(int)(short)( *(ushort*)( puVar9 + 0xd4 ) << 8 | *(ushort*)( puVar9 + 0xd4 ) >> 8 );
      }

   }

   return 0;
   code_r0x00100f12:if (lVar6 != 0) {
      LAB_00100ebc:lVar7 = hb_blob_get_empty();
      if (lVar6 != lVar7) {
         hb_blob_destroy(lVar6);
      }
   ...
   if (uVar3 == 0) {
      ...
      do {
         while (true) {
            ...
            iVar5 = OT::MathValueRecord::get_y_value((MathValueRecord*)( puVar12 + (ulong)uVar10 * 2 + 1 ), param_1, puVar12);
            iVar5 = iVar5 * uVar4;
...
;
 ...
 while ( (int)uVar13 <= iVar14 );
      LAB_0010107c:lVar16 = (ulong)uVar3 + (ulong)uVar13;
   }

   LAB_00101087:uVar7 = OT::MathValueRecord::get_x_value((MathValueRecord*)( puVar12 + lVar16 * 2 + 1 ), param_1, puVar12);
   return uVar7;
   code_r0x00101186:if (lVar8 != 0) {
      LAB_001010f8:lVar9 = hb_blob_get_empty();
      if (lVar8 != lVar9) {
         hb_blob_destroy(lVar8);
      }
      ...
      if (uVar1 != 0) {
         ...
         do {
            while (true) {
               ...
               if (param_1 <= ( ushort )(*(ushort*)( pCVar5 + 2 ) << 8 | *(ushort*)( pCVar5 + 2 ) >> 8)) goto LAB_00101243;
               iVar4 = uVar2 + 1;
...
;
 ...
 while ( iVar4 <= iVar6 );
      ...
      LAB_0010121e:uVar1 = __hb_Null_OT_RangeRecord << 8 | __hb_Null_OT_RangeRecord >> 8;
      if (uVar1 <= ( ushort )(_DAT_00105002 << 8 | _DAT_00105002 >> 8)) {
         pCVar5 = (Coverage*)&_hb_Null_OT_RangeRecord;
         LAB_00101243:return ( ( uint )(ushort)(*(ushort*)( pCVar5 + 4 ) << 8 | *(ushort*)( pCVar5 + 4 ) >> 8) - (uint)uVar1 ) + param_1;
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* OT::MathValueRecord::get_x_value(hb_font_t*, void const*) const */int OT::MathValueRecord::get_x_value(MathValueRecord *this, hb_font_t *param_1, void *param_2) {
   int iVar1;
   long lVar2;
   byte bVar3;
   int iVar4;
   ...
   iVar4 = (int)( ( ulong )((long)(short)( *(ushort*)this << 8 | *(ushort*)this >> 8 ) * *(long*)( param_1 + 0x58 ) + 0x8000) >> 0x10 );
   ...
   if (( ushort )(uVar24 << 8 | uVar24 >> 8) < 4) {
      ...
      uVar15 = ( ushort )(uVar24 << 8 | uVar24 >> 8) >> ( 0x10U - (char)( ( ( 1 << ( 4 - bVar3 & 0x1f ) ) - 1U & uVar15 ) + 1 << ( bVar3 & 0x1f ) ) & 0x1f ) & uVar5;
      if (uVar5 + 1 >> 1 <= uVar15) {
   ...
   if (uVar11 < ( ushort )(_DAT_0010500e << 8 | _DAT_0010500e >> 8)) {
      ...
      if (uVar11 != 0) {
         puVar23 = (ushort*)( &_hb_NullPool + ( uVar11 >> 0x18 | ( uVar11 & 0xff0000 ) >> 8 | ( uVar11 & 0xff00 ) << 8 | uVar11 << 0x18 ) );
      }

      puVar14 = (ushort*)&_hb_NullPool;
      if (_DAT_0010500a != 0) {
         puVar14 = (ushort*)( &_hb_NullPool + ( _DAT_0010500a >> 0x18 | ( _DAT_0010500a & 0xff0000 ) >> 8 | ( _DAT_0010500a & 0xff00 ) << 8 | _DAT_0010500a << 0x18 ) );
      }
                        ...
                        do {
                           ...
                           if ((uint)lVar7 < uVar15) {
                              ...
                              if (( uVar22 != 0 ) && ( iVar1 != iVar20 )) {
                                 ...
                                 if (( ( iVar18 <= iVar20 ) && ( iVar20 <= iVar12 ) ) && ( ( -1 < (short)uVar17 || ( (short)uVar22 < 1 ) ) )) {
 ...
 while ( (uint)lVar7 < (uint)uVar24 );
                     ...
                     LAB_0010159e:fVar27 = 0.0;
                  }

                  uVar6 = *(uint*)( puVar13 + lVar8 * 4 );
                  lVar8 = lVar8 + 1;
                  fVar28 = fVar28 + (float)(int)( uVar6 >> 0x18 | ( uVar6 & 0xff0000 ) >> 8 | ( uVar6 & 0xff00 ) << 8 | uVar6 << 0x18 ) * fVar27;
               }
                     ...
                     do {
                        ...
                        if ((uint)lVar7 < uVar15) {
                           ...
                           if (( uVar19 != 0 ) && ( iVar1 != iVar20 )) {
                              ...
                              if (( ( iVar12 <= iVar20 ) && ( iVar20 <= iVar18 ) ) && ( ( -1 < (short)uVar19 || ( (short)uVar22 < 1 ) ) )) {
 ...
 while ( (uint)lVar7 < (uint)uVar24 );
                  ...
                  LAB_00101733:fVar27 = 0.0;
               }

               lVar7 = uVar16 * 2;
               uVar16 = uVar16 + 1;
               fVar28 = fVar28 + (float)(int)(short)( *(ushort*)( puVar13 + lVar7 + lVar8 ) << 8 | *(ushort*)( puVar13 + lVar7 + lVar8 ) >> 8 ) * fVar27;
            }
 while ( (uint)uVar16 < uVar5 );
         ...
         if (uVar11 < uVar9) {
            uVar16 = 0;
            do {
               uVar5 = ( uint )(ushort)(puVar23[(ulong)uVar11 + uVar16 + 3] << 8 | puVar23[(ulong)uVar11 + uVar16 + 3] >> 8);
 ...
 while ( bVar25 );
   ...
   fVar28 = 0.0;
   LAB_001013f6:fVar28 = _LC2 + fVar28 * *(float*)( param_1 + 0x4c );
   if ((float)( (uint)fVar28 & _LC5 ) < _LC3) {
      fVar28 = (float)( ( uint )((float)(int)fVar28 - (float)( -(uint)(fVar28 < (float)(int)fVar28) & (uint)_LC1 )) | ~_LC5 & (uint)fVar28 );
   }

   return (int)fVar28 + iVar4;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* OT::MathValueRecord::get_y_value(hb_font_t*, void const*) const */int OT::MathValueRecord::get_y_value(MathValueRecord *this, hb_font_t *param_1, void *param_2) {
   int iVar1;
   long lVar2;
   byte bVar3;
   int iVar4;
   ...
   float fVar28;
   puVar21 = (uint*)&_hb_NullPool;
   iVar4 = (int)( ( ulong )((long)(short)( *(ushort*)this << 8 | *(ushort*)this >> 8 ) * *(long*)( param_1 + 0x60 ) + 0x8000) >> 0x10 );
   uVar24 = *(ushort*)( this + 2 );
   if (uVar24 != 0) {
      puVar21 = (uint*)( (long)param_2 + ( ulong )(ushort)(uVar24 << 8 | uVar24 >> 8) );
   }
 ...
 while ( bVar25 );
   ...
   fVar28 = 0.0;
   LAB_00101bc6:fVar28 = _LC2 + fVar28 * *(float*)( param_1 + 0x50 );
   if ((float)( (uint)fVar28 & _LC5 ) < _LC3) {
      fVar28 = (float)( ( uint )((float)(int)fVar28 - (float)( -(uint)(fVar28 < (float)(int)fVar28) & (uint)_LC1 )) | ~_LC5 & (uint)fVar28 );
   }
...
/* OT::MathValueRecord::sanitize(hb_sanitize_context_t*, void const*) const */undefined8 OT::MathValueRecord::sanitize(MathValueRecord *this, hb_sanitize_context_t *param_1, void *param_2) {
   ushort uVar1;
   int iVar2;
   uint uVar3;
   ushort *puVar4;
   ...
   if (this + ( 4 - *(long*)( param_1 + 8 ) ) <= (MathValueRecord*)( ulong ) * (uint*)( param_1 + 0x18 )) {
      ...
      if (( ulong )((long)puVar4 + ( 6 - *(long*)( param_1 + 8 ) )) <= ( ulong ) * (uint*)( param_1 + 0x18 )) {
         ...
         if (( ( ( ulong )((long)puVar4 - *(long*)( param_1 + 8 )) <= ( ulong ) * (uint*)( param_1 + 0x18 ) ) && ( uVar3 <= ( uint )((int)*(undefined8*)( param_1 + 0x10 ) - (int)puVar4) ) ) && ( iVar2 = *(int*)( param_1 + 0x1c ) ),*(uint*)( param_1 + 0x1c ) = iVar2 - uVar3,0 < (int)( iVar2 - uVar3 )) {
            return 1;
         }

      }

      if (( *(uint*)( param_1 + 0x2c ) < 0x20 ) && ( *(uint*)( param_1 + 0x2c ) = *(uint*)( param_1 + 0x2c ) + 1 ),param_1[0x28] != (hb_sanitize_context_t)0x0) {
         *(undefined2*)( this + 2 ) = 0;
         return 1;
      }
...
/* OT::MathItalicsCorrectionInfo::sanitize(hb_sanitize_context_t*) const */undefined8 OT::MathItalicsCorrectionInfo::sanitize(MathItalicsCorrectionInfo *this, hb_sanitize_context_t *param_1) {
   ushort uVar1;
   ushort uVar2;
   int iVar3;
   long lVar4;
   ...
   pMVar6 = this + 4;
   if ((MathItalicsCorrectionInfo*)( ulong ) * (uint*)( param_1 + 0x18 ) < pMVar6 + -*(long *)(param_1 + 8)) {
      return 0;
   }

   if ((MathItalicsCorrectionInfo*)( ulong ) * (uint*)( param_1 + 0x18 ) < this + ( 2 - *(long*)( param_1 + 8 ) )) {
      return 0;
   }
   ...
   if (uVar1 != 0) {
      ...
      if (pMVar9 + ( 2 - *(long*)( param_1 + 8 ) ) <= (MathItalicsCorrectionInfo*)( ulong ) * (uint*)( param_1 + 0x18 )) {
         if (*(short*)pMVar9 == 0x100) {
            if (pMVar9 + ( 4 - *(long*)( param_1 + 8 ) ) <= (MathItalicsCorrectionInfo*)( ulong ) * (uint*)( param_1 + 0x18 )) {
               ...
               if (pMVar9 + ( 4 - lVar4 ) <= pMVar5) {
                  ...
                  LAB_001025a4:if (( uVar8 * 2 <= ( uint )((int)*(undefined8*)( param_1 + 0x10 ) - ( (int)pMVar9 + 4 )) ) && ( iVar3 = *(int*)( param_1 + 0x1c ) + uVar8 * -2 ),*(int*)( param_1 + 0x1c ) = iVar3,0 < iVar3) goto LAB_00102384;
               }
   ...
   LAB_0010237d:lVar4 = *(long*)( param_1 + 8 );
   pMVar5 = (MathItalicsCorrectionInfo*)( ulong ) * (uint*)( param_1 + 0x18 );
   LAB_00102384:if (( ( ( pMVar5 < pMVar6 + -lVar4 ) || ( ( ulong ) * (uint*)( param_1 + 0x18 ) < ( ulong )((long)pMVar6 - *(long*)( param_1 + 8 )) ) ) || ( uVar8 = ( uint )(ushort)(*(ushort*)( this + 2 ) << 8 | *(ushort*)( this + 2 ) >> 8)(uint)((int)*(undefined8*)( param_1 + 0x10 ) - (int)pMVar6) < uVar8 * 4 ) ) || ( iVar3 = *(int*)( param_1 + 0x1c ) + uVar8 * -4 ),*(int*)( param_1 + 0x1c ) = iVar3,iVar3 < 1) {
      return 0;
   }
 ...
 while ( this + ( ulong )(uVar1 - 1) * 4 + 0xc != pMVar6 );
   ...
   return 1;
   LAB_00102423:pMVar9 = this + ( ushort )(uVar2 << 8 | uVar2 >> 8);
   if ((MathItalicsCorrectionInfo*)( ulong ) * (uint*)( param_1 + 0x18 ) < pMVar9 + ( 6 - *(long*)( param_1 + 8 ) )) {
      LAB_00102528:if (( 0x1f < *(uint*)( param_1 + 0x2c ) ) || ( *(uint*)( param_1 + 0x2c ) = *(uint*)( param_1 + 0x2c ) + 1 ),param_1[0x28] == (hb_sanitize_context_t)0x0) {
         return 0;
      }
      ...
      *(undefined2*)( pMVar6 + -2 ) = 0;
      ...
      if (( ushort )(( uVar2 << 8 | uVar2 >> 8 ) - 1) < 3) {
         ...
         if (( ( (MathItalicsCorrectionInfo*)( ulong ) * (uint*)( param_1 + 0x18 ) < pMVar9 + -*(long *)(param_1 + 8) ) || ( ( uint )((int)*(undefined8*)( param_1 + 0x10 ) - (int)pMVar9) < uVar8 ) ) || ( iVar3 = *(int*)( param_1 + 0x1c ) ),*(uint*)( param_1 + 0x1c ) = iVar3 - uVar8,(int)( iVar3 - uVar8 ) < 1) goto LAB_00102528;
      }
...
/* OT::MathTopAccentAttachment::sanitize(hb_sanitize_context_t*) const */undefined8 OT::MathTopAccentAttachment::sanitize(MathTopAccentAttachment *this, hb_sanitize_context_t *param_1) {
   ushort uVar1;
   ushort uVar2;
   int iVar3;
   long lVar4;
   ...
   if ((MathTopAccentAttachment*)( ulong ) * (uint*)( param_1 + 0x18 ) < this + ( 2 - *(long*)( param_1 + 8 ) )) {
      return 0;
   }
   ...
   if (uVar1 != 0) {
      pMVar9 = this + ( ushort )(uVar1 << 8 | uVar1 >> 8);
      if (pMVar9 + ( 2 - *(long*)( param_1 + 8 ) ) <= (MathTopAccentAttachment*)( ulong ) * (uint*)( param_1 + 0x18 )) {
         if (*(short*)pMVar9 == 0x100) {
            if (pMVar9 + ( 4 - *(long*)( param_1 + 8 ) ) <= (MathTopAccentAttachment*)( ulong ) * (uint*)( param_1 + 0x18 )) {
               lVar4 = *(long*)( param_1 + 8 );
               pMVar5 = (MathTopAccentAttachment*)( ulong ) * (uint*)( param_1 + 0x18 );
               if (pMVar9 + ( 4 - lVar4 ) <= pMVar5) {
                  uVar8 = ( uint )(ushort)(*(ushort*)( pMVar9 + 2 ) << 8 | *(ushort*)( pMVar9 + 2 ) >> 8);
                  LAB_001028b4:if (( uVar8 * 2 <= ( uint )((int)*(undefined8*)( param_1 + 0x10 ) - ( (int)pMVar9 + 4 )) ) && ( iVar3 = *(int*)( param_1 + 0x1c ) + uVar8 * -2 ),*(int*)( param_1 + 0x1c ) = iVar3,0 < iVar3) goto LAB_00102694;
               }
   ...
   LAB_0010268d:lVar4 = *(long*)( param_1 + 8 );
   pMVar5 = (MathTopAccentAttachment*)( ulong ) * (uint*)( param_1 + 0x18 );
   LAB_00102694:if (( ( ( pMVar5 < pMVar6 + -lVar4 ) || ( ( ulong ) * (uint*)( param_1 + 0x18 ) < ( ulong )((long)pMVar6 - *(long*)( param_1 + 8 )) ) ) || ( uVar8 = ( uint )(ushort)(*(ushort*)( this + 2 ) << 8 | *(ushort*)( this + 2 ) >> 8)(uint)((int)*(undefined8*)( param_1 + 0x10 ) - (int)pMVar6) < uVar8 * 4 ) ) || ( iVar3 = *(int*)( param_1 + 0x1c ) + uVar8 * -4 ),*(int*)( param_1 + 0x1c ) = iVar3,iVar3 < 1) {
      return 0;
   }
 ...
 while ( this + ( ulong )(uVar1 - 1) * 4 + 0xc != pMVar6 );
   ...
   return 1;
   LAB_00102733:pMVar9 = this + ( ushort )(uVar2 << 8 | uVar2 >> 8);
   if ((MathTopAccentAttachment*)( ulong ) * (uint*)( param_1 + 0x18 ) < pMVar9 + ( 6 - *(long*)( param_1 + 8 ) )) {
      LAB_00102838:if (( 0x1f < *(uint*)( param_1 + 0x2c ) ) || ( *(uint*)( param_1 + 0x2c ) = *(uint*)( param_1 + 0x2c ) + 1 ),param_1[0x28] == (hb_sanitize_context_t)0x0) {
         return 0;
      }
      ...
      *(undefined2*)( pMVar6 + -2 ) = 0;
      ...
      if (( ushort )(( uVar2 << 8 | uVar2 >> 8 ) - 1) < 3) {
         ...
         if (( ( (MathTopAccentAttachment*)( ulong ) * (uint*)( param_1 + 0x18 ) < pMVar9 + -*(long *)(param_1 + 8) ) || ( ( uint )((int)*(undefined8*)( param_1 + 0x10 ) - (int)pMVar9) < uVar8 ) ) || ( iVar3 = *(int*)( param_1 + 0x1c ) ),*(uint*)( param_1 + 0x1c ) = iVar3 - uVar8,(int)( iVar3 - uVar8 ) < 1) goto LAB_00102838;
      }
...
/* OT::MathKernInfo::sanitize(hb_sanitize_context_t*) const */undefined8 OT::MathKernInfo::sanitize(MathKernInfo *this, hb_sanitize_context_t *param_1) {
   MathKernInfo *pMVar1;
   char cVar2;
   ushort uVar3;
   ushort uVar4;
      ...
      if (pMVar9 + ( 2 - *(long*)( param_1 + 8 ) ) <= (MathKernInfo*)( ulong ) * (uint*)( param_1 + 0x18 )) {
         if (*(short*)pMVar9 == 0x100) {
            ...
            if (( ulong )((long)pMVar11 - *(long*)( param_1 + 8 )) <= ( ulong ) * (uint*)( param_1 + 0x18 )) {
               ...
               if (( ( ulong )((long)pMVar11 - lVar8) <= uVar6 ) && ( uVar5 = ( uint )(ushort)(*(ushort*)( pMVar9 + 2 ) << 8 | *(ushort*)( pMVar9 + 2 ) >> 8) ),uVar5 * 2 <= ( uint )((int)*(undefined8*)( param_1 + 0x10 ) - (int)pMVar11)) {
                  iVar7 = *(int*)( param_1 + 0x1c ) + uVar5 * -2;
                  *(int*)( param_1 + 0x1c ) = iVar7;
                  joined_r0x00102bd1:if (0 < iVar7) goto LAB_001029b7;
               }
            ...
            if (( ulong )((long)pMVar11 - *(long*)( param_1 + 8 )) <= ( ulong ) * (uint*)( param_1 + 0x18 )) {
               lVar8 = *(long*)( param_1 + 8 );
               uVar6 = ( ulong ) * (uint*)( param_1 + 0x18 );
               if (( ( ulong )((long)pMVar11 - lVar8) <= uVar6 ) && ( uVar3 = *(ushort*)( pMVar9 + 2 ) << 8 | *(ushort*)( pMVar9 + 2 ) >> 8 ),iVar7 = (uint)uVar3 + (uint)uVar3 * 2,( uint )(iVar7 * 2) <= ( uint )((int)*(undefined8*)( param_1 + 0x10 ) - (int)pMVar11)) {
   ...
   LAB_001029b0:lVar8 = *(long*)( param_1 + 8 );
   uVar6 = ( ulong ) * (uint*)( param_1 + 0x18 );
   LAB_001029b7:if (( ( ( uVar6 < ( ulong )((long)pMVar10 - lVar8) ) || ( ( ulong ) * (uint*)( param_1 + 0x18 ) < ( ulong )((long)pMVar10 - *(long*)( param_1 + 8 )) ) ) || ( uVar5 = ( uint )(ushort)(*(ushort*)( this + 2 ) << 8 | *(ushort*)( this + 2 ) >> 8)(uint)((int)*(undefined8*)( param_1 + 0x10 ) - (int)pMVar10) < uVar5 * 8 ) ) || ( iVar7 = *(int*)( param_1 + 0x1c ) + uVar5 * -8 ),*(int*)( param_1 + 0x1c ) = iVar7,iVar7 < 1) {
      return 0;
   }
      ...
      do {
         ...
         do {
            ...
            if (uVar4 != 0) {
               ...
               pMVar11 = pMVar1 + 2;
               if (( ( ( ulong ) * (uint*)( param_1 + 0x18 ) < ( ulong )((long)pMVar11 - *(long*)( param_1 + 8 )) ) || ( ( ulong ) * (uint*)( param_1 + 0x18 ) < ( ulong )((long)pMVar11 - *(long*)( param_1 + 8 )) ) ) || ( ( uVar4 = *(ushort*)pMVar1 << 8 | *(ushort*)pMVar1 >> 8 ),uVar5 = uVar4 + 1 + (uint)uVar4,( uint )((int)*(undefined8*)( param_1 + 0x10 ) - (int)pMVar11) < uVar5 * 4 || ( iVar7 = *(int*)( param_1 + 0x1c ) + uVar5 * -4 ),*(int*)( param_1 + 0x1c ) = iVar7,iVar7 < 1 )) {
                  LAB_00102b18:if (0x1f < *(uint*)( param_1 + 0x2c )) {
                     return 0;
                  }
...
/* OT::MathGlyphInfo::sanitize(hb_sanitize_context_t*) const */undefined8 OT::MathGlyphInfo::sanitize(MathGlyphInfo *this, hb_sanitize_context_t *param_1) {
   ...
   uVar2 = *(ushort*)this;
   if (( uVar2 != 0 ) && ( cVar4 = MathItalicsCorrectionInfo::sanitize((MathItalicsCorrectionInfo*)( this + ( ushort )(uVar2 << 8 | uVar2 >> 8) ), param_1) ),cVar4 == '\0') {
      if (0x1f < *(uint*)( param_1 + 0x2c )) {
         return 0;
      }
   ...
   uVar2 = *(ushort*)( this + 2 );
   if (( uVar2 != 0 ) && ( cVar4 = MathTopAccentAttachment::sanitize((MathTopAccentAttachment*)( this + ( ushort )(uVar2 << 8 | uVar2 >> 8) ), param_1) ),cVar4 == '\0') {
      if (0x1f < *(uint*)( param_1 + 0x2c )) {
         return 0;
      }
   ...
   if (pMVar6 + ( 2 - *(long*)( param_1 + 8 ) ) <= (MathGlyphInfo*)( ulong ) * (uint*)( param_1 + 0x18 )) {
      if (*(short*)pMVar6 == 0x100) {
         pMVar1 = pMVar6 + 4;
         if (( ( ( ulong )((long)pMVar1 - *(long*)( param_1 + 8 )) <= ( ulong ) * (uint*)( param_1 + 0x18 ) ) && ( ( ulong )((long)pMVar1 - *(long*)( param_1 + 8 )) <= ( ulong ) * (uint*)( param_1 + 0x18 ) ) ) && ( uVar5 = ( uint )(ushort)(*(ushort*)( pMVar6 + 2 ) << 8 | *(ushort*)( pMVar6 + 2 ) >> 8) * 2 ),uVar5 <= ( uint )((int)*(undefined8*)( param_1 + 0x10 ) - (int)pMVar1)) {
            LAB_00102e0e:iVar3 = *(int*)( param_1 + 0x1c );
         ...
         pMVar1 = pMVar6 + 4;
         if (( ( ( ulong )((long)pMVar1 - *(long*)( param_1 + 8 )) <= ( ulong ) * (uint*)( param_1 + 0x18 ) ) && ( ( ulong )((long)pMVar1 - *(long*)( param_1 + 8 )) <= ( ulong ) * (uint*)( param_1 + 0x18 ) ) ) && ( uVar5 = ( uint )(ushort)(*(ushort*)( pMVar6 + 2 ) << 8 | *(ushort*)( pMVar6 + 2 ) >> 8) * 6 ),uVar5 <= ( uint )((int)*(undefined8*)( param_1 + 0x10 ) - (int)pMVar1)) goto LAB_00102e0e;
      }
   ...
   *(undefined2*)( this + 4 ) = 0;
   LAB_00102cd2:if ((MathGlyphInfo*)( ulong ) * (uint*)( param_1 + 0x18 ) < this + ( 8 - *(long*)( param_1 + 8 ) )) {
      return 0;
   }

   uVar2 = *(ushort*)( this + 6 );
   if (( uVar2 != 0 ) && ( cVar4 = MathKernInfo::sanitize((MathKernInfo*)( this + ( ushort )(uVar2 << 8 | uVar2 >> 8) ), param_1) ),cVar4 == '\0') {
      if (0x1f < *(uint*)( param_1 + 0x2c )) {
         return 0;
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* OT::MathGlyphAssembly::get_parts(hb_direction_t, hb_font_t*, unsigned int, unsigned int*,
   hb_ot_math_glyph_part_t*, int*) const */ushort OT::MathGlyphAssembly::get_parts(MathGlyphAssembly *this, uint param_2, hb_font_t *param_3, uint param_4, uint *param_5, uint *param_6, undefined4 *param_7) {
   uint *puVar1;
   uint uVar2;
   undefined4 uVar3;
   ulong uVar4;
      ...
      *param_5 = uVar8;
      ...
      if (pMVar12 == pMVar10) {
         ...
         while (true) {
            ...
            LAB_00102f8d:while (true) {
               *puVar6 = ( uint )(ushort)(*(ushort*)pMVar5 << 8 | *(ushort*)pMVar5 >> 8);
               for (int i = 0; i < 3; i++) {
                  puVar6[( i + 1 )] = ( uint )(( ulong )((short)( *(ushort*)( pMVar5 + ( 2*i + 2 ) ) << 8 | *(ushort*)( pMVar5 + ( 2*i + 2 ) ) >> 8 ) * lVar11 + 32768) >> 16);
               }
               ...
               LAB_001030f1:_hb_blob_reference = _hb_face_reference_table;
...
;
            ...
            LAB_00103082:uVar14 = __hb_CrapPool;
...
;
   ...
   LAB_00103048:if (param_7 != (undefined4*)0x0) {
...
/* OT::MathGlyphConstruction::sanitize(hb_sanitize_context_t*) const */undefined8 OT::MathGlyphConstruction::sanitize(MathGlyphConstruction *this, hb_sanitize_context_t *param_1) {
   ...
   if ((MathGlyphConstruction*)( ulong ) * (uint*)( param_1 + 0x18 ) < this + ( 2 - *(long*)( param_1 + 8 ) )) {
      return 0;
   }
   ...
   if (uVar7 != 0) {
      ...
      pMVar2 = this_00 + 6;
      if (( ( ( ulong )((long)pMVar2 - *(long*)( param_1 + 8 )) <= ( ulong ) * (uint*)( param_1 + 0x18 ) ) && ( cVar3 = MathValueRecord::sanitize(this_00, param_1, this_00) ),cVar3 != '\0' )) {
         lVar6 = *(long*)( param_1 + 8 );
         uVar5 = ( ulong ) * (uint*)( param_1 + 0x18 );
         if (( ( ( ulong )((long)pMVar2 - lVar6) <= uVar5 ) && ( uVar7 = *(ushort*)( this_00 + 4 ) << 8 | *(ushort*)( this_00 + 4 ) >> 8 ),iVar8 = (uint)uVar7 + (uint)uVar7 * 4,( uint )(iVar8 * 2) <= ( uint )((int)*(undefined8*)( param_1 + 0x10 ) - (int)pMVar2) )) &&( iVar8 = *(int*)( param_1 + 0x1c ) + iVar8 * -2 ),*(int*)( param_1 + 0x1c ) = iVar8,0 < iVar8;
      }
   ...
   lVar6 = *(long*)( param_1 + 8 );
   uVar5 = ( ulong ) * (uint*)( param_1 + 0x18 );
   LAB_0010318b:if (( ( ulong )((long)pMVar1 - lVar6) <= uVar5 ) && ( ( ulong )((long)pMVar1 - *(long*)( param_1 + 8 )) <= ( ulong ) * (uint*)( param_1 + 0x18 ) )) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* OT::MathGlyphConstruction::get_variants(hb_direction_t, hb_font_t*, unsigned int, unsigned int*,
   hb_ot_math_glyph_variant_t*) const */ushort OT::MathGlyphConstruction::get_variants(MathGlyphConstruction *this, uint param_2, long param_3, uint param_4, uint *param_5, uint *param_6) {
   MathGlyphConstruction *pMVar1;
   uint *puVar2;
   uint uVar3;
   ushort uVar4;
   ...
   *param_5 = uVar11;
   ...
   LAB_00103367:iVar8 = (int)uVar6;
   puVar9 = param_6;
   if (pMVar13 == pMVar5) {
      if (uVar11 == 0) {
         LAB_00103394:return *(ushort*)( this + 2 ) << 8 | *(ushort*)( this + 2 ) >> 8;
      }
   ...
   LAB_00103329:do {
      ...
      while (true) {
         *puVar9 = (uint)uVar10;
         ...
         LAB_001033b2:__hb_CrapPool = CONCAT44(_DAT_0010500c, CONCAT22(_DAT_0010500a, __hb_NullPool));
         puVar9 = (uint*)&_hb_CrapPool;
         if (uVar11 != 0) goto LAB_00103329;
         LAB_001033d0:uVar4 = _DAT_0010500a << 8 | _DAT_0010500a >> 8;
         uVar10 = __hb_NullPool << 8 | __hb_NullPool >> 8;
      }
;
      if (( uVar11 == 0 ) || ( param_6 == puVar2 )) goto LAB_00103394;
      LAB_00103432:__hb_CrapPool = CONCAT44(_DAT_0010500c, CONCAT22(_DAT_0010500a, __hb_NullPool));
      puVar9 = (uint*)&_hb_CrapPool;
   }
 while ( true );
}
/* OT::MathVariants::sanitize(hb_sanitize_context_t*) const */undefined8 OT::MathVariants::sanitize(MathVariants *this, hb_sanitize_context_t *param_1) {
   char cVar1;
   ushort uVar2;
   uint uVar3;
   MathVariants *pMVar4;
   ...
   uVar2 = *(ushort*)( this + 2 );
   if (uVar2 == 0) {
      LAB_001034ab:lVar6 = *(long*)( param_1 + 8 );
      ...
      if ((MathVariants*)( ulong ) * (uint*)( param_1 + 0x18 ) < pMVar4 + ( 2 - *(long*)( param_1 + 8 ) )) {
         LAB_001035be:if (0x1f < *(uint*)( param_1 + 0x2c )) {
            return 0;
         }
      ...
      if ((MathVariants*)( ulong ) * (uint*)( param_1 + 0x18 ) < pMVar4 + ( 4 - *(long*)( param_1 + 8 ) )) goto LAB_001035be;
      lVar6 = *(long*)( param_1 + 8 );
      pMVar7 = (MathVariants*)( ulong ) * (uint*)( param_1 + 0x18 );
      if (pMVar7 < pMVar4 + ( 4 - lVar6 )) goto LAB_001035be;
      uVar3 = ( uint )(ushort)(*(ushort*)( pMVar4 + 2 ) << 8 | *(ushort*)( pMVar4 + 2 ) >> 8);
      LAB_001036f0:if (( ( uint )((int)*(undefined8*)( param_1 + 0x10 ) - ( (int)pMVar4 + 4 )) < uVar3 * 2 ) || ( iVar8 = *(int*)( param_1 + 0x1c ) + uVar3 * -2 ),*(int*)( param_1 + 0x1c ) = iVar8,iVar8 < 1) goto LAB_001035be;
   }
   ...
   if (pMVar4 + ( 2 - *(long*)( param_1 + 8 ) ) <= (MathVariants*)( ulong ) * (uint*)( param_1 + 0x18 )) {
      if (*(short*)pMVar4 == 0x100) {
         if (( pMVar4 + ( 4 - *(long*)( param_1 + 8 ) ) <= (MathVariants*)( ulong ) * (uint*)( param_1 + 0x18 ) ) && ( pMVar4 + ( 4 - *(long*)( param_1 + 8 ) ) <= (MathVariants*)( ulong ) * (uint*)( param_1 + 0x18 ) )) {
            uVar3 = ( uint )(ushort)(*(ushort*)( pMVar4 + 2 ) << 8 | *(ushort*)( pMVar4 + 2 ) >> 8);
            LAB_00103653:if (( uVar3 * 2 <= ( uint )((int)*(undefined8*)( param_1 + 0x10 ) - ( (int)pMVar4 + 4 )) ) && ( iVar8 = *(int*)( param_1 + 0x1c ) + uVar3 * -2 ),*(int*)( param_1 + 0x1c ) = iVar8,0 < iVar8) goto LAB_001034cf;
         }
   ...
   *(undefined2*)( this + 4 ) = 0;
   LAB_001034cf:lVar6 = *(long*)( param_1 + 8 );
   uVar5 = ( ulong ) * (uint*)( param_1 + 0x18 );
   if (( ulong )((long)pMVar9 - lVar6) <= uVar5) {
      uVar3 = ( uint )(ushort)(*(ushort*)( this + 8 ) << 8 | *(ushort*)( this + 8 ) >> 8) + ( uint )(ushort)(*(ushort*)( this + 6 ) << 8 | *(ushort*)( this + 6 ) >> 8);
      if (( uVar3 * 2 <= ( uint )((int)*(undefined8*)( param_1 + 0x10 ) - (int)pMVar9) ) && ( iVar8 = *(int*)( param_1 + 0x1c ) + uVar3 * -2 ),*(int*)( param_1 + 0x1c ) = iVar8,0 < iVar8) {
         if (uVar3 == 0) {
            return 1;
         }
         ...
         while (( ulong )((long)pMVar9 - lVar6) <= uVar5) {
            ...
            if (( uVar2 != 0 ) && ( cVar1 = MathGlyphConstruction::sanitize((MathGlyphConstruction*)( this + ( ushort )(uVar2 << 8 | uVar2 >> 8) ), param_1) ),cVar1 == '\0') {
               if (0x1f < *(uint*)( param_1 + 0x2c )) {
                  return 0;
               }
...
/* OT::MATH::sanitize(hb_sanitize_context_t*) const */undefined8 OT::MATH::sanitize(MATH *this, hb_sanitize_context_t *param_1) {
   ushort uVar1;
   char cVar2;
   MathValueRecord *this_00;
   MATH *pMVar3;
   ...
   if (( *(short*)this == 0x100 ) && ( this + ( 6 - *(long*)( param_1 + 8 ) ) <= (MATH*)( ulong ) * (uint*)( param_1 + 0x18 ) )) {
      uVar1 = *(ushort*)( this + 4 );
      if (uVar1 != 0) {
         pMVar3 = this + ( ushort )(uVar1 << 8 | uVar1 >> 8);
         if ((MATH*)( ulong ) * (uint*)( param_1 + 0x18 ) < pMVar3 + ( 0xd6 - *(long*)( param_1 + 8 ) )) {
            LAB_0010389f:if (0x1f < *(uint*)( param_1 + 0x2c )) {
               return 0;
            }
 ...
 while ( (MathValueRecord*)( pMVar3 + 0xd4 ) != this_00 );
      ...
      if (this + ( 8 - *(long*)( param_1 + 8 ) ) <= (MATH*)( ulong ) * (uint*)( param_1 + 0x18 )) {
         uVar1 = *(ushort*)( this + 6 );
         if (( uVar1 != 0 ) && ( cVar2 = MathGlyphInfo::sanitize((MathGlyphInfo*)( this + ( ushort )(uVar1 << 8 | uVar1 >> 8) ), param_1) ),cVar2 == '\0') {
            if (0x1f < *(uint*)( param_1 + 0x2c )) {
               return 0;
            }
         ...
         if (this + ( 10 - *(long*)( param_1 + 8 ) ) <= (MATH*)( ulong ) * (uint*)( param_1 + 0x18 )) {
            uVar1 = *(ushort*)( this + 8 );
            if (( uVar1 != 0 ) && ( cVar2 = MathVariants::sanitize((MathVariants*)( this + ( ushort )(uVar1 << 8 | uVar1 >> 8) ), param_1) ),cVar2 == '\0') {
               if (0x1f < *(uint*)( param_1 + 0x2c )) {
                  return 0;
               }
...
/* hb_table_lazy_loader_t<OT::MATH, 40u, true>::create(hb_face_t*) */long hb_table_lazy_loader_t<OT::MATH,40u,true>::create(hb_face_t *param_1) {
   MATH *this;
   char cVar1;
   long lVar2;
   long lVar3;
   ...
   do {
      ...
      if (this == (MATH*)0x0) {
         ...
         LAB_00103a83:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
            return lVar2;
         }
      ...
      if (( local_4c == 0 ) || ( local_50 != '\0' )) {
         LAB_00103aa8:hb_blob_destroy(lVar3);
         LAB_00103ab0:hb_blob_destroy(lVar2);
         if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
            lVar3 = hb_blob_get_empty();
            return lVar3;
         }

         LAB_00103b5e:/* WARNING: Subroutine does not return */__stack_chk_fail();
      }

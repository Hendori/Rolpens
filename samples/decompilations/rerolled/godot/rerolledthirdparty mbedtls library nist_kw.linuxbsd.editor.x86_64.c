...
;
   ...
   if (iVar3 == 0) {
      ...
      if (( ( iVar3 != 0 ) || ( sVar2 = sVar2 != local_e0 ) ) || ( iVar3 = memcmp(local_78, kwp_res + lVar4 * 0x30, sVar2) ),iVar3 != 0) goto LAB_00100c40;
      ...
      if (( ( iVar3 != 0 ) || ( sVar1 != local_e0 ) ) || ( iVar3 = memcmp(local_78, kwp_msg + lVar4 * 0x1f, sVar1) ),iVar3 != 0) goto LAB_00100c40;
      if (param_1 == 0) {
         lVar4 = lVar4 + 1;
         if (lVar4 == 3) {

/* jolt_alloc(unsigned long) */void jolt_alloc(ulong param_1) {
   Memory::alloc_static(param_1, false);
   return;
}
/* jolt_realloc(void*, unsigned long, unsigned long) */void jolt_realloc(void *param_1, ulong param_2, ulong param_3) {
   Memory::realloc_static(param_1, param_3, false);
   return;
}
/* jolt_free(void*) */void jolt_free(void *param_1) {
   Memory::free_static(param_1, false);
   return;
}
/* jolt_aligned_alloc(unsigned long, unsigned long) */void jolt_aligned_alloc(ulong param_1, ulong param_2) {
   Memory::alloc_aligned_static(param_1, param_2);
   return;
}
/* jolt_aligned_free(void*) */void jolt_aligned_free(void *param_1) {
   Memory::free_aligned_static(param_1);
   return;
}
/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* jolt_initialize() */void jolt_initialize(void) {
   ...
   *JPH::Factory::sInstance = (undefined1[16])0x0;
   for (int i = 0; i < 3; i++) {
      JPH::Factory::sInstance[( i + 1 )] = (undefined1[16])0;
   }
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* jolt_deinitialize() */void jolt_deinitialize(void) {
   long *plVar1;

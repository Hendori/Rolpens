...
void __thiscall UIDUpgradeTool::~UIDUpgradeTool(UIDUpgradeTool *this)
...
/* UIDUpgradeDialog::_notification(int) [clone .part.0] */

void UIDUpgradeDialog::_notification(int param_1)
...
/* UIDUpgradeDialog::_notification(int) */

void __thiscall UIDUpgradeDialog::_notification(UIDUpgradeDialog *this,int param_1)
...
/* UIDUpgradeTool::begin_upgrade() */

void UIDUpgradeTool::begin_upgrade(void)
...
/* UIDUpgradeDialog::_on_custom_action(String const&) */

void __thiscall UIDUpgradeDialog::_on_custom_action(UIDUpgradeDialog *this,String *param_1)

{
  ...
  cVar2 = String::operator==(param_1,"uid_upgrade_learn_more");
  if (cVar2 != '\0') {
    plVar3 = (long *)OS::get_singleton();
    local_40 = 0;
    local_30 = 0x40;
    pcVar1 = *(code **)(*plVar3 + 0x150);
    local_38 = "https://godotengine.org/article/uid-changes-coming-to-godot-4-4/";
    String::parse_latin1((StrRange *)&local_40);
    (*pcVar1)(plVar3,(StrRange *)&local_40);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* UIDUpgradeDialog::popup_on_demand() */

void __thiscall UIDUpgradeDialog::popup_on_demand(UIDUpgradeDialog *this)
...
/* UIDUpgradeTool::finish_upgrade() */

void __thiscall UIDUpgradeTool::finish_upgrade(UIDUpgradeTool *this)

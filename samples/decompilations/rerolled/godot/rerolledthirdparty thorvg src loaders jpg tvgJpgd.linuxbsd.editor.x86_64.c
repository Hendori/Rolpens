/* jpeg_decoder_mem_stream::read(unsigned char*, int, bool*) */uint jpeg_decoder_mem_stream::read(jpeg_decoder_mem_stream *this, uchar *param_1, int param_2, bool *param_3) {
   uint uVar1;
   long lVar2;
   uint uVar3;
   lVar2 = *(long*)( this + 8 );
...
/* jpeg_decoder_file_stream::read(unsigned char*, int, bool*) */ulong jpeg_decoder_file_stream::read(jpeg_decoder_file_stream *this, uchar *param_1, int param_2, bool *param_3) {
   int iVar1;
   size_t sVar2;
...
/* jpeg_decoder_file_stream::~jpeg_decoder_file_stream() */void jpeg_decoder_file_stream::~jpeg_decoder_file_stream(jpeg_decoder_file_stream *this) {
   *(undefined***)this = &PTR__jpeg_decoder_file_stream_00112c08;
   if (*(FILE**)( this + 8 ) != (FILE*)0x0) {
      fclose(*(FILE**)( this + 8 ));
      return;
   }
...
/* jpeg_decoder::free_all_blocks() */void jpeg_decoder::free_all_blocks(jpeg_decoder *this) {
   undefined8 *puVar1;
   undefined8 *__ptr;
...
/* jpeg_decoder::stop_decoding(jpgd_status) */void jpeg_decoder::stop_decoding(jpeg_decoder *this, undefined4 param_2) {
   *(undefined4*)( this + 0x3548 ) = param_2;
   free_all_blocks(this);
   /* WARNING: Subroutine does not return */
   __longjmp_chk(this, param_2);
}
/* jpeg_decoder::alloc(unsigned long, bool) */undefined8 * __thiscall jpeg_decoder::alloc(jpeg_decoder *this,ulong param_1,bool param_2){
   undefined8 *puVar1;
   long lVar2;
   undefined8 *puVar3;
   ulong uVar4;
...
/* jpeg_decoder::word_clear(void*, unsigned short, unsigned int) */void jpeg_decoder::word_clear(jpeg_decoder *this, void *param_1, ushort param_2, uint param_3) {
   ushort *puVar1;
   ushort *puVar2;
   if (param_3 != 0) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* jpeg_decoder::prep_in_buffer() */void jpeg_decoder::prep_in_buffer(jpeg_decoder *this) {
   long lVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   int iVar4;
   ...
   *(jpeg_decoder**)( this + 0x328 ) = this + 0x3b9;
   if (this[0x338] == (jpeg_decoder)0x0) {
      iVar4 = 0;
      do {
         iVar4 = ( **(code**)( **(long**)( this + 0xd8 ) + 0x10 ) )(*(long**)( this + 0xd8 ), this + 0x3b9 + iVar4, 0x2000 - iVar4, this + 0x338);
         if (iVar4 == -1) {
            /* WARNING: Subroutine does not return */
...
/* jpeg_decoder::decode_block_dc_first(jpeg_decoder*, int, int, int) */void jpeg_decoder::decode_block_dc_first(jpeg_decoder *param_1, int param_2, int param_3, int param_4) {
   int iVar1;
   long *plVar2;
   long lVar3;
   long lVar4;
   ...
   if ((int)uVar9 < 0) {
      ...
      do {
         bVar7 = (byte)iVar8;
         iVar8 = iVar8 + -1;
         uVar9 = *(uint*)( lVar4 + 0x904 + (long)(int)-((*(uint *)(param_1 + 0x24c0) >> (bVar7 & 0x1f) & 1) + uVar9) * 4 );
      }
 while ( (int)uVar9 < 0 );
   ...
   *(short*)( (long)( (int)lVar6 * (int)lVar5 * param_4 ) + (long)( param_3 * (int)lVar5 ) + lVar3 ) = (short)( iVar8 + iVar1 << ( ( byte ) * (undefined4*)( param_1 + 0x234 ) & 0x1f ) );
   return;
}
/* jpeg_decoder::decode_block_dc_refine(jpeg_decoder*, int, int, int) */void jpeg_decoder::decode_block_dc_refine(jpeg_decoder *param_1, int param_2, int param_3, int param_4) {
   long *plVar1;
   int iVar2;
   ushort *puVar3;
...
/* jpeg_decoder::decode_block_ac_first(jpeg_decoder*, int, int, int) */void jpeg_decoder::decode_block_ac_first(jpeg_decoder *param_1, int param_2, int param_3, int param_4) {
   long *plVar1;
   long lVar2;
   long lVar3;
   long lVar4;
   ...
   if (iVar8 != 0) {
      LAB_00100707:*(int*)( param_1 + 0x310 ) = iVar8 + -1;
      return;
   }
   ...
   if (iVar8 <= *(int*)( param_1 + 0x230 )) {
      do {
         lVar3 = *(long*)( param_1 + (long)*(int*)( param_1 + ( (long)param_2 + 0x84 ) * 4 + 0xc ) * 8 + 0x290 );
         ...
         if ((int)uVar9 < 0) {
            ...
            do {
               bVar6 = (byte)iVar7;
               iVar7 = iVar7 + -1;
               uVar9 = *(uint*)( lVar3 + 0x904 + (long)(int)-((*(uint *)(param_1 + 0x24c0) >> (bVar6 & 0x1f) & 1) + uVar9) * 4 );
            }
 while ( (int)uVar9 < 0 );
         ...
         if (uVar9 == 0) {
            ...
            iVar8 = iVar8 + iVar7;
            if (0x3f < iVar8) {
               LAB_001006c5:/* WARNING: Subroutine does not return */stop_decoding(param_1, 0xffffff1a);
            }
            ...
            *(short*)( lVar2 + (long)*(int*)( g_ZAG + (long)iVar8 * 4 ) * 2 + (long)( param_3 * (int)lVar4 ) + (long)( (int)lVar5 * (int)lVar4 * param_4 ) ) = (short)( iVar7 << ( ( byte ) * (undefined4*)( param_1 + 0x234 ) & 0x1f ) );
         }
...
/* jpeg_decoder::decode_block_ac_refine(jpeg_decoder*, int, int, int) */void jpeg_decoder::decode_block_ac_refine(jpeg_decoder *param_1, int param_2, int param_3, int param_4) {
   short *psVar1;
   byte bVar2;
   short sVar3;
   int iVar4;
   ...
   lVar20 = (long)( (int)plVar6[1] * (int)plVar6[3] * param_4 ) + (long)( param_3 * (int)plVar6[3] ) + *plVar6;
      ...
      do {
         ...
         if ((int)uVar16 < 0) {
            ...
            do {
               bVar12 = (byte)iVar13;
               iVar13 = iVar13 + -1;
               uVar16 = *(uint*)( lVar7 + 0x904 + (long)(int)-((*(uint *)(param_1 + 0x24c0) >> (bVar12 & 0x1f) & 1) +
                                        uVar16) * 4 );
            }
 while ( (int)uVar16 < 0 );
                  ...
                  if (iVar18 < 2) {
                     if (iVar18 == 0) {
                        ...
                        *(uint*)( param_1 + 0x334 ) = uVar17 ^ 1;
                        ...
                        LAB_00100c60:pbVar8 = *(byte**)( param_1 + 0x328 );
                        iVar18 = iVar18 + -1;
                        pbVar15 = pbVar8 + 1;
                        ...
                        *(int*)( param_1 + 0x330 ) = iVar18;
                        ...
                        LAB_00100c8c:if (iVar18 != 0) goto LAB_00100bb8;
                     }
                     ...
                     if (iVar18 == 0) {
                        ...
                        *(uint*)( param_1 + 0x334 ) = uVar14 ^ 1;
                        ...
                        LAB_00100bb8:pbVar8 = *(byte**)( param_1 + 0x328 );
                        iVar18 = iVar18 + -1;
                        pbVar15 = pbVar8 + 1;
                        *(byte**)( param_1 + 0x328 ) = pbVar15;
                        uVar14 = ( uint ) * pbVar8;
                        ...
                        if (uVar14 == 0xff) {
                           if (iVar18 == 0) {
                              ...
                              *(uint*)( param_1 + 0x334 ) = *(uint*)( param_1 + 0x334 ) ^ 1;
                              ...
                              LAB_00100bea:*(byte**)( param_1 + 0x328 ) = pbVar15 + 1;
                              bVar12 = *pbVar15;
                     ...
                     LAB_00100b70:uVar17 = uVar14 | uVar17 | *(uint*)( param_1 + 0x24c0 );
                     iVar13 = *(int*)( param_1 + 0x24bc );
                  }
 else {
                     pbVar8 = *(byte**)( param_1 + 0x328 );
                     bVar12 = *pbVar8;
                     if (( bVar12 == 0xff ) || ( bVar2 = bVar2 == 0xff )) {
                        pbVar15 = pbVar8 + 1;
                        iVar18 = iVar18 + -1;
                        *(byte**)( param_1 + 0x328 ) = pbVar15;
                        bVar12 = *pbVar8;
 ...
 while ( (int)( uVar16 + 1 ) <= iVar13 );
         uVar16 = uVar16 + 1;
         LAB_00100924:if (( (int)uVar16 < 0x40 ) && ( bVar21 )) {
 ...
 while ( (int)uVar17 <= iVar13 );
   ...
   LAB_0010094d:if (0 < iVar13) {
      LAB_00100955:if ((int)uVar17 <= *(int*)( param_1 + 0x230 )) {
         do {
            while (( ( psVar1 = (short*)( lVar20 + (long)*(int*)( g_ZAG + ( ulong )(uVar17 & 0x3f) * 4 ) * 2 ) * psVar1 != 0 && ( iVar13 = get_bits_no_markers(param_1, 1) != 0 ) ) && ( sVar3 = *psVar1((int)sVar3 & uVar10) == 0 ) )) {
               sVar9 = local_48;
               if (-1 < sVar3) {
                  sVar9 = (short)uVar10;
               }
...
;
 ...
 while ( (int)uVar17 <= *(int*)( param_1 + 0x230 ) );
         LAB_001009d0:iVar13 = *(int*)( param_1 + 0x310 );
      }
...
/* jpeg_decoder::read_dht_marker() */void jpeg_decoder::read_dht_marker(jpeg_decoder *this) {
   byte bVar1;
   uint uVar2;
   int iVar3;
   byte *pbVar4;
   ...
   *(uint*)( this + 0x24c0 ) = uVar18 << ( (byte)iVar8 & 0x1f );
   ...
   if (iVar8 == 0) {
      ...
      *(uint*)( this + 0x334 ) = uVar14 ^ 1;
      ...
      LAB_0010154d:prep_in_buffer(this);
      iVar8 = *(int*)( this + 0x330 );
      if (iVar8 != 0) {
      ...
      *(uint*)( this + 0x334 ) = uVar6 ^ 1;
      ...
      LAB_001014b3:pbVar4 = *(byte**)( this + 0x328 );
      iVar8 = iVar8 + -1;
      pbVar12 = pbVar4 + 1;
      ...
      *(int*)( this + 0x330 ) = iVar8;
      ...
      LAB_001014d8:*(byte**)( this + 0x328 ) = pbVar12 + 1;
      uVar6 = ( uint ) * pbVar12;
   ...
   iVar10 = iVar8 + 0x10;
   *(int*)( this + 0x24bc ) = iVar10;
   *(uint*)( this + 0x24c0 ) = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar6 | uVar14 ) << ( -(char)iVar8 & 0x1fU );
   LAB_00100e78:if (uVar18 >> 0x10 < 2) {
      LAB_001015b2:/* WARNING: Subroutine does not return */stop_decoding(this, 0xffffff02);
   }

   uVar18 = ( uVar18 >> 0x10 ) - 2;
   if (uVar18 == 0) {
      LAB_00101478:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   ...
   LAB_00100ea0:uVar14 = *(uint*)( this + 0x24c0 );
   iVar8 = iVar10 + -8;
   ...
   *(uint*)( this + 0x24c0 ) = uVar14 << ( (byte)iVar10 & 0x1f );
   if (iVar8 == 0) {
      ...
      *(uint*)( this + 0x334 ) = uVar6 ^ 1;
      ...
      LAB_00101436:prep_in_buffer(this);
      iVar8 = *(int*)( this + 0x330 );
      if (iVar8 != 0) {
         pbVar12 = *(byte**)( this + 0x328 );
         goto LAB_00101383;
      ...
      *(uint*)( this + 0x334 ) = uVar16 ^ 1;
      ...
      LAB_00101358:pbVar4 = *(byte**)( this + 0x328 );
      iVar8 = iVar8 + -1;
      pbVar12 = pbVar4 + 1;
      *(byte**)( this + 0x328 ) = pbVar12;
      bVar1 = *pbVar4;
      *(int*)( this + 0x330 ) = iVar8;
      ...
      LAB_00101383:*(byte**)( this + 0x328 ) = pbVar12 + 1;
      uVar16 = ( uint ) * pbVar12;
      *(int*)( this + 0x330 ) = iVar8 + -1;
   }

   uVar6 = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar16 | uVar6 ) << ( -(char)*(int *)(this + 0x24bc) & 0x1fU );
   iVar8 = *(int*)( this + 0x24bc ) + 0x10;
   LAB_00100ec5:iVar10 = 0;
   puVar19 = &uStack_167;
   do {
         ...
         *(uint*)( this + 0x24c0 ) = uVar6 << ( (byte)iVar8 & 0x1f );
         ...
         if (iVar8 == 0) {
            ...
            *(uint*)( this + 0x334 ) = uVar16 ^ 1;
            ...
            LAB_0010123b:prep_in_buffer(this);
            iVar8 = *(int*)( this + 0x330 );
            if (iVar8 != 0) {
               pbVar12 = *(byte**)( this + 0x328 );
               goto LAB_00100f4b;
            ...
            *(uint*)( this + 0x334 ) = uVar9 ^ 1;
            ...
            LAB_00100f20:pbVar4 = *(byte**)( this + 0x328 );
            iVar8 = iVar8 + -1;
            pbVar12 = pbVar4 + 1;
            *(byte**)( this + 0x328 ) = pbVar12;
            bVar1 = *pbVar4;
            *(int*)( this + 0x330 ) = iVar8;
            ...
            LAB_00100f4b:*(byte**)( this + 0x328 ) = pbVar12 + 1;
            uVar9 = ( uint ) * pbVar12;
            *(int*)( this + 0x330 ) = iVar8 + -1;
         }
         ...
         while (true) {
            ...
            *(int*)( this + 0x24c0 ) = iVar3 << ( (byte)iVar8 & 0x1f );
            ...
            if (iVar8 == 0) {
               ...
               *(uint*)( this + 0x334 ) = uVar6 ^ 1;
               uVar6 = ( -(uint)(uVar6 == 0) & 0x2600 ) + 0xd900;
               LAB_001012b0:prep_in_buffer(this);
               iVar8 = *(int*)( this + 0x330 );
               if (iVar8 != 0) {
                  pbVar12 = *(byte**)( this + 0x328 );
                  goto LAB_00101042;
               ...
               *(uint*)( this + 0x334 ) = uVar16 ^ 1;
               ...
               LAB_00101019:pbVar4 = *(byte**)( this + 0x328 );
               iVar8 = iVar8 + -1;
               pbVar12 = pbVar4 + 1;
               *(byte**)( this + 0x328 ) = pbVar12;
               bVar1 = *pbVar4;
               *(int*)( this + 0x330 ) = iVar8;
               ...
               LAB_00101042:*(byte**)( this + 0x328 ) = pbVar12 + 1;
               uVar16 = ( uint ) * pbVar12;
               *(int*)( this + 0x330 ) = iVar8 + -1;
            }
            ...
            *(undefined1*)puVar20 = uVar13;
            ...
            iVar8 = iVar3 + 0x10;
            *(int*)( this + 0x24bc ) = iVar8;
            *(uint*)( this + 0x24c0 ) = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar16 | uVar6 ) << ( -(char)iVar3 & 0x1fU );
...
;
 ...
 while ( puVar17 != puVar20 );
   ...
   LAB_00101091:if (uVar18 < iVar10 + 0x11U) goto LAB_001015b2;
...
/* jpeg_decoder::read_dqt_marker() */void jpeg_decoder::read_dqt_marker(jpeg_decoder *this) {
   byte bVar1;
   byte bVar2;
   byte *pbVar3;
   int iVar4;
   ...
   *(uint*)( this + 0x24c0 ) = uVar11 << ( (byte)iVar5 & 0x1f );
   if (iVar4 == 0) {
      ...
      *(uint*)( this + 0x334 ) = uVar9 ^ 1;
      ...
      LAB_00101b2f:prep_in_buffer(this);
      iVar4 = *(int*)( this + 0x330 );
      if (iVar4 != 0) {
      ...
      *(uint*)( this + 0x334 ) = uVar12 ^ 1;
      ...
      LAB_00101a8f:pbVar3 = *(byte**)( this + 0x328 );
      iVar4 = iVar4 + -1;
      pbVar10 = pbVar3 + 1;
      ...
      *(int*)( this + 0x330 ) = iVar4;
      ...
      LAB_00101ab6:*(byte**)( this + 0x328 ) = pbVar10 + 1;
      uVar12 = ( uint ) * pbVar10;
   ...
   iVar4 = iVar5 + 0x10;
   *(int*)( this + 0x24bc ) = iVar4;
   *(uint*)( this + 0x24c0 ) = ( uVar12 | uVar9 | *(uint*)( this + 0x24c0 ) & 0xffff0000 ) << ( -(char)iVar5 & 0x1fU );
   LAB_00101602:if (uVar11 >> 0x10 < 2) {
      /* WARNING: Subroutine does not return */
      ...
      if (iVar5 < 1) {
         ...
         *(uint*)( this + 0x24c0 ) = uVar9 << ( (byte)iVar4 & 0x1f );
         if (iVar5 == 0) {
            ...
            *(uint*)( this + 0x334 ) = uVar9 ^ 1;
            uVar9 = ( -(uint)(uVar9 == 0) & 0x2600 ) + 0xd900;
            LAB_00101a3b:prep_in_buffer(this);
            iVar5 = *(int*)( this + 0x330 );
            if (iVar5 != 0) {
               pbVar10 = *(byte**)( this + 0x328 );
               goto LAB_0010199d;
            ...
            *(uint*)( this + 0x334 ) = uVar8 ^ 1;
            ...
            LAB_00101972:pbVar3 = *(byte**)( this + 0x328 );
            iVar5 = iVar5 + -1;
            pbVar10 = pbVar3 + 1;
            *(byte**)( this + 0x328 ) = pbVar10;
            bVar2 = *pbVar3;
            *(int*)( this + 0x330 ) = iVar5;
            ...
            LAB_0010199d:*(byte**)( this + 0x328 ) = pbVar10 + 1;
            uVar8 = ( uint ) * pbVar10;
         ...
         iVar5 = iVar4 + 0x10;
         *(int*)( this + 0x24bc ) = iVar5;
         *(uint*)( this + 0x24c0 ) = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar8 | uVar9 ) << ( -(char)iVar4 & 0x1fU );
      }
 else {
         ...
         if (iVar6 < 1) {
            ...
            *(int*)( this + 0x24c0 ) = iVar4 << ( (byte)iVar5 & 0x1f );
            if (iVar6 == 0) {
               ...
               *(uint*)( this + 0x334 ) = uVar9 ^ 1;
               uVar9 = ( -(uint)(uVar9 == 0) & 0x2600 ) + 0xd900;
               LAB_00101848:prep_in_buffer(this);
               iVar6 = *(int*)( this + 0x330 );
               if (iVar6 != 0) {
                  pbVar10 = *(byte**)( this + 0x328 );
                  goto LAB_00101739;
               ...
               *(uint*)( this + 0x334 ) = uVar8 ^ 1;
               ...
               LAB_0010170e:pbVar3 = *(byte**)( this + 0x328 );
               iVar6 = iVar6 + -1;
               pbVar10 = pbVar3 + 1;
               *(byte**)( this + 0x328 ) = pbVar10;
               bVar1 = *pbVar3;
               *(int*)( this + 0x330 ) = iVar6;
               ...
               LAB_00101739:*(byte**)( this + 0x328 ) = pbVar10 + 1;
               uVar8 = ( uint ) * pbVar10;
            ...
            if (iVar6 < 1) {
               ...
               *(int*)( this + 0x24c0 ) = iVar4 << ( (byte)iVar5 & 0x1f );
               if (iVar6 == 0) {
                  ...
                  *(uint*)( this + 0x334 ) = uVar9 ^ 1;
                  uVar9 = ( -(uint)(uVar9 == 0) & 0x2600 ) + 0xd900;
                  LAB_001018d3:prep_in_buffer(this);
                  iVar6 = *(int*)( this + 0x330 );
                  if (iVar6 != 0) {
                     pbVar10 = *(byte**)( this + 0x328 );
                     goto LAB_001017c1;
                  ...
                  *(uint*)( this + 0x334 ) = uVar8 ^ 1;
                  ...
                  LAB_00101796:pbVar3 = *(byte**)( this + 0x328 );
                  iVar6 = iVar6 + -1;
                  pbVar10 = pbVar3 + 1;
                  *(byte**)( this + 0x328 ) = pbVar10;
                  bVar1 = *pbVar3;
                  *(int*)( this + 0x330 ) = iVar6;
                  ...
                  LAB_001017c1:*(byte**)( this + 0x328 ) = pbVar10 + 1;
                  uVar8 = ( uint ) * pbVar10;
                  *(int*)( this + 0x330 ) = iVar6 + -1;
               }
               ...
               iVar5 = iVar6 + 0x10;
               *(int*)( this + 0x24bc ) = iVar5;
               *(uint*)( this + 0x24c0 ) = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar8 | uVar9 ) << ( -(char)iVar6 & 0x1fU );
            }
 else {
               *(int*)( this + 0x24c0 ) = iVar4 << 8;
               iVar5 = iVar6;
...
/* jpeg_decoder::read_sof_marker() */void jpeg_decoder::read_sof_marker(jpeg_decoder *this) {
   byte bVar1;
   byte *pbVar2;
   uint uVar3;
   int iVar4;
      ...
      *(uint*)( this + 0x24c0 ) = uVar7 << ( (byte)iVar4 & 0x1f );
      if (iVar6 == 0) {
         ...
         *(uint*)( this + 0x334 ) = uVar3 ^ 1;
         ...
         LAB_00102630:prep_in_buffer(this);
         iVar6 = *(int*)( this + 0x330 );
         if (iVar6 != 0) {
         ...
         *(uint*)( this + 0x334 ) = uVar10 ^ 1;
         ...
         LAB_001021a6:pbVar2 = *(byte**)( this + 0x328 );
         iVar6 = iVar6 + -1;
         pbVar8 = pbVar2 + 1;
         ...
         *(int*)( this + 0x330 ) = iVar6;
         ...
         LAB_001021d1:*(byte**)( this + 0x328 ) = pbVar8 + 1;
         uVar10 = ( uint ) * pbVar8;
         *(int*)( this + 0x330 ) = iVar6 + -1;
      }

      iVar6 = *(int*)( this + 0x24bc ) + 0x10;
      uVar3 = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar10 | uVar3 ) << ( -(char)*(int *)(this + 0x24bc) & 0x1fU );
   }
   ...
   *(int*)( this + 0x24bc ) = iVar6 + -8;
   if (iVar6 + -8 < 1) {
      *(uint*)( this + 0x24c0 ) = uVar3 << ( (byte)iVar6 & 0x1f );
      ...
      if (iVar4 == 0) {
         ...
         *(uint*)( this + 0x334 ) = uVar10 ^ 1;
         ...
         LAB_001024cb:prep_in_buffer(this);
         iVar4 = *(int*)( this + 0x330 );
         if (iVar4 != 0) {
            pbVar8 = *(byte**)( this + 0x328 );
            goto LAB_00102373;
         ...
         *(uint*)( this + 0x334 ) = uVar11 ^ 1;
         ...
         LAB_00102348:pbVar2 = *(byte**)( this + 0x328 );
         iVar4 = iVar4 + -1;
         pbVar8 = pbVar2 + 1;
         *(byte**)( this + 0x328 ) = pbVar8;
         bVar1 = *pbVar2;
         *(int*)( this + 0x330 ) = iVar4;
         ...
         LAB_00102373:*(byte**)( this + 0x328 ) = pbVar8 + 1;
         uVar11 = ( uint ) * pbVar8;
         *(int*)( this + 0x330 ) = iVar4 + -1;
      }
      ...
      *(uint*)( this + 0x24c0 ) = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar11 | uVar10 ) << ( -(char)iVar4 & 0x1fU );
   }
 else {
   ...
   if (iVar6 < 1) {
      ...
      *(uint*)( this + 0x24c0 ) = uVar3 << ( (byte)iVar4 & 0x1f );
      if (iVar6 == 0) {
         ...
         *(uint*)( this + 0x334 ) = uVar10 ^ 1;
         uVar10 = ( -(uint)(uVar10 == 0) & 0x2600 ) + 0xd900;
         LAB_00102543:prep_in_buffer(this);
         iVar6 = *(int*)( this + 0x330 );
         if (iVar6 != 0) {
            pbVar8 = *(byte**)( this + 0x328 );
            goto LAB_001022e1;
         ...
         *(uint*)( this + 0x334 ) = uVar11 ^ 1;
         ...
         LAB_001022b6:pbVar2 = *(byte**)( this + 0x328 );
         iVar6 = iVar6 + -1;
         pbVar8 = pbVar2 + 1;
         *(byte**)( this + 0x328 ) = pbVar8;
         bVar1 = *pbVar2;
         *(int*)( this + 0x330 ) = iVar6;
         ...
         LAB_001022e1:*(byte**)( this + 0x328 ) = pbVar8 + 1;
         uVar11 = ( uint ) * pbVar8;
         *(int*)( this + 0x330 ) = iVar6 + -1;
      }
   ...
   if (iVar4 < 1) {
      ...
      *(uint*)( this + 0x24c0 ) = uVar3 << ( (byte)iVar6 & 0x1f );
      if (iVar4 == 0) {
         ...
         *(uint*)( this + 0x334 ) = uVar10 ^ 1;
         uVar10 = ( -(uint)(uVar10 == 0) & 0x2600 ) + 0xd900;
         LAB_001025bb:prep_in_buffer(this);
         iVar4 = *(int*)( this + 0x330 );
         if (iVar4 != 0) {
            pbVar8 = *(byte**)( this + 0x328 );
            goto LAB_00102251;
         ...
         *(uint*)( this + 0x334 ) = uVar11 ^ 1;
         ...
         LAB_00102226:pbVar2 = *(byte**)( this + 0x328 );
         iVar4 = iVar4 + -1;
         pbVar8 = pbVar2 + 1;
         *(byte**)( this + 0x328 ) = pbVar8;
         bVar1 = *pbVar2;
         *(int*)( this + 0x330 ) = iVar4;
         ...
         LAB_00102251:*(byte**)( this + 0x328 ) = pbVar8 + 1;
         uVar11 = ( uint ) * pbVar8;
         *(int*)( this + 0x330 ) = iVar4 + -1;
      }
      ...
      iVar4 = iVar6 + 0x10;
      *(int*)( this + 0x24bc ) = iVar4;
      *(uint*)( this + 0x24c0 ) = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar11 | uVar10 ) << ( -(char)iVar6 & 0x1fU );
   }
 else {
      *(uint*)( this + 0x24c0 ) = uVar3 << 0x10;
   }
   ...
   *(uint*)( this + 0x24c0 ) = uVar3 << ( (byte)iVar4 & 0x1f );
   if (iVar6 == 0) {
      ...
      *(uint*)( this + 0x334 ) = uVar11 ^ 1;
      ...
      LAB_001026ab:prep_in_buffer(this);
      iVar6 = *(int*)( this + 0x330 );
      if (iVar6 != 0) {
         pbVar8 = *(byte**)( this + 0x328 );
         goto LAB_00102401;
      ...
      *(uint*)( this + 0x334 ) = uVar5 ^ 1;
      ...
      LAB_001023d6:pbVar2 = *(byte**)( this + 0x328 );
      iVar6 = iVar6 + -1;
      pbVar8 = pbVar2 + 1;
      *(byte**)( this + 0x328 ) = pbVar8;
      bVar1 = *pbVar2;
      *(int*)( this + 0x330 ) = iVar6;
      ...
      LAB_00102401:*(byte**)( this + 0x328 ) = pbVar8 + 1;
      uVar5 = ( uint ) * pbVar8;
      *(int*)( this + 0x330 ) = iVar6 + -1;
   }
   ...
   iVar6 = iVar4 + 0x10;
   *(int*)( this + 0x24bc ) = iVar6;
   *(uint*)( this + 0x24c0 ) = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar5 | uVar11 ) << ( -(char)iVar4 & 0x1fU );
   LAB_00101cb2:*(uint*)( this + 0x194 ) = uVar10;
   if (4 < uVar10) {
      /* WARNING: Subroutine does not return */
      ...
      if (iVar4 < 1) {
         ...
         *(uint*)( this + 0x24c0 ) = uVar7 << ( (byte)iVar6 & 0x1f );
         if (iVar4 == 0) {
            ...
            *(uint*)( this + 0x334 ) = uVar3 ^ 1;
            uVar3 = ( -(uint)(uVar3 == 0) & 0x2600 ) + 0xd900;
            LAB_00101feb:prep_in_buffer(this);
            iVar4 = *(int*)( this + 0x330 );
            if (iVar4 != 0) {
               pbVar8 = *(byte**)( this + 0x328 );
               goto LAB_00101ddb;
            ...
            *(uint*)( this + 0x334 ) = uVar10 ^ 1;
            ...
            LAB_00101db0:pbVar2 = *(byte**)( this + 0x328 );
            iVar4 = iVar4 + -1;
            pbVar8 = pbVar2 + 1;
            *(byte**)( this + 0x328 ) = pbVar8;
            bVar1 = *pbVar2;
            *(int*)( this + 0x330 ) = iVar4;
            ...
            LAB_00101ddb:*(byte**)( this + 0x328 ) = pbVar8 + 1;
            uVar10 = ( uint ) * pbVar8;
            *(int*)( this + 0x330 ) = iVar4 + -1;
         }
         ...
         *(uint*)( this + 0x24c0 ) = uVar3 << ( (byte)iVar4 & 0x1f );
         if (iVar6 == 0) {
            ...
            *(uint*)( this + 0x334 ) = uVar7 ^ 1;
            ...
            LAB_00102063:prep_in_buffer(this);
            iVar6 = *(int*)( this + 0x330 );
            if (iVar6 != 0) {
               pbVar8 = *(byte**)( this + 0x328 );
               goto LAB_00101f61;
            ...
            *(uint*)( this + 0x334 ) = uVar10 ^ 1;
            ...
            LAB_00101f36:pbVar2 = *(byte**)( this + 0x328 );
            iVar6 = iVar6 + -1;
            pbVar8 = pbVar2 + 1;
            *(byte**)( this + 0x328 ) = pbVar8;
            bVar1 = *pbVar2;
            *(int*)( this + 0x330 ) = iVar6;
            ...
            LAB_00101f61:*(byte**)( this + 0x328 ) = pbVar8 + 1;
            uVar10 = ( uint ) * pbVar8;
            *(int*)( this + 0x330 ) = iVar6 + -1;
         }

         iVar6 = *(int*)( this + 0x24bc ) + 0x10;
         uVar7 = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar10 | uVar7 ) << ( -(char)*(int *)(this + 0x24bc) & 0x1fU );
      }
      ...
      if (iVar4 < 1) {
         ...
         *(uint*)( this + 0x24c0 ) = uVar7 << ( (byte)iVar6 & 0x1f );
         if (iVar4 == 0) {
            ...
            *(uint*)( this + 0x334 ) = uVar3 ^ 1;
            uVar3 = ( -(uint)(uVar3 == 0) & 0x2600 ) + 0xd900;
            LAB_001020db:prep_in_buffer(this);
            iVar4 = *(int*)( this + 0x330 );
            if (iVar4 != 0) {
               pbVar8 = *(byte**)( this + 0x328 );
               goto LAB_00101ee3;
            ...
            *(uint*)( this + 0x334 ) = uVar10 ^ 1;
            ...
            LAB_00101eb8:pbVar2 = *(byte**)( this + 0x328 );
            iVar4 = iVar4 + -1;
            pbVar8 = pbVar2 + 1;
            *(byte**)( this + 0x328 ) = pbVar8;
            bVar1 = *pbVar2;
            *(int*)( this + 0x330 ) = iVar4;
            ...
            LAB_00101ee3:*(byte**)( this + 0x328 ) = pbVar8 + 1;
            uVar10 = ( uint ) * pbVar8;
            *(int*)( this + 0x330 ) = iVar4 + -1;
         }
      ...
      if (iVar4 + -8 < 1) {
         *(uint*)( this + 0x24c0 ) = uVar3 << ( (byte)iVar4 & 0x1f );
         ...
         if (iVar4 == 0) {
            ...
            *(uint*)( this + 0x334 ) = uVar7 ^ 1;
            uVar7 = ( -(uint)(uVar7 == 0) & 0x2600 ) + 0xd900;
            LAB_00102153:prep_in_buffer(this);
            iVar4 = *(int*)( this + 0x330 );
            if (iVar4 != 0) {
               pbVar8 = *(byte**)( this + 0x328 );
               goto LAB_00101e59;
            ...
            *(uint*)( this + 0x334 ) = uVar10 ^ 1;
            ...
            LAB_00101e2e:pbVar2 = *(byte**)( this + 0x328 );
            iVar4 = iVar4 + -1;
            pbVar8 = pbVar2 + 1;
            *(byte**)( this + 0x328 ) = pbVar8;
            bVar1 = *pbVar2;
            *(int*)( this + 0x330 ) = iVar4;
            ...
            LAB_00101e59:*(byte**)( this + 0x328 ) = pbVar8 + 1;
            uVar10 = ( uint ) * pbVar8;
            *(int*)( this + 0x330 ) = iVar4 + -1;
         }
         ...
         iVar4 = *(int*)( this + 0x24bc );
         *(int*)( this + 0x24bc ) = iVar4 + 0x10;
         *(uint*)( this + 0x24c0 ) = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar10 | uVar7 ) << ( -(char)iVar4 & 0x1fU );
      }
 else {
         *(uint*)( this + 0x24c0 ) = uVar3 << 8;
      }
...
/* jpeg_decoder::skip_variable_marker() */void jpeg_decoder::skip_variable_marker(jpeg_decoder *this) {
   byte bVar1;
   byte *pbVar2;
   int iVar3;
   int iVar4;
   ...
   *(uint*)( this + 0x24c0 ) = uVar9 << ( (byte)iVar8 & 0x1f );
   if (iVar3 == 0) {
      ...
      *(uint*)( this + 0x334 ) = uVar5 ^ 1;
      ...
      LAB_001029a2:prep_in_buffer(this);
      iVar3 = *(int*)( this + 0x330 );
      if (iVar3 != 0) {
      ...
      *(uint*)( this + 0x334 ) = uVar6 ^ 1;
      ...
      LAB_00102902:pbVar2 = *(byte**)( this + 0x328 );
      iVar3 = iVar3 + -1;
      pbVar7 = pbVar2 + 1;
      ...
      *(int*)( this + 0x330 ) = iVar3;
      ...
      LAB_00102929:*(byte**)( this + 0x328 ) = pbVar7 + 1;
      uVar6 = ( uint ) * pbVar7;
   ...
   iVar3 = iVar8 + 0x10;
   *(int*)( this + 0x24bc ) = iVar3;
   *(uint*)( this + 0x24c0 ) = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar6 | uVar5 ) << ( -(char)iVar8 & 0x1fU );
   LAB_00102798:if (uVar9 >> 0x10 < 2) {
      /* WARNING: Subroutine does not return */
      ...
      while (true) {
         ...
         *(int*)( this + 0x24c0 ) = *(int*)( this + 0x24c0 ) << ( (byte)iVar3 & 0x1f );
         if (iVar4 == 0) {
            ...
            *(uint*)( this + 0x334 ) = uVar9 ^ 1;
            uVar9 = ( -(uint)(uVar9 == 0) & 0x2600 ) + 0xd900;
            LAB_001028a3:prep_in_buffer(this);
            iVar4 = *(int*)( this + 0x330 );
            if (iVar4 != 0) {
               pbVar7 = *(byte**)( this + 0x328 );
               goto LAB_00102814;
            ...
            *(uint*)( this + 0x334 ) = uVar5 ^ 1;
            ...
            LAB_001027e9:pbVar2 = *(byte**)( this + 0x328 );
            iVar4 = iVar4 + -1;
            pbVar7 = pbVar2 + 1;
            *(byte**)( this + 0x328 ) = pbVar7;
            bVar1 = *pbVar2;
            *(int*)( this + 0x330 ) = iVar4;
            ...
            LAB_00102814:*(byte**)( this + 0x328 ) = pbVar7 + 1;
            uVar5 = ( uint ) * pbVar7;
            *(int*)( this + 0x330 ) = iVar4 + -1;
         }
         ...
         iVar3 = iVar4 + 0x10;
         *(int*)( this + 0x24bc ) = iVar3;
         *(uint*)( this + 0x24c0 ) = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar5 | uVar9 ) << ( -(char)iVar4 & 0x1fU );
         iVar8 = iVar8 + -1;
         if (iVar8 == 0) {
            return;
         }
...
/* jpeg_decoder::read_dri_marker() */void jpeg_decoder::read_dri_marker(jpeg_decoder *this) {
   byte bVar1;
   uint uVar2;
   byte *pbVar3;
   int iVar4;
      ...
      *(uint*)( this + 0x24c0 ) = uVar2 << ( (byte)iVar5 & 0x1f );
      if (iVar4 == 0) {
         ...
         *(uint*)( this + 0x334 ) = uVar8 ^ 1;
         ...
         LAB_00102bc8:prep_in_buffer(this);
         iVar4 = *(int*)( this + 0x330 );
         if (iVar4 != 0) {
            pbVar7 = *(byte**)( this + 0x328 );
            goto LAB_00102ab1;
         ...
         *(uint*)( this + 0x334 ) = uVar6 ^ 1;
         ...
         LAB_00102a86:pbVar3 = *(byte**)( this + 0x328 );
         iVar4 = iVar4 + -1;
         pbVar7 = pbVar3 + 1;
         *(byte**)( this + 0x328 ) = pbVar7;
         bVar1 = *pbVar3;
         *(int*)( this + 0x330 ) = iVar4;
         ...
         LAB_00102ab1:*(byte**)( this + 0x328 ) = pbVar7 + 1;
         uVar6 = ( uint ) * pbVar7;
         *(int*)( this + 0x330 ) = iVar4 + -1;
      }
      ...
      iVar4 = iVar5 + 0x10;
      *(int*)( this + 0x24bc ) = iVar4;
      *(uint*)( this + 0x24c0 ) = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar6 | uVar8 ) << ( -(char)iVar5 & 0x1fU );
   }
 else {
   ...
   *(uint*)( this + 0x24c0 ) = uVar2 << ( (byte)iVar4 & 0x1f );
   if (iVar5 == 0) {
      ...
      *(uint*)( this + 0x334 ) = uVar8 ^ 1;
      uVar8 = ( -(uint)(uVar8 == 0) & 0x2600 ) + 0xd900;
      LAB_00102c43:prep_in_buffer(this);
      iVar5 = *(int*)( this + 0x330 );
      if (iVar5 == 0) {
         uVar6 = *(uint*)( this + 0x334 );
         *(uint*)( this + 0x334 ) = uVar6 ^ 1;
      ...
      LAB_00102b18:pbVar3 = *(byte**)( this + 0x328 );
      iVar5 = iVar5 + -1;
      pbVar7 = pbVar3 + 1;
      *(byte**)( this + 0x328 ) = pbVar7;
      bVar1 = *pbVar3;
   ...
   *(byte**)( this + 0x328 ) = pbVar7 + 1;
   uVar6 = ( uint ) * pbVar7;
   *(int*)( this + 0x330 ) = iVar5 + -1;
   LAB_00102b5a:iVar5 = *(int*)( this + 0x24bc );
   *(uint*)( this + 0x24c4 ) = uVar2 >> 0x10;
   *(int*)( this + 0x24bc ) = iVar5 + 0x10;
   *(uint*)( this + 0x24c0 ) = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar6 | uVar8 ) << ( -(char)iVar5 & 0x1fU );
   return;
}
/* jpeg_decoder::read_sos_marker() */void jpeg_decoder::read_sos_marker(jpeg_decoder *this) {
   byte bVar1;
   byte *pbVar2;
   uint uVar3;
   long lVar4;
   ...
   if (iVar6 < 1) {
      ...
      *(uint*)( this + 0x24c0 ) = uVar9 << ( (byte)iVar11 & 0x1f );
      if (iVar6 == 0) {
         ...
         *(uint*)( this + 0x334 ) = uVar3 ^ 1;
         uVar3 = ( -(uint)(uVar3 == 0) & 0x2600 ) + 0xd900;
         LAB_0010362a:prep_in_buffer(this);
         iVar6 = *(int*)( this + 0x330 );
         if (iVar6 != 0) {
            pbVar7 = *(byte**)( this + 0x328 );
            goto LAB_001033e3;
         ...
         *(uint*)( this + 0x334 ) = uVar13 ^ 1;
         ...
         LAB_001033ba:pbVar2 = *(byte**)( this + 0x328 );
         iVar6 = iVar6 + -1;
         pbVar7 = pbVar2 + 1;
         *(byte**)( this + 0x328 ) = pbVar7;
         bVar1 = *pbVar2;
         *(int*)( this + 0x330 ) = iVar6;
         ...
         LAB_001033e3:*(byte**)( this + 0x328 ) = pbVar7 + 1;
         uVar13 = ( uint ) * pbVar7;
         *(int*)( this + 0x330 ) = iVar6 + -1;
      }

      iVar6 = *(int*)( this + 0x24bc ) + 0x10;
      uVar3 = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar13 | uVar3 ) << ( -(char)*(int *)(this + 0x24bc) & 0x1fU );
   }
   ...
   if (iVar6 + -8 < 1) {
      *(uint*)( this + 0x24c0 ) = uVar3 << ( (byte)iVar6 & 0x1f );
      ...
      if (iVar11 == 0) {
         ...
         *(uint*)( this + 0x334 ) = uVar3 ^ 1;
         uVar3 = ( -(uint)(uVar3 == 0) & 0x2600 ) + 0xd900;
         LAB_00103546:prep_in_buffer(this);
         iVar11 = *(int*)( this + 0x330 );
         if (iVar11 != 0) {
            pbVar7 = *(byte**)( this + 0x328 );
            goto LAB_001034ce;
         ...
         *(uint*)( this + 0x334 ) = uVar8 ^ 1;
         ...
         LAB_001034a9:pbVar2 = *(byte**)( this + 0x328 );
         iVar11 = iVar11 + -1;
         pbVar7 = pbVar2 + 1;
         *(byte**)( this + 0x328 ) = pbVar7;
         bVar1 = *pbVar2;
         *(int*)( this + 0x330 ) = iVar11;
         ...
         LAB_001034ce:*(byte**)( this + 0x328 ) = pbVar7 + 1;
         uVar8 = ( uint ) * pbVar7;
      ...
      *(uint*)( this + 0x24c0 ) = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar8 | uVar3 ) << ( -(char)iVar11 & 0x1fU );
   }
 else {
      *(uint*)( this + 0x24c0 ) = uVar3 << 8;
   }
   ...
   *(uint*)( this + 0x1f8 ) = uVar13;
   ...
   do {
      ...
      if (iVar6 < 1) {
         ...
         *(uint*)( this + 0x24c0 ) = uVar9 << ( (byte)iVar11 & 0x1f );
         if (iVar6 == 0) {
            ...
            *(uint*)( this + 0x334 ) = uVar3 ^ 1;
            uVar3 = ( -(uint)(uVar3 == 0) & 0x2600 ) + 0xd900;
            LAB_00102fb7:prep_in_buffer(this);
            iVar6 = *(int*)( this + 0x330 );
            if (iVar6 != 0) {
               pbVar7 = *(byte**)( this + 0x328 );
               goto LAB_00102ee1;
            ...
            *(uint*)( this + 0x334 ) = uVar8 ^ 1;
            ...
            LAB_00102eb6:pbVar2 = *(byte**)( this + 0x328 );
            iVar6 = iVar6 + -1;
            pbVar7 = pbVar2 + 1;
            *(byte**)( this + 0x328 ) = pbVar7;
            bVar1 = *pbVar2;
            *(int*)( this + 0x330 ) = iVar6;
            ...
            LAB_00102ee1:*(byte**)( this + 0x328 ) = pbVar7 + 1;
            uVar8 = ( uint ) * pbVar7;
            *(int*)( this + 0x330 ) = iVar6 + -1;
         }

         iVar6 = *(int*)( this + 0x24bc ) + 0x10;
         uVar3 = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar8 | uVar3 ) << ( -(char)*(int *)(this + 0x24bc) & 0x1fU );
      }
      ...
      *(int*)( this + 0x24bc ) = iVar6 + -8;
      if (iVar6 + -8 < 1) {
         *(uint*)( this + 0x24c0 ) = uVar3 << ( (byte)iVar6 & 0x1f );
         ...
         if (iVar11 == 0) {
            ...
            *(uint*)( this + 0x334 ) = uVar8 ^ 1;
            uVar8 = ( -(uint)(uVar8 == 0) & 0x2600 ) + 0xd900;
            LAB_00102f52:prep_in_buffer(this);
            iVar11 = *(int*)( this + 0x330 );
            if (iVar11 != 0) {
               pbVar7 = *(byte**)( this + 0x328 );
               goto LAB_00102e39;
            ...
            *(uint*)( this + 0x334 ) = uVar5 ^ 1;
            ...
            LAB_00102e10:pbVar2 = *(byte**)( this + 0x328 );
            iVar11 = iVar11 + -1;
            pbVar7 = pbVar2 + 1;
            *(byte**)( this + 0x328 ) = pbVar7;
            bVar1 = *pbVar2;
            *(int*)( this + 0x330 ) = iVar11;
            ...
            LAB_00102e39:*(byte**)( this + 0x328 ) = pbVar7 + 1;
            uVar5 = ( uint ) * pbVar7;
            *(int*)( this + 0x330 ) = iVar11 + -1;
         }
         ...
         *(uint*)( this + 0x24c0 ) = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar5 | uVar8 ) << ( -(char)iVar11 & 0x1fU );
      }
 else {
         iVar6 = *(int*)( this + 0x194 );
         *(uint*)( this + 0x24c0 ) = uVar3 << 8;
      ...
      if (iVar6 < 1) {
         LAB_00102e90:/* WARNING: Subroutine does not return */stop_decoding(this, 0xffffff0d);
      }
 ...
 while ( (int)lVar10 < (int)uVar13 );
   ...
   if (iVar6 < 1) {
      ...
      *(uint*)( this + 0x24c0 ) = uVar9 << ( (byte)iVar11 & 0x1f );
      if (iVar6 == 0) {
         ...
         *(uint*)( this + 0x334 ) = uVar3 ^ 1;
         uVar3 = ( -(uint)(uVar3 == 0) & 0x2600 ) + 0xd900;
         LAB_001035bb:prep_in_buffer(this);
         iVar6 = *(int*)( this + 0x330 );
         if (iVar6 != 0) {
            pbVar7 = *(byte**)( this + 0x328 );
            goto LAB_0010345c;
         ...
         *(uint*)( this + 0x334 ) = uVar13 ^ 1;
         ...
         LAB_00103431:pbVar2 = *(byte**)( this + 0x328 );
         iVar6 = iVar6 + -1;
         pbVar7 = pbVar2 + 1;
         *(byte**)( this + 0x328 ) = pbVar7;
         bVar1 = *pbVar2;
         *(int*)( this + 0x330 ) = iVar6;
         ...
         LAB_0010345c:*(byte**)( this + 0x328 ) = pbVar7 + 1;
         uVar13 = ( uint ) * pbVar7;
         *(int*)( this + 0x330 ) = iVar6 + -1;
      }
   ...
   if (iVar11 < 1) {
      ...
      *(uint*)( this + 0x24c0 ) = uVar3 << ( (byte)iVar6 & 0x1f );
      if (iVar11 == 0) {
         ...
         *(uint*)( this + 0x334 ) = uVar9 ^ 1;
         uVar9 = ( -(uint)(uVar9 == 0) & 0x2600 ) + 0xd900;
         LAB_00103714:prep_in_buffer(this);
         iVar11 = *(int*)( this + 0x330 );
         if (iVar11 != 0) {
            pbVar7 = *(byte**)( this + 0x328 );
            goto LAB_001032e3;
         ...
         *(uint*)( this + 0x334 ) = uVar13 ^ 1;
         ...
         LAB_001032b8:pbVar2 = *(byte**)( this + 0x328 );
         iVar11 = iVar11 + -1;
         pbVar7 = pbVar2 + 1;
         *(byte**)( this + 0x328 ) = pbVar7;
         bVar1 = *pbVar2;
         *(int*)( this + 0x330 ) = iVar11;
         ...
         LAB_001032e3:*(byte**)( this + 0x328 ) = pbVar7 + 1;
         uVar13 = ( uint ) * pbVar7;
         *(int*)( this + 0x330 ) = iVar11 + -1;
      }

      iVar11 = *(int*)( this + 0x24bc ) + 0x10;
      uVar9 = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar13 | uVar9 ) << ( -(char)*(int *)(this + 0x24bc) & 0x1fU );
   }
   ...
   if (iVar6 < 1) {
      ...
      *(uint*)( this + 0x24c0 ) = uVar9 << ( (byte)iVar11 & 0x1f );
      if (iVar6 == 0) {
         ...
         *(uint*)( this + 0x334 ) = uVar3 ^ 1;
         uVar3 = ( -(uint)(uVar3 == 0) & 0x2600 ) + 0xd900;
         LAB_00103789:prep_in_buffer(this);
         iVar6 = *(int*)( this + 0x330 );
         if (iVar6 != 0) {
            pbVar7 = *(byte**)( this + 0x328 );
            goto LAB_00103267;
         ...
         *(uint*)( this + 0x334 ) = uVar13 ^ 1;
         ...
         LAB_0010323c:pbVar2 = *(byte**)( this + 0x328 );
         iVar6 = iVar6 + -1;
         pbVar7 = pbVar2 + 1;
         *(byte**)( this + 0x328 ) = pbVar7;
         bVar1 = *pbVar2;
         *(int*)( this + 0x330 ) = iVar6;
         ...
         LAB_00103267:*(byte**)( this + 0x328 ) = pbVar7 + 1;
         uVar13 = ( uint ) * pbVar7;
         *(int*)( this + 0x330 ) = iVar6 + -1;
      }
   ...
   *(uint*)( this + 0x24c0 ) = uVar3 << ( (byte)iVar6 & 0x1f );
   ...
   if (iVar11 == 0) {
      ...
      *(uint*)( this + 0x334 ) = uVar9 ^ 1;
      uVar9 = ( -(uint)(uVar9 == 0) & 0x2600 ) + 0xd900;
      LAB_0010369f:prep_in_buffer(this);
      iVar11 = *(int*)( this + 0x330 );
      if (iVar11 != 0) {
         pbVar7 = *(byte**)( this + 0x328 );
         goto LAB_0010335f;
      ...
      *(uint*)( this + 0x334 ) = uVar13 ^ 1;
      ...
      LAB_00103334:pbVar2 = *(byte**)( this + 0x328 );
      iVar11 = iVar11 + -1;
      pbVar7 = pbVar2 + 1;
      *(byte**)( this + 0x328 ) = pbVar7;
      bVar1 = *pbVar2;
      *(int*)( this + 0x330 ) = iVar11;
      ...
      LAB_0010335f:*(byte**)( this + 0x328 ) = pbVar7 + 1;
      uVar13 = ( uint ) * pbVar7;
      *(int*)( this + 0x330 ) = iVar11 + -1;
   }
   ...
   iVar11 = *(int*)( this + 0x24bc );
   *(int*)( this + 0x24bc ) = iVar11 + 0x10;
   *(uint*)( this + 0x24c0 ) = ( uVar13 | uVar9 | *(uint*)( this + 0x24c0 ) & 0xffff0000 ) << ( -(char)iVar11 & 0x1fU );
   LAB_00103067:*(uint*)( this + 0x234 ) = uVar3 >> 0x1c;
   if (*(int*)( this + 0xe0 ) == 0) {
         ...
         while (true) {
            ...
            *(int*)( this + 0x24c0 ) = *(int*)( this + 0x24c0 ) << ( (byte)iVar11 & 0x1f );
            if (iVar6 == 0) {
               ...
               *(uint*)( this + 0x334 ) = uVar9 ^ 1;
               uVar9 = ( -(uint)(uVar9 == 0) & 0x2600 ) + 0xd900;
               LAB_001031cf:prep_in_buffer(this);
               iVar6 = *(int*)( this + 0x330 );
               if (iVar6 != 0) {
                  pbVar7 = *(byte**)( this + 0x328 );
                  goto LAB_001030f7;
               ...
               *(uint*)( this + 0x334 ) = uVar3 ^ 1;
               ...
               LAB_001030ce:pbVar2 = *(byte**)( this + 0x328 );
               iVar6 = iVar6 + -1;
               pbVar7 = pbVar2 + 1;
               *(byte**)( this + 0x328 ) = pbVar7;
               bVar1 = *pbVar2;
               *(int*)( this + 0x330 ) = iVar6;
               ...
               LAB_001030f7:*(byte**)( this + 0x328 ) = pbVar7 + 1;
               uVar3 = ( uint ) * pbVar7;
               *(int*)( this + 0x330 ) = iVar6 + -1;
            }
            ...
            iVar11 = iVar6 + 0x10;
            *(int*)( this + 0x24bc ) = iVar11;
            *(uint*)( this + 0x24c0 ) = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar3 | uVar9 ) << ( -(char)iVar6 & 0x1fU );
            iVar12 = iVar12 + -1;
            if (iVar12 == 0) {
               return;
            }
...
/* jpeg_decoder::next_marker() */uint jpeg_decoder::next_marker(jpeg_decoder *this) {
   byte bVar1;
   byte *pbVar2;
   int iVar3;
   uint uVar4;
   ...
   byte *pbVar7;
   uint uVar8;
   LAB_00103830:uVar4 = *(uint*)( this + 0x24c0 );
   iVar3 = *(int*)( this + 0x24bc );
   do {
      iVar6 = iVar3 + -8;
      *(int*)( this + 0x24bc ) = iVar6;
         ...
         *(uint*)( this + 0x24c0 ) = uVar4 << ( (byte)iVar3 & 0x1f );
         ...
         if (iVar3 == 0) {
            ...
            *(uint*)( this + 0x334 ) = uVar4 ^ 1;
            ...
            LAB_001039fb:prep_in_buffer(this);
            iVar3 = *(int*)( this + 0x330 );
            if (iVar3 != 0) {
               pbVar7 = *(byte**)( this + 0x328 );
               goto LAB_001038aa;
            ...
            *(uint*)( this + 0x334 ) = uVar5 ^ 1;
            ...
            LAB_0010387f:pbVar2 = *(byte**)( this + 0x328 );
            iVar3 = iVar3 + -1;
            pbVar7 = pbVar2 + 1;
            *(byte**)( this + 0x328 ) = pbVar7;
            bVar1 = *pbVar2;
            *(int*)( this + 0x330 ) = iVar3;
            ...
            LAB_001038aa:*(byte**)( this + 0x328 ) = pbVar7 + 1;
            uVar5 = ( uint ) * pbVar7;
            *(int*)( this + 0x330 ) = iVar3 + -1;
         }

         uVar4 = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar5 | uVar4 ) << ( -(char)*(int *)(this + 0x24bc) & 0x1fU );
         iVar6 = *(int*)( this + 0x24bc ) + 0x10;
      ...
      if (iVar6 + -8 < 1) {
         *(uint*)( this + 0x24c0 ) = uVar4 << ( (byte)iVar6 & 0x1f );
         ...
         if (iVar3 == 0) {
            ...
            *(uint*)( this + 0x334 ) = uVar4 ^ 1;
            uVar4 = ( -(uint)(uVar4 == 0) & 0x2600 ) + 0xd900;
            LAB_00103a5b:prep_in_buffer(this);
            iVar3 = *(int*)( this + 0x330 );
            if (iVar3 != 0) {
               pbVar7 = *(byte**)( this + 0x328 );
               goto LAB_00103964;
            ...
            *(uint*)( this + 0x334 ) = uVar5 ^ 1;
            ...
            LAB_00103939:pbVar2 = *(byte**)( this + 0x328 );
            iVar3 = iVar3 + -1;
            pbVar7 = pbVar2 + 1;
            *(byte**)( this + 0x328 ) = pbVar7;
            bVar1 = *pbVar2;
            *(int*)( this + 0x330 ) = iVar3;
            ...
            LAB_00103964:*(byte**)( this + 0x328 ) = pbVar7 + 1;
            uVar5 = ( uint ) * pbVar7;
            *(int*)( this + 0x330 ) = iVar3 + -1;
         }
         ...
         *(uint*)( this + 0x24c0 ) = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar5 | uVar4 ) << ( -(char)iVar3 & 0x1fU );
      }
 else {
...
/* jpeg_decoder::process_markers() */uint jpeg_decoder::process_markers(jpeg_decoder *this) {
   byte bVar1;
   byte *pbVar2;
   uint uVar3;
   int iVar4;
   ...
   int iVar10;
   uint uVar11;
   LAB_00103ae8:uVar3 = *(uint*)( this + 0x24c0 );
   iVar4 = *(int*)( this + 0x24bc );
   LAB_00103b17:do {
      iVar9 = iVar4 + -8;
      ...
      if (iVar9 < 1) {
         ...
         *(uint*)( this + 0x24c0 ) = uVar3 << ( (byte)iVar4 & 0x1f );
         if (iVar9 == 0) {
            ...
            *(uint*)( this + 0x334 ) = uVar3 ^ 1;
            uVar3 = ( -(uint)(uVar3 == 0) & 0x2600 ) + 0xd900;
            LAB_00103d1b:prep_in_buffer(this);
            iVar9 = *(int*)( this + 0x330 );
            if (iVar9 != 0) {
            ...
            *(uint*)( this + 0x334 ) = uVar8 ^ 1;
            ...
            LAB_00103b3f:pbVar2 = *(byte**)( this + 0x328 );
            iVar9 = iVar9 + -1;
            pbVar5 = pbVar2 + 1;
            ...
            *(int*)( this + 0x330 ) = iVar9;
            ...
            LAB_00103b6a:*(byte**)( this + 0x328 ) = pbVar5 + 1;
            uVar8 = ( uint ) * pbVar5;
            ...
            if (iVar9 + -8 < 1) {
               *(uint*)( this + 0x24c0 ) = uVar3 << ( (byte)iVar9 & 0x1f );
               ...
               if (iVar4 == 0) {
                  ...
                  *(uint*)( this + 0x334 ) = uVar8 ^ 1;
                  uVar8 = ( -(uint)(uVar8 == 0) & 0x2600 ) + 0xd900;
                  LAB_00103d7b:prep_in_buffer(this);
                  iVar4 = *(int*)( this + 0x330 );
                  if (iVar4 != 0) {
                     pbVar5 = *(byte**)( this + 0x328 );
                     goto LAB_00103c27;
                  ...
                  *(uint*)( this + 0x334 ) = uVar7 ^ 1;
                  ...
                  LAB_00103bfc:pbVar2 = *(byte**)( this + 0x328 );
                  iVar4 = iVar4 + -1;
                  pbVar5 = pbVar2 + 1;
                  *(byte**)( this + 0x328 ) = pbVar5;
                  bVar1 = *pbVar2;
                  *(int*)( this + 0x330 ) = iVar4;
                  ...
                  LAB_00103c27:*(byte**)( this + 0x328 ) = pbVar5 + 1;
                  uVar7 = ( uint ) * pbVar5;
                  *(int*)( this + 0x330 ) = iVar4 + -1;
               }
               ...
               iVar4 = *(int*)( this + 0x24bc );
               *(int*)( this + 0x24bc ) = iVar4 + 0x10;
               *(uint*)( this + 0x24c0 ) = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar7 | uVar8 ) << ( -(char)iVar4 & 0x1fU );
            }
 else {
               *(uint*)( this + 0x24c0 ) = uVar3 << 8;
            }
 ...
 while ( true );
   LAB_00103c74:if (uVar11 == 0) goto LAB_00103ae8;
   if (uVar11 < 0xdb) {
      if (0xd7 < uVar11) {
         return uVar11;
      }
      ...
      if (0xc4 < uVar11) {
         ...
         LAB_00104331:/* WARNING: Subroutine does not return */stop_decoding(this, 0xffffff10);
      }
      ...
      if (uVar11 == 0xdd) {
         ...
         if (iVar9 < 1) {
            *(uint*)( this + 0x24c0 ) = uVar3 << ( (byte)iVar4 & 0x1f );
            ...
            if (iVar4 == 0) {
               ...
               *(uint*)( this + 0x334 ) = uVar11 ^ 1;
               uVar11 = ( -(uint)(uVar11 == 0) & 0x2600 ) + 0xd900;
               LAB_001042ca:prep_in_buffer(this);
               iVar4 = *(int*)( this + 0x330 );
               if (iVar4 != 0) {
                  pbVar5 = *(byte**)( this + 0x328 );
                  goto LAB_0010406e;
               ...
               *(uint*)( this + 0x334 ) = uVar8 ^ 1;
               ...
               LAB_00104043:pbVar2 = *(byte**)( this + 0x328 );
               iVar4 = iVar4 + -1;
               pbVar5 = pbVar2 + 1;
               *(byte**)( this + 0x328 ) = pbVar5;
               bVar1 = *pbVar2;
               *(int*)( this + 0x330 ) = iVar4;
               ...
               LAB_0010406e:*(byte**)( this + 0x328 ) = pbVar5 + 1;
               uVar8 = ( uint ) * pbVar5;
               *(int*)( this + 0x330 ) = iVar4 + -1;
            }
            ...
            iVar9 = iVar4 + 0x10;
            *(int*)( this + 0x24bc ) = iVar9;
            *(uint*)( this + 0x24c0 ) = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar8 | uVar11 ) << ( -(char)iVar4 & 0x1fU );
         }
 else {
            *(uint*)( this + 0x24c0 ) = uVar3 << 0x10;
         }
         ...
         *(uint*)( this + 0x24c0 ) = uVar11 << ( (byte)iVar9 & 0x1f );
         if (iVar4 == 0) {
            ...
            *(uint*)( this + 0x334 ) = uVar3 ^ 1;
            uVar3 = ( -(uint)(uVar3 == 0) & 0x2600 ) + 0xd900;
            LAB_001041e4:prep_in_buffer(this);
            iVar4 = *(int*)( this + 0x330 );
            if (iVar4 != 0) {
               pbVar5 = *(byte**)( this + 0x328 );
               goto LAB_00104174;
            ...
            *(uint*)( this + 0x334 ) = uVar8 ^ 1;
            ...
            LAB_0010414d:pbVar2 = *(byte**)( this + 0x328 );
            iVar4 = iVar4 + -1;
            pbVar5 = pbVar2 + 1;
            *(byte**)( this + 0x328 ) = pbVar5;
            bVar1 = *pbVar2;
            *(int*)( this + 0x330 ) = iVar4;
            ...
            LAB_00104174:*(byte**)( this + 0x328 ) = pbVar5 + 1;
            uVar7 = ( uint ) * pbVar5;
            *(int*)( this + 0x330 ) = iVar4 + -1;
         }

         uVar3 = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar7 | uVar3 ) << ( -(char)*(int *)(this + 0x24bc) & 0x1fU );
         iVar4 = *(int*)( this + 0x24bc ) + 0x10;
         LAB_00103e60:*(uint*)( this + 0x24c4 ) = uVar11 >> 0x10;
         goto LAB_00103b17;
      }
   ...
   *(uint*)( this + 0x24c0 ) = uVar11 << ( (byte)iVar9 & 0x1f );
   ...
   if (iVar4 == 0) {
      ...
      *(uint*)( this + 0x334 ) = uVar3 ^ 1;
      uVar3 = ( -(uint)(uVar3 == 0) & 0x2600 ) + 0xd900;
      LAB_00104255:prep_in_buffer(this);
      iVar4 = *(int*)( this + 0x330 );
      if (iVar4 != 0) {
         pbVar5 = *(byte**)( this + 0x328 );
         goto LAB_001040f4;
      ...
      *(uint*)( this + 0x334 ) = uVar8 ^ 1;
      ...
      LAB_001040c9:pbVar2 = *(byte**)( this + 0x328 );
      iVar4 = iVar4 + -1;
      pbVar5 = pbVar2 + 1;
      *(byte**)( this + 0x328 ) = pbVar5;
      bVar1 = *pbVar2;
      *(int*)( this + 0x330 ) = iVar4;
      ...
      LAB_001040f4:*(byte**)( this + 0x328 ) = pbVar5 + 1;
      uVar8 = ( uint ) * pbVar5;
      *(int*)( this + 0x330 ) = iVar4 + -1;
   }
   ...
   iVar4 = iVar9 + 0x10;
   *(int*)( this + 0x24bc ) = iVar4;
   *(uint*)( this + 0x24c0 ) = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar8 | uVar3 ) << ( -(char)iVar9 & 0x1fU );
   LAB_00103ecb:if (uVar11 >> 0x10 < 2) {
      /* WARNING: Subroutine does not return */
      stop_decoding(this, 0xffffff0a);
   }
      ...
      if (iVar10 < 1) {
         *(uint*)( this + 0x24c0 ) = uVar3 << ( (byte)iVar4 & 0x1f );
         ...
         if (iVar4 == 0) {
            ...
            *(uint*)( this + 0x334 ) = uVar3 ^ 1;
            uVar3 = ( -(uint)(uVar3 == 0) & 0x2600 ) + 0xd900;
            LAB_00103feb:prep_in_buffer(this);
            iVar4 = *(int*)( this + 0x330 );
            if (iVar4 != 0) {
               pbVar5 = *(byte**)( this + 0x328 );
               goto LAB_00103f52;
            ...
            *(uint*)( this + 0x334 ) = uVar11 ^ 1;
            ...
            LAB_00103f27:pbVar2 = *(byte**)( this + 0x328 );
            iVar4 = iVar4 + -1;
            pbVar5 = pbVar2 + 1;
            *(byte**)( this + 0x328 ) = pbVar5;
            bVar1 = *pbVar2;
            *(int*)( this + 0x330 ) = iVar4;
            ...
            LAB_00103f52:*(byte**)( this + 0x328 ) = pbVar5 + 1;
            uVar11 = ( uint ) * pbVar5;
            *(int*)( this + 0x330 ) = iVar4 + -1;
         }

         uVar3 = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar11 | uVar3 ) << ( -(char)*(int *)(this + 0x24bc) & 0x1fU );
...
/* jpeg_decoder::locate_soi_marker() */void jpeg_decoder::locate_soi_marker(jpeg_decoder *this) {
   byte bVar1;
   byte *pbVar2;
   uint uVar3;
   int iVar4;
   ...
   if (iVar7 < 1) {
      ...
      *(uint*)( this + 0x24c0 ) = uVar9 << ( (byte)iVar5 & 0x1f );
      if (iVar7 == 0) {
         ...
         *(uint*)( this + 0x334 ) = uVar3 ^ 1;
         uVar3 = ( -(uint)(uVar3 == 0) & 0x2600 ) + 0xd900;
         LAB_001046a1:prep_in_buffer(this);
         iVar7 = *(int*)( this + 0x330 );
         if (iVar7 != 0) {
            pbVar8 = *(byte**)( this + 0x328 );
            goto LAB_00104634;
         ...
         *(uint*)( this + 0x334 ) = uVar10 ^ 1;
         ...
         LAB_0010460d:pbVar2 = *(byte**)( this + 0x328 );
         iVar7 = iVar7 + -1;
         pbVar8 = pbVar2 + 1;
         *(byte**)( this + 0x328 ) = pbVar8;
         bVar1 = *pbVar2;
         *(int*)( this + 0x330 ) = iVar7;
         ...
         LAB_00104634:*(byte**)( this + 0x328 ) = pbVar8 + 1;
         uVar10 = ( uint ) * pbVar8;
   ...
   *(uint*)( this + 0x24c0 ) = uVar3 << ( (byte)iVar7 & 0x1f );
   ...
   if (iVar5 == 0) {
      ...
      *(uint*)( this + 0x334 ) = uVar10 ^ 1;
      uVar10 = ( -(uint)(uVar10 == 0) & 0x2600 ) + 0xd900;
      LAB_00104716:prep_in_buffer(this);
      iVar5 = *(int*)( this + 0x330 );
      if (iVar5 != 0) {
         pbVar8 = *(byte**)( this + 0x328 );
         goto LAB_001045b6;
      ...
      *(uint*)( this + 0x334 ) = uVar6 ^ 1;
      ...
      LAB_0010458b:pbVar2 = *(byte**)( this + 0x328 );
      iVar5 = iVar5 + -1;
      pbVar8 = pbVar2 + 1;
      *(byte**)( this + 0x328 ) = pbVar8;
      bVar1 = *pbVar2;
      *(int*)( this + 0x330 ) = iVar5;
      ...
      LAB_001045b6:*(byte**)( this + 0x328 ) = pbVar8 + 1;
      uVar6 = ( uint ) * pbVar8;
      *(int*)( this + 0x330 ) = iVar5 + -1;
   }
   ...
   iVar5 = *(int*)( this + 0x24bc );
   *(int*)( this + 0x24bc ) = iVar5 + 0x10;
   *(uint*)( this + 0x24c0 ) = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar6 | uVar10 ) << ( -(char)iVar5 & 0x1fU );
   LAB_001043b7:if (( uVar9 >> 0x18 == 0xff ) && ( uVar3 >> 0x18 == 0xd8 )) {
      return;
   }
      ...
      if (iVar4 < 1) {
         ...
         *(uint*)( this + 0x24c0 ) = uVar3 << ( (byte)iVar5 & 0x1f );
         if (iVar4 == 0) {
            ...
            *(uint*)( this + 0x334 ) = uVar3 ^ 1;
            uVar3 = ( -(uint)(uVar3 == 0) & 0x2600 ) + 0xd900;
            LAB_0010450b:prep_in_buffer(this);
            iVar4 = *(int*)( this + 0x330 );
            if (iVar4 != 0) {
               pbVar8 = *(byte**)( this + 0x328 );
               goto LAB_00104485;
            ...
            *(uint*)( this + 0x334 ) = uVar6 ^ 1;
            ...
            LAB_0010445a:pbVar2 = *(byte**)( this + 0x328 );
            iVar4 = iVar4 + -1;
            pbVar8 = pbVar2 + 1;
            *(byte**)( this + 0x328 ) = pbVar8;
            bVar1 = *pbVar2;
            *(int*)( this + 0x330 ) = iVar4;
            ...
            LAB_00104485:*(byte**)( this + 0x328 ) = pbVar8 + 1;
            uVar6 = ( uint ) * pbVar8;
            *(int*)( this + 0x330 ) = iVar4 + -1;
         }
         ...
         iVar5 = iVar4 + 0x10;
         *(int*)( this + 0x24bc ) = iVar5;
         *(uint*)( this + 0x24c0 ) = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar6 | uVar3 ) << ( -(char)iVar4 & 0x1fU );
      }
 else {
         *(uint*)( this + 0x24c0 ) = uVar3 << 8;
         iVar5 = iVar4;
...
/* jpeg_decoder::locate_sof_marker() */void jpeg_decoder::locate_sof_marker(jpeg_decoder *this) {
   int iVar1;
...
/* jpeg_decoder::locate_sos_marker() */undefined8 jpeg_decoder::locate_sos_marker(jpeg_decoder *this) {
   int iVar1;
   iVar1 = process_markers(this);
   if (iVar1 == 0xd9) {
      return 0;
...
/* jpeg_decoder::init(jpeg_decoder_stream*) */void jpeg_decoder::init(jpeg_decoder *this, jpeg_decoder_stream *param_1) {
   byte *pbVar1;
   char cVar2;
   undefined8 uVar3;
   int iVar4;
   ...
   *(undefined8*)( this + 0x3b1 ) = 0;
   puVar11 = (undefined8*)( ( ulong )(this + 0x341) & 0xfffffffffffffff8 );
   for (uVar6 = ( ulong )(( (int)this - (int)(undefined8*)( ( ulong )(this + 0x341) & 0xfffffffffffffff8 ) ) + 0x3b9U >> 3); uVar6 != 0; uVar6 = uVar6 - 1) {
      *puVar11 = 0;
      puVar11 = puVar11 + 1;
   }
   ...
   *(undefined8*)( this + 0x24b1 ) = 0;
   puVar11 = (undefined8*)( ( ulong )(this + 0x2441) & 0xfffffffffffffff8 );
   for (uVar6 = ( ulong )(( (int)this - (int)(undefined8*)( ( ulong )(this + 0x2441) & 0xfffffffffffffff8 ) ) + 0x24b9U >> 3); uVar6 != 0; uVar6 = uVar6 - 1) {
      *puVar11 = 0;
   ...
   *(undefined8*)( this + 0x24bc ) = 0;
   if (iVar4 == 0) {
      ...
      *(uint*)( this + 0x334 ) = uVar10 ^ 1;
      uVar10 = ( -(uint)(uVar10 == 0) & 0x2600 ) + 0xd900;
      LAB_00104c70:prep_in_buffer(this);
      iVar4 = *(int*)( this + 0x330 );
      if (iVar4 != 0) {
         pbVar7 = *(byte**)( this + 0x328 );
         goto LAB_00104ad8;
      ...
      *(uint*)( this + 0x334 ) = uVar5 ^ 1;
      ...
      LAB_00104aaf:pbVar1 = *(byte**)( this + 0x328 );
      iVar4 = iVar4 + -1;
      pbVar7 = pbVar1 + 1;
      *(byte**)( this + 0x328 ) = pbVar7;
      bVar12 = *pbVar1;
      *(int*)( this + 0x330 ) = iVar4;
      uVar10 = (uint)bVar12 << 8;
      if (iVar4 == 0) goto LAB_00104c70;
      LAB_00104ad8:*(byte**)( this + 0x328 ) = pbVar7 + 1;
      uVar5 = ( uint ) * pbVar7;
      *(int*)( this + 0x330 ) = iVar4 + -1;
   }

   cVar2 = (char)*(int*)( this + 0x24bc );
   iVar4 = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar5 | uVar10 ) << ( -cVar2 & 0x1fU );
   ...
   *(int*)( this + 0x24c0 ) = iVar4 << ( cVar2 + 0x10U & 0x1f );
   ...
   if (iVar4 == 0) {
      prep_in_buffer(this);
      iVar4 = *(int*)( this + 0x330 );
      if (iVar4 != 0) goto LAB_00104b5d;
      uVar10 = *(uint*)( this + 0x334 );
      *(uint*)( this + 0x334 ) = uVar10 ^ 1;
      uVar10 = ( -(uint)(uVar10 == 0) & 0x2600 ) + 0xd900;
      LAB_00104bfa:prep_in_buffer(this);
      iVar4 = *(int*)( this + 0x330 );
      if (iVar4 != 0) {
         pbVar7 = *(byte**)( this + 0x328 );
         goto LAB_00104b82;
      ...
      *(uint*)( this + 0x334 ) = uVar5 ^ 1;
      ...
      LAB_00104b5d:pbVar1 = *(byte**)( this + 0x328 );
      iVar4 = iVar4 + -1;
      pbVar7 = pbVar1 + 1;
      *(byte**)( this + 0x328 ) = pbVar7;
      bVar12 = *pbVar1;
      *(int*)( this + 0x330 ) = iVar4;
      uVar10 = (uint)bVar12 << 8;
      if (iVar4 == 0) goto LAB_00104bfa;
      LAB_00104b82:*(byte**)( this + 0x328 ) = pbVar7 + 1;
      uVar5 = ( uint ) * pbVar7;
      *(int*)( this + 0x330 ) = iVar4 + -1;
   }
   ...
   iVar4 = *(int*)( this + 0x24bc );
   *(int*)( this + 0x24bc ) = iVar4 + 0x10;
   *(uint*)( this + 0x24c0 ) = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar5 | uVar10 ) << ( -(char)iVar4 & 0x1fU );
   LAB_00104b15:uVar3 = _LC2;
   *(undefined8*)( this + 0x2508 ) = _LC2;
   pjVar8 = this + 0x2510;
   do {
      *(undefined8*)pjVar8 = uVar3;
      pjVar9 = pjVar8 + 0x10;
      *(undefined8*)( pjVar8 + 8 ) = uVar3;
      pjVar8 = pjVar9;
   }
 while ( this + 0x2530 != pjVar9 );
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* jpeg_decoder::create_look_ups() */void jpeg_decoder::create_look_ups(jpeg_decoder *this) {
   int iVar1;
   int iVar2;
   int iVar3;
   int iVar4;
   ...
   int iVar21;
   int iVar22;
   iVar12 = _UNK_00112c9c;
   iVar11 = _UNK_00112c98;
   iVar10 = _UNK_00112c94;
   iVar9 = __LC9;
   iVar8 = _UNK_00112c8c;
   iVar7 = _UNK_00112c88;
   iVar6 = _UNK_00112c84;
   ...
   pjVar13 = this + 0x2538;
   iVar19 = __LC6;
   iVar20 = _UNK_00112c64;
   iVar21 = _UNK_00112c68;
   iVar22 = _UNK_00112c6c;
   do {
...
/* jpeg_decoder::fix_in_buffer() */void jpeg_decoder::fix_in_buffer(jpeg_decoder *this) {
   long lVar1;
   int iVar2;
...
/* jpeg_decoder::process_restart() */void jpeg_decoder::process_restart(jpeg_decoder *this) {
   char cVar1;
   byte bVar2;
   char *pcVar3;
   byte *pbVar4;
   ...
   do {
      ...
      if (iVar5 == 0) {
         ...
         *(uint*)( this + 0x334 ) = uVar6 ^ 1;
         ...
         LAB_00104ef8:pcVar3 = *(char**)( this + 0x328 );
         iVar5 = iVar5 + -1;
 ...
 while ( iVar7 != 0 );
   LAB_00105050:/* WARNING: Subroutine does not return */stop_decoding(this, 0xffffff1b);
   LAB_00104f94:if (iVar5 == 0) {
      prep_in_buffer(this);
      iVar5 = *(int*)( this + 0x330 );
      ...
      *(uint*)( this + 0x334 ) = uVar6 ^ 1;
      ...
      LAB_00104f60:pbVar4 = *(byte**)( this + 0x328 );
      *(byte**)( this + 0x328 ) = pbVar4 + 1;
      bVar2 = *pbVar4;
      uVar6 = (uint)bVar2;
      *(int*)( this + 0x330 ) = iVar5 + -1;
      if (bVar2 != 0xff) {
         LAB_00104fc4:iVar7 = *(int*)( this + 0x24cc );
...
/* jpeg_decoder::H1V1Convert() */void jpeg_decoder::H1V1Convert(jpeg_decoder *this) {
   byte bVar1;
   byte bVar2;
   byte bVar3;
   int iVar4;
   ...
   pbVar11 = (byte*)( (long)( ( *(int*)( this + 0x240 ) - *(int*)( this + 0x280 ) ) * 8 ) + *(long*)( this + 0x2530 ) );
   if (0 < iVar4) {
      ...
      do {
         ...
         do {
            ...
            *puVar7 = (char)uVar6;
            uVar6 = ( *(int*)( this + (ulong)bVar3 * 4 + 0x3138 ) + *(int*)( this + (ulong)bVar1 * 4 + 0x2d38 ) >> 0x10 ) + (uint)bVar2;
            if (0xff < uVar6) {
               uVar6 = (int)~uVar6 >> 0x1f & 0xff;
            }
...
/* jpeg_decoder::H2V1Convert() */void jpeg_decoder::H2V1Convert(jpeg_decoder *this) {
   byte bVar1;
   int iVar2;
   int iVar3;
   int iVar4;
      ...
      do {
         ...
         do {
            ...
            do {
               ...
               iVar6 = *(int*)( this + ( ulong ) * (byte*)( lVar15 + lVar13 ) * 4 + 0x3138 ) + *(int*)( this + uVar12 * 4 + 0x2d38 ) >> 0x10;
               uVar18 = iVar3 + uVar8;
               if (0xff < uVar18) {
...
/* jpeg_decoder::H1V2Convert() */void jpeg_decoder::H1V2Convert(jpeg_decoder *this) {
   long lVar1;
   int iVar2;
   int iVar3;
   uint uVar4;
   ...
   if (0 < (int)*(uint*)( this + 0x24d0 )) {
      ...
      do {
         ...
         do {
            ...
            iVar6 = *(int*)( this + ( ulong ) * (byte*)( lVar13 + lVar5 ) * 4 + 0x3138 ) + *(int*)( this + uVar9 * 4 + 0x2d38 ) >> 0x10;
            uVar4 = iVar2 + uVar8;
            if (0xff < uVar4) {
...
/* jpeg_decoder::H2V2Convert() */void jpeg_decoder::H2V2Convert(jpeg_decoder *this) {
   byte bVar1;
   int iVar2;
   int iVar3;
   uint uVar4;
      ...
      do {
         ...
         do {
            ...
            do {
               ...
               iVar7 = *(int*)( this + ( ulong ) * (byte*)( lVar9 + lVar16 ) * 4 + 0x3138 ) + *(int*)( this + uVar15 * 4 + 0x2d38 ) >> 0x10;
               uVar4 = iVar2 + uVar14;
               if (0xff < uVar4) {
                  uVar4 = (int)~uVar4 >> 0x1f & 0xff;
               }
...
/* jpeg_decoder::gray_convert() */void jpeg_decoder::gray_convert(jpeg_decoder *this) {
   uint uVar1;
   undefined4 *puVar2;
   undefined4 *puVar3;
   undefined4 *puVar4;
   ...
   if (0 < (int)uVar1) {
      puVar3 = puVar2;
      puVar5 = (undefined4*)( (long)( ( *(int*)( this + 0x240 ) - *(int*)( this + 0x280 ) ) * 8 ) + *(long*)( this + 0x2530 ) );
      do {
         puVar4 = puVar3 + 2;
         *puVar3 = *puVar5;
         puVar3[1] = puVar5[1];
...
/* jpeg_decoder::expanded_convert() */void jpeg_decoder::expanded_convert(jpeg_decoder *this) {
   byte bVar1;
   byte bVar2;
   byte bVar3;
   int iVar4;
   ...
   lVar10 = (long)( ( iVar9 >> 3 ) * *(int*)( this + 0x198 ) * 0x40 ) + ( ulong )(iVar4 * 8 & 0x38) + *(long*)( this + 0x2530 );
   if (0 < iVar14) {
      do {
         puVar8 = puVar7 + 0x20;
         lVar13 = 0;
         if (0 < *(int*)( this + 0x23c )) {
            do {
               ...
               do {
                  ...
                  *puVar6 = (char)uVar5;
                  uVar5 = ( *(int*)( this + (ulong)bVar1 * 4 + 0x3138 ) + *(int*)( this + (ulong)bVar2 * 4 + 0x2d38 ) >> 0x10 ) + (uint)bVar3;
                  if (0xff < uVar5) {
                     uVar5 = (int)~uVar5 >> 0x1f & 0xff;
                  }
...
/* jpeg_decoder::find_eoi() */void jpeg_decoder::find_eoi(jpeg_decoder *this) {
   byte bVar1;
   byte *pbVar2;
   char cVar3;
   int iVar4;
   ...
   *(undefined4*)( this + 0x24bc ) = 0;
   if (iVar4 == 0) {
      ...
      *(uint*)( this + 0x334 ) = uVar7 ^ 1;
      uVar7 = ( -(uint)(uVar7 == 0) & 0x2600 ) + 0xd900;
      LAB_00105a85:prep_in_buffer(this);
      iVar4 = *(int*)( this + 0x330 );
      if (iVar4 != 0) {
      ...
      *(uint*)( this + 0x334 ) = uVar5 ^ 1;
      ...
      LAB_0010594f:pbVar2 = *(byte**)( this + 0x328 );
      iVar4 = iVar4 + -1;
      pbVar6 = pbVar2 + 1;
      ...
      *(int*)( this + 0x330 ) = iVar4;
      ...
      LAB_00105978:*(byte**)( this + 0x328 ) = pbVar6 + 1;
      uVar5 = ( uint ) * pbVar6;
      *(int*)( this + 0x330 ) = iVar4 + -1;
   }
   ...
   if (*(int*)( this + 0x24bc ) < 1) {
      *(int*)( this + 0x24c0 ) = iVar4 << ( cVar3 + 0x10U & 0x1f );
      ...
      if (iVar4 == 0) {
         ...
         *(uint*)( this + 0x334 ) = uVar7 ^ 1;
         uVar7 = ( -(uint)(uVar7 == 0) & 0x2600 ) + 0xd900;
         LAB_00105ae0:prep_in_buffer(this);
         iVar4 = *(int*)( this + 0x330 );
         if (iVar4 != 0) {
            pbVar6 = *(byte**)( this + 0x328 );
            goto LAB_00105a0a;
         ...
         *(uint*)( this + 0x334 ) = uVar5 ^ 1;
         ...
         LAB_001059e1:pbVar2 = *(byte**)( this + 0x328 );
         iVar4 = iVar4 + -1;
         pbVar6 = pbVar2 + 1;
         *(byte**)( this + 0x328 ) = pbVar6;
         bVar1 = *pbVar2;
         *(int*)( this + 0x330 ) = iVar4;
         ...
         LAB_00105a0a:*(byte**)( this + 0x328 ) = pbVar6 + 1;
         uVar5 = ( uint ) * pbVar6;
         *(int*)( this + 0x330 ) = iVar4 + -1;
      }
      ...
      iVar4 = *(int*)( this + 0x24bc );
      *(int*)( this + 0x24bc ) = iVar4 + 0x10;
      *(uint*)( this + 0x24c0 ) = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar5 | uVar7 ) << ( -(char)iVar4 & 0x1fU );
   }
 else {
      *(int*)( this + 0x24c0 ) = iVar4 << 0x10;
   }
   ...
   LAB_00105917:*(int*)( this + 0x3550 ) = *(int*)( this + 0x3550 ) - *(int*)( this + 0x330 );
   return;
}
/* jpeg_decoder::make_huff_table(int, jpeg_decoder::huff_tables*) */void jpeg_decoder::make_huff_table(jpeg_decoder *this, int param_1, huff_tables *param_2) {
   long lVar1;
   byte bVar2;
   huff_tables hVar3;
   uint uVar4;
      ...
      if (bVar2 != 0) {
         ...
         if (uVar10 < 8) {
            ...
            *(long*)( pbVar8 + ( (ulong)uVar10 - 8 ) ) = lVar5;
            ...
            for (uVar9 = ( ulong )(( (int)pbVar8 - (int)(long*)( ( ulong )(local_140 + iVar18) & 0xfffffffffffffff8 ) ) + uVar10 >> 3); uVar9 != 0; uVar9 = uVar9 - 1) {
               *plVar14 = lVar5;
               plVar14 = plVar14 + 1;
            }
 ...
 while ( bVar2 != 0 );
   ...
   *(undefined8*)( param_2 + 0x3fc ) = 0;
   ...
   for (uVar16 = ( ulong )(( iVar12 - (int)(undefined8*)( ( ulong )(param_2 + 0xc) & 0xfffffffffffffff8 ) ) + 0x404U >> 3); uVar16 != 0; uVar16 = uVar16 - 1) {
      *puVar15 = 0;
      puVar15 = puVar15 + 1;
   }
   ...
   *(undefined8*)( param_2 + 0x7fc ) = 0;
   ...
   for (uVar16 = ( ulong )(( iVar12 - (int)(undefined8*)( ( ulong )(param_2 + 0x40c) & 0xfffffffffffffff8 ) ) + 0x804U >> 3); uVar16 != 0; uVar16 = uVar16 - 1) {
      *puVar15 = 0;
      puVar15 = puVar15 + 1;
   }
   ...
   *(undefined8*)( param_2 + 0x10fc ) = 0;
   ...
   for (uVar16 = ( ulong )(( iVar12 - (int)(undefined8*)( ( ulong )(param_2 + 0x90c) & 0xfffffffffffffff8 ) ) + 0x1104U >> 3); uVar16 != 0; uVar16 = uVar16 - 1) {
      *puVar15 = 0;
      puVar15 = puVar15 + 1;
   }
   ...
   *(undefined8*)( param_2 + 0x8fc ) = 0;
   ...
   for (uVar16 = ( ulong )(( iVar12 - (int)(undefined8*)( ( ulong )(param_2 + 0x80c) & 0xfffffffffffffff8 ) ) + 0x904U >> 3); uVar16 != 0; uVar16 = uVar16 - 1) {
      *puVar15 = 0;
      puVar15 = puVar15 + 1;
   }
...
;
                  ...
                  *(uint*)( param_2 + (ulong)uVar10 * 4 + 0x404 ) = ( uVar10 >> ( 8U - (char)uVar7 & 0x1f ) & ( 1 << ( sbyte )(bVar2 & 0xf) ) - 1U ) << 0x10 | uVar11 | uVar7 * 0x100 | 0x8000;
                  uVar10 = uVar4;
               }
 while ( uVar4 != uVar19 );
            }

            joined_r0x00105f0b:lVar5 = lVar5 + 1;
...
;
         ...
         lVar5 = lVar5 + 1;
         *(uint*)( param_2 + (long)(int)~(iVar12 - (uint)((uVar10 & 0x8000) == 0)) * 4 + 0x904 ) = (uint)bVar2;
      }
 while ( lVar6 != lVar5 );
   }

   LAB_00105dea:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* jpeg_decoder::check_quant_tables() */void jpeg_decoder::check_quant_tables(jpeg_decoder *this) {
   jpeg_decoder *pjVar1;
   if (0 < *(int*)( this + 0x1f8 )) {
      pjVar1 = this;
      do {
         if (*(long*)( this + (long)*(int*)( this + (long)*(int*)( pjVar1 + 0x1fc ) * 4 + 0x1b8 ) * 8 + 0x170 ) == 0) {
            /* WARNING: Subroutine does not return */
...
/* jpeg_decoder::check_huff_tables() */void jpeg_decoder::check_huff_tables(jpeg_decoder *this) {
   jpeg_decoder *pjVar1;
   huff_tables *phVar2;
   long lVar3;
   if (0 < *(int*)( this + 0x1f8 )) {
      ...
      do {
         if (*(int*)( this + 0x22c ) == 0) {
            while (true) {
               if (*(long*)( this + (long)*(int*)( this + (long)*(int*)( pjVar1 + 0x1fc ) * 4 + 0x20c ) * 8 + 0xf0 ) == 0) goto LAB_001060d7;
               if (0 < *(int*)( this + 0x230 )) break;
               pjVar1 = pjVar1 + 4;
               if (pjVar1 == this + (long)*(int*)( this + 0x1f8 ) * 4) goto LAB_00106078;
            }
;
            LAB_0010601a:if (*(long*)( this + (long)*(int*)( this + (long)*(int*)( pjVar1 + 0x1fc ) * 4 + 0x21c ) * 8 + 0xf0 ) == 0) {
               LAB_001060d7:/* WARNING: Subroutine does not return */stop_decoding(this, 0xffffff16);
            }
...
/* jpeg_decoder::calc_mcu_block_order() */void jpeg_decoder::calc_mcu_block_order(jpeg_decoder *this) {
   uint uVar1;
   int iVar2;
   undefined4 uVar3;
   undefined4 uVar4;
      ...
      *(int*)( this + 0x250 ) = ( iVar11 + -1 + ( iVar12 >> 3 ) ) / iVar11;
      if (0 < iVar2) {
         ...
         do {
            ...
            uVar1 = *(int*)( this + (long)iVar12 * 4 + 0x198 ) * *(int*)( this + (long)iVar12 * 4 + 0x1a8 ) - 1;
            if (*(int*)( this + (long)iVar12 * 4 + 0x198 ) * *(int*)( this + (long)iVar12 * 4 + 0x1a8 ) != 0) {
               iVar11 = *(int*)( this + 0x244 );
               pjVar8 = this + (long)iVar11 * 4;
               if (( (int)( this + ( (ulong)uVar1 + (long)iVar11 ) * 4 + 4 ) - (int)pjVar8 & 4U ) == 0) goto LAB_00106260;
               *(int*)( pjVar8 + 0x254 ) = iVar12;
               for (pjVar8 = pjVar8 + 4; pjVar8 != this + ( (ulong)uVar1 + (long)iVar11 ) * 4 + 4; pjVar8 = pjVar8 + 8) {
                  LAB_00106260:*(int*)( pjVar8 + 0x254 ) = iVar12;
                  *(int*)( pjVar8 + 600 ) = iVar12;
               }
...
/* jpeg_decoder::init_scan() [clone .part.0] */undefined8 jpeg_decoder::init_scan(jpeg_decoder *this) {
   jpeg_decoder *pjVar1;
...
/* jpeg_decoder::init_scan() */undefined8 jpeg_decoder::init_scan(jpeg_decoder *this) {
   int iVar1;
   undefined8 uVar2;
   iVar1 = process_markers(this);
   if (iVar1 == 0xd9) {
...
/* jpeg_decoder::init_frame() */void jpeg_decoder::init_frame(jpeg_decoder *this) {
   int iVar1;
   uint uVar2;
   int iVar3;
   undefined8 uVar4;
   ...
   if (*(int*)( this + 0x194 ) == 1) {
      if (*(int*)( this + 0x198 ) != 1) {
         LAB_00106438:/* WARNING: Subroutine does not return */stop_decoding(this, 0xffffff19);
      }

      if (*(int*)( this + 0x1a8 ) != 1) goto LAB_00106438;
      iVar3 = 0;
      iVar9 = 7;
      iVar7 = 7;
      iVar10 = 8;
      ...
      if (( ( ( *(int*)( this + 0x19c ) != 1 ) || ( *(int*)( this + 0x1ac ) != 1 ) ) || ( *(int*)( this + 0x1a0 ) != 1 ) ) || ( *(int*)( this + 0x1b0 ) != 1 )) goto LAB_00106438;
      if (*(int*)( this + 0x198 ) == 1) {
         if (*(int*)( this + 0x1a8 ) == 1) {
            iVar9 = 7;
            iVar10 = 8;
            ...
            if (*(int*)( this + 0x1a8 ) != 2) goto LAB_00106438;
            iVar3 = 3;
            uVar8 = 4;
            iVar9 = 0xf;
            iVar10 = 0x10;
         ...
         if (*(int*)( this + 0x198 ) != 2) goto LAB_00106438;
         if (*(int*)( this + 0x1a8 ) == 1) {
            uVar8 = 4;
            iVar9 = 7;
            iVar7 = 0xf;
   ...
   iVar1 = *(int*)( this + 0xd0 );
   *(undefined4*)( this + 0x24d4 ) = uVar8;
   *(int*)( this + 400 ) = iVar3;
   *(int*)( this + 0x23c ) = iVar11;
   *(int*)( this + 0x240 ) = iVar10;
   *(int*)( this + 0x24d0 ) = ( iVar7 + iVar1 ) / iVar11;
   *(int*)( this + 0x24e8 ) = ( *(int*)( this + 0xd4 ) + iVar9 ) / iVar10;
   if (iVar3 == 0) {
      iVar7 = 1;
      iVar3 = iVar1;
   }
   ...
   *(int*)( this + 0x284 ) = iVar3;
   *(int*)( this + 0x28c ) = iVar7;
   iVar7 = ( iVar1 + 0xfU & 0xfff0 ) * iVar7;
   *(int*)( this + 0x288 ) = iVar7;
   uVar4 = alloc(this, (long)iVar7, true);
   *(undefined8*)( this + 0x3538 ) = uVar4;
   if (*(int*)( this + 400 ) - 3U < 2) {
      uVar4 = alloc(this, (long)*(int*)( this + 0x288 ), true);
      *(undefined8*)( this + 0x3540 ) = uVar4;
   }

   iVar3 = *(int*)( this + 0x24d0 ) * *(int*)( this + 0x24d4 );
   *(int*)( this + 0x248 ) = iVar3;
   if (0x2000 < iVar3) {
      /* WARNING: Subroutine does not return */
      stop_decoding(this, 0xffffff1c);
   }

   uVar4 = alloc(this, (long)( *(int*)( this + 0x24d4 ) << 6 ) * 2, false);
   uVar2 = *(uint*)( this + 0x24d4 );
   *(undefined8*)( this + 0x2500 ) = uVar4;
   if (0 < (int)uVar2) {
      pjVar5 = this;
      if (( uVar2 & 1 ) != 0) {
         *(undefined4*)( this + 0x2508 ) = 0x40;
         pjVar5 = this + 4;
         if (this + 4 == this + (long)(int)uVar2 * 4) goto LAB_001065cd;
      }

      do {
         *(undefined4*)( pjVar5 + 0x2508 ) = 0x40;
         pjVar6 = pjVar5 + 8;
         *(undefined4*)( pjVar5 + 0x250c ) = 0x40;
         pjVar5 = pjVar6;
      }
 while ( pjVar6 != this + (long)(int)uVar2 * 4 );
   }

   LAB_001065cd:*(int*)( this + 0x24e0 ) = *(int*)( this + 0x198 ) * *(int*)( this + 0x1a8 );
   iVar7 = *(int*)( this + 0x198 ) * *(int*)( this + 0x1a8 ) * *(int*)( this + 0x194 );
   iVar3 = *(int*)( this + 0x24d0 ) * iVar7;
   *(int*)( this + 0x24d8 ) = iVar7;
   this[0x24e4] = ( jpeg_decoder )(iVar7 == 0xc);
   *(int*)( this + 0x24dc ) = iVar3;
   if (iVar7 != 0xc) {
      iVar3 = *(int*)( this + 0x248 );
   }

   uVar4 = alloc(this, (long)( iVar3 << 6 ), false);
   *(undefined4*)( this + 0x280 ) = 0;
   *(undefined8*)( this + 0x2530 ) = uVar4;
   *(undefined4*)( this + 0x27c ) = *(undefined4*)( this + 0xd4 );
   create_look_ups(this);
   return;
}
/* jpeg_decoder::coeff_buf_open(int, int, int, int) */undefined8 * __thiscall
...
/* jpeg_decoder::decode_scan(void (*)(jpeg_decoder*, int, int, int)) */void jpeg_decoder::decode_scan(jpeg_decoder *this, _func_void_jpeg_decoder_ptr_int_int_int *param_1) {
   jpeg_decoder *pjVar1;
   jpeg_decoder *pjVar2;
   int iVar3;
   int iVar4;
               ...
               if (0 < *(int*)( this + 0x244 )) {
                  ...
                  do {
                     while (true) {
                        ...
                        ( *param_1 )(this, *(int*)( this + lVar6 * 4 + 0x254 ), iVar4 + iVar7, *(int*)( local_58 + lVar5 * 4 ) + iVar3);
                        if (*(int*)( this + 0x1f8 ) != 1) break;
                        lVar6 = lVar6 + 1;
                        *(int*)( local_68 + lVar5 * 4 ) = iVar4 + 1;
                        if (*(int*)( this + 0x244 ) <= (int)lVar6) goto LAB_001068b4;
                     }
;
                     iVar7 = iVar7 + 1;
 ...
 while ( (int)lVar6 < *(int*)( this + 0x244 ) );
               ...
               LAB_001068b4:local_78 = local_78 + 1;
 ...
 while ( local_78 < *(int*)( this + 0x24c ) );
         ...
         if (iVar3 == 1) {
            *(int*)( local_58 + (long)*(int*)( this + 0x1fc ) * 4 ) = *(int*)( local_58 + (long)*(int*)( this + 0x1fc ) * 4 ) + 1;
         }
 else if (0 < iVar3) {
            pjVar2 = this;
            do {
               pjVar1 = pjVar2 + 0x1fc;
               pjVar2 = pjVar2 + 4;
               *(int*)( local_58 + (long)*(int*)pjVar1 * 4 ) = *(int*)( local_58 + (long)*(int*)pjVar1 * 4 ) + *(int*)( this + (long)*(int*)pjVar1 * 4 + 0x1a8 );
            }
...
/* jpeg_decoder::init_progressive() [clone .part.0] */void jpeg_decoder::init_progressive(jpeg_decoder *this) {
   byte bVar1;
   int iVar2;
   int iVar3;
   int iVar4;
 ...
 while ( (int)lVar14 < *(int*)( this + 0x194 ) );
   ...
   LAB_00106ac0:iVar8 = process_markers(this);
   do {
      if (iVar8 == 0xd9) {
         LAB_00106be9:iVar8 = *(int*)( this + 0x194 );
         lVar14 = 0;
 ...
 while ( iVar8 != lVar14 );
      ...
      if (iVar8 == 0) goto LAB_00106be9;
      iVar8 = *(int*)( this + 0x230 );
      iVar2 = *(int*)( this + 0x238 );
      if (( iVar8 < *(int*)( this + 0x22c ) ) || ( 0x3f < iVar8 )) {
         LAB_00106dfc:/* WARNING: Subroutine does not return */stop_decoding(this, 0xffffff1d);
      }

      if (*(int*)( this + 0x22c ) == 0) {
         if (iVar8 != 0) goto LAB_00106dfc;
         pcVar13 = decode_block_dc_first;
         if (iVar2 != 0) {
            if (iVar2 + -1 != *(int*)( this + 0x234 )) {
               LAB_00106e16:/* WARNING: Subroutine does not return */stop_decoding(this, 0xffffff1e);
            }
         ...
         if (*(int*)( this + 0x1f8 ) != 1) goto LAB_00106dfc;
         pcVar13 = decode_block_ac_first;
         if (iVar2 != 0) {
            if (iVar2 + -1 != *(int*)( this + 0x234 )) goto LAB_00106e16;
      ...
      *(int*)( this + 0x24c0 ) = *(int*)( this + 0x24c0 ) << 0x10;
      if (iVar8 == 0) {
         ...
         *(uint*)( this + 0x334 ) = uVar11 ^ 1;
         ...
         LAB_00106b69:pbVar5 = *(byte**)( this + 0x328 );
         iVar8 = iVar8 + -1;
         pbVar12 = pbVar5 + 1;
         *(byte**)( this + 0x328 ) = pbVar12;
         bVar1 = *pbVar5;
         *(int*)( this + 0x330 ) = iVar8;
         uVar15 = (uint)bVar1 << 8;
         if (iVar8 == 0) goto LAB_00106d2b;
         LAB_00106b94:*(byte**)( this + 0x328 ) = pbVar12 + 1;
         uVar11 = ( uint ) * pbVar12;
         *(int*)( this + 0x330 ) = iVar8 + -1;
      }
 ...
 while ( true );
   *(int*)( this + 0x24c0 ) = iVar8 << ( cVar6 + 0x10U & 0x1f );
   ...
   if (iVar8 == 0) {
      prep_in_buffer(this);
      iVar8 = *(int*)( this + 0x330 );
      if (iVar8 != 0) goto LAB_00106c79;
      uVar15 = *(uint*)( this + 0x334 );
      *(uint*)( this + 0x334 ) = uVar15 ^ 1;
      uVar15 = ( -(uint)(uVar15 == 0) & 0x2600 ) + 0xd900;
      LAB_00106d8b:prep_in_buffer(this);
      iVar8 = *(int*)( this + 0x330 );
      if (iVar8 == 0) {
         uVar11 = *(uint*)( this + 0x334 );
         *(uint*)( this + 0x334 ) = uVar11 ^ 1;
      ...
      LAB_00106c79:pbVar5 = *(byte**)( this + 0x328 );
      iVar8 = iVar8 + -1;
      pbVar12 = pbVar5 + 1;
      *(byte**)( this + 0x328 ) = pbVar12;
      bVar1 = *pbVar5;
      *(int*)( this + 0x330 ) = iVar8;
      uVar15 = (uint)bVar1 << 8;
      if (iVar8 == 0) goto LAB_00106d8b;
   }

   *(byte**)( this + 0x328 ) = pbVar12 + 1;
   uVar11 = ( uint ) * pbVar12;
   *(int*)( this + 0x330 ) = iVar8 + -1;
   LAB_00106cbc:iVar8 = *(int*)( this + 0x24bc );
   *(int*)( this + 0x24bc ) = iVar8 + 0x10;
   *(uint*)( this + 0x24c0 ) = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar11 | uVar15 ) << ( -(char)iVar8 & 0x1fU );
   goto LAB_00106ac0;
}
/* jpeg_decoder::init_progressive() */void jpeg_decoder::init_progressive(jpeg_decoder *this) {
   if (*(int*)( this + 0x194 ) != 4) {
...
/* jpeg_decoder::init_sequential() */void jpeg_decoder::init_sequential(jpeg_decoder *this) {
   int iVar1;
   iVar1 = process_markers(this);
...
/* jpeg_decoder::decode_start() */void jpeg_decoder::decode_start(jpeg_decoder *this) {
   int iVar1;
   init_frame(this);
   if (*(int*)( this + 0xe0 ) == 0) {
      iVar1 = process_markers(this);
...
/* jpeg_decoder::decode_init(jpeg_decoder_stream*) */void jpeg_decoder::decode_init(jpeg_decoder *this, jpeg_decoder_stream *param_1) {
   init(this, param_1);
   locate_sof_marker(this);
   return;
}
/* jpeg_decoder::jpeg_decoder(jpeg_decoder_stream*) */void jpeg_decoder::jpeg_decoder(jpeg_decoder *this, jpeg_decoder_stream *param_1) {
   int iVar1;
...
/* jpeg_decoder::begin_decoding() */undefined8 jpeg_decoder::begin_decoding(jpeg_decoder *this) {
   int iVar1;
   undefined8 uVar2;
   if (this[0x354c] == (jpeg_decoder)0x0) {
      ...
      LAB_00106fb7:uVar2 = 0;
   }

   return uVar2;
}
/* jpeg_decoder::~jpeg_decoder() */void jpeg_decoder::~jpeg_decoder(jpeg_decoder *this) {
   undefined8 *puVar1;
   undefined8 *__ptr;
   if (*(long**)( this + 0xd8 ) != (long*)0x0) {
      ( **(code**)( **(long**)( this + 0xd8 ) + 8 ) )();
...
/* jpeg_decoder_file_stream::close() */void jpeg_decoder_file_stream::close(jpeg_decoder_file_stream *this) {
   if (*(FILE**)( this + 8 ) != (FILE*)0x0) {
      fclose(*(FILE**)( this + 8 ));
      *(undefined8*)( this + 8 ) = 0;
   }
...
/* jpeg_decoder_file_stream::open(char const*) */bool jpeg_decoder_file_stream::open(jpeg_decoder_file_stream *this, char *param_1) {
   FILE *pFVar1;
   if (*(FILE**)( this + 8 ) != (FILE*)0x0) {
      fclose(*(FILE**)( this + 8 ));
      *(undefined8*)( this + 8 ) = 0;
...
/* jpeg_decoder_mem_stream::open(unsigned char const*, unsigned int) */undefined8 jpeg_decoder_mem_stream::open(jpeg_decoder_mem_stream *this, uchar *param_1, uint param_2) {
   *(undefined4*)( this + 0x10 ) = 0;
   *(uchar**)( this + 8 ) = param_1;
   *(uint*)( this + 0x14 ) = param_2;
   return 1;
}
/* jpgdHeader(char const*, int, int*, int*) */jpeg_decoder *jpgdHeader(char *param_1, int param_2, int *param_3, int *param_4) {
   undefined8 *puVar1;
   undefined8 *__ptr;
   jpeg_decoder *this;
   ...
   *(undefined***)pjVar2 = &PTR__jpeg_decoder_mem_stream_00112c30;
...
/* jpgdHeader(char const*, int*, int*) */jpeg_decoder *jpgdHeader(char *param_1, int *param_2, int *param_3) {
   undefined8 *puVar1;
   undefined8 *__ptr;
   jpeg_decoder_stream *pjVar2;
   FILE *pFVar3;
   jpeg_decoder *this;
   pjVar2 = (jpeg_decoder_stream*)operator_new(0x18);
   *(undefined***)pjVar2 = &PTR__jpeg_decoder_file_stream_00112c08;
...
/* jpgdDelete(jpeg_decoder*) */void jpgdDelete(jpeg_decoder *param_1) {
   undefined8 *puVar1;
   undefined8 *__ptr;
...
/* idct_4x4(short const*, unsigned char*) */void idct_4x4(short *param_1, uchar *param_2) {
   int iVar1;
   int iVar2;
   int iVar3;
   int iVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* idct(short const*, unsigned char*, int) */void idct(short *param_1, uchar *param_2, int param_3) {
   uchar uVar1;
   uint uVar2;
   int iVar3;
   int *piVar4;
      ...
      *(int*)param_2 = iVar3;
      ...
      do {
        ...
        *piVar4 = iVar5 * 0x2c63 + iVar3 + __LC13 >> 0xb;
        piVar4[1] = iVar5 * 0x25a1 + iVar3 + _UNK_00112ca4 >> 0xb;
        piVar4[2] = iVar5 * 0x1925 + iVar3 + _UNK_00112ca8 >> 0xb;
        piVar4[3] = iVar5 * 0x8d4 + iVar3 + _UNK_00112cac >> 0xb;
        piVar4[4] = iVar3 + iVar5 * -0x8d4 + __LC13 >> 0xb;
        piVar4[5] = iVar3 + iVar5 * -0x1925 + _UNK_00112ca4 >> 0xb;
        piVar4[6] = iVar3 + iVar5 * -0x25a1 + _UNK_00112ca8 >> 0xb;
        piVar4[7] = iVar3 + iVar5 * -0x2c63 + _UNK_00112cac >> 0xb;
        break;
            case 3:
        iVar7 = (int)param_1[2];
...
LAB_00107795:
 ...
 while ( piVar4 != local_48 );
      ...
      do {
         switch (s_idct_col_table[param_3 + -1]) {
            case 1:
        goto switchD_00107763_caseD_1;
            case 2:
        goto switchD_00107763_caseD_2;
            case 3:
        goto switchD_00107763_caseD_3;
            case 4:
        goto switchD_00107763_caseD_4;
            case 5:
        goto switchD_00107763_caseD_5;
            case 6:
        goto switchD_00107763_caseD_6;
            case 7:
        goto switchD_00107763_caseD_7;
            case 8:
        goto switchD_00107763_caseD_8;
         }
 ...
 while ( piVar18 != piVar4 );
   ...
   LAB_00107cb8:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }

   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   switchD_00107763_caseD_8:do {
      piVar17 = piVar18 + 1;
...
/* jpeg_decoder::transform_mcu(int) */void jpeg_decoder::transform_mcu(jpeg_decoder *this, int param_1) {
   long lVar1;
   uchar *puVar2;
   long lVar3;
   short *psVar4;
...
/* jpeg_decoder::transform_mcu_expand(int) */void jpeg_decoder::transform_mcu_expand(jpeg_decoder *this, int param_1) {
...
LAB_001089e1:
      ...
      break;
         default:
      goto switchD_001080aa_caseD_13;
         case 0x22:
...
LAB_00108e99:
      ...
      do {
         ...
         *(int*)( (long)local_188 + lVar22 + 0x40 ) = *(int*)( lVar22 + (long)local_208 ) + *(int*)( (long)piVar23 + lVar22 );
 ...
 while ( piVar24 != (int*)local_208 );
      ...
      do {
         ...
         *(int*)( (long)local_188 + lVar22 + 0x80 ) = *(int*)( lVar22 + (long)local_188 ) + *(int*)( (long)piVar25 + lVar22 );
 ...
 while ( local_188 != piVar29 );
      ...
      local_c8[0] = CONCAT26(sVar53 + sVar47, CONCAT24(sVar50 + sVar45, CONCAT22(sVar57 + sVar52, sVar60 + sVar49)));
      ...
      local_b8 = CONCAT26(sVar59 + sVar58, CONCAT24(sVar56 + sVar55, CONCAT22(sVar67 + sVar54, sVar68 + sVar51)));
      local_98 = CONCAT26(sVar62 + sVar64, CONCAT24(sVar61 + sVar63, CONCAT22(sVar48 + sVar70, sVar46 + sVar69)));
      ...
      local_a8 = CONCAT26(sVar72 + sVar75, CONCAT24(sVar71 + sVar73, CONCAT22(sVar76 + sVar66, sVar74 + sVar65)));
      idct_4x4((short*)local_c8, puVar21);
      local_c8[0] = CONCAT26(sVar47 - sVar53, CONCAT24(sVar45 - sVar50, CONCAT22(sVar52 - sVar57, sVar49 - sVar60)));
      local_b8 = CONCAT26(sVar58 - sVar59, CONCAT24(sVar55 - sVar56, CONCAT22(sVar54 - sVar67, sVar51 - sVar68)));
      local_a8 = CONCAT26(sVar75 - sVar72, CONCAT24(sVar73 - sVar71, CONCAT22(sVar66 - sVar76, sVar65 - sVar74)));
      local_98 = CONCAT26(sVar64 - sVar62, CONCAT24(sVar63 - sVar61, CONCAT22(sVar70 - sVar48, sVar69 - sVar46)));
      ...
      local_c8[0] = CONCAT26(sVar60 + sVar49, CONCAT24(sVar52 + sVar47, CONCAT22(sVar68 + sVar54, sVar65 + sVar51)));
      ...
      local_b8 = CONCAT26(sVar72 + sVar67, CONCAT24(sVar69 + sVar66, CONCAT22(sVar58 + sVar55, sVar56 + sVar53)));
      ...
      local_a8 = CONCAT26(sVar76 + sVar73, CONCAT24(sVar75 + sVar70, CONCAT22(sVar74 + sVar59, sVar71 + sVar57)));
      ...
      local_98 = CONCAT26(sVar62 + sVar64, CONCAT24(sVar61 + sVar63, CONCAT22(sVar50 + sVar46, sVar48 + sVar45)));
      idct_4x4((short*)local_c8, puVar21 + 0x80);
      puVar42 = puVar21 + 0xc0;
      puVar21 = puVar21 + 0x100;
      local_c8[0] = CONCAT26(sVar49 - sVar60, CONCAT24(sVar47 - sVar52, CONCAT22(sVar54 - sVar68, sVar51 - sVar65)));
      local_b8 = CONCAT26(sVar67 - sVar72, CONCAT24(sVar66 - sVar69, CONCAT22(sVar55 - sVar58, sVar53 - sVar56)));
      local_a8 = CONCAT26(sVar73 - sVar76, CONCAT24(sVar70 - sVar75, CONCAT22(sVar59 - sVar74, sVar57 - sVar71)));
      local_98 = CONCAT26(sVar64 - sVar62, CONCAT24(sVar63 - sVar61, CONCAT22(sVar46 - sVar50, sVar45 - sVar48)));
      idct_4x4((short*)local_c8, puVar42);
   }
 while ( psVar44 != psVar43 );
   switchD_001080aa_caseD_13:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* jpeg_decoder::load_next_row() */void jpeg_decoder::load_next_row(jpeg_decoder *this) {
   jpeg_decoder *pjVar1;
   short sVar2;
   int iVar3;
   long *plVar4;
      ...
      do {
         while (true) {
            ...
            do {
               ...
               sVar2 = *(short*)( (long)( (int)plVar5[1] * (int)plVar5[3] * ( *(int*)( this + lVar16 * 4 + 0x314 ) + iVar17 ) ) + *plVar5 + (long)( (int)plVar5[3] * ( iVar3 + iVar18 ) ) );
               lVar14 = 0x3f;
               puVar10 = (undefined8*)( (long)( (int)plVar4[1] * (int)plVar4[3] * ( *(int*)( this + lVar16 * 4 + 0x314 ) + iVar17 ) ) + 2 + (long)( ( iVar3 + iVar18 ) * (int)plVar4[3] ) + *plVar4 );
               *psVar8 = sVar2;
               uVar7 = puVar10[1];
               ...
               *(undefined8*)( psVar8 + 5 ) = uVar7;
               for (int i = 0; i < 6; i++) {
                  uVar7 = puVar10[( 2*i + 3 )];
                  *(undefined8*)( psVar8 + ( 8*i + 9 ) ) = puVar10[( 2*i + 2 )];
                  *(undefined8*)( psVar8 + ( 8*i + 13 ) ) = uVar7;
               }
...
;
               ...
               iVar13 = iVar12 + 1;
               sVar2 = psVar8[lVar11];
               LAB_0010a415:*(int*)( this + lVar20 * 4 + 0x2508 ) = iVar13;
               lVar11 = (long)iVar12;
               while (true) {
                  if (sVar2 != 0) {
...
;
 ...
 while ( (int)lVar20 < iVar3 );
            if (this[0x24e4] != (jpeg_decoder)0x0) goto LAB_0010a59c;
            if (0 < iVar3) {
               lVar20 = 0;
 ...
 while ( (int)lVar20 < *(int*)( this + 0x244 ) );
            ...
            LAB_0010a500:iVar15 = iVar15 + 1;
            if (*(int*)( this + 0x24c ) <= iVar15) goto LAB_0010a510;
         }
;
         if (this[0x24e4] == (jpeg_decoder)0x0) goto LAB_0010a500;
         LAB_0010a59c:iVar17 = iVar15 + 1;
 ...
 while ( iVar17 < *(int*)( this + 0x24c ) );
   ...
   LAB_0010a510:iVar15 = *(int*)( this + 0x1f8 );
   if (iVar15 == 1) {
      *(int*)( this + (long)*(int*)( this + 0x1fc ) * 4 + 0x314 ) = *(int*)( this + (long)*(int*)( this + 0x1fc ) * 4 + 0x314 ) + 1;
   }
 else if (0 < iVar15) {
      pjVar9 = this;
      do {
         pjVar1 = pjVar9 + 0x1fc;
         pjVar9 = pjVar9 + 4;
         *(int*)( this + (long)*(int*)pjVar1 * 4 + 0x314 ) = *(int*)( this + (long)*(int*)pjVar1 * 4 + 0x314 ) + *(int*)( this + (long)*(int*)pjVar1 * 4 + 0x1a8 );
      }
...
/* jpeg_decoder::decode_next_row() */void jpeg_decoder::decode_next_row(jpeg_decoder *this) {
   byte bVar1;
   int iVar2;
   short *psVar3;
   long lVar4;
   ...
   do {
      ...
      if (*(int*)( this + 0x244 ) < 1) {
         if (this[0x24e4] != (jpeg_decoder)0x0) goto LAB_0010a96f;
      }
 else {
         lVar19 = 0;
         do {
            ...
            uVar12 = *(uint*)( *(long*)( this + (long)*(int*)( this + (long)iVar10 * 4 + 0x20c ) * 8 + 0x290 ) + 0x404 + ( ulong )(*(uint*)( this + 0x24c0 ) >> 0x18) * 4 );
            if ((int)uVar12 < 0) {
               iVar14 = 0x17;
               do {
                  bVar9 = (byte)iVar14;
                  iVar14 = iVar14 + -1;
                  uVar12 = *(uint*)( *(long*)( this + (long)*(int*)( this + (long)iVar10 * 4 + 0x20c ) * 8 + 0x290 ) + 0x904 + (long)(int)-((*(uint *)(this + 0x24c0) >> (bVar9 & 0x1f) & 1) + uVar12
                                          ) * 4 );
               }
 while ( (int)uVar12 < 0 );
               uVar12 = uVar12 & 0xf;
            ...
            do {
               while (true) {
                  ...
                  do {
                     bVar9 = (byte)iVar10;
                     iVar10 = iVar10 + -1;
                     uVar15 = *(uint*)( lVar4 + 0x904 + (long)(int)-((uVar12 >> (bVar9 & 0x1f) & 1) + uVar15) * 4 );
                  }
 while ( (int)uVar15 < 0 );
                     ...
                     *(uint*)( this + 0x24c0 ) = uVar12;
                     if (iVar10 < 2) {
                        if (iVar10 == 0) {
                           prep_in_buffer(this);
                           iVar10 = *(int*)( this + 0x330 );
                           if (iVar10 != 0) goto LAB_0010b1a0;
                           uVar12 = *(uint*)( this + 0x334 );
                           *(uint*)( this + 0x334 ) = uVar12 ^ 1;
                           uVar12 = ( -(uint)(uVar12 == 0) & 0x2600 ) + 0xd900;
                        }
 else {
                           LAB_0010b1a0:pbVar5 = *(byte**)( this + 0x328 );
                           iVar10 = iVar10 + -1;
                           pbVar8 = pbVar5 + 1;
                           *(byte**)( this + 0x328 ) = pbVar8;
                           bVar9 = *pbVar5;
                           *(int*)( this + 0x330 ) = iVar10;
                           ...
                           LAB_0010b1ce:if (iVar10 != 0) goto LAB_0010b098;
                        }
                        ...
                        if (iVar10 == 0) {
                           ...
                           *(uint*)( this + 0x334 ) = uVar20 ^ 1;
                           ...
                           LAB_0010b098:pbVar5 = *(byte**)( this + 0x328 );
                           iVar10 = iVar10 + -1;
                           pbVar8 = pbVar5 + 1;
                           *(byte**)( this + 0x328 ) = pbVar8;
                           uVar20 = ( uint ) * pbVar5;
                           ...
                           if (uVar20 == 0xff) {
                              if (iVar10 == 0) {
                                 ...
                                 *(uint*)( this + 0x334 ) = *(uint*)( this + 0x334 ) ^ 1;
                                 ...
                                 LAB_0010b0c9:*(byte**)( this + 0x328 ) = pbVar8 + 1;
                                 bVar9 = *pbVar8;
                                 *(int*)( this + 0x330 ) = iVar10 + -1;
                                 if (bVar9 == 0) goto LAB_0010b058;
                                 *(byte**)( this + 0x328 ) = pbVar8;
                                 *pbVar8 = bVar9;
                                 *(int*)( this + 0x330 ) = *(int*)( this + 0x330 ) + 1;
                              }
                        ...
                        LAB_0010b058:iVar17 = *(int*)( this + 0x24bc );
                        uVar12 = uVar20 | uVar12 | *(uint*)( this + 0x24c0 );
                     }
 else {
                        pbVar5 = *(byte**)( this + 0x328 );
                        bVar9 = *pbVar5;
                        if (( bVar9 == 0xff ) || ( bVar1 = bVar1 == 0xff )) {
                           pbVar8 = pbVar5 + 1;
                           iVar10 = iVar10 + -1;
                           *(byte**)( this + 0x328 ) = pbVar8;
                           bVar9 = *pbVar5;
                           *(int*)( this + 0x330 ) = iVar10;
                           if (bVar9 == 0xff) goto LAB_0010b9e0;
                           uVar12 = (uint)bVar9 << 8;
                           goto LAB_0010b098;
                        }
                  ...
                  *(int*)( this + 0x24bc ) = iVar16;
                     ...
                     if (iVar10 < 2) {
                        if (iVar10 == 0) {
                           ...
                           *(int*)( this + 0x330 ) = iVar10;
                           ...
                           LAB_0010af1a:if (iVar10 != 0) goto LAB_0010af22;
                        }
                        ...
                        if (iVar10 == 0) {
                           ...
                           *(uint*)( this + 0x334 ) = uVar11 ^ 1;
                           ...
                           LAB_0010af22:pbVar5 = *(byte**)( this + 0x328 );
                           iVar10 = iVar10 + -1;
                           pbVar8 = pbVar5 + 1;
                           *(byte**)( this + 0x328 ) = pbVar8;
                           uVar11 = ( uint ) * pbVar5;
                           ...
                           if (uVar11 == 0xff) {
                              if (iVar10 == 0) {
                                 ...
                                 *(uint*)( this + 0x334 ) = *(uint*)( this + 0x334 ) ^ 1;
                                 ...
                                 LAB_0010af51:*(byte**)( this + 0x328 ) = pbVar8 + 1;
                                 bVar9 = *pbVar8;
                                 *(int*)( this + 0x330 ) = iVar10 + -1;
                                 if (bVar9 == 0) goto LAB_0010aed0;
                                 *(byte**)( this + 0x328 ) = pbVar8;
                                 *pbVar8 = bVar9;
                                 *(int*)( this + 0x330 ) = *(int*)( this + 0x330 ) + 1;
                              }
                        ...
                        LAB_0010aed0:uVar18 = uVar11 | uVar18 | *(uint*)( this + 0x24c0 );
                        iVar16 = *(int*)( this + 0x24bc );
                     }
 else {
                        pbVar5 = *(byte**)( this + 0x328 );
                        ...
                        if (( bVar9 == 0xff ) || ( bVar1 = bVar1 == 0xff )) {
                           ...
                           *(byte**)( this + 0x328 ) = pbVar8;
                           bVar9 = *pbVar5;
                           *(int*)( this + 0x330 ) = iVar10;
                           if (bVar9 == 0xff) goto LAB_0010b945;
                           uVar18 = (uint)bVar9 << 8;
                           goto LAB_0010af22;
                        }
                  ...
                  LAB_0010a7db:iVar10 = iVar14;
                  if (uVar12 != 0) {
                     iVar10 = uVar12 + iVar14;
                     if (0x3f < iVar10) {
                        LAB_0010c04c:/* WARNING: Subroutine does not return */stop_decoding(this, 0xffffff1a);
                     }
 ...
 while ( piVar7 != (int*)( g_ZAG + ( ( ulong )(uVar20 - 1) + (long)iVar14 ) * 4 + 4 ) );
                  ...
                  if (iVar14 == 0x40) goto LAB_0010a92b;
               }
;
               ...
               if (( uVar15 & 0x8000 ) == 0) {
                  ...
                  if (iVar16 + 0x10 < iVar10) {
                           ...
                           *(uint*)( this + 0x24c0 ) = uVar12;
                           if (iVar17 < 2) {
                              if (iVar17 == 0) {
                                 prep_in_buffer(this);
                                 iVar17 = *(int*)( this + 0x330 );
                                 if (iVar17 != 0) goto LAB_0010b59f;
                                 uVar12 = *(uint*)( this + 0x334 );
                                 *(uint*)( this + 0x334 ) = uVar12 ^ 1;
                                 uVar12 = ( -(uint)(uVar12 == 0) & 0x2600 ) + 0xd900;
                              }
 else {
                                 LAB_0010b59f:pbVar5 = *(byte**)( this + 0x328 );
                                 iVar17 = iVar17 + -1;
                                 pbVar8 = pbVar5 + 1;
                                 *(byte**)( this + 0x328 ) = pbVar8;
                                 bVar9 = *pbVar5;
                                 *(int*)( this + 0x330 ) = iVar17;
                                 ...
                                 LAB_0010b5d1:if (iVar17 != 0) goto LAB_0010b5da;
                              }
                              ...
                              if (iVar17 == 0) {
                                 ...
                                 *(uint*)( this + 0x334 ) = uVar20 ^ 1;
                                 ...
                                 LAB_0010b5da:pbVar5 = *(byte**)( this + 0x328 );
                                 iVar17 = iVar17 + -1;
                                 pbVar8 = pbVar5 + 1;
                                 *(byte**)( this + 0x328 ) = pbVar8;
                                 uVar20 = ( uint ) * pbVar5;
                                 ...
                                 if (uVar20 == 0xff) {
                                    if (iVar17 == 0) {
                                       ...
                                       *(uint*)( this + 0x334 ) = *(uint*)( this + 0x334 ) ^ 1;
                                       ...
                                       LAB_0010b60b:*(byte**)( this + 0x328 ) = pbVar8 + 1;
                                       bVar9 = *pbVar8;
                                       *(int*)( this + 0x330 ) = iVar17 + -1;
                                       if (bVar9 == 0) goto LAB_0010b587;
                                       *(byte**)( this + 0x328 ) = pbVar8;
                                       *pbVar8 = bVar9;
                                       *(int*)( this + 0x330 ) = *(int*)( this + 0x330 ) + 1;
                                    }
                              ...
                              LAB_0010b587:iVar10 = *(int*)( this + 0x24bc );
                              ...
                              if (( bVar9 == 0xff ) || ( bVar1 = bVar1 == 0xff )) {
                                 ...
                                 *(byte**)( this + 0x328 ) = pbVar8;
                                 bVar9 = *pbVar5;
                                 *(int*)( this + 0x330 ) = iVar17;
                                 if (bVar9 == 0xff) goto LAB_0010ba84;
                                 uVar12 = (uint)bVar9 << 8;
                                 goto LAB_0010b5da;
                              }
                     ...
                     *(uint*)( this + 0x24c0 ) = uVar20;
                     if (iVar17 < 2) {
                        if (iVar17 == 0) {
                           prep_in_buffer(this);
                           iVar17 = *(int*)( this + 0x330 );
                           if (iVar17 != 0) goto LAB_0010b417;
                           uVar12 = *(uint*)( this + 0x334 );
                           *(uint*)( this + 0x334 ) = uVar12 ^ 1;
                           uVar12 = ( -(uint)(uVar12 == 0) & 0x2600 ) + 0xd900;
                        }
 else {
                           LAB_0010b417:pbVar5 = *(byte**)( this + 0x328 );
                           iVar17 = iVar17 + -1;
                           pbVar8 = pbVar5 + 1;
                           *(byte**)( this + 0x328 ) = pbVar8;
                           bVar9 = *pbVar5;
                           *(int*)( this + 0x330 ) = iVar17;
                           ...
                           LAB_0010b444:if (iVar17 != 0) goto LAB_0010b44c;
                        }
                        ...
                        if (iVar17 == 0) {
                           ...
                           *(uint*)( this + 0x334 ) = uVar20 ^ 1;
                           ...
                           LAB_0010b44c:pbVar5 = *(byte**)( this + 0x328 );
                           iVar17 = iVar17 + -1;
                           pbVar8 = pbVar5 + 1;
                           *(byte**)( this + 0x328 ) = pbVar8;
                           uVar20 = ( uint ) * pbVar5;
                           ...
                           if (uVar20 == 0xff) {
                              if (iVar17 == 0) {
                                 ...
                                 *(uint*)( this + 0x334 ) = *(uint*)( this + 0x334 ) ^ 1;
                                 ...
                                 LAB_0010b47b:*(byte**)( this + 0x328 ) = pbVar8 + 1;
                                 bVar9 = *pbVar8;
                                 *(int*)( this + 0x330 ) = iVar17 + -1;
                                 if (bVar9 == 0) goto LAB_0010b400;
                                 *(byte**)( this + 0x328 ) = pbVar8;
                                 *pbVar8 = bVar9;
                                 *(int*)( this + 0x330 ) = *(int*)( this + 0x330 ) + 1;
                              }
                        ...
                        LAB_0010b400:iVar16 = *(int*)( this + 0x24bc );
                        uVar12 = *(uint*)( this + 0x24c0 ) | uVar20 | uVar12;
                     }
 else {
                        pbVar5 = *(byte**)( this + 0x328 );
                        ...
                        if (( bVar9 == 0xff ) || ( bVar1 = bVar1 == 0xff )) {
                           ...
                           *(byte**)( this + 0x328 ) = pbVar8;
                           bVar9 = *pbVar5;
                           *(int*)( this + 0x330 ) = iVar17;
                           if (bVar9 == 0xff) goto LAB_0010bb1f;
                           uVar12 = (uint)bVar9 << 8;
                           goto LAB_0010b44c;
                        }
                     ...
                     *(uint*)( this + 0x24c0 ) = uVar12 << ( -(char)iVar16 & 0x1fU );
                     ...
                     if (iVar10 == 0) {
                        LAB_0010aa48:uVar12 = (int)uVar15 >> 4 & 0xf;
                        goto LAB_0010a905;
                     }
                     ...
                     *(uint*)( this + 0x24c0 ) = uVar12;
                     if (iVar10 < 2) {
                        if (iVar10 == 0) {
                           prep_in_buffer(this);
                           iVar10 = *(int*)( this + 0x330 );
                           if (iVar10 != 0) goto LAB_0010b29f;
                           uVar12 = *(uint*)( this + 0x334 );
                           *(uint*)( this + 0x334 ) = uVar12 ^ 1;
                           uVar12 = ( -(uint)(uVar12 == 0) & 0x2600 ) + 0xd900;
                        }
 else {
                           LAB_0010b29f:pbVar5 = *(byte**)( this + 0x328 );
                           iVar10 = iVar10 + -1;
                           pbVar8 = pbVar5 + 1;
                           *(byte**)( this + 0x328 ) = pbVar8;
                           bVar9 = *pbVar5;
                           *(int*)( this + 0x330 ) = iVar10;
                           ...
                           LAB_0010b2d0:if (iVar10 != 0) goto LAB_0010b2d8;
                        }
                        ...
                        if (iVar10 == 0) {
                           ...
                           *(uint*)( this + 0x334 ) = uVar20 ^ 1;
                           ...
                           LAB_0010b2d8:pbVar5 = *(byte**)( this + 0x328 );
                           iVar10 = iVar10 + -1;
                           pbVar8 = pbVar5 + 1;
                           *(byte**)( this + 0x328 ) = pbVar8;
                           uVar20 = ( uint ) * pbVar5;
                           ...
                           if (uVar20 == 0xff) {
                              if (iVar10 == 0) {
                                 ...
                                 *(uint*)( this + 0x334 ) = *(uint*)( this + 0x334 ) ^ 1;
                                 ...
                                 LAB_0010b307:*(byte**)( this + 0x328 ) = pbVar8 + 1;
                                 bVar9 = *pbVar8;
                                 *(int*)( this + 0x330 ) = iVar10 + -1;
                                 if (bVar9 == 0) goto LAB_0010b287;
                                 *(byte**)( this + 0x328 ) = pbVar8;
                                 *pbVar8 = bVar9;
                                 *(int*)( this + 0x330 ) = *(int*)( this + 0x330 ) + 1;
                              }
                        ...
                        LAB_0010b287:iVar17 = *(int*)( this + 0x24bc );
                        uVar12 = *(uint*)( this + 0x24c0 ) | uVar20 | uVar12;
                     }
 else {
                        pbVar5 = *(byte**)( this + 0x328 );
                        ...
                        if (( bVar9 == 0xff ) || ( bVar1 = bVar1 == 0xff )) {
                           ...
                           *(byte**)( this + 0x328 ) = pbVar8;
                           bVar9 = *pbVar5;
                           *(int*)( this + 0x330 ) = iVar10;
                           if (bVar9 == 0xff) goto LAB_0010bbb9;
                           uVar12 = (uint)bVar9 << 8;
                           goto LAB_0010b2d8;
                        }
                        ...
                        *(uint*)( this + 0x24c0 ) = uVar12;
                        if (iVar17 < 2) {
                           if (iVar17 == 0) {
                              prep_in_buffer(this);
                              iVar17 = *(int*)( this + 0x330 );
                              if (iVar17 != 0) goto LAB_0010b720;
                              uVar12 = *(uint*)( this + 0x334 );
                              *(uint*)( this + 0x334 ) = uVar12 ^ 1;
                              uVar12 = ( -(uint)(uVar12 == 0) & 0x2600 ) + 0xd900;
                           }
 else {
                              LAB_0010b720:pbVar5 = *(byte**)( this + 0x328 );
                              iVar17 = iVar17 + -1;
                              pbVar8 = pbVar5 + 1;
                              *(byte**)( this + 0x328 ) = pbVar8;
                              bVar9 = *pbVar5;
                              *(int*)( this + 0x330 ) = iVar17;
                              ...
                              LAB_0010b74e:if (iVar17 != 0) goto LAB_0010b756;
                           }
                           ...
                           if (iVar17 == 0) {
                              ...
                              *(uint*)( this + 0x334 ) = uVar20 ^ 1;
                              ...
                              LAB_0010b756:pbVar5 = *(byte**)( this + 0x328 );
                              iVar17 = iVar17 + -1;
                              pbVar8 = pbVar5 + 1;
                              *(byte**)( this + 0x328 ) = pbVar8;
                              uVar20 = ( uint ) * pbVar5;
                              ...
                              if (uVar20 == 0xff) {
                                 if (iVar17 == 0) {
                                    ...
                                    *(uint*)( this + 0x334 ) = *(uint*)( this + 0x334 ) ^ 1;
                                    ...
                                    LAB_0010b787:*(byte**)( this + 0x328 ) = pbVar8 + 1;
                                    bVar9 = *pbVar8;
                                    *(int*)( this + 0x330 ) = iVar17 + -1;
                                    if (bVar9 == 0) goto LAB_0010b70a;
                                    *(byte**)( this + 0x328 ) = pbVar8;
                                    *pbVar8 = bVar9;
                                    *(int*)( this + 0x330 ) = *(int*)( this + 0x330 ) + 1;
                                 }
                           ...
                           LAB_0010b70a:iVar16 = *(int*)( this + 0x24bc );
                           uVar12 = uVar20 | uVar12 | *(uint*)( this + 0x24c0 );
                        }
 else {
                           pbVar5 = *(byte**)( this + 0x328 );
                           ...
                           if (( bVar9 == 0xff ) || ( bVar1 = bVar1 == 0xff )) {
                              ...
                              *(byte**)( this + 0x328 ) = pbVar8;
                              bVar9 = *pbVar5;
                              *(int*)( this + 0x330 ) = iVar17;
                              if (bVar9 == 0xff) goto LAB_0010bc52;
                              uVar12 = (uint)bVar9 << 8;
                              goto LAB_0010b756;
                           }
               ...
               LAB_0010a7c8:uVar12 = (int)uVar15 >> 4 & 0xf;
               uVar15 = uVar15 & 0xf;
               if (uVar15 != 0) goto LAB_0010a7db;
               LAB_0010a905:if (uVar12 != 0xf) break;
               if (0x30 < iVar14) goto LAB_0010c04c;
               if (iVar14 < iVar2) {
                  iVar10 = iVar2 - iVar14;
                  piVar7 = (int*)( g_ZAG + (long)iVar14 * 4 );
                  if (0x10 < iVar10) {
 ...
 while ( (int)lVar19 < *(int*)( this + 0x244 ) );
            ...
            LAB_0010a96f:transform_mcu_expand(this, iVar21);
         }
...
/* jpeg_decoder::decode(void const**, unsigned int*) */undefined4 jpeg_decoder::decode(jpeg_decoder *this, void **param_1, uint *param_2) {
   undefined4 *puVar1;
   byte *pbVar2;
   char cVar3;
   int iVar4;
         ...
         if (*(int*)( this + 0xe0 ) == 0) {
            ...
            *(int*)( this + 0x24c0 ) = *(int*)( this + 0x24c0 ) << 0x10;
            if (iVar10 == 0) {
               prep_in_buffer(this);
               iVar10 = *(int*)( this + 0x330 );
               if (iVar10 != 0) goto LAB_0010c359;
               uVar12 = *(uint*)( this + 0x334 );
               *(uint*)( this + 0x334 ) = uVar12 ^ 1;
               uVar12 = ( -(uint)(uVar12 == 0) & 0x26 ) + 0xd9;
               LAB_0010c4dd:prep_in_buffer(this);
               iVar10 = *(int*)( this + 0x330 );
               if (iVar10 != 0) {
                  pbVar8 = *(byte**)( this + 0x328 );
                  goto LAB_0010c382;
               ...
               *(uint*)( this + 0x334 ) = uVar9 ^ 1;
               ...
               LAB_0010c359:iVar10 = iVar10 + -1;
               pbVar2 = *(byte**)( this + 0x328 );
               pbVar8 = pbVar2 + 1;
               *(byte**)( this + 0x328 ) = pbVar8;
               uVar12 = ( uint ) * pbVar2;
               *(int*)( this + 0x330 ) = iVar10;
               if (iVar10 == 0) goto LAB_0010c4dd;
               LAB_0010c382:*(byte**)( this + 0x328 ) = pbVar8 + 1;
               uVar9 = ( uint ) * pbVar8;
               *(int*)( this + 0x330 ) = iVar10 + -1;
            }
            ...
            if (*(int*)( this + 0x24bc ) < 1) {
               *(int*)( this + 0x24c0 ) = iVar4 << ( cVar3 + 0x10U & 0x1f );
               ...
               if (iVar4 == 0) {
                  prep_in_buffer(this);
                  iVar4 = *(int*)( this + 0x330 );
                  if (iVar4 != 0) goto LAB_0010c42a;
                  uVar12 = *(uint*)( this + 0x334 );
                  *(uint*)( this + 0x334 ) = uVar12 ^ 1;
                  uVar12 = ( -(uint)(uVar12 == 0) & 0x26 ) + 0xd9;
                  LAB_0010c539:prep_in_buffer(this);
                  iVar4 = *(int*)( this + 0x330 );
                  if (iVar4 != 0) {
                     pbVar8 = *(byte**)( this + 0x328 );
                     goto LAB_0010c453;
                  ...
                  *(uint*)( this + 0x334 ) = uVar9 ^ 1;
                  ...
                  LAB_0010c42a:iVar4 = iVar4 + -1;
                  pbVar2 = *(byte**)( this + 0x328 );
                  pbVar8 = pbVar2 + 1;
                  *(byte**)( this + 0x328 ) = pbVar8;
                  uVar12 = ( uint ) * pbVar2;
                  *(int*)( this + 0x330 ) = iVar4;
                  if (iVar4 == 0) goto LAB_0010c539;
                  LAB_0010c453:*(byte**)( this + 0x328 ) = pbVar8 + 1;
                  uVar9 = ( uint ) * pbVar8;
                  *(int*)( this + 0x330 ) = iVar4 + -1;
               }
               ...
               iVar4 = *(int*)( this + 0x24bc );
               *(int*)( this + 0x24bc ) = iVar4 + 0x10;
               *(uint*)( this + 0x24c0 ) = ( *(uint*)( this + 0x24c0 ) & 0xffff0000 | uVar9 | uVar12 << 8 ) << ( -(char)iVar4 & 0x1fU );
            }
 else {
               *(int*)( this + 0x24c0 ) = iVar4 << 0x10;
            }
...
LAB_0010c20a:
   ...
   switchD_0010c157_default:iVar10 = _LC15._4_4_;
   iVar4 = (int)_LC15;
   *param_2 = *(uint*)( this + 0x284 );
   *(ulong*)( this + 0x27c ) = CONCAT44((int)( ( ulong ) * (undefined8*)( this + 0x27c ) >> 0x20 ) + iVar10, (int)*(undefined8*)( this + 0x27c ) + iVar4);
   return 0;
}
/* jpgdDecompress(jpeg_decoder*) */void *jpgdDecompress(jpeg_decoder *param_1) {
   undefined1 uVar1;
   int iVar2;
   int iVar3;
   int iVar4;
 ...
 while ( puVar6 != puVar10 );
                     ...
                     LAB_0010c661:iVar4 = iVar4 + 1;
                     puVar10 = (undefined2*)( (long)puVar10 + lVar8 );
                     if (iVar3 == iVar4) goto LAB_0010c6e0;
                  }
;
                  puVar9 = local_48;
                  if (iVar2 < 1) goto LAB_0010c661;
                  do {
                     puVar6 = puVar7 + 2;
 ...
 while ( iVar3 != iVar4 );
   ...
   LAB_0010c752:local_60 = (void*)0x0;
   LAB_0010c6e0:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* jpeg_decoder_mem_stream::~jpeg_decoder_mem_stream() */void jpeg_decoder_mem_stream::~jpeg_decoder_mem_stream(jpeg_decoder_mem_stream *this) {
   return;
}
/* jpeg_decoder_mem_stream::~jpeg_decoder_mem_stream() */void jpeg_decoder_mem_stream::~jpeg_decoder_mem_stream(jpeg_decoder_mem_stream *this) {
   operator_delete(this, 0x18);
...
/* jpeg_decoder::get_bits_no_markers(int) */uint jpeg_decoder::get_bits_no_markers(jpeg_decoder *this, int param_1) {
   byte bVar1;
   byte bVar2;
   byte *pbVar3;
   long lVar4;
   ...
   *(uint*)( this + 0x24c0 ) = uVar5;
   if (iVar7 < 2) {
      if (iVar7 == 0) {
         prep_in_buffer(this);
         iVar7 = *(int*)( this + 0x330 );
         if (iVar7 != 0) goto LAB_0010c8e7;
         uVar5 = *(uint*)( this + 0x334 );
         *(uint*)( this + 0x334 ) = uVar5 ^ 1;
         uVar5 = ( -(uint)(uVar5 == 0) & 0x2600 ) + 0xd900;
      }
 else {
         LAB_0010c8e7:pbVar3 = *(byte**)( this + 0x328 );
         iVar7 = iVar7 + -1;
         pbVar6 = pbVar3 + 1;
         *(byte**)( this + 0x328 ) = pbVar6;
         bVar1 = *pbVar3;
         *(int*)( this + 0x330 ) = iVar7;
         ...
         LAB_0010c990:if (iVar7 != 0) goto LAB_0010c889;
      }

      prep_in_buffer(this);
      iVar7 = *(int*)( this + 0x330 );
      if (iVar7 != 0) goto LAB_0010c889;
      uVar9 = *(uint*)( this + 0x334 );
      *(uint*)( this + 0x334 ) = uVar9 ^ 1;
      uVar9 = ( -(uint)(uVar9 == 0) & 0x26 ) + 0xd9;
   }
      ...
      *(byte**)( this + 0x328 ) = pbVar6;
      bVar1 = *pbVar3;
      *(int*)( this + 0x330 ) = iVar7;
      if (bVar1 == 0xff) goto LAB_0010c938;
      uVar5 = (uint)bVar1 << 8;
      LAB_0010c889:pbVar3 = *(byte**)( this + 0x328 );
      iVar7 = iVar7 + -1;
      pbVar6 = pbVar3 + 1;
      *(byte**)( this + 0x328 ) = pbVar6;
      bVar1 = *pbVar3;
      ...
      if (bVar1 == 0xff) {
         if (iVar7 == 0) {
            ...
            *(uint*)( this + 0x334 ) = *(uint*)( this + 0x334 ) ^ 1;
            ...
            LAB_0010ca18:*(byte**)( this + 0x328 ) = pbVar6 + 1;
            bVar1 = *pbVar6;
            *(int*)( this + 0x330 ) = iVar7 + -1;
            if (bVar1 == 0) goto LAB_0010c8b3;
            *(byte**)( this + 0x328 ) = pbVar6;
            *pbVar6 = bVar1;
            *(int*)( this + 0x330 ) = *(int*)( this + 0x330 ) + 1;
         }
   ...
   LAB_0010c8b3:iVar8 = *(int*)( this + 0x24bc );
   uVar5 = uVar9 | uVar5 | *(uint*)( this + 0x24c0 );
   LAB_0010c83c:*(int*)( this + 0x24bc ) = iVar8 + 0x10;
   *(uint*)( this + 0x24c0 ) = uVar5 << ( -(char)iVar8 & 0x1fU );
   return uVar10;
}
/* Col<3>::idct(unsigned char*, int const*) */void Col<3>::idct(uchar *param_1, int *param_2) {
   int iVar1;
   int iVar2;
   int iVar3;
   uchar uVar4;
...
/* Col<4>::idct(unsigned char*, int const*) */void Col<4>::idct(uchar *param_1, int *param_2) {
   int iVar1;
   int iVar2;
   int iVar3;
   uchar uVar4;
...
/* Col<5>::idct(unsigned char*, int const*) */void Col<5>::idct(uchar *param_1, int *param_2) {
   int iVar1;
   int iVar2;
   int iVar3;
   uchar uVar4;
...
/* Col<6>::idct(unsigned char*, int const*) */void Col<6>::idct(uchar *param_1, int *param_2) {
   int iVar1;
   int iVar2;
   int iVar3;
   int iVar4;
...
/* Col<7>::idct(unsigned char*, int const*) */void Col<7>::idct(uchar *param_1, int *param_2) {
   int iVar1;
   int iVar2;
   uchar uVar3;
   int iVar4;
...
/* Col<8>::idct(unsigned char*, int const*) */void Col<8>::idct(uchar *param_1, int *param_2) {
   int iVar1;
   int iVar2;
   uint uVar3;
   uchar uVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* DCT_Upsample::P_Q<5, 4>::calc(DCT_Upsample::Matrix44&, DCT_Upsample::Matrix44&, short const*) */void DCT_Upsample::P_Q<5,4>::calc(Matrix44 *param_1, Matrix44 *param_2, short *param_3) {
   short sVar1;
   short sVar2;
   short sVar3;
   short sVar4;
   ...
   *(int*)( param_1 + 0x1c ) = iVar13 * 0x17 + 0x200 + iVar12 * -99 >> 10;
   iVar17 = iVar16 * 0x1aa + iVar11 * 0x32a + _UNK_00112cb4;
   iVar18 = sVar10 * 0x17 + sVar8 * -99 + _UNK_00112cb8;
   iVar19 = iVar16 * 0x17 + iVar11 * -99 + _UNK_00112cbc;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* DCT_Upsample::R_S<5, 4>::calc(DCT_Upsample::Matrix44&, DCT_Upsample::Matrix44&, short const*) */void DCT_Upsample::R_S<5,4>::calc(Matrix44 *param_1, Matrix44 *param_2, short *param_3) {
   short sVar1;
   short sVar2;
   short sVar3;
   short sVar4;
   ...
   iVar16 = iVar10 * 0x1aa + iVar9 * 0x32a + _UNK_00112cb4;
   iVar17 = sVar5 * 0x3a0 + sVar4 * -0x145 + _UNK_00112cb8;
   iVar18 = iVar10 * 0x17 + iVar9 * -99 + _UNK_00112cbc;
...
/* DCT_Upsample::P_Q<5, 5>::calc(DCT_Upsample::Matrix44&, DCT_Upsample::Matrix44&, short const*) */void DCT_Upsample::P_Q<5,5>::calc(Matrix44 *param_1, Matrix44 *param_2, short *param_3) {
   short sVar1;
   short sVar2;
   short sVar3;
   short sVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* DCT_Upsample::R_S<5, 5>::calc(DCT_Upsample::Matrix44&, DCT_Upsample::Matrix44&, short const*) */void DCT_Upsample::R_S<5,5>::calc(Matrix44 *param_1, Matrix44 *param_2, short *param_3) {
   short sVar1;
   short sVar2;
   short sVar3;
   short sVar4;
...
/* DCT_Upsample::P_Q<5, 6>::calc(DCT_Upsample::Matrix44&, DCT_Upsample::Matrix44&, short const*) */void DCT_Upsample::P_Q<5,6>::calc(Matrix44 *param_1, Matrix44 *param_2, short *param_3) {
   short sVar1;
   short sVar2;
   short sVar3;
   short sVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* DCT_Upsample::R_S<5, 6>::calc(DCT_Upsample::Matrix44&, DCT_Upsample::Matrix44&, short const*) */void DCT_Upsample::R_S<5,6>::calc(Matrix44 *param_1, Matrix44 *param_2, short *param_3) {
   short sVar1;
   short sVar2;
   short sVar3;
   short sVar4;
   ...
   *(int*)( param_1 + 0x10 ) = (int)sVar10;
   ...
   iVar19 = iVar14 * 0x1aa + iVar12 * 0x32a + _UNK_00112cb4;
   iVar20 = sVar6 * -0x145 + sVar8 * 0x3a0 + sVar9 * 0xda + _UNK_00112cb8;
   iVar21 = iVar14 * 0x17 + iVar12 * -99 + _UNK_00112cbc;
...
/* DCT_Upsample::P_Q<6, 6>::calc(DCT_Upsample::Matrix44&, DCT_Upsample::Matrix44&, short const*) */void DCT_Upsample::P_Q<6,6>::calc(Matrix44 *param_1, Matrix44 *param_2, short *param_3) {
   short sVar1;
   short sVar2;
   short sVar3;
   short sVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* DCT_Upsample::R_S<6, 6>::calc(DCT_Upsample::Matrix44&, DCT_Upsample::Matrix44&, short const*) */void DCT_Upsample::R_S<6,6>::calc(Matrix44 *param_1, Matrix44 *param_2, short *param_3) {
   short sVar1;
   short sVar2;
   short sVar3;
   short sVar4;
   ...
   *(int*)( param_1 + 0x10 ) = (int)sVar12;
   iVar22 = iVar16 * 0x32a + iVar14 * 0x1aa + iVar18 * -0x168 + _UNK_00112cb4;
   iVar23 = sVar7 * 0xda + sVar10 * -0x145 + sVar8 * 0x3a0 + _UNK_00112cb8;
   iVar24 = iVar16 * -99 + iVar14 * 0x17 + iVar18 * 0x1f6 + _UNK_00112cbc;
...
/* DCT_Upsample::P_Q<7, 6>::calc(DCT_Upsample::Matrix44&, DCT_Upsample::Matrix44&, short const*) */void DCT_Upsample::P_Q<7,6>::calc(Matrix44 *param_1, Matrix44 *param_2, short *param_3) {
   short sVar1;
   short sVar2;
   short sVar3;
   short sVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* DCT_Upsample::R_S<7, 6>::calc(DCT_Upsample::Matrix44&, DCT_Upsample::Matrix44&, short const*) */void DCT_Upsample::R_S<7,6>::calc(Matrix44 *param_1, Matrix44 *param_2, short *param_3) {
   short sVar1;
   short sVar2;
   short sVar3;
   short sVar4;
   ...
   *(undefined1(*) [16])( param_1 + 0x30 ) = (undefined1[16])0x0;
   iVar20 = _UNK_00112cbc;
   iVar19 = _UNK_00112cb8;
   iVar18 = _UNK_00112cb4;
   iVar17 = __LC14;
   ...
   *(ulong*)( param_2 + 0x14 ) = CONCAT44(iVar25 * -0x4b + iVar29 * 0x20e + 0x200 + iVar26 * 0x313 >> 10, (int)sVar12);
   *(ulong*)( param_2 + 0x1c ) = CONCAT44(iVar21 * 0x3a0 + iVar27 * -0x145 + 0x200 + iVar28 * 0xda >> 10, (int)sVar16);
...
/* DCT_Upsample::P_Q<7, 7>::calc(DCT_Upsample::Matrix44&, DCT_Upsample::Matrix44&, short const*) */void DCT_Upsample::P_Q<7,7>::calc(Matrix44 *param_1, Matrix44 *param_2, short *param_3) {
   short sVar1;
   short sVar2;
   short sVar3;
   short sVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* DCT_Upsample::R_S<7, 7>::calc(DCT_Upsample::Matrix44&, DCT_Upsample::Matrix44&, short const*) */void DCT_Upsample::R_S<7,7>::calc(Matrix44 *param_1, Matrix44 *param_2, short *param_3) {
   short sVar1;
   short sVar2;
   short sVar3;
   short sVar4;
   ...
   int iVar34;
   int iVar35;
   iVar23 = _UNK_00112cbc;
   iVar22 = _UNK_00112cb8;
   iVar21 = _UNK_00112cb4;
   iVar20 = __LC14;
   sVar1 = param_3[1];
   sVar2 = param_3[3];
   sVar3 = param_3[5];
...
/* DCT_Upsample::P_Q<7, 8>::calc(DCT_Upsample::Matrix44&, DCT_Upsample::Matrix44&, short const*) */void DCT_Upsample::P_Q<7,8>::calc(Matrix44 *param_1, Matrix44 *param_2, short *param_3) {
   short sVar1;
   short sVar2;
   short sVar3;
   short sVar4;
   ...
   sVar12 = param_3[0x23];
   sVar13 = param_3[0x11];
   iVar24 = param_3[0xd] * -0x168 + param_3[0xb] * 0x32a + param_3[9] * 0x1aa + 0x200 + param_3[0xf] * 0x11c >> 10;
   sVar14 = param_3[0x17];
   sVar15 = param_3[0x27];
   iVar30 = param_3[0x1d] * -0x168 + param_3[0x1b] * 0x32a + param_3[0x19] * 0x1aa + 0x200 + param_3[0x1f] * 0x11c >> 10;
   sVar16 = param_3[0x34];
   sVar17 = param_3[0x31];
   iVar32 = param_3[0x2d] * -0x168 + param_3[0x2b] * 0x32a + param_3[0x29] * 0x1aa + 0x200 + param_3[0x2f] * 0x11c >> 10;
   sVar18 = param_3[0x33];
   iVar29 = param_3[0xd] * 0x1f6 + param_3[0xb] * -99 + param_3[9] * 0x17 + 0x200 + param_3[0xf] * 0x377 >> 10;
   sVar19 = param_3[0x35];
   sVar20 = param_3[0x37];
   sVar21 = param_3[4];
   iVar27 = param_3[0x1d] * 0x1f6 + param_3[0x1b] * -99 + param_3[0x19] * 0x17 + 0x200 + param_3[0x1f] * 0x377 >> 10;
   iVar33 = (int)param_3[0xc];
   sVar22 = param_3[0x14];
   iVar25 = param_3[0x2d] * 0x1f6 + param_3[0x2b] * -99 + param_3[0x29] * 0x17 + 0x200 + param_3[0x2f] * 0x377 >> 10;
   ...
   *(int*)( param_1 + 0x10 ) = sVar4 * -0x168 + sVar6 * 0x32a + sVar5 * 0x1aa + 0x200 + sVar7 * 0x11c >> 10;
   *(int*)( param_1 + 0x14 ) = iVar30 * 0x32a + iVar24 * 0x1aa + 0x200 + iVar32 * -0x168 >> 10;
   *(int*)( param_1 + 0x18 ) = sVar10 * -0x168 + sVar12 * 0x32a + sVar11 * 0x1aa + 0x200 + sVar15 * 0x11c >> 10;
   ...
   *(int*)( param_1 + 0x30 ) = sVar4 * 0x1f6 + sVar6 * -99 + sVar5 * 0x17 + 0x200 + sVar7 * 0x377 >> 10;
   *(int*)( param_1 + 0x34 ) = iVar27 * 0x32a + iVar29 * 0x1aa + 0x200 + iVar25 * -0x168 >> 10;
   *(int*)( param_1 + 0x38 ) = sVar10 * 0x1f6 + sVar12 * -99 + sVar11 * 0x17 + 0x200 + sVar15 * 0x377 >> 10;
   ...
   *(int*)( param_2 + 0x14 ) = sVar9 * -0x168 + sVar8 * 0x32a + sVar13 * 0x1aa + 0x200 + sVar14 * 0x11c >> 10;
   *(int*)( param_2 + 0x18 ) = iVar30 * 0x20e + iVar24 * -0x4b + 0x200 + iVar32 * 0x313 >> 10;
   *(int*)( param_2 + 0x1c ) = sVar19 * -0x168 + sVar18 * 0x32a + sVar17 * 0x1aa + 0x200 + sVar20 * 0x11c >> 10;
   ...
   *(int*)( param_2 + 0x34 ) = sVar13 * 0x17 + sVar8 * -99 + sVar9 * 0x1f6 + 0x200 + sVar14 * 0x377 >> 10;
   *(int*)( param_2 + 0x38 ) = iVar29 * -0x4b + iVar27 * 0x20e + 0x200 + iVar25 * 0x313 >> 10;
   *(int*)( param_2 + 0x3c ) = sVar17 * 0x17 + sVar18 * -99 + sVar19 * 0x1f6 + 0x200 + sVar20 * 0x377 >> 10;
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* DCT_Upsample::R_S<7, 8>::calc(DCT_Upsample::Matrix44&, DCT_Upsample::Matrix44&, short const*) */void DCT_Upsample::R_S<7,8>::calc(Matrix44 *param_1, Matrix44 *param_2, short *param_3) {
   short sVar1;
   short sVar2;
   short sVar3;
   short sVar4;
   ...
   sVar6 = param_3[0x15];
   sVar7 = param_3[0x11];
   iVar28 = param_3[9] * 0x3a0 + param_3[0xb] * -0x145 + param_3[0xd] * 0xda + 0x200 + param_3[0xf] * -0xb8 >> 10;
   sVar8 = param_3[0x17];
   sVar9 = param_3[0x25];
   sVar10 = param_3[0x27];
   sVar11 = param_3[0x23];
   sVar12 = param_3[0x21];
   iVar34 = param_3[0x1d] * 0xda + param_3[0x1b] * -0x145 + param_3[0x19] * 0x3a0 + 0x200 + param_3[0x1f] * -0xb8 >> 10;
   iVar36 = param_3[0x2d] * 0xda + param_3[0x2b] * -0x145 + param_3[0x29] * 0x3a0 + 0x200 + param_3[0x2f] * -0xb8 >> 10;
   sVar13 = param_3[0x31];
   sVar14 = param_3[0x33];
   sVar15 = param_3[0x35];
   sVar16 = param_3[0x37];
   ...
   sVar21 = param_3[0x22];
   iVar35 = param_3[0xd] * 0x313 + param_3[0xb] * 0x20e + param_3[9] * -0x4b + 0x200 + param_3[0xf] * -0x17f >> 10;
   iVar39 = (int)param_3[0x2a];
   sVar22 = param_3[0x16];
   iVar31 = param_3[0x1d] * 0x313 + param_3[0x1b] * 0x20e + param_3[0x19] * -0x4b + 0x200 + param_3[0x1f] * -0x17f >> 10;
   sVar23 = param_3[0x26];
   iVar33 = (int)param_3[0x1e];
   iVar29 = (int)param_3[0xe];
   iVar32 = (int)param_3[0x2e];
   iVar30 = param_3[0x2d] * 0x313 + param_3[0x2b] * 0x20e + param_3[0x29] * -0x4b + 0x200 + param_3[0x2f] * -0x17f >> 10;
   *(int*)( param_1 + 0x30 ) = (int)param_3[6];
   iVar27 = _UNK_00112cbc;
   iVar26 = _UNK_00112cb8;
   iVar25 = _UNK_00112cb4;
   iVar24 = __LC14;
   ...
   *(int*)( param_1 + 8 ) = sVar9 * 0xda + sVar11 * -0x145 + sVar12 * 0x3a0 + sVar10 * -0xb8 + iVar26 >> 10;
   ...
   *(int*)( param_1 + 0x20 ) = sVar1 * 0x313 + sVar3 * 0x20e + sVar2 * -0x4b + 0x200 + sVar4 * -0x17f >> 10;
   *(int*)( param_1 + 0x24 ) = iVar31 * 0x32a + iVar35 * 0x1aa + 0x200 + iVar30 * -0x168 >> 10;
   *(int*)( param_1 + 0x28 ) = sVar9 * 0x313 + sVar11 * 0x20e + sVar12 * -0x4b + 0x200 + sVar10 * -0x17f >> 10;
   ...
   *(int*)( param_2 + 4 ) = sVar6 * 0xda + sVar5 * -0x145 + sVar7 * 0x3a0 + sVar8 * -0xb8 + iVar25 >> 10;
   *(int*)( param_2 + 8 ) = iVar34 * 0x20e + iVar28 * -0x4b + iVar36 * 0x313 + iVar26 >> 10;
   *(int*)( param_2 + 0xc ) = sVar15 * 0xda + sVar14 * -0x145 + sVar13 * 0x3a0 + sVar16 * -0xb8 + iVar27 >> 10;
   ...
   *(int*)( param_2 + 0x24 ) = sVar6 * 0x313 + sVar5 * 0x20e + sVar7 * -0x4b + 0x200 + sVar8 * -0x17f >> 10;
   *(int*)( param_2 + 0x28 ) = iVar35 * -0x4b + iVar31 * 0x20e + 0x200 + iVar30 * 0x313 >> 10;
   *(int*)( param_2 + 0x2c ) = sVar13 * -0x4b + sVar14 * 0x20e + sVar15 * 0x313 + 0x200 + sVar16 * -0x17f >> 10;
...
/* DCT_Upsample::P_Q<8, 8>::calc(DCT_Upsample::Matrix44&, DCT_Upsample::Matrix44&, short const*) */void DCT_Upsample::P_Q<8,8>::calc(Matrix44 *param_1, Matrix44 *param_2, short *param_3) {
   short sVar1;
   short sVar2;
   short sVar3;
   short sVar4;
   ...
   *(int*)( param_1 + 4 ) = iVar51 * -0x168 + iVar50 * 0x32a + iVar44 * 0x1aa + 0x200 + iVar43 * 0x11c >> 10;
   *(int*)( param_1 + 0xc ) = iVar51 * 0x1f6 + iVar50 * -99 + iVar44 * 0x17 + 0x200 + iVar43 * 0x377 >> 10;
   *(int*)( param_1 + 0x10 ) = sVar6 * -0x168 + sVar4 * 0x32a + sVar5 * 0x1aa + 0x200 + sVar10 * 0x11c >> 10;
   *(int*)( param_1 + 0x14 ) = iVar45 * -0x168 + iVar41 * 0x32a + iVar40 * 0x1aa + 0x200 + iVar48 * 0x11c >> 10;
   *(int*)( param_1 + 0x18 ) = sVar22 * -0x168 + sVar15 * 0x32a + sVar14 * 0x1aa + 0x200 + sVar26 * 0x11c >> 10;
   *(int*)( param_1 + 0x1c ) = iVar45 * 0x1f6 + iVar41 * -99 + iVar40 * 0x17 + 0x200 + iVar48 * 0x377 >> 10;
   *(int*)( param_1 + 0x20 ) = (int)sVar36;
   *(int*)( param_1 + 0x24 ) = iVar54 * -0x168 + iVar53 * 0x32a + iVar52 * 0x1aa + 0x200 + iVar49 * 0x11c >> 10;
   *(int*)( param_1 + 0x28 ) = (int)sVar37;
   *(int*)( param_1 + 0x2c ) = iVar54 * 0x1f6 + iVar53 * -99 + iVar52 * 0x17 + 0x200 + iVar49 * 0x377 >> 10;
   *(int*)( param_1 + 0x30 ) = sVar6 * 0x1f6 + sVar4 * -99 + sVar5 * 0x17 + 0x200 + sVar10 * 0x377 >> 10;
   *(int*)( param_1 + 0x34 ) = iVar46 * -0x168 + iVar47 * 0x32a + iVar55 * 0x1aa + 0x200 + iVar42 * 0x11c >> 10;
   *(int*)( param_1 + 0x38 ) = sVar22 * 0x1f6 + sVar15 * -99 + sVar14 * 0x17 + 0x200 + sVar26 * 0x377 >> 10;
   *(int*)( param_1 + 0x3c ) = iVar46 * 0x1f6 + iVar47 * -99 + iVar55 * 0x17 + 0x200 + iVar42 * 0x377 >> 10;
   *(int*)param_2 = iVar51 * 0xda + iVar50 * -0x145 + iVar44 * 0x3a0 + 0x200 + iVar43 * -0xb8 >> 10;
   *(int*)( param_2 + 4 ) = (int)sVar1;
   *(int*)( param_2 + 0xc ) = (int)sVar2;
   *(int*)( param_2 + 8 ) = iVar51 * 0x313 + iVar50 * 0x20e + iVar44 * -0x4b + 0x200 + iVar43 * -0x17f >> 10;
   *(int*)( param_2 + 0x10 ) = iVar45 * 0xda + iVar41 * -0x145 + iVar40 * 0x3a0 + 0x200 + iVar48 * -0xb8 >> 10;
   *(int*)( param_2 + 0x14 ) = sVar20 * -0x168 + sVar12 * 0x32a + sVar13 * 0x1aa + 0x200 + sVar21 * 0x11c >> 10;
   *(int*)( param_2 + 0x18 ) = iVar45 * 0x313 + iVar41 * 0x20e + iVar40 * -0x4b + 0x200 + iVar48 * -0x17f >> 10;
   *(int*)( param_2 + 0x1c ) = sVar27 * -0x168 + sVar32 * 0x32a + sVar28 * 0x1aa + 0x200 + sVar34 * 0x11c >> 10;
   *(int*)( param_2 + 0x20 ) = iVar54 * 0xda + iVar53 * -0x145 + iVar52 * 0x3a0 + 0x200 + iVar49 * -0xb8 >> 10;
   *(int*)( param_2 + 0x24 ) = (int)sVar38;
   *(int*)( param_2 + 0x28 ) = iVar54 * 0x313 + iVar53 * 0x20e + iVar52 * -0x4b + 0x200 + iVar49 * -0x17f >> 10;
   *(int*)( param_2 + 0x2c ) = (int)sVar39;
   *(int*)( param_2 + 0x30 ) = iVar55 * 0x3a0 + iVar47 * -0x145 + iVar46 * 0xda + 0x200 + iVar42 * -0xb8 >> 10;
   *(int*)( param_2 + 0x34 ) = sVar13 * 0x17 + sVar12 * -99 + sVar20 * 0x1f6 + 0x200 + sVar21 * 0x377 >> 10;
   *(int*)( param_2 + 0x38 ) = iVar55 * -0x4b + iVar47 * 0x20e + iVar46 * 0x313 + 0x200 + iVar42 * -0x17f >> 10;
   *(int*)( param_2 + 0x3c ) = sVar28 * 0x17 + sVar32 * -99 + sVar27 * 0x1f6 + 0x200 + sVar34 * 0x377 >> 10;
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* DCT_Upsample::R_S<8, 8>::calc(DCT_Upsample::Matrix44&, DCT_Upsample::Matrix44&, short const*) */void DCT_Upsample::R_S<8,8>::calc(Matrix44 *param_1, Matrix44 *param_2, short *param_3) {
   short sVar1;
   short sVar2;
   short sVar3;
   short sVar4;
   ...
   sVar13 = param_3[0x23];
   sVar14 = param_3[0x21];
   iVar31 = param_3[0x1d] * 0xda + param_3[0x1b] * -0x145 + param_3[0x19] * 0x3a0 + 0x200 + param_3[0x1f] * -0xb8 >> 10;
   sVar15 = param_3[0x31];
   iVar29 = param_3[0x2d] * 0xda + param_3[0x2b] * -0x145 + param_3[0x29] * 0x3a0 + 0x200 + param_3[0x2f] * -0xb8 >> 10;
   sVar16 = param_3[0x37];
   iVar39 = param_3[0x3d] * 0xda + param_3[0x3b] * -0x145 + param_3[0x39] * 0x3a0 + 0x200 + param_3[0x3f] * -0xb8 >> 10;
   iVar40 = (int)param_3[10];
   sVar17 = param_3[0x12];
   iVar41 = (int)param_3[0x1a];
   iVar36 = param_3[0xd] * 0x313 + param_3[0xb] * 0x20e + param_3[9] * -0x4b + 0x200 + param_3[0xf] * -0x17f >> 10;
   sVar18 = param_3[6];
   iVar33 = param_3[0x2d] * 0x313 + param_3[0x2b] * 0x20e + param_3[0x29] * -0x4b + 0x200 + param_3[0x2f] * -0x17f >> 10;
   sVar19 = param_3[0x22];
   sVar20 = param_3[0x16];
   iVar42 = (int)param_3[0x2a];
   sVar21 = param_3[0x32];
   iVar30 = (int)param_3[0xe];
   iVar32 = param_3[0x3d] * 0x313 + param_3[0x3b] * 0x20e + param_3[0x39] * -0x4b + 0x200 + param_3[0x3f] * -0x17f >> 10;
   iVar43 = (int)param_3[0x3a];
   iVar35 = (int)param_3[0x1e];
   iVar34 = (int)param_3[0x2e];
   sVar22 = param_3[0x26];
   iVar38 = param_3[0x1d] * 0x313 + param_3[0x1b] * 0x20e + param_3[0x19] * -0x4b + 0x200 + param_3[0x1f] * -0x17f >> 10;
   sVar23 = param_3[0x36];
   iVar37 = (int)param_3[0x3e];
   *(int*)( param_1 + 0x10 ) = (int)param_3[2];
   *(int*)param_1 = sVar3 * 0xda + sVar2 * -0x145 + sVar1 * 0x3a0 + sVar4 * -0xb8 + iVar24 >> 10;
   *(int*)( param_1 + 4 ) = iVar29 * -0x168 + iVar31 * 0x32a + iVar28 * 0x1aa + iVar39 * 0x11c + iVar25 >> 10;
   *(int*)( param_1 + 8 ) = sVar9 * 0xda + sVar13 * -0x145 + sVar14 * 0x3a0 + sVar10 * -0xb8 + iVar26 >> 10;
   *(int*)( param_1 + 0xc ) = iVar29 * 0x1f6 + iVar31 * -99 + iVar28 * 0x17 + iVar39 * 0x377 + iVar27 >> 10;
   *(int*)( param_1 + 0x14 ) = iVar42 * -0x168 + iVar41 * 0x32a + iVar40 * 0x1aa + 0x200 + iVar43 * 0x11c >> 10;
   *(int*)( param_1 + 0x18 ) = (int)sVar19;
   *(int*)( param_1 + 0x1c ) = iVar42 * 0x1f6 + iVar41 * -99 + iVar40 * 0x17 + 0x200 + iVar43 * 0x377 >> 10;
   *(int*)( param_1 + 0x20 ) = sVar3 * 0x313 + sVar2 * 0x20e + sVar1 * -0x4b + 0x200 + sVar4 * -0x17f >> 10;
   *(int*)( param_1 + 0x24 ) = iVar33 * -0x168 + iVar38 * 0x32a + iVar36 * 0x1aa + 0x200 + iVar32 * 0x11c >> 10;
   *(int*)( param_1 + 0x28 ) = sVar9 * 0x313 + sVar13 * 0x20e + sVar14 * -0x4b + 0x200 + sVar10 * -0x17f >> 10;
   *(int*)( param_1 + 0x2c ) = iVar33 * 0x1f6 + iVar38 * -99 + iVar36 * 0x17 + 0x200 + iVar32 * 0x377 >> 10;
   *(int*)( param_1 + 0x30 ) = (int)sVar18;
   *(int*)( param_1 + 0x34 ) = iVar34 * -0x168 + iVar35 * 0x32a + iVar30 * 0x1aa + 0x200 + iVar37 * 0x11c >> 10;
   *(int*)( param_1 + 0x38 ) = (int)sVar22;
   *(int*)( param_1 + 0x3c ) = iVar34 * 0x1f6 + iVar35 * -99 + iVar30 * 0x17 + 0x200 + iVar37 * 0x377 >> 10;
   *(int*)param_2 = iVar39 * -0xb8 + iVar29 * 0xda + iVar31 * -0x145 + iVar28 * 0x3a0 + iVar24 >> 10;
   *(int*)( param_2 + 4 ) = sVar8 * 0xda + sVar6 * -0x145 + sVar5 * 0x3a0 + sVar7 * -0xb8 + iVar25 >> 10;
   *(int*)( param_2 + 8 ) = iVar39 * -0x17f + iVar29 * 0x313 + iVar31 * 0x20e + iVar28 * -0x4b + iVar26 >> 10;
   *(int*)( param_2 + 0xc ) = sVar12 * 0xda + sVar11 * -0x145 + sVar15 * 0x3a0 + sVar16 * -0xb8 + iVar27 >> 10;
   *(int*)( param_2 + 0x10 ) = iVar42 * 0xda + iVar41 * -0x145 + iVar40 * 0x3a0 + 0x200 + iVar43 * -0xb8 >> 10;
   *(int*)( param_2 + 0x14 ) = (int)sVar17;
   *(int*)( param_2 + 0x1c ) = (int)sVar21;
   *(int*)( param_2 + 0x18 ) = iVar42 * 0x313 + iVar41 * 0x20e + iVar40 * -0x4b + 0x200 + iVar43 * -0x17f >> 10;
   *(int*)( param_2 + 0x20 ) = iVar33 * 0xda + iVar38 * -0x145 + iVar36 * 0x3a0 + 0x200 + iVar32 * -0xb8 >> 10;
   *(int*)( param_2 + 0x24 ) = sVar8 * 0x313 + sVar6 * 0x20e + sVar5 * -0x4b + 0x200 + sVar7 * -0x17f >> 10;
   *(int*)( param_2 + 0x28 ) = iVar36 * -0x4b + iVar38 * 0x20e + iVar33 * 0x313 + 0x200 + iVar32 * -0x17f >> 10;
   *(int*)( param_2 + 0x2c ) = sVar15 * -0x4b + sVar11 * 0x20e + sVar12 * 0x313 + 0x200 + sVar16 * -0x17f >> 10;
   *(int*)( param_2 + 0x30 ) = iVar30 * 0x3a0 + iVar35 * -0x145 + iVar34 * 0xda + 0x200 + iVar37 * -0xb8 >> 10;
   *(int*)( param_2 + 0x34 ) = (int)sVar20;
   *(int*)( param_2 + 0x38 ) = iVar30 * -0x4b + iVar35 * 0x20e + iVar34 * 0x313 + 0x200 + iVar37 * -0x17f >> 10;
   *(int*)( param_2 + 0x3c ) = (int)sVar23;
   return;
}
/* WARNING: Control flow encountered bad instruction data *//* jpeg_decoder_mem_stream::~jpeg_decoder_mem_stream() */void jpeg_decoder_mem_stream::~jpeg_decoder_mem_stream(jpeg_decoder_mem_stream *this) {

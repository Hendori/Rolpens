...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 mbedtls_md5_starts(undefined8 *param_1) {
   undefined8 uVar1;
   undefined8 uVar2;
   uVar2 = _UNK_00101168;
   uVar1 = __LC0;
...
undefined8 mbedtls_internal_md5_process(long param_1, undefined8 *param_2) {
   ...
   uVar15 = ( ( *(uint*)( param_1 + 0x14 ) ^ *(uint*)( param_1 + 0x10 ) ) & uVar18 ^ *(uint*)( param_1 + 0x14 ) ) + iVar17 + -0x28955b88 + *(int*)( param_1 + 8 );
   uVar16 = ( uVar15 * 0x80 | uVar15 >> 0x19 ) + uVar18;
   uVar15 = ( ( *(uint*)( param_1 + 0x10 ) ^ *(uint*)( param_1 + 0xc ) ) & uVar16 ^ *(uint*)( param_1 + 0x10 ) ) + iVar6 + -0x173848aa + *(uint*)( param_1 + 0x14 );
...
undefined8 mbedtls_md5_update(uint *param_1, undefined8 *param_2, ulong param_3) {
 ...
 while ( uVar3 < uVar4 );
      ...
      for (param_3 = param_3 - uVar8; 0x3f < param_3; param_3 = param_3 - 0x40) {
         LAB_001009ce:uVar1 = mbedtls_internal_md5_process(param_1, param_2);
         if ((int)uVar1 != 0) {
            return uVar1;
         }
...
int mbedtls_md5_finish(uint *param_1, uint *param_2) {
 ...
 while ( uVar4 < -uVar3 + 0x40 );
   ...
   LAB_00100ba8:mbedtls_platform_zeroize(param_1, 0x58);
   return iVar1;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int mbedtls_md5(undefined8 param_1, undefined8 param_2, undefined8 param_3) {
   int iVar1;
   long lVar2;
   undefined8 *puVar3;
   long in_FS_OFFSET;
...
int mbedtls_md5_self_test(int param_1) {
 ...
 while ( uVar4 != 8 );
   ...
   LAB_00100d8a:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar1;
   }

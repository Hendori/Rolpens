/* EditorUndoRedoManager::is_committing_action() const */EditorUndoRedoManager EditorUndoRedoManager::is_committing_action(EditorUndoRedoManager *this) {
   return this[0x1c9];
}
/* EditorUndoRedoManager::force_fixed_history() */void EditorUndoRedoManager::force_fixed_history(EditorUndoRedoManager *this) {
   if (*(int*)( this + 0x1a8 ) != -99) {
      this[0x1c8] = (EditorUndoRedoManager)0x1;
      return;
   }

   _err_print_error("force_fixed_history", "editor/editor_undo_redo_manager.cpp", 0x7c, "Condition \"pending_action.history_id == INVALID_HISTORY\" is true.", "The current action has no valid history assigned.", 0, 0);
   return;
}
/* HashMap<int, EditorUndoRedoManager::History, HashMapHasherDefault, HashMapComparatorDefault<int>,
   ...
   const&, unsigned int&) const [clone .isra.0] */undefined8 HashMap<int,EditorUndoRedoManager::History,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,EditorUndoRedoManager::History>>>::_lookup_pos(HashMap<int,EditorUndoRedoManager::History,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,EditorUndoRedoManager::History>>> *this, int *param_1, uint *param_2) {
   ulong uVar1;
...
/* EditorUndoRedoManager::get_history_undo_redo(int) const */undefined8 EditorUndoRedoManager::get_history_undo_redo(EditorUndoRedoManager *this, int param_1) {
   uint uVar1;
   long lVar2;
   ulong uVar3;
   long lVar4;
 ...
 while ( ( uVar20 != 0 ) && ( auVar10._8_8_ = 0 ),auVar10._0_8_ = uVar20 * uVar3,auVar17._8_8_ = 0,auVar17._0_8_ = uVar28,auVar11._8_8_ = 0,auVar11._0_8_ = ( ( uVar1 + uVar21 ) - SUB164(auVar10 * auVar17, 8) ) * uVar3,auVar18._8_8_ = 0,auVar18._0_8_ = uVar28,uVar27 <= SUB164(auVar11 * auVar18, 8) );
 ...
 while ( ( uVar27 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = uVar27 * uVar3,auVar14._8_8_ = 0,auVar14._0_8_ = uVar28,auVar8._8_8_ = 0,auVar8._0_8_ = ( ( uVar1 + uVar22 ) - SUB164(auVar7 * auVar14, 8) ) * uVar3,auVar15._8_8_ = 0,auVar15._0_8_ = uVar28,uVar25 <= SUB164(auVar8 * auVar15, 8) );
      }

   }

   _err_print_error("get_history_undo_redo", "editor/editor_undo_redo_manager.cpp", 0x39, "Condition \"!history_map.has(p_idx)\" is true. Returning: nullptr", 0, 0);
   return 0;
}
...
/* List<EditorUndoRedoManager::Action, DefaultAllocator>::push_back(EditorUndoRedoManager::Action
   const&) [clone .isra.0] */void List<EditorUndoRedoManager::Action,DefaultAllocator>::push_back(List<EditorUndoRedoManager::Action,DefaultAllocator> *this, Action *param_1) {
   undefined8 uVar1;
   undefined4 uVar2;
   long *plVar3;
   long lVar4;
...
/* EditorUndoRedoManager::has_undo() */undefined8 EditorUndoRedoManager::has_undo(EditorUndoRedoManager *this) {
   int iVar1;
   undefined8 *puVar2;
   int iVar3;
   ...
   while (true) {
      ...
      iVar1 = *(int*)( puVar2 + 2 );
      if (( ( ( iVar1 == 0 ) || ( iVar1 == -9 ) ) || ( iVar3 = EditorData::get_current_edited_scene_history_id() ),iVar1 == iVar3 )) &&( ( puVar2[6] != 0 && ( *(int*)( puVar2[6] + 0x10 ) != 0 ) ) );
      puVar2 = (undefined8*)*puVar2;
   }
;
   return 1;
}
/* EditorUndoRedoManager::has_redo() */undefined8 EditorUndoRedoManager::has_redo(EditorUndoRedoManager *this) {
   int iVar1;
   undefined8 *puVar2;
   int iVar3;
   puVar2 = *(undefined8**)( this + 400 );
   while (true) {
      ...
      iVar1 = *(int*)( puVar2 + 2 );
      if (( ( ( iVar1 == 0 ) || ( iVar1 == -9 ) ) || ( iVar3 = EditorData::get_current_edited_scene_history_id() ),iVar1 == iVar3 )) &&( ( puVar2[7] != 0 && ( *(int*)( puVar2[7] + 0x10 ) != 0 ) ) );
      puVar2 = (undefined8*)*puVar2;
   }
;
   return 1;
}
/* EditorUndoRedoManager::has_history(int) const */undefined8 EditorUndoRedoManager::has_history(EditorUndoRedoManager *this, int param_1) {
   ulong uVar1;
   undefined1 auVar2[16];
   undefined1 auVar3[16];
   undefined1 auVar4[16];
   ...
   if (uVar10 != 0) {
      uVar16 = 0;
      do {
         if (( uVar14 == uVar10 ) && ( *(int*)( *(long*)( *(long*)( this + 0x180 ) + lVar13 * 8 ) + 0x10 ) == param_1 )) {
            return 1;
         }
 ...
 while ( ( uVar10 != 0 ) && ( auVar4._8_8_ = 0 ),auVar4._0_8_ = uVar10 * uVar1,auVar8._8_8_ = 0,auVar8._0_8_ = uVar15,auVar5._8_8_ = 0,auVar5._0_8_ = ( ( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x1a0 ) * 4 ) + iVar11 ) - SUB164(auVar4 * auVar8, 8) ) * uVar1,auVar9._8_8_ = 0,auVar9._0_8_ = uVar15,uVar16 <= SUB164(auVar5 * auVar9, 8) );
   }

   return 0;
}
/* EditorUndoRedoManager::get_singleton() */undefined8 EditorUndoRedoManager::get_singleton(void) {
   return singleton;
}
/* EditorUndoRedoManager::EditorUndoRedoManager() */void EditorUndoRedoManager::EditorUndoRedoManager(EditorUndoRedoManager *this) {
   bool bVar1;
...
/* EditorUndoRedoManager::get_history_id_for_object(Object*) const */int EditorUndoRedoManager::get_history_id_for_object(EditorUndoRedoManager *this, Object *param_1) {
   String *pSVar1;
   char cVar2;
   int iVar3;
   long lVar4;
   ...
   if (param_1 != (Object*)0x0) {
      ...
      if (( ( ( pNVar5 == (Node*)0x0 ) || ( pNVar6 = (Node*)EditorData::get_edited_scene_root((int)EditorNode::singleton + 0x430) ),pNVar6 == (Node*)0x0 ) ) || ( ( pNVar6 != pNVar5 && ( cVar2 = Node::is_ancestor_of(pNVar6) ),cVar2 == '\0' ) )) {
      ...
      if (( *(long*)( lVar4 + 0x188 ) == 0 ) || ( *(uint*)( *(long*)( lVar4 + 0x188 ) + -8 ) < 2 )) {
         LAB_001009cb:Resource::get_path();
         if (( local_48 == 0 ) || ( iVar3 = iVar3 == 0 )) {
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_48);
            LAB_00100a60:iVar3 = EditorData::get_current_edited_scene_history_id();
         }
 else {
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_48);
         ...
         if (( iVar3 != -1 ) || ( cVar2 = String::begins_with((char*)( lVar4 + 0x188 )) ),cVar2 != '\0') goto LAB_001009cb;
      }
   ...
   LAB_00100b30:iVar3 = *(int*)( this + 0x1a8 );
   if (iVar3 == -99) {
      iVar3 = 0;
   }

   LAB_00100ac5:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
...
/* EditorUndoRedoManager::discard_history(int, bool) */void EditorUndoRedoManager::discard_history(EditorUndoRedoManager *this, int param_1, bool param_2) {
   undefined8 *puVar1;
   undefined8 *puVar2;
   long *plVar3;
   uint *puVar4;
   ...
   if (( *(long*)( this + 0x180 ) != 0 ) && ( *(int*)( this + 0x1a4 ) != 0 )) {
      ...
      if (uVar31 != 0) {
         uVar36 = 0;
         do {
            if (( uVar38 == uVar31 ) && ( param_1 == *(int*)( *(long*)( *(long*)( this + 0x180 ) + lVar34 * 8 ) + 0x10 ) )) {
               lVar34 = HashMap<int,EditorUndoRedoManager::History,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,EditorUndoRedoManager::History>>>::operator []((HashMap<int,EditorUndoRedoManager::History,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,EditorUndoRedoManager::History>>>*)( this + 0x178 ), local_4c);
               ...
               local_44 = 0;
               cVar30 = HashMap<int,EditorUndoRedoManager::History,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,EditorUndoRedoManager::History>>>::_lookup_pos((HashMap<int,EditorUndoRedoManager::History,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,EditorUndoRedoManager::History>>>*)( this + 0x178 ), (int*)(ulong)(uint)param_1, &local_44);
               ...
               uVar38 = *puVar41;
               if (( uVar38 == 0 ) || ( auVar14._8_8_ = 0 ),auVar14._0_8_ = (ulong)uVar38 * lVar7,auVar24._8_8_ = 0,auVar24._0_8_ = uVar39,auVar15._8_8_ = 0,auVar15._0_8_ = ( ulong )(( uVar31 + uVar36 ) - SUB164(auVar14 * auVar24, 8)) * lVar7,auVar25._8_8_ = 0,auVar25._0_8_ = uVar39,uVar29 = local_44,SUB164(auVar15 * auVar25, 8) == 0) goto LAB_00100e35;
               goto LAB_00100de6;
            }
 ...
 while ( ( uVar31 != 0 ) && ( auVar11._8_8_ = 0 ),auVar11._0_8_ = uVar31 * uVar39,auVar21._8_8_ = 0,auVar21._0_8_ = uVar40,auVar12._8_8_ = 0,auVar12._0_8_ = ( ( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x1a0 ) * 4 ) + iVar33 ) - SUB164(auVar11 * auVar21, 8) ) * uVar39,auVar22._8_8_ = 0,auVar22._0_8_ = uVar40,uVar36 <= SUB164(auVar12 * auVar22, 8) );
      }

   }

   _err_print_error("discard_history", "editor/editor_undo_redo_manager.cpp", 0x1c2, "Condition \"!history_map.has(p_idx)\" is true.", 0, 0);
   goto LAB_00100ceb;
   while (auVar16._8_8_ = 0,auVar16._0_8_ = (ulong)uVar38 * lVar7,auVar26._8_8_ = 0,auVar26._0_8_ = uVar39,auVar17._8_8_ = 0,auVar17._0_8_ = ( ulong )(( uVar36 + uVar31 ) - SUB164(auVar16 * auVar26, 8)) * lVar7,auVar27._8_8_ = 0,auVar27._0_8_ = uVar39,uVar29 = local_44,SUB164(auVar17 * auVar27, 8) != 0) {
      LAB_00100de6:local_44 = uVar36;
...
;
   LAB_00100e35:uVar39 = (ulong)local_44;
   *(undefined4*)( lVar34 + uVar39 * 4 ) = 0;
   ...
   List<EditorUndoRedoManager::Action,DefaultAllocator>::~List((List<EditorUndoRedoManager::Action,DefaultAllocator>*)( plVar37 + 7 ));
   List<EditorUndoRedoManager::Action,DefaultAllocator>::~List((List<EditorUndoRedoManager::Action,DefaultAllocator>*)( plVar37 + 6 ));
   Memory::free_static(plVar37, false);
   *(undefined8*)( *(long*)( this + 0x180 ) + uVar39 * 8 ) = 0;
   *(int*)( this + 0x1a4 ) = *(int*)( this + 0x1a4 ) + -1;
   LAB_00100ceb:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* EditorUndoRedoManager::~EditorUndoRedoManager() */void EditorUndoRedoManager::~EditorUndoRedoManager(EditorUndoRedoManager *this) {
 ...
 while ( (int)plVar6[2] != 0 );
                  ...
                  LAB_00101079:plVar6 = *(long**)( (long)pvVar7 + 0x30 );
                  if (plVar6 != (long*)0x0) {
                     do {
                        pvVar3 = (void*)*plVar6;
                        if (pvVar3 == (void*)0x0) {
 ...
 while ( (int)plVar6[2] != 0 );
                  ...
                  LAB_001010f6:Memory::free_static(pvVar7, false);
                  pvVar7 = *(void**)( this + 0x180 );
 ...
 while ( lVar8 != (ulong)uVar1 << 2 );
   ...
   LAB_00101136:Object::~Object((Object*)this);
   return;
}
/* EditorUndoRedoManager::~EditorUndoRedoManager() */void EditorUndoRedoManager::~EditorUndoRedoManager(EditorUndoRedoManager *this) {
...
/* EditorUndoRedoManager::get_or_create_history(int) */void EditorUndoRedoManager::get_or_create_history(EditorUndoRedoManager *this, int param_1) {
   HashMap<int,EditorUndoRedoManager::History,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,EditorUndoRedoManager::History>>> *this_00;
   void *pvVar1;
   long lVar2;
   char cVar3;
   Object *this_01;
   ...
   long local_40;
   this_00 = (HashMap<int,EditorUndoRedoManager::History,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,EditorUndoRedoManager::History>>>*)( this + 0x178 );
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   local_6c = param_1;
   cVar3 = HashMap<int,EditorUndoRedoManager::History,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,EditorUndoRedoManager::History>>>::_lookup_pos(this_00, (int*)CONCAT44(in_register_00000034, param_1), local_68);
   if (cVar3 == '\0') {
      local_58 = 1;
      for (int i = 0; i < 16; i++) {
         local_50[i] = (List<EditorUndoRedoManager::Action,DefaultAllocator>)0;
      }
      ...
      *(undefined1(*) [16])( this_01 + 0x1d0 ) = (undefined1[16])0x0;
      ...
      local_68[0] = param_1;
      local_60 = this_01;
      piVar4 = (int*)HashMap<int,EditorUndoRedoManager::History,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,EditorUndoRedoManager::History>>>::operator [](this_00, &local_6c);
 ...
 while ( (int)plVar6[2] != 0 );
      ...
      LAB_00101472:plVar6 = *(long**)( piVar4 + 8 );
      if (plVar6 != (long*)0x0) {
         do {
            pvVar1 = (void*)*plVar6;
 ...
 while ( (int)plVar6[2] != 0 );
      ...
      LAB_001014ee:EditorLog::register_undo_redo(*(UndoRedo**)( EditorNode::singleton + 0x5d0 ));
   ...
   HashMap<int,EditorUndoRedoManager::History,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,EditorUndoRedoManager::History>>>::operator [](this_00, &local_6c);
...
/* EditorUndoRedoManager::get_history_for_object(Object*) */long EditorUndoRedoManager::get_history_for_object(EditorUndoRedoManager *this, Object *param_1) {
   int iVar1;
   undefined8 uVar2;
   int iVar3;
   long lVar4;
   ...
   if (this[0x1c8] == (EditorUndoRedoManager)0x0) {
      ...
      if (( iVar1 != iVar3 ) && ( iVar1 != -99 )) {
         ...
         _err_print_error("get_history_for_object", "editor/editor_undo_redo_manager.cpp", 0x6d, "Condition \"pending_action.history_id != INVALID_HISTORY && history_id != pending_action.history_id\" is true. Returning: get_or_create_history(pending_action.history_id)", local_38, 0, 0);
   ...
   LAB_0010170a:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* EditorUndoRedoManager::add_do_methodp(Object*, StringName const&, Variant const**, int) */void EditorUndoRedoManager::add_do_methodp(Object *param_1, StringName *param_2, Variant **param_3, int param_4) {
   Callable *pCVar1;
   long lVar2;
   long in_FS_OFFSET;
...
/* EditorUndoRedoManager::_add_do_method(Variant const**, int, Callable::CallError&) */void EditorUndoRedoManager::_add_do_method(EditorUndoRedoManager *this, Variant **param_1, int param_2, CallError *param_3) {
   Variant *this_00;
   undefined4 uVar1;
   Object *pOVar2;
   long in_FS_OFFSET;
   ...
   *(undefined4*)( param_3 + 8 ) = uVar1;
   LAB_001017f2:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* EditorUndoRedoManager::add_undo_methodp(Object*, StringName const&, Variant const**, int) */void EditorUndoRedoManager::add_undo_methodp(Object *param_1, StringName *param_2, Variant **param_3, int param_4) {
   Callable *pCVar1;
   long lVar2;
   long in_FS_OFFSET;
   Callable aCStack_68[16];
...
/* EditorUndoRedoManager::_add_undo_method(Variant const**, int, Callable::CallError&) */void EditorUndoRedoManager::_add_undo_method(EditorUndoRedoManager *this, Variant **param_1, int param_2, CallError *param_3) {
   Variant *this_00;
   undefined4 uVar1;
   Object *pOVar2;
   long in_FS_OFFSET;
   ...
   *(undefined4*)( param_3 + 8 ) = uVar1;
   LAB_00101992:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* EditorUndoRedoManager::add_do_property(Object*, StringName const&, Variant const&) */void EditorUndoRedoManager::add_do_property(Object *param_1, StringName *param_2, Variant *param_3) {
   long lVar1;
...
/* EditorUndoRedoManager::add_undo_property(Object*, StringName const&, Variant const&) */void EditorUndoRedoManager::add_undo_property(Object *param_1, StringName *param_2, Variant *param_3) {
   long lVar1;
   lVar1 = get_history_for_object((EditorUndoRedoManager*)param_1, (Object*)param_2);
   UndoRedo::add_undo_property(*(Object**)( lVar1 + 8 ), param_2, param_3);
   return;
}
/* EditorUndoRedoManager::add_do_reference(Object*) */void EditorUndoRedoManager::add_do_reference(EditorUndoRedoManager *this, Object *param_1) {
   long lVar1;
   lVar1 = get_history_for_object(this, param_1);
   UndoRedo::add_do_reference(*(Object**)( lVar1 + 8 ));
   return;
}
/* EditorUndoRedoManager::add_undo_reference(Object*) */void EditorUndoRedoManager::add_undo_reference(EditorUndoRedoManager *this, Object *param_1) {
   long lVar1;
   lVar1 = get_history_for_object(this, param_1);
...
/* EditorUndoRedoManager::create_action_for_history(String const&, int, UndoRedo::MergeMode, bool)
    */void EditorUndoRedoManager::create_action_for_history(EditorUndoRedoManager *this, CowData *param_1, int param_2, undefined4 param_4, EditorUndoRedoManager param_5) {
   int iVar1;
   long lVar2;
   long *plVar3;
   undefined8 uVar4;
   ...
   *(int*)( this + 0x1a8 ) = iVar1;
   ...
   UndoRedo::create_action(*(undefined8*)( lVar2 + 8 ), this + 0x1b8, *(undefined4*)( this + 0x1c0 ), this[0x1c4]);
   return;
}
/* EditorUndoRedoManager::set_history_as_saved(int) */void EditorUndoRedoManager::set_history_as_saved(EditorUndoRedoManager *this, int param_1) {
   long lVar1;
   undefined8 uVar2;
...
/* EditorUndoRedoManager::set_history_as_unsaved(int) */void EditorUndoRedoManager::set_history_as_unsaved(EditorUndoRedoManager *this, int param_1) {
   long lVar1;
   lVar1 = get_or_create_history(this, param_1);
   *(undefined8*)( lVar1 + 0x10 ) = 0xffffffffffffffff;
   return;
}
/* EditorUndoRedoManager::is_history_unsaved(int) */bool EditorUndoRedoManager::is_history_unsaved(EditorUndoRedoManager *this, int param_1) {
   long lVar1;
   long lVar2;
   lVar1 = get_or_create_history(this, param_1);
...
/* EditorUndoRedoManager::_get_newest_undo() */long EditorUndoRedoManager::_get_newest_undo(EditorUndoRedoManager *this) {
   double dVar1;
   int iVar2;
   long lVar3;
   long lVar4;
   ...
   if (( ( lVar3 != 0 ) && ( *(int*)( lVar3 + 0x10 ) != 0 ) ) && ( dVar1 = local_20 < dVar1 )) {
      lVar5 = lVar4;
      local_20 = dVar1;
   }
...
/* EditorUndoRedoManager::get_current_action_name() */void EditorUndoRedoManager::get_current_action_name(void) {
   long lVar1;
   char cVar2;
   long lVar3;
   ...
   *(undefined8*)in_RDI = 0;
   ...
   LAB_00101d86:if (lVar1 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* EditorUndoRedoManager::get_current_action_history_id() */undefined4 EditorUndoRedoManager::get_current_action_history_id(EditorUndoRedoManager *this) {
   char cVar1;
   undefined4 *puVar2;
   cVar1 = has_undo(this);
   if (cVar1 != '\0') {
...
/* EditorUndoRedoManager::undo_history(int) */undefined4 EditorUndoRedoManager::undo_history(EditorUndoRedoManager *this, int param_1) {
   undefined8 uVar1;
   long lVar2;
   code *pcVar3;
   undefined4 uVar4;
   ...
   if (param_1 == -99) {
      uVar4 = 0;
      _err_print_error("undo_history", "editor/editor_undo_redo_manager.cpp", 0x130, "Condition \"p_id == INVALID_HISTORY\" is true. Returning: false", 0, 0);
      goto LAB_00101f62;
   }
   ...
   if (*(long*)( puVar7 + 4 ) == 0) {
      ...
      local_60 = uVar13;
      local_5c = uVar12;
      if (( plVar8 != (long*)0x0 ) && ( puVar7 = (undefined4*)plVar8[1] ),puVar7 != (undefined4*)0x0) goto LAB_00102018;
   }
   ...
   *(int*)( plVar8 + 2 ) = (int)plVar8[2] + 1;
   uVar4 = UndoRedo::undo();
   if ((char)uVar4 != '\0') {
      if (undo_history(int)::{lambda()
      #1
      iVar5 = __cxa_guard_acquire(&undo_history(int)::{lambda()
      #1
      if (iVar5 != 0) {
         _scs_create((char *)&undo_history(int)::{lambda()
         #1
         __cxa_atexit(StringName::~StringName, &undo_history(int)::{lambda()#1}::operator()()::sname,&__dso_handle);__cxa_guard_release(&undo_history(int)::{lambda()#1}, ::operator()(), ::sname);}(undefined1[16])(**(code**)( *(long*)this + 0xd0 ))(this, &undo_history(int)::{lambda()#1}, ::operator()(), ::sname, 0, 0)(Variant::needs_deinit[(int)local_58] != '\0'), {
...
/* EditorUndoRedoManager::undo() */undefined8 EditorUndoRedoManager::undo(EditorUndoRedoManager *this) {
   char cVar1;
   int *piVar2;
   undefined8 uVar3;
   cVar1 = has_undo(this);
...
/* EditorUndoRedoManager::redo_history(int) */undefined4 EditorUndoRedoManager::redo_history(EditorUndoRedoManager *this, int param_1) {
   undefined8 uVar1;
   long lVar2;
   code *pcVar3;
   undefined4 uVar4;
   ...
   if (param_1 == -99) {
      uVar4 = 0;
      _err_print_error("redo_history", "editor/editor_undo_redo_manager.cpp", 0x165, "Condition \"p_id == INVALID_HISTORY\" is true. Returning: false", 0, 0);
      goto LAB_00102392;
   }
   ...
   if (*(long*)( puVar7 + 4 ) == 0) {
      ...
      local_60 = uVar13;
      local_5c = uVar12;
      if (( plVar8 != (long*)0x0 ) && ( puVar7 = (undefined4*)plVar8[1] ),puVar7 != (undefined4*)0x0) goto LAB_00102448;
   }
   ...
   *(int*)( plVar8 + 2 ) = (int)plVar8[2] + 1;
   uVar4 = UndoRedo::redo();
   if ((char)uVar4 != '\0') {
      if (redo_history(int)::{lambda()
      #1
      iVar5 = __cxa_guard_acquire(&redo_history(int)::{lambda()
      #1
      if (iVar5 != 0) {
         _scs_create((char *)&redo_history(int)::{lambda()
         #1
         __cxa_atexit(StringName::~StringName, &redo_history(int)::{lambda()#1}::operator()()::sname,&__dso_handle);__cxa_guard_release(&redo_history(int)::{lambda()#1}, ::operator()(), ::sname);}(undefined1[16])(**(code**)( *(long*)this + 0xd0 ))(this, &redo_history(int)::{lambda()#1}, ::operator()(), ::sname, 0, 0)(Variant::needs_deinit[(int)local_58] != '\0'), {
      Variant::_clear_internal());
      }
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
   LAB_00102392:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar4;
   }
...
/* EditorUndoRedoManager::redo() */undefined8 EditorUndoRedoManager::redo(EditorUndoRedoManager *this) {
   double *pdVar1;
   double dVar2;
   long lVar3;
   char cVar4;
   ...
   if (cVar4 != '\0') {
      ...
      lVar3 = *(long*)( piVar6 + 8 );
      if (( ( lVar3 != 0 ) && ( *(int*)( lVar3 + 0x10 ) != 0 ) ) && ( dVar2 = dVar2 < dVar9 )) {
         iVar8 = *piVar6;
         dVar9 = dVar2;
      }
      ...
      lVar3 = *(long*)( piVar6 + 8 );
      if (( ( lVar3 != 0 ) && ( *(int*)( lVar3 + 0x10 ) != 0 ) ) && ( pdVar1 = (double*)( *(long*)( lVar3 + 8 ) + 8 ) * pdVar1 <= dVar9 && dVar9 != *pdVar1 )) {
         iVar8 = *piVar6;
      }
...
/* EditorUndoRedoManager::create_action(String const&, UndoRedo::MergeMode, Object*, bool) */void EditorUndoRedoManager::create_action(EditorUndoRedoManager *this, CowData *param_1, undefined4 param_3, Object *param_4, EditorUndoRedoManager param_5) {
   long lVar1;
   long *plVar2;
   undefined8 uVar3;
   if (*(int*)( this + 0x1a8 ) == -99) {
      ...
      *(undefined8*)( this + 0x1b0 ) = uVar3;
      ...
      UndoRedo::create_action(*(undefined8*)( lVar1 + 8 ), this + 0x1b8, *(undefined4*)( this + 0x1c0 ), this[0x1c4]);
   }
...
/* EditorUndoRedoManager::clear_history(int, bool) */void EditorUndoRedoManager::clear_history(EditorUndoRedoManager *this, int param_1, bool param_2) {
   long lVar1;
   undefined8 *puVar2;
   void *pvVar3;
   long lVar4;
...
;
      pcVar9 = (char *)&clear_history(int,bool)::{lambda()
      #2
      if (clear_history(int,bool)::{lambda()
      #2
      puVar10 = &clear_history(int,bool)::{lambda()
      #2
      pcVar9 = (char *)&clear_history(int,bool)::{lambda()
      #2
      iVar5 = __cxa_guard_acquire(&clear_history(int,bool)::{lambda()
      #2
   }
 else {
      lVar6 = get_or_create_history(this, param_1);
 ...
 while ( (int)plVar11[2] != 0 );
      ...
      LAB_001029db:plVar11 = *(long**)( lVar6 + 0x20 );
      if (plVar11 != (long*)0x0) {
         do {
            pvVar3 = (void*)*plVar11;
 ...
 while ( (int)plVar11[2] != 0 );
   ...
   LAB_00102889:( **(code**)( *(long*)this + 0xd0 ) )(this, pcVar9, 0, 0);
...
/* EditorUndoRedoManager::commit_action(bool) */void EditorUndoRedoManager::commit_action(bool param_1)

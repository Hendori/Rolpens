...
/* OpenXRAPI::load_layer_properties() */undefined8 OpenXRAPI::load_layer_properties(OpenXRAPI *this) {
 ...
 while ( puVar12 != puVar8 );
            ...
            if (( *(code**)( this + 0x278 ) == (code*)0x0 ) || ( iVar7 = ( **(code**)( this + 0x278 ) )(local_7c, &local_7c, puVar12) ),iVar7 < 0) {
...
/* OpenXRAPI::load_supported_extensions() */undefined8 OpenXRAPI::load_supported_extensions(OpenXRAPI *this) {
 ...
 while ( puVar12 != puVar9 );
            ...
            if (( *(code**)( this + 0x288 ) == (code*)0x0 ) || ( iVar8 = ( **(code**)( this + 0x288 ) )(0, local_7c, &local_7c, puVar12) ),iVar8 < 0) {
...
;
 ...
 while ( lVar10 != lVar16 );
               ...
               LAB_00114da0:if (( ( this[0x4a9] == (OpenXRAPI)0x0 ) || ( this[0x511] == (OpenXRAPI)0x0 ) ) || ( OVar19 = this[0x574] ),OVar19 == (OpenXRAPI)0x0) {
                  local_64 = 0;
                  uStack_6c = 0;
                  uStack_68 = 0;
                  uStack_84 = 0;
...
;
 ...
 while ( lVar20 != 0 );
         ...
         if (( *(code**)( this + 0x218 ) == (code*)0x0 ) || ( iVar6 = ( **(code**)( this + 0x218 ) )(local_188, this + 0xd0) ),iVar6 < 0) {
            uVar12 = 0;
      ...
      undefined8 OpenXRAPI::initialize(OpenXRAPI *this, String *param_1) {
         ...
         if (*(long*)( this + 0xd0 ) == 0) {
            ...
            if (cVar1 != '\0') {
               ...
               if (( ( ( ( cVar1 != '\0' ) && ( cVar1 = load_supported_extensions(this) ),cVar1 != '\0' ) ) && ( cVar1 = create_instance(this) ),cVar1 != '\0' )) &&( ( cVar1 = resolve_instance_openxr_symbols(this) ),cVar1 != '\0' && ( cVar1 = get_system_info(this) ),cVar1 != '\0' ) && ( ( cVar1 = load_supported_view_configuration_types(this) ),cVar1 != '\0' && ( ( cVar1 = load_supported_view_configuration_views(this, *(undefined4*)( this + 0x9c )) ),cVar1 != '\0' && ( uVar3 = load_supported_environmental_blend_modes(this) ),(char)uVar3 != '\0' ) );
            }

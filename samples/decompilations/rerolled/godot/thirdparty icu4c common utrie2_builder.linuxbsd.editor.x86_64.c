/* allocIndex2Block(UNewTrie2*) */int allocIndex2Block(UNewTrie2 *param_1) {
   UNewTrie2 *pUVar1;
   UNewTrie2 *pUVar2;
   undefined8 uVar3;
   int iVar4;
   ...
   if (iVar4 + 0x40 < 0x8aa1) {
      ...
      *(undefined8*)( pUVar1 + 8 ) = uVar3;
      for (int i = 0; i < 15; i++) {
         uVar3 = *(undefined8*)( pUVar2 + ( 16*i + 24 ) );
         *(undefined8*)( pUVar1 + ( 16*i + 16 ) ) = *(undefined8*)( pUVar2 + ( 16*i + 16 ) );
         *(undefined8*)( pUVar1 + ( 16*i + 24 ) ) = uVar3;
      }
...
/* getDataBlock(UNewTrie2*, int, signed char) */int getDataBlock(UNewTrie2 *param_1, uint param_2, char param_3) {
   UNewTrie2 *pUVar1;
   undefined8 *puVar2;
   undefined8 *puVar3;
   int iVar4;
   ...
   if (( iVar4 != *(int*)( param_1 + 0x23324 ) ) && ( *(int*)( param_1 + (long)( iVar4 >> 5 ) * 4 + 0x23330 ) == 1 )) {
      return iVar4;
   }
...
void utrie2_setRange32_76_godot_part_0_isra_0(UNewTrie2 *param_1, ulong param_2, int param_3, int param_4, char param_5, undefined4 *param_6) {
   UNewTrie2 *pUVar1;
   bool bVar2;
   int iVar3;
   uint uVar4;
   ...
   uVar16 = (uint)param_2;
   if (param_5 != '\0') {
      if (( param_2 & 0x1f ) != 0) goto LAB_00100720;
      goto LAB_0010051f;
   }
   ...
   if (( param_2 & 0x1f ) == 0) {
      ...
      LAB_00100720:iVar6 = getDataBlock(param_1, param_2, 1);
      if (iVar6 < 0) goto LAB_00100850;
      ...
      if ((int)( param_3 + 1U ) < (int)uVar12) {
         ...
         *piVar8 = param_4;
         ...
         piVar10 = piVar8 + 1;
         if (( ~(ulong)piVar8 + (long)piVar9 >> 2 & 1 ) != 0) {
            piVar8[1] = param_4;
            piVar10 = piVar8 + 2;
            if (piVar9 <= piVar8 + 2) {
               return;
         ...
         *piVar8 = param_4;
         if (piVar8 + 1 < piVar9) {
            ...
            if (( ~(ulong)piVar8 + (long)piVar9 >> 2 & 1 ) != 0) {
               piVar8[1] = param_4;
               piVar10 = piVar8 + 2;
               if (piVar9 <= piVar8 + 2) goto LAB_0010051f;
            }
 ...
 while ( piVar8 < piVar9 );
         ...
         LAB_0010051f:iVar13 = *(int*)( param_1 + 0x23308 );
      }
      ...
      do {
         while (true) {
            ...
            if (( uVar5 & 0xfffffc00 ) == 0xd800) {
               if (*(int*)( param_1 + (long)(int)( uVar4 + 0x140 ) * 4 + 0x880 ) != iVar13) goto LAB_001005e5;
            }
 else {
               ...
               if (*(int*)( param_1 + (long)(int)( ( uVar4 & 0x3f ) + iVar3 ) * 4 + 0x880 ) != iVar13) {
                  ...
                  LAB_001004dc:lVar7 = (long)iVar6;
                  iVar3 = allocIndex2Block(param_1);
                  if (iVar3 < 0) {
                     LAB_001006d0:*param_6 = 5;
                     return;
                  }
            ...
            LAB_0010048e:param_2 = (ulong)uVar12;
...
;
         if (( uVar5 & 0xfffffc00 ) == 0xd800) {
            iVar13 = *(int*)( param_1 + 0x23324 );
            LAB_001005e5:lVar11 = (long)iVar13;
            iVar3 = 0x800;
         }
 else {
            iVar3 = *(int*)( param_1 + (long)iVar6 * 4 );
            if (*(int*)( param_1 + 0x23320 ) == iVar3) goto LAB_001004dc;
            LAB_00100433:if (iVar3 < 0) goto LAB_001006d0;
            lVar11 = (long)*(int*)( param_1 + 0x23324 );
         }

         LAB_00100448:lVar7 = (long)(int)( ( uVar4 & 0x3f ) + iVar3 );
 ...
 while ( piVar8 + 0x20 != piVar10 );
            }

            goto LAB_0010048e;
         }

         if (( param_4 == *(int*)( *(long*)( param_1 + 0x23300 ) + (long)iVar6 * 4 ) ) || ( param_5 == '\0' )) goto LAB_0010048e;
         LAB_00100561:iVar3 = (int)uVar15;
         if (iVar3 < 0) {
            uVar5 = getDataBlock(param_1, uVar14 & 0xffffffff, 1);
            uVar15 = (ulong)uVar5;
            if (-1 < (int)uVar5) {
               piVar8 = (int*)( *(long*)( param_1 + 0x23300 ) + (long)(int)uVar5 * 4 );
               piVar9 = piVar8;
               do {
                  *piVar9 = param_4;
                  for (int i = 0; i < 3; i++) {
 ...
 while ( piVar8 + 0x20 != piVar10 );
         ...
         *(int*)( param_1 + (long)( iVar3 >> 5 ) * 4 + 0x23330 ) = *(int*)( param_1 + (long)( iVar3 >> 5 ) * 4 + 0x23330 ) + 1;
 ...
 while ( piVar8 < piVar9 );
   ...
   LAB_00100850:*param_6 = 7;
   return;
}
/* WARNING: Removing unreachable block (ram,0x00101071) *//* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void utrie2_freeze_76_godot_part_0(undefined8 *param_1, uint param_2, int *param_3) {
   undefined4 uVar1;
   int *piVar2;
   bool bVar3;
   undefined8 uVar4;
      ...
      do {
         ...
         if (iVar30 == iVar25) {
            ...
            do {
               iVar9 = piVar17[0x25f];
               if (iVar9 == iVar19) {
                  LAB_00100dc5:iVar8 = iVar8 + -0x20;
               }
 else {
                  if (piVar2[0x8cc9] == iVar9) {
                     if (iVar7 == iVar18) goto LAB_00100dc5;
                     goto LAB_00100e02;
                  }
                  ...
                  do {
                     if (iVar7 != *(int*)( lVar31 + 0x7c )) goto LAB_00100e02;
                     iVar8 = iVar8 + -1;
                     lVar31 = lVar31 + -4;
                  }
 while ( iVar25 != iVar8 );
 ...
 while ( 0 < iVar8 );
      ...
      *(undefined4*)( (long)param_1 + 0x2c ) = 0;
      ...
      utrie2_setRange32_76_godot_part_0_isra_0(param_1[9], uVar26, 0x10ffff, *(undefined4*)( (long)param_1 + 0x24 ), 1);
      iVar18 = *param_3;
      if (0 < iVar18) {
         return;
      }
      ...
      lVar20 = *(long*)( piVar2 + 0x8cc0 );
      LAB_00100e7a:uVar5 = _UNK_00102008;
      uVar4 = __LC0;
 ...
 while ( iVar30 < iVar10 );
         ...
         do {
            ...
            if (piVar2[lVar24 + 0x8ccc] < 1) {
               LAB_00100fc9:iVar25 = iVar8 + iVar30;
               iVar8 = iVar9;
            }
 else {
               if (-1 < iVar9 - iVar30) {
 ...
 while ( iVar19 != iVar25 );
                  ...
                  do {
                     lVar15 = 0;
                     while (*(int*)( lVar29 + lVar15 * 4 ) == *(int*)( lVar20 + (long)iVar8 * 4 + lVar15 * 4 )) {
                        lVar15 = lVar15 + 1;
                        if (lVar31 == lVar15) goto LAB_00100fa0;
                     }
;
                     iVar25 = iVar25 + 4;
                     lVar29 = lVar29 + 0x10;
 ...
 while ( iVar25 <= iVar9 - iVar30 );
               ...
               if (0 < (int)uVar26) {
                  ...
                  do {
                     uVar32 = 0;
                     while (*(int*)( lVar29 + uVar32 * 4 ) == *(int*)( lVar20 + (long)iVar8 * 4 + uVar32 * 4 )) {
                        uVar32 = uVar32 + 1;
                        uVar26 = uVar27;
                        if (uVar32 == uVar27) goto LAB_00101128;
                     }
;
                     uVar27 = uVar27 - 4;
                     lVar29 = lVar29 + 0x10;
 ...
 while ( iVar9 != iVar10 * 0x20 + iVar8 );
                  ...
                  LAB_00101128:iVar25 = iVar9 - uVar26;
                  if (iVar10 != 0) {
                     piVar16 = piVar2 + lVar24;
                     iVar19 = iVar10 * 0x20 + iVar25;
                     do {
 ...
 while ( iVar25 < piVar2[0x8cc6] );
         ...
         iVar9 = piVar2[0x8cc9];
         lVar31 = (long)iVar8 * 4;
         if (0 < iVar10) goto LAB_00101013;
         LAB_0010119d:iVar30 = piVar2[(long)( iVar9 >> 5 ) + 0x8ccc];
      }
         ...
         if (0xa60 < iVar10) {
            ...
            do {
               ...
               if (0x3f < (int)uVar22) {
                  ...
                  do {
                     lVar24 = 0;
                     while (*(int*)( (long)piVar17 + lVar24 ) == *(int*)( (long)piVar16 + lVar24 + (long)(int)uVar26 * 4 )) {
                        lVar24 = lVar24 + 4;
                        if (lVar24 == 0x100) {
                           uVar26 = uVar26 + 0x40;
 ...
 while ( uVar22 - 0x3f != iVar8 );
               ...
               do {
                  ...
                  while (piVar17[lVar29] == piVar16[(int)uVar26 + lVar29]) {
                     lVar29 = lVar29 + 1;
                     if (lVar24 == lVar29) goto LAB_00101371;
                  }
;
                  piVar17 = piVar17 + 1;
                  lVar24 = lVar24 + -1;
...
;
   ...
   if (iVar18 < 0x10001) {
      ...
      LAB_00100ceb:uVar26 = 0;
      if (0xffff < piVar2[0x8cc9]) goto LAB_00100ccc;
   }
 else {
      uVar22 = piVar2[0x8cc4];
      if (param_2 != 0) {
         if (0xffff < (int)uVar22) goto LAB_00100ccc;
         goto LAB_00100ceb;
      }

      bVar3 = 0xf77f < (int)uVar22;
      if (0xffff < (int)uVar22) goto LAB_00100ccc;
      LAB_0010097d:if (( 0xffff < (int)( piVar2[0x8cc9] + uVar22 ) ) || ( uVar26 = bVar3 )) goto LAB_00100ccc;
   }
   ...
   if ((int)( iVar10 + uVar26 ) < 0x3fffd) {
      ...
      *param_1 = puVar11 + 4;
      *(ulong*)( puVar11 + 1 ) = ( ( uVar12 << 0x10 | ( ulong )((int)uVar27 >> 2 & 0xffff) ) << 0x10 | ( ulong )(uVar22 & 0xffff) ) << 0x10 | (ulong)local_5c;
      *(short*)( (long)puVar11 + 0xe ) = (short)( iVar18 >> 0xb );
      ...
      do {
         ...
         *(short*)( (long)puVar11 + lVar20 + 0x10 ) = (short)( *(int*)( (long)piVar2 + lVar20 * 2 + 0x880 ) + uVar26 >> 2 );
         lVar20 = lVar20 + 2;
      }
 while ( lVar20 != 0x1040 );
      uVar13 = uVar12;
 ...
 while ( uVar22 != uVar12 );
         ...
         if (0 < (int)uVar6) {
            ...
            do {
               ...
               uVar13 = ( uVar13 - uVar23 ) + -2 + uVar14;
               *(short*)( (long)puVar28 + uVar12 * 2 ) = (short)( piVar2[(long)(int)( uVar22 + 0x840 ) + uVar12 + 0x220] + uVar26 >> 2 );
               uVar12 = uVar12 + 1;
            }
 while ( uVar12 != uVar6 );
 ...
 while ( uVar32 != uVar27 );
   ...
   LAB_00100ccc:*param_3 = 8;
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined1(*)[16];utrie2_open_76_godot(undefined4 param_1, undefined4 param_2, int *param_3) {
   long lVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   int iVar4;
   ...
   if (*param_3 < 1) {
      ...
      if (( pauVar7 != (undefined1(*) [16])0x0 && pauVar8 != (undefined1(*) [16])0x0 ) && ( puVar9 != (undefined4*)0x0 )) {
 ...
 while ( puVar9 + 0x100 != puVar12 );
         ...
         *(undefined8*)( pauVar8[0x2334] + 8 ) = uVar2;
         uVar3 = _UNK_00102048;
         uVar2 = __LC5;
         pauVar11 = pauVar8 + 0x89;
         do {
            *(undefined8*)*pauVar11 = uVar2;
            *(undefined8*)( *pauVar11 + 8 ) = uVar3;
            pauVar10 = pauVar11 + 3;
            *(undefined8*)pauVar11[1] = uVar2;
            *(undefined8*)( pauVar11[1] + 8 ) = uVar3;
            *(undefined8*)pauVar11[2] = uVar2;
            *(undefined8*)( pauVar11[2] + 8 ) = uVar3;
            pauVar11 = pauVar10;
         }
 while ( pauVar8 + 0x290 != pauVar10 );
         *(undefined8*)pauVar8[0x290] = 0xffffffffffffffff;
         *(undefined8*)( pauVar8[799] + 8 ) = 0xffffffffffffffff;
         puVar16 = (undefined8*)( ( ulong )(pauVar8[0x290] + 8) & 0xfffffffffffffff8 );
         uVar13 = ( ulong )(( (int)( pauVar8 + 0x290 ) - (int)puVar16 ) + 0x900U >> 3);
         for (; uVar13 != 0; uVar13 = uVar13 - 1) {
            *puVar16 = 0xffffffffffffffff;
            puVar16 = puVar16 + (ulong)bVar17 * -2 + 1;
         }

         pauVar11 = pauVar8 + 800;
         do {
            *(undefined8*)*pauVar11 = uVar2;
            *(undefined8*)( *pauVar11 + 8 ) = uVar3;
            pauVar10 = pauVar11 + 2;
 ...
 while ( pauVar8 + 0x330 != pauVar10 );
         ...
         *(undefined4*)pauVar8[0x2331] = 0xaa0;
         ...
         do {
            pauVar10 = pauVar11 + 1;
            auVar19._0_4_ = auVar18._0_4_ + iVar15;
            auVar19._4_4_ = auVar18._4_4_ + iVar6;
            auVar19._8_4_ = auVar18._8_4_ + iVar4;
            auVar19._12_4_ = auVar18._12_4_ + iVar5;
            *pauVar11 = auVar18;
            uVar3 = _UNK_00102068;
            uVar2 = __LC7;
            pauVar11 = pauVar10;
 ...
 while ( pauVar10 != pauVar8 + 0x88 );
         ...
         do {
            while (0 < *param_3) {
               LAB_00101780:iVar15 = iVar15 + 0x20;
               if (iVar15 == 0x800) {
                  return pauVar7;
               }
...
;
            ...
            if (( lVar1 != 0 ) && ( *(char*)( lVar1 + 0x2332c ) == '\0' )) {
               iVar6 = getDataBlock(lVar1, iVar15, 1);
               if (iVar6 < 0) {
                  *param_3 = 7;
               }
 else {
   ...
   if (( lVar1 == 0 ) || ( *(char*)( lVar1 + 0x2332c ) != '\0' )) {
      *param_4 = 0x1e;
      ...
      if (iVar2 < 0) {
         ...
         *(undefined4*)( *(long*)( lVar1 + 0x23300 ) + (long)(int)( ( (uint)param_2 & 0x1f ) + iVar2 ) * 4 ) = param_3;
      }
...
/* copyEnumRange(void const*, int, int, unsigned int) */bool copyEnumRange(void *param_1, int param_2, int param_3, uint param_4) {
   uint uVar1;
   ...
   if (uVar1 != param_2) {
      if (*(int*)( (long)param_1 + 8 ) < 1) {
         if (( (uint)param_2 < 0x110000 && param_2 <= (int)uVar1 ) && ( uVar1 < 0x110000 )) {
            utrie2_setRange32_76_godot_part_0_isra_0(*(undefined8*)( *param_1 + 0x48 ), param_2, uVar1, param_4, 1, (long)param_1 + 8);
...
void utrie2_set32ForLeadSurrogateCodeUnit_76_godot(long param_1, undefined8 param_2, undefined4 param_3, int *param_4) {
   long lVar1;
   int iVar2;
   if (0 < *param_4) {
      return;
   ...
   if (( lVar1 != 0 ) && ( *(char*)( lVar1 + 0x2332c ) == '\0' )) {
      ...
      if (iVar2 < 0) {
         ...
         *(undefined4*)( *(long*)( lVar1 + 0x23300 ) + (long)(int)( iVar2 + ( (uint)param_2 & 0x1f ) ) * 4 ) = param_3;
      }
...
undefined8 utrie2_cloneAsThawed_76_godot(long *param_1, int *param_2) {
   ...
   if (*param_2 < 1) {
      if (param_1 == (long*)0x0) {
         LAB_00101dcf:*param_2 = 1;
         goto LAB_00101de0;
      }

      lVar1 = param_1[9];
      if (param_1[7] == 0) {
         if (lVar1 == 0) goto LAB_00101dcf;
         LAB_00101d19:if (*(char*)( lVar1 + 0x2332c ) == '\0') {
      ...
      *param_2 = local_30;
      do {
         lVar1 = (long)(int)( ( (uint)uVar4 & 0x1f ) + ( uint ) * (ushort*)( *param_1 + ( ulong )(( ushort )(uVar4 >> 5) & 0x7ff) * 2 ) * 4 );
         if (param_1[2] == 0) {
 ...
 while ( uVar3 != 0xdc00 );
   ...
   LAB_00101e35:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
long utrie2_fromUTrie_76_godot(long *param_1, undefined8 param_2, int *param_3) {
      ...
      if (param_1 == (long*)0x0) {
         *param_3 = 1;
         ...
         if (*param_3 < 1) {
            ...
            *param_3 = local_30;
            do {
               lVar1 = (long)(int)( ( (uint)uVar3 & 0x1f ) + ( uint ) * (ushort*)( *param_1 + ( ulong )(( ushort )(uVar3 >> 5) & 0x7ff) * 2 ) * 4 );
               if (param_1[1] == 0) {
 ...
 while ( uVar2 != 0xdc00 );
            if (*param_3 < 1) {
               if (local_38 == 0) {
                  *param_3 = 1;
                  ...
                  lVar1 = local_38;
                  if (*param_3 < 1) goto LAB_00101f20;
               }
   ...
   lVar1 = 0;
   LAB_00101f20:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
...
void utrie2_setRange32_76_godot(long param_1, uint param_2, uint param_3, undefined8 param_4, undefined8 param_5, int *param_6) {
   if (0 < *param_6) {
      return;
   }

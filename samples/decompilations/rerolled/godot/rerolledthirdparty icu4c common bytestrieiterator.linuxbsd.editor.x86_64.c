/* icu_76_godot::BytesTrie::Iterator::Iterator(void const*, int, UErrorCode&) */void icu_76_godot::BytesTrie::Iterator::Iterator(Iterator *this, void *param_1, int param_2, UErrorCode *param_3) {
   uint uVar1;
   int iVar2;
   long *plVar3;
   UVector32 *this_00;
...
/* icu_76_godot::BytesTrie::Iterator::Iterator(icu_76_godot::BytesTrie const&, int, UErrorCode&) */void icu_76_godot::BytesTrie::Iterator::Iterator(Iterator *this, BytesTrie *param_1, int param_2, UErrorCode *param_3) {
   undefined4 uVar1;
   uint uVar2;
   int iVar3;
   uint uVar4;
   ...
   if (this_00 == (UVector32*)0x0) {
      ...
      *(UVector32**)( this + 0x30 ) = this_00;
      ...
      if (*(char**)( this + 0x20 ) != (char*)0x0) {
         ...
         icu_76_godot::CharString::append(*(char**)( this + 0x20 ), (int)*(undefined8*)( this + 8 ), (UErrorCode*)(ulong)uVar9);
...
/* icu_76_godot::BytesTrie::Iterator::~Iterator() */void icu_76_godot::BytesTrie::Iterator::~Iterator(Iterator *this) {
   UMemory *this_00;
   void *in_RSI;
...
/* icu_76_godot::BytesTrie::Iterator::reset() */Iterator * __thiscall icu_76_godot::BytesTrie::Iterator::reset(Iterator *this){
   int iVar1;
   int iVar2;
   int iVar3;
...
/* icu_76_godot::BytesTrie::Iterator::hasNext() const */undefined4 icu_76_godot::BytesTrie::Iterator::hasNext(Iterator *this) {
   if (*(long*)( this + 8 ) != 0) {
      return 1;
   }

   return CONCAT31(( int3 )(( uint ) * (int*)( *(long*)( this + 0x30 ) + 8 ) >> 8), *(int*)( *(long*)( this + 0x30 ) + 8 ) != 0);
}
/* icu_76_godot::BytesTrie::Iterator::getString() const */undefined1[16];icu_76_godot::BytesTrie::Iterator::getString (Iterator *this) {
   undefined8 *puVar1;
   undefined8 uVar2;
   ulong uVar3;
...
/* icu_76_godot::BytesTrie::Iterator::truncateAndStop() */undefined8 icu_76_godot::BytesTrie::Iterator::truncateAndStop(Iterator *this) {
   *(undefined8*)( this + 8 ) = 0;
   *(undefined4*)( this + 0x2c ) = 0xffffffff;
   return 1;
}
/* icu_76_godot::BytesTrie::Iterator::branchNext(unsigned char const*, int, UErrorCode&) */uchar *icu_76_godot::BytesTrie::Iterator::branchNext(uchar *param_1, int param_2, UErrorCode *param_3) {
   byte bVar1;
   int iVar2;
   undefined8 uVar3;
   char cVar4;
   ...
   if (5 < (int)uVar10) {
      do {
         ...
         if (( (int)uVar10 < 0 ) || ( lVar8 = lVar9 * (int*)( lVar9 + 0xc ) < (int)uVar10 )) {
            ...
            LAB_001003f5:*(int*)( *(long*)( lVar9 + 0x18 ) + (long)iVar2 * 4 ) = iVar6 - (int)uVar3;
         ...
         if (( (int)uVar12 < 0 ) || ( *(int*)( lVar8 + 0xc ) < (int)uVar12 )) {
            ...
            LAB_00100414:*(uint*)( *(long*)( lVar8 + 0x18 ) + (long)iVar6 * 4 ) = ( (int)uVar13 - uVar10 ) * 0x10000 | uVar11;
 ...
 while ( true );
   ...
   if (( (int)uVar11 < 0 ) || ( lVar8 = lVar9 * (int*)( lVar9 + 0xc ) < (int)uVar11 )) {
      ...
      LAB_0010059b:*(int*)( *(long*)( lVar9 + 0x18 ) + (long)iVar2 * 4 ) = (int)puVar14 - (int)uVar3;
      *(int*)( lVar9 + 8 ) = *(int*)( lVar9 + 8 ) + 1;
   }
   ...
   *(int*)( lVar8 + 8 ) = *(int*)( lVar8 + 8 ) + 1;
   LAB_0010050e:icu_76_godot::CharString::append(cVar5, (UErrorCode*)(ulong)(uint)(int)cVar4);
   if (local_58 == 0) {
...
/* icu_76_godot::BytesTrie::Iterator::next(UErrorCode&) */undefined8 icu_76_godot::BytesTrie::Iterator::next(Iterator *this, UErrorCode *param_1) {
   byte bVar1;
   int iVar2;
   long lVar3;
   undefined4 uVar4;
   ...
   if (pbVar5 == (byte*)0x0) {
      ...
      icu_76_godot::CharString::append((char)*(undefined8*)( this + 0x20 ), (UErrorCode*)(ulong)(uint)(int)*pcVar8);
   }

   LAB_00100651:if (-1 < *(int*)( this + 0x18 )) {
      LAB_0010065a:*(undefined8*)( this + 8 ) = 0;
      *(undefined4*)( this + 0x2c ) = 0xffffffff;
      return 1;
   }

   LAB_001006a6:bVar1 = *pbVar5;
   do {
      uVar7 = (uint)bVar1;
      pbVar9 = pbVar5 + 1;
      if (0x1f < uVar7) {
         ...
         *(undefined4*)( this + 0x2c ) = uVar4;
         if (( ( bVar1 & 1 ) == 0 ) && ( ( *(int*)( this + 0x28 ) < 1 || ( *(int*)( this + 0x28 ) != *(int*)( *(long*)( this + 0x20 ) + 0x38 ) ) ) )) {
            if (0xa1 < uVar7) {
               if (uVar7 < 0xd8) {
                  pbVar9 = pbVar5 + 2;
               }
      ...
      if (iVar2 < 1) {
         ...
         if (iVar2 < (int)( ( uVar7 - 0xf ) + iVar6 )) {
            icu_76_godot::CharString::append(pcVar8, (int)pbVar9, (UErrorCode*)( ulong )(uint)(iVar2 - iVar6));
            goto LAB_0010065a;
         }

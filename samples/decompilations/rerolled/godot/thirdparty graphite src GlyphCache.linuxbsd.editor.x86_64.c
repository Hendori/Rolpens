/* graphite2::GlyphCache::~GlyphCache() */void graphite2::GlyphCache::~GlyphCache(GlyphCache *this) {
   long *plVar1;
   undefined8 *puVar2;
   void *pvVar3;
   long lVar4;
 ...
 while ( __ptr != plVar1 );
         LAB_0010005a:__ptr = *(long**)( this + 0x18 );
      }
   ...
   if (*(long*)( this + 0x10 ) == 0) {
      free((void*)*__ptr_00);
      LAB_001000a1:__ptr_00 = *(undefined8**)( this + 0x20 );
   }
 else if (*(ushort*)( this + 0x28 ) != 0) {
 ...
 while ( puVar2 != __ptr_00 );
   ...
   free(__ptr_00);
   LAB_001000ae:pvVar3 = *(void**)( this + 0x10 );
   if (pvVar3 != (void*)0x0) {
      for (int i = 0; i < 7; i++) {
...
/* graphite2::GlyphCache::Loader::Loader(graphite2::Face const&) */void graphite2::GlyphCache::Loader::Loader(Loader *this, Face *param_1) {
   uint *puVar1;
   ushort uVar2;
   short sVar3;
   ushort uVar4;
   ...
   *(undefined1(*) [16])( this + 0xc0 ) = (undefined1[16])0x0;
   if (( ( ( *(long*)( this + 8 ) == 0 ) || ( *(long*)( this + 0x28 ) == 0 ) ) || ( *(long*)( this + 0x48 ) == 0 ) ) || ( ( *(long*)( this + 0x68 ) != 0 ) != ( *(long*)( this + 0x88 ) != 0 ) )) goto LAB_00100280;
   graphite2::Face::Table::Table(aTStack_98, param_1, 0x6d617870, 0xffffffff);
   if (local_90 == (void*)0x0) {
      LAB_001004e8:local_40 = 0;
      for (int i = 0; i < 16; i++) {
         local_58[i] = (Table)0;
      }
   ...
   *(short*)( this + 0xe2 ) = sVar3;
   if (*(long*)( this + 0x68 ) != 0) {
      lVar6 = graphite2::TtfUtil::LocaLookup(sVar3 - 1, *(void**)( this + 0x88 ), *(ulong*)( this + 0x90 ), *(void**)( this + 8 ));
   ...
   if (*(long*)( lVar6 + 8 ) == 0) {
      ...
      *(ushort*)( this + 0xe6 ) = uVar4;
      ...
      if (( ( 0x2fff < (ulong)uVar4 - 1 || 0x1ffff < (int)( uVar5 >> 0x18 | ( uVar5 & 0xff0000 ) >> 8 | ( uVar5 & 0xff00 ) << 8 | uVar5 << 0x18 ) ) || ( 0xffff < uVar7 ) ) || ( ( (long)uVar7 < (long)( ulong ) * (ushort*)( this + 0xe2 ) || ( *(ulong*)( this + 0xb0 ) < 4 ) ) )) goto LAB_0010038e;
   ...
   LAB_001003b8:graphite2::Face::Table::release();
   LAB_00100280:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* graphite2::GlyphCache::Loader::read_glyph(unsigned short, graphite2::GlyphFace&, int*) const */GlyphFace * __thiscall
graphite2::GlyphCache::Loader::read_glyph
   ...
   if (param_1 < *(ushort*)( this + 0xe2 )) {
      if (*(long*)( this + 0x68 ) == 0) {
         ...
         uVar5 = graphite2::TtfUtil::LocaLookup(param_1, *(void**)( this + 0x88 ), *(ulong*)( this + 0x90 ), *(void**)( this + 8 ));
         pvVar6 = (void*)graphite2::TtfUtil::GlyfLookup(*(void**)( this + 0x68 ), uVar5, *(ulong*)( this + 0x70 ));
         if (( pvVar6 == (void*)0x0 ) || ( cVar4 = graphite2::TtfUtil::GlyfBox(pvVar6, &local_50, &local_4c, &local_48, (int*)&local_44) ),cVar4 == '\0') {
            fVar21 = 0.0;
            fVar22 = 0.0;
            fVar23 = 0.0;
            fVar25 = 0.0;
      ...
      cVar4 = graphite2::TtfUtil::HorMetrics(param_1, *(void**)( this + 0x48 ), *(ulong*)( this + 0x50 ), *(void**)( this + 0x28 ), &local_48, &local_44);
   ...
   if (this[0xe0] == (Loader)0x0) {
      ...
      if (uVar5 <= *(ulong*)( this + 0xd0 )) {
         ...
         uVar12 = *puVar7;
         uVar3 = puVar7[1];
         uVar10 = ( ulong )(uVar12 >> 0x18 | ( uVar12 & 0xff0000 ) >> 8 | ( uVar12 & 0xff00 ) << 8 | uVar12 << 0x18);
         uVar5 = ( ulong )(uVar3 >> 0x18 | ( uVar3 & 0xff0000 ) >> 8 | ( uVar3 & 0xff00 ) << 8 | uVar3 << 0x18);
         LAB_00100709:uVar17 = *(ulong*)( this + 0xb0 );
 ...
 while ( puVar13 < puVar1 );
                        ...
                        LAB_001009b0:*(undefined8**)( param_2 + 0x18 ) = &sparse::empty_chunk;
                     }

                     LAB_001009bb:uVar5 = graphite2::sparse::capacity();
                  ...
                  LAB_001008a1:if (( ( 5 < uVar5 - uVar10 ) && ( uVar5 - uVar10 <= ( ulong )((long)(int)( ( uint ) * (ushort*)( this + 0xe6 ) + ( uint ) * (ushort*)( this + 0xe6 ) * 2 ) * 2) ) ) && ( uVar10 <= uVar17 - 4 )) {
                     puVar20 = (ushort*)( uVar10 + (long)puVar7 );
                     puVar1 = (ushort*)( (long)puVar7 + ( uVar5 - 1 ) );
                     *(undefined8*)param_2 = local_68;
                     *(undefined8*)( param_2 + 8 ) = uVar24;
                           ...
                           if (puVar9 != (ulong*)0x0) {
                              *(short*)( (long)puVar9 + 6 ) = (short)uVar5;
                              ...
                              do {
                                 ...
                                 puVar19 = puVar18;
                                 if (uVar11 != 0) {
                                    uVar12 = ( uint )(ushort)(*puVar20 << 8 | *puVar20 >> 8) + (int)uVar10 & 0xffff;
                                    puVar19 = puVar9 + (ulong)uVar12 / 0x30;
                                    if (puVar19 != puVar18) {
                                       *(short*)( (long)puVar19 + 6 ) = (short)( (long)puVar14 - (long)puVar9 >> 1 );
                                    }
 ...
 while ( puVar13 < puVar1 );
   ...
   LAB_001009a0:param_2 = (GlyphFace*)0x0;
   LAB_0010062d:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }

   return param_2;
   LAB_00100990:*(undefined2*)( param_2 + 0x20 ) = 0;
   goto LAB_001009a0;
}
/* readbox(graphite2::Rect&, unsigned char, unsigned char, unsigned char, unsigned char) */undefined1[16];readbox(Rect *param_1, uchar param_2, uchar param_3, uchar param_4, uchar param_5) {
   float fVar1;
   float fVar2;
...
/* graphite2::GlyphCache::Loader::read_box(unsigned short, graphite2::GlyphBox*,
   graphite2::GlyphFace const&) const */GlyphBox * __thiscall
graphite2::GlyphCache::Loader::read_box
   ...
   if (param_1 < *(ushort*)( this + 0xe4 )) {
      if (this[0xe0] == (Loader)0x0) {
         ...
         uVar7 = *puVar4;
         uVar13 = puVar4[1];
         uVar11 = ( ulong )(uVar7 >> 0x18 | ( uVar7 & 0xff0000 ) >> 8 | ( uVar7 & 0xff00 ) << 8 | uVar7 << 0x18);
         uVar14 = ( ulong )(uVar13 >> 0x18 | ( uVar13 & 0xff0000 ) >> 8 | ( uVar13 & 0xff00 ) << 8 | uVar13 << 0x18);
      }
      ...
      if (( uVar14 <= *(ulong*)( this + 0xb0 ) ) && ( uVar11 + 6 < uVar14 )) {
         ...
         local_48 = fVar18;
         fStack_40 = fVar19;
         uVar17 = readbox((Rect*)&local_48, (uchar)puVar12[1], (uchar)puVar12[2], *(uchar*)( (long)puVar12 + 3 ), *(uchar*)( (long)puVar12 + 5 ));
 ...
 while ( uVar7 != uVar13 );
   ...
   pGVar9 = (GlyphBox*)0x0;
   LAB_00100e3a:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return pGVar9;
   }
...
/* graphite2::GlyphCache::glyph(unsigned short) const */Loader * __thiscall graphite2::GlyphCache::glyph(GlyphCache *this,ushort param_1){
   Loader *this_00;
   long *plVar1;
   GlyphFace *__ptr;
   Loader *this_01;
      ...
      *plVar1 = (long)this_01;
      if (this_01 != (Loader*)0x0) {
         if (*(long*)( this + 0x20 ) != 0) {
            ...
            *puVar4 = __ptr_00;
            lVar2 = Loader::read_box(this_00, param_1, __ptr_00, *(GlyphFace**)( *(long*)( this + 0x18 ) + uVar3 * 8 ));
            if (lVar2 == 0) {
               free(__ptr_00);
               *puVar4 = 0;
               this_01 = (Loader*)*plVar1;
   ...
   this_01 = (Loader*)*plVar1;
   LAB_00100ec3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return this_01;
   }
...
/* graphite2::GlyphCache::GlyphCache(graphite2::Face const&, unsigned int) */void graphite2::GlyphCache::GlyphCache(GlyphCache *this, Face *param_1, uint param_2) {
   GlyphFace *pGVar1;
   Loader LVar2;
   ushort uVar3;
   long *plVar4;
   ...
   *(Loader**)( this + 0x10 ) = pLVar6;
   if (( ( ( pvVar7 == (void*)0x0 ) || ( *(long*)( pLVar6 + 0x28 ) == 0 ) ) || ( *(long*)( pLVar6 + 0x48 ) == 0 ) ) || ( ( *(long*)( pLVar6 + 0x68 ) != 0 ) != ( *(long*)( pLVar6 + 0x88 ) != 0 ) )) {
      LVar2 = pLVar6[0xe1];
      *(undefined8*)( this + 0x18 ) = 0;
      if (LVar2 == (Loader)0x0) {
         LAB_001010f6:*(undefined8*)( this + 0x20 ) = 0;
      ...
      *(undefined4*)( this + 0x28 ) = 0;
      ...
      if (uVar3 == 0) {
         ...
         *(undefined8*)( this + 0x20 ) = 0;
         LAB_001010b9:puVar16 = *(undefined8**)( this + 0x18 );
         goto LAB_0010144d;
      }
      ...
      *puVar16 = uVar11;
      ...
      while (lVar13 != 0) {
         if (*(ushort*)( this + 0x28 ) == uVar3) {
            if (( local_44 < 1 ) || ( puVar16 = *(undefined8**)( this + 0x20 ) ),puVar16 == (undefined8*)0x0) goto LAB_00101320;
         ...
         lVar13 = Loader::read_glyph(*(Loader**)( this + 0x10 ), uVar3, pGVar1 + (ulong)uVar3 * 0x28, &local_44);
         plVar4 = *(long**)( this + 0x18 );
         plVar4[uVar3] = lVar13;
         uVar3 = uVar3 + 1;
      }
;
   ...
   goto LAB_0010138a;
   LAB_0010130c:free(__ptr_00);
   *puVar16 = 0;
   LAB_00101320:pLVar6 = *(Loader**)( this + 0x10 );
   goto LAB_00101324;
   while (uVar14 = uVar14 + 1,uVar3 != uVar14) {
      LAB_001012f1:puVar16[uVar14] = pGVar12;
      pGVar12 = (GlyphBox*)Loader::read_box(pLVar6, (ushort)uVar14, pGVar12, *(GlyphFace**)( lVar13 + uVar14 * 8 ));
      if (pGVar12 == (GlyphBox*)0x0) goto LAB_0010130c;
   }
;
   LAB_00101324:if (pLVar6 != (Loader*)0x0) {
      for (int i = 0; i < 7; i++) {
         graphite2::Face::Table::release();
      }
   ...
   *(undefined8*)( this + 0x10 ) = 0;
   puVar16 = *(undefined8**)( this + 0x18 );
   LAB_0010138a:if (( puVar16 != (undefined8*)0x0 ) && ( lVar13 = lVar13 == 0 )) {
      free(*(void**)( this + 0x18 ));
      *(undefined8*)( this + 0x18 ) = 0;
   ...
   LAB_0010110d:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }

   ...
   if (pOVar4 != pOVar3) {
      *(Object**)( this + 0x408 ) = pOVar4;
      if (pOVar4 == (Object*)0x0) {
         ...
         joined_r0x0010189d:if (( cVar2 != '\0' ) && ( cVar2 = predelete_handler(pOVar3) ),cVar2 != '\0') {
...
/* AudioStreamPlaybackWAV::_initialize_classv() */void AudioStreamPlaybackWAV::_initialize_classv(void) {
 ...
 while ( pVVar2 != local_88 );
   ...
   const* const, unsigned int const) */
      String *vformat<unsigned_long,char_const*,unsigned_int>(String *param_1, ulong param_2, char *param_3, uint param_4) {
         Variant *pVVar1;
 ...
 while ( lVar7 != lVar6 );
      ...
      GetTypeInfo<AudioStreamWAV::Format,void> * GetTypeInfo<AudioStreamWAV::Format,void>::get_class_info(GetTypeInfo<AudioStreamWAV::Format,void> * this);
      {
         long *plVar1;
         long lVar2;
         long in_FS_OFFSET;
      ...
      GetTypeInfo<AudioStreamWAV::LoopMode,void> * GetTypeInfo<AudioStreamWAV::LoopMode,void>::get_class_info(GetTypeInfo<AudioStreamWAV::LoopMode,void> * this);
      {
         long *plVar1;
         long lVar2;
         long in_FS_OFFSET;
   ...
   const**, int, Callable::CallError&) const */
      Object *MethodBindTRS<Ref<AudioStreamWAV>,String_const&,Dictionary_const&>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
         Variant *pVVar1;
         long lVar2;
         code *pcVar3;
         undefined8 uVar4;

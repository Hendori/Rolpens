...
void png_set_add_alpha(long param_1, undefined2 param_2, int param_3) {
      ...
      if (*(char*)( param_1 + 0x267 ) == '\0') {
         ...
         *(undefined1*)( param_1 + 0x26c ) = 2;
         ...
         if (*(char*)( param_1 + 0x267 ) != '\x02') {
            ...
            LAB_00100237:png_app_error(param_1, pcVar3);
   ...
   *(uint*)( param_1 + 0x130 ) = uVar1;
   LAB_001001d6:*(uint*)( param_1 + 0x134 ) = uVar2 | 0x1000000;
   return;
}
...
void png_do_invert(long param_1, byte *param_2) {
 ...
 else if (( *(short*)( param_1 + 0x10 ) == 0x1004 ) && ( uVar2 = uVar2 != 0 )) {
      uVar3 = 0;
      do {
...
void png_do_swap(int *param_1, undefined2 *param_2) {
   ...
   undefined2 *puVar2;
   undefined2 *puVar3;
   if (( *(char*)( (long)param_1 + 0x11 ) == '\x10' ) && ( uVar1 = ( uint ) * (byte*)( (long)param_1 + 0x12 ) * *param_1 ),uVar1 != 0) {
      puVar2 = param_2;
      do {
         puVar3 = puVar2 + 1;
...
void png_do_check_palette_indexes(long param_1, uint *param_2) {
   ...
   if (( (int)( uint ) * (ushort*)( param_1 + 600 ) < 1 << ( bVar1 & 0x1f ) ) && ( *(ushort*)( param_1 + 600 ) != 0 )) {
...
void png_set_user_transform_info(long param_1, undefined8 param_2, undefined1 param_3, undefined1 param_4) {
   if (param_1 != 0) {

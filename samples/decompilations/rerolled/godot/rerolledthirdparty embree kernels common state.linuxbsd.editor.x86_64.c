/* std::__cxx11::string::TEMPNAMEPLACEHOLDERVALUE(std::__cxx11::string&&) [clone .isra.0] */void std::__cxx11::string::operator =(string *this, string *param_1) {
   string *psVar1;
   undefined8 uVar2;
   uint uVar3;
   string *psVar4;
   ...
   if (psVar6 == this + 0x10) {
      if (psVar1 != psVar4) {
         ...
         *(undefined8*)( this + 0x10 ) = *(undefined8*)( param_1 + 0x10 );
         LAB_00100073:*(string**)param_1 = psVar1;
   ...
   if (this == param_1) {
      LAB_00100045:*(undefined8*)( param_1 + 8 ) = 0;
      *psVar4 = (string)0x0;
      return;
   }
      ...
      if (uVar9 == 1) {
         *psVar6 = *psVar4;
         ...
         if (uVar3 < 8) {
            ...
            *(undefined8*)( psVar6 + ( ( uVar9 & 0xffffffff ) - 8 ) ) = *(undefined8*)( psVar4 + ( ( uVar9 & 0xffffffff ) - 8 ) );
            ...
            if (7 < uVar3) {
               ...
               do {
                  uVar9 = (ulong)uVar8;
                  uVar8 = uVar8 + 8;
                  *(undefined8*)( ( ( ulong )(psVar6 + 8) & 0xfffffffffffffff8 ) + uVar9 ) = *(undefined8*)( psVar4 + ( uVar9 - lVar7 ) );
               }
 while ( uVar8 < uVar3 );
            }
   ...
   LAB_001000d8:*(ulong*)( this + 8 ) = uVar9;
...
/* embree::State::ErrorHandler::~ErrorHandler() */void embree::State::ErrorHandler::~ErrorHandler(ErrorHandler *this) {
   void *pvVar1;
   long lVar2;
   long lVar3;
   ulong uVar4;
...
/* std::__cxx11::string::string<std::allocator<char> >(char const*, std::allocator<char> const&)
   [clone .constprop.0] */char *__thiscallstd::__cxx11::string::string<std::allocator<char>>(string *this, char *param_1, allocator *param_2) {
   ulong *__src;
   size_t __n;
   string *__dest;
   char *__dest_00;
   ...
   *(string**)this = __dest;
   if (param_1 != (char*)0x0) {
      ...
      __dest = *(string**)this;
      LAB_00100323:*(size_t*)( this + 8 ) = local_38;
   ...
   if (__n_00 < 0x10) {
      ...
      LAB_001004fb:memcpy(puStack_90, param_1, __n_00);
      __n_01 = uStack_98;
   }
   ...
   *(char**)( pcVar1 + 8 ) = __dest_00;
   ...
   LAB_00100446:*(ulong*)( pcVar1 + 0x10 ) = uStack_98;
...
/* embree::Token::Id(std::__cxx11::string) [clone .isra.0] */undefined4 *embree::Token::Id(undefined4 *param_1, undefined1 *param_2, ulong param_3) {
   ulong *__src;
   undefined4 *__dest;
   long in_FS_OFFSET;
   ulong local_60;
   ...
   if (param_3 < 0x10) {
      ...
      local_48[0] = local_60;
      LAB_001004fb:memcpy(local_58, param_2, param_3);
      param_3 = local_60;
   }
   ...
   *(undefined4**)( param_1 + 2 ) = __dest;
   ...
   LAB_00100446:*(ulong*)( param_1 + 4 ) = local_60;
...
/* embree::State::~State() */void embree::State::~State(State *this) {
...
/* embree::State::State() */void embree::State::State(State *this) {
   ...
   *(undefined***)this = &PTR__State_0010f510;
   for (int i = 0; i < 5; i++) {
      *(State**)( this + ( 32*i + 16 ) ) = this + ( 32*i + 32 );
   }

   *(undefined8*)( this + 8 ) = 0;
   for (int i = 0; i < 5; i++) {
      *(undefined8*)( this + ( 32*i + 24 ) ) = 0;
      this[( 32*i + 32 )] = (State)0;
   }

   for (int i = 0; i < 8; i++) {
      *(State**)( this + ( 32*i + 176 ) ) = this + ( 32*i + 192 );
   }

   for (int i = 0; i < 8; i++) {
      *(undefined8*)( this + ( 32*i + 184 ) ) = 0;
      this[( 32*i + 192 )] = (State)0;
   }

   for (int i = 0; i < 9; i++) {
      *(State**)( this + ( 32*i + 432 ) ) = this + ( 32*i + 448 );
   }

   *(undefined8*)( this + 0x1b8 ) = 0;
   for (int i = 0; i < 8; i++) {
      this[( 32*i + 448 )] = (State)0;
      *(undefined8*)( this + ( 32*i + 472 ) ) = 0;
   }
   ...
   *(undefined8*)( this + 0x3c8 ) = 0;
   ...
   for (int i = 0; i < 3; i++) {
      *(State**)( this + ( 32*i + 992 ) ) = this + ( 32*i + 1008 );
   }

   for (int i = 0; i < 3; i++) {
      *(undefined8*)( this + ( 32*i + 1000 ) ) = 0;
      this[( 32*i + 1008 )] = (State)0;
   }
   ...
   *(undefined8*)( this + 0x518 ) = 0;
   ...
   for (int i = 0; i < 26; i++) {
      std::__cxx11::string::_M_replace(( ulong )(this + ( 32*i + 16 )), 0, *(char**)( this + ( 32*i + 24 ) ), 1092252);
   }
   ...
   *(undefined8*)( this + 0x468 ) = 0x8000000;
   for (int i = 0; i < 6; i++) {
      std::__cxx11::string::_M_replace(( ulong )(this + ( 32*i + 928 )), 0, *(char**)( this + ( 32*i + 936 ) ), 1092252);
   }
   ...
   *(undefined4*)( this + 0x4f8 ) = 0xffffffff;
   for (int i = 0; i < 4; i++) {
      *(undefined8*)( this + ( 8*i + 1320 ) ) = 0;
   }

   return;
}
/* embree::State::hasISA(int) */undefined4 embree::State::hasISA(State *this, int param_1) {
   return CONCAT31(( int3 )(( *(uint*)( this + 0x4cc ) & param_1 ) >> 8), ( *(uint*)( this + 0x4cc ) & param_1 ) == param_1);
}
/* embree::State::checkISASupport() */undefined4 embree::State::checkISASupport(State *this) {
   uint uVar1;
   uVar1 = embree::getCPUFeatures();
   return CONCAT31(( int3 )(~uVar1 >> 8), ( ~uVar1 & *(uint*)( this + 0x4cc ) ) == 0);
}
/* embree::State::verify() */void embree::State::verify(void) {
   return;
}
/* embree::string_to_cpufeatures(std::__cxx11::string const&) */undefined8 embree::string_to_cpufeatures(string *param_1) {
   long lVar1;
   int *piVar2;
   short *psVar3;
   undefined8 uVar4;
   ...
   if (lVar1 == 3) {
      ...
      if (lVar1 == 4) {
         piVar2 = *(int**)param_1;
         uVar4 = 0x2000003;
         if (( ( *piVar2 != 0x32657373 ) && ( uVar4 = 0x2000007 * piVar2 != 0x33657373 ) ) && ( uVar4 = 0x60003ff * piVar2 != 0x69787661 )) {
            uVar4 = 0x6007fff;
...
/* embree::State::verbosity(unsigned long) */bool embree::State::verbosity(State *this, ulong param_1) {
   return param_1 <= *(ulong*)( this + 0x4a8 );
}
/* WARNING: Removing unreachable block (ram,0x001044d8) *//* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* embree::State::print() */void embree::State::print(State *this) {
   ...
   if ((ostream*)pcVar16 != (ostream*)0x0) {
      ...
      std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, "  build threads      = ", 0x17);
      ...
      if ((ostream*)unaff_R13 != (ostream*)0x0) {
         ...
         std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, "  build user threads = ", 0x17);
         ...
         if ((ostream*)unaff_R13 != (ostream*)0x0) {
            ...
            std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, "  start_threads      = ", 0x17);
            ...
            if ((ostream*)unaff_R13 != (ostream*)0x0) {
               ...
               std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, "  affinity           = ", 0x17);
               ...
               if ((ostream*)unaff_R13 != (ostream*)0x0) {
                  ...
                  std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, "  frequency_level    = ", 0x17);
                  ...
                  std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, "  hugepages          = ", 0x17);
                  lVar18 = 8;
                  pcVar21 = "disabled";
                  ...
                  if ((ostream*)pcVar16 != (ostream*)0x0) {
                     ...
                     std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, "  verbosity          = ", 0x17);
                     ...
                     if ((ostream*)unaff_R13 != (ostream*)0x0) {
                        ...
                        std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, "  cache_size         = ", 0x17);
                        poStack_50 = (ostream*)0x101b25;
                        pcVar16 = (char*)std::ostream::_M_insert<double>((double)*(ulong*)( this + 0x468 ) * __LC28);
                        pcVar21 = &_LC29;
                        ...
                        if ((ostream*)unaff_R13 != (ostream*)0x0) {
                           ...
                           std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, "  max_spatial_split_replications = ", 0x23);
                           poVar22 = (ostream*)&std::cout;
                           poStack_50 = (ostream*)0x101b9d;
                           pcVar16 = (char*)std::ostream::_M_insert<double>((double)*(float*)( this + 0x460 ));
                           unaff_R13 = *(char**)( (ostream*)pcVar16 + *(long*)( *(long*)pcVar16 + -0x18 ) + 0xf0 );
                           if ((ostream*)unaff_R13 != (ostream*)0x0) {
                              if (( (ostream*)unaff_R13 )[0x38] == (ostream)0x0) {
                              ...
                              std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, "triangles:", 10);
                              pcVar16 = *(char**)( std::__basic_file<char>::is_open + *(long*)( std::cout + -0x18 ) );
                              if ((ostream*)pcVar16 != (ostream*)0x0) {
                                 if (( (ostream*)pcVar16 )[0x38] == (ostream)0x0) {
                                 ...
                                 std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, "  accel              = ", 0x17);
                                 pcVar21 = *(char**)( this + 0x10 );
                                 poVar22 = (ostream*)&std::cout;
                                 poStack_50 = (ostream*)0x101c51;
                                 poVar17 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, pcVar21, *(long*)( this + 0x18 ));
                                 ...
                                 if ((ostream*)unaff_R14 != (ostream*)0x0) {
                                    ...
                                    std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, "  builder            = ", 0x17);
                                    pcVar21 = *(char**)( this + 0x30 );
                                    poVar22 = (ostream*)&std::cout;
                                    poStack_50 = (ostream*)0x101cb3;
                                    poVar17 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, pcVar21, *(long*)( this + 0x38 ));
                                    unaff_R15 = *(ostream**)( poVar17 + *(long*)( *(long*)poVar17 + -0x18 ) + 0xf0 );
                                    ...
                                    if (unaff_R15 != (ostream*)0x0) {
                                       ...
                                       std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, "  traverser          = ", 0x17);
                                       pcVar21 = *(char**)( this + 0x50 );
                                       poVar22 = (ostream*)&std::cout;
                                       poStack_50 = (ostream*)0x101d15;
                                       poVar17 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, pcVar21, *(long*)( this + 0x58 ));
                                       unaff_R15 = *(ostream**)( poVar17 + *(long*)( *(long*)poVar17 + -0x18 ) + 0xf0 );
                                       if (unaff_R15 != (ostream*)0x0) {
                                          if (unaff_R15[0x38] == (ostream)0x0) {
                                          ...
                                          std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, "motion blur triangles:", 0x16);
                                          unaff_R15 = *(ostream**)( std::__basic_file<char>::is_open + *(long*)( std::cout + -0x18 ) );
                                          if (unaff_R15 != (ostream*)0x0) {
                                             if (unaff_R15[0x38] == (ostream)0x0) {
                                             ...
                                             unaff_R15 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, pcVar21, *(long*)( this + 0x78 ));
                                             poVar22 = *(ostream**)( unaff_R15 + *(long*)( *(long*)unaff_R15 + -0x18 ) + 0xf0 );
                                             if (poVar22 != (ostream*)0x0) {
                                                if (poVar22[0x38] == (ostream)0x0) {
                                                   poStack_50 = (ostream*)0x102fb2;
                                                   local_40 = poVar22;
                                                   std::ctype<char>::_M_widen_init();
                                                   if (*(code**)( *(long*)local_40 + 0x30 ) != std::ctype<char>::do_widen) {
                                                ...
                                                poVar17 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, pcVar21, *(long*)( this + 0x98 ));
                                                unaff_R15 = *(ostream**)( poVar17 + *(long*)( *(long*)poVar17 + -0x18 ) + 0xf0 );
                                                if (unaff_R15 != (ostream*)0x0) {
                                                   if (unaff_R15[0x38] == (ostream)0x0) {
                                                   ...
                                                   poVar17 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, pcVar21, *(long*)( this + 0xb8 ));
                                                   unaff_R15 = *(ostream**)( poVar17 + *(long*)( *(long*)poVar17 + -0x18 ) + 0xf0 );
                                                   if (unaff_R15 != (ostream*)0x0) {
                                                      if (unaff_R15[0x38] == (ostream)0x0) {
                                                      ...
                                                      std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, "quads:", 6);
                                                      unaff_R15 = *(ostream**)( std::__basic_file<char>::is_open + *(long*)( std::cout + -0x18 ) );
                                                      if (unaff_R15 != (ostream*)0x0) {
                                                         if (unaff_R15[0x38] == (ostream)0x0) {
                                                         ...
                                                         poVar17 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, pcVar21, *(long*)( this + 0xd8 ));
                                                         unaff_R15 = *(ostream**)( poVar17 + *(long*)( *(long*)poVar17 + -0x18 ) + 0xf0 );
                                                         if (unaff_R15 != (ostream*)0x0) {
                                                            if (unaff_R15[0x38] == (ostream)0x0) {
                                                            ...
                                                            unaff_R15 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, pcVar21, *(long*)( this + 0xf8 ));
                                                            poVar22 = *(ostream**)( unaff_R15 + *(long*)( *(long*)unaff_R15 + -0x18 ) + 0xf0 );
                                                            if (poVar22 != (ostream*)0x0) {
                                                               if (poVar22[0x38] == (ostream)0x0) {
                                                               ...
                                                               poVar17 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, pcVar21, *(long*)( this + 0x118 ));
                                                               unaff_R15 = *(ostream**)( poVar17 + *(long*)( *(long*)poVar17 + -0x18 ) + 0xf0 );
                                                               if (unaff_R15 != (ostream*)0x0) {
                                                                  if (unaff_R15[0x38] == (ostream)0x0) {
                                                                  ...
                                                                  std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, "motion blur quads:", 0x12);
                                                                  unaff_R15 = *(ostream**)( std::__basic_file<char>::is_open + *(long*)( std::cout + -0x18 ) );
                                                                  if (unaff_R15 != (ostream*)0x0) {
                                                                     if (unaff_R15[0x38] == (ostream)0x0) {
                                                                     ...
                                                                     poVar17 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, pcVar21, *(long*)( this + 0x138 ));
                                                                     unaff_R15 = *(ostream**)( poVar17 + *(long*)( *(long*)poVar17 + -0x18 ) + 0xf0 );
                                                                     if (unaff_R15 != (ostream*)0x0) {
                                                                        if (unaff_R15[0x38] == (ostream)0x0) {
                                                                        ...
                                                                        poVar17 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, pcVar21, *(long*)( this + 0x158 ));
                                                                        unaff_R15 = *(ostream**)( poVar17 + *(long*)( *(long*)poVar17 + -0x18 ) + 0xf0 );
                                                                        if (unaff_R15 != (ostream*)0x0) {
                                                                           if (unaff_R15[0x38] == (ostream)0x0) {
                                                                           ...
                                                                           unaff_R15 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, pcVar21, *(long*)( this + 0x178 ));
                                                                           poVar22 = *(ostream**)( unaff_R15 + *(long*)( *(long*)unaff_R15 + -0x18 ) + 0xf0 );
                                                                           if (poVar22 != (ostream*)0x0) {
                                                                              if (poVar22[0x38] == (ostream)0x0) {
                                                                              ...
                                                                              std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, "line segments:", 0xe);
                                                                              unaff_R15 = *(ostream**)( std::__basic_file<char>::is_open + *(long*)( std::cout + -0x18 ) );
                                                                              if (unaff_R15 != (ostream*)0x0) {
                                                                                 if (unaff_R15[0x38] == (ostream)0x0) {
                                                                                 ...
                                                                                 poVar17 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, pcVar21, *(long*)( this + 0x198 ));
                                                                                 unaff_R15 = *(ostream**)( poVar17 + *(long*)( *(long*)poVar17 + -0x18 ) + 0xf0 );
                                                                                 if (unaff_R15 != (ostream*)0x0) {
                                                                                    if (unaff_R15[0x38] == (ostream)0x0) {
                                                                                    ...
                                                                                    poVar17 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, pcVar21, *(long*)( this + 0x1b8 ));
                                                                                    unaff_R15 = *(ostream**)( poVar17 + *(long*)( *(long*)poVar17 + -0x18 ) + 0xf0 );
                                                                                    if (unaff_R15 != (ostream*)0x0) {
                                                                                       if (unaff_R15[0x38] == (ostream)0x0) {
                                                                                       ...
                                                                                       poVar17 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, pcVar21, *(long*)( this + 0x1d8 ));
                                                                                       unaff_R15 = *(ostream**)( poVar17 + *(long*)( *(long*)poVar17 + -0x18 ) + 0xf0 );
                                                                                       if (unaff_R15 != (ostream*)0x0) {
                                                                                          if (unaff_R15[0x38] == (ostream)0x0) {
                                                                                          ...
                                                                                          std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, "motion blur line segments:", 0x1a);
                                                                                          unaff_R15 = *(ostream**)( std::__basic_file<char>::is_open + *(long*)( std::cout + -0x18 ) );
                                                                                          if (unaff_R15 != (ostream*)0x0) {
                                                                                             if (unaff_R15[0x38] == (ostream)0x0) {
                                                                                             ...
                                                                                             unaff_R15 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, pcVar21, *(long*)( this + 0x1f8 ));
                                                                                             poVar22 = *(ostream**)( unaff_R15 + *(long*)( *(long*)unaff_R15 + -0x18 ) + 0xf0 );
                                                                                             if (poVar22 != (ostream*)0x0) {
                                                                                                if (poVar22[0x38] == (ostream)0x0) {
                                                                                                ...
                                                                                                poVar17 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, pcVar21, *(long*)( this + 0x218 ));
                                                                                                unaff_R15 = *(ostream**)( poVar17 + *(long*)( *(long*)poVar17 + -0x18 ) + 0xf0 );
                                                                                                if (unaff_R15 != (ostream*)0x0) {
                                                                                                   if (unaff_R15[0x38] == (ostream)0x0) {
                                                                                                   ...
                                                                                                   poVar17 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, pcVar21, *(long*)( this + 0x238 ));
                                                                                                   unaff_R15 = *(ostream**)( poVar17 + *(long*)( *(long*)poVar17 + -0x18 ) + 0xf0 );
                                                                                                   if (unaff_R15 != (ostream*)0x0) {
                                                                                                      if (unaff_R15[0x38] == (ostream)0x0) {
                                                                                                      ...
                                                                                                      std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, "hair:", 5);
                                                                                                      unaff_R15 = *(ostream**)( std::__basic_file<char>::is_open + *(long*)( std::cout + -0x18 ) );
                                                                                                      if (unaff_R15 != (ostream*)0x0) {
                                                                                                         if (unaff_R15[0x38] == (ostream)0x0) {
                                                                                                         ...
                                                                                                         poVar17 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, pcVar21, *(long*)( this + 600 ));
                                                                                                         unaff_R15 = *(ostream**)( poVar17 + *(long*)( *(long*)poVar17 + -0x18 ) + 0xf0 );
                                                                                                         if (unaff_R15 != (ostream*)0x0) {
                                                                                                            if (unaff_R15[0x38] == (ostream)0x0) {
                                                                                                            ...
                                                                                                            unaff_R15 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, pcVar21, *(long*)( this + 0x278 ));
                                                                                                            poVar22 = *(ostream**)( unaff_R15 + *(long*)( *(long*)unaff_R15 + -0x18 ) + 0xf0 );
                                                                                                            if (poVar22 != (ostream*)0x0) {
                                                                                                               if (poVar22[0x38] == (ostream)0x0) {
                                                                                                               ...
                                                                                                               poVar17 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, pcVar21, *(long*)( this + 0x298 ));
                                                                                                               unaff_R15 = *(ostream**)( poVar17 + *(long*)( *(long*)poVar17 + -0x18 ) + 0xf0 );
                                                                                                               if (unaff_R15 != (ostream*)0x0) {
                                                                                                                  if (unaff_R15[0x38] == (ostream)0x0) {
                                                                                                                  ...
                                                                                                                  std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, "motion blur hair:", 0x11);
                                                                                                                  unaff_R15 = *(ostream**)( std::__basic_file<char>::is_open + *(long*)( std::cout + -0x18 ) );
                                                                                                                  if (unaff_R15 != (ostream*)0x0) {
                                                                                                                     if (unaff_R15[0x38] == (ostream)0x0) {
                                                                                                                     ...
                                                                                                                     poVar17 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, pcVar21, *(long*)( this + 0x2b8 ));
                                                                                                                     unaff_R15 = *(ostream**)( poVar17 + *(long*)( *(long*)poVar17 + -0x18 ) + 0xf0 );
                                                                                                                     if (unaff_R15 != (ostream*)0x0) {
                                                                                                                        if (unaff_R15[0x38] == (ostream)0x0) {
                                                                                                                        ...
                                                                                                                        poVar17 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, pcVar21, *(long*)( this + 0x2d8 ));
                                                                                                                        unaff_R15 = *(ostream**)( poVar17 + *(long*)( *(long*)poVar17 + -0x18 ) + 0xf0 );
                                                                                                                        if (unaff_R15 != (ostream*)0x0) {
                                                                                                                           if (unaff_R15[0x38] == (ostream)0x0) {
                                                                                                                           ...
                                                                                                                           unaff_R14 = (char*)std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, pcVar21, *(long*)( this + 0x2f8 ));
                                                                                                                           unaff_R15 = *(ostream**)( (ostream*)unaff_R14 + *(long*)( *(long*)unaff_R14 + -0x18 ) + 0xf0 );
                                                                                                                           if (unaff_R15 != (ostream*)0x0) {
                                                                                                                              if (unaff_R15[0x38] == (ostream)0x0) {
                                                                                                                              ...
                                                                                                                              std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, "subdivision surfaces:", 0x15);
                                                                                                                              unaff_R14 = *(char**)( std::__basic_file<char>::is_open + *(long*)( std::cout + -0x18 ) );
                                                                                                                              if ((ostream*)unaff_R14 != (ostream*)0x0) {
                                                                                                                                 if (( (ostream*)unaff_R14 )[0x38] == (ostream)0x0) {
                                                                                                                                 ...
                                                                                                                                 unaff_R15 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, pcVar21, *(long*)( this + 0x3a8 ));
                                                                                                                                 unaff_R14 = *(char**)( unaff_R15 + *(long*)( *(long*)unaff_R15 + -0x18 ) + 0xf0 );
                                                                                                                                 if ((ostream*)unaff_R14 != (ostream*)0x0) {
                                                                                                                                    if (( (ostream*)unaff_R14 )[0x38] == (ostream)0x0) {
                                                                                                                                    ...
                                                                                                                                    std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, "grids:", 6);
                                                                                                                                    unaff_R14 = *(char**)( std::__basic_file<char>::is_open + *(long*)( std::cout + -0x18 ) );
                                                                                                                                    if ((ostream*)unaff_R14 != (ostream*)0x0) {
                                                                                                                                       if (( (ostream*)unaff_R14 )[0x38] == (ostream)0x0) {
                                                                                                                                       ...
                                                                                                                                       unaff_R15 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, pcVar21, *(long*)( this + 1000 ));
                                                                                                                                       unaff_R14 = *(char**)( unaff_R15 + *(long*)( *(long*)unaff_R15 + -0x18 ) + 0xf0 );
                                                                                                                                       if ((ostream*)unaff_R14 != (ostream*)0x0) {
                                                                                                                                          if (( (ostream*)unaff_R14 )[0x38] == (ostream)0x0) {
                                                                                                                                          ...
                                                                                                                                          unaff_R14 = (char*)std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, pcVar21, *(long*)( this + 0x408 ));
                                                                                                                                          unaff_R15 = *(ostream**)( (ostream*)unaff_R14 + *(long*)( *(long*)unaff_R14 + -0x18 ) + 0xf0 );
                                                                                                                                          if (unaff_R15 != (ostream*)0x0) {
                                                                                                                                             if (unaff_R15[0x38] == (ostream)0x0) {
                                                                                                                                             ...
                                                                                                                                             std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, "motion blur grids:", 0x12);
                                                                                                                                             unaff_R14 = *(char**)( std::__basic_file<char>::is_open + *(long*)( std::cout + -0x18 ) );
                                                                                                                                             if ((ostream*)unaff_R14 != (ostream*)0x0) {
                                                                                                                                                if (( (ostream*)unaff_R14 )[0x38] == (ostream)0x0) {
                                                                                                                                                ...
                                                                                                                                                pcVar16 = (char*)std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, pcVar21, *(long*)( this + 0x428 ));
                                                                                                                                                unaff_R14 = *(char**)( (ostream*)pcVar16 + *(long*)( *(long*)pcVar16 + -0x18 ) + 0xf0 );
                                                                                                                                                if ((ostream*)unaff_R14 != (ostream*)0x0) {
                                                                                                                                                   if (( (ostream*)unaff_R14 )[0x38] == (ostream)0x0) {
                                                                                                                                                   ...
                                                                                                                                                   pcVar16 = (char*)std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, pcVar21, *(long*)( this + 0x448 ));
                                                                                                                                                   unaff_R13 = *(char**)( (ostream*)pcVar16 + *(long*)( *(long*)pcVar16 + -0x18 ) + 0xf0 );
                                                                                                                                                   if ((ostream*)unaff_R13 != (ostream*)0x0) {
                                                                                                                                                      if (( (ostream*)unaff_R13 )[0x38] == (ostream)0x0) {
                                                                                                                                                      ...
                                                                                                                                                      std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, "object_accel:", 0xd);
                                                                                                                                                      pcVar16 = *(char**)( std::__basic_file<char>::is_open + *(long*)( std::cout + -0x18 ) );
                                                                                                                                                      if ((ostream*)pcVar16 != (ostream*)0x0) {
                                                                                                                                                         if (( (ostream*)pcVar16 )[0x38] == (ostream)0x0) {
                                                                                                                                                         ...
                                                                                                                                                         std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, "  min_leaf_size      = ", 0x17);
                                                                                                                                                         pcVar21 = (char*)( ulong ) * (uint*)( this + 0x350 );
                                                                                                                                                         poVar22 = (ostream*)&std::cout;
                                                                                                                                                         poStack_50 = (ostream*)0x102ab1;
                                                                                                                                                         pcVar16 = (char*)std::ostream::operator <<((ostream*)&std::cout, *(uint*)( this + 0x350 ));
                                                                                                                                                         unaff_R14 = *(char**)( (ostream*)pcVar16 + *(long*)( *(long*)pcVar16 + -0x18 ) + 0xf0 );
                                                                                                                                                         if ((ostream*)unaff_R14 != (ostream*)0x0) {
                                                                                                                                                            if (( (ostream*)unaff_R14 )[0x38] == (ostream)0x0) {
                                                                                                                                                            ...
                                                                                                                                                            std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, "  max_leaf_size      = ", 0x17);
                                                                                                                                                            pcVar21 = (char*)( ulong ) * (uint*)( this + 0x354 );
                                                                                                                                                            poVar22 = (ostream*)&std::cout;
                                                                                                                                                            poStack_50 = (ostream*)0x102b11;
                                                                                                                                                            pcVar16 = (char*)std::ostream::operator <<((ostream*)&std::cout, *(uint*)( this + 0x354 ));
                                                                                                                                                            unaff_R15 = *(ostream**)( (ostream*)pcVar16 + *(long*)( *(long*)pcVar16 + -0x18 ) + 0xf0 );
                                                                                                                                                            if (unaff_R15 != (ostream*)0x0) {
                                                                                                                                                               if (unaff_R15[0x38] == (ostream)0x0) {
                                                                                                                                                               ...
                                                                                                                                                               std::__ostream_insert<char,std::char_traits<char>>((ostream*)&std::cout, "object_accel_mb:", 0x10);
                                                                                                                                                               pcVar16 = *(char**)( std::__basic_file<char>::is_open + *(long*)( std::cout + -0x18 ) );
                                                                                                                                                               if ((ostream*)pcVar16 != (ostream*)0x0) {
                                                                                                                                                                  if (( (ostream*)pcVar16 )[0x38] == (ostream)0x0) {
                                                                                                                                                                  ...
                                                                                                                                                                  pcVar16 = (char*)std::ostream::operator <<((ostream*)&std::cout, *(uint*)( this + 0x398 ));
                                                                                                                                                                  unaff_R13 = *(char**)( (ostream*)pcVar16 + *(long*)( *(long*)pcVar16 + -0x18 ) + 0xf0 );
                                                                                                                                                                  if ((ostream*)unaff_R13 != (ostream*)0x0) {
                                                                                                                                                                     if (( (ostream*)unaff_R13 )[0x38] == (ostream)0x0) {
                                                                                                                                                                     ...
                                                                                                                                                                     plVar20 = (long*)std::ostream::operator <<((ostream*)&std::cout, *(uint*)( this + 0x39c ));
                                                                                                                                                                     this * (State**)( (long)plVar20 + *(long*)( *plVar20 + -0x18 ) + 0xf0 );
                                                                                                                                                                     if (this != (State*)0x0) {
   ...
   LAB_00103a10:plVar20 = *(long**)pcVar21;
   uStack_9d8 = 0;
   ...
   if (plVar20[4] == 0) {
      if (*(code**)( *plVar20 + 0x28 ) == TokenStream::location) {
         ...
         if (plVar5[4] == 0) {
            ...
            if (lVar18 + lVar6 == 0x400) {
               if (lVar18 == 0) {
                  embree_State_parse:/* WARNING: Subroutine does not return */abort();
               }
            ...
            plVar5[4] = lVar6 + 1;
            puVar3 = (undefined4*)( plVar5[5] + ( ulong )((int)lVar18 + uVar15 + (int)lVar6 & 0x3ff) * 0x28 );
      ...
      if (uStack_130 < 0x10) {
         ...
         LAB_0010485c:memcpy(puStack_e8, puVar3, __n_00);
      }
      ...
      *(undefined8*)( puVar3 + 0x18 ) = uStack_90;
      ...
      LAB_0010410d:if (puStack_9f8 != &uStack_9e8) {
   ...
   if (( ( ( aiStack_9b0[0] == 4 ) && ( lStack_9a0 == 7 ) ) && ( (int)*plStack_9a8 == 0x65726874 ) ) && ( *(int*)( (long)plStack_9a8 + 3 ) == 0x73646165 )) {
   ...
   LAB_00104400:lStack_180 = 0x7268745f72657375;
   ...
   uStack_b8 = 0xffffffffffffffff;
   uStack_b0 = 0xffffffffffffffff;
   if (( ( aiStack_9b0[0] == 4 ) && ( lStack_9a0 == 0xc ) ) && ( ( *plStack_9a8 == 0x7268745f72657375 && ( (int)plStack_9a8[1] == 0x73646165 ) ) )) {
            ...
            if (p_Stack_8e0 != (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)0x0) {
               ...
               if (*(long*)( p_Stack_8e0 + 8 ) == 0x100000001) {
                  *(undefined8*)( p_Stack_8e0 + 8 ) = 0;
                  ...
                  if (iVar14 == 1) {
                     std::_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>::_M_release_last_use_cold(p_Stack_8e0);
                  }
   ...
   uStack_b0 = 0xffffffffffffffff;
   puStack_e8 = &uStack_d8;
   if (( ( aiStack_9b0[0] == 4 ) && ( lStack_9a0 == 0xc ) ) && ( ( *plStack_9a8 == 0x696666615f746573 && ( (int)plStack_9a8[1] == 0x7974696e ) ) )) {
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "max_builder_isa", paVar19);
   Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
   cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
   if (cVar11 == '\0') {
      Token::~Token((Token*)&uStack_f0);
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "frequency_level", paVar19);
   Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
   cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
   if (cVar11 == '\0') {
      Token::~Token((Token*)&uStack_f0);
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "enable_selockmemoryprivilege", paVar19);
   Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
   cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
   if (cVar11 == '\0') {
      Token::~Token((Token*)&uStack_f0);
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "float_exceptions", paVar19);
   Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
   cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
   if (cVar11 == '\0') {
      Token::~Token((Token*)&uStack_f0);
   ...
   if (cVar11 == '\0') {
      std::__cxx11::string::string<std::allocator<char>>((string*)&iStack_1e0, "accel", extraout_RDX_20);
   ...
   if (cVar11 != '\0') {
      ...
      LAB_00104d35:std::__cxx11::string::operator =((string*)poVar17, (string*)&uStack_140);
      std::__cxx11::string::_M_dispose();
      Token::~Token((Token*)&uStack_f0);
      goto LAB_00104323;
   }

   std::__cxx11::string::string<std::allocator<char>>((string*)&iStack_230, "tri_builder", extraout_RDX_22);
   Token::Id((Token*)&uStack_140, CONCAT44(iStack_22c, iStack_230), uStack_228);
   cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_140 );
   if (cVar11 == '\0') {
      std::__cxx11::string::string<std::allocator<char>>((string*)&iStack_1e0, "builder", extraout_RDX_35);
      Token::Id((Token*)&uStack_f0, CONCAT44(uStack_1dc, iStack_1e0), uStack_1d8);
      cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
      if (cVar11 != '\0') {
         psVar7 = *(string**)pcVar21;
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&iStack_230, "tri_traverser", extraout_RDX_37);
   Token::Id((Token*)&uStack_140, CONCAT44(iStack_22c, iStack_230), uStack_228);
   cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_140 );
   if (cVar11 == '\0') {
      std::__cxx11::string::string<std::allocator<char>>((string*)&iStack_1e0, "traverser", extraout_RDX_38);
      Token::Id((Token*)&uStack_f0, CONCAT44(uStack_1dc, iStack_1e0), uStack_1d8);
      cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
      if (cVar11 != '\0') {
         psVar7 = *(string**)pcVar21;
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&iStack_230, "tri_accel_mb", extraout_RDX_40);
   Token::Id((Token*)&uStack_140, CONCAT44(iStack_22c, iStack_230), uStack_228);
   cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_140 );
   if (cVar11 == '\0') {
      std::__cxx11::string::string<std::allocator<char>>((string*)&iStack_1e0, "accel_mb", extraout_RDX_41);
      Token::Id((Token*)&uStack_f0, CONCAT44(uStack_1dc, iStack_1e0), uStack_1d8);
      cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
      if (cVar11 != '\0') {
         psVar7 = *(string**)pcVar21;
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&iStack_230, "tri_builder_mb", extraout_RDX_43);
   Token::Id((Token*)&uStack_140, CONCAT44(iStack_22c, iStack_230), uStack_228);
   cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_140 );
   if (cVar11 == '\0') {
      std::__cxx11::string::string<std::allocator<char>>((string*)&iStack_1e0, "builder_mb", extraout_RDX_44);
      Token::Id((Token*)&uStack_f0, CONCAT44(uStack_1dc, iStack_1e0), uStack_1d8);
      cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
      if (cVar11 != '\0') {
         psVar7 = *(string**)pcVar21;
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&iStack_230, "tri_traverser_mb", extraout_RDX_46);
   Token::Id((Token*)&uStack_140, CONCAT44(iStack_22c, iStack_230), uStack_228);
   cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_140 );
   if (cVar11 == '\0') {
      std::__cxx11::string::string<std::allocator<char>>((string*)&iStack_1e0, "traverser_mb", extraout_RDX_47);
      Token::Id((Token*)&uStack_f0, CONCAT44(uStack_1dc, iStack_1e0), uStack_1d8);
      cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
      if (cVar11 != '\0') {
         psVar7 = *(string**)pcVar21;
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "quad_accel", extraout_RDX_49);
   Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
   cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
   if (cVar11 == '\0') {
      Token::~Token((Token*)&uStack_f0);
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "quad_builder_mb", paVar19);
   Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
   cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
   if (cVar11 == '\0') {
      Token::~Token((Token*)&uStack_f0);
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "quad_traverser_mb", paVar19);
   Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
   cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
   if (cVar11 == '\0') {
      Token::~Token((Token*)&uStack_f0);
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "line_builder_mb", paVar19);
   Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
   cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
   if (cVar11 == '\0') {
      Token::~Token((Token*)&uStack_f0);
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "line_traverser_mb", paVar19);
   Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
   cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
   if (cVar11 == '\0') {
      Token::~Token((Token*)&uStack_f0);
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "hair_builder_mb", paVar19);
   Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
   cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
   if (cVar11 == '\0') {
      Token::~Token((Token*)&uStack_f0);
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "hair_traverser_mb", paVar19);
   Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
   cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
   if (cVar11 == '\0') {
      Token::~Token((Token*)&uStack_f0);
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "object_accel_min_leaf_size", paVar19);
   Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
   cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
   if (cVar11 == '\0') {
      Token::~Token((Token*)&uStack_f0);
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "object_accel_max_leaf_size", paVar19);
   Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
   cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
   if (cVar11 == '\0') {
      Token::~Token((Token*)&uStack_f0);
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "object_accel_mb", paVar19);
   Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
   cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
   if (cVar11 == '\0') {
      Token::~Token((Token*)&uStack_f0);
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "object_builder_mb", paVar19);
   Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
   cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
   if (cVar11 == '\0') {
      Token::~Token((Token*)&uStack_f0);
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "object_accel_mb_min_leaf_size", paVar19);
   Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
   cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
   if (cVar11 == '\0') {
      Token::~Token((Token*)&uStack_f0);
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "object_accel_mb_max_leaf_size", paVar19);
   Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
   cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
   if (cVar11 == '\0') {
      Token::~Token((Token*)&uStack_f0);
      ...
      psVar7 = *(string**)pcVar21;
      std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_140, "=", extraout_RDX_x00100);
      cVar11 = embree::TokenStream::trySymbol(psVar7);
      std::__cxx11::string::_M_dispose();
      Token::~Token((Token*)&uStack_f0);
      std::__cxx11::string::_M_dispose();
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "instancing_open_min", paVar19);
   Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
   cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
   if (cVar11 == '\0') {
      Token::~Token((Token*)&uStack_f0);
      ...
      psVar7 = *(string**)pcVar21;
      std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_140, "=", extraout_RDX_x00102);
      cVar11 = embree::TokenStream::trySymbol(psVar7);
      std::__cxx11::string::_M_dispose();
      Token::~Token((Token*)&uStack_f0);
      std::__cxx11::string::_M_dispose();
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "instancing_block_size", paVar19);
   Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
   cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
   if (cVar11 == '\0') {
      Token::~Token((Token*)&uStack_f0);
      ...
      psVar7 = *(string**)pcVar21;
      std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_140, "=", extraout_RDX_x00104);
      cVar11 = embree::TokenStream::trySymbol(psVar7);
      std::__cxx11::string::_M_dispose();
      Token::~Token((Token*)&uStack_f0);
      std::__cxx11::string::_M_dispose();
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "instancing_open_max_depth", paVar19);
   Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
   cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
   if (cVar11 == '\0') {
      Token::~Token((Token*)&uStack_f0);
      ...
      psVar7 = *(string**)pcVar21;
      std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_140, "=", extraout_RDX_x00106);
      cVar11 = embree::TokenStream::trySymbol(psVar7);
      std::__cxx11::string::_M_dispose();
      Token::~Token((Token*)&uStack_f0);
      std::__cxx11::string::_M_dispose();
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "instancing_open_factor", paVar19);
   Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
   cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
   if (cVar11 == '\0') {
      Token::~Token((Token*)&uStack_f0);
      ...
      psVar7 = *(string**)pcVar21;
      std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_140, "=", extraout_RDX_x00108);
      cVar11 = embree::TokenStream::trySymbol(psVar7);
      std::__cxx11::string::_M_dispose();
      Token::~Token((Token*)&uStack_f0);
      std::__cxx11::string::_M_dispose();
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "instancing_open_max", paVar19);
   Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
   cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
   if (cVar11 == '\0') {
      Token::~Token((Token*)&uStack_f0);
      ...
      psVar7 = *(string**)pcVar21;
      std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_140, "=", extraout_RDX_x00110);
      cVar11 = embree::TokenStream::trySymbol(psVar7);
      std::__cxx11::string::_M_dispose();
      Token::~Token((Token*)&uStack_f0);
      std::__cxx11::string::_M_dispose();
   ...
   if (cVar11 == '\0') {
      ...
      psVar7 = *(string**)pcVar21;
      std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_140, "=", extraout_RDX_x00112);
      cVar11 = embree::TokenStream::trySymbol(psVar7);
      std::__cxx11::string::_M_dispose();
      Token::~Token((Token*)&uStack_f0);
      std::__cxx11::string::_M_dispose();
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "subdiv_accel_mb", paVar19);
   Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
   cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
   if (cVar11 == '\0') {
      Token::~Token((Token*)&uStack_f0);
      ...
      psVar7 = *(string**)pcVar21;
      std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_140, "=", extraout_RDX_x00114);
      cVar11 = embree::TokenStream::trySymbol(psVar7);
      std::__cxx11::string::_M_dispose();
      Token::~Token((Token*)&uStack_f0);
      std::__cxx11::string::_M_dispose();
   ...
   if (cVar11 == '\0') {
      ...
      psVar7 = *(string**)pcVar21;
      std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_140, "=", extraout_RDX_x00116);
      cVar11 = embree::TokenStream::trySymbol(psVar7);
      std::__cxx11::string::_M_dispose();
      Token::~Token((Token*)&uStack_f0);
      std::__cxx11::string::_M_dispose();
   ...
   if (cVar11 == '\0') {
      ...
      psVar7 = *(string**)pcVar21;
      std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_140, "=", extraout_RDX_x00118);
      cVar11 = embree::TokenStream::trySymbol(psVar7);
      std::__cxx11::string::_M_dispose();
      Token::~Token((Token*)&uStack_f0);
      std::__cxx11::string::_M_dispose();
   ...
   if (cVar11 == '\0') {
      ...
      psVar7 = *(string**)pcVar21;
      std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_140, "=", extraout_RDX_x00120);
      cVar11 = embree::TokenStream::trySymbol(psVar7);
      std::__cxx11::string::_M_dispose();
      Token::~Token((Token*)&uStack_f0);
      std::__cxx11::string::_M_dispose();
   ...
   if (cVar11 == '\0') {
      ...
      psVar7 = *(string**)pcVar21;
      std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_140, "=", extraout_RDX_x00122);
      cVar11 = embree::TokenStream::trySymbol(psVar7);
      std::__cxx11::string::_M_dispose();
      Token::~Token((Token*)&uStack_f0);
      std::__cxx11::string::_M_dispose();
   ...
   if (cVar11 != '\0') {
      ...
      Stream<embree::Token>::get();
      std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "low", extraout_RDX_x00125);
      Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
      cVar11 = operator == ( (Token*)&uStack_140,(Token*)&uStack_f0 );
      Token::~Token((Token*)&uStack_f0);
      std::__cxx11::string::_M_dispose();
      if (cVar11 == '\0') {
         std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "medium", extraout_RDX_x00126);
         Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
         cVar11 = operator == ( (Token*)&uStack_140,(Token*)&uStack_f0 );
         Token::~Token((Token*)&uStack_f0);
         std::__cxx11::string::_M_dispose();
         if (cVar11 == '\0') {
            std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "high", extraout_RDX_x00128);
            Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
            cVar11 = operator == ( (Token*)&uStack_140,(Token*)&uStack_f0 );
            Token::~Token((Token*)&uStack_f0);
            std::__cxx11::string::_M_dispose();
      ...
      LAB_00106d9e:Token::~Token((Token*)&uStack_140);
      goto LAB_00104323;
   }

   std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_140, "scene_flags", extraout_RDX_x00124);
   Token::Id((Token*)&uStack_f0, uStack_140, puStack_138);
   cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
   Token::~Token((Token*)&uStack_f0);
   std::__cxx11::string::_M_dispose();
   if (cVar11 != '\0') {
      *(undefined4*)( poVar22 + 0x4a0 ) = 0;
      ...
      while (cVar11 != '\0') {
         Stream<embree::Token>::get();
         std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "dynamic", extraout_RDX_x00130);
         Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
         cVar11 = operator == ( (Token*)&uStack_140,(Token*)&uStack_f0 );
         Token::~Token((Token*)&uStack_f0);
         std::__cxx11::string::_M_dispose();
         if (cVar11 == '\0') {
            std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "compact", extraout_RDX_x00131);
            Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
            cVar11 = operator == ( (Token*)&uStack_140,(Token*)&uStack_f0 );
            Token::~Token((Token*)&uStack_f0);
            std::__cxx11::string::_M_dispose();
            if (cVar11 == '\0') {
               std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "robust", extraout_RDX_x00133);
               Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
               cVar11 = operator == ( (Token*)&uStack_140,(Token*)&uStack_f0 );
               Token::~Token((Token*)&uStack_f0);
               std::__cxx11::string::_M_dispose();
         ...
         Token::~Token((Token*)&uStack_140);
         psVar7 = *(string**)pcVar21;
         std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_f0, "|", extraout_RDX_x00132);
         cVar11 = embree::TokenStream::trySymbol(psVar7);
         std::__cxx11::string::_M_dispose();
      }
;
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "max_spatial_split_replications", extraout_RDX_x00129);
   Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
   cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
   if (cVar11 == '\0') {
      Token::~Token((Token*)&uStack_f0);
      ...
      psVar7 = *(string**)pcVar21;
      std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_140, "=", extraout_RDX_x00134);
      cVar11 = embree::TokenStream::trySymbol(psVar7);
      std::__cxx11::string::_M_dispose();
      Token::~Token((Token*)&uStack_f0);
      std::__cxx11::string::_M_dispose();
   ...
   if (cVar11 == '\0') {
      ...
      psVar7 = *(string**)pcVar21;
      std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_140, "=", extraout_RDX_x00136);
      cVar11 = embree::TokenStream::trySymbol(psVar7);
      std::__cxx11::string::_M_dispose();
      Token::~Token((Token*)&uStack_f0);
      std::__cxx11::string::_M_dispose();
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "tessellation_cache_size", paVar19);
   Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
   cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
   if (cVar11 == '\0') {
      Token::~Token((Token*)&uStack_f0);
      ...
      LAB_0010715f:std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "cache_size", paVar19);
      Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
      cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
      if (cVar11 == '\0') {
         Token::~Token((Token*)&uStack_f0);
         ...
         psVar7 = *(string**)pcVar21;
         std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_140, "=", extraout_RDX_x00140);
         cVar11 = embree::TokenStream::trySymbol(psVar7);
         std::__cxx11::string::_M_dispose();
         Token::~Token((Token*)&uStack_f0);
         std::__cxx11::string::_M_dispose();
      ...
      std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "alloc_main_block_size", paVar19);
      Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
      cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
      if (cVar11 == '\0') {
         Token::~Token((Token*)&uStack_f0);
         ...
         psVar7 = *(string**)pcVar21;
         std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_140, "=", extraout_RDX_x00142);
         cVar11 = embree::TokenStream::trySymbol(psVar7);
         std::__cxx11::string::_M_dispose();
         Token::~Token((Token*)&uStack_f0);
         std::__cxx11::string::_M_dispose();
      ...
      std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "alloc_num_main_slots", paVar19);
      Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
      cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
      if (cVar11 == '\0') {
         Token::~Token((Token*)&uStack_f0);
         ...
         psVar7 = *(string**)pcVar21;
         std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_140, "=", extraout_RDX_x00144);
         cVar11 = embree::TokenStream::trySymbol(psVar7);
         std::__cxx11::string::_M_dispose();
         Token::~Token((Token*)&uStack_f0);
         std::__cxx11::string::_M_dispose();
      ...
      std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "alloc_thread_block_size", paVar19);
      Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
      cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
      if (cVar11 == '\0') {
         Token::~Token((Token*)&uStack_f0);
         ...
         psVar7 = *(string**)pcVar21;
         std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_140, "=", extraout_RDX_x00146);
         cVar11 = embree::TokenStream::trySymbol(psVar7);
         std::__cxx11::string::_M_dispose();
         Token::~Token((Token*)&uStack_f0);
         std::__cxx11::string::_M_dispose();
      ...
      std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_190, "alloc_single_thread_alloc", paVar19);
      Token::Id((Token*)&uStack_f0, uStack_190, uStack_188);
      cVar11 = operator == ( (Token*)aiStack_9b0,(Token*)&uStack_f0 );
      if (cVar11 == '\0') {
         Token::~Token((Token*)&uStack_f0);
         ...
         psVar7 = *(string**)pcVar21;
         std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_140, "=", extraout_RDX_x00148);
         cVar11 = embree::TokenStream::trySymbol(psVar7);
         std::__cxx11::string::_M_dispose();
         Token::~Token((Token*)&uStack_f0);
         std::__cxx11::string::_M_dispose();
      ...
      psVar7 = *(string**)pcVar21;
      std::__cxx11::string::string<std::allocator<char>>((string*)&uStack_140, "=", extraout_RDX_x00138);
      cVar11 = embree::TokenStream::trySymbol(psVar7);
      std::__cxx11::string::_M_dispose();
      Token::~Token((Token*)&uStack_f0);
      std::__cxx11::string::_M_dispose();
      ...
      LAB_001075b3:fVar24 = fVar24 * _LC120 * _LC120;
      if (__LC121 <= fVar24) {
      ...
      LAB_001074ac:Token::~Token(this_00);
   }

   LAB_00104323:puStack_e8 = (ulong*)0x1;
...
/* WARNING: Removing unreachable block (ram,0x001044d8) *//* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* embree::State::parse(embree::Ref<embree::TokenStream>) */void embree::State::parse(State *this, long *param_2) {
   _Sp_counted_base<(__gnu_cxx::_Lock_policy)2> *p_Var1;
   _Sp_counted_base<(__gnu_cxx::_Lock_policy)2> *p_Var2;
   undefined4 *puVar3;
   int *piVar4;
   ...
   LAB_00103a10:plVar5 = (long*)*param_2;
   local_990 = 0;
   ...
   if (plVar5[4] == 0) {
      if (*(code**)( *plVar5 + 0x28 ) == TokenStream::location) {
         ...
         if (plVar6[4] == 0) {
            ...
            plVar6[4] = lVar7 + 1;
            puVar3 = (undefined4*)( plVar6[5] + ( ulong )((int)lVar17 + uVar16 + (int)lVar7 & 0x3ff) * 0x28 );
            p_Var1 = *(_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>**)( puVar3 + 4 );
            *puVar3 = uVar14;
      ...
      if (local_e8 < 0x10) {
         ...
         local_90 = local_9e0;
         LAB_0010485c:memcpy(local_a0, puVar3, __n_00);
      }
      ...
      *(undefined8*)( puVar3 + 0x18 ) = local_48;
      ...
      LAB_0010410d:if (local_9b0 != &local_9a0) {
   ...
   if (( ( ( local_968[0] == 4 ) && ( local_958 == 7 ) ) && ( (int)*local_960 == 0x65726874 ) ) && ( *(int*)( (long)local_960 + 3 ) == 0x73646165 )) {
   ...
   LAB_00104400:local_138 = 0x7268745f72657375;
   ...
   local_70 = 0xffffffffffffffff;
   local_68 = 0xffffffffffffffff;
   if (( ( local_968[0] == 4 ) && ( local_958 == 0xc ) ) && ( ( *local_960 == 0x7268745f72657375 && ( (int)local_960[1] == 0x73646165 ) ) )) {
   ...
   local_68 = 0xffffffffffffffff;
   local_a0 = &local_90;
   if (( ( local_968[0] == 4 ) && ( local_958 == 0xc ) ) && ( ( *local_960 == 0x696666615f746573 && ( (int)local_960[1] == 0x7974696e ) ) )) {
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&local_148, "enable_selockmemoryprivilege", paVar18);
   Token::Id((Token*)&local_a8, local_148, local_140);
   cVar12 = operator == ( (Token*)local_968,(Token*)&local_a8 );
   if (cVar12 == '\0') {
      Token::~Token((Token*)&local_a8);
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&local_148, "float_exceptions", paVar18);
   Token::Id((Token*)&local_a8, local_148, local_140);
   cVar12 = operator == ( (Token*)local_968,(Token*)&local_a8 );
   if (cVar12 == '\0') {
      Token::~Token((Token*)&local_a8);
   ...
   if (cVar12 != '\0') {
      ...
      Token::Identifier_abi_cxx11_();
      this_01 = this + 0x10;
      LAB_00104d35:std::__cxx11::string::operator =((string*)this_01, (string*)&local_f8);
      std::__cxx11::string::_M_dispose();
      Token::~Token((Token*)&local_a8);
      goto LAB_00104323;
   }

   std::__cxx11::string::string<std::allocator<char>>((string*)&local_1e8, "tri_builder", extraout_RDX_22);
   Token::Id((Token*)&local_f8, CONCAT44(iStack_1e4, local_1e8), local_1e0);
   cVar12 = operator == ( (Token*)local_968,(Token*)&local_f8 );
   if (cVar12 == '\0') {
      std::__cxx11::string::string<std::allocator<char>>((string*)&local_198, "builder", extraout_RDX_35);
      Token::Id((Token*)&local_a8, CONCAT44(uStack_194, local_198), local_190);
      cVar12 = operator == ( (Token*)local_968,(Token*)&local_a8 );
      if (cVar12 != '\0') {
         psVar8 = (string*)*param_2;
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&local_1e8, "tri_traverser", extraout_RDX_37);
   Token::Id((Token*)&local_f8, CONCAT44(iStack_1e4, local_1e8), local_1e0);
   cVar12 = operator == ( (Token*)local_968,(Token*)&local_f8 );
   if (cVar12 == '\0') {
      std::__cxx11::string::string<std::allocator<char>>((string*)&local_198, "traverser", extraout_RDX_38);
      Token::Id((Token*)&local_a8, CONCAT44(uStack_194, local_198), local_190);
      cVar12 = operator == ( (Token*)local_968,(Token*)&local_a8 );
      if (cVar12 != '\0') {
         psVar8 = (string*)*param_2;
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&local_1e8, "tri_accel_mb", extraout_RDX_40);
   Token::Id((Token*)&local_f8, CONCAT44(iStack_1e4, local_1e8), local_1e0);
   cVar12 = operator == ( (Token*)local_968,(Token*)&local_f8 );
   if (cVar12 == '\0') {
      std::__cxx11::string::string<std::allocator<char>>((string*)&local_198, "accel_mb", extraout_RDX_41);
      Token::Id((Token*)&local_a8, CONCAT44(uStack_194, local_198), local_190);
      cVar12 = operator == ( (Token*)local_968,(Token*)&local_a8 );
      if (cVar12 != '\0') {
         psVar8 = (string*)*param_2;
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&local_1e8, "tri_builder_mb", extraout_RDX_43);
   Token::Id((Token*)&local_f8, CONCAT44(iStack_1e4, local_1e8), local_1e0);
   cVar12 = operator == ( (Token*)local_968,(Token*)&local_f8 );
   if (cVar12 == '\0') {
      std::__cxx11::string::string<std::allocator<char>>((string*)&local_198, "builder_mb", extraout_RDX_44);
      Token::Id((Token*)&local_a8, CONCAT44(uStack_194, local_198), local_190);
      cVar12 = operator == ( (Token*)local_968,(Token*)&local_a8 );
      if (cVar12 != '\0') {
         psVar8 = (string*)*param_2;
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&local_1e8, "tri_traverser_mb", extraout_RDX_46);
   Token::Id((Token*)&local_f8, CONCAT44(iStack_1e4, local_1e8), local_1e0);
   cVar12 = operator == ( (Token*)local_968,(Token*)&local_f8 );
   if (cVar12 == '\0') {
      std::__cxx11::string::string<std::allocator<char>>((string*)&local_198, "traverser_mb", extraout_RDX_47);
      Token::Id((Token*)&local_a8, CONCAT44(uStack_194, local_198), local_190);
      cVar12 = operator == ( (Token*)local_968,(Token*)&local_a8 );
      if (cVar12 != '\0') {
         psVar8 = (string*)*param_2;
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&local_148, "quad_accel", extraout_RDX_49);
   Token::Id((Token*)&local_a8, local_148, local_140);
   cVar12 = operator == ( (Token*)local_968,(Token*)&local_a8 );
   if (cVar12 == '\0') {
      Token::~Token((Token*)&local_a8);
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&local_148, "quad_traverser_mb", paVar18);
   Token::Id((Token*)&local_a8, local_148, local_140);
   cVar12 = operator == ( (Token*)local_968,(Token*)&local_a8 );
   if (cVar12 == '\0') {
      Token::~Token((Token*)&local_a8);
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&local_148, "line_traverser_mb", paVar18);
   Token::Id((Token*)&local_a8, local_148, local_140);
   cVar12 = operator == ( (Token*)local_968,(Token*)&local_a8 );
   if (cVar12 == '\0') {
      Token::~Token((Token*)&local_a8);
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&local_148, "hair_traverser_mb", paVar18);
   Token::Id((Token*)&local_a8, local_148, local_140);
   cVar12 = operator == ( (Token*)local_968,(Token*)&local_a8 );
   if (cVar12 == '\0') {
      Token::~Token((Token*)&local_a8);
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&local_148, "object_accel_min_leaf_size", paVar18);
   Token::Id((Token*)&local_a8, local_148, local_140);
   cVar12 = operator == ( (Token*)local_968,(Token*)&local_a8 );
   if (cVar12 == '\0') {
      Token::~Token((Token*)&local_a8);
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&local_148, "object_accel_max_leaf_size", paVar18);
   Token::Id((Token*)&local_a8, local_148, local_140);
   cVar12 = operator == ( (Token*)local_968,(Token*)&local_a8 );
   if (cVar12 == '\0') {
      Token::~Token((Token*)&local_a8);
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&local_148, "object_builder_mb", paVar18);
   Token::Id((Token*)&local_a8, local_148, local_140);
   cVar12 = operator == ( (Token*)local_968,(Token*)&local_a8 );
   if (cVar12 == '\0') {
      Token::~Token((Token*)&local_a8);
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&local_148, "object_accel_mb_min_leaf_size", paVar18);
   Token::Id((Token*)&local_a8, local_148, local_140);
   cVar12 = operator == ( (Token*)local_968,(Token*)&local_a8 );
   if (cVar12 == '\0') {
      Token::~Token((Token*)&local_a8);
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&local_148, "object_accel_mb_max_leaf_size", paVar18);
   Token::Id((Token*)&local_a8, local_148, local_140);
   cVar12 = operator == ( (Token*)local_968,(Token*)&local_a8 );
   if (cVar12 == '\0') {
      Token::~Token((Token*)&local_a8);
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&local_148, "instancing_open_min", paVar18);
   Token::Id((Token*)&local_a8, local_148, local_140);
   cVar12 = operator == ( (Token*)local_968,(Token*)&local_a8 );
   if (cVar12 == '\0') {
      Token::~Token((Token*)&local_a8);
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&local_148, "instancing_block_size", paVar18);
   Token::Id((Token*)&local_a8, local_148, local_140);
   cVar12 = operator == ( (Token*)local_968,(Token*)&local_a8 );
   if (cVar12 == '\0') {
      Token::~Token((Token*)&local_a8);
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&local_148, "instancing_open_max_depth", paVar18);
   Token::Id((Token*)&local_a8, local_148, local_140);
   cVar12 = operator == ( (Token*)local_968,(Token*)&local_a8 );
   if (cVar12 == '\0') {
      Token::~Token((Token*)&local_a8);
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&local_148, "instancing_open_factor", paVar18);
   Token::Id((Token*)&local_a8, local_148, local_140);
   cVar12 = operator == ( (Token*)local_968,(Token*)&local_a8 );
   if (cVar12 == '\0') {
      Token::~Token((Token*)&local_a8);
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&local_148, "instancing_open_max", paVar18);
   Token::Id((Token*)&local_a8, local_148, local_140);
   cVar12 = operator == ( (Token*)local_968,(Token*)&local_a8 );
   if (cVar12 == '\0') {
      Token::~Token((Token*)&local_a8);
   ...
   if (cVar12 != '\0') {
      ...
      Stream<embree::Token>::get();
      std::__cxx11::string::string<std::allocator<char>>((string*)&local_148, "low", extraout_RDX_x00125);
      Token::Id((Token*)&local_a8, local_148, local_140);
      cVar12 = operator == ( (Token*)&local_f8,(Token*)&local_a8 );
      Token::~Token((Token*)&local_a8);
      std::__cxx11::string::_M_dispose();
      if (cVar12 == '\0') {
         std::__cxx11::string::string<std::allocator<char>>((string*)&local_148, "medium", extraout_RDX_x00126);
         Token::Id((Token*)&local_a8, local_148, local_140);
         cVar12 = operator == ( (Token*)&local_f8,(Token*)&local_a8 );
         Token::~Token((Token*)&local_a8);
         std::__cxx11::string::_M_dispose();
         if (cVar12 == '\0') {
            std::__cxx11::string::string<std::allocator<char>>((string*)&local_148, "high", extraout_RDX_x00128);
            Token::Id((Token*)&local_a8, local_148, local_140);
            cVar12 = operator == ( (Token*)&local_f8,(Token*)&local_a8 );
            Token::~Token((Token*)&local_a8);
            std::__cxx11::string::_M_dispose();
      ...
      LAB_00106d9e:Token::~Token((Token*)&local_f8);
      goto LAB_00104323;
   }

   std::__cxx11::string::string<std::allocator<char>>((string*)&local_f8, "scene_flags", extraout_RDX_x00124);
   Token::Id((Token*)&local_a8, local_f8, local_f0);
   cVar12 = operator == ( (Token*)local_968,(Token*)&local_a8 );
   Token::~Token((Token*)&local_a8);
   std::__cxx11::string::_M_dispose();
   if (cVar12 != '\0') {
      *(undefined4*)( this + 0x4a0 ) = 0;
      ...
      while (cVar12 != '\0') {
         Stream<embree::Token>::get();
         std::__cxx11::string::string<std::allocator<char>>((string*)&local_148, "dynamic", extraout_RDX_x00130);
         Token::Id((Token*)&local_a8, local_148, local_140);
         cVar12 = operator == ( (Token*)&local_f8,(Token*)&local_a8 );
         Token::~Token((Token*)&local_a8);
         std::__cxx11::string::_M_dispose();
         if (cVar12 == '\0') {
            std::__cxx11::string::string<std::allocator<char>>((string*)&local_148, "compact", extraout_RDX_x00131);
            Token::Id((Token*)&local_a8, local_148, local_140);
            cVar12 = operator == ( (Token*)&local_f8,(Token*)&local_a8 );
            Token::~Token((Token*)&local_a8);
            std::__cxx11::string::_M_dispose();
            if (cVar12 == '\0') {
               std::__cxx11::string::string<std::allocator<char>>((string*)&local_148, "robust", extraout_RDX_x00133);
               Token::Id((Token*)&local_a8, local_148, local_140);
               cVar12 = operator == ( (Token*)&local_f8,(Token*)&local_a8 );
               Token::~Token((Token*)&local_a8);
               std::__cxx11::string::_M_dispose();
         ...
         Token::~Token((Token*)&local_f8);
         psVar8 = (string*)*param_2;
         std::__cxx11::string::string<std::allocator<char>>((string*)&local_a8, "|", extraout_RDX_x00132);
         cVar12 = embree::TokenStream::trySymbol(psVar8);
         std::__cxx11::string::_M_dispose();
      }
;
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&local_148, "max_spatial_split_replications", extraout_RDX_x00129);
   Token::Id((Token*)&local_a8, local_148, local_140);
   cVar12 = operator == ( (Token*)local_968,(Token*)&local_a8 );
   if (cVar12 == '\0') {
      Token::~Token((Token*)&local_a8);
   ...
   std::__cxx11::string::string<std::allocator<char>>((string*)&local_148, "tessellation_cache_size", paVar18);
   Token::Id((Token*)&local_a8, local_148, local_140);
   cVar12 = operator == ( (Token*)local_968,(Token*)&local_a8 );
   if (cVar12 == '\0') {
      Token::~Token((Token*)&local_a8);
      ...
      LAB_0010715f:std::__cxx11::string::string<std::allocator<char>>((string*)&local_148, "cache_size", paVar18);
      Token::Id((Token*)&local_a8, local_148, local_140);
      cVar12 = operator == ( (Token*)local_968,(Token*)&local_a8 );
      if (cVar12 == '\0') {
         Token::~Token((Token*)&local_a8);
         ...
         psVar8 = (string*)*param_2;
         std::__cxx11::string::string<std::allocator<char>>((string*)&local_f8, "=", extraout_RDX_x00140);
         cVar12 = embree::TokenStream::trySymbol(psVar8);
         std::__cxx11::string::_M_dispose();
         Token::~Token((Token*)&local_a8);
         std::__cxx11::string::_M_dispose();
      ...
      std::__cxx11::string::string<std::allocator<char>>((string*)&local_148, "alloc_main_block_size", paVar18);
      Token::Id((Token*)&local_a8, local_148, local_140);
      cVar12 = operator == ( (Token*)local_968,(Token*)&local_a8 );
      if (cVar12 == '\0') {
         Token::~Token((Token*)&local_a8);
         ...
         psVar8 = (string*)*param_2;
         std::__cxx11::string::string<std::allocator<char>>((string*)&local_f8, "=", extraout_RDX_x00142);
         cVar12 = embree::TokenStream::trySymbol(psVar8);
         std::__cxx11::string::_M_dispose();
         Token::~Token((Token*)&local_a8);
         std::__cxx11::string::_M_dispose();
      ...
      std::__cxx11::string::string<std::allocator<char>>((string*)&local_148, "alloc_num_main_slots", paVar18);
      Token::Id((Token*)&local_a8, local_148, local_140);
      cVar12 = operator == ( (Token*)local_968,(Token*)&local_a8 );
      if (cVar12 == '\0') {
         Token::~Token((Token*)&local_a8);
         ...
         psVar8 = (string*)*param_2;
         std::__cxx11::string::string<std::allocator<char>>((string*)&local_f8, "=", extraout_RDX_x00144);
         cVar12 = embree::TokenStream::trySymbol(psVar8);
         std::__cxx11::string::_M_dispose();
         Token::~Token((Token*)&local_a8);
         std::__cxx11::string::_M_dispose();
      ...
      std::__cxx11::string::string<std::allocator<char>>((string*)&local_148, "alloc_thread_block_size", paVar18);
      Token::Id((Token*)&local_a8, local_148, local_140);
      cVar12 = operator == ( (Token*)local_968,(Token*)&local_a8 );
      if (cVar12 == '\0') {
         Token::~Token((Token*)&local_a8);
         ...
         psVar8 = (string*)*param_2;
         std::__cxx11::string::string<std::allocator<char>>((string*)&local_f8, "=", extraout_RDX_x00146);
         cVar12 = embree::TokenStream::trySymbol(psVar8);
         std::__cxx11::string::_M_dispose();
         Token::~Token((Token*)&local_a8);
         std::__cxx11::string::_M_dispose();
      ...
      std::__cxx11::string::string<std::allocator<char>>((string*)&local_148, "alloc_single_thread_alloc", paVar18);
      Token::Id((Token*)&local_a8, local_148, local_140);
      cVar12 = operator == ( (Token*)local_968,(Token*)&local_a8 );
      if (cVar12 == '\0') {
         Token::~Token((Token*)&local_a8);
         ...
         psVar8 = (string*)*param_2;
         std::__cxx11::string::string<std::allocator<char>>((string*)&local_f8, "=", extraout_RDX_x00148);
         cVar12 = embree::TokenStream::trySymbol(psVar8);
         std::__cxx11::string::_M_dispose();
         Token::~Token((Token*)&local_a8);
         std::__cxx11::string::_M_dispose();
      ...
      LAB_001075b3:fVar20 = fVar20 * _LC120 * _LC120;
      if (__LC121 <= fVar20) {
   ...
   LAB_00104323:local_a0 = (ulong*)0x1;
...
/* embree::State::ErrorHandler::error() */undefined4 * __thiscall embree::State::ErrorHandler::error(ErrorHandler *this){
   undefined8 *puVar1;
   undefined4 *puVar2;
   long in_FS_OFFSET;
   undefined4 *local_28;
   ...
   if (puVar2 == (undefined4*)0x0) {
      ...
      *puVar2 = 0;
      ...
      if (puVar1 == *(undefined8**)( this + 0x18 )) {
         std::vector<RTCError*,std::allocator<RTCError*>>::_M_realloc_insert<RTCError*const&>((vector<RTCError*,std::allocator<RTCError*>>*)( this + 8 ), puVar1, &local_28);
      }
 else {
         *puVar1 = puVar2;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* embree::State::parseFile(embree::FileName const&) */undefined8 embree::State::parseFile(State *this, FileName *param_1) {
   TokenStream *pTVar1;
   undefined1 *puVar2;
   code *pcVar3;
   bool bVar4;
 ...
 while ( puVar11 != puVar10 + 0x2800 );
   ...
   *puVar12 = (ulong)__dest;
   ...
   if (pTVar15 < (TokenStream*)0x10) {
      ...
      *puVar12 = (ulong)__dest;
      ...
      LAB_001094a7:memcpy(__dest, puVar2, (size_t)pTVar15);
   ...
   *puVar13 = &PTR___Sp_counted_ptr_0010f540;
   ...
   if (( ( *(byte*)( plVar9 + 0x2c ) & 5 ) == 0 ) && ( lVar14 = lVar14 == 0 )) {
   ...
   if (pTVar15 < (TokenStream*)0x10) {
      ...
      local_58[0] = local_e8;
      LAB_0010942f:memcpy(local_68, puVar2, (size_t)pTVar15);
   }
   ...
   *(TokenStream*)( (long)local_68 + (long)local_e8 ) = (TokenStream)0x0;
   ...
   if (symbols != (undefined*)0x0) {
      ...
      if (pTVar15 < (TokenStream*)0x10) {
         ...
         local_68 = (TokenStream**)std::__cxx11::string::_M_create((ulong*)&local_68, ( ulong ) & local_f0);
         local_58[0] = local_f0;
         ppTVar22 = local_68;
         LAB_001094ea:memcpy(ppTVar22, puVar5, (size_t)pTVar15);
         ppTVar22 = local_68;
      }
      ...
      *(TokenStream*)( (long)ppTVar22 + (long)local_f0 ) = (TokenStream)0x0;
      if (local_d8 == local_e0) {
         std::vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>::_M_realloc_insert<std::__cxx11::string>((vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>*)&local_e8, local_e0, (string*)&local_68);
         if (local_68 != local_58) {
            operator_delete(local_68, ( ulong )(local_58[0] + 1));
         }
               ...
               if (( (ulong)pTVar15 & 4 ) == 0) {
                  if (uVar21 != 0) {
                     ...
                     if (( (ulong)pTVar15 & 2 ) != 0) {
                        *(undefined2*)( local_e0 + ( (ulong)pTVar15 & 0xffffffff ) + 0xe ) = *(undefined2*)( (long)local_58 + ( ( (ulong)pTVar15 & 0xffffffff ) - 2 ) );
                     }
                  ...
                  *(undefined4*)( local_e0 + ( (ulong)pTVar15 & 0xffffffff ) + 0xc ) = *(undefined4*)( (long)local_58 + ( ( (ulong)pTVar15 & 0xffffffff ) - 4 ) );
               }

            }
 else {
               *(TokenStream**)( local_e0 + 0x10 ) = local_58[0];
               *(undefined8*)( local_e0 + ( (ulong)pTVar15 & 0xffffffff ) + 8 ) = *(undefined8*)( (long)local_58 + ( ( (ulong)pTVar15 & 0xffffffff ) - 8 ) );
               ...
               if (7 < uVar21) {
                  ...
                  do {
                     uVar27 = (ulong)uVar8;
                     uVar8 = uVar8 + 8;
                     *(undefined8*)( ( ( ulong )(local_e0 + 0x18) & 0xfffffffffffffff8 ) + uVar27 ) = *(undefined8*)( (long)local_58 + ( uVar27 - lVar14 ) );
                  }
 while ( uVar8 < uVar21 );
               }
      ...
      if (PTR_DAT_0010f578 != (undefined*)0x0) {
         ...
         if (pTVar15 < (TokenStream*)0x10) {
            ...
            local_58[0] = local_f0;
            ppTVar22 = local_68;
            LAB_0010958a:memcpy(ppTVar22, puVar5, (size_t)pTVar15);
            ppTVar22 = local_68;
         }
 ...
 while ( uVar8 < uVar21 );
         ...
         if (PTR__LC116_0010f580 != (undefined*)0x0) {
            ...
            if (pTVar15 < (TokenStream*)0x10) {
               ...
               local_58[0] = local_f0;
               ppTVar22 = local_68;
               LAB_0010953a:memcpy(ppTVar22, puVar5, (size_t)pTVar15);
               ppTVar22 = local_68;
            }
 ...
 while ( uVar8 < uVar21 );
            ...
            if (( ( uVar25 <= 0x3fffffffffffffffU - local_a0 ) && ( std::__cxx11::string::_M_append((char*)&local_a8, uVar27),uVar23 <= 0x3fffffffffffffffU - local_a0 ) ) && ( std::__cxx11::string::_M_append((char*)&local_a8, uVar25),TokenStream::separators_abi_cxx11_ <= 0x3fffffffffffffffU - local_a0 )) {
               plVar16 = (long*)std::__cxx11::string::_M_append((char*)&local_a8, TokenStream::numbers_abi_cxx11_);
               plVar17 = plVar16 + 2;
                  ...
                  if ((TokenStream**)*plVar17 == ppTVar22) {
                     ...
                     if (7 < (uint)uVar27) {
                        ...
                        do {
                           uVar21 = (int)uVar25 + 8;
                           uVar23 = (ulong)uVar21;
                           *(undefined8*)( (long)local_58 + uVar25 ) = *(undefined8*)( (long)ppTVar22 + uVar25 );
                           uVar25 = uVar23;
                        }
 while ( uVar21 < ( (uint)uVar27 & 0xfffffff8 ) );
 ...
 while ( puVar11 != puVar10 + 0x2800 );
                  ...
                  *(TokenStream**)( pTVar18 + 0x48 ) = pTVar20;
                  ...
                  if (local_c0 < (TokenStream*)0x10) {
                     ...
                     pTVar20 = (TokenStream*)std::__cxx11::string::_M_create((ulong*)( pTVar18 + 0x48 ), ( ulong ) & local_f0);
                     *(TokenStream**)( pTVar18 + 0x48 ) = pTVar20;
                     *(TokenStream**)( pTVar18 + 0x58 ) = local_f0;
                     LAB_00109616:memcpy(pTVar20, pTVar1, (size_t)pTVar28);
                  ...
                  *(TokenStream**)( pTVar18 + 0x50 ) = pTVar28;
                  ...
                  local_f0 = pTVar18;
                  embree::TokenStream::TokenStream(pTVar15, (Ref*)&local_f0, (string*)&local_68, (string*)&TokenStream::separators_abi_cxx11_, (vector*)&local_e8);
                  ...
                  for (; pTVar15 = local_e0,bVar4 = local_e0 != pTVar18,local_e0 = pTVar20,bVar4; pTVar18 = pTVar18 + 0x20) {
...
;
                  ...
                  LAB_0010927c:if (local_e8 != (TokenStream*)0x0) {
   ...
   std::__throw_logic_error("basic_string: construction from null is not valid");
   LAB_00109a6c:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* embree::State::parseString(char const*) */void embree::State::parseString(State *this, char *param_1) {
   undefined *puVar1;
   uint uVar2;
   TokenStream *pTVar3;
   long *plVar4;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (param_1 == (char*)0x0) {
      LAB_0010a0bc:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
      ...
      if (symbols != (undefined*)0x0) {
         ...
         if (pTVar3 < (TokenStream*)0x10) {
            ...
            local_68 = (TokenStream**)std::__cxx11::string::_M_create((ulong*)&local_68, ( ulong ) & local_d0);
            local_58[0] = local_d0;
            ppTVar11 = local_68;
            LAB_0010a24f:memcpy(ppTVar11, puVar1, (size_t)pTVar3);
            ppTVar11 = local_68;
         }
         ...
         *(TokenStream*)( (long)ppTVar11 + (long)local_d0 ) = (TokenStream)0x0;
         if (local_b8 == local_c0) {
            std::vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>::_M_realloc_insert<std::__cxx11::string>((vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>*)&local_c8, local_c0, (string*)&local_68);
            if (local_68 != local_58) {
               operator_delete(local_68, ( ulong )(local_58[0] + 1));
            }
                  ...
                  if (( (ulong)pTVar3 & 4 ) == 0) {
                     if (uVar10 != 0) {
                        *(undefined1*)( local_c0 + 2 ) = local_58[0]._0_1_;
                        if (( (ulong)pTVar3 & 2 ) != 0) {
                           *(undefined2*)( (long)local_c0 + ( (ulong)pTVar3 & 0xffffffff ) + 0xe ) = *(undefined2*)( (long)local_58 + ( ( (ulong)pTVar3 & 0xffffffff ) - 2 ) );
                        }
                     ...
                     *(undefined4*)( (long)local_c0 + ( (ulong)pTVar3 & 0xffffffff ) + 0xc ) = *(undefined4*)( (long)local_58 + ( ( (ulong)pTVar3 & 0xffffffff ) - 4 ) );
                  }

               }
 else {
                  local_c0[2] = (long)local_58[0];
                  *(undefined8*)( (long)local_c0 + ( (ulong)pTVar3 & 0xffffffff ) + 8 ) = *(undefined8*)( (long)local_58 + ( ( (ulong)pTVar3 & 0xffffffff ) - 8 ) );
                  ...
                  if (7 < uVar10) {
                     ...
                     do {
                        uVar16 = (ulong)uVar2;
                        uVar2 = uVar2 + 8;
                        *(undefined8*)( ( ( ulong )(local_c0 + 3) & 0xfffffffffffffff8 ) + uVar16 ) = *(undefined8*)( (long)local_58 + ( uVar16 - lVar17 ) );
                     }
 while ( uVar2 < uVar10 );
                  }
         ...
         if (PTR_DAT_0010f578 != (undefined*)0x0) {
            ...
            if (pTVar3 < (TokenStream*)0x10) {
               ...
               local_58[0] = local_d0;
               ppTVar11 = local_68;
               LAB_0010a297:memcpy(ppTVar11, puVar1, (size_t)pTVar3);
               ppTVar11 = local_68;
            }
 ...
 while ( uVar2 < uVar10 );
            ...
            if (PTR__LC116_0010f580 != (undefined*)0x0) {
               ...
               if (pTVar3 < (TokenStream*)0x10) {
                  ...
                  local_58[0] = local_d0;
                  ppTVar11 = local_68;
                  LAB_0010a207:memcpy(ppTVar11, puVar1, (size_t)pTVar3);
                  ppTVar11 = local_68;
               }
 ...
 while ( uVar2 < uVar10 );
               ...
               local_a8 = &local_98;
               std::__cxx11::string::reserve(( ulong ) & local_a8);
               if (( ( uVar14 <= 0x3fffffffffffffffU - local_a0 ) && ( std::__cxx11::string::_M_append((char*)&local_a8, uVar16),uVar12 <= 0x3fffffffffffffffU - local_a0 ) ) && ( std::__cxx11::string::_M_append((char*)&local_a8, uVar14),TokenStream::separators_abi_cxx11_ <= 0x3fffffffffffffffU - local_a0 )) {
                  plVar4 = (long*)std::__cxx11::string::_M_append((char*)&local_a8, TokenStream::numbers_abi_cxx11_);
                  plVar5 = plVar4 + 2;
                     ...
                     if ((TokenStream**)*plVar5 == ppTVar11) {
                        ...
                        if (7 < (uint)uVar16) {
                           ...
                           do {
                              uVar10 = (int)uVar14 + 8;
                              uVar12 = (ulong)uVar10;
                              *(undefined8*)( (long)local_58 + uVar14 ) = *(undefined8*)( (long)ppTVar11 + uVar14 );
                              uVar14 = uVar12;
                           }
 while ( uVar10 < ( (uint)uVar16 & 0xfffffff8 ) );
                        ...
                        if (( uVar16 & 2 ) != 0) {
                           *(undefined2*)( (long)ppTVar19 + lVar17 ) = *(undefined2*)( (long)ppTVar15 + lVar17 );
                           lVar17 = lVar17 + 2;
                        }

                        local_68 = local_58;
                        if (( uVar16 & 1 ) != 0) {
                           *(undefined1*)( (long)ppTVar19 + lVar17 ) = *(undefined1*)( (long)ppTVar15 + lVar17 );
                        }
 ...
 while ( puVar9 != puVar7 + 0x2800 );
                     ...
                     *(long*)( pTVar6 + 0x58 ) = 0;
                     ...
                     local_d0 = pTVar6;
                     embree::TokenStream::TokenStream(pTVar3, (Ref*)&local_d0, (string*)&local_68, (string*)&TokenStream::separators_abi_cxx11_, (vector*)&local_c8);
...
/* embree::StrStream::next() */int embree::StrStream::next(StrStream *this) {
   char cVar1;
   int iVar2;
...
/* std::_Sp_counted_ptr<std::__cxx11::string*, (__gnu_cxx::_Lock_policy)2>::~_Sp_counted_ptr() */void std::_Sp_counted_ptr<std::__cxx11::string*,(__gnu_cxx::_Lock_policy)2>::~_Sp_counted_ptr(_Sp_counted_ptr<std::__cxx11::string*,(__gnu_cxx::_Lock_policy)2> *this) {
   return;
}
/* std::_Sp_counted_ptr<std::__cxx11::string*,
   (__gnu_cxx::_Lock_policy)2>::_M_get_deleter(std::type_info const&) */undefined8 std::_Sp_counted_ptr<std::__cxx11::string*,(__gnu_cxx::_Lock_policy)2>::_M_get_deleter(type_info *param_1) {
   return 0;
}
/* std::_Sp_counted_ptr<std::__cxx11::string*, (__gnu_cxx::_Lock_policy)2>::~_Sp_counted_ptr() */void std::_Sp_counted_ptr<std::__cxx11::string*,(__gnu_cxx::_Lock_policy)2>::~_Sp_counted_ptr(_Sp_counted_ptr<std::__cxx11::string*,(__gnu_cxx::_Lock_policy)2> *this) {
...
/* std::_Sp_counted_ptr<std::__cxx11::string*, (__gnu_cxx::_Lock_policy)2>::_M_destroy() */void std::_Sp_counted_ptr<std::__cxx11::string*,(__gnu_cxx::_Lock_policy)2>::_M_destroy(_Sp_counted_ptr<std::__cxx11::string*,(__gnu_cxx::_Lock_policy)2> *this) {
...
/* embree::FileStream::next() */void embree::FileStream::next(FileStream *this) {
   int iVar1;
...
/* embree::StrStream::location() */void embree::StrStream::location(void) {
   undefined8 uVar1;
   undefined8 uVar2;
   long in_RSI;
   undefined8 *in_RDI;
...
/* std::_Sp_counted_ptr<std::__cxx11::string*, (__gnu_cxx::_Lock_policy)2>::_M_dispose() */void std::_Sp_counted_ptr<std::__cxx11::string*,(__gnu_cxx::_Lock_policy)2>::_M_dispose(_Sp_counted_ptr<std::__cxx11::string*,(__gnu_cxx::_Lock_policy)2> *this) {
   undefined8 *puVar1;
   puVar1 = *(undefined8**)( this + 0x10 );
...
/* embree::Token::Identifier[abi:cxx11]() const */void embree::Token::Identifier_abi_cxx11_(void) {
   ulong __n;
   undefined1 *__src;
   ulong *__dest;
   int *in_RSI;
   ...
   *in_RDI = (ulong)__dest;
   ...
   __dest = (ulong*)*in_RDI;
   LAB_0010a94f:in_RDI[1] = local_28;
...
/* embree::TEMPNAMEPLACEHOLDERVALUE(embree::Token const&, embree::Token const&) */ulong embree::operator ==(Token *param_1, Token *param_2) {
   size_t __n;
   int iVar1;
   ulong uVar2;
...
/* std::_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>::_M_release() */void std::_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>::_M_release(_Sp_counted_base<(__gnu_cxx::_Lock_policy)2> *this) {
   _Sp_counted_base<(__gnu_cxx::_Lock_policy)2> *p_Var1;
   int iVar2;
...
/* embree::StrStream::~StrStream() */void embree::StrStream::~StrStream(StrStream *this) {
   _Sp_counted_base<(__gnu_cxx::_Lock_policy)2> *p_Var1;
   int iVar2;
   void *pvVar3;
...
/* embree::LineCommentFilter::~LineCommentFilter() */void embree::LineCommentFilter::~LineCommentFilter(LineCommentFilter *this) {
   long *plVar1;
   _Sp_counted_base<(__gnu_cxx::_Lock_policy)2> *p_Var2;
   int iVar3;
   long *plVar4;
...
/* embree::Token::~Token() */void embree::Token::~Token(Token *this) {
   _Sp_counted_base<(__gnu_cxx::_Lock_policy)2> *p_Var1;
   _Sp_counted_base<(__gnu_cxx::_Lock_policy)2> *this_00;
   int iVar2;
   Token *pTVar3;
   ...
   LAB_0010b731:operator_delete(pTVar3, *(long*)( this + 0x18 ) + 1);
   return;
}
/* embree::FileStream::location() */undefined8 *embree::FileStream::location(void) {
   _Sp_counted_base<(__gnu_cxx::_Lock_policy)2> *p_Var1;
   ...
   *(int*)( this + 8 ) = *(int*)( this + 8 ) + 1;
   in_RDI[2] = uVar3;
   in_RDI[3] = uVar2;
   LAB_0010b7f5:if (*(long*)( this + 8 ) != 0x100000001) {
      if (__libc_single_threaded == '\0') {
         LOCK();
         iVar5 = *(int*)p_Var1;
         *(int*)p_Var1 = *(int*)p_Var1 + -1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* embree::FileStream::~FileStream() */void embree::FileStream::~FileStream(FileStream *this) {
   _Sp_counted_base<(__gnu_cxx::_Lock_policy)2> *p_Var1;
   _Sp_counted_base<(__gnu_cxx::_Lock_policy)2> *p_Var2;
   void *pvVar3;
   undefined8 uVar4;
   ...
   *(undefined***)this = &PTR__FileStream_0010f450;
   if (( (byte)this[0x160] & 5 ) == 0) {
      ...
      if (lVar6 == 0) {
         std::ios::clear(this + *(long*)( *(long*)( this + 0x40 ) + -0x18 ) + 0x40, *(uint*)( this + *(long*)( *(long*)( this + 0x40 ) + -0x18 ) + 0x40 + 0x20 ) | 4);
      }
...
/* embree::TokenStream::location() */void embree::TokenStream::location(void) {
   _Sp_counted_base<(__gnu_cxx::_Lock_policy)2> *p_Var1;
   undefined4 *puVar2;
   long *plVar3;
   long lVar4;
   ...
   *(undefined8*)( puVar2 + 2 ) = local_68;
   if (local_60 == p_Var10) {
      LAB_0010bf0a:*(undefined8*)( puVar2 + 6 ) = local_58;
   ...
   LAB_0010bf20:lVar8 = plVar3[5] + ( ulong )((int)plVar3[3] + (int)plVar3[2] & 0x3ff) * 0x28;
...
/* embree::LineCommentFilter::location() */void embree::LineCommentFilter::location(void) {
   _Sp_counted_base<(__gnu_cxx::_Lock_policy)2> *p_Var1;
   undefined4 *puVar2;
   long *plVar3;
   long lVar4;
   ...
   *(undefined8*)( puVar2 + 2 ) = local_68;
   if (local_60 == p_Var10) {
      LAB_0010c2fa:*(undefined8*)( puVar2 + 6 ) = local_58;
      *(undefined8*)( puVar2 + 8 ) = local_50;
   ...
   LAB_0010c310:lVar8 = plVar3[5] + ( ulong )((int)plVar3[3] + (int)plVar3[2] & 0x3ff) * 0x28;
   *in_RDI = *(undefined8*)( lVar8 + 8 );
   lVar4 = *(long*)( lVar8 + 0x10 );
   in_RDI[1] = lVar4;
   if (lVar4 != 0) {
...
/* embree::Stream<int>::peek() */long embree::Stream<int>::peek(Stream<int> *this) {
   _Sp_counted_base<(__gnu_cxx::_Lock_policy)2> *p_Var1;
   undefined4 *puVar2;
   long lVar3;
   undefined4 uVar4;
   ...
   *(long*)( this + 0x20 ) = lVar3 + 1;
   puVar2 = (undefined4*)( *(long*)( this + 0x28 ) + ( ulong )((int)lVar6 + uVar7 + (int)lVar3 & 0x3ff) * 0x28 );
   *puVar2 = uVar4;
   p_Var8 = *(_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>**)( puVar2 + 4 );
   *(undefined8*)( puVar2 + 2 ) = local_68;
   if (local_60 == p_Var8) {
      LAB_0010c6ea:*(undefined8*)( puVar2 + 6 ) = local_58;
      *(undefined8*)( puVar2 + 8 ) = local_50;
   ...
   LAB_0010c700:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return *(long*)( this + 0x28 ) + ( ulong )((int)*(undefined8*)( this + 0x18 ) + (int)*(undefined8*)( this + 0x10 ) & 0x3ff) * 0x28;
   }

   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
/* embree::LineCommentFilter::next() */undefined4 embree::LineCommentFilter::next(LineCommentFilter *this) {
   _Sp_counted_base<(__gnu_cxx::_Lock_policy)2> *p_Var1;
   long *plVar2;
   long *plVar3;
   long *plVar4;
      ...
      do {
         ...
         if (*(long*)( pSVar6 + 0x20 ) == 0) {
            ...
            *(long*)( pSVar6 + 0x20 ) = lVar15 + 1;
            puVar5 = (undefined4*)( *(long*)( pSVar6 + 0x28 ) + ( ulong )((int)lVar12 + uVar13 + (int)lVar15 & 0x3ff) * 0x28 );
            *puVar5 = uVar11;
            p_Var14 = *(_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>**)( puVar5 + 4 );
            *(undefined8*)( puVar5 + 2 ) = uVar7;
            if (p_Var18 == p_Var14) {
               LAB_0010ca63:*(undefined8*)( puVar5 + 6 ) = uVar8;
               ...
               *(undefined8*)( puVar5 + 6 ) = uVar8;
               *(undefined8*)( puVar5 + 8 ) = uVar9;
               LAB_0010cc46:p_Var14 = p_Var18 + 8;
         ...
         LAB_0010ca78:if (*(int*)( *(long*)( pSVar6 + 0x28 ) + ( ulong )((int)*(long*)( pSVar6 + 0x18 ) + (int)*(long*)( pSVar6 + 0x10 ) & 0x3ff) * 0x28 ) != (int)*(char*)( *(long*)( this + 0x48 ) + uVar19 )) {
         ...
         if (lVar12 == 0) {
            ...
            *(long*)( this_00 + 0x20 ) = lVar15 + 1;
            puVar5 = (undefined4*)( *(long*)( this_00 + 0x28 ) + ( ulong )((int)lVar12 + uVar13 + (int)lVar15 & 0x3ff) * 0x28 );
            *puVar5 = uVar11;
            p_Var14 = *(_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>**)( puVar5 + 4 );
            *(undefined8*)( puVar5 + 2 ) = uVar7;
            if (p_Var18 == p_Var14) {
               LAB_0010cbdc:*(undefined8*)( puVar5 + 6 ) = uVar8;
               *(undefined8*)( puVar5 + 8 ) = uVar9;
               ...
               *(undefined8*)( puVar5 + 6 ) = uVar8;
               *(undefined8*)( puVar5 + 8 ) = uVar9;
               LAB_0010ccce:p_Var14 = p_Var18 + 8;
               if (*(long*)( p_Var18 + 8 ) == 0x100000001) {
                  *(undefined8*)( p_Var18 + 8 ) = 0;
                  ( **(code**)( *(long*)p_Var18 + 0x10 ) )(p_Var18);
                  ( **(code**)( *(long*)p_Var18 + 0x18 ) )(p_Var18);
         ...
         LAB_0010cbf1:*(long*)( this_00 + 0x18 ) = *(long*)( this_00 + 0x18 ) + 1;
         uVar19 = uVar19 + 1;
 ...
 while ( uVar19 < *(ulong*)( this + 0x50 ) );
   ...
   do {
      ...
      if (lVar12 == 0) {
         ...
         *(undefined8*)( puVar5 + 2 ) = uVar7;
         if (p_Var18 == p_Var14) {
            LAB_0010cfaf:*(undefined8*)( puVar5 + 6 ) = uVar8;
            *(undefined8*)( puVar5 + 8 ) = uVar9;
            if (p_Var18 != (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)0x0) {
               lVar12 = *(long*)( p_Var18 + 8 );
               joined_r0x0010d019:if (lVar12 == 0x100000001) {
                  *(undefined8*)( p_Var18 + 8 ) = 0;
                  ( **(code**)( *(long*)p_Var18 + 0x10 ) )(p_Var18);
                  ( **(code**)( *(long*)p_Var18 + 0x18 ) )(p_Var18);
         ...
         plVar16[4] = lVar15 + 1;
         puVar5 = (undefined4*)( plVar16[5] + ( ulong )((int)lVar12 + uVar13 + (int)lVar15 & 0x3ff) * 0x28 );
         *puVar5 = uVar11;
         p_Var14 = *(_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>**)( puVar5 + 4 );
         *(undefined8*)( puVar5 + 2 ) = uVar7;
         if (p_Var18 == p_Var14) {
            LAB_0010d191:*(undefined8*)( puVar5 + 6 ) = uVar8;
            *(undefined8*)( puVar5 + 8 ) = uVar9;
            if (p_Var18 != (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)0x0) {
               LAB_0010d1ba:p_Var14 = p_Var18 + 8;
               if (*(long*)( p_Var18 + 8 ) == 0x100000001) {
                  *(undefined8*)( p_Var18 + 8 ) = 0;
                  ( **(code**)( *(long*)p_Var18 + 0x10 ) )(p_Var18);
                  ( **(code**)( *(long*)p_Var18 + 0x18 ) )(p_Var18);
            ...
            if (p_Var18 != (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)0x0) {
               ...
               *(int*)( p_Var18 + 8 ) = *(int*)( p_Var18 + 8 ) + 1;
               ...
               LAB_0010d1ae:*(_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>**)( puVar5 + 4 ) = p_Var18;
               *(undefined8*)( puVar5 + 6 ) = uVar8;
               *(undefined8*)( puVar5 + 8 ) = uVar9;
               goto LAB_0010d1ba;
            }
         ...
         if (lVar12 == 0) {
            ...
            *(undefined8*)( puVar5 + 2 ) = uVar7;
            if (p_Var18 == p_Var14) {
               LAB_0010d349:*(undefined8*)( puVar5 + 6 ) = uVar8;
               *(undefined8*)( puVar5 + 8 ) = uVar9;
               ...
               *(undefined8*)( puVar5 + 6 ) = uVar8;
               *(undefined8*)( puVar5 + 8 ) = uVar9;
               LAB_0010d44e:p_Var14 = p_Var18 + 8;
               if (*(long*)( p_Var18 + 8 ) == 0x100000001) {
                  *(undefined8*)( p_Var18 + 8 ) = 0;
                  ( **(code**)( *(long*)p_Var18 + 0x10 ) )(p_Var18);
                  ( **(code**)( *(long*)p_Var18 + 0x18 ) )(p_Var18);
         ...
         plVar16 = plVar17;
         if (*(int*)( plVar17[5] + ( ulong )((int)plVar17[2] + (int)plVar17[3] & 0x3ff) * 0x28 ) == 10) break;
         LAB_0010d38b:lVar15 = plVar16[3];
         if (*(int*)( plVar16[5] + ( ulong )((int)plVar16[2] + (int)lVar15 & 0x3ff) * 0x28 ) == -1) goto LAB_0010d654;
      }

      LAB_0010d3b1:plVar16[3] = lVar15 + 1;
      plVar16[4] = lVar12 + -1;
   }
 while ( true );
   LAB_0010d4e8:plVar16 = plVar17;
   ...
   if (lVar12 + lVar15 == 0x400) {
      if (lVar12 == 0) {
         LAB_0010de64:/* WARNING: Subroutine does not return */abort();
      }
   ...
   *(undefined8*)( puVar5 + 2 ) = local_68;
   if (local_60 == p_Var18) {
      LAB_0010d63d:*(undefined8*)( puVar5 + 6 ) = local_58;
      *(undefined8*)( puVar5 + 8 ) = local_50;
      ...
      if (local_60 == (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)0x0) {
         ...
         LAB_0010d5fc:p_Var14 = p_Var18 + 8;
         if (*(long*)( p_Var18 + 8 ) == 0x100000001) {
            *(undefined8*)( p_Var18 + 8 ) = 0;
            ( **(code**)( *(long*)p_Var18 + 0x10 ) )(p_Var18);
            ( **(code**)( *(long*)p_Var18 + 0x18 ) )(p_Var18);
      ...
      *(undefined8*)( puVar5 + 6 ) = local_58;
      *(undefined8*)( puVar5 + 8 ) = local_50;
      LAB_0010d94d:p_Var18 = local_60 + 8;
      if (*(long*)( local_60 + 8 ) == 0x100000001) {
         *(undefined8*)( local_60 + 8 ) = 0;
         ( **(code**)( *(long*)local_60 + 0x10 ) )(local_60);
         ( **(code**)( *(long*)local_60 + 0x18 ) )(local_60);
   ...
   lVar12 = plVar17[4];
   LAB_0010d654:uVar11 = *(undefined4*)( plVar16[5] + ( ulong )((int)plVar16[2] + (int)plVar16[3] & 0x3ff) * 0x28 );
...
/* embree::Stream<embree::Token>::get() */void embree::Stream<embree::Token>::get(void) {
   _Sp_counted_base<(__gnu_cxx::_Lock_policy)2> *p_Var1;
   undefined4 *puVar2;
   long *plVar3;
   long lVar4;
   ...
   if (in_RSI[4] == 0) {
      if (*(code**)( *in_RSI + 0x28 ) == TokenStream::location) {
         ...
         if (plVar3[4] == 0) {
            ...
            plVar3[4] = lVar4 + 1;
            puVar11 = (undefined4*)( plVar3[5] + ( ulong )((int)lVar10 + uVar12 + (int)lVar4 & 0x3ff) * 0x28 );
            *puVar11 = uVar8;
            p_Var14 = *(_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>**)( puVar11 + 4 );
            *(ulong*)( puVar11 + 2 ) = uVar5;
            if (p_Var13 == p_Var14) {
               LAB_0010e07a:*(undefined8*)( puVar11 + 6 ) = uVar6;
         ...
         LAB_0010e0c8:lVar10 = plVar3[5] + ( ulong )((int)plVar3[3] + (int)plVar3[2] & 0x3ff) * 0x28;
      ...
      if (local_e8 < 0x10) {
         ...
         LAB_0010e64c:memcpy(local_a0, plVar3, local_e8);
      }
      ...
      *(undefined1*)( (long)local_a0 + local_120 ) = 0;
      ...
      if (lVar10 + lVar4 == 0x400) {
         if (lVar10 == 0) {
            LAB_0010eaf9:/* WARNING: Subroutine does not return */abort();
         }
   ...
   *(undefined4**)( in_RDI + 2 ) = puVar11;
   ...
   LAB_0010e596:*(ulong*)( in_RDI + 4 ) = local_118;
...
/* embree::State::parse(embree::Ref<embree::TokenStream>) [clone .cold] */void embree::State::parse(void) {
   /* WARNING: Subroutine does not return */
   abort();
}
/* embree::State::parseFile(embree::FileName const&) [clone .cold] */void embree::State::parseFile(FileName *param_1) {
   /* WARNING: Subroutine does not return */
   abort();
}
/* WARNING: Control flow encountered bad instruction data *//* void std::vector<RTCError*, std::allocator<RTCError*> >::_M_realloc_insert<RTCError*
   const&>(__gnu_cxx::__normal_iterator<RTCError**, std::vector<RTCError*, std::allocator<RTCError*>
   > >, RTCError* const&) */void std::vector<RTCError*,std::allocator<RTCError*>>::_M_realloc_insert<RTCError*const&>(vector<RTCError*,std::allocator<RTCError*>> *this, void *param_2, undefined8 *param_3) {
   void *__src;
   ulong uVar1;
   void *pvVar2;
   void *__dest;
   ...
   if (__src == pvVar2) {
      ...
      uVar4 = uVar1 * 2;
      if (uVar4 < uVar1) {
         LAB_0010ec30:uVar4 = 0x7ffffffffffffff8;
      }
 else {
         if (uVar4 == 0) {
            lVar3 = 0;
   ...
   LAB_0010ebb9:*(undefined8*)( (long)__dest + __n ) = *param_3;
   if (0 < (long)__n) {
...
/* WARNING: Control flow encountered bad instruction data *//* void std::vector<std::__cxx11::string, std::allocator<std::__cxx11::string >
   ...
   if (pvVar2 == pvVar1) {
      ...
      uVar13 = uVar13 << 5;
      LAB_0010edea:plVar5 = (long*)operator_new(uVar13);
      ...
      uVar13 = uVar3 * 2;
      if (uVar13 < uVar3) {
         LAB_0010ede0:uVar13 = 0x7fffffffffffffe0;
         goto LAB_0010edea;
      }
   ...
   if ((long*)*param_3 == plVar9) {
      ...
      if (uVar7 < 8) {
         if (( uVar3 & 4 ) != 0) {
            ...
            *(undefined4*)( (long)plVar8 + ( uVar3 & 0xffffffff ) + 0xc ) = *(undefined4*)( (long)param_3 + ( uVar3 & 0xffffffff ) + 0xc );
            lVar12 = param_3[1];
            goto LAB_0010ed44;
         }
         ...
         *(char*)( plVar8 + 2 ) = (char)param_3[2];
         if (( uVar3 & 2 ) != 0) {
            *(undefined2*)( (long)plVar8 + ( uVar3 & 0xffffffff ) + 0xe ) = *(undefined2*)( (long)param_3 + ( uVar3 & 0xffffffff ) + 0xe );
            lVar12 = param_3[1];
            goto LAB_0010ed44;
         }
         ...
         plVar8[2] = param_3[2];
         *(undefined8*)( (long)plVar8 + ( uVar3 & 0xffffffff ) + 8 ) = *(undefined8*)( (long)param_3 + ( uVar3 & 0xffffffff ) + 8 );
         ...
         if (7 < uVar7) {
            ...
            do {
               uVar3 = (ulong)uVar11;
               uVar11 = uVar11 + 8;
               *(undefined8*)( ( ( ulong )(plVar8 + 3) & 0xfffffffffffffff8 ) + uVar3 ) = *(undefined8*)( (long)plVar9 + ( uVar3 - lVar12 ) );
            }
 while ( uVar11 < uVar7 );
            lVar12 = param_3[1];
            goto LAB_0010ed44;
            ...
            if (uVar7 < 8) {
               if (( uVar3 & 4 ) == 0) {
                  if (( uVar7 != 0 ) && ( *(char*)plVar8 = (char)*plVar4(uVar3 & 2) != 0 )) {
                     *(undefined2*)( (long)plVar9 + ( uVar3 & 0xffffffff ) + 0xe ) = *(undefined2*)( (long)plVar4 + ( ( uVar3 & 0xffffffff ) - 2 ) );
                  }

               }
 else {
                  *(int*)plVar8 = (int)*plVar4;
                  *(undefined4*)( (long)plVar9 + ( uVar3 & 0xffffffff ) + 0xc ) = *(undefined4*)( (long)plVar4 + ( ( uVar3 & 0xffffffff ) - 4 ) );
               }

            }
 else {
               *plVar8 = *plVar4;
               *(undefined8*)( (long)plVar9 + ( uVar3 & 0xffffffff ) + 8 ) = *(undefined8*)( (long)plVar4 + ( ( uVar3 & 0xffffffff ) - 8 ) );
               ...
               if (7 < uVar7) {
                  ...
                  do {
                     uVar3 = (ulong)uVar11;
                     uVar11 = uVar11 + 8;
                     *(undefined8*)( ( ( ulong )(plVar9 + 3) & 0xfffffffffffffff8 ) + uVar3 ) = *(undefined8*)( (long)plVar4 + ( uVar3 - lVar12 ) );
                  }
 while ( uVar11 < uVar7 );
               }
...
;
         ...
         if (uVar7 < 8) {
            if (( uVar3 & 4 ) == 0) {
               if (uVar7 != 0) {
                  ...
                  *(undefined2*)( (long)plVar4 + ( uVar3 & 0xffffffff ) + 0xe ) = *(undefined2*)( (long)plVar8 + ( ( uVar3 & 0xffffffff ) - 2 ) );
                  lVar12 = plVar8[-1];
               }
               ...
               *(undefined4*)( (long)plVar4 + ( uVar3 & 0xffffffff ) + 0xc ) = *(undefined4*)( (long)plVar8 + ( ( uVar3 & 0xffffffff ) - 4 ) );
               lVar12 = plVar8[-1];
            }
            ...
            *plVar6 = *plVar8;
            *(undefined8*)( (long)plVar4 + ( uVar3 & 0xffffffff ) + 8 ) = *(undefined8*)( (long)plVar8 + ( ( uVar3 & 0xffffffff ) - 8 ) );
            ...
            if (7 < uVar7) {
               ...
               do {
                  uVar3 = (ulong)uVar11;
                  uVar11 = uVar11 + 8;
                  *(undefined8*)( ( ( ulong )(plVar4 + 3) & 0xfffffffffffffff8 ) + uVar3 ) = *(undefined8*)( (long)plVar8 + ( uVar3 - lVar12 ) );
               }
 while ( uVar11 < uVar7 );
            }

            LAB_0010eec9:lVar12 = plVar8[-1];
         }
 ...
 while ( plVar4 != plVar9 );
   ...
   LAB_0010ee6f:if (pvVar2 != (void*)0x0) {
...
/* embree::g_printMutex */void embree::_GLOBAL__sub_I_g_printMutex(void) {
...
/* WARNING: Control flow encountered bad instruction data *//* embree::FileStream::~FileStream() */void embree::FileStream::~FileStream(FileStream *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* embree::Token::~Token() */void embree::Token::~Token(Token *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* embree::LineCommentFilter::~LineCommentFilter() */void embree::LineCommentFilter::~LineCommentFilter(LineCommentFilter *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* embree::StrStream::~StrStream() */void embree::StrStream::~StrStream(StrStream *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* std::_Sp_counted_ptr<std::__cxx11::string*, (__gnu_cxx::_Lock_policy)2>::~_Sp_counted_ptr() */void std::_Sp_counted_ptr<std::__cxx11::string*,(__gnu_cxx::_Lock_policy)2>::~_Sp_counted_ptr(_Sp_counted_ptr<std::__cxx11::string*,(__gnu_cxx::_Lock_policy)2> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

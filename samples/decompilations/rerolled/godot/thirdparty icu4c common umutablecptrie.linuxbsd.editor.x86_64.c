/* icu_76_godot::(anonymous namespace)::MutableCodePointTrie::maskValues(unsigned int) */void MutableCodePointTrie::maskValues(MutableCodePointTrie *this, uint param_1) {
   uint *puVar1;
   int iVar2;
   long lVar3;
   long lVar4;
...
/* icu_76_godot::(anonymous namespace)::MutableCodePointTrie::ensureHighStart(int) */undefined8 MutableCodePointTrie::ensureHighStart(MutableCodePointTrie *this, int param_1) {
   undefined8 uVar1;
   int iVar2;
   long lVar3;
   long lVar4;
...
/* icu_76_godot::(anonymous namespace)::MutableCodePointTrie::allocDataBlock(int) */int MutableCodePointTrie::allocDataBlock(MutableCodePointTrie *this, int param_1) {
   int iVar1;
   undefined8 uVar2;
   long lVar3;
   undefined8 uVar4;
   ...
   if (iVar1 < iVar5 + param_1) {
      if (iVar1 < 0x20000) {
         uVar4 = 0x80000;
         uVar6 = 0x20000;
         LAB_0010017a:lVar3 = uprv_malloc_76_godot(uVar4);
         if (lVar3 != 0) {
      ...
      LAB_001001bb:*(int*)( this + 0x1c ) = iVar5 + param_1;
   }

   return iVar5;
}
/* icu_76_godot::(anonymous namespace)::MutableCodePointTrie::getDataBlock(int) */ulong MutableCodePointTrie::getDataBlock(MutableCodePointTrie *this, int param_1) {
   long lVar1;
   undefined4 *puVar2;
   undefined4 uVar3;
   long lVar4;
      ...
      if (-1 < (int)uVar7) {
         ...
         do {
            ...
            *puVar2 = uVar3;
            ...
            for (int i = 0; i < 3; i++) {
               puVar2 = (undefined4*)( lVar5 + ( 16*i + 16 ) + lVar8 * 4 );
               *puVar2 = uVar3;
               puVar2[1] = uVar3;
               puVar2[2] = uVar3;
               puVar2[3] = uVar3;
...
/* icu_76_godot::(anonymous namespace)::MutableCodePointTrie::setRange(int, int, unsigned int,
   UErrorCode&) [clone .part.0] */void MutableCodePointTrie::setRange(MutableCodePointTrie *this, int param_1, int param_2, uint param_3, UErrorCode *param_4) {
   long lVar1;
   char cVar2;
   int iVar3;
   uint *puVar4;
 ...
 while ( puVar4 < puVar7 );
   ...
   LAB_0010030c:uVar8 = uVar9 & 0xfffffff0;
   if (param_1 < (int)uVar8) {
      lVar1 = *(long*)this;
      uVar6 = param_1;
      do {
         while (puVar4 = (uint*)( lVar1 + (long)( (int)uVar6 >> 4 ) * 4 ),this[(long)( (int)uVar6 >> 4 ) + 0x40] == (MutableCodePointTrie)0x0) {
            uVar6 = uVar6 + 0x10;
            *puVar4 = param_3;
...
;
 ...
 while ( (int)uVar6 < (int)uVar8 );
      LAB_0010036e:param_1 = ( ( uVar8 - 1 ) - param_1 & 0xfffffff0 ) + 0x10 + param_1;
   }

   if (( uVar9 & 0xf ) != 0) {
      iVar3 = getDataBlock(this, param_1 >> 4);
      if (iVar3 < 0) {
         LAB_00100448:*(undefined4*)param_4 = 7;
         return;
      }
...
/* (anonymous namespace)::getRange(void const*, int, unsigned int (*)(void const*, unsigned int),
   void const*, unsigned int*) */uint(anonymous_namespace) {
   uint uVar1;
   uint uVar2;
   uint uVar3;
   long lVar4;
         ...
         do {
            ...
            if (*(char*)( (long)param_1 + local_48 + 0x40 ) == '\0') {
               if (bVar5) {
                  ...
                  unaff_R15D = local_5c;
                  if (( *(uint*)( (long)param_1 + 0x28 ) != uVar3 ) && ( unaff_R15D = uVar3 ),param_3 != (_func_uint_void_ptr_uint*)0x0) {
               ...
               if (bVar5) {
                  ...
                  unaff_R15D = local_5c;
                  if (( uVar3 != *(uint*)( (long)param_1 + 0x28 ) ) && ( unaff_R15D = uVar3 ),param_3 != (_func_uint_void_ptr_uint*)0x0) {
                     unaff_R15D = ( *param_3 )(param_4, uVar3);
                  }
...
;
 ...
 while ( param_2 < *(int*)( (long)param_1 + 0x30 ) );
         ...
         if (( *(uint*)( (long)param_1 + 0x28 ) != uVar3 ) && ( local_5c = uVar3 ),param_3 != (_func_uint_void_ptr_uint*)0x0) {
            local_5c = ( *param_3 )(param_4, uVar3);
         }

         if (local_5c != unaff_R15D) {
            LAB_00100641:return param_2 - 1;
         }
...
/* WARNING: Type propagation algorithm not settling *//* icu_76_godot::(anonymous namespace)::MutableCodePointTrie::compactTrie(int, UErrorCode&) */uint MutableCodePointTrie::compactTrie(MutableCodePointTrie *this, int param_1, UErrorCode *param_2) {
   ...
   while (lVar36 = lVar36 + -4,0 < iVar25) {
      if (*pMVar40 == (MutableCodePointTrie)0x0) {
         if (uVar43 != *(uint*)( lVar17 + lVar36 )) {
            LAB_001008cd:uVar26 = iVar25 * 0x10 + 0x1ffU & 0xfffffe00;
            local_1d38 = uVar26;
            if (uVar26 != 0x110000) {
...
;
 ...
 while ( (int)lVar36 < param_1 );
   ...
   local_1da0 = (int)uVar26 >> 4;
   LAB_00100975:*(uint*)( this + 0x30 ) = uVar26;
   lVar36 = 0;
   do {
 ...
 while ( lVar36 != 0x80 );
   ...
   do {
      ...
      if (param_1 == uVar26) {
         ...
         iVar10 = 0x10;
         uVar8 = param_1 + 1;
         LAB_00100aaa:if (( iVar25 < 0 ) || ( uVar38 != auStack_1c50[iVar25] )) {
            lVar16 = (long)iVar11;
            lVar30 = 0;
            if (0 < iVar11) {
               do {
 ...
 while ( lVar16 != lVar30 );
               if (iVar11 == 0x20) {
                  LAB_00100d58:if (uVar26 != 0) goto LAB_00100cbd;
                  LAB_00100d04:lVar17 = 0;
                  iVar25 = -1;
                  uVar14 = 0x11000;
                  do {
 ...
 while ( iVar11 != lVar17 );
         ...
         if (uVar14 == 0xfffffffe) {
            if (uVar26 != 0) {
               LAB_00100cbd:iVar7 = 4;
               uVar14 = 0;
               LAB_00100cd0:if (param_1 == uVar14) {
                  iVar7 = 1;
               }

               if (( this[(long)(int)uVar14 + 0x40] != (MutableCodePointTrie)0x0 ) || ( uVar38 != *(uint*)( lVar17 + (long)(int)uVar14 * 4 ) )) break;
               if (iVar11 < 1) {
                  iVar25 = -1;
               }
 else {
 ...
 while ( iVar11 != lVar17 );
            ...
            LAB_00100cf0:if (0 < iVar11) goto LAB_00100d04;
            iVar25 = -1;
            LAB_00100d2b:local_1d68 = local_1d68 + iVar10;
            ...
            LAB_00100b0b:if ((int)uVar14 < 0) goto LAB_00100c40;
 ...
 while ( (int)lVar16 < (int)uVar8 );
         ...
         LAB_00100c5b:puVar19 = (uint*)( *(long*)( this + 0x10 ) + (ulong)uVar38 * 4 );
         uVar38 = *puVar19;
         puVar19 = puVar19 + 1;
         ...
         LAB_00100c40:local_1d68 = local_1d68 + iVar10;
         uVar26 = uVar8;
      }

      joined_r0x00100b24:if ((int)local_1da0 <= (int)uVar26) goto LAB_00100b2a;
      lVar17 = *(long*)this;
   }
 while ( true );
   uVar14 = uVar14 + iVar7;
   ...
   goto LAB_00100cd0;
   LAB_0010176f:iVar25 = (int)uVar33;
   piVar29 = piVar24;
   if (iVar25 == -1) {
   ...
   goto LAB_0010173a;
   LAB_0010254b:if (-1 < (int)uVar14) {
      *local_1d80 = (short)uVar14;
      goto LAB_001024a6;
   }

   LAB_001027c3:if (uVar38 == uVar43) {
      sVar42 = (short)uVar38;
      uVar9 = 0;
...
;
 ...
 while ( uVar9 != 0 );
      ...
      LAB_00102825:sVar42 = (short)uVar14;
      memcpy((void*)( lVar17 + lVar36 * 2 ), local_1148 + (long)(int)uVar9 + (long)iVar11, ( ulong )(( uVar8 - 1 ) - uVar9) * 2 + 2);
      uVar26 = ( uVar43 + uVar8 ) - uVar9;
      LAB_0010286e:uVar14 = uVar43 - 0x1f;
 ...
 while ( puVar21 != puVar37 );
         ...
         while (uVar9 != 0) {
            if (uVar27 == ( uVar9 & ~local_1da0 )) {
               lVar36 = 0;
               while (*(short*)( lVar17 + (long)(int)( ( uVar9 & local_1da0 ) - 1 ) * 2 + lVar36 ) == *(short*)( (long)puVar37 + lVar36 + -0x40 )) {
                  lVar36 = lVar36 + 2;
...
;
         *(uint*)( (long)__s + (long)(int)uVar41 * 4 ) = uVar27 | uVar14;
         LAB_0010296a:puVar37 = puVar37 + 1;
      }
 while ( uVar14 != uVar26 - 0x1f );
   }

   LAB_00102487:iVar11 = iVar10;
   *local_1d80 = sVar42;
   local_1d80 = local_1d80 + 1;
   if (iVar25 <= iVar11) goto LAB_001024a6;
   goto LAB_00102395;
   LAB_00100b2a:if (-1 < local_1d68) {
 ...
 while ( piVar24 != piVar28 );
               ...
               while (uVar8 != 0) {
                  if (uVar41 == ( uVar8 & ~uVar43 )) {
                     lVar36 = 0;
                     while (*(int*)( lVar17 + (long)(int)( ( uVar8 & uVar43 ) - 1 ) * 4 + lVar36 ) == *(int*)( (long)piVar24 + lVar36 + -0x100 )) {
                        lVar36 = lVar36 + 4;
...
;
               *(uint*)( (long)__s + (long)(int)uVar14 * 4 ) = uVar41 | uVar38;
               LAB_00100f0e:piVar24 = piVar24 + 1;
            }
 while ( uVar38 != 0x41 );
               ...
               if (*(int*)param_2 < 1) {
                  ...
                  *(int*)( this + 0x20 ) = iVar25;
                  ...
                  if ((int)uVar43<*(int*)( this + 0x30 )> > 6) {
                     ...
                     LAB_00101734:uVar33 = 0xffffffff;
                     piVar29 = piVar24;
                     LAB_0010173a:iVar25 = iVar10 + 0x30;
                     piVar24 = piVar29;
                     do {
                        iVar10 = iVar10 + 0x10;
                        *piVar24 = iVar10;
 ...
 while ( puVar37 != puVar21 );
                        ...
                        while (uVar14 != 0) {
                           if (uVar38 * 0x1000 == ( uVar14 & 0xfffff000 )) {
                              lVar17 = 0;
                              while (*(short*)( (long)local_1948 + lVar17 + (long)(int)( ( uVar14 & 0xfff ) - 1 ) * 2 ) == *(short*)( (long)puVar37 + lVar17 + -0x40 )) {
                                 lVar17 = lVar17 + 2;
...
;
                        *(uint*)( (long)__s + (long)(int)uVar9 * 4 ) = uVar38 * 0x1000 | uVar26;
                        joined_r0x00101b3c:puVar37 = puVar37 + 1;
                     }
 while ( uVar26 != uVar43 - 0x1f );
                     ...
                     if (iVar10 == iVar25 || SBORROW4(iVar10, iVar25) != (int)( iVar10 + uVar26 * -0x1000 ) < 0) {
                        bVar44 = false;
                        iVar11 = 0;
                     }
 else {
                              ...
                              if (uVar8 != 0) {
                                 do {
                                    ...
                                    if (uVar38 * 0x1000 == ( uVar8 & 0xfffff000 )) {
                                       lVar16 = 0;
                                       while (( uint ) * (ushort*)( (long)local_1948 + lVar16 + (long)(int)( ( uVar8 & 0xfff ) - 1 ) * 2 ) == *(uint*)( (long)puVar15 + lVar16 * 2 )) {
                                          lVar16 = lVar16 + 2;
...
;
 ...
 while ( uVar8 != 0 );
                                 uVar9 = ~uVar9;
                                 LAB_00102167:if (( -1 < (int)uVar9 ) && ( uVar38 = *(uint*)( (long)__s + (long)(int)uVar9 * 4 ) & 0xfff ),uVar38 != 0) {
                           ...
                           LAB_00101be9:lVar36 = lVar36 + 0x20;
 ...
 while ( (int)lVar36 < iVar10 );
                     ...
                     *(long*)( this + 0x38 ) = lVar17;
                     ...
                     if (iVar11 < 0x1000) {
                        ...
                        LAB_001029d2:local_1d98 = 0xfff;
                        sVar32 = 0x5ddc;
                        iVar11 = 0x1777;
                        local_1d68._0_1_ = 0xc;
                        LAB_001029ec:uprv_free_76_godot(0);
                        ...
                        *(undefined4*)param_2 = 7;
                        ...
                        LAB_00101cfa:local_1d98 = 0;
                        iVar7 = 0;
                        iVar11 = 0;
                        local_1d68._0_1_ = 0;
                        local_1d48 = (void*)0x0;
                        LAB_00101d17:local_1d50 = *(uint*)( this + 0xc );
                        if (iVar25 < iVar10) {
                           ...
                           do {
                              ...
                              if (bVar23 == 0) {
                                 ...
                                 if (*(int*)( this + 0x20 ) < 0x10000) {
                                    lVar17 = *(long*)this;
                                    LAB_001021cd:local_1d10 = bVar23;
                                    ...
                                    if (uVar9 != 0) {
                                       do {
                                          ...
                                          if (uVar14 << ( bVar6 & 0x1f ) == ( uVar9 & ~local_1da0 )) {
                                             lVar17 = 0;
                                             while (( uint ) * (ushort*)( lVar36 + (long)(int)( ( uVar9 & local_1da0 ) - 1 ) * 2 + lVar17 ) == *(uint*)( (long)puVar15 + lVar17 * 2 )) {
                                                lVar17 = lVar17 + 2;
...
;
 ...
 while ( uVar9 != 0 );
                                       uVar12 = ~uVar12;
                                       LAB_0010256a:if (( -1 < (int)uVar12 ) && ( uVar9 = local_1da0 & *(uint*)( (long)__s + (long)(int)uVar12 * 4 ) ),uVar14 = uVar9 - 1,uVar9 != 0) goto LAB_001022be;
                                    }
...
;
 ...
 while ( lVar30 != 0 );
                                    ...
                                    LAB_001025c3:lVar16 = (long)iVar25;
 ...
 while ( puVar37 != puVar21 );
                                          ...
                                          while (uVar41 != 0) {
                                             if (uVar31 == ( uVar41 & ~local_1da0 )) {
                                                lVar17 = 0;
                                                while (*(short*)( lVar36 + (long)(int)( ( uVar41 & local_1da0 ) - 1 ) * 2 + lVar17 ) == *(short*)( (long)puVar37 + lVar17 + -0x40 )) {
                                                   lVar17 = lVar17 + 2;
...
;
                                          *(uint*)( (long)__s + (long)(int)uVar12 * 4 ) = uVar31 | uVar9;
                                          LAB_00102704:puVar37 = puVar37 + 1;
                                       }
 ...
 while ( (int)lVar16 < iVar25 );
                                             ...
                                             uVar12 = (int)( CONCAT44(0 << ( (byte)local_1d68 & 0x1f ), uVar8) % ( ulong )(iVar11 - 1) ) + 1;
                                             ...
                                             while (uVar8 != 0) {
                                                if (uVar41 == ( ~local_1d98 & uVar8 )) {
                                                   ...
                                                   lVar16 = 0;
                                                   while (*(ushort*)( lVar36 + (long)(int)( ( uVar8 & local_1d98 ) - 1 ) * 2 + lVar16 * 2 ) == puVar37[lVar16]) {
                                                      lVar16 = lVar16 + 1;
...
;
                                             uVar9 = ~uVar9;
                                             LAB_00103069:if ((int)uVar9 < 0) {
                                                *(uint*)( (long)local_1d48 + (long)(int)~uVar9 * 4 ) = uVar41 | (uint)lVar17;
                                             }
 ...
 while ( ( uVar43 - iVar7 ) + 1 + iVar7 != iVar25 );
                                    ...
                                    lVar17 = *(long*)this;
                                    local_1d10 = bVar23;
                                    LAB_00101de3:lVar16 = (long)(int)uVar8;
                                    lVar36 = *(long*)( this + 0x38 );
                                    ...
                                    do {
                                       ...
                                       *(ulong*)puVar20 = CONCAT44(uVar9 & 0xffff | uVar41 << 0x10, uVar3 >> 0x10 & 3 | uVar39 >> 0xe & 0xc | uVar31 >> 0xc & 0x30 | uVar27 >> 10 & 0xc0 | uVar12 >> 8 & 0x300 | uVar41 >> 6 & 0xc00 | uVar14 >> 2 & 0xc000 | uVar9 >> 4 & 0x3000 | uVar14 << 0x10);
                                       *(ulong*)( puVar20 + 4 ) = CONCAT44(uVar31 & 0xffff | uVar39 << 0x10, uVar12 & 0xffff | uVar27 << 0x10);
                                       puVar20 = puVar20 + 9;
                                       puVar15 = puVar19;
                                    }
 ...
 while ( (int)lVar17 < (int)( uVar8 + iVar7 ) );
                                    ...
                                    while (uVar9 != 0) {
                                       if (uVar14 << ( (byte)local_1d68 & 0x1f ) == ( ~local_1d98 & uVar9 )) {
                                          ...
                                          lVar17 = 0;
                                          while (*(ushort*)( lVar36 + (long)(int)( ( uVar9 & local_1d98 ) - 1 ) * 2 + lVar17 * 2 ) == puVar37[lVar17]) {
                                             lVar17 = lVar17 + 1;
...
;
                                    uVar41 = ~uVar41;
                                    LAB_001022a0:if (( (int)uVar41 < 0 ) || ( uVar14 = local_1d98 & *(uint*)( (long)local_1d48 + (long)(int)uVar41 * 4 ) ),uVar14 == 0) {
                                       if (uVar38 == uVar8) {
                                          uVar43 = uVar38 + 0x24;
                                          uVar14 = uVar38;
                                          uVar9 = uVar38;
 ...
 while ( (ushort*)( lVar36 + 2 + ( ( ulong )(0x23 - iVar25) + lVar16 ) * 2 ) != puVar20 );
                                                   uVar14 = uVar8 - iVar25;
...
;
                                             *(uint*)( (long)__s + (long)(int)uVar12 * 4 ) = uVar31 | uVar9;
                                             LAB_00102c14:puVar37 = puVar37 + 1;
                                          }
 ...
 while ( (int)lVar17 < iVar25 );
                                                uVar41 = uVar8 << ( (byte)local_1d68 & 0x1f );
                                                uVar12 = (int)( CONCAT44(0 << ( (byte)local_1d68 & 0x1f ), uVar8) % ( ulong )(iVar11 - 1U) ) + 1;
                                                uVar8 = *(uint*)( (long)local_1d48 + (long)(int)uVar12 * 4 );
                                                uVar9 = uVar12;
                                                while (uVar8 != 0) {
                                                   if (uVar41 == ( uVar8 & ~local_1d98 )) {
                                                      ...
                                                      lVar17 = 0;
                                                      while (*(ushort*)( lVar36 + (long)(int)( ( uVar8 & local_1d98 ) - 1 ) * 2 + lVar17 * 2 ) == puVar37[lVar17]) {
                                                         lVar17 = lVar17 + 1;
...
;
                                                uVar9 = ~uVar9;
                                                LAB_00102e17:if ((int)uVar9 < 0) {
                                                   *(uint*)( (long)local_1d48 + (long)(int)~uVar9 * 4 ) = uVar41 | (uint)local_1d70;
                                                }
 ...
 while ( ( uVar43 - iVar7 ) + 1 + iVar7 != iVar25 );
                              ...
                              LAB_001022be:if (( (int)local_1d34 < 0 ) && ( local_1d10 != 0 )) {
 ...
 while ( (int)local_1d58 < iVar10 );
                           ...
                           if ((int)uVar43 < 0x801f) {
                              ...
                              LAB_00102395:uVar26 = iVar25 - iVar11;
 ...
 while ( local_1108 + iVar11 != puVar21 );
                              ...
                              do {
                                 ...
                                 if (uVar26 << ( bVar6 & 0x1f ) == ( uVar14 & ~local_1da0 )) {
                                    lVar36 = 0;
                                    while (*(short*)( lVar17 + (long)(int)( ( uVar14 & local_1da0 ) - 1 ) * 2 + lVar36 ) == *(short*)( (long)puVar37 + lVar36 )) {
                                       lVar36 = lVar36 + 2;
...
;
 ...
 while ( uVar14 != 0 );
                              uVar41 = ~uVar41;
                              LAB_00102467:iVar10 = iVar11 + uVar8;
                              if (( (int)uVar41 < 0 ) || ( uVar26 = local_1da0 & *(uint*)( (long)__s + (long)(int)uVar41 * 4 ) ),sVar42 = (short)uVar26 + -1,uVar26 == 0) goto LAB_001027c3;
                              goto LAB_00102487;
                           }

                           LAB_00102a71:*(undefined4*)param_2 = 8;
                           uVar43 = 0;
                        }
 else {
                           if ((int)local_1d50 < 0) {
                     ...
                     LAB_001024a6:uprv_free_76_godot(local_1d48);
                  }
 else {
                     *(undefined4*)( this + 0xc ) = 0x7fff;
                  }

                  LAB_00102023:*(uint*)( this + 0x30 ) = local_1d38;
                  goto LAB_0010166b;
               }
               ...
               uVar8 = 0x80;
               uVar38 = 0;
               LAB_00100f88:puVar19 = puVar15 + (int)local_1da0;
               uVar9 = *puVar19;
               uVar18 = (ulong)uVar9;
               uVar41 = uVar8;
 ...
 while ( uVar27 != 0 );
                  ...
                  iVar11 = uVar8 - uVar14;
                  LAB_001013c8:if (-1 < (int)uVar12) {
                     if ((uint)local_1d58 == local_1da0) {
                        if (( (int)uVar38 <= (int)uVar12 ) || ( puVar34 = puVar15 ),(int)local_1da0 < param_1) goto LAB_00100fbc;
...
;
 ...
 while ( (int)uVar12 <= iVar11 );
                  ...
                  LAB_00101464:iVar11 = uVar8 - uVar14;
                  LAB_00101469:iVar7 = 0;
                        ...
                        while (uVar8 != 0) {
                           if (uVar12 == ( uVar8 & ~uVar43 )) {
                              ...
                              if (uVar14 == 0) {
                                 ...
                                 while (*(int*)( lVar17 + (long)(int)( ( uVar8 & uVar43 ) - 1 ) * 4 + lVar16 ) == *(int*)( (long)puVar19 + lVar16 )) {
                                    lVar16 = lVar16 + 4;
                                    uVar9 = uVar9 - 1;
                  ...
                  while (uVar12 != 0) {
                     if (uVar9 << ( bVar6 & 0x1f ) == ( uVar12 & ~uVar43 )) {
                        if (uVar14 == 0) {
                           ...
                           uVar18 = 0;
                           while (*(uint*)( lVar17 + (long)(int)( ( uVar12 & uVar43 ) - 1 ) * 4 + uVar18 * 4 ) == puVar34[uVar18]) {
                              uVar18 = uVar18 + 1;
...
;
                  uVar27 = ~uVar27;
                  LAB_0010130d:if (-1 < (int)uVar27) {
                     LAB_00101311:uVar12 = ( *(uint*)( (long)__s + (long)(int)uVar27 * 4 ) & uVar43 ) - 1;
...
;
 ...
 while ( uVar9 != 0 );
                  ...
                  LAB_00101871:lVar36 = 0;
                  do {
                     *(undefined4*)( lVar17 + (long)(int)uVar8 * 4 + lVar36 ) = *(undefined4*)( (long)puVar34 + lVar36 + (long)(int)uVar9 * 4 );
                     lVar36 = lVar36 + 4;
                  }
 while ( ( ulong )(uVar14 - uVar9) << 2 != lVar36 );
                  uVar41 = ( uVar8 + uVar14 ) - uVar9;
                  LAB_001018aa:iVar11 = -1;
                        ...
                        while (uVar8 != 0) {
                           if (uVar12 == ( uVar8 & ~uVar43 )) {
                              if (uVar14 == 0) {
                                 ...
                                 uVar33 = 0;
                                 while (*(int*)( lVar17 + (long)(int)( ( uVar8 & uVar43 ) - 1 ) * 4 + uVar33 * 4 ) == piVar24[uVar33]) {
                                    uVar33 = uVar33 + 1;
 ...
 while ( piVar24 != piVar28 );
                           ...
                           while (uVar14 != 0) {
                              if (uVar27 == ( uVar14 & ~uVar43 )) {
                                 lVar36 = 0;
                                 while (*(int*)( lVar17 + (long)(int)( ( uVar14 & uVar43 ) - 1 ) * 4 + lVar36 ) == *(int*)( (long)piVar24 + lVar36 + -0x40 )) {
                                    lVar36 = lVar36 + 4;
...
;
                           *(uint*)( (long)__s + (long)(int)uVar9 * 4 ) = uVar27 | uVar38;
                           LAB_0010114e:piVar24 = piVar24 + 1;
                        }
 while ( uVar38 != uVar41 - 0xf );
         ...
         LAB_0010166b:uprv_free_76_godot(__s);
         goto LAB_00101606;
      }

   }

   LAB_001015f8:uVar43 = 0;
   *(undefined4*)param_2 = 7;
                           ...
                           if (uVar11 == uVar5) {
                              if (*(int*)param_2 < 1) {
                                 if ((int)uVar5 < 0x110000) {
                                    cVar2 = (anonymous_namespace)::MutableCodePointTrie::ensureHighStart((MutableCodePointTrie*)this, uVar5);
                                    if (cVar2 != '\0') {
                                       iVar6 = (anonymous_namespace)::MutableCodePointTrie::getDataBlock((MutableCodePointTrie*)this, (int)uVar5 >> 4);
                                       if (-1 < iVar6) {
                                          *(uint*)( *(long*)( this + 0x10 ) + (long)(int)( iVar6 + ( uVar5 & 0xf ) ) * 4 ) = uVar1;
                                          goto LAB_001035c0;
                                       }
                                    ...
                                    *(undefined4*)param_2 = 7;
                                    ...
                                    LAB_00103650:*(undefined4*)param_2 = 1;
                                 }
                              ...
                              if (( 0x10ffff < uVar11 || 0x10ffff < uVar5 ) || ( (int)uVar5 < (int)uVar11 )) goto LAB_00103650;
                              icu_76_godot::
                              (anonymous_namespace)::MutableCodePointTrie::setRange((MutableCodePointTrie*)this, uVar11, uVar5, local_44, param_2);
                           }

                        }

                        LAB_001035c0:uVar11 = uVar5 + 1;
                     }
;
   ...
   this(UMemory * 0x0);
   LAB_001034f0:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return this;
   }
...
UMemory *umutablecptrie_fromUCPTrie_76_godot(long param_1, UErrorCode *param_2) {
   ...
   if (*(int*)param_2 < 1) {
      if (param_1 == 0) {
         LAB_0010371d:*(undefined4*)param_2 = 1;
      }
 else {
                           ...
                           if (uVar10 == uVar3) {
                              if (*(int*)param_2 < 1) {
                                 if ((int)uVar3 < 0x110000) {
                                    cVar2 = (anonymous_namespace)::MutableCodePointTrie::ensureHighStart((MutableCodePointTrie*)this, uVar3);
                                    if (cVar2 != '\0') {
                                       iVar4 = (anonymous_namespace)::MutableCodePointTrie::getDataBlock((MutableCodePointTrie*)this, (int)uVar3 >> 4);
                                       if (-1 < iVar4) {
                                          *(uint*)( *(long*)( this + 0x10 ) + (long)(int)( iVar4 + ( uVar3 & 0xf ) ) * 4 ) = uVar1;
                                          goto LAB_001038c0;
                                       }
                                    ...
                                    *(undefined4*)param_2 = 7;
                                    ...
                                    LAB_00103950:*(undefined4*)param_2 = 1;
                                 }
                              ...
                              if (( 0x10ffff < uVar10 || 0x10ffff < uVar3 ) || ( (int)uVar3 < (int)uVar10 )) goto LAB_00103950;
                              icu_76_godot::
                              (anonymous_namespace)::MutableCodePointTrie::setRange((MutableCodePointTrie*)this, uVar10, uVar3, local_44, param_2);
                           }

                        }

                        LAB_001038c0:uVar10 = uVar3 + 1;
                     }
;
   ...
   this(UMemory * 0x0);
   LAB_00103728:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return this;
   }
...
void umutablecptrie_getRange_76_godot(undefined8 param_1, undefined4 param_2, undefined4 param_3, undefined4 param_4, undefined8 param_5, undefined8 param_6, undefined8 param_7) {
   ucptrie_internalGetRange_76_godot((anonymous_namespace)::getRange, param_1, param_2, param_3, param_4, param_5, param_6, param_7);
   return;
}
void umutablecptrie_set_76_godot(MutableCodePointTrie *param_1, uint param_2, undefined4 param_3, int *param_4) {
   char cVar1;
   int iVar2;
   if (0 < *param_4) {
      return;
   ...
   if (param_2 < 0x110000) {
      cVar1 = (anonymous_namespace)::MutableCodePointTrie::ensureHighStart(param_1, param_2);
      if (( cVar1 != '\0' ) && ( iVar2 = -1 < iVar2 )) {
         *(undefined4*)( *(long*)( param_1 + 0x10 ) + (long)(int)( iVar2 + ( param_2 & 0xf ) ) * 4 ) = param_3;
         return;
      }
...
void umutablecptrie_setRange_76_godot(MutableCodePointTrie *param_1, uint param_2, uint param_3, uint param_4, UErrorCode *param_5) {
   if (0 < *(int*)param_5) {
      return;
   }
   ...
   if (( param_3 < 0x110000 && (int)param_2 <= (int)param_3 ) && ( param_2 < 0x110000 )) {
      icu_76_godot::
      (anonymous_namespace)::MutableCodePointTrie::setRange(param_1, param_2, param_3, param_4, param_5);
      return;
   }
...
long *umutablecptrie_buildImmutable_76_godot(MutableCodePointTrie *param_1, uint param_2, uint param_3, UErrorCode *param_4) {
   undefined4 uVar1;
   int iVar2;
   long lVar3;
   int iVar4;
   ...
   if (param_3 == 0) {
      icu_76_godot::
      (anonymous_namespace)::MutableCodePointTrie::maskValues(param_1, 0xffff);
   }
 else if (param_3 == 2) {
      icu_76_godot::
      (anonymous_namespace)::MutableCodePointTrie::maskValues(param_1, 0xff);
   }

   uVar6 = (anonymous_namespace)::MutableCodePointTrie::compactTrie(param_1, ( -(uint)(param_2 == 0) & 0xf00 ) + 0x100, param_4);
   ...
   if (param_3 == 1) {
      ...
      if (param_3 == 0) {
         ...
         if (( *(int*)( lVar3 + -4 + uVar15 * 4 ) != *(int*)( param_1 + 0x2c ) ) || ( *(int*)( lVar3 + -8 + uVar15 * 4 ) != *(int*)( param_1 + 0x34 ) )) {
         ...
         uVar12 = uVar16 & 3;
         if (uVar12 == 0) {
            if (( *(int*)( lVar3 + -4 + lVar19 ) != *(int*)( param_1 + 0x2c ) ) || ( *(int*)( lVar3 + -8 + lVar19 ) != iVar18 )) {
               LAB_00103f2c:*(uint*)( param_1 + 0x1c ) = uVar13 + 1;
               uVar13 = uVar12 + 1 & 3;
...
;
               LAB_00103f59:uVar13 = *(uint*)( param_1 + 0x1c );
               uVar15 = (ulong)(int)uVar13;
               iVar18 = *(int*)( param_1 + 0x34 );
               goto LAB_00103f64;
            }
            ...
            *(undefined4*)( lVar3 + uVar15 * 4 ) = *(undefined4*)( param_1 + 0x2c );
            ...
            LAB_00103f64:*(uint*)( param_1 + 0x1c ) = uVar13 + 1;
            *(int*)( lVar3 + uVar15 * 4 ) = iVar18;
            iVar18 = *(int*)( param_1 + 0x1c );
            *(int*)( param_1 + 0x1c ) = iVar18 + 1;
            *(undefined4*)( lVar3 + (long)iVar18 * 4 ) = *(undefined4*)( param_1 + 0x2c );

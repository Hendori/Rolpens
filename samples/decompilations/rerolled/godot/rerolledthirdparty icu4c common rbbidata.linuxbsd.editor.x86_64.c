/* icu_76_godot::RBBIDataWrapper::isDataVersionAcceptable(unsigned char const*) */bool icu_76_godot::RBBIDataWrapper::isDataVersionAcceptable(uchar *param_1) {
   return *param_1 == '\x06';
}
/* icu_76_godot::RBBIDataWrapper::init0() */undefined4 icu_76_godot::RBBIDataWrapper::init0(RBBIDataWrapper *this) {
   undefined4 uVar1;
   for (int i = 0; i < 3; i++) {
      *(undefined8*)( this + ( 16*i + 32 ) ) = 0;
   }
...
/* icu_76_godot::RBBIDataWrapper::init(icu_76_godot::RBBIDataHeader const*, UErrorCode&) */void icu_76_godot::RBBIDataWrapper::init(RBBIDataWrapper *this, RBBIDataHeader *param_1, UErrorCode *param_2) {
   undefined4 uVar1;
   int iVar2;
   uint uVar3;
   undefined8 uVar4;
   ...
   *(RBBIDataHeader**)this = param_1;
   if (( iVar2 == 0xb1a0 ) && ( param_1[4] == (RBBIDataHeader)0x6 )) {
      ...
      uVar4 = ucptrie_openFromBinary_76_godot(0, 0xffffffff, param_1 + *(uint*)( param_1 + 0x20 ), *(undefined4*)( param_1 + 0x24 ), 0, param_2);
      iVar2 = *(int*)param_2;
   ...
   *(undefined4*)param_2 = 3;
   LAB_0010008f:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* icu_76_godot::RBBIDataWrapper::RBBIDataWrapper(icu_76_godot::RBBIDataHeader const*, UErrorCode&)
    */void icu_76_godot::RBBIDataWrapper::RBBIDataWrapper(RBBIDataWrapper *this, RBBIDataHeader *param_1, UErrorCode *param_2) {
...
/* icu_76_godot::RBBIDataWrapper::RBBIDataWrapper(icu_76_godot::RBBIDataHeader const*,
   icu_76_godot::RBBIDataWrapper::EDontAdopt, UErrorCode&) */void icu_76_godot::RBBIDataWrapper::RBBIDataWrapper(RBBIDataWrapper *this, RBBIDataHeader *param_1, undefined8 param_3, UErrorCode *param_4) {
   *(code**)( this + 0x48 ) = udata_close_76_godot;
   *(undefined2*)( this + 0x50 ) = 2;
   for (int i = 0; i < 3; i++) {
      *(undefined8*)( this + ( 16*i + 32 ) ) = 0;
...
/* icu_76_godot::RBBIDataWrapper::RBBIDataWrapper(UDataMemory*, UErrorCode&) */ulong icu_76_godot::RBBIDataWrapper::RBBIDataWrapper(RBBIDataWrapper *this, UDataMemory *param_1, UErrorCode *param_2) {
   uint uVar1;
   int iVar2;
   ushort *puVar3;
   ulong uVar4;
   ...
   *(uint*)( this + 0x38 ) = 0;
   ...
   if (iVar2 < 1) {
      ...
      uVar4 = ( ulong ) * puVar3;
      if (( ( ( *puVar3 < 0x14 ) || ( puVar3[4] != 0 ) ) || ( puVar3[6] != 0x7242 ) ) || ( ( puVar3[7] != 0x206b || ( (char)puVar3[8] != '\x06' ) ) )) {
         *(undefined4*)param_2 = 3;
      }
 else {
...
/* icu_76_godot::RBBIDataWrapper::~RBBIDataWrapper() */void icu_76_godot::RBBIDataWrapper::~RBBIDataWrapper(RBBIDataWrapper *this) {
...
/* icu_76_godot::RBBIDataWrapper::TEMPNAMEPLACEHOLDERVALUE(icu_76_godot::RBBIDataWrapper const&)
   const */undefined8 icu_76_godot::RBBIDataWrapper::operator ==(RBBIDataWrapper *this, RBBIDataWrapper *param_1) {
   void *__s1;
   void *__s2;
   int iVar1;
...
/* icu_76_godot::RBBIDataWrapper::hashCode() */undefined4 icu_76_godot::RBBIDataWrapper::hashCode(RBBIDataWrapper *this) {
   return *(undefined4*)( *(long*)this + 0x14 );
}
/* icu_76_godot::RBBIDataWrapper::removeReference() */void icu_76_godot::RBBIDataWrapper::removeReference(void) {
   UMemory *pUVar1;
   void *in_RSI;
   UMemory *in_RDI;
   LOCK();
...
/* icu_76_godot::RBBIDataWrapper::addReference() */RBBIDataWrapper * __thiscall icu_76_godot::RBBIDataWrapper::addReference(RBBIDataWrapper *this){
   LOCK();
   *(int*)( this + 0x38 ) = *(int*)( this + 0x38 ) + 1;
   UNLOCK();
   return this;
}
/* icu_76_godot::RBBIDataWrapper::getRuleSourceString() const */RBBIDataWrapper * __thiscall
icu_76_godot::RBBIDataWrapper::getRuleSourceString(RBBIDataWrapper *this){
   return this + 0x48;
}
/* icu_76_godot::RBBIDataWrapper::printData() */void icu_76_godot::RBBIDataWrapper::printData(void) {
   return;
}
int ubrk_swap_76_godot(long param_1, long param_2, int param_3, long param_4, int *param_5) {
   ...
   if (( ( *(short*)( param_2 + 0xc ) != 0x7242 ) || ( *(short*)( param_2 + 0xe ) != 0x206b ) ) || ( *(char*)( param_2 + 0x10 ) != '\x06' )) {
      udata_printError_76_godot(param_1, "ubrk_swap(): data format %02x.%02x.%02x.%02x (format version %02x) is not recognized\n", *(undefined1*)( param_2 + 0xc ), *(undefined1*)( param_2 + 0xd ), *(undefined1*)( param_2 + 0xe ), *(undefined1*)( param_2 + 0xf ), *(undefined1*)( param_2 + 0x10 ));
      *param_5 = 0x10;
      return 0;
   }
   ...
   if (( ( iVar3 != 0xb1a0 ) || ( *(char*)( puVar8 + 1 ) != '\x06' ) ) || ( uVar4 = uVar4 < 0x50 )) {
   ...
   if (param_3 < iVar9) {
      udata_printError_76_godot(param_1, "ubrk_swap(): too few bytes (%d after ICU Data header) for break data.\n", iVar3);
      *param_5 = 8;
      return 0;
   }
   ...
   if (0 < iVar2) {
      ...
      if (( uVar4 & 4 ) == 0) {
         ( **(code**)( param_1 + 0x30 ) )(param_1, (long)puVar8 + lVar10 + 0x14, iVar2 + -0x14, (long)__s + lVar10 + 0x14, param_5);
      }
 else if (puVar8 != __s) {
         memmove((void*)( (long)__s + lVar10 + 0x14 ), (void*)( (long)puVar8 + lVar10 + 0x14 ), (long)( iVar2 + -0x14 ));
      }
   ...
   if (iVar2 < 1) {
      LAB_00100798:uVar4 = ( **(code**)( param_1 + 0x10 ) )(puVar8[8]);
      uVar5 = ( **(code**)( param_1 + 0x10 ) )(puVar8[9]);
      uVar6 = ( **(code**)( param_1 + 0x10 ) )(puVar8[8]);
      ucptrie_swap_76_godot(param_1, (ulong)uVar6 + (long)puVar8, uVar5, (ulong)uVar4 + (long)__s, param_5);
      ...
      if (puVar8 == __s) {
         ...
         uVar5 = ( **(code**)( param_1 + 0x10 ) )(puVar8[9]);
         uVar6 = ( **(code**)( param_1 + 0x10 ) )(puVar8[8]);
         ucptrie_swap_76_godot(param_1, (ulong)uVar6 + (long)puVar8, uVar5, (ulong)uVar4 + (long)puVar8, param_5);
         goto LAB_001006e7;
      }
   ...
   LAB_001006e7:pcVar1 = *(code**)( param_1 + 0x38 );

/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* putil_cleanup() */undefined8 putil_cleanup(void) {
   UMemory *this;
   void *in_RSI;
...
/* TimeZoneDataDirInitFn(UErrorCode&) */void TimeZoneDataDirInitFn(UErrorCode *param_1) {
   undefined1 *puVar1;
   long *plVar2;
   char *pcVar3;
   ulong uVar4;
...
undefined8 uprv_isNaN_76_godot(ulong param_1) {
   return CONCAT71(( int7 )(( param_1 & 0x7fffffffffffffff ) >> 8), 0x7ff0000000000000 < ( param_1 & 0x7fffffffffffffff ));
}
undefined8 uprv_isInfinite_76_godot(ulong param_1) {
   return CONCAT71(( int7 )(( param_1 & 0x7fffffffffffffff ) >> 8), ( param_1 & 0x7fffffffffffffff ) == 0x7ff0000000000000);
}
...
double uprv_floor_76_godot(double param_1) {
   if ((double)( (ulong)param_1 & _LC8 ) < _LC5) {
      param_1 = (double)( ( ulong )((double)(long)param_1 - (double)( -(ulong)(param_1 < (double)(long)param_1) & _LC7 )) | ~_LC8 & (ulong)param_1 );
   }
...
double uprv_ceil_76_godot(double param_1) {
   if ((double)( (ulong)param_1 & _LC8 ) < _LC5) {
      param_1 = (double)( ( ulong )((double)(long)param_1 + (double)( -(ulong)((double)(long)param_1 < param_1) & _LC7 )) | ~_LC8 & (ulong)param_1 );
   }

   return param_1;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */double uprv_round_76_godot(double param_1) {
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked */double uprv_modf_76_godot(double __x, double *__iptr) {
   double dVar1;
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked */double uprv_pow_76_godot(double __x, double __y) {
   double dVar1;
   dVar1 = pow(__x, __y);
   return dVar1;
}
...
double uprv_fmax_76_godot(double param_1, double param_2) {
   ...
   dVar1 = _LC3;
   if (( (ulong)ABS(param_2) < 0x7ff0000000000001 ) && ( ( param_1 != 0.0 || ( dVar1 = param_2 ),param_2 != 0.0 ) )) {
      if (param_1 <= param_2) {
         param_1 = param_2;
      }
...
double uprv_trunc_76_godot(double param_1) {
   ...
   if (ABS(param_1) != INFINITY) {
      ...
      if ((long)param_1 < 0) {
         if ((double)( (ulong)param_1 & _LC8 ) < _LC5) {
            return (double)( ( ulong )((double)(long)param_1 + (double)( -(ulong)((double)(long)param_1 < param_1) & _LC7 )) | ~_LC8 & (ulong)param_1 );
         }

      }
 else if ((double)( (ulong)param_1 & _LC8 ) < _LC5) {
         return (double)( ( ulong )((double)(long)param_1 - (double)( -(ulong)(param_1 < (double)(long)param_1) & _LC7 )) | ~_LC8 & (ulong)param_1 );
      }
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked */double uprv_log_76_godot(double __x) {
   double dVar1;
   dVar1 = log(__x);
   return dVar1;
}
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked */void uprv_tzset_76_godot(void) {
   tzset();
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined4 uprv_timezone_76_godot(void) {
   return ___timezone;
}
void uprv_tzname_clear_cache_76_godot(void) {
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */char *uprv_tzname_76_godot(int param_1) {
   char cVar1;
   int iVar2;
   int iVar3;
   char *pcVar4;
   ...
   if (pcVar4 == (char*)0x0) {
      ...
      iVar9 = 0;
      do {
         if (( ( iVar2 == *piVar8 ) && ( uVar10 == piVar8[1] ) ) && ( ( iVar3 = strcmp(*(char**)( piVar8 + 2 ), pcVar4) ),iVar3 == 0 && ( iVar3 = strcmp(*(char**)( piVar8 + 4 ), pcVar7) ),iVar3 == 0 )) {
 ...
 while ( iVar9 != 0x3b );
      ...
      if (cVar1 != '\0') {
         ...
         pcVar7 = pcVar4 + 1;
         cVar6 = cVar1;
         LAB_00100872:if (( 9 < ( byte )(cVar6 - 0x30U) ) && ( cVar6 != ',' )) goto code_r0x00100864;
         cVar6 = pcVar4[iVar2];
 ...
 while ( ( byte )(cVar6 - 0x30U) < 10 && iVar9 < iVar2 + 2 );
         ...
         if (( ( ( cVar6 != '\0' ) && ( iVar2 = strcmp(pcVar4, "PST8PDT") ),iVar2 != 0 ) ) && ( iVar2 = iVar2 != 0 )) &&( ( iVar2 = strcmp(pcVar4, "CST6CDT") ),iVar2 != 0 && ( iVar2 = iVar2 != 0 ) );
         LAB_001008c4:if (cVar1 == ':') {
            pcVar4 = pcVar4 + 1;
         }
   ...
   LAB_001008ec:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }

   return pcVar4;
   code_r0x00100864:cVar6 = *pcVar7;
   pcVar7 = pcVar7 + 1;
   iVar2 = iVar2 + 1;
...
undefined *u_getTimeZoneFilesDirectory_76_godot(UErrorCode *param_1) {
   ...
   if (( gTimeZoneFilesInitOnce_76_godot == 2 ) || ( cVar1 = icu_76_godot::umtx_initImplPreInit((UInitOnce*)&gTimeZoneFilesInitOnce_76_godot) ),cVar1 == '\0') {
      if (0 < DAT_0010129c) {
...
void u_setTimeZoneFilesDirectory_76_godot(char *param_1, UErrorCode *param_2) {
   ...
   if (gTimeZoneFilesInitOnce_76_godot == 2) {
      LAB_00100c71:if (0 < DAT_0010129c) {
   ...
   LAB_00100c42:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
char *uprv_getDefaultLocaleID_76_godot(void) {
   ...
   ;
   if (( ( uprv_getPOSIXIDForDefaultLocale() ) && ( ( pcVar5 = setlocale(5, (char*)0x0) ),pcVar5 == (char*)0x0 || ( ( ( *pcVar5 == 'C' && ( pcVar5[1] == '\0' ) ) || ( iVar2 = strcmp("POSIX", pcVar5) ),iVar2 == 0 ) ) ) )) {
      pcVar5 = "en_US_POSIX";
   }
   ...
   uprv_getPOSIXIDForDefaultLocale() {
      ...
      if (__s != (char*)0x0) {
         ...
         if (( ( *__s == 'C' ) && ( __s[1] == '\0' ) ) || ( iVar2 = iVar2 == 0 )) {
...
;
 ...
 while ( uVar3 < uVar2 );
   ...
   LAB_0010102b:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }

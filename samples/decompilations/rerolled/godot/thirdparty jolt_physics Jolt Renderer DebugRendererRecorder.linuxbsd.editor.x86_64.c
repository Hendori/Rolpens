/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JPH::HashTable<JPH::Ref<JPH::DebugRenderer::Geometry>,
   ...
   std::equal_to<JPH::Ref<JPH::DebugRenderer::Geometry> > >::rehash(unsigned int) [clone .isra.0] */void JPH::HashTable<JPH::Ref<JPH::DebugRenderer::Geometry>,std::pair<JPH::Ref<JPH::DebugRenderer::Geometry>,unsigned_int>,JPH::UnorderedMapDetail<JPH::Ref<JPH::DebugRenderer::Geometry>,unsigned_int>,JPH::Hash<JPH::Ref<JPH::DebugRenderer::Geometry>>,std::equal_to<JPH::Ref<JPH::DebugRenderer::Geometry>>>::rehash(uint param_1) {
   char *pcVar1;
   long *plVar2;
   undefined4 uVar3;
   ushort uVar4;
...
;
 ...
 while ( (uint)lVar7 < uVar22 );
   ...
   LAB_00100064:puVar21[uVar16] = *puVar21;
   lVar7 = 1;
   do {
      ...
      lVar7 = lVar7 + 1;
      *(undefined1*)( lVar17 + ( ulong )(uint)(iVar10 + *(int*)( CONCAT44(in_register_0000003c, param_1) + 0x14 )) ) = *puVar21;
      auVar5 = __LC0;
   }
 while ( lVar7 != 0xf );
   uVar22 = *(uint*)( CONCAT44(in_register_0000003c, param_1) + 0x14 );
...
/* JPH::DebugRendererRecorder::DrawLine(JPH::Vec3, JPH::Vec3, JPH::Color) */void JPH::DebugRendererRecorder::DrawLine(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, long param_5, undefined4 param_6) {
   long lVar1;
   ulong uVar2;
   int iVar3;
   ulong uVar4;
...
/* JPH::DebugRendererRecorder::DrawTriangle(JPH::Vec3, JPH::Vec3, JPH::Vec3, JPH::Color,
   JPH::DebugRenderer::ECastShadow) */void JPH::DebugRendererRecorder::DrawTriangle(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6, long param_7, undefined4 param_8, undefined4 param_9) {
   long lVar1;
   ulong uVar2;
   int iVar3;
   long lVar4;
...
/* JPH::DebugRendererRecorder::CreateTriangleBatch(JPH::DebugRenderer::Vertex const*, int, unsigned
   int const*, int) */Vertex *JPH::DebugRendererRecorder::CreateTriangleBatch(Vertex *param_1, int param_2, uint *param_3, int param_4) {
   long lVar1;
   int iVar2;
   undefined8 *puVar3;
   ...
   if (( ( ( param_3 == (uint*)0x0 ) || ( param_4 == 0 ) ) || ( in_R8 == 0 ) ) || ( in_R9D == 0 )) {
      ...
      *(int*)( lVar4 + 0x170 ) = local_48 + 1;
      ...
      ( **(code**)( **(long**)( lVar4 + 0x168 ) + 0x10 ) )(*(long**)( lVar4 + 0x168 ), param_3, (long)param_4 * 0x24);
      ( **(code**)( **(long**)( lVar4 + 0x168 ) + 0x10 ) )(*(long**)( lVar4 + 0x168 ), &local_44, 4);
      ( **(code**)( **(long**)( lVar4 + 0x168 ) + 0x10 ) )(*(long**)( lVar4 + 0x168 ), in_R8, (long)in_R9D << 2);
      puVar3 = (undefined8*)( *Allocate )(0x10);
      *puVar3 = &PTR__BatchImpl_00101ce8;
...
/* JPH::DebugRendererRecorder::CreateTriangleBatch(JPH::DebugRenderer::Triangle const*, int) */Triangle *JPH::DebugRendererRecorder::CreateTriangleBatch(Triangle *param_1, int param_2) {
   long lVar1;
   int iVar2;
   undefined8 *puVar3;
   int in_ECX;
   ...
   *(int*)( puVar3 + 1 ) = *(int*)( puVar3 + 1 ) + 1;
   UNLOCK();
   LAB_001007a7:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* JPH::DebugRendererRecorder::DrawText3D(JPH::Vec3, std::basic_string_view<char,
   std::char_traits<char> > const&, JPH::Color, float) */void JPH::DebugRendererRecorder::DrawText3D(ulong param_1, ulong param_2, undefined4 param_3, long param_4, ulong *param_5, uint param_6, ulong *param_7) {
   ...
   if (uVar18 < 0x10) {
      ...
      if ((long)uVar18 < 0) {
         ...
         for (; lVar10 != lVar13; lVar10 = lVar10 + 0x30) {
            ...
            ( **(code**)( **(long**)( pcVar17 + 0x168 ) + 0x10 ) )(*(long**)( pcVar17 + 0x168 ), lVar10 + 0x10, 0xc);
            ( **(code**)( **(long**)( pcVar17 + 0x168 ) + 0x10 ) )(*(long**)( pcVar17 + 0x168 ), lVar10 + 0x20, 4);
         }
         ...
         for (; lVar13 != lVar10; lVar10 = lVar10 + 0x40) {
            ( **(code**)( **(long**)( pcVar17 + 0x168 ) + 0x10 ) )(*(long**)( pcVar17 + 0x168 ), lVar10, 0xc);
            ( **(code**)( **(long**)( pcVar17 + 0x168 ) + 0x10 ) )(*(long**)( pcVar17 + 0x168 ), lVar10 + 0x10, 0xc);
            ( **(code**)( **(long**)( pcVar17 + 0x168 ) + 0x10 ) )(*(long**)( pcVar17 + 0x168 ), lVar10 + 0x20, 0xc);
            ( **(code**)( **(long**)( pcVar17 + 0x168 ) + 0x10 ) )(*(long**)( pcVar17 + 0x168 ), lVar10 + 0x30, 4);
            ( **(code**)( **(long**)( pcVar17 + 0x168 ) + 0x10 ) )(*(long**)( pcVar17 + 0x168 ), lVar10 + 0x34, 4);
         }
         ...
         if (lVar19 != lVar13) {
            do {
               ...
               ( **(code**)( **(long**)( pcVar17 + 0x168 ) + 0x10 ) )(*(long**)( pcVar17 + 0x168 ), lVar13 + 0x30, 4);
               lVar10 = lVar13 + 0x34;
               lVar13 = lVar13 + 0x40;
 ...
 while ( lVar19 != lVar13 );
         ...
         for (; lVar13 != lVar10; lVar10 = lVar10 + 0x60) {
            ...
            for (int i = 0; i < 5; i++) {
               ( **(code**)( **(long**)( pcVar17 + 360 ) + 16 ) )(*(long**)( pcVar17 + 360 ), lVar10 + ( 4*i + 64 ), 4);
            }
      ...
      local_68[0] = uVar18;
      LAB_00100b70:uStack_a0 = 0x100b7b;
            ...
            do {
               ...
               *puVar7 = uVar18;
               ...
               if (puVar2 == param_7) {
                  ...
                  if (7 < uVar15) {
                     *puVar8 = *param_7;
                     *(undefined8*)( (long)puVar7 + ( uVar18 & 0xffffffff ) + 0x18 ) = *(undefined8*)( (long)param_7 + ( ( uVar18 & 0xffffffff ) - 8 ) );
                     ...
                     if (7 < uVar15) {
                        ...
                        do {
                           uVar18 = (ulong)uVar12;
                           uVar12 = uVar12 + 8;
                           *(undefined8*)( ( ( ulong )(puVar7 + 5) & 0xfffffffffffffff8 ) + uVar18 ) = *(undefined8*)( (long)param_7 + ( uVar18 - lVar13 ) );
                        }
 while ( uVar12 < uVar15 );
                     }
                  ...
                  if (( uVar18 & 4 ) == 0) {
                     if (uVar15 != 0) {
                        ...
                        *(undefined2*)( (long)puVar7 + ( uVar18 & 0xffffffff ) + 0x1e ) = *(undefined2*)( (long)param_7 + ( ( uVar18 & 0xffffffff ) - 2 ) );
                        uVar16 = param_7[-1];
                     }
                     ...
                     *(undefined4*)( (long)puVar7 + ( uVar18 & 0xffffffff ) + 0x1c ) = *(undefined4*)( (long)param_7 + ( ( uVar18 & 0xffffffff ) - 4 ) );
                     uVar16 = param_7[-1];
                  }
 ...
 while ( puVar8 < puVar6 + lVar10 * 8 );
            LAB_00100a80:param_7 = *(ulong**)( param_4 + 0x1d8 );
         }
                  ...
                  if (uVar15 < 8) {
                     if (( uVar18 & 4 ) == 0) {
                        if (( uVar15 != 0 ) && ( *(char*)puVar7 = (char)*param_7(uVar18 & 2) != 0 )) {
                           *(undefined2*)( (long)puVar8 + ( uVar18 & 0xffffffff ) + 0x1e ) = *(undefined2*)( (long)param_7 + ( ( uVar18 & 0xffffffff ) - 2 ) );
                        }

                     }
 else {
                        *(int*)puVar7 = (int)*param_7;
                        *(undefined4*)( (long)puVar8 + ( uVar18 & 0xffffffff ) + 0x1c ) = *(undefined4*)( (long)param_7 + ( ( uVar18 & 0xffffffff ) - 4 ) );
                     }

                  }
 else {
                     LAB_00100cd8:uVar15 = auVar20._8_4_;
                     puVar9 = auVar20._0_8_;
                     *puVar7 = *param_7;
                     *(undefined8*)( (long)puVar7 + ( (ulong)uVar15 - 8 ) ) = *(undefined8*)( (long)param_7 + ( (ulong)uVar15 - 8 ) );
                     ...
                     if (7 < uVar15) {
                        ...
                        do {
                           uVar18 = (ulong)uVar12;
                           uVar12 = uVar12 + 8;
                           *(undefined8*)( ( ( ulong )(puVar9 + 5) & 0xfffffffffffffff8 ) + uVar18 ) = *(undefined8*)( (long)param_7 + ( uVar18 - lVar10 ) );
                        }
 while ( uVar12 < uVar15 );
                     }
         ...
         if (( uVar14 & 4 ) == 0) {
            if (uVar15 != 0) {
               *(undefined1*)puVar7 = (undefined1)local_68[0];
               if (( uVar14 & 2 ) != 0) {
                  *(undefined2*)( (long)puVar6 + ( uVar14 & 0xffffffff ) + 0x1e ) = *(undefined2*)( (long)local_68 + ( ( uVar14 & 0xffffffff ) - 2 ) );
               }
            ...
            *(undefined4*)( (long)puVar6 + ( uVar14 & 0xffffffff ) + 0x1c ) = *(undefined4*)( (long)local_68 + ( ( uVar14 & 0xffffffff ) - 4 ) );
         }

      }
 else {
         *puVar7 = local_68[0];
         *(undefined8*)( (long)puVar6 + ( uVar14 & 0xffffffff ) + 0x18 ) = *(undefined8*)( (long)local_68 + ( ( uVar14 & 0xffffffff ) - 8 ) );
         ...
         if (7 < uVar15) {
            ...
            do {
               uVar12 = (int)uVar14 + 8;
               *(undefined8*)( ( ( ulong )(puVar6 + 5) & 0xfffffffffffffff8 ) + uVar14 ) = *(undefined8*)( (long)local_68 + ( uVar14 - lVar10 ) );
               uVar14 = (ulong)uVar12;
            }
 while ( uVar12 < uVar15 );
         }
...
/* JPH::DebugRendererRecorder::EndFrame() */void JPH::DebugRendererRecorder::EndFrame(DebugRendererRecorder *this) {
   long *plVar1;
   char cVar2;
   int iVar3;
   long lVar4;
 ...
 while ( lVar8 != lVar6 );
   ...
   *(undefined8*)( this + 0x1c8 ) = 0;
   ...
   for (; lVar6 != lVar4; lVar4 = lVar4 + 0x60) {
      ...
      for (int i = 0; i < 5; i++) {
         ( **(code**)( **(long**)( this + 360 ) + 16 ) )(*(long**)( this + 360 ), lVar4 + ( 4*i + 64 ), 4);
      }
...
/* JPH::DebugRendererRecorder::DrawGeometry(JPH::Mat44 const&, JPH::AABox const&, float, JPH::Color,
   ...
   JPH::DebugRenderer::ECastShadow, JPH::DebugRenderer::EDrawMode) */void JPH::DebugRendererRecorder::DrawGeometry(long param_1, undefined8 *param_2, undefined8 param_3, undefined4 param_4, Ref *param_5, undefined4 param_6, undefined4 param_7, undefined4 param_8) {
   ulong uVar1;
   int *piVar2;
   bool bVar3;
   int iVar4;
   ...
   bVar3 = HashTable<JPH::Ref<JPH::DebugRenderer::Geometry>,std::pair<JPH::Ref<JPH::DebugRenderer::Geometry>,unsigned_int>,JPH::UnorderedMapDetail<JPH::Ref<JPH::DebugRenderer::Geometry>,unsigned_int>,JPH::Hash<JPH::Ref<JPH::DebugRenderer::Geometry>>,std::equal_to<JPH::Ref<JPH::DebugRenderer::Geometry>>>::InsertKey<false>((HashTable<JPH::Ref<JPH::DebugRenderer::Geometry>,std::pair<JPH::Ref<JPH::DebugRenderer::Geometry>,unsigned_int>,JPH::UnorderedMapDetail<JPH::Ref<JPH::DebugRenderer::Geometry>,unsigned_int>,JPH::Hash<JPH::Ref<JPH::DebugRenderer::Geometry>>,std::equal_to<JPH::Ref<JPH::DebugRenderer::Geometry>>>*)( param_1 + 0x178 ), param_5, &local_ac);
   ...
   *(int*)( puVar8 + 1 ) = iVar4;
   ...
   ( **(code**)( **(long**)( param_1 + 0x168 ) + 0x10 ) )(*(long**)( param_1 + 0x168 ), *(long*)param_5 + 0x20, 0xc);
   ( **(code**)( **(long**)( param_1 + 0x168 ) + 0x10 ) )(*(long**)( param_1 + 0x168 ), *(long*)param_5 + 0x30, 0xc);
   ...
   iVar4 = *(int*)( puVar8 + 1 );
   LAB_0010126f:lVar7 = *(long*)( param_1 + 0x1e0 );
   local_a8 = *param_2;
   uStack_a0 = param_2[1];
   local_98 = param_2[2];
   uStack_90 = param_2[3];
...
/* JPH::DebugRendererRecorder::BatchImpl::~BatchImpl() */void JPH::DebugRendererRecorder::BatchImpl::~BatchImpl(BatchImpl *this) {
   return;
}
/* JPH::DebugRendererRecorder::BatchImpl::~BatchImpl() */void JPH::DebugRendererRecorder::BatchImpl::~BatchImpl(BatchImpl *this) {
...
/* JPH::DebugRendererRecorder::~DebugRendererRecorder() */void JPH::DebugRendererRecorder::~DebugRendererRecorder(DebugRendererRecorder *this) {
   long *plVar1;
   int *piVar2;
   long *plVar3;
   long lVar4;
   ...
   *(undefined***)this = &PTR__DebugRendererRecorder_00101d18;
   ...
   uVar5 = *(ulong*)( this + 0x1d8 );
   if (uVar5 != 0) {
      if (( *(long*)( this + 0x1c8 ) != 0 ) && ( uVar7 = uVar5 < uVar7 )) {
         do {
            if (*(long*)( uVar5 + 0x10 ) != uVar5 + 0x20) {
               ( *Free )();
            }
 ...
 while ( uVar5 < uVar7 );
   ...
   if (( *(int*)( this + 0x188 ) != 0 ) && ( *(int*)( this + 0x18c ) != 0 )) {
      lVar4 = 0;
      do {
         while (( -1 < *(char*)( *(long*)( this + 0x180 ) + lVar4 ) || ( piVar2 = *(int**)( lVar6 + lVar4 * 0x10 ) ),piVar2 == (int*)0x0 )) {
            lVar4 = lVar4 + 1;
         ...
         *piVar2 = *piVar2 + -1;
         ...
         if (*piVar2 == 0) {
            ...
            if (puVar8 != (undefined8*)0x0) {
               if (( *(long*)( piVar2 + 2 ) != 0 ) && ( puVar9 = puVar8 < puVar9 )) {
                  do {
                     plVar3 = (long*)*puVar8;
                     if (plVar3 != (long*)0x0) {
...
/* JPH::HashTable<JPH::Ref<JPH::DebugRenderer::Geometry>,
   ...
   JPH::UnorderedMapDetail<JPH::Ref<JPH::DebugRenderer::Geometry>, unsigned int>,
   JPH::Hash<JPH::Ref<JPH::DebugRenderer::Geometry> >,
   std::equal_to<JPH::Ref<JPH::DebugRenderer::Geometry> > >::GrowTable() */void JPH::HashTable<JPH::Ref<JPH::DebugRenderer::Geometry>,std::pair<JPH::Ref<JPH::DebugRenderer::Geometry>,unsigned_int>,JPH::UnorderedMapDetail<JPH::Ref<JPH::DebugRenderer::Geometry>,unsigned_int>,JPH::Hash<JPH::Ref<JPH::DebugRenderer::Geometry>>,std::equal_to<JPH::Ref<JPH::DebugRenderer::Geometry>>>::GrowTable(HashTable<JPH::Ref<JPH::DebugRenderer::Geometry>,std::pair<JPH::Ref<JPH::DebugRenderer::Geometry>,unsigned_int>,JPH::UnorderedMapDetail<JPH::Ref<JPH::DebugRenderer::Geometry>,unsigned_int>,JPH::Hash<JPH::Ref<JPH::DebugRenderer::Geometry>>,std::equal_to<JPH::Ref<JPH::DebugRenderer::Geometry>>> *this) {
   void *__s;
   char *pcVar1;
   uint uVar2;
   undefined8 *puVar3;
...
;
                  ...
                  *(byte*)( *(long*)( this + 8 ) + ( ulong )(( uVar7 - 0xf & *(int*)( this + 0x14 ) - 1U ) + 0xf) ) = bVar13;
                  uVar4 = *puVar14;
...
;
 ...
 while ( puVar3 + (ulong)uVar2 * 2 != puVar14 );
         ...
         LAB_001019b5:if (local_40[0] == *(long*)( in_FS_OFFSET + 0x28 )) {
   ...
   LAB_00101a00:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* bool JPH::HashTable<JPH::Ref<JPH::DebugRenderer::Geometry>,
   ...
   >::InsertKey<false>(JPH::Ref<JPH::DebugRenderer::Geometry> const&, unsigned int&) */bool JPH::HashTable<JPH::Ref<JPH::DebugRenderer::Geometry>,std::pair<JPH::Ref<JPH::DebugRenderer::Geometry>,unsigned_int>,JPH::UnorderedMapDetail<JPH::Ref<JPH::DebugRenderer::Geometry>,unsigned_int>,JPH::Hash<JPH::Ref<JPH::DebugRenderer::Geometry>>,std::equal_to<JPH::Ref<JPH::DebugRenderer::Geometry>>>::InsertKey<false>(HashTable<JPH::Ref<JPH::DebugRenderer::Geometry>,std::pair<JPH::Ref<JPH::DebugRenderer::Geometry>,unsigned_int>,JPH::UnorderedMapDetail<JPH::Ref<JPH::DebugRenderer::Geometry>,unsigned_int>,JPH::Hash<JPH::Ref<JPH::DebugRenderer::Geometry>>,std::equal_to<JPH::Ref<JPH::DebugRenderer::Geometry>>> *this, Ref *param_1, uint *param_2) {
   uint uVar1;
   byte bVar2;
   ushort uVar3;
   int iVar4;
...
/* JPH::DebugRendererRecorder::DrawLine(JPH::Vec3, JPH::Vec3, JPH::Color) */void JPH::DebugRendererRecorder::_GLOBAL__sub_I_DrawLine(void) {
   if (DVec3::cTrue == '\0') {
      DVec3::cTrue = '\x01';
      DVec3::cTrue = _LC4;
   }
...
/* WARNING: Control flow encountered bad instruction data *//* JPH::DebugRendererRecorder::~DebugRendererRecorder() */void JPH::DebugRendererRecorder::~DebugRendererRecorder(DebugRendererRecorder *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* JPH::DebugRendererRecorder::BatchImpl::~BatchImpl() */void JPH::DebugRendererRecorder::BatchImpl::~BatchImpl(BatchImpl *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

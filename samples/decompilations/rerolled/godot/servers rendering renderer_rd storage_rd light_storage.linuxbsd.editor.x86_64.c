...
/* RendererRD::LightStorage::reflection_probe_instance_needs_redraw(RID) */bool RendererRD::LightStorage::reflection_probe_instance_needs_redraw(LightStorage *this, ulong param_2) {
   ...
   if (( param_2 != 0 ) && ( (uint)param_2 < *(uint*)( this + 0x1e4 ) )) {
      ...
      if (*(int*)( puVar2 + 0xd ) == (int)( param_2 >> 0x20 )) {
         ...
         if (( *(char*)( puVar2 + 3 ) == '\0' ) && ( iVar1 = ( **(code**)( *singleton + 0x220 ) )(singleton, *puVar2) ),iVar1 != 1) {
...
/* RendererRD::LightStorage::reflection_probe_get_size(RID) const */undefined1[16];RendererRD::LightStorage::reflection_probe_get_size (LightStorage *this,ulong param_2) {
   long lVar1;
   long lVar2;
   long in_FS_OFFSET;
...
/* RendererRD::LightStorage::reflection_probe_get_origin_offset(RID) const */undefined1[16];RendererRD::LightStorage::reflection_probe_get_origin_offset (LightStorage *this,ulong param_2) {
   long lVar1;
   long lVar2;
   long in_FS_OFFSET;
   undefined1 auVar3[16];
...
/* RendererRD::LightStorage::reflection_probe_instance_free(RID) */undefined1[16];RendererRD::LightStorage::reflection_probe_instance_free (LightStorage *this,ulong param_2) {
   int iVar1;
   int iVar2;
   code *pcVar3;
   uint uVar4;
...
/* RendererRD::LightStorage::reflection_probe_get_ambient_color(RID) const */undefined1[16];RendererRD::LightStorage::reflection_probe_get_ambient_color (LightStorage *this,ulong param_2) {
   int iVar1;
   long lVar2;
   if (( param_2 != 0 ) && ( (uint)param_2 < *(uint*)( this + 0x134 ) )) {
      lVar2 = ( ( param_2 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x130 ) ) * 0x90 + *(long*)( *(long*)( this + 0x120 ) + ( ( param_2 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x130 ) ) * 8 );
...
/* RendererRD::LightStorage::get_directional_shadow_rect() */undefined1[16];RendererRD::LightStorage::get_directional_shadow_rect (LightStorage *this) {
   uint uVar1;
   int iVar2;
   int iVar3;
   int iVar4;
...
/* RendererRD::LightStorage::reflection_atlas_free(RID) */undefined1[16];RendererRD::LightStorage::reflection_atlas_free (LightStorage *this,ulong param_2) {
   int iVar1;
...
/* RendererRD::LightStorage::light_get_color(RID) */undefined1[16];RendererRD::LightStorage::light_get_color (LightStorage *this,ulong param_2) {
   int iVar1;
   long lVar2;
   if (( param_2 != 0 ) && ( (uint)param_2 < *(uint*)( this + 0x2c ) )) {
      lVar2 = ( ( param_2 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x28 ) ) * 0xe8 + *(long*)( *(long*)( this + 0x18 ) + ( ( param_2 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x28 ) ) * 8 );

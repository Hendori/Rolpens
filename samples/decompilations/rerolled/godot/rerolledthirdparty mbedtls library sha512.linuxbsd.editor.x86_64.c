...
undefined8 mbedtls_internal_sha512_process(long param_1, long param_2) {
   ...
   lVar7 = 0;
   for (int i = 0; i < 8; i++) {
      local_308[( i + 80 )] = *(ulong*)( param_1 + ( 8*i + 16 ) );
   }

   do {
      uVar3 = *(ulong*)( param_2 + lVar7 );
      *(ulong*)( (long)local_308 + lVar7 ) = uVar3 >> 0x38 | ( uVar3 & 0xff000000000000 ) >> 0x28 | ( uVar3 & 0xff0000000000 ) >> 0x18 | ( uVar3 & 0xff00000000 ) >> 8 | ( uVar3 & 0xff000000 ) << 8 | ( uVar3 & 0xff0000 ) << 0x18 | ( uVar3 & 0xff00 ) << 0x28 | uVar3 << 0x38;
      lVar7 = lVar7 + 8;
   }
 while ( lVar7 != 0x80 );
   ...
   do {
      ...
      uVar4 = puVar8[-0xe];
      puVar9 = puVar8 + 2;
      local_308[0xe] = puVar8[-7] + puVar8[-0x10] + ( ( uVar3 << 0x38 | uVar3 >> 8 ) ^ ( uVar3 << 0x3f | uVar3 >> 1 ) ^ uVar3 >> 7 ) + ( local_308[0xe] >> 6 ^ ( local_308[0xe] << 3 | local_308[0xe] >> 0x3d ) ^ ( local_308[0xe] << 0x2d | local_308[0xe] >> 0x13 ) );
      local_308[0xf] = puVar8[-6] + puVar8[-0xf] + ( ( uVar4 << 0x38 | uVar4 >> 8 ) ^ ( uVar4 << 0x3f | uVar4 >> 1 ) ^ uVar4 >> 7 ) + ( local_308[0xf] >> 6 ^ ( local_308[0xf] << 3 | local_308[0xf] >> 0x3d ) ^ ( local_308[0xf] << 0x2d | local_308[0xf] >> 0x13 ) );
 ...
 while ( local_308 + 0x50 != puVar9 );
   ...
   puVar8 = local_308;
   do {
      lVar7 = ( ( local_308[0x54] >> 0xe | local_308[0x54] << 0x32 ) ^ ( local_308[0x54] >> 0x12 | local_308[0x54] << 0x2e ) ^ ( local_308[0x54] << 0x17 | local_308[0x54] >> 0x29 ) ) + *puVar8 + *(long*)pNVar10 + ( ( local_308[0x56] ^ local_308[0x55] ) & local_308[0x54] ^ local_308[0x56] ) + local_308[0x57];
      local_308[0x53] = local_308[0x53] + lVar7;
      local_308[0x57] = ( ( local_308[0x50] >> 0x1c | local_308[0x50] << 0x24 ) ^ ( local_308[0x50] << 0x1e | local_308[0x50] >> 0x22 ) ^ ( local_308[0x50] << 0x19 | local_308[0x50] >> 0x27 ) ) + lVar7 + ( ( local_308[0x50] | local_308[0x51] ) & local_308[0x52] | local_308[0x50] & local_308[0x51] );
      lVar7 = puVar8[1] + *(long*)&pNVar10->type + local_308[0x56] + ( ( local_308[0x54] ^ local_308[0x55] ) & local_308[0x53] ^ local_308[0x55] ) + ( ( local_308[0x53] >> 0xe | local_308[0x53] << 0x32 ) ^ ( local_308[0x53] >> 0x12 | local_308[0x53] << 0x2e ) ^ ( local_308[0x53] * 0x800000 | local_308[0x53] >> 0x29 ) );
      local_308[0x52] = lVar7 + local_308[0x52];
      local_308[0x56] = ( ( local_308[0x57] >> 0x1c | local_308[0x57] << 0x24 ) ^ ( local_308[0x57] * 0x40000000 | local_308[0x57] >> 0x22 ) ^ ( local_308[0x57] * 0x2000000 | local_308[0x57] >> 0x27 ) ) + lVar7 + ( ( local_308[0x57] | local_308[0x50] ) & local_308[0x51] | local_308[0x57] & local_308[0x50] );
      lVar7 = puVar8[2] + *(long*)( pNVar10 + 1 ) + local_308[0x55] + ( ( local_308[0x54] ^ local_308[0x53] ) & local_308[0x52] ^ local_308[0x54] ) + ( ( local_308[0x52] >> 0xe | local_308[0x52] << 0x32 ) ^ ( local_308[0x52] >> 0x12 | local_308[0x52] << 0x2e ) ^ ( local_308[0x52] * 0x800000 | local_308[0x52] >> 0x29 ) );
      local_308[0x51] = local_308[0x51] + lVar7;
      local_308[0x55] = ( ( local_308[0x56] >> 0x1c | local_308[0x56] << 0x24 ) ^ ( local_308[0x56] * 0x40000000 | local_308[0x56] >> 0x22 ) ^ ( local_308[0x56] * 0x2000000 | local_308[0x56] >> 0x27 ) ) + lVar7 + ( ( local_308[0x57] | local_308[0x56] ) & local_308[0x50] | local_308[0x57] & local_308[0x56] );
      lVar7 = local_308[0x54] + puVar8[3] + *(long*)&pNVar10[1].type + ( ( local_308[0x53] ^ local_308[0x52] ) & local_308[0x51] ^ local_308[0x53] ) + ( ( local_308[0x51] >> 0xe | local_308[0x51] << 0x32 ) ^ ( local_308[0x51] >> 0x12 | local_308[0x51] << 0x2e ) ^ ( local_308[0x51] * 0x800000 | local_308[0x51] >> 0x29 ) );
      local_308[0x50] = local_308[0x50] + lVar7;
      local_308[0x54] = ( ( local_308[0x55] >> 0x1c | local_308[0x55] << 0x24 ) ^ ( local_308[0x55] * 0x40000000 | local_308[0x55] >> 0x22 ) ^ ( local_308[0x55] * 0x2000000 | local_308[0x55] >> 0x27 ) ) + lVar7 + ( ( local_308[0x56] | local_308[0x55] ) & local_308[0x57] | local_308[0x56] & local_308[0x55] );
      lVar7 = puVar8[4] + *(long*)( pNVar10 + 2 ) + local_308[0x53] + ( ( local_308[0x52] ^ local_308[0x51] ) & local_308[0x50] ^ local_308[0x52] ) + ( ( local_308[0x50] >> 0xe | local_308[0x50] << 0x32 ) ^ ( local_308[0x50] >> 0x12 | local_308[0x50] << 0x2e ) ^ ( local_308[0x50] * 0x800000 | local_308[0x50] >> 0x29 ) );
      local_308[0x57] = local_308[0x57] + lVar7;
      local_308[0x53] = ( ( local_308[0x54] >> 0x1c | local_308[0x54] << 0x24 ) ^ ( local_308[0x54] * 0x40000000 | local_308[0x54] >> 0x22 ) ^ ( local_308[0x54] * 0x2000000 | local_308[0x54] >> 0x27 ) ) + lVar7 + ( ( local_308[0x55] | local_308[0x54] ) & local_308[0x56] | local_308[0x55] & local_308[0x54] );
      lVar7 = puVar8[5] + *(long*)&pNVar10[2].type + local_308[0x52] + ( ( local_308[0x51] ^ local_308[0x50] ) & local_308[0x57] ^ local_308[0x51] ) + ( ( local_308[0x57] >> 0xe | local_308[0x57] << 0x32 ) ^ ( local_308[0x57] >> 0x12 | local_308[0x57] << 0x2e ) ^ ( local_308[0x57] * 0x800000 | local_308[0x57] >> 0x29 ) );
      local_308[0x56] = local_308[0x56] + lVar7;
      local_308[0x52] = ( ( local_308[0x53] >> 0x1c | local_308[0x53] << 0x24 ) ^ ( local_308[0x53] * 0x40000000 | local_308[0x53] >> 0x22 ) ^ ( local_308[0x53] * 0x2000000 | local_308[0x53] >> 0x27 ) ) + lVar7 + ( ( local_308[0x54] | local_308[0x53] ) & local_308[0x55] | local_308[0x54] & local_308[0x53] );
      lVar7 = puVar8[6] + *(long*)( pNVar10 + 3 ) + local_308[0x51] + ( ( local_308[0x50] ^ local_308[0x57] ) & local_308[0x56] ^ local_308[0x50] ) + ( ( local_308[0x56] >> 0xe | local_308[0x56] << 0x32 ) ^ ( local_308[0x56] >> 0x12 | local_308[0x56] << 0x2e ) ^ ( local_308[0x56] * 0x800000 | local_308[0x56] >> 0x29 ) );
      local_308[0x55] = local_308[0x55] + lVar7;
      pNVar11 = pNVar10 + 4;
      local_308[0x51] = ( ( local_308[0x52] >> 0x1c | local_308[0x52] << 0x24 ) ^ ( local_308[0x52] * 0x40000000 | local_308[0x52] >> 0x22 ) ^ ( local_308[0x52] * 0x2000000 | local_308[0x52] >> 0x27 ) ) + lVar7 + ( ( local_308[0x53] | local_308[0x52] ) & local_308[0x54] | local_308[0x53] & local_308[0x52] );
      local_318 = puVar8[7] + *(long*)&pNVar10[3].type + local_308[0x50] + ( ( local_308[0x57] ^ local_308[0x56] ) & local_308[0x55] ^ local_308[0x57] ) + ( ( local_308[0x55] >> 0xe | local_308[0x55] << 0x32 ) ^ ( local_308[0x55] >> 0x12 | local_308[0x55] << 0x2e ) ^ ( local_308[0x55] * 0x800000 | local_308[0x55] >> 0x29 ) );
      local_310 = ( ( local_308[0x51] >> 0x1c | local_308[0x51] << 0x24 ) ^ ( local_308[0x51] * 0x40000000 | local_308[0x51] >> 0x22 ) ^ ( local_308[0x51] * 0x2000000 | local_308[0x51] >> 0x27 ) ) + ( ( local_308[0x52] | local_308[0x51] ) & local_308[0x53] | local_308[0x52] & local_308[0x51] );
...
int mbedtls_sha512_finish(ulong *param_1, ulong *param_2) {
   ...
   if (uVar6 < 0x71) {
      ...
      if (uVar3 < 8) {
         ...
         *(undefined8*)( (long)puVar5 + ( (ulong)uVar3 - 8 ) ) = 0;
         uVar7 = ( ulong )(uVar3 + ( (int)puVar5 - (int)(undefined8*)( ( ulong )(puVar5 + 1) & 0xfffffffffffffff8 ) ) >> 3);
 ...
 while ( uVar6 < uVar3 );
      ...
      for (uVar7 = ( ulong )(( (int)puVar1 - (int)(undefined8*)( ( ulong )(param_1 + 0xb) & 0xfffffffffffffff8 ) ) + 0x70U >> 3); uVar7 != 0; uVar7 = uVar7 - 1) {
         *puVar5 = 0;
   ...
   uVar8 = uVar7 << 3;
   uVar2 = param_1[1] << 3;
   param_1[0x19] = uVar8 >> 0x38 | ( uVar8 & 0xff000000000000 ) >> 0x28 | ( uVar8 & 0xff0000000000 ) >> 0x18 | ( uVar8 & 0xff00000000 ) >> 8 | ( uVar8 & 0xff000000 ) << 8 | ( uVar8 & 0xff0000 ) << 0x18 | ( uVar8 & 0xff00 ) << 0x28 | uVar7 << 0x3b;
   param_1[0x18] = uVar2 >> 0x38 | ( uVar2 & 0xff000000000000 ) >> 0x28 | ( uVar2 & 0xff0000000000 ) >> 0x18 | ( uVar2 & 0xff00000000 ) >> 8 | ( uVar2 & 0xff000000 ) << 8 | ( uVar2 & 0xff0000 ) << 0x18 | ( uVar2 & 0xff00 ) << 0x28 | ( uVar7 >> 0x3d | uVar2 ) << 0x38;
   iVar4 = mbedtls_internal_sha512_process(param_1, param_1 + 10);
   if (iVar4 == 0) {
      uVar7 = param_1[2];
      *param_2 = uVar7 >> 0x38 | ( uVar7 & 0xff000000000000 ) >> 0x28 | ( uVar7 & 0xff0000000000 ) >> 0x18 | ( uVar7 & 0xff00000000 ) >> 8 | ( uVar7 & 0xff000000 ) << 8 | ( uVar7 & 0xff0000 ) << 0x18 | ( uVar7 & 0xff00 ) << 0x28 | uVar7 << 0x38;
      for (int i = 0; i < 5; i++) {
         uVar7 = param_1[( i + 3 )];
         param_2[( i + 1 )] = uVar7 >> 56 | ( uVar7 & 71776119061217280 ) >> 40 | ( uVar7 & 280375465082880 ) >> 24 | ( uVar7 & 1095216660480 ) >> 8 | ( uVar7 & 4278190080 ) << 8 | ( uVar7 & 16711680 ) << 24 | ( uVar7 & 65280 ) << 40 | uVar7 << 56;
      }

      if ((uint)param_1[0x1a] == 0) {
         uVar7 = param_1[8];
         param_2[6] = uVar7 >> 0x38 | ( uVar7 & 0xff000000000000 ) >> 0x28 | ( uVar7 & 0xff0000000000 ) >> 0x18 | ( uVar7 & 0xff00000000 ) >> 8 | ( uVar7 & 0xff000000 ) << 8 | ( uVar7 & 0xff0000 ) << 0x18 | ( uVar7 & 0xff00 ) << 0x28 | uVar7 << 0x38;
         uVar7 = param_1[9];
         param_2[7] = uVar7 >> 0x38 | ( uVar7 & 0xff000000000000 ) >> 0x28 | ( uVar7 & 0xff0000000000 ) >> 0x18 | ( uVar7 & 0xff00000000 ) >> 8 | ( uVar7 & 0xff000000 ) << 8 | ( uVar7 & 0xff0000 ) << 0x18 | ( uVar7 & 0xff00 ) << 0x28 | uVar7 << 0x38;
      }

   }

   LAB_00100b04:mbedtls_platform_zeroize(param_1, 0xd8);
   return iVar4;
}
int mbedtls_sha512_common_self_test(int param_1, int param_2) {
 ...
 while ( iVar5 != 0 );
         LAB_00100e0d:iVar1 = mbedtls_sha512_finish(local_168, local_88);
         if (iVar1 != 0) goto LAB_00100f68;
 ...
 while ( lVar3 != 3 );
      ...
      LAB_00100e71:mbedtls_platform_zeroize(local_168, 0xd8);
      free(__ptr);
   }

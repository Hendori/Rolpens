/* JustifyTotal::accumulate(graphite2::Slot*, graphite2::Segment*, int) */void JustifyTotal::accumulate(JustifyTotal *this, Slot *param_1, Segment *param_2, int param_3) {
   int iVar1;
   uchar uVar2;
   uchar uVar3;
   uVar2 = (uchar)param_3;
   *(int*)this = *(int*)this + 1;
   ...
   for (int i = 0; i < 4; i++) {
      ...
      *(int*)( this + ( 4*i + 4 ) ) = *(int*)( this + ( 4*i + 4 ) ) + iVar1;
   }

   return;
}
/* graphite2::Segment::addLineEnd(graphite2::Slot*) */Segment * __thiscall graphite2::Segment::addLineEnd(Segment *this,Slot *param_1){
   undefined8 uVar1;
   ushort uVar2;
   undefined4 uVar3;
   undefined8 *puVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* graphite2::Segment::justify(graphite2::Slot*, graphite2::Font const*, float,
   graphite2::justFlags, graphite2::Slot*, graphite2::Slot*) */void graphite2::Segment::justify(float param_3, Segment *this, Slot *param_1, Slot *param_2, uint param_5, Slot *param_6, Slot *param_7) {
   byte bVar1;
   long *plVar2;
   code *pcVar3;
   undefined8 uVar4;
   ...
   pSVar14 = param_6;
   if (( ( (byte)this[0xc4] & 1 ) != *(byte*)( lVar12 + 0x2f ) ) && ( *(char*)( lVar12 + 0x2d ) != *(char*)( lVar12 + 0x28 ) )) {
 ...
 while ( *(Slot**)( pSVar14 + 0x28 ) != (Slot*)0x0 );
   ...
   if (( ( param_5 & 2 ) == 0 ) && ( pSVar24 != pSVar14 )) {
      do {
         pfVar11 = (float*)graphite2::GlyphCache::glyph(( ushort ) * (undefined8*)( *(long*)( this + 0x88 ) + 0x78 ));
         ...
         if (( bVar6 ) || ( pSVar14 = pSVar14 == pSVar24 )) goto LAB_001002b2;
      }
 while ( pSVar14 != (Slot*)0x0 );
   }
 else {
      LAB_001002b2:local_80 = *(Slot**)( pSVar14 + 0x38 );
   }
   ...
   uVar21 = (uchar)this;
   if (bVar1 == 0) {
      if (( param_1 != (Slot*)0x0 ) && ( pSVar19 = local_80 != param_1 )) {
         do {
            ...
            if (( uint )(iVar17 - 9U < 5) + ( uint )(iVar17 == 0x20) + ( uint )(iVar17 == 0x85) + ( uint )(iVar17 == 0xa0) + ( uint )(iVar17 == 0x1680) + ( uint )(iVar17 == 0x180e) + ( uint )(iVar17 - 0x2000U < 0xb) + ( uint )(iVar17 == 0x2028) + ( uint )(iVar17 == 0x2029) + ( uint )(iVar17 == 0x202f) + ( uint )(iVar17 == 0x205f) + ( uint )(iVar17 == 0x3000) != 0) {
...
;
 ...
 while ( iVar17 != -1 );
   ...
   LAB_00100545:uVar4 = *(undefined8*)( this + 0x98 );
   ...
   graphite2::Segment::positionSlots((Font*)this, param_2, local_50, SUB81(pSVar14, 0), this[0xc4] != (Segment)0x0);
   lVar12 = *(long*)( this + 0x90 );
   ...
   *(undefined8*)( this + 0xa0 ) = uVar5;
   if (( ( (byte)this[0xc4] & 1 ) != *(byte*)( lVar12 + 0x2f ) ) && ( *(char*)( lVar12 + 0x28 ) != *(char*)( lVar12 + 0x2d ) )) {
      graphite2::Segment::reverseSlots();
   }

   LAB_00100695:free(local_48);
   return;
}
/* graphite2::Segment::delLineEnd(graphite2::Slot*) */void graphite2::Segment::delLineEnd(Segment *this, Slot *param_1) {
   long lVar1;
   long *plVar2;
   lVar1 = *(long*)param_1;
...
/* graphite2::Segment::justify(graphite2::Slot*, graphite2::Font const*, float,
   graphite2::justFlags, graphite2::Slot*, graphite2::Slot*) [clone .cold] */void graphite2::Segment::justify(void) {
   /* WARNING: Subroutine does not return */
   abort();
}

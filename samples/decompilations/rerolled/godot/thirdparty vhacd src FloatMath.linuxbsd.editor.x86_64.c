/* FLOAT_MATH::CTriangulator::~CTriangulator() */void FLOAT_MATH::CTriangulator::~CTriangulator(CTriangulator *this) {
   void *pvVar1;
...
/* FLOAT_MATH::fm_inverseRT(float const*, float const*, float*) */void FLOAT_MATH::fm_inverseRT(float *param_1, float *param_2, float *param_3) {
   float fVar1;
   float fVar2;
   float fVar3;
...
/* FLOAT_MATH::fm_getDeterminant(float const*) */float FLOAT_MATH::fm_getDeterminant(float *param_1) {
   return ( param_1[5] * param_1[10] - param_1[6] * param_1[9] ) * *param_1 + ( param_1[6] * param_1[8] - param_1[10] * param_1[4] ) * param_1[1] + ( param_1[4] * param_1[9] - param_1[5] * param_1[8] ) * param_1[2];
}
/* FLOAT_MATH::fm_squared(float) */float FLOAT_MATH::fm_squared(float param_1) {
   return param_1 * param_1;
}
/* FLOAT_MATH::fm_getSubMatrix(int, int, float*, float const*) */void FLOAT_MATH::fm_getSubMatrix(int param_1, int param_2, float *param_3, float *param_4) {
   int iVar1;
   int iVar2;
   int iVar3;
   int iVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FLOAT_MATH::fm_inverseTransform(float const*, float*) */void FLOAT_MATH::fm_inverseTransform(float *param_1, float *param_2) {
   uint uVar1;
   int extraout_EDX;
   long lVar2;
   int iVar3;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FLOAT_MATH::fm_identity(float*) */void FLOAT_MATH::fm_identity(float *param_1) {
   undefined8 uVar1;
...
/* FLOAT_MATH::fm_quatToEuler(float const*, float&, float&, float&) */void FLOAT_MATH::fm_quatToEuler(float *param_1, float *param_2, float *param_3, float *param_4) {
   float fVar1;
   float fVar2;
   float fVar3;
   float __x;
   ...
   __x = _LC3;
   LAB_00100408:fVar3 = atan2f(fVar2, fVar3);
   *param_2 = fVar3;
...
/* FLOAT_MATH::fm_getAABB(unsigned int, float const*, unsigned int, float*, float*) */void FLOAT_MATH::fm_getAABB(uint param_1, float *param_2, uint param_3, float *param_4, float *param_5) {
   float fVar1;
   uint uVar2;
   uVar2 = 1;
   *param_4 = *param_2;
...
/* FLOAT_MATH::fm_eulerToQuat(float, float, float, float*) */void FLOAT_MATH::fm_eulerToQuat(float param_1, float param_2, float param_3, float *param_4) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
...
/* FLOAT_MATH::fm_eulerToQuat(float const*, float*) */void FLOAT_MATH::fm_eulerToQuat(float *param_1, float *param_2) {
   fm_eulerToQuat(*param_1, param_1[1], param_1[2], param_2);
   return;
}
/* FLOAT_MATH::fm_quatToMatrix(float const*, float*) */void FLOAT_MATH::fm_quatToMatrix(float *param_1, float *param_2) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
...
/* FLOAT_MATH::fm_eulerToMatrix(float, float, float, float*) */void FLOAT_MATH::fm_eulerToMatrix(float param_1, float param_2, float param_3, float *param_4) {
   long in_FS_OFFSET;
   float afStack_38[6];
   long local_20;
...
/* FLOAT_MATH::fm_quatRotate(float const*, float const*, float*) */void FLOAT_MATH::fm_quatRotate(float *param_1, float *param_2, float *param_3) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   *param_3 = ( ( (float)( (uint)fVar6 ^ _LC14 ) * fVar8 + fVar1 * fVar10 ) - fVar5 * fVar9 ) + fVar2 * fVar7;
...
/* FLOAT_MATH::fm_getTranslation(float const*, float*) */void FLOAT_MATH::fm_getTranslation(float *param_1, float *param_2) {
   *param_2 = param_1[0xc];
   param_2[1] = param_1[0xd];
   param_2[2] = param_1[0xe];
   return;
}
/* FLOAT_MATH::fm_matrixToQuat(float const*, float*) */void FLOAT_MATH::fm_matrixToQuat(float *param_1, float *param_2) {
   int iVar1;
   int iVar2;
   bool bVar3;
   uint uVar4;
   ...
   if (0.0 < fVar16) {
      ...
      *(float*)( (long)&local_58 + lVar5 * 4 ) = ( *(float*)( (long)param_1 + lVar7 ) + *(float*)( (long)param_1 + lVar6 ) ) * fVar15;
      *(float*)( (long)&local_58 + lVar11 * 4 ) = ( *(float*)( (long)param_1 + lVar14 ) + *(float*)( (long)param_1 + lVar12 ) ) * fVar15;
...
/* FLOAT_MATH::fm_decomposeTransform(float const*, float*, float*, float*) */void FLOAT_MATH::fm_decomposeTransform(float *param_1, float *param_2, float *param_3, float *param_4) {
   long in_FS_OFFSET;
   float fVar1;
   float fVar2;
   float fVar3;
   ...
   *param_4 = fVar3;
   ...
   local_58 = CONCAT44(fVar3 * (float)( ( ulong ) * (undefined8*)param_1 >> 0x20 ), fVar3 * (float)*(undefined8*)param_1);
   _fStack_50 = CONCAT44((int)( ( ulong ) * (undefined8*)( param_1 + 2 ) >> 0x20 ), fVar3 * fStack_50);
   fStack_40 = (float)*(undefined8*)( param_1 + 6 );
   local_48 = CONCAT44(fVar2 * (float)( ( ulong ) * (undefined8*)( param_1 + 4 ) >> 0x20 ), fVar2 * (float)*(undefined8*)( param_1 + 4 ));
   ...
   local_38 = CONCAT44(fVar1 * (float)( ( ulong ) * (undefined8*)( param_1 + 8 ) >> 0x20 ), fVar1 * (float)*(undefined8*)( param_1 + 8 ));
...
/* FLOAT_MATH::fm_sphereVolume(float) */float FLOAT_MATH::fm_sphereVolume(float param_1) {
   return _LC16 * param_1 * param_1 * param_1;
}
/* FLOAT_MATH::fm_cylinderVolume(float, float) */float FLOAT_MATH::fm_cylinderVolume(float param_1, float param_2) {
   return _LC17 * param_1 * param_1 * param_2;
}
/* FLOAT_MATH::fm_capsuleVolume(float, float) */float FLOAT_MATH::fm_capsuleVolume(float param_1, float param_2) {
   float fVar1;
   float fVar2;
...
/* FLOAT_MATH::fm_transform(float const*, float const*, float*) */void FLOAT_MATH::fm_transform(float *param_1, float *param_2, float *param_3) {
   float fVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   undefined8 uVar4;
   ...
   if (param_1 != (float*)0x0) {
      ...
      *(ulong*)param_3 = CONCAT44((float)( (ulong)uVar2 >> 0x20 ) * fVar6 + (float)( (ulong)uVar3 >> 0x20 ) * fVar1 + (float)( (ulong)uVar4 >> 0x20 ) * fVar7 + (float)( (ulong)uVar5 >> 0x20 ), (float)uVar2 * fVar6 + (float)uVar3 * fVar1 + (float)uVar4 * fVar7 + (float)uVar5);
      return;
   }
...
/* FLOAT_MATH::fm_rotate(float const*, float const*, float*) */void FLOAT_MATH::fm_rotate(float *param_1, float *param_2, float *param_3) {
   float fVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   undefined8 uVar4;
   ...
   if (param_1 != (float*)0x0) {
      ...
      *(ulong*)param_3 = CONCAT44((float)( (ulong)uVar2 >> 0x20 ) * fVar5 + (float)( (ulong)uVar3 >> 0x20 ) * fVar1 + fVar6 * (float)( (ulong)uVar4 >> 0x20 ), (float)uVar2 * fVar5 + (float)uVar3 * fVar1 + fVar6 * (float)uVar4);
      return;
   }
...
/* FLOAT_MATH::fm_distance(float const*, float const*) */float FLOAT_MATH::fm_distance(float *param_1, float *param_2) {
   return SQRT(( param_1[2] - param_2[2] ) * ( param_1[2] - param_2[2] ) + ( *param_1 - *param_2 ) * ( *param_1 - *param_2 ) + ( param_1[1] - param_2[1] ) * ( param_1[1] - param_2[1] ));
}
/* FLOAT_MATH::fm_distanceSquared(float const*, float const*) */float FLOAT_MATH::fm_distanceSquared(float *param_1, float *param_2) {
   return ( *param_1 - *param_2 ) * ( *param_1 - *param_2 ) + ( param_1[1] - param_2[1] ) * ( param_1[1] - param_2[1] ) + ( param_1[2] - param_2[2] ) * ( param_1[2] - param_2[2] );
}
/* FLOAT_MATH::fm_distanceSquaredXZ(float const*, float const*) */float FLOAT_MATH::fm_distanceSquaredXZ(float *param_1, float *param_2) {
   return ( *param_1 - *param_2 ) * ( *param_1 - *param_2 ) + ( param_1[2] - param_2[2] ) * ( param_1[2] - param_2[2] );
}
/* FLOAT_MATH::fm_computePlane(float const*, float const*, float const*, float*) */undefined8 FLOAT_MATH::fm_computePlane(float *param_1, float *param_2, float *param_3, float *param_4) {
   float fVar1;
   float fVar2;
   float fVar4;
   float fVar5;
   ...
   fVar8 = fVar5 * ( fVar8 - (float)( ( ulong ) * (undefined8*)( param_3 + 1 ) >> 0x20 ) ) - fVar6 * ( fVar4 - fVar8 );
...
/* FLOAT_MATH::fm_distToPlane(float const*, float const*) */float FLOAT_MATH::fm_distToPlane(float *param_1, float *param_2) {
   return *param_2 * *param_1 + param_2[1] * param_1[1] + param_2[2] * param_1[2] + param_1[3];
}
/* FLOAT_MATH::fm_dot(float const*, float const*) */float FLOAT_MATH::fm_dot(float *param_1, float *param_2) {
   return *param_1 * *param_2 + param_1[1] * param_2[1] + param_1[2] * param_2[2];
}
/* FLOAT_MATH::fm_cross(float*, float const*, float const*) */void FLOAT_MATH::fm_cross(float *param_1, float *param_2, float *param_3) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FLOAT_MATH::fm_normalize(float*) */void FLOAT_MATH::fm_normalize(float *param_1) {
   float fVar1;
   undefined8 uVar2;
   float fVar3;
   float fVar4;
...
/* FLOAT_MATH::fm_computeNormalVector(float*, float const*, float const*) */void FLOAT_MATH::fm_computeNormalVector(float *param_1, float *param_2, float *param_3) {
...
/* FLOAT_MATH::fm_computeWindingOrder(float const*, float const*, float const*) */bool FLOAT_MATH::fm_computeWindingOrder(float *param_1, float *param_2, float *param_3) {
   ...
   if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 0.0 < ( local_28 * local_20 - local_18 * local_30 ) * 0.0 + ( local_18 * fStack_2c - local_28 * fStack_1c ) + ( fStack_1c * local_30 - fStack_2c * local_20 ) * 0.0;
   }

   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
/* FLOAT_MATH::fm_eulerToQuatDX(float, float, float, float*) */void FLOAT_MATH::fm_eulerToQuatDX(float param_1, float param_2, float param_3, float *param_4) {
   float *pfVar1;
   long in_FS_OFFSET;
   float afStack_78[4];
   float local_68[18];
...
/* FLOAT_MATH::fm_eulerToMatrixDX(float, float, float, float*) */void FLOAT_MATH::fm_eulerToMatrixDX(float param_1, float param_2, float param_3, float *param_4) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
...
/* FLOAT_MATH::fm_scale(float, float, float, float*) */void FLOAT_MATH::fm_scale(float param_1, float param_2, float param_3, float *param_4) {
   *param_4 = param_1;
   param_4[5] = param_2;
   param_4[10] = param_3;
   return;
}
/* FLOAT_MATH::fm_setTranslation(float const*, float*) */void FLOAT_MATH::fm_setTranslation(float *param_1, float *param_2) {
   param_2[0xc] = *param_1;
   param_2[0xd] = param_1[1];
   param_2[0xe] = param_1[2];
   return;
}
/* FLOAT_MATH::fm_computeArea(float const*, float const*, float const*) */float FLOAT_MATH::fm_computeArea(float *param_1, float *param_2, float *param_3) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
...
/* FLOAT_MATH::fm_lerp(float const*, float const*, float*, float) */void FLOAT_MATH::fm_lerp(float *param_1, float *param_2, float *param_3, float param_4) {
...
/* FLOAT_MATH::fm_pointTestXZ(float const*, float const*, float const*) */bool FLOAT_MATH::fm_pointTestXZ(float *param_1, float *param_2, float *param_3) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   fVar2 = param_3[2];
   fVar3 = fVar2;
   if (( ( fVar4 <= fVar1 ) || ( fVar3 = fVar4 ),fVar2 <= fVar1 )) {
...
/* FLOAT_MATH::fm_insideTriangleXZ(float const*, float const*, float const*, float const*) */uint FLOAT_MATH::fm_insideTriangleXZ(float *param_1, float *param_2, float *param_3, float *param_4) {
   uint uVar1;
   uint uVar2;
   float *extraout_RDX;
...
/* FLOAT_MATH::fm_insideAABB(float const*, float const*, float const*) */bool FLOAT_MATH::fm_insideAABB(float *param_1, float *param_2, float *param_3) {
   if (( ( ( *param_2 <= *param_1 ) && ( *param_1 <= *param_3 ) ) && ( param_2[1] <= param_1[1] ) ) && ( ( param_1[1] <= param_3[1] && ( param_2[2] <= param_1[2] ) ) )) {
      return param_1[2] <= param_3[2];
   }

   return false;
}
/* FLOAT_MATH::fm_clipTestPoint(float const*, float const*, float const*) */byte FLOAT_MATH::fm_clipTestPoint(float *param_1, float *param_2, float *param_3) {
   byte bVar1;
   float fVar2;
   fVar2 = *param_3;
   bVar1 = 1;
   ...
   fVar2 = param_3[2];
   if (param_1[2] <= fVar2) {
      LAB_00101990:if (param_2[2] <= fVar2 && fVar2 != param_2[2]) {
         bVar1 = bVar1 | 0x20;
      }
   ...
   LAB_00101971:return bVar1 | 0x10;
}
/* FLOAT_MATH::fm_clipTestPointXZ(float const*, float const*, float const*) */byte FLOAT_MATH::fm_clipTestPointXZ(float *param_1, float *param_2, float *param_3) {
   float fVar1;
   byte bVar2;
   fVar1 = *param_3;
   bVar2 = 1;
...
/* FLOAT_MATH::fm_clipTestAABB(float const*, float const*, float const*, float const*, float const*,
   unsigned int&) */uint FLOAT_MATH::fm_clipTestAABB(float *param_1, float *param_2, float *param_3, float *param_4, float *param_5, uint *param_6) {
   uint uVar1;
   uint uVar2;
   uint uVar3;
   uint uVar4;
...
/* FLOAT_MATH::intersect(float const*, float const*, float const*, float const*, float*) */undefined8 FLOAT_MATH::intersect(float *param_1, float *param_2, float *param_3, float *param_4, float *param_5) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
...
/* FLOAT_MATH::fm_lineTestAABB(float const*, float const*, float const*, float const*, float&) */void FLOAT_MATH::fm_lineTestAABB(float *param_1, float *param_2, float *param_3, float *param_4, float *param_5) {
   intersect(param_1, param_2, param_3, param_4, param_5);
   return;
}
/* FLOAT_MATH::fm_lineTestAABBXZ(float const*, float const*, float const*, float const*, float&) */void FLOAT_MATH::fm_lineTestAABBXZ(float *param_1, float *param_2, float *param_3, float *param_4, float *param_5) {
   long in_FS_OFFSET;
   float local_28[3];
   float local_1c[3];
   long local_10;
...
/* FLOAT_MATH::fm_minmax(float const*, float*, float*) */void FLOAT_MATH::fm_minmax(float *param_1, float *param_2, float *param_3) {
   float fVar1;
   if (*param_1 < *param_2) {
      *param_2 = *param_1;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FLOAT_MATH::fm_solveX(float const*, float, float) */undefined8 FLOAT_MATH::fm_solveX(float *param_1, float param_2, float param_3) {
   uint in_XMM0_Db;
   return CONCAT44(in_XMM0_Db ^ _UNK_00111594, (float)( ( uint )(param_2 * param_1[1] + param_3 * param_1[2] + param_1[3]) ^ _LC14 ) / *param_1);
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FLOAT_MATH::fm_solveY(float const*, float, float) */undefined8 FLOAT_MATH::fm_solveY(float *param_1, float param_2, float param_3) {
   uint in_XMM0_Db;
   return CONCAT44(in_XMM0_Db ^ _UNK_00111594, (float)( ( uint )(param_2 * *param_1 + param_3 * param_1[2] + param_1[3]) ^ _LC14 ) / param_1[1]);
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FLOAT_MATH::fm_solveZ(float const*, float, float) */undefined8 FLOAT_MATH::fm_solveZ(float *param_1, float param_2, float param_3) {
   uint in_XMM0_Db;
   return CONCAT44(in_XMM0_Db ^ _UNK_00111594, (float)( ( uint )(param_2 * *param_1 + param_3 * param_1[1] + param_1[3]) ^ _LC14 ) / param_1[2]);
}
/* FLOAT_MATH::fm_getAABBCenter(float const*, float const*, float*) */void FLOAT_MATH::fm_getAABBCenter(float *param_1, float *param_2, float *param_3) {
   float fVar1;
   fVar1 = _LC13;
...
/* FLOAT_MATH::fm_getDominantAxis(float const*) */char FLOAT_MATH::fm_getDominantAxis(float *param_1) {
   char cVar1;
   float fVar2;
   float fVar3;
   fVar2 = (float)( (uint)param_1[1] & _LC11 );
   fVar3 = (float)( (uint)param_1[2] & _LC11 );
   if (( fVar2 <= (float)( ( uint ) * param_1 & _LC11 ) ) || ( cVar1 = fVar2 <= fVar3 )) {
...
/* FLOAT_MATH::fm_raySphereIntersect(float const*, float, float const*, float const*, float, float*)
    */bool FLOAT_MATH::fm_raySphereIntersect(float *param_1, float param_2, float *param_3, float *param_4, float param_5, float *param_6) {
   bool bVar1;
   float fVar2;
   float fVar3;
   float fVar4;
...
/* FLOAT_MATH::fm_lineSphereIntersect(float const*, float, float const*, float const*, float*) */undefined8 FLOAT_MATH::fm_lineSphereIntersect(float *param_1, float param_2, float *param_3, float *param_4, float *param_5) {
   undefined8 uVar1;
   long in_FS_OFFSET;
   float fVar2;
   float fVar3;
   ...
   if (0.0 < fVar2) {
      ...
      local_20 = CONCAT44(( (float)( ( ulong ) * (undefined8*)param_4 >> 0x20 ) - fVar5 ) * fVar3, fVar6 * fVar3);
...
/* FLOAT_MATH::fm_catmullRom(float*, float const*, float const*, float const*, float const*, float)
    */void FLOAT_MATH::fm_catmullRom(float *param_1, float *param_2, float *param_3, float *param_4, float *param_5, float param_6) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   *param_1 = ( *param_2 * fVar2 + *param_3 * fVar6 + *param_4 * fVar3 + *param_5 * fVar4 ) * _LC13;
   param_1[1] = ( param_2[1] * fVar2 + param_3[1] * fVar6 + param_4[1] * fVar3 + param_5[1] * fVar4 ) * fVar1;
   param_1[2] = ( fVar2 * param_2[2] + fVar6 * param_3[2] + fVar3 * param_4[2] + fVar4 * param_5[2] ) * fVar1;
   return;
}
/* FLOAT_MATH::fm_intersectAABB(float const*, float const*, float const*, float const*) */bool FLOAT_MATH::fm_intersectAABB(float *param_1, float *param_2, float *param_3, float *param_4) {
   bool bVar1;
   bVar1 = false;
   if (( ( ( *param_1 < *param_4 || *param_1 == *param_4 ) && ( *param_3 < *param_2 || *param_3 == *param_2 ) ) && ( param_1[1] < param_4[1] || param_1[1] == param_4[1] ) ) && ( ( bVar1 = false ),param_3[1] < param_2[1] || param_3[1] == param_2[1] && ( param_1[2] < param_4[2] || param_1[2] == param_4[2] ) )) {
      bVar1 = param_3[2] < param_2[2] || param_3[2] == param_2[2];
   }

   return bVar1;
}
/* FLOAT_MATH::fm_insideAABB(float const*, float const*, float const*, float const*) */bool FLOAT_MATH::fm_insideAABB(float *param_1, float *param_2, float *param_3, float *param_4) {
   if (( ( ( *param_4 <= *param_2 ) && ( param_4[1] <= param_2[1] ) ) && ( param_4[2] <= param_2[2] ) ) && ( ( *param_1 <= *param_3 && ( param_1[1] <= param_3[1] ) ) )) {
      return param_1[2] <= param_3[2];
   }

   return false;
}
/* FLOAT_MATH::fm_rotationArc(float const*, float const*, float*) */void FLOAT_MATH::fm_rotationArc(float *param_1, float *param_2, float *param_3) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
...
/* FLOAT_MATH::fm_distancePointLineSegment(float const*, float const*, float const*, float*,
   FLOAT_MATH::LineSegmentType&, float) */float FLOAT_MATH::fm_distancePointLineSegment(float *param_1, float *param_2, float *param_3, float *param_4, LineSegmentType *param_5, float param_6) {
   int iVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   if (0.0 < fVar2) {
      ...
      if (( 0.0 <= fVar2 ) && ( fVar2 <= _LC3 )) {
         ...
         *param_4 = fVar8;
         ...
         param_4[2] = fVar3;
         fVar2 = SQRT(( param_1[2] - fVar3 ) * ( param_1[2] - fVar3 ) + ( *param_1 - fVar8 ) * ( *param_1 - fVar8 ) + ( param_1[1] - fVar4 ) * ( param_1[1] - fVar4 ));
         if (fVar6 <= ( fVar8 - *param_2 ) * ( fVar8 - *param_2 ) + ( fVar4 - param_2[1] ) * ( fVar4 - param_2[1] ) + ( fVar3 - param_2[2] ) * ( fVar3 - param_2[2] )) {
            iVar1 = ( ( fVar8 - *param_3 ) * ( fVar8 - *param_3 ) + ( fVar4 - param_3[1] ) * ( fVar4 - param_3[1] ) + ( fVar3 - param_3[2] ) * ( fVar3 - param_3[2] ) < fVar6 ) + 1;
         }
   ...
   *param_4 = fVar3;
   ...
   param_4[1] = param_3[1];
   param_4[2] = param_3[2];
   LAB_0010242c:*(int*)param_5 = iVar1;
   return fVar2;
}
/* FLOAT_MATH::fm_colinear(float const*, float const*, float const*, float const*, float) */bool FLOAT_MATH::fm_colinear(float *param_1, float *param_2, float *param_3, float *param_4, float param_5) {
   float fVar1;
   long in_FS_OFFSET;
   float fVar2;
   float fVar3;
   ...
   fStack_1c = ( (float)( ( ulong ) * (undefined8*)param_4 >> 0x20 ) - fVar3 ) - ( (float)( ( ulong ) * (undefined8*)param_3 >> 0x20 ) - fVar3 );
...
/* FLOAT_MATH::fm_colinear(float const*, float const*, float const*, float) */bool FLOAT_MATH::fm_colinear(float *param_1, float *param_2, float *param_3, float param_4) {
   long in_FS_OFFSET;
   float local_30;
   float fStack_2c;
   float local_28;
...
/* FLOAT_MATH::fm_initMinMax(float const*, float*, float*) */void FLOAT_MATH::fm_initMinMax(float *param_1, float *param_2, float *param_3) {
   float fVar1;
   fVar1 = *param_1;
   *param_2 = fVar1;
   *param_3 = fVar1;
...
/* FLOAT_MATH::fm_intersectLineSegments2d(float const*, float const*, float const*, float const*,
   float*) */int FLOAT_MATH::fm_intersectLineSegments2d(float *param_1, float *param_2, float *param_3, float *param_4, float *param_5) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   fVar7 = _LC3 / fVar7;
   fVar2 = fVar2 * fVar7;
   if (( ( ( 0.0 <= fVar2 ) && ( fVar2 <= _LC3 ) ) && ( fVar4 = fVar4 * fVar7 ),0.0 <= fVar4 )) &&( fVar4 <= _LC3 ) * param_5 = fVar6 * fVar2 + fVar1;
   param_5[1] = fVar2 * ( param_2[1] - param_1[1] ) + param_1[1];
   return 1;
}
return 0;}/* FLOAT_MATH::fm_intersectLineSegments2dTime(float const*, float const*, float const*, float
   const*, float&, float&) */int FLOAT_MATH::fm_intersectLineSegments2dTime(float *param_1, float *param_2, float *param_3, float *param_4, float *param_5, float *param_6) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
...
/* FLOAT_MATH::fm_intersectPointPlane(float const*, float const*, float*, float const*) */undefined8 FLOAT_MATH::fm_intersectPointPlane(float *param_1, float *param_2, float *param_3, float *param_4) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   if (( fVar6 < 0.0 ) || ( uVar5 = fVar8 < 0.0 )) {
      fVar10 = *param_2 - fVar1;
      fVar9 = param_2[1] - param_1[1];
      uVar5 = 1;
      fVar8 = param_2[2] - param_1[2];
      fVar7 = (float)( ( uint )(( fVar6 - fVar4 ) + fVar4) ^ _LC14 ) / ( fVar7 * fVar10 + fVar2 * fVar9 + fVar3 * fVar8 );
...
/* FLOAT_MATH::fm_getSidePlane(float const*, float const*, float) */char FLOAT_MATH::fm_getSidePlane(float *param_1, float *param_2, float param_3) {
   float fVar1;
...
/* FLOAT_MATH::fm_planeTriIntersection(float const*, float const*, unsigned int, float, float*,
   unsigned int&, float*, unsigned int&) */char FLOAT_MATH::fm_planeTriIntersection(float *param_1, float *param_2, uint param_3, float param_4, float *param_5, uint *param_6, float *param_7, uint *param_8) {
   uint *puVar1;
   float *pfVar2;
   uint *puVar3;
   float fVar4;
   ...
   if (( fVar30 < fVar32 ) || ( param_4 < fVar30 )) {
      if (fVar30 <= 0.0) {
         if (cVar23 == '\0' || cVar15 == '\0') {
            ...
            LAB_00102eaf:bVar28 = cVar23 == cVar16;
            LAB_00102eb4:if (bVar28) goto LAB_00102ebc;
         }
 else if (( cVar23 == '\x02' ) && ( bVar28 = cVar15 == '\x02' ),cVar15 = '\x02',bVar28) goto LAB_00102eca;
      }
 else {
         if (cVar23 == '\0' || cVar15 == '\0') {
            if (cVar23 == '\0') {
         ...
         LAB_00102ce2:if (( cVar15 == cVar23 ) && ( cVar23 == '\x01' )) goto LAB_00102c1f;
      }

      LAB_00102cef:uVar21 = 0;
      uVar27 = 0;
      local_2444[0] = fVar29;
      local_1858 = 0;
      pfVar24 = &local_2468;
      ...
      do {
         ...
         if (0.0 < fVar31) {
            uVar18 = uVar21;
            if (fVar30 < 0.0) {
               fm_intersectPointPlane((float*)&local_3c90, (float*)&local_3c9c, (float*)&local_3c84, (float*)&local_3c78);
 ...
 while ( puVar12 != puVar3 );
      ...
      if (cVar15 != '\0' || cVar23 != '\0') {
         if (cVar23 == '\0') {
            ...
            LAB_00102ebc:cVar15 = '\x02';
            if (cVar23 == '\x01') goto LAB_00102c1f;
         }

         LAB_00102eca:*param_7 = fVar31;
      ...
      *pfVar26 = *pfVar22;
      ...
      pfVar26[2] = pfVar22[2];
      *param_6 = 3;
      LAB_00102c85:cVar15 = '\x01';
   }

   LAB_00102c90:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FLOAT_MATH::computeOBB(unsigned int, float const*, unsigned int, float*, float*) */void FLOAT_MATH::computeOBB(uint param_1, float *param_2, uint param_3, float *param_4, float *param_5) {
   uint uVar1;
   long in_FS_OFFSET;
   float fVar2;
   float fVar3;
 ...
 while ( uVar1 != param_1 );
   ...
   *(ulong*)( param_5 + 0xc ) = CONCAT44((float)( ( ulong ) * (undefined8*)( param_5 + 0xc ) >> 0x20 ) + local_20[1], (float)*(undefined8*)( param_5 + 0xc ) + local_20[0]);
...
/* FLOAT_MATH::fm_computeBestFitABB(unsigned int, float const*, unsigned int, float*, float*) */void FLOAT_MATH::fm_computeBestFitABB(uint param_1, float *param_2, uint param_3, float *param_4, float *param_5) {
   float fVar1;
   uint uVar2;
   float fVar3;
   float fVar4;
...
/* FLOAT_MATH::fm_planeToMatrix(float const*, float*) */void FLOAT_MATH::fm_planeToMatrix(float *param_1, float *param_2) {
   float *extraout_RDX;
...
/* FLOAT_MATH::fm_planeToQuat(float const*, float*, float*) */void FLOAT_MATH::fm_planeToQuat(float *param_1, float *param_2, float *param_3) {
   float fVar1;
   long in_FS_OFFSET;
   float fVar2;
   undefined8 local_68;
   ...
   *(ulong*)param_3 = CONCAT44(local_58[1] * 0.0 + fVar1 * (float)( (ulong)local_48 >> 0x20 ) + (float)( (ulong)local_38 >> 0x20 ) * 0.0 + (float)( (ulong)local_28 >> 0x20 ), local_58[0] * 0.0 + fVar1 * (float)local_48 + (float)local_38 * 0.0 + (float)local_28);
   if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* FLOAT_MATH::fm_eulerMatrix(float, float, float, float*) */void FLOAT_MATH::fm_eulerMatrix(float param_1, float param_2, float param_3, float *param_4) {
   long in_FS_OFFSET;
   float afStack_38[6];
   long local_20;
   local_20 = *(long*)( in_FS_OFFSET + 0x28 );
...
/* FLOAT_MATH::fm_createVertexIndex(double, bool) */void FLOAT_MATH::fm_createVertexIndex(double param_1, bool param_2) {
   undefined8 *puVar1;
...
/* FLOAT_MATH::fm_createVertexIndex(float, bool) */void FLOAT_MATH::fm_createVertexIndex(float param_1, bool param_2) {
   undefined8 *puVar1;
   puVar1 = (undefined8*)operator_new(0x78);
   *(undefined1(*) [16])( puVar1 + 9 ) = (undefined1[16])0x0;
   *(undefined1(*) [16])( puVar1 + 0xb ) = (undefined1[16])0x0;
...
/* FLOAT_MATH::fm_releaseVertexIndex(FLOAT_MATH::fm_VertexIndex*) */void FLOAT_MATH::fm_releaseVertexIndex(fm_VertexIndex *param_1) {
   long *plVar1;
   long *plVar2;
   void *pvVar3;
...
/* FLOAT_MATH::fm_computeBestFitAABB(unsigned int, float const*, unsigned int, float*, float*) */float FLOAT_MATH::fm_computeBestFitAABB(uint param_1, float *param_2, uint param_3, float *param_4, float *param_5) {
   uint uVar1;
   float fVar2;
   float fVar3;
   float fVar4;
 ...
 while ( param_1 != uVar1 );
   ...
   return SQRT(( fVar2 - param_4[2] ) * ( fVar2 - param_4[2] ) + ( fVar3 - *param_4 ) * ( fVar3 - *param_4 ) + ( fVar4 - param_4[1] ) * ( fVar4 - param_4[1] ));
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FLOAT_MATH::fm_rayIntersectsTriangle(float const*, float const*, float const*, float const*,
   float const*, float&) */bool FLOAT_MATH::fm_rayIntersectsTriangle(float *param_1, float *param_2, float *param_3, float *param_4, float *param_5, float *param_6) {
   float fVar1;
   float fVar2;
   float fVar3;
   bool bVar4;
   ...
   dVar18 = (double)fVar8;
   if (( dVar18 <= __LC33 ) || ( bVar4 = _LC34 <= dVar18 )) {
      fVar8 = _LC3 / fVar8;
      fVar9 = *param_1 - fVar9;
...
/* FLOAT_MATH::fm_lineIntersectsTriangle(float const*, float const*, float const*, float const*,
   float const*, float*) */undefined8 FLOAT_MATH::fm_lineIntersectsTriangle(float *param_1, float *param_2, float *param_3, float *param_4, float *param_5, float *param_6) {
   undefined8 uVar1;
   long in_FS_OFFSET;
   float fVar2;
   float fVar3;
   ...
   fVar5 = (float)( ( ulong ) * (undefined8*)param_2 >> 0x20 ) - (float)( ( ulong ) * (undefined8*)param_1 >> 0x20 );
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FLOAT_MATH::fm_computeMeshVolume(float const*, unsigned int, unsigned int const*) */ulong FLOAT_MATH::fm_computeMeshVolume(float *param_1, uint param_2, uint *param_3) {
   float *pfVar1;
   float *pfVar2;
   float *pfVar3;
   uint *puVar4;
   ...
   do {
      ...
      fVar6 = fVar6 + ( ( ( ( *pfVar1 * pfVar3[1] * pfVar2[2] + *pfVar3 * pfVar2[1] * pfVar1[2] + *pfVar2 * pfVar1[1] * pfVar3[2] ) - *pfVar1 * pfVar2[1] * pfVar3[2] ) - *pfVar3 * pfVar1[1] * pfVar2[2] ) - pfVar3[1] * *pfVar2 * pfVar1[2] );
      puVar4 = puVar5;
   }
...
/* FLOAT_MATH::fm_getPoint(float const*, unsigned int, unsigned int) */long FLOAT_MATH::fm_getPoint(float *param_1, uint param_2, uint param_3) {
   return (long)param_1 + ( ulong )(param_3 * param_2);
}
/* FLOAT_MATH::fm_insideTriangle(float, float, float, float, float, float, float, float) */bool FLOAT_MATH::fm_insideTriangle(float param_1, float param_2, float param_3, float param_4, float param_5, float param_6, float param_7, float param_8) {
   if (( 0.0 <= ( param_5 - param_3 ) * ( param_8 - param_4 ) - ( param_6 - param_4 ) * ( param_7 - param_3 ) ) && ( 0.0 <= ( param_1 - param_5 ) * ( param_8 - param_6 ) - ( param_2 - param_6 ) * ( param_7 - param_5 ) )) {
      return 0.0 <= ( param_3 - param_1 ) * ( param_8 - param_2 ) - ( param_4 - param_2 ) * ( param_7 - param_1 );
   }

   return false;
}
/* FLOAT_MATH::fm_areaPolygon2d(unsigned int, float const*, unsigned int) */float FLOAT_MATH::fm_areaPolygon2d(uint param_1, float *param_2, uint param_3) {
   float fVar1;
   float *pfVar2;
   uint uVar3;
   ulong uVar4;
...
/* FLOAT_MATH::fm_pointInsidePolygon2d(unsigned int, float const*, unsigned int, float const*,
   unsigned int, unsigned int) */uint FLOAT_MATH::fm_pointInsidePolygon2d(uint param_1, float *param_2, uint param_3, float *param_4, uint param_5, uint param_6) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
...
/* FLOAT_MATH::fm_consolidatePolygon(unsigned int, float const*, unsigned int, float*, float) */int FLOAT_MATH::fm_consolidatePolygon(uint param_1, float *param_2, uint param_3, float *param_4, float param_5) {
   float *pfVar1;
   char cVar2;
   float *pfVar3;
   float *pfVar4;
...
/* FLOAT_MATH::splitRect(unsigned int, FLOAT_MATH::Rect3d<float> const&, FLOAT_MATH::Rect3d<float>&,
   FLOAT_MATH::Rect3d<float>&, float const*) */void FLOAT_MATH::splitRect(uint param_1, Rect3d *param_2, Rect3d *param_3, Rect3d *param_4, float *param_5) {
   undefined4 uVar1;
   undefined4 uVar2;
   float fVar3;
   undefined4 uVar4;
   ...
   for (int i = 0; i < 3; i++) {
      *(undefined4*)( param_4 + ( 4*i + 12 ) ) = *(undefined4*)( param_2 + ( 4*i + 12 ) );
   }

   return;
}
/* FLOAT_MATH::fm_nearestPointInTriangle(float const*, float const*, float const*, float const*,
   float*) */void FLOAT_MATH::fm_nearestPointInTriangle(float *param_1, float *param_2, float *param_3, float *param_4, float *param_5) {
   return;
}
/* FLOAT_MATH::fm_areaTriangle(float const*, float const*, float const*) */float FLOAT_MATH::fm_areaTriangle(float *param_1, float *param_2, float *param_3) {
   return ( ( param_2[1] * *param_1 - *param_2 * param_1[1] ) + ( param_3[1] * *param_2 - *param_3 * param_2[1] ) + ( *param_3 * param_1[1] - param_3[1] * *param_1 ) ) * _LC13;
}
/* FLOAT_MATH::fm_subtract(float const*, float const*, float*) */void FLOAT_MATH::fm_subtract(float *param_1, float *param_2, float *param_3) {
   *param_3 = *param_1 - *param_2;
   param_3[1] = param_1[1] - param_2[1];
   param_3[2] = param_1[2] - param_2[2];
   return;
}
/* FLOAT_MATH::fm_multiplyTransform(float const*, float const*, float*) */void FLOAT_MATH::fm_multiplyTransform(float *param_1, float *param_2, float *param_3) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FLOAT_MATH::fm_composeTransform(float const*, float const*, float const*, float*) */void FLOAT_MATH::fm_composeTransform(float *param_1, float *param_2, float *param_3, float *param_4) {
   undefined8 uVar1;
   float *pfVar2;
   float *pfVar3;
   long in_FS_OFFSET;
   ...
   *(undefined8*)( param_4 + 0xe ) = uVar1;
   ...
   pfVar3 = auVar4._8_8_;
   pfVar2 = auVar4._0_8_;
   if (( pfVar3 != (float*)0x0 ) && ( ( ( *pfVar3 != _LC3 || ( _LC3 != pfVar3[1] ) ) || ( _LC3 != pfVar3[2] ) ) )) {
      local_30 = pfVar3[2];
      local_58[5] = pfVar3[1];
...
/* FLOAT_MATH::fm_matrixMultiply(float const*, float const*, float*) */void FLOAT_MATH::fm_matrixMultiply(float *param_1, float *param_2, float *param_3) {
   fm_multiplyTransform(param_1, param_2, param_3);
   return;
}
/* FLOAT_MATH::fm_multiply(float*, float) */void FLOAT_MATH::fm_multiply(float *param_1, float param_2) {
   param_1[2] = param_2 * param_1[2];
   *(ulong*)param_1 = CONCAT44((float)( ( ulong ) * (undefined8*)param_1 >> 0x20 ) * param_2, (float)*(undefined8*)param_1 * param_2);
   return;
}
/* FLOAT_MATH::fm_add(float const*, float const*, float*) */void FLOAT_MATH::fm_add(float *param_1, float *param_2, float *param_3) {
   *param_3 = *param_1 + *param_2;
   param_3[1] = param_1[1] + param_2[1];
   param_3[2] = param_1[2] + param_2[2];
   return;
}
/* FLOAT_MATH::fm_copy3(float const*, float*) */void FLOAT_MATH::fm_copy3(float *param_1, float *param_2) {
   *param_2 = *param_1;
   param_2[1] = param_1[1];
   param_2[2] = param_1[2];
   return;
...
/* FLOAT_MATH::fm_copyUniqueVertices(unsigned int, float const*, float*, unsigned int, unsigned int
   const*, unsigned int*) */uint FLOAT_MATH::fm_copyUniqueVertices(uint param_1, float *param_2, float *param_3, uint param_4, uint *param_5, uint *param_6) {
   float *pfVar1;
   size_t __size;
   uint *puVar2;
   uint uVar3;
...
;
 ...
 while ( (uint)lVar5 < param_4 * 3 );
   ...
   LAB_001047cc:free(__ptr);
   free(__ptr_00);
   return uVar6;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FLOAT_MATH::fm_isMeshCoplanar(unsigned int, unsigned int const*, float const*, bool) */undefined8 FLOAT_MATH::fm_isMeshCoplanar(uint param_1, uint *param_2, float *param_3, bool param_4) {
   undefined8 uVar1;
   ulong uVar2;
   uint *puVar3;
   uint *puVar4;
   ...
   if (param_1 != 0) {
      puVar3 = param_2 + 3;
      fVar6 = (float)fm_computePlane(param_3 + *param_2 * 3, param_3 + param_2[1] * 3, param_3 + param_2[2] * 3, &local_48);
      local_3c = fVar6;
      if (param_1 != 1) {
         ...
         do {
            puVar4 = puVar3 + 3;
            fVar7 = (float)fm_computePlane(param_3 + *puVar3 * 3, param_3 + puVar3[1] * 3, param_3 + puVar3[2] * 3, &local_38);
            if (fVar9 <= (float)( ( uint )(fVar6 - fVar7) & uVar8 )) {
               LAB_00104950:uVar1 = 0;
               goto LAB_00104828;
            }
 ...
 while ( puVar4 != puVar5 );
   ...
   LAB_00104828:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* FLOAT_MATH::fm_samePlane(float const*, float const*, float, float, bool) */bool FLOAT_MATH::fm_samePlane(float *param_1, float *param_2, float param_3, float param_4, bool param_5) {
   float fVar1;
...
/* FLOAT_MATH::fm_initMinMax(float*, float*) */void FLOAT_MATH::fm_initMinMax(float *param_1, float *param_2) {
   undefined8 uVar1;
   uVar1 = _LC38;
...
/* FLOAT_MATH::fm_inflateMinMax(float*, float*, float) */void FLOAT_MATH::fm_inflateMinMax(float *param_1, float *param_2, float param_3) {
   float fVar1;
   fVar1 = param_1[2] - param_2[2];
   fVar1 = SQRT(( *param_1 - *param_2 ) * ( *param_1 - *param_2 ) + ( param_1[1] - param_2[1] ) * ( param_1[1] - param_2[1] ) + fVar1 * fVar1) * _LC13 * param_3;
   param_1[2] = param_1[2] - fVar1;
   *(ulong*)param_1 = CONCAT44((float)( ( ulong ) * (undefined8*)param_1 >> 0x20 ) - fVar1, (float)*(undefined8*)param_1 - fVar1);
   param_2[2] = fVar1 + param_2[2];
   *(ulong*)param_2 = CONCAT44((float)( ( ulong ) * (undefined8*)param_2 >> 0x20 ) + fVar1, (float)*(undefined8*)param_2 + fVar1);
   return;
}
/* FLOAT_MATH::fm_createTesselate() */void FLOAT_MATH::fm_createTesselate(void) {
   undefined8 *puVar1;
...
/* FLOAT_MATH::fm_releaseTesselate(FLOAT_MATH::fm_Tesselate*) */void FLOAT_MATH::fm_releaseTesselate(fm_Tesselate *param_1) {
   void *pvVar1;
...
/* FLOAT_MATH::fm_intersectRayAABB(float const*, float const*, float const*, float const*, float*)
    */undefined1 FLOAT_MATH::fm_intersectRayAABB(float *param_1, float *param_2, float *param_3, float *param_4, float *param_5) {
   float *pfVar1;
   float fVar2;
   int iVar3;
   float fVar4;
   ...
   do {
      ...
      if (fVar2 <= *(float*)( (long)param_3 + lVar6 )) {
         ...
         *(float*)( (long)param_5 + lVar6 ) = fVar2;
         if (iVar3 != 0) {
            *(float*)( (long)&local_20 + lVar6 ) = ( fVar2 - *(float*)( (long)param_3 + lVar6 ) ) / *(float*)( (long)param_4 + lVar6 );
         }

         LAB_00104baa:bVar5 = false;
      }
 ...
 while ( lVar6 != 3 );
   ...
   uVar7 = 1;
   LAB_00104c51:if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar7;
   }
...
/* FLOAT_MATH::fm_intersectLineSegmentAABB(float const*, float const*, float const*, float const*,
   float*) */bool FLOAT_MATH::fm_intersectLineSegmentAABB(float *param_1, float *param_2, float *param_3, float *param_4, float *param_5) {
   bool bVar1;
   char cVar2;
   float *pfVar3;
   float *pfVar4;
   ...
   long local_20;
   local_20 = *(long*)( in_FS_OFFSET + 0x28 );
   local_30 = CONCAT44((float)( ( ulong ) * (undefined8*)param_4 >> 0x20 ) - (float)( ( ulong ) * (undefined8*)param_3 >> 0x20 ), (float)*(undefined8*)param_4 - (float)*(undefined8*)param_3);
   ...
   if (_LC44 < extraout_XMM0_Da) {
      ...
      if (cVar2 != '\0') {
         bVar1 = ( *param_3 - *param_5 ) * ( *param_3 - *param_5 ) + ( param_3[1] - param_5[1] ) * ( param_3[1] - param_5[1] ) + ( param_3[2] - param_5[2] ) * ( param_3[2] - param_5[2] ) <= extraout_XMM0_Da * extraout_XMM0_Da;
         goto LAB_00104d48;
      }
   ...
   bVar1 = false;
   LAB_00104d48:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return bVar1;
   }
...
/* FLOAT_MATH::fm_OBBtoAABB(float const*, float const*, float const*, float*, float*) */void FLOAT_MATH::fm_OBBtoAABB(float *param_1, float *param_2, float *param_3, float *param_4, float *param_5) {
   return;
}
/* FLOAT_MATH::computePos(unsigned int, float const*, unsigned int) */long FLOAT_MATH::computePos(uint param_1, float *param_2, uint param_3) {
   return (long)param_2 + ( ulong )(param_1 * param_3);
}
/* FLOAT_MATH::computeNormal(unsigned int, float*, unsigned int, float const*) */void FLOAT_MATH::computeNormal(uint param_1, float *param_2, uint param_3, float *param_4) {
   float *pfVar1;
...
/* FLOAT_MATH::fm_computeMeanNormals(unsigned int, float const*, unsigned int, float*, unsigned int,
   unsigned int, unsigned int const*) */void FLOAT_MATH::fm_computeMeanNormals(uint param_1, float *param_2, uint param_3, float *param_4, uint param_5, uint param_6, uint *param_7) {
   uint uVar1;
   float *pfVar2;
   undefined8 *puVar3;
   ulong uVar4;
   ...
   if (param_1 == 0) {
      ...
      do {
         ...
         fm_computePlane((float*)( ( ulong )(param_7[2] * iVar6) + (long)param_2 ), (float*)( ( ulong )(param_7[1] * iVar6) + (long)param_2 ), (float*)( ( ulong )(*param_7 * iVar6) + (long)param_2 ), pfVar2);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FLOAT_MATH::fm_computeBestFitSphere(unsigned int, float const*, unsigned int, float*) */ulong FLOAT_MATH::fm_computeBestFitSphere(uint param_1, float *param_2, uint param_3, float *param_4) {
   float fVar1;
   float fVar2;
   int iVar3;
   float *pfVar4;
 ...
 while ( param_1 != uVar6 );
      ...
      fVar23 = ( fVar7 - local_8 ) * ( fVar7 - local_8 ) + ( fVar18 - fVar17 ) * ( fVar18 - fVar17 ) + ( local_c - local_4 ) * ( local_c - local_4 );
      fVar24 = ( fVar13 - fVar14 ) * ( fVar13 - fVar14 ) + ( fVar19 - fVar20 ) * ( fVar19 - fVar20 ) + ( fVar12 - fVar25 ) * ( fVar12 - fVar25 );
      fVar10 = ( fVar9 - fVar10 ) * ( fVar9 - fVar10 ) + ( fVar22 - local_10 ) * ( fVar22 - local_10 ) + ( fVar11 - fVar8 ) * ( fVar11 - fVar8 );
   ...
   if (param_1 != 0) {
      ...
      while (true) {
         ...
         if (fVar11 < fVar14) {
            ...
            *(ulong*)param_4 = CONCAT44(( (float)( (ulong)uVar5 >> 0x20 ) * auVar16._0_4_ + fVar14 * fVar25 ) * fVar24, ( (float)uVar5 * auVar16._0_4_ + fVar14 * (float)uVar21 ) * fVar24);
         }
...
/* FLOAT_MATH::CTriangulator::CTriangulator() */void FLOAT_MATH::CTriangulator::CTriangulator(CTriangulator *this) {
   ...
   *(undefined***)this = &PTR__CTriangulator_001114d8;
   for (int i = 0; i < 4; i++) {
      *(undefined1(*) [16])( this + ( 16*i + 64 ) ) = (undefined1[16])0;
   }

   return;
}
/* FLOAT_MATH::CTriangulator::_area() */double FLOAT_MATH::CTriangulator::_area(CTriangulator *this) {
   double *pdVar1;
   double *pdVar2;
   int iVar3;
   double *pdVar4;
...
/* FLOAT_MATH::CTriangulator::_snip(int, int, int, int, int*) */ulong FLOAT_MATH::CTriangulator::_snip(CTriangulator *this, int param_1, int param_2, int param_3, int param_4, int *param_5) {
   double *pdVar1;
   double dVar2;
   double dVar3;
   double dVar4;
   ...
   if (0 < param_4) {
      ...
      do {
         ...
         uVar16 = (uint)CONCAT71(( int7 )(uVar17 >> 8), param_1 == iVar11) | (uint)CONCAT71(uVar14, param_2 == iVar11);
         ...
         if (bVar15 == 0) {
            ...
            dVar8 = pdVar13[1];
            dVar9 = *pdVar13;
            if (( ( 0.0 <= ( dVar7 - dVar4 ) * ( dVar8 - dVar5 ) - ( dVar6 - dVar5 ) * ( dVar9 - dVar4 ) ) && ( 0.0 <= ( dVar2 - dVar7 ) * ( dVar8 - dVar6 ) - ( dVar3 - dVar6 ) * ( dVar9 - dVar7 ) ) ) && ( 0.0 <= ( dVar8 - dVar3 ) * ( dVar4 - dVar2 ) - ( dVar9 - dVar2 ) * ( dVar5 - dVar3 ) )) {
               return uVar17;
            }
...
/* FLOAT_MATH::CTriangulator::_insideTriangle(FLOAT_MATH::TVec const&, FLOAT_MATH::TVec const&,
   FLOAT_MATH::TVec const&, FLOAT_MATH::TVec const&) */bool FLOAT_MATH::CTriangulator::_insideTriangle(CTriangulator *this, TVec *param_1, TVec *param_2, TVec *param_3, TVec *param_4) {
   double dVar1;
   double dVar2;
   double dVar3;
   double dVar4;
...
/* FLOAT_MATH::fm_createTriangulate() */void FLOAT_MATH::fm_createTriangulate(void) {
   undefined8 *puVar1;
...
/* FLOAT_MATH::fm_releaseTriangulate(FLOAT_MATH::fm_Triangulate*) */void FLOAT_MATH::fm_releaseTriangulate(fm_Triangulate *param_1) {
...
/* FLOAT_MATH::validDistance(float const*, float const*, float) */bool FLOAT_MATH::validDistance(float *param_1, float *param_2, float param_3) {
   return param_3 * param_3 <= ( *param_1 - *param_2 ) * ( *param_1 - *param_2 ) + ( param_1[1] - param_2[1] ) * ( param_1[1] - param_2[1] ) + ( param_1[2] - param_2[2] ) * ( param_1[2] - param_2[2] );
}
/* FLOAT_MATH::fm_isValidTriangle(float const*, float const*, float const*, float) */undefined1 FLOAT_MATH::fm_isValidTriangle(float *param_1, float *param_2, float *param_3, float param_4) {
   float fVar1;
   float fVar2;
   float fVar3;
   float *pfVar4;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   uVar5 = 0;
   if (fVar13 <= ( fVar1 - fVar16 ) * ( fVar1 - fVar16 ) + ( fVar2 - fVar14 ) * ( fVar2 - fVar14 ) + ( fVar3 - fVar15 ) * ( fVar3 - fVar15 )) {
      fVar17 = *param_3;
      fVar19 = param_3[1];
      fVar18 = param_3[2];
      if (( ( fVar13 <= ( fVar1 - fVar17 ) * ( fVar1 - fVar17 ) + ( fVar2 - fVar19 ) * ( fVar2 - fVar19 ) + ( fVar3 - fVar18 ) * ( fVar3 - fVar18 ) ) && ( fVar13 <= ( fVar16 - fVar17 ) * ( fVar16 - fVar17 ) + ( fVar14 - fVar19 ) * ( fVar14 - fVar19 ) + ( fVar15 - fVar18 ) * ( fVar15 - fVar18 ) ) ) && ( uVar5 = param_4 < extraout_XMM0_Da )) {
         iVar11 = 0;
         iVar8 = 0;
         pfVar12 = &fStack_36c;
         puVar10 = local_348;
 ...
 while ( true );
   ...
   LAB_00105879:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }

   return uVar5;
   LAB_001059b0:uVar5 = iVar11 == 3;
   goto LAB_00105879;
}
/* FLOAT_MATH::fm_multiplyQuat(float const*, float const*, float*) */void FLOAT_MATH::fm_multiplyQuat(float *param_1, float *param_2, float *param_3) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
...
/* FLOAT_MATH::fm_computeCentroid(unsigned int, float const*, float*) */undefined8 FLOAT_MATH::fm_computeCentroid(uint param_1, float *param_2, float *param_3) {
   undefined8 uVar1;
   float *pfVar2;
   float *pfVar3;
   float fVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FLOAT_MATH::fm_computeCentroid(unsigned int, float const*, unsigned int, unsigned int const*,
   float*) */undefined8 FLOAT_MATH::fm_computeCentroid(uint param_1, float *param_2, uint param_3, uint *param_4, float *param_5) {
   float *pfVar1;
   float *pfVar2;
   float *pfVar3;
   uint uVar4;
   ...
   if (param_1 != 0) {
      ...
      if (param_3 == 0) {
         ...
         do {
            ...
            auVar8._0_4_ = (float)*(undefined8*)pfVar2 + (float)*(undefined8*)pfVar1 + (float)*(undefined8*)pfVar3;
            auVar8._4_4_ = (float)( ( ulong ) * (undefined8*)pfVar2 >> 0x20 ) + (float)( ( ulong ) * (undefined8*)pfVar1 >> 0x20 ) + (float)( ( ulong ) * (undefined8*)pfVar3 >> 0x20 );
            auVar8._8_8_ = 0;
            auVar9._4_4_ = uVar13;
            auVar9._0_4_ = fVar12;
            auVar9._8_4_ = uVar14;
...
/* FLOAT_MATH::fm_transformAABB(float const*, float const*, float const*, float*, float*) */void FLOAT_MATH::fm_transformAABB(float *param_1, float *param_2, float *param_3, float *param_4, float *param_5) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   if (param_3 != (float*)0x0) {
      ...
      while (true) {
         ...
         fVar3 = param_3[4];
         fVar4 = param_3[8];
         *(ulong*)( pfVar6 + 1 ) = CONCAT44((float)( ( ulong ) * (undefined8*)( param_3 + 5 ) >> 0x20 ) * fVar8 + (float)( ( ulong ) * (undefined8*)( param_3 + 1 ) >> 0x20 ) * fVar1 + (float)( ( ulong ) * (undefined8*)( param_3 + 9 ) >> 0x20 ) * fVar9 + (float)( ( ulong ) * (undefined8*)( param_3 + 0xd ) >> 0x20 ), (float)*(undefined8*)( param_3 + 5 ) * fVar8 + (float)*(undefined8*)( param_3 + 1 ) * fVar1 + (float)*(undefined8*)( param_3 + 9 ) * fVar9 + (float)*(undefined8*)( param_3 + 0xd ));
...
/* FLOAT_MATH::fm_normalizeQuat(float*) */void FLOAT_MATH::fm_normalizeQuat(float *param_1) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   *param_1 = fVar1 * *param_1;
   for (int i = 0; i < 3; i++) {
      param_1[( i + 1 )] = fVar1 * param_1[( i + 1 )];
   }

   return;
}
/* FLOAT_MATH::fm_inverseRT(double const*, double const*, double*) */void FLOAT_MATH::fm_inverseRT(double *param_1, double *param_2, double *param_3) {
   double dVar1;
   double dVar2;
   double dVar3;
...
/* FLOAT_MATH::fm_getDeterminant(double const*) */double FLOAT_MATH::fm_getDeterminant(double *param_1) {
   return ( param_1[5] * param_1[10] - param_1[6] * param_1[9] ) * *param_1 + ( param_1[6] * param_1[8] - param_1[10] * param_1[4] ) * param_1[1] + ( param_1[4] * param_1[9] - param_1[5] * param_1[8] ) * param_1[2];
}
/* FLOAT_MATH::fm_squared(double) */double FLOAT_MATH::fm_squared(double param_1) {
   return param_1 * param_1;
}
/* FLOAT_MATH::fm_getSubMatrix(int, int, double*, double const*) */void FLOAT_MATH::fm_getSubMatrix(int param_1, int param_2, double *param_3, double *param_4) {
   int iVar1;
   int iVar2;
   int iVar3;
   int iVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FLOAT_MATH::fm_inverseTransform(double const*, double*) */void FLOAT_MATH::fm_inverseTransform(double *param_1, double *param_2) {
   uint uVar1;
   int extraout_EDX;
   long lVar2;
   int iVar3;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FLOAT_MATH::fm_identity(double*) */void FLOAT_MATH::fm_identity(double *param_1) {
   double dVar1;
   double dVar2;
   double dVar3;
   dVar3 = _LC56;
...
/* FLOAT_MATH::fm_quatToEuler(double const*, double&, double&, double&) */void FLOAT_MATH::fm_quatToEuler(double *param_1, double *param_2, double *param_3, double *param_4) {
   double dVar1;
   double dVar2;
   double dVar3;
   double __x;
   ...
   __x = _LC54;
   LAB_001061f8:dVar3 = atan2(dVar2, dVar3);
   *param_2 = dVar3;
...
/* FLOAT_MATH::fm_getAABB(unsigned int, double const*, unsigned int, double*, double*) */void FLOAT_MATH::fm_getAABB(uint param_1, double *param_2, uint param_3, double *param_4, double *param_5) {
   double dVar1;
   uint uVar2;
   uVar2 = 1;
   *param_4 = *param_2;
...
/* FLOAT_MATH::fm_eulerToQuat(double, double, double, double*) */void FLOAT_MATH::fm_eulerToQuat(double param_1, double param_2, double param_3, double *param_4) {
   double dVar1;
   double dVar2;
   double dVar3;
   double dVar4;
...
/* FLOAT_MATH::fm_eulerToQuat(double const*, double*) */void FLOAT_MATH::fm_eulerToQuat(double *param_1, double *param_2) {
   fm_eulerToQuat(*param_1, param_1[1], param_1[2], param_2);
   return;
}
/* FLOAT_MATH::fm_quatToMatrix(double const*, double*) */void FLOAT_MATH::fm_quatToMatrix(double *param_1, double *param_2) {
   double dVar1;
   double dVar2;
   double dVar3;
   double dVar4;
...
/* FLOAT_MATH::fm_eulerToMatrix(double, double, double, double*) */void FLOAT_MATH::fm_eulerToMatrix(double param_1, double param_2, double param_3, double *param_4) {
   long in_FS_OFFSET;
   double adStack_48[5];
   long local_20;
   local_20 = *(long*)( in_FS_OFFSET + 0x28 );
...
/* FLOAT_MATH::fm_quatRotate(double const*, double const*, double*) */void FLOAT_MATH::fm_quatRotate(double *param_1, double *param_2, double *param_3) {
   double dVar1;
   double dVar2;
   double dVar3;
   double dVar4;
   ...
   *param_3 = ( ( (double)( (ulong)dVar4 ^ _LC95 ) * dVar8 + dVar1 * dVar10 ) - dVar6 * dVar9 ) + dVar2 * dVar7;
...
/* FLOAT_MATH::fm_getTranslation(double const*, double*) */void FLOAT_MATH::fm_getTranslation(double *param_1, double *param_2) {
   *param_2 = param_1[0xc];
   param_2[1] = param_1[0xd];
   param_2[2] = param_1[0xe];
   return;
}
/* FLOAT_MATH::fm_matrixToQuat(double const*, double*) */void FLOAT_MATH::fm_matrixToQuat(double *param_1, double *param_2) {
   int iVar1;
   int iVar2;
   bool bVar3;
   uint uVar4;
   ...
   if (0.0 < dVar16) {
      ...
      *param_2 = ( param_1[6] - param_1[9] ) * dVar15;
      ...
      local_68[lVar5] = ( *(double*)( (long)param_1 + lVar7 ) + *(double*)( (long)param_1 + lVar6 ) ) * dVar15;
      local_68[lVar11] = ( *(double*)( (long)param_1 + lVar14 ) + *(double*)( (long)param_1 + lVar12 ) ) * dVar15;
      *param_2 = local_68[0];
      for (int i = 0; i < 3; i++) {
         param_2[( i + 1 )] = local_68[( i + 1 )];
      }
...
/* FLOAT_MATH::fm_decomposeTransform(double const*, double*, double*, double*) */void FLOAT_MATH::fm_decomposeTransform(double *param_1, double *param_2, double *param_3, double *param_4) {
   long in_FS_OFFSET;
   double local_98;
   double dStack_90;
   double local_88;
...
/* FLOAT_MATH::fm_sphereVolume(double) */double FLOAT_MATH::fm_sphereVolume(double param_1) {
   return _LC24 * param_1 * param_1 * param_1;
}
/* FLOAT_MATH::fm_cylinderVolume(double, double) */double FLOAT_MATH::fm_cylinderVolume(double param_1, double param_2) {
   return _LC61 * param_1 * param_1 * param_2;
}
/* FLOAT_MATH::fm_capsuleVolume(double, double) */double FLOAT_MATH::fm_capsuleVolume(double param_1, double param_2) {
   double dVar1;
   double dVar2;
...
/* FLOAT_MATH::fm_transform(double const*, double const*, double*) */void FLOAT_MATH::fm_transform(double *param_1, double *param_2, double *param_3) {
   double dVar1;
   double dVar2;
   double dVar3;
   double dVar4;
...
/* FLOAT_MATH::fm_rotate(double const*, double const*, double*) */void FLOAT_MATH::fm_rotate(double *param_1, double *param_2, double *param_3) {
   double dVar1;
   double dVar2;
   double dVar3;
   double dVar4;
...
/* FLOAT_MATH::fm_distance(double const*, double const*) */double FLOAT_MATH::fm_distance(double *param_1, double *param_2) {
   return SQRT(( param_1[2] - param_2[2] ) * ( param_1[2] - param_2[2] ) + ( *param_1 - *param_2 ) * ( *param_1 - *param_2 ) + ( param_1[1] - param_2[1] ) * ( param_1[1] - param_2[1] ));
}
/* FLOAT_MATH::fm_distanceSquared(double const*, double const*) */double FLOAT_MATH::fm_distanceSquared(double *param_1, double *param_2) {
   return ( *param_1 - *param_2 ) * ( *param_1 - *param_2 ) + ( param_1[1] - param_2[1] ) * ( param_1[1] - param_2[1] ) + ( param_1[2] - param_2[2] ) * ( param_1[2] - param_2[2] );
}
/* FLOAT_MATH::fm_distanceSquaredXZ(double const*, double const*) */double FLOAT_MATH::fm_distanceSquaredXZ(double *param_1, double *param_2) {
   return ( *param_1 - *param_2 ) * ( *param_1 - *param_2 ) + ( param_1[2] - param_2[2] ) * ( param_1[2] - param_2[2] );
}
/* FLOAT_MATH::fm_computePlane(double const*, double const*, double const*, double*) */double FLOAT_MATH::fm_computePlane(double *param_1, double *param_2, double *param_3, double *param_4) {
   double dVar1;
   double dVar2;
   double dVar3;
   double dVar4;
...
/* FLOAT_MATH::fm_distToPlane(double const*, double const*) */double FLOAT_MATH::fm_distToPlane(double *param_1, double *param_2) {
   return *param_2 * *param_1 + param_2[1] * param_1[1] + param_2[2] * param_1[2] + param_1[3];
}
/* FLOAT_MATH::fm_dot(double const*, double const*) */double FLOAT_MATH::fm_dot(double *param_1, double *param_2) {
   return *param_1 * *param_2 + param_1[1] * param_2[1] + param_1[2] * param_2[2];
}
/* FLOAT_MATH::fm_cross(double*, double const*, double const*) */void FLOAT_MATH::fm_cross(double *param_1, double *param_2, double *param_3) {
   *param_1 = param_2[1] * param_3[2] - param_2[2] * param_3[1];
   param_1[1] = param_2[2] * *param_3 - *param_2 * param_3[2];
   param_1[2] = *param_2 * param_3[1] - param_2[1] * *param_3;
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FLOAT_MATH::fm_normalize(double*) */void FLOAT_MATH::fm_normalize(double *param_1) {
   double dVar1;
   double dVar2;
   double dVar3;
   double dVar4;
...
/* FLOAT_MATH::fm_computeNormalVector(double*, double const*, double const*) */void FLOAT_MATH::fm_computeNormalVector(double *param_1, double *param_2, double *param_3) {
   *param_1 = *param_3 - *param_2;
   param_1[1] = param_3[1] - param_2[1];
   param_1[2] = param_3[2] - param_2[2];
   fm_normalize(param_1);
...
/* FLOAT_MATH::fm_computeWindingOrder(double const*, double const*, double const*) */bool FLOAT_MATH::fm_computeWindingOrder(double *param_1, double *param_2, double *param_3) {
   double *extraout_RDX;
   long in_FS_OFFSET;
   double dVar1;
   double dVar2;
   ...
   if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 0.0 < ( local_38 * local_28 - local_18 * local_48 ) * 0.0 + ( local_18 * dStack_40 - local_38 * dStack_20 ) + ( dStack_20 * local_48 - dStack_40 * local_28 ) * 0.0;
   }

   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
/* FLOAT_MATH::fm_eulerToQuatDX(double, double, double, double*) */void FLOAT_MATH::fm_eulerToQuatDX(double param_1, double param_2, double param_3, double *param_4) {
   double *pdVar1;
   long in_FS_OFFSET;
   double adStack_c8[4];
   double local_a8[17];
...
/* FLOAT_MATH::fm_eulerToMatrixDX(double, double, double, double*) */void FLOAT_MATH::fm_eulerToMatrixDX(double param_1, double param_2, double param_3, double *param_4) {
   double dVar1;
   double dVar2;
   double dVar3;
   double dVar4;
...
/* FLOAT_MATH::fm_scale(double, double, double, double*) */void FLOAT_MATH::fm_scale(double param_1, double param_2, double param_3, double *param_4) {
   *param_4 = param_1;
   param_4[5] = param_2;
   param_4[10] = param_3;
   return;
}
/* FLOAT_MATH::fm_setTranslation(double const*, double*) */void FLOAT_MATH::fm_setTranslation(double *param_1, double *param_2) {
   param_2[0xc] = *param_1;
   param_2[0xd] = param_1[1];
   param_2[0xe] = param_1[2];
   return;
}
/* FLOAT_MATH::fm_computeArea(double const*, double const*, double const*) */double FLOAT_MATH::fm_computeArea(double *param_1, double *param_2, double *param_3) {
   double dVar1;
   double dVar2;
   double dVar3;
   double dVar4;
...
/* FLOAT_MATH::fm_lerp(double const*, double const*, double*, double) */void FLOAT_MATH::fm_lerp(double *param_1, double *param_2, double *param_3, double param_4) {
   *param_3 = ( *param_2 - *param_1 ) * param_4 + *param_1;
   param_3[1] = ( param_2[1] - param_1[1] ) * param_4 + param_1[1];
   param_3[2] = ( param_2[2] - param_1[2] ) * param_4 + param_1[2];
   return;
}
/* FLOAT_MATH::fm_pointTestXZ(double const*, double const*, double const*) */bool FLOAT_MATH::fm_pointTestXZ(double *param_1, double *param_2, double *param_3) {
   double dVar1;
   double dVar2;
   double dVar3;
   double dVar4;
   ...
   dVar2 = param_3[2];
   dVar3 = dVar2;
   if (( ( dVar4 <= dVar1 ) || ( dVar3 = dVar4 ),dVar2 <= dVar1 )) {
...
/* FLOAT_MATH::fm_insideTriangleXZ(double const*, double const*, double const*, double const*) */uint FLOAT_MATH::fm_insideTriangleXZ(double *param_1, double *param_2, double *param_3, double *param_4) {
   uint uVar1;
   uint uVar2;
   double *extraout_RDX;
   uVar1 = fm_pointTestXZ(param_1, param_2, param_3);
...
/* FLOAT_MATH::fm_insideAABB(double const*, double const*, double const*) */bool FLOAT_MATH::fm_insideAABB(double *param_1, double *param_2, double *param_3) {
   if (( ( ( *param_2 <= *param_1 ) && ( *param_1 <= *param_3 ) ) && ( param_2[1] <= param_1[1] ) ) && ( ( param_1[1] <= param_3[1] && ( param_2[2] <= param_1[2] ) ) )) {
      return param_1[2] <= param_3[2];
   }
...
/* FLOAT_MATH::fm_clipTestPoint(double const*, double const*, double const*) */byte FLOAT_MATH::fm_clipTestPoint(double *param_1, double *param_2, double *param_3) {
   byte bVar1;
   double dVar2;
   dVar2 = *param_3;
   bVar1 = 1;
   ...
   dVar2 = param_3[2];
   if (param_1[2] <= dVar2) {
      LAB_0010787a:if (param_2[2] <= dVar2 && dVar2 != param_2[2]) {
         bVar1 = bVar1 | 0x20;
      }
   ...
   LAB_00107855:return bVar1 | 0x10;
}
/* FLOAT_MATH::fm_clipTestPointXZ(double const*, double const*, double const*) */byte FLOAT_MATH::fm_clipTestPointXZ(double *param_1, double *param_2, double *param_3) {
   double dVar1;
   byte bVar2;
   dVar1 = *param_3;
   bVar2 = 1;
...
/* FLOAT_MATH::fm_clipTestAABB(double const*, double const*, double const*, double const*, double
   const*, unsigned int&) */uint FLOAT_MATH::fm_clipTestAABB(double *param_1, double *param_2, double *param_3, double *param_4, double *param_5, uint *param_6) {
   uint uVar1;
   uint uVar2;
   uint uVar3;
   uint uVar4;
...
/* FLOAT_MATH::intersect(double const*, double const*, double const*, double const*, double*) */undefined8 FLOAT_MATH::intersect(double *param_1, double *param_2, double *param_3, double *param_4, double *param_5) {
   double dVar1;
   double dVar2;
   double dVar3;
   double dVar4;
...
/* FLOAT_MATH::fm_lineTestAABB(double const*, double const*, double const*, double const*, double&)
    */void FLOAT_MATH::fm_lineTestAABB(double *param_1, double *param_2, double *param_3, double *param_4, double *param_5) {
   intersect(param_1, param_2, param_3, param_4, param_5);
   return;
}
/* FLOAT_MATH::fm_lineTestAABBXZ(double const*, double const*, double const*, double const*,
   double&) */void FLOAT_MATH::fm_lineTestAABBXZ(double *param_1, double *param_2, double *param_3, double *param_4, double *param_5) {
   long in_FS_OFFSET;
   double local_48;
   undefined8 local_40;
   double local_38;
...
/* FLOAT_MATH::fm_minmax(double const*, double*, double*) */void FLOAT_MATH::fm_minmax(double *param_1, double *param_2, double *param_3) {
   double dVar1;
   if (*param_1 < *param_2) {
      *param_2 = *param_1;
   }
...
/* FLOAT_MATH::fm_solveX(double const*, double, double) */double FLOAT_MATH::fm_solveX(double *param_1, double param_2, double param_3) {
   return (double)( ( ulong )(param_2 * param_1[1] + param_3 * param_1[2] + param_1[3]) ^ _LC95 ) / *param_1;
}
/* FLOAT_MATH::fm_solveY(double const*, double, double) */double FLOAT_MATH::fm_solveY(double *param_1, double param_2, double param_3) {
   return (double)( ( ulong )(param_2 * *param_1 + param_3 * param_1[2] + param_1[3]) ^ _LC95 ) / param_1[1];
}
/* FLOAT_MATH::fm_solveZ(double const*, double, double) */double FLOAT_MATH::fm_solveZ(double *param_1, double param_2, double param_3) {
   return (double)( ( ulong )(param_2 * *param_1 + param_3 * param_1[1] + param_1[3]) ^ _LC95 ) / param_1[2];
}
/* FLOAT_MATH::fm_getAABBCenter(double const*, double const*, double*) */void FLOAT_MATH::fm_getAABBCenter(double *param_1, double *param_2, double *param_3) {
   double dVar1;
   dVar1 = _LC50;
...
/* FLOAT_MATH::fm_getDominantAxis(double const*) */char FLOAT_MATH::fm_getDominantAxis(double *param_1) {
   char cVar1;
   double dVar2;
   double dVar3;
   dVar2 = (double)( (ulong)param_1[1] & _LC58 );
   dVar3 = (double)( (ulong)param_1[2] & _LC58 );
   if (( dVar2 <= (double)( ( ulong ) * param_1 & _LC58 ) ) || ( cVar1 = dVar2 <= dVar3 )) {
...
/* FLOAT_MATH::fm_raySphereIntersect(double const*, double, double const*, double const*, double,
   double*) */bool FLOAT_MATH::fm_raySphereIntersect(double *param_1, double param_2, double *param_3, double *param_4, double param_5, double *param_6) {
   bool bVar1;
   double dVar2;
   double dVar3;
   double dVar4;
...
/* FLOAT_MATH::fm_lineSphereIntersect(double const*, double, double const*, double const*, double*)
    */undefined8 FLOAT_MATH::fm_lineSphereIntersect(double *param_1, double param_2, double *param_3, double *param_4, double *param_5) {
   double dVar1;
   undefined8 uVar2;
   long in_FS_OFFSET;
   double dVar3;
   ...
   dVar3 = SQRT(local_28 * local_28 + ( param_4[1] - param_3[1] ) * ( param_4[1] - param_3[1] ) + local_18 * local_18);
   if (0.0 < dVar3) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FLOAT_MATH::fm_catmullRom(double*, double const*, double const*, double const*, double const*,
   double) */void FLOAT_MATH::fm_catmullRom(double *param_1, double *param_2, double *param_3, double *param_4, double *param_5, double param_6) {
   double dVar1;
   double dVar2;
   double dVar3;
   double dVar4;
   ...
   *param_1 = ( *param_2 * dVar2 + *param_3 * dVar6 + *param_4 * dVar3 + *param_5 * dVar4 ) * _LC50;
   param_1[1] = ( param_2[1] * dVar2 + param_3[1] * dVar6 + param_4[1] * dVar3 + param_5[1] * dVar4 ) * dVar1;
   param_1[2] = ( dVar2 * param_2[2] + dVar6 * param_3[2] + dVar3 * param_4[2] + dVar4 * param_5[2] ) * dVar1;
   return;
}
/* FLOAT_MATH::fm_intersectAABB(double const*, double const*, double const*, double const*) */bool FLOAT_MATH::fm_intersectAABB(double *param_1, double *param_2, double *param_3, double *param_4) {
   bool bVar1;
   bVar1 = false;
   if (( ( ( *param_1 < *param_4 || *param_1 == *param_4 ) && ( *param_3 < *param_2 || *param_3 == *param_2 ) ) && ( param_1[1] < param_4[1] || param_1[1] == param_4[1] ) ) && ( ( bVar1 = false ),param_3[1] < param_2[1] || param_3[1] == param_2[1] && ( param_1[2] < param_4[2] || param_1[2] == param_4[2] ) )) {
      bVar1 = param_3[2] < param_2[2] || param_3[2] == param_2[2];
...
/* FLOAT_MATH::fm_insideAABB(double const*, double const*, double const*, double const*) */bool FLOAT_MATH::fm_insideAABB(double *param_1, double *param_2, double *param_3, double *param_4) {
   if (( ( ( *param_4 <= *param_2 ) && ( param_4[1] <= param_2[1] ) ) && ( param_4[2] <= param_2[2] ) ) && ( ( *param_1 <= *param_3 && ( param_1[1] <= param_3[1] ) ) )) {
      return param_1[2] <= param_3[2];
   }
...
/* FLOAT_MATH::fm_rotationArc(double const*, double const*, double*) */void FLOAT_MATH::fm_rotationArc(double *param_1, double *param_2, double *param_3) {
   double dVar1;
   double dVar2;
   float fVar3;
   double dVar4;
...
/* FLOAT_MATH::fm_distancePointLineSegment(double const*, double const*, double const*, double*,
   FLOAT_MATH::LineSegmentType&, double) */double FLOAT_MATH::fm_distancePointLineSegment(double *param_1, double *param_2, double *param_3, double *param_4, LineSegmentType *param_5, double param_6) {
   int iVar1;
   double dVar2;
   double dVar3;
   double dVar4;
   ...
   if (0.0 < dVar2) {
      ...
      if (( 0.0 <= dVar2 ) && ( dVar2 <= _LC54 )) {
         ...
         *param_4 = dVar8;
         ...
         param_4[2] = dVar3;
         dVar2 = SQRT(( param_1[2] - dVar3 ) * ( param_1[2] - dVar3 ) + ( *param_1 - dVar8 ) * ( *param_1 - dVar8 ) + ( param_1[1] - dVar4 ) * ( param_1[1] - dVar4 ));
         if (dVar6 <= ( dVar8 - *param_2 ) * ( dVar8 - *param_2 ) + ( dVar4 - param_2[1] ) * ( dVar4 - param_2[1] ) + ( dVar3 - param_2[2] ) * ( dVar3 - param_2[2] )) {
            iVar1 = ( ( dVar8 - *param_3 ) * ( dVar8 - *param_3 ) + ( dVar4 - param_3[1] ) * ( dVar4 - param_3[1] ) + ( dVar3 - param_3[2] ) * ( dVar3 - param_3[2] ) < dVar6 ) + 1;
         }
   ...
   *param_4 = dVar3;
   ...
   param_4[1] = param_3[1];
   param_4[2] = param_3[2];
   LAB_0010840d:*(int*)param_5 = iVar1;
   return dVar2;
}
/* FLOAT_MATH::fm_colinear(double const*, double const*, double const*, double const*, double) */bool FLOAT_MATH::fm_colinear(double *param_1, double *param_2, double *param_3, double *param_4, double param_5) {
   double dVar1;
   double dVar2;
   double dVar3;
   long in_FS_OFFSET;
...
/* FLOAT_MATH::fm_colinear(double const*, double const*, double const*, double) */bool FLOAT_MATH::fm_colinear(double *param_1, double *param_2, double *param_3, double param_4) {
   long in_FS_OFFSET;
   double local_48;
   double dStack_40;
   double local_38;
...
/* FLOAT_MATH::fm_consolidatePolygon(unsigned int, double const*, unsigned int, double*, double)
   [clone .part.0] */int FLOAT_MATH::fm_consolidatePolygon(uint param_1, double *param_2, uint param_3, double *param_4, double param_5) {
   double *pdVar1;
   char cVar2;
   double *pdVar3;
   double *pdVar4;
...
/* FLOAT_MATH::fm_initMinMax(double const*, double*, double*) */void FLOAT_MATH::fm_initMinMax(double *param_1, double *param_2, double *param_3) {
   double dVar1;
   dVar1 = *param_1;
   *param_2 = dVar1;
   *param_3 = dVar1;
...
/* FLOAT_MATH::fm_intersectLineSegments2d(double const*, double const*, double const*, double
   const*, double*) */int FLOAT_MATH::fm_intersectLineSegments2d(double *param_1, double *param_2, double *param_3, double *param_4, double *param_5) {
   double dVar1;
   double dVar2;
   double dVar3;
   double dVar4;
   ...
   dVar7 = _LC54 / dVar7;
   dVar2 = dVar2 * dVar7;
   if (( ( ( 0.0 <= dVar2 ) && ( dVar2 <= _LC54 ) ) && ( dVar4 = dVar4 * dVar7 ),0.0 <= dVar4 )) &&( dVar4 <= _LC54 ) * param_5 = dVar6 * dVar2 + dVar1;
   param_5[1] = dVar2 * ( param_2[1] - param_1[1] ) + param_1[1];
   return 1;
}
return 0;}/* FLOAT_MATH::fm_intersectLineSegments2dTime(double const*, double const*, double const*, double
   const*, double&, double&) */int FLOAT_MATH::fm_intersectLineSegments2dTime(double *param_1, double *param_2, double *param_3, double *param_4, double *param_5, double *param_6) {
   double dVar1;
   double dVar2;
   double dVar3;
   double dVar4;
   ...
   dVar7 = _LC54 / dVar7;
   dVar1 = dVar1 * dVar7;
   if (( ( ( 0.0 <= dVar1 ) && ( dVar1 <= _LC54 ) ) && ( dVar2 = dVar2 * dVar7 ),0.0 <= dVar2 )) &&( dVar2 <= _LC54 ) * param_5 = dVar1;
   *param_6 = dVar2;
   return 1;
}
return 0;}/* FLOAT_MATH::fm_intersectPointPlane(double const*, double const*, double*, double const*) */undefined8 FLOAT_MATH::fm_intersectPointPlane(double *param_1, double *param_2, double *param_3, double *param_4) {
   double dVar1;
   double dVar2;
   double dVar3;
   double dVar4;
   ...
   if (( dVar6 < 0.0 ) || ( uVar5 = dVar8 < 0.0 )) {
      dVar10 = *param_2 - dVar1;
      dVar9 = param_2[1] - param_1[1];
      uVar5 = 1;
      dVar8 = param_2[2] - param_1[2];
      dVar7 = (double)( ( ulong )(( dVar6 - dVar4 ) + dVar4) ^ _LC95 ) / ( dVar7 * dVar10 + dVar2 * dVar9 + dVar3 * dVar8 );
...
/* FLOAT_MATH::fm_getSidePlane(double const*, double const*, double) */char FLOAT_MATH::fm_getSidePlane(double *param_1, double *param_2, double param_3) {
   double dVar1;
...
/* FLOAT_MATH::fm_planeTriIntersection(double const*, double const*, unsigned int, double, double*,
   unsigned int&, double*, unsigned int&) */char FLOAT_MATH::fm_planeTriIntersection(double *param_1, double *param_2, uint param_3, double param_4, double *param_5, uint *param_6, double *param_7, uint *param_8) {
   undefined8 *puVar1;
   double *pdVar2;
   double dVar3;
   double dVar4;
 ...
 while ( puVar22 + -0x1000 != local_7030 );
   ...
   *puVar28 = 0;
   ...
   if (( dVar36 < dVar40 ) || ( cVar26 = param_4 < dVar36 )) {
   ...
   if (( dVar37 < dVar40 ) || ( cVar15 = param_4 < dVar37 )) {
   ...
   if (( dVar41 < dVar40 ) || ( param_4 < dVar41 )) {
      if (dVar41 <= 0.0) {
         ...
         if (( cVar26 == '\x02' ) && ( bVar35 = cVar15 == '\x02' ),cVar15 = '\x02',bVar35) goto LAB_001092e6;
      }
         ...
         LAB_00109027:if (cVar15 == cVar26) goto LAB_00109034;
      }
 else if (cVar26 == '\x01') {
         joined_r0x0010945d:if (cVar15 == '\x01') goto LAB_00108d39;
      }

      LAB_00108e10:*(double*)( puVar22 + 0x17d0 ) = dVar6;
      ...
      *(undefined8*)( puVar22 + -0x18b0 ) = *(undefined8*)( puVar22 + 0x1808 );
      do {
         ...
         *(undefined8*)( puVar22 + -0x1888 ) = uVar12;
         dVar42 = *(double*)( puVar22 + -0x1898 ) * dVar43 + *(double*)( puVar22 + -0x1890 ) * dVar44 + *(double*)( puVar22 + -0x1888 ) * dVar38 + dVar39;
         if (0.0 < dVar42) {
            uVar19 = uVar23;
            if (dVar41 < 0.0) {
               ...
               *(undefined8*)( puVar22 + -0x18d0 ) = 0x109134;
               fm_intersectPointPlane((double*)( puVar22 + -0x1898 ), (double*)( puVar22 + -0x18b8 ), (double*)( puVar22 + -0x1878 ), (double*)( puVar22 + -0x1858 ));
 ...
 while ( puVar21 != puVar13 );
      ...
      if (cVar15 != '\0' || cVar26 != '\0') {
         if (cVar26 == '\0') {
            ...
            LAB_00109034:cVar15 = '\x02';
            if (cVar26 == '\x01') goto LAB_00108d39;
         }

         LAB_001092e6:*param_7 = dVar42;
      ...
      *pdVar32 = *pdVar24;
      ...
      pdVar32[2] = pdVar24[2];
      *param_6 = 3;
      LAB_00108d9f:cVar15 = '\x01';
   }

   LAB_00108da8:if (*(long*)( puVar22 + 0x5ff0 ) != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
...
/* FLOAT_MATH::computeOBB(unsigned int, double const*, unsigned int, double*, double*) */void FLOAT_MATH::computeOBB(uint param_1, double *param_2, uint param_3, double *param_4, double *param_5) {
   uint uVar1;
   long in_FS_OFFSET;
   double dVar2;
   double dVar3;
...
/* FLOAT_MATH::fm_computeBestFitABB(unsigned int, double const*, unsigned int, double*, double*) */void FLOAT_MATH::fm_computeBestFitABB(uint param_1, double *param_2, uint param_3, double *param_4, double *param_5) {
   double dVar1;
   uint uVar2;
   double dVar3;
   double dVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FLOAT_MATH::fm_planeToMatrix(double const*, double*) */void FLOAT_MATH::fm_planeToMatrix(double *param_1, double *param_2) {
   double *extraout_RDX;
   long in_FS_OFFSET;
   double local_a8;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FLOAT_MATH::fm_planeToQuat(double const*, double*, double*) */void FLOAT_MATH::fm_planeToQuat(double *param_1, double *param_2, double *param_3) {
   double dVar1;
   long in_FS_OFFSET;
   double local_c8;
...
/* FLOAT_MATH::fm_eulerMatrix(double, double, double, double*) */void FLOAT_MATH::fm_eulerMatrix(double param_1, double param_2, double param_3, double *param_4) {
   long in_FS_OFFSET;
   double adStack_48[5];
   long local_20;
   local_20 = *(long*)( in_FS_OFFSET + 0x28 );
...
/* FLOAT_MATH::fm_computeBestFitAABB(unsigned int, double const*, unsigned int, double*, double*) */double FLOAT_MATH::fm_computeBestFitAABB(uint param_1, double *param_2, uint param_3, double *param_4, double *param_5) {
   uint uVar1;
   double dVar2;
   double dVar3;
   double dVar4;
 ...
 while ( param_1 != uVar1 );
   ...
   return SQRT(( dVar2 - param_4[2] ) * ( dVar2 - param_4[2] ) + ( dVar3 - *param_4 ) * ( dVar3 - *param_4 ) + ( dVar4 - param_4[1] ) * ( dVar4 - param_4[1] ));
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FLOAT_MATH::fm_rayIntersectsTriangle(double const*, double const*, double const*, double const*,
   double const*, double&) */bool FLOAT_MATH::fm_rayIntersectsTriangle(double *param_1, double *param_2, double *param_3, double *param_4, double *param_5, double *param_6) {
   double dVar1;
   double dVar2;
   double dVar3;
   bool bVar4;
   ...
   if (( dVar16 <= __LC33 ) || ( bVar4 = _LC34 <= dVar16 )) {
      dVar16 = _LC54 / dVar16;
...
/* FLOAT_MATH::fm_lineIntersectsTriangle(double const*, double const*, double const*, double const*,
   double const*, double*) */undefined8 FLOAT_MATH::fm_lineIntersectsTriangle(double *param_1, double *param_2, double *param_3, double *param_4, double *param_5, double *param_6) {
   double dVar1;
   undefined8 uVar2;
   long in_FS_OFFSET;
   double dVar3;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FLOAT_MATH::fm_computeMeshVolume(double const*, unsigned int, unsigned int const*) */double FLOAT_MATH::fm_computeMeshVolume(double *param_1, uint param_2, uint *param_3) {
   double *pdVar1;
   double *pdVar2;
   double *pdVar3;
   uint *puVar4;
   ...
   do {
      ...
      dVar6 = dVar6 + ( ( ( ( *pdVar1 * pdVar3[1] * pdVar2[2] + *pdVar3 * pdVar2[1] * pdVar1[2] + *pdVar2 * pdVar1[1] * pdVar3[2] ) - *pdVar1 * pdVar2[1] * pdVar3[2] ) - *pdVar3 * pdVar1[1] * pdVar2[2] ) - pdVar3[1] * *pdVar2 * pdVar1[2] );
      puVar4 = puVar5;
   }
 while ( puVar5 != param_3 + (ulong)param_2 * 3 );
   dVar6 = dVar6 * __LC75;
...
/* FLOAT_MATH::fm_getPoint(double const*, unsigned int, unsigned int) */long FLOAT_MATH::fm_getPoint(double *param_1, uint param_2, uint param_3) {
   return (long)param_1 + ( ulong )(param_2 * param_3);
}
/* FLOAT_MATH::fm_insideTriangle(double, double, double, double, double, double, double, double) */bool FLOAT_MATH::fm_insideTriangle(double param_1, double param_2, double param_3, double param_4, double param_5, double param_6, double param_7, double param_8) {
   if (( 0.0 <= ( param_5 - param_3 ) * ( param_8 - param_4 ) - ( param_6 - param_4 ) * ( param_7 - param_3 ) ) && ( 0.0 <= ( param_1 - param_5 ) * ( param_8 - param_6 ) - ( param_2 - param_6 ) * ( param_7 - param_5 ) )) {
      return 0.0 <= ( param_3 - param_1 ) * ( param_8 - param_2 ) - ( param_4 - param_2 ) * ( param_7 - param_1 );
   }
...
/* FLOAT_MATH::fm_areaPolygon2d(unsigned int, double const*, unsigned int) */double FLOAT_MATH::fm_areaPolygon2d(uint param_1, double *param_2, uint param_3) {
   double dVar1;
   double *pdVar2;
   uint uVar3;
   ulong uVar4;
...
/* FLOAT_MATH::fm_pointInsidePolygon2d(unsigned int, double const*, unsigned int, double const*,
   unsigned int, unsigned int) */uint FLOAT_MATH::fm_pointInsidePolygon2d(uint param_1, double *param_2, uint param_3, double *param_4, uint param_5, uint param_6) {
   double dVar1;
   double dVar2;
   double dVar3;
   double dVar4;
...
/* FLOAT_MATH::fm_consolidatePolygon(unsigned int, double const*, unsigned int, double*, double) */undefined8 FLOAT_MATH::fm_consolidatePolygon(uint param_1, double *param_2, uint param_3, double *param_4, double param_5) {
   undefined8 uVar1;
   if (2 < param_1) {
...
/* FLOAT_MATH::splitRect(unsigned int, FLOAT_MATH::Rect3d<double> const&,
   FLOAT_MATH::Rect3d<double>&, FLOAT_MATH::Rect3d<double>&, double const*) */void FLOAT_MATH::splitRect(uint param_1, Rect3d *param_2, Rect3d *param_3, Rect3d *param_4, double *param_5) {
   undefined8 uVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   double dVar4;
   ...
   for (int i = 0; i < 3; i++) {
      *(undefined8*)( param_4 + ( 8*i + 24 ) ) = *(undefined8*)( param_2 + ( 8*i + 24 ) );
   }

   return;
}
/* FLOAT_MATH::fm_nearestPointInTriangle(double const*, double const*, double const*, double const*,
   double*) */void FLOAT_MATH::fm_nearestPointInTriangle(double *param_1, double *param_2, double *param_3, double *param_4, double *param_5) {
   return;
}
/* FLOAT_MATH::fm_areaTriangle(double const*, double const*, double const*) */double FLOAT_MATH::fm_areaTriangle(double *param_1, double *param_2, double *param_3) {
   return ( ( param_2[1] * *param_1 - *param_2 * param_1[1] ) + ( param_3[1] * *param_2 - *param_3 * param_2[1] ) + ( *param_3 * param_1[1] - param_3[1] * *param_1 ) ) * _LC50;
}
/* FLOAT_MATH::fm_subtract(double const*, double const*, double*) */void FLOAT_MATH::fm_subtract(double *param_1, double *param_2, double *param_3) {
   *param_3 = *param_1 - *param_2;
   param_3[1] = param_1[1] - param_2[1];
   param_3[2] = param_1[2] - param_2[2];
   return;
}
/* FLOAT_MATH::fm_multiplyTransform(double const*, double const*, double*) */void FLOAT_MATH::fm_multiplyTransform(double *param_1, double *param_2, double *param_3) {
   double dVar1;
   double dVar2;
   double dVar3;
   double dVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FLOAT_MATH::fm_composeTransform(double const*, double const*, double const*, double*) */void FLOAT_MATH::fm_composeTransform(double *param_1, double *param_2, double *param_3, double *param_4) {
   double dVar1;
   double dVar2;
   double dVar3;
   double *pdVar4;
   ...
   *(undefined1(*) [16])( param_4 + 0xc ) = (undefined1[16])0x0;
   ...
   pdVar5 = auVar6._8_8_;
   pdVar4 = auVar6._0_8_;
   if (( pdVar5 != (double*)0x0 ) && ( ( ( *pdVar5 != _LC54 || ( _LC54 != pdVar5[1] ) ) || ( _LC54 != pdVar5[2] ) ) )) {
      local_118 = *param_4;
...
/* FLOAT_MATH::fm_matrixMultiply(double const*, double const*, double*) */void FLOAT_MATH::fm_matrixMultiply(double *param_1, double *param_2, double *param_3) {
   fm_multiplyTransform(param_1, param_2, param_3);
   return;
}
/* FLOAT_MATH::fm_multiply(double*, double) */void FLOAT_MATH::fm_multiply(double *param_1, double param_2) {
   param_1[2] = param_2 * param_1[2];
   *param_1 = param_2 * *param_1;
   param_1[1] = param_2 * param_1[1];
   return;
}
/* FLOAT_MATH::fm_add(double const*, double const*, double*) */void FLOAT_MATH::fm_add(double *param_1, double *param_2, double *param_3) {
   *param_3 = *param_1 + *param_2;
   param_3[1] = param_1[1] + param_2[1];
   param_3[2] = param_1[2] + param_2[2];
   return;
}
/* FLOAT_MATH::fm_copy3(double const*, double*) */void FLOAT_MATH::fm_copy3(double *param_1, double *param_2) {
   *param_2 = *param_1;
   param_2[1] = param_1[1];
   param_2[2] = param_1[2];
   return;
...
/* FLOAT_MATH::fm_copyUniqueVertices(unsigned int, double const*, double*, unsigned int, unsigned
   int const*, unsigned int*) */uint FLOAT_MATH::fm_copyUniqueVertices(uint param_1, double *param_2, double *param_3, uint param_4, uint *param_5, uint *param_6) {
   double *pdVar1;
   size_t __size;
   uint *puVar2;
   uint uVar3;
...
;
 ...
 while ( (uint)lVar5 < param_4 * 3 );
   ...
   LAB_0010a99c:free(__ptr);
   free(__ptr_00);
   return uVar6;
}
/* FLOAT_MATH::fm_isMeshCoplanar(unsigned int, unsigned int const*, double const*, bool) */undefined8 FLOAT_MATH::fm_isMeshCoplanar(uint param_1, uint *param_2, double *param_3, bool param_4) {
   undefined8 uVar1;
   uint *puVar2;
   ulong uVar3;
   uint *puVar4;
   ...
   uVar1 = 1;
   if (param_1 != 0) {
      puVar2 = (uint*)fm_computePlane(param_3 + *param_2 * 3, param_3 + param_2[1] * 3, param_3 + param_2[2] * 3, &local_58);
      ...
      if (param_1 != 1) {
         ...
         uVar7 = _LC58;
         do {
            puVar2 = (uint*)fm_computePlane(param_3 + *puVar2 * 3, param_3 + puVar2[1] * 3, param_3 + puVar2[2] * 3, pdVar5);
            if (dVar8 <= (double)( ( ulong )(dVar11 - extraout_XMM0_Qa_00) & uVar7 )) {
               LAB_0010ab31:uVar1 = 0;
               goto LAB_0010a9f8;
            }
 ...
 while ( puVar2 != puVar4 );
   ...
   LAB_0010a9f8:if (local_10 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* FLOAT_MATH::fm_samePlane(double const*, double const*, double, double, bool) */bool FLOAT_MATH::fm_samePlane(double *param_1, double *param_2, double param_3, double param_4, bool param_5) {
   double dVar1;
...
/* FLOAT_MATH::fm_initMinMax(double*, double*) */void FLOAT_MATH::fm_initMinMax(double *param_1, double *param_2) {
   double dVar1;
   double dVar2;
   dVar1 = _LC79;
   param_1[2] = _LC79;
...
/* FLOAT_MATH::fm_inflateMinMax(double*, double*, double) */void FLOAT_MATH::fm_inflateMinMax(double *param_1, double *param_2, double param_3) {
   double dVar1;
   dVar1 = param_1[2] - param_2[2];
   dVar1 = SQRT(( *param_1 - *param_2 ) * ( *param_1 - *param_2 ) + ( param_1[1] - param_2[1] ) * ( param_1[1] - param_2[1] ) + dVar1 * dVar1) * _LC50 * param_3;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FLOAT_MATH::fm_computeBestFitSphere(unsigned int, double const*, unsigned int, double*) */double FLOAT_MATH::fm_computeBestFitSphere(uint param_1, double *param_2, uint param_3, double *param_4) {
   double dVar1;
   int iVar2;
   double *pdVar3;
   uint uVar4;
 ...
 while ( param_1 != uVar4 );
      dVar17 = ( dVar5 - local_30 ) * ( dVar5 - local_30 ) + ( dVar14 - dVar9 ) * ( dVar14 - dVar9 ) + ( local_38 - local_28 ) * ( local_38 - local_28 );
      dVar18 = ( dVar20 - dVar19 ) * ( dVar20 - dVar19 ) + ( dVar11 - dVar7 ) * ( dVar11 - dVar7 ) + ( dVar12 - dVar10 ) * ( dVar12 - dVar10 );
      dVar21 = ( dVar8 - dVar15 ) * ( dVar8 - dVar15 ) + ( dVar16 - local_40 ) * ( dVar16 - local_40 ) + ( dVar13 - dVar6 ) * ( dVar13 - dVar6 );
      if (dVar18 <= dVar17) {
         dVar11 = dVar14;
         dVar10 = local_28;
         dVar7 = dVar9;
   ...
   *param_4 = dVar10;
   param_4[1] = dVar11;
   dVar12 = _LC54;
   dVar8 = ( dVar8 - dVar10 ) * ( dVar8 - dVar10 ) + ( dVar16 - dVar11 ) * ( dVar16 - dVar11 ) + ( dVar13 - dVar6 ) * ( dVar13 - dVar6 );
   dVar13 = SQRT(dVar8);
   if (param_1 != 0) {
      iVar2 = 0;
      while (true) {
...
/* FLOAT_MATH::validDistance(double const*, double const*, double) */bool FLOAT_MATH::validDistance(double *param_1, double *param_2, double param_3) {
   return param_3 * param_3 <= ( *param_1 - *param_2 ) * ( *param_1 - *param_2 ) + ( param_1[1] - param_2[1] ) * ( param_1[1] - param_2[1] ) + ( param_1[2] - param_2[2] ) * ( param_1[2] - param_2[2] );
}
/* FLOAT_MATH::fm_isValidTriangle(double const*, double const*, double const*, double) */undefined1 FLOAT_MATH::fm_isValidTriangle(double *param_1, double *param_2, double *param_3, double param_4) {
   double dVar1;
   double *pdVar2;
   undefined1 uVar3;
   char cVar4;
   ...
   if (dVar13 <= dVar11 * dVar11 + ( dVar18 - dVar16 ) * ( dVar18 - dVar16 ) + ( dVar1 - dVar14 ) * ( dVar1 - dVar14 )) {
      dVar11 = *param_3;
      dVar19 = param_3[1];
      dVar20 = param_3[2];
      dVar12 = *param_1 - dVar11;
      if (( ( dVar13 <= dVar12 * dVar12 + ( dVar18 - dVar19 ) * ( dVar18 - dVar19 ) + ( dVar1 - dVar20 ) * ( dVar1 - dVar20 ) ) && ( dVar12 = *param_2 - dVar11 ),dVar13 <= dVar12 * dVar12 + ( dVar16 - dVar19 ) * ( dVar16 - dVar19 ) + ( dVar14 - dVar20 ) * ( dVar14 - dVar20 ) )) {
         iVar9 = 0;
         iVar6 = 0;
         pdVar10 = &local_680;
         pdVar8 = local_648;
 ...
 while ( true );
   ...
   LAB_0010b205:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }

   return uVar3;
   LAB_0010b330:uVar3 = iVar9 == 3;
   goto LAB_0010b205;
}
/* FLOAT_MATH::fm_multiplyQuat(double const*, double const*, double*) */void FLOAT_MATH::fm_multiplyQuat(double *param_1, double *param_2, double *param_3) {
   double dVar1;
   double dVar2;
   double dVar3;
   double dVar4;
...
/* FLOAT_MATH::fm_computeCentroid(unsigned int, double const*, double*) */undefined8 FLOAT_MATH::fm_computeCentroid(uint param_1, double *param_2, double *param_3) {
   undefined8 uVar1;
   double *pdVar2;
   double *pdVar3;
   double dVar4;
...
/* FLOAT_MATH::fm_computeCentroid(unsigned int, double const*, unsigned int, unsigned int const*,
   double*) */undefined8 FLOAT_MATH::fm_computeCentroid(uint param_1, double *param_2, uint param_3, uint *param_4, double *param_5) {
   double *pdVar1;
   double *pdVar2;
   double *pdVar3;
   uint uVar4;
...
/* FLOAT_MATH::fm_transformAABB(double const*, double const*, double const*, double*, double*) */void FLOAT_MATH::fm_transformAABB(double *param_1, double *param_2, double *param_3, double *param_4, double *param_5) {
   double dVar1;
   double dVar2;
   double dVar3;
   double dVar4;
      ...
      while (true) {
         ...
         *pdVar13 = dVar1 * dVar2 + dVar3 * dVar4 + dVar5 * dVar6 + param_3[0xc];
         ...
         do {
            ...
            LAB_0010b711:pdVar13 = pdVar12 + 3;
         }
...
/* FLOAT_MATH::fm_normalizeQuat(double*) */void FLOAT_MATH::fm_normalizeQuat(double *param_1) {
   double dVar1;
   double dVar2;
   double dVar3;
   double dVar4;
...
/* FLOAT_MATH::fm_computeBestFitPlane(unsigned int, float const*, unsigned int, float const*,
   unsigned int, float*, float*) */undefined8 FLOAT_MATH::fm_computeBestFitPlane(uint param_1, float *param_2, uint param_3, float *param_4, uint param_5, float *param_6, float *param_7) {
   float *pfVar1;
   float fVar2;
   float *pfVar3;
   float *pfVar4;
 ...
 while ( bVar7 );
   ...
   *(ulong*)( param_6 + 2 ) = CONCAT44(0.0 - ( fVar14 * local_48 + fVar12 * local_60 + fVar13 * local_54 ), local_48);
   if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* FLOAT_MATH::fm_computeBestFitOBB(unsigned int, float const*, unsigned int, float*, float*, bool)
    */void FLOAT_MATH::fm_computeBestFitOBB(uint param_1, float *param_2, uint param_3, float *param_4, float *param_5, bool param_6) {
   float *extraout_RDX;
   int iVar1;
   float *pfVar2;
   long in_FS_OFFSET;
...
;
 ...
 while ( iVar1 != 0 );
   ...
   LAB_0010bd60:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* FLOAT_MATH::fm_computeBestFitOBB(unsigned int, float const*, unsigned int, float*, float*,
   float*, bool) */void FLOAT_MATH::fm_computeBestFitOBB(uint param_1, float *param_2, uint param_3, float *param_4, float *param_5, float *param_6, bool param_7) {
   long in_FS_OFFSET;
   float afStack_68[12];
   undefined8 local_38;
   float local_30;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FLOAT_MATH::fm_computeSplitPlane(unsigned int, float const*, unsigned int, unsigned int const*,
   float*) */undefined8 FLOAT_MATH::fm_computeSplitPlane(uint param_1, float *param_2, uint param_3, uint *param_4, float *param_5) {
   float *pfVar1;
   uint uVar2;
   float *pfVar3;
   float *pfVar4;
...
/* FLOAT_MATH::fm_computeBestFitCapsule(unsigned int, float const*, unsigned int, float&, float&,
   float*, bool) */void FLOAT_MATH::fm_computeBestFitCapsule(uint param_1, float *param_2, uint param_3, float *param_4, float *param_5, float *param_6, bool param_7) {
   uint uVar1;
   float *pfVar2;
   ulong uVar3;
   long in_FS_OFFSET;
 ...
 while ( param_1 != uVar1 );
         ...
         LAB_0010c0d8:fm_eulerToQuat(_LC91, 0.0, 0.0, &local_d8);
         pfVar2 = local_88;
         fm_quatToMatrix(&local_d8, pfVar2);
         fm_multiplyTransform(pfVar2, local_c8, param_6);
         if (param_1 == 0) goto LAB_0010c360;
...
/* FLOAT_MATH::fm_computeBestFitPlane(unsigned int, double const*, unsigned int, double const*,
   unsigned int, double*, double*) */undefined8 FLOAT_MATH::fm_computeBestFitPlane(uint param_1, double *param_2, uint param_3, double *param_4, uint param_5, double *param_6, double *param_7) {
   double *pdVar1;
   double dVar2;
   double *pdVar3;
   double *pdVar4;
...
/* FLOAT_MATH::fm_computeBestFitOBB(unsigned int, double const*, unsigned int, double*, double*,
   bool) */void FLOAT_MATH::fm_computeBestFitOBB(uint param_1, double *param_2, uint param_3, double *param_4, double *param_5, bool param_6) {
   double *extraout_RDX;
   int iVar1;
   double *pdVar2;
   long in_FS_OFFSET;
...
;
 ...
 while ( iVar1 != 0 );
   ...
   LAB_0010c910:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* FLOAT_MATH::fm_computeBestFitOBB(unsigned int, double const*, unsigned int, double*, double*,
   double*, bool) */void FLOAT_MATH::fm_computeBestFitOBB(uint param_1, double *param_2, uint param_3, double *param_4, double *param_5, double *param_6, bool param_7) {
   long in_FS_OFFSET;
...
/* FLOAT_MATH::fm_computeSplitPlane(unsigned int, double const*, unsigned int, unsigned int const*,
   double*) */undefined8 FLOAT_MATH::fm_computeSplitPlane(uint param_1, double *param_2, uint param_3, uint *param_4, double *param_5) {
   double *pdVar1;
   uint uVar2;
   double *pdVar3;
   double *pdVar4;
...
/* FLOAT_MATH::fm_computeBestFitCapsule(unsigned int, double const*, unsigned int, double&, double&,
   double*, bool) */void FLOAT_MATH::fm_computeBestFitCapsule(uint param_1, double *param_2, uint param_3, double *param_4, double *param_5, double *param_6, bool param_7) {
   uint uVar1;
   double *pdVar2;
   ulong uVar3;
   long in_FS_OFFSET;
 ...
 while ( param_1 != uVar1 );
         ...
         LAB_0010ccea:fm_eulerToQuat(_LC96, 0.0, 0.0, &local_168);
         pdVar2 = local_c8;
         fm_quatToMatrix(&local_168, pdVar2);
         fm_multiplyTransform(pdVar2, local_148, param_6);
         if (param_1 == 0) goto LAB_0010cf88;
...
/* FLOAT_MATH::CTriangulator::_process(std::vector<unsigned int, std::allocator<unsigned int> >&) */void FLOAT_MATH::CTriangulator::_process(CTriangulator *this, vector *param_1) {
   char cVar1;
   int *__ptr;
   ulong uVar2;
   int *piVar3;
      ...
      do {
         ...
         if (cVar1 == '\0') {
            ...
            if (bVar17) {
               if (piVar3 == piVar4) {
                  local_44 = iVar13;
                  std::vector<unsigned_int,std::allocator<unsigned_int>>::_M_realloc_insert<unsigned_int>((vector<unsigned_int,std::allocator<unsigned_int>>*)param_1, piVar4, &local_44);
                  piVar4 = *(int**)( param_1 + 0x10 );
                  piVar3 = *(int**)( param_1 + 8 );
               }
 else {
               ...
               if (piVar12 == piVar4) {
                  local_44 = iVar13;
                  std::vector<unsigned_int,std::allocator<unsigned_int>>::_M_realloc_insert<unsigned_int>((vector<unsigned_int,std::allocator<unsigned_int>>*)param_1, piVar12, &local_44);
               }
 else {
                  *piVar12 = iVar13;
 ...
 while ( true );
   ...
   LAB_0010d375:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* FLOAT_MATH::CTriangulator::triangulate(std::vector<unsigned int, std::allocator<unsigned int> >&)
    */void FLOAT_MATH::CTriangulator::triangulate(CTriangulator *this, vector *param_1) {
   _process(this, param_1);
   return;
}
/* FLOAT_MATH::VERTEX_INDEX::KdTree::getPositionDouble(unsigned int) const */long FLOAT_MATH::VERTEX_INDEX::KdTree::getPositionDouble(KdTree *this, uint param_1) {
   return *(long*)( this + 0x28 ) + ( ulong )(param_1 * 3) * 8;
}
/* FLOAT_MATH::VERTEX_INDEX::KdTree::getPositionFloat(unsigned int) const */long FLOAT_MATH::VERTEX_INDEX::KdTree::getPositionFloat(KdTree *this, uint param_1) {
   return *(long*)( this + 0x40 ) + ( ulong )(param_1 * 3) * 4;
}
/* FLOAT_MATH::MyVertexIndex::getVerticesFloat() const */long FLOAT_MATH::MyVertexIndex::getVerticesFloat(MyVertexIndex *this) {
...
/* FLOAT_MATH::MyVertexIndex::getVerticesDouble() const */long FLOAT_MATH::MyVertexIndex::getVerticesDouble(MyVertexIndex *this) {
...
/* FLOAT_MATH::MyVertexIndex::getVertexFloat(unsigned int) const */long FLOAT_MATH::MyVertexIndex::getVertexFloat(MyVertexIndex *this, uint param_1) {
   if (*(long*)( this + 0x68 ) != *(long*)( this + 0x60 )) {
...
/* FLOAT_MATH::MyVertexIndex::getVertexDouble(unsigned int) const */long FLOAT_MATH::MyVertexIndex::getVertexDouble(MyVertexIndex *this, uint param_1) {
   if (*(long*)( this + 0x50 ) != *(long*)( this + 0x48 )) {
...
/* FLOAT_MATH::MyVertexIndex::getVcount() const */undefined4 FLOAT_MATH::MyVertexIndex::getVcount(MyVertexIndex *this) {
   return *(undefined4*)( this + 0x40 );
}
/* FLOAT_MATH::MyVertexIndex::isDouble() const */byte FLOAT_MATH::MyVertexIndex::isDouble(MyVertexIndex *this) {
   return (byte)this[8] & 1;
}
/* FLOAT_MATH::CTriangulator::getPoint(unsigned int) */long FLOAT_MATH::CTriangulator::getPoint(CTriangulator *this, uint param_1) {
   return *(long*)( this + 0x40 ) + (ulong)param_1 * 0x18;
}
/* FLOAT_MATH::VERTEX_INDEX::KdTree::~KdTree() */void FLOAT_MATH::VERTEX_INDEX::KdTree::~KdTree(KdTree *this) {
   long *plVar1;
   long *plVar2;
   void *pvVar3;
...
/* FLOAT_MATH::MyVertexIndex::saveAsObj(char const*, unsigned int, unsigned int*) */undefined8 FLOAT_MATH::MyVertexIndex::saveAsObj(MyVertexIndex *this, char *param_1, uint param_2, uint *param_3) {
   double *pdVar1;
   double *pdVar2;
   float *pfVar3;
   float *pfVar4;
      ...
      if (( (byte)this[8] & 1 ) == 0) {
         ...
         if (uVar9 != 0) {
            ...
            do {
               ...
               pfVar4 = pfVar13 + 1;
               pfVar13 = pfVar13 + 3;
               __fprintf_chk((double)fVar7, (double)*pfVar4, (double)*pfVar3, __stream, 2, "v %0.9f %0.9f %0.9f\r\n");
            }
 while ( pfVar13 != pfVar6 );
         ...
         if (uVar9 != 0) {
            ...
            do {
               ...
               dVar8 = *pdVar12;
               pdVar12 = pdVar12 + 3;
               __fprintf_chk((double)(float)dVar8, (double)(float)*pdVar2, (double)(float)*pdVar1, __stream, 2, "v %0.9f %0.9f %0.9f\r\n");
            }
...
/* FLOAT_MATH::CTriangulator::reset() */void FLOAT_MATH::CTriangulator::reset(CTriangulator *this) {
...
/* FLOAT_MATH::Myfm_Tesselate::~Myfm_Tesselate() */void FLOAT_MATH::Myfm_Tesselate::~Myfm_Tesselate(Myfm_Tesselate *this) {
   void *pvVar1;
...
/* FLOAT_MATH::Triangulate::~Triangulate() */void FLOAT_MATH::Triangulate::~Triangulate(Triangulate *this) {
   free(*(void**)( this + 8 ));
   free(*(void**)( this + 0x10 ));
   return;
}
...
/* FLOAT_MATH::Triangulate::triangulate3d(unsigned int, float const*, unsigned int, unsigned int&,
   bool, float) */undefined8 FLOAT_MATH::Triangulate::triangulate3d(Triangulate *this, uint param_1, float *param_2, uint param_3, uint *param_4, bool param_5, float param_6) {
   undefined8 uVar1;
   double *__ptr;
   double *pdVar2;
   double *pdVar3;
...
/* FLOAT_MATH::MyVertexIndex::~MyVertexIndex() */void FLOAT_MATH::MyVertexIndex::~MyVertexIndex(MyVertexIndex *this) {
   long *plVar1;
   long *plVar2;
   void *pvVar3;
...
/* FLOAT_MATH::VERTEX_INDEX::KdTreeNode::search(FLOAT_MATH::VERTEX_INDEX::Axes, double const*,
   ...
   FLOAT_MATH::VERTEX_INDEX::KdTreeInterface const*) */undefined8 * __thiscall
FLOAT_MATH::VERTEX_INDEX::KdTreeNode::search
   ...
   double *pdStack_60;
   pdVar2 = param_4;
   LAB_0010dc1b:if (*(code**)*param_8 == KdTree::getPositionDouble) {
      uVar4 = *(int*)this * 3;
      auVar14._8_4_ = uVar4;
   ...
   if (param_3 == 1) {
      if (dVar13 <= 0.0) {
         ...
         if (param_1 <= dVar13) {
            LAB_0010dec0:pKVar10 = (KdTreeNode*)0x0;
            param_3 = 2;
         }
 else {
      ...
      if (dVar12 <= 0.0) {
         ...
         lVar8 = *(long*)( this + 0x10 );
         if (param_1 <= dVar12) {
            LAB_0010deb0:pKVar10 = (KdTreeNode*)0x0;
            param_3 = 0;
         }
 else {
            pKVar10 = *(KdTreeNode**)( this + 8 );
      ...
      if (dVar11 <= 0.0) {
         ...
         lVar8 = *(long*)( this + 0x10 );
         if (param_1 <= dVar11) {
            LAB_0010ded0:pKVar10 = (KdTreeNode*)0x0;
            param_3 = 1;
         }
 else {
            pKVar10 = *(KdTreeNode**)( this + 8 );
   ...
   if (dVar11 < param_1 * param_1) {
      ...
      auVar14._12_4_ = 0;
      if (uVar4 == 0) {
         LAB_0010dd13:*param_7 = (double)this;
         param_7[1] = dVar11;
         goto LAB_0010dd1c;
      }
      ...
      if (uVar4 != 1) {
         uVar3 = 0;
         pdVar2 = param_7;
         LAB_0010de0f:if (pdVar2[1] <= dVar11) goto LAB_0010de00;
         uVar9 = param_6 - 1;
         if (uVar4 < param_6) {
            uVar9 = uVar4;
         }
 ...
 while ( param_7 + uVar5 * 2 + ( ulong )(( uVar9 - uVar3 ) - 1) * -2 + -2 != pdVar7 );
   ...
   goto LAB_0010dd2d;
   LAB_0010de00:uVar3 = uVar3 + 1;
   pdVar2 = pdVar2 + 2;
   if (uVar4 <= uVar3) goto LAB_0010df58;
   goto LAB_0010de0f;
   LAB_0010df58:pdVar2 = (double*)(ulong)param_6;
   if (uVar4 < param_6) {
   ...
   *param_5 = uVar4;
   if (param_6 < uVar4) {
      LAB_0010dd27:auVar14._4_4_ = 0;
      auVar14._0_4_ = param_6;
      auVar14._8_8_ = uVar5;
      *param_5 = param_6;
   }

   LAB_0010dd2d:puVar1 = auVar14._0_8_;
...
/* FLOAT_MATH::VERTEX_INDEX::KdTreeNode::search(FLOAT_MATH::VERTEX_INDEX::Axes, float const*, float,
   ...
   FLOAT_MATH::VERTEX_INDEX::KdTreeInterface const*) */long *__thiscallFLOAT_MATH::VERTEX_INDEX::KdTreeNode::search(undefined8 param_1, KdTreeNode *this, int param_3, float *param_4, uint *param_5, uint param_6, float *param_7, long *param_8) {
   undefined8 uVar1;
   long *plVar2;
   float *pfVar3;
   uint uVar4;
   ...
   pfVar3 = param_4;
   LAB_0010dfc9:if (*(code**)( *param_8 + 8 ) == KdTree::getPositionFloat) {
      uVar5 = *(int*)this * 3;
      auVar18._8_4_ = uVar5;
   ...
   if (param_3 == 1) {
      if (fVar16 <= 0.0) {
         ...
         if (fVar12 <= fVar16) {
            LAB_0010e270:pKVar11 = (KdTreeNode*)0x0;
            param_3 = 2;
         }
 else {
      ...
      if (fVar15 <= 0.0) {
         ...
         lVar9 = *(long*)( this + 0x10 );
         if (fVar12 <= fVar15) {
            LAB_0010e260:pKVar11 = (KdTreeNode*)0x0;
            param_3 = 0;
         }
 else {
            pKVar11 = *(KdTreeNode**)( this + 8 );
      ...
      if (fVar13 <= 0.0) {
         ...
         lVar9 = *(long*)( this + 0x10 );
         if (fVar12 <= fVar13) {
            LAB_0010e280:pKVar11 = (KdTreeNode*)0x0;
            param_3 = 1;
         }
 else {
            pKVar11 = *(KdTreeNode**)( this + 8 );
   ...
   if (fVar13 < fVar12 * fVar12) {
      ...
      if (uVar5 == 0) {
         LAB_0010e0c6:*(KdTreeNode**)param_7 = this;
      ...
      if (uVar5 != 1) {
         uVar4 = 0;
         pfVar3 = param_7;
         LAB_0010e1bf:if (*(double*)( pfVar3 + 2 ) <= dVar14) goto LAB_0010e1b0;
         uVar10 = param_6 - 1;
         if (uVar5 < param_6) {
            uVar10 = uVar5;
         }
 ...
 while ( param_7 + uVar6 * 4 + ( ulong )(( uVar10 - uVar4 ) - 1) * -4 + -4 != pfVar8 );
   ...
   goto LAB_0010e0e0;
   LAB_0010e1b0:uVar4 = uVar4 + 1;
   pfVar3 = pfVar3 + 4;
   if (uVar5 <= uVar4) goto LAB_0010e300;
   goto LAB_0010e1bf;
   LAB_0010e300:pfVar3 = (float*)(ulong)param_6;
   if (uVar5 < param_6) {
   ...
   *param_5 = uVar5;
   if (param_6 < uVar5) {
      LAB_0010e0da:auVar18._4_4_ = 0;
      auVar18._0_4_ = param_6;
      auVar18._8_8_ = uVar6;
      *param_5 = param_6;
   }

   LAB_0010e0e0:plVar2 = auVar18._0_8_;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FLOAT_MATH::Eigen<float>::DecrSortEigenStuff() */void FLOAT_MATH::Eigen<float>::DecrSortEigenStuff(Eigen<float> *this) {
   long lVar1;
   undefined4 uVar2;
   float fVar3;
   uint uVar4;
   ...
   *(float*)( this + 0x20 ) = fVar20;
   pEVar10 = this + 0x24;
   LAB_0010e3f9:iVar15 = 0x20;
   iVar14 = (int)lVar6;
   lVar8 = lVar6;
   LAB_0010e441:iVar7 = (int)lVar8;
   if (iVar7 != 2) goto LAB_0010e410;
   goto LAB_0010e446;
   LAB_0010e410:fVar16 = (float)( *(uint*)( this + lVar8 * 4 + 0x24 ) & uVar4 ) + (float)( *(uint*)( this + lVar8 * 4 + 0x28 ) & uVar4 );
   lVar1 = lVar8 * 4;
   lVar8 = lVar8 + 1;
   if (fVar16 != (float)( *(uint*)( this + lVar1 + 0x30 ) & uVar4 ) + fVar16) goto LAB_0010e441;
   LAB_0010e446:if (iVar7 != iVar14) {
 ...
 while ( iVar14 <= iVar11 );
   ...
   goto LAB_0010e3f9;
   code_r0x0010e6f3:fVar16 = *(float*)( this + 0x24 );
   fVar24 = *(float*)( this + 0x28 );
   if (fVar24 <= fVar16) {
      LAB_0010e5ed:fVar18 = *(float*)( this + 0x2c );
      if (fVar18 <= fVar16) goto LAB_0010e638;
      LAB_0010e5fa:fVar24 = fVar18;
      lVar6 = 2;
   }
 else {
      LAB_0010e706:fVar18 = *(float*)( this + 0x2c );
...
/* FLOAT_MATH::Eigen<double>::DecrSortEigenStuff() */void FLOAT_MATH::Eigen<double>::DecrSortEigenStuff(Eigen<double> *this) {
   long lVar1;
   undefined8 uVar2;
   ulong uVar3;
   double dVar4;
   ...
   *(double*)( this + 0x40 ) = dVar23;
   pEVar8 = this + 0x48;
   LAB_0010e86c:iVar13 = 0x20;
   iVar14 = (int)lVar9;
   lVar6 = lVar9;
   LAB_0010e8b5:iVar5 = (int)lVar6;
   if (iVar5 != 2) goto LAB_0010e880;
   goto LAB_0010e8ba;
   LAB_0010e880:dVar22 = (double)( *(ulong*)( this + lVar6 * 8 + 0x48 ) & uVar3 ) + (double)( *(ulong*)( this + lVar6 * 8 + 0x50 ) & uVar3 );
   lVar1 = lVar6 * 8;
   lVar6 = lVar6 + 1;
   if (dVar22 != (double)( *(ulong*)( this + lVar1 + 0x60 ) & uVar3 ) + dVar22) goto LAB_0010e8b5;
   LAB_0010e8ba:if (iVar5 != iVar14) {
 ...
 while ( iVar14 <= iVar10 );
   ...
   goto LAB_0010e86c;
   code_r0x0010ebab:dVar22 = *(double*)( this + 0x48 );
   dVar27 = *(double*)( this + 0x50 );
   uVar16 = SUB84(dVar27, 0);
   uVar17 = ( undefined4 )((ulong)dVar27 >> 0x20);
   if (dVar27 <= dVar22) {
      LAB_0010ea8d:dVar27 = *(double*)( this + 0x58 );
      if (dVar27 <= dVar22) goto LAB_0010eadc;
      LAB_0010ea9c:lVar9 = 2;
   }
 else {
      LAB_0010ebbf:dVar27 = *(double*)( this + 0x58 );
      if ((double)CONCAT44(uVar17, uVar16) <= dVar27 && dVar27 != (double)CONCAT44(uVar17, uVar16)) goto LAB_0010ea9c;
 ...
 while ( this + 0x48 != pEVar8 );
   ...
   this[0x78] = EVar15;
   LAB_0010eadc:if ((double)CONCAT44(uVar17, uVar16) <= dVar27 && dVar27 != (double)CONCAT44(uVar17, uVar16)) {
...
/* void std::vector<double, std::allocator<double> >::_M_realloc_insert<double
   ...
   double const&) */void std::vector<double,std::allocator<double>>::_M_realloc_insert<double_const&>(vector<double,std::allocator<double>> *this, void *param_2, undefined8 *param_3) {
   void *__dest;
   void *pvVar1;
   void *__src;
   ulong uVar2;
   ...
   if (__src == pvVar1) {
      ...
      uVar3 = uVar3 << 3;
      LAB_0010ed5a:__dest_00 = operator_new(uVar3);
      lVar4 = uVar3 + (long)__dest_00;
   }
 else {
      uVar3 = uVar2 * 2;
      if (uVar3 < uVar2) {
         LAB_0010ed50:uVar3 = 0x7ffffffffffffff8;
         goto LAB_0010ed5a;
      }
   ...
   *(undefined8*)( (long)__dest_00 + __n ) = *param_3;
   ...
   LAB_0010ed2f:*(void**)this = __dest_00;
   *(size_t*)( this + 8 ) = (long)__dest + __n_00;
   *(long*)( this + 0x10 ) = lVar4;
   return;
}
/* FLOAT_MATH::MyVertexIndex::getIndex(double const*, bool&) */int FLOAT_MATH::MyVertexIndex::getIndex(MyVertexIndex *this, double *param_1, bool *param_2) {
 ...
 while ( ( in_FPUStatusWord & 0x400 ) != 0 );
      ...
      if (*(long*)( this + 0x30 ) != 0) {
         ...
         VERTEX_INDEX::KdTreeNode::search(__y, *(long*)( this + 0x30 ), 0, local_38, &local_50, 1, &local_48, this + 0x20);
         if (local_50._0_4_ != 0) {
            iVar7 = *local_48;
            goto LAB_0010ee75;
         }
      ...
      *param_2 = true;
      ...
      local_50 = local_28;
      if (pdVar8 == pdVar16) {
         std::vector<double,std::allocator<double>>::_M_realloc_insert<double_const&>(pvVar1, pdVar16, &local_60);
         pdVar8 = *(double**)( this + 0x50 );
         pdVar16 = *(double**)( this + 0x58 );
      }
 else {
      ...
      if (pdVar8 == pdVar16) {
         std::vector<double,std::allocator<double>>::_M_realloc_insert<double_const&>(pvVar1, pdVar16, &local_58);
         pdVar8 = *(double**)( this + 0x50 );
         pdVar16 = *(double**)( this + 0x58 );
      }
 else {
      ...
      if (pdVar16 == pdVar8) {
         std::vector<double,std::allocator<double>>::_M_realloc_insert<double_const&>(pvVar1, pdVar16, &local_50);
      }
 else {
         *pdVar8 = dVar5;
 ...
 while ( true );
   ...
   goto LAB_0010ee75;
   LAB_0010f2a0:*(undefined8**)( piVar12 + 2 ) = puVar17;
   LAB_0010ee75:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* void std::vector<float, std::allocator<float> >::_M_realloc_insert<float
   ...
   const&) */void std::vector<float,std::allocator<float>>::_M_realloc_insert<float_const&>(vector<float,std::allocator<float>> *this, void *param_2, undefined4 *param_3) {
   void *__dest;
   void *pvVar1;
   void *__src;
   ulong uVar2;
   ...
   if (__src == pvVar1) {
      ...
      uVar3 = uVar3 << 2;
      LAB_0010f44a:__dest_00 = operator_new(uVar3);
      lVar4 = uVar3 + (long)__dest_00;
   }
 else {
      uVar3 = uVar2 * 2;
      if (uVar3 < uVar2) {
         LAB_0010f440:uVar3 = 0x7ffffffffffffffc;
         goto LAB_0010f44a;
      }
   ...
   *(undefined4*)( (long)__dest_00 + __n ) = *param_3;
   ...
   operator_delete(__src, *(long*)( this + 0x10 ) - (long)__src);
   LAB_0010f41f:*(void**)this = __dest_00;
   *(size_t*)( this + 8 ) = (long)__dest + __n_00;
   *(long*)( this + 0x10 ) = lVar4;
   return;
}
/* FLOAT_MATH::MyVertexIndex::getIndex(float const*, bool&) */int FLOAT_MATH::MyVertexIndex::getIndex(MyVertexIndex *this, float *param_1, bool *param_2) {
 ...
 while ( ( in_FPUStatusWord & 0x400 ) != 0 );
      ...
      if (*(KdTreeNode**)( this + 0x30 ) != (KdTreeNode*)0x0) {
         local_4c = 0.0;
         VERTEX_INDEX::KdTreeNode::search(*(KdTreeNode**)( this + 0x30 ), 0, &local_48, &local_4c, 1, local_38, this + 0x20);
         if (local_4c != 0.0) {
      ...
      *param_2 = true;
      ...
      local_4c = local_40;
      if (pfVar8 == pfVar16) {
         std::vector<float,std::allocator<float>>::_M_realloc_insert<float_const&>(pvVar1, pfVar16, &local_54);
         pfVar8 = *(float**)( this + 0x68 );
         pfVar16 = *(float**)( this + 0x70 );
      }
 else {
      ...
      if (pfVar8 == pfVar16) {
         std::vector<float,std::allocator<float>>::_M_realloc_insert<float_const&>(pvVar1, pfVar16, &local_50);
         pfVar8 = *(float**)( this + 0x68 );
         pfVar16 = *(float**)( this + 0x70 );
      }
 else {
      ...
      if (pfVar16 == pfVar8) {
         std::vector<float,std::allocator<float>>::_M_realloc_insert<float_const&>(pvVar1, pfVar16, &local_4c);
      }
 else {
         *pfVar8 = fVar3;
 ...
 while ( true );
   ...
   goto LAB_0010f568;
   LAB_0010f9aa:*(undefined8**)( piVar12 + 2 ) = puVar17;
   LAB_0010f568:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* void std::vector<unsigned int, std::allocator<unsigned int> >::_M_realloc_insert<unsigned int
   ...
   if (__src == pvVar1) {
      ...
      uVar3 = uVar3 << 2;
      LAB_0010fb5a:__dest_00 = operator_new(uVar3);
      lVar4 = uVar3 + (long)__dest_00;
   }
 else {
      uVar3 = uVar2 * 2;
      if (uVar3 < uVar2) {
         LAB_0010fb50:uVar3 = 0x7ffffffffffffffc;
         goto LAB_0010fb5a;
      }
   ...
   *(undefined4*)( (long)__dest_00 + __n ) = *param_3;
   ...
   operator_delete(__src, *(long*)( this + 0x10 ) - (long)__src);
   LAB_0010fb2b:*(void**)this = __dest_00;
   *(size_t*)( this + 8 ) = (long)__dest + __n_00;
   *(long*)( this + 0x10 ) = lVar4;
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FLOAT_MATH::Myfm_Tesselate::tesselate(float const*, float const*, float const*, unsigned int) */void FLOAT_MATH::Myfm_Tesselate::tesselate(Myfm_Tesselate *this, float *param_1, float *param_2, float *param_3, uint param_4) {
   ...
   if (*(uint*)( this + 0x38 ) <= param_4) {
      LAB_0010fde0:uVar5 = ( **(code**)**(undefined8**)( this + 0x18 ) )(*(undefined8**)( this + 0x18 ), param_1, &local_4d);
      local_4c = uVar5;
      uVar6 = ( **(code**)**(undefined8**)( this + 0x18 ) )(*(undefined8**)( this + 0x18 ), param_2, &local_4d);
      pvVar1 = (vector<unsigned_int,std::allocator<unsigned_int>>*)( this + 0x20 );
      local_48 = uVar6;
      uVar7 = ( **(code**)**(undefined8**)( this + 0x18 ) )(*(undefined8**)( this + 0x18 ), param_3, &local_4d);
      puVar11 = *(undefined4**)( this + 0x28 );
      puVar8 = *(undefined4**)( this + 0x30 );
      local_44 = uVar7;
      if (puVar11 == puVar8) {
         std::vector<unsigned_int,std::allocator<unsigned_int>>::_M_realloc_insert<unsigned_int_const&>(pvVar1, puVar8, &local_4c);
         puVar11 = *(undefined4**)( this + 0x28 );
         puVar8 = *(undefined4**)( this + 0x30 );
      }
 else {
      ...
      if (puVar11 == puVar8) {
         std::vector<unsigned_int,std::allocator<unsigned_int>>::_M_realloc_insert<unsigned_int_const&>(pvVar1, puVar8, &local_48);
         puVar11 = *(undefined4**)( this + 0x28 );
         puVar8 = *(undefined4**)( this + 0x30 );
      }
 else {
      ...
      if (puVar11 == puVar8) {
         std::vector<unsigned_int,std::allocator<unsigned_int>>::_M_realloc_insert<unsigned_int_const&>(pvVar1, puVar11, &local_44);
      }
 else {
         *puVar11 = uVar7;
   ...
   fVar15 = fVar14 * fVar14 + ( fVar17 - fVar21 ) * ( fVar17 - fVar21 ) + ( fVar2 - fVar4 ) * ( fVar2 - fVar4 );
   fVar12 = *param_2 - *param_3;
   fVar13 = *param_3 - *param_1;
   fVar14 = *(float*)( this + 8 );
   fVar13 = fVar13 * fVar13 + ( fVar19 - fVar17 ) * ( fVar19 - fVar17 ) + ( fVar3 - fVar2 ) * ( fVar3 - fVar2 );
   fVar12 = fVar12 * fVar12 + ( fVar21 - fVar19 ) * ( fVar21 - fVar19 ) + ( fVar4 - fVar3 ) * ( fVar4 - fVar3 );
   if (( fVar14 < fVar15 ) || ( fVar14 < fVar12 )) {
      if (( fVar15 < fVar12 ) || ( fVar15 < fVar13 )) {
         LAB_0010fd38:if (( fVar15 <= fVar12 ) && ( fVar13 <= fVar12 )) {
            local_38 = ( fVar3 - fVar4 ) * _LC13 + fVar4;
            local_40 = CONCAT44(( fVar19 - fVar21 ) * _UNK_00111674 + fVar21, ( fVar18 - fVar20 ) * _LC13 + fVar20);
      ...
      local_40 = CONCAT44(( fVar21 - fVar17 ) * _UNK_00111674 + fVar17, ( fVar20 - fVar16 ) * _LC13 + fVar16);
      pfVar9 = param_3;
   }
 else {
      if (fVar13 <= fVar14) goto LAB_0010fde0;
      if (fVar15 < fVar12) goto LAB_0010fd38;
      LAB_0010fd46:local_38 = ( fVar2 - fVar3 ) * _LC13 + fVar3;
      local_40 = CONCAT44(( fVar17 - fVar19 ) * _UNK_00111674 + fVar19, ( fVar16 - fVar18 ) * _LC13 + fVar18);
   ...
   LAB_0010fd9e:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* FLOAT_MATH::Myfm_Tesselate::tesselate(double const*, double const*, double const*, unsigned int)
    */void FLOAT_MATH::Myfm_Tesselate::tesselate(Myfm_Tesselate *this, double *param_1, double *param_2, double *param_3, uint param_4) {
   vector<unsigned_int,std::allocator<unsigned_int>> *pvVar1;
   double dVar2;
   double dVar3;
   double dVar4;
   ...
   local_30 = *(long*)( in_FS_OFFSET + 0x28 );
   if (*(uint*)( this + 0x38 ) <= param_4) {
      LAB_00110178:uVar11 = ( **(code**)( **(long**)( this + 0x18 ) + 8 ) )(*(long**)( this + 0x18 ), param_1, &local_55);
      local_54 = uVar11;
      ...
      local_4c = uVar13;
      if (puVar17 == puVar14) {
         std::vector<unsigned_int,std::allocator<unsigned_int>>::_M_realloc_insert<unsigned_int_const&>(pvVar1, puVar14, &local_54);
         puVar17 = *(undefined4**)( this + 0x28 );
         puVar14 = *(undefined4**)( this + 0x30 );
      }
 else {
      ...
      if (puVar17 == puVar14) {
         std::vector<unsigned_int,std::allocator<unsigned_int>>::_M_realloc_insert<unsigned_int_const&>(pvVar1, puVar14, &local_50);
         puVar17 = *(undefined4**)( this + 0x28 );
         puVar14 = *(undefined4**)( this + 0x30 );
      }
 else {
      ...
      if (puVar17 == puVar14) {
         std::vector<unsigned_int,std::allocator<unsigned_int>>::_M_realloc_insert<unsigned_int_const&>(pvVar1, puVar17, &local_4c);
      }
 else {
         *puVar17 = uVar13;
   ...
   if (( dVar20 < dVar21 ) || ( dVar20 < dVar18 )) {
      if (( dVar21 < dVar18 ) || ( dVar21 < dVar19 )) {
         LAB_001100bd:if (( dVar21 <= dVar18 ) && ( dVar19 <= dVar18 )) {
      ...
      LAB_001100cd:local_38 = ( dVar2 - dVar4 ) * _LC50 + dVar4;
   ...
   LAB_0011012a:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* FLOAT_MATH::Myfm_Tesselate::tesselate(FLOAT_MATH::fm_VertexIndex*, unsigned int, unsigned int
   const*, float, unsigned int, unsigned int&) */long FLOAT_MATH::Myfm_Tesselate::tesselate(Myfm_Tesselate *this, fm_VertexIndex *param_1, uint param_2, uint *param_3, float param_4, uint param_5, uint *param_6) {
   code *pcVar1;
   long *plVar2;
   byte bVar3;
   uint uVar4;
   ...
   *(double*)( this + 0x10 ) = (double)( param_4 * param_4 );
   ...
   if (bVar3 == 0) {
      ...
      if (param_2 != 0) {
         ...
         do {
            puVar6 = puVar7 + 3;
            tesselate(this, (float*)( (long)__ptr + ( ulong )(*puVar7 * 3) * 4 ), (float*)( (long)__ptr + ( ulong )(puVar7[1] * 3) * 4 ), (float*)( (long)__ptr + ( ulong )(puVar7[2] * 3) * 4 ), 0);
            puVar7 = puVar6;
         }
 while ( puVar6 != param_3 + (ulong)param_2 * 3 );
      ...
      if (param_2 != 0) {
         ...
         do {
            puVar6 = puVar7 + 3;
            tesselate(this, (double*)( (long)__ptr + ( ulong )(*puVar7 * 3) * 8 ), (double*)( (long)__ptr + ( ulong )(puVar7[1] * 3) * 8 ), (double*)( (long)__ptr + ( ulong )(puVar7[2] * 3) * 8 ), 0);
            puVar7 = puVar6;
         }
 while ( puVar6 != param_3 + (ulong)param_2 * 3 );
      }
...
/* void std::vector<FLOAT_MATH::TVec, std::allocator<FLOAT_MATH::TVec>
   ...
   std::vector<FLOAT_MATH::TVec, std::allocator<FLOAT_MATH::TVec> > >, FLOAT_MATH::TVec const&) */void std::vector<FLOAT_MATH::TVec,std::allocator<FLOAT_MATH::TVec>>::_M_realloc_insert<FLOAT_MATH::TVec_const&>(vector<FLOAT_MATH::TVec,std::allocator<FLOAT_MATH::TVec>> *this, undefined8 *param_2, undefined8 *param_3) {
   size_t __n;
   undefined8 *puVar1;
   undefined8 *puVar2;
   undefined8 uVar3;
   ...
   if (puVar2 == puVar1) {
      ...
      uVar9 = uVar9 * 0x18;
      LAB_001106ca:puVar7 = (undefined8*)operator_new(uVar9);
 ...
 while ( puVar10 != param_2 );
         puVar10 = (undefined8*)( (long)puVar11 + ( (long)param_2 + ( -0x18 - (long)puVar2 ) & 0xfffffffffffffff8U ) + 0x30 );
         puVar7 = puVar11;
      }
      ...
      if (uVar9 < uVar6) {
         LAB_001106c0:uVar9 = 0x7ffffffffffffff8;
         goto LAB_001106ca;
      }
   ...
   LAB_00110686:if (puVar2 != (undefined8*)0x0) {
...
/* FLOAT_MATH::CTriangulator::addPoint(double, double, double) */void FLOAT_MATH::CTriangulator::addPoint(CTriangulator *this, double param_1, double param_2, double param_3) {
   double *pdVar1;
   double *pdVar2;
   long in_FS_OFFSET;
   double local_28;
   ...
   pdVar2 = *(double**)( this + 0x50 );
   joined_r0x00110839:local_28 = param_1;
   dStack_20 = param_2;
   local_18 = param_3;
   if (pdVar1 == pdVar2) {
      std::vector<FLOAT_MATH::TVec,std::allocator<FLOAT_MATH::TVec>>::_M_realloc_insert<FLOAT_MATH::TVec_const&>((vector<FLOAT_MATH::TVec,std::allocator<FLOAT_MATH::TVec>>*)( this + 0x40 ), pdVar1, &local_28);
   }
 else {
      *pdVar1 = param_1;
      pdVar1[1] = param_2;
...
/* void std::vector<unsigned int, std::allocator<unsigned int> >::_M_realloc_insert<unsigned
   ...
   std::allocator<unsigned int> > >, unsigned int&&) */void std::vector<unsigned_int,std::allocator<unsigned_int>>::_M_realloc_insert<unsigned_int>(vector<unsigned_int,std::allocator<unsigned_int>> *this, void *param_2, undefined4 *param_3) {
   void *__dest;
   void *pvVar1;
   void *__src;
   ulong uVar2;
   ...
   if (__src == pvVar1) {
      ...
      uVar3 = uVar3 << 2;
      LAB_0011094a:__dest_00 = operator_new(uVar3);
      lVar4 = uVar3 + (long)__dest_00;
   }
 else {
      uVar3 = uVar2 * 2;
      if (uVar3 < uVar2) {
         LAB_00110940:uVar3 = 0x7ffffffffffffffc;
         goto LAB_0011094a;
      }
   ...
   *(undefined4*)( (long)__dest_00 + __n ) = *param_3;
   ...
   operator_delete(__src, *(long*)( this + 0x10 ) - (long)__src);
   LAB_0011091b:*(void**)this = __dest_00;
   *(size_t*)( this + 8 ) = (long)__dest + __n_00;
   *(long*)( this + 0x10 ) = lVar4;
   return;
}
/* FLOAT_MATH::CTriangulator::triangulate(unsigned int&, double) */long FLOAT_MATH::CTriangulator::triangulate(CTriangulator *this, uint *param_1, double param_2) {
   undefined8 *puVar1;
   long lVar2;
   undefined8 *puVar3;
   int iVar4;
      ...
      if (iVar4 != 0) {
         ...
         do {
            while (true) {
               ...
               puVar8 = puVar8 + 3;
               std::vector<FLOAT_MATH::TVec,std::allocator<FLOAT_MATH::TVec>>::_M_realloc_insert<FLOAT_MATH::TVec_const&>((vector<FLOAT_MATH::TVec,std::allocator<FLOAT_MATH::TVec>>*)( this + 0x58 ), puVar3, &local_58);
...
;
 ...
 while ( puVar8 != puVar1 );
      ...
      LAB_00110b90:if (*(long*)( this + 0x70 ) != *(long*)( this + 0x78 )) {
         *(long*)( this + 0x78 ) = *(long*)( this + 0x70 );
      }
   ...
   lVar7 = 0;
   LAB_00110bd3:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* FLOAT_MATH::Triangulate::triangulate3d(unsigned int, double const*, unsigned int, unsigned int&,
   bool, double) */undefined8 FLOAT_MATH::Triangulate::triangulate3d(Triangulate *this, uint param_1, double *param_2, uint param_3, uint *param_4, bool param_5, double param_6) {
   undefined8 *puVar1;
   undefined8 *puVar2;
   undefined8 *puVar3;
   uint uVar4;
   ...
   if (2 < param_1) {
      ...
      do {
         ...
         if (pdVar6 == pdVar11) {
            ...
            LAB_00110dc5:pdVar6[2] = local_d8;
            *pdVar6 = local_e8;
            pdVar6[1] = dStack_e0;
            ...
            LAB_00110e43:std::vector<FLOAT_MATH::TVec,std::allocator<FLOAT_MATH::TVec>>::_M_realloc_insert<FLOAT_MATH::TVec_const&>((vector<FLOAT_MATH::TVec,std::allocator<FLOAT_MATH::TVec>>*)local_88, pdVar6, &local_e8);
      ...
      if (iVar13 != 0) {
         ...
         do {
            while (true) {
               ...
               pdVar6 = pdVar6 + 3;
               std::vector<FLOAT_MATH::TVec,std::allocator<FLOAT_MATH::TVec>>::_M_realloc_insert<FLOAT_MATH::TVec_const&>((vector<FLOAT_MATH::TVec,std::allocator<FLOAT_MATH::TVec>>*)( local_78 + 8 ), local_68._0_8_, &local_e8);
...
;
 ...
 while ( pdVar11 + ( ulong )(iVar13 - 1) * 3 + uVar7 + 3 != pdVar6 );
      ...
      LAB_00110fe0:if (local_58._0_8_ != local_58._8_8_) {
...
/* WARNING: Control flow encountered bad instruction data *//* FLOAT_MATH::MyVertexIndex::~MyVertexIndex() */void FLOAT_MATH::MyVertexIndex::~MyVertexIndex(MyVertexIndex *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* FLOAT_MATH::Triangulate::~Triangulate() */void FLOAT_MATH::Triangulate::~Triangulate(Triangulate *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* FLOAT_MATH::Myfm_Tesselate::~Myfm_Tesselate() */void FLOAT_MATH::Myfm_Tesselate::~Myfm_Tesselate(Myfm_Tesselate *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* FLOAT_MATH::VERTEX_INDEX::KdTree::~KdTree() */void FLOAT_MATH::VERTEX_INDEX::KdTree::~KdTree(KdTree *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

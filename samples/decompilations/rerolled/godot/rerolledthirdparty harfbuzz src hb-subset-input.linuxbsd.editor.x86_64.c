...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* hb_subset_input_t::hb_subset_input_t() */void hb_subset_input_t::hb_subset_input_t(hb_subset_input_t *this) {
   byte *pbVar1;
   char cVar2;
   long lVar3;
   undefined4 *puVar4;
 ...
 while ( this + 0x50 != phVar8 );
   ...
   do {
      if (cVar2 == '\0') {
         LAB_00100213:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            return;
         }
            ...
            if (*(char*)( lVar3 + 0x40 ) == '\0') {
               if (*(char*)( lVar3 + 0x10 ) != '\0') {
                  ...
                  *(undefined4*)( lVar3 + 0x14 ) = 0xffffffff;
                  while (true) {
                     uVar9 = uVar6 >> 9;
                     puVar4 = (undefined4*)hb_bit_set_t::page_for((hb_bit_set_t*)( lVar3 + 0x10 ), uVar6, true);
                     ...
                     while (true) {
                        ...
                        LAB_001003c9:*(ulong*)( puVar4 + ( ulong )(uVar6 >> 6 & 7) * 2 + 2 ) = *(ulong*)( puVar4 + ( ulong )(uVar6 >> 6 & 7) * 2 + 2 ) | 1L << ( (byte)uVar6 & 0x3f );
                        *puVar4 = 0xffffffff;
                     }
;
                  }
;
               ...
               *(undefined4*)( lVar3 + 0x14 ) = 0xffffffff;
               do {
                  puVar4 = (undefined4*)hb_bit_set_t::page_for((hb_bit_set_t*)( lVar3 + 0x10 ), uVar6, false);
                  uVar9 = uVar6 & 0xfffffe00;
                  do {
                     if (( uVar6 != 0xffffffff ) && ( puVar4 != (undefined4*)0x0 )) {
                        *(ulong*)( puVar4 + ( ulong )(uVar6 >> 6 & 7) * 2 + 2 ) = *(ulong*)( puVar4 + ( ulong )(uVar6 >> 6 & 7) * 2 + 2 ) & ~(1L << ((byte)uVar6 & 0x3f));
                        *puVar4 = 0xffffffff;
                     }
 ...
 while ( true );
            ...
            LAB_001003ea:lVar3 = *(long*)( this + 0x20 );
                  ...
                  *(undefined4*)( lVar3 + 0x14 ) = 0xffffffff;
                  while (true) {
                     ...
                     while (true) {
                        ...
                        puVar15 = (undefined8*)( (long)puVar15 + 4 );
                        if (( uVar6 < uVar10 ) || ( ( uVar9 + 1 ) * 0x200 <= uVar6 )) break;
                        LAB_00100527:*(ulong*)( puVar4 + ( ulong )(uVar6 >> 6 & 7) * 2 + 2 ) = *(ulong*)( puVar4 + ( ulong )(uVar6 >> 6 & 7) * 2 + 2 ) | 1L << ( (byte)uVar6 & 0x3f );
                        *puVar4 = 0xffffffff;
                     }
;
                  }
;
 ...
 while ( true );
            ...
            LAB_00100548:lVar3 = *(long*)( this + 0x40 );
            puVar15 = &local_168;
                  ...
                  *(undefined4*)( lVar3 + 0x14 ) = 0xffffffff;
                  ...
                  while (true) {
                     ...
                     while (true) {
                        ...
                        puVar15 = (undefined8*)( (long)puVar15 + 4 );
                        if (( uVar6 < uVar10 ) || ( ( uVar9 + 1 ) * 0x200 <= uVar6 )) break;
                        LAB_00100687:*(ulong*)( puVar4 + ( ulong )(uVar6 >> 6 & 7) * 2 + 2 ) = *(ulong*)( puVar4 + ( ulong )(uVar6 >> 6 & 7) * 2 + 2 ) | 1L << ( (byte)uVar6 & 0x3f );
                        *puVar4 = 0xffffffff;
                     }
;
                  }
;
 ...
 while ( true );
            ...
            LAB_001006aa:if (*(char*)( *(long*)( this + 0x48 ) + 0x10 ) != '\0') {
   ...
   if (*(int*)param_1 != 0) {
      ...
      *(int*)param_1 = *(int*)param_1 + -1;
      ...
      if (*(int*)param_1 == 0) {
         ...
         for (int i = 0; i < 8; i++) {
            hb_set_destroy(*(undefined8*)( param_1 + ( -8*i + 72 ) ));
         }
...
hb_subset_input_t *hb_subset_input_create_or_fail(void) {
 ...
 while ( this + 0x50 != phVar1 );
      ...
      LAB_0010081a:hb_subset_input_destroy(this);
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 hb_subset_input_set(long param_1, uint param_2) {
   if (param_2 < 8) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */bool hb_subset_input_set_user_data(int *param_1, long param_2, long param_3, long param_4, int param_5) {
   uint uVar1;
   long lVar2;
   code *pcVar3;
   long lVar4;
...
;
 ...
 while ( uVar8 != uVar5 );
   ...
   if (uVar8 == 0) {
      ...
      if (__mutex[1].__data.__lock < 1) {
         ...
         uVar9 = 8;
         LAB_00100b7c:plVar6 = (long*)realloc(plVar6, uVar9 * 0x18);
         if (plVar6 == (long*)0x0) {
 ...
 while ( uVar8 < uVar5 );
         ...
         LAB_00100be8:uVar11 = __hb_CrapPool;
   ...
   LAB_00100b43:*(uint*)( (long)__mutex + 0x2c ) = uVar5;
   plVar10 = plVar6 + uVar7 * 3;
   *plVar10 = param_2;
   plVar10[1] = param_3;
   plVar10[2] = param_4;
   LAB_00100b5a:pthread_mutex_unlock(__mutex);
   LAB_00100995:return -1 < __mutex[1].__data.__lock && plVar10 != (long*)0x0;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void hb_subset_input_keep_everything(long param_1) {
   undefined8 uVar1;
   undefined8 *puVar2;
   uint *puVar3;
   long in_FS_OFFSET;
...
bool hb_subset_input_get_axis_range(long param_1, int param_2, float *param_3, float *param_4, float *param_5) {
   byte bVar1;
   long lVar2;
   int *piVar3;
   int iVar4;
...
undefined8 hb_subset_input_set_axis_range(float param_1, float param_2, float param_3, long param_4, undefined8 param_5, int param_6) {
   float fVar1;
   byte bVar2;
   long lVar3;
   char cVar4;
   ...
   if (iVar5 != 0) {
      ...
      if (param_1 <= param_2) {
         ...
         fVar14 = (float)( (uint)param_2 & -(uint)(local_48 <= param_2) | ~-(uint)(local_48 <= param_2) & (uint)local_48 );
         uVar12 = -(uint)(local_40 < fVar14);
         fVar15 = (float)( (uint)local_40 & uVar12 | ~uVar12 & (uint)fVar14 );
         fVar14 = (float)( (uint)param_3 & -(uint)(fVar1 <= param_3) | ~-(uint)(fVar1 <= param_3) & (uint)fVar1 );
         ...
         if (*(char*)( param_4 + 0x68 ) != '\0') {
            ...
            if (*(uint*)( param_4 + 0x74 ) <= ( uVar12 >> 1 ) + uVar12) {
               cVar4 = hb_hashmap_t<unsigned_int,Triple,false>::alloc((hb_hashmap_t<unsigned_int,Triple,false>*)( param_4 + 0x58 ), 0);
 ...
 while ( ( bVar2 & 2 ) != 0 );
               if (uVar11 == 0xffffffff) {
                  LAB_0010119a:uVar12 = uVar12 + 1;
               }
 else {
                  LAB_0010110e:piVar7 = (int*)( (ulong)uVar11 * 0x20 + lVar3 );
                  LAB_00101118:if (( *(byte*)( piVar7 + 1 ) & 2 ) == 0) goto LAB_0010119a;
               ...
               *(int*)( param_4 + 0x6c ) = iVar5 + 1;
               if (( *(ushort*)( param_4 + 0x6a ) < uVar9 ) && ( *(uint*)( param_4 + 0x74 ) < uVar12 << 3 )) {
                  hb_hashmap_t<unsigned_int,Triple,false>::alloc((hb_hashmap_t<unsigned_int,Triple,false>*)( param_4 + 0x58 ), *(uint*)( param_4 + 0x74 ) - 8);
               }
   ...
   LAB_00101160:uVar8 = 0;
   LAB_00101162:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 hb_subset_input_pin_all_axes_to_default(long param_1, undefined8 param_2) {
      ...
      if (local_44 != 0) {
         ...
         do {
            ...
            if (*(char*)( param_1 + 0x68 ) == '\0') {
               LAB_00101400:free(__ptr);
               goto LAB_00101258;
            }

            uVar11 = *(uint*)( param_1 + 0x70 );
            if (*(uint*)( param_1 + 0x74 ) <= ( uVar11 >> 1 ) + uVar11) {
               cVar4 = hb_hashmap_t<unsigned_int,Triple,false>::alloc((hb_hashmap_t<unsigned_int,Triple,false>*)( param_1 + 0x58 ), 0);
 ...
 while ( ( bVar1 & 2 ) != 0 );
               if ((int)uVar10 == -1) {
                  LAB_001013f5:uVar11 = uVar11 + 1;
               }
 else {
                  LAB_0010137e:piVar5 = (int*)( uVar10 * 0x20 + lVar3 );
                  LAB_00101387:if (( *(byte*)( piVar5 + 1 ) & 2 ) == 0) goto LAB_001013f5;
               ...
               *(int*)( param_1 + 0x6c ) = iVar12 + 1;
               if (( *(ushort*)( param_1 + 0x6a ) < uVar7 ) && ( *(uint*)( param_1 + 0x74 ) < uVar11 << 3 )) {
                  hb_hashmap_t<unsigned_int,Triple,false>::alloc((hb_hashmap_t<unsigned_int,Triple,false>*)( param_1 + 0x58 ), *(uint*)( param_1 + 0x74 ) - 8);
               }
...
undefined8 hb_subset_input_pin_axis_location(float param_1, long param_2, undefined8 param_3, int param_4) {
   byte bVar1;
   long lVar2;
   char cVar3;
   undefined8 uVar4;
   ...
   if (*(char*)( param_2 + 0x68 ) == '\0') {
      LAB_00101630:uVar4 = 0;
      goto LAB_001015f0;
   }

   uVar8 = *(uint*)( param_2 + 0x70 );
   if (*(uint*)( param_2 + 0x74 ) <= ( uVar8 >> 1 ) + uVar8) {
      cVar3 = hb_hashmap_t<unsigned_int,Triple,false>::alloc((hb_hashmap_t<unsigned_int,Triple,false>*)( param_2 + 0x58 ), 0);
 ...
 while ( ( bVar1 & 2 ) != 0 );
      if (uVar9 == 0xffffffff) {
         LAB_0010162a:uVar8 = uVar8 + 1;
      }
 else {
         LAB_001015a6:piVar5 = (int*)( (ulong)uVar9 * 0x20 + lVar2 );
         LAB_001015b0:if (( *(byte*)( piVar5 + 1 ) & 2 ) == 0) goto LAB_0010162a;
      ...
      *(int*)( param_2 + 0x6c ) = iVar10 + 1;
      if (( *(ushort*)( param_2 + 0x6a ) < uVar6 ) && ( *(uint*)( param_2 + 0x74 ) < uVar8 << 3 )) {
         hb_hashmap_t<unsigned_int,Triple,false>::alloc((hb_hashmap_t<unsigned_int,Triple,false>*)( param_2 + 0x58 ), *(uint*)( param_2 + 0x74 ) - 8);
      }

   }

   uVar4 = 1;
   LAB_001015f0:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar4;
   }
...
undefined8 hb_subset_input_pin_axis_to_default(long param_1, undefined8 param_2, int param_3) {
   ...
   if (*(char*)( param_1 + 0x68 ) == '\0') {
      LAB_00101820:uVar4 = 0;
      goto LAB_001016f6;
   }

   uVar8 = *(uint*)( param_1 + 0x70 );
   if (*(uint*)( param_1 + 0x74 ) <= ( uVar8 >> 1 ) + uVar8) {
      cVar3 = hb_hashmap_t<unsigned_int,Triple,false>::alloc((hb_hashmap_t<unsigned_int,Triple,false>*)( param_1 + 0x58 ), 0);
 ...
 while ( ( bVar1 & 2 ) != 0 );
      if (uVar9 == 0xffffffff) {
         LAB_00101816:uVar8 = uVar8 + 1;
      }
 else {
         LAB_001017c2:piVar5 = (int*)( (ulong)uVar9 * 0x20 + lVar2 );
         LAB_001017cc:if (( *(byte*)( piVar5 + 1 ) & 2 ) == 0) goto LAB_00101816;
         iVar10 = iVar10 - ( *(byte*)( piVar5 + 1 ) & 1 );
      }
   ...
   uVar4 = 1;
   LAB_001016f6:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar4;
   }
...
/* hb_bit_set_t::resize(unsigned int, bool, bool) */hb_bit_set_t hb_bit_set_t::resize(hb_bit_set_t *this, uint param_1, bool param_2, bool param_3) {
 ...
 while ( uVar8 < param_1 );
      ...
      LAB_001019c7:*(uint*)( this + 0x20 ) = ~uVar5;
      goto LAB_001019cc;
   }
   ...
   if (uVar5 == 0) {
      param_1 = 1;
      uVar8 = 1;
      LAB_00101b59:pvVar2 = *(void**)( this + 0x28 );
      param_3 = (bool)hVar1;
      LAB_00101b60:pvVar2 = realloc(pvVar2, (ulong)uVar8 * 0x48);
      if (pvVar2 == (void*)0x0) {
         uVar5 = *(uint*)( this + 0x20 );
         if (uVar5 < uVar8) goto LAB_001019c7;
      }
 else {
         LAB_00101b7c:*(void**)( this + 0x28 ) = pvVar2;
   ...
   LAB_00101913:if (( (uint)uVar7 < param_1 ) && ( param_2 )) {
 ...
 while ( uVar5 < param_1 );
      ...
      LAB_001019df:if (( (uint)uVar6 < param_1 ) && ( param_2 )) {
 ...
 while ( uVar8 < uVar4 );
      ...
      LAB_00101a84:uVar8 = *(uint*)( this + 0x24 );
   }
 else {
      LAB_00101ac6:uVar8 = *(uint*)( this + 0x24 );
      uVar4 = (uint)uVar6;
      if (uVar4 <= uVar8) {
         uVar6 = (ulong)uVar8;
      }
      ...
      uVar9 = (uint)uVar6;
      if (uVar5 < uVar9) {
         LAB_00101a50:if (0x38e38e3 < (uint)uVar6) goto LAB_001019c7;
         pvVar2 = *(void**)( this + 0x28 );
         LAB_00101a61:uVar8 = (uint)uVar6;
         ...
         if (pvVar2 == (void*)0x0) {
            ...
            LAB_00101a7d:*(void**)( this + 0x28 ) = pvVar2;
            *(uint*)( this + 0x20 ) = uVar8;
         }
   ...
   *(uint*)( this + 0x24 ) = uVar4;
   LAB_001019cc:*this = (hb_bit_set_t)0x0;
   return (hb_bit_set_t)0x0;
}
   ...
   LAB_00101d5c:if (param_2) {
      ...
      if (cVar6 != '\0') {
         ...
         *(ulong*)( *(long*)( this + 0x18 ) + (ulong)uVar8 * 8 ) = CONCAT44(uVar4, uVar9);
         uVar7 = uVar8;
         LAB_00101df5:*(uint*)( this + 8 ) = uVar7;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* hb_hashmap_t<unsigned int, Triple, false>::alloc(unsigned int) */hb_hashmap_t<unsigned_int,Triple,false> hb_hashmap_t<unsigned_int,Triple,false>::alloc(hb_hashmap_t<unsigned_int,Triple,false> *this, uint param_1) {
   byte bVar1;
   int *__ptr;
   long lVar2;
   undefined8 uVar3;
 ...
 while ( puVar12 != (undefined4*)( (long)puVar7 + __size ) );
         ...
         *(undefined4**)( this + 0x28 ) = puVar7;
         if (uVar10 != 0) {
            piVar18 = __ptr;
            do {
               if (( ( *(byte*)( piVar18 + 1 ) & 1 ) != 0 ) && ( uVar19 = (uint)piVar18[1] >> 2 ),this[0x10] != (hb_hashmap_t<unsigned_int,Triple,false>)0x0) {
 ...
 while ( ( bVar1 & 2 ) != 0 );
                     if (uVar6 == 0xffffffff) {
                        LAB_00102281:uVar20 = uVar20 + 1;
                     }
 else {
                        LAB_00102195:piVar9 = (int*)( (ulong)uVar6 * 0x20 + lVar2 );
                        LAB_0010219e:if (( *(byte*)( piVar9 + 1 ) & 2 ) == 0) goto LAB_00102281;
               ...
               LAB_001020f0:piVar18 = piVar18 + 8;
            }
 while ( piVar18 != __ptr + (ulong)uVar10 * 8 );
   ...
   LAB_00102248:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }

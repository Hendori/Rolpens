/* (anonymous namespace)::DebugUtilsLogRecorder::LogDebugUtilsMessage(unsigned long, unsigned long,
   XrDebugUtilsMessengerCallbackDataEXT const*) */bool DebugUtilsLogRecorder::LogDebugUtilsMessage(DebugUtilsLogRecorder *this, ulong param_1, ulong param_2, XrDebugUtilsMessengerCallbackDataEXT *param_3) {
   int iVar1;
   iVar1 = ( **(code**)( this + 0x30 ) )(param_1, param_2, param_3, *(undefined8*)( this + 0x18 ));
   return iVar1 == 1;
}
/* (anonymous namespace)::DebugUtilsLogRecorder::~DebugUtilsLogRecorder() */void DebugUtilsLogRecorder::~DebugUtilsLogRecorder(DebugUtilsLogRecorder *this) {
   return;
}
/* (anonymous namespace)::OstreamLoaderLogRecorder::~OstreamLoaderLogRecorder() */void OstreamLoaderLogRecorder::~OstreamLoaderLogRecorder(OstreamLoaderLogRecorder *this) {
   return;
}
/* (anonymous namespace)::OstreamLoaderLogRecorder::~OstreamLoaderLogRecorder() */void OstreamLoaderLogRecorder::~OstreamLoaderLogRecorder(OstreamLoaderLogRecorder *this) {
...
/* (anonymous namespace)::DebugUtilsLogRecorder::LogMessage(unsigned long, unsigned long,
   XrLoaderLogMessengerCallbackData const*) */DebugUtilsLogRecorder DebugUtilsLogRecorder::LogMessage(DebugUtilsLogRecorder *this, ulong param_1, ulong param_2, XrLoaderLogMessengerCallbackData *param_3) {
   int iVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   ulong uVar4;
   ...
   DVar11 = this[8];
   if (( ( DVar11 != (DebugUtilsLogRecorder)0x0 ) && ( DVar11 = (DebugUtilsLogRecorder)0x0(param_1 & *(ulong*)( this + 0x20 )) != 0 ) ) && ( ( param_2 & *(ulong*)( this + 0x28 ) ) != 0 )) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* (anonymous namespace)::OutputMessageToStream(std::ostream&, unsigned long, unsigned long,
   XrLoaderLogMessengerCallbackData const*) */void (anonymous_namespace)::OutputMessageToStream(ostream *param_1, ulong param_2, ulong param_3, XrLoaderLogMessengerCallbackData *param_4) {
   char *pcVar1;
   size_t sVar2;
   ostream *poVar3;
   long *plVar4;
   ...
   if (pcVar1 == (char*)0x0) {
      std::ios::clear(param_1 + *(long*)( *(long*)param_1 + -0x18 ), *(uint*)( param_1 + *(long*)( *(long*)param_1 + -0x18 ) + 0x20 ) | 1);
   }
 else {
      sVar2 = strlen(pcVar1);
   ...
   if (plVar4 == (long*)0x0) {
      LAB_001009ef:std::__throw_bad_cast();
   }
 else {
      if ((char)plVar4[7] == '\0') {
      ...
      if (param_4[0x28] != (XrLoaderLogMessengerCallbackData)0x0) {
         ...
         do {
            ...
            if (uVar7 < 10) {
               ...
               uVar6 = uVar7;
               LAB_001006f6:cVar5 = (char)uVar6 + '0';
               plVar4 = local_138;
            }
 else {
               if (99 < uVar7) {
                  ...
                  *(char*)( (long)local_138 + ( ulong )((int)local_130 - 1) ) = *(char*)( (long)&local_118 + ( ulong )(uVar6 + 1) );
            ...
            *(char*)plVar4 = cVar5;
            poVar3 = std::__ostream_insert<char,std::char_traits<char>>(param_1, (char*)local_138, local_130);
            std::__ostream_insert<char,std::char_traits<char>>(poVar3, "] = ", 4);
            pcVar1 = *(char**)( *(long*)( param_4 + 0x30 ) + 0x10 + lVar9 );
            if (pcVar1 == (char*)0x0) {
               std::ios::clear(poVar3 + *(long*)( *(long*)poVar3 + -0x18 ), *(uint*)( poVar3 + *(long*)( *(long*)poVar3 + -0x18 ) + 0x20 ) | 1);
            }
 else {
               sVar2 = strlen(pcVar1);
...
/* (anonymous namespace)::OstreamLoaderLogRecorder::LogMessage(unsigned long, unsigned long,
   XrLoaderLogMessengerCallbackData const*) */undefined8 OstreamLoaderLogRecorder::LogMessage(OstreamLoaderLogRecorder *this, ulong param_1, ulong param_2, XrLoaderLogMessengerCallbackData *param_3) {
   if (( ( this[8] != (OstreamLoaderLogRecorder)0x0 ) && ( ( param_1 & *(ulong*)( this + 0x20 ) ) != 0 ) ) && ( ( param_2 & *(ulong*)( this + 0x28 ) ) != 0 )) {
...
/* MakeStdOutLoaderLogRecorder(void*, unsigned long) */void *MakeStdOutLoaderLogRecorder(void *param_1, ulong param_2) {
   undefined8 *puVar1;
   undefined8 in_RDX;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* MakeStdErrLoaderLogRecorder(void*) */void *MakeStdErrLoaderLogRecorder(void *param_1) {
   undefined8 uVar1;
   undefined8 uVar2;
   undefined8 *puVar3;
   undefined8 in_RSI;
...
/* MakeDebugUtilsLoaderLogRecorder(XrDebugUtilsMessengerCreateInfoEXT const*,
   XrDebugUtilsMessengerEXT_T*) */XrDebugUtilsMessengerCreateInfoEXT *MakeDebugUtilsLoaderLogRecorder(XrDebugUtilsMessengerCreateInfoEXT *param_1, XrDebugUtilsMessengerEXT_T *param_2) {
   undefined8 uVar1;
   undefined8 *puVar2;
   undefined8 uVar3;
   undefined8 uVar4;

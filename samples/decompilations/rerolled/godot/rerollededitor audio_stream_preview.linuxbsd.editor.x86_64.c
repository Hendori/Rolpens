...
;
                        ...
                        *(undefined4*)( lVar23 + uVar31 * 4 ) = 0;
                        ...
                        for (int i = 0; i < 3; i++) {
                           if (( plVar21[( 5 - i )] != 0 ) && ( cVar19 = RefCounted::unreference() ),cVar19 != '\0') {
...
;
 ...
 while ( iVar24 != 0 );
      ...
      if ((Object*)local_78._0_8_ == pOVar13) {
         LAB_00101f59:if (( pOVar13 != (Object*)0x0 ) && ( cVar6 = RefCounted::unreference() ),cVar6 != '\0') {
            uVar5 = local_78._0_8_;
            cVar6 = predelete_handler((Object*)local_78._0_8_);
            if (cVar6 != '\0') {
               ( **(code**)( *(long*)uVar5 + 0x140 ) )(uVar5);
...
LAB_00103ddc:if (( ( local_a8 != (Object*)0x0 ) && ( cVar24 = RefCounted::unreference() ),pOVar23 = local_a8,cVar24 != '\0' )) &&( cVar24 = cVar24 != '\0' )(**(code**)( *(long*)pOVar23 + 0x140 ))(pOVar23);Memory::free_static(pOVar23, false);}if (( local_b8._8_8_ != 0 ) && ( cVar24 = RefCounted::unreference() ),cVar24 != '\0') {

undefined4 ftc_basic_family_compare(long param_1, long param_2) {
   if (( ( ( *(long*)( param_1 + 0x28 ) == *(long*)( param_2 + 0x10 ) ) && ( *(long*)( param_1 + 0x30 ) == *(long*)( param_2 + 0x18 ) ) ) && ( ( *(int*)( param_1 + 0x38 ) == 0 ) != ( *(int*)( param_2 + 0x20 ) != 0 ) ) ) && ( ( *(int*)( param_1 + 0x38 ) != 0 || ( ( *(int*)( param_1 + 0x3c ) == *(int*)( param_2 + 0x24 ) && ( *(int*)( param_1 + 0x40 ) == *(int*)( param_2 + 0x28 ) ) ) ) ) )) {
      return CONCAT31(( int3 )(( uint ) * (int*)( param_2 + 0x30 ) >> 8), *(int*)( param_1 + 0x48 ) == *(int*)( param_2 + 0x30 ));
   }
...
undefined8 ftc_basic_gnode_compare_faceid(long param_1, long param_2, long param_3, undefined1 *param_4) {
   int *piVar1;
   long lVar2;
...
int ftc_cmap_node_new(long *param_1, undefined8 *param_2, long param_3) {
   ...
   if (local_24 == 0) {
      ...
      *(ulong*)( lVar2 + 0x30 ) = CONCAT44(*(undefined4*)( (long)param_2 + 0xc ), uVar1) & 0xffffff80ffffffff;
      for (int i = 0; i < 64; i++) {
         *(undefined4*)( lVar2 + ( 4*i + 56 ) ) = 4294967295;
      }
      ...
      *plVar5 = lVar1;
      ...
      while (true) {
         ...
         *param_1 = uVar10;
         ...
         uVar13 = uVar12;
         if (-1 < lVar7) break;
         LAB_0010066a:lVar4 = *(long*)( param_1 + 4 );
         uVar12 = uVar13;
...
;
         LAB_001006bb:*(long*)( lVar4 + uVar11 * 8 ) = lVar9;
...
;
   LAB_00100757:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
void ftc_node_destroy(long *param_1, long param_2) {
   ...
   *(int*)( param_2 + 0x28 ) = *(int*)( param_2 + 0x28 ) + -1;
   ...
   do {
      if (plVar4 == (long*)0x0) {
         LAB_00100837:/* WARNING: Could not recover jumptable at 0x00100846. Too many branches *//* WARNING: Treating indirect jump as call */( **(code**)( puVar3 + 0xe ) )(param_1, puVar3);
         return;
      }
...
uint FTC_Manager_FlushN(long param_1, uint param_2) {
 ...
 while ( ( lVar3 != lVar1 ) && ( lVar3 = uVar4 < param_2 ) );
   }
...
int ftc_snode_load(long param_1, long param_2, int param_3, long *param_4) {
   ...
   iVar3 = ( **(code**)( *(long*)( *(long*)( param_1 + 0x28 ) + 0x20 ) + 0x30 ) )(*(long*)( param_1 + 0x28 ), param_3, param_2, &local_38);
   if (( iVar3 == 0 ) && ( lVar5 = *(long*)( local_38 + 0x98 ) * (int*)( lVar5 + 0x90 ) == 0x62697473 )) {
      ...
      sVar12 = (short)iVar3;
      if (( ( ( iVar3 != sVar12 ) || ( cVar10 = (char)*(int*)( lVar5 + 0xc0 ) * (int*)( lVar5 + 0xc0 ) != (int)cVar10 ) ) || ( cVar11 = (char)*(int*)( lVar5 + 0xc4 ) * (int*)( lVar5 + 0xc4 ) != (int)cVar11 ) ) || ( ( lVar7 = *(long*)( lVar5 + 0x80 ) + 0x20 >> 6 ),cVar6 = (char)lVar7,(int)cVar6 != (int)lVar7 || ( lVar7 = *(long*)( lVar5 + 0x88 ) + 0x20 >> 6 ),cVar9 = (char)lVar7,(int)cVar9 != (int)lVar7 )) goto LAB_0010095c;
      ...
      *(char*)( (long)puVar1 + 9 ) = cVar9;
      ...
      LAB_0010095c:*(undefined8*)( puVar1 + 8 ) = 0;
      *puVar1 = 0xff;
      if (param_4 != (long*)0x0) {
         *param_4 = 0;
      }
   ...
   LAB_0010097b:iVar3 = 0;
   LAB_0010097d:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 ftc_snode_compare(long param_1, int *param_2, long param_3, undefined1 *param_4) {
   ...
   uVar9 = 0;
   if (( *(long*)( param_1 + 0x28 ) == *(long*)( param_2 + 2 ) ) && ( uVar10 = iVar3 - *(int*)( param_1 + 0x30 ) ),uVar10 < *(uint*)( param_1 + 0x38 )) {
      ...
      if (( *(long*)( pcVar2 + 0x10 ) == 0 ) && ( *pcVar2 == -1 )) {
         ...
         *(short*)( param_1 + 0x22 ) = *(short*)( param_1 + 0x22 ) + 1;
         ...
         while (iVar7 = ftc_snode_load(param_1, lVar11, iVar3, &local_48),iVar7 != 0) {
            if (( (char)iVar7 != '@' ) || ( uVar8 = uVar8 == 0 )) {
               LAB_00100c62:*(short*)( param_1 + 0x22 ) = *(short*)( param_1 + 0x22 ) + -1;
               uVar9 = 0;
               goto LAB_00100ba2;
            }
...
undefined8 ftc_size_node_compare(long param_1, long *param_2) {
   if (( *(long*)( param_1 + 0x18 ) == *param_2 ) && ( *(long*)( param_1 + 0x20 ) == param_2[1] )) {
      if (( ( *(int*)( param_1 + 0x28 ) == 0 ) != ( (int)param_2[2] != 0 ) ) && ( ( *(int*)( param_1 + 0x28 ) != 0 || ( ( *(int*)( param_1 + 0x2c ) == *(int*)( (long)param_2 + 0x14 ) && ( *(int*)( param_1 + 0x30 ) == (int)param_2[3] ) ) ) ) )) {
...
int FTC_Cache_NewNode(uint *param_1, ulong param_2, undefined8 param_3, undefined8 *param_4) {
 ...
 while ( ( lVar12 != lVar13 ) && ( lVar13 = lVar3 * (ulong*)( lVar1 + 0x18 ) < *(ulong*)( lVar1 + 0x20 ) ) );
...
;
 ...
 while ( bVar5 );
   ...
   LAB_0010110a:FT_Done_Face(*(undefined8*)( param_1 + 0x18 ));
...
ulong ftc_snode_new(long *param_1, uint *param_2, long param_3) {
   ...
   uVar5 = ( **(code**)( *(long*)( *(long*)( param_3 + 0x70 ) + 0x40 ) + 0x28 ) )(lVar2, *(undefined8*)( param_3 + 0x58 ));
   if (uVar1 < uVar5) {
...
ulong FTC_ImageCache_Lookup(uint *param_1, ulong *param_2, uint param_3, long *param_4, undefined8 *param_5) {
   int iVar1;
   int iVar2;
   uint uVar3;
   ulong uVar4;
   ...
   if (param_4 == (long*)0x0) {
      ...
      *param_4 = 0;
      ...
      if (plVar5 != (long*)0x0) {
         do {
            if (( ( ( uVar4 == local_70[5] ) && ( uVar14 == local_70[6] ) ) && ( (int)local_70[7] != 0 ) ) && ( iVar1 == (int)local_70[9] )) {
               if (local_70 != plVar5) {
                  lVar6 = *local_70;
 ...
 while ( plVar5 != local_70 );
      ...
      local_70 = local_88;
      if ((int)uVar10 == 0) {
         LAB_0010185c:plVar5 = local_70;
         iVar2 = (int)local_70[2];
         lVar6 = *(long*)( param_1 + 4 );
         uVar3 = *param_1;
         *(int*)( local_70 + 2 ) = iVar2 + 1;
         uVar14 = ( uVar4 >> 3 ^ uVar4 << 7 ) + ( uVar14 & 0xffffffff ) + (ulong)param_3 + ( ulong )(uint)(iVar1 * 0x1f) + ( ulong )(uint)((int)( uVar14 >> 0x20 ) * 7);
         ...
         if (local_80 != (long*)0x0) {
            ...
            plVar12 = plVar15;
            do {
               if (( ( plVar11[3] == uVar14 ) && ( local_70 == (long*)plVar11[5] ) ) && ( *(uint*)( plVar11 + 6 ) == local_78[0] )) {
                  plVar13 = local_80;
                  if (bVar9) {
                     plVar13 = unaff_RBP;
                  }
 ...
 while ( unaff_RBP != (long*)0x0 );
         ...
         *(int*)plVar15 = (int)*plVar15 + -1;
         ...
         if ((int)uVar10 == 0) {
            *param_4 = plVar13[7];
            if (param_5 != (undefined8*)0x0) {
               LAB_0010199f:*param_5 = plVar13;
               *(short*)( (long)plVar13 + 0x22 ) = *(short*)( (long)plVar13 + 0x22 ) + 1;
            }

            LAB_001019a7:uVar10 = 0;
         }
...
ulong FTC_ImageCache_LookupScaler(uint *param_1, ulong *param_2, int param_3, uint param_4, long *param_5, undefined8 *param_6) {
   int iVar1;
   ulong uVar2;
   long *plVar3;
   long lVar4;
   ...
   if (param_5 != (long*)0x0 && param_2 != (ulong*)0x0) {
      *param_5 = 0;
      ...
      if (plVar3 != (long*)0x0) {
         do {
            if (( ( ( ( uVar2 == local_70[5] ) && ( local_70[6] == uVar10 ) ) && ( ( (int)local_70[7] == 0 ) != ( (int)local_58 != 0 ) ) ) && ( ( (int)local_70[7] != 0 || ( ( *(int*)( (long)local_70 + 0x3c ) == local_58._4_4_ && ( (int)local_70[8] == (int)uStack_50 ) ) ) ) ) ) && ( param_3 == (int)local_70[9] )) {
               if (local_70 != plVar3) {
                  lVar4 = *local_70;
 ...
 while ( plVar3 != local_70 );
      ...
      local_70 = local_88;
      if ((int)uVar12 == 0) {
         LAB_00101c00:plVar3 = local_70;
         iVar1 = (int)local_70[2];
         lVar4 = *(long*)( param_1 + 4 );
         *(int*)( local_70 + 2 ) = iVar1 + 1;
         uVar15 = ( uVar2 >> 3 ^ uVar2 << 7 ) + ( ulong )(uint)(iVar11 * 7) + ( uVar10 & 0xffffffff ) + (ulong)param_4 + ( ulong )(uint)(param_3 * 0x1f) + uVar15;
         ...
         while (local_88 = local_70,plVar7 != (long*)0x0) {
            if (( ( plVar7[3] == uVar15 ) && ( local_70 == (long*)plVar7[5] ) ) && ( *(uint*)( plVar7 + 6 ) == local_78[0] )) {
               plVar14 = local_80;
               if (bVar9) {
                  plVar14 = unaff_RBP;
               }
...
;
         ...
         *(int*)plVar5 = (int)*plVar5 + -1;
         ...
         if ((int)uVar12 == 0) {
            LAB_00101d38:*param_5 = plVar14[7];
            if (param_6 != (undefined8*)0x0) {
               *param_6 = plVar14;
...
ulong FTC_SBitCache_Lookup(uint *param_1, ulong *param_2, uint param_3, long *param_4, undefined8 *param_5) {
   uint uVar1;
   ulong uVar2;
   long *plVar3;
   long lVar4;
   ...
   *param_4 = 0;
   ...
   if (plVar3 != (long*)0x0) {
      do {
         if (( ( ( uVar2 == local_70[5] ) && ( local_70[6] == uVar11 ) ) && ( (int)local_70[7] != 0 ) ) && ( iVar9 == (int)local_70[9] )) {
            if (local_70 != plVar3) {
               lVar4 = *local_70;
               plVar15 = (long*)local_70[1];
               *plVar15 = lVar4;
 ...
 while ( plVar3 != local_70 );
   ...
   LAB_00101ff0:plVar3 = local_70;
   local_c0 = local_78;
   uVar1 = *param_1;
   *(int*)( local_70 + 2 ) = (int)local_70[2] + 1;
   local_89 = '\0';
   uVar10 = ( uVar2 >> 3 ^ uVar2 << 7 ) + ( uVar11 & 0xffffffff ) + ( ulong )(param_3 >> 4) + ( ulong )(uint)(iVar9 * 0x1f) + ( ulong )(uint)((int)( uVar11 >> 0x20 ) * 7);
   ...
   if (plVar15 != (long*)0x0) {
      plVar14 = local_a0;
      do {
         if (( plVar15[3] == uVar10 ) && ( local_80 = plVar15 ),cVar8 = ftc_snode_compare(plVar15, local_c0, param_1, &local_89),plVar13 = local_80,cVar8 != '\0') {
            if (local_89 == '\0') {
 ...
 while ( plVar15 != (long*)0x0 );
   ...
   LAB_00102128:uVar10 = FTC_Cache_NewNode(param_1, uVar10, local_c0, &local_80);
   plVar13 = local_80;
   plVar15 = plVar3 + 2;
   *(int*)plVar15 = (int)*plVar15 + -1;
   iVar9 = (int)uVar10;
   ...
   while (plVar7 = (long*)plVar14[2],plVar15 != (long*)plVar14[2]) {
      LAB_00102120:plVar14 = plVar7;
      if (plVar14 == (long*)0x0) goto LAB_00102128;
   }
;
   plVar14 = plVar14 + 2;
   LAB_0010223a:if (plVar15 != plVar12) {
      *plVar14 = plVar15[2];
      plVar15[2] = *local_a0;
      *local_a0 = (long)plVar15;
   }

   LAB_00102256:lVar4 = *(long*)( param_1 + 0x16 );
   ...
   *(int*)( plVar3 + 2 ) = iVar9;
   ...
   LAB_00102150:*param_4 = (long)( plVar13 + ( ulong )(param_3 - (int)plVar13[6]) * 3 + 8 );
   if (param_5 != (undefined8*)0x0) {
      *param_5 = plVar13;
      *(short*)( (long)plVar13 + 0x22 ) = *(short*)( (long)plVar13 + 0x22 ) + 1;
   }
   ...
   uVar10 = 0;
   LAB_0010217a:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
ulong FTC_SBitCache_LookupScaler(uint *param_1, ulong *param_2, int param_3, uint param_4, long *param_5, undefined8 *param_6) {
   uint uVar1;
   ulong uVar2;
   long *plVar3;
   long lVar4;
   ...
   *param_5 = 0;
   ...
   if (plVar3 != (long*)0x0) {
      do {
         if (( ( ( ( uVar2 == local_70[5] ) && ( local_70[6] == uVar7 ) ) && ( ( (int)local_70[7] == 0 ) != ( (int)local_58 != 0 ) ) ) && ( ( (int)local_70[7] != 0 || ( ( *(int*)( (long)local_70 + 0x3c ) == local_58._4_4_ && ( (int)local_70[8] == (int)uStack_50 ) ) ) ) ) ) && ( param_3 == (int)local_70[9] )) {
            if (local_70 != plVar3) {
               lVar4 = *local_70;
 ...
 while ( plVar3 != local_70 );
   ...
   LAB_0010243c:plVar3 = local_70;
   uVar1 = *param_1;
   *(int*)( local_70 + 2 ) = (int)local_70[2] + 1;
   local_89 = '\0';
   uVar15 = ( uVar2 >> 3 ^ uVar2 << 7 ) + ( ulong )(uint)(iVar10 * 7) + ( uVar7 & 0xffffffff ) + ( ulong )(param_4 >> 4) + ( ulong )(uint)(param_3 * 0x1f) + uVar15;
   ...
   if (plVar16 != (long*)0x0) {
      plVar13 = plVar12;
      do {
         if (( plVar16[3] == uVar15 ) && ( local_80 = plVar16 ),cVar9 = ftc_snode_compare(plVar16, local_78, param_1, &local_89),plVar14 = local_80,cVar9 != '\0') {
            if (local_89 == '\0') {
 ...
 while ( plVar16 != (long*)0x0 );
   ...
   LAB_00102588:uVar11 = FTC_Cache_NewNode(param_1, uVar15, local_78, &local_80);
   plVar14 = local_80;
   plVar16 = plVar3 + 2;
   *(int*)plVar16 = (int)*plVar16 + -1;
   ...
   while (plVar8 = (long*)plVar13[2],(long*)plVar13[2] != plVar16) {
      LAB_00102580:plVar13 = plVar8;
      if (plVar13 == (long*)0x0) goto LAB_00102588;
   }
;
   plVar13 = plVar13 + 2;
   LAB_001026c9:*plVar13 = plVar16[2];
   plVar16[2] = *plVar12;
   *plVar12 = (long)plVar16;
   LAB_001026db:lVar4 = *(long*)( param_1 + 0x16 );
   ...
   *(int*)( plVar3 + 2 ) = iVar10;
   ...
   LAB_001025bc:*param_5 = (long)( plVar14 + ( ulong )(param_4 - (int)plVar14[6]) * 3 + 8 );
   if (param_6 != (undefined8*)0x0) {
      *param_6 = plVar14;
      *(short*)( (long)plVar14 + 0x22 ) = *(short*)( (long)plVar14 + 0x22 ) + 1;
   }
   ...
   uVar11 = 0;
   LAB_00102657:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 FTC_Manager_LookupSize(long param_1, long *param_2, long *param_3) {
      ...
      *param_3 = 0;
      if (param_1 == 0) {
         ...
         if (plVar1 != (long*)0x0) {
            plVar6 = plVar1;
            do {
               if (( ( ( plVar6[3] == *param_2 ) && ( plVar6[4] == param_2[1] ) ) && ( ( (int)plVar6[5] == 0 ) != ( (int)param_2[2] != 0 ) ) ) && ( ( (int)plVar6[5] != 0 || ( ( *(int*)( (long)plVar6 + 0x2c ) == *(int*)( (long)param_2 + 0x14 ) && ( (int)plVar6[6] == (int)param_2[3] ) ) ) ) )) {
                  FT_Activate_Size(plVar6[2]);
                  local_38 = plVar6;
                  if (( plVar1 != plVar6 ) && ( plVar1 = plVar6 != plVar1 )) {
                     lVar2 = *plVar6;
 ...
 while ( plVar1 != plVar6 );
         ...
         if ((int)uVar5 == 0) {
            LAB_001028a0:*param_3 = local_38[2];
            uVar5 = 0;
         }
...
undefined8 ftc_basic_family_load_glyph(long param_1, undefined4 param_2, long param_3, undefined8 *param_4) {
   int iVar1;
   long lVar2;
   undefined8 uVar3;
   long in_FS_OFFSET;
   ...
   if ((int)uVar3 == 0) {
      ...
      if ((int)uVar3 == 0) {
         ...
         if (( iVar1 == 0x62697473 || iVar1 == 0x6f75746c ) || ( uVar3 = iVar1 == 0x53564720 )) {
...
void ftc_basic_family_load_bitmap(long param_1, undefined4 param_2, undefined8 param_3, undefined8 *param_4) {
   undefined8 uVar1;
   int iVar2;
   long in_FS_OFFSET;
   undefined8 *local_38;
...
undefined8 FTC_Manager_LookupFace(long param_1, long param_2, long *param_3) {
 ...
 while ( plVar1 != plVar5 );
         ...
         if ((int)uVar6 == 0) {
            LAB_00102ac8:*param_3 = local_18[3];
            uVar6 = 0;
         }
...
ulong FTC_CMapCache_Lookup(uint *param_1, ulong param_2, int param_3, uint param_4, long *param_5) {
   ...
   if (param_1 != (uint*)0x0) {
      ...
      if (plVar2 != (long*)0x0) {
         ...
         plVar12 = plVar2;
         do {
            if (( ( ( plVar12[3] == uVar13 ) && ( param_2 == plVar12[5] ) ) && ( iVar15 == (int)plVar12[6] ) ) && ( uVar14 = param_4 - *(int*)( (long)plVar12 + 0x34 ) ),uVar8 = (ulong)uVar14,uVar14 < 0x80) {
               if (bVar6) {
                  local_60 = param_5;
               }
 ...
 while ( plVar12 != (long*)0x0 );
      ...
      if (( iVar7 == 0 ) && ( uVar14 = param_4 - *(int*)( (long)local_60 + 0x34 ) ),uVar8 = (ulong)uVar14,plVar12 = local_60,uVar14 < 0x80) {
         LAB_00102d10:uVar1 = *(ushort*)( (long)plVar12 + uVar8 * 2 + 0x38 );
         uVar8 = (ulong)uVar1;
         ...
         if (iVar7 == 0) {
            ...
            *(undefined2*)( (long)plVar12 + ( ulong )(param_4 - *(int*)( (long)plVar12 + 0x34 )) * 2 + 0x38 ) = uVar10;
            goto LAB_00102d1d;
         }
   ...
   uVar8 = 0;
   LAB_00102d1d:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
int ftc_scaler_lookup_size(undefined8 param_1, undefined8 *param_2, undefined8 *param_3) {
   ...
   if (( iVar1 == 0 ) && ( iVar1 = FT_New_Size(local_40, &local_38) ),uVar2 = local_38,iVar1 == 0) {
      FT_Activate_Size();
      if (*(int*)( param_2 + 2 ) == 0) {
         iVar1 = FT_Set_Char_Size(local_40, *(undefined4*)( param_2 + 1 ), *(undefined4*)( (long)param_2 + 0xc ), *(undefined4*)( (long)param_2 + 0x14 ), *(undefined4*)( param_2 + 3 ));
      }
 else {
         iVar1 = FT_Set_Pixel_Sizes(local_40, *(undefined4*)( param_2 + 1 ), *(undefined4*)( (long)param_2 + 0xc ));
      }
...
int FTC_Manager_New(undefined8 *param_1, int param_2, int param_3, long param_4, long param_5, undefined8 param_6, undefined8 *param_7) {
   undefined8 uVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   undefined8 uVar4;
      ...
      if (*(int*)( param_1 + 0xb0 ) != 0) {
         do {
            ...
            if (uVar1 != 0) {
               local_68 = 0;
               plVar10 = (long*)0x0;
               LAB_001033e8:plVar11 = (long*)( local_68 + *(long*)( puVar4 + 4 ) );
               LAB_001033f8:plVar5 = (long*)*plVar11;
...
;
 ...
 while ( (uint)local_58 < *(uint*)( param_1 + 0xb0 ) );
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   LAB_001034b8:plVar11 = plVar6 + 2;
   goto LAB_001033f8;
}
void FTC_Node_Unref(long param_1, long param_2) {
   if (( ( param_1 != 0 ) && ( param_2 != 0 ) ) && ( ( uint ) * (ushort*)( param_1 + 0x20 ) < *(uint*)( param_2 + 0xb0 ) )) {
      *(short*)( param_1 + 0x22 ) = *(short*)( param_1 + 0x22 ) + -1;
   }

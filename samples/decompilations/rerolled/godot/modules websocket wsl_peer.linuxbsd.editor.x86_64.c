   ...
   if (*param_2 == 0) {
      ...
      if (cVar3 == '\0') {
         ...
         if (cVar3 != '\0') {
            ...
            cVar3 = RefCounted::unreference();
            joined_r0x00104e15:if (( cVar3 != '\0' ) && ( cVar3 = predelete_handler(pOVar5) ),cVar3 != '\0') {
               ( **(code**)( *(long*)pOVar5 + 0x140 ) )(pOVar5);
               Memory::free_static(pOVar5, false);
            }
      ...
      if (( *param_3 == 0 ) || ( *(int*)( *param_3 + 0x17c ) != 2 )) {
         ...
         if (local_c4 == 0) {
            ...
            if (( cVar3 == '\0' ) || ( cVar3 = String::operator !=((String*)&local_90, "wss://") ),cVar3 == '\0') {
               ...
               if (( this[0x268] == (WSLPeer)0x0 ) || ( cVar3 = StreamPeerTLS::is_available() ),cVar3 != '\0') {
...
/* WSLPeer::~WSLPeer() */void WSLPeer::~WSLPeer(WSLPeer *this) {
 ...
 while ( (int)lVar8 < *(int*)( this + 700 ) );
   ...
   *(undefined8*)( this + 0x298 ) = 0;
   ...
   lVar8 = *(long*)( this + 0x1f0 );
   joined_r0x00106a21:if (( lVar8 != 0 ) && ( cVar7 = RefCounted::unreference() ),cVar7 != '\0') {
      pOVar5 = *(Object**)( this + 0x1f0 );
      cVar7 = predelete_handler(pOVar5);
      if (cVar7 != '\0') {
         ( **(code**)( *(long*)pOVar5 + 0x140 ) )(pOVar5);
...
/* WSLPeer::_do_client_handshake() */void WSLPeer::_do_client_handshake(WSLPeer *this) {
   ...
   if (( ( *(long*)( this + 0x1f0 ) != 0 ) && ( pOVar9 = (Object*)__dynamic_cast(*(long*)( this + 0x1f0 ), &Object::typeinfo, &StreamPeerTLS::typeinfo, 0) ),pOVar9 != (Object*)0x0 )) {
      ...
      if (cVar5 != '\0') {
         cVar5 = RefCounted::unreference();
         pOVar10 = pOVar9;
         if (( cVar5 != '\0' ) && ( cVar5 = predelete_handler(pOVar9) ),cVar5 != '\0') goto LAB_00107593;

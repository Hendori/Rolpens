/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* embree::sse2::BVHNRotate<4>::rotate(embree::NodeRefPtr<4>, unsigned long) */long embree::sse2::BVHNRotate<4>::rotate(long *param_1, long param_2) {
   long lVar1;
   ...
   lVar26 = 0;
   if (( (long)param_1 < 0 ) || ( uVar24 = ( ulong )((uint)param_1 & 8)((ulong)param_1 & 8) != 0 )) goto LAB_001009b2;
   plVar23 = param_1;
   pfVar30 = local_88;
   do {
      lVar26 = *plVar23;
 ...
 while ( pfVar31 != local_78 );
   ...
   local_78[0] = ( fVar70 + fVar79 ) * ( *(float*)( param_1 + 6 ) - *(float*)( param_1 + 4 ) ) + fVar70 * fVar79;
   local_78[1] = ( fVar74 + fVar82 ) * ( *(float*)( (long)param_1 + 0x34 ) - *(float*)( (long)param_1 + 0x24 ) ) + fVar74 * fVar82;
   local_78[2] = ( fVar75 + fVar83 ) * ( *(float*)( param_1 + 7 ) - *(float*)( param_1 + 5 ) ) + fVar75 * fVar83;
   local_78[3] = ( fVar76 + fVar84 ) * ( *(float*)( (long)param_1 + 0x3c ) - *(float*)( (long)param_1 + 0x2c ) ) + fVar76 * fVar84;
   ...
   do {
      ...
      if (( -1 < (long)uVar21 ) && ( ( uVar21 & 8 ) == 0 )) {
         ...
         auVar57._0_4_ = ( -(uint)(__LC1 < iVar18 + (int)local_88[0]) ^ 0xffffffff ) & ( -(uint)(iVar20 == __LC2) ^ __LC5 );
         auVar57._4_4_ = ( -(uint)(_UNK_00100e64 < iVar18 + (int)local_88[1]) ^ 0xffffffff ) & ( -(uint)(iVar20 == _UNK_00100e74) ^ _UNK_00100e94 );
         auVar57._8_4_ = ( -(uint)(_UNK_00100e68 < iVar18 + (int)local_88[2]) ^ 0xffffffff ) & ( -(uint)(iVar20 == _UNK_00100e78) ^ _UNK_00100e98 );
         auVar57._12_4_ = ( -(uint)(_UNK_00100e6c < iVar18 + (int)local_88[3]) ^ 0xffffffff ) & ( -(uint)(iVar20 == _UNK_00100e7c) ^ _UNK_00100e9c );
 ...
 while ( uVar24 != 4 );
   if (uVar25 != 0xffffffffffffffff) {
      ...
      *(undefined4*)( (long)param_1 + uVar25 * 4 + 0x20 ) = *(undefined4*)( (long)plVar23 + lVar26 * 4 + 0x20 );
      *(undefined4*)( (long)plVar23 + lVar26 * 4 + 0x20 ) = uVar19;
      uVar19 = *(undefined4*)( (long)param_1 + uVar25 * 4 + 0x40 );
      *(undefined4*)( (long)param_1 + uVar25 * 4 + 0x40 ) = *(undefined4*)( (long)plVar23 + lVar26 * 4 + 0x40 );
      *(undefined4*)( (long)plVar23 + lVar26 * 4 + 0x40 ) = uVar19;
      uVar19 = *(undefined4*)( (long)param_1 + uVar25 * 4 + 0x60 );
      *(undefined4*)( (long)param_1 + uVar25 * 4 + 0x60 ) = *(undefined4*)( (long)plVar23 + lVar26 * 4 + 0x60 );
      *(undefined4*)( (long)plVar23 + lVar26 * 4 + 0x60 ) = uVar19;
      uVar19 = *(undefined4*)( (long)param_1 + uVar25 * 4 + 0x30 );
      *(undefined4*)( (long)param_1 + uVar25 * 4 + 0x30 ) = *(undefined4*)( (long)plVar23 + lVar26 * 4 + 0x30 );
      *(undefined4*)( (long)plVar23 + lVar26 * 4 + 0x30 ) = uVar19;
      uVar19 = *(undefined4*)( (long)param_1 + uVar25 * 4 + 0x50 );
      *(undefined4*)( (long)param_1 + uVar25 * 4 + 0x50 ) = *(undefined4*)( (long)plVar23 + lVar26 * 4 + 0x50 );
      *(undefined4*)( (long)plVar23 + lVar26 * 4 + 0x50 ) = uVar19;
      uVar19 = *(undefined4*)( (long)param_1 + uVar25 * 4 + 0x70 );
      *(undefined4*)( (long)param_1 + uVar25 * 4 + 0x70 ) = *(undefined4*)( (long)plVar23 + lVar26 * 4 + 0x70 );
      ...
      *(int*)( (long)param_1 + uVar22 * 4 + 0x30 ) = auVar41._0_4_;
      if (param_1[3] == 8) {
         if (param_1[2] == 8) {
            if (( param_1[1] != 8 ) && ( *param_1 == 8 )) {
               lVar26 = 1;
               LAB_00100d61:*param_1 = param_1[lVar26];
               param_1[lVar26] = 8;
               lVar1 = param_1[4];
         ...
         lVar26 = 3;
         LAB_00100c00:param_1[1] = param_1[lVar26];
         param_1[lVar26] = 8;
      ...
      LAB_00100959:if (plVar23[3] == 8) {
         if (plVar23[2] == 8) {
            if (( plVar23[1] != 8 ) && ( *plVar23 == 8 )) {
               lVar26 = 1;
               LAB_00100ca0:*plVar23 = plVar23[lVar26];
               plVar23[lVar26] = 8;
               lVar1 = plVar23[4];
         ...
         lVar26 = 3;
         LAB_00100b50:plVar23[1] = plVar23[lVar26];
         plVar23[lVar26] = 8;
      ...
      LAB_0010097a:local_88[uVar25] = (float)( (int)local_88[uVar25] + 1 );
   }

   for (int i = 0; i < 3; i++) {
      if ((int)local_88[3] < (int)local_88[( 2 - i )]) {
         local_88[3] = local_88[( 2 - i )];
      }

   }

   lVar26 = (long)( (int)local_88[3] + 1 );
   LAB_001009b2:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {

...
/* uninitialize_ogg_module(ModuleInitializationLevel) */

void uninitialize_ogg_module(void)
...
/* initialize_ogg_module(ModuleInitializationLevel) */

void initialize_ogg_module(int param_1)

{
  ...
  if (param_1 == 2) {
    ...
    _global_lock();
    if (OggPacketSequencePlayback::initialize_class()::initialized == '\0') {
      ...
      OggPacketSequencePlayback::initialize_class()::initialized = '\x01';
    }
    local_58 = "OggPacketSequencePlayback";
    local_60 = 0;
    local_50 = 0x19;
        ...
        do {
          if ((uVar18 == uVar14) &&
             (*(char **)(*(long *)(CONCAT44(ClassDB::current_api._4_4_,
                                            (undefined4)ClassDB::current_api) + lVar16 * 8) + 0x10)
              == local_58)) {
            puVar17 = (undefined4 *)
                      (*(long *)(CONCAT44(ClassDB::current_api._4_4_,
                                          (undefined4)ClassDB::current_api) + (ulong)uVar15 * 8) +
                      0x18);
...
LAB_0010039f:
          *(undefined1 *)((long)puVar17 + 0x289) = 1;
          *(code **)(puVar17 + 0xa4) = ClassDB::creator<OggPacketSequencePlayback>;
          *(undefined4 **)(puVar17 + 4) = &OggPacketSequencePlayback::get_class_ptr_static()::ptr;
...
{
  return (uint)CONCAT71(0x102c,(undefined4 *)param_1 == &Resource::get_class_ptr_static()::ptr) |
...
/* Object* ClassDB::creator<OggPacketSequence>(bool) */

Object * ClassDB::creator<OggPacketSequence>(bool param_1)
...
/* Object* ClassDB::creator<OggPacketSequencePlayback>(bool) */

Object * ClassDB::creator<OggPacketSequencePlayback>(bool param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* void ClassDB::register_class<OggPacketSequence>(bool) */

void ClassDB::register_class<OggPacketSequence>(bool param_1)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  _global_lock();
  if (OggPacketSequence::initialize_class()::initialized == '\0') {
    if (Resource::initialize_class()::initialized == '\0') {
      if (RefCounted::initialize_class()::initialized == '\0') {
        Object::initialize_class();
        local_68 = 0;
    ...
    OggPacketSequence::initialize_class()::initialized = '\x01';
  }
  local_58 = "OggPacketSequence";
  local_60 = 0;
  local_50 = 0x11;
...
LAB_00102657:
        ...
        *(undefined4 **)(puVar16 + 4) = &OggPacketSequence::get_class_ptr_static()::ptr;

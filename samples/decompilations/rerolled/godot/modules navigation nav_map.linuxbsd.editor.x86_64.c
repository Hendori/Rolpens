/* NavMap::_build_iteration_threaded(void*) */void NavMap::_build_iteration_threaded(void *param_1) {
   NavMapBuilder3D::build_navmap_iteration((NavMapIterationBuild*)param_1);
   return;
}
/* NavMap::compute_single_avoidance_step_2d(unsigned int, NavAgent**) */void NavMap::compute_single_avoidance_step_2d(NavMap *this, uint param_1, NavAgent **param_2) {
   NavAgent **ppNVar1;
...
/* NavMap::compute_single_avoidance_step_3d(unsigned int, NavAgent**) */void NavMap::compute_single_avoidance_step_3d(NavMap *this, uint param_1, NavAgent **param_2) {
   NavAgent **ppNVar1;
   ppNVar1 = param_2 + param_1;
...
/* NavMap::set_up(Vector3) */void NavMap::set_up(undefined8 param_1, float param_2, long param_3) {
   if (( ( *(float*)( param_3 + 8 ) == (float)param_1 ) && ( *(float*)( param_3 + 0xc ) == (float)( (ulong)param_1 >> 0x20 ) ) ) && ( *(float*)( param_3 + 0x10 ) == param_2 )) {
      return;
   }
...
/* NavMap::set_cell_size(float) */void NavMap::set_cell_size(NavMap *this, float param_1) {
   float fVar1;
...
/* NavMap::set_cell_height(float) */void NavMap::set_cell_height(NavMap *this, float param_1) {
   float fVar1;
...
/* NavMap::set_merge_rasterizer_cell_scale(float) */void NavMap::set_merge_rasterizer_cell_scale(NavMap *this, float param_1) {
...
/* NavMap::set_use_edge_connections(bool) */void NavMap::set_use_edge_connections(NavMap *this, bool param_1) {
...
/* NavMap::set_edge_connection_margin(float) */void NavMap::set_edge_connection_margin(NavMap *this, float param_1) {
...
/* NavMap::set_link_connection_radius(float) */void NavMap::set_link_connection_radius(NavMap *this, float param_1) {
...
/* NavMap::get_merge_rasterizer_cell_size() const */NavMap * __thiscall NavMap::get_merge_rasterizer_cell_size(NavMap *this){
   return this + 0x1c;
}
/* NavMap::get_point_key(Vector3 const&) const */ulong NavMap::get_point_key(NavMap *this, Vector3 *param_1) {
   float fVar1;
   float fVar2;
   float fVar3;
   fVar2 = *(float*)param_1 / *(float*)( this + 0x1c );
   if ((float)( (uint)fVar2 & _LC2 ) < _LC1) {
      fVar2 = (float)( ( uint )((float)(int)fVar2 - (float)( -(uint)(fVar2 < (float)(int)fVar2) & _LC48._4_4_ )) | ~_LC2 & (uint)fVar2 );
   }

   fVar3 = *(float*)( param_1 + 4 ) / *(float*)( this + 0x20 );
   if ((float)( (uint)fVar3 & _LC2 ) < _LC1) {
      fVar3 = (float)( ( uint )((float)(int)fVar3 - (float)( -(uint)(fVar3 < (float)(int)fVar3) & _LC48._4_4_ )) | ~_LC2 & (uint)fVar3 );
   }

   fVar1 = *(float*)( param_1 + 8 ) / *(float*)( this + 0x24 );
   if ((float)( (uint)fVar1 & _LC2 ) < _LC1) {
      fVar1 = (float)( ( uint )((float)(int)fVar1 - (float)( -(uint)(fVar1 < (float)(int)fVar1) & _LC48._4_4_ )) | ~_LC2 & (uint)fVar1 );
   }

   return ( ulong )((int)fVar3 & 0x3fffff) << 0x15 | ( ulong )((int)fVar2 & 0x1fffff) | (ulong)(uint)(int)fVar1 << 0x2b;
}
/* NavMap::query_path(NavMeshQueries3D::NavMeshPathQueryTask3D&) */void NavMap::query_path(NavMap *this, NavMeshPathQueryTask3D *param_1) {
 ...
 while ( iVar4 == 0xb );
   if (iVar4 == 0x23) {
      LAB_0010071f:/* WARNING: Subroutine does not return */std::__throw_system_error(0x23);
   }
 ...
 while ( *(int*)( pNVar8 + 0x178 ) == 0 );
   ...
   if (*(long*)( param_1 + 0x78 ) == 0) {
      ...
      *(int*)( pNVar8 + 0x178 ) = *(int*)( pNVar8 + 0x178 ) + 1;
      ...
      _err_print_error("query_path", "modules/navigation/nav_map.cpp", 0xa4, "Parameter \"p_query_task.path_query_slot\" is null.", "No unused NavMap path query slot found! This should never happen :(.", 0, 0);
      LOCK();
      *(int*)pNVar8 = *(int*)pNVar8 + -1;
      UNLOCK();
      ...
      LAB_0010055a:*(undefined8*)( param_1 + 100 ) = *(undefined8*)( pNVar8 + 0x40 );
      *(undefined4*)( param_1 + 0x6c ) = *(undefined4*)( pNVar8 + 0x48 );
      NavMeshQueries3D::query_task_map_iteration_get_path(param_1, pNVar8);
      iVar4 = pthread_mutex_lock(__mutex_00);
      if (iVar4 != 0) {
         LAB_00100718:/* WARNING: Subroutine does not return */std::__throw_system_error(iVar4);
      }

      uVar1 = *(uint*)( pNVar8 + 0xe8 );
      uVar5 = ( ulong ) * (uint*)( *(long*)( param_1 + 0x78 ) + 0x2c );
      if (uVar1 <= *(uint*)( *(long*)( param_1 + 0x78 ) + 0x2c )) {
         LAB_001006d8:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, uVar5, (ulong)uVar1, "p_index", "count", "", false, true);
         _err_flush_stdout();
   ...
   LAB_001006cf:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* NavMap::get_closest_point_to_segment(Vector3 const&, Vector3 const&, bool) const */undefined1  [16] __thiscallNavMap::get_closest_point_to_segment(NavMap *this, Vector3 *param_1, Vector3 *param_2, bool param_3) {
   uint uVar1;
   long lVar2;
   code *pcVar3;
   int iVar4;
   ...
   lVar2 = *(long*)( in_FS_OFFSET + 0x28 );
   if (*(int*)( this + 0x130 ) == 0) {
      if (get_closest_point_to_segment(Vector3_const & Vector3_const & ::first_print != '\0') {
         _err_print_error("get_closest_point_to_segment", "modules/navigation/nav_map.cpp", 0xb6, "NavigationServer navigation map query failed because it was made before first map synchronization.\n\tNavigationServer \'map_changed\' signal can be used to receive update notifications.\n\tNavigationServer \'map_get_iteration_id()\' can be used to check if a map has finished its newest iteration.", 0, 0);
         get_closest_point_to_segment(Vector3_const&,Vector3_const&,bool)::first_print =
         '\0';
      }

      auVar7 = ZEXT812(0);
      LAB_0010077a:if (lVar2 == *(long*)( in_FS_OFFSET + 0x28 )) {
         auVar6._12_4_ = 0;
 ...
 while ( iVar4 == 0xb );
   if (iVar4 != 0x23) {
      ...
      if (*(uint*)( this + 0x1b0 ) <= uVar1) {
         _err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xae, (ulong)uVar1, ( ulong ) * (uint*)( this + 0x1b0 ), "p_index", "count", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
 ...
 while ( iVar4 == 0xb );
      if (iVar4 != 0x23) {
         ...
         *(int*)pNVar5 = *(int*)pNVar5 + 1;
         UNLOCK();
         pthread_rwlock_unlock((pthread_rwlock_t*)( this + 0x1c0 ));
         auVar7 = NavMeshQueries3D::map_iteration_get_closest_point_to_segment(pNVar5, param_1, param_2, param_3);
         LOCK();
         *(int*)pNVar5 = *(int*)pNVar5 + -1;
         UNLOCK();
...
/* NavMap::get_closest_point(Vector3 const&) const */undefined1  [16] __thiscallNavMap::get_closest_point(NavMap *this, Vector3 *param_1) {
   uint uVar1;
   long lVar2;
   code *pcVar3;
   int iVar4;
   ...
   if (*(int*)( this + 0x130 ) == 0) {
      if (get_closest_point(Vector3_const & ::first_print != '\0') {
         _err_print_error("get_closest_point", "modules/navigation/nav_map.cpp", 0xc1, "NavigationServer navigation map query failed because it was made before first map synchronization.\n\tNavigationServer \'map_changed\' signal can be used to receive update notifications.\n\tNavigationServer \'map_get_iteration_id()\' can be used to check if a map has finished its newest iteration.", 0, 0);
         get_closest_point(Vector3_const&)::first_print =
         '\0';
      }

      auVar7 = ZEXT812(0);
      LAB_00100922:if (lVar2 == *(long*)( in_FS_OFFSET + 0x28 )) {
         auVar6._12_4_ = 0;
         auVar6._0_12_ = auVar7;
         return auVar6;
      }
...
/* NavMap::get_closest_point_normal(Vector3 const&) const */undefined1  [16] __thiscallNavMap::get_closest_point_normal(NavMap *this, Vector3 *param_1) {
   uint uVar1;
   long lVar2;
   code *pcVar3;
   int iVar4;
   ...
   if (*(int*)( this + 0x130 ) == 0) {
      if (get_closest_point_normal(Vector3_const & ::first_print != '\0') {
         _err_print_error("get_closest_point_normal", "modules/navigation/nav_map.cpp", 0xcc, "NavigationServer navigation map query failed because it was made before first map synchronization.\n\tNavigationServer \'map_changed\' signal can be used to receive update notifications.\n\tNavigationServer \'map_get_iteration_id()\' can be used to check if a map has finished its newest iteration.", 0, 0);
         get_closest_point_normal(Vector3_const&)::first_print =
         '\0';
      }

      auVar7 = ZEXT812(0);
      LAB_00100ab2:if (lVar2 == *(long*)( in_FS_OFFSET + 0x28 )) {
         auVar6._12_4_ = 0;
         auVar6._0_12_ = auVar7;
         return auVar6;
      }
...
/* NavMap::get_closest_point_owner(Vector3 const&) const */undefined8 NavMap::get_closest_point_owner(NavMap *this, Vector3 *param_1) {
   uint uVar1;
   code *pcVar2;
   int iVar3;
   undefined8 uVar4;
   ...
   if (*(int*)( this + 0x130 ) == 0) {
      if (get_closest_point_owner(Vector3_const & ::first_print != '\0') {
         _err_print_error("get_closest_point_owner", "modules/navigation/nav_map.cpp", 0xd7, "NavigationServer navigation map query failed because it was made before first map synchronization.\n\tNavigationServer \'map_changed\' signal can be used to receive update notifications.\n\tNavigationServer \'map_get_iteration_id()\' can be used to check if a map has finished its newest iteration.", 0, 0);
         get_closest_point_owner(Vector3_const&)::first_print =
         '\0';
      }
...
/* NavMap::get_closest_point_info(Vector3 const&) const */NavMap * __thiscall NavMap::get_closest_point_info(NavMap *this,Vector3 *param_1){
   uint uVar1;
   long lVar2;
   code *pcVar3;
   int iVar4;
 ...
 while ( iVar4 == 0xb );
   if (iVar4 != 0x23) {
      ...
      if (*(uint*)( param_1 + 0x1b0 ) <= uVar1) {
         _err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xae, (ulong)uVar1, ( ulong ) * (uint*)( param_1 + 0x1b0 ), "p_index", "count", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
 ...
 while ( iVar4 == 0xb );
      if (iVar4 != 0x23) {
         ...
         *piVar5 = *piVar5 + 1;
         ...
         NavMeshQueries3D::map_iteration_get_closest_point_info((NavMapIteration*)this, (Vector3*)piVar5);
         LOCK();
         *piVar5 = *piVar5 + -1;
         UNLOCK();
...
/* NavMap::add_region(NavRegion*) */void NavMap::add_region(NavMap *this, NavRegion *param_1) {
   uint uVar1;
   code *pcVar2;
   void *pvVar3;
   ulong uVar4;
...
/* NavMap::remove_region(NavRegion*) */void NavMap::remove_region(NavMap *this, NavRegion *param_1) {
   long *plVar1;
   uint uVar2;
   uint uVar3;
...
/* NavMap::add_link(NavLink*) */void NavMap::add_link(NavMap *this, NavLink *param_1) {
   uint uVar1;
   code *pcVar2;
   void *pvVar3;
   ulong uVar4;
...
/* NavMap::remove_link(NavLink*) */void NavMap::remove_link(NavMap *this, NavLink *param_1) {
   long *plVar1;
   uint uVar2;
   uint uVar3;
...
/* NavMap::has_agent(NavAgent*) const */undefined8 NavMap::has_agent(NavMap *this, NavAgent *param_1) {
   long *plVar1;
   long *plVar2;
...
/* NavMap::add_agent(NavAgent*) */void NavMap::add_agent(NavMap *this, NavAgent *param_1) {
   uint uVar1;
   code *pcVar2;
   long *plVar3;
   long *plVar4;
...
/* NavMap::has_obstacle(NavObstacle*) const */undefined8 NavMap::has_obstacle(NavMap *this, NavObstacle *param_1) {
   long *plVar1;
   long *plVar2;
...
/* NavMap::add_obstacle(NavObstacle*) */void NavMap::add_obstacle(NavMap *this, NavObstacle *param_1) {
   uint uVar1;
   code *pcVar2;
   char cVar3;
   long *plVar4;
...
/* NavMap::remove_obstacle(NavObstacle*) */void NavMap::remove_obstacle(NavMap *this, NavObstacle *param_1) {
   long *plVar1;
   uint uVar2;
   uint uVar3;
...
/* NavMap::remove_agent_as_controlled(NavAgent*) */void NavMap::remove_agent_as_controlled(NavMap *this, NavAgent *param_1) {
   long *plVar1;
   uint uVar2;
   uint uVar3;
...
/* NavMap::set_agent_as_controlled(NavAgent*) */void NavMap::set_agent_as_controlled(NavMap *this, NavAgent *param_1) {
   uint uVar1;
   code *pcVar2;
   char cVar3;
   long *plVar4;
 ...
 while ( plVar4 + uVar1 != plVar5 );
      ...
      if (*(uint*)( this + 0xf4 ) == uVar1) {
         ...
         *(long**)( this + 0xf8 ) = plVar4;
         if (plVar4 == (long*)0x0) {
            LAB_00101544:_err_print_error("push_back", "./core/templates/local_vector.h", 0x41, "FATAL: Condition \"!data\" is true.", "Out of memory", 0, 0);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar2 = (code*)invalidInstructionException();
            ( *pcVar2 )();
...
/* NavMap::remove_agent(NavAgent*) */void NavMap::remove_agent(NavMap *this, NavAgent *param_1) {
   long *plVar1;
   uint uVar2;
   uint uVar3;
   remove_agent_as_controlled(this, param_1);
...
/* NavMap::get_random_point(unsigned int, bool) const */undefined1  [16] __thiscallNavMap::get_random_point(NavMap *this, uint param_1, bool param_2) {
   uint uVar1;
   long lVar2;
   code *pcVar3;
...
/* NavMap::_sync_iteration() */void NavMap::_sync_iteration(NavMap *this) {
   int iVar1;
...
/* NavMap::step(float) */void NavMap::step(NavMap *this, float param_1) {
 ...
 while ( plVar2 != plVar12 );
         ...
         if ((step(float)::{lambda()
         #1
         (iVar9 = __cxa_guard_acquire(&step(float)::{lambda()
         #1
         {
            _scs_create((char *)&step(float)::{lambda()
            #1
      ...
      lVar4 = step(float)::{lambda()
            #1
            if (step(float)::{lambda()
            #1
            LAB_00101c1f:local_60 = 0;
         }

         else {
        pcVar5 = *(char **)(step(float)::{lambda()
         #1
         local_60 = 0;
         if (pcVar5 == (char*)0x0) {
            plVar2 = (long*)( *(long*)( step(float)::{lambda()#1}::operator()() ) + -0x10 );
            if (*(long*)( step(float)::{lambda()#1}::operator()() ) != 0) {
               do {
                  lVar7 = *plVar2;
 ...
 while ( !bVar13 );
      ...
      LAB_00101ad6:iVar9 = *(int*)( this + 0xe0 );
      ...
      *puVar10 = &PTR_callback_001072f0;
      ...
      local_58 = (char*)0x0;
      local_50 = 0;
      WorkerThreadPool::_add_group_task(pCVar8, (_func_void_void_ptr_uint*)&local_58, (void*)0x0, (BaseTemplateUserdata*)0x0, (int)puVar10, iVar9, true, (String*)0x1);
...
pCVar8 = WorkerThreadPool::singleton;if (*(uint*)( this + 0xf0 ) != 0) {
   if (( this[0x134] != (NavMap)0x0 ) && ( this[0x135] != (NavMap)0x0 )) {
      if ((step(float)::{lambda()
      #2
      (iVar9 = __cxa_guard_acquire(&step(float)::{lambda()
      ...
      local_60 = 0;
      if (pcVar5 == (char*)0x0) {
         plVar2 = (long*)( *(long*)( step(float)::{lambda()#2}::operator()() ) + -0x10 );
         if (*(long*)( step(float)::{lambda()#2}::operator()() ) != 0) {
            do {
               lVar7 = *plVar2;
 ...
 while ( !bVar13 );
   ...
   LAB_0010197d:iVar9 = *(int*)( this + 0xf0 );
...
plVar12 = *(long**)( this + 0xf8 );plVar2 = plVar12 + *(uint*)( this + 0xf0 );do {
   lVar4 = *plVar12;
   plVar12 = plVar12 + 1;
 ...
 while ( plVar2 != plVar12 );}if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return;
}
LAB_00101cf0:/* WARNING: Subroutine does not return */__stack_chk_fail();}/* NavMap::dispatch_callbacks() */void NavMap::dispatch_callbacks(NavMap *this) {
   long lVar1;
   long lVar2;
...
/* NavMap::_update_merge_rasterizer_cell_dimensions() */void NavMap::_update_merge_rasterizer_cell_dimensions(NavMap *this) {
   float fVar1;
   float fVar2;
   fVar2 = (float)( ( ulong ) * (undefined8*)( this + 0x24 ) >> 0x20 );
   fVar1 = (float)*(undefined8*)( this + 0x14 ) * fVar2;
   *(ulong*)( this + 0x1c ) = CONCAT44(fVar2 * (float)( ( ulong ) * (undefined8*)( this + 0x14 ) >> 0x20 ), fVar1);
   *(float*)( this + 0x24 ) = fVar1;
   return;
}
/* NavMap::get_region_connections_count(NavRegion*) const */uint NavMap::get_region_connections_count(NavMap *this, NavRegion *param_1) {
   long lVar1;
   ...
   if (param_1 == (NavRegion*)0x0) {
      _err_print_error("get_region_connections_count", "modules/navigation/nav_map.cpp", 0x2a7, "Parameter \"p_region\" is null.", 0, 0);
      return 0;
   }
 ...
 while ( iVar19 == 0xb );
   if (iVar19 != 0x23) {
      ...
      if (*(uint*)( this + 0x1b0 ) <= uVar27) {
         _err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xae, (ulong)uVar27, ( ulong ) * (uint*)( this + 0x1b0 ), "p_index", "count", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
 ...
 while ( iVar19 == 0xb );
      if (iVar19 != 0x23) {
         ...
         *piVar21 = *piVar21 + 1;
         ...
         uVar27 = uVar20;
         if (( lVar25 != 0 ) && ( uVar27 = piVar21[0x39] != 0 )) {
            ...
            if (uVar26 != 0) {
               while (( (uint)uVar30 != uVar26 || ( *(NavRegion**)( *(long*)( lVar25 + lVar24 * 8 ) + 0x10 ) != param_1 ) )) {
                  uVar20 = uVar20 + 1;
                  auVar3._8_8_ = 0;
                  ...
                  if (( uVar26 == 0 ) || ( auVar4._8_8_ = 0 ),auVar4._0_8_ = (ulong)uVar26 * lVar1,auVar12._8_8_ = 0,auVar12._0_8_ = uVar29,auVar5._8_8_ = 0,auVar5._0_8_ = ( ulong )(( *(uint*)( hash_table_size_primes + (ulong)(uint)piVar21[0x38] * 4 ) + uVar23 ) - SUB164(auVar4 * auVar12, 8)) * lVar1,auVar13._8_8_ = 0,auVar13._0_8_ = uVar29,SUB164(auVar5 * auVar13, 8) < uVar20) goto LAB_00102090;
               }
;
   ...
   /* WARNING: Subroutine does not return */
   std::__throw_system_error(0x23);
   LAB_00102051:if (( uVar20 == uVar26 ) && ( uVar27 == *(uint*)( *(long*)( lVar1 + lVar25 * 8 ) + 0x10 ) )) {
   ...
   if (( uVar20 == 0 ) || ( auVar8._8_8_ = 0 ),auVar8._0_8_ = uVar20 * uVar22,auVar16._8_8_ = 0,auVar16._0_8_ = uVar29,auVar9._8_8_ = 0,auVar9._0_8_ = ( ( *(uint*)( hash_table_size_primes + (ulong)(uint)piVar21[0x2c] * 4 ) + uVar23 ) - SUB164(auVar8 * auVar16, 8) ) * uVar22,auVar17._8_8_ = 0,auVar17._0_8_ = uVar29,SUB164(auVar9 * auVar17, 8) < uVar28) goto LAB_00102090;
   goto LAB_00102051;
}
/* NavMap::get_region_connection_pathway_start(NavRegion*, int) const */undefined1  [16] __thiscallNavMap::get_region_connection_pathway_start(NavMap *this, NavRegion *param_1, int param_2) {
   long lVar1;
   long lVar2;
   undefined1 auVar3[16];
   undefined1 auVar4[16];
   ...
   if (param_1 == (NavRegion*)0x0) {
      _err_print_error("get_region_connection_pathway_start", "modules/navigation/nav_map.cpp", 0x2b7, "Parameter \"p_region\" is null.", 0, 0);
      local_44 = 0;
      local_4c = 0;
      LAB_00102472:auVar32._8_4_ = local_44;
 ...
 while ( iVar20 == 0xb );
   if (iVar20 != 0x23) {
      ...
      if (uVar21 <= uVar27) {
         uVar22 = (ulong)uVar27;
         LAB_0010250d:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xae, uVar22, (ulong)uVar21, "p_index", "count", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
      ...
      if (iVar20 != 0x23) {
         ...
         *piVar26 = *piVar26 + 1;
         ...
         if (( lVar25 != 0 ) && ( piVar26[0x39] != 0 )) {
            ...
            if (uVar27 != 0) {
               uVar30 = 0;
               while (( uVar27 != (uint)uVar31 || ( *(NavRegion**)( *(long*)( lVar25 + lVar24 * 8 ) + 0x10 ) != param_1 ) )) {
                  uVar30 = uVar30 + 1;
                  auVar4._8_8_ = 0;
                  ...
                  if (( uVar27 == 0 ) || ( auVar5._8_8_ = 0 ),auVar5._0_8_ = (ulong)uVar27 * lVar2,auVar13._8_8_ = 0,auVar13._0_8_ = uVar28,auVar6._8_8_ = 0,auVar6._0_8_ = ( ulong )(( *(uint*)( hash_table_size_primes + (ulong)(uint)piVar26[0x38] * 4 ) + uVar21 ) - SUB164(auVar5 * auVar13, 8)) * lVar2,auVar14._8_8_ = 0,auVar14._0_8_ = uVar28,SUB164(auVar6 * auVar14, 8) < uVar30) goto LAB_00102455;
               }
;
               lVar25 = *(long*)( lVar25 + (ulong)uVar21 * 8 );
               if (( lVar25 != 0 ) && ( ( lVar2 = *(long*)( piVar26 + 0x24 ) ),lVar2 != 0 && ( piVar26[0x2d] != 0 ) )) {
                  uVar27 = *(uint*)( lVar25 + 0x18 );
   ...
   /* WARNING: Subroutine does not return */
   std::__throw_system_error(0x23);
   LAB_001023ea:if (( uVar30 == uVar21 ) && ( uVar27 == *(uint*)( *(long*)( lVar2 + lVar25 * 8 ) + 0x10 ) )) {
      lVar25 = *(long*)( lVar2 + (ulong)uVar23 * 8 );
      if (lVar25 != 0) {
         uVar21 = *(uint*)( lVar25 + 0x18 );
         if (( param_2 < 0 ) || ( (int)uVar21 <= param_2 )) {
            _err_print_index_error("get_region_connection_pathway_start", "modules/navigation/nav_map.cpp", 0x2bf, (long)param_2, (long)(int)uVar21, "p_connection_id", "int(found_connections->value.size())", "", false, false);
            local_44 = 0;
            local_4c = 0;
            goto LAB_00102466;
         }
   ...
   if (( uVar21 == 0 ) || ( auVar9._8_8_ = 0 ),auVar9._0_8_ = uVar21 * uVar22,auVar17._8_8_ = 0,auVar17._0_8_ = uVar28,auVar10._8_8_ = 0,auVar10._0_8_ = ( ( *(uint*)( hash_table_size_primes + (ulong)(uint)piVar26[0x2c] * 4 ) + uVar23 ) - SUB164(auVar9 * auVar17, 8) ) * uVar22,auVar18._8_8_ = 0,auVar18._0_8_ = uVar28,SUB164(auVar10 * auVar18, 8) < uVar29) goto LAB_00102455;
   goto LAB_001023ea;
}
/* NavMap::get_region_connection_pathway_end(NavRegion*, int) const */undefined1  [16] __thiscallNavMap::get_region_connection_pathway_end(NavMap *this, NavRegion *param_1, int param_2) {
   long lVar1;
   long lVar2;
   undefined1 auVar3[16];
   undefined1 auVar4[16];
   ...
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
   if (param_1 == (NavRegion*)0x0) {
      _err_print_error("get_region_connection_pathway_end", "modules/navigation/nav_map.cpp", 0x2c8, "Parameter \"p_region\" is null.", 0, 0);
      local_44 = 0;
      local_4c = 0;
      LAB_00102922:auVar32._8_4_ = local_44;
      auVar32._0_8_ = local_4c;
      if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Subroutine does not return */
         __stack_chk_fail();
 ...
 while ( iVar20 == 0xb );
   if (iVar20 != 0x23) {
      ...
      if (uVar21 <= uVar27) {
         uVar22 = (ulong)uVar27;
         LAB_001029bd:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xae, uVar22, (ulong)uVar21, "p_index", "count", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar19 = (code*)invalidInstructionException();
         ( *pcVar19 )();
         ...
         if (( lVar25 != 0 ) && ( piVar26[0x39] != 0 )) {
            ...
            if (uVar27 != 0) {
               ...
               while (( uVar27 != (uint)uVar31 || ( *(NavRegion**)( *(long*)( lVar25 + lVar24 * 8 ) + 0x10 ) != param_1 ) )) {
                  ...
                  uVar27 = *(uint*)( *(long*)( piVar26 + 0x32 ) + lVar24 * 4 );
                  uVar21 = SUB164(auVar4 * auVar12, 8);
                  if (( uVar27 == 0 ) || ( auVar5._8_8_ = 0 ),auVar5._0_8_ = (ulong)uVar27 * lVar2,auVar13._8_8_ = 0,auVar13._0_8_ = uVar28,auVar6._8_8_ = 0,auVar6._0_8_ = ( ulong )(( *(uint*)( hash_table_size_primes + (ulong)(uint)piVar26[0x38] * 4 ) + uVar21 ) - SUB164(auVar5 * auVar13, 8)) * lVar2,auVar14._8_8_ = 0,auVar14._0_8_ = uVar28,SUB164(auVar6 * auVar14, 8) < uVar30) goto LAB_00102905;
               }
;
               lVar25 = *(long*)( lVar25 + (ulong)uVar21 * 8 );
               if (( lVar25 != 0 ) && ( ( lVar2 = *(long*)( piVar26 + 0x24 ) ),lVar2 != 0 && ( piVar26[0x2d] != 0 ) )) {
   ...
   /* WARNING: Subroutine does not return */
   std::__throw_system_error(0x23);
   LAB_0010289a:if (( uVar30 == uVar21 ) && ( uVar27 == *(uint*)( *(long*)( lVar2 + lVar25 * 8 ) + 0x10 ) )) {
      lVar25 = *(long*)( lVar2 + (ulong)uVar23 * 8 );
      if (lVar25 != 0) {
         uVar21 = *(uint*)( lVar25 + 0x18 );
         if (( param_2 < 0 ) || ( (int)uVar21 <= param_2 )) {
            _err_print_index_error("get_region_connection_pathway_end", "modules/navigation/nav_map.cpp", 0x2d0, (long)param_2, (long)(int)uVar21, "p_connection_id", "int(found_connections->value.size())", "", false, false);
            local_44 = 0;
            local_4c = 0;
            goto LAB_00102916;
         }
   ...
   uVar21 = *(uint*)( *(long*)( piVar26 + 0x26 ) + lVar25 * 4 );
   uVar23 = SUB164(auVar8 * auVar16, 8);
   if (( uVar21 == 0 ) || ( auVar9._8_8_ = 0 ),auVar9._0_8_ = uVar21 * uVar22,auVar17._8_8_ = 0,auVar17._0_8_ = uVar28,auVar10._8_8_ = 0,auVar10._0_8_ = ( ( *(uint*)( hash_table_size_primes + (ulong)(uint)piVar26[0x2c] * 4 ) + uVar23 ) - SUB164(auVar9 * auVar17, 8) ) * uVar22,auVar18._8_8_ = 0,auVar18._0_8_ = uVar28,SUB164(auVar10 * auVar18, 8) < uVar29) goto LAB_00102905;
   goto LAB_0010289a;
}
/* NavMap::add_region_sync_dirty_request(SelfList<NavRegion>*) */void NavMap::add_region_sync_dirty_request(NavMap *this, SelfList *param_1) {
   long lVar1;
   if (*(long*)param_1 != 0) {
      return;
   }
...
/* NavMap::add_link_sync_dirty_request(SelfList<NavLink>*) */void NavMap::add_link_sync_dirty_request(NavMap *this, SelfList *param_1) {
   long lVar1;
   if (*(long*)param_1 != 0) {
      return;
   }
...
/* NavMap::add_agent_sync_dirty_request(SelfList<NavAgent>*) */void NavMap::add_agent_sync_dirty_request(NavMap *this, SelfList *param_1) {
   long lVar1;
   if (*(long*)param_1 != 0) {
      return;
   }
...
/* NavMap::add_obstacle_sync_dirty_request(SelfList<NavObstacle>*) */void NavMap::add_obstacle_sync_dirty_request(NavMap *this, SelfList *param_1) {
   long lVar1;
   if (*(long*)param_1 != 0) {
      return;
   }
...
/* NavMap::remove_region_sync_dirty_request(SelfList<NavRegion>*) */void NavMap::remove_region_sync_dirty_request(NavMap *this, SelfList *param_1) {
   long lVar1;
   long lVar2;
   SelfList *pSVar3;
...
/* NavMap::remove_link_sync_dirty_request(SelfList<NavLink>*) */void NavMap::remove_link_sync_dirty_request(NavMap *this, SelfList *param_1) {
   long lVar1;
   long lVar2;
   SelfList *pSVar3;
   if (*(NavMap**)param_1 != (NavMap*)0x0) {
...
/* NavMap::remove_agent_sync_dirty_request(SelfList<NavAgent>*) */void NavMap::remove_agent_sync_dirty_request(NavMap *this, SelfList *param_1) {
   long lVar1;
   long lVar2;
   SelfList *pSVar3;
   if (*(NavMap**)param_1 != (NavMap*)0x0) {
...
/* NavMap::remove_obstacle_sync_dirty_request(SelfList<NavObstacle>*) */void NavMap::remove_obstacle_sync_dirty_request(NavMap *this, SelfList *param_1) {
   long lVar1;
   long lVar2;
   SelfList *pSVar3;
   if (*(NavMap**)param_1 != (NavMap*)0x0) {
...
/* NavMap::_sync_dirty_map_update_requests() */void NavMap::_sync_dirty_map_update_requests(NavMap *this) {
   long *plVar1;
   long *plVar2;
   long lVar3;
   ...
   if (this[0x38] == (NavMap)0x0) {
      ...
      this[0x2a0] = (NavMap)0x1;
      LAB_00102ffa:if (lVar3 == 0) goto LAB_00103008;
   }
...
;
   LAB_00103008:lVar3 = *(long*)( this + 0x170 );
   if (lVar3 != 0) {
      do {
         NavLink::sync();
         lVar3 = *(long*)( lVar3 + 0x10 );
...
/* NavMap::_sync_dirty_avoidance_update_requests() */void NavMap::_sync_dirty_avoidance_update_requests(NavMap *this) {
   long *plVar1;
   long *plVar2;
   long lVar3;
...
/* NavMap::set_use_async_iterations(bool) */void NavMap::set_use_async_iterations(NavMap *this, bool param_1) {
...
/* NavMap::get_use_async_iterations() const */NavMap NavMap::get_use_async_iterations(NavMap *this) {
   return this[0x1a4];
}
/* NavMap::_update_rvo_obstacles_tree_2d() */void NavMap::_update_rvo_obstacles_tree_2d(NavMap *this) {
   ulong uVar1;
   long *plVar2;
   float *pfVar3;
   undefined4 uVar4;
 ...
 while ( uVar19 < ( ulong )(*(long*)( this + 0x98 ) - lVar20 >> 3) );
   ...
   LAB_00103428:if (uVar21 >> 0x3c != 0) {
      LAB_001039ea:/* WARNING: Subroutine does not return */std::__throw_length_error("vector::reserve");
   }
   ...
   do {
      plVar13 = *(long**)( this + 0x120 );
      uVar19 = ( ulong ) * (uint*)( this + 0x118 );
      LAB_00103466:local_70 = (vector<RVO2D::Obstacle2D*,std::allocator<RVO2D::Obstacle2D*>>*)( this + 0x90 );
      plVar2 = plVar13 + uVar19;
      __dest = unaff_R12;
      for (; pfVar23 = __dest,plVar13 != plVar2; plVar13 = plVar13 + 1) {
         while (true) {
            lVar20 = *plVar13;
            if (( *(long*)( lVar20 + 0x38 ) == 0 ) || ( unaff_R13 = *(float**)( *(long*)( lVar20 + 0x38 ) + -8 ) ),(long)unaff_R13 < 2) break;
            ...
            local_48 = unaff_R13;
            if (( pfVar22 != (float*)0x0 ) && ( pfVar3 = pfVar22 != pfVar3 )) {
               do {
                  while (true) {
                     if (( pfVar22[1] != 0.0 ) && ( _update_rvo_obstacles_tree_2d() )) {
                        _err_print_error("_update_rvo_obstacles_tree_2d", "modules/navigation/nav_map.cpp", 0x21c, "Y coordinates of static obstacle vertices are ignored. Please use obstacle position Y to change elevation of obstacle.", 0, 1);
                        _update_rvo_obstacles_tree_2d()::first_print =
                        '\0';
                     }

                     local_60 = (Obstacle2D*)CONCAT44(*(float*)( lVar20 + 0x2c ) + pfVar22[2], *(float*)( lVar20 + 0x24 ) + *pfVar22);
                     if (__dest != unaff_R13) break;
                     pfVar22 = pfVar22 + 3;
                     std::vector<RVO2D::Vector2,std::allocator<RVO2D::Vector2>>::_M_realloc_insert<RVO2D::Vector2>((vector<RVO2D::Vector2,std::allocator<RVO2D::Vector2>>*)local_58, __dest, &local_60);
...
;
 ...
 while ( pfVar3 != pfVar22 );
               LAB_001035b0:__dest = (float*)local_58._0_8_;
                  ...
                  do {
                     while (true) {
                        ...
                        *(ulong*)( this_00 + 0x28 ) = CONCAT44(uVar5, uVar4);
                        ...
                        fVar27 = (float)( ( ulong ) * (undefined8*)pfVar23 >> 0x20 ) - (float)( (ulong)uVar6 >> 0x20 );
                        ...
                        *(ulong*)( this_00 + 0x20 ) = CONCAT44(fVar25 * fVar27, fVar25 * fVar26);
                        if (lVar16 != 0x10) {
                           ...
                           OVar24 = ( Obstacle2D )(0.0 <= ( *(float*)( (undefined8)__dest + uVar1 * 2 + -1 ) - fVar25 ) * ( fVar26 - *pfVar23 ) - ( *(float*)( (undefined8)__dest + uVar1 * 2 + -2 ) - fVar26 ) * ( fVar25 - pfVar23[1] ));
                        }
                        ...
                        *(long*)( this_00 + 0x38 ) = (long)puVar14 - lVar11 >> 3;
                        ...
                        std::vector<RVO2D::Obstacle2D*,std::allocator<RVO2D::Obstacle2D*>>::_M_realloc_insert<RVO2D::Obstacle2D*const&>(local_70, puVar14, &local_60);
...
;
 ...
 while ( uVar1 < uVar19 );
            ...
            LAB_00103800:plVar13 = plVar13 + 1;
...
;
      ...
      LAB_00103820:uVar21 = *(long*)( this + 0x98 ) - *(long*)( this + 0x90 );
      local_48 = (float*)0x0;
      ...
      if (uVar21 < 0x7ffffffffffffff9) {
         ...
         LAB_001038ae:local_58._8_8_ = (long)puVar14 + __n;
      ...
      LAB_001039cd:uVar19 = *(long*)( this + 0xa0 ) - (long)unaff_R13;
      LAB_00103997:operator_delete(unaff_R13, uVar19);
      LAB_00103954:*(float**)( this + 0x90 ) = __dest;
...
/* NavMap::_update_rvo_agents_tree_2d() */void NavMap::_update_rvo_agents_tree_2d(NavMap *this) {
   long *plVar1;
   long lVar2;
   long *plVar3;
   long *__src;
   ...
   if (uVar4 == 0) {
      ...
      __src = (long*)0x0;
      LAB_00103a46:local_48._0_8_ = (long*)0x0;
      local_38 = 0;
      LAB_00103a5b:local_48._8_8_ = local_38;
      ...
      LAB_00103bef:uVar4 = (long)local_58 - (long)__src;
   }
 else {
      ...
      plStack_60 = local_68;
      if (plVar1 == plVar3) {
         LAB_00103c27:uVar6 = *(undefined8*)( this + 0x88 );
         goto LAB_00103a46;
      }
      ...
      while (true) {
         ...
         if (local_58 == plStack_60) {
            std::vector<RVO2D::Agent2D*,std::allocator<RVO2D::Agent2D*>>::_M_realloc_insert<RVO2D::Agent2D*>((vector<RVO2D::Agent2D*,std::allocator<RVO2D::Agent2D*>>*)&local_68, plStack_60, local_48);
            plVar5 = plStack_60;
            __src = local_68;
         }
 else {
...
;
      ...
      LAB_00103bbb:local_48._8_8_ = lVar2;
      RVO2D::KdTree2D::buildAgentTree(uVar6, local_48);
   ...
   LAB_00103c48:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* NavMap::_update_rvo_agents_tree_3d() */void NavMap::_update_rvo_agents_tree_3d(NavMap *this) {
   long *plVar1;
   long lVar2;
   long *plVar3;
   long *__src;
   ...
   if (uVar4 == 0) {
      ...
      __src = (long*)0x0;
      LAB_00103c96:local_48._0_8_ = (long*)0x0;
      local_38 = 0;
      LAB_00103cab:local_48._8_8_ = local_38;
      ...
      LAB_00103e47:uVar4 = (long)local_58 - (long)__src;
   }
 else {
      local_68 = (long*)operator_new(uVar4 * 8);
      local_58 = local_68 + uVar4;
      ...
      plStack_60 = local_68;
      if (plVar1 == plVar3) {
         LAB_00103e77:uVar6 = *(undefined8*)( this + 0xb8 );
         goto LAB_00103c96;
      }
      ...
      while (true) {
         ...
         if (local_58 == plStack_60) {
            std::vector<RVO3D::Agent3D*,std::allocator<RVO3D::Agent3D*>>::_M_realloc_insert<RVO3D::Agent3D*>((vector<RVO3D::Agent3D*,std::allocator<RVO3D::Agent3D*>>*)&local_68, plStack_60, local_48);
            plVar5 = plStack_60;
            __src = local_68;
         }
 else {
...
;
      ...
      memmove((void*)local_48._0_8_, __src, uVar4);
      LAB_00103e13:local_48._8_8_ = lVar2;
      RVO3D::KdTree3D::buildAgentTree(uVar6, local_48);
      uVar4 = (long)local_58 - (long)__src;
      if ((void*)local_48._0_8_ != (void*)0x0) {
         operator_delete((void*)local_48._0_8_, local_38 - local_48._0_8_);
   ...
   LAB_00103e98:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* NavMap::_update_rvo_simulation() */void NavMap::_update_rvo_simulation(NavMap *this) {
   NavMap NVar1;
   if (this[0x128] == (NavMap)0x0) {
      NVar1 = this[0x100];
   }
...
/* NavMap::_sync_avoidance() */void NavMap::_sync_avoidance(NavMap *this) {
...
/* NavMap::~NavMap() */void NavMap::~NavMap(NavMap *this) {
   uint uVar1;
   long lVar2;
   void *pvVar3;
 ...
 while ( (ulong)uVar1 << 2 != lVar2 );
   ...
   LAB_00104029:pvVar3 = *(void**)( this + 0x1b8 );
   if (pvVar3 != (void*)0x0) {
      if (*(int*)( this + 0x1b0 ) != 0) {
         lVar2 = 0;
         while (true) {
...
;
   ...
   LAB_0010408e:if (*(void**)( this + 0x120 ) != (void*)0x0) {
      if (*(int*)( this + 0x118 ) != 0) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* NavMap::NavMap() */void NavMap::NavMap(NavMap *this) {
   code *pcVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   undefined4 uVar4;
   ...
   *(undefined4*)( this + 0x28 ) = 0x3f800000;
   this[0x38] = (NavMap)0x1;
   for (int i = 0; i < 4; i++) {
      *(undefined8*)( this + ( 8*i + 64 ) ) = 0;
   }

   for (int i = 0; i < 4; i++) {
      *(undefined4*)( this + ( 4*i + 24 ) ) = uVar4;
   }
   ...
   *(undefined1(*) [16])( this + 0x278 ) = (undefined1[16])0x0;
   ...
   StringName::StringName((StringName*)&local_60, "navigation/avoidance/thread_model/avoidance_use_multiple_threads", false);
   ...
   ProjectSettings::get_singleton();
   StringName::StringName((StringName*)&local_60, "navigation/avoidance/thread_model/avoidance_use_high_priority_threads", false);
   ProjectSettings::get_setting_with_override((StringName*)local_58);
   NVar6 = (NavMap)Variant::operator_cast_to_bool((Variant*)local_58);
   this[0x136] = NVar6;
   if (Variant::needs_deinit[local_58[0]] != '\0') {
...
;
   ...
   *(undefined4*)( this + 0x1b0 ) = 2;
   LAB_0010465a:lVar15 = (long)pvVar10 + 0x148;
   while (true) {
      LocalVector<NavMeshQueries3D::PathQuerySlot,unsigned_int,false,false>::resize((LocalVector<NavMeshQueries3D::PathQuerySlot,unsigned_int,false,false>*)( lVar15 + -0x60 ), *(uint*)( this + 0x1a0 ));
 ...
 while ( iVar7 != iVar8 );
      ...
      if ((long)pvVar10 + 0x300 == lVar13) {
         ProjectSettings::get_singleton();
         StringName::StringName((StringName*)&local_60, "navigation/world/map_use_async_iterations", false);
         ProjectSettings::get_setting_with_override((StringName*)local_58);
         NVar6 = (NavMap)Variant::operator_cast_to_bool((Variant*)local_58);
         this[0x1a4] = NVar6;
         if (Variant::needs_deinit[local_58[0]] != '\0') {
...
/* NavMap::_build_iteration() [clone .part.0] */void NavMap::_build_iteration(NavMap *this) {
   long *plVar1;
   undefined8 *puVar2;
   NavMap NVar3;
 ...
 while ( iVar9 == 0xb );
   ...
   if (*(uint*)( this + 0x1b0 ) <= uVar10) {
      LAB_00104e6c:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, uVar17, uVar20, "p_index", "count", "", false, true);
      _err_flush_stdout();
      /* WARNING: Does not return */
   ...
   if (piVar21[0x18] != 0) {
      ...
      do {
         ...
         if (*(long*)( lVar24 + 0x68 ) != 0) {
            LocalVector<gd::Polygon,unsigned_int,false,false>::resize((LocalVector<gd::Polygon,unsigned_int,false,false>*)( lVar24 + 0x60 ), 0);
         ...
         if (uVar22 < uVar10) {
            ...
            do {
               ...
               *(undefined8*)( puVar15 + 0x18 ) = 0;
               for (int i = 0; i < 3; i++) {
                  *(undefined8*)( puVar15 + ( 3*i + 26 ) ) = 0;
                  puVar15[( 3*i + 28 )] = 0;
               }

               puVar15 = puVar13;
            }
 while ( (undefined4*)( lVar19 + 0x90 + ( ( ulong )(( uVar10 - uVar22 ) - 1) + (ulong)uVar22 ) * 0x90 ) != puVar13 );
         }
      ...
      LAB_00104ec1:if (uVar22 < uVar18) {
         ...
         if ((uint)piVar21[0x1d] < uVar18) {
            ...
            *(long*)( piVar21 + 0x1e ) = lVar19;
            if (lVar19 == 0) {
               LAB_0010534d:_err_print_error("resize", "./core/templates/local_vector.h", 0xa3, "FATAL: Condition \"!data\" is true.", "Out of memory", 0, 0);
               _err_flush_stdout();
               /* WARNING: Does not return */
               pcVar5 = (code*)invalidInstructionException();
               ( *pcVar5 )();
 ...
 while ( puVar13 != (undefined4*)( lVar19 + 0x58 + ( ( ulong )(uVar10 - uVar22) + (ulong)uVar22 ) * 0x58 ) );
         goto LAB_00104ddf;
      }
      ...
      do {
         ...
         if (*(long*)( lVar24 + 0x50 ) != 0) {
            LocalVector<gd::Polygon,unsigned_int,false,false>::resize((LocalVector<gd::Polygon,unsigned_int,false,false>*)( lVar24 + 0x48 ), 0);
 ...
 while ( uVar22 < (uint)piVar21[0x18] );
      LAB_00104d84:uVar22 = piVar21[0x1c];
      piVar21[0x18] = uVar10;
 ...
 while ( uVar10 < (uint)piVar21[0x1c] );
      LAB_00104ddf:piVar21[0x1c] = uVar18;
   }
   ...
   for (; puVar23 != puVar2; puVar23 = puVar23 + 1) {
      ...
      if (local_68[0xa0] != (NavRegionIteration)0x0) {
         ...
         *puVar12 = uVar10;
         ...
         uVar18 = *puVar12;
         puVar12 = (uint*)HashMap<NavRegion*,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<NavRegion*>,DefaultTypedAllocator<HashMapElement<NavRegion*,unsigned_int>>>::operator []((HashMap<NavRegion*,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<NavRegion*>,DefaultTypedAllocator<HashMapElement<NavRegion*,unsigned_int>>>*)( piVar21 + 0x2e ), (NavRegion**)&local_68);
   ...
   *(int**)( this + 0x280 ) = piVar21;
   ...
   if ((_build_iteration()::{lambda()
   #1
   ( iVar9 = __cxa_guard_acquire(&_build_iteration()::{lambda()#1}::operator()()::sname),
     iVar9 != 0) );
   {
      _scs_create((char *)&_build_iteration()::{lambda()
      #1
      __cxa_atexit(StringName::~StringName, &_build_iteration()::, {
            lambda()
            #1
            &__dso_handle;
            __cxa_guard_release(&_build_iteration()::{lambda()#1}::operator()()::sname);
  }
  lVar19 = _build_iteration()::{lambda()
            #1
            if (_build_iteration()::{lambda()
            #1
            LAB_00105244:local_70 = 0;
         }
, else {
    __s = *(NavRegionIteration **)(_build_iteration()::, {
            lambda()
            #1
            local_70 = 0;
            if (__s == (NavRegionIteration*)0x0) {
               plVar1 = (long *)(*(long *)(_build_iteration()::{lambda()
               #1
               -0x10;
               if (*(long *)(_build_iteration()::{lambda()
               #1
               goto LAB_00105244;
               do {
                  lVar24 = *plVar1;
...
, uVar14 = WorkerThreadPool::add_native_task
                     (p_Var8, _build_iteration_threaded, SUB81((NavMapIterationBuild*)( this + 0x1f8 ), 0), (String*)0x1);
      lVar19 = local_70;
      *(undefined8*)( this + 0x298 ) = uVar14;
      ...
      LAB_00104a40:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Subroutine does not return */
         __stack_chk_fail();
      }
   ...
   void NavMap::_build_iteration(NavMap *this) {
   ...
   /* NavMap::sync() */
   void NavMap::sync(NavMap *this) {
      char cVar1;
      *(undefined4*)( this + 0x140 ) = *(undefined4*)( this + 0x50 );
      *(undefined4*)( this + 0x158 ) = *(undefined4*)( this + 0x118 );
      *(ulong*)( this + 0x138 ) = CONCAT44((int)*(undefined8*)( this + 0x108 ), (int)*(undefined8*)( this + 0x40 ));
      _sync_dirty_map_update_requests(this);
      if (( this[0x2a0] == (NavMap)0x0 ) || ( this[0x2a1] != (NavMap)0x0 )) {
         LAB_00105460:if (( this[0x1a4] != (NavMap)0x0 ) && ( *(long*)( this + 0x298 ) != -1 )) goto LAB_00105476;
      }
 else {
         if (this[0x2a2] == (NavMap)0x0) {
            _build_iteration(this);
         ...
         LAB_00105476:cVar1 = WorkerThreadPool::is_task_completed(WorkerThreadPool::singleton);
         if (cVar1 != '\0') {
            WorkerThreadPool::wait_for_task_completion(WorkerThreadPool::singleton);
            *(undefined8*)( this + 0x298 ) = 0xffffffffffffffff;
      ...
      LAB_0010543c:_sync_iteration(this);
      this[0x38] = (NavMap)0x0;
      _sync_avoidance(this);
      return;
   }
   ...
   void WorkerThreadPool::GroupUserData<NavMap,void(NavMap::*)(unsigned_int, NavAgent * *),NavAgent**>::~GroupUserData(GroupUserData<NavMap,void(NavMap::*)(unsigned_int, NavAgent * *),NavAgent**> *this) {
      return;
   }

   /* WorkerThreadPool::GroupUserData<NavMap, void (NavMap::*)(unsigned int, NavAgent**),
   NavAgent**>::callback_indexed(unsigned int) */
   void WorkerThreadPool::GroupUserData<NavMap,void(NavMap::*)(unsigned_int, NavAgent * *),NavAgent**>::callback_indexed(GroupUserData<NavMap,void(NavMap::*)(unsigned_int, NavAgent * *),NavAgent**> *this, uint param_1) {
...

{
 ...
 while ( uVar55 != uVar40 );
      ...
      if (iVar43 != 0) {
         ...
         if (uVar44 != 0) {
            ...
            lVar46 = lVar45;
            do {
               if (( (uint)uVar54 == uVar44 ) && ( pNVar56 == *(NavRegion**)( *(long*)( (long)local_70 + lVar45 * 8 ) + 0x10 ) )) {
 ...
 while ( ( uVar44 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = (ulong)uVar44 * lVar3,auVar23._8_8_ = 0,auVar23._0_8_ = uVar55,auVar8._8_8_ = 0,auVar8._0_8_ = ( ulong )(( uVar53 + uVar47 ) - SUB164(auVar7 * auVar23, 8)) * lVar3,auVar24._8_8_ = 0,auVar24._0_8_ = uVar55,lVar46 = SUB168(auVar8 * auVar24, 8),uVar50 <= SUB164(auVar8 * auVar24, 8) );
         ...
         LAB_001060f3:uVar51 = CONCAT44(0, *(uint*)( hash_table_size_primes + uVar40 * 4 ));
         lVar3 = *(long*)( hash_table_size_primes_inv + uVar40 * 8 );
         uVar39 = (long)pNVar56 * 0x3ffff - 1;
         uVar39 = ( uVar39 ^ uVar39 >> 0x1f ) * 0x15;
         uVar39 = ( uVar39 ^ uVar39 >> 0xb ) * 0x41;
         ...
         if (uVar47 != 0) {
            ...
            lVar46 = lVar45;
            do {
               if (( (uint)uVar54 == uVar47 ) && ( *(NavRegion**)( *(long*)( (long)local_70 + lVar45 * 8 ) + 0x10 ) == pNVar56 )) {
 ...
 while ( ( uVar47 != 0 ) && ( auVar19._8_8_ = 0 ),auVar19._0_8_ = (ulong)uVar47 * lVar3,auVar35._8_8_ = 0,auVar35._0_8_ = uVar51,auVar20._8_8_ = 0,auVar20._0_8_ = ( ulong )(( *(uint*)( hash_table_size_primes + uVar40 * 4 ) + uVar44 ) - SUB164(auVar19 * auVar35, 8)) * lVar3,auVar36._8_8_ = 0,auVar36._0_8_ = uVar51,lVar46 = SUB168(auVar20 * auVar36, 8),uVar53 <= SUB164(auVar20 * auVar36, 8) );
   ...
   LAB_00105d4b:if ((float)uVar55 * __LC33 < (float)( iVar43 + 1 )) {
...
;
   ...
   *puVar1 = uVar53;
   *(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;
   LAB_001060d4:auVar59._8_8_ = lStack_90;
   auVar59._0_8_ = pauVar42[1] + 8;
   return auVar59;
}
/* LocalVector<NavMeshQueries3D::PathQuerySlot, unsigned int, false, false>::resize(unsigned int) */void LocalVector<NavMeshQueries3D::PathQuerySlot,unsigned_int,false,false>::resize(LocalVector<NavMeshQueries3D::PathQuerySlot,unsigned_int,false,false> *this, uint param_1) {
   code *pcVar1;
   undefined8 *puVar2;
   undefined8 *puVar3;
   uint uVar4;
 ...
 while ( puVar3 != (undefined8*)( lVar6 + 0x30 + ( ( ulong )(uVar4 - uVar7) + (ulong)uVar7 ) * 0x30 ) );
   ...
   LAB_001063e7:*(uint*)this = param_1;
   return;
}
/* void std::vector<RVO2D::Obstacle2D*, std::allocator<RVO2D::Obstacle2D*>
   ...
   const&) */void std::vector<RVO2D::Obstacle2D*,std::allocator<RVO2D::Obstacle2D*>>::_M_realloc_insert<RVO2D::Obstacle2D*const&>(vector<RVO2D::Obstacle2D*,std::allocator<RVO2D::Obstacle2D*>> *this, void *param_2, undefined8 *param_3) {
   void *__dest;
   void *pvVar1;
   void *__src;
   ulong uVar2;
   ...
   if (__src == pvVar1) {
      ...
      uVar3 = uVar3 << 3;
      LAB_001065da:__dest_00 = operator_new(uVar3);
      lVar4 = uVar3 + (long)__dest_00;
   }
 else {
      uVar3 = uVar2 * 2;
      if (uVar3 < uVar2) {
         LAB_001065d0:uVar3 = 0x7ffffffffffffff8;
         goto LAB_001065da;
      }
   ...
   *(undefined8*)( (long)__dest_00 + __n ) = *param_3;
   ...
   LAB_001065ac:*(void**)this = __dest_00;
...
/* void std::vector<RVO2D::Vector2, std::allocator<RVO2D::Vector2>
   ...
   std::vector<RVO2D::Vector2, std::allocator<RVO2D::Vector2> > >, RVO2D::Vector2&&) */void std::vector<RVO2D::Vector2,std::allocator<RVO2D::Vector2>>::_M_realloc_insert<RVO2D::Vector2>(vector<RVO2D::Vector2,std::allocator<RVO2D::Vector2>> *this, void *param_2, undefined8 *param_3) {
   void *pvVar1;
   void *pvVar2;
   ulong uVar3;
   void *pvVar4;
   ...
   if (pvVar2 == pvVar1) {
      ...
      uVar6 = uVar6 << 3;
      LAB_001067ca:pvVar4 = operator_new(uVar6);
      lVar7 = uVar6 + (long)pvVar4;
      lVar5 = (long)pvVar4 + 8;
      *(undefined8*)( (long)pvVar4 + ( (long)param_2 - (long)pvVar2 ) ) = *param_3;
      if (param_2 != pvVar2) goto LAB_00106719;
      LAB_001067fe:if (param_2 != pvVar1) goto LAB_00106752;
      LAB_00106787:if (pvVar2 == (void*)0x0) goto LAB_001067a3;
   }
 else {
      uVar6 = uVar3 * 2;
      if (uVar6 < uVar3) {
         LAB_001067c0:uVar6 = 0x7ffffffffffffff8;
         goto LAB_001067ca;
      }
...
/* void std::vector<RVO2D::Agent2D*, std::allocator<RVO2D::Agent2D*>
   ...
   std::vector<RVO2D::Agent2D*, std::allocator<RVO2D::Agent2D*> > >, RVO2D::Agent2D*&&) */void std::vector<RVO2D::Agent2D*,std::allocator<RVO2D::Agent2D*>>::_M_realloc_insert<RVO2D::Agent2D*>(vector<RVO2D::Agent2D*,std::allocator<RVO2D::Agent2D*>> *this, void *param_2, undefined8 *param_3) {
   void *__dest;
   void *pvVar1;
   void *__src;
   ulong uVar2;
   ...
   if (__src == pvVar1) {
      ...
      uVar3 = uVar3 << 3;
      LAB_0010692a:__dest_00 = operator_new(uVar3);
      lVar4 = uVar3 + (long)__dest_00;
   }
 else {
      uVar3 = uVar2 * 2;
      if (uVar3 < uVar2) {
         LAB_00106920:uVar3 = 0x7ffffffffffffff8;
         goto LAB_0010692a;
      }
   ...
   *(undefined8*)( (long)__dest_00 + __n ) = *param_3;
   ...
   operator_delete(__src, *(long*)( this + 0x10 ) - (long)__src);
   LAB_001068fc:*(void**)this = __dest_00;
   *(size_t*)( this + 8 ) = (long)__dest + __n_00;
   *(long*)( this + 0x10 ) = lVar4;
   return;
}
/* void std::vector<RVO3D::Agent3D*, std::allocator<RVO3D::Agent3D*>
   ...
   std::vector<RVO3D::Agent3D*, std::allocator<RVO3D::Agent3D*> > >, RVO3D::Agent3D*&&) */void std::vector<RVO3D::Agent3D*,std::allocator<RVO3D::Agent3D*>>::_M_realloc_insert<RVO3D::Agent3D*>(vector<RVO3D::Agent3D*,std::allocator<RVO3D::Agent3D*>> *this, void *param_2, undefined8 *param_3) {
   void *__dest;
   void *pvVar1;
   void *__src;
   ulong uVar2;
   ...
   if (__src == pvVar1) {
      ...
      uVar3 = uVar3 << 3;
      LAB_00106aba:__dest_00 = operator_new(uVar3);
      lVar4 = uVar3 + (long)__dest_00;
   }
 else {
      uVar3 = uVar2 * 2;
      if (uVar3 < uVar2) {
         LAB_00106ab0:uVar3 = 0x7ffffffffffffff8;
         goto LAB_00106aba;
      }
   ...
   *(undefined8*)( (long)__dest_00 + __n ) = *param_3;
   ...
   operator_delete(__src, *(long*)( this + 0x10 ) - (long)__src);
   LAB_00106a8c:*(void**)this = __dest_00;
   *(size_t*)( this + 8 ) = (long)__dest + __n_00;
   *(long*)( this + 0x10 ) = lVar4;
   return;
}
/* LocalVector<gd::Polygon, unsigned int, false, false>::resize(unsigned int) */void LocalVector<gd::Polygon,unsigned_int,false,false>::resize(LocalVector<gd::Polygon,unsigned_int,false,false> *this, uint param_1) {
 ...
 while ( (uint)lVar9 < *(uint*)( lVar10 + 0x20 ) );
         ...
         LAB_00106c24:if (*(void**)( lVar10 + 0x18 ) != (void*)0x0) {
 ...
 while ( puVar4 != (undefined4*)( lVar6 + 0x38 + ( ( ulong )(uVar5 - uVar8) + (ulong)uVar8 ) * 0x38 ) );
   ...
   LAB_00106c56:*(uint*)this = param_1;
   return;
}
/* NavMapIteration::~NavMapIteration() */void NavMapIteration::~NavMapIteration(NavMapIteration *this) {
   int iVar1;
   uint uVar2;
   long lVar3;
   void *pvVar4;
   ...
   std::condition_variable::~condition_variable((condition_variable*)( this + 0x148 ));
   if (*(long*)( this + 0xf0 ) != 0) {
      LocalVector<NavMeshQueries3D::PathQuerySlot,unsigned_int,false,false>::resize((LocalVector<NavMeshQueries3D::PathQuerySlot,unsigned_int,false,false>*)( this + 0xe8 ), 0);
 ...
 while ( lVar3 != (ulong)uVar2 << 2 );
   ...
   LAB_00106f99:pvVar4 = *(void**)( this + 0x90 );
   if (pvVar4 != (void*)0x0) {
      if (*(int*)( this + 0xb4 ) != 0) {
 ...
 while ( (ulong)uVar2 << 2 != lVar3 );
   ...
   LAB_00107062:pvVar4 = *(void**)( this + 0x78 );
   if (pvVar4 != (void*)0x0) {
      if (*(int*)( this + 0x70 ) != 0) {
         lVar3 = 0;
         uVar2 = 0;
         do {
            if (*(long*)( (long)pvVar4 + lVar3 + 0x50 ) != 0) {
               LocalVector<gd::Polygon,unsigned_int,false,false>::resize((LocalVector<gd::Polygon,unsigned_int,false,false>*)( (long)pvVar4 + lVar3 + 0x48 ), 0);
 ...
 while ( uVar2 < *(uint*)( this + 0x70 ) );
   ...
   LAB_001070c6:pvVar4 = *(void**)( this + 0x68 );
   if (pvVar4 != (void*)0x0) {
      if (*(int*)( this + 0x60 ) != 0) {
         lVar3 = 0;
         do {
            if (*(long*)( (long)pvVar4 + lVar3 * 0x90 + 0x68 ) != 0) {
               LocalVector<gd::Polygon,unsigned_int,false,false>::resize((LocalVector<gd::Polygon,unsigned_int,false,false>*)( (long)pvVar4 + lVar3 * 0x90 + 0x60 ), 0);
 ...
 while ( (uint)lVar3 < *(uint*)( this + 0x60 ) );
   ...
   LAB_0010712b:if (*(long*)( this + 0x58 ) != 0) {
      LocalVector<gd::Polygon,unsigned_int,false,false>::resize((LocalVector<gd::Polygon,unsigned_int,false,false>*)( this + 0x50 ), 0);
      if (*(void**)( this + 0x58 ) != (void*)0x0) {
         Memory::free_static(*(void**)( this + 0x58 ), false);
         return;
      }
...
/* WARNING: Control flow encountered bad instruction data *//* NavMapIteration::~NavMapIteration() */void NavMapIteration::~NavMapIteration(NavMapIteration *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* WorkerThreadPool::GroupUserData<NavMap, void (NavMap::*)(unsigned int, NavAgent**),
   NavAgent**>::~GroupUserData() */void WorkerThreadPool::GroupUserData<NavMap,void(NavMap::*)(unsigned_int, NavAgent * *),NavAgent**>::~GroupUserData(GroupUserData<NavMap,void(NavMap::*)(unsigned_int, NavAgent * *),NavAgent**> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

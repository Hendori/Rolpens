...
/* OS_LinuxBSD::get_unique_id() const */OS_LinuxBSD * __thiscall OS_LinuxBSD::get_unique_id(OS_LinuxBSD *this){
   ...
   long local_30;
   local_30 = *(long*)( in_FS_OFFSET + 0x28 );
   if (( get_unique_id() ) && ( iVar5 = __cxa_guard_acquire(&get_unique_id(), ::machine_id) ),iVar5 != 0) {
      get_unique_id() {
         local_50 = 0;
         local_40 = 0xf;
               ...
               if (cVar4 != '\0') {
                  if (local_50[0] == 0) {
                     ...
                     if (1 < lVar9) {
                        ...
                        if (( ( *param_5 == 0 ) || ( *(uint*)( *param_5 + -8 ) < 2 ) ) || ( iVar5 = String::find((String*)&local_88, (int)param_5) ),iVar5 == -1) {
                           local_80 = 0;
                           if (local_88 != 0) {
      ...
      *(undefined8*)( param_1 + 8 ) = 0;
      ...
      do {
         while (lVar6 = ( *_FcPatternCreate_dylibloader_wrapper_fontconfig )(),lVar6 != 0) {
            ...
            uVar7 = 0x32;
            if (( ( ( ( 0x37 < in_stack_00000010 ) && ( uVar7 = 0x3f ),0x44 < in_stack_00000010 ) ) && ( uVar7 = 0x4b ),0x50 < in_stack_00000010 )) {
               uVar7 = 0x96;
            }
...
/* OS_LinuxBSD::get_video_adapter_driver_info() const */long OS_LinuxBSD::get_video_adapter_driver_info(void) {
   ...
   if (( get_video_adapter_driver_info() ) && ( iVar6 = __cxa_guard_acquire(&get_video_adapter_driver_info(), ::info) ),iVar6 != 0) {

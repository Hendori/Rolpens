/* glslang::TIntermConstantUnion::fold(glslang::TOperator, glslang::TIntermTyped const*) const */TIntermTyped * __thiscall
glslang::TIntermConstantUnion::fold(TIntermConstantUnion *this,int param_2,long *param_3){
   ...
   local_d0 = CONCAT22(*(ushort*)( pTVar34 + 10 ) & 0x7e0 | (ushort)uVar18 & 0xf800 | ( ushort )(( *(uint*)( pTVar34 + 8 ) & 0x1fffff ) >> 0x10), (undefined2)local_d0);
   ...
   if (param_2 != 0xb1) {
      if (param_2 != 0x129) {
         if (param_2 == 0xb0) {
            ...
            LAB_001006ab:puVar27 = (ulong*)0x0;
            goto LAB_001006ae;
         }
 ...
 while ( puVar26 != puVar25 + uVar58 * 2 );
            ...
            LAB_00100286:local_1c8 = (ulong*)( uVar58 * 0x10 );
            uVar23 = glslang::GetThreadPoolAllocator();
 ...
 while ( puVar26 != puVar25 + uVar58 * 2 );
            ...
            local_d0 = CONCAT22(*(ushort*)( (long)plVar35 + 10 ) & 0x7e0 | (ushort)uVar18 & 0xf800 | ( ushort )(( *(uint*)( plVar35 + 1 ) & 0x1fffff ) >> 0x10), (undefined2)local_d0);
            uVar18 = uVar19;
            goto LAB_00100286;
         }
      ...
      if (uVar18 != 0) goto LAB_00100a03;
      LAB_0010039b:puVar27 = (ulong*)0x0;
      LAB_0010039e:iVar42 = 0;
      while (true) {
         if (*(code**)( *(long*)this + 0x140 ) == TIntermTyped::getMatrixRows) {
...
;
      ...
      LAB_00101d3d:uStack_8c = 0xffffffff;
      uStack_90 = 0;
   ...
   if (*(code**)( lVar39 + 0x140 ) != TIntermTyped::getMatrixRows) {
      ...
      if (uVar18 != 0) goto LAB_00100a03;
      lVar39 = *(long*)this;
      LAB_0010054b:puVar27 = (ulong*)0x0;
      LAB_0010054e:local_1c8 = (ulong*)0x0;
      while (true) {
         if (*(code**)( lVar39 + 0x140 ) == TIntermTyped::getMatrixRows) {
            uVar18 = (byte)this[0x2a] & 0xf;
            puVar36 = local_1c8;
         ...
         while (true) {
            ...
            dVar61 = dVar61 + *(double*)( (long)(int)( uVar18 * (int)uVar58 + (int)puVar36 ) * 0x10 + puVar32[1] ) * *(double*)( uVar23 * 0x10 + puVar24[1] );
            uVar23 = uVar23 + 1;
         }
;
...
;
   ...
   LAB_00100a03:uVar58 = (ulong)(int)uVar18;
   uVar23 = glslang::GetThreadPoolAllocator();
   puVar27 = (ulong*)glslang::TPoolAllocator::allocate(uVar23);
   uVar23 = glslang::GetThreadPoolAllocator();
   if (uVar58 >> 0x3b != 0) {
...
LAB_001006ae:
   ...
   *(undefined8*)( this_01 + 0x18 ) = *(undefined8*)( this + 0x10 );
   LAB_001009c0:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* glslang::TIntermConstantUnion::fold(glslang::TOperator, glslang::TType const&) const */TIntermTyped * __thiscall
glslang::TIntermConstantUnion::fold(TIntermConstantUnion *this,uint param_2,TType *param_3){
      ...
      if (param_2 < 0x12e) {
         if (0xf0 < param_2) {
            ...
            if (( uVar20 & 0x1c000000fc00030f ) != 0) {
               switchD_00102393_caseD_132:return (TIntermTyped*)0x0;
            }
 ...
 while ( pdVar31 != pdVar24 );
               if (dVar34 < 0.0) {
                  ...
                  dVar34 = SQRT(dVar34);
                  if (param_2 != 0x111) {
                     LAB_00102503:lVar30 = *(long*)( lVar30 + 8 );
                     uVar20 = puVar26[1];
                     lVar19 = 0;
                     do {
 ...
 while ( pcVar18 != pcVar27 );
      ...
      joined_r0x001044aa:if (!bVar10) goto LAB_00102593;
   }
 else {
      if (param_2 - 0x1c4 < 2) {
         switchD_00102393_caseD_111:lVar30 = 0x10;
         uVar33 = 1;
         LAB_001023cd:uVar20 = glslang::GetThreadPoolAllocator();
         puVar26 = (ulong*)glslang::TPoolAllocator::allocate(uVar20);
         uVar20 = glslang::GetThreadPoolAllocator();
         bVar10 = false;
         goto LAB_001023ed;
      ...
      switchD_00102393_caseD_112:if (iVar13 != 0) goto LAB_001044f6;
      puVar26 = (ulong*)0x0;
      if (0x1c4 < param_2) goto LAB_00102593;
      LAB_00102794:if (0x3c < param_2 - 0xf1) {
         puVar26 = (ulong*)0x0;
         goto LAB_00102593;
      }

      LAB_0010279d:bVar10 = true;
      LAB_001026e5:uVar20 = 1L << ( (char)param_2 + 0xfU & 0x3f );
      if (( uVar20 & 0x1c000000fc00030f ) != 0) {
      ...
      LAB_00102712:if (( !bVar10 ) || ( iVar13 < 1 )) goto LAB_00102593;
   }
   ...
   do {
      ...
      switch ((long)&switchD_00102569::switchdataD_0010daac + (long)(int)( &switchD_00102569::switchdataD_0010daac )[param_2 - 8]) {
         case 0x102670:
      uVar20 = puVar26[1];
...
LAB_0010480a:
 ...
 while ( (long)iVar13 * 0x10 != lVar30 );
   LAB_00102593:uVar20 = glslang::GetThreadPoolAllocator();
   ...
   *(code**)this_00 = log2;
   *(undefined***)( this_00 + 0xb8 ) = &PTR__TConstUnionArray_0010ebd8;
...
/* glslang::TIntermediate::areAllChildConst(glslang::TIntermAggregate*) */undefined8 glslang::TIntermediate::areAllChildConst(TIntermediate *this, TIntermAggregate *param_1) {
   long *plVar1;
   long lVar2;
...
/* glslang::TIntermediate::foldConstructor(glslang::TIntermAggregate*) */TIntermAggregate * __thiscall
glslang::TIntermediate::foldConstructor(TIntermediate *this,TIntermAggregate *param_1){
   ...
   if (*(code**)( *(long*)param_1 + 0xf0 ) == TIntermTyped::getType) {
      ...
      pTVar14 = (TIntermAggregate*)( **(code**)( *(long*)param_1 + 0xf0 ) )(param_1);
   }

   if (*(code**)( *(long*)pTVar14 + 0x38 ) == TType::getBasicType) {
      uVar4 = (uint)(byte)pTVar14[8];
      if (pTVar14[8] == (TIntermAggregate)0xf) goto LAB_00104c10;
      LAB_00104a58:if (uVar4 == 0x10) goto LAB_00104c10;
      if ((byte)pTVar14[9] < 0x10) {
         uVar16 = (byte)pTVar14[9] & 0xf;
      }
 else {
         uVar16 = ( uint )((byte)pTVar14[9] >> 4) * ( (byte)pTVar14[10] & 0xf );
      }

      LAB_00104a85:if (( *(long*)( pTVar14 + 0x60 ) != 0 ) && ( lVar6 = lVar6 != 0 )) {
         LAB_00104a97:piVar5 = *(int**)( lVar6 + 8 );
         iVar3 = (int)( *(long*)( lVar6 + 0x10 ) - (long)piVar5 >> 4 );
         if (iVar3 < 1) {
            iVar15 = 1;
         }
 else {
            piVar1 = piVar5 + 4;
            iVar15 = 1;
            if (( (int)( piVar1 + ( ulong )(iVar3 - 1) * 4 ) - (int)piVar5 & 0x10U ) == 0) goto LAB_00104ae0;
            iVar15 = *piVar5;
            for (piVar5 = piVar1; piVar5 != piVar1 + ( ulong )(iVar3 - 1) * 4; piVar5 = piVar5 + 8) {
               LAB_00104ae0:iVar15 = iVar15 * *piVar5 * piVar5[4];
            }
      ...
      local_68 = &PTR__TConstUnionArray_0010ebd8;
      if (uVar16 == 0) goto LAB_00104b09;
      uVar7 = glslang::GetThreadPoolAllocator();
      puVar8 = (ulong*)glslang::TPoolAllocator::allocate(uVar7);
      uVar7 = glslang::GetThreadPoolAllocator();
      if ((ulong)(long)(int)uVar16 >> 0x3b != 0) {
         /* WARNING: Subroutine does not return */
         std::__throw_length_error("cannot create std::vector larger than max_size()");
      }
      ...
      *puVar8 = uVar7;
      ...
      puVar8[3] = ( ulong )(puVar9 + (long)(int)uVar16 * 4);
      puVar10 = puVar9;
      do {
         *puVar10 = 0;
         puVar11 = puVar10 + 4;
 ...
 while ( puVar11 != puVar9 + (long)(int)uVar16 * 4 );
      puVar8[2] = (ulong)puVar11;
      local_60 = puVar8;
   }
 else {
      iVar3 = ( **(code**)( *(long*)pTVar14 + 0x38 ) )(pTVar14);
      if (iVar3 != 0xf) {
         if (*(code**)( *(long*)pTVar14 + 0x38 ) == TType::getBasicType) {
            uVar4 = (uint)(byte)pTVar14[8];
         }
 else {
            uVar4 = ( **(code**)( *(long*)pTVar14 + 0x38 ) )(pTVar14);
         }

         goto LAB_00104a58;
      }

      LAB_00104c10:uVar16 = 0;
      puVar17 = *(undefined8**)( *(long*)( pTVar14 + 0x68 ) + 8 );
      uVar4 = 0;
      if (puVar17 != *(undefined8**)( *(long*)( pTVar14 + 0x68 ) + 0x10 )) {
         do {
            this_00 = (TType*)*puVar17;
            puVar17 = puVar17 + 4;
            iVar3 = TType::computeNumComponents(this_00);
            uVar16 = uVar4 + iVar3;
            uVar4 = uVar16;
         }
 while ( *(undefined8**)( *(long*)( pTVar14 + 0x68 ) + 0x10 ) != puVar17 );
         goto LAB_00104a85;
      }

      if (( *(long*)( pTVar14 + 0x60 ) != 0 ) && ( lVar6 = lVar6 != 0 )) goto LAB_00104a97;
      LAB_00104b09:local_68 = &PTR__TConstUnionArray_0010ebd8;
      local_60 = (ulong*)0x0;
   }

   lVar6 = *(long*)param_1;
   if (*(code**)( lVar6 + 400 ) == TIntermAggregate::getSequence) {
      pTVar14 = param_1 + 0xc0;
   }
 else {
      pTVar14 = (TIntermAggregate*)( **(code**)( lVar6 + 400 ) )(param_1);
      lVar6 = *(long*)param_1;
   }

   pcVar12 = *(code**)( lVar6 + 0xf0 );
   if (*(long*)( pTVar14 + 0x10 ) - *(long*)( pTVar14 + 8 ) == 8) {
      if (pcVar12 == TIntermTyped::getType) {
         pTVar14 = param_1 + 0x20;
      }
 else {
         pTVar14 = (TIntermAggregate*)( *pcVar12 )(param_1);
      }

      local_58 = &PTR__TConstUnionArray_0010ebd8;
      local_50 = local_60;
      cVar2 = glslang::TIntermediate::parseConstTree(this, param_1, &local_58, *(undefined4*)( param_1 + 0xb8 ), pTVar14, 1);
   }
 else {
      if (pcVar12 == TIntermTyped::getType) {
         pTVar14 = param_1 + 0x20;
      ...
      local_58 = &PTR__TConstUnionArray_0010ebd8;
      local_50 = local_60;
      cVar2 = glslang::TIntermediate::parseConstTree(this, param_1, &local_58, *(undefined4*)( param_1 + 0xb8 ), pTVar14, 0);
   }

   if (cVar2 != '\0') goto LAB_00104bd1;
   pcVar12 = (code*)**(undefined8**)param_1;
   if (pcVar12 == TIntermNode::getLoc) {
      pcVar12 = (code*)( *(undefined8**)param_1 )[0x1e];
      cVar2 = (char)param_1 + '\b';
      if (pcVar12 == TIntermTyped::getType) goto LAB_00104bb9;
      LAB_00104dc4:pTVar13 = (TSourceLoc*)( *pcVar12 )(param_1);
   }
 else {
      cVar2 = ( *pcVar12 )(param_1);
      pcVar12 = *(code**)( *(long*)param_1 + 0xf0 );
      if (pcVar12 != TIntermTyped::getType) goto LAB_00104dc4;
      LAB_00104bb9:pTVar13 = (TSourceLoc*)( param_1 + 0x20 );
   }

   param_1 = (TIntermAggregate*)glslang::TIntermediate::addConstantUnion((TConstUnionArray*)this, (TType*)&local_68, pTVar13, (bool)cVar2);
   LAB_00104bd1:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* glslang::TIntermediate::fold(glslang::TIntermAggregate*) */TIntermTyped * __thiscall
glslang::TIntermediate::fold(TIntermediate *this,TIntermAggregate *param_1){
   ...
   if (param_1 == (TIntermAggregate*)0x0) {
      ...
      if (cVar31 == '\0') goto switchD_001054b1_caseD_a1;
      ...
      if (uVar35 < 0x114) {
         if (uVar35 < 0x112) {
            if (uVar35 == 0xa0) {
               LAB_00106ca8:plVar42 = (long*)( **(code**)( *(long*)**(undefined8**)( pTVar49 + 8 ) + 0x28 ) )();
            ...
            uVar35 = uVar35 - 0xa8;
            if (0x37 < uVar35) goto switchD_001054b1_caseD_a1;
            if (( 0x3c00040800003fU >> ( (ulong)uVar35 & 0x3f ) & 1 ) != 0) goto LAB_00106ca8;
            if (uVar35 == 0x37) {
               plVar42 = (long*)( **(code**)( **(long**)( *(long*)( pTVar49 + 8 ) + 0x10 ) + 0x18 ) )();
               pcVar52 = *(code**)( *plVar42 + 0xf0 );
               if (pcVar52 == TIntermTyped::getType) goto LAB_00104f60;
               LAB_0010532c:plVar42 = (long*)( *pcVar52 )(plVar42);
            }
 else {
               if (uVar35 != 0x36) goto switchD_001054b1_caseD_a1;
               plVar42 = (long*)( **(code**)( **(long**)( *(long*)( pTVar49 + 8 ) + 8 ) + 0x18 ) )();
               pcVar52 = *(code**)( *plVar42 + 0xf0 );
               if (pcVar52 != TIntermTyped::getType) goto LAB_0010532c;
               LAB_00104f60:plVar42 = plVar42 + 4;
            }
            ...
            LAB_0010512b:local_b8 = (ulong*)0x0;
            if (uVar35 != 0) {
            ...
            uVar63 = 1;
            uVar35 = 1;
            LAB_00104feb:uVar43 = glslang::GetThreadPoolAllocator();
            local_b8 = (ulong*)glslang::TPoolAllocator::allocate(uVar43);
            uVar43 = glslang::GetThreadPoolAllocator();
            LAB_0010500a:*local_b8 = uVar43;
            for (int i = 0; i < 3; i++) {
               local_b8[( i + 1 )] = 0;
            }
         ...
         if (puVar73 == *(undefined8**)( pTVar49 + 0x10 )) {
            ...
            do {
               ...
               if (puVar78 == puVar64) {
                  ...
                  if (puVar56 == puVar78) {
                     if (0xfffffffffffffffe < uVar47) goto LAB_00106c78;
                     ...
                     lVar71 = uVar70 << 4;
                     LAB_00106c1e:puVar53 = (undefined8*)glslang::TPoolAllocator::allocate(uVar63);
                     puVar64 = (undefined8*)( lVar71 + (long)puVar53 );
                     uVar5 = *(undefined8*)( lVar75 + 0xc0 );
                     *(undefined8*)( (long)puVar73 + (long)puVar53 ) = &PTR__TConstUnionArray_0010ebd8;
                     ...
                     uVar70 = uVar47 * 2;
                     if (uVar70 < uVar47) {
                        LAB_00106c78:lVar71 = 0x7ffffffffffffff0;
                        goto LAB_00106c1e;
                     }
                     ...
                     puVar64 = (undefined8*)0x0;
                     *puVar73 = &PTR__TConstUnionArray_0010ebd8;
                     puVar73[1] = uVar5;
                  }
                  ...
                  do {
                     puVar77 = puVar30;
                     uVar5 = *puVar73;
                     *puVar77 = &PTR__TConstUnionArray_0010ebd8;
                     puVar73 = puVar73 + 2;
                     puVar77[1] = uVar5;
                     puVar30 = puVar77 + 2;
                  }
 while ( puVar77 + 2 != (undefined8*)( ( (long)puVar78 - (long)puVar56 ) + (long)puVar53 ) );
                  ...
                  puVar77 = puVar78 + 2;
                  *puVar78 = &PTR__TConstUnionArray_0010ebd8;
                  puVar78[1] = *(undefined8*)( lVar75 + 0xc0 );
               }

               LAB_00105192:puVar73 = *(undefined8**)( pTVar49 + 8 );
 ...
 while ( uVar43 < ( ulong )(*(long*)( pTVar49 + 0x10 ) - (long)puVar73 >> 3) );
          ...
          *(undefined1 (*) [12])(pauVar7[2] + 8) = auVar84;
          break;
               default:
          goto switchD_001054b1_caseD_a1;
               case 0x116:
               ...
               do {
                  ...
                  if (( ulong )(*(long*)( pTVar49 + 0x10 ) - *(long*)( pTVar49 + 8 )) < 9) {
                     ...
                     if (*(code**)( *plVar42 + 0xf0 ) == TIntermTyped::getType) {
                        ...
                        if (pcVar52 == TType::getVectorSize) goto LAB_0010541a;
                        LAB_00106bd5:uVar38 = ( *pcVar52 )();
                     }
 else {
                        plVar51 = (long*)( **(code**)( *plVar42 + 0xf0 ) )();
                        pcVar52 = *(code**)( *plVar51 + 0x60 );
                        if (pcVar52 != TType::getVectorSize) goto LAB_00106bd5;
                        LAB_0010541a:uVar38 = *(byte*)( (long)plVar51 + 9 ) & 0xf;
                     }
...
LAB_00105bc8:
              ...
              *(double *)(uVar63 + lVar75) = dVar83;
              ...
              if (*(code **)(*plVar42 + 0x170) == TIntermTyped::isFloatingDomain) {
                if (2 < (byte)((char)plVar42[5] - 1U)) goto switchD_001054b1_caseD_a1;
              }
              else {
...
LAB_001055b4:
 ...
 while ( true );
         ...
         LAB_00106500:uVar63 = glslang::GetThreadPoolAllocator();
         ...
         *(code**)pTVar49 = log2;
         *(undefined***)( (TIntermTyped*)pTVar49 + 0xb8 ) = &PTR__TConstUnionArray_0010ebd8;
         ...
         *(undefined8*)( (TIntermTyped*)pTVar49 + 0x18 ) = *(undefined8*)( pTVar62 + 0x10 );
         ...
         switchD_001054b1_caseD_a1:pTVar49 = param_1;
      }
   ...
   LAB_00106f54:/* WARNING: Subroutine does not return */__stack_chk_fail();
   LAB_00106e00:iVar65 = iVar65 + 1;
   lVar75 = lVar75 + 0x10;
   local_68 = auVar12;
   local_58 = auVar23;
   if (iVar40 == iVar65) goto LAB_00106500;
   goto LAB_0010666b;
}
...
glslang::TIntermediate::foldDereference
   ...
   if (*(code**)( *(long*)param_1 + 0xf0 ) == TIntermTyped::getType) {
      ...
      pTVar13 = (TIntermTyped*)( **(code**)( *(long*)param_1 + 0xf0 ) )(param_1);
   }

   TType::TType(local_d8, (TType*)pTVar13, param_2, false);
   bStack_c0 = bStack_c0 & 0x80 | 2;
   if (( local_d0 & 0xff ) - 0xf < 2) {
      uVar20 = 0;
      puVar18 = *(undefined8**)( local_70 + 8 );
      if (*(undefined8**)( local_70 + 0x10 ) != puVar18) {
         do {
            pTVar2 = (TType*)*puVar18;
            puVar18 = puVar18 + 4;
            iVar5 = TType::computeNumComponents(pTVar2);
            uVar20 = uVar20 + iVar5;
         }
 while ( *(undefined8**)( local_70 + 0x10 ) != puVar18 );
      }

   }
 else if (local_d0._1_1_ < 0x10) {
      uVar20 = local_d0._1_1_ & 0xf;
   }
 else {
      uVar20 = ( uint )(local_d0._1_1_ >> 4) * ( local_d0 >> 0x10 & 0xf );
   }

   if (( local_78 != 0 ) && ( lVar7 = lVar7 != 0 )) {
      piVar14 = *(int**)( lVar7 + 8 );
      iVar5 = (int)( *(long*)( lVar7 + 0x10 ) - (long)piVar14 >> 4 );
      if (iVar5 < 1) {
         iVar16 = 1;
      }
 else {
         piVar1 = piVar14 + 4;
         iVar16 = 1;
         if (( (int)( piVar1 + ( ulong )(iVar5 - 1) * 4 ) - (int)piVar14 & 0x10U ) == 0) goto LAB_001070a0;
         iVar16 = *piVar14;
         for (piVar14 = piVar1; piVar1 + ( ulong )(iVar5 - 1) * 4 != piVar14; piVar14 = piVar14 + 8) {
            LAB_001070a0:iVar16 = iVar16 * *piVar14 * piVar14[4];
         }
   ...
   if (*(code**)( lVar7 + 0xf0 ) == TIntermTyped::getType) {
      if (( ( (byte)param_1[0x2a] & 0x20 ) == 0 ) && ( ( (byte)param_1[0x2a] & 0x40 ) == 0 )) {
         LAB_001072f9:if (*(code**)( lVar7 + 0x150 ) == TIntermTyped::isArray) {
            if (*(long*)( param_1 + 0x80 ) == 0) {
               LAB_0010731f:if (*(code**)( lVar7 + 0x168 ) == TIntermTyped::isStruct) {
                  if (( byte )((char)param_1[0x28] - 0xfU) < 2) {
                     LAB_00107348:iVar5 = 0;
                     if (0 < param_2) {
                        lVar19 = 0;
                        iVar5 = 0;
                        do {
                           pTVar13 = param_1 + 0x20;
                           if (*(code**)( lVar7 + 0xf0 ) != TIntermTyped::getType) {
                              pTVar13 = (TIntermTyped*)( **(code**)( lVar7 + 0xf0 ) )(param_1);
                           }

                           plVar3 = *(long**)( *(long*)( *(long*)( pTVar13 + 0x68 ) + 8 ) + lVar19 );
                           if (*(code**)( *plVar3 + 0x38 ) == TType::getBasicType) {
                              uVar6 = ( uint ) * (byte*)( plVar3 + 1 );
                              if (*(byte*)( plVar3 + 1 ) == 0xf) goto LAB_00107570;
                              LAB_001073c6:if (uVar6 == 0x10) goto LAB_00107570;
                              if (*(byte*)( (long)plVar3 + 9 ) < 0x10) {
                                 uVar15 = *(byte*)( (long)plVar3 + 9 ) & 0xf;
                              }
 else {
                                 uVar15 = ( uint )(*(byte*)( (long)plVar3 + 9 ) >> 4) * ( *(byte*)( (long)plVar3 + 10 ) & 0xf );
                              }

                           }
 else {
                              iVar16 = ( **(code**)( *plVar3 + 0x38 ) )(plVar3);
                              if (iVar16 != 0xf) {
                                 if (*(code**)( *plVar3 + 0x38 ) == TType::getBasicType) {
                                    uVar6 = ( uint ) * (byte*)( plVar3 + 1 );
                                 }
 else {
                                    uVar6 = ( **(code**)( *plVar3 + 0x38 ) )(plVar3);
                                 }

                                 goto LAB_001073c6;
                              }

                              LAB_00107570:uVar15 = 0;
                              puVar18 = *(undefined8**)( plVar3[0xd] + 8 );
                              uVar6 = 0;
                              if (puVar18 != *(undefined8**)( plVar3[0xd] + 0x10 )) {
                                 do {
                                    pTVar2 = (TType*)*puVar18;
                                    puVar18 = puVar18 + 4;
                                    iVar16 = TType::computeNumComponents(pTVar2);
                                    uVar15 = uVar6 + iVar16;
                                    uVar6 = uVar15;
                                 }
 while ( *(undefined8**)( plVar3[0xd] + 0x10 ) != puVar18 );
                              }

                           }

                           if (( plVar3[0xc] != 0 ) && ( lVar7 = lVar7 != 0 )) {
                              piVar14 = *(int**)( lVar7 + 8 );
                              iVar16 = (int)( *(long*)( lVar7 + 0x10 ) - (long)piVar14 >> 4 );
                              if (iVar16 < 1) {
                                 iVar17 = 1;
                              }
 else {
                                 piVar1 = piVar14 + 4;
                                 iVar17 = 1;
                                 if (( (int)( piVar1 + ( ulong )(iVar16 - 1) * 4 ) - (int)piVar14 & 0x10U ) == 0) goto LAB_00107450;
                                 iVar17 = *piVar14;
                                 for (piVar14 = piVar1; piVar14 != piVar1 + ( ulong )(iVar16 - 1) * 4; piVar14 = piVar14 + 8) {
                                    LAB_00107450:iVar17 = iVar17 * *piVar14 * piVar14[4];
                                 }
 ...
 while ( lVar19 != (long)param_2 << 5 );
                  ...
                  cVar4 = ( **(code**)( lVar7 + 0x168 ) )(param_1);
                  lVar7 = *(long*)param_1;
                  if (cVar4 != '\0') goto LAB_00107348;
               }
            ...
            cVar4 = ( **(code**)( lVar7 + 0x150 ) )(param_1);
            lVar7 = *(long*)param_1;
            if (cVar4 == '\0') goto LAB_0010731f;
         }

         iVar5 = param_2 * uVar20;
         goto LAB_00107490;
      }
      ...
      iVar5 = 0;
      lVar19 = ( **(code**)( lVar7 + 0xf0 ) )(param_1);
      lVar7 = *(long*)param_1;
      if (( ( *(byte*)( lVar19 + 10 ) & 0x20 ) == 0 ) && ( ( *(byte*)( lVar19 + 10 ) & 0x40 ) == 0 )) goto LAB_001072f9;
      LAB_00107490:if (*(code**)( lVar7 + 0xf0 ) != TIntermTyped::getType) {
         local_120 = (TSourceLoc*)( **(code**)( lVar7 + 0xf0 ) )(param_1);
         lVar7 = *(long*)param_1;
         goto LAB_001070e2;
      }
   ...
   LAB_001070e2:uVar21 = (ulong)(int)uVar20;
   lVar7 = ( **(code**)( lVar7 + 0x28 ) )(param_1);
   local_e8 = &PTR__TConstUnionArray_0010ebd8;
   uVar8 = glslang::GetThreadPoolAllocator();
   puVar9 = (ulong*)glslang::TPoolAllocator::allocate(uVar8);
   uVar8 = glslang::GetThreadPoolAllocator();
   if (uVar21 >> 0x3b != 0) {
      /* WARNING: Subroutine does not return */
      std::__throw_length_error("cannot create std::vector larger than max_size()");
   ...
   *puVar9 = uVar8;
   ...
   if (uVar21 == 0) {
      ...
      puVar10 = (undefined4*)glslang::TPoolAllocator::allocate(uVar8);
      puVar9[1] = (ulong)puVar10;
      puVar9[3] = ( ulong )(puVar10 + uVar21 * 4);
      puVar11 = puVar10;
      do {
         *puVar11 = 0;
         puVar12 = puVar11 + 4;
 ...
 while ( puVar12 != puVar10 + uVar21 * 4 );
      puVar9[2] = (ulong)puVar12;
      lVar19 = (long)iVar5 * 0x10 + *(long*)( *(long*)( lVar7 + 0xc0 ) + 8 );
      lVar7 = 0;
      do {
         *(undefined8*)( (long)puVar10 + lVar7 ) = *(undefined8*)( lVar19 + lVar7 );
         *(undefined4*)( (long)puVar10 + lVar7 + 8 ) = *(undefined4*)( lVar19 + 8 + lVar7 );
         lVar7 = lVar7 + 0x10;
      }
 while ( lVar7 != (ulong)uVar20 << 4 );
   }

   local_e0 = puVar9;
   pTVar13 = (TIntermTyped*)glslang::TIntermediate::addConstantUnion((TConstUnionArray*)this, (TType*)&local_e8, local_120, SUB81(param_3, 0));
   if (pTVar13 != (TIntermTyped*)0x0) {
      param_1 = pTVar13;
      if (*(code**)( *(long*)pTVar13 + 0xe8 ) == TIntermTyped::setType) {
         *(long*)( pTVar13 + 0x30 ) = local_c8;
         *(long*)( pTVar13 + 0x38 ) = CONCAT71(uStack_bf, bStack_c0);
         *(undefined4*)( pTVar13 + 0xa0 ) = local_58;
         *(long*)( pTVar13 + 0x40 ) = local_b8;
         *(long*)( pTVar13 + 0x48 ) = lStack_b0;
         *(long*)( pTVar13 + 0x50 ) = local_a8;
         *(long*)( pTVar13 + 0x58 ) = lStack_a0;
         *(long*)( pTVar13 + 0x60 ) = local_98;
         *(long*)( pTVar13 + 0x68 ) = lStack_90;
         *(uint*)( pTVar13 + 0x28 ) = *(uint*)( pTVar13 + 0x28 ) & 0xffe00000 | local_d0 & 0x1fffff;
         *(long*)( pTVar13 + 0x70 ) = local_88;
         *(long*)( pTVar13 + 0x78 ) = lStack_80;
         *(long*)( pTVar13 + 0x80 ) = local_78;
         *(long*)( pTVar13 + 0x90 ) = local_68;
         *(long*)( pTVar13 + 0x98 ) = lStack_60;
         *(long*)( pTVar13 + 0x88 ) = local_70;
         *(long*)( pTVar13 + 0xa8 ) = local_50;
         *(long*)( pTVar13 + 0xb0 ) = lStack_48;
         *(ushort*)( pTVar13 + 0x2a ) = *(ushort*)( pTVar13 + 0x2a ) & 0xf81f | local_d0._2_2_ & 0x7e0;
      }
 else {
         ( **(code**)( *(long*)pTVar13 + 0xe8 ) )(pTVar13, local_d8);
      }
...
glslang::TIntermediate::foldSwizzle
 ...
 while ( lVar15 != (long)iVar1 * 4 );
   ...
   pTVar7 = (TIntermTyped*)glslang::TIntermediate::addConstantUnion((TConstUnionArray*)this, (TType*)&local_e8, pTVar13, SUB81(param_3, 0));
...
/* __gnu_cxx::__normal_iterator<glslang::TTypeLoc*, std::vector<glslang::TTypeLoc,
 ...
 while ( param_1 != puVar3 );
      ...
      param_1 = param_1 + 4;
      LAB_00107b01:bVar1 = glslang::TType::contains<glslang::TType::containsSampler()const::_lambda(glslang::TType_const*)_1_>(*param_1);
      if (!bVar1) {
         return param_2;
      }
...
, /* glslang::TSmallArrayVector::~TSmallArrayVector() */, void __thiscall glslang::TSmallArrayVector::~TSmallArrayVector(TSmallArrayVector *this) * this * this * (ushort*)( this + 8 ) = *(ushort*)( this + 8 ) & 0xf000 | 0x100 ;return;}/* glslang::TType::hiddenMember() const */bool glslang::TType::hiddenMember(TType *this) {
   ...
   if (bVar1 == 0) {
      ...
      if (*(code**)( lVar4 + 0x128 ) == isStruct) {
         if (1 < ( byte )((char)this[8] - 0xfU)) {
            LAB_00108381:if (*(code**)( lVar4 + 0xe8 ) == isArray) {
               uVar3 = (uint)CONCAT71(0x107d, *(long*)( this + 0x60 ) != 0);
            }
 else {
...
/* glslang::TType::isScalarOrVector() const */uint glslang::TType::isScalarOrVector(TType *this) {
   ...
   if (*(code**)( lVar3 + 0xe8 ) == isArray) {
      uVar2 = (uint)CONCAT71(0x107d, *(long*)( this + 0x60 ) != 0);
   }
 else {
...
/* glslang::TType::isScalarOrVec1() const */byte glslang::TType::isScalarOrVec1(TType *this) {
   ...
   if (pcVar2 == isScalar) {
      ...
      if (pcVar2 == isVector) {
         ...
         if (1 < ( (byte)this[9] & 0xf )) goto LAB_00108693;
      }
 else {
         bVar3 = ( *pcVar2 )();
      }
      ...
      if (bVar3 == 0) {
         ...
         if (*(code**)( lVar5 + 0xe0 ) == isMatrix) {
            if ((byte)this[9] < 0x10) {
               LAB_001086bc:if (*(code**)( lVar5 + 0x128 ) == isStruct) {
                  if (1 < ( byte )((char)this[8] - 0xfU)) {
                     LAB_001086db:if (*(code**)( lVar5 + 0xe8 ) == isArray) {
                        if (*(long*)( this + 0x60 ) == 0) {
                           return 1;
                        }
   ...
   TVar1 = this[10];
   LAB_00108693:return (byte)TVar1 >> 4 & 1;
}
   ...
   if (0 < lVar5 >> 7) {
      ...
      do {
         ...
         if (*(code**)( *plVar2 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )(bVar1 - 0xf) < 2) {
               LAB_001089fd:lVar5 = *(long*)( plVar2[0xd] + 0x10 );
            ...
            if (cVar3 != '\0') goto LAB_001089fd;
         }

         plVar2 = (long*)param_1[4];
         bVar1 = *(byte*)( plVar2 + 1 );
         if (( bVar1 < 0xd ) || ( bVar1 == 0x12 )) goto LAB_001088ff;
         if (*(code**)( *plVar2 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )(bVar1 - 0xf) < 2) {
               LAB_00108a3d:lVar5 = *(long*)( plVar2[0xd] + 0x10 );
               lVar4 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsNonOpaque()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsNonOpaque ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar2[0xd] + 8 ),lVar5 ));
               if (lVar5 != lVar4) {
                  LAB_001088ff:return param_1 + 4;
               }
         ...
         bVar1 = *(byte*)( plVar2 + 1 );
         if (( bVar1 < 0xd ) || ( bVar1 == 0x12 )) goto LAB_0010893f;
         if (*(code**)( *plVar2 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )(bVar1 - 0xf) < 2) {
               LAB_00108a6d:lVar5 = *(long*)( plVar2[0xd] + 0x10 );
               lVar4 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsNonOpaque()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsNonOpaque ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar2[0xd] + 8 ),lVar5 ));
               if (lVar5 != lVar4) {
                  LAB_0010893f:return param_1 + 8;
               }
            ...
            cVar3 = ( **(code**)( *plVar2 + 0x128 ) )(plVar2);
            if (cVar3 != '\0') goto LAB_00108a6d;
         }

         plVar2 = (long*)param_1[0xc];
         bVar1 = *(byte*)( plVar2 + 1 );
         if (( bVar1 < 0xd ) || ( bVar1 == 0x12 )) goto LAB_0010897f;
         if (*(code**)( *plVar2 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )(bVar1 - 0xf) < 2) {
               LAB_00108a9d:lVar5 = *(long*)( plVar2[0xd] + 0x10 );
               lVar4 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsNonOpaque()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsNonOpaque ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar2[0xd] + 8 ),lVar5 ));
               if (lVar5 != lVar4) {
                  LAB_0010897f:return param_1 + 0xc;
               }
 ...
 while ( param_1 != plVar6 );
   ...
   if (lVar5 != 2) {
      ...
      if (*(code**)( *plVar6 + 0x128 ) == glslang::TType::isStruct) {
         if (( byte )(bVar1 - 0xf) < 2) {
            LAB_00108bdb:lVar5 = *(long*)( plVar6[0xd] + 0x10 );
   ...
   if (*(code**)( *plVar6 + 0x128 ) == glslang::TType::isStruct) {
      if (( byte )(bVar1 - 0xf) < 2) {
         LAB_00108b9d:lVar5 = *(long*)( plVar6[0xd] + 0x10 );
         lVar4 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsNonOpaque()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsNonOpaque ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar6[0xd] + 8 ),lVar5 ));
         if (lVar5 != lVar4) {
            return param_1;
         }
      ...
      cVar3 = ( **(code**)( *plVar6 + 0x128 ) )(plVar6);
      if (cVar3 != '\0') goto LAB_00108b9d;
   }

   param_1 = param_1 + 4;
   LAB_00108b39:plVar6 = (long*)*param_1;
   bVar1 = *(byte*)( plVar6 + 1 );
   if (bVar1 < 0xd) {
      return param_1;
   }
...
/* glslang::TType::containsNonOpaque() const */ulong glslang::TType::containsNonOpaque(TType *this) {
   ...
   if (*(code**)( *(long*)this + 0x128 ) == isStruct) {
      if (( byte )((char)TVar1 - 0xfU) < 2) {
         LAB_00108c60:lVar2 = *(long*)( *(long*)( this + 0x68 ) + 0x10 );
...
/* __gnu_cxx::__normal_iterator<glslang::TTypeLoc*, std::vector<glslang::TTypeLoc,
      ...
      do {
         ...
         if (*(code**)( *plVar1 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )(*(byte*)( plVar1 + 1 ) - 0xf) < 2) {
               LAB_00108dcd:lVar4 = *(long*)( plVar1[0xd] + 0x10 );
            ...
            if (cVar2 != '\0') goto LAB_00108dcd;
         }

         plVar1 = (long*)param_1[4];
         if (*(byte*)( plVar1 + 1 ) == param_3) goto LAB_00108e1c;
         if (*(code**)( *plVar1 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )(*(byte*)( plVar1 + 1 ) - 0xf) < 2) {
               LAB_00108dfd:lVar4 = *(long*)( plVar1[0xd] + 0x10 );
               lVar3 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsBasicType(glslang::TBasicType)const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsBasicType (glslang::TBasicType)const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar1[0xd] + 8 ),lVar4,param_3 ));
               if (lVar4 != lVar3) {
                  LAB_00108e1c:return param_1 + 4;
               }
            ...
            cVar2 = ( **(code**)( *plVar1 + 0x128 ) )(plVar1);
            if (cVar2 != '\0') goto LAB_00108dfd;
         }

         plVar1 = (long*)param_1[8];
         if (*(byte*)( plVar1 + 1 ) == param_3) goto LAB_00108e54;
         if (*(code**)( *plVar1 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )(*(byte*)( plVar1 + 1 ) - 0xf) < 2) {
               LAB_00108e35:lVar4 = *(long*)( plVar1[0xd] + 0x10 );
               lVar3 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsBasicType(glslang::TBasicType)const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsBasicType (glslang::TBasicType)const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar1[0xd] + 8 ),lVar4,param_3 ));
               if (lVar4 != lVar3) {
                  LAB_00108e54:return param_1 + 8;
               }
            ...
            cVar2 = ( **(code**)( *plVar1 + 0x128 ) )(plVar1);
            if (cVar2 != '\0') goto LAB_00108e35;
         }

         plVar1 = (long*)param_1[0xc];
         if (*(byte*)( plVar1 + 1 ) == param_3) goto LAB_00108e8c;
         if (*(code**)( *plVar1 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )(*(byte*)( plVar1 + 1 ) - 0xf) < 2) {
               LAB_00108e6d:lVar4 = *(long*)( plVar1[0xd] + 0x10 );
               lVar3 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsBasicType(glslang::TBasicType)const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsBasicType (glslang::TBasicType)const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar1[0xd] + 8 ),lVar4,param_3 ));
               if (lVar4 != lVar3) {
                  LAB_00108e8c:return param_1 + 0xc;
               }
 ...
 while ( param_1 != plVar5 );
   ...
   if (lVar4 != 2) {
      ...
      if (*(code**)( *plVar5 + 0x128 ) == glslang::TType::isStruct) {
         if (( byte )(*(byte*)( plVar5 + 1 ) - 0xf) < 2) {
            LAB_00108fd2:lVar4 = *(long*)( plVar5[0xd] + 0x10 );
   ...
   if (*(code**)( *plVar5 + 0x128 ) == glslang::TType::isStruct) {
      if (( byte )(*(byte*)( plVar5 + 1 ) - 0xf) < 2) {
         LAB_00108f91:lVar4 = *(long*)( plVar5[0xd] + 0x10 );
         lVar3 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsBasicType(glslang::TBasicType)const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsBasicType (glslang::TBasicType)const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar5[0xd] + 8 ),lVar4,param_3 ));
         if (lVar4 != lVar3) {
            return param_1;
         }
      ...
      cVar2 = ( **(code**)( *plVar5 + 0x128 ) )(plVar5);
      if (cVar2 != '\0') goto LAB_00108f91;
   }

   param_1 = param_1 + 4;
   LAB_00108f2e:plVar5 = (long*)*param_1;
...
/* glslang::TType::containsBasicType(glslang::TBasicType) const */ulong glslang::TType::containsBasicType(TType *this, uint param_2) {
   ...
   if (*(code**)( *(long*)this + 0x128 ) == isStruct) {
      if (( byte )((char)this[8] - 0xfU) < 2) {
         LAB_00109056:lVar1 = *(long*)( *(long*)( this + 0x68 ) + 0x10 );
...
/* __gnu_cxx::__normal_iterator<glslang::TTypeLoc*, std::vector<glslang::TTypeLoc,
      ...
      do {
         ...
         if (*(code**)( lVar4 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )((char)plVar1[1] - 0xfU) < 2) {
               LAB_001092cd:lVar4 = *(long*)( plVar1[0xd] + 0x10 );
            ...
            if (cVar2 != '\0') goto LAB_001092cd;
         }

         plVar1 = (long*)param_1[4];
         lVar4 = *plVar1;
         if (*(code**)( lVar4 + 0xe8 ) == glslang::TType::isArray) {
            if (plVar1[0xc] != 0) goto LAB_00109243;
         }
 else {
            cVar2 = ( **(code**)( lVar4 + 0xe8 ) )(plVar1);
            if (cVar2 != '\0') goto LAB_00109243;
            lVar4 = *plVar1;
         }

         if (*(code**)( lVar4 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )((char)plVar1[1] - 0xfU) < 2) {
               LAB_00109225:lVar4 = *(long*)( plVar1[0xd] + 0x10 );
               lVar3 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsArray()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsArray ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar1[0xd] + 8 ),lVar4 ));
               if (lVar4 != lVar3) {
                  LAB_00109243:return param_1 + 4;
               }
            ...
            cVar2 = ( **(code**)( lVar4 + 0x128 ) )(plVar1);
            if (cVar2 != '\0') goto LAB_00109225;
         }

         plVar1 = (long*)param_1[8];
         lVar4 = *plVar1;
         if (*(code**)( lVar4 + 0xe8 ) == glslang::TType::isArray) {
            if (plVar1[0xc] != 0) goto LAB_0010927b;
         }
 else {
            cVar2 = ( **(code**)( lVar4 + 0xe8 ) )(plVar1);
            if (cVar2 != '\0') goto LAB_0010927b;
            lVar4 = *plVar1;
         }

         if (*(code**)( lVar4 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )((char)plVar1[1] - 0xfU) < 2) {
               LAB_0010925d:lVar4 = *(long*)( plVar1[0xd] + 0x10 );
               lVar3 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsArray()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsArray ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar1[0xd] + 8 ),lVar4 ));
               if (lVar4 != lVar3) {
                  LAB_0010927b:return param_1 + 8;
               }
            ...
            cVar2 = ( **(code**)( lVar4 + 0x128 ) )(plVar1);
            if (cVar2 != '\0') goto LAB_0010925d;
         }

         plVar1 = (long*)param_1[0xc];
         lVar4 = *plVar1;
         if (*(code**)( lVar4 + 0xe8 ) == glslang::TType::isArray) {
            if (plVar1[0xc] != 0) goto LAB_001092b3;
         }
 else {
            cVar2 = ( **(code**)( lVar4 + 0xe8 ) )(plVar1);
            if (cVar2 != '\0') goto LAB_001092b3;
            lVar4 = *plVar1;
         }

         if (*(code**)( lVar4 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )((char)plVar1[1] - 0xfU) < 2) {
               LAB_00109295:lVar4 = *(long*)( plVar1[0xd] + 0x10 );
               lVar3 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsArray()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsArray ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar1[0xd] + 8 ),lVar4 ));
               if (lVar4 != lVar3) {
                  LAB_001092b3:return param_1 + 0xc;
               }
 ...
 while ( param_1 != plVar5 );
   ...
   if (lVar4 != 2) {
      ...
      if (*(code**)( lVar4 + 0x128 ) == glslang::TType::isStruct) {
         if (( byte )((char)plVar5[1] - 0xfU) < 2) {
            LAB_0010953c:lVar4 = *(long*)( plVar5[0xd] + 0x10 );
   ...
   if (*(code**)( lVar4 + 0x128 ) == glslang::TType::isStruct) {
      if (( byte )((char)plVar5[1] - 0xfU) < 2) {
         LAB_001094e3:lVar4 = *(long*)( plVar5[0xd] + 0x10 );
         lVar3 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsArray()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsArray ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar5[0xd] + 8 ),lVar4 ));
         if (lVar4 != lVar3) {
            return param_1;
         }
      ...
      cVar2 = ( **(code**)( lVar4 + 0x128 ) )(plVar5);
      if (cVar2 != '\0') goto LAB_001094e3;
   }

   param_1 = param_1 + 4;
   LAB_0010939e:plVar5 = (long*)*param_1;
   lVar4 = *plVar5;
   if (*(code**)( lVar4 + 0xe8 ) == glslang::TType::isArray) {
      if (plVar5[0xc] != 0) {
         return param_1;
...
/* glslang::TType::containsArray() const */bool glslang::TType::containsArray(TType *this) {
   ...
   if (*(code**)( lVar2 + 0x128 ) == isStruct) {
      if (( byte )((char)this[8] - 0xfU) < 2) {
         LAB_001095b9:lVar2 = *(long*)( *(long*)( this + 0x68 ) + 0x10 );
...
/* __gnu_cxx::__normal_iterator<glslang::TTypeLoc*, std::vector<glslang::TTypeLoc,
   ...
   if (0 < lVar6 >> 7) {
      ...
      do {
         ...
         if (*(code**)( *plVar5 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )((char)plVar5[1] - 0xfU) < 2) {
               LAB_00109865:lVar6 = *(long*)( plVar5[0xd] + 0x10 );
         ...
         if (*(code**)( *plVar5 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )((char)plVar5[1] - 0xfU) < 2) {
               LAB_001097cd:lVar6 = *(long*)( plVar5[0xd] + 0x10 );
               lVar4 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsBuiltIn()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsBuiltIn ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar5[0xd] + 8 ),lVar6 ));
               if (lVar6 != lVar4) {
                  LAB_001097ea:return param_1 + 4;
               }
         ...
         if (pcVar1 == glslang::TType::isBuiltIn) {
            ...
            if (0x7f < *(ushort*)( plVar3 + 1 )) goto LAB_0010981a;
         }
 else {
            cVar2 = ( *pcVar1 )(plVar5);
            if (cVar2 != '\0') {
         ...
         if (*(code**)( *plVar5 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )((char)plVar5[1] - 0xfU) < 2) {
               LAB_001097fd:lVar6 = *(long*)( plVar5[0xd] + 0x10 );
               lVar4 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsBuiltIn()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsBuiltIn ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar5[0xd] + 8 ),lVar6 ));
               if (lVar6 != lVar4) {
                  LAB_0010981a:return param_1 + 8;
               }
         ...
         if (pcVar1 == glslang::TType::isBuiltIn) {
            ...
            if (0x7f < *(ushort*)( plVar3 + 1 )) goto LAB_0010984a;
         }
 else {
            cVar2 = ( *pcVar1 )(plVar5);
            if (cVar2 != '\0') {
         ...
         if (*(code**)( *plVar5 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )((char)plVar5[1] - 0xfU) < 2) {
               LAB_0010982d:lVar6 = *(long*)( plVar5[0xd] + 0x10 );
               lVar4 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsBuiltIn()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsBuiltIn ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar5[0xd] + 8 ),lVar6 ));
               if (lVar6 != lVar4) {
                  LAB_0010984a:return param_1 + 0xc;
               }
 ...
 while ( param_1 != plVar7 );
   ...
   if (lVar6 != 2) {
      ...
      if (*(code**)( *plVar7 + 0x128 ) == glslang::TType::isStruct) {
         if (( byte )((char)plVar7[1] - 0xfU) < 2) {
            LAB_00109b76:lVar6 = *(long*)( plVar7[0xd] + 0x10 );
   ...
   if (*(code**)( *plVar7 + 0x128 ) == glslang::TType::isStruct) {
      if (( byte )((char)plVar7[1] - 0xfU) < 2) {
         LAB_00109aff:lVar6 = *(long*)( plVar7[0xd] + 0x10 );
         lVar4 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsBuiltIn()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsBuiltIn ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar7[0xd] + 8 ),lVar6 ));
         if (lVar6 != lVar4) {
            return param_1;
         }
      ...
      cVar2 = ( **(code**)( *plVar7 + 0x128 ) )(plVar7);
      if (cVar2 != '\0') goto LAB_00109aff;
   }

   param_1 = param_1 + 4;
   LAB_00109978:plVar7 = (long*)*param_1;
   pcVar1 = *(code**)( *plVar7 + 0x148 );
   if (pcVar1 == glslang::TType::isBuiltIn) {
      pcVar1 = *(code**)( *plVar7 + 0x58 );
      if (pcVar1 == glslang::TType::getQualifier) {
...
/* glslang::TType::containsBuiltIn() const */bool glslang::TType::containsBuiltIn(TType *this) {
   ...
   if (*(code**)( *(long*)this + 0x128 ) == isStruct) {
      if (( byte )((char)this[8] - 0xfU) < 2) {
         LAB_00109c19:lVar2 = *(long*)( *(long*)( this + 0x68 ) + 0x10 );
...
/* __gnu_cxx::__normal_iterator<glslang::TTypeLoc*, std::vector<glslang::TTypeLoc,
   ...
   if (0 < lVar4 >> 7) {
      ...
      do {
         ...
         if (*(code**)( lVar4 + 0xe8 ) == glslang::TType::isArray) {
            lVar3 = plVar1[0xc];
            if (lVar3 != 0) {
               LAB_00109cb8:if (*(long*)( *(long*)( *(long*)( lVar3 + 8 ) + 8 ) + 8 ) != 0) {
                  return param_1;
               }
            ...
            LAB_00109ce0:lVar4 = *plVar1;
         }

         if (*(code**)( lVar4 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )((char)plVar1[1] - 0xfU) < 2) {
               LAB_00109efd:lVar4 = *(long*)( plVar1[0xd] + 0x10 );
         ...
         if (*(code**)( lVar4 + 0xe8 ) == glslang::TType::isArray) {
            lVar3 = plVar1[0xc];
            if (lVar3 != 0) {
               LAB_00109d24:if (*(long*)( *(long*)( *(long*)( lVar3 + 8 ) + 8 ) + 8 ) != 0) goto LAB_00109d33;
               goto LAB_00109d40;
            }
            ...
            LAB_00109d40:lVar4 = *plVar1;
         }

         if (*(code**)( lVar4 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )((char)plVar1[1] - 0xfU) < 2) {
               LAB_00109f2d:lVar4 = *(long*)( plVar1[0xd] + 0x10 );
               lVar3 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsSpecializationSize()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsSpecializationSize ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar1[0xd] + 8 ),lVar4 ));
               if (lVar4 != lVar3) {
                  LAB_00109d33:return param_1 + 4;
               }
         ...
         if (*(code**)( lVar4 + 0xe8 ) == glslang::TType::isArray) {
            lVar3 = plVar1[0xc];
            if (lVar3 != 0) {
               LAB_00109d84:if (*(long*)( *(long*)( *(long*)( lVar3 + 8 ) + 8 ) + 8 ) != 0) goto LAB_00109d93;
               goto LAB_00109da0;
            }
            ...
            LAB_00109da0:lVar4 = *plVar1;
         }

         if (*(code**)( lVar4 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )((char)plVar1[1] - 0xfU) < 2) {
               LAB_00109f5d:lVar4 = *(long*)( plVar1[0xd] + 0x10 );
               lVar3 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsSpecializationSize()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsSpecializationSize ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar1[0xd] + 8 ),lVar4 ));
               if (lVar4 != lVar3) {
                  LAB_00109d93:return param_1 + 8;
               }
         ...
         if (*(code**)( lVar4 + 0xe8 ) == glslang::TType::isArray) {
            lVar3 = plVar1[0xc];
            if (lVar3 != 0) {
               LAB_00109de4:if (*(long*)( *(long*)( *(long*)( lVar3 + 8 ) + 8 ) + 8 ) != 0) goto LAB_00109df3;
               goto LAB_00109e00;
            }
            ...
            LAB_00109e00:lVar4 = *plVar1;
         }

         if (*(code**)( lVar4 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )((char)plVar1[1] - 0xfU) < 2) {
               LAB_00109f8d:lVar4 = *(long*)( plVar1[0xd] + 0x10 );
               lVar3 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsSpecializationSize()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsSpecializationSize ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar1[0xd] + 8 ),lVar4 ));
               if (lVar4 != lVar3) {
                  LAB_00109df3:return param_1 + 0xc;
               }
 ...
 while ( param_1 != plVar5 );
   ...
   lVar4 = lVar4 >> 5;
   if (lVar4 == 2) {
      LAB_0010a08e:plVar5 = (long*)*param_1;
      lVar4 = *plVar5;
      if (*(code**)( lVar4 + 0xe8 ) == glslang::TType::isArray) {
         lVar3 = plVar5[0xc];
         if (lVar3 != 0) {
            LAB_0010a0ae:if (*(long*)( *(long*)( *(long*)( lVar3 + 8 ) + 8 ) + 8 ) != 0) {
               return param_1;
            }
         ...
         LAB_0010a0c1:lVar4 = *plVar5;
      }

      if (*(code**)( lVar4 + 0x128 ) == glslang::TType::isStruct) {
         if (( byte )((char)plVar5[1] - 0xfU) < 2) {
            LAB_0010a107:lVar4 = *(long*)( plVar5[0xd] + 0x10 );
      ...
      if (lVar4 == 3) {
         ...
         if (*(code**)( lVar4 + 0xe8 ) == glslang::TType::isArray) {
            lVar3 = plVar5[0xc];
            if (lVar3 != 0) {
               LAB_0010a04d:if (*(long*)( *(long*)( *(long*)( lVar3 + 8 ) + 8 ) + 8 ) != 0) {
                  return param_1;
               }
            ...
            LAB_0010a060:lVar4 = *plVar5;
         }

         if (*(code**)( lVar4 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )((char)plVar5[1] - 0xfU) < 2) {
               LAB_0010a175:lVar4 = *(long*)( plVar5[0xd] + 0x10 );
               lVar3 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsSpecializationSize()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsSpecializationSize ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar5[0xd] + 8 ),lVar4 ));
               if (lVar4 != lVar3) {
                  return param_1;
               }
   ...
   if (*(code**)( lVar4 + 0xe8 ) == glslang::TType::isArray) {
      lVar3 = plVar5[0xc];
      if (lVar3 == 0) goto LAB_00109e99;
      LAB_00109e82:if (*(long*)( *(long*)( *(long*)( lVar3 + 8 ) + 8 ) + 8 ) != 0) {
         return param_1;
      }
   ...
   lVar4 = *plVar5;
   LAB_00109e99:if (*(code**)( lVar4 + 0x128 ) == glslang::TType::isStruct) {
      if (1 < ( byte )((char)plVar5[1] - 0xfU)) {
         return param_2;
      }
...
/* glslang::TType::containsSpecializationSize() const */bool glslang::TType::containsSpecializationSize(TType *this) {
   ...
   if (*(code**)( lVar2 + 0xe8 ) == isArray) {
      ...
      if (lVar3 != 0) {
         LAB_0010a1fa:if (*(long*)( *(long*)( *(long*)( lVar3 + 8 ) + 8 ) + 8 ) != 0) {
            return true;
         }
      ...
      LAB_0010a20e:lVar2 = *(long*)this;
   }

   if (*(code**)( lVar2 + 0x128 ) == isStruct) {
      if (( byte )((char)this[8] - 0xfU) < 2) {
         LAB_0010a221:lVar2 = *(long*)( *(long*)( this + 0x68 ) + 0x10 );
...
/* __gnu_cxx::__normal_iterator<glslang::TTypeLoc*, std::vector<glslang::TTypeLoc,
   ...
   if (0 < lVar4 >> 7) {
      ...
      do {
         ...
         if (*(code**)( lVar4 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )((char)plVar1[1] - 0xfU) < 2) {
               LAB_0010a4fd:lVar4 = *(long*)( plVar1[0xd] + 0x10 );
         ...
         lVar4 = *plVar1;
         if (*(code**)( lVar4 + 0x140 ) == glslang::TType::isOpaque) {
            if (( *(byte*)( plVar1 + 1 ) < 0x15 ) && ( ( 0x1a6000UL >> ( ( ulong ) * (byte*)( plVar1 + 1 ) & 0x3f ) & 1 ) != 0 )) goto LAB_0010a320;
         }
 else {
            cVar2 = ( **(code**)( lVar4 + 0x140 ) )(plVar1);
            if (cVar2 != '\0') goto LAB_0010a320;
            lVar4 = *plVar1;
         }

         if (*(code**)( lVar4 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )((char)plVar1[1] - 0xfU) < 2) {
               LAB_0010a52d:lVar4 = *(long*)( plVar1[0xd] + 0x10 );
               lVar3 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsOpaque()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsOpaque ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar1[0xd] + 8 ),lVar4 ));
               if (lVar4 != lVar3) {
                  LAB_0010a320:return param_1 + 4;
               }
         ...
         lVar4 = *plVar1;
         if (*(code**)( lVar4 + 0x140 ) == glslang::TType::isOpaque) {
            if (( *(byte*)( plVar1 + 1 ) < 0x15 ) && ( ( 0x1a6000UL >> ( ( ulong ) * (byte*)( plVar1 + 1 ) & 0x3f ) & 1 ) != 0 )) goto LAB_0010a388;
         }
 else {
            cVar2 = ( **(code**)( lVar4 + 0x140 ) )(plVar1);
            if (cVar2 != '\0') goto LAB_0010a388;
            lVar4 = *plVar1;
         }

         if (*(code**)( lVar4 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )((char)plVar1[1] - 0xfU) < 2) {
               LAB_0010a55d:lVar4 = *(long*)( plVar1[0xd] + 0x10 );
               lVar3 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsOpaque()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsOpaque ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar1[0xd] + 8 ),lVar4 ));
               if (lVar4 != lVar3) {
                  LAB_0010a388:return param_1 + 8;
               }
            ...
            cVar2 = ( **(code**)( lVar4 + 0x128 ) )(plVar1);
            if (cVar2 != '\0') goto LAB_0010a55d;
         }

         plVar1 = (long*)param_1[0xc];
         lVar4 = *plVar1;
         if (*(code**)( lVar4 + 0x140 ) == glslang::TType::isOpaque) {
            if (( *(byte*)( plVar1 + 1 ) < 0x15 ) && ( ( 0x1a6000UL >> ( ( ulong ) * (byte*)( plVar1 + 1 ) & 0x3f ) & 1 ) != 0 )) goto LAB_0010a3f0;
         }
 else {
            cVar2 = ( **(code**)( lVar4 + 0x140 ) )(plVar1);
            if (cVar2 != '\0') goto LAB_0010a3f0;
            lVar4 = *plVar1;
         }

         if (*(code**)( lVar4 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )((char)plVar1[1] - 0xfU) < 2) {
               LAB_0010a58d:lVar4 = *(long*)( plVar1[0xd] + 0x10 );
               lVar3 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsOpaque()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsOpaque ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar1[0xd] + 8 ),lVar4 ));
               if (lVar4 != lVar3) {
                  LAB_0010a3f0:return param_1 + 0xc;
               }
 ...
 while ( param_1 != plVar5 );
   ...
   if (lVar4 != 2) {
      ...
      if (*(code**)( lVar4 + 0x128 ) == glslang::TType::isStruct) {
         if (( byte )((char)plVar5[1] - 0xfU) < 2) {
            LAB_0010a6f8:lVar4 = *(long*)( plVar5[0xd] + 0x10 );
   ...
   if (*(code**)( lVar4 + 0x128 ) == glslang::TType::isStruct) {
      if (( byte )((char)plVar5[1] - 0xfU) < 2) {
         LAB_0010a69f:lVar4 = *(long*)( plVar5[0xd] + 0x10 );
         lVar3 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsOpaque()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsOpaque ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar5[0xd] + 8 ),lVar4 ));
         if (lVar4 != lVar3) {
            return param_1;
         }
      ...
      cVar2 = ( **(code**)( lVar4 + 0x128 ) )(plVar5);
      if (cVar2 != '\0') goto LAB_0010a69f;
   }

   param_1 = param_1 + 4;
   LAB_0010a46d:plVar5 = (long*)*param_1;
   lVar4 = *plVar5;
   if (*(code**)( lVar4 + 0x140 ) == glslang::TType::isOpaque) {
      if (( *(byte*)( plVar5 + 1 ) < 0x15 ) && ( ( 0x1a6000UL >> ( ( ulong ) * (byte*)( plVar5 + 1 ) & 0x3f ) & 1 ) != 0 )) {
         return param_1;
...
/* glslang::TType::containsOpaque() const */bool glslang::TType::containsOpaque(TType *this) {
   ...
   if (*(code**)( lVar2 + 0x128 ) == isStruct) {
      if (( byte )((char)this[8] - 0xfU) < 2) {
         LAB_0010a799:lVar2 = *(long*)( *(long*)( this + 0x68 ) + 0x10 );
...
/* __gnu_cxx::__normal_iterator<glslang::TTypeLoc*, std::vector<glslang::TTypeLoc,
   ...
   if (0 < lVar4 >> 7) {
      ...
      do {
         ...
         if (*(code**)( lVar4 + 0xf8 ) == glslang::TType::isUnsizedArray) {
            ...
            lVar3 = plVar1[0xc];
            if (lVar3 != 0) {
               LAB_0010a83b:if (**(int**)( *(long*)( lVar3 + 8 ) + 8 ) == 0) {
                  return param_1;
               }
            ...
            LAB_0010a869:lVar4 = *plVar1;
         }

         if (*(code**)( lVar4 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )((char)plVar1[1] - 0xfU) < 2) {
               LAB_0010aae5:lVar4 = *(long*)( plVar1[0xd] + 0x10 );
         ...
         if (*(code**)( lVar4 + 0xf8 ) == glslang::TType::isUnsizedArray) {
            ...
            lVar3 = plVar1[0xc];
            if (lVar3 != 0) {
               LAB_0010a8b8:if (**(int**)( *(long*)( lVar3 + 8 ) + 8 ) == 0) goto LAB_0010a8c8;
               goto LAB_0010a8e1;
            }
            ...
            cVar2 = ( **(code**)( lVar4 + 0xf8 ) )(plVar1);
            if (cVar2 != '\0') goto LAB_0010a8c8;
            LAB_0010a8e1:lVar4 = *plVar1;
         }

         if (*(code**)( lVar4 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )((char)plVar1[1] - 0xfU) < 2) {
               LAB_0010ab1d:lVar4 = *(long*)( plVar1[0xd] + 0x10 );
               lVar3 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsUnsizedArray()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsUnsizedArray ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar1[0xd] + 8 ),lVar4 ));
               if (lVar4 != lVar3) {
                  LAB_0010a8c8:return param_1 + 4;
               }
         ...
         if (*(code**)( lVar4 + 0xf8 ) == glslang::TType::isUnsizedArray) {
            ...
            lVar3 = plVar1[0xc];
            if (lVar3 != 0) {
               LAB_0010a930:if (**(int**)( *(long*)( lVar3 + 8 ) + 8 ) == 0) goto LAB_0010a93e;
               goto LAB_0010a959;
            }
            ...
            cVar2 = ( **(code**)( lVar4 + 0xf8 ) )(plVar1);
            if (cVar2 != '\0') goto LAB_0010a93e;
            LAB_0010a959:lVar4 = *plVar1;
         }

         if (*(code**)( lVar4 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )((char)plVar1[1] - 0xfU) < 2) {
               LAB_0010ab4d:lVar4 = *(long*)( plVar1[0xd] + 0x10 );
               lVar3 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsUnsizedArray()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsUnsizedArray ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar1[0xd] + 8 ),lVar4 ));
               if (lVar4 != lVar3) {
                  LAB_0010a93e:return param_1 + 8;
               }
         ...
         if (*(code**)( lVar4 + 0xf8 ) == glslang::TType::isUnsizedArray) {
            ...
            lVar3 = plVar1[0xc];
            if (lVar3 != 0) {
               LAB_0010a9a8:if (**(int**)( *(long*)( lVar3 + 8 ) + 8 ) == 0) goto LAB_0010a9b6;
               goto LAB_0010a9c9;
            }
            ...
            cVar2 = ( **(code**)( lVar4 + 0xf8 ) )(plVar1);
            if (cVar2 != '\0') goto LAB_0010a9b6;
            LAB_0010a9c9:lVar4 = *plVar1;
         }

         if (*(code**)( lVar4 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )((char)plVar1[1] - 0xfU) < 2) {
               LAB_0010ab7d:lVar4 = *(long*)( plVar1[0xd] + 0x10 );
               lVar3 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsUnsizedArray()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsUnsizedArray ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar1[0xd] + 8 ),lVar4 ));
               if (lVar4 != lVar3) {
                  LAB_0010a9b6:return param_1 + 0xc;
               }
 ...
 while ( param_1 != plVar5 );
   ...
   lVar4 = lVar4 >> 5;
   if (lVar4 == 2) {
      LAB_0010ac97:plVar5 = (long*)*param_1;
      lVar4 = *plVar5;
      if (*(code**)( lVar4 + 0xf8 ) == glslang::TType::isUnsizedArray) {
         if (*(code**)( lVar4 + 0xe8 ) != glslang::TType::isArray) {
            cVar2 = ( **(code**)( lVar4 + 0xe8 ) )(plVar5);
         ...
         lVar3 = plVar5[0xc];
         if (lVar3 != 0) {
            LAB_0010accf:if (**(int**)( *(long*)( lVar3 + 8 ) + 8 ) == 0) {
               return param_1;
            }
         ...
         LAB_0010ace1:lVar4 = *plVar5;
      }

      if (*(code**)( lVar4 + 0x128 ) == glslang::TType::isStruct) {
         if (( byte )((char)plVar5[1] - 0xfU) < 2) {
            LAB_0010ad29:lVar4 = *(long*)( plVar5[0xd] + 0x10 );
      ...
      if (lVar4 == 3) {
         ...
         if (*(code**)( lVar4 + 0xf8 ) == glslang::TType::isUnsizedArray) {
            ...
            lVar3 = plVar5[0xc];
            if (lVar3 != 0) {
               LAB_0010ac55:if (**(int**)( *(long*)( lVar3 + 8 ) + 8 ) == 0) {
                  return param_1;
               }
            ...
            LAB_0010ac67:lVar4 = *plVar5;
         }

         if (*(code**)( lVar4 + 0x128 ) == glslang::TType::isStruct) {
            if (( byte )((char)plVar5[1] - 0xfU) < 2) {
               LAB_0010adba:lVar4 = *(long*)( plVar5[0xd] + 0x10 );
               lVar3 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsUnsizedArray()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsUnsizedArray ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar5[0xd] + 8 ),lVar4 ));
               if (lVar4 != lVar3) {
                  return param_1;
               }
   ...
   if (*(code**)( lVar4 + 0xf8 ) == glslang::TType::isUnsizedArray) {
      if (*(code**)( lVar4 + 0xe8 ) == glslang::TType::isArray) {
         lVar3 = plVar5[0xc];
         if (lVar3 == 0) goto LAB_0010aa7f;
      }
 else {
         cVar2 = ( **(code**)( lVar4 + 0xe8 ) )(plVar5);
         if (cVar2 == '\0') goto LAB_0010aa7b;
         lVar3 = plVar5[0xc];
      }
   ...
   LAB_0010aa7b:lVar4 = *plVar5;
   LAB_0010aa7f:if (*(code**)( lVar4 + 0x128 ) == glslang::TType::isStruct) {
      if (1 < ( byte )((char)plVar5[1] - 0xfU)) {
         return param_2;
      }
...
/* glslang::TType::containsUnsizedArray() const */bool glslang::TType::containsUnsizedArray(TType *this) {
   ...
   if (*(code**)( lVar2 + 0xf8 ) == isUnsizedArray) {
      ...
      lVar3 = *(long*)( this + 0x60 );
      if (lVar3 != 0) {
         LAB_0010ae6a:if (**(int**)( *(long*)( lVar3 + 8 ) + 8 ) == 0) {
            return true;
         }
      ...
      LAB_0010ae86:lVar2 = *(long*)this;
   }

   if (*(code**)( lVar2 + 0x128 ) == isStruct) {
      if (( byte )((char)this[8] - 0xfU) < 2) {
         LAB_0010ae99:lVar2 = *(long*)( *(long*)( this + 0x68 ) + 0x10 );
...
/* __gnu_cxx::__normal_iterator<glslang::TTypeLoc*, std::vector<glslang::TTypeLoc,
   ...
   if (0 < lVar7 >> 7) {
      ...
      LAB_0010af00:do {
         ...
         lVar5 = *plVar1;
         if (plVar1 == param_3) {
            LAB_0010af50:if (*(code**)( lVar5 + 0x128 ) == glslang::TType::isStruct) {
               if (( byte )((char)plVar1[1] - 0xfU) < 2) {
                  LAB_0010af6d:lVar5 = *(long*)( plVar1[0xd] + 0x10 );
         ...
         lVar5 = *plVar1;
         if (plVar1 == param_3) {
            LAB_0010afd0:if (*(code**)( lVar5 + 0x128 ) == glslang::TType::isStruct) {
               if (( byte )((char)plVar1[1] - 0xfU) < 2) {
                  LAB_0010afed:lVar5 = *(long*)( plVar1[0xd] + 0x10 );
                  lVar3 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsStructure()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsStructure ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar1[0xd] + 8 ),lVar5,param_3 ));
                  if (lVar5 != lVar3) {
                     LAB_0010afb6:return plVar6 + 4;
                  }
            ...
            if (*(code**)( lVar5 + 0x128 ) != glslang::TType::isStruct) {
               cVar2 = ( **(code**)( lVar5 + 0x128 ) )(plVar1);
               if (cVar2 != '\0') goto LAB_0010afb6;
               lVar5 = *plVar1;
               goto LAB_0010afd0;
            }

            if (( byte )((char)plVar1[1] - 0xfU) < 2) goto LAB_0010afb6;
         }

         plVar1 = (long*)plVar6[8];
         lVar5 = *plVar1;
         if (plVar1 == param_3) {
            LAB_0010b050:if (*(code**)( lVar5 + 0x128 ) == glslang::TType::isStruct) {
               if (( byte )((char)plVar1[1] - 0xfU) < 2) {
                  LAB_0010b06d:lVar5 = *(long*)( plVar1[0xd] + 0x10 );
                  lVar3 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsStructure()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsStructure ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar1[0xd] + 8 ),lVar5,param_3 ));
                  if (lVar5 != lVar3) {
                     LAB_0010b036:return plVar6 + 8;
                  }
            ...
            if (*(code**)( lVar5 + 0x128 ) != glslang::TType::isStruct) {
               cVar2 = ( **(code**)( lVar5 + 0x128 ) )(plVar1);
               if (cVar2 != '\0') goto LAB_0010b036;
               lVar5 = *plVar1;
               goto LAB_0010b050;
            }

            if (( byte )((char)plVar1[1] - 0xfU) < 2) goto LAB_0010b036;
         }

         plVar1 = (long*)plVar6[0xc];
         lVar5 = *plVar1;
         if (plVar1 == param_3) {
            LAB_0010b0d0:if (*(code**)( lVar5 + 0x128 ) == glslang::TType::isStruct) {
               if (1 < ( byte )((char)plVar1[1] - 0xfU)) goto LAB_0010b10a;
            }
 else {
               cVar2 = ( **(code**)( lVar5 + 0x128 ) )(plVar1);
               if (cVar2 == '\0') {
            ...
            lVar3 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsStructure()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsStructure ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar1[0xd] + 8 ),lVar5,param_3 ));
            if (lVar5 != lVar3) {
               LAB_0010b0b6:return plVar6 + 0xc;
            }
            ...
            if (*(code**)( lVar5 + 0x128 ) != glslang::TType::isStruct) {
               cVar2 = ( **(code**)( lVar5 + 0x128 ) )(plVar1);
               if (cVar2 != '\0') goto LAB_0010b0b6;
               lVar5 = *plVar1;
               goto LAB_0010b0d0;
            }

            if (( byte )((char)plVar1[1] - 0xfU) < 2) goto LAB_0010b0b6;
         }

         LAB_0010b10a:plVar1 = plVar6 + 0x10;
      }
 while ( plVar6 + 0x10 != param_1 + ( lVar7 >> 7 ) * 0x10 );
   ...
   if (lVar7 != 2) {
      ...
      if (param_3 == plVar1) {
         LAB_0010b282:if (pcVar4 == glslang::TType::isStruct) {
            cVar2 = (char)plVar1[1];
            goto LAB_0010b259;
         }

         cVar2 = ( *pcVar4 )(plVar1);
         if (cVar2 != '\0') goto LAB_0010b35b;
      }
 else {
         ...
         LAB_0010b259:if (( byte )(cVar2 - 0xfU) < 2) {
            LAB_0010b35b:lVar7 = *(long*)( plVar1[0xd] + 0x10 );
   ...
   lVar7 = *plVar1;
   if (plVar1 == param_3) {
      LAB_0010b2a4:if (*(code**)( lVar7 + 0x128 ) == glslang::TType::isStruct) {
         if (( byte )((char)plVar1[1] - 0xfU) < 2) {
            LAB_0010b2c5:lVar7 = *(long*)( plVar1[0xd] + 0x10 );
            lVar5 = __find_if<__gnu_cxx::__normal_iterator<glslang::TTypeLoc*,std::vector<glslang::TTypeLoc,glslang::pool_allocator<glslang::TTypeLoc>>>,__gnu_cxx::__ops::_Iter_pred<glslang::TType::contains<glslang::TType::containsStructure()const::_lambda(glslang::TType_const *)_1_>(glslang::TType::containsStructure ()const::_lambda(glslang::TType_const*) _1_)const::_lambda(glslang::TTypeLoc_const & _1_ >> ( *(undefined8*)( plVar1[0xd] + 8 ),lVar7,param_3 ));
            if (lVar7 != lVar5) {
               return param_1;
            }
   ...
   param_1 = param_1 + 4;
   LAB_0010b142:plVar1 = (long*)*param_1;
   lVar7 = *plVar1;
   if (plVar1 != param_3) {
      if (*(code**)( lVar7 + 0x128 ) == glslang::TType::isStruct) {
...
/* glslang::TType::containsStructure() const */bool glslang::TType::containsStructure(TType *this) {
   ...
   if (*(code**)( *(long*)this + 0x128 ) == isStruct) {
      if (( byte )((char)this[8] - 0xfU) < 2) {
         LAB_0010b3e6:lVar1 = *(long*)( *(long*)( this + 0x68 ) + 0x10 );
...
/* glslang::TType::TType(glslang::TType const&, int, bool) */void glslang::TType::TType(TType *this, TType *param_1, int param_2, bool param_3) {
   ...
   ulong uVar28;
   lVar26 = *(long*)param_1;
   *(undefined***)this = &PTR__TType_0010e9f0;
   if (*(code**)( lVar26 + 0xe8 ) == isArray) {
      lVar23 = *(long*)( param_1 + 0x60 );
      if (lVar23 != 0) {
         LAB_0010b58d:uVar9 = *(undefined4*)( param_1 + 0x80 );
         ...
         *puVar21 = &PTR__TSmallArrayVector_0010e9d0;
         puVar21[1] = 0;
...
/* glslang::TType::computeNumComponents() const */uint glslang::TType::computeNumComponents(TType *this) {
   ...
   if (plVar21 != *(long**)( *(long*)( this + 0x68 ) + 0x10 )) {
      do {
         ...
         if (*(code**)( *plVar3 + 0x38 ) == getBasicType) {
            ...
            if (*(byte*)( plVar3 + 1 ) == 0xf) goto LAB_0010ba9e;
            LAB_0010b9eb:if (uVar16 == 0x10) goto LAB_0010ba9e;
            if (*(byte*)( (long)plVar3 + 9 ) < 0x10) {
            ...
            if (plVar27 != *(long**)( plVar3[0xd] + 0x10 )) {
               do {
                  ...
                  if (*(code**)( *plVar4 + 0x38 ) == getBasicType) {
                     ...
                     if (*(byte*)( plVar4 + 1 ) == 0xf) goto LAB_0010bbad;
                     LAB_0010baef:if (uVar11 == 0x10) goto LAB_0010bbad;
                     ...
                     if (plVar22 != *(long**)( plVar4[0xd] + 0x10 )) {
                        do {
                           ...
                           if (*(code**)( *plVar5 + 0x38 ) == getBasicType) {
                              ...
                              if (*(byte*)( plVar5 + 1 ) == 0xf) goto LAB_0010bcca;
                              LAB_0010bc04:if (uVar19 == 0x10) goto LAB_0010bcca;
                              ...
                              if (plVar28 != *(long**)( plVar5[0xd] + 0x10 )) {
                                 do {
                                    ...
                                    if (*(code**)( *plVar6 + 0x38 ) == getBasicType) {
                                       ...
                                       if (*(byte*)( plVar6 + 1 ) == 0xf) goto LAB_0010bdf8;
                                       LAB_0010bd22:if (uVar12 == 0x10) goto LAB_0010bdf8;
                                       ...
                                       if (plVar25 != *(long**)( plVar6[0xd] + 0x10 )) {
                                          ...
                                          do {
                                             ...
                                             if (*(code**)( *plVar7 + 0x38 ) == getBasicType) {
                                                ...
                                                if (*(byte*)( plVar7 + 1 ) == 0xf) goto LAB_0010bf20;
                                                LAB_0010be51:if (uVar15 == 0x10) goto LAB_0010bf20;
                                                ...
                                                if (*(long**)( plVar7[0xd] + 0x10 ) != plVar29) {
                                                   do {
                                                      ...
                                                      if (*(code**)( *plVar8 + 0x38 ) == getBasicType) {
                                                         ...
                                                         if (*(byte*)( plVar8 + 1 ) == 0xf) goto LAB_0010c040;
                                                         LAB_0010bf76:if (uVar24 == 0x10) goto LAB_0010c040;
                                                         ...
                                                         if (*(long**)( plVar8[0xd] + 0x10 ) != plVar26) {
                                                            ...
                                                            do {
                                                               ...
                                                               if (*(code**)( *plVar9 + 0x38 ) == getBasicType) {
                                                                  ...
                                                                  if (*(byte*)( plVar9 + 1 ) == 0xf) goto LAB_0010c160;
                                                                  LAB_0010c096:if (uVar14 == 0x10) goto LAB_0010c160;
 ...
 while ( *(undefined8**)( plVar9[0xd] + 0x10 ) != puVar23 );
                                                               ...
                                                               if (( plVar9[0xc] != 0 ) && ( lVar2 = lVar2 != 0 )) {
                                                                  ...
                                                                  if (iVar13 < 1) {
                                                                     ...
                                                                     piVar1 = piVar17 + 4;
                                                                     iVar18 = 1;
                                                                     if (( (int)( piVar1 + ( ulong )(iVar13 - 1) * 4 ) - (int)piVar17 & 0x10U ) == 0) goto LAB_0010c112;
                                                                     iVar18 = *piVar17;
                                                                     for (piVar17 = piVar1; piVar17 != piVar1 + ( ulong )(iVar13 - 1) * 4; piVar17 = piVar17 + 8) {
                                                                        LAB_0010c112:iVar18 = iVar18 * *piVar17 * piVar17[4];
                                                                     }
 ...
 while ( *(long**)( plVar8[0xd] + 0x10 ) != plVar26 );
                                                      ...
                                                      if (( plVar8[0xc] != 0 ) && ( lVar2 = lVar2 != 0 )) {
                                                         ...
                                                         if (iVar13 < 1) {
                                                            ...
                                                            piVar1 = piVar17 + 4;
                                                            iVar18 = 1;
                                                            if (( (int)( piVar1 + ( ulong )(iVar13 - 1) * 4 ) - (int)piVar17 & 0x10U ) == 0) goto LAB_0010bff4;
                                                            iVar18 = *piVar17;
                                                            for (piVar17 = piVar1; piVar17 != piVar1 + ( ulong )(iVar13 - 1) * 4; piVar17 = piVar17 + 8) {
                                                               LAB_0010bff4:iVar18 = iVar18 * *piVar17 * piVar17[4];
                                                            }
 ...
 while ( *(long**)( plVar7[0xd] + 0x10 ) != plVar29 );
                                             ...
                                             if (( plVar7[0xc] != 0 ) && ( lVar2 = lVar2 != 0 )) {
                                                ...
                                                if (iVar13 < 1) {
                                                   ...
                                                   piVar1 = piVar17 + 4;
                                                   iVar18 = 1;
                                                   if (( (int)( piVar1 + ( ulong )(iVar13 - 1) * 4 ) - (int)piVar17 & 0x10U ) == 0) goto LAB_0010bed8;
                                                   iVar18 = *piVar17;
                                                   for (piVar17 = piVar1; piVar17 != piVar1 + ( ulong )(iVar13 - 1) * 4; piVar17 = piVar17 + 8) {
                                                      LAB_0010bed8:iVar18 = iVar18 * *piVar17 * piVar17[4];
                                                   }
 ...
 while ( *(long**)( plVar6[0xd] + 0x10 ) != plVar25 );
                                    ...
                                    if (( plVar6[0xc] != 0 ) && ( lVar2 = lVar2 != 0 )) {
                                       ...
                                       if (iVar13 < 1) {
                                          ...
                                          piVar1 = piVar17 + 4;
                                          iVar18 = 1;
                                          if (( (int)( piVar1 + ( ulong )(iVar13 - 1) * 4 ) - (int)piVar17 & 0x10U ) == 0) goto LAB_0010bdb0;
                                          iVar18 = *piVar17;
                                          for (piVar17 = piVar1; piVar17 != piVar1 + ( ulong )(iVar13 - 1) * 4; piVar17 = piVar17 + 8) {
                                             LAB_0010bdb0:iVar18 = iVar18 * *piVar17 * piVar17[4];
                                          }
 ...
 while ( *(long**)( plVar5[0xd] + 0x10 ) != plVar28 );
                           ...
                           if (( plVar5[0xc] != 0 ) && ( lVar2 = lVar2 != 0 )) {
                              ...
                              if (iVar13 < 1) {
                                 ...
                                 piVar1 = piVar17 + 4;
                                 iVar18 = 1;
                                 if (( (int)( piVar1 + ( ulong )(iVar13 - 1) * 4 ) - (int)piVar17 & 0x10U ) == 0) goto LAB_0010bc88;
                                 iVar18 = *piVar17;
                                 for (piVar17 = piVar1; piVar17 != piVar1 + ( ulong )(iVar13 - 1) * 4; piVar17 = piVar17 + 8) {
                                    LAB_0010bc88:iVar18 = iVar18 * *piVar17 * piVar17[4];
                                 }
 ...
 while ( *(long**)( plVar4[0xd] + 0x10 ) != plVar22 );
                  ...
                  if (( plVar4[0xc] != 0 ) && ( lVar2 = lVar2 != 0 )) {
                     ...
                     if (iVar13 < 1) {
                        ...
                        piVar1 = piVar17 + 4;
                        iVar18 = 1;
                        if (( (int)( piVar1 + ( ulong )(iVar13 - 1) * 4 ) - (int)piVar17 & 0x10U ) == 0) goto LAB_0010bb70;
                        iVar18 = *piVar17;
                        for (piVar17 = piVar1; piVar17 != piVar1 + ( ulong )(iVar13 - 1) * 4; piVar17 = piVar17 + 8) {
                           LAB_0010bb70:iVar18 = iVar18 * *piVar17 * piVar17[4];
                        }
 ...
 while ( *(long**)( plVar3[0xd] + 0x10 ) != plVar27 );
         ...
         if (( plVar3[0xc] != 0 ) && ( lVar2 = lVar2 != 0 )) {
            ...
            if (iVar13 < 1) {
               ...
               piVar1 = piVar17 + 4;
               iVar18 = 1;
               if (( (int)( piVar1 + ( ulong )(iVar13 - 1) * 4 ) - (int)piVar17 & 0x10U ) == 0) goto LAB_0010ba6d;
               iVar18 = *piVar17;
               for (piVar17 = piVar1; piVar17 != piVar1 + ( ulong )(iVar13 - 1) * 4; piVar17 = piVar17 + 8) {
                  LAB_0010ba6d:iVar18 = iVar18 * *piVar17 * piVar17[4];
               }
 ...
 while ( *(long**)( *(long*)( this + 0x68 ) + 0x10 ) != plVar21 );
   ...
   LAB_0010b924:if (( *(long*)( this + 0x60 ) != 0 ) && ( lVar2 = lVar2 != 0 )) {
      piVar17 = *(int**)( lVar2 + 8 );
      iVar13 = (int)( *(long*)( lVar2 + 0x10 ) - (long)piVar17 >> 4 );
      if (iVar13 < 1) {
         iVar18 = 1;
         ...
         piVar1 = piVar17 + 4;
         iVar18 = 1;
         if (( (int)( piVar1 + ( ulong )(iVar13 - 1) * 4 ) - (int)piVar17 & 0x10U ) == 0) goto LAB_0010b975;
         iVar18 = *piVar17;
         for (piVar17 = piVar1; piVar17 != piVar1 + ( ulong )(iVar13 - 1) * 4; piVar17 = piVar17 + 8) {
            LAB_0010b975:iVar18 = iVar18 * *piVar17 * piVar17[4];
         }
...
/* glslang::TConstUnion::TEMPNAMEPLACEHOLDERVALUE(glslang::TConstUnion const&) const */undefined8 glslang::TConstUnion::operator ==(TConstUnion *this, TConstUnion *param_1) {
   undefined8 uVar1;
   uVar1 = 0;
   if (*(int*)( param_1 + 8 ) == *(int*)( this + 8 )) {
      ...
      break;
         case 2:
      uVar1 = CONCAT71(0x10c5,!NAN(*(double *)param_1) && !NAN(*(double *)this));
      ...
      break;
         ...
         case 5:
         case 0xc:
      uVar1 = CONCAT71(0x10c5,*param_1 == *this);
      break;
         case 6:
         case 7:
      uVar1 = CONCAT71(0x10c5,*(short *)param_1 == *(short *)this);
      break;
         case 8:
         case 9:
      uVar1 = CONCAT71(0x10c5,*(int *)param_1 == *(int *)this);
      break;
         case 10:
         case 0xb:
      uVar1 = CONCAT71(0x10c5,*(long *)param_1 == *(long *)this);
      }
...
/* glslang::TConstUnion::TEMPNAMEPLACEHOLDERVALUE(glslang::TConstUnion const&) const */ulong glslang::TConstUnion::operator >(TConstUnion *this, TConstUnion *param_1) {
   if (*(uint*)( this + 8 ) < 0xc) {
      switch (*(uint*)( this + 8 )) {
         case 2:
      return CONCAT71((int7)((ulong)((long)&switchD_0010c56f::switchdataD_0010c604 +
                                    (long)(int)(&switchD_0010c56f::switchdataD_0010c604)
                                               [*(uint *)(this + 8)]) >> 8),
...
/* glslang::TConstUnion::TEMPNAMEPLACEHOLDERVALUE(glslang::TConstUnion const&) const */ulong glslang::TConstUnion::operator <(TConstUnion *this, TConstUnion *param_1) {
   if (*(uint*)( this + 8 ) < 0xc) {
      switch (*(uint*)( this + 8 )) {
         case 2:
      return CONCAT71((int7)((ulong)((long)&switchD_0010c65f::switchdataD_0010c6f4 +
                                    (long)(int)(&switchD_0010c65f::switchdataD_0010c6f4)
                                               [*(uint *)(this + 8)]) >> 8),
...
/* glslang::TConstUnion::TEMPNAMEPLACEHOLDERVALUE(glslang::TConstUnion const&) const */undefined1  [16] __thiscallglslang::TConstUnion::operator -(TConstUnion *this, TConstUnion *param_1) {
   undefined4 uVar1;
   ulong uVar2;
   undefined1 auVar3[16];
   undefined1 auVar4[16];
...
/* glslang::TConstUnion::TEMPNAMEPLACEHOLDERVALUE(glslang::TConstUnion const&) const */undefined1[16];glslang::TConstUnion::operator *(TConstUnion *this,TConstUnion *param_1) {
   undefined4 uVar1;
   ulong uVar2;
   undefined1 auVar3[16];
   undefined1 auVar4[16];
...
/* glslang::TConstUnion::TEMPNAMEPLACEHOLDERVALUE(glslang::TConstUnion const&) const */undefined1  [16] __thiscallglslang::TConstUnion::operator <<(TConstUnion *this, TConstUnion *param_1) {
   ...
   switch (*(uint*)( this + 8 )) {
    ...
    switch(*(undefined4 *)(param_1 + 8)) {
    case 4:
switchD_0010ce6d_caseD_4:
      uVar3 = *(long *)this << ((byte)*param_1 & 0x3f);
      goto LAB_0010cf38;
    case 5:
switchD_0010ce6d_caseD_5:
      uVar3 = *(long *)this << ((byte)*param_1 & 0x3f);
      goto LAB_0010cf38;
    case 6:
switchD_0010ce6d_caseD_6:
      uVar3 = *(long *)this << ((byte)*(undefined2 *)param_1 & 0x3f);
      goto LAB_0010cf38;
    case 7:
switchD_0010ce6d_caseD_7:
      uVar3 = *(long *)this << ((byte)*(undefined2 *)param_1 & 0x3f);
      goto LAB_0010cf38;
    case 8:
    case 9:
switchD_0010ce6d_caseD_8:
      uVar3 = *(long *)this << ((byte)*(undefined4 *)param_1 & 0x3f);
      goto LAB_0010cf38;
    case 10:
    case 0xb:
switchD_0010ce6d_caseD_a:
      uVar3 = *(long *)this << ((byte)*(undefined8 *)param_1 & 0x3f);
      goto LAB_0010cf38;
    }
    break;
    ...
    switch(*(undefined4 *)(param_1 + 8)) {
    case 4:
      goto switchD_0010ce6d_caseD_4;
    case 5:
      goto switchD_0010ce6d_caseD_5;
    case 6:
      goto switchD_0010ce6d_caseD_6;
    case 7:
      goto switchD_0010ce6d_caseD_7;
    case 8:
    case 9:
      goto switchD_0010ce6d_caseD_8;
    case 10:
    case 0xb:
      goto switchD_0010ce6d_caseD_a;
    }
   }

   switchD_0010ce26_default:uVar1 = 8;
   LAB_0010cf38:auVar4._8_8_ = uVar1;
   auVar4._0_8_ = uVar3;
   return auVar4;
}
/* glslang::TIntermTyped::TIntermTyped(glslang::TType const&) */void glslang::TIntermTyped::TIntermTyped(TIntermTyped *this, TType *param_1) {
   ushort uVar1;
   undefined4 uVar2;
   uint uVar3;
   undefined8 uVar4;
   ...
   *(undefined***)( this + 0x20 ) = &PTR__TType_0010e9f0;
...
/* bool glslang::TType::contains<glslang::TType::containsSampler() const::{lambda(glslang::TType
   const*)#1}>(glslang::TType::containsSampler() const::{lambda(glslang::TType const*)#1}) const */bool glslang::TType::contains<glslang::TType::containsSampler()const::_lambda(glslang::TType_const *)_1_>
               (long *param_1)

{
  ...
  if (*(code **)(lVar2 + 0x168) == isTexture) {
    ...
    if (pcVar5 != isImage) goto LAB_0010e7b0;
  }
  else {
...
LAB_0010e760:
    ...
    pcVar5 = *(code **)(lVar2 + 0x158);
    if (pcVar5 == isImage) {
      if ((char)param_1[1] != '\x0e') goto LAB_0010e6cf;
      if (*(code **)(lVar2 + 0x40) == getSampler) {
        plVar4 = param_1 + 0x10;
      }
      else {
...

{
  ...
  if (*(code **)(lVar2 + 0x168) == isTexture) {
    ...
    pcVar5 = *(code **)(lVar2 + 0x158);
    if (pcVar5 != isImage) goto LAB_0010e900;
  }
  else {
    cVar1 = (**(code **)(lVar2 + 0x168))();
    if (cVar1 != '\0') {
...
LAB_0010e8b0:
    ...
    pcVar5 = *(code **)(lVar2 + 0x158);
    if (pcVar5 == isImage) {
      if (this[8] != (TType)0xe) goto LAB_0010e81f;
      if (*(code **)(lVar2 + 0x40) == getSampler) {
        pTVar4 = this + 0x80;
      }
      else {

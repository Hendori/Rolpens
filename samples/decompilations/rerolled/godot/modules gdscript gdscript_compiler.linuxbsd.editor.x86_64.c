               ...
               do {
                  if (*(int*)( *(long*)( param_1 + 0x370 ) + lVar28 ) != 0) {
                     *(int*)( *(long*)( param_1 + 0x370 ) + lVar28 ) = 0;
                     ...
                     if (( *(long*)( (long)pvVar2 + 0x18 ) != 0 ) && ( cVar15 = RefCounted::unreference() ),cVar15 != '\0') {
...
LAB_0010510b:
   ...
   *(int*)( plVar3 + 2 ) = (int)plVar3[2] + 1;
   if (( ( local_140 != (Object*)0x0 ) && ( cVar7 = RefCounted::unreference() ),pOVar2 = local_140,cVar7 != '\0' )) &&( cVar7 = cVar7 != '\0' )(**(code**)( *(long*)pOVar2 + 0x140 ))(pOVar2);
   Memory::free_static(pOVar2, false);
}
if (( StringName::configured != '\0' ) && ( local_150._0_8_ != 0 )) {
   StringName::unref();
...
GDScriptDataType::~GDScriptDataType((GDScriptDataType*)&local_168);piVar18 = *(int**)( param_3 + 0x148 );if (piVar18 != (int*)0x0) {
 ...
 while ( piVar15 != piVar18 );
   ...
   do {
      ...
      piVar15 = piVar18;
      if (( ( *piVar16 == 5 ) && ( puVar2 = *(undefined8**)( piVar16 + 2 ) * (char*)( (long)puVar2 + 0x1a4 ) != '\0' ) ) && ( puVar2[0x26] != 0 )) {
         ( **(code**)( *local_1e8 + 0x2b0 ) )(local_1e8, *(undefined4*)( puVar2[0x26] + 0xc ));
         _parse_expression((CodeGen*)local_248, this, (ExpressionNode*)local_208, SUB81(param_1, 0), SUB81(puVar2[0x26], 0));
         plVar10 = local_1e8;
         if (*(int*)param_1 != 0) {
            ( **(code**)( *local_1e8 + 0x2c8 ) )(local_1e8);
            uVar17 = 0;
      ...
      if (local_158._0_8_ != local_2c8._8_8_) {
         CowData<GDScriptDataType>::_ref((CowData<GDScriptDataType>*)local_158, (CowData*)( local_2c8 + 8 ));
      }
      ...
      if (*(char*)( (long)puVar2 + 0x141 ) == '\0') {
         ...
         ( **(code**)( *local_1e8 + 0x150 ) )(local_1e8, (GDScriptDataType*)&local_168, (CodeGen*)local_248);
      }
      ...
      ( *pcVar1 )(plVar10, (GDScriptDataType*)&local_168, local_288, *puVar14);
      ( **(code**)( *local_1e8 + 0x30 ) )();
      if (( ( local_130 != (Object*)0x0 ) && ( cVar11 = RefCounted::unreference() ),pOVar9 = local_130,cVar11 != '\0' )) &&( cVar11 = cVar11 != '\0' )(**(code**)( *(long*)pOVar9 + 0x140 ))(pOVar9);
      Memory::free_static(pOVar9, false);
   }
...
;
                  ...
                  cVar32 = RefCounted::unreference();
                  pOVar10 = pOVar57;
                  joined_r0x001186be:if (( cVar32 != '\0' ) && ( cVar32 = predelete_handler(pOVar10) ),cVar32 != '\0') {
...
;*(undefined8**)( lVar47 + lVar48 * 8 ) = puVar4;*puVar1 = uVar38;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_0011a20c:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return puVar42 + 3;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* List<GDScriptParser::SubscriptNode const*, DefaultAllocator>::~List() */undefined8 List<GDScriptParser::SubscriptNode_const*,DefaultAllocator>::~List(List<GDScriptParser::SubscriptNode_const*,DefaultAllocator> *this) {
   void *pvVar1;
   long lVar2;
   long lVar3;
   undefined8 uVar4;
            ...
            do {
               if (*(int*)( *(long*)( this + 0x10 ) + lVar7 ) != 0) {
                  *(int*)( *(long*)( this + 0x10 ) + lVar7 ) = 0;
                  ...
                  if (( *(long*)( (long)pvVar3 + 0x60 ) != 0 ) && ( cVar6 = RefCounted::unreference() ),cVar6 != '\0') {
      ...
      if (( local_50._4_4_ != 0 ) && ( *(uint*)( hash_table_size_primes + ( local_50 & 0xffffffff ) * 4 ) != 0 )) {
         ...
         do {
            if (*piVar12 != 0) {
               pvVar5 = (void*)*puVar13;
               *piVar12 = 0;
               if (( *(long*)( (long)pvVar5 + 0x50 ) != 0 ) && ( cVar8 = RefCounted::unreference() ),cVar8 != '\0') {

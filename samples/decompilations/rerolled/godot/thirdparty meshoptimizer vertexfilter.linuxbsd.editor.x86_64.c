/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* meshopt::decodeFilterOctSimd(short*, unsigned long) */void meshopt::decodeFilterOctSimd(short *param_1, ulong param_2) {
   uint uVar1;
   uint uVar2;
   uint uVar3;
   uint uVar4;
   ...
   uVar12 = _LC1;
   uVar11 = _UNK_001010cc;
   uVar10 = _UNK_001010c8;
   uVar9 = _UNK_001010c4;
   uVar8 = __LC7;
   auVar7 = __LC6;
   uVar6 = _LC5;
   ...
   if (param_2 != 0) {
      ...
      do {
         ...
         fVar20 = (float)(int)( *(uint*)( (long)*pauVar13 + 4 ) & uVar5 ) - ( (float)( ~uVar12 & (uint)fVar39 ) + (float)( ~uVar12 & (uint)fVar28 ) );
         fVar25 = (float)(int)( *(uint*)( (long)*pauVar13 + 0xc ) & uVar5 ) - ( (float)( ~uVar12 & (uint)fVar41 ) + (float)( ~uVar12 & (uint)fVar31 ) );
         auVar17._4_4_ = fVar25;
         auVar17._0_4_ = fVar20;
         fVar26 = (float)(int)( *(uint*)( (long)pauVar13[1] + 4 ) & uVar5 ) - ( (float)( ~uVar12 & (uint)fVar42 ) + (float)( ~uVar12 & (uint)fVar33 ) );
         fVar27 = (float)(int)( *(uint*)( (long)pauVar13[1] + 0xc ) & uVar5 ) - ( (float)( ~uVar12 & (uint)fVar43 ) + (float)( ~uVar12 & (uint)fVar35 ) );
 ...
 while ( (undefined1(*) [16])( (long)param_1 + ( param_2 * 8 - 8 & 0xffffffffffffffe0 ) + 0x20 ) != pauVar14 );
   }

   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* meshopt::decodeFilterOctSimd(signed char*, unsigned long) */void meshopt::decodeFilterOctSimd(signed *param_1, ulong param_2) {
   uint uVar1;
   uint uVar2;
   uint uVar3;
   uint uVar4;
   ...
   float fVar34;
   uVar14 = _LC1;
   uVar13 = _UNK_001010ec;
   uVar12 = _UNK_001010e8;
   uVar11 = _UNK_001010e4;
   uVar10 = __LC11;
   uVar9 = _UNK_001010dc;
   uVar8 = _UNK_001010d8;
   uVar7 = _UNK_001010d4;
   ...
   if (param_2 != 0) {
      ...
      do {
         ...
         fVar27 = (float)( (int)( uVar1 << 8 ) >> 0x18 ) - ( (float)( ~uVar14 & (uint)fVar31 ) + (float)( ~uVar14 & (uint)fVar17 ) );
         fVar28 = (float)( (int)( uVar2 << 8 ) >> 0x18 ) - ( (float)( ~uVar14 & (uint)fVar32 ) + (float)( ~uVar14 & (uint)fVar19 ) );
         auVar25._4_4_ = fVar28;
         auVar25._0_4_ = fVar27;
         fVar29 = (float)( (int)( uVar3 << 8 ) >> 0x18 ) - ( (float)( ~uVar14 & (uint)fVar33 ) + (float)( ~uVar14 & (uint)fVar21 ) );
         fVar30 = (float)( (int)( uVar4 << 8 ) >> 0x18 ) - ( (float)( ~uVar14 & (uint)fVar34 ) + (float)( ~uVar14 & (uint)fVar23 ) );
         ...
         *(uint*)psVar15 = uVar1 & uVar10 | (int)( fVar31 * fVar18 ) & uVar6 | ( (int)( fVar17 * fVar18 ) & uVar6 ) << 8 | ( (int)( fVar18 * fVar27 ) & uVar6 ) << 0x10;
         *(uint*)( psVar15 + 4 ) = uVar2 & uVar11 | (int)( fVar32 * fVar20 ) & uVar7 | ( (int)( fVar19 * fVar20 ) & uVar7 ) << 8 | ( (int)( fVar20 * fVar28 ) & uVar7 ) << 0x10;
         *(uint*)( psVar15 + 8 ) = uVar3 & uVar12 | (int)( fVar33 * fVar22 ) & uVar8 | ( (int)( fVar21 * fVar22 ) & uVar8 ) << 8 | ( (int)( fVar22 * fVar29 ) & uVar8 ) << 0x10;
         *(uint*)( psVar15 + 0xc ) = uVar4 & uVar13 | (int)( fVar34 * fVar24 ) & uVar9 | ( (int)( fVar23 * fVar24 ) & uVar9 ) << 8 | ( (int)( fVar24 * fVar30 ) & uVar9 ) << 0x10;
         psVar15 = psVar16;
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* meshopt::decodeFilterQuatSimd(short*, unsigned long) */void meshopt::decodeFilterQuatSimd(short *param_1, ulong param_2) {
   float fVar1;
   undefined4 uVar2;
   float fVar3;
   ...
   if (param_2 != 0) {
      ...
      do {
         ...
         auVar15._0_8_ = CONCAT26(auVar26._10_2_, CONCAT24(auVar14._10_2_, CONCAT22(auVar26._8_2_, auVar14._8_2_)));
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void meshopt_decodeFilterExp(float *param_1, long param_2, ulong param_3) {
   size_t __n;
   int iVar1;
   int iVar2;
   int iVar3;
   ...
   if (uVar9 != 0) {
      ...
      do {
         pfVar5 = pfVar6 + 4;
         *pfVar6 = (float)( ( (int)*pfVar6 << 8 ) >> 8 ) * (float)( ( ( (int)*pfVar6 >> 0x18 ) + iVar1 ) * 0x800000 );
         pfVar6[1] = (float)( ( (int)pfVar6[1] << 8 ) >> 8 ) * (float)( ( ( (int)pfVar6[1] >> 0x18 ) + iVar2 ) * 0x800000 );
         pfVar6[2] = (float)( ( (int)pfVar6[2] << 8 ) >> 8 ) * (float)( ( ( (int)pfVar6[2] >> 0x18 ) + iVar3 ) * 0x800000 );
         pfVar6[3] = (float)( ( (int)pfVar6[3] << 8 ) >> 8 ) * (float)( ( ( (int)pfVar6[3] >> 0x18 ) + iVar4 ) * 0x800000 );
         pfVar6 = pfVar5;
      }
...
void meshopt_encodeFilterOct(long param_1, long param_2, long param_3, char param_4, float *param_5) {
   ...
   do {
      while (true) {
         ...
         fVar1 = param_5[2];
         fVar2 = param_5[3];
         fVar14 = (float)( (uint)fVar15 & uVar6 ) + (float)( (uint)fVar16 & uVar6 ) + (float)( (uint)fVar1 & uVar6 );
         fVar13 = fVar5;
         if (fVar14 != 0.0) break;
         if (0.0 <= fVar1) {
         ...
         LAB_0010092a:fVar15 = _LC19;
         fVar16 = fVar19;
         if (fVar2 < _LC24) goto LAB_00100823;
         uVar8 = ( uint )(_LC19 + fVar2 * fVar18);
         if (param_3 != 4) goto LAB_00100835;
         LAB_00100956:param_5 = param_5 + 4;
         *(uint*)( param_1 + lVar9 * 4 ) = ( ( ( uVar8 & 0xff ) << 8 | (int)fVar12 & 0xffU ) << 8 | uVar11 & 0xff ) << 8 | uVar10 & 0xff;
         lVar9 = lVar9 + 1;
         if (param_2 == lVar9) {
            return;
         }
...
;
      ...
      if (0.0 <= fVar14) {
         ...
         LAB_001008f6:fVar14 = fVar14 + fVar15;
      }
      ...
      LAB_001007f9:uVar11 = ( uint )(fVar13 + fVar15);
      if (fVar2 < 0.0) goto LAB_0010092a;
      LAB_0010080b:fVar15 = fVar5;
      fVar16 = fVar18;
      if (fVar2 <= _LC16) {
         fVar16 = fVar2 * fVar18;
      }

      LAB_00100823:uVar8 = ( uint )(fVar15 + fVar16);
      if (param_3 == 4) goto LAB_00100956;
      LAB_00100835:param_5 = param_5 + 4;
      *(ulong*)( param_1 + lVar9 * 8 ) = ( ( ( ulong )(uVar8 & 0xffff) << 0x10 | ( ulong )((int)fVar12 & 0xffff) ) << 0x10 | ( ulong )(uVar11 & 0xffff) ) << 0x10 | ( ulong )(uVar10 & 0xffff);
      lVar9 = lVar9 + 1;
      if (param_2 == lVar9) {
         return;
      }
...
void meshopt_encodeFilterQuat(ushort *param_1, long param_2, undefined8 param_3, char param_4, float *param_5) {
   bool bVar1;
   ushort uVar2;
   float fVar3;
   float fVar4;
...
void meshopt_encodeFilterExp(long param_1, long param_2, ulong param_3, int param_4, float *param_5, int param_6) {
   uint uVar1;
   uint uVar2;
   int iVar3;
   int *piVar4;
   ...
   if (param_6 == 2) {
      if (param_3 != 0) {
         ...
         if (( param_3 & 1 ) != 0) {
            local_138[0] = -100;
            piVar4 = local_138 + 1;
            if (local_138 + param_3 == local_138 + 1) goto LAB_00100ff6;
         }
 ...
 while ( local_138 + param_3 != piVar5 );
      }

      LAB_00100ff6:lVar9 = 0;
      pfVar8 = param_5 + param_3;
      if (param_2 == 0) goto LAB_00100e78;
      do {
         pfVar10 = pfVar8 + -param_3;
         piVar4 = local_138;
         if (param_3 != 0) {
            do {
               iVar6 = 0;
               if (*pfVar10 != 0.0) {
                  iVar6 = ( ( uint ) * pfVar10 >> 0x17 & 0xff ) - 0x7e;
               }
      ...
      while (param_6 == 1) {
         ...
         if (param_3 != 0) {
            do {
               iVar3 = 0;
               if (*pfVar8 != 0.0) {
                  iVar3 = ( ( uint ) * pfVar8 >> 0x17 & 0xff ) - 0x7e;
               }
 ...
 while ( pfVar8 != param_5 + param_3 );
            LAB_00100e00:uVar7 = 0;
            do {
               iVar3 = iVar6;
               if (param_6 != 1) {
                  iVar3 = local_138[uVar7];
               }

               uVar11 = -(uint)(0.0 <= param_5[uVar7]);
               *(uint*)( param_1 + uVar7 * 4 ) = ( iVar3 - ( param_4 + -1 ) ) * 0x1000000 | (int)( (float)( ( ( ( param_4 + -1 ) - iVar3 ) + 0x7f ) * 0x800000 ) * param_5[uVar7] + (float)( ~uVar11 & uVar1 | uVar2 & uVar11 ) ) & 0xffffffU;
               uVar7 = uVar7 + 1;
            }
 while ( param_3 != uVar7 );
         }
         ...
         if (param_2 == lVar9) goto LAB_00100e78;
      }
;
      if (param_6 == 0) {
         uVar7 = 0;
         if (param_3 != 0) {
            do {
               iVar6 = 0;
               if (( param_5[uVar7] != 0.0 ) && ( iVar6 = ( (uint)param_5[uVar7] >> 0x17 & 0xff ) - 0x7e ),iVar6 < -100) {
                  iVar6 = -100;
               }

               local_138[uVar7] = iVar6;
               uVar7 = uVar7 + 1;
            }
 while ( uVar7 != param_3 );
            goto LAB_00100df6;
         ...
         if (param_3 != 0) {
            do {
               iVar6 = 0;
               if (( param_5[uVar7] != 0.0 ) && ( iVar6 = ( (uint)param_5[uVar7] >> 0x17 & 0xff ) - 0x7e ),iVar6 < 0) {
                  iVar6 = 0;
               }
 ...
 while ( param_2 != lVar9 );
   LAB_00100e78:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }

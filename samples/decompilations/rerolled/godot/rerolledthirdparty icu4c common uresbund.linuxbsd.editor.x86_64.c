...
;
 ...
 while ( param_1 < pcVar2 );
   ...
   LAB_00100998:while (( param_3<pcVar3&&(cVar1 = *param_5, cVar1, != '\0') )) {
      if (param_3 < pcVar3) {
         do {
            if (*param_3 == '/') {
...
/* loadParentsExceptRoot(UResourceDataEntry*&, char*, int, signed char, char*, UErrorCode*) [clone
   ...
   do {
      ...
      while (true) {
         if (( ( lVar1 != 0 ) || ( *(char*)( lVar3 + 0x60 ) != '\0' ) ) || ( iVar2 = res_getResource_76_godot(lVar3 + 0x28, "%%ParentIsRoot") ),iVar2 != -1) goto LAB_00100c08;

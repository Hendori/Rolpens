   ...
   if (uVar3 != 0) {
      ...
      do {
         while (true) {
            ...
            LAB_001000cd:uVar1 = ( uVar3 - uVar4 >> 1 ) + uVar4;
...
;
         ...
         LAB_001000ab:if (uVar1 < uVar4) goto LAB_001000cd;
      }
 while ( uVar4 < uVar3 );
      LAB_001000d9:uVar3 = 0;
   }
      ...
      do {
         ...
         while (true) {
            ...
            if (uVar1 < uVar5) {
               ...
               LAB_0010014f:uVar1 = (uint)uVar3;
               uVar2 = ( uVar4 - uVar1 >> 1 ) + uVar1;
               if (uVar4 <= uVar1) {
                  LAB_0010015b:uVar5 = (uint)uVar3;
                  if (uVar6 <= uVar5) {
                     *param_2 = 0;
                     return 0;
                  }
...
;
 ...
 while ( uVar2 == 0 );
   ...
   LAB_00100172:*param_2 = (uint)uVar3;
   return uVar6;
}
...
void pfr_glyph_close_contour(long param_1) {
   ...
   LAB_0010024c:*(short*)( lVar3 + 0x60 ) = sVar2 + 1;
...
undefined8 pfr_face_get_kerning(long param_1, int param_2, int param_3, undefined1 (*param_4)[16]) {
   ...
   *param_4 = (undefined1[16])0x0;
   ...
   uVar9 = *(int*)( *(long*)( param_1 + 600 ) + (ulong)uVar10 * 0x10 ) << 0x10 | ( uint ) * (ushort*)( *(long*)( param_1 + 600 ) + (ulong)uVar7 * 0x10 );
   if (plVar8 == (long*)0x0) {
      return 0;
   }
...
;
   ...
   iVar3 = bVar1 - uVar10;
   if (iVar3 == 0) {
      LAB_001003d0:while (uVar7 < (uint)uVar6) {
...
int pfr_extra_item_load_bitmap_info(long param_1, ushort *param_2, undefined8 *param_3) {
   ...
   if (puVar9 <= param_2) {
      ...
      bVar13 = bVar3 & 8;
      bVar10 = bVar3 & 0x10;
      if ((ushort*)( ( ulong )(( ( ( ( ( ( uint )(byte)(( bVar3 & 1 ) + 8) - ( uint )(( bVar3 & 2 ) == 0) ) - ( uint )(bVar11 == 0) ) - ( uint )(bVar13 == 0) ) + 4 ) - ( uint )(bVar10 == 0) ) * (uint)bVar2) + (long)puVar9 ) <= param_2) {
         if (bVar2 != 0) {
            ...
            do {
               while (true) {
                  ...
                  *puVar6 = uVar15;
                  ...
                  LAB_00100614:puVar8 = (ushort*)( (long)puVar9 + 3 );
                  puVar6[5] = ( uint )(ushort)(*(ushort*)( (long)puVar9 + 1 ) << 8 | *(ushort*)( (long)puVar9 + 1 ) >> 8);
                  if (bVar13 == 0) goto LAB_00100630;
                  LAB_0010058e:puVar12 = (ushort*)( (long)puVar8 + 3 );
                  puVar6[6] = ( uint )(byte) * puVar8 << 0x10 | ( uint ) * (byte*)( (long)puVar8 + 1 ) << 8 | (uint)(byte)puVar8[1];
                  if (bVar10 != 0) goto LAB_001005b6;
                  LAB_0010064a:puVar5 = puVar6 + 10;
...
;
               ...
               LAB_00100562:puVar8 = puVar9 + 2;
               puVar6[5] = ( uint ) * (byte*)( (long)puVar9 + 1 ) << 0x10 | (uint)(byte)puVar9[1] << 8 | ( uint ) * (byte*)( (long)puVar9 + 3 );
               if (bVar13 != 0) goto LAB_0010058e;
               LAB_00100630:puVar12 = puVar8 + 1;
               puVar6[6] = ( uint )(ushort)(*puVar8 << 8 | *puVar8 >> 8);
               if (bVar10 == 0) goto LAB_0010064a;
               LAB_001005b6:puVar5 = puVar6 + 10;
               puVar9 = puVar12 + 1;
 ...
 while ( puVar5 != puVar1 );
         ...
         LAB_00100662:*(uint*)( param_3 + 0x11 ) = (int)uVar14 + (uint)bVar2;
         iVar4 = local_44;
         goto LAB_0010067d;
      }
   ...
   iVar4 = 8;
   LAB_0010067d:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar4;
   }
...
int pfr_extra_item_load_stem_snaps(byte *param_1, byte *param_2, undefined8 *param_3) {
 ...
 while ( uVar5 != uVar4 );
   ...
   iVar2 = 0;
   LAB_001007f1:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
int pfr_extra_item_load_kerning_pairs(byte *param_1, byte *param_2, undefined8 *param_3) {
         ...
         if (pbVar1 + (uint)bVar2 * iVar7 <= param_2) {
            if (bVar2 == 0) {
               ...
               if (( bVar3 & 1 ) == 0) {
                  ...
                  *(uint*)( puVar8 + 3 ) = uVar6 >> 0x18 | ( uVar6 & 0xff0000 ) >> 8 | ( uVar6 & 0xff00 ) << 8 | uVar6 << 0x18;
                  uVar6 = *puVar9;
   ...
   LAB_001009f0:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar10;
   }
...
undefined8 pfr_get_metrics(long param_1, undefined4 *param_2, undefined4 *param_3, undefined8 *param_4, undefined8 *param_5) {
   long lVar1;
   undefined8 uVar2;
   undefined8 uVar3;
...
int pfr_glyph_load_rec(long param_1, long param_2, long param_3, long param_4, long param_5) {
   ...
   if (( iVar7 != 0 ) || ( iVar8 = FT_Stream_EnterFrame(param_2, param_5) ),iVar7 = iVar8,iVar8 != 0) goto LAB_00100f52;
   ...
   if (( param_5 == 0 ) || ( -1 < (char)*pbVar3 )) {
      ...
      if (( bVar2 & 4 ) == 0) {
         if (( bVar2 & 2 ) != 0) {
            ...
            LAB_001012b3:puVar26 = (ushort*)( (long)puVar25 + 1 );
            if (puVar1 < puVar26) goto LAB_001012d8;
         ...
         *(undefined8*)( param_1 + 0x10 ) = *(undefined8*)( param_1 + 8 );
         ...
         LAB_00100ffe:lVar14 = *(long*)( param_1 + 8 );
         uVar28 = (uint)uVar18;
         if (*(uint*)( param_1 + 4 ) < uVar28) {
            lVar14 = ft_mem_realloc(*puVar24, 8, *(uint*)( param_1 + 4 ), uVar28 + 7 & 0xfffffff8, lVar14, &local_8c);
 ...
 while ( uVar18 != uVar10 );
      ...
      if (( bVar2 & 8 ) != 0) {
         ...
         if (puVar25 <= puVar1) {
            ...
            if ((ushort*)( (long)puVar26 + 3U ) <= puVar1) {
               for (puVar25 = (ushort*)( ( ulong ) * (byte*)( (long)puVar26 + 1 ) + (long)( (long)puVar26 + 3U ) ); puVar25 <= puVar1; puVar25 = (ushort*)( ( ulong )(byte) * puVar25 + (long)( puVar25 + 1 ) )) {
                  uVar28 = uVar28 - 1;
                  if (uVar28 == 0) {
                     local_8c = 0;
                     goto LAB_00101505;
      ...
      LAB_00101505:*(undefined1*)( param_1 + 0x30 ) = 0;
...
LAB_001016db:
        ...
        uVar28 = 4;
         ...
         do {
            ...
            if (uVar19 == 1) {
               ...
               if (( uVar18 & 3 ) == 0) {
                  if (( puVar1 < (ushort*)( (long)puVar26 + 1U ) ) || ( uVar6 = *puVar26 ),(uint)uVar29 <= (uint)(byte)uVar6) goto LAB_001012d8;
                  puVar26 = (ushort*)( (long)puVar26 + 1U );
            ...
            *(long*)( local_88 + lVar23 ) = lVar31;
            ...
            if (uVar19 == 1) {
               ...
               if (( uVar18 >> 2 & 3 ) == 0) {
                  if (( puVar1 < (ushort*)( (long)puVar26 + 1U ) ) || ( uVar6 = *puVar26 ),local_c0 <= (byte)uVar6) goto LAB_001012d8;
                  puVar26 = (ushort*)( (long)puVar26 + 1U );
 ...
 while ( (uint)lVar14 < uVar28 );
         ...
         if (3 < bVar2 >> 4) {
            ...
            *(undefined1*)( param_1 + 0x30 ) = 1;
            if (( ( *(uint*)( lVar14 + 8 ) < ( uint )(*(short*)( lVar14 + 0x1a ) + 1 + (int)*(short*)( lVar14 + 0x62 )) ) || ( *(uint*)( lVar14 + 0xc ) < ( uint )(*(short*)( lVar14 + 0x18 ) + 1 + (int)*(short*)( lVar14 + 0x60 )) ) ) && ( iVar9 = FT_GlyphLoader_CheckPoints(lVar14, 1, 1) ),iVar7 = iVar9,iVar9 != 0) break;
         }

         LAB_001016f0:local_8c = pfr_glyph_line_to_isra_0(*(undefined8*)( param_1 + 0x28 ), *(undefined1*)( param_1 + 0x30 ), local_88);
         puVar25 = puVar26;
         iVar9 = local_8c;
         iVar7 = local_8c;
      }
 while ( local_8c == 0 );
      ...
      if (( puVar26 <= puVar1 ) && ( bVar2 = *pbVar3 ),(char)bVar2 < '\0') {
         local_b8 = bVar2 & 0x3f;
         if (( bVar2 & 0x40 ) == 0) {
            LAB_001010dd:uVar19 = uVar28 + ( bVar2 & 0x3f );
            if (*(uint*)( param_1 + 0x1c ) < uVar19) {
               uVar19 = uVar19 + 3 & 0xfffffffc;
               if (0x40 < uVar19) goto LAB_001012d8;
               lVar14 = ft_mem_realloc(*puVar24, 0x20, *(uint*)( param_1 + 0x1c ), uVar19, *(undefined8*)( param_1 + 0x20 ));
            ...
            if (local_b8 == 0) {
               LAB_00101355:iVar7 = local_8c;
               FT_Stream_ExitFrame(param_2);
               if (iVar7 != 0) goto LAB_00100f52;
               LAB_0010137d:uVar19 = *(int*)( param_1 + 0x18 ) - uVar28;
               iVar7 = iVar8;
               if (uVar19 != 0) {
                  ...
                  do {
                     sVar30 = (short)uVar17;
                     iVar7 = pfr_glyph_load_rec(param_1, param_2, param_3, *(undefined4*)( lVar14 + lVar31 + 0x18 ), *(undefined4*)( lVar14 + lVar31 + 0x1c ));
                     if (iVar7 != 0) break;
                     lVar14 = *(long*)( param_1 + 0x20 );
...
;
                        ...
                        if (0 < iVar7) {
                           ...
                           do {
                              ...
                              *plVar21 = (long)( (int)( ( ulong )(lVar22 + 0x8000 + ( lVar22 >> 0x3f )) >> 0x10 ) + (int)lVar11 );
                              lVar22 = (long)(int)plVar21[1] * (long)(int)lVar5;
                              plVar21[1] = (long)( (int)( ( ulong )(lVar22 + 0x8000 + ( lVar22 >> 0x3f )) >> 0x10 ) + iVar9 );
                              plVar21 = plVar13;
                           }
 ...
 while ( ( (ulong)uVar19 + (ulong)uVar28 ) * 0x20 != lVar31 );
            ...
            LAB_00101160:puVar25 = (ushort*)( (long)puVar26 + 1 );
            if (puVar25 <= puVar1) {
               uVar19 = 0;
               do {
                  bVar4 = ( byte ) * puVar26;
                  *plVar21 = 0x10000;
                  if (( bVar4 & 0x10 ) != 0) {
                     ...
                     *plVar21 = (long)( (int)(short)( *(ushort*)( (long)puVar26 + 1 ) << 8 | *(ushort*)( (long)puVar26 + 1 ) >> 8 ) << 4 );
                  }
                  ...
                  *(uint*)( (long)plVar21 + 0x1c ) = uVar17;
                  if ((char)bVar4 < '\0') {
                     ...
                     if (puVar1 < puVar26) break;
                     uVar17 = ( uint )(byte) * puVar25 << 0x10 | ( uint ) * (byte*)( (long)puVar25 + 1 ) << 8 | (uint)(byte)puVar25[1];
                  }
 else {
                     puVar26 = puVar25 + 1;
                     if (puVar1 < puVar26) break;
 ...
 while ( puVar25 <= puVar1 );
            ...
            if (puVar26 <= puVar1) {
               ...
               if (pbVar3 + 4 <= puVar1) {
                  for (puVar26 = (ushort*)( (long)( pbVar3 + 4 ) + (ulong)pbVar3[2] ); puVar26 <= puVar1; puVar26 = (ushort*)( ( ulong )(byte) * puVar26 + (long)( puVar26 + 1 ) )) {
                     uVar19 = uVar19 - 1;
      ...
      LAB_001012d8:iVar9 = local_8c;
      iVar7 = 8;
   }

   LAB_001012dd:local_8c = iVar9;
   FT_Stream_ExitFrame(param_2);
   LAB_00100f52:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar7;
   }
...
undefined8 pfr_slot_load(long param_1, long param_2, int param_3, uint param_4) {
   ...
   if (( lVar36 != 0 ) && ( uVar24 < *(uint*)( lVar36 + 0x248 ) )) {
      if (( param_4 & 9 ) == 0) {
         ...
         if (*(uint*)( lVar36 + 0x220 ) != 0) {
            ...
            do {
               if (( *puVar39 == ( uint ) * (ushort*)( param_2 + 0x18 ) ) && ( puVar39[1] == ( uint ) * (ushort*)( param_2 + 0x1a ) )) {
                  uVar34 = puVar39[2];
                  iVar12 = FT_Stream_Seek(lVar30, (ulong)puVar39[6] + *(long*)( lVar36 + 0x278 ));
                  if (( iVar12 == 0 ) && ( iVar12 = FT_Stream_EnterFrame(lVar30, ( ( ( uVar34 & 1 ) + ( uint )(( uVar34 & 2 ) != 0) + 5 ) - ( uint )(( uVar34 & 4 ) == 0) ) * puVar39[7]) ),iVar12 == 0) {
                     uVar34 = puVar39[2];
                     uVar32 = puVar39[7];
 ...
 while ( puVar39 != puVar17 );
   ...
   goto LAB_00101e30;
   joined_r0x00101faa:if (puVar40 <= puVar28) goto LAB_00102015;
   ...
   uVar20 = uVar18;
   goto joined_r0x00101faa;
   LAB_00101fdd:puVar39[2] = uVar34 & 0xffffff7f | 0x40;
   goto LAB_00101fea;
   LAB_00102015:uVar13 = uVar34 | 0xc0;
   uVar34 = uVar34 | 0xc0;
   puVar39[2] = uVar13;
   LAB_00102025:if (( uVar34 & 0x80 ) != 0) {
      uVar33 = 0;
      uVar13 = uVar32 >> 1;
      if (uVar32 != 0) {
         LAB_00102059:puVar28 = (ushort*)( ( ulong )(uVar37 * uVar13) + (long)puVar19 );
         ...
         if (( uVar34 & 4 ) == 0) {
            ...
            uVar20 = ( ulong )(( uint )(byte) * puVar19 << 0x10 | ( uint ) * (byte*)( (long)puVar19 + 1 ) << 8 | (uint)(byte)puVar19[1]);
         }
         ...
         *(long*)( param_1 + 0x70 ) = lVar27;
         ...
         if (( iVar12 != 0 ) || ( iVar12 = iVar12 != 0 )) goto LAB_00101c07;
         ...
         if (bVar11 == 2) {
            ...
            if (puVar19 < puVar40) goto LAB_00101fea;
            lVar27 = (long)( (int)( (uint)pbVar8[1] << 0x18 | (uint)pbVar8[2] << 0x10 | (uint)pbVar8[3] << 8 ) >> 8 );
            local_78 = (long)( (int)( (uint)pbVar8[6] << 8 | (uint)pbVar8[4] << 0x18 | (uint)pbVar8[5] << 0x10 ) >> 8 );
         }
 else if (bVar11 == 1) {
         ...
         if (bVar11 == 2) {
            ...
            if (puVar19 < puVar40) goto LAB_00101fea;
            local_80 = (long)( (int)( ( uint ) * (byte*)( (long)puVar28 + 1 ) << 0x10 | ( uint )(byte) * puVar28 << 0x18 | (uint)(byte)puVar28[1] << 8 ) >> 8 );
         }
 else {
            puVar40 = puVar28;
            if (bVar11 == 1) {
 ...
 while ( (byte)uVar1 == 0 );
         ...
         LAB_00102387:FT_Stream_ExitFrame(lVar30);
         uVar14 = 0;
         goto LAB_00101e35;
      }
   ...
   LAB_00101fea:FT_Stream_ExitFrame(lVar30);
   LAB_00101c07:if (( param_4 & 0x4000 ) == 0) {
...
ulong pfr_face_init(long param_1, ulong *param_2, ulong param_3) {
   ...
   if (( iVar6 == 0 ) && ( iVar6 = FT_Stream_ReadFields(param_1, pfr_header_fields, param_2 + 0x1f) ),iVar6 == 0) {
      local_5c = 0;
      *(int*)( (long)param_2 + 0x11c ) = *(int*)( (long)param_2 + 0x11c ) + (int)param_2[0x28] * 0x10000;
      if (( (int)param_2[0x1f] == 0x50465230 ) && ( ( ( *(uint*)( (long)param_2 + 0xfc ) < 5 && ( 0x39 < *(uint*)( (long)param_2 + 0x104 ) ) ) && ( (int)param_2[0x20] == 0xd0a ) ) )) {
         ...
         if (( ( 0x3332 < uVar5 ) || ( *(ulong*)( param_1 + 8 ) - (ulong)uVar28 <= uVar19 * 5 + 2 ) ) || ( *(ulong*)( param_1 + 8 ) <= ( ulong )((uint)uVar5 * 0x17 + 0x5f) )) {
            uVar11 = 8;
            goto LAB_001027da;
         }
         ...
         *(uint*)( (long)param_2 + 0x164 ) = (uint)uVar5;
         ...
         if (puVar16 < puVar12) {
            LAB_00103538:local_58 = (ulong*)CONCAT44(local_58._4_4_, 8);
         }
 else {
            *(int*)( (long)param_2 + 0x16c ) = (int)( ( uint ) * pbVar4 << 0x18 | (uint)pbVar4[1] << 0x10 | (uint)pbVar4[2] << 8 ) >> 8;
            *(int*)( param_2 + 0x2e ) = (int)( (uint)pbVar4[3] << 0x18 | (uint)pbVar4[4] << 0x10 | (uint)pbVar4[5] << 8 ) >> 8;
            *(int*)( (long)param_2 + 0x174 ) = (int)( (uint)pbVar4[6] << 0x18 | (uint)pbVar4[7] << 0x10 | (uint)pbVar4[8] << 8 ) >> 8;
            *(int*)( param_2 + 0x2f ) = (int)( (uint)pbVar4[9] << 0x18 | (uint)pbVar4[10] << 0x10 | (uint)pbVar4[0xb] << 8 ) >> 8;
            bVar2 = pbVar4[0xc];
            if (( bVar2 & 4 ) == 0) {
               if (( bVar2 & 0x10 ) != 0) {
                  uVar28 = 0;
               ...
               if (( bVar2 & 0x10 ) == 0) {
                  ...
                  *(uint*)( param_2 + 0x30 ) = uVar28;
                  ...
                  if (( bVar2 & 3 ) == 0) {
                     ...
                     *(int*)( param_2 + 0x31 ) = (int)( ( uint )(byte) * puVar26 << 0x18 | ( uint ) * (byte*)( (long)puVar26 + 1 ) << 0x10 | (uint)(byte)puVar26[1] << 8 ) >> 8;
                  }

                  if (bVar30 == 0) goto LAB_00102b25;
               }
 else {
                  LAB_00103556:if (puVar16 < (ushort*)( ( ulong )(( ( bVar2 & 0x20 ) != 0 ) + uVar28 + 1) + (long)puVar12 )) goto LAB_00103538;
                  if (( bVar2 & 4 ) != 0) {
                     bVar30 = 0x10;
                     goto LAB_00102aae;
                  }
            ...
            LAB_00102b25:puVar26 = puVar12;
            if (( bVar2 & 0x40 ) != 0) {
               puVar26 = (ushort*)( (long)puVar12 + 1 );
               if (puVar16 < puVar26) goto LAB_00103538;
               for (uVar28 = ( uint )(byte) * puVar12; uVar28 != 0; uVar28 = uVar28 - 1) {
                  if (( puVar16 < puVar26 + 1 ) || ( puVar26 = (ushort*)( ( ulong )(byte) * puVar26 + (long)( puVar26 + 1 ) ) ),puVar16 < puVar26) goto LAB_00103538;
               }
            ...
            *(uint*)( param_2 + 0x32 ) = (uint)(byte)puVar26[1] << 0x10 | ( uint ) * (byte*)( (long)puVar26 + 3 ) << 8 | (uint)(byte)puVar26[2];
            if ((int)uVar19 != 0) {
         ...
         *(uint*)( param_2 + 0x34 ) = uVar28;
         ...
         if (puVar16 < puVar12) {
            LAB_00102e60:local_58 = (ulong*)CONCAT44(local_58._4_4_, 8);
         }
 else {
            ...
            *(uint*)( (long)param_2 + 0x1ac ) = uVar10;
            for (int i = 0; i < 4; i++) {
               param_2[( i + 54 )] = (long)(short)( puVar26[( i + 3 )] << 8 | puVar26[( i + 3 )] >> 8 );
            }
            ...
            *(uint*)( param_2 + 0x3a ) = (uint)bVar2;
            ...
            if (( bVar2 & 4 ) == 0) {
               ...
               *(int*)( (long)param_2 + 0x1d4 ) = (int)(short)( *(ushort*)( (long)puVar26 + 0xf ) << 8 | *(ushort*)( (long)puVar26 + 0xf ) >> 8 );
            }
 ...
 while ( puVar26 <= puVar16 );
                        iVar6 = 8;
                        LAB_0010352f:local_58 = (ulong*)CONCAT44(local_58._4_4_, iVar6);
                        goto LAB_00102e68;
                     }
            ...
            LAB_00102cfb:puVar12 = (ushort*)( (long)puVar26 + 3 );
            if (puVar16 < puVar12) goto LAB_00102e60;
            uVar7 = ( uint )(byte) * puVar26 << 0x10 | ( uint ) * (byte*)( (long)puVar26 + 1 ) << 8 | (uint)(byte)puVar26[1];
            puVar29 = puVar12;
            if (uVar7 != 0) {
               uVar11 = (ulong)uVar7;
               ...
               if (puVar26 <= puVar29) {
                  while (true) {
                     ...
                     if (( uVar5 < 4 ) || ( uVar23 = uVar11 < uVar23 )) break;
                     uVar3 = puVar12[1];
                     ...
                     LAB_00102da8:uVar11 = uVar11 - uVar23;
                     if (( uVar11 == 0 ) || ( puVar26 = puVar1 + 2 ),puVar12 = puVar1,puVar29 < puVar26) break;
                  }
;
               }
            ...
            *(uint*)( param_2 + 0x46 ) = uVar7;
            if (puVar16 < (ushort*)( ( ulong )((uint)bVar30 + (uint)bVar30) + (long)local_98 )) goto LAB_00102e60;
            ...
            if ((uint)local_58 == 0) {
               if (uVar7 != 0) {
                  lVar22 = 0;
                  do {
                     *(int*)( uVar11 + lVar22 * 4 ) = (int)CONCAT11(*(byte*)( (long)puVar29 + lVar22 * 2 + 1 ), (byte)puVar29[lVar22 + 1]);
                     lVar22 = lVar22 + 1;
                  }
               ...
               if (puVar12 <= puVar16) {
                  ...
                  *(uint*)( param_2 + 0x49 ) = uVar28;
                  if (uVar28 != 0) {
                     ...
                     local_80 = bVar2 & 0x10;
                     if ((ushort*)( ( ulong )(( ( ( ( iVar9 - ( uint )(( bVar2 & 8 ) == 0) ) - ( uint )(( bVar2 & 0x10 ) == 0) ) + 3 ) - ( uint )(( bVar2 & 0x20 ) == 0) ) * uVar28) + (long)puVar12 ) <= puVar16) {
                           ...
                           do {
                              ...
                              *puVar15 = uVar10;
                              ...
                              if (( bVar2 & 0x20 ) == 0) {
                                 ...
                                 puVar12 = (ushort*)( (long)puVar26 + 3 );
                                 uVar10 = ( uint )(byte) * puVar26 << 0x10 | ( uint ) * (byte*)( (long)puVar26 + 1 ) << 8 | (uint)(byte)puVar26[1];
                              }
 ...
 while ( uVar7 < uVar28 );
         ...
         LAB_00102e68:FT_Stream_ExitFrame(param_1);
 ...
 while ( uVar28 != uVar7 );
         ...
         LAB_00102f06:uVar7 = (uint)param_2[0x3a] & 4;
         if (uVar7 == 0) {
            uVar11 = uVar11 | 4;
         }
 ...
 while ( uVar19 != uVar23 );
         ...
         LAB_0010301d:param_2[0x12] = ( ( ( ulong )(uVar10 / 0x1e) << 0x10 | ( ulong )(-(int)((long)(uVar11 * 0x66666667) >> 0x22) & 0xffff) ) << 0x10 | ( ulong ) * (ushort*)( (long)param_2 + 0x8e ) ) << 0x10 | ( ulong )(uVar28 & 0xffff);

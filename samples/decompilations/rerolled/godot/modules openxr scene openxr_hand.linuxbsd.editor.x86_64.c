...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* OpenXRHand::_update_skeleton() */void __thiscall OpenXRHand::_update_skeleton(OpenXRHand *this)
  ...
  if ((((*(long *)(this + 0x528) != 0) && (cVar6 = OpenXRAPI::is_initialized(), cVar6 != '\0')) &&
    ...
    if (_update_skeleton()::bone_adjustments == '\0') {
      ...
      if (iVar7 != 0) {
        ...
        _update_skeleton()::bone_adjustments._24_8_ = _UNK_0010d0f8;
        _update_skeleton()::bone_adjustments._8_8_ = uVar30;
    ...
    pcVar11 = (char *)OpenXRHandTrackingExtension::get_hand_tracker
          ...
          if ((((auVar4._0_4_ != 0.0) || (auVar4._4_4_ != 0.0)) || (auVar4._8_4_ != 0.0)) ||
            ...
            *(undefined8 *)(pQVar10 + 8) = local_568._8_8_;
            if ((bVar18 & 2) == 0) {
              ...
              *(ulong *)pfVar14 =
                   CONCAT44((float)((ulong)uVar3 >> 0x20) * fVar28,(float)uVar3 * fVar28);
            }
          }
        }
        piVar17 = piVar17 + 1;
      ...
      if (local_538[0] != 0) {
        ...
        do {
          if (*(uint *)pOVar13 != 0xffffffff) {
            ...
            fVar32 = (float)*(undefined8 *)(pfVar14 + 1) -
                     (float)*(undefined8 *)(local_4c0 + lVar12 * 3 + -1);
            fVar34 = (float)((ulong)*(undefined8 *)(pfVar14 + 1) >> 0x20) -
                     (float)((ulong)*(undefined8 *)(local_4c0 + lVar12 * 3 + -1) >> 0x20);
            ...
            if (cVar6 == '\0') {
              ...
              fVar33 = ((fVar2 - fVar33) * fVar26 - fVar32 * fVar37) * fVar35 +
                       (fVar26 * fVar24 - fVar37 * fVar36);
              fVar28 = ((fVar28 - fVar1) * fVar27 - fVar34 * fVar19) * fVar35 +
                       (fVar27 * fVar25 - fVar19 * (fVar31 * fVar19 - fVar23 * (fVar28 - fVar1)));
...

{
  ...
  *(undefined4 *)(this + 0x55c) = 0xffffffff;
  ...
  do {
    ...
    *(undefined4 *)(pOVar4 + 4) = 0xffffffff;
    *(undefined4 *)(pOVar4 + 8) = 0xffffffff;
    *(undefined4 *)(pOVar4 + 0xc) = 0xffffffff;
    pOVar5 = pOVar4 + 0x20;
    *(undefined4 *)(pOVar4 + 0x10) = 0xffffffff;
    *(undefined4 *)(pOVar4 + 0x14) = 0xffffffff;
    *(undefined4 *)(pOVar4 + 0x18) = 0xffffffff;
    *(undefined4 *)(pOVar4 + 0x1c) = 0xffffffff;
    pOVar4 = pOVar5;
...

{
  ...
  if (param_1 == 0xb) {
    ...
    *(undefined4 *)(this + 0x550) = 0xffffffff;
    *(undefined4 *)(this + 0x554) = 0xffffffff;
    *(undefined4 *)(this + 0x558) = 0xffffffff;
    *(undefined4 *)(this + 0x55c) = 0xffffffff;
    pOVar1 = this + 0x560;
    do {
      ...
      *(undefined4 *)(pOVar1 + 0xc) = 0xffffffff;
      pOVar2 = pOVar1 + 0x20;
      *(undefined4 *)(pOVar1 + 0x10) = 0xffffffff;
      *(undefined4 *)(pOVar1 + 0x14) = 0xffffffff;
      *(undefined4 *)(pOVar1 + 0x18) = 0xffffffff;
      *(undefined4 *)(pOVar1 + 0x1c) = 0xffffffff;
      pOVar1 = pOVar2;

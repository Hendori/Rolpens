...
int gxv_validate(long param_1, ulong param_2, undefined8 *param_3, uint param_4) {
   ...
   if (( ( param_2 & 0x4000 ) == 0 ) || ( iVar5 = gxv_load_table(param_1, 0x66656174, &local_960, &local_958) ),iVar5 == 0) {
      if (param_4 < 4) {
         if (param_4 != 1) {
            if (( param_2 & 0x8000 ) == 0) {
               if (param_4 != 2) {
...
;
 ...
 while ( uVar8 != uVar16 );
         ...
         if (( ( ( ( ( ( param_4 != 0 ) && ( *param_3 = local_960 ),param_4 != 1 ) ) && ( param_3[1] = local_920 ),param_4 != 2 ) ) && ( ( param_3[2] = local_910 ),param_4 != 3 && ( param_3[3] = local_950 ),param_4 != 4 ) )) {
            param_3[9] = local_8d0;
         }
      ...
      if (( ( param_2 & 0x20000 ) == 0 ) || ( iVar5 = gxv_load_table(param_1, 0x62736c6e, &local_950, &local_948) ),iVar5 == 0) {
         if (param_4 < 8) {
            if (param_4 == 4) {
 ...
 else if (( ( param_2 & 0x200000 ) != 0 ) && ( iVar5 = gxv_load_table(param_1, 0x7472616b, &local_940, &local_938) ),iVar5 != 0) goto LAB_001066f0;
         if (( ( param_2 & 0x40000 ) == 0 ) || ( iVar5 = gxv_load_table(param_1, 0x6a757374, &local_930, &local_928) ),iVar5 == 0) {
   ...
   LAB_001066f0:ft_mem_free(local_968, local_960);
   local_960 = (int*)0x0;
   ...
   local_8d0 = (int*)0x0;
   LAB_0010683a:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar5;
   }

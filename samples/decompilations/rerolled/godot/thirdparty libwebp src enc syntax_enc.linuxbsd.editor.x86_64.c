...
ulong VP8EncWrite(long param_1) {
 ...
 while ( (char*)( param_1 + 0xe23 ) != pcVar24 );
      ...
      if (( iVar11 != 0 ) && ( iVar11 = VP8PutBitUniform(lVar23, *(int*)( param_1 + 0x1c ) != 0) ),iVar11 != 0) {
...
;
 ...
 while ( iVar14 != iVar12 + -1 );
      ...
      *(int*)( param_1 + 0x5c00 ) = (int)uVar1 + 8;
      if (( (int)uVar26 == 0 ) || ( iVar12 = WebPReportProgress(lVar5, iVar3 + 0x13, param_1 + 0x218) ),iVar12 == 0) goto LAB_00100569;
   }

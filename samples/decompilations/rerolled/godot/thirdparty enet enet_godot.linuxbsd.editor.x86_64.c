      ...
      if (pOVar3 != pOVar6) {
         ...
         if (cVar1 == '\0') {
            ...
            if (pOVar6 != (Object*)0x0) {
               cVar1 = RefCounted::unreference();
               joined_r0x00100443:if (( cVar1 != '\0' ) && ( cVar1 = predelete_handler(pOVar6) ),cVar1 != '\0') goto LAB_00100496;
            }
...
undefined8 enet_host_dtls_client_setup(undefined8 *param_1, int param_2, Object *param_3) {
   ...
   if (cVar4 == '\0') {
      ...
      cVar4 = RefCounted::unreference();
      joined_r0x0010098f:if (( cVar4 != '\0' ) && ( cVar4 = predelete_handler(pOVar6) ),cVar4 != '\0') {
         ...
         do {
            if (*(int*)( *(long*)( this + 0x28 ) + lVar8 ) != 0) {
               *(int*)( *(long*)( this + 0x28 ) + lVar8 ) = 0;
               ...
               if (( *(long*)( (long)pvVar4 + 0x18 ) != 0 ) && ( cVar7 = RefCounted::unreference() ),cVar7 != '\0') {
...
cVar4 = RefCounted::unreference();if (( cVar4 != '\0' ) && ( cVar4 = predelete_handler(pOVar5) ),cVar4 != '\0') {
   ( **(code**)( *(long*)pOVar5 + 0x140 ) )(pOVar5);
   Memory::free_static(pOVar5, false);
}

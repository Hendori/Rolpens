/* SubViewportContainer::is_stretch_enabled() const */SubViewportContainer SubViewportContainer::is_stretch_enabled(SubViewportContainer *this) {
   return this[0xa00];
}
/* SubViewportContainer::get_stretch_shrink() const */undefined4 SubViewportContainer::get_stretch_shrink(SubViewportContainer *this) {
   return *(undefined4*)( this + 0xa04 );
}
/* SubViewportContainer::get_allowed_size_flags_vertical() const */SubViewportContainer * SubViewportContainer::get_allowed_size_flags_vertical(SubViewportContainer * this) * (undefined8*)( this + 8 ) = 0 ;return this;}/* SubViewportContainer::set_mouse_target(bool) */void SubViewportContainer::set_mouse_target(SubViewportContainer *this, bool param_1) {
   this[0xa08] = (SubViewportContainer)param_1;
   return;
}
/* SubViewportContainer::is_mouse_target_enabled() */SubViewportContainer SubViewportContainer::is_mouse_target_enabled(SubViewportContainer *this) {
   return this[0xa08];
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* SubViewportContainer::recalc_force_viewport_sizes() [clone .part.0] */void SubViewportContainer::recalc_force_viewport_sizes(SubViewportContainer *this) {
   int iVar1;
   long lVar2;
   Vector2i *pVVar3;
   int iVar4;
...
/* SubViewportContainer::set_stretch(bool) */void SubViewportContainer::set_stretch(SubViewportContainer *this, bool param_1) {
...
/* SubViewportContainer::set_stretch_shrink(int) */void SubViewportContainer::set_stretch_shrink(SubViewportContainer *this, int param_1) {
   if (param_1 < 1) {
      _err_print_error("set_stretch_shrink", "scene/gui/subviewport_container.cpp", 0x47, "Condition \"p_shrink < 1\" is true.", 0, 0);
      return;
   }
...
/* SubViewportContainer::get_minimum_size() const */undefined8 SubViewportContainer::get_minimum_size(SubViewportContainer *this) {
   int iVar1;
   long lVar2;
   int iVar3;
   long in_FS_OFFSET;
...
/* SubViewportContainer::remove_child_notify(Node*) */void SubViewportContainer::remove_child_notify(SubViewportContainer *this, Node *param_1) {
   long lVar1;
   if (param_1 == (Node*)0x0) {
      return;
   }
...
/* SubViewportContainer::recalc_force_viewport_sizes() */void SubViewportContainer::recalc_force_viewport_sizes(SubViewportContainer *this) {
   if (this[0xa00] != (SubViewportContainer)0x0) {
      recalc_force_viewport_sizes(this);
      return;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* SubViewportContainer::_notification(int) */void SubViewportContainer::_notification(SubViewportContainer *this, int param_1) {
   char cVar1;
   int iVar2;
   long lVar3;
   Object *pOVar4;
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);if (initialize_class()::initialized == '\0') {

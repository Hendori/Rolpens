            ...
            *(undefined8*)( param_2 + 0x18 ) = 0;
            ...
            if (( lVar8 != 0 ) && ( *(long*)( lVar8 + 0x80 ) != 0 )) {
               ...
               if (*(long*)( lVar8 + 0x80 ) != 0) {
                  ...
                  if (( ( ( plVar9 != (long*)0x0 ) && ( lVar21 = *(long*)( lVar8 + 0x90 ) + *plVar9 * 0x18 ),lVar21 != 0 ) ) && ( *(int*)( lVar21 + 8 ) == 1 )) &&
                 (((pbVar15 = *(byte **)(lVar21 + 0x10), pbVar15 != (byte *)0x0 && (*pbVar15 != 0))
                  && ((*pbVar15 & 0xdf) != 0x4e)))) {
                local_78._8_8_ = pbVar15;
               }

               if (( ( *(long*)( lVar8 + 0x80 ) != 0 ) && ( plVar9 = (long*)ft_hash_str_lookup("ADD_STYLE_NAME") ),plVar9 != (long*)0x0 )) &&
   ...
   if (iVar14 == 0) {
      ...
      if (( uVar15 & 0x20 ) == 0) {
         ...
         if (( ( iVar14 == 0 ) && ( (byte)param_1[5] < 0x21 ) ) && ( ( 0xfffffffeffffd9feU >> ( (ulong)(byte)param_1[5] & 0x3f ) & 1 ) == 0 )) {
            ...
            if (( ( param_2 == 0 ) || ( *param_1 == '\0' ) ) || ( local_4c = bdf_list_split__part_0(param_5 + 9, &_LC9, param_1, param_2) ),local_4c == 0) {
         ...
         if (( ( iVar14 == 0 ) && ( (byte)param_1[8] < 0x21 ) ) && ( ( 0xfffffffeffffd9feU >> ( (ulong)(byte)param_1[8] & 0x3f ) & 1 ) == 0 )) {
            ...
            if (( ( param_2 != 0 ) && ( *param_1 != '\0' ) ) && ( local_4c = bdf_list_split__part_0(param_5 + 9, &_LC9, param_1, param_2) ),local_4c != 0) goto LAB_00103834;
            uVar15 = param_5[9];

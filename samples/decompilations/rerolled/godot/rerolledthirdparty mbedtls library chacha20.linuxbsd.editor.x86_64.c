...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 mbedtls_chacha20_setkey(undefined8 *param_1, undefined4 *param_2) {
   undefined8 uVar1;
   uVar1 = _UNK_001010c8;
   *param_1 = __LC0;
   param_1[1] = uVar1;
   ...
   *(undefined4*)( (long)param_1 + 0x14 ) = param_2[1];
   for (int i = 0; i < 3; i++) {
      *(undefined4*)( param_1 + ( i + 3 ) ) = param_2[( 2*i + 2 )];
      *(undefined4*)( (long)param_1 + ( 8*i + 28 ) ) = param_2[( 2*i + 3 )];
   }
            ...
            if (0x3f < uVar4) {
               ...
               do {
                  ...
                  *(int*)( param_1 + 0x30 ) = *(int*)( param_1 + 0x30 ) + 1;
                  lVar2 = 0;
                  do {
                     *(ulong*)( lVar6 + lVar2 ) = *(ulong*)( lVar7 + lVar2 ) ^ *(ulong*)( param_1 + 0x40 + lVar2 );
                     lVar2 = lVar2 + 8;
                  }
 while ( lVar2 != 0x40 );
                  lVar6 = lVar6 + 0x40;
 ...
 while ( lVar6 != param_4 + 0x40 + lVar5 + ( uVar3 & 0xffffffffffffffc0 ) );
            ...
            *(int*)( param_1 + 0x30 ) = *(int*)( param_1 + 0x30 ) + 1;
            if (uVar4 < 8) {
               ...
               do {
                  uVar3 = uVar1;
                  *(ulong*)( param_4 + lVar5 + -8 + uVar3 ) = *(ulong*)( param_3 + lVar5 + -8 + uVar3 ) ^ *(ulong*)( param_1 + 0x38 + uVar3 );
                  uVar1 = uVar3 + 8;
               }
 while ( uVar3 + 8 <= uVar4 );
            ...
            do {
               *(byte*)( param_4 + lVar5 + uVar3 ) = *(byte*)( param_3 + lVar5 + uVar3 ) ^ *(byte*)( param_1 + 0x40 + uVar3 );
               uVar3 = uVar3 + 1;
            }
 while ( uVar3 != uVar4 );
            LAB_00100577:*(ulong*)( param_1 + 0x80 ) = uVar4;
            return 0;
         }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined4 mbedtls_chacha20_crypt(undefined8 *param_1, undefined4 *param_2, undefined4 param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6) {
   undefined4 uVar1;
   long in_FS_OFFSET;
   undefined8 local_c8;
...
undefined8 mbedtls_chacha20_self_test(int param_1) {
   ...
   if (param_1 == 0) {
      ...
      if (( ( iVar1 == 0 ) && ( local_1a8 == -0x6fc20e5f521f478a && local_1a0 == 0x28bd8653e56a5d40 ) ) && ( ( local_198 == 0x1aed8da0b819d2bd && local_190 == -0x38f288743310c958 && ( ( local_188 == -0x72b7a8ae83a6be26 && local_180 == 0x374ad8b83fe02477 && ( local_178 == 0x1ca11815f4b8436a && local_170 == -0x799a114d9649783d ) ) ) ) )) {
         iVar1 = mbedtls_chacha20_crypt(0x1010a0, 0x10105c, 1, 0x177, "Any submission to the IETF intended by the Contributor for publication as all or part of an IETF Internet-Draft or RFC and any statement made within the context of an IETF activity is considered an \"IETF Contribution\". Such statements include oral statements in IETF sessions, as well as written and electronic communications made at any time or place, which are addressed to", &local_1a8);
         if (iVar1 == 0) {
      ...
      iVar1 = mbedtls_chacha20_crypt(test_keys, test_nonces, 0, 0x40, &test_input, &local_1a8);
      if (iVar1 == 0) {
         if (( ( ( local_1a8 == -0x6fc20e5f521f478a && local_1a0 == 0x28bd8653e56a5d40 ) && ( local_198 == 0x1aed8da0b819d2bd && local_190 == -0x38f288743310c958 ) ) && ( local_188 == -0x72b7a8ae83a6be26 && local_180 == 0x374ad8b83fe02477 ) ) && ( local_178 == 0x1ca11815f4b8436a && local_170 == -0x799a114d9649783d )) {
            puts("passed");
         ...
         LAB_001009f0:__printf_chk(2, "error code: %i\n", iVar1);
      }

   }

   uVar2 = 0xffffffff;
   LAB_00100851:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar2;
   }

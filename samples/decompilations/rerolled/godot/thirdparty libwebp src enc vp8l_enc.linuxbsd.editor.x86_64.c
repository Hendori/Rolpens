...
undefined8 AllocateTransformBuffer(long param_1, int param_2, int param_3) {
   ...
   iVar6 = 1 << ( bVar5 & 0x1f );
   lVar2 = ( ulong )(( uint )(iVar6 + -1 + param_2) >> ( bVar5 & 0x1f )) * ( ulong )(( uint )(iVar6 + -1 + param_3) >> ( bVar5 & 0x1f ));
   LAB_001000cd:lVar3 = *(long*)( param_1 + 0x30 );
...
undefined8 GetHuffBitLengthsAndCodes(int *param_1, int *param_2) {
 ...
 while ( lVar8 != (long)iVar2 * 8 );
         LAB_00100379:WebPSafeFree(lVar6);
         WebPSafeFree(lVar11);
         return 1;
      }
   ...
   WebPSafeFree(lVar6);
   WebPSafeFree(lVar11);
   LAB_0010040f:WebPSafeFree(lVar8);
...
undefined8 EncoderInit(long param_1) {
   ...
   if ((int)uVar1 != 0) {
      ...
      iVar2 = ( iVar3 >> 4 ) + 1;
      for (int i = 0; i < 4; i++) {
         VP8LBackwardRefsInit(param_1 + ( 40*i + 2152 ), iVar2);
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 ApplyPalette(uint *param_1, uint param_2, long param_3, uint param_4, uint *param_5, int param_6, int param_7, uint param_8, undefined4 param_9, undefined8 param_10) {
   code *pcVar1;
   uint uVar2;
   int iVar3;
   undefined1 *puVar4;
...
;
 ...
 while ( param_8 != uVar15 );
      ...
      LAB_001006cd:WebPSafeFree(puVar4);
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
undefined8 StoreImageToBitMask(ulong *param_1, int param_2, int param_3, undefined8 param_4, ushort *param_5, long param_6, undefined8 param_7) {
   byte bVar1;
   ushort uVar2;
   long lVar3;
   long lVar4;
   ...
   if (local_58[0] != (char*)0x0) {
      ...
      do {
         ...
         if (( uVar18 != uVar20 ) || ( uVar23 != uVar19 )) {
            lVar8 = param_6 + (long)(int)( (uint)param_5[(int)( ( (int)uVar16 >> ( bVar10 & 0x1f ) ) * local_90 + ( (int)uVar14 >> ( bVar10 & 0x1f ) ) )] + (uint)param_5[(int)( ( (int)uVar16 >> ( bVar10 & 0x1f ) ) * local_90 + ( (int)uVar14 >> ( bVar10 & 0x1f ) ) )] * 4 ) * 0x18;
         }
...
;
            ...
            if (uVar2 < 0x200) {
               ...
               if (0 < iVar21) {
                  ...
                  uVar20 = ( uint )(byte)(&kPrefixEncodeExtraBitsValue)[uVar13] << ( bVar1 & 0x1f ) | ( uint ) * (ushort*)( lVar3 + (long)( (char)( &kPrefixEncodeCode )[uVar13 * 2] + 0x100 ) * 2 );
               ...
               uVar20 = ( uVar20 & ( 1 << ( bVar11 & 0x1f ) ) - 1U ) << ( bVar1 & 0x1f ) | ( uint ) * (ushort*)( lVar3 + lVar22 * 2 );
               iVar12 = (int)param_1[1];
               joined_r0x0010104e:if (0x1f < iVar12) {
                  VP8LPutBitsFlushBits(param_1);
                  iVar12 = (int)param_1[1];
               }
         ...
         for (uVar14 = uVar14 + *(ushort*)( pcVar5 + 2 ); param_2 <= (int)uVar14; uVar14 = uVar14 - param_2) {
            uVar16 = uVar16 + 1;
         }
 ...
 while ( ( local_58[0] != local_48 ) || ( VP8LRefsCursorNextBlock(local_58),local_58[0] != (char*)0x0 ) );
   }
...
void StoreHuffmanCode(ulong *param_1, undefined8 param_2, byte *param_3, int *param_4) {
 ...
 while ( local_78[( byte )(&DAT_0010477f)[lVar5]] == '\0' );
         ...
         joined_r0x001016c7:if (iVar8 < 0x20) {
 ...
 while ( pbVar6 != &kStorageOrder_2 + lVar14 );
         ...
         if (iVar3 < 1) {
            ...
            LAB_00101740:VP8LPutBitsFlushBits(param_1);
            *(int*)( param_1 + 1 ) = (int)param_1[1] + 1;
            ...
            iVar8 = 0;
            LAB_00101502:bVar1 = param_3[lVar14 * 2];
            iVar11 = (int)lVar14;
            if (( bVar1 == 0 ) || ( bVar1 == 0x11 )) {
               ...
               joined_r0x0010152d:if (lVar14 + -1 == ( (long)iVar3 + -2 ) - ( ulong )(iVar3 - 1U)) goto LAB_00101532;
               lVar14 = lVar14 + -1;
               goto LAB_00101502;
            }
            ...
            iVar11 = iVar11 + 1;
            LAB_00101532:if (( iVar11 < 2 ) || ( iVar8 < 0xd )) {
 ...
 while ( param_3 != pbVar6 );
   ...
   *(int*)( param_1 + 1 ) = iVar8 + 4;
   LAB_0010168a:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
bool EncodeImageNoHuffman(long param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined4 param_5, undefined4 param_6, undefined4 param_7, undefined4 param_8, long param_9, int param_10, undefined8 param_11) {
   int iVar1;
   long lVar2;
   long lVar3;
   long lVar4;
   ...
   if (lVar4 != 0) {
      iVar1 = VP8LHashChainFill(param_3, param_7, param_2, param_5, param_6, param_8, param_9, param_10 / 2, param_11);
      if (( iVar1 == 0 ) || ( iVar1 = VP8LGetBackwardReferences(param_5, param_6, param_2, param_7, 0, 3, local_c0, 0, param_3, param_4, &local_c0, param_9, param_10 - param_10 / 2, param_11) ),iVar1 == 0) {
         lVar2 = 0;
         lVar3 = 0;
         goto LAB_00101a53;
      }
 ...
 while ( plVar6 != local_40 );
   ...
   lVar3 = 0;
   WebPEncodingSetError(param_9, 1);
   LAB_00101a53:WebPSafeFree(lVar3);
   WebPSafeFree(lVar4);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */bool EncodeStreamHook(long *param_1) {
   long *plVar1;
   uint *puVar2;
   size_t __n;
   ushort uVar3;
   ...
   if (iVar21 == 0) {
      LAB_0010211b:WebPEncodingSetError(lVar10, 1);
   }
 else {
      if (iVar4 < 2) {
         ...
         do {
            ...
            *(undefined4*)( (long)plVar13 + 0x4c ) = 0;
            ...
            if (( *(int*)( lVar11 + 0x5c ) < 100 ) && ( plVar13[0xb] == 0 )) {
               ...
               if (( (int)plVar13[3] != 2 ) && ( iVar21 = VP8ApplyNearLossless(lVar10, *(undefined4*)( lVar11 + 0x5c ), plVar13[2]) ),iVar21 == 0) goto LAB_0010211b;
               *(undefined4*)( plVar13 + 3 ) = 2;
               if (*(int*)( (long)plVar13 + 0x5c ) != 0) {
                  lVar49 = plVar13[1];
                  LAB_00101ef5:iVar21 = PaletteSort(local_640[1], lVar49, (long)plVar13 + 0x464, (int)plVar13[0xc]);
                  if (iVar21 == 0) {
                  ...
                  *puVar12 = (ulong)uVar26 << ( (byte)iVar21 & 0x3f ) | uVar42;
                  while (0 < (int)uVar26) {
                     ...
                     local_448[lVar41] = ( uVar25 | 0xff00ff00 ) - ( uVar26 & 0xff00ff ) & 0xff00ff | ( uVar25 | 0xff00ff ) - ( uVar26 & 0xff00ff00 ) & 0xff00ff00;
                     lVar41 = lVar41 + -1;
                     uVar26 = (uint)lVar41;
                  }
;
                  local_448[0] = *(uint*)( (long)plVar13 + 100 );
                  iVar21 = EncodeImageNoHuffman(puVar12, local_448, plVar13 + 0x121, plVar1, (int)lVar49, 1, 0x14, bVar51, plVar13[1], (int)uVar23 >> 2, &local_520);
                  if (iVar21 == 0) goto LAB_001020a0;
                  lVar49 = plVar13[1];
                  ...
                  if (( iVar24 == 0 ) || ( iVar21 = ApplyPalette(uVar15, uVar9, plVar13[2], (int)plVar13[8], (long)plVar13 + 100, iVar21, iVar39, uVar31, cVar48, lVar49) ),iVar21 == 0) goto LAB_001020a0;
 ...
 while ( iVar21 != iVar39 );
            ...
            if (iVar21 != 0) {
               ...
               iVar39 = VP8LResidualImage((int)lVar49, iVar8, iVar21, bVar51, plVar13[2], plVar13[4], plVar13[5], uVar31, *(undefined4*)( *plVar13 + 0x60 ), *(undefined4*)( (long)plVar13 + 0x54 ), plVar13[1], (ulong)local_610 / 6, &local_520);
               ...
               *puVar12 = *puVar12 | ( ulong )(iVar21 - 2) << ( (byte)iVar39 & 0x3f );
               iVar21 = EncodeImageNoHuffman(puVar12, plVar13[5], plVar13 + 0x121, plVar1, ( uint )((int)lVar49 + -1 + iVar24) >> ( bVar38 & 0x1f ), ( uint )(iVar24 + iVar8 + -1) >> ( bVar38 & 0x1f ), iVar22, bVar51, plVar13[1], local_610 / 3 - local_610 / 6, &local_520);
               if (iVar21 == 0) goto LAB_001020a0;
            ...
            if ((int)plVar13[10] != 0) {
               ...
               iVar39 = VP8LColorSpaceTransform((int)lVar49, iVar8, iVar21, iVar22, plVar13[2], plVar13[5], plVar13[1], (int)uVar26 >> 2, &local_520);
               if (iVar39 == 0) goto LAB_001020a0;
               iVar39 = (int)puVar12[1];
               if (0x1f < iVar39) {
                  VP8LPutBitsFlushBits(puVar12);
               ...
               *puVar12 = ( ulong )(iVar21 - 2) << ( (byte)iVar39 & 0x3f ) | uVar42;
               iVar21 = EncodeImageNoHuffman(puVar12, plVar13[5], plVar13 + 0x121, plVar1, ( uint )((int)lVar49 + -1 + iVar24) >> ( bVar38 & 0x1f ), ( uint )(iVar24 + iVar8 + -1) >> ( bVar38 & 0x1f ), iVar22, bVar51, plVar13[1], (int)local_610 / 2 - ( (int)uVar26 >> 2 ), &local_520);
               if (iVar21 == 0) goto LAB_001020a0;
            ...
            *(int*)( puVar12 + 1 ) = iVar21 + 1;
            ...
            if (( ( ( iVar21 == 0 ) || ( lVar41 == 0 ) ) || ( lVar33 == 0 ) ) || ( iVar21 = iVar21 == 0 )) {
               LAB_00102130:WebPEncodingSetError(lVar10, 1);
            }
 else {
               iVar21 = VP8LHashChainFill(plVar13 + 0x121, iVar22, lVar49, iVar24, iVar8, bVar51, lVar10, (int)local_610 / 5, &local_520);
               if (iVar21 != 0) {
                  ...
                  if (0 < (int)uVar44) {
                     ...
                     do {
                        ...
                        iVar28 = VP8LGetBackwardReferences(iVar24, iVar8, lVar49, iVar22, bVar51, local_640[lStack_5c0 * 2 + 2], iVar21, local_640[lStack_5c0 * 2 + 3], plVar13 + 0x121, plVar1, &iStack_51c, lVar10, iVar27 >> 2, &local_520);
                        local_630 = plVar1;
                        iVar27 = iStack_51c;
                        if (iVar28 == 0) {
                           lVar35 = 0;
                           piVar34 = (int*)0x0;
                           LAB_00103141:WebPSafeFree(0);
                           WebPSafeFree(lVar41);
                        ...
                        do {
                           ...
                           iVar28 = VP8LGetHistoImageSymbols(iVar24, iVar8, local_630, iVar22, bVar51, iVar39, iVar27, piVar34, lVar35, lVar33, lVar10, iVar28, &local_520);
                           if (iVar28 == 0) goto LAB_00103141;
                           iVar28 = *piVar34;
                           iVar30 = iVar28 * 5;
                           piVar36 = (int*)WebPSafeCalloc((long)iVar30, 0x18);
                           if (( piVar36 == (int*)0x0 ) || ( iVar29 = iVar29 == 0 )) {
                              WebPEncodingSetError(lVar10, 1);
                              WebPSafeFree(0);
                              WebPSafeFree(lVar41);
                              VP8LFreeHistogramSet(piVar34);
                              ...
                              VP8LHashChainClear(auStack_518);
                              if (piVar36 != (int*)0x0) {
                                 LAB_00102a4d:WebPSafeFree(*(undefined8*)( piVar36 + 4 ));
 ...
 while ( uVar42 != uVar43 );
                              ...
                              *(int*)( puVar12 + 1 ) = iVar28 + 3;
                              iVar28 = iStack_608 / 2;
                              iStack_608 = iStack_608 - iVar28;
                              iVar28 = EncodeImageNoHuffman(puVar12, lVar35, auStack_518, plVar13 + 0x117, uVar25, uVar26, iVar22, bVar51, lVar10, iVar28, &local_520);
                              if (iVar28 != 0) {
                                 WebPSafeFree();
                                 iVar30 = uVar44 * 5;
                              ...
                              WebPSafeFree(lVar35);
                              LAB_00102ed2:lVar35 = 0;
                              LAB_00102ed4:WebPSafeFree(lVar35);
                              WebPSafeFree(lVar41);
                           ...
                           if (iVar30 < 1) {
                              LAB_00102ea4:lVar35 = WebPSafeMalloc(0, 2);
                              if (lVar35 == 0) goto LAB_00102ebc;
                           }
 else {
                              LAB_00102854:lVar35 = 0;
                              piVar34 = piVar36;
                              ...
                              for (piVar34 = piVar36 + 6; piVar34 != piVar36 + (long)iVar30 * 6; piVar34 = piVar34 + 0xc) {
                                 LAB_00102880:if ((int)lVar35 < *piVar34) {
                                    lVar35 = (long)*piVar34;
                                 }
                              ...
                              piVar34 = piVar36;
                              if (lVar35 == 0) {
                                 LAB_00102ebc:WebPEncodingSetError(lVar10, 1);
                                 goto LAB_00102ed2;
                              }
 ...
 while ( local_640 != puVar2 );
   ...
   LAB_001020a0:VP8LBitWriterWipeOut(local_4d8);
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */ulong VP8LEncodeStream(long param_1, long param_2, long param_3) {
   float *pfVar1;
   int iVar2;
   long lVar3;
   uint *puVar4;
      ...
      if (iVar5 != 0) {
         ...
         if (iVar5 == 0) {
            ...
            *(int*)( plVar8 + 0xc ) = iVar6;
            ...
            bVar13 = (byte)iVar14;
            iVar7 = 1 << ( bVar13 & 0x1f );
            for (iVar7 = ( ( uint )(iVar21 + -1 + iVar7) >> ( bVar13 & 0x1f ) ) * ( ( uint )(iVar7 + iVar20 + -1) >> ( bVar13 & 0x1f ) ); 0xa28 < iVar7; iVar7 = ( ( uint )(iVar7 + iVar21 + -1) >> ( bVar13 & 0x1f ) ) * ( ( uint )(iVar7 + iVar20 + -1) >> ( bVar13 & 0x1f ) )) {
               iVar14 = iVar14 + 1;
               bVar13 = (byte)iVar14;
               iVar7 = 1 << ( bVar13 & 0x1f );
            }
            ...
            *(int*)( (long)plVar8 + 0x44 ) = iVar14;
            if (3 < iVar2) {
               ...
               LAB_00103456:iVar21 = (int)plVar8[0xc];
               ...
               if (( iVar6 < 0x101 ) && ( iVar21 < 0x11 )) {
                  if (iVar2 != 6) {
                     ...
                     if (( iVar2 == 5 ) && ( __LC1 <= *(float*)( lVar3 + 4 ) )) {
                        LAB_00103dd5:uVar30 = 2;
                        iVar5 = 1;
                        local_52c = 0x100000005;
                        goto LAB_0010360c;
                     }

                     LAB_001034d8:uVar30 = 1;
                     iVar5 = 0;
                     goto LAB_0010360c;
                  }
                  ...
                  if (*(float*)( lVar3 + 4 ) != __LC0) {
                     local_548[0] = 4;
                     uVar34 = 1;
                     LAB_001034c6:local_548[1] = 1;
                     goto LAB_001034d8;
                  }

                  LAB_001041c1:uVar30 = 0;
                  iVar5 = 0;
                  while (true) {
...
;
                     ...
                     do {
                        ...
                        if (0 < iVar5) {
                           do {
                              ...
                              uVar32 = (ulong)uVar30;
                              uVar24 = ( ( uVar30 & 0xff00ff ) - ( (uint)uVar17 & 0xff00ff ) ) - 0xff0100 & 0xff00ff | ( ( uVar30 & 0xff00ff00 ) - ( (uint)uVar17 & 0xff00ff00 ) ) + 0xff00ff & 0xff00ff00;
                              uVar17 = (ulong)uVar24;
                              if (( uVar24 != 0 ) && ( ( puVar31 == (uint*)0x0 || ( uVar30 != *(uint*)( (long)puVar31 + lVar29 ) ) ) )) {
                                 AddSingle(uVar30, lVar16, lVar16 + 0x1000, lVar16 + 0x800, lVar16 + 0x1800);
                                 iVar25 = (int)uVar17;
                                 AddSingle(uVar17 & 0xffffffff, lVar16 + 0x400, lVar16 + 0x1400, lVar16 + 0xc00, lVar16 + 0x1c00);
                                 iVar26 = (int)uVar32;
                                 piVar10 = (int*)( lVar16 + 0x2000 + ( ulong )(( iVar26 >> 0x10 ) - ( iVar26 >> 8 ) & 0xff) * 4 );
                                 *piVar10 = *piVar10 + 1;
                                 piVar10 = (int*)( lVar16 + 0x2800 + ( ulong )(iVar26 - ( iVar26 >> 8 ) & 0xff) * 4 );
                                 *piVar10 = *piVar10 + 1;
                                 piVar10 = (int*)( lVar16 + 0x2400 + ( ulong )(( iVar25 >> 0x10 ) - ( iVar25 >> 8 ) & 0xff) * 4 );
                                 *piVar10 = *piVar10 + 1;
                                 piVar10 = (int*)( lVar16 + 0x2c00 + ( ulong )(iVar25 - ( iVar25 >> 8 ) & 0xff) * 4 );
                                 *piVar10 = *piVar10 + 1;
                                 piVar10 = (int*)( lVar16 + ( ulong )(( ( ( ( uint )(uVar32 >> 0x13) & 0x1fff ) + iVar26 ) * 0x39c5fba7 >> 0x18 ) + 0xc00) * 4 );
                                 *piVar10 = *piVar10 + 1;
                              }
 ...
 while ( local_1c4 != puVar22 );
                  ...
                  fVar37 = (float)( ( ( uint )(iVar5 + -1 + iVar20) >> ( bVar13 & 0x1f ) ) * ( ( uint )(iVar15 + -1 + iVar20) >> ( bVar13 & 0x1f ) ) );
                  fVar35 = (float)local_1e8 + (float)local_1f8 + (float)uStack_1f0 + (float)local_1e0;
                  fVar36 = local_1e8._4_4_ + local_1f8._4_4_ + uStack_1f0._4_4_ + local_1e0._4_4_ + _DAT_001051b0 * fVar37;
                  local_3b8 = CONCAT44(fVar36, fVar35);
                  uStack_3b0 = CONCAT44(local_1f8._4_4_ + local_1d4 + uStack_1f0._4_4_ + local_1cc + fVar37 * _DAT_001051d8, local_1d8 + (float)local_1f8 + (float)uStack_1f0 + local_1d0);
 ...
 while ( (int)uVar17 <= (int)uVar30 );
                  ...
                  do {
                     if (piVar12[(ulong)bVar13 * -0x100 + (ulong)(byte)kHistoPairs_0[uVar32 * 2 + 1] * 0x100] != 0 || *piVar12 != 0) {
                        uVar34 = 0;
                        goto LAB_00104125;
                     }
 ...
 while ( piVar12 != piVar10 + (ulong)bVar13 * 0x100 );
                  uVar34 = 1;
                  LAB_00104125:WebPSafeFree(lVar16);
                  if (iVar2 == 6) {
               ...
               LAB_00103b98:WebPEncodingSetError(param_2, 1);
               goto LAB_0010328c;
            }
            ...
            *(int*)( plVar8 + 9 ) = iVar20;
            ...
            iVar5 = 0;
            LAB_0010360c:piVar10 = local_548 + 2;
            iVar15 = 0;
            do {
               *piVar10 = 3;
               piVar10[1] = iVar5;
 ...
 while ( iVar15 < (int)uVar30 );
            LAB_00103649:iVar5 = EncoderInit(plVar8);
            ...
            if (*(int*)( param_1 + 0x54 ) < 1) {
               ...
               LAB_00103e1b:local_208 = *(undefined8*)( param_2 + 0x80 );
               local_3b8 = param_1;
               uStack_3b0 = param_2;
               local_3a8 = param_3;
               ...
               plVar11 = (long*)0x0;
               LAB_00103935:iVar5 = ( *(code*)puVar9[1] )(local_768);
 ...
 else if (( ulong )((long)( local_730 + 7 >> 3 ) + ( local_720 - local_728 )) < ( ulong )(( *(long*)( param_3 + 0x18 ) - *(long*)( param_3 + 0x10 ) ) + (long)( *(int*)( param_3 + 8 ) + 7 >> 3 ))) {
               ...
               if ((int)uVar30 < 2) {
                  ...
                  local_210 = uVar24;
                  if (0 < (int)uVar24) {
                     LAB_001036f0:memcpy(local_398, local_548, (ulong)uVar24 * 0x1c);
                     goto LAB_00103712;
                  }
               ...
               local_1f8 = param_1;
               local_4c = uVar34;
               WebPPictureView(param_2, 0, 0, *(undefined4*)( param_2 + 8 ), *(undefined4*)( param_2 + 0xc ), local_648);
               local_5b8 = 0;
               ...
               LAB_00103bbf:WebPEncodingSetError(param_2, 1);
            }
         ...
         for (int i = 0; i < 4; i++) {
            VP8LBackwardRefsClear(plVar8 + ( 5*i + 269 ));
         }
         ...
         if (plVar11 != (long*)0x0) {
            ...
            for (int i = 0; i < 4; i++) {
               VP8LBackwardRefsClear(plVar11 + ( 5*i + 269 ));
            }
   ...
   LAB_00103552:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar17;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */ulong VP8LEncodeImage(long param_1, long param_2) {
   int iVar1;
   int iVar2;
   undefined8 *puVar3;
   int *piVar4;
   ...
   if (puVar3 != (undefined8*)0x0) {
      ...
      *(undefined8*)( (long)puVar3 + 0xb4 ) = 0;
      ...
      for (uVar9 = ( ulong )(( (int)puVar3 - (int)(undefined8*)( ( ulong )(puVar3 + 1) & 0xfffffffffffffff8 ) ) + 0xbcU >> 3); uVar9 != 0; uVar9 = uVar9 - 1) {
         *puVar12 = 0;
   ...
   if (local_60 == 0) {
      ...
      if (iVar11 == 0) {
         LAB_001046e0:WebPEncodingSetError(param_2, 10);
      }
 else {
         ...
         if (iVar11 != 0) {
            ...
            if (local_60 == 0) {
               ...
               if (iVar7 == 0) {
                  LAB_00104739:iVar11 = WebPEncodingSetError(param_2, 8);
                  goto LAB_00104746;
               }
               ...
               LAB_00104746:if (iVar11 == 0) goto LAB_00104635;
               iVar11 = 0;
            }
      ...
      LAB_00104628:WebPEncodingSetError(param_2, 1);
   }

   LAB_00104635:if (local_60 != 0) {
      WebPEncodingSetError(param_2, 1);
   }

   VP8LBitWriterWipeOut(&local_88);
   uVar9 = ( ulong )(*(int*)( param_2 + 0x88 ) == 0);
   LAB_00104657:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar9;
   }

/* tvg::TaskScheduler::init(unsigned int) */void tvg::TaskScheduler::init(uint param_1) {
...
/* tvg::TaskScheduler::term() */ulong tvg::TaskScheduler::term(void) {
 ...
 while ( plVar12 < plVar8 + uVar9 );
   ...
   while (true) {
      ...
      LAB_00100250:puVar11 = *(undefined8**)( puVar5[2] + ( ( ulong )((uint)uVar9 + uVar13) % (ulong)uVar6 ) * 8 );
...
;
   ...
   pthread_mutex_unlock((pthread_mutex_t*)( puVar11 + 2 ));
   LAB_001002a7:uVar9 = std::condition_variable::notify_one();
   return uVar9;
}
/* tvg::TaskScheduler::request(tvg::Task*) */ulong tvg::TaskScheduler::request(Task *param_1) {
   uint *puVar1;
   uint uVar2;
   undefined8 *puVar3;
   undefined8 uVar4;
   ...
   *puVar1 = *puVar1 + 1;
   ...
   uVar10 = 0;
   do {
      puVar3 = *(undefined8**)( *(long*)( lVar6 + 0x10 ) + ( ( ulong )(uVar2 + uVar10) % (ulong)uVar9 ) * 8 );
 ...
 while ( uVar10 < uVar9 );
   ...
   pthread_mutex_unlock((pthread_mutex_t*)( puVar3 + 2 ));
   LAB_001002a7:uVar8 = std::condition_variable::notify_one();
   return uVar8;
}
/* tvg::TaskScheduler::threads() */undefined4 tvg::TaskScheduler::threads(void) {
   undefined4 uVar1;
   uVar1 = 0;
   if (inst != 0) {
...
/* tvg::TaskScheduler::async(bool) */void tvg::TaskScheduler::async(bool param_1) {
...
/* std::thread::_State_impl<std::thread::_Invoker<std::tuple<tvg::TaskSchedulerImpl::TaskSchedulerImpl(unsigned
   int)::{lambda()#1}> > >::~_State_impl() */void std::thread::_State_impl<std::thread::_Invoker < std::tuple<tvg::TaskSchedulerImpl::TaskSchedulerImpl(unsigned_int)::{lambda()#1}>>>::~_State_impl(_State_impl<std::thread::_Invoker < std::tuple<tvg::TaskSchedulerImpl::TaskSchedulerImpl(unsigned_int)::_lambda()_1_> >> *this) {
...
/* tvg::TaskSchedulerImpl::TaskSchedulerImpl(unsigned int) */void tvg::TaskSchedulerImpl::TaskSchedulerImpl(TaskSchedulerImpl *this, uint param_1) {
   size_t __size;
   long *plVar1;
   void *pvVar2;
   undefined8 *puVar3;
...
/* tvg::TaskSchedulerImpl::run(unsigned int) */void tvg::TaskSchedulerImpl::run(TaskSchedulerImpl *this, uint param_1) {
...
;
 ...
 while ( uVar8 < uVar6 * 2 );
      ...
      LAB_0010072b:plVar3 = *(long**)( *(long*)( this + 0x10 ) + (ulong)param_1 * 8 );
      ppVar1 = (pthread_mutex_t*)( plVar3 + 2 );
      iVar5 = pthread_mutex_lock(ppVar1);
      if (iVar5 != 0) {
         LAB_00100860:std::__throw_system_error(iVar5);
         LAB_00100867:/* WARNING: Subroutine does not return */__stack_chk_fail();
      }
 ...
 while ( plVar7 == (long*)0x0 );
      ...
      LAB_001006ae:( **(code**)( *plVar7 + 0x10 ) )(plVar7, param_1 + 1);
...
/* std::thread::_State_impl<std::thread::_Invoker<std::tuple<tvg::TaskSchedulerImpl::TaskSchedulerImpl(unsigned
   int)::{lambda()#1}> > >::_M_run() */void std::thread::_State_impl<std::thread::_Invoker < std::tuple<tvg::TaskSchedulerImpl::TaskSchedulerImpl(unsigned_int)::{lambda()#1}>>>::_M_run(_State_impl<std::thread::_Invoker < std::tuple<tvg::TaskSchedulerImpl::TaskSchedulerImpl(unsigned_int)::_lambda()_1_> >> *this) {
   tvg::TaskSchedulerImpl::run(*(TaskSchedulerImpl**)( this + 0x10 ), *(uint*)( this + 8 ));
   return;
}
/* tvg::TaskScheduler::request(tvg::Task*) [clone .cold] */void tvg::TaskScheduler::request(Task *param_1) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* WARNING: Control flow encountered bad instruction data *//* tvg::TaskSchedulerImpl::TaskSchedulerImpl(unsigned int) */void tvg::TaskSchedulerImpl::TaskSchedulerImpl(TaskSchedulerImpl *this, uint param_1) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* std::thread::_State_impl<std::thread::_Invoker<std::tuple<tvg::TaskSchedulerImpl::TaskSchedulerImpl(unsigned
   int)::{lambda()#1}> > >::~_State_impl() */void std::thread::_State_impl<std::thread::_Invoker < std::tuple<tvg::TaskSchedulerImpl::TaskSchedulerImpl(unsigned_int)::{lambda()#1}>>>::~_State_impl(_State_impl<std::thread::_Invoker < std::tuple<tvg::TaskSchedulerImpl::TaskSchedulerImpl(unsigned_int)::_lambda()_1_> >> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

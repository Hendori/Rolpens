/* TPPLPoly::TPPLPoly() */void TPPLPoly::TPPLPoly(TPPLPoly *this) {
...
/* TPPLPoly::Clear() */void TPPLPoly::Clear(TPPLPoly *this) {
   if (*(void**)this != (void*)0x0) {
      operator_delete__(*(void**)this);
   }
...
/* TPPLPoly::Init(long) */void TPPLPoly::Init(TPPLPoly *this, long param_1) {
   void *__s;
   ulong uVar1;
   if (*(void**)this != (void*)0x0) {
      operator_delete__(*(void**)this);
...
/* TPPLPoly::Triangle(Vector2&, Vector2&, Vector2&) */void TPPLPoly::Triangle(TPPLPoly *this, Vector2 *param_1, Vector2 *param_2, Vector2 *param_3) {
   undefined8 uVar1;
   undefined8 *puVar2;
   if (*(void**)this != (void*)0x0) {
      operator_delete__(*(void**)this);
...
/* TPPLPoly::TPPLPoly(TPPLPoly const&) */void TPPLPoly::TPPLPoly(TPPLPoly *this, TPPLPoly *param_1) {
   TPPLPoly TVar1;
   ulong uVar2;
   undefined8 uVar3;
   void *pvVar4;
...
/* TPPLPoly::TEMPNAMEPLACEHOLDERVALUE(TPPLPoly const&) */TPPLPoly * __thiscall TPPLPoly::operator=(TPPLPoly *this,TPPLPoly *param_1){
   TPPLPoly TVar1;
   ulong uVar2;
   void *pvVar3;
   ulong uVar4;
...
/* TPPLPoly::GetOrientation() const */int TPPLPoly::GetOrientation(TPPLPoly *this) {
   long lVar1;
   float *pfVar2;
   float fVar3;
   float *pfVar4;
...
/* TPPLPoly::SetOrientation(TPPLOrientation) */void TPPLPoly::SetOrientation(TPPLPoly *this, int param_2) {
   undefined8 uVar1;
   int iVar2;
   undefined8 *puVar3;
   undefined8 *puVar4;
...
/* TPPLPoly::Invert() */void TPPLPoly::Invert(TPPLPoly *this) {
   undefined8 uVar1;
   undefined8 *puVar2;
   undefined8 *puVar3;
...
/* TPPLPartition::PartitionVertex::PartitionVertex() */void TPPLPartition::PartitionVertex::PartitionVertex(PartitionVertex *this) {
   *(undefined8*)( this + 4 ) = 0;
   *(undefined1(*) [16])( this + 0x18 ) = (undefined1[16])0x0;
   return;
}
/* TPPLPartition::Normalize(Vector2 const&) */undefined8 TPPLPartition::Normalize(TPPLPartition *this, Vector2 *param_1) {
   float fVar3;
...
/* TPPLPartition::Distance(Vector2 const&, Vector2 const&) */double TPPLPartition::Distance(TPPLPartition *this, Vector2 *param_1, Vector2 *param_2) {
   return SQRT((double)( *(float*)param_2 - *(float*)param_1 ) * (double)( *(float*)param_2 - *(float*)param_1 ) + (double)( *(float*)( param_2 + 4 ) - *(float*)( param_1 + 4 ) ) * (double)( *(float*)( param_2 + 4 ) - *(float*)( param_1 + 4 ) ));
}
/* TPPLPartition::Intersects(Vector2&, Vector2&, Vector2&, Vector2&) */bool TPPLPartition::Intersects(TPPLPartition *this, Vector2 *param_1, Vector2 *param_2, Vector2 *param_3, Vector2 *param_4) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   fVar1 = *(float*)param_1;
   fVar2 = *(float*)param_3;
   if (( ( fVar1 != fVar2 ) || ( bVar9 = false * (float*)( param_1 + 4 ) != *(float*)( param_3 + 4 ) ) ) && ( ( fVar3 = *(float*)param_4 ),fVar1 != fVar3 || ( bVar9 = false * (float*)( param_1 + 4 ) != *(float*)( param_4 + 4 ) ) )) {
      fVar4 = *(float*)param_2;
      ...
      if (( ( fVar2 != fVar4 ) || ( bVar9 = false ),fVar5 != *(float*)( param_3 + 4 ) )) {
         ...
         bVar9 = false;
         if (( ( fVar7 - fVar8 ) * ( fVar2 - fVar3 ) + ( fVar1 - fVar2 ) * ( fVar6 - fVar8 ) ) * ( ( fVar4 - fVar2 ) * ( fVar6 - fVar8 ) + ( fVar2 - fVar3 ) * ( fVar5 - fVar8 ) ) <= 0.0) {
            bVar9 = ( ( fVar2 - fVar1 ) * ( fVar5 - fVar7 ) + ( fVar8 - fVar7 ) * ( fVar1 - fVar4 ) ) * ( ( fVar3 - fVar1 ) * ( fVar5 - fVar7 ) + ( fVar6 - fVar7 ) * ( fVar1 - fVar4 ) ) <= 0.0;
         }
...
/* TPPLPartition::IsConvex(Vector2&, Vector2&, Vector2&) */bool TPPLPartition::IsConvex(TPPLPartition *this, Vector2 *param_1, Vector2 *param_2, Vector2 *param_3) {
   return 0.0 < ( *(float*)( param_3 + 4 ) - *(float*)( param_1 + 4 ) ) * ( *(float*)param_2 - *(float*)param_1 ) - ( *(float*)param_3 - *(float*)param_1 ) * ( *(float*)( param_2 + 4 ) - *(float*)( param_1 + 4 ) );
}
/* TPPLPartition::IsReflex(Vector2&, Vector2&, Vector2&) */bool TPPLPartition::IsReflex(TPPLPartition *this, Vector2 *param_1, Vector2 *param_2, Vector2 *param_3) {
   return ( *(float*)( param_3 + 4 ) - *(float*)( param_1 + 4 ) ) * ( *(float*)param_2 - *(float*)param_1 ) - ( *(float*)param_3 - *(float*)param_1 ) * ( *(float*)( param_2 + 4 ) - *(float*)( param_1 + 4 ) ) < 0.0;
}
/* TPPLPartition::IsInside(Vector2&, Vector2&, Vector2&, Vector2&) */bool TPPLPartition::IsInside(TPPLPartition *this, Vector2 *param_1, Vector2 *param_2, Vector2 *param_3, Vector2 *param_4) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
...
/* TPPLPartition::InCone(Vector2&, Vector2&, Vector2&, Vector2&) */bool TPPLPartition::InCone(TPPLPartition *this, Vector2 *param_1, Vector2 *param_2, Vector2 *param_3, Vector2 *param_4) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   fVar3 = *(float*)( param_1 + 4 );
   fVar4 = *(float*)param_1;
   fVar5 = ( *(float*)( param_4 + 4 ) - fVar3 ) * ( fVar1 - fVar4 ) - ( *(float*)param_4 - fVar4 ) * ( fVar2 - fVar3 );
   if (( *(float*)( param_3 + 4 ) - fVar3 ) * ( fVar1 - fVar4 ) - ( *(float*)param_3 - fVar4 ) * ( fVar2 - fVar3 ) <= 0.0) {
      if (0.0 < fVar5) {
         return true;
      }
   ...
   return 0.0 < ( *(float*)( param_4 + 4 ) - fVar2 ) * ( *(float*)param_3 - fVar1 ) - ( *(float*)param_4 - fVar1 ) * ( *(float*)( param_3 + 4 ) - fVar2 );
}
/* TPPLPartition::InCone(TPPLPartition::PartitionVertex*, Vector2&) */void TPPLPartition::InCone(TPPLPartition *this, PartitionVertex *param_1, Vector2 *param_2) {
   long in_FS_OFFSET;
   undefined8 local_28;
   undefined8 local_20;
   undefined8 local_18;
...
/* TPPLPartition::UpdateVertexReflexity(TPPLPartition::PartitionVertex*) */void TPPLPartition::UpdateVertexReflexity(TPPLPartition *this, PartitionVertex *param_1) {
   float fVar1;
   float fVar2;
   fVar1 = *(float*)( *(long*)( param_1 + 0x18 ) + 4 );
   fVar2 = *(float*)( *(long*)( param_1 + 0x18 ) + 8 );
   param_1[1] = ( PartitionVertex )(0.0 <= ( *(float*)( *(long*)( param_1 + 0x20 ) + 8 ) - fVar2 ) * ( *(float*)( param_1 + 4 ) - fVar1 ) - ( *(float*)( *(long*)( param_1 + 0x20 ) + 4 ) - fVar1 ) * ( *(float*)( param_1 + 8 ) - fVar2 ));
   return;
}
/* TPPLPartition::UpdateVertex(TPPLPartition::PartitionVertex*, TPPLPartition::PartitionVertex*,
   long) */void TPPLPartition::UpdateVertex(TPPLPartition *this, PartitionVertex *param_1, PartitionVertex *param_2, long param_3) {
   float fVar1;
   long lVar2;
   long lVar3;
   char cVar4;
   ...
   *(double*)( param_1 + 0x10 ) = (double)( fVar10 * fVar15 + fVar11 * fVar14 );
   if (fVar12 <= 0.0) {
      LAB_00100ab0:param_1[2] = (PartitionVertex)0x0;
      return;
   }
   ...
   if (0 < param_3) {
      ...
      do {
         fVar10 = *(float*)pPVar8;
         if (( ( ( fVar10 != fVar19 ) || ( fVar17 != *(float*)( (Vector2*)pPVar8 + 4 ) ) ) && ( ( fVar10 != fVar20 || ( fVar18 != *(float*)( (Vector2*)pPVar8 + 4 ) ) ) ) ) && ( ( ( fVar10 != fVar16 || ( fVar1 != *(float*)( (Vector2*)pPVar8 + 4 ) ) ) && ( cVar4 = IsInside(this, pVVar7, pVVar6, pVVar5, (Vector2*)pPVar8) ),pVVar6 = extraout_RDX,cVar4 != '\0' ) )) goto LAB_00100ab0;
         lVar9 = lVar9 + 1;
...
/* TPPLPartition::Triangulate_EC(TPPLPoly*, List<TPPLPoly, DefaultAllocator>*) */undefined8 TPPLPartition::Triangulate_EC(TPPLPartition *this, TPPLPoly *param_1, List *param_2) {
   ulong uVar1;
   ulong uVar2;
   long *plVar3;
   long lVar4;
 ...
 while ( pPVar11 != pPVar13 );
         ...
         do {
            ...
            pPVar11 = pPVar5;
            do {
               if (( ( *pPVar11 != (PartitionVertex)0x0 ) && ( pPVar11[2] != (PartitionVertex)0x0 ) ) && ( ( PVar9 == (PartitionVertex)0x0 || ( *(double*)( pPVar6 + 0x10 ) <= *(double*)( pPVar11 + 0x10 ) && *(double*)( pPVar11 + 0x10 ) != *(double*)( pPVar6 + 0x10 ) ) ) )) {
                  pPVar6 = pPVar11;
                  PVar9 = pPVar11[2];
               }
 ...
 while ( pPVar11 != pPVar13 );
            ...
            TPPLPoly::Triangle((TPPLPoly*)&local_58, (Vector2*)( *(long*)( pPVar6 + 0x18 ) + 4 ), (Vector2*)( pPVar6 + 4 ), (Vector2*)( *(long*)( pPVar6 + 0x20 ) + 4 ));
            if (*(long*)param_2 == 0) {
               pauVar8 = (undefined1(*) [16])operator_new(0x18, DefaultAllocator::alloc);
               *(undefined1(**) [16])param_2 = pauVar8;
               *(undefined4*)pauVar8[1] = 0;
 ...
 while ( lVar14 < (long)( uVar2 - 3 ) );
         do {
            if (*pPVar10 != (PartitionVertex)0x0) {
               TPPLPoly::Triangle((TPPLPoly*)&local_58, (Vector2*)( *(long*)( pPVar10 + 0x18 ) + 4 ), (Vector2*)( pPVar10 + 4 ), (Vector2*)( *(long*)( pPVar10 + 0x20 ) + 4 ));
               if (*(long*)param_2 == 0) {
                  pauVar8 = (undefined1(*) [16])operator_new(0x18, DefaultAllocator::alloc);
                  *(undefined1(**) [16])param_2 = pauVar8;
                  *(undefined4*)pauVar8[1] = 0;
 ...
 while ( pPVar10 != pPVar13 );
         uVar12 = 1;
         operator_delete__(pPVar5);
         LAB_00100e56:if (local_58 != (void*)0x0) {
...
/* TPPLPartition::Triangulate_OPT(TPPLPoly*, List<TPPLPoly, DefaultAllocator>*) */undefined8 TPPLPartition::Triangulate_OPT(TPPLPartition *this, TPPLPoly *param_1, List *param_2) {
   long lVar1;
   char *pcVar2;
   ulong uVar3;
   char cVar4;
            ...
            do {
               ...
               *(undefined8*)( puVar25 + 0x10 ) = 0xffffffffffffffff;
               if (uVar17 != uVar23) {
                  ...
                  cVar4 = InCone(this, (Vector2*)&local_50, (Vector2*)&local_60, pVVar14, (Vector2*)&local_58);
                  if (cVar4 != '\0') {
                     ...
                     cVar4 = InCone(this, (Vector2*)&local_50, (Vector2*)&local_58, pVVar14, (Vector2*)&local_60);
                     if (cVar4 != '\0') {
                        uVar22 = 0;
                        uVar24 = uVar28;
                        do {
                           ...
                           iVar5 = Intersects(this, (Vector2*)&local_60, (Vector2*)&local_58, (Vector2*)&local_50, pVVar14);
 ...
 while ( uVar3 != uVar22 );
                  ...
                  LAB_001011d8:*puVar25 = 0;
               }

               LAB_001011dc:uVar23 = uVar23 + 1;
            }
 while ( uVar3 != uVar23 );
         }
 ...
 while ( uVar17 != uVar28 );
      ...
      *(undefined8*)( puVar25 + 0x10 ) = 0xffffffffffffffff;
      lVar11 = 2;
      LAB_00101634:lVar26 = 0;
      lVar10 = 0;
      lVar21 = lVar11;
      LAB_00101651:lVar15 = *(long*)( (long)pvVar6 + lVar21 * 8 );
      lVar18 = lVar10 + 1;
      ...
      if (*pcVar2 != '\0') {
         ...
         do {
            ...
            if (( *pcVar31 == '\0' ) || ( *(char*)( pdVar19 + -1 ) == '\0' )) {
               ...
               dVar32 = 0.0;
               if (lVar18 < lVar15) {
                  dVar32 = (double)( *(float*)( (long)puVar9 + lVar1 * 8 + -4 ) - *(float*)( (long)puVar9 + lVar18 * 8 + -4 ) );
                  dVar32 = SQRT((double)( *(float*)( puVar9 + lVar15 ) - *(float*)( puVar9 + lVar10 ) ) * (double)( *(float*)( puVar9 + lVar15 ) - *(float*)( puVar9 + lVar10 ) ) + dVar32 * dVar32);
               }

               if (lVar21 <= lVar1) {
                  in_XMM12_Qa = *pdVar19 + *(double*)( pcVar31 + 8 ) + dVar32 + 0.0;
                  if (lVar30 != -1) {
                     LAB_001016a3:if (in_XMM12_Qa < dVar33) {
                        lVar30 = lVar15;
                        dVar33 = in_XMM12_Qa;
                     }
               ...
               dVar34 = (double)( *(float*)( (long)puVar9 + lVar21 * 8 + 4 ) - *(float*)( (long)puVar9 + lVar1 * 8 + -4 ) );
               in_XMM12_Qa = *pdVar19 + *(double*)( pcVar31 + 8 ) + dVar32 + SQRT((double)( *(float*)( puVar9 + lVar21 ) - *(float*)( puVar9 + lVar15 ) ) * (double)( *(float*)( puVar9 + lVar21 ) - *(float*)( puVar9 + lVar15 ) ) + dVar34 * dVar34);
               lVar29 = lVar15;
 ...
 while ( true );
   ...
   goto LAB_00101523;
   LAB_00101790:if (lVar15 != -1) {
      LAB_0010179e:*(long*)( pcVar2 + 0x10 ) = lVar15;
      *(double*)( pcVar2 + 8 ) = in_XMM12_Qa;
      LAB_00101640:lVar26 = lVar26 + 0x18;
      lVar21 = lVar21 + 1;
      lVar10 = lVar18;
 ...
 while ( uVar28 != uVar3 );
   ...
   goto LAB_00101523;
   LAB_00101240:lVar11 = lVar11 + 1;
   lVar16 = lVar16 + -1;
   if (lVar16 == 0) goto code_r0x0010124e;
   goto LAB_00101634;
   code_r0x0010124e:pauVar8 = (undefined1(*) [16])operator_new(0x18, DefaultAllocator::alloc);
   *(undefined4*)pauVar8[1] = 0;
   *pauVar8 = (undefined1[16])0x0;
   ...
   *(int*)pauVar8[1] = *(int*)pauVar8[1] + 1;
   do {
      while (true) {
         ...
         lVar21 = *(long*)param_1;
         TPPLPoly::Triangle((TPPLPoly*)&local_78, (Vector2*)( lVar21 + lVar16 * 8 ), (Vector2*)( lVar21 + lVar10 * 8 ), (Vector2*)( lVar11 * 8 + lVar21 ));
         if (*(long*)param_2 == 0) {
         ...
         *(int*)pauVar8[1] = *(int*)pauVar8[1] + 1;
         if (lVar10 + 1 < lVar11) {
            LAB_001018eb:plVar12 = (long*)operator_new(0x28, DefaultAllocator::alloc);
            lVar16 = *(long*)( *pauVar8 + 8 );
            plVar12[2] = 0;
            *plVar12 = lVar10;
            plVar12[1] = lVar11;
...
;
 ...
 while ( pauVar8 != (undefined1(*) [16])0x0 );
   LAB_00101443:uVar27 = 1;
   LAB_00101456:uVar28 = 1;
   do {
      pvVar7 = *(void**)( (long)pvVar6 + uVar28 * 8 );
      if (pvVar7 != (void*)0x0) {
         operator_delete__(pvVar7);
...
;
 ...
 while ( *(int*)pauVar8[1] != 0 );
      LAB_00101519:Memory::free_static(pauVar8, false);
   }

   LAB_00101523:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar27;
   }
...
/* TPPLPartition::UpdateState(long, long, long, long, long, TPPLPartition::DPState2**) */void TPPLPartition::UpdateState(TPPLPartition *this, long param_1, long param_2, long param_3, long param_4, long param_5, DPState2 **param_6) {
   DPState2 *pDVar1;
   void *pvVar2;
   long lVar3;
   long lVar4;
 ...
 while ( (int)plVar7[2] != 0 );
         ...
         *pauVar5 = (undefined1[16])0x0;
         LAB_00101c21:plVar6 = (long*)operator_new(0x28, DefaultAllocator::alloc);
         plVar7 = *(long**)( pDVar1 + lVar8 + 0x10 );
         plVar6[3] = 0;
         lVar4 = *plVar7;
         *plVar6 = param_4;
      ...
      if (plVar7 != (long*)0x0) {
         ...
         if (plVar7 != (long*)0x0) {
            do {
               if (( (int)plVar7[2] == 0 ) || ( pvVar2 = (void*)*plVar7 * (long*)( (long)pvVar2 + 8 ) < param_5 )) goto LAB_00101b27;
               if (*(long**)( (long)pvVar2 + 0x20 ) == plVar7) {
                  lVar4 = *(long*)( (long)pvVar2 + 0x10 );
                  lVar3 = *(long*)( (long)pvVar2 + 0x18 );
                  *plVar7 = lVar4;
 ...
 while ( (int)plVar7[2] != 0 );
      ...
      *(undefined4*)pauVar5[1] = 0;
      *pauVar5 = (undefined1[16])0x0;
      LAB_00101b27:plVar6 = (long*)operator_new(0x28, DefaultAllocator::alloc);
      plVar7 = *(long**)( pDVar1 + lVar8 + 0x10 );
      plVar6[3] = 0;
      lVar8 = *plVar7;
      *plVar6 = param_4;
...
/* TPPLPartition::TypeA(long, long, long, TPPLPartition::PartitionVertex*,
   TPPLPartition::DPState2**) */undefined1  [16] __thiscallTPPLPartition::TypeA(TPPLPartition *this, long param_1, long param_2, long param_3, PartitionVertex *param_4, DPState2 **param_5) {
   long *plVar1;
   DPState2 **ppDVar2;
   long *plVar3;
   long *plVar4;
 ...
 while ( 0.0 <= ( *(float*)( pPVar7 + 8 ) - *(float*)( param_4 + plVar4[-4] * 0x28 + 8 ) ) * ( *(float*)( param_4 + param_2 * 0x28 + 4 ) - *(float*)( param_4 + plVar4[-4] * 0x28 + 4 ) ) - ( *(float*)( pPVar7 + 4 ) - *(float*)( param_4 + plVar4[-4] * 0x28 + 4 ) ) * ( *(float*)( param_4 + param_2 * 0x28 + 8 ) - *(float*)( param_4 + plVar4[-4] * 0x28 + 8 ) ) );
      }

      if (( plVar9 == plVar4 ) || ( lVar6 = *plVar4(*(float*)( param_4 + lVar6 * 0x28 + 8 ) - *(float*)( pPVar7 + 8 )) * ( *(float*)( param_4 + param_1 * 0x28 + 4 ) - *(float*)( pPVar7 + 4 ) ) - ( *(float*)( param_4 + lVar6 * 0x28 + 4 ) - *(float*)( pPVar7 + 4 ) ) * ( *(float*)( param_4 + param_1 * 0x28 + 8 ) - *(float*)( pPVar7 + 8 ) ) < 0.0 )) {
         lVar8 = lVar8 + 1;
         lVar6 = param_2;
      }
   ...
   pDVar5 = pDStack_30;
   LAB_00101ec6:auVar10._8_8_ = pDVar5;
   auVar10._0_8_ = param_2;
   return auVar10;
}
/* TPPLPartition::TypeB(long, long, long, TPPLPartition::PartitionVertex*,
   TPPLPartition::DPState2**) */undefined1  [16] __thiscallTPPLPartition::TypeB(TPPLPartition *this, long param_1, long param_2, long param_3, PartitionVertex *param_4, DPState2 **param_5) {
   DPState2 *pDVar1;
   float fVar2;
   float fVar3;
   undefined8 *puVar4;
   ...
   if (1 < param_3 - param_2) {
      ...
      if (( puVar4 != (undefined8*)0x0 ) && ( *(int*)( puVar4 + 2 ) != 0 )) {
         ...
         plVar5 = plVar8;
         if (0.0 <= fVar11 * ( *(float*)( param_4 + param_2 * 0x28 + 4 ) - fVar3 ) - fVar12 * ( *(float*)( param_4 + param_2 * 0x28 + 8 ) - fVar2 )) {
            while (( plVar7 = plVar5 ),0.0 <= fVar11 * ( *(float*)( param_4 + param_2 * 0x28 + 4 ) - fVar3 ) - fVar12 * ( *(float*)( param_4 + param_2 * 0x28 + 8 ) - fVar2 ) && ( plVar5 = (long*)plVar7[2] ),plVar8 = plVar7,plVar5 != (long*)0x0) {
               fVar11 = *(float*)( param_4 + *plVar5 * 0x28 + 8 ) - fVar2;
               fVar12 = *(float*)( param_4 + *plVar5 * 0x28 + 4 ) - fVar3;
            }
;
            lVar10 = plVar8[1];
            if (0.0 <= ( *(float*)( param_4 + param_3 * 0x28 + 4 ) - *(float*)( param_4 + lVar10 * 0x28 + 4 ) ) * ( fVar2 - *(float*)( param_4 + lVar10 * 0x28 + 8 ) ) - ( *(float*)( param_4 + param_3 * 0x28 + 8 ) - *(float*)( param_4 + lVar10 * 0x28 + 8 ) ) * ( fVar3 - *(float*)( param_4 + lVar10 * 0x28 + 4 ) )) goto LAB_00102097;
         }
...
/* TPPLPartition::AddDiagonal(TPPLPartition::MonotoneVertex*, long*, long, long, TPPLVertexType*,
   ...
   Comparator<TPPLPartition::ScanLineEdge>, DefaultAllocator>*, long*) */void TPPLPartition::AddDiagonal(TPPLPartition *this, MonotoneVertex *param_1, long *param_2, long param_3, long param_4, TPPLVertexType *param_5, Element **param_6, RBSet *param_7, long *param_8) {
   long lVar1;
...
/* TPPLPartition::Below(Vector2&, Vector2&) */bool TPPLPartition::Below(TPPLPartition *this, Vector2 *param_1, Vector2 *param_2) {
   bool bVar1;
   bVar1 = true;
...
/* TPPLPartition::VertexSorter::TEMPNAMEPLACEHOLDERVALUE(long, long) */bool TPPLPartition::VertexSorter::operator ()(VertexSorter *this, long param_1, long param_2) {
   float *pfVar1;
   float *pfVar2;
   float fVar3;
   bool bVar4;
...
/* TPPLPartition::ScanLineEdge::IsConvex(Vector2 const&, Vector2 const&, Vector2 const&) const */bool TPPLPartition::ScanLineEdge::IsConvex(ScanLineEdge *this, Vector2 *param_1, Vector2 *param_2, Vector2 *param_3) {
   return 0.0 < ( *(float*)( param_3 + 4 ) - *(float*)( param_1 + 4 ) ) * ( *(float*)param_2 - *(float*)param_1 ) - ( *(float*)param_3 - *(float*)param_1 ) * ( *(float*)( param_2 + 4 ) - *(float*)( param_1 + 4 ) );
}
/* TPPLPartition::ScanLineEdge::TEMPNAMEPLACEHOLDERVALUE(TPPLPartition::ScanLineEdge const&) const
    */bool TPPLPartition::ScanLineEdge::operator <(ScanLineEdge *this, ScanLineEdge *param_1) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   if (fVar1 == *(float*)( param_1 + 0x14 )) {
      if (fVar2 != fVar3) {
         return 0.0 < ( *(float*)( this + 0x10 ) - *(float*)( this + 8 ) ) * ( fVar1 - fVar2 ) - ( fVar3 - fVar2 ) * ( *(float*)( param_1 + 8 ) - *(float*)( this + 8 ) );
      }
   ...
   if (( fVar2 != fVar3 ) && ( fVar1 <= fVar2 )) {
      return 0.0 < ( *(float*)( this + 0x10 ) - fVar4 ) * ( fVar1 - fVar2 ) - ( fVar5 - fVar4 ) * ( fVar3 - fVar2 );
   }

   return ( *(float*)( param_1 + 0x10 ) - fVar5 ) * ( fVar2 - fVar1 ) - ( fVar4 - fVar5 ) * ( *(float*)( param_1 + 0x14 ) - fVar1 ) <= 0.0;
}
/* TPPLPartition::TriangulateMonotone(TPPLPoly*, List<TPPLPoly, DefaultAllocator>*) */undefined8 TPPLPartition::TriangulateMonotone(TPPLPartition *this, TPPLPoly *param_1, List *param_2) {
   Vector2 *pVVar1;
   Vector2 *pVVar2;
   Vector2 *pVVar3;
   char cVar4;
   ...
   do {
      while (true) {
         ...
         if (( fVar32 == fVar30 ) && ( fVar32 = pfVar6[uVar24 * 2] ),pfVar6[uVar11 * 2] <= fVar32 && fVar32 != pfVar6[uVar11 * 2]) {
            uVar24 = uVar11;
         }
...
;
      ...
      LAB_00102469:if (( fVar32 == fVar30 ) && ( *pfVar21 <= pfVar6[uVar11 * 2] && pfVar6[uVar11 * 2] != *pfVar21 )) {
         uVar23 = uVar11;
      }
 ...
 while ( uVar11 + 1 != uVar5 );
   LAB_001024c7:if (uVar23 != uVar24) {
      ...
      do {
         ...
         while (true) {
            fVar30 = pfVar21[1];
            if (( fVar32 <= fVar30 ) && ( ( fVar30 != fVar32 || ( pfVar6[uVar11 * 2] < *pfVar21 || pfVar6[uVar11 * 2] == *pfVar21 ) ) )) goto LAB_00102507;
            if (uVar10 == uVar24) {
               uVar27 = uVar24;
...
;
 ...
 while ( true );
   ...
   goto LAB_001025b0;
   LAB_00102507:uVar18 = 0;
   goto LAB_00102509;
   while (uVar27 = uVar11,fVar30 = fVar32,uVar11 != uVar23) {
      LAB_0010259e:uVar11 = uVar27 + 1;
      ...
      fVar32 = pfVar21[1];
      if (( fVar32 <= fVar30 ) && ( ( fVar32 != fVar30 || ( *pfVar21 < pfVar6[uVar27 * 2] || *pfVar21 == pfVar6[uVar27 * 2] ) ) )) goto LAB_00102507;
   }
;
   LAB_001025b0:pvVar12 = operator_new__(uVar5);
   if (uVar5 >> 0x3c == 0) {
      uVar27 = uVar5 * 8;
   }
 else {
...
;
      if (uVar24 == uVar22) {
         ...
         *(undefined1*)( (long)pvVar12 + uVar10 ) = 1;
         ...
         if (( fVar30 <= pfVar21[1] ) && ( ( pfVar21[1] != fVar30 || ( fVar30 = pfVar6[uVar22 * 2] ),fVar30 < *pfVar21 || fVar30 == *pfVar21 ) )) goto LAB_0010266e;
         *puVar20 = uVar22;
         uVar23 = uVar22 - 1;
         if ((long)( uVar22 - 1 ) < 0) {
            uVar23 = uVar11;
 ...
 while ( (ulong*)( pauVar19[-1] + uVar5 * 8 + 8 ) != puVar20 );
   LAB_001026b0:*(undefined1*)( (long)pvVar12 + uVar24 ) = 0;
      ...
      if (cVar4 == *(char*)( (long)pvVar12 + *(long*)( pauVar14[-1] + lVar26 + 8 ) )) {
         if (1 < lVar25) {
            ...
            do {
               ...
               fVar30 = ( *(float*)( pVVar2 + 4 ) - *(float*)( pVVar1 + 4 ) ) * ( *(float*)pVVar3 - *(float*)pVVar1 );
               fVar32 = ( *(float*)pVVar2 - *(float*)pVVar1 ) * ( *(float*)( pVVar3 + 4 ) - *(float*)( pVVar1 + 4 ) );
               if (cVar4 == '\x01') {
 ...
 while ( bVar29 );
         ...
         *(long*)( *pauVar14 + lVar26 ) = lVar7;
         ...
         if (1 < lVar25) {
            ...
            do {
               if (cVar4 == '\x01') {
                  TPPLPoly::Triangle((TPPLPoly*)&local_58, (Vector2*)( pfVar6 + *(long*)( *pauVar14 + lVar25 * 8 + 8 ) * 2 ), (Vector2*)( pfVar6 + *(long*)( *pauVar14 + lVar25 * 8 ) * 2 ), (Vector2*)( pfVar6 + lVar7 * 2 ));
                  lVar26 = *(long*)param_2;
               }
 else {
                  TPPLPoly::Triangle((TPPLPoly*)&local_58, (Vector2*)( pfVar6 + *(long*)( *pauVar14 + lVar25 * 8 ) * 2 ), (Vector2*)( pfVar6 + *(long*)( *pauVar14 + lVar25 * 8 + 8 ) * 2 ), (Vector2*)( pfVar6 + lVar7 * 2 ));
                  lVar26 = *(long*)param_2;
               }
   ...
   if (1 < lVar25) {
      ...
      do {
         if (*(char*)( (long)pvVar12 + *(long*)( *pauVar14 + lVar28 * 8 + 8 ) ) == '\x01') {
            TPPLPoly::Triangle((TPPLPoly*)&local_58, (Vector2*)( pfVar6 + *(long*)( *pauVar14 + lVar28 * 8 ) * 2 ), (Vector2*)( pfVar6 + *(long*)( *pauVar14 + lVar28 * 8 + 8 ) * 2 ), (Vector2*)( pfVar6 + lVar15 * 2 ));
            lVar26 = *(long*)param_2;
         }
 else {
            TPPLPoly::Triangle((TPPLPoly*)&local_58, (Vector2*)( pfVar6 + *(long*)( *pauVar14 + lVar28 * 8 + 8 ) * 2 ), (Vector2*)( pfVar6 + *(long*)( *pauVar14 + lVar28 * 8 ) * 2 ), (Vector2*)( pfVar6 + lVar15 * 2 ));
            lVar26 = *(long*)param_2;
         }
 ...
 while ( lVar28 != lVar25 + -1 );
   ...
   uVar18 = 1;
   LAB_00102509:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar18;
   }
...
/* TPPLPartition::RemoveHoles(List<TPPLPoly, DefaultAllocator>*, List<TPPLPoly, DefaultAllocator>*)
    */undefined8 TPPLPartition::RemoveHoles(TPPLPartition *this, List *param_1, List *param_2) {
   TPPLPoly *pTVar1;
   float *pfVar2;
   TPPLPoly TVar3;
   long lVar4;
   ...
   local_70 = 0;
   local_78 = (void*)0x0;
   if (( *(long**)param_1 != (long*)0x0 ) && ( pTVar14 = (TPPLPoly*)**(long**)param_1 ),pTVar11 = pTVar14,pTVar14 != (TPPLPoly*)0x0) {
 ...
 while ( pTVar14 != (TPPLPoly*)0x0 );
      ...
      do {
         ...
         if (pTVar14 == (TPPLPoly*)0x0) {
            uVar15 = 1;
            LAB_001033f5:if (pvVar20 != (void*)0x0) {
...
;
 ...
 while ( pTVar11 != (TPPLPoly*)0x0 );
         LAB_00102f6b:if (TVar7 == (TPPLPoly)0x0) {
            if (*(long*)param_2 == 0) {
               pauVar10 = (undefined1(*) [16])operator_new(0x18, DefaultAllocator::alloc);
 ...
 while ( pTVar14 != (TPPLPoly*)0x0 );
         ...
         local_60 = uVar15;
         do {
            while (( pTVar11[0x10] != (TPPLPoly)0x0 || ( lVar12 = lVar12 < 1 ) )) {
               pTVar11 = *(TPPLPoly**)( pTVar11 + 0x18 );
...
;
            ...
            LAB_00103099:do {
               ...
               lVar18 = lVar16 + 1;
               if (( fVar27 < fVar29 ) && ( cVar8 = InCone(this, (Vector2*)( lVar13 + ( ( lVar16 + -1 + lVar12 ) % lVar12 ) * 8 ), (Vector2*)( lVar13 + lVar16 * 8 ), (Vector2*)( lVar13 + ( lVar18 % lVar12 ) * 8 ), pVVar19) ),cVar8 != '\0') {
                  ...
                  if (cVar6 != '\0') {
                     ...
                     if (fVar24 == 0.0) {
                        ...
                        fVar25 = 0.0;
                        LAB_00103082:fVar24 = fVar26 / fVar23;
                     }
 else {
...
;
 ...
 while ( *(TPPLPoly**)pTVar1 != (TPPLPoly*)0x0 );
               ...
               LAB_00103090:lVar16 = lVar18;
            }
 while ( lVar16 != lVar12 );
            LAB_0010317a:pTVar11 = *(TPPLPoly**)( pTVar11 + 0x18 );
         }
 while ( pTVar11 != (TPPLPoly*)0x0 );
         LAB_0010318f:if (cVar6 == '\0') {
            uVar15 = 0;
            pvVar20 = local_78;
            goto LAB_001033f5;
         }
 ...
 while ( lVar13 <= local_b8 );
         ...
         if (-1 < lVar13) {
            ...
            do {
               ...
               iVar9 = (int)lVar18;
               lVar18 = lVar18 + 1;
               *(undefined8*)( (long)local_78 + (long)iVar9 * 8 ) = *(undefined8*)( lVar4 + ( lVar21 % lVar13 ) * 8 );
            }
 while ( lVar16 + 2 + lVar13 != lVar18 );
         ...
         if (local_b8 < *(long*)( local_c0 + 8 )) {
            ...
            do {
               ...
               iVar9 = (int)lVar18;
               lVar18 = lVar18 + 1;
               *(undefined8*)( (long)local_78 + (long)iVar9 * 8 ) = *(undefined8*)( lVar12 + lVar13 * 8 + lVar4 );
            }
 while ( lVar18 != lVar16 );
         }
         ...
         if (iVar9 == 0) {
            LAB_00103560:Memory::free_static(pauVar10, false);
            pauVar10 = (undefined1(*) [16])operator_new(0x18, DefaultAllocator::alloc);
            *(undefined4*)pauVar10[1] = 0;
            *pauVar10 = (undefined1[16])0x0;
            local_80 = pauVar10;
 ...
 while ( true );
   ...
   LAB_00103404:uVar15 = 1;
   LAB_00103409:List<TPPLPoly,DefaultAllocator>::~List((List<TPPLPoly,DefaultAllocator>*)&local_80);
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   ...
   return uVar15;
   LAB_0010343e:if (*(long*)param_2 == 0) {
      pauVar10 = (undefined1(*) [16])operator_new(0x18, DefaultAllocator::alloc);
      *(undefined1(**) [16])param_2 = pauVar10;
      *(undefined4*)pauVar10[1] = 0;
      *pauVar10 = (undefined1[16])0x0;
...
/* TPPLPartition::Triangulate_EC(List<TPPLPoly, DefaultAllocator>*, List<TPPLPoly,
   DefaultAllocator>*) */undefined8 TPPLPartition::Triangulate_EC(TPPLPartition *this, List *param_1, List *param_2) {
   TPPLPoly *pTVar1;
   int iVar2;
   undefined8 uVar3;
   long in_FS_OFFSET;
   ...
   if (iVar2 == 0) {
      LAB_0010376b:uVar3 = 0;
   }
 else {
      if (local_38 != (undefined8*)0x0) {
         for (pTVar1 = (TPPLPoly*)*local_38; pTVar1 != (TPPLPoly*)0x0; pTVar1 = *(TPPLPoly**)( pTVar1 + 0x18 )) {
...
/* TPPLPartition::ConvexPartition_HM(TPPLPoly*, List<TPPLPoly, DefaultAllocator>*) */int TPPLPartition::ConvexPartition_HM(TPPLPartition *this, TPPLPoly *param_1, List *param_2) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   if (2 < lVar18) {
      ...
      pfVar24 = pfVar12;
      lVar21 = lVar23;
      while (lVar15 = lVar16,fVar1 = ( pfVar7 + lVar21 * 2 )[1],fVar2 = pfVar7[lVar21 * 2],0.0 <= ( pfVar12[-2] - fVar2 ) * ( pfVar24[1] - fVar1 ) - ( pfVar12[-1] - fVar1 ) * ( *pfVar24 - fVar2 )) {
         lVar16 = lVar15 + 1;
         pfVar12 = pfVar12 + 2;
         if (lVar16 == lVar18) {
            if (*(long*)param_2 == 0) {
                  ...
                  do {
                     ...
                     while (pTVar17 = *(TPPLPoly**)( pTVar17 + 0x18 ),pTVar17 != (TPPLPoly*)0x0) {
                        if (( pTVar17 != pTVar13 ) && ( lVar15= *(long *)(pTVar17 + 8),0 < lVar15 )) {
                           ...
                           do {
                              lVar14 = lVar20 + 1;
                              if (( *(float*)( lVar9 + lVar20 * 8 ) == fVar3 ) && ( fVar4 == *(float*)( lVar9 + -4 + lVar14 * 8 ) )) {
                                 ...
                                 if (( fVar1 == *pfVar7 ) && ( fVar2 == pfVar7[1] )) {
                                    ...
                                    if (0.0 < ( ( (float*)( lVar14 + lVar9 ) )[1] - fVar6 ) * ( fVar1 - fVar5 ) - ( *(float*)( lVar14 + lVar9 ) - fVar5 ) * ( fVar2 - fVar6 )) {
                                       if (lVar18 + -1 != lVar21) {
                                       ...
                                       fVar1 = *pfVar7;
                                       fVar2 = pfVar7[1];
                                       if (0.0 < ( pfVar12[1] - fVar2 ) * ( fVar3 - fVar1 ) - ( fVar4 - fVar2 ) * ( *pfVar12 - fVar1 )) {
                                          ...
                                          if (lVar21 == lVar23) {
                                             ...
                                             do {
                                                lVar15 = (long)iVar11;
                                                iVar11 = iVar11 + 1;
                                                *(undefined8*)( (long)local_58 + lVar15 * 8 ) = *(undefined8*)( lVar18 + lVar21 * 8 );
 ...
 while ( lVar21 != lVar23 );
                                          ...
                                          if (lVar22 != lVar20) {
                                             ...
                                             do {
                                                lVar16 = (long)iVar11;
                                                iVar11 = iVar11 + 1;
                                                *(undefined8*)( (long)local_58 + lVar16 * 8 ) = *(undefined8*)( lVar18 + lVar22 * 8 );
...
;
 ...
 while ( pTVar13 != (TPPLPoly*)0x0 );
            if (( local_90 != (long*)0x0 ) && ( pTVar13 = (TPPLPoly*)*local_90 ),pTVar13 != (TPPLPoly*)0x0) {
               if (*(long*)param_2 == 0) {
                  pauVar19 = (undefined1(*) [16])operator_new(0x18, DefaultAllocator::alloc);
                  *(undefined1(**) [16])param_2 = pauVar19;
                  *(undefined4*)pauVar19[1] = 0;
...
;
 ...
 while ( pTVar13 != (TPPLPoly*)0x0 );
            ...
            LAB_00103ce0:if (pvVar10 != (void*)0x0) {
      ...
      LAB_00103917:List<TPPLPoly,DefaultAllocator>::~List((List<TPPLPoly,DefaultAllocator>*)&local_60);
   }
...
/* TPPLPartition::ConvexPartition_HM(List<TPPLPoly, DefaultAllocator>*, List<TPPLPoly,
   DefaultAllocator>*) */undefined8 TPPLPartition::ConvexPartition_HM(TPPLPartition *this, List *param_1, List *param_2) {
   TPPLPoly *pTVar1;
   int iVar2;
   undefined8 uVar3;
   long in_FS_OFFSET;
...
/* TPPLPartition::ConvexPartition_OPT(TPPLPoly*, List<TPPLPoly, DefaultAllocator>*) */undefined8 TPPLPartition::ConvexPartition_OPT(TPPLPartition *this, TPPLPoly *param_1, List *param_2) {
   DPState2 **ppDVar1;
   float fVar2;
   float fVar3;
   ulong uVar4;
...
;
      ...
      do {
         ...
         *pPVar11 = ( PartitionVertex )(0.0 <= ( *(float*)( *(long*)( pPVar11 + 0x1f ) + 8 ) - fVar3 ) * ( *(float*)( pPVar11 + 3 ) - fVar2 ) - ( *(float*)( *(long*)( pPVar11 + 0x1f ) + 4 ) - fVar2 ) * ( *(float*)( pPVar11 + 7 ) - fVar3 ));
         pPVar11 = pPVar11 + 0x28;
      }
                  ...
                  if (cVar7 != '\0') {
                     ...
                     if (cVar7 != '\0') {
                        ...
                        do {
                           ...
                           if (uVar32 == uVar25) {
                              local_60 = *puVar15;
                              iVar8 = Intersects(this, (Vector2*)&local_78, (Vector2*)&local_70, pVVar22, pVVar36);
                           }
 else {
 ...
 while ( uVar25 != uVar4 );
                  ...
                  LAB_0010426c:*pDVar20 = (DPState2)0x0;
               }

               LAB_00104270:uVar37 = uVar37 + 1;
               pDVar20 = pDVar20 + 0x18;
...
;
 ...
 while ( lVar13 != lVar30 );
      LAB_00104437:pPVar9[1] = (PartitionVertex)0x0;
      uVar37 = 3;
      ...
      if (uVar4 != 3) {
         do {
            ...
            do {
               lVar30 = lVar23 + 1;
               if (( pPVar9[lVar23 * 0x28 + 1] == (PartitionVertex)0x0 ) && ( local_d0[lVar23][uVar28 * 0x18] != (DPState2)0x0 )) {
                  lVar38 = lVar30;
 ...
 while ( lVar30 != lVar13 );
            ...
            if ((long)uVar37 < (long)uVar4) {
               do {
                  if (( ( pPVar9[uVar28 * 0x28 + 1] == (PartitionVertex)0x0 ) && ( pPVar9[uVar25 * 0x28 + -0x4f] != (PartitionVertex)0x0 ) ) && ( local_d0[uVar25 - 2][uVar28 * 0x18] != (DPState2)0x0 )) {
      ...
      *(int*)pauVar14[1] = *(int*)pauVar14[1] + 1;
      LAB_00104612:do {
         ...
         if ((undefined1(*) [16])plVar16[4] != pauVar14) {
            ...
            LAB_00105a09:Memory::free_static(pauVar14, false);
            if (1 < lVar23 - lVar13) {
               pauVar14 = (undefined1(*) [16])0x0;
               goto LAB_00104c44;
            }
 ...
 while ( true );
               ...
               LAB_00105704:plVar16 = (long*)operator_new(0x28, DefaultAllocator::alloc);
               plVar16[3] = 0;
               lVar38 = lVar13;
               lVar23 = lVar39;
            }
 ...
 while ( true );
               ...
               LAB_001056a7:plVar16 = (long*)operator_new(0x28, DefaultAllocator::alloc);
               plVar16[3] = 0;
            }
 ...
 while ( true );
   ...
   uVar31 = 0;
   goto LAB_00104ae7;
   LAB_00104624:puVar15 = (undefined8*)operator_new(0x28, DefaultAllocator::alloc);
   lVar13 = *(long*)*pauVar14;
   puVar15[3] = 0;
   *puVar15 = 0;
   puVar15[1] = uVar35;
   ...
   LAB_00104687:do {
      ...
      if ((undefined1(*) [16])plVar16[4] == pauVar14) {
         ...
         *(int*)*pauVar18 = *(int*)*pauVar18 + -1;
         ...
         LAB_00104e1b:if (lVar23 - lVar13 < 2) goto LAB_00104687;
      }
 else {
         _err_print_error("erase", "./core/templates/list.h", 0xe7, "Condition \"p_I->data != this\" is true. Returning: false", 0, 0);
         if (*(int*)pauVar14[1] != 0) goto LAB_00104e1b;
         LAB_00105941:Memory::free_static(pauVar14, false);
         if (lVar23 - lVar13 < 2) {
            pauVar14 = (undefined1(*) [16])0x0;
            break;
         }
...
;
 ...
 while ( *(int*)pauVar17[1] != 0 );
         LAB_00104e7c:Memory::free_static(pauVar17, false);
         local_a0 = (undefined1(*) [16])0x0;
      }

      pauVar17 = (undefined1(*) [16])0x0;
      LAB_00104e95:if (pauVar19 != (undefined1(*) [16])0x0) {
         do {
            while (true) {
...
;
 ...
 while ( *(int*)pauVar19[1] != 0 );
         LAB_00104ee6:Memory::free_static(pauVar19, false);
      }

      pauVar19 = (undefined1(*) [16])0x0;
      LAB_00104ef2:if (pauVar17 == (undefined1(*) [16])0x0) {
      ...
      LAB_00104fea:do {
         ...
         if (pauVar19 == (undefined1(*) [16])plVar16[4]) {
            ...
            *(int*)*pauVar17 = *(int*)*pauVar17 + -1;
            ...
            LAB_0010504c:if (lVar23 - lVar13 < 2) goto LAB_00104fea;
         }
 else {
            _err_print_error("erase", "./core/templates/list.h", 0xe7, "Condition \"p_I->data != this\" is true. Returning: false", 0, 0);
            if (*(int*)pauVar19[1] != 0) goto LAB_0010504c;
            LAB_00105b65:Memory::free_static(pauVar19, false);
            if (lVar23 - lVar13 < 2) {
               pauVar19 = (undefined1(*) [16])0x0;
               break;
            }
         ...
         if (pPVar9[lVar13 * 0x28 + 1] == (PartitionVertex)0x0) {
            ...
            *(int*)pauVar19[1] = *(int*)pauVar19[1] + 1;
            ...
            LAB_0010510b:plVar16 = (long*)operator_new(0x28, DefaultAllocator::alloc);
            lVar13 = *(long*)( *pauVar14 + 8 );
            plVar16[2] = 0;
            *plVar16 = lVar30;
            plVar16[1] = lVar23;
            ...
            *(int*)pauVar14[1] = *(int*)pauVar14[1] + 1;
            ...
            LAB_0010574a:if (pauVar14 == (undefined1(*) [16])0x0) {
               pauVar14 = (undefined1(*) [16])operator_new(0x18, DefaultAllocator::alloc);
               *(undefined4*)pauVar14[1] = 0;
               *pauVar14 = (undefined1[16])0x0;
            }
 ...
 while ( pauVar19 != (undefined1(*) [16])0x0 );
      List<long,DefaultAllocator>::sort_custom<Comparator<long>>((List<long,DefaultAllocator>*)&local_a0);
      pauVar17 = local_a0;
      if (local_a0 == (undefined1(*) [16])0x0) {
...
;
      ...
      if (pDVar20 != pDVar27) {
         LAB_001046f0:pDVar26 = pDVar27 + -0x18;
         do {
            plVar16 = *(long**)( pDVar27 + -8 );
            do {
               if (plVar16 == (long*)0x0) {
                  LAB_001047a7:pDVar27 = pDVar26;
                  if (pDVar20 != pDVar26) goto LAB_001046f0;
                  LAB_001047b0:lVar23 = *(long*)( pDVar20 + -8 ) * 0x18;
                  goto LAB_001047bc;
               }
 ...
 while ( true );
      ...
      lVar23 = 0;
      LAB_001047bc:lVar13 = lVar13 + 1;
      operator_delete__(pDVar20 + -8, lVar23 + 8);
   }
 while ( lVar13 < (long)uVar4 );
   LAB_001047d6:operator_delete__(local_d0);
...
;
 ...
 while ( *(int*)pauVar17[1] != 0 );
      LAB_00104854:Memory::free_static(pauVar17, false);
   }
   ...
   LAB_00105355:do {
      ...
      pDVar27 = pDVar20 + *(long*)( pDVar20 + -8 ) * 0x18;
      if (pDVar20 != pDVar27) {
         LAB_00105380:pDVar26 = pDVar27 + -0x18;
         do {
            plVar16 = *(long**)( pDVar27 + -8 );
            do {
               if (plVar16 == (long*)0x0) {
                  LAB_00105416:pDVar27 = pDVar26;
 ...
 while ( lVar13 < (long)uVar4 );
   ...
   operator_delete__(pPVar9);
   LAB_00104863:if (local_98 != (void*)0x0) {
...
;
 ...
 while ( *(int*)pauVar19[1] != 0 );
      LAB_001048c9:Memory::free_static(pauVar19, false);
   }

   LAB_001048d3:if (pauVar14 != (undefined1(*) [16])0x0) {
      do {
         while (true) {
...
;
 ...
 while ( *(int*)pauVar14[1] != 0 );
      LAB_0010492a:Memory::free_static(pauVar14, false);
   }

   LAB_00104ae7:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* TPPLPartition::MonotonePartition(List<TPPLPoly, DefaultAllocator>*, List<TPPLPoly,
   DefaultAllocator>*) */undefined8 TPPLPartition::MonotonePartition(TPPLPartition *this, List *param_1, List *param_2) {
   long *plVar1;
   float *pfVar2;
   float fVar3;
   float fVar4;
   ...
   void *local_f8;
   void *pvStack_e8;
   RBSet<TPPLPartition::ScanLineEdge,Comparator<TPPLPartition::ScanLineEdge>,DefaultAllocator> *local_e0;
   void *pvStack_98;
   ...
   local_50 = 0;
   local_48 = 0;
   if (( *(long**)param_1 == (long*)0x0 ) || ( lVar24 = lVar24 == 0 )) {
      uVar22 = 0;
      uVar17 = 0;
      pfVar6 = (float*)operator_new__(0);
      local_e0 = (RBSet<TPPLPartition::ScanLineEdge,Comparator<TPPLPartition::ScanLineEdge>,DefaultAllocator>*)0x0;
   }
 else {
      local_e0 = (RBSet<TPPLPartition::ScanLineEdge,Comparator<TPPLPartition::ScanLineEdge>,DefaultAllocator>*)0x0;
      do {
         local_e0 = (RBSet<TPPLPartition::ScanLineEdge,Comparator<TPPLPartition::ScanLineEdge>,DefaultAllocator>*)( (long)local_e0 + *(long*)( lVar24 + 8 ) );
 ...
 while ( lVar24 != -1 );
   ...
   if (( *(long**)param_1 != (long*)0x0 ) && ( plVar8 = (long*)**(long**)param_1 ),plVar8 != (long*)0x0) {
      lVar24 = 0;
      do {
         lVar19 = plVar8[1];
         if (0 < lVar19) {
 ...
 while ( true );
         ...
         plVar8 = (long*)plVar8[3];
         joined_r0x00105f5b:lVar24 = lVar24 + lVar19;
      }
 while ( plVar8 != (long*)0x0 );
   ...
   if (0 < (long)local_e0) {
      if (( (ulong)local_e0 & 1 ) != 0) {
         *plVar8 = 0;
         uVar20 = 1;
         if (local_e0 == (RBSet<TPPLPartition::ScanLineEdge,Comparator<TPPLPartition::ScanLineEdge>,DefaultAllocator>*)0x1) goto LAB_00105e8b;
      }
 ...
 while ( local_e0 != (RBSet<TPPLPartition::ScanLineEdge,Comparator<TPPLPartition::ScanLineEdge>,DefaultAllocator>*)uVar20 );
   }

   LAB_00105e8b:plVar1 = (long*)( (long)plVar8 + uVar22 );
   if (plVar1 != plVar8) {
      lVar24 = -2;
      ...
      std::__introsort_loop<long*,long,__gnu_cxx::__ops::_Iter_comp_iter<TPPLPartition::VertexSorter>>(plVar8, plVar1, lVar24, pfVar6);
      if ((long)uVar22 < 0x81) {
         std::__insertion_sort<long*,__gnu_cxx::__ops::_Iter_comp_iter<TPPLPartition::VertexSorter>>(plVar8, plVar1, pfVar6);
      }
 else {
         plVar21 = plVar8 + 0x10;
         std::__insertion_sort<long*,__gnu_cxx::__ops::_Iter_comp_iter<TPPLPartition::VertexSorter>>(plVar8, plVar21, pfVar6);
...
;
               if (( fVar3 != pfVar10[1] ) || ( fVar4 = pfVar6[lVar24 * 6] ),fVar4 < *pfVar10 || fVar4 == *pfVar10) break;
               *plVar16 = lVar19;
               plVar16 = plVar16 + -1;
            }
;
   ...
   if (uVar17 < 0x1fffffffffffffff) {
      ...
      LAB_0010609d:local_f8 = operator_new__(uVar17 << 3);
      uStack_88 = 0;
      pvStack_98 = (void*)0x0;
      puStack_90 = &_GlobalNilClass::_nil;
      pvStack_e8 = operator_new__(uVar17 << 3);
      if ((long)local_e0 < 1) {
         LAB_00106d1f:pcVar12 = (char*)operator_new__((ulong)local_e0);
         goto LAB_00106b88;
      }
      ...
      if ((long)local_e0 < 1) {
         LAB_00106cd7:local_f8 = operator_new__(0xffffffffffffffff);
         pvStack_98 = (void*)0x0;
         uStack_88 = 0;
         puStack_90 = &_GlobalNilClass::_nil;
         ...
         while (true) {
            ...
            if (!NAN(fVar3) && !NAN(fVar4)) {
               if (fVar3 == fVar4) {
 ...
 else if (( fVar26 != fVar3 ) || ( fVar28 = fVar25 <= fVar28 )) goto LAB_00105fe0;
                     goto LAB_00106048;
                  }
                  ...
                  LAB_00105fba:fVar26 = pfVar2[1];
                  if (fVar3 < fVar26) {
                     fVar25 = *pfVar2;
                     fVar28 = *pfVar10;
                     LAB_00106168:if (( fVar3 - fVar26 ) * ( *pfVar18 - fVar25 ) - ( fVar28 - fVar25 ) * ( fVar4 - fVar26 ) <= 0.0) {
            ...
            LAB_00105fe0:*(undefined4*)( (long)pvVar9 + lVar24 * 4 ) = 0;
            LAB_00105fe8:lVar24 = lVar24 + 1;
            pfVar10 = pfVar10 + 6;
...
;
         ...
         fVar27 = *pfVar18;
         fVar25 = *pfVar10;
         LAB_00106048:if (( fVar3 - fVar26 ) * ( fVar27 - fVar28 ) - ( fVar25 - fVar28 ) * ( fVar4 - fVar26 ) <= 0.0) {
 ...
 while ( lVar24 < (long)local_e0 );
      LAB_00106090:if (uVar17 >> 0x3c == 0) goto LAB_0010609d;
   ...
   do {
      if (*(uint*)( (long)pvVar9 + plVar8[uVar22] * 4 ) < 5) {
         ...
         uVar11 = ( *(code*)( &DAT_001095b4 + *(int*)( &DAT_001095b4 + ( ulong ) * (uint*)( (long)pvVar9 + plVar8[uVar22] * 4 ) * 4 ) ) )();
         return uVar11;
      }

      uVar22 = uVar22 + 1;
   }
 while ( local_e0 != (RBSet<TPPLPartition::ScanLineEdge,Comparator<TPPLPartition::ScanLineEdge>,DefaultAllocator>*)uVar22 );
...
;
         lVar19 = 1;
         for (lVar24 = *(long*)( pfVar10 + 4 ); pfVar6 + lVar24 * 6 != pfVar10; lVar24 = *(long*)( pfVar6 + lVar24 * 6 + 4 )) {
            lVar19 = lVar19 + 1;
         }
...
;
 ...
 while ( pcVar23 != pcVar12 + (long)local_e0 );
      LAB_0010653c:if (puStack_78 != (undefined8*)0x0) {
         operator_delete__(puStack_78);
      }

   }

   LAB_00106b88:local_e0 = (RBSet<TPPLPartition::ScanLineEdge,Comparator<TPPLPartition::ScanLineEdge>,DefaultAllocator>*)&pvStack_98;
   ...
   RBSet<TPPLPartition::ScanLineEdge,Comparator<TPPLPartition::ScanLineEdge>,DefaultAllocator>::clear(local_e0);
...
/* TPPLPartition::Triangulate_MONO(List<TPPLPoly, DefaultAllocator>*, List<TPPLPoly,
   DefaultAllocator>*) */undefined8 TPPLPartition::Triangulate_MONO(TPPLPartition *this, List *param_1, List *param_2) {
   TPPLPoly *pTVar1;
   int iVar2;
   undefined8 uVar3;
   long in_FS_OFFSET;
...
/* TPPLPartition::Triangulate_MONO(TPPLPoly*, List<TPPLPoly, DefaultAllocator>*) */undefined4 TPPLPartition::Triangulate_MONO(TPPLPartition *this, TPPLPoly *param_1, List *param_2) {
   long lVar1;
   undefined4 uVar2;
...
/* RBSet<TPPLPartition::ScanLineEdge, Comparator<TPPLPartition::ScanLineEdge>,
   ...
   Comparator<TPPLPartition::ScanLineEdge>, DefaultAllocator>::Element*) [clone .part.0] */void RBSet<TPPLPartition::ScanLineEdge,Comparator<TPPLPartition::ScanLineEdge>,DefaultAllocator>::_cleanup_tree(RBSet<TPPLPartition::ScanLineEdge,Comparator<TPPLPartition::ScanLineEdge>,DefaultAllocator> *this, Element *param_1) {
   Element *pEVar1;
   Element *pEVar2;
   Element *pEVar3;
   Element *pEVar4;
...
/* SortArray<List<long, DefaultAllocator>::Element*, List<long,
   ...
   List<long, DefaultAllocator>::Element**, long) const [clone .isra.0] */void SortArray<List<long,DefaultAllocator>::Element*,List<long,DefaultAllocator>::AuxiliaryComparator<Comparator<long>>,true>::introsort(long param_1, long param_2, Element **param_3, long param_4) {
   Element *pEVar1;
   long lVar2;
   long lVar3;
   long lVar4;
 ...
 while ( lVar8 < lVar4 );
         ...
         while (true) {
            ...
            LAB_00107a8d:lVar7 = lVar9;
            ppEVar12 = ppEVar6;
            ppEVar5 = ppEVar6;
            if (lVar9 == lVar13) break;
            LAB_00107bd1:*ppEVar5 = pEVar10;
         }
;
         LAB_00107a93:lVar2 = lVar9 + -1;
 ...
 while ( true );
   ...
   lVar9 = param_2;
   local_58 = param_4;
   LAB_001077c1:pEVar10 = param_3[lVar9 + -1];
   local_58 = local_58 + -1;
   lVar8 = *(long*)pEVar10;
   ...
   if (lVar7 < lVar3) {
      if (lVar3 < lVar8) {
         LAB_00107953:pEVar10 = param_3[( lVar13 >> 1 ) + param_1];
         lVar8 = lVar3;
         goto LAB_00107804;
      }
...
;
         ...
         LAB_001078a5:if (lVar7 <= param_2) break;
 ...
 while ( true );
   ...
   goto LAB_001077c1;
   LAB_00107ac8:pEVar10 = ppEVar6[lVar13];
   ...
   if (lVar13 < 3) {
      ...
      *ppEVar6 = param_3[lVar9];
      LAB_00107b58:lVar3 = *(long*)pEVar10;
      while (true) {
...
/* void List<long, DefaultAllocator>::sort_custom<Comparator<long> >() */void List<long,DefaultAllocator>::sort_custom<Comparator<long>>(List<long,DefaultAllocator> *this) {
   size_t __n;
   int iVar1;
   undefined8 *puVar2;
   long lVar3;
   ...
   if (*(long**)this != (long*)0x0) {
      ppEVar7 = __src;
      for (pEVar13 = (Element*)**(long**)this; pEVar13 != (Element*)0x0; pEVar13 = *(Element**)( pEVar13 + 8 )) {
         *ppEVar7 = pEVar13;
         ppEVar7 = ppEVar7 + 1;
      }
 ...
 while ( pEVar13 != (Element*)0x1 );
   SortArray<List<long,DefaultAllocator>::Element*,List<long,DefaultAllocator>::AuxiliaryComparator<Comparator<long>>,true>::introsort(0, (long)pEVar4, __src, lVar9 * 2);
   if ((long)pEVar4 < 0x11) {
      pEVar13 = (Element*)0x1;
      pEVar8 = *__src;
      do {
 ...
 while ( lVar9 < *(long*)pEVar8 );
            ...
            LAB_0010818c:pEVar13 = pEVar13 + 1;
            *ppEVar7 = pEVar6;
            pEVar6 = *__src;
            pEVar8 = pEVar6;
...
;
 ...
 while ( lVar14 + 1 != 0x10 );
      LAB_00107f7d:pEVar13 = (Element*)( lVar14 + 1 );
      ppEVar7 = __src + 0x10;
      do {
         pEVar6 = *ppEVar7;
         pEVar10 = ppEVar7[-1];
 ...
 while ( pEVar11 != (Element*)0x0 );
         ...
         LAB_00108004:pEVar13 = pEVar13 + 1;
         *ppEVar12 = pEVar6;
         ppEVar7 = ppEVar7 + 1;
      }
 while ( pEVar4 != pEVar13 );
   ...
   LAB_00108021:puVar2 = *(undefined8**)this;
   *puVar2 = pEVar6;
   *(long*)( pEVar6 + 0x10 ) = 0;
...
/* TPPLPartition::ConvexPartition_OPT(TPPLPoly*, List<TPPLPoly, DefaultAllocator>*) [clone .cold] */void TPPLPartition::ConvexPartition_OPT(TPPLPoly *param_1, List *param_2) {
   code *pcVar1;
   /* WARNING: Does not return */
...
/* RBSet<TPPLPartition::ScanLineEdge, Comparator<TPPLPartition::ScanLineEdge>,
   DefaultAllocator>::clear() */void RBSet<TPPLPartition::ScanLineEdge,Comparator<TPPLPartition::ScanLineEdge>,DefaultAllocator>::clear(RBSet<TPPLPartition::ScanLineEdge,Comparator<TPPLPartition::ScanLineEdge>,DefaultAllocator> *this) {
   Element *pEVar1;
   Element *pEVar2;
   Element *pEVar3;
   Element *pEVar4;
...
/* RBSet<TPPLPartition::ScanLineEdge, Comparator<TPPLPartition::ScanLineEdge>,
   DefaultAllocator>::_insert(TPPLPartition::ScanLineEdge const&) */int *__thiscallRBSet<TPPLPartition::ScanLineEdge,Comparator<TPPLPartition::ScanLineEdge>,DefaultAllocator>::_insert(RBSet<TPPLPartition::ScanLineEdge,Comparator<TPPLPartition::ScanLineEdge>,DefaultAllocator> *this, ScanLineEdge *param_1) {
   int iVar1;
   long lVar2;
   long lVar3;
   long lVar4;
   ...
   if (*(int**)( piVar14 + 4 ) != piVar10) {
      do {
         while (piVar14 = piVar8,cVar7 = TPPLPartition::ScanLineEdge::operator <(param_1, (ScanLineEdge*)( piVar14 + 0xc )),cVar7 == '\0') {
...
;
 ...
 while ( *(int**)( piVar14 + 4 ) != piVar10 );
   ...
   LAB_001084db:piVar8 = (int*)operator_new(0x48, DefaultAllocator::alloc);
   ...
   *(undefined8*)( piVar8 + 0x10 ) = *(undefined8*)( param_1 + 0x10 );
   if (( *(int**)this == piVar14 ) || ( cVar7 = TPPLPartition::ScanLineEdge::operator <(param_1, (ScanLineEdge*)( piVar14 + 0xc )) ),piVar10 = extraout_RDX,cVar7 != '\0') {
 ...
 while ( bVar15 );
         LAB_001086f5:if (piVar12 == piVar11) {
            piVar11 = (int*)0x0;
         }
 ...
 while ( bVar15 );
      ...
      LAB_001085b5:*(int**)( piVar11 + 10 ) = piVar8;
 ...
 while ( *(int**)( this + 8 ) != *(int**)( piVar13 + 2 ) );
      LAB_001085ac:*(int**)( piVar8 + 10 ) = piVar13;
      if (piVar11 != (int*)0x0) goto LAB_001085b5;
   }

   *(int**)( piVar13 + 8 ) = piVar8;
   LAB_001085c6:iVar1 = *piVar14;
               ...
               *(long*)( piVar14 + 2 ) = lVar3;
               if (lVar2 == lVar3) {
                  *(int**)( piVar12 + 6 ) = piVar10;
                  piVar13 = piVar10;
                  LAB_00108935:*(int**)( piVar13 + 4 ) = piVar12;
               }
 else {
...
;
         if (*piVar9 != 0) {
            ...
            if (piVar13 == piVar9) {
               ...
               *piVar9 = 1;
               ...
               LAB_001087e8:_err_print_error("_set_color", "./core/templates/rb_set.h", 0xd0, "Condition \"p_node == _data._nil && p_color == RED\" is true.", 0, 0);
               piVar13 = piVar14;
            }
 else {
               piVar12 = *(int**)( this + 8 );
         ...
         LAB_0010865d:piVar13 = *(int**)( this + 8 );
         *piVar14 = 1;
         *piVar9 = 1;
         if (piVar10 == piVar13) {
            _err_print_error("_set_color", "./core/templates/rb_set.h", 0xd0, "Condition \"p_node == _data._nil && p_color == RED\" is true.", 0, 0);
...
/* RBSet<TPPLPartition::ScanLineEdge, Comparator<TPPLPartition::ScanLineEdge>,
   ...
   Comparator<TPPLPartition::ScanLineEdge>, DefaultAllocator>::Element*) */void RBSet<TPPLPartition::ScanLineEdge,Comparator<TPPLPartition::ScanLineEdge>,DefaultAllocator>::_erase_fix_rb(RBSet<TPPLPartition::ScanLineEdge,Comparator<TPPLPartition::ScanLineEdge>,DefaultAllocator> *this, Element *param_1) {
   int iVar1;
   Element *pEVar2;
   long lVar3;
   long lVar4;
   ...
   do {
      pEVar6 = pEVar9;
      if (pEVar2 == pEVar7) {
         LAB_00108a80:iVar1 = *(int*)pEVar8;
         joined_r0x00108b43:if (iVar1 != 1) {
      ...
      pEVar9 = param_1;
      if (*(int*)param_1 != 0) {
         LAB_00108a29:pEVar7 = *(Element**)( pEVar9 + 0x10 );
         if (*(int*)pEVar7 == 1) goto LAB_00108a36;
         LAB_00108ae0:if (pEVar9 != *(Element**)( pEVar6 + 8 )) {
            iVar1 = *(int*)pEVar6;
            pEVar7 = pEVar9;
         ...
         LAB_00108cd1:if (( pEVar9 == pEVar8 ) && ( *(int*)pEVar6 == 0 )) {
            _err_print_error("_set_color", "./core/templates/rb_set.h", 0xd0, "Condition \"p_node == _data._nil && p_color == RED\" is true.", 0, 0);
            pEVar8 = *(Element**)( this + 8 );
         }
 else {
      ...
      *(Element**)( pEVar6 + 0x18 ) = param_1;
      ...
      LAB_00108a36:pEVar7 = *(Element**)( pEVar9 + 8 );
      if (*(int*)pEVar7 != 1) {
         ...
         *(Element**)( pEVar9 + 0x18 ) = pEVar7;
         iVar1 = *(int*)pEVar6;
         joined_r0x00108aef:if (( iVar1 == 0 ) && ( pEVar7 == pEVar8 )) {
            _err_print_error("_set_color", "./core/templates/rb_set.h", 0xd0, "Condition \"p_node == _data._nil && p_color == RED\" is true.", 0, 0);
            pEVar8 = *(Element**)( this + 8 );
         }
 else {
...
/* RBSet<TPPLPartition::ScanLineEdge, Comparator<TPPLPartition::ScanLineEdge>,
   ...
   Comparator<TPPLPartition::ScanLineEdge>, DefaultAllocator>::Element*) */void RBSet<TPPLPartition::ScanLineEdge,Comparator<TPPLPartition::ScanLineEdge>,DefaultAllocator>::_erase(RBSet<TPPLPartition::ScanLineEdge,Comparator<TPPLPartition::ScanLineEdge>,DefaultAllocator> *this, Element *param_1) {
   int *piVar1;
   Element *pEVar2;
   Element *pEVar3;
   int *piVar4;
   ...
   pEVar8 = param_1;
   if (piVar4 == piVar1) {
      LAB_00108fa8:lVar6 = *(long*)( pEVar8 + 0x18 );
      piVar4 = *(int**)( pEVar8 + 8 );
      pEVar9 = *(Element**)( lVar6 + 0x10 );
      if (pEVar9 == pEVar8) goto LAB_00108fbd;
      LAB_00108ecd:*(int**)( lVar6 + 8 ) = piVar4;
   }
 else {
      ...
      LAB_00108fbd:*(int**)( lVar6 + 0x10 ) = piVar4;
   ...
   *(int*)( this + 0x10 ) = *(int*)( this + 0x10 ) + -1;
   ...
   LAB_00108ff2:_err_print_error("_erase", "./core/templates/rb_set.h", uVar7, pcVar5, 0, 0);
   return;
}
/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* void std::__insertion_sort<long*, __gnu_cxx::__ops::_Iter_comp_iter<TPPLPartition::VertexSorter>
   >(long*, long*, __gnu_cxx::__ops::_Iter_comp_iter<TPPLPartition::VertexSorter>) */void std::__insertion_sort<long*,__gnu_cxx::__ops::_Iter_comp_iter<TPPLPartition::VertexSorter>>(long *param_1, long *param_2, long param_3) {
   float *pfVar1;
   float *pfVar2;
   float fVar3;
   long lVar4;
   ...
   do {
      ...
      while (true) {
         ...
         fVar3 = pfVar1[1];
         if (( pfVar2[1] < fVar3 ) || ( ( plVar6 = plVar7 ),fVar3 == pfVar2[1] && ( *pfVar2 <= *pfVar1 && *pfVar1 != *pfVar2 ) )) break;
         while (true) {
            while (true) {
               lVar5 = plVar6[-1];
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* void std::__adjust_heap<long*, long, long,
   __gnu_cxx::__ops::_Iter_comp_iter<TPPLPartition::VertexSorter> >(long*, long, long, long,
   __gnu_cxx::__ops::_Iter_comp_iter<TPPLPartition::VertexSorter>) */void std::__adjust_heap<long*,long,long,__gnu_cxx::__ops::_Iter_comp_iter<TPPLPartition::VertexSorter>>(long param_1, long param_2, ulong param_3, long param_4, long param_5) {
   float *pfVar1;
   float *pfVar2;
   float fVar3;
   float fVar4;
   ...
   if (param_2 < lVar9) {
      do {
         ...
         fVar3 = pfVar2[1];
         if (( pfVar1[1] < fVar3 ) || ( ( fVar3 == pfVar1[1] && ( fVar3 = *pfVar2 * pfVar1 <= fVar3 && fVar3 != *pfVar1 ) ) )) {
            lVar5 = lVar5 + -1;
 ...
 while ( lVar6 < lVar9 );
      ...
      LAB_00109288:if ((long)( param_3 - 2 ) / 2 == lVar6) {
         lVar9 = lVar6 * 2;
         lVar6 = lVar9 + 1;
   ...
   if (param_2 < lVar6) {
      ...
      do {
         ...
         pfVar2 = (float*)( param_5 + *plVar7 * 0x18 );
         fVar4 = pfVar2[1];
         if (( fVar4 <= fVar3 ) && ( ( fVar4 != fVar3 || ( fVar4 = *pfVar2 ),fVar4 < *pfVar1 || fVar4 == *pfVar1 ) )) {
            plVar7 = (long*)( param_1 + lVar6 * 8 );
            break;
         }
 ...
 while ( param_2 < lVar9 );
   ...
   LAB_00109267:*plVar7 = param_4;
   return;
}
/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* void std::__introsort_loop<long*, long,
   __gnu_cxx::__ops::_Iter_comp_iter<TPPLPartition::VertexSorter> >(long*, long*, long,
   __gnu_cxx::__ops::_Iter_comp_iter<TPPLPartition::VertexSorter>) */void std::__introsort_loop<long*,long,__gnu_cxx::__ops::_Iter_comp_iter<TPPLPartition::VertexSorter>>(long *param_1, long *param_2, long param_3, long param_4) {
   long *plVar1;
   long *plVar2;
   float *pfVar3;
   float *pfVar4;
         ...
         do {
            ...
            if (( fVar6 < fVar15 ) || ( ( fVar15 == fVar6 && ( *pfVar4 <= *pfVar3 && *pfVar3 != *pfVar4 ) ) )) {
               ...
               if (( fVar6 <= fVar7 ) && ( ( fVar6 != fVar7 || ( *pfVar4 < *pfVar5 || *pfVar4 == *pfVar5 ) ) )) {
                  if (( fVar7 < fVar15 ) || ( ( fVar15 == fVar7 && ( *pfVar5 <= *pfVar3 && *pfVar3 != *pfVar5 ) ) )) goto LAB_0010958e;
                  goto LAB_001094b7;
               }

               LAB_001093c7:lVar11 = *param_1;
               *param_1 = lVar14;
               ...
               if (( fVar7 < fVar15 ) || ( ( fVar15 == fVar7 && ( *pfVar5 <= *pfVar3 && *pfVar3 != *pfVar5 ) ) )) {
                  LAB_001094b7:lVar8 = *param_1;
                  *param_1 = lVar11;
                  param_1[1] = lVar8;
               }
 else {
                  if (( fVar6 <= fVar7 ) && ( ( fVar6 != fVar7 || ( *pfVar4 < *pfVar5 || *pfVar4 == *pfVar5 ) ) )) goto LAB_001093c7;
                  LAB_0010958e:lVar8 = *param_1;
                  *param_1 = lVar13;
                  plVar12[-1] = lVar8;
                  lVar11 = *param_1;
                  lVar10 = lVar11 * 2;
            ...
            while (true) {
               ...
               while (true) {
                  ...
                  fVar6 = pfVar4[1];
                  if (( fVar6 <= fVar15 ) && ( ( fVar6 != fVar15 || ( fVar6 = *pfVar4 ),fVar6 < *pfVar3 || fVar6 == *pfVar3 ) )) break;
                  param_2 = param_2 + 1;
               }
;
               do {
...
;
            __introsort_loop<long*,long,__gnu_cxx::__ops::_Iter_comp_iter<TPPLPartition::VertexSorter>>(param_2, plVar12, param_3, param_4);
            lVar8 = (long)param_2 - (long)param_1;
            if (lVar8 < 0x81) {
               return;
            }
 ...
 while ( param_3 != 0 );
      ...
      for (lVar14 = ( lVar8 >> 3 ) + -2 >> 1; __adjust_heap<long*,long,long,__gnu_cxx::__ops::_Iter_comp_iter<TPPLPartition::VertexSorter>>(param_1, lVar14, lVar8 >> 3, param_1[lVar14], param_4),lVar14 != 0; lVar14 = lVar14 + -1) {}
      do {
         param_2 = param_2 + -1;
         lVar8 = *param_2;
         *param_2 = *param_1;
         __adjust_heap<long*,long,long,__gnu_cxx::__ops::_Iter_comp_iter<TPPLPartition::VertexSorter>>(param_1, 0, (long)param_2 - (long)param_1 >> 3, lVar8, param_4);
      }

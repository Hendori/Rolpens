...
/* std::__cxx11::string::string<std::allocator<char> >(char const*, std::allocator<char> const&)
   ...
   *(string**)this = __dest;
   ...
   __dest = *(string**)this;
   LAB_001001b3:*(size_t*)( this + 8 ) = local_38;
...
/* ApiLayerManifestFile::LocateLibraryRelativeToJson(std::__cxx11::string const&,
   std::__cxx11::string const&, std::__cxx11::string&) */undefined4 ApiLayerManifestFile::LocateLibraryRelativeToJson(string *param_1, string *param_2, string *param_3) {
   char cVar1;
   undefined4 uVar2;
   long in_FS_OFFSET;
   undefined1 *local_88;
   ...
   uVar2 = 0;
   std::__cxx11::string::_M_assign(param_3);
   LAB_001002ca:if (local_68 != &local_58) {
...
/* LoaderLogger::LogErrorMessage(std::__cxx11::string const&, std::__cxx11::string const&,
   std::vector<XrSdkLogObjectInfo, std::allocator<XrSdkLogObjectInfo> > const&) [clone .isra.0] */void LoaderLogger::LogErrorMessage(string *param_1, string *param_2, vector *param_3) {
   int iVar1;
   long in_FS_OFFSET;
   undefined5 *local_58;
   undefined8 local_50;
   ...
   local_58 = &local_48;
   LoaderLogger::LogMessage(0x10b680, 0x1000, (string*)0x1, (string*)&local_58, param_1, (vector*)param_2);
...
/* CopyIncludedPaths(bool, std::__cxx11::string const&, std::__cxx11::string const&,
   std::__cxx11::string&) [clone .part.0] [clone .constprop.0] */void CopyIncludedPaths(bool param_1, string *param_2, string *param_3, string *param_4) {
   char cVar1;
   ulong uVar2;
   string *psVar3;
   ulong uVar4;
   ...
   if (uVar2 == 0xffffffffffffffff) {
      ...
      do {
         ...
         local_88 = local_78;
         std::__cxx11::string::_M_construct<char_const*>(&local_88, *plVar7 + uVar5, *plVar7 + uVar5 + uVar2);
 ...
 while ( uVar2 != 0xffffffffffffffff );
      ...
      if (uVar2 != uVar6) {
         if (uVar4 < uVar6) {
            LAB_00100819:std::__throw_out_of_range_fmt("%s: __pos (which is %zu) > this->size() (which is %zu)", "basic_string::substr", uVar5, uVar4);
            goto LAB_0010082e;
         }

         LAB_00100689:local_68 = local_58;
         ...
         if (0x3fffffffffffffffU - *(long*)( param_3 + 8 ) < local_60) {
            LAB_00100807:/* WARNING: Subroutine does not return */std::__throw_length_error("basic_string::append");
         }
   ...
   LAB_0010082e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* WARNING: Removing unreachable block (ram,0x00100bb8) *//* WARNING: Removing unreachable block (ram,0x00100bc5) *//* WARNING: Removing unreachable block (ram,0x00100bd2) *//* WARNING: Removing unreachable block (ram,0x00100bdb) *//* WARNING: Removing unreachable block (ram,0x00100be5) *//* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FindEitherActiveRuntimeFilename(char const*, std::__cxx11::string const&, unsigned short,
   std::__cxx11::string&) */undefined4 FindEitherActiveRuntimeFilename(char *param_1, string *param_2, ushort param_3, string *param_4) {
   ulong *puVar1;
   ...
   *(undefined8*)psVar16 = _locale;
   ...
   std::__ostream_insert<char,std::char_traits<char>>((ostream*)local_298, "Looking for active_runtime.x86_64.json or active_runtime.json in ", 0x41);
   ...
   std::__ostream_insert<char,std::char_traits<char>>((ostream*)local_298, *(char**)param_2, *(long*)( param_2 + 8 ));
   local_2f0 = 0;
   local_2e8 = '\0';
   local_2f8 = &local_2e8;
   ...
   LoaderLogger::LogMessage(0x10b680, 0x10, (string*)0x1, (string*)&local_2b8, (string*)&local_2d8, (vector*)&local_2f8);
   ...
   *(undefined8*)( (long)local_298 + *(long*)( _init + -0x18 ) ) = _locale;
   ...
   if (param_3 < 10) {
      ...
      LAB_00100e1f:cVar14 = (char)uVar20 + '0';
   }
 else {
      if (uVar12 < 100) {
         local_2f8 = &local_2e8;
 ...
 while ( 9999 < uVar15 );
   ...
   *local_2f8 = cVar14;
   plVar7 = (long*)std::__cxx11::string::_M_replace(( ulong ) & local_2f8, 0, (char*)0x0, *(ulong*)param_2);
   ...
   *(undefined1*)( plVar7 + 2 ) = 0;
   ...
   if (cVar14 == '\0') {
      ...
      if (uVar12 < 10) {
         ...
         LAB_001010f7:cVar14 = (char)uVar12 + '0';
      }
 else {
         if (uVar12 < 100) {
            local_2b8 = (char*)&local_2a8;
 ...
 while ( 9999 < uVar21 );
      ...
      *local_2b8 = cVar14;
      plVar7 = (long*)std::__cxx11::string::_M_replace(( ulong ) & local_2b8, 0, (char*)0x0, *(ulong*)param_2);
      puVar2 = ( pointer_____offset_0x10___ )(plVar7 + 2);
      if (( pointer_____offset_0x10___ ) * plVar7 == puVar2) {
         uVar3 = plVar7[1] + 1;
         puVar10 = puVar2;
 ...
 while ( uVar12 < ( (uint)uVar3 & 0xfffffff8 ) );
      ...
      *plVar7 = (long)puVar2;
      if (0x3fffffffffffffffU - (long)local_298[1] < 0x14) {
         LAB_00101803:/* WARNING: Subroutine does not return */std::__throw_length_error("basic_string::append");
      }
 ...
 while ( uVar12 < ( (uint)uVar3 & 0xfffffff8 ) );
   ...
   uVar4 = 1;
   LAB_00101247:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* PlatformUtilsGetSecureEnv(char const*) */char *PlatformUtilsGetSecureEnv(char *param_1) {
   ulong uVar1;
   uint uVar2;
   char *pcVar3;
   size_t sVar4;
   ...
   if (pcVar3 == (char*)0x0) {
      ...
      if (pcVar3 != (char*)0x0) {
         ...
         if (sVar4 < 0x10) {
            ...
            local_58[0] = local_f0;
            psVar10 = local_68;
            LAB_00101cf1:memcpy(psVar10, pcVar3, sVar4);
            psVar10 = local_68;
         }
         ...
         if (sVar4 != 0) {
            ...
            *(undefined1*)( (long)local_e8 + local_f0 ) = 0;
            ...
            if (0x3fffffffffffffff - local_e0 < sVar4) {
               LAB_00101f09:/* WARNING: Subroutine does not return */std::__throw_length_error("basic_string::append");
            }
   ...
   *(char**)param_1 = __dest;
   ...
   if (sVar4 < 0x10) {
      ...
      *(size_t*)( param_1 + 0x10 ) = local_f0;
      LAB_001018e6:memcpy(__dest, pcVar3, sVar4);
      __dest = *(char**)param_1;
   }

   *(size_t*)( param_1 + 8 ) = local_f0;
   __dest[local_f0] = '\0';
   LAB_00101896:if (local_58[3] != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* ManifestFile::ManifestFile(ManifestFileType, std::__cxx11::string const&, std::__cxx11::string
   const&) */void ManifestFile::ManifestFile(ManifestFile *this, undefined4 param_2, long *param_3, long *param_4) {
   long lVar1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ManifestFile::IsValidJson(Json::Value const&, JsonVersion&) */undefined4 ManifestFile::IsValidJson(Value *param_1, JsonVersion *param_2) {
   undefined8 uVar1;
   code *pcVar2;
   undefined4 uVar3;
   undefined4 uVar4;
   ...
   if ((char)uVar3 == '\0') {
      ...
      if ((char)uVar4 != '\0') {
         ...
         if (( ( ( iVar5 != 3 ) || ( *(int*)param_2 != 1 ) ) || ( *(int*)( param_2 + 4 ) != 0 ) ) || ( *(int*)( param_2 + 8 ) != 0 )) {
            ...
            *(undefined8*)psVar7 = _locale;
            ...
            std::__ostream_insert<char,std::char_traits<char>>((ostream*)local_1b8, "ManifestFile::IsValidJson - JSON \"file_format_version\" ", 0x37);
            ...
            local_1bb = 0;
            local_1d8 = &local_1c8;
            LoaderLogger::LogMessage(0x10b680, 0x1000, (string*)0x1, (string*)&local_1d8, (string*)&local_1f8, (vector*)&local_218);
 ...
 while ( (void*)uVar1 != pvVar8 );
   ...
   *(undefined1*)( (long)local_1d8 + local_260 ) = 0;
   ...
   LoaderLogger::LogMessage(0x10b680, 0x1000, (string*)0x1, (string*)local_1b8, (string*)&local_1f8, (vector*)&local_1d8);
 ...
 while ( (void*)uVar1 != pvVar8 );
   ...
   uVar4 = 0;
   LAB_0010223f:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar4;
   }
...
/* RuntimeManifestFile::RuntimeManifestFile(std::__cxx11::string const&, std::__cxx11::string
   const&) */void RuntimeManifestFile::RuntimeManifestFile(RuntimeManifestFile *this, string *param_1, string *param_2) {
   long lVar1;
   *(RuntimeManifestFile**)this = this + 0x10;
   std::__cxx11::string::_M_construct<char*>(this, *(long*)param_1, *(long*)( param_1 + 8 ) + *(long*)param_1);
...
/* ApiLayerManifestFile::ApiLayerManifestFile(ManifestFileType, std::__cxx11::string const&,
   ...
   const&, std::__cxx11::string const&) */void ApiLayerManifestFile::ApiLayerManifestFile(ApiLayerManifestFile *this, undefined8 param_2, undefined8 param_3, long *param_4, long *param_5, undefined8 *param_6, undefined4 *param_7) {
   long lVar1;
...
/* ApiLayerManifestFile::PopulateApiLayerProperties(XrApiLayerProperties&) const */void ApiLayerManifestFile::PopulateApiLayerProperties(ApiLayerManifestFile *this, XrApiLayerProperties *param_1) {
   *(undefined4*)( param_1 + 0x118 ) = *(undefined4*)( this + 0xe8 );
   *(ulong*)( param_1 + 0x110 ) = ( ulong ) * (uint*)( this + 0x98 ) << 0x30 | ( ulong ) * (uint*)( this + 0xa0 ) | ( ( ulong ) * (uint*)( this + 0x9c ) & 0xffff ) << 0x20;
...
/* AddIfJson(std::__cxx11::string const&, std::vector<std::__cxx11::string,
   std::allocator<std::__cxx11::string > >&) [clone .isra.0] */void AddIfJson(string *param_1, vector *param_2) {
   ulong uVar1;
   long *plVar2;
   long lVar3;
   long in_FS_OFFSET;
   ...
   if (uVar1 != 0) {
      ...
      if (4 < uVar1) {
         lVar3 = 5;
         do {
            if (*(char*)( (long)&local_30 + lVar3 + 7 ) != *(char*)( *(long*)param_1 + uVar1 + -6 + lVar3 )) goto LAB_00102a2e;
            lVar3 = lVar3 + -1;
         }
 while ( lVar3 != 0 );
         ...
         if (plVar2 == *(long**)( param_2 + 0x10 )) {
            if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
               std::vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>::_M_realloc_insert<std::__cxx11::string_const&>((vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>*)param_2, plVar2, param_1);
               return;
            }
   ...
   LAB_00102a2e:if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }

   LAB_00102af3:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* CheckAllFilesInThePath(std::__cxx11::string const&, bool, std::vector<std::__cxx11::string,
   std::allocator<std::__cxx11::string > >&) [clone .part.0] */void CheckAllFilesInThePath(string *param_1, bool param_2, vector *param_3) {
   undefined8 uVar1;
   char cVar2;
   string *psVar3;
   long in_FS_OFFSET;
   ...
   if (cVar2 == '\0') {
      LAB_00102c48:uVar1 = local_a8._8_8_;
 ...
 while ( (string*)uVar1 != psVar3 );
   ...
   LAB_00102b58:if (local_88 != &local_78) {
      operator_delete(local_88, CONCAT71(uStack_77, local_78) + 1);
   }
...
/* ManifestFile::GetInstanceExtensionProperties(std::vector<XrExtensionProperties,
   std::allocator<XrExtensionProperties> >&) */void ManifestFile::GetInstanceExtensionProperties(ManifestFile *this, vector *param_1) {
   undefined8 *puVar1;
   char *__src;
   undefined8 *puVar2;
   int iVar3;
            ...
            while (true) {
               ...
               if (sVar9 != sVar6) {
                  ...
                  if (sVar9 == sVar6) {
                     puVar8 = puVar7 + 0x26;
                     if (sVar9 != 0) {
                        LAB_00102fe8:iVar3 = memcmp(__src, puVar7 + 0x28, sVar9);
                        puVar8 = puVar7 + 0x26;
               ...
               LAB_00102e6c:iVar3 = memcmp(__src, puVar7 + 0x15, sVar9);
               puVar8 = puVar7 + 0x13;
               ...
               LAB_00102dc8:puVar8 = puVar7 + 0x4c;
               if (puVar7 + 0x4c == puVar11) goto LAB_00103030;
            }
;
            puVar8 = puVar7;
            if (( sVar9 == 0 ) || ( iVar3 = iVar3 == 0 )) goto joined_r0x00102ee8;
            sVar6 = strlen((char*)( puVar7 + 0x15 ));
            if (sVar9 == sVar6) goto LAB_00102e6c;
            sVar6 = strlen((char*)( puVar7 + 0x28 ));
            if (sVar9 == sVar6) goto LAB_00102fe8;
            LAB_00103006:sVar6 = strlen((char*)( puVar7 + 0x3b ));
            if (sVar9 == sVar6) {
               LAB_00102ebd:iVar3 = memcmp(__src, puVar7 + 0x3b, sVar9);
               puVar8 = puVar7 + 0x39;
 ...
 while ( puVar7 + 0x4c != puVar11 );
         LAB_00103030:puVar8 = puVar7 + 0x4c;
         lVar5 = ( (long)puVar2 - (long)puVar8 >> 3 ) * -0x79435e50d79435e5;
      }

      if (lVar5 == 2) {
         sVar9 = puVar12[1];
         LAB_00103123:pcVar10 = (char*)( puVar8 + 2 );
         sVar6 = strlen(pcVar10);
         if (sVar9 == sVar6) {
            if (sVar9 != 0) {
               LAB_00103166:iVar3 = memcmp(__src, pcVar10, sVar9);
               if (iVar3 != 0) {
            ...
            LAB_00103134:puVar8 = puVar8 + 0x13;
            LAB_0010306c:pcVar10 = (char*)( puVar8 + 2 );
            sVar6 = strlen(pcVar10);
            if (sVar9 != sVar6) goto LAB_00102eee;
            if (sVar9 != 0) {
               LAB_0010308a:iVar3 = memcmp(__src, pcVar10, sVar9);
               if (iVar3 != 0) goto LAB_00102eee;
            }

         }

         joined_r0x00102ee8:if (puVar2 == puVar8) goto LAB_00102eee;
         ...
         *(uint*)( puVar8 + 0x12 ) = uVar4;
         ...
         if (puVar2 == *(undefined8**)( param_1 + 0x10 )) {
            std::vector<XrExtensionProperties,std::allocator<XrExtensionProperties>>::_M_realloc_insert<XrExtensionProperties_const&>((vector<XrExtensionProperties,std::allocator<XrExtensionProperties>>*)param_1, puVar2, &local_d8);
         }
 else {
...
/* ManifestFile::GetFunctionName(std::__cxx11::string const&) const */string * __thiscall ManifestFile::GetFunctionName(ManifestFile *this,string *param_1){
   size_t __n;
   int iVar1;
   ulong uVar2;
   undefined8 *puVar3;
   ...
   if (*(ulong*)( this + 0x78 ) != 0) {
      if (*(ulong*)( this + 0x78 ) < 0x15) {
         ...
         if (plVar4 != (long*)0x0) {
            ...
            do {
               if (__n == plVar4[2]) {
                  if (( __n == 0 ) || ( iVar1 = memcmp(*(void**)param_1, (void*)plVar4[1], __n) ),iVar1 == 0) goto LAB_00103257;
               }
 ...
 while ( plVar4 != (long*)0x0 );
         ...
         puVar3 = (undefined8*)std::_Hashtable<std::__cxx11::string,std::pair<std::__cxx11::string_const,std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,std::__cxx11::string>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::string>,std::hash<std::__cxx11::string>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>::_M_find_before_node((_Hashtable<std::__cxx11::string,std::pair<std::__cxx11::string_const,std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,std::__cxx11::string>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::string>,std::hash<std::__cxx11::string>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>*)( this + 0x60 ), uVar2 % *(ulong*)( this + 0x68 ), param_1, uVar2);
         if (( puVar3 != (undefined8*)0x0 ) && ( plVar4 = (long*)*puVar3 ),plVar4 != (long*)0x0) {
            LAB_00103257:return (string*)( plVar4 + 5 );
         }
...
/* ManifestFile::ParseCommon(Json::Value const&) */void ManifestFile::ParseCommon(ManifestFile *this, Value *param_1) {
   ManifestFile *pMVar1;
   undefined8 *puVar2;
   undefined8 uVar3;
   undefined3 uVar4;
   ...
   LAB_001032fc:Json::Value::operator []((char*)param_1);
   cVar6 = Json::Value::isNull();
   if (cVar6 == '\0') {
         ...
         while (true) {
            ...
            if (cVar6 == '\0') {
               ...
               if (0x3fffffffffffffffU - local_c0 < 0x1a) {
                  LAB_00103f5a:/* WARNING: Subroutine does not return */std::__throw_length_error("basic_string::append");
               }
 ...
 while ( uVar17 < ( (uint)uVar19 & 0xfffffff8 ) );
               ...
               *(undefined1*)( plVar14 + 2 ) = 0;
               ...
               uStack_4b = 0;
               local_68 = &VStack_58;
               LoaderLogger::LogMessage(0x10b680, 0x100, (string*)0x1, (string*)&local_68, (string*)&local_88, (vector*)&local_a8);
 ...
 while ( (void*)uVar3 != pvVar22 );
               ...
               *(ValueIteratorBase**)( this_00 + 8 ) = pVVar25;
               std::__cxx11::string::_M_construct<char*>((string*)( this_00 + 8 ), local_88, local_88 + local_80);
               *(Value**)( this_00 + 0x28 ) = this_00 + 0x38;
               ...
               if (*(ulong*)( this + 0x78 ) < 0x15) {
                  ...
                  for (puVar2 = *(undefined8**)( this + 0x70 ); puVar2 != (undefined8*)0x0; puVar2 = (undefined8*)*puVar2) {
                     if (__n == puVar2[2]) {
               ...
               if (uVar23 < 0x15) {
                  LAB_00103838:uVar18 = 1;
                  cVar6 = std::__detail::_Prime_rehash_policy::_M_need_rehash(( ulong )(this + 0x80), uVar19, uVar23);
                  if (cVar6 == '\0') {
                           ...
                           LAB_001034ea:do {
                              ...
                              *local_88 = (ValueIteratorBase)0x0;
                              ...
                              if (plVar13 == *(long**)( this + 0x58 )) {
                                 std::vector<ExtensionListing,std::allocator<ExtensionListing>>::_M_realloc_insert<ExtensionListing_const&>((vector<ExtensionListing,std::allocator<ExtensionListing>>*)( this + 0x48 ), plVar13, &local_68);
                              }
 else {
                                 *plVar13 = (long)( plVar13 + 2 );
                                 std::__cxx11::string::_M_construct<char*>(plVar13, local_68, local_68 + local_60);
                              ...
                              do {
                                 do {
                                    ...
                                    LAB_001033c0:cVar6 = Json::ValueIteratorBase::isEqual(pVVar25);
                                    param_1 = local_168;
...
;
                     LAB_00103cdc:if (*(ManifestFile**)( this + 0x60 ) != this + 0x90) {
                  ...
                  *(ValueIteratorBase**)( this_00 + 0x48 ) = pVVar12;
                  ...
                  if (*(long**)pMVar1 == (long*)0x0) {
                     ...
                     *(long*)this_00 = lVar15;
                     if (lVar15 != 0) {
                        *(Value**)( __s + ( *(ulong*)( lVar15 + 0x48 ) % *(ulong*)( this + 0x68 ) ) * 8 ) = this_00;
                     }
                  ...
                  *(long*)( this + 0x78 ) = *(long*)( this + 0x78 ) + 1;
                  ...
                  plVar13 = (long*)std::_Hashtable<std::__cxx11::string,std::pair<std::__cxx11::string_const,std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,std::__cxx11::string>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::string>,std::hash<std::__cxx11::string>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>::_M_find_before_node((_Hashtable<std::__cxx11::string,std::pair<std::__cxx11::string_const,std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,std::__cxx11::string>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::string>,std::hash<std::__cxx11::string>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>*)( this + 0x60 ), (ulong)local_168, (string*)( this_00 + 8 ), (ulong)pVVar12);
                  if (( plVar13 == (long*)0x0 ) || ( *plVar13 == 0 )) goto LAB_00103838;
                  LAB_00103731:if (this_00 + 0x38 != *(Value**)( this_00 + 0x28 )) {
         ...
         *(undefined8*)( pVVar16 + ( uVar19 - 8 ) ) = *(undefined8*)( (long)auStack_78 + ( uVar19 - 8 ) );
         ...
         if (7 < uVar17) {
            ...
            do {
               uVar19 = (ulong)uVar9;
               uVar9 = uVar9 + 8;
               *(undefined8*)( ( ( ulong )(pVVar16 + 8) & 0xfffffffffffffff8 ) + uVar19 ) = *(undefined8*)( pVVar21 + ( uVar19 - lVar15 ) );
            }
 while ( uVar9 < uVar17 );
         }
      ...
      if (( local_80 & 4 ) == 0) {
         if (( uVar17 != 0 ) && ( *local_68 = VStack_58 ),VStack_58 = VVar5,VVar5 = VStack_58,( uVar19 & 2 ) != 0) {
...
/* WARNING: Type propagation algorithm not settling *//* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RuntimeManifestFile::CreateIfValid(Json::Value const&, std::__cxx11::string const&,
   ...
   *(undefined8*)psVar10 = _locale;
   ...
   if (local_1d0 < 0x10) {
      ...
      LAB_00104799:memcpy(local_168, puVar1, __n);
   ...
   *(undefined1*)( (long)local_168 + local_160 ) = 0;
   ...
   if (cVar4 == '\0') {
      std::__ostream_insert<char,std::char_traits<char>>((ostream*)&local_1b8, "isValidJson indicates ", 0x16);
      poVar7 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&local_1b8, *(char**)param_2, *(long*)( param_2 + 8 ));
         ...
         if (cVar4 == '\0') {
            ...
            if (cVar4 != '\0') {
               ...
               if (( ( lVar8 != -1 ) || ( lVar8 = std::__cxx11::string::find(cVar4, 0x2f) ),lVar8 != -1 )) {
                  ...
                  if (( cVar4 == '\0' ) || ( cVar4 = FileSysUtilsCombinePaths((string*)&local_238, (string*)local_298, (string*)&local_258) ),cVar4 == '\0') {
                     poVar7 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&local_1b8, *(char**)param_2, *(long*)( param_2 + 8 ));
                     std::__ostream_insert<char,std::char_traits<char>>(poVar7, " filesystem operations failed for path  ", 0x28);
 ...
 while ( (void*)uVar2 != pvVar9 );
               ...
               if (puVar1 == *(undefined8**)( param_3 + 0x10 )) {
                  std::vector<std::unique_ptr<RuntimeManifestFile,std::default_delete<RuntimeManifestFile>>,std::allocator<std::unique_ptr<RuntimeManifestFile,std::default_delete<RuntimeManifestFile>>>>::_M_realloc_insert<RuntimeManifestFile*>((vector<std::unique_ptr<RuntimeManifestFile,std::default_delete<RuntimeManifestFile>>,std::allocator<std::unique_ptr<RuntimeManifestFile,std::default_delete<RuntimeManifestFile>>>>*)param_3, puVar1, local_2b8);
      ...
      poVar7 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&local_1b8, *(char**)param_2, *(long*)( param_2 + 8 ));
      std::__ostream_insert<char,std::char_traits<char>>(poVar7, " is missing required fields.  Verify all proper fields exist.", 0x3d);
      local_2a8 = 0;
      local_210 = 0;
      local_208 = 0;
      local_2b8 = (undefined1[16])0x0;
 ...
 while ( (void*)uVar2 != pvVar9 );
   ...
   joined_r0x001044ab:local_1b8 = &std::__cxx11::ostringstream::VTT;
   local_148[0] = (code*)&std::streambuf::vtable;
   if (local_168 != local_158) {
      puStack_1b0 = std::ios_base::ios_base;
      local_1b8 = &std::__cxx11::ostringstream::VTT;
...
/* WARNING: Removing unreachable block (ram,0x0010587b) *//* WARNING: Removing unreachable block (ram,0x00105880) *//* WARNING: Removing unreachable block (ram,0x0010588d) *//* WARNING: Removing unreachable block (ram,0x0010589a) *//* WARNING: Removing unreachable block (ram,0x001058a3) *//* WARNING: Removing unreachable block (ram,0x001058b0) *//* WARNING: Type propagation algorithm not settling *//* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RuntimeManifestFile::CreateIfValid(std::__cxx11::string const&,
   std::vector<std::unique_ptr<RuntimeManifestFile, std::default_delete<RuntimeManifestFile> >,
   std::allocator<std::unique_ptr<RuntimeManifestFile, std::default_delete<RuntimeManifestFile> > >
   ...
   *(undefined8*)( (long)local_248 + *(long*)( _vtable + -0x18 ) ) = _filebuf;
   ...
   if (( 0x3fffffffffffffffU - local_400 < 0x38 ) || ( std::__cxx11::string::_M_append((char*)&local_408, 0x10a1c0),0x3fffffffffffffffU - local_400 < uVar1 )) {
      /* WARNING: Subroutine does not return */
   ...
   if (( LoaderLogger::GetInstance():: ) && ( iVar7 = __cxa_guard_acquire(&LoaderLogger::GetInstance(), ::instance) ),iVar7 != 0) {
      LoaderLogger::LoaderLogger((LoaderLogger*)LoaderLogger::GetInstance(), ::instance);
      __cxa_atexit(LoaderLogger::~LoaderLogger, LoaderLogger::GetInstance(), ::instance, &__dso_handle);
      __cxa_guard_release(&LoaderLogger::GetInstance(), ::instance);
   }
   ...
   local_3b8[0xd] = 0;
   local_3c8 = local_3b8;
   LoaderLogger::LogMessage(0x10b680, 0x10, (string*)0x1, (string*)&local_3c8, (string*)&local_3e8, (vector*)&local_408);
 ...
 while ( (void*)uVar3 != pvVar11 );
   ...
   *(undefined8*)psVar10 = _locale;
   ...
   LAB_001053d5:*(undefined1*)( (long)local_378 + local_370 ) = 0;
   local_380 = 0x10;
   ...
   if (cVar6 == '\0') {
      ...
      poVar9 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&local_3c8, *(char**)param_1, *(long*)( param_1 + 8 ));
      ...
      local_3cb = 0;
      local_3e8 = (undefined8*)&local_3d8;
      LoaderLogger::LogMessage(0x10b680, 0x1000, (string*)0x1, (string*)&local_3e8, (string*)&local_408, (vector*)&local_428);
      if (local_3e8 != (undefined8*)&local_3d8) {
         operator_delete(local_3e8, CONCAT35(uStack_3d3, CONCAT41(uStack_3d7, local_3d8)) + 1);
      }
 ...
 while ( (void*)uVar3 != pvVar11 );
      ...
      cVar6 = Json::parseFromStream((Factory*)local_478, (istream*)local_248, local_4a8, (string*)&local_448);
      if (( cVar6 == '\0' ) || ( cVar6 = Json::Value::isObject() ),cVar6 == '\0') {
         std::__ostream_insert<char,std::char_traits<char>>((ostream*)&local_3c8, "failed to parse ", 0x10);
         poVar9 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&local_3c8, *(char**)param_1, *(long*)( param_1 + 8 ));
         std::__ostream_insert<char,std::char_traits<char>>(poVar9, ".", 1);
         if (local_440 != 0) {
            std::__ostream_insert<char,std::char_traits<char>>((ostream*)&local_3c8, " (Error message: ", 0x11);
            poVar9 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&local_3c8, local_448, local_440);
            std::__ostream_insert<char,std::char_traits<char>>(poVar9, ")", 1);
         }

         std::__ostream_insert<char,std::char_traits<char>>((ostream*)&local_3c8, " Is it a valid runtime manifest file?", 0x25);
         local_420 = 0;
         local_418 = 0;
         local_428 = &local_418;
         if (local_398._0_8_ == 0) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RuntimeManifestFile::FindManifestFiles(std::__cxx11::string const&,
   std::vector<std::unique_ptr<RuntimeManifestFile, std::default_delete<RuntimeManifestFile> >,
   std::allocator<std::unique_ptr<RuntimeManifestFile, std::default_delete<RuntimeManifestFile> > >
                  ...
                  *(undefined1*)local_208 = (undefined1)uStack_1b8;
                  ...
                  if (uVar7 < 8) {
                     if (( (ulong)local_1c0 & 4 ) == 0) {
                        if (( uVar7 != 0 ) && ( *(undefined1*)local_208 = (undefined1)uStack_1b8((ulong)local_1c0 & 2) != 0 )) {
                           *(undefined2*)( (long)local_208 + ( uVar6 - 2 ) ) = *(undefined2*)( (long)&local_1c0 + uVar6 + 6 );
                        }

                     }
 else {
                        *(undefined4*)local_208 = (undefined4)uStack_1b8;
                        *(undefined4*)( (long)local_208 + ( uVar6 - 4 ) ) = *(undefined4*)( (long)&local_1c0 + uVar6 + 4 );
                     }

                  }
 else {
                     *local_208 = (char*)CONCAT44(uStack_1b8._4_4_, (undefined4)uStack_1b8);
                     *(undefined8*)( (long)local_208 + ( ( (ulong)local_1c0 & 0xffffffff ) - 8 ) ) = *(undefined8*)( (long)&local_1c0 + ( (ulong)local_1c0 & 0xffffffff ) );
                     ...
                     if (7 < uVar7) {
                        ...
                        do {
                           uVar8 = (int)uVar6 + 8;
                           *(undefined8*)( ( ( ulong )(local_208 + 1) & 0xfffffffffffffff8 ) + uVar6 ) = *(undefined8*)( (long)&uStack_1b8 + ( uVar6 - lVar12 ) );
                           uVar6 = (ulong)uVar8;
                        }
 while ( uVar8 < uVar7 );
                     }
         ...
         *(undefined1*)local_1c8 = 0;
         ...
         if (local_200 != (char*)0x0) {
            if (( local_200 == (char*)0x3fffffffffffffff ) || ( std::__cxx11::string::_M_append((char*)&local_208, 0x10a48e),0x3fffffffffffffffU - (long)local_200 < 7 )) goto LAB_00106bfa;
            std::__cxx11::string::_M_append((char*)&local_208, 0x10a490);
            if (local_200 != (char*)0x0) goto LAB_00106072;
         }

         LAB_001060ed:PlatformUtilsGetSecureEnv((char*)&local_1c8);
         local_1e0 = local_1c0;
         local_1e8 = &local_1d8;
         if (local_1c0 == (char*)0x0) {
            local_1d0 = 0;
 ...
 while ( uVar7 < ( (uint)pcVar1 & 0xfffffff8 ) );
         ...
         local_1c8 = _vtable;
         local_78 = 0;
         *(undefined8*)( (long)&local_1c8 + (long)_vtable[-3] ) = _getline<char,std::char_traits<char>,std::allocator<char>>;
         local_1c0 = (char*)0x0;
         ...
         std::__cxx11::string::_M_construct<char_const*>(local_170, local_1e8, local_1e0 + (long)local_1e8);
         local_178 = 8;
         ...
         do {
            do {
               piVar5 = std::getline<char,std::char_traits<char>,std::allocator<char>>((istream*)&local_1c8, (string*)&local_1e8, ':');
               ...
               if (( (byte)piVar5[*(long*)( *(long*)piVar5 + -0x18 ) + 0x20] & 5 ) != 0) {
                  ...
                  cVar3 = FindEitherActiveRuntimeFilename("compiled-in SYSCONFDIR", (string*)&local_208, 1, (string*)&local_268);
                  if (cVar3 == '\0') {
                     local_260 = 0;
 ...
 while ( local_1e0 == (char*)0x0 );
            ...
            LAB_00106427:local_1e0 = (char*)0x0;
            *(undefined1*)local_1e8 = 0;
            if (( local_200 == (char*)0x3fffffffffffffff ) || ( std::__cxx11::string::_M_append((char*)&local_208, 0x10a48e),0x3fffffffffffffffU - (long)local_200 < 7 )) goto LAB_00106bfa;
            std::__cxx11::string::_M_append((char*)&local_208, 0x10a498);
            cVar3 = FindEitherActiveRuntimeFilename("an entry of XDG_CONFIG_DIRS", (string*)&local_208, 1, (string*)&local_268);
         }
 while ( cVar3 == '\0' );
         LAB_001064a0:cVar3 = '\x01';
         LAB_001064a6:if (local_1e8 != &local_1d8) {
            operator_delete(local_1e8, ( ulong )(local_1d8 + 1));
         }
         ...
         *(undefined8*)( (long)&local_1c8 + (long)_vtable[-3] ) = _getline<char,std::char_traits<char>,std::allocator<char>>;
         ...
         LAB_00106072:if (( local_200 == (char*)0x3fffffffffffffff ) || ( std::__cxx11::string::_M_append((char*)&local_208, 0x10a48e),0x3fffffffffffffffU - (long)local_200 < 7 )) {
            LAB_00106bfa:/* WARNING: Subroutine does not return */std::__throw_length_error("basic_string::append");
         }

         std::__cxx11::string::_M_append((char*)&local_208, 0x10a498);
         cVar3 = FindEitherActiveRuntimeFilename("XDG_CONFIG_HOME", (string*)&local_208, 1, (string*)&local_268);
         ...
         LAB_00106586:operator_delete(local_208, ( ulong )(apcStack_1f8[0] + 1));
      }
      ...
      if (cVar3 == '\0') {
         ...
         *(char*)( (long)local_1e8 + (long)local_290 ) = '\0';
         ...
         uStack_1ab = 0;
         local_1c8 = (char**)&uStack_1b8;
         LoaderLogger::LogMessage(0x10b680, 0x1000, (string*)0x1, (string*)&local_1c8, param_1, (vector*)&local_1e8);
         if (local_1c8 != (char**)&uStack_1b8) {
            operator_delete(local_1c8, CONCAT44(uStack_1b8._4_4_, (undefined4)uStack_1b8) + 1);
         }
      ...
      if (( 0x3fffffffffffffffU - local_240 < 0x5a ) || ( std::__cxx11::string::_M_append((char*)&local_248, 0x10a228),0x3fffffffffffffffU - local_240 < uVar6 )) goto LAB_00106bfa;
      ...
      uStack_1ab = 0;
      local_1c8 = (char**)&uStack_1b8;
      LoaderLogger::LogMessage(0x10b680, 0x10, (string*)0x1, (string*)&local_1c8, param_1, (vector*)&local_248);
      if (local_1c8 != (char**)&uStack_1b8) {
         operator_delete(local_1c8, CONCAT44(uStack_1b8._4_4_, (undefined4)uStack_1b8) + 1);
      }
 ...
 while ( (void*)uVar13 != pvVar11 );
   ...
   LAB_00105f4d:uVar13 = 0;
   CreateIfValid((string*)&local_268, param_2);
   LAB_00105f5b:if (local_268 != local_258) {
...
/* WARNING: Type propagation algorithm not settling *//* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ApiLayerManifestFile::CreateIfValid(ManifestFileType, std::__cxx11::string const&, std::istream&,
   ...
   > >&) */void ApiLayerManifestFile::CreateIfValid(int param_1, undefined8 *param_2, istream *param_3, code *param_4, vector<std::unique_ptr<ApiLayerManifestFile,std::default_delete<ApiLayerManifestFile>>,std::allocator<std::unique_ptr<ApiLayerManifestFile,std::default_delete<ApiLayerManifestFile>>>> *param_5) {
   undefined8 *puVar1;
   ulong uVar2;
   pointer_____offset_0x10___ puVar3;
   undefined8 uVar4;
   ...
   *(undefined8*)psVar16 = _locale;
   ...
   if (local_1d0 < 0x10) {
      ...
      LAB_00107615:memcpy(local_168, puVar15, uVar13);
   }
   ...
   *(undefined1*)( (long)local_168 + local_2c8[0] ) = 0;
   ...
   if (( cVar5 == '\0' ) || ( cVar5 = Json::Value::isObject() ),cVar5 == '\0') {
      std::__ostream_insert<char,std::char_traits<char>>((ostream*)&local_1b8, "failed to parse ", 0x10);
      poVar9 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&local_1b8, (char*)*param_2, param_2[1]);
      std::__ostream_insert<char,std::char_traits<char>>(poVar9, ".", 1);
      if (local_290 != 0) {
         std::__ostream_insert<char,std::char_traits<char>>((ostream*)&local_1b8, " (Error message: ", 0x11);
         poVar9 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&local_1b8, local_298, local_290);
         std::__ostream_insert<char,std::char_traits<char>>(poVar9, ")", 1);
      }

      std::__ostream_insert<char,std::char_traits<char>>((ostream*)&local_1b8, " Is it a valid layer manifest file?", 0x23);
      local_2e8 = 0;
      local_210 = 0;
      local_208 = '\0';
 ...
 while ( (void*)uVar4 != pvVar14 );
         LAB_001074d3:}LAB_001074db:if ((void*)local_2f8._0_8_ != (void*)0x0) {
         ...
         if (cVar5 == '\0') {
            std::__ostream_insert<char,std::char_traits<char>>((ostream*)&local_1b8, "isValidJson indicates ", 0x16);
            poVar9 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&local_1b8, (char*)*param_2, param_2[1]);
            std::__ostream_insert<char,std::char_traits<char>>(poVar9, " is not a valid manifest file.", 0x1e);
            local_2e8 = 0;
            local_210 = 0;
            local_208 = '\0';
            local_2f8 = (undefined1[16])0x0;
         ...
         if (cVar5 == '\0') {
            ...
            if (param_1 == 2) {
               ...
               if (cVar5 == '\0') {
                  ...
                  poVar9 = std::__ostream_insert<char,std::char_traits<char>>(poVar9, (char*)*param_2, param_2[1]);
                  std::operator <<(poVar9, " is disabled");
                  local_338 = 0;
                  local_348 = (undefined1[16])0x0;
                  std::__cxx11::stringbuf::str();
                  std::__cxx11::string::string<std::allocator<char>>((string*)&local_1f8, "", extraout_RDX_00);
                  if (( LoaderLogger::GetInstance():: ) && ( iVar7 = __cxa_guard_acquire(&LoaderLogger::GetInstance(), ::instance) ),iVar7 != 0) {
                     LoaderLogger::LoaderLogger((LoaderLogger*)LoaderLogger::GetInstance(), ::instance);
                     __cxa_atexit(LoaderLogger::~LoaderLogger, LoaderLogger::GetInstance(), ::instance, &__dso_handle);
                     __cxa_guard_release(&LoaderLogger::GetInstance(), ::instance);
                  ...
                  local_1bb = 0;
                  local_1d8 = (ulong*)&cStack_1c8;
                  LoaderLogger::LogMessage(0x10b680, 0x10, (string*)0x1, (string*)&local_1d8, (string*)&local_1f8, (vector*)&local_218);
                  if (local_1d8 != (ulong*)&cStack_1c8) {
                     operator_delete(local_1d8, CONCAT35(uStack_1c3, CONCAT41(uStack_1c7, cStack_1c8)) + 1);
                  }
                  ...
                  std::__cxx11::string::_M_dispose();
                  std::__cxx11::string::_M_dispose();
                  std::vector<XrSdkLogObjectInfo,std::allocator<XrSdkLogObjectInfo>>::~vector((vector<XrSdkLogObjectInfo,std::allocator<XrSdkLogObjectInfo>>*)local_348);
                  std::__cxx11::string::_M_dispose();
               }
 else {
                  LAB_0010826a:poVar9 = std::operator <<((ostream*)&local_1b8, "Implicit layer ");
                  poVar9 = std::__ostream_insert<char,std::char_traits<char>>(poVar9, (char*)*param_2, param_2[1]);
                  std::operator <<(poVar9, " is missing \"disable_environment\"");
                  local_338 = 0;
                  local_348 = (undefined1[16])0x0;
                  std::__cxx11::stringbuf::str();
                  std::__cxx11::string::string<std::allocator<char>>((string*)&local_1d8, "", extraout_RDX_01);
                  LoaderLogger::LogErrorMessage((string*)&local_1d8, (string*)&local_1f8, (vector*)local_348);
                  std::__cxx11::string::_M_dispose();
                  std::__cxx11::string::_M_dispose();
                  std::vector<XrSdkLogObjectInfo,std::allocator<XrSdkLogObjectInfo>>::~vector((vector<XrSdkLogObjectInfo,std::allocator<XrSdkLogObjectInfo>>*)local_348);
               }
               ...
               LAB_00107a5a:Json::Value::operator []((char*)local_2f8);
               Json::Value::asString_abi_cxx11_();
               Json::Value::operator []((char*)local_2f8);
               Json::Value::asString_abi_cxx11_();
               local_354 = 0;
               ...
               if (iVar7 == 2) {
                  ...
                  LAB_00107b22:Json::Value::operator []((char*)local_2f8);
                  Json::Value::asString_abi_cxx11_();
                  ...
                  if (( lVar10 == -1 ) && ( lVar10 = lVar10 == -1 )) {
                     LAB_00107c1f:auStack_1e8[0] = auStack_1e8[0] & 0xffffffffffffff00;
                     local_1f0 = 0;
                     local_1f8 = auStack_1e8;
                     Json::Value::operator []((char*)local_2f8);
                     cVar5 = Json::Value::isNull();
                     ...
                     if (puVar1 == *(undefined8**)( param_5 + 0x10 )) {
                        std::vector<std::unique_ptr<ApiLayerManifestFile,std::default_delete<ApiLayerManifestFile>>,std::allocator<std::unique_ptr<ApiLayerManifestFile,std::default_delete<ApiLayerManifestFile>>>>::_M_realloc_insert<ApiLayerManifestFile*>(param_5, puVar1, local_348, (string*)&local_238);
                     }
 else {
                        *puVar1 = pAVar11;
                     ...
                     ManifestFile::ParseCommon(*(ManifestFile**)( *(long*)( param_5 + 8 ) + -8 ), (Value*)local_2f8);
                     for (int i = 0; i < 4; i++) {
                        std::__cxx11::string::_M_dispose();
                     }
                  ...
                  if (cVar5 == '\0') {
                     ...
                     local_348 = (undefined1[16])0x0;
                     std::__cxx11::stringbuf::str();
                     std::__cxx11::string::string<std::allocator<char>>((string*)&local_1d8, "", extraout_RDX_02);
                     LoaderLogger::LogErrorMessage((string*)&local_1d8, (string*)&local_1f8, (vector*)local_348);
                     std::__cxx11::string::_M_dispose();
                     std::__cxx11::string::_M_dispose();
                     std::vector<XrSdkLogObjectInfo,std::allocator<XrSdkLogObjectInfo>>::~vector((vector<XrSdkLogObjectInfo,std::allocator<XrSdkLogObjectInfo>>*)local_348);
                     ...
                     local_348 = (undefined1[16])0x0;
                     std::__cxx11::stringbuf::str();
                     std::__cxx11::string::string<std::allocator<char>>((string*)&local_1d8, "", extraout_RDX_03);
                     LoaderLogger::LogErrorMessage((string*)&local_1d8, (string*)&local_1f8, (vector*)local_348);
                     std::__cxx11::string::_M_dispose();
                     std::__cxx11::string::_M_dispose();
                     std::vector<XrSdkLogObjectInfo,std::allocator<XrSdkLogObjectInfo>>::~vector((vector<XrSdkLogObjectInfo,std::allocator<XrSdkLogObjectInfo>>*)local_348);
                  ...
                  LAB_00107dde:poVar9 = std::operator <<((ostream*)&local_1b8, "layer ");
                  poVar9 = std::__ostream_insert<char,std::char_traits<char>>(poVar9, (char*)*param_2, param_2[1]);
                  ...
                  local_1bb = 0;
                  local_1d8 = (ulong*)&cStack_1c8;
                  LoaderLogger::LogMessage(0x10b680, 0x100, (string*)0x1, (string*)&local_1d8, (string*)&local_1f8, (vector*)&local_218);
                  if (local_1d8 != (ulong*)&cStack_1c8) {
                     operator_delete(local_1d8, CONCAT35(uStack_1c3, CONCAT41(uStack_1c7, cStack_1c8)) + 1);
                  }
            ...
            LAB_00107068:poVar9 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&local_1b8, (char*)*param_2, param_2[1]);
            std::__ostream_insert<char,std::char_traits<char>>(poVar9, " is missing required fields.  Verify all proper fields exist.", 0x3d);
            local_338 = 0;
            local_210 = 0;
            local_208 = '\0';
            local_348 = (undefined1[16])0x0;
 ...
 while ( (void*)uVar4 != pvVar14 );
      ...
      *(undefined8*)( (long)&local_1b8 + *(long*)( _init + -0x18 ) ) = _locale;
      local_148[0] = std::ios::init;
      std::ios_base::~ios_base((ios_base*)local_148);
      LAB_001075b9:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   ...
   void ApiLayerManifestFile::CreateIfValid(undefined4 param_1, undefined8 *param_2, undefined8 param_3) {
      ...
      *(undefined8*)( (long)local_248 + *(long*)( _vtable + -0x18 ) ) = _filebuf;
      ...
      if (lVar6 == 0) {
         std::ios::clear((long)local_248 + *(long*)( local_248[0] + -0x18 ), *(uint*)( (long)auStack_228 + *(long*)( local_248[0] + -0x18 ) ) | 4);
      }
 else {
      ...
      *(undefined8*)psVar9 = _locale;
      ...
      if (local_3e0 < 0x10) {
         ...
         LAB_00108e36:memcpy(local_378, __src, __n);
      ...
      *(undefined1*)( (long)local_378 + local_370 ) = 0;
      ...
      std::__ostream_insert<char,std::char_traits<char>>((ostream*)&local_3c8, "failed to open ", 0xf);
      poVar7 = std::__ostream_insert<char,std::char_traits<char>>((ostream*)&local_3c8, (char*)*param_2, param_2[1]);
 ...
 while ( (void*)uVar1 != pvVar8 );
      ...
      *(undefined8*)( (long)&local_3c8 + *(long*)( _init + -0x18 ) ) = _locale;
      ...
      std::filebuf::close();
      std::__basic_file<char>::~__basic_file(local_1d0);
      LAB_001087d2:local_238[0] = std::ios_base::~ios_base;
      std::locale::~locale(local_200);
      local_248[0] = pcVar3;
      ...
      if (param_2 == 2) {
         ...
         if (param_2 != 3) {
            ...
            *(undefined8*)( local_98 + 0x41 ) = uVar15;
            ...
            LoaderLogger::LogMessage(0x10b680, 0x1000, (string*)0x1, (string*)&local_78, param_1, (vector*)&local_98);
 ...
 while ( (void*)uVar15 != pvVar14 );
      ...
      if (local_190 == (char*)0x0) {
         LAB_00109331:local_4e = 0x61636f6c2e;
         uStack_49 = 0x6c;
         uStack_48 = 0x732f;
         ...
         if (local_f0 == 0) {
            ...
            CopyIncludedPaths(SUB81(&local_f8, 0), (string*)&local_1b8, (string*)&local_118, (string*)pcVar11);
         }
         ...
         if (local_d0 == 0) {
            ...
            *(undefined8*)( local_78 + 0x13 ) = uVar15;
            ...
            LAB_00109b04:CopyIncludedPaths(SUB81(&local_b8, 0), (string*)&local_1b8, (string*)&local_118, (string*)pcVar11);
         }
 else {
            CopyIncludedPaths(SUB81(&local_d8, 0), (string*)&local_1b8, (string*)&local_118, (string*)pcVar11);
            LAB_0010949e:if (local_b0 != 0) goto LAB_00109b04;
            LAB_001094ad:if (local_90 != 0) {
               uStack_5b = 0;
               ...
               if (0x3ffffffffffffff2 < local_1b0) {
                  LAB_00109f92:/* WARNING: Subroutine does not return */std::__throw_length_error("basic_string::append");
               }

               std::__cxx11::string::_M_append((char*)&local_78, (ulong)local_1b8);
               if (local_90 != 0) {
                  CopyIncludedPaths(SUB81(&local_98, 0), (string*)&local_78, (string*)&local_118, (string*)pcVar11);
               }
         ...
         if (_Var2 == _Var3) {
            ...
            if (_Var5 == _Var6) {
               ...
               if (local_78 == (string*)&uStack_68) {
                  ...
                  if (( local_138 == (string*)auStack_128 ) || ( local_138 = local_78 ),psVar18 == (string*)0x0) {
                     local_138 = local_78;
                     auStack_128[0] = uVar8;
                     local_78 = (string*)&uStack_68;
                  }
      ...
      if (uVar8 == 0xffffffffffffffff) {
         ...
         do {
            if (local_110 < uVar9) {
               std::__throw_out_of_range_fmt("%s: __pos (which is %zu) > this->size() (which is %zu)", "basic_string::substr", uVar9);
               goto LAB_00109f8d;
            }
            ...
            local_78 = (string*)&uStack_68;
            std::__cxx11::string::_M_construct<char_const*>((string*)&local_78, local_118 + uVar9, local_118 + uVar9 + uVar12);
            psVar18 = local_98;
            if (local_78 == (string*)&uStack_68) {
               if (local_70 != 0) {
                  if (local_70 == 1) {
                     ...
                     if (uVar7 < 8) {
                        if (( local_70 & 4 ) == 0) {
                           if (( uVar7 != 0 ) && ( *local_98 = uStack_68._0_1_(local_70 & 2) != 0 )) {
                              *(undefined2*)( local_98 + ( uVar9 - 2 ) ) = *(undefined2*)( (long)&local_70 + uVar9 + 6 );
                           }

                        }
 else {
                           *(uint*)local_98 = uStack_68;
                           *(undefined4*)( local_98 + ( uVar9 - 4 ) ) = *(undefined4*)( (long)&local_70 + uVar9 + 4 );
                        }

                     }
 else {
                        *(ulong*)local_98 = CONCAT44(uStack_64, uStack_68);
                        *(undefined8*)( local_98 + ( ( local_70 & 0xffffffff ) - 8 ) ) = *(undefined8*)( (long)&local_70 + ( local_70 & 0xffffffff ) );
                        ...
                        if (7 < uVar7) {
                           ...
                           do {
                              uVar13 = (int)uVar9 + 8;
                              *(undefined8*)( ( ( ulong )(local_98 + 8) & 0xfffffffffffffff8 ) + uVar9 ) = *(undefined8*)( (string*)&uStack_68 + ( uVar9 - lVar10 ) );
                              uVar9 = (ulong)uVar13;
                           }
 while ( uVar13 < uVar7 );
                        }
 ...
 while ( uVar8 != 0xffffffffffffffff );
         if (uVar9 < local_110) {
            LAB_00109983:local_78 = (string*)&uStack_68;
            std::__cxx11::string::_M_construct<char_const*>((string*)&local_78, local_118 + uVar9, local_118 + local_110);
            psVar18 = local_98;
            if (local_78 == (string*)&uStack_68) {
               if (local_70 != 0) {
                  if (local_70 == 1) {
                     *local_98 = uStack_68._0_1_;
                     ...
                     if (uVar7 < 8) {
                        if (( local_70 & 4 ) == 0) {
                           if (( uVar7 != 0 ) && ( *local_98 = uStack_68._0_1_(local_70 & 2) != 0 )) {
                              *(undefined2*)( local_98 + ( uVar8 - 2 ) ) = *(undefined2*)( (long)&local_70 + uVar8 + 6 );
                           }

                        }
 else {
                           *(uint*)local_98 = uStack_68;
                           *(undefined4*)( local_98 + ( uVar8 - 4 ) ) = *(undefined4*)( (long)&local_70 + uVar8 + 4 );
                        }
                        ...
                        *(undefined8*)( local_98 + ( ( local_70 & 0xffffffff ) - 8 ) ) = *(undefined8*)( (long)&local_70 + ( local_70 & 0xffffffff ) );
                        ...
                        if (7 < uVar7) {
                           ...
                           do {
                              uVar8 = (ulong)uVar13;
                              uVar13 = uVar13 + 8;
                              *(undefined8*)( ( ( ulong )(local_98 + 8) & 0xfffffffffffffff8 ) + uVar8 ) = *(undefined8*)( (string*)&uStack_68 + ( uVar8 - lVar10 ) );
                           }
 while ( uVar13 < uVar7 );
                        }
 ...
 while ( puVar21 != puVar16 );
      ...
      uVar15 = 0;
      LAB_001091c2:if (local_178 != &local_168) {
      ...
      LAB_00109f8d:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }
...
;
 ...
 while ( plVar4 != plVar8 );
   ...
   void std::vector<std::__cxx11::string,std::allocator<std::__cxx11::string>>::_M_realloc_insert<std::__cxx11::string_const&>(vector<std::__cxx11::string,std::allocator<std::__cxx11::string>> *this, void *param_2, long *param_3) {
      ...
      if (pvVar3 == pvVar2) {
         ...
         uVar14 = uVar5 * 2;
         if (uVar14 < uVar5) {
            LAB_0010aa88:uVar14 = 0x7fffffffffffffe0;
         }
 else {
            if (uVar14 == 0) {
               plVar11 = (long*)0x20;
      ...
      plVar11 = plVar6 + 4;
      LAB_0010a9db:plVar15 = (long*)( (long)plVar6 + ( (long)param_2 - (long)pvVar3 ) );
      lVar13 = *param_3;
 ...
 while ( plVar11 != plVar15 );
   ...
   void std::vector<XrExtensionProperties,std::allocator<XrExtensionProperties>>::_M_realloc_insert<XrExtensionProperties_const&>(vector<XrExtensionProperties,std::allocator<XrExtensionProperties>> *this, void *param_2, undefined8 *param_3) {
      ...
      if (__src == pvVar2) {
         ...
         uVar20 = uVar20 * 0x98;
         LAB_0010ae0a:__dest_00 = operator_new(uVar20);
         lVar18 = uVar20 + (long)__dest_00;
      }
 else {
         uVar20 = lVar18 * 0xd79435e50d79436;
         if (uVar20 < uVar19) {
            LAB_0010ae00:uVar20 = 0x7fffffffffffffc8;
            goto LAB_0010ae0a;
         }
      ...
      *puVar1 = uVar16;
      ...
      operator_delete(__src, *(long*)( this + 0x10 ) - (long)__src);
      LAB_0010ade3:*(void**)this = __dest_00;
   ...
   void std::vector<ExtensionListing,std::allocator<ExtensionListing>>::_M_realloc_insert<ExtensionListing_const&>(vector<ExtensionListing,std::allocator<ExtensionListing>> *this, undefined8 *param_2, long *param_3) {
      undefined4 uVar1;
      undefined8 *puVar2;
      undefined8 *puVar3;
      long *plVar4;
      ...
      if (puVar3 == puVar2) {
         ...
         if (uVar14 < uVar7) {
            LAB_0010b050:uVar14 = 0x7ffffffffffffff8;
         }
 else {
            if (uVar14 == 0) {
               local_40 = 0;
      ...
      plVar11 = plVar8 + 5;
      LAB_0010af83:plVar10 = (long*)( (long)plVar8 + ( (long)param_2 - (long)puVar3 ) );
      lVar6 = *param_3;
         ...
         do {
            ...
            *plVar10 = (long)plVar11;
            ...
            if (plVar4 == puVar9 + 2) {
               ...
               if (7 < uVar15) {
                  *plVar11 = *plVar4;
                  *(undefined8*)( (long)plVar10 + ( uVar7 & 0xffffffff ) + 8 ) = *(undefined8*)( (long)plVar4 + ( ( uVar7 & 0xffffffff ) - 8 ) );
                  ...
                  if (7 < uVar15) {
                     ...
                     do {
                        uVar7 = (ulong)uVar12;
                        uVar12 = uVar12 + 8;
                        *(undefined8*)( ( ( ulong )(plVar10 + 3) & 0xfffffffffffffff8 ) + uVar7 ) = *(undefined8*)( (long)plVar4 + ( uVar7 - lVar6 ) );
                     }
 while ( uVar12 < uVar15 );
                  }
               ...
               if (( uVar7 & 4 ) == 0) {
                  if (uVar15 != 0) {
                     ...
                     *(undefined2*)( (long)plVar10 + ( uVar7 & 0xffffffff ) + 0xe ) = *(undefined2*)( (long)plVar4 + ( ( uVar7 & 0xffffffff ) - 2 ) );
                     lVar6 = puVar9[1];
                  }
                  ...
                  *(undefined4*)( (long)plVar10 + ( uVar7 & 0xffffffff ) + 0xc ) = *(undefined4*)( (long)plVar4 + ( ( uVar7 & 0xffffffff ) - 4 ) );
                  lVar6 = puVar9[1];
               }
 ...
 while ( param_2 != puVar9 );
         plVar11 = (long*)( (long)plVar8 + ( (long)param_2 + ( -0x28 - (long)puVar3 ) & 0xfffffffffffffff8U ) + 0x50 );
      }
               ...
               if (uVar15 < 8) {
                  if (( uVar7 & 4 ) == 0) {
                     if (( uVar15 != 0 ) && ( *(char*)plVar4 = (char)*plVar5(uVar7 & 2) != 0 )) {
                        *(undefined2*)( (long)plVar10 + ( uVar7 & 0xffffffff ) + 0xe ) = *(undefined2*)( (long)plVar5 + ( ( uVar7 & 0xffffffff ) - 2 ) );
                     }

                  }
 else {
                     *(int*)plVar4 = (int)*plVar5;
                     *(undefined4*)( (long)plVar10 + ( uVar7 & 0xffffffff ) + 0xc ) = *(undefined4*)( (long)plVar5 + ( ( uVar7 & 0xffffffff ) - 4 ) );
                  }

               }
 else {
                  *plVar4 = *plVar5;
                  *(undefined8*)( (long)plVar10 + ( uVar7 & 0xffffffff ) + 8 ) = *(undefined8*)( (long)plVar5 + ( ( uVar7 & 0xffffffff ) - 8 ) );
                  ...
                  if (7 < uVar15) {
                     ...
                     do {
                        uVar7 = (ulong)uVar12;
                        uVar12 = uVar12 + 8;
                        *(undefined8*)( ( ( ulong )(plVar10 + 3) & 0xfffffffffffffff8 ) + uVar7 ) = *(undefined8*)( (long)plVar5 + ( uVar7 - lVar13 ) );
                     }
 while ( uVar12 < uVar15 );
                  }
 ...
 while ( puVar2 != puVar9 );
         plVar11 = (long*)( (long)plVar11 + ( (long)puVar2 + ( -0x28 - (long)param_2 ) & 0xfffffffffffffff8U ) + 0x28 );
      }
 ...
 while ( puVar9 + 1 != (undefined8*)( ( (long)param_2 - (long)puVar2 ) + (long)puVar7 ) );
         ...
         uVar4 = uVar6 * 2;
         if (uVar4 < uVar6) {
            LAB_0010b3a8:uVar11 = 0x7ffffffffffffff8;
            goto LAB_0010b3b2;
         }
      ...
      LAB_0010b379:if (puVar2 != (undefined8*)0x0) {
   ...
   void std::vector<std::unique_ptr<ApiLayerManifestFile,std::default_delete<ApiLayerManifestFile>>,std::allocator<std::unique_ptr<ApiLayerManifestFile,std::default_delete<ApiLayerManifestFile>>>>::_M_realloc_insert<ApiLayerManifestFile*>(vector<std::unique_ptr<ApiLayerManifestFile,std::default_delete<ApiLayerManifestFile>>,std::allocator<std::unique_ptr<ApiLayerManifestFile,std::default_delete<ApiLayerManifestFile>>>> *this, undefined8 *param_2, undefined8 *param_3) {
      undefined8 *puVar1;
      undefined8 *puVar2;
      undefined8 uVar3;
      ulong uVar4;
      ...
      if (puVar2 == puVar1) {
         ...
         uVar11 = uVar11 * 8;
         LAB_0010b542:puVar7 = (undefined8*)operator_new(uVar11);
         lVar10 = uVar11 + (long)puVar7;
         puVar9 = puVar7 + 1;
         *(undefined8*)( (long)puVar7 + ( (long)param_2 - (long)puVar2 ) ) = *param_3;
         if (param_2 != puVar2) {
            LAB_0010b4b9:puVar5 = puVar7;
            puVar8 = puVar2;
            do {
               puVar9 = puVar5;
               uVar3 = *puVar8;
 ...
 while ( puVar9 + 1 != (undefined8*)( ( (long)param_2 - (long)puVar2 ) + (long)puVar7 ) );
         ...
         uVar4 = uVar6 * 2;
         if (uVar4 < uVar6) {
            LAB_0010b538:uVar11 = 0x7ffffffffffffff8;
            goto LAB_0010b542;
         }
      ...
      memcpy(puVar9, param_2, (long)puVar1 - (long)param_2);
      puVar9 = (undefined8*)( (long)puVar9 + ( (long)puVar1 - (long)param_2 ) );
      LAB_0010b509:if (puVar2 != (undefined8*)0x0) {
         operator_delete(puVar2, *(long*)( this + 0x10 ) - (long)puVar2);
      }
   ...
   long *__thiscallstd::_Hashtable<std::__cxx11::string,std::pair<std::__cxx11::string_const,std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,std::__cxx11::string>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::string>,std::hash<std::__cxx11::string>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>::_M_find_before_node(_Hashtable<std::__cxx11::string,std::pair<std::__cxx11::string_const,std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,std::__cxx11::string>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::string>,std::hash<std::__cxx11::string>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>> *this, ulong param_1, string *param_2, ulong param_3) {
      long *plVar1;
      size_t __n;
      int iVar2;
      ulong uVar3;
 ...
 while ( ( plVar1 != (long*)0x0 ) && ( uVar3 = plVar1[9] ),plVar5 = plVar4,param_1 == uVar3 % *(ulong*)( this + 8 ) );
         plVar5 = (long*)0x0;
      }

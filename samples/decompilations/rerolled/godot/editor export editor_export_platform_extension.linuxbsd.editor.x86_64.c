   ...
   if (plVar5 == (long*)0x0) {
      ...
      if (*(code**)( in_RSI[1] + 0xe0 ) == (code*)0x0) {
         ...
         if (pOVar3 != (Object*)0x0) {
            ...
            cVar1 = RefCounted::unreference();
            joined_r0x001051df:if (( cVar1 != '\0' ) && ( cVar1 = predelete_handler(pOVar3) ),cVar1 != '\0') {
...
goto LAB_00110357;}LAB_00110726:if (pOVar9 == (Object*)0x0) goto LAB_00110357;cVar2 = RefCounted::unreference();}if (( cVar2 != '\0' ) && ( cVar2 = predelete_handler(pOVar9) ),cVar2 != '\0') {
   ...
   if (plVar7 == (long*)0x0) {
      ...
      if (pcVar1 == (code*)0x0) {
         ...
         if (pOVar5 != (Object*)0x0) {
            ...
            cVar2 = RefCounted::unreference();
            joined_r0x00110eb5:if (( cVar2 != '\0' ) && ( cVar2 = predelete_handler(pOVar5) ),cVar2 != '\0') {
               ( **(code**)( *(long*)pOVar5 + 0x140 ) )(pOVar5);
               Memory::free_static(pOVar5, false);
            }

            if (( CONCAT44(uStack_f4, local_f8) == 0 ) || ( cVar2 = RefCounted::unreference() ),cVar2 == '\0') goto LAB_00110d27;

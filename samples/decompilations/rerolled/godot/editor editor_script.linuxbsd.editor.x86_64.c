   ...
   if (( local_68 != 0 ) && ( 1 < *(uint*)( local_68 + -8 ) )) {
      ...
      if (local_58 == (Object*)0x0) {
         ...
         if (pOVar4 == (Object*)0x0) {
            ...
            if (( local_58 != (Object*)0x0 ) && ( cVar1 = RefCounted::unreference() ),cVar1 != '\0') goto LAB_0010051b;
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
         }
...
/* EditorScript::_initialize_classv() */void EditorScript::_initialize_classv(void) {
   ...
   void MethodBindTRC<EditorInterface*>::validated_call(MethodBindTRC<EditorInterface*> *this, Object *param_1, Variant **param_2, Variant *param_3) {
      code *pcVar1;
      long *plVar2;
      long in_FS_OFFSET;
      long local_58;
   ...
   void MethodBindTRC<EditorInterface*>::ptrcall(MethodBindTRC<EditorInterface*> *this, Object *param_1, void **param_2, void *param_3) {
      undefined8 uVar1;
      long *plVar3;
      long in_FS_OFFSET;
      long local_58;
   ...
   void MethodBindTRC<EditorInterface*>::~MethodBindTRC(MethodBindTRC<EditorInterface*> *this) {
      /* WARNING: Bad instruction - Truncating control flow here */
      halt_baddata();
   }
   ...
   void MethodBindT<Node*>::~MethodBindT(MethodBindT<Node*> *this) {
      /* WARNING: Bad instruction - Truncating control flow here */
      halt_baddata();
   }
   ...
   void EditorScript::~EditorScript(EditorScript *this) {
      /* WARNING: Bad instruction - Truncating control flow here */
      halt_baddata();
   }

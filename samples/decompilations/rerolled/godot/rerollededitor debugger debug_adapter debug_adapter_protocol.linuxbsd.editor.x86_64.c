...
/* DebugAdapterProtocol::poll() */void DebugAdapterProtocol::poll(DebugAdapterProtocol *this) {
   ...
   if (( plVar11 != (long*)0x0 ) && ( plVar11 = (long*)*plVar11 ),plVar11 != (long*)0x0) {
      ...
      do {
         ...
         if (( iVar7 == 0 ) || ( iVar7 == 3 )) {
            LAB_00105f19:if (pauVar10 == (undefined1(*) [16])0x0) {
               pauVar10 = (undefined1(*) [16])operator_new(0x18, DefaultAllocator::alloc);
               *(undefined4*)pauVar10[1] = 0;
               *pauVar10 = (undefined1[16])0x0;
            }

            LAB_00105f4d:puVar8 = (undefined8*)operator_new(0x20, DefaultAllocator::alloc);
            for (int i = 0; i < 3; i++) {
               puVar8[( i + 1 )] = 0;
            }
            ...
            *(int*)pauVar10[1] = *(int*)pauVar10[1] + 1;
            ...
            if (pOVar2 != (Object*)this_00) {
               *(DAPeer**)( this + 0x1b8 ) = this_00;
               ...
               if (( ( pOVar2 != (Object*)0x0 ) && ( cVar6 = RefCounted::unreference() ),cVar6 != '\0' )) &&( cVar6 = cVar6 != '\0' )(**(code**)( *(long*)pOVar2 + 0x140 ))(pOVar2);
               Memory::free_static(pOVar2, false);
            }

/* GPUParticlesCollisionSDF3DEditorPlugin::edit(Object*) */

void __thiscall
GPUParticlesCollisionSDF3DEditorPlugin::edit
          (GPUParticlesCollisionSDF3DEditorPlugin *this,Object *param_1)
...
/* GPUParticlesCollisionSDF3DEditorPlugin::make_visible(bool) */

void __thiscall
GPUParticlesCollisionSDF3DEditorPlugin::make_visible
          (GPUParticlesCollisionSDF3DEditorPlugin *this,bool param_1)
...
/* GPUParticlesCollisionSDF3DEditorPlugin::bake_func_step(int, String const&) */

void GPUParticlesCollisionSDF3DEditorPlugin::bake_func_step(int param_1,String *param_2)

{
  ...
  _err_print_error("bake_func_step","editor/plugins/gpu_particles_collision_sdf_editor_plugin.cpp",
                   0x82,"Parameter \"tmp_progress\" is null.",0,0);
  return;
}



/* GPUParticlesCollisionSDF3DEditorPlugin::bake_func_end() */

void GPUParticlesCollisionSDF3DEditorPlugin::bake_func_end(void)

{
  ...
  _err_print_error("bake_func_end","editor/plugins/gpu_particles_collision_sdf_editor_plugin.cpp",
                   0x87,"Parameter \"tmp_progress\" is null.",0,0);
  return;
}



/* GPUParticlesCollisionSDF3DEditorPlugin::handles(Object*) const */

undefined4 __thiscall
GPUParticlesCollisionSDF3DEditorPlugin::handles
          (GPUParticlesCollisionSDF3DEditorPlugin *this,Object *param_1)
...
/* GPUParticlesCollisionSDF3DEditorPlugin::bake_func_begin(int) */

void GPUParticlesCollisionSDF3DEditorPlugin::bake_func_begin(int param_1)

{
  ...
  if (tmp_progress == (EditorProgress *)0x0) {
    ...
    _err_print_error("bake_func_begin",
                     "editor/plugins/gpu_particles_collision_sdf_editor_plugin.cpp",0x7c,
                     "Condition \"tmp_progress != nullptr\" is true.",0,0);
    return;
  }
                    /* WARNING: Subroutine does not return */
  __stack_chk_fail();
...

{
  ...
  *(Button **)(this + 0x670) = this_01;
  ...
  if ((GPUParticlesCollisionSDF3DEditorPlugin()::{lambda()#1}::operator()()::sname == '\0') &&
     (iVar8 = __cxa_guard_acquire(&GPUParticlesCollisionSDF3DEditorPlugin()::{lambda()#1}::
                                   operator()()::sname), iVar8 != 0)) {
    _scs_create((char *)&GPUParticlesCollisionSDF3DEditorPlugin()::{lambda()#1}::operator()()::sname
                ,true);
    __cxa_atexit(StringName::~StringName,
                 &GPUParticlesCollisionSDF3DEditorPlugin()::{lambda()#1}::operator()()::sname,
                 &__dso_handle);
    __cxa_guard_release(&GPUParticlesCollisionSDF3DEditorPlugin()::{lambda()#1}::operator()()::sname
                       );
  }
  (*pcVar3)((CowData<char32_t> *)local_58,pOVar11,
            &GPUParticlesCollisionSDF3DEditorPlugin()::{lambda()#1}::operator()()::sname,lVar1);
...
/* GPUParticlesCollisionSDF3DEditorPlugin::_notification(int) [clone .part.0] */

void GPUParticlesCollisionSDF3DEditorPlugin::_notification(int param_1)

{
  ...
  if (*(long *)(lVar8 + 0x660) != 0) {
    ...
    local_68 = &_LC67;
    String::parse_utf32((StrRange *)&local_88);
    vformat<float,float,float>
              (local_80,fVar9 / (float)(int)uVar1,fVar12 / (float)(int)uVar2,
               in_XMM1_Da / (float)(int)uVar3);
    local_98 = 0;
    String::parse_latin1((String *)&local_98,"");
    local_a0 = 0;
    ...
    vformat<String,String>
              ((String *)&local_68,local_80,(String *)&local_78,(CowData<char32_t> *)&local_70);
    String::operator+=((String *)&local_a8,(String *)&local_68);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_68);
    CowData<char32_t>::_unref((CowData<char32_t> *)local_80);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_90);
    ...
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_70);
    local_4c = 0;
    (**(code **)(**(long **)(lVar8 + 0x670) + 0x348))
              ((String *)&local_68,*(long **)(lVar8 + 0x670),&local_4c);
...
void __thiscall
GPUParticlesCollisionSDF3DEditorPlugin::_notification
          (GPUParticlesCollisionSDF3DEditorPlugin *this,int param_1)
...
void __thiscall
GPUParticlesCollisionSDF3DEditorPlugin::_sdf_save_path_and_bake
          (GPUParticlesCollisionSDF3DEditorPlugin *this,String *param_1)
...
LAB_00101ea0:
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_88);
LAB_00101ea8:
        _err_print_error("_sdf_save_path_and_bake",
                         "editor/plugins/gpu_particles_collision_sdf_editor_plugin.cpp",0xac,
                         "Condition \"t.is_null()\" is true.",0,0);
      }
      else {
...
LAB_00101cbf:
          ...
          if (cVar4 == '\0') {
            if (((local_80 == (Object *)0x0) ||
               ...
               (cVar4 = predelete_handler(local_80), cVar4 == '\0')) goto LAB_00101ea0;
            pOVar6 = (Object *)0x0;
LAB_00101ca5:
      ...
      _err_print_error("_sdf_save_path_and_bake",
                       "editor/plugins/gpu_particles_collision_sdf_editor_plugin.cpp",0xa9,
  ...
  if ((local_b0 != (String *)0x0) && (cVar4 = RefCounted::unreference(), cVar4 != '\0')) {
...
/* GPUParticlesCollisionSDF3DEditorPlugin::_bake() */

void __thiscall
GPUParticlesCollisionSDF3DEditorPlugin::_bake(GPUParticlesCollisionSDF3DEditorPlugin *this)

{
  ...
  if (*(long *)(this + 0x660) != 0) {
    ...
    if ((local_90 == 0) || (*(uint *)(local_90 + -8) < 2)) {
      ...
      operator+((char *)&local_58,(String *)"res://");
...
/* GPUParticlesCollisionSDF3DEditorPlugin::is_class_ptr(void*) const */

uint __thiscall
GPUParticlesCollisionSDF3DEditorPlugin::is_class_ptr
          (GPUParticlesCollisionSDF3DEditorPlugin *this,void *param_1)

{
  return (uint)CONCAT71(0x1098,(undefined4 *)param_1 == &EditorPlugin::get_class_ptr_static()::ptr)
         | (uint)CONCAT71(0x1098,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1098,(undefined4 *)param_1 == &Node::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1098,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr);
}



/* GPUParticlesCollisionSDF3DEditorPlugin::_getv(StringName const&, Variant&) const */

undefined8 GPUParticlesCollisionSDF3DEditorPlugin::_getv(StringName *param_1,Variant *param_2)
...
/* GPUParticlesCollisionSDF3DEditorPlugin::_setv(StringName const&, Variant const&) */

undefined8 GPUParticlesCollisionSDF3DEditorPlugin::_setv(StringName *param_1,Variant *param_2)
...
/* GPUParticlesCollisionSDF3DEditorPlugin::_property_can_revertv(StringName const&) const */

undefined8 GPUParticlesCollisionSDF3DEditorPlugin::_property_can_revertv(StringName *param_1)
...
undefined8
GPUParticlesCollisionSDF3DEditorPlugin::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* GPUParticlesCollisionSDF3DEditorPlugin::has_main_screen() const */

undefined8 GPUParticlesCollisionSDF3DEditorPlugin::has_main_screen(void)
...
void __thiscall
CallableCustomMethodPointer<GPUParticlesCollisionSDF3DEditorPlugin,void,String_const&>::
...
void __thiscall
CallableCustomMethodPointer<GPUParticlesCollisionSDF3DEditorPlugin,void>::
~CallableCustomMethodPointer
          (CallableCustomMethodPointer<GPUParticlesCollisionSDF3DEditorPlugin,void> *this)
...
CallableCustomMethodPointer<GPUParticlesCollisionSDF3DEditorPlugin,void,String_const&>::
get_argument_count(CallableCustomMethodPointer<GPUParticlesCollisionSDF3DEditorPlugin,void,String_const&>
                   *this,bool *param_1)
...
undefined8 __thiscall
CallableCustomMethodPointer<GPUParticlesCollisionSDF3DEditorPlugin,void>::get_argument_count
          (CallableCustomMethodPointer<GPUParticlesCollisionSDF3DEditorPlugin,void> *this,
          bool *param_1)
...
/* GPUParticlesCollisionSDF3DEditorPlugin::_validate_propertyv(PropertyInfo&) const */

void GPUParticlesCollisionSDF3DEditorPlugin::_validate_propertyv(PropertyInfo *param_1)
...
undefined8 __thiscall
CallableCustomMethodPointer<GPUParticlesCollisionSDF3DEditorPlugin,void,String_const&>::get_object
          (CallableCustomMethodPointer<GPUParticlesCollisionSDF3DEditorPlugin,void,String_const&>
           *this)
...
/* CallableCustomMethodPointer<GPUParticlesCollisionSDF3DEditorPlugin, void>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<GPUParticlesCollisionSDF3DEditorPlugin,void>::get_object
          (CallableCustomMethodPointer<GPUParticlesCollisionSDF3DEditorPlugin,void> *this)
...

{
  ...
  if (in_RSI != &get_class_ptr_static()::ptr) {
    uVar1 = (uint)CONCAT71(0x1098,in_RSI == &Container::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x1098,in_RSI == &BoxContainer::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x1098,in_RSI == &Control::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x1098,in_RSI == &CanvasItem::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x1098,in_RSI == &Node::get_class_ptr_static()::ptr) |
...
/* GPUParticlesCollisionSDF3DEditorPlugin::_get_class_namev() const */

undefined8 * GPUParticlesCollisionSDF3DEditorPlugin::_get_class_namev(void)
...
/* GPUParticlesCollisionSDF3DEditorPlugin::get_plugin_name() const */

GPUParticlesCollisionSDF3DEditorPlugin * __thiscall
...
/* GPUParticlesCollisionSDF3DEditorPlugin::get_class() const */

void GPUParticlesCollisionSDF3DEditorPlugin::get_class(void)
...
/* GPUParticlesCollisionSDF3DEditorPlugin::GPUParticlesCollisionSDF3DEditorPlugin() [clone .cold] */
...
void __thiscall
CallableCustomMethodPointer<GPUParticlesCollisionSDF3DEditorPlugin,void>::call
          (CallableCustomMethodPointer<GPUParticlesCollisionSDF3DEditorPlugin,void> *this,
...
void __thiscall
CallableCustomMethodPointer<GPUParticlesCollisionSDF3DEditorPlugin,void,String_const&>::call
          (CallableCustomMethodPointer<GPUParticlesCollisionSDF3DEditorPlugin,void,String_const&>
...
/* GPUParticlesCollisionSDF3DEditorPlugin::_notificationv(int, bool) */

void __thiscall
GPUParticlesCollisionSDF3DEditorPlugin::_notificationv
          (GPUParticlesCollisionSDF3DEditorPlugin *this,int param_1,bool param_2)
...
/* GPUParticlesCollisionSDF3DEditorPlugin::is_class(String const&) const */

undefined8 __thiscall
GPUParticlesCollisionSDF3DEditorPlugin::is_class
          (GPUParticlesCollisionSDF3DEditorPlugin *this,String *param_1)
...
/* GPUParticlesCollisionSDF3DEditorPlugin::_initialize_classv() */

void GPUParticlesCollisionSDF3DEditorPlugin::_initialize_classv(void)
...
void __thiscall
GPUParticlesCollisionSDF3DEditorPlugin::_get_property_listv
          (GPUParticlesCollisionSDF3DEditorPlugin *this,List *param_1,bool param_2)
...
void GPUParticlesCollisionSDF3DEditorPlugin::_GLOBAL__sub_I__bake(void)

/* embree::getPlatformName[abi:cxx11]() */embree * __thiscall embree::getPlatformName_abi_cxx11_(embree *this){
...
/* embree::getCompilerName[abi:cxx11]() */embree * __thiscall embree::getCompilerName_abi_cxx11_(embree *this){
...
/* WARNING: Removing unreachable block (ram,0x001000a1) *//* embree::getCPUVendor[abi:cxx11]() */embree * __thiscall embree::getCPUVendor_abi_cxx11_(embree *this){
   undefined4 uVar1;
   size_t sVar2;
   uint uVar3;
   ulong uVar4;
      ...
      if (uVar5 < 8) {
         if (( sVar2 & 4 ) == 0) {
            if (uVar5 != 0) {
               ...
               if (( sVar2 & 2 ) != 0) {
                  *(undefined2*)( this + ( sVar2 & 0xffffffff ) + 0xe ) = *(undefined2*)( (long)&uStack_50 + ( sVar2 & 0xffffffff ) + 6 );
               }
            ...
            *(undefined4*)( this + ( sVar2 & 0xffffffff ) + 0xc ) = *(undefined4*)( (long)&uStack_50 + ( sVar2 & 0xffffffff ) + 4 );
         }

      }
 else {
         *(ulong*)( this + 0x10 ) = CONCAT44(local_48._4_4_, (undefined4)local_48);
         *(undefined8*)( this + ( sVar2 & 0xffffffff ) + 8 ) = *(undefined8*)( (long)&uStack_50 + ( sVar2 & 0xffffffff ) );
         ...
         if (7 < uVar5) {
            ...
            do {
               uVar3 = (int)uVar4 + 8;
               *(undefined8*)( ( ( ulong )(this + 0x18) & 0xfffffffffffffff8 ) + uVar4 ) = *(undefined8*)( (long)&local_48 + ( uVar4 - lVar6 ) );
               uVar4 = (ulong)uVar3;
            }
 while ( uVar3 < uVar5 );
         }
...
/* WARNING: Removing unreachable block (ram,0x001002e7) *//* WARNING: Removing unreachable block (ram,0x001002d8) *//* WARNING: Removing unreachable block (ram,0x001001dc) *//* embree::getCPUModel() */undefined8 embree::getCPUModel(void) {
   int *piVar1;
   uint *puVar2;
   undefined4 uVar3;
   long lVar4;
   ...
   *(undefined1*)( (long)local_38 + local_40 ) = 0;
   if (( ( local_40 == 0xc ) && ( *local_48 == 0x49656e69756e6547 ) ) && ( (int)local_48[1] == 0x6c65746e )) {
      ...
      if (0 < *piVar1) {
         ...
         uVar5 = *puVar2;
         if (( ( uVar5 & 0xf00 ) == 0x600 ) && ( uVar5 = ( uVar5 >> 0xc & 0xf0 ) + 0x600 + ( (int)uVar5 >> 4 & 0xfU ) ),uVar5 < 0x6a7) {
            if (0x63b < uVar5) {
               switch (uVar5) {
                  case 0x63c:
                  case 0x645:
            ...
            if (uVar5 != 0x63b) {
               if (uVar5 < 0x61a) {
                  ...
                  if (( ( ( uVar8 & 0x140839 ) != 0 ) || ( uVar10 = 0x10(uVar8 & 0x290000) != 0 ) ) || ( uVar10 = uVar5 == 0x63a )) goto switchD_00100347_caseD_66a;
               }
   ...
   switchD_00100347_caseD_640:uVar10 = 0x15;
   switchD_00100347_caseD_66a:if (local_38[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar10;
   }
...
/* embree::stringOfCPUModel[abi:cxx11](embree::CPU) */embree * __thiscall embree::stringOfCPUModel_abi_cxx11_(embree *this,undefined4 param_2){
   undefined8 uVar1;
   char *pcVar2;
   undefined8 uVar3;
   long in_FS_OFFSET;
...
/* embree::get_xcr0() */undefined1[12];embree::get_xcr0(void) {
   int in_XCR0;
...
/* WARNING: Removing unreachable block (ram,0x00100af2) *//* WARNING: Removing unreachable block (ram,0x00100db0) *//* WARNING: Removing unreachable block (ram,0x00100a21) *//* WARNING: Removing unreachable block (ram,0x00100a0f) *//* WARNING: Removing unreachable block (ram,0x00100a05) *//* embree::getCPUFeatures() */ulong embree::getCPUFeatures(void)

...
/* std::_Rb_tree<int, std::pair<int const, glslang::TPpContext::MacroSymbol>,
   ...
   .isra.0] */void std::_Rb_tree<int,std::pair<int_const,glslang::TPpContext::MacroSymbol>,std::_Select1st<std::pair<int_const,glslang::TPpContext::MacroSymbol>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,glslang::TPpContext::MacroSymbol>>>::_M_erase(_Rb_tree_node *param_1) {
   long lVar1;
   long lVar2;
   long lVar3;
   long lVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* glslang::TPpContext::~TPpContext() */void glslang::TPpContext::~TPpContext(TPpContext *this) {
   undefined8 uVar1;
   long lVar2;
   undefined8 *puVar3;
   void *pvVar4;
 ...
 while ( puVar3 < (undefined8*)( lVar2 + 8U ) );
   ...
   for (lVar2 = *(long*)( this + 0x20 ); lVar2 != 0; lVar2 = *(long*)( lVar2 + 0x10 )) {
      std::_Rb_tree<int,std::pair<int_const,glslang::TPpContext::MacroSymbol>,std::_Select1st<std::pair<int_const,glslang::TPpContext::MacroSymbol>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,glslang::TPpContext::MacroSymbol>>>::_M_erase(*(_Rb_tree_node**)( lVar2 + 0x18 ));
   }

   return;
}
/* glslang::TPpContext::~TPpContext() */void glslang::TPpContext::~TPpContext(TPpContext *this) {
   ~TPpContext(this)
   ;;
   operator_delete(this, 0x3d0);
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* glslang::TPpContext::TPpContext(glslang::TParseContextBase&, std::__cxx11::string const&,
   glslang::TShader::Includer&) */void glslang::TPpContext::TPpContext(TPpContext *this, TParseContextBase *param_1, string *param_2, Includer *param_3) {
   undefined8 *puVar1;
   long lVar2;
   long lVar3;
   undefined8 uVar4;
   ...
   *(TParseContextBase**)( this + 0x100 ) = param_1;
   for (int i = 0; i < 3; i++) {
      *(undefined8*)( this + ( 16*i + 264 ) ) = 0;
      *(undefined8*)( this + ( 16*i + 272 ) ) = 0;
   }
   ...
   *(undefined8*)( this + 0x1e0 ) = 8;
   for (int i = 0; i < 4; i++) {
      *(undefined1(*) [16])( this + ( 16*i + 488 ) ) = (undefined1[16])0;
   }
   ...
   *(undefined4*)( this + 0x180 ) = 0;
   for (int i = 0; i < 4; i++) {
      *(undefined1(*) [16])( this + ( 16*i + 316 ) ) = (undefined1[16])0;
   }
...
/* glslang::TPpContext::setInput(glslang::TInputScanner&, bool) */void glslang::TPpContext::setInput(TPpContext *this, TInputScanner *param_1, bool param_2) {
   undefined8 *puVar1;
   long *plVar2;
   long lVar3;
   long in_FS_OFFSET;
   ...
   *plVar2 = 0x1010c8;
   ...
   if (puVar1 == *(undefined8**)( this + 0x198 )) {
      std::vector<glslang::TPpContext::tInput*,std::allocator<glslang::TPpContext::tInput*>>::_M_realloc_insert<glslang::TPpContext::tInput*const&>((vector<glslang::TPpContext::tInput*,std::allocator<glslang::TPpContext::tInput*>>*)( this + 0x188 ), puVar1, &local_38);
      lVar3 = *plVar2;
   }
 else {
      *puVar1 = plVar2;
...
/* WARNING: Control flow encountered bad instruction data *//* void std::vector<glslang::TPpContext::tInput*, std::allocator<glslang::TPpContext::tInput*>
   ...
   if (__src == pvVar1) {
      ...
      uVar3 = uVar3 << 3;
      LAB_0010098a:__dest_00 = operator_new(uVar3);
      lVar4 = uVar3 + (long)__dest_00;
   }
 else {
      uVar3 = uVar2 * 2;
      if (uVar3 < uVar2) {
         LAB_00100980:uVar3 = 0x7ffffffffffffff8;
         goto LAB_0010098a;
      }
   ...
   *(undefined8*)( (long)__dest_00 + __n ) = *param_3;
   ...
   LAB_0010095c:*(void**)this = __dest_00;

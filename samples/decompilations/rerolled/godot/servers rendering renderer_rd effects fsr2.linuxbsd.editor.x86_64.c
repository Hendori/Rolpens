...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RendererRD::FSR2Effect::FSR2Effect() */void RendererRD::FSR2Effect::FSR2Effect(FSR2Effect *this) {
 ...
 while ( true );
            ...
            if (( *(long*)( piVar11 + 8 ) != 0 ) && ( uVar3 = ( uint ) * (undefined8*)( *(long*)( piVar11 + 8 ) + -8 ) ),uVar3 != 0) goto LAB_00108832;
...
;
      ...
      do {
         ...
         if (*(long*)( piVar11 + 4 ) != 0) {
            if (lVar5 == 0) {
               if (( *(long*)( piVar12 + 8 ) == 0 ) || ( uVar8 = ( uint ) * (undefined8*)( *(long*)( piVar12 + 8 ) + -8 ) ),uVar8 != 1) goto LAB_00108960;
            }
 else {
               uVar8 = 1;
            }
...
;
 ...
 while ( true );
      ...
      if (( *(long*)( param_4 + 8 ) != 0 ) && ( uVar7 = ( uint ) * (undefined8*)( *(long*)( param_4 + 8 ) + -8 ) ),uVar7 != 0) goto LAB_00109ead;

...
/* GLTFDocumentExtensionPhysics::export_preserialize(Ref<GLTFState>) */undefined8 GLTFDocumentExtensionPhysics::export_preserialize(undefined8 param_1, undefined8 *param_2) {
   ...
   if (local_78 != local_68) {
      do if (( cVar2 != '\0' ) && ( cVar2 = predelete_handler(pOVar3) ),cVar2 != '\0') local_78 = local_78 + 0x18; while ( local_78 != local_68 );
   }
...
return 0;}/* Resource::initialize_class() [clone .part.0] */void Resource::initialize_class(void) {
   ...
   void GLTFDocumentExtensionPhysics::convert_scene_node(undefined8 param_1, undefined8 *param_2, undefined8 *param_3, long param_4) {
      undefined8 uVar1;
      Object *pOVar2;
      Object *pOVar3;
      char cVar4;
   ...
   Object * GLTFDocumentExtensionPhysics::generate_scene_node(undefined8, param_1, undefined8 * param_2, long * param_3, Object * param_4);
   {
      char cVar1;
      bool bVar2;
      int iVar3;
      ...
      if (( lVar6 == 0 ) || ( pRVar7 = (Ref*)__dynamic_cast(lVar6, &Object::typeinfo, &GLTFPhysicsShape::typeinfo, 0) ),pRVar7 == (Ref*)0x0) {
         ...
         if (pOVar5 == (Object*)0x0) {
            if (param_4 == (Object*)0x0) {
               ...
               if (( cVar1 != '\0' ) && ( lVar6 = __dynamic_cast(lVar6, &Object::typeinfo, &Area3D::typeinfo, 0) ),lVar6 == 0) goto LAB_00105ab8;

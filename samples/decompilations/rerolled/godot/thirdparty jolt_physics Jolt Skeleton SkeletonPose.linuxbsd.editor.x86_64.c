/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JPH::SkeletonPose::SetSkeleton(JPH::Skeleton const*) */void JPH::SkeletonPose::SetSkeleton(SkeletonPose *this, Skeleton *param_1) {
   long *plVar1;
   Skeleton *pSVar2;
   undefined8 uVar3;
   long lVar4;
   ...
   if (pSVar2 == (Skeleton*)0x0) {
      LAB_0010002b:*(Skeleton**)this = param_1;
   }
 else {
      LOCK();
      *(int*)pSVar2 = *(int*)pSVar2 + -1;
      ...
      if (plVar9 != (long*)0x0) {
         if (( *(long*)( pSVar2 + 8 ) != 0 ) && ( plVar1 = plVar9 < plVar1 )) {
            do {
 ...
 while ( plVar9 < plVar1 );
   ...
   LAB_0010003b:uVar6 = ( ulong ) * (int*)( param_1 + 8 );
...
/* JPH::SkeletonPose::CalculateJointMatrices() */void JPH::SkeletonPose::CalculateJointMatrices(SkeletonPose *this) {
   undefined8 *puVar1;
   float *pfVar2;
   undefined4 uVar3;
   int iVar4;
         ...
         *(ulong*)( pauVar24[1] + 8 ) = ( ulong )(uint)(fVar37 * fVar33 + fVar32 * fVar38);
         ...
         if (-1 < iVar4) {
            ...
            do {
               ...
               fVar20 = pfVar2[2];
               fVar21 = pfVar2[3];
               *(float*)( (long)&local_58 + lVar29 ) = fVar21 * fVar14 + fVar19 * fVar36 + fVar18 * fVar26 + fVar20 * fVar10;
               *(float*)( (long)&local_58 + lVar29 + 4 ) = fVar21 * fVar15 + fVar19 * fVar37 + fVar18 * fVar27 + fVar20 * fVar11;
               *(float*)( (long)&uStack_50 + lVar29 ) = fVar21 * fVar16 + fVar19 * fVar38 + fVar18 * fVar32 + fVar20 * fVar12;
               *(float*)( (long)&uStack_50 + lVar29 + 4 ) = fVar21 * fVar17 + fVar19 * fVar39 + fVar18 * fVar33 + fVar20 * fVar13;
               lVar29 = lVar29 + 0x10;
            }
 while ( lVar29 != 0x40 );
...
/* JPH::SkeletonPose::CalculateJointStates() */void JPH::SkeletonPose::CalculateJointStates(SkeletonPose *this) {
   float *pfVar1;
   float fVar2;
   undefined8 uVar3;
   float fVar4;
   ...
   if (0 < (int)uVar3) {
      ...
      do {
         ...
         if (*piVar22 < 0) {
            ...
            fVar58 = fVar10 * fVar8;
            fVar59 = fVar14 * fVar4;
            fVar35 = ( ( ( ( fVar33 * fVar11 - fVar31 * fVar11 ) + fVar52 * fVar13 ) - fVar54 * fVar13 ) + fVar25 * fVar12 ) - fVar12 * fVar28;
            fVar36 = ( ( ( ( fVar32 * fVar15 - fVar30 * fVar15 ) + fVar51 * fVar17 ) - fVar53 * fVar17 ) + fVar23 * fVar16 ) - fVar16 * fVar26;
            fVar37 = ( ( ( ( fVar31 * fVar7 - fVar33 * fVar7 ) + fVar54 * fVar9 ) - fVar52 * fVar9 ) + fVar28 * fVar8 ) - fVar8 * fVar25;
            fVar38 = ( ( ( ( fVar30 * fVar50 - fVar32 * fVar50 ) + fVar53 * fVar5 ) - fVar51 * fVar5 ) + fVar26 * fVar4 ) - fVar4 * fVar23;
            fVar45 = fVar6 * fVar13;
            ...
            do {
               ...
               fVar34 = pfVar18[2];
               fVar39 = pfVar18[3];
               *(float*)( (long)local_78 + lVar19 ) = fVar39 * ( ( ( ( fVar61 * fVar12 - ( fVar10 * fVar52 - fVar10 * fVar54 ) ) - fVar12 * fVar63 ) - fVar57 * fVar11 ) + fVar11 * fVar59 ) * fVar41 + fVar2 * fVar35 * fVar41 + fVar29 * ( ( ( ( fVar10 * fVar31 - fVar10 * fVar33 ) - fVar12 * fVar46 ) + fVar12 * fVar48 + fVar13 * fVar57 ) - fVar13 * fVar59 ) * fVar41 + fVar34 * ( ( ( fVar13 * fVar63 - ( ( fVar25 * fVar10 - fVar28 * fVar10 ) + fVar13 * fVar61 ) ) + fVar46 * fVar11 ) - fVar48 * fVar11 ) * fVar41;
               *(float*)( (long)local_78 + lVar19 + 4 ) = fVar39 * ( ( ( ( fVar60 * fVar16 - ( fVar14 * fVar51 - fVar14 * fVar53 ) ) - fVar16 * fVar62 ) - fVar56 * fVar15 ) + fVar15 * fVar58 ) * fVar41 + fVar2 * fVar36 * fVar41 + fVar29 * ( ( ( ( fVar14 * fVar30 - fVar14 * fVar32 ) - fVar16 * fVar45 ) + fVar16 * fVar47 + fVar17 * fVar56 ) - fVar17 * fVar58 ) * fVar41 + fVar34 * ( ( ( fVar17 * fVar62 - ( ( fVar23 * fVar14 - fVar26 * fVar14 ) + fVar17 * fVar60 ) ) + fVar45 * fVar15 ) - fVar47 * fVar15 ) * fVar41;
               *(float*)( (long)local_78 + lVar19 + 8 ) = fVar39 * ( ( ( ( fVar63 * fVar8 - ( fVar6 * fVar54 - fVar6 * fVar52 ) ) - fVar8 * fVar61 ) - fVar59 * fVar7 ) + fVar7 * fVar57 ) * fVar41 + fVar2 * fVar37 * fVar41 + fVar29 * ( ( ( ( fVar6 * fVar33 - fVar6 * fVar31 ) - fVar8 * fVar48 ) + fVar8 * fVar46 + fVar9 * fVar59 ) - fVar9 * fVar57 ) * fVar41 + fVar34 * ( ( ( fVar9 * fVar61 - ( ( fVar28 * fVar6 - fVar25 * fVar6 ) + fVar9 * fVar63 ) ) + fVar48 * fVar7 ) - fVar46 * fVar7 ) * fVar41;
               *(float*)( (long)local_78 + lVar19 + 0xc ) = fVar39 * ( ( ( ( fVar62 * fVar4 - ( fVar49 * fVar53 - fVar49 * fVar51 ) ) - fVar4 * fVar60 ) - fVar58 * fVar50 ) + fVar50 * fVar56 ) * fVar41 + fVar2 * fVar38 * fVar41 + fVar29 * ( ( ( ( fVar49 * fVar32 - fVar49 * fVar30 ) - fVar4 * fVar47 ) + fVar4 * fVar45 + fVar5 * fVar58 ) - fVar5 * fVar56 ) * fVar41 + fVar34 * ( ( ( fVar5 * fVar60 - ( ( fVar26 * fVar49 - fVar23 * fVar49 ) + fVar5 * fVar62 ) ) + fVar47 * fVar50 ) - fVar45 * fVar50 ) * fVar41;
               lVar19 = lVar19 + 0x10;
               fVar29 = local_78[0];
               fVar34 = local_78[8];
               fVar39 = local_78[1];
         ...
         *puVar20 = uVar27;
         ...
         if (fVar49 < 0.0) {
            if (fVar29 < fVar2) {
               ...
               LAB_001007e8:fVar49 = ( fVar43 - ( fVar29 + fVar2 ) ) + _LC2;
               if (fVar49 < 0.0) {
                  fVar49 = sqrtf(fVar49);
                  fVar64 = _LC5;
               }
...
/* JPH::SkeletonPose::CalculateLocalSpaceJointMatrices(JPH::Mat44*) const */void JPH::SkeletonPose::CalculateLocalSpaceJointMatrices(SkeletonPose *this, Mat44 *param_1) {
   undefined4 uVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   undefined8 uVar4;
   ...
   if (0 < (int)uVar2) {
      ...
      do {
         ...
         *(ulong*)( pMVar10 + 0x10 ) = CONCAT44(( fVar6 - fVar19 ) - fVar7 * fVar17, fVar8 * fVar17 - fVar16);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JPH::SkeletonPose::Draw(JPH::SkeletonPose::DrawSettings const&, JPH::DebugRenderer*, JPH::Mat44
   const&) const */void JPH::SkeletonPose::Draw(SkeletonPose *this, DrawSettings *param_1, DebugRenderer *param_2, Mat44 *param_3) {
   float *pfVar1;
   int iVar2;
   long lVar3;
   float fVar4;
   ...
   do {
      ...
      *(float*)( (long)local_c8 + lVar24 ) = fVar23 * fVar16 + fVar21 * fVar8 + fVar20 * fVar4 + fVar22 * fVar12;
      *(float*)( (long)local_c8 + lVar24 + 4 ) = fVar23 * fVar17 + fVar21 * fVar9 + fVar20 * fVar5 + fVar22 * fVar13;
      *(float*)( (long)local_c8 + lVar24 + 8 ) = fVar23 * fVar18 + fVar21 * fVar10 + fVar20 * fVar6 + fVar22 * fVar14;
      *(float*)( (long)local_c8 + lVar24 + 0xc ) = fVar23 * fVar19 + fVar21 * fVar11 + fVar20 * fVar7 + fVar22 * fVar15;
      lVar24 = lVar24 + 0x10;
   }
 while ( lVar24 != 0x40 );
   lVar24 = *(long*)this;
   if (0 < *(int*)( lVar24 + 8 )) {
      ...
      do {
         ...
         do {
            ...
            fVar6 = pfVar1[2];
            fVar7 = pfVar1[3];
            *(float*)( local_88 + lVar25 ) = fVar7 * local_c8[0xc] + fVar4 * local_c8[0] + fVar5 * local_c8[4] + fVar6 * local_c8[8];
            for (int i = 0; i < 3; i++) {
               *(float*)( local_88 + lVar25 + ( 4*i + 4 ) ) = fVar7 * local_c8[( i + 13 )] + fVar4 * local_c8[( i + 1 )] + fVar5 * local_c8[( i + 5 )] + fVar6 * local_c8[( i + 9 )];
            }

            lVar25 = lVar25 + 0x10;
         }
 while ( lVar25 != 0x40 );
         if (( *param_1 != (DrawSettings)0x0 ) && ( iVar2 = *(int*)( *(long*)( lVar24 + 0x18 ) + 0x40 + lVar28 ) ),-1 < iVar2) {
            pfVar1 = (float*)( lVar3 + 0x30 + (long)iVar2 * 0x40 );
            fVar4 = *pfVar1;
            fVar5 = pfVar1[1];
            fVar6 = pfVar1[2];
            ( **(code**)( *(long*)param_2 + 0x10 ) )(CONCAT44(fVar6 * local_c8[9] + fVar4 * local_c8[1] + fVar5 * local_c8[5] + local_c8[0xd], fVar6 * local_c8[8] + fVar4 * local_c8[0] + fVar5 * local_c8[4] + local_c8[0xc]), CONCAT44(fVar6 * local_c8[0xb] + fVar4 * local_c8[3] + fVar5 * local_c8[7] + local_c8[0xf], fVar6 * local_c8[10] + fVar4 * local_c8[2] + fVar5 * local_c8[6] + local_c8[0xe]), local_58, CONCAT44(uStack_4c, local_50), param_2, (undefined4)Color::sGreen);
         }
         ...
         if (param_1[2] != (DrawSettings)0x0) {
            ...
            local_d0 = *puVar26;
            local_d8 = puVar26[1];
            ( **(code**)( *(long*)param_2 + 0x38 ) )(local_58, CONCAT44(uStack_4c, local_50), param_2, &local_d8, (undefined4)Color::sWhite);
         }
...
/* JPH::SkeletonPose::SetSkeleton(JPH::Skeleton const*) */void JPH::SkeletonPose::_GLOBAL__sub_I_SetSkeleton(void) {
   if (DVec3::cTrue == '\0') {
      DVec3::cTrue = '\x01';
      DVec3::cTrue = _LC9;
   }

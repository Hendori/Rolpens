undefined8 mbedtls_mpi_lt_mpi_ct(long *param_1, undefined8 *param_2, uint *param_3) {
   ...
   if (*(short*)( (long)param_1 + 10 ) == *(short*)( (long)param_2 + 10 )) {
      ...
      uVar6 = 0;
      *param_3 = ( ( uVar3 ^ uVar4 ) & (int)( ( uint )(-(ulong)((int)sVar1 >> 1 & 1) >> 0x20) ^ uVar2 ) >> 0x1f ^ uVar4 ) & 1;
   }
 else {
      uVar6 = 0xfffffffc;
   }
...
int mbedtls_mpi_safe_cond_assign(long *param_1, undefined8 *param_2, ulong param_3) {
   ...
   if (iVar5 == 0) {
      ...
      uVar4 = ( ushort )((long)uVar6 >> 0x3f);
      uVar2 = *(undefined2*)( (long)param_2 + 10 );
      uVar3 = *param_2;
      *(ushort*)( param_1 + 1 ) = ( (short)param_1[1] + 1U & ~uVar4 | *(short*)( param_2 + 1 ) + 1U & uVar4 ) - 1;
      mbedtls_mpi_core_cond_assign(*param_1, uVar3, uVar2, uVar7);
      uVar7 = ~uVar7;
      if (( ulong ) * (ushort*)( (long)param_2 + 10 ) < ( ulong ) * (ushort*)( (long)param_1 + 10 )) {
         puVar1 = (ulong*)( *param_1 + ( ulong ) * (ushort*)( (long)param_1 + 10 ) * 8 );
         puVar8 = (ulong*)( *param_1 + ( ulong ) * (ushort*)( (long)param_2 + 10 ) * 8 );
         if (( (int)puVar1 - (int)puVar8 & 8U ) != 0) {
            *puVar8 = *puVar8 & uVar7;
            puVar8 = puVar8 + 1;
            if (puVar8 == puVar1) {
               return 0;
...
undefined8 mbedtls_mpi_shrink(long *param_1, ulong param_2) {
 ...
 while ( lVar2 != 0 );
   ...
   __nmemb = 1;
   LAB_001004a1:if (__nmemb <= param_2) {
      __nmemb = param_2;
   }
...
undefined8 mbedtls_mpi_copy(long *param_1, long *param_2) {
         ...
         do {
            if (*(long*)( *param_2 + lVar2 * 8 ) != 0) {
               ...
               *(short*)( param_1 + 1 ) = (short)param_2[1];
               if (uVar6 <= uVar4) goto LAB_00100604;
               goto LAB_00100590;
            }
 ...
 while ( lVar2 != 0 );
      ...
      *(short*)( param_1 + 1 ) = (short)param_2[1];
      if (uVar4 != 0) {
         LAB_00100604:memset((void*)( *param_1 + uVar6 * 8 ), 0, ( uVar4 - uVar6 ) * 8);
         memcpy((void*)*param_1, (void*)*param_2, uVar6 * 8);
         return 0;
      }

      LAB_00100590:uVar3 = mbedtls_mpi_grow(param_1, uVar6);
      if ((int)uVar3 != 0) {
         return uVar3;
      }
...
undefined8 mbedtls_mpi_set_bit(long *param_1, ulong param_2, byte param_3) {
   ...
   *puVar1 = ( -2L << bVar2 | 0xfffffffffffffffeU >> 0x40 - bVar2 ) & *puVar1 | (ulong)param_3 << ( (byte)param_2 & 0x3f );
   return 0;
}
...
;
 ...
 while ( uVar3 != 0 );
   LAB_00100a68:return ( ulong )(uVar2 != 0);
}
...
;
 ...
 while ( uVar5 != 0 );
   ...
   LAB_00100b50:return (int)(short)param_1[1];
}
...
int mbedtls_mpi_sub_abs(long *param_1, long *param_2, long *param_3) {
   ...
   if (uVar6 != 0) {
      do {
         if (*(long*)( *param_3 + -8 + uVar6 * 8 ) != 0) {
            if (*(ushort*)( (long)param_2 + 10 ) < uVar6) goto LAB_00100dcf;
            break;
         }
 ...
 while ( uVar6 != 0 );
   ...
   if (( param_2 == param_1 ) || ( uVar5 <= uVar6 )) {
      ...
      if (uVar2 <= *(ushort*)( (long)param_2 + 10 )) goto LAB_00100d82;
   }
 else {
   ...
   LAB_00100d82:lVar4 = mbedtls_mpi_core_sub(*param_1, *param_2, *param_3, uVar6);
   if (( lVar4 == 0 ) || ( lVar1 = *param_1 + uVar6 * 8 ),lVar4 = mbedtls_mpi_core_sub_int(lVar1, lVar1, lVar4, *(ushort*)( (long)param_1 + 10 ) - uVar6),lVar4 == 0) {
      *(undefined2*)( param_1 + 1 ) = 1;
      iVar3 = 0;
   }
 else {
      LAB_00100dcf:iVar3 = -10;
   }
...
int mbedtls_mpi_mul_mpi(long *param_1, long *param_2, long *param_3) {
   ...
   if (param_1 == param_2) {
      ...
      if (iVar3 != 0) goto LAB_00101108;
      if (param_1 == param_3) goto LAB_001011a8;
      LAB_0010103f:uVar4 = ( ulong ) * (ushort*)( (long)param_2 + 10 );
      if (uVar4 != 0) {
         do {
 ...
 while ( uVar4 != 0 );
      ...
      bVar1 = true;
      LAB_00101072:uVar5 = ( ulong ) * (ushort*)( (long)param_3 + 10 );
      if (uVar5 != 0) {
         do {
 ...
 while ( uVar5 != 0 );
      ...
      bVar1 = true;
      uVar6 = uVar4;
      LAB_0010109e:iVar3 = mbedtls_mpi_grow(param_1, uVar6);
      ...
      if (param_1 != param_3) goto LAB_0010103f;
      LAB_001011a8:param_3 = &local_58;
      iVar3 = mbedtls_mpi_copy(param_3, param_1);
      if (iVar3 == 0) goto LAB_0010103f;
   }
         ...
         if (*(long*)( *param_2 + -8 + uVar2 * 8 ) != 0) {
            if (param_3 != 0) {
               ...
               if (uVar1 == 0) {
                  ...
                  uVar3 = (ulong)uVar1;
                  if (uVar1 == 0) {
                     mbedtls_mpi_core_mla(*param_1, *(undefined2*)( (long)param_1 + 10 ), *param_2, uVar2, param_3 + -1);
                     return uVar3;
                  }
...
ulong mbedtls_mpi_read_string(long *param_1, int param_2, char *param_3) {
   ...
   if (param_2 == 0x10) {
      if (sVar4 >> 0x3e != 0) goto LAB_0010157e;
      uVar5 = mbedtls_mpi_grow(param_1, ( ( sVar4 * 4 >> 6 ) + 1 ) - ( ulong )(( sVar4 & 0xf ) == 0));
      if (( (int)uVar5 != 0 ) || ( uVar5 = mbedtls_mpi_lset(param_1, 0) ),(int)uVar5 != 0) goto LAB_00101348;
      if (sVar4 == 0) goto LAB_00101552;
      uVar5 = 0;
      do {
         sVar4 = sVar4 - 1;
         cVar2 = param_3[sVar4];
 ...
 while ( sVar4 != 0 );
      LAB_00101510:if (local_6c == -1) goto LAB_0010155d;
      LAB_00101517:uVar5 = 0;
   }
 else {
      uVar5 = mbedtls_mpi_lset(param_1, 0);
      if ((int)uVar5 != 0) goto LAB_00101348;
      if (sVar4 != 0) {
         ...
         do {
            ...
            if (9 < ( byte )(cVar2 - 0x30U)) {
               ...
               LAB_00101520:uVar5 = 0xfffffffa;
               goto LAB_001014e5;
            }

            uVar8 = ( ulong )(cVar2 + -0x30);
            LAB_0010139b:if ((ulong)(long)param_2 <= uVar8) goto LAB_00101520;
            uVar5 = mbedtls_mpi_mul_int(&local_68, param_1, (long)param_2);
            if ((int)uVar5 != 0) goto LAB_001014e5;
            local_58 = &local_48;
            local_50 = 0x10001;
            local_48 = uVar8;
 ...
 while ( pcVar7 != param_3 );
      ...
      LAB_00101552:if (local_6c != -1) goto LAB_00101469;
      LAB_0010155d:uVar5 = mbedtls_mpi_core_bitlen(*param_1, *(undefined2*)( (long)param_1 + 10 ));
      if (uVar5 != 0) {
   ...
   LAB_001014e5:if (local_68 != 0) {
      mbedtls_zeroize_and_free(local_68, (ulong)local_60._2_2_ << 3);
      uVar5 = uVar5 & 0xffffffff;
   }

   LAB_00101348:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 mbedtls_mpi_read_file(undefined8 param_1, uint param_2, FILE *param_3) {
 ...
 while ( uVar3 < param_2 );
   uStack_9e0 = (undefined*)0x10164d;
   uVar6 = mbedtls_mpi_read_string(param_1, param_2, pcVar9);
   LAB_0010164d:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      uStack_9e0 = &UNK_00101711;
      __stack_chk_fail();
   }
         ...
         if (iVar5 == 0) {
            ...
            if (( uVar16 < 0x2711 ) && ( pvVar8 = calloc((long)(int)uVar16, 8) ),pvVar8 != (void*)0x0) {
               ...
               if (iVar5 == 0) {
                  uVar3 = *(ushort*)( param_3 + 10 );
                  uVar16 = uVar3 + 2;
                  if (( 10000 < uVar16 ) || ( puVar9 = (undefined8*)calloc((long)(int)uVar16, 8) ),puVar9 == (undefined8*)0x0) goto LAB_00101dde;
                  ...
                  if (( ulong )(uVar16 & 0x3f) == 0x3f) {
                     ...
                     lVar18 = local_a8;
                     if (( iVar5 != 0 ) || ( iVar5 = mbedtls_mpi_shift_l(&local_98, local_108) ),lVar18 = local_a8,lVar19 = local_98,iVar5 != 0) goto LAB_00101911;
                     local_120 = (ulong)local_90._2_2_;
                     uVar4 = local_90._2_2_;
                  }
                  ...
                  while (lVar18 = local_a8,local_98 = lVar19,iVar5 == 0) {
                     ...
                     if (iVar5 < 0) {
                        ...
                        if (uVar17 <= uVar12) goto LAB_00101f14;
...
;
               ...
               LAB_00101dde:iVar5 = -0x10;
               lVar18 = local_a8;
            }

         }

         LAB_00101911:if (lVar18 != 0) {
   ...
   LAB_00101894:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar5;
   }
   ...
   while (true) {
      ...
      if (( iVar5 != 0 ) || ( iVar5 = add_sub_mpi(&local_a8, &local_a8, &local_78, 0xffffffff) ),lVar18 = local_a8,iVar5 != 0) goto LAB_00101911;
      iVar5 = mbedtls_mpi_cmp_int(&local_a8);
      if (iVar5 < 0) {
         iVar5 = mbedtls_mpi_copy(&local_78, &local_98);
         lVar18 = local_a8;
         if (( ( iVar5 != 0 ) || ( iVar5 = mbedtls_mpi_shift_l(&local_78, local_100 * 8) ),lVar18 = local_a8,iVar5 != 0 )) goto LAB_00101911;
         *plVar15 = *plVar15 + -1;
      }
...
;
   ...
   while (iVar1 = add_sub_mpi(param_1, param_1, param_3, 0xffffffff),iVar1 == 0) {
      LAB_0010215f:iVar3 = mbedtls_mpi_cmp_mpi(param_1, param_3);
      iVar1 = iVar2;
      if (iVar3 < 0) break;
   }
;
   LAB_00102170:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar1;
   }
...
ulong mbedtls_mpi_exp_mod_optionally_safe(undefined8 *param_1, long param_2, undefined8 *param_3, int param_4, undefined8 *param_5, long *param_6) {
   long lVar1;
   undefined8 uVar2;
   ushort uVar3;
   int iVar4;
   ...
   if (( ( ( iVar4 < 1 ) || ( ( *(byte*)*param_5 & 1 ) == 0 ) ) || ( iVar4 = mbedtls_mpi_cmp_mpi(param_3, &local_58) ),iVar4 < 0 )) {
      uVar6 = 0xfffffffc;
   }
 else {
      ...
      if (param_6 == (long*)0x0) {
         ...
         if (( uVar5 == 0 ) && ( uVar5 = uVar5 == 0 )) {
            LAB_00102309:*(undefined2*)( param_1 + 1 ) = 1;
            iVar4 = mbedtls_mpi_cmp_mpi(param_1, param_5);
            if (iVar4 < 0) {
               LAB_0010233c:uVar5 = mbedtls_mpi_grow(param_1, *(undefined2*)( (long)param_5 + 10 ));
               uVar6 = (ulong)uVar5;
               if (uVar5 == 0) {
                  uVar8 = mbedtls_mpi_core_montmul_init(*param_5);
                  mbedtls_mpi_core_to_mont_rep(*param_1, *param_1, *param_5, *(undefined2*)( (long)param_5 + 10 ), uVar8, local_58, pvVar7);
                  uVar2 = *param_1;
                  if (param_4 == 0x2a2a2a2a) {
                     mbedtls_mpi_core_exp_mod_unsafe(uVar2, uVar2, *param_5, *(undefined2*)( (long)param_5 + 10 ), *param_3, *(undefined2*)( (long)param_3 + 10 ), local_58, pvVar7);
                  }
 else {
                     mbedtls_mpi_core_exp_mod(uVar2, uVar2, *param_5, *(undefined2*)( (long)param_5 + 10 ), *param_3, *(undefined2*)( (long)param_3 + 10 ), local_58, pvVar7);
                  }

                  mbedtls_mpi_core_from_mont_rep(*param_1, *param_1, *param_5, *(undefined2*)( (long)param_5 + 10 ), uVar8, pvVar7);
               ...
               uVar6 = (ulong)uVar5;
               if (uVar5 == 0) goto LAB_0010233c;
            }

            mbedtls_zeroize_and_free(pvVar7, lVar1);
            if (param_6 != (long*)0x0) goto LAB_0010244d;
         }
 else {
            uVar6 = (ulong)uVar5;
            mbedtls_zeroize_and_free(pvVar7, lVar1);
         ...
         if (*param_6 == 0) {
            ...
            if (uVar5 == 0) {
               ...
               uStack_50 = param_6[1];
               LAB_001022f2:uVar5 = mbedtls_mpi_copy(param_1, param_2);
               uVar6 = (ulong)uVar5;
               if (uVar5 == 0) goto LAB_00102309;
            }

         }

         mbedtls_zeroize_and_free(pvVar7, lVar1);
         LAB_0010244d:if (*param_6 != 0) goto LAB_00102454;
      }
   ...
   LAB_00102454:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar6;
   }

   LAB_00102574:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
ulong mpi_miller_rabin(long param_1, long param_2, undefined8 param_3, undefined8 param_4) {
   ...
   if ((int)uVar7 == 0) {
      ...
      if (uVar11 != 0) {
         uVar7 = 0;
         LAB_00102789:uVar9 = *(ulong*)( local_a8 + uVar7 * 8 );
         if (uVar9 == 0) goto LAB_00102780;
         iVar10 = 0;
      ...
      uVar9 = 0;
      LAB_001027a1:uVar7 = mbedtls_mpi_copy(&local_98, &local_a8);
      lVar4 = local_98;
      if ((int)uVar7 == 0) {
         if (local_90._2_2_ != 0) {
            ...
            do {
               ...
               do {
                  do {
                     ...
                     if ((int)uVar7 != 0) goto LAB_00102acf;
                     if ((ulong)uVar2 != 0) {
                        uVar7 = mbedtls_mpi_core_fill_random(local_78, local_70._2_2_, (ulong)uVar2 * 8, param_3, param_4);
                        if ((int)uVar7 != 0) goto LAB_00102acf;
                     }
 ...
 while ( iVar6 < 1 );
               uVar7 = mbedtls_mpi_exp_mod_optionally_safe(&local_78, &local_78, &local_98, 0, param_1, &local_68);
               if ((int)uVar7 != 0) goto LAB_00102acf;
               ...
               if (iVar10 != 0) {
                  ...
                  if (iVar10 != 0) {
                     ...
                     if (1 < uVar9) {
                        do {
                           iVar10 = mbedtls_mpi_cmp_mpi(&local_78, &local_a8);
                           if (iVar10 == 0) goto LAB_00102a4e;
                           uVar7 = mbedtls_mpi_mul_mpi(&local_88, &local_78, &local_78);
                           if (( (int)uVar7 != 0 ) || ( uVar7 = mbedtls_mpi_mod_mpi(&local_78, &local_88, param_1) ),(int)uVar7 != 0) goto LAB_00102acf;
                           local_48 = 1;
                           local_50 = 0x10001;
                           local_58 = &local_48;
                           iVar10 = mbedtls_mpi_cmp_mpi(&local_78, &local_58);
                        }
 while ( ( iVar10 != 0 ) && ( uVar8 = uVar8 != uVar9 ) );
                        iVar10 = mbedtls_mpi_cmp_mpi(&local_78, &local_a8);
                     }

                     if (iVar10 == 0) {
                        LAB_00102a4e:local_48 = 1;
                        local_50 = 0x10001;
                        local_58 = &local_48;
                        iVar10 = mbedtls_mpi_cmp_mpi(&local_78, &local_58);
                        if (iVar10 != 0) goto LAB_00102a90;
                     }

                     LAB_00102b50:uVar7 = 0xfffffff2;
                     goto LAB_00102acf;
                  }

               }

               LAB_00102a90:lStack_b8 = lStack_b8 + 1;
            }
 while ( param_2 != lStack_b8 );
      ...
      if (local_a8 == 0) goto LAB_0010272f;
      mbedtls_zeroize_and_free(local_a8, (ulong)local_a0._2_2_ << 3);
      uVar7 = uVar7 & 0xffffffff;
   }
   ...
   LAB_0010272f:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }

   return uVar7;
   LAB_00102780:uVar7 = uVar7 + 1;
   uVar9 = 0;
   if (uVar7 == uVar11) goto LAB_001027a1;
   goto LAB_00102789;
}
undefined8 mbedtls_mpi_mod_int(ulong *param_1, long *param_2, ulong param_3) {
   ...
   uVar2 = 0;
   if (( param_3 != 1 ) && ( uVar3 = ( ulong ) * (ushort*)( (long)param_2 + 10 ) * (ushort*)( (long)param_2 + 10 ) != 0 )) {
      ...
      do {
         uVar2 = ( ( ulong ) * (uint*)( puVar1 + ( uVar3 - 1 ) ) | ( (ulong)puVar1[uVar3 - 1] >> 0x20 | uVar2 << 0x20 ) % param_3 << 0x20 ) % param_3;
         uVar3 = uVar3 - 1;
      }
 while ( uVar3 != 0 );
   ...
   if (param_2 == 0x10) {
      ...
      do {
         ...
         do {
            ...
            uVar3 = (uint)uVar4;
            if (( ( ( uVar4 & 0xff ) != 0 ) || ( bVar2 ) ) || ( pcVar10 = lVar7 == 2 )) {
               pcVar10 = pcVar9 + 2;
               bVar2 = true;
      ...
      *param_5 = ( ulong )(pcVar10 + ( 1 - (long)param_3 ));
      ...
      if ((int)uVar5 == 0) {
         ...
         do {
            ...
            if ((int)uVar5 != 0) goto LAB_00102d68;
            local_50 = 0x10001;
            local_58 = &local_48;
...
int mbedtls_mpi_write_file(char *param_1, undefined8 param_2, int param_3, FILE *param_4) {
      ...
      if (iVar1 == 0) {
         ...
         if (param_4 == (FILE*)0x0) {
            ...
            if (sVar4 == sVar2) {
               ...
               if (sVar2 == sVar3 + 2) goto LAB_00102fe5;
            }
   ...
   LAB_00102fe5:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar1;
   }
...
ulong mbedtls_mpi_gcd(undefined8 param_1, undefined8 param_2) {
   ...
   if ((int)uVar3 == 0) {
      ...
      if ((int)uVar3 == 0) {
         if (uStack_6e != 0) {
            uVar3 = 0;
            LAB_00103259:uVar6 = *(ulong*)( local_78 + uVar3 * 8 );
            if (uVar6 == 0) goto LAB_00103250;
            iVar2 = 0;
         ...
         uVar6 = 0;
         LAB_00103271:if ((ulong)local_60._2_2_ == 0) {
            LAB_00103483:uVar3 = mbedtls_mpi_copy(param_1, param_2);
         }
 else {
            uVar3 = 0;
            LAB_0010329d:uVar4 = *(ulong*)( local_68 + uVar3 * 8 );
            if (uVar4 == 0) goto LAB_00103290;
            iVar2 = 0;
            ...
            if (uVar3 == 0) {
               LAB_00103477:uVar6 = 0;
               if (( *local_68 & 1 ) != 0) goto LAB_001032c5;
               goto LAB_00103483;
            }
            ...
            LAB_001032c5:local_60 = CONCAT22(local_60._2_2_, 1);
            local_70 = 1;
            while (true) {
               uStack_48 = 0;
               uStack_50 = 0x10001;
               ...
               if (uVar3 != 0) {
                  uVar4 = 0;
                  LAB_00103331:uVar1 = *(ulong*)( local_78 + uVar4 * 8 );
                  if (uVar1 == 0) goto LAB_00103328;
                  iVar2 = 0;
                  for (; ( uVar1 & 1 ) == 0; uVar1 = uVar1 >> 1 | 0x8000000000000000) {
                     iVar2 = iVar2 + 1;
                  }
                  ...
                  LAB_00103349:mbedtls_mpi_core_shift_r(local_78, uVar3, lVar5);
               }

               uVar3 = (ulong)local_60._2_2_;
               if (uVar3 != 0) {
                  uVar4 = 0;
                  LAB_00103371:uVar1 = *(ulong*)( local_68 + uVar4 * 8 );
                  if (uVar1 == 0) goto LAB_00103368;
                  iVar2 = 0;
                  for (; ( uVar1 & 1 ) == 0; uVar1 = uVar1 >> 1 | 0x8000000000000000) {
                     iVar2 = iVar2 + 1;
                  }
                  ...
                  lVar5 = (long)iVar2 + uVar4 * 0x40;
                  LAB_00103389:mbedtls_mpi_core_shift_r(local_68, uVar3, lVar5);
               }
               ...
               if (iVar2 < 0) {
                  ...
                  pbVar7 = local_68;
                  if ((int)uVar3 != 0) goto LAB_001033f5;
                  if (local_60._2_2_ != 0) {
...
;
   ...
   return uVar3;
   LAB_00103250:uVar3 = uVar3 + 1;
   uVar6 = 0;
   if (uStack_6e == uVar3) goto LAB_00103271;
   goto LAB_00103259;
   LAB_00103290:uVar3 = uVar3 + 1;
   if (uVar3 == local_60._2_2_) goto LAB_00103477;
   goto LAB_0010329d;
   LAB_00103328:uVar4 = uVar4 + 1;
   lVar5 = 0;
   if (uVar4 == uVar3) goto LAB_00103349;
   goto LAB_00103331;
   LAB_00103368:uVar4 = uVar4 + 1;
   lVar5 = 0;
   if (uVar3 == uVar4) goto LAB_00103389;
   goto LAB_00103371;
}
void mbedtls_mpi_fill_random(undefined8 *param_1, ulong param_2, undefined8 param_3, undefined8 param_4) {
   int iVar1;
   iVar1 = mbedtls_mpi_resize_clear(param_1, ( ulong )(( param_2 & 7 ) != 0) + ( param_2 >> 3 ));
   if (( iVar1 == 0 ) && ( param_2 != 0 )) {
      mbedtls_mpi_core_fill_random(*param_1, *(undefined2*)( (long)param_1 + 10 ), param_2, param_3, param_4);
      return;
   }

   return;
}
undefined8 mbedtls_mpi_random(undefined8 *param_1, long param_2, undefined8 *param_3, undefined8 param_4, undefined8 param_5) {
   int iVar1;
   undefined8 uVar2;
   long in_FS_OFFSET;
   long *local_48;
   ...
   if (param_2 < 0) {
      ...
      local_38 = param_2;
      iVar1 = mbedtls_mpi_cmp_mpi(param_3, &local_48);
      if (iVar1 < 1) goto LAB_001035e0;
      uVar2 = mbedtls_mpi_resize_clear(param_1, *(undefined2*)( (long)param_3 + 10 ));
      if ((int)uVar2 == 0) {
         if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
            uVar2 = mbedtls_mpi_core_random(*param_1, param_2, *param_3, *(undefined2*)( (long)param_1 + 10 ), param_4, param_5);
            return uVar2;
         }
   ...
   LAB_001035e7:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
                              ...
                              if (iVar5 == 0) {
                                 do {
                                    while (pbVar4 = local_88,( *pbVar1 & 1 ) == 0) {
                                       ...
                                       if (( ( ( *local_b8 & 1 ) != 0 ) || ( ( *local_a8 & 1 ) != 0 ) ) && ( ( iVar5 = add_sub_mpi(&local_b8, &local_b8, &local_98, 1) ),iVar5 != 0 || ( iVar5 = add_sub_mpi(&local_a8, &local_a8, &local_d8, 0xffffffff) ),iVar5 != 0 )) goto LAB_001038af;
                                       if (local_b0._2_2_ != 0) {
...
;
                                    while (( *pbVar4 & 1 ) == 0) {
                                       ...
                                       if (( ( ( *local_78 & 1 ) != 0 ) || ( ( *local_68 & 1 ) != 0 ) ) && ( ( iVar5 = add_sub_mpi(&local_78, &local_78, &local_98, 1) ),iVar5 != 0 || ( iVar5 = add_sub_mpi(&local_68, &local_68, &local_d8, 0xffffffff) ),iVar5 != 0 )) goto LAB_001038af;
                                       if (local_70._2_2_ != 0) {
...
;
                                    ...
                                    if (( iVar5 != 0 ) || ( iVar5 = add_sub_mpi(ppbVar3, ppbVar3, ppbVar2, 0xffffffff) ),iVar5 != 0) goto LAB_001038af;
 ...
 while ( iVar5 == 0 );
   ...
   while (iVar5 = add_sub_mpi(&local_78, &local_78, param_3, 0xffffffff),iVar5 == 0) {
      LAB_00103c46:iVar5 = mbedtls_mpi_cmp_mpi(&local_78, param_3);
      if (iVar5 < 0) {
...
;
   ...
   LAB_00103765:if (local_a8 != (byte*)0x0) {
      mbedtls_zeroize_and_free(local_a8, (ulong)local_a0._2_2_ << 3);
   }
   ...
   LAB_0010380d:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar5;
   }
...
ulong mbedtls_mpi_is_prime_ext(undefined8 *param_1, int param_2, undefined8 param_3, undefined8 param_4) {
   int iVar1;
   uint uVar2;
   ulong uVar3;
   undefined8 **ppuVar4;
   ...
   uVar3 = 0xfffffff2;
   LAB_00103d7a:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar3;
   }
...
ulong mbedtls_mpi_gen_prime(long *param_1, ulong param_2, uint param_3, undefined8 param_4, undefined8 param_5) {
   char cVar1;
   ulong uVar2;
   long lVar3;
   ulong *puVar4;
   ...
   if (( param_3 & 2 ) == 0) {
      ...
      cVar1 = '\x04';
      if (( ( ( param_2 < 0x5aa ) && ( cVar1 = '\x05' ),param_2 < 0x47e ) ) && ( cVar1 = param_2 < 1000 )) {
   ...
   do {
      do {
         ...
         if (( (int)uVar2 != 0 ) || ( ( lVar3 != 0 && ( uVar2 = mbedtls_mpi_core_fill_random(*param_1, *(undefined2*)( (long)param_1 + 10 ), lVar3 * 8, param_4, param_5) ),(int)uVar2 != 0 ) )) goto LAB_00103f10;
      ...
      *puVar4 = uVar2 | 1;
      if (( param_3 & 1 ) != 0) {
         *puVar4 = uVar2 | 3;
         ...
         if (local_70 == 0) {
            local_48 = 8;
            LAB_001041c0:local_58 = &local_48;
            local_50 = 0x10001;
 ...
 while ( (int)uVar2 == -0xe );
   ...
   while (true) {
      ...
      if ((int)uVar2 != 0) break;
      LAB_00104105:uVar2 = mpi_check_small_factors(param_1);
      if (( ( ( ( (int)uVar2 == 0 ) && ( uVar2 = mpi_check_small_factors(&local_68) ),(int)uVar2 == 0 ) ) && ( uVar2 = mpi_miller_rabin(param_1, cVar1, param_4, param_5) ),(int)uVar2 == 0 )) break;
   }
;
   LAB_00103f10:if (local_68 != 0) {
      mbedtls_zeroize_and_free(local_68, (ulong)local_60._2_2_ << 3);
      uVar2 = uVar2 & 0xffffffff;
   }

   LAB_00103f2e:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar2;
   }
...
int mbedtls_mpi_self_test(int param_1) {
   ...
   local_58 = 0;
   local_50 = 1;
   iVar2 = mbedtls_mpi_read_string(&local_b8, 0x10, "EFE021C2645FD1DC586E69184AF4A31ED5F53E93B5F123FA41680867BA110131944FE7952E2517337780CB0DB80E61AAE7C8DDC6C5C6AADEB34EB38A2F40D5E6");
   if (iVar2 != 0) {
      lVar4 = 0;
      lVar5 = 0;
      lVar6 = 0;
      lVar8 = 0;
      lVar3 = 0;
      goto joined_r0x00104461;
   }

   iVar2 = mbedtls_mpi_read_string(&local_a8, 0x10, "B2E7EFD37075B9F03FF989C7C5051C2034D2A323810251127E7BF8625A4F49A5F3E27F4DA8BD59C47D6DAABA4C8127BD5B5C25763222FEFCCFC38B832366C29E");
   if (iVar2 == 0) {
      iVar2 = mbedtls_mpi_read_string(&local_98, 0x10, "0066A198186C18C10B2F5ED9B522752A9830B69916E535C8F047518A889A43A594B6BED27A168D31D4A52F88925AA8F5");
      if (iVar2 != 0) goto LAB_0010444e;
      ...
      iVar2 = mbedtls_mpi_read_string(&local_68, 0x10, "602AB7ECA597A3D6B56FF9829A5E8B859E857EA95A03512E2BAE7391688D264AA5663B0341DB9CCFD2C4C5F421FEC8148001B72E848A38CAE1C65F78E56ABDEFE12D3C039B8A02D6BE593F0BBBDA56F1ECF677152EF804370C1A305CAF3B5BF130879B56C61DE584A0F53A2447A51E");
      if (iVar2 != 0) {
         lVar4 = 0;
         lVar5 = local_88;
         lVar6 = 0;
      ...
      LAB_00104610:local_d0 = &local_78;
      ...
      iVar2 = mbedtls_mpi_read_string(&local_58, 0x10, "6613F26162223DF488E9CD48CC132C7A0AC93C701B001B092E4E5B9F73BCD27B9EE50D0657C77F374E903CDFA4C642");
      lVar4 = local_58;
      lVar3 = local_a8;
      lVar5 = local_88;
      lVar6 = local_78;
      lVar8 = local_68;
      if (iVar2 != 0) goto joined_r0x00104461;
      if (param_1 == 0) {
         iVar2 = mbedtls_mpi_cmp_mpi(&local_88, &local_68);
         ...
         lVar6 = local_78;
         lVar8 = local_68;
         if (iVar2 != 0) goto LAB_00104317;
         iVar2 = mbedtls_mpi_read_string(&local_68, 0x10, "36E139AEA55215609D2816998ED020BBBD96C37890F65171D948E9BC7CBAA4D9325D24D6A3C12710F10A09FA08AB87");
         lVar5 = local_88;
         lVar6 = local_78;
         lVar8 = local_68;
         if (iVar2 == 0) {
            ...
            if (iVar2 == 0) {
               ...
               lVar8 = local_68;
               if (iVar2 != 0) goto LAB_00104317;
               iVar2 = mbedtls_mpi_read_string(&local_68, 0x10, "003A0AAEDD7E784FC07D8F9EC6E3BFD5C3DBA76456363A10869622EAC2DD84ECC5B8A74DAC4D09E03B5E0BE779F2DF61");
               lVar5 = local_88;
               lVar6 = local_78;
               lVar8 = local_68;
               if (iVar2 != 0) goto joined_r0x00104461;
               iVar2 = mbedtls_mpi_cmp_mpi(&local_88, &local_68);
               if (iVar2 == 0) goto LAB_001047a9;
            }
            ...
            if (iVar2 == 0) {
               ...
               if (iVar2 == 0) {
                  ...
                  do {
                     ...
                     lVar6 = local_78;
                     lVar8 = local_68;
                     if (( ( iVar2 != 0 ) || ( iVar2 = mbedtls_mpi_lset(local_d0, (long)piVar7[1]) ),lVar5 = local_88,lVar6 = local_78,lVar8 = local_68,iVar2 != 0 )) goto joined_r0x00104461;
                     ...
                     if (iVar2 != 0) {
                        iVar2 = 1;
                        if (param_1 == 0) goto LAB_00104317;
 ...
 while ( iVar1 != 3 );
      ...
      LAB_0010444e:lVar4 = 0;
      lVar5 = 0;
      lVar6 = 0;
      lVar8 = 0;
      lVar3 = local_a8;
      joined_r0x00104461:if (param_1 == 0) goto LAB_00104317;
   }

   LAB_00104469:__printf_chk(2, "Unexpected error, return code = %08X\n", iVar2);
   LAB_00104317:if (local_b8 != 0) {
      mbedtls_zeroize_and_free(local_b8, (ulong)local_b0._2_2_ << 3);
   }

...
/* GodotPhysicsDirectSpaceState3D::_initialize_classv() */void GodotPhysicsDirectSpaceState3D::_initialize_classv(void) {
   ...
   undefined1[16];
   HashSet<GodotCollisionObject3D*,HashMapHasherDefault,HashMapComparatorDefault<GodotCollisionObject3D*>>::insert(GodotCollisionObject3D **param_1) {
      uint *puVar1;
      long lVar2;
      long lVar3;
      void *pvVar4;
...
;
   ...
   void GodotPhysicsDirectSpaceState3D::~GodotPhysicsDirectSpaceState3D(GodotPhysicsDirectSpaceState3D *this) {
      /* WARNING: Bad instruction - Truncating control flow here */
      halt_baddata();
   }
   ...
   void GodotMotionShape3D::~GodotMotionShape3D(GodotMotionShape3D *this) {
      /* WARNING: Bad instruction - Truncating control flow here */
      halt_baddata();
   }

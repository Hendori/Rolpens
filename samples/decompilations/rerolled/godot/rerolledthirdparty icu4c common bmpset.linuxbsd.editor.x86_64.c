/* icu_76_godot::BMPSet::~BMPSet() */void icu_76_godot::BMPSet::~BMPSet(BMPSet *this) {
   return;
}
/* icu_76_godot::set32x64Bits(unsigned int*, int, int) */void icu_76_godot::set32x64Bits(uint *param_1, int param_2, int param_3) {
   uint *puVar1;
   uint *puVar2;
   int iVar3;
   uint uVar4;
   ...
   if (param_2 + 1 == param_3) {
      param_1[uVar7] = param_1[uVar7] | uVar6;
      return;
   }
   ...
   if (iVar3 == iVar5) {
      if (uVar7 < uVar4) {
         puVar2 = param_1 + (int)uVar7;
         puVar1 = param_1 + ( ulong )(uVar4 - uVar7) + (long)(int)uVar7;
         if (( (int)puVar1 - (int)puVar2 & 4U ) != 0) {
            *puVar2 = *puVar2 | uVar6;
            puVar2 = puVar2 + 1;
            if (puVar2 == puVar1) {
               return;
 ...
 while ( puVar2 != puVar1 );
      ...
      if (uVar7 != 0) {
         puVar2 = param_1 + (int)uVar7;
         if (( (int)( param_1 + ( ulong )(0x3f - uVar7) + (long)(int)uVar7 + 1 ) - (int)puVar2 & 4U ) == 0) goto LAB_00100080;
         *puVar2 = *puVar2 | uVar6;
         for (puVar2 = puVar2 + 1; puVar2 != param_1 + ( ulong )(0x3f - uVar7) + (long)(int)uVar7 + 1; puVar2 = puVar2 + 2) {
            LAB_00100080:*puVar2 = *puVar2 | uVar6;
            puVar2[1] = puVar2[1] | uVar6;
         }
...
/* icu_76_godot::BMPSet::BMPSet(icu_76_godot::BMPSet const&, int const*, int) */void icu_76_godot::BMPSet::BMPSet(BMPSet *this, BMPSet *param_1, int *param_2, int param_3) {
   BMPSet BVar1;
   undefined8 uVar2;
   *(int**)( this + 0x358 ) = param_2;
   *(undefined***)this = &PTR__BMPSet_00101570;
   BVar1 = param_1[0x108];
...
/* icu_76_godot::BMPSet::initBits() */void icu_76_godot::BMPSet::initBits(BMPSet *this) {
   long lVar1;
   int iVar2;
   long lVar3;
   uint *puVar4;
   ...
   do {
      ...
      if (iVar6 + 1 < iVar11) {
         iVar10 = *(int*)( lVar1 + 4 + (long)iVar6 * 4 );
         iVar6 = iVar6 + 2;
      }
 else {
         iVar10 = 0x110000;
 ...
 while ( iVar10 < 0x101 );
   ...
   if (1 < iVar11) {
      do {
         ...
         iVar2 = iVar6 + 2;
         puVar4 = puVar4 + 2;
         if (0x80 < (int)uVar12) goto LAB_0010057f;
         lVar3 = (long)iVar10;
         iVar6 = iVar2;
      }
 while ( iVar2 < iVar11 );
   ...
   uVar12 = 0x110000;
   iVar10 = iVar2;
   LAB_0010057f:uVar8 = *(uint*)( lVar1 + lVar3 * 4 );
   uVar7 = 0x80;
   if (0x7f < (int)uVar8) {
      uVar7 = uVar8;
   }
   ...
   if ((int)uVar8 < 0x800) {
      ...
      do {
         while (true) {
            ...
            set32x64Bits((uint*)pBVar9, uVar7, uVar8);
            if (0x800 < (int)uVar12) {
               uVar7 = 0x800;
               goto LAB_00100607;
            }
            ...
            iVar10 = iVar11 + 1;
            uVar7 = *(uint*)( lVar1 + (long)iVar11 * 4 );
            if (iVar10 < *(int*)( this + 0x360 )) break;
            uVar12 = 0x110000;
            iVar11 = iVar10;
            if (0x7ff < (int)uVar7) goto LAB_001005fb;
         }
;
         uVar12 = *(uint*)( lVar1 + 4 + (long)iVar11 * 4 );
         iVar10 = iVar11 + 2;
         iVar11 = iVar10;
      }
 while ( (int)uVar7 < 0x800 );
   ...
   LAB_001005fb:iVar11 = iVar10;
   if (0xffff < (int)uVar7) {
      return;
   }

   LAB_00100607:uVar8 = 0x800;
   do {
      uVar5 = 0x10000;
      if ((int)uVar12 < 0x10001) {
         uVar5 = uVar12;
      }
      ...
      if ((int)uVar7 < (int)uVar5) {
         if (( uVar7 & 0x3f ) != 0) {
            iVar6 = ( (int)uVar7 >> 6 ) + 1;
            uVar8 = iVar6 * 0x40;
            *(uint*)( this + ( ulong )((int)uVar7 >> 6 & 0x3f) * 4 + 0x20c ) = *(uint*)( this + ( ulong )((int)uVar7 >> 6 & 0x3f) * 4 + 0x20c ) | 0x10001 << ( ( byte )((int)uVar7 >> 0xc) & 0x1f );
            uVar7 = uVar8;
            if (uVar5 == uVar8 || SBORROW4(uVar5, uVar8) != (int)( uVar5 + iVar6 * -0x40 ) < 0) goto LAB_001006b0;
         }

         uVar12 = (int)uVar5 >> 6;
         if ((int)uVar7 < (int)( uVar5 & 0xffffffc0 )) {
            set32x64Bits((uint*)( this + 0x20c ), (int)uVar7 >> 6, uVar12);
            if (( uVar5 & 0x3f ) != 0) goto LAB_0010068c;
            goto LAB_001006b0;
         }

         if (( uVar5 & 0x3f ) != 0) {
            LAB_0010068c:*(uint*)( this + ( ulong )(uVar12 & 0x3f) * 4 + 0x20c ) = *(uint*)( this + ( ulong )(uVar12 & 0x3f) * 4 + 0x20c ) | 0x10001 << ( ( byte )((int)uVar5 >> 0xc) & 0x1f );
            uVar8 = ( uVar12 + 1 ) * 0x40;
            uVar5 = uVar8;
            goto LAB_001006b0;
         }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* icu_76_godot::BMPSet::overrideIllegal() */void icu_76_godot::BMPSet::overrideIllegal(BMPSet *this) {
   ulong uVar1;
   ulong uVar2;
   ulong uVar3;
   ulong uVar4;
...
/* icu_76_godot::BMPSet::findCodePoint(int, int, int) const */int icu_76_godot::BMPSet::findCodePoint(BMPSet *this, int param_1, int param_2, int param_3) {
   long lVar1;
   int iVar2;
   lVar1 = *(long*)( this + 0x358 );
   iVar2 = param_2;
...
/* icu_76_godot::BMPSet::contains(int) const */uint icu_76_godot::BMPSet::contains(BMPSet *this, int param_1) {
   uint uVar1;
   int iVar2;
   ...
   if (0x7ff < (uint)param_1) {
      if (( param_1 - 0xe000U < 0x2000 ) || ( (uint)param_1 < 0xd800 )) {
         iVar2 = param_1 >> 0xc;
         uVar1 = *(uint*)( this + ( ulong )(param_1 >> 6 & 0x3f) * 4 + 0x20c ) >> ( (byte)iVar2 & 0x1f ) & 0x10001;
         if (1 < uVar1) {
            uVar1 = findCodePoint(this, param_1, *(int*)( this + (long)iVar2 * 4 + 0x30c ), *(int*)( this + (long)( iVar2 + 1 ) * 4 + 0x30c ));
            return uVar1 & 1;
         }
   ...
   return CONCAT31(( int3 )(*(uint*)( this + ( ulong )(param_1 & 0x3f) * 4 + 0x10c ) >> 8), ( *(uint*)( this + ( ulong )(param_1 & 0x3f) * 4 + 0x10c ) >> ( param_1 >> 6 & 0x1fU ) & 1 ) != 0);
}
/* icu_76_godot::BMPSet::BMPSet(int const*, int) */void icu_76_godot::BMPSet::BMPSet(BMPSet *this, int *param_1, int param_2) {
   byte bVar1;
   undefined4 uVar2;
   ulong uVar3;
   int iVar4;
   ...
   *(undefined8*)( this + 0x100 ) = 0;
   ...
   for (uVar3 = ( ulong )(( iVar4 - (int)(undefined8*)( ( ulong )(this + 0x10) & 0xfffffffffffffff8 ) ) + 0x108U >> 3); uVar3 != 0; uVar3 = uVar3 - 1) {
      *puVar5 = 0;
      puVar5 = puVar5 + 1;
   }
   ...
   *(undefined8*)( this + 0x204 ) = 0;
   ...
   for (uVar3 = ( ulong )(( iVar4 - (int)(undefined8*)( ( ulong )(this + 0x114) & 0xfffffffffffffff8 ) ) + 0x20cU >> 3); uVar3 != 0; uVar3 = uVar3 - 1) {
      *puVar5 = 0;
      puVar5 = puVar5 + 1;
   }
   ...
   *(undefined8*)( this + 0x304 ) = 0;
   ...
   for (uVar3 = ( ulong )(( iVar4 - (int)(undefined8*)( ( ulong )(this + 0x214) & 0xfffffffffffffff8 ) ) + 0x30cU >> 3); uVar3 != 0; uVar3 = uVar3 - 1) {
      *puVar5 = 0;
      puVar5 = puVar5 + 1;
   }
...
/* icu_76_godot::BMPSet::span(char16_t const*, char16_t const*, USetSpanCondition) const */ushort * __thiscall
         ...
         if (uVar1 < 0x100) {
            ...
            if (( ushort )(uVar1 + 0x2800) < 0x800) {
               if (( ( uVar1 < 0xdc00 ) && ( puVar4 = param_1 + 1 ),puVar4 != param_2 )) {
                  uVar2 = findCodePoint(this, (uint)uVar1 * 0x400 + -0x35fdc00 + (uint)param_1[1], *(int*)( this + 0x34c ), *(int*)( this + 0x350 ));
                  if (( uVar2 & 1 ) != 0) {
                     return param_1;
                  }
               ...
               uVar3 = *(uint*)( this + ( ulong )(uVar1 >> 6 & 0x3f) * 4 + 0x20c ) >> ( byte )(uVar1 >> 0xc) & 0x10001;
               if (uVar3 < 2) goto joined_r0x00100b6e;
               uVar2 = findCodePoint(this, (uint)uVar1, *(int*)( this + ( ulong )(uVar1 >> 0xc) * 4 + 0x30c ), *(int*)( this + (long)(int)( ( uVar1 >> 0xc ) + 1 ) * 4 + 0x30c ));
            }
      ...
      do {
         ...
         if (uVar1 < 0x100) {
            ...
            if (( ushort )(uVar1 + 0x2800) < 0x800) {
               ...
               uVar3 = *(uint*)( this + ( ulong )(uVar1 >> 6 & 0x3f) * 4 + 0x20c ) >> ( byte )(uVar1 >> 0xc) & 0x10001;
               if (uVar3 < 2) goto joined_r0x00100bb6;
               uVar2 = findCodePoint(this, (uint)uVar1, *(int*)( this + ( ulong )(uVar1 >> 0xc) * 4 + 0x30c ), *(int*)( this + (long)(int)( ( uVar1 >> 0xc ) + 1 ) * 4 + 0x30c ));
            }
...
/* WARNING: Type propagation algorithm not settling *//* icu_76_godot::BMPSet::spanBack(char16_t const*, char16_t const*, USetSpanCondition) const */long icu_76_godot::BMPSet::spanBack(BMPSet *this, long param_1, long param_2, int param_4) {
   ushort uVar1;
   ulong uVar2;
   uint uVar3;
   long lVar4;
   if (param_4 == 0) {
      LAB_00100da0:while (true) {
         lVar4 = param_2;
...
;
      if (( ushort )(uVar1 + 0x2800) < 0x800) {
         ...
         uVar2 = findCodePoint(this, uVar1 + 0xfca02400 + ( uint ) * (ushort*)( lVar4 + -4 ) * 0x400, *(int*)( this + 0x34c ), *(int*)( this + 0x350 ));
         if (( uVar2 & 1 ) != 0) {
            return lVar4;
         }
         ...
         if (uVar3 < 2) {
            ...
            uVar2 = findCodePoint(this, (uint)uVar1, *(int*)( this + ( ulong )(uVar1 >> 0xc) * 4 + 0x30c ), *(int*)( this + (long)(int)( ( uVar1 >> 0xc ) + 1 ) * 4 + 0x30c ));
            joined_r0x00100fc0:if (( uVar2 & 1 ) != 0) {
               return lVar4;
            }
      ...
      LAB_00100d98:if (param_2 == param_1) {
         return param_2;
      }
   ...
   do {
      while (true) {
         ...
         LAB_00100d50:if (param_2 == param_1) {
            return param_2;
         }
...
;
      ...
      if (0x7ff < ( ushort )(uVar1 + 0x2800)) {
         uVar3 = *(uint*)( this + ( ulong )(uVar1 >> 6 & 0x3f) * 4 + 0x20c ) >> ( byte )(uVar1 >> 0xc) & 0x10001;
         if (uVar3 < 2) goto joined_r0x00100d86;
         uVar2 = findCodePoint(this, (uint)uVar1, *(int*)( this + ( ulong )(uVar1 >> 0xc) * 4 + 0x30c ), *(int*)( this + (long)(int)( ( uVar1 >> 0xc ) + 1 ) * 4 + 0x30c ));
         joined_r0x00100f98:if (( uVar2 & 1 ) == 0) {
            return lVar4;
         }
...
/* icu_76_godot::BMPSet::spanUTF8(unsigned char const*, int, USetSpanCondition) const */byte * __thiscall icu_76_godot::BMPSet::spanUTF8(BMPSet *this,byte *param_1,int param_2,int param_4){
   byte bVar1;
   BMPSet BVar2;
   byte bVar3;
   uint uVar4;
...
;
   ...
   if ((char)pbVar8[-1] < '\0') {
      if (pbVar8[-1] < 0xc0) {
         if (1 < param_2) {
            if (pbVar8[-2] < 0xe0) {
               if (( ( ( ( byte )(pbVar8[-2] + 0x80) < 0x40 ) && ( param_2 != 2 ) ) && ( 0xef < pbVar8[-3] ) ) && ( pbVar7 = pbVar8 + -3 ),(int)(char)this[0x108] != uVar9) {
                  pbVar8 = pbVar7;
               }
...
;
         ...
         if (( bVar3 < 0xc0 ) || ( 0x3f < ( byte )(param_1[1] + 0x80) )) {
            LAB_00101268:if ((int)(char)this[0x108] != uVar9) {
               return param_1;
            }
            ...
            if (( *(uint*)( this + ( ulong )(byte)(param_1[1] + 0x80) * 4 + 0x10c ) >> ( bVar3 & 0x1f ) & 1 ) != uVar9) {
               return param_1;
            }
...
;
      ...
      if (bVar3 < 0xf0) {
         if (( 0x3f < bVar1 ) || ( 0x3f < ( byte )(param_1[2] + 0x80) )) goto LAB_00101268;
         uVar4 = uVar4 & 0xf;
         uVar6 = *(uint*)( this + (ulong)bVar1 * 4 + 0x20c ) >> ( bVar3 & 0xf ) & 0x10001;
         if (1 < uVar6) {
            uVar6 = findCodePoint(this, uVar4 << 0xc | ( uint )(byte)(param_1[2] + 0x80) | (uint)bVar1 << 6, *(int*)( this + (long)(int)uVar4 * 4 + 0x30c ), *(int*)( this + (long)(int)( uVar4 + 1 ) * 4 + 0x30c ));
            uVar6 = uVar6 & 1;
         }
         ...
         if (( ( 0x3f < bVar1 ) || ( 0x3f < ( byte )(param_1[2] + 0x80) ) ) || ( 0x3f < ( byte )(param_1[3] + 0x80) )) goto LAB_00101268;
         uVar4 = ( uVar4 - 0xf0 ) * 0x40000 | ( uint )(byte)(param_1[3] + 0x80) | (uint)bVar1 << 0xc | ( uint )(byte)(param_1[2] + 0x80) << 6;
...
/* icu_76_godot::BMPSet::spanBackUTF8(unsigned char const*, int, USetSpanCondition) const */int icu_76_godot::BMPSet::spanBackUTF8(BMPSet *this, long param_1, int param_2, int param_4) {
   byte *pbVar1;
   bool bVar2;
   uint uVar3;
   uint uVar4;
   ...
   do {
      ...
      if (-1 < (char)*pbVar5) {
         ...
         if (param_4 == 0) {
            do {
               if (this[uVar7 + 8] != (BMPSet)0x0) goto LAB_001013e4;
               if (iVar9 == 0) {
                  return 0;
               }
 ...
 while ( -1 < (char)*pbVar1 );
      ...
      param_2 = local_2c;
      if ((int)uVar3 < 0x800) {
         uVar4 = *(uint*)( this + ( ulong )(uVar3 & 0x3f) * 4 + 0x10c ) >> ( ( byte )((int)uVar3 >> 6) & 0x1f ) & 1;
      }
 else {
         if ((int)uVar3 < 0x10000) {
            iVar6 = (int)uVar3 >> 0xc;
            uVar4 = *(uint*)( this + ( ulong )((int)uVar3 >> 6 & 0x3f) * 4 + 0x20c ) >> ( (byte)iVar6 & 0x1f ) & 0x10001;
            if (uVar4 < 2) goto joined_r0x001014df;
      ...
      joined_r0x001014df:if (uVar4 != ( param_4 != 0 )) {
         return iVar9 + 1;
      }

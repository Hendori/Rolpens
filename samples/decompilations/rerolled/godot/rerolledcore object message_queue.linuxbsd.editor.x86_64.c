...
/* CallQueue::_call_function(Callable const&, Variant const*, int, bool) */void CallQueue::_call_function(CallQueue *this, Callable *param_1, Variant *param_2, int param_3, bool param_4) {
   long *plVar1;
   long lVar2;
   undefined *puVar3;
   undefined8 *puVar4;
...
;
 ...
 while ( puVar9 + param_3 != puVar4 );
   ...
   *(undefined8*)( puVar7 + -8 ) = 0x100171;
   Callable::callp((Variant**)param_1, (int)puVar9, (Variant*)(ulong)(uint)param_3, (CallError*)local_58);
   if (( param_4 ) && ( local_78 != 0 )) {
      ...
      *(undefined8*)( puVar7 + -8 ) = 0x10020f;
      Variant::get_callable_error_text((Callable*)&local_90, (Variant**)param_1, (int)puVar9, (CallError*)(ulong)(uint)param_3);
      *(undefined8*)( puVar7 + -8 ) = 0x100225;
      operator+((char *)&
      local_88,(String*)"Error calling deferred method: ";
...
/* CallQueue::flush() */undefined8 CallQueue::flush(CallQueue *this) {
   ...
   if ((CallQueue*)*in_FS_OFFSET == this) {
      ...
      if (iVar4 != 0) {
         LAB_00100717:/* WARNING: Subroutine does not return */std::__throw_system_error(iVar4);
      }
      ...
      if (*(int*)( this + 0x40 ) == 0) {
         ...
         if (this[0x68] != (CallQueue)0x0) {
            ...
            LAB_00100561:uVar7 = 0x2c;
            goto LAB_00100566;
         }

         LAB_0010038d:this[0x68] = (CallQueue)0x1;
         uVar11 = 0;
         uVar9 = 0;
         ...
         if (*(int*)( this + 100 ) == 0) {
            if (*(uint*)( this + 0x50 ) == 0) {
               uVar10 = 0;
               uVar8 = 0;
               LAB_001005de:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, uVar8, uVar10, "p_index", "count", "", false, true);
               _err_flush_stdout();
            ...
            do {
               ...
               if (uVar2 == 1) {
                  ...
                  if (uVar2 == 2) {
                     ...
                     _call_function(this, this_00, (Variant*)( this_00 + 0x18 ), (int)*(short*)( this_00 + 0x12 ), (bool)( ( byte )(uVar3 >> 0xe) & 1 ));
                     uVar3 = *(ushort*)( this_00 + 0x10 ) & 0x1fff;
                     LAB_00100474:if (uVar3 == 1) goto LAB_0010047a;
                  }
 ...
 while ( iVar4 < *(short*)( this_00 + 0x12 ) );
               ...
               LAB_0010047a:Callable::~Callable(this_00);
               if (( (CallQueue*)*in_FS_OFFSET != this ) && ( iVar4 = pthread_mutex_lock((pthread_mutex_t*)( this + 8 )) ),iVar4 != 0) goto LAB_00100717;
               uVar10 = ( ulong ) * (uint*)( this + 0x50 );
 ...
 while ( uVar9 < *(uint*)( this + 100 ) );
   ...
   uVar7 = 0;
   LAB_00100566:if (local_40 != in_FS_OFFSET[5]) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* CallQueue::clear() */void CallQueue::clear(CallQueue *this) {
   short sVar1;
   code *pcVar2;
   int iVar3;
   uint uVar4;
   ...
   if (*(int*)( this + 100 ) != 0) {
      ...
      do {
         uVar4 = (uint)local_50;
         if ((uint)uVar6 <= uVar4) {
            LAB_00100858:local_50 = local_50 & 0xffffffff;
            goto LAB_00100877;
         }
 ...
 while ( (uint)local_50 < *(uint*)( this + 100 ) );
   ...
   *(undefined4*)( this + 100 ) = 1;
   if (*(int*)( this + 0x50 ) == 0) {
      uVar6 = 0;
      local_50 = 0;
      LAB_00100877:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, local_50, uVar6, "p_index", "count", "", false, true);
      _err_flush_stdout();
      /* WARNING: Does not return */
   ...
   **(undefined4**)( this + 0x58 ) = 0;
   ...
   LAB_00100906:pthread_mutex_unlock((pthread_mutex_t*)( this + 8 ));
   return;
}
/* CallQueue::is_flushing() const */CallQueue CallQueue::is_flushing(CallQueue *this) {
   return this[0x68];
}
/* CallQueue::has_messages() const */undefined4 CallQueue::has_messages(CallQueue *this) {
   code *pcVar1;
   if (*(int*)( this + 100 ) == 0) {
      return 0;
   }
   ...
   _err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xae, 0, 0, "p_index", "count", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* CallQueue::get_max_buffer_usage() const */int CallQueue::get_max_buffer_usage(CallQueue *this) {
   return *(int*)( this + 0x40 ) << 0xc;
}
/* CallQueue::CallQueue(PagedAllocator<CallQueue::Page, true, 4096u>*, unsigned int, String const&)
    */void CallQueue::CallQueue(CallQueue *this, PagedAllocator *param_1, uint param_2, String *param_3) {
   char *pcVar1;
   char cVar2;
   long lVar3;
   undefined8 uVar4;
...
;
      if (*(long*)*pauVar6 == 0) {
         ...
         *(undefined8*)( pauVar6[1] + 8 ) = uVar4;
         ...
         _err_print_error("configure", "./core/templates/paged_allocator.h", 0x93, "Condition \"page_pool != nullptr\" is true.", 0, 0);
      }
...
/* MessageQueue::set_thread_singleton_override(CallQueue*) */void MessageQueue::set_thread_singleton_override(CallQueue *param_1) {
   undefined8 *in_FS_OFFSET;
   *in_FS_OFFSET = param_1;
   return;
}
/* MessageQueue::MessageQueue() */void MessageQueue::MessageQueue(MessageQueue *this) {
   long *plVar1;
   long lVar2;
   MessageQueue *pMVar3;
   int iVar4;
   ...
   local_b8 = 0;
   local_a0 = 0x6a;
   local_a8 = "Message queue out of memory. Try increasing \'memory/limits/message_queue/max_size_mb\' in project settings.";
   ...
   LAB_00100d97:_GLOBAL_DEF((PropertyInfo*)local_78, (Variant*)&local_a8, SUB81((Variant*)local_58, 0), true, false, false);
   ...
   *(undefined***)this = &PTR__MessageQueue_00105418;
   pMVar3 = this;
   if (bVar5) {
      _err_print_error("MessageQueue", "core/object/message_queue.cpp", 0x1fe, "Condition \"main_singleton != nullptr\" is true.", "A MessageQueue singleton already exists.", 0, 0);
...
/* CallQueue::_add_page() */void CallQueue::_add_page(CallQueue *this) {
   uint uVar1;
   uint uVar2;
   code *pcVar3;
   Page *pPVar4;
   ...
   if (uVar1 == uVar2) {
      pPVar4 = PagedAllocator<CallQueue::Page,true,4096u>::alloc<>(*(PagedAllocator<CallQueue::Page,true,4096u>**)( this + 0x30 ));
      ...
      *(Page**)( lVar5 + (ulong)uVar1 * 8 ) = pPVar4;
      ...
      if (uVar1 == *(uint*)( this + 0x54 )) {
         ...
         *(void**)( this + 0x58 ) = pvVar6;
         if (pvVar6 == (void*)0x0) {
            LAB_00101149:_err_print_error("push_back", "./core/templates/local_vector.h", 0x41, "FATAL: Condition \"!data\" is true.", "Out of memory", 0, 0);
            _err_flush_stdout();
            /* WARNING: Does not return */
   ...
   _err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, (ulong)uVar1, (ulong)uVar2, "p_index", "count", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar3 = (code*)invalidInstructionException();
   ( *pcVar3 )();
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* CallQueue::statistics() */void CallQueue::statistics(CallQueue *this) {
   long *plVar1;
   undefined4 uVar2;
   char *pcVar3;
   long lVar4;
   ...
   char *local_e8;
   size_t local_e0;
   HashMap<StringName,int,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,int>>> local_d8[8];
   undefined1 local_d0[16];
   undefined1 local_c0[16];
   undefined8 local_b0;
   HashMap<int,int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,int>>> local_a8[8];
   undefined1 local_a0[16];
   undefined1 local_90[16];
   undefined8 local_80;
   HashMap<Callable,int,HashMapHasherDefault,HashMapComparatorDefault<Callable>,DefaultTypedAllocator<HashMapElement<Callable,int>>> local_78[8];
   undefined1 local_70[16];
   undefined1 local_60[16];
   undefined8 local_50;
   long local_40;
   local_40 = in_FS_OFFSET[5];
   if (( (CallQueue*)*in_FS_OFFSET != this ) && ( iVar33 = pthread_mutex_lock((pthread_mutex_t*)( this + 8 )) ),iVar33 != 0) {
      /* WARNING: Subroutine does not return */
   ...
   if (*(int*)( this + 100 ) == 0) {
      ...
      do {
         ...
         if ((uint)uVar50 <= uVar51) {
            LAB_001013ab:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, uVar53 & 0xffffffff, uVar50, "p_index", "count", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            ...
            if (uVar41 == 1) {
               ...
               if (( local_a0._0_8_ != 0 ) && ( local_80._4_4_ != 0 )) {
                  ...
                  if (uVar34 != 0) {
                     uVar47 = 0;
                     do {
                        if (( uVar34 == uVar46 ) && ( uVar40 == *(uint*)( *(long*)( local_a0._0_8_ + lVar35 * 8 ) + 0x10 ) )) goto LAB_00101698;
                        uVar47 = uVar47 + 1;
                        auVar11._8_8_ = 0;
 ...
 while ( ( uVar34 != 0 ) && ( auVar12._8_8_ = 0 ),auVar12._0_8_ = uVar34 * uVar50,auVar24._8_8_ = 0,auVar24._0_8_ = uVar52,auVar13._8_8_ = 0,auVar13._0_8_ = ( ( *(uint*)( hash_table_size_primes + ( local_80 & 0xffffffff ) * 4 ) + iVar33 ) - SUB164(auVar12 * auVar24, 8) ) * uVar50,auVar25._8_8_ = 0,auVar25._0_8_ = uVar52,uVar47 <= SUB164(auVar13 * auVar25, 8) );
                  }

               }

               local_e8 = (char*)CONCAT44(local_e8._4_4_, uVar40);
               puVar36 = (undefined4*)HashMap<int,int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,int>>>::operator [](local_a8, (int*)&local_e8);
               *puVar36 = 0;
               uVar40 = ( uint ) * (short*)( this_00 + 0x12 );
               LAB_00101698:local_118 = &local_e8;
               local_e8 = (char*)CONCAT44(local_e8._4_4_, uVar40);
               piVar37 = (int*)HashMap<int,int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,int>>>::operator [](local_a8, (int*)local_118);
               *piVar37 = *piVar37 + 1;
            }
 else if (uVar41 == 2) {
               if (lVar35 == 0) goto LAB_00101358;
               ...
               if (( local_d0._0_8_ != 0 ) && ( local_b0._4_4_ != 0 )) {
                  ...
                  if (uVar46 != 0) {
                     uVar47 = 0;
                     do {
                        if (( uVar46 == uVar34 ) && ( *(char**)( *(long*)( uVar38 + lVar43 * 8 ) + 0x10 ) == local_e8 )) goto LAB_0010182a;
                        uVar47 = uVar47 + 1;
                        auVar7._8_8_ = 0;
 ...
 while ( ( uVar46 != 0 ) && ( auVar8._8_8_ = 0 ),auVar8._0_8_ = (ulong)uVar46 * lVar35,auVar20._8_8_ = 0,auVar20._0_8_ = uVar50,auVar9._8_8_ = 0,auVar9._0_8_ = ( ulong )(( uVar40 + iVar33 ) - SUB164(auVar8 * auVar20, 8)) * lVar35,auVar21._8_8_ = 0,auVar21._0_8_ = uVar50,uVar47 <= SUB164(auVar9 * auVar21, 8) );
                  }

               }

               puVar36 = (undefined4*)HashMap<StringName,int,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,int>>>::operator [](local_d8, (StringName*)&local_e8);
               *puVar36 = 0;
               LAB_0010182a:piVar37 = (int*)HashMap<StringName,int,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,int>>>::operator [](local_d8, (StringName*)&local_e8);
               *piVar37 = *piVar37 + 1;
               ...
               if (( local_70._0_8_ != 0 ) && ( local_50._4_4_ != 0 )) {
                  ...
                  if (uVar34 != 0) {
                     ...
                     do {
                        if (uVar34 == uVar46) {
                           cVar32 = Callable::operator ==((Callable*)( *(long*)( local_70._0_8_ + lVar43 * 8 ) + 0x10 ), this_00);
 ...
 while ( ( uVar34 != 0 ) && ( auVar16._8_8_ = 0 ),auVar16._0_8_ = (ulong)uVar34 * lVar35,auVar28._8_8_ = 0,auVar28._0_8_ = uVar50,auVar17._8_8_ = 0,auVar17._0_8_ = ( ulong )(( uVar40 + iVar33 ) - SUB164(auVar16 * auVar28, 8)) * lVar35,auVar29._8_8_ = 0,auVar29._0_8_ = uVar50,uVar47 <= SUB164(auVar17 * auVar29, 8) );
                  }

               }

               puVar36 = (undefined4*)HashMap<Callable,int,HashMapHasherDefault,HashMapComparatorDefault<Callable>,DefaultTypedAllocator<HashMapElement<Callable,int>>>::operator [](local_78, this_00);
               *puVar36 = 0;
               LAB_00101338:piVar37 = (int*)HashMap<Callable,int,HashMapHasherDefault,HashMapComparatorDefault<Callable>,DefaultTypedAllocator<HashMapElement<Callable,int>>>::operator [](local_78, this_00);
               *piVar37 = *piVar37 + 1;
            }
 else {
               LAB_00101358:fwrite("Object was deleted while awaiting a callback.\n", 1, 0x2e, _stdout);
...
;
 ...
 while ( plVar44 != (long*)0x0 );
   ...
   for (puVar49 = (undefined8*)local_60._0_8_; puVar49 != (undefined8*)0x0; puVar49 = (undefined8*)*puVar49) {
   ...
   for (puVar49 = (undefined8*)local_90._0_8_; puVar49 != (undefined8*)0x0; puVar49 = (undefined8*)*puVar49) {
      __fprintf_chk(_stdout, 2, "NOTIFY %d: %d.\n", *(undefined4*)( puVar49 + 2 ), *(undefined4*)( (long)puVar49 + 0x14 ));
   }
   ...
   if ((undefined8*)local_70._0_8_ != (undefined8*)0x0) {
      ...
      if (( local_50._4_4_ != 0 ) && ( *(uint*)( hash_table_size_primes + ( local_50 & 0xffffffff ) * 4 ) != 0 )) {
         piVar37 = (int*)( local_70._8_8_ + ( ulong ) * (uint*)( hash_table_size_primes + ( local_50 & 0xffffffff ) * 4 ) * 4 );
 ...
 while ( piVar45 != piVar37 );
   ...
   if ((undefined8*)local_a0._0_8_ != (undefined8*)0x0) {
      ...
      if (( local_80._4_4_ != 0 ) && ( *(uint*)( hash_table_size_primes + ( local_80 & 0xffffffff ) * 4 ) != 0 )) {
         piVar37 = (int*)( local_a0._8_8_ + ( ulong ) * (uint*)( hash_table_size_primes + ( local_80 & 0xffffffff ) * 4 ) * 4 );
 ...
 while ( piVar37 != piVar45 );
   ...
   if ((undefined8*)local_d0._0_8_ == (undefined8*)0x0) {
      ...
      if (( local_b0._4_4_ != 0 ) && ( *(uint*)( hash_table_size_primes + ( local_b0 & 0xffffffff ) * 4 ) != 0 )) {
         piVar37 = (int*)( local_d0._8_8_ + ( ulong ) * (uint*)( hash_table_size_primes + ( local_b0 & 0xffffffff ) * 4 ) * 4 );
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* CallQueue::push_callablep(Callable const&, Variant const**, int, bool) */undefined8 CallQueue::push_callablep(CallQueue *this, Callable *param_1, Variant **param_2, int param_3, bool param_4) {
   long *plVar1;
   int *piVar2;
   uint uVar3;
   uint uVar4;
   ...
   if (0x1000 < uVar19) {
      ...
      itos((long)&local_70);
      operator+((char *)&
      local_68,(String*)"Message is too large to fit on a page (";
      String::operator +((String*)&local_58, (String*)&local_68);
      _err_print_error("push_callablep", "core/object/message_queue.cpp", 0x59, "Condition \"room_needed > uint32_t(PAGE_SIZE_BYTES)\" is true. Returning: ERR_INVALID_PARAMETER", (String*)&local_58, 0, 0);
      pcVar6 = local_58;
   ...
   if (( (CallQueue*)*in_FS_OFFSET != this ) && ( iVar8 = pthread_mutex_lock((pthread_mutex_t*)( this + 8 )) ),iVar8 != 0) {
      /* WARNING: Subroutine does not return */
      std::__throw_system_error(iVar8);
   }

   if (*(int*)( this + 0x40 ) == 0) {
      pPVar11 = PagedAllocator<CallQueue::Page,true,4096u>::alloc<>(*(PagedAllocator<CallQueue::Page,true,4096u>**)( this + 0x30 ));
      ...
      *(Page**)( lVar10 + (ulong)uVar9 * 8 ) = pPVar11;
      ...
      if (uVar9 == *(uint*)( this + 0x54 )) {
         ...
         *(void**)( this + 0x58 ) = pvVar15;
         if (pvVar15 == (void*)0x0) {
            LAB_001023d8:_err_print_error("push_back", "./core/templates/local_vector.h", 0x41, "FATAL: Condition \"!data\" is true.", "Out of memory", 0, 0);
            _err_flush_stdout();
            /* WARNING: Does not return */
   ...
   if (uVar3 + uVar19 < 0x1001) {
      ...
      if (uVar4 <= uVar9) {
         LAB_001021b8:uVar18 = (ulong)uVar4;
         goto LAB_0010200d;
      }
 ...
 while ( ppVVar17 != param_2 + param_3 );
   ...
   if (uVar9 < *(uint*)( this + 0x50 )) {
      ...
      *piVar2 = *piVar2 + uVar19;
      ...
      uVar12 = 0;
      LAB_00101f79:if (local_40 != in_FS_OFFSET[5]) {
         /* WARNING: Subroutine does not return */
         __stack_chk_fail();
      }
   ...
   uVar14 = (ulong)uVar9;
   LAB_0010200d:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, uVar14, uVar18, "p_index", "count", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar5 = (code*)invalidInstructionException();
   ( *pcVar5 )();
}
/* CallQueue::push_callp(ObjectID, StringName const&, Variant const**, int, bool) */undefined4 CallQueue::push_callp(CallQueue *this, undefined8 param_2, undefined8 param_3, Variant **param_4, int param_5, bool param_6) {
   undefined4 uVar1;
   long in_FS_OFFSET;
...
/* CallQueue::push_callp(Object*, StringName const&, Variant const**, int, bool) */undefined4 CallQueue::push_callp(CallQueue *this, Object *param_1, StringName *param_2, Variant **param_3, int param_4, bool param_5) {
   undefined4 uVar1;
   long in_FS_OFFSET;
   Callable aCStack_48[24];
   long local_30;
...
/* WARNING: Removing unreachable block (ram,0x00102b2a) *//* WARNING: Removing unreachable block (ram,0x00102b36) *//* WARNING: Removing unreachable block (ram,0x001027ed) *//* WARNING: Removing unreachable block (ram,0x001027f5) *//* WARNING: Removing unreachable block (ram,0x0010280c) *//* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* CallQueue::push_set(ObjectID, StringName const&, Variant const&) */undefined8 CallQueue::push_set(CallQueue *this, ulong param_2, long *param_3, Variant *param_4) {
   long *plVar1;
   int *piVar2;
   uint uVar3;
   char *pcVar4;
   ...
   long local_40;
   local_40 = in_FS_OFFSET[5];
   if (( (CallQueue*)*in_FS_OFFSET != this ) && ( iVar7 = pthread_mutex_lock((pthread_mutex_t*)( this + 8 )) ),iVar7 != 0) {
      /* WARNING: Subroutine does not return */
      std::__throw_system_error(iVar7);
   }

   if (*(int*)( this + 0x40 ) == 0) {
      pPVar13 = PagedAllocator<CallQueue::Page,true,4096u>::alloc<>(*(PagedAllocator<CallQueue::Page,true,4096u>**)( this + 0x30 ));
      ...
      *(Page**)( lVar15 + (ulong)uVar8 * 8 ) = pPVar13;
      ...
      if (uVar8 == *(uint*)( this + 0x54 )) {
         ...
         *(void**)( this + 0x58 ) = pvVar16;
         if (pvVar16 == (void*)0x0) {
            LAB_00102c03:_err_print_error("push_back", "./core/templates/local_vector.h", 0x41, "FATAL: Condition \"!data\" is true.", "Out of memory", 0, 0);
            _err_flush_stdout();
            /* WARNING: Does not return */
            ...
            if (uVar17 == ( *puVar18 & 0x7fffffffff )) {
               ...
               if (puVar18[1] != 0) {
                  if ((uint)ObjectDB::slot_max <= uVar8) {
                     ...
                     LAB_0010511f:/* WARNING: Does not return */pcVar6 = (code*)invalidInstructionException();
                     ( *pcVar6 )();
                  }
 ...
 while ( !bVar20 );
   ...
   *(undefined1(*) [16])( this_00 + 0x20 ) = (undefined1[16])0x0;
   ...
   if (*(uint*)( this + 0x50 ) <= uVar8) {
      uVar17 = (ulong)uVar8;
      LAB_001026af:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, uVar17, uVar19, "p_index", "count", "", false, true);
      _err_flush_stdout();
      /* WARNING: Does not return */
      pcVar6 = (code*)invalidInstructionException();
      ( *pcVar6 )();
   ...
   *piVar2 = *piVar2 + 0x30;
   ...
   uVar9 = 0;
   LAB_0010264c:if (local_40 != in_FS_OFFSET[5]) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* CallQueue::push_set(Object*, StringName const&, Variant const&) */void CallQueue::push_set(Object *param_1, StringName *param_2, Variant *param_3) {
   push_set((CallQueue*)param_1, *(undefined8*)( param_2 + 0x60 ));
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* CallQueue::push_notification(ObjectID, int) */undefined8 CallQueue::push_notification(CallQueue *this, undefined8 param_2, int param_3) {
   long *plVar1;
   Callable *this_00;
   int *piVar2;
   uint uVar3;
   ...
   if (param_3 < 0) {
      _err_print_error("push_notification", "core/object/message_queue.cpp", 0xb1, "Condition \"p_notification < 0\" is true. Returning: ERR_INVALID_PARAMETER", 0, 0);
      uVar7 = 0x1f;
   }
 else {
      if ((CallQueue*)*in_FS_OFFSET != this) {
      ...
      if (*(int*)( this + 0x40 ) == 0) {
         pPVar6 = PagedAllocator<CallQueue::Page,true,4096u>::alloc<>(*(PagedAllocator<CallQueue::Page,true,4096u>**)( this + 0x30 ));
         ...
         *(Page**)( lVar9 + (ulong)uVar12 * 8 ) = pPVar6;
         ...
         if (uVar12 == *(uint*)( this + 0x54 )) {
            ...
            *(void**)( this + 0x58 ) = pvVar10;
            if (pvVar10 == (void*)0x0) {
               LAB_00103023:_err_print_error("push_back", "./core/templates/local_vector.h", 0x41, "FATAL: Condition \"!data\" is true.", "Out of memory", 0, 0);
               _err_flush_stdout();
               /* WARNING: Does not return */
      ...
      if (uVar3 + 0x18 < 0x1001) {
         ...
         if (*(int*)( this + 0x60 ) == iVar5) {
            ...
            __fprintf_chk(_stderr, 2, "Failed notification: %d target ID: %s. Message queue out of memory. %s\n", param_3, uVar8, uVar7);
            lVar9 = local_50;
            if (local_50 != 0) {
               LOCK();
      ...
      *(short*)( this_00 + 0x12 ) = (short)param_3;
      ...
      if (uVar12 <= iVar5 - 1U) {
         LAB_00102de0:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, uVar11, uVar13, "p_index", "count", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar4 = (code*)invalidInstructionException();
         ( *pcVar4 )();
   ...
   LAB_00102d7c:if (local_30 == in_FS_OFFSET[5]) {
      return uVar7;
   }
...
/* CallQueue::push_notification(Object*, int) */void CallQueue::push_notification(Object *param_1, int param_2) {
   undefined4 in_register_00000034;
   push_notification((CallQueue*)param_1, *(undefined8*)( CONCAT44(in_register_00000034, param_2) + 0x60 ));
   return;
}
/* CallQueue::~CallQueue() */void CallQueue::~CallQueue(CallQueue *this) {
   char *pcVar1;
   long *plVar2;
   char cVar3;
   uint uVar4;
...
;
         ...
         lVar8 = lVar8 + 1;
         *(undefined8*)( *(long*)( *(long*)( lVar6 + 8 ) + ( ulong )(uVar4 >> ( ( byte ) * (undefined4*)( lVar6 + 0x18 ) & 0x1f )) * 8 ) + ( ulong )(uVar4 & *(uint*)( lVar6 + 0x1c )) * 8 ) = uVar7;
...
/* CallQueue::Page* PagedAllocator<CallQueue::Page, true, 4096u>::alloc<>() */Page * __thiscall
PagedAllocator<CallQueue::Page,true,4096u>::alloc<>
   ...
   while (true) {
      ...
      do {} while ( *pPVar1 != (PagedAllocator<CallQueue::Page,true,4096u>)0x0 );
   }
;
   iVar8 = *(int*)( this + 0x14 );
   if (iVar8 == 0) {
 ...
 while ( uVar10 != uVar7 );
   ...
   *(uint*)( this + 0x14 ) = uVar7;
   pPVar4 = *(Page**)( plVar12[uVar7 >> ( ( byte ) * (undefined4*)( this + 0x18 ) & 0x1f )] + ( ulong )(uVar7 & *(uint*)( this + 0x1c )) * 8 );
   ...
   *(undefined8*)( pPVar4 + 0xff8 ) = 0;
   ...
   for (uVar10 = ( ulong )(( (int)pPVar4 - (int)(undefined8*)( ( ulong )(pPVar4 + 8) & 0xfffffffffffffff8 ) ) + 0x1000U >> 3); uVar10 != 0; uVar10 = uVar10 - 1) {
      *puVar13 = 0;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<Callable, int, HashMapHasherDefault, HashMapComparatorDefault<Callable>,
   DefaultTypedAllocator<HashMapElement<Callable, int> > >::operator[](Callable const&) */undefined8 * __thiscallHashMap<Callable,int,HashMapHasherDefault,HashMapComparatorDefault<Callable>,DefaultTypedAllocator<HashMapElement<Callable,int>>>::operator [](HashMap<Callable,int,HashMapHasherDefault,HashMapComparatorDefault<Callable>,DefaultTypedAllocator<HashMapElement<Callable,int>>> * this, Callable * param_1) * plVar1 ;uint *puVar2undefined8 *puVar3void *pvVar4void *__slong lVar5undefined8 *puVar6undefined1 auVar7[16]undefined1 auVar8[16]undefined1 auVar9[16]undefined1 auVar10[16]undefined1 auVar11[16]undefined1 auVar12[16]undefined1 auVar13[16]undefined1 auVar14[16]undefined1 auVar15[16]undefined1 auVar16[16]undefined1 auVar17[16]undefined1 auVar18[16]undefined1 auVar19[16]undefined1 auVar20[16]undefined1 auVar21[16]undefined1 auVar22[16]undefined1 auVar23[16]undefined1 auVar24[16]undefined1 auVar25[16]undefined1 auVar26[16]undefined1 auVar27[16]undefined1 auVar28[16]undefined1 auVar29[16]undefined1 auVar30[16]undefined1 auVar31[16]undefined1 auVar32[16]undefined1 auVar33[16]undefined1 auVar34[16]undefined1 auVar35[16]undefined1 auVar36[16]undefined1 auVar37[16]undefined1 auVar38[16]undefined1 auVar39[16]undefined1 auVar40[16]undefined1 auVar41[16]char cVar42uint uVar43uint uVar44uint uVar45uint uVar46ulong uVar47undefined8 uVar48void *__s_00undefined8 *puVar49void *pvVar50ulong uVar51int iVar52long lVar53long lVar54ulong uVar55undefined8 uVar56uint uVar57uint uVar58long lVar59undefined8 *puVar60long in_FS_OFFSETundefined1 local_68[16]Callable local_58[16]undefined4 local_48long local_40local_40 = *(long*)( in_FS_OFFSET + 0x28 );uVar44 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );if (*(long*)( this + 8 ) == 0) {
   LAB_00104120:uVar47 = (ulong)uVar44;
   uVar51 = uVar47 * 4;
   uVar55 = uVar47 * 8;
 ...
 while ( uVar47 != uVar51 );
      ...
      LAB_00103f7e:if (iVar52 != 0) {
         LAB_00103f86:uVar45 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
         ...
         if (uVar46 != 0) {
            do {
               if ((uint)uVar47 == uVar46) {
                  cVar42 = Callable::operator ==((Callable*)( *(long*)( *(long*)( this + 8 ) + lVar53 * 8 ) + 0x10 ), param_1);
                  if (cVar42 != '\0') {
 ...
 while ( ( uVar46 != 0 ) && ( auVar21._8_8_ = 0 ),auVar21._0_8_ = (ulong)uVar46 * lVar5,auVar37._8_8_ = 0,auVar37._0_8_ = uVar51,auVar22._8_8_ = 0,auVar22._0_8_ = ( ulong )(( uVar45 + uVar58 ) - SUB164(auVar21 * auVar37, 8)) * lVar5,auVar38._8_8_ = 0,auVar38._0_8_ = uVar51,uVar57 <= SUB164(auVar22 * auVar38, 8) );
         }
   ...
   LAB_00103a4e:uVar44 = *(uint*)( this + 0x28 );
   if (uVar44 == 0x1c) {
...
;
 ...
 while ( ( uVar45 != 0 ) && ( auVar17._8_8_ = 0 ),auVar17._0_8_ = (ulong)uVar45 * lVar5,auVar33._8_8_ = 0,auVar33._0_8_ = uVar51,auVar18._8_8_ = 0,auVar18._0_8_ = ( ulong )(( uVar46 + uVar44 ) - SUB164(auVar17 * auVar33, 8)) * lVar5,auVar34._8_8_ = 0,auVar34._0_8_ = uVar51,uVar58 <= SUB164(auVar18 * auVar34, 8) );
      }

      uVar44 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
      if (*(long*)( this + 8 ) == 0) goto LAB_00104120;
      LAB_00103f7a:iVar52 = *(int*)( this + 0x2c );
      goto LAB_00103f7e;
   }

   LAB_00103a28:if ((float)uVar47 * __LC25 < (float)( iVar52 + 1 )) goto LAB_00103a4e;
}
local_68 = (undefined1[16])0x0;Callable::Callable(local_58, param_1);local_48 = 0;puVar49 = (undefined8*)operator_new(0x28, "");*puVar49 = local_68._0_8_;puVar49[1] = local_68._8_8_;Callable::Callable((Callable*)( puVar49 + 2 ), local_58);*(undefined4*)( puVar49 + 4 ) = local_48;Callable::~Callable(local_58);puVar6 = *(undefined8**)( this + 0x20 );if (puVar6 == (undefined8*)0x0) {
...
*(undefined8**)( this + 0x20 ) = puVar49;Callable::operator_cast_to_String((Callable*)local_68);uVar44 = String::hash();uVar47 = (ulong)uVar44;uVar48 = local_68._0_8_;if (local_68._0_8_ != 0) {
   LOCK();
   plVar1 = (long*)( local_68._0_8_ + -0x10 );
   *plVar1 = *plVar1 + -1;
   UNLOCK();
...
lVar5 = *(long*)( this + 0x10 );uVar58 = 0;lVar59 = *(long*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( this + 0x28 ) * 8 );uVar46 = (uint)uVar47;uVar44 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );uVar51 = CONCAT44(0, uVar44);auVar11._8_8_ = 0;auVar11._0_8_ = uVar47 * lVar59;auVar27._8_8_ = 0;auVar27._0_8_ = uVar51;lVar54 = SUB168(auVar11 * auVar27, 8);lVar53 = *(long*)( this + 8 );puVar2 = (uint*)( lVar5 + lVar54 * 4 );iVar52 = SUB164(auVar11 * auVar27, 8);uVar45 = *puVar2;puVar6 = puVar49;while (uVar45 != 0) {
   auVar12._8_8_ = 0;
...
;*(undefined8**)( lVar53 + lVar54 * 8 ) = puVar6;*puVar2 = uVar46;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_00103ddb:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return puVar49 + 4;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<int, int, HashMapHasherDefault, HashMapComparatorDefault<int>,
...

{
 ...
 while ( ( uVar37 != 0 ) && ( auVar6._8_8_ = 0 ),auVar6._0_8_ = uVar37 * uVar48,auVar22._8_8_ = 0,auVar22._0_8_ = uVar51,auVar7._8_8_ = 0,auVar7._0_8_ = ( ( uVar54 + uVar39 ) - SUB164(auVar6 * auVar22, 8) ) * uVar48,auVar23._8_8_ = 0,auVar23._0_8_ = uVar51,lVar47 = SUB168(auVar7 * auVar23, 8),uVar50 <= SUB164(auVar7 * auVar23, 8) );
   ...
   LAB_00104713:uVar45 = CONCAT44(0, *(uint*)( hash_table_size_primes + uVar40 * 4 ));
   uVar48 = *(ulong*)( hash_table_size_primes_inv + uVar40 * 8 );
...
}LAB_00104393:if ((float)uVar51 * __LC25 < (float)( iVar44 + 1 )) {
...
;*(undefined1(**) [16])( lVar47 + lStack_90 * 8 ) = pauVar36;*puVar1 = uVar38;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_001046f4:auVar57._8_8_ = lStack_90;auVar57._0_8_ = pauVar42[1] + 4;return auVar57;}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<StringName, int, HashMapHasherDefault, HashMapComparatorDefault<StringName>,
 ...
 while ( uVar40 != uVar45 );
      ...
      LAB_00104e9c:if (iVar46 != 0) {
         LAB_00104ea4:uVar38 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
 ...
 while ( ( uVar52 != 0 ) && ( auVar19._8_8_ = 0 ),auVar19._0_8_ = (ulong)uVar52 * lVar43,auVar35._8_8_ = 0,auVar35._0_8_ = uVar45,auVar20._8_8_ = 0,auVar20._0_8_ = ( ulong )(( uVar38 + uVar53 ) - SUB164(auVar19 * auVar35, 8)) * lVar43,auVar36._8_8_ = 0,auVar36._0_8_ = uVar45,uVar54 <= SUB164(auVar20 * auVar36, 8) );
   ...
   LAB_00104af9:uVar38 = *(uint*)( this + 0x28 );
   if (uVar38 == 0x1c) {
...
;
 ...
 while ( ( uVar52 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = (ulong)uVar52 * lVar49,auVar23._8_8_ = 0,auVar23._0_8_ = uVar40,auVar8._8_8_ = 0,auVar8._0_8_ = ( ulong )(( uVar53 + uVar38 ) - SUB164(auVar7 * auVar23, 8)) * lVar49,auVar24._8_8_ = 0,auVar24._0_8_ = uVar40,uVar54 <= SUB164(auVar8 * auVar24, 8) );
      ...
      LAB_00104e98:iVar46 = *(int*)( this + 0x2c );
      goto LAB_00104e9c;
   }

   LAB_00104ad3:if ((float)uVar40 * __LC25 < (float)( iVar46 + 1 )) goto LAB_00104af9;
}
...
puVar4 = *(undefined8**)( this + 0x20 );if (puVar4 == (undefined8*)0x0) {
   ...
   *(undefined8**)( this + 0x20 ) = puVar42;
   ...
   LAB_00104d84:uVar38 = *(uint*)( lVar43 + 0x20 );
}
 else {
   *puVar4 = puVar42;
   puVar42[1] = puVar4;
   ...
   *(undefined8**)( this + 0x20 ) = puVar42;
   ...
   LAB_00104fad:uVar38 = StringName::get_empty_hash();
}
if (uVar38 == 0) {
   uVar38 = 1;
}
...
;*(undefined8**)( lVar47 + lVar48 * 8 ) = puVar4;*puVar1 = uVar38;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_00104a9c:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return puVar42 + 3;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* CallQueue::push_set(ObjectID, StringName const&, Variant const&) [clone .cold] */void CallQueue::push_set(void) {
   code *pcVar1;
   _err_print_error("get_instance", "./core/object/object.h", 0x418, "Condition \"slot >= slot_max\" is true. Returning: nullptr", 0, 0);
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
...
/* PagedAllocator<CallQueue::Page, true, 4096u>::~PagedAllocator() */void PagedAllocator<CallQueue::Page,true,4096u>::~PagedAllocator(PagedAllocator<CallQueue::Page,true,4096u> *this) {
   PagedAllocator<CallQueue::Page,true,4096u> *pPVar1;
   long *plVar2;
   long lVar3;
...
/* WARNING: Control flow encountered bad instruction data *//* PagedAllocator<CallQueue::Page, true, 4096u>::~PagedAllocator() */void PagedAllocator<CallQueue::Page,true,4096u>::~PagedAllocator(PagedAllocator<CallQueue::Page,true,4096u> *this) {

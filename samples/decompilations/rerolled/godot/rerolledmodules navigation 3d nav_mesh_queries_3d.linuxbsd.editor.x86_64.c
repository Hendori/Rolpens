/* LocalVector<long, unsigned int, false, false>::resize(unsigned int) [clone .part.0] */void LocalVector<long,unsigned_int,false,false>::resize(uint param_1) {
   code *pcVar1;
...
/* gd::Heap<gd::NavigationPoly*, gd::NavPolyTravelCostGreaterThan,
   gd::NavPolyHeapIndexer>::_shift_down(unsigned int) [clone .isra.0] */void gd::Heap<gd::NavigationPoly*,gd::NavPolyTravelCostGreaterThan,gd::NavPolyHeapIndexer>::_shift_down(Heap<gd::NavigationPoly*,gd::NavPolyTravelCostGreaterThan,gd::NavPolyHeapIndexer> *this, uint param_1) {
   uint uVar1;
   float fVar2;
   uint uVar3;
   long lVar4;
   ...
   uVar9 = (ulong)param_1;
   if (uVar3 <= param_1) {
      LAB_00100122:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, uVar9, (ulong)uVar3, "p_index", "count", "", false, true);
      _err_flush_stdout();
      /* WARNING: Does not return */
 ...
 while ( uVar11 < uVar3 );
      if (param_1 != uVar12) {
         if (uVar3 <= uVar12) {
            LAB_00100120:uVar9 = (ulong)uVar12;
            goto LAB_00100122;
         }
...
/* NavMeshQueries3D::emit_callback(Callable const&) */undefined4 NavMeshQueries3D::emit_callback(Callable *param_1) {
   char cVar1;
   undefined4 uVar2;
   long in_FS_OFFSET;
   int local_38[2];
   ...
   if (cVar1 == '\0') {
      _err_print_error("emit_callback", "modules/navigation/3d/nav_mesh_queries_3d.cpp", 0x2d, "Condition \"!p_callback.is_valid()\" is true. Returning: false", 0, 0);
      uVar2 = 0;
   }
 else {
...
/* NavMeshQueries3D::_query_task_push_back_point_with_metadata(NavMeshQueries3D::NavMeshPathQueryTask3D&,
   Vector3 const&, gd::Polygon const*) */void NavMeshQueries3D::_query_task_push_back_point_with_metadata(NavMeshPathQueryTask3D *param_1, Vector3 *param_2, Polygon *param_3) {
   undefined8 *puVar1;
   undefined4 uVar2;
   uint uVar3;
   long lVar4;
   ...
   if (uVar8 == *(uint*)( param_1 + 0x84 )) {
      ...
      *(void**)( param_1 + 0x88 ) = pvVar7;
      if (pvVar7 == (void*)0x0) {
         LAB_00100410:_err_print_error("push_back", "./core/templates/local_vector.h", 0x41, "FATAL: Condition \"!data\" is true.", "Out of memory", 0, 0);
         _err_flush_stdout();
         /* WARNING: Does not return */
...
/* NavMeshQueries3D::map_query_path(NavMap*, Ref<NavigationPathQueryParameters3D> const&,
   Ref<NavigationPathQueryResult3D>, Callable const&) */void NavMeshQueries3D::map_query_path(NavMeshPathQueryTask3D *param_1, long *param_2, long *param_3, Callable *param_4) {
   ...
   if (param_1 == (NavMeshPathQueryTask3D*)0x0) {
      if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         ...
         LAB_001007f9:_err_print_error("map_query_path", "modules/navigation/3d/nav_mesh_queries_3d.cpp", uVar8, pcVar7, 0, 0);
         return;
      }
      ...
      if (iVar6 != 0) {
         _err_print_error("map_query_path", "modules/navigation/3d/nav_mesh_queries_3d.cpp", 0xa6, "No match for used PathfindingAlgorithm - fallback to default", 0, 1);
      }
      ...
      if (( iVar6 != 1 ) && ( iVar6 != 2 )) {
         if (iVar6 != 0) {
            _err_print_error("map_query_path", "modules/navigation/3d/nav_mesh_queries_3d.cpp", 0xb6, "No match for used PathPostProcessing - fallback to default", 0, 1);
         }
      ...
      NavigationPathQueryResult3D::set_data((LocalVector*)*param_3, (LocalVector*)&local_98, (LocalVector*)&local_88, (LocalVector*)&local_78);
...
/* NavMeshQueries3D::_query_task_find_start_end_positions(NavMeshQueries3D::NavMeshPathQueryTask3D&,
   NavMapIteration const&) */void NavMeshQueries3D::_query_task_find_start_end_positions(NavMeshPathQueryTask3D *param_1, NavMapIteration *param_2) {
   long lVar1;
   long lVar2;
   long lVar3;
   undefined8 *puVar4;
      ...
      do {
         if (*(char*)( lVar8 + 4 ) != '\0') {
            ...
            if (lVar1 != lVar3) {
               ...
               while (true) {
                  if (( uVar6 != 0 ) && ( uVar9 = ( ulong ) * (uint*)( lVar3 + 0x10 ) ),2 < *(uint*)( lVar3 + 0x10 )) {
                     lVar10 = 0x30;
                     uVar7 = 2;
                     do {
                        ...
                        fVar13 = ( *(float*)( param_1 + 8 ) - in_XMM1_Da ) * ( *(float*)( param_1 + 8 ) - in_XMM1_Da );
                        ...
                        in_XMM1_Da = ( *(float*)( param_1 + 0x14 ) - fVar13 ) * ( *(float*)( param_1 + 0x14 ) - fVar13 );
...
/* NavMeshQueries3D::_query_task_post_process_edgecentered(NavMeshQueries3D::NavMeshPathQueryTask3D&)
   ...
   _query_task_push_back_point_with_metadata(param_1, (Vector3*)&local_58, *(Polygon**)( param_1 + 0x58 ));
   if (uVar13 != 0xffffffff) {
      uVar12 = ( ulong ) * puVar5;
      do {
         if ((uint)uVar12 <= uVar13) {
            LAB_00100d1e:uVar9 = (ulong)uVar13;
            iVar10 = 0xb2;
            LAB_00100d23:_err_print_index_error("operator[]", "./core/templates/local_vector.h", iVar10, uVar9, uVar12, "p_index", "count", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
         ...
         if (uVar4 == 0xffffffff) {
            ...
            local_68 = CONCAT44(( (float)( (ulong)uVar3 >> 0x20 ) + (float)( (ulong)uVar2 >> 0x20 ) ) * _LC21._4_4_, ( (float)uVar3 + (float)uVar2 ) * (float)_LC21);
...
/* NavMeshQueries3D::_query_task_post_process_nopostprocessing(NavMeshQueries3D::NavMeshPathQueryTask3D&)
   ...
   if (uVar4 != 0xffffffff) {
      ...
      do {
         if ((uint)uVar6 <= uVar4) {
            LAB_00100e7d:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, (ulong)uVar4, uVar6, "p_index", "count", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
         ...
         _query_task_push_back_point_with_metadata(param_1, (Vector3*)( (long)puVar5 + 0x2c ), (Polygon*)*puVar5);
         uVar6 = ( ulong ) * puVar2;
...
/* NavMeshQueries3D::map_iteration_get_closest_point_to_segment(NavMapIteration const&, Vector3
   const&, Vector3 const&, bool) */void NavMeshQueries3D::map_iteration_get_closest_point_to_segment(NavMapIteration *param_1, Vector3 *param_2, Vector3 *param_3, bool param_4) {
   long lVar1;
   undefined8 *puVar2;
               ...
               do {
                  ...
                  if (cVar7 == '\0') {
                     if (local_cd == '\0') {
                        ...
                        fVar17 = SQRT(( local_80 - *(float*)param_2 ) * ( local_80 - *(float*)param_2 ) + ( fStack_7c - *(float*)( param_2 + 4 ) ) * ( fStack_7c - *(float*)( param_2 + 4 ) ) + fVar17 * fVar17);
                        if (fVar17 < local_cc) {
                           local_cc = fVar17;
                           auVar6 = auVar18;
                        }
                        ...
                        fVar17 = SQRT(( (float)local_74._0_4_ - *(float*)param_3 ) * ( (float)local_74._0_4_ - *(float*)param_3 ) + ( (float)local_74._4_4_ - *(float*)( param_3 + 4 ) ) * ( (float)local_74._4_4_ - *(float*)( param_3 + 4 ) ) + fVar17 * fVar17);
                        if (fVar17 < local_cc) {
                           local_cc = fVar17;
                           auVar6 = auVar18;
                        }
                     ...
                     fVar17 = SQRT(( 0.0 - *(float*)param_2 ) * ( 0.0 - *(float*)param_2 ) + ( 0.0 - *(float*)( param_2 + 4 ) ) * ( 0.0 - *(float*)( param_2 + 4 ) ) + ( 0.0 - *(float*)( param_2 + 8 ) ) * ( 0.0 - *(float*)( param_2 + 8 ) ));
                     if (local_cd == '\0') {
                        local_cd = cVar7;
                        local_cc = fVar17;
                        auVar6 = ZEXT812(0);
            ...
            if (( local_cd == '\0' ) && ( uVar12 != 0 )) {
               ...
               do {
                  ...
                  if ((uint)uVar12 <= SUB164(auVar4 % auVar3, 0)) {
                     LAB_0010122e:_local_74 = auVar18;
                     _err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xae, uVar11, uVar12, "p_index", "count", "", false, true);
                     _err_flush_stdout();
                     /* WARNING: Does not return */
                     pcVar5 = (code*)invalidInstructionException();
                     ( *pcVar5 )();
                  ...
                  Geometry3D::get_closest_points_between_segments(param_2, param_3, (Vector3*)( *(long*)( lVar10 + 0x18 ) + uVar15 * 0x18 ), (Vector3*)( *(long*)( lVar10 + 0x18 ) + uVar9 * 0x18 ), (Vector3*)local_74, (Vector3*)local_68);
                  auVar18._8_4_ = local_6c;
                  auVar18._0_8_ = local_74;
                  fVar17 = SQRT(( (float)local_68._0_4_ - (float)local_74._0_4_ ) * ( (float)local_68._0_4_ - (float)local_74._0_4_ ) + ( (float)local_68._4_4_ - (float)local_74._4_4_ ) * ( (float)local_68._4_4_ - (float)local_74._4_4_ ) + ( local_60 - local_6c ) * ( local_60 - local_6c ));
                  if (fVar17 < local_cc) {
...
/* NavMeshQueries3D::map_iteration_get_closest_point_info(NavMapIteration const&, Vector3 const&) */NavMeshQueries3D * __thiscall
NavMeshQueries3D::map_iteration_get_closest_point_info
   ...
   *(undefined8*)( this + 0x18 ) = 0;
   ...
   while (true) {
      ...
      LAB_001017db:lVar13 = lVar13 + 0x90;
      fVar15 = fVar19;
   }
;
   LAB_00101492:uVar7 = *(uint*)( lVar17 + 0x10 );
   if (uVar7 == 0) {
      lVar16 = 0;
      lVar13 = 0;
   }
      ...
      if (uVar7 == 1) {
         ...
         if (uVar7 != 2) {
            ...
            fVar32 = ( pfVar12[8] - fVar31 ) * ( (float)*(undefined8*)( pfVar12 + 0xc ) - fVar19 ) - ( (float)*(undefined8*)( pfVar12 + 6 ) - fVar19 ) * ( pfVar12[0xe] - fVar31 );
            ...
            do {
               ...
               fVar27 = fVar6 - fVar21;
               fVar30 = fVar5 - fVar28;
               if (( fVar35 * fVar29 - fVar33 * fVar30 ) * fVar32 + ( fVar33 * fVar27 - fVar26 * fVar29 ) * fVar22 + ( fVar26 * fVar30 - fVar35 * fVar27 ) * fVar34 <= 0.0) {
                  ...
                  if (fVar18 <= fVar23) {
                     ...
                     fVar28 = ( fVar3 - fVar5 ) * ( fVar3 - fVar5 ) + ( fVar9 - fVar6 ) * ( fVar9 - fVar6 ) + ( fVar8 - fVar4 ) * ( fVar8 - fVar4 );
                     if (fVar28 < fVar24) {
                        bVar11 = false;
                        fVar24 = fVar28;
                        local_4c = fVar6;
               ...
               joined_r0x001015b7:if (lVar14 + 1U == (ulong)uVar7) goto LAB_00101730;
               lVar14 = lVar14 + 1;
               pfVar12 = pfVar12 + 6;
               fVar28 = fVar5;
               fVar21 = fVar6;
 ...
 while ( true );
   ...
   _err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xae, lVar13, lVar16, "p_index", "count", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar10 = (code*)invalidInstructionException();
   ( *pcVar10 )();
   LAB_00101730:if (bVar11) {
      ...
      LAB_00101758:fVar19 = ( fVar3 - local_48 ) * ( fVar3 - local_48 ) + ( fVar9 - local_4c ) * ( fVar9 - local_4c ) + ( fVar8 - local_44 ) * ( fVar8 - local_44 );
      if (fVar19 < fVar15) {
         lVar14 = *(long*)( lVar17 + 8 );
...
/* NavMeshQueries3D::map_iteration_get_closest_point(NavMapIteration const&, Vector3 const&) */undefined1[16];NavMeshQueries3D::map_iteration_get_closest_point(NavMapIteration *param_1, Vector3 *param_2) {
   long in_FS_OFFSET;
...
/* NavMeshQueries3D::map_iteration_get_closest_point_normal(NavMapIteration const&, Vector3 const&)
    */undefined1[16];NavMeshQueries3D::map_iteration_get_closest_point_normal(NavMapIteration *param_1, Vector3 *param_2) {
   long in_FS_OFFSET;
   undefined1 auVar1[16];
...
/* NavMeshQueries3D::map_iteration_get_closest_point_owner(NavMapIteration const&, Vector3 const&)
    */undefined8 NavMeshQueries3D::map_iteration_get_closest_point_owner(NavMapIteration *param_1, Vector3 *param_2) {
   long in_FS_OFFSET;
...
/* NavMeshQueries3D::polygons_get_closest_point_to_segment(LocalVector<gd::Polygon, unsigned int,
   false, false> const&, Vector3 const&, Vector3 const&, bool) */void NavMeshQueries3D::polygons_get_closest_point_to_segment(LocalVector *param_1, Vector3 *param_2, Vector3 *param_3, bool param_4) {
   long lVar1;
   undefined8 *puVar2;
   undefined1 auVar3[16];
   undefined1 auVar4[16];
         ...
         do {
            ...
            if (cVar7 == '\0') {
               if (local_bd == '\0') {
                  ...
                  fVar15 = SQRT(( local_80 - *(float*)param_2 ) * ( local_80 - *(float*)param_2 ) + ( fStack_7c - *(float*)( param_2 + 4 ) ) * ( fStack_7c - *(float*)( param_2 + 4 ) ) + fVar15 * fVar15);
                  if (fVar15 < local_bc) {
                     local_bc = fVar15;
                     auVar6 = auVar16;
                  }
                  ...
                  fVar15 = SQRT(( (float)local_74._0_4_ - *(float*)param_3 ) * ( (float)local_74._0_4_ - *(float*)param_3 ) + ( (float)local_74._4_4_ - *(float*)( param_3 + 4 ) ) * ( (float)local_74._4_4_ - *(float*)( param_3 + 4 ) ) + fVar15 * fVar15);
                  if (fVar15 < local_bc) {
                     local_bc = fVar15;
                     auVar6 = auVar16;
                  }
               ...
               fVar15 = SQRT(( 0.0 - *(float*)param_2 ) * ( 0.0 - *(float*)param_2 ) + ( 0.0 - *(float*)( param_2 + 4 ) ) * ( 0.0 - *(float*)( param_2 + 4 ) ) + ( 0.0 - *(float*)( param_2 + 8 ) ) * ( 0.0 - *(float*)( param_2 + 8 ) ));
               if (local_bd == '\0') {
                  local_bd = cVar7;
                  local_bc = fVar15;
                  auVar6 = ZEXT812(0);
      ...
      if (( local_bd == '\0' ) && ( uVar8 != 0 )) {
         ...
         do {
            ...
            if ((uint)uVar8 <= SUB164(auVar4 % auVar3, 0)) {
               LAB_00101e9e:_local_74 = auVar16;
               _err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xae, uVar14, uVar8, "p_index", "count", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
               pcVar5 = (code*)invalidInstructionException();
               ( *pcVar5 )();
            ...
            Geometry3D::get_closest_points_between_segments(param_2, param_3, (Vector3*)( *(long*)( lVar10 + 0x18 ) + uVar12 * 0x18 ), (Vector3*)( *(long*)( lVar10 + 0x18 ) + uVar9 * 0x18 ), (Vector3*)local_74, (Vector3*)local_68);
            auVar16._8_4_ = local_6c;
            auVar16._0_8_ = local_74;
            fVar15 = SQRT(( (float)local_68._0_4_ - (float)local_74._0_4_ ) * ( (float)local_68._0_4_ - (float)local_74._0_4_ ) + ( (float)local_68._4_4_ - (float)local_74._4_4_ ) * ( (float)local_68._4_4_ - (float)local_74._4_4_ ) + ( local_60 - local_6c ) * ( local_60 - local_6c ));
            if (fVar15 < local_bc) {
               auVar6._8_4_ = local_60;
               auVar6._0_8_ = local_68;
               local_bc = fVar15;
...
/* NavMeshQueries3D::polygons_get_closest_point_info(LocalVector<gd::Polygon, unsigned int, false,
   false> const&, Vector3 const&) */NavMeshQueries3D * __thiscall
NavMeshQueries3D::polygons_get_closest_point_info
   ...
   *(undefined8*)( this + 0x18 ) = 0;
   fVar27 = _LC20;
   joined_r0x001020ba:if (lVar12 == lVar14) {
      return this;
   }
   ...
   if (uVar6 == 0) {
      ...
      if (uVar6 == 1) {
         ...
         if (uVar6 != 2) {
            ...
            local_38 = 0.0;
            fVar24 = ( pfVar11[8] - fVar16 ) * ( (float)*(undefined8*)( pfVar11 + 0xc ) - fVar30 ) - ( (float)*(undefined8*)( pfVar11 + 6 ) - fVar30 ) * ( pfVar11[0xe] - fVar16 );
            ...
            do {
               ...
               if (( fVar20 * fVar23 - fVar28 * fVar25 ) * fVar24 + ( fVar28 * fVar21 - fVar29 * fVar23 ) * fVar32 + ( fVar29 * fVar25 - fVar20 * fVar21 ) * fVar26 <= 0.0) {
                  ...
                  if (fVar15 <= fVar18) {
                     ...
                     fVar22 = ( fVar8 - fVar5 ) * ( fVar8 - fVar5 ) + ( fVar2 - fVar4 ) * ( fVar2 - fVar4 ) + ( fVar7 - fVar3 ) * ( fVar7 - fVar3 );
                     if (fVar22 < fVar19) {
                        bVar10 = false;
                        fVar19 = fVar22;
                        local_3c = fVar3;
               ...
               joined_r0x001021e7:if (lVar13 + 1U == (ulong)uVar6) goto LAB_00102370;
               lVar13 = lVar13 + 1;
               pfVar11 = pfVar11 + 6;
               fVar22 = fVar4;
               fVar17 = fVar3;
 ...
 while ( true );
   ...
   _err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xae, lVar12, lVar14, "p_index", "count", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar9 = (code*)invalidInstructionException();
   ( *pcVar9 )();
   LAB_00102370:if (bVar10) {
      ...
      LAB_0010238c:fVar22 = ( fVar8 - local_34 ) * ( fVar8 - local_34 ) + ( fVar2 - local_38 ) * ( fVar2 - local_38 ) + ( fVar7 - local_3c ) * ( fVar7 - local_3c );
      if (fVar22 < fVar27) {
         lVar13 = *(long*)( lVar14 + 8 );
         *(ulong*)( this + 0x10 ) = CONCAT44(fVar26, fVar24);
         *(undefined8*)( this + 0x18 ) = *(undefined8*)( lVar13 + 0x20 );
...
/* NavMeshQueries3D::polygons_get_closest_point(LocalVector<gd::Polygon, unsigned int, false, false>
   const&, Vector3 const&) */undefined1[16];NavMeshQueries3D::polygons_get_closest_point(LocalVector *param_1, Vector3 *param_2) {
   long in_FS_OFFSET;
   undefined1 auVar1[16];
   undefined8 local_38;
   undefined4 local_30;
...
/* NavMeshQueries3D::polygons_get_closest_point_normal(LocalVector<gd::Polygon, unsigned int, false,
   false> const&, Vector3 const&) */undefined1[16];NavMeshQueries3D::polygons_get_closest_point_normal(LocalVector *param_1, Vector3 *param_2) {
   long in_FS_OFFSET;
   undefined1 auVar1[16];
   NavMeshQueries3D local_38[12];
   undefined8 local_2c;
...
/* NavMeshQueries3D::polygons_get_closest_point_owner(LocalVector<gd::Polygon, unsigned int, false,
   false> const&, Vector3 const&) */undefined8 NavMeshQueries3D::polygons_get_closest_point_owner(LocalVector *param_1, Vector3 *param_2) {
   long in_FS_OFFSET;
   NavMeshQueries3D aNStack_38[24];
   undefined8 local_20;
   long local_10;
...
/* NavMeshQueries3D::_query_task_clip_path(NavMeshQueries3D::NavMeshPathQueryTask3D&,
   gd::NavigationPoly const*, Vector3 const&, gd::NavigationPoly const*) */void NavMeshQueries3D::_query_task_clip_path(NavMeshPathQueryTask3D *param_1, NavigationPoly *param_2, Vector3 *param_3, NavigationPoly *param_4) {
   undefined8 *puVar1;
   float fVar2;
   float fVar3;
   undefined8 uVar4;
   ...
   if (*(int*)( param_1 + 0x80 ) == 0) {
      LAB_001027bb:uVar15 = 0;
      uVar13 = 0xffffffff;
      iVar14 = 0xb2;
      LAB_001027e3:_err_print_index_error("operator[]", "./core/templates/local_vector.h", iVar14, uVar13, uVar15, "p_index", "count", "", false, true);
      _err_flush_stdout();
      /* WARNING: Does not return */
      pcVar10 = (code*)invalidInstructionException();
      ( *pcVar10 )();
   ...
   if (cVar12 == '\0') {
      ...
      fVar20 = fVar2 * ( local_80 - (float)( ( ulong ) * (undefined8*)( param_3 + 4 ) >> 0x20 ) ) - (float)( (ulong)uVar4 >> 0x20 ) * fVar21;
      auVar19._0_8_ = CONCAT44(fVar20, fVar18);
      auVar19._8_8_ = 0;
      local_50 = fVar17 * fVar21 - fVar16 * fVar2;
      if (( fVar20 != 0.0 || fVar18 != 0.0 ) || ( local_58 = local_50 != 0.0 )) {
         ...
         if (param_2 != param_4) {
            do {
               ...
               if (uVar6 == 0xffffffff) {
                  _err_print_error("_query_task_clip_path", "modules/navigation/3d/nav_mesh_queries_3d.cpp", 0x436, "Condition \"from_poly->back_navigation_poly_id == -1\" is true.", 0, 0);
                  break;
               }
               ...
               if (cVar12 == '\0') {
                  local_5c = 0;
                  local_64 = 0;
                  cVar12 = Plane::intersects_segment((Vector3*)&local_58, (Vector3*)&local_7c, (Vector3*)&local_70);
                  if (( cVar12 != '\0' ) && ( cVar12 = Vector3::is_equal_approx((Vector3*)&local_64) ),cVar12 == '\0') {
                     if (*(int*)( param_1 + 0x80 ) == 0) goto LAB_001027bb;
                     cVar12 = Vector3::is_equal_approx((Vector3*)&local_64);
                     if (cVar12 == '\0') {
                        _query_task_push_back_point_with_metadata(param_1, (Vector3*)&local_64, *(Polygon**)param_2);
                     }

/* insert_result(unsigned int, float, unsigned int, float*, unsigned int*) */void insert_result(uint param_1, float param_2, uint param_3, float *param_4, uint *param_5) {
   undefined4 uVar1;
   long lVar2;
   long lVar3;
   float *pfVar4;
      ...
      if (param_2 < *pfVar4 || param_2 == *pfVar4) {
         if ((uint)uVar6 < uVar5) {
            ...
            do {
               ...
               *(undefined4*)( (long)( param_4 + uVar5 ) + lVar2 ) = *(undefined4*)( (long)param_4 + lVar2 + lVar3 );
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* find_best_partition_candidates(block_size_descriptor const&, image_block const&, unsigned int,
   unsigned int, unsigned int*, unsigned int) */ulong find_best_partition_candidates(block_size_descriptor *param_1, image_block *param_2, uint param_3, uint param_4, uint *param_5, uint param_6) {
   ...
   do {
      ...
      fVar68 = fVar68 * fVar68 * fVar82 + fVar79 * fVar79 * fVar12 + fVar78 * fVar78 * fVar85 + fVar80 * fVar80 * fVar13;
      *pfVar46 = fVar68;
 ...
 while ( piVar43 != piVar21 );
   ...
   do {
      ...
      do {
         ...
         if (fVar84 * *(float*)( (long)&local_f68 + ( ulong )(param_3 * 3 + -7 + uVar44) * 4 ) <= fVar69) break;
         uVar58 = (int)uVar35 + 1;
         uVar35 = (ulong)uVar58;
         pfVar46 = pfVar46 + 1;
      }
      ...
      if (param_3 <= uVar44) {
         ...
         do {
            ...
            do {
               ...
               fVar69 = _LC2;
               do {
                  fVar70 = ( *(float*)( piVar50 + 0x6e0 ) - *(float*)( ppVar62 + 8 ) ) * ( *(float*)( piVar50 + 0x6e0 ) - *(float*)( ppVar62 + 8 ) ) * fVar12 + ( *(float*)piVar50 - *(float*)ppVar62 ) * ( *(float*)piVar50 - *(float*)ppVar62 ) * fVar82 + ( *(float*)( piVar50 + 0xa50 ) - *(float*)( ppVar62 + 0xc ) ) * ( *(float*)( piVar50 + 0xa50 ) - *(float*)( ppVar62 + 0xc ) ) * fVar13 + ( *(float*)( piVar50 + 0x370 ) - *(float*)( ppVar62 + 4 ) ) * ( *(float*)( piVar50 + 0x370 ) - *(float*)( ppVar62 + 4 ) ) * fVar85;
                  if (fVar70 < fVar69) {
                     uVar35 = uVar36;
                     fVar69 = fVar70;
                  }
 ...
 while ( piVar43 != piVar50 );
            LAB_001003f8:bVar15 = false;
            uVar36 = 0;
            pbVar54 = local_528;
            uVar35 = uVar36;
            pbVar63 = local_448;
            if (local_448[0] != 0) goto LAB_00100427;
            LAB_0010040d:bVar40 = *pbVar54;
            *pbVar54 = (byte)uVar36;
            bVar15 = true;
            local_448[bVar40] = local_448[bVar40] - 1;
            *pbVar63 = *pbVar63 + 1;
            uVar35 = uVar36;
            LAB_00100427:while (true) {
               uVar59 = (int)uVar35 + 1;
               uVar36 = (ulong)uVar59;
               pbVar63 = pbVar63 + 1;
               pbVar54 = pbVar54 + 1;
...
;
            ...
            if (iVar20 == 3) {
               ...
               do {
                  ...
                  bVar40 = (byte)lVar55;
                  lVar55 = lVar55 + 1;
                  *(ulong*)( local_1068 + (ulong)local_528[(byte)param_1[lVar16]] * 8 ) = *(ulong*)( local_1068 + (ulong)local_528[(byte)param_1[lVar16]] * 8 ) | 1L << ( bVar40 & 0x3f );
               }
 while ( (uint)lVar55 < (uint)(byte)bVar19 );
               ...
               if (uVar59 == 2) {
                  ...
                  do {
                     ...
                     uVar58 = ( uint )(byte)(( uVar34 + ( uVar34 >> 4 ) & 0xf0f0f0f0f0f0f0f ) * 0x101010101010101 >> 0x38) + ( uint )(byte)(( uVar39 + ( uVar39 >> 4 ) & 0xf0f0f0f0f0f0f0f ) * 0x101010101010101 >> 0x38);
                     uVar36 = uVar36 - ( uVar36 >> 1 & 0x5555555555555555 );
                     uVar34 = ( uVar36 >> 2 & 0x3333333333333333 ) + ( uVar36 & 0x3333333333333333 );
                     uVar52 = ( uint )(byte)(( uVar34 + ( uVar34 >> 4 ) & 0xf0f0f0f0f0f0f0f ) * 0x101010101010101 >> 0x38) + ( uint )(byte)(( uVar35 + ( uVar35 >> 4 ) & 0xf0f0f0f0f0f0f0f ) * 0x101010101010101 >> 0x38);
                     if (uVar52 < uVar58) {
                        uVar58 = uVar52;
                     }
 ...
 while ( local_448 + uVar44 != pbVar63 );
                  ...
                  do {
                     ...
                     uVar39 = ( (ulong)local_1068 ^ uVar34 ) - ( ( (ulong)local_1068 ^ uVar34 ) >> 1 & 0x5555555555555555 );
                     uVar39 = ( uVar39 >> 2 & 0x3333333333333333 ) + ( uVar39 & 0x3333333333333333 );
                     uVar22 = ( (ulong)local_1068 ^ uVar35 ) - ( ( (ulong)local_1068 ^ uVar35 ) >> 1 & 0x5555555555555555 );
                     uVar22 = ( uVar22 >> 2 & 0x3333333333333333 ) + ( uVar22 & 0x3333333333333333 );
                     uVar23 = ( (ulong)local_1068 ^ uVar36 ) - ( ( (ulong)local_1068 ^ uVar36 ) >> 1 & 0x5555555555555555 );
                     ...
                     uVar34 = ( uVar34 ^ (ulong)local_1058 ) - ( ( uVar34 ^ (ulong)local_1058 ) >> 1 & 0x5555555555555555 );
                     uVar34 = ( uVar34 >> 2 & 0x3333333333333333 ) + ( uVar34 & 0x3333333333333333 );
                     uVar35 = ( uVar35 ^ (ulong)local_1058 ) - ( ( uVar35 ^ (ulong)local_1058 ) >> 1 & 0x5555555555555555 );
                     uVar35 = ( uVar35 >> 2 & 0x3333333333333333 ) + ( uVar35 & 0x3333333333333333 );
                     uVar36 = ( uVar36 ^ (ulong)local_1058 ) - ( ( uVar36 ^ (ulong)local_1058 ) >> 1 & 0x5555555555555555 );
                     bVar40 = ( byte )(( uVar26 + ( uVar26 >> 4 ) & 0xf0f0f0f0f0f0f0f ) * 0x101010101010101 >> 0x38);
                     bVar7 = ( byte )(( ( uVar35 >> 4 ) + uVar35 & 0xf0f0f0f0f0f0f0f ) * 0x101010101010101 >> 0x38);
                     uVar52 = (uint)bVar40 + (uint)bVar7;
                     uVar35 = ( uVar36 >> 2 & 0x3333333333333333 ) + ( uVar36 & 0x3333333333333333 );
                     bVar8 = ( byte )(( uVar25 + ( uVar25 >> 4 ) & 0xf0f0f0f0f0f0f0f ) * 0x101010101010101 >> 0x38);
                     bVar9 = ( byte )(( uVar35 + ( uVar35 >> 4 ) & 0xf0f0f0f0f0f0f0f ) * 0x101010101010101 >> 0x38);
                     uVar58 = (uint)bVar8 + (uint)bVar9;
                     if (uVar52 < uVar58) {
                        uVar58 = uVar52;
                     }

                     uVar45 = ( uint )(byte)(( uVar24 + ( uVar24 >> 4 ) & 0xf0f0f0f0f0f0f0f ) * 0x101010101010101 >> 0x38);
                     uVar56 = bVar9 + uVar45;
                     uVar53 = ( uint )(byte)(( ( uVar34 >> 4 ) + uVar34 & 0xf0f0f0f0f0f0f0f ) * 0x101010101010101 >> 0x38);
                     uVar52 = bVar40 + uVar53;
                     uVar58 = ( byte )(( uVar39 + ( uVar39 >> 4 ) & 0xf0f0f0f0f0f0f0f ) * 0x101010101010101 >> 0x38) + uVar58;
                     if (uVar56 <= uVar52) {
                        uVar52 = uVar56;
                     }

                     uVar52 = uVar52 + ( byte )(( uVar22 + ( uVar22 >> 4 ) & 0xf0f0f0f0f0f0f0f ) * 0x101010101010101 >> 0x38);
                     if (uVar52 < uVar58) {
                        uVar58 = uVar52;
                     }
                     ...
                     uVar53 = uVar53 + ( byte )(( uVar23 + ( uVar23 >> 4 ) & 0xf0f0f0f0f0f0f0f ) * 0x101010101010101 >> 0x38);
                     if (uVar53 < uVar58) {
                        uVar58 = uVar53;
                     }
 ...
 while ( pbVar63 != local_448 + uVar44 );
                  ...
                  do {
                     ...
                     uVar22 = ( (ulong)local_1068 ^ uVar34 ) - ( ( (ulong)local_1068 ^ uVar34 ) >> 1 & 0x5555555555555555 );
                     uVar22 = ( uVar22 >> 2 & 0x3333333333333333 ) + ( uVar22 & 0x3333333333333333 );
                     uVar23 = ( (ulong)local_1068 ^ uVar35 ) - ( ( (ulong)local_1068 ^ uVar35 ) >> 1 & 0x5555555555555555 );
                     uVar23 = ( uVar23 >> 2 & 0x3333333333333333 ) + ( uVar23 & 0x3333333333333333 );
                     uVar24 = ( (ulong)local_1068 ^ uVar36 ) - ( ( (ulong)local_1068 ^ uVar36 ) >> 1 & 0x5555555555555555 );
                     uVar24 = ( uVar24 >> 2 & 0x3333333333333333 ) + ( uVar24 & 0x3333333333333333 );
                     uVar25 = ( (ulong)local_1068 ^ uVar39 ) - ( ( (ulong)local_1068 ^ uVar39 ) >> 1 & 0x5555555555555555 );
                     uVar25 = ( uVar25 >> 2 & 0x3333333333333333 ) + ( uVar25 & 0x3333333333333333 );
                     ...
                     uVar30 = ( (ulong)local_1058 ^ uVar34 ) - ( ( (ulong)local_1058 ^ uVar34 ) >> 1 & 0x5555555555555555 );
                     uVar30 = ( uVar30 >> 2 & 0x3333333333333333 ) + ( uVar30 & 0x3333333333333333 );
                     uVar31 = ( (ulong)local_1058 ^ uVar35 ) - ( ( (ulong)local_1058 ^ uVar35 ) >> 1 & 0x5555555555555555 );
                     uVar31 = ( uVar31 >> 2 & 0x3333333333333333 ) + ( uVar31 & 0x3333333333333333 );
                     uVar32 = ( (ulong)local_1058 ^ uVar36 ) - ( ( (ulong)local_1058 ^ uVar36 ) >> 1 & 0x5555555555555555 );
                     uVar32 = ( uVar32 >> 2 & 0x3333333333333333 ) + ( uVar32 & 0x3333333333333333 );
                     uVar33 = ( (ulong)local_1058 ^ uVar39 ) - ( ( (ulong)local_1058 ^ uVar39 ) >> 1 & 0x5555555555555555 );
                     ...
                     bVar40 = ( byte )(( uVar33 + ( uVar33 >> 4 ) & 0xf0f0f0f0f0f0f0f ) * 0x101010101010101 >> 0x38);
                     bVar7 = ( byte )(( uVar35 + ( uVar35 >> 4 ) & 0xf0f0f0f0f0f0f0f ) * 0x101010101010101 >> 0x38);
                     uVar35 = ( uVar39 ^ uStack_1050 ) - ( ( uVar39 ^ uStack_1050 ) >> 1 & 0x5555555555555555 );
                     uVar35 = ( uVar35 >> 2 & 0x3333333333333333 ) + ( uVar35 & 0x3333333333333333 );
                     bVar8 = ( byte )(( uVar36 + ( uVar36 >> 4 ) & 0xf0f0f0f0f0f0f0f ) * 0x101010101010101 >> 0x38);
                     bVar9 = ( byte )(( uVar32 + ( uVar32 >> 4 ) & 0xf0f0f0f0f0f0f0f ) * 0x101010101010101 >> 0x38);
                     bVar10 = ( byte )(( uVar35 + ( uVar35 >> 4 ) & 0xf0f0f0f0f0f0f0f ) * 0x101010101010101 >> 0x38);
                     uVar58 = (uint)bVar9 + (uint)bVar10;
                     if ((uint)bVar40 + (uint)bVar8 <= (uint)bVar9 + (uint)bVar10) {
                        uVar58 = (uint)bVar40 + (uint)bVar8;
                     }

                     bVar11 = ( byte )(( uVar31 + ( uVar31 >> 4 ) & 0xf0f0f0f0f0f0f0f ) * 0x101010101010101 >> 0x38);
                     ...
                     bVar11 = ( byte )(( uVar34 + ( uVar34 >> 4 ) & 0xf0f0f0f0f0f0f0f ) * 0x101010101010101 >> 0x38);
                     uVar56 = (uint)bVar40 + (uint)bVar11;
                     uVar64 = ( uint )(byte)(( uVar30 + ( uVar30 >> 4 ) & 0xf0f0f0f0f0f0f0f ) * 0x101010101010101 >> 0x38);
                     ...
                     uVar56 = bVar8 + uVar64;
                     bVar40 = ( byte )(( uVar28 + ( uVar28 >> 4 ) & 0xf0f0f0f0f0f0f0f ) * 0x101010101010101 >> 0x38);
                     ...
                     bVar7 = ( byte )(( uVar29 + ( uVar29 >> 4 ) & 0xf0f0f0f0f0f0f0f ) * 0x101010101010101 >> 0x38);
                     uVar57 = uVar53 + bVar7;
                     uVar48 = uVar56 + bVar7;
                     bVar8 = ( byte )(( uVar27 + ( uVar27 >> 4 ) & 0xf0f0f0f0f0f0f0f ) * 0x101010101010101 >> 0x38);
                     ...
                     uVar57 = uVar57 + ( byte )(( uVar22 + ( uVar22 >> 4 ) & 0xf0f0f0f0f0f0f0f ) * 0x101010101010101 >> 0x38);
                     uVar64 = uVar45 + local_12e8;
                     if (uVar48 <= uVar45 + local_12e8) {
                        uVar64 = uVar48;
                     }

                     uVar49 = ( uint )(byte)(( uVar26 + ( uVar26 >> 4 ) & 0xf0f0f0f0f0f0f0f ) * 0x101010101010101 >> 0x38);
                     uVar48 = uVar58 + uVar49;
                     if (uVar64 <= uVar58 + uVar49) {
                        uVar48 = uVar64;
                     }

                     uVar48 = uVar48 + ( byte )(( uVar23 + ( uVar23 >> 4 ) & 0xf0f0f0f0f0f0f0f ) * 0x101010101010101 >> 0x38);
                     if (uVar57 <= uVar48) {
                        uVar48 = uVar57;
                     }
                     ...
                     uVar45 = uVar45 + ( byte )(( uVar24 + ( uVar24 >> 4 ) & 0xf0f0f0f0f0f0f0f ) * 0x101010101010101 >> 0x38);
                     local_12e8 = (uint)bVar40;
                     if (uVar45 < uVar48) {
                        uVar48 = uVar45;
                     }
                     ...
                     uVar56 = uVar56 + ( byte )(( uVar25 + ( uVar25 >> 4 ) & 0xf0f0f0f0f0f0f0f ) * 0x101010101010101 >> 0x38);
                     if (uVar56 < uVar48) {
                        uVar48 = uVar56;
                     }
 ...
 while ( (partition_lines3*)( (long)&local_f68 + ( ulong )((byte)bVar19 - 1) * 2 + 2 ) != ppVar37 );
               uVar34 = 0;
               do {
 ...
 while ( uVar44 != uVar34 );
               ...
               auVar72._0_4_ = -(uint)(*(float *)(param_2 + 0xdd0) == *(float *)(param_2 + 0xdf0)) & __LC13;
               auVar72._4_4_ = -(uint)(*(float *)(param_2 + 0xdd4) == *(float *)(param_2 + 0xdf4)) & _UNK_00101984;
               auVar72._8_4_ = -(uint)(*(float *)(param_2 + 0xdd8) == *(float *)(param_2 + 0xdf8)) & _UNK_00101988;
               auVar72._12_4_ = -(uint)(*(float *)(param_2 + 0xddc) == *(float *)(param_2 + 0xdfc)) & _UNK_0010198c;
               iVar20 = movmskps((int)local_448, auVar72);
               uVar44 = (uint)uVar34;
               if (uVar44 == 0) {
                  if (iVar20 == 0) goto LAB_00100cf5;
                  LAB_0010146f:pfVar46 = (float*)( (long)pfVar66 + uVar35 * 2 );
                  uVar58 = 5;
                  if (uVar59 != 1) {
                     uVar58 = uVar59;
                  }
                  ...
                  do {
                     ...
                     ppVar51 = (partition_info*)( param_1 + ( (ulong)uVar6 + ( ulong )(( uVar58 - 2 ) * 0x400) ) * 0x450 + 0xacb560 );
                     ...
                     do {
                        ...
                        *(undefined8*)( ppVar37 + 8 ) = uVar14;
                        auVar75._0_4_ = auVar72._0_4_ * auVar72._0_4_ + auVar72._8_4_ * auVar72._8_4_ + auVar72._4_4_ * auVar72._4_4_ + auVar72._12_4_ * auVar72._12_4_;
                        auVar73 = __LC5;
                        ...
                        *(undefined1(*) [16])( ppVar37 + 0x20 ) = (undefined1[16])0x0;
                        auVar76._0_4_ = auVar72._0_4_ * auVar72._0_4_ + auVar72._8_4_ * auVar72._8_4_ + auVar72._4_4_ * auVar72._4_4_ + auVar72._12_4_ * auVar72._12_4_;
                        auVar77 = __LC5;
                        ...
                        *(undefined1(*) [16])( ppVar37 + 0x70 ) = auVar77;
                        fVar69 = *(float*)ppVar37 * auVar73._0_4_ + *(float*)( ppVar37 + 4 ) * auVar73._4_4_ + *(float*)( ppVar37 + 8 ) * auVar73._8_4_;
 ...
 while ( (processed_line4*)&local_fe8 + (ulong)uVar59 * 0x20 != ppVar62 );
                     local_1200 = 0.0;
                     local_11fc = 0.0;
                     compute_error_squared_rgb(ppVar51, param_2, (partition_lines3*)&local_f68, &local_1200, &local_11fc);
                     ...
                     do {
                        ...
                        local_1200 = local_1200 + *(float*)( ppVar37 + 0x18 ) * fVar69 * *(float*)( ppVar37 + 0x18 ) * fVar69 * fVar70 + *(float*)( ppVar37 + 0x10 ) * fVar69 * *(float*)( ppVar37 + 0x10 ) * fVar69 * fVar70 + *(float*)( ppVar37 + 0x14 ) * fVar69 * *(float*)( ppVar37 + 0x14 ) * fVar69 * fVar70;
                        local_11fc = local_11fc + fVar69 * *(float*)( ppVar37 + 0x38 ) * fVar69 * *(float*)( ppVar37 + 0x38 ) * fVar70 + fVar69 * *(float*)( ppVar37 + 0x30 ) * fVar69 * *(float*)( ppVar37 + 0x30 ) * fVar70 + fVar69 * *(float*)( ppVar37 + 0x34 ) * fVar69 * *(float*)( ppVar37 + 0x34 ) * fVar70;
                        ppVar37 = ppVar37 + 0x90;
                     }
 ...
 while ( uVar34 << 2 != lVar55 );
                  ...
                  LAB_00100cf5:pfVar46 = (float*)( (long)pfVar66 + uVar35 * 2 );
                  uVar58 = 5;
                  if (uVar59 != 1) {
                     uVar58 = uVar59;
                  }
                  ...
                  do {
                     ...
                     do {
                        ...
                        *(undefined8*)( pfVar47 + 2 ) = uVar14;
                        auVar77._0_4_ = auVar72._0_4_ * auVar72._0_4_ + auVar72._8_4_ * auVar72._8_4_ + auVar72._4_4_ * auVar72._4_4_ + auVar72._12_4_ * auVar72._12_4_;
                        auVar73 = __LC3;
                        ...
                        *(undefined1(*) [16])( ppVar62 + 0x10 ) = auVar73;
                        fVar71 = fVar69 * auVar73._0_4_ + fVar81 * auVar73._8_4_ + fVar70 * auVar73._4_4_ + fVar71 * auVar73._12_4_;
                        fVar69 = pfVar47[1];
                        fVar70 = pfVar47[2];
                        fVar81 = pfVar47[3];
                        ...
                        *(float*)( ppVar62 + 0xc ) = fVar81 - fVar71 * auVar73._12_4_;
                        ...
                        auVar74._0_4_ = auVar72._8_4_ * auVar72._8_4_ + auVar72._0_4_ * auVar72._0_4_ + auVar72._12_4_ * auVar72._12_4_ + auVar72._4_4_ * auVar72._4_4_;
                        auVar73 = __LC3;
 ...
 while ( local_1168 + (ulong)uVar59 * 0x20 != ppVar38 );
                     local_1200 = 0.0;
                     local_11fc = 0.0;
                     compute_error_squared_rgba(ppVar51, param_2, (processed_line4*)&local_fe8, (processed_line4*)&local_f68, local_11f8, &local_1200, &local_11fc);
                     uVar35 = 0;
                     lVar55 = 0x10;
                     do {
                        ...
                        lVar18 = lVar55 + 0xc;
                        lVar55 = lVar55 + 0x20;
                        local_1200 = local_1200 + fVar70 * fVar70 * fVar85 + fVar71 * fVar71 * fVar85 + fVar81 * fVar81 * fVar85 + fVar82 * fVar82 * fVar85;
                        local_11fc = local_11fc + fVar69 * *pfVar47 * fVar69 * *pfVar47 * fVar85 + fVar69 * *(float*)( local_1068 + lVar17 ) * fVar69 * *(float*)( local_1068 + lVar17 ) * fVar85 + fVar69 * *(float*)( local_1068 + lVar16 ) * fVar69 * *(float*)( local_1068 + lVar16 ) * fVar85 + fVar69 * *(float*)( local_1068 + lVar18 ) * fVar69 * *(float*)( local_1068 + lVar18 ) * fVar85;
                     }
 while ( uVar59 != uVar35 );
                     pfVar66 = (float*)( (long)pfVar66 + 2 );
 ...
 while ( pfVar46 != pfVar66 );
               ...
               if (uVar44 != 0) {
                  ...
                  do {
                     *(uint*)( (processed_line4*)&local_fe8 + lVar55 * 2 ) = ( uint ) * (ushort*)( param_1 + ( *(uint*)( (long)local_11c8 + lVar55 ) + uVar35 ) * 0x450 + 0xacb562 );
                     *(uint*)( (long)&local_fe8 + lVar55 * 2 + 4 ) = ( uint ) * (ushort*)( param_1 + ( *(uint*)( (long)local_1188 + lVar55 ) + uVar35 ) * 0x450 + 0xacb562 );
                     lVar55 = lVar55 + 4;
                  }
 while ( uVar34 << 2 != lVar55 );
                  ppVar37 = (partition_lines3*)&local_f68;
...
;
 ...
 while ( true );
      ...
      do {
         ...
         fVar79 = *(float*)( piVar50 + 0x6e0 ) - fVar70;
         fVar80 = *(float*)( piVar50 + 0xa50 ) - fVar69;
         fVar68 = fVar79 * fVar79 * fVar12 + fVar68 * fVar68 * fVar82 + fVar80 * fVar80 * fVar13 + fVar78 * fVar78 * fVar85;
         if (*pfVar46 <= fVar68) {
            fVar68 = *pfVar46;
         }

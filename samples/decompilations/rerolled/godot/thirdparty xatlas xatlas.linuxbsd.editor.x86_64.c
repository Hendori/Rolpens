/* xatlas::internal::nextPowerOfTwo(unsigned int) */int xatlas::internal::nextPowerOfTwo(uint param_1) {
   uint uVar1;
...
/* void xatlas::internal::insertionSort<unsigned int>(unsigned int*, unsigned int) */void xatlas::internal::insertionSort<unsigned_int>(uint *param_1, uint param_2) {
   uint uVar1;
   ulong uVar2;
   uint *puVar3;
   ulong uVar4;
...
/* xatlas::internal::Realloc(void*, unsigned long, int, char const*, int) [clone .part.0] */void xatlas::internal::Realloc(void *param_1, ulong param_2, int param_3, char *param_4, int param_5) {
   ( *(code*)s_realloc )();
   return;
}
/* xatlas::internal::RadixSort::radixSort(xatlas::internal::ConstArrayView<unsigned int>) [clone
   .isra.0] */void xatlas::internal::RadixSort::radixSort(long *param_1, byte *param_2, uint param_3) {
   long lVar1;
   byte bVar2;
   int iVar3;
   int *piVar4;
 ...
 while ( uVar16 != uVar12 );
   ...
   LAB_00100230:*(undefined1*)( param_1 + 8 ) = 1;
   LAB_00100235:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* xatlas::internal::cross(xatlas::internal::Vector3 const&, xatlas::internal::Vector3 const&)
   [clone .isra.0] */undefined8 xatlas::internal::cross(Vector3 *param_1, Vector3 *param_2) {
   float in_XMM0_Da;
   float in_XMM1_Da;
   float in_XMM2_Da;
   float in_XMM3_Da;
   float in_XMM4_Da;
   float in_XMM5_Da;
   return CONCAT44(in_XMM2_Da * in_XMM3_Da - in_XMM5_Da * in_XMM0_Da, in_XMM1_Da * in_XMM5_Da - in_XMM4_Da * in_XMM2_Da);
}
/* xatlas::internal::linesIntersect(xatlas::internal::Vector2 const&, xatlas::internal::Vector2
   ...
   .isra.0] */bool xatlas::internal::linesIntersect(Vector2 *param_1, Vector2 *param_2, Vector2 *param_3, Vector2 *param_4, float param_5) {
   float in_XMM1_Da;
   float in_XMM2_Da;
   float fVar1;
   float in_XMM3_Da;
   ...
   fVar3 = ( in_XMM2_Da - param_5 ) * ( in_XMM7_Da - in_XMM5_Da ) - ( in_XMM6_Da - in_XMM4_Da ) * ( in_XMM3_Da - in_XMM1_Da );
   ...
   if (fVar1 < fVar2) {
      fVar1 = ( ( in_XMM2_Da - param_5 ) * ( in_XMM1_Da - in_XMM5_Da ) - ( in_XMM3_Da - in_XMM1_Da ) * ( param_5 - in_XMM4_Da ) ) / fVar3;
      if (( ( in_stack_00000008 < fVar1 ) && ( fVar1 < _LC4 - in_stack_00000008 ) ) && ( fVar3 = ( ( in_XMM6_Da - in_XMM4_Da ) * ( in_XMM1_Da - in_XMM5_Da ) - ( in_XMM7_Da - in_XMM5_Da ) * ( param_5 - in_XMM4_Da ) ) / fVar3 ),in_stack_00000008 < fVar3) {
...
/* xatlas::internal::equal(xatlas::internal::Vector2 const&, xatlas::internal::Vector2 const&,
   float) [clone .isra.0] */bool xatlas::internal::equal(Vector2 *param_1, Vector2 *param_2, float param_3) {
   float fVar1;
   float in_XMM1_Da;
   float in_XMM2_Da;
   float in_XMM3_Da;
...
/* xatlas::internal::TaskScheduler::wait(xatlas::internal::TaskGroupHandle*) [clone .isra.0] */ulong xatlas::internal::TaskScheduler::wait(TaskScheduler *this, TaskGroupHandle *param_1) {
...
;
   ...
   LAB_001004c5:while (*(int*)( pTVar2 + 0x28 ) != 0) {
      sched_yield();
   }
;
   LOCK();
...
/* xatlas::internal::Realloc(void*, unsigned long, int, char const*, int) [clone .constprop.0] */undefined8 xatlas::internal::Realloc(void *param_1, ulong param_2, int param_3, char *param_4, int param_5) {
   undefined8 uVar1;
...
/* xatlas::internal::normalize(xatlas::internal::Vector3 const&) [clone .isra.0] */undefined8 xatlas::internal::normalize(Vector3 *param_1) {
   float in_XMM0_Da;
   float in_XMM1_Da;
   float in_XMM2_Da;
   float fVar1;
...
/* xatlas::internal::param::PiecewiseParam::orthoProjectFace(unsigned int,
   xatlas::internal::Vector2*) const [clone .isra.0] */void xatlas::internal::param::PiecewiseParam::orthoProjectFace(uint param_1, Vector2 *param_2) {
   float *pfVar1;
   Vector3 *pVVar2;
   undefined8 *puVar3;
   long lVar4;
   ...
   fVar15 = ( *(float*)pVVar2 - fVar17 ) * ( pfVar1[1] - fVar10 ) - ( *(float*)( pVVar2 + 4 ) - fVar10 ) * ( *pfVar1 - fVar17 );
   fVar14 = ( *(float*)( pVVar2 + 8 ) - fVar11 ) * ( *pfVar1 - fVar17 ) - ( *(float*)pVVar2 - fVar17 ) * ( pfVar1[2] - fVar11 );
   fVar12 = ( *(float*)( pVVar2 + 4 ) - fVar10 ) * ( pfVar1[2] - fVar11 ) - ( *(float*)( pVVar2 + 8 ) - fVar11 ) * ( pfVar1[1] - fVar10 );
   ...
   *extraout_RDX = CONCAT44(fVar8 * fVar17 + fVar18 * fVar10 + fVar14 * fVar11, fVar13 * fVar10 + fVar12 * fVar17 + extraout_XMM1_Da * fVar11);
   lVar4 = 1;
   while (puVar3 = (undefined8*)( lVar6 + ( ulong ) * (uint*)( lVar5 + ( ulong )(uVar7 + (int)lVar4) * 4 ) * 0xc ),uVar9 = *puVar3,fVar17 = *(float*)( puVar3 + 1 ),fVar10 = (float)uVar9,fVar11 = (float)( (ulong)uVar9 >> 0x20 ),extraout_RDX[lVar4] = CONCAT44(fVar11 * fVar18 + fVar10 * fVar8 + fVar17 * fVar14, fVar11 * fVar13 + fVar10 * fVar12 + fVar17 * extraout_XMM1_Da),lVar4 == 1) {
      lVar4 = 2;
   }
;
   return;
}
/* xatlas::DestroyOutputMeshes(xatlas::Context*) [clone .part.0] */void xatlas::DestroyOutputMeshes(Context *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   int in_EDX;
...
;
 ...
 while ( (uint)lVar5 < *(uint*)( plVar1 + 3 ) );
               LAB_0010089d:if (lVar2 == 0) goto LAB_001007f0;
            }
...
/* xatlas::internal::Fit::computeLeastSquaresNormal(xatlas::internal::ConstArrayView<xatlas::internal::Vector3>,
   xatlas::internal::Vector3*) [clone .isra.0] */undefined8 xatlas::internal::Fit::computeLeastSquaresNormal(Fit *this, ulong param_2, undefined8 *param_3) {
   uint uVar1;
   float fVar2;
   Fit *pFVar3;
   Fit *pFVar4;
 ...
 while ( this + ( param_2 & 0xffffffff ) * 0xc != pFVar6 );
   ...
   fVar16 = fVar14 * fVar14;
   LAB_00100a9d:fVar21 = SQRT(fVar21 + fVar16 + fVar13 * fVar13);
...
/* xatlas::internal::RadixSort::sort(xatlas::internal::ConstArrayView<float>) [clone .isra.0] */void xatlas::internal::RadixSort::sort(undefined8 *param_1, uint *param_2, uint param_3) {
   float fVar1;
   uint uVar2;
   ulong uVar3;
   uint *puVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* xatlas::internal::BoundingBox2D::compute(xatlas::internal::ConstArrayView<xatlas::internal::Vector2>)
   [clone .isra.0] */void xatlas::internal::BoundingBox2D::compute(undefined8 *param_1, float *param_2, uint param_3, char *param_4, undefined8 param_5) {
   uchar *puVar1;
   float fVar2;
   uint uVar3;
   undefined8 uVar4;
 ...
 while ( uVar7 != uVar18 );
   ...
   fVar28 = fVar21;
   if (( fVar21 <= fVar34 ) && ( fVar28 = fVar21 < fVar34 )) {
      fVar34 = fVar21;
   }
   ...
   *(undefined4*)( (long)param_1 + 0x8c ) = 0;
   ...
   if (*(uint*)( (long)param_1 + 0x5c ) < 3) {
      ...
      do {
         ...
         fVar34 = ( ( *pfVar12 - (float)local_48 ) * ( pfVar9[1] - local_48._4_4_ ) - ( pfVar12[1] - local_48._4_4_ ) * ( *pfVar9 - (float)local_48 ) ) * fVar21;
         local_48 = uVar4;
         if (fVar34 < _LC12) {
            if (_LC12 <= fVar34) goto LAB_00101180;
            LAB_00101061:uVar30 = uVar30 + 1;
            *(uint*)( (long)param_1 + 0x8c ) = uVar30;
            if (*(uint*)( param_1 + 0x12 ) < uVar30) {
               uVar33 = uVar30;
               if (( *(uint*)( param_1 + 0x12 ) == 0 ) || ( uVar33 = uVar33 != 0 )) {
                  pvVar8 = (void*)Realloc(pvVar8, ( ulong )(uVar33 * *(int*)( param_1 + 0x11 )), (int)lVar14, param_4, (int)param_5);
               ...
               *(undefined4*)( param_1 + 0x12 ) = 0;
               ...
               LAB_001010a6:if (pvVar8 != (void*)0x0) {
                  memcpy((void*)( (long)pvVar8 + ( ulong )(( uVar30 - 1 ) * *(uint*)( param_1 + 0x11 )) ), &local_48, ( ulong ) * (uint*)( param_1 + 0x11 ));
                  uVar30 = *(uint*)( (long)param_1 + 0x8c );
               }
   ...
   if (*(uint*)( (long)param_1 + 0x74 ) < 3) {
      ...
      do {
         ...
         if (fVar34 < _LC12) {
            ...
            LAB_00101239:uVar13 = *(uint*)( param_1 + 0x12 );
            uVar3 = uVar32 + 1;
            *(uint*)( (long)param_1 + 0x8c ) = uVar3;
            if (uVar13 < uVar3) {
               uVar16 = uVar3;
               if (( uVar13 == 0 ) || ( uVar13 = ( uVar3 >> 2 ) + uVar3 ),uVar16 = uVar13,uVar13 != 0) {
                  pvVar8 = (void*)Realloc(pvVar8, ( ulong )(uVar16 * *(int*)( param_1 + 0x11 )), uVar13, pcVar11, (int)param_5);
               ...
               LAB_0010127d:uVar13 = uVar32;
               if (pvVar8 != (void*)0x0) {
                  memcpy((void*)( (long)pvVar8 + ( ulong )(uVar32 * *(uint*)( param_1 + 0x11 )) ), &local_48, ( ulong ) * (uint*)( param_1 + 0x11 ));
                  uVar3 = *(uint*)( (long)param_1 + 0x8c );
                  uVar13 = *(uint*)( (long)param_1 + 0x8c ) - 1;
               }
            ...
            *(uint*)( (long)param_1 + 0x8c ) = uVar3;
            ...
            LAB_00101352:cVar6 = (char)uVar32 + -1;
            if (uVar30 == uVar32) {
               pvVar8 = (void*)param_1[0x10];
               goto LAB_00101239;
            }
 ...
 while ( uVar33 < *(uint*)( (long)param_1 + 0x74 ) );
   ...
   if (uVar18 == 0) {
      ...
      *(undefined1(*) [16])( param_1 + 2 ) = (undefined1[16])0x0;
      LAB_00101682:if (( iVar19 + 0x80800000U < 2 ) || ( (int)fVar21 + 0x80800000U < 2 )) goto LAB_00101600;
   }
 else {
      ...
      do {
         while (true) {
            ...
            fVar22 = (float)uVar23;
            if (cVar6 == '\0') break;
            LAB_00101448:pVVar15 = (Vector2*)( extraout_RDX_00 + 8 );
            fVar34 = fVar40;
            fVar41 = fVar2;
...
;
 ...
 while ( pVVar15 != pVVar17 );
      LAB_00101590:*param_1 = CONCAT44(fVar28, fVar22);
      param_1[1] = CONCAT44(fVar22, uVar30 ^ (uint)fVar28);
      iVar19 = (int)pVVar20;
      param_1[2] = CONCAT44(fVar21, iVar19);
      param_1[3] = CONCAT44(fVar26, fVar24);
      if (( ( 1 < (int)fVar22 + 0x80800000U ) && ( 1 < (int)fVar28 + 0x80800000U ) ) && ( 1 < ( uVar30 ^ (uint)fVar28 ) + 0x80800000 )) goto LAB_00101682;
      LAB_00101600:if (s_print != (undefined*)0x0) {
         if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            ( *(code*)s_print )("\rASSERT: %s %s %d\n", "isFinite(majorAxis) && isFinite(minorAxis) && isFinite(minCorner)", "thirdparty/xatlas/xatlas.cpp", 0x8ed);
            return;
         }
   ...
   LAB_00101720:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* xatlas::internal::Fit::computeEigen(xatlas::internal::ConstArrayView<xatlas::internal::Vector3>,
   xatlas::internal::Basis*) [clone .isra.0] */ulong xatlas::internal::Fit::computeEigen(Fit *this, uint param_2, undefined8 *param_3) {
   uint uVar1;
   Fit *pFVar2;
   Fit *pFVar3;
   Vector3 *pVVar4;
   ...
   if (param_2 == 0) {
      ...
      LAB_0010186e:if (( fStack_8c != 0.0 ) || ( fStack_84 != 0.0 )) goto LAB_00101888;
   }
 else {
      uVar6 = (ulong)param_2;
      fVar9 = 0.0;
 ...
 while ( pFVar3 != this + uVar6 * 0xc );
      ...
      LAB_00101888:if (__LC27 <= (float)( (uint)fStack_90 & _LC37 )) {
 ...
 while ( local_24 != pVVar5 );
   ...
   uVar6 = 0;
   LAB_00101a74:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* xatlas::runAddMeshTask(void*, void*) */ulong xatlas::runAddMeshTask(void *param_1, void *param_2) {
   byte bVar1;
   uint uVar2;
   byte *pbVar3;
   uint uVar4;
         ...
         *(int*)( pbVar3 + 0x18 ) = *(int*)( pbVar3 + 0x18 ) + 1;
         ...
         if (*(long*)( pbVar3 + 8 ) != 0) {
            ...
            if ((float)( (uint)fVar8 & _LC37 ) < _LC36) {
               fVar8 = (float)( ( uint )((float)(int)fVar8 + (float)( -(uint)((float)(int)fVar8 < fVar8) & _LC4 )) | ~_LC37 & (uint)fVar8 );
            }
 ...
 while ( !bVar7 );
               uVar6 = ( **(code**)( pbVar3 + 8 ) )(*(undefined4*)( pbVar3 + 4 ), *(undefined4*)( pbVar3 + 0x20 ), *(undefined8*)( pbVar3 + 0x10 ));
               if ((char)uVar6 == '\0') {
                  LOCK();
                  bVar1 = *pbVar3;
                  *pbVar3 = 1;
...
/* xatlas::internal::UniformGrid2::intersect(float, xatlas::internal::ConstArrayView<unsigned int>,
   xatlas::internal::ConstArrayView<unsigned int>) [clone .isra.0] */undefined8 xatlas::internal::UniformGrid2::intersect(UniformGrid2 *param_1, uint *param_2, uint param_3, uint *param_4, uint param_5) {
   float *pfVar1;
   Vector2 *pVVar2;
   float *pfVar3;
   undefined8 uVar4;
   ...
   if (uVar14 < 0x15) {
      ...
      if (param_3 == 0) {
         LAB_00101eaf:param_2 = puVar10;
         local_79 = 1;
         puVar10 = param_2;
         uVar14 = local_80;
         LAB_00101ebb:if (local_80 == 0) goto LAB_00101ec7;
      }
 else {
         local_79 = 1;
         local_80 = param_3;
 ...
 while ( puVar6 != param_4 + param_5 );
                  ...
                  if (( (uint)pVVar15 != uVar26 && ( (uint)uVar8 != uVar20 && uVar20 != uVar26 ) ) && ( (uint)pVVar15 != (uint)uVar8 )) {
                     ...
                     if (fVar31 <= fVar30) {
                        if (fVar23 <= fVar28) {
                           fVar29 = (float)( ~-(uint)(fVar31 < fVar30) & (uint)fVar31 | -(uint)(fVar31 < fVar30) & (uint)fVar30 );
                           fVar30 = fVar31;
                           goto LAB_00101f93;
                        }
                        ...
                        fVar31 = fVar30;
                        if (fVar23 <= fVar28) {
                           LAB_00101f93:bVar21 = fVar23 < fVar28;
                     ...
                     if (( ( ( fVar22 <= fVar23 ) && ( fVar28 <= fVar25 ) ) && ( fVar27 <= fVar29 ) ) && ( fVar31 <= fVar24 )) {
               ...
               LAB_00101e7f:pVVar11 = pVVar11 + 4;
            }
 while ( pVVar11 != pVVar18 );
         ...
         fVar31 = fVar24;
         if (fVar25 <= fVar22) {
            LAB_00101dcd:fVar30 = fVar25;
            fVar24 = fVar27;
            if (fVar25 < fVar22) goto LAB_00101dd7;
         }

         LAB_00101de3:fVar24 = fVar27;
         fVar22 = fVar30;
         fVar27 = fVar31;
         if (local_79 != 0) goto LAB_00101dee;
         LAB_0010209c:*(undefined4*)( param_1 + 0x8c ) = 0;
         traverse(param_1);
         ...
         if (*(int*)( param_1 + 0xa4 ) != 0) {
            lVar9 = 0;
            do {
               uVar12 = *(uint*)( *(long*)( param_1 + 0x50 ) + ( ulong ) * (uint*)( *(long*)( param_1 + 0x98 ) + lVar9 * 4 ) * 4 );
                  ...
                  do {
                     while (true) {
                        ...
                        *(uint*)( param_1 + 0x8c ) = uVar14;
                        ...
                        LAB_00102200:if (puVar10 != (uint*)0x0) {
                           memcpy((void*)( (long)puVar10 + ( ulong )(( uVar14 - 1 ) * *(uint*)( param_1 + 0x88 )) ), &local_44, ( ulong ) * (uint*)( param_1 + 0x88 ));
                           uVar14 = *(uint*)( param_1 + 0x8c );
                           puVar10 = *(uint**)( param_1 + 0x80 );
                        }
...
;
                     uVar16 = uVar14;
                     if (( *(uint*)( param_1 + 0x90 ) == 0 ) || ( uVar16 = uVar16 != 0 )) {
                        if (uVar16 * *(int*)( param_1 + 0x88 ) != 0) {
                           LAB_001022c8:puVar10 = (uint*)( *(code*)s_realloc )(puVar10, uVar16 * *(int*)( param_1 + 0x88 ));
 ...
 while ( bVar21 );
   LAB_00101ec7:uVar7 = 0;
   LAB_00101ec9:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar7;
   }
...
/* xatlas::Create() */undefined1(*)[16];xatlas::Create(void) {
   undefined8 uVar1;
...
/* xatlas::AddMesh(xatlas::Atlas*, xatlas::MeshDecl const&, unsigned int) */undefined8 xatlas::AddMesh(Atlas *param_1, MeshDecl *param_2, uint param_3) {
   float *pfVar1;
   float *pfVar2;
   byte bVar3;
   Progress *this;
      ...
      if (*(int*)( param_1 + 0xe4 ) == 0) {
         ...
         if (this == (Progress*)0x0) {
            ...
            *(undefined4*)( puVar20 + 0x20 ) = 0;
            if (( pcVar4 != (code*)0x0 ) && ( cVar11 = cVar11 == '\0' )) {
               LOCK();
               *puVar20 = 1;
               UNLOCK();
            }
         ...
         if (*(long*)( param_2 + 0x30 ) == 0) {
            if (( internal::s_print != (undefined*)0x0 ) && ( internal::s_printVerbose != '\0' )) {
               ( *(code*)internal::s_print )("Adding mesh %d: %u vertices, %u triangles\n", *(undefined4*)( param_1 + 0xb4 ), *(undefined4*)( param_2 + 0x38 ), (ulong)uVar39 / 3);
            }
            ...
            if (( internal::s_print != (undefined*)0x0 ) && ( internal::s_printVerbose != '\0' )) {
               ( *(code*)internal::s_print )("Adding mesh %d: %u vertices, %u polygons\n", *(undefined4*)( param_1 + 0xb4 ), *(undefined4*)( param_2 + 0x38 ));
            }
 ...
 while ( pbVar28 != pbVar14 );
         ...
         internal::Mesh::Mesh(pMVar15, *(float*)( param_2 + 0x58 ), *(uint*)( param_2 + 0x38 ), uVar39 / 3, uVar37, *(uint*)( param_1 + 0xb4 ));
         iVar38 = extraout_EDX;
         local_518 = pMVar15;
         if (*(int*)( param_2 + 0x38 ) != 0) {
            ...
            do {
               ...
               if (*(long*)( param_2 + 8 ) != 0) {
                  puVar16 = (undefined8*)( *(long*)( param_2 + 8 ) + ( ulong )(uVar39 * *(int*)( param_2 + 0x40 )) );
                  uVar31 = *puVar16;
               ...
               if (*(long*)( param_2 + 0x10 ) != 0) {
                  local_4e8 = *(Vector3**)( *(long*)( param_2 + 0x10 ) + ( ulong )(uVar39 * *(int*)( param_2 + 0x44 )) );
               }
 ...
 while ( uVar39 < *(uint*)( param_2 + 0x38 ) );
         ...
         uVar29 = _LC18;
         if (*(long*)( param_2 + 0x30 ) != 0) {
            pauVar17 = (undefined1(*) [16])internal::Realloc((void*)0x0, 0x48, iVar38, pcVar24, (int)pfVar35);
            uVar29 = _LC18;
         ...
         if (local_558 != 0) {
            local_560 = 0;
            uVar29 = 0;
            LAB_0010293d:if (*(long*)( param_2 + 0x30 ) == 0) {
               pVVar34 = (Vector3*)0x3;
               LAB_0010295c:pVVar32 = pVVar34;
               pVVar18 = local_448;
 ...
 while ( pVVar33 != pVVar18 );
                  ...
                  do {
                     if (*(int*)( param_2 + 0x54 ) == 0) {
                        pcVar24 = (char*)( ( ulong )(( uint ) * (ushort*)( (long)pfVar35 + (ulong)(uint)fVar25 * 2 ) + iVar38) & 0xffff );
                        *(float*)pVVar18 = SUB84(pcVar24, 0);
                        if (( uint ) * (float*)( param_2 + 0x38 ) <= (uint)SUB84(pcVar24, 0)) {
                           LAB_001029cf:uVar31 = 2;
 ...
 while ( pVVar33 != pVVar18 );
            ...
            do {
               ...
               uVar26 = *(uint*)( local_448 + ( ulong )(uint)((int)pVVar18 + (int)( ( (ulong)pVVar18 & 0xffffffff ) / 3 ) * -3) * 4 );
               if (uVar37 == uVar26) {
                  if (( ( local_560 + 1 < 0x33 ) && ( internal::s_print != (undefined*)0x0 ) ) && ( internal::s_printVerbose != '\0' )) {
 ...
 while ( 0.0 < SQRT(fVar43 * fVar43 + fVar51 * fVar51 + fVar45 * fVar45) );
            if (( ( local_560 + 1 < 0x33 ) && ( pfVar35 = (float*)internal::s_print ),internal::s_print != (undefined*)0x0 )) &&( internal::s_printVerbose != '\0' )(*(code*)internal::s_print)((double)*pfVar2, (double)pfVar2[1], (double)pfVar2[2], (double)fVar25, (double)*pfVar30, (double)*pfVar1, "   Zero length edge: index %d position (%g %g %g), index %d position (%g %g %g)\n", pVVar33, uVar26);
         }

         LAB_00102c08:local_560 = local_560 + 1;
         local_559 = 1;
         goto LAB_00102c0d;
      }
   ...
   if (internal::s_print != (undefined*)0x0) {
      ( *(code*)internal::s_print )("AddMesh: Meshes and UV meshes cannot be added to the same atlas.\n");
   }

}
uVar31 = 1;goto LAB_00102a18;while (true) {
   if (( *(long*)( param_2 + 0x10 ) != 0 ) && ( ( pfVar30 = (float*)( *(long*)( local_518 + 0x88 ) + (long)pfVar35 * 8 ) ),NAN(*pfVar30) || ( NAN(pfVar30[1]) ) )) {
      if (( local_560 + 1 < 0x33 ) && ( ( internal::s_print != (undefined*)0x0 && ( internal::s_printVerbose != '\0' ) ) )) {
   ...
   LAB_00102bda:pfVar35 = (float*)( ulong ) * (uint*)pVVar18;
   pVVar33 = (Vector3*)( lVar19 + (long)pfVar35 * 0xc );
   if (( ( NAN(*(float*)pVVar33) ) || ( NAN(*(float*)( pVVar33 + 4 )) ) ) || ( NAN(*(float*)( pVVar33 + 8 )) )) {
      if (( ( local_560 + 1 < 0x33 ) && ( internal::s_print != (undefined*)0x0 ) ) && ( internal::s_printVerbose != '\0' )) {
         pVVar33 = (Vector3*)(ulong)local_51c;
   ...
   if (( *(long*)( param_2 + 8 ) != 0 ) && ( ( ( pfVar30 = (float*)( (long)pfVar35 * 0xc + *(long*)( local_518 + 0x70 ) ) ),NAN(*pfVar30) || ( NAN(pfVar30[1]) ) ) || ( NAN(pfVar30[2]) ) )) {
      if (( ( local_560 + 1 < 0x33 ) && ( internal::s_print != (undefined*)0x0 ) ) && ( internal::s_printVerbose != '\0' )) {
         pVVar33 = (Vector3*)(ulong)local_51c;
...
;local_559 = 0;LAB_00102c0d:local_4e0 = local_4e0 & 0xffffffff;if (uVar39 == 3) {
   ...
   fVar25 = _LC11;
   fVar43 = _LC19;
   joined_r0x0010390f:_LC11 = fVar25;
   _LC19 = fVar43;
   if (( local_559 == 0 ) && ( uVar39 != 0 )) {
      ...
      do {
         ...
         lVar23 = internal::cross((Vector3*)( lVar19 + ( ulong ) * (uint*)( pVVar33 + ( ulong )((int)lVar23 + 2) * 4 ) * 0xc ), pVVar33);
         local_4c8 = (float)extraout_XMM0_Qa;
         fStack_4c4 = (float)( (ulong)extraout_XMM0_Qa >> 0x20 );
         fVar45 = SQRT(local_4c8 * local_4c8 + fStack_4c4 * fStack_4c4 + extraout_XMM1_Da * extraout_XMM1_Da) * fVar25;
         fStack_4c0 = extraout_XMM1_Da;
         if (fVar45 <= fVar43) {
            local_560 = local_560 + 1;
            if (( ( local_560 < 0x33 ) && ( internal::s_print != (undefined*)0x0 ) ) && ( internal::s_printVerbose != '\0' )) {
               pVVar33 = (Vector3*)(ulong)local_51c;
 ...
 while ( (uint)lVar23 < uVar39 );
   ...
   pVVar34 = local_4e8;
   if (( *(long*)( param_2 + 0x20 ) != 0 ) && ( bVar3 = *(byte*)( *(long*)( param_2 + 0x20 ) + (ulong)local_51c ) ),bVar3 != 0) {
      local_559 = bVar3;
   }
...
lVar19 = *(long*)( local_518 + 0x58 );local_490 = local_490 & 0xffffffff;if (local_488 < uVar39) {
   pVVar33 = pVVar34;
   internal::ArrayBase::setArrayCapacity((uint)local_548);
}
LAB_00102c58:fStack_4b8 = 0.0;fStack_4b4 = 0.0;local_4c8 = 0.0;fStack_4c4 = 0.0;fStack_4c0 = 0.0;fStack_4bc = 0.0;pVVar32 = (Vector3*)local_4b0;pcVar24 = (char*)( lVar19 + (ulong)local_440[0] * 0xc );auVar52 = internal::cross(pVVar32, pVVar33);local_4f8 = auVar52;auVar52 = internal::normalize(pVVar32);local_4b0[0] = auVar52;auVar53 = internal::Basis::computeTangent(pVVar32);local_4c8 = auVar53._0_4_;fStack_4c4 = auVar53._4_4_;fVar25 = local_4c8;fVar43 = fStack_4c4;fStack_4c0 = auVar53._8_4_;auVar52 = internal::cross(pVVar32, pVVar33);fVar45 = auVar52._8_4_;local_460 = local_460 & 0xffffffff;local_508._0_4_ = auVar52._0_4_;uVar13 = local_508._0_4_;local_508._4_4_ = auVar52._4_4_;uVar8 = local_508._4_4_;fStack_4bc = (float)local_508._0_4_;fStack_4b8 = (float)local_508._4_4_;fStack_4b4 = fVar45;_local_508 = auVar52;if (local_458 < uVar39) {
         ...
         do {
            ...
            do {
               while (true) {
                  ...
                  fVar47 = ( fVar44 * fVar47 + fVar49 * fVar50 ) / ( SQRT(fVar44 * fVar44 + fVar49 * fVar49) * SQRT(fVar47 * fVar47 + fVar50 * fVar50) );
                  fVar44 = _LC5;
                  if (( _LC5 < fVar47 ) && ( fVar44 = _LC4 <= fVar47 )) {
                     fVar44 = _LC4;
                  }
                  ...
                  pcVar9 = local_498;
                  fVar44 = _LC11;
                  if (( ( fVar25 - fVar46 ) * ( fVar51 - fVar48 ) - ( fVar43 - fVar48 ) * ( fVar45 - fVar46 ) ) * _LC11 < 0.0) {
                     fVar47 = _LC89 - fVar47;
                  }

                  *(float*)( lVar19 + uVar22 * 4 ) = fVar47;
                  if (( fVar47 < local_57c ) || ( !bVar6 )) break;
                  LAB_00103184:bVar6 = true;
                  fVar47 = local_57c;
                  uVar37 = local_56c;
                  LAB_0010318a:local_56c = uVar37;
                  local_57c = fVar47;
                  uVar41 = uVar41 + 1;
...
;
               ...
               do {
                  uVar26 = (uint)uVar22;
                  pcVar24 = (char*)CONCAT71(( int7 )((ulong)pcVar24 >> 8), uVar26 == uVar39 || uVar37 == uVar26);
                  if (( uVar26 != uVar39 && uVar37 != uVar26 ) && ( (uint)uVar5 != uVar26 )) {
                     fVar49 = *(float*)( (long)pvVar21 + uVar22 * 8 );
                     fVar50 = *(float*)( (long)pvVar21 + uVar22 * 8 + 4 );
                     if (_LC19 <= ( ( fVar25 - fVar49 ) * ( fVar51 - fVar50 ) - ( fVar43 - fVar50 ) * ( fVar45 - fVar49 ) ) * fVar44) {
                        if (( _LC19 <= ( ( fVar45 - fVar49 ) * ( fVar48 - fVar50 ) - ( fVar51 - fVar50 ) * ( fVar46 - fVar49 ) ) * fVar44 ) && ( _LC19 <= ( ( fVar43 - fVar50 ) * ( fVar46 - fVar49 ) - ( fVar25 - fVar49 ) * ( fVar48 - fVar50 ) ) * fVar44 )) {
 ...
 while ( uVar41 != uVar29 );
            LAB_001034aa:uVar37 = (int)uVar29 - 1;
            ...
            if ((uint)local_4d8 < uVar39) {
               if (( (uint)local_4d8 == 0 ) || ( uVar39 = uVar39 != 0 )) {
                  local_4e8 = (Vector3*)internal::Realloc(local_4e8, ( ulong )(uVar39 * (int)local_4e0), uVar39, pcVar24, (int)pfVar35);
               ...
               LAB_00103534:if (local_4e8 != (Vector3*)0x0) {
            ...
            if (pcVar9 != (char*)0x0) {
               ...
               memmove(pcVar9 + ( uVar39 - (int)local_490 ), pVVar34, ( ulong )(( uVar37 - iVar27 ) * (int)local_490));
            ...
            if (local_460._4_4_ < 2) {
               ...
               memmove((void*)( (long)pvVar21 + ( ulong )(uVar39 - (int)local_460) ), pVVar34, ( ulong )(uint)(( iVar38 - iVar27 ) * (int)local_460));
               LAB_0010385d:local_460 = CONCAT44(iVar38, (int)local_460);
            }
            ...
            if (local_478._4_4_ < 2) {
               ...
               memmove((void*)( lVar19 + ( ulong )(uVar39 - (int)local_478) ), pVVar34, ( ulong )(uint)(( iVar38 - iVar27 ) * (int)local_478));
            }
...
_local_508 = auVar52;internal::ArrayBase::setArrayCapacity(( uint ) & local_480);uVar37 = local_460._4_4_;LAB_00102e01:lVar23 = 0;local_5b8 = local_498;pvVar21 = local_468;uVar26 = local_490._4_4_;do {
   uVar10 = local_458;
   uVar40 = uVar26 + 1;
   ...
   if (local_488 < uVar40) {
      uVar36 = uVar40;
      if (( local_488 == 0 ) || ( uVar36 = uVar36 != 0 )) {
         local_5b8 = (char*)internal::Realloc(local_5b8, ( ulong )(uVar36 * (int)local_490), uVar26, pcVar24, (int)pfVar35);
         local_498 = local_5b8;
         local_488 = uVar36;
         goto LAB_00102f50;
      }
      ...
      LAB_00102f50:if (local_5b8 != (char*)0x0) {
   ...
   local_4f8._0_8_ = CONCAT44(fVar48 * (float)uVar8 + fVar46 * (float)uVar13 + fVar51 * fVar45, fVar48 * fVar43 + fVar46 * fVar25 + fVar51 * auVar53._8_4_);
   if (uVar10 < uVar36) {
      uVar42 = uVar36;
      if (( uVar10 == 0 ) || ( uVar26 = ( uVar36 >> 2 ) + uVar36 ),uVar42 = uVar26,uVar26 != 0) {
         pvVar21 = (void*)internal::Realloc(pvVar21, ( ulong )(uVar42 * (int)local_460), uVar26, pcVar24, (int)pfVar35);
         local_468 = pvVar21;
         local_458 = uVar42;
         goto LAB_00102fde;
      }
      ...
      LAB_00102fde:if (pvVar21 != (void*)0x0) {
 ...
 while ( true );code_r0x001036f2:if (( ( 0x32 < local_560 ) && ( internal::s_print != (undefined*)0x0 ) ) && ( internal::s_printVerbose != '\0' )) {
   ( *(code*)internal::s_print )("   %u additional warnings truncated\n", local_560 - 0x32);
}
LAB_00103728:internal::ArrayBase::push_back((uchar*)( param_1 + 0xa8 ));internal::ArrayBase::push_back((uchar*)( param_1 + 0xc0 ));local_4c8 = SUB84(local_518, 0);fStack_4c4 = (float)( (ulong)local_518 >> 0x20 );internal::ArrayBase::push_back((uchar*)( param_1 + 0x40 ));if (*(int*)( param_1 + 0x38 ) == -1) {
   uVar13 = internal::TaskScheduler::createTaskGroup(*(void**)( param_1 + 0xa0 ), (uint)param_1);
   *(undefined4*)( param_1 + 0x38 ) = uVar13;
}
uVar31 = 0;fStack_4c0 = SUB84(local_518, 0);fStack_4bc = (float)( (ulong)local_518 >> 0x20 );local_4c8 = 1.479256e-39;fStack_4c4 = 0.0;internal::TaskScheduler::run(*(undefined8*)( param_1 + 0xa0 ), *(undefined4*)( param_1 + 0x38 ), &local_4c8);LAB_001029f0:local_540 = (ArrayBase*)&local_468;local_550 = (ArrayBase*)&local_480;internal::ArrayBase::~ArrayBase(local_540);internal::ArrayBase::~ArrayBase(local_550);internal::ArrayBase::~ArrayBase(local_548);internal::ArrayBase::~ArrayBase(local_568);LAB_00102a18:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return uVar31;}/* xatlas::AddMeshJoin(xatlas::Atlas*) */void xatlas::AddMeshJoin(Atlas *param_1) {
   char cVar1;
   char *in_RCX;
   int extraout_EDX;
   int extraout_EDX_00;
   ...
   if (param_1 != (Atlas*)0x0) {
      if (( *(int*)( param_1 + 0xe4 ) == 0 ) && ( *(long*)( param_1 + 0x30 ) != 0 )) {
         internal::TaskScheduler::wait((TaskScheduler*)**(undefined8**)( param_1 + 0xa0 ), (TaskGroupHandle*)( param_1 + 0x38 ));
         puVar3 = *(undefined1**)( param_1 + 0x30 );
         iVar2 = extraout_EDX;
         if (*(code**)( puVar3 + 8 ) != (code*)0x0) {
            cVar1 = ( **(code**)( puVar3 + 8 ) )(*(undefined4*)( puVar3 + 4 ), 100, *(undefined8*)( puVar3 + 0x10 ));
            if (cVar1 == '\0') {
               LOCK();
               *puVar3 = 1;
               UNLOCK();
...
/* xatlas::Destroy(xatlas::Atlas*) */void xatlas::Destroy(Atlas *param_1) {
   long *plVar1;
   void *pvVar2;
   undefined8 *puVar3;
   char *in_RCX;
...
;
 ...
 while ( (uint)lVar9 < *(uint*)( param_1 + 0xfc ) );
   ...
   for (int i = 0; i < 4; i++) {
      internal::ArrayBase::~ArrayBase((ArrayBase*)( param_1 + ( -24*i + 240 ) ));
   }
...
/* xatlas::SetProgressCallback(xatlas::Atlas*, bool (*)(xatlas::ProgressCategory, int, void*),
   void*) */void xatlas::SetProgressCallback(Atlas *param_1, _func_bool_ProgressCategory_int_void_ptr *param_2, void *param_3) {
   if (param_1 == (Atlas*)0x0) {
      if (internal::s_print != (undefined*)0x0) {
...
/* xatlas::SetAlloc(void* (*)(void*, unsigned long), void (*)(void*)) */void xatlas::SetAlloc(_func_void_ptr_void_ptr_ulong *param_1, _func_void_void_ptr *param_2) {
   internal::s_realloc = param_1;
   internal::s_free = param_2;
   return;
}
/* xatlas::SetPrint(int (*)(char const*, ...), bool) */void xatlas::SetPrint(_func_int_char_ptr____ *param_1, bool param_2) {
   internal::s_print = param_1;
   internal::s_printVerbose = param_2;
   return;
}
/* xatlas::StringForEnum(xatlas::AddMeshError) */char *xatlas::StringForEnum(int param_1) {
   char *pcVar1;
   pcVar1 = "Unspecified error";
   if (( ( ( param_1 != 1 ) && ( pcVar1 = "Index out of range" ),param_1 != 2 ) ) && ( pcVar1 = param_1 != 3 )) {
      pcVar1 = "Success";
   }

   return pcVar1;
}
/* xatlas::StringForEnum(xatlas::ProgressCategory) */char *xatlas::StringForEnum(int param_1) {
   char *pcVar1;
   pcVar1 = "Adding mesh(es)";
   if (( ( ( param_1 != 0 ) && ( pcVar1 = "Computing charts" ),param_1 != 1 ) ) && ( pcVar1 = param_1 != 2 )) {
      pcVar1 = "";
   }

   return pcVar1;
}
/* xatlas::AddUvMesh(xatlas::Atlas*, xatlas::UvMeshDecl const&) */undefined8 xatlas::AddUvMesh(Atlas *param_1, UvMeshDecl *param_2) {
   float *pfVar1;
   float *pfVar2;
   float *pfVar3;
   uint *puVar4;
   ...
   if (param_1 == (Atlas*)0x0) {
      ...
      if (*(int*)( param_1 + 0xb4 ) == 0) {
         ...
         if (uVar20 == 0) {
            ...
            if (( internal::s_print == (undefined*)0x0 ) || ( uVar16 = uVar27 ),internal::s_printVerbose == '\0') {
               if (0x55555555 < uVar27 * -0x55555555) goto LAB_001045f8;
            }
 else {
               LAB_00104606:in_RCX = (long*)( (ulong)uVar27 / 3 );
               ( *(code*)internal::s_print )("Adding UV mesh %d: %u vertices, %u triangles\n", *(undefined4*)( param_1 + 0xe4 ), uVar16);
               if (uVar27 != ( uVar27 / 3 ) * 3) {
                  LAB_001045f8:uVar8 = 4;
                  goto LAB_001045b6;
               }
            ...
            if (internal::s_print == (undefined*)0x0) {
               ...
               if (0x55555555 < uVar20 * -0x55555555) goto LAB_001045f8;
               LAB_0010444c:if (uVar27 == 0) goto LAB_001044bb;
            }
            ...
            if (*(int*)( param_2 + 0x28 ) == 0) {
               lVar19 = 0;
               do {
                  if (*(uint*)( param_2 + 0x18 ) <= ( *(ushort*)( *(long*)( param_2 + 8 ) + lVar19 * 2 ) + uVar16 & 0xffff )) goto LAB_00104482;
                  lVar19 = lVar19 + 1;
               }
 while ( (uint)lVar19 < uVar27 );
               ...
               do {
                  if (*(uint*)( param_2 + 0x18 ) <= *(int*)( *(long*)( param_2 + 8 ) + lVar19 * 4 ) + uVar16) goto LAB_00104482;
                  lVar19 = lVar19 + 1;
               }
 while ( (uint)lVar19 < uVar27 );
            }
         ...
         LAB_001044bb:iVar22 = (int)puVar18;
         ...
         *pauVar9 = (undefined1[16])0x0;
         ...
         if (*(uint*)( param_1 + 0xe4 ) != 0) {
            ...
            do {
               ...
               if (( ( *in_RCX == *(long*)param_2 && uVar17 == 0 ) && ( uVar17 = in_RCX[3] ^ *(ulong*)( param_2 + 0x18 ) ),in_RCX[2] == *(long*)( param_2 + 0x10 ) && uVar17 == 0 )) {
                  puVar18 = internal::s_print;
                  if (( internal::s_print != (undefined*)0x0 ) && ( internal::s_printVerbose != '\0' )) {
 ...
 while ( puVar11 != puVar6 );
         ...
         *(undefined8*)( (long)in_RCX + 0x24 ) = uVar8;
         ...
         if (*(long*)( param_2 + 0x10 ) != 0) {
            ...
            memcpy((void*)in_RCX[10], *(void**)( param_2 + 0x10 ), ( ulong ) * (uint*)( (long)in_RCX + 0x5c ) << 2);
         }
 ...
 while ( uVar17 != uVar10 );
               ...
               while (true) {
                  if (*(int*)( param_2 + 0x28 ) == 0) {
                     *(uint*)( lVar19 + uVar10 * 4 ) = ( uint )(ushort)((short)*(int*)( param_2 + 0x24 ) + *(short*)( lVar7 + uVar10 * 2 ));
                  }
 else {
...
;
            ...
            do {
               ...
               do {
                  ...
                  if (( NAN(*pfVar1) ) || ( NAN(pfVar1[1]) )) {
                     if (( uVar20 + 1 < 0x33 ) && ( ( internal::s_print != (undefined*)0x0 && ( internal::s_printVerbose != '\0' ) ) )) {
 ...
 while ( puVar13 != local_40 );
               ...
               fVar25 = *pfVar1;
               fVar5 = pfVar1[1];
               fVar25 = (float)( ( uint )(( ( *pfVar2 - fVar25 ) * ( pfVar3[1] - fVar5 ) - ( *pfVar3 - fVar25 ) * ( pfVar2[1] - fVar5 ) ) * fVar28) & uVar27 );
               if (fVar25 <= fVar26) {
                  if (( ( uVar20 + 1 < 0x33 ) && ( internal::s_print != (undefined*)0x0 ) ) && ( internal::s_printVerbose != '\0' )) {
                     ( *(code*)internal::s_print )((double)fVar25, "   Zero area face: %d, indices (%d %d %d), area is %f\n", uVar23, local_4c & 0xffffffff, local_4c >> 0x20, (ulong)local_44);
                     fVar26 = _LC19;
                     uVar27 = _LC37;
                     fVar28 = _LC11;
                  }

                  LAB_001049b0:uVar20 = uVar20 + 1;
 ...
 while ( (uint)uVar10 < ( uint )(uVar17 / 3) );
            if (( ( 0x32 < uVar20 ) && ( internal::s_print != (undefined*)0x0 ) ) && ( internal::s_printVerbose != '\0' )) {
               ( *(code*)internal::s_print )("   %u additional warnings truncated\n", uVar20 - 0x32);
            }

         }

         LAB_00104594:*(long**)*pauVar9 = in_RCX;
         uVar8 = 0;
         goto LAB_001045b6;
      }

      if (internal::s_print != (undefined*)0x0) {
         ( *(code*)internal::s_print )("AddUvMesh: Meshes and UV meshes cannot be added to the same atlas.\n");
      }

   }

   uVar8 = 1;
   LAB_001045b6:if (local_40[0] == *(ulong*)( in_FS_OFFSET + 0x28 )) {
      return uVar8;
   }

   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   LAB_00104482:uVar8 = 2;
   goto LAB_001045b6;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* xatlas::PackCharts(xatlas::Atlas*, xatlas::PackOptions) */void xatlas::PackCharts(Context *param_1, undefined8 param_2, int param_3, char *param_4, undefined4 *param_5, undefined8 param_6, undefined8 param_7, float param_8, undefined8 param_9) {
   long lVar1;
   uint *puVar2;
   float *pfVar3;
   Context CVar4;
   ...
   if (*(int*)( param_1 + 0xb4 ) == 0) {
      ...
      LAB_00105552:CVar4 = param_1[0x108];
   }
 else {
   ...
   if (CVar4 == (Context)0x0) {
      ...
      *(undefined4*)( param_1 + 0x28 ) = 0;
      ...
      local_58 = 0;
      if (*(int*)( param_1 + 0xfc ) == 0) {
         internal::pack::Atlas::addCharts((Atlas*)&local_108, *(TaskScheduler**)( param_1 + 0xa0 ), (Atlas*)( param_1 + 0x40 ));
      }
 else {
         uVar34 = 0;
         do {
 ...
 while ( uVar34 < *(uint*)( param_1 + 0xfc ) );
      ...
      cVar12 = internal::pack::Atlas::packCharts((Atlas*)&local_108, (_func_bool_ProgressCategory_int_void_ptr*)&param_7, *(void**)( param_1 + 0x90 ));
      ...
      if (cVar12 != '\0') {
         ...
         *(undefined4*)( param_1 + 0x2c ) = local_58;
         if (local_d0._4_4_ != 0) {
            auVar46 = internal::Realloc((void*)0x0, (ulong)local_d0._4_4_ * 4, (int)extraout_RDX, pcVar28, (int)param_5);
            auVar45 = auVar46._0_12_;
 ...
 while ( (ulong)uVar34 << 2 != lVar19 );
         ...
         if (param_9._3_1_ != '\0') {
            puVar27 = (undefined4*)internal::Realloc((void*)0x0, ( ulong )(uint)(*(int*)( param_1 + 0x20 ) * *(int*)( param_1 + 0x18 ) * *(int*)( param_1 + 0x1c )) << 2, auVar45._8_4_, (char*)piVar29, (int)param_5);
            lVar26 = local_108;
               ...
               while (true) {
                  ...
                  if (iVar33 != 0) {
                     ...
                     do {
                        ...
                        iVar35 = iVar35 + 1;
                        memcpy(puVar27 + uVar24 + iVar33 * uVar34 * (int)lVar19, (void*)( *(long*)( piVar10 + 2 ) + ( ulong )(uint)(iVar16 + param_7._4_4_) * 4 ), (ulong)uVar34 << 2);
...
;
         ...
         iVar33 = (int)puVar30;
         if (( *(code**)( param_1 + 0x90 ) == (code*)0x0 ) || ( cVar13 = ( **(code**)( param_1 + 0x90 ) )(3, 0, *(undefined8*)( param_1 + 0x98 )) ),iVar33 = extraout_EDX_01,cVar13 != '\0') {
            ...
            *(uint*)( param_1 + 0x28 ) = uVar34;
            pvVar17 = (void*)internal::Realloc((void*)0x0, (ulong)uVar34 * 0x28, iVar33, (char*)piVar29, (int)param_5);
            ...
            if (*(int*)( param_1 + 0xfc ) == 0) {
               if (*(int*)( param_1 + 0x28 ) != 0) {
                  ...
                  do {
                     ...
                     local_118 = _LC18;
                     if (plVar6 != (long*)0x0) {
                        internal::ArrayBase::resize((uint)(Array<unsigned_int>*)&local_120, SUB41(*(int*)( (long)plVar6 + 0xc ) + 0x1fU >> 5, 0));
                     ...
                     uVar44 = *(int*)( lVar19 + 0x3c ) + (int)( ( ulong ) * (undefined8*)( (long)plVar18 + 0x1c ) >> 0x20 );
                     *(ulong*)( (long)plVar18 + 0x1c ) = CONCAT44(uVar44, *(int*)( lVar19 + 0xc ) * 3 + (int)*(undefined8*)( (long)plVar18 + 0x1c ));
                     uVar24 = (ulong)uVar44;
                              ...
                              do {
                                 while (true) {
                                    ...
                                    *(int*)( (long)plVar18 + 0x1c ) = *(int*)( (long)plVar18 + 0x1c ) + uVar44;
                                    LAB_00104f97:*(int*)( plVar18 + 3 ) = (int)plVar18[3] + 1;
                                    lVar37 = lVar37 + 1;
...
;
                                 ...
                                 do {
                                    ...
                                    if (( uVar14 & uVar40 ) == 0) {
                                       ...
                                       *(int*)( (long)plVar18 + 0x1c ) = *(int*)( (long)plVar18 + 0x1c ) + ( uint ) * (byte*)( *plVar6 + (long)piVar29 );
                                    }
 ...
 while ( (uint)lVar37 < (uint)param_5[0x11] );
                              LAB_00105041:uVar24 = (ulong)uVar14;
                           }
 ...
 while ( (uint)lVar22 < *(uint*)( (long)plVar20 + 0xc ) );
                     ...
                     auVar45 = internal::Realloc((void*)0x0, uVar24 * 0x14, (int)uVar24, (char*)piVar29, (int)param_5);
                     plVar18[2] = auVar45._0_8_;
                     auVar45 = internal::Realloc((void*)0x0, ( ulong ) * (uint*)( (long)plVar18 + 0x1c ) << 2, auVar45._8_4_, (char*)piVar29, (int)param_5);
                     plVar18[1] = auVar45._0_8_;
                     lVar19 = internal::Realloc((void*)0x0, ( ulong ) * (uint*)( plVar18 + 3 ) * 0x18, auVar45._8_4_, (char*)piVar29, (int)param_5);
                     puVar30 = internal::s_print;
                     *plVar18 = lVar19;
                     if (( puVar30 != (undefined*)0x0 ) && ( internal::s_printVerbose != '\0' )) {
                        param_5 = (undefined4*)( ulong ) * (uint*)( plVar18 + 3 );
                        ( *(code*)puVar30 )("   Mesh %u: %u vertices, %u triangles, %u charts\n", uVar34, (int)plVar18[4], ( ulong ) * (uint*)( (long)plVar18 + 0x1c ) / 3);
                     }
                           ...
                           if (*(int*)( lVar7 + 0x44 ) != 0) {
                              ...
                              do {
                                 ...
                                 if (uVar14 != 0) {
                                    ...
                                    uVar24 = 0;
                                    do {
                                       puVar31 = (undefined8*)( lVar25 + ( ulong )(uint)(iVar33 + (int)uVar24) * 0x14 );
                                    ...
                                    *(undefined4*)( (long)plVar20 + 0xc ) = 0;
                                    if (uVar44 < 3) {
                                       *plVar20 = 0;
                                       ...
                                       LAB_0010533b:lVar25 = *(long*)( lVar19 + 0x58 );
                                       lVar8 = plVar6[3];
                                       lVar21 = 0;
                                       do {
 ...
 while ( (uint)lVar22 < *(uint*)( (long)plVar20 + 0xc ) );
                     ...
                     uVar34 = uVar34 + 1;
                     if (( ( *(code**)( param_1 + 0x90 ) != (code*)0x0 ) && ( iVar33 = (int)( ( (float)uVar34 / (float)*(uint*)( param_1 + 0x28 ) ) * __LC35 ) ),bVar42 = iVar33 != local_13c,local_13c = iVar33,bVar42 )) {
 ...
 while ( uVar34 < *(uint*)( param_1 + 0x28 ) );
               ...
               do {
                  ...
                  *(uint*)( plVar18 + 4 ) = uVar14;
                  ...
                  auVar45 = internal::Realloc((void*)0x0, (ulong)uVar14 * 0x14, (int)lVar26, (char*)piVar29, (int)param_5);
                  plVar18[2] = auVar45._0_8_;
                  auVar45 = internal::Realloc((void*)0x0, ( ulong ) * (uint*)( (long)plVar18 + 0x1c ) << 2, auVar45._8_4_, (char*)piVar29, (int)param_5);
                  plVar18[1] = auVar45._0_8_;
                  lVar26 = internal::Realloc((void*)0x0, ( ulong ) * (uint*)( plVar18 + 3 ) * 0x18, auVar45._8_4_, (char*)piVar29, (int)param_5);
                  puVar30 = internal::s_print;
                  *plVar18 = lVar26;
                  if (( puVar30 != (undefined*)0x0 ) && ( internal::s_printVerbose != '\0' )) {
                     param_5 = (undefined4*)( ulong ) * (uint*)( plVar18 + 3 );
 ...
 while ( uVar14 != uVar24 );
                  ...
                  if (*(uint*)( *plVar6 + 0xa4 ) != 0) {
                     ...
                     do {
                        ...
                        lVar22 = internal::Realloc((void*)0x0, (ulong)uVar14 << 2, (int)lVar22, (char*)piVar29, (int)param_5);
                        uVar14 = puVar27[1];
                        *plVar20 = lVar22;
 ...
 while ( (uint)lVar19 < *(uint*)( *plVar6 + 0xa4 ) );
                  ...
                  uVar34 = uVar34 + 1;
                  if (( ( *(code**)( param_1 + 0x90 ) != (code*)0x0 ) && ( iVar35 = (int)( ( (float)uVar34 / (float)*(uint*)( param_1 + 0x28 ) ) * __LC35 ) ),bVar42 = iVar35 != iVar33,iVar33 = iVar35,bVar42 )) &&( cVar12 = ( **(code**)( param_1 + 0x90 ) )(3, iVar35, *(undefined8*)( param_1 + 0x98 )) ),cVar12 == '\0';
 ...
 while ( uVar34 < *(uint*)( param_1 + 0xfc ) );
      ...
      LAB_0010551d:internal::pack::Atlas::~Atlas((Atlas*)&local_108);
   }

   LAB_00105525:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* xatlas::internal::segment::runComputeUvMeshChartsTask(void*, void*) */void xatlas::internal::segment::runComputeUvMeshChartsTask(void *param_1, void *param_2) {
   char *in_RCX;
   int in_EDX;
   int extraout_EDX;
   int extraout_EDX_00;
...
/* xatlas::ComputeCharts(xatlas::Atlas*, xatlas::ChartOptions) */void xatlas::ComputeCharts(Atlas *param_1, undefined8 param_2, undefined8 param_3, char *param_4, int param_5) {
   long *plVar1;
   long *plVar2;
   uint uVar3;
   uint uVar4;
   ...
   AddMeshJoin(param_1);
   if (( *(int*)( param_1 + 0xb4 ) == 0 ) && ( param_4 = (char*)( ulong ) * (uint*)( param_1 + 0xfc ) * (uint*)( param_1 + 0xfc ) == 0 )) {
      if (internal::s_print != (undefined*)0x0) {
 ...
 while ( plVar20 + uVar3 != plVar13 );
      ...
      local_60 = p_Var7;
      local_58 = pvVar6;
      if (( p_Var7 != (_func_bool_ProgressCategory_int_void_ptr*)0x0 ) && ( bVar11 = !bVar11 )) {
         LOCK();
 ...
 while ( uVar18 != uVar3 );
      ...
      if (( local_60 != (_func_bool_ProgressCategory_int_void_ptr*)0x0 ) && ( bVar11 = ( *local_60 )((char)( (ulong)local_68 >> 0x20 ), 100, local_58) ),!bVar11) {
         LOCK();
         local_68 = CONCAT71(local_68._1_7_, 1);
         UNLOCK();
      }
 ...
 while ( plVar20 != plVar13 );
   ...
   cVar12 = internal::param::Atlas::computeCharts((Atlas*)( param_1 + 0x40 ), pTVar8, &stack0x00000008, p_Var7, pvVar6);
   if (cVar12 == '\0') {
      if (( internal::s_print != (undefined*)0x0 ) && ( internal::s_printVerbose != '\0' )) {
         ( *(code*)internal::s_print )("   Cancelled by user\n");
      }
   ...
   if (uVar3 == 0) {
      ...
      iVar28 = 0;
      iVar22 = 0;
      LAB_00106488:if (( ( ( ( internal::s_print != (undefined*)0x0 ) && ( internal::s_printVerbose != '\0' ) ) && ( ( *(code*)internal::s_print )("   %u charts\n", iVar27),internal::s_print != (undefined*)0x0 ) ) && ( ( internal::s_printVerbose != '\0' && ( ( *(code*)internal::s_print )("      %u planar, %u ortho, %u LSCM, %u piecewise\n", iVar28, iVar22, iVar25, iVar26),iVar15 != 0 ) ) ) ) && ( ( internal::s_print != (undefined*)0x0 && ( internal::s_printVerbose != '\0' ) ) )) {
               ...
               if (uVar4 != 0) {
                  ...
                  do {
                     while (true) {
                        ...
                        if (iVar5 != 0) break;
                        iVar28 = iVar28 + 1;
                        LAB_001060e3:iVar15 = iVar15 + ( uint )(*(int*)( lVar29 + 0x34 ) == 0);
                        plVar14 = plVar14 + 1;
...
;
 ...
 while ( plVar2 != plVar14 );
                  LAB_00106139:iVar27 = iVar27 + uVar4;
               }
               ...
               do {
                  ...
                  if (*(char*)( lVar9 + 0xe0 ) != '\0') {
                     if (*(char*)( lVar9 + 0xb8 ) == '\0') {
                        LAB_00106285:if (*(int*)( lVar9 + 0xc0 ) != 0) {
                           if (internal::s_print == (undefined*)0x0) goto LAB_0010630c;
                           ( *(code*)internal::s_print )("   Chart %u  (mesh %u, group %u, id %u) (%s): invalid parameterization, %u / %u flipped triangles.\n", iVar15, uVar18 & 0xffffffff, uVar24 & 0xffffffff, uVar17 & 0xffffffff, pcVar23, *(int*)( lVar9 + 0xc0 ), *(undefined4*)( lVar9 + 0xbc ));
                        }

                        LAB_001062cd:if (( *(int*)( lVar9 + 0xc4 ) != 0 ) && ( internal::s_print != (undefined*)0x0 )) {
                           ( *(code*)internal::s_print )("   Chart %u  (mesh %u, group %u, id %u) (%s): invalid parameterization, %u / %u zero area triangles.\n", iVar15, uVar18 & 0xffffffff, uVar24 & 0xffffffff, uVar17 & 0xffffffff, pcVar23, *(int*)( lVar9 + 0xc4 ), *(undefined4*)( lVar9 + 0xbc ));
                        }

                     }
 else {
                        if (internal::s_print != (undefined*)0x0) {
                           ( *(code*)internal::s_print )("   Chart %u (mesh %u, group %u, id %u) (%s): invalid parameterization, self-intersecting boundary.\n", iVar15, uVar18 & 0xffffffff, uVar24 & 0xffffffff, uVar17 & 0xffffffff, pcVar23);
                           goto LAB_00106285;
                        }
 ...
 while ( uVar18 != uVar3 );
   ...
   LAB_00106394:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* xatlas::Generate(xatlas::Atlas*, xatlas::ChartOptions, xatlas::PackOptions) */void xatlas::Generate(long param_1) {
   if (param_1 == 0) {
      if (internal::s_print != (undefined*)0x0) {
...
/* std::thread::_M_thread_deps_never_run() */void std::thread::_M_thread_deps_never_run(void) {
   return;
}
/* xatlas::internal::opennl::nlCoeffCompare(void const*, void const*) */bool xatlas::internal::opennl::nlCoeffCompare(void *param_1, void *param_2) {
   /* WARNING: Load size is inaccurate */
   /* WARNING: Load size is inaccurate */
   return *param_2 < *param_1;
}
/* xatlas::internal::opennl::nlCRSMatrixMult(xatlas::internal::opennl::NLCRSMatrix*, double const*,
   double*) */void xatlas::internal::opennl::nlCRSMatrixMult(NLCRSMatrix *param_1, double *param_2, double *param_3) {
   uint *puVar1;
   long lVar2;
   int iVar3;
   uint uVar4;
      ...
      if (uVar4 < puVar10[1]) {
         ...
         do {
            while (true) {
               ...
               uVar9 = 0;
               do {
                  dVar14 = dVar14 + param_2[*(uint*)( *(long*)( param_1 + 0x30 ) + (ulong)uVar5 * 4 + uVar9 * 4 )] * *(double*)( *(long*)( param_1 + 0x20 ) + (ulong)uVar5 * 8 + uVar9 * 8 );
...
;
 ...
 while ( lVar2 != lVar11 );
      ...
      LAB_001066fe:if (puVar1 + ( iVar3 - 1 ) == puVar12) {
         return;
      }
...
/* xatlas::internal::opennl::nlSparseMatrixMult(xatlas::internal::opennl::NLSparseMatrix*, double
   const*, double*) */void xatlas::internal::opennl::nlSparseMatrixMult(NLSparseMatrix *param_1, double *param_2, double *param_3) {
   int *piVar1;
   uint *puVar2;
   int iVar3;
   int iVar4;
...
/* xatlas::internal::opennl::nlJacobiPreconditionerMult(xatlas::internal::opennl::NLJacobiPreconditioner*,
   double const*, double*) */void xatlas::internal::opennl::nlJacobiPreconditionerMult(NLJacobiPreconditioner *param_1, double *param_2, double *param_3) {
   uint uVar1;
   long lVar2;
   long lVar3;
   ...
   if (uVar1 != 0) {
      ...
      lVar3 = 0;
      do {
         *(double*)( (long)param_3 + lVar3 ) = *(double*)( (long)param_2 + lVar3 ) * *(double*)( lVar2 + lVar3 );
         lVar3 = lVar3 + 8;
      }
...
/* std::thread::_State_impl<std::thread::_Invoker<std::tuple<void
   ...
   xatlas::internal::TaskScheduler*, xatlas::internal::TaskScheduler::Worker*, unsigned int> >
   >::_M_run() */void std::thread::_State_impl<std::thread::_Invoker<std::tuple<void(*)(xatlas::internal::TaskScheduler *, xatlas::internal::TaskScheduler::Worker *, unsigned_int),xatlas::internal::TaskScheduler*,xatlas::internal::TaskScheduler::Worker*,unsigned_int>>>::_M_run(_State_impl<std::thread::_Invoker<std::tuple<void(*)(xatlas::internal::TaskScheduler *, xatlas::internal::TaskScheduler::Worker *, unsigned_int),xatlas::internal::TaskScheduler*,xatlas::internal::TaskScheduler::Worker*,unsigned_int>>> *this) {
   /* WARNING: Could not recover jumptable at 0x00106826. Too many branches */
   /* WARNING: Treating indirect jump as call */
   ( **(code**)( this + 0x20 ) )(*(undefined8*)( this + 0x18 ), *(undefined8*)( this + 0x10 ), *(undefined4*)( this + 8 ));
   return;
}
/* std::thread::_State_impl<std::thread::_Invoker<std::tuple<void
   (*)(xatlas::internal::TaskScheduler*, xatlas::internal::TaskScheduler::Worker*, unsigned int),
   xatlas::internal::TaskScheduler*, xatlas::internal::TaskScheduler::Worker*, unsigned int> >
   >::~_State_impl() */void std::thread::_State_impl<std::thread::_Invoker<std::tuple<void(*)(xatlas::internal::TaskScheduler *, xatlas::internal::TaskScheduler::Worker *, unsigned_int),xatlas::internal::TaskScheduler*,xatlas::internal::TaskScheduler::Worker*,unsigned_int>>>::~_State_impl(_State_impl<std::thread::_Invoker<std::tuple<void(*)(xatlas::internal::TaskScheduler *, xatlas::internal::TaskScheduler::Worker *, unsigned_int),xatlas::internal::TaskScheduler*,xatlas::internal::TaskScheduler::Worker*,unsigned_int>>> *this) {
...
/* WARNING: Control flow encountered bad instruction data *//* xatlas::internal::TaskScheduler::workerThread(xatlas::internal::TaskScheduler*,
   xatlas::internal::TaskScheduler::Worker*, unsigned int) */void xatlas::internal::TaskScheduler::workerThread(TaskScheduler *param_1, Worker *param_2, uint param_3) {
   ...
   *in_FS_OFFSET = param_3;
   ...
   LAB_001068f3:while (param_2[0x60] == (Worker)0x0) {
...
;
   ...
   UNLOCK();
   TVar3 = param_1[0x20];
   joined_r0x00106905:if (TVar3 != (TaskScheduler)0x0) {
 ...
 while ( true );
   ...
   goto LAB_001068f3;
   LAB_00106977:*(uint*)( pcVar1 + 0x20 ) = uVar4 + 1;
...
/* xatlas::internal::pack::Atlas::drawTriangleCallback(void*, int, int) */undefined8 xatlas::internal::pack::Atlas::drawTriangleCallback(void *param_1, int param_2, int param_3) {
   ulong *puVar1;
   long lVar2;
   /* WARNING: Load size is inaccurate */
   puVar1 = (ulong*)( *(long*)( *param_1 + 0x10 ) + ( ulong )(*(int*)( *param_1 + 8 ) * param_3 + ( (uint)param_2 >> 6 )) * 8 );
   *puVar1 = *puVar1 | 1L << ( (byte)param_2 & 0x3f );
   lVar2 = *(long*)( (long)param_1 + 8 );
   if (lVar2 != 0) {
      puVar1 = (ulong*)( *(long*)( lVar2 + 0x10 ) + ( ulong )(( (uint)param_3 >> 6 ) + param_2 * *(int*)( lVar2 + 8 )) * 8 );
      *puVar1 = *puVar1 | 1L << ( (byte)param_3 & 0x3f );
   }

   return 1;
}
/* xatlas::internal::opennl::nlRowColumnGrow(xatlas::internal::opennl::NLRowColumn*) */void xatlas::internal::opennl::nlRowColumnGrow(NLRowColumn *param_1) {
   uint uVar1;
   undefined8 uVar2;
   void *__s;
   char *in_RCX;
...
/* xatlas::internal::opennl::nlEnd(xatlas::internal::opennl::NLContext*, unsigned int) [clone
   .part.0] */void xatlas::internal::opennl::nlEnd(NLContext *param_1, uint param_2) {
   double *pdVar1;
   double *pdVar2;
   uint uVar3;
   uint uVar4;
 ...
 while ( puVar10 != puVar13 );
            ...
            *(uint*)pNVar17 = uVar7 + 1;
            LAB_00106b7c:lVar18 = lVar18 + 0x10;
         }
   ...
   if (uVar6 != 0) {
      ...
      do {
         ...
         if (uVar3 != 0) {
            ...
            do {
               piVar12 = piVar11 + 4;
               dVar19 = dVar19 + *(double*)( *(long*)( *(long*)param_1 + lVar16 ) + ( ulong )(uint)((int)( (long*)( *(long*)param_1 + lVar16 ) )[1] * *piVar11) ) * *(double*)( piVar11 + 2 );
               piVar11 = piVar12;
            }
...
/* xatlas::internal::opennl::nlCoefficient(xatlas::internal::opennl::NLContext*, unsigned int,
   double) */void xatlas::internal::opennl::nlCoefficient(NLContext *param_1, uint param_2, double param_3) {
   undefined4 uVar1;
   uint *puVar2;
   undefined4 *puVar3;
   uint uVar4;
...
/* xatlas::internal::opennl::nlDeleteContext(xatlas::internal::opennl::NLContext*) */void xatlas::internal::opennl::nlDeleteContext(NLContext *param_1) {
   void *pvVar1;
   char *in_RCX;
   int in_EDX;
   int extraout_EDX;
...
/* xatlas::internal::param::vec_angle_cos(xatlas::internal::Vector3 const&,
   xatlas::internal::Vector3 const&, xatlas::internal::Vector3 const&) [clone .isra.0] */ulong xatlas::internal::param::vec_angle_cos(Vector3 *param_1, Vector3 *param_2, Vector3 *param_3) {
   float in_XMM0_Da;
   float fVar1;
   ...
   fVar1 = ( fVar1 * fVar4 + fVar2 * fVar5 + fVar3 * fVar6 ) / ( SQRT(fVar4 * fVar4 + fVar5 * fVar5 + fVar6 * fVar6) * SQRT(fVar1 * fVar1 + fVar2 * fVar2 + fVar3 * fVar3) );
   if (_LC5 < fVar1) {
      if (_LC4 <= fVar1) {
         fVar1 = _LC4;
      }
...
/* xatlas::internal::opennl::nlSparseMatrixDestroy(xatlas::internal::opennl::NLSparseMatrix*) */void xatlas::internal::opennl::nlSparseMatrixDestroy(NLSparseMatrix *param_1) {
   void *pvVar1;
   char *in_RCX;
   uint uVar2;
   int extraout_EDX;
...
/* xatlas::internal::opennl::nlCRSMatrixDestroy(xatlas::internal::opennl::NLCRSMatrix*) */void xatlas::internal::opennl::nlCRSMatrixDestroy(NLCRSMatrix *param_1) {
   char *in_RCX;
   int in_EDX;
   int extraout_EDX;
   int extraout_EDX_00;
...
/* xatlas::internal::ArrayBase::~ArrayBase() */void xatlas::internal::ArrayBase::~ArrayBase(ArrayBase *this) {
   if (*(long*)this == 0) {
      return;
   }
...
/* xatlas::internal::ArrayBase::copyTo(xatlas::internal::ArrayBase&) const */void xatlas::internal::ArrayBase::copyTo(ArrayBase *param_1) {
   uint uVar1;
   void *__dest;
   char *in_RCX;
   int in_EDX;
   ...
   *(uint*)( (long)in_RSI + 0xc ) = uVar1;
   ...
   if (( ( __dest != (void*)0x0 ) && ( *(void**)param_1 != (void*)0x0 ) ) && ( *(int*)( param_1 + 0xc ) != 0 )) {
...
/* xatlas::internal::ArrayBase::push_back(unsigned char const*) */void xatlas::internal::ArrayBase::push_back(uchar *param_1) {
   void *pvVar1;
   char *in_RCX;
   int in_EDX;
   uint uVar2;
   ...
   *(uint*)( param_1 + 0xc ) = uVar2;
   ...
   if (*(uint*)( param_1 + 0x10 ) < uVar2) {
      if (( *(uint*)( param_1 + 0x10 ) != 0 ) && ( uVar2 = uVar2 == 0 )) {
         if (pvVar1 != (void*)0x0) {
   ...
   memcpy((void*)( (long)pvVar1 + ( ulong )(( *(int*)( param_1 + 0xc ) + -1 ) * *(uint*)( param_1 + 8 )) ), in_RSI, ( ulong ) * (uint*)( param_1 + 8 ));
   return;
}
/* xatlas::internal::ArrayBase::removeAt(unsigned int) */void xatlas::internal::ArrayBase::removeAt(ArrayBase *this, uint param_1) {
   uint uVar1;
   int iVar2;
   long lVar3;
   uint uVar4;
   ...
   if (lVar3 != 0) {
      ...
      if (1 < uVar1) {
         ...
         memmove((void*)( lVar3 + ( ulong )(uVar4 - iVar2) ), (void*)( (ulong)uVar4 + lVar3 ), ( ulong )(( ( uVar1 - param_1 ) + -1 ) * iVar2));
         uVar1 = *(uint*)( this + 0xc );
      }
...
/* xatlas::internal::ArrayBase::resize(unsigned int, bool) */void xatlas::internal::ArrayBase::resize(uint param_1, bool param_2) {
   void *pvVar1;
   undefined8 uVar2;
   char *in_RCX;
   int in_EDX;
   ...
   *(uint*)( (long)puVar4 + 0xc ) = uVar3;
   if (*(uint*)( puVar4 + 2 ) < uVar3) {
      pvVar1 = (void*)*puVar4;
      if (( ( *(uint*)( puVar4 + 2 ) == 0 ) || ( (char)in_EDX != '\0' ) ) || ( uVar3 = uVar3 + ( ( uint )(CONCAT71(in_register_00000031, param_2) >> 2) & 0x3fffffff ) ),uVar3 != 0) {
...
/* xatlas::internal::ArrayBase::setArrayCapacity(unsigned int) */void xatlas::internal::ArrayBase::setArrayCapacity(uint param_1) {
   void *pvVar1;
   undefined8 uVar2;
   char *in_RCX;
   int in_EDX;
...
/* xatlas::internal::pack::runAddChartTask(void*, void*) */void xatlas::internal::pack::runAddChartTask(void *param_1, void *param_2) {
   float *pfVar1;
   float *pfVar2;
   uint uVar3;
   uint uVar4;
   ...
   memcpy(*(void**)( *(long*)( lVar6 + 0x28 ) + 0x88 ), *(void**)( lVar6 + 0xa0 ), ( ulong ) * (uint*)( *(long*)( lVar6 + 0x28 ) + 100 ) << 3);
   ...
   *(uint*)( puVar11 + 2 ) = uVar3;
   ...
   if (uVar3 < 3) {
      *(undefined4*)( puVar11 + 3 ) = 0;
      ...
      fVar22 = _LC11;
      LAB_00107f37:uVar12 = *(uint*)( *(long*)( lVar6 + 0x28 ) + 100 );
      fVar21 = _LC10;
      fVar24 = _LC9;
      fVar23 = _LC10;
      fVar25 = _LC9;
 ...
 while ( pfVar1 != pfVar14 );
      ...
      *(float*)( puVar11 + 3 ) = ( fVar21 - fVar24 ) * fVar22 * ( fVar23 - fVar25 ) * fVar22;
      ...
      do {
         ...
         fVar24 = fVar24 + (float)( ( uint )(( ( *pfVar1 - fVar25 ) * ( pfVar14[1] - fVar23 ) - ( pfVar1[1] - fVar23 ) * ( *pfVar14 - fVar25 ) ) * _LC11) & _LC37 );
      }
 ...
 while ( uVar16 < uVar3 / 3 );
   LAB_00107e31:iVar5 = *(int*)( lVar8 + 0x94 );
   puVar11[4] = lVar13;
   ...
   *(undefined4*)( (long)puVar18 + 0x2c ) = 0;
   if (iVar5 != 0) {
      uVar15 = 0;
      do {
         while (( 1 << ( (byte)uVar15 & 0x1f ) & *(uint*)( *(long*)( lVar8 + 0xd8 ) + ( uVar15 >> 5 & 0x7ffffff ) * 4 ) ) == 0) {
            uVar15 = uVar15 + 1;
...
;
 ...
 while ( (uint)uVar15 < *(uint*)( puVar11 + 5 ) );
   ...
   LAB_00107ecf:BoundingBox2D::compute(puVar18, lVar13, *(undefined4*)( lVar8 + 0x94 ));
   puVar11[9] = *puVar18;
   for (int i = 0; i < 3; i++) {
      puVar11[( i + 10 )] = puVar18[( i + 1 )];
   }
...
/* xatlas::internal::Basis::computeTangent(xatlas::internal::Vector3 const&) */void xatlas::internal::Basis::computeTangent(Vector3 *param_1) {
   char *pcVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   fVar2 = SQRT(*(float*)param_1 * *(float*)param_1 + *(float*)( param_1 + 4 ) * *(float*)( param_1 + 4 ) + *(float*)( param_1 + 8 ) * *(float*)( param_1 + 8 ));
   ...
   if (( fVar4 < (float)( ( uint )(fVar2 - _LC4) & _LC37 ) ) && ( s_print != (undefined*)0x0 )) {
      ...
      ( *(code*)s_print )("\rASSERT: %s %s %d\n", "isNormalized(normal)", "thirdparty/xatlas/xatlas.cpp", 0x4ef);
...
/* xatlas::internal::BitImage::resize(unsigned int, unsigned int, bool) */void xatlas::internal::BitImage::resize(uint param_1, uint param_2, bool param_3) {
   void *__dest;
   uint uVar1;
   char *in_RCX;
   uint uVar2;
         ...
         if (( *puVar6 != 0 ) && ( uVar4 = uVar4 != 0 )) {
            ...
            if (uVar3 != 0) {
               ...
               while (true) {
                  ...
                  memcpy((void*)( (long)__dest + uVar7 * 8 ), (void*)( *(long*)( puVar6 + 4 ) + ( ulong )(uVar1 * (int)in_RCX) * 8 ), (ulong)uVar4 << 3);
                  uVar1 = (int)in_RCX + 1;
...
/* xatlas::internal::BitImage::dilate(unsigned int) */void xatlas::internal::BitImage::dilate(uint param_1) {
   uint uVar1;
   uint uVar2;
   uint uVar3;
   uint uVar4;
   ...
   iVar6 = local_50;
   local_50 = 8;
   if (( ( uStack_4c != 0 ) && ( ArrayBase::setArrayCapacity(( uint ) & local_58),__s = local_58,iVar6 = local_50,local_58 != (byte*)0x0 ) ) && ( uStack_4c != 0 )) {
               ...
               LAB_0010874a:do {
                  ...
                  if (puVar19[8] < uVar24) {
                     ...
                     *(long*)( puVar19 + 4 ) = auVar26._0_8_;
                     pbVar21 = __s;
                     if (auVar26._0_8_ != 0) {
                        joined_r0x0010880b:uVar13 = auVar26._8_8_;
                        if (pbVar21 != (byte*)0x0) {
                  ...
                  LAB_0010882e:local_90 = puVar19[1];
                  pbVar21 = *(byte**)( puVar19 + 4 );
                  uVar24 = uStack_4c;
                  joined_r0x00108865:;
               }
 ...
 while ( true );
         ...
         puVar19[7] = 0;
         uVar24 = uStack_4c;
         joined_r0x001087a4:local_70 = local_70 + 1;
      }
 while ( in_ESI != local_70 );
   }

   LAB_001087ad:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
      ...
      if (( uVar18 & 1 ) == 0) {
         ...
         if (uVar16 == 0) {
            if (uVar14 == 0) {
               ...
               LAB_00108550:in_RCX = (char*)(ulong)uVar22;
               uVar10 = uVar10 | ( uint )(*(ulong*)( pbVar21 + ( ulong )(iVar6 + uVar20) * 8 ) >> sVar7) & 1;
               uVar13 = (ulong)uVar10;
               if (uVar1 <= uVar16) goto LAB_001085c2;
               uVar10 = uVar10 | ( uint )(*(ulong*)( pbVar21 + ( ulong )(iVar23 + ( uVar2 >> 6 )) * 8 ) >> ( bVar8 & 0x3f )) & 1;
               uVar16 = uVar2;
               ...
               LAB_00108718:uVar10 = uVar10 | ( uint )(*(ulong*)( pbVar21 + ( ulong )(iVar23 + ( uVar2 >> 6 )) * 8 ) >> ( bVar8 & 0x3f )) & 1;
               LAB_00108595:uVar16 = uVar2 & 0x3f;
               uVar10 = uVar10 | ( uint )(*(ulong*)( pbVar21 + ( ulong )(uVar25 + ( uVar2 >> 6 )) * 8 ) >> (sbyte)uVar16) & 1;
            }
            ...
            if (uVar14 < uVar5) {
               ...
               uVar13 = ( ulong )(uVar10 | ( uint )(*(ulong*)( pbVar21 + ( ulong )(iVar6 + ( uVar2 >> 6 )) * 8 ) >> ( sbyte )(uVar2 & 0x3f)) & 1);
            }
            ...
            uVar11 = ( uint )(*(ulong*)( pbVar21 + ( ulong )(iVar23 + uVar15) * 8 ) >> ( (byte)uVar10 & 0x3f )) | uVar11;
            if (uVar14 == 0) {
               if (local_90 != 1) {
                  uVar10 = ( uVar11 | ( uint )(*(ulong*)( pbVar21 + ( ulong )(uVar15 + iVar6) * 8 ) >> bVar9) ) & 1;
                  goto LAB_00108550;
               }
               ...
               if (uVar14 < uVar5) {
                  uVar10 = ( ( uint )(*(ulong*)( pbVar21 + ( ulong )(uVar25 + uVar20) * 8 ) >> sVar7) | ( uint )(*(ulong*)( pbVar21 + ( ulong )(uVar15 + iVar6) * 8 ) >> bVar9) | uVar11 ) & 1;
                  goto LAB_00108550;
               }

               in_RCX = (char*)(ulong)uVar1;
               uVar10 = ( uVar11 | ( uint )(*(ulong*)( pbVar21 + ( ulong )(uVar25 + uVar20) * 8 ) >> sVar7) ) & 1;
               uVar13 = (ulong)uVar10;
         ...
         LAB_001085c2:if ((char)uVar13 != '\0') goto LAB_001085c6;
      }
 else {
         LAB_001085c6:in_RCX = (char*)(ulong)uVar22;
         uVar13 = 1L << sVar7;
         *(ulong*)( __s + ( ulong )(local_ac + uVar20) * 8 ) = *(ulong*)( __s + ( ulong )(local_ac + uVar20) * 8 ) | uVar13;
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* xatlas::internal::BVH::BVH(xatlas::internal::Array<xatlas::internal::AABB> const&, unsigned int)
    */void xatlas::internal::BVH::BVH(BVH *this, Array *param_1, uint param_2) {
   float *pfVar1;
   undefined8 *puVar2;
   uint *puVar3;
   float fVar4;
   ...
   *(undefined4*)( this + 0x30 ) = 0;
   if (iVar6 == 0) {
      LAB_00108929:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
 ...
 while ( uVar11 != uVar21 );
   ...
   LAB_001089a3:uVar21 = *(uint*)( this + 0x30 );
 ...
 while ( (uint*)( lVar20 + 4 + ( ( ulong )(( uVar7 - 2 ) - uVar16) + (ulong)uVar14 ) * 4 ) != puVar15 );
      ...
      *(uint*)( this + 0x2c ) = uVar14;
      ...
      local_65c = uVar22;
      if (uVar21 < uVar14) {
         if (( uVar21 == 0 ) || ( uVar14 = uVar14 != 0 )) {
            pvVar12 = (void*)Realloc(pvVar12, ( ulong )(uVar14 * *(int*)( this + 0x28 )), uVar14, pcVar13, (int)in_R8);
         ...
         LAB_00108cea:if (pvVar12 != (void*)0x0) {
            memcpy((void*)( (long)pvVar12 + ( ulong )(( *(int*)( this + 0x2c ) + -1 ) * *(uint*)( this + 0x28 )) ), &local_678, ( ulong ) * (uint*)( this + 0x28 ));
            fVar35 = _LC11;
         }
      ...
      if ((int)pcVar13 != 0) {
         ...
         fVar33 = ( *(float*)( (long)&local_698 + lVar20 ) + *(float*)( (long)afStack_68c + lVar20 ) ) * fVar35;
         if (uVar16 < uVar7) {
            lVar10 = *(long*)( this + 8 );
            in_R8 = *(ulong*)param_1;
            ...
            do {
               ...
               local_6a0 = ( *(float*)( (long)puVar2 + 0x14 ) - *(float*)( puVar2 + 1 ) ) * fVar35 + *(float*)( puVar2 + 1 );
               local_6a8 = CONCAT44(( (float)( ( ulong ) * (undefined8*)( (long)puVar2 + 0xc ) >> 0x20 ) - fVar30 ) * _UNK_00120544 + fVar30, ( (float)*(undefined8*)( (long)puVar2 + 0xc ) - fVar27 ) * _LC11 + fVar27);
               uVar19 = uVar18;
               if (*(float*)( (long)&local_6a8 + lVar20 ) <= fVar33 && fVar33 != *(float*)( (long)&local_6a8 + lVar20 )) {
 ...
 while ( puVar15 != (uint*)( lVar10 + 4 + ( ( ( uVar7 - 1 ) - uVar16 ) + uVar23 ) * 4 ) );
            ...
            LAB_00108f30:uVar19 = ( ulong )(( uVar22 >> 1 ) + uVar16);
         }
...
/* xatlas::internal::Fit::EigenSolver3_QLAlgorithm(float (*) [3], float*, float*) */undefined8 xatlas::internal::Fit::EigenSolver3_QLAlgorithm(float *param_1, float *param_2, float *param_3) {
   uint uVar1;
   float fVar2;
   int iVar3;
   float *pfVar4;
      ...
      if (iVar13 <= iVar3 + -1) {
         ...
         do {
            ...
            do {
               ...
               *(ulong*)pfVar4 = CONCAT44(fVar14 * fVar17 + *pfVar4 * fVar16, *pfVar4 * fVar17 - fVar14 * fVar16);
               pfVar4 = pfVar5;
            }
...
/* xatlas::internal::Mesh::Mesh(float, unsigned int, unsigned int, unsigned int, unsigned int) */void xatlas::internal::Mesh::Mesh(Mesh *this, float param_1, uint param_2, uint param_3, uint param_4, uint param_5) {
   int iVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   uVar3 = _LC31;
   ...
   *(undefined4*)( this + 0xd0 ) = 0;
   for (int i = 0; i < 3; i++) {
      *(undefined8*)( this + ( 24*i + 216 ) ) = 0;
      *(undefined8*)( this + ( 24*i + 224 ) ) = uVar2;
      *(undefined4*)( this + ( 24*i + 232 ) ) = 0;
   }
   ...
   *(undefined1(*) [16])( this + 0x130 ) = (undefined1[16])0x0;
   ...
   if (param_3 == 0) {
      ...
      LAB_001093df:ArrayBase::setArrayCapacity(iVar1 + 0x58);
   }
 else {
   ...
   LAB_001093b7:if (( ( param_4 & 4 ) != 0 ) && ( *(uint*)( this + 0x38 ) < param_3 )) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* xatlas::internal::Mesh::addFace(unsigned int const*, bool, unsigned int) */void xatlas::internal::Mesh::addFace(uint *param_1, bool param_2, uint param_3) {
   void *pvVar1;
   int iVar2;
   int iVar3;
   ...
   do {
      ...
      if (param_1[0x14] < uVar12) {
         if (( param_1[0x14] == 0 ) || ( uVar12 = uVar12 != 0 )) {
         ...
         LAB_001094bd:if (pvVar15 != (void*)0x0 && auVar17._0_8_ != 0) {
            memcpy((void*)( auVar17._0_8_ + ( ulong )(( param_1[0x13] - 1 ) * param_1[0x12]) ), pvVar15, (ulong)param_1[0x12]);
 ...
 while ( (uint)lVar11 < param_1[0x4a] );
         ...
         if (param_1[0x52] < param_1[0x49]) {
            ...
            LAB_0010983d:ArrayBase::setArrayCapacity((int)param_1 + 0x150);
      ...
      if (param_1[0x52] < uVar16) {
         if (( param_1[0x52] == 0 ) || ( uVar16 = uVar16 != 0 )) {
            pvVar15 = (void*)Realloc(pvVar15, ( ulong )(uVar16 * param_1[0x50]), (int)lVar11, pcVar9, (int)in_R8);
            param_1[0x52] = uVar16;
         ...
         LAB_001095cf:if (pvVar15 != (void*)0x0) {
            memcpy((void*)( (long)pvVar15 + ( ulong )(( param_1[0x51] - 1 ) * param_1[0x50]) ), &local_48, (ulong)param_1[0x50]);
         }
      ...
      if (param_1[0x58] < uVar16) {
         if (( param_1[0x58] == 0 ) || ( uVar16 = uVar16 != 0 )) {
            pvVar15 = (void*)Realloc(pvVar15, ( ulong )(uVar16 * param_1[0x56]), (int)lVar11, pcVar9, uVar14);
            param_1[0x58] = uVar16;
            *(void**)( param_1 + 0x54 ) = pvVar15;
            uVar14 = ( uint )(pcVar9 != (char*)0x0) & (uint)CONCAT71(( int7 )((ulong)pvVar15 >> 8), pvVar15 != (void*)0x0);
         ...
         LAB_00109631:in_R8 = (ulong)uVar14;
         if ((char)uVar14 != '\0') {
...
/* xatlas::internal::Mesh::createColocalsBVH() */void xatlas::internal::Mesh::createColocalsBVH(Mesh *this) {
 ...
 while ( pauVar6 != pauVar1 );
   ...
   if (uVar4 == 0) {
      LAB_00109e68:ArrayBase::~ArrayBase((ArrayBase*)&local_1a8);
   ...
   LAB_00109aab:if (*(int*)( *(long*)( this + 0xa0 ) + uVar7 * 4 ) == -1) {
            ...
            if (*(int*)( lVar15 + 0x1c ) != 0) {
               LAB_00109c18:do {
                  while (true) {
                     ...
                     if (( ( ( fVar21 <= pfVar11[3] ) && ( *pfVar11 <= fVar20 ) ) && ( fVar22 <= pfVar11[4] ) ) && ( ( ( pfVar11[1] <= local_224 && ( local_214 <= pfVar11[5] ) ) && ( pfVar11[2] <= local_1fc ) ) )) break;
                     LAB_00109d68:uVar12 = uVar12 + 1;
                     uVar5 = local_198;
...
;
                  ...
                  if (uVar14 <= local_198) {
                     LAB_00109d16:if (local_1a8 != (void*)0x0) {
                        memcpy((void*)( (long)local_1a8 + ( ulong )(( uVar14 - 1 ) * (int)local_1a0) ), puVar16, local_1a0 & 0xffffffff);
                  ...
                  uVar5 = uVar14;
                  if (( local_198 == 0 ) || ( uVar5 = uVar5 != 0 )) {
                     local_1a8 = (void*)Realloc(local_1a8, ( ulong )(uVar5 * (int)local_1a0), iVar10, (char*)pAVar8, (int)in_R8);
                     uVar14 = local_1a0._4_4_;
                     local_198 = uVar5;
                     goto LAB_00109d16;
                  }
 ...
 while ( uVar12 < *(uint*)( lVar15 + 0x1c ) );
            ...
            LAB_00109d75:local_198 = uVar5;
            if (iVar9 == -1) goto LAB_00109d81;
            LAB_00109be9:lVar15 = (long)iVar9;
            lVar13 = local_168[0];
            iVar10 = iVar9;
            iVar9 = iVar9 + -1;
         }
            ...
            if (( ( ( ( pfVar11[3] < fVar21 ) || ( fVar20 < *pfVar11 ) ) || ( pfVar11[4] < fVar22 ) ) || ( ( local_224 < pfVar11[1] || ( pfVar11[5] < local_214 ) ) ) ) || ( local_1fc < pfVar11[2] )) {
               pfVar11 = (float*)( lVar13 + (ulong)uVar5 * 0x24 );
               iVar10 = iVar9;
               if (fVar21 <= pfVar11[3]) goto LAB_00109bb8;
               LAB_00109be0:if (iVar9 != -1) goto LAB_00109be9;
               goto LAB_00109d81;
            }
            ...
            pfVar11 = (float*)( lVar13 + (ulong)uVar5 * 0x24 );
            if (fVar21 <= pfVar11[3]) {
               LAB_00109bb8:iVar9 = iVar10;
               if (( ( fVar20 < *pfVar11 ) || ( pfVar11[4] < fVar22 ) ) || ( ( local_224 < pfVar11[1] || ( ( pfVar11[5] < local_214 || ( local_1fc < pfVar11[2] ) ) ) ) )) goto LAB_00109be0;
               iVar10 = iVar9 + 1;
               lVar15 = (long)iVar10;
   ...
   if (uVar14 != 0) {
      do {
         ...
         if (uVar12 != local_1f0) {
            ...
            if (( ( ( (float)( ( uint )(*pfVar2 - *pfVar11) & _LC37 ) <= fVar3 ) && ( (float)( ( uint )(pfVar2[1] - pfVar11[1]) & _LC37 ) <= fVar3 ) ) && ( (float)( ( uint )(pfVar2[2] - pfVar11[2]) & _LC37 ) <= fVar3 ) ) && ( *(int*)( *(long*)( this + 0xa0 ) + (ulong)uVar12 * 4 ) == -1 )) {
               ArrayBase::push_back((uchar*)&local_1c8);
            }
 ...
 while ( uVar14 != uVar12 );
   ...
   joined_r0x00109aa5:local_1f0 = local_1f0 + 1;
   uVar7 = (ulong)local_1f0;
   if (uVar4 <= local_1f0) goto LAB_00109e68;
   goto LAB_00109aab;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* xatlas::internal::Mesh::createColocalsHash() */void xatlas::internal::Mesh::createColocalsHash(void) {
   float fVar1;
   byte bVar2;
   float fVar3;
   uint uVar4;
 ...
 while ( pbVar12 != __src + 0xc );
         ...
         if ((uint)local_60 < (uint)fStack_64) {
            fVar10 = fStack_64;
            if (( local_60 == 0.0 ) || ( fVar10 = (float)( (int)fStack_64 + ( (uint)fStack_64 >> 2 ) ) ),fVar10 != 0.0) {
               pvVar6 = (void*)Realloc((void*)local_78._8_8_, ( ulong )((int)fVar10 * local_68), (int)fVar10, (char*)(ulong)uVar4, uVar17);
               local_78._8_8_ = pvVar6;
               uVar17 = ( uint )(__src != (byte*)0x0) & (uint)CONCAT71(( int7 )((ulong)pvVar6 >> 8), pvVar6 != (void*)0x0);
               local_60 = fVar10;
               goto LAB_0010a20c;
            }
            ...
            LAB_0010a20c:in_R8 = (ulong)uVar17;
            if ((char)uVar17 != '\0') {
               memcpy((void*)( (long)pvVar6 + ( ulong )(( (int)fStack_64 - 1U ) * local_68) ), __src, (ulong)local_68);
            }
         ...
         if ((uint)local_48 < (uint)fVar10) {
            if (( local_48 == 0.0 ) || ( fVar10 = fVar10 != 0.0 )) {
               local_58 = (void*)Realloc(local_58, ( ulong )(uint)((int)fVar10 * (int)local_50), (int)fVar10, (char*)in_RCX, (int)in_R8);
            ...
            LAB_0010a26e:if (pvVar6 != (void*)0x0 && local_58 != (void*)0x0) {
               memcpy((void*)( (long)local_58 + ( ulong )(uint)((int)in_RCX * (int)local_50) ), pvVar6, local_50 & 0xffffffff);
               in_RCX = (float*)( ulong )(local_50._4_4_ - 1);
            }
 ...
 while ( (ulong)(uint)fVar3 * 0xc != lVar18 );
   ...
   uVar5 = 0;
   if (fVar3 == 0.0) {
      LAB_0010a518:ArrayBase::~ArrayBase((ArrayBase*)&local_a8);
   ...
   LAB_0010a354:if (*(int*)( *(long*)( in_RDI + 0x28 ) + uVar5 * 4 ) == -1) {
 ...
 while ( pfVar13 != in_RCX + 3 );
         ...
         if (fVar11 != -NAN) {
            do {
               ...
               if (( ( fVar10 == *in_RCX ) && ( fVar19 == in_RCX[1] ) ) && ( pvVar6 = local_58 ),uVar4 = _LC37,fVar20 == in_RCX[2]) goto LAB_0010a438;
 ...
 while ( fVar11 != -NAN );
   ...
   goto LAB_0010a340;
   LAB_0010a438:while (true) {
      if (fVar11 != local_b0) {
         fVar1 = *in_RDI;
         pfVar13 = (float*)( lVar7 + uVar5 * 0xc );
         if (( ( (float)( ( uint )(fVar10 - *pfVar13) & uVar4 ) <= fVar1 ) && ( (float)( ( uint )(fVar19 - pfVar13[1]) & uVar4 ) <= fVar1 ) ) && ( ( (float)( ( uint )(fVar20 - pfVar13[2]) & uVar4 ) <= fVar1 && ( *(int*)( *(long*)( in_RDI + 0x28 ) + uVar5 * 4 ) == -1 ) ) )) {
            ArrayBase::push_back((uchar*)&local_a8);
            lVar7 = *(long*)( in_RDI + 0x16 );
...
;
   LAB_0010a4d0:in_R8 = (ulong)(uint)local_b0;
   if (local_a0._4_4_ == 1) {
 ...
 while ( uVar17 != uVar4 );
      ...
      LAB_0010a340:fVar10 = (float)in_R8;
   }
...
/* xatlas::internal::Mesh::findEdge(unsigned int, unsigned int) const */ulong xatlas::internal::Mesh::findEdge(Mesh *this, uint param_1, uint param_2) {
   uint *puVar1;
   int *piVar2;
   uint uVar3;
   long lVar4;
   ...
   if (( lVar4 != 0 ) && ( uVar3 = *(uint*)( lVar4 + ( ulong )(param_1 * 0x8000 + param_2 & *(int*)( this + 0x128 ) - 1U) * 4 ) ),uVar3 != 0xffffffff) {
      do {
         uVar6 = (ulong)uVar3;
         puVar1 = (uint*)( *(long*)( this + 0x138 ) + uVar6 * 8 );
         if (( param_1 == *puVar1 ) && ( param_2 == puVar1[1] )) {
            LAB_0010a8ec:if (( *(uint*)( this + 4 ) & 1 ) == 0) {
               return uVar6;
            }
...
;
 ...
 while ( uVar3 != 0xffffffff );
   ...
   LAB_0010a940:if (*(int*)( this + 0xac ) != 0) {
      do {
         uVar6 = (ulong)param_2;
         if (lVar4 == 0) {
            do {
 ...
 while ( param_2 != uVar3 );
            ...
            do {
               while (true) {
                  iVar5 = (int)uVar6;
                  uVar3 = *(uint*)( lVar4 + ( ulong )(iVar9 * 0x8000 + iVar5 & *(int*)( this + 0x128 ) - 1U) * 4 );
...
;
               LAB_0010aa40:lVar8 = *(long*)( this + 0xa0 );
               uVar3 = *(uint*)( lVar8 + uVar6 * 4 );
               uVar6 = (ulong)uVar3;
            }
 while ( param_2 != uVar3 );
         ...
         LAB_0010aa10:uVar3 = *(uint*)( lVar8 + uVar10 * 4 );
         uVar10 = (ulong)uVar3;
      }
 while ( param_1 != uVar3 );
   }
...
/* xatlas::internal::Mesh::createBoundaries() */void xatlas::internal::Mesh::createBoundaries(Mesh *this) {
   uint *puVar1;
   uint uVar2;
   long lVar3;
   uint uVar4;
...
;
            ...
            if (iVar5 == -1) {
               ...
               *(uint*)( this + 0xfc ) = uVar8;
               if (*(uint*)( this + 0x100 ) < uVar8) {
                  if (( *(uint*)( this + 0x100 ) == 0 ) || ( uVar8 = uVar8 != 0 )) {
                     pvVar6 = (void*)Realloc(pvVar6, ( ulong )(uVar8 * *(int*)( this + 0xf8 )), uVar8, pcVar7, (int)lVar10);
                  ...
                  *(undefined4*)( this + 0x100 ) = 0;
                  ...
                  LAB_0010ac86:if (pvVar6 != (void*)0x0) {
                     memcpy((void*)( (long)pvVar6 + ( ulong )(( *(int*)( this + 0xfc ) + -1 ) * *(uint*)( this + 0xf8 )) ), &local_44, ( ulong ) * (uint*)( this + 0xf8 ));
                  }
 ...
 while ( (uint)lVar12 < local_58 );
   ...
   LAB_0010abeb:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* xatlas::internal::Mesh::computeFaceCenter(unsigned int) const */undefined8 xatlas::internal::Mesh::computeFaceCenter(Mesh *this, uint param_1) {
   undefined8 *puVar1;
   undefined8 *puVar2;
   undefined8 *puVar3;
   long lVar4;
   ...
   return CONCAT44(fVar16 * ( fVar15 + fVar10 ) * fVar8 + fVar11 * ( fVar15 + fVar13 ) * fVar8 + fVar7 * ( fVar13 + fVar10 ) * fVar8, fVar16 * ( fVar14 + fVar9 ) * fVar8 + fVar11 * ( fVar14 + fVar12 ) * fVar8 + fVar7 * ( fVar12 + fVar9 ) * fVar8);
}
/* xatlas::internal::MeshFaceGroups::compute() */void xatlas::internal::MeshFaceGroups::compute(MeshFaceGroups *this) {
   uint uVar1;
   Mesh *pMVar2;
   long lVar3;
   undefined1 auVar4[16];
   ...
   do {
      local_64 = 0xffffffff;
      if (uVar6 <= uVar16) {
         LAB_0010afd9:ArrayBase::~ArrayBase((ArrayBase*)&local_58);
         if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            return;
         }
      ...
      while (( *piVar13 != -1 || ( ( pcVar11 = *(char**)this(pcVar11[4] & 1U) != 0 && ( pcVar11 = *(char**)( pcVar11 + 0x10 ), pcVar11[uVar9] != '\0' ) ) ) )) {
         uVar9 = uVar9 + 1;
         piVar13 = piVar13 + 1;
...
;
      ...
      *(uint*)( this + 0x2c ) = uVar15;
      if (*(uint*)( this + 0x30 ) < uVar15) {
         if (( *(uint*)( this + 0x30 ) == 0 ) || ( uVar15 = uVar15 != 0 )) {
            auVar17 = Realloc(pvVar10, ( ulong )(uVar15 * *(int*)( this + 0x28 )), local_64, pcVar11, (int)in_R8);
         ...
         *(undefined4*)( this + 0x30 ) = 0;
         ...
         LAB_0010b07e:uVar9 = auVar17._8_8_;
         if (auVar17._0_8_ != 0) {
            memcpy((void*)( auVar17._0_8_ + ( ulong )(( *(int*)( this + 0x2c ) + -1 ) * *(uint*)( this + 0x28 )) ), &local_64, ( ulong ) * (uint*)( this + 0x28 ));
            uVar9 = extraout_RDX;
         }
      ...
      if ((uint)local_48 == 0) {
         ...
         LAB_0010b0c6:memcpy((void*)( (long)local_58 + ( ulong )(uint)(( iVar14 + -1 ) * (int)local_50) ), &local_64, local_50 & 0xffffffff);
      ...
      iVar14 = local_50._4_4_;
      if (local_50._4_4_ != 0) {
         LAB_0010b110:local_58 = auVar18._0_8_;
         uVar7 = iVar14 - 1;
         uVar15 = *(uint*)( (long)local_58 + (ulong)uVar7 * 4 );
         local_50 = CONCAT44(uVar7, (int)local_50);
         if ((uint)local_48 < uVar7) {
            if (( (uint)local_48 == 0 ) || ( uVar7 = uVar7 != 0 )) {
               local_58 = (void*)Realloc(local_58, ( ulong )(uVar7 * (int)local_50), auVar18._8_4_, pcVar11, (int)in_R8);
            }
         ...
         do {
            ...
            in_R8 = (ulong)uVar8;
            uVar8 = Mesh::findEdge(this_00, *(uint*)( *(long*)( pMVar2 + 0x40 ) + ( ulong )(uVar7 % 3 + uVar15) * 4 ), uVar8);
            ...
            if (uVar8 != 0xffffffff) {
               ...
               auVar18._12_4_ = 0;
               local_5c = uVar8 / 3;
               if (( ( uVar1 & 1 ) == 0 ) || ( in_R8 = *(ulong*)( this_00 + 0x10 ) * (char*)( in_R8 + local_5c ) == '\0' )) {
                  uVar9 = ( ulong )(uVar1 & 4);
                  iVar12 = -1;
                  if (( uVar1 & 4 ) != 0) {
                     uVar9 = ( ulong )(uVar8 / 3);
                     ...
                     if (*piVar13 == -1) {
                        ...
                        *(undefined4*)( lVar3 + uVar9 * 4 ) = 0xffffffff;
                        ...
                        if ((uint)local_48 < uVar8) {
                           if (( (uint)local_48 == 0 ) || ( uVar8 = uVar8 != 0 )) {
                              if (uVar8 * (int)local_50 != 0) {
                                 LAB_0010b2bb:auVar18 = ( *(code*)s_realloc )();
                           ...
                           LAB_0010b2cd:local_58 = auVar18._0_8_;
                           if (local_58 != (void*)0x0) {
                              memcpy((void*)( (long)local_58 + ( ulong )(uint)(( local_50._4_4_ + -1 ) * (int)local_50) ), &local_5c, local_50 & 0xffffffff);
 ...
 while ( true );
      ...
      LAB_0010b319:pvVar10 = *(void**)( this + 0x50 );
      uVar15 = *(int*)( this + 0x5c ) + 1;
      *(uint*)( this + 0x5c ) = uVar15;
      if (*(uint*)( this + 0x60 ) < uVar15) {
         if (( *(uint*)( this + 0x60 ) == 0 ) || ( uVar15 = uVar15 != 0 )) {
            pvVar10 = (void*)Realloc(pvVar10, ( ulong )(uVar15 * *(int*)( this + 0x58 )), iVar12, pcVar11, (int)in_R8);
         ...
         *(undefined4*)( this + 0x60 ) = 0;
         ...
         LAB_0010b352:if (pvVar10 != (void*)0x0) {
            memcpy((void*)( (long)pvVar10 + ( ulong )(( *(int*)( this + 0x5c ) + -1 ) * *(uint*)( this + 0x58 )) ), &local_60, ( ulong ) * (uint*)( this + 0x58 ));
         }
      ...
      if (( local_74 == -1 ) && ( s_print != (undefined*)0x0 )) {
         ( *(code*)s_print )("\rASSERT: %s %s %d\n", "group < kInvalid", "thirdparty/xatlas/xatlas.cpp", 0xb6a);
      }

   }
 while ( true );
   code_r0x0010b304:iVar14 = local_50._4_4_;
   if (local_50._4_4_ == 0) goto LAB_0010b319;
   goto LAB_0010b110;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* xatlas::internal::InvalidMeshGeometry::extract(xatlas::internal::Mesh const*,
   xatlas::internal::MeshFaceGroups const*) */void xatlas::internal::InvalidMeshGeometry::extract(Mesh *param_1, MeshFaceGroups *param_2) {
   ulong uVar1;
   void *pvVar2;
   void *pvVar3;
   char *in_RCX;
...
;
 ...
 while ( local_88 < uVar9 );
   LAB_0010b5ac:uVar1 = ( ulong ) * (uint*)( param_1 + 0xc );
      ...
      do {
         ...
         do {
            ...
            if (in_RCX == (char*)0x0) {
               ...
               for (uVar5 = *__src; uVar5 != 0xffffffff; uVar5 = *(uint*)( (long)local_58 + (ulong)uVar5 * 4 )) {
            ...
            if (local_60 < uVar9) {
               if (( local_60 == 0 ) || ( uVar9 = uVar9 != 0 )) {
                  pvVar2 = (void*)Realloc((void*)local_78._8_8_, ( ulong )(uVar9 * (int)local_68), (int)lVar4, in_RCX, iVar8);
               ...
               LAB_0010b7e5:if (pvVar2 != (void*)0x0) {
                  memcpy((void*)( (long)pvVar2 + ( ulong )(uVar5 * (int)local_68) ), &local_8c, local_68 & 0xffffffff);
               }
            ...
            if (uVar7 < uVar9) {
               ...
               LAB_0010b856:if (pvVar3 != (void*)0x0 && __src != (uint*)0x0) {
                  memcpy((void*)( ( ulong )(uVar6 * (int)local_50) + (long)pvVar3 ), __src, local_50 & 0xffffffff);
            ...
            *(uint*)( param_1 + 0x3c ) = uVar7;
            if (*(uint*)( param_1 + 0x40 ) < uVar7) {
               if (( *(uint*)( param_1 + 0x40 ) == 0 ) || ( uVar7 = uVar7 != 0 )) {
                  pvVar3 = (void*)Realloc(pvVar3, ( ulong )(uVar7 * *(int*)( param_1 + 0x38 )), uVar9, in_RCX, iVar8);
               ...
               LAB_0010b8fa:if (pvVar3 != (void*)0x0) {
                  memcpy((void*)( (long)pvVar3 + ( ulong )(( *(int*)( param_1 + 0x3c ) + -1 ) * *(uint*)( param_1 + 0x38 )) ), &local_8c, ( ulong ) * (uint*)( param_1 + 0x38 ));
               }

            }

            LAB_0010b6e4:uVar9 = iVar10 + iVar12;
            iVar10 = iVar10 + 1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* xatlas::internal::Progress::update() */ulong xatlas::internal::Progress::update(Progress *this) {
   Progress PVar1;
   uint uVar2;
   uint uVar3;
   uint uVar4;
   ...
   if ((float)( (uint)fVar7 & _LC37 ) < _LC36) {
      fVar7 = (float)( ( uint )((float)(int)fVar7 + (float)( -(uint)((float)(int)fVar7 < fVar7) & _LC4 )) | ~_LC37 & (uint)fVar7 );
   }
 ...
 while ( !bVar6 );
      uVar5 = ( **(code**)( this + 8 ) )(*(undefined4*)( this + 4 ), *(undefined4*)( this + 0x20 ), *(undefined8*)( this + 0x10 ));
      if ((char)uVar5 == '\0') {
         LOCK();
         PVar1 = *this;
         *this = (Progress)0x1;
...
/* xatlas::internal::TaskScheduler::TaskScheduler() */void xatlas::internal::TaskScheduler::TaskScheduler(TaskScheduler *this) {
   undefined1 *puVar1;
   undefined1 uVar2;
   undefined8 uVar3;
   int iVar4;
 ...
 while ( uVar8 < *(uint*)( this + 0x24 ) );
   ...
   if (uVar8 < 2) {
      *(undefined4*)( this + 0x14 ) = 1;
      if (*(int*)( this + 0x18 ) == 0) {
         LAB_0010c025:ArrayBase::setArrayCapacity((int)this + 8);
      ...
      *(uint*)( this + 0x14 ) = uVar8;
      ...
      LAB_0010c031:if (uVar8 == 0) goto LAB_0010c001;
   }
   ...
   do {
      ...
      std::condition_variable::condition_variable((condition_variable*)( (undefined8*)( lVar5 + lVar10 ) + 6 ));
      LOCK();
 ...
 while ( uVar8 < *(uint*)( this + 0x14 ) );
   LAB_0010c001:if (local_40 != *(long*)( in_FS_OFFSET + 10 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* xatlas::internal::TaskScheduler::createTaskGroup(void*, unsigned int) */ulong xatlas::internal::TaskScheduler::createTaskGroup(void *param_1, uint param_2) {
   char *pcVar1;
   char cVar2;
   byte bVar3;
   long lVar4;
 ...
 while ( bVar3 != 0 );
            ...
            if (*(uint*)( pcVar1 + 0x18 ) < in_EDX) {
               uVar5 = Realloc(*(void**)( pcVar1 + 8 ), ( ulong )(in_EDX * *(int*)( pcVar1 + 0x10 )), (uint)bVar3, (char*)0x1, in_R8D);
 ...
 while ( (uint)uVar6 < *(uint*)( (long)param_1 + 0x24 ) );
   ...
   uVar6 = 0xffffffff;
   LAB_0010c0fb:if (lVar4 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* xatlas::internal::param::runMeshComputeChartsTask(void*, void*) */void xatlas::internal::param::runMeshComputeChartsTask(void *param_1, void *param_2) {
   char cVar1;
   ...
   if (**(char**)( (long)param_1 + 0x10 ) == '\0') {
      ...
      *(undefined4*)( this + 0x18 ) = 0;
      for (int i = 0; i < 3; i++) {
         ...
         *(undefined8*)( this + ( 24*i + 40 ) ) = uVar7;
         *(undefined4*)( this + ( 24*i + 48 ) ) = 0;
      }
 ...
 while ( (char*)(ulong)uVar3 != pcVar11 + 1 );
            ...
            do {
               ...
               *(float*)( local_e8 + (long)pcVar9 * 4 ) = (float)*(uint*)( *(long*)( *(long*)( lVar6 + 0x10 ) + 0x50 ) + in_R8 * 4 );
 ...
 while ( cVar1 != '\0' );
            ...
            *(uint*)( lVar15 + 0x14 ) = uVar13;
            if (*(uint*)( lVar15 + 0x18 ) < uVar13) {
               if (( *(uint*)( lVar15 + 0x18 ) == 0 ) || ( uVar13 = uVar13 != 0 )) {
                  pvVar10 = (void*)Realloc(pvVar10, ( ulong )(uVar13 * *(int*)( lVar15 + 0x10 )), uVar13, pcVar11, (int)in_R8);
               ...
               *(undefined4*)( lVar15 + 0x18 ) = 0;
               ...
               LAB_0010c4de:if (pvVar10 != (void*)0x0) {
                  memcpy((void*)( (long)pvVar10 + ( ulong )(( *(int*)( lVar15 + 0x14 ) + -1 ) * *(uint*)( lVar15 + 0x10 )) ), &local_f8, ( ulong ) * (uint*)( lVar15 + 0x10 ));
               }
...
;
         TaskScheduler::wait((TaskScheduler*)**(undefined8**)( (long)param_1 + 0x18 ), (TaskGroupHandle*)&local_fc);
...
/* xatlas::internal::TaskScheduler::run(xatlas::internal::TaskGroupHandle, xatlas::internal::Task
   const&) */void xatlas::internal::TaskScheduler::run(long *param_1, uint param_2, void *param_3, undefined8 param_4, int param_5) {
   byte bVar1;
   void *pvVar2;
   long lVar3;
   uint uVar4;
 ...
 while ( bVar1 != 0 );
   ...
   *(uint*)( lVar3 + 0x14 ) = uVar4;
   if (*(uint*)( lVar3 + 0x18 ) < uVar4) {
      if (( *(uint*)( lVar3 + 0x18 ) != 0 ) && ( uVar4 = uVar4 == 0 )) {
         if (pvVar2 != (void*)0x0) {
      ...
      pvVar2 = (void*)Realloc(pvVar2, ( ulong )(uVar4 * *(int*)( lVar3 + 0x10 )), (uint)bVar1, (char*)0x1, param_5);
      *(uint*)( lVar3 + 0x18 ) = uVar4;
      *(void**)( lVar3 + 8 ) = pvVar2;
   }

   if (pvVar2 != (void*)0x0) {
      memcpy((void*)( (long)pvVar2 + ( ulong )(( *(int*)( lVar3 + 0x14 ) + -1 ) * *(uint*)( lVar3 + 0x10 )) ), param_3, ( ulong ) * (uint*)( lVar3 + 0x10 ));
   }

   LAB_0010c721:*(undefined1*)( lVar3 + 0x24 ) = 0;
   LOCK();
...
/* xatlas::internal::UniformGrid2::traverse(xatlas::internal::Vector2, xatlas::internal::Vector2) */void xatlas::internal::UniformGrid2::traverse(undefined8 param_1, undefined8 param_2, UniformGrid2 *this) {
   float fVar1;
   void *pvVar2;
   char *pcVar3;
   uint uVar4;
   ...
   uVar13 = 0;
   if (( 0.0 <= fVar16 / fVar1 ) && ( uVar8 = ( ulong )(fVar16 / fVar1) ),in_R8 = uVar8 & 0xffffffff,uVar13 = in_R8,uVar6 <= (uint)uVar8) {
      in_R8 = (ulong)uVar6;
      uVar13 = in_R8;
   }
   ...
   uVar6 = 0;
   if (( 0.0 <= fVar14 ) && ( uVar6 = uVar4 <= uVar6 )) {
      uVar6 = uVar4;
   }
   ...
   *(undefined4*)( this + 0xa4 ) = 0;
   ...
   LAB_0010c9d0:if ((uint)pcVar10 != uVar6) goto LAB_0010c9e2;
   LAB_0010c9d5:if ((uint)uVar13 != local_58) {
      LAB_0010c9e2:uVar4 = (uint)pcVar10;
      if (local_68 <= local_64) goto LAB_0010cae8;
      LAB_0010c9f6:local_64 = local_64 + local_54;
      ...
      if (uVar4 < uVar5) {
         do {
            ...
            if (uVar7 == 0xffffffff) {
               ...
               LAB_0010cb4b:if (uVar4 < uVar6) break;
            }
 else {
               if (local_58 < uVar12) break;
               if (uVar9 == 0xffffffff) goto LAB_0010cb4b;
               LAB_0010ca3a:if (uVar6 < uVar4) break;
            }
            ...
            *(uint*)( this + 0xa4 ) = uVar5;
            if (*(uint*)( this + 0xa8 ) < uVar5) {
               if (( *(uint*)( this + 0xa8 ) != 0 ) && ( uVar5 = uVar5 == 0 )) {
                  if (pvVar2 != (void*)0x0) {
               ...
               pvVar2 = (void*)Realloc(pvVar2, ( ulong )(uVar5 * *(int*)( this + 0xa0 )), uVar5, pcVar3, (int)in_R8);
               *(void**)( this + 0x98 ) = pvVar2;
               *(uint*)( this + 0xa8 ) = uVar5;
            }

            if (pvVar2 == (void*)0x0) goto LAB_0010c9d0;
            memcpy((void*)( (long)pvVar2 + ( ulong )(( *(int*)( this + 0xa4 ) + -1 ) * *(uint*)( this + 0xa0 )) ), &local_44, ( ulong ) * (uint*)( this + 0xa0 ));
            if (uVar4 == uVar6) goto LAB_0010c9d5;
            if (local_64 < local_68) goto LAB_0010c9f6;
            LAB_0010cae8:local_68 = local_68 + local_50;
...
/* WARNING: Type propagation algorithm not settling *//* xatlas::internal::UniformGrid2::createGrid() */undefined8 xatlas::internal::UniformGrid2::createGrid(UniformGrid2 *this) {
   float *pfVar1;
   float fVar2;
   float fVar3;
   uint uVar4;
   ...
   *(float*)( this + 0x38 ) = fVar22;
   ...
   if (0.0 < fVar22) {
      ...
      if ((float)( (uint)fVar20 & _LC37 ) < _LC36) {
         fVar20 = (float)( ( uint )((float)(int)fVar20 + (float)( -(uint)((float)(int)fVar20 < fVar20) & _LC4 )) | ~_LC37 & (uint)fVar20 );
      }
      ...
      *(uint*)( this + 0x44 ) = uVar7;
      if ((float)( (uint)fVar21 & uVar19 ) < fVar23) {
         fVar21 = (float)( ( uint )((float)(int)fVar21 + (float)( -(uint)((float)(int)fVar21 < fVar21) & _LC4 )) | ~uVar19 & (uint)fVar21 );
      }
         ...
         if (uVar4 != 0) {
            do {
               ...
               if (*(int*)( this + 0x30 ) == 0) {
                  ...
                  uVar8 = ( ulong ) * (uint*)( *(long*)( this + 0x28 ) + uVar8 * 4 );
                  uVar11 = *(undefined8*)( lVar9 + ( ulong ) * (uint*)( *(long*)( this + 0x28 ) + uVar15 * 4 ) * 8 );
               }
               ...
               if (*(int*)( this + 0xa4 ) != 0) {
                  LAB_0010cf5f:do {
                     ...
                     puVar16 = (uint*)( *(long*)( this + 0x50 ) + ( ulong ) * (uint*)( *(long*)( this + 0x98 ) + lVar17 * 4 ) * 4 );
                     uVar19 = *puVar16;
...
;
                     ...
                     *(uint*)( this + 0x74 ) = uVar19;
                     if (uVar19 <= *(uint*)( this + 0x78 )) {
                        LAB_0010cef0:iVar14 = auVar6._8_4_;
                        ...
                        *(uint*)( this + 0x74 ) = uVar19;
                        ...
                        LAB_0010cf33:if (pvVar10 != (void*)0x0) {
                           memcpy((void*)( (long)pvVar10 + ( ulong )(( *(int*)( this + 0x74 ) + -1 ) * *(uint*)( this + 0x70 )) ), local_48 + 1, ( ulong ) * (uint*)( this + 0x70 ));
                        }

                        LAB_0010cf4f:lVar17 = lVar17 + 1;
                        if (*(uint*)( this + 0xa4 ) <= (uint)lVar17) break;
                        goto LAB_0010cf5f;
                     }

                     uVar7 = uVar19;
                     if (( *(uint*)( this + 0x78 ) == 0 ) || ( uVar7 = uVar7 != 0 )) {
                        auVar24 = Realloc(pvVar10, ( ulong )(uVar7 * *(int*)( this + 0x70 )), (int)puVar16, pcVar13, (int)in_R8);
                        auVar6 = auVar24._0_12_;
                     ...
                     *(undefined4*)( this + 0x78 ) = 0;
                     LAB_0010d06e:uVar7 = *(uint*)( this + 0x78 );
                     uVar19 = uVar19 + 1;
                     local_48[1] = 0xffffffff;
                     pvVar10 = (void*)0x0;
                     *(uint*)( this + 0x74 ) = uVar19;
                     if (uVar19 <= uVar7) goto LAB_0010cf4f;
                     LAB_0010d08c:local_48[1] = 0xffffffff;
                     if (( uVar7 == 0 ) || ( uVar19 = uVar19 != 0 )) {
                        pvVar10 = (void*)Realloc(pvVar10, ( ulong )(uVar19 * *(int*)( this + 0x70 )), iVar14, pcVar13, (int)in_R8);
 ...
 while ( lVar18 != (ulong)uVar4 * 4 );
   ...
   uVar11 = 0;
   LAB_0010cfaf:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar11;
   }
...
/* xatlas::internal::segment::AtlasData::compute() */void xatlas::internal::segment::AtlasData::compute(AtlasData *this) {
   float *pfVar1;
   float *pfVar2;
   float *pfVar3;
   float *pfVar4;
   ...
   if (2 < uVar23) {
      ...
      do {
         ...
         do {
            ...
            uVar16 = uVar15 + 1;
            pfVar2 = (float*)( lVar22 + ( ulong ) * (uint*)( lVar20 + ( ulong )(( uVar15 % 3 + 1 ) % 3 + ( uVar15 / 3 ) * 3) * 4 ) * 0xc );
            *(float*)( lVar9 + lVar17 ) = SQRT(( *pfVar2 - *pfVar1 ) * ( *pfVar2 - *pfVar1 ) + ( pfVar2[1] - pfVar1[1] ) * ( pfVar2[1] - pfVar1[1] ) + ( pfVar2[2] - pfVar1[2] ) * ( pfVar2[2] - pfVar1[2] ));
            lVar17 = lVar17 + 4;
            uVar15 = uVar16;
         }
 while ( uVar16 != uVar23 );
         ...
         *(float*)( lVar14 + lVar21 * 4 ) = SQRT(fVar26 * fVar26 + fVar28 * fVar28 + fVar30 * fVar30) * fVar27;
         if (AVar7 != (AtlasData)0x0) {
            ...
            fVar26 = pfVar4[1];
            fVar28 = *pfVar4;
            *(float*)( *(long*)( this + 0x80 ) + lVar21 * 4 ) = ( ( *pfVar5 - fVar28 ) * ( pfVar6[1] - fVar26 ) - ( pfVar5[1] - fVar26 ) * ( *pfVar6 - fVar28 ) ) * fVar27;
         }
         ...
         fVar31 = fVar29 * ( (float)( ( ulong ) * (undefined8*)( pfVar2 + 1 ) >> 0x20 ) - fVar28 ) - ( (float)( ( ulong ) * (undefined8*)( pfVar3 + 1 ) >> 0x20 ) - fVar28 ) * fVar33;
...
/* xatlas::internal::segment::OriginalUvCharts::floodfillFaces(xatlas::internal::segment::OriginalUvCharts::Chart&)
    */void xatlas::internal::segment::OriginalUvCharts::floodfillFaces(OriginalUvCharts *this, Chart *param_1) {
   float *pfVar1;
   float fVar2;
   float fVar4;
   int iVar5;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   lVar19 = *(long*)this;
   pfVar1 = (float*)( *(long*)( lVar19 + 0x80 ) + ( ulong ) * (uint*)( *(long*)( this + 0x38 ) + ( ulong ) * (uint*)param_1 * 4 ) * 4 );
   fVar2 = *pfVar1;
   fVar3 = *pfVar1;
   do {
      iVar5 = *(int*)( param_1 + 4 );
      ...
      do {
         ...
         LAB_0010d6d8:do {
            ...
            if (uVar20 != 0xffffffff) {
               ...
               if (( ( ( uVar20 & *(uint*)( *(long*)( lVar19 + 0xb8 ) + uVar15 * 4 ) ) == 0 ) && ( fVar4 = *(float*)( *(long*)( lVar19 + 0x80 ) + uVar17 * 4 ) ),_LC19 < (float)( (uint)fVar4 & _LC37 ) )) {
                  pVVar18 = *(Vector2**)( lVar19 + 0x30 );
                  pVVar16 = *(Vector2**)( pVVar18 + 0x88 );
                  uVar17 = ( ulong ) * (uint*)( *(long*)( lVar6 + 0x40 ) + ( ulong )(uVar13 % 3 + uVar7) * 4 );
                  cVar9 = equal(pVVar18, pVVar16, *(float*)( pVVar16 + ( ulong ) * (uint*)( *(long*)( lVar6 + 0x40 ) + ( ulong )(uVar7 + uVar14) * 4 ) * 8 ));
                  if (( cVar9 != '\0' ) && ( cVar9 = equal(pVVar18, pVVar16, *(float*)( pVVar16 + uVar17 * 8 )) ),cVar9 != '\0') {
                     uVar12 = *(int*)( this + 0x44 ) + 1;
                     lVar10 = *(long*)( this + 0x38 );
                     *(uint*)( this + 0x44 ) = uVar12;
                     if (*(uint*)( this + 0x48 ) < uVar12) {
                        if (( *(uint*)( this + 0x48 ) == 0 ) || ( uVar12 = uVar12 != 0 )) {
                           if (uVar12 * *(int*)( this + 0x40 ) != 0) {
                              LAB_0010d89a:lVar10 = ( *(code*)s_realloc )(lVar10);
                        ...
                        LAB_0010d8c1:if (lVar10 == 0) {
                           lVar19 = *(long*)this;
                        }
 else {
                           memcpy((void*)( ( ulong )(( *(int*)( this + 0x44 ) + -1 ) * *(uint*)( this + 0x40 )) + lVar10 ), &local_44, ( ulong ) * (uint*)( this + 0x40 ));
                           lVar19 = *(long*)this;
                        }
...
/* xatlas::internal::segment::OriginalUvCharts::compute() */void xatlas::internal::segment::OriginalUvCharts::compute(OriginalUvCharts *this) {
   uint uVar1;
   undefined8 *puVar2;
   int iVar3;
   long lVar4;
   ...
   *(undefined4*)( this + 0x44 ) = 0;
   ...
   if (uVar12 < 3) {
      *(undefined4*)( this + 0x2c ) = 0;
      ...
      pcVar9 = (char*)0x0;
      while (true) {
         if (( ( 1 << ( (byte)pcVar9 & 0x1f ) & *(uint*)( *(long*)( lVar11 + 0xb8 ) + ( (ulong)pcVar9 >> 5 ) * 4 ) ) == 0 ) && ( _LC19 < (float)( *(uint*)( *(long*)( lVar11 + 0x80 ) + (long)pcVar9 * 4 ) & _LC37 ) )) {
         ...
         do {
            ...
            *(uint*)( this + 0x5c ) = uVar1;
            ...
            if (*(uint*)( this + 0x60 ) < uVar1) {
               if (uVar12 != 0) {
                  pcVar14 = (char*)Realloc(pcVar14, ( ulong )(uVar1 * *(int*)( this + 0x58 )), uVar1, pcVar9, (int)pcVar14);
                  uVar12 = puVar17[1];
                  uVar10 = *(uint*)( this + 0x5c );
                  *(char**)( this + 0x50 ) = pcVar14;
                  LAB_0010dbc5:*(uint*)( this + 0x60 ) = uVar1;
                  goto LAB_0010dbc9;
               }
               ...
               LAB_0010dbc9:if (uVar12 != 0) {
                  ...
                  do {
                     ...
                     do {
                        ...
                        *(undefined4*)( (Fit*)pcVar14 + (ulong)uVar1 * 0xc + 8 ) = *(undefined4*)( puVar2 + 1 );
                     }
 while ( iVar8 != 3 );
                     iVar13 = iVar13 + 3;
 ...
 while ( iVar13 != uVar12 * 3 );
            ...
            if (cVar7 == '\0') {
               ...
               *(float*)( (long)puVar2 + 0xc ) = fVar21 * extraout_XMM1_Da - fVar20 * fVar18;
               puVar2[2] = CONCAT44(fVar18 * fVar22 - (float)local_50 * (float)( (ulong)uVar23 >> 0x20 ), (float)local_50 * fVar24 - extraout_XMM1_Da * (float)uVar23);
...
/* xatlas::internal::segment::PlanarCharts::compute() */void xatlas::internal::segment::PlanarCharts::compute(PlanarCharts *this) {
   uint *puVar1;
   float *pfVar2;
   ulong *puVar3;
   ulong *puVar4;
 ...
 while ( (uint)lVar11 < uVar34 / 3 );
      ...
      uVar5 = 0;
      do {
         while (( *(int*)( *(long*)( this + 0x20 ) + (long)pcVar15 * 4 ) != (int)pcVar15 || ( ( 1 << ( (byte)pcVar15 & 0x1f ) & *(uint*)( *(long*)( *(long*)this + 0xb8 ) + ( (ulong)pcVar15 >> 5 ) * 4 ) ) != 0 ) )) {
            local_6c = local_6c + 1;
...
;
         ...
         joined_r0x0010e04f:if (uVar19 != 0) {
            ...
            *(uint*)( *(long*)( this + 0x38 ) + uVar24 * 4 ) = uVar5;
            if ((uint)local_48 < uVar10) {
               uVar17 = uVar10;
               if (( (uint)local_48 == 0 ) || ( uVar17 = uVar17 != 0 )) {
            ...
            uVar27 = uVar25;
            LAB_0010e100:local_58 = auVar36._0_8_;
            ...
            do {
               if (uVar10 != 0xffffffff) {
                  ...
                  if (( *puVar1 == uVar10 / 3 ) && ( auVar36 = auVar7(1 << ( (byte)pcVar15 & 0x1f ) & *(uint*)( *(long*)( *(long*)this + 0xb8 ) + ( (ulong)uVar10 / 0x60 ) * 4 )) == 0 )) {
                     ...
                     if ((float)( ( uint )(fVar28 - fVar33) & uVar16 ) <= fVar30) {
                        ...
                        *(uint*)( *(long*)( this + 0x38 ) + uVar18 * 4 ) = uVar5;
                        if ((uint)local_48 < uVar10) {
                           uVar17 = uVar10;
                           if ((uint)local_48 == 0) {
                              LAB_0010e1fa:local_58 = (void*)Realloc(local_58, ( ulong )(uVar17 * (int)local_50), uVar17, (char*)(ulong)uVar10, iVar23);
                              uVar18 = (ulong)uVar17;
                              local_48 = CONCAT44(local_48._4_4_, uVar17);
                              fVar33 = _LC4;
                              uVar16 = _LC37;
                           ...
                           LAB_0010e249:if (local_58 != (void*)0x0) {
                              memcpy((void*)( (long)local_58 + ( ulong )(uint)(iVar23 * (int)local_50) ), &local_68, local_50 & 0xffffffff);
 ...
 while ( local_6c < uVar26 );
      LAB_0010e31a:ArrayBase::resize(iVar6 + 0x50, SUB41(uVar5, 0));
      pvVar14 = *(void**)( this + 0x50 );
      if (( pvVar14 != (void*)0x0 ) && ( uVar16 = uVar16 != 0 )) {
         LAB_0010e928:memset(pvVar14, 0, ( ulong )(uVar16 * *(int*)( this + 0x58 )));
 ...
 while ( (uint)lVar13 < uVar26 );
      LAB_0010e37b:*(undefined4*)( this + 0x74 ) = 0;
      uVar24 = 0;
      *(undefined4*)( this + 0x8c ) = 0;
      fVar33 = _LC9;
      if (uVar5 != 0) {
         LAB_0010e3b3:lVar20 = *(long*)this;
         ...
         do {
            ...
            do {
               ...
               if (( ( ( uVar10 != 0xffffffff ) && ( *(int*)( *(long*)( this + 0x38 ) + ( (ulong)uVar10 / 3 ) * 4 ) != (int)uVar24 ) ) && ( fVar30 = *(float*)( *(long*)( lVar20 + 0x38 ) + (ulong)uVar19 * 4 ) ),0.0 < fVar30 )) goto LAB_0010e5f0;
               uVar19 = uVar19 + 1;
            }
 while ( uVar19 != uVar16 );
         ...
         do {
            ...
            *(uint*)( this + 0x8c ) = uVar16;
            ...
            if (*(uint*)( this + 0x90 ) < uVar16) {
               if (( *(uint*)( this + 0x90 ) == 0 ) || ( uVar16 = uVar16 != 0 )) {
                  pvVar14 = (void*)Realloc(pvVar14, ( ulong )(uVar16 * *(int*)( this + 0x88 )), uVar16, (char*)(ulong)uVar26, (int)in_R8);
               ...
               LAB_0010e46f:if (pvVar14 != (void*)0x0) {
                  memcpy((void*)( (long)pvVar14 + ( ulong )(( *(int*)( this + 0x8c ) + -1 ) * *(uint*)( this + 0x88 )) ), &local_6c, ( ulong ) * (uint*)( this + 0x88 ));
               }
 ...
 while ( true );
   ...
   uVar21 = false;
   LAB_0010e60a:pcVar15 = (char*)( this + 0x98 );
   ...
   if (*(int*)( this + 0x74 ) != 0) {
      ...
      do {
         ...
         puVar4 = (ulong*)( *(long*)( *(long*)this + 0x98 ) + ( ulong ) * (uint*)( *(long*)( this + 0x80 ) + ( ulong ) * (uint*)( *(long*)( this + 0x68 ) + lVar20 * 8 ) * 4 ) * 0xc );
         puVar3[3] = *puVar4;
         uVar24 = puVar3[3];
         fVar30 = (float)uVar24;
         ...
         *(float*)( (long)puVar3 + 0xc ) = fVar35 * extraout_XMM1_Da - fVar29 * fVar31;
         ...
         puVar3[2] = CONCAT44(fVar30 * fVar31 - (float)local_68 * (float)( uVar24 >> 0x20 ), fVar28 * (float)local_68 - extraout_XMM1_Da * (float)uVar24);
 ...
 while ( (uint)lVar20 < uVar26 );
   ...
   return;
   LAB_0010e5da:local_6c = uVar26;
   ArrayBase::push_back((uchar*)( this + 0x68 ));
   fVar33 = _LC9;
   LAB_0010e5f0:uVar24 = uVar24 + 1;
   if (uVar24 == uVar5) goto code_r0x0010e602;
   goto LAB_0010e3b3;
   code_r0x0010e602:uVar21 = ( undefined1 ) * (undefined4*)( this + 0x74 );
   goto LAB_0010e60a;
}
/* xatlas::internal::segment::ClusteredCharts::relocateSeeds() */undefined1 xatlas::internal::segment::ClusteredCharts::relocateSeeds(ClusteredCharts *this) {
   uint uVar1;
   long lVar2;
   char *pcVar3;
   void *__dest;
         ...
         *(undefined4*)( this + 0x74 ) = 0;
         if (uVar10 == 0) {
            ...
            do {
               ...
               fVar15 = _LC4 - ( (float)local_4c * *(float*)( lVar2 + 0x1c ) + local_4c._4_4_ * *(float*)( lVar2 + 0x20 ) + local_44 * *(float*)( lVar2 + 0x24 ) );
               if (_LC4 <= fVar15) {
                  fVar15 = _LC4;
               }
               ...
               if (( uVar12 == 0 ) || ( fVar15 < pfVar6[( ulong )(uVar12 - 1) * 2] )) {
                  ...
                  *(uint*)( this + 0x74 ) = uVar12;
                  if (*(uint*)( this + 0x78 ) < uVar12) {
                     if (( *(uint*)( this + 0x78 ) != 0 ) && ( uVar12 = uVar12 == 0 )) {
                        if (pfVar6 != (float*)0x0) {
                           if (s_free == (undefined*)0x0) {
                     ...
                     pfVar6 = (float*)Realloc(pfVar6, ( ulong )(uVar12 * *(int*)( this + 0x70 )), uVar13, pcVar3, in_R8D);
                  ...
                  if (pfVar6 != (float*)0x0) {
                     memcpy((void*)( (long)pfVar6 + ( ulong )(( (int)uVar7 + -1 ) * *(uint*)( this + 0x70 )) ), &local_4c, ( ulong ) * (uint*)( this + 0x70 ));
                     uVar7 = ( ulong ) * (uint*)( this + 0x74 );
                  }
                  ...
                  *(uint*)( this + 0x74 ) = uVar12;
                  if (*(uint*)( this + 0x78 ) < uVar12) {
                     if (( *(uint*)( this + 0x78 ) != 0 ) && ( uVar12 = uVar12 == 0 )) {
                        if (pfVar6 != (float*)0x0) {
                           ...
                           LAB_0010ecfc:*(undefined8*)( this + 0x68 ) = 0;
                           uVar7 = ( ulong ) * (uint*)( this + 0x74 );
                        }

                        LAB_0010ed08:*(undefined4*)( this + 0x78 ) = 0;
                        goto LAB_0010eb10;
                     }
                  ...
                  if (pfVar6 != (float*)0x0) {
                     ...
                     if (uVar9 < uVar12) {
                        ...
                        memmove((void*)( (long)pfVar6 + (ulong)uVar4 ), (void*)( ( ulong )(uVar4 - uVar13) + (long)pfVar6 ), ( ulong )(( uVar12 - uVar9 ) * uVar13));
                        pfVar6 = *(float**)( this + 0x68 );
                        if (pfVar6 == (float*)0x0) {
                           uVar7 = ( ulong ) * (uint*)( this + 0x74 );
                           goto LAB_0010eb10;
                     ...
                     uVar7 = (ulong)uVar13;
                     if (( *(uint*)( this + 0x60 ) < uVar13 ) && ( __dest = *(void**)( this + 0x68 ) ),__dest != (void*)0x0) {
                        if (uVar13 != 1) {
                           memmove(__dest, (void*)( (long)__dest + ( ulong ) * (uint*)( this + 0x70 ) ), ( ulong )(( uVar13 - 1 ) * *(uint*)( this + 0x70 )));
                           uVar13 = *(uint*)( this + 0x74 );
                           uVar7 = (ulong)uVar13;
               ...
               if (*(uint*)( this + 0x78 ) < uVar12) {
                  if (( *(uint*)( this + 0x78 ) == 0 ) || ( uVar12 = uVar12 != 0 )) {
                     if (uVar12 * *(int*)( this + 0x70 ) == 0) {
                        ...
                        LAB_0010ec4d:uVar8 = ( *(code*)s_realloc )();
                        uVar7 = ( ulong ) * (uint*)( this + 0x74 );
                     }
...
/* xatlas::internal::segment::ClusteredCharts::isChartParameterizationValid(xatlas::internal::segment::ClusteredCharts::Chart
   const*) */uint xatlas::internal::segment::ClusteredCharts::isChartParameterizationValid(ClusteredCharts *this, Chart *param_1) {
   float fVar1;
   float fVar2;
   uint uVar3;
   void *pvVar4;
   ...
   if (uVar3 == 0) {
      ...
      *(undefined4*)( this + 0xf4 ) = 0;
      LAB_0010f150:uVar14 = UniformGrid2::intersect(*puVar8, this + 0x98, 0, 0, 0, 0);
      uVar14 = uVar14 ^ 1;
   }
 else {
      ...
      do {
         ...
         piVar7 = piVar7 + 1;
         uVar9 = uVar9 + ( ( ( *(float*)( (long)( pcVar5 + ( ulong )(uVar14 + 2) * 8 ) + 4 ) - fVar1 ) * ( *(float*)( pcVar5 + ( ulong )(uVar14 + 1) * 8 ) - fVar2 ) - ( *(float*)( (long)( pcVar5 + ( ulong )(uVar14 + 1) * 8 ) + 4 ) - fVar1 ) * ( *(float*)( pcVar5 + ( ulong )(uVar14 + 2) * 8 ) - fVar2 ) ) * _LC11 < 0.0 );
      }
 while ( piVar7 != piVar12 );
      if (( uVar9 == 0 ) || ( uVar14 = uVar3 == uVar9 )) {
         lVar10 = *(long*)this;
         *(char**)( this + 0xb0 ) = pcVar5;
         lVar13 = 0;
         *(undefined4*)( this + 0xa4 ) = 0;
         ...
         *(undefined4*)( this + 0xf4 ) = 0;
         do {
            ...
            do {
               ...
               if (( uVar6 == 0xffffffff ) || ( pcVar5 = (char*)( ulong ) * (uint*)param_1 * (uint*)( *(long*)( this + 0x30 ) + ( (ulong)uVar6 / 3 ) * 4 ) != *(uint*)param_1 )) {
                  pvVar4 = *(void**)( this + 0x98 );
                  uVar6 = *(int*)( this + 0xa4 ) + 1;
                  *(uint*)( this + 0xa4 ) = uVar6;
                  local_44 = uVar9;
                  if (*(uint*)( this + 0xa8 ) < uVar6) {
                     if (( *(uint*)( this + 0xa8 ) == 0 ) || ( uVar6 = uVar6 != 0 )) {
                        pvVar4 = (void*)Realloc(pvVar4, ( ulong )(uVar6 * *(int*)( this + 0xa0 )), uVar6, pcVar5, (int)piVar12);
                     ...
                     LAB_0010f070:if (pvVar4 != (void*)0x0) {
                        memcpy((void*)( (long)pvVar4 + ( ulong )(( *(int*)( this + 0xa4 ) + -1 ) * *(uint*)( this + 0xa0 )) ), &local_44, ( ulong ) * (uint*)( this + 0xa0 ));
                     }
...
/* xatlas::internal::segment::ClusteredCharts::isNormalSeam(unsigned int) const */bool xatlas::internal::segment::ClusteredCharts::isNormalSeam(ClusteredCharts *this, uint param_1) {
   float *pfVar1;
   float *pfVar2;
   uint uVar3;
   uint uVar4;
   ...
   if (uVar3 != 0xffffffff) {
      if (( *(byte*)( lVar7 + 4 ) & 2 ) == 0) {
         if (*(int*)( *(long*)( *(long*)( this + 8 ) + 0x38 ) + ( ulong )(uVar3 / 3) * 4 ) != *(int*)( *(long*)( *(long*)( this + 8 ) + 0x38 ) + ( ulong )(param_1 / 3) * 4 )) {
         ...
         if (( uVar3 != uVar4 ) || ( uVar5 != uVar6 )) {
            ...
            if (( (float)( ( uint )(*pfVar2 - *pfVar1) & _LC37 ) <= _LC7 ) && ( ( (float)( ( uint )(pfVar2[1] - pfVar1[1]) & _LC37 ) <= _LC7 && ( (float)( ( uint )(pfVar2[2] - pfVar1[2]) & _LC37 ) <= _LC7 ) ) )) {
               pfVar1 = (float*)( lVar7 + (ulong)uVar5 * 0xc );
               pfVar2 = (float*)( lVar7 + (ulong)uVar6 * 0xc );
               if (( (float)( ( uint )(*pfVar2 - *pfVar1) & _LC37 ) <= _LC7 ) && ( (float)( ( uint )(pfVar2[1] - pfVar1[1]) & _LC37 ) <= _LC7 )) {
...
/* xatlas::internal::segment::ClusteredCharts::computeNormalSeamMetric(xatlas::internal::segment::ClusteredCharts::Chart*,
   unsigned int) const */void xatlas::internal::segment::ClusteredCharts::computeNormalSeamMetric(ClusteredCharts *this, Chart *param_1, uint param_2) {
   uint uVar1;
   long lVar2;
   long lVar3;
   long lVar4;
   ...
   do {
      ...
      while (true) {
         do {
            ...
            uVar11 = (uint)uVar12;
            if (( ( uVar1 != 0xffffffff ) && ( *(int*)( *(long*)( this + 0x30 ) + ( ulong )(uVar1 / 3) * 4 ) == *(int*)param_1 ) ) && ( ( lVar5 = *(long*)( lVar2 + 0x40 ) * (int*)( lVar5 + uVar9 * 4 ) != *(int*)( lVar5 + ( ulong )(( uVar1 % 3 + 1 ) % 3 + ( uVar1 / 3 ) * 3) * 4 ) || ( iVar6 = (int)( uVar9 / 3 ) * (int*)( lVar5 + ( ulong )(( uVar11 + iVar6 * -3 + 1 ) % 3 + iVar6 * 3) * 4 ) != *(int*)( lVar5 + (ulong)uVar1 * 4 ) ) ) )) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* xatlas::internal::segment::ClusteredCharts::computeCost(xatlas::internal::segment::ClusteredCharts::Chart*,
   unsigned int) const */float xatlas::internal::segment::ClusteredCharts::computeCost(ClusteredCharts *this, Chart *param_1, uint param_2) {
   undefined8 *puVar1;
   float *pfVar2;
   float *pfVar3;
   float fVar4;
 ...
 while ( param_2 != uVar24 );
   ...
   uVar22 = uVar24;
   fVar28 = fVar5;
   LAB_0010f788:uVar19 = ( ulong )(uVar22 * 3);
   uVar20 = 0;
   uVar21 = uVar19;
   LAB_0010f798:uVar9 = *(uint*)( lVar16 + uVar19 * 4 );
   fVar33 = *(float*)( lVar15 + uVar19 * 4 );
   do {
      if (uVar9 == 0xffffffff) {
         LAB_0010f7bf:fVar28 = fVar28 + fVar33;
      }
      ...
      if (uVar20 == 3) {
         ...
         fVar33 = _LC4 - ( local_44 * *(float*)( param_1 + 0x1c ) + fStack_40 * *(float*)( param_1 + 0x20 ) + *(float*)( puVar1 + 1 ) * *(float*)( param_1 + 0x24 ) );
 ...
 while ( true );
   LAB_0010f9b0:uVar19 = ( ulong )(uVar22 * 3);
   uVar20 = 0;
   uVar21 = uVar19;
   LAB_0010f9c0:uVar9 = *(uint*)( lVar16 + uVar19 * 4 );
   fVar30 = *(float*)( lVar15 + uVar19 * 4 );
   do {
      if (uVar9 == 0xffffffff) {
         LAB_0010f9e7:fVar29 = fVar29 + fVar30;
      }
 else if (iVar8 != *(int*)( lVar14 + ( (ulong)uVar9 / 3 ) * 4 )) {
 ...
 while ( true );
   LAB_0010fa88:uVar20 = 0;
   uVar19 = ( ulong )(uVar22 * 3);
   uVar21 = uVar19;
   LAB_0010fa98:uVar9 = *(uint*)( lVar16 + uVar19 * 4 );
   do {
      if (uVar9 != 0xffffffff) {
         uVar23 = (ulong)uVar9;
      ...
      LAB_0010fb94:if (2 < uVar20) goto LAB_0010fa98;
      uVar20 = uVar20 + 1;
      if (uVar20 == 3) {
         uVar22 = *(uint*)( lVar12 + (ulong)uVar22 * 4 );
         if (uVar24 == uVar22) {
            ...
            return fVar32 * *(float*)( lVar11 + 0x20 ) + *(float*)( lVar11 + 0x18 ) * fVar27 + *(float*)( lVar11 + 0x14 ) * ( _LC4 - ( ( fVar5 * fVar5 ) / fVar4 ) / ( ( fVar28 * fVar28 ) / fVar31 ) ) + *(float*)( lVar11 + 0x1c ) * fVar26 + fVar33 * fVar6 + 0.0;
         }
...
/* xatlas::internal::segment::ClusteredCharts::addFaceToChart(xatlas::internal::segment::ClusteredCharts::Chart*,
   unsigned int) */undefined8 xatlas::internal::segment::ClusteredCharts::addFaceToChart(ClusteredCharts *this, Chart *param_1, uint param_2) {
   undefined8 *puVar1;
   uint *puVar2;
   float fVar3;
   float fVar4;
      ...
      do {
         ...
         *(uint*)( param_1 + 0x54 ) = uVar30;
         if (*(uint*)( param_1 + 0x58 ) < uVar30) {
            uVar10 = uVar30;
            if (( *(uint*)( param_1 + 0x58 ) == 0 ) || ( uVar10 = uVar10 != 0 )) {
               pvVar12 = (void*)Realloc(pvVar12, ( ulong )(uVar10 * *(int*)( param_1 + 0x50 )), (int)lVar15, pcVar18, (int)uVar25);
            ...
            LAB_0010fcc3:if (pvVar12 != (void*)0x0) {
               memcpy((void*)( (long)pvVar12 + ( ulong )(( uVar30 - 1 ) * *(uint*)( param_1 + 0x50 )) ), &local_8c, ( ulong ) * (uint*)( param_1 + 0x50 ));
               uVar30 = *(uint*)( param_1 + 0x54 );
            }
 ...
 while ( (uint*)( lVar22 + 4 + lVar32 ) != puVar17 );
            LAB_00110632:ArrayBase::resize(( uint )(param_1 + 0x48), SUB41(uVar29, 0));
            auVar37._8_4_ = local_88._8_4_;
            auVar37._0_8_ = local_88._0_8_;
            uVar16 = 0;
            LAB_00110335:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
               return uVar16;
            }
 ...
 while ( param_2 != uVar10 );
   ...
   *(float*)( param_1 + 0x28 ) = fVar33;
   uVar10 = param_2;
   LAB_0010fee8:uVar19 = ( ulong )(uVar10 * 3);
   uVar21 = 0;
   uVar25 = uVar19;
   LAB_0010fef8:uVar23 = *(uint*)( *(long*)( this_00 + 0x108 ) + uVar19 * 4 );
   fVar33 = *(float*)( lVar32 + uVar19 * 4 );
   if (uVar23 == 0xffffffff) goto LAB_0010ff20;
   LAB_0010ff07:if (*(int*)( lVar22 + (ulong)param_2 * 4 ) == *(int*)( lVar22 + ( (ulong)uVar23 / 3 ) * 4 )) goto LAB_0010ff24;
   if (iVar27 == *(int*)( *(long*)( this + 0x30 ) + ( (ulong)uVar23 / 3 ) * 4 )) {
      fVar35 = fVar35 - fVar33;
      goto LAB_0010ff24;
   }

   LAB_0010ff20:while (true) {
      fVar35 = fVar35 + fVar33;
      LAB_0010ff24:if (2 < uVar21) goto LAB_0010fef8;
      uVar21 = uVar21 + 1;
      if (uVar21 == 3) break;
...
;
   ...
   lVar31 = 0;
   LAB_001100e8:uVar29 = *(int*)( lVar22 + lVar31 ) * 3;
   iVar27 = uVar29 + 3;
   do {
      uVar10 = *(uint*)( *(long*)( this_00 + 0x108 ) + (ulong)uVar29 * 4 );
      if (uVar10 != 0xffffffff) {
         uVar25 = (ulong)uVar10 / 3;
         if (( 1 << ( (byte)uVar25 & 0x1f ) & *(uint*)( *(long*)( lVar15 + 0xb8 ) + ( (ulong)uVar10 / 0x60 ) * 4 ) ) == 0) {
            if (*(uint*)( param_1 + 0x6c ) != 0) {
               piVar13 = *(int**)( param_1 + 0x60 );
               piVar20 = piVar13 + *(uint*)( param_1 + 0x6c );
               do {
                  if (*piVar13 == *(int*)( *(long*)( *(long*)( this + 8 ) + 0x38 ) + uVar25 * 4 )) goto joined_r0x001101fb;
                  piVar13 = piVar13 + 1;
               }
 ...
 while ( uVar10 != uVar21 );
                     ...
                     if (lVar15 != 0) {
                        ...
                        if (uVar21 < *(int*)( param_1 + 0x8c ) - 1U) {
                           ...
                           memmove((void*)( lVar15 + (ulong)uVar23 ), (void*)( ( ulong )(uVar23 - uVar10) + lVar15 ), ( ulong )(( ( *(int*)( param_1 + 0x8c ) - 1U ) - uVar21 ) * uVar10));
                           lVar15 = *(long*)( param_1 + 0x80 );
                     ...
                     LAB_001102b6:auVar37._8_4_ = local_88._8_4_;
                     auVar37._0_8_ = local_88._0_8_;
      ...
      joined_r0x001101fb:if (uVar29 + 1 == iVar27) break;
      uVar29 = uVar29 + 1;
      lVar15 = *(long*)this;
      this_00 = *(Mesh**)( lVar15 + 0x30 );
   }
...
/* xatlas::internal::segment::ClusteredCharts::createChart(float) */void xatlas::internal::segment::ClusteredCharts::createChart(ClusteredCharts *this, float param_1) {
   float *pfVar1;
   float fVar2;
   undefined4 uVar3;
   long lVar4;
   ...
   *(undefined4*)( pCVar8 + 0x90 ) = 0;
   for (int i = 0; i < 4; i++) {
      *(undefined1(*) [16])( pCVar8 + ( 16*i + 4 ) ) = (undefined1[16])0;
   }
   ...
   *(undefined4*)( pCVar8 + 0x98 ) = 0;
   ...
   if (uVar11 < 3) {
      ...
      do {
         ...
         if (( ( 1 << ( (byte)pcVar10 & 0x1f ) & *(uint*)( lVar5 + ( uVar12 >> 5 & 0x7ffffff ) * 4 ) ) == 0 ) && ( fVar2 = *(float*)( *(long*)( *(long*)( this + 8 ) + 0x50 ) + ( ulong ) * (uint*)( *(long*)( *(long*)( this + 8 ) + 0x38 ) + uVar12 * 4 ) * 4 ) ),fVar13 < fVar2) {
   ...
   while (*(int*)( pCVar8 + 0x8c ) != 0) {
      ...
      *(uint*)( pCVar8 + 0x8c ) = uVar11;
      if (*(uint*)( pCVar8 + 0x90 ) < uVar11) {
         if (( *(uint*)( pCVar8 + 0x90 ) == 0 ) || ( uVar11 = uVar11 != 0 )) {
            uVar9 = Realloc(pvVar6, ( ulong )(uVar11 * *(int*)( pCVar8 + 0x88 )), (int)uVar12, pcVar10, (int)in_R8);
      ...
      if (( ( 1 << ( SUB41(fVar13, 0) & 0x1f ) & *(uint*)( *(long*)( *(long*)this + 0xb8 ) + uVar12 * 4 ) ) == 0 ) && ( cVar7 = addFaceToChart(this, pCVar8, (uint)fVar13) ),uVar12 = extraout_RDX_00,cVar7 == '\0') {
         pcVar10 = (char*)(ulong)(uint)fVar13;
...
/* xatlas::internal::segment::ClusteredCharts::resetCharts() */void xatlas::internal::segment::ClusteredCharts::resetCharts(ClusteredCharts *this) {
   uint *puVar1;
   long lVar2;
   Chart *pCVar3;
   ulong uVar4;
   ...
   if (uVar5 != 0) {
      do {
         ...
         *(undefined4*)( pCVar3 + 0x6c ) = 0;
         for (int i = 0; i < 4; i++) {
            *(undefined1(*) [16])( pCVar3 + ( 16*i + 4 ) ) = (undefined1[16])0;
         }
...
/* xatlas::internal::segment::ClusteredCharts::mergeChart(xatlas::internal::segment::ClusteredCharts::Chart*,
   xatlas::internal::segment::ClusteredCharts::Chart*, float) */undefined4 xatlas::internal::segment::ClusteredCharts::mergeChart(Chart *param_1, Chart *param_2, float param_3) {
   undefined8 *puVar1;
   float *pfVar2;
   Fit *pFVar3;
   float fVar4;
   ...
   if (uVar10 != 0) {
      ...
      if (*(long*)( param_2 + 0x48 ) != 0) {
         memcpy((void*)( *(long*)( param_2 + 0x48 ) + ( ulong )(uint)(iVar28 * *(int*)( param_2 + 0x50 )) ), *(void**)( in_RDX + 0x12 ), ( ulong )(in_RDX[0x15] * in_RDX[0x14]));
      }
 ...
 while ( puVar21 != puVar19 );
      ...
      LAB_00110ca0:puVar21 = *(uint**)( param_2 + 0x48 );
 ...
 while ( puVar19 != puVar21 );
      ...
      if ((char)uVar17 != '\0') {
         ...
         *(undefined8*)( param_2 + 0x1c ) = uStack_50;
         if (uVar10 != 0) {
            ...
            if (*(long*)( param_2 + 0x60 ) != 0) {
               memcpy((void*)( *(long*)( param_2 + 0x60 ) + ( ulong )(uint)(iVar23 * *(int*)( param_2 + 0x68 )) ), *(void**)( in_RDX + 0x18 ), ( ulong )(in_RDX[0x1b] * in_RDX[0x1a]));
            }
         ...
         *(ulong*)( param_2 + 0x28 ) = CONCAT44((float)( ( ulong ) * (undefined8*)( param_2 + 0x28 ) >> 0x20 ) + ( (float)in_RDX[0xb] - param_3 ), (float)*(undefined8*)( param_2 + 0x28 ) + (float)in_RDX[10]);
 ...
 while ( puVar19 != puVar21 );
   ...
   uVar17 = 0;
   LAB_00110e5d:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar17;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* xatlas::internal::segment::ClusteredCharts::mergeCharts() */void xatlas::internal::segment::ClusteredCharts::mergeCharts(ClusteredCharts *this) {
   int *piVar1;
   float *pfVar2;
   long lVar3;
   long lVar4;
      ...
      LAB_001110c2:do {
         ...
         *(uint*)( this + 0x154 ) = uVar7;
         ...
         if (*(uint*)( this + 0x158 ) < uVar7) {
            auVar38 = Realloc(pvVar31, ( ulong )(uVar7 * *(int*)( this + 0x150 )), (int)pfVar21, pcVar20, -0x55555555);
            ...
            *(void**)( this + 0x148 ) = pvVar31;
            ...
            uVar33 = uVar7;
            if (pvVar31 != (void*)0x0) {
               LAB_001116f6:memset(pvVar31, 0, ( ulong )(uVar33 * *(int*)( this + 0x150 )));
         ...
         *(uint*)( this + 0x16c ) = uVar7;
         ...
         if (*(uint*)( this + 0x170 ) < uVar7) {
            auVar38 = Realloc(pvVar31, ( ulong )(uVar7 * *(int*)( this + 0x168 )), (int)pfVar21, pcVar20, -0x55555555);
            pfVar21 = auVar38._8_8_;
            pvVar31 = auVar38._0_8_;
            ...
            *(void**)( this + 0x160 ) = pvVar31;
            ...
            uVar33 = uVar7;
            if (pvVar31 != (void*)0x0) {
               LAB_001116cf:memset(pvVar31, 0, ( ulong )(uVar33 * *(int*)( this + 0x168 )));
         ...
         *(uint*)( this + 0x184 ) = uVar7;
         ...
         if (*(uint*)( this + 0x188 ) < uVar7) {
            auVar38 = Realloc(pvVar31, ( ulong )(uVar7 * *(int*)( this + 0x180 )), (int)pfVar21, pcVar20, -0x55555555);
            pfVar21 = auVar38._8_8_;
            pvVar31 = auVar38._0_8_;
            ...
            *(void**)( this + 0x178 ) = pvVar31;
            ...
            LAB_001111ec:uVar33 = *(uint*)( pCVar11 + 0x54 );
            if (uVar33 == 0) goto LAB_001116ba;
            LAB_001111fc:piVar19 = *(int**)( pCVar11 + 0x48 );
            fVar35 = 0.0;
            ...
            do {
               ...
               LAB_00111258:do {
                  ...
                  uVar28 = (uint)uVar25;
                  if (fVar8 == -NAN) {
                     LAB_00111420:fVar35 = fVar35 + fVar37;
                  }
 else {
                     ...
                     if (*(Chart**)( *(long*)( this + 0x48 ) + uVar30 * 8 ) != pCVar11) {
                        ...
                        uVar10 = *(uint*)( lVar18 + ( ulong )(( (uint)fVar8 % 3 + 1 ) % 3 + ( (uint)fVar8 / 3 ) * 3) * 4 );
                        if (( uVar9 == uVar10 ) && ( *(int*)( lVar18 + (ulong)uVar29 * 4 ) == *(int*)( lVar18 + uVar24 * 4 ) )) {
                           LAB_00111442:lVar18 = uVar30 * 4;
                           *(float*)( *(long*)( this + 0x148 ) + lVar18 ) = *(float*)( *(long*)( this + 0x148 ) + lVar18 ) + fVar37;
                        }
 else {
 ...
 while ( piVar19 != piVar1 );
            ...
            LAB_00111694:memset(pvVar31, 0, ( ulong )(uVar33 * *(int*)( this + 0x180 )));
            uVar33 = *(uint*)( pCVar11 + 0x54 );
            pfVar21 = extraout_RDX_00;
            if (uVar33 != 0) goto LAB_001111fc;
            LAB_001116ba:fVar35 = 0.0;
            fVar37 = _LC11;
         }

         do {
            if (( ( ( uVar22 != uVar32 ) && ( pfVar21 = *(float**)( *(long*)( this + 0x48 ) + lVar34 * 2 ) ),pfVar21 != (float*)0x0 ) ) && ( fVar8 = *(float*)( *(long*)( this + 0x148 ) + lVar34 ) ),0.0 < fVar8) {
                  ...
                  if (( fVar5 <= 0.0 ) || ( ( *(float*)( pCVar11 + 0x2c ) + pfVar21[0xb] ) - fVar6 <= fVar5 )) {
                     ...
                     if (0.0 < fVar6) {
                        if (( *(uint*)( pCVar11 + 0x54 ) < 2 ) || ( fVar5 != 1.4013e-45 )) {
                           if (( fVar5 != 2.8026e-45 ) || ( *(uint*)( *(long*)( this + 0x178 ) + lVar34 ) < 2 )) goto LAB_001114d9;
                        }
 else if (_LC38 * *(float*)( pCVar11 + 0x28 ) < pfVar21[10]) {
                           LAB_001114d9:fVar36 = (float)( (uint)pfVar21[0xb] & _LC37 );
                        ...
                        LAB_00111638:cVar17 = mergeChart((Chart*)this, pCVar11, fVar6);
                        ...
                        if (( fVar5 == 2.8026e-45 ) && ( 1 < *(uint*)( *(long*)( this + 0x178 ) + lVar34 ) )) goto LAB_00111638;
                        LAB_00111523:if (0.0 <= *(float*)( pCVar11 + 0x2c ) - fVar35) {
                           if (( ( *(float*)( pCVar11 + 0x2c ) - fVar35 ) * __LC46 < fVar8 ) || ( _LC47 * pfVar21[0xb] < fVar8 )) goto LAB_00111638;
                        }
...
/* xatlas::internal::segment::ClusteredCharts::compute() */void xatlas::internal::segment::ClusteredCharts::compute(ClusteredCharts *this) {
   float *pfVar1;
   uint *puVar2;
   float fVar3;
   float fVar4;
...
;
 ...
 while ( lVar20 != lVar19 );
   ...
   LAB_0011190a:*(undefined4*)( this + 0x54 ) = 0;
 ...
 while ( *(uint*)( this + 0x28 ) != 0 );
      ...
      if (*(int*)( *(long*)this + 0x28 ) != 0) {
         ...
         do {
            ...
            LAB_00111a10:if (*(int*)( this + 0x28 ) != 0) {
               do {
                     ...
                     while (uVar15 != 0) {
                        ...
                        while (true) {
                           while (true) {
                              ...
                              fVar3 = *pfVar1;
                              uVar14 = 1 << ( SUB41(fVar4, 0) & 0x1f ) & *(uint*)( uVar16 + ( ulong )((uint)fVar4 >> 5) * 4 );
                              uVar13 = (ulong)uVar14;
                              if (uVar14 == 0) {
                              ...
                              *(uint*)( lVar19 + 0x8c ) = uVar15;
                              ...
                              bVar22 = local_60 == 0;
                              local_60 = uVar15;
                              if (( bVar22 ) || ( local_60 = local_60 != 0 )) break;
                              if (lVar8 != 0) {
                                 if (s_free == (undefined*)0x0) {
                                    ( *(code*)s_realloc )();
                                 }
...
;
                        if (s_free == (undefined*)0x0) {
                           LAB_00111a9e:pcVar11 = (char*)( *(code*)s_realloc )();
                           uVar15 = *(uint*)( lVar19 + 0x8c );
                        }
 else {
                           ( *(code*)s_free )();
                        ...
                        *(char**)( lVar19 + 0x80 ) = pcVar11;
                        LAB_00111abf:uVar10 = (ulong)uVar15;
                        *(uint*)( lVar19 + 0x90 ) = local_60;
                        LAB_00111ac7:uVar13 = (ulong)local_60;
                        uVar15 = (uint)uVar10;
                     }
;
                     LAB_00111ba7:uVar17 = uVar17 + 1;
                  }
 ...
 while ( *(int*)( this + 0x28 ) != 0 );
                  ...
                  *(uint*)( pCVar6 + 0x8c ) = uVar15;
                  if (*(uint*)( pCVar6 + 0x90 ) < uVar15) {
                     if (( *(uint*)( pCVar6 + 0x90 ) == 0 ) || ( uVar15 = uVar15 != 0 )) {
                        uVar12 = Realloc(pvVar7, ( ulong )(uVar15 * *(int*)( pCVar6 + 0x88 )), (int)uVar13, pcVar11, (int)uVar16);
 ...
 while ( true );
            ...
            mergeCharts(this);
            local_54 = local_54 + 1;
            if (( *(int*)( *(long*)this + 0x28 ) == local_54 ) || ( cVar9 = relocateSeeds(this) ),cVar9 == '\0') break;
            lVar19 = *(long*)this;
            ...
            if (uVar15 != 0) {
               ...
               do {
                  ...
                  *(undefined4*)( pCVar6 + 0x6c ) = 0;
                  for (int i = 0; i < 4; i++) {
                     *(undefined1(*) [16])( pCVar6 + ( 16*i + 4 ) ) = (undefined1[16])0;
                  }
...
/* xatlas::internal::param::PiecewiseParam::addCandidateFace(unsigned int, float, unsigned int,
   unsigned int, unsigned int) */void xatlas::internal::param::PiecewiseParam::addCandidateFace(PiecewiseParam *this, uint param_1, float param_2, uint param_3, uint param_4, uint param_5) {
   undefined8 *puVar1;
   float *pfVar2;
   long *plVar3;
   float fVar4;
   ...
   do {
      ...
      uVar13 = uVar11;
      uVar25 = uVar24;
      if (( *(int*)( lVar9 + ( ulong )(( (int)uVar23 + iVar27 * -3 + 1U ) % 3 + iVar27 * 3) * 4 ) != iVar7 ) && ( uVar13 = uVar12 ),uVar25 = uVar11,iVar7 == *(int*)( lVar9 + ( uVar23 & 0xffffffff ) * 4 )) {
         uVar19 = uVar11;
         uVar25 = uVar24;
      }
 ...
 while ( uVar10 != 3 );
   ...
   do {
      pVVar15 = pVVar16 + 8;
      *(ulong*)pVVar16 = CONCAT44((float)( ( ulong ) * (undefined8*)pVVar16 >> 0x20 ) * fVar28, (float)*(undefined8*)pVVar16 * fVar28);
      pVVar16 = pVVar15;
   }
 while ( pVVar15 != pVVar20 );
   ...
   do {
      pVVar15 = pVVar16 + 8;
      *(ulong*)pVVar16 = CONCAT44((float)( ( ulong ) * (undefined8*)pVVar16 >> 0x20 ) + ( (float)( (ulong)uVar5 >> 0x20 ) - (float)( (ulong)uVar6 >> 0x20 ) ), (float)*(undefined8*)pVVar16 + ( fVar35 - (float)uVar6 ));
      pVVar16 = pVVar15;
   }
 while ( pVVar15 != pVVar20 );
   ...
   do {
      if ((int)uVar13 != iVar27) {
         ...
         *(float*)( pVVar26 + 4 ) = (float)( (ulong)uVar5 >> 0x20 ) + fVar33 * local_6c + local_70 * fVar32;
      }
 ...
 while ( iVar27 != 3 );
   ...
   if (( !NAN(fVar28) ) && ( fVar30 = local_58[uVar25 * 2 + 1] ),!NAN(fVar30)) {
      ...
      if (param_2 < 0.0) {
         ...
         LAB_0011225f:pcVar14 = (char*)( *(long*)( lVar8 + 0x58 ) + uVar12 * 0xc );
         if (_LC19 < (float)( ( uint )(( ( local_58[3] - local_58[1] ) * ( local_48 - local_58[0] ) - ( local_44 - local_58[1] ) * ( local_58[2] - local_58[0] ) ) * _LC11) & _LC37 )) {
            fVar34 = 0.0;
            fVar31 = _LC11;
            uVar10 = _LC37;
            ...
            fVar31 = SQRT((float)local_68 * (float)local_68 + local_68._4_4_ * local_68._4_4_ + extraout_XMM1_Da * extraout_XMM1_Da) * fVar31;
            if (fVar34 <= fVar31) {
            ...
            local_68 = puVar29;
            local_60 = extraout_XMM1_Da;
            if (( fVar31 < _LC9 ) && ( fVar31 = fVar31 <= _LC11 )) {
 ...
 while ( plVar17 != plVar3 );
               ...
               puVar29 = local_68;
               for (puVar18 = *(uint**)( local_68 + 2 ); puVar18 != (uint*)0x0; puVar18 = *(uint**)( puVar18 + 2 )) {
                  LAB_001124b0:puVar29 = puVar18;
               }
 ...
 while ( puVar29 != (uint*)0x0 );
   ...
   *puVar29 = *puVar29 | 1 << ( (byte)param_3 & 0x1f );
   LAB_00112528:if (local_40[0] == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* xatlas::internal::param::PiecewiseParam::addFaceToPatch(unsigned int) */void xatlas::internal::param::PiecewiseParam::addFaceToPatch(PiecewiseParam *this, uint param_1) {
   uint *puVar1;
   float *pfVar2;
   float *pfVar3;
   float *pfVar4;
   ...
   *puVar1 = *puVar1 | 1 << ( (byte)param_1 & 0x1f );
   ...
   do {
      ...
      if (uVar6 != 0xffffffff) {
         ...
         if (( ( uVar10 & *(uint*)( *(long*)( this + 0x28 ) + uVar9 * 4 ) ) == 0 ) && ( *(long*)( *(long*)( this + 0x58 ) + uVar13 * 8 ) == 0 )) {
            lVar17 = *(long*)( lVar8 + 0x40 );
            uVar15 = *(uint*)( lVar17 + (ulong)uVar12 * 4 );
            lVar16 = 0;
            do {
               uVar14 = *(uint*)( *(long*)( *(long*)this + 0x40 ) + uVar13 * 0xc + lVar16 * 4 );
               if (( uVar15 != uVar14 ) && ( uVar7 = *(uint*)( lVar17 + ( ulong )(uVar11 % 3 + param_1 * 3) * 4 ) ),uVar14 != uVar7) {
                  lVar17 = *(long*)( this + 8 );
                  pfVar2 = (float*)( lVar17 + (ulong)uVar7 * 8 );
                  pfVar3 = (float*)( lVar17 + (ulong)uVar15 * 8 );
                  pfVar4 = (float*)( lVar17 + ( ulong ) * (uint*)( *(long*)( *(long*)this + 0x40 ) + ( ulong )((int)lVar16 + param_1 * 3) * 4 ) * 8 );
                  fVar18 = pfVar4[1];
                  fVar5 = *pfVar4;
                  uVar15 = 1 << ( (byte)uVar14 & 0x1f );
                  lVar17 = ( ulong )(uVar14 >> 5) << 2;
                  fVar18 = ( *pfVar3 - fVar5 ) * ( pfVar2[1] - fVar18 ) - ( pfVar3[1] - fVar18 ) * ( *pfVar2 - fVar5 );
                  goto LAB_001126c8;
               }
 ...
 while ( lVar16 != 3 );
            ...
            fVar18 = 0.0;
            uVar14 = 0xffffffff;
            LAB_001126c8:if (( ( uVar15 & *(uint*)( *(long*)( this + 0xb0 ) + lVar17 ) ) == 0 ) && ( ( uVar10 & *(uint*)( *(long*)( this + 0xd0 ) + uVar9 * 4 ) ) == 0 )) {
...
/* xatlas::internal::param::Quality::computeBoundaryIntersection(xatlas::internal::Mesh const*,
   xatlas::internal::UniformGrid2&) */void xatlas::internal::param::Quality::computeBoundaryIntersection(Mesh *param_1, UniformGrid2 *param_2) {
   uint uVar1;
   undefined4 uVar2;
   undefined4 uVar3;
   undefined8 uVar4;
   ...
   *(undefined4*)( (long)in_RDX + 0xc ) = 0;
   if (uVar1 == 0) {
      ...
      *(undefined4*)( (long)in_RDX + 0x5c ) = 0;
      LAB_0011281d:MVar5 = (Mesh)UniformGrid2::intersect(*(undefined4*)param_2);
      *param_1 = MVar5;
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   ...
   *(undefined4*)( (long)in_RDX + 0x5c ) = 0;
   do {
      ...
      *(uint*)( (long)in_RDX + 0xc ) = uVar10;
      if (uVar6 < uVar10) {
         if (( uVar6 == 0 ) || ( uVar10 = uVar10 != 0 )) {
            pvVar7 = (void*)Realloc(pvVar7, ( ulong )(uVar10 * *(int*)( in_RDX + 1 )), local_44, in_RCX, (int)uVar8);
         ...
         *(undefined4*)( in_RDX + 2 ) = 0;
         ...
         LAB_001128c6:if (pvVar7 != (void*)0x0) {
            memcpy((void*)( (long)pvVar7 + ( ulong )(( *(int*)( (long)in_RDX + 0xc ) + -1 ) * *(uint*)( in_RDX + 1 )) ), &local_44, ( ulong ) * (uint*)( in_RDX + 1 ));
         }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* xatlas::internal::param::Quality::computeMetrics(xatlas::internal::Mesh const*) */void xatlas::internal::param::Quality::computeMetrics(Quality *this, Mesh *param_1) {
   undefined8 *puVar1;
   uint uVar2;
   long lVar3;
   long lVar4;
 ...
 while ( lVar8 != 3 );
         ...
         if (_LC19 < (float)( (uint)fVar16 & _LC37 )) {
            ...
            fVar16 = (float)( (uint)fVar16 & _LC37 & -(uint)(fVar16 < 0.0) | ~-(uint)(fVar16 < 0.0) & (uint)fVar16 );
            fVar14 = ( local_4c - fStack_64 ) * ( local_5c - local_68 ) - ( local_58 - fStack_64 ) * ( local_50 - local_68 );
            fVar17 = ( local_50 - local_68 ) * ( local_54 - local_60 ) - ( local_5c - local_68 ) * ( local_48 - local_60 );
            fVar20 = ( local_58 - fStack_64 ) * ( local_48 - local_60 ) - ( local_54 - local_60 ) * ( local_4c - fStack_64 );
            ...
            if (0.0 <= fVar15 - fVar23) {
               ...
               fVar18 = 0.0;
               fVar24 = 0.0;
               LAB_00112d6b:fVar17 = SQRT(( fVar23 + fVar15 ) * fVar13);
            }
            ...
            if (fVar17 <= fVar24) {
               ...
               if (( fVar19 < (float)( ( uint )(fVar24 - fVar17) & _LC37 ) ) && ( s_print != (undefined*)0x0 )) {
                  ( *(code*)s_print )("\rASSERT: %s %s %d\n", "sigma2 > sigma1 || equal(sigma1, sigma2, kEpsilon)", "thirdparty/xatlas/xatlas.cpp", 0x1bb5);
                  fVar13 = _LC11;
               }
            ...
            *(float*)( this + 0x18 ) = SQRT(fVar15 * fVar13) * SQRT(fVar15 * fVar13) * fVar14 + *(float*)( this + 0x18 );
            if (bVar7) {
               *(float*)( this + 0x20 ) = ( fVar17 / fVar24 ) * fVar14 + *(float*)( this + 0x20 );
            }

            *(ulong*)( this + 0x10 ) = CONCAT44((float)( ( ulong ) * (undefined8*)( this + 0x10 ) >> 0x20 ) + fVar14, (float)*(undefined8*)( this + 0x10 ) + fVar16);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* xatlas::internal::param::Chart::Chart(xatlas::internal::param::ChartCtorBuffers&,
   xatlas::internal::param::Chart const*, xatlas::internal::Mesh const*,
   xatlas::internal::ConstArrayView<unsigned int>,
   xatlas::internal::ConstArrayView<xatlas::internal::Vector2>, xatlas::internal::Mesh const*) */void xatlas::internal::param::Chart::Chart(Chart *this, long *param_1, long param_2, long param_3, long param_5, uint param_6, undefined8 param_7, undefined8 param_8, float *param_9) {
   void *pvVar1;
   long lVar2;
   long lVar3;
   uint uVar4;
   ...
   *(undefined1(*) [16])( this + 200 ) = (undefined1[16])0x0;
   ...
   if (param_6 != 0) {
      ...
      do {
         *(undefined4*)( lVar15 + lVar5 ) = *(undefined4*)( lVar8 + ( ulong ) * (uint*)( param_5 + lVar5 ) * 4 );
         lVar5 = lVar5 + 4;
      }
   ...
   *(Mesh**)( this + 0x28 ) = this_00;
   ...
   if (param_6 == 0) {
      ...
      do {
         iVar19 = 0;
         do {
            uVar18 = *(uint*)( *(long*)( param_9 + 0x10 ) + ( ulong )(uint)(*(int*)( pcVar17 + *(long*)( this + 0x58 ) ) * 3 + iVar19) * 4 );
            lVar8 = (ulong)uVar18 * 4;
            local_b0 = *(uint*)( *(long*)( param_9 + 0x2e ) + (ulong)uVar18 * 4 );
            pcVar9 = (char*)( ulong ) * (uint*)( *(long*)( param_3 + 0x40 ) + ( ulong )(uint)(*(int*)( pcVar17 + param_5 ) * 3 + iVar19) * 4 );
 ...
 while ( (uint)lVar8 < local_90 );
               ...
               lVar15 = uVar7 * 4;
               for (local_ac[0] = *(uint*)( (long)local_88 + uVar7 * 4 ); local_ac[0] != 0xffffffff; local_ac[0] = *(uint*)( (long)local_68 + (ulong)local_ac[0] * 4 )) {
            ...
            if (local_70 < uVar11) {
               if (( local_70 == 0 ) || ( uVar11 = uVar11 != 0 )) {
                  pvStack_80 = (void*)Realloc(pvStack_80, ( ulong )(uVar11 * (int)local_78), uVar11, pcVar9, (int)uVar13);
                  local_70 = uVar11;
                  goto LAB_001134ee;
               }
               ...
               LAB_001134ee:if (pvStack_80 != (void*)0x0) {
                  memcpy((void*)( (long)pvStack_80 + ( ulong )(uint)(( local_78._4_4_ + -1 ) * (int)local_78) ), &local_b0, local_78 & 0xffffffff);
               }
            ...
            *(int*)( (long)local_88 + lVar15 ) = local_60._4_4_ + -1;
            ...
            LAB_001132f8:if (*(int*)( lVar8 + *param_1 ) == -1) {
               ...
               *(uint*)( this + 0x94 ) = uVar18;
               if (*(uint*)( this + 0x98 ) < uVar18) {
                  ...
                  if (( *(uint*)( this + 0x98 ) != 0 ) && ( uVar18 = uVar18 == 0 )) {
                     if (pvVar1 == (void*)0x0) {
                        *(undefined4*)( this + 0x98 ) = 0;
                     }
 else {
                  ...
                  lVar8 = Realloc(pvVar1, ( ulong )(uVar18 * *(int*)( this + 0x90 )), extraout_EDX, pcVar9, (int)uVar13);
               ...
               if (lVar8 != 0) {
                  memcpy((void*)( lVar8 + ( ulong )(( *(int*)( this + 0x94 ) + -1 ) * *(uint*)( this + 0x90 )) ), local_ac, ( ulong ) * (uint*)( this + 0x90 ));
               }

            }

            LAB_00113305:iVar19 = iVar19 + 1;
         }
 while ( iVar19 != 3 );
         pcVar17 = pcVar17 + 4;
      }
 while ( pcVar17 != pcVar6 );
      ...
      do {
         ...
         do {
            while (true) {
               iVar19 = (int)lVar14;
               uVar7 = ( ulong ) * (uint*)( lVar15 + ( ulong )(uint)(*(int*)( local_f0 + lVar3 ) * 3 + iVar19) * 4 );
               *(undefined4*)( lVar8 + ( ulong )(uint)(iVar16 + iVar19) * 4 ) = *(undefined4*)( lVar5 + uVar7 * 4 );
               uVar18 = *(uint*)( lVar2 + uVar7 * 4 );
               if (local_88 == (void*)0x0) break;
               uVar11 = *(uint*)( (long)local_88 + ( ulong )(local_90 - 1 & uVar18) * 4 );
               while (( uVar11 != 0xffffffff && ( uVar18 != *(uint*)( (long)pvStack_80 + (ulong)uVar11 * 4 ) ) )) {
...
;
 ...
 while ( local_f0 != pcVar6 );
   ...
   memcpy(*(void**)( this + 0xa0 ), *(void**)( *(long*)( this + 0x28 ) + 0x88 ), ( ulong ) * (uint*)( *(long*)( this + 0x28 ) + 100 ) << 3);
...
/* xatlas::internal::Mesh::~Mesh() */void xatlas::internal::Mesh::~Mesh(Mesh *this) {
   char *in_RCX;
   int in_EDX;
   int extraout_EDX;
   int extraout_EDX_00;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* xatlas::internal::param::Chart::parameterize(xatlas::ChartOptions const&,
   xatlas::internal::UniformGrid2&) */void xatlas::internal::param::Chart::parameterize(ChartOptions *param_1, UniformGrid2 *param_2) {
   Vector3 *pVVar1;
   Mesh *this;
   double dVar2;
   uint uVar3;
 ...
 while ( pfVar5 + (ulong)uVar3 * 2 != pfVar19 );
   ...
   *(undefined4*)( param_1 + 0xc4 ) = 0;
   ...
   if (uVar47 < 3) {
      LAB_00113f9f:*(undefined4*)( param_1 + 0xc0 ) = 0;
   }
 else {
      ...
      do {
         lVar43 = 0;
         do {
            *(undefined8*)( local_58 + lVar43 * 2 ) = *(undefined8*)( lVar44 + ( ulong ) * (uint*)( lVar37 + lVar43 * 4 ) * 8 );
            lVar43 = lVar43 + 1;
         }
 while ( lVar43 != 3 );
         uVar50 = uVar50 + 1;
         *(uint*)( param_1 + 0xbc ) = uVar50;
         fVar67 = ( ( local_58[3] - local_58[1] ) * ( local_48 - local_58[0] ) - ( local_44 - local_58[1] ) * ( local_58[2] - local_58[0] ) ) * fVar76;
 ...
 while ( uVar50 < uVar47 / 3 );
   ...
   if (( ( ( param_1[0xb8] == '\0' ) && ( *(long*)( param_1 + 0xc0 ) == 0 ) ) && ( 0.0 < *(float*)( param_1 + 0xcc ) ) ) && ( ( *(float*)( param_1 + 0xd0 ) <= _LC52 && ( *(float*)( param_1 + 0xd4 ) <= _LC53 ) ) )) {
      pUVar49 = *(UniformGrid2**)( param_1 + 0x28 );
...
;
         ...
         do {
            ...
            *(float*)( (long)local_58 + lVar44 ) = SQRT(( *pfVar18 - *pfVar42 ) * ( *pfVar18 - *pfVar42 ) + ( pfVar18[1] - pfVar42[1] ) * ( pfVar18[1] - pfVar42[1] ) + ( pfVar18[2] - pfVar42[2] ) * ( pfVar18[2] - pfVar42[2] ));
            lVar44 = lVar44 + 4;
         }
 while ( lVar44 != 0xc );
         if (( ( local_58[0] <= local_58[1] ) || ( local_58[0] <= local_58[2] ) ) && ( uVar50 = local_70 ),uVar36 = local_60,local_58[2] < local_58[1]) {
         ...
         *(undefined8*)( pNVar21 + 0xa0 ) = 0;
         ...
         for (pcVar39 = (char*)( ulong )(( auVar83._0_4_ - (int)(undefined8*)( ( ulong )(pNVar21 + 8) & 0xfffffffffffffff8 ) ) + 0xa8U >> 3); pcVar39 != (char*)0x0; pcVar39 = pcVar39 + -1) {
            *puVar45 = 0;
         ...
         *(void**)pNVar21 = pvVar22;
         ...
         pvVar22 = (void*)Realloc((void*)0x0, ( ulong )(uint)(*(int*)( pNVar21 + 0x70 ) * *(int*)( pNVar21 + 0x74 )) << 3, extraout_EDX, pcVar39, (int)puVar56);
 ...
 while ( plVar48 + (ulong)uVar60 * 2 != plVar24 );
         ...
         *(void**)( pNVar21 + 0x10 ) = pvVar22;
         ...
         pvVar22 = (void*)Realloc((void*)0x0, ( ulong ) * (uint*)( pNVar21 + 0x70 ) << 2, extraout_EDX_00, pcVar39, iVar61);
 ...
 while ( puVar45 != puVar31 );
            ...
            *(void**)( pcVar39 + 0x38 ) = pvVar22;
            ...
            pvVar22 = (void*)Realloc((void*)0x0, ( ulong )(uVar36 * *(int*)( pNVar21 + 0x74 )) << 3, extraout_EDX_11, pcVar39, (int)uVar57);
            *(void**)( pNVar21 + 0x60 ) = pvVar22;
            memset(pvVar22, 0, ( ulong )(uVar36 * *(int*)( pNVar21 + 0x74 )) << 3);
            pvVar22 = (void*)Realloc((void*)0x0, ( ulong )(uVar36 * *(int*)( pNVar21 + 0x74 )) << 3, extraout_EDX_12, pcVar39, (int)uVar57);
                  ...
                  do {
                     ...
                     do {
                        if (*(char*)( lVar43 + uVar25 ) == '\0') {
                           *(undefined8*)( *(long*)( pNVar21 + 0x60 ) + ( ulong )(uint)((int)uVar57 + *(int*)( *(long*)( pNVar21 + 0x18 ) + uVar25 * 4 )) * 8 ) = *(undefined8*)( *(long*)( *(long*)pNVar21 + lVar37 ) + ( ulong )(uint)((int)uVar25 * (int)( (long*)( *(long*)pNVar21 + lVar37 ) )[1]) );
                        }
 ...
 while ( lVar37 != lVar44 );
         ...
         if (2 < uVar36) {
            ...
            do {
               ...
               if (( fVar69 == 0.0 || (char)pcVar40 != '\0' ) || ( pcVar40 = (code*)CONCAT71(( int7 )((ulong)pcVar40 >> 8), !NAN(__x)) ),__x == 0.0) {
                  uVar60 = uVar60 * 2;
                  ...
                  *(undefined4*)( pNVar21 + 0x50 ) = 0;
                  ...
                  dVar73 = (double)( fVar78 * ( fStack_80 * fVar68 - extraout_XMM1_Da * fStack_8c ) + fVar70 * ( fVar76 * extraout_XMM1_Da - local_84 * fVar68 ) + fVar79 * ( fStack_8c * local_84 - local_90 * fStack_80 ) );
 ...
 while ( (uint)lVar37 < local_d0 );
         ...
         *(code**)( local_f8[1] + 8 ) = opennl::nlJacobiPreconditionerMult;
         pvVar22 = (void*)Realloc((void*)0x0, ( uVar25 >> 0x20 ) << 3, auVar83._8_4_, (char*)pcVar40, iVar61);
 ...
 while ( piVar46 != piVar32 );
            ...
            *(void**)local_110[3] = pvVar22;
            ...
            pauVar33 = (undefined1(*) [16])Realloc((void*)0x0, 0x24, extraout_EDX_14, (char*)pcVar40, iVar61);
 ...
 while ( puVar35 + 8 != puVar59 );
         ...
         if (*(uint*)( pNVar21 + 0x74 ) == 0) {
            LAB_0011530f:plVar48 = *(long**)pNVar21;
         }
 else {
            uVar50 = 0;
            lVar37 = lVar44;
            do {
               ...
               if ((int)uVar54 < 1) {
                  ...
                  LAB_001151cf:dVar75 = SQRT(dVar75);
               }
 else {
 ...
 while ( uVar25 != uVar27 );
                  ...
                  pdVar28 = (double*)0x0;
                  do {
                     dVar73 = dVar73 + pdVar26[(long)pdVar28] * *(double*)( (long)pvVar22 + (long)pdVar28 * 8 );
 ...
 while ( pdVar28 != pdVar26 + uVar25 );
                  if (( dVar75 <= dVar74 ) || ( pdVar28 = uVar60 == 0 )) {
                     uVar54 = 0;
                  }
 else {
                     uVar41 = 1;
 ...
 while ( uVar25 != uVar52 );
                        ...
                        pdVar28 = (double*)0x0;
                        do {
                           *(double*)( lVar37 + (long)pdVar28 * 8 ) = __src[(long)pdVar28] * dVar75 + *(double*)( lVar37 + (long)pdVar28 * 8 );
 ...
 while ( bVar65 );
                        pdVar28 = (double*)0x0;
                        do {
                           pdVar26[(long)pdVar28] = *(double*)( (long)pvVar22 + (long)pdVar28 * 8 ) * dVar75 + pdVar26[(long)pdVar28];
                           bVar65 = pdVar63 != pdVar28;
                           pdVar28 = (double*)( (long)pdVar28 + 1 );
                        }
 while ( bVar65 );
 ...
 while ( __src + uVar25 != pdVar53 );
                        ...
                        do {
                           pdVar28 = pdVar53;
                           __src[(long)pdVar28] = __src[(long)pdVar28] + *(double*)( (long)pvVar22 + (long)pdVar28 * 8 );
 ...
 while ( ( dVar74 < dVar75 ) && ( pcVar39 = (char*)(ulong)uVar60 ),uVar41 = uVar54 + 1,uVar54 < uVar60 );
                  }
            ...
            do {
               ...
               do {
                  if (*(char*)( lVar37 + uVar25 ) == '\0') {
                     *(undefined8*)( *(long*)( (long)plVar48 + lVar44 ) + ( ulong )(uint)((int)uVar25 * (int)( (long*)( (long)plVar48 + lVar44 ) )[1]) ) = *(undefined8*)( *(long*)( pNVar21 + 0x60 ) + ( ulong )(uint)(iVar58 + *(int*)( *(long*)( pNVar21 + 0x18 ) + uVar25 * 4 )) * 8 );
                  }
 ...
 while ( puVar30 != puVar56 + uVar47 );
      ...
      ( **(code**)param_2 )(*(undefined8*)( pUVar49 + 0x58 ), *(undefined8*)( pUVar49 + 0x88 ), uVar47, *(undefined8*)( pUVar49 + 0x40 ), *(undefined4*)( pUVar49 + 0x4c ));
      pUVar49 = *(UniformGrid2**)( param_1 + 0x28 );
   }

   LAB_00113dee:Quality::computeBoundaryIntersection(this, pUVar49);
   pUVar49 = *(UniformGrid2**)( param_1 + 0x28 );
   *(undefined8*)( param_1 + 0xbc ) = 0;
   *(undefined4*)( param_1 + 0xc4 ) = 0;
   fVar77 = _LC19;
   ...
   if (uVar47 < 3) {
      LAB_00113f91:*(undefined4*)( param_1 + 0xc0 ) = 0;
   }
 else {
 ...
 while ( uVar50 < uVar47 / 3 );
   ...
   if (param_2[0x2d] != (UniformGrid2)0x0) {
      ...
      if (( ( ( (float)puVar6[( ulong ) * puVar34 * 2] - fVar77 ) * ( (float)( puVar6 + (ulong)puVar34[1] * 2 )[1] - fVar76 ) - ( (float)( puVar6 + ( ulong ) * puVar34 * 2 )[1] - fVar76 ) * ( (float)puVar6[(ulong)puVar34[1] * 2] - fVar77 ) ) * _LC11 < 0.0 ) && ( uVar3 != 0 )) {
         puVar34 = puVar6;
         do {
            puVar20 = puVar34 + 2;
 ...
 while ( puVar20 != puVar6 + (ulong)uVar3 * 2 );
   ...
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      memcpy(*(void**)( param_1 + 0xa0 ), *(void**)( *(long*)( param_1 + 0x28 ) + 0x88 ), ( ulong ) * (uint*)( *(long*)( param_1 + 0x28 ) + 100 ) << 3);
      return;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* xatlas::internal::param::ChartGroup::createMesh() */Mesh * __thiscall xatlas::internal::param::ChartGroup::createMesh(ChartGroup *this){
   long lVar1;
   uint uVar2;
   uint uVar3;
   Mesh *this_00;
      ...
      do {
         while (true) {
            ...
            *(uint*)( this + 0x2c ) = uVar10;
            ...
            LAB_001159bb:lVar20 = auVar21._8_8_;
            if (auVar21._0_8_ != 0) {
               memcpy((void*)( auVar21._0_8_ + ( ulong )(( (int)uVar11 + -1 ) * *(uint*)( this + 0x28 )) ), &local_98, ( ulong ) * (uint*)( this + 0x28 ));
               uVar11 = ( ulong ) * (uint*)( this + 0x2c );
               lVar20 = extraout_RDX;
            }
...
;
         if (( *(uint*)( this + 0x30 ) == 0 ) || ( uVar10 = uVar10 != 0 )) {
            auVar21 = Realloc(pvVar5, ( ulong )(uVar10 * *(int*)( this + 0x28 )), (int)lVar20, pcVar7, (int)in_R8);
 ...
 while ( uVar10 != 0xffffffff );
   ...
   LAB_00115a3e:uVar10 = (uint)uVar11;
   uVar12 = uVar10 * 3;
      ...
      do {
         ...
         LAB_00115b34:do {
            ...
            if (pvVar19 == (void*)0x0) {
               ...
               for (uVar8 = *puVar14; uVar8 != 0xffffffff; uVar8 = *(uint*)( (long)local_68 + (ulong)uVar8 * 4 )) {
            ...
            if (local_70 < uVar8) {
               if (( local_70 == 0 ) || ( uVar8 = uVar8 != 0 )) {
                  pvVar4 = (void*)Realloc((void*)local_88._8_8_, ( ulong )(uVar8 * (int)local_78), uVar8, pcVar7, (int)uVar17);
               ...
               LAB_00115ce8:if (pvVar4 != (void*)0x0) {
                  memcpy((void*)( (long)pvVar4 + ( ulong )(uint)(iVar16 * (int)local_78) ), &local_ac, local_78 & 0xffffffff);
               }
            ...
            if (uVar3 < uVar8) {
               ...
               LAB_00115d3b:if (puVar14 != (uint*)0x0 && pvVar5 != (void*)0x0) {
                  memcpy((void*)( ( ulong )(uVar2 * (int)local_60) + (long)pvVar5 ), puVar14, local_60 & 0xffffffff);
               }
...
;
 ...
 while ( true );
   ...
   pvVar5 = (void*)0x0;
   pvVar19 = (void*)0x0;
   LAB_00115f16:if (_LC19 < *(float*)this_00) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* xatlas::internal::param::ChartGroup::computeCharts(xatlas::internal::TaskScheduler*,
   ...
   xatlas::internal::ThreadLocal<xatlas::internal::param::PiecewiseParam>*) */void xatlas::internal::param::ChartGroup::computeCharts(ChartGroup *this, TaskScheduler *param_1, ChartOptions *param_2, Progress *param_3, Atlas *param_4, ThreadLocal *param_5, ThreadLocal *param_6, ThreadLocal *param_7) {
   uint *puVar1;
   long *plVar2;
   undefined4 uVar3;
   long lVar4;
   ...
   if (*(uint*)( this + 0x44 ) != 0) {
      ...
      do {
         ...
         Realloc(*(void**)( *(long*)( this + 0x38 ) + lVar13 ), 0, extraout_EDX_18, (char*)pPVar16, (int)pAVar28);
         uVar27 = extraout_RDX;
      }
 while ( (uint)lVar19 < *(uint*)( this + 0x44 ) );
   ...
   *(undefined8*)( param_4 + 0x26 ) = uVar8;
   ...
   LOCK();
   *(int*)( param_3 + 0x18 ) = *(int*)( param_3 + 0x18 ) + *(int*)( *(long*)( *(long*)( this + 0x10 ) + 0x50 ) + ( ulong ) * (uint*)( this + 0x18 ) * 4 );
   UNLOCK();
   if (*(long*)( param_3 + 8 ) != 0) {
      fVar32 = ( (float)*(uint*)( param_3 + 0x18 ) / (float)*(uint*)( param_3 + 0x1c ) ) * __LC35;
      if ((float)( (uint)fVar32 & _LC37 ) < _LC36) {
         fVar32 = (float)( ( uint )((float)(int)fVar32 + (float)( -(uint)((float)(int)fVar32 < fVar32) & _LC4 )) | ~_LC37 & (uint)fVar32 );
      }
 ...
 while ( !bVar31 );
         cVar10 = ( **(code**)( param_3 + 8 ) )(*(undefined4*)( param_3 + 4 ), *(undefined4*)( param_3 + 0x20 ), *(undefined8*)( param_3 + 0x10 ));
         if (cVar10 == '\0') {
            LOCK();
         ...
         do {
            if ((uint)uVar27 < *(uint*)( param_4 + 0xe4 )) {
               ...
               if (uVar18 < *(uint*)( param_4 + 0x1ac )) {
                  ...
                  lVar19 = *(long*)( *(long*)( param_4 + 0x230 ) + ( ulong )(uVar18 - *(uint*)( param_4 + 0x1ac )) * 8 );
         ...
         do {
            ...
            if (uVar11 < *(uint*)( param_4 + 0xe4 )) {
               ...
               if (uVar17 < *(uint*)( param_4 + 0x1ac )) {
                  ...
                  uVar15 = 2;
                  lVar19 = *(long*)( *(long*)( param_4 + 0x230 ) + ( ulong )(uVar17 - *(uint*)( param_4 + 0x1ac )) * 8 ) + 4;
               }
...
;
 ...
 while ( plVar14 != plVar2 );
         LAB_001168a4:ArrayBase::resize((int)this + 0x38, (bool)uVar25);
...
;
 ...
 while ( plVar2 != plVar23 );
         LAB_00116960:puVar29 = (undefined8*)( lVar19 + 0x10 );
...
/* xatlas::internal::param::runChartGroupComputeChartsTask(void*, void*) */void xatlas::internal::param::runChartGroupComputeChartsTask(void *param_1, void *param_2) {
   uint *in_FS_OFFSET;
   if (**(char**)( (long)param_1 + 0x10 ) != '\0') {
      return;
   }
   ...
   /* WARNING: Load size is inaccurate */
   ChartGroup::computeCharts((ChartGroup*)param_2, *(TaskScheduler**)( (long)param_1 + 0x18 ), *(ChartOptions**)( (long)param_1 + 8 ), *(Progress**)( (long)param_1 + 0x10 ), (Atlas*)( ( ulong ) * in_FS_OFFSET * 0x380 + **param_1 ), *(ThreadLocal**)( (long)param_1 + 0x20 ), *(ThreadLocal**)( (long)param_1 + 0x28 ), *(ThreadLocal**)( (long)param_1 + 0x30 ));
   return;
}
/* xatlas::internal::param::Atlas::~Atlas() */void xatlas::internal::param::Atlas::~Atlas(Atlas *this) {
   undefined8 *puVar1;
   long lVar2;
   long lVar3;
   long *plVar4;
               ...
               if (*(int*)( lVar5 + 0x44 ) != 0) {
                  ...
                  do {
                     while (true) {
                        ...
                        for (int i = 0; i < 5; i++) {
                           if (*(long*)( lVar6 + ( -24*i + 160 ) ) != 0) {
                              if (s_free == (undefined*)0) {
                                 ( *(code*)s_realloc )();
                              }
 else {
                                 ( *(code*)s_free )();
...
/* xatlas::internal::pack::Atlas::~Atlas() */void xatlas::internal::pack::Atlas::~Atlas(Atlas *this) {
   char *pcVar1;
   int iVar2;
   int extraout_EDX;
   int extraout_EDX_00;
...
;
 ...
 while ( (uint)lVar4 < *(uint*)( this + 0xc ) );
   ...
   LAB_0011727b:uVar3 = ( ulong ) * (uint*)( this + 0x3c );
   lVar4 = 0;
   if (*(uint*)( this + 0x3c ) != 0) {
      do {
         while (true) {
...
;
 ...
 while ( (uint)lVar4 < *(uint*)( this + 0x54 ) );
   ...
   LAB_001173b3:Realloc(*(void**)( this + 0x88 ), 0, iVar2, pcVar1, in_R8D);
...
/* xatlas::internal::pack::Atlas::addCharts(xatlas::internal::TaskScheduler*,
   xatlas::internal::param::Atlas*) */void xatlas::internal::pack::Atlas::addCharts(Atlas *this, TaskScheduler *param_1, Atlas *param_2) {
   long *plVar1;
   char cVar2;
   undefined8 uVar3;
   uint uVar4;
 ...
 while ( plVar20 != plVar23 );
      if (uVar17 != 0) {
         ...
         local_70 = (void*)Realloc((void*)0x0, (ulong)uVar4 * 0xe0, extraout_EDX, (char*)pAVar12, (int)plVar23);
         uVar3 = _LC32;
         uVar16 = _LC18;
         if (uVar4 != 0) {
            pvVar6 = local_70;
            do {
               ...
               *(undefined4*)( (long)pvVar6 + 0x48 ) = 0;
               for (int i = 0; i < 3; i++) {
                  *(undefined8*)( (long)pvVar6 + ( 24*i + 80 ) ) = 0;
                  *(undefined8*)( (long)pvVar6 + ( 24*i + 88 ) ) = uVar3;
                  *(undefined4*)( (long)pvVar6 + ( 24*i + 96 ) ) = 0;
               }
 ...
 while ( cVar2 != '\0' );
                           ...
                           *(uint*)( lVar27 + 0x14 ) = uVar18;
                           if (*(uint*)( lVar27 + 0x18 ) < uVar18) {
                              if (( *(uint*)( lVar27 + 0x18 ) == 0 ) || ( uVar18 = uVar18 != 0 )) {
                                 if (uVar18 * *(int*)( lVar27 + 0x10 ) != 0) {
                                    LAB_00117709:lVar8 = ( *(code*)s_realloc )();
                                    *(long*)( lVar27 + 8 ) = lVar8;
                              ...
                              LAB_00117722:if (lVar8 != 0) {
                                 memcpy((void*)( lVar8 + ( ulong )(( *(int*)( lVar27 + 0x14 ) + -1 ) * *(uint*)( lVar27 + 0x10 )) ), &local_68, ( ulong ) * (uint*)( lVar27 + 0x10 ));
                              }
...
/* xatlas::internal::pack::Atlas::addUvMeshCharts(xatlas::internal::UvMeshInstance*) */void xatlas::internal::pack::Atlas::addUvMeshCharts(UvMeshInstance *param_1) {
   float *pfVar1;
   uint *puVar2;
   float fVar3;
   float fVar4;
   ...
   if (*(int*)( lVar19 + 0xa4 ) == 0) {
      LAB_00117f37:ArrayBase::~ArrayBase((ArrayBase*)&local_68);
   ...
   local_180 = 0;
   LAB_00117b28:puVar7 = *(undefined8**)( *(long*)( lVar19 + 0x98 ) + local_180 * 8 );
   auVar25 = ( *(code*)s_realloc )(0, 0x88);
   puVar9 = auVar25._0_8_;
   puVar17 = puVar9;
   for (pfVar11 = (float*)0x11; uVar8 = _LC18,pfVar11 != (float*)0x0; pfVar11 = (float*)( (long)pfVar11 + -1 )) {
      *puVar17 = 0;
   ...
   *(undefined4*)( puVar9 + 5 ) = uVar6;
   local_158 = puVar9;
   if (iVar5 != 0) {
      pvVar10 = (void*)Realloc((void*)0x0, ( ulong )(uint)(iVar5 * 4), auVar25._8_4_, (char*)0x0, (int)in_R8);
   ...
   if (*(int*)( puVar9 + 2 ) != 0) {
      ...
      do {
         while (true) {
            ...
            LAB_00117c00:uVar15 = *(uint*)( puVar9 + 2 );
            lVar19 = lVar19 + 1;
...
;
         ...
         *(uint*)( (long)puVar9 + 0x3c ) = uVar15;
         if (*(uint*)( puVar9 + 8 ) < uVar15) {
            if (( *(uint*)( puVar9 + 8 ) != 0 ) && ( uVar15 = uVar15 == 0 )) {
               if (pvVar10 != (void*)0x0) {
            ...
            pvVar10 = (void*)Realloc(pvVar10, ( ulong )(uVar15 * *(int*)( puVar9 + 7 )), uVar15, (char*)pfVar11, (int)in_R8);
            puVar9[6] = pvVar10;
         ...
         lVar19 = lVar19 + 1;
         memcpy((void*)( (long)pvVar10 + ( ulong )(( *(int*)( (long)puVar9 + 0x3c ) + -1 ) * *(uint*)( puVar9 + 7 )) ), &local_150, ( ulong ) * (uint*)( puVar9 + 7 ));
         uVar15 = *(uint*)( puVar9 + 2 );
      }
 while ( (uint)lVar19 < uVar15 );
      LAB_00117c9a:fVar21 = _LC19;
      if (2 < uVar15) {
         ...
         do {
            ...
            fVar22 = fVar22 + (float)( ( uint )(( ( *in_R8 - fVar23 ) * ( pfVar1[1] - fVar24 ) - ( in_R8[1] - fVar24 ) * ( *pfVar1 - fVar23 ) ) * _LC11) & _LC37 );
         }
 while ( uVar12 < uVar15 / 3 );
   ...
   *(undefined4*)( puVar9 + 3 ) = 0;
   uVar15 = *(uint*)( (long)puVar9 + 0x3c );
   LAB_00118038:uVar14 = 0;
   fVar21 = _LC10;
   fVar22 = _LC9;
   fVar24 = _LC9;
   fVar23 = _LC10;
   LAB_00118083:uVar16 = (uint)uVar14;
   if (uVar15 == 0) {
   ...
   goto LAB_00118083;
   LAB_001180a0:fVar22 = ( fVar23 - fVar22 ) * _LC11 * ( fVar21 - fVar24 ) * _LC11;
   *(float*)( puVar9 + 3 ) = fVar22;
   LAB_00117d6a:local_100 = (ulong)(uint)local_100;
   uVar16 = 0;
   *(float*)( (long)puVar9 + 0x1c ) = fVar22;
   do {
      ...
      if (local_f8 < uVar12) {
         uVar18 = local_f8;
         if (local_f8 == 0) {
            LAB_00117dd7:local_108 = (void*)Realloc(local_108, ( ulong )(uVar12 * (uint)local_100), uVar18, (char*)pfVar11, (int)in_R8);
            local_f8 = uVar12;
            goto LAB_00117df8;
         }
         ...
         LAB_00117df8:if (local_108 != (void*)0x0) {
            memcpy((void*)( (long)local_108 + ( ulong )(iVar5 * (uint)local_100) ), &local_150, local_100 & 0xffffffff);
         }
 ...
 while ( true );
   ...
   *(uint*)( param_1 + 0x54 ) = uVar15;
   if (*(uint*)( param_1 + 0x58 ) < uVar15) {
      ...
      if (( *(uint*)( param_1 + 0x58 ) != 0 ) && ( uVar15 = uVar15 == 0 )) {
         if (pvVar10 != (void*)0x0) {
      ...
      lVar19 = Realloc(pvVar10, ( ulong )(uVar15 * *(int*)( param_1 + 0x50 )), extraout_EDX, (char*)pfVar11, (int)in_R8);
   ...
   if (lVar19 != 0) {
      memcpy((void*)( lVar19 + ( ulong )(( *(int*)( param_1 + 0x54 ) + -1 ) * *(uint*)( param_1 + 0x50 )) ), &local_158, ( ulong ) * (uint*)( param_1 + 0x50 ));
   }

   LAB_00117f13:local_180 = local_180 + 1;
   lVar19 = *in_RSI;
   if (*(uint*)( lVar19 + 0xa4 ) <= (uint)local_180) goto LAB_00117f37;
   goto LAB_00117b28;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* xatlas::internal::pack::Atlas::packCharts(xatlas::PackOptions const&, bool
   (*)(xatlas::ProgressCategory, int, void*), void*) */ulong xatlas::internal::pack::Atlas::packCharts(PackOptions *param_1, _func_bool_ProgressCategory_int_void_ptr *param_2, void *param_3) {
   float *pfVar1;
   long lVar2;
   float fVar3;
   float fVar4;
   ...
   if (param_3 == (void*)0x0) {
      ...
      if (( s_print == (undefined*)0x0 ) || ( s_printVerbose == '\0' )) {
         ...
         LAB_001182fc:( *(code*)s_print )("Packing %u charts\n", local_53c);
         if (local_53c != 0) {
            LAB_001184ba:fVar97 = *(float*)( param_2 + 8 );
            iVar56 = *(int*)( param_2 + 0xc );
            *(float*)( param_1 + 0xb0 ) = fVar97;
            if (iVar56 == 0) {
               uVar22 = 0;
               if (fVar97 <= 0.0) {
                  LAB_001187f8:uVar22 = ( uint )(fVar97 <= 0.0) << 10;
               }
 ...
 while ( plVar32 != plVar34 );
            ...
            bVar16 = true;
            local_5cc = 0;
            LAB_0011852d:local_4d0 = (ulong)local_53c;
            uVar72 = 0;
            local_3b8 = 0;
            local_3b0 = _LC18;
            local_3a8 = 0;
            ...
            LAB_00118615:lVar12 = *(long*)( *(long*)( param_1 + 0x48 ) + uVar72 * 8 );
            fVar97 = _LC4;
            if (*(float*)( lVar12 + 0x18 ) != 0.0) {
               ...
               if (( (int)fVar97 + 0x80800000U < 2 ) && ( s_print != (undefined*)0x0 )) {
                  ( *(code*)s_print )("\rASSERT: %s %s %d\n", "isFinite(scale)", "thirdparty/xatlas/xatlas.cpp");
               }
            ...
            if (cVar8 == (code)0x0) {
               do {
                  if (uVar23 == 0) {
                     ...
                     pfVar43 = (float*)( *(long*)( lVar12 + 0x20 ) + ( ulong ) * (uint*)( *(long*)( lVar12 + 0x30 ) + (ulong)uVar41 * 4 ) * 8 );
                  }
 ...
 while ( true );
            ...
            do {
               ...
               if (uVar23 == 0) {
                  ...
                  LAB_0011872f:fVar94 = fVar94 - fVar84;
                  fVar83 = fVar83 - fVar95;
               }
 else {
                  uVar73 = uVar23;
                  if (uVar23 <= uVar41) goto LAB_00118851;
                  pfVar43 = (float*)( *(long*)( lVar12 + 0x20 ) + ( ulong ) * (uint*)( *(long*)( lVar12 + 0x30 ) + uVar33 * 4 ) * 8 );
                  fVar83 = pfVar43[1];
                  fVar94 = *pfVar43;
                  if (cVar8 == (code)0x0) goto LAB_0011872f;
                  LAB_0011869e:fVar103 = *(float*)( lVar12 + 0x4c ) * fVar83 + *(float*)( lVar12 + 0x48 ) * fVar94;
 ...
 while ( true );
      ...
      if ((char)uVar22 != '\0') {
         ...
         if (local_53c != 0) goto LAB_001184ba;
         LAB_00118327:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   ...
   if (( 0.0 < fVar82 ) && ( 0.0 < fVar77 )) {
      if ((float)( (uint)fVar82 & _LC37 ) < _LC36) {
         ...
         auVar96 = ZEXT416(( uint )((float)( -(uint)((float)(int)fVar82 < fVar82) & (uint)_LC4 ) + (float)(int)fVar82)) | auVar89;
      }

      iVar56 = (int)auVar96._0_4_;
      if ((float)( (uint)fVar77 & _LC37 ) < _LC36) {
         fVar97 = (float)( ( uint )((float)( -(uint)((float)(int)fVar77 < fVar77) & (uint)_LC4 ) + (float)(int)fVar77) | ~_LC37 & (uint)fVar77 );
      }
 ...
 while ( lVar44 != (ulong)uVar73 * 4 );
   ...
   if (local_5cc == 0) {
      ...
      if (( uVar41 == 0 ) || ( ( fVar95 = (float)uVar41 - _LC4 ),fVar84 <= fVar95 && ( fVar97 <= fVar95 ) )) goto LAB_0011898f;
      if (( s_print != (undefined*)0x0 ) && ( s_printVerbose != '\0' )) {
         ( *(code*)s_print )((double)fVar84, (double)fVar97, "   Resizing chart %u from %gx%g to %ux%u to fit atlas\n", uVar72 & 0xffffffff, uVar41);
         uVar23 = *(uint*)( lVar12 + 0x3c );
   ...
   if (( fVar95 < fVar84 ) || ( fVar95 < fVar97 )) {
      LAB_00118911:if (auVar96._0_4_ <= fVar97) {
 ...
 while ( true );
   ...
   LAB_0011898f:uVar33 = 0;
   auVar93 = ZEXT816(0);
   fVar97 = 0.0;
   LAB_001189de:uVar41 = (uint)uVar33;
   ...
   if (uVar23 == 0) {
      ...
      puVar36 = (undefined8*)( *(long*)( lVar12 + 0x20 ) + ( ulong ) * (uint*)( *(long*)( lVar12 + 0x30 ) + uVar33 * 4 ) * 8 );
   }
   ...
   *puVar36 = CONCAT44(fVar77, fVar95);
   ...
   goto LAB_001189de;
   LAB_001189f9:if (( ( ( (float)uVar22 < fVar84 ) || ( (float)uVar22 < fVar97 ) ) && ( s_print != (undefined*)0x0 ) ) && ( s_printVerbose != '\0' )) {
   ...
   *(float*)( lVar55 + uVar72 * 4 ) = fVar84;
   ...
   goto LAB_00118615;
   code_r0x00118ab7:RadixSort::sort(param_1 + 0x60, lVar55, local_3b0._4_4_);
   ...
   LAB_00118ed2:uVar41 = *(uint*)( lVar12 + (ulong)local_4fc * 4 );
   uVar31 = (ulong)uVar41;
   pfVar43 = (float*)( lVar63 + uVar31 * 8 );
   fVar84 = pfVar43[1];
   puVar13 = *(uint**)( *(long*)( param_1 + 0x48 ) + uVar31 * 8 );
   if ((float)( (uint)fVar84 & _LC37 ) < _LC36) {
      fVar84 = (float)( ( uint )((float)(int)fVar84 + (float)( -(uint)((float)(int)fVar84 < fVar84) & (uint)_LC4 )) | ~_LC37 & (uint)fVar84 );
   }

   fVar95 = *pfVar43;
   if ((float)( (uint)fVar95 & _LC37 ) < _LC36) {
      fVar95 = (float)( ( uint )((float)(int)fVar95 + (float)( -(uint)((float)(int)fVar95 < fVar95) & (uint)_LC4 )) | ~_LC37 & (uint)fVar95 );
   }

   pfVar43 = (float*)0x1;
   BitImage::resize(( uint ) & local_318, (int)fVar95 + *(int*)( param_2 + 4 ), (bool)( (char)(int)fVar84 + (char)*(int*)( param_2 + 4 ) ));
 ...
 while ( lVar44 != 3 );
         ...
         if (fVar103 - fVar105 != 0.0) {
            ...
            if ((float)( (uint)fVar98 & _LC37 ) < _LC36) {
               ...
               fVar98 = (float)( ( uint )((float)( -(uint)(fVar108 < fVar98) & (uint)_LC4 ) + fVar108) | ~_LC37 & (uint)fVar98 );
            }
            ...
            if ((float)( (uint)fVar90 & _LC37 ) < _LC36) {
               ...
               fVar90 = (float)( ( uint )((float)( -(uint)(fVar108 < fVar90) & (uint)_LC4 ) + fVar108) | ~_LC37 & (uint)fVar90 );
            }
            ...
            fVar108 = _LC4;
            joined_r0x001199e9:fVar85 = fVar107;
            if (fVar85 <= fVar90) {
               ...
               if (fVar94 <= fVar98) {
                  ...
                  do {
                     while (true) {
                        ...
                        if (( ( _LC68 < fVar109 ) && ( fVar99 = fVar111 * fVar92 + fVar113 + fVar106 * fVar85 ),_LC68 < fVar99 )) &&( fVar92 = _LC68 < fVar92 );
                        LAB_00119cc8:fVar114 = fVar115;
...
;
                              ...
                              if (fVar114 < fVar115) {
                                 ...
                                 do {
                                    ...
                                    if (__LC70 <= fVar100) {
                                       ...
                                       LAB_00119e64:cVar20 = drawTriangleCallback((ArrayBase*)&local_338, (int)fVar86, (int)fVar109);
                                       ...
                                       LAB_00119f46:if (__LC71 <= fVar117) {
                                          LAB_00119f50:if (__LC71 <= fVar118) {
                                             local_58 = 3;
                                             local_50 = 0.0;
                                             ...
                                             do {
                                                ...
                                                if (uVar42 != 0) {
                                                   ...
                                                   *(undefined8*)( local_a8 + (long)puVar37 * 2 ) = *(undefined8*)pfVar35;
                                                   in_R8 = puVar37;
                                                }
                                                ...
                                                if (uVar42 == 1) {
                                                   ...
                                                   *pfVar43 = fVar99;
                                                   local_a8[(long)puVar38 * 2 + 1] = ( ( fVar3 - fVar101 ) / ( fVar4 - fVar5 ) ) * fVar120 + fVar101;
                                                }
 ...
 while ( pfVar35 != (float*)local_d0 );
                                             local_54 = 0;
                                             *(ulong*)( local_a8 + (long)puVar37 * 2 ) = CONCAT44(local_a8[1], local_a8[0]);
                                             if ((int)puVar37 != 0) {
                                                puVar38 = (uint*)0x0;
                                                pfVar35 = local_e8;
                                                ...
                                                do {
                                                   ...
                                                   if (bVar76 != 0) {
                                                      ...
                                                      *(undefined8*)( local_e8 + (long)puVar38 * 2 ) = *(undefined8*)( pfVar35 + 0x10 );
                                                      in_R8 = puVar38;
                                                   }
                                                   ...
                                                   if (uVar42 == 1) {
                                                      ...
                                                      *pfVar43 = ( ( fVar3 - fVar101 ) / ( fVar4 - fVar5 ) ) * fVar120 + fVar101;
                                                   }
 ...
 while ( local_e8 + (long)puVar37 * 2 != pfVar35 );
                                                ...
                                                *(ulong*)( local_e8 + (long)puVar38 * 2 ) = CONCAT44(local_e8[1], local_e8[0]);
                                                if ((int)puVar38 != 0) {
                                                   puVar37 = (uint*)0x0;
                                                   pfVar35 = local_e8;
                                                   ...
                                                   do {
                                                      ...
                                                      if (uVar42 == 1) {
                                                         ...
                                                         *pfVar43 = fVar84;
                                                         local_a8[(long)puVar62 * 2 + 1] = ( ( fVar3 - fVar101 ) / ( fVar4 - fVar5 ) ) * fVar120 + fVar101;
                                                      }
                                                   ...
                                                   *(ulong*)( local_a8 + (long)puVar37 * 2 ) = CONCAT44(local_a8[1], local_a8[0]);
                                                   if ((int)puVar37 != 0) {
                                                      ...
                                                      do {
                                                         ...
                                                         if (bVar76 != false) {
                                                            puVar62 = (uint*)( ulong )((int)puVar38 + 1);
                                                            *(undefined8*)( local_e8 + (long)puVar38 * 2 ) = *(undefined8*)( pfVar43 + 0x10 );
                                                            in_R8 = puVar38;
                                                         }
                                                         ...
                                                         if ((char)( bVar76 + ( 0.0 <= fVar121 ) ) == '\x01') {
                                                            ...
                                                            local_e8[(long)puVar62 * 2] = ( ( fVar3 - fVar101 ) / ( fVar4 - fVar5 ) ) * fVar120 + fVar101;
                                                         }
 ...
 while ( fVar109 < fVar107 );
                     ...
                     do {
                        if (fVar114 < fVar115) {
                           fVar108 = fVar114;
                           do {
                              cVar20 = drawTriangleCallback((ArrayBase*)&local_338, (int)fVar108, (int)auVar102._0_4_);
                              if (cVar20 == '\0') goto LAB_001191c6;
 ...
 while ( uVar24 < uVar73 / 3 );
   ...
   if (param_2[0x10] == (_func_bool_ProgressCategory_int_void_ptr)0x0) {
      ...
      if (param_2[0x12] != (_func_bool_ProgressCategory_int_void_ptr)0x0) {
         LAB_0011a50f:fVar84 = *(float*)( lVar55 + uVar31 * 4 );
         if (( local_4c8 < fVar84 ) && ( uVar73 = local_420 + 1 ),fVar84 <= local_4e4 - (float)uVar73 * fVar97) {
            local_420 = uVar73;
 ...
 while ( puVar38 != local_378 + (ulong)local_370._4_4_ * 2 );
      ...
      LAB_0011a55c:local_518 = &local_228;
      local_548 = &local_2b8;
 ...
 while ( uVar24 < puVar13[4] );
         ...
         if (uVar73 != 0) {
            ...
            do {
               ...
               if (local_1e8 < uVar24) {
                  if (( local_1e8 == 0 ) || ( uVar24 = uVar24 != 0 )) {
                     pVVar52 = (Vector2*)Realloc(pVVar52, ( ulong )(uVar24 * (int)local_1f0), iVar74, (char*)pfVar43, (int)in_R8);
                     local_1e8 = uVar24;
                     local_1f8 = pVVar52;
                     goto LAB_001192b1;
                  }
                  ...
                  LAB_001192b1:if (pVVar52 != (Vector2*)0x0) {
                     memcpy(pVVar52 + ( uint )(iVar74 * (int)local_1f0), (ArrayBase*)&local_338, local_1f0 & 0xffffffff);
                  }
 ...
 while ( true );
      ...
      if (local_318._4_4_ != 0) {
         ...
         do {
            if (uVar73 != 0) {
               uVar72 = 0;
               LAB_00119449:uVar24 = (uint)uVar72;
               if (( *(ulong*)( local_308 + ( ulong )((int)local_310 * local_5a4 + ( uVar24 >> 6 )) * 8 ) >> ( uVar72 & 0x3f ) & 1 ) != 0) goto LAB_001193f8;
               lVar63 = 0;
               do {
                  uVar42 = local_148[lVar63] + uVar24;
                  uVar48 = *(int*)( (long)&local_128 + lVar63 * 4 ) + local_5a4;
                  if (( ( ( -1 < (int)( uVar42 | uVar48 ) ) && ( (int)uVar42 < (int)uVar73 ) ) && ( (int)uVar48 < (int)local_318._4_4_ ) ) && ( ( *(ulong*)( local_308 + ( ulong )(uVar48 * (int)local_310 + ( uVar42 >> 6 )) * 8 ) >> ( (ulong)uVar42 & 0x3f ) & 1 ) != 0 )) {
                     pVVar52 = (Vector2*)local_108;
                     uVar73 = 0;
                     fVar84 = (float)(int)( __LC82 & uVar24 ) + (float)( uVar24 >> 0x10 ) * _LC84 + _LC11;
                     fVar95 = (float)(int)( _UNK_001205c4 & local_5a4 ) + (float)( local_5a4 >> 0x10 ) * _LC84 + _LC11;
                     fVar77 = (float)(int)( _UNK_001205c8 & uVar24 ) + (float)( uVar24 >> 0x10 ) * _LC84 + _LC11;
                     fVar82 = (float)(int)( _UNK_001205cc & local_5a4 ) + (float)( local_5a4 >> 0x10 ) * _LC84 + _LC11;
 ...
 while ( lVar63 != 8 );
            ...
            LAB_0011ba6a:local_5a4 = local_5a4 + 1;
         }
 while ( local_5a4 < local_318._4_4_ );
      ...
      if (param_2[0x12] != (_func_bool_ProgressCategory_int_void_ptr)0x0) goto LAB_0011a50f;
      LAB_0011b8f7:if (param_2[0x10] == (_func_bool_ProgressCategory_int_void_ptr)0x0) {
         LAB_0011b93c:local_518 = &local_288;
         local_548 = &local_318;
      }
 else {
         local_518 = &local_258;
   ...
   do {
         ...
         *(int*)( (long)puVar36 + 0x1c ) = iVar56;
         if (iVar56 != 0) {
            ...
            if (( (void*)puVar36[2] != (void*)0x0 ) && ( *(int*)( (long)puVar36 + 0x1c ) != 0 )) {
               memset((void*)puVar36[2], 0, ( ulong )(uint)(*(int*)( (long)puVar36 + 0x1c ) * *(int*)( puVar36 + 3 )));
            }
      ...
      if (( cVar9 == (code)0x0 ) && ( 0x1000 < (int)( uVar48 * uVar51 ) )) {
         ...
         iVar25 = uVar48 + 1;
         do {
            if (( cVar11 == (code)0x0 ) || ( iVar50 = *(int*)( param_1 + 0xb4 ) * 0x10dcd + 0x3039 ),uVar30 = *(uint*)( param_1 + 0xb8 ) ^ *(uint*)( param_1 + 0xb8 ) << 0xd,uVar30 = uVar30 ^ uVar30 >> 0x11,uVar30 = uVar30 << 5 ^ uVar30,lVar63 = ( ulong ) * (uint*)( param_1 + 0xbc ) * 0x29a65ead + ( ulong ) * (uint*)( param_1 + 0xc0 ),auVar81._4_4_ = uVar30,auVar81._0_4_ = iVar50,auVar81._8_8_ = lVar63,*(undefined1(*) [16])( param_1 + 0xb4 ) = auVar81,( (int)lVar63 + iVar50 + uVar30 & 1 ) == 0) {
               local_5c8 = (uint*)0x0;
               uVar30 = uVar42;
               uVar53 = uVar61;
            }
            ...
            if (cVar10 == (code)0x0) {
               LAB_0011b112:uVar29 = uVar30 + uVar75;
                     ...
                     do {
                        while (uVar67 = (uint)puVar69,uVar67 < puVar38[1]) {
                           ...
                           do {
                              ...
                              if (( *(ulong*)( *(long*)( puVar38 + 4 ) + ( ulong )(puVar38[2] * uVar67 + ( uVar26 >> 6 )) * 8 ) >> ( (byte)uVar26 & 0x3f ) & *(ulong*)( puVar66[2] + ( ulong )((uint)puVar66[1] * uVar71 + (int)( uVar31 >> 6 )) * 8 ) >> ( (byte)uVar31 & 0x3f ) ) != 0) goto joined_r0x0011b388;
                              uVar28 = uVar26 & 0x3f;
...
;
 ...
 while ( uVar71 != uVar60 );
               ...
               if (( local_5cc == 0 ) || ( ( (int)uVar75 <= (int)( local_5cc - uVar30 ) && ( (int)uVar60 <= (int)( local_5cc - uVar53 ) ) ) )) goto LAB_0011b112;
            }

            joined_r0x0011b388:local_5a0 = local_5a0 + -1;
         }
 while ( local_5a0 != 0 );
      }
 else {
            ...
            if ((int)uVar30 <= (int)( uVar48 + iVar25 )) {
               ...
               do {
                  ...
                  if ((int)fVar84 <= (int)( uVar51 + iVar25 )) {
                     for (; ( local_5cc == 0 || ( (int)fVar84 <= (int)( local_5cc - uVar75 ) ) ); fVar84 = (float)( iVar25 + (int)fVar84 )) {
                              ...
                              do {
                                 while (uVar67 < puVar38[1]) {
                                    ...
                                    do {
                                       ...
                                       if (( *(ulong*)( *(long*)( puVar38 + 4 ) + ( ulong )(puVar38[2] * uVar67 + ( uVar28 >> 6 )) * 8 ) >> ( (byte)uVar28 & 0x3f ) & *(ulong*)( puVar66[2] + ( ulong )((uint)puVar66[1] * uVar70 + ( uVar26 >> 6 )) * 8 ) >> ( (byte)uVar26 & 0x3f ) ) != 0) goto joined_r0x0011a9a7;
                                       uVar58 = uVar28 & 0x3f;
...
;
 ...
 while ( uVar71 != uVar70 );
                           ...
                           LAB_0011a943:puVar46 = (ulong*)( ulong )(uVar48 * uVar51);
                           iVar74 = iVar50;
                           local_578 = fVar84;
                           local_574 = uVar60;
                           local_550 = uVar75;
                        ...
                        joined_r0x0011a9a7:if ((int)uVar51 < (int)fVar84) break;
                     }
 ...
 while ( ( uVar60 != 1 ) && ( uVar60 = 1 ),uVar53 = uVar42,uVar75 = uVar61,param_2[0x15] != (_func_bool_ProgressCategory_int_void_ptr)0x0 );
 ...
 while ( !bVar76 && !bVar16 );
   ...
   fVar84 = local_578;
   uVar15 = uVar73;
   LAB_0011aa4b:local_5e0 = (uint*)(ulong)uVar15;
 ...
 while ( (ulong*)puVar69 != puVar46 );
   ...
   LAB_0011aa78:if ((int)uVar29 < (int)*puVar54) {
      uVar29 = *puVar54;
   }
      ...
      if ((int)uVar73 < 1) {
         ...
         do {
            while (( iVar25 = (int)in_R8 ),-1 < iVar74 && ( 0 < (int)uVar24 )) {
               ...
               do {
                  iVar50 = (int)puVar46;
                  if (( ( ( -1 < iVar50 ) && ( ( *(ulong*)( local_548[2] + ( ulong )((uint)local_548[1] * iVar25 + (int)( uVar31 >> 6 )) * 8 ) >> ( uVar31 & 0x3f ) & 1 ) != 0 ) ) && ( iVar50 < (int)uVar29 ) ) && ( iVar74 < (int)local_5a8 )) {
                     puVar66 = (ulong*)( *(long*)( puVar38 + 4 ) + ( ulong )(puVar38[2] * iVar74 + (int)( (ulong)puVar46 >> 6 )) * 8 );
...
;
 ...
 while ( uVar73 != iVar25 + 1U );
         LAB_0011abb3:if (cVar8 == (code)0x0) goto LAB_0011ad20;
            ...
            if (( -1 < iVar25 ) && ( 0 < (int)(uint)local_318 )) {
               ...
               do {
                  while (true) {
                     iVar50 = (int)puVar46;
                     uVar73 = (uint)uVar31;
                     if (( ( iVar50<(int)uVar29 & (byte)~(byte)((ulong)puVar46 >> 0x18)> > 7 ) != 0 ) && ( iVar25 < (int)local_5a8 )) break;
                     LAB_0011ac91:uVar31 = ( ulong )(uVar73 + 1);
                     puVar46 = (ulong*)( ulong )(iVar50 + 1);
...
;
                  ...
                  iVar64 = (int)( uVar31 >> 6 );
                  if (( *(ulong*)( local_308 + ( ulong )(uint)((int)local_310 * iVar74 + iVar64) * 8 ) >> ( uVar31 & 0x3f ) & 1 ) == 0) {
                     if (( puVar68 == (ulong*)0x0 ) || ( ( *(ulong*)( puVar68[2] + ( ulong )(uint)((int)puVar68[1] * iVar74 + iVar64) * 8 ) >> ( uVar73 & 0x3f ) & 1 ) == 0 )) {
                        if (( puVar66 != (ulong*)0x0 ) && ( ( *(ulong*)( puVar66[2] + ( ulong )(uint)((int)puVar66[1] * iVar74 + iVar64) * 8 ) >> ( uVar73 & 0x3f ) & 1 ) != 0 )) {
 ...
 while ( local_318._4_4_ != iVar74 );
      ...
      if (cVar8 == (code)0x0) goto LAB_0011ad20;
      LAB_0011b725:puVar66 = (ulong*)0x0;
      piVar14 = *(int**)( *(long*)param_1 + (long)puVar62 * 8 );
      if (*(int*)( param_2 + 4 ) != 0) {
         puVar66 = &local_228;
      }
            ...
            if (( -1 < iVar25 ) && ( 0 < (int)(uint)local_288 )) {
               ...
               do {
                  while (true) {
                     ...
                     uVar73 = (uint)uVar31;
                     if (( ( iVar50<(int)uVar29 & (byte)~(byte)((ulong)puVar46 >> 0x18)> > 7 ) != 0 ) && ( iVar25 < (int)local_5a8 )) break;
                     LAB_0011b7e7:uVar31 = ( ulong )(uVar73 + 1);
                     puVar46 = (ulong*)( ulong )(iVar50 + 1);
...
;
                  uVar24 = *piVar14 * iVar25 + iVar50;
                  iVar64 = (int)( uVar31 >> 6 );
                  if (( *(ulong*)( local_278 + ( ulong )(uint)((int)local_280 * iVar74 + iVar64) * 8 ) >> ( uVar31 & 0x3f ) & 1 ) == 0) {
                     if (( puVar68 == (ulong*)0x0 ) || ( ( *(ulong*)( puVar68[2] + ( ulong )(uint)((int)puVar68[1] * iVar74 + iVar64) * 8 ) >> ( uVar73 & 0x3f ) & 1 ) == 0 )) {
                        if (( puVar66 != (ulong*)0x0 ) && ( ( *(ulong*)( puVar66[2] + ( ulong )(uint)((int)puVar66[1] * iVar74 + iVar64) * 8 ) >> ( uVar73 & 0x3f ) & 1 ) != 0 )) {
                           *(uint*)( *(long*)( piVar14 + 2 ) + (ulong)uVar24 * 4 ) = uVar41 | 0xa0000000;
                        }
   ...
   *puVar13 = local_4c4;
   ...
   do {
      ...
      if (uVar41 == 0) {
         ...
         pfVar43 = (float*)( *(long*)( puVar13 + 8 ) + ( ulong ) * (uint*)( *(long*)( puVar13 + 0xc ) + uVar31 * 4 ) * 8 );
      }
      ...
      *pfVar43 = fVar84;
      ...
      if (( fVar84 < 0.0 ) || ( fVar95 < 0.0 )) {
         if (s_print != (undefined*)0x0) {
            ...
            ( *(code*)s_print )("\rASSERT: %s %s %d\n", "texcoord.x >= 0 && texcoord.y >= 0", "thirdparty/xatlas/xatlas.cpp");
         ...
         if ((int)fVar84 + 0x80800000U < 2) {
            LAB_0011b5b2:if (s_print != (undefined*)0x0) {
               puVar46 = (ulong*)0x2197;
               ( *(code*)s_print )("\rASSERT: %s %s %d\n", "isFinite(texcoord.x) && isFinite(texcoord.y)", "thirdparty/xatlas/xatlas.cpp");
            }

         }
 else {
            LAB_0011adec:if ((int)pfVar43[1] + 0x80800000U < 2) goto LAB_0011b5b2;
         }
   ...
   while (pVVar52 = pVVar52 + 8,uVar73 != 4) {
      ...
      if (local_1f0._4_4_ < 0x15) {
         if (local_1f0._4_4_ != 0) {
            LAB_001195ee:pVVar39 = local_1f8 + uVar33 * 4;
            pVVar45 = local_1f8;
            pVVar59 = local_1e0;
            do {
               cVar20 = linesIntersect(pVVar59, (Vector2*)( ulong )(( ( *(uint*)pVVar45 % 3 + 1 ) / 3 ) * 3), pVVar52, pVVar45, fVar84);
 ...
 while ( pVVar45 != pVVar39 );
         ...
         if (( local_1a0._4_4_ == 0 ) && ( cVar20 = UniformGrid2::createGrid((UniformGrid2*)&local_1f8) ),cVar20 == '\0') goto LAB_001195ee;
         ...
         if (local_158._4_4_ != 0) {
            ...
            do {
               ...
               uVar61 = uVar42;
               pVVar39 = local_178;
               for (uVar48 = *(uint*)( (long)pvVar18 + ( ulong ) * puVar38 * 4 ); uVar42 = uVar61,uVar48 != 0xffffffff; uVar48 = *(uint*)( (long)pvVar19 + ( ulong )(uVar48 + 1) * 4 )) {
                  while (true) {
                     uVar42 = uVar61 + 1;
                     local_170 = CONCAT44(uVar42, (int)local_170);
                     local_338 = (ulong*)CONCAT44(local_338._4_4_, *(undefined4*)( (long)pvVar19 + (ulong)uVar48 * 4 ));
                     if (uVar42 <= local_168) break;
                     uVar51 = uVar42;
                     if (( local_168 == 0 ) || ( uVar51 = uVar51 != 0 )) {
                        if (uVar51 * (int)local_170 != 0) {
                           LAB_0011bbf5:pVVar39 = (Vector2*)( *(code*)s_realloc )(pVVar39);
                           local_178 = pVVar39;
                           local_168 = uVar51;
                           break;
                        }
...
;
                  if (pVVar39 != (Vector2*)0x0) {
                     memcpy(pVVar39 + uVar61 * (int)local_170, (ArrayBase*)&local_338, local_170 & 0xffffffff);
                  }

                  uVar61 = uVar42;
               }

               LAB_0011bcd5:puVar38 = puVar38 + 1;
            }
 while ( puVar38 != puVar37 );
         ...
         if (uVar42 != 0) {
            ...
            do {
               ...
               if (( uVar42 != (uint)pVVar45 ) && ( cVar20 = linesIntersect((Vector2*)( ulong )(( ( uVar42 % 3 + 1 ) / 3 ) * 3), pVVar59, pVVar52, pVVar47, fVar84) ),pVVar52 = extraout_RDX_00,cVar20 != '\0') goto LAB_0011be4f;
               pVVar59 = pVVar59 + 4;
               pVVar45 = pVVar47;
            }
...
;
   ...
   goto LAB_00119449;
   LAB_0011be4f:uVar73 = (uint)local_318;
   LAB_001193f8:puVar46 = (ulong*)( local_2d8 + ( ulong )((int)local_2e0 * local_5a4 + ( uVar24 >> 6 )) * 8 );
   *puVar46 = *puVar46 | 1L << ( (byte)uVar72 & 0x3f );
   ...
   LAB_0011943e:uVar72 = ( ulong )(uVar24 + 1);
   if (uVar73 <= uVar24 + 1) goto LAB_0011ba6a;
   goto LAB_00119449;
   LAB_0011b5de:if (( param_3 != (void*)0x0 ) && ( iVar74 = (int)( ( (float)( local_53c - local_4fc ) / (float)local_4d0 ) * __LC35 ) ),bVar76 = iVar74 != local_4a8,local_4a8 = iVar74,bVar76) {
   ...
   goto LAB_00118ed2;
   LAB_0011c2be:iVar56 = *(int*)( param_2 + 4 );
   if (local_5cc == 0) {
   ...
   *(int*)( param_1 + 0xa8 ) = iVar74;
   ...
   if (uVar22 != 0) {
      LAB_0011c3aa:do {
         ...
         if (uVar41 == 0) {
            LAB_0011c3c5:puVar46 = *(ulong**)( param_1 + 0x18 );
            *(undefined4*)( (long)puVar46 + lVar55 ) = 0;
            ...
            do {
               ...
               do {
                  ...
                  bVar40 = (byte)uVar48;
                  uVar48 = uVar48 + 1;
                  uVar24 = uVar24 + ( ( uint )(*(ulong*)( *(long*)( lVar63 + 0x10 ) + ( ulong )(uVar61 + iVar56) * 8 ) >> ( bVar40 & 0x3f )) & 1 );
               }
 while ( uVar41 != uVar48 );
               uVar42 = uVar42 + 1;
 ...
 while ( uVar73 != uVar42 );
         ...
         if (uVar22 == 1) {
            ...
            ( *(code*)s_print )((double)( *(float*)( (long)puVar46 + lVar55 ) * __LC35 ), "   %u: %f%% utilization\n");
            uVar22 = *(uint*)( param_1 + 0x24 );
         }
 ...
 while ( uVar23 < uVar22 );
   ...
   LAB_00118373:ArrayBase::~ArrayBase((ArrayBase*)&local_358);
   ...
   LAB_0011843b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar31;
   }

   LAB_0011c5a1:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* xatlas::internal::Array<unsigned int>::zeroOutMemory() */void xatlas::internal::Array<unsigned_int>::zeroOutMemory(Array<unsigned_int> *this) {
...
/* xatlas::internal::param::PiecewiseParam::computeChart() */undefined8 __thiscall xatlas::internal::param::PiecewiseParam::computeChart(PiecewiseParam *this)

...
undefined8 cff_cmap_unicode_init(long *param_1) {
   ...
   if (UNRECOVERED_JUMPTABLE != (code*)0x0) {
      ...
      uVar2 = ( *UNRECOVERED_JUMPTABLE )(*(undefined8*)( *param_1 + 0xb8 ), param_1, *(undefined4*)( lVar1 + 0x24 ), cff_sid_to_glyph_name, 0);
      return uVar2;
   }
...
undefined8 cff_get_kerning(long param_1, undefined8 param_2, undefined8 param_3, undefined1 (*param_4)[16]) {
   long lVar1;
   int iVar2;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 cff_driver_init(long param_1) {
   undefined8 uVar1;
   undefined8 uVar2;
   uint uVar3;
   long in_FS_OFFSET;
...
void cff_make_private_dict(long param_1, undefined8 *param_2) {
   ...
   *(byte*)( param_2 + 1 ) = bVar1;
   if (bVar1 != 0) {
      do {
         *(short*)( (long)param_2 + lVar2 * 2 + 0xc ) = (short)*(undefined8*)( param_1 + 0x150 + lVar2 * 8 );
         lVar2 = lVar2 + 1;
      }
 while ( (uint)lVar2 < (uint)bVar1 );
   ...
   *(byte*)( (long)param_2 + 9 ) = bVar1;
   if (bVar1 != 0) {
      lVar2 = 0;
      do {
         *(short*)( (long)param_2 + lVar2 * 2 + 0x28 ) = (short)*(undefined8*)( param_1 + 0x1c0 + lVar2 * 8 );
         lVar2 = lVar2 + 1;
      }
 while ( (uint)lVar2 < (uint)bVar1 );
   }
   ...
   *(byte*)( (long)param_2 + 10 ) = bVar1;
   if (bVar1 != 0) {
      lVar2 = 0;
      do {
         *(short*)( (long)param_2 + lVar2 * 2 + 0x3c ) = (short)*(undefined8*)( param_1 + 0x210 + lVar2 * 8 );
         lVar2 = lVar2 + 1;
      }
 while ( (uint)lVar2 < (uint)bVar1 );
   }
   ...
   *(byte*)( (long)param_2 + 0xb ) = bVar1;
   if (bVar1 != 0) {
      lVar2 = 0;
      do {
         *(short*)( (long)param_2 + lVar2 * 2 + 0x58 ) = (short)*(undefined8*)( param_1 + 0x280 + lVar2 * 8 );
         lVar2 = lVar2 + 1;
      }
 while ( (uint)lVar2 < (uint)bVar1 );
   }
   ...
   *(byte*)( (long)param_2 + 0x84 ) = bVar1;
   if (bVar1 != 0) {
      lVar2 = 0;
      do {
         *(short*)( (long)param_2 + lVar2 * 2 + 0x88 ) = (short)*(undefined8*)( param_1 + 0x300 + lVar2 * 8 );
         lVar2 = lVar2 + 1;
      }
 while ( (uint)lVar2 < (uint)bVar1 );
   }
   ...
   *(byte*)( (long)param_2 + 0x85 ) = bVar1;
   if (bVar1 != 0) {
      lVar2 = 0;
      do {
         *(short*)( (long)param_2 + lVar2 * 2 + 0xa2 ) = (short)*(undefined8*)( param_1 + 0x368 + lVar2 * 8 );
         lVar2 = lVar2 + 1;
      }
 while ( (uint)lVar2 < (uint)bVar1 );
   }
...
undefined8 cff_get_cmap_info(long *param_1, undefined8 param_2) {
   undefined8 uVar1;
   undefined8 *puVar2;
   if (( (undefined1*)param_1[2] == cff_cmap_unicode_class_rec ) || ( (undefined1*)param_1[2] == cff_cmap_encoding_class_rec )) {
      return 0x96;
   }
...
;
   LAB_00100cc8:lVar7 = 0;
   goto LAB_00100b8c;
   joined_r0x00100bc2:pbVar5 = pbVar6;
   if (( ( iVar4 != 0 ) && ( pbVar5 = pbVar6 + 1 ),param_2 < pbVar6 + 2 )) goto LAB_00100cc8;
   iVar14 = 4 - iVar4;
   uVar8 = (int)( uint ) * pbVar5 >> ( (byte)iVar4 & 0x1f ) & 0xf;
   if (uVar8 < 10) {
      pbVar6 = pbVar5;
   ...
   LAB_00100adc:lVar7 = lVar9;
   if (uVar8 == 0xc) {
      bVar3 = true;
      LAB_00100c18:bVar2 = false;
      lVar13 = 0;
      while (true) {
         pbVar6 = pbVar5;
         if (( ( iVar14 != 0 ) && ( pbVar6 = pbVar5 + 1 ),param_2 < pbVar5 + 2 )) goto LAB_00100cc8;
...
;
      if (bVar3) {
         if (( lVar9 == 0 ) || ( lVar13 = bVar2 )) goto LAB_00100cc8;
         goto LAB_00100afa;
      }
      ...
      if (lVar9 == 0) goto LAB_00100b8c;
      lVar13 = 0;
      LAB_00100afa:lVar13 = lVar10 + param_3 + lVar13;
         ...
         if (lVar11 < 6) {
            ...
            if (lVar9 / lVar12 < 0x8000) {
               ...
               *param_4 = lVar10 + -5;
               ...
               lVar7 = FT_DivFix(lVar9, *(undefined8*)( power_ten_limits + lVar11 * 8 + 0x40 ), lVar9 % lVar12);
               *param_4 = lVar10 + -4;
            }
...
int cff_charset_compute_cids(long param_1, uint param_2, undefined8 param_3) {
   ...
   if (*(int*)( param_1 + 0x20 ) == 0) {
      if (param_2 == 0) {
         ...
         *(undefined8*)( param_1 + 0x18 ) = uVar5;
         iVar7 = local_24;
         if (local_24 != 0) goto LAB_0010102d;
      }
 else {
         puVar3 = *(ushort**)( param_1 + 0x10 );
         uVar8 = 0;
         puVar1 = puVar3 + param_2;
         if (( param_2 & 1 ) == 0) goto LAB_00100fc0;
         uVar8 = 0;
         if (*puVar3 != 0) {
            uVar8 = ( uint ) * puVar3;
         }
         ...
         for (puVar3 = puVar3 + 1; puVar1 != puVar3; puVar3 = puVar3 + 2) {
            LAB_00100fc0:if ((ushort)uVar8 < *puVar3) {
               uVar8 = ( uint ) * puVar3;
            }

            if ((ushort)uVar8 < puVar3[1]) {
               uVar8 = (uint)puVar3[1];
            }
 ...
 while ( uVar6 < param_2 );
   ...
   iVar7 = 0;
   LAB_0010102d:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar7;
   }
...
ulong cff_blend_check_vector(char *param_1, int param_2, uint param_3, void *param_4) {
   ...
   ulong uVar2;
   uVar2 = 1;
   if (( ( ( *param_1 != '\0' ) && ( *(int*)( param_1 + 0x10 ) == param_2 ) ) && ( *(uint*)( param_1 + 0x14 ) == param_3 ) ) && ( uVar2 = param_3 != 0 )) {
...
int cff_blend_build_vector(undefined1 *param_1, uint param_2, uint param_3, long *param_4) {
   ...
   local_44 = 0;
   if (( ( ( param_3 == 0 ) || ( param_4 != (long*)0x0 ) ) && ( ( *param_1 = 0 ),param_3 == 0 || ( *(ushort*)( lVar5 + 0x13a8 ) == param_3 ) ) )) {
      puVar12 = (uint*)( (ulong)param_2 * 0x10 + *(long*)( lVar5 + 0x13a0 ) );
      uVar3 = *puVar12;
      iVar11 = uVar3 + 1;
      uVar13 = ft_mem_qrealloc(uVar6, 4, *(undefined4*)( param_1 + 0x20 ), iVar11, *(undefined8*)( param_1 + 0x28 ), &local_44);
            ...
            do {
               if (uVar21 == 0) {
                  **(undefined4**)( param_1 + 0x28 ) = 0x10000;
                  ...
                  if (*(uint*)( lVar5 + 0x13ac ) <= uVar4) goto LAB_00101117;
 ...
 while ( bVar22 );
         ...
         *(uint*)( param_1 + 0x10 ) = param_2;
         if (param_3 != 0) {
            __dest = (void*)ft_mem_qrealloc(uVar6, 8, *(undefined4*)( param_1 + 0x14 ), (ulong)param_3, *(undefined8*)( param_1 + 0x18 ), &local_44);
            *(void**)( param_1 + 0x18 ) = __dest;
            iVar10 = local_44;
            if (local_44 != 0) goto LAB_0010111c;
      ...
      LAB_00101117:iVar10 = 3;
   }

   LAB_0010111c:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
int cff_index_get_pointers(long *param_1, undefined8 *param_2, long *param_3, long *param_4) {
            ...
            if (local_44 == 0) {
               ...
               if (bVar2 == 2) {
                  ...
                  for (; puVar10 < puVar1; puVar10 = (uint*)( (long)puVar10 + 3 )) {
                     *puVar12 = ( ulong )(( uint )(byte) * puVar10 << 0x10 | ( uint ) * (byte*)( (long)puVar10 + 1 ) << 8 | ( uint ) * (byte*)( (long)puVar10 + 2 ));
                     puVar12 = puVar12 + 1;
                  }
 ...
 while ( lVar9 - lVar8 != 0 );
                  ...
                  for (; puVar10 < puVar1; puVar10 = puVar10 + 1) {
                     uVar16 = *puVar10;
                     *puVar12 = ( ulong )(uVar16 >> 0x18 | ( uVar16 & 0xff0000 ) >> 8 | ( uVar16 & 0xff00 ) << 8 | uVar16 << 0x18);
                     puVar12 = puVar12 + 1;
                  }
      ...
      local_48 = local_44;
      param_1[6] = 0;
      if (local_44 != 0) goto LAB_00101497;
      uVar16 = *(uint*)( (long)param_1 + 0x14 );
   }

   LAB_0010143f:if (uVar16 == 0) goto LAB_00101497;
   lVar5 = param_1[5];
            ...
            *param_2 = plVar7;
            ...
            do {
               while (uVar18 = *(long*)( param_1[6] + uVar13 * 8 ) - 1,uVar18 < uVar15) {
                  uVar18 = uVar15;
                  if (param_3 == (long*)0x0) goto LAB_0010168b;
                  *plVar17 = lVar14 + uVar15 + lVar8;
                  LAB_00101585:uVar13 = uVar13 + 1;
                  plVar17 = plVar17 + 1;
                  if (*(uint*)( (long)param_1 + 0x14 ) < uVar13) goto LAB_0010160e;
               }
;
               ...
               if (param_3 == (long*)0x0) {
                  LAB_0010168b:*plVar17 = lVar9 + uVar18;
                  uVar15 = uVar18;
                  goto LAB_00101585;
               }
               ...
               *plVar17 = lVar11;
               if (uVar18 == uVar15) goto LAB_00101585;
               uVar13 = uVar13 + 1;
               lVar14 = lVar14 + 1;
 ...
 while ( uVar13 <= uVar4 );
            LAB_0010160e:*param_2 = plVar7;
            if (param_3 != (long*)0x0) goto LAB_0010163a;
         }

         LAB_0010163e:if (param_4 != (long*)0x0) {
         ...
         if (local_48 == 0) {
            ...
            *plVar7 = lVar8;
            bVar20 = bVar19;
            if (iVar3 != 0) goto LAB_0010152e;
            *param_2 = plVar7;
            LAB_0010163a:*param_3 = lVar8;
            goto LAB_0010163e;
         }
   ...
   LAB_00101497:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
int cff_ps_get_font_info(long param_1, undefined8 *param_2) {
   ...
   if (( *(char*)( param_1 + 0x4b8 ) == '\0' ) && ( iVar3 = lVar2 != 0 )) {
      ...
      if (puVar4 == (undefined8*)0x0) {
         ...
         *puVar4 = uVar5;
         ...
         for (int i = 0; i < 3; i++) {
            uVar1 = *(undefined4*)( lVar2 + ( 4*i + 1652 ) );
            puVar4[( i + 1 )] = uVar5;
            uVar5 = cff_index_get_sid_string(lVar2, uVar1);
         }
   ...
   LAB_00101a22:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar3;
   }
...
undefined8 cff_get_glyph_name(long param_1, uint param_2, undefined8 param_3, undefined4 param_4) {
   ...
   if (*(char*)( lVar1 + 0x28 ) == '\x02') {
      ...
      if (( puVar3 != (undefined8*)0x0 ) && ( (code*)*puVar3 != (code*)0x0 )) {
         /* WARNING: Could not recover jumptable at 0x00101bd5. Too many branches */
         /* WARNING: Treating indirect jump as call */
      ...
      lVar1 = cff_index_get_sid_string(lVar1, *(undefined2*)( *(long*)( lVar1 + 0x520 ) + (ulong)param_2 * 2 ));
      if (lVar1 != 0) {
...
int cff_ps_get_font_extra(long param_1, ushort *param_2) {
   ...
   if (lVar3 != 0) {
      ...
      if (puVar6 == (ushort*)0x0) {
         ...
         iVar5 = local_34;
         if (local_34 != 0) goto LAB_00101c29;
 ...
 else if (( 0x20 < bVar1 ) || ( ( 0xfffffffeffffdbffU >> ( (ulong)bVar1 & 0x3f ) & 1 ) != 0 )) goto LAB_00101d0a;
               }
...
long cff_get_interface(long param_1, undefined8 param_2) {
   ...
   if (( ( lVar1 == 0 ) && ( param_1 != 0 ) ) && ( *(long*)( param_1 + 8 ) != 0 )) {
      ...
      if (plVar2 != (long*)0x0) {
         /* WARNING: Could not recover jumptable at 0x00101e21. Too many branches */
         /* WARNING: Treating indirect jump as call */
...
undefined8 cff_size_get_globals_funcs_isra_0(long param_1) {
   ...
   if (( ( lVar2 != 0 ) && ( puVar1 != (undefined8*)0x0 ) ) && ( UNRECOVERED_JUMPTABLE = (code*)*puVar1 ),UNRECOVERED_JUMPTABLE != (code*)0x0) {
      /* WARNING: Could not recover jumptable at 0x00101e64. Too many branches */
      /* WARNING: Treating indirect jump as call */
...
int cff_size_init(long *param_1) {
   ...
   if (puVar4 == (undefined8*)0x0) {
      if (local_12c == 0) {
         LAB_00102019:iVar3 = 0;
         goto LAB_00101f57;
      }

      LAB_00102028:puVar5 = (undefined8*)0x0;
   }
 else {
            ...
            do {
               if ((int)uVar8 == 0) {
                  *(undefined8**)param_1[10] = puVar5;
                  ...
                  if (local_12c == 0) goto LAB_00102019;
                  break;
               }
 ...
 while ( local_12c == 0 );
      ...
      if (puVar5 == (undefined8*)0x0) goto LAB_00102028;
 ...
 while ( puVar7 != puVar5 );
   ...
   ft_mem_free(uVar1, puVar5);
   iVar3 = local_12c;
   LAB_00101f57:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
int cff_size_request(long *param_1, undefined8 param_2) {
 ...
 while ( lVar9 != -8 );
   ...
   LAB_00102237:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return local_4c;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 cff_parse_font_matrix(long param_1) {
   long lVar1;
   long lVar2;
   char *pcVar3;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   uVar8 = 0xa1;
   if (*(ulong*)( param_1 + 0x28 ) < lVar1 + 0x30U) goto LAB_001027da;
   ...
   *(undefined1*)( lVar2 + 0x60 ) = 1;
   ...
   do {
      ...
      LAB_001026fd:lVar10 = auVar20._8_8_;
   ...
   if (( lVar19 + 9U < 10 ) && ( plVar11 = local_78(ulong)(lVar19 - lVar18) < 10 )) {
      do {
         while (lVar1 = *plVar16,lVar1 == 0) {
            LAB_0010285b:plVar16 = plVar16 + 1;
            plVar11 = plVar11 + 1;
            if (plVar16 == local_78) goto LAB_001028b0;
         }
;
 ...
 while ( plVar17 != local_78 );
      LAB_001028b0:*(undefined8*)( lVar2 + 0x68 ) = *(undefined8*)( power_tens + lVar19 * -8 );
      ...
      *(long*)( lVar2 + 0x78 ) = local_a8[5];
      ...
      if (cVar7 == '\0') goto LAB_001027ad;
   }
 else {
      LAB_001027ad:uVar6 = _UNK_00108de8;
      uVar8 = __LC10;
   ...
   uVar8 = 0;
   LAB_001027da:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 cff_parse_font_bbox(long param_1) {
   ...
   if (puVar1 + 4 <= *(undefined8**)( param_1 + 0x28 )) {
      ...
      for (int i = 0; i < 3; i++) {
         ...
         uVar3 = puVar1[( i + 1 )];
         *(undefined8*)( lVar2 + ( 8*i + 136 ) ) = uVar4;
...
long cff_parse_num_isra_0(long param_1, char *param_2) {
   ...
   return (long)(short)( ( (uint)(byte)param_2[1] << 0x10 | (uint)(byte)param_2[2] << 8 | (uint)(byte)param_2[3] ) + 0x80 >> 8 );
}
...
undefined8 cff_parser_run(long param_1, byte *param_2, byte *param_3) {
   ...
   do {
      ...
      if (( uVar10 < 0x1b || uVar10 == 0x1f ) || ( uVar10 == 0xff )) {
         ...
         *puVar4 = (ulong)param_2;
         ...
         iVar3 = 4;
         LAB_00102e6f:if (piVar11[1] != ( uVar10 | *(uint*)( param_1 + 0x34 ) )) break;
         plVar13 = (long*)( (ulong)(uint)piVar11[2] + *(long*)( param_1 + 0x38 ) );
         if (iVar3 == 6) {
            switchD_00102ea7_caseD_6:uVar9 = uVar9 & 0xffffffff;
 ...
 while ( puVar4 != puVar12 );
          ...
          goto joined_r0x00102f36;
               case 6:
          goto switchD_00102ea7_caseD_6;
            }

            cVar2 = (char)piVar11[3];
            joined_r0x00102f36:if (cVar2 == '\x02') {
               *(short*)plVar13 = (short)lVar15;
               iVar3 = *piVar11;
            }
 else if (cVar2 == '\x04') {
         ...
         LAB_00102ee8:if (iVar3 == 8) goto joined_r0x00102f00;
         puVar12 = *(ulong**)( param_1 + 0x20 );
         LAB_00102ef5:*(ulong**)( param_1 + 0x28 ) = puVar12;
      }
 else {
         if (*(uint*)( param_1 + 0x30 ) <= uVar8) {
            return 6;
...
;
      ...
      joined_r0x00102f00:param_2 = pbVar14 + 1;
      if (param_3 <= param_2) {
         return 0;
      }
 ...
 while ( true );
   iVar3 = piVar11[8];
   piVar11 = piVar11 + 8;
   if (iVar3 == 0) goto LAB_00102ef5;
   goto LAB_00102e6f;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int cff_load_private_dict(undefined8 *param_1, long param_2, undefined4 param_3, undefined8 param_4) {
   long lVar1;
   undefined8 uVar2;
   int iVar3;
   undefined8 uVar4;
      ...
      *(undefined8*)( param_2 + 0x2d8 ) = uVar2;
      ...
      if (local_8c == 0) {
         ...
         if (iVar3 == 0) {
            ...
            if (iVar3 == 0) {
               iVar3 = cff_parser_run(&local_88, *(undefined8*)( lVar1 + 0x40 ), *(undefined8*)( lVar1 + 0x48 ));
...
void cff_free_glyph_data(long param_1, undefined8 *param_2, undefined4 param_3) {
   ...
   LAB_001033c9:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
ulong cff_parse_blend(long param_1) {
   ...
   if (( lVar19 != 0 ) && ( lVar2 = lVar2 != 0 )) {
      __s1 = *(void**)( lVar2 + 0x458 );
      uVar7 = *(uint*)( lVar2 + 0x450 );
      iVar10 = *(int*)( lVar19 + 0x2c8 );
      if (( ( ( *(char*)( lVar2 + 0x420 ) == '\0' ) || ( ( iVar10 != *(int*)( lVar2 + 0x430 ) || ( uVar7 != *(uint*)( lVar2 + 0x434 ) ) ) ) ) || ( ( uVar7 != 0 && ( iVar11 = memcmp(__s1, *(void**)( lVar2 + 0x438 ), (ulong)uVar7 << 3) ),iVar11 != 0 ) ) )) goto LAB_001035d5;
      ...
      if (uVar7 <= *(uint*)( param_1 + 0x30 )) {
         ...
         if (uVar20 <= local_50) {
            ...
            if (uVar9 < uVar8) {
               ...
               uVar15 = ft_mem_qrealloc(*(undefined8*)( *(long*)( lVar2 + 0x428 ) + 0x10 ), 1, uVar9, iVar10 + uVar9, uVar21, &local_44);
               *(ulong*)( lVar2 + 0x460 ) = uVar15;
               uVar13 = (ulong)local_44;
               if (local_44 != 0) goto LAB_00103718;
                  ...
                  if (1 < *(uint*)( lVar2 + 0x440 )) {
                     ...
                     do {
                        ...
                        if (*pcVar3 == '\x1e') {
                           ...
                           uVar7 = *(uint*)( pcVar3 + 1 );
                           lVar17 = (long)(int)( uVar7 >> 0x18 | ( uVar7 & 0xff0000 ) >> 8 | ( uVar7 & 0xff00 ) << 8 | uVar7 << 0x18 );
                        }
 else {
                           lVar14 = cff_parse_integer(pcVar3, *(undefined8*)( param_1 + 0x10 ));
                           lVar17 = 0x7fffffff;
                           if (( lVar14 < 0x8000 ) && ( lVar17 = lVar14 < -0x7fff )) {
                              lVar17 = -0x7fffffff;
                           }

                        }

                        iVar10 = iVar10 + (int)( ( ulong )(iVar1 * lVar17 + 0x8000 + ( iVar1 * lVar17 >> 0x3f )) >> 0x10 );
                     }
 while ( iVar11 + uVar20 < *(uint*)( lVar2 + 0x440 ) );
                  ...
                  *(undefined1**)( lVar2 + 0x468 ) = puVar4 + 1;
                  for (int i = 0; i < 3; i++) {
                     *puVar4 = (char)( (uint)iVar10 >> ( -8*i + 24 ) );
                     puVar4 = *(undefined1**)( lVar2 + 1128 );
                     *(undefined1**)( lVar2 + 1128 ) = puVar4 + 1;
                  }
 ...
 while ( uVar9 != local_50 );
         ...
         LAB_00103718:*(undefined1*)( lVar2 + 0x421 ) = 1;
         goto LAB_001035d5;
      }
   ...
   uVar13 = 3;
   LAB_001035d5:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar13;
   }
   ...
   if (param_2 < *(uint*)( (long)param_1 + 0x14 )) {
      ...
      if (lVar11 != 0) {
         ...
         if (uVar7 != 0) {
            ...
            do {
               uVar8 = *puVar4;
               if (uVar8 != 0) goto LAB_00103865;
               puVar4 = puVar4 + 1;
            }
 while ( puVar4 != (ulong*)( lVar11 + 8 + ( ( ulong )(( *(uint*)( (long)param_1 + 0x14 ) - param_2 ) - 1) + ( ulong )(param_2 + 1) ) * 8 ) );
            uVar6 = 0;
            LAB_001039d2:lVar11 = *(long*)( lVar3 + 8 );
            uVar12 = param_1[4];
            uVar8 = 0;
            uVar10 = lVar11 + 1;
            goto LAB_001039e0;
         ...
         LAB_001038e0:uVar6 = 0;
         goto LAB_001038e2;
      }

      uVar6 = FT_Stream_Seek(lVar3, ( ulong ) * (uint*)( param_1 + 2 ) + param_1[1] + ( ulong )(*(byte*)( param_1 + 3 ) * param_2));
      if ((int)uVar6 == 0) {
...
;
   ...
   goto LAB_001038b5;
   LAB_00103865:lVar11 = *(long*)( lVar3 + 8 );
   uVar12 = param_1[4];
   uVar10 = lVar11 + 1;
   if (uVar10 < uVar8) {
      ...
      uVar6 = 0;
      LAB_001039e0:if (uVar10 - uVar8 < uVar12) {
         uVar8 = ( lVar11 - uVar12 ) + 1;
      }
   ...
   if (bVar13) {
      *param_4 = uVar8 - uVar7;
      ...
      LAB_001038e2:*param_3 = 0;
      *param_4 = 0;
   }

   LAB_001038b5:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar6;
   }

   LAB_00103a45:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */ulong cff_slot_load(long param_1, ulong *param_2, undefined8 *param_3, ulong param_4) {
   undefined8 *puVar1;
   ushort uVar2;
   short sVar3;
   int iVar4;
   ...
   if (( *(int*)( lVar5 + 0x74c ) == 0xffff ) || ( *(long*)( lVar5 + 0x528 ) == 0 )) {
      if (uVar22 < *(uint*)( lVar5 + 0x24 )) {
         LAB_00103b96:uVar23 = param_4 & 0xffffffff;
         if (( param_4 & 0x400 ) != 0) {
         ...
         *(undefined8*)( param_1 + 0x140 ) = uVar16;
         ...
         if (param_2 == (ulong*)0x0) {
            LAB_00103d70:if (( uVar23 & 0x4000 ) != 0) goto LAB_00103b59;
            if (( ( local_bb0 & 0x1100000 ) == 0x100000 ) && ( *(long*)( lVar18 + 0x5c8 ) != 0 )) {
               if (( param_2 != (ulong*)0x0 ) && ( ( uVar15 = 0x24 ),(short)param_2[3] == 0 || ( *(short*)( (long)param_2 + 0x1a ) == 0 ) )) goto LAB_00103b5e;
            ...
            *(char*)( param_1 + 0x130 ) = local_b95;
            ( *(code*)*puVar6 )(local_638, lVar18, param_2, param_1, uVar22, (int)local_bb0 >> 0x10 & 0xf, cff_get_glyph_data, cff_free_glyph_data);
            if (( uVar23 & 0x100 ) != 0) {
               local_19f = 1;
            }
            ...
            if ((int)uVar15 != 0) goto LAB_00103b5e;
            ...
            uVar15 = (ulong)uVar22;
            if (uVar22 != 0) goto LAB_00103b5e;
            if (*(long*)( *(long*)( lVar18 + 0xf0 ) + 0x68 ) == 0) {
               if (*(long*)( lVar5 + 0x568 ) != 0) {
                  *(long*)( param_1 + 0x100 ) = *(long*)( lVar5 + 0x570 ) + -1 + *(long*)( *(long*)( lVar5 + 0x568 ) + uVar21 * 8 );
            ...
            *(int*)( param_1 + 0xe8 ) = iVar14;
            lVar18 = param_1 + 200;
            if (( ( local_b68 != 0x10000 ) || ( lStack_b50 != 0x10000 ) ) || ( lStack_b60 != 0 || local_b58 != 0 )) {
               FT_Outline_Transform(lVar18, &local_b68);
               lVar17 = (long)*(int*)( param_1 + 0x50 ) * (long)(int)local_b68;
               *(long*)( param_1 + 0x50 ) = (long)(int)( ( ulong )(lVar17 + 0x8000 + ( lVar17 >> 0x3f )) >> 0x10 );
               lVar17 = (long)*(int*)( param_1 + 0x68 ) * (long)(int)lStack_b50;
               *(long*)( param_1 + 0x68 ) = (long)(int)( ( ulong )(lVar17 + 0x8000 + ( lVar17 >> 0x3f )) >> 0x10 );
            }
            ...
            if (( ( uVar23 & 1 ) == 0 ) || ( bVar11 )) {
               ...
               if (( ( local_b95 == '\0' ) || ( local_5b0 == 0 ) ) && ( sVar3= *(short *)(param_1 + 0xca),0 < sVar3 )) {
 ...
 while ( plVar20 != plVar7 + (ulong)(uint)(int)sVar3 * 2 );
            ...
            *(long*)( param_1 + 0x48 ) = lStack_b30;
            if (local_bb0 != 0) {
               ...
               *(long*)( param_1 + 0x60 ) = (long)(int)( ( ulong )(lVar18 + 0x8000 + ( lVar18 >> 0x3f )) >> 0x10 );
               uVar15 = 0;
               goto LAB_00103b5e;
            }
            ...
            *(ulong*)( param_1 + 0x140 ) = uVar15;
            plVar7 = param_3 + 0x6e;
            puVar1 = param_3 + 0x18;
            if (( ( ( param_2[0xb] == 0xffffffff ) || ( ( uVar23 & 8 ) != 0 ) ) || ( ( param_3[1] & 0x7fff0000 ) != 0 ) ) || ( ( *(byte*)( (long)param_3 + 0x11 ) & 0x80 ) != 0 )) goto LAB_00103d70;
            param_3 = &local_b48;
            param_4 = in_stack_fffffffffffff430;
            iVar14 = ( **(code**)( *plVar7 + 0x90 ) )(lVar18, param_2[0xb], uVar21, uVar23, *puVar1, param_1 + 0x98);
            if (iVar14 != 0) goto LAB_00103d70;
            *(undefined4*)( param_1 + 200 ) = 0;
 ...
 else if (( uVar22 == 0 ) || ( ( uVar22 <= *(uint*)( lVar5 + 0x530 ) && ( uVar2 = *(ushort*)( *(long*)( lVar5 + 0x528 ) + uVar21 * 2 ) ),uVar21 = (ulong)uVar2,uVar2 != 0 ) )) goto LAB_00103b96;
   LAB_00103b59:uVar15 = 6;
   LAB_00103b5e:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 cff_get_advances(long param_1, int param_2, int param_3, uint param_4, ulong *param_5) {
   ...
   if (( uVar4 & 8 ) == 0) {
      LAB_001047b0:if (param_3 != 0) {
         ...
         while (true) {
            uVar1 = param_4 | 0x103;
            if (( ( plVar7 != (long*)0x0 ) && ( uVar1 = param_4 | 0x100(param_4 & 1) == 0 ) ) && ( *plVar7 != *(long*)( lVar2 + 8 ) )) {
               uVar3 = 0x23;
               goto LAB_0010478a;
            }

            uVar3 = cff_slot_load(lVar2, plVar7, param_2, uVar1);
            if ((int)uVar3 != 0) goto LAB_0010478a;
...
;
      ...
      if (( param_4 & 0x10 ) == 0) {
         if (( ( uVar4 & 0x8000 ) != 0 || ( *(ulong*)( param_1 + 8 ) & 0x7fff0000 ) != 0 ) && ( uVar3 = 7(*(byte*)( param_1 + 0x4c8 ) & 2) == 0 )) goto LAB_0010478a;
 ...
 while ( iVar6 != param_3 + param_2 );
      ...
      if (( ( uVar4 & 0x8000 ) != 0 || ( *(ulong*)( param_1 + 8 ) & 0x7fff0000 ) != 0 ) && ( uVar3 = 7(*(byte*)( param_1 + 0x4c8 ) & 0x10) == 0 )) goto LAB_0010478a;
      if (*(char*)( param_1 + 0x1f0 ) == '\0') goto LAB_001047b0;
      if (param_3 != 0) {
         iVar5 = param_2;
         do {
            iVar6 = iVar5 + 1;
 ...
 while ( iVar6 != param_3 + param_2 );
   ...
   LAB_00104788:uVar3 = 0;
   LAB_0010478a:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
void *cff_index_get_name(long param_1, undefined8 param_2) {
   ...
   __dest = (void*)0x0;
   LAB_0010493e:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
ulong cff_index_init(long *param_1, long param_2, char param_3, char param_4) {
   ...
   if (param_4 == '\0') {
      ...
      if (local_48 == 0) {
         *(undefined4*)( param_1 + 2 ) = 5;
         if (uVar4 == 0) {
            LAB_00104a23:uVar7 = (ulong)local_48;
            goto LAB_00104a26;
         }

         LAB_00104a6d:bVar2 = FT_Stream_ReadByte(param_2, &local_48);
         if (local_48 == 0) {
            if (3 < ( byte )(bVar2 - 1)) goto LAB_00104ae0;
 ...
 while ( local_44 + ( ulong )(*(byte*)( param_1 + 3 ) - 1) + 1 != pbVar6 );
                     ...
                     if (uVar7 != 0) {
                        ...
                        local_48 = (uint)uVar7;
                        if (local_48 == 0) goto LAB_00104a26;
                        goto LAB_00104ac0;
                     }

                  }

                  LAB_00104ae0:local_48 = 8;
               }
   ...
   LAB_00104ac0:ft_mem_free(uVar1, param_1[6]);
   param_1[6] = 0;
   uVar7 = (ulong)local_48;
   LAB_00104a26:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
long cff_sid_to_glyph_name(long param_1, uint param_2) {
   ...
   if (uVar1 == 0xffff) {
      ...
      if (lVar3 != 0) {
         /* WARNING: Could not recover jumptable at 0x00104bb4. Too many branches */
         /* WARNING: Treating indirect jump as call */
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int cff_subfont_load(undefined8 *param_1, undefined8 *param_2, undefined4 param_3, undefined8 param_4, long param_5, int param_6, undefined8 *param_7, long param_8) {
   long lVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   int iVar4;
   ...
   if ((int)local_90 != 0) goto LAB_00104e30;
   local_60._8_4_ = ( -(uint)(uVar9 == 0) & 0x1a1 ) + 0x60;
   local_60._0_8_ = uVar6;
   param_1[0x28] = 0;
   puVar10 = (undefined8*)( ( ulong )(param_1 + 1) & 0xfffffffffffffff8 );
   for (uVar7 = ( ulong )(( (int)param_1 - (int)(undefined8*)( ( ulong )(param_1 + 1) & 0xfffffffffffffff8 ) ) + 0x148U >> 3); uVar6 = _LC18,uVar7 != 0; uVar7 = uVar7 - 1) {
      *puVar10 = 0;
   ...
   *(uint*)( param_1 + 0x28 ) = ( -(uint)(uVar9 == 0) & 0x1d1 ) + 0x30;
   if (iVar4 == 0) {
      ...
      if (( iVar4 != 0 ) || ( iVar4 = FT_Stream_ExtractFrame(param_4, param_2[5], &local_98) ),iVar4 != 0) goto LAB_00104e30;
      local_90 = param_2[5];
   }
 else {
   ...
   if (( ( iVar4 != 0 ) || ( *(int*)( (long)param_1 + 0xe4 ) != 0xffff ) ) || ( iVar4 = iVar4 != 0 )) goto LAB_00104e30;
   if (uVar9 != 0) {
 ...
 while ( iVar5 < 0 );
            LAB_00104f63:if (*(int*)( param_1 + 0x98 ) != 0) goto LAB_00104f7c;
         }
   ...
   LAB_00104f7c:if (( param_1[0x7f] != 0 ) && ( iVar4 = FT_Stream_Seek(param_4, param_5 + param_1[0x7f] + param_1[0x19]) ),iVar4 == 0) {
   ...
   LAB_00104e30:ft_mem_free(*local_88, local_70._8_8_);
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */uint cff_face_init(long param_1, ulong *param_2, uint param_3, undefined4 param_4, undefined8 param_5) {
   ...
   if (lVar21 != 0) {
      ...
      if (uVar24 != 0) {
         ...
         if (local_d4 == 0) {
            ...
            if (local_d4 == 0) {
               *(undefined1*)( param_2 + 0x97 ) = 1;
               ...
               uVar15 = local_d4;
               uVar17 = local_d4;
               if (( (char)local_d4 != -0x72 ) || ( local_d4 = ( *(code*)param_2[0x68] )(param_2, 0x43464620, param_1, 0) ),uVar15 = local_d4,uVar17 = local_d4,local_d4 != 0) goto LAB_00105276;
               bVar4 = true;
               bVar5 = false;
            }
            ...
            uVar15 = local_d4;
            uVar17 = local_d4;
            if (local_d4 != 0) goto LAB_00105276;
            bVar4 = false;
            bVar5 = false;
            local_e8 = 1;
         }
         ...
         *puVar26 = 0;
         ...
         for (uVar42 = ( ulong )(( iVar16 - (int)(undefined8*)( ( ulong )(puVar26 + 1) & 0xfffffffffffffff8 ) ) + 0x13c0U >> 3); uVar42 != 0; uVar42 = uVar42 - 1) {
            *puVar35 = 0;
         ...
         *puVar26 = uVar27;
         ...
         if (local_d0 == 0) {
            if (bVar5 == false) {
               ...
               if (local_d0 == 0) {
                  if (( ( *(char*)( puVar26 + 5 ) != '\x01' ) || ( *(byte*)( (long)puVar26 + 0x2a ) < 4 ) ) || ( 4 < bVar8 )) goto LAB_00105c80;
                  local_d0 = FT_Stream_Seek(param_1, ( ulong ) * (byte*)( (long)puVar26 + 0x2a ) + lVar21);
                  if (( local_d0 != 0 ) || ( local_d0 = local_d0 != 0 )) goto LAB_00105980;
                  if (( *(uint*)( (long)puVar26 + 0x4c ) < 2 ) || ( ( ulong ) * (uint*)( (long)puVar26 + 0x4c ) <= (ulong)puVar26[0xc] )) {
                     local_d0 = cff_index_init(puVar26 + 0xaf, param_1, 0, 0);
                     if (( ( ( local_d0 == 0 ) && ( local_d0 = cff_index_init(local_c8, param_1, 1, 0) ),local_d0 == 0 ) ) && ( local_d0 = local_d0 == 0 )) {
                        uVar15 = *(uint*)( (long)puVar26 + 0x4c );
                        if (uVar15 <= *(uint*)( (long)puVar26 + 0x58c )) goto LAB_00105513;
                        LAB_001061ec:local_d0 = 3;
                     }
            ...
            if (( *(char*)( puVar26 + 5 ) != '\x02' ) || ( *(byte*)( (long)puVar26 + 0x2a ) < 5 )) {
               LAB_00105c80:local_d0 = 2;
               goto LAB_00105998;
            }

            uVar9 = FT_Stream_ReadUShort(param_1, &local_d0);
            *(uint*)( (long)puVar26 + 0x2c ) = (uint)uVar9;
            if (local_d0 != 0) goto LAB_00105998;
            local_d0 = FT_Stream_Seek(param_1, ( ulong ) * (byte*)( (long)puVar26 + 0x2a ) + lVar21);
            if (local_d0 != 0) {
               LAB_00105980:if (local_e8 != 0) goto LAB_00105c80;
               goto LAB_00105998;
            }

            for (int i = 0; i < 4; i++) {
               *(undefined1(*) [16])( puVar26 + ( 2*i + 175 ) ) = (undefined1[16])0;
            }
            ...
            if (( local_d0 != 0 ) || ( local_d0 = local_d0 != 0 )) goto LAB_00105998;
            uVar15 = *(uint*)( (long)puVar26 + 0x4c );
            LAB_00105513:local_110 = puVar26 + 0x17;
            *(undefined4*)( puVar26 + 0xc9 ) = local_b8._4_4_;
            if (local_e8 == 0) {
               if (1 < uVar15) goto LAB_001061ec;
               local_108 = 0;
               LAB_00105550:if ((int)param_3 < 0) {
                  cff_index_done(local_c8);
                  local_d4 = local_d0;
                  uVar15 = local_d4;
                  uVar17 = local_d0;
                  if (local_d0 != 0) goto LAB_00105276;
                  goto LAB_00106322;
               }

               local_d0 = cff_subfont_load(puVar26 + 0xcd, puVar26 + 0xaf, local_108, param_1, lVar21, ( -(uint)(bVar5 == false) & 0xffffe000 ) + 0x3000, puVar26);
               if (( ( local_d0 != 0 ) || ( local_d0 = FT_Stream_Seek(param_1, puVar26[0xe5] + lVar21, param_2) ),local_d0 != 0 )) goto LAB_001058e1;
               if (( *(int*)( (long)puVar26 + 0x74c ) != 0xffff ) || ( bVar5 )) {
                  uVar27 = *(undefined8*)( param_1 + 0x38 );
                  local_88 = (ulong*)CONCAT44(local_88._4_4_, 3);
                  local_120 = 0;
                  if (puVar26[0xf4] == 0) goto LAB_00105659;
 ...
 while ( (uint)local_88 == 0 );
            ...
            local_d0 = 6;
            cff_index_done(local_c8);
            goto joined_r0x00106659;
         }

         LAB_00105998:cff_index_done(local_c8);
         local_d4 = local_d0;
         uVar15 = local_d4;
         uVar17 = local_d0;
         if (local_d0 != 0) goto LAB_00105276;
         if ((int)param_3 < 0) {
            LAB_00106322:*param_2 = ( ulong ) * (uint*)( puVar26 + 4 );
            uVar15 = local_d0;
            uVar17 = uVar14;
            goto LAB_00105276;
         }
...
;
   ...
   while (true) {
      ...
      LAB_0010658f:if (pcVar29[lVar21 + -1 + (long)iVar18] != pcVar30[lVar21 + -1 + (long)iVar16]) break;
   }
;
   if (iVar16 < iVar40) {
      LAB_001065a3:iVar16 = ( iVar18 - iVar16 ) + -1;
      if (iVar16 != 0) {
         lVar21 = (long)iVar16;
         do {
            if (( pcVar29[lVar21] != 0x20 ) && ( ( uVar15 = (byte)pcVar29[lVar21] - 0x2b ),0x34 < (byte)uVar15 || ( ( 0x10000000000005U >> ( (ulong)uVar15 & 0x3f ) & 1 ) == 0 ) )) {
 ...
 while ( (int)lVar21 != 0 );
   ...
   LAB_00105e87:param_2[6] = (ulong)pcVar30;
   ...
   if (( ( pcVar30 != (char*)0x0 ) && ( ( iVar16 = strcmp(pcVar30, "Bold") ),iVar16 == 0 || ( iVar16 = strcmp(pcVar30, "Black") ),iVar16 == 0 ) )) {
      uVar15 = uVar15 | 2;
   }
   ...
   if (iVar16 == 0xffff) {
      LAB_0010632e:if (bVar5 == false) {
         param_2[2] = param_2[2] | 0x200;
      }

      iVar16 = 0xffff;
      LAB_00106210:if (0 < (int)lVar21) goto LAB_00105f87;
   }
 else {
      param_2[2] = param_2[2] | 0x1000;
      uVar15 = local_d4;
      uVar17 = local_d4;
      if ((int)param_2[9] < 1) goto LAB_00105276;
      LAB_00105f87:lVar22 = 0;
      do {
         lVar28 = *(long*)( param_2[10] + lVar22 * 8 );
         if (( *(int*)( lVar28 + 0xc ) == 0x10003 ) || ( *(short*)( lVar28 + 0xc ) == 0 )) goto LAB_00105fb0;
         lVar22 = lVar22 + 1;
      }
 while ( (int)lVar22 < (int)lVar21 );
      if (( iVar16 != 0xffff ) && ( uVar15 = local_d4 ),uVar17 = local_d4,local_e8 != 0) goto LAB_00105276;
   }
   ...
   goto LAB_00105276;
   LAB_001074dc:*(undefined4*)( puVar26 + 0x273 ) = 0;
   ...
   if ((uint)local_88 == 0) {
      ...
      LAB_00105659:local_88 = (ulong*)( (ulong)local_88 & 0xffffffff00000000 );
   }

   LAB_00105662:ft_mem_free(uVar27, local_120);
   if ((uint)local_88 == 0) {
      local_d0 = 0;
      LAB_00105692:local_d0 = FT_Stream_Seek(param_1, lVar21 + puVar26[0xf1]);
      if (local_d0 == 0) {
         ...
         if (local_d0 == 0) {
            if (local_74 < 0x101) {
               *(uint*)( puVar26 + 0x166 ) = local_74;
               ...
               if (local_d0 == 0) {
                  for (puVar43 = (ulong*)0x0; (uint)puVar43 < local_74; puVar43 = (ulong*)( (long)puVar43 + 1 )) {
                  ...
                  do {
                     ...
                     if (local_74 <= (uint)uVar42) {
                        if (( bVar5 == false ) || ( 1 < local_74 )) {
                           ...
                           LAB_001058ae:local_d0 = local_cc;
                        }
 ...
 while ( local_d0 == 0 );
            ...
            if (local_d0 == 0) {
               LAB_0010666d:if (puVar26[0xe5] == 0) {
                  local_d0 = 3;
               }
 else {
                  *(undefined4*)( (long)puVar26 + 0x24 ) = *(undefined4*)( (long)puVar26 + 0x54c );
                  ...
                  if (local_d0 == 0) {
                     if (( bVar5 == false ) && ( uVar15 = uVar15 != 0 )) {
                        ...
                        if (uVar42 < 3) {
                           puVar26[0xa3] = uVar42;
                           if ((int)uVar42 == 1) {
                              if (0xa6 < uVar15) goto LAB_00106dee;
                                    ...
                                    if (( uVar17 & 4 ) == 0) {
                                       if (uVar17 != 0) {
                                          *(char*)puVar35 = (char)(undefined4)cff_expert_charset;
                                          joined_r0x001070bf:uVar17 = uVar15 * 2;
                                          if (( uVar17 & 2 ) != 0) {
                                             *(undefined2*)( (long)puVar35 + ( (ulong)uVar17 - 2 ) ) = *(undefined2*)( (long)puVar48 + ( (ulong)uVar17 - 2 ) );
                                          }
                                       ...
                                       *(undefined4*)( (long)puVar35 + ( (ulong)uVar17 - 4 ) ) = *(undefined4*)( &DAT_00107c1c + uVar17 );
                                    }

                                 }
 else {
                                    uVar45 = CONCAT44(cff_expert_charset._4_4_, (undefined4)cff_expert_charset);
                                    LAB_001069ea:uVar17 = uVar15 * 2;
                                    *puVar35 = uVar45;
                                    *(undefined8*)( (long)puVar35 + ( (ulong)uVar17 - 8 ) ) = *(undefined8*)( (long)puVar48 + ( (ulong)uVar17 - 8 ) );
                                    ...
                                    for (uVar42 = ( ulong )(uVar17 + (int)lVar28 >> 3); uVar42 != 0; uVar42 = uVar42 - 1) {
                                       *puVar35 = *puVar48;
                              ...
                              if (0x57 < uVar15) goto LAB_00106dee;
                              ...
                              if ((uint)local_88 == 0) {
                                 ...
                                 if (7 < uVar17) {
                                    uVar45 = CONCAT44(cff_isoadobe_charset._4_4_, (undefined4)cff_isoadobe_charset);
                                    goto LAB_001069ea;
                                 }
                                 ...
                                 if (( uVar17 & 4 ) == 0) {
                                    ...
                                    *(undefined4*)( (long)puVar35 + ( (ulong)uVar17 - 4 ) ) = *(undefined4*)( &DAT_00107d7c + uVar17 );
                                 }
                              ...
                              LAB_00106dee:local_88 = (ulong*)CONCAT44(local_88._4_4_, 3);
                           }

                           LAB_00106df9:ft_mem_free(uVar27, puVar26[0xa4]);
                           puVar26[0xa4] = 0;
                           ft_mem_free();
...
;
                              ...
                              if (1 < *(int*)( puVar26 + 0xa2 ) - 1U) goto LAB_00106dee;
                              uVar17 = 1;
...
;
                           ...
                           LAB_00106838:if (( iVar18 != 0xffff ) && ( local_e8 != 0 )) {
                        ...
                        if (*(int*)( (long)puVar26 + 0x74c ) == 0xffff) {
                           ...
                           local_88 = (ulong*)( (ulong)local_88 & 0xffffffff00000000 );
                           if (puVar26[0xa4] == 0) {
                              LAB_00106a28:local_88 = (ulong*)CONCAT44(local_88._4_4_, 3);
                           }
 else if (uVar42 < 2) {
                              if ((int)uVar42 == 1) {
                                 ...
                                 *(undefined8*)( (long)puVar26 + 0x304 ) = DAT_00107958;
                                 puVar35 = (undefined8*)( (long)&cff_expert_encoding - lVar21 );
                                 for (uVar44 = ( ulong )((int)lVar21 + 0x200U >> 3); uVar44 != 0; uVar44 = uVar44 - 1) {
                                    *puVar48 = *puVar35;
                                    puVar35 = puVar35 + (ulong)bVar7 * -2 + 1;
                                    puVar48 = puVar48 + (ulong)bVar7 * -2 + 1;
                                 }
                                 ...
                                 *(undefined8*)( (long)puVar26 + 0x10c ) = cff_standard_encoding;
                                 lVar21 = (long)puVar26 + ( 0x10c - (long)puVar48 );
                                 *(undefined8*)( (long)puVar26 + 0x304 ) = DAT_00107b58;
                              ...
                              *(undefined4*)( puVar26 + 0x21 ) = 0;
                              ...
                              if (iVar16 == 0) {
                                 ...
                                 do {
                                    ...
                                    if (( ( uVar15 == 0 ) || ( *(uint*)( puVar26 + 0xa6 ) < uVar15 ) ) || ( sVar50 = *(short*)( puVar26[0xa5] + (ulong)uVar15 * 2 ) ),sVar50 == 0) {
                                          ...
                                          *(uint*)( puVar26 + 0x21 ) = bVar7 + 1;
                                          ...
                                          for (uVar17 = 1; uVar17 <= bVar7; uVar17 = uVar17 + 1) {
                                             if (uVar17 < uVar15) {
                                                ...
                                                *(undefined2*)( (long)puVar26 + uVar42 * 2 + 0x10c ) = *(undefined2*)( lVar39 + ( lVar28 + 1 ) * 2 );
                                             }
                                          ...
                                          if (( *(uint*)( puVar26 + 0x1f ) & 0x7f ) != 1) goto LAB_00106a28;
                                          *(undefined4*)( puVar26 + 0x21 ) = 0;
                                          uVar14 = 1;
                                          for (uVar17 = 0; uVar17 < bVar7; uVar17 = uVar17 + 1) {
                                             bVar8 = FT_Stream_ReadByte(param_1, &local_88);
                                             if ((uint)local_88 != 0) goto LAB_00106a33;
                                             uVar41 = (uint)bVar8;
                                             bVar8 = FT_Stream_ReadByte(param_1, &local_88);
                                             if ((uint)local_88 != 0) goto LAB_00106a33;
                                             uVar20 = bVar8 + 1;
                                             ...
                                             for (; uVar14 < uVar20; uVar14 = uVar14 + 1) {
                                                if (( uVar14 < uVar15 ) && ( uVar41 < 0x100 )) {
                                                   lVar28 = puVar26[0xa4];
                                                   *(short*)( (long)puVar26 + (ulong)uVar41 * 2 + 0x30c ) = (short)uVar14;
                                                   *(undefined2*)( (long)puVar26 + (ulong)uVar41 * 2 + 0x10c ) = *(undefined2*)( lVar28 + lVar21 );
                                                }
                                       ...
                                       if (( *(byte*)( puVar26 + 0x1f ) & 0x80 ) != 0) {
                                          ...
                                          for (uVar17 = 0; uVar17 < bVar7; uVar17 = uVar17 + 1) {
                                             ...
                                             *(short*)( (long)puVar26 + (ulong)bVar8 * 2 + 0x10c ) = sVar50;
                                             ...
                                             do {
                                                lVar28 = lVar21;
                                                if (uVar15 <= (uint)lVar28) goto LAB_00106fc4;
                                                lVar21 = lVar28 + 1;
                                             }
 while ( sVar50 != *(short*)( puVar26[0xa4] + lVar28 * 2 ) );
                           ...
                           LAB_00106a33:local_d0 = (uint)local_88;
                           goto LAB_001058e1;
                        }

                     }

                     LAB_00106894:uVar27 = cff_index_get_name(puVar26, local_108);
                     puVar26[199] = uVar27;
                  }
      ...
      local_d0 = (uint)local_88;
      if ((uint)local_88 == 0) goto LAB_00105692;
   }

   LAB_001058e1:cff_index_done(local_c8);
   joined_r0x00106659:uVar15 = local_d0;
   uVar17 = local_d0;
   if (local_d0 != 0) goto LAB_00105276;
   LAB_001059cc:iVar16 = *(int*)( (long)puVar26 + 0x74c );
   ...
   if (( iVar16 != 0xffff ) || ( lVar22 != 0 )) {
      if (( ( *(byte*)( (long)param_2 + 0x11 ) & 1 ) != 0 ) && ( ( param_3 >> 0x10 != 0 && ( local_d4 = FT_Set_Named_Instance(param_2) ),uVar15 = local_d4,uVar17 = local_d4,local_d4 != 0 ) )) goto LAB_00105276;
 ...
 while ( plVar51 != puVar26 + 0x166 );
      ...
      if (local_e8 != 0) {
         ...
         *(int*)( (long)param_2 + 0x74 ) = auVar1._12_4_ >> 0x10;
         ...
         lVar28 = puVar26[0xe1] + _UNK_00108e48;
                  ...
                  while (pcVar31 = pcVar30,bVar7 = local_e8,pcVar30[6] == '+') {
                     do {
                        while (pcVar32 = pcVar31 + 1,0x19 < ( byte )(*pcVar31 + 0xbfU)) {
                           if (pcVar32 == pcVar29) goto LAB_001064a7;
                           pcVar31 = pcVar32;
                           bVar7 = 0;
                        }
;
...
;
                  LAB_001064a7:if (param_2[5] == 0) goto LAB_001064b5;
               }

               goto LAB_00105e01;
            }

            LAB_001064b5:lVar21 = cff_index_get_sid_string(puVar26, *(undefined4*)( puVar26 + 0xf3 ));
            if (lVar21 != 0) {
               uVar42 = ft_mem_strdup(uVar24, lVar21, &local_88);
               param_2[5] = uVar42;
            }
            ...
            LAB_00105e01:pcVar29 = (char*)cff_index_get_sid_string(puVar26, *(undefined4*)( (long)puVar26 + 0x674 ));
            ...
            if (( pcVar29 != (char*)0x0 ) && ( pcVar30 != (char*)0x0 )) {
               while (cVar6 = *pcVar29,cVar6 != '\0') {
                  ...
                  if (cVar2 == cVar6) {
                     ...
                     if (( cVar2 != ' ' ) && ( cVar2 != '-' )) {
                        if (( cVar2 == '\0' ) && ( pcVar30 = (char*)ft_mem_strdup(uVar24, pcVar29, &local_88) ),pcVar30 != (char*)0x0) {
                           pcVar29 = (char*)param_2[5];
                           sVar33 = strlen(pcVar29);
                           sVar34 = strlen(pcVar30);
                           iVar18 = (int)sVar33;
                           iVar16 = (int)sVar34;
                           if (iVar18 <= iVar16) goto LAB_00105e87;
                           if (iVar16 < 1) goto LAB_001065a3;
                           iVar40 = 1;
                           lVar21 = 0;
                           goto LAB_0010658f;
                        }
...
;
      ...
      lVar21 = (long)(int)param_2[9];
      if (iVar16 == 0xffff) goto LAB_0010632e;
      goto LAB_00106210;
   }

   LAB_00105270:uVar15 = local_d4;
   uVar17 = 0xb;
   LAB_00105276:local_d4 = uVar15;
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }

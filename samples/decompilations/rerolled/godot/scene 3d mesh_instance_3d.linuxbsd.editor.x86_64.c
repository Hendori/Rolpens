...
/* MeshInstance3D::_resolve_skeleton_path() */void MeshInstance3D::_resolve_skeleton_path(MeshInstance3D *this) {
   code *pcVar1;
   char cVar2;
   long *plVar3;
   undefined8 uVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* MeshInstance3D::bake_mesh_from_current_blend_shape_mix(Ref<ArrayMesh>) */Ref<ArrayMesh> *MeshInstance3D::bake_mesh_from_current_blend_shape_mix(Ref<ArrayMesh> *param_1, MeshInstance3D *param_2, long *param_3) {
   ...
   if (( pOVar6 != (Object*)0x0 ) && ( cVar14 = RefCounted::reference() ),cVar14 != '\0') {
      ...
      if (( local_240 != (Object*)0x0 ) && ( cVar14 = RefCounted::reference() ),cVar14 != '\0') {
         ...
         if (( cVar14 != '\0' ) && ( cVar14 = predelete_handler(pOVar6) ),cVar14 != '\0') goto LAB_00107179;

...
/* GLES3::LightStorage::reflection_probe_instance_needs_redraw(RID) */bool GLES3::LightStorage::reflection_probe_instance_needs_redraw(LightStorage *this, ulong param_2) {
   ...
   if (( param_2 != 0 ) && ( (uint)param_2 < *(uint*)( this + 0x184 ) )) {
      ...
      if (*(int*)( puVar1 + 0xc ) == (int)( param_2 >> 0x20 )) {
         ...
         if (( *(char*)( puVar1 + 3 ) == '\0' ) && ( iVar2 = ( **(code**)( *(long*)this + 0x220 ) )(this, *puVar1) ),iVar2 != 1) {
...
/* GLES3::LightStorage::reflection_probe_instance_free(RID) */undefined1[16];GLES3::LightStorage::reflection_probe_instance_free (LightStorage *this,ulong param_2) {
   long lVar1;
   int iVar2;
   uint uVar3;
   undefined8 uVar4;
...
/* GLES3::LightStorage::reflection_probe_get_size(RID) const */undefined1[16];GLES3::LightStorage::reflection_probe_get_size (LightStorage *this,ulong param_2) {
   long lVar1;
   long lVar2;
   long in_FS_OFFSET;
...
/* GLES3::LightStorage::reflection_probe_get_origin_offset(RID) const */undefined1[16];GLES3::LightStorage::reflection_probe_get_origin_offset (LightStorage *this,ulong param_2) {
   long lVar1;
   long lVar2;
   long in_FS_OFFSET;
   undefined1 auVar3[16];
...
/* GLES3::LightStorage::reflection_atlas_free(RID) */undefined1[16];GLES3::LightStorage::reflection_atlas_free (LightStorage *this,ulong param_2) {
   long *plVar1;
   long lVar2;
   Object *pOVar3;
   ulong uVar4;
...
/* GLES3::LightStorage::get_directional_shadow_rect() */undefined1[16];GLES3::LightStorage::get_directional_shadow_rect (LightStorage *this) {
   uint uVar1;
   int iVar2;
   int iVar3;
   int iVar4;
...
/* GLES3::LightStorage::light_get_color(RID) */undefined1[16];GLES3::LightStorage::light_get_color (LightStorage *this,ulong param_2) {
   int iVar1;
   long lVar2;
   if (( param_2 != 0 ) && ( (uint)param_2 < *(uint*)( this + 0x24 ) )) {
      lVar2 = ( ( param_2 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x20 ) ) * 0xe8 + *(long*)( *(long*)( this + 0x10 ) + ( ( param_2 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x20 ) ) * 8 );

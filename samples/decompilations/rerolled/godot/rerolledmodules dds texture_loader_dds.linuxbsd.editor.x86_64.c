...
/* ResourceFormatLoader::_initialize_classv() */void ResourceFormatLoader::_initialize_classv(void) {
   ...
   void ResourceFormatDDS::~ResourceFormatDDS(ResourceFormatDDS *this) {
   ...
   undefined8 *vformat<String,unsigned_int,unsigned_int>(undefined8 *param_1, bool *param_2, String *param_3, uint param_4, uint param_5) {
      Variant *pVVar1;
      int iVar2;
      Variant *pVVar3;
      int iVar4;
 ...
 while ( pVVar3 != local_a8 );
   ...
   void CowData<Ref<Image>>::_unref(CowData<Ref<Image>> *this) {
      long *plVar1;
      long lVar2;
      Image *pIVar3;
      code *pcVar4;
 ...
 while ( lVar2 != lVar7 );
   ...
   undefined8 CowData<Ref<Image>>::_realloc(CowData<Ref<Image>> *this, long param_1) {
      undefined8 *puVar1;
      puVar1 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), param_1 + 0x10, false);
      if (puVar1 != (undefined8*)0x0) {
         *puVar1 = 1;

/* std::_Function_handler<int (linalg::vec<double, 3>, linalg::vec<double, 4>, linalg::vec<double,
   ...
   linalg::vec<double, 4>&&, linalg::vec<double, 4>&&) */int std::_Function_handler<int(linalg::vec<double,3>, linalg::vec<double,4>, linalg::vec<double,4>),manifold::Manifold::Sphere(double,int)::{lambda(linalg::vec<double,3>,linalg::vec<double,4>,linalg::vec<double,4>)#1}>::_M_invoke(_Any_data *param_1, vec *param_2, vec *param_3, vec *param_4) {
...
/* std::_Rb_tree<int, std::pair<int const, manifold::Manifold::Impl::Relation>,
 ...
 while ( p_Var2 != (_Rb_tree_node_base*)0x0 );
   ...
   iVar5 = *(int*)( p_Var4 + 0x20 );
   LAB_00100048:p_Var3 = (_Rb_tree_node_base*)0x0;
   if (iVar5 < iVar6) {
      p_Var4 = p_Var3;
      p_Var3 = p_Var2;
   }
...
/* std::_Function_handler<int (linalg::vec<double, 3>, linalg::vec<double, 4>, linalg::vec<double,
   ...
   std::_Manager_operation) */undefined8 std::_Function_handler<int(linalg::vec<double,3>, linalg::vec<double,4>, linalg::vec<double,4>),manifold::Manifold::Sphere(double,int)::{lambda(linalg::vec<double,3>,linalg::vec<double,4>,linalg::vec<double,4>)#1}>::_M_manager(undefined8 *param_1, undefined4 *param_2, int param_3) {
   if (param_3 != 0) {
      if (param_3 == 1) {
         *param_1 = param_2;
      }
   ...
   *param_1 = &manifold::Manifold::Sphere;
   return 0;
}
/* std::_Rb_tree_iterator<std::pair<int const, manifold::Manifold::Impl::Relation> >
   ...
   std::piecewise_construct_t const&, std::tuple<int const&>&&, std::tuple<>&&) [clone .isra.0] */_Rb_tree_node_base * std::_Rb_tree<int,std::pair<int_const,manifold::Manifold::Impl::Relation>,std::_Select1st<std::pair<int_const,manifold::Manifold::Impl::Relation>>,std::less<int>,std::allocator<std::pair<int_const,manifold::Manifold::Impl::Relation>>>::_M_emplace_hint_unique<std::piecewise_construct_t_const&,std::tuple<int_const&>,std::tuple<>>(_Rb_tree<int,std::pair<int_const,manifold::Manifold::Impl::Relation>,std::_Select1st<std::pair<int_const,manifold::Manifold::Impl::Relation>>,std::less<int>,std::allocator<std::pair<int_const,manifold::Manifold::Impl::Relation>>> * param_1, _Rb_tree_node_base * param_2, undefined8 * param_3) * p_Var1 ;uint uVar2_Rb_tree_node_base *p_Var3_Rb_tree_node_base *p_Var4long lVar5bool bVar6byte bVar7undefined1 auVar8[16]bVar7 = 0;p_Var1 = (_Rb_tree_node_base*)( param_1 + 8 );p_Var3 = (_Rb_tree_node_base*)operator_new(0x98);uVar2 = *(uint*)*param_3;*(uint*)( p_Var3 + 0x20 ) = uVar2;p_Var4 = p_Var3 + 0x28;for (lVar5 = 0xe; lVar5 != 0; lVar5 = lVar5 + -1) {
   *(undefined8*)p_Var4 = 0;
   p_Var4 = p_Var4 + (ulong)bVar7 * -0x10 + 8;
}
*(undefined2*)( p_Var3 + 0x56 ) = 0x3ff0;*(undefined4*)( p_Var3 + 0x28 ) = 0xffffffff;*(undefined2*)( p_Var3 + 0x36 ) = 0x3ff0;*(undefined2*)( p_Var3 + 0x76 ) = 0x3ff0;if (p_Var1 == param_2) {
   if (( *(long*)( param_1 + 0x28 ) == 0 ) || ( p_Var4 = *(_Rb_tree_node_base**)( param_1 + 0x20 ) ),(int)uVar2 <= *(int*)( p_Var4 + 0x20 )) {
      LAB_001001e8:auVar8 = _M_get_insert_unique_pos(param_1, (int*)(ulong)uVar2);
      param_2 = auVar8._0_8_;
      bVar6 = param_2 != (_Rb_tree_node_base*)0x0;
      p_Var4 = auVar8._8_8_;
      if (auVar8._8_8_ == (_Rb_tree_node_base*)0x0) {
         LAB_00100201:operator_delete(p_Var3, 0x98);
         return param_2;
      }

   }
 else {
      LAB_0010022b:bVar6 = false;
   }

   joined_r0x001001bc:param_2 = p_Var4;
   p_Var4 = param_2;
   if (( p_Var1 == param_2 ) || ( bVar6 )) {
      LAB_001001c2:param_2 = p_Var4;
      bVar6 = true;
      goto LAB_001001c7;
   }
...
bVar6 = (int)uVar2 < *(int*)( param_2 + 0x20 );LAB_001001c7:std::_Rb_tree_insert_and_rebalance(bVar6, p_Var3, param_2, p_Var1);*(long*)( param_1 + 0x28 ) = *(long*)( param_1 + 0x28 ) + 1;return p_Var3;}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* manifold::Manifold::Tetrahedron() */Manifold * __thiscall manifold::Manifold::Tetrahedron(Manifold *this){
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* manifold::Manifold::Sphere(double, int) */Manifold * __thiscall manifold::Manifold::Sphere(Manifold *this,double param_1,int param_2){
   _Sp_counted_base<(__gnu_cxx::_Lock_policy)2> *p_Var1;
   Impl *pIVar2;
   _Sp_counted_base<(__gnu_cxx::_Lock_policy)2> *p_Var3;
   ...
   if (param_1 <= 0.0) {
      ...
      if (param_2 < 1) {
         ...
         if (Quality::circularSegments_ < 1) {
            dVar9 = fmin((double)(int)( ( ( param_1 + param_1 ) * __LC6 ) / Quality::circularEdgeLength_ ), (double)(int)( _LC12 / Quality::circularAngle_ ));
      ...
      *(undefined***)this_00 = &PTR___Sp_counted_ptr_inplace_0010c268;
      ...
      local_5c = 0;
      local_64 = 0;
      local_58 = std::_Function_handler<int(linalg::vec<double,3>, linalg::vec<double,4>, linalg::vec<double,4>),manifold::Manifold::Sphere(double,int)::{lambda(linalg::vec<double,3>, linalg::vec<double,4>, linalg::vec<double,4>)#1}>::_M_manager;
      uStack_50 = 0x100000;
      local_68 = iVar7 >> 2;
...
/* manifold::Manifold::Cube(linalg::vec<double, 3>, bool) */Manifold *manifold::Manifold::Cube(Manifold *param_1, char param_2) {
   _Sp_counted_base<(__gnu_cxx::_Lock_policy)2> *p_Var1;
   int iVar2;
   _Sp_counted_base<(__gnu_cxx::_Lock_policy)2> *p_Var3;
   long in_FS_OFFSET;
   ...
   long local_20;
   local_20 = *(long*)( in_FS_OFFSET + 0x28 );
   if (( ( ( in_stack_00000008 < 0.0 ) || ( in_stack_00000010 < 0.0 ) ) || ( in_stack_00000018 < 0.0 ) ) || ( SQRT(in_stack_00000008 * in_stack_00000008 + 0.0 + in_stack_00000010 * in_stack_00000010 + in_stack_00000018 * in_stack_00000018) == 0.0 )) {
      manifold::Manifold::Invalid();
   }
 else {
      if (param_2 == '\0') {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* manifold::Manifold::Extrude(std::vector<std::vector<linalg::vec<double, 2>,
   ...
   2>) */Manifold *manifold::Manifold::Extrude(double param_2, double param_4, double param_3, _Sp_counted_base<(__gnu_cxx::_Lock_policy)2> *param_4_00, Manifold *param_1, undefined1 (*param_6)[16], uint param_7) {
   Vec *pVVar1;
   double *pdVar2;
   int *piVar3;
   undefined8 uVar4;
   ...
   if (( *(long*)*param_6 == *(long*)( *param_6 + 8 ) ) || ( param_2 <= 0.0 )) {
      ...
      *(undefined1(*) [16])( p_Var16 + 0x128 ) = (undefined1[16])0x0;
      ...
      for (int i = 0; i < 4; i++) {
         *(undefined8*)( p_Var16 + ( 24*i + 312 ) ) = 0;
      }

      local_b8 = (undefined8*)0x0;
      local_88 = (undefined1(*) [16])0x0;
      for (int i = 0; i < 4; i++) {
         *(undefined1(*) [16])( p_Var16 + ( 24*i + 320 ) ) = (undefined1[16])0;
      }
      ...
      if (p_Var22 != local_1a8) {
         ...
         uVar35 = 0;
         local_1d0 = p_Var22;
         LAB_00100e08:puVar17 = *(undefined8**)( local_1d0 + 8 );
         ...
         if (puVar17 != puVar34) {
            ...
            do {
               ...
               local_48 = iVar15;
               if (puVar21 == puVar14) {
                  std::vector<manifold::PolyVert,std::allocator<manifold::PolyVert>>::_M_realloc_insert<manifold::PolyVert>((vector<manifold::PolyVert,std::allocator<manifold::PolyVert>>*)local_78, puVar21, &local_58);
               }
 else {
                  *puVar21 = local_58;
 ...
 while ( true );
         ...
         if ((undefined1(*) [16])local_98._8_8_ == local_88) {
            std::vector<std::vector<manifold::PolyVert,std::allocator<manifold::PolyVert>>,std::allocator<std::vector<manifold::PolyVert,std::allocator<manifold::PolyVert>>>>::_M_realloc_insert<std::vector<manifold::PolyVert,std::allocator<manifold::PolyVert>>const&>((vector<std::vector<manifold::PolyVert,std::allocator<manifold::PolyVert>>,std::allocator<std::vector<manifold::PolyVert,std::allocator<manifold::PolyVert>>>>*)local_98, local_98._8_8_, local_78);
            local_1d8 = local_1d0;
         }
 else {
      ...
      LAB_00102b75:param_7 = (uint)p_Var23;
      local_fc = 0;
      param_6 = pauVar28;
      p_Var16 = local_1d0;
      uVar35 = local_fc;
      LAB_001010e8:local_fc = uVar35;
      local_100 = param_7 + 1;
      local_c8 = p_Var16;
      if (local_100 < 1) {
         ...
         do {
            ...
            p_Var16 = (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)( local_f8 * (double)local_1b8 + ( _LC11 - (double)local_1b8 ) );
            local_1c8 = (undefined8*)( (double)local_f0 * (double)local_1b8 + ( _LC11 - (double)local_1b8 ) );
            local_1a8 = p_Var16;
            ...
            if (_LC3 < dVar41) {
               ...
               if (dVar40 <= _LC3) {
                  LAB_001020a9:if (dVar39 < 0.0) {
                     dVar41 = remquo((double)( (ulong)dVar39 ^ (ulong)local_178 ), _LC4, (int*)local_108);
                     iVar15 = (int)local_58 % 4;
                     if (iVar15 == 2) {
                        local_1d0 = (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)sin(( dVar41 * __LC6 ) / __LC7);
                     }
 else if (iVar15 == 3) {
                        local_1d0 = (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)cos(( dVar41 * __LC6 ) / __LC7);
                     }
 else if (( (ulong)local_58 & 3 ) == 0) {
                        dVar41 = sin(( dVar41 * __LC6 ) / __LC7);
                        local_1d0 = (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)( (ulong)dVar41 ^ (ulong)local_178 );
                     }
 else if (iVar15 == 1) {
                     ...
                     iVar15 = (int)local_58 % 4;
                     if (iVar15 == 2) {
                        param_4_00 = (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)sin(( dVar41 * __LC6 ) / __LC7);
                     }
 else if (iVar15 == 3) {
                        param_4_00 = (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)cos(( dVar41 * __LC6 ) / __LC7);
                     }
 else if (( (ulong)local_58 & 3 ) == 0) {
                        dVar41 = sin(( dVar41 * __LC6 ) / __LC7);
                        param_4_00 = (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)( (ulong)dVar41 ^ (ulong)local_178 );
                     }
 else {
                        param_4_00 = _LC0;
                        if (iVar15 == 1) {
                  ...
                  LAB_0010128b:dVar39 = remquo(dVar40, _LC4, (int*)local_108);
                  iVar15 = (int)local_58 % 4;
                  if (iVar15 == 2) {
                     dVar39 = sin(( dVar39 * __LC6 ) / __LC7);
                     local_1d0 = (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)( (ulong)dVar39 ^ (ulong)_LC0 );
                  }
 else if (iVar15 == 3) {
                     ...
                     local_1d0 = (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)sin(( dVar39 * __LC6 ) / __LC7);
                  }
 else if (iVar15 == 1) {
                     local_1d0 = (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)cos(( dVar39 * __LC6 ) / __LC7);
                  }
 else {
                  ...
                  if (iVar15 == 2) {
                     dVar39 = sin(( dVar39 * __LC6 ) / __LC7);
                     param_4_00 = (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)( (ulong)dVar39 ^ (ulong)_LC0 );
                  }
 else if (iVar15 == 3) {
                     dVar39 = cos(( dVar39 * __LC6 ) / __LC7);
                     param_4_00 = (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)( (ulong)dVar39 ^ (ulong)_LC0 );
                     ...
                     param_4_00 = (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)sin(( dVar39 * __LC6 ) / __LC7);
                  }
 else {
                     param_4_00 = (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)0x0;
                     if (iVar15 == 1) {
                        param_4_00 = (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)cos(( dVar39 * __LC6 ) / __LC7);
                     }

                  }

                  if ((double)local_1d8 < 0.0) {
                     LAB_001029db:uVar35 = (uint)pauVar28;
                     local_178 = _LC0;
                     goto LAB_001021ab;
                  }
               ...
               if (iVar15 == 2) {
                  dVar39 = sin(( dVar39 * __LC6 ) / __LC7);
                  local_188 = (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)( (ulong)dVar39 ^ (ulong)_LC0 );
               }
 else if (iVar15 == 3) {
                  dVar39 = cos(( dVar39 * __LC6 ) / __LC7);
                  local_188 = (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)( (ulong)dVar39 ^ (ulong)_LC0 );
                  ...
                  local_188 = (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)sin(( dVar39 * __LC6 ) / __LC7);
               }
 else if (iVar15 == 1) {
                  local_188 = (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)cos(( dVar39 * __LC6 ) / __LC7);
               }
 else {
               ...
               param_4_00 = (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)sin(dVar39);
               local_1d0 = param_4_00;
               LAB_001021ab:dVar41 = remquo((double)( (ulong)local_1d8 ^ (ulong)local_178 ), _LC4, (int*)local_108);
               iVar15 = (int)local_58 % 4;
               if (iVar15 == 2) {
                  LAB_0010261d:p_Var22 = (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)sin(( dVar41 * __LC6 ) / __LC7);
                  p_Var23 = (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)( (double)p_Var22 * 0.0 );
               }
 else {
                  if (iVar15 != 3) {
                     ...
                     p_Var22 = (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)( (ulong)local_178 ^ (ulong)dVar41 );
                     p_Var23 = (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)( (double)( (ulong)local_178 ^ (ulong)dVar41 ) * 0.0 );
                     goto LAB_00101420;
                  }

                  LAB_001013ee:p_Var22 = (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)cos(( dVar41 * __LC6 ) / __LC7);
                  p_Var23 = (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)( (double)p_Var22 * 0.0 );
               }
               ...
               if (iVar15 == 2) {
                  local_188 = (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)sin(( dVar39 * __LC6 ) / __LC7);
                  LAB_00101266:dVar40 = _LC4 + (double)local_1d8;
               ...
               LAB_0010138e:dVar41 = remquo(dVar41, _LC4, (int*)local_108);
               iVar15 = (int)local_58 % 4;
               if (iVar15 == 2) {
                  dVar41 = sin(( dVar41 * __LC6 ) / __LC7);
               }
               ...
               p_Var23 = (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)( (double)( (ulong)dVar41 ^ (ulong)_LC0 ) * 0.0 );
            }

            LAB_00101420:plVar31 = *(long**)*local_e0;
                     ...
                     do {
                        ...
                        if ((bool)( iVar32 == local_100 & bVar13 )) {
                           if (uStack_a8 <= local_b0) {
                              ...
                              if (local_b0 == 0) {
                                 LAB_00101773:if (local_b8 != (undefined8*)0x0) goto LAB_00101dbe;
                              }
 else {
                                 sVar30 = local_b0 * 0xc;
                                 if ((long)sVar30 < 0xd) {
                           ...
                           LAB_0010156f:puVar17 = (undefined8*)( (long)local_b8 + local_b0 * 0xc );
                           ...
                           *puVar17 = CONCAT44(iVar27 - local_fc, uVar5);
                           ...
                           dVar40 = dVar41 * ( (double)param_4_00 * (double)local_1a8 + (double)p_Var23 ) + dVar39 * ( (double)local_1d0 * 0.0 + (double)p_Var16 * (double)local_188 );
                           dVar41 = dVar41 * ( (double)p_Var22 * (double)puStack_1a0 + (double)param_4_00 * 0.0 ) + dVar39 * ( (double)local_1c8 * (double)local_1d0 + (double)local_188 * 0.0 );
                           if (uVar29 < uVar26) {
                              ...
                              *pdVar2 = dVar40;
                              ...
                              if (uVar26 == 0) {
                                 sVar30 = 0xc00;
                                 uVar38 = 0x80;
                                 LAB_00101abb:puVar17 = (undefined8*)malloc(sVar30);
                                 puVar34 = *(undefined8**)( local_c8 + 0x58 );
                                 if (uVar29 == 0) {
                                    LAB_00101b41:if (puVar34 != (undefined8*)0x0) goto LAB_00101e7c;
                                 }
 else {
                                    sVar30 = uVar29 * 0x18;
                                    if ((long)sVar30 < 0x19) {
                           ...
                           if (uStack_a8 <= local_b0) {
                              ...
                              uStack_a8 = uVar29;
                              if (local_b0 == 0) {
                                 LAB_00101827:if (local_b8 == (undefined8*)0x0) goto LAB_0010164f;
                              }
 else {
                                 sVar30 = local_b0 * 0xc;
                                 if ((long)sVar30 < 0xd) {
                           ...
                           *piVar3 = (int)uVar33 + iVar15;
                           ...
                           piVar3[2] = iVar36;
                           puVar17 = local_b8;
                           if (( uStack_a8 <= uVar29 ) && ( uVar26 = uStack_a8 < uVar26 )) {
            ...
            if (uVar26 < uVar33) {
               ...
               *(double*)pauVar28[1] = param_2;
               ...
               if (uVar33 == 0) {
                  sVar30 = 0xc00;
                  uVar38 = 0x80;
                  LAB_00102946:puVar17 = (undefined8*)malloc(sVar30);
                  puVar34 = *(undefined8**)( local_c8 + 0x58 );
                  if (uVar26 == 0) {
                     LAB_0010295b:if (puVar34 != (undefined8*)0x0) goto LAB_00102a15;
                  }
 else {
                     sVar30 = uVar26 * 0x18;
                     if ((long)sVar30 < 0x19) {
      ...
      if (puStack_50 != local_58) {
         ...
         LAB_00101a53:do {
            ...
            if (uStack_a8 <= local_b0) {
               ...
               uStack_a8 = uVar29;
               if (local_b0 == 0) {
                  LAB_001024ed:if (local_b8 == (undefined8*)0x0) goto LAB_00101a20;
               }
 else {
                  sVar30 = local_b0 * 0xc;
                  if ((long)sVar30 < 0xd) {
            ...
            *puVar21 = CONCAT44(uVar7, uVar6);
            ...
            if (uStack_a8 <= uVar29) {
               ...
               puVar21 = (undefined8*)malloc(sVar30);
               if (uVar29 == 0) {
                  LAB_001025b9:if (local_b8 != (undefined8*)0x0) goto LAB_00102910;
               }
 else {
                  sVar30 = uVar29 * 0xc;
                  if ((long)sVar30 < 0xd) {
            ...
            LAB_00102282:local_b0 = local_b0 + 2;
            puVar34 = (undefined8*)( (long)puVar34 + 0xc );
 ...
 while ( puVar17 != puVar34 );
      ...
      uVar4 = local_78._8_8_;
      if ((_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)local_78._8_8_ != (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)0x0) {
         ...
         if (*(long*)( local_78._8_8_ + 8 ) == 0x100000001) {
            *(undefined8*)( local_78._8_8_ + 8 ) = 0;
            ...
            if (iVar32 == 1) {
               std::_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>::_M_release_last_use_cold((_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)local_78._8_8_);
            }
 ...
 while ( (undefined8*)uVar4 != puVar17 );
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   LAB_00100f98:pauVar28 = (undefined1(*) [16])local_98._8_8_;
   ...
   if ((undefined1(*) [16])local_98._8_8_ == local_88) {
      ...
      *(_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>**)*(undefined1(*) [16])( (undefined8)pauVar28 + 1 ) = p_Var24;
 ...
 while ( (undefined8*)uVar4 != puVar18 );
         puVar17 = puVar17 + ( ( ( ulong )(uVar4 + ( -0x18 - uVar12 )) >> 3 ) * 0xaaaaaaaaaaaaaab & 0x1fffffffffffffff ) * 3 + 3;
      }
   ...
   LAB_001010c4:local_1d0 = local_1d0 + 0x18;
   if (local_1a8 == local_1d0) goto LAB_001010e8;
   goto LAB_00100e08;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* manifold::Manifold::Cylinder(double, double, double, int, bool) */Manifold * __thiscall
manifold::Manifold::Cylinder
   ...
   if (( param_1 <= 0.0 ) || ( param_2 <= 0.0 )) {
      manifold::Manifold::Invalid();
      LAB_00102e7a:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return this;
      }

      LAB_0010360b:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }
   ...
   if (( param_4 < 3 ) && ( pauVar9 = (undefined1(*) [16])(ulong)Quality::circularSegments_ ),(int)Quality::circularSegments_ < 1) {
      dVar11 = fmax(param_2, param_3);
      dVar5 = _LC12;
      dVar11 = fmin((double)(int)( ( ( dVar11 + dVar11 ) * __LC6 ) / Quality::circularEdgeLength_ ), (double)(int)( _LC12 / Quality::circularAngle_ ));
 ...
 while ( __src + (int)uVar7 != pauVar6 );
   ...
   do {
      ...
      if ((double)( (ulong)dVar11 & __LC2 ) <= _LC3) {
         ...
         local_c8 = local_c8 * param_2;
         LAB_001032cc:dVar11 = remquo((double)( (ulong)dVar13 ^ (ulong)local_a8 ), _LC4, (int*)local_58);
         iVar2 = (int)local_58._0_4_ % 4;
         if (iVar2 == 2) {
            LAB_00103340:dVar13 = sin(( dVar11 * __LC6 ) / __LC7);
         }
 else if (iVar2 == 3) {
            LAB_0010303f:dVar13 = cos(( dVar11 * __LC6 ) / __LC7);
         }
 else if (( local_58 & (undefined1[16])0x3 ) == (undefined1[16])0x0) {
            dVar11 = sin(( dVar11 * __LC6 ) / __LC7);
         ...
         dVar11 = (double)( (ulong)dVar13 & __LC2 );
         if (dVar11 <= _LC3) {
            joined_r0x001033a1:local_a8 = _LC0;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* manifold::Manifold::Revolve(std::vector<std::vector<linalg::vec<double, 2>,
   std::allocator<linalg::vec<double, 2> > >, std::allocator<std::vector<linalg::vec<double, 2>,
   std::allocator<linalg::vec<double, 2> > > > > const&, int, double) */Manifold * __thiscall
 ...
 while ( uVar30 < uVar27 );
         ...
         if (uVar30 != uVar27) {
            ...
            if (local_c8 == pauVar32) {
               std::vector<std::vector<linalg::vec<double,2>,std::allocator < linalg::vec<double,2>>>,std::allocator<std::vector<linalg::vec<double,2>,std::allocator<linalg::vec<double,2>>>> > ::_M_realloc_insert<std::vector<linalg::vec<double,2>,std::allocator<linalg::vec<double,2>>>>((vector<std::vector<linalg::vec<double,2>,std::allocator<linalg::vec<double,2>>>,std::allocator<std::vector<linalg::vec<double,2>,std::allocator<linalg::vec<double,2>>>>>*)&local_d8, pauVar32, local_58);
            ...
            do {
               ...
               if (0.0 <= dVar45) {
                  ...
                  if (pdVar12 == *(double**)( pauVar32[-1] + 8 )) {
                     std::vector<linalg::vec<double,2>,std::allocator<linalg::vec<double,2>>>::_M_realloc_insert<linalg::vec<double,2>const&>((vector<linalg::vec<double,2>,std::allocator<linalg::vec<double,2>>>*)( pauVar32[-2] + 8 ), pdVar12, pdVar20);
                     pdVar28 = (double*)*plVar37;
                     pdVar20 = pdVar28 + uVar27 * 2;
                     pauVar32 = pauStack_d0;
                  }
               ...
               if (dVar10 < 0.0 != dVar45 < 0.0) {
                  ...
                  if (puVar21 == *(undefined8**)( pauVar32[-1] + 8 )) {
                     std::vector<linalg::vec<double,2>,std::allocator<linalg::vec<double,2>>>::_M_realloc_insert<linalg::vec<double,2>>((vector<linalg::vec<double,2>,std::allocator<linalg::vec<double,2>>>*)( pauVar32[-2] + 8 ), puVar21, local_58);
                     pauVar32 = pauStack_d0;
                  }
 else {
                     *puVar21 = 0;
 ...
 while ( plVar8 != plVar37 );
      if (local_d8 != pauVar32) {
         ...
         if (param_2 < 3) {
            ...
            if (Quality::circularSegments_ < 1) {
               dVar40 = fmin((double)(int)( ( ( dVar40 + dVar40 ) * __LC6 ) / Quality::circularEdgeLength_ ), (double)(int)( _LC12 / Quality::circularAngle_ ));
         ...
         *(undefined1(*) [16])( this_00 + 0x140 ) = (undefined1[16])0x0;
         bVar13 = dVar45 == _LC12;
         for (int i = 0; i < 3; i++) {
            *(undefined1(*) [16])( this_00 + ( 24*i + 344 ) ) = (undefined1[16])0;
         }
         ...
         if (bVar13) {
            ...
            if (pauStack_d0 != local_d8) {
               LAB_001039b4:pauVar34 = local_d8;
               do {
...
;
 ...
 while ( pdVar20 != pdVar28 );
                     LAB_00103a24:uVar27 = 0;
                     do {
                        iVar36 = (int)*(undefined8*)( this_00 + 0x60 );
                        if (dVar45 != _LC12) {
                           local_58._0_4_ = iVar36;
                           if ((int*)local_98._8_8_ == local_88) {
                              std::vector<int,std::allocator<int>>::_M_realloc_insert<int>((vector<int,std::allocator<int>>*)local_98, local_98._8_8_, local_58);
                           }
 else {
                        ...
                        if (0 < iVar18) {
                           ...
                           do {
                              ...
                              if (dVar41 < 0.0) {
                                 ...
                                 local_188 = local_188 * dVar10;
                                 LAB_001043fb:dVar44 = remquo((double)( (ulong)dVar44 ^ (ulong)local_158 ), _LC4, (int*)local_58);
                                 iVar19 = (int)local_58._0_4_ % 4;
                                 if (iVar19 == 2) {
                                    LAB_00104640:dVar41 = sin(( dVar44 * __LC6 ) / __LC7);
                                 }
 else if (iVar19 == 3) {
                                    LAB_00103c4e:dVar41 = cos(( dVar44 * __LC6 ) / __LC7);
                                 }
 else if (( local_58 & (undefined1[16])0x3 ) == (undefined1[16])0x0) {
                                 ...
                                 joined_r0x00103bf9:local_158 = _LC0;
                              ...
                              LAB_00103c68:uVar30 = *(ulong*)( this_00 + 0x60 );
                              ...
                              if (uVar30 < uVar38) {
                                 ...
                                 *pdVar20 = local_188;
                                 ...
                                 if (uVar38 == 0) {
                                    sVar23 = 0xc00;
                                    uVar35 = 0x80;
                                    LAB_001045bb:puVar21 = (undefined8*)malloc(sVar23);
                                    puVar22 = *(undefined8**)( this_00 + 0x58 );
                                    if (uVar30 == 0) {
                                       LAB_001045fb:if (puVar22 != (undefined8*)0x0) goto LAB_001047e9;
                                    }
 else {
                                       sVar23 = uVar30 * 0x18;
                                       if ((long)sVar23 < 0x19) {
                              ...
                              if (dVar45 == _LC12) {
                                 ...
                                 uVar38 = uVar35;
                                 if (uVar30 == 0) {
                                    LAB_0010458d:if (puVar21 == (undefined8*)0x0) goto LAB_0010428b;
                                 }
 else {
                                    sVar23 = uVar30 * 0xc;
                                    if ((long)sVar23 < 0xd) {
                                 ...
                                 free(puVar21);
                                 uVar30 = local_b0._0_8_;
                                 LAB_0010428b:local_b0._8_8_ = uVar38;
                                 local_b8 = puVar22;
                              ...
                              while (dVar10 <= 0.0) {
                                 ...
                                 LAB_00103d03:if (0.0 < dVar4) {
                                    iVar33 = iVar36;
                                    if (dVar10 != 0.0) {
                                       iVar33 = iVar29 + iVar36;
                                    }

                                    LAB_00103d2d:puVar21 = local_b8;
                                    uVar30 = local_b0._0_8_;
                                    puVar22 = local_b8;
                                    uVar38 = local_b0._8_8_;
                                    if ((ulong)local_b0._8_8_ <= (ulong)local_b0._0_8_) {
                                       ...
                                       uVar38 = uVar35;
                                       if (uVar30 == 0) {
                                          LAB_001044e3:if (puVar21 == (undefined8*)0x0) goto LAB_00103d4e;
                                       }
 else {
                                          sVar23 = uVar30 * 0xc;
                                          if ((long)sVar23 < 0xd) {
                                    ...
                                    LAB_00103d4e:local_b0._8_8_ = uVar38;
                                    local_b8 = puVar22;
                                    local_b0._0_8_ = uVar30 + 1;
                                    puVar21 = (undefined8*)( (long)local_b8 + uVar30 * 0xc );
                                    *(int*)( puVar21 + 1 ) = iVar33;
...
;
 ...
 while ( true );
                        ...
                        LAB_00103d86:if (dVar45 != _LC12) {
                           LAB_00104870:local_58._0_4_ = *(int*)( this_00 + 0x60 ) + -1;
                           if ((int*)local_78._8_8_ == local_68) {
                              std::vector<int,std::allocator<int>>::_M_realloc_insert<int>((vector<int,std::allocator<int>>*)local_78, local_78._8_8_, local_58);
                           }
 else {
 ...
 while ( pauVar32 != pauVar34 );
            ...
            LAB_00104bae:local_e0 = (vector*)local_58;
            ...
            if (local_58._8_8_ != local_58._0_8_) {
               ...
               do {
                  ...
                  if ((ulong)local_b0._8_8_ <= (ulong)local_b0._0_8_) {
                     ...
                     uVar30 = uVar38;
                     if (uVar27 == 0) {
                        LAB_00104cbb:if (puVar21 == (undefined8*)0x0) goto LAB_00104c06;
                     }
 else {
                        sVar23 = uVar27 * 0xc;
                        if ((long)sVar23 < 0xd) {
                  ...
                  LAB_00104c06:local_b0._8_8_ = uVar30;
                  local_b8 = puVar22;
                  piVar39 = piVar39 + 3;
               ...
               if (local_58._8_8_ != local_58._0_8_) {
                  ...
                  do {
                     ...
                     if ((ulong)local_b0._8_8_ <= (ulong)local_b0._0_8_) {
                        ...
                        uVar30 = uVar38;
                        if (uVar27 == 0) {
                           LAB_00104dff:if (puVar21 == (undefined8*)0x0) goto LAB_00104d4e;
                        }
 else {
                           sVar23 = uVar27 * 0xc;
                           if ((long)sVar23 < 0xd) {
                     ...
                     LAB_00104d4e:local_b0._8_8_ = uVar30;
                     local_b8 = puVar22;
                     piVar39 = piVar39 + 3;
                     local_b0._0_8_ = uVar27 + 1;
                     puVar21 = (undefined8*)( (long)local_b8 + uVar27 * 0xc );
 ...
 while ( (int*)uVar43 != piVar39 );
         ...
         uVar43 = local_58._8_8_;
         if ((_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)local_58._8_8_ != (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)0x0) {
            ...
            if (*(long*)( local_58._8_8_ + 8 ) == 0x100000001) {
               *(undefined8*)( local_58._8_8_ + 8 ) = 0;
               ...
               if (iVar18 == 1) {
                  std::_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>::_M_release_last_use_cold((_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)local_58._8_8_);
               }
   ...
   pauVar32 = local_d8;
   pauVar34 = pauStack_d0;
   joined_r0x00103f5b:for (; pauVar17 = pauStack_d0,pauStack_d0 != pauVar32; pauVar32 = (undefined1(*) [16])( pauVar32[1] + 8 )) {
...
/* manifold::Manifold::Compose(std::vector<manifold::Manifold, std::allocator<manifold::Manifold> >
   const&) */Manifold * __thiscall manifold::Manifold::Compose(Manifold *this,vector *param_1){
   _Sp_counted_base<(__gnu_cxx::_Lock_policy)2> *p_Var1;
   ...
   joined_r0x00105005:if (puVar3 != puVar7) {
      do {
         ( *(code*)**(undefined8**)*puVar7 )(local_68);
         if ((undefined8*)local_58._8_8_ == local_48) {
            std::vector<std::shared_ptr<manifold::CsgLeafNode>,std::allocator<std::shared_ptr<manifold::CsgLeafNode>>>::_M_realloc_insert<std::shared_ptr<manifold::CsgLeafNode>>((vector<std::shared_ptr<manifold::CsgLeafNode>,std::allocator<std::shared_ptr<manifold::CsgLeafNode>>>*)local_58, local_58._8_8_, local_68);
         }
 else {
            *(undefined8*)( local_58._8_8_ + 8 ) = 0;
         ...
         if ((_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)local_68._8_8_ != (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)0x0) {
 ...
 while ( true );
   ...
   if ((_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)local_68._8_8_ != (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)0x0) {
      ...
      if (*(long*)( local_68._8_8_ + 8 ) == 0x100000001) {
         *(undefined8*)( local_68._8_8_ + 8 ) = 0;
         ...
         if (iVar5 == 1) {
            std::_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>::_M_release_last_use_cold((_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)local_68._8_8_);
         }
   ...
   do {
      while (p_Var1 = *(_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>**)( (long)pvVar6 + 8 ),p_Var1 != (_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)0x0) {
         p_Var2 = p_Var1 + 8;
...
;
 ...
 while ( (void*)uVar4 != pvVar6 );
   LAB_001051f0:LAB_001051f5:if ((void*)local_58._0_8_ != (void*)0x0) {
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   LAB_001050ae:std::_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>::_M_release_last_use_cold((_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>*)local_68._8_8_);
   puVar7 = puVar7 + 2;
   goto joined_r0x00105005;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* manifold::Manifold::Decompose() const */undefined1(*)[16];manifold::Manifold::Decompose(void) {
   _Sp_counted_base<(__gnu_cxx::_Lock_policy)2> *p_Var1;
   Impl *pIVar2;
   _Sp_counted_base<(__gnu_cxx::_Lock_policy)2> *p_Var3;
   undefined8 *puVar4;
   ...
   joined_r0x00105379:if (piVar24 != piVar23) {
      do {
         iVar17 = *piVar24;
         iVar18 = piVar24[1];
         if (iVar17 < iVar18) {
 ...
 while ( true );
   ...
   iVar17 = UnionFind<int,unsigned_char>::connectedComponents((UnionFind<int,unsigned_char>*)local_78, (vector*)local_f8);
   if (iVar17 == 1) {
   ...
   if (sVar27 == 0) {
      ...
      LAB_001054de:local_c8 = (Manifold*)0x0;
      local_d8 = (undefined1[16])0x0;
      uVar30 = (ulong)iVar18;
      iVar18 = 0;
      do {
         ...
         *(undefined8*)( this + 0x138 ) = 0;
         ...
         for (int i = 0; i < 3; i++) {
            *(undefined8*)( this + ( 24*i + 336 ) ) = 0;
         }

         local_b8 = (int*)0x0;
         uStack_a8 = 0;
         for (int i = 0; i < 5; i++) {
            *(undefined1(*) [16])( this + ( 24*i + 296 ) ) = (undefined1[16])0;
         }
 ...
 while ( uVar30 != uVar20 );
            ...
            if (uVar32 == 0) {
               ...
               *(undefined8*)( this + 0x60 ) = 0;
               local_b0 = 0;
               if (uVar30 != 0) {
                  LAB_001060af:if (piVar23 != (int*)0x0) goto LAB_00105bca;
                  goto LAB_00105bd2;
               }

               LAB_00106121:lVar26 = local_b0 * 4;
               LAB_00105bee:puVar25 = *(undefined8**)( this + 0x58 );
 ...
 while ( (undefined1(*) [16])( (long)pauVar21 + uVar32 * 0x18 ) != (undefined1(*) [16])( *pauVar8 + 8 ) );
               *(ulong*)( this + 0x60 ) = uVar32;
               if (uVar32 <= uStack_a8) {
                  ...
                  LAB_00105bca:free(piVar23);
                  LAB_00105bd2:uStack_a8 = local_b0;
                  lVar26 = local_b0 << 2;
                  piVar23 = piVar24;
                  local_b8 = piVar24;
                  goto LAB_00105bee;
               ...
               if (uVar16 == 0) {
                  ...
                  joined_r0x0010602d:if (uVar20 < uVar16) goto LAB_00105b94;
                  lVar26 = uVar32 * 4;
                  puVar25 = *(undefined8**)( this + 0x58 );
                  lVar29 = *(long*)( local_128 + 0x48 );
                  local_b0 = uVar32;
 ...
 while ( piVar23 != piVar24 );
         ...
         LAB_001056be:lVar26 = manifold::Manifold::NumTri();
         local_98 = (int*)0x0;
 ...
 while ( lVar26 != lVar19 );
         ...
         if (iVar31 == 0) {
            ...
            if ((ulong)local_90._8_8_ < uVar32) {
               ...
               LAB_00105915:if (( uVar20 < uVar32 ) && ( local_98 + uVar20 != local_98 + uVar32 )) {
            ...
            if ((Manifold*)local_d8._8_8_ == local_c8) {
               std::vector<manifold::Manifold,std::allocator<manifold::Manifold>>::_M_realloc_insert<manifold::Manifold>((vector<manifold::Manifold,std::allocator<manifold::Manifold>>*)local_d8, local_d8._8_8_, local_108);
            }
 else {
 ...
 while ( iVar17 != iVar18 );
   ...
   *(undefined8*)( *in_RDI + 8 ) = local_d8._8_8_;
   ...
   LAB_001057ec:if (__src != (undefined4*)0x0) {
   ...
   return in_RDI;
   code_r0x0010541e:if (*(byte*)( (long)local_60 + lVar29 ) <= *(byte*)( (long)local_60 + lVar26 )) {
      lVar26 = (long)iVar18;
      iVar18 = iVar17;
   }
...
/* manifold::Manifold::Smooth(manifold::MeshGLP<double, unsigned long> const&,
   std::vector<manifold::Smoothness, std::allocator<manifold::Smoothness> > const&) */MeshGLP *manifold::Manifold::Smooth(MeshGLP *param_1, vector *param_2) {
   Impl *this;
   _Sp_counted_base<(__gnu_cxx::_Lock_policy)2> *p_Var1;
   _Sp_counted_base<(__gnu_cxx::_Lock_policy)2> *p_Var2;
   _Sp_counted_base<(__gnu_cxx::_Lock_policy)2> *p_Var3;
...
/* std::_Sp_counted_ptr_inplace<manifold::Manifold::Impl, std::allocator<void>,
   (__gnu_cxx::_Lock_policy)2>::~_Sp_counted_ptr_inplace() */void std::_Sp_counted_ptr_inplace<manifold::Manifold::Impl,std::allocator<void>,(__gnu_cxx::_Lock_policy)2>::~_Sp_counted_ptr_inplace(_Sp_counted_ptr_inplace<manifold::Manifold::Impl,std::allocator<void>,(__gnu_cxx::_Lock_policy)2> *this) {
   return;
}
/* std::_Sp_counted_ptr_inplace<manifold::Manifold::Impl, std::allocator<void>,
   (__gnu_cxx::_Lock_policy)2>::~_Sp_counted_ptr_inplace() */void std::_Sp_counted_ptr_inplace<manifold::Manifold::Impl,std::allocator<void>,(__gnu_cxx::_Lock_policy)2>::~_Sp_counted_ptr_inplace(_Sp_counted_ptr_inplace<manifold::Manifold::Impl,std::allocator<void>,(__gnu_cxx::_Lock_policy)2> *this) {
...
/* std::_Sp_counted_ptr_inplace<manifold::Manifold::Impl, std::allocator<void>,
   (__gnu_cxx::_Lock_policy)2>::_M_destroy() */void std::_Sp_counted_ptr_inplace<manifold::Manifold::Impl,std::allocator<void>,(__gnu_cxx::_Lock_policy)2>::_M_destroy(_Sp_counted_ptr_inplace<manifold::Manifold::Impl,std::allocator<void>,(__gnu_cxx::_Lock_policy)2> *this) {
   operator_delete(this, 0x198);
   return;
}
/* std::_Sp_counted_ptr_inplace<manifold::Manifold::Impl, std::allocator<void>,
   (__gnu_cxx::_Lock_policy)2>::_M_get_deleter(std::type_info const&) */_Sp_counted_ptr_inplace<manifold::Manifold::Impl,std::allocator<void>,(__gnu_cxx::_Lock_policy)2> * __thiscallstd::_Sp_counted_ptr_inplace<manifold::Manifold::Impl,std::allocator<void>,(__gnu_cxx::_Lock_policy)2>::_M_get_deleter(_Sp_counted_ptr_inplace<manifold::Manifold::Impl,std::allocator<void>,(__gnu_cxx::_Lock_policy)2> * this, type_info * param_1) * __s1 ;int iVar1_Sp_counted_ptr_inplace<manifold::Manifold::Impl,std::allocator<void>,(__gnu_cxx::_Lock_policy)2> *p_Var2p_Var2 = this + 0x10;if (( param_1 != (type_info*)::__tag ) && ( __s1 = *(char**)( param_1 + 8 ) ),__s1 != "St19_Sp_make_shared_tag") {
   if (*__s1 == '*') {
      return (_Sp_counted_ptr_inplace<manifold::Manifold::Impl,std::allocator<void>,(__gnu_cxx::_Lock_policy)2>*)0x0;
   }

   iVar1 = strcmp(__s1, "St19_Sp_make_shared_tag");
   if (iVar1 != 0) {
      p_Var2 = (_Sp_counted_ptr_inplace<manifold::Manifold::Impl,std::allocator<void>,(__gnu_cxx::_Lock_policy)2>*)0x0;
   }

}
return p_Var2;}/* std::_Rb_tree<int, std::pair<int const, manifold::Manifold::Impl::Relation>,
   std::_Select1st<std::pair<int const, manifold::Manifold::Impl::Relation> >, std::less<int>,
   std::allocator<std::pair<int const, manifold::Manifold::Impl::Relation> >
...
/* std::_Sp_counted_ptr_inplace<manifold::Manifold::Impl, std::allocator<void>,
   (__gnu_cxx::_Lock_policy)2>::_M_dispose() */void std::_Sp_counted_ptr_inplace<manifold::Manifold::Impl,std::allocator<void>,(__gnu_cxx::_Lock_policy)2>::_M_dispose(_Sp_counted_ptr_inplace<manifold::Manifold::Impl,std::allocator<void>,(__gnu_cxx::_Lock_policy)2> *this) {
   void *pvVar1;
   void *pvVar2;
   ...
   while (pvVar2 != (void*)0x0) {
      _Rb_tree<int,std::pair<int_const,manifold::Manifold::Impl::Relation>,std::_Select1st<std::pair<int_const,manifold::Manifold::Impl::Relation>>,std::less<int>,std::allocator<std::pair<int_const,manifold::Manifold::Impl::Relation>>>::_M_erase(*(_Rb_tree_node**)( (long)pvVar2 + 0x18 ));
      pvVar1 = *(void**)( (long)pvVar2 + 0x10 );
      operator_delete(pvVar2, 0x98);
      pvVar2 = pvVar1;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* manifold::sind(double) */double manifold::sind(double param_1) {
   int iVar1;
   long in_FS_OFFSET;
   double dVar2;
   double dVar3;
   ...
   if (param_1 < 0.0) {
      ...
      if (iVar1 == 2) {
         LAB_00106a30:if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
            param_1 = ( dVar2 * __LC6 ) / __LC7;
            LAB_00106a20:dVar2 = sin(param_1);
            return dVar2;
         }
      ...
      if (iVar1 == 3) {
         LAB_0010695e:if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
      ...
      LAB_00106a58:dVar2 = sin(( dVar2 * __LC6 ) / __LC7);
      ...
      if (iVar1 == 3) {
         LAB_001069d5:dVar2 = cos(( dVar2 * __LC6 ) / __LC7);
         dVar3 = (double)( (ulong)dVar2 ^ (ulong)_LC0 );
      }
 else {
   ...
   LAB_001069f2:if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return dVar3;
   }

   LAB_00106a9d:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* manifold::UnionFind<int, unsigned char>::UnionFind(int) */void manifold::UnionFind<int,unsigned_char>::UnionFind(UnionFind<int,unsigned_char> *this, int param_1) {
   long lVar1;
   size_t __size;
   undefined4 *puVar2;
   void *pvVar3;
...
/* void std::vector<unsigned long, std::allocator<unsigned long> >::_M_realloc_insert<unsigned long
   ...
   std::allocator<unsigned long> > >, unsigned long const&) */void std::vector<unsigned_long,std::allocator<unsigned_long>>::_M_realloc_insert<unsigned_long_const&>(vector<unsigned_long,std::allocator<unsigned_long>> *this, void *param_2, undefined8 *param_3) {
   void *__dest;
   void *pvVar1;
   void *__src;
   ulong uVar2;
   ...
   if (__src == pvVar1) {
      ...
      uVar3 = uVar3 << 3;
      LAB_00106cba:__dest_00 = operator_new(uVar3);
      lVar4 = uVar3 + (long)__dest_00;
   }
 else {
      uVar3 = uVar2 * 2;
      if (uVar3 < uVar2) {
         LAB_00106cb0:uVar3 = 0x7ffffffffffffff8;
         goto LAB_00106cba;
      }
   ...
   *(undefined8*)( (long)__dest_00 + __n ) = *param_3;
   ...
   LAB_00106c8c:*(void**)this = __dest_00;
...
/* void std::vector<std::vector<manifold::PolyVert, std::allocator<manifold::PolyVert> >,
   ...
   std::allocator<manifold::PolyVert> > const&) */void std::vector<std::vector<manifold::PolyVert,std::allocator<manifold::PolyVert>>,std::allocator<std::vector<manifold::PolyVert,std::allocator<manifold::PolyVert>>>>::_M_realloc_insert<std::vector<manifold::PolyVert,std::allocator<manifold::PolyVert>>const&>(vector<std::vector<manifold::PolyVert,std::allocator<manifold::PolyVert>>,std::allocator<std::vector<manifold::PolyVert,std::allocator<manifold::PolyVert>>>> *this, undefined8 *param_2, long *param_3) {
   undefined8 *puVar1;
   undefined8 *puVar2;
   undefined8 uVar3;
   undefined8 uVar4;
   ...
   uVar15 = 0x555555555555555;
   LAB_00106f75:while (true) {
      puVar11 = (undefined8*)operator_new(uVar6);
      LAB_00106def:puVar10 = (undefined8*)param_3[1];
      ...
      *pauVar14 = (undefined1[16])0x0;
      ...
      if (uVar6 < 0x7ffffffffffffff9) {
         ...
         puVar13 = (undefined8*)*param_3;
         LAB_00106e54:*(undefined8**)*pauVar14 = puVar7;
 ...
 while ( puVar10 != puVar9 );
            puVar7 = (undefined8*)( (long)puVar7 + ( (long)puVar10 + ( -0x18 - (long)puVar13 ) & 0xfffffffffffffff8U ) + 0x18 );
         }
 ...
 while ( puVar1 != puVar8 );
            puVar10 = (undefined8*)( (long)puVar13 + ( (long)puVar1 + ( -0x18 - (long)param_2 ) & 0xfffffffffffffff8U ) + 0x30 );
         }
      ...
      LAB_00106fe5:if (0x555555555555555 < uVar15) {
         uVar15 = 0x555555555555555;
      }
...
/* void std::vector<linalg::vec<double, 2>, std::allocator<linalg::vec<double, 2> >
   ...
   std::allocator<linalg::vec<double, 2> > > >, linalg::vec<double, 2> const&) */void std::vector<linalg::vec<double,2>,std::allocator<linalg::vec<double,2>>>::_M_realloc_insert<linalg::vec<double,2>const&>(vector<linalg::vec<double,2>,std::allocator<linalg::vec<double,2>>> *this, undefined8 *param_2, undefined8 *param_3) {
   undefined8 *puVar1;
   undefined8 *puVar2;
   undefined8 uVar3;
   undefined8 uVar4;
   ...
   if (puVar2 == puVar1) {
      ...
      uVar7 = uVar7 << 4;
      LAB_00107122:puVar6 = (undefined8*)operator_new(uVar7);
      uVar3 = param_3[1];
 ...
 while ( puVar10 + 2 != (undefined8*)( ( (long)param_2 - (long)puVar2 ) + (long)puVar6 ) );
      ...
      uVar7 = uVar5 * 2;
      if (uVar7 < uVar5) {
         LAB_00107118:uVar7 = 0x7ffffffffffffff0;
         goto LAB_00107122;
      }
   ...
   LAB_001070dc:if (puVar2 != (undefined8*)0x0) {
      operator_delete(puVar2, *(long*)( this + 0x10 ) - (long)puVar2);
   }
...
/* void std::vector<manifold::PolyVert, std::allocator<manifold::PolyVert>
   ...
   std::vector<manifold::PolyVert, std::allocator<manifold::PolyVert> > >, manifold::PolyVert&&) */void std::vector<manifold::PolyVert,std::allocator<manifold::PolyVert>>::_M_realloc_insert<manifold::PolyVert>(vector<manifold::PolyVert,std::allocator<manifold::PolyVert>> *this, undefined8 *param_2, undefined8 *param_3) {
   size_t __n;
   undefined8 *puVar1;
   undefined8 *puVar2;
   undefined8 uVar3;
   ...
   if (puVar2 == puVar1) {
      ...
      uVar9 = uVar9 * 0x18;
      LAB_001072da:puVar7 = (undefined8*)operator_new(uVar9);
 ...
 while ( puVar10 != param_2 );
      ...
      if (uVar9 < uVar6) {
         LAB_001072d0:uVar9 = 0x7ffffffffffffff8;
         goto LAB_001072da;
      }
   ...
   LAB_00107296:if (puVar2 != (undefined8*)0x0) {
      operator_delete(puVar2, *(long*)( this + 0x10 ) - (long)puVar2);
   }
...
/* void std::vector<std::vector<linalg::vec<double, 2>, std::allocator<linalg::vec<double, 2> > >,
   ...
   std::allocator<linalg::vec<double, 2> > >&&) */void std::vector<std::vector<linalg::vec<double,2>,std::allocator<linalg::vec<double,2>>>,std::allocator<std::vector<linalg::vec<double,2>,std::allocator<linalg::vec<double,2>>>>>::_M_realloc_insert<std::vector<linalg::vec<double,2>,std::allocator<linalg::vec<double,2>>>>(vector<std::vector<linalg::vec<double,2>,std::allocator<linalg::vec<double,2>>>,std::allocator<std::vector<linalg::vec<double,2>,std::allocator<linalg::vec<double,2>>>>> *this, undefined8 *param_2, undefined1 (*param_3)[16]) {
   undefined8 *puVar1;
   undefined8 *puVar2;
   undefined8 uVar3;
   undefined8 uVar4;
   ...
   if (puVar2 == puVar1) {
      ...
      if (uVar12 < uVar7) {
         LAB_001074e0:uVar12 = 0x7ffffffffffffff8;
      }
 else {
         if (uVar12 == 0) {
   ...
   puVar13 = puVar10 + 3;
   LAB_001073fb:puVar8 = (undefined8*)( (long)puVar10 + ( (long)param_2 - (long)puVar2 ) );
 ...
 while ( param_2 != puVar13 );
      puVar13 = (undefined8*)( (long)puVar10 + ( (long)param_2 + ( -0x18 - (long)puVar2 ) & 0xfffffffffffffff8U ) + 0x30 );
   }
 ...
 while ( puVar1 != puVar9 );
      puVar13 = (undefined8*)( (long)puVar13 + ( (long)puVar1 + ( -0x18 - (long)param_2 ) & 0xfffffffffffffff8U ) + 0x18 );
   }
...
/* void std::vector<linalg::vec<double, 2>, std::allocator<linalg::vec<double, 2> >
   ...
   linalg::vec<double, 2>&&) */void std::vector<linalg::vec<double,2>,std::allocator<linalg::vec<double,2>>>::_M_realloc_insert<linalg::vec<double,2>>(vector<linalg::vec<double,2>,std::allocator<linalg::vec<double,2>>> *this, undefined8 *param_2, undefined8 *param_3) {
   undefined8 *puVar1;
   undefined8 *puVar2;
   undefined8 uVar3;
   undefined8 uVar4;
   ...
   if (puVar2 == puVar1) {
      ...
      uVar7 = uVar7 << 4;
      LAB_00107672:puVar6 = (undefined8*)operator_new(uVar7);
      uVar3 = param_3[1];
      lVar11 = uVar7 + (long)puVar6;
      puVar10 = puVar6 + 2;
      *(undefined8*)( (long)puVar6 + (long)puVar8 ) = *param_3;
 ...
 while ( puVar10 + 2 != (undefined8*)( ( (long)param_2 - (long)puVar2 ) + (long)puVar6 ) );
      ...
      uVar7 = uVar5 * 2;
      if (uVar7 < uVar5) {
         LAB_00107668:uVar7 = 0x7ffffffffffffff0;
         goto LAB_00107672;
      }
   ...
   puVar8 = (undefined8*)( (long)puVar10 + ( (long)puVar1 - (long)param_2 ) );
   memcpy(puVar10, param_2, (long)puVar1 - (long)param_2);
   LAB_0010762c:if (puVar2 != (undefined8*)0x0) {
      operator_delete(puVar2, *(long*)( this + 0x10 ) - (long)puVar2);
   }
...
/* void std::vector<int, std::allocator<int>
   ...
   > >, int&&) */void std::vector<int,std::allocator<int>>::_M_realloc_insert<int>(vector<int,std::allocator<int>> *this, void *param_2, undefined4 *param_3) {
   void *__dest;
   void *pvVar1;
   void *__src;
   ulong uVar2;
   ...
   if (__src == pvVar1) {
      ...
      uVar3 = uVar3 << 2;
      LAB_001077ba:__dest_00 = operator_new(uVar3);
      lVar4 = uVar3 + (long)__dest_00;
   }
 else {
      uVar3 = uVar2 * 2;
      if (uVar3 < uVar2) {
         LAB_001077b0:uVar3 = 0x7ffffffffffffffc;
         goto LAB_001077ba;
      }
   ...
   *(undefined4*)( (long)__dest_00 + __n ) = *param_3;
   ...
   operator_delete(__src, *(long*)( this + 0x10 ) - (long)__src);
   LAB_0010778b:*(void**)this = __dest_00;
   *(size_t*)( this + 8 ) = (long)__dest + __n_00;
   *(long*)( this + 0x10 ) = lVar4;
   return;
}
/* void std::vector<std::shared_ptr<manifold::CsgLeafNode>,
   ...
   std::allocator<std::shared_ptr<manifold::CsgLeafNode> > > >,
   std::shared_ptr<manifold::CsgLeafNode>&&) */void std::vector<std::shared_ptr<manifold::CsgLeafNode>,std::allocator<std::shared_ptr<manifold::CsgLeafNode>>>::_M_realloc_insert<std::shared_ptr<manifold::CsgLeafNode>>(vector<std::shared_ptr<manifold::CsgLeafNode>,std::allocator<std::shared_ptr<manifold::CsgLeafNode>>> *this, void *param_2, undefined1 (*param_3)[16]) {
   undefined8 *puVar1;
   void *pvVar2;
   void *pvVar3;
   undefined8 uVar4;
   ...
   if (pvVar3 == pvVar2) {
      ...
      uVar9 = uVar9 << 4;
      LAB_001079c2:pvVar7 = operator_new(uVar9);
      ...
      uVar9 = uVar5 * 2;
      if (uVar9 < uVar5) {
         LAB_001079b8:uVar9 = 0x7ffffffffffffff0;
         goto LAB_001079c2;
      }
   ...
   *puVar1 = *(undefined8*)*param_3;
   ...
   if (param_2 == pvVar3) {
      ...
      LAB_0010797c:if (pvVar3 == (void*)0x0) goto LAB_00107998;
   }
 else {
      lVar8 = 0;
      uVar5 = 0;
...
/* std::vector<int, std::allocator<int> >::_M_default_append(unsigned long) */void std::vector<int,std::allocator<int>>::_M_default_append(vector<int,std::allocator<int>> *this, ulong param_1) {
   ...
   if (uVar2 < param_1) {
      ...
      *puVar6 = 0;
      ...
      LAB_00107b28:if (sVar4 != 0) goto LAB_00107bf8;
      ...
      *puVar6 = 0;
      if (param_1 != 1) {
         LAB_00107b14:memset(puVar6 + 1, 0, ( param_1 - 1 ) * 4);
         goto LAB_00107b28;
      }

      LAB_00107bf8:memmove(__dest, pvVar3, sVar4);
      uVar5 = *(long*)( this + 0x10 ) - (long)pvVar3;
   }

   operator_delete(pvVar3, uVar5);
   LAB_00107b3a:*(void**)this = __dest;
      ...
      if (uVar16 == 0) {
         ...
         if (puVar13 != (undefined8*)0x0) {
            ...
            while (iVar14 != iVar8) {
               ...
               if (( puVar4 == (undefined8*)0x0 ) || ( iVar8 = *(int*)( puVar4 + 1 ) ),puVar13 = puVar6,puVar6 = puVar4,uVar18 % local_70 != (ulong)(long)iVar8 % local_70) goto LAB_00107e90;
            }
;
      ...
      LAB_00107e90:iVar8 = iVar17 + (int)uVar16;
      ...
      *(int*)( (long)plVar11 + 0xc ) = iVar8;
      ...
      if (local_60 == 0) {
         ...
         if (plVar10 != (long*)0x0) {
            ...
            while (iVar2 != iVar14) {
               plVar5 = (long*)*plVar12;
               if (( plVar5 == (long*)0x0 ) || ( iVar2 = (int)plVar5[1] ),plVar10 = plVar12,plVar12 = plVar5,uVar18 % local_70 != (ulong)(long)iVar2 % local_70) goto LAB_00107fb6;
            }
;
      ...
      LAB_00107fb6:cVar7 = std::__detail::_Prime_rehash_policy::_M_need_rehash((ulong)local_58, local_70, local_60);
      if (cVar7 == '\0') {
         plVar10 = local_78 + uVar18 % local_70;
         plVar12 = (long*)*plVar10;
         if (plVar12 != (long*)0x0) goto LAB_00108005;
         LAB_00108154:*plVar11 = (long)local_68;
...
;
         LAB_001080f0:if (local_78 != &local_48) {
   ...
   __n = 8;
   iVar17 = 0;
   LAB_00107dd7:memset(local_78, 0, __n);
   local_60 = 0;
   local_68 = (long*)0x0;
   ...
   LAB_001081f5:/* WARNING: Subroutine does not return */__stack_chk_fail();
   LAB_00107d81:uVar9 = uVar9 + 1;
   *(undefined4*)( *(long*)param_1 + lVar1 ) = *(undefined4*)( (long)plVar10 + 0xc );
   if (*(ulong*)( this + 8 ) <= uVar9) goto LAB_00107d99;
   goto LAB_00107d0d;
   LAB_00107f43:operator_delete(plVar11, 0x10);
   LAB_00107f5f:*(int*)( *(long*)param_1 + lVar1 ) = iVar8;
   uVar16 = local_60;
   LAB_00107cff:uVar9 = uVar9 + 1;
   if (*(ulong*)( this + 8 ) <= uVar9) goto LAB_00107d99;
   goto LAB_00107d0d;
   LAB_00107d99:iVar17 = iVar17 + (int)uVar16;
   plVar10 = local_68;
...
/* void std::vector<manifold::Manifold, std::allocator<manifold::Manifold>
   ...
   std::vector<manifold::Manifold, std::allocator<manifold::Manifold> > >, manifold::Manifold&&) */void std::vector<manifold::Manifold,std::allocator<manifold::Manifold>>::_M_realloc_insert<manifold::Manifold>(vector<manifold::Manifold,std::allocator<manifold::Manifold>> *this, Manifold *param_2, Manifold *param_3) {
   Manifold *pMVar1;
   Manifold *pMVar2;
   Manifold *pMVar3;
   ulong uVar4;
   ...
   if (pMVar2 == pMVar1) {
      ...
      uVar5 = uVar5 << 4;
      LAB_00108342:local_58 = (Manifold*)operator_new(uVar5);
 ...
 while ( param_2 != pMVar7 );
      ...
      uVar5 = uVar4 * 2;
      if (uVar5 < uVar4) {
         LAB_00108338:uVar5 = 0x7ffffffffffffff0;
         goto LAB_00108342;
      }
 ...
 while ( pMVar1 != pMVar6 );
   LAB_001082e8:if (pMVar2 != (Manifold*)0x0) {
...
/* WARNING: Removing unreachable block (ram,0x0010953a) *//* WARNING: Removing unreachable block (ram,0x0010954c) *//* WARNING: Removing unreachable block (ram,0x00109556) *//* WARNING: Removing unreachable block (ram,0x0010960e) *//* WARNING: Removing unreachable block (ram,0x001099d5) *//* WARNING: Removing unreachable block (ram,0x00109617) *//* WARNING: Removing unreachable block (ram,0x00109e78) *//* WARNING: Removing unreachable block (ram,0x001099e3) *//* WARNING: Removing unreachable block (ram,0x00109d2a) *//* WARNING: Removing unreachable block (ram,0x0010a17a) *//* WARNING: Removing unreachable block (ram,0x0010a180) *//* WARNING: Removing unreachable block (ram,0x00109d3c) *//* WARNING: Removing unreachable block (ram,0x00109a72) *//* WARNING: Removing unreachable block (ram,0x00109daf) *//* WARNING: Removing unreachable block (ram,0x00109a7b) *//* WARNING: Removing unreachable block (ram,0x00109629) *//* WARNING: Removing unreachable block (ram,0x00109577) *//* WARNING: Removing unreachable block (ram,0x0010959a) *//* WARNING: Removing unreachable block (ram,0x0010964a) *//* WARNING: Removing unreachable block (ram,0x00109a9a) *//* WARNING: Removing unreachable block (ram,0x00109c99) *//* WARNING: Removing unreachable block (ram,0x00109aad) *//* WARNING: Removing unreachable block (ram,0x0010a110) *//* WARNING: Removing unreachable block (ram,0x00109ca7) *//* WARNING: Removing unreachable block (ram,0x00109ed6) *//* WARNING: Removing unreachable block (ram,0x0010a162) *//* WARNING: Removing unreachable block (ram,0x0010a168) *//* WARNING: Removing unreachable block (ram,0x00109ee7) *//* WARNING: Removing unreachable block (ram,0x00109d09) *//* WARNING: Removing unreachable block (ram,0x00109f3f) *//* WARNING: Removing unreachable block (ram,0x00109d12) *//* WARNING: Removing unreachable block (ram,0x00109abf) *//* WARNING: Removing unreachable block (ram,0x00109ac6) *//* WARNING: Removing unreachable block (ram,0x00109661) *//* WARNING: Removing unreachable block (ram,0x001095a9) *//* WARNING: Removing unreachable block (ram,0x00109684) *//* WARNING: Removing unreachable block (ram,0x00109ae5) *//* WARNING: Removing unreachable block (ram,0x00109bfc) *//* WARNING: Removing unreachable block (ram,0x00109aee) *//* WARNING: Removing unreachable block (ram,0x0010a107) *//* WARNING: Removing unreachable block (ram,0x00109c0a) *//* WARNING: Removing unreachable block (ram,0x00109b00) *//* WARNING: Removing unreachable block (ram,0x001096c4) *//* WARNING: Removing unreachable block (ram,0x001095b8) *//* WARNING: Type propagation algorithm not settling *//* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* manifold::Manifold::Impl::Impl<double, unsigned long>(manifold::MeshGLP<double, unsigned long>
   const&) */void manifold::Manifold::Impl::Impl<double,unsigned_long>(Impl *this, MeshGLP *param_1) {
   int iVar1;
   uint uVar2;
   long lVar3;
   long lVar4;
   ...
   *(undefined8*)( this + 0x170 ) = 0;
   if (uVar31 < 3) {
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         uVar40 = 5;
         LAB_001087c4:manifold::Manifold::Impl::MarkFailure(this, uVar40);
         return;
      }
   ...
   if (( *(long*)( param_1 + 0x98 ) != *(long*)( param_1 + 0xa0 ) ) && ( in_R11 = (Vec*)( ( *(long*)( param_1 + 0x88 ) - *(long*)( param_1 + 0x80 ) >> 2 ) * 0xc ) ),in_R11 != (Vec*)( *(long*)( param_1 + 0xa0 ) - *(long*)( param_1 + 0x98 ) >> 3 )) {
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         uVar40 = 8;
         goto LAB_001087c4;
      }
   ...
   if (( *(long*)( param_1 + 0xb0 ) != *(long*)( param_1 + 0xb8 ) ) && ( uVar34 != *(long*)( param_1 + 0xb8 ) - *(long*)( param_1 + 0xb0 ) >> 3 )) {
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         uVar40 = 10;
         goto LAB_001087c4;
      }
 ...
 while ( uVar31 < ( ulong )(lVar44 >> 3) );
   ...
   *(int*)( this + 0xc4 ) = (int)pVVar27;
   ...
   if (*(ulong*)( this + 0xd8 ) < uVar43) {
      ...
      *(ulong*)( this + 0xd8 ) = uVar43;
      ...
      LAB_001098c9:*(ulong*)( this + 0xd0 ) = uVar43;
      joined_r0x001098d3:if (uVar43 * 2 < uVar31) {
         LAB_00109126:sVar50 = uVar43 * 8;
         ...
         LAB_0010915f:free(puVar35);
         LAB_00108881:*(undefined8**)( this + 200 ) = puVar29;
      ...
      if (uVar31 < uVar43) {
         puVar35 = *(undefined8**)( this + 200 );
         LAB_001090eb:if (puVar35 + uVar33 == puVar35 + uVar43) goto LAB_001098c9;
      ...
      *(ulong*)( this + 0xd0 ) = uVar43;
      if (uVar43 * 2 < uVar31) {
         ...
         LAB_00108878:if (puVar35 != (undefined8*)0x0) goto LAB_0010915f;
         goto LAB_00108881;
      }
   ...
   *(undefined8*)( this + 0x38 ) = *(undefined8*)( param_1 + 0xe0 );
   ...
   if (*(Vec**)( this + 0x58 ) < pVVar24) {
      ...
      *(Vec**)( this + 0x48 ) = pVVar46;
      *(Vec**)( this + 0x58 ) = pVVar24;
      LAB_001092a5:lVar48 = *(long*)( this + 0x48 );
      for (pauVar28 = (undefined1(*) [16])( lVar48 + (long)pVVar39 * 0x18 ); (undefined1(*) [16])( lVar48 + (long)pVVar24 * 0x18 ) != pauVar28; pauVar28 = (undefined1(*) [16])( pauVar28[1] + 8 )) {
      ...
      LAB_001088df:if (pVVar39 < pVVar24) goto LAB_001092a5;
   }
   ...
   *(Vec**)( this + 0x50 ) = pVVar24;
   if (pVVar25 < pVVar45) {
      if (pVVar47 < pVVar32) {
         puVar35 = *(undefined8**)( this + 0x48 );
         puVar29 = (undefined8*)0x0;
         LAB_001093c1:if (puVar35 != (undefined8*)0x0) goto LAB_00109930;
      }
 else {
 ...
 while ( pVVar32 != pVVar25 );
         if (pVVar27 != (Vec*)0x0) {
            ...
            pVVar25 = (Vec*)0x0;
            do {
               *(undefined8*)( lVar3 + lVar48 + (long)pVVar25 * 8 ) = *(undefined8*)( pVVar39 + (long)pVVar25 * 8 + 0x18 );
               pVVar25 = pVVar25 + 1;
            }
 ...
 while ( pVVar46 < local_148 );
   ...
   if (*(Vec**)( this + 0xb8 ) < pVVar47) {
      ...
      *(Vec**)( this + 0xb8 ) = pVVar47;
      ...
      LAB_001097fc:*(Vec**)( this + 0xb0 ) = pVVar47;
      if (pVVar24 <= pVVar27) goto LAB_00108ae4;
      LAB_0010980c:pVVar25 = (Vec*)( (long)pVVar47 << 5 );
      ...
      LAB_00109854:free(pVVar24);
      local_158 = pVVar23;
      LAB_0010932c:*(undefined8**)( this + 0xa8 ) = puVar35;
      pVVar47 = *(Vec**)( this + 0xb0 );
      *(Vec**)( this + 0xb8 ) = pVVar47;
      LAB_00109341:if (pVVar47 != (Vec*)0x0) goto LAB_00108ae4;
      pVVar47 = (Vec*)0x0;
   }
 else {
      if (pVVar47 <= pVVar24) {
         *(Vec**)( this + 0xb0 ) = pVVar47;
         if (pVVar27 < pVVar24) {
            ...
            LAB_00109323:if (pVVar24 != (Vec*)0x0) goto LAB_00109854;
            goto LAB_0010932c;
         }
      ...
      LAB_00108a97:pVVar25 = pVVar32 + (long)pVVar26 * 0x20;
 ...
 while ( uVar31 < ( ( ulong )(pVVar32 + (long)pVVar47 * 0x20 + ( -0x20 - (long)pVVar25 )) >> 5 ) + 1 );
      *(Vec**)( this + 0xb0 ) = pVVar47;
      ...
      LAB_00108ae4:uStack_50 = _UNK_0010c338;
      local_58 = _LC31;
      lVar48 = 0;
      pVVar39 = *(Vec**)( this + 0xa8 );
      pVVar45 = local_48;
      ...
      do {
         ...
         do {
            ...
            pVVar25 = pVVar39;
            if (( ( iVar22 != 0 ) && ( pVVar25 = pVVar27 ),iVar22 != 1 )) {
               pVVar25 = pVVar47;
            }
   ...
   if (*(long*)( param_1 + 0x88 ) == *(long*)( param_1 + 0x80 )) {
      ...
      if (pVVar26 == (Vec*)0x0) {
         ...
         if ((Vec*)0x7ffffffffffffff8 < pVVar26) {
            ...
            LAB_00109c81:*(Vec**)( pVVar46 + 0x128 ) = in_R11;
      ...
      if (local_70 == (undefined1[8])pVVar27) {
         ...
         if (local_70 == (undefined1[8])pVVar46) {
            std::vector<unsigned_long,std::allocator<unsigned_long>>::_M_realloc_insert<unsigned_long_const&>((vector<unsigned_long,std::allocator<unsigned_long>>*)&local_78, pVVar46, &local_90);
            uVar33 = *(long*)( param_1 + 0x28 ) - *(long*)( param_1 + 0x20 );
 ...
 while ( uVar33 < ( sVar50 - 0x10 >> 4 ) + 1 );
      ...
      iVar22 = manifold::Manifold::Impl::ReserveIDs(( uint )(*(long*)( param_1 + 0x88 ) - *(long*)( param_1 + 0x80 ) >> 2));
 ...
 while ( uVar43 != uVar33 / 3 );
            ...
            if (*(long*)( param_1 + 0xa0 ) == *(long*)( param_1 + 0x98 )) {
               pVVar32 = local_150;
               if (pVVar46 == (Vec*)0x0) {
                  LAB_001091de:local_88 = &local_94;
                  pVVar32 = (Vec*)std::_Rb_tree<int,std::pair<int_const,manifold::Manifold::Impl::Relation>,std::_Select1st<std::pair<int_const,manifold::Manifold::Impl::Relation>>,std::less<int>,std::allocator<std::pair<int_const,manifold::Manifold::Impl::Relation>>>::_M_emplace_hint_unique<std::piecewise_construct_t_const&,std::tuple<int_const&>,std::tuple<>>(this + 0xe0, pVVar32, &local_88);
                  lVar48 = *(long*)( param_1 + 0x80 );
               }
 else {
                  do {
...
;
 ...
 while ( *(Vec**)( pVVar25 + 0x18 ) != (Vec*)0x0 );
                  LAB_001091d1:if (( local_150 == pVVar32 ) || ( iVar22 < *(int*)( pVVar32 + 0x20 ) )) goto LAB_001091de;
               }
               ...
               *(int*)( pVVar32 + 0x28 ) = iVar1;
               ...
               for (int i = 0; i < 3; i++) {
                  *(undefined8*)( pVVar32 + ( 32*i + 48 ) ) = uVar40;
                  *(undefined8*)( pVVar32 + ( 32*i + 56 ) ) = 0;
                  *(undefined1(*) [16])( pVVar32 + ( 32*i + 64 ) ) = (undefined1[16])0;
               }
               ...
               pVVar32 = local_150;
               if (pVVar46 == (Vec*)0x0) {
                  LAB_00108e42:local_88 = &local_94;
                  pVVar32 = (Vec*)std::_Rb_tree<int,std::pair<int_const,manifold::Manifold::Impl::Relation>,std::_Select1st<std::pair<int_const,manifold::Manifold::Impl::Relation>>,std::less<int>,std::allocator<std::pair<int_const,manifold::Manifold::Impl::Relation>>>::_M_emplace_hint_unique<std::piecewise_construct_t_const&,std::tuple<int_const&>,std::tuple<>>(this + 0xe0, pVVar32, &local_88);
                  lVar48 = *(long*)( param_1 + 0x80 );
               }
 else {
...
;
 ...
 while ( *(Vec**)( pVVar25 + 0x18 ) != (Vec*)0x0 );
                  LAB_00108e31:if (( local_150 == pVVar32 ) || ( iVar22 < *(int*)( pVVar32 + 0x20 ) )) goto LAB_00108e42;
               }
 ...
 while ( pVVar32 != pVVar46 );
         LAB_001095c0:pVVar27 = pVVar27 + 0x10;
         pVVar24 = pVVar24 + 3;
 ...
 while ( pVVar27 != local_150 );
   ...
   joined_r0x00109603:if (local_78 != (Vec*)0x0) {
      free(local_78);
   }
   ...
   LAB_00108766:if (pVVar23 == (Vec*)0x0) {
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   ...
   LAB_0010a175:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* void std::vector<unsigned int, std::allocator<unsigned int> >::_M_realloc_insert<unsigned
   ...
   if (__src == pvVar1) {
      ...
      uVar3 = uVar3 << 2;
      LAB_0010a28a:__dest_00 = operator_new(uVar3);
      lVar4 = uVar3 + (long)__dest_00;
   }
 else {
      uVar3 = uVar2 * 2;
      if (uVar3 < uVar2) {
         LAB_0010a280:uVar3 = 0x7ffffffffffffffc;
         goto LAB_0010a28a;
      }
   ...
   *(undefined4*)( (long)__dest_00 + __n ) = *param_3;
   ...
   operator_delete(__src, *(long*)( this + 0x10 ) - (long)__src);
   LAB_0010a25b:*(void**)this = __dest_00;
   *(size_t*)( this + 8 ) = (long)__dest + __n_00;
   *(long*)( this + 0x10 ) = lVar4;
   return;
}
/* WARNING: Removing unreachable block (ram,0x0010b402) *//* WARNING: Removing unreachable block (ram,0x0010b414) *//* WARNING: Removing unreachable block (ram,0x0010b41e) *//* WARNING: Removing unreachable block (ram,0x0010b4c8) *//* WARNING: Removing unreachable block (ram,0x0010b87b) *//* WARNING: Removing unreachable block (ram,0x0010b4d1) *//* WARNING: Removing unreachable block (ram,0x0010be69) *//* WARNING: Removing unreachable block (ram,0x0010b889) *//* WARNING: Removing unreachable block (ram,0x0010bb60) *//* WARNING: Removing unreachable block (ram,0x0010c067) *//* WARNING: Removing unreachable block (ram,0x0010c06d) *//* WARNING: Removing unreachable block (ram,0x0010bb72) *//* WARNING: Removing unreachable block (ram,0x0010b91e) *//* WARNING: Removing unreachable block (ram,0x0010bbf1) *//* WARNING: Removing unreachable block (ram,0x0010b927) *//* WARNING: Removing unreachable block (ram,0x0010b4e3) *//* WARNING: Removing unreachable block (ram,0x0010b43f) *//* WARNING: Removing unreachable block (ram,0x0010b462) *//* WARNING: Removing unreachable block (ram,0x0010b504) *//* WARNING: Removing unreachable block (ram,0x0010b946) *//* WARNING: Removing unreachable block (ram,0x0010bc68) *//* WARNING: Removing unreachable block (ram,0x0010b959) *//* WARNING: Removing unreachable block (ram,0x0010bfb8) *//* WARNING: Removing unreachable block (ram,0x0010bc76) *//* WARNING: Removing unreachable block (ram,0x0010beba) *//* WARNING: Removing unreachable block (ram,0x0010c083) *//* WARNING: Removing unreachable block (ram,0x0010c089) *//* WARNING: Removing unreachable block (ram,0x0010becb) *//* WARNING: Removing unreachable block (ram,0x0010bce3) *//* WARNING: Removing unreachable block (ram,0x0010bf29) *//* WARNING: Removing unreachable block (ram,0x0010bcec) *//* WARNING: Removing unreachable block (ram,0x0010b96b) *//* WARNING: Removing unreachable block (ram,0x0010b977) *//* WARNING: Removing unreachable block (ram,0x0010b520) *//* WARNING: Removing unreachable block (ram,0x0010b471) *//* WARNING: Removing unreachable block (ram,0x0010b548) *//* WARNING: Removing unreachable block (ram,0x0010b99b) *//* WARNING: Removing unreachable block (ram,0x0010baad) *//* WARNING: Removing unreachable block (ram,0x0010b9a4) *//* WARNING: Removing unreachable block (ram,0x0010bff2) *//* WARNING: Removing unreachable block (ram,0x0010babb) *//* WARNING: Removing unreachable block (ram,0x0010bd57) *//* WARNING: Removing unreachable block (ram,0x0010c096) *//* WARNING: Removing unreachable block (ram,0x0010c09c) *//* WARNING: Removing unreachable block (ram,0x0010bd69) *//* WARNING: Removing unreachable block (ram,0x0010bb3a) *//* WARNING: Removing unreachable block (ram,0x0010bdd9) *//* WARNING: Removing unreachable block (ram,0x0010bb43) *//* WARNING: Removing unreachable block (ram,0x0010b9b6) *//* WARNING: Removing unreachable block (ram,0x0010b9c2) *//* WARNING: Removing unreachable block (ram,0x0010b577) *//* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* manifold::Manifold::Impl::Impl<float, unsigned int>(manifold::MeshGLP<float, unsigned int>
   const&) */void manifold::Manifold::Impl::Impl<float,unsigned_int>(Impl *this, MeshGLP *param_1) {
   Impl *pIVar1;
   uint uVar2;
   int iVar3;
   long lVar4;
   ...
   *(undefined1(*) [16])( this + 0x178 ) = (undefined1[16])0x0;
   if (uVar49 < 3) {
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         uVar39 = 5;
         LAB_0010a76c:manifold::Manifold::Impl::MarkFailure(this, uVar39);
         return;
      }
   ...
   if (( *(long*)( param_1 + 0x98 ) != *(long*)( param_1 + 0xa0 ) ) && ( in_R11 = (double*)( ( *(long*)( param_1 + 0x88 ) - *(long*)( param_1 + 0x80 ) >> 2 ) * 0xc ) ),in_R11 != (double*)( *(long*)( param_1 + 0xa0 ) - *(long*)( param_1 + 0x98 ) >> 2 )) {
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         uVar39 = 8;
         goto LAB_0010a76c;
      }
   ...
   if (( *(long*)( param_1 + 0xb0 ) != *(long*)( param_1 + 0xb8 ) ) && ( *(long*)( param_1 + 0xb8 ) - *(long*)( param_1 + 0xb0 ) >> 2 != ( uVar32 & 0xffffffff ) )) {
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         uVar39 = 10;
         goto LAB_0010a76c;
      }
   ...
   *(uint*)( this + 0xc4 ) = uVar41;
   ...
   if (*(double**)( this + 0xd8 ) < pdVar43) {
      ...
      *(double**)( this + 0xd8 ) = pdVar43;
      ...
      LAB_0010b824:*(double**)( this + 0xd0 ) = pdVar43;
      if (pdVar21 < pdVar28) {
         LAB_0010b834:pdVar46 = (double*)malloc((long)pdVar43 * 8);
         ...
         LAB_0010b85e:free(pdVar28);
         uVar39 = *(undefined8*)( this + 0xd0 );
         lVar48 = *(long*)( param_1 + 0x10 );
         LAB_0010a828:*(double**)( this + 200 ) = pdVar46;
         *(undefined8*)( this + 0xd8 ) = uVar39;
      }
 else {
         LAB_0010b054:lVar48 = *(long*)( param_1 + 0x10 );
      }
      ...
      if (pdVar28 < pdVar43) {
         ...
         LAB_0010b023:if (pdVar22 + (long)pdVar46 == pdVar22 + (long)pdVar43) goto LAB_0010b824;
         __src = (double*)0x0;
   ...
   *(double*)( this + 0x38 ) = (double)*(float*)( param_1 + 0xe0 );
   ...
   if (*(ulong*)( this + 0x58 ) < uVar44) {
      ...
      *(ulong*)( this + 0x58 ) = uVar44;
      ...
      LAB_0010b6a1:*(ulong*)( this + 0x50 ) = uVar44;
      if (uVar31 < uVar33) {
         LAB_0010b6ae:sVar47 = uVar44 * 0x18;
         ...
         LAB_0010b6d8:free(pdVar28);
         uVar39 = *(undefined8*)( this + 0x50 );
         lVar48 = *(long*)( param_1 + 0x10 );
         local_178 = ( ulong ) * (uint*)param_1;
         LAB_0010a8a0:*(double**)( this + 0x48 ) = pdVar46;
         *(undefined8*)( this + 0x58 ) = uVar39;
      }
 else {
         LAB_0010b1fa:lVar48 = *(long*)( param_1 + 0x10 );
         local_178 = ( ulong ) * (uint*)param_1;
      }
      ...
      if (uVar33 < uVar44) {
         pdVar28 = *(double**)( this + 0x48 );
         LAB_0010b1b9:pauVar27 = (undefined1(*) [16])( pdVar28 + uVar24 * 3 );
 ...
 while ( in_R11 != pdVar22 );
         if (uVar41 != 0) {
            ...
            uVar33 = 0;
            do {
               *(double*)( lVar4 + lVar45 + uVar33 * 8 ) = (double)*(float*)( (long)__src + uVar33 * 4 + 0xc );
               uVar33 = uVar33 + 1;
            }
 while ( uVar41 != uVar33 );
         }
 ...
 while ( pdVar46 != pdVar43 );
   ...
   if (*(double**)( this + 0xb8 ) < pdVar46) {
      ...
      *(double**)( this + 0xb8 ) = pdVar46;
      ...
      LAB_0010b77c:*(double**)( this + 0xb0 ) = pdVar46;
      if (pdVar28 <= pdVar43) goto LAB_0010aa74;
      LAB_0010b78c:sVar47 = (long)pdVar46 << 5;
      pdVar46 = (double*)malloc(sVar47);
      ...
      LAB_0010b7c0:free(pdVar28);
      LAB_0010b176:*(double**)( this + 0xa8 ) = pdVar46;
      pdVar46 = *(double**)( this + 0xb0 );
      *(double**)( this + 0xb8 ) = pdVar46;
      LAB_0010b18b:if (pdVar46 != (double*)0x0) goto LAB_0010aa74;
      pdVar46 = (double*)0x0;
   }
 else {
      if (pdVar46 <= pdVar28) {
         *(double**)( this + 0xb0 ) = pdVar46;
         if (pdVar43 < pdVar28) {
            ...
            pdVar28 = *(double**)( this + 0xa8 );
            pdVar46 = (double*)0x0;
            LAB_0010b16d:if (pdVar28 != (double*)0x0) goto LAB_0010b7c0;
            goto LAB_0010b176;
         }
      ...
      LAB_0010aa27:pauVar27 = (undefined1(*) [16])( piVar29 + (long)pdVar22 * 8 );
 ...
 while ( uVar33 < ( ( ulong )((long)( piVar29 + (long)pdVar46 * 8 ) + ( -0x20 - (long)pauVar27 )) >> 5 ) + 1 );
      *(double**)( this + 0xb0 ) = pdVar46;
      if (pdVar43 < pdVar28) goto LAB_0010b78c;
      LAB_0010aa74:auStack_50 = (undefined1[8])_UNK_0010c338;
      local_58 = _LC31;
      lVar48 = 0;
      __src = *(double**)( this + 0xa8 );
      ...
      do {
         ...
         do {
            ...
            pdVar34 = __src;
            if (( ( iVar19 != 0 ) && ( pdVar34 = pdVar21 ),iVar19 != 1 )) {
               pdVar34 = pdVar46;
            }
 ...
 while ( __src != pdVar43 );
   ...
   if (*(long*)( param_1 + 0x88 ) == *(long*)( param_1 + 0x80 )) {
      ...
      LAB_0010aba4:local_70 = ( undefined1[8] )((long)pdVar46 + (long)in_R11);
      ...
      if (local_70 == (undefined1[8])in_R11) {
         ...
         if ((undefined1[8])pdVar21 == local_70) {
            std::vector<unsigned_int,std::allocator<unsigned_int>>::_M_realloc_insert<unsigned_int>((vector<unsigned_int,std::allocator<unsigned_int>>*)&local_78, pdVar21, &local_88);
            uVar31 = *(long*)( param_1 + 0x28 ) - *(long*)( param_1 + 0x20 ) >> 2;
 ...
 while ( uVar24 < ( sVar47 - 0x10 >> 4 ) + 1 );
      ...
      iVar19 = manifold::Manifold::Impl::ReserveIDs(( uint )(*(long*)( param_1 + 0x88 ) - *(long*)( param_1 + 0x80 ) >> 2));
 ...
 while ( uVar24 != uVar44 );
            ...
            if (*(long*)( param_1 + 0xa0 ) == *(long*)( param_1 + 0x98 )) {
               pIVar25 = pIVar1;
               if (pIVar6 == (Impl*)0x0) {
                  LAB_0010b0c6:local_88 = &local_8c;
                  pIVar25 = (Impl*)std::_Rb_tree<int,std::pair<int_const,manifold::Manifold::Impl::Relation>,std::_Select1st<std::pair<int_const,manifold::Manifold::Impl::Relation>>,std::less<int>,std::allocator<std::pair<int_const,manifold::Manifold::Impl::Relation>>>::_M_emplace_hint_unique<std::piecewise_construct_t_const&,std::tuple<int_const&>,std::tuple<>>(this + 0xe0, pIVar25, &local_88);
                  lVar45 = *(long*)( param_1 + 0x80 );
               }
 else {
                  do {
...
;
 ...
 while ( *(Impl**)( pIVar26 + 0x18 ) != (Impl*)0x0 );
                  LAB_0010b0b9:if (( pIVar1 == pIVar25 ) || ( iVar19 < *(int*)( pIVar25 + 0x20 ) )) goto LAB_0010b0c6;
               }
               ...
               *(int*)( pIVar25 + 0x28 ) = iVar3;
               ...
               for (int i = 0; i < 3; i++) {
                  *(undefined8*)( pIVar25 + ( 32*i + 48 ) ) = uVar39;
                  *(undefined8*)( pIVar25 + ( 32*i + 56 ) ) = 0;
                  *(undefined1(*) [16])( pIVar25 + ( 32*i + 64 ) ) = (undefined1[16])0;
               }
               ...
               pIVar25 = pIVar1;
               if (pIVar6 == (Impl*)0x0) {
                  LAB_0010adb2:auVar8._8_4_ = SUB84(dStack_f0, 0);
...
;
 ...
 while ( *(Impl**)( pIVar26 + 0x18 ) != (Impl*)0x0 );
                  LAB_0010ada1:if (( pIVar1 == pIVar25 ) || ( iVar19 < *(int*)( pIVar25 + 0x20 ) )) goto LAB_0010adb2;
               }
 ...
 while ( uVar31 < ( ulong )(*(long*)( param_1 + 0x88 ) - lVar45 >> 2) );
   ...
   LAB_0010aea1:local_78 = (double*)0x0;
   _local_70 = (undefined1[16])0x0;
 ...
 while ( pvVar36 != (void*)( (long)local_188 + uVar33 * 0x10 ) );
   ...
   joined_r0x0010b4bd:if (local_78 != (double*)0x0) {
      free(local_78);
   }
   ...
   LAB_0010a709:if (local_148 == (double*)0x0) {
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   ...
   LAB_0010c062:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* WARNING: Control flow encountered bad instruction data *//* manifold::Manifold::Impl::Impl<float, unsigned int>(manifold::MeshGLP<float, unsigned int>
   const&) */void manifold::Manifold::Impl::Impl<float,unsigned_int>(Impl *this, MeshGLP *param_1) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* manifold::Manifold::Impl::Impl<double, unsigned long>(manifold::MeshGLP<double, unsigned long>
   const&) */void manifold::Manifold::Impl::Impl<double,unsigned_long>(Impl *this, MeshGLP *param_1) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* manifold::UnionFind<int, unsigned char>::UnionFind(int) */void manifold::UnionFind<int,unsigned_char>::UnionFind(int param_1) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* std::_Sp_counted_ptr_inplace<manifold::Manifold::Impl, std::allocator<void>,
   (__gnu_cxx::_Lock_policy)2>::~_Sp_counted_ptr_inplace() */void std::_Sp_counted_ptr_inplace<manifold::Manifold::Impl,std::allocator<void>,(__gnu_cxx::_Lock_policy)2>::~_Sp_counted_ptr_inplace(_Sp_counted_ptr_inplace<manifold::Manifold::Impl,std::allocator<void>,(__gnu_cxx::_Lock_policy)2> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

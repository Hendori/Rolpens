/* _FUN(void*, bool, Array const&) */void EngineProfiler::bind(String_const &) {
   lambda(void*,bool,Array_const&)#1
}
::_FUN(void *param_1, bool param_2, Array *param_3) {
...
/* _FUN(void*, Array const&) */void EngineProfiler::bind(String_const &) {
   lambda(void*,Array_const&)#1
}
::_FUN(void *param_1, Array *param_2) {
   /* WARNING: Load size is inaccurate */
...
/* _FUN(void*, double, double, double, double) */void EngineProfiler::bind(String_const &) {
   lambda(void*,double,double,double,double)#1
}
::_FUN(void *param_1, double param_2, double param_3, double param_4, double param_5) {
   /* WARNING: Load size is inaccurate */
...
/* EngineProfiler::bind(String const&) */undefined8 __thiscall EngineProfiler::bind(EngineProfiler *this,String *param_1)

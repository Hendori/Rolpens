/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* basisu::verify(bool, int) [clone .part.0] */void basisu::verify(bool param_1, int param_2) {
...
/* basisu::etc_block::get_block_colors(basisu::color_rgba*, unsigned int) const [clone .isra.0] */void basisu::etc_block::get_block_colors(etc_block *this, color_rgba *param_1, uint param_2) {
   ...
   if (iVar2 < 0) {
      ...
      if (0xff < iVar8) {
         iVar2 = -1;
         LAB_001004d7:iVar8 = -1;
      }

      LAB_001000f5:iVar7 = -1;
   ...
   *param_1 = SUB41(iVar7, 0);
   ...
   if (iVar9 < 0) {
      ...
      if ((int)( iVar8 + uVar6 ) < 0) {
         ...
         LAB_00100345:cVar10 = ( color_rgba )((char)iVar8 + (char)local_24._0_1_);
      }
      ...
      if (iVar9 < 0x100) {
         ...
         if (0xff < iVar2) {
            iVar9 = -1;
            LAB_0010032d:iVar2 = -1;
         }

         LAB_00100333:cVar10 = (color_rgba)0xff;
   ...
   if (iVar9 < 0) {
      ...
      if ((int)( iVar8 + uVar6 ) < 0) {
         ...
         LAB_0010030d:cVar10 = ( color_rgba )((char)iVar8 + (char)local_24._0_1_);
      }
      ...
      if (iVar9 < 0x100) {
         ...
         if (0xff < iVar2) {
            iVar9 = -1;
            LAB_001002f5:iVar2 = -1;
         }

         LAB_001002fb:cVar10 = (color_rgba)0xff;
   ...
   if (iVar9 < 0) {
      ...
      LAB_001002d0:iVar7 = iVar8 + uVar6;
   }

   LAB_00100210:param_1[0xc] = SUB41(iVar7, 0);
...
/* basisu::bitwise_coder::put_bits(unsigned int, unsigned int) [clone .part.0] */void basisu::bitwise_coder::put_bits(bitwise_coder *this, uint param_1, uint param_2) {
   int iVar1;
   undefined1 uVar2;
   uint uVar3;
   size_t __n;
   ...
   while (7 < uVar3) {
      ...
      if (uVar3 != 0xffffffff) {
         ...
         if (*(uint*)( this + 0xc ) < uVar6) {
            basisu::elemental_vector::increase_capacity((uint)this, SUB41(uVar6, 0), 1, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
            uVar3 = *(uint*)( this + 8 );
...
/* basisu::bitwise_coder::flush() [clone .isra.0] */void basisu::bitwise_coder::flush(bitwise_coder *this) {
   undefined4 uVar1;
   uint uVar2;
   size_t __n;
   ulong uVar3;
   ...
   *(ulong*)( this + 0x18 ) = *(long*)( this + 0x18 ) + ( ulong )(8 - ( *(uint*)( this + 0x14 ) & 7 ));
   ...
   if (uVar2 != 0xffffffff) {
      if (*(uint*)( this + 0xc ) < uVar4) {
         basisu::elemental_vector::increase_capacity((uint)this, SUB41(uVar4, 0), 1, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
         uVar2 = *(uint*)( this + 8 );
...
/* basisu::basisu_backend::basisu_backend() */void basisu::basisu_backend::basisu_backend(basisu_backend *this) {
   ...
   *(undefined8*)( this + 0x28 ) = 0;
   for (int i = 0; i < 4; i++) {
      *(undefined8*)( this + ( 24*i + 64 ) ) = 0;
      *(undefined8*)( this + ( 24*i + 72 ) ) = 0;
      *(undefined8*)( this + ( 24*i + 80 ) ) = 0;
   }
   ...
   *(undefined8*)( this + 0x38 ) = 0;
   for (int i = 0; i < 10; i++) {
      *(undefined8*)( this + ( 16*i + 160 ) ) = 0;
      *(undefined8*)( this + ( 16*i + 168 ) ) = 0;
   }

   *(undefined8*)this = 0;
   return;
}
/* basisu::basisu_backend::clear() */void basisu::basisu_backend::clear(basisu_backend *this) {
   undefined8 *puVar1;
   undefined8 *__ptr;
   *(undefined8*)this = 0;
   *(undefined2*)( this + 8 ) = 0;
   ...
   *(undefined8*)( this + 0x38 ) = 0;
   for (int i = 0; i < 4; i++) {
      if (*(void**)( this + ( 16*i + 64 ) ) != (void*)0) {
         free(*(void**)( this + ( 16*i + 64 ) ));
         *(undefined8*)( this + ( 16*i + 64 ) ) = 0;
...
/* basisu::basisu_backend::init(basisu::basisu_frontend*, basisu::basisu_backend_params&,
   basisu::vector<basisu::basisu_backend_slice_desc> const&) */void basisu::basisu_backend::init(basisu_backend *this, basisu_frontend *param_1, basisu_backend_params *param_2, vector *param_3) {
   undefined8 uVar1;
   undefined8 uVar2;
   uint *puVar3;
   ulong uVar4;
   ...
   *(undefined2*)( this + 0x18 ) = *(undefined2*)( param_2 + 0x10 );
   if ((vector*)( this + 0x20 ) == param_3) {
      ...
      if (*(uint*)( this + 0x2c ) < *(uint*)( param_3 + 8 )) {
         ...
         basisu::elemental_vector::increase_capacity((uint)(vector*)( this + 0x20 ), SUB81(uVar5, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x30, false);
         uVar5 = ( ulong ) * (uint*)( param_3 + 8 );
         __ptr = *(void**)( this + 0x20 );
      }
   ...
   uVar4 = 0;
   basisu::debug_printf("basisu_backend::Init: Slices: %u, ETC1S: %u, EndpointRDOQualityThresh: %f, SelectorRDOQualityThresh: %f\n", (double)*(float*)( param_2 + 4 ), (double)*(float*)( param_2 + 8 ), uVar5, ( ulong )(byte) * param_2);
   basisu::debug_printf("Frontend endpoints: %u selectors: %u\n", ( ulong ) * (uint*)( *(long*)this + 200 ), ( ulong ) * (uint*)( *(long*)this + 0x128 ));
   if (*(int*)( this + 0x28 ) != 0) {
      do {
         puVar3 = (uint*)( uVar4 * 0x30 + *(long*)( this + 0x20 ) );
         uVar5 = uVar4 & 0xffffffff;
         uVar4 = uVar4 + 1;
         basisu::debug_printf("Slice: %u, OrigWidth: %u, OrigHeight: %u, Width: %u, Height: %u, NumBlocksX: %u, NumBlocksY: %u, FirstBlockIndex: %u\n", uVar5, (ulong)puVar3[1], (ulong)puVar3[2], (ulong)puVar3[3], (ulong)puVar3[4], (ulong)puVar3[5], (ulong)puVar3[6], ( ulong ) * puVar3);
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* basisu::basisu_backend::create_endpoint_palette() */void basisu::basisu_backend::create_endpoint_palette(basisu_backend *this) {
   undefined8 *puVar1;
   char cVar2;
   uint uVar3;
   long lVar4;
   ...
   if (uVar3 != uVar10) {
      ...
      if (uVar10 <= uVar3) {
         if (*(uint*)( this + 0xac ) < uVar3) {
            basisu::elemental_vector::increase_capacity((int)this + 0xa0, SUB41(uVar3, 0), ( uint )(uVar10 + 1 == uVar3), (_func_void_void_ptr_void_ptr_uint*)0xc, false);
            uVar10 = *(uint*)( this + 0xa8 );
         }
...
/* basisu::basisu_backend::create_selector_palette() */void basisu::basisu_backend::create_selector_palette(basisu_backend *this) {
   long lVar1;
   long lVar2;
   long lVar3;
   int iVar4;
   ...
   *(uint*)( this + 0x3c ) = uVar12;
   ...
   if (uVar14 <= uVar12) {
      if (*(uint*)( this + 0xbc ) < uVar12) {
         basisu::elemental_vector::increase_capacity((int)this + 0xb0, SUB41(uVar12, 0), ( uint )(uVar14 + 1 == uVar12), (_func_void_void_ptr_void_ptr_uint*)0x10, false);
         uVar14 = *(uint*)( this + 0xb8 );
      }
 ...
 while ( pauVar11 != pauVar5 );
      ...
      LAB_00100e10:uVar9 = *(uint*)( lVar2 + 0x128 );
   }

   uVar14 = uVar9;
   *(uint*)( this + 0xb8 ) = uVar12;
   LAB_00100cce:lVar15 = 0;
   if (uVar14 != 0) {
      do {
         uVar14 = 0x10;
         uVar10 = 0;
         ...
         do {
            ...
            do {
               ...
               *(undefined1*)( lVar15 * 0x10 + lVar3 + uVar13 ) = *(undefined1*)( (long)&g_etc1_to_selector_index + ( ulong )(( (int)( uint ) * (byte*)( lVar1 + -2 + uVar16 ) >> bVar7 ) * 2 & 2U | (int)( uint ) * (byte*)( lVar1 + uVar16 ) >> bVar7 & 1U) );
            }
 while ( uVar9 != uVar14 );
            uVar12 = iVar4 + 1;
            uVar10 = (ulong)uVar12;
...
/* basisu::basisu_backend::reoptimize_and_sort_endpoints_codebook(unsigned int,
   basisu::vector<unsigned int>&) */void basisu::basisu_backend::reoptimize_and_sort_endpoints_codebook(basisu_backend *this, uint param_1, vector *param_2) {
   int *piVar1;
   uint uVar2;
   vector *pvVar3;
   long lVar4;
 ...
 while ( piVar17 != piVar12 );
            ...
            local_a0 = 0;
            if (iVar24 != 0) {
               basisu::elemental_vector::increase_capacity(( uint ) & local_a8, SUB41(iVar24, 0), ( uint )(iVar24 == 1), (_func_void_void_ptr_void_ptr_uint*)0x4, false);
               memset((void*)( (long)local_a8 + ( local_a0 & 0xffffffff ) * 4 ), 0, ( ulong )(uint)(iVar24 - (int)local_a0) << 2);
               ...
               if (( iVar24 != 0 ) && ( iVar22 != 0 )) {
                  ...
                  do {
                     ...
                     do {
                        ...
                        iVar8 = iVar8 + 1;
                        *(undefined4*)( (long)local_a8 + (ulong)uVar26 * 4 ) = *(undefined4*)( lVar5 + 4 + (ulong)uVar15 * 0x14 );
                     }
 while ( iVar22 != iVar8 );
                     iVar20 = iVar20 + 1;
 ...
 while ( uVar25 < *(uint*)( this + 0x28 ) );
         ...
         LAB_00101589:uVar25 = ( uint ) & local_98;
         local_98 = (void*)0x0;
         local_90 = 0;
         basisu::basisu_frontend::reoptimize_remapped_endpoints(pvVar3, (vector*)&local_a8, SUB81(&local_98, 0), (vector*)0x1);
 ...
 while ( iVar24 != iVar22 );
                     ...
                     do {
                        ...
                        do {
                           ...
                           *(undefined4*)( lVar6 + 4 ) = *(undefined4*)( (long)local_98 + (long)*(int*)( lVar6 + 4 ) * 4 );
                        }
 while ( uVar13 != uVar26 );
                        iVar22 = iVar22 + 1;
                     }
 ...
 while ( lVar9 != (ulong)uVar15 * 0x18 );
         ...
         if (*(int*)( param_2 + 8 ) != 0) {
            ...
            lVar9 = 0;
            do {
               *(undefined4*)( lVar14 + lVar9 * 4 ) = *(undefined4*)( (long)local_98 + ( ulong ) * (uint*)( lVar14 + lVar9 * 4 ) * 4 );
               lVar9 = lVar9 + 1;
            }
 while ( (uint)lVar9 < *(uint*)( param_2 + 8 ) );
      ...
      local_68 = (void*)0x0;
      local_58 = (void*)0x0;
      basisu::palette_index_reorderer::init(uVar25, (uint*)( ulong ) * (uint*)( param_2 + 8 ), ( uint ) * (undefined8*)param_2, (_func_float_uint_uint_void_ptr*)( ulong ) * (uint*)( pvVar3 + 200 ), (void*)0x0, 0.0);
      ...
      if (*(uint*)( this + 0xec ) < (uint)local_50) {
         ...
         basisu::elemental_vector::increase_capacity(iVar7 + 0xe0, SUB81(uVar16, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x4, false);
         uVar16 = local_50 & 0xffffffff;
      }
      ...
      uVar19 = (int)uVar16;
      if (*(void**)( this + 0xe0 ) == (void*)0x0) {
         LAB_00100f3e:*(undefined4*)( this + 0xe8 ) = uVar19;
 ...
 while ( (uint)lVar9 < *(uint*)( pvVar3 + 200 ) );
      ...
      *(undefined8*)( this + 0xe0 ) = 0;
      if (uVar25 != 0) {
         uVar15 = 0;
         LAB_001012c0:basisu::elemental_vector::increase_capacity(iVar7 + 0xe0, SUB41(uVar25, 0), ( uint )(uVar15 + 1 == uVar25), (_func_void_void_ptr_void_ptr_uint*)0x4, false);
         lVar14 = *(long*)( this + 0xe0 );
         uVar15 = *(uint*)( this + 0xe8 );
         LAB_001012f0:memset((void*)( lVar14 + (ulong)uVar15 * 4 ), 0, ( ulong )(uVar25 - uVar15) << 2);
         uVar26 = *(uint*)( pvVar3 + 200 );
         LAB_0010141e:*(uint*)( this + 0xe8 ) = uVar25;
         uVar15 = uVar26;
         goto LAB_00101424;
      }
   ...
   if (*(void**)( this + 0x100 ) == (void*)0x0) {
      ...
      *(undefined8*)( this + 0x100 ) = 0;
      if (uVar25 != 0) {
         uVar15 = 0;
         LAB_00101315:basisu::elemental_vector::increase_capacity(iVar7 + 0x100, SUB41(uVar25, 0), ( uint )(uVar15 + 1 == uVar25), (_func_void_void_ptr_void_ptr_uint*)0x1, false);
         lVar14 = *(long*)( this + 0x100 );
         uVar15 = *(uint*)( this + 0x108 );
         LAB_00101346:memset((void*)( lVar14 + (ulong)uVar15 ), 0, ( ulong )(uVar25 - uVar15));
         LAB_00101278:*(uint*)( this + 0x108 ) = uVar25;
      }
 ...
 while ( lVar9 != (ulong)uVar25 * 0x18 );
   ...
   basisu::debug_printf("basisu_backend::reoptimize_and_sort_endpoints_codebook: First old entry index: %u\n");
   if (*(void**)( this + 0x110 ) == (void*)0x0) {
      ...
      *(undefined8*)( this + 0x110 ) = 0;
      if (uVar25 != 0) {
         uVar26 = 0;
         LAB_001013b0:basisu::elemental_vector::increase_capacity(iVar7 + 0x110, SUB41(uVar25, 0), ( uint )(uVar26 + 1 == uVar25), (_func_void_void_ptr_void_ptr_uint*)0x1, false);
         lVar14 = *(long*)( this + 0x110 );
         uVar26 = *(uint*)( this + 0x118 );
         LAB_001013e3:memset((void*)( lVar14 + (ulong)uVar26 ), 0, ( ulong )(uVar25 - uVar26));
         LAB_0010124e:*(uint*)( this + 0x118 ) = uVar25;
      }
   ...
   if (*(void**)( this + 0xf0 ) == (void*)0x0) {
      ...
      *(undefined8*)( this + 0xf0 ) = 0;
      ...
      uVar26 = 0;
      LAB_0010135b:basisu::elemental_vector::increase_capacity(iVar7 + 0xf0, SUB81(uVar16, 0), ( uint )(uVar26 + 1 == (int)uVar16), (_func_void_void_ptr_void_ptr_uint*)0x4, false);
      lVar14 = *(long*)( this + 0xf0 );
      uVar26 = *(uint*)( this + 0xf8 );
      LAB_0010138e:memset((void*)( lVar14 + (ulong)uVar26 * 4 ), 0, ( ulong )((int)uVar16 - uVar26) << 2);
      puVar21 = *(uint**)( this + 0xf0 );
      LAB_001011ea:*(int*)( this + 0xf8 ) = (int)uVar16;
 ...
 while ( puVar11 != puVar18 );
   ...
   LAB_001010fa:if (*(int*)( this + 0xe8 ) != 0) {
      lVar14 = *(long*)( this + 0x100 );
      lVar9 = 0;
      do {
...
/* basisu::basisu_backend::find_video_frame(int, int) */int basisu::basisu_backend::find_video_frame(basisu_backend *this, int param_1, int param_2) {
   int iVar1;
   int *piVar2;
   long lVar3;
   if (*(int*)( this + 0x28 ) != 0) {
      ...
      do {
         if (( ( ( piVar2[4] == param_2 + *(int*)( lVar3 + 0x24 ) ) && ( piVar2[5] == *(int*)( lVar3 + 0x28 ) ) ) && ( *piVar2 == *(int*)( lVar3 + 0x14 ) ) ) && ( ( piVar2[1] == *(int*)( lVar3 + 0x18 ) && ( (char)piVar2[6] == *(char*)( lVar3 + 0x2c ) ) ) )) {
            return iVar1;
         }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* basisu::basisu_backend::check_for_valid_cr_blocks() [clone .part.0] */void basisu::basisu_backend::check_for_valid_cr_blocks(basisu_backend *this) {
   int *piVar1;
   int *piVar2;
   long lVar3;
   char cVar4;
 ...
 while ( iVar5 != iVar7 );
               ...
               do {
                  ...
                  uVar15 = iVar17 + uVar9;
                  do {
                     if (*(int*)( *(long*)( (int*)( *(long*)( this + 0xd0 ) + lVar13 ) + 2 ) + (ulong)uVar9 * 0x14 ) == 2) {
                        uVar11 = 0x172;
                        goto LAB_001019ce;
                     }
         ...
         if (iVar5 != 0) {
            ...
            do {
               if (iVar17 != 0) {
                  ...
                  iVar8 = 0;
                  do {
                     while (piVar2 = (int*)( *(long*)( piVar1 + 2 ) + ( ulong )(uint)(*piVar1 * iVar16 + iVar8) * 0x14 ),*piVar2 != 2) {
                        LAB_001018b8:iVar8 = iVar8 + 1;
                        if (iVar17 == iVar8) goto LAB_00101902;
                     }
;
                     uVar18 = ( ulong )((int)uVar18 + 1);
                     lVar3 = *(long*)( piVar10 + 2 ) + ( ulong )(uint)(*piVar10 * iVar16 + iVar8) * 0x14;
                     if (( piVar2[1] == *(int*)( lVar3 + 4 ) ) && ( piVar2[2] == *(int*)( lVar3 + 8 ) )) goto LAB_001018b8;
                     iVar8 = iVar8 + 1;
                     uVar12 = uVar12 + 1;
                  }
 while ( iVar17 != iVar8 );
 ...
 while ( iVar19 != iVar14 );
   ...
   verify(true, iVar14);
   LAB_00101a00:uVar11 = 0x167;
   LAB_001019ce:__fprintf_chk(_stderr, 2, "ERROR: basisu_backend: verify() failed at line %i!\n", uVar11);
   /* WARNING: Subroutine does not return */
   abort();
}
/* basisu::basisu_backend::check_for_valid_cr_blocks() */void basisu::basisu_backend::check_for_valid_cr_blocks(basisu_backend *this) {
...
/* basisu::basisu_backend::compute_slice_crcs() */void basisu::basisu_backend::compute_slice_crcs(basisu_backend *this) {
   ushort *puVar1;
   byte bVar2;
   ...
   if (*(int*)( this + 0x28 ) != 0) {
      ...
      do {
         ...
         if (iVar22 != 0) {
            basisu::elemental_vector::increase_capacity(( uint ) & local_158, SUB41(iVar22, 0), ( uint )(iVar22 == 1), (_func_void_void_ptr_void_ptr_uint*)0x8, false);
            memset((void*)( (long)local_158 + ( local_150 & 0xffffffff ) * 8 ), 0, ( ulong )(uint)(iVar22 - (int)local_150) << 3);
               ...
               if (iVar4 != 0) {
                  do {
                     ...
                     *(byte*)( (long)puVar1 + 3 ) = *(byte*)( (long)puVar1 + 3 ) & 0xfc | 2;
                     ...
                     iVar22 = basisu::etc_block::pack_color5((color_rgba*)( *(long*)( this + 0xa0 ) + lVar23 ), false, 0x7f);
                     *puVar1 = CONCAT11((char)( (ushort)iVar22 >> 5 ) << 3, ( ( byte )((uint)iVar22 >> 8) >> 2 ) << 3) | _LC10 & *puVar1;
                     ...
                     *(byte*)puVar1 = ( byte ) * puVar1 & 0xf8 | ( byte )(uVar9 >> 6) & 7;
                     uVar21 = 0;
                     *(byte*)( (long)puVar1 + 1 ) = *(byte*)( (long)puVar1 + 1 ) & 0xf8 | ( byte )(uVar9 >> 3) & 7;
                     *(byte*)( puVar1 + 1 ) = (byte)uVar9 & 7 | (byte)puVar1[1] & 0xf8;
                     iVar22 = *(int*)( *(long*)( this + 0xa0 ) + 4 + lVar23 );
                     *(byte*)( (long)puVar1 + 3 ) = *(byte*)( (long)puVar1 + 3 ) & 3 | ( byte )(iVar22 << 5) | ( byte )(iVar22 << 2);
                     ...
                     do {
                        ...
                        do {
                           ...
                           uVar19 = uVar19 + 1;
                           bVar2 = *(byte*)( (long)&g_selector_index_to_etc1 + ( ulong ) * (byte*)( (ulong)uVar11 * 0x10 + lVar12 + uVar20 ) );
                           bVar7 = ~(byte)(1 << bVar13);
                           *(byte*)( (long)puVar1 + uVar16 ) = *(byte*)( (long)puVar1 + uVar16 ) & bVar7 | ( byte )(( bVar2 & 1 ) << bVar13);
                           *(byte*)( (long)puVar1 + ( uVar16 - 2 ) ) = bVar7 & *(byte*)( (long)puVar1 + ( uVar16 - 2 ) ) | ( bVar2 >> 1 ) << bVar13;
                           uVar8 = uVar6 + 4;
                        }
...
/* basisu::basisu_backend::encode_endpoint_palette() */char basisu::basisu_backend::encode_endpoint_palette(basisu_backend *this) {
   int *piVar1;
   byte bVar2;
   int iVar3;
   uint uVar4;
   ...
   local_150 = 0;
   if (iVar31 != 0) {
      basisu::elemental_vector::increase_capacity(( uint ) & local_158, SUB41(iVar31, 0), ( uint )(iVar31 == 1), (_func_void_void_ptr_void_ptr_uint*)0x1, false);
      memset((void*)( ( local_150 & 0xffffffff ) + (long)local_158 ), 0, ( ulong )(uint)(iVar31 - (int)local_150));
 ...
 while ( (ulong)uVar25 * 0x18 != lVar14 );
   ...
   local_140 = 0;
   if (uVar25 == 0) {
      LAB_00102c6a:local_130 = 0;
      local_138 = (char*)0x0;
      if (*(int*)( this + 0xe8 ) != 0) {
         LAB_00102126:lVar15 = 0;
         do {
 ...
 while ( (uint)lVar15 < *(uint*)( this + 0xe8 ) );
      ...
      basisu::elemental_vector::increase_capacity(( uint ) & local_148, SUB41(uVar25, 0), ( uint )(uVar25 == 1), (_func_void_void_ptr_void_ptr_uint*)0x4, false);
      ...
      *local_148 = uVar24;
      ...
      basisu::elemental_vector::increase_capacity(( uint ) & local_138, SUB41(uVar25, 0), ( uint )(uVar25 == 1), (_func_void_void_ptr_void_ptr_uint*)0x1, false);
 ...
 while ( local_138 + uVar25 != pcVar16 );
   ...
   basisu::debug_printf("basisu_backend::encode_endpoint_palette: total_unused_new_entries: %u out of %u\n", uVar20, (ulong)uVar25);
   if (*(uint*)( this + 0xa8 ) != 0) {
 ...
 while ( pcVar17 != pcVar16 );
   ...
   bVar7 = 1;
   LAB_001021e9:local_128 = (uint*)0x0;
   local_120 = 0;
   basisu::elemental_vector::increase_capacity(( uint ) & local_128, true, 0, (_func_void_void_ptr_void_ptr_uint*)0x4, false);
   memset(local_128 + ( local_120 & 0xffffffff ), 0, ( ulong )(0x20 - (int)local_120) << 2);
   local_120 = CONCAT44(local_120._4_4_, 0x20);
   local_118 = (uint*)0x0;
   local_110 = 0;
   basisu::elemental_vector::increase_capacity(( uint ) & local_118, true, 0, (_func_void_void_ptr_void_ptr_uint*)0x4, false);
   memset(local_118 + ( local_110 & 0xffffffff ), 0, ( ulong )(0x20 - (int)local_110) << 2);
   local_110 = CONCAT44(local_110._4_4_, 0x20);
   local_108 = (uint*)0x0;
   local_100 = 0;
   basisu::elemental_vector::increase_capacity(( uint ) & local_108, true, 0, (_func_void_void_ptr_void_ptr_uint*)0x4, false);
   memset(local_108 + ( local_100 & 0xffffffff ), 0, ( ulong )(0x20 - (int)local_100) << 2);
   local_100 = CONCAT44(local_100._4_4_, 0x20);
   local_f8 = (void*)0x0;
   local_f0 = 0;
   basisu::elemental_vector::increase_capacity(( uint ) & local_f8, true, 0, (_func_void_void_ptr_void_ptr_uint*)0x4, false);
 ...
 while ( (uint)lVar14 < *(uint*)( lVar5 + 200 ) );
   ...
   if ((int)local_120 == 0) {
      LAB_00102c46:*local_128 = *local_128 + 1;
   }
 else {
      lVar15 = 0;
      puVar19 = local_128;
 ...
 while ( local_128 + ( local_120 & 0xffffffff ) != puVar19 );
   ...
   if ((int)local_110 == 0) {
      LAB_00102c2a:*local_118 = *local_118 + 1;
      if ((int)local_100 == 0) goto LAB_00102c3d;
      LAB_00102516:lVar15 = 0;
      puVar19 = local_108;
      do {
         uVar25 = *puVar19;
         puVar19 = puVar19 + 1;
 ...
 while ( puVar19 != local_118 + ( local_110 & 0xffffffff ) );
      ...
      LAB_00102c3d:*local_108 = *local_108 + 1;
   }
   ...
   local_78 = (void*)0x0;
   local_70 = 0;
   cVar12 = basisu::huffman_encoding_table::init(( uint ) & local_e8, (uint*)( local_120 & 0xffffffff ), (uint)local_128);
   if (( ( cVar12 == '\0' ) || ( cVar12 = basisu::huffman_encoding_table::init(( uint ) & local_c8, (uint*)( local_110 & 0xffffffff ), (uint)local_118) ),cVar12 == '\0' )) {
      basisu::error_printf("color5_delta_model.init() failed!");
   }
 else {
      local_15d = basisu::huffman_encoding_table::init(( uint ) & local_88, (uint*)( local_f0 & 0xffffffff ), (uint)local_f8);
      if (local_15d != '\0') {
         local_68 = (void*)0x0;
         local_50 = 0;
         local_60 = (undefined1[16])0x0;
         uVar25 = (uint)(huffman_encoding_table*)&local_68;
         basisu::elemental_vector::increase_capacity(uVar25, false, 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
         ...
         while (7 < uVar24) {
            ...
            if (local_60._0_4_ != 0xffffffff) {
               ...
               if ((uint)local_60._4_4_ < uVar24) {
                  basisu::elemental_vector::increase_capacity(uVar25, SUB41(uVar24, 0), 1, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
...
;
         ...
         if (*(int*)( lVar5 + 200 ) != 0) {
            ...
            do {
               ...
               if (bVar2 != 0) {
                  ...
                  bVar22 = (byte)uVar24;
                  uVar24 = uVar24 + bVar2;
                  uVar20 = ( ulong ) * (ushort*)( (long)local_88 + uVar20 * 2 ) << ( bVar22 & 0x3f ) | (ulong)(uint)local_60._8_4_;
                  local_60._12_4_ = uVar24;
                  if (7 < uVar24) {
                     do {
                        uVar34 = (ulong)(uint)local_60._0_4_;
               ...
               do {
                  ...
                  if (bVar2 < 10) {
                     ...
                     if (bVar2 != 0) {
                        ...
                        uVar24 = uVar24 + bVar2;
                        local_60._12_4_ = uVar24;
                        uVar34 = ( ulong ) * (ushort*)( (long)local_e8 + uVar34 * 2 ) << ( bVar23 & 0x3f ) | (ulong)(uint)uVar11;
                        if (7 < uVar24) {
                           do {
 ...
 while ( 7 < uVar24 );
                     ...
                     if (bVar2 != 0) {
                        ...
                        local_60._12_4_ = uVar24;
                        uVar34 = ( ulong ) * (ushort*)( (long)local_c8 + uVar34 * 2 ) << ( bVar22 & 0x3f ) | (ulong)(uint)uVar11;
                        if (7 < uVar24) {
                           do {
                              uVar32 = (ulong)(uint)local_60._0_4_;
                              uVar24 = local_60._0_4_ + 1;
 ...
 while ( 7 < uVar24 );
                           LAB_00102ca0:lVar15 = *(long*)( this + 0xa0 );
                           lVar14 = lVar15 + lVar33;
                           uVar34 = uVar27;
                        }

                        LAB_00102cc4:local_60._8_4_ = (uint)uVar34 & 0xff;
                        bVar22 = *(byte*)( lVar14 + ( uVar20 & 0xffffffff ) );
                     }
                     ...
                     if (bVar2 != 0) {
                        ...
                        uVar24 = uVar24 + bVar2;
                        local_60._12_4_ = uVar24;
                        uVar34 = ( ulong ) * (ushort*)( (long)local_a8 + uVar34 * 2 ) << ( bVar23 & 0x3f ) | (ulong)(uint)uVar11;
                        if (7 < uVar24) {
                           do {
                              uVar32 = (ulong)(uint)local_60._0_4_;
                              uVar24 = local_60._0_4_ + 1;
 ...
 while ( (uint)local_188 < *(uint*)( lVar5 + 200 ) );
         ...
         if (*(uint*)( this + 0x4c ) < (uint)local_60._0_4_) {
            ...
            basisu::elemental_vector::increase_capacity((int)this + 0x40, SUB41(local_60._0_4_, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
            __ptr = *(void**)( this + 0x40 );
         }
 ...
 while ( piVar21 != piVar29 );
         ...
         basisu::debug_printf("Endpoint codebook size: %u bits %u bytes, Bits per entry: %3.1f, Avg bits/texel: %3.3f\n", (double)( fVar36 / (float)*(uint*)( lVar5 + 200 ) ), (double)( fVar36 / fVar37 ), ( ulong )(uVar25 * 8), (ulong)uVar25);
         if (local_68 != (void*)0x0) {
            free(local_68);
         }
   ...
   local_15d = '\0';
   LAB_00102afa:if (local_78 != (void*)0x0) {
      free(local_78);
   }
...
/* basisu::basisu_backend::encode_selector_palette() */uint basisu::basisu_backend::encode_selector_palette(basisu_backend *this) {
   int *piVar1;
   undefined8 *puVar2;
   int iVar3;
   long lVar4;
   ...
   local_b8 = (uint*)0x0;
   local_b0 = 0;
   basisu::elemental_vector::increase_capacity(( uint ) & local_b8, false, 0, (_func_void_void_ptr_void_ptr_uint*)0x4, false);
...
;
         puVar2 = (undefined8*)( *(long*)( this + 0xb0 ) + ( ulong ) * (uint*)( *(long*)( this + 0x130 ) + ( ulong )((int)lVar23 - 1) * 4 ) * 0x10 );
         local_58 = *puVar2;
         uStack_50 = puVar2[1];
         pbVar29 = (byte*)( *(long*)( this + 0xb0 ) + ( ulong ) * (uint*)( *(long*)( this + 0x130 ) + lVar23 * 4 ) * 0x10 );
         pbVar18 = (byte*)&local_58;
         do {
            pbVar16 = pbVar18 + 4;
            local_b8[(int)( ( (uint)pbVar29[1] << 2 | (uint)pbVar29[2] << 4 | ( uint ) * pbVar29 | (uint)pbVar29[3] << 6 ) ^ ( (uint)pbVar18[3] << 6 | (uint)pbVar18[1] << 2 | (uint)pbVar18[2] << 4 | ( uint ) * pbVar18 ) )] = local_b8[(int)( ( (uint)pbVar29[1] << 2 | (uint)pbVar29[2] << 4 | ( uint ) * pbVar29 | (uint)pbVar29[3] << 6 ) ^ ( (uint)pbVar18[3] << 6 | (uint)pbVar18[1] << 2 | (uint)pbVar18[2] << 4 | ( uint ) * pbVar18 ) )] + 1;
            pbVar29 = pbVar29 + 4;
            pbVar18 = pbVar16;
         }
 ...
 while ( local_b8 + 0x100 != puVar10 );
   ...
   basisu::elemental_vector::increase_capacity(uVar14, false, 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
      ...
      do {
         ...
         if ((int)uVar11 == 0) {
            ...
            while (true) {
               ...
               uVar21 = (long)(int)( ( uint ) * (byte*)( lVar23 + ( ulong )(iVar3 + 1) ) << 2 | ( uint ) * (byte*)( lVar23 + ( ulong )(iVar3 + 2) ) << 4 | ( uint ) * (byte*)( lVar23 + ( uVar22 & 0xffffffff ) ) | ( uint ) * (byte*)( lVar23 + ( ulong )(iVar3 + 3) ) << 6 ) << ( bVar13 & 0x3f ) | uVar21;
               while (7 < uVar27) {
                  ...
                  if (local_70._0_4_ != 0xffffffff) {
                     ...
                     if ((uint)local_70._4_4_ < uVar27) {
                        basisu::elemental_vector::increase_capacity(uVar14, SUB41(uVar27, 0), 1, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
...
;
            ...
            uStack_50 = puVar2[1];
            do {
               lVar23 = (long)(int)( ( (uint)pbVar29[1] << 2 | (uint)pbVar29[2] << 4 | ( uint ) * pbVar29 | (uint)pbVar29[3] << 6 ) ^ ( (uint)pbVar18[3] << 6 | (uint)pbVar18[1] << 2 | (uint)pbVar18[2] << 4 | ( uint ) * pbVar18 ) );
...
;
 ...
 while ( (uint)uVar11 < *(uint*)( lVar4 + 0x128 ) );
   ...
   if (*(uint*)( this + 0x5c ) < (uint)local_70._0_4_) {
      ...
      basisu::elemental_vector::increase_capacity(uVar27, SUB41(local_70._0_4_, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
      sVar17 = (size_t)(uint)local_70._0_4_;
      pvVar26 = *(void**)( this + 0x50 );
   }
   ...
   if (uVar15 * 4 <= uVar20) {
      if ((uint)local_70._4_4_ < 0x100000) {
         ...
         if (bVar31) {
            ...
            basisu::elemental_vector::increase_capacity(( uint ) & local_a8, SUB41(uVar15, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
            if (local_a0._4_4_ < (uint)local_70._0_4_) {
               ...
               basisu::elemental_vector::increase_capacity(( uint ) & local_a8, SUB41(local_70._0_4_, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
            }
      ...
      if (uVar15 == 0) {
         ...
         LAB_00103c5e:local_70._0_4_ = uVar15;
         *(undefined1*)( (long)local_78 + sVar17 ) = uVar28;
         ...
         do {
            ...
            do {
               ...
               uVar22 = (long)(int)( ( uint ) * (byte*)( lVar25 + ( ulong )(iVar3 + 1) ) << 2 | ( uint ) * (byte*)( lVar25 + ( ulong )(iVar3 + 2) ) << 4 | ( uint ) * (byte*)( lVar25 + uVar21 ) | ( uint ) * (byte*)( lVar25 + ( ulong )(iVar3 + 3) ) << 6 ) << ( bVar13 & 0x3f ) | uVar11;
               if (7 < uVar15) {
                  while (true) {
                     ...
                     if ((int)sVar17 != -1) {
                        ...
                        if ((uint)local_70._4_4_ < uVar30) {
                           basisu::elemental_vector::increase_capacity(uVar14, SUB41(uVar30, 0), 1, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
                           uVar11 = (ulong)(uint)local_70._0_4_;
...
;
 ...
 while ( (uint)lVar23 < *(uint*)( lVar4 + 0x128 ) );
      ...
      if (*(uint*)( this + 0x5c ) < (uint)sVar17) {
         ...
         basisu::elemental_vector::increase_capacity(uVar27, SUB41(uVar14, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
         sVar17 = (size_t)(uint)local_70._0_4_;
         pvVar26 = *(void**)( this + 0x50 );
      }
 else if (*(int*)( this + 0x58 ) != 0) {
 ...
 while ( piVar12 != piVar24 );
   ...
   basisu::debug_printf("Selector codebook bits: %u bytes: %u, Bits per entry: %3.1f, Avg bits/texel: %3.3f\n", (double)( ( (float)sVar17 * _LC17 ) / (float)uVar15 ), (double)( ( (float)sVar17 * _LC17 ) / fVar32 ), ( ulong )(uint)((int)sVar17 * 8), sVar17);
   if (local_78 != (void*)0x0) {
      free(local_78);
   }

   LAB_0010365f:if (local_88 != (void*)0x0) {
      free(local_88);
   }
...
/* WARNING: Type propagation algorithm not settling *//* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* basisu::basisu_backend::encode_image() */ulong basisu::basisu_backend::encode_image(basisu_backend *this) {
   int *piVar1;
   color_rgba *pcVar2;
   byte *pbVar3;
   undefined4 *puVar4;
   ...
   local_148 = (void*)0x0;
   local_140 = 0;
   basisu::elemental_vector::increase_capacity(( uint ) & local_148, true, 0, (_func_void_void_ptr_void_ptr_uint*)0x4, false);
   memset((void*)( (long)local_148 + ( local_140 & 0xffffffff ) * 4 ), 0, ( ulong )(0x40 - (uint)local_140) << 2);
   ...
   if (iVar45 == 0) {
      ...
      basisu::elemental_vector::increase_capacity(( uint ) & local_1b8, SUB41(iVar45, 0), ( uint )(iVar45 == 1), (_func_void_void_ptr_void_ptr_uint*)0x10, false);
      ...
      if (uVar39 != uVar28) {
         if (uVar39 <= uVar28) {
            if (*(uint*)( this + 0x9c ) < uVar28) {
               basisu::elemental_vector::increase_capacity((int)this + 0x90, SUB41(uVar28, 0), ( uint )(uVar39 + 1 == uVar28), (_func_void_void_ptr_void_ptr_uint*)0x2, false);
               uVar39 = *(uint*)( this + 0x98 );
            }
   ...
   iVar45 = *(int*)( this + 0x28 );
   if (iVar45 != 0) {
      basisu::elemental_vector::increase_capacity(( uint ) & local_188, SUB41(iVar45, 0), ( uint )(iVar45 == 1), (_func_void_void_ptr_void_ptr_uint*)0x10, false);
   ...
   if (*(int*)( this + 0x28 ) == 0) {
      ...
      do {
         ...
         if (local_148 != (void*)0x0) {
            ...
            local_140 = 0;
            if (uVar50 != 0) {
               basisu::elemental_vector::increase_capacity(( uint ) & local_148, SUB81(uVar51, 0), ( uint )(uVar50 == 1), (_func_void_void_ptr_void_ptr_uint*)0x4, false);
               memset((void*)( (long)local_148 + ( local_140 & 0xffffffff ) * 4 ), 0, ( ulong )(uVar50 - (uint)local_140) << 2);
         ...
         local_138 = uVar50 >> 1;
         if (uVar28 == 0) {
            joined_r0x00106765:if (uVar39 != 0) {
               local_250 = (void*)0x0;
               LAB_00104284:if (-uVar28 != 0) {
                  uVar50 = 0;
                  iVar55 = -uVar28;
                  do {
                     ...
                     do {
                        while (true) {
                           ...
                           piVar21 = (int*)( *(long*)( piVar21 + 2 ) + ( ulong )(*piVar21 * uVar50 + uVar15) * 0x14 );
                           iVar18 = *piVar21;
                           if (iVar18 != 0) break;
                           *(undefined1*)( (long)local_250 + ( ulong )(iVar53 + -1 + uVar15) ) = 1;
                           LAB_001042d9:if (iVar6 == 3) {
                              LAB_001058e0:if ((char)piVar21[4] != '\0') {
...
;
                     ...
                     do {
                        ...
                        if (( ( uVar50 | uVar59 ) & 1 ) == 0) {
                           ...
                           if (( uVar28 <= uVar59 ) || ( uVar39 <= uVar16 )) {
                              ...
                              LAB_00105eb3:uVar29 = uVar29 | 0xc0;
                           }
 else {
                              uVar29 = *(int*)( lVar68 + ( ulong )(iVar32 + uVar59) * 0x14 ) << 4 | uVar29;
                              if (!bVar49) goto LAB_00105eb3;
                              LAB_00105cdc:if (uVar39 <= uVar16) goto LAB_00105eb3;
                              ...
                              if (0 < iVar55) {
                                 if (iVar55 < 4) {
                                    ...
                                    do {
                                       ...
                                       vector<unsigned_int>::push_back((vector<unsigned_int>*)( local_188 + lVar67 * 2 ), (uint*)&local_88);
                                    }
 while ( iVar18 != iVar55 );
                                 }
 else {
                                    local_198[0x100] = local_198[0x100] + 1;
                                    vector<unsigned_int>::push_back((vector<unsigned_int>*)( local_188 + lVar67 * 2 ), &basist::ENDPOINT_PRED_REPEAT_LAST_SYMBOL);
                              ...
                              if (*(uint*)( (long)plVar57 + 0xc ) <= uVar15) {
                                 basisu::elemental_vector::increase_capacity((uint)plVar57, (bool)( (char)uVar15 + '\x01' ), 1, (_func_void_void_ptr_void_ptr_uint*)0x4, false);
                                 uVar15 = *(uint*)( plVar57 + 1 );
                              }
                        ...
                        if (*puVar23 == 3) {
                           ...
                           if (*(float*)( this + 0xc ) <= _LC24) {
                              LAB_00105a06:uVar69 = (ulong)uVar17;
                              ...
                              if (( (int)uVar44 < 2 ) || ( *(char*)( (long)local_250 + ( ulong )(local_260 + uVar59) ) != '\0' )) goto LAB_00105a06;
                              bVar49 = (bool)( (char)*(undefined8*)( pvVar8 + 0x58 ) + (char)uVar64 * '@' );
                              local_60 = *(ulong*)( *(long*)( pvVar8 + 0x68 ) + uVar51 * 8 );
                              uVar69 = basisu::etc_block::evaluate_etc1_error((color_rgba*)&local_60, bVar49, (uint)(byte)pvVar8[0x1c]);
                              ...
                              do {
                                 ...
                                 if (( -1 < iVar54 ) && ( iVar62 = iVar54 < iVar61 )) {
                                    iVar62 = iVar54;
                                 }

                                 if (( iVar62 != iVar18 ) && ( *(char*)( *(long*)( this + 0x110 ) + (long)iVar62 ) != '\0' )) {
                                    pcVar2 = (color_rgba*)( *(long*)( this + 0xa0 ) + ( ulong ) * (uint*)( lVar65 + (long)iVar62 * 4 ) * 0xc );
                                    if (*(uint*)( this + 0x14 ) < 2) {
                                       ...
                                       LAB_0010619d:local_58 = local_58 | 0x2000000;
                                       iVar61 = basisu::etc_block::pack_color5(pcVar2, false, 0x7f);
                                       local_58._0_3_ = CONCAT12(( byte )(iVar61 << 3) | local_58._2_1_ & 7, CONCAT11((char)( (ushort)iVar61 >> 5 ) << 3, ( ( byte )((uint)iVar61 >> 8) >> 2 ) << 3) | _LC10 & (ushort)local_58);
                                       uVar14 = basisu::etc_block::pack_delta3(0, 0, 0);
                                       uVar9 = local_58;
                                       local_58._0_2_ = CONCAT11(local_58._1_1_ & 0xf8 | ( byte )(uVar14 >> 3) & 7, (byte)local_58._0_1_ & 0xf8 | ( byte )(uVar14 >> 6) & 7);
                                       local_58._2_1_ = SUB81(uVar9, 2);
                                       local_58._0_3_ = CONCAT12((byte)uVar14 & 7 | local_58._2_1_ & 0xf8, (ushort)local_58);
                                       local_58._3_1_ = SUB81(uVar9, 3);
                                       bVar27 = local_58._3_1_ & 3;
                                       local_58._4_4_ = SUB84(uVar9, 4);
                                       local_58._0_4_ = CONCAT13(bVar27 | ( byte )(*(int*)( pcVar2 + 4 ) << 5) | ( byte )(*(int*)( pcVar2 + 4 ) << 2), (undefined3)local_58);
                                       uVar60 = basisu::etc_block::evaluate_etc1_error((color_rgba*)&local_58, bVar49, (uint)(byte)pvVar8[0x1c]);
                                       lVar65 = *(long*)( this + 0xf0 );
 ...
 while ( iVar54 != iVar38 + local_2f8 );
                           ...
                           if (local_170._4_4_ <= (uint)local_170) {
                              LAB_00105a4f:basisu::elemental_vector::increase_capacity(( uint ) & local_178, (bool)( (char)(uint)local_170 + '\x01' ), 1, (_func_void_void_ptr_void_ptr_uint*)0x4, false);
                              uVar69 = local_170 & 0xffffffff;
                           }
                        ...
                        *(uint*)( (long)local_178 + uVar69 * 4 ) = *puVar46;
                        ...
                        if (( iVar6 != 3 ) || ( *puVar23 != 2 )) {
                           ...
                           if (cVar70 == '\0') {
                              ...
                              LAB_001044e1:lVar65 = uVar51 * 0x40 + *(long*)( pvVar8 + 0x58 );
                              uVar9 = *(undefined8*)( *(long*)( pvVar8 + 0x68 ) + uVar51 * 8 );
                              pcVar2 = (color_rgba*)( *(long*)( this + 0xa0 ) + ( ulong ) * (uint*)( *(long*)( this + 0xf0 ) + lVar68 ) * 0xc );
                              ...
                              iVar18 = *(int*)( pcVar2 + 4 );
                              local_60 = CONCAT44(local_60._4_4_, ( ( ( ( bVar27 & 1 | iVar18 << 5 | iVar18 << 2 ) & 0xff | 2 ) << 8 | ( uVar64 & 0x1f ) << 3 | uVar17 & 7 ) << 8 | ( uint )(byte)((char)( (ushort)uVar64 >> 5 ) << 3 | ( byte )((ushort)uVar17 >> 3) & 7) ) << 8 | ( ( ushort )((ushort)uVar64 >> 10) & 0x1f ) << 3 | ( ushort )((ushort)uVar17 >> 6) & 7);
                              ...
                              if (pvVar8[0x1c] == (vector)0x0) {
                                 ...
                                 do {
                                    ...
                                    iVar18 = ( uint ) * (byte*)( lVar65 + lVar68 * 4 ) - ( uint )(byte)((color_rgba*)&local_58)[lVar22];
                                    iVar38 = ( uint ) * (byte*)( lVar65 + 1 + lVar68 * 4 ) - ( uint ) * (byte*)( (long)&local_58 + lVar22 + 1 );
                                    lVar34 = lVar68 * 4;
                                    lVar68 = lVar68 + 1;
                                    iVar32 = ( uint ) * (byte*)( lVar65 + 2 + lVar34 ) - ( uint ) * (byte*)( (long)&local_58 + lVar22 + 2 );
                                    uVar51 = uVar51 + (long)( iVar18 * iVar18 + iVar38 * iVar38 + iVar32 * iVar32 );
                                 }
 while ( lVar68 != 0x10 );
                                 if ((long)uVar51 < 0) goto LAB_00106487;
                                 LAB_00104743:fVar74 = (float)(long)uVar51;
                              }
 else {
                                 lVar68 = 0;
                                 uVar51 = 0;
                                 do {
                                    ...
                                    iVar18 = ( uint ) * (byte*)( lVar65 + lVar68 * 4 ) - ( uint ) * (byte*)( (long)&local_58 + uVar69 * 4 );
                                    iVar32 = ( uint ) * (byte*)( lVar65 + 2 + lVar68 * 4 ) - ( uint ) * (byte*)( (long)&local_58 + uVar69 * 4 + 2 );
                                    lVar22 = lVar68 * 4;
                                    lVar68 = lVar68 + 1;
                                    lVar34 = (long)(int)( ( ( uint ) * (byte*)( lVar65 + 1 + lVar22 ) - ( uint ) * (byte*)( (long)&local_58 + uVar69 * 4 + 1 ) ) * 0x5c + iVar18 * 0x1b + iVar32 * 9 );
                                    lVar22 = iVar18 * 0x80 - lVar34;
                                    lVar58 = iVar32 * 0x80 - lVar34;
                                    uVar51 = uVar51 + ( ( ( uint )((int)( lVar22 * lVar22 >> 7 ) * 0x1a) >> 7 ) + ( ( uint )((int)( lVar58 * lVar58 >> 7 ) * 3) >> 7 ) + (int)( lVar34 * lVar34 >> 7 ) );
                                 }
 while ( lVar68 != 0x10 );
                                 if (-1 < (long)uVar51) goto LAB_00104743;
                                 LAB_00106487:fVar74 = (float)uVar51;
                              }

                              fVar71 = fVar71 * fVar74;
                              if ((float)( (uint)fVar71 & _LC28 ) < _LC27) {
                                 fVar71 = (float)( ( uint )((float)(int)fVar71 + (float)( -(uint)((float)(int)fVar71 < fVar71) & (uint)_LC24 )) | ~_LC28 & (uint)fVar71 );
                              }
                              ...
                              if ((uint)local_140 != 0) {
                                 ...
                                 do {
                                    ...
                                    pbVar56 = (byte*)( ( ulong ) * (uint*)( lVar68 + (long)(int)uVar44 * 4 ) * 0x10 + *(long*)( this + 0xb0 ) );
                                    if (*(uint*)( this + 0x14 ) < 2) {
                                       iVar18 = 0;
                                       pbVar31 = pbVar56;
                                       pbVar37 = pbVar3;
 ...
 while ( pbVar37 != pbVar3 + 0x10 );
                                    ...
                                    if (pvVar8[0x1c] == (vector)0x0) {
                                       do {
                                          ...
                                          iVar38 = ( uint ) * (byte*)( lVar65 + lVar22 * 4 ) - ( uint )(byte)((color_rgba*)&local_58)[lVar34];
                                          iVar32 = ( uint ) * (byte*)( lVar65 + 1 + lVar22 * 4 ) - ( uint ) * (byte*)( (long)&local_58 + lVar34 + 1 );
                                          iVar18 = ( uint ) * (byte*)( lVar65 + 2 + lVar22 * 4 ) - ( uint ) * (byte*)( (long)&local_58 + lVar34 + 2 );
                                          uVar52 = uVar52 + (long)( iVar32 * iVar32 + iVar38 * iVar38 + iVar18 * iVar18 );
 ...
 while ( lVar22 != 0x10 );
                                       ...
                                       do {
                                          ...
                                          iVar32 = ( uint ) * (byte*)( lVar65 + lVar22 * 4 ) - ( uint ) * (byte*)( (long)&local_58 + uVar40 * 4 );
                                          iVar18 = ( uint ) * (byte*)( lVar65 + 2 + lVar22 * 4 ) - ( uint ) * (byte*)( (long)&local_58 + uVar40 * 4 + 2 );
                                          lVar41 = (long)(int)( iVar32 * 0x1b + ( ( uint ) * (byte*)( lVar65 + 1 + lVar22 * 4 ) - ( uint ) * (byte*)( (long)&local_58 + uVar40 * 4 + 1 ) ) * 0x5c + iVar18 * 9 );
                                          lVar58 = iVar32 * 0x80 - lVar41;
                                          lVar34 = iVar18 * 0x80 - lVar41;
                                          uVar52 = uVar52 + ( ( ( uint )((int)( lVar34 * lVar34 >> 7 ) * 3) >> 7 ) + ( ( uint )((int)( lVar58 * lVar58 >> 7 ) * 0x1a) >> 7 ) + (int)( lVar41 * lVar41 >> 7 ) );
                                          if (uVar43 < uVar52) goto LAB_00104977;
                                          lVar22 = lVar22 + 1;
                                       }
 while ( lVar22 != 0x10 );
 ...
 while ( (uint)uVar69 < (uint)local_140 );
                           ...
                           LAB_001049e8:puVar23[2] = *(uint*)( lVar68 + (long)(int)uVar59 * 4 );
                           uVar64 = (uint)uVar51;
                           if (( iVar53 == 0 ) || ( cVar70 == '\0' )) {
                              LAB_0010597c:if ((int)uVar64 < 0) goto LAB_00105b13;
                              ...
                              if (iVar53 < 3) {
                                 ...
                                 if (0 < iVar53) {
                                    ...
                                    if (*(uint*)( (long)plVar57 + 0xc ) <= *(uint*)( plVar57 + 1 )) goto LAB_00105bf0;
                                    while (true) {
                                       iVar18 = iVar18 + 1;
                                       ...
                                       *(int*)( plVar57 + 1 ) = (int)plVar57[1] + 1;
                                       ...
                                       if (*(uint*)( (long)plVar57 + 0xc ) <= *(uint*)( plVar57 + 1 )) {
                                          LAB_00105bf0:basisu::elemental_vector::increase_capacity((uint)plVar57, (bool)( (char)uVar69 + '\x01' ), 1, (_func_void_void_ptr_void_ptr_uint*)0x4, false);
                                          uVar69 = ( ulong ) * (uint*)( plVar57 + 1 );
                                       }
...
;
                                 ...
                                 if (*(uint*)( (long)plVar57 + 0xc ) <= uVar17) {
                                    basisu::elemental_vector::increase_capacity((uint)plVar57, (bool)( (char)uVar17 + '\x01' ), 1, (_func_void_void_ptr_void_ptr_uint*)0x4, false);
                                    uVar17 = *(uint*)( plVar57 + 1 );
                                 }
                              ...
                              if ((int)uVar64 < 0) {
                                 iVar53 = 0;
                                 LAB_00105b13:plVar57 = local_1b8 + lVar67 * 2;
                                 uVar17 = *(uint*)( plVar57 + 1 );
                                 if (*(uint*)( (long)plVar57 + 0xc ) <= uVar17) {
                                    basisu::elemental_vector::increase_capacity((uint)plVar57, (bool)( (char)uVar17 + '\x01' ), 1, (_func_void_void_ptr_void_ptr_uint*)0x4, false);
                                    uVar17 = *(uint*)( plVar57 + 1 );
                                 ...
                                 *(uint*)( (long)local_148 + uVar51 * 4 ) = uVar59;
                                 ...
                                 LAB_00104aa8:plVar57 = local_1b8 + lVar67 * 2;
                                 uVar59 = *(uint*)( plVar57 + 1 );
                                 if (*(uint*)( (long)plVar57 + 0xc ) <= uVar59) {
                                    basisu::elemental_vector::increase_capacity((uint)plVar57, (bool)( (char)uVar59 + '\x01' ), 1, (_func_void_void_ptr_void_ptr_uint*)0x4, false);
                                    uVar59 = *(uint*)( plVar57 + 1 );
                                 }
                        ...
                        if (local_160._4_4_ <= (uint)local_160) {
                           basisu::elemental_vector::increase_capacity(( uint ) & local_168, (bool)( (char)local_160 + '\x01' ), 1, (_func_void_void_ptr_void_ptr_uint*)0x4, false);
                        }
                  ...
                  if (iVar53 < 3) {
                     ...
                     if (0 < iVar53) {
                        do {
                           ...
                           vector<unsigned_int>::push_back((vector<unsigned_int>*)( local_1b8 + lVar67 * 2 ), (uint*)&local_88);
                           local_1d8[local_2e4] = local_1d8[local_2e4] + 1;
                        }
 while ( iVar45 != iVar53 );
                     }
                     ...
                     vector<unsigned_int>::push_back((vector<unsigned_int>*)( local_1b8 + lVar67 * 2 ), &local_1ec);
            ...
            basisu::elemental_vector::increase_capacity(( uint ) & local_88, SUB41(iVar55, 0), ( uint )(iVar55 == 1), (_func_void_void_ptr_void_ptr_uint*)0x1, false);
            memset((void*)( (ulong)(uint)local_80._0_4_ + (long)local_88 ), 0, ( ulong )(uint)(iVar55 - local_80._0_4_));
            local_250 = local_88;
            if (uVar39 != 0) goto LAB_00104284;
            LAB_00104c66:if (local_250 != (void*)0x0) {
               free(local_250);
            }
 ...
 while ( piVar21 != piVar24 );
   ...
   basisu::debug_printf("Endpoint pred RDO total endpoint indices remapped: %u %3.2f%%\n", (double)( ( (float)local_214 * _LC30 ) / fVar71 ), (ulong)local_214);
   if (*(uint*)( this + 0x28 ) == 0) {
      fVar71 = 0.0;
   }
 else {
 ...
 while ( piVar21 != piVar24 );
   ...
   basisu::debug_printf("Selector history RDO total selector indices remapped: %u %3.2f%%, Used history buf: %u %3.2f%%\n", (double)( ( (float)local_218 * _LC30 ) / fVar71 ), (double)( ( (float)local_25c * _LC30 ) / fVar71 ), (ulong)local_218, (ulong)local_25c);
   if (( ( local_214 != 0 ) && ( 1 < *(uint*)( this + 0x14 ) ) ) && ( this[0x18] == (basisu_backend)0x0 )) {
      local_88 = (void*)0x0;
      auVar12._8_8_ = 0;
      auVar12._0_8_ = local_80._8_8_;
      local_80 = auVar12 << 0x40;
      basisu::basisu_frontend::reoptimize_remapped_endpoints(pvVar8, (vector*)&local_178, SUB81(&local_88, 0), (vector*)0x0);
      create_endpoint_palette(this);
      if (local_88 != (void*)0x0) {
         free(local_88);
      }
...
;
 ...
 while ( puVar23 != puVar46 );
   ...
   if ((int)local_1a0 == 0) {
      dVar72 = 0.0;
      dVar77 = 0.0;
      LAB_00104fdf:dVar77 = dVar77 / dVar72;
      if ((uint)local_1d0 != 0) goto LAB_00104ff2;
      LAB_0010671a:dVar73 = 0.0;
      dVar72 = dVar73;
   }
 else {
...
;
 ...
 while ( puVar23 != puVar46 );
      ...
      LAB_00104ff2:puVar46 = local_1d8;
...
;
 ...
 while ( puVar46 != puVar23 );
   ...
   basisu::debug_printf("Histogram entropy: EndpointPred: %3.3f DeltaEndpoint: %3.3f DeltaSelector: %3.3f\n", dVar75 / dVar76, dVar77, dVar72 / dVar73);
   if ((int)local_190 == 0) {
      LAB_00106685:*local_198 = *local_198 + 1;
   }
 else {
      lVar67 = 0;
      puVar23 = local_198;
 ...
 while ( puVar23 != local_198 + ( local_190 & 0xffffffff ) );
   ...
   local_f8 = (void*)0x0;
   local_f0 = 0;
   uVar28 = basisu::huffman_encoding_table::init(( uint ) & local_108, (uint*)( local_190 & 0xffffffff ), (uint)local_198);
   uVar51 = (ulong)uVar28;
   if ((char)uVar28 == '\0') {
   ...
   if ((int)local_1a0 == 0) {
      LAB_00106694:*local_1a8 = *local_1a8 + 1;
   }
 else {
      lVar67 = 0;
      puVar23 = local_1a8;
 ...
 while ( puVar23 != local_1a8 + ( local_1a0 & 0xffffffff ) );
   ...
   local_d8 = (void*)0x0;
   local_d0 = 0;
   uVar28 = basisu::huffman_encoding_table::init(( uint ) & local_e8, (uint*)( local_1a0 & 0xffffffff ), (uint)local_1a8);
   uVar51 = (ulong)uVar28;
   if ((char)uVar28 == '\0') {
      ...
      if ((uint)local_1d0 == 0) {
         LAB_001066a3:*local_1d8 = *local_1d8 + 1;
      }
 else {
         lVar67 = 0;
         puVar23 = local_1d8;
 ...
 while ( puVar23 != local_1d8 + ( local_1d0 & 0xffffffff ) );
      ...
      local_b8 = (void*)0x0;
      local_b0 = 0;
      uVar28 = basisu::huffman_encoding_table::init(( uint ) & local_c8, (uint*)( local_1d0 & 0xffffffff ), (uint)local_1d8);
      uVar51 = (ulong)uVar28;
      if ((char)uVar28 == '\0') {
         ...
         if ((int)local_1c0 == 0) {
            LAB_00106962:*local_1c8 = *local_1c8 + 1;
         }
 else {
            lVar67 = 0;
            puVar23 = local_1c8;
 ...
 while ( puVar23 != local_1c8 + ( local_1c0 & 0xffffffff ) );
         ...
         local_98 = 0;
         local_90 = 0;
         uVar28 = basisu::huffman_encoding_table::init((uint)this_00, (uint*)( local_1c0 & 0xffffffff ), (uint)local_1c8);
         uVar51 = (ulong)uVar28;
         if ((char)uVar28 == '\0') {
 ...
 while ( piVar24 != piVar30 );
            ...
            while (true) {
               ...
               basisu::debug_printf("Model sizes: EndpointPred: %u bits %u bytes (%3.3f bpp) DeltaEndpoint: %u bits %u bytes (%3.3f bpp) Selector: %u bits %u bytes (%3.3f bpp) SelectorHistBufRLE: %u bits %u bytes (%3.3f bpp)\n", (double)( (float)( (ulong)pbVar63 & 0xffffffff ) / fVar71 ), (double)( (float)( (ulong)pvVar47 & 0xffffffff ) / fVar71 ), (double)( (float)( (ulong)piVar21 & 0xffffffff ) / fVar71 ), auVar79._0_8_, (ulong)pbVar63 & 0xffffffff, ( ulong )((int)pbVar63 + 7U >> 3), (ulong)pvVar47 & 0xffffffff, ( ulong )((int)pvVar47 + 7U >> 3), (ulong)piVar21 & 0xffffffff, ( ulong )((int)piVar21 + 7U >> 3), this_01, ( ulong )((int)this_01 + 7U >> 3));
               bitwise_coder::flush((bitwise_coder*)&local_88);
               vector<unsigned_char>::operator =((vector<unsigned_char>*)( this + 0x70 ), (vector*)&local_88);
 ...
 while ( puVar33 != puVar25 );
                     ...
                     if (*(uint*)( this + 0x8c ) < uVar39) {
                        basisu::elemental_vector::increase_capacity((int)this + 0x80, SUB41(uVar39, 0), ( uint )(uVar28 + 1 == uVar39), (_func_void_void_ptr_void_ptr_uint*)0x10, false);
                        uVar50 = *(uint*)( this + 0x28 );
               ...
               local_2b0 = 0;
               pvVar47 = this_01;
               LAB_0010556d:auVar13 = local_80._0_12_;
               ...
               if ((uint)local_80._4_4_ < 0x400000) {
                  basisu::elemental_vector::increase_capacity(uVar15, false, 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
                  ...
                  if (local_80._4_4_ != 0x400000) {
                     ...
                     basisu::elemental_vector::increase_capacity((uint)this_01, SUB41(uVar59, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
                  ...
                  do {
                     ...
                     if (uVar39 != 0) {
                        do {
                           ...
                           uVar16 = (uint)this_01;
                           piVar21 = (int*)( *(long*)( piVar21 + 2 ) + ( ulong )(*piVar21 * uVar59 + uVar16) * 0x14 );
                              ...
                              if (iVar55 < 1) {
                                 ...
                                 if (uVar29 == 0x100) {
                                    ...
                                    if (bVar26 != 0) {
                                       ...
                                       uVar60 = ( ulong ) * (ushort*)( (long)local_108 + 0x200 ) << ( bVar27 & 0x3f ) | uVar60;
                                       uVar43 = uVar60;
                                       if (7 < uVar29) {
                                          do {
                                             ...
                                             if (local_80._0_4_ != 0xffffffff) {
                                                if ((uint)local_80._4_4_ < uVar29) {
                                                   basisu::elemental_vector::increase_capacity(uVar15, SUB41(uVar29, 0), 1, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
 ...
 while ( 7 < uVar29 );
                                    ...
                                    do {
                                       ...
                                       uVar60 = ( ulong )(( uint )(uVar17 >> 4 != 0) << 4 | uVar17 & 0xf) << ( (byte)uVar29 & 0x3f ) | uVar60;
                                       while (7 < uVar44) {
...
;
 ...
 while ( uVar44 != 0 );
                                    ...
                                    if (bVar26 != 0) {
                                       ...
                                       uVar60 = ( ulong ) * (ushort*)( (long)local_108 + (ulong)uVar29 * 2 ) << ( bVar27 & 0x3f ) | (ulong)(uint)uVar7;
                                       while (7 < uVar17) {
                                          uVar43 = (ulong)(uint)local_80._0_4_;
                                          uVar29 = local_80._0_4_ + 1;
                                          if (local_80._0_4_ != 0xffffffff) {
...
;
                           ...
                           if (*piVar21 == 3) {
                              ...
                              if (bVar27 != 0) {
                                 ...
                                 local_80._12_4_ = uVar29;
                                 uVar60 = ( ulong ) * (ushort*)( (long)local_e8 + (ulong)uVar64 * 2 ) << ( bVar26 & 0x3f ) | uVar60;
                                 while (7 < uVar29) {
                                    uVar43 = (ulong)(uint)local_80._0_4_;
                                    uVar10 = (undefined1)uVar60;
                                    ...
                                    if (local_80._0_4_ != 0xffffffff) {
                                       ...
                                       if ((uint)local_80._4_4_ < uVar64) {
                                          basisu::elemental_vector::increase_capacity(uVar15, SUB41(uVar64, 0), 1, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
                           ...
                           if (( iVar6 != 3 ) || ( *piVar21 != 2 )) {
                              if (iVar18 == 0) {
                                 ...
                                 if (uVar29 == local_2e8) {
                                    ...
                                    piVar21 = (int*)( ulong ) * (uint*)( local_1b8[(long)pvVar47 * 2] + (ulong)uVar64 * 4 );
                                    if (bVar27 != 0) goto LAB_001057ac;
                                    LAB_00106e81:iVar18 = (int)piVar21;
                                    uVar64 = iVar18 - 3;
                                    uVar7 = local_80._8_4_;
                                    bVar27 = local_80[0xc];
                                    if (0x3e < (int)uVar64) {
...
;
                                       ...
                                       do {
                                          ...
                                          uVar17 = uVar29 + 8;
                                          local_80._12_4_ = uVar17;
                                          uVar60 = ( ulong )(( uint )(uVar44 != 0) << 7 | uVar64 & 0x7f) << ( (byte)uVar29 & 0x3f ) | uVar60;
                                          while (7 < uVar17) {
                                             uVar43 = (ulong)(uint)local_80._0_4_;
                                             uVar10 = (undefined1)uVar60;
                                             uVar64 = local_80._0_4_ + 1;
...
;
 ...
 while ( uVar44 != 0 );
                                    ...
                                    if (bVar26 != 0) {
                                       ...
                                       local_80._12_4_ = uVar29;
                                       uVar60 = ( ulong ) * (ushort*)( local_a8 + (ulong)uVar64 * 2 ) << ( bVar27 & 0x3f ) | (ulong)(uint)uVar7;
                                       while (7 < uVar29) {
                                          uVar43 = (ulong)(uint)local_80._0_4_;
                                          uVar64 = local_80._0_4_ + 1;
                                          if (local_80._0_4_ != 0xffffffff) {
...
;
                                    ...
                                    LAB_001057ac:local_70 = local_70 + bVar27;
                                    uVar60 = (ulong)(uint)local_80._8_4_;
                                    bVar26 = local_80[0xc];
                                    uVar64 = local_80._12_4_ + (uint)bVar27;
                                    local_80._12_4_ = uVar64;
                                    uVar60 = ( ulong ) * (ushort*)( (long)local_c8 + (ulong)uVar29 * 2 ) << ( bVar26 & 0x3f ) | uVar60;
                                    while (7 < uVar64) {
                                       uVar43 = (ulong)(uint)local_80._0_4_;
...
;
                              ...
                              LAB_001069a8:piVar24 = (int*)( ulong )(iVar18 - 1);
                           }

                           joined_r0x001069b5:this_01 = (vector<unsigned_char>*)( ulong )(uVar16 + 1);
                           iVar53 = iVar45;
                        }
 ...
 while ( uVar50 != uVar59 );
               ...
               if (local_2b8 == *(uint*)( local_188 + (long)pvVar47 * 2 + 1 )) {
                  ...
                  if (local_80._12_4_ != 0) {
                     ...
                     vector<unsigned_char>::resize((vector<unsigned_char>*)&local_88, ( ulong )(local_80._0_4_ + 1), false);
                     *(char*)( (long)local_88 + ( ulong )(local_80._0_4_ - 1) ) = auVar11[8];
                     local_80._8_8_ = 0;
                  }

                  pvVar48 = pvVar47 + 1;
                  vector<unsigned_char>::operator =((vector<unsigned_char>*)( *(long*)( this + 0x80 ) + lVar67 ), (vector*)&local_88);
                  fVar71 = _LC17;
                  uVar60 = ( ulong ) * (uint*)( *(long*)( this + 0x80 ) + 8 + lVar67 );
                  uVar28 = uVar28 + local_80._0_4_;
                  basisu::debug_printf("Slice %u compressed size: %u bytes, %3.3f bits per slice texel\n", (double)( ( (float)uVar60 * _LC17 ) / (float)( uint )(*(int*)( uVar51 + *(long*)( this + 0x20 ) + 4 ) * *(int*)( uVar51 + *(long*)( this + 0x20 ) + 8 )) ), (ulong)pvVar47 & 0xffffffff, uVar60);
                  uVar15 = *(uint*)( this + 0x28 );
                  pvVar47 = pvVar48;
 ...
 while ( piVar21 != piVar24 );
               ...
               LAB_001078e9:verify(true, (int)lVar67);
               pbVar63 = this;
               LAB_001078f8:fVar71 = 0.0;
               phVar66 = this_00;
               uVar69 = uVar51;
            }
;
            ...
            local_2f8 = 0;
            fVar71 = _LC17;
            LAB_001078d0:dVar75 = 0.0;
            local_320 = 0.0;
            LAB_00106b69:basisu::debug_printf("Total endpoint pred bits: %u bytes: %u bits/texel: %3.3f bits/block: %3.3f\n", dVar76 / local_320, dVar76 / dVar75, local_2b0, uVar51);
            dVar76 = (double)local_260;
            basisu::debug_printf("Total delta endpoint bits: %u bytes: %u bits/texel: %3.3f bits/block: %3.3f\n", dVar76 / local_320, dVar76 / dVar75, (ulong)local_260, (ulong)uVar50);
            dVar76 = (double)local_2f8;
            basisu::debug_printf("Total selector bits: %u bytes: %u bits/texel: %3.3f bits/block: %3.3f\n", dVar76 / local_320, dVar76 / dVar75, (ulong)local_2f8, (ulong)uVar39);
            basisu::debug_printf("Total table bytes: %u, %3.3f bits/texel\n", (double)( (float)*(uint*)( this + 0x78 ) * fVar71 ) / local_320, ( ulong ) * (uint*)( this + 0x78 ));
            basisu::debug_printf("Total image bytes: %u, %3.3f bits/texel\n", (double)( (float)uVar28 * fVar71 ) / local_320, (ulong)uVar28);
            this_00 = phVar66;
            uVar51 = uVar69;
            if (local_88 != (void*)0x0) {
               free(local_88);
   ...
   LAB_001067ae:if (local_f8 != (void*)0x0) {
      free(local_f8);
   }
...
/* basisu::basisu_backend::sort_selector_codebook() */void basisu::basisu_backend::sort_selector_codebook(basisu_backend *this) {
   int iVar1;
   long lVar2;
   uint uVar3;
   long lVar4;
      ...
      if (uVar7 < uVar3) {
         *(uint*)( this + 0x138 ) = uVar7;
         ...
         if (*(uint*)( this + 0x13c ) < uVar7) {
            basisu::elemental_vector::increase_capacity((int)this + 0x130, SUB41(uVar7, 0), ( uint )(uVar3 + 1 == uVar7), (_func_void_void_ptr_void_ptr_uint*)0x4, false);
            uVar3 = *(uint*)( this + 0x138 );
         }
      ...
      if (1 < *(uint*)( lVar2 + 0x128 )) {
         ...
         do {
            if (local_60._4_4_ <= uVar3) {
               basisu::elemental_vector::increase_capacity(uVar7, (bool)( (char)uVar3 + '\x01' ), 1, (_func_void_void_ptr_void_ptr_uint*)0x4, false);
               uVar3 = (uint)local_60;
            }
 ...
 while ( uVar8 < *(uint*)( lVar2 + 0x128 ) );
      ...
      if (iVar1 == 0) {
         ...
         basisu::elemental_vector::increase_capacity(( uint ) & local_58, SUB41(iVar1, 0), ( uint )(iVar1 == 1), (_func_void_void_ptr_void_ptr_uint*)0x4, false);
         memset((void*)( (long)local_58 + ( local_50 & 0xffffffff ) * 4 ), 0, ( ulong )(uint)(iVar1 - (int)local_50) << 2);
         local_50 = CONCAT44(local_50._4_4_, iVar1);
         if (*(int*)( this + 0xb8 ) == 0) {
            if (1 < *(uint*)( lVar2 + 0x128 )) goto LAB_00107c88;
            LAB_00107dd5:if (local_58 == (void*)0x0) goto LAB_00107de4;
         }
 else {
            lVar9 = 0;
            pbVar5 = *(byte**)( this + 0xb0 );
            do {
               *(uint*)( (long)local_58 + lVar9 * 4 ) = ( (uint)pbVar5[9] << 2 | (uint)pbVar5[10] << 4 | (uint)pbVar5[8] | (uint)pbVar5[0xb] << 6 ) << 0x10 | ( (uint)pbVar5[5] << 2 | (uint)pbVar5[6] << 4 | (uint)pbVar5[4] | (uint)pbVar5[7] << 6 ) << 8 | (uint)pbVar5[1] << 2 | (uint)pbVar5[2] << 4 | ( uint ) * pbVar5 | (uint)pbVar5[3] << 6 | ( (uint)pbVar5[0xe] << 4 | (uint)pbVar5[0xd] << 2 | (uint)pbVar5[0xc] | (uint)pbVar5[0xf] << 6 ) << 0x18;
               lVar9 = lVar9 + 1;
               pbVar5 = pbVar5 + 0x10;
            }
 while ( (uint)lVar9 < *(uint*)( this + 0xb8 ) );
            if (1 < *(uint*)( lVar2 + 0x128 )) {
               LAB_00107c88:lVar9 = 0;
               uVar14 = 0;
               uVar3 = (uint)local_60;
               do {
                  uVar8 = *local_68;
                  ...
                  if (uVar3 != 0) {
                     ...
                     do {
                        uVar8 = *puVar10;
                        uVar11 = *(uint*)( (long)local_58 + (long)(int)uVar8 * 4 ) ^ *(uint*)( (long)local_58 + uVar14 * 4 );
                        uVar11 = ( uint ) * (byte*)( (long)&g_hamming_dist + ( ulong )(uVar11 >> 8 & 0xff) ) + ( uint ) * (byte*)( (long)&g_hamming_dist + ( ulong )(uVar11 & 0xff) ) + ( uint ) * (byte*)( (long)&g_hamming_dist + ( ulong )(uVar11 >> 0x10 & 0xff) ) + ( uint ) * (byte*)( (long)&g_hamming_dist + ( ulong )(uVar11 >> 0x18) );
                        if (( uVar11 < uVar13 ) && ( uVar6 = uVar12 ),uVar13 = uVar11,uVar11 < 2) goto LAB_00107d37;
                        uVar8 = (int)uVar12 + 1;
                        uVar12 = (ulong)uVar8;
                        puVar10 = puVar10 + 1;
                     }
 while ( uVar8 != uVar3 );
                  ...
                  LAB_00107d37:uVar14 = (ulong)uVar8;
                  lVar9 = lVar9 + 1;
                  ...
                  *puVar10 = local_68[(uint)local_60 - 1];
                  ...
                  if ((uint)local_60 == 0) {
                     if (local_60._4_4_ != -1) {
                        basisu::elemental_vector::increase_capacity(uVar7, true, 0, (_func_void_void_ptr_void_ptr_uint*)0x4, false);
 ...
 while ( (int)lVar9 + 1U < *(uint*)( lVar2 + 0x128 ) );
      ...
      LAB_00107de4:if (local_68 != (uint*)0x0) {
         free(local_68);
      }

      uVar7 = *(uint*)( lVar2 + 0x128 );
      LAB_00107992:uVar3 = *(uint*)( this + 0x128 );
      if (uVar3 == uVar7) goto LAB_001079f1;
      if (uVar3 <= uVar7) {
         if (*(uint*)( this + 300 ) < uVar7) {
            basisu::elemental_vector::increase_capacity((int)this + 0x120, SUB41(uVar7, 0), ( uint )(uVar3 + 1 == uVar7), (_func_void_void_ptr_void_ptr_uint*)0x4, false);
   ...
   *(uint*)( this + 0x128 ) = uVar7;
   LAB_001079f1:if (*(int*)( this + 0x138 ) != 0) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* basisu::basisu_backend::create_encoder_blocks() */void basisu::basisu_backend::create_encoder_blocks(basisu_backend *this) {
   int *piVar1;
   undefined4 *puVar2;
   undefined8 *puVar3;
   uint *puVar4;
 ...
 while ( lVar28 != lVar35 );
         ...
         if (*(uint*)( this + 0xdc ) < uVar37) {
            basisu::elemental_vector::increase_capacity((int)this + 0xd0, SUB41(uVar37, 0), ( uint )(uVar24 + 1 == uVar37), (_func_void_void_ptr_void_ptr_uint*)0x18, true);
            uVar24 = *(uint*)( this + 0xd8 );
            uVar23 = *(uint*)( this + 0x28 );
         }
         ...
         do {
            ...
            if (( uVar23 != uVar9 ) || ( puVar17[1] != uVar10 )) {
               ...
               if (uVar29 == 0) {
                  ...
                  basisu::elemental_vector::increase_capacity(( uint ) & local_c8, SUB41(uVar29, 0), ( uint )(uVar29 == 1), (_func_void_void_ptr_void_ptr_uint*)0x14, false);
                     ...
                     LAB_00108259:do {
                        ...
                        *puVar17 = 3;
                        ...
                        do {
                           uVar14 = (uint)lVar19;
                           if (( uVar14 == 2 ) && ( iVar6 == 3 )) {
                              if (( cVar5 != '\x01' ) && ( ( ( local_14c != -1 && ( piVar16 = (int*)( lVar28 + (long)local_14c * 0x18 ) ),lVar28 = *(long*)( piVar16 + 2 ) + ( ulong )(*piVar16 * uVar37 + uVar24) * 0x14,*(uint*)( lVar28 + 4 ) == uVar23 ) ) && ( *(uint*)( lVar28 + 8 ) == uVar29 ) )) {
                           ...
                           if (( ( ( -1 < iVar32 ) && ( iVar32 < (int)uVar9 ) ) && ( ( iVar25 = (int)(char)( &DAT_00109af5 )[lVar19 * 2] + uVar37 ),-1 < iVar25 && ( ( iVar25 < (int)uVar10 && ( uVar23 == *(uint*)( lVar22 + 4 + ( ulong )(uint)(iVar32 + iVar25 * iVar30) * 0x14 ) ) ) ) ) )) {
                              uVar13 = uVar14;
                           }
 ...
 while ( lVar19 != 3 );
                        if (uVar13 == 0xffffffff) {
                           if (0.0 < *(float*)( this + 0xc )) {
                              ...
                              uVar21 = basisu::etc_block::evaluate_etc1_error((color_rgba*)&local_98, SUB81(pbVar20, 0), ( uint ) * (byte*)( lVar7 + 0x1c ));
                              if (uVar21 != 0) {
                                 fVar38 = (float)uVar21;
                                 if (_LC24 <= *(float*)( this + 0xc )) {
                                 ...
                                 do {
                                    ...
                                    uVar21 = local_110;
                                    uVar14 = local_f8;
                                    if (( -1 < iVar30 ) && ( ( ( iVar30 < (int)uVar9 && ( iVar32 = -1 < iVar32 ) ) && ( iVar32 < (int)uVar10 ) ) )) {
                                       uVar36 = *(uint*)( *(long*)( (int*)( lVar35 + *(long*)( this + 0xd0 ) ) + 2 ) + ( ulong )(uint)(iVar30 + iVar32 * *(int*)( lVar35 + *(long*)( this + 0xd0 ) )) * 0x14 + 4 );
                                       puVar18 = (undefined4*)( *(long*)( lVar7 + 0x100 ) + (ulong)uVar36 * 0x38 );
                                       iVar30 = puVar18[2];
                                       local_9c = *puVar18;
                                       local_90 = local_90 | 0x2000000;
                                       iVar32 = basisu::etc_block::pack_color5((color_rgba*)&local_9c, false, 0x7f);
                                       local_90._0_3_ = CONCAT12(( byte )(iVar32 << 3) | local_90._2_1_ & 7, CONCAT11((char)( (ushort)iVar32 >> 5 ) << 3, ( ( byte )((uint)iVar32 >> 8) >> 2 ) << 3) | _LC10 & (ushort)local_90);
                                       uVar12 = basisu::etc_block::pack_delta3(0, 0, 0);
                                       uVar11 = local_90;
                                       local_90._0_2_ = CONCAT11(local_90._1_1_ & 0xf8 | ( byte )(uVar12 >> 3) & 7, (byte)local_90._0_1_ & 0xf8 | ( byte )(uVar12 >> 6) & 7);
                                       local_90._2_1_ = SUB81(uVar11, 2);
                                       local_90._0_3_ = CONCAT12((byte)uVar12 & 7 | local_90._2_1_ & 0xf8, (ushort)local_90);
                                       local_90._3_1_ = SUB81(uVar11, 3);
                                       bVar8 = local_90._3_1_ & 3;
                                       pcVar33 = local_88;
                                       local_90._4_4_ = SUB84(uVar11, 4);
                                       local_90._0_4_ = CONCAT13(bVar8 | ( byte )(iVar30 << 5) | ( byte )(iVar30 << 2), (undefined3)local_90);
                                       basisu::unpack_etc1((etc_block*)&local_90, pcVar33, false);
                                       if (*(char*)( lVar7 + 0x1c ) == '\0') {
                                          uVar31 = 0;
                                          pbVar34 = pbVar20;
                                          do {
                                             uVar31 = uVar31 + (long)(int)( ( ( uint ) * pbVar34 - ( uint )(byte) * pcVar33 ) * ( ( uint ) * pbVar34 - ( uint )(byte) * pcVar33 ) + ( (uint)pbVar34[1] - (uint)(byte)pcVar33[1] ) * ( (uint)pbVar34[1] - (uint)(byte)pcVar33[1] ) + ( (uint)pbVar34[2] - (uint)(byte)pcVar33[2] ) * ( (uint)pbVar34[2] - (uint)(byte)pcVar33[2] ) );
 ...
 while ( pcVar33 != local_48 );
                                          ...
                                          pbVar34 = pbVar20;
                                          do {
                                             lVar19 = (long)(int)( ( (uint)pbVar34[1] - (uint)(byte)pcVar33[1] ) * 0x5c + ( ( uint ) * pbVar34 - ( uint )(byte) * pcVar33 ) * 0x1b + ( (uint)pbVar34[2] - (uint)(byte)pcVar33[2] ) * 9 );
                                             lVar27 = (int)( ( ( uint ) * pbVar34 - ( uint )(byte) * pcVar33 ) * 0x80 ) - lVar19;
                                             lVar22 = (int)( ( (uint)pbVar34[2] - (uint)(byte)pcVar33[2] ) * 0x80 ) - lVar19;
                                             uVar31 = uVar31 + ( ( ( uint )((int)( lVar27 * lVar27 >> 7 ) * 0x1a) >> 7 ) + ( ( uint )((int)( lVar22 * lVar22 >> 7 ) * 3) >> 7 ) + (int)( lVar19 * lVar19 >> 7 ) );
                                             if (local_108 < uVar31) goto LAB_001087a0;
                                             pcVar33 = pcVar33 + 4;
                                             pbVar34 = pbVar34 + 4;
                                          }
 while ( pcVar33 != local_48 );
                                       ...
                                       uVar21 = uVar31;
                                       uVar14 = uVar36;
                                       if (( ( local_110 <= uVar31 ) && ( uVar13 = uVar23 ),uVar21 = local_110,uVar14 = local_f8,local_110 == uVar31 )) {
                                          uVar13 = uVar29;
                                          uVar14 = uVar36;
                                       }
 ...
 while ( lVar28 != 3 );
                           ...
                           local_130 = local_130 + 1;
                           *puVar17 = uVar13;
                           LAB_00108343:if (uVar13 != 3) {
                              LAB_00108248:uVar24 = uVar24 + 1;
                           ...
                           if (local_d0._4_4_ <= (uint)local_d0) {
                              LAB_0010840c:basisu::elemental_vector::increase_capacity(( uint ) & local_d8, (bool)( (char)(uint)local_d0 + '\x01' ), 1, (_func_void_void_ptr_void_ptr_uint*)0x4, false);
                              uVar21 = local_d0 & 0xffffffff;
                           }
 ...
 while ( true );
      ...
      basisu::elemental_vector::increase_capacity(( uint ) & local_d8, SUB41(iVar30, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x4, false);
      if (*(int*)( this + 0x28 ) != 0) {
         lVar35 = *(long*)( this + 0x20 );
         goto LAB_00107f81;
      }
   ...
   fVar40 = 0.0;
   local_f4 = 0;
   LAB_00108950:basisu::debug_printf("total_endpoint_pred_missed: %u (%3.2f%%) total_endpoint_pred_hit: %u (%3.2f%%), total_block_endpoints_remapped: %u (%3.2f%%)\n", (double)( fVar38 / fVar41 ), (double)( fVar39 / fVar41 ), (double)( fVar40 / fVar41 ), (ulong)local_12c, (ulong)local_130, (ulong)local_f4);
   ...
   return;
   LAB_001088c9:fVar40 = (float)local_f4 * _LC30;
...
/* basisu::basisu_backend::encode() */uint basisu::basisu_backend::encode(basisu_backend *this) {
   int *piVar1;
   int iVar2;
   char cVar3;
   long lVar4;
   ...
   if (*(uint*)( this + 0x6c ) < *(uint*)( this + 0x28 )) {
      ...
      basisu::elemental_vector::increase_capacity((int)this + 0x60, SUB81(uVar9, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x30, false);
      uVar9 = ( ulong ) * (uint*)( this + 0x28 );
      __ptr = *(void**)( this + 0x60 );
   }
 ...
 while ( piVar10 != piVar5 );
            ...
            basisu::debug_printf("Wrote %u bytes, %3.3f bits/texel\n", (double)( ( (float)uVar8 * _LC17 ) / fVar11 ), (ulong)uVar8);
            return uVar8;
         }
...
/* basisu::vector<basisu::vector2D<basisu::encoder_block> >::object_mover(void*, void*, unsigned
   int) */void basisu::vector<basisu::vector2D<basisu::encoder_block>>::object_mover(void *param_1, void *param_2, uint param_3) {
   uint *puVar1;
   undefined8 *puVar2;
   int iVar3;
   void *__ptr;
      ...
      do {
         while (true) {
            ...
            *(undefined8*)( (long)param_1 + 0x10 ) = 0;
            ...
            LAB_00109579:param_2 = (void*)( (long)param_2 + 0x18 );
...
;
         ...
         *(undefined8*)param_1 = *param_2;
         if ((undefined8*)( (long)param_1 + 8 ) == (undefined8*)( (long)param_2 + 8 )) {
            ...
            LAB_0010956f:if (__ptr != (void*)0x0) {
               free(__ptr);
            }
         ...
         if (iVar3 == 0) {
            LAB_00109568:__ptr = *(void**)( (long)param_2 + 8 );
            *(int*)( (long)param_1 + 0x10 ) = iVar3;
            goto LAB_0010956f;
         }

         basisu::elemental_vector::increase_capacity((uint)(undefined8*)( (long)param_1 + 8 ), SUB41(iVar3, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x14, false);
         if (*(void**)( (long)param_1 + 8 ) == (void*)0x0) {
            LAB_00109565:iVar3 = *(int*)( (long)param_2 + 0x10 );
            goto LAB_00109568;
         }
...
/* basisu::bitwise_coder::init(unsigned int) */void basisu::bitwise_coder::init(bitwise_coder *this, uint param_1) {
   void *__ptr;
   uint uVar1;
   long in_FS_OFFSET;
   void *local_38;
   ...
   if (*(uint*)( this + 0xc ) < param_1) {
      basisu::elemental_vector::increase_capacity((uint)this, SUB41(param_1, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
   }
      ...
      basisu::elemental_vector::increase_capacity(( uint ) & local_38, SUB41(param_1, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
      uVar1 = *(uint*)( this + 8 );
...
/* basisu::huffman_encoding_table::~huffman_encoding_table() */void basisu::huffman_encoding_table::~huffman_encoding_table(huffman_encoding_table *this) {
...
/* basisu::vector<unsigned int>::resize(unsigned long, bool) */void basisu::vector<unsigned_int>::resize(vector<unsigned_int> *this, ulong param_1, bool param_2) {
   uint uVar1;
   uint uVar2;
   if (param_1 >> 0x20 == 0) {
      uVar1 = *(uint*)( this + 8 );
      ...
      if (uVar1 != uVar2) {
         if (uVar1 <= uVar2) {
            if (*(uint*)( this + 0xc ) < uVar2) {
               ...
               basisu::elemental_vector::increase_capacity((uint)this, SUB81(param_1, 0), (uint)param_2, (_func_void_void_ptr_void_ptr_uint*)0x4, false);
               uVar1 = *(uint*)( this + 8 );
            }
...
/* basisu::vector<unsigned int>::push_back(unsigned int const&) */void basisu::vector<unsigned_int>::push_back(vector<unsigned_int> *this, uint *param_1) {
   uint uVar1;
   uVar1 = *(uint*)( this + 8 );
   if (*(uint*)( this + 0xc ) <= uVar1) {
      basisu::elemental_vector::increase_capacity((uint)this, (bool)( (char)uVar1 + '\x01' ), 1, (_func_void_void_ptr_void_ptr_uint*)0x4, false);
      uVar1 = *(uint*)( this + 8 );
   }
...
/* basisu::vector<int>::reserve(unsigned long) */void basisu::vector<int>::reserve(vector<int> *this, ulong param_1) {
   void *__ptr;
   uint uVar1;
   uint uVar2;
   long in_FS_OFFSET;
   ...
   if (param_1 >> 0x20 == 0) {
      ...
      if (*(uint*)( this + 0xc ) < uVar2) {
         if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
            basisu::elemental_vector::increase_capacity((uint)this, SUB81(param_1, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x4, false);
            return;
         }
      ...
      if (uVar2 < *(uint*)( this + 0xc )) {
         ...
         basisu::elemental_vector::increase_capacity(( uint ) & local_38, SUB41(uVar1, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x4, false);
         uVar2 = *(uint*)( this + 8 );
         if (local_30._4_4_ < uVar2) {
            ...
            basisu::elemental_vector::increase_capacity(( uint ) & local_38, SUB41(uVar2, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x4, false);
         }
 else if ((int)local_30 != 0) {
            local_30 = (ulong)local_30._4_4_ << 0x20;
         }
   ...
   LAB_00109a68:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }

   LAB_00109adc:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* basisu::basisu_backend::basisu_backend() */void basisu::basisu_backend::_GLOBAL__sub_I_basisu_backend(void) {
   return;
}
/* WARNING: Control flow encountered bad instruction data *//* basisu::huffman_encoding_table::~huffman_encoding_table() */void basisu::huffman_encoding_table::~huffman_encoding_table(huffman_encoding_table *this) {

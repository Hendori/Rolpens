...
;
   ...
   if (cVar13 == '\0') {
      ...
      *puVar14 = 0;
      ...
      if (( cVar13 == '\0' ) || ( cVar13 = predelete_handler(pOVar21) ),cVar13 == '\0') goto LAB_00100d6a;
   ...
   *(undefined8*)( this + 0x200 ) = uVar1;
   ...
   if (local_50 == pOVar4) {
      LAB_001085d6:if (pOVar3 != (Object*)0x0) {
         cVar2 = RefCounted::unreference();
         joined_r0x001085e9:if (( cVar2 != '\0' ) && ( cVar2 = predelete_handler(pOVar3) ),cVar2 != '\0') {
            ( **(code**)( *(long*)pOVar3 + 0x140 ) )(pOVar3);
            Memory::free_static(pOVar3, false);
         }
   ...
   if (local_50 == pOVar4) {
      LAB_00108566:if (pOVar3 != (Object*)0x0) {
         cVar2 = RefCounted::unreference();
         joined_r0x00108579:if (( cVar2 != '\0' ) && ( cVar2 = predelete_handler(pOVar3) ),cVar2 != '\0') {
            ( **(code**)( *(long*)pOVar3 + 0x140 ) )(pOVar3);
            Memory::free_static(pOVar3, false);
         }
...
;*(undefined1(**) [16])( lVar46 + lVar47 * 8 ) = pauVar37;*puVar1 = uVar55;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_0010f803:CowData<char32_t>::_unref((CowData<char32_t>*)&local_70);LAB_0010f80f:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return pauVar43[1] + 8;}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<String, int, HashMapHasherDefault, HashMapComparatorDefault<String>,

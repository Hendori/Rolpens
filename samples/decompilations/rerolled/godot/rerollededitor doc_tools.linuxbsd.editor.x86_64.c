...
/* DocData::ClassDoc::TEMPNAMEPLACEHOLDERVALUE(DocData::ClassDoc const&) [clone .isra.0] */void DocData::ClassDoc::operator =(ClassDoc *this, ClassDoc *param_1) {
   ...
   if (*(long*)( this + 0x40 ) != *(long*)( param_1 + 0x40 )) {
      CowData<DocData::MethodDoc>::_ref((CowData<DocData::MethodDoc>*)( this + 0x40 ), (CowData*)( param_1 + 0x40 ));
   }

   if (*(long*)( this + 0x50 ) != *(long*)( param_1 + 0x50 )) {
      CowData<DocData::MethodDoc>::_ref((CowData<DocData::MethodDoc>*)( this + 0x50 ), (CowData*)( param_1 + 0x50 ));
   }

   if (*(long*)( this + 0x60 ) != *(long*)( param_1 + 0x60 )) {
      CowData<DocData::MethodDoc>::_ref((CowData<DocData::MethodDoc>*)( this + 0x60 ), (CowData*)( param_1 + 0x60 ));
   }

   if (*(long*)( this + 0x70 ) != *(long*)( param_1 + 0x70 )) {
      CowData<DocData::MethodDoc>::_ref((CowData<DocData::MethodDoc>*)( this + 0x70 ), (CowData*)( param_1 + 0x70 ));
   }

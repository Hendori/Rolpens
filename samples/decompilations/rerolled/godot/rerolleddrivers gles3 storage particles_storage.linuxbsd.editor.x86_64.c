...
/* GLES3::ParticlesStorage::particles_collision_get_extents(RID) const */undefined1[16];GLES3::ParticlesStorage::particles_collision_get_extents (ParticlesStorage *this,ulong param_2) {
   long lVar1;
   long lVar2;
   long in_FS_OFFSET;

/* glslang::(anonymous namespace)::op_logor(int, int) */bool glslang:: = (anonymous_namespace)::op_logor(int param_1, int param_2) {
   return param_1 != 0 || param_2 != 0;
}
/* glslang::(anonymous namespace)::op_logand(int, int) */bool glslang:: = (anonymous_namespace)::op_logand(int param_1, int param_2) {
   return param_2 != 0 && param_1 != 0;
}
/* glslang::(anonymous namespace)::op_or(int, int) */uint glslang:: = (anonymous_namespace)::op_or(int param_1, int param_2) {
   return param_1 | param_2;
}
/* glslang::(anonymous namespace)::op_xor(int, int) */uint glslang:: = (anonymous_namespace)::op_xor(int param_1, int param_2) {
   return param_1 ^ param_2;
}
/* glslang::(anonymous namespace)::op_and(int, int) */uint glslang:: = (anonymous_namespace)::op_and(int param_1, int param_2) {
   return param_1 & param_2;
}
/* glslang::(anonymous namespace)::op_eq(int, int) */bool glslang:: = (anonymous_namespace)::op_eq(int param_1, int param_2) {
   return param_1 == param_2;
}
/* glslang::(anonymous namespace)::op_ne(int, int) */bool glslang:: = (anonymous_namespace)::op_ne(int param_1, int param_2) {
   return param_1 != param_2;
}
/* glslang::(anonymous namespace)::op_ge(int, int) */bool glslang:: = (anonymous_namespace)::op_ge(int param_1, int param_2) {
   return param_2 <= param_1;
}
/* glslang::(anonymous namespace)::op_le(int, int) */bool glslang:: = (anonymous_namespace)::op_le(int param_1, int param_2) {
   return param_1 <= param_2;
}
/* glslang::(anonymous namespace)::op_gt(int, int) */bool glslang:: = (anonymous_namespace)::op_gt(int param_1, int param_2) {
   return param_2 < param_1;
}
/* glslang::(anonymous namespace)::op_lt(int, int) */bool glslang:: = (anonymous_namespace)::op_lt(int param_1, int param_2) {
   return param_1 < param_2;
}
/* glslang::(anonymous namespace)::op_shl(int, int) */int glslang:: = (anonymous_namespace)::op_shl(int param_1, int param_2) {
   return param_1 << ( (byte)param_2 & 0x1f );
}
/* glslang::(anonymous namespace)::op_shr(int, int) */int glslang:: = (anonymous_namespace)::op_shr(int param_1, int param_2) {
   return param_1 >> ( (byte)param_2 & 0x1f );
}
/* glslang::(anonymous namespace)::op_add(int, int) */int glslang:: = (anonymous_namespace)::op_add(int param_1, int param_2) {
   return param_1 + param_2;
}
/* glslang::(anonymous namespace)::op_sub(int, int) */int glslang:: = (anonymous_namespace)::op_sub(int param_1, int param_2) {
   return param_1 - param_2;
}
/* glslang::(anonymous namespace)::op_mul(int, int) */int glslang:: = (anonymous_namespace)::op_mul(int param_1, int param_2) {
   return param_1 * param_2;
}
/* glslang::(anonymous namespace)::op_div(int, int) */undefined1[16];__thiscall
...
/* glslang::(anonymous namespace)::op_mod(int, int) */ulong glslang:: = (anonymous_namespace)::op_mod(int param_1, int param_2) {
...
/* glslang::(anonymous namespace)::op_pos(int) */int glslang:: = (anonymous_namespace)::op_pos(int param_1) {
   return param_1;
}
/* glslang::(anonymous namespace)::op_neg(int) */int glslang:: = (anonymous_namespace)::op_neg(int param_1) {
   return -param_1;
}
/* glslang::(anonymous namespace)::op_cmpl(int) */uint glslang:: = (anonymous_namespace)::op_cmpl(int param_1) {
   return ~param_1;
}
/* glslang::(anonymous namespace)::op_not(int) */bool glslang:: = (anonymous_namespace)::op_not(int param_1) {
   return param_1 == 0;
}
/* glslang::TPpContext::tZeroInput::scan(glslang::TPpToken*) */undefined8 glslang::TPpContext::tZeroInput::scan(tZeroInput *this, TPpToken *param_1) {
...
/* std::vector<int, glslang::pool_allocator<int> >::TEMPNAMEPLACEHOLDERVALUE(std::vector<int,
   glslang::pool_allocator<int> > const&) [clone .isra.0] */void std::vector<int,glslang::pool_allocator<int>>::operator =(vector<int,glslang::pool_allocator<int>> *this, vector *param_1) {
   long lVar1;
   long lVar2;
   size_t __n;
   ulong uVar3;
...
/* glslang::TPpContext::scanHeaderName(glslang::TPpToken*, char) */undefined8 glslang::TPpContext::scanHeaderName(TPpContext *this, TPpToken *param_1, char param_2) {
   bool bVar1;
   int iVar2;
   long lVar3;
   int iVar4;
   ...
   while (true) {
      ...
      if (iVar2 == param_2) {
         ...
         if (bVar1) {
            ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), param_1, "header name too long", &_LC3);
         }
...
/* glslang::TPpContext::extraTokenCheck(int, glslang::TPpToken*, int) [clone .part.0] */ulong glslang::TPpContext::extraTokenCheck(TPpContext *this, int param_1, TPpToken *param_2, int param_3) {
   long *plVar1;
   ulong uVar2;
   char *pcVar3;
   switch (param_1) {
   ...
   if (( *(byte*)( plVar1 + 0x1a ) & 1 ) == 0) {
      ( **(code**)( *plVar1 + 0x168 ) )(plVar1, param_2, "unexpected tokens following directive", pcVar3, &_LC3);
   }
 else {
      ( **(code**)( *plVar1 + 0x170 ) )();
   }
...
/* glslang::TPpContext::extraTokenCheck(int, glslang::TPpToken*, int) */ulong glslang::TPpContext::extraTokenCheck(TPpContext *this, int param_1, TPpToken *param_2, int param_3) {
   ulong uVar1;
   if (( param_3 != 10 ) && ( param_3 != -1 )) {
...
/* glslang::TPpContext::CPPerror(glslang::TPpToken*) */undefined8 glslang::TPpContext::CPPerror(TPpContext *this, TPpToken *param_1) {
   int iVar1;
   size_t sVar2;
   long *plVar3;
   ulong uVar4;
   ...
   if (( iVar1 != -1 ) && ( iVar1 != 10 )) {
      do {
         ...
         if (local_60 == 0x3fffffffffffffff) {
            LAB_00100829:/* WARNING: Subroutine does not return */std::__throw_length_error("basic_string::append");
         }
...
/* glslang::TPpContext::CPPextension(glslang::TPpToken*) */int glslang::TPpContext::CPPextension(TPpContext *this, TPpToken *param_1) {
   TPpToken *pTVar1;
   undefined4 uVar2;
   long *plVar3;
   int iVar4;
   ...
   if (iVar4 == 10) {
      ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), param_1, "extension name not specified", "#extension", &_LC3);
      iVar4 = 10;
   }
 else {
      if (iVar4 != 0xa2) {
         ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), param_1, "extension name expected", "#extension", &_LC3);
      }
      ...
      if (iVar4 == 0x3a) {
         ...
         if (iVar4 == 0xa2) {
            ...
            iVar4 = scanToken(this, param_1);
            if (iVar4 != 10) {
               ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), param_1, "extra tokens -- expected newline", "#extension", &_LC3);
            }

         }
 else {
            ( **(code**)( *plVar3 + 0x168 ) )(plVar3, param_1, "behavior for extension not specified", "#extension", &_LC3);
         }

      }
 else {
         ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), param_1, "\':\' missing after extension name", "#extension", &_LC3);
      }
...
/* glslang::TPpContext::tMacroInput::scan(glslang::TPpToken*) */ulong glslang::TPpContext::tMacroInput::scan(tMacroInput *this, TPpToken *param_1) {
   TokenStream *pTVar1;
   long lVar2;
   tMacroInput tVar3;
   uint uVar4;
   ...
   do {
      uVar4 = glslang::TPpContext::TokenStream::getToken((TParseContextBase*)( *(long*)( this + 0x18 ) + 0x20 ), *(TPpToken**)( *(long*)( this + 0x10 ) + 0x100 ));
   }
 while ( uVar4 == 0x20 );
   local_41 = this[0x61];
...
/* std::vector<glslang::TPpContext::TokenStream::Token,
   ...
   glslang::pool_allocator<glslang::TPpContext::TokenStream::Token> > const&) [clone .isra.0] */void std::vector<glslang::TPpContext::TokenStream::Token,glslang::pool_allocator<glslang::TPpContext::TokenStream::Token>>::operator =(vector<glslang::TPpContext::TokenStream::Token,glslang::pool_allocator<glslang::TPpContext::TokenStream::Token>> *this, vector *param_1) {
   undefined1 *puVar1;
   ulong uVar2;
   undefined4 *__dest;
   ulong uVar3;
      ...
      for (; puVar13 != puVar8; puVar8 = puVar8 + 0xe) {
         ...
         *(ulong*)( puVar11 + 4 ) = uVar3;
         if (uVar2 < 0x10) {
            ...
            *(undefined4**)( puVar11 + 6 ) = __dest;
            LAB_00100d90:memcpy(__dest, puVar1, uVar2);
      ...
      *(long*)( this + 0x18 ) = lVar10;
      ...
      if (uVar2 < uVar5) {
         if (0 < (long)uVar2) {
            ...
            pbVar9 = (basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>*)( lVar10 + 0x10 );
            do {
               pbVar7 = pbVar6 + 0x38;
               *(undefined4*)( pbVar9 + -0x10 ) = *(undefined4*)( pbVar6 + -0x10 );
               *(basic_string*)( pbVar9 + -0xc ) = pbVar6[-0xc];
               *(undefined8*)( pbVar9 + -8 ) = *(undefined8*)( pbVar6 + -8 );
               __cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::_M_assign(pbVar9, pbVar6);
               pbVar6 = pbVar7;
               pbVar9 = pbVar9 + 0x38;
            }
            ...
            do {
               ...
               *(ulong*)( puVar11 + 4 ) = uVar3;
               if (uVar2 < 0x10) {
                  ...
                  if ((long)uVar2 < 0) {
                     LAB_00100efe:/* WARNING: Subroutine does not return */std::__throw_length_error("basic_string::_M_create");
                  }

                  puVar4 = (undefined4*)glslang::TPoolAllocator::allocate(uVar3);
                  *(ulong*)( puVar11 + 10 ) = uVar2;
                  *(undefined4**)( puVar11 + 6 ) = puVar4;
                  LAB_00100eac:memcpy(puVar4, puVar1, uVar2);
 ...
 while ( lVar12 != 0 );
   ...
   LAB_00100cda:*(long*)( this + 0x10 ) = lVar10;
   return;
}
/* glslang::TPpContext::CPPpragma(glslang::TPpToken*) */int glslang::TPpContext::CPPpragma(TPpContext *this, TPpToken *param_1) {
   TPpToken *__s;
   long *plVar1;
   ulong *puVar2;
   undefined1 *__src;
   ...
   if (( iVar3 != -1 ) && ( iVar3 != 10 )) {
      do {
         if (iVar3 < 0xa1) {
            ...
            LAB_00100fac:local_42[0] = (char)iVar3;
            local_42[1] = 0;
            local_78 = glslang::GetThreadPoolAllocator();
            local_70 = local_60;
            sVar4 = strlen(local_42);
            std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::_M_construct<char_const*>(&local_78, local_42, local_42 + sVar4);
            puVar2 = local_b8;
            if (local_b8 == local_b0) {
               std::vector<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,glslang::pool_allocator<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>>::_M_realloc_insert<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>((vector<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,glslang::pool_allocator<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>>*)&local_c8, local_b8, &local_78);
            }
 else {
               ...
               *puVar2 = uVar5;
               __src = local_70;
               __n = local_68;
               joined_r0x00101022:if (__n < 0x10) {
                  if (__n == 1) {
                  ...
                  puVar2[3] = __n;
                  puVar2[1] = (ulong)__dest;
                  LAB_00101104:memcpy(__dest, __src, __n);
            ...
            LAB_00101080:local_a8 = glslang::GetThreadPoolAllocator();
            __s = param_1 + 0x28;
            local_a0 = local_90;
            sVar4 = strlen((char*)__s);
            std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::_M_construct<char_const*>(&local_a8, __s, __s + sVar4);
            puVar2 = local_b8;
            if (local_b8 != local_b0) {
               uVar5 = glslang::GetThreadPoolAllocator();
               __dest = puVar2 + 3;
 ...
 while ( ( iVar3 != 10 ) && ( iVar3 != -1 ) );
   ...
   plVar1 = *(long**)( this + 0x100 );
   if (iVar3 == -1) {
      ( **(code**)( *plVar1 + 0x168 ) )(plVar1, &local_e8, "directive must end with a newline", "#pragma", &_LC3);
   }
 else {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* glslang::TPpContext::CPPinclude(glslang::TPpToken*) */int glslang::TPpContext::CPPinclude(TPpContext *this, TPpToken *param_1) {
   code *pcVar1;
   undefined8 uVar2;
...
;
   ...
   if (iVar5 != 0xa1) {
      ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), &local_3b8, "must be followed by a header name", "#include", &_LC3);
      goto LAB_001012c6;
   }
   ...
   if (pTVar8 < (TokenizableIncludeFile*)0x10) {
      ...
      local_398 = (TokenizableIncludeFile**)std::__cxx11::string::_M_create((ulong*)&local_398, ( ulong ) & local_3c0);
      local_388[0] = local_3c0;
      ppTVar13 = local_398;
      LAB_0010160f:memcpy(ppTVar13, param_1 + 0x28, (size_t)pTVar8);
      ppTVar13 = local_398;
   }
   ...
   *(TokenizableIncludeFile*)( (long)ppTVar13 + (long)local_3c0 ) = (TokenizableIncludeFile)0x0;
   ...
   if (iVar5 == 10) {
      ...
      if (bVar17) {
         ...
         pIVar10 = (IncludeResult*)( *pcVar1 )(plVar15, local_398, *(undefined8*)( this + 0x228 ), ( ( lVar7 - *(long*)( this + 0x200 ) >> 3 ) + -1 + ( ulong )(lVar7 == 0) ) * 0x40 + ( *(long*)( this + 0x208 ) - *(long*)( this + 0x210 ) >> 3 ) + 1 + ( *(long*)( this + 0x1f8 ) - *(long*)( this + 0x1e8 ) >> 3 ), pcVar1, lVar7, local_398);
         ...
         LAB_001016ee:puVar3 = PTR_vtable_0010af08;
         if (( *(long*)( pIVar10 + 0x20 ) == 0 ) || ( *(long*)( pIVar10 + 0x28 ) == 0 )) {
            ...
            *(undefined8*)psVar16 = _init;
            ...
            std::__ostream_insert<char,std::char_traits<char>>(poVar11, "\"", 1);
            poVar11 = std::__ostream_insert<char,std::char_traits<char>>(poVar11, *(char**)pIVar10, *(long*)( pIVar10 + 8 ));
            ...
            std::__ostream_insert<char,std::char_traits<char>>((ostream*)local_1b8, pcVar14, (ulong)!bVar17);
            std::__ostream_insert<char,std::char_traits<char>>((ostream*)local_1b8, "#line ", 6);
            poVar11 = (ostream*)std::ostream::operator <<((ostream*)local_1b8, uVar18 + uStack_3b0._4_4_);
            std::__ostream_insert<char,std::char_traits<char>>(poVar11, " ", 1);
            ...
            TokenizableIncludeFile::TokenizableIncludeFile(pTVar12, (TSourceLoc*)&local_3b8, (string*)&local_378, pIVar10, psVar19, this);
            puVar9 = *(undefined8**)( this + 400 );
            local_3c0 = pTVar12;
            if (puVar9 == *(undefined8**)( this + 0x198 )) {
               std::vector<glslang::TPpContext::tInput*,std::allocator<glslang::TPpContext::tInput*>>::_M_realloc_insert<glslang::TPpContext::tInput*const&>((vector<glslang::TPpContext::tInput*,std::allocator<glslang::TPpContext::tInput*>>*)( this + 0x188 ), puVar9, &local_3c0);
            }
 else {
               *puVar9 = pTVar12;
            ...
            pTVar12 = (TokenizableIncludeFile*)PTR_vtable_0010af00;
            TIntermediate::addIncludeText(*(char**)( *(long*)( this + 0x100 ) + 0x38 ), *(char**)pIVar10, *(ulong*)( pIVar10 + 0x20 ));
         ...
         pIVar10 = (IncludeResult*)0x0;
         LAB_00101467:if ((code*)puVar9[2] != TShader::ForbidIncluder::releaseInclude) {
         ...
         if ((code*)*puVar9 == TShader::Includer::includeSystem) {
            LAB_001014c7:pIVar10 = (IncludeResult*)0x0;
            local_1b8[0] = (TokenizableIncludeFile*)local_1a8;
            local_3c0 = (TokenizableIncludeFile*)0x23;
            local_1b8[0] = (TokenizableIncludeFile*)std::__cxx11::string::_M_create((ulong*)local_1b8, ( ulong ) & local_3c0);
            uVar2 = _UNK_0010aee8;
            ...
            *(undefined4*)( local_1b8[0] + 0x1f ) = 0x65766974;
            ...
            pIVar10 = (IncludeResult*)( *(code*)*puVar9 )(plVar15, local_398, *(undefined8*)( this + 0x228 ), ( ( *(long*)( this + 0x220 ) - *(long*)( this + 0x200 ) >> 3 ) + -1 + ( ulong )(*(long*)( this + 0x220 ) == 0) ) * 0x40 + ( *(long*)( this + 0x208 ) - *(long*)( this + 0x210 ) >> 3 ) + 1 + ( *(long*)( this + 0x1f8 ) - *(long*)( this + 0x1e8 ) >> 3 ));
            ...
            if (pTVar8 < (TokenizableIncludeFile*)0x10) {
               ...
               local_1b8[0] = (TokenizableIncludeFile*)std::__cxx11::string::_M_create((ulong*)local_1b8, ( ulong ) & local_3c0);
               local_1a8._0_8_ = local_3c0;
               LAB_00101e46:memcpy(local_1b8[0], __src, (size_t)pTVar8);
            }
         ...
         ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), &local_3b8, local_1b8[0], "#include", "for header name: %s", local_398);
         pcVar1 = *(code**)( **(long**)( this + 0x1a8 ) + 0x10 );
         if (pcVar1 != TShader::ForbidIncluder::releaseInclude) {
            ( *pcVar1 )(*(long**)( this + 0x1a8 ), pIVar10);
         }
      ...
      if (iVar5 == -1) {
         ( **(code**)( *plVar15 + 0x168 ) )(plVar15, param_1, "expected newline after header name:", "#include", &_LC38, local_398);
      }
 else {
   ...
   LAB_001012c6:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar5;
   }
...
/* std::pair<std::__detail::_Node_iterator<std::pair<std::__cxx11::basic_string<char,
   ...
   >, int>&&) [clone .isra.0] */undefined1[16];std::_Hashtable<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::hash<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>::_M_emplace<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,int>>(_Hashtable<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::hash<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>> *param_1, long *param_2) {
   _Hashtable<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::hash<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>> *p_Var1;
   long *plVar2;
   undefined1 auVar3[16];
   ...
   undefined8 *puVar10;
   void *__s;
   _Hashtable<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::hash<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>> *p_Var11;
   long lVar12;
   uint uVar13;
   char *__s1;
   ulong uVar14;
   ...
   *plVar9 = 0;
   ...
   if (plVar2 == plVar18) {
      ...
      if (7 < uVar7) {
         *plVar17 = param_2[3];
         *(undefined8*)( (long)plVar9 + ( uVar15 & 0xffffffff ) + 0x18 ) = *(undefined8*)( (long)param_2 + ( uVar15 & 0xffffffff ) + 0x10 );
         ...
         if (7 < uVar7) {
            ...
            do {
               uVar13 = (int)uVar15 + 8;
               *(undefined8*)( ( ( ulong )(plVar9 + 5) & 0xfffffffffffffff8 ) + uVar15 ) = *(undefined8*)( (long)plVar18 + ( uVar15 - lVar12 ) );
               uVar15 = (ulong)uVar13;
            }
 while ( uVar13 < uVar7 );
         }
      ...
      if (( uVar15 & 4 ) == 0) {
         if (uVar7 != 0) {
            ...
            *(undefined2*)( (long)plVar9 + ( uVar15 & 0xffffffff ) + 0x1e ) = *(undefined2*)( (long)param_2 + ( uVar15 & 0xffffffff ) + 0x16 );
            lVar12 = param_2[2];
         }
         ...
         *(undefined4*)( (long)plVar9 + ( uVar15 & 0xffffffff ) + 0x1c ) = *(undefined4*)( (long)param_2 + ( uVar15 & 0xffffffff ) + 0x14 );
         lVar12 = param_2[2];
      }
   ...
   *(int*)( plVar9 + 6 ) = (int)param_2[5];
   if (uVar15 == 0) {
      ...
      for (plVar17 = *(long**)( param_1 + 0x18 ); plVar17 != (long*)0x0; plVar17 = (long*)*plVar17) {
         if (( plVar17[3] == __n ) && ( ( __n == 0 || ( iVar8 = memcmp(__s1, (void*)plVar17[2], __n) ),iVar8 == 0 ) )) goto LAB_00102128;
      }
 ...
 while ( __s1 != pcVar20 );
      ...
      LAB_001020f0:puVar10 = (undefined8*)_M_find_before_node(param_1, uVar14, (basic_string*)( plVar9 + 1 ), uVar16);
      if (( puVar10 != (undefined8*)0x0 ) && ( plVar17 = (long*)*puVar10 ),plVar17 != (long*)0x0) {
         LAB_00102128:uVar6 = 0;
         goto LAB_0010212d;
      }
   ...
   if (cVar5 == '\0') {
      ...
      if (extraout_RDX == 1) {
         *(undefined8*)( param_1 + 0x38 ) = 0;
         ...
         p_Var11 = (_Hashtable<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::hash<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>*)memset(__s, 0, extraout_RDX * 8);
      }
...
;
         ...
         *(_Hashtable<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::hash<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>**)p_Var1 = param_1 + 0x18;
         if (*plVar18 != 0) {
...
;
      LAB_001021b9:*(ulong*)( param_1 + 0x10 ) = extraout_RDX;
      uVar14 = uVar16 % extraout_RDX;
      *(_Hashtable<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::hash<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>**)( param_1 + 8 ) = p_Var11;
   }
   ...
   *(long*)( param_1 + 0x20 ) = *(long*)( param_1 + 0x20 ) + 1;
   uVar6 = 1;
   plVar17 = plVar9;
   LAB_0010212d:auVar21[8] = uVar6;
   auVar21._0_8_ = plVar17;
   auVar21._9_7_ = 0;
   return auVar21;
}
/* glslang::TPpContext::CPPundef(glslang::TPpToken*) */int glslang::TPpContext::CPPundef(TPpContext *this, TPpToken *param_1) {
   TPpToken *__s;
   char cVar1;
   TPpContext *pTVar2;
   int iVar3;
   ...
   iVar3 = scanToken(this, param_1);
   if (iVar3 != 0xa2) {
      ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), param_1, "must be followed by macro name", "#undef", &_LC3);
      goto LAB_00102361;
   }
   ...
   pcVar6 = local_60;
   if (*(long*)( this + 0x60 ) == 0) {
      for (puVar7 = *(undefined8**)( this + 0x58 ); puVar7 != (undefined8*)0x0; puVar7 = (undefined8*)*puVar7) {
         if (( local_58 == puVar7[3] ) && ( ( local_58 == 0 || ( iVar3 = memcmp(pcVar6, (void*)puVar7[2], local_58) ),iVar3 == 0 ) )) goto LAB_00102432;
      }

      LAB_0010251d:iVar3 = 0;
   }
 else {
      uVar8 = 0x811c9dc5;
      if (local_58 != 0) {
 ...
 while ( local_60 + local_58 != pcVar6 );
      ...
      puVar7 = (undefined8*)std::_Hashtable<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::hash<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>::_M_find_before_node((_Hashtable<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::hash<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>*)( this + 0x40 ), uVar8 % *(ulong*)( this + 0x50 ), (basic_string*)&local_68, uVar8);
      if (( puVar7 == (undefined8*)0x0 ) || ( puVar7 = (undefined8*)*puVar7 ),puVar7 == (undefined8*)0x0) goto LAB_0010251d;
      LAB_00102432:iVar3 = *(int*)( puVar7 + 6 );
   }
...
;
 ...
 while ( *(TPpContext**)( pTVar5 + 0x18 ) != (TPpContext*)0x0 );
      LAB_00102470:if (( this + 0x18 != pTVar9 ) && ( *(int*)( pTVar9 + 0x20 ) <= iVar3 )) {
   ...
   iVar3 = scanToken(this, param_1);
   if (iVar3 != 10) {
      ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), param_1, "can only be followed by a single macro name", "#undef", &_LC3);
   }

   LAB_00102361:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar3;
   }
...
/* glslang::TPpContext::CPPversion(glslang::TPpToken*) */int glslang::TPpContext::CPPversion(TPpContext *this, TPpToken *param_1) {
   TPpToken *__s;
   char cVar1;
   undefined4 uVar2;
   long *plVar3;
   ...
   if (( this[0x1a0] == (TPpContext)0x0 ) && ( this[0x1a1] == (TPpContext)0x0 )) {
      ...
      LAB_0010279c:( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), param_1, "must be followed by version number", "#version", &_LC3);
   }
 else {
      ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), param_1, "must occur first in shader", "#version", &_LC3);
      this[0x1a1] = (TPpContext)0x1;
      if (iVar4 == 10) goto LAB_0010279c;
      LAB_0010259b:if (iVar4 != 0x98) {
         ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), param_1, "must be followed by version number", "#version", &_LC3);
      }
      ...
      *(undefined4*)( param_1 + 0x20 ) = uVar5;
      ...
      if (iVar4 != 10) {
         ...
         std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::_M_construct<char_const*>((basic_string*)&local_68, __s, __s + sVar6);
         pcVar7 = local_60;
         if (*(long*)( this + 0x60 ) == 0) {
            for (puVar8 = *(undefined8**)( this + 0x58 ); puVar8 != (undefined8*)0x0; puVar8 = (undefined8*)*puVar8) {
               if (( local_58 == puVar8[3] ) && ( ( local_58 == 0 || ( iVar4 = memcmp(pcVar7, (void*)puVar8[2], local_58) ),iVar4 == 0 ) )) goto LAB_00102693;
            }

            LAB_0010282d:( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), param_1, "bad profile name; use es, core, or compatibility", "#version", &_LC3);
         }
 else {
            uVar9 = 0x811c9dc5;
            if (local_58 != 0) {
 ...
 while ( pcVar7 != local_60 + local_58 );
            ...
            puVar8 = (undefined8*)std::_Hashtable<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::hash<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>::_M_find_before_node((_Hashtable<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::hash<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>*)( this + 0x40 ), uVar9 % *(ulong*)( this + 0x50 ), (basic_string*)&local_68, uVar9);
            if (( puVar8 == (undefined8*)0x0 ) || ( puVar8 = (undefined8*)*puVar8 ),puVar8 == (undefined8*)0x0) goto LAB_0010282d;
            LAB_00102693:if (2 < *(int*)( puVar8 + 6 ) - 0xafU) goto LAB_0010282d;
         }
         ...
         iVar4 = scanToken(this, param_1);
         if (iVar4 != 10) {
            ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), param_1, "bad tokens following profile -- expected newline", "#version", &_LC3);
         }
...
/* glslang::TPpContext::MacroExpand(glslang::TPpToken*, bool, bool) */undefined8 glslang::TPpContext::MacroExpand(TPpContext *this, TPpToken *param_1, bool param_2, bool param_3) {
   TPpToken *__s;
   long lVar1;
   char cVar2;
   undefined4 uVar3;
   ...
   std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::_M_construct<char_const*>((basic_string*)&local_478, __s, __s + sVar12);
   pcVar25 = local_470;
   if (*(long*)( this + 0x60 ) == 0) {
      ...
      if (plVar15 != (long*)0x0) {
         ...
         do {
            if (( sVar12 == plVar15[3] ) && ( ( sVar12 == 0 || ( iVar7 = memcmp(pcVar25, (void*)plVar15[2], sVar12) ),iVar7 == 0 ) )) goto LAB_001029ea;
            plVar15 = (long*)*plVar15;
         }
 while ( plVar15 != (long*)0x0 );
      }

      LAB_00102ada:if (param_1[0x19] == (TPpToken)0x0) {
         LAB_00102ae6:if (param_2) {
            ...
            *plVar15 = (long)&PTR__tZeroInput_0010ac28;
            ...
            if (puVar19 == *(undefined8**)( this + 0x198 )) {
               std::vector<glslang::TPpContext::tInput*,std::allocator<glslang::TPpContext::tInput*>>::_M_realloc_insert<glslang::TPpContext::tInput*const&>((vector<glslang::TPpContext::tInput*,std::allocator<glslang::TPpContext::tInput*>>*)( this + 0x188 ), puVar19, &local_4c8);
 ...
 while ( local_470 + CONCAT44(uStack_464, local_468) != pcVar25 );
      ...
      puVar19 = (undefined8*)std::_Hashtable<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::hash<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>::_M_find_before_node((_Hashtable<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::hash<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>*)( this + 0x40 ), uVar28 % *(ulong*)( this + 0x50 ), (basic_string*)&local_478, uVar28);
      if (( puVar19 == (undefined8*)0x0 ) || ( plVar15 = (long*)*puVar19 ),plVar15 == (long*)0x0) goto LAB_00102ada;
      LAB_001029ea:iVar7 = (int)plVar15[6];
      if (param_1[0x19] == (TPpToken)0x0) {
         ...
         if (iVar7 == 0xb4) {
            ...
            if (*(char*)( lVar16 + 0x58 ) == '\0') {
               ...
               if (*plVar31 != 0) {
                  LAB_00102c07:( **(code**)( *plVar15 + 0x30 ) )(plVar15, param_1, 1, &E_GL_GOOGLE_cpp_style_line_directive, "filename-based __FILE__");
               ...
               LAB_00102ce3:plVar24 = (long*)( lVar16 + 0x40 );
            }
         ...
         if (iVar7 == 0xb5) {
            ...
            LAB_00102b5b:*(undefined4*)( param_1 + 0x20 ) = uVar3;
            LAB_00102b60:__snprintf_chk(__s, 0x401, 2, 0xffffffffffffffff, &_LC68);
            glslang::TPpContext::UngetToken(iVar10, (TPpToken*)0x98);
            goto LAB_00102b92;
         }
...
;
 ...
 while ( uVar28 < ( ulong )(plVar15[10] - lVar16 >> 3) );
                     ...
                     if (uVar30 < uVar28) {
                        std::vector<glslang::TPpContext::TokenStream*,glslang::pool_allocator<glslang::TPpContext::TokenStream*>>::_M_default_append((vector<glslang::TPpContext::TokenStream*,glslang::pool_allocator<glslang::TPpContext::TokenStream*>>*)( plVar15 + 4 ), uVar28 - uVar30);
                        lVar20 = plVar15[3];
                        lVar16 = *(long*)( lVar20 + 0x10 );
                        lVar27 = *(long*)( lVar20 + 8 );
                     }
                     ...
                     if (lVar16 == lVar27) {
                        ...
                        LAB_0010318c:plVar15[10] = lVar16;
 ...
 while ( uVar28 < uVar30 );
                        ...
                        if (uVar28 < uVar30) {
                           std::vector<glslang::TPpContext::TokenStream*,glslang::pool_allocator<glslang::TPpContext::TokenStream*>>::_M_default_append((vector<glslang::TPpContext::TokenStream*,glslang::pool_allocator<glslang::TPpContext::TokenStream*>>*)( plVar15 + 8 ), uVar30 - uVar28);
                           uVar30 = *(long*)( plVar15[3] + 0x10 ) - *(long*)( plVar15[3] + 8 ) >> 2;
                        }
 else if (( uVar30 < uVar28 ) && ( lVar16 = plVar15[9] + uVar30 * 8 ),plVar15[10] != lVar16) goto LAB_0010318c;
                     }
                     ...
                     LAB_001031c3:local_500 = 0;
                     bVar6 = false;
                     LAB_001031f8:uVar28 = glslang::GetThreadPoolAllocator();
                     ...
                     LAB_00103225:do {
                        ...
                        if (( ~uVar9 & 0xfffffffd ) == 0) {
                           ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), &local_4c8, "End of input in macro", "macro expansion", *(undefined8*)( *(long*)( *(long*)( this + 0x88 ) + (long)iVar7 * 8 ) + 8 ));
 ...
 while ( uVar28 < ( ulong )(plVar15[10] - lVar16 >> 3) );
                        ...
                        if (uVar9 == 0x23) {
                           ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), param_1, "unexpected \'#\'", "macro expansion", *(undefined8*)( *(long*)( *(long*)( this + 0x88 ) + (long)iVar7 * 8 ) + 8 ));
                           pcVar13 = *(code**)( *plVar15 + 8 );
 ...
 while ( uVar28 < ( ulong )(plVar15[10] - lVar16 >> 3) );
                        ...
                        lVar16 = plVar15[3];
                        if (( uVar9 != 0x29 ) && ( *(long*)( lVar16 + 0x10 ) == *(long*)( lVar16 + 8 ) )) goto LAB_00103891;
                        if (puVar32 == local_520) {
                           ...
                           LAB_001035c0:puVar22 = (undefined1*)glslang::TPoolAllocator::allocate(uVar28);
                           puVar22[uVar26] = 0x29;
                           puVar23 = puVar22;
                           if (puVar32 != local_520) {
                              lVar16 = 0;
 ...
 while ( lVar16 != (long)puVar32 - (long)local_520 );
                        ...
                        local_4a0 = local_490;
                        sVar12 = strlen((char*)__s);
                        std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::_M_construct<char_const*>((basic_string*)&local_4a8, __s, __s + sVar12);
                        sVar12 = local_498;
                        pcVar25 = local_4a0;
                        if (*(long*)( this + 0x60 ) == 0) {
                           for (puVar19 = *(undefined8**)( this + 0x58 ); puVar19 != (undefined8*)0x0; puVar19 = (undefined8*)*puVar19) {
                              if (( sVar12 == puVar19[3] ) && ( ( sVar12 == 0 || ( iVar10 = memcmp(pcVar25, (void*)puVar19[2], sVar12) ),iVar10 == 0 ) )) goto LAB_00103339;
                           }
 ...
 while ( pcVar25 != local_4a0 + local_498 );
                           ...
                           puVar19 = (undefined8*)std::_Hashtable<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::hash<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>::_M_find_before_node((_Hashtable<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::hash<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>*)( this + 0x40 ), uVar30 % *(ulong*)( this + 0x50 ), (basic_string*)&local_4a8, uVar30);
                           if (( puVar19 != (undefined8*)0x0 ) && ( puVar19 = (undefined8*)*puVar19 ),puVar19 != (undefined8*)0x0) {
                              LAB_00103339:if (*(int*)( puVar19 + 6 ) == 0xb3) {
                                 lVar27 = *(long*)( *(long*)( this + 0x100 ) + 0xd8 );
                                 lVar16 = lVar27 + 0x40;
                                 if (*(char*)( lVar27 + 0x58 ) == '\0') {
                                    lVar16 = *(long*)( lVar27 + 0x30 );
                        ...
                        bVar6 = true;
                        glslang::TPpContext::TokenStream::putToken((int)*(undefined8*)( plVar15[5] + local_500 * 8 ), (TPpToken*)(ulong)uVar9);
                     }
 while ( true );
                  }
   ...
   LAB_00102f10:uVar14 = 0;
   LAB_00102b97:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }

   return uVar14;
   LAB_001033b0:if (!param_3) {
      ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), &local_4c8, "End of line in macro substitution:", "macro expansion", *(undefined8*)( *(long*)( *(long*)( this + 0x88 ) + (long)iVar7 * 8 ) + 8 ));
      pcVar13 = *(code**)( *plVar15 + 8 );
      if (pcVar13 == tMacroInput::~tMacroInput) {
         lVar16 = plVar15[5];
         uVar28 = 0;
 ...
 while ( uVar28 < ( ulong )(plVar15[10] - lVar16 >> 3) );
         ...
         LAB_0010349b:operator_delete(plVar15, 0x68);
      }
 else {
         LAB_00103680:( *pcVar13 )(plVar15);
      }
   ...
   goto LAB_00103225;
   LAB_00103869:lVar27 = *(long*)( lVar16 + 0x10 ) - *(long*)( lVar16 + 8 );
   uVar28 = lVar27 >> 2;
   if (uVar9 != 0x29) {
      local_500 = local_500 + 1;
      if (uVar28 <= local_500) {
         LAB_00103891:iVar10 = 0;
         LAB_001038a8:do {
            if (uVar9 == 0x29) goto LAB_0010398c;
            while (true) {
               if (uVar9 == 0x7d) {
                  LAB_0010398c:iVar10 = iVar10 + -1;
               }
               ...
               if (uVar9 == 0xffffffff) {
                  ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), &local_4c8, "End of input in macro", "macro expansion", *(undefined8*)( *(long*)( *(long*)( this + 0x88 ) + (long)iVar7 * 8 ) + 8 ));
                  ( **(code**)( *plVar15 + 8 ) )(plVar15);
                  LAB_001034a8:uVar14 = 1;
                  goto LAB_00102b97;
               }

               if (0 < iVar10) goto LAB_001038a8;
               if (uVar9 == 0x29) {
                  ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), &local_4c8, "Too many args in macro", "macro expansion", *(undefined8*)( *(long*)( *(long*)( this + 0x88 ) + (long)iVar7 * 8 ) + 8 ));
                  lVar16 = plVar15[3];
                  goto LAB_00102ffa;
               }
...
;
 ...
 while ( true );
   ...
   if (local_500 < uVar28) {
      ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), &local_4c8, "Too few args in Macro", "macro expansion", *(undefined8*)( *(long*)( *(long*)( this + 0x88 ) + (long)iVar7 * 8 ) + 8 ));
      lVar16 = plVar15[3];
   }

   LAB_00102ffa:for (uVar28 = 0; uVar28 < ( ulong )(*(long*)( lVar16 + 0x10 ) - *(long*)( lVar16 + 8 ) >> 2); uVar28 = uVar28 + 1) {
      uVar14 = PrescanMacroArg((TokenStream*)this, *(TPpToken**)( plVar15[5] + uVar28 * 8 ), SUB81(param_1, 0));
      *(undefined8*)( plVar15[9] + uVar28 * 8 ) = uVar14;
      lVar16 = plVar15[3];
   }

   LAB_0010303e:puVar19 = *(undefined8**)( this + 400 );
   local_4d0 = plVar15;
   if (puVar19 == *(undefined8**)( this + 0x198 )) {
      std::vector<glslang::TPpContext::tInput*,std::allocator<glslang::TPpContext::tInput*>>::_M_realloc_insert<glslang::TPpContext::tInput*const&>((vector<glslang::TPpContext::tInput*,std::allocator<glslang::TPpContext::tInput*>>*)( this + 0x188 ), puVar19, &local_4d0);
   }
 else {
      *puVar19 = plVar15;
      *(undefined8**)( this + 400 ) = puVar19 + 1;
   ...
   *(undefined8*)( pTVar33 + 0x68 ) = 0;
   LAB_00102b92:uVar14 = 2;
   goto LAB_00102b97;
}
/* glslang::TPpContext::evalToToken(int, bool, int&, bool&, glslang::TPpToken*) */int glslang::TPpContext::evalToToken(TPpContext *this, int param_1, bool param_2, int *param_3, bool *param_4, TPpToken *param_5) {
   long *plVar1;
   int iVar2;
   uint uVar3;
   while (true) {
      ...
      if (uVar3 < 2) {
         ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), param_5, "can\'t evaluate expression", "preprocessor evaluation", &_LC3);
         *param_4 = true;
         *param_3 = 0;
      }
 else if (( ( uVar3 == 3 ) && ( !param_2 ) ) && ( plVar1 = *(long**)( this + 0x100 ) * (int*)( (long)plVar1 + 0xc ) == 8 )) {
         if (( *(byte*)( plVar1 + 0x1a ) & 1 ) == 0) {
            ( **(code**)( *plVar1 + 0x168 ) )(plVar1, param_5, "undefined macro in expression not allowed in es profile", "preprocessor evaluation", param_5 + 0x28);
         }
 else {
            ( **(code**)( *plVar1 + 0x170 ) )();
         }
...
/* glslang::TPpContext::PrescanMacroArg(glslang::TPpContext::TokenStream&, glslang::TPpToken*, bool)
    */undefined8 *glslang::TPpContext::PrescanMacroArg(TokenStream *param_1, TPpToken *param_2, bool param_3) {
   undefined8 *puVar1;
   uint uVar2;
   int iVar3;
   undefined8 *puVar4;
   ...
   *plVar6 = (long)&PTR__tMarkerInput_0010aad8;
   ...
   if (puVar1 == *(undefined8**)( param_1 + 0x198 )) {
      std::vector<glslang::TPpContext::tInput*,std::allocator<glslang::TPpContext::tInput*>>::_M_realloc_insert<glslang::TPpContext::tInput*const&>((vector<glslang::TPpContext::tInput*,std::allocator<glslang::TPpContext::tInput*>>*)( param_1 + 0x188 ), puVar1, &local_48);
   ...
   LAB_00103bbc:uVar2 = scanToken((TPpContext*)param_1, pTVar8);
   if (uVar2 != 0xfffffffd) {
   ...
   goto LAB_00103c35;
   code_r0x00103bfd:if (1 < iVar3 - 2U) {
      LAB_00103bae:glslang::TPpContext::TokenStream::putToken((int)puVar4, (TPpToken*)(ulong)uVar2);
   }

   goto LAB_00103bbc;
   while (iVar3 != -1) {
      LAB_00103c10:iVar3 = scanToken((TPpContext*)param_1, pTVar8);
      if (iVar3 == -3) goto LAB_00103c35;
   }
;
   LAB_00103c25:operator_delete(puVar4, 0x28);
   puVar4 = (undefined8*)0x0;
   LAB_00103c35:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* glslang::TPpContext::CPPdefine(glslang::TPpToken*) */TPpToken * __thiscall glslang::TPpContext::CPPdefine(TPpContext *this,TPpToken *param_1){
   _Hashtable<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::hash<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>> *this_00;
   long lVar1;
   char cVar2;
   bool bVar3;
   uint *puVar4;
   ...
   if (uVar7 != 0xa2) {
      ...
      ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), param_1, "must be followed by macro name", "#define", &_LC3);
      goto LAB_00103d6e;
   }
   ...
   if (*(int*)( param_1 + 8 ) < 0) {
      ...
      ( **(code**)( **(long**)( this + 0x100 ) + 0x1a8 ) )(*(long**)( this + 0x100 ), param_1, param_1 + 0x28, "#define");
      local_478 = glslang::GetThreadPoolAllocator();
   }
 ...
 while ( plVar24 != (long*)0x0 );
      ...
      *(uint*)( this + 0xa0 ) = uVar7 + 1;
      ...
      std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::_M_construct<char_const*>((basic_string*)&local_478, __s, __s + sVar11);
      local_450[0] = uVar7;
      lVar16 = std::_Hashtable<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::hash<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>::_M_emplace<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,int>>(this_00, (basic_string*)&local_478);
      ...
      if (uVar13 < (long)(int)uVar7 + 1U) {
         ...
         if (uVar13 < uVar14) {
            std::vector<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const*,glslang::pool_allocator<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const*>>::_M_fill_insert((vector<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const*,glslang::pool_allocator<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const*>>*)( this + 0x80 ), lVar22, uVar14 - uVar13, &local_918);
            lVar17 = *(long*)( this + 0x88 );
         }
 else if (( uVar14 < uVar13 ) && ( lVar1 = lVar22 != lVar1 )) {
 ...
 while ( pcVar19 != local_470 + CONCAT44(uStack_464, local_468) );
      ...
      puVar15 = (undefined8*)std::_Hashtable<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::hash<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>::_M_find_before_node(this_00, uVar13 % *(ulong*)( this + 0x50 ), (basic_string*)&local_478, uVar13);
      if (( puVar15 == (undefined8*)0x0 ) || ( plVar24 = (long*)*puVar15 ),plVar24 == (long*)0x0) goto LAB_001040d9;
      LAB_00103e75:uVar7 = *(uint*)( plVar24 + 6 );
      ...
      if (param_1[0x18] == (TPpToken)0x0) {
         ...
         do {
            ...
            if ((int)uVar13 != 0xa2) {
               ...
               ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), param_1, "bad argument", "#define", &_LC3);
               goto LAB_00103d6e;
            }
            ...
            if (*(long*)( this + 0x60 ) == 0) {
               ...
               if (plVar24 != (long*)0x0) {
                  sVar11 = CONCAT44(uStack_464, local_468);
                  do {
                     if (( sVar11 == plVar24[3] ) && ( ( sVar11 == 0 || ( iVar8 = memcmp(pcVar19, (void*)plVar24[2], sVar11) ),iVar8 == 0 ) )) goto LAB_001042a3;
                     plVar24 = (long*)*plVar24;
                  }
 while ( plVar24 != (long*)0x0 );
               }

               LAB_00104409:uVar9 = *(uint*)( this + 0xa0 );
               *(uint*)( this + 0xa0 ) = uVar9 + 1;
               ...
               if (uVar13 < (long)(int)uVar9 + 1U) {
                  ...
                  if (uVar13 < uVar14) {
                     std::vector<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const*,glslang::pool_allocator<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const*>>::_M_fill_insert((vector<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const*,glslang::pool_allocator<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const*>>*)( this + 0x80 ), lVar22, uVar14 - uVar13, &local_920);
                     lVar17 = *(long*)( this + 0x88 );
                  }
 else if (( uVar14 < uVar13 ) && ( lVar1 = lVar22 != lVar1 )) {
                     *(long*)( this + 0x90 ) = lVar1;
 ...
 while ( pcVar19 != local_470 + CONCAT44(uStack_464, local_468) );
               ...
               puVar15 = (undefined8*)std::_Hashtable<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::hash<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>::_M_find_before_node(this_00, uVar13 % *(ulong*)( this + 0x50 ), (basic_string*)&local_478, uVar13);
               if (( puVar15 == (undefined8*)0x0 ) || ( plVar24 = (long*)*puVar15 ),plVar24 == (long*)0x0) goto LAB_00104409;
               LAB_001042a3:uVar9 = *(uint*)( plVar24 + 6 );
            ...
            if (puVar23 != (uint*)0x0) {
               ...
               do {
                  if (local_8f0[uVar14] == uVar9) {
                     ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), param_1, "duplicate macro parameter", "#define", &_LC3);
                     goto LAB_0010431e;
                  }
 ...
 while ( uVar14 < uVar13 );
            ...
            if (local_8e0 == local_8e8) {
               ...
               if (local_8f0 == local_8e8) {
                  puVar18 = puVar23 + 1;
                  LAB_00104789:local_8f0 = (uint*)glslang::TPoolAllocator::allocate(local_8f8);
 ...
 while ( lVar17 + 4 != (long)puVar5 - (long)puVar4 );
            ...
            LAB_0010431e:uVar9 = scanToken(this, param_1);
         }
 while ( uVar9 == 0x2c );
         pTVar25 = (TPpToken*)(ulong)uVar9;
         if (uVar9 != 0x29) {
            ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), param_1, "missing parenthesis", "#define", &_LC3);
            goto LAB_00103d6e;
         }

         LAB_00103f03:uVar9 = scanToken(this, param_1);
         pTVar25 = (TPpToken*)(ulong)uVar9;
 ...
 while ( uVar9 != 0xffffffff );
      ...
      if (param_1[0x18] == (TPpToken)0x0) {
         ( **(code**)( **(long**)( this + 0x100 ) + 0x170 ) )(*(long**)( this + 0x100 ), param_1, "missing space after macro name", "#define", &_LC3);
         goto LAB_00103d6e;
      }
   ...
   LAB_00103f6b:pTVar6 = *(TPpContext**)( this + 0x20 );
   pTVar20 = this + 0x18;
   if (*(TPpContext**)( this + 0x20 ) == (TPpContext*)0x0) {
      LAB_00103fac:addMacroDef(this, uVar7, (MacroSymbol*)&local_8f8);
   }
 else {
      do {
         while (true) {
...
;
 ...
 while ( *(TPpContext**)( pTVar12 + 0x18 ) != (TPpContext*)0x0 );
      LAB_00103fa1:if (( this + 0x18 == pTVar20 ) || ( (int)uVar7 < *(int*)( pTVar20 + 0x20 ) )) goto LAB_00103fac;
      if (( (byte)pTVar20[0x70] & 4 ) == 0) {
         ...
         if (( ( (byte)pTVar20[0x70] ^ local_8b0 ) & 1 ) == 0) {
            ...
            if (sVar11 == *(long*)( pTVar20 + 0x38 ) - (long)*(void**)( pTVar20 + 0x30 )) {
               if (( sVar11 != 0 ) && ( iVar8 = memcmp(*(void**)( pTVar20 + 0x30 ), local_8f0, sVar11) ),iVar8 != 0) {
                  ( **(code**)( *(long*)pTVar25 + 0x168 ) )(pTVar25, &local_918, "Macro redefined; different argument names:", "#define", *(undefined8*)( *(long*)( *(long*)( this + 0x88 ) + (long)(int)uVar7 * 8 ) + 8 ));
                  pTVar25 = *(TPpToken**)( this + 0x100 );
               }
               ...
               *(undefined8*)( pTVar20 + 0x68 ) = 0;
               ...
               while (true) {
                  ...
                  iVar8 = glslang::TPpContext::TokenStream::getToken((TParseContextBase*)( pTVar20 + 0x48 ), pTVar25);
                  iVar10 = glslang::TPpContext::TokenStream::getToken((TParseContextBase*)&local_8d8, *(TPpToken**)( this + 0x100 ));
                  if (!bVar3) break;
                  local_460[0] = (char)local_890;
                  if (iVar8 != iVar10) goto LAB_00104740;
                  LAB_0010472c:if (( ( ( local_888._0_4_ != local_458._0_4_ ) || ( local_888 != local_458 ) ) || ( local_888 != local_458 ) ) || ( iVar8 = iVar8 != 0 )) goto LAB_00104740;
                  bVar3 = false;
...
;
               ...
               LAB_00104740:( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), &local_918, "Macro redefined; different substitutions:", "#define", *(undefined8*)( *(long*)( *(long*)( this + 0x88 ) + (long)(int)uVar7 * 8 ) + 8 ));
               goto LAB_00104023;
            }
      ...
      LAB_00104023:std::vector<int,glslang::pool_allocator<int>>::operator =((vector<int,glslang::pool_allocator<int>>*)( pTVar20 + 0x28 ), (vector*)&local_8f8);
      std::vector<glslang::TPpContext::TokenStream::Token,glslang::pool_allocator<glslang::TPpContext::TokenStream::Token>>::operator =((vector<glslang::TPpContext::TokenStream::Token,glslang::pool_allocator<glslang::TPpContext::TokenStream::Token>>*)( pTVar20 + 0x48 ), (vector*)&local_8d8);
      *(undefined8*)( pTVar20 + 0x68 ) = local_8b8;
      pTVar20[0x70] = ( TPpContext )((byte)pTVar20[0x70] & 0xf8 | local_8b0 & 7);
   }

   pTVar25 = (TPpToken*)0xa;
   LAB_00103d6e:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return pTVar25;
   }
...
/* glslang::TPpContext::eval(int, int, bool, int&, bool&, glslang::TPpToken*) */int glslang::TPpContext::eval(TPpContext *this, int param_1, int param_2, bool param_3, int *param_4, bool *param_5, TPpToken *param_6) {
   TPpToken *__s2;
   int iVar1;
   code *pcVar2;
   char cVar3;
   ...
   if (param_1 == 0xa2) {
      ...
      if (( *(long*)( this + 400 ) != *(long*)( this + 0x188 ) ) && ( cVar3 = ( **(code**)( **(long**)( *(long*)( this + 400 ) + -8 ) + 0x40 ) )() ),cVar3 != '\0') {
         plVar14 = *(long**)( this + 0x100 );
         if (( *(byte*)( plVar14 + 0x1a ) & 1 ) == 0) {
            ( **(code**)( *plVar14 + 0x168 ) )(plVar14, param_6, "cannot use in preprocessor expression when expanded from macros", "defined", &_LC3);
         }
 else {
            ( **(code**)( *plVar14 + 0x170 ) )(plVar14, param_6, "nonportable when expanded from macros for preprocessor expression");
         }
      ...
      if (param_1 == 0xa2) {
         ...
         std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::_M_construct<char_const*>((basic_string*)&local_68, __s2, __s2 + sVar7);
         pcVar12 = local_60;
         if (*(long*)( this + 0x60 ) == 0) {
            plVar14 = *(long**)( this + 0x58 );
            if (plVar14 == (long*)0x0) {
               LAB_00104f9f:iVar4 = 0;
            }
 else {
               do {
                  if (( local_58 == plVar14[3] ) && ( ( local_58 == 0 || ( iVar4 = memcmp(pcVar12, (void*)plVar14[2], local_58) ),iVar4 == 0 ) )) goto LAB_00104ee9;
 ...
 while ( local_60 + local_58 != pcVar12 );
            ...
            puVar10 = (undefined8*)std::_Hashtable<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::hash<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>::_M_find_before_node((_Hashtable<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::hash<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>*)( this + 0x40 ), uVar11 % *(ulong*)( this + 0x50 ), (basic_string*)&local_68, uVar11);
            if (( puVar10 == (undefined8*)0x0 ) || ( plVar14 = (long*)*puVar10 ),plVar14 == (long*)0x0) goto LAB_00104f9f;
            LAB_00104ee9:iVar4 = (int)plVar14[6];
         }
 ...
 while ( pTVar8 != (TPpContext*)0x0 );
      ...
      LAB_00104a20:( **(code**)( lVar18 + 0x168 ) )(plVar14, &local_88, pcVar12, "preprocessor evaluation", &_LC3);
      *param_5 = true;
      *param_4 = 0;
   }
 else {
      if (param_1 == 0x98) {
         *param_4 = *(int*)( param_6 + 0x20 );
         LAB_00104e37:param_1 = scanToken(this, param_6);
      }
         ...
         if (*param_5 == false) {
            if (param_1 != 0x29) {
               ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), &local_88, "expected \')\'", "preprocessor evaluation", &_LC3);
               *param_5 = true;
               *param_4 = 0;
               goto LAB_00104a38;
            }
      ...
      LAB_00104c63:param_1 = evalToToken(this, param_1, param_3, param_4, param_5, param_6);
...
;
            ...
            iVar1 = *param_4;
            bVar19 = true;
            if (( param_3 == false ) && ( param_3 = param_1 == 0x8e && iVar1 == 1 ),param_1 != 0x8e || iVar1 != 1) {
            ...
            if (( ( pcVar2 == (anonymous_namespace)::op_mod ) || ( pcVar2 == (anonymous_namespace)::op_div ) ) && ( iVar15 == 0 )) {
               ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), &local_88, "division by 0", "preprocessor evaluation", &_LC3);
               *param_4 = 1;
               iVar15 = 1;
               uVar13 = extraout_RDX;
            }
...
;
   ...
   LAB_00104a38:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* glslang::TPpContext::CPPif(glslang::TPpToken*) */undefined8 glslang::TPpContext::CPPif(TPpContext *this, TPpToken *param_1) {
   int iVar1;
   undefined8 uVar2;
   long in_FS_OFFSET;
   bool local_25;
   ...
   if (( *(int*)( this + 0x138 ) < 0x41 ) && ( *(int*)( this + 0x180 ) < 0x41 )) {
      ...
      *(int*)( this + 0x138 ) = *(int*)( this + 0x138 ) + 1;
      ...
      ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), param_1, "maximum nesting depth exceeded", &_LC30, &_LC3);
      uVar2 = 0xffffffff;
   }
...
/* WARNING: Removing unreachable block (ram,0x00105542) *//* glslang::TPpContext::CPPelse(int, glslang::TPpToken*) */undefined8 glslang::TPpContext::CPPelse(TPpContext *this, int param_1, TPpToken *param_2) {
   TPpToken *__s;
   char cVar1;
   int iVar2;
   uint uVar3;
   ...
   if (iVar2 == -1) {
      LAB_001051f9:uVar4 = 0xffffffff;
      LAB_001051fe:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return uVar4;
      }

      LAB_00105673:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }

   iVar9 = 0;
   LAB_001051d0:if (iVar2 != 0x23) {
      if (iVar2 != 10) goto LAB_001051e0;
      LAB_00105359:iVar2 = scanToken(this, param_2);
      LAB_00105364:if (iVar2 == -1) goto LAB_001051f9;
      goto LAB_001051d0;
   }
   ...
   std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::_M_construct<char_const*>((basic_string*)&local_68, __s, __s + sVar5);
   sVar5 = local_58;
   pcVar8 = local_60;
   if (*(long*)( this + 0x60 ) == 0) {
      for (puVar6 = *(undefined8**)( this + 0x58 ); puVar6 != (undefined8*)0x0; puVar6 = (undefined8*)*puVar6) {
         if (( sVar5 == puVar6[3] ) && ( ( sVar5 == 0 || ( iVar2 = memcmp(pcVar8, (void*)puVar6[2], sVar5) ),iVar2 == 0 ) )) goto LAB_001052cb;
      }
 ...
 while ( pcVar8 != local_60 + local_58 );
      ...
      puVar6 = (undefined8*)std::_Hashtable<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::hash<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>::_M_find_before_node((_Hashtable<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::hash<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>*)( this + 0x40 ), uVar7 % *(ulong*)( this + 0x50 ), (basic_string*)&local_68, uVar7);
      if (( puVar6 == (undefined8*)0x0 ) || ( puVar6 = (undefined8*)*puVar6 ),puVar6 == (undefined8*)0x0) goto LAB_001051e0;
      LAB_001052cb:iVar2 = *(int*)( puVar6 + 6 );
      if (iVar2 - 0xa5U < 3) {
         iVar9 = iVar9 + 1;
         if (( *(int*)( this + 0x138 ) < 0x41 ) && ( *(int*)( this + 0x180 ) < 0x41 )) {
            *(int*)( this + 0x138 ) = *(int*)( this + 0x138 ) + 1;
         ...
         ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), param_2, "maximum nesting depth exceeded", "#if/#ifdef/#ifndef", &_LC3);
         goto LAB_001051f9;
      }
      ...
      if (( param_1 != 0 ) && ( iVar9 == 0 )) {
         if (iVar2 == 0xa8) {
            ...
            if (this[(long)*(int*)( this + 0x180 ) + 0x13c] != (TPpContext)0x0) {
               ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), param_2, "#elif after #else", "#elif", &_LC3);
            }
      ...
      if (iVar2 == 0xa8) {
         if (this[(long)*(int*)( this + 0x180 ) + 0x13c] == (TPpContext)0x0) {
            ...
            ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), param_2, "#else after #else", "#else", &_LC3);
         }
   ...
   LAB_001051e0:while (true) {
      uVar4 = scanToken(this, param_2);
      if ((int)uVar4 == 10) break;
      if ((int)uVar4 == -1) goto LAB_001051f9;
   }
;
   LAB_00105350:if ((int)uVar4 != -1) goto LAB_00105359;
   goto LAB_001051f9;
}
/* glslang::TPpContext::CPPifdef(int, glslang::TPpToken*) */ulong glslang::TPpContext::CPPifdef(TPpContext *this, int param_1, TPpToken *param_2) {
   TPpToken *__s;
   char cVar1;
   long *plVar2;
   TPpContext *pTVar3;
   ...
   if (( *(int*)( this + 0x138 ) < 0x42 ) && ( *(int*)( this + 0x180 ) < 0x42 )) {
      ...
      *(int*)( this + 0x138 ) = *(int*)( this + 0x138 ) + 1;
      if (uVar4 == 0xa2) {
         ...
         local_60 = local_50;
         sVar6 = strlen((char*)__s);
         std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::_M_construct<char_const*>(&local_68, __s, __s + sVar6);
         pcVar9 = local_60;
         if (*(long*)( this + 0x60 ) == 0) {
            for (puVar10 = *(undefined8**)( this + 0x58 ); puVar10 != (undefined8*)0x0; puVar10 = (undefined8*)*puVar10) {
               if (( local_58 == puVar10[3] ) && ( ( local_58 == 0 || ( iVar5 = memcmp(pcVar9, (void*)puVar10[2], local_58) ),iVar5 == 0 ) )) goto LAB_001057eb;
            }

            LAB_0010598d:iVar5 = 0;
         }
 else {
            uVar8 = 0x811c9dc5;
            if (local_58 != 0) {
 ...
 while ( pcVar9 != local_60 + local_58 );
            ...
            puVar10 = (undefined8*)std::_Hashtable<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::hash<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>::_M_find_before_node((_Hashtable<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::hash<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>*)( this + 0x40 ), uVar8 % *(ulong*)( this + 0x50 ), (basic_string*)&local_68, uVar8);
            if (( puVar10 == (undefined8*)0x0 ) || ( puVar10 = (undefined8*)*puVar10 ),puVar10 == (undefined8*)0x0) goto LAB_0010598d;
            LAB_001057eb:iVar5 = *(int*)( puVar10 + 6 );
         }

         pTVar3 = *(TPpContext**)( this + 0x20 );
         pTVar11 = this + 0x18;
         if (*(TPpContext**)( this + 0x20 ) == (TPpContext*)0x0) {
            LAB_0010582a:uVar4 = scanToken(this, param_2);
            uVar8 = (ulong)uVar4;
            if (uVar4 != 10) {
               pTVar11 = (TPpContext*)0x0;
               ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), param_2, "unexpected tokens following #ifdef directive - expected a newline", "#ifdef", &_LC3);
...
;
 ...
 while ( *(TPpContext**)( pTVar7 + 0x18 ) != (TPpContext*)0x0 );
            LAB_00105820:if (( this + 0x18 == pTVar11 ) || ( iVar5 < *(int*)( pTVar11 + 0x20 ) )) goto LAB_0010582a;
            pTVar11 = pTVar11 + 0x28;
            uVar4 = scanToken(this, param_2);
            uVar8 = (ulong)uVar4;
            if (( uVar4 != 10 ) && ( ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), param_2, "unexpected tokens following #ifdef directive - expected a newline", "#ifdef", &_LC3),uVar4 != 0xffffffff )) {
               LAB_001058c0:do {
                  uVar4 = scanToken(this, param_2);
                  uVar8 = (ulong)uVar4;
                  if (uVar4 == 10) break;
 ...
 while ( uVar4 != 0xffffffff );
         ...
         if (param_1 == 0) {
            ...
            ( **(code**)( *plVar2 + 0x168 ) )(plVar2, param_2, "must be followed by macro name", "#ifdef", &_LC3);
         }
      ...
      uVar8 = 0xffffffff;
      ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), param_2, "maximum nesting depth exceeded", "#ifdef", &_LC3);
   }
   ...
   LAB_001059cd:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* glslang::TPpContext::CPPline(glslang::TPpToken*) */int glslang::TPpContext::CPPline(TPpContext *this, TPpToken *param_1) {
   TPpToken *__s;
   long lVar1;
   long *plVar2;
   long lVar3;
   ...
   if (iVar6 == 10) {
      ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), param_1, "must by followed by an integral literal", "#line", &_LC3);
      LAB_00105d8b:iVar7 = 10;
      goto LAB_00105aac;
   }
   ...
   if (local_b7 == false) {
      ...
      *(int*)( *(long*)( lVar15 + 0x30 ) + (long)iVar8 * 0x18 + 0xc ) = local_b4;
      if (iVar7 == 10) {
         ...
         if (iVar7 == 0xa1) {
            __s = param_1 + 0x28;
            ( **(code**)( *plVar2 + 0x30 ) )(plVar2, &local_98, 1, &E_GL_GOOGLE_cpp_style_line_directive, "filename-based #line");
            local_78 = glslang::GetThreadPoolAllocator();
            local_70 = local_60;
            sVar10 = strlen((char*)__s);
            std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::_M_construct<char_const*>((basic_string*)&local_78, __s, __s + sVar10);
            pcVar14 = local_70;
            if (*(long*)( this + 0x60 ) == 0) {
               for (puVar12 = *(undefined8**)( this + 0x58 ); puVar12 != (undefined8*)0x0; puVar12 = (undefined8*)*puVar12) {
                  if (( local_68 == puVar12[3] ) && ( ( local_68 == 0 || ( iVar7 = memcmp(pcVar14, (void*)puVar12[2], local_68) ),iVar7 == 0 ) )) goto LAB_00105c13;
               }

               LAB_00105e6e:iVar7 = *(int*)( this + 0xa0 );
               *(int*)( this + 0xa0 ) = iVar7 + 1;
               ...
               std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::_M_construct<char_const*>((basic_string*)&local_78, __s, __s + sVar10);
               local_50 = iVar7;
               lVar15 = std::_Hashtable<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::hash<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>::_M_emplace<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,int>>((_Hashtable<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::hash<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>*)( this + 0x40 ), (basic_string*)&local_78);
               ...
               if (uVar11 < (long)iVar7 + 1U) {
                  ...
                  if (uVar11 < uVar18) {
                     std::vector<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const*,glslang::pool_allocator<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const*>>::_M_fill_insert((vector<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const*,glslang::pool_allocator<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const*>>*)( this + 0x80 ), lVar3, uVar18 - uVar11, &local_a0);
                     lVar17 = *(long*)( this + 0x88 );
                  }
 else if (( uVar18 < uVar11 ) && ( lVar1 = lVar3 != lVar1 )) {
                     *(long*)( this + 0x90 ) = lVar1;
                  }
 ...
 while ( pcVar14 != local_70 + local_68 );
               ...
               puVar12 = (undefined8*)std::_Hashtable<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::hash<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>::_M_find_before_node((_Hashtable<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::hash<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>*)( this + 0x40 ), uVar11 % *(ulong*)( this + 0x50 ), (basic_string*)&local_78, uVar11);
               if (( puVar12 == (undefined8*)0x0 ) || ( puVar12 = (undefined8*)*puVar12 ),puVar12 == (undefined8*)0x0) goto LAB_00105e6e;
               LAB_00105c13:if (*(int*)( puVar12 + 6 ) == 0) goto LAB_00105e6e;
            ...
            *puVar12 = uVar13;
            ...
            std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::_M_construct<char_const*>(puVar12, __s_00, __s_00 + sVar10);
   ...
   LAB_00105a93:if (bVar4) {
      iVar7 = extraTokenCheck(this, 0xab, param_1, iVar7);
   }

   LAB_00105aac:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar7;
   }
...
/* glslang::TPpContext::readCPPline(glslang::TPpToken*) */void glslang::TPpContext::readCPPline(TPpContext *this, TPpToken *param_1) {
   TPpToken *__s;
   char cVar1;
   int iVar2;
   int iVar3;
   ...
   if (iVar3 == 0xa2) {
      ...
      if (*(long*)( this + 0x60 ) == 0) {
         for (puVar6 = *(undefined8**)( this + 0x58 ); puVar6 != (undefined8*)0x0; puVar6 = (undefined8*)*puVar6) {
            if (( local_58 == puVar6[3] ) && ( ( local_58 == 0 || ( iVar3 = memcmp(pcVar9, (void*)puVar6[2], local_58) ),iVar3 == 0 ) )) goto LAB_0010612f;
         }
 ...
 while ( pcVar9 != pcStack_60 + local_58 );
         ...
         if (( puVar6 != (undefined8*)0x0 ) && ( puVar6 = (undefined8*)*puVar6 ),puVar6 != (undefined8*)0x0) {
            LAB_0010612f:switch (*(undefined4*)( puVar6 + 6 )) {
               case 0xa3:
      ...
      switchD_0010614c_caseD_af:( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), param_1, "invalid directive:", &_LC25, __s);
   }
 else {
      if (( iVar3 == 10 ) || ( iVar3 == -1 )) goto LAB_00106075;
      ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), param_1, "invalid directive", &_LC25, &_LC3);
   }
...
/* glslang::TShader::Includer::includeSystem(char const*, char const*, unsigned long) */undefined8 glslang::TShader::Includer::includeSystem(char *param_1, char *param_2, ulong param_3) {
   return 0;
}
/* glslang::TShader::Includer::includeLocal(char const*, char const*, unsigned long) */undefined8 glslang::TShader::Includer::includeLocal(char *param_1, char *param_2, ulong param_3) {
   return 0;
}
/* glslang::TShader::ForbidIncluder::releaseInclude(glslang::TShader::Includer::IncludeResult*) */void glslang::TShader::ForbidIncluder::releaseInclude(IncludeResult *param_1) {
   return;
}
/* glslang::TPpContext::tInput::peekPasting() */undefined8 glslang::TPpContext::tInput::peekPasting(void) {
   return 0;
}
/* glslang::TPpContext::tInput::peekContinuedPasting(int) */undefined8 glslang::TPpContext::tInput::peekContinuedPasting(int param_1) {
   return 0;
}
/* glslang::TPpContext::tInput::endOfReplacementList() */undefined8 glslang::TPpContext::tInput::endOfReplacementList(void) {
   return 0;
}
/* glslang::TPpContext::tInput::isMacroInput() */undefined8 glslang::TPpContext::tInput::isMacroInput(void) {
   return 0;
}
/* glslang::TPpContext::tInput::isStringInput() */undefined8 glslang::TPpContext::tInput::isStringInput(void) {
   return 0;
}
/* glslang::TPpContext::tInput::notifyActivated() */void glslang::TPpContext::tInput::notifyActivated(void) {
   return;
}
/* glslang::TPpContext::tInput::notifyDeleted() */void glslang::TPpContext::tInput::notifyDeleted(void) {
   return;
}
/* glslang::TPpContext::tMacroInput::getch() */undefined8 glslang::TPpContext::tMacroInput::getch(void) {
   return 0xffffffff;
}
/* glslang::TPpContext::tMacroInput::ungetch() */void glslang::TPpContext::tMacroInput::ungetch(void) {
   return;
}
/* glslang::TPpContext::tMacroInput::peekPasting() */tMacroInput glslang::TPpContext::tMacroInput::peekPasting(tMacroInput *this) {
   return this[0x60];
}
/* glslang::TPpContext::tMacroInput::peekContinuedPasting(int) */ulong glslang::TPpContext::tMacroInput::peekContinuedPasting(tMacroInput *this, int param_1) {
   int *piVar1;
   long lVar2;
   bool bVar3;
   uint uVar4;
...
/* glslang::TPpContext::tMacroInput::endOfReplacementList() */undefined8 glslang::TPpContext::tMacroInput::endOfReplacementList(tMacroInput *this) {
   long lVar1;
   ulong uVar2;
...
/* glslang::TPpContext::tMacroInput::isMacroInput() */undefined8 glslang::TPpContext::tMacroInput::isMacroInput(void) {
   return 1;
}
/* glslang::TPpContext::tMarkerInput::scan(glslang::TPpToken*) */undefined8 glslang::TPpContext::tMarkerInput::scan(TPpToken *param_1) {
   undefined8 uVar1;
   uVar1 = 0xffffffff;
...
/* glslang::TPpContext::tMarkerInput::getch() */undefined8 glslang::TPpContext::tMarkerInput::getch(void) {
   return 0xffffffff;
}
/* glslang::TPpContext::tMarkerInput::ungetch() */void glslang::TPpContext::tMarkerInput::ungetch(void) {
   return;
}
/* glslang::TPpContext::tZeroInput::getch() */undefined8 glslang::TPpContext::tZeroInput::getch(void) {
   return 0xffffffff;
}
/* glslang::TPpContext::tZeroInput::ungetch() */void glslang::TPpContext::tZeroInput::ungetch(void) {
   return;
}
/* glslang::TPpContext::tZeroInput::~tZeroInput() */void glslang::TPpContext::tZeroInput::~tZeroInput(tZeroInput *this) {
   return;
}
/* glslang::TPpContext::tMarkerInput::~tMarkerInput() */void glslang::TPpContext::tMarkerInput::~tMarkerInput(tMarkerInput *this) {
   return;
}
/* glslang::TPpContext::TokenizableIncludeFile::scan(glslang::TPpToken*) */void glslang::TPpContext::TokenizableIncludeFile::scan(TPpToken *param_1) {
...
/* glslang::TInputScanner::~TInputScanner() */void glslang::TInputScanner::~TInputScanner(TInputScanner *this) {
...
/* std::_Rb_tree<int, std::pair<int const, glslang::TPpContext::MacroSymbol>,
   ...
   >::_M_get_insert_unique_pos(int const&) [clone .isra.0] */undefined1[16];std::_Rb_tree<int,std::pair<int_const,glslang::TPpContext::MacroSymbol>,std::_Select1st<std::pair<int_const,glslang::TPpContext::MacroSymbol>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,glslang::TPpContext::MacroSymbol>>>::_M_get_insert_unique_pos (_Rb_tree<int,std::pair<int_const,glslang::TPpContext::MacroSymbol>,std::_Select1st<std::pair<int_const,glslang::TPpContext::MacroSymbol>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,glslang::TPpContext::MacroSymbol>>>
           *this,int *param_1) {
 ...
 while ( p_Var2 != (_Rb_tree_node_base*)0x0 );
   ...
   iVar5 = *(int*)( p_Var4 + 0x20 );
   LAB_00106958:p_Var3 = (_Rb_tree_node_base*)0x0;
   if (iVar5 < iVar6) {
      p_Var4 = p_Var3;
      p_Var3 = p_Var2;
   }
...
/* glslang::TPpContext::TokenizableIncludeFile::notifyDeleted() */void glslang::TPpContext::TokenizableIncludeFile::notifyDeleted(TokenizableIncludeFile *this) {
   long lVar1;
   void *pvVar2;
   code *pcVar3;
   long lVar4;
...
/* void std::__cxx11::string::_M_construct<char*>(char*, char*, std::forward_iterator_tag) [clone
   ...
   memcpy(__dest, param_2, __n);
   __dest = (undefined1*)*param_1;
   LAB_00106b14:param_1[1] = local_28;
   __dest[local_28] = 0;
   if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
...
/* glslang::TPpContext::tMacroInput::~tMacroInput() */void glslang::TPpContext::tMacroInput::~tMacroInput(tMacroInput *this) {
   void *pvVar1;
   long lVar2;
   ulong uVar3;
...
/* glslang::TPpContext::TokenizableIncludeFile::notifyActivated() */void glslang::TPpContext::TokenizableIncludeFile::notifyActivated(TokenizableIncludeFile *this) {
   long lVar1;
   undefined8 uVar2;
   long lVar3;
   undefined8 *puVar4;
   ...
   *(TokenizableIncludeFile**)( lVar10 + 0xd8 ) = this + 0x90;
   ...
   if (( (long)puVar4 - *(long*)( lVar1 + 0x210 ) >> 3 ) + ( ( lVar10 >> 3 ) + -1 + ( ulong )(plVar8 == (long*)0x0) ) * 0x40 + ( *(long*)( lVar1 + 0x1f8 ) - *(long*)( lVar1 + 0x1e8 ) >> 3 ) == 0xfffffffffffffff) {
      LAB_00106f34:/* WARNING: Subroutine does not return */std::__throw_length_error("cannot create std::deque larger than max_size()");
   }
   ...
   if (uVar7 - ( (long)plVar8 - *(long*)( lVar1 + 0x1d8 ) >> 3 ) < 2) {
      ...
      if (( ulong )((long)__dest * 2) < uVar7) {
         ...
         if (uVar7 == 0) {
            uVar7 = 0x18;
            uVar9 = 3;
            LAB_00106dd7:unaff_R15 = operator_new(uVar7);
            __src = *(long**)( lVar1 + 0x200 );
   ...
   *(undefined8**)( lVar1 + 0x218 ) = puVar4 + 0x40;
   LAB_00106cba:*(undefined8**)( lVar1 + 0x208 ) = puVar4;
   return;
}
/* glslang::TPpContext::tMacroInput::~tMacroInput() */void glslang::TPpContext::tMacroInput::~tMacroInput(tMacroInput *this) {
   void *pvVar1;
...
/* glslang::TPpContext::TokenizableIncludeFile::~TokenizableIncludeFile() */void glslang::TPpContext::TokenizableIncludeFile::~TokenizableIncludeFile(TokenizableIncludeFile *this) {
...
/* glslang::TInputScanner::get() */uint glslang::TInputScanner::get(TInputScanner *this) {
   byte bVar1;
   int iVar2;
   int iVar3;
   long lVar4;
 ...
 while ( lVar6 != ( ( ulong )(uint)(iVar2 - iVar7) + lVar10 ) * 8 );
   ...
   return 0xffffffff;
   LAB_00107451:if (( iVar2 <= iVar7 ) || ( *(long*)( lVar4 + lVar6 * 8 ) != 0 )) {
      LAB_0010746c:*(undefined8*)( this + 0x28 ) = 0;
      return uVar9;
   }
...
/* glslang::TInputScanner::unget() */void glslang::TInputScanner::unget(TInputScanner *this) {
   int *piVar1;
   int iVar2;
   long lVar3;
   long lVar4;
 ...
 while ( lVar7 == 0 );
         *(int*)( this + 0x20 ) = iVar2;
         LAB_00107613:*(long*)( this + 0x28 ) = lVar7 + -1;
         iVar2 = *(int*)( this + 0x20 );
      }
 else {
 ...
 while ( lVar4 != 0 );
            ...
            lVar4 = 0;
            LAB_001075fd:iVar5 = (int)lVar3 - (int)lVar4;
            *(int*)( this + 0x50 ) = iVar5;
      ...
      LAB_0010753d:if (*(int*)( this + 8 ) <= iVar2) {
         this[0x59] = (TInputScanner)0x1;
         return;
      }
...
/* WARNING: Removing unreachable block (ram,0x00107785) *//* glslang::TPpContext::TokenizableIncludeFile::ungetch() */void glslang::TPpContext::TokenizableIncludeFile::ungetch(TokenizableIncludeFile *this) {
   char cVar1;
   int iVar2;
...
;
 ...
 while ( ( ( ulong )(uint)(*(int*)( this_00 + 8 ) - iVar6) + (long)iVar6 ) * 8 != lVar5 );
         ...
         LAB_00107710:TInputScanner::unget(this_00);
         iVar6 = *(int*)( this_00 + 0x20 );
         if (*(int*)( this_00 + 8 ) <= iVar6) {
            this_00[0x59] = (TInputScanner)0x1;
            LAB_001077a1:TInputScanner::get(this_00);
            return;
         }
         ...
         while (*(ulong*)( lVar3 + lVar5 ) <= uVar7) {
            lVar5 = lVar5 + 8;
            uVar7 = 0;
            if (( ( ulong )(uint)(*(int*)( this_00 + 8 ) - iVar6) + (long)iVar6 ) * 8 == lVar5) goto LAB_001077a1;
         }
;
...
/* glslang::TPpContext::tStringInput::getch() */int glslang::TPpContext::tStringInput::getch(tStringInput *this) {
 ...
 while ( ( ( ulong )(uint)(*(int*)( pTVar1 + 8 ) - iVar4) + (long)iVar4 ) * 8 != lVar6 );
      ...
      do {
         if (uVar7 < *(ulong*)( *(long*)( pTVar1 + 0x18 ) + lVar5 )) {
            if (*(char*)( *(long*)( *(long*)( pTVar1 + 0x10 ) + lVar5 ) + uVar7 ) == '\r') goto LAB_00107813;
            break;
         }
...
;
      ...
      LAB_00107813:pTVar9 = pTVar1 + 0x40;
      ...
      cVar3 = ( **(code**)( *plVar2 + 0x1b0 ) )(plVar2, pTVar9, *(undefined1*)( *(long*)( this + 0x10 ) + 0x1b0 ));
...
/* glslang::TPpContext::TokenizableIncludeFile::getch() */void glslang::TPpContext::TokenizableIncludeFile::getch(TokenizableIncludeFile *this) {
...
/* glslang::TPpContext::TokenizableIncludeFile::TokenizableIncludeFile(glslang::TSourceLoc const&,
   ...
   const&, glslang::TPpContext*) */void glslang::TPpContext::TokenizableIncludeFile::TokenizableIncludeFile(TokenizableIncludeFile *this, TSourceLoc *param_1, string *param_2, IncludeResult *param_3, string *param_4, TPpContext *param_5) {
   int iVar1;
   long lVar2;
   int iVar3;
   undefined8 *puVar4;
   ...
   *(TokenizableIncludeFile**)( this + 0x18 ) = this + 0x28;
   std::__cxx11::string::_M_construct<char*>(this + 0x18, *(long*)param_2, *(long*)( param_2 + 8 ) + *(long*)param_2);
 ...
 while ( iVar3 - iVar1 != iVar9 );
   ...
   *(undefined8*)( this + 0xd8 ) = uVar7;
   ...
   std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::_M_construct<char_const*>(puVar4, pcVar11, pcVar10);
   ...
   *(undefined8**)( *(long*)( this + 0xc0 ) + 0x18 ) = puVar4;
   if (*(long*)param_1 == 0) {
      ...
      *puVar4 = uVar7;
      puVar4[1] = puVar4 + 3;
      if (pcVar11 == (char*)0x0) {
         LAB_00107e37:/* WARNING: Subroutine does not return */std::__throw_logic_error("basic_string: construction from null is not valid");
      }
...
std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::_M_append
   ...
   if (__dest == this + 0x18) {
      ...
      if (uVar2 < uVar1) {
         ...
         if (__n != 0) {
            if (__n == 1) {
               *__dest = **(basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>**)( this + 8 );
               ...
               memcpy(__dest, *(basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>**)( this + 8 ), __n);
            }
         ...
         if (( param_1 != (char*)0x0 ) && ( param_2 != 0 )) {
            if (param_2 == 1) {
               __dest[__n] = ( basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> ) * param_1;
            }
 else {
   ...
   LAB_00107eac:*(ulong*)( this + 0x10 ) = uVar1;
   __dest[uVar1] = (basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>)0x0;
   return this;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* glslang::TSourceLoc::getStringNameOrNum[abi:cxx11](bool) const */ulong *glslang::TSourceLoc::getStringNameOrNum_abi_cxx11_(bool param_1) {
   undefined1 *puVar1;
   undefined1 auVar2[16];
   int iVar3;
   ulong *puVar4;
   ...
   if (lVar11 != 0) {
      if (in_DL == '\0') {
         ...
         if (uVar14 < 0x10) {
            ...
            local_160[0] = uVar14;
            LAB_00108542:memcpy(local_170, puVar1, uVar14);
         }
         ...
         *(undefined1*)( (long)local_170 + uVar14 ) = 0;
         ...
         if (0xf < uVar14) {
            if ((long)uVar14 < 0) {
               LAB_0010880d:/* WARNING: Subroutine does not return */std::__throw_length_error("basic_string::_M_create");
            }
         ...
         LAB_00108088:local_130[0] = uVar9;
         local_140 = puVar4;
         std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::_M_append((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>*)&local_148, "\"", 1);
         if (( 0x7fffffffffffffffU - (long)local_138 < uVar15 ) || ( std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::_M_append((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>*)&local_148, pcVar7, uVar15),local_138 == (ulong*)0x7fffffffffffffff )) {
            LAB_001082b7:/* WARNING: Subroutine does not return */std::__throw_length_error("basic_string::append");
         }

         puVar5 = (ulong*)std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::_M_append((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>*)&local_148, "\"", 1);
         local_170 = local_160;
         local_178 = *puVar5;
         puVar4 = puVar5 + 3;
         if ((ulong*)puVar5[1] == puVar4) {
            ...
            uVar6 = (uint)uVar14;
            if (7 < uVar6) {
               *(undefined8*)( (long)local_160 + ( ( uVar14 & 0xffffffff ) - 8 ) ) = *(undefined8*)( (long)puVar5 + ( uVar14 & 0xffffffff ) + 0x10 );
               if (7 < uVar6 - 1) {
                  uVar8 = 0;
                  do {
                     uVar14 = (ulong)uVar8;
 ...
 while ( uVar8 < ( uVar6 - 1 & 0xfffffff8 ) );
            ...
            if (( uVar14 & 4 ) == 0) {
               if (uVar6 != 0) {
                  ...
                  *(undefined2*)( (long)local_160 + ( ( uVar14 & 0xffffffff ) - 2 ) ) = *(undefined2*)( (long)puVar5 + ( uVar14 & 0xffffffff ) + 0x16 );
                  local_168 = puVar5[2];
               }
               ...
               *(undefined4*)( (long)local_160 + ( ( uVar14 & 0xffffffff ) - 4 ) ) = *(undefined4*)( (long)puVar5 + ( uVar14 & 0xffffffff ) + 0x14 );
               local_168 = puVar5[2];
            }
            ...
            LAB_00108119:local_168 = puVar5[2];
         }
      ...
      if (puVar5 < (ulong*)0x10) {
         ...
         local_138 = local_180;
         ppuVar10 = local_148;
         LAB_00108261:memcpy(ppuVar10, puVar4, (size_t)puVar5);
         ppuVar10 = local_148;
      }
            ...
            if (( (ulong)puVar1 & 4 ) == 0) {
               if (uVar6 != 0) {
                  *(undefined1*)( puVar13 + 2 ) = local_138._0_1_;
                  if (( (ulong)puVar1 & 2 ) != 0) {
                     *(undefined2*)( (long)puVar13 + ( (ulong)puVar1 & 0xffffffff ) + 0xe ) = *(undefined2*)( (long)&local_140 + ( (ulong)puVar1 & 0xffffffff ) + 6 );
                  }
               ...
               *(undefined4*)( (long)puVar13 + ( (ulong)puVar1 & 0xffffffff ) + 0xc ) = *(undefined4*)( (long)&local_140 + ( (ulong)puVar1 & 0xffffffff ) + 4 );
            }

         }
 else {
            puVar13[2] = (ulong)local_138;
            *(undefined8*)( (long)puVar13 + ( (ulong)puVar1 & 0xffffffff ) + 8 ) = *(undefined8*)( (long)&local_140 + ( (ulong)puVar1 & 0xffffffff ) );
            ...
            if (7 < uVar6) {
               ...
               do {
                  uVar8 = (int)uVar14 + 8;
                  *(undefined8*)( ( ( ulong )(puVar13 + 3) & 0xfffffffffffffff8 ) + uVar14 ) = *(undefined8*)( (long)&local_138 + ( uVar14 - lVar11 ) );
                  uVar14 = (ulong)uVar8;
               }
 while ( uVar8 < uVar6 );
            }
   ...
   if (uVar14 < 10) {
      *puVar13 = ( ulong )(puVar13 + 2);
      ...
      LAB_001084c6:*pcVar7 = (char)uVar14 + '0';
   }
 else {
      if (uVar14 < 100) {
         *puVar13 = ( ulong )(puVar13 + 2);
         ...
         if (uVar14 < 1000) {
            uVar6 = 2;
            iVar3 = 3;
            LAB_00108569:cVar12 = (char)iVar3 - cVar12;
            *puVar13 = ( ulong )(puVar13 + 2);
         }
 else {
            if (uVar14 < 10000) {
            ...
            uVar6 = 5;
            LAB_00108368:cVar12 = ( '\x01' - cVar12 ) + (char)uVar6;
            *puVar13 = ( ulong )(puVar13 + 2);
         }
         ...
         do {
            ...
            lVar11 = ( uVar15 + ( ( SUB168(auVar2 * ZEXT816(0x28f5c28f5c28f5c3), 8) & 0xfffffffffffffffc ) + uVar14 ) * -0x14 ) * 2;
 ...
 while ( 9999 < uVar15 );
   ...
   LAB_001081ae:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* std::vector<std::__cxx11::basic_string<char, std::char_traits<char>,
   ...
   const&) */void std::vector<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const*,glslang::pool_allocator<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const*>>::_M_fill_insert(vector<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const*,glslang::pool_allocator<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const*>> *this, undefined8 *param_2, ulong param_3, undefined8 *param_4) {
   undefined8 uVar1;
   ulong uVar2;
   long lVar3;
   long lVar4;
 ...
 while ( param_3 != uVar2 );
   ...
   puVar9 = puVar11 + param_3;
   LAB_001088c8:lVar4 = (long)puVar9 + ( (long)puVar11 - (long)param_2 );
   if (puVar11 == param_2) {
...
/* void std::vector<glslang::TPpContext::tInput*, std::allocator<glslang::TPpContext::tInput*>
   ...
   glslang::TPpContext::tInput* const&) */void std::vector<glslang::TPpContext::tInput*,std::allocator<glslang::TPpContext::tInput*>>::_M_realloc_insert<glslang::TPpContext::tInput*const&>(vector<glslang::TPpContext::tInput*,std::allocator<glslang::TPpContext::tInput*>> *this, void *param_2, undefined8 *param_3) {
   void *__dest;
   void *pvVar1;
   void *__src;
   ulong uVar2;
   ...
   if (__src == pvVar1) {
      ...
      uVar3 = uVar3 << 3;
      LAB_00108c5a:__dest_00 = operator_new(uVar3);
      lVar4 = uVar3 + (long)__dest_00;
   }
 else {
      uVar3 = uVar2 * 2;
      if (uVar3 < uVar2) {
         LAB_00108c50:uVar3 = 0x7ffffffffffffff8;
         goto LAB_00108c5a;
      }
   ...
   *(undefined8*)( (long)__dest_00 + __n ) = *param_3;
   ...
   LAB_00108c2c:*(void**)this = __dest_00;
...
/* void std::vector<int, std::allocator<int> >::_M_realloc_insert<int
    ...
    */void std::vector<int,std::allocator<int>>::_M_realloc_insert<int_const&>(vector<int,std::allocator<int>> *this, void *param_2, undefined4 *param_3) {
   void *__dest;
   void *pvVar1;
   void *__src;
   ulong uVar2;
   ...
   if (__src == pvVar1) {
      ...
      uVar3 = uVar3 << 2;
      LAB_00108dea:__dest_00 = operator_new(uVar3);
      lVar4 = uVar3 + (long)__dest_00;
   }
 else {
      uVar3 = uVar2 * 2;
      if (uVar3 < uVar2) {
         LAB_00108de0:uVar3 = 0x7ffffffffffffffc;
         goto LAB_00108dea;
      }
   ...
   *(undefined4*)( (long)__dest_00 + __n ) = *param_3;
   ...
   operator_delete(__src, *(long*)( this + 0x10 ) - (long)__src);
   LAB_00108dbb:*(void**)this = __dest_00;
   *(size_t*)( this + 8 ) = (long)__dest + __n_00;
   *(long*)( this + 0x10 ) = lVar4;
   return;
}
/* void std::vector<glslang::TSourceLoc, std::allocator<glslang::TSourceLoc>
   ...
   std::allocator<glslang::TSourceLoc> > >, glslang::TSourceLoc const&) */void std::vector<glslang::TSourceLoc,std::allocator<glslang::TSourceLoc>>::_M_realloc_insert<glslang::TSourceLoc_const&>(vector<glslang::TSourceLoc,std::allocator<glslang::TSourceLoc>> *this, void *param_2, undefined8 *param_3) {
   void *__dest;
   void *pvVar1;
   void *__src;
   undefined8 uVar2;
   ...
   if (__src == pvVar1) {
      ...
      uVar6 = uVar6 * 0x18;
      LAB_00108f8a:__dest_00 = operator_new(uVar6);
      lVar4 = uVar6 + (long)__dest_00;
   }
 else {
      uVar6 = lVar4 * 0x5555555555555556;
      if (uVar6 < uVar5) {
         LAB_00108f80:uVar6 = 0x7ffffffffffffff8;
         goto LAB_00108f8a;
      }
   ...
   *(undefined8*)( (long)__dest_00 + __n ) = uVar2;
   ...
   operator_delete(__src, *(long*)( this + 0x10 ) - (long)__src);
   LAB_00108f66:*(void**)this = __dest_00;
   *(size_t*)( this + 8 ) = (long)__dest + __n_00;
   *(long*)( this + 0x10 ) = lVar4;
   return;
}
/* glslang::TPpContext::scanToken(glslang::TPpToken*) */int glslang::TPpContext::scanToken(TPpContext *this, TPpToken *param_1) {
   int iVar1;
   undefined8 *puVar2;
   undefined8 uVar3;
   char cVar4;
                     ...
                     if (1 < (int)( (long)piVar10 - (long)piVar7 >> 2 )) {
                        ...
                        do {
                           ...
                           if (( ( piVar7[lVar6] == 0x23 ) && ( iVar8 = iVar9 + 2 ),piVar7[lVar6 + 1] != 0x23 )) {
                              ( **(code**)( **(long**)( this + 0x100 ) + 0x168 ) )(*(long**)( this + 0x100 ), *(long*)( this + 0x120 ) + lVar6 * 0x18, "(#) can be preceded in its line only by spaces or horizontal tabs", &_LC25, &_LC3);
                              piVar10 = *(int**)( this + 0x110 );
                              piVar7 = *(int**)( this + 0x108 );
                           }
 ...
 while ( iVar8 < (int)( (long)piVar10 - (long)piVar7 >> 2 ) + -1 );
                     ...
                     if (*(int**)( this + 0x118 ) == piVar10) {
                        std::vector<int,std::allocator<int>>::_M_realloc_insert<int_const&>((vector<int,std::allocator<int>>*)( this + 0x108 ), piVar10, &local_44);
                     }
 else {
                        *piVar10 = iVar5;
                     ...
                     if (puVar2 == *(undefined8**)( this + 0x130 )) {
                        std::vector<glslang::TSourceLoc,std::allocator<glslang::TSourceLoc>>::_M_realloc_insert<glslang::TSourceLoc_const&>((vector<glslang::TSourceLoc,std::allocator<glslang::TSourceLoc>>*)( this + 0x120 ), puVar2, param_1);
                     }
 else {
...
/* std::vector<glslang::TPpContext::TokenStream*,
   glslang::pool_allocator<glslang::TPpContext::TokenStream*> >::_M_default_append(unsigned long) */void std::vector<glslang::TPpContext::TokenStream*,glslang::pool_allocator<glslang::TPpContext::TokenStream*>>::_M_default_append(vector<glslang::TPpContext::TokenStream*,glslang::pool_allocator<glslang::TPpContext::TokenStream*>> *this, ulong param_1) {
   ulong uVar1;
   void *__s;
   void *pvVar2;
   ulong uVar3;
   ...
   if (( ulong )(*(long*)( this + 0x18 ) - (long)__s >> 3) < param_1) {
      ...
      if (( param_1 <= uVar6 ) && ( uVar3 = 0xfffffffffffffff < uVar3 )) {
         uVar3 = 0xfffffffffffffff;
      }
...
/* std::__cxx11::basic_string<char, std::char_traits<char>, glslang::std::allocator<char>
   ...
   LAB_00109a3c:*(ulong*)( this + 0x10 ) = __n;
   __dest[__n] = (basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>)0x0;
   return;
}
/* glslang::TPpContext::addMacroDef(int, glslang::TPpContext::MacroSymbol&) */void glslang::TPpContext::addMacroDef(TPpContext *this, int param_1, MacroSymbol *param_2) {
...
;
 ...
 while ( *(_Rb_tree_node_base**)( p_Var7 + 0x18 ) != (_Rb_tree_node_base*)0x0 );
      LAB_00109b20:if (( p_Var1 != p_Var9 ) && ( *(int*)( p_Var9 + 0x20 ) <= param_1 )) goto LAB_00109bed;
   }
   ...
   *(undefined8*)( p_Var5 + 0x48 ) = uVar6;
   for (int i = 0; i < 4; i++) {
      *(undefined8*)( p_Var5 + ( 8*i + 80 ) ) = 0;
   }

   if (p_Var1 == p_Var9) {
      if (( *(long*)( this + 0x38 ) == 0 ) || ( p_Var7 = *(_Rb_tree_node_base**)( this + 0x30 ) ),(int)uVar4 <= *(int*)( p_Var7 + 0x20 )) {
         LAB_00109c78:auVar11 = std::_Rb_tree<int,std::pair<int_const,glslang::TPpContext::MacroSymbol>,std::_Select1st<std::pair<int_const,glslang::TPpContext::MacroSymbol>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,glslang::TPpContext::MacroSymbol>>>::_M_get_insert_unique_pos((_Rb_tree<int,std::pair<int_const,glslang::TPpContext::MacroSymbol>,std::_Select1st<std::pair<int_const,glslang::TPpContext::MacroSymbol>>,std::less<int>,glslang::pool_allocator<std::pair<int_const,glslang::TPpContext::MacroSymbol>>>*)( this + 8 ), (int*)(ulong)uVar4);
      ...
      LAB_00109c99:p_Var9 = p_Var7;
      if (( p_Var1 == p_Var7 ) || ( bVar10 )) goto LAB_00109bd2;
      LAB_00109caa:bVar10 = (int)uVar4 < *(int*)( p_Var9 + 0x20 );
   }
 else {
      ...
      LAB_00109bd2:bVar10 = true;
   }

   std::_Rb_tree_insert_and_rebalance(bVar10, p_Var5, p_Var9, p_Var1);
   *(long*)( this + 0x38 ) = *(long*)( this + 0x38 ) + 1;
   p_Var9 = p_Var5;
   LAB_00109bed:std::vector<int,glslang::pool_allocator<int>>::operator =((vector<int,glslang::pool_allocator<int>>*)( p_Var9 + 0x28 ), (vector*)param_2);
   std::vector<glslang::TPpContext::TokenStream::Token,glslang::pool_allocator<glslang::TPpContext::TokenStream::Token>>::operator =((vector<glslang::TPpContext::TokenStream::Token,glslang::pool_allocator<glslang::TPpContext::TokenStream::Token>>*)( p_Var9 + 0x48 ), (vector*)( param_2 + 0x20 ));
   *(undefined8*)( p_Var9 + 0x68 ) = *(undefined8*)( param_2 + 0x40 );
   ...
   p_Var9[0x70] = ( _Rb_tree_node_base )((byte)_Var2 & 0xf8 | bVar8 | (byte)MVar3 & 2 | (byte)param_2[0x48] & 4);
   return;
}
/* void std::vector<std::__cxx11::basic_string<char, std::char_traits<char>,
   ...
   if (lVar8 == lVar1) {
      ...
      LAB_00109e6f:local_58 = (ulong*)glslang::TPoolAllocator::allocate(*(ulong*)this);
   }
 else {
      uVar5 = lVar3 * -0x6666666666666666;
      if (uVar5 < uVar4) {
         LAB_00109e60:local_48 = 0x333333333333333;
         goto LAB_00109e6f;
      }
   ...
   *puVar7 = uVar5;
   ...
   if (uVar4 < 0x10) {
      ...
      if ((long)uVar4 < 0) {
         LAB_0010a019:/* WARNING: Subroutine does not return */std::__throw_length_error("basic_string::_M_create");
      }
   ...
   for (; param_2 != lVar8; lVar8 = lVar8 + 0x28) {
      ...
      *puVar6 = uVar5;
      if (uVar4 < 0x10) {
         ...
         puVar6[3] = uVar4;
         puVar6[1] = (ulong)puVar7;
         LAB_00109e49:memcpy(puVar7, puVar2, uVar4);
      ...
      do {
         ...
         *puVar6 = uVar5;
         if (uVar4 < 0x10) {
            ...
            puVar6[3] = uVar4;
            puVar6[1] = (ulong)puVar7;
            LAB_00109f0e:memcpy(puVar7, puVar2, uVar4);
            puVar7 = (ulong*)puVar6[1];
         }
...
/* std::_Rb_tree<std::__cxx11::string, std::pair<std::__cxx11::string const, std::__cxx11::string >,
   ...
   long lVar6;
   size_t __n;
   _Rb_tree<std::__cxx11::string,std::pair<std::__cxx11::string_const,std::__cxx11::string>,std::_Select1st<std::pair<std::__cxx11::string_const,std::__cxx11::string>>,std::less<std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,std::__cxx11::string>>> *p_Var7;
   ...
   if (*(_Rb_tree_node_base**)( this + 0x10 ) == (_Rb_tree_node_base*)0x0) {
      p_Var7 = this + 8;
      LAB_0010a154:if (*(_Rb_tree_node_base**)( this + 0x18 ) == (_Rb_tree_node_base*)p_Var7) {
      ...
      do {
         p_Var7 = (_Rb_tree<std::__cxx11::string,std::pair<std::__cxx11::string_const,std::__cxx11::string>,std::_Select1st<std::pair<std::__cxx11::string_const,std::__cxx11::string>>,std::less<std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,std::__cxx11::string>>>*)p_Var5;
         ...
         if (__n == 0) {
            LAB_0010a0c4:uVar4 = uVar10 - uVar9;
            if (0x7fffffff < (long)uVar4) goto LAB_0010a0e2;
            if (-0x80000001 < (long)uVar4) goto LAB_0010a0de;
            LAB_0010a088:p_Var5 = *(_Rb_tree_node_base**)( (_Rb_tree_node_base*)p_Var7 + 0x10 );
            bVar1 = true;
         }
 else {
            ...
            LAB_0010a0de:if ((int)uVar4 < 0) goto LAB_0010a088;
            LAB_0010a0e2:p_Var5 = *(_Rb_tree_node_base**)( (_Rb_tree_node_base*)p_Var7 + 0x18 );
            bVar1 = false;
         }
 ...
 while ( p_Var5 != (_Rb_tree_node_base*)0x0 );
   ...
   LAB_0010a11a:auVar11._8_8_ = p_Var8;
...
/* std::_Rb_tree<std::__cxx11::string, std::pair<std::__cxx11::string const, std::__cxx11::string >,
   ...
   if (param_2 == (_Rb_tree_node_base*)( this + 8 )) {
      if (*(long*)( this + 0x28 ) != 0) {
         ...
         if (( uVar6 == 0 ) || ( iVar3 = memcmp(*(void**)( param_2 + 0x20 ), *(void**)param_3, uVar6) ),iVar3 == 0) {
            lVar5 = uVar2 - uVar1;
   ...
   if (uVar6 == 0) {
      ...
      if (( lVar5 < 0x80000000 ) && ( ( lVar5 < -0x80000000 || ( (int)lVar5 < 0 ) ) )) {
         LAB_0010a2aa:if (*(_Rb_tree_node_base**)( this + 0x18 ) == param_2) goto LAB_0010a27b;
         ...
         if (( uVar6 == 0 ) || ( iVar3 = memcmp(*(void**)( p_Var8 + 0x20 ), __s1, uVar6) ),iVar3 == 0) {
            ...
            LAB_0010a308:if (-1 < iVar3) goto LAB_0010a3f6;
         }
      ...
      LAB_0010a254:uVar6 = uVar2 - uVar1;
      ...
      if (iVar3 == 0) {
         ...
         LAB_0010a243:if (iVar3 < 0) goto LAB_0010a2aa;
      }

      uVar4 = memcmp(__s2, __s1, uVar6);
      uVar6 = (ulong)uVar4;
      if (uVar4 == 0) goto LAB_0010a254;
      LAB_0010a26e:if ((int)uVar6 < 0) {
         LAB_0010a3a0:if (*(_Rb_tree_node_base**)( this + 0x20 ) == param_2) {
            LAB_0010a386:auVar10._8_8_ = 0;
         ...
         if (uVar6 == 0) {
            LAB_0010a3dc:uVar6 = uVar1 - uVar2;
            ...
            LAB_0010a3f2:if (-1 < (int)uVar6) {
               LAB_0010a3f6:auVar10 = _M_get_insert_unique_pos(this, param_3);
               return auVar10;
            }
   ...
   LAB_0010a27b:auVar9._8_8_ = param_2;
   auVar9._0_8_ = p_Var7;
   return auVar9;
}
/* WARNING: Restarted to delay deadcode elimination for space: stack *//* glslang::TIntermediate::addIncludeText(char const*, char const*, unsigned long) */void glslang::TIntermediate::addIncludeText(char *param_1, char *param_2, ulong param_3) {
   _Rb_tree_node_base *p_Var1;
   _Rb_tree_node_base *p_Var2;
   ulong uVar3;
   ulong *__s2;
   ...
   if (__n < 0x10) {
      ...
      local_58[0] = local_70;
      puVar8 = local_68;
      LAB_0010a706:memcpy(puVar8, param_2, __n);
      puVar8 = local_68;
   }
   ...
   if (*(_Rb_tree_node_base**)( param_1 + 0x7b0 ) != (_Rb_tree_node_base*)0x0) {
      do {
         while (true) {
            ...
            if (( uVar10 != 0 ) && ( iVar4 = memcmp(*(void**)( p_Var6 + 0x20 ), __s2, uVar10) ),iVar4 != 0) break;
            lVar13 = uVar11 - uVar3;
...
;
 ...
 while ( *(_Rb_tree_node_base**)( p_Var6 + 0x18 ) != (_Rb_tree_node_base*)0x0 );
   ...
   LAB_0010a5a7:p_Var6 = (_Rb_tree_node_base*)operator_new(0x60);
   uVar3 = local_60;
   p_Var1 = p_Var6 + 0x30;
         ...
         if (( uVar11 & 4 ) == 0) {
            if (uVar5 != 0) {
               *p_Var1 = local_58[0]._0_1_;
               if (( uVar11 & 2 ) != 0) {
                  *(undefined2*)( p_Var6 + ( uVar11 & 0xffffffff ) + 0x2e ) = *(undefined2*)( (long)local_58 + ( ( uVar11 & 0xffffffff ) - 2 ) );
               }
            ...
            *(undefined4*)( p_Var6 + ( uVar11 & 0xffffffff ) + 0x2c ) = *(undefined4*)( (long)local_58 + ( ( uVar11 & 0xffffffff ) - 4 ) );
         }

      }
 else {
         *(ulong*)p_Var1 = local_58[0];
         *(undefined8*)( p_Var6 + ( uVar11 & 0xffffffff ) + 0x28 ) = *(undefined8*)( (long)local_58 + ( ( uVar11 & 0xffffffff ) - 8 ) );
         ...
         if (7 < uVar5) {
            ...
            do {
               uVar7 = (int)uVar11 + 8;
               *(undefined8*)( ( ( ulong )(p_Var6 + 0x38) & 0xfffffffffffffff8 ) + uVar11 ) = *(undefined8*)( (long)local_58 + ( uVar11 - lVar13 ) );
               uVar11 = (ulong)uVar7;
            }
 while ( uVar7 < uVar5 );
         }
   ...
   *(_Rb_tree_node_base**)( p_Var6 + 0x40 ) = p_Var6 + 0x50;
   ...
   local_68 = local_58;
   auVar15 = std::_Rb_tree<std::__cxx11::string,std::pair<std::__cxx11::string_const,std::__cxx11::string>,std::_Select1st<std::pair<std::__cxx11::string_const,std::__cxx11::string>>,std::less<std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,std::__cxx11::string>>>::_M_get_insert_hint_unique_pos((_Rb_tree<std::__cxx11::string,std::pair<std::__cxx11::string_const,std::__cxx11::string>,std::_Select1st<std::pair<std::__cxx11::string_const,std::__cxx11::string>>,std::less<std::__cxx11::string>,std::allocator<std::pair<std::__cxx11::string_const,std::__cxx11::string>>>*)( param_1 + 0x7a0 ), p_Var14, p_Var6 + 0x20);
   ...
   if (( p_Var2 == p_Var9 ) || ( p_Var14 != (_Rb_tree_node_base*)0x0 )) {
      ...
      if (( uVar10 == 0 ) || ( iVar4 = memcmp(*(void**)( p_Var6 + 0x20 ), *(void**)( p_Var9 + 0x20 ), uVar10) ),iVar4 == 0) {
         lVar13 = uVar3 - uVar11;
         bVar12 = false;
   ...
   LAB_0010a654:std::_Rb_tree_insert_and_rebalance(bVar12, p_Var6, p_Var9, p_Var2);
   *(long*)( param_1 + 0x7c8 ) = *(long*)( param_1 + 0x7c8 ) + 1;
   p_Var14 = p_Var6;
   LAB_0010a66d:std::__cxx11::string::_M_replace(( ulong )(p_Var14 + 0x40), 0, *(char**)( p_Var14 + 0x48 ), param_3);
   if (local_68 != local_58) {
...
/* std::_Hashtable<std::__cxx11::basic_string<char, std::char_traits<char>,
   ...
   std::__cxx11::basic_string<char, std::char_traits<char>, glslang::std::allocator<char> > const&,
   unsigned long) const */long *__thiscallstd::_Hashtable<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::hash<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>::_M_find_before_node(_Hashtable<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>,std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>,glslang::pool_allocator<std::pair<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>const,int>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::hash<std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>> *this, ulong param_1, basic_string *param_2, ulong param_3) {
   long *plVar1;
   size_t __n;
   int iVar2;
   ulong uVar3;
 ...
 while ( ( plVar1 != (long*)0x0 ) && ( uVar3 = plVar1[7] ),plVar5 = plVar4,param_1 == uVar3 % *(ulong*)( this + 0x10 ) );
      plVar5 = (long*)0x0;
   }

   return plVar5;
}
/* WARNING: Control flow encountered bad instruction data *//* glslang::TPpContext::TokenizableIncludeFile::~TokenizableIncludeFile() */void glslang::TPpContext::TokenizableIncludeFile::~TokenizableIncludeFile(TokenizableIncludeFile *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* glslang::TPpContext::tMacroInput::~tMacroInput() */void glslang::TPpContext::tMacroInput::~tMacroInput(tMacroInput *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* glslang::TPpContext::TokenizableIncludeFile::TokenizableIncludeFile(glslang::TSourceLoc const&,
   std::__cxx11::string const&, glslang::TShader::Includer::IncludeResult*, std::__cxx11::string
   const&, glslang::TPpContext*) */void glslang::TPpContext::TokenizableIncludeFile::TokenizableIncludeFile(TokenizableIncludeFile *this, TSourceLoc *param_1, string *param_2, IncludeResult *param_3, string *param_4, TPpContext *param_5) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
...
/* WARNING: Control flow encountered bad instruction data *//* glslang::TPpContext::tMarkerInput::~tMarkerInput() */void glslang::TPpContext::tMarkerInput::~tMarkerInput(tMarkerInput *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* glslang::TPpContext::tZeroInput::~tZeroInput() */void glslang::TPpContext::tZeroInput::~tZeroInput(tZeroInput *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

...
/* enumEitherTrie(UTrie2 const*, int, int, unsigned int (*)(void const*, unsigned int), signed char
   (*)(void const*, int, int, unsigned int), void const*) */void enumEitherTrie(UTrie2 *param_1, int param_2, int param_3, _func_uint_void_ptr_uint *param_4, _func_signed_void_ptr_int_int_uint *param_5, void *param_6) {
   uint uVar1;
   uint uVar2;
   char cVar3;
   uint uVar4;
         ...
         if (param_2 < 0x10000) {
            ...
            if (( param_2 & 0xfffff800U ) == 0xd800) {
               ...
               if (uVar9 != local_54) {
                  ...
                  uVar11 = uVar9;
                  LAB_0010049e:uVar15 = param_2;
                  if (local_58 <= (uint)uVar13) goto LAB_00100187;
                  LAB_00100243:do {
                     while (true) {
                        if (lVar12 == 0) {
                           uVar15 = *(uint*)( *(long*)( param_1 + 0x48 ) + 0x880 + (long)(int)( uVar11 + (int)uVar13 ) * 4 );
                        }
 else {
...
;
 ...
 while ( (int)uVar13 < (int)local_58 );
            ...
            LAB_0010010d:if (( ( uVar4 != uVar5 ) && ( uVar1 = uVar4 ),uVar16 = local_74,uVar2 = param_2,(int)uVar17 < param_2 )) {
               return;
            }
 ...
 while ( param_2 < iVar10 );
   ...
   uVar11 = uVar5;
   uVar16 = uVar17;
   if (( param_2 <= param_3 ) && ( uVar4 = param_2 < param_3 )) {
      if (lVar12 == 0) {
         uVar4 = *(uint*)( *(long*)( *(long*)( param_1 + 0x48 ) + 0x23300 ) + -0x10 + (long)*(int*)( *(long*)( param_1 + 0x48 ) + 0x23318 ) * 4 );
      }
 else if (local_a8 == 0) {
...
/* get32(UNewTrie2 const*, int, signed char) */undefined4 get32(long param_1, uint param_2, byte param_3) {
   int iVar1;
   if ((int)param_2 < *(int*)( param_1 + 0x23328 )) {
      ...
      return *(undefined4*)( *(long*)( param_1 + 0x23300 ) + -0x10 + (long)*(int*)( param_1 + 0x23318 ) * 4 );
   }

   iVar1 = ( (int)param_2 >> 5 & 0x3fU ) + *(int*)( param_1 + (long)( (int)param_2 >> 0xb ) * 4 );
   LAB_00100583:return *(undefined4*)( *(long*)( param_1 + 0x23300 ) + (long)(int)( ( param_2 & 0x1f ) + *(int*)( param_1 + 0x880 + (long)iVar1 * 4 ) ) * 4 );
}
ulong utrie2_get32_76_godot(long *param_1, undefined8 param_2) {
   ...
   if (param_1[1] != 0) {
      ...
      LAB_001005dc:return ( ulong ) * (ushort*)( lVar1 + lVar3 );
   }
   ...
   if (uVar7 < 0xd800) {
      return ( ulong ) * (uint*)( lVar1 + (long)(int)( ( uVar7 & 0x1f ) + ( uint ) * (ushort*)( *param_1 + (long)(int)uVar2 * 2 ) * 4 ) * 4 );
   }
   ...
   lVar3 = (long)(int)( ( uVar7 & 0x1f ) + ( uint ) * (ushort*)( lVar3 + (long)(int)( uVar2 + uVar6 ) * 2 ) * 4 ) << 2;
   LAB_00100659:return ( ulong ) * (uint*)( lVar1 + lVar3 );
}
ulong utrie2_get32FromLeadSurrogateCodeUnit_76_godot(long *param_1, undefined8 param_2) {
   ...
   if (param_1[1] != 0) {
      return ( ulong ) * (ushort*)( *param_1 + (long)(int)( ( uVar2 & 0x1f ) + ( uint ) * (ushort*)( *param_1 + (long)( (int)uVar2 >> 5 ) * 2 ) * 4 ) * 2 );
   }

   if (param_1[2] != 0) {
      return ( ulong ) * (uint*)( param_1[2] + (long)(int)( ( uVar2 & 0x1f ) + ( uint ) * (ushort*)( *param_1 + (long)( (int)uVar2 >> 5 ) * 2 ) * 4 ) * 4 );
   }
...
uint utrie2_internalU8NextIndex_76_godot(long *param_1, undefined4 param_2, long param_3, long param_4) {
   ...
   LAB_00100844:if (local_10 != *(long*)( in_FS_OFFSET + 0x28 )) {
...
uint utrie2_internalU8PrevIndex_76_godot(long *param_1, undefined4 param_2, long param_3, long param_4) {
   ...
   LAB_00100970:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 *utrie2_openFromSerialized_76_godot(uint param_1, int *param_2, int param_3, int *param_4, int *param_5) {
   long lVar1;
   ushort uVar2;
   undefined4 uVar3;
   long lVar4;
   ...
   if (*param_5 < 1) {
      if (( ( param_3 < 1 ) || ( ( (ulong)param_2 & 3 ) != 0 ) ) || ( 1 < param_1 )) {
         *param_5 = 1;
         ...
         if (( ( 0xf < param_3 ) && ( *param_2 == 0x54726932 ) ) && ( ( *(ushort*)( param_2 + 1 ) & 0xf ) == param_1 )) {
   ...
   LAB_00100bb7:puVar7 = (undefined8*)0x0;
   LAB_00100bb9:if (lVar4 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return puVar7;
   }
...
undefined1(*)[16];utrie2_openDummy_76_godot(uint param_1, uint param_2, uint param_3, int *param_4) {
            ...
            *(undefined4**)( pauVar2[3] + 8 ) = puVar3;
            if (puVar3 != (undefined4*)0x0) {
               ...
               *(undefined4*)( pauVar2[2] + 0xc ) = 0;
               auVar13 = pshuflw(auVar13, ZEXT416((uint)CONCAT62(( int6 )(uVar4 >> 0x10), (short)uVar4 + 0x80)), 0);
               *(undefined8*)( pauVar2[1] + 8 ) = uVar1;
               *puVar3 = 0x54726932;
               uVar11 = CONCAT22(-(ushort)(param_1 == 0), -(ushort)(param_1 == 0));
               auVar12._0_8_ = CONCAT44(uVar11, uVar11) & 0x210021002100210;
               auVar12._8_4_ = uVar11 & 0x2100210;
               auVar12._12_4_ = uVar11 & 0x2100210;
               puVar3[2] = 0x31;
               *(uint*)pauVar2[3] = ( -(uint)(param_1 == 0) & 0x840 ) + 0xc0;
               uVar11 = -(uint)(param_1 == 0) & 0xffff0840;
               *(undefined2*)pauVar2[2] = 0;
               uVar10 = (undefined2)uVar11;
               *(undefined2*)( pauVar2[2] + 2 ) = uVar10;
               *(undefined2*)( (long)puVar3 + 6 ) = 0x840;
               *(undefined2*)( puVar3 + 3 ) = uVar10;
               *(undefined2*)( (long)puVar3 + 0xe ) = 0;
               *(undefined1(**) [16])*pauVar2 = (undefined1(*) [16])( puVar3 + 4 );
 ...
 while ( pauVar6 != (undefined1(*) [16])( puVar3 + 0x414 ) );
               puVar3[0x414] = auVar13._0_4_;
               auVar13 = pshuflw(auVar12, ZEXT416(uVar11), 0);
               puVar8 = puVar3 + 0x415;
               do {
                  puVar7 = puVar8;
 ...
 while ( puVar8 != puVar3 + 0x424 );
               if (param_1 != 1) {
                  puVar9 = puVar3 + 0x464;
                  *(uint**)( *pauVar2 + 8 ) = puVar8;
                  uVar11 = CONCAT22((short)param_2, (short)param_2);
                  auVar13 = pshuflw(in_XMM2, ZEXT416(param_2), 0);
                  *(undefined8*)pauVar2[1] = 0;
                  if (( (int)puVar9 - (int)puVar8 & 0x10U ) == 0) goto LAB_00100e00;
                  *puVar8 = uVar11;
                  for (int i = 0; i < 3; i++) {
                     puVar7[( i + 4 )] = uVar11;
                  }

                  for (puVar8 = puVar7 + 7; puVar8 != puVar9; puVar8 = puVar8 + 8) {
                     LAB_00100e00:*puVar8 = uVar11;
                     for (int i = 0; i < 7; i++) {
                        puVar8[( i + 1 )] = uVar11;
                     }
                  ...
                  uVar11 = CONCAT22((short)param_3, (short)param_3);
                  do {
                     *puVar9 = uVar11;
                     for (int i = 0; i < 3; i++) {
                        puVar9[( i + 1 )] = uVar11;
 ...
 while ( puVar8 != puVar3 + 0x484 );
                  *(long*)( puVar3 + 0x484 ) = auVar13._0_8_;
                  return pauVar2;
               }

               puVar9 = puVar3 + 0x4a4;
               *(undefined8*)( *pauVar2 + 8 ) = 0;
               *(uint**)pauVar2[1] = puVar8;
               if (( (int)puVar9 - (int)puVar8 & 0x10U ) == 0) goto LAB_00100e88;
               *puVar8 = param_2;
               for (int i = 0; i < 3; i++) {
                  puVar7[( i + 4 )] = param_2;
               }

               for (puVar8 = puVar7 + 7; puVar9 != puVar8; puVar8 = puVar8 + 8) {
                  LAB_00100e88:*puVar8 = param_2;
                  for (int i = 0; i < 7; i++) {
                     puVar8[( i + 1 )] = param_2;
                  }
 ...
 while ( puVar8 != puVar3 + 0x4e4 );
               for (int i = 0; i < 4; i++) {
                  puVar3[( i + 1252 )] = param_2;
               }
...
int utrie2_serialize_76_godot(long param_1, void *param_2, int param_3, int *param_4) {
   ...
   if (( ( ( ( param_1 != 0 ) && ( *(void**)( param_1 + 0x38 ) != (void*)0x0 ) ) && ( *(long*)( param_1 + 0x48 ) == 0 ) ) && ( -1 < param_3 ) ) && ( ( param_3 == 0 || ( ( param_2 != (void*)0x0 && ( ( (ulong)param_2 & 3 ) == 0 ) ) ) ) )) {
...
void utrie2_enum_76_godot(UTrie2 *param_1, _func_uint_void_ptr_uint *param_2, _func_signed_void_ptr_int_int_uint *param_3, void *param_4) {
   enumEitherTrie(param_1, 0, 0x110000, param_2, param_3, param_4);
   return;
}
void utrie2_enumForLeadSurrogate_76_godot(UTrie2 *param_1, uint param_2, _func_uint_void_ptr_uint *param_3, _func_signed_void_ptr_int_int_uint *param_4, void *param_5) {
   int iVar1;
...
/* icu_76_godot::BackwardUTrie2StringIterator::previous16() */undefined2 icu_76_godot::BackwardUTrie2StringIterator::previous16(BackwardUTrie2StringIterator *this) {
   ushort uVar1;
   ulong uVar2;
   long *plVar3;
   long lVar4;
   ...
   *(uint*)( this + 0x18 ) = (uint)uVar1;
         ...
         if (( *(ushort*)( uVar2 - 4 ) & 0xfc00 ) == 0xd800) {
            ...
            *(uint*)( this + 0x18 ) = uVar6;
            if ((int)uVar6 < *(int*)( (long)plVar3 + 0x2c )) {
               iVar5 = ( uVar6 & 0x1f ) + ( uint ) * (ushort*)( lVar4 + (long)(int)( ( uint ) * (ushort*)( lVar4 + (long)( ( (int)uVar6 >> 0xb ) + 0x820 ) * 2 ) + ( (int)uVar6 >> 5 & 0x3fU ) ) * 2 ) * 4;
            }
 else {
               iVar5 = (int)plVar3[6];
            }
   ...
   return *(undefined2*)( lVar4 + (long)(int)( ( uVar1 & 0x1f ) + ( uint ) * (ushort*)( lVar4 + (long)( ( (int)(uint)uVar1 >> 5 ) + iVar5 ) * 2 ) * 4 ) * 2 );
}
/* icu_76_godot::ForwardUTrie2StringIterator::next16() */undefined2 icu_76_godot::ForwardUTrie2StringIterator::next16(ForwardUTrie2StringIterator *this) {
   ushort uVar1;
   ushort *puVar2;
   long *plVar3;
   long lVar4;
   ...
   *(uint*)( this + 0x18 ) = (uint)uVar1;
      ...
      if (( *(ushort**)( this + 0x20 ) != puVar2 + 1 ) && ( ( puVar2[1] & 0xfc00 ) == 0xdc00 )) {
         ...
         *(uint*)( this + 0x18 ) = uVar5;
         if ((int)uVar5 < *(int*)( (long)plVar3 + 0x2c )) {
            iVar6 = ( uVar5 & 0x1f ) + ( uint ) * (ushort*)( lVar4 + (long)(int)( ( uint ) * (ushort*)( lVar4 + (long)( ( (int)uVar5 >> 0xb ) + 0x820 ) * 2 ) + ( (int)uVar5 >> 5 & 0x3fU ) ) * 2 ) * 4;
         }
 else {
            iVar6 = (int)plVar3[6];
         }
   ...
   return *(undefined2*)( lVar4 + (long)(int)( ( uVar1 & 0x1f ) + ( uint ) * (ushort*)( lVar4 + (long)iVar6 * 2 ) * 4 ) * 2 );
}

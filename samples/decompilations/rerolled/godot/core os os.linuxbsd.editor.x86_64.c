...
/* JSON::_initialize_classv() */void JSON::_initialize_classv(void) {
   ...
   if (initialize_class() == '\0') {
      ...
      undefined8 JSON::is_class(JSON *this, String *param_1) {
         long *plVar1;
         long lVar2;
         char *pcVar3;
         long lVar4;
 ...
 while ( !bVar9 );
      ...
      void JSON::_get_property_listv(JSON *this, List *param_1, bool param_2) {
         long *plVar1;
         long lVar2;
         long lVar3;
         undefined1(*pauVar4)[16];
...
;
 ...
 while ( pVVar2 != local_88 );
   ...
   >::operator[](Pair<String, String> const&) */
      undefined8 * __thiscallHashMap<Pair<String,String>,unsigned_long,PairHash<String,String>,HashMapComparatorDefault<Pair<String,String>>,DefaultTypedAllocator<HashMapElement<Pair<String,String>,unsigned_long>>>::operator [](HashMap<Pair<String,String>,unsigned_long,PairHash<String,String>,HashMapComparatorDefault<Pair<String,String>>,DefaultTypedAllocator<HashMapElement<Pair<String,String>,unsigned_long>>> * this, Pair * param_1);
      {
         long *plVar1;
         undefined8 *puVar2;
         void *pvVar3;
...
;
 ...
 while ( uVar50 != 0 );
         ...
         *puVar49 = uVar53;
         *(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;
         LAB_00108ddc:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
            /* WARNING: Subroutine does not return */
            __stack_chk_fail();
         }
   ...
   String> const&) */
      undefined8 * __thiscallHashMap<Pair<String,String>,double,PairHash<String,String>,HashMapComparatorDefault<Pair<String,String>>,DefaultTypedAllocator<HashMapElement<Pair<String,String>,double>>>::operator [](HashMap<Pair<String,String>,double,PairHash<String,String>,HashMapComparatorDefault<Pair<String,String>>,DefaultTypedAllocator<HashMapElement<Pair<String,String>,double>>> * this, Pair * param_1) * plVar1;
      undefined8 *puVar2;
      void *pvVar3;
      void *__s;
      undefined1 auVar4[16];
...
;
 ...
 while ( uVar50 != 0 );
      ...
      *puVar49 = uVar53;
      *(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;
      LAB_001097dc:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Subroutine does not return */
         __stack_chk_fail();
      }
   ...
   undefined8 *vformat<String,double>(double param_1_00, undefined8 *param_1, bool *param_3, String *param_4) {
      Variant *pVVar1;
      Variant *pVVar2;
      int iVar3;
      long in_FS_OFFSET;
...
;
 ...
 while ( uVar39 != 0 );
   ...
   undefined8 CowData<Logger*>::_realloc(CowData<Logger*> *this, long param_1) {
      undefined8 *puVar1;
      puVar1 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), param_1 + 0x10, false);
      if (puVar1 != (undefined8*)0x0) {
         *puVar1 = 1;
   ...
   undefined8 CowData<Logger*>::resize<false>(CowData<Logger*> *this, long param_1) {
      long *plVar1;
      code *pcVar2;
      long lVar3;
      ulong uVar4;

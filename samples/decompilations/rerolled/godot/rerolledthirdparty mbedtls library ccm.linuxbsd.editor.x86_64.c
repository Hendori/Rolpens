undefined8 ccm_calculate_first_block_if_ready(byte *param_1) {
   ...
   if (( ~uVar1 & 3 ) == 0) {
      if (*(long*)( param_1 + 0x30 ) == 0) {
         ...
         *param_1 = ( byte )((int)( *(long*)( param_1 + 0x30 ) - 2U >> 1 ) << 3) | (char)uVar2 - 1U | *param_1 | ( *(long*)( param_1 + 0x28 ) != 0 ) << 6;
         if (uVar2 != 0) {
            uVar7 = 0;
            uVar5 = 0;
            do {
 ...
 while ( uVar5 < uVar2 );
      ...
      LAB_00100025:uVar4 = 0;
   }

   LAB_00100027:if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar4;
   }
...
int mbedtls_ccm_crypt(long param_1, long param_2, ulong param_3, ulong *param_4, ulong *param_5) {
   ...
   if (param_3 < 8) {
      uVar2 = 0;
      LAB_001001d0:do {
         *(byte*)( (long)param_5 + uVar2 ) = *(byte*)( (long)param_4 + uVar2 ) ^ *(byte*)( (long)puVar3 + uVar2 );
         uVar2 = uVar2 + 1;
      }
 while ( uVar2 < param_3 );
   }
         ...
         *(ulong*)( param_1 + 0x38 ) = *(long*)( param_1 + 0x38 ) + uVar10;
         ...
         if (uVar3 == 1) {
            ...
            *puVar2 = *puVar2 ^ *param_2;
            ...
            uVar5 = 8;
            while (uVar8 < uVar10) {
               LAB_00100320:*(byte*)( (long)puVar2 + uVar5 ) = *(byte*)( (long)puVar2 + uVar5 ) ^ *(byte*)( (long)param_2 + uVar5 );
               uVar5 = uVar5 + 1;
               uVar8 = uVar5;
            }
;
            if (( ( uVar11 + uVar10 == 0x10 ) || ( *(long*)( param_1 + 0x38 ) == *(long*)( param_1 + 0x20 ) ) ) && ( iVar4 = mbedtls_cipher_update(param_1 + 0x48, param_1, 0x10, param_1, &local_60) ),iVar4 != 0) {
               LAB_00100451:*(uint*)( param_1 + 0xa8 ) = *(uint*)( param_1 + 0xa8 ) | 0x10;
            }
 else {
         ...
         if (uVar3 == 0) {
            LAB_00100381:iVar4 = mbedtls_ccm_crypt(param_1, uVar11, uVar10, param_2, &local_58);
            if (iVar4 == 0) {
               puVar2 = (ulong*)( param_1 + uVar11 );
               if (uVar10 < 8) {
                  uVar5 = 0;
               ...
               *puVar2 = *puVar2 ^ CONCAT44(local_58._4_4_, (undefined4)local_58);
               ...
               uVar5 = 8;
               while (uVar8 < uVar10) {
                  LAB_001003e0:*(byte*)( (long)puVar2 + uVar5 ) = *(byte*)( (long)puVar2 + uVar5 ) ^ *(byte*)( (long)&local_58 + uVar5 );
                  uVar5 = uVar5 + 1;
                  uVar8 = uVar5;
               }
;
                  ...
                  if (( uVar10 & 4 ) == 0) {
                     if (uVar3 != 0) {
                        *(undefined1*)param_4 = (undefined1)local_58;
                        if (( uVar10 & 2 ) != 0) {
                           *(undefined2*)( (long)param_4 + ( ( uVar10 & 0xffffffff ) - 2 ) ) = *(undefined2*)( (long)&local_60 + ( uVar10 & 0xffffffff ) + 6 );
                        }
                     ...
                     *(undefined4*)( (long)param_4 + ( ( uVar10 & 0xffffffff ) - 4 ) ) = *(undefined4*)( (long)&local_60 + ( uVar10 & 0xffffffff ) + 4 );
                  }

               }
 else {
                  *param_4 = CONCAT44(local_58._4_4_, (undefined4)local_58);
                  *(undefined8*)( (long)param_4 + ( ( uVar10 & 0xffffffff ) - 8 ) ) = *(undefined8*)( (long)&local_60 + ( uVar10 & 0xffffffff ) );
                  ...
                  if (7 < uVar3) {
                     ...
                     do {
                        uVar9 = (int)uVar5 + 8;
                        *(undefined8*)( ( ( ulong )(param_4 + 1) & 0xfffffffffffffff8 ) + uVar5 ) = *(undefined8*)( (long)&local_58 + ( uVar5 - lVar6 ) );
                        uVar5 = (ulong)uVar9;
                     }
 while ( uVar9 < uVar3 );
                  }
         ...
         LAB_00100288:if (uVar11 + uVar10 == 0x10) {
            LAB_001004b8:uVar3 = *(uint*)( param_1 + 0x40 );
            uVar7 = 0;
            uVar9 = 0;
            if (uVar3 != 0) {
               do {
 ...
 while ( uVar9 < uVar3 );
            ...
            LAB_00100295:if (*(long*)( param_1 + 0x38 ) == *(long*)( param_1 + 0x20 )) goto LAB_001004b8;
         }

         LAB_001002a6:param_2 = (ulong*)( (long)param_2 + uVar10 );
         param_4 = (undefined8*)( (long)param_4 + uVar10 );
         param_3 = param_3 - uVar10;
      }
 while ( param_3 != 0 );
   ...
   LAB_001004fb:iVar4 = 0;
   LAB_00100460:mbedtls_platform_zeroize(&local_58, 0x10);
...
void mbedtls_ccm_init(undefined8 *param_1) {
   ...
   *param_1 = 0;
   ...
   for (uVar1 = ( ulong )(( (int)param_1 - (int)(undefined8*)( ( ulong )(param_1 + 1) & 0xfffffffffffffff8 ) ) + 0xb0U >> 3); uVar1 != 0; uVar1 = uVar1 - 1) {
      *puVar2 = 0;
      puVar2 = puVar2 + 1;
   }
...
undefined8 mbedtls_ccm_update_ad(ushort *param_1, ulong *param_2, ulong param_3) {
      ...
      if (param_3 != 0) {
         ...
         do {
            ...
            if (uVar6 < 8) {
               uVar3 = 0;
               LAB_001008a0:do {
                  *(byte*)( (long)puVar1 + uVar3 ) = *(byte*)( (long)puVar1 + uVar3 ) ^ *(byte*)( (long)param_2 + uVar3 );
                  uVar3 = uVar3 + 1;
               }
 while ( uVar6 != uVar3 );
            }
 ...
 while ( param_3 != 0 );
      ...
      LAB_00100940:uVar5 = 0xfffffff3;
   }

   LAB_001008e3:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 mbedtls_ccm_update(long param_1, undefined8 param_2, ulong param_3, undefined8 param_4, ulong param_5, ulong *param_6) {
   undefined8 uVar1;
   if (( ( *(byte*)( param_1 + 0xa8 ) & 0x10 ) == 0 ) && ( ( ( *(long*)( param_1 + 0x30 ) == 0 || ( *(long*)( param_1 + 0x38 ) + param_3 <= *(ulong*)( param_1 + 0x20 ) ) ) && ( param_3 <= param_5 ) ) )) {
      *param_6 = param_3;
...
int mbedtls_ccm_finish(undefined1 (*param_1)[16], void *param_2, size_t param_3) {
   ...
   if (( *(uint*)( param_1[10] + 8 ) & 0x10 ) == 0) {
      if (( ( *(long*)( param_1[2] + 8 ) == 0 ) || ( ( *(uint*)( param_1[10] + 8 ) & 8 ) != 0 ) ) && ( ( *(long*)param_1[2] == 0 || ( *(long*)param_1[2] == *(long*)( param_1[3] + 8 ) ) ) )) {
...
undefined8 ccm_auth_crypt_part_0(long param_1, long param_2, undefined8 param_3, ulong param_4, undefined8 param_5, undefined8 param_6, undefined8 param_7, ulong param_8) {
   undefined8 uVar1;
   if (( ( ( param_8 != 2 ) && ( param_8 < 0x11 ) ) && ( param_4 < 0xff00 ) ) && ( ( param_8 & 1 ) == 0 )) {
      ...
      *(undefined8*)( param_1 + 0x38 ) = 0;
      ...
      if (( ( *(byte*)( param_1 + 0xa8 ) & 0x10 ) == 0 ) && ( ( *(long*)( param_1 + 0x30 ) == 0 || ( ( ulong )(*(long*)( param_1 + 0x38 ) + param_2) <= *(ulong*)( param_1 + 0x20 ) ) ) )) {
...
void mbedtls_ccm_star_encrypt_and_tag(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6, undefined8 param_7, undefined8 param_8) {
   int iVar1;
...
void mbedtls_ccm_encrypt_and_tag(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6, undefined8 param_7, undefined8 param_8) {
   int iVar1;
...
undefined8 mbedtls_ccm_star_auth_decrypt(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6, undefined8 param_7, undefined8 param_8, undefined8 param_9, undefined8 param_10) {
   undefined8 uVar1;
   long in_FS_OFFSET;
...
undefined8 mbedtls_ccm_auth_decrypt(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6, undefined8 param_7, undefined8 param_8, undefined8 param_9, undefined8 param_10) {
   undefined8 uVar1;
   long in_FS_OFFSET;
   undefined1 local_58[24];
   long local_40;
...
undefined4 mbedtls_ccm_self_test(int param_1) {
   ...
   if (iVar5 == 0) {
      ...
      LAB_00100f61:__printf_chk(2, "  CCM-AES #%u: ", (int)lVar6 + 1);
      LAB_00100f7b:do {
         local_78 = 0;
         ...
         if (( iVar5 != 0 ) || ( iVar5 = memcmp(local_68, res_test_data + lVar6 * 0x20, __n + lVar2) ),iVar5 != 0) goto LAB_00100fed;
         local_78 = 0;
         local_88 = (undefined1[16])0x0;
 ...
 while ( true );
   ...
   return uVar7;
   LAB_00101160:lVar6 = lVar6 + 1;
   puts("passed");
   if (lVar6 == 3) goto code_r0x0010117e;
   goto LAB_00100f61;
   code_r0x0010117e:mbedtls_cipher_free(local_100);
   mbedtls_platform_zeroize(local_148, 0xb0);
   putchar(10);
   goto LAB_0010112b;
}

         ...
         *(Object**)( this + 400 ) = pOVar3;
         ...
         if (cVar1 == '\0') {
            *(undefined8*)( this + 400 ) = 0;
            if (pOVar2 != (Object*)0x0) {
               cVar1 = RefCounted::unreference();
               joined_r0x0010032f:if (( cVar1 != '\0' ) && ( cVar1 = predelete_handler(pOVar2) ),cVar1 != '\0') goto LAB_00100345;
            }
      ...
      if (cVar1 == '\0') {
         *(undefined8*)( this + 400 ) = 0;
         if (pOVar4 != (Object*)0x0) {
            cVar1 = RefCounted::unreference();
            joined_r0x0010062f:if (( cVar1 != '\0' ) && ( cVar1 = predelete_handler(pOVar4) ),cVar1 != '\0') goto LAB_0010068b;
         }
...
iVar5 = InputEventMouseButton::get_button_index();iVar6 = InputEventMouseButton::get_button_index();fVar13 = (float)(int)( ( uint )(iVar5 == 5) - ( uint )(iVar6 == 4) );iVar5 = InputEventMouseButton::get_button_index();iVar6 = InputEventMouseButton::get_button_index();if (( ( (float)(int)( ( uint )(iVar5 == 7) - ( uint )(iVar6 == 6) ) == 0.0 ) && ( fVar13 == 0.0 ) ) || ( cVar2 = InputEvent::is_pressed() ),cVar2 == '\0') {
...
}cVar2 = RefCounted::unreference();if (( cVar2 != '\0' ) && ( cVar2 = predelete_handler(pOVar7) ),cVar2 != '\0') {

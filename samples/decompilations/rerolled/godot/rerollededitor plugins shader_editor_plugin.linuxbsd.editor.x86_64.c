/* ShaderEditorPlugin::selected_notify() */

void ShaderEditorPlugin::selected_notify(void)
...
/* ShaderEditorPlugin::_shader_selected(int) */

void __thiscall ShaderEditorPlugin::_shader_selected(ShaderEditorPlugin *this,int param_1)
...
/* ShaderEditorPlugin::_window_changed(bool) */

void ShaderEditorPlugin::_window_changed(bool param_1)
...
/* ShaderEditorPlugin::make_visible(bool) */

void __thiscall ShaderEditorPlugin::make_visible(ShaderEditorPlugin *this,bool param_1)

{
  ...
  EditorBottomPanel::make_item_visible
            (*(Control **)(EditorNode::singleton + 0xa40),SUB81(*(undefined8 *)(this + 0x6a8),0),
             true);
  return;
}
...
/* ShaderEditorPlugin::apply_changes() */

void __thiscall ShaderEditorPlugin::apply_changes(ShaderEditorPlugin *this)
...
/* ShaderEditorPlugin::_set_text_shader_zoom_factor(float) [clone .part.0] */

void __thiscall
ShaderEditorPlugin::_set_text_shader_zoom_factor(ShaderEditorPlugin *this,float param_1)
...
joined_r0x001001ae:
  do {
    ...
    if (((*(long *)(lVar3 + 0x10) != 0) &&
        (lVar2 = __dynamic_cast(*(long *)(lVar3 + 0x10),&Object::typeinfo,
                                &TextShaderEditor::typeinfo,0), lVar2 != 0)) &&
       (*(long *)(lVar2 + 0xa18) != 0)) {
...
/* ShaderEditorPlugin::_set_text_shader_zoom_factor(float) */
...
/* ShaderEditorPlugin::handles(Object*) const */

bool __thiscall ShaderEditorPlugin::handles(ShaderEditorPlugin *this,Object *param_1)
...
/* void Ref<Resource>::TEMPNAMEPLACEHOLDERVALUE(Ref<Shader> const&) [clone .isra.0] */
...
/* void Ref<Resource>::TEMPNAMEPLACEHOLDERVALUE(Ref<ShaderInclude> const&) [clone .isra.0] */
...
/* ShaderEditorPlugin::_get_current_shader() */

void ShaderEditorPlugin::_get_current_shader(void)

{
  ...
  if ((-1 < (int)uVar4) && (iVar5 = TabContainer::get_tab_count(), (int)uVar4 < iVar5)) {
    if (*(uint *)(in_RSI + 0x660) <= uVar4) {
      _err_print_index_error
                ("operator[]","./core/templates/local_vector.h",0xb2,(long)(int)uVar4,
                 (ulong)*(uint *)(in_RSI + 0x660),"p_index","count","",false,true);
      _err_flush_stdout();
                    /* WARNING: Does not return */
    ...
    lVar6 = *plVar1;
    *in_RDI = 0;
    if (((lVar6 != 0) || (lVar6 = plVar1[1], lVar6 != 0)) &&
       (lVar6 = __dynamic_cast(lVar6,&Object::typeinfo,&Resource::typeinfo,0), lVar6 != 0)) {
      *in_RDI = lVar6;
  ...
  _err_print_index_error
            ("_get_current_shader","editor/plugins/shader_editor_plugin.cpp",0x33,(long)(int)uVar4,
             (long)iVar5,"index","shader_tabs->get_tab_count()","",false,false);
  *in_RDI = 0;
  return;
}
...
/* ShaderEditorPlugin::_update_shader_list_status() */

void __thiscall ShaderEditorPlugin::_update_shader_list_status(ShaderEditorPlugin *this)
        ...
        if (*(char *)(lVar5 + 0xa20) == '\0') {
          if ((_update_shader_list_status()::{lambda()#1}::operator()()::sname == '\0') &&
             (iVar4 = __cxa_guard_acquire(&_update_shader_list_status()::{lambda()#1}::operator()()
                                           ::sname), iVar4 != 0)) {
            _scs_create((char *)&_update_shader_list_status()::{lambda()#1}::operator()()::sname,
                        true);
            __cxa_atexit(StringName::~StringName,
                         &_update_shader_list_status()::{lambda()#1}::operator()()::sname,
                         &__dso_handle);
...
/* ShaderEditorPlugin::get_shader_editor(Ref<Shader> const&) */

long __thiscall ShaderEditorPlugin::get_shader_editor(ShaderEditorPlugin *this,Ref *param_1)
...
/* ShaderEditorPlugin::_set_file_specific_items_disabled(bool) */

void ShaderEditorPlugin::_set_file_specific_items_disabled(bool param_1)
...
/* ShaderEditorPlugin::_notification(int) [clone .part.0] */

void ShaderEditorPlugin::_notification(int param_1)

{
  ...
  *(char **)(pCVar4 + 0x20) = "ShaderEditorPlugin::_resource_saved";
  ...
  plVar3 = EditorNode::singleton;
  pcVar1 = *(code **)(*EditorNode::singleton + 0x108);
  create_custom_callable_function_pointer<ShaderEditorPlugin,String_const&>
            ((ShaderEditorPlugin *)local_58,pcVar5,
             (_func_void_String_ptr *)"&ShaderEditorPlugin::_close_builtin_shaders_from_scene");
  ...
  create_custom_callable_function_pointer<ShaderEditorPlugin,String_const&>
            ((ShaderEditorPlugin *)local_58,pcVar5,
             (_func_void_String_ptr *)"&ShaderEditorPlugin::_file_removed");
...
/* ShaderEditorPlugin::_notification(int) */

void __thiscall ShaderEditorPlugin::_notification(ShaderEditorPlugin *this,int param_1)
...
/* ShaderEditorPlugin::_shader_include_created(Ref<ShaderInclude>) */

void __thiscall ShaderEditorPlugin::_shader_include_created(undefined8 param_1,undefined8 *param_2)
...
/* ShaderEditorPlugin::_shader_created(Ref<Shader>) */

void __thiscall ShaderEditorPlugin::_shader_created(undefined8 param_1,undefined8 *param_2)
...
/* ShaderEditorPlugin::get_drag_data_fw(Vector2 const&, Control*) */

ShaderEditorPlugin * __thiscall
...
/* ShaderEditorPlugin::_update_shader_list() */

void __thiscall ShaderEditorPlugin::_update_shader_list(ShaderEditorPlugin *this)
...
LAB_001012ce:
    do {
      if ((((*plVar10 == 0) ||
           (pOVar9 = (Object *)__dynamic_cast(*plVar10,&Object::typeinfo,&Resource::typeinfo,0),
           pOVar9 == (Object *)0x0)) || (cVar6 = RefCounted::reference(), cVar6 == '\0')) &&
         (((pOVar9 = (Object *)plVar10[1], pOVar9 != (Object *)0x0 &&
      ...
      if ((local_80 == (char *)0x0) || (*(uint *)(local_80 + -8) < 2)) {
        ...
        if ((*(long *)(pOVar9 + 0x188) != 0) && (1 < *(uint *)(*(long *)(pOVar9 + 0x188) + -8))) {
          iVar8 = String::find((char *)(pOVar9 + 0x188),0x10839b);
          if ((iVar8 == -1) &&
             (cVar6 = String::begins_with((char *)(pOVar9 + 0x188)), cVar6 == '\0'))
          goto LAB_00101415;
        }
        Resource::get_name();
        if ((local_78 != 0) && (1 < *(uint *)(local_78 + -8))) {
          String::get_slice((char *)local_70,(int)(CowData<char32_t> *)&local_80);
          local_60 = (Object *)0x0;
          ...
          vformat<String,String>
                    ((StringName *)&local_58,(CowData<char32_t> *)&local_68,(StrRange *)&local_60,
                     local_70);
          pcVar5 = local_58;
          if (local_80 != local_58) {
            CowData<char32_t>::_unref((CowData<char32_t> *)&local_80);
...
LAB_00101415:
      CowData<char32_t>::_ref((CowData<char32_t> *)(plVar10 + 3),(CowData *)local_88);
      if (((long *)plVar10[2] != (long *)0x0) &&
         (cVar6 = (**(code **)(*(long *)plVar10[2] + 0x370))(), cVar6 != '\0')) {
        String::operator+=((String *)&local_80,"(*)");
      }
      (**(code **)(*(long *)pOVar9 + 0x48))((CowData<char32_t> *)&local_68,pOVar9);
      pSVar2 = *(StringName **)(this + 0x680);
      StringName::StringName((StringName *)&local_58,(String *)&local_68,false);
      cVar6 = Control::has_theme_icon(pSVar2,(StringName *)&local_58);
      ...
      ItemList::add_item(*(String **)(this + 0x680),(Ref *)&local_80,SUB81((StrRange *)&local_60,0))
      ;
      ItemList::set_item_tooltip((int)*(undefined8 *)(this + 0x680),(String *)0xffffffff);
      CowData<char32_t>::_ref((CowData<char32_t> *)(plVar10 + 4),(CowData *)&local_80);
      if (((local_60 != (Object *)0x0) &&
          (cVar6 = RefCounted::unreference(), pOVar4 = local_60, cVar6 != '\0')) &&
...
/* ShaderEditorPlugin::save_external_data() */

void __thiscall ShaderEditorPlugin::save_external_data(ShaderEditorPlugin *this)
...
/* ShaderEditorPlugin::_resource_saved(Object*) */

void __thiscall ShaderEditorPlugin::_resource_saved(ShaderEditorPlugin *this,Object *param_1)
...
/* ShaderEditorPlugin::get_window_layout(Ref<ConfigFile>) */

void __thiscall ShaderEditorPlugin::get_window_layout(ShaderEditorPlugin *this,undefined8 *param_2)

{
  ...
  while( true ) {
    ...
    if (*(uint *)(this + 0x660) <= (uint)lVar8) {
      _err_print_index_error
                ("operator[]","./core/templates/local_vector.h",0xb2,lVar8,
                 (ulong)*(uint *)(this + 0x660),"p_index","count","",false,true);
      _err_flush_stdout();
                    /* WARNING: Does not return */
      pcVar2 = (code *)invalidInstructionException();
      (*pcVar2)();
    }
    EditedShader::EditedShader
              ((EditedShader *)&local_98,(EditedShader *)(*(long *)(this + 0x668) + lVar8 * 0x28));
    lVar4 = local_88;
    if (local_88 != 0) {
      local_a8 = 0;
      Resource::get_path();
...
/* ShaderEditorPlugin::_close_shader(int) */

void __thiscall ShaderEditorPlugin::_close_shader(ShaderEditorPlugin *this,int param_1)

{
  ...
  if (-1 < param_1) {
    ...
    if (param_1 < iVar2) {
      ...
      LocalVector<ShaderEditorPlugin::EditedShader,unsigned_int,false,false>::remove_at
                ((LocalVector<ShaderEditorPlugin::EditedShader,unsigned_int,false,false> *)
                 (this + 0x660),param_1);
      _update_shader_list(this);
  ...
  iVar2 = TabContainer::get_tab_count();
  _err_print_index_error
            ("_close_shader","editor/plugins/shader_editor_plugin.cpp",0x1b5,(long)param_1,
             (long)iVar2,"p_index","shader_tabs->get_tab_count()","",false,false);
  return;
}



/* ShaderEditorPlugin::_close_builtin_shaders_from_scene(String const&) */

void ShaderEditorPlugin::_close_builtin_shaders_from_scene(String *param_1)
    ...
    do {
      while( true ) {
        ...
        if ((*(long *)(lVar1 + 0x188) != 0) && (1 < *(uint *)(*(long *)(lVar1 + 0x188) + -8))) {
          ...
          if ((iVar4 == -1) && (cVar3 = String::begins_with((char *)(lVar1 + 0x188)), cVar3 == '\0')
             ) break;
        }
        Resource::get_path();
        ...
        if (cVar3 == '\0') break;
LAB_00102406:
        _close_shader((ShaderEditorPlugin *)param_1,uVar6);
        if (*(uint *)(param_1 + 0x660) <= uVar6) goto LAB_0010241d;
      }
      uVar7 = *(uint *)(param_1 + 0x660);
      if (uVar7 <= uVar6) {
        _err_print_index_error
                  ("operator[]","./core/templates/local_vector.h",0xb2,(ulong)uVar6,(ulong)uVar7,
                   "p_index","count","",false,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
        pcVar2 = (code *)invalidInstructionException();
...
/* ShaderEditorPlugin::_file_removed(String const&) */

void __thiscall ShaderEditorPlugin::_file_removed(ShaderEditorPlugin *this,String *param_1)
...
/* ShaderEditorPlugin::set_window_layout(Ref<ConfigFile>) */

void __thiscall ShaderEditorPlugin::set_window_layout(ShaderEditorPlugin *this,undefined8 *param_2)

{
  ...
  if ((bVar3) && (cVar4 = WindowWrapper::is_window_available(), cVar4 != '\0')) {
    local_120 = 0;
    pSVar1 = (String *)*param_2;
...
LAB_00102665:
  local_120 = 0;
  String::parse_latin1
            ((String *)&local_120,"editors/shader_editor/behavior/files/restore_shaders_on_load");
  _EDITOR_GET((String *)local_58);
  bVar3 = Variant::operator_cast_to_bool((Variant *)local_58);
  if (Variant::needs_deinit[local_58[0]] != '\0') {
    Variant::_clear_internal();
...
/* ShaderEditorPlugin::_res_saved_callback(Ref<Resource> const&) */

void __thiscall ShaderEditorPlugin::_res_saved_callback(ShaderEditorPlugin *this,Ref *param_1)

{
  ...
  if (*(long *)param_1 != 0) {
    ...
    for (; plVar6 != plVar1; plVar6 = plVar6 + 5) {
      local_58 = (Object *)0x0;
      if ((*plVar6 == 0) ||
         (pOVar4 = (Object *)__dynamic_cast(*plVar6,&Object::typeinfo,&Resource::typeinfo,0),
         pOVar4 == (Object *)0x0)) {
LAB_001031e3:
        if ((plVar6[1] != 0) &&
           (pOVar4 = (Object *)__dynamic_cast(plVar6[1],&Object::typeinfo,&Resource::typeinfo,0),
           pOVar4 != (Object *)0x0)) {
          local_58 = pOVar4;
        ...
        _err_print_error("_res_saved_callback","editor/plugins/shader_editor_plugin.cpp",0x2ea,
                         "Condition \"shader_res.is_null()\" is true.",0,0);
...
LAB_00103230:
      if ((plVar6[2] == 0) ||
         (lVar5 = __dynamic_cast(plVar6[2],&Object::typeinfo,&TextShaderEditor::typeinfo,0),
         lVar5 == 0)) {
LAB_00103390:
        Ref<Resource>::unref((Ref<Resource> *)&local_58);
      }
        ...
        if ((*(long *)(pOVar4 + 0x188) != 0) && (1 < *(uint *)(*(long *)(pOVar4 + 0x188) + -8))) {
          ...
          if ((iVar3 == -1) &&
             (cVar2 = String::begins_with((char *)(pOVar4 + 0x188)), cVar2 == '\0'))
          goto LAB_00103390;
        }
        Resource::get_path();
...
/* ShaderEditorPlugin::_menu_item_pressed(int) */

void __thiscall ShaderEditorPlugin::_menu_item_pressed(ShaderEditorPlugin *this,int param_1)
...
/* ShaderEditorPlugin::_setup_popup_menu(ShaderEditorPlugin::PopupMenuType, PopupMenu*) */

void __thiscall ShaderEditorPlugin::_setup_popup_menu(undefined8 param_1,int param_2,Ref *param_3)
...
/* ShaderEditorPlugin::_make_script_list_context_menu() */

void __thiscall ShaderEditorPlugin::_make_script_list_context_menu(ShaderEditorPlugin *this)
...
LAB_00104760:
  ...
  local_40 = CONCAT44((float)((ulong)uVar7 >> 0x20) + (float)((ulong)uVar8 >> 0x20),
...
/* ShaderEditorPlugin::_shader_list_clicked(int, Vector2, MouseButton) */

void ShaderEditorPlugin::_shader_list_clicked(ShaderEditorPlugin *param_1,int param_2,int param_3)
...
void __thiscall ShaderEditorPlugin::ShaderEditorPlugin(ShaderEditorPlugin *this)

{
  ...
  *(MenuButton **)(this + 0x698) = this_02;
  ...
  create_custom_callable_function_pointer<ShaderEditorPlugin,int>
            ((ShaderEditorPlugin *)local_98,(char *)this,
             (_func_void_int *)"&ShaderEditorPlugin::_menu_item_pressed");
  ...
  *(ItemList **)(this + 0x680) = this_06;
  ...
  create_custom_callable_function_pointer<ShaderEditorPlugin,int>
            ((ShaderEditorPlugin *)local_98,(char *)this,
             (_func_void_int *)"&ShaderEditorPlugin::_shader_selected");
...
LAB_00105db0:
        (**(code **)(*(long *)this_08 + 0x140))(this_08);
      ...
      if ((pOVar11 != (Object *)0x0) &&
         (local_98[0] = pOVar11, cVar6 = RefCounted::reference(), cVar6 == '\0')) {
        local_98[0] = (Object *)0x0;
      }
      goto LAB_0010595a;
    }
  ...
  pSVar12 = (StyleBox *)0x0;
LAB_0010595a:
  Control::add_theme_style_override(pSVar13,(Ref *)(SceneStringNames::singleton + 600));
  if (((local_98[0] != (Object *)0x0) &&
      (cVar6 = RefCounted::unreference(), pOVar11 = local_98[0], cVar6 != '\0')) &&
     (cVar6 = predelete_handler(local_98[0]), cVar6 != '\0')) {
    (**(code **)(*(long *)pOVar11 + 0x140))(pOVar11);
    Memory::free_static(pOVar11,false);
  }
  uVar8 = *(undefined8 *)(EditorNode::singleton + 0xa40);
  local_98[0] = (Object *)0x0;
  String::parse_latin1((String *)local_98,"");
  local_a8[0] = 0;
  String::parse_latin1((String *)local_a8,"Toggle Shader Editor Bottom Panel");
  local_b8[0] = 0;
  String::parse_latin1((String *)local_b8,"bottom_panels/toggle_shader_editor_bottom_panel");
  ED_SHORTCUT_AND_COMMAND
            ((String *)local_c8,(String *)local_b8,(String *)local_a8,0x4000053,(String *)local_98);
  uVar5 = *(undefined8 *)(this + 0x6a8);
  local_d8[0] = 0;
  String::parse_latin1((String *)local_d8,"");
  local_e8[0] = 0;
  String::parse_latin1((String *)local_e8,"Shader Editor");
  TTR((String *)local_f0,(String *)local_e8);
  uVar8 = EditorBottomPanel::add_item(uVar8,local_f0,uVar5,(String *)local_c8,0);
  *(undefined8 *)(this + 0x690) = uVar8;
  CowData<char32_t>::_unref(local_f0);
  CowData<char32_t>::_unref((CowData<char32_t> *)local_e8);
  CowData<char32_t>::_unref((CowData<char32_t> *)local_d8);
  Ref<Shortcut>::unref((Ref<Shortcut> *)local_c8);
  CowData<char32_t>::_unref((CowData<char32_t> *)local_b8);
  CowData<char32_t>::_unref((CowData<char32_t> *)local_a8);
  CowData<char32_t>::_unref((CowData<char32_t> *)local_98);
  this_09 = (ShaderCreateDialog *)operator_new(0xe38,"");
  ShaderCreateDialog::ShaderCreateDialog(this_09);
  postinitialize_handler((Object *)this_09);
  *(ShaderCreateDialog **)(this + 0x6b8) = this_09;
  Node::add_child(*(undefined8 *)(this + 0x670),this_09,0,0);
  ...
  *(ShaderEditorPlugin **)(pCVar10 + 0x28) = this;
  *(undefined1 (*) [16])(pCVar10 + 0x30) = (undefined1  [16])0x0;
  *(undefined ***)pCVar10 = &PTR_hash_001165e8;
  *(undefined8 *)(pCVar10 + 0x40) = 0;
  uVar8 = *(undefined8 *)(this + 0x60);
  *(undefined8 *)(pCVar10 + 0x10) = 0;
  *(undefined8 *)(pCVar10 + 0x30) = uVar8;
  *(code **)(pCVar10 + 0x38) = _shader_created;
  CallableCustomMethodPointerBase::_setup((uint *)pCVar10,(int)pCVar10 + 0x28);
  *(char **)(pCVar10 + 0x20) = "ShaderEditorPlugin::_shader_created";
  Callable::Callable((Callable *)local_98,pCVar10);
  StringName::StringName((StringName *)local_a8,"shader_created",false);
  (*pcVar2)(plVar9,(String *)local_a8,(String *)local_98,0);
  if ((StringName::configured != '\0') && (local_a8[0] != 0)) {
    StringName::unref();
  }
  ...
  *(ShaderEditorPlugin **)(pCVar10 + 0x28) = this;
  *(undefined1 (*) [16])(pCVar10 + 0x30) = (undefined1  [16])0x0;
  *(undefined ***)pCVar10 = &PTR_hash_00116678;
  *(undefined8 *)(pCVar10 + 0x40) = 0;
  uVar8 = *(undefined8 *)(this + 0x60);
  *(undefined8 *)(pCVar10 + 0x10) = 0;
  *(undefined8 *)(pCVar10 + 0x30) = uVar8;
  *(code **)(pCVar10 + 0x38) = _shader_include_created;
  CallableCustomMethodPointerBase::_setup((uint *)pCVar10,(int)pCVar10 + 0x28);
  *(char **)(pCVar10 + 0x20) = "ShaderEditorPlugin::_shader_include_created";
  Callable::Callable((Callable *)local_98,pCVar10);
  StringName::StringName((StringName *)local_a8,"shader_include_created",false);
  (*pcVar2)(plVar9,(String *)local_a8,(String *)local_98,0);
  if ((StringName::configured != '\0') && (local_a8[0] != 0)) {
    StringName::unref();
  }
  Callable::~Callable((Callable *)local_98);
  if (((pSVar12 != (StyleBox *)0x0) && (cVar6 = RefCounted::unreference(), cVar6 != '\0')) &&
     (cVar6 = predelete_handler((Object *)pSVar12), cVar6 != '\0')) {
    (**(code **)(*(long *)pSVar12 + 0x140))(pSVar12);
    Memory::free_static(pSVar12,false);
  }
  Ref<Shortcut>::unref(local_f8);
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    __stack_chk_fail();
  }
...
/* ShaderEditorPlugin::edit(Object*) */

void __thiscall ShaderEditorPlugin::edit(ShaderEditorPlugin *this,Object *param_1)
...
LAB_001064ca:
    ...
    if (((local_98._0_8_ == 0) ||
        (pOVar8 = (Object *)
                  __dynamic_cast(local_98._0_8_,&Object::typeinfo,&VisualShader::typeinfo,0),
        pOVar8 == (Object *)0x0)) || (cVar7 = RefCounted::reference(), cVar7 == '\0')) {
      ...
      cVar7 = RefCounted::unreference();
      if ((cVar7 != '\0') && (cVar7 = predelete_handler(pOVar8), cVar7 != '\0')) {
...
LAB_001060c6:
  ...
  if ((local_88._0_8_ != 0) &&
     (plVar9 = (long *)__dynamic_cast(local_88._0_8_,&Object::typeinfo,&TextShaderEditor::typeinfo,0
                                     ), plVar9 != (long *)0x0)) {
  ...
  *(uint *)(this + 0x660) = uVar2 + 1;
  EditedShader::EditedShader
            ((EditedShader *)(lVar12 + (ulong)uVar2 * 0x28),(EditedShader *)local_68);
...
/* ShaderEditorPlugin::_move_shader_tab(int, int) */

void __thiscall
ShaderEditorPlugin::_move_shader_tab(ShaderEditorPlugin *this,int param_1,int param_2)

{
  ...
  if (param_1 != param_2) {
    ...
    EditedShader::EditedShader
              ((EditedShader *)&local_c8,
               (EditedShader *)(*(long *)(this + 0x668) + (ulong)(uint)param_1 * 0x28));
    LocalVector<ShaderEditorPlugin::EditedShader,unsigned_int,false,false>::remove_at
              ((LocalVector<ShaderEditorPlugin::EditedShader,unsigned_int,false,false> *)
               (this + 0x660),param_1);
...
LAB_00106afe:
        ...
        *(uint *)(this + 0x660) = uVar5 + 1;
        EditedShader::EditedShader
                  ((EditedShader *)((long)pvVar15 + (ulong)uVar5 * 0x28),(EditedShader *)&local_68);
        EditedShader::~EditedShader((EditedShader *)&local_68);
      }
      else {
        LocalVector<ShaderEditorPlugin::EditedShader,unsigned_int,false,false>::resize
                  ((LocalVector<ShaderEditorPlugin::EditedShader,unsigned_int,false,false> *)
                   (this + 0x660),uVar5);
        uVar5 = *(int *)(this + 0x660) - 1;
        if ((uint)param_2 < uVar5) {
          ...
          lVar16 = uVar14 * 0x28;
          do {
            plVar2 = (long *)(*(long *)(this + 0x668) + lVar16);
            plVar3 = (long *)(*(long *)(this + 0x668) + (uVar5 - uVar14) * 0x28 + lVar16);
            pOVar6 = (Object *)*plVar2;
            pOVar7 = (Object *)*plVar3;
            if (pOVar6 != pOVar7) {
              *plVar3 = (long)pOVar6;
              if ((pOVar6 != (Object *)0x0) && (cVar12 = RefCounted::reference(), cVar12 == '\0')) {
                *plVar3 = 0;
              }
              if (((pOVar7 != (Object *)0x0) && (cVar12 = RefCounted::unreference(), cVar12 != '\0')
                  ) && (cVar12 = predelete_handler(pOVar7), cVar12 != '\0')) {
                (**(code **)(*(long *)pOVar7 + 0x140))(pOVar7);
                Memory::free_static(pOVar7,false);
              }
            }
            pOVar6 = (Object *)plVar2[1];
            pOVar7 = (Object *)plVar3[1];
            if (pOVar6 != pOVar7) {
              plVar3[1] = (long)pOVar6;
              if ((pOVar6 != (Object *)0x0) && (cVar12 = RefCounted::reference(), cVar12 == '\0')) {
                plVar3[1] = 0;
              }
              if (((pOVar7 != (Object *)0x0) && (cVar12 = RefCounted::unreference(), cVar12 != '\0')
            ...
            if (plVar3[3] != plVar2[3]) {
              CowData<char32_t>::_unref((CowData<char32_t> *)(plVar3 + 3));
              plVar3[3] = plVar2[3];
              plVar2[3] = 0;
            }
            if (plVar3[4] != plVar2[4]) {
              CowData<char32_t>::_unref((CowData<char32_t> *)(plVar3 + 4));
              plVar3[4] = plVar2[4];
              plVar2[4] = 0;
            }
            bVar17 = (uVar14 - (uVar1 - param_2)) * 0x28 != lVar16;
            lVar16 = lVar16 + -0x28;
          } while (bVar17);
        }
        ...
        if (pOVar6 != local_98) {
          *puVar4 = local_98;
          if ((local_98 != (Object *)0x0) && (cVar12 = RefCounted::reference(), cVar12 == '\0')) {
            *puVar4 = 0;
          }
        ...
        if (local_90 != pOVar6) {
          puVar4[1] = local_90;
          local_68 = pOVar6;
          if ((local_90 != (Object *)0x0) && (cVar12 = RefCounted::reference(), cVar12 == '\0')) {
            puVar4[1] = 0;
          }
          Ref<ShaderInclude>::unref((Ref<ShaderInclude> *)&local_68);
        }
      ...
      _err_print_index_error
                ("insert","./core/templates/local_vector.h",0xf7,(ulong)(uint)param_2,(ulong)uVar5,
    ...
    if (((local_c0 != (Object *)0x0) && (cVar12 = RefCounted::unreference(), cVar12 != '\0')) &&
       (cVar12 = predelete_handler(local_c0), cVar12 != '\0')) {
      (**(code **)(*(long *)local_c0 + 0x140))(local_c0);
      Memory::free_static(local_c0,false);
    }
    if (((local_c8 != (Object *)0x0) && (cVar12 = RefCounted::unreference(), cVar12 != '\0')) &&
       (cVar12 = predelete_handler(local_c8), cVar12 != '\0')) {
...
/* ShaderEditorPlugin::can_drop_data_fw(Vector2 const&, Variant const&, Control*) const */

uint ShaderEditorPlugin::can_drop_data_fw(Vector2 *param_1,Variant *param_2,Control *param_3)
...
/* ShaderEditorPlugin::drop_data_fw(Vector2 const&, Variant const&, Control*) */

void ShaderEditorPlugin::drop_data_fw(Vector2 *param_1,Variant *param_2,Control *param_3)
...
/* ShaderEditorPlugin::get_unsaved_status(String const&) const */

String * ShaderEditorPlugin::get_unsaved_status(String *param_1)

{
    ...
    do {
      ...
      if ((plVar2 != (long *)0x0) && (cVar4 = (**(code **)(*plVar2 + 0x370))(), cVar4 != '\0')) {
        if (local_60 == (String *)0x0) {
          ...
          local_80 = 0;
          String::parse_latin1
                    ((String *)&local_80,"Save changes to the following shaders(s) before quitting?"
                    );
        ...
        if (uVar1 <= (uint)uVar7) {
          _err_print_index_error
                    ("operator[]","./core/templates/local_vector.h",0xae,uVar7 & 0xffffffff,
  ...
  if ((*in_RDX == 0) || (*(uint *)(*in_RDX + -8) < 2)) {
    ...
    for (; pSVar8 != pSVar6; pSVar8 = pSVar8 + 8) {
      while ((cVar4 = String::is_resource_file(), cVar4 == '\0' &&
             (iVar5 = String::find(pSVar8,(int)local_90), iVar5 != -1))) {
        if (local_50[0] == 0) {
          local_80 = 0;
          String::parse_latin1((String *)&local_80,"");
          local_88 = 0;
          String::parse_latin1
                    ((String *)&local_88,
                     "There are unsaved changes in the following built-in shaders(s):");
...
{
  return (uint)CONCAT71(0x116b,(undefined4 *)param_1 == &StyleBox::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x116b,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x116b,(undefined4 *)param_1 == &Resource::get_class_ptr_static()::ptr) |
...
/* ShaderEditorPlugin::is_class_ptr(void*) const */

uint __thiscall ShaderEditorPlugin::is_class_ptr(ShaderEditorPlugin *this,void *param_1)
...
/* ShaderEditorPlugin::_getv(StringName const&, Variant&) const */

undefined8 ShaderEditorPlugin::_getv(StringName *param_1,Variant *param_2)
...
/* ShaderEditorPlugin::_setv(StringName const&, Variant const&) */

undefined8 ShaderEditorPlugin::_setv(StringName *param_1,Variant *param_2)
...
/* ShaderEditorPlugin::_property_can_revertv(StringName const&) const */

undefined8 ShaderEditorPlugin::_property_can_revertv(StringName *param_1)
...
/* ShaderEditorPlugin::_property_get_revertv(StringName const&, Variant&) const */

undefined8 ShaderEditorPlugin::_property_get_revertv(StringName *param_1,Variant *param_2)
...
CallableCustomMethodPointer<ShaderEditorPlugin,void,Ref<ShaderInclude>>::
~CallableCustomMethodPointer
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,Ref<ShaderInclude>> *this)
...
void __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,Ref<Shader>>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,Ref<Shader>> *this)
...
void __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,Vector2_const&,Variant_const&,Control*>::
~CallableCustomMethodPointer
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,Vector2_const&,Variant_const&,Control*>
           *this)
...
void __thiscall
CallableCustomMethodPointerC<ShaderEditorPlugin,bool,Vector2_const&,Variant_const&,Control*>::
...
void __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,Variant,Vector2_const&,Control*>::
~CallableCustomMethodPointer
          (CallableCustomMethodPointer<ShaderEditorPlugin,Variant,Vector2_const&,Control*> *this)
...
void __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,int,Vector2,MouseButton>::
~CallableCustomMethodPointer
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,int,Vector2,MouseButton> *this)
...
/* CallableCustomMethodPointer<ShaderEditorPlugin, void, bool>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,bool>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,bool> *this)
...
/* CallableCustomMethodPointer<WindowWrapper, void, int, bool>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<WindowWrapper,void,int,bool>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<WindowWrapper,void,int,bool> *this)
...
/* CallableCustomMethodPointer<ShaderEditorPlugin, void, int>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,int>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,int> *this)
...
void __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,Ref<Resource>const&>::
~CallableCustomMethodPointer
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,Ref<Resource>const&> *this)
...
void __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,String_const&>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,String_const&> *this)
...
/* CallableCustomMethodPointer<ShaderEditorPlugin, void, Object*>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,Object*>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,Object*> *this)
...
/* CallableCustomMethodPointer<ShaderEditorPlugin, void, float>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,float>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,float> *this)
...
/* CallableCustomMethodPointer<ShaderEditorPlugin, void>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<ShaderEditorPlugin,void> *this)
...
CallableCustomMethodPointer<ShaderEditorPlugin,void,Ref<ShaderInclude>>::get_argument_count
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,Ref<ShaderInclude>> *this,
          bool *param_1)
...
undefined8 __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,Ref<Shader>>::get_argument_count
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,Ref<Shader>> *this,bool *param_1)
...
undefined8 __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,Vector2_const&,Variant_const&,Control*>::
get_argument_count(CallableCustomMethodPointer<ShaderEditorPlugin,void,Vector2_const&,Variant_const&,Control*>
                   *this,bool *param_1)
...
undefined8 __thiscall
CallableCustomMethodPointerC<ShaderEditorPlugin,bool,Vector2_const&,Variant_const&,Control*>::
get_argument_count(CallableCustomMethodPointerC<ShaderEditorPlugin,bool,Vector2_const&,Variant_const&,Control*>
                   *this,bool *param_1)
...
undefined8 __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,Variant,Vector2_const&,Control*>::get_argument_count
          (CallableCustomMethodPointer<ShaderEditorPlugin,Variant,Vector2_const&,Control*> *this,
          bool *param_1)
...
undefined8 __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,int,Vector2,MouseButton>::get_argument_count
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,int,Vector2,MouseButton> *this,
          bool *param_1)
...
/* CallableCustomMethodPointer<ShaderEditorPlugin, void, bool>::get_argument_count(bool&) const */

undefined8 __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,bool>::get_argument_count
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,bool> *this,bool *param_1)
...
/* CallableCustomMethodPointer<WindowWrapper, void, int, bool>::get_argument_count(bool&) const */

undefined8 __thiscall
CallableCustomMethodPointer<WindowWrapper,void,int,bool>::get_argument_count
          (CallableCustomMethodPointer<WindowWrapper,void,int,bool> *this,bool *param_1)
...
/* CallableCustomMethodPointer<ShaderEditorPlugin, void, int>::get_argument_count(bool&) const */

undefined8 __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,int>::get_argument_count
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,int> *this,bool *param_1)
...
undefined8 __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,Ref<Resource>const&>::get_argument_count
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,Ref<Resource>const&> *this,
          bool *param_1)
...
undefined8 __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,String_const&>::get_argument_count
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,String_const&> *this,bool *param_1)
...
undefined8 __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,Object*>::get_argument_count
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,Object*> *this,bool *param_1)
...
/* CallableCustomMethodPointer<ShaderEditorPlugin, void, float>::get_argument_count(bool&) const */

undefined8 __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,float>::get_argument_count
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,float> *this,bool *param_1)
...
/* CallableCustomMethodPointer<ShaderEditorPlugin, void>::get_argument_count(bool&) const */

undefined8 __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void>::get_argument_count
          (CallableCustomMethodPointer<ShaderEditorPlugin,void> *this,bool *param_1)
...
/* ShaderEditorPlugin::_validate_propertyv(PropertyInfo&) const */

void ShaderEditorPlugin::_validate_propertyv(PropertyInfo *param_1)
...
/* CallableCustomMethodPointer<ShaderEditorPlugin, void, String const&>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,String_const&>::get_object
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,String_const&> *this)
...
undefined8 __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,Variant,Vector2_const&,Control*>::get_object
          (CallableCustomMethodPointer<ShaderEditorPlugin,Variant,Vector2_const&,Control*> *this)
...
/* CallableCustomMethodPointer<WindowWrapper, void, int, bool>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<WindowWrapper,void,int,bool>::get_object
          (CallableCustomMethodPointer<WindowWrapper,void,int,bool> *this)
...
undefined8 __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,Ref<Resource>const&>::get_object
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,Ref<Resource>const&> *this)
...
/* CallableCustomMethodPointer<ShaderEditorPlugin, void, Ref<ShaderInclude> >::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,Ref<ShaderInclude>>::get_object
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,Ref<ShaderInclude>> *this)
...
undefined8 __thiscall
CallableCustomMethodPointerC<ShaderEditorPlugin,bool,Vector2_const&,Variant_const&,Control*>::
get_object(CallableCustomMethodPointerC<ShaderEditorPlugin,bool,Vector2_const&,Variant_const&,Control*>
           *this)
...
/* CallableCustomMethodPointer<ShaderEditorPlugin, void, float>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,float>::get_object
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,float> *this)
...
undefined8 __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,Vector2_const&,Variant_const&,Control*>::
get_object(CallableCustomMethodPointer<ShaderEditorPlugin,void,Vector2_const&,Variant_const&,Control*>
           *this)
...
/* CallableCustomMethodPointer<ShaderEditorPlugin, void>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void>::get_object
          (CallableCustomMethodPointer<ShaderEditorPlugin,void> *this)
...
/* CallableCustomMethodPointer<ShaderEditorPlugin, void, bool>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,bool>::get_object
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,bool> *this)
...
/* CallableCustomMethodPointer<ShaderEditorPlugin, void, Object*>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,Object*>::get_object
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,Object*> *this)
...
/* CallableCustomMethodPointer<ShaderEditorPlugin, void, int>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,int>::get_object
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,int> *this)
...
/* CallableCustomMethodPointer<ShaderEditorPlugin, void, Ref<Shader> >::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,Ref<Shader>>::get_object
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,Ref<Shader>> *this)
...

{
  ...
  if (in_RSI != &get_class_ptr_static()::ptr) {
    uVar1 = (uint)CONCAT71(0x116b,in_RSI == &Container::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x1169,in_RSI == &SplitContainer::get_class_ptr_static()::ptr) |
            ...
            (uint)CONCAT71(0x116b,in_RSI == &Node::get_class_ptr_static()::ptr) |
...
/* WARNING: Removing unreachable block (ram,0x0010a2e8) */
...

{
  ...
  if (((code *)PTR__get_0011c030 != CanvasItem::_get) &&
...
/* WARNING: Removing unreachable block (ram,0x0010a358) */
...
/* ShaderEditorPlugin::get_plugin_name() const */

ShaderEditorPlugin * __thiscall ShaderEditorPlugin::get_plugin_name(ShaderEditorPlugin *this)
...
/* ShaderEditorPlugin::_get_class_namev() const */

undefined8 * ShaderEditorPlugin::_get_class_namev(void)
...
LAB_0010b173:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      goto LAB_0010b173;
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"ShaderEditorPlugin");
      goto LAB_0010b1de;
    }
  }
  StringName::assign_static_unique_class_name
...
/* Callable create_custom_callable_function_pointer<ShaderEditorPlugin, String
   const&>(ShaderEditorPlugin*, char const*, void (ShaderEditorPlugin::*)(String const&)) */

ShaderEditorPlugin *
create_custom_callable_function_pointer<ShaderEditorPlugin,String_const&>
          (ShaderEditorPlugin *param_1,char *param_2,_func_void_String_ptr *param_3)
...
/* ShaderEditorPlugin::_notificationv(int, bool) */

void __thiscall
ShaderEditorPlugin::_notificationv(ShaderEditorPlugin *this,int param_1,bool param_2)
...
/* Callable create_custom_callable_function_pointer<ShaderEditorPlugin, int>(ShaderEditorPlugin*,
   char const*, void (ShaderEditorPlugin::*)(int)) */

ShaderEditorPlugin *
create_custom_callable_function_pointer<ShaderEditorPlugin,int>
          (ShaderEditorPlugin *param_1,char *param_2,_func_void_int *param_3)
...
/* WARNING: Removing unreachable block (ram,0x0010bff0) */
...
/* ShaderEditorPlugin::EditedShader::~EditedShader() */

void __thiscall ShaderEditorPlugin::EditedShader::~EditedShader(EditedShader *this)
...
/* ShaderEditorPlugin::get_class() const */

void ShaderEditorPlugin::get_class(void)
...
/* ShaderEditorPlugin::EditedShader::EditedShader(ShaderEditorPlugin::EditedShader const&) */

void __thiscall
ShaderEditorPlugin::EditedShader::EditedShader(EditedShader *this,EditedShader *param_1)
...
void __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void>::call
          (CallableCustomMethodPointer<ShaderEditorPlugin,void> *this,Variant **param_1,int param_2,
...
void __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,Vector2_const&,Variant_const&,Control*>::call
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,Vector2_const&,Variant_const&,Control*>
...
LAB_0010cb7f:
          ...
          *(undefined8 *)(param_4 + 4) = uVar3;
          ...
          if (((pOVar6 == (Object *)0x0) ||
             ...
             && (pOVar5 != (Object *)0x0)) goto LAB_0010cb7f;
        }
...
void __thiscall
CallableCustomMethodPointerC<ShaderEditorPlugin,bool,Vector2_const&,Variant_const&,Control*>::call
          (CallableCustomMethodPointerC<ShaderEditorPlugin,bool,Vector2_const&,Variant_const&,Control*>
           *this,Variant **param_1,int param_2,Variant *param_3,CallError *param_4)
...
LAB_0010ceec:
          ...
          *(undefined8 *)(param_4 + 4) = uVar3;
          ...
          if (((pOVar6 == (Object *)0x0) ||
              (lVar7 = __dynamic_cast(pOVar6,&Object::typeinfo,&Control::typeinfo,0), lVar7 == 0))
             && (pOVar5 != (Object *)0x0)) goto LAB_0010ceec;
        }
        pOVar5 = Variant::operator_cast_to_Object_(param_1[2]);
        if (pOVar5 != (Object *)0x0) {
          pOVar5 = (Object *)__dynamic_cast(pOVar5,&Object::typeinfo,&Control::typeinfo,0);
  ...
  _err_print_error(&_LC41,"./core/object/callable_method_pointer.h",0xad,
                   "Parameter \"ObjectDB::get_instance(ObjectID(data.object_id))\" is null.",
                   local_88,0,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)local_88);
...
void __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,Variant,Vector2_const&,Control*>::call
          (CallableCustomMethodPointer<ShaderEditorPlugin,Variant,Vector2_const&,Control*> *this,
...
LAB_0010d27c:
          ...
          *(undefined8 *)(param_4 + 4) = uVar3;
          ...
          if (((pOVar6 == (Object *)0x0) ||
              (lVar7 = __dynamic_cast(pOVar6,&Object::typeinfo,&Control::typeinfo,0), lVar7 == 0))
             && (pOVar5 != (Object *)0x0)) goto LAB_0010d27c;
        }
...
void __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,int>::call
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,int> *this,Variant **param_1,
...
void __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,int,Vector2,MouseButton>::call
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,int,Vector2,MouseButton> *this,
          Variant **param_1,int param_2,Variant *param_3,CallError *param_4)
...
void __thiscall
CallableCustomMethodPointer<WindowWrapper,void,int,bool>::call
          (CallableCustomMethodPointer<WindowWrapper,void,int,bool> *this,Variant **param_1,
          int param_2,Variant *param_3,CallError *param_4)
...
void __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,bool>::call
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,bool> *this,Variant **param_1,
          int param_2,Variant *param_3,CallError *param_4)
...
void __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,Object*>::call
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,Object*> *this,Variant **param_1,
          int param_2,Variant *param_3,CallError *param_4)
...
void __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,float>::call
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,float> *this,Variant **param_1,
          int param_2,Variant *param_3,CallError *param_4)
...
void __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,String_const&>::call
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,String_const&> *this,
          Variant **param_1,int param_2,Variant *param_3,CallError *param_4)
...
/* ShaderEditorPlugin::_initialize_classv() */

void ShaderEditorPlugin::_initialize_classv(void)
      ...
      if (Container::initialize_class()::initialized == '\0') {
        if (Control::initialize_class()::initialized == '\0') {
          if (CanvasItem::initialize_class()::initialized == '\0') {
            ...
            if ((code *)PTR__bind_compatibility_methods_0011c070 !=
                Object::_bind_compatibility_methods) {
...
/* ShaderEditorPlugin::is_class(String const&) const */

undefined8 __thiscall ShaderEditorPlugin::is_class(ShaderEditorPlugin *this,String *param_1)
...
void __thiscall
LocalVector<ShaderEditorPlugin::EditedShader,unsigned_int,false,false>::remove_at
          (LocalVector<ShaderEditorPlugin::EditedShader,unsigned_int,false,false> *this,uint param_1
          )

{
  ...
  if (uVar8 <= param_1) {
    _err_print_index_error
              ("remove_at","./core/templates/local_vector.h",0x4c,(ulong)param_1,(ulong)uVar8,
  ...
  *(uint *)this = uVar8;
  if (param_1 < uVar8) {
    ...
    do {
      uVar5 = (int)uVar6 + 1;
      uVar6 = (ulong)uVar5;
      plVar1 = (long *)(*(long *)(this + 8) + uVar6 * 0x28);
      ...
      pOVar3 = (Object *)plVar7[1];
      if (pOVar2 != pOVar3) {
        plVar7[1] = (long)pOVar2;
        if ((pOVar2 != (Object *)0x0) && (cVar4 = RefCounted::reference(), cVar4 == '\0')) {
          plVar7[1] = 0;
        }
        if (((pOVar3 != (Object *)0x0) && (cVar4 = RefCounted::unreference(), cVar4 != '\0')) &&
  ...
  lVar9 = *plVar1;
joined_r0x00110b9e:
  if ((lVar9 != 0) && (cVar4 = RefCounted::unreference(), cVar4 != '\0')) {
    pOVar2 = (Object *)*plVar1;
    cVar4 = predelete_handler(pOVar2);
    if (cVar4 != '\0') {
      (**(code **)(*(long *)pOVar2 + 0x140))(pOVar2);
...
/* ShaderEditorPlugin::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void __thiscall
ShaderEditorPlugin::_get_property_listv(ShaderEditorPlugin *this,List *param_1,bool param_2)
...
void __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,Ref<Resource>const&>::call
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,Ref<Resource>const&> *this,
          Variant **param_1,int param_2,Variant *param_3,CallError *param_4)
...
void __thiscall Ref<Shader>::unref(Ref<Shader> *this)
...
void __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,Ref<Shader>>::call
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,Ref<Shader>> *this,Variant **param_1,
          int param_2,Variant *param_3,CallError *param_4)
...
LAB_00113542:
              Ref<Shader>::unref((Ref<Shader> *)&local_38);
            }
          }
        }
        (*pcVar10)((long *)(lVar1 + lVar2));
        if (((local_40 != (Object *)0x0) &&
            (cVar6 = RefCounted::unreference(), pOVar3 = local_40, cVar6 != '\0')) &&
           (cVar6 = predelete_handler(local_40), cVar6 != '\0')) {
          (**(code **)(*(long *)pOVar3 + 0x140))(pOVar3);
          Memory::free_static(pOVar3,false);
        }
        goto LAB_0011346e;
...
/* Ref<ShaderInclude>::unref() */

void __thiscall Ref<ShaderInclude>::unref(Ref<ShaderInclude> *this)
...
void __thiscall
CallableCustomMethodPointer<ShaderEditorPlugin,void,Ref<ShaderInclude>>::call
          (CallableCustomMethodPointer<ShaderEditorPlugin,void,Ref<ShaderInclude>> *this,
          Variant **param_1,int param_2,Variant *param_3,CallError *param_4)
...
LAB_001138e2:
              Ref<ShaderInclude>::unref((Ref<ShaderInclude> *)&local_38);
            }
          }
        }
  ...
  _err_print_error(&_LC41,"./core/object/callable_method_pointer.h",0x67,
                   "Parameter \"ObjectDB::get_instance(ObjectID(data.object_id))\" is null.",
                   (Ref<ShaderInclude> *)&local_38,0,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_38);
  CowData<char32_t>::_unref(local_48);
  CowData<char32_t>::_unref(local_50);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_40);
...

{
  ...
  if (param_1 < uVar9) {
    ...
    do {
      ...
      CowData<char32_t>::_unref((CowData<char32_t> *)(plVar7 + 4));
      CowData<char32_t>::_unref((CowData<char32_t> *)(plVar7 + 3));
      if ((plVar7[1] != 0) && (cVar4 = RefCounted::unreference(), cVar4 != '\0')) {
      ...
      if ((*plVar7 != 0) && (cVar4 = RefCounted::unreference(), cVar4 != '\0')) {
    ...
    } while ((undefined1 (*) [16])(lVar8 + 0x28 + ((ulong)(uVar6 - uVar9) + (ulong)uVar9) * 0x28) !=
...
void ShaderEditorPlugin::_GLOBAL__sub_I__get_current_shader(void)

/* manifold::CsgLeafNode::GetNodeType() const */undefined8 manifold::CsgLeafNode::GetNodeType(void) {
   return 3;
}
/* manifold::CsgOpNode::GetNodeType() const */undefined4 manifold::CsgOpNode::GetNodeType(CsgOpNode *this) {
   undefined4 uVar1;
   uVar1 = 3;
   if (*(uint*)( this + 0x38 ) < 3) {
...
/* std::_Rb_tree<int, std::pair<int const, manifold::Manifold::Impl::Relation>,
 ...
 while ( p_Var2 != (_Rb_tree_node_base*)0x0 );
   ...
   iVar5 = *(int*)( p_Var4 + 0x20 );
   LAB_00100068:p_Var3 = (_Rb_tree_node_base*)0x0;
   if (iVar5 < iVar6) {
      p_Var4 = p_Var3;
      p_Var3 = p_Var2;
   }

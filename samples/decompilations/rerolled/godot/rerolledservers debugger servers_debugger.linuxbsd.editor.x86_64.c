         ...
         if (cVar3 == '\0') {
            *(undefined8*)( this + 0x10 ) = 0;
            if (pOVar6 != (Object*)0x0) {
               cVar3 = RefCounted::unreference();
               joined_r0x001058d3:if (( cVar3 != '\0' ) && ( cVar3 = predelete_handler(pOVar6) ),cVar3 != '\0') goto LAB_001058f3;
            }
...
/* EngineProfiler::_initialize_classv() */void EngineProfiler::_initialize_classv(void) {
 ...
 while ( !bVar9 );
   ...
   void ServersDebugger::ServerInfo::~ServerInfo(ServerInfo *this) {
      long *plVar1;
      long lVar2;
      long lVar3;
      long *plVar4;
 ...
 while ( (int)plVar4[2] != 0 );
   ...
   void ServersDebugger::VisualProfiler::~VisualProfiler(VisualProfiler *this) {
      uint uVar1;
      long lVar2;
      void *pvVar3;
...
;
   ...
   void List<ServersDebugger::ServerInfo,DefaultAllocator>::~List(List<ServersDebugger::ServerInfo,DefaultAllocator> *this) {
      ServerInfo *this_00;
      long lVar1;
      long lVar2;
      long *plVar3;
 ...
 while ( (int)plVar3[2] != 0 );
   ...
   StringName * __thiscallHashMap<StringName,ServersDebugger::ServerInfo,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ServersDebugger::ServerInfo>>>::operator [](HashMap<StringName,ServersDebugger::ServerInfo,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ServersDebugger::ServerInfo>>> * this, StringName * param_1);
   {
      uint *puVar1;
      undefined8 *puVar2;
      long *plVar3;
...
;
 ...
 while ( ( uVar57 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = (ulong)uVar57 * lVar51,auVar23._8_8_ = 0,auVar23._0_8_ = uVar41,auVar8._8_8_ = 0,auVar8._0_8_ = ( ulong )(( uVar58 + uVar38 ) - SUB164(auVar7 * auVar23, 8)) * lVar51,auVar24._8_8_ = 0,auVar24._0_8_ = uVar41,uVar59 <= SUB164(auVar8 * auVar24, 8) );
      ...
      if (( plStack_70 != (long*)0x0 ) && ( pSVar56 = (StringName*)*plStack_70 ),pSVar56 != (StringName*)0x0) {
...
;
 ...
 while ( pSVar56 != (StringName*)0x0 );
      ...
      LAB_001095ad:puVar44 = (undefined8*)operator_new(0x28, "");
      *puVar44 = local_68._0_8_;
      ...
      puVar44[4] = 0;
      if (( local_48 != (undefined1(*) [16])0x0 ) && ( pSVar56 = *(StringName**)*local_48 ),pSVar56 != (StringName*)0x0) {
...
;
 ...
 while ( pSVar56 != (StringName*)0x0 );
      ...
      LAB_001096e9:ServersDebugger::ServerInfo::~ServerInfo((ServerInfo*)local_50);
...
;
      ...
      *puVar1 = uVar38;
      *(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;
      LAB_00109811:local_a0 = (ServerInfo*)local_78;
      ServersDebugger::ServerInfo::~ServerInfo(local_a0);
      LAB_00108f7c:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return local_a8;
      }
...
;
      ...
      *(undefined8*)( lVar46 + 0x20 ) = 0;
      LAB_00109154:plVar40 = (long*)0x0;
      LAB_00109156:if (( plStack_70 != (long*)0x0 ) && ( pSVar56 = (StringName*)*plStack_70 ),pSVar56 != (StringName*)0x0) {
         if (plVar40 == (long*)0x0) {
            pauVar45 = (undefined1(*) [16])operator_new(0x18, DefaultAllocator::alloc);
...
;
 ...
 while ( pSVar56 != (StringName*)0x0 );
      ...
      LAB_00109239:local_a8 = (StringName*)( *(long*)( *(long*)( this + 8 ) + (ulong)uVar58 * 8 ) + 0x18 );
      goto LAB_00109811;
   }

   /* ServersDebugger::ServersProfiler::add(Array const&) */
   void ServersDebugger::ServersProfiler::add(ServersProfiler *this, Array *param_1) {
      uint uVar1;
      long *plVar2;
      undefined1 auVar3[16];
...
;
 ...
 while ( pSVar23 != (StringName*)0x0 );
   ...
   void List<ServersDebugger::ResourceInfo,DefaultAllocator>::~List(List<ServersDebugger::ResourceInfo,DefaultAllocator> *this) {
      long *plVar1;
      long *plVar2;
      long lVar3;
      long lVar4;
 ...
 while ( (int)plVar5[2] != 0 );
   ...
   void List<RenderingServer::TextureInfo,DefaultAllocator>::~List(List<RenderingServer::TextureInfo,DefaultAllocator> *this) {
      long *plVar1;
      void *pvVar2;
      long lVar3;
      long lVar4;
 ...
 while ( (int)plVar5[2] != 0 );
   ...
   void List<ServersDebugger::ResourceInfo,DefaultAllocator>::sort_custom<Comparator<ServersDebugger::ResourceInfo>>(List<ServersDebugger::ResourceInfo,DefaultAllocator> *this) {
      size_t __n;
      int iVar1;
      int iVar2;
      int iVar3;
...
;
 ...
 while ( ppEVar8 != __src + ( iVar2 - 2 ) );
   ...
   void CowData<RenderingServer::FrameProfileArea>::_unref(CowData<RenderingServer::FrameProfileArea> *this) {
      long *plVar1;
      long *plVar2;
      long lVar3;
      long lVar4;
 ...
 while ( lVar3 != lVar7 );
   ...
   undefined8 CowData<RenderingServer::FrameProfileArea>::_realloc(CowData<RenderingServer::FrameProfileArea> *this, long param_1) {
      undefined8 *puVar1;
 ...
 while ( lVar6 != lVar2 );
   ...
   void ServersDebugger::VisualProfiler::tick(double param_1, double param_2, double param_3, double param_4) {
      long lVar1;
      code *pcVar2;
      long *plVar3;
      long lVar4;
 ...
 while ( !bVar5 );
   ...
   void CowData<ServersDebugger::ScriptFunctionInfo>::_unref(CowData<ServersDebugger::ScriptFunctionInfo> *this) {
      long *plVar1;
      long lVar2;
      code *pcVar3;
      long *plVar4;
 ...
 while ( lVar2 != lVar5 );
   ...
   undefined8 CowData<ServersDebugger::ScriptFunctionInfo>::_realloc(CowData<ServersDebugger::ScriptFunctionInfo> *this, long param_1) {
      undefined8 *puVar1;
      puVar1 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), param_1 + 0x10, false);
      if (puVar1 != (undefined8*)0x0) {
         *puVar1 = 1;
   ...
   undefined8 CowData<ServersDebugger::ScriptFunctionInfo>::resize<false>(CowData<ServersDebugger::ScriptFunctionInfo> *this, long param_1) {
      code *pcVar1;
      undefined8 uVar2;
      undefined8 *puVar3;
      undefined8 *puVar4;
...
;
 ...
 while ( puVar4 != puVar6 + param_1 * 5 );
   ...
   void CowData<ScriptLanguage::ProfilingInfo>::_unref(CowData<ScriptLanguage::ProfilingInfo> *this) {
      long *plVar1;
      long lVar2;
      code *pcVar3;
      long *plVar4;
 ...
 while ( lVar2 != lVar5 );
   ...
   void ServersDebugger::ScriptsProfiler::~ScriptsProfiler(ScriptsProfiler *this) {
      long *plVar1;
      uint uVar2;
      long lVar3;
      void *pvVar4;
 ...
 while ( lVar3 != (ulong)uVar2 << 2 );
   ...
   unsigned long&, bool) */
   void ServersDebugger::ScriptsProfiler::write_frame_data(ScriptsProfiler *this, Vector *param_1, ulong *param_2, bool param_3) {
      uint uVar1;
      code *pcVar2;
...
;
 ...
 while ( local_c8 != uVar24 );
   ...
   void ServersDebugger::ServersProfiler::_send_frame_data(ServersProfiler *this, bool param_1) {
      undefined8 *puVar1;
      long *plVar2;
      long lVar3;
      code *pcVar4;
 ...
 while ( true );
   ...
   void ServersDebugger::ServersProfiler::tick(ServersProfiler *this, double param_1, double param_2, double param_3, double param_4) {
   ...
   void ServersDebugger::ServersProfiler::toggle(ServersProfiler *this, bool param_1, Array *param_2) {
      uint uVar1;
      void *pvVar2;
      long lVar3;
      this[0x1d0] = (ServersProfiler)0x0;
 ...
 while ( lVar3 != (ulong)uVar2 << 2 );
   ...
   void ServersDebugger::ServersProfiler::~ServersProfiler(ServersProfiler *this) {
      long *plVar1;
      uint uVar2;
      long lVar3;
      void *pvVar4;
 ...
 while ( lVar3 != (ulong)uVar2 << 2 );
   ...
   undefined8 CowData<ScriptLanguage::ProfilingInfo>::_realloc(CowData<ScriptLanguage::ProfilingInfo> *this, long param_1) {
      undefined8 *puVar1;
      puVar1 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), param_1 + 0x10, false);
      if (puVar1 != (undefined8*)0x0) {
         *puVar1 = 1;
   ...
   void Ref<ServersDebugger::ServersProfiler>::instantiate<>(Ref<ServersDebugger::ServersProfiler> *this) {
      long *plVar1;
...
;
 ...
 while ( puVar18 != puVar8 );
      ...
      *(undefined1(*) [16])( this_02 + 0x440 ) = (undefined1[16])0x0;
      ...
      cVar5 = RefCounted::unreference();
      joined_r0x0010d0dd:if (( cVar5 != '\0' ) && ( cVar5 = predelete_handler(pOVar15) ),cVar5 != '\0') {
   ...
   LAB_0010d4e6:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* WARNING: Control flow encountered bad instruction data *//* ServersDebugger::ServersProfiler::~ServersProfiler() */void ServersDebugger::ServersProfiler::~ServersProfiler(ServersProfiler *this) {

...
uint FNT_Face_Init(long param_1, ulong *param_2, int param_3) {
   ...
   if (( local_148 == 0 ) && ( iVar7 = FT_Stream_ReadFields(uVar3, winmz_header_fields, &local_142) ),iVar7 == 0) {
      local_148 = 2;
      if (local_142 == 0x5a4d) {
         local_148 = FT_Stream_Seek(uVar3, local_140);
         uVar8 = local_148;
         if (( local_148 != 0 ) || ( uVar8 = FT_Stream_ReadFields(uVar3, winne_header_fields, &local_13e) ),uVar8 != 0) goto LAB_00100720;
         local_148 = 2;
         if (local_13e != 0x454e) {
            if (local_13e == 0x4550) {
               local_148 = FT_Stream_Seek(uVar3, local_140);

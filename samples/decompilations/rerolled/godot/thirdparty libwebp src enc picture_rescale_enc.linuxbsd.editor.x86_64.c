...
undefined8 RescalePlane(long param_1, undefined8 param_2, undefined8 param_3, int param_4, undefined8 param_5, undefined4 param_6, undefined4 param_7, undefined4 param_8, undefined8 param_9, undefined4 param_10) {
   int iVar1;
   undefined8 uVar2;
   int iVar3;
   int iVar4;
   ...
   uVar2 = WebPRescalerInit(auStack_98, param_2, param_3, param_5, param_6, param_7, param_8, param_10, param_9);
   if ((int)uVar2 != 0) {
      iVar4 = 0;
      iVar3 = (int)param_3;
      if (0 < iVar3) {
...
undefined8 WebPPictureCopy(int *param_1, int *param_2) {
   ...
   if (param_1 != param_2) {
      ...
      *(undefined8*)( param_2 + 2 ) = uVar1;
      for (int i = 0; i < 15; i++) {
         uVar1 = *(undefined8*)( param_1 + ( 4*i + 6 ) );
         *(undefined8*)( param_2 + ( 4*i + 4 ) ) = *(undefined8*)( param_1 + ( 4*i + 4 ) );
         *(undefined8*)( param_2 + ( 4*i + 6 ) ) = uVar1;
      }
      ...
      if (*param_1 == 0) {
         WebPCopyPlane(*(undefined8*)( param_1 + 4 ), param_1[10], *(undefined8*)( param_2 + 4 ), param_2[10], param_2[2], param_2[3]);
         WebPCopyPlane(*(undefined8*)( param_1 + 6 ), param_1[0xb], *(undefined8*)( param_2 + 6 ), param_2[0xb], param_2[2] + 1 >> 1, param_2[3] + 1 >> 1);
         WebPCopyPlane(*(undefined8*)( param_1 + 8 ), param_1[0xb], *(undefined8*)( param_2 + 8 ), param_2[0xb], param_2[2] + 1 >> 1, param_2[3] + 1 >> 1);
         if (*(long*)( param_2 + 0xc ) != 0) {
            WebPCopyPlane(*(undefined8*)( param_1 + 0xc ), param_1[0xe], *(long*)( param_2 + 0xc ), param_2[0xe], param_2[2], param_2[3]);
         }

      }
 else {
         WebPCopyPlane(*(undefined8*)( param_1 + 0x12 ), param_1[0x14] * 4, *(undefined8*)( param_2 + 0x12 ), param_2[0x14] * 4, param_2[2] * 4, param_2[3]);
      }
...
undefined8 WebPPictureView(int *param_1, int param_2, int param_3, int param_4, int param_5, int *param_6) {
   undefined8 uVar1;
   long lVar2;
   long lVar3;
   int iVar4;
      ...
      if (iVar4 != 0) {
         if (param_1 != piVar7) {
            ...
            *(undefined8*)( piVar7 + 2 ) = uVar1;
            for (int i = 0; i < 15; i++) {
               uVar1 = *(undefined8*)( param_1 + ( 4*i + 6 ) );
               *(undefined8*)( piVar7 + ( 4*i + 4 ) ) = *(undefined8*)( param_1 + ( 4*i + 4 ) );
               *(undefined8*)( piVar7 + ( 4*i + 6 ) ) = uVar1;
            }
...
undefined8 WebPPictureCrop(int *param_1, int param_2, int param_3, int param_4, int param_5) {
      ...
      if (iVar2 != 0) {
         ...
         if (iVar3 == 0) {
            ...
            if (*param_1 == 0) {
               ...
               iVar4 = local_14c / 2;
               iVar3 = param_1[0xb];
               WebPCopyPlane((long)( param_1[10] * local_150 + local_14c ) + *(long*)( param_1 + 4 ), param_1[10], local_138, uStack_120 & 0xffffffff, param_4, param_5);
               lVar7 = (long)( iVar6 * iVar3 + iVar4 );
               WebPCopyPlane(*(long*)( param_1 + 6 ) + lVar7, param_1[0xb], uStack_130, uStack_120._4_4_);
               WebPCopyPlane(*(long*)( param_1 + 8 ) + lVar7, param_1[0xb], local_128, uStack_120._4_4_, param_4 + 1 >> 1, param_5 + 1 >> 1);
               if (local_118 != 0) {
                  WebPCopyPlane((long)( iVar2 * param_1[0xe] + iVar1 ) + *(long*)( param_1 + 0xc ), param_1[0xe], local_118, uStack_110 & 0xffffffff, param_4, param_5);
               }

            }
 else {
               WebPCopyPlane(*(long*)( param_1 + 0x12 ) + ( (long)( param_1[0x14] * local_150 ) + (long)local_14c ) * 4, param_1[0x14] * 4, uStack_100, (int)local_f8 << 2, param_4 * 4, param_5);
            }
   ...
   uVar5 = 0;
   LAB_00100593:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar5;
   }
...
undefined8 WebPPictureRescale(int *param_1, int param_2, int param_3) {
   ...
   if (iVar1 == 0) {
      LAB_00100b60:uVar4 = WebPEncodingSetError(param_1, 5);
   }
 else {
      ...
      if (*param_1 == 0) {
         ...
         if (lVar3 != 0) {
            if (*(long*)( param_1 + 0xc ) == 0) {
               LAB_00100ad7:iVar1 = param_1[10];
               uVar4 = *(undefined8*)( param_1 + 4 );
            }
 else {
               WebPInitAlphaProcessing();
               iVar1 = RescalePlane(*(undefined8*)( param_1 + 0xc ), iVar5, iVar2, param_1[0xe], local_108, local_13c, local_140, uStack_100 & 0xffffffff, lVar3, 1);
            ...
            iVar1 = RescalePlane(uVar4, iVar5, iVar2, iVar1, local_128, local_13c, local_140, uStack_110 & 0xffffffff, lVar3, 1);
            if (iVar1 != 0) {
               iVar1 = iVar2 + 1 >> 1;
               iVar5 = iVar5 + 1 >> 1;
               iVar2 = RescalePlane(*(undefined8*)( param_1 + 6 ), iVar5, iVar1, param_1[0xb], uStack_120, local_13c + 1 >> 1, local_140 + 1 >> 1, uStack_110 >> 0x20, lVar3, 1);
               if (( iVar2 != 0 ) && ( iVar2 = RescalePlane(*(undefined8*)( param_1 + 8 ), iVar5, iVar1, param_1[0xb], local_118, local_13c + 1 >> 1, local_140 + 1 >> 1, uStack_110 >> 0x20, lVar3) ),iVar2 != 0) {
                  if (local_108 != 0) {
                     WebPMultRows(local_128, uStack_110 & 0xffffffff, local_108, uStack_100 & 0xffffffff, uStack_130 & 0xffffffff, uStack_130._4_4_, 1);
                  }
         ...
         if (lVar3 != 0) {
            ...
            iVar2 = RescalePlane(*(undefined8*)( param_1 + 0x12 ), iVar5, iVar2, param_1[0x14] * 4, uStack_f0, local_13c, local_140, (int)local_e8 << 2, lVar3, 4);
            if (iVar2 == 0) goto LAB_00100b60;
            WebPMultARGBRows(uStack_f0, (int)local_e8 * 4, uStack_130 & 0xffffffff, uStack_130._4_4_, 1);
            LAB_00100c35:WebPPictureFree(param_1);
            WebPSafeFree(lVar3);
            uVar4 = 1;
   ...
   LAB_00100b6d:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }

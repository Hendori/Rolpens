...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<Vector2, int, HashMapHasherDefault, HashMapComparatorDefault<Vector2>,
   DefaultTypedAllocator<HashMapElement<Vector2, int> > >::operator[](Vector2 const&) */undefined1 * __thiscallHashMap<Vector2,int,HashMapHasherDefault,HashMapComparatorDefault<Vector2>,DefaultTypedAllocator<HashMapElement<Vector2,int>>>::operator [](HashMap<Vector2,int,HashMapHasherDefault,HashMapComparatorDefault<Vector2>,DefaultTypedAllocator<HashMapElement<Vector2,int>>> * this, Vector2 * param_1) * puVar1 ;undefined8 *puVar2float fVar3uint uVar4void *pvVar5void *__slong lVar6long lVar7undefined1 auVar8[16]undefined1 auVar9[16]undefined1 auVar10[16]undefined1 auVar11[16]undefined1 auVar12[16]undefined1 auVar13[16]undefined1 auVar14[16]undefined1 auVar15[16]undefined1 auVar16[16]undefined1 auVar17[16]undefined1 auVar18[16]undefined1 auVar19[16]undefined1 auVar20[16]undefined1 auVar21[16]undefined1 auVar22[16]undefined1 auVar23[16]undefined1(*pauVar24)[16];char cVar25uint uVar26ulong uVar27undefined8 uVar28void *__s_00undefined1(*pauVar29)[16];void *pvVar30int iVar31uint uVar32long lVar33long lVar34ulong uVar35undefined8 uVar36uint uVar37uint uVar38ulong uVar39undefined1(*pauVar40)[16];long in_FS_OFFSETfloat fVar41uint local_c8uint local_70uint local_6c[5]undefined8 local_58long local_40local_40 = *(long*)( in_FS_OFFSET + 0x28 );local_70 = 0;cVar25 = _lookup_pos(this, param_1, &local_70);if (cVar25 != '\0') {
   pauVar29 = *(undefined1(**) [16])( *(long*)( this + 8 ) + (ulong)local_70 * 8 );
   goto LAB_0010a067;
}
uVar32 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );if (*(long*)( this + 8 ) == 0) {
   uVar35 = (ulong)uVar32;
   uVar27 = uVar35 * 4;
   uVar39 = uVar35 * 8;
...
local_6c[0] = 0;cVar25 = _lookup_pos(this, param_1, local_6c);if (cVar25 != '\0') {
...
local_58 = *(undefined8*)param_1;pauVar29 = (undefined1(*) [16])operator_new(0x20, "");*pauVar29 = (undefined1[16])0x0;*(undefined4*)( pauVar29[1] + 8 ) = 0;*(undefined8*)pauVar29[1] = local_58;puVar2 = *(undefined8**)( this + 0x20 );if (puVar2 == (undefined8*)0x0) {
...
fVar3 = *(float*)param_1;*(undefined1(**) [16])( this + 0x20 ) = pauVar29;uVar32 = 0x3413905a;if (fVar3 == 0.0) {
...
uVar38 = 0;lVar6 = *(long*)( this + 0x10 );lVar7 = *(long*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( this + 0x28 ) * 8 );uVar26 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );uVar39 = CONCAT44(0, uVar26);auVar12._8_8_ = 0;auVar12._0_8_ = uVar27 * lVar7;auVar20._8_8_ = 0;auVar20._0_8_ = uVar39;lVar34 = SUB168(auVar12 * auVar20, 8);lVar33 = *(long*)( this + 8 );puVar1 = (uint*)( lVar6 + lVar34 * 4 );iVar31 = SUB164(auVar12 * auVar20, 8);uVar4 = *puVar1;pauVar24 = pauVar29;while (uVar4 != 0) {
   auVar13._8_8_ = 0;
...
;*(undefined1(**) [16])( lVar33 + lVar34 * 8 ) = pauVar24;*puVar1 = uVar32;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_0010a067:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return pauVar29[1] + 8;}/* CowData<Vector2>::_realloc(long) */undefined8 CowData<Vector2>::_realloc(CowData<Vector2> *this, long param_1) {
   undefined8 *puVar1;

/* ShaderFileEditorPlugin::make_visible(bool) */

void __thiscall ShaderFileEditorPlugin::make_visible(ShaderFileEditorPlugin *this,bool param_1)
...
/* ShaderFileEditorPlugin::handles(Object*) const */

bool __thiscall ShaderFileEditorPlugin::handles(ShaderFileEditorPlugin *this,Object *param_1)
...
/* ShaderFileEditor::_update_version(StringName const&, RenderingDeviceCommons::ShaderStage) */

void ShaderFileEditor::_update_version(void)
...
void __thiscall ShaderFileEditorPlugin::~ShaderFileEditorPlugin(ShaderFileEditorPlugin *this)
...
/* WARNING: Removing unreachable block (ram,0x00100a00) */
/* WARNING: Removing unreachable block (ram,0x00100d60) */
/* WARNING: Removing unreachable block (ram,0x00100ca9) */
/* WARNING: Removing unreachable block (ram,0x00100d98) */
/* WARNING: Removing unreachable block (ram,0x00100da8) */
/* WARNING: Removing unreachable block (ram,0x00100d73) */
/* WARNING: Removing unreachable block (ram,0x00100d93) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ShaderFileEditor::ShaderFileEditor() */

void __thiscall ShaderFileEditor::ShaderFileEditor(ShaderFileEditor *this)

{
  ...
  *(ItemList **)(this + 0xa18) = this_01;
  ...
  create_custom_callable_function_pointer<ShaderFileEditor,int>
            ((ShaderFileEditor *)&local_98,(char *)this,
             (_func_void_int *)"&ShaderFileEditor::_version_selected");
  ...
  *(BoxContainer **)(this + 0xa10) = this_03;
  ...
  if (cVar5 != '\0') {
    pBVar7 = local_b0;
    if ((this_04 != (ButtonGroup *)0x0) &&
       (cVar5 = RefCounted::reference(), pBVar7 = this_04, local_b0 = this_04, cVar5 == '\0')) {
      local_b0 = (ButtonGroup *)0x0;
    }
  ...
  *(RichTextLabel **)(this + 0xa48) = this_06;
  ...
  if (((local_b0 != (ButtonGroup *)0x0) && (cVar5 = RefCounted::unreference(), cVar5 != '\0')) &&
     (cVar5 = predelete_handler((Object *)local_b0), cVar5 != '\0')) {
...
/* ShaderFileEditor::_version_selected(int) */

void ShaderFileEditor::_version_selected(int param_1)

{
  ...
  if (local_88 == 0) {
    _err_print_error("_version_selected","editor/plugins/shader_file_editor_plugin.cpp",0x39,
                     "Condition \"bytecode.is_null()\" is true.",0,0);
  }
  else {
    lVar9 = 0;
    uVar7 = 0xffffffff;
...
LAB_0010183f:
        ...
        _err_print_index_error
                  ("get_stage_compile_error","./servers/rendering/rendering_device_binds.h",0x13f,
                   (ulong)uVar7,5,"p_stage","RD::SHADER_STAGE_MAX","",false,false);
        local_80 = 0;
      }
      pRVar2 = *(Ref **)(pSVar10 + 0xa48);
      if ((_version_selected(int)::{lambda()#3}::operator()()::sname == '\0') &&
         (iVar6 = __cxa_guard_acquire(&_version_selected(int)::{lambda()#3}::operator()()::sname),
         iVar6 != 0)) {
        _scs_create((char *)&_version_selected(int)::{lambda()#3}::operator()()::sname,true);
        __cxa_atexit(StringName::~StringName,
                     &_version_selected(int)::{lambda()#3}::operator()()::sname,&__dso_handle);
        __cxa_guard_release(&_version_selected(int)::{lambda()#3}::operator()()::sname);
      }
  ...
  Ref<RDShaderSPIRV>::unref((Ref<RDShaderSPIRV> *)&local_88);
...
void __thiscall ShaderFileEditor::_update_options(ShaderFileEditor *this)

{
  ...
  if (*(long *)(this + 0xa08) == 0) {
    if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
      _err_print_error("_update_options","editor/plugins/shader_file_editor_plugin.cpp",0x6a,
                       "Condition \"shader_file.is_null()\" is true.",0,0);
      return;
    }
    goto LAB_00102b87;
  }
  ...
  CowData<char32_t>::_ref
            ((CowData<char32_t> *)&local_58,(CowData *)(*(long *)(this + 0xa08) + 0x270));
...
LAB_00102526:
        ...
        _err_print_error("_update_options","editor/plugins/shader_file_editor_plugin.cpp",0x90,
                         "Condition \"bytecode.is_null()\" is true.",0,0);
      ...
      uVar41 = 0;
      while ((uVar28 != uVar39 ||
             (*(Object **)(*(long *)(*(long *)(lVar34 + 0x248) + lVar30 * 8) + 0x10) != local_58)))
      {
        uVar41 = uVar41 + 1;
        auVar7._8_8_ = 0;
        ...
        if ((uVar39 == 0) ||
           (auVar8._8_8_ = 0, auVar8._0_8_ = (ulong)uVar39 * lVar45, auVar16._8_8_ = 0,
           auVar16._0_8_ = uVar44, auVar9._8_8_ = 0,
           auVar9._0_8_ = (ulong)((uVar25 + iVar29) - SUB164(auVar8 * auVar16,8)) * lVar45,
           auVar17._8_8_ = 0, auVar17._0_8_ = uVar44, SUB164(auVar9 * auVar17,8) < uVar41))
        goto LAB_001024f8;
      }
      if ((*(long *)(lVar34 + 0x248) == 0) || (*(int *)(lVar34 + 0x26c) == 0)) {
LAB_001024c8:
             ...
             (*(Object **)(*(long *)(*(long *)(lVar34 + 0x248) + lVar30 * 8) + 0x10) != local_58)))
      {
        ...
        if ((uVar39 == 0) ||
           (auVar12._8_8_ = 0, auVar12._0_8_ = (ulong)uVar39 * lVar45, auVar20._8_8_ = 0,
           auVar20._0_8_ = uVar44, auVar13._8_8_ = 0,
           auVar13._0_8_ = (ulong)((uVar25 + uVar41) - SUB164(auVar12 * auVar20,8)) * lVar45,
           auVar21._8_8_ = 0, auVar21._0_8_ = uVar44, SUB164(auVar13 * auVar21,8) < uVar40))
        goto LAB_001024c8;
      }
      ...
      do {
        local_58 = (Object *)0x0;
        if (((*(long *)pCVar35 != 0) &&
            (CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,pCVar35),
            local_58 != (Object *)0x0)) && (1 < *(uint *)(local_58 + -8))) {
          cVar43 = cVar24;
        }
        pCVar35 = pCVar35 + 8;
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_58);
      ...
      if (cVar43 == '\0') {
        if (_update_options()::{lambda()#3}::operator()()::sname == '\0') {
          puVar32 = &_update_options()::{lambda()#3}::operator()()::sname;
          pcVar36 = (char *)&_update_options()::{lambda()#3}::operator()()::sname;
...
joined_r0x00102633:
          local_58 = pOVar31;
          if ((cVar24 != '\0') &&
             (cVar24 = predelete_handler(pOVar23), pOVar31 = local_58, cVar24 != '\0')) {
      ...
      pOVar31 = local_60;
      if (((local_60 != (Object *)0x0) && (cVar24 = RefCounted::unreference(), cVar24 != '\0')) &&
         (cVar24 = predelete_handler(pOVar31), cVar24 != '\0')) {
        (**(code **)(*(long *)pOVar31 + 0x140))(pOVar31);
        Memory::free_static(pOVar31,false);
      }
      if (((local_68 != (Object *)0x0) &&
          (cVar24 = RefCounted::unreference(), pOVar31 = local_68, cVar24 != '\0')) &&
         (cVar24 = predelete_handler(local_68), cVar24 != '\0')) {
        (**(code **)(*(long *)pOVar31 + 0x140))(pOVar31);
        Memory::free_static(pOVar31,false);
      }
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_70);
...
LAB_00102582:
      ...
      if (local_68 == (Object *)0x0) {
        _err_print_error("_update_options","editor/plugins/shader_file_editor_plugin.cpp",0xb1,
                         "Condition \"bytecode.is_null()\" is true.",0,0);
      ...
      do {
        ...
        if (*(long *)pCVar35 == 0) {
          local_60 = (Object *)0x0;
          if ((*(long *)pCVar37 == 0) ||
             (CowData<char32_t>::_ref((CowData<char32_t> *)&local_60,pCVar37),
             local_60 == (Object *)0x0)) {
...
LAB_001029fb:
    ...
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_58);
    if ((int)uVar3 == 1) goto LAB_00101e28;
    CanvasItem::hide();
    CanvasItem::hide();
    RichTextLabel::clear();
    pRVar4 = *(Ref **)(this + 0xa48);
    if ((_update_options()::{lambda()#1}::operator()()::sname == '\0') &&
       (iVar26 = __cxa_guard_acquire(&_update_options()::{lambda()#1}::operator()()::sname),
       iVar26 != 0)) {
      _scs_create((char *)&_update_options()::{lambda()#1}::operator()()::sname,true);
      __cxa_atexit(StringName::~StringName,&_update_options()::{lambda()#1}::operator()()::sname,
                   &__dso_handle);
      __cxa_guard_release(&_update_options()::{lambda()#1}::operator()()::sname);
    }
    Control::get_theme_font((StringName *)&local_58,(StringName *)this);
    RichTextLabel::push_font(pRVar4,(int)(CowData<char32_t> *)&local_58);
    if (((local_58 != (Object *)0x0) &&
        (cVar24 = RefCounted::unreference(), pOVar31 = local_58, cVar24 != '\0')) &&
       (cVar24 = predelete_handler(local_58), cVar24 != '\0')) {
      (**(code **)(*(long *)pOVar31 + 0x140))(pOVar31);
    ...
    vformat<String>((CowData<char32_t> *)&local_58,(String_conflict *)&local_70,
...
/* ShaderFileEditor::_notification(int) */

void __thiscall ShaderFileEditor::_notification(ShaderFileEditor *this,int param_1)
...
/* ShaderFileEditor::_editor_settings_changed() */

void __thiscall ShaderFileEditor::_editor_settings_changed(ShaderFileEditor *this)
...
/* ShaderFileEditor::edit(Ref<RDShaderFile> const&) */

void __thiscall ShaderFileEditor::edit(ShaderFileEditor *this,Ref *param_1)

{
  ...
  if (pCVar1 == (Callable *)0x0) {
    if (pCVar2 != (Callable *)0x0) {
      create_custom_callable_function_pointer<ShaderFileEditor>
                (aSStack_38,(char *)this,(_func_void *)"&ShaderFileEditor::_shader_changed");
...
joined_r0x00102ce7:
        if ((cVar3 != '\0') && (cVar3 = predelete_handler((Object *)pCVar2), cVar3 != '\0')) {
...
/* ShaderFileEditorPlugin::edit(Object*) */

void __thiscall ShaderFileEditorPlugin::edit(ShaderFileEditorPlugin *this,Object *param_1)
...
/* ShaderFileEditor::_shader_changed() */

void __thiscall ShaderFileEditor::_shader_changed(ShaderFileEditor *this)
...
/* ShaderFileEditorPlugin::is_class_ptr(void*) const */

uint __thiscall ShaderFileEditorPlugin::is_class_ptr(ShaderFileEditorPlugin *this,void *param_1)

{
  return (uint)CONCAT71(0x10f3,(undefined4 *)param_1 == &EditorPlugin::get_class_ptr_static()::ptr)
         | (uint)CONCAT71(0x10f2,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x10f3,(undefined4 *)param_1 == &Node::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x10f3,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr);
}



/* ShaderFileEditorPlugin::_getv(StringName const&, Variant&) const */

undefined8 ShaderFileEditorPlugin::_getv(StringName *param_1,Variant *param_2)
...
/* ShaderFileEditorPlugin::_setv(StringName const&, Variant const&) */

undefined8 ShaderFileEditorPlugin::_setv(StringName *param_1,Variant *param_2)
...
/* ShaderFileEditorPlugin::_property_can_revertv(StringName const&) const */

undefined8 ShaderFileEditorPlugin::_property_can_revertv(StringName *param_1)
...
/* ShaderFileEditorPlugin::_property_get_revertv(StringName const&, Variant&) const */

undefined8 ShaderFileEditorPlugin::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* ShaderFileEditorPlugin::has_main_screen() const */

undefined8 ShaderFileEditorPlugin::has_main_screen(void)
...
/* CallableCustomMethodPointer<ShaderFileEditor, void, int>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<ShaderFileEditor,void,int>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<ShaderFileEditor,void,int> *this)
...
/* CallableCustomMethodPointer<ShaderFileEditor, void>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<ShaderFileEditor,void>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<ShaderFileEditor,void> *this)
...
/* CallableCustomMethodPointer<ShaderFileEditor, void, int>::get_argument_count(bool&) const */

undefined8 __thiscall
CallableCustomMethodPointer<ShaderFileEditor,void,int>::get_argument_count
          (CallableCustomMethodPointer<ShaderFileEditor,void,int> *this,bool *param_1)
...
/* CallableCustomMethodPointer<ShaderFileEditor, void>::get_argument_count(bool&) const */

undefined8 __thiscall
CallableCustomMethodPointer<ShaderFileEditor,void>::get_argument_count
          (CallableCustomMethodPointer<ShaderFileEditor,void> *this,bool *param_1)
...
/* ShaderFileEditor::_property_get_revertv(StringName const&, Variant&) const */

undefined8 ShaderFileEditor::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* ShaderFileEditor::_property_can_revertv(StringName const&) const */

undefined8 ShaderFileEditor::_property_can_revertv(StringName *param_1)
...
/* ShaderFileEditorPlugin::_validate_propertyv(PropertyInfo&) const */

void ShaderFileEditorPlugin::_validate_propertyv(PropertyInfo *param_1)
...
LAB_00104636:
        if (pbVar15 != (byte *)0x0) goto LAB_00104528;
        goto LAB_0010463f;
      }
      if (pbVar16 == (byte *)0x0) {
        puVar7 = *(uint **)(lVar8 + 0x10);
...
LAB_001045d9:
        if (pbVar16 == (byte *)0x0) goto LAB_001045de;
        goto LAB_00104586;
      }
      bVar11 = *pbVar17;
      uVar4 = (uint)(char)bVar11;
...
/* CallableCustomMethodPointer<ShaderFileEditor, void, int>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<ShaderFileEditor,void,int>::get_object
          (CallableCustomMethodPointer<ShaderFileEditor,void,int> *this)
...
/* CallableCustomMethodPointer<ShaderFileEditor, void>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<ShaderFileEditor,void>::get_object
          (CallableCustomMethodPointer<ShaderFileEditor,void> *this)
...

{
  ...
  if (in_RSI != &get_class_ptr_static()::ptr) {
    uVar1 = (uint)CONCAT71(0x10f3,in_RSI == &Container::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10f2,in_RSI == &SplitContainer::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10f3,in_RSI == &Control::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10f3,in_RSI == &CanvasItem::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10f3,in_RSI == &Node::get_class_ptr_static()::ptr) |
...
/* ShaderFileEditor::is_class_ptr(void*) const */

uint ShaderFileEditor::is_class_ptr(void *param_1)

{
  ...
  if (in_RSI != &get_class_ptr_static()::ptr) {
    uVar1 = (uint)CONCAT71(0x10f3,in_RSI == &Container::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10f3,in_RSI == &PanelContainer::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10f3,in_RSI == &Control::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10f3,in_RSI == &CanvasItem::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10f3,in_RSI == &Node::get_class_ptr_static()::ptr) |
            CONCAT31((int3)((uint)in_EDX >> 8),in_RSI == &Object::get_class_ptr_static()::ptr);
...
/* ShaderFileEditorPlugin::_notificationv(int, bool) */

void __thiscall
ShaderFileEditorPlugin::_notificationv(ShaderFileEditorPlugin *this,int param_1,bool param_2)
...
/* ShaderFileEditor::_validate_propertyv(PropertyInfo&) const */

void ShaderFileEditor::_validate_propertyv(PropertyInfo *param_1)
...

{
  ...
  if (in_RSI != &get_class_ptr_static()::ptr) {
    uVar1 = (uint)CONCAT71(0x10f3,in_RSI == &Container::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10f3,in_RSI == &BoxContainer::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10f3,in_RSI == &Control::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10f3,in_RSI == &CanvasItem::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10f3,in_RSI == &Node::get_class_ptr_static()::ptr) |
            CONCAT31((int3)((uint)in_EDX >> 8),in_RSI == &Object::get_class_ptr_static()::ptr);
...
/* ShaderFileEditor::_setv(StringName const&, Variant const&) */

undefined8 ShaderFileEditor::_setv(StringName *param_1,Variant *param_2)
...
/* ShaderFileEditor::_getv(StringName const&, Variant&) const */

undefined8 ShaderFileEditor::_getv(StringName *param_1,Variant *param_2)

{
  undefined8 uVar1;
  
  if (((code *)PTR__get_00113058 != CanvasItem::_get) &&
...
/* WARNING: Removing unreachable block (ram,0x00105ab8) */
...
/* WARNING: Removing unreachable block (ram,0x00105b28) */
...
/* ShaderFileEditorPlugin::get_plugin_name() const */

ShaderFileEditorPlugin * __thiscall
...
/* ShaderFileEditor::_get_class_namev() const */

undefined8 * ShaderFileEditor::_get_class_namev(void)
...
LAB_00106873:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      goto LAB_00106873;
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"ShaderFileEditor");
      goto LAB_001068de;
    }
  }
  StringName::assign_static_unique_class_name
...
/* ShaderFileEditorPlugin::_get_class_namev() const */

undefined8 * ShaderFileEditorPlugin::_get_class_namev(void)
...
LAB_00106b43:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      goto LAB_00106b43;
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"ShaderFileEditorPlugin");
      goto LAB_00106bae;
    }
  }
  StringName::assign_static_unique_class_name
...
/* Callable create_custom_callable_function_pointer<ShaderFileEditor>(ShaderFileEditor*, char
   const*, void (ShaderFileEditor::*)()) */

ShaderFileEditor *
create_custom_callable_function_pointer<ShaderFileEditor>
          (ShaderFileEditor *param_1,char *param_2,_func_void *param_3)
...
/* Callable create_custom_callable_function_pointer<ShaderFileEditor, int>(ShaderFileEditor*, char
   const*, void (ShaderFileEditor::*)(int)) */

ShaderFileEditor *
create_custom_callable_function_pointer<ShaderFileEditor,int>
          (ShaderFileEditor *param_1,char *param_2,_func_void_int *param_3)
...
/* ShaderFileEditor::_initialize_classv() */

void ShaderFileEditor::_initialize_classv(void)
...
/* ShaderFileEditorPlugin::get_class() const */

void ShaderFileEditorPlugin::get_class(void)
...
/* ShaderFileEditor::get_class() const */

void ShaderFileEditor::get_class(void)
...
void __thiscall
CallableCustomMethodPointer<ShaderFileEditor,void>::call
          (CallableCustomMethodPointer<ShaderFileEditor,void> *this,Variant **param_1,int param_2,
...
void __thiscall
CallableCustomMethodPointer<ShaderFileEditor,void,int>::call
          (CallableCustomMethodPointer<ShaderFileEditor,void,int> *this,Variant **param_1,
...
/* ShaderFileEditorPlugin::_initialize_classv() */

void ShaderFileEditorPlugin::_initialize_classv(void)
...
/* ShaderFileEditorPlugin::is_class(String const&) const */

undefined8 __thiscall
ShaderFileEditorPlugin::is_class(ShaderFileEditorPlugin *this,String_conflict *param_1)
...
undefined8 __thiscall Container::is_class(Container *this,String_conflict *param_1)
...
/* ShaderFileEditor::is_class(String const&) const */

undefined8 __thiscall ShaderFileEditor::is_class(ShaderFileEditor *this,String_conflict *param_1)
...
/* ShaderFileEditorPlugin::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void __thiscall
ShaderFileEditorPlugin::_get_property_listv(ShaderFileEditorPlugin *this,List *param_1,bool param_2)
...
/* ShaderFileEditor::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void __thiscall
ShaderFileEditor::_get_property_listv(ShaderFileEditor *this,List *param_1,bool param_2)
...
/* Ref<RDShaderSPIRV>::unref() */

void __thiscall Ref<RDShaderSPIRV>::unref(Ref<RDShaderSPIRV> *this)
...
/* ShaderFileEditor::_notificationv(int, bool) */

void __thiscall ShaderFileEditor::_notificationv(ShaderFileEditor *this,int param_1,bool param_2)
...
void ShaderFileEditor::_GLOBAL__sub_I__update_version(void)

...
void parse_encoding(long param_1, ulong *param_2) {
            ...
            *(undefined8*)( param_1 + 0x238 ) = uVar9;
            if (local_44 == 0) {
               ...
               *(undefined8*)( param_1 + 0x240 ) = uVar9;
               if (( local_44 == 0 ) && ( local_44 = ( **(code**)*puVar3 )(puVar1, local_78, uVar10) ),local_44 == 0) {
                  if (0 < local_78) {
                     iVar7 = 0;
                     do {
                        iVar11 = iVar7 + 1;
 ...
 else if (( __s1 + 0x11 < pbVar4 ) && ( iVar7 = strncmp((char*)__s1, "StandardEncoding", 0x10) ),iVar7 == 0) {
         *(undefined4*)( param_1 + 0x220 ) = 2;
      }
 else if (( __s1 + 0xf < pbVar4 ) && ( iVar7 = iVar7 == 0 )) {
         *(undefined4*)( param_1 + 0x220 ) = 4;
      }
 else if (( __s1 + 0x12 < pbVar4 ) && ( iVar7 = strncmp((char*)__s1, "ISOLatin1Encoding", 0x11) ),iVar7 == 0) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int T1_Read_Metrics(long param_1, long param_2) {
   ...
   if (( local_70 == 0 ) && ( local_70 = FT_Stream_EnterFrame(param_2, *(undefined8*)( param_2 + 8 )) ),local_70 == 0) {
         ...
         *(int*)( param_1 + 0x84 ) = (int)( lVar19 >> 0x30 );
         ...
         if (local_70 == 0) {
            ...
            if (( ( 6 < *(ulong*)( param_2 + 8 ) ) && ( *(byte*)( (long)puVar17 + 1 ) < 4 ) ) && ( *(ulong*)( param_2 + 8 ) == ( ulong ) * (uint*)( puVar17 + 1 ) )) {
               ...
               if (( ( puVar16 < puVar15 + 9 ) || ( *puVar15 < 0x12 ) ) || ( puVar15 = (ushort*)( ( ulong ) * (uint*)( puVar15 + 7 ) + (long)puVar17 ) ),puVar17 == puVar15) goto LAB_00106300;
               puVar17 = puVar15 + 1;
               if (puVar16 < puVar17) {

/* Basis::invert() */void Basis::invert(Basis *this) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
...
/* Basis::orthonormalize() */void Basis::orthonormalize(Basis *this) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   fVar5 = *(float*)( this + 4 ) * fVar4 + fVar11 * *(float*)( this + 0x10 ) + *(float*)( this + 0x1c ) * fVar9;
...
/* Basis::orthonormalized() const */void Basis::orthonormalized(void) {
   undefined4 uVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   undefined8 uVar4;
...
/* Basis::is_orthogonal() const */undefined4 Basis::is_orthogonal(Basis *this) {
   float fVar1;
   if (ABS(*(float*)( this + 4 ) * *(float*)this + *(float*)( this + 0x10 ) * *(float*)( this + 0xc ) + *(float*)( this + 0x1c ) * *(float*)( this + 0x18 )) < _LC5) {
      if (ABS(*(float*)this * *(float*)( this + 8 ) + *(float*)( this + 0xc ) * *(float*)( this + 0x14 ) + *(float*)( this + 0x18 ) * *(float*)( this + 0x20 )) < _LC5) {
         fVar1 = ABS(*(float*)( this + 8 ) * *(float*)( this + 4 ) + *(float*)( this + 0x14 ) * *(float*)( this + 0x10 ) + *(float*)( this + 0x20 ) * *(float*)( this + 0x1c ));
...
/* Basis::is_orthonormal() const */undefined4 Basis::is_orthonormal(Basis *this) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   if (( ABS(fVar9 * fVar1 + fVar6 * fVar5 + fVar3 * fVar2) < _LC5 ) && ( ABS(fVar1 * fVar10 + fVar5 * fVar7 + fVar2 * fVar4) < _LC5 )) {
...
/* Basis::is_conformal() const */undefined4 Basis::is_conformal(Basis *this) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   if (( ABS(fVar4 * fVar1 + fVar3 * fVar7 + fVar5 * fVar2) < _LC5 ) && ( ABS(fVar1 * fVar11 + fVar7 * fVar9 + fVar2 * fVar6) < _LC5 )) {
...
/* Basis::is_diagonal() const */undefined4 Basis::is_diagonal(Basis *this) {
   if (( ( ( ABS(*(float*)( this + 4 )) < _LC5 ) && ( ABS(*(float*)( this + 8 )) < _LC5 ) ) && ( ABS(*(float*)( this + 0xc )) < _LC5 ) ) && ( ( ABS(*(float*)( this + 0x14 )) < _LC5 && ( ABS(*(float*)( this + 0x18 )) < _LC5 ) ) )) {
      return CONCAT31(( int3 )((uint)ABS(*(float*)( this + 0x1c )) >> 8), ABS(*(float*)( this + 0x1c )) < _LC5);
   }

   return 0;
}
/* Basis::is_rotation() const */ulong Basis::is_rotation(Basis *this) {
   ulong uVar1;
   float fVar2;
   uVar1 = is_conformal(this);
   if (( (char)uVar1 != '\0' ) && ( fVar2 = ( ( *(float*)( this + 0x10 ) * *(float*)( this + 0x20 ) - *(float*)( this + 0x1c ) * *(float*)( this + 0x14 ) ) * *(float*)this - ( *(float*)( this + 0x20 ) * *(float*)( this + 4 ) - *(float*)( this + 0x1c ) * *(float*)( this + 8 ) ) * *(float*)( this + 0xc ) ) + ( *(float*)( this + 0x14 ) * *(float*)( this + 4 ) - *(float*)( this + 0x10 ) * *(float*)( this + 8 ) ) * *(float*)( this + 0x18 ) ),fVar2 != _LC4) {
...
/* Basis::is_symmetric() const */undefined4 Basis::is_symmetric(Basis *this) {
   float fVar1;
   float fVar2;
   undefined4 uVar3;
   float fVar4;
   ...
   if (*(float*)( this + 0xc ) == fVar1) {
      LAB_00100a2c:fVar1 = *(float*)( this + 8 );
      ...
      LAB_00100ac0:uVar3 = 0;
   }

   return uVar3;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Basis::diagonalize() */undefined1(*)[16];Basis::diagonalize(void) {
   char cVar1;
   long lVar2;
   int iVar3;
   Basis *in_RSI;
   ...
   if (cVar1 == '\0') {
      _err_print_error("diagonalize", "core/math/basis.cpp", 0x9a, "Condition \"!is_symmetric()\" is true. Returning: Basis()", 0, 0);
      fVar17 = _LC4;
      ...
      if (__LC12 < local_8c) {
         ...
         while (true) {
            ...
            *(uint*)( local_58 + ( lVar2 + uVar4 * 3 ) * 4 ) = uVar9;
            ...
            fVar13 = local_a4 * (float)local_48._0_4_ + afStack_54[2] * fVar10 + local_84 * (float)local_48._4_4_;
            fVar6 = local_ac * (float)local_48._0_4_ + afStack_54[2] * fVar17 + local_b0 * (float)local_48._4_4_;
            fVar14 = local_9c * (float)local_48._0_4_ + local_a8 * afStack_54[2] + local_98 * (float)local_48._4_4_;
            ...
            local_b0 = fVar8 * (float)local_48._0_4_ + afStack_54[2] * fVar16 + (float)local_48._4_4_ * fVar15;
            ...
            local_ac = (float)local_48._0_4_ * fVar6 + afStack_54[2] * fVar14 + (float)local_48._4_4_ * fVar13;
            ...
            *(float*)( in_RSI + 8 ) = fVar10;
            fVar17 = (float)local_48._0_4_ * fVar7 + afStack_54[2] * fVar12 + (float)local_48._4_4_ * fVar11;
            ...
            *(float*)( in_RSI + 0x14 ) = local_a4;
            ...
            fVar11 = afStack_54[2] * local_7c + local_78 * (float)local_48._0_4_ + local_70 * (float)local_48._4_4_;
            fVar12 = local_74 * (float)local_48._0_4_ + afStack_54[2] * local_80 + local_90 * (float)local_48._4_4_;
            fVar15 = (float)local_48._4_4_ * local_88 + (float)local_48._0_4_ * local_94 + local_a0 * afStack_54[2];
            ...
            if (( local_8c <= __LC12 ) || ( iVar5 = iVar5 == 0 )) break;
            fVar8 = fVar10 * fVar10;
            fVar6 = fVar17 * fVar17;
            fVar7 = local_a4 * local_a4;
            local_94 = fVar15;
...
/* Basis::inverse() const */void Basis::inverse(void) {
   undefined8 uVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   undefined8 uVar4;
...
/* Basis::transpose() */void Basis::transpose(Basis *this) {
   undefined4 uVar1;
   uVar1 = *(undefined4*)( this + 4 );
   *(ulong*)( this + 4 ) = CONCAT44((int)( ( ulong ) * (undefined8*)( this + 0x14 ) >> 0x20 ), (int)*(undefined8*)( this + 0xc ));
...
/* Basis::transposed() const */void Basis::transposed(void) {
   undefined4 uVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   undefined8 uVar4;
   ...
   *(ulong*)( (long)in_RDI + 4 ) = CONCAT44((int)( ( ulong ) * (undefined8*)( (long)in_RDI + 0x14 ) >> 0x20 ), (int)*(undefined8*)( (long)in_RDI + 0xc ));
...
/* Basis::from_scale(Vector3 const&) */Basis * __thiscall Basis::from_scale(Basis *this,Vector3 *param_1){
   undefined4 uVar1;
   undefined4 uVar2;
   undefined4 uVar3;
...
/* Basis::scale(Vector3 const&) */void Basis::scale(Basis *this, Vector3 *param_1) {
...
/* Basis::scaled(Vector3 const&) const */Vector3 *Basis::scaled(Vector3 *param_1) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Basis::get_uniform_scale() const */float Basis::get_uniform_scale(Basis *this) {
   return ( SQRT(*(float*)( this + 0x10 ) * *(float*)( this + 0x10 ) + *(float*)( this + 0xc ) * *(float*)( this + 0xc ) + *(float*)( this + 0x14 ) * *(float*)( this + 0x14 )) + SQRT(*(float*)this * *(float*)this + *(float*)( this + 4 ) * *(float*)( this + 4 ) + *(float*)( this + 8 ) * *(float*)( this + 8 )) + SQRT(*(float*)( this + 0x18 ) * *(float*)( this + 0x18 ) + *(float*)( this + 0x1c ) * *(float*)( this + 0x1c ) + *(float*)( this + 0x20 ) * *(float*)( this + 0x20 )) ) / __LC15;
}
/* Basis::scaled_local(Vector3 const&) const */Vector3 *Basis::scaled_local(Vector3 *param_1) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
...
/* Basis::scale_local(Vector3 const&) */void Basis::scale_local(Vector3 *param_1) {
   long in_FS_OFFSET;
   undefined8 local_48;
...
/* Basis::scaled_orthogonal(Vector3 const&) const */Vector3 *Basis::scaled_orthogonal(Vector3 *param_1) {
   Vector3 *pVVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   Basis *pBVar4;
   ...
   *(float*)( param_1 + 0x20 ) = local_18;
   ...
   local_60 = CONCAT44(fStack_28 * fVar14 + (float)( (ulong)local_38 >> 0x20 ) * auVar20._12_4_ + (float)( (ulong)uStack_20 >> 0x20 ) * auVar20._4_4_, fStack_2c * fVar10 + (float)local_38 * auVar20._8_4_ + (float)uStack_20 * auVar20._0_4_);
   do {
      ...
      do {
         ...
         pBVar5 = pBVar4 + 4;
         *pfVar6 = (float)( ( uint )(fVar12 * *(float*)pBVar4 + fVar13 * *(float*)( pBVar4 + 0xc ) + fVar15 * *(float*)( pBVar4 + 0x18 )) & _LC16 ) * fVar10 + *pfVar6;
         pBVar4 = pBVar5;
         pfVar6 = pfVar6 + 1;
      }
 while ( pBVar5 != pBVar7 );
...
/* Basis::scale_orthogonal(Vector3 const&) */void Basis::scale_orthogonal(Vector3 *param_1) {
   long in_FS_OFFSET;
   undefined8 local_48;
   undefined8 uStack_40;
   undefined8 local_38;
...
/* Basis::get_scale_abs() const */undefined1  [16] __thiscallBasis::get_scale_abs(Basis *this) {
   float fVar1;
   long in_FS_OFFSET;
   float fVar2;
   float fVar3;
   ...
   auVar10._8_4_ = SQRT(*(float*)( this + 0x20 ) * *(float*)( this + 0x20 ) + *(float*)( this + 8 ) * *(float*)( this + 8 ) + *(float*)( this + 0x14 ) * *(float*)( this + 0x14 ));
...
/* Basis::get_scale_global() const */void Basis::get_scale_global(Basis *this) {
   float fVar1;
   long in_FS_OFFSET;
   ...
   auVar2._0_4_ = *(float*)( this + 4 ) * *(float*)( this + 4 ) + (float)*(undefined8*)this * (float)*(undefined8*)this + fVar3 * fVar3;
...
/* Basis::get_scale() const */void Basis::get_scale(Basis *this) {
   long lVar1;
   long in_FS_OFFSET;
   float fVar2;
   float fVar3;
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
   fVar2 = ( ( *(float*)( this + 0x10 ) * *(float*)( this + 0x20 ) - *(float*)( this + 0x1c ) * *(float*)( this + 0x14 ) ) * *(float*)this - ( *(float*)( this + 0x20 ) * *(float*)( this + 4 ) - *(float*)( this + 0x1c ) * *(float*)( this + 8 ) ) * *(float*)( this + 0xc ) ) + ( *(float*)( this + 0x14 ) * *(float*)( this + 4 ) - *(float*)( this + 0x10 ) * *(float*)( this + 8 ) ) * *(float*)( this + 0x18 );
   fVar3 = _LC4;
   if (fVar2 <= 0.0) {
...
/* Basis::orthogonalize() */void Basis::orthogonalize(Basis *this) {
   long in_FS_OFFSET;
   undefined8 local_58;
...
/* Basis::orthogonalized() const */void Basis::orthogonalized(void) {
   undefined4 uVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   undefined8 uVar4;
...
/* Basis::rotref_posscale_decomposition(Basis&) const */undefined1  [16] __thiscallBasis::rotref_posscale_decomposition(Basis *this, Basis *param_1) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   fVar2 = *(float*)( this + 0x14 );
   fVar3 = *(float*)( this + 8 );
   if (( ( *(float*)( this + 0x10 ) * fVar1 - fVar18 * fVar2 ) * *(float*)this - ( *(float*)( this + 4 ) * fVar1 - fVar18 * fVar16 ) * *(float*)( this + 0xc ) ) + ( *(float*)( this + 4 ) * fVar2 - *(float*)( this + 0x10 ) * fVar16 ) * fVar9 == 0.0) {
      uVar13 = 0x14c;
      ...
      if (cVar11 == '\0') {
         ...
         *(float*)( param_1 + 0x20 ) = fVar9 * fStack_30 + (float)local_28._4_4_ * fVar18 + fVar1 * local_18;
         *(float*)param_1 = (float)local_38._0_4_ * fVar4 + fStack_2c * fVar5 + fStack_20 * fVar3;
         *(float*)( param_1 + 4 ) = (float)local_38._4_4_ * fVar4 + (float)local_28._0_4_ * fVar5 + fStack_1c * fVar3;
         *(float*)( param_1 + 8 ) = fStack_30 * fVar4 + (float)local_28._4_4_ * fVar5 + local_18 * fVar3;
         *(float*)( param_1 + 0xc ) = (float)local_38._0_4_ * fVar6 + fStack_2c * fVar7 + fStack_20 * fVar2;
         *(float*)( param_1 + 0x10 ) = (float)local_28._0_4_ * fVar7 + fVar6 * (float)local_38._4_4_ + fStack_1c * fVar2;
         *(float*)( param_1 + 0x14 ) = (float)local_28._4_4_ * fVar7 + fVar6 * fStack_30 + local_18 * fVar2;
         *(float*)( param_1 + 0x18 ) = fStack_2c * fVar10 + fVar9 * (float)local_38._0_4_ + fStack_20 * fVar1;
         *(float*)( param_1 + 0x1c ) = (float)local_28._0_4_ * fVar10 + fVar9 * (float)local_38._4_4_ + fStack_1c * fVar1;
   ...
   local_78 = 0;
   local_70 = 0.0;
   LAB_001022dd:auVar19._8_4_ = local_70;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Basis::get_euler(EulerOrder) const */undefined1  [16] __thiscallBasis::get_euler(Basis *this, undefined4 param_2) {
   float __y;
   long lVar1;
   long in_FS_OFFSET;
   float fVar2;
...
/* Basis::get_euler_normalized(EulerOrder) const */void Basis::get_euler_normalized(undefined8 *param_1) {
   Basis *this;
   long in_FS_OFFSET;
   ...
   this(Basis * ) & local_38;
   orthonormalize(this);
   if (( ( (float)local_28 * local_18 - uStack_20._4_4_ * local_28._4_4_ ) * (float)local_38 - ( local_18 * local_38._4_4_ - uStack_20._4_4_ * (float)uStack_30 ) * uStack_30._4_4_ ) + ( local_28._4_4_ * local_38._4_4_ - (float)local_28 * (float)uStack_30 ) * (float)uStack_20 < 0.0) {
      local_40 = 0xbf800000;
      local_48 = _LC19;
...
/* Basis::set_euler(Vector3 const&, EulerOrder) */ulong Basis::set_euler(Basis *this, float *param_1, uint param_3) {
   ulong uVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   if (param_3 < 6) {
      uVar1 = (long)&switchD_00102c75::switchdataD_001068dc + (long)(int)( &switchD_00102c75::switchdataD_001068dc )[param_3];
      switch (param_3) {
         case 0:
      fVar14 = local_30 * 0.0;
      fVar17 = local_2c * 0.0;
   ...
   _err_print_error("set_euler", "core/math/basis.cpp", 0x2b5, "Method/function failed.", "Invalid Euler order parameter.", 0);
   return 0;
}
/* Basis::rotated(Vector3 const&, EulerOrder) const */float *Basis::rotated(float *param_1, float *param_2, undefined8 param_3, undefined4 param_4) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
...
/* Basis::rotate(Vector3 const&, EulerOrder) */void Basis::rotate(Basis *this, undefined8 param_1, undefined4 param_3) {
   long in_FS_OFFSET;
   undefined8 local_48;
   undefined8 uStack_40;
   undefined8 local_38;
...
/* Basis::is_equal_approx(Basis const&) const */undefined8 Basis::is_equal_approx(Basis *param_1) {
   char cVar1;
   undefined8 uVar2;
...
/* Basis::is_finite() const */undefined8 Basis::is_finite(void) {
   char cVar1;
   undefined8 uVar2;
...
/* Basis::TEMPNAMEPLACEHOLDERVALUE(Basis const&) const */undefined8 Basis::operator ==(Basis *this, Basis *param_1) {
   long lVar1;
   lVar1 = 0;
   while (( ( *(float*)( param_1 + lVar1 ) == *(float*)( this + lVar1 ) && ( *(float*)( this + lVar1 + 4 ) == *(float*)( param_1 + lVar1 + 4 ) ) ) && ( *(float*)( this + lVar1 + 8 ) == *(float*)( param_1 + lVar1 + 8 ) ) )) {
      lVar1 = lVar1 + 0xc;
      if (lVar1 == 0x24) {
         return 1;
      }
...
/* Basis::TEMPNAMEPLACEHOLDERVALUE(Basis const&) const */undefined8 Basis::operator !=(Basis *this, Basis *param_1) {
   long lVar1;
   lVar1 = 0;
   while (( ( *(float*)( this + lVar1 ) == *(float*)( param_1 + lVar1 ) && ( *(float*)( this + lVar1 + 4 ) == *(float*)( param_1 + lVar1 + 4 ) ) ) && ( *(float*)( this + lVar1 + 8 ) == *(float*)( param_1 + lVar1 + 8 ) ) )) {
      lVar1 = lVar1 + 0xc;
      if (lVar1 == 0x24) {
         return 0;
      }
...
/* Basis::operator String() const */Basis * __thiscall Basis::operator_cast_to_String(Basis *this){
   long *plVar1;
   long lVar2;
   char *pcVar3;
   undefined8 *in_RSI;
   ...
   local_60 = CONCAT44((int)( ( ulong ) * (undefined8*)( (long)in_RSI + 0xc ) >> 0x20 ), (int)*(undefined8*)( (long)in_RSI + 4 ));
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Basis::get_quaternion() const */void Basis::get_quaternion(void) {
   long *plVar1;
   int iVar2;
   undefined8 uVar3;
   float fVar4;
   ...
   if (cVar9 == '\0') {
      local_80 = 0;
      local_78 = " must be normalized in order to be casted to a Quaternion. Use get_rotation_quaternion() or call orthonormalized() if the Basis contains linearly independent vectors.";
      ...
      _err_print_error("get_quaternion", "core/math/basis.cpp", 0x2da, "Condition \"!is_rotation()\" is true. Returning: Quaternion()", (String*)&local_78, 0, 0);
      pcVar5 = local_78;
      ...
      *in_RDI = __LC44;
      ...
      if (0.0 < fVar14) {
         ...
         fVar13 = ( *(float*)( (long)&local_58 + ( lVar10 * 3 + lVar11 ) * 4 ) - *(float*)( (long)&local_58 + ( lVar11 * 3 + lVar10 ) * 4 ) ) * fVar14;
         local_70[lVar11 + 2] = ( *(float*)( (long)&local_58 + ( lVar11 * 3 + lVar12 ) * 4 ) + *(float*)( (long)&local_58 + ( lVar12 * 3 + lVar11 ) * 4 ) ) * fVar14;
         local_70[lVar10 + 2] = ( *(float*)( (long)&local_58 + ( lVar10 * 3 + lVar12 ) * 4 ) + *(float*)( (long)&local_58 + ( lVar12 * 3 + lVar10 ) * 4 ) ) * fVar14;
      }
...
/* Basis::get_rotation_quaternion() const */void Basis::get_rotation_quaternion(void) {
   undefined8 *in_RSI;
   Basis *this;
   long in_FS_OFFSET;
   undefined8 local_48;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Basis::get_axis_angle(Vector3&, float&) const */void Basis::get_axis_angle(Basis *this, Vector3 *param_1, float *param_2) {
   undefined8 uVar1;
   char cVar2;
   Vector3 *pVVar3;
   float fVar4;
   ...
   if (( ( _LC5 <= ABS(fVar7 - fVar6) ) || ( _LC5 <= ABS(fVar9) ) ) || ( _LC5 <= ABS(fVar13 - fVar11) )) {
      ...
      *(ulong*)param_1 = CONCAT44((float)auVar8._8_8_, (float)auVar8._0_8_);
      ...
      if (( fVar4 <= fVar6 ) && ( fVar7 = fVar6 <= _LC4 )) {
         fVar7 = acosf(fVar6);
         *param_2 = fVar7;
         return;
      }
      ...
      uVar1 = _LC50;
      if (( cVar2 == '\0' ) || ( _LC48 <= (double)ABS(( *(float*)this + *(float*)( this + 0x10 ) + *(float*)( this + 0x20 ) ) - __LC15) )) {
...
/* Basis::get_rotation_axis_angle(Vector3&, float&) const */void Basis::get_rotation_axis_angle(Vector3 *param_1, float *param_2) {
   Basis *this;
   long in_FS_OFFSET;
...
/* Basis::get_rotation_axis_angle_local(Vector3&, float&) const */void Basis::get_rotation_axis_angle_local(Basis *this, Vector3 *param_1, float *param_2) {
   float fVar1;
   float fVar2;
   float fVar3;
   Vector3 *pVVar4;
   ...
   if (( ( fStack_28 * local_18 - fStack_1c * fStack_24 ) * local_38 - ( local_18 * fStack_34 - fStack_1c * fStack_30 ) * fStack_2c ) + ( fStack_24 * fStack_34 - fStack_28 * fStack_30 ) * fStack_20 < 0.0) {
      local_40 = 0xbf800000;
      local_48 = _LC19;
...
/* Basis::set_quaternion(Quaternion const&) */void Basis::set_quaternion(Basis *this, Quaternion *param_1) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
...
/* Basis::rotated(Quaternion const&) const */Quaternion *Basis::rotated(Quaternion *param_1) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
...
/* Basis::rotate(Quaternion const&) */void Basis::rotate(Quaternion *param_1) {
   long in_FS_OFFSET;
   undefined8 local_48;
   undefined8 uStack_40;
   undefined8 local_38;
...
/* Basis::set_axis_angle(Vector3 const&, float) */void Basis::set_axis_angle(Basis *this, Vector3 *param_1, float param_2) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long in_FS_OFFSET;
   ...
   if (( fVar4 == _LC4 ) || ( ABS(fVar4 - _LC4) < _LC6 )) {
      ...
      *(float*)( this + 0x14 ) = fVar6 - local_6c[0] * fVar4;
      ...
      operator+((char *)&
      local_58,"The axis Vector3 ";
      String::operator +((String*)&local_48, (String*)&local_58);
      _err_print_error("set_axis_angle", "core/math/basis.cpp", 0x359, "Condition \"!p_axis.is_normalized()\" is true.", (String*)&local_48, 0, 0);
      pcVar3 = local_48;
...
/* Basis::rotate_to_align(Vector3, Vector3) */void Basis::rotate_to_align(undefined8 param_1, float param_2, undefined8 param_3, float param_4, float *param_5) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   if (fVar8 != 0.0) {
      ...
      if (auVar7._0_4_ * auVar7._0_4_ + auVar7._4_4_ * auVar7._4_4_ + local_40 * local_40 != 0.0) {
         ...
         fVar6 = (float)_LC19;
         if (( (float)_LC19 <= fVar5 ) && ( fVar6 = fVar5 <= _LC4 )) {
            fVar6 = fVar5;
         }
         ...
         *param_5 = fVar3 * (float)local_38._4_4_ + fVar9 * (float)local_38._0_4_ + fStack_30 * fVar8;
         ...
         param_5[2] = param_5[5] * (float)local_38._4_4_ + fVar2 * (float)local_38._0_4_ + fStack_30 * fVar6;
         ...
         param_5[5] = fVar6 * (float)local_28._4_4_ + fVar2 * fStack_2c + param_5[5] * (float)local_28._0_4_;
...
/* Basis::rotated(Vector3 const&, float) const */Vector3 *Basis::rotated(Vector3 *param_1, float param_2) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   *(float*)param_1 = fVar7 * (float)local_48._4_4_ + fVar4 * (float)local_48._0_4_ + fStack_40 * fVar2;
   *(float*)( param_1 + 4 ) = fVar8 * (float)local_48._4_4_ + fVar5 * (float)local_48._0_4_ + fStack_40 * fVar3;
   *(float*)( param_1 + 8 ) = fVar9 * (float)local_48._4_4_ + fVar6 * (float)local_48._0_4_ + fStack_40 * fVar1;
   *(float*)( param_1 + 0xc ) = fVar7 * (float)local_38._0_4_ + fVar4 * fStack_3c + (float)local_38._4_4_ * fVar2;
   *(float*)( param_1 + 0x10 ) = fVar8 * (float)local_38._0_4_ + fVar5 * fStack_3c + fVar3 * (float)local_38._4_4_;
   *(float*)( param_1 + 0x14 ) = fVar9 * (float)local_38._0_4_ + fVar6 * fStack_3c + fVar1 * (float)local_38._4_4_;
...
/* Basis::rotate(Vector3 const&, float) */void Basis::rotate(Vector3 *param_1, float param_2) {
   long in_FS_OFFSET;
   undefined8 local_48;
   undefined8 uStack_40;
   undefined8 local_38;
...
/* Basis::rotated_local(Vector3 const&, float) const */Vector3 *Basis::rotated_local(Vector3 *param_1, float param_2) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   fVar2 = in_RSI[5];
   fVar3 = in_RSI[2];
   *(float*)( param_1 + 0x20 ) = fStack_40 * in_RSI[6] + (float)local_38._4_4_ * in_RSI[7] + local_28 * fVar1;
   *(float*)param_1 = fVar3 * fStack_30 + (float)local_48._0_4_ * fVar4 + fStack_3c * fVar5;
   *(float*)( param_1 + 4 ) = fVar3 * fStack_2c + (float)local_48._4_4_ * fVar4 + (float)local_38._0_4_ * fVar5;
   ...
   *(float*)( param_1 + 0x10 ) = (float)local_38._0_4_ * fVar7 + fVar6 * (float)local_48._4_4_ + fStack_2c * fVar2;
   ...
   *(float*)( param_1 + 0x1c ) = (float)local_38._0_4_ * fVar9 + fVar8 * (float)local_48._4_4_ + fStack_2c * fVar1;
   if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* Basis::rotate_local(Vector3 const&, float) */void Basis::rotate_local(Vector3 *param_1, float param_2) {
   long in_FS_OFFSET;
   undefined8 local_48;
   undefined8 uStack_40;
   undefined8 local_38;
...
/* Basis::set_axis_angle_scale(Vector3 const&, float, Vector3 const&) */void Basis::set_axis_angle_scale(Basis *this, Vector3 *param_1, float param_2, Vector3 *param_3) {
   undefined4 uVar1;
   long in_FS_OFFSET;
   undefined8 local_48;
   undefined8 uStack_40;
...
/* Basis::set_euler_scale(Vector3 const&, Vector3 const&, EulerOrder) */void Basis::set_euler_scale(undefined8 *param_1, undefined8 param_2, undefined4 *param_3) {
   undefined4 uVar1;
   long in_FS_OFFSET;
   undefined8 local_48;
   undefined8 uStack_40;
...
/* Basis::set_quaternion_scale(Quaternion const&, Vector3 const&) */void Basis::set_quaternion_scale(Basis *this, Quaternion *param_1, Vector3 *param_2) {
   undefined4 uVar1;
   long in_FS_OFFSET;
   undefined8 local_48;
   undefined8 uStack_40;
...
/* Basis::_set_diagonal(Vector3 const&) */void Basis::_set_diagonal(Basis *this, Vector3 *param_1) {
   undefined4 uVar1;
...
/* Basis::lerp(Basis const&, float) const */Basis *Basis::lerp(Basis *param_1, float param_2) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
...
/* Basis::slerp(Basis const&, float) const */Basis *Basis::slerp(Basis *param_1, float param_2) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   *(float*)param_1 = ( ( auVar20._0_4_ - auVar22._0_4_ ) * param_2 + auVar22._0_4_ ) * *(float*)param_1;
   *(float*)( param_1 + 4 ) = ( ( auVar20._4_4_ - auVar22._4_4_ ) * param_2 + auVar22._4_4_ ) * *(float*)( param_1 + 4 );
   *(float*)( param_1 + 8 ) = ( ( auVar20._8_4_ - auVar22._8_4_ ) * param_2 + auVar22._8_4_ ) * *(float*)( param_1 + 8 );
   *(float*)( param_1 + 0xc ) = ( ( auVar20._12_4_ - auVar22._12_4_ ) * param_2 + auVar22._12_4_ ) * *(float*)( param_1 + 0xc );
   *(float*)( param_1 + 0x10 ) = *(float*)( param_1 + 0x10 ) * ( ( auVar16._0_4_ - auVar19._0_4_ ) * param_2 + auVar19._0_4_ );
   *(float*)( param_1 + 0x14 ) = *(float*)( param_1 + 0x14 ) * ( ( auVar16._4_4_ - auVar19._4_4_ ) * param_2 + auVar19._4_4_ );
   *(float*)( param_1 + 0x18 ) = *(float*)( param_1 + 0x18 ) * fVar17;
   *(float*)( param_1 + 0x1c ) = *(float*)( param_1 + 0x1c ) * ( ( auVar16._12_4_ - auVar19._12_4_ ) * param_2 + auVar19._12_4_ );
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Basis::rotate_sh(float*) */void Basis::rotate_sh(Basis *this, float *param_1) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   fVar16 = (float)( ( uint )(fVar24 * fVar22 + fVar19 * fVar28 + fVar21 * fVar32 + fVar4 * fVar29 + fVar5 * fVar30) ^ _LC14 );
   fVar20 = _LC59 * ( ( fVar24 * fVar24 - __LC58 ) * fVar13 + fVar26 * fVar18 + fVar23 * fVar8 + fVar25 * fVar17 + fVar31 * fVar33 );
   fVar12 = ( ( ( fVar6 + fVar7 ) * fVar22 - fVar15 * fVar13 * fVar15 ) + ( fVar30 * fVar7 - fVar3 * fVar17 * fVar3 ) + ( fVar29 * fVar12 - fVar2 * fVar33 * fVar2 ) + ( ( fVar12 + fVar6 ) * fVar32 - fVar27 * fVar1 * fVar27 ) + ( ( fVar12 + fVar7 ) * fVar28 - fVar14 * fVar18 * fVar14 ) ) * __LC60;
   param_1[5] = (float)( ( uint )(fVar24 * fVar13 * fVar15 + fVar21 * fVar1 * fVar27 + fVar5 * fVar3 * fVar17 + fVar4 * fVar2 * fVar33 + fVar19 * fVar18 * fVar14) ^ _LC14 );
   param_1[6] = fVar20;
   param_1[7] = fVar16;
   param_1[8] = fVar12;
   return;
}
/* Basis::looking_at(Vector3 const&, Vector3 const&, bool) */Basis * __thiscall Basis::looking_at(Basis *this,Vector3 *param_1,Vector3 *param_2,bool param_3){
   float fVar1;
   ulong uVar2;
   long lVar3;
   float fVar4;
   ...
   if (cVar5 == '\0') {
      ...
      if (cVar5 == '\0') {
         ...
         fVar15 = (float)( ( ulong ) * (undefined8*)( param_2 + 4 ) >> 0x20 ) * fVar11 - *(float*)param_2 * (float)( (ulong)uVar18 >> 0x20 );
         cVar5 = Vector3::is_zero_approx();
         if (cVar5 == '\0') {
            LAB_00105ff3:fVar14 = fVar13 * fVar13 + fVar15 * fVar15 + fVar21 * fVar21;
            ...
            _err_print_error("looking_at", "core/math/basis.cpp", 0x422, "Target and up vectors are colinear. This is not advised as it may cause unwanted rotation around local Z axis.", 0, 1);
            cVar5 = Vector3::is_zero_approx();
            if (cVar5 == '\0') {
   ...
   *(undefined1(*) [16])( this + 0x10 ) = auVar10;
   LAB_00106093:if (lVar3 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return this;
   }

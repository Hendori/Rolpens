...
/* TriangleMesh::_initialize_classv() */void TriangleMesh::_initialize_classv(void) {
 ...
 while ( ( uVar13 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = uVar13 * uVar4,auVar11._8_8_ = 0,auVar11._0_8_ = uVar17,auVar8._8_8_ = 0,auVar8._0_8_ = ( ( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 ) + uVar14 ) - SUB164(auVar7 * auVar11, 8) ) * uVar4,auVar12._8_8_ = 0,auVar12._0_8_ = uVar17,uVar18 <= SUB164(auVar8 * auVar12, 8) );
   ...
   undefined1 * __thiscallHashMap<Vector3,int,HashMapHasherDefault,HashMapComparatorDefault<Vector3>,DefaultTypedAllocator<HashMapElement<Vector3,int>>>::operator [](HashMap<Vector3,int,HashMapHasherDefault,HashMapComparatorDefault<Vector3>,DefaultTypedAllocator<HashMapElement<Vector3,int>>> * this, Vector3 * param_1);
   {
      uint *puVar1;
      undefined8 *puVar2;
      float fVar3;
...
;
   ...
   undefined8 CowData<Face3>::_realloc(CowData<Face3> *this, long param_1) {
      undefined8 *puVar1;
      puVar1 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), param_1 + 0x10, false);
      if (puVar1 != (undefined8*)0x0) {
         *puVar1 = 1;
   ...
   undefined8 CowData<TriangleMesh::Triangle>::_realloc(CowData<TriangleMesh::Triangle> *this, long param_1) {
      undefined8 *puVar1;
      puVar1 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), param_1 + 0x10, false);
      if (puVar1 != (undefined8*)0x0) {
         *puVar1 = 1;
   ...
   undefined8 CowData<TriangleMesh::BVH>::_realloc(CowData<TriangleMesh::BVH> *this, long param_1) {
      undefined8 *puVar1;
      puVar1 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), param_1 + 0x10, false);
      if (puVar1 != (undefined8*)0x0) {
         *puVar1 = 1;
   ...
   void TriangleMesh::~TriangleMesh(TriangleMesh *this) {

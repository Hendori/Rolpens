...
/* FramebufferCacheRD::~FramebufferCacheRD() */void FramebufferCacheRD::~FramebufferCacheRD(FramebufferCacheRD *this) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long lVar4;
   ...
   *(undefined***)this = &PTR__initialize_classv_001046f0;
   if (*(int*)( this + 0x201c8 ) != 0) {
      ...
      itos((long)&local_48);
      operator+((char *)&
      local_58,(String*)"At exit: ";
      String::operator +((String*)&local_60, (String*)&local_58);
      _err_print_error("~FramebufferCacheRD", "servers/rendering/renderer_rd/framebuffer_cache_rd.cpp", 0x55, (String*)&local_60, 0, 0);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
...
/* FramebufferCacheRD::_bind_methods() */void FramebufferCacheRD::_bind_methods(void) {
   long lVar1;
   code *pcVar2;
   long *plVar3;
   MethodBind *this;
...
/* FramebufferCacheRD::_invalidate(FramebufferCacheRD::Cache*) */void FramebufferCacheRD::_invalidate(FramebufferCacheRD *this, Cache *param_1) {
   long *plVar1;
   uint uVar2;
   long lVar3;
   void *pvVar4;
   long lVar5;
   if (*(long*)param_1 == 0) {
      *(undefined8*)( this + ( ulong )(*(uint*)( param_1 + 0x10 ) % 0x3ffd) * 8 + 0x1e0 ) = *(undefined8*)( param_1 + 8 );
   }
 else {
   ...
   if (pvVar4 != (void*)0x0) {
      if (*(int*)( param_1 + 0x30 ) != 0) {
         ...
         do {
            for (int i = 0; i < 4; i++) {
               lVar3 = *(long*)( (long)pvVar4 + lVar5 * 72 + ( -16*i + 56 ) );
               if (lVar3 != 0) {
                  LOCK();
                  plVar1 = (long*)( lVar3 + -16 );
                  *plVar1 = *plVar1 + -1;
                  UNLOCK();
                  if (*plVar1 == 0) {
                     lVar3 = *(long*)( (long)pvVar4 + lVar5 * 72 + ( -16*i + 56 ) );
                     *(undefined8*)( (long)pvVar4 + lVar5 * 72 + ( -16*i + 56 ) ) = 0;
 ...
 while ( (uint)lVar5 < *(uint*)( param_1 + 0x30 ) );
   ...
   LAB_0010092e:if (*(void**)( param_1 + 0x28 ) != (void*)0x0) {
   ...
   *(Cache**)( *(long*)( *(long*)( this + 0x180 ) + ( ulong )(uVar2 >> ( ( byte ) * (undefined4*)( this + 400 ) & 0x1f )) * 8 ) + ( ulong )(uVar2 & *(uint*)( this + 0x194 )) * 8 ) = param_1;
   *(int*)( this + 0x201c8 ) = *(int*)( this + 0x201c8 ) + -1;
   *(uint*)( this + 0x18c ) = uVar2 + 1;
   return;
}
/* FramebufferCacheRD::_framebuffer_invalidation_callback(void*) */void FramebufferCacheRD::_framebuffer_invalidation_callback(void *param_1) {
   _invalidate(singleton, (Cache*)param_1);
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* FramebufferCacheRD::FramebufferCacheRD() */void FramebufferCacheRD::FramebufferCacheRD(FramebufferCacheRD *this) {
   undefined8 uVar1;
   undefined8 uVar2;
   bool bVar3;
   Object::Object((Object*)this);
   ...
   *(undefined4*)( this + 0x201c8 ) = 0;
   ...
   _err_print_error("FramebufferCacheRD", "servers/rendering/renderer_rd/framebuffer_cache_rd.cpp", 0x4f, "Condition \"singleton != nullptr\" is true.", 0, 0);
   return;
}
/* CowData<RenderingDevice::FramebufferPass>::_copy_on_write() [clone .isra.0] */void CowData<RenderingDevice::FramebufferPass>::_copy_on_write(CowData<RenderingDevice::FramebufferPass> *this) {
   long lVar1;
   code *pcVar2;
   long lVar3;
   undefined8 *puVar4;
         ...
         *(undefined8*)this_00 = 0;
         ...
         for (int i = 0; i < 3; i++) {
            *(undefined8*)( this_00 + ( 16*i + 16 ) ) = 0;
            if (*(long*)( this_00 + lVar3 + ( 16*i + 24 ) ) != 0) {
               CowData<int>::_ref(this_00 + ( 16*i + 16 ), (CowData*)( this_00 + lVar3 + ( 16*i + 24 ) ));
            }
...
/* FramebufferCacheRD::get_cache_multipass_array(TypedArray<RID> const&,
   TypedArray<RDFramebufferPass> const&, unsigned int) */undefined8 FramebufferCacheRD::get_cache_multipass_array(TypedArray *param_1, TypedArray *param_2, uint param_3) {
   long *plVar1;
   char cVar2;
   int iVar3;
   Variant *this;
...
;
   ...
   do {
      ...
      if (iVar3 <= iVar7) {
         ...
         CowData<RenderingDevice::FramebufferPass>::_unref((CowData<RenderingDevice::FramebufferPass>*)local_90);
         lVar4 = local_a0;
         if (local_a0 != 0) {
            LOCK();
      ...
      if (lVar4 != 0) {
         ...
         if (pOVar5 != (Object*)0x0) {
            ...
            if (cVar2 != '\0') {
               ...
               local_48 = uVar6;
               iVar3 = CowData<RenderingDevice::FramebufferPass>::resize<false>((CowData<RenderingDevice::FramebufferPass>*)local_90, lVar8);
               if (iVar3 == 0) {
                  if (local_90[0] == 0) {
                     lVar9 = -1;
                     lVar8 = 0;
                     ...
                     lVar9 = lVar8 + -1;
                     if (-1 < lVar9) {
                        CowData<RenderingDevice::FramebufferPass>::_copy_on_write((CowData<RenderingDevice::FramebufferPass>*)local_90);
...
/* FramebufferCacheRD::is_class_ptr(void*) const */uint FramebufferCacheRD::is_class_ptr(FramebufferCacheRD *this, void *param_1) {
   return (uint)CONCAT71(0x1048, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1048, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr);
}
/* FramebufferCacheRD::_getv(StringName const&, Variant&) const */undefined8 FramebufferCacheRD::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* FramebufferCacheRD::_setv(StringName const&, Variant const&) */undefined8 FramebufferCacheRD::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* FramebufferCacheRD::_validate_propertyv(PropertyInfo&) const */void FramebufferCacheRD::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* FramebufferCacheRD::_property_can_revertv(StringName const&) const */undefined8 FramebufferCacheRD::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* FramebufferCacheRD::_property_get_revertv(StringName const&, Variant&) const */undefined8 FramebufferCacheRD::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* FramebufferCacheRD::_notificationv(int, bool) */void FramebufferCacheRD::_notificationv(int param_1, bool param_2) {
   return;
}
/* MethodBindTRS<RID, TypedArray<RID> const&, TypedArray<RDFramebufferPass> const&, unsigned
   int>::_gen_argument_type(int) const */int MethodBindTRS<RID,TypedArray<RID>const&,TypedArray<RDFramebufferPass>const&,unsigned_int>::_gen_argument_type(MethodBindTRS<RID,TypedArray<RID>const&,TypedArray<RDFramebufferPass>const&,unsigned_int> *this, int param_1) {
   if ((uint)param_1 < 3) {
      if (param_1 != 2) {
         param_1 = 0x1c;
      }
...
/* MethodBindTRS<RID, TypedArray<RID> const&, TypedArray<RDFramebufferPass> const&, unsigned
   int>::get_argument_meta(int) const */undefined8 MethodBindTRS<RID,TypedArray<RID>const&,TypedArray<RDFramebufferPass>const&,unsigned_int>::get_argument_meta(MethodBindTRS<RID,TypedArray<RID>const&,TypedArray<RDFramebufferPass>const&,unsigned_int> *this, int param_1) {
   undefined8 uVar1;
   uVar1 = 0;
   if (param_1 == 2) {
      uVar1 = 7;
...
/* MethodBindTRS<RID, TypedArray<RID> const&, TypedArray<RDFramebufferPass> const&, unsigned
   int>::~MethodBindTRS() */void MethodBindTRS<RID,TypedArray<RID>const&,TypedArray<RDFramebufferPass>const&,unsigned_int>::~MethodBindTRS(MethodBindTRS<RID,TypedArray<RID>const&,TypedArray<RDFramebufferPass>const&,unsigned_int> *this) {
   *(undefined***)this = &PTR__gen_argument_type_00104850;
...
/* FramebufferCacheRD::_bind_methods() [clone .cold] */void FramebufferCacheRD::_bind_methods(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* CowData<RenderingDevice::FramebufferPass>::_copy_on_write() [clone .isra.0] [clone .cold] */void CowData<RenderingDevice::FramebufferPass>::_copy_on_write(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* FramebufferCacheRD::_get_class_namev() const */undefined8 *FramebufferCacheRD::_get_class_namev(void) {
   int iVar1;
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00101493:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00101493;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "FramebufferCacheRD");
         goto LAB_001014fe;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "FramebufferCacheRD");
   LAB_001014fe:return &_get_class_namev();
}
/* FramebufferCacheRD::get_class() const */void FramebufferCacheRD::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* FramebufferCacheRD::is_class(String const&) const */undefined8 FramebufferCacheRD::is_class(FramebufferCacheRD *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long lVar4;
 ...
 while ( !bVar9 );
      ...
      LAB_0010168f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
 ...
 while ( !bVar9 );
         ...
         LAB_001017f3:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
      ...
      LAB_00101743:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* MethodBindTRS<RID, TypedArray<RID> const&, TypedArray<RDFramebufferPass> const&, unsigned
   int>::ptrcall(Object*, void const**, void*) const */void MethodBindTRS<RID,TypedArray<RID>const&,TypedArray<RDFramebufferPass>const&,unsigned_int>::ptrcall(MethodBindTRS<RID,TypedArray<RID>const&,TypedArray<RDFramebufferPass>const&,unsigned_int> *this, Object *param_1, void **param_2, void *param_3) {
   long *plVar1;
   undefined4 uVar2;
   code *pcVar3;
   long lVar4;
...
/* MethodBindTRS<RID, TypedArray<RID> const&, TypedArray<RDFramebufferPass> const&, unsigned
   int>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTRS<RID,TypedArray<RID>const&,TypedArray<RDFramebufferPass>const&,unsigned_int>::validated_call(MethodBindTRS<RID,TypedArray<RID>const&,TypedArray<RDFramebufferPass>const&,unsigned_int> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   long *plVar1;
   undefined4 uVar2;
   code *pcVar3;
   long lVar4;
...
/* MethodBindTRS<RID, TypedArray<RID> const&, TypedArray<RDFramebufferPass> const&, unsigned
   int>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindTRS<RID,TypedArray<RID>const&,TypedArray<RDFramebufferPass>const&,unsigned_int>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   long *plVar1;
   Variant *pVVar2;
   Variant *pVVar3;
   code *pcVar4;
      ...
      if ((int)( 3 - in_R8D ) <= iVar10) {
         ...
         do {
            if ((int)lVar9 < (int)in_R8D) {
               ...
               if (lVar12 <= (int)uVar7) {
                  _err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, (long)(int)uVar7, lVar12, "p_index", "size()", "", false, true);
                  _err_flush_stdout();
                  /* WARNING: Does not return */
 ...
 while ( lVar9 != 3 );
   ...
   *in_R9 = uVar8;
   in_R9[2] = 3;
   LAB_0010209f:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* FramebufferCacheRD::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void FramebufferCacheRD::_get_property_listv(List *param_1, bool param_2) {
   long *plVar1;
   long lVar2;
   long lVar3;
...
/* FramebufferCacheRD::_initialize_classv() */void FramebufferCacheRD::_initialize_classv(void) {
   long *plVar1;
   long lVar2;
   long in_FS_OFFSET;
   long local_50;
    ...
    */
   void LocalVector<RenderingDevice::FramebufferPass,unsigned_int,false,false>::resize(LocalVector<RenderingDevice::FramebufferPass,unsigned_int,false,false> *this, uint param_1) {
      long *plVar1;
      code *pcVar2;
      undefined8 uVar3;
      long lVar4;
      ...
      if (param_1 < uVar8) {
         ...
         do {
            ...
            for (int i = 0; i < 4; i++) {
               if (*(long*)( lVar6 + ( -16*i + 56 ) ) != 0) {
                  LOCK();
                  plVar1 = (long*)( *(long*)( lVar6 + ( -16*i + 56 ) ) + -16 );
                  *plVar1 = *plVar1 + -1;
                  UNLOCK();
                  if (*plVar1 == 0) {
                     lVar4 = *(long*)( lVar6 + ( -16*i + 56 ) );
                     *(undefined8*)( lVar6 + ( -16*i + 56 ) ) = 0;
 ...
 while ( lVar4 != lVar7 + 0x48 + ( ( ulong )(uVar5 - uVar8) + (ulong)uVar8 ) * 0x48 );
      ...
      LAB_001029e9:*(uint*)this = param_1;
      return;
   }
   ...
   long FramebufferCacheRD::_allocate_from_data(FramebufferCacheRD *this, uint param_1, uint param_2, uint param_3, Vector *param_4, Vector *param_5) {
      ...
      if (lVar10 == 0) {
         ...
         if (iVar8 == 0) {
            ...
            *(undefined8*)( this + 0x178 ) = uVar13;
            uVar13 = Memory::realloc_static(*(void**)( this + 0x180 ), ( ulong ) * (uint*)( this + 0x188 ) << 3, false);
 ...
 while ( plVar4 + uVar6 != plVar16 );
         ...
         *(uint*)( this + 0x18c ) = uVar6;
         pauVar1 = *(undefined1(**) [16])( plVar17[uVar6 >> ( ( byte ) * (undefined4*)( this + 400 ) & 0x1f )] + ( ulong )(uVar6 & *(uint*)( this + 0x194 )) * 8 );
            ...
            if (uVar6 != 0) {
               ...
               *(uint*)pauVar1[2] = uVar6;
               if (lVar20 == 0) {
                  uVar12 = 0;
                  lVar14 = 0;
                  LAB_00102e15:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar12, lVar14, "p_index", "size()", "", false, true);
                  _err_flush_stdout();
                  /* WARNING: Does not return */
                  pcVar5 = (code*)invalidInstructionException();
                  ( *pcVar5 )();
 ...
 while ( ( uVar2 & 0xffffffff ) != uVar12 );
         ...
         uVar12 = 0;
         LocalVector<RenderingDevice::FramebufferPass,unsigned_int,false,false>::resize((LocalVector<RenderingDevice::FramebufferPass,unsigned_int,false,false>*)( pauVar1 + 3 ), uVar6);
         if (*(int*)pauVar1[3] != 0) {
            do {
 ...
 while ( (uint)uVar12 < *(uint*)pauVar1[3] );
         ...
         *(undefined1(**) [16])( this + (ulong)param_3 * 8 + 0x1e0 ) = pauVar1;
         ...
         RenderingDevice::framebuffer_set_invalidation_callback(uVar13, lVar10, _framebuffer_invalidation_callback, pauVar1);
         *(int*)( this + 0x201c8 ) = *(int*)( this + 0x201c8 ) + 1;
      }
   ...
   undefined8 FramebufferCacheRD::get_cache_multipass(FramebufferCacheRD *this, Vector *param_1, Vector *param_2, uint param_3) {
      undefined8 *puVar1;
      int *piVar2;
      uint uVar3;
      uint uVar4;
         ...
         if (0 < lVar23) {
            ...
            do {
               ...
               if (piVar24 == (int*)0x0) {
                  ...
                  LAB_001034aa:piVar24 = (int*)puVar21[6];
                  uVar10 = ( uVar10 << 0xd | uVar10 >> 0x13 ) * 5 + 0xe6546b64;
                  if (piVar24 != (int*)0x0) goto LAB_001032c5;
                  LAB_001034c1:uVar10 = ( uVar10 << 0xd | uVar10 >> 0x13 ) * 5 + 0xe6546b64;
               }
 else {
 ...
 while ( piVar2 != piVar24 );
                  ...
                  LAB_0010325d:lVar7 = *(long*)( piVar24 + -2 );
 ...
 while ( piVar2 != piVar24 );
                  ...
                  LAB_001032c5:lVar7 = *(long*)( piVar24 + -2 );
                  uVar10 = uVar10 ^ ( (int)lVar7 * 0x16a88000 | ( uint )((int)lVar7 * -0x3361d2af) >> 0x11 ) * 0x1b873593;
                  uVar10 = ( uVar10 << 0xd | uVar10 >> 0x13 ) * 5 + 0xe6546b64;
                  if (0 < lVar7) {
                     piVar2 = piVar24 + lVar7;
      ...
      do {
         ...
         if (( *(uint*)( lVar7 + 0x10 ) == uVar10 ) && ( *(uint*)( lVar7 + 0x40 ) == param_3 )) {
            ...
            if (( uVar3 == (uint)uVar17 ) && ( uVar4 = uVar4 == local_50 )) {
               if ((long)uVar16 < 1) {
                  LAB_00103510:if (lVar23 < 1) {
                     LAB_00103707:return *(undefined8*)( lVar7 + 0x18 );
                  }

                  uVar3 = uVar4;
                  if (uVar4 == 0) {
                     uVar17 = 0;
                     LAB_0010344b:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xae, uVar17, (ulong)uVar3, "p_index", "count", "", false, true);
                     _err_flush_stdout();
                     /* WARNING: Does not return */
                  ...
                  while (( (int)plVar20[7] == (int)plVar18[7] && ( *(int*)( (long)plVar20 + 0x3c ) == *(int*)( (long)plVar18 + 0x3c ) ) )) {
                     ...
                     if (lVar8 == 0) {
                        ...
                        lVar15 = *(long*)( lVar8 + -8 );
                        if (lVar19 == 0) {
                           joined_r0x001036ef:if (lVar15 != 0) break;
                        }
 else {
                           ...
                           if (0 < lVar15) {
                              lVar14 = 0;
                              do {
                                 if (*(int*)( lVar8 + lVar14 * 4 ) != *(int*)( lVar19 + lVar14 * 4 )) goto LAB_001033a0;
                                 lVar14 = lVar14 + 1;
                              }
 while ( lVar15 != lVar14 );
                           }
                     ...
                     if (lVar8 == 0) {
                        ...
                        lVar15 = *(long*)( lVar8 + -8 );
                        if (lVar19 == 0) {
                           joined_r0x00103675:if (lVar15 != 0) break;
                        }
 else {
                           if (lVar15 != *(long*)( lVar19 + -8 )) break;
                           if (0 < lVar15) {
 ...
 while ( lVar15 != lVar14 );
                     ...
                     if (lVar8 == 0) {
                        ...
                        if (lVar19 == 0) {
                           ...
                           LAB_0010362a:if (*(long*)( lVar19 + -8 ) != lVar15) break;
                           if (0 < lVar15) {
                              lVar14 = 0;
                              do {
                                 if (*(int*)( lVar8 + lVar14 * 4 ) != *(int*)( lVar19 + lVar14 * 4 )) goto LAB_001033a0;
...
;
         ...
         LAB_001033a0:lVar7 = *(long*)( lVar7 + 8 );
      }
 while ( true );
   }
   ...
   undefined8 CowData<RID>::resize<false>(CowData<RID> *this, long param_1) {
      ...
      if (param_1 * 8 == 0) {
         LAB_00103a80:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
         return 6;
      }
      ...
      if (lVar7 == lVar3) {
         LAB_001039ec:puVar9 = *(undefined8**)this;
      ...
      LAB_00103981:puVar9[-1] = param_1;
      return 0;
   }

   /* CowData<RenderingDevice::FramebufferPass>::_unref() */
   void CowData<RenderingDevice::FramebufferPass>::_unref(CowData<RenderingDevice::FramebufferPass> *this) {
      long *plVar1;
      long lVar2;
      long lVar3;
      long lVar4;
 ...
 while ( lVar3 != lVar7 );
   ...
   undefined8 CowData<RenderingDevice::FramebufferPass>::_realloc(CowData<RenderingDevice::FramebufferPass> *this, long param_1) {
      undefined8 *puVar1;
      puVar1 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), param_1 + 0x10, false);
      if (puVar1 != (undefined8*)0x0) {
         *puVar1 = 1;
   ...
   undefined8 CowData<RenderingDevice::FramebufferPass>::resize<false>(CowData<RenderingDevice::FramebufferPass> *this, long param_1) {
      long *plVar1;
      long lVar2;
      code *pcVar3;
      undefined8 *puVar4;
      ...
      if (param_1 * 0x48 == 0) {
         LAB_00103fe0:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
         return 6;
      }
...
;
      ...
      if (lVar12 == lVar9) {
         LAB_00103f53:puVar8 = *(undefined8**)this;
         if (puVar8 == (undefined8*)0x0) {
            LAB_00104036:/* WARNING: Does not return */pcVar3 = (code*)invalidInstructionException();
            ( *pcVar3 )();
         }
 ...
 while ( puVar5 != puVar8 + param_1 * 9 );
      LAB_00103e1d:puVar8[-1] = param_1;
      return 0;
   }

   /* void call_get_argument_type_info<TypedArray<RID> const&, TypedArray<RDFramebufferPass> const&,
   unsigned int>(int, PropertyInfo&) */
   void call_get_argument_type_info<TypedArray<RID>const&,TypedArray<RDFramebufferPass>const&,unsigned_int>(int param_1, PropertyInfo *param_2) {
      long *plVar1;
      long lVar2;
      ...
      if (param_1 == 0) {
         ...
         LAB_00104199:local_58 = (char*)CONCAT44(local_58._4_4_, 0x1c);
         local_40 = 0x1f;
         if (local_70 != 0) goto LAB_001040ff;
         LAB_001041c7:local_38 = 0;
         local_50 = (undefined1[16])0x0;
         LAB_001041cf:local_30 = 6;
      ...
      *(int*)( param_2 + 0x18 ) = local_40;
      ...
      LAB_00104075:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Subroutine does not return */
         __stack_chk_fail();
      }
   ...
   undefined4 *MethodBindTRS<RID,TypedArray<RID>const&,TypedArray<RDFramebufferPass>const&,unsigned_int>::_gen_argument_type_info(int param_1) {
      long *plVar1;
      ...
      if (in_EDX < 3) {
         ...
         call_get_argument_type_info<TypedArray<RID>const&,TypedArray<RDFramebufferPass>const&,unsigned_int>(in_EDX, (PropertyInfo*)&local_68);
      ...
      *(undefined1(*) [16])( puVar4 + 2 ) = (undefined1[16])0x0;
      if (local_78 == 0) {
         puVar4[10] = 6;
         LAB_00104577:StringName::operator =((StringName*)( puVar4 + 4 ), (StringName*)&local_70);
         lVar3 = local_78;
      }
 else {
      ...
      LAB_00104469:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return puVar4;
      }
   ...
   /* MethodBindTRS<RID, TypedArray<RID> const&, TypedArray<RDFramebufferPass> const&, unsigned
   int>::~MethodBindTRS() */
   void MethodBindTRS<RID,TypedArray<RID>const&,TypedArray<RDFramebufferPass>const&,unsigned_int>::~MethodBindTRS(MethodBindTRS<RID,TypedArray<RID>const&,TypedArray<RDFramebufferPass>const&,unsigned_int> *this) {

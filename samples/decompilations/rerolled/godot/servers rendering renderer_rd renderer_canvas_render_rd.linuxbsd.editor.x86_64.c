/* RendererCanvasRenderRD::CanvasShaderData::casts_shadows() const */undefined8 RendererCanvasRenderRD::CanvasShaderData::casts_shadows(void) {
   return 0;
}
/* RendererCanvasRenderRD::update() */void RendererCanvasRenderRD::update(void) {
   return;
}
/* RendererCanvasRenderRD::set_debug_redraw(bool, double, Color const&) */void RendererCanvasRenderRD::set_debug_redraw(RendererCanvasRenderRD *this, bool param_1, double param_2, Color *param_3) {
   undefined8 uVar1;
   undefined8 uVar2;
...
/* RendererCanvasRenderRD::light_set_use_shadow(RID, bool) */void RendererCanvasRenderRD::light_set_use_shadow(RendererCanvasRenderRD *this, ulong param_2, undefined1 param_3) {
   long lVar1;
   int iVar2;
   if (( param_2 != 0 ) && ( (uint)param_2 < *(uint*)( this + 0x76c ) )) {
      lVar1 = *(long*)( *(long*)( this + 0x758 ) + ( ( param_2 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x768 ) ) * 8 ) + ( ( param_2 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x768 ) ) * 0x38;
   ...
   _err_print_error("light_set_use_shadow", "servers/rendering/renderer_rd/renderer_canvas_render_rd.cpp", 0x3b5, "Parameter \"cl\" is null.", 0, 0);
   return;
}
/* RendererCanvasRenderRD::occluder_polygon_set_cull_mode(RID,
   RenderingServer::CanvasOccluderPolygonCullMode) */void RendererCanvasRenderRD::occluder_polygon_set_cull_mode(RendererCanvasRenderRD *this, ulong param_2, undefined4 param_3) {
   int iVar1;
   undefined4 *puVar2;
   if (( param_2 != 0 ) && ( (uint)param_2 < *(uint*)( this + 0x7c4 ) )) {
      puVar2 = (undefined4*)( ( ( param_2 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x7c0 ) ) * 0x60 + *(long*)( *(long*)( this + 0x7b0 ) + ( ( param_2 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x7c0 ) ) * 8 ) );
      iVar1 = puVar2[0x16];
   ...
   _err_print_error("occluder_polygon_set_cull_mode", "servers/rendering/renderer_rd/renderer_canvas_render_rd.cpp", 0x5bd, "Parameter \"oc\" is null.", 0, 0);
   return;
}
/* RendererCanvasRenderRD::light_set_texture(RID, RID) */void RendererCanvasRenderRD::light_set_texture(RendererCanvasRenderRD *this, ulong param_2, ulong param_3) {
   ...
   if (( param_2 != 0 ) && ( (uint)param_2 < *(uint*)( this + 0x76c ) )) {
      puVar1 = (ulong*)( *(long*)( *(long*)( this + 0x758 ) + ( ( param_2 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x768 ) ) * 8 ) + ( ( param_2 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x768 ) ) * 0x38 );
      if ((int)puVar1[6] == (int)( param_2 >> 0x20 )) {
         ...
         if (( ( (uint)param_3 < *(uint*)( (long)plVar5 + 0x124 ) ) && ( param_3 >> 0x20 != 0x7fffffff ) ) && ( ( *(uint*)( ( ( param_3 & 0xffffffff ) % ( ulong ) * (uint*)( plVar5 + 0x24 ) ) * 0x118 + *(long*)( plVar5[0x22] + ( ( param_3 & 0xffffffff ) / ( ulong ) * (uint*)( plVar5 + 0x24 ) ) * 8 ) + 0x110 ) & 0x7fffffff ) == ( uint )(param_3 >> 0x20) )) {
         ...
         pthread_mutex_unlock(__mutex);
         uVar7 = 0x3a7;
         pcVar6 = "Condition \"p_texture.is_valid() && !texture_storage->owns_texture(p_texture)\" is true.";
         goto LAB_001002a2;
      }
   ...
   LAB_001002a2:_err_print_error("light_set_texture", "servers/rendering/renderer_rd/renderer_canvas_render_rd.cpp", uVar7, pcVar6, 0, 0);
   return;
}
/* RendererCanvasRenderRD::CanvasMaterialData::~CanvasMaterialData() */void RendererCanvasRenderRD::CanvasMaterialData::~CanvasMaterialData(CanvasMaterialData *this) {
   *(undefined***)this = &PTR_set_render_priority_00124318;
   RendererRD::MaterialStorage::MaterialData::free_parameters_uniform_set(this, *(undefined8*)( this + 0xb0 ));
   RendererRD::MaterialStorage::MaterialData::free_parameters_uniform_set(this, *(undefined8*)( this + 0xb8 ));
...
/* LocalVector<RendererCanvasRenderRD::Batch, unsigned int, false, false>::resize(unsigned int)
   [clone .part.0] */void LocalVector<RendererCanvasRenderRD::Batch,unsigned_int,false,false>::resize(uint param_1) {
   code *pcVar1;
...
/* RendererCanvasRenderRD::get_pipeline_compilations(RenderingServer::PipelineSource) */undefined4 RendererCanvasRenderRD::get_pipeline_compilations(RendererCanvasRenderRD *this, int param_2) {
   pthread_mutex_t *__mutex;
   undefined4 uVar1;
   int iVar2;
...
/* RendererCanvasRenderRD::CanvasShaderData::get_native_source_code() const */void RendererCanvasRenderRD::CanvasShaderData::get_native_source_code(void) {
   pthread_mutex_t *__mutex;
   long lVar1;
   int iVar2;
   long in_FS_OFFSET;
...
/* RendererCanvasRenderRD::CanvasShaderData::is_valid() const [clone .part.0] */undefined4 RendererCanvasRenderRD::CanvasShaderData::is_valid(CanvasShaderData *this) {
   pthread_mutex_t *__mutex;
   long lVar1;
   int iVar2;
   undefined4 uVar3;
...
/* RendererCanvasRenderRD::CanvasShaderData::get_shader(RendererCanvasRenderRD::ShaderVariant, bool)
   const [clone .part.0] */undefined8 RendererCanvasRenderRD::CanvasShaderData::get_shader(CanvasShaderData *this, int param_2, char param_3) {
   Version *pVVar1;
   pthread_mutex_t *__mutex;
   ulong uVar2;
   long lVar3;
   ...
   if (param_2 < 0) {
      ...
      lVar8 = *(long*)( lVar8 + -8 );
      LAB_0010074d:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, uVar10, lVar8, "p_variant", "variant_defines.size()", "", false, false);
   }
 else {
      if (lVar8 == 0) {
         LAB_001008c0:lVar8 = 0;
         goto LAB_0010074d;
      }
      ...
      if (( uVar2 == 0 ) || ( *(uint*)( lVar3 + 0xec ) <= (uint)uVar2 )) {
         LAB_001007d0:uVar7 = 0;
         _err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
         goto LAB_00100726;
      }

      lVar8 = ( ( uVar2 & 0xffffffff ) % ( ulong ) * (uint*)( lVar3 + 0xe8 ) ) * 0xa0 + *(long*)( *(long*)( lVar3 + 0xd8 ) + ( ( uVar2 & 0xffffffff ) / ( ulong ) * (uint*)( lVar3 + 0xe8 ) ) * 8 );
 ...
 while ( lVar9 != 0 );
      ...
      if (lVar3 == 0) {
         LAB_00100860:lVar9 = 0;
         uVar6 = uVar10;
         LAB_00100881:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar6, lVar9, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
   ...
   uVar7 = 0;
   LAB_00100726:pthread_mutex_unlock(__mutex);
   return uVar7;
}
/* RendererCanvasRenderRD::CanvasMaterialData::update_parameters(HashMap<StringName, Variant,
   ...
   DefaultTypedAllocator<HashMapElement<StringName, Variant> > > const&, bool, bool) */uint RendererCanvasRenderRD::CanvasMaterialData::update_parameters(CanvasMaterialData *this, HashMap *param_1, bool param_2, bool param_3) {
   Version *pVVar1;
   pthread_mutex_t *__mutex;
   char cVar2;
   char *pcVar3;
   ...
   if (*(long*)( lVar5 + 0x30 ) == 0) {
      lVar13 = 0;
      LAB_00100ba3:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 0, lVar13, "p_variant", "variant_defines.size()", "", false, false);
   }
 else {
      ...
      if (pcVar3 == (char*)0x0) {
         LAB_00100c50:lVar13 = 0;
         LAB_00100c53:uVar11 = 0;
         LAB_00100c70:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar11, lVar13, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
      ...
      if (*pcVar3 == '\0') {
         ...
         if (( uVar11 != 0 ) && ( (uint)uVar11 < *(uint*)( lVar5 + 0xec ) )) {
            lVar12 = ( ( uVar11 & 0xffffffff ) % ( ulong ) * (uint*)( lVar5 + 0xe8 ) ) * 0xa0 + *(long*)( *(long*)( lVar5 + 0xd8 ) + ( ( uVar11 & 0xffffffff ) / ( ulong ) * (uint*)( lVar5 + 0xe8 ) ) * 8 );
 ...
 while ( lVar13 != 0 );
   ...
   LAB_00100be0:uVar15 = 0;
   LAB_00100a82:lVar5 = *(long*)( this + 0xa8 );
   uVar9 = RendererRD::MaterialStorage::MaterialData::update_parameters_uniform_set(this, param_1, param_2, param_3, lVar5 + 0x10, *(undefined8*)( lVar5 + 0x90 ), lVar5 + 0x70, lVar5 + 0x40, *(undefined4*)( lVar5 + 0x98 ), this + 0xb0, uVar15, 1, 1, 0);
   lVar5 = *(long*)( this + 0xa8 );
   uVar10 = RendererRD::MaterialStorage::MaterialData::update_parameters_uniform_set(this, param_1, param_2, param_3, lVar5 + 0x10, *(undefined8*)( lVar5 + 0x90 ), lVar5 + 0x70, lVar5 + 0x40, *(undefined4*)( lVar5 + 0x98 ), this + 0xb8, uVar15, 1, 0, 0);
   pthread_mutex_unlock(__mutex);
   return uVar9 | uVar10;
}
/* HashMap<unsigned int, long, HashMapHasherDefault, HashMapComparatorDefault<unsigned int>,
   ...
   .isra.0] */void HashMap<unsigned_int,long,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,long>>>::erase(HashMap<unsigned_int,long,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,long>>> *this, uint *param_1) {
   uint *puVar1;
   undefined8 *puVar2;
   undefined8 *puVar3;
   long *plVar4;
...
/* RendererCanvasRenderRD::free_polygon(unsigned long) */ulong RendererCanvasRenderRD::free_polygon(RendererCanvasRenderRD *this, ulong param_1) {
   uint *puVar1;
   undefined8 *puVar2;
   undefined8 *puVar3;
   long *plVar4;
   ...
   if (( lVar5 != 0 ) && ( *(int*)( this + 0x724 ) != 0 )) {
      ...
      if (uVar42 != 0) {
         uVar45 = 0;
         do {
            if (( (uint)uVar41 == uVar42 ) && ( *(ulong*)( *(long*)( lVar5 + lVar39 * 8 ) + 0x10 ) == param_1 )) {
               ...
               while (true) {
                  ...
                  if (( (uint)uVar41 == uVar37 ) && ( uVar35 = *(ulong*)( lVar5 + uVar36 * 8 ) * (ulong*)( uVar35 + 0x10 ) == param_1 )) break;
...
;
               ...
               uVar37 = *puVar46;
               if (( uVar37 != 0 ) && ( auVar15._8_8_ = 0 ),auVar15._0_8_ = (ulong)uVar37 * lVar39,auVar28._8_8_ = 0,auVar28._0_8_ = uVar44,auVar16._8_8_ = 0,auVar16._0_8_ = ( ulong )(( uVar38 + uVar42 ) - SUB164(auVar15 * auVar28, 8)) * lVar39,auVar29._8_8_ = 0,auVar29._0_8_ = uVar44,uVar41 = (ulong)uVar38,uVar36 = uVar33,SUB164(auVar16 * auVar29, 8) != 0) {
                  while (true) {
                     uVar33 = uVar41;
                     ...
                     *puVar3 = uVar34;
                     ...
                     puVar46 = (uint*)( lVar6 + uVar40 * 4 );
                     uVar37 = *puVar46;
                     if (( uVar37 == 0 ) || ( auVar17._8_8_ = 0 ),auVar17._0_8_ = (ulong)uVar37 * lVar39,auVar30._8_8_ = 0,auVar30._0_8_ = uVar44,auVar18._8_8_ = 0,auVar18._0_8_ = ( ulong )(( SUB164(auVar19 * auVar32, 8) + uVar42 ) - SUB164(auVar17 * auVar30, 8)) * lVar39,auVar31._8_8_ = 0,auVar31._0_8_ = uVar44,SUB164(auVar18 * auVar31, 8) == 0) break;
...
;
               ...
               *(long*)( this + 0x718 ) = plVar43[1];
               plVar43 = (long*)*plVar4;
               LAB_001012a2:if ((long*)plVar43[1] != (long*)0x0) {
 ...
 while ( ( uVar42 != 0 ) && ( auVar9._8_8_ = 0 ),auVar9._0_8_ = (ulong)uVar42 * lVar6,auVar22._8_8_ = 0,auVar22._0_8_ = uVar44,auVar10._8_8_ = 0,auVar10._0_8_ = ( ulong )(( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x720 ) * 4 ) + uVar37 ) - SUB164(auVar9 * auVar22, 8)) * lVar6,auVar23._8_8_ = 0,auVar23._0_8_ = uVar44,uVar45 <= SUB164(auVar10 * auVar23, 8) );
      }

   }

   uVar33 = _err_print_error("free_polygon", "servers/rendering/renderer_rd/renderer_canvas_render_rd.cpp", 0x14f, "Parameter \"pb_ptr\" is null.", 0, 0);
   return uVar33;
}
/* RendererCanvasRenderRD::free(RID) */undefined8 RendererCanvasRenderRD::free(RendererCanvasRenderRD *this, ulong param_2) {
   long *plVar1;
   uint uVar2;
   uint uVar3;
   undefined8 uVar4;
   ...
   if (uVar6 < *(uint*)( this + 0x76c )) {
      if (param_2 >> 0x20 != 0x7fffffff) {
         uVar2 = *(uint*)( *(long*)( *(long*)( this + 0x758 ) + ( ( param_2 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x768 ) ) * 8 ) + ( ( param_2 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x768 ) ) * 0x38 + 0x30 );
         if (uVar3 == ( uVar2 & 0x7fffffff )) {
            if (param_2 != 0) {
               if (uVar3 == uVar2) {
                  ( **(code**)( *(long*)this + 0x28 ) )(this, param_2, 0);
                  if (*(uint*)( this + 0x76c ) <= uVar6) goto LAB_00101688;
                  lVar5 = *(long*)( *(long*)( this + 0x758 ) + ( ( param_2 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x768 ) ) * 8 ) + ( ( param_2 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x768 ) ) * 0x38;
                  ...
                  *(uint*)( *(long*)( *(long*)( this + 0x760 ) + ( (ulong)uVar3 / ( ulong ) * (uint*)( this + 0x768 ) ) * 8 ) + ( (ulong)uVar3 % ( ulong ) * (uint*)( this + 0x768 ) ) * 4 ) = uVar6;
                  goto LAB_00101524;
               }
            ...
            _err_print_error(&_LC28, "servers/rendering/renderer_rd/renderer_canvas_render_rd.cpp", 0x81e, "Parameter \"cl\" is null.", 0, 0);
         }
      ...
      LAB_00101436:if (uVar3 == ( *(uint*)( ( ( param_2 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x7c0 ) ) * 0x60 + *(long*)( *(long*)( this + 0x7b0 ) + ( ( param_2 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x7c0 ) ) * 8 ) + 0x58 ) & 0x7fffffff )) {
         local_40 = 0;
         ...
         if (uVar6 < *(uint*)( this + 0x7c4 )) {
            lVar5 = ( ( param_2 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x7c0 ) ) * 0x60 + *(long*)( *(long*)( this + 0x7b0 ) + ( ( param_2 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x7c0 ) ) * 8 );
            uVar2 = *(uint*)( lVar5 + 0x58 );
            if ((int)uVar2 < 0) {
               LAB_001016b8:_err_print_error(&_LC28, "./core/templates/rid_owner.h", 0x16c, "Method/function failed.", "Attempted to free an uninitialized or invalid RID", 0, 0);
            }
 else if (uVar3 == uVar2) {
               *(undefined4*)( lVar5 + 0x58 ) = 0xffffffff;
               uVar3 = *(int*)( this + 0x7c8 ) - 1;
               *(uint*)( this + 0x7c8 ) = uVar3;
               *(uint*)( *(long*)( *(long*)( this + 0x7b8 ) + ( (ulong)uVar3 / ( ulong ) * (uint*)( this + 0x7c0 ) ) * 8 ) + ( (ulong)uVar3 % ( ulong ) * (uint*)( this + 0x7c0 ) ) * 4 ) = uVar6;
            }
 else {
               LAB_001016f0:_err_print_error(&_LC28, "./core/templates/rid_owner.h", 0x171, "Method/function failed.", 0, 0);
            }

         }
 else {
            LAB_00101688:_err_print_error(&_LC28, "./core/templates/rid_owner.h", 0x161, "Method/function failed.", 0, 0);
         }

         LAB_00101524:uVar4 = 1;
         goto LAB_0010146b;
      }
   ...
   uVar4 = 0;
   LAB_0010146b:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* RendererCanvasRenderRD::_canvas_texture_invalidation_callback(bool, void*) */ulong RendererCanvasRenderRD::_canvas_texture_invalidation_callback(bool param_1, void *param_2) {
   long lVar1;
   uint *puVar2;
   undefined8 *puVar3;
   undefined8 *puVar4;
 ...
 while ( lVar1 != lVar32 );
   ...
   if (( ( param_1 ) && ( lVar32 = *(long*)( RendererCanvasRender::singleton + 0xa08 ) ),lVar32 != 0 )) {
      ...
      uVar6 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( RendererCanvasRender::singleton + 0xa28 ) * 4 );
      uVar36 = CONCAT44(0, uVar6);
      lVar8 = *(long*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( RendererCanvasRender::singleton + 0xa28 ) * 8 );
      ...
      if (uVar38 != 0) {
         ...
         do {
            ...
            if (( uVar38 == (uint)uVar33 ) && ( uVar28 = *(ulong*)( lVar32 + uVar29 * 8 ) * param_2 == *(long*)( uVar28 + 0x10 ) )) {
               puVar39 = (uint*)( lVar7 + uVar31 * 4 );
               uVar38 = *puVar39;
               if (( uVar38 != 0 ) && ( auVar13._8_8_ = 0 ),auVar13._0_8_ = (ulong)uVar38 * lVar8,auVar22._8_8_ = 0,auVar22._0_8_ = uVar36,auVar14._8_8_ = 0,auVar14._0_8_ = ( ulong )(( uVar30 + uVar6 ) - SUB164(auVar13 * auVar22, 8)) * lVar8,auVar23._8_8_ = 0,auVar23._0_8_ = uVar36,uVar28 = (ulong)uVar30,uVar33 = uVar35,SUB164(auVar14 * auVar23, 8) != 0) {
                  while (true) {
                     uVar35 = uVar28;
                     ...
                     *puVar4 = uVar27;
                     ...
                     puVar39 = (uint*)( lVar7 + uVar31 * 4 );
                     uVar38 = *puVar39;
                     if (( uVar38 == 0 ) || ( auVar15._8_8_ = 0 ),auVar15._0_8_ = (ulong)uVar38 * lVar8,auVar24._8_8_ = 0,auVar24._0_8_ = uVar36,auVar16._8_8_ = 0,auVar16._0_8_ = ( ulong )(( SUB164(auVar17 * auVar26, 8) + uVar6 ) - SUB164(auVar15 * auVar24, 8)) * lVar8,auVar25._8_8_ = 0,auVar25._0_8_ = uVar36,SUB164(auVar16 * auVar25, 8) == 0) break;
...
;
 ...
 while ( ( uVar38 != 0 ) && ( auVar10._8_8_ = 0 ),auVar10._0_8_ = (ulong)uVar38 * lVar8,auVar19._8_8_ = 0,auVar19._0_8_ = uVar36,auVar11._8_8_ = 0,auVar11._0_8_ = ( ulong )(( uVar6 + uVar30 ) - SUB164(auVar10 * auVar19, 8)) * lVar8,auVar20._8_8_ = 0,auVar20._0_8_ = uVar36,uVar28 = SUB168(auVar11 * auVar20, 0),uVar29 = uVar31,uVar37 <= SUB164(auVar11 * auVar20, 8) );
      }
   ...
   if (param_1 <= lVar7) {
      ...
      if (uVar3 + 1 == lVar4) {
         ...
         if (puVar6 == (undefined8*)0x0) {
            LAB_00102520:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
            return;
         }
...
/* RendererCanvasRenderRD::CanvasShaderData::_clear_vertex_input_mask_cache() */void RendererCanvasRenderRD::CanvasShaderData::_clear_vertex_input_mask_cache(CanvasShaderData *this) {
...
/* RendererCanvasRenderRD::CanvasShaderData::get_shader(RendererCanvasRenderRD::ShaderVariant, bool)
   const */undefined8 RendererCanvasRenderRD::CanvasShaderData::get_shader(CanvasShaderData *this, undefined8 param_2, undefined1 param_3) {
   undefined8 uVar1;
   if (*(long*)( this + 0xa8 ) != 0) {
...
/* RendererCanvasRenderRD::CanvasShaderData::get_vertex_input_mask(RendererCanvasRenderRD::ShaderVariant,
   bool) */long RendererCanvasRenderRD::CanvasShaderData::get_vertex_input_mask(CanvasShaderData *this, undefined8 param_2, char param_3) {
   long lVar1;
   undefined8 uVar2;
   ...
   _err_print_error("get_vertex_input_mask", "servers/rendering/renderer_rd/renderer_canvas_render_rd.cpp", 0x66c, "Condition \"shader_rid.is_null()\" is true. Returning: 0", 0, 0);
   return 0;
}
/* RendererCanvasRenderRD::CanvasShaderData::is_valid() const */undefined8 RendererCanvasRenderRD::CanvasShaderData::is_valid(CanvasShaderData *this) {
   undefined8 uVar1;
   if (*(long*)( this + 0xa8 ) == 0) {
      return 0;
   }
...
/* RendererCanvasRenderRD::CanvasShaderData::CanvasShaderData() */void RendererCanvasRenderRD::CanvasShaderData::CanvasShaderData(CanvasShaderData *this) {
   undefined8 uVar1;
   long lVar2;
   long lVar3;
   ...
   *(undefined***)this = &PTR_set_path_hint_001242a8;
...
/* RendererCanvasRenderRD::_create_shader_func() */CanvasShaderData *RendererCanvasRenderRD::_create_shader_func(void) {
   CanvasShaderData *this;
   this(CanvasShaderData * operator_new(0x200, ""));
   CanvasShaderData::CanvasShaderData(this);
   return this;
}
/* RendererCanvasRenderRD::_create_material_func(RendererCanvasRenderRD::CanvasShaderData*) */void RendererCanvasRenderRD::_create_material_func(RendererCanvasRenderRD *this, CanvasShaderData *param_1) {
   undefined8 *puVar1;
   ...
   puVar1[0x10] = 0;
   puVar1[0x14] = 0;
   *puVar1 = &PTR_set_render_priority_00124318;
   puVar1[0x15] = param_1;
...
/* RendererCanvasRenderRD::set_time(double) */void RendererCanvasRenderRD::set_time(RendererCanvasRenderRD *this, double param_1) {
   *(double*)( this + 0xb40 ) = param_1;
   return;
}
/* RendererCanvasRenderRD::new_instance_data(float*, unsigned int*, unsigned int, unsigned int,
   unsigned int, RendererCanvasRenderRD::TextureInfo*) */void RendererCanvasRenderRD::new_instance_data(RendererCanvasRenderRD *this, float *param_1, uint *param_2, uint param_3, uint param_4, uint param_5, TextureInfo *param_6) {
   undefined8 uVar1;
   long lVar2;
   long lVar3;
   ...
   *(undefined8*)( lVar2 + 0x60 ) = 0;
   for (int i = 0; i < 4; i++) {
      *(undefined1(*) [16])( lVar2 + ( 16*i + 32 ) ) = (undefined1[16])0;
   }

   *(uint*)( lVar2 + 0x70 ) = *param_2;
   for (int i = 0; i < 3; i++) {
      *(uint*)( lVar2 + ( 4*i + 116 ) ) = param_2[( i + 1 )];
   }
...
/* RendererCanvasRenderRD::_before_evict(RendererCanvasRenderRD::RIDSetKey&, RID&) */void RendererCanvasRenderRD::_before_evict(RIDSetKey *param_1, RID *param_2) {
   undefined8 uVar1;
...
/* RendererCanvasRenderRD::_new_batch(bool&) */int *__thiscallRendererCanvasRenderRD::_new_batch(RendererCanvasRenderRD *this, bool *param_1) {
   ulong *puVar1;
   int *piVar2;
   uint uVar3;
   int iVar4;
   ...
   if (uVar3 == 0) {
      ...
      if (*(int*)( this + 0xa94 ) == 0) {
         ...
         *(int**)( this + 0xa98 ) = piVar18;
         if (piVar18 == (int*)0x0) {
            LAB_00102e25:_err_print_error("push_back", "./core/templates/local_vector.h", 0x41, "FATAL: Condition \"!data\" is true.", "Out of memory", 0, 0);
            _err_flush_stdout();
            /* WARNING: Does not return */
      ...
      *(undefined1(*) [16])( piVar2 + 0xe ) = (undefined1[16])0x0;
      LAB_00102b2a:if (lVar5 != *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Subroutine does not return */
         __stack_chk_fail();
      }
      ...
      if (uVar21 < uVar3) {
         ...
         if (iVar4 != 0) {
            *param_1 = true;
            ...
            uStack_f0 = CONCAT44((int)( ( ulong ) * (undefined8*)( piVar18 + 2 ) >> 0x20 ), *(undefined4*)( this + 0xaa4 ));
   ...
   LAB_00102d5b:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, uVar20, uVar22, "p_index", "count", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar6 = (code*)invalidInstructionException();
   ( *pcVar6 )();
}
/* RendererCanvasRenderRD::_allocate_instance_buffer() */void RendererCanvasRenderRD::_allocate_instance_buffer(RendererCanvasRenderRD *this) {
   long *plVar1;
   int iVar2;
   uint uVar3;
   uint uVar4;
   ...
   *(uint*)( this + 0xaa4 ) = iVar2 + 1U;
   if (*(uint*)( this + ( ulong ) * (uint*)( this + 0xaa0 ) * 0x10 + 0xa60 ) <= iVar2 + 1U) {
      ...
      local_30 = 0;
      uVar7 = RenderingDevice::storage_buffer_create(uVar7, *(undefined4*)( this + 0xabc ), auStack_38, 0, 0);
      lVar6 = local_30;
      if (local_30 != 0) {
         LOCK();
...
/* RendererCanvasRenderRD::_add_to_batch(unsigned int&, bool&, RendererCanvasRenderRD::Batch*&) */void RendererCanvasRenderRD::_add_to_batch(RendererCanvasRenderRD *this, uint *param_1, bool *param_2, Batch **param_3) {
   uint uVar1;
   code *pcVar2;
   undefined8 uVar3;
   Batch *pBVar4;
   ...
   *param_1 = uVar1 + 1;
   ...
   if (uVar1 < *(uint*)( this + ( ulong ) * (uint*)( this + 0xaa0 ) * 0x10 + 0xa60 )) {
      RenderingDevice::buffer_update(uVar3, *(undefined8*)( *(long*)( this + ( ulong ) * (uint*)( this + 0xaa0 ) * 0x10 + 0xa68 ) + (ulong)uVar1 * 8 ), *(int*)( this + 0xaac ) << 7, *param_1 << 7, *(undefined8*)( this + 0xab0 ));
   ...
   _err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, (ulong)uVar1, ( ulong ) * (uint*)( this + ( ulong ) * (uint*)( this + 0xaa0 ) * 0x10 + 0xa60 ), "p_index", "count", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar2 = (code*)invalidInstructionException();
   ( *pcVar2 )();
...
/* RendererCanvasRenderRD::_prepare_batch_texture_info(RID, RendererCanvasRenderRD::TextureState&,
   RendererCanvasRenderRD::TextureInfo*) */void RendererCanvasRenderRD::_prepare_batch_texture_info(RendererCanvasRenderRD *this, long param_2, undefined8 *param_3, undefined8 *param_4) {
   double dVar1;
   ulong uVar2;
   uint uVar3;
   undefined8 uVar4;
   ...
   while (true) {
      ...
      RendererRD::TextureStorage::canvas_texture_get_info(&local_78, uVar4, param_2, uVar3 & 7, uVar3 >> 3 & 3, uVar3 >> 6 & 1);
      dVar7 = _LC56;
      dVar1 = _LC55;
      if (local_78 != 0) break;
...
;
   ...
   *(undefined4*)( param_4 + 1 ) = *(undefined4*)( param_3 + 1 );
   ...
   if (dVar7 <= (double)local_44) {
      ...
      *(uint*)( (long)param_4 + 0x3c ) = uVar3 | 0x400;
      ...
      if (0.0 <= dVar9) {
         LAB_00103346:uVar5 = ( ulong )(uint)((int)dVar9 << 0x18);
      }
 else {
         uVar5 = 0;
      }
   ...
   *(uint*)( param_4 + 7 ) = uVar3;
   ...
   LAB_00103364:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RendererCanvasRenderRD::_record_item_commands(RendererCanvasRender::Item const*,
   RendererCanvasRenderRD::RenderTarget, Transform2D const&, RendererCanvasRender::Item*&,
   RendererCanvasRender::Light*, unsigned int&, bool&, bool&, RendererCanvasRenderRD::Batch*&) */void RendererCanvasRenderRD::_record_item_commands(RendererCanvasRenderRD *param_1, long param_2, undefined8 param_3, byte param_4, undefined1 (*param_5)[16], long *param_6, long param_7, uint *param_8, bool *param_9, byte *param_10, Batch **param_11) {
   undefined4 uVar1;
   undefined8 uVar2;
   uint uVar3;
   int iVar4;
   ...
   if (param_7 == 0) {
      local_1c8 = 0;
      LAB_001045e8:RVar26 = param_1[0x200b88];
   }
 else {
      uVar27 = 0;
      uVar31 = 0;
      do {
         if (( ( ( -1 < *(int*)( param_7 + 0x128 ) ) && ( ( *(uint*)( param_2 + 0x4c ) & *(uint*)( param_7 + 0x60 ) ) != 0 ) ) && ( *(int*)( param_7 + 0x50 ) <= *(int*)( param_2 + 0x50 ) ) ) && ( *(int*)( param_2 + 0x50 ) <= *(int*)( param_7 + 0x54 ) )) {
            if (( ( *(float*)( param_2 + 0x108 ) <= 0.0 && *(float*)( param_2 + 0x108 ) != 0.0 ) || ( *(float*)( param_2 + 0x10c ) <= 0.0 && *(float*)( param_2 + 0x10c ) != 0.0 ) ) || ( ( fVar46 = *(float*)( param_7 + 0xb8 ) ),fVar46 < 0.0 || ( *(float*)( param_7 + 0xbc ) <= 0.0 && *(float*)( param_7 + 0xbc ) != 0.0 ) )) {
            ...
            if (( *(float*)( param_2 + 0x100 ) < fVar46 + *(float*)( param_7 + 0xb0 ) ) && ( *(float*)( param_7 + 0xb0 ) < *(float*)( param_2 + 0x100 ) + *(float*)( param_2 + 0x108 ) )) {
               if (( *(float*)( param_2 + 0x104 ) < *(float*)( param_7 + 0xbc ) + *(float*)( param_7 + 0xb4 ) ) && ( *(float*)( param_7 + 0xb4 ) < *(float*)( param_2 + 0x104 ) + *(float*)( param_2 + 0x10c ) )) {
                  *(uint*)( local_138 + ( ulong )(uVar31 >> 2 & 0x3fff) * 4 ) = *(uint*)( local_138 + ( ulong )(uVar31 >> 2 & 0x3fff) * 4 ) | *(int*)( param_7 + 0x128 ) << ( sbyte )(( uVar31 & 3 ) << 3);
 ...
 while ( param_7 != 0 );
   ...
   LAB_00103504:if (*(RendererCanvasRenderRD*)( *param_11 + 0x54 ) != RVar26) {
...
;
         switchD_00103573_caseD_9:dVar34 = (double)( **(code**)( *RenderingServerGlobals::rasterizer + 0x98 ) )();
 ...
 while ( ( in_FPUStatusWord & 0x400 ) != 0 );
         if (NAN(dVar36)) {
            ...
            if (dVar36 < 0.0) {
               ...
               LAB_001047b2:dVar36 = dVar36 + dVar35;
            }
 ...
 while ( lVar18 != 0 );
      LAB_0010363a:RVar26 = param_1[0x200bc0];
   ...
   LAB_00103663:dVar36 = *(double*)( param_1 + 0x200bd8 );
   pBVar16 = *param_11;
   ...
   pTVar17 = (TextureInfo*)HashMap<RendererCanvasRenderRD::TextureState,RendererCanvasRenderRD::TextureInfo,HashableHasher<RendererCanvasRenderRD::TextureState>,HashMapComparatorDefault<RendererCanvasRenderRD::TextureState>,DefaultTypedAllocator<HashMapElement<RendererCanvasRenderRD::TextureState,RendererCanvasRenderRD::TextureInfo>>>::getptr((HashMap<RendererCanvasRenderRD::TextureState,RendererCanvasRenderRD::TextureInfo,HashableHasher<RendererCanvasRenderRD::TextureState>,HashMapComparatorDefault<RendererCanvasRenderRD::TextureState>,DefaultTypedAllocator<HashMapElement<RendererCanvasRenderRD::TextureState,RendererCanvasRenderRD::TextureInfo>>>*)( param_1 + 0xa30 ), (TextureState*)&local_158);
   if (pTVar17 == (TextureInfo*)0x0) {
      uStack_7c = 0;
      auStack_58 = SUB1612((undefined1[16])0x0, 4);
      local_4c = 0;
      ...
      auStack_68 = SUB1612((undefined1[16])0x0, 0);
      local_5c = 0;
      HashMap<RendererCanvasRenderRD::TextureState,RendererCanvasRenderRD::TextureInfo,HashableHasher<RendererCanvasRenderRD::TextureState>,HashMapComparatorDefault<RendererCanvasRenderRD::TextureState>,DefaultTypedAllocator<HashMapElement<RendererCanvasRenderRD::TextureState,RendererCanvasRenderRD::TextureInfo>>>::insert((TextureState*)&local_160, (TextureInfo*)( param_1 + 0xa30 ), SUB81((TextureState*)&local_158, 0));
      pTVar17 = (TextureInfo*)( local_160 + 0x20 );
      _prepare_batch_texture_info(param_1, *(undefined8*)( param_1 + 0x200b90 ), (TextureState*)&local_158, pTVar17);
   }
   ...
   local_d8 = local_f8;
   lVar18 = new_instance_data(param_1, (float*)local_e8, (uint*)local_138, local_1c8, *param_8, uVar3, pTVar17);
   uVar12 = __LC65;
   ...
   *param_9 = false;
   goto LAB_0010382d;
   switchD_00103573_caseD_0:if (*(int*)( *param_11 + 0x48 ) != 0) {
      pBVar16 = (Batch*)_new_batch(param_1, param_9);
      *param_11 = pBVar16;
      *(long*)( pBVar16 + 0x40 ) = lVar18;
      *(undefined8*)( pBVar16 + 0x48 ) = 0;
   ...
   pBVar16 = *param_11;
   uVar24 = uVar22 & 0x100;
   if (( pBVar16[0x5c] != ( Batch )(uVar24 != 0) ) || ( ( uVar24 != 0 && ( ( ( fVar33 != *(float*)( pBVar16 + 0x18 ) || ( fVar40 != *(float*)( pBVar16 + 0x1c ) ) ) || ( ( fVar48 != *(float*)( pBVar16 + 0x20 ) || ( extraout_XMM1_Db_01 != *(float*)( pBVar16 + 0x24 ) ) ) ) ) ) ) )) {
      pBVar16 = (Batch*)_new_batch(param_1, param_9);
      uVar2 = _LC74;
      *param_11 = pBVar16;
   ...
   if (pTVar17 == (TextureInfo*)0x0) {
      ...
      HashMap<RendererCanvasRenderRD::TextureState,RendererCanvasRenderRD::TextureInfo,HashableHasher<RendererCanvasRenderRD::TextureState>,HashMapComparatorDefault<RendererCanvasRenderRD::TextureState>,DefaultTypedAllocator<HashMapElement<RendererCanvasRenderRD::TextureState,RendererCanvasRenderRD::TextureInfo>>>::insert((TextureState*)&local_160, (TextureInfo*)( param_1 + 0xa30 ), SUB81((TextureState*)&local_158, 0));
      pTVar17 = (TextureInfo*)( local_160 + 0x20 );
      _prepare_batch_texture_info(param_1, *(undefined8*)( lVar18 + 0x50 ), (TextureState*)&local_158, pTVar17);
   }
   ...
   lVar20 = new_instance_data(param_1, (float*)local_e8, (uint*)local_138, local_1c8, *param_8, uVar3, pTVar17);
   fVar46 = (float)_LC51;
   fVar45 = (float)_LC51;
   ...
   *(undefined1(*) [16])( lVar20 + 0x20 ) = auVar11;
   LAB_001045c2:_add_to_batch(param_1, param_8, param_9, param_11);
   switchD_00103573_default:lVar18 = *(long*)( lVar18 + 8 );
   *param_9 = false;
   if (lVar18 == 0) goto code_r0x001039d2;
   goto LAB_00103550;
   code_r0x001039d2:RVar26 = param_1[0x200bc0];
   joined_r0x001039df:if (( RVar26 != (RendererCanvasRenderRD)0x0 ) && ( dVar35 = 0.0 < dVar35 )) goto LAB_00103663;
   LAB_0010382d:if (( *param_6 != 0 ) && ( local_1c1 != '\0' )) {
      *param_6 = 0;
   }

   LAB_00103846:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* RendererCanvasRenderRD::occluder_polygon_set_shape(RID, Vector<Vector2> const&, bool) */void RendererCanvasRenderRD::occluder_polygon_set_shape(RendererCanvasRenderRD *this, ulong param_2, Vector *param_3, byte param_4) {
   long *plVar1;
   undefined4 uVar2;
   void *__src;
   undefined4 uVar3;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (( param_2 != 0 ) && ( (uint)param_2 < *(uint*)( this + 0x7c4 ) )) {
      lVar21 = ( ( param_2 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x7c0 ) ) * 0x60 + *(long*)( *(long*)( this + 0x7b0 ) + ( ( param_2 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x7c0 ) ) * 8 );
      if (*(int*)( lVar21 + 0x58 ) == (int)( param_2 >> 0x20 )) {
         lVar19 = *(long*)( param_3 + 8 );
         if (( lVar19 == 0 ) || ( *(long*)( lVar19 + -8 ) == 0 )) {
            LAB_00106830:if (*(long*)( lVar21 + 0x10 ) != 0) {
            ...
            if ((long)uVar22 < 0) {
               ...
               if (uVar22 == 0) {
                  ...
                  joined_r0x0010688d:iVar18 = iVar13;
                  if (( param_4 == 0 ) && ( iVar18 = iVar13 + -1 == 0 )) goto LAB_00106537;
               }
               ...
               do {
                  uVar15 = uVar22 + 1;
                  uVar20 = *(ulong*)( lVar19 + (long)(int)( (long)( ( ulong )(uint)((int)uVar22 >> 0x1f) << 0x20 | uVar22 & 0xffffffff ) % (long)iVar13 ) * 8 );
 ...
 while ( (long)( iVar18 + 1 ) != uVar15 );
            ...
            LAB_00106537:if (local_b0 == (ulong*)0x0) goto LAB_00106830;
            uVar22 = local_b0[-1];
            if ((long)*(int*)( lVar21 + 4 ) == uVar22) {
               ...
               if (*(long*)( lVar21 + 0x10 ) != 0) {
                  LAB_0010699d:uVar9 = RenderingDevice::get_singleton();
                  RenderingDevice::free(uVar9, *(undefined8*)( lVar21 + 0x10 ));
                  uVar9 = RenderingDevice::get_singleton();
                  RenderingDevice::free(uVar9, *(undefined8*)( lVar21 + 8 ));
                  uVar9 = RenderingDevice::get_singleton();
               ...
               if (uVar22 != 0) {
                  LAB_00106a10:iVar18 = (int)uVar22;
                  *(int*)( lVar21 + 4 ) = iVar18;
                  local_80 = (undefined4*)0x0;
                  local_70 = (undefined8*)0x0;
                  CowData<unsigned_char>::resize<false>((CowData<unsigned_char>*)&local_80, (long)( iVar18 * 6 ) * 4);
                  CowData<unsigned_char>::resize<false>((CowData<unsigned_char>*)&local_70, (long)( iVar18 * 6 ));
 ...
 while ( iVar13<(int)( ( ( uint )(uVar22 >> 0x1f) & 1 ) + iVar18 )> > 1 );
                  ...
                  if (*(long*)( lVar21 + 0x10 ) == 0) {
                     ...
                     *(undefined8*)( lVar21 + 8 ) = uVar9;
                     ...
                     uVar9 = RenderingDevice::vertex_array_create(uVar7, ( ulong )(uint)(iVar18 * 2), *(Vector**)( this + 0x9a0 ), local_68);
                     puVar8 = local_50[0];
                     ...
                     *(undefined8*)( lVar21 + 0x18 ) = uVar9;
                     uVar9 = RenderingDevice::get_singleton();
                     uVar9 = RenderingDevice::index_array_create(uVar9, *(undefined8*)( lVar21 + 0x18 ), 0, iVar18 * 3);
                     lVar19 = local_60;
         ...
         if (lVar19 == 0) {
            if (*(int*)( lVar21 + 0x2c ) == 0) {
               ...
               puVar8 = (ulong*)0x0;
               LAB_00106e36:uVar9 = RenderingDevice::get_singleton();
            ...
            *(undefined4*)( lVar21 + 0x2c ) = 0;
            ...
            if (*(long*)( lVar19 + -8 ) == 0) {
               ...
               LAB_001065a6:if (*(long*)( lVar21 + 0x38 ) != 0) goto LAB_00106e36;
            }
 else {
               if (param_4 == 0) {
                  ...
                  if ((long)uVar22 < 0) {
                     _err_print_error("resize", "./core/templates/cowdata.h", 0x157, "Condition \"p_size < 0\" is true. Returning: ERR_INVALID_PARAMETER", 0, 0);
                     lVar19 = *(long*)( param_3 + 8 );
                     LAB_00106f80:*(undefined1*)( lVar21 + 0x50 ) = 1;
 ...
 while ( iVar13 < iVar18 );
                  ...
                  LAB_00106948:puVar8 = puVar17;
                  if (uVar22 == 0) {
                     LAB_00106dbc:if (lVar19 != 0) goto LAB_00106973;
                     goto LAB_001065a6;
                  }
                  ...
                  if (cVar5 == '\0') {
                     ...
                     LAB_00106937:*(undefined1*)( lVar21 + 0x50 ) = 0;
                     lVar19 = *(long*)( param_3 + 8 );
                     uVar22 = (ulong)iVar18;
                     puVar17 = (ulong*)0x0;
                     goto LAB_00106948;
                  ...
                  *(undefined1*)( lVar21 + 0x50 ) = 0;
                  lVar19 = *(long*)( param_3 + 8 );
                  LAB_00106daf:if (puVar8[-1] == uVar22) goto LAB_00106dbc;
               }

               if (( lVar19 == 0 ) || ( *(long*)( lVar19 + -8 ) != (long)*(int*)( lVar21 + 0x28 ) )) goto LAB_001065a6;
               LAB_00106973:if (*(long*)( lVar19 + -8 ) == 0) goto LAB_001065a6;
            }

            if (puVar8 != (ulong*)0x0) {
               uVar22 = puVar8[-1];
               LAB_001065bf:if (uVar22 != 0) {
                  if (*(long*)( lVar21 + 0x38 ) == 0) {
                     uVar9 = RenderingDevice::get_singleton();
                     local_50[0] = (ulong*)0x0;
                     if (*(long*)( param_3 + 8 ) == 0) {
                        LAB_00107005:iVar18 = 0;
                     }
 else {
                     ...
                     *(undefined8*)( lVar21 + 0x40 ) = uVar9;
                     ...
                     uVar9 = RenderingDevice::get_singleton();
                     uVar9 = RenderingDevice::index_array_create(uVar9, *(undefined8*)( lVar21 + 0x40 ), 0, (int)puVar8[-1]);
                     *(undefined8*)( lVar21 + 0x48 ) = uVar9;
                     ...
                     uVar9 = RenderingDevice::vertex_array_create(uVar7, uVar22, *(Vector**)( this + 0x9a8 ), local_68);
                     puVar10 = local_50[0];
                     *(undefined8*)( lVar21 + 0x38 ) = uVar9;
                     ...
                     uVar9 = RenderingDevice::get_singleton();
                     RenderingDevice::buffer_update(uVar9, *(undefined8*)( lVar21 + 0x40 ), 0, (int)puVar8[-1] * 4, puVar8);
                  }
         ...
         LAB_001067ca:if (local_b0 != (ulong*)0x0) {
            local_b0 = local_b0 + -2;
            LOCK();
            *local_b0 = *local_b0 - 1;
            UNLOCK();
   ...
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      _err_print_error("occluder_polygon_set_shape", "servers/rendering/renderer_rd/renderer_canvas_render_rd.cpp", 0x4fd, "Parameter \"oc\" is null.", 0, 0);
      return;
   }

   LAB_0010749f:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RendererCanvasRenderRD::request_polygon(Vector<int> const&, Vector<Vector2> const&, Vector<Color>
   const&, Vector<Vector2> const&, Vector<int> const&, Vector<float> const&) */ulong RendererCanvasRenderRD::request_polygon(RendererCanvasRenderRD *this, Vector *param_1, Vector *param_2, Vector *param_3, Vector *param_4, Vector *param_5, Vector *param_6) {
   long *plVar1;
   undefined2 *puVar2;
   undefined4 uVar3;
   undefined4 uVar4;
   ...
   if (*(long*)( param_2 + 8 ) == 0) {
      ...
      if (lVar15 == 0) {
         ...
         lVar15 = *(long*)( param_5 + 8 );
         if (lVar15 != 0) goto LAB_0010757e;
         LAB_001080f9:lVar15 = *(long*)( param_6 + 8 );
         if (lVar15 == 0) {
            iVar13 = 0;
         }
 else {
            LAB_0010810b:iVar11 = 0;
            LAB_00107c22:iVar13 = *(int*)( lVar15 + -8 );
            iVar28 = iVar11;
            LAB_00107c28:if (iVar28 != iVar13) goto LAB_0010758d;
         }
      ...
      LAB_0010756c:lVar15 = *(long*)( param_5 + 8 );
      if (lVar15 == 0) {
         if (iVar28 == 0) goto LAB_001080f9;
      }
 else {
         LAB_0010757e:iVar11 = (int)*(undefined8*)( lVar15 + -8 );
         if (iVar28 == iVar11) {
            lVar15 = *(long*)( param_6 + 8 );
   ...
   LAB_0010758d:local_b0[0] = 0;
   iVar11 = (int)uVar26;
   CowData<unsigned_char>::resize<false>((CowData<unsigned_char>*)local_b0, ( ulong )(uVar32 * iVar11) << 2);
   local_a0 = (undefined8*)0x0;
   CowData<RenderingDeviceCommons::VertexAttribute>::resize<false>((CowData<RenderingDeviceCommons::VertexAttribute>*)&local_a0, 5);
   local_90 = 0;
      ...
      if (0 < lVar17) {
         ...
         *(undefined4*)( local_a0 + 2 ) = 0;
         if (iVar11 == 0) {
            ...
            LAB_00107b40:lVar17 = local_a0[-1];
            if (1 < lVar17) {
               CowData<RenderingDeviceCommons::VertexAttribute>::_copy_on_write((CowData<RenderingDeviceCommons::VertexAttribute>*)&local_a0);
 ...
 while ( puVar6 + uVar26 * 4 != puVar16 );
                  lVar17 = *(long*)( param_4 + 8 );
                  LAB_00107bf2:uVar25 = 6;
                  if (lVar17 != 0) goto LAB_00107733;
                  LAB_0010773e:if (local_a0 != (undefined8*)0x0) {
                     lVar17 = local_a0[-1];
 ...
 while ( iVar11 != iVar29 );
                  ...
                  if (lVar17 != 0) {
                     LAB_001081b2:uVar25 = 6;
                     LAB_00107733:iVar29 = *(int*)( lVar17 + -8 );
                     goto LAB_00107736;
                  }

                  iVar29 = 0x18;
                  uVar25 = 6;
                  LAB_00107c48:if (local_a0 == (undefined8*)0x0) goto LAB_00107ff0;
                  LAB_00107c51:lVar17 = local_a0[-1];
                  if (2 < lVar17) {
                     CowData<RenderingDeviceCommons::VertexAttribute>::_copy_on_write((CowData<RenderingDeviceCommons::VertexAttribute>*)&local_a0);
 ...
 while ( puVar6 + uVar26 * 2 != puVar16 );
                        uVar25 = uVar25 + 2;
                        LAB_001077b4:lVar17 = *(long*)( param_1 + 8 );
                        if (lVar17 != 0) goto LAB_001077c6;
                        if (iVar28 == 0) goto LAB_00108149;
                        LAB_001077d0:if (local_a0 == (undefined8*)0x0) {
                           LAB_00108018:lVar17 = 0;
                        }
 else {
                           LAB_001077d9:lVar17 = local_a0[-1];
                           if (3 < lVar17) {
                              CowData<RenderingDeviceCommons::VertexAttribute>::_copy_on_write((CowData<RenderingDeviceCommons::VertexAttribute>*)&local_a0);
                              uVar20 = _UNK_0012dac8;
                              uVar19 = __LC109;
                     ...
                     if (lVar17 != 0) {
                        LAB_001077c6:if (iVar28 == *(int*)( lVar17 + -8 )) {
                           lVar17 = *(long*)( param_6 + 8 );
                           if (lVar17 != 0) goto LAB_00107d3a;
                           iVar29 = 0;
                           LAB_00107d3d:if (iVar28 == iVar29) goto LAB_00107d46;
                        }
                     ...
                     LAB_00108149:lVar17 = *(long*)( param_6 + 8 );
                     if (lVar17 != 0) {
                        LAB_00107d3a:iVar29 = *(int*)( lVar17 + -8 );
                        goto LAB_00107d3d;
                     }

                     LAB_00107d46:if (local_a0 == (undefined8*)0x0) goto LAB_00108018;
                     lVar17 = local_a0[-1];
                     ...
                     *(undefined4*)( (long)local_a0 + 0x4c ) = 0;
                     ...
                     if (iVar11 != 0) {
                        do {
                           ...
                           iVar29 = iVar29 + 1;
                           uVar30 = uVar30 + uVar32;
                           *(ulong*)( lVar15 + uVar31 * 4 ) = CONCAT62(CONCAT42(CONCAT22(*(undefined2*)( lVar17 + ( ulong )(iVar9 + 3) * 4 ), *(undefined2*)( lVar17 + ( ulong )(iVar9 + 2) * 4 )), *(undefined2*)( lVar17 + ( ulong )(iVar9 + 1) * 4 )), *(undefined2*)( lVar17 + uVar26 * 4 ));
 ...
 while ( iVar11 != iVar29 );
                     ...
                     uVar25 = uVar25 + 2;
                     LAB_00107849:if (*(long*)( param_6 + 8 ) == 0) {
                        iVar29 = 0;
                     }
 else {
                              ...
                              *(undefined4*)( local_a0 + 0xc ) = 0;
                              ...
                              if (iVar11 != 0) {
                                 ...
                                 do {
                                    ...
                                    if (( 0.0 <= fVar33 ) && ( uVar24 = fVar33 <= _LC110 )) {
 ...
 while ( iVar11 != iVar28 );
                              ...
                              LAB_001078db:if (uVar32 == uVar25) {
                                 ...
                                 if (pVVar18 != (Vector*)0xffffffffffffffff) {
                                    ...
                                    local_70 = uVar19;
                                    joined_r0x00107943:if (local_a0 != (undefined8*)0x0) {
                                       do {
                                          if ((long)local_a0[-1] <= lVar14) break;
                                          if (local_90 == 0) {
                                             lVar15 = 0;
                                             LAB_00107ce3:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar14, lVar15, "p_index", "size()", "", false, true);
                                             _err_flush_stdout();
                                             /* WARNING: Does not return */
 ...
 while ( true );
                                    ...
                                    uVar20 = RenderingDevice::vertex_array_create(uVar32, uVar26, pVVar18, local_98);
                                    pvVar7 = local_80[0];
                                    local_68 = uVar20;
                                    ...
                                    if (*(long*)( param_1 + 8 ) == 0) {
                                       ...
                                       if (lVar14 != 0) {
                                          local_80[0] = (void*)0x0;
                                          CowData<unsigned_char>::resize<false>((CowData<unsigned_char>*)local_80, lVar14 * 4);
                                          CowData<unsigned_char>::_copy_on_write((CowData<unsigned_char>*)local_80);
                                          ...
                                          lVar14 = RenderingDevice::index_buffer_create(uVar23, uVar27, 1, &local_88, 0, 0);
                                          local_60 = lVar14;
                                          uVar23 = RenderingDevice::get_singleton();
                                          if (*(long*)( param_1 + 8 ) == 0) {
                                             uVar27 = 0;
                                    ...
                                    *(ulong*)( this + 0x728 ) = uVar26 + 1;
                                    local_88 = uVar26;
                                    puVar21 = (undefined8*)HashMap<unsigned_long,RendererCanvasRenderRD::PolygonBuffers,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>,DefaultTypedAllocator<HashMapElement<unsigned_long,RendererCanvasRenderRD::PolygonBuffers>>>::operator []((HashMap<unsigned_long,RendererCanvasRenderRD::PolygonBuffers,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>,DefaultTypedAllocator<HashMapElement<unsigned_long,RendererCanvasRenderRD::PolygonBuffers>>>*)( this + 0x6f8 ), &local_88);
                                    *puVar21 = pVVar18;
                                    puVar21[1] = uVar19;
                                    puVar21[2] = uVar20;
                                    puVar21[3] = lVar14;
                                 ...
                                 _err_print_error("request_polygon", "servers/rendering/renderer_rd/renderer_canvas_render_rd.cpp", 0x12a, "Condition \"vertex_id == RD::INVALID_ID\" is true. Returning: 0", 0, 0);
                              }
 else {
                                 _err_print_error("request_polygon", "servers/rendering/renderer_rd/renderer_canvas_render_rd.cpp", 0x126, "Condition \"base_offset != stride\" is true. Returning: 0", 0, 0);
                              }

                              uVar26 = 0;
                              LAB_00107a7b:lVar14 = local_90;
                              if (local_90 != 0) {
                                 LOCK();
                     ...
                     LAB_00108068:lVar14 = 4;
                     goto LAB_00107fc9;
                  }

               }

               LAB_00107ff3:lVar14 = 2;
               goto LAB_00107fc9;
            }
 ...
 while ( puVar6 + uVar26 * 2 != puVar16 );
            lVar17 = *(long*)( param_3 + 8 );
            if (lVar17 != 0) {
               LAB_0010769d:if (( iVar11 == (int)*(long*)( lVar17 + -8 ) ) || ( *(long*)( lVar17 + -8 ) == 1 )) goto LAB_00107b40;
            }
               ...
               if (local_90 == 0) {
                  ...
                  if (1 < lVar17) {
                     ...
                     *(undefined8*)( local_90 + 8 ) = uVar19;
                     ...
                     iVar29 = 0;
                     uVar25 = 2;
                     LAB_00107736:if (iVar11 != iVar29) goto LAB_0010773e;
                     iVar29 = uVar25 * 4;
                     goto LAB_00107c48;
                  }
   ...
   lVar14 = 0;
   LAB_00107fc9:_err_print_index_error("operator[]", "./core/templates/vector.h", 0x38, lVar14, lVar17, "p_index", "((Vector<T> *)(this))->_cowdata.size()", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar8 = (code*)invalidInstructionException();
   ( *pcVar8 )();
   code_r0x00107981:CowData<RID>::_copy_on_write((CowData<RID>*)&local_90);
   *(undefined8*)( local_90 + lVar14 * 8 ) = uVar19;
   lVar14 = lVar14 + 1;
   goto joined_r0x00107943;
}
/* RendererCanvasRenderRD::light_create() */void RendererCanvasRenderRD::light_create(RendererCanvasRenderRD *this) {
   long in_FS_OFFSET;
   undefined8 local_48;
   undefined1 local_40;
   undefined8 local_34;
   ...
   local_24 = 0;
   RID_Alloc<RendererCanvasRenderRD::CanvasLight,false>::make_rid((RID_Alloc<RendererCanvasRenderRD::CanvasLight,false>*)( this + 0x750 ), (CanvasLight*)&local_48);
...
/* RendererCanvasRenderRD::occluder_polygon_create() */void RendererCanvasRenderRD::occluder_polygon_create(RendererCanvasRenderRD *this) {
   long in_FS_OFFSET;
   undefined8 local_68;
   ...
   RID_Alloc<RendererCanvasRenderRD::OccluderPolygon,false>::make_rid((RID_Alloc<RendererCanvasRenderRD::OccluderPolygon,false>*)( this + 0x7a8 ), (OccluderPolygon*)&local_68);
   if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RendererCanvasRenderRD::set_shadow_texture_size(int) */void RendererCanvasRenderRD::set_shadow_texture_size(RendererCanvasRenderRD *this, int param_1) {
   long *plVar1;
   long lVar2;
   uint uVar3;
   int iVar4;
   ...
   if (( *(int*)( this + 0xb10 ) != iVar4 ) && ( *(int*)( this + 0xb10 ) = iVar4 * (long*)( this + 0xb08 ) != 0 )) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RendererCanvasRenderRD::_update_shadow_atlas() [clone .part.0] */void RendererCanvasRenderRD::_update_shadow_atlas(RendererCanvasRenderRD *this) {
   long *plVar1;
   long lVar2;
   undefined8 uVar3;
...
/* RendererCanvasRenderRD::_update_shadow_atlas() */void RendererCanvasRenderRD::_update_shadow_atlas(RendererCanvasRenderRD *this) {
...
/* RendererCanvasRenderRD::~RendererCanvasRenderRD() */void RendererCanvasRenderRD::~RendererCanvasRenderRD(RendererCanvasRenderRD *this) {
   uint uVar1;
   uint uVar2;
   long lVar3;
   code *pcVar4;
   ...
   long local_40;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   *(undefined***)this = &PTR_request_polygon_00124200;
      ...
      if (*(uint*)pRVar12 != 0) {
         do {
            ...
            if (*(uint*)pRVar12 <= (uint)uVar9) {
               _err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, uVar9 & 0xffffffff, ( ulong ) * (uint*)pRVar12, "p_index", "count", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
               pcVar4 = (code*)invalidInstructionException();
               ( *pcVar4 )();
 ...
 while ( pRVar12 != this + 0xa90 );
   RendererRD::TextureStorage::canvas_texture_set_invalidation_callback(plVar7, *(undefined8*)( this + 0x200b90 ), 0, 0);
 ...
 while ( (ulong)uVar1 << 2 != lVar10 );
   ...
   LAB_00108fb2:pvVar11 = *(void**)( this + 0xa08 );
   if (pvVar11 != (void*)0x0) {
      if (*(int*)( this + 0xa2c ) != 0) {
 ...
 while ( lVar10 != (ulong)uVar1 << 2 );
   ...
   LAB_0010908a:pvVar11 = *(void**)( this + 0x9d0 );
   if (pvVar11 != (void*)0x0) {
      if (*(int*)( this + 0x9f4 ) != 0) {
 ...
 while ( lVar10 != (ulong)uVar1 << 2 );
   ...
   LAB_00109130:plVar6 = *(long**)( this + 0x9c0 );
   if (plVar6 != (long*)0x0) {
      do {
         pvVar11 = (void*)*plVar6;
         if (pvVar11 == (void*)0x0) {
 ...
 while ( (int)plVar6[2] != 0 );
   ...
   LAB_001091a2:*(undefined***)( this + 0x800 ) = &PTR__CanvasOcclusionShaderRD_001241a0;
   ShaderRD::~ShaderRD((ShaderRD*)( this + 0x800 ));
   uVar1 = *(uint*)( this + 0x7c8 );
   *(undefined***)( this + 0x7a8 ) = &PTR__RID_Alloc_001241e0;
   if (uVar1 != 0) {
      local_60 = 0;
      local_50 = 0x3b;
      local_58 = "ERROR: %d RID allocations of type \'%s\' were leaked at exit.";
      String::parse_latin1((StrRange*)&local_60);
      vformat<unsigned_int,char_const*>((String*)&local_58, (uint)(StrRange*)&local_60, (char*)(ulong)uVar1);
 ...
 while ( (uint)lVar10 < uVar1 / uVar2 );
   ...
   *(undefined***)( this + 0x750 ) = &PTR__RID_Alloc_001241c0;
   if (uVar1 != 0) {
      local_60 = 0;
      local_50 = 0x3b;
      local_58 = "ERROR: %d RID allocations of type \'%s\' were leaked at exit.";
 ...
 while ( (ulong)uVar1 << 2 != lVar10 );
   ...
   LAB_001094ea:ShaderCompiler::DefaultIdentifierActions::~DefaultIdentifierActions((DefaultIdentifierActions*)( this + 0x5c0 ));
   pvVar11 = *(void**)( this + 0x598 );
   if (pvVar11 != (void*)0x0) {
      if (( *(int*)( this + 0x5bc ) != 0 ) && ( ( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x5b8 ) * 4 ) == 0 || ( memset(*(void**)( this + 0x5b0 ), 0, ( ulong ) * (uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x5b8 ) * 4 ) * 4),*(int*)( this + 0x5bc ) != 0 ) ) )) {
         lVar10 = 0;
         do {
 ...
 while ( (uint)lVar10 < *(uint*)( this + 0x5bc ) );
   ...
   LAB_001095be:pvVar11 = *(void**)( this + 0x570 );
   if (pvVar11 != (void*)0x0) {
      if (( *(int*)( this + 0x594 ) != 0 ) && ( ( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x590 ) * 4 ) == 0 || ( memset(*(void**)( this + 0x588 ), 0, ( ulong ) * (uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x590 ) * 4 ) * 4),*(int*)( this + 0x594 ) != 0 ) ) )) {
         lVar10 = 0;
         do {
            if (( StringName::configured != '\0' ) && ( *(long*)( (long)pvVar11 + lVar10 * 8 ) != 0 )) {
               StringName::unref();
 ...
 while ( (uint)lVar10 < *(uint*)( this + 0x594 ) );
   ...
   LAB_0010967e:pvVar11 = *(void**)( this + 0x548 );
   if (pvVar11 != (void*)0x0) {
      if (( *(int*)( this + 0x56c ) != 0 ) && ( ( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x568 ) * 4 ) == 0 || ( memset(*(void**)( this + 0x560 ), 0, ( ulong ) * (uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x568 ) * 4 ) * 4),*(int*)( this + 0x56c ) != 0 ) ) )) {
         lVar10 = 0;
         do {
            if (( StringName::configured != '\0' ) && ( *(long*)( (long)pvVar11 + lVar10 * 8 ) != 0 )) {
               StringName::unref();
 ...
 while ( (uint)lVar10 < *(uint*)( this + 0x56c ) );
   ...
   LAB_00109746:pvVar11 = *(void**)( this + 0x520 );
   if (pvVar11 != (void*)0x0) {
      if (( *(int*)( this + 0x544 ) != 0 ) && ( ( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x540 ) * 4 ) == 0 || ( memset(*(void**)( this + 0x538 ), 0, ( ulong ) * (uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x540 ) * 4 ) * 4),*(int*)( this + 0x544 ) != 0 ) ) )) {
         lVar10 = 0;
         do {
            if (( StringName::configured != '\0' ) && ( *(long*)( (long)pvVar11 + lVar10 * 8 ) != 0 )) {
               StringName::unref();
 ...
 while ( (uint)lVar10 < *(uint*)( this + 0x544 ) );
   ...
   LAB_0010980e:pvVar11 = *(void**)( this + 0x4f8 );
   if (pvVar11 != (void*)0x0) {
      if (( *(int*)( this + 0x51c ) != 0 ) && ( ( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x518 ) * 4 ) == 0 || ( memset(*(void**)( this + 0x510 ), 0, ( ulong ) * (uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x518 ) * 4 ) * 4),*(int*)( this + 0x51c ) != 0 ) ) )) {
         lVar10 = 0;
         do {
            if (( StringName::configured != '\0' ) && ( *(long*)( (long)pvVar11 + lVar10 * 8 ) != 0 )) {
               StringName::unref();
 ...
 while ( (uint)lVar10 < *(uint*)( this + 0x51c ) );
   ...
   LAB_001098ce:pvVar11 = *(void**)( this + 0x4d0 );
   if (pvVar11 != (void*)0x0) {
      if (( *(int*)( this + 0x4f4 ) != 0 ) && ( ( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x4f0 ) * 4 ) == 0 || ( memset(*(void**)( this + 0x4e8 ), 0, ( ulong ) * (uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x4f0 ) * 4 ) * 4),*(int*)( this + 0x4f4 ) != 0 ) ) )) {
         lVar10 = 0;
         do {
            if (( StringName::configured != '\0' ) && ( *(long*)( (long)pvVar11 + lVar10 * 8 ) != 0 )) {
               StringName::unref();
 ...
 while ( (uint)lVar10 < *(uint*)( this + 0x4f4 ) );
   ...
   LAB_0010998e:if (( StringName::configured != '\0' ) && ( ( ( *(long*)( this + 0x4c8 ) == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) && ( *(long*)( this + 0x4c0 ) != 0 ) ) )) {
      StringName::unref();
   }

   ShaderLanguage::~ShaderLanguage((ShaderLanguage*)( this + 0x1a8 ));
   *(undefined***)( this + 0x18 ) = &PTR__CanvasShaderRD_00124180;
...
/* RendererCanvasRenderRD::_update_occluder_buffer(unsigned int) */void RendererCanvasRenderRD::_update_occluder_buffer(RendererCanvasRenderRD *this, uint param_1) {
   long *plVar1;
   Version *pVVar2;
   code *pcVar3;
   undefined8 uVar4;
   ...
   *(undefined8*)( this + 0xb18 ) = uVar4;
   ...
   if (*(long*)( this + 0x818 ) == 0) {
      lVar7 = 0;
      LAB_0010a0a3:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 1, lVar7, "p_variant", "variant_defines.size()", "", false, false);
      LAB_0010a0df:uVar6 = 0;
   }
 else {
      ...
      if (lVar7 == 0) {
         LAB_0010a1e0:lVar10 = 0;
         LAB_0010a1e3:uVar5 = 1;
         LAB_0010a203:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar5, lVar10, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
      ...
      if (*(char*)( lVar7 + 1 ) != '\0') {
         if (( uVar5 == 0 ) || ( *(uint*)( this + 0x8d4 ) <= (uint)uVar5 )) {
            LAB_0010a150:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
            uVar6 = 0;
            goto LAB_0010a027;
         }

         lVar7 = ( ( uVar5 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x8d0 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x8c0 ) + ( ( uVar5 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x8d0 ) ) * 8 );
 ...
 while ( lVar10 != 0 );
   ...
   LAB_0010a027:uVar4 = RenderingDevice::uniform_set_create<Vector<RenderingDevice::Uniform>>(uVar4, aVStack_78, uVar6, 0, 0);
   *(undefined8*)( this + 0xb28 ) = uVar4;
   CowData<RenderingDevice::Uniform>::_unref((CowData<RenderingDevice::Uniform>*)&local_70);
   LAB_0010a048:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* RendererCanvasRenderRD::_create_base_uniform_set(RID, bool) */undefined8 RendererCanvasRenderRD::_create_base_uniform_set(RendererCanvasRenderRD *this, undefined8 param_2, char param_3) {
   undefined8 uVar1;
   long lVar2;
   long lVar3;
   undefined8 uVar4;
   ...
   local_68 = _LC141;
   Vector<RenderingDevice::Uniform>::push_back(local_78, &local_68);
   RendererRD::MaterialStorage::Samplers::append_uniforms<Vector<RenderingDevice::Uniform>>((Vector*)( lVar2 + 8 ), (int)local_78);
   uVar4 = RenderingDevice::get_singleton();
   uVar4 = RenderingDevice::uniform_set_create<Vector<RenderingDevice::Uniform>>(uVar4, local_78, *(undefined8*)( this + 400 ), 0, 0);
   if (param_3 == '\0') {
...
/* RendererCanvasRenderRD::render_sdf(RID, RendererCanvasRender::LightOccluderInstance*) */void RendererCanvasRenderRD::render_sdf(RendererCanvasRenderRD *this, undefined8 param_2, long param_3) {
   ulong uVar1;
   long *plVar2;
   undefined8 uVar3;
   undefined8 uVar4;
   ...
   if (param_3 != 0) {
      do {
         while (( uVar1 = *(ulong*)( param_3 + 0x18 ) ),uVar1 == 0 || ( *(uint*)( this + 0x7c4 ) <= (uint)uVar1 )) {
            LAB_0010a9e1:param_3 = *(long*)( param_3 + 0x88 );
            LAB_0010a9e9:if (param_3 == 0) goto LAB_0010a9ee;
         }
;
         lVar6 = *(long*)( *(long*)( this + 0x7b0 ) + ( ( uVar1 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x7c0 ) ) * 8 ) + ( ( uVar1 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x7c0 ) ) * 0x60;
         ...
         local_5c = local_104;
         uVar3 = RenderingDevice::get_singleton();
         RenderingDevice::draw_list_bind_render_pipeline(uVar3, pvVar5, *(undefined8*)( this + ( ulong ) * (byte*)( lVar6 + 0x50 ) * 8 + 0x990 ));
         uVar3 = RenderingDevice::get_singleton();
 ...
 while ( param_3 != 0 );
   ...
   LAB_0010a9ee:RenderingDevice::get_singleton();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RendererCanvasRenderRD::light_update_directional_shadow(RID, int, Transform2D const&, int, float,
   Rect2 const&, RendererCanvasRender::LightOccluderInstance*) */void RendererCanvasRenderRD::light_update_directional_shadow(float param_1, RendererCanvasRenderRD *this, ulong param_3, int param_4, undefined8 param_5, uint param_6, ulong *param_7, long param_8) {
   long *plVar1;
   long lVar2;
   ulong uVar3;
   code *pcVar4;
   ...
   if (( param_3 != 0 ) && ( (uint)param_3 < *(uint*)( this + 0x76c ) )) {
      lVar2 = *(long*)( *(long*)( this + 0x758 ) + ( ( param_3 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x768 ) ) * 8 ) + ( ( param_3 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x768 ) ) * 0x38;
      if (*(int*)( lVar2 + 0x30 ) == (int)( param_3 >> 0x20 )) {
         if (*(char*)( lVar2 + 8 ) == '\0') {
            if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
               _err_print_error("light_update_directional_shadow", "servers/rendering/renderer_rd/renderer_canvas_render_rd.cpp", 0x464, "Condition \"!cl->shadow.enabled\" is true.", 0, 0);
               return;
            }
            ...
            local_220 = CONCAT44(_UNK_0012d9dc * (float)( param_7[1] >> 0x20 ) + fVar12, _LC146 * fVar11 + (float)uVar3);
            ...
            *(ulong*)( lVar2 + 0xc ) = CONCAT44((float)(int)( param_4 * 2 + 1 ) / (float)( uint )(*(int*)( this + 0xb38 ) * 2), fVar12);
            local_1e8 = CONCAT44((float)local_228, local_228._4_4_ ^ uVar6);
            local_1e0 = local_228;
            local_1d8 = CONCAT44((float)uVar5 - ( param_1 + fVar11 ) * (float)uVar3, fVar15 - ( param_1 + fVar11 ) * fVar14);
            Transform2D::invert();
            local_230 = 0;
            ...
            pvVar8 = (void*)RenderingDevice::draw_list_begin(uVar7, *(undefined8*)( this + 0xb08 ), 0x500ff, local_238, 0, (Projection*)local_b8, 0);
            uVar7 = RenderingDevice::get_singleton();
            ...
            if (param_8 != 0) {
               LAB_0010b0d0:do {
                  ...
                  if (( uVar3 == 0 ) || ( *(uint*)( this + 0x7c4 ) <= (uint)uVar3 )) {
                     LAB_0010b12a:param_8 = *(long*)( param_8 + 0x88 );
                  }
 else {
                     puVar10 = (undefined4*)( ( ( uVar3 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x7c0 ) ) * 0x60 + *(long*)( *(long*)( this + 0x7b0 ) + ( ( uVar3 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x7c0 ) ) * 8 ) );
                     if (puVar10[0x16] == (int)( uVar3 >> 0x20 )) {
                        if (( *(long*)( puVar10 + 8 ) == 0 ) || ( ( param_6 & *(uint*)( param_8 + 0x78 ) ) == 0 )) goto LAB_0010b12a;
                        ...
                        local_5c = local_e4;
                        uVar7 = RenderingDevice::get_singleton();
                        RenderingDevice::draw_list_bind_vertex_array(uVar7, pvVar8, *(undefined8*)( puVar10 + 4 ));
                        uVar7 = RenderingDevice::get_singleton();
                        RenderingDevice::draw_list_bind_index_array(uVar7, pvVar8, *(undefined8*)( puVar10 + 8 ));
                        lVar9 = RenderingDevice::get_singleton();
                        RenderingDevice::draw_list_set_push_constant(lVar9, pvVar8, (uint)(Projection*)local_b8);
                        lVar9 = RenderingDevice::get_singleton();
 ...
 while ( param_8 != 0 );
      ...
      if (*(int*)( lVar2 + 0x30 ) + 0x80000000U < 0x7fffffff) {
         _err_print_error("get_or_null", "./core/templates/rid_owner.h", 0x103, "Method/function failed. Returning: nullptr", "Attempting to use an uninitialized RID", 0, 0, *(long*)( this + 0x758 ));
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RendererCanvasRenderRD::light_update_shadow(RID, int, Transform2D const&, int, float, float,
   RendererCanvasRender::LightOccluderInstance*, Rect2 const&) */void RendererCanvasRenderRD::light_update_shadow(undefined4 param_1, undefined4 param_2, RendererCanvasRenderRD *this, ulong param_4, int param_5, undefined8 *param_6, uint param_7, long param_8, Transform2D *param_9) {
   long *plVar1;
   undefined4 *puVar2;
   undefined4 uVar3;
   code *pcVar4;
   ...
   if (( param_4 != 0 ) && ( (uint)param_4 < *(uint*)( this + 0x76c ) )) {
      lVar16 = *(long*)( *(long*)( this + 0x758 ) + ( ( param_4 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x768 ) ) * 8 ) + ( ( param_4 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x768 ) ) * 0x38;
      if (*(int*)( lVar16 + 0x30 ) == (int)( param_4 >> 0x20 )) {
         if (*(char*)( lVar16 + 8 ) == '\0') {
            if (local_40 == *(long*)( in_FS_OFFSET + 10 )) {
               _err_print_error("light_update_shadow", "servers/rendering/renderer_rd/renderer_canvas_render_rd.cpp", 0x3fa, "Condition \"!cl->shadow.enabled\" is true.", 0, 0);
               return;
            }
            ...
            uVar5 = param_5 * 2;
            *(ulong*)( lVar16 + 0xc ) = CONCAT44((float)(int)( uVar5 + 1 ) / (float)( uint )(*(int*)( this + 0xb38 ) * 2), param_2);
            local_c0 = 0;
            ...
            if ((char)*in_FS_OFFSET == '\0') {
               ...
               *(undefined1*)in_FS_OFFSET = 1;
               __cxa_thread_atexit(LocalVector<RendererCanvasRenderRD::OccluderPolygon*,unsigned_int,false,false>::~LocalVector, uVar9, &__dso_handle);
            }
            ...
            if ((char)*in_FS_OFFSET == '\0') {
               ...
               *(undefined1*)in_FS_OFFSET = 1;
               in_FS_OFFSET[0] = 0;
               in_FS_OFFSET[1] = 0;
               __cxa_thread_atexit(LocalVector<unsigned_int,unsigned_int,false,false>::~LocalVector, uVar9, &__dso_handle);
            }
            ...
            if (param_8 != 0) {
               ...
               do {
                  while (true) {
                     ...
                     LAB_0010b530:lVar16 = *(long*)( lVar16 + 0x88 );
                     iVar7 = iVar17;
                     if (lVar16 == 0) goto LAB_0010b5e0;
                  }
;
                  lVar15 = ( ( uVar14 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x7c0 ) ) * 0x60 + *(long*)( *(long*)( this + 0x7b0 ) + ( ( uVar14 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x7c0 ) ) * 8 );
                  if (*(int*)( lVar15 + 0x58 ) == (int)( uVar14 >> 0x20 )) {
                     if (( ( *(long*)( lVar15 + 0x20 ) != 0 ) && ( ( param_7 & *(uint*)( lVar16 + 0x78 ) ) != 0 ) ) && ( cVar6 = Rect2::intersects_transformed(param_9, (Rect2*)( lVar16 + 0x60 )) ),cVar6 != '\0') {
                        uVar13 = *in_FS_OFFSET;
                        ...
                        *(long*)( (long)pvVar11 + (ulong)uVar13 * 8 ) = lVar15;
                        ...
                        if (uVar13 == *in_FS_OFFSET) {
                           ...
                           *(void**)in_FS_OFFSET = pvVar11;
                           if (pvVar11 == (void*)0x0) {
                              LAB_0010be46:_err_print_error("push_back", "./core/templates/local_vector.h", 0x41, "FATAL: Condition \"!data\" is true.", "Out of memory", 0, 0);
                              _err_flush_stdout();
                              /* WARNING: Does not return */
                              pcVar4 = (code*)invalidInstructionException();
                              ( *pcVar4 )();
 ...
 while ( lVar16 != 0 );
               LAB_0010b5e0:if (( param_5 == 0 ) && ( iVar17 != 0 )) {
                  if ((char)*in_FS_OFFSET == '\0') {
                     uVar9 = *(undefined8*)in_FS_OFFSET;
                     in_FS_OFFSET[0] = 0;
                     in_FS_OFFSET[1] = 0;
                     *(undefined1*)in_FS_OFFSET = 1;
                     in_FS_OFFSET[0] = 0;
                     in_FS_OFFSET[1] = 0;
                     __cxa_thread_atexit(LocalVector<float,unsigned_int,false,false>::~LocalVector, uVar9, &__dso_handle);
                     uVar13 = *in_FS_OFFSET;
                  }
 else {
                     uVar13 = *in_FS_OFFSET;
                  ...
                  if (uVar13 == 0) {
                     uVar14 = 0;
                     LAB_0010ba8a:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, uVar14, (ulong)uVar13, "p_index", "count", "", false, true);
                     _err_flush_stdout();
                     /* WARNING: Does not return */
                     pcVar4 = (code*)invalidInstructionException();
                     ( *pcVar4 )();
 ...
 while ( param_8 != 0 );
                  ...
                  uVar9 = RenderingDevice::get_singleton();
                  RenderingDevice::buffer_update(uVar9, *(undefined8*)( this + 0xb18 ), 0, *in_FS_OFFSET * 4, *(undefined8*)in_FS_OFFSET);
               }
            ...
            pRVar10 = (Rect2*)RenderingDevice::draw_list_begin(uVar9, *(undefined8*)( this + 0xb08 ), 0x500ff, local_c8, 0, local_98, 0);
            if (*(long*)( this + 0xb18 ) != 0) {
               uVar9 = RenderingDevice::get_singleton();
               RenderingDevice::draw_list_bind_render_pipeline(uVar9, pRVar10, *(undefined8*)( this + 0x988 ));
               uVar9 = RenderingDevice::get_singleton();
               RenderingDevice::draw_list_bind_uniform_set(uVar9, pRVar10, *(undefined8*)( this + 0xb28 ), 0);
               lVar16 = 0;
               puVar12 = &light_update_shadow(RID, ,int, Transform2D_const, &,int,float,float, RendererCanvasRender::LightOccluderInstance * Rect2_const & ::rotations);
               do {
            ...
            if (light_update_shadow(RID,int,Transform2D_const&,int,float,float,RendererCanvasRender::LightOccluderInstance*,Rect2_const&)
              ...
              if (iVar7 != 0) {
                ...
                light_update_shadow(RID,int,Transform2D_const&,int,float,float,RendererCanvasRender::LightOccluderInstance*,Rect2_const&)
                ::directions._8_8_ = _UNK_0012db38;
                light_update_shadow(RID,int,Transform2D_const&,int,float,float,RendererCanvasRender::LightOccluderInstance*,Rect2_const&)
                ::directions._16_8_ = __LC156;
                light_update_shadow(RID,int,Transform2D_const&,int,float,float,RendererCanvasRender::LightOccluderInstance*,Rect2_const&)
                ::directions._24_8_ = _UNK_0012db48;
            ...
            if (light_update_shadow(RID,int,Transform2D_const&,int,float,float,RendererCanvasRender::LightOccluderInstance*,Rect2_const&)
              ...
              if (iVar7 != 0) {
                _rotations = __LC157;
                _DAT_001170e8 = _UNK_0012db58;
                _DAT_001170f0 = __LC156;
                uRam00000000001170f8 = _UNK_0012db48;
                _DAT_00117100 = __LC158;
                uRam0000000000117108 = _UNK_0012db68;
                _DAT_00117110 = __LC155;
                uRam0000000000117118 = _UNK_0012db38;
                __cxa_guard_release(&light_update_shadow(RID,int,Transform2D_const&,int,float,float,RendererCanvasRender::LightOccluderInstance*,Rect2_const&)
                                     ::rotations);
              }
            }
    ...
    */
         void RendererCanvasRenderRD::CanvasShaderData::_create_pipeline(CanvasShaderData *param_1) {
            ...
            if (iStack0000000000000028 == 0) {
               RendererRD::MaterialStorage::ShaderData::blend_mode_to_blend_attachment(&local_138, *(undefined4*)( param_1 + 0x80 ));
               local_160 = 0;
            }
 else {
            ...
            local_140 = 0;
            iVar3 = CowData<RenderingDeviceCommons::PipelineSpecializationConstant>::resize<false>((CowData<RenderingDeviceCommons::PipelineSpecializationConstant>*)&local_140, 1);
            if (iVar3 == 0) {
               if (local_140 == 0) {
                  lVar10 = -1;
                  lVar5 = 0;
                  ...
                  lVar10 = lVar5 + -1;
                  if (-1 < lVar10) {
                     CowData<RenderingDeviceCommons::PipelineSpecializationConstant>::_copy_on_write((CowData<RenderingDeviceCommons::PipelineSpecializationConstant>*)&local_140);
               ...
               _err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar10, lVar5, "p_index", "size()", "", false, false);
            }
 else {
               _err_print_error("push_back", "./core/templates/vector.h", 0x142, "Condition \"err\" is true. Returning: true", 0, 0);
            }

            LAB_0010c0b3:if (( *(long*)( param_1 + 0xa8 ) == 0 ) || ( lVar5 = get_shader(param_1, in_stack_00000008, iStack000000000000002c != 0) ),lVar5 == 0) {
               _err_print_error("_create_pipeline", "servers/rendering/renderer_rd/renderer_canvas_render_rd.cpp", 0x5f3, "Condition \"shader_rid.is_null()\" is true.", 0, 0);
               lVar5 = local_140;
            }
 else {
               ...
               lVar5 = RenderingDevice::render_pipeline_create(uVar6, lVar5, in_stack_00000010, in_stack_00000018, iStack0000000000000020, local_118, &local_e8, local_b8, local_68, local_160, 0, local_148);
               if (lVar5 == 0) {
                  _err_print_error("_create_pipeline", "servers/rendering/renderer_rd/renderer_canvas_render_rd.cpp", 0x5f6, "Condition \"pipeline.is_null()\" is true.", 0, 0);
                  lVar5 = local_140;
               }
 else {
                  iVar3 = (int)( (ulong)in_stack_00000018 >> 0x20 );
                  uVar8 = ( in_stack_00000008 * 0x16a88000 | ( uint )(in_stack_00000008 * -0x3361d2af) >> 0x11 ) * 0x1b873593 ^ 0x7f07c65;
                  uVar4 = ( uVar8 << 0xd | uVar8 >> 0x13 ) * 5 + 0xe6546b64 ^ ( uVar4 * 0x16a88000 | uVar4 * -0x3361d2af >> 0x11 ) * 0x1b873593;
                  uVar4 = ( uVar4 << 0xd | uVar4 >> 0x13 ) * 5 + 0xe6546b64 ^ ( (int)in_stack_00000018 * 0x16a88000 | ( uint )((int)in_stack_00000018 * -0x3361d2af) >> 0x11 ) * 0x1b873593;
                  uVar4 = ( uVar4 << 0xd | uVar4 >> 0x13 ) * 5 + 0xe6546b64 ^ ( iVar3 * 0x16a88000 | ( uint )(iVar3 * -0x3361d2af) >> 0x11 ) * 0x1b873593;
                  uVar4 = ( uVar4 << 0xd | uVar4 >> 0x13 ) * 5 + 0xe6546b64 ^ ( iStack0000000000000020 * 0x16a88000 | ( uint )(iStack0000000000000020 * -0x3361d2af) >> 0x11 ) * 0x1b873593;
                  uVar4 = ( uVar4 << 0xd | uVar4 >> 0x13 ) * 5 + 0xe6546b64 ^ ( iStack0000000000000024 * 0x16a88000 | ( uint )(iStack0000000000000024 * -0x3361d2af) >> 0x11 ) * 0x1b873593;
                  uVar4 = ( uVar4 << 0xd | uVar4 >> 0x13 ) * 5 + 0xe6546b64 ^ ( iStack0000000000000028 * 0x16a88000 | ( uint )(iStack0000000000000028 * -0x3361d2af) >> 0x11 ) * 0x1b873593;
                  uVar4 = ( uVar4 << 0xd | uVar4 >> 0x13 ) * 5 + 0xe6546b64 ^ ( iStack000000000000002c * 0x16a88000 | ( uint )(iStack000000000000002c * -0x3361d2af) >> 0x11 ) * 0x1b873593;
   ...
   .isra.0] */
         void Vector<RenderingDevice::AttachmentFormat>::push_back(long param_1, undefined8 param_2, undefined4 param_3) {
            undefined8 *puVar1;
            int iVar2;
            long lVar3;
            long lVar4;
            ...
            iVar2 = CowData<RenderingDevice::AttachmentFormat>::resize<false>((CowData<RenderingDevice::AttachmentFormat>*)( param_1 + 8 ), lVar3);
            if (iVar2 == 0) {
               if (*(long*)( param_1 + 8 ) == 0) {
                  lVar4 = -1;
                  lVar3 = 0;
                  ...
                  lVar4 = lVar3 + -1;
                  if (-1 < lVar4) {
                     CowData<RenderingDevice::AttachmentFormat>::_copy_on_write((CowData<RenderingDevice::AttachmentFormat>*)( param_1 + 8 ));
   ...
   >::erase(RendererCanvasRenderRD::RIDSetKey const&) [clone .isra.0] */
         void HashMap<RendererCanvasRenderRD::RIDSetKey,List<LRUCache<RendererCanvasRenderRD::RIDSetKey,RID,HashableHasher<RendererCanvasRenderRD::RIDSetKey>,HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,&RendererCanvasRenderRD::_before_evict>::Pair,DefaultAllocator>::Element*,HashableHasher<RendererCanvasRenderRD::RIDSetKey>,HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,DefaultTypedAllocator<HashMapElement<RendererCanvasRenderRD::RIDSetKey,List<LRUCache<RendererCanvasRenderRD::RIDSetKey,RID,HashableHasher<RendererCanvasRenderRD::RIDSetKey>,HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,&RendererCanvasRenderRD::_before_evict>::Pair,DefaultAllocator>::Element*>>>::erase(HashMap<RendererCanvasRenderRD::RIDSetKey,List<LRUCache<RendererCanvasRenderRD::RIDSetKey,RID,HashableHasher<RendererCanvasRenderRD::RIDSetKey>,HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,&RendererCanvasRenderRD::_before_evict>::Pair,DefaultAllocator>::Element*,HashableHasher<RendererCanvasRenderRD::RIDSetKey>,HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,DefaultTypedAllocator<HashMapElement<RendererCanvasRenderRD::RIDSetKey,List<LRUCache<RendererCanvasRenderRD::RIDSetKey,RID,HashableHasher<RendererCanvasRenderRD::RIDSetKey>,HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,&RendererCanvasRenderRD::_before_evict>::Pair,DefaultAllocator>::Element*>>> *this, RIDSetKey *param_1) {
            uint *puVar1;
            uint *puVar2;
            undefined8 *puVar3;
            undefined8 *puVar4;
...
;
            ...
            *(undefined4*)( lVar8 + uVar30 * 4 ) = 0;
            ...
            if (*(long**)( this + 0x18 ) == plVar31) {
               *(long*)( this + 0x18 ) = *plVar31;
               ...
               LAB_0010c890:*(long*)( this + 0x20 ) = plVar31[1];
               plVar31 = (long*)*plVar5;
               plVar12 = (long*)plVar31[1];
            }
 else {
               if (*(long**)( this + 0x20 ) == plVar31) goto LAB_0010c890;
               LAB_0010c82e:plVar12 = (long*)plVar31[1];
            }
            ...
            *(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + -1;
            LAB_0010c86b:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
               /* WARNING: Subroutine does not return */
               __stack_chk_fail();
            }
         ...
         void RendererCanvasRenderRD::RendererCanvasRenderRD(RendererCanvasRenderRD *this) {
            ShaderRD *this_00;
            ShaderRD *this_01;
            CanvasShaderData *pCVar1;
            undefined8 *puVar2;
            ...
            HashMap<StringName,String,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,String>>> local_258[8];
            undefined1 local_250[16];
            undefined1 local_240[16];
            undefined8 local_230;
            HashMap<StringName,String,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,String>>> local_228[8];
            undefined1 local_220[16];
            undefined1 local_210[16];
            undefined8 local_200;
            HashMap<StringName,String,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,String>>> local_1f8[8];
            ...
            *(undefined***)this = &PTR___cxa_pure_virtual_001240d8;
            pRVar24 = this;
            if (bVar31) {
               _err_print_error("RendererCanvasRender", "./servers/rendering/renderer_canvas_render.h", 0x229, "Condition \"singleton != nullptr\" is true.", "A RendererCanvasRender singleton already exists.", 0, 0);
            ...
            *(ulong*)( this + 0x720 ) = uVar17;
            for (int i = 0; i < 4; i++) {
               *(undefined8*)( this + ( 8*i*i + 1880 ) ) = 0;
            }

            *(undefined4*)( this + 0x790 ) = 1;
            for (int i = 0; i < 4; i++) {
               *(undefined8*)( this + ( 8*i*i + 1968 ) ) = 0;
            }

            *(undefined4*)( this + 0x7e8 ) = 1;
            ShaderRD::ShaderRD(this_01);
            *(undefined***)( this + 0x800 ) = &PTR__CanvasOcclusionShaderRD_001241a0;
 ...
 while ( this + 0xa90 != pRVar10 );
            ...
            *(undefined8*)( this + 0x6f0 ) = uVar13;
            CowData<RenderingDevice::Uniform>::resize<false>((CowData<RenderingDevice::Uniform>*)( this + 0xac8 ), 5);
            local_2d8 = 0;
            ...
            if (uVar14 < 0x10000) {
               ...
               *(undefined4*)( this + 0xb38 ) = 0x100;
               ...
               itos((long)&local_198);
               operator+((char *)&
               local_2b8,(String*)"#define MAX_LIGHTS ";
               String::operator +((String*)&local_2c8, (String*)&local_2b8);
               String::operator +=((String*)&local_2d8, (String*)&local_2c8);
               lVar15 = local_2c8;
               if (local_2c8 == 0) {
                  LAB_0010f549:lVar15 = CONCAT44(uStack_2b4, CONCAT13(uStack_2b5, CONCAT12(uStack_2b6, local_2b8)));
                  ...
                  *plVar25 = *plVar25 + -1;
                  ...
                  LAB_0010f57b:lVar15 = CONCAT44(uStack_284, local_288);
               }
 else {
                  LOCK();
                  ...
                  *plVar25 = *plVar25 + -1;
                  ...
                  LAB_0010f562:lVar15 = CONCAT44(uStack_194, CONCAT22(uStack_196, local_198));
            ...
            if (CONCAT44(uStack_284, local_288) == 0) {
               LAB_0010ce41:uVar14 = ( ulong ) * (uint*)( this + 0xb38 );
               if (uVar14 != 0) goto LAB_0010ce51;
               LAB_0010f77f:lVar15 = 0;
            }
 else {
               LOCK();
               ...
               *plVar25 = *plVar25 + -1;
               ...
               LAB_0010ce51:lVar15 = Memory::alloc_static(uVar14 << 7, true);
               if (lVar15 == 0) {
            ...
            *(long*)( this + 400 ) = lVar15;
            ...
            pSVar16 = (StrRange*)HashMap<StringName,String,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,String>>>::operator []((HashMap<StringName,String,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,String>>>*)&local_288, (StringName*)&local_2b8);
            uStack_190 = 6;
            uStack_18c = 0;
            local_198 = 0x8403;
            uStack_196 = 0x11;
            ...
            if (( StringName::configured != '\0' ) && ( CONCAT44(uStack_2b4, CONCAT13(uStack_2b5, CONCAT12(uStack_2b6, local_2b8))) != 0 )) {
               StringName::unref();
            }
            ...
            StringName::StringName((StringName*)&local_2b8, "COLOR", false);
            pSVar16 = (StrRange*)HashMap<StringName,String,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,String>>>::operator [](local_228, (StringName*)&local_2b8);
            uStack_190 = 0x13;
            uStack_18c = 0;
            local_198 = 0x87d6;
            uStack_196 = 0x11;
            ...
            pSVar16 = (StrRange*)HashMap<StringName,String,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,String>>>::operator [](local_258, (StringName*)&local_2b8);
            uStack_190 = 0x1c;
            uStack_18c = 0;
            local_198 = 0x8895;
            uStack_196 = 0x11;
            ...
            StringName::StringName((StringName*)&local_2b8, "TEXTURE", false);
            pSVar16 = (StrRange*)HashMap<StringName,String,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,String>>>::operator [](local_1f8, (StringName*)&local_2b8);
            local_198 = 0x890a;
            uStack_196 = 0x11;
            uStack_194 = 0;
            uStack_190 = 0xf;
            ...
            if (5 < *(uint*)( hash_table_size_primes + ( local_260 & 0xffffffff ) * 4 )) {
               do {
                  if (*(uint*)( hash_table_size_primes + ( local_260 & 0xffffffff ) * 4 ) <= *(uint*)( hash_table_size_primes + lVar15 * 4 )) {
 ...
 while ( lVar15 != 0x1d );
            ...
            LAB_0010e9c1:if (local_260._4_4_ != 0) {
               for (puVar2 = (undefined8*)CONCAT44(uStack_26c, uStack_270); puVar2 != (undefined8*)0x0; puVar2 = (undefined8*)*puVar2) {
                  HashMap<StringName,String,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,String>>>::insert((StringName*)&local_2b8, (String*)&local_198, (bool)( (char)puVar2 + '\x10' ));
               }
            ...
            if (5 < *(uint*)( hash_table_size_primes + ( local_230 & 0xffffffff ) * 4 )) {
               do {
                  if (*(uint*)( hash_table_size_primes + ( local_230 & 0xffffffff ) * 4 ) <= *(uint*)( hash_table_size_primes + uVar17 * 4 )) {
 ...
 while ( uVar17 != 0x1d );
            ...
            LAB_0010ea79:if (( local_230._4_4_ != 0 ) && ( (long*)local_240._0_8_ != (long*)0x0 )) {
               plVar25 = (long*)local_240._0_8_;
               do {
                  HashMap<StringName,String,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,String>>>::insert((StringName*)&local_2b8, (String*)&uStack_168, (bool)( (char)plVar25 + '\x10' ));
 ...
 while ( plVar25 != (long*)0x0 );
            ...
            if (5 < *(uint*)( hash_table_size_primes + ( local_200 & 0xffffffff ) * 4 )) {
               do {
                  if (*(uint*)( hash_table_size_primes + ( local_200 & 0xffffffff ) * 4 ) <= *(uint*)( hash_table_size_primes + uVar17 * 4 )) {
 ...
 while ( uVar17 != 0x1d );
            ...
            LAB_0010eb4b:if (( local_200._4_4_ != 0 ) && ( (long*)local_210._0_8_ != (long*)0x0 )) {
               plVar25 = (long*)local_210._0_8_;
               do {
                  HashMap<StringName,String,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,String>>>::insert((StringName*)&local_2b8, local_138, (bool)( (char)plVar25 + '\x10' ));
                  plVar25 = (long*)*plVar25;
               }
 while ( plVar25 != (long*)0x0 );
            }
            ...
            if (5 < *(uint*)( hash_table_size_primes + ( local_1d0 & 0xffffffff ) * 4 )) {
               do {
                  if (*(uint*)( hash_table_size_primes + ( local_1d0 & 0xffffffff ) * 4 ) <= *(uint*)( hash_table_size_primes + uVar17 * 4 )) {
 ...
 while ( uVar17 != 0x1d );
            ...
            LAB_0010ec23:if (( local_1d0._4_4_ != 0 ) && ( (long*)local_1e0._0_8_ != (long*)0x0 )) {
               plVar25 = (long*)local_1e0._0_8_;
               do {
                  HashMap<StringName,String,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,String>>>::insert((StringName*)&local_2b8, local_108, (bool)( (char)plVar25 + '\x10' ));
                  plVar25 = (long*)*plVar25;
               }
 while ( plVar25 != (long*)0x0 );
            }
            ...
            ShaderCompiler::DefaultIdentifierActions::~DefaultIdentifierActions((DefaultIdentifierActions*)&local_198);
            ShaderCompiler::DefaultIdentifierActions::~DefaultIdentifierActions((DefaultIdentifierActions*)&local_288);
            local_198 = 0x8948;
            uStack_196 = 0x11;
            uStack_194 = 0;
            local_2e0 = 0;
            ...
            *(undefined8*)( this + 0x9b8 ) = uVar13;
            ...
            iVar7 = CowData<RenderingDeviceCommons::VertexAttribute>::resize<false>((CowData<RenderingDeviceCommons::VertexAttribute>*)&local_2d0, 1);
            if (iVar7 == 0) {
               if (local_2d0 == (undefined8*)0x0) {
                  ...
                  lVar29 = lVar15 + -1;
                  if (-1 < lVar29) {
                     CowData<RenderingDeviceCommons::VertexAttribute>::_copy_on_write((CowData<RenderingDeviceCommons::VertexAttribute>*)&local_2d0);
                     uVar19 = _UNK_0012dbb8;
                     uVar13 = __LC299;
               ...
               _err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar29, lVar15, "p_index", "size()", "", false, false);
            }
 else {
               _err_print_error("push_back", "./core/templates/vector.h", 0x142, "Condition \"err\" is true. Returning: true", 0, 0);
            }

            LAB_0010f03d:pVVar18 = (Vector*)RenderingDevice::get_singleton();
            uVar13 = RenderingDevice::vertex_format_create(pVVar18);
            *(undefined8*)( this + 0x9a0 ) = uVar13;
            if (local_2d0 == (undefined8*)0x0) {
               lVar15 = 0;
               LAB_00110dc5:_err_print_index_error("operator[]", "./core/templates/vector.h", 0x38, 0, lVar15, "p_index", "((Vector<T> *)(this))->_cowdata.size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
               pcVar5 = (code*)invalidInstructionException();
               ( *pcVar5 )();
            ...
            *(undefined8*)( this + 0x978 ) = uVar13;
            ...
            uStack_168 = (undefined4)_UNK_0012dbd8;
            uStack_164 = ( undefined4 )((ulong)_UNK_0012dbd8 >> 0x20);
            ...
            uStack_158 = (undefined4)_UNK_0012dbe8;
            uStack_154 = ( undefined4 )((ulong)_UNK_0012dbe8 >> 0x20);
            uVar19 = RenderingDevice::get_singleton();
            local_2c0 = 0;
            local_288 = 0;
            uStack_284 = 0;
            ...
            if (*(long*)( this + 0x818 ) == 0) {
               lVar29 = 0;
               LAB_0010fe09:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, uVar17, lVar29, "p_variant", "variant_defines.size()", "", false, false);
            }
 else {
               ...
               if (( uVar14 == 0 ) || ( *(uint*)( this + 0x8d4 ) <= (uint)uVar14 )) {
                  LAB_00110f20:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
                  uVar20 = 0;
                  goto LAB_0010f389;
               }

               lVar29 = ( ( uVar14 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x8d0 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x8c0 ) + ( ( uVar14 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x8d0 ) ) * 8 );
               if (*(int*)( lVar29 + 0x98 ) != (int)( uVar14 >> 0x20 )) {
                  if (*(int*)( lVar29 + 0x98 ) + 0x80000000U < 0x7fffffff) {
                     _err_print_error("get_or_null", "./core/templates/rid_owner.h", 0x103, "Method/function failed. Returning: nullptr", "Attempting to use an uninitialized RID", 0, 0, lVar15);
                  }
 ...
 while ( lVar15 != 0 );
               ...
               if (*(long*)( lVar15 + uVar23 * 8 ) != 0) {
                  ...
                  LAB_0010f368:lVar15 = *(long*)( lVar29 + 0x88 );
                  if (lVar15 == 0) goto LAB_00110cb0;
                  lVar28 = *(long*)( lVar15 + -8 );
                  uVar23 = uVar17;
            ...
            LAB_0010fe43:uVar20 = 0;
            LAB_0010f389:uVar13 = RenderingDevice::render_pipeline_create(uVar19, uVar20, uVar13);
            *(undefined8*)( this + ( (long)(int)uVar17 + 0x130 ) * 8 ) = uVar13;
            ...
            do {
               ...
               if (*(long*)( this + 0x818 ) == 0) {
                  lVar29 = 0;
                  LAB_00110f4f:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 2, lVar29, "p_variant", "variant_defines.size()", "", false, false);
                  LAB_0010fc70:uVar27 = 0;
               }
 else {
                  lVar29 = *(long*)( *(long*)( this + 0x818 ) + -8 );
                  ...
                  if (( uVar17 == 0 ) || ( *(uint*)( this + 0x8d4 ) <= (uint)uVar17 )) {
                     LAB_001110c0:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
                     goto LAB_0010fc70;
                  }

                  lVar29 = ( ( uVar17 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x8d0 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x8c0 ) + ( ( uVar17 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x8d0 ) ) * 8 );
 ...
 while ( lVar15 != 0 );
               ...
               uVar13 = RenderingDevice::render_pipeline_create(uVar20, uVar27, uVar19, uVar13, ( -(iVar7 == 0) & 4U ) + 1, (StrRange*)&local_2b8, (StrRange*)&local_288, (String*)&local_198, &local_88, 0, 0, local_360);
 ...
 while ( true );
            ...
            if (*(long*)( this + 0x818 ) != 0) {
               ...
               if (pcVar3 == (char*)0x0) {
                  LAB_00110f90:lVar28 = 0;
                  LAB_00110f93:uVar23 = 0;
                  goto LAB_0010ff1b;
               }
               ...
               if (( uVar17 == 0 ) || ( *(uint*)( this + 0x8d4 ) <= (uint)uVar17 )) {
                  LAB_00111408:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
                  uVar19 = 0;
                  uVar23 = extraout_RDX_06;
                  goto LAB_0011006d;
               }

               lVar15 = ( ( uVar17 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x8d0 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x8c0 ) + ( ( uVar17 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x8d0 ) ) * 8 );
 ...
 while ( lVar29 != 0 );
               ...
               LAB_00110d50:lVar28 = 0;
               goto LAB_0010ff1b;
            }

            lVar15 = 0;
            LAB_00111224:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 0, lVar15, "p_variant", "variant_defines.size()", "", false, false);
            uVar23 = extraout_RDX_01;
            LAB_0011125d:uVar19 = 0;
            LAB_0011006d:RenderingDevice::shader_destroy_modules(uVar13, uVar19, uVar23);
            uVar13 = RenderingDevice::get_singleton();
            uVar17 = *(ulong*)( this + 0x978 );
            if (*(long*)( this + 0x818 ) == 0) {
               lVar15 = 0;
               LAB_0011126b:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 1, lVar15, "p_variant", "variant_defines.size()", "", false, false);
               uVar23 = extraout_RDX_02;
               LAB_001112a7:uVar19 = 0;
            }
 else {
               lVar15 = *(long*)( *(long*)( this + 0x818 ) + -8 );
               ...
               if (lVar15 == 0) {
                  LAB_0011114d:lVar28 = 0;
                  LAB_00111150:uVar23 = 1;
                  goto LAB_0010ff1b;
               }
               ...
               if (*(char*)( lVar15 + 1 ) != '\0') {
                  if (( uVar17 == 0 ) || ( *(uint*)( this + 0x8d4 ) <= (uint)uVar17 )) {
                     LAB_001114a1:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
                     uVar19 = 0;
 ...
 while ( lVar29 != 0 );
            ...
            LAB_0011019f:RenderingDevice::shader_destroy_modules(uVar13, uVar19, uVar23);
            uVar13 = RenderingDevice::get_singleton();
            uVar17 = *(ulong*)( this + 0x978 );
            if (*(long*)( this + 0x818 ) == 0) {
               lVar15 = 0;
               LAB_001112b3:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 2, lVar15, "p_variant", "variant_defines.size()", "", false, false);
               uVar23 = extraout_RDX_03;
               LAB_001112ef:uVar19 = 0;
            }
 else {
               lVar15 = *(long*)( *(long*)( this + 0x818 ) + -8 );
               ...
               lVar15 = *(long*)( this + 0x828 );
               if (lVar15 == 0) {
                  LAB_0010fef8:lVar28 = 0;
                  LAB_0010fefb:uVar23 = 2;
                  LAB_0010ff1b:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar23, lVar28, "p_index", "size()", "", false, true);
                  _err_flush_stdout();
                  /* WARNING: Does not return */
                  pcVar5 = (code*)invalidInstructionException();
                  ( *pcVar5 )();
               ...
               if (*(char*)( lVar15 + 2 ) != '\0') {
                  if (( uVar17 == 0 ) || ( *(uint*)( this + 0x8d4 ) <= (uint)uVar17 )) {
                     LAB_00111559:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
                     uVar19 = 0;
 ...
 while ( lVar29 != 0 );
            ...
            LAB_001102ce:RenderingDevice::shader_destroy_modules(uVar13, uVar19, uVar23);
            puVar2 = local_2d0;
            if (local_2d0 != (undefined8*)0x0) {
               LOCK();
               plVar25 = local_2d0 + -2;
            ...
            *(undefined8*)( this + 0xae8 ) = uVar13;
            ...
            uStack_190 = 0;
            uStack_18c = 0;
            uVar13 = RenderingDevice::uniform_buffer_create(uVar13, *(int*)( this + 0xb38 ) << 7, (String*)&local_198, 0);
            *(undefined8*)( this + 0xae0 ) = uVar13;
            ...
            uStack_190 = (uint)_UNK_0012dbf8;
            uStack_18c = ( undefined4 )((ulong)_UNK_0012dbf8 >> 0x20);
            ...
            *(undefined8*)( this + 0x1a0 ) = uVar13;
            ...
            uVar13 = RenderingDevice::get_singleton();
            for (int i = 0; i < 3; i++) {
               uVar13 = RenderingDevice::index_array_create(uVar13, *(undefined8*)( this + 408 ), 0, ( i + 1 ));
               *(undefined8*)( this + ( 8*i + 1840 ) ) = uVar13;
               uVar13 = RenderingDevice::get_singleton();
            }

            uVar20 = RenderingDevice::index_array_create(uVar13, *(undefined8*)( this + 0x198 ), 0, 6);
            uVar19 = _UNK_0012dae8;
            uVar13 = __LC124;
            uStack_168 = 0;
            uStack_164 = 0;
            *(undefined8*)( this + 0x748 ) = uVar20;
            ...
            uStack_180 = (undefined4)_UNK_0012daf8;
            uStack_17c = ( uint )((ulong)_UNK_0012daf8 >> 0x20);
            uStack_178 = 1;
            ...
            uStack_280 = (undefined4)_UNK_0012db08;
            uStack_27c = ( undefined4 )((ulong)_UNK_0012db08 >> 0x20);
            ...
            *(undefined8*)( this + 0xaf8 ) = uVar13;
            ...
            uStack_178 = 0;
            uStack_174 = 0;
            Vector<RenderingDevice::Uniform>::push_back((Vector<RenderingDevice::Uniform>*)&local_288, (String*)&local_198);
            uVar13 = RenderingDevice::get_singleton();
            uVar13 = RenderingDevice::uniform_set_create<Vector<RenderingDevice::Uniform>>(uVar13, (StrRange*)&local_288, *(undefined8*)( this + 400 ), 2, 0);
            ...
            *(undefined8*)( this + 0x200b90 ) = uVar13;
            ...
            RendererRD::TextureStorage::canvas_texture_get_info(&local_88, uVar13, *(undefined8*)( this + 0x200b90 ), *(undefined4*)( this + 0x200bb8 ), *(undefined4*)( this + 0x200bbc ), 0, 0);
            ...
            *(undefined8*)( this + 0x200ba0 ) = uVar13;
            ...
            ( **(code**)( *plVar12 + 0xe8 ) )(plVar12, *(undefined8*)( this + 0x200ba0 ), *(undefined8*)( this + 0x200b98 ));
            ...
            *(undefined8*)( this + 0x200ba8 ) = uVar13;
            ( **(code**)( *plVar12 + 0xd0 ) )(plVar12, uVar13);
            ( **(code**)( *plVar12 + 0xe8 ) )(plVar12, *(undefined8*)( this + 0x200ba8 ), *(undefined8*)( this + 0x200bb0 ));
            ProjectSettings::get_singleton();
            StringName::StringName((StringName*)&local_198, "rendering/2d/batching/uniform_set_cache_size", false);
            ProjectSettings::get_setting_with_override((StringName*)local_a8);
            ...
            if (( *(long*)( this + 0x9f8 ) != 0 ) && ( *(ulong*)( this + 0x9f8 ) = (ulong)uVar8 ),(ulong)uVar8 < ( ulong ) * (uint*)( this + 0x9f4 )) {
               do {
 ...
 while ( *(ulong*)( this + 0x9f8 ) < ( ulong ) * (uint*)( this + 0x9f4 ) );
            ...
            *(int*)( this + 0xabc ) = *(int*)( this + 0xab8 ) << 7;
            ...
            do {
               ...
               uStack_190 = 0;
               uStack_18c = 0;
               uVar13 = RenderingDevice::storage_buffer_create(uVar13, *(undefined4*)( this + 0xabc ), (String*)&local_198, 0, 0);
               uVar8 = *(uint*)pRVar24;
 ...
 while ( this + 0xa90 != pRVar24 );
            ...
            lVar15 = 0;
            LAB_00110c7c:*(long*)( this + 0xab0 ) = lVar15;
            if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
               /* WARNING: Subroutine does not return */
               __stack_chk_fail();
            }
         ...
         void RendererCanvasRenderRD::_uniform_set_invalidation_callback(void *param_1) {
            HashMap<RendererCanvasRenderRD::RIDSetKey,List<LRUCache<RendererCanvasRenderRD::RIDSetKey,RID,HashableHasher<RendererCanvasRenderRD::RIDSetKey>,HashMapComparatorDefault < RendererCanvasRenderRD::RIDSetKey>,&RendererCanvasRenderRD::_before_evict>::Pair,DefaultAllocator>::Element *;
            long *plVar1;
            long lVar2;
            long lVar3;
            void *pvVar4;
            ...
            if (cVar6 != '\0') {
               ...
               if (plVar1 == *(long**)( lVar7 + 0x30 )) {
                  ...
                  _err_print_error("move_to_front", "./core/templates/list.h", 0x25d, "Condition \"p_I->data != _data\" is true.", 0, 0);
               }

               HashMap<RendererCanvasRenderRD::RIDSetKey,List<LRUCache<RendererCanvasRenderRD::RIDSetKey,RID,HashableHasher<RendererCanvasRenderRD::RIDSetKey>,HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,&RendererCanvasRenderRD::_before_evict>::Pair,DefaultAllocator>::Element*,HashableHasher<RendererCanvasRenderRD::RIDSetKey>,HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,DefaultTypedAllocator<HashMapElement<RendererCanvasRenderRD::RIDSetKey,List<LRUCache<RendererCanvasRenderRD::RIDSetKey,RID,HashableHasher < RendererCanvasRenderRD::RIDSetKey>,HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,&RendererCanvasRenderRD::_before_evict>::Pair,DefaultAllocator>::Element*>> > ::erase(this, (RIDSetKey*)param_1);
               plVar1 = *(long**)( lVar5 + 0x9c0 );
         ...
         void RendererCanvasRenderRD::CanvasShaderData::set_code(CanvasShaderData *this, String *param_1) {
            pthread_mutex_t *__mutex;
            uint uVar1;
            undefined8 *puVar2;
 ...
 while ( this + 0x1f8 != pCVar6 );
            if (( *(long*)( this + 0xa0 ) == 0 ) || ( *(uint*)( *(long*)( this + 0xa0 ) + -8 ) < 2 )) goto LAB_001119c1;
            local_4c = 0;
            *(undefined4*)( this + 0x80 ) = 0;
            local_58 = uVar4;
            local_1b0 = uVar4;
            ...
            *plVar8 = (long)( this + 0x1fb );
            ...
            iVar5 = pthread_mutex_lock(__mutex);
            if (iVar5 != 0) {
               LAB_00112431:/* WARNING: Subroutine does not return */std::__throw_system_error(iVar5);
            }

            iVar5 = ShaderCompiler::compile(lVar12 + 0x1a8, 1, (CowData<char32_t>*)( this + 0xa0 ), local_1d8, this + 8, local_d8);
            if (iVar5 == 0) {
               *(ushort*)( this + 0x1f8 ) = CONCAT11(local_50._3_1_, (undefined1)local_4c);
               ...
               for (puVar2 = *(undefined8**)( this + 0x158 ); puVar2 != (undefined8*)0x0; puVar2 = (undefined8*)*puVar2) {
                  WorkerThreadPool::wait_for_task_completion(WorkerThreadPool::singleton);
               }

               pthread_mutex_unlock((pthread_mutex_t*)( this + 0x170 ));
               PipelineHashMapRD<RendererCanvasRenderRD::PipelineKey,RendererCanvasRenderRD::CanvasShaderData,void(RendererCanvasRenderRD::CanvasShaderData::*)(RendererCanvasRenderRD::PipelineKey)>::_add_new_pipelines_to_map((PipelineHashMapRD<RendererCanvasRenderRD::PipelineKey,RendererCanvasRenderRD::CanvasShaderData,void(RendererCanvasRenderRD::CanvasShaderData::*)(RendererCanvasRenderRD::PipelineKey)>*)( this + 0xb0 ));
               if (*(long*)( this + 0xd8 ) != 0) {
 ...
 while ( lVar14 != 0 );
               ...
               RBMap<unsigned_int,RID,Comparator<unsigned_int>,DefaultAllocator>::clear((RBMap<unsigned_int,RID,Comparator<unsigned_int>,DefaultAllocator>*)( this + 0xd8 ));
               RBSet<unsigned_int,Comparator<unsigned_int>,DefaultAllocator>::clear((RBSet<unsigned_int,Comparator<unsigned_int>,DefaultAllocator>*)( this + 0x128 ));
               if (*(long*)( this + 0xa8 ) == 0) {
               ...
               plVar8 = &local_80;
               ShaderRD::version_set_code(lVar12 + 0x18, *(undefined8*)( this + 0xa8 ), plVar8, local_a0, local_a0 + 8, local_90, local_d8);
 ...
 while ( !bVar15 );
               ...
               LAB_001121cf:if (( *(long*)( this + 0x78 ) != local_c0[0] ) && ( CowData<ShaderCompiler::GeneratedCode::Texture>::_unref((CowData<ShaderCompiler::GeneratedCode::Texture>*)( this + 0x78 )),local_c0[0] != 0 )) {
 ...
 while ( !bVar15 );
               ...
               LAB_0011221c:pthread_mutex_unlock(__mutex);
 ...
 while ( plVar8 != (long*)( local_a0 + 8 ) );
               ...
               _err_print_error("set_code", "servers/rendering/renderer_rd/renderer_canvas_render_rd.cpp", 0x629, "Method/function failed.", "Shader compilation failed.", 0, 0);
               pthread_mutex_unlock(__mutex);
               ShaderCompiler::IdentifierActions::~IdentifierActions((IdentifierActions*)local_1d8);
               if ((void*)local_78._0_8_ != (void*)0x0) {
                  pvVar13 = (void*)local_78._0_8_;
 ...
 while ( lVar12 != (ulong)uVar1 * 4 );
               ...
               LAB_00111f60:plVar8 = (long*)( local_90 + 8 );
               do {
                  if (*plVar8 != 0) {
                     LOCK();
 ...
 while ( plVar8 != (long*)local_a0 );
            ...
            LAB_001119c1:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
               return;
            }
         ...
         void RendererCanvasRenderRD::CanvasShaderData::~CanvasShaderData(CanvasShaderData *this) {
            long *plVar1;
            pthread_mutex_t *__mutex;
            ...
            *(undefined***)this = &PTR_set_path_hint_001242a8;
            iVar4 = pthread_mutex_lock(__mutex);
            if (iVar4 == 0) {
               for (puVar3 = *(undefined8**)( this + 0x158 ); puVar3 != (undefined8*)0x0; puVar3 = (undefined8*)*puVar3) {
                  WorkerThreadPool::wait_for_task_completion(WorkerThreadPool::singleton);
               }
 ...
 while ( lVar7 != (ulong)uVar2 << 2 );
                  ...
                  LAB_0011267f:RBSet<unsigned_int,Comparator<unsigned_int>,DefaultAllocator>::clear(this_01);
                  ...
                  CowData<ShaderCompiler::GeneratedCode::Texture>::_unref((CowData<ShaderCompiler::GeneratedCode::Texture>*)( this + 0x78 ));
            ...
            LAB_00112801:/* WARNING: Subroutine does not return */std::__throw_system_error(iVar4);
         }
   ...
   int, RID*) [clone .isra.0] */
         long RendererCanvasRenderRD::_get_pipeline_specialization_or_ubershader(CanvasShaderData *param_1, int *param_2, long param_3, ulong param_4, ulong param_5, uint param_6, long *param_7) {
            char *pcVar1;
            PipelineHashMapRD<RendererCanvasRenderRD::PipelineKey,RendererCanvasRenderRD::CanvasShaderData,void(RendererCanvasRenderRD::CanvasShaderData::*)(RendererCanvasRenderRD::PipelineKey)> *this;
            int *piVar2;
            undefined1 auVar3[16];
...
;
 ...
 while ( plVar21 != plVar26 + (ulong)uVar16 * 5 );
                     ...
                     *(long*)( param_5 + 0x78 ) = lVar27;
                     RendererRD::MeshStorage::_mesh_surface_generate_version_for_input_mask(pVVar19, (Surface*)( lVar27 + lVar29 ), param_5, SUB81(lVar20, 0), (Surface*)0x0, 0, 0);
                     ...
                     *(undefined1*)( param_5 + 0x34 ) = 0;
                     ...
                     if ((uint)param_4 < *(uint*)( pVVar19 + 0x124 )) {
                        plVar26 = (long*)( ( ( param_4 & 0xffffffff ) % ( ulong ) * (uint*)( pVVar19 + 0x120 ) ) * 0xb0 + *(long*)( *(long*)( pVVar19 + 0x110 ) + ( ( param_4 & 0xffffffff ) / ( ulong ) * (uint*)( pVVar19 + 0x120 ) ) * 8 ) );
                        if ((int)plVar26[0x15] == (int)( param_4 >> 0x20 )) {
                           uVar24 = ( ulong ) * (uint*)( *plVar26 + 0x10 );
                           if (uVar18 < uVar24) {
                              if (*(uint*)( plVar26 + 2 ) <= param_6) {
                                 _err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, uVar18, ( ulong ) * (uint*)( plVar26 + 2 ), "p_index", "count", "", false, true);
                                 _err_flush_stdout();
                                 /* WARNING: Does not return */
...
;
                              ...
                              if (uVar13 == 0) {
                                 ...
                                 plVar21 = plVar26;
                                 do {
                                    if (( ( ( lVar20 == *plVar21 ) && ( (char)plVar21[2] == '\0' ) ) && ( uVar16 == *(uint*)( plVar21 + 1 ) ) ) && ( uVar16 == *(uint*)( (long)plVar21 + 0xc ) )) {
                                       *(long*)( param_2 + 4 ) = plVar21[3];
                                       *param_7 = plVar21[4];
 ...
 while ( plVar26 + (ulong)uVar13 * 5 != plVar21 );
                              ...
                              *(long*)( lVar29 + 0x30 ) = lVar22;
                              RendererRD::MeshStorage::_mesh_surface_generate_version_for_input_mask(pVVar19, (Surface*)( lVar22 + lVar27 ), uVar24, SUB81(lVar20, 0), (Surface*)0x0, (uint)lVar29, uVar16);
                              ...
                              *(undefined1*)( uVar24 + 0x34 ) = 0;
                              ...
                              _err_print_index_error("mesh_instance_surface_get_vertex_arrays_and_format", "./servers/rendering/renderer_rd/storage_rd/mesh_storage.h", 0x213, uVar18, uVar24, "p_surface_index", "mesh->surface_count", "", false, false);
                           }
                     ...
                     _err_print_error("mesh_instance_surface_get_vertex_arrays_and_format", "./servers/rendering/renderer_rd/storage_rd/mesh_storage.h", 0x211);
                  }

               }

               LAB_00112a50:iVar17 = param_2[9];
               if (iVar17 == 0) {
                  iVar14 = param_2[7];
               ...
               uVar13 = ( *param_2 * 0x16a88000 | ( uint )(*param_2 * -0x3361d2af) >> 0x11 ) * 0x1b873593 ^ 0x7f07c65;
               uVar13 = ( uVar13 << 0xd | uVar13 >> 0x13 ) * 5 + 0xe6546b64 ^ ( param_2[2] * 0x16a88000 | ( uint )(param_2[2] * -0x3361d2af) >> 0x11 ) * 0x1b873593;
               iVar14 = (int)*(undefined8*)( param_2 + 4 );
               iVar15 = (int)( ( ulong ) * (undefined8*)( param_2 + 4 ) >> 0x20 );
               uVar13 = ( uVar13 << 0xd | uVar13 >> 0x13 ) * 5 + 0xe6546b64 ^ ( iVar14 * 0x16a88000 | ( uint )(iVar14 * -0x3361d2af) >> 0x11 ) * 0x1b873593;
               uVar13 = ( iVar15 * 0x16a88000 | ( uint )(iVar15 * -0x3361d2af) >> 0x11 ) * 0x1b873593 ^ ( uVar13 << 0xd | uVar13 >> 0x13 ) * 5 + 0xe6546b64;
               uVar13 = ( uVar13 << 0xd | uVar13 >> 0x13 ) * 5 + 0xe6546b64 ^ ( param_2[6] * 0x16a88000 | ( uint )(param_2[6] * -0x3361d2af) >> 0x11 ) * 0x1b873593;
               uVar16 = ( uVar13 << 0xd | uVar13 >> 0x13 ) * 5 + 0xe6546b64 ^ uVar16;
               uVar16 = ( uVar16 << 0xd | uVar16 >> 0x13 ) * 5 + 0xe6546b64 ^ ( param_2[8] * 0x16a88000 | ( uint )(param_2[8] * -0x3361d2af) >> 0x11 ) * 0x1b873593;
               uVar16 = ( iVar17 * 0x16a88000 | ( uint )(iVar17 * -0x3361d2af) >> 0x11 ) * 0x1b873593 ^ ( uVar16 << 0xd | uVar16 >> 0x13 ) * 5 + 0xe6546b64;
               ...
               if (*(long*)( param_1 + 0xd8 ) != 0) {
                  for (lVar20 = *(long*)( *(long*)( param_1 + 0xd8 ) + 0x10 ); *(long*)( param_1 + 0xe0 ) != lVar20; lVar20 = *(long*)( lVar20 + 0x10 )) {
...
;
               ...
               LAB_00112bc1:this(PipelineHashMapRD<RendererCanvasRenderRD::PipelineKey,RendererCanvasRenderRD::CanvasShaderData,void(RendererCanvasRenderRD::CanvasShaderData::*)(RendererCanvasRenderRD::PipelineKey)> * )(param_1 + 0xb0);
               cVar12 = PipelineHashMapRD<RendererCanvasRenderRD::PipelineKey,RendererCanvasRenderRD::CanvasShaderData,void(RendererCanvasRenderRD::CanvasShaderData::*)(RendererCanvasRenderRD::PipelineKey)>::_add_new_pipelines_to_map(this);
               if (( cVar12 != '\0' ) && ( lVar20 = lVar20 != 0 )) {
...
;
               ...
               LAB_00112bd8:PipelineHashMapRD<RendererCanvasRenderRD::PipelineKey,RendererCanvasRenderRD::CanvasShaderData,void(RendererCanvasRenderRD::CanvasShaderData::*)(RendererCanvasRenderRD::PipelineKey)>::compile_pipeline(this, param_2, uVar13, 0);
               ...
               if (*(long*)( param_1 + 0x128 ) != 0) {
                  for (lVar20 = *(long*)( *(long*)( param_1 + 0x128 ) + 0x10 ); *(long*)( param_1 + 0x130 ) != lVar20; lVar20 = *(long*)( lVar20 + 0x10 )) {
                     while (*(uint*)( lVar20 + 0x30 ) <= uVar13) {
                        if (uVar13 <= *(uint*)( lVar20 + 0x30 )) {
                           ...
                           uVar31 = CONCAT44(0, *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( param_1 + 0x168 ) * 4 ));
                           auVar3._8_8_ = 0;
                           auVar3._0_8_ = uVar31;
                           auVar7._8_8_ = 0;
                           auVar7._0_8_ = uVar28;
...
;
               ...
               LAB_00112c51:pthread_mutex_unlock((pthread_mutex_t*)( param_1 + 0x170 ));
               PipelineHashMapRD<RendererCanvasRenderRD::PipelineKey,RendererCanvasRenderRD::CanvasShaderData,void(RendererCanvasRenderRD::CanvasShaderData::*)(RendererCanvasRenderRD::PipelineKey)>::_add_new_pipelines_to_map(this);
...
;
               ...
               LAB_00112c9d:puVar23 = (undefined8*)RBMap<unsigned_int,RID,Comparator<unsigned_int>,DefaultAllocator>::operator []((RBMap<unsigned_int,RID,Comparator<unsigned_int>,DefaultAllocator>*)( param_1 + 0xd8 ), &local_44);
               *puVar23 = 0;
               piVar2 = param_2 + 9;
               *piVar2 = *piVar2 + 1;
            }
 while ( *piVar2 == 0 );
            lVar20 = 0;
            goto LAB_00112cc3;
            LAB_00112fd1:if (( uVar16 == uVar32 ) && ( uVar13 == *(uint*)( *(long*)( lVar20 + lVar29 * 8 ) + 0x10 ) )) {
               lVar20 = *(long*)( lVar20 + (ulong)uVar25 * 8 );
               if (lVar20 != 0) {
                  WorkerThreadPool::wait_for_task_completion(WorkerThreadPool::singleton);
                  HashMap<unsigned_int,long,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,long>>>::erase((HashMap<unsigned_int,long,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,long>>>*)( param_1 + 0x140 ), (uint*)( lVar20 + 0x10 ));
               }
            ...
            if (( uVar16 == 0 ) || ( auVar5._8_8_ = 0 ),auVar5._0_8_ = uVar16 * uVar24,auVar9._8_8_ = 0,auVar9._0_8_ = uVar31,auVar6._8_8_ = 0,auVar6._0_8_ = ( ( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( param_1 + 0x168 ) * 4 ) + uVar25 ) - SUB164(auVar5 * auVar9, 8) ) * uVar24,auVar10._8_8_ = 0,auVar10._0_8_ = uVar31,SUB164(auVar6 * auVar10, 8) < uVar30) goto LAB_00112c51;
            goto LAB_00112fd1;
            LAB_00112d10:lVar20 = *(long*)( lVar20 + 0x38 );
            if (lVar20 != 0) goto LAB_00112cc3;
            piVar2 = param_2 + 9;
            *piVar2 = *piVar2 + 1;
            if (*piVar2 != 0) {
               lVar20 = 0;
               LAB_00112cc3:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
                  /* WARNING: Subroutine does not return */
                  __stack_chk_fail();
               }
    ...
    */
         void RendererCanvasRenderRD::_render_batch(RendererCanvasRenderRD *this, long param_1, CanvasShaderData *param_2, long param_3, Light *param_4, Batch *param_5, RenderInfo *param_6) {
            HashMap<RendererCanvasRenderRD::RIDSetKey,List<LRUCache<RendererCanvasRenderRD::RIDSetKey,RID,HashableHasher<RendererCanvasRenderRD::RIDSetKey>,HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,&RendererCanvasRenderRD::_before_evict>::Pair,DefaultAllocator>::Element*,HashableHasher<RendererCanvasRenderRD::RIDSetKey>,HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,DefaultTypedAllocator<HashMapElement<RendererCanvasRenderRD::RIDSetKey,List<LRUCache<RendererCanvasRenderRD::RIDSetKey,RID,HashableHasher < RendererCanvasRenderRD::RIDSetKey>,HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,&RendererCanvasRenderRD::_before_evict>::Pair,DefaultAllocator>::Element*>> > *this_00;
            pthread_mutex_t *__mutex;
            int iVar1;
            int iVar2;
            ...
            if (uVar26 <= *(uint*)( param_5 + 8 )) {
               LAB_00113f98:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, uVar34, (ulong)uVar26, "p_index", "count", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
            ...
            if (cVar24 == '\0') {
               ...
               *(undefined1*)( puVar38 + 0x10 ) = 0;
               ...
               uVar30 = *(undefined8*)( *(long*)( this + ( ulong ) * (uint*)( this + 0xaa0 ) * 0x10 + 0xa68 ) + (ulong)uVar27 * 8 );
               *(undefined1*)( puVar38 + 0x15 ) = 0;
               ...
               lVar36 = RenderingDevice::uniform_set_create<Vector<RenderingDevice::Uniform>>(uVar29, this + 0xac0, *(undefined8*)( this + 400 ), 3);
               if (lVar36 == 0) {
                  if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
                     _err_print_error("_render_batch", "servers/rendering/renderer_rd/renderer_canvas_render_rd.cpp", 0xbbe, "Condition \"rid.is_null()\" is true.", "Failed to create uniform set for batch.", 0);
                     return;
                  }
               ...
               *(int*)( plVar4 + 2 ) = (int)plVar4[2] + 1;
               ...
               if (plVar31 != (long*)0x0) {
                  lVar35 = *plVar31;
                  uVar29 = RenderingDevice::get_singleton();
                  RenderingDevice::uniform_set_set_invalidation_callback(uVar29, *(undefined8*)( lVar35 + 0x18 ), 0, 0);
                  uVar29 = RenderingDevice::get_singleton();
                  ...
                  HashMap<RendererCanvasRenderRD::RIDSetKey,List<LRUCache<RendererCanvasRenderRD::RIDSetKey,RID,HashableHasher<RendererCanvasRenderRD::RIDSetKey>,HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,&RendererCanvasRenderRD::_before_evict>::Pair,DefaultAllocator>::Element*,HashableHasher<RendererCanvasRenderRD::RIDSetKey>,HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,DefaultTypedAllocator<HashMapElement<RendererCanvasRenderRD::RIDSetKey,List<LRUCache<RendererCanvasRenderRD::RIDSetKey,RID,HashableHasher < RendererCanvasRenderRD::RIDSetKey>,HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,&RendererCanvasRenderRD::_before_evict>::Pair,DefaultAllocator>::Element*>> > ::erase(this_00, (RIDSetKey*)&local_88);
               ...
               *plVar31 = (long)pLVar49;
               while (*(ulong*)( this + 0x9f8 ) < ( ulong ) * (uint*)( this + 0x9f4 )) {
                  ...
                  uVar29 = RenderingDevice::get_singleton();
                  RenderingDevice::uniform_set_set_invalidation_callback(uVar29, *(undefined8*)( pRVar50 + 0x18 ), 0, 0);
                  uVar29 = RenderingDevice::get_singleton();
                  RenderingDevice::free(uVar29, *(undefined8*)( pRVar50 + 0x18 ));
                  HashMap<RendererCanvasRenderRD::RIDSetKey,List<LRUCache<RendererCanvasRenderRD::RIDSetKey,RID,HashableHasher<RendererCanvasRenderRD::RIDSetKey>,HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,&RendererCanvasRenderRD::_before_evict>::Pair,DefaultAllocator>::Element*,HashableHasher<RendererCanvasRenderRD::RIDSetKey>,HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,DefaultTypedAllocator<HashMapElement<RendererCanvasRenderRD::RIDSetKey,List<LRUCache<RendererCanvasRenderRD::RIDSetKey,RID,HashableHasher < RendererCanvasRenderRD::RIDSetKey>,HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,&RendererCanvasRenderRD::_before_evict>::Pair,DefaultAllocator>::Element*>> > ::erase(this_00, pRVar50);
...
;
               ...
               RenderingDevice::uniform_set_set_invalidation_callback(uVar29, lVar36, _uniform_set_invalidation_callback);
               ...
               if (( ( (uint)uVar34 < *(uint*)( lVar28 + 0xcc ) ) && ( pcVar41 = (char*)( ulong ) * (uint*)( lVar28 + 200 ) ),uVar34 >> 0x20 != 0x7fffffff )) {
                  pthread_mutex_unlock(__mutex);
                  plVar31 = *(long**)( param_5 + 0x10 );
                  lVar35 = *(long*)( this + 0xa08 );
                  if (( lVar35 != 0 ) && ( *(int*)( this + 0xa2c ) != 0 )) {
                     pBVar47 = (Batch*)CONCAT44(0, *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0xa28 ) * 4 ));
                     ...
                     if (uVar27 != 0) {
                        uVar27 = 0;
                        while (( (uint)uVar34 != uVar26 || ( *plVar31 != *(long*)( *(long*)( lVar35 + lVar44 * 8 ) + 0x10 ) ) )) {
                           uVar27 = uVar27 + 1;
                           auVar12._8_8_ = 0;
                           ...
                           if (( uVar3 == 0 ) || ( auVar13._8_8_ = 0 ),auVar13._0_8_ = uVar34 * lVar43,auVar21._8_8_ = 0,auVar21._0_8_ = pBVar47,auVar14._8_8_ = 0,auVar14._0_8_ = ( ulong )(( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0xa28 ) * 4 ) + uVar45 ) - SUB164(auVar13 * auVar21, 8)) * lVar43,auVar22._8_8_ = 0,auVar22._0_8_ = pBVar47,SUB164(auVar14 * auVar22, 8) < uVar27) goto LAB_00114714;
                        }
;
                        ...
                        if (lVar35 != 0) {
                           ...
                           if (uVar26 == *(uint*)( lVar35 + 0x1c )) {
                              ...
                              *(void**)( lVar35 + 0x20 ) = pvVar39;
                              if (pvVar39 == (void*)0x0) {
                                 _err_print_error("push_back", "./core/templates/local_vector.h", 0x41, "FATAL: Condition \"!data\" is true.", "Out of memory", 0, 0, lVar28);
                                 _err_flush_stdout();
                                 /* WARNING: Does not return */
                                 pcVar23 = (code*)invalidInstructionException();
                                 ( *pcVar23 )();
                  ...
                  LAB_00114714:local_b8[1] = 1;
                  uVar29 = *(undefined8*)( pLVar33 + 0x18 );
                  puVar38 = (undefined8*)Memory::realloc_static((void*)0x0, 8, false);
                  puStack_b0 = puVar38;
                  if (puVar38 == (undefined8*)0x0) {
                     _err_print_error("reserve", "./core/templates/local_vector.h", 0x92, "FATAL: Condition \"!data\" is true.", "Out of memory", 0, 0, param_3);
                     _err_flush_stdout();
                     /* WARNING: Does not return */
                     pcVar23 = (code*)invalidInstructionException();
                     ( *pcVar23 )();
                  ...
                  *puVar38 = uVar29;
                  local_b8[0] = 1;
                  HashMap<RID,LocalVector<RID,unsigned_int,false,true>,HashMapHasherDefault,HashMapComparatorDefault<RID>,DefaultTypedAllocator<HashMapElement<RID,LocalVector<RID,unsigned_int,false,true>>>>::insert((RID*)&local_c8, (LocalVector*)( this + 0xa00 ), SUB81(uVar30, 0));
                  Memory::free_static(puVar38, false);
                  plVar31 = *(long**)( param_5 + 0x10 );
                  LAB_00114557:pcVar41 = (char*)( local_c8 + 0x10 );
                  RendererRD::TextureStorage::canvas_texture_set_invalidation_callback(lVar28, *plVar31, _canvas_texture_invalidation_callback);
               }
 else {
                  pthread_mutex_unlock(__mutex);
               }
               ...
               if (plVar31 == *(long**)( lVar36 + 0x30 )) {
                  ...
                  _err_print_error("move_to_front", "./core/templates/list.h", 0x25d, "Condition \"p_I->data != _data\" is true.", 0);
                  lVar36 = *(long*)( lVar28 + 0x28 );
               }
            ...
            local_d0 = CONCAT44(*(uint*)( *(long*)( param_5 + 0x10 ) + 0x3c ) | *(uint*)( param_5 + 0x60 ), *(undefined4*)( *(long*)( param_5 + 0x10 ) + 0x38 ));
            ...
            if (uVar26 == 3) {
               ...
               if (lVar28 == 0) {
                  _err_print_error("_render_batch", "servers/rendering/renderer_rd/renderer_canvas_render_rd.cpp", 0xc13, "Parameter \"p_batch->command\" is null.", 0, 0);
               }
 else {
                  ...
                  RenderingDevice::draw_list_bind_index_array(uVar29, param_1, *(undefined8*)( this + ( ulong )(uVar26 - 1) * 8 + 0x730 ));
                  uVar26 = *(uint*)( param_5 + 4 );
                  lVar28 = RenderingDevice::get_singleton();
                  RenderingDevice::draw_list_draw(lVar28, bVar46, 1, uVar26);
                  uVar30 = _UNK_0012dc08;
                  uVar29 = __LC341;
                  if (param_6 != (RenderInfo*)0x0) {
                     ...
                     *(ulong*)( param_6 + 0x18 ) = CONCAT44(( ( uVar27 - *(int*)( _indices_to_primitives(RenderingServer::PrimitiveType,unsigned_int) ) ) / *(uint*)( _indices_to_primitives(RenderingServer::PrimitiveType,unsigned_int) ) ) * uVar26 + (int)( ( ulong ) * (undefined8*)( param_6 + 0x18 ) >> 0x20 ), uVar26 + (int)*(undefined8*)( param_6 + 0x18 ));
                  }
               ...
               if (uVar26 == 2) {
                  lVar28 = *(long*)( param_5 + 0x40 );
                  if (lVar28 == 0) {
                     _err_print_error("_render_batch", "servers/rendering/renderer_rd/renderer_canvas_render_rd.cpp", 0xbf9, "Parameter \"p_batch->command\" is null.", 0, 0);
                  }
 else {
                     ...
                     if (( lVar36 != 0 ) && ( *(int*)( this + 0x724 ) != 0 )) {
                        ...
                        if (uVar26 != 0) {
                           uVar45 = 0;
                           do {
                              if (( uVar26 == (uint)uVar48 ) && ( *(long*)( lVar28 + 0x18 ) == *(long*)( *(long*)( lVar36 + lVar43 * 8 ) + 0x10 ) )) {
                                 ...
                                 uVar29 = RenderingDevice::get_singleton();
                                 RenderingDevice::draw_list_bind_vertex_array(uVar29, param_1, *(undefined8*)( lVar36 + 0x28 ));
                                 if (*(long*)( lVar36 + 0x38 ) != 0) {
                                    uVar29 = RenderingDevice::get_singleton();
                                    RenderingDevice::draw_list_bind_index_array(uVar29, param_1, *(undefined8*)( lVar36 + 0x38 ));
                                 }

                                 lVar35 = RenderingDevice::get_singleton();
                                 RenderingDevice::draw_list_draw(lVar35, bVar46, ( uint )(*(long*)( lVar36 + 0x38 ) != 0), 1);
                                 if (param_6 != (RenderInfo*)0x0) {
                                    ...
                                    *(int*)( param_6 + 0x20 ) = *(int*)( param_6 + 0x20 ) + 1;
                                    *(uint*)( param_6 + 0x1c ) = *(int*)( param_6 + 0x1c ) + ( uint )(iVar1 - iVar2) / *(uint*)( _indices_to_primitives(RenderingServer::PrimitiveType,unsigned_int) );
                                 }
 ...
 while ( ( uVar26 != 0 ) && ( auVar9._8_8_ = 0 ),auVar9._0_8_ = (ulong)uVar26 * lVar35,auVar17._8_8_ = 0,auVar17._0_8_ = uVar51,auVar10._8_8_ = 0,auVar10._0_8_ = ( ulong )(( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x720 ) * 4 ) + uVar27 ) - SUB164(auVar9 * auVar17, 8)) * lVar35,auVar18._8_8_ = 0,auVar18._0_8_ = uVar51,uVar45 <= SUB164(auVar10 * auVar18, 8) );
                        }

                     }

                     _err_print_error("_render_batch", "servers/rendering/renderer_rd/renderer_canvas_render_rd.cpp", 0xbfe, "Parameter \"pb\" is null.", 0, 0);
                  }
                  ...
                  if (param_6 != (RenderInfo*)0x0) {
                     ...
                     *(int*)( param_6 + 0x20 ) = *(int*)( param_6 + 0x20 ) + 1;
                     *(ulong*)( param_6 + 0x18 ) = CONCAT44(iVar25 * 2 + (int)( ( ulong ) * (undefined8*)( param_6 + 0x18 ) >> 0x20 ), iVar25 + (int)*(undefined8*)( param_6 + 0x18 ));
                  }
               ...
               if (*(long*)( param_5 + 0x40 ) == 0) {
                  _err_print_error("_render_batch", "servers/rendering/renderer_rd/renderer_canvas_render_rd.cpp", 0xc2a, "Parameter \"p_batch->command\" is null.", 0, 0);
               }
 else {
                  ...
                  if (iVar25 == 4) {
                     ...
                     if (iVar25 != 5) {
                        ...
                        if (( uVar51 == 0 ) || ( *(uint*)( pPVar32 + 0x91c ) <= (uint)uVar51 )) {
                           LAB_001149ec:pBVar47 = (Batch*)0x0;
                           _err_print_error("particles_get_mode", "./servers/rendering/renderer_rd/storage_rd/particles_storage.h", 0x1ee, "Parameter \"particles\" is null.", 0);
                        }
 else {
                           piVar42 = (int*)( ( ( uVar51 & 0xffffffff ) % ( ulong ) * (uint*)( pPVar32 + 0x918 ) ) * 0x2f8 + *(long*)( *(long*)( pPVar32 + 0x908 ) + ( ( uVar51 & 0xffffffff ) / ( ulong ) * (uint*)( pPVar32 + 0x918 ) ) * 8 ) );
                           if (piVar42[0xbc] != (int)( uVar51 >> 0x20 )) {
                              if (piVar42[0xbc] + 0x80000000U < 0x7fffffff) {
                                 _err_print_error("get_or_null", "./core/templates/rid_owner.h", 0x103, "Method/function failed. Returning: nullptr", "Attempting to use an uninitialized RID", 0, 0, piVar42);
                              }
                           ...
                           if (*piVar42 != 0) {
                              _err_print_error("_render_batch", "servers/rendering/renderer_rd/renderer_canvas_render_rd.cpp", 0xc42, "Condition \"particles_storage->particles_get_mode(particles) != RenderingServer::PARTICLES_MODE_2D\" is true. Breaking.", 0, 0);
                              goto LAB_00113450;
                           }
                        ...
                        if (cVar24 == '\0') {
                           ...
                           if (iVar25 != 0) {
                              ...
                              uVar51 = *(ulong*)( lVar28 + 0x18 );
                              if (( uVar51 == 0 ) || ( *(uint*)( pPVar32 + 0x91c ) <= (uint)uVar51 )) {
                                 LAB_00114aca:pBVar47 = (Batch*)0x0;
                                 uVar29 = 0;
                                 _err_print_error("particles_get_instance_buffer_uniform_set", "./servers/rendering/renderer_rd/storage_rd/particles_storage.h", 0x215, "Parameter \"particles\" is null.", 0);
                              }
 else {
                                 lVar28 = ( ( uVar51 & 0xffffffff ) % ( ulong ) * (uint*)( pPVar32 + 0x918 ) ) * 0x2f8 + *(long*)( *(long*)( pPVar32 + 0x908 ) + ( ( uVar51 & 0xffffffff ) / ( ulong ) * (uint*)( pPVar32 + 0x918 ) ) * 8 );
                                 if (*(int*)( lVar28 + 0x2f0 ) != (int)( uVar51 >> 0x20 )) {
                                    if (*(int*)( lVar28 + 0x2f0 ) + 0x80000000U < 0x7fffffff) {
                                       _err_print_error("get_or_null", "./core/templates/rid_owner.h", 0x103, "Method/function failed. Returning: nullptr", "Attempting to use an uninitialized RID", 0, 0, pBVar47);
                                    }
                                 ...
                                 if (*(long*)( lVar28 + 0x108 ) == 0) {
                                    LAB_00113646:RendererRD::ParticlesStorage::_particles_update_buffers(pPVar32);
                                    local_78 = *(long*)( lVar28 + 0xe0 );
                                    local_c0 = 0;
                                    local_88 = 8;
                                    local_80 = local_80 & 0xffffff00;
                                    local_68 = 0;
                                    Vector<RenderingDevice::Uniform>::push_back((Vector<RenderingDevice::Uniform>*)&local_c8, (RIDSetKey*)&local_88);
                                    uVar30 = RenderingDevice::get_singleton();
                                    uVar29 = RenderingDevice::uniform_set_create<Vector<RenderingDevice::Uniform>>(uVar30, (Vector<RenderingDevice::Uniform>*)&local_c8, uVar29, 2, 0);
                                    *(undefined8*)( lVar28 + 0x108 ) = uVar29;
                                    CowData<RenderingDevice::Uniform>::_unref((CowData<RenderingDevice::Uniform>*)&local_c0);
                                 }
 else {
                                    uVar30 = RenderingDevice::get_singleton();
                                    cVar24 = RenderingDevice::uniform_set_is_valid(uVar30, *(undefined8*)( lVar28 + 0x108 ));
                     ...
                     if (( uVar51 == 0 ) || ( *(uint*)( (long)plVar31 + 0x19c ) <= (uint)uVar51 )) {
                        LAB_00114665:lVar36 = 0;
                     }
 else {
                        lVar28 = ( ( uVar51 & 0xffffffff ) % ( ulong ) * (uint*)( plVar31 + 0x33 ) ) * 0x160 + *(long*)( plVar31[0x31] + ( ( uVar51 & 0xffffffff ) / ( ulong ) * (uint*)( plVar31 + 0x33 ) ) * 8 );
                        if (*(int*)( lVar28 + 0x158 ) != (int)( uVar51 >> 0x20 )) {
                           if (*(int*)( lVar28 + 0x158 ) + 0x80000000U < 0x7fffffff) {
                              pBVar47 = (Batch*)0x0;
                              _err_print_error("get_or_null", "./core/templates/rid_owner.h", 0x103, "Method/function failed. Returning: nullptr", "Attempting to use an uninitialized RID", 0, 0, plVar31[0x31]);
                           }
                  ...
                  LAB_00114051:if (( uVar34 != 0 ) && ( uVar26 = ( **(code**)( *plVar31 + 0x80 ) )(plVar31, uVar34) ),uVar26 != 0) {
                     uVar51 = 0;
                     do {
                        if (*(uint*)( (long)plVar31 + 0xcc ) <= (uint)uVar34) {
                           LAB_001142c2:_err_print_error("mesh_get_surface", "./servers/rendering/renderer_rd/storage_rd/mesh_storage.h", 0x1a6, "Parameter \"mesh\" is null.", 0, 0);
                           /* WARNING: Does not return */
                           pcVar23 = (code*)invalidInstructionException();
                           ( *pcVar23 )();
                        }
                        ...
                        lVar28 = (long)pCVar6 * 0xe0 + *(long*)( plVar31[0x17] + ( ( uVar34 & 0xffffffff ) / ( ulong ) * (uint*)( plVar31 + 0x19 ) ) * 8 );
                        ...
                        if (*(uint*)( lVar28 + 0x10 ) <= (uint)uVar51) {
                           _render_batch(plVar31[0x17], pCVar6, (ulong)uVar27, (Light*)puVar40, (Batch*)( ulong ) * (uint*)( lVar28 + 0x10 ), (RenderInfo*)pBVar47);
                           return;
                        }
                        ...
                        if (uVar27 < 5) {
                           ...
                           uVar29 = _get_pipeline_specialization_or_ubershader(param_2, local_b8, local_d8, local_118, puVar5, pBVar47, (RIDSetKey*)&local_88);
                           uVar30 = RenderingDevice::get_singleton();
                           RenderingDevice::draw_list_bind_render_pipeline(uVar30, param_1, uVar29);
                           lVar28 = RenderingDevice::get_singleton();
                           RenderingDevice::draw_list_set_push_constant(lVar28, (void*)param_1, (uint)local_d8);
                           ...
                           RenderingDevice::draw_list_draw(lVar36, bVar46, ( uint )(lVar28 != 0), *(uint*)( param_5 + 0x58 ));
                           if (param_6 != (RenderInfo*)0x0) {
                              *(int*)( param_6 + 0x18 ) = *(int*)( param_6 + 0x18 ) + 1;
                              uVar45 = puVar5[0x26];
                              if (uVar45 == 0) {
                              ...
                              *(int*)( param_6 + 0x20 ) = *(int*)( param_6 + 0x20 ) + 1;
                              *(uint*)( param_6 + 0x1c ) = *(int*)( param_6 + 0x1c ) + ( ( uVar45 - iVar25 ) / uVar27 ) * iVar1;
                           }

                        }
 else {
                           pBVar47 = (Batch*)0x0;
                           pcVar41 = "Condition \"primitive < 0 || primitive >= RenderingServer::PRIMITIVE_MAX\" is true. Continuing.";
                           _err_print_error("_render_batch", "servers/rendering/renderer_rd/renderer_canvas_render_rd.cpp", 0xc5e, "Condition \"primitive < 0 || primitive >= RenderingServer::PRIMITIVE_MAX\" is true. Continuing.", 0);
                           puVar40 = pcVar41;
                        }
 ...
 while ( uVar51 != uVar26 );
            ...
            LAB_00113450:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
               return;
            }

            LAB_00114af6:/* WARNING: Subroutine does not return */__stack_chk_fail();
         }
   ...
   Transform2D const&, RendererCanvasRender::Light*, bool&, bool, RenderingMethod::RenderInfo*) */
         void RendererCanvasRenderRD::_render_batch_items(RendererCanvasRenderRD *param_1, undefined8 param_2, undefined8 param_3, int param_4, Transform2D *param_5, Light *param_6, undefined8 param_7, char param_8, RenderInfo *param_9) {
            Batch *pBVar1;
            uint uVar2;
            code *pcVar3;
            char cVar4;
            ...
            if (0 < param_4) {
               ...
               do {
                  ...
                  if (*(char*)( lVar12 + 0x48 ) == '\0') {
                     LAB_00114cb0:if (uVar15 != *(ulong*)( local_68 + 0xc )) {
                        puVar6 = (undefined4*)_new_batch(param_1, &local_75);
                        uVar8 = 0;
                        local_68 = puVar6;
                        if (uVar15 != 0) {
                           LAB_00115058:puVar6 = local_68;
                           if ((uint)uVar15 < *(uint*)( lVar5 + 0x26c )) {
                              lVar10 = ( ( uVar15 & 0xffffffff ) % ( ulong ) * (uint*)( lVar5 + 0x268 ) ) * 0xc0 + *(long*)( *(long*)( lVar5 + 600 ) + ( ( uVar15 & 0xffffffff ) / ( ulong ) * (uint*)( lVar5 + 0x268 ) ) * 8 );
                              if (*(int*)( lVar10 + 0xb8 ) == (int)( uVar15 >> 0x20 )) {
                                 if (*(int*)( lVar10 + 0x18 ) == 0) {
                                    uVar8 = *(undefined8*)( lVar10 + 8 );
                                 }
 else {
                                    LAB_00115559:uVar8 = 0;
                                 }
                     ...
                     if (**(int**)( lVar12 + 0x40 ) == 2) {
                        LAB_00115027:uVar15 = *(ulong*)( param_1 + 0x200ba8 );
                        goto LAB_00114cb0;
                     }
                  ...
                  if (*(long*)( lVar12 + 0xf8 ) == 0) {
                     LAB_00114f67:Transform2D::operator *(local_58, param_5);
                     _record_item_commands(param_1, lVar12, param_2, param_3, local_58, &local_70, param_6, &local_74, &local_75, param_7, &local_68);
                     iVar19 = local_74;
                  }
 else {
                     ...
                     while (true) {
                        ...
                        if (-1 < iVar17) {
                           ...
                           do {
                              ...
                              local_48 = CONCAT44((float)( ( ulong ) * (undefined8*)( lVar12 + 0xb0 ) >> 0x20 ) + (float)( (ulong)uVar8 >> 0x20 ) * fVar25 + (float)( (ulong)uVar9 >> 0x20 ) * fVar24, (float)*(undefined8*)( lVar12 + 0xb0 ) + (float)uVar8 * fVar25 + (float)uVar9 * fVar24);
...
;
                  ...
                  joined_r0x00114fd2:local_74 = iVar19;
 ...
 while ( true );
            ...
            iVar19 = 0;
            goto LAB_00114fe9;
            LAB_00114fd8:if (iVar19 != 0) {
               uVar8 = RenderingDevice::get_singleton();
               uVar21 = *(uint*)( param_1 + 0xaa4 );
               uVar2 = *(uint*)( param_1 + ( ulong ) * (uint*)( param_1 + 0xaa0 ) * 0x10 + 0xa60 );
               if (uVar2 <= uVar21) {
                  LAB_0011540b:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, (ulong)uVar21, (ulong)uVar2, "p_index", "count", "", false, true);
                  _err_flush_stdout();
                  /* WARNING: Does not return */
                  pcVar3 = (code*)invalidInstructionException();
                  ( *pcVar3 )();
               ...
               RenderingDevice::buffer_update(uVar8, *(undefined8*)( *(long*)( param_1 + ( ulong ) * (uint*)( param_1 + 0xaa0 ) * 0x10 + 0xa68 ) + (ulong)uVar21 * 8 ), *(int*)( param_1 + 0xaac ) << 7, iVar19 << 7, *(undefined8*)( param_1 + 0xab0 ));
            }

            LAB_00114fe9:if (*(int*)( param_1 + 0xa90 ) == 0) goto LAB_00114ffe;
            plVar7 = (long*)RendererRD::TextureStorage::get_singleton();
            local_60 = 0;
            if (param_8 == '\0') {
            ...
            if (lVar5 == 0) {
               LAB_00115350:lVar5 = _create_base_uniform_set(param_1, param_2, param_8);
            }
 else {
               uVar9 = RenderingDevice::get_singleton();
            ...
            pRVar11 = (Rect2*)RenderingDevice::draw_list_begin(uVar9, uVar8, bVar22, &local_68, 0, local_58, 0xb0000);
            uVar8 = RenderingDevice::get_singleton();
            ...
            *(undefined8*)( param_1 + 0xad0 ) = 0;
            do {
               ...
               if (*(int*)( pBVar1 + 4 ) != 0) {
                  ...
                  if (( ( lVar5 != 0 ) && ( *(long*)( *(CanvasShaderData**)( lVar5 + 0xa8 ) + 0xa8 ) != 0 ) ) && ( cVar4 = CanvasShaderData::is_valid(*(CanvasShaderData**)( lVar5 + 0xa8 )) ),cVar4 != '\0') {
 ...
 while ( uVar21 <= *(uint*)( param_1 + 0xaa8 ) );
            ...
            *(int*)( param_1 + 0xaac ) = *(int*)( param_1 + 0xaac ) + iVar19;
            ...
            LAB_00114ffe:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
               /* WARNING: Subroutine does not return */
               __stack_chk_fail();
            }
   ...
   RenderingMethod::RenderInfo*) */
         void RendererCanvasRenderRD::canvas_render_items(RendererCanvasRenderRD *this, undefined8 param_2, long param_3, float *param_4, byte *param_5, long param_6, ulong *param_7, undefined4 param_8, undefined4 param_9, uint param_10, undefined1 *param_11, undefined8 param_12) {
            long *plVar1;
            long lVar2;
            code *pcVar3;
            undefined1 auVar4[16];
            ...
            *param_11 = 0;
            ...
            if (param_6 == 0) {
               ...
               uVar38 = 0;
               local_228 = (double)CONCAT44(_LC178._4_4_, (undefined4)_LC178);
               do if (param_3 != 0) RendererCanvasRenderRD::CanvasMaterialData::set_next_pass(void)
...
{
  *(undefined ***)this = &PTR__CanvasShaderRD_00124180;
...
{
  *(undefined ***)this = &PTR__CanvasOcclusionShaderRD_001241a0;
  ShaderRD::~ShaderRD((ShaderRD *)this);
  return;
}
...
, /* RBMap<unsigned int, RID, Comparator<unsigned int>,
   ...
   DefaultAllocator>::Element*) [clone .part.0] */, void __thiscall
...
, /* RBSet<unsigned int, Comparator<unsigned int>, DefaultAllocator>::_cleanup_tree(RBSet<unsigned
   int, Comparator<unsigned int>, DefaultAllocator>::Element*) [clone .part.0] */, void __thiscall
...
, /* CowData<RenderingDeviceCommons::VertexAttribute>::_copy_on_write() [clone .isra.0] [clone .cold]
    */, void CowData<RenderingDeviceCommons::VertexAttribute>::_copy_on_write(void) * pcVar1; else {
                  lVar2 = 0;
                  do {
 ...
 while ( (ulong)uVar1 << 2 != lVar2 );
      ...
      LAB_00119b4c:pvVar3 = *(void**)( this + 0x68 );
      if (pvVar3 != (void*)0x0) {
         if (*(int*)( this + 0x8c ) != 0) {
 ...
 while ( (ulong)uVar1 << 2 != lVar2 );
      ...
      LAB_00119c03:pvVar3 = *(void**)( this + 0x38 );
      if (pvVar3 != (void*)0x0) {
         if (*(int*)( this + 0x5c ) != 0) {
 ...
 while ( lVar2 != (ulong)uVar1 << 2 );
      ...
      LAB_00119cae:pvVar3 = *(void**)( this + 8 );
      if (pvVar3 == (void*)0x0) {
         return;
      }
 ...
 while ( lVar2 != (ulong)uVar1 << 2 );
   ...
   void ShaderCompiler::DefaultIdentifierActions::~DefaultIdentifierActions(DefaultIdentifierActions *this) {
      long *plVar1;
      uint uVar2;
      long lVar3;
      long lVar4;
 ...
 while ( (ulong)uVar2 << 2 != lVar4 );
      ...
      LAB_0011a003:pvVar5 = *(void**)( this + 0x68 );
      if (pvVar5 != (void*)0x0) {
         if (*(int*)( this + 0x8c ) != 0) {
 ...
 while ( (ulong)uVar2 << 2 != lVar4 );
      ...
      LAB_0011a0e2:pvVar5 = *(void**)( this + 0x38 );
      if (pvVar5 != (void*)0x0) {
         if (*(int*)( this + 0x5c ) != 0) {
 ...
 while ( lVar4 != (ulong)uVar2 << 2 );
      ...
      LAB_0011a1bd:pvVar5 = *(void**)( this + 8 );
      if (pvVar5 == (void*)0x0) {
         return;
      }
...

{
   ...
   if (local_70 == (void*)0x0) {
      ...
      *(void**)( this + 8 ) = local_70;
      if (uVar47 == 0) {
         ...
         if (( pvVar4 < (void*)( (long)local_70 + uVar56 ) ) && ( local_70 < (void*)( (long)pvVar4 + uVar40 ) )) {
            uVar40 = 0;
            do {
 ...
 while ( uVar48 != uVar40 );
      ...
      if (iVar43 != 0) {
         ...
         if (uVar44 != 0) {
            ...
            lVar46 = lVar45;
            do {
               if (( (uint)uVar55 == uVar44 ) && ( uVar40 == *(ulong*)( *(long*)( (long)local_70 + lVar45 * 8 ) + 0x10 ) )) {
 ...
 while ( ( uVar44 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = (ulong)uVar44 * lVar3,auVar23._8_8_ = 0,auVar23._0_8_ = uVar48,auVar8._8_8_ = 0,auVar8._0_8_ = ( ulong )(( uVar54 + uVar47 ) - SUB164(auVar7 * auVar23, 8)) * lVar3,auVar24._8_8_ = 0,auVar24._0_8_ = uVar48,lVar46 = SUB168(auVar8 * auVar24, 8),uVar51 <= SUB164(auVar8 * auVar24, 8) );
         }

         LAB_0011a9b3:uVar52 = CONCAT44(0, *(uint*)( hash_table_size_primes + uVar56 * 4 ));
         lVar3 = *(long*)( hash_table_size_primes_inv + uVar56 * 8 );
         uVar39 = uVar40 * 0x3ffff - 1;
         uVar39 = ( uVar39 ^ uVar39 >> 0x1f ) * 0x15;
         uVar39 = ( uVar39 ^ uVar39 >> 0xb ) * 0x41;
         ...
         if (uVar47 != 0) {
            ...
            lVar46 = lVar45;
            do {
               if (( (uint)uVar55 == uVar47 ) && ( *(ulong*)( *(long*)( (long)local_70 + lVar45 * 8 ) + 0x10 ) == uVar40 )) {
 ...
 while ( ( uVar47 != 0 ) && ( auVar19._8_8_ = 0 ),auVar19._0_8_ = (ulong)uVar47 * lVar3,auVar35._8_8_ = 0,auVar35._0_8_ = uVar52,auVar20._8_8_ = 0,auVar20._0_8_ = ( ulong )(( *(uint*)( hash_table_size_primes + uVar56 * 4 ) + uVar44 ) - SUB164(auVar19 * auVar35, 8)) * lVar3,auVar36._8_8_ = 0,auVar36._0_8_ = uVar52,lVar46 = SUB168(auVar20 * auVar36, 8),uVar54 <= SUB164(auVar20 * auVar36, 8) );
         }
   ...
   LAB_0011a5fb:if ((float)uVar48 * __LC59 < (float)( iVar43 + 1 )) {
...
;
   ...
   *puVar1 = uVar54;
   *(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;
   LAB_0011a997:auVar59._8_8_ = lStack_90;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<StringName, ShaderCompiler::Stage, HashMapHasherDefault,
 ...
 while ( uVar40 != uVar45 );
      ...
      LAB_0011b14c:if (iVar46 != 0) {
         LAB_0011b154:uVar38 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
 ...
 while ( ( uVar52 != 0 ) && ( auVar19._8_8_ = 0 ),auVar19._0_8_ = (ulong)uVar52 * lVar43,auVar35._8_8_ = 0,auVar35._0_8_ = uVar45,auVar20._8_8_ = 0,auVar20._0_8_ = ( ulong )(( uVar38 + uVar53 ) - SUB164(auVar19 * auVar35, 8)) * lVar43,auVar36._8_8_ = 0,auVar36._0_8_ = uVar45,uVar54 <= SUB164(auVar20 * auVar36, 8) );
   ...
   LAB_0011ada9:uVar38 = *(uint*)( this + 0x28 );
   if (uVar38 == 0x1c) {
...
;
 ...
 while ( ( uVar52 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = (ulong)uVar52 * lVar49,auVar23._8_8_ = 0,auVar23._0_8_ = uVar40,auVar8._8_8_ = 0,auVar8._0_8_ = ( ulong )(( uVar53 + uVar38 ) - SUB164(auVar7 * auVar23, 8)) * lVar49,auVar24._8_8_ = 0,auVar24._0_8_ = uVar40,uVar54 <= SUB164(auVar8 * auVar24, 8) );
      ...
      LAB_0011b148:iVar46 = *(int*)( this + 0x2c );
      goto LAB_0011b14c;
   }

   LAB_0011ad83:if ((float)uVar40 * __LC59 < (float)( iVar46 + 1 )) goto LAB_0011ada9;
}
...
puVar4 = *(undefined8**)( this + 0x20 );if (puVar4 == (undefined8*)0x0) {
   ...
   *(undefined8**)( this + 0x20 ) = puVar42;
   ...
   LAB_0011b034:uVar38 = *(uint*)( lVar43 + 0x20 );
}
 else {
   *puVar4 = puVar42;
   puVar42[1] = puVar4;
   ...
   *(undefined8**)( this + 0x20 ) = puVar42;
   ...
   LAB_0011b25d:uVar38 = StringName::get_empty_hash();
}
if (uVar38 == 0) {
   uVar38 = 1;
}
...
;*(undefined8**)( lVar47 + lVar48 * 8 ) = puVar4;*puVar1 = uVar38;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_0011ad4c:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return puVar42 + 3;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<StringName, Pair<int*, int>, HashMapHasherDefault, HashMapComparatorDefault<StringName>,
 ...
 while ( uVar40 != uVar45 );
      ...
      memset(pvVar44, 0, uVar50);
      iVar46 = *(int*)( this + 0x2c );
      LAB_0011b8cc:if (iVar46 != 0) {
         LAB_0011b8d4:uVar38 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
         uVar45 = CONCAT44(0, uVar38);
         lVar43 = *(long*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( this + 0x28 ) * 8 );
         if (*(long*)param_1 == 0) {
            uVar39 = StringName::get_empty_hash();
 ...
 while ( ( uVar52 != 0 ) && ( auVar19._8_8_ = 0 ),auVar19._0_8_ = (ulong)uVar52 * lVar43,auVar35._8_8_ = 0,auVar35._0_8_ = uVar45,auVar20._8_8_ = 0,auVar20._0_8_ = ( ulong )(( uVar38 + uVar53 ) - SUB164(auVar19 * auVar35, 8)) * lVar43,auVar36._8_8_ = 0,auVar36._0_8_ = uVar45,uVar54 <= SUB164(auVar20 * auVar36, 8) );
   ...
   LAB_0011b519:uVar38 = *(uint*)( this + 0x28 );
   if (uVar38 == 0x1c) {
      puVar42 = (undefined8*)0x0;
      _err_print_error("_insert", "./core/templates/hash_map.h", 0xdd, "Condition \"capacity_index + 1 == HASH_TABLE_SIZE_MAX\" is true. Returning: nullptr", "Hash table maximum capacity reached, aborting insertion.", 0, 0);
      goto LAB_0011b4bc;
...
;
 ...
 while ( ( uVar52 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = (ulong)uVar52 * lVar49,auVar23._8_8_ = 0,auVar23._0_8_ = uVar40,auVar8._8_8_ = 0,auVar8._0_8_ = ( ulong )(( uVar53 + uVar38 ) - SUB164(auVar7 * auVar23, 8)) * lVar49,auVar24._8_8_ = 0,auVar24._0_8_ = uVar40,uVar54 <= SUB164(auVar8 * auVar24, 8) );
      ...
      LAB_0011b8c8:iVar46 = *(int*)( this + 0x2c );
      goto LAB_0011b8cc;
   }

   LAB_0011b4f3:if ((float)uVar40 * __LC59 < (float)( iVar46 + 1 )) goto LAB_0011b519;
}
...
puVar4 = *(undefined8**)( this + 0x20 );if (puVar4 == (undefined8*)0x0) {
   ...
   *(undefined8**)( this + 0x20 ) = puVar42;
   ...
   LAB_0011b7b0:uVar38 = *(uint*)( lVar43 + 0x20 );
}
 else {
   *puVar4 = puVar42;
   puVar42[1] = puVar4;
   ...
   *(undefined8**)( this + 0x20 ) = puVar42;
   ...
   LAB_0011b9dd:uVar38 = StringName::get_empty_hash();
}
if (uVar38 == 0) {
   uVar38 = 1;
}
...
;*(undefined8**)( lVar47 + lVar48 * 8 ) = puVar4;*puVar1 = uVar38;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_0011b4bc:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return puVar42 + 3;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<StringName, bool*, HashMapHasherDefault, HashMapComparatorDefault<StringName>,
 ...
 while ( uVar40 != uVar45 );
      ...
      memset(pvVar44, 0, uVar50);
      iVar46 = *(int*)( this + 0x2c );
      LAB_0011c03c:if (iVar46 != 0) {
         LAB_0011c044:uVar38 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
         uVar45 = CONCAT44(0, uVar38);
         lVar43 = *(long*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( this + 0x28 ) * 8 );
         if (*(long*)param_1 == 0) {
            uVar39 = StringName::get_empty_hash();
 ...
 while ( ( uVar52 != 0 ) && ( auVar19._8_8_ = 0 ),auVar19._0_8_ = (ulong)uVar52 * lVar43,auVar35._8_8_ = 0,auVar35._0_8_ = uVar45,auVar20._8_8_ = 0,auVar20._0_8_ = ( ulong )(( uVar38 + uVar53 ) - SUB164(auVar19 * auVar35, 8)) * lVar43,auVar36._8_8_ = 0,auVar36._0_8_ = uVar45,uVar54 <= SUB164(auVar20 * auVar36, 8) );
   ...
   LAB_0011bc99:uVar38 = *(uint*)( this + 0x28 );
   if (uVar38 == 0x1c) {
      puVar42 = (undefined8*)0x0;
      _err_print_error("_insert", "./core/templates/hash_map.h", 0xdd, "Condition \"capacity_index + 1 == HASH_TABLE_SIZE_MAX\" is true. Returning: nullptr", "Hash table maximum capacity reached, aborting insertion.", 0, 0);
      goto LAB_0011bc3c;
...
;
 ...
 while ( ( uVar52 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = (ulong)uVar52 * lVar49,auVar23._8_8_ = 0,auVar23._0_8_ = uVar40,auVar8._8_8_ = 0,auVar8._0_8_ = ( ulong )(( uVar53 + uVar38 ) - SUB164(auVar7 * auVar23, 8)) * lVar49,auVar24._8_8_ = 0,auVar24._0_8_ = uVar40,uVar54 <= SUB164(auVar8 * auVar24, 8) );
      ...
      LAB_0011c038:iVar46 = *(int*)( this + 0x2c );
      goto LAB_0011c03c;
   }

   LAB_0011bc73:if ((float)uVar40 * __LC59 < (float)( iVar46 + 1 )) goto LAB_0011bc99;
}
...
puVar4 = *(undefined8**)( this + 0x20 );if (puVar4 == (undefined8*)0x0) {
   ...
   *(undefined8**)( this + 0x20 ) = puVar42;
   ...
   LAB_0011bf27:uVar38 = *(uint*)( lVar43 + 0x20 );
}
 else {
   *puVar4 = puVar42;
   puVar42[1] = puVar4;
   ...
   *(undefined8**)( this + 0x20 ) = puVar42;
   ...
   LAB_0011c14d:uVar38 = StringName::get_empty_hash();
}
if (uVar38 == 0) {
   uVar38 = 1;
}
...
;*(undefined8**)( lVar47 + lVar48 * 8 ) = puVar4;*puVar1 = uVar38;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_0011bc3c:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return puVar42 + 3;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* HashMap<RendererCanvasRenderRD::TextureState, RendererCanvasRenderRD::TextureInfo,
   ...
   RendererCanvasRenderRD::TextureInfo> > >::getptr(RendererCanvasRenderRD::TextureState const&) */long HashMap<RendererCanvasRenderRD::TextureState,RendererCanvasRenderRD::TextureInfo,HashableHasher<RendererCanvasRenderRD::TextureState>,HashMapComparatorDefault<RendererCanvasRenderRD::TextureState>,DefaultTypedAllocator<HashMapElement<RendererCanvasRenderRD::TextureState,RendererCanvasRenderRD::TextureInfo>>>::getptr(HashMap<RendererCanvasRenderRD::TextureState,RendererCanvasRenderRD::TextureInfo,HashableHasher<RendererCanvasRenderRD::TextureState>,HashMapComparatorDefault<RendererCanvasRenderRD::TextureState>,DefaultTypedAllocator<HashMapElement<RendererCanvasRenderRD::TextureState,RendererCanvasRenderRD::TextureInfo>>> *this, TextureState *param_1) {
   int iVar1;
   long lVar2;
   long lVar3;
   long lVar4;
   ...
   if (*(int*)( this + 0x2c ) != 0) {
      ...
      uVar13 = ( (int)lVar3 * 0x16a88000 | ( uint )((int)lVar3 * -0x3361d2af) >> 0x11 ) * 0x1b873593 ^ 0x7f07c65;
      uVar13 = ( iVar14 * 0x16a88000 | ( uint )(iVar14 * -0x3361d2af) >> 0x11 ) * 0x1b873593 ^ ( uVar13 << 0xd | uVar13 >> 0x13 ) * 5 + 0xe6546b64;
      uVar13 = ( uVar13 << 0xd | uVar13 >> 0x13 ) * 5 + 0xe6546b64 ^ ( iVar1 * 0x16a88000 | ( uint )(iVar1 * -0x3361d2af) >> 0x11 ) * 0x1b873593;
      ...
      if (uVar13 != 0) {
         uVar19 = 0;
         do {
            if (( ( (uint)uVar17 == uVar13 ) && ( lVar16 = *(long*)( lVar2 + lVar16 * 8 ) * (long*)( lVar16 + 0x10 ) == lVar3 ) ) && ( *(int*)( lVar16 + 0x18 ) == iVar1 )) {
 ...
 while ( ( uVar13 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = (ulong)uVar13 * lVar4,auVar11._8_8_ = 0,auVar11._0_8_ = uVar18,auVar8._8_8_ = 0,auVar8._0_8_ = ( ulong )(( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 ) + uVar15 ) - SUB164(auVar7 * auVar11, 8)) * lVar4,auVar12._8_8_ = 0,auVar12._0_8_ = uVar18,uVar19 <= SUB164(auVar8 * auVar12, 8) );
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<RendererCanvasRenderRD::TextureState, RendererCanvasRenderRD::TextureInfo,
   HashableHasher<RendererCanvasRenderRD::TextureState>,
   HashMapComparatorDefault<RendererCanvasRenderRD::TextureState>,
   DefaultTypedAllocator<HashMapElement<RendererCanvasRenderRD::TextureState,
   RendererCanvasRenderRD::TextureInfo> > >::insert(RendererCanvasRenderRD::TextureState const&,
   RendererCanvasRenderRD::TextureInfo const&, bool) */TextureState * HashMap<RendererCanvasRenderRD::TextureState,RendererCanvasRenderRD::TextureInfo,HashableHasher<RendererCanvasRenderRD::TextureState>,HashMapComparatorDefault<RendererCanvasRenderRD::TextureState>,DefaultTypedAllocator<HashMapElement<RendererCanvasRenderRD::TextureState,RendererCanvasRenderRD::TextureInfo>>>::insert(TextureState * param_1, TextureInfo * param_2, bool, param_3) * puVar1 ;undefined8 *puVar2long lVar3long lVar4long lVar5void *pvVar6void *__sundefined1 auVar7[16]undefined1 auVar8[16]undefined1 auVar9[16]undefined1 auVar10[16]undefined1 auVar11[16]undefined1 auVar12[16]undefined1 auVar13[16]undefined1 auVar14[16]undefined1 auVar15[16]undefined1 auVar16[16]undefined1 auVar17[16]undefined1 auVar18[16]undefined1 auVar19[16]undefined1 auVar20[16]undefined1 auVar21[16]undefined1 auVar22[16]undefined1 auVar23[16]undefined1 auVar24[16]undefined1 auVar25[16]undefined1 auVar26[16]undefined1 auVar27[16]undefined1 auVar28[16]undefined1 auVar29[16]undefined1 auVar30[16]undefined8 uVar31undefined8 uVar32undefined8 uVar33undefined8 uVar34undefined8 uVar35undefined8 uVar36undefined1(*pauVar37)[16];uint uVar38uint uVar39int iVar40int iVar41uint uVar42ulong uVar43undefined8 uVar44void *__s_00undefined1(*pauVar45)[16];undefined8 *in_RCXint iVar46uint uVar47undefined7 in_register_00000011long *plVar48long lVar49long lVar50ulong uVar51undefined8 uVar52char in_R8Buint uVar53uint uVar54ulong uVar55undefined1(*pauVar56)[16];long in_FS_OFFSETvoid *local_e8plVar48 = (long*)CONCAT71(in_register_00000011, param_3);lVar3 = *(long*)( in_FS_OFFSET + 0x28 );uVar47 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( param_2 + 0x28 ) * 4 );local_e8 = *(void**)( param_2 + 8 );if (local_e8 == (void*)0x0) {
   uVar51 = (ulong)uVar47;
   uVar43 = uVar51 * 4;
   uVar55 = uVar51 * 8;
   ...
   *(void**)( param_2 + 8 ) = local_e8;
   if (uVar47 != 0) {
      ...
      if (( pvVar6 < (void*)( (long)local_e8 + uVar55 ) ) && ( local_e8 < (void*)( (long)pvVar6 + uVar43 ) )) {
         uVar43 = 0;
         do {
 ...
 while ( uVar51 != uVar43 );
   ...
   LAB_0011c467:iVar40 = *(int*)( param_2 + 0x2c );
   LAB_0011c46b:if (iVar40 != 0) {
      ...
      uVar38 = ( (int)lVar5 * 0x16a88000 | ( uint )((int)lVar5 * -0x3361d2af) >> 0x11 ) * 0x1b873593 ^ 0x7f07c65;
      uVar38 = ( iVar46 * 0x16a88000 | ( uint )(iVar46 * -0x3361d2af) >> 0x11 ) * 0x1b873593 ^ ( uVar38 << 0xd | uVar38 >> 0x13 ) * 5 + 0xe6546b64;
      uVar38 = ( uVar38 << 0xd | uVar38 >> 0x13 ) * 5 + 0xe6546b64 ^ ( iVar41 * 0x16a88000 | ( uint )(iVar41 * -0x3361d2af) >> 0x11 ) * 0x1b873593;
      ...
      if (uVar38 != 0) {
         do {
            if (( ( (uint)uVar43 == uVar38 ) && ( lVar49 = *(long*)( (long)local_e8 + lVar49 * 8 ) * (long*)( lVar49 + 0x10 ) == lVar5 ) ) && ( *(int*)( lVar49 + 0x18 ) == iVar41 )) {
               uVar44 = in_RCX[1];
               ...
               *(undefined8*)( pauVar45[2] + 8 ) = uVar44;
               for (int i = 0; i < 3; i++) {
                  uVar44 = in_RCX[( 2*i + 3 )];
                  *(undefined8*)pauVar45[( i + 3 )] = in_RCX[( 2*i + 2 )];
                  *(undefined8*)( pauVar45[( i + 3 )] + 8 ) = uVar44;
               }
 ...
 while ( ( uVar38 != 0 ) && ( auVar9._8_8_ = 0 ),auVar9._0_8_ = (ulong)uVar38 * lVar4,auVar21._8_8_ = 0,auVar21._0_8_ = uVar55,auVar10._8_8_ = 0,auVar10._0_8_ = ( ulong )(( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( param_2 + 0x28 ) * 4 ) + uVar42 ) - SUB164(auVar9 * auVar21, 8)) * lVar4,auVar22._8_8_ = 0,auVar22._0_8_ = uVar55,uVar54 <= SUB164(auVar10 * auVar22, 8) );
      }
...
uVar44 = *in_RCX;uVar52 = in_RCX[1];uVar31 = in_RCX[2];uVar32 = in_RCX[3];uVar33 = in_RCX[4];uVar34 = in_RCX[5];lVar4 = *plVar48;lVar5 = plVar48[1];uVar35 = in_RCX[6];uVar36 = in_RCX[7];pauVar45 = (undefined1(*) [16])operator_new(0x60, "");*pauVar45 = (undefined1[16])0x0;*(undefined8*)pauVar45[2] = uVar44;*(undefined8*)( pauVar45[2] + 8 ) = uVar52;*(long*)pauVar45[1] = lVar4;*(long*)( pauVar45[1] + 8 ) = lVar5;*(undefined8*)pauVar45[3] = uVar31;*(undefined8*)( pauVar45[3] + 8 ) = uVar32;*(undefined8*)pauVar45[4] = uVar33;*(undefined8*)( pauVar45[4] + 8 ) = uVar34;*(undefined8*)pauVar45[5] = uVar35;*(undefined8*)( pauVar45[5] + 8 ) = uVar36;puVar2 = *(undefined8**)( param_2 + 0x20 );if (puVar2 == (undefined8*)0x0) {
...
iVar40 = (int)*plVar48;iVar41 = (int)( ( ulong ) * plVar48 >> 0x20 );uVar47 = ( iVar40 * 0x16a88000 | ( uint )(iVar40 * -0x3361d2af) >> 0x11 ) * 0x1b873593 ^ 0x7f07c65;uVar47 = ( iVar41 * 0x16a88000 | ( uint )(iVar41 * -0x3361d2af) >> 0x11 ) * 0x1b873593 ^ ( uVar47 << 0xd | uVar47 >> 0x13 ) * 5 + 0xe6546b64;lVar4 = *(long*)( param_2 + 0x10 );uVar47 = ( uVar47 << 0xd | uVar47 >> 0x13 ) * 5 + 0xe6546b64 ^ ( (int)plVar48[1] * 0x16a88000 | ( uint )((int)plVar48[1] * -0x3361d2af) >> 0x11 ) * 0x1b873593;uVar47 = ( uVar47 << 0xd | uVar47 >> 0x13 ) * 5 + 0xe6546b64;uVar43 = (ulong)uVar47;if (uVar47 == 0) {
   uVar43 = 1;
}
uVar54 = 0;lVar5 = *(long*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( param_2 + 0x28 ) * 8 );uVar42 = (uint)uVar43;uVar47 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( param_2 + 0x28 ) * 4 );uVar55 = CONCAT44(0, uVar47);auVar15._8_8_ = 0;auVar15._0_8_ = uVar43 * lVar5;auVar27._8_8_ = 0;auVar27._0_8_ = uVar55;lVar50 = SUB168(auVar15 * auVar27, 8);lVar49 = *(long*)( param_2 + 8 );puVar1 = (uint*)( lVar4 + lVar50 * 4 );iVar40 = SUB164(auVar15 * auVar27, 8);uVar38 = *puVar1;pauVar37 = pauVar45;while (uVar38 != 0) {
   auVar16._8_8_ = 0;
...
;*(undefined1(**) [16])( lVar49 + lVar50 * 8 ) = pauVar37;*puVar1 = uVar42;*(int*)( param_2 + 0x2c ) = *(int*)( param_2 + 0x2c ) + 1;LAB_0011ca23:*(undefined1(**) [16])param_1 = pauVar45;if (lVar3 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return param_1;}/* WARNING: Control flow encountered bad instruction data *//* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<RID, LocalVector<RID, unsigned int, false, true>, HashMapHasherDefault,
   ...
   const&, bool) */void HashMap<RID,LocalVector<RID,unsigned_int,false,true>,HashMapHasherDefault,HashMapComparatorDefault<RID>,DefaultTypedAllocator<HashMapElement<RID,LocalVector<RID,unsigned_int,false,true>>>>::insert(RID *param_1, LocalVector *param_2, bool param_3) {
   uint *puVar1;
   undefined8 *puVar2;
   uint uVar3;
   void *__s;
   ...
   if (local_a0 == (void*)0x0) {
      ...
      *(void**)( param_2 + 8 ) = local_a0;
      if (uVar42 != 0) {
         ...
         if (( pvVar35 < (void*)( (long)local_a0 + uVar43 ) ) && ( local_a0 < (void*)( (long)pvVar35 + uVar32 ) )) {
            uVar32 = 0;
            do {
 ...
 while ( uVar44 != uVar32 );
      ...
      LAB_0011ccbe:lVar36 = *plVar39;
      iVar38 = *(int*)( param_2 + 0x2c );
      LAB_0011cccf:if (iVar38 != 0) {
         ...
         if (uVar3 != 0) {
            do {
               if (( (int)uVar32 == (int)uVar43 ) && ( *(long*)( *(long*)( (long)local_a0 + lVar40 * 8 ) + 0x10 ) == lVar36 )) {
                     ...
                     *(uint*)( lVar36 + 0x18 ) = uVar42;
                     ...
                     if (*(uint*)( lVar36 + 0x1c ) < uVar42) {
                        ...
                        *(long*)( lVar36 + 0x20 ) = lVar37;
                        if (lVar37 == 0) {
                           LocalVector<RendererCanvasRenderRD::Batch,unsigned_int,false,false>::resize((uint)pvVar35);
                        ...
                        LAB_0011d269:memset((void*)( *(long*)( lVar36 + 0x20 ) + (ulong)uVar3 * 8 ), 0, ( ulong )(( uVar42 - 1 ) - uVar3) * 8 + 8);
                     }
 ...
 while ( ( uVar3 != 0 ) && ( auVar6._8_8_ = 0 ),auVar6._0_8_ = uVar32 * lVar37,auVar18._8_8_ = 0,auVar18._0_8_ = uVar44,auVar7._8_8_ = 0,auVar7._0_8_ = ( ulong )(( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( param_2 + 0x28 ) * 4 ) + uVar31 ) - SUB164(auVar6 * auVar18, 8)) * lVar37,auVar19._8_8_ = 0,auVar19._0_8_ = uVar44,uVar47 <= SUB164(auVar7 * auVar19, 8) );
         }
 ...
 while ( uVar32 != uVar3 );
   ...
   if (uVar42 == 0) {
      ...
      *(undefined8*)pauVar34[2] = 0;
      ...
      if (pvVar35 == (void*)0x0) {
         LAB_0011d520:_err_print_error("resize", "./core/templates/local_vector.h", 0xa3, "FATAL: Condition \"!data\" is true.", "Out of memory", 0, 0);
         _err_flush_stdout();
         /* WARNING: Does not return */
...
;
   ...
   *puVar1 = uVar31;
   *(int*)( param_2 + 0x2c ) = *(int*)( param_2 + 0x2c ) + 1;
   LAB_0011d20e:*(undefined1(**) [16])param_1 = pauVar34;
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<RID>::resize<false>(long) */undefined8 CowData<RID>::resize<false>(CowData<RID> *this, long param_1) {
   ...
   if (param_1 * 8 == 0) {
      LAB_0011d848:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (param_1 <= lVar7) {
      ...
      if (uVar4 + 1 == lVar3) {
         ...
         if (puVar5 == (undefined8*)0x0) {
            LAB_0011d880:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
            return 6;
         }
   ...
   if (uVar4 + 1 == lVar3) {
      ...
      lVar3 = puVar6[-1];
      LAB_0011d789:if (param_1 <= lVar3) goto LAB_0011d701;
   }
 else {
      if (lVar7 != 0) {
...
/* WARNING: Removing unreachable block (ram,0x0011dab0) *//* WARNING: Removing unreachable block (ram,0x0011dbe0) *//* WARNING: Removing unreachable block (ram,0x0011dd59) *//* WARNING: Removing unreachable block (ram,0x0011dbec) *//* WARNING: Removing unreachable block (ram,0x0011dbf6) *//* WARNING: Removing unreachable block (ram,0x0011dd3b) *//* WARNING: Removing unreachable block (ram,0x0011dc02) *//* WARNING: Removing unreachable block (ram,0x0011dc0c) *//* WARNING: Removing unreachable block (ram,0x0011dd1d) *//* WARNING: Removing unreachable block (ram,0x0011dc18) *//* WARNING: Removing unreachable block (ram,0x0011dc22) *//* WARNING: Removing unreachable block (ram,0x0011dcff) *//* WARNING: Removing unreachable block (ram,0x0011dc2e) *//* WARNING: Removing unreachable block (ram,0x0011dc38) *//* WARNING: Removing unreachable block (ram,0x0011dce1) *//* WARNING: Removing unreachable block (ram,0x0011dc44) *//* WARNING: Removing unreachable block (ram,0x0011dc4e) *//* WARNING: Removing unreachable block (ram,0x0011dcc3) *//* WARNING: Removing unreachable block (ram,0x0011dc56) *//* WARNING: Removing unreachable block (ram,0x0011dc60) *//* WARNING: Removing unreachable block (ram,0x0011dca8) *//* WARNING: Removing unreachable block (ram,0x0011dc68) *//* WARNING: Removing unreachable block (ram,0x0011dc7e) *//* WARNING: Removing unreachable block (ram,0x0011dc8a) *//* String vformat<unsigned int, char const*>(String const&, unsigned int const, char const* const)
...
/* RID_Alloc<RendererCanvasRenderRD::CanvasLight, false>::~RID_Alloc() */void RID_Alloc<RendererCanvasRenderRD::CanvasLight,false>::~RID_Alloc(RID_Alloc<RendererCanvasRenderRD::CanvasLight,false> *this) {
   long *plVar1;
   long lVar2;
   uint uVar3;
   uint uVar4;
...
/* RID_Alloc<RendererCanvasRenderRD::OccluderPolygon, false>::~RID_Alloc() */void RID_Alloc<RendererCanvasRenderRD::OccluderPolygon,false>::~RID_Alloc(RID_Alloc<RendererCanvasRenderRD::OccluderPolygon,false> *this) {
   long *plVar1;
   long lVar2;
   uint uVar3;
   uint uVar4;
   ...
   uVar3 = *(uint*)( this + 0x20 );
   local_30 = *(long*)( in_FS_OFFSET + 0x28 );
   *(undefined***)this = &PTR__RID_Alloc_001241e0;
   if (uVar3 != 0) {
      local_50 = 0;
      local_40 = 0x3b;
      local_48 = "ERROR: %d RID allocations of type \'%s\' were leaked at exit.";
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<RenderingDeviceCommons::VertexAttribute>::resize<false>(long) */undefined8 CowData<RenderingDeviceCommons::VertexAttribute>::resize<false>(CowData<RenderingDeviceCommons::VertexAttribute> *this, long param_1) {
   ...
   lVar10 = param_1 * 0x14;
   if (lVar10 == 0) {
      LAB_0011e728:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (param_1 <= lVar11) {
      ...
      if (uVar6 + 1 == lVar5) {
         ...
         if (puVar7 == (undefined8*)0x0) {
            LAB_0011e760:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
            return 6;
         }
   ...
   if (uVar6 + 1 == lVar5) {
      ...
      lVar5 = puVar9[-1];
      LAB_0011e669:if (param_1 <= lVar5) goto LAB_0011e5dc;
   }
 else {
      if (lVar11 != 0) {
 ...
 while ( (undefined8*)( lVar10 + (long)puVar9 ) != puVar8 );
   LAB_0011e5dc:puVar9[-1] = param_1;
   return 0;
}
/* RID_Alloc<RendererCanvasRenderRD::CanvasLight,
   false>::make_rid(RendererCanvasRenderRD::CanvasLight const&) */ulong RID_Alloc<RendererCanvasRenderRD::CanvasLight,false>::make_rid(RID_Alloc<RendererCanvasRenderRD::CanvasLight,false> *this, CanvasLight *param_1) {
   undefined8 *puVar1;
   void *pvVar2;
   code *pcVar3;
   undefined8 uVar4;
 ...
 while ( (uint)lVar7 < uVar8 );
   ...
   if (uVar10 != 0x7fffffff) {
      ...
      *(uint*)( *(long*)( lVar16 + ( uVar17 / uVar8 ) * 8 ) + ( uVar17 % (ulong)uVar8 ) * 0x38 + 0x30 ) = uVar10 | 0x80000000;
      *(int*)( this + 0x20 ) = *(int*)( this + 0x20 ) + 1;
      uVar14 = CONCAT44(uVar9, uVar13) & 0x7fffffffffffffff;
      if (( uVar14 != 0 ) && ( (uint)uVar14 < *(uint*)( this + 0x1c ) )) {
         puVar1 = (undefined8*)( *(long*)( lVar16 + ( uVar17 / *(uint*)( this + 0x18 ) ) * 8 ) + ( uVar17 % ( ulong ) * (uint*)( this + 0x18 ) ) * 0x38 );
...
/* RID_Alloc<RendererCanvasRenderRD::OccluderPolygon,
   false>::make_rid(RendererCanvasRenderRD::OccluderPolygon const&) */ulong RID_Alloc<RendererCanvasRenderRD::OccluderPolygon,false>::make_rid(RID_Alloc<RendererCanvasRenderRD::OccluderPolygon,false> *this, OccluderPolygon *param_1) {
   void *pvVar1;
   code *pcVar2;
   undefined8 uVar3;
   long lVar4;
 ...
 while ( (uint)lVar6 < uVar7 );
   ...
   if (uVar9 != 0x7fffffff) {
      lVar16 = *(long*)( this + 8 );
      RID_AllocBase::base_id = RID_AllocBase::base_id + 1;
      *(uint*)( ( uVar17 % (ulong)uVar7 ) * 0x60 + *(long*)( lVar16 + ( uVar17 / uVar7 ) * 8 ) + 0x58 ) = uVar9 | 0x80000000;
      *(int*)( this + 0x20 ) = *(int*)( this + 0x20 ) + 1;
      uVar14 = CONCAT44(uVar8, uVar10) & 0x7fffffffffffffff;
      if (( uVar14 != 0 ) && ( (uint)uVar14 < *(uint*)( this + 0x1c ) )) {
         puVar11 = (undefined8*)( ( uVar17 % ( ulong ) * (uint*)( this + 0x18 ) ) * 0x60 + *(long*)( lVar16 + ( uVar17 / *(uint*)( this + 0x18 ) ) * 8 ) );
...
/* Error CowData<String>::resize<false>(long) */undefined8 CowData<String>::resize<false>(CowData<String> *this, long param_1) {
   ...
   if (param_1 * 8 == 0) {
      LAB_0011f570:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
      LAB_0011f5ed:/* WARNING: Does not return */pcVar3 = (code*)invalidInstructionException();
      ( *pcVar3 )();
   }
   ...
   if (uVar6 + 1 == lVar5) {
      ...
      lVar9 = puVar7[-1];
      LAB_0011f4d0:if (param_1 <= lVar9) goto LAB_0011f485;
   }
 else {
      if (lVar9 != 0) {
         puVar4 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), uVar6 + 0x11, false);
         if (puVar4 == (undefined8*)0x0) {
            LAB_0011f59f:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
            return 6;
         }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<RenderingDeviceCommons::PipelineColorBlendState::Attachment>::resize<false>(long)
   ...
   if (param_1 * 0x20 == 0) {
      LAB_0011f8a8:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (param_1 <= lVar9) {
      ...
      if (uVar5 + 1 == lVar4) {
         ...
         if (puVar6 == (undefined8*)0x0) {
            LAB_0011f8e0:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
            return 6;
         }
   ...
   if (uVar5 + 1 == lVar4) {
      ...
      lVar4 = puVar8[-1];
      LAB_0011f7e9:if (param_1 <= lVar4) goto LAB_0011f763;
   }
 else {
      if (lVar9 != 0) {
...
/* Error CowData<RenderingDevice::Uniform>::resize<false>(long) */undefined8 CowData<RenderingDevice::Uniform>::resize<false>(CowData<RenderingDevice::Uniform> *this, long param_1) {
   ...
   if (param_1 * 0x28 == 0) {
      LAB_0011fdd8:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
      LAB_0011fe55:/* WARNING: Does not return */pcVar2 = (code*)invalidInstructionException();
      ( *pcVar2 )();
   }
   ...
   if (uVar7 + 1 == lVar6) {
      ...
      lVar9 = puVar10[-1];
      LAB_0011fd30:if (param_1 <= lVar9) goto LAB_0011fce0;
   }
 else {
      if (lVar9 != 0) {
         puVar5 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), uVar7 + 0x11, false);
         if (puVar5 == (undefined8*)0x0) {
            LAB_0011fe07:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
            return 6;
         }
 ...
 while ( puVar10 + param_1 * 5 != puVar4 );
   LAB_0011fce0:puVar10[-1] = param_1;
   return 0;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<unsigned int, long, HashMapHasherDefault, HashMapComparatorDefault<unsigned int>,
 ...
 while ( uVar42 != uVar34 );
      ...
      LAB_0011ff4b:uVar33 = *puVar37;
      iVar36 = *(int*)( (long)param_2 + 0x2c );
      LAB_0011ff5b:if (iVar36 != 0) {
...
;
   ...
   *puVar37 = uVar32;
   *(int*)( (long)param_2 + 0x2c ) = *(int*)( (long)param_2 + 0x2c ) + 1;
   LAB_001203d8:*(undefined1(**) [16])param_1 = pauVar35;
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Color>::resize<false>(long) */undefined8 CowData<Color>::resize<false>(CowData<Color> *this, long param_1) {
   ...
   if (param_1 * 0x10 == 0) {
      LAB_00120848:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   uVar6 = uVar6 | uVar6 >> 0x10;
   uVar6 = uVar6 | uVar6 >> 0x20;
   if (uVar6 == 0xffffffffffffffff) goto LAB_00120848;
   if (param_1 <= lVar11) {
      puVar10 = *(undefined8**)this;
      if (uVar6 + 1 == lVar5) {
         ...
         if (puVar7 == (undefined8*)0x0) {
            LAB_00120880:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
            return 6;
         }
   ...
   if (uVar6 + 1 == lVar5) {
      ...
      lVar5 = puVar10[-1];
      LAB_00120789:if (param_1 <= lVar5) goto LAB_00120700;
   }
 else {
      if (lVar11 != 0) {
         puVar7 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), uVar6 + 0x11, false);
         if (puVar7 == (undefined8*)0x0) goto LAB_00120880;
         puVar10 = puVar7 + 2;
         *puVar7 = 1;
         *(undefined8**)this = puVar10;
         lVar5 = puVar7[1];
   ...
   if (( ( param_1 - lVar5 ) * 0x10 & 0x10U ) != 0) {
      *puVar8 = __LC142;
      puVar8[1] = uVar4;
      puVar7 = puVar8 + 2;
      if (puVar8 + 2 == puVar8 + ( param_1 - lVar5 ) * 2) goto LAB_00120700;
   }
 ...
 while ( puVar9 != puVar8 + ( param_1 - lVar5 ) * 2 );
   LAB_00120700:puVar10[-1] = param_1;
   return 0;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<RenderingDeviceCommons::PipelineSpecializationConstant>::resize<false>(long) */undefined8 CowData<RenderingDeviceCommons::PipelineSpecializationConstant>::resize<false>(CowData<RenderingDeviceCommons::PipelineSpecializationConstant> *this, long param_1) {
   ...
   lVar9 = param_1 * 0xc;
   if (lVar9 == 0) {
      LAB_00120b98:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   uVar5 = uVar5 | uVar5 >> 0x10;
   uVar5 = uVar5 | uVar5 >> 0x20;
   if (uVar5 == 0xffffffffffffffff) goto LAB_00120b98;
   if (param_1 <= lVar10) {
      puVar8 = *(undefined8**)this;
      if (uVar5 + 1 == lVar4) {
         if (puVar8 == (undefined8*)0x0) {
         ...
         puVar6 = (undefined8*)Memory::realloc_static(puVar8 + -2, uVar5 + 0x11, false);
         if (puVar6 == (undefined8*)0x0) {
            LAB_00120bd0:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
            return 6;
         }
   ...
   if (uVar5 + 1 == lVar4) {
      ...
      lVar4 = puVar8[-1];
      LAB_00120ad9:if (param_1 <= lVar4) goto LAB_00120a4b;
   }
 else {
      if (lVar10 != 0) {
         puVar6 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), uVar5 + 0x11, false);
         if (puVar6 == (undefined8*)0x0) goto LAB_00120bd0;
         puVar8 = puVar6 + 2;
         *puVar6 = 1;
         *(undefined8**)this = puVar8;
         lVar4 = puVar6[1];
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<StringName, String, HashMapHasherDefault, HashMapComparatorDefault<StringName>,
 ...
 while ( uVar43 != uVar33 );
      ...
      LAB_00120fd1:iVar35 = *(int*)( this + 0x2c );
      if (iVar35 != 0) {
         LAB_00120fdd:uVar29 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
 ...
 while ( ( uVar40 != 0 ) && ( auVar11._8_8_ = 0 ),auVar11._0_8_ = (ulong)uVar40 * lVar34,auVar23._8_8_ = 0,auVar23._0_8_ = uVar33,auVar12._8_8_ = 0,auVar12._0_8_ = ( ulong )(( uVar29 + uVar41 ) - SUB164(auVar11 * auVar23, 8)) * lVar34,auVar24._8_8_ = 0,auVar24._0_8_ = uVar33,uVar42 <= SUB164(auVar12 * auVar24, 8) );
   ...
   iVar35 = *(int*)( this + 0x2c );
   if (__s_00 == (void*)0x0) goto LAB_001210dc;
   if (*(int*)( this + 0x2c ) != 0) goto LAB_00120fdd;
   LAB_001210fe:if (*(int*)( this + 0x28 ) == 0x1c) {
      _err_print_error("_insert", "./core/templates/hash_map.h", 0xdd, "Condition \"capacity_index + 1 == HASH_TABLE_SIZE_MAX\" is true. Returning: nullptr", "Hash table maximum capacity reached, aborting insertion.", 0, 0);
      lVar34 = 0;
      LAB_00120f78:local_88 = (CowData<char32_t>*)( lVar34 + 0x18 );
      goto LAB_00120f81;
   }
 ...
 while ( ( uVar40 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = (ulong)uVar40 * lVar37,auVar19._8_8_ = 0,auVar19._0_8_ = uVar43,auVar8._8_8_ = 0,auVar8._0_8_ = ( ulong )(( uVar41 + uVar29 ) - SUB164(auVar7 * auVar19, 8)) * lVar37,auVar20._8_8_ = 0,auVar20._0_8_ = uVar43,uVar42 <= SUB164(auVar8 * auVar20, 8) );
      ...
      if (lVar34 == 0) goto LAB_001213b8;
      goto LAB_00120fd1;
   }

   local_70 = 0;
   iVar35 = 0;
   LAB_001210dc:if ((float)uVar43 * __LC59 < (float)( iVar35 + 1 )) goto LAB_001210fe;
}
...
puVar39 = *(undefined8**)( this + 0x20 );if (puVar39 == (undefined8*)0x0) {
   ...
   *(undefined8**)( this + 0x20 ) = puVar31;
   if (lVar34 == 0) goto LAB_00121385;
   LAB_001211f2:uVar29 = *(uint*)( lVar34 + 0x20 );
}
 else {
   *puVar39 = puVar31;
   puVar31[1] = puVar39;
   lVar34 = *(long*)param_1;
   *(undefined8**)( this + 0x20 ) = puVar31;
   if (lVar34 != 0) goto LAB_001211f2;
   LAB_00121385:uVar29 = StringName::get_empty_hash();
}
...
LAB_00120f81:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return local_88;
}
...
::insert(StringName *param_1,String *param_2,bool param_3){
 ...
 while ( uVar22 != uVar32 );
      ...
      if (__s_00 == (void*)0x0) goto LAB_00121619;
      if (*(int*)( param_2 + 0x2c ) != 0) goto LAB_0012150e;
      LAB_0012163b:if (*(int*)( param_2 + 0x28 ) == 0x1c) {
         _err_print_error("_insert", "./core/templates/hash_map.h", 0xdd, "Condition \"capacity_index + 1 == HASH_TABLE_SIZE_MAX\" is true. Returning: nullptr", "Hash table maximum capacity reached, aborting insertion.", 0, 0);
         local_80 = (long*)0x0;
         goto LAB_0012180b;
      }
      ...
      LAB_00121502:iVar28 = *(int*)( param_2 + 0x2c );
      if (iVar28 != 0) {
         LAB_0012150e:uVar3 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( param_2 + 0x28 ) * 4 );
 ...
 while ( ( uVar33 != 0 ) && ( auVar8._8_8_ = 0 ),auVar8._0_8_ = (ulong)uVar33 * lVar25,auVar16._8_8_ = 0,auVar16._0_8_ = uVar32,auVar9._8_8_ = 0,auVar9._0_8_ = ( ulong )(( uVar3 + uVar27 ) - SUB164(auVar8 * auVar16, 8)) * lVar25,auVar17._8_8_ = 0,auVar17._0_8_ = uVar32,uVar35 <= SUB164(auVar9 * auVar17, 8) );
      ...
      LAB_00121619:if ((float)uVar23 * __LC59 < (float)( iVar28 + 1 )) goto LAB_0012163b;
   }
   ...
   *local_80 = 0;
   ...
   if (puVar4 == (undefined8*)0x0) {
      ...
      *(long**)( param_2 + 0x20 ) = local_80;
      LAB_0012172c:lVar25 = *(long*)pSVar29;
      if (lVar25 != 0) goto LAB_00121739;
      LAB_00121861:uVar23 = StringName::get_empty_hash();
   }
 else {
      if (in_R8B == '\0') {
         *puVar4 = local_80;
      ...
      *local_80 = lVar25;
      lVar25 = *(long*)pSVar29;
      *(long**)( param_2 + 0x18 ) = local_80;
      if (lVar25 == 0) goto LAB_00121861;
      LAB_00121739:uVar23 = *(uint*)( lVar25 + 0x20 );
   }
...
;
   ...
   *puVar2 = uVar23;
   *(int*)( param_2 + 0x2c ) = *(int*)( param_2 + 0x2c ) + 1;
   LAB_0012180b:*(long**)param_1 = local_80;
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<RenderingDevice::AttachmentFormat>::resize<false>(long) */undefined8 CowData<RenderingDevice::AttachmentFormat>::resize<false>(CowData<RenderingDevice::AttachmentFormat> *this, long param_1) {
   ...
   lVar9 = param_1 * 0xc;
   if (lVar9 == 0) {
      LAB_00121c78:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   uVar5 = uVar5 | uVar5 >> 0x10;
   uVar5 = uVar5 | uVar5 >> 0x20;
   if (uVar5 == 0xffffffffffffffff) goto LAB_00121c78;
   if (param_1 <= lVar10) {
      puVar8 = *(undefined8**)this;
      if (uVar5 + 1 == lVar4) {
         if (puVar8 == (undefined8*)0x0) {
         ...
         puVar6 = (undefined8*)Memory::realloc_static(puVar8 + -2, uVar5 + 0x11, false);
         if (puVar6 == (undefined8*)0x0) {
            LAB_00121cb0:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
            return 6;
         }
   ...
   if (uVar5 + 1 == lVar4) {
      ...
      lVar4 = puVar8[-1];
      LAB_00121bb9:if (param_1 <= lVar4) goto LAB_00121b2b;
   }
 else {
      if (lVar10 != 0) {
         puVar6 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), uVar5 + 0x11, false);
         if (puVar6 == (undefined8*)0x0) goto LAB_00121cb0;
         puVar8 = puVar6 + 2;
         *puVar6 = 1;
         *(undefined8**)this = puVar8;
         lVar4 = puVar6[1];
...
/* HashMap<RendererCanvasRenderRD::RIDSetKey, List<LRUCache<RendererCanvasRenderRD::RIDSetKey, RID,
   ...
   HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,
   &RendererCanvasRenderRD::_before_evict>::Pair, DefaultAllocator>::Element*> >
   >::_lookup_pos(RendererCanvasRenderRD::RIDSetKey const&, unsigned int&) const */undefined8 HashMap<RendererCanvasRenderRD::RIDSetKey,List<LRUCache<RendererCanvasRenderRD::RIDSetKey,RID,HashableHasher<RendererCanvasRenderRD::RIDSetKey>,HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,&RendererCanvasRenderRD::_before_evict>::Pair,DefaultAllocator>::Element*,HashableHasher<RendererCanvasRenderRD::RIDSetKey>,HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,DefaultTypedAllocator<HashMapElement<RendererCanvasRenderRD::RIDSetKey,List<LRUCache<RendererCanvasRenderRD::RIDSetKey,RID,HashableHasher<RendererCanvasRenderRD::RIDSetKey>,HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,&RendererCanvasRenderRD::_before_evict>::Pair,DefaultAllocator>::Element*>>>::_lookup_pos(HashMap<RendererCanvasRenderRD::RIDSetKey,List<LRUCache<RendererCanvasRenderRD::RIDSetKey,RID,HashableHasher<RendererCanvasRenderRD::RIDSetKey>,HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,&RendererCanvasRenderRD::_before_evict>::Pair,DefaultAllocator>::Element*,HashableHasher<RendererCanvasRenderRD::RIDSetKey>,HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,DefaultTypedAllocator<HashMapElement<RendererCanvasRenderRD::RIDSetKey,List<LRUCache<RendererCanvasRenderRD::RIDSetKey,RID,HashableHasher<RendererCanvasRenderRD::RIDSetKey>,HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,&RendererCanvasRenderRD::_before_evict>::Pair,DefaultAllocator>::Element*>>> *this, RIDSetKey *param_1, uint *param_2) {
   int iVar1;
   long lVar2;
   long lVar3;
   ulong uVar4;
   ...
   uVar13 = ( (int)lVar2 * 0x16a88000 | ( uint )((int)lVar2 * -0x3361d2af) >> 0x11 ) * 0x1b873593 ^ 0x7f07c65;
   uVar13 = ( iVar14 * 0x16a88000 | ( uint )(iVar14 * -0x3361d2af) >> 0x11 ) * 0x1b873593 ^ ( uVar13 << 0xd | uVar13 >> 0x13 ) * 5 + 0xe6546b64;
   uVar13 = ( uVar13 << 0xd | uVar13 >> 0x13 ) * 5 + 0xe6546b64 ^ ( iVar1 * 0x16a88000 | ( uint )(iVar1 * -0x3361d2af) >> 0x11 ) * 0x1b873593;
   uVar13 = ( (int)lVar3 * 0x16a88000 | ( uint )((int)lVar3 * -0x3361d2af) >> 0x11 ) * 0x1b873593 ^ ( uVar13 << 0xd | uVar13 >> 0x13 ) * 5 + 0xe6546b64;
   iVar14 = (int)( (ulong)lVar3 >> 0x20 );
   uVar13 = ( iVar14 * 0x16a88000 | ( uint )(iVar14 * -0x3361d2af) >> 0x11 ) * 0x1b873593 ^ ( uVar13 << 0xd | uVar13 >> 0x13 ) * 5 + 0xe6546b64;
   uVar13 = ( uVar13 << 0xd | uVar13 >> 0x13 ) * 5 + 0xe6546b64;
   ...
   if (uVar13 != 0) {
      uVar20 = 0;
      do {
         if (( ( ( uVar18 == uVar13 ) && ( lVar17 = *(long*)( *(long*)( this + 8 ) + lVar17 * 8 ) * (long*)( lVar17 + 0x10 ) == lVar2 ) ) && ( *(int*)( lVar17 + 0x18 ) == iVar1 ) ) && ( lVar3 == *(long*)( lVar17 + 0x20 ) )) {
            *param_2 = uVar15;
            return 1;
         }
 ...
 while ( ( uVar13 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = uVar13 * uVar4,auVar11._8_8_ = 0,auVar11._0_8_ = uVar19,auVar8._8_8_ = 0,auVar8._0_8_ = ( ( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 ) + uVar15 ) - SUB164(auVar7 * auVar11, 8) ) * uVar4,auVar12._8_8_ = 0,auVar12._0_8_ = uVar19,uVar20 <= SUB164(auVar8 * auVar12, 8) );
   }

   return 0;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<RendererCanvasRenderRD::RIDSetKey, List<LRUCache<RendererCanvasRenderRD::RIDSetKey, RID,
   HashableHasher<RendererCanvasRenderRD::RIDSetKey>,
   HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,
   &RendererCanvasRenderRD::_before_evict>::Pair, DefaultAllocator>::Element*,
   HashableHasher<RendererCanvasRenderRD::RIDSetKey>,
   ...
   HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,
   &RendererCanvasRenderRD::_before_evict>::Pair, DefaultAllocator>::Element*> >
   >::operator[](RendererCanvasRenderRD::RIDSetKey const&) */undefined1 * __thiscallHashMap<RendererCanvasRenderRD::RIDSetKey,List<LRUCache<RendererCanvasRenderRD::RIDSetKey,RID,HashableHasher<RendererCanvasRenderRD::RIDSetKey>,HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,&RendererCanvasRenderRD::_before_evict>::Pair,DefaultAllocator>::Element*,HashableHasher<RendererCanvasRenderRD::RIDSetKey>,HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,DefaultTypedAllocator<HashMapElement<RendererCanvasRenderRD::RIDSetKey,List<LRUCache<RendererCanvasRenderRD::RIDSetKey,RID,HashableHasher<RendererCanvasRenderRD::RIDSetKey>,HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,&RendererCanvasRenderRD::_before_evict>::Pair,DefaultAllocator>::Element*>>>::operator [](HashMap<RendererCanvasRenderRD::RIDSetKey,List<LRUCache<RendererCanvasRenderRD::RIDSetKey,RID,HashableHasher<RendererCanvasRenderRD::RIDSetKey>,HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,&RendererCanvasRenderRD::_before_evict>::Pair,DefaultAllocator>::Element*,HashableHasher<RendererCanvasRenderRD::RIDSetKey>,HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,DefaultTypedAllocator<HashMapElement<RendererCanvasRenderRD::RIDSetKey,List<LRUCache<RendererCanvasRenderRD::RIDSetKey,RID,HashableHasher < RendererCanvasRenderRD::RIDSetKey>,HashMapComparatorDefault<RendererCanvasRenderRD::RIDSetKey>,&RendererCanvasRenderRD::_before_evict>::Pair,DefaultAllocator>::Element*>> > *this, RIDSetKey * param_1) * puVar1 ;undefined8 *puVar2uint uVar3void *pvVar4void *__slong lVar5long lVar6undefined1 auVar7[16]undefined1 auVar8[16]undefined1 auVar9[16]undefined1 auVar10[16]undefined1 auVar11[16]undefined1 auVar12[16]undefined1 auVar13[16]undefined1 auVar14[16]undefined1 auVar15[16]undefined1 auVar16[16]undefined1 auVar17[16]undefined1 auVar18[16]undefined1 auVar19[16]undefined1 auVar20[16]undefined1 auVar21[16]undefined1 auVar22[16]undefined1(*pauVar23)[16];char cVar24int iVar25int iVar26uint uVar27ulong uVar28undefined8 uVar29void *__s_00undefined1(*pauVar30)[16];void *pvVar31uint uVar32long lVar33long lVar34ulong uVar35undefined8 uVar36uint uVar37uint uVar38ulong uVar39undefined1(*pauVar40)[16];long in_FS_OFFSETuint local_d8uint local_80uint local_7c[5]undefined8 local_68undefined8 uStack_60undefined8 local_58long local_40local_40 = *(long*)( in_FS_OFFSET + 0x28 );local_80 = 0;cVar24 = _lookup_pos(this, param_1, &local_80);if (cVar24 == '\0') {
...
;
 ...
 while ( uVar28 != uVar27 );
      ...
      *(undefined1(**) [16])( this + 0x20 ) = pauVar30;
      ...
      uVar32 = ( iVar26 * 0x16a88000 | ( uint )(iVar26 * -0x3361d2af) >> 0x11 ) * 0x1b873593 ^ ( uVar32 << 0xd | uVar32 >> 0x13 ) * 5 + 0xe6546b64;
      uVar32 = ( uVar32 << 0xd | uVar32 >> 0x13 ) * 5 + 0xe6546b64 ^ ( *(int*)( param_1 + 8 ) * 0x16a88000 | ( uint )(*(int*)( param_1 + 8 ) * -0x3361d2af) >> 0x11 ) * 0x1b873593;
      iVar25 = (int)*(undefined8*)( param_1 + 0x10 );
      iVar26 = (int)( ( ulong ) * (undefined8*)( param_1 + 0x10 ) >> 0x20 );
      uVar32 = ( iVar25 * 0x16a88000 | ( uint )(iVar25 * -0x3361d2af) >> 0x11 ) * 0x1b873593 ^ ( uVar32 << 0xd | uVar32 >> 0x13 ) * 5 + 0xe6546b64;
      uVar32 = ( iVar26 * 0x16a88000 | ( uint )(iVar26 * -0x3361d2af) >> 0x11 ) * 0x1b873593 ^ ( uVar32 << 0xd | uVar32 >> 0x13 ) * 5 + 0xe6546b64;
...
LAB_001223f8:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return pauVar30[2] + 8;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* void memdelete<HashMapElement<StringName, HashMap<int, RID, HashMapHasherDefault,
 ...
 while ( lVar2 != (ulong)uVar1 << 2 );
            *(undefined4*)( param_1 + 0x44 ) = 0;
            *(undefined1(*) [16])( param_1 + 0x30 ) = (undefined1[16])0x0;
            if (pvVar3 == (void*)0x0) goto LAB_001225f7;
         }
   ...
   LAB_001225f7:if (( StringName::configured != '\0' ) && ( *(long*)( param_1 + 0x10 ) != 0 )) {
      StringName::unref();
   }
...
/* RendererRD::MaterialStorage::ShaderData::~ShaderData() */void RendererRD::MaterialStorage::ShaderData::~ShaderData(ShaderData *this) {
 ...
 while ( (ulong)uVar2 << 2 != lVar4 );
            *(undefined4*)( this + 0x6c ) = 0;
            *(undefined1(*) [16])( this + 0x58 ) = (undefined1[16])0x0;
            if (pvVar5 == (void*)0x0) goto LAB_001226e9;
         }
   ...
   LAB_001226e9:pvVar5 = *(void**)( this + 0x18 );
   if (pvVar5 != (void*)0x0) {
      if (*(int*)( this + 0x3c ) != 0) {
 ...
 while ( lVar4 != (ulong)uVar2 << 2 );
            *(undefined4*)( this + 0x3c ) = 0;
            *(undefined1(*) [16])( this + 0x28 ) = (undefined1[16])0x0;
            if (pvVar5 == (void*)0x0) goto LAB_0012282f;
         }
   ...
   if (param_1 * 4 != 0) {
      ...
      if (uVar4 != 0xffffffffffffffff) {
         if (lVar7 < param_1) {
            if (uVar4 + 1 == lVar3) {
               puVar5 = *(undefined8**)this;
               if (puVar5 == (undefined8*)0x0) goto LAB_00122a89;
            }
 else {
               if (lVar7 == 0) {
                  puVar5 = (undefined8*)Memory::alloc_static(uVar4 + 0x11, false);
                  ...
                  *puVar5 = 1;
                  ...
                  puVar5 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), uVar4 + 0x11, false);
                  if (puVar5 == (undefined8*)0x0) goto LAB_00122b70;
                  *puVar5 = 1;
               }
            ...
            if (uVar4 + 1 == lVar3) {
               ...
               if (puVar6 == (undefined8*)0x0) {
                  LAB_00122b70:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
                  return 6;
               }
...
/* RBSet<unsigned int, Comparator<unsigned int>, DefaultAllocator>::_insert_rb_fix(RBSet<unsigned
   ...
   do {
      while (true) {
         ...
         if (*(int*)pEVar6 == 0) goto LAB_00122ccd;
         if (*(Element**)( pEVar8 + 0x10 ) == param_1) {
            ...
            *(int*)param_1 = 1;
            pEVar7 = param_1;
            if (pEVar5 == pEVar6) goto LAB_00122df0;
            LAB_00122c76:*(int*)pEVar5 = 0;
         }
 else {
            pEVar6 = *(Element**)( this + 8 );
            *(int*)pEVar8 = 1;
            pEVar8 = param_1;
            if (pEVar5 != pEVar6) goto LAB_00122c76;
            LAB_00122df0:_err_print_error("_set_color", "./core/templates/rb_set.h", 0xd0, "Condition \"p_node == _data._nil && p_color == RED\" is true.", 0, 0);
         }
...
;
      ...
      if (*(int*)pEVar6 != 0) {
         if (*(Element**)( pEVar8 + 8 ) == param_1) {
            ...
            *(long*)( pEVar8 + 8 ) = lVar3;
            if (lVar2 == lVar3) {
               *(Element**)( param_1 + 0x18 ) = pEVar5;
               pEVar7 = pEVar5;
               LAB_00122ee2:*(Element**)( pEVar7 + 0x10 ) = param_1;
            }
 else {
               *(Element**)( lVar3 + 0x18 ) = pEVar8;
               pEVar7 = *(Element**)( pEVar8 + 0x18 );
               *(Element**)( param_1 + 0x18 ) = pEVar7;
               if (pEVar8 == *(Element**)( pEVar7 + 0x10 )) goto LAB_00122ee2;
               *(Element**)( pEVar7 + 8 ) = param_1;
            }
            ...
            *(int*)param_1 = 1;
            pEVar7 = param_1;
            if (pEVar5 == pEVar6) goto LAB_00122eb0;
            LAB_00122d40:*(int*)pEVar5 = 0;
         }
 else {
            pEVar6 = *(Element**)( this + 8 );
            *(int*)pEVar8 = 1;
            pEVar8 = param_1;
            if (pEVar5 != pEVar6) goto LAB_00122d40;
            LAB_00122eb0:_err_print_error("_set_color", "./core/templates/rb_set.h", 0xd0, "Condition \"p_node == _data._nil && p_color == RED\" is true.", 0, 0);
         }
      ...
      LAB_00122ccd:pEVar7 = *(Element**)( this + 8 );
      *(int*)pEVar8 = 1;
      *(int*)pEVar6 = 1;
      if (pEVar5 == pEVar7) {
...
/* PipelineHashMapRD<RendererCanvasRenderRD::PipelineKey, RendererCanvasRenderRD::CanvasShaderData,
   ...
   const&, unsigned int, RenderingServer::PipelineSource, bool) */void PipelineHashMapRD<RendererCanvasRenderRD::PipelineKey,RendererCanvasRenderRD::CanvasShaderData,void(RendererCanvasRenderRD::CanvasShaderData::*)(RendererCanvasRenderRD::PipelineKey)>::compile_pipeline(PipelineHashMapRD<RendererCanvasRenderRD::PipelineKey,RendererCanvasRenderRD::CanvasShaderData,void(RendererCanvasRenderRD::CanvasShaderData::*)(RendererCanvasRenderRD::PipelineKey)> *this, undefined8 *param_1, uint param_2, int param_4, byte param_5) {
   long *plVar1;
   int *piVar2;
   pthread_mutex_t *__mutex;
   undefined8 uVar3;
      ...
      if (pEVar14 != pEVar10) {
         do {
            if (local_8c[0] < *(uint*)( pEVar9 + 0x30 )) {
               ...
               if (local_8c[0] <= *(uint*)( pEVar9 + 0x30 )) goto LAB_00123226;
 ...
 while ( pEVar9 != pEVar14 );
         do {
            ...
            if (local_8c[0] < *(uint*)( pEVar15 + 0x30 )) {
               ...
               if (local_8c[0] <= *(uint*)( pEVar15 + 0x30 )) goto LAB_001230af;
   ...
   if (( pEVar15 == *(Element**)( this + 0x78 ) ) || ( uVar6 < *(uint*)( pEVar15 + 0x30 ) )) {
      *(Element**)( pEVar15 + 0x10 ) = pEVar10;
      ...
      if (pEVar14 == pEVar17) {
         pEVar14 = pEVar15;
         pEVar13 = pEVar15;
         if (pEVar10 == *(Element**)( pEVar15 + 8 )) goto LAB_00123288;
         goto LAB_00123295;
      }
 ...
 while ( pEVar17 != *(Element**)pEVar18 );
      ...
      *(Element**)( pEVar15 + 8 ) = pEVar10;
      ...
      pEVar13 = pEVar15;
      pEVar16 = pEVar14;
      if (pEVar9 != pEVar17) goto LAB_00123050;
      LAB_00123288:do {
 ...
 while ( bVar19 );
      LAB_00123295:if (pEVar14 == pEVar18) {
         pEVar14 = (Element*)0x0;
      }
 ...
 while ( bVar19 );
      ...
      if (*(Element**)( this + 0x78 ) != pEVar9) goto LAB_00123084;
      *(undefined8*)( pEVar10 + 0x28 ) = 0;
      if (pEVar14 != (Element*)0x0) goto LAB_0012308d;
   }
 else {
      do {
         pEVar15 = pEVar16;
 ...
 while ( *(Element**)( this + 0x80 ) != *(Element**)( pEVar15 + 8 ) );
      LAB_00123084:*(Element**)( pEVar10 + 0x28 ) = pEVar15;
      if (pEVar14 != (Element*)0x0) {
         LAB_0012308d:*(Element**)( pEVar14 + 0x28 ) = pEVar10;
         pEVar15 = *(Element**)( pEVar10 + 0x28 );
         if (pEVar15 == (Element*)0x0) goto LAB_0012309e;
      }

      *(Element**)( pEVar15 + 0x20 ) = pEVar10;
   }

   LAB_0012309e:*(int*)( this + 0x88 ) = *(int*)( this + 0x88 ) + 1;
   ...
   LAB_001230af:__mutex = *(pthread_mutex_t**)( this + 0x18 );
   if (__mutex != (pthread_mutex_t*)0x0) {
      iVar8 = pthread_mutex_lock(__mutex);
      if (iVar8 != 0) {
         LAB_0012334f:/* WARNING: Subroutine does not return */std::__throw_system_error(iVar8);
      }
   ...
   *puVar11 = &PTR_callback_00124350;
   ...
   local_78 = 0;
   local_70 = 0;
   uVar12 = WorkerThreadPool::_add_task(pCVar5, (_func_void_void_ptr*)&local_78, (void*)0x0, (BaseTemplateUserdata*)0x0, SUB81(puVar11, 0), (String*)(ulong)param_5);
   ...
   HashMap<unsigned_int,long,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,long>>>::insert((uint*)&local_68, (long*)( this + 0x90 ), SUB81(local_8c, 0));
   LAB_00123226:pthread_mutex_unlock((pthread_mutex_t*)( this + 0xc0 ));
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* RBMap<unsigned int, RID, Comparator<unsigned int>,
   ...
   do {
      while (true) {
         ...
         pEVar7 = pEVar8;
         if (pEVar6 == pEVar8) break;
         if (*(int*)pEVar6 == 0) goto LAB_0012340d;
         if (*(Element**)( pEVar8 + 0x10 ) == param_1) {
            lVar2 = *(long*)( this + 8 );
            lVar3 = *(long*)( param_1 + 8 );
            *(long*)( pEVar8 + 0x10 ) = lVar3;
            ...
            *(int*)param_1 = 1;
            pEVar7 = param_1;
            if (pEVar5 == pEVar6) goto LAB_00123530;
            LAB_001233b6:*(int*)pEVar5 = 0;
         }
 else {
            pEVar6 = *(Element**)( this + 8 );
            *(int*)pEVar8 = 1;
            pEVar8 = param_1;
            if (pEVar5 != pEVar6) goto LAB_001233b6;
            LAB_00123530:_err_print_error("_set_color", "./core/templates/rb_map.h", 0xed, "Condition \"p_node == _data._nil && p_color == RED\" is true.", 0, 0);
         }
...
;
         ...
         if (*(Element**)( pEVar8 + 8 ) == param_1) {
            ...
            *(long*)( pEVar8 + 8 ) = lVar3;
            if (lVar2 == lVar3) {
               *(Element**)( param_1 + 0x18 ) = pEVar5;
               pEVar7 = pEVar5;
               LAB_00123622:*(Element**)( pEVar7 + 0x10 ) = param_1;
            }
 else {
               *(Element**)( lVar3 + 0x18 ) = pEVar8;
               pEVar7 = *(Element**)( pEVar8 + 0x18 );
               *(Element**)( param_1 + 0x18 ) = pEVar7;
               if (pEVar8 == *(Element**)( pEVar7 + 0x10 )) goto LAB_00123622;
               *(Element**)( pEVar7 + 8 ) = param_1;
            }
            ...
            *(int*)param_1 = 1;
            pEVar7 = param_1;
            if (pEVar5 == pEVar6) goto LAB_001235f0;
            LAB_00123480:*(int*)pEVar5 = 0;
         }
 else {
            pEVar6 = *(Element**)( this + 8 );
            *(int*)pEVar8 = 1;
            pEVar8 = param_1;
            if (pEVar5 != pEVar6) goto LAB_00123480;
            LAB_001235f0:_err_print_error("_set_color", "./core/templates/rb_map.h", 0xed, "Condition \"p_node == _data._nil && p_color == RED\" is true.", 0, 0);
         }
      ...
      LAB_0012340d:pEVar7 = *(Element**)( this + 8 );
      *(int*)pEVar8 = 1;
      *(int*)pEVar6 = 1;
      if (pEVar5 == pEVar7) {
...
RBMap<unsigned_int,RID,Comparator<unsigned_int>,DefaultAllocator>::operator[]
   ...
   if (pEVar7 != pEVar4) {
      do {
         if (uVar1 < *(uint*)( pEVar2 + 0x30 )) {
            ...
            if (uVar1 <= *(uint*)( pEVar2 + 0x30 )) goto LAB_001237bf;
   ...
   if (( pEVar5 == *(Element**)this ) || ( *param_1 < *(uint*)( pEVar5 + 0x30 ) )) {
      *(Element**)( pEVar5 + 0x10 ) = pEVar2;
      ...
      if (pEVar8 == pEVar4) {
         pEVar4 = pEVar5;
         pEVar3 = pEVar5;
         if (pEVar2 == *(Element**)( pEVar5 + 8 )) goto LAB_001237e0;
         goto LAB_001237ed;
      }
 ...
 while ( *(Element**)pEVar9 != pEVar8 );
      ...
      *(Element**)( pEVar5 + 8 ) = pEVar2;
      ...
      pEVar3 = pEVar5;
      pEVar6 = pEVar4;
      if (pEVar7 != pEVar8) goto LAB_00123760;
      LAB_001237e0:do {
 ...
 while ( bVar10 );
      ...
      if (pEVar7 != *(Element**)this) goto LAB_00123794;
      *(undefined8*)( pEVar2 + 0x28 ) = 0;
      if (pEVar4 == (Element*)0x0) goto LAB_001237ae;
      LAB_0012379d:*(Element**)( pEVar4 + 0x28 ) = pEVar2;
      pEVar5 = *(Element**)( pEVar2 + 0x28 );
      if (pEVar5 == (Element*)0x0) goto LAB_001237ae;
   }
 else {
      do {
         pEVar5 = pEVar6;
 ...
 while ( *(Element**)( this + 8 ) != *(Element**)( pEVar5 + 8 ) );
      LAB_00123794:*(Element**)( pEVar2 + 0x28 ) = pEVar5;
      if (pEVar4 != (Element*)0x0) goto LAB_0012379d;
   }

   *(Element**)( pEVar5 + 0x20 ) = pEVar2;
   LAB_001237ae:*(int*)( this + 0x10 ) = *(int*)( this + 0x10 ) + 1;
   _insert_rb_fix(this, pEVar2);
   LAB_001237bf:return pEVar2 + 0x38;
}
/* PipelineHashMapRD<RendererCanvasRenderRD::PipelineKey, RendererCanvasRenderRD::CanvasShaderData,
   void 
   (RendererCanvasRenderRD::CanvasShaderData::*)(RendererCanvasRenderRD::PipelineKey)>::_add_new_pipelines_to_map()
    */undefined8 PipelineHashMapRD<RendererCanvasRenderRD::PipelineKey,RendererCanvasRenderRD::CanvasShaderData,void(RendererCanvasRenderRD::CanvasShaderData::*)(RendererCanvasRenderRD::PipelineKey)>::_add_new_pipelines_to_map(PipelineHashMapRD<RendererCanvasRenderRD::PipelineKey,RendererCanvasRenderRD::CanvasShaderData,void(RendererCanvasRenderRD::CanvasShaderData::*)(RendererCanvasRenderRD::PipelineKey)> *this) {
   long *plVar1;
      ...
      if (puVar18 != puVar23) {
         ...
         do {
            ...
            *puVar15 = *(undefined8*)( puVar23 + 2 );
            ...
            LAB_00123a0e:puVar23 = puVar23 + 4;
         }
            ...
            if (( lVar20 != 0 ) && ( *(int*)( this + 0xbc ) != 0 )) {
               ...
               if (uVar14 != 0) {
                  ...
                  while (( uVar14 != uVar19 || ( uVar13 != *(uint*)( *(long*)( lVar20 + lVar24 * 8 ) + 0x10 ) ) )) {
                     ...
                     if (( uVar14 == 0 ) || ( auVar6._8_8_ = 0 ),auVar6._0_8_ = uVar14 * uVar3,auVar10._8_8_ = 0,auVar10._0_8_ = uVar21,auVar7._8_8_ = 0,auVar7._0_8_ = ( ( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0xb8 ) * 4 ) + uVar17 ) - SUB164(auVar6 * auVar10, 8) ) * uVar3,auVar11._8_8_ = 0,auVar11._0_8_ = uVar21,SUB164(auVar7 * auVar11, 8) < uVar22) goto LAB_00123bc9;
                  }
;
            ...
            LAB_00123bc9:puVar23 = puVar23 + 1;
         }
 while ( true );
      }
...
/* WARNING: Control flow encountered bad instruction data *//* RID_Alloc<RendererCanvasRenderRD::OccluderPolygon, false>::~RID_Alloc() */void RID_Alloc<RendererCanvasRenderRD::OccluderPolygon,false>::~RID_Alloc(RID_Alloc<RendererCanvasRenderRD::OccluderPolygon,false> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* RID_Alloc<RendererCanvasRenderRD::CanvasLight, false>::~RID_Alloc() */void RID_Alloc<RendererCanvasRenderRD::CanvasLight,false>::~RID_Alloc(RID_Alloc<RendererCanvasRenderRD::CanvasLight,false> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* CanvasOcclusionShaderRD::~CanvasOcclusionShaderRD() */void CanvasOcclusionShaderRD::~CanvasOcclusionShaderRD(CanvasOcclusionShaderRD *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* CanvasShaderRD::~CanvasShaderRD() */void CanvasShaderRD::~CanvasShaderRD(CanvasShaderRD *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* WorkerThreadPool::TaskUserData<RendererCanvasRenderRD::CanvasShaderData, void
   (RendererCanvasRenderRD::CanvasShaderData::*)(RendererCanvasRenderRD::PipelineKey),
   RendererCanvasRenderRD::PipelineKey>::~TaskUserData() */void WorkerThreadPool::TaskUserData<RendererCanvasRenderRD::CanvasShaderData,void(RendererCanvasRenderRD::CanvasShaderData::*)(RendererCanvasRenderRD::PipelineKey),RendererCanvasRenderRD::PipelineKey>::~TaskUserData(TaskUserData<RendererCanvasRenderRD::CanvasShaderData,void(RendererCanvasRenderRD::CanvasShaderData::*)(RendererCanvasRenderRD::PipelineKey),RendererCanvasRenderRD::PipelineKey> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* LocalVector<RendererCanvasRenderRD::OccluderPolygon*, unsigned int, false, false>::~LocalVector()
    */void LocalVector<RendererCanvasRenderRD::OccluderPolygon*,unsigned_int,false,false>::~LocalVector(LocalVector<RendererCanvasRenderRD::OccluderPolygon*,unsigned_int,false,false> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* LocalVector<float, unsigned int, false, false>::~LocalVector() */void LocalVector<float,unsigned_int,false,false>::~LocalVector(LocalVector<float,unsigned_int,false,false> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

...
/* ScriptDebugger::set_lines_left(int) */void ScriptDebugger::set_lines_left(ScriptDebugger *this, int param_1) {
   int *in_FS_OFFSET;
   *in_FS_OFFSET = param_1;
   return;
}
/* ScriptDebugger::set_depth(int) */void ScriptDebugger::set_depth(ScriptDebugger *this, int param_1) {
   int *in_FS_OFFSET;
   *in_FS_OFFSET = param_1;
   return;
}
/* ScriptDebugger::breakpoint_find_source(String const&) const */String *ScriptDebugger::breakpoint_find_source(String *param_1) {
   CowData *in_RDX;
...
/* ScriptDebugger::clear_breakpoints() */void ScriptDebugger::clear_breakpoints(ScriptDebugger *this) {
   uint uVar1;
   void *pvVar2;
   long lVar3;
   void *pvVar4;
         ...
         do {
            if (*(int*)( *(long*)( this + 0x18 ) + lVar5 ) != 0) {
               *(int*)( *(long*)( this + 0x18 ) + lVar5 ) = 0;
               ...
               if (pvVar4 != (void*)0x0) {
                  if (( *(int*)( (long)pvVar2 + 0x3c ) != 0 ) && ( ( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( (long)pvVar2 + 0x38 ) * 4 ) == 0 || ( memset(*(void**)( (long)pvVar2 + 0x30 ), 0, ( ulong ) * (uint*)( hash_table_size_primes + ( ulong ) * (uint*)( (long)pvVar2 + 0x38 ) * 4 ) << 2),*(int*)( (long)pvVar2 + 0x3c ) != 0 ) ) )) {
                     lVar3 = 0;
                     do {
 ...
 while ( (uint)lVar3 < *(uint*)( (long)pvVar2 + 0x3c ) );
               ...
               LAB_001001c1:Memory::free_static(pvVar2, false);
...
/* ScriptDebugger::set_skip_breakpoints(bool) */void ScriptDebugger::set_skip_breakpoints(ScriptDebugger *this, bool param_1) {
   *this = (ScriptDebugger)param_1;
   return;
}
/* ScriptDebugger::is_skipping_breakpoints() */ScriptDebugger ScriptDebugger::is_skipping_breakpoints(ScriptDebugger *this) {
   return *this;
}
/* ScriptDebugger::debug(ScriptLanguage*, bool, bool) */void ScriptDebugger::debug(ScriptDebugger *this, ScriptLanguage *param_1, bool param_2, bool param_3) {
   undefined8 uVar1;
...
/* ScriptDebugger::get_break_language() const */undefined8 ScriptDebugger::get_break_language(void) {
   undefined8 *in_FS_OFFSET;
   return *in_FS_OFFSET;
}
/* ScriptDebugger::remove_breakpoint(int, StringName const&) */void ScriptDebugger::remove_breakpoint(ScriptDebugger *this, int param_1, StringName *param_2) {
   undefined4 *puVar1;
   undefined4 *puVar2;
   uint *puVar3;
   undefined8 *puVar4;
   ...
   if (( *(long*)( this + 0x10 ) != 0 ) && ( *(int*)( this + 0x34 ) != 0 )) {
      ...
      if (uVar59 != 0) {
         uVar71 = 0;
         do {
            if (( uVar78 == uVar59 ) && ( param_1 == *(int*)( *(long*)( *(long*)( this + 0x10 ) + lVar64 * 8 ) + 0x10 ) )) {
               local_3c[0] = param_1;
               plVar60 = (long*)HashMap<int,HashSet<StringName,HashMapHasherDefault,HashMapComparatorDefault<StringName>>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,HashSet<StringName,HashMapHasherDefault,HashMapComparatorDefault < StringName>>>> > ::operator []((HashMap<int,HashSet<StringName,HashMapHasherDefault,HashMapComparatorDefault<StringName>>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,HashSet<StringName,HashMapHasherDefault,HashMapComparatorDefault<StringName>>>>>*)( this + 8 ), local_3c);
 ...
 while ( ( uVar59 != 0 ) && ( auVar14._8_8_ = 0 ),auVar14._0_8_ = uVar59 * uVar67,auVar37._8_8_ = 0,auVar37._0_8_ = uVar73,auVar15._8_8_ = 0,auVar15._0_8_ = ( ( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x30 ) * 4 ) + iVar63 ) - SUB164(auVar14 * auVar37, 8) ) * uVar67,auVar38._8_8_ = 0,auVar38._0_8_ = uVar73,uVar71 <= SUB164(auVar15 * auVar38, 8) );
      }

   }

   return;
   LAB_001004d0:if (uVar71 == uVar79) {
      lVar8 = plVar60[1];
      lVar9 = *plVar60;
      ...
      if (*(long*)( lVar9 + uVar68 * 8 ) == *(long*)param_2) {
         ...
         if (( *puVar77 != 0 ) && ( auVar21._8_8_ = 0 ),auVar21._0_8_ = ( ulong ) * puVar77 * lVar10,auVar44._8_8_ = 0,auVar44._0_8_ = uVar73,auVar22._8_8_ = 0,auVar22._0_8_ = ( ulong )(( uVar59 + uVar71 ) - SUB164(auVar21 * auVar44, 8)) * lVar10,auVar45._8_8_ = 0,auVar45._0_8_ = uVar73,uVar66 = (ulong)uVar71,uVar69 = uVar67,SUB164(auVar22 * auVar45, 8) != 0) {
            while (true) {
               uVar67 = uVar66;
               ...
               *puVar3 = uVar71;
               ...
               lVar64 = uVar66 * 4;
               puVar77 = (uint*)( lVar7 + lVar64 );
               if (( *puVar77 == 0 ) || ( auVar23._8_8_ = 0 ),auVar23._0_8_ = ( ulong ) * puVar77 * lVar10,auVar46._8_8_ = 0,auVar46._0_8_ = uVar73,auVar24._8_8_ = 0,auVar24._0_8_ = ( ulong )(( SUB164(auVar25 * auVar48, 8) + uVar59 ) - SUB164(auVar23 * auVar46, 8)) * lVar10,auVar47._8_8_ = 0,auVar47._0_8_ = uVar73,SUB164(auVar24 * auVar47, 8) == 0) break;
...
;
         ...
         *(uint*)( (long)plVar60 + 0x24 ) = uVar59;
         if (uVar79 < uVar59) {
            StringName::StringName((StringName*)( *plVar60 + uVar68 * 8 ), (StringName*)( *plVar60 + (ulong)uVar59 * 8 ));
            ...
            *(uint*)( plVar60[1] + ( ulong ) * (uint*)( lVar64 + ( ulong ) * (uint*)( (long)plVar60 + 0x24 ) * 4 ) * 4 ) = uVar79;
         }

         LAB_001006c0:lVar64 = HashMap<int,HashSet<StringName,HashMapHasherDefault,HashMapComparatorDefault<StringName>>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,HashSet<StringName,HashMapHasherDefault,HashMapComparatorDefault < StringName>>>> > ::operator []((HashMap<int,HashSet<StringName,HashMapHasherDefault,HashMapComparatorDefault<StringName>>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,HashSet<StringName,HashMapHasherDefault,HashMapComparatorDefault<StringName>>>>>*)( this + 8 ), local_3c);
         ...
         while (true) {
            ...
            if (( uVar78 == uVar58 ) && ( param_1 == *(int*)( *(long*)( lVar64 + uVar68 * 8 ) + 0x10 ) )) break;
...
;
         ...
         uVar58 = *puVar77;
         if (( uVar58 != 0 ) && ( auVar30._8_8_ = 0 ),auVar30._0_8_ = uVar58 * uVar67,auVar53._8_8_ = 0,auVar53._0_8_ = uVar73,auVar31._8_8_ = 0,auVar31._0_8_ = ( ( uVar70 + uVar59 ) - SUB164(auVar30 * auVar53, 8) ) * uVar67,auVar54._8_8_ = 0,auVar54._0_8_ = uVar73,uVar68 = (ulong)uVar70,uVar76 = uVar66,SUB164(auVar31 * auVar54, 8) != 0) {
            while (true) {
               uVar66 = uVar68;
               ...
               *puVar5 = uVar11;
               ...
               puVar77 = (uint*)( lVar7 + uVar69 * 4 );
               uVar58 = *puVar77;
               if (( uVar58 == 0 ) || ( auVar32._8_8_ = 0 ),auVar32._0_8_ = uVar58 * uVar67,auVar55._8_8_ = 0,auVar55._0_8_ = uVar73,auVar33._8_8_ = 0,auVar33._0_8_ = ( ( SUB164(auVar34 * auVar57, 8) + uVar59 ) - SUB164(auVar32 * auVar55, 8) ) * uVar67,auVar56._8_8_ = 0,auVar56._0_8_ = uVar73,SUB164(auVar33 * auVar56, 8) == 0) break;
...
;
         ...
         *(undefined4*)( lVar7 + uVar66 * 4 ) = 0;
         ...
         if (pvVar80 != (void*)0x0) {
            if (( *(int*)( (long)plVar72 + 0x3c ) != 0 ) && ( ( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( plVar72 + 7 ) * 4 ) == 0 || ( memset((void*)plVar72[6], 0, ( ulong ) * (uint*)( hash_table_size_primes + ( ulong ) * (uint*)( plVar72 + 7 ) * 4 ) * 4),*(int*)( (long)plVar72 + 0x3c ) != 0 ) ) )) {
               lVar64 = 0;
               do {
 ...
 while ( (uint)lVar64 < *(uint*)( (long)plVar72 + 0x3c ) );
         ...
         LAB_00100923:Memory::free_static(plVar72, false);
   ...
   if (( uVar79 == 0 ) || ( auVar18._8_8_ = 0 ),auVar18._0_8_ = (ulong)uVar79 * lVar64,auVar41._8_8_ = 0,auVar41._0_8_ = uVar67,auVar19._8_8_ = 0,auVar19._0_8_ = ( ulong )(( uVar59 + iVar63 ) - SUB164(auVar18 * auVar41, 8)) * lVar64,auVar42._8_8_ = 0,auVar42._0_8_ = uVar67,SUB164(auVar19 * auVar42, 8) < uVar75) goto LAB_001006c0;
   goto LAB_001004d0;
}
/* ScriptDebugger::insert_breakpoint(int, StringName const&) */void ScriptDebugger::insert_breakpoint(int param_1, StringName *param_2) {
   ulong uVar1;
   ...
   if (( *(long*)( lVar16 + 0x10 ) != 0 ) && ( *(int*)( lVar16 + 0x34 ) != 0 )) {
      ...
      if (uVar10 != 0) {
         uVar18 = 0;
         do {
            if (( uVar15 == uVar10 ) && ( local_5c == *(uint*)( *(long*)( *(long*)( lVar16 + 0x10 ) + lVar14 * 8 ) + 0x10 ) )) goto LAB_00100bce;
            uVar18 = uVar18 + 1;
            auVar3._8_8_ = 0;
 ...
 while ( ( uVar10 != 0 ) && ( auVar4._8_8_ = 0 ),auVar4._0_8_ = uVar10 * uVar1,auVar8._8_8_ = 0,auVar8._0_8_ = uVar17,auVar5._8_8_ = 0,auVar5._0_8_ = ( ( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( lVar16 + 0x30 ) * 4 ) + iVar12 ) - SUB164(auVar4 * auVar8, 8) ) * uVar1,auVar9._8_8_ = 0,auVar9._0_8_ = uVar17,uVar18 <= SUB164(auVar5 * auVar9, 8) );
      }

   }

   pauVar11 = (undefined1(*) [16])HashMap<int,HashSet<StringName,HashMapHasherDefault,HashMapComparatorDefault<StringName>>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,HashSet<StringName,HashMapHasherDefault,HashMapComparatorDefault < StringName>>>> > ::operator []((HashMap<int,HashSet<StringName,HashMapHasherDefault,HashMapComparatorDefault<StringName>>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,HashSet<StringName,HashMapHasherDefault,HashMapComparatorDefault<StringName>>>>>*)( lVar16 + 8 ), (int*)&local_5c);
   pvVar19 = *(void**)*pauVar11;
   if (pvVar19 != (void*)0x0) {
      if (( *(int*)( pauVar11[2] + 4 ) != 0 ) && ( ( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)pauVar11[2] * 4 ) == 0 || ( memset(*(void**)( pauVar11[1] + 8 ), 0, ( ulong ) * (uint*)( hash_table_size_primes + ( ulong ) * (uint*)pauVar11[2] * 4 ) * 4),*(int*)( pauVar11[2] + 4 ) != 0 ) ) )) {
         lVar14 = 0;
         do {
 ...
 while ( (uint)lVar14 < *(uint*)( pauVar11[2] + 4 ) );
   ...
   LAB_00100bc6:*(undefined8*)pauVar11[2] = 2;
   LAB_00100bce:HashMap<int,HashSet<StringName,HashMapHasherDefault,HashMapComparatorDefault<StringName>>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,HashSet<StringName,HashMapHasherDefault,HashMapComparatorDefault < StringName>>>> > ::operator []((HashMap<int,HashSet<StringName,HashMapHasherDefault,HashMapComparatorDefault<StringName>>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,HashSet<StringName,HashMapHasherDefault,HashMapComparatorDefault<StringName>>>>>*)( lVar16 + 8 ), (int*)&local_5c);
...
/* CowData<ScriptLanguage::StackInfo>::_ref(CowData<ScriptLanguage::StackInfo> const&) [clone
   .part.0] */void CowData<ScriptLanguage::StackInfo>::_ref(CowData<ScriptLanguage::StackInfo> *this, CowData *param_1) {
   long *plVar1;
   long lVar2;
   long lVar3;
   bool bVar4;
...
/* ScriptDebugger::get_error_stack_info() const */ScriptDebugger * __thiscall ScriptDebugger::get_error_stack_info(ScriptDebugger *this){
   long lVar1;
   long *in_FS_OFFSET;
   ...
   *(undefined8*)( this + 8 ) = 0;
   if (*in_FS_OFFSET != 0) {
      CowData<ScriptLanguage::StackInfo>::_ref((CowData<ScriptLanguage::StackInfo>*)( this + 8 ), (CowData*)*in_FS_OFFSET);
   }

   return this;
}
/* ScriptDebugger::send_error(String const&, String const&, int, String const&, String const&, bool,
   ErrorHandlerType, Vector<ScriptLanguage::StackInfo> const&) */void ScriptDebugger::send_error(undefined8 param_1_00, undefined8 param_1, undefined8 param_2, undefined4 param_3, undefined8 param_4, undefined8 param_5, undefined1 param_6, undefined8 param_8, long param_9) {
   ...
   local_50[0] = 0;
   if (*(long*)( param_9 + 8 ) != 0) {
      CowData<ScriptLanguage::StackInfo>::_ref((CowData<ScriptLanguage::StackInfo>*)local_50, (CowData*)( param_9 + 8 ));
   }
   ...
   ( **(code**)( *EngineDebugger::singleton + 0x10 ) )(EngineDebugger::singleton, param_1, param_2, param_3, param_4, param_5, param_6);
   if ((char)*in_FS_OFFSET == '\0') {
      *(char*)in_FS_OFFSET = '\x01';
      *in_FS_OFFSET = 0;
...
/* TLS init function for ScriptDebugger::error_stack_info */void ScriptDebugger::error_stack_info(void) {
   undefined8 uVar1;
   char *in_FS_OFFSET;
   if (*in_FS_OFFSET != '\0') {
      return;
...
/* Vector<ScriptLanguage::StackInfo>::~Vector() */void Vector<ScriptLanguage::StackInfo>::~Vector(Vector<ScriptLanguage::StackInfo> *this) {
...
/* HashSet<StringName, HashMapHasherDefault, HashMapComparatorDefault<StringName>
 ...
 while ( (uint)lVar8 < *(uint*)( this + 0x24 ) );
   ...
   LAB_00100fd4:uVar1 = *(ulong*)( param_1 + 0x20 );
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<int, HashSet<StringName, HashMapHasherDefault, HashMapComparatorDefault<StringName> >,
   HashMapHasherDefault, HashMapComparatorDefault<int>, DefaultTypedAllocator<HashMapElement<int,
   HashSet<StringName, HashMapHasherDefault, HashMapComparatorDefault<StringName> > > >
   >::operator[](int const&) */undefined1 * __thiscallHashMap<int,HashSet<StringName,HashMapHasherDefault,HashMapComparatorDefault<StringName>>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,HashSet<StringName,HashMapHasherDefault,HashMapComparatorDefault<StringName>>>>>::operator [](HashMap<int,HashSet<StringName,HashMapHasherDefault,HashMapComparatorDefault<StringName>>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,HashSet<StringName,HashMapHasherDefault,HashMapComparatorDefault < StringName>>>> > *this, int, *param_1) * puVar1 ;undefined8 *puVar2void *pvVar3void *__sundefined1 auVar4[16]undefined1 auVar5[16]undefined1 auVar6[16]undefined1 auVar7[16]undefined1 auVar8[16]undefined1 auVar9[16]undefined1 auVar10[16]undefined1 auVar11[16]undefined1 auVar12[16]undefined1 auVar13[16]undefined1 auVar14[16]undefined1 auVar15[16]undefined1 auVar16[16]undefined1 auVar17[16]undefined1 auVar18[16]undefined1 auVar19[16]undefined1 auVar20[16]undefined1 auVar21[16]undefined1 auVar22[16]undefined1 auVar23[16]undefined1 auVar24[16]undefined1 auVar25[16]undefined1 auVar26[16]undefined1 auVar27[16]undefined1 auVar28[16]undefined1 auVar29[16]undefined1 auVar30[16]undefined1 auVar31[16]undefined1 auVar32[16]undefined1 auVar33[16]undefined1 auVar34[16]undefined1 auVar35[16]undefined1(*pauVar36)[16];undefined8 uVar37uint uVar38uint uVar39uint uVar40ulong uVar41undefined8 uVar42void *__s_00undefined1(*pauVar43)[16];int iVar44ulong uVar45long lVar46ulong uVar47long lVar48long lVar49ulong uVar50undefined8 uVar51uint uVar52ulong uVar53uint uVar54uint uVar55long lVar56undefined1(*pauVar57)[16];long in_FS_OFFSETvoid *local_a8HashSet local_68[16]undefined1 local_58[16]undefined8 local_48long local_40uVar37 = _LC6;local_a8 = *(void**)( this + 8 );uVar40 = *param_1;local_40 = *(long*)( in_FS_OFFSET + 0x28 );uVar41 = ( ulong ) * (uint*)( this + 0x28 );uVar39 = *(uint*)( hash_table_size_primes + uVar41 * 4 );uVar53 = CONCAT44(0, uVar39);if (local_a8 == (void*)0x0) {
   uVar41 = uVar53 * 4;
   for (int i = 0; i < 16; i++) {
   ...
   *(void**)( this + 8 ) = local_a8;
   if (uVar39 == 0) {
      ...
      if (( pvVar3 < (void*)( (long)local_a8 + uVar50 ) ) && ( local_a8 < (void*)( (long)pvVar3 + uVar41 ) )) {
         uVar41 = 0;
         do {
 ...
 while ( uVar53 != uVar41 );
   ...
   if (iVar44 == 0) {
      ...
      if (uVar38 != 0) {
         uVar52 = 0;
         do {
            if (( uVar54 == uVar38 ) && ( uVar40 == *(uint*)( *(long*)( (long)local_a8 + lVar46 * 8 ) + 0x10 ) )) {
 ...
 while ( ( uVar38 != 0 ) && ( auVar6._8_8_ = 0 ),auVar6._0_8_ = uVar38 * uVar50,auVar22._8_8_ = 0,auVar22._0_8_ = uVar53,auVar7._8_8_ = 0,auVar7._0_8_ = ( ( uVar39 + uVar55 ) - SUB164(auVar6 * auVar22, 8) ) * uVar50,auVar23._8_8_ = 0,auVar23._0_8_ = uVar53,uVar52 <= SUB164(auVar7 * auVar23, 8) );
      }
      ...
      local_48 = _LC6;
      local_58 = (undefined1[16])0x0;
      LAB_00101352:uVar45 = CONCAT44(0, *(uint*)( hash_table_size_primes + uVar41 * 4 ));
      uVar50 = *(ulong*)( hash_table_size_primes_inv + uVar41 * 8 );
      ...
      if (uVar39 != 0) {
         uVar55 = 0;
         do {
            if (( uVar38 == uVar39 ) && ( *(uint*)( *(long*)( (long)local_a8 + lVar46 * 8 ) + 0x10 ) == uVar40 )) {
               HashSet<StringName,HashMapHasherDefault,HashMapComparatorDefault<StringName>>::operator =((HashSet<StringName,HashMapHasherDefault,HashMapComparatorDefault<StringName>>*)( *(long*)( (long)local_a8 + (ulong)uVar54 * 8 ) + 0x18 ), local_68);
 ...
 while ( ( uVar39 != 0 ) && ( auVar10._8_8_ = 0 ),auVar10._0_8_ = uVar39 * uVar50,auVar26._8_8_ = 0,auVar26._0_8_ = uVar45,auVar11._8_8_ = 0,auVar11._0_8_ = ( ( *(uint*)( hash_table_size_primes + uVar41 * 4 ) + uVar54 ) - SUB164(auVar10 * auVar26, 8) ) * uVar50,auVar27._8_8_ = 0,auVar27._0_8_ = uVar45,uVar55 <= SUB164(auVar11 * auVar27, 8) );
      }

   }

}
LAB_00101443:if ((float)uVar53 * __LC0 < (float)( iVar44 + 1 )) {
...
iVar44 = *param_1;pauVar43 = (undefined1(*) [16])operator_new(0x40, "");*pauVar43 = (undefined1[16])0x0;*(undefined1(*) [16])( pauVar43[1] + 8 ) = (undefined1[16])0x0;*(undefined1(*) [16])( pauVar43[2] + 8 ) = (undefined1[16])0x0;*(int*)pauVar43[1] = iVar44;*(undefined8*)( pauVar43[3] + 8 ) = uVar37;puVar2 = *(undefined8**)( this + 0x20 );if (puVar2 == (undefined8*)0x0) {
...
uVar54 = 0;lVar56 = *(long*)( this + 0x10 );lVar46 = *(long*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( this + 0x28 ) * 8 );uVar39 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );uVar53 = CONCAT44(0, uVar39);auVar16._8_8_ = 0;auVar16._0_8_ = uVar41 * lVar46;auVar32._8_8_ = 0;auVar32._0_8_ = uVar53;lVar49 = SUB168(auVar16 * auVar32, 8);lVar48 = *(long*)( this + 8 );puVar1 = (uint*)( lVar56 + lVar49 * 4 );iVar44 = SUB164(auVar16 * auVar32, 8);uVar38 = *puVar1;pauVar36 = pauVar43;while (uVar38 != 0) {
   auVar17._8_8_ = 0;
...
;*(undefined1(**) [16])( lVar48 + lVar49 * 8 ) = pauVar36;*puVar1 = uVar40;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_00101301:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return pauVar43[1] + 8;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashSet<StringName, HashMapHasherDefault, HashMapComparatorDefault<StringName>
 ...
 while ( ( uVar42 != 0 ) && ( auVar5._8_8_ = 0 ),auVar5._0_8_ = (ulong)uVar42 * lVar30,auVar17._8_8_ = 0,auVar17._0_8_ = uVar29,auVar6._8_8_ = 0,auVar6._0_8_ = ( ulong )(( uVar40 + iVar33 ) - SUB164(auVar5 * auVar17, 8)) * lVar30,auVar18._8_8_ = 0,auVar18._0_8_ = uVar29,uVar37 <= SUB164(auVar6 * auVar18, 8) );
   ...
   if ((float)( iVar44 + 1 ) <= (float)uVar27 * __LC0) {
      ...
      LAB_00101ef6:uVar27 = StringName::get_empty_hash();
   }
 else {
 ...
 while ( (uint)uVar29 < *(uint*)( (long)in_RSI + 0x24 ) );
      ...
      LAB_00101d95:uVar27 = *(uint*)( lVar30 + 0x20 );
   }
 ...
 while ( uVar42 != 0 );
   ...
   *(int*)( (long)in_RSI + 0x24 ) = iVar44;
   LAB_00101eb8:*(uint*)( param_1 + 0xc ) = uVar42;
   *(long*)param_1 = lVar36;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Vector<ScriptLanguage::StackInfo>::append_array(Vector<ScriptLanguage::StackInfo>) */void Vector<ScriptLanguage::StackInfo>::append_array(Vector<ScriptLanguage::StackInfo> *this, long param_2) {
   long *plVar1;
   CowData *pCVar2;
   long *plVar3;
   ...
   if (*(long*)( this + 8 ) == 0) {
      if (-1 < (long)uVar5) {
         CowData<ScriptLanguage::StackInfo>::_copy_on_write((CowData<ScriptLanguage::StackInfo>*)( this + 8 ));
         lVar15 = 0;
         local_48 = 0;
         uVar11 = uVar5;
         goto LAB_001024e1;
      ...
      if (-1 < (long)uVar11) {
         ...
         LAB_001024e1:local_50 = (CowData<ScriptLanguage::StackInfo>*)( this + 8 );
         if (uVar11 * 0x18 != 0) {
...
;
               ...
               if (lVar17 == local_48) {
                  LAB_001027ef:puVar16 = *(undefined8**)( this + 8 );
                  if (puVar16 == (undefined8*)0x0) {
                     LAB_001028cf:/* WARNING: Does not return */pcVar6 = (code*)invalidInstructionException();
                     ( *pcVar6 )();
                  }

                  lVar17 = puVar16[-1];
                  if (lVar17 < (long)uVar11) goto LAB_00102806;
               }
 else {
                  if (lVar15 != 0) {
                     iVar7 = CowData<ScriptLanguage::StackInfo>::_realloc(local_50, lVar17);
                  ...
                  *(undefined8**)( this + 8 ) = puVar16;
                  LAB_00102806:pauVar4 = (undefined1(*) [16])( puVar16 + uVar11 * 3 );
                  ...
                  if (( (int)pauVar4 - (int)pauVar10 & 8U ) != 0) {
                     *pauVar10 = (undefined1[16])0x0;
                     ...
                     if ((undefined1(*) [16])( pauVar10[1] + 8 ) == pauVar4) goto LAB_00102848;
                  }
 ...
 while ( pauVar10 != pauVar4 );
   ...
   LAB_00102608:local_50 = (CowData<ScriptLanguage::StackInfo>*)( this + 8 );
   if (0 < (long)uVar5) {
      uVar11 = 0;
      lVar15 = lVar15 * 0x18;
      do {
         ...
         if (lVar17 == 0) {
            lVar12 = 0;
            LAB_00102696:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar11, lVar12, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar6 = (code*)invalidInstructionException();
            ( *pcVar6 )();
         ...
         if (lVar12 <= (long)uVar11) goto LAB_00102696;
...
/* WARNING: Control flow encountered bad instruction data *//* Vector<ScriptLanguage::StackInfo>::~Vector() */void Vector<ScriptLanguage::StackInfo>::~Vector(Vector<ScriptLanguage::StackInfo> *this) {

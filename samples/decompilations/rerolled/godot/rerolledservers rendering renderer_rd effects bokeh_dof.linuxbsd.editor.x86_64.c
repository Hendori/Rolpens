...
/* RendererRD::BokehDOF::~BokehDOF() */void RendererRD::BokehDOF::~BokehDOF(BokehDOF *this) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RendererRD::BokehDOF::BokehDOF(bool) */void RendererRD::BokehDOF::BokehDOF(BokehDOF *this, bool param_1) {
   ShaderRD *this_00;
   long *plVar1;
   ShaderRD *this_01;
   ulong uVar2;
...
;
         ...
         if (*(long*)( this + 0x80 ) == 0) {
            lVar8 = 0;
            LAB_00101563:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, uVar10, lVar8, "p_variant", "variant_defines.size()", pcVar20, false, false);
            LAB_00101599:uVar11 = 0;
         }
 else {
            ...
            if (*(char*)( lVar8 + uVar10 ) != '\0') {
               if (( uVar2 == 0 ) || ( *(uint*)( this + 0x13c ) <= (uint)uVar2 )) {
                  LAB_00101620:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
                  uVar11 = 0;
                  goto LAB_0010123d;
               }

               lVar8 = ( ( uVar2 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x138 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x128 ) + ( ( uVar2 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x138 ) ) * 8 );
 ...
 while ( lVar9 != 0 );
         ...
         LAB_0010123d:uVar6 = RenderingDevice::compute_pipeline_create(uVar6, uVar11, puVar17);
 ...
 while ( pBVar22 != pBVar14 );
      LAB_00101028:CowData<String>::_unref((CowData<String>*)&local_150);
 ...
 while ( iVar12 != iVar13 );
   ...
   if (*(long*)( this + 0x1f8 ) == 0) {
      lVar8 = 0;
      LAB_00101523:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, uVar10, lVar8, "p_variant", "variant_defines.size()", pcVar20, false, false);
   }
 else {
      ...
      if (lVar9 <= (long)uVar10) goto LAB_00101670;
      if (*(char*)( lVar8 + uVar10 ) == '\0') {
         _err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa7, "Condition \"!variants_enabled[p_variant]\" is true. Returning: RID()", 0, 0, puVar17, pSVar18, pBVar14, pcVar20, pSVar21, pSVar19);
         uVar6 = 0;
         goto LAB_00100f37;
      }

      if (( uVar2 == 0 ) || ( *(uint*)( this + 0x2b4 ) <= (uint)uVar2 )) {
         LAB_001017a8:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0, puVar17, pSVar18, pBVar14, pcVar20, pSVar21, pSVar19);
         uVar6 = 0;
         goto LAB_00100f37;
      }

      lVar8 = ( ( uVar2 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x2b0 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x2a0 ) + ( ( uVar2 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x2b0 ) ) * 8 );
      if (*(int*)( lVar8 + 0x98 ) != (int)( uVar2 >> 0x20 )) {
         if (*(int*)( lVar8 + 0x98 ) + 0x80000000U < 0x7fffffff) {
            _err_print_error("get_or_null", "./core/templates/rid_owner.h", 0x103, "Method/function failed. Returning: nullptr", "Attempting to use an uninitialized RID", 0, 0);
         }
 ...
 while ( lVar9 != 0 );
      ...
      if (*(long*)( lVar15 + uVar7 * 8 ) == 0) {
         ...
         LAB_00100f16:lVar8 = *(long*)( lVar8 + 0x88 );
   ...
   LAB_00101559:uVar6 = 0;
   LAB_00100f37:PipelineCacheRD::setup(pBVar14, uVar6, 5, pSVar21, pSVar19, puVar17, local_68, 0, local_148);
   lVar8 = local_f0;
   if (local_f0 != 0) {
      LOCK();
   ...
   goto LAB_00100ce4;
   LAB_00101718:lVar9 = 0;
   LAB_00101670:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar7, lVar9, "p_index", "size()", pcVar20, false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar3 = (code*)invalidInstructionException();
   ( *pcVar3 )();
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RendererRD::BokehDOF::bokeh_dof_compute(RendererRD::BokehDOF::BokehBuffers const&, RID, float,
   float, bool) */void RendererRD::BokehDOF::bokeh_dof_compute(undefined4 param_1_00, undefined4 param_2, BokehDOF *this, uint *param_1, undefined8 param_5, uint param_6) {
   long *plVar1;
   Version *pVVar2;
   uint uVar3;
   uint *puVar4;
   ...
   if (*this == (BokehDOF)0x0) {
      if (UniformSetCacheRD::singleton == (UniformSetCacheRD*)0x0) {
         if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
            ...
            LAB_00102b09:_err_print_error("bokeh_dof_compute", "servers/rendering/renderer_rd/effects/bokeh_dof.cpp", uVar17, pcVar20, 0, 0);
            return;
         }
      ...
      bVar9 = RendererCameraAttributes::camera_attributes_get_dof_far_enabled(RenderingServerGlobals::camera_attributes, param_5);
      fVar29 = (float)RendererCameraAttributes::camera_attributes_get_dof_far_distance(RenderingServerGlobals::camera_attributes, param_5);
      fVar30 = (float)RendererCameraAttributes::camera_attributes_get_dof_far_transition(RenderingServerGlobals::camera_attributes, param_5);
      bVar10 = RendererCameraAttributes::camera_attributes_get_dof_near_enabled(RenderingServerGlobals::camera_attributes, param_5);
      fVar31 = (float)RendererCameraAttributes::camera_attributes_get_dof_near_distance(RenderingServerGlobals::camera_attributes, param_5);
      fVar32 = (float)RendererCameraAttributes::camera_attributes_get_dof_near_transition(RenderingServerGlobals::camera_attributes, param_5);
      fVar33 = (float)RendererCameraAttributes::camera_attributes_get_dof_blur_amount(RenderingServerGlobals::camera_attributes, param_5);
      ...
      *(undefined8*)( this + 0x60 ) = 0;
      ...
      for (uVar18 = ( ulong )(( uVar7 - (int)(undefined8*)( ( ulong )(this + 0x10) & 0xfffffffffffffff8 ) ) + 0x60 >> 3); uVar18 != 0; uVar18 = uVar18 - 1) {
         *puVar22 = 0;
      ...
      *(undefined4*)( this + 0x20 ) = 0x3f000000;
      ...
      if (iVar12 == 0) {
         do {
            if (uVar18 == 0) {
               lVar25 = 0;
               LAB_0010267b:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar23, lVar25, "p_index", "size()", "", false, false);
            }
 else {
 ...
 while ( !bVar27 );
      ...
      if (iVar12 == 0) {
         ...
         do {
            if (uVar18 == 0) {
               lVar25 = 0;
               LAB_0010262b:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar23, lVar25, "p_index", "size()", "", false, false);
            }
 else {
               lVar25 = *(long*)( uVar18 + -8 );
 ...
 while ( !bVar27 );
      ...
      if (iVar12 == 0) {
         ...
         do {
            if (uVar18 == 0) {
               lVar25 = 0;
               LAB_00102713:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar23, lVar25, "p_index", "size()", "", false, false);
            }
 else {
               lVar25 = *(long*)( uVar18 + -8 );
 ...
 while ( !bVar27 );
      ...
      if (iVar12 == 0) {
         ...
         do {
            if (uVar18 == 0) {
               lVar25 = 0;
               LAB_001026c3:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar23, lVar25, "p_index", "size()", "", false, false);
            }
 else {
               lVar25 = *(long*)( uVar18 + -8 );
 ...
 while ( !bVar27 );
      ...
      if (iVar12 == 0) {
         do {
            if (uVar18 == 0) {
               lVar13 = 0;
               LAB_001025e3:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar23, lVar13, "p_index", "size()", "", false, false);
            }
 else {
 ...
 while ( !bVar27 );
      ...
      if (*(long*)( this + 0x80 ) == 0) {
         lVar13 = 0;
         LAB_00102763:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 0, lVar13, "p_variant", "variant_defines.size()", "", false, false);
         LAB_001027a0:_err_print_error("bokeh_dof_compute", "servers/rendering/renderer_rd/effects/bokeh_dof.cpp", 0x9b, "Condition \"shader.is_null()\" is true.", 0, 0);
      }
 else {
         ...
         if (pcVar20 == (char*)0x0) {
            LAB_00102a80:lVar13 = 0;
            LAB_00102a83:uVar18 = 0;
            LAB_00102aa0:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar18, lVar13, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
         ...
         if (( uVar18 == 0 ) || ( *(uint*)( this + 0x13c ) <= (uint)uVar18 )) {
            LAB_00102810:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
            goto LAB_001027a0;
         }

         lVar23 = ( ( uVar18 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x138 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x128 ) + ( ( uVar18 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x138 ) ) * 8 );
 ...
 while ( lVar13 != 0 );
         ...
         RenderingDevice::compute_list_bind_compute_pipeline(uVar15, pvVar14, *(undefined8*)( this + 0x360 ));
         uVar15 = RenderingDevice::get_singleton();
         local_88 = uVar16;
         ...
         *(uint*)( this + 0xc ) = param_1[1];
         ...
         if (uVar26 < 2) {
            ...
            if (*(long*)( this + 0x80 ) == 0) {
               lVar13 = 0;
               LAB_00103f7d:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, uVar24, lVar13, "p_variant", "variant_defines.size()", "", false, false);
            }
 else {
               lVar13 = *(long*)( *(long*)( this + 0x80 ) + -8 );
               ...
               if (( uVar5 == 0 ) || ( *(uint*)( this + 0x13c ) <= (uint)uVar5 )) {
                  LAB_00104148:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
               }
 else {
                  lVar23 = ( ( uVar5 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x138 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x128 ) + ( ( uVar5 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x138 ) ) * 8 );
 ...
 while ( lVar13 != 0 );
                  ...
                  if (*(char*)( lVar23 + 0x90 ) != '\0') {
                     ...
                     uVar16 = RenderingDevice::get_singleton();
                     RenderingDevice::compute_list_bind_compute_pipeline(uVar16, pvVar14, *(undefined8*)( this + (long)(int)uVar26 * 8 + 0x360 ));
                     *(undefined4*)( this + 0x24 ) = *(undefined4*)( bokeh_dof_raster(RendererRD::BokehDOF::BokehBuffers_const&,RID,float,float,bool)
                     :: );
                     if (uVar3 < 2) {
                        uVar16 = RenderingDevice::get_singleton();
                        local_68[0] = 0;
                        ...
                        local_78 = local_d8;
                        if (local_c8[0] == 0) {
                           uVar15 = UniformSetCacheRD::get_cache<RenderingDevice::Uniform>(pUVar8, lVar13, 0, &local_88);
                        ...
                        local_78 = 0;
                        if (local_218[0] == 0) {
                           uVar17 = UniformSetCacheRD::get_cache<RenderingDevice::Uniform>(pUVar8, lVar13, 1, &local_88);
                        ...
                        *(float*)( this + 0x1c ) = fVar33;
                        ...
                        lVar23 = RenderingDevice::get_singleton();
                        RenderingDevice::compute_list_dispatch_threads(lVar23, uVar11, *(uint*)( this + 8 ), *(uint*)( this + 0xc ));
                        lVar23 = RenderingDevice::get_singleton();
                        ...
                        *(undefined4*)( this + 0x40 ) = 1;
                        ...
                        local_78 = local_198;
                        if (local_188[0] == 0) {
                           uVar16 = UniformSetCacheRD::get_cache<RenderingDevice::Uniform>(pUVar8, lVar13, 1, &local_88);
                        ...
                        RenderingDevice::compute_list_set_push_constant(lVar13, pvVar14, uVar7);
                        lVar13 = RenderingDevice::get_singleton();
                        RenderingDevice::compute_list_dispatch_threads(lVar13, uVar11, *(uint*)( this + 8 ), *(uint*)( this + 0xc ));
                        lVar13 = RenderingDevice::get_singleton();
                        RenderingDevice::compute_list_add_barrier(lVar13);
                        uVar18 = *(ulong*)( this + 0x358 );
                        if (*(long*)( this + 0x80 ) == 0) {
                           lVar13 = 0;
                           LAB_0010429e:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 6, lVar13, "p_variant", "variant_defines.size()", "", false, false);
                        }
 else {
                           lVar13 = *(long*)( *(long*)( this + 0x80 ) + -8 );
                           ...
                           if (( uVar18 == 0 ) || ( *(uint*)( this + 0x13c ) <= (uint)uVar18 )) {
                              LAB_00104347:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
                           }
 else {
                              lVar23 = ( ( uVar18 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x138 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x128 ) + ( ( uVar18 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x138 ) ) * 8 );
                              if (*(int*)( lVar23 + 0x98 ) != (int)( uVar18 >> 0x20 )) {
 ...
 while ( lVar13 != 0 );
                              ...
                              if (*(char*)( lVar23 + 0x90 ) != '\0') {
                                 ...
                                 if (lVar13 != 0) {
                                    uVar17 = RenderingDevice::get_singleton();
                                    RenderingDevice::compute_list_bind_compute_pipeline(uVar17, pvVar14, *(undefined8*)( this + 0x390 ));
                                    uVar17 = RenderingDevice::get_singleton();
                                    local_68[0] = 0;
                                    local_88 = local_148;
                        ...
                        LAB_00103afa:_err_print_error("bokeh_dof_compute", "servers/rendering/renderer_rd/effects/bokeh_dof.cpp", 0xe0, "Condition \"shader.is_null()\" is true.", 0, 0);
                     }
 else {
                        uVar16 = RenderingDevice::get_singleton();
                        local_68[0] = 0;
                        ...
                        *(undefined4*)( this + 0x40 ) = 1;
                        ...
                        lVar13 = RenderingDevice::get_singleton();
                        RenderingDevice::compute_list_add_barrier(lVar13);
                        LAB_0010337c:RenderingDevice::get_singleton();
            ...
            LAB_001029af:_err_print_error("bokeh_dof_compute", "servers/rendering/renderer_rd/effects/bokeh_dof.cpp", 0xae, "Condition \"shader.is_null()\" is true.", 0, 0);
         }
 else {
            uVar18 = *(ulong*)( this + 0x358 );
            if (*(long*)( this + 0x80 ) == 0) {
               lVar13 = 0;
               LAB_00103df5:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 5, lVar13, "p_variant", "variant_defines.size()", "", false, false);
            }
 else {
               lVar13 = *(long*)( *(long*)( this + 0x80 ) + -8 );
               ...
               lVar23 = *(long*)( this + 0x90 );
               if (lVar23 == 0) {
                  LAB_001033a0:lVar13 = 0;
                  LAB_001033a3:uVar18 = 5;
                  goto LAB_00102aa0;
               }
 ...
 while ( lVar13 != 0 );
                  ...
                  uVar16 = RenderingDevice::get_singleton();
                  RenderingDevice::compute_list_bind_compute_pipeline(uVar16, pvVar14, *(undefined8*)( this + 0x388 ));
                  *(undefined4*)( this + 0x24 ) = 0;
                  *(undefined4*)( this + 0x20 ) = *(undefined4*)( bokeh_dof_raster(RendererRD::BokehDOF::BokehBuffers_const&,RID,float,float,bool)
                   :: );
                  uVar16 = RenderingDevice::get_singleton();
                  local_68[0] = 0;
                  local_88 = local_e8;
                  ...
                  *(int*)( this + 0xc ) = (int)uVar26 >> 1;
                  ...
                  if (*(long*)( this + 0x80 ) == 0) {
                     lVar13 = 0;
                     LAB_00103fbf:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 6, lVar13, "p_variant", "variant_defines.size()", "", false, false);
                  }
 else {
                     lVar13 = *(long*)( *(long*)( this + 0x80 ) + -8 );
                     ...
                     lVar23 = *(long*)( this + 0x90 );
                     if (lVar23 == 0) {
                        LAB_00103628:lVar13 = 0;
                        LAB_0010362b:uVar18 = 6;
                        goto LAB_00102aa0;
                     }
                     ...
                     if (( uVar18 == 0 ) || ( *(uint*)( this + 0x13c ) <= (uint)uVar18 )) {
                        LAB_001041b0:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
                     }
 else {
                        lVar23 = ( ( uVar18 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x138 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x128 ) + ( ( uVar18 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x138 ) ) * 8 );
                        if (*(int*)( lVar23 + 0x98 ) != (int)( uVar18 >> 0x20 )) {
 ...
 while ( lVar13 != 0 );
                        ...
                        if (*(char*)( lVar23 + 0x90 ) != '\0') {
                           ...
                           if (lVar13 != 0) {
                              ...
                              local_78 = local_198;
                              if (local_188[0] == 0) {
                                 LAB_00103c6f:local_68[0] = 0;
                                 uVar16 = UniformSetCacheRD::get_cache<RenderingDevice::Uniform>(pUVar8, lVar13, 1, &local_88);
                                 RenderingDevice::compute_list_bind_uniform_set(uVar17, pvVar14, uVar16, 1);
                              }
 else {
                                 pCVar21 = (CowData*)local_188;
                                 LAB_0010351f:local_68[0] = 0;
                  ...
                  LAB_00102e6a:_err_print_error("bokeh_dof_compute", "servers/rendering/renderer_rd/effects/bokeh_dof.cpp", 0x111, "Condition \"shader.is_null()\" is true.", 0, 0);
                  goto joined_r0x00103394;
               }

               LAB_00103f50:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
            }

            LAB_0010228d:_err_print_error("bokeh_dof_compute", "servers/rendering/renderer_rd/effects/bokeh_dof.cpp", 0xf4, "Condition \"shader.is_null()\" is true.", 0, 0);
         }

         joined_r0x00103394:if (local_98[0] != 0) {
            LOCK();
      ...
      _err_print_error("bokeh_dof_compute", "servers/rendering/renderer_rd/effects/bokeh_dof.cpp", 0x58, "Condition \"prefer_raster_effects\" is true.", "Can\'t use compute version of bokeh depth of field with the mobile renderer.", 0, 0);
   }
   ...
   LAB_00104371:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RendererRD::BokehDOF::bokeh_dof_raster(RendererRD::BokehDOF::BokehBuffers const&, RID, float,
   float, bool) */void RendererRD::BokehDOF::bokeh_dof_raster(undefined4 param_1_00, undefined4 param_2, BokehDOF *this, int *param_1, undefined8 param_5, uint param_6) {
   long *plVar1;
   Version *pVVar2;
   BokehDOF BVar3;
   uint uVar4;
   ...
   local_58[3] = *(long*)( in_FS_OFFSET + 0x28 );
   if (*this == (BokehDOF)0x0) {
      _err_print_error("bokeh_dof_raster", "servers/rendering/renderer_rd/effects/bokeh_dof.cpp", 0x126, "Condition \"!prefer_raster_effects\" is true.", "Can\'t blur-based depth of field with the clustered renderer.", 0, 0);
   }
 else {
      if (UniformSetCacheRD::singleton == (UniformSetCacheRD*)0x0) {
         if (local_58[3] == *(long*)( in_FS_OFFSET + 0x28 )) {
            ...
            LAB_0010641b:_err_print_error("bokeh_dof_raster", "servers/rendering/renderer_rd/effects/bokeh_dof.cpp", uVar20, pcVar24, 0, 0);
            return;
         }
      ...
      cVar12 = RendererCameraAttributes::camera_attributes_get_dof_far_enabled(RenderingServerGlobals::camera_attributes, param_5);
      fVar36 = (float)RendererCameraAttributes::camera_attributes_get_dof_far_distance(RenderingServerGlobals::camera_attributes, param_5);
      fVar37 = (float)RendererCameraAttributes::camera_attributes_get_dof_far_transition(RenderingServerGlobals::camera_attributes, param_5);
      cVar13 = RendererCameraAttributes::camera_attributes_get_dof_near_enabled(RenderingServerGlobals::camera_attributes, param_5);
      fVar38 = (float)RendererCameraAttributes::camera_attributes_get_dof_near_distance(RenderingServerGlobals::camera_attributes, param_5);
      fVar39 = (float)RendererCameraAttributes::camera_attributes_get_dof_near_transition(RenderingServerGlobals::camera_attributes, param_5);
      fVar40 = (float)RendererCameraAttributes::camera_attributes_get_dof_blur_amount(RenderingServerGlobals::camera_attributes, param_5);
      ...
      *(undefined8*)( this + 0x60 ) = 0;
      ...
      for (uVar23 = ( ulong )(( uVar10 - (int)(undefined8*)( ( ulong )(this + 0x10) & 0xfffffffffffffff8 ) ) + 0x60 >> 3); uVar23 != 0; uVar23 = uVar23 - 1) {
         *puVar26 = 0;
      ...
      *(float*)( this + 0x1c ) = fVar40;
      ...
      if (iVar14 == 0) {
         do {
            if (uVar23 == 0) {
               lVar32 = 0;
               LAB_00105873:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar28, lVar32, "p_index", "size()", "", false, false);
            }
 else {
 ...
 while ( !bVar34 );
      ...
      if (iVar14 == 0) {
         ...
         do {
            if (uVar23 == 0) {
               lVar32 = 0;
               LAB_00105733:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar28, lVar32, "p_index", "size()", "", false, false);
            }
 else {
               lVar32 = *(long*)( uVar23 + -8 );
 ...
 while ( !bVar34 );
      ...
      if (iVar14 == 0) {
         ...
         do {
            if (uVar23 == 0) {
               lVar32 = 0;
               LAB_00105783:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar28, lVar32, "p_index", "size()", "", false, false);
            }
 else {
               lVar32 = *(long*)( uVar23 + -8 );
 ...
 while ( !bVar34 );
      ...
      if (iVar14 == 0) {
         ...
         do {
            if (uVar23 == 0) {
               lVar32 = 0;
               LAB_00105953:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar28, lVar32, "p_index", "size()", "", false, false);
            }
 else {
               lVar32 = *(long*)( uVar23 + -8 );
 ...
 while ( !bVar34 );
      ...
      if (iVar14 == 0) {
         ...
         do {
            if (uVar23 == 0) {
               lVar32 = 0;
               LAB_00105903:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar28, lVar32, "p_index", "size()", "", false, false);
            }
 else {
               lVar32 = *(long*)( uVar23 + -8 );
 ...
 while ( !bVar34 );
      ...
      if (iVar14 == 0) {
         ...
         do {
            if (uVar23 == 0) {
               lVar32 = 0;
               LAB_001057d3:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar28, lVar32, "p_index", "size()", "", false, false);
            }
 else {
               lVar32 = *(long*)( uVar23 + -8 );
 ...
 while ( !bVar34 );
      ...
      if (iVar14 == 0) {
         ...
         do {
            if (uVar23 == 0) {
               lVar32 = 0;
               LAB_001056e3:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar28, lVar32, "p_index", "size()", "", false, false);
            }
 else {
               lVar32 = *(long*)( uVar23 + -8 );
 ...
 while ( !bVar34 );
      ...
      if (iVar14 == 0) {
         do {
            if (uVar23 == 0) {
               lVar32 = 0;
               LAB_00105823:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar28, lVar32, "p_index", "size()", "", false, false);
            }
 else {
               lVar32 = *(long*)( uVar23 + -8 );
 ...
 while ( !bVar34 );
      ...
      if (iVar14 == 0) {
         ...
         do {
            if (uVar23 == 0) {
               lVar28 = 0;
               LAB_001058bb:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar16, lVar28, "p_index", "size()", "", false, false);
            }
 else {
 ...
 while ( !bVar34 );
      ...
      *(ulong*)( this + 0x38 ) = CONCAT44(fVar37 + fVar36, fVar36);
      if (cVar13 != '\0') {
         LAB_00104ba2:*(undefined4*)( this + 0x28 ) = 1;
      ...
      if (*(long*)( this + 0x1f8 ) == 0) {
         lVar16 = 0;
         LAB_0010695e:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 0, lVar16, "p_variant", "variant_defines.size()", "", false, false);
         LAB_001069a0:_err_print_error("bokeh_dof_raster", "servers/rendering/renderer_rd/effects/bokeh_dof.cpp", 0x162, "Condition \"shader.is_null()\" is true.", 0, 0);
      }
 else {
         ...
         if (pcVar24 == (char*)0x0) {
            LAB_0010643f:lVar16 = 0;
            LAB_00106442:uVar23 = 0;
            LAB_0010645f:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar23, lVar16, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
         ...
         if (( uVar23 == 0 ) || ( *(uint*)( this + 0x2b4 ) <= (uint)uVar23 )) {
            LAB_00107746:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
            goto LAB_001069a0;
         }

         lVar28 = ( ( uVar23 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x2b0 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x2a0 ) + ( ( uVar23 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x2b0 ) ) * 8 );
 ...
 while ( lVar16 != 0 );
         ...
         local_58[1] = 0;
         local_80 = 0;
         pvVar18 = (void*)RenderingDevice::draw_list_begin(_LC74, uVar17, uVar20, 0, &local_88, 0, local_58, 0);
         uVar23 = local_80;
         if (local_80 != 0) {
            LOCK();
            plVar1 = (long*)( local_80 + -0x10 );
...
;
            if (*(uint*)( this + 0x4c8 ) != 0) {
               ...
               do {
                  if (( ( ( *plVar22 == -1 ) && ( lVar28 == plVar22[1] ) ) && ( this[0x3e6] == *(BokehDOF*)( (long)plVar22 + 0x14 ) ) ) && ( ( (int)plVar22[2] == 0 && ( (int)plVar22[3] == 0 ) ) )) {
                     lVar28 = plVar22[4];
 ...
 while ( plVar22 != plVar1 );
            ...
            lVar28 = PipelineCacheRD::_generate_version((long)pBVar29, -1, SUB81(lVar28, 0), (uint)(byte)this[0x3e6], 0);
            this[0x398] = (BokehDOF)0x0;
         }

         LAB_00105af0:RenderingDevice::draw_list_bind_render_pipeline(uVar17, pvVar18, lVar28);
         ...
         if (uVar15 < 2) {
            ...
            if (*(long*)( this + 0x1f8 ) == 0) {
               lVar16 = 0;
               LAB_001069cd:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, uVar30, lVar16, "p_variant", "variant_defines.size()", "", false, false);
               LAB_00106a07:_err_print_error("bokeh_dof_raster", "servers/rendering/renderer_rd/effects/bokeh_dof.cpp", 0x174, "Condition \"shader.is_null()\" is true.", 0, 0);
            }
 else {
               lVar16 = *(long*)( *(long*)( this + 0x1f8 ) + -8 );
               ...
               if (( uVar31 == 0 ) || ( *(uint*)( this + 0x2b4 ) <= (uint)uVar31 )) {
                  LAB_00107c84:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
                  goto LAB_00106a07;
               }

               lVar28 = ( ( uVar31 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x2b0 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x2a0 ) + ( ( uVar31 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x2b0 ) ) * 8 );
 ...
 while ( lVar16 != 0 );
               ...
               if (uVar4 < 2) {
                  ...
                  *(int*)( this + 0xc ) = iVar14 >> 1;
                  uVar5 = *(undefined4*)( bokeh_dof_raster(RendererRD::BokehDOF::BokehBuffers_const&,RID,float,float,bool)
                      :: );
                  *(float*)( this + 0x1c ) = *(float*)( this + 0x1c ) * fVar36;
                  *(undefined4*)( this + 0x24 ) = uVar5;
                  LAB_0010754c:uVar20 = *(undefined8*)( param_1 + 0x10 );
               }
 else {
                  *(undefined4*)( this + 0x20 ) = 0x3f000000;
                  *(undefined4*)( this + 0x24 ) = *(undefined4*)( bokeh_dof_raster(RendererRD::BokehDOF::BokehBuffers_const&,RID,float,float,bool)
...
;
                  if (*(uint*)( this + lVar28 * 0x138 + 0x4c8 ) != 0) {
                     ...
                     do {
                        if (( ( ( *plVar22 == -1 ) && ( lVar16 == plVar22[1] ) ) && ( this[lVar28 * 0x138 + 0x3e6] == *(BokehDOF*)( (long)plVar22 + 0x14 ) ) ) && ( ( (int)plVar22[2] == 0 && ( (int)plVar22[3] == 0 ) ) )) {
                           lVar16 = plVar22[4];
 ...
 while ( plVar1 != plVar22 );
                  ...
                  lVar16 = PipelineCacheRD::_generate_version((long)pBVar29, -1, SUB81(lVar16, 0), (uint)(byte)this[lVar28 * 0x138 + 0x3e6], 0);
                  *pBVar29 = (BokehDOF)0x0;
               }

               LAB_0010600a:RenderingDevice::draw_list_bind_render_pipeline(uVar17, pvVar18, lVar16);
               uVar20 = RenderingDevice::get_singleton();
               local_68[0] = 0;
               local_88 = uVar7;
               local_80 = local_80 & 0xffffffffffffff00;
               local_78 = 0;
               if (local_278[0] == 0) {
                  uVar17 = UniformSetCacheRD::get_cache<RenderingDevice::Uniform>(pUVar11, local_2b8, 0, &local_88);
                  RenderingDevice::draw_list_bind_uniform_set(uVar20, pvVar18, uVar17, 0);
               }
 else {
               ...
               local_78 = local_198;
               if (local_188[0] == 0) {
                  uVar17 = UniformSetCacheRD::get_cache<RenderingDevice::Uniform>(pUVar11, local_2b8, 1, &local_88);
               ...
               if (*(int*)( this + 0x44 ) == 0) {
                  ...
                  if (*(long*)( this + 0x1f8 ) == 0) {
                     lVar16 = 0;
                     LAB_00108033:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, uVar31, lVar16, "p_variant", "variant_defines.size()", "", false, false);
                  }
 else {
                     lVar16 = *(long*)( *(long*)( this + 0x1f8 ) + -8 );
                     ...
                     if (( uVar7 == 0 ) || ( *(uint*)( this + 0x2b4 ) <= (uint)uVar7 )) {
                        LAB_00107f98:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
                     }
 else {
                        lVar28 = *(long*)( *(long*)( this + 0x2a0 ) + ( ( uVar7 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x2b0 ) ) * 8 ) + ( ( uVar7 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x2b0 ) ) * 0xa0;
                        if (*(int*)( lVar28 + 0x98 ) != (int)( uVar7 >> 0x20 )) {
                           if (*(int*)( lVar28 + 0x98 ) + 0x80000000U < 0x7fffffff) {
                              _err_print_error("get_or_null", "./core/templates/rid_owner.h", 0x103, "Method/function failed. Returning: nullptr", "Attempting to use an uninitialized RID", 0, 0, *(long*)( this + 0x2a0 ));
                           }
 ...
 while ( lVar16 != 0 );
                  ...
                  LAB_00106305:_err_print_error("bokeh_dof_raster", "servers/rendering/renderer_rd/effects/bokeh_dof.cpp", 0x195, "Condition \"shader.is_null()\" is true.", 0, 0);
               }
 else {
                  *(undefined4*)( this + 0x40 ) = 1;
                  LAB_00106b7d:uVar20 = *(undefined8*)( param_1 + 0x12 );
                  ...
                  local_d8 = local_1f8;
                  if (local_1e8[0] == 0) {
                     LAB_00106be7:puVar21 = &local_148;
                  }
 else {
                     LAB_00106bcf:local_c8[0] = 0;
                     CowData<RID>::_ref((CowData<RID>*)local_c8, pCVar25);
                     if (*(int*)( this + 0x44 ) != 0) goto LAB_00106be7;
                     LAB_001076d2:puVar21 = &local_178;
                  }
...
;
                     if (*(uint*)( this + (long)(int)uVar33 * 0x138 + 0x4c8 ) != 0) {
                        ...
                        do {
                           if (( ( ( *plVar22 == -1 ) && ( lVar16 == plVar22[1] ) ) && ( this[(long)(int)uVar33 * 0x138 + 0x3e6] == *(BokehDOF*)( (long)plVar22 + 0x14 ) ) ) && ( ( (int)plVar22[2] == 0 && ( (int)plVar22[3] == 0 ) ) )) {
                              lVar16 = plVar22[4];
                              *pBVar29 = (BokehDOF)0x0;
                              goto LAB_00106d78;
                           }
 ...
 while ( plVar1 != plVar22 );
                     ...
                     lVar16 = PipelineCacheRD::_generate_version((long)pBVar29, -1, SUB81(lVar16, 0), (uint)(byte)this[(long)(int)uVar33 * 0x138 + 0x3e6], 0);
                     *pBVar29 = (BokehDOF)0x0;
                  }

                  LAB_00106d78:RenderingDevice::draw_list_bind_render_pipeline(uVar17, pvVar18, lVar16);
                  uVar20 = RenderingDevice::get_singleton();
                  local_68[0] = 0;
                  local_88 = local_e8;
                  local_80 = CONCAT71(local_80._1_7_, local_e0);
                  ...
                  if (*(int*)( this + 0x44 ) != 0) {
                     ...
                     if (*(long*)( this + 0x1f8 ) == 0) {
                        lVar16 = 0;
                        LAB_00107fc5:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 6, lVar16, "p_variant", "variant_defines.size()", "", false, false);
                     }
 else {
                        lVar16 = *(long*)( *(long*)( this + 0x1f8 ) + -8 );
                        ...
                        lVar28 = *(long*)( this + 0x208 );
                        if (lVar28 == 0) {
                           LAB_001078b3:lVar16 = 0;
                           LAB_001078b6:uVar23 = 6;
                           goto LAB_0010645f;
                        }
                        ...
                        if (( uVar23 == 0 ) || ( *(uint*)( this + 0x2b4 ) <= (uint)uVar23 )) {
                           LAB_001080ac:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
                        }
 else {
                           lVar28 = ( ( uVar23 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x2b0 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x2a0 ) + ( ( uVar23 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x2b0 ) ) * 8 );
                           if (*(int*)( lVar28 + 0x98 ) != (int)( uVar23 >> 0x20 )) {
                              ...
                              if (uVar15 < 0x7fffffff) {
                                 _err_print_error("get_or_null", "./core/templates/rid_owner.h", 0x103, "Method/function failed. Returning: nullptr", "Attempting to use an uninitialized RID", 0, 0, uVar15);
                              }
...
;
                                    if (*(uint*)( this + 0xc18 ) != 0) {
                                       ...
                                       do {
                                          if (( ( ( *plVar22 == -1 ) && ( lVar28 == plVar22[1] ) ) && ( this[0xb36] == *(BokehDOF*)( (long)plVar22 + 0x14 ) ) ) && ( ( (int)plVar22[2] == 0 && ( (int)plVar22[3] == 0 ) ) )) {
                                             lVar28 = plVar22[4];
 ...
 while ( plVar1 != plVar22 );
                                    ...
                                    lVar28 = PipelineCacheRD::_generate_version((long)pBVar29, -1, SUB81(lVar28, 0), (uint)(byte)this[0xb36], 0);
                                    this[0xae8] = (BokehDOF)0x0;
                                 }

                                 LAB_00107282:RenderingDevice::draw_list_bind_render_pipeline(uVar17, pvVar18, lVar28);
                                 uVar20 = RenderingDevice::get_singleton();
                                 local_68[0] = 0;
                                 local_88 = local_1d8;
                                 local_80 = CONCAT71(local_80._1_7_, local_1d0);
                                 ...
                                 local_78 = local_108;
                                 if (local_f8[0] == 0) {
                                    uVar17 = UniformSetCacheRD::get_cache<RenderingDevice::Uniform>(pUVar11, lVar16, 1, &local_88);
                                    RenderingDevice::draw_list_bind_uniform_set(uVar20, pvVar18, uVar17, 1);
                                 }
 else {
                                    CowData<RID>::_ref((CowData<RID>*)local_68, (CowData*)local_f8);
                                 ...
                                 local_78 = local_198;
                                 if (local_188[0] == 0) {
                                    uVar17 = UniformSetCacheRD::get_cache<RenderingDevice::Uniform>(pUVar11, lVar16, 2, &local_88);
                     ...
                     LAB_0010704c:_err_print_error("bokeh_dof_raster", "servers/rendering/renderer_rd/effects/bokeh_dof.cpp", 0x1ab, "Condition \"shader.is_null()\" is true.", 0, 0);
                  }

                  joined_r0x001074fd:if (local_98[0] != 0) {
                     LOCK();
                     plVar1 = (long*)( local_98[0] + -0x10 );
                     *plVar1 = *plVar1 + -1;
                     UNLOCK();
            ...
            if (*(long*)( this + 0x1f8 ) == 0) {
               lVar16 = 0;
               LAB_00107a69:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 5, lVar16, "p_variant", "variant_defines.size()", "", false, false);
            }
 else {
               lVar16 = *(long*)( *(long*)( this + 0x1f8 ) + -8 );
               ...
               lVar28 = *(long*)( this + 0x208 );
               if (lVar28 == 0) {
                  LAB_00106ac2:lVar16 = 0;
                  LAB_00106ac5:uVar23 = 5;
                  goto LAB_0010645f;
               }
               ...
               if (( uVar23 == 0 ) || ( *(uint*)( this + 0x2b4 ) <= (uint)uVar23 )) {
                  LAB_00107b23:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
               }
 else {
                  lVar28 = ( ( uVar23 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x2b0 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x2a0 ) + ( ( uVar23 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x2b0 ) ) * 8 );
                  if (*(int*)( lVar28 + 0x98 ) != (int)( uVar23 >> 0x20 )) {
...
;
                        if (*(uint*)( this + 0xae0 ) != 0) {
                           ...
                           do {
                              if (( ( ( *plVar22 == -1 ) && ( lVar28 == plVar22[1] ) ) && ( this[0x9fe] == *(BokehDOF*)( (long)plVar22 + 0x14 ) ) ) && ( ( (int)plVar22[2] == 0 && ( (int)plVar22[3] == 0 ) ) )) {
                                 lVar28 = plVar22[4];
 ...
 while ( plVar22 != plVar1 );
                        ...
                        lVar28 = PipelineCacheRD::_generate_version((long)pBVar29, -1, SUB81(lVar28, 0), (uint)(byte)this[0x9fe], 0);
                        this[0x9b0] = (BokehDOF)0x0;
                     }

                     LAB_0010667a:RenderingDevice::draw_list_bind_render_pipeline(uVar17, pvVar18, lVar28);
                     uVar20 = RenderingDevice::get_singleton();
                     local_68[0] = 0;
                     local_88 = uVar7;
                     local_80 = local_80 & 0xffffffffffffff00;
                     ...
                     if (*(int*)( this + 0x44 ) == 0) {
                        ...
                        RendererRD::CopyEffects::copy_raster(uVar20, *(undefined8*)( param_1 + 6 ), *(undefined8*)( param_1 + 0xc ));
                        goto LAB_001055d0;
                     }
                     ...
                     if (*(long*)( this + 0x1f8 ) == 0) {
                        lVar16 = 0;
                        LAB_00107dc6:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 6, lVar16, "p_variant", "variant_defines.size()", "", false, false);
                        LAB_00106931:_err_print_error("bokeh_dof_raster", "servers/rendering/renderer_rd/effects/bokeh_dof.cpp", 0x1de, "Condition \"shader.is_null()\" is true.", 0, 0);
                        goto LAB_001055d0;
                     }
                     ...
                     if (lVar28 != 0) {
                        ...
                        if (6 < lVar16) {
                           ...
                           if (( uVar23 == 0 ) || ( *(uint*)( this + 0x2b4 ) <= (uint)uVar23 )) {
                              LAB_00107f32:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
                           }
 else {
                              lVar28 = ( ( uVar23 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x2b0 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x2a0 ) + ( ( uVar23 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x2b0 ) ) * 8 );
                              if (*(int*)( lVar28 + 0x98 ) != (int)( uVar23 >> 0x20 )) {
...
;
 ...
 while ( plVar22 != plVar1 );
                                    ...
                                    LAB_0010535a:RenderingDevice::draw_list_bind_render_pipeline(uVar17, pvVar18, lVar28);
                                    uVar20 = RenderingDevice::get_singleton();
                                    local_68[0] = 0;
                                    local_88 = local_208;
                                    local_80 = CONCAT71(local_80._1_7_, local_200);
            ...
            LAB_00105d00:_err_print_error("bokeh_dof_raster", "servers/rendering/renderer_rd/effects/bokeh_dof.cpp", 0x1c0, "Condition \"shader.is_null()\" is true.", 0, 0);
         }

      }

      LAB_001055d0:if (local_f8[0] != 0) {
         LOCK();
         plVar1 = (long*)( local_f8[0] + -0x10 );
         *plVar1 = *plVar1 + -1;
         UNLOCK();
   ...
   LAB_0010815e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* BokehDofShaderRD::~BokehDofShaderRD() */void BokehDofShaderRD::~BokehDofShaderRD(BokehDofShaderRD *this) {
...
/* BokehDofRasterShaderRD::~BokehDofRasterShaderRD() */void BokehDofRasterShaderRD::~BokehDofRasterShaderRD(BokehDofRasterShaderRD *this) {
 ...
 while ( (undefined8*)( lVar9 + ( (ulong)uVar5 + 1 + ( ulong )(uVar14 - uVar5) ) * 0x28 ) != puVar13 );
         ...
         *(uint*)pauVar1[3] = uVar4;
         ...
         do {
            ...
            if (lVar2 == 0) {
               lVar15 = 0;
               LAB_00108683:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar9, lVar15, "p_index", "size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
               pcVar3 = (code*)invalidInstructionException();
               ( *pcVar3 )();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<String>::resize<false>(long) */undefined8 CowData<String>::resize<false>(CowData<String> *this, long param_1) {
   ...
   if (param_1 * 8 == 0) {
      LAB_00108cd0:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (lVar10 == lVar7) {
      LAB_00108c4f:puVar9 = *(undefined8**)this;
      if (puVar9 == (undefined8*)0x0) {
         LAB_00108d26:/* WARNING: Does not return */pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<RID>::resize<false>(long) */undefined8 CowData<RID>::resize<false>(CowData<RID> *this, long param_1) {
   ...
   if (param_1 * 8 == 0) {
      LAB_00109410:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (lVar7 == lVar3) {
      LAB_0010937c:puVar9 = *(undefined8**)this;
      if (puVar9 == (undefined8*)0x0) {
         /* WARNING: Does not return */
         pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<RenderingDeviceCommons::PipelineColorBlendState::Attachment>::resize<false>(long)
   ...
   if (param_1 * 0x20 == 0) {
      LAB_00109810:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (lVar11 == lVar4) {
      LAB_0010977c:puVar9 = *(undefined8**)this;
      if (puVar9 == (undefined8*)0x0) {
         /* WARNING: Does not return */
         pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<RenderingDevice::Uniform>::resize<false>(long) */undefined8 CowData<RenderingDevice::Uniform>::resize<false>(CowData<RenderingDevice::Uniform> *this, long param_1) {
   ...
   if (param_1 * 0x28 == 0) {
      LAB_00109bb0:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (lVar11 == lVar9) {
      LAB_00109b23:puVar7 = *(undefined8**)this;
      if (puVar7 == (undefined8*)0x0) {
         LAB_00109c06:/* WARNING: Does not return */pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
      }
...
/* RID UniformSetCacheRD::get_cache<RenderingDevice::Uniform>(RID, unsigned int,
   ...
   uVar6 = ( (int)param_2 * 0x16a88000 | ( uint )((int)param_2 * -0x3361d2af) >> 0x11 ) * 0x1b873593 ^ 0x7f07c65;
   uVar6 = ( iVar7 * 0x16a88000 | ( uint )(iVar7 * -0x3361d2af) >> 0x11 ) * 0x1b873593 ^ ( uVar6 << 0xd | uVar6 >> 0x13 ) * 5 + 0xe6546b64;
   uVar6 = ( param_3 * 0x16a88000 | ( uint )(param_3 * -0x3361d2af) >> 0x11 ) * 0x1b873593 ^ ( uVar6 << 0xd | uVar6 >> 0x13 ) * 5 + 0xe6546b64;
   uVar6 = ( (int)*param_4 * 0x16a88000 | ( uint )((int)*param_4 * -0x3361d2af) >> 0x11 ) * 0x1b873593 ^ ( uVar6 << 0xd | uVar6 >> 0x13 ) * 5 + 0xe6546b64;
   uVar6 = ( iVar17 * 0x16a88000 | ( uint )(iVar17 * -0x3361d2af) >> 0x11 ) * 0x1b873593 ^ ( uVar6 << 0xd | uVar6 >> 0x13 ) * 5 + 0xe6546b64;
   uVar13 = ( ulong )(( uVar6 << 0xd | uVar6 >> 0x13 ) * 5 + 0xe6546b64);
   uVar11 = param_4[2];
   if (uVar11 != 0) {
      uVar15 = 1;
      LAB_0010a086:uVar14 = 0;
      do {
         uVar6 = (uint)uVar13;
         if (uVar11 == 0) {
            uVar11 = param_4[4];
            if (uVar11 == 0) {
               lVar9 = 0;
               LAB_0010a181:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar14, lVar9, "p_index", "size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
               pcVar5 = (code*)invalidInstructionException();
               ( *pcVar5 )();
            ...
            LAB_0010a0a9:iVar7 = (int)( uVar11 >> 0x20 );
            uVar8 = ( iVar7 * 0x16a88000 | ( uint )(iVar7 * -0x3361d2af) >> 0x11 ) * 0x1b873593;
            uVar6 = uVar6 ^ ( (int)uVar11 * 0x16a88000 | ( uint )((int)uVar11 * -0x3361d2af) >> 0x11 ) * 0x1b873593;
         }
 else {
 ...
 while ( true );
   ...
   if (( param_4[4] != 0 ) && ( uVar14 = *(ulong*)( param_4[4] - 8 ) ),uVar15 = uVar14 & 0xffffffff,(int)uVar14 != 0) goto LAB_0010a086;
   goto LAB_00109d80;
   LAB_0010a369:auVar16._8_8_ = 0;
   auVar16._0_8_ = *param_4;
   goto LAB_00109de0;
   LAB_0010a110:auVar16._8_8_ = 0;
   auVar16._0_8_ = *param_4;
   LAB_00109d80:uVar10 = auVar16._0_8_;
   ...
   if (lVar12 != 0) {
      LAB_00109ded:if (( ( ( *(uint*)( lVar12 + 0x10 ) == uVar6 ) && ( *(int*)( lVar12 + 0x20 ) == param_3 ) ) && ( param_2 == *(long*)( lVar12 + 0x18 ) ) ) && ( *(int*)( lVar12 + 0x30 ) == 1 )) {
            ...
            if (*(long*)( piVar3 + 4 ) == 0) {
               if (*(long*)( piVar3 + 8 ) == 0) {
                  ...
                  if (param_4[4] != 0) {
                     ...
                     joined_r0x0010a333:if (uVar8 != 0) goto LAB_00109de0;
                  }

                  LAB_0010a274:uVar10 = *(undefined8*)( lVar12 + 0x28 );
                  goto LAB_0010a057;
               }
               ...
               if (uVar11 != 0) {
                  ...
                  do {
                     ...
                     if (uVar11 == 0) {
                        ...
                        uVar14 = 0;
                        if (uVar15 == 0) {
                           LAB_00109e95:lVar4 = *(long*)( piVar3 + 8 );
                           if (lVar4 == 0) {
                              lVar9 = 0;
                              goto LAB_0010a181;
                           }
                        ...
                        uVar11 = 0;
                        LAB_00109f15:_err_print_error("get_id", "./servers/rendering/rendering_device.h", 0x3ca, "Condition \"p_idx != 0\" is true. Returning: RID()", 0, 0);
                        uVar15 = 0;
                     }
 ...
 while ( true );
      ...
      LAB_00109de0:uVar10 = auVar16._0_8_;
      lVar12 = *(long*)( lVar12 + 8 );
      if (lVar12 == 0) goto LAB_00109f35;
      goto LAB_00109ded;
   }

   LAB_00109f35:local_60 = (undefined1)param_4[1];
   local_70 = 0;
   local_48 = 0;
   local_58 = param_4[2];
   lVar9 = 1;
   ...
   iVar7 = CowData<RenderingDevice::Uniform>::resize<false>((CowData<RenderingDevice::Uniform>*)&local_70, lVar9);
   if (iVar7 == 0) {
      if (local_70 == 0) {
         lVar12 = -1;
         lVar9 = 0;
         ...
         lVar12 = lVar9 + -1;
         if (-1 < lVar12) {
            CowData<RenderingDevice::Uniform>::_copy_on_write((CowData<RenderingDevice::Uniform>*)&local_70);
   ...
   uVar10 = _allocate_from_uniforms<Vector<RenderingDevice::Uniform>>(this, param_2, param_3, uVar6, uVar6 % 0x3ffd, local_78);
   CowData<RenderingDevice::Uniform>::_unref((CowData<RenderingDevice::Uniform>*)&local_70);
   LAB_0010a057:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Control flow encountered bad instruction data *//* BokehDofRasterShaderRD::~BokehDofRasterShaderRD() */void BokehDofRasterShaderRD::~BokehDofRasterShaderRD(BokehDofRasterShaderRD *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* BokehDofShaderRD::~BokehDofShaderRD() */void BokehDofShaderRD::~BokehDofShaderRD(BokehDofShaderRD *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

      ...
      do {
         ...
         if (uVar6 != 0xff) {
            ...
            if (uVar1 >> 0x18 != 0) {
               ...
               uVar3 = ( ( ( uVar1 >> 8 & 0xff ) * uVar6 + ( uVar3 >> 8 & 0xff ) * iVar5 ) * uVar2 >> 0x18 ) << 8 | ( ( uVar1 & 0xff ) * uVar6 + ( uVar3 & 0xff ) * iVar5 ) * uVar2 >> 0x18 | ( uVar6 + iVar5 ) * 0x1000000 | ( ( ( uVar1 >> 0x10 & 0xff ) * uVar6 + ( uVar3 >> 0x10 & 0xff ) * iVar5 ) * uVar2 >> 0x18 ) << 0x10;
            }
...
void BlendPixelRowPremult(long param_1, long param_2, int param_3) {
   ...
   if (0 < param_3) {
      ...
      do {
         ...
         if (uVar1 != 0xff) {
            iVar3 = 0x100 - uVar1;
            *(uint*)( param_1 + lVar2 ) = ( ( *(uint*)( param_2 + lVar2 ) & 0xff00ff ) * iVar3 >> 8 & 0xff00ff | ( *(uint*)( param_2 + lVar2 ) >> 8 & 0xff00ff ) * iVar3 & 0xff00ff00 ) + *(uint*)( param_1 + lVar2 );
         }
      ...
      if (iVar1 == 0) {
         ...
         if (plVar3 != (long*)0x0) {
            if (param_2 == (uint*)0x0) {
               uVar7 = 1;
               uVar6 = 0;
               LAB_00100415:pcVar4 = BlendPixelRowNonPremult;
               LAB_00100269:plVar3[0x1f] = (long)pcVar4;
                     ...
                     if (lVar5 != 0) {
                        ...
                        if (lVar5 != 0) {
                           ...
                           *(undefined1(*) [16])( plVar3 + 0x28 ) = (undefined1[16])0x0;
                           plVar3[0x32] = lVar5;
                           for (int i = 0; i < 4; i++) {
                              *(undefined1(*) [16])( plVar3 + ( 2*i + 42 ) ) = (undefined1[16])0;
                           }
...
undefined8 WebPAnimDecoderGetNext(undefined8 *param_1, undefined8 *param_2, int *param_3) {
   ...
   if (( ( param_2 != (undefined8*)0x0 && param_3 != (int*)0x0 ) && ( param_1 != (undefined8*)0x0 ) ) && ( *(int*)( (long)param_1 + 0x194 ) <= *(int*)( param_1 + 0x22 ) )) {
      ...
      if (iVar5 != 0) {
         ...
         if (( ( local_98 == 1 ) || ( ( ( iStack_60 == 0 || ( iStack_5c == 1 ) ) && ( ( local_88 == uVar1 && ( uStack_84 == uVar2 ) ) ) ) ) ) || ( ( *(int*)( (long)param_1 + 0x15c ) == 1 && ( ( *(uint*)( param_1 + 0x2a ) == uVar1 && *(uint*)( (long)param_1 + 0x154 ) == uVar2 || ( *(int*)( param_1 + 0x32 ) != 0 ) ) ) ) )) {
 ...
 while ( iVar6 < (int)uStack_84 );
                  ...
                  do {
                     ...
                     if (( ( ( iVar10 < *(int*)( (long)param_1 + 0x14c ) ) || ( *(int*)( (long)param_1 + 0x14c ) + *(int*)( (long)param_1 + 0x154 ) <= iVar10 ) ) || ( iVar14 = *(int*)( param_1 + 0x2a ) + iVar11 ),iVar14 <= iStack_90 )) {
                        if (0 < (int)local_88) {
                        ...
                        LAB_00100667:lVar8 = ( ulong )(iVar14 + iVar10 * uVar1) * 4;
 ...
 while ( iVar6 < (int)uStack_84 );
            ...
            *(int*)( param_1 + 0x32 ) = local_c8;
            ...
            if (*(int*)( (long)param_1 + 0x15c ) == 1) {
               ...
               pvVar12 = (void*)( (long)(int)( *(int*)( (long)param_1 + 0x14c ) * uVar2 + *(int*)( param_1 + 0x29 ) * 4 ) + param_1[0x26] );
               if (0 < iVar6) {
                  iVar10 = 0;
                  do {
                     iVar10 = iVar10 + 1;
 ...
 while ( iVar6 != iVar10 );
   ...
   uVar7 = 0;
   LAB_001004c6:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
void WebPAnimDecoderReset(long param_1) {
   ...
   if (param_1 != 0) {
      ...
      *(undefined8*)( param_1 + 400 ) = uVar1;
      for (int i = 0; i < 4; i++) {
         *(undefined1(*) [16])( param_1 + ( 16*i + 336 ) ) = (undefined1[16])0;
      }

/* JPH::DebugRendererSimple::DrawGeometry(JPH::Mat44 const&, JPH::AABox const&, float, JPH::Color,
   ...
   JPH::DebugRenderer::ECastShadow, JPH::DebugRenderer::EDrawMode) */void JPH::DebugRendererSimple::DrawGeometry(float param_3, DebugRendererSimple *this, float *param_1, undefined1 (*param_2)[16], undefined4 param_5, long *param_6, undefined8 param_7, undefined4 param_8, int param_9) {
   float *pfVar1;
   float fVar2;
   uint uVar3;
   long *plVar4;
   ...
   if (this[0x150] != (DebugRendererSimple)0x0) {
      ...
      for (; plVar30 != plVar4 + lVar29 * 2; plVar30 = plVar30 + 2) {
         if (fVar38 * fVar38 + fVar33 * fVar33 + 0.0 + fVar36 * fVar36 <= *(float*)( plVar30 + 1 ) * *(float*)( plVar30 + 1 ) * param_3) goto LAB_001000c2;
      }

      plVar30 = plVar4 + lVar29 * 2 + -2;
   }

   LAB_001000c2:pfVar31 = *(float**)( *plVar30 + 0x18 );
   ...
   if (pfVar1 != pfVar31) {
      ...
      do {
         while (true) {
            ...
            local_98 = CONCAT44(fVar33 * fVar14 + (float)*(undefined8*)pfVar31 * fVar10 + fVar36 * fVar18 + fVar37, fVar33 * fVar13 + (float)*(undefined8*)pfVar31 * fVar9 + fVar36 * fVar17 + fVar34);
            fVar33 = pfVar31[9];
            fVar36 = pfVar31[0xb];
            fVar2 = pfVar31[0x13];
            fVar40 = fVar38 * fVar15 + fVar33 * fVar11 + fVar36 * fVar19 + fVar41;
            fVar43 = fVar38 * fVar16 + fVar33 * fVar12 + fVar36 * fVar20 + fVar44;
            local_88 = CONCAT44(fVar38 * fVar14 + fVar33 * fVar10 + fVar36 * fVar18 + fVar37, fVar38 * fVar13 + fVar33 * fVar9 + fVar36 * fVar17 + fVar34);
            fVar33 = pfVar31[0x12];
            fVar36 = pfVar31[0x14];
            fVar38 = pfVar31[8];
            ...
            uVar48 = ( undefined1 )(( ushort )(( ushort )(byte)((uint)fVar38 >> 8) * (short)( uVar3 >> 0x10 )) >> 8);
            uVar45 = ( undefined1 )(( ushort )(( ushort )(byte)((uint)fVar38 >> 0x10) * (short)( CONCAT25(uVar5, CONCAT14((char)( (uint)param_5 >> 0x10 ), param_5)) >> 0x20 )) >> 8);
            ...
            if (param_9 == 1) {
               lVar29 = *(long*)this;
               LAB_00100122:uVar21 = CONCAT44(fVar42, fVar39);
...
;
         ...
         pfVar31 = pfVar31 + 0x1b;
         ( **(code**)( lVar29 + 0x18 ) )(local_98, CONCAT44(fVar42, fVar39), local_88, CONCAT44(fVar43, fVar40), CONCAT44(fVar37, fVar34), CONCAT44(fVar44, fVar41), this, uVar32, param_8);
      }
...
/* JPH::DebugRendererSimple::CreateTriangleBatch(JPH::DebugRenderer::Vertex const*, int, unsigned
   int const*, int) */Vertex *JPH::DebugRendererSimple::CreateTriangleBatch(Vertex *param_1, int param_2, uint *param_3, int param_4) {
   uint *puVar1;
   code *pcVar2;
   undefined8 uVar3;
   long *plVar4;
   ...
   *(undefined1(*) [16])( plVar4 + 1 ) = (undefined1[16])0x0;
   if (( ( ( param_3 == (uint*)0x0 ) || ( param_4 == 0 ) ) || ( in_R8 == (uint*)0x0 ) ) || ( ( in_R9D == 0 || ( lVar8 = (long)( in_R9D / 3 ) ),lVar8 == 0 ) )) {
      *(long**)param_1 = plVar4;
   }
 else {
...
/* JPH::DebugRendererSimple::CreateTriangleBatch(JPH::DebugRenderer::Triangle const*, int) */Triangle *JPH::DebugRendererSimple::CreateTriangleBatch(Triangle *param_1, int param_2) {
   undefined8 uVar1;
   undefined8 uVar2;
   long *plVar3;
   long lVar4;
...
/* JPH::DebugRendererSimple::DebugRendererSimple() */void JPH::DebugRendererSimple::DebugRendererSimple(DebugRendererSimple *this) {
...
/* JPH::DebugRendererSimple::DrawTriangle(JPH::Vec3, JPH::Vec3, JPH::Vec3, JPH::Color,
   JPH::DebugRenderer::ECastShadow) */void JPH::DebugRendererSimple::DrawTriangle(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6, long *param_7, undefined4 param_8) {
   ( **(code**)( *param_7 + 0x10 ) )();
...
/* JPH::DebugRendererSimple::BatchImpl::~BatchImpl() */void JPH::DebugRendererSimple::BatchImpl::~BatchImpl(BatchImpl *this) {
...
/* JPH::DebugRendererSimple::BatchImpl::AddRef() */void JPH::DebugRendererSimple::BatchImpl::AddRef(BatchImpl *this) {
   LOCK();
   *(int*)( this + 0x20 ) = *(int*)( this + 0x20 ) + 1;
   UNLOCK();
   return;
}
/* JPH::DebugRendererSimple::BatchImpl::Release() */void JPH::DebugRendererSimple::BatchImpl::Release(BatchImpl *this) {
   BatchImpl *pBVar1;
   LOCK();
   pBVar1 = this + 0x20;
...
/* JPH::DebugRendererSimple::DebugRendererSimple() */void JPH::DebugRendererSimple::_GLOBAL__sub_I_DebugRendererSimple(void) {
   if (DVec3::cTrue == '\0') {
      DVec3::cTrue = '\x01';
      DVec3::cTrue = _LC1;
   }
...
/* WARNING: Control flow encountered bad instruction data *//* JPH::DebugRendererSimple::BatchImpl::~BatchImpl() */void JPH::DebugRendererSimple::BatchImpl::~BatchImpl(BatchImpl *this) {

/* rcBuildHeightfieldLayers(rcContext*, rcCompactHeightfield const&, int, int,
   rcHeightfieldLayerSet&) */undefined8 rcBuildHeightfieldLayers(rcContext *param_1, rcCompactHeightfield *param_2, int param_3, int param_4, rcHeightfieldLayerSet *param_5) {
   char *pcVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   if (__s == (void*)0x0) {
      uVar36 = 0;
      rcContext::log(param_1, 3, "rcBuildHeightfieldLayers: Out of memory \'srcReg\' (%d).", *(undefined4*)( param_2 + 8 ));
      goto LAB_00100a9a;
   }
                  ...
                  if (uVar16 < uVar34) {
                     do {
                        if (*(char*)( *(long*)( param_2 + 0x58 ) + uVar20 ) != '\0') {
                           ...
                           uVar38 = uVar16 & 0x3f;
                           if (( ( uVar38 == 0x3f ) || ( lVar55 = (long)(int)( ( *(uint*)( *(long*)( param_2 + 0x40 ) + (long)iVar54 * 4 ) & 0xffffff ) + uVar38 ) * (char*)( *(long*)( param_2 + 0x58 ) + lVar55 ) == '\0' ) ) || ( bVar14 = bVar14 == 0xff )) {
                           ...
                           if (iVar53 != 0x3f) {
                              bVar30 = *(byte*)( (long)__s + (long)(int)( ( *(uint*)( *(long*)( param_2 + 0x40 ) + (long)( ( 1 - iVar12 ) + iVar54 ) * 4 ) & 0xffffff ) + iVar53 ) );
                              if (bVar30 != 0xff) {
                           ...
                           LAB_00100298:*(byte*)( (long)__s + uVar20 ) = bVar14;
                        }
 ...
 while ( ( (long)iVar37 + ( ulong )(uint)(iVar50 - param_3) + (long)param_3 ) * 4 - lVar44 != 0 );
            }
                        ...
                        do {
                           ...
                           if (bVar56 != 0xff) {
                              ...
                              *(ushort*)( local_648 + (ulong)bVar56 * 0x58 + 0x52 ) = uVar31;
                              ...
                              piVar45 = &rcGetDirOffsetX(int)::offset;, piVar41 = &rcGetDirOffsetY(int)::offset;
                    iVar54 = 0;
                    do, {
                                       uVar38 = (int)( *(uint*)( puVar21 + 2 ) & 0xffffff ) >> ( (byte)iVar54 & 0x1f ) & 0x3f;
                                       if (( ( uVar38 != 0x3f ) && ( bVar47 = *(byte*)( (long)__s + (long)(int)( uVar38 + ( *(uint*)( *(long*)( param_2 + 0x40 ) + (long)( ( *piVar41 + iVar39 ) * iVar12 + *piVar45 + iVar37 ) * 4 ) & 0xffffff ) ) ) ),bVar47 != 0xff )) {
 ...
 while ( local_648 + ( ulong )(bVar14 - 1) + (ulong)bVar56 * 0x58 + 0x40 != pbVar22 );
                                             if (0xf < bVar14) goto LAB_00100670;
                                          }

                                          local_648[(ulong)bVar14 + (ulong)bVar56 * 0x58 + 0x3f] = bVar47;
                                          local_648[(ulong)bVar56 * 0x58 + 0x56] = local_648[(ulong)bVar56 * 0x58 + 0x56] + 1;
                                       }

                                       LAB_00100670:iVar54 = iVar54 + 6;
                                       piVar45 = piVar45 + 1;
                                       piVar41 = piVar41 + 1;
                                    }
, while (iVar54 != 0x18));
 ...
 while ( pbVar29 + ( ulong )(bVar14 - 1) + 1 != pbVar23 );
                                       ...
                                       LAB_00100789:bVar47 = pbVar48[0x55];
                                       if (bVar47 != 0) {
                                          pbVar23 = pbVar48;
                                          do {
 ...
 while ( pbVar48 + ( ulong )(bVar47 - 1) + 1 != pbVar23 );
                                    ...
                                    LAB_001007c2:pbVar46 = pbVar46 + 1;
                                 }
 ...
 while ( iVar39 < iVar27 );
            ...
            if (uVar16 != 0) {
               LAB_00100848:bVar47 = 0;
               bVar56 = local_648[0x54];
               uVar34 = 0;
               pbVar22 = local_648;
               joined_r0x00100869:if (bVar56 == 0xff) {
                  pbVar22[0x54] = bVar47;
...
;
                        LAB_00100923:pbVar46 = pbVar29 + 0x3f;
                        do {
                           bVar14 = *pbVar46;
 ...
 while ( pbVar22 + ( ulong )(pbVar22[0x55] - 1) + 1 != pbVar48 );
                              ...
                              if (*(ushort*)( local_648 + (ulong)bVar14 * 0x58 + 0x52 ) < *(ushort*)( pbVar22 + 0x52 )) {
                                 uVar31 = *(ushort*)( pbVar22 + 0x52 );
                              }

                              uVar49 = *(ushort*)( local_648 + (ulong)bVar14 * 0x58 + 0x50 );
                              if (*(ushort*)( pbVar22 + 0x50 ) < *(ushort*)( local_648 + (ulong)bVar14 * 0x58 + 0x50 )) {
                                 ...
                                 if (local_648[(ulong)bVar14 * 0x58 + 0x55] != 0) {
                                    do {
                                       ...
                                       if (bVar30 != 0) {
                                          pbVar48 = pbVar22;
                                          do {
                                             if (local_648[lVar44 + (ulong)bVar14 * 0x58] == *pbVar48) goto LAB_00100a1c;
                                             pbVar48 = pbVar48 + 1;
                                          }
 ...
 while ( (int)lVar44 < (int)(uint)local_648[(ulong)bVar14 * 0x58 + 0x55] );
                                 ...
                                 if (*(ushort*)( local_648 + (ulong)bVar14 * 0x58 + 0x50 ) < *(ushort*)( pbVar22 + 0x50 )) {
                                    uVar31 = *(ushort*)( local_648 + (ulong)bVar14 * 0x58 + 0x50 );
                                 }

                                 *(ushort*)( pbVar22 + 0x50 ) = uVar31;
                                 uVar31 = *(ushort*)( pbVar22 + 0x52 );
                                 if (*(ushort*)( pbVar22 + 0x52 ) < *(ushort*)( local_648 + (ulong)bVar14 * 0x58 + 0x52 )) {
                                    uVar31 = *(ushort*)( local_648 + (ulong)bVar14 * 0x58 + 0x52 );
                                 }
                           ...
                           LAB_00100940:pbVar46 = pbVar46 + 1;
                        }
 ...
 while ( true );
   ...
   LAB_00100a8e:uVar36 = 0;
   goto LAB_00100a90;
   LAB_00100d1a:bVar47 = bVar47 + 1;
   LAB_0010086b:uVar38 = uVar34 + 1;
   if (uVar38 == uVar16) goto LAB_00100c97;
   bVar56 = pbVar22[0xac];
   uVar34 = uVar38;
   pbVar22 = pbVar22 + 0x58;
   goto joined_r0x00100869;
   LAB_00100d87:puVar21 = puVar21 + 0x2c;
   bVar58 = uVar34 == uVar35;
   uVar35 = uVar35 + 1;
   if (bVar58) goto LAB_00100cc4;
   goto LAB_00100d99;
   LAB_00100b66:rcContext::log(param_1, 3, "rcBuildHeightfieldLayers: layer overflow (too many overlapping walkable platforms). Try increasing RC_MAX_LAYERS.");
   LAB_00100b7c:uVar36 = 0;
   goto LAB_00100b7e;
   LAB_00100c97:uVar52 = param_4 * 4;
   pbVar22 = local_648 + 0x54;
   pbVar29 = local_648;
   uVar16 = 0;
   do {
      if (pbVar29[0x57] != 0) {
         ...
         do {
            ...
            uVar35 = 0;
            LAB_00100d99:if (( uVar16 == uVar35 ) || ( *(byte*)( (long)puVar21 + 7 ) == 0 )) goto LAB_00100d87;
            uVar10 = puVar21[1];
            uVar31 = *(ushort*)( pbVar29 + 0x50 );
            uVar49 = *puVar21;
            uVar11 = *(ushort*)( pbVar29 + 0x52 );
            if (( ( ushort )(uVar10 + (short)uVar52) < uVar31 ) || ( ( ushort )(uVar11 + (short)uVar52) < uVar49 )) goto LAB_00100d87;
            if (uVar10 < uVar11) {
               uVar10 = uVar11;
            }
 ...
 while ( true );
      ...
      LAB_00100cc4:pbVar29 = pbVar29 + 0x58;
      bVar58 = uVar34 != uVar16;
      uVar16 = uVar16 + 1;
   }
 while ( bVar58 );
   LAB_00100c01:pbVar29 = local_148;
   lVar44 = 0;
   pbVar46 = pbVar29;
 ...
 while ( pbVar29 != local_48 );
   ...
   if (bVar59 != 0) {
      ...
      *(void**)param_5 = pvVar24;
      if (pvVar24 == (void*)0x0) {
         rcContext::log(param_1, 3, "rcBuildHeightfieldLayers: Out of memory \'layers\' (%d).", *(undefined4*)( param_5 + 8 ));
         goto LAB_00100b7c;
      }
            ...
            do {
               if (0 < iVar27) {
                  ...
                  do {
                     ...
                     if (uVar52 < uVar16) {
                        do {
                           if (( *(byte*)( (long)__s + uVar51 ) != 0xff ) && ( bVar59 = local_648[( ulong ) * (byte*)( (long)__s + uVar51 ) * 0x58 + 0x54] ),bVar59 == (byte)lVar44) {
                              ...
                              *(undefined1*)( puVar25[9] + lVar55 ) = *(undefined1*)( *(long*)( param_2 + 0x58 ) + uVar51 );
                              lVar33 = 0;
                              do {
                                 bVar56 = (byte)lVar33;
                                 uVar18 = (int)( *(uint*)( pcVar1 + 4 ) & 0xffffff ) >> ( bVar56 * '\x06' & 0x1f ) & 0x3f;
                                 if (uVar18 != 0x3f) {
                                    iVar40 = param_3 + iVar53 + ( &rcGetDirOffsetX(int), ::offset)[lVar33] );
                                    iVar42 = iVar50 + param_3 + ( &rcGetDirOffsetY(int), ::offset)[lVar33] );
                                    lVar26 = (long)(int)( ( *(uint*)( *(long*)( param_2 + 0x40 ) + (long)( iVar12 * iVar42 + iVar40 ) * 4 ) & 0xffffff ) + uVar18 );
                                    ...
                                    if (*(char*)( *(long*)( param_2 + 0x58 ) + lVar26 ) != '\0') {
                                       if (bVar47 == bVar59) {
                                          ...
                                          if (( ( -1 < (int)( iVar42 - param_3 | uVar18 ) ) && ( (int)uVar18 < iVar27 ) ) && ( iVar42 < iVar15 )) {
 ...
 while ( iVar39 != iVar50 );
   ...
   uVar36 = 1;
   LAB_00100b7e:rcFree(local_648);
   LAB_00100a90:rcFree(puVar19);
   LAB_00100a9a:rcFree(__s);

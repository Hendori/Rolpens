...
;
 ...
 while ( lVar7 != (ulong)uVar1 << 2 );
      ...
      LAB_00108132:if (( *(long*)( this + 0x240 ) != 0 ) && ( cVar5 = RefCounted::unreference() ),cVar5 != '\0') {
...
;*(undefined1(**) [16])( lVar46 + lVar47 * 8 ) = pauVar37;*puVar1 = uVar55;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_00111363:CowData<char32_t>::_unref((CowData<char32_t>*)&local_70);LAB_0011136f:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return pauVar43[1] + 8;}/* MethodBindTRC<GDExtension::InitializationLevel>::validated_call(Object*, Variant const**,

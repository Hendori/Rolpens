   ...
   *(int*)( param_1 + 0x180 ) = *(int*)( param_1 + 0x180 ) + -1;
   ...
   if (iVar1 == 0) {
      ...
      *(undefined8*)( param_1 + 0x37c ) = *(undefined8*)( param_1 + 0xb7c );
      ...
      if (( ( *(long*)( param_1 + 0xb04 ) == 0x656863733a6e7275 && *(long*)( param_1 + 0xb0c ) == 0x706e70752d73616d ) && ( *(long*)( param_1 + 0xb14 ) == 0x7265733a67726f2d && *(long*)( param_1 + 0xb1c ) == 0x4e41573a65636976 ) ) && ( ( *(long*)( param_1 + 0xb24 ) == 0x6572694636765049 && *(long*)( param_1 + 0xb2c ) == 0x746e6f436c6c6177 && ( *(int*)( param_1 + 0xb34 ) == 0x3a6c6f72 ) ) )) {
      ...
      if (( iVar1 != 0 ) && ( iVar1 = memcmp(__s1, "urn:schemas-upnp-org:service:WANPPPConnection:", 0x2e) ),iVar1 != 0) {
         return;
      }

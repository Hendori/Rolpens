/* std::_Hashtable<linalg::vec<int, 4>, std::pair<linalg::vec<int, 4> const,
   ...
   linalg::vec<int, 4> const&, unsigned long) const [clone .constprop.0] */long *std::_Hashtable<linalg::vec<int,4>,std::pair<linalg::vec<int,4>const,std::unique_ptr<(anonymous_namespace)::Partition,std::default_delete<(anonymous_namespace)::Partition>>>,std::allocator<std::pair<linalg::vec<int,4>const,std::unique_ptr<(anonymous_namespace)::Partition,std::default_delete<(anonymous_namespace)::Partition>>>>,std::__detail::_Select1st,std::equal_to<linalg::vec<int,4>>,std::hash<linalg::vec<int,4>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>::_M_find_before_node(ulong param_1, vec *param_2, ulong param_3) {
   long *plVar1;
   long *plVar2;
   long *plVar3;
   ulong uVar4;
   ...
   if (plVar3 != (long*)0x0) {
      ...
      do {
         plVar2 = plVar1;
         if (( ( ( ( param_3 == uVar4 ) && ( *(int*)param_2 == (int)plVar2[1] ) ) && ( *(int*)( param_2 + 4 ) == *(int*)( (long)plVar2 + 0xc ) ) ) && ( ( *(int*)( param_2 + 8 ) == (int)plVar2[2] && ( *(int*)( param_2 + 0xc ) == *(int*)( (long)plVar2 + 0x14 ) ) ) ) ) || ( plVar3 = (long*)*plVar2 ),plVar3 == (long*)0x0) {
            return plVar3;
         }
...
/* std::unordered_map<linalg::vec<int, 4>, std::unique_ptr<(anonymous namespace)::Partition,
   ...
   std::unique_ptr<(anonymous namespace)::Partition, std::default_delete<(anonymous
   namespace)::Partition> > > > >::~unordered_map() */void std::unordered_map<linalg::vec<int,4>,std::unique_ptr<(anonymous_namespace)::Partition,std::default_delete<(anonymous_namespace)::Partition>>,std::hash<linalg::vec<int,4>>,std::equal_to<linalg::vec<int,4>>,std::allocator<std::pair<linalg::vec<int,4>const,std::unique_ptr<(anonymous_namespace)::Partition,std::default_delete<(anonymous_namespace)::Partition>>>>>::~unordered_map(unordered_map<linalg::vec<int,4>,std::unique_ptr<(anonymous_namespace)::Partition,std::default_delete<(anonymous_namespace)::Partition>>,std::hash<linalg::vec<int,4>>,std::equal_to<linalg::vec<int,4>>,std::allocator<std::pair<linalg::vec<int,4>const,std::unique_ptr<(anonymous_namespace)::Partition,std::default_delete<(anonymous_namespace)::Partition>>>>> *this) {
   undefined8 *puVar1;
   void *pvVar2;
   undefined8 *puVar3;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* (anonymous namespace)::Partition::Reindex(linalg::vec<int, 4>, linalg::vec<int, 4>,
   linalg::vec<bool, 4>, int) const */undefined8 *
...

{
  size_t __size;
  int iVar1;
  ulong uVar2;long lVar3bool bVar4bool bVar5bool bVar6byte bVar7int iVar8undefined4 *puVar9undefined4 *puVar10void *pvVar11int *piVar12byte bVar13int iVar14int iVar15int iVar16undefined4 *puVar17int iVar18ulong uVar19size_t sVar20long lVar21int iVar22undefined4 uVar23int *piVar24ulong uVar25long lVar26ulong uVar27byte bVar28int iVar29long lVar30size_t sVar31uint uVar32int iVar33uint uVar34ulong uVar35byte bVar36int iVar37int iVar38long in_FS_OFFSETundefined8 uVar39undefined8 uVar40int *local_f8int local_f0undefined4 *local_c0int local_90undefined8 local_58undefined8 uStack_50int local_48[2]long local_40puVar10 = (undefined4*)0x0;uVar2 = *(ulong*)( param_2 + 10 );bVar13 = ( byte )(param_7 >> 0x10);local_40 = *(long*)( in_FS_OFFSET + 0x28 );uVar34 = param_7 >> 8;iVar14 = (int)param_4;__size = uVar2 * 4;iVar38 = (int)( (ulong)param_3 >> 0x20 );bVar36 = ( byte )(param_7 >> 0x18);if (uVar2 != 0) {
   puVar10 = (undefined4*)malloc(__size);
   uVar34 = param_7 >> 8 & 0xff;
}
uVar34 = uVar34 & 0xff;iVar18 = param_2[2];bVar5 = true;iVar8 = *param_2;iVar37 = param_2[1];iVar22 = (int)( (ulong)param_4 >> 0x20 );iVar1 = param_2[3];bVar6 = false;iVar29 = iVar8;iVar33 = iVar37;if (param_4 < 0) {
   iVar15 = 1;
   if (iVar8 != 0) {
...
local_58 = _LC1;uStack_50 = _UNK_00108c58;uVar25 = 0;piVar24 = (int*)&local_58;uVar27 = uVar2;uVar39 = _LC1;uVar40 = _UNK_00108c58;do {
   while (iVar8 = *piVar24,uVar19 = uVar25,puVar9 = puVar10,iVar37 = iVar38,iVar8 != 1) {
      if (iVar8 == 2) {
         if (iVar18 != 1) {
            ...
            LAB_001002e0:if (( ( iVar15 != 1 ) && ( iVar37 = iVar14 ),iVar15 != 2 )) {
               iVar37 = (int)param_3;
            }
         ...
         LAB_00100870:if (-1 < param_3) goto LAB_001002ff;
      }
 else {
         if (iVar8 != 0) {
            if (iVar1 != 1) {
               ...
               if (iVar14 < 0) goto LAB_0010031b;
               joined_r0x00100823:iVar15 = iVar18;
               if (( iVar8 != 2 ) && ( iVar15 = iVar8 == 0 )) {
                  iVar15 = iVar29;
               }
      ...
      LAB_0010031b:piVar24 = piVar24 + 1;
      uVar25 = uVar19;
...
;
   ...
   if (uVar27 == 0) {
      sVar31 = 0x200;
      uVar35 = 0x80;
      LAB_00100913:puVar9 = (undefined4*)malloc(sVar31);
      if (uVar25 == 0) {
         LAB_00100988:if (puVar10 != (undefined4*)0x0) goto LAB_00100c83;
      }
 else {
         if ((long)sVar20 < 5) {
 ...
 while ( piVar24 != local_48 );LAB_00100328:local_90 = (int)param_5;local_f8 = (int*)&local_58;local_58 = uVar39;uStack_50 = uVar40;do {
   bVar7 = (byte)uVar34;
   iVar14 = *local_f8;
   ...
   if (iVar14 == 0) {
      ...
      if (iVar14 == 1) {
         ...
         LAB_0010039b:iVar38 = (int)param_6;
         if (( iVar8 != 2 ) && ( iVar38 = iVar8 == 0 )) {
            iVar38 = local_90;
         }
   ...
   LAB_001003c3:bVar28 = bVar7;
   if (( ( iVar8 != 1 ) && ( bVar28 = bVar13 ),iVar8 != 2 )) {
      bVar28 = (byte)param_7;
   }
   ...
   if (0 < local_f0) {
      ...
      LAB_00100410:*(int*)( (long)puVar9 + sVar20 ) = iVar38;
      uVar27 = uVar35;
      if (iVar14 != 0) goto LAB_00100538;
      do {
         iVar18 = *param_2;
         LAB_00100420:bVar7 = (byte)uVar34;
         if (( ( iVar18 != 1 ) && ( bVar7 = bVar13 ),iVar18 != 2 )) {
            bVar7 = (byte)param_7;
         }
         ...
         LAB_0010045e:bVar7 = (byte)uVar34;
         uVar27 = uVar35 * 2;
         if (uVar27 <= uVar35) goto LAB_00100410;
         sVar31 = uVar35 * 8;
         local_c0 = puVar9;
         uVar32 = param_7;
         LAB_00100478:puVar9 = (undefined4*)malloc(sVar31);
         param_7 = uVar32 & 0xff;
         uVar34 = (uint)bVar7;
         if (uVar25 == 0) {
            LAB_001004cc:uVar35 = uVar27;
 ...
 while ( iVar14 == 0 );
   ...
   LAB_00100574:local_f8 = local_f8 + 1;
}
 while ( local_f8 != local_48 );sVar20 = uVar19 * 4;uVar25 = uVar2 * 2;if (uVar27 < uVar2) {
   puVar10 = (undefined4*)malloc(__size);
   if (uVar19 == 0) {
      ...
      LAB_001005ff:puVar9 = puVar10 + uVar19;
   ...
   puVar10 = puVar9;
   if (uVar19 < uVar2) {
      LAB_001005bf:puVar9 = puVar10 + uVar2;
      puVar17 = puVar10 + uVar19;
      if (puVar9 != puVar10 + uVar19) {
         LAB_001005d5:memset(puVar17, 0, (long)puVar9 - (long)puVar17);
         goto LAB_001005f6;
      }

      if (uVar19 <= uVar25) goto LAB_0010064f;
      LAB_00100d74:puVar9 = (undefined4*)malloc(__size);
      if ((long)__size < 5) {
      ...
      LAB_001009ae:free(puVar10);
   }
 else {
      LAB_001005f6:if (uVar19 <= uVar25) goto LAB_001005ff;
      puVar9 = (undefined4*)0x0;
      if (uVar2 != 0) goto LAB_00100d74;
      LAB_001009a5:if (puVar10 != (undefined4*)0x0) goto LAB_001009ae;
   }
...
lVar26 = (long)( param_8 - (int)uVar19 ) + uVar19;if (puVar9 != puVar17) {
   lVar3 = lVar26 + 1;
   lVar30 = lVar26;
   while (lVar21 = lVar3,puVar9[lVar30 - lVar26] = (int)lVar30,( ( ulong )((long)puVar17 + ( -4 - (long)puVar9 )) >> 2 ) + lVar26 + 1 != lVar21) {
      lVar30 = lVar21;
      lVar3 = lVar21 + 1;
   }
;
}
LAB_0010064f:lVar26 = (long)param_2[0x10];*param_1 = 0;param_1[2] = 0;if (lVar26 == 0) {
   param_1[1] = 0;
}
 else {
...
return param_1;}/* WARNING: Type propagation algorithm not settling *//* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* (anonymous namespace)::Partition::PartitionQuad(manifold::Vec<linalg::vec<int, 3> >&,
   manifold::Vec<linalg::vec<double, 4> >&, linalg::vec<int, 4>, linalg::vec<int, 4>,
   linalg::vec<int, 4>, linalg::vec<bool, 4>) */void Partition::PartitionQuad(Partition *this, undefined8 *param_1, ulong param_2, ulong param_4, ulong param_5, ulong param_6, ulong param_7, ulong param_8, uint param_9) {
   double *pdVar1;
   int *piVar2;
   undefined4 uVar3;
   undefined4 uVar4;
   ...
   do {
      ...
      if (uVar15 == 0xffffffff) {
         ...
         if (uVar31 != 0) {
            ...
            uVar37 = local_170;
            uVar34 = uVar31;
            if (( ( ( uVar22 == 1 ) || ( uVar37 = uVar43 ),uVar22 == 2 ) ) || ( uVar37 = uVar22 == 0 )) goto LAB_00100f8f;
            goto LAB_00100fa5;
         }

         if (uVar39 != 0) goto LAB_00100f99;
         uVar34 = local_170;
         if (( uVar22 == 1 ) || ( uVar34 = uVar22 == 2 )) {
         ...
         uVar37 = local_170;
         if (( uVar31 != 1 ) && ( uVar37 = uVar31 != 2 )) {
            LAB_00100f8f:uVar37 = uVar39;
            if (uVar31 != 0) {
               LAB_00100f97:uVar37 = uVar30;
            }

         }

         LAB_00100f99:uVar34 = uVar15;
      ...
      LAB_00100fa5:puVar14 = puVar14 + 1;
      uVar22 = uVar31;
      uVar15 = uVar34;
   }
   ...
   if ((int)uVar34 < 0) {
      ...
      if (1 < iVar20) {
         ...
         do {
            ...
            dVar46 = round(( (double)(int)local_160 / (double)iVar20 ) * (double)(int)uVar43 + ( _LC3 - (double)(int)local_160 / (double)iVar20 ) * (double)(int)uVar39);
            iVar21 = (int)dVar46;
                  ...
                  if (uVar17 < uVar36) {
                     ...
                     *pdVar29 = dVar49;
                     ...
                     if (uVar36 == 0) {
                        sVar32 = 0x1000;
                        uVar35 = 0x80;
                        LAB_0010153b:puVar10 = (undefined8*)malloc(sVar32);
                        if (uVar17 == 0) {
                           LAB_001015b4:if (puVar11 != (undefined8*)0x0) goto LAB_0010161a;
                        }
 else {
                           sVar32 = uVar17 * 0x20;
                           if ((long)sVar32 < 0x21) {
 ...
 while ( true );
            ...
            PartitionQuad(this, param_1, CONCAT44(iVar16, (undefined4)local_158), local_150 & 0xffffffff00000000 | (ulong)uVar34, (ulong)uVar31 | uVar13 << 0x20, local_148 & 0xffffffff00000000 | (ulong)uVar37, CONCAT44(iVar21, iVar24 + -1), local_190 & 0xffffffff00000000 | ( ulong )(iVar27 - 1U), local_13c);
 ...
 while ( bVar45 );
      ...
      PartitionQuad(this, param_1, local_158 & 0xffffffff | (long)local_60 << 0x20, (ulong)local_60 >> 0x20 | local_150 & 0xffffffff00000000, CONCAT44(uVar33, uVar26), local_148 & 0xffffffff00000000 | (long)param_6 >> 0x20 & 0xffffffffU, CONCAT44(uVar43, local_170), local_190 & 0xffffffff00000000 | ( ulong )(uVar15 - 1), CONCAT22((short)( uVar22 >> 0x10 ), CONCAT11(bVar18, (char)uVar22)));
      goto LAB_0010176d;
   }
   ...
   if ((int)uVar25 < 0) {
      ...
      do {
         ...
         if (uVar15 == 2) {
            uVar22 = uVar26;
            uVar31 = uVar39;
            if (( ( ( uVar25 & 3 ) == 0 ) || ( uVar22 = uVar12 ),iVar24 = local_68._4_4_,uVar31 = local_170,iVar16 == 1 )) {
            ...
            if (uVar13 < uVar17) {
               ...
               *piVar2 = iVar24;
               ...
               if (uVar17 == 0) {
                  local_130 = 0x80;
                  sVar32 = 0x600;
                  LAB_001029c3:puVar11 = (undefined8*)malloc(sVar32);
                  puVar10 = *(undefined8**)this;
                  if (uVar13 == 0) {
                     LAB_00102a16:if (puVar10 != (undefined8*)0x0) goto LAB_00102af0;
                  }
 else {
                     sVar32 = uVar13 * 0xc;
                     if ((long)sVar32 < 0xd) {
            ...
            LAB_00101f01:iVar24 = local_60._4_4_;
         }

         LAB_00101f10:iVar21 = 0;
         iVar20 = iVar24;
         while (true) {
            uVar22 = uVar39;
            uVar31 = uVar26;
            bVar7 = bVar9;
            if (( ( uVar25 & 3 ) != 0 ) && ( ( uVar37 = uVar12 ),uVar38 = local_170,bVar6 = (byte)local_13c,iVar16 == 1 || ( uVar37 = uVar41 ),uVar38 = uVar30,bVar6 = bVar19,uVar22 = uVar43,uVar31 = uVar33,bVar7 = bVar18,iVar16 != 2 )) {
               uVar22 = uVar38;
               uVar31 = uVar37;
               bVar7 = bVar6;
            }
            ...
            if (uVar13 < uVar17) {
               ...
               *piVar2 = iVar23;
               ...
               if (uVar17 == 0) {
                  sVar32 = 0x600;
                  uVar36 = 0x80;
                  LAB_00102063:puVar11 = (undefined8*)malloc(sVar32);
                  puVar10 = *(undefined8**)this;
                  if (uVar13 == 0) {
                     LAB_001020b6:if (puVar10 != (undefined8*)0x0) goto LAB_00102223;
                  }
 else {
                     sVar32 = uVar13 * 0xc;
                     if ((long)sVar32 < 0xd) {
...
;
         if (( uVar15 == 2 ) || ( uVar22 == 0 )) {
            ...
            if (( uVar34 != 1 ) && ( ( iVar24 = local_60._0_4_ ),uVar34 != 2 && ( iVar24 = uVar34 != 0 ) )) {
               iVar24 = local_60._4_4_;
            }

            iVar16 = uVar3;
            if (( ( ( uVar25 + 1 & 3 ) != 0 ) && ( iVar21 = (int)( uVar25 + 1 ) % 4 ),iVar16 = local_68._4_4_,iVar21 != 1 )) {
            ...
            if (uVar13 < uVar17) {
               ...
               *piVar2 = iVar24;
               ...
               if (uVar17 == 0) {
                  sVar32 = 0x600;
                  uVar36 = 0x80;
                  LAB_00102500:puVar11 = (undefined8*)malloc(sVar32);
                  puVar10 = *(undefined8**)this;
                  if (uVar13 == 0) {
                     LAB_00102529:if (puVar10 != (undefined8*)0x0) goto LAB_0010295c;
                  }
 else {
                     sVar32 = uVar13 * 0xc;
                     if ((long)sVar32 < 0xd) {
 ...
 while ( (uint*)&uStack_50 != puVar44 );
   ...
   if (uVar25 == 1) {
      ...
      LAB_00101a59:puVar10 = (undefined8*)local_68;
      LAB_00101a61:if (uVar25 == 1) {
         param_5 = uVar13 & 0xffffffff;
         param_9 = param_9 >> 8 & 0xff;
      }
 else {
         LAB_0010182e:param_5 = (long)param_6 >> 0x20 & 0xffffffff;
         param_9 = (uint)bVar19;
      }
   ...
   if (uVar36 < uVar17) {
      ...
      *puVar11 = CONCAT44(uVar3, uVar4);
      ...
      if (uVar17 == 0) {
         sVar32 = 0x600;
         uVar35 = 0x80;
         LAB_0010247c:puVar11 = (undefined8*)malloc(sVar32);
         puVar10 = *(undefined8**)this;
         if (uVar36 == 0) {
            LAB_001024c0:if (puVar10 != (undefined8*)0x0) goto LAB_001028f7;
         }
 else {
            sVar32 = uVar36 * 0xc;
            if ((long)sVar32 < 0xd) {
   ...
   if (uVar37 == 1) {
      LAB_001018ae:if (-1 < iVar20) {
         LAB_001018ba:uVar17 = uVar13 & 0xffffffff;
            ...
            if (uVar13 < uVar17) {
               ...
               *puVar11 = CONCAT44(uVar22, uVar3);
               ...
               if (uVar17 == 0) {
                  sVar32 = 0x600;
                  uVar36 = 0x80;
                  LAB_00101cab:puVar11 = (undefined8*)malloc(sVar32);
                  puVar10 = *(undefined8**)this;
                  if (uVar13 == 0) {
                     LAB_00101d1a:if (puVar10 != (undefined8*)0x0) goto LAB_00102381;
                  }
 else {
                     sVar32 = uVar13 * 0xc;
                     if ((long)sVar32 < 0xd) {
 ...
 while ( true );
      ...
      if (uVar34 == 1) {
         LAB_001025e8:uVar15 = local_68._4_4_;
         LAB_00101af8:if (uVar25 != 1) goto LAB_00101afd;
      }
 else {
         LAB_00101add:if (uVar34 == 2) {
      ...
      LAB_00101afd:local_170 = uVar43;
      if (( uVar25 != 2 ) && ( local_170 = uVar25 != 0 )) {
         LAB_00101d4c:local_170 = uVar30;
      }

   }

   LAB_00101b1d:if (iVar20 <= (int)( local_170 - 1 )) {
         ...
         if (uVar13 < uVar17) {
            ...
            *puVar11 = CONCAT44(uVar37, uVar3);
            ...
            if (uVar17 == 0) {
               local_178 = 0x80;
               sVar32 = 0x600;
               LAB_00101e16:puVar11 = (undefined8*)malloc(sVar32);
               puVar10 = *(undefined8**)this;
               if (uVar13 == 0) {
                  LAB_00101e67:if (puVar10 != (undefined8*)0x0) goto LAB_001022e2;
               }
 else {
                  sVar32 = uVar13 * 0xc;
                  if ((long)sVar32 < 0xd) {
 ...
 while ( uVar39 != ( uVar33 + 1 ) - iVar20 );
   ...
   LAB_0010176d:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* (anonymous namespace)::Partition::GetPartition(linalg::vec<int, 4>) */undefined1 (*) [16]
(anonymous_namespace)::Partition::GetPartition(undefined1 (*param_1)[16], ulong param_2, ulong param_3) {
   long lVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   undefined4 uVar4;
   ...
   if (uVar8 != 0) {
      ...
      if (uStack_ec == 0) {
         ...
         do {
            ...
            if (( ( ( iVar39 + 1U & 3 ) != 0 ) && ( iVar19 = (int)( iVar39 + 1U ) % 4 ),uVar32 = uVar34,iVar19 != 1 )) {
 ...
 else if (( iVar30 < iVar19 ) && ( uVar40 = uVar40 & 0xffffffff ),iVar22 = iVar9,uStack_f4 == uVar27) {
                  uVar40 = uVar32;
                  iVar22 = iVar39;
                  iVar9 = iVar39;
               }
 ...
 else if (( iVar30 < iVar19 ) && ( uVar40 = uVar40 & 0xffffffff ),iVar22 = iVar9,uStack_f0 == uVar27) {
                  uVar40 = uVar32;
                  iVar22 = iVar39;
                  iVar9 = iVar39;
               }
 ...
 else if (( iVar30 < iVar19 ) && ( uVar40 = uVar40 & 0xffffffff ),iVar22 = iVar9,uVar8 == uVar27) {
                  uVar40 = uVar32;
                  iVar22 = iVar39;
                  iVar9 = iVar39;
               }
 ...
 else if (( iVar30 < iVar19 ) && ( uVar40 = uVar40 & 0xffffffff ),iVar22 = iVar9,uStack_ec == uVar27) {
               uVar40 = uVar32;
               iVar22 = iVar39;
               iVar9 = iVar39;
            }
 ...
 while ( pPVar13 != (Partition*)( (long)&uStack_50 + 4 ) );
         ...
         do {
            ...
            if (iVar9 == 1) {
               uVar26 = uVar33;
               if (( ( uVar7 != 1 ) && ( uVar26 = uVar29 ),uVar7 != 2 )) {
            ...
            if (iVar9 == 2) {
               ...
               LAB_00103390:puVar10 = &uStack_f0;
            }
 else if (iVar9 == 0) {
               if (uVar7 == 1) {
                  uVar27 = 1;
            ...
            LAB_00102e1d:uVar31 = (uint)pPVar13;
            pPVar14 = pPVar14 + 4;
            *puVar10 = uVar26;
         }
 while ( pPVar14 != local_48 );
      ...
      if (DAT_00108778 == (Partition*)0x0) {
         for (; pPVar13 != (Partition*)0x0; pPVar13 = *(Partition**)pPVar13) {
            if (( ( (uint)local_e8 == *(uint*)( pPVar13 + 8 ) ) && ( local_e8._4_4_ == *(uint*)( pPVar13 + 0xc ) ) ) && ( ( (uint)uStack_e0 == *(uint*)( pPVar13 + 0x10 ) && ( uStack_e0._4_4_ == *(uint*)( pPVar13 + 0x14 ) ) ) )) goto LAB_00102edf;
         }

      }
 else {
         uVar23 = (ulong)(int)( (uint)local_e8 ^ local_e8._4_4_ ^ (uint)uStack_e0 ^ uStack_e0._4_4_ );
         puVar15 = (undefined8*)std::_Hashtable<linalg::vec<int,4>,std::pair<linalg::vec<int,4>const,std::unique_ptr<(anonymous_namespace)::Partition,std::default_delete<(anonymous_namespace)::Partition>>>,std::allocator<std::pair<linalg::vec<int,4>const,std::unique_ptr<(anonymous_namespace)::Partition,std::default_delete<(anonymous_namespace)::Partition>>>>,std::__detail::_Select1st,std::equal_to<linalg::vec<int,4>>,std::hash<linalg::vec<int,4>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>::_M_find_before_node(uVar23 % (ulong)DAT_00108768, (vec*)&local_e8, uVar23);
         if (( puVar15 != (undefined8*)0x0 ) && ( pPVar13 = (Partition*)*puVar15 ),pPVar13 != (Partition*)0x0) {
            LAB_00102edf:lVar1 = *(long*)( pPVar13 + 0x18 );
               ...
               if ((ulong)local_80._0_8_ < (ulong)local_80._8_8_) {
                  ...
                  *(double*)( pPVar11 + 0x18 ) = dVar46;
                  ...
                  if ((Partition*)local_80._8_8_ == (Partition*)0x0) {
                     ...
                     LAB_00103313:pPVar12 = (Partition*)malloc(sVar36);
                     if (pPVar21 == (Partition*)0x0) {
                        LAB_00103360:local_1d8 = (Partition*)( (long)(int)uVar33 * 0x20 );
                        local_1c8 = pPVar14;
...
;
 ...
 while ( pPVar13 != local_198 );
         ...
         PartitionQuad((Partition*)&local_70, pPVar13, 0x100000000, &DAT_300000002, local_d8, uStack_d0, local_1e8, uStack_1e0, 0x1010101);
         goto LAB_0010364c;
      }
      ...
      *(undefined8*)( local_88 + 0x58 ) = 0;
      do {
         ...
         if (iVar22 == 0) {
            iVar39 = 1;
            LAB_00104175:iVar9 = (uint)local_e8;
               ...
               do {
                  while (true) {
                     ...
                     if ((Partition*)local_80._8_8_ == (Partition*)0x0) {
                        ...
                        LAB_001041eb:in_R10 = (Partition*)malloc(sVar36);
                        if (pPVar11 == (Partition*)0x0) {
                           LAB_0010422a:local_1d8 = pPVar13;
...
;
                  ...
                  *(double*)( pPVar13 + 0x18 ) = dVar46;
                  ...
                  LAB_0010416c:iVar39 = iVar39 + 1;
                  if (iVar22 != 2) goto LAB_00104175;
                  LAB_001040c0:iVar9 = (uint)uStack_e0;
 ...
 while ( pPVar14 != local_1a8 );
      ...
      if (local_e8._4_4_ != 1) {
         ...
         if (dVar43 - (double)(int)(uint)local_e8 * __LC9 * (double)(int)(uint)uStack_e0 < (double)(int)( local_e8._4_4_ * local_e8._4_4_ )) {
            pPVar14 = local_70;
            pPVar11 = pPStack_60;
         ...
         dVar43 = round(( dVar43 - (double)(int)( local_e8._4_4_ * local_e8._4_4_ ) ) / (double)(int)( (uint)local_e8 * 2 ));
                  ...
                  if (uVar23 < (ulong)local_80._8_8_) {
                     ...
                     *(double*)( pPVar14 + 0x18 ) = dVar44;
                     ...
                     if (local_80._8_8_ == 0) {
                        sVar36 = 0x1000;
                        uVar40 = 0x80;
                        LAB_00104483:pPVar13 = (Partition*)malloc(sVar36);
                        if (uVar23 != 0) {
                           sVar36 = uVar23 * 0x20;
                           if ((long)sVar36 < 0x21) {
                              if (sVar36 == 0x20) {
            ...
            do {
               ...
               *(int*)pPVar42 = (int)pPVar14;
               ...
               while (true) {
                  ...
                  LAB_00103fb2:pPVar11 = (Partition*)( (long)pPVar42 * 2 );
                  if (pPVar42 < pPVar11) {
                     uVar29 = (uint)pPVar47;
                     pPVar14 = (Partition*)(ulong)uVar8;
                     sVar36 = (long)pPVar42 * 0x18;
                     pPVar13 = pPVar21;
                     LAB_00104b0f:auVar24 = local_68;
                     local_1a8 = (Partition*)(ulong)uVar29;
                     pPVar21 = (Partition*)malloc(sVar36);
                     if (auVar24 == (undefined1[8])0x0) {
                        LAB_00104b4e:local_1d8 = (Partition*)auVar24;
                        local_1c8 = pPVar13;
                        uVar8 = uVar33;
                        ...
                        LAB_00104bb0:local_1c8 = (Partition*)(ulong)uVar33;
                        free(pPVar13);
                        auVar24 = local_68;
                        local_1d8 = pPVar21;
                        uVar8 = uVar29;
 ...
 while ( true );
         ...
         if (pPStack_60 <= (ulong)local_68) {
            if (pPStack_60 == (Partition*)0x0) {
               ...
               LAB_00104d3a:sVar36 = (long)pPVar11 * 0x18;
            ...
            if (auVar24 == (undefined1[8])0x0) {
               LAB_00104d66:if (pPVar12 == (Partition*)0x0) goto LAB_001046d3;
            }
 else {
               sVar36 = (long)auVar24 * 0xc;
               if ((long)sVar36 < 0xd) {
         ...
         LAB_001046d3:pPStack_60 = pPVar47;
         local_70 = pPVar42;
      ...
      if (pPStack_60 == (Partition*)0x0) {
         sVar36 = 0x600;
         pPVar14 = (Partition*)0x80;
         LAB_00104f06:local_1e8 = (undefined1[8])local_70;
         pPVar38 = (Partition*)malloc(sVar36);
         pPVar11 = pPVar38;
         pPVar21 = pPVar14;
         if (auVar25 == (undefined1[8])0x0) {
            LAB_00104f21:if (pPVar13 == (Partition*)0x0) goto LAB_00104cf2;
         }
 else {
      ...
      LAB_00104cf2:pPStack_60 = pPVar21;
      local_70 = pPVar11;
      pPVar11 = _LC1;
      *(Partition**)( local_70 + (long)local_68 * 0xc ) = _LC1;
      *(undefined4*)( local_70 + (long)local_68 * 0xc + 8 ) = 2;
      ...
      LAB_0010364c:do {
         while (true) {
            ...
            *(undefined4*)( pPVar13 + 8 ) = local_1b8._0_4_;
            ...
            pPVar13 = local_1b8;
            PartitionQuad(pPVar38, local_1b8, (ulong)local_1a8 & 0xffffffff | uVar23, (long)pPVar11 << 0x20 | 2, ( ulong )(iVar22 + 3) << 0x20 | 0xffffffff, (long)local_180 << 0x20 | (ulong)auVar24, ( ulong )(uVar8 - 2) << 0x20, CONCAT44(( iVar22 - (int)local_1c8 ) + -2, local_188._0_4_), 0x1010101);
            auVar25 = local_68;
            pPVar21 = local_70;
                  ...
                  do {
                     ...
                     *(int*)pPVar11 = (int)pPVar14;
                     ...
                     while (true) {
                        ...
                        LAB_00104982:auVar24 = ( undefined1[8] )((long)pPVar11 * 2);
                        if (pPVar11 < (ulong)auVar24) {
                           sVar36 = (long)pPVar11 * 0x18;
                           pPVar14 = (Partition*)(ulong)uVar8;
                           pPVar13 = pPVar21;
                           LAB_00104de7:auVar35 = local_68;
                           local_1a8 = (Partition*)(ulong)uVar33;
                           pPVar21 = (Partition*)malloc(sVar36);
                           pPVar11 = (Partition*)auVar24;
                           if (auVar35 == (undefined1[8])0x0) {
                              LAB_00104e12:local_1e8 = auVar35;
                              local_1b8 = pPVar13;
                              pPVar42 = pPVar21;
                        ...
                        LAB_00104997:pPStack_60 = pPVar11;
                        local_70 = pPVar42;
...
;
 ...
 while ( true );
               ...
               LAB_0010504f:if ((ulong)auVar35 < (ulong)auVar24) {
                  LAB_001049ca:pPVar21 = pPVar21 + (long)auVar35 * 0xc;
                  pPVar11 = (Partition*)( (ulong)local_1d8 & 0xffffffff );
                  ...
                  *(undefined4*)( pPVar21 + 8 ) = 2;
                  ...
                  if (auVar24 == (undefined1[8])0x0) {
                     LAB_00105067:auVar24 = (undefined1[8])malloc((long)pPVar38 * 0xc);
                     local_1e8 = (undefined1[8])pPVar21;
                     pPVar11 = (Partition*)auVar24;
                     pPVar42 = pPVar38;
                     if (auVar35 == (undefined1[8])0x0) {
                        LAB_00105082:if (pPVar21 == (Partition*)0x0) goto LAB_00104fe6;
                     }
 else {
                        sVar36 = (long)auVar35 * 0xc;
                        if ((long)sVar36 < 0xd) {
                     ...
                     LAB_00104fd9:pPVar38 = (Partition*)( (long)auVar24 * 2 );
                     pPVar11 = local_70;
                     pPVar42 = pPStack_60;
                     if ((ulong)auVar24 < pPVar38) goto LAB_00105067;
                  }

                  LAB_00104fe6:pPStack_60 = pPVar42;
                  local_70 = pPVar11;
                  pPVar11 = (Partition*)( (ulong)local_1d8 & 0xffffffff );
               ...
               if (pPStack_60 <= (ulong)local_68) {
                  ...
                  if (auVar25 == (undefined1[8])0x0) {
                     LAB_00104c36:if (pPVar21 != (Partition*)0x0) goto LAB_0010513f;
                  }
 else {
                     sVar36 = (long)auVar25 * 0xc;
                     if ((long)sVar36 < 0xd) {
               ...
               *(undefined4*)( pPVar13 + 8 ) = local_190._0_4_;
               pPVar13 = local_1b8;
               local_68 = ( undefined1[8] )((long)local_68 + 1);
               PartitionQuad(pPVar38, local_1b8, (long)local_190 << 0x20 | (ulong)auVar24, pPVar11, (ulong)local_170 << 0x20 | 0xffffffff, ( ulong )(( uVar29 - 2 ) + (int)local_198) << 0x20 | 0xffffffff, ( ulong )((int)local_1e8 - 2) << 0x20, ( ulong )(uVar29 - 2) << 0x20, 0x10101);
            }
 else {
               ...
               if ((ulong)local_68 < pPStack_60) {
                  ...
                  *(undefined8*)( local_70 + (long)local_68 * 0xc + 4 ) = 0x300000000;
                  ...
                  if (pPStack_60 == (Partition*)0x0) {
                     sVar36 = 0x600;
                     pPVar14 = (Partition*)0x80;
                     LAB_00104c69:local_180 = local_70;
                     local_188 = (Partition*)local_68;
                     pPVar13 = (Partition*)malloc(sVar36);
                     if (auVar25 == (undefined1[8])0x0) {
                        LAB_00104c98:if (pPVar21 != (Partition*)0x0) goto LAB_00104fb8;
                     }
 else {
                        sVar36 = (long)auVar25 * 0xc;
                        if ((long)sVar36 < 0xd) {
               ...
               pPVar13 = local_1b8;
               PartitionQuad(pPVar38, local_1b8, (ulong)uVar8 | 0x300000000, pPVar11, _LC13, ( ulong )(( uVar29 - 2 ) + (int)local_198) | (long)local_190 << 0x20, ( ulong )((int)local_1c8 - 2) << 0x20, pPVar14, 0x1000101);
...
;
         ...
         *(double*)( (long)auVar35 + 0x10 ) = dStack_c0;
         ...
         if (pPVar14 == (Partition*)0x0) {
            for (pPVar38 = DAT_00108770; pPVar38 != (Partition*)0x0; pPVar38 = *(Partition**)pPVar38) {
               if (( ( *(uint*)( pPVar38 + 8 ) == *(uint*)( (long)auVar35 + 8 ) ) && ( *(uint*)( (long)auVar35 + 0xc ) == *(uint*)( pPVar38 + 0xc ) ) ) && ( ( *(uint*)( (long)auVar35 + 0x10 ) == *(uint*)( pPVar38 + 0x10 ) && ( *(int*)( (long)auVar35 + 0x14 ) == *(int*)( pPVar38 + 0x14 ) ) ) )) goto LAB_00103784;
            }

            pPVar38 = (Partition*)(long)(int)( *(uint*)( (long)auVar35 + 0x10 ) ^ *(uint*)( (long)auVar35 + 8 ) ^ *(uint*)( (long)auVar35 + 0xc ) ^ *(uint*)( (long)auVar35 + 0x14 ) );
            auVar24 = ( undefined1[8] )((ulong)pPVar38 % (ulong)DAT_00108768);
         }
 else {
            local_1d8 = pPVar14;
            pPVar38 = (Partition*)(long)(int)( *(uint*)( (long)auVar35 + 8 ) ^ *(uint*)( (long)auVar35 + 0xc ) ^ *(uint*)( (long)auVar35 + 0x10 ) ^ *(uint*)( (long)auVar35 + 0x14 ) );
            auVar24 = ( undefined1[8] )((ulong)pPVar38 % (ulong)DAT_00108768);
            local_1e8 = (undefined1[8])DAT_00108768;
            plVar16 = (long*)std::_Hashtable<linalg::vec<int,4>,std::pair<linalg::vec<int,4>const,std::unique_ptr<(anonymous_namespace)::Partition,std::default_delete<(anonymous_namespace)::Partition>>>,std::allocator<std::pair<linalg::vec<int,4>const,std::unique_ptr<(anonymous_namespace)::Partition,std::default_delete<(anonymous_namespace)::Partition>>>>,std::__detail::_Select1st,std::equal_to<linalg::vec<int,4>>,std::hash<linalg::vec<int,4>>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,true>>::_M_find_before_node((ulong)auVar24, (vec*)( (long)auVar35 + 8 ), (ulong)pPVar38);
            if (( plVar16 != (long*)0x0 ) && ( *plVar16 != 0 )) {
               LAB_00103784:if ((void*)puVar15[7] != (void*)0x0) {
                  free((void*)puVar15[7]);
               }
         ...
         cVar6 = std::__detail::_Prime_rehash_policy::_M_need_rehash(0x108780, (ulong)pPVar13, (ulong)pPVar14);
         ...
         LAB_00104d2b:sVar36 = 0x600;
         pPVar21 = (Partition*)0x80;
         LAB_00104a97:pPVar14 = (Partition*)malloc(sVar36);
         local_1c8 = pPVar13;
         pPVar11 = pPVar21;
         if (auVar25 == (undefined1[8])0x0) {
            LAB_00104abc:local_1d8 = (Partition*)auVar25;
            ...
            LAB_001050bf:free(pPVar13);
            local_1d8 = pPVar14;
         }

         LAB_0010460a:pPStack_60 = pPVar11;
         local_70 = pPVar14;
         ...
         *(undefined4*)( pPVar14 + 8 ) = local_1b8._0_4_;
         ...
         local_68 = ( undefined1[8] )((long)local_68 + 1);
         PartitionQuad((Partition*)&local_70, pPVar13, (ulong)local_1a8 & 0xffffffff | (long)local_1b8 << 0x20, 2, ( ulong )((int)pPVar38 + 3) << 0x20 | 0xffffffff, (ulong)local_190 & 0xffffffff | 0x300000000, ( ulong )(SUB84(auVar24, 0) - 2) << 0x20, pPVar14, 0x1010101);
      }
 while ( true );
   }
   ...
   *param_1 = (undefined1[16])0x0;
   ...
   goto LAB_00102bf2;
   code_r0x00103e75:__s = operator_new((long)extraout_RDX * 8);
   puVar17 = (undefined*)memset(__s, 0, (long)extraout_RDX * 8);
   LAB_00103e9c:pPVar14 = DAT_00108770;
...
;
   LAB_00103eec:if (cache != &DAT_00108790) {
   ...
   *(Partition**)( (long)auVar35 + 0x20 ) = pPVar38;
   ...
   if ((undefined8*)*plVar16 == (undefined8*)0x0) {
      ...
      *(Partition**)auVar35 = DAT_00108770;
      DAT_00108770 = pPVar13;
      if (pPVar14 != (Partition*)0x0) {
         *(undefined1(*) [8])( puVar17 + ( *(ulong*)( pPVar14 + 0x20 ) % (ulong)DAT_00108768 ) * 8 ) = auVar35;
      }
   ...
   LAB_00102f38:*(Partition**)param_1[2] = pPVar14;
   ...
   *(Partition**)( param_1[4] + 8 ) = uStack_1e0;
   LAB_00102bf2:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }

   LAB_0010519d:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* manifold::Manifold::Impl::GetNeighbor(int) const */int manifold::Manifold::Impl::GetNeighbor(int param_1) {
   int iVar1;
   char cVar2;
   int *piVar3;
   int iVar4;
...
/* manifold::Manifold::Impl::GetHalfedges(int) const */undefined8 manifold::Manifold::Impl::GetHalfedges(Impl *this, int param_1) {
   int iVar1;
   char cVar2;
   int *piVar3;
   undefined8 uVar4;
   ...
   do {
      iVar7 = *piVar3;
      piVar5 = local_68 + 1;
      if (( ( iVar7 != 1 ) && ( piVar5 = local_68 + 2 ),iVar7 != 2 )) {
         piVar5 = local_68;
      }
 ...
 while ( &local_44 != piVar6 );
   ...
   LAB_001054c0:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* manifold::Manifold::Impl::GetIndices(int) const */undefined8 manifold::Manifold::Impl::GetIndices(Impl *this, int param_1) {
   int iVar1;
   char cVar2;
   uint uVar3;
   int iVar4;
...
/* manifold::Manifold::Impl::FillRetainedVerts(manifold::Vec<manifold::Barycentric>&) const */void manifold::Manifold::Impl::FillRetainedVerts(Impl *this, Vec *param_1) {
   undefined4 *puVar1;
   int iVar2;
   long lVar3;
   long lVar4;
      ...
      do {
         ...
         do {
            ...
            if (-1 < lVar4) {
               ...
               *puVar5 = _LC3;
               puVar1 = (undefined4*)( *(long*)param_1 + (long)*(int*)( lVar3 + (long)( iVar2 + iVar7 ) * 0xc ) * 0x28 );
...
/* WARNING: Heritage AFTER dead removal. Example location: s0xfffffffffffffe68 : 0x001067f3 *//* WARNING: Type propagation algorithm not settling *//* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* WARNING: Restarted to delay deadcode elimination for space: stack *//* manifold::Manifold::Impl::Subdivide(std::function<int (linalg::vec<double, 3>,
   linalg::vec<double, 4>, linalg::vec<double, 4>)>, bool) */Vec *manifold::Manifold::Impl::Subdivide(Vec *param_1, Impl *param_2, long param_3, char param_4) {
   ...
   if ((long)( local_240 * 2 ) == 0) {
      ...
      if ((Impl*)(long)local_240 == (Impl*)0x0) {
         ...
         pIVar43 = (Impl*)0x0;
         local_348 = (undefined1[16])0x0;
         LAB_00105c67:local_358 = (ulong)iVar39;
         lVar57 = 0;
 ...
 while ( (Impl*)(long)local_240 != pIVar43 );
   ...
   LAB_0010592f:local_358 = (ulong)iVar39;
      ...
      do {
         ...
         if (cVar14 == '\0') {
            ...
            if (*(long*)( local_48 + 0xb0 ) == 0) {
               ...
               puVar32 = (undefined8*)( (long)*(int*)( *(long*)( local_48 + 0x60 ) + lVar57 * 0xc + 8 ) * 0x20 + *(long*)( local_48 + 0xa8 ) );
 ...
 while ( pIVar40 != pIVar43 );
   ...
   if (param_4 == '\0') {
      LAB_00105e18:sVar44 = (long)local_220 * 4;
   }
 else {
      pvVar29 = (void*)0x0;
      if (pIVar43 != (Impl*)0x0) {
         ...
         do {
            ...
            *(int*)pIVar40 = *(int*)( (long)local_228 + lVar57 * 4 );
            ...
            if (cVar14 == '\0') {
               ...
               do {
                  iVar53 = iVar33 + -2;
                  iVar4 = *(int*)( (long)local_228 + (long)*(int*)( (long)local_380 + (long)iVar33 * 4 ) * 4 );
                  iVar33 = iVar33 + 1;
                  if (iVar49 < iVar4) {
                     iVar49 = iVar4;
                  }
 ...
 while ( lVar57 != 0 );
               ...
               LAB_00108459:iVar49 = 0;
               iVar56 = 0;
               lVar57 = 3;
               do {
                  iVar53 = iVar39 + -2;
                  iVar4 = *(int*)( (long)local_228 + (long)*(int*)( (long)local_380 + (long)iVar39 * 4 ) * 4 );
                  iVar39 = iVar39 + 1;
                  if (iVar49 < iVar4) {
                     iVar49 = iVar4;
                  }
            ...
            do {
               ...
               if (iVar39 == 1) {
                  if (-1 < lVar57) {
                     ...
                     iVar39 = *(int*)( (long)local_228 + (long)*(int*)( (long)local_380 + ( lVar57 >> 0x20 ) * 4 ) * 4 ) + 1;
                     goto LAB_001061a5;
                  }
                  ...
                  if (-1 < (int)lVar59) {
                     ...
                     iVar39 = *(int*)( (long)local_228 + (long)*(int*)( (long)local_380 + (long)(int)lVar59 * 4 ) * 4 ) + 1;
                     goto LAB_001061a5;
                  }
                  ...
                  if (-1 < (int)lVar57) {
                     ...
                     iVar39 = *(int*)( (long)local_228 + (long)*(int*)( (long)local_380 + (long)(int)lVar57 * 4 ) * 4 ) + 1;
                     goto LAB_001061a5;
                  }
                  ...
                  iVar39 = *(int*)( (long)local_228 + (long)*(int*)( (long)local_380 + ( lVar59 >> 0x20 ) * 4 ) * 4 ) + 1;
                  LAB_001061a5:*piVar19 = iVar39;
               }
 ...
 while ( pauVar20 != pauVar58 );
         ...
         do {
            ...
            *piVar19 = (int)uVar52;
            uVar52 = ( ulong )(uint)(( (int)uVar52 - ( iVar39 + iVar17 + iVar33 + iVar51 ) ) + *(int*)( pauVar24[2] + 8 ));
            pauVar24 = local_2c8;
            piVar19 = piVar19 + 1;
         }
 while ( pauVar58 != local_2c8 );
      ...
      uVar54 = ( ulong )(( local_3a8 - ( *(int*)( local_2c8[-4] + 4 ) + *(int*)local_2c8[-4] + *(int*)( local_2c8[-4] + 8 ) + *(int*)( local_2c8[-4] + 0xc ) ) ) + local_2e8[local_358 - 1]);
      uVar52 = uVar54 * 2;
      uVar30 = uVar46;
      if (*(ulong*)( param_1 + 0x10 ) < uVar54) {
         ...
         *(ulong*)( param_1 + 8 ) = uVar54;
         ...
         LAB_00108250:sVar42 = uVar54 * 0x28;
      ...
      if (uVar46 < uVar54) {
         ...
         LAB_0010798d:puVar25 = puVar32 + uVar30 * 5;
 ...
 while ( puVar32 + uVar54 * 5 != puVar28 );
      ...
      LAB_00108676:std::__throw_length_error("cannot create std::vector larger than max_size()");
      LAB_00108688:if ((bool)uVar60) {
         ...
         *(undefined8*)( __dest + 0x20 ) = *(undefined8*)( pIVar40 + 0x20 );
         LAB_0010827e:free(pIVar40);
      }
 else {
         LAB_001063ba:if (pIVar40 != (Impl*)0x0) goto LAB_0010827e;
      }
   ...
   LAB_001063d6:auVar13 = auStack_1e0;
               ...
               do {
                  ...
                  if (iVar17 == 1) {
                     if (-1 < lVar57) {
                        ...
                        uVar46 = uVar46 & 0xffffffff | ( ulong ) * (uint*)( local_388 + (long)*(int*)( (long)local_380 + lVar35 * 4 ) * 4 ) << 0x20;
                     ...
                     LAB_00106c5a:*puVar26 = 0xffffffff;
                  }
 else {
                     if (iVar17 == 2) {
                        iVar17 = (int)lVar59;
                        ...
                        uVar52 = uVar52 & 0xffffffff00000000 | ( ulong ) * (uint*)( local_388 + (long)*(int*)( (long)local_380 + (long)iVar17 * 4 ) * 4 );
                        ...
                        iVar17 = *piVar19;
                        uVar46 = uVar46 & 0xffffffff00000000 | ( ulong ) * (uint*)( local_388 + (long)*(int*)( (long)local_380 + (long)iVar39 * 4 ) * 4 );
                        ...
                        uVar52 = uVar52 & 0xffffffff | ( ulong ) * (uint*)( local_388 + (long)*(int*)( (long)local_380 + lVar35 * 4 ) * 4 ) << 0x20;
                        puVar26 = (undefined4*)( (long)local_25c + 3 );
                        bVar61 = iVar17 < piVar19[1];
                     }

                     LAB_00106536:*(bool*)puVar26 = bVar61;
                  }
 ...
 while ( pppvVar41 != (void***)local_68 );
               ...
               (anonymous_namespace)::Partition::Reindex(local_1c8, pauVar24, local_258._0_8_, local_258._8_8_, uVar46, uVar52, _local_25c, (long)iVar39);
 ...
 while ( pppvVar22 != (void***)local_68 );
               ...
               for (pauVar24 = (undefined1(*) [16])( lVar59 + (long)( *(int*)( pauVar24[1] + 4 ) + *(int*)pauVar24[1] + *(int*)( pauVar24[1] + 8 ) + *(int*)( pauVar24[1] + 0xc ) ) * 0x20 ); (undefined1(*) [16])( lVar57 * 0x20 + lVar59 ) != pauVar24; pauVar24 = pauVar24 + 2) {
                  local_198 = *pauVar24;
                  auVar65 = local_198;
 ...
 while ( local_358 != local_378 );
      ...
      LAB_00107c3b:sVar42 = (long)auVar13 * 0x10;
         ...
         if (lVar47 < 0) {
            ...
            do {
               ...
               if (iVar33 == 1) {
                  ...
                  iVar51 = (int)lVar47;
                  if (( iVar33 == 2 ) || ( iVar51 = iVar33 != 0 )) {
                     pdVar37 = (double*)( (long)pvVar29 + (long)*(int*)( lVar36 + (long)iVar51 * 0xc ) * 0x18 );
 ...
 while ( pppvVar22 != (void***)( auStack_70 + 4 ) );
            ...
            pdVar37[2] = local_158 * dStack_1b0 + (double)local_1b8 * (double)local_178._8_8_ + uStack_1c0 * (double)local_188;
            *pdVar37 = (double)local_1b8 * dStack_180 + (double)local_198._0_8_ * uStack_1c0 + dStack_1b0 * (double)auStack_168._0_8_;
            pdVar37[1] = (double)local_1b8 * (double)local_178._0_8_ + (double)local_198._8_8_ * uStack_1c0 + dStack_1b0 * (double)auStack_168._8_8_;
         }
 else {
            ...
            do {
               ...
               if (iVar33 == 1) {
                  ...
                  pdVar37 = (double*)( (long)pvVar29 + (long)*(int*)( lVar36 + (long)(int)lVar47 * 0xc ) * 0x18 );
                  pdVar38 = (double*)auStack_168;
               }
 else if (iVar33 == 0) {
                  pdVar37 = (double*)( (long)pvVar29 + (long)*(int*)( lVar36 + (long)iVar39 * 0xc ) * 0x18 );
 ...
 while ( pppvVar22 != (void***)local_68 );
            pdVar37 = (double*)( local_2e0 + lVar48 * 3 );
            pdVar37[2] = (double)local_1b8 * (double)local_178._8_8_ + uStack_1c0 * (double)local_188 + dStack_1b0 * local_158 + local_1a8 * local_140;
            *pdVar37 = uStack_1c0 * (double)local_198._0_8_ + dStack_180 * (double)local_1b8 + dStack_1b0 * (double)auStack_168._0_8_ + local_1a8 * dStack_150;
            pdVar37[1] = uStack_1c0 * (double)local_198._8_8_ + (double)local_178._0_8_ * (double)local_1b8 + dStack_1b0 * (double)auStack_168._8_8_ + local_1a8 * dStack_148;
         }
 ...
 while ( pppvVar22 != (void***)( auStack_70 + 4 ) );
                  ...
                  iVar51 = iVar51 + 1;
                  iVar49 = iVar49 + 1;
                  *(double*)( local_348._0_8_ + lVar47 * 8 ) = (double)local_1c8 * dVar64 + 0.0 + uStack_1c0 * dVar63 + (double)local_1b8 * dVar7;
               }
 while ( iVar39 != iVar51 );
            }
 else {
 ...
 while ( pppvVar22 != (void***)local_68 );
                  ...
                  iVar53 = iVar53 + 1;
                  iVar49 = iVar49 + 1;
                  *(double*)( local_348._0_8_ + lVar47 * 8 ) = (double)local_1c8 * dVar64 + 0.0 + uStack_1c0 * dVar63 + (double)local_1b8 * dVar7 + dStack_1b0 * dVar5;
               }
 while ( iVar39 != iVar53 );
            }
 ...
 while ( local_3a8 != local_2f8 );
      ...
      if (pIVar43 != (Impl*)0x0) {
         ...
         do {
            ...
            if (0 < iVar15) {
               iVar49 = 0;
               puVar25 = (undefined8*)( local_348._0_8_ + (long)( ( iVar33 + *(int*)( local_388 + lVar47 * 4 ) + local_3a8 ) * iVar39 ) * 8 );
               do {
                  iVar49 = iVar49 + 1;
                  lVar47 = 0;
                  dVar64 = (double)iVar49 * ( dVar5 / (double)( iVar15 + 1 ) );
                  do {
                     *(double*)( (long)puVar25 + lVar47 ) = *(double*)( (long)puVar32 + lVar47 + (long)( iVar17 * iVar39 ) * 8 ) * ( dVar5 - dVar64 ) + *(double*)( (long)puVar32 + lVar47 + (long)( iVar51 * iVar39 ) * 8 ) * dVar64;
                     lVar47 = lVar47 + 8;
                  }
...
;
            ...
            do {
               ...
               if (iVar39 == 1) {
                  ...
                  if (iVar39 == 2) {
                     ...
                     if (iVar17 < 0) {
                        LAB_0010768b:*puVar26 = 0xffffffff;
                        goto LAB_001073a9;
                     }
                  ...
                  LAB_00107400:piVar19 = (int*)( *(long*)( param_2 + 0x60 ) + lVar35 * 0xc );
                  lVar35 = *(long*)( param_2 + 0x128 );
                  piVar3 = (int*)( lVar35 + (long)iVar56 * 0xc );
                  if (iVar53 == 0) {
                     iVar56 = *piVar3;
                     LAB_001072d3:if (iVar39 == 1) goto LAB_0010743c;
                     LAB_001072dc:if (iVar39 == 2) {
                        local_208._8_4_ = iVar56;
                        uVar16 = *(undefined4*)( local_388 + (long)*(int*)( (long)local_380 + (long)iVar17 * 4 ) * 4 );
                        puVar26 = (undefined4*)( local_1c8 + 8 );
                     }
 else if (iVar39 == 0) {
                        local_208._0_4_ = iVar56;
                        uVar16 = *(undefined4*)( local_388 + (long)*(int*)( (long)local_380 + (long)iVar15 * 4 ) * 4 );
                        puVar26 = (undefined4*)local_1c8;
                     }
 else {
                        iStack_1fc = iVar56;
                        uVar16 = *(undefined4*)( local_388 + (long)*(int*)( (long)local_380 + (long)iVar49 * 4 ) * 4 );
                     ...
                     LAB_0010743c:local_208._4_4_ = iVar56;
                     uVar16 = *(undefined4*)( local_388 + (long)*(int*)( (long)local_380 + (long)iVar51 * 4 ) * 4 );
                  ...
                  *puVar26 = uVar16;
                  if (piVar19[1] <= *piVar19) {
                     ...
                     if (iVar53 == 0) {
                        ...
                        iVar17 = piVar2[1];
                        LAB_0010774e:iVar51 = *piVar3;
                        LAB_00107750:if (iVar17 == iVar51) {
                           puVar27 = local_258 + 1;
                           if (( iVar39 != 1 ) && ( puVar27 = iVar39 != 2 )) {
                              puVar27 = local_258;
                              if (iVar39 != 0) {
                                 puVar27 = local_258 + 3;
                              }
                        ...
                        LAB_001081d7:iVar51 = piVar3[1];
                        goto LAB_00107750;
                     }

                     LAB_00107375:if (iVar39 == 1) {
                        piVar19 = (int*)( local_1c8 + 4 );
               ...
               LAB_001073a9:pppvVar22 = (void***)( (long)pppvVar22 + 4 );
            }
 while ( pppvVar22 != (void***)local_68 );
            local_378 = CONCAT44(iVar33 + local_1c8._4_4_, iVar33 + local_1c8._0_4_);
            (anonymous_namespace)::Partition::Reindex(local_198, local_300 + lVar47 * 5, local_208._0_8_, stack0xfffffffffffffe00, local_378, CONCAT44(iVar33 + uStack_1c0._4_4_, iVar33 + (int)uStack_1c0), local_258._0_4_, iVar33 + local_2e8[lVar47]);
 ...
 while ( local_358 != uVar46 );
         LAB_001075ac:puVar32 = *(undefined8**)( param_2 + 200 );
      }
      ...
      *(undefined1(*) [8])( param_2 + 0x138 ) = auVar13;
      if (auVar13 == (undefined1[8])0x0) {
         LAB_00107625:if (local_338 != (undefined8*)0x0) goto LAB_001081c4;
      }
 else {
 ...
 while ( pauVar24 != local_2c8 );
   ...
   LAB_001069f5:if (local_388 != (Impl*)0x0) {
      free(local_388);
   }
...
/* manifold::CreateTmpEdges(manifold::Vec<manifold::Halfedge> const&) */manifold * __thiscall manifold::CreateTmpEdges(manifold *this,Vec *param_1){
   ...
   *(undefined8*)( this + 0x10 ) = 0;
   ...
   if (uVar1 == 0) {
      *(undefined8*)( this + 8 ) = 0;
      ...
      uVar14 = 0;
      __size = 0;
      LAB_00108819:uVar4 = *(ulong*)( this + 8 );
      if (uVar4 < uVar14) {
         puVar10 = *(undefined8**)this;
         LAB_0010885c:for (puVar5 = (undefined4*)( (long)puVar10 + uVar4 * 0xc ); (undefined4*)( (long)puVar10 + __size ) != puVar5; puVar5 = puVar5 + 3) {
            *puVar5 = 0;
            puVar5[1] = 0;
            puVar5[2] = 0;
         }
 ...
 while ( puVar6 + lVar8 * 6 != puVar13 );
      ...
      puVar9 = puVar10;
      if (lVar8 == 0x18) {
         LAB_00108b4b:if (-1 < *(int*)( puVar13 + 1 )) {
            puVar13 = (undefined8*)( (long)puVar13 + 0xc );
            LAB_00108b28:if (-1 < *(int*)( puVar13 + 1 )) goto LAB_001089e1;
         }

         LAB_001089ab:puVar9 = puVar13;
         puVar2 = puVar13;
         if (puVar10 != puVar13) {
...
;
      ...
      LAB_001089e1:__size = (long)puVar9 - (long)puVar6;
      ...
      *(ulong*)( this + 8 ) = uVar14;
      joined_r0x00108a95:if (uVar1 <= uVar12) {
         return this;
      }

      LAB_00108a9b:puVar10 = (undefined8*)malloc(__size);
      puVar6 = *(undefined8**)this;
      if (0xc < (long)__size) {
   ...
   LAB_00108ac2:free(puVar6);
   *(undefined8**)this = puVar10;
   *(undefined8*)( this + 0x10 ) = *(undefined8*)( this + 8 );
   return this;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* manifold::Manifold::Impl::GetNeighbor(int) const */void manifold::Manifold::Impl::_GLOBAL__sub_I_GetNeighbor(void) {
   DAT_00108768 = 1;
   ...
   __cxa_atexit(std::unordered_map<linalg::vec<int,4>,std::unique_ptr<(anonymous_namespace)::Partition,std::default_delete<(anonymous_namespace)::Partition>>,std::hash<linalg::vec<int,4>>,std::equal_to<linalg::vec<int,4>>,std::allocator<std::pair<linalg::vec<int,4>const,std::unique_ptr<(anonymous_namespace)::Partition,std::default_delete<(anonymous_namespace)::Partition>>>>>::~unordered_map, &(anonymous_namespace)::Partition::cache, &__dso_handle);
   return;
}

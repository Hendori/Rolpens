...
/* RendererDummy::MaterialStorage::material_free(RID) */undefined1[16];RendererDummy::MaterialStorage::material_free (MaterialStorage *this,ulong param_2) {
   int iVar1;
   uint uVar2;
...
/* RendererDummy::MaterialStorage::shader_initialize(RID) */undefined1[16];RendererDummy::MaterialStorage::shader_initialize (MaterialStorage *this,ulong param_2) {
   long lVar1;

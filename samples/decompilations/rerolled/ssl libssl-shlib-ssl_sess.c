undefined8 def_generate_session_id(SSL *param_1, uchar *param_2, uint *param_3) {
   ...
   *(undefined8*)( ses[1].krb5_client_princ + 0x98 ) = param_1[0x70];
   ...
   for (int i_281 = 0; i_281 < 16; i_281++) {
      ses[1].session_id[i_281] = '\0';
   }
   for (int i_286 = 0; i_286 < 8; i_286++) {
      ses[1].krb5_client_princ[( i_286 + 96 )] = '\0';
   }
   for (int i_287 = 0; i_287 < 8; i_287++) {
      ses[1].sid_ctx[( i_287 + 4 )] = '\0';
   }
   for (int i_288 = 0; i_288 < 8; i_288++) {
      ses[1].krb5_client_princ[( i_288 + 168 )] = '\0';
   }
   for (int i_282 = 0; i_282 < 16; i_282++) {
      ses[1].krb5_client_princ[( i_282 + 56 )] = '\0';
   }
   *(undefined1(*) [16])( ses[1].session_id + 0x18 ) = (undefined1[16])0x0;
   for (int i_285 = 0; i_285 < 16; i_285++) {
      ses[1].krb5_client_princ[( i_285 + 120 )] = '\0';
   }
   for (int i_284 = 0; i_284 < 16; i_284++) {
      ses[1].krb5_client_princ[( i_284 + 40 )] = '\0';
   }
   for (int i_283 = 0; i_283 < 16; i_283++) {
      ses[1].krb5_client_princ[( i_283 + 152 )] = '\0';
   }
   LOCK();
   for (int i_289 = 0; i_289 < 4; i_289++) {
      ses[1].krb5_client_princ[( i_289 + 176 )] = '\x01';
   }
   UNLOCK();
   ...
   if (iVar1 == 0) {
      ...
      if (param_1[0x58] == 0) {
         ...
         if (( param_2 == 0 ) || ( param_1[0x65] == 0 )) {
            for (int i_290 = 0; i_290 < 16; i_290++) {
               ses[1].krb5_client_princ[( i_290 + 72 )] = '\0';
            }
         } else {
         ...
         *(long*)( ses[1].krb5_client_princ + 0x80 ) = lVar3;
         ...
         if (iVar1 != 0) {
            ...
            for (int i_291 = 0; i_291 < 4; i_291++) {
               ses[1].sid_ctx[i_291] = (char)( (ulong)uVar6 >> ( 8*i_291 + 32 ) );
            }
            goto LAB_001002cc;
         }
         ERR_new();
   ...
   *(long*)( param_1 + 0x2e8 ) = lVar1;
   ...
   if (( iVar1 != 0 ) && ( obj = (SSL_SESSION*)CRYPTO_zalloc(0x3a0, "ssl/ssl_sess.c", 0x6d) ),obj != (SSL_SESSION*)0x0) {
      ...
      for (int i_292 = 0; i_292 < 9; i_292++) {
         obj[1].sid_ctx[( i_292 + 12 )] = '\x01';
      }
      ...
      *(undefined8*)( obj[1].sid_ctx + 0x1c ) = uVar2;
      ...
      LOCK();
      for (int i_293 = 0; i_293 < 4; i_293++) {
         obj[1].krb5_client_princ[( i_293 + 176 )] = '\x01';
      }
      UNLOCK();
   ...
   *(undefined8*)( param_1 + 0x900 ) = 0;
   ...
   if (*(ulong*)( param_1 + 0x8d8 ) < 0x21) {
      ...
      *(SSL_SESSION**)( param_1 + 0x900 ) = ses;
      ...
      for (int i_294 = 0; i_294 < 8; i_294++) {
         ses[1].sid_ctx[( i_294 + 12 )] = '\0';
      }
   ...
   if (( c->tlsext_tick_lifetime_hint != 0 ) && ( uVar1._0_4_ = param_1[1].quiet_shutdown ),uVar1._4_4_ = param_1[1].max_send_fragment,iVar6 = CRYPTO_THREAD_write_lock(uVar1),iVar6 != 0) {
      ...
      if (lVar7 != 0) {
         ...
         if (( puVar2 != (undefined1*)0x0 ) && ( puVar3 = *(undefined1**)( ses[1].krb5_client_princ + 0xa0 ) ),puVar3 != (undefined1*)0x0) {
            ...
            for (int i_298 = 0; i_298 < 8; i_298++) {
               ses[1].krb5_client_princ[( i_298 + 168 )] = '\0';
            }
            for (int i_297 = 0; i_297 < 16; i_297++) {
               ses[1].krb5_client_princ[( i_297 + 152 )] = '\0';
            }
         }
         for (int i_296 = 0; i_296 < 4; i_296++) {
            c[1].session_id[( i_296 + 16 )] = '\x01';
         }
      ...
      for (int i_295 = 0; i_295 < 4; i_295++) {
         c[1].session_id[( i_295 + 16 )] = '\x01';
      }
   ...
   *piVar1 = *piVar1 + 1;
   ...
   if (pSVar6 == (SSL_SESSION*)0x0) {
      ...
      if (( puVar2 != (undefined1*)0x0 ) && ( puVar3 = *(undefined1**)( pSVar6[1].krb5_client_princ + 0xa0 ) ),puVar3 != (undefined1*)0x0) {
         ...
         for (int i_300 = 0; i_300 < 8; i_300++) {
            pSVar6[1].krb5_client_princ[( i_300 + 168 )] = '\0';
         }
         for (int i_299 = 0; i_299 < 16; i_299++) {
            pSVar6[1].krb5_client_princ[( i_299 + 152 )] = '\0';
         }
      }
      SSL_SESSION_free(pSVar6);
            ...
            *(undefined4*)( lVar9 + 0x2b0 ) = 1;
            ...
            if (puVar3 == (undefined1*)0x0) {
               *(undefined4*)( lVar9 + 0x2b0 ) = 1;
               ...
               for (int i_302 = 0; i_302 < 8; i_302++) {
                  pSVar6[1].krb5_client_princ[( i_302 + 168 )] = '\0';
               }
               for (int i_301 = 0; i_301 < 16; i_301++) {
                  pSVar6[1].krb5_client_princ[( i_301 + 152 )] = '\0';
               }
               *(undefined4*)( lVar9 + 0x2b0 ) = 1;
            }
            if (pcVar4 != (code*)0x0) {
      ...
      if (param_2 == 0) {
         do {
            ...
            if (( lVar1 != 0 ) && ( lVar2 = lVar2 != 0 )) {
               ...
               for (int i_305 = 0; i_305 < 8; i_305++) {
                  ses[1].krb5_client_princ[( i_305 + 168 )] = '\0';
               }
               for (int i_304 = 0; i_304 < 16; i_304++) {
                  ses[1].krb5_client_princ[( i_304 + 152 )] = '\0';
               }
            }
            for (int i_303 = 0; i_303 < 4; i_303++) {
               ses[1].session_id[( i_303 + 16 )] = '\x01';
            }
         ...
         do {
            ...
            if (( lVar1 != 0 ) && ( lVar2 = lVar2 != 0 )) {
               ...
               for (int i_308 = 0; i_308 < 8; i_308++) {
                  ses[1].krb5_client_princ[( i_308 + 168 )] = '\0';
               }
               for (int i_307 = 0; i_307 < 16; i_307++) {
                  ses[1].krb5_client_princ[( i_307 + 152 )] = '\0';
               }
            }
            for (int i_306 = 0; i_306 < 4; i_306++) {
               ses[1].session_id[( i_306 + 16 )] = '\x01';
            }
            if (*(code**)( param_1 + 0x68 ) != (code*)0x0) {
               ( **(code**)( param_1 + 0x68 ) )(param_1, ses);
            }
         ...
         do {
            while (true) {
               ...
               if (( lVar1 != 0 ) && ( lVar2 = lVar2 != 0 )) {
                  ...
                  for (int i_311 = 0; i_311 < 8; i_311++) {
                     ses[1].krb5_client_princ[( i_311 + 168 )] = '\0';
                  }
                  for (int i_310 = 0; i_310 < 16; i_310++) {
                     ses[1].krb5_client_princ[( i_310 + 152 )] = '\0';
                  }
               }
               for (int i_309 = 0; i_309 < 4; i_309++) {
                  ses[1].session_id[( i_309 + 16 )] = '\x01';
               }
               if (*(code**)( param_1 + 0x68 ) != (code*)0x0) {
                  ( **(code**)( param_1 + 0x68 ) )(param_1, ses);
               }

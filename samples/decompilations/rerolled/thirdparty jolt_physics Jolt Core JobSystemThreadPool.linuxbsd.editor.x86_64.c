/* std::thread::_State_impl<std::thread::_Invoker<std::tuple<JPH::JobSystemThreadPool::StartThreads(int)::{lambda()#1}>
   > >::~_State_impl() */void std::thread::_State_impl<std::thread::_Invoker < std::tuple<JPH::JobSystemThreadPool::StartThreads(int)::{lambda()#1}>>>::~_State_impl(_State_impl<std::thread::_Invoker < std::tuple<JPH::JobSystemThreadPool::StartThreads(int)::_lambda()_1_> >> *this) {
   ...
   *(undefined***)this = &PTR___State_impl_001013b8;
   ...
   return;
}/* JPH::JobSystemThreadPool::StopThreads() [clone .part.0] */ulong JPH::JobSystemThreadPool::StopThreads(JobSystemThreadPool *this) {
   ...
   if (pJVar10 != pJVar1) {
      ...
      LAB_001000c0:lVar12 = *(long*)( this + 0x100 );
   }
   if (lVar12 != 0) {
   ...
   *(undefined8*)( this + 0x100 ) = 0;
      ...
      if (pJVar10 != (JobSystemThreadPool*)0x0) {
         ...
         if (iVar3 == 0) {
            if (*(long*)( pJVar10 + 0x20 ) == 0) {
               ...
               lVar12 = ( ulong )(uVar13 & *(uint*)( pJVar15 + 0x88 )) * 0x40 + *(long*)( *(long*)( pJVar15 + 0x98 ) + ( ulong )(uVar13 >> ( ( byte ) * (undefined4*)( pJVar15 + 0x84 ) & 0x1f )) * 8 );
         ...
         *(int*)pJVar11 = *(int*)pJVar11 + -1;
         ...
         if (*(int*)pJVar11 == 0) {
            ...
            if (*(code**)( *(long*)pJVar11 + 0x48 ) == FreeJob) {
               ...
               lVar12 = ( ulong )(uVar5 & *(uint*)( pJVar11 + 0x88 )) * 0x40 + *(long*)( *(long*)( pJVar11 + 0x98 ) + ( ulong )(uVar5 >> ( ( byte ) * (undefined4*)( pJVar11 + 0x84 ) & 0x1f )) * 8 );
               if (*(code**)( lVar12 + 0x20 ) != (code*)0x0) {
...
}/* JPH::JobSystemThreadPool::FreeJob(JPH::JobSystem::Job*) */long JPH::JobSystemThreadPool::FreeJob(JobSystemThreadPool *this, Job *param_1) {
   JobSystemThreadPool *pJVar1;
   ...
   lVar7 = ( ulong )(uVar4 & *(uint*)( this + 0x88 )) * 0x40 + *(long*)( *(long*)( this + 0x98 ) + ( ulong )(uVar4 >> ( ( byte ) * (undefined4*)( this + 0x84 ) & 0x1f )) * 8 );
   ...
   return lVar6;
}/* JPH::JobSystemThreadPool::~JobSystemThreadPool() */void JPH::JobSystemThreadPool::~JobSystemThreadPool(JobSystemThreadPool *this) {
   long lVar1;
   long *plVar2;
   uint uVar3;
   uint uVar4;
   ...
   *(undefined***)this = &PTR__JobSystemThreadPool_00101358;
   ...
   ;;
   for (int i_312 = 0; i_312 < 2; i_312++) {
      /* WARNING: Could not recover jumptable at 0x00100441. Too many branches */
   }
   ( *AlignedFree )(this);
   return;
}/* JPH::JobSystemThreadPool::StartThreads(int) */void JPH::JobSystemThreadPool::StartThreads(JobSystemThreadPool *this, int param_1) {
   undefined8 uVar1;
   ulong uVar2;
   long lVar3;
   undefined8 *puVar4;
   ...
   *(long*)( this + 0x2118 ) = lVar3;
   if (param_1 < 1) {
      ...
      LAB_00100690:puVar5 = (undefined8*)( *Allocate )(uVar10 * 8);
   ...
   do {
      ...
      if (*(ulong*)( this + 0x108 ) < uVar10) {
         ...
         LAB_00100610:lVar3 = *(long*)( this + 0x100 );
         *(ulong*)( this + 0x108 ) = uVar10;
   ...
   LAB_00100485:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* JPH::JobSystemThreadPool::Init(unsigned int, unsigned int, int) */void JPH::JobSystemThreadPool::Init(JobSystemThreadPool *this, uint param_1, uint param_2, int param_3) {
   ulong uVar1;
   int iVar2;
   uint uVar3;
   undefined8 uVar4;
   ...
   *(undefined8*)( this + 0xf0 ) = 0xffffffff;
   ...
   return;
}/* JPH::JobSystemThreadPool::JobSystemThreadPool(unsigned int, unsigned int, int) */void JPH::JobSystemThreadPool::JobSystemThreadPool(JobSystemThreadPool *this, uint param_1, uint param_2, int param_3) {
   *(undefined***)this = &PTR__JobSystemThreadPool_00101358;
   *(undefined4*)( this + 8 ) = 0;
   *(undefined8*)( this + 0x10 ) = 0;
   *(code**)( this + 0x28 ) = std::_Function_handler<void(int),JPH::JobSystemThreadPool::mThreadInitFunction::{lambda(int)#1}>::_M_manager;
   *(code**)( this + 0x30 ) = std::_Function_handler<void(int),JPH::JobSystemThreadPool::mThreadInitFunction::{lambda(int)#1}>::_M_invoke;
   ...
   *(code**)( this + 0x48 ) = std::_Function_handler<void(int),JPH::JobSystemThreadPool::mThreadExitFunction::{lambda(int)#1}>::_M_manager;
   *(code**)( this + 0x50 ) = std::_Function_handler<void(int),JPH::JobSystemThreadPool::mThreadExitFunction::{lambda(int)#1}>::_M_invoke;
   *(undefined1(*) [16])( this + 0x100 ) = (undefined1[16])0x0;
   JPH::Semaphore::Semaphore((Semaphore*)( this + 0x2148 ));
   this[0x21a8] = (JobSystemThreadPool)0x0;
   Init(this, param_1, param_2, param_3);
   return;
}/* JPH::JobSystemThreadPool::StopThreads() */void JPH::JobSystemThreadPool::StopThreads(JobSystemThreadPool *this) {
   if (*(long*)( this + 0x100 ) == 0) {
      return;
   }
   StopThreads(this);
   return;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JPH::JobSystemThreadPool::CreateJob(char const*, JPH::Color, std::function<void ()> const&,
   unsigned int) */undefined8 *JPH::JobSystemThreadPool::CreateJob(undefined8 *param_1, timespec *param_2, undefined8 param_3, undefined8 param_4, long param_5, int param_6) {
   timespec *ptVar1;
   long *plVar2;
   ...
   LAB_00100990:do {
      ...
      if (uVar17 == 0xffffffff) {
         ...
         *(int*)plVar2 = (int)*plVar2 + 1;
         ...
         if ((uint)param_2[9].tv_sec <= uVar17) {
            ...
            if (uVar10 != 0) {
               this(JobSystemThreadPool * )(ulong);
               std::__throw_system_error(uVar10);
               if (*(undefined8**)( this + 0x100 ) != (undefined8*)0x0) {
                  p_Var8 = &ptVar16->tv_sec;
                  for (; ptVar16 < (timespec*)( p_Var8 + extraout_EDX ); ptVar16 = (timespec*)&ptVar16->tv_nsec) {
            ...
            LAB_00100c3c:pthread_mutex_unlock(__mutex);
         }
         puVar14 = (undefined8*)( ( ulong )(uVar17 & (uint)param_2[8].tv_nsec) * 0x40 + *(long*)( param_2[9].tv_nsec + ( ulong )(uVar17 >> ( ( byte ) * (undefined4*)( (long)&param_2[8].tv_sec + 4 ) & 0x1f )) * 8 ) );
      ...
      uVar3 = *(undefined4*)( ( ulong )(uVar17 & (uint)param_2[8].tv_nsec) * 0x40 + *(long*)( param_2[9].tv_nsec + ( ulong )(uVar17 >> ( ( byte ) * (undefined4*)( (long)&param_2[8].tv_sec + 4 ) & 0x1f )) * 8 ) + 0x38 );
      LOCK();
      ...
      *(int*)plVar2 = (int)*plVar2 + 1;
      ...
      if (bVar18) {
         ...
         *(uint*)( puVar14 + 7 ) = uVar17;
         LAB_00100a69:pJVar15 = (Job*)( ( ulong )(uVar17 & (uint)param_2[8].tv_nsec) * 0x40 + *(long*)( param_2[9].tv_nsec + ( ulong )(uVar17 >> ( ( byte ) * (undefined4*)( (long)&param_2[8].tv_sec + 4 ) & 0x1f )) * 8 ) );
         *param_1 = pJVar15;
         if (pJVar15 != (Job*)0x0) {
            LOCK();
...
}/* JPH::JobSystemThreadPool::QueueJobs(JPH::JobSystem::Job**, unsigned int) */void JPH::JobSystemThreadPool::QueueJobs(JobSystemThreadPool *this, Job **param_1, uint param_2) {
   Job **ppJVar1;
   Job *pJVar2;
   if (*(long*)( this + 0x100 ) == 0) {
      return;
   ...
   return;
}/* JPH::JobSystemThreadPool::QueueJob(JPH::JobSystem::Job*) */void JPH::JobSystemThreadPool::QueueJob(JobSystemThreadPool *this, Job *param_1) {
   if (*(long*)( this + 0x100 ) == 0) {
      return;
   }
   ...
   JPH::Semaphore::Release((int)this + 0x2148);
   return;
}/* JPH::JobSystemThreadPool::ThreadMain(int) */void JPH::JobSystemThreadPool::ThreadMain(JobSystemThreadPool *this, int param_1) {
   int *piVar1;
   uint *puVar2;
                  ...
                  *(int*)plVar12 = (int)*plVar12 + -1;
                  ...
                  if ((int)*plVar12 == 0) {
                     ...
                     if (*(code**)( *plVar12 + 0x48 ) == FreeJob) {
                        uVar7 = *(uint*)( plVar5 + 7 );
                        lVar11 = ( ulong )(uVar7 & *(uint*)( plVar12 + 0x11 )) * 0x40 + *(long*)( plVar12[0x13] + ( ulong )(uVar7 >> ( ( byte ) * (undefined4*)( (long)plVar12 + 0x84 ) & 0x1f )) * 8 );
   ...
   LAB_00100f73:std::__throw_bad_function_call();
   LAB_00100f78:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* std::thread::_State_impl<std::thread::_Invoker<std::tuple<JPH::JobSystemThreadPool::StartThreads(int)::{lambda()#1}>
   > >::_M_run() */void std::thread::_State_impl<std::thread::_Invoker < std::tuple<JPH::JobSystemThreadPool::StartThreads(int)::{lambda()#1}>>>::_M_run(_State_impl<std::thread::_Invoker < std::tuple<JPH::JobSystemThreadPool::StartThreads(int)::_lambda()_1_> >> *this) {
   ...
   return;
}/* JPH::JobSystemThreadPool::GetMaxConcurrency() const */int JPH::JobSystemThreadPool::GetMaxConcurrency(JobSystemThreadPool *this) {
   ...
   int&&) */void std::_Function_handler<void(int),JPH::JobSystemThreadPool::mThreadInitFunction::{lambda(int)#1}>::_M_invoke(_Any_data *param_1, int *param_2) {
   return;
}/* std::_Function_handler<void (int),
   JPH::JobSystemThreadPool::mThreadExitFunction::{lambda(int)#1}>::_M_invoke(std::_Any_data const&,
   int&&) */void std::_Function_handler<void(int),JPH::JobSystemThreadPool::mThreadExitFunction::{lambda(int)#1}>::_M_invoke(_Any_data *param_1, int *param_2) {
   return;
}/* std::_Function_handler<void (int),
    ...
    */undefined8 std::_Function_handler<void(int),JPH::JobSystemThreadPool::mThreadInitFunction::{lambda(int)#1}>::_M_manager(undefined8 *param_1, undefined8 param_2, int param_3) {
   if (param_3 == 0) {
      *param_1 = &JPH::JobSystemThreadPool::mThreadInitFunction::{lambda;
      return 0;
   }
   if (param_3 != 1) {
      return 0;
   ...
   *param_1 = param_2;
    ...
    */undefined8 std::_Function_handler<void(int),JPH::JobSystemThreadPool::mThreadExitFunction::{lambda(int)#1}>::_M_manager(undefined8 *param_1, undefined8 param_2, int param_3) {
   if (param_3 == 0) {
      *param_1 = &JPH::JobSystemThreadPool::mThreadExitFunction::{lambda;
      return 0;
   }
   if (param_3 != 1) {
      return 0;
   ...
   *param_1 = param_2;
   return 0;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JPH::JobSystemThreadPool::QueueJobInternal(JPH::JobSystem::Job*) */void JPH::JobSystemThreadPool::QueueJobInternal(JobSystemThreadPool *this, Job *param_1) {
   JobSystemThreadPool *pJVar1;
   uint uVar2;
   int iVar3;
   ulong uVar4;
...
}/* JPH::JobSystemThreadPool::Init(unsigned int, unsigned int, int) */void JPH::JobSystemThreadPool::_GLOBAL__sub_I_Init(void) {
   if (DVec3::cTrue == '\0') {
      DVec3::cTrue = '\x01';
      DVec3::cTrue = _LC3;
   }

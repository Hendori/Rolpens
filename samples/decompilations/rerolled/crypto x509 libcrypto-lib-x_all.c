...
int X509_sign_ctx(X509 *x, EVP_MD_CTX *ctx) {
   ...
   *(undefined4*)&x->crldp = 1;
   ...
   iVar1 = ASN1_item_sign_ctx(it, (X509_ALGOR*)&x->name, (X509_ALGOR*)&x->altname, (ASN1_BIT_STRING*)&x->rfc3779_addr, x, ctx);
   return iVar1;
}
...
int X509_CRL_sign(X509_CRL *x, EVP_PKEY *pkey, EVP_MD *md) {
   ...
   if (x != (X509_CRL*)0x0) {
      ...
      iVar3 = ASN1_item_sign_ex(uVar4, &x->sig_alg, x->sha1_hash + 0x10, &x->meth, x, 0, pkey, md, pvVar2, pXVar1);
      return iVar3;
   }
...
int X509_CRL_sign_ctx(X509_CRL *x, EVP_MD_CTX *ctx) {
   ...
   if (x != (X509_CRL*)0x0) {
      ...
      iVar1 = ASN1_item_sign_ctx(it, (X509_ALGOR*)&x->sig_alg, (X509_ALGOR*)( x->sha1_hash + 0x10 ), (ASN1_BIT_STRING*)&x->meth, x, ctx);
      return iVar1;
   }
...
void X509_ACERT_sign_ctx(undefined8 *param_1, EVP_MD_CTX *param_2) {
   ...
   ASN1_item_sign_ctx(it, (X509_ALGOR*)( param_1 + 1 ), (X509_ALGOR*)( (long)asn + 0x40 ), (ASN1_BIT_STRING*)( param_1 + 3 ), asn, param_2);
   return;
}
...
ASN1_OCTET_STRING *X509_digest_sig(X509 *param_1, undefined8 *param_2, undefined4 *param_3) {
   ...
   if (local_98 == 0) {
      if (local_94 == 0x390) {
         ...
         if (local_94 != 0) {
            pcVar3 = "SHA512";
            if (( local_94 != 0x43f ) && ( pcVar3 = local_94 != 0x440 )) {
               pcVar3 = "SHA256";
            }

            type = (EVP_MD*)EVP_MD_fetch(*(undefined8*)param_1[1].sha1_hash, pcVar3, *(undefined8*)( param_1[1].sha1_hash + 8 ));
            if (type != (EVP_MD*)0x0) {
               if (param_3 != (undefined4*)0x0) {
                  *param_3 = 1;
               }
      ...
      LAB_00101278:str = (ASN1_OCTET_STRING*)0x0;
      ...
      LAB_00101190:iVar1 = X509_digest(param_1, type, local_78, (uint*)&local_80);
      if (iVar1 != 0) {
      ...
      EVP_MD_free(type);
      LAB_00101210:str = (ASN1_OCTET_STRING*)0x0;
   }

   LAB_001011d7:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return str;
   }
...
PKCS8_PRIV_KEY_INFO *d2i_PKCS8_PRIV_KEY_INFO_fp(FILE *fp, PKCS8_PRIV_KEY_INFO **p8inf) {
   ...
   pPVar1 = (PKCS8_PRIV_KEY_INFO*)ASN1_d2i_fp((xnew*)&PKCS8_PRIV_KEY_INFO_new, &d2i_PKCS8_PRIV_KEY_INFO, fp, p8inf);
   return pPVar1;
}
...
PKCS8_PRIV_KEY_INFO *d2i_PKCS8_PRIV_KEY_INFO_bio(BIO *bp, PKCS8_PRIV_KEY_INFO **p8inf) {
   PKCS8_PRIV_KEY_INFO *pPVar1;
   pPVar1 = (PKCS8_PRIV_KEY_INFO*)ASN1_d2i_bio((xnew*)&PKCS8_PRIV_KEY_INFO_new, &d2i_PKCS8_PRIV_KEY_INFO, bp, p8inf);
   return pPVar1;
}
...
undefined8 d2i_PrivateKey_ex_bio(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4) {
   int iVar1;
   undefined8 uVar2;
   long in_FS_OFFSET;
   BUF_MEM *local_40;
...
undefined8 d2i_PrivateKey_ex_fp(void *param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4) {
   BIO_METHOD *type;
   BIO *bp;
   undefined8 uVar1;
   type = BIO_s_file();
...
undefined8 d2i_PUBKEY_ex_bio(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4) {
   int iVar1;
   undefined8 uVar2;
   long in_FS_OFFSET;
   BUF_MEM *local_40;

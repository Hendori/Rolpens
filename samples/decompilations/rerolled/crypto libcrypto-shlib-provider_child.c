undefined8 ossl_child_provider_init(undefined8 param_1, int *param_2, undefined8 *param_3, undefined8 *param_4) {
   int iVar1;
   undefined8 uVar2;
   long lVar3;
   code *pcVar4;
   ...
   if (lVar2 != 0) {
      ...
      if (iVar1 != 0) {
         ...
         *(undefined8*)( lVar2 + 8 ) = param_1;
         ...
         LAB_001001c8:CRYPTO_THREAD_unlock(*(undefined8*)( lVar2 + 0x10 ));
         return bVar5;
      }
   }
   return false;
      ...
      *puVar3 = param_2;
      ...
      while (iVar2 != 0) {
         if (iVar2 == 4) {
            ...
            switch (iVar2) {
               for (int i_2437 = 0; i_2437 < 6; i_2437++) {
                  case 0x6a:
      ...
      if (( ( ( puVar3[3] != 0 ) && ( puVar3[4] != 0 ) ) && ( puVar3[6] != 0 ) ) && ( ( ( puVar3[7] != 0 && ( puVar3[8] != 0 ) ) && ( ( puVar3[9] != 0 && ( puVar3[10] != 0 ) ) ) ) )) {
         lVar4 = CRYPTO_THREAD_lock_new();
         puVar3[2] = lVar4;
         if (lVar4 != 0) {
            iVar2 = ( *(code*)puVar3[4] )(*puVar3, provider_create_child_cb, provider_remove_child_cb, provider_global_props_cb, param_1);
            return iVar2 != 0;
         }
      }
   }
   ...
   if (puVar1 != (undefined8*)0x0) {
      for (int i_2438 = 0; i_2438 < 2; i_2438++) {
   ...
   if (*plVar2 != lVar3) {
      for (int i_2439 = 0; i_2439 < 2; i_2439++) {
   ...
   if (*plVar2 != lVar3) {
      ...
      for (int i_2440 = 0; i_2440 < 2; i_2440++) {

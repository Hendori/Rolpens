/* JPH::VehicleTransmissionSettings::sCreateRTTI(JPH::RTTI&) */void JPH::VehicleTransmissionSettings::sCreateRTTI(RTTI *param_1) {
   return;
}
/* _FUN(void*) */void JPH::GetRTTIOfType(JPH::VehicleTransmissionSettings*)::{lambda(void*)#1}::_FUN(void *param_1)

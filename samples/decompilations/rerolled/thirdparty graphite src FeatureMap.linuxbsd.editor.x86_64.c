/* (anonymous namespace)::cmpNameAndFeatures(void const*, void const*) */ulong(anonymous_namespace) {
   ulong uVar1;
   for (int i_163 = 0; i_163 < 2; i_163++) {
    ...
    */void graphite2::FeatureRef::FeatureRef(FeatureRef *this, undefined8 param_1, ushort *param_2, uint param_3, undefined4 param_4, undefined2 param_5, undefined2 param_7, undefined8 param_8, undefined2 param_9) {
   ushort uVar1;
   FeatureRef FVar2;
   uint uVar3;
   uint uVar4;
   ...
   *(uint*)( this + 0x10 ) = param_3 << (sbyte)FVar2;
   return;
}/* graphite2::FeatureRef::~FeatureRef() */void graphite2::FeatureRef::~FeatureRef(FeatureRef *this) {
   free(*(void**)( this + 8 ));
   return;
}/* graphite2::SillMap::cloneFeatures(unsigned int) const */undefined1(*)[16];graphite2::SillMap::cloneFeatures (SillMap *this,uint param_1) {
   size_t sVar1;
   long *plVar2;
   long lVar3;
   long lVar4;
   ...
   *pauVar6 = (undefined1[16])0x0;
   ...
   if (uVar8 != 0) {
      ...
      graphite2_SillMap_cloneFeatures:/* WARNING: Subroutine does not return */abort();
   }
   pvVar9 = (void*)0x0;
   LAB_0010024a:lVar10 = 0;
   *(long*)( *pauVar6 + 8 ) = ( lVar3 - lVar4 ) + (long)pvVar9;
   if (lVar3 != lVar4) {
      do {
         *(undefined4*)( (long)pvVar9 + lVar10 ) = *(undefined4*)( lVar4 + lVar10 );
   ...
   *(undefined8*)( pauVar6[1] + 8 ) = *(undefined8*)( this + 0x30 );
   return pauVar6;
}/* graphite2::FeatureMap::findFeatureRef(unsigned int) const */undefined8 graphite2::FeatureMap::findFeatureRef(FeatureMap *this, uint param_1) {
   uint *puVar1;
   uint *puVar2;
...
}/* graphite2::FeatureRef::applyValToFeature(unsigned int, graphite2::FeatureVal&) const */undefined8 graphite2::FeatureRef::applyValToFeature(FeatureRef *this, uint param_1, FeatureVal *param_2) {
   uint *puVar1;
   long lVar2;
   void *__ptr;
   ulong uVar3;
   ...
   return uVar4;
}/* graphite2::FeatureMap::readFeats(graphite2::Face const&) */undefined8 graphite2::FeatureMap::readFeats(FeatureMap *this, Face *param_1) {
   ushort *puVar1;
   uint uVar2;
   undefined4 uVar3;
   void *__base;
               ...
               *(FeatureRef**)( this + 8 ) = pFVar15;
               ...
               if (__ptr != (void*)0x0) {
                  ...
                  do {
                     ...
                     uVar16 = ( ulong )(uVar2 >> 0x18 | ( uVar2 & 0xff0000 ) >> 8 | ( uVar2 & 0xff00 ) << 8 | uVar2 << 0x18);
                     if (( local_58 < uVar16 ) || ( local_58 < uVar31 * 4 + uVar16 )) {
                        LAB_001007a0:free(__ptr);
                        goto LAB_001004b9;
                     }
                     if (uVar31 == 0) {
                        uVar5 = 0;
                     ...
                     *(ushort*)( (long)__ptr + lVar29 * 2 ) = uVar5;
                     lVar29 = lVar29 + 1;
                     FeatureRef::FeatureRef(pFVar9, param_1, &local_6a, uVar16, uVar25, uVar6 << 8 | uVar6 >> 8, (ushort)uVar4 << 8 | (ushort)uVar4 >> 8, puVar11, uVar31);
                  ...
                  *(undefined4**)( this + 0x10 ) = puVar14;
                  if (puVar14 != (undefined4*)0x0) {
                     ...
                     do {
                        lVar30 = lVar29 * 0x28;
                        FeatureRef::applyValToFeature(pFVar15 + lVar30, ( uint ) * (ushort*)( (long)__ptr + lVar29 * 2 ), (FeatureVal*)( this + 0x18 ));
   ...
   return uVar22;
}/* graphite2::SillMap::readSill(graphite2::Face const&) */undefined8 graphite2::SillMap::readSill(SillMap *this, Face *param_1) {
   ulong *puVar1;
   size_t __size;
   ushort uVar2;
   uint uVar3;
               ...
               do {
                  ...
                  *(undefined1(*) [16])pFVar8 = (undefined1[16])0x0;
                  ...
                  if (uVar10 == 0) {
                     ...
                     __size = uVar10 * 4;
                     if (uVar9 >> 0x3e != 0) {
                        graphite2_SillMap_readSill:/* WARNING: Subroutine does not return */abort();
                     }
                  ...
                  if (uVar2 == 0) {
                     ...
                     do {
                        ...
                        for (puVar13 = puVar14; puVar13 < puVar17; puVar13 = puVar13 + 4) {
                           if (*puVar13 == ( uVar3 >> 0x18 | ( uVar3 & 0xff0000 ) >> 8 | ( uVar3 & 0xff00 ) << 8 | uVar3 << 0x18 )) {
                              if (*(FeatureRef**)( puVar13 + 2 ) != (FeatureRef*)0x0) {
                                 FeatureRef::applyValToFeature(*(FeatureRef**)( puVar13 + 2 ), ( uint )(ushort)((ushort)puVar22[1] << 8 | (ushort)puVar22[1] >> 8), pFVar8);
                                 uVar9 = ( ulong ) * (ushort*)this;
                                 puVar14 = *(uint**)( this + 0x10 );
                                 puVar17 = puVar14 + uVar9 * 4;
                              }
   ...
   LAB_00100cb9:uVar18 = 1;
   LAB_001009b9:graphite2::Face::Table::release();
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return uVar18;
}/* graphite2::SillMap::readFace(graphite2::Face const&) */undefined8 graphite2::SillMap::readFace(SillMap *this, Face *param_1) {
   char cVar1;
   undefined8 uVar2;
   ...
   return uVar2;
}/* graphite2::FeatureRef::getFeatureVal(graphite2::FeatureVal const&) const */uint graphite2::FeatureRef::getFeatureVal(FeatureRef *this, FeatureVal *param_1) {
   if (( ( (ulong)(byte)this[0x23] < ( ulong )(*(long*)( param_1 + 8 ) - *(long*)param_1 >> 2) ) && ( *(long*)this != 0 ) ) && ( *(long*)( param_1 + 0x18 ) == *(long*)this + 8 )) {
      return ( *(uint*)( *(long*)param_1 + (ulong)(byte)this[0x23] * 4 ) & *(uint*)( this + 0x10 ) ) >> ( (byte)this[0x22] & 0x1f );
   }
   return 0;
}/* graphite2::SillMap::cloneFeatures(unsigned int) const [clone .cold] */void graphite2::SillMap::cloneFeatures(uint param_1) {
   /* WARNING: Subroutine does not return */
   abort();
}/* graphite2::FeatureRef::applyValToFeature(unsigned int, graphite2::FeatureVal&) const [clone
   .cold] */void graphite2::FeatureRef::applyValToFeature(uint param_1, FeatureVal *param_2) {
   /* WARNING: Subroutine does not return */
   abort();
}/* graphite2::FeatureMap::readFeats(graphite2::Face const&) [clone .cold] */void graphite2::FeatureMap::readFeats(Face *param_1) {
   /* WARNING: Subroutine does not return */
   abort();
}/* graphite2::SillMap::readSill(graphite2::Face const&) [clone .cold] */void graphite2::SillMap::readSill(Face *param_1) {
   /* WARNING: Subroutine does not return */
   abort();
}

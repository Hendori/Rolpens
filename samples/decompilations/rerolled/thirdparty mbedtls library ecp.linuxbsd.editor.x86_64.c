...
;
 ...
 while ( puVar16 != local_48 );
   ...
   if (( iVar6 != 0 ) || ( iVar6 = mbedtls_mpi_safe_cond_swap(lVar1, local_d8, uVar5) ),iVar6 != 0) goto LAB_001037f8;
...
;
   ...
   if (( ( ( iVar6 != 0 ) || ( iVar6 = mbedtls_mpi_add_mod(param_1, lVar1, local_78) ),iVar6 != 0 ) ) || ( iVar6 = mbedtls_mpi_add_mod(param_1, local_f8, local_58) ),iVar6 != 0) ( ( ( ( iVar6 = mbedtls_mpi_mul_mod(param_1, local_f8, local_f8) ),iVar6 != 0 || ( iVar6 = mbedtls_mpi_sub_mod(param_1, local_d8, local_58) ),iVar6 != 0 ) ) || ( ( iVar6 = mbedtls_mpi_mul_mod(param_1, local_d8, local_d8) ),iVar6 != 0 || ( ( iVar6 = mbedtls_mpi_mul_mod(param_1, local_d8, local_108) ),iVar6 != 0 || ( iVar6 = mbedtls_mpi_mul_mod(param_1, lVar1, local_88) ),iVar6 != 0 ) ) ) || ( iVar6 = iVar6 != 0 );

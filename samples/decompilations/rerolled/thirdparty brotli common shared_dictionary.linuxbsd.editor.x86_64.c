void BrotliSharedDictionaryDestroyInstance(long param_1) {
   ...
   return;
}undefined8 BrotliSharedDictionaryAttach(uint *param_1, int param_2, undefined8 param_3, undefined8 param_4) {
   uint uVar1;
   if (( ( param_2 == 0 ) && ( param_1 != (uint*)0x0 ) ) && ( uVar1 = uVar1 < 0xf )) {
   ...
   return 0;
}undefined8 *BrotliSharedDictionaryCreateInstance(code *param_1, undefined *param_2, undefined8 param_3) {
   undefined8 *puVar1;
   undefined8 uVar2;
   ulong uVar3;
   undefined8 *puVar4;
   ...
   if (param_1 == (code*)0x0 && param_2 == (undefined*)0x0) {
      ...
      if (puVar1 != (undefined8*)0x0) {
         *(undefined1*)( (long)puVar1 + 0x13c ) = 1;
         ...
         LAB_0010013f:puVar1[0xae] = param_2;
         puVar1[0xaf] = param_3;
         return puVar1;
      }
      ...
      if (puVar1 != (undefined8*)0x0) {
         *puVar1 = 0;
         ...
         for (uVar3 = ( ulong )(( (int)puVar1 - (int)(undefined8*)( ( ulong )(puVar1 + 1) & 0xfffffffffffffff8 ) ) + 0x580U >> 3); uVar3 != 0; uVar3 = uVar3 - 1) {
            *puVar4 = 0;

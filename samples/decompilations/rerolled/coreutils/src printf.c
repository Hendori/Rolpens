arg_cursor *get_curr_arg(arg_cursor *__return_storage_ptr__, wchar_t pos, arg_cursor ac) {
 ...
 while ( iVar6 - 0x30U < 10 );
   ...
   LAB_001000a1:__return_storage_ptr__->f = ac.f;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* WARNING: Unknown calling convention */wchar_t print_esc(char *escstart, _Bool octal_0) {
   int iVar1;
   bool bVar2;
   wchar_t wVar3;
   char *pcVar4;
   ...
   if (bVar12 == 0x78) {
      ...
      while (true) {
         bVar12 = *pbVar13;
         if (( 0x36 < ( byte )(bVar12 - 0x30) ) || ( ( 0x7e0000007e03ffU >> ( ( ulong )(bVar12 - 0x30) & 0x3f ) & 1 ) == 0 )) break;
         cVar15 = bVar12 + 0xa9;
...
;
      ...
      if (7 < ( byte )(bVar12 - 0x30)) {
         if (bVar12 == 0) {
            LAB_00100199:pcVar4 = _stdout->_IO_write_ptr;
            ...
            while (true) {
               ...
               while (true) {
                  bVar14 = *pbVar8;
                  if (( 0x36 < ( byte )(bVar14 - 0x30) ) || ( ( 0x7e0000007e03ffU >> ( ( ulong )(bVar14 - 0x30) & 0x3f ) & 1 ) == 0 )) break;
...
;
               LAB_00100260:uVar5 = dcgettext(0, "missing hexadecimal number in escape", 5);
               error(1, 0, uVar5);
            }
;
 ...
 while ( pbVar8 != pbVar11 );
   ...
   LAB_00100155:pbVar8 = (byte*)_stdout->_IO_write_ptr;
   if (pbVar8 < _stdout->_IO_write_end) {
      _stdout->_IO_write_ptr = (char*)( pbVar8 + 1 );
      *pbVar8 = bVar14;
   }
...
/* WARNING: Unknown calling convention */void verify_numeric(char *s, char *end) {
   int *piVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   char *pcVar4;
...
/* WARNING: Unknown calling convention */intmax_t vstrtoimax(char *s) {
   long lVar1;
   char cVar2;
   int *piVar3;
   ulong uVar4;
   ...
   if (( ( *s == '\"' ) || ( *s == '\'' ) ) && ( uVar4 = (ulong)(byte)s[1] ),s[1] != 0) {
      ...
      if (( cVar2 != '\0' ) && ( posixly_correct == false )) {
         uVar7 = dcgettext(0, "warning: %s: character(s) following character constant have been ignored", 5);
   ...
   LAB_001006cb:if (lVar1 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar4;
   }
...
/* WARNING: Type propagation algorithm not settling *//* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* WARNING: Unknown calling convention */wchar_t print_formatted(char *format, wchar_t argc, char **argv) {
   byte *pbVar1;
   bool bVar2;
   arg_cursor ac;
   arg_cursor ac_00;
   ...
   if (bVar7 != 0) {
      ...
      *pcVar13 = '%';
      ...
      if (bVar7 == 0x62) {
         ...
         if (( ( L'\xffffffff' < local_158._4_4_ ) || ( local_20c = local_20c + L'\x01' ),wVar6 = local_20c,L'\xffffffff' < local_20c )) &&( wVar26 = wVar6 ),uVar27 = (ulong)(uint)wVar9,wVar9;
      }
...
;
   ...
   if (bVar7 != 0x71) {
      ...
      LAB_00100bb0:bVar7 = (byte)uVar23;
...
wVar9 = (wchar_t)uVar27;pbVar25 = (byte*)( local_168._0_8_ + 1 );format = (char*)uVar19;if (argc <= wVar26) goto LAB_00100861;pcVar14 = (char*)quotearg_style(3, argv[wVar26]);fputs_unlocked(pcVar14, pFVar5);bVar7 = *(byte*)( uVar19 + 1 );format = (char*)pbVar25;goto joined_r0x00100867;}free(pcVar13);local_1e0 = L'\0';LAB_001009a5:if (lVar22 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return local_1e0;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();switchD_00100bc1_caseD_7:pbVar25 = pbVar25 + 1;*pbVar29 = bVar7;bVar4 = true;uVar23 = ( uint ) * pbVar25;bVar2 = true;pbVar29 = pbVar29 + 1;goto LAB_00100bb0;switchD_00100bc1_caseD_1:if (bVar3) {
   ok[99] = '\x01';
   ok[100] = '\0';
   ok[0x65] = '\x01';
   ok[0x66] = '\x01';
...
ok[0x75] = !bVar3;ok[0x69] = !bVar3;if (bVar2) {
   ok[0x61] = '\0';
   ok[0x41] = '\0';
   if (!bVar4) {
      ok[0x6f] = '\0';
...
uVar27 = (ulong)(uint)wVar9;uVar30 = (ulong)auVar32._12_4_;if (bVar7 == 0x2e) {
   bVar7 = pbVar25[1];
   *pbVar29 = 0x2e;
   ok._99_4_ = ok._99_4_ & 0xffffff00;
   if (bVar7 == 0x2a) {
...
*pbVar29 = 0;do {
 ...
 while ( ( 0x410150000001U >> ( ( ulong )(bVar7 - 0x4c) & 0x3f ) & 1 ) != 0 );if (ok[bVar7] == '\0') {
   ...
   pFVar5 = _stdout;
   pcVar13 = (char*)dcgettext(0, "Print ARGUMENT(s) according to FORMAT, or execute according to OPTION:\n\n", 5);
   ...
   fputs_unlocked(pcVar13, pFVar5);
   pFVar5 = _stdout;
   pcVar13 = (char*)dcgettext(0, "  \\\\      backslash\n  \\a      alert (BEL)\n  \\b      backspace\n  \\c      produce no further output\n  \\e      escape\n  \\f      form feed\n  \\n      new line\n  \\r      carriage return\n  \\t      horizontal tab\n  \\v      vertical tab\n", 5);
   fputs_unlocked(pcVar13, pFVar5);
   pFVar5 = _stdout;
   pcVar13 = (char*)dcgettext(0, "  \\NNN    byte with octal value NNN (1 to 3 digits)\n  \\xHH    byte with hexadecimal value HH (1 to 2 digits)\n  \\uHHHH  Unicode (ISO/IEC 10646) character with hex value HHHH (4 digits)\n  \\UHHHHHHHH  Unicode character with hex value HHHHHHHH (8 digits)\n", 5);
   fputs_unlocked(pcVar13, pFVar5);
   pFVar5 = _stdout;
   pcVar13 = (char*)dcgettext(0, "  %%      a single %\n  %b      ARGUMENT as a string with \'\\\' escapes interpreted,\n          except that octal escapes should have a leading 0 like \\0NNN\n  %q      ARGUMENT is printed in a format that can be reused as shell input,\n          escaping non-printable characters with the POSIX $\'\' syntax\n\nand all C format specifications ending with one of diouxXfeEgGcs, with\nARGUMENTs converted to proper type first.  Variable widths are handled.\n", 5);
   fputs_unlocked(pcVar13, pFVar5);
...
wVar9 = (wchar_t)uVar30;if (( ( L'\xffffffff' < (wchar_t)uVar30 ) || ( local_20c = local_20c + L'\x01' ),wVar9 = local_20c,L'\xffffffff' < local_20c )) {
   uVar27 = (ulong)(uint)wVar26;
}
pcVar14 = (char*)0x0;if (wVar26 < argc) {
   pcVar14 = argv[wVar26];
}
...
sVar12 = strlen(pcVar13);lVar21 = uVar28 + 2 + sVar12;__ptr = (void*)xmalloc(lVar21);lVar21 = __mempcpy_chk(__ptr, pcVar13, sVar12, lVar21);if ((uint)uVar28 != 0) {
   uVar16 = 0;
   do {
      uVar23 = (int)uVar16 + 1;
...
*(byte*)( lVar21 + uVar28 ) = bVar7;( (byte*)( lVar21 + uVar28 ) )[1] = 0;switch (bVar7) {
   case 0x41:
   case 0x45:
   case 0x46:
   case 0x47:
...
free(__ptr);format = (char*)pbVar29;LAB_00100861:wVar9 = (wchar_t)uVar27;bVar7 = ( (byte*)format )[1];format = (char*)pbVar25;joined_r0x00100867:if (bVar7 == 0) goto LAB_00100988;goto LAB_0010086d;LAB_00100988:free(pcVar13);local_1e0 = wVar9 + L'\x01';if (argc <= wVar9) {
   local_1e0 = argc;
}
goto LAB_001009a5;while (true) {
   pcVar13 = *(char**)( (long)ppuVar24 + 0x10 );
   ppuVar24 = (undefined**)( (long)ppuVar24 + 0x10 );
   if (pcVar13 == (char*)0x0) break;
   LAB_00101955:iVar11 = strcmp("printf", pcVar13);
   if (iVar11 == 0) break;
}
;pcVar13 = *(char**)( (long)ppuVar24 + 8 );if (pcVar13 == (char*)0x0) {
   uVar19 = dcgettext(0, "\n%s online help: <%s>\n", 5);
   pcVar13 = "printf";
   ...
   LAB_001019b5:iVar11 = strncmp(pcVar14, "en_", 3);
   pFVar5 = _stdout;
   if (iVar11 != 0) {
      pcVar14 = (char*)dcgettext(0, "Report any translation bugs to <https://translationproject.org/team/>\n", 5);
...
uVar19 = dcgettext(0, "Full documentation <%s%s>\n", 5);pcVar14 = "";__printf_chk(2, uVar19, "https://www.gnu.org/software/coreutils/", "printf");if (pcVar13 == "printf") {
   pcVar14 = " invocation";
}
LAB_00101a0b:uVar19 = dcgettext(0, "or available locally via: info \'(coreutils) %s%s\'\n", 5);__printf_chk(2, uVar19, pcVar13, pcVar14);LAB_0010173a:/* WARNING: Subroutine does not return */exit(__status);}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* WARNING: Unknown calling convention */void usage(wchar_t status) {
   FILE *pFVar1;
   int iVar2;
   undefined8 uVar3;
   char *pcVar4;
   ...
   pFVar1 = _stdout;
   pcVar4 = (char*)dcgettext(0, "Print ARGUMENT(s) according to FORMAT, or execute according to OPTION:\n\n", 5);
   ...
   fputs_unlocked(pcVar4, pFVar1);
   pFVar1 = _stdout;
   pcVar4 = (char*)dcgettext(0, "  \\\\      backslash\n  \\a      alert (BEL)\n  \\b      backspace\n  \\c      produce no further output\n  \\e      escape\n  \\f      form feed\n  \\n      new line\n  \\r      carriage return\n  \\t      horizontal tab\n  \\v      vertical tab\n", 5);
   fputs_unlocked(pcVar4, pFVar1);
   pFVar1 = _stdout;
   pcVar4 = (char*)dcgettext(0, "  \\NNN    byte with octal value NNN (1 to 3 digits)\n  \\xHH    byte with hexadecimal value HH (1 to 2 digits)\n  \\uHHHH  Unicode (ISO/IEC 10646) character with hex value HHHH (4 digits)\n  \\UHHHHHHHH  Unicode character with hex value HHHHHHHH (8 digits)\n", 5);
   fputs_unlocked(pcVar4, pFVar1);
   pFVar1 = _stdout;
   pcVar4 = (char*)dcgettext(0, "  %%      a single %\n  %b      ARGUMENT as a string with \'\\\' escapes interpreted,\n          except that octal escapes should have a leading 0 like \\0NNN\n  %q      ARGUMENT is printed in a format that can be reused as shell input,\n          escaping non-printable characters with the POSIX $\'\' syntax\n\nand all C format specifications ending with one of diouxXfeEgGcs, with\nARGUMENTs converted to proper type first.  Variable widths are handled.\n", 5);
   fputs_unlocked(pcVar4, pFVar1);
   uVar5 = dcgettext(0, "\nYour shell may have its own version of %s, which usually supersedes\nthe version described here.  Please refer to your shell\'s documentation\nfor details about the options it supports.\n", 5);
 ...
 while ( pcVar4 != (char*)0x0 );
   ...
   if (pcVar4 == (char*)0x0) {
      ...
      pcVar6 = setlocale(5, (char*)0x0);
      if (pcVar6 != (char*)0x0) {
         LAB_001019b5:iVar2 = strncmp(pcVar6, "en_", 3);
         pFVar1 = _stdout;
         if (iVar2 != 0) {
            pcVar6 = (char*)dcgettext(0, "Report any translation bugs to <https://translationproject.org/team/>\n", 5);
   ...
   LAB_0010173a:/* WARNING: Subroutine does not return */exit(status);
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* WARNING: Unknown calling convention */wchar_t main(wchar_t argc, char **argv) {
   int iVar1;
   wchar_t wVar2;
   char *pcVar3;
   undefined8 uVar4;
   ...
   if (argc == L'\x02') {
      ...
      if (argc < L'\x02') {
         LAB_00102772:uVar4 = dcgettext(0, "missing operand", 5);
         error(0, 0, uVar4);
         /* WARNING: Subroutine does not return */
         usage(L'\x01');
      }

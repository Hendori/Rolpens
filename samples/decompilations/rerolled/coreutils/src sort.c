/* WARNING: Unknown calling convention */size_t proctab_hasher(void *entry, size_t tabsize) {
   return ( ulong )(long) * (int*)( (long)entry + 8 ) % tabsize;
}
/* WARNING: Unknown calling convention */_Bool proctab_comparator(void *e1, void *e2) {
   return *(int*)( (long)e1 + 8 ) == *(int*)( (long)e2 + 8 );
}
/* WARNING: Unknown calling convention */char traverse_raw_number(char **number) {
   char *pcVar1;
   char *pcVar2;
   char *pcVar3;
   char cVar4;
 ...
 while ( iVar5 - 0x30U < 10 );
   ...
   pcVar3 = pcVar2 + -1;
   LAB_00100085:*number = pcVar3;
   return cVar4;
}
/* WARNING: Unknown calling convention */int getmonth(char *month, char **ea) {
   char cVar1;
   byte bVar2;
   byte *pbVar3;
   byte *pbVar4;
...
/* WARNING: Unknown calling convention */_Bool default_key_compare(keyfield *key) {
   ulong uVar1;
   if (( key->ignore == (_Bool*)0x0 ) && ( key->translate == (char*)0x0 )) {
      ...
      if (( key->skipeblanks == false ) && ( uVar1._0_1_ = key->skipsblanks ),uVar1._1_1_ = key->skipeblanks,uVar1._2_1_ = key->numeric,uVar1._3_1_ = key->random,uVar1._4_1_ = key->general_numeric,uVar1._5_1_ = key->human_numeric,uVar1._6_1_ = key->month,uVar1._7_1_ = key->reverse,( uVar1 & 0xffff00ff0000 ) == 0) {
         if (key->month != false) {
            return false;
         }
...
/* WARNING: Unknown calling convention */void key_to_opts(keyfield *key, char *opts) {
   short sVar1;
...
/* WARNING: Unknown calling convention */char *set_ordering(char *s, keyfield *key, blanktype blanktype) {
   char *pcVar1;
   char cVar2;
   cVar2 = *s;
   while (cVar2 != '\0') {
...
;
   switchD_001002da_caseD_4e:return s;
}
/* WARNING: Unknown calling convention */int struct_month_cmp(void *m1, void *m2) {
   int iVar1;
...
/* WARNING: Unknown calling convention */keyfield *key_init(keyfield *key) {
...
/* WARNING: Unknown calling convention */void insertkey(keyfield *key_arg) {
   keyfield *pkVar1;
   keyfield *pkVar2;
   keyfield **ppkVar3;
   keyfield *pkVar4;
...
/* WARNING: Unknown calling convention */void add_temp_dir(char *dir) {
...
/* WARNING: Unknown calling convention */void incompatible_options(char *opts) {
   undefined8 uVar1;
   uVar1 = dcgettext(0, "options \'-%s\' are incompatible", 5);
   /* WARNING: Subroutine does not return */
   error(2, 0, uVar1, opts);
}
/* WARNING: Unknown calling convention */void badfieldspec(char *spec, char *msgid) {
   undefined8 uVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   uVar1 = quote();
...
/* WARNING: Unknown calling convention */char *parse_field_count(char *string, size_t *val, char *msgid) {
   undefined4 uVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   undefined8 uVar4;
...
/* WARNING: Unknown calling convention */void sort_die(char *message, char *file) {
   undefined8 uVar1;
   int *piVar2;
   if (file == (char*)0x0) {
...
/* WARNING: Unknown calling convention */void xfclose(FILE *fp, char *file) {
   int iVar1;
   char *pcVar2;
   ...
   if (iVar1 == 1) {
      ...
      if (iVar1 != 0) {
         ...
         LAB_001006c8:pcVar2 = (char*)dcgettext(0, pcVar2, 5);
         /* WARNING: Subroutine does not return */
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* WARNING: Unknown calling convention */FILE *stream_open(char *file, char *how) {
   int iVar1;
   int iVar2;
   FILE *pFVar3;
   int *piVar4;
   ...
   if (outstat_errno_4 == 0) {
      ...
      LAB_001007b5:if (-1 < outstat_errno_4) goto LAB_001007cf;
   }
   ...
   LAB_001007cf:uVar5 = quotearg_n_style_colon(0, 3, file);
   uVar6 = dcgettext(0, "%s: error truncating", 5);
   /* WARNING: Subroutine does not return */
   error(2, iVar1, uVar6, uVar5);
}
/* WARNING: Unknown calling convention -- yet parameter storage is locked */void link_failure(void) {
   undefined8 uVar1;
   uVar1 = dlerror();
   /* WARNING: Subroutine does not return */
   error(2, 0, &_LC11, uVar1);
}
/* WARNING: Unknown calling convention */void initbuf(buffer *buf, size_t line_bytes, size_t alloc) {
   char *pcVar1;
   int *piVar2;
   undefined8 uVar3;
   size_t __n;
...
/* WARNING: Unknown calling convention */size_t xstrxfrm(char *dest, char *src, size_t destsize) {
   int *piVar1;
   size_t sVar2;
   undefined8 uVar3;
...
/* WARNING: Unknown calling convention */pid_t reap(pid_t pid) {
   long lVar1;
   __pid_t _Var2;
   long lVar3;
   int *piVar4;
   ...
   LAB_00100a12:if (lVar1 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return _Var2;
   }
...
/* WARNING: Unknown calling convention */void async_safe_die(int errnum, char *errstr) {
   size_t sVar1;
   char *__s;
   char errbuf[12];
   sVar1 = strlen(errstr);
...
/* WARNING: Unknown calling convention */void register_proc(tempnode *temp) {
   uint uVar1;
   long lVar2;
   merge_node *pmVar3;
   merge_node *pmVar4;
...
/* WARNING: Unknown calling convention */merge_node *init_node(merge_node *parent, merge_node *node_pool, line *dest, size_t nthreads, size_t total_lines, _Bool is_lo_child) {
...
/* WARNING: Unknown calling convention */int compare_nodes(void *a, void *b) {
   if (*(uint*)( (long)a + 0x50 ) != *(uint*)( (long)b + 0x50 )) {
      return (int)( *(uint*)( (long)a + 0x50 ) < *(uint*)( (long)b + 0x50 ) );
   }

   return (int)( ( ulong )(*(long*)( (long)a + 0x30 ) + *(long*)( (long)a + 0x28 )) < ( ulong )(*(long*)( (long)b + 0x30 ) + *(long*)( (long)b + 0x28 )) );
}
...
/* WARNING: Unknown calling convention */void move_fd(int oldfd, int newfd) {
   dup2(oldfd, newfd);
   close(oldfd);
   return;
}
char *limfield(line *line, keyfield *key) {
   ...
   if (lVar1 == 0) {
      if (tab == 0x80) {
         ...
         LAB_00100e98:while (line < plVar2) {
...
;
         ...
         while (line < plVar2) {
            LAB_00100e39:while (*(char*)&line->text != tab) {
               line = (line*)( (long)&line->text + 1 );
               if (plVar2 == line) {
                  LAB_00100e70:if (lVar1 == 0) {
                     return (char*)plVar2;
                  }
...
;
      ...
      LAB_00100f3b:if (*(char*)( in_RDX + 0x31 ) == '\0') goto LAB_00100df7;
   }
 ...
 while ( plVar2 != line );
   LAB_00100df7:plVar5 = (line*)( (long)&line->text + lVar1 );
   if (plVar5 < plVar2) {
      plVar2 = plVar5;
   }
...
;
 ...
 while ( line < plVar4 );
   ...
   goto LAB_00100fd2;
   LAB_00100fa8:if ((char)in_RDX[6] == '\0') goto LAB_00100fd2;
   goto LAB_00100fc9;
   LAB_00101040:if (( (char)in_RDX[6] == '\0' ) || ( plVar4 <= line )) goto LAB_00100fd2;
   LAB_00100fc9:do {
      if (blanks[*(byte*)&line->text] == false) break;
      line = (line*)( (long)&line->text + 1 );
   }
 while ( plVar4 != line );
   LAB_00100fd2:plVar1 = (line*)( (long)&line->text + in_RDX[1] );
   if (plVar1 < plVar4) {
      plVar4 = plVar1;
   }
...
/* WARNING: Unknown calling convention */_Bool fillbuf(buffer *buf, FILE *fp, char *file) {
   size_t sVar1;
   size_t sVar2;
   char cVar3;
   keyfield *pkVar4;
   ...
   if (buf->eof == false) {
      ...
      do {
         ...
         do {
            ...
            plVar14 = plVar15;
            plVar5 = line;
            while (line = plVar5,plVar15 = plVar14,pcVar8 = (char*)memchr(__ptr, (int)cVar3, (long)local_80 - (long)__ptr),pcVar8 != (char*)0x0) {
               __ptr = (line*)( pcVar8 + 1 );
               plVar14 = plVar15 + -4;
               *pcVar8 = '\0';
               *plVar14 = (long)line;
...
;
 ...
 while ( true );
   ...
   LAB_0010122d:_Var6 = false;
   LAB_0010122f:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return _Var6;
   }

   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   LAB_0010139b:merge_buffer_size = (long)&pkVar10->ignore + 2;
   _Var6 = true;
   buf->left = (long)__ptr - (long)line;
   goto LAB_0010122f;
}
/* WARNING: Unknown calling convention */void sighandler(int sig) {
   tempnode **pptVar1;
   tempnode *ptVar2;
   ptVar2 = temphead;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* WARNING: Unknown calling convention */void write_line(line *line, FILE *fp, char *output_file) {
   byte *pbVar1;
   char cVar2;
   size_t __n;
   ulong uVar3;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   pbVar1 = __ptr + __n;
   if (( output_file != (char*)0x0 ) || ( pkVar19 = !debug )) {
      pbVar1[-1] = eolchar;
      ...
      pbVar1[-1] = 0;
      LAB_001014a0:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   ...
   joined_r0x001014d7:do {
      ...
      if (pbVar1 <= __ptr) {
         ...
         LAB_00101510:month = (line*)begfield(plVar16, key);
         ...
         do {
            ...
            do {
               if (( pkVar19->skipsblanks == false ) || ( sVar20 != 0xffffffffffffffff )) {
                  LAB_00101557:if (( pkVar19->month != false ) || ( uVar3._0_1_ = pkVar19->skipsblanks ),uVar3._1_1_ = pkVar19->skipeblanks,uVar3._2_1_ = pkVar19->numeric,uVar3._3_1_ = pkVar19->random,uVar3._4_1_ = pkVar19->general_numeric,uVar3._5_1_ = pkVar19->human_numeric,uVar3._6_1_ = pkVar19->month,uVar3._7_1_ = pkVar19->reverse,( uVar3 & 0xffff00ff0000 ) != 0) goto LAB_00101574;
               }
 else {
                  LAB_00101574:cVar2 = *(char*)&plVar11->text;
                  *(char*)&plVar11->text = '\0';
                     ...
                     if (pkVar19->month == false) {
                        if (pkVar19->general_numeric == false) {
                           ...
                           if (( uVar4 & 0xff0000ff0000 ) != 0) {
                              ...
                              if (( '/' < cVar6 ) && ( tighter_lim = pkVar19->human_numeric != false )) {
...
;
 ...
 while ( lVar18 != 0 );
                  ...
                  LAB_00101717:pkVar19 = (keyfield*)0x0;
 ...
 while ( true );
      ...
      if (bVar7 == 9) {
         ...
         if (pbVar15 < fp->_IO_write_end) {
            LAB_0010167a:fp->_IO_write_ptr = (char*)( pbVar15 + 1 );
            *pbVar15 = bVar7;
            pkVar19 = keylist;
...
/* WARNING: Unknown calling convention */pid_t pipe_fork(int *pipefds, size_t tries) {
   long lVar1;
   tempnode *ptVar2;
   int iVar3;
   __pid_t _Var4;
 ...
 while ( pVar5 != 0 );
      ...
      do {
         ...
         if (cs.valid == false) {
            LAB_001019c0:_Var4 = 0;
            close(0);
            close(1);
            goto LAB_001019d4;
         }

         LAB_00101a88:pthread_sigmask(2, (__sigset_t*)&cs.sigs, (__sigset_t*)0x0);
         *piVar6 = iVar3;
         if (-1 < _Var4) {
            LAB_00101ab0:if (_Var4 == 0) goto LAB_001019c0;
            nprocs = nprocs + 1;
            goto LAB_001019d4;
         }

         LAB_00101a1a:if (iVar3 != 0xb) {
 ...
 while ( bVar8 );
   ...
   LAB_001019d4:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Unknown calling convention */size_t open_input_files(sortfile *files, size_t nfiles, FILE ***pfps) {
   long lVar1;
   tempnode *temp;
   int iVar2;
   pid_t pVar3;
...
/* WARNING: Unknown calling convention */tempnode *maybe_create_temp(FILE **pfp, _Bool survive_fd_exhaustion) {
   ulong uVar1;
   undefined1 *file;
   int iVar2;
   int iVar3;
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked */void exit_cleanup(void) {
   long lVar1;
   tempnode *ptVar2;
   int iVar3;
   long in_FS_OFFSET;
...
/* WARNING: Unknown calling convention */void zaptemp(char *name) {
   char *pcVar1;
   pid_t pid;
   long lVar2;
   tempnode *ptVar3;
...
/* WARNING: Unknown calling convention */int keycompare(line *a, line *b) {
   MD5_CTX *pMVar1;
   byte bVar2;
   byte bVar3;
   byte bVar4;
   ...
   pkVar21 = keylist;
   LAB_00102340:pcVar16 = pkVar21->translate;
   ...
   if (( ( hard_LC_COLLATE == false ) && ( uVar19._0_1_ = pkVar21->skipsblanks ),uVar19._1_1_ = pkVar21->skipeblanks,uVar19._2_1_ = pkVar21->numeric,uVar19._3_1_ = pkVar21->random,uVar19._4_1_ = pkVar21->general_numeric,uVar19._5_1_ = pkVar21->human_numeric,uVar19._6_1_ = pkVar21->month,uVar19._7_1_ = pkVar21->reverse,( uVar19 & 0xffffffffff0000 ) == 0 )) {
      if (p_Var6 != (_Bool*)0x0) {
         if (pcVar16 == (char*)0x0) {
            do {
      ...
      if (uVar22 != 0) {
         ...
         if (pcVar16 == (char*)0x0) {
            ...
            do {
               ...
               if ((uint)(byte)pcVar16[pbVar13[sVar17]] - (uint)(byte)pcVar16[__s2[sVar17]] != 0) goto LAB_00102645;
               sVar17 = sVar17 + 1;
            }
 while ( uVar22 != sVar17 );
         }
...
;
 ...
 while ( pbVar11 != pbVar13 );
         LAB_00102798:pbVar11 = __nptr + local_2120;
      }
...
;
 ...
 while ( pbVar12 != __s2 );
         LAB_00102808:pbVar12 = __nptr_00 + local_2118;
      }
...
;
      LAB_00102430:local_2138._0_8_ = pbVar12;
      uVar10 = strnumcmp(__nptr, __nptr_00, (int)decimal_point, thousands_sep);
      LAB_00102470:local_2138._0_4_ = uVar10;
      *pbVar11 = bVar2;
      *pbVar12 = bVar3;
      free(local_2150);
      uVar19 = (ulong)uVar10;
   ...
   if (pkVar21->general_numeric != false) {
      ...
      if (__nptr == (byte*)ea) {
         ...
         LAB_001028b6:uVar10 = 1;
         local_2138._0_10_ = lVar23;
      }
 else if (lVar23 < lVar24) {
         LAB_001032b1:uVar10 = 0xffffffff;
         local_2138._0_10_ = lVar23;
      }
 else {
         uVar10 = 1;
         local_2138._0_10_ = lVar23;
         if (( lVar23 <= lVar24 ) && ( uVar10 = lVar23 != lVar24 )) {
            if (!NAN(lVar24)) goto LAB_001032b1;
            if (!NAN(lVar23)) goto LAB_001028b6;
            __snprintf_chk(buf, 0x87, 2, 0x10e, &_LC34, pbVar12, SUB108(lVar23, 0), (short)( (unkuint10)lVar23 >> 0x40 ));
            in_ST7 = in_ST6;
   ...
   if (pkVar21->human_numeric == false) {
      if (pkVar21->month == false) {
         if (pkVar21->random == false) {
            ...
            for (int i = 0; i < 3; i++) {
               buf[1][( 4*i + 29 )] = (undefined1)random_md5_state.CTX.data[( i + 12 )];
               buf[1][( 4*i + 30 )] = random_md5_state.CTX.data[0xc]._1_1_;
               buf[1][( 4*i + 31 )] = random_md5_state.CTX.data[0xc]._2_1_;
               buf[1][( 4*i + 32 )] = random_md5_state.CTX.data[0xc]._3_1_;
            }
            ...
            if (hard_LC_COLLATE == false) {
               ...
               joined_r0x0010303e:uVar10 = uVar9;
               if (uVar10 == 0) {
                  uVar19 = local_2118;
                  if (local_2120 <= local_2118) {
                     uVar19 = local_2120;
               ...
               if (__nptr < pbVar11) {
                  ...
                  if (__nptr_00 < pbVar12) {
                     ...
                     if (uVar22 < local_2120) {
                        local_2118 = 0;
                        uVar15 = local_2120;
                        LAB_00102e8c:if (uVar15 < 0x5555555555555555) goto LAB_00102b7f;
                        free(local_2110);
                     ...
                     local_2118 = 0;
                     LAB_00102edb:local_2108 = (byte*)( local_2138._0_8_ + local_2120 );
                  }

                  LAB_00102d65:sVar17 = strlen((char*)__nptr);
                  __nptr = __nptr + sVar17 + 1;
                  if (__nptr_00 < pbVar12) goto LAB_00102d77;
                  LAB_00102d84:if (( pbVar11 <= __nptr ) && ( pbVar12 <= __nptr_00 )) goto LAB_00102bdc;
               ...
               if (__nptr_00 < pbVar12) {
                  ...
                  if (uVar22 < uVar15) {
                     local_2120 = 0;
                     LAB_00102b70:if (uVar15 < 0x5555555555555555) {
                        LAB_00102b7f:uVar15 = uVar15 * 3 >> 1;
                     }
                     ...
                     if (__nptr < pbVar11) {
                        LAB_00102eb6:strxfrm((char*)local_2138._0_8_, (char*)__nptr, local_2120);
                  ...
                  LAB_00102d77:sVar17 = strlen((char*)__nptr_00);
               ...
               local_2120 = 0;
               local_2108 = (byte*)local_2138._0_8_;
               LAB_00102bdc:( *ptr_MD5_Update )((MD5_CTX*)buf, (void*)local_2138._0_8_, local_2120);
               ( *ptr_MD5_Final )((uchar*)dig, (MD5_CTX*)buf);
               ( *ptr_MD5_Update )(pMVar1, local_2108, local_2118);
...
;
   ...
   *pbVar12 = bVar3;
   ...
   uVar19 = (ulong)uVar10;
   goto LAB_00102645;
   LAB_00103230:uVar19 = ( ulong )(( uint )(pbVar13 < pbVar11) - ( uint )(__s2 < pbVar12));
   goto LAB_00102495;
   LAB_001030d0:uVar19 = ( ulong )(( uint )(pbVar13 < pbVar11) - ( uint )(__s2 < pbVar12));
   LAB_00102495:if ((int)uVar19 != 0) {
      LAB_00102645:iVar18 = (int)uVar19;
      if (pkVar21->reverse != false) {
         iVar18 = (int)( uVar19 >> 0x1f ) - ( uint )(0 < iVar18);
      }

      LAB_00102650:if (lVar5 != *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Subroutine does not return */
         __stack_chk_fail();
      }
...
/* WARNING: Unknown calling convention */int compare(line *a, line *b) {
   ulong uVar1;
   int iVar2;
   uint uVar3;
   ulong uVar4;
...
/* WARNING: Unknown calling convention */void sequential_sort(line *lines, size_t nlines, line *temp, _Bool to_temp) {
   size_t sVar1;
   char *pcVar2;
   char *pcVar3;
   char *pcVar4;
...
/* WARNING: Unknown calling convention */void write_unique(line *line, FILE *tfp, char *temp_output) {
   int iVar1;
   if (unique) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* WARNING: Unknown calling convention */void mergefps(sortfile *files, size_t ntemps, size_t nfiles, FILE *ofp, char *output_file, FILE **fps) {
   size_t sVar1;
   buffer *buf;
   sortfile *__dest;
   undefined8 *puVar2;
...
;
      ...
      lVar5 = local_e8 * 8;
      if (( __dest < files + local_e8 ) && ( lVar30 = lVar26 ),psVar25 < (sortfile*)( fps + ( local_e8 - 1 ) )) {
         do {
   ...
   if (uVar31 != 1) {
      ...
      do {
         while (true) {
            ...
            iVar21 = compare(*(line**)( (long)__ptr_00 + uVar27 * 8 ), *(line**)( (long)__ptr_00 + uVar32 * 8 ));
            if (iVar21 < 1) break;
...
;
 ...
 while ( local_98 < uVar32 );
      ...
      LAB_00103cb3:*plVar3 = (long)( plVar6 + -1 );
      LAB_00103b5f:if (uVar31 != 1) {
         plVar6 = (line*)*plVar3;
         uVar32 = 1;
         uVar27 = uVar31;
         uVar33 = 1;
...
;
   ...
   LAB_00103ace:if (*(line**)( (long)__ptr_01 + lVar26 ) < plVar6) goto LAB_00103cb3;
   LAB_00103ae0:psVar25 = files + uVar29;
   ...
   if (uVar31 == 1) {
      ...
      if (local_78 <= uVar29) {
         free(local_e0->buf);
         LAB_00103904:if (( local_a8 != (line*)0x0 ) && ( unique != false )) {
            write_line(&saved, ofp, output_file);
            free(saved.text);
         }

         LAB_00103939:xfclose(ofp, output_file);
         free(fps);
         free(__ptr);
         free(__ptr_02);
         free(__ptr_01);
         ...
         LAB_00104025:/* WARNING: Subroutine does not return */__stack_chk_fail();
      }

      uVar32 = 0;
      LAB_00103ef0:local_78 = local_78 - 1;
      zaptemp(psVar25->name);
   }
 else {
      do {
 ...
 while ( __ptr_02 + uVar31 != puVar24 );
   ...
   free(local_e0->buf);
   if (uVar29 < uVar32) {
      if (( (sortfile*)( (long)fps + lVar26 ) < files + ( uVar31 - 1 ) ) && ( files + uVar29 < (sortfile*)( fps + uVar31 ) )) {
 ...
 while ( uVar31 * 8 + -8 != lVar26 );
         ...
         memmove((void*)( lVar30 + (long)__ptr ), (void*)( (long)__ptr + lVar30 + 0x38 ), ( uVar31 - uVar29 ) * 0x38 - 0x38);
...
/* WARNING: Unknown calling convention */size_t mergefiles(sortfile *files, size_t ntemps, size_t nfiles, FILE *ofp, char *output_file) {
   char *file;
   size_t nfiles_00;
   char *message;
   long in_FS_OFFSET;
...
/* WARNING: Unknown calling convention */void merge(sortfile *files, size_t ntemps, size_t nfiles, char *output_file) {
   long lVar1;
   byte *__s2;
   FILE **fps_00;
   uint uVar2;
   ...
   if (ntemps < local_128) {
      ...
      do {
         while (true) {
            ...
            if (( ( output_file == (char*)0x0 ) || ( iVar3 = strcmp(output_file, (char*)__s2) ),iVar3 != 0 )) break;
            LAB_0010428b:if (ptVar4 == (tempnode*)0x0) {
               ptVar4 = maybe_create_temp(&tfp, false);
...
;
         if (outstat_errno_4 == 0) {
            ...
            LAB_001042e1:if (-1 < outstat_errno_4) break;
         }
         ...
         if (iVar3 == 0) {
            LAB_0010426e:if (instat.st_dev == outstat_3._0_8_ && instat.st_ino == outstat_3._8_8_) goto LAB_0010428b;
            goto LAB_001042a0;
         }
...
/* WARNING: Unknown calling convention */void sortlines(line *lines, size_t nthreads, size_t total_lines, merge_node *node, merge_node_queue *queue, FILE *tfp, char *temp_output) {
   ...
   if (( 0x1ffff < nlines_00 + nlines ) && ( 1 < nthreads )) {
      ...
      if (iVar6 == 0) {
         sortlines(lines + -node->nlo, nthreads - uVar16, total_lines, node->hi_child, queue, tfp, temp_output);
   ...
   LAB_00104770:pthread_mutex_lock((pthread_mutex_t*)__mutex);
...
;
         ...
         if (puVar3 == puVar17) {
            ...
            LAB_0010484d:do {
               if ((undefined8*)plVar7[3] == puVar8) {
                  ...
                  LAB_00104ac0:lVar10 = (long)puVar15 - (long)puVar8 >> 5;
                  local_b8 = plVar7[6];
                  local_c8 = plVar7[5];
                  if (local_b8 != lVar10) goto LAB_001048f5;
                  puVar19 = puVar14;
                  if (( puVar17 == puVar13 ) || ( lVar11 = lVar9 == 0 )) goto LAB_00104b28;
                  goto LAB_00104b02;
               }
 ...
 while ( puVar17 != puVar13 );
            ...
            puVar12 = puVar13;
            if (local_b8 != lVar10) {
               LAB_001048f5:local_b0 = (long)puVar3 - (long)puVar12 >> 5;
               puVar19 = puVar14;
               if (local_c8 == local_b0) {
                  LAB_00104905:puVar17 = (undefined8*)plVar7[3];
                  if (( puVar17 != puVar8 ) && ( lVar11 = lVar9 != 0 )) {
                     do {
                        puVar12 = puVar8 + -4;
                        uVar4 = puVar8[-3];
                        puVar14 = puVar19 + -4;
 ...
 while ( lVar11 != -1 );
      ...
      if (puVar3 != puVar17) {
         LAB_001049ca:do {
            lVar9 = lVar10;
            if ((undefined8*)plVar7[3] == puVar8) {
               LAB_00104d05:if ((long)puVar15 - (long)puVar8 >> 5 != plVar7[6]) goto LAB_00104a43;
 ...
 while ( puVar13 != (undefined8*)plVar7[2] );
         if ((long)puVar15 - (long)puVar8 >> 5 != plVar7[6]) {
            LAB_00104a43:local_c8 = plVar7[5];
            lVar10 = (long)puVar3 - (long)puVar13 >> 5;
            goto LAB_00104a51;
         }

         LAB_0010500f:cVar1 = *(char*)( (long)plVar7 + 0x54 );
         local_c8 = plVar7[5] - ( (long)puVar3 - (long)puVar13 >> 5 );
         local_b8 = 0;
         goto LAB_00104b42;
      }
      ...
      lVar10 = 0;
      if (plVar7[6] != 0) {
         LAB_00104a51:if (lVar10 == local_c8) {
 ...
 while ( lVar9 != 0 );
   ...
   *(undefined1*)( (long)plVar7 + 0x54 ) = 1;
   pthread_cond_signal((pthread_cond_t*)__cond);
   pthread_mutex_unlock((pthread_mutex_t*)__mutex);
   LAB_00104e1f:if (lVar2 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   ...
   while (lVar11 = lVar11 + -1,puVar14 = puVar19,lVar11 != -1) {
      LAB_00104b02:puVar15 = puVar13 + -4;
      uVar4 = puVar13[-3];
      puVar19 = puVar14 + -4;
      *puVar19 = *puVar15;
      puVar14[-3] = uVar4;
...
;
   *plVar7 = (long)puVar15;
   LAB_00104b28:*puVar18 = puVar19;
   local_c8 = local_c8 - ( (long)puVar3 - (long)puVar13 >> 5 );
   local_b8 = local_b8 - lVar10;
   LAB_00104b42:plVar7[5] = local_c8;
   plVar7[6] = local_b8;
   if (cVar1 == '\0') {
      bVar21 = (undefined8*)plVar7[3] != puVar8;
      if ((undefined8*)plVar7[2] == puVar13) {
         LAB_00104cd8:if (( local_c8 == 0 ) && ( bVar21 )) {
            LAB_00104b6d:pthread_mutex_lock((pthread_mutex_t*)__mutex);
            heap_insert(queue->priority_queue, plVar7);
            *(undefined1*)( (long)plVar7 + 0x54 ) = 1;
            pthread_cond_signal((pthread_cond_t*)__cond);
            pthread_mutex_unlock((pthread_mutex_t*)__mutex);
   ...
   if (*(char*)( (long)plVar20 + 0x54 ) == '\0') {
      if (*plVar20 == plVar20[2]) {
         ...
         if (plVar20[1] == plVar20[3]) {
            lVar9 = plVar20[6];
            joined_r0x00104f08:if (lVar9 != 0) goto LAB_00104c23;
         }
   ...
   LAB_00104c23:pthread_mutex_unlock((pthread_mutex_t*)( plVar20 + 0xb ));
   LAB_00104ba8:pthread_mutex_unlock(__mutex_00);
   goto LAB_00104770;
   while (lVar9 != 0) {
      LAB_00104d5e:lVar9 = lVar9 + -1;
...
;
   cVar1 = *(char*)( (long)plVar7 + 0x54 );
   puVar8 = (undefined8*)plVar7[1];
   LAB_00104d97:local_c8 = plVar7[5];
   LAB_00104da2:local_c8 = local_c8 - ( (long)puVar3 - (long)puVar13 >> 5 );
   local_b8 = plVar7[6] - ( (long)puVar15 - (long)puVar8 >> 5 );
   goto LAB_00104b42;
}
/* WARNING: Unknown calling convention */void *sortlines_thread(void *data) {
   /* WARNING: Load size is inaccurate */
   sortlines(*data, *(size_t*)( (long)data + 8 ), *(size_t*)( (long)data + 0x10 ), *(merge_node**)( (long)data + 0x18 ), *(merge_node_queue**)( (long)data + 0x20 ), *(FILE**)( (long)data + 0x28 ), *(char**)( (long)data + 0x30 ));
   return (void*)0x0;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* WARNING: Unknown calling convention */void usage(int status) {
   ...
   fputs_unlocked(pcVar4, pFVar1);
   pFVar1 = _stdout;
   pcVar4 = (char*)dcgettext(0, "  -b, --ignore-leading-blanks  ignore leading blanks\n  -d, --dictionary-order      consider only blanks and alphanumeric characters\n  -f, --ignore-case           fold lower case to upper case characters\n", 5);
   fputs_unlocked(pcVar4, pFVar1);
   pFVar1 = _stdout;
   pcVar4 = (char*)dcgettext(0, "  -g, --general-numeric-sort  compare according to general numerical value\n  -i, --ignore-nonprinting    consider only printable characters\n  -M, --month-sort            compare (unknown) < \'JAN\' < ... < \'DEC\'\n", 5);
   fputs_unlocked(pcVar4, pFVar1);
   pFVar1 = _stdout;
   pcVar4 = (char*)dcgettext(0, "  -h, --human-numeric-sort    compare human readable numbers (e.g., 2K 1G)\n", 5);
   fputs_unlocked(pcVar4, pFVar1);
   pFVar1 = _stdout;
   pcVar4 = (char*)dcgettext(0, "  -n, --numeric-sort          compare according to string numerical value;\n                                see full documentation for supported strings\n", 5);
   fputs_unlocked(pcVar4, pFVar1);
   pFVar1 = _stdout;
   pcVar4 = (char*)dcgettext(0, "  -R, --random-sort           shuffle, but group identical keys.  See shuf(1)\n      --random-source=FILE    get random bytes from FILE\n  -r, --reverse               reverse the result of comparisons\n", 5);
   fputs_unlocked(pcVar4, pFVar1);
   pFVar1 = _stdout;
   pcVar4 = (char*)dcgettext(0, "      --sort=WORD             sort according to WORD:\n                                general-numeric -g, human-numeric -h, month -M,\n                                numeric -n, random -R, version -V\n  -V, --version-sort          natural sort of (version) numbers within text\n\n", 5);
   fputs_unlocked(pcVar4, pFVar1);
   pFVar1 = _stdout;
   pcVar4 = (char*)dcgettext(0, "Other options:\n\n", 5);
   fputs_unlocked(pcVar4, pFVar1);
   pFVar1 = _stdout;
   pcVar4 = (char*)dcgettext(0, "      --batch-size=NMERGE   merge at most NMERGE inputs at once;\n                            for more use temp files\n", 5);
   fputs_unlocked(pcVar4, pFVar1);
   pFVar1 = _stdout;
   pcVar4 = (char*)dcgettext(0, "  -c, --check, --check=diagnose-first  check for sorted input; do not sort\n  -C, --check=quiet, --check=silent  like -c, but do not report first bad line\n      --compress-program=PROG  compress temporaries with PROG;\n                              decompress them with PROG -d\n", 5);
   fputs_unlocked(pcVar4, pFVar1);
   pFVar1 = _stdout;
   pcVar4 = (char*)dcgettext(0, "      --debug               annotate the part of the line used to sort,\n                              and warn about questionable usage to stderr\n      --files0-from=F       read input from the files specified by\n                            NUL-terminated names in file F;\n                            If F is - then read names from standard input\n", 5);
   fputs_unlocked(pcVar4, pFVar1);
   pFVar1 = _stdout;
   pcVar4 = (char*)dcgettext(0, "  -k, --key=KEYDEF          sort via a key; KEYDEF gives location and type\n  -m, --merge               merge already sorted files; do not sort\n", 5);
   fputs_unlocked(pcVar4, pFVar1);
   pFVar1 = _stdout;
   pcVar4 = (char*)dcgettext(0, "  -o, --output=FILE         write result to FILE instead of standard output\n  -s, --stable              stabilize sort by disabling last-resort comparison\n  -S, --buffer-size=SIZE    use SIZE for main memory buffer\n", 5);
   fputs_unlocked(pcVar4, pFVar1);
   uVar5 = dcgettext(0, "  -t, --field-separator=SEP  use SEP instead of non-blank to blank transition\n  -T, --temporary-directory=DIR  use DIR for temporaries, not $TMPDIR or %s;\n                              multiple options specify multiple directories\n      --parallel=N          change the number of sorts run concurrently to N\n  -u, --unique              output only the first of lines with equal keys;\n                              with -c, check for strict ordering\n", 5);
   ...
   fputs_unlocked(pcVar4, pFVar1);
   pFVar1 = _stdout;
   pcVar4 = (char*)dcgettext(0, "% 1% of memory, b 1, K 1024 (default), and so on for M, G, T, P, E, Z, Y, R, Q.\n\n*** WARNING ***\nThe locale specified by the environment affects sort order.\nSet LC_ALL=C to get the traditional sort order that uses\nnative byte values.\n", 5);
   fputs_unlocked(pcVar4, pFVar1);
   pcVar4 = "[";
   infomap[0].program = "[";
 ...
 while ( pcVar4 != (char*)0x0 );
   ...
   if (puVar7 == (undefined*)0x0) {
      ...
      pcVar4 = setlocale(5, (char*)0x0);
      if (pcVar4 != (char*)0x0) {
         LAB_0010555d:iVar2 = strncmp(pcVar4, "en_", 3);
         pFVar1 = _stdout;
         if (iVar2 != 0) {
   ...
   LAB_001050da:/* WARNING: Subroutine does not return */exit(status);
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* WARNING: Unknown calling convention *//* WARNING: Enum "__rlimit_resource": Some values do not have unique names */int main(int argc, char **argv) {
   _Bool *p_Var1;
   undefined1 *puVar2;
   byte *pbVar3;
   pthread_cond_t *__cond;
   ...
   thousands_sep = 0x80;
   LAB_00107fd6:have_read_stdin = false;
...
;
 ...
 while ( piVar41 != (int*)&DAT_0010604c );
   ...
   for (int i = 0; i < 6; i++) {
      act.sa_mask.__val[i] = caught_signals.__val[i];
   }

   act.sa_flags = 0;
   for (int i = 0; i < 10; i++) {
      act.sa_mask.__val[( i + 6 )] = caught_signals.__val[( i + 6 )];
   }
...
;
 ...
 while ( piVar41 != (int*)&DAT_0010604c );
   LAB_001082aa:signal(0x11, (__sighandler_t)0x0);
   pcVar47 = (char*)0x0;
   atexit(exit_cleanup);
   key_init(&gkey);
   ...
   if ((int)uVar31 != -1) {
      ...
      if (( bVar53 ) && ( (char)pcVar20 == '\0' )) {
         if ((int)pTVar44 == _optind) {
            ...
            LAB_0010a11c:uVar33 = quotearg_style(4, *__ptr);
   ...
   LAB_00108390:pTVar39 = (Tokens*)p_Var46;
   if (_optind < (int)pTVar44) goto code_r0x00108399;
   LAB_0010a6f3:argv = (char**)( (ulong)pcVar20 & 0xffffffff );
 ...
 while ( pcVar20 != pcVar47 );
         ...
         iVar13 = (int)pFVar32;
         LAB_0010a85b:xstrtol_fatal(iVar13, (ulong)local_3d0 & 0xffffffff, 0xffffff87, long_options, pTVar39);
         goto LAB_0010a879;
      }
...
;
 ...
 while ( pkVar22 != (keyfield*)0x0 );
      LAB_001085fa:bVar53 = false;
      do if (pcVar47 != (char*)0x1) switch (uVar21 & 0xffffffff) {
         case 1:
...
switchD_001084a0_caseD_4d:
 ...
 while ( _Var11= fillbuf(local_3f8,(FILE *)__stream,local_430),cVar10 = local_2a8,lVar38 = local_2c0,uVar21 = local_2c8,uVar8 = n,_Var11 );
      {
         if (local_2a8 == false) {
            LAB_001096c7:saved_line.text = (char*)0x0;
      ...
      LAB_00109b33:__ptr = __ptr + 1;
      goto LAB_001095bb;
      LAB_0010a2a5:free((void*)n);
      ptVar26 = temphead;
...
;
      ...
      free(files);
      joined_r0x00109843:while (0 < nprocs) {
         reap(-1);
      }
;
      goto LAB_0010985c;
      LAB_001099fd:_Var11 = fillbuf((buffer*)&n, pFVar32, local_430);
      uVar21 = local_2c8;
      if (!_Var11) {
         bVar40 = 1;
         LAB_00109b4f:xfclose(pFVar32, local_430);
         free((void*)n);
         free(_oi);
         /* WARNING: Subroutine does not return */
         exit(( uint )(bVar40 ^ 1));
      ...
      lVar6 = -local_2c8;
      if (( uVar31 != 0 ) && ( iVar12 = compare((line*)&oi, plVar43 + -1) ),a = plVar43,(int)( uVar50 ^ 1 ) <= iVar12) {
         LAB_00109b44:if (cVar10 == 'c') {
...
;
 ...
 while ( uVar21 < uVar36 );
      ...
      goto LAB_001099fd;
      LAB_0010a6e7:incompatible_options("cC");
      pTVar39 = (Tokens*)p_Var46;
      goto LAB_0010a6f3;
      switchD_001084a0_caseD_1:if ((char)_optarg->n_tok == '+') {
         ...
         if (bVar53) {
            ...
            if (pcVar45 == (char*)0x0) {
               ...
               if (*pcVar45 == '.') {
                  ...
                  if (pkVar22->sword == 0) goto LAB_0010921b;
                  LAB_00109229:uVar31 = uVar21 & 0xffffffff;
                  if (pcVar45 == (char*)0x0) goto LAB_00108ee0;
               }
 else if (pkVar22->sword == 0) {
                  LAB_0010921b:if (pkVar22->schar == 0) {
                     pkVar22->sword = 0xffffffffffffffff;
                  }
               ...
               if (*pcVar45 == '\0') {
                  ...
                  if (bVar7) {
                     ...
                     s = (Tokens*)parse_field_count((char*)( (long)&pTVar39->n_tok + 1 ), &pkVar22->eword, "invalid number after \'-\'");
                     pkVar37 = pkVar22;
                     ...
                     while (true) {
                        ...
                        pTVar44 = pTVar39;
                        LAB_0010a57a:s = (Tokens*)parse_field_count((char*)( (long)&s->n_tok + 1 ), &pkVar37->echar, "invalid number after \'.\'");
                     }
;
                  }
      ...
      LAB_00108ee0:__ptr[(long)pcVar47] = (char*)_optarg;
      pcVar47 = pcVar47 + 1;
      iVar12 = tab;
      goto LAB_001083b1;
      while (true) {
         ...
         LAB_00108f72:pcVar15 = local_3d0;
         pcVar14 = *ppcVar42;
         if (( ( *pcVar14 != '-' ) || ( pcVar14[1] != '\0' ) ) && ( iVar12 = iVar12 != 0 )) {
            pcVar14 = *ppcVar42;
            pcVar15 = "cannot read";
            goto LAB_00108f97;
         }
...
;
      if (local_3e0 != (Tokens*)0x0) {
         ...
         if (iVar12 < 0) {
            LAB_0010ab49:pcVar14 = (char*)dcgettext(0, "open failed", 5);
            /* WARNING: Subroutine does not return */
      ...
      if (!bVar52) {
         ...
         local_438 = 0;
         local_3a8 = "r";
         LAB_001095bb:local_430 = *__ptr;
         pcVar14 = local_3a8;
         __stream = (FILE*)stream_open(local_430, "r");
         if (__stream == (FILE*)0x0) {
            LAB_0010a4df:xfopen(local_430, pcVar14);
            LAB_0010a4e9:badfieldspec((char*)_optarg, "stray character in field spec");
            uVar50 = extraout_EAX_00;
            LAB_0010a4fc:if (uVar50 == 0xffffff7e) {
               /* WARNING: Subroutine does not return */
               usage(0);
            }

            switchD_001084a0_caseD_2:/* WARNING: Subroutine does not return */usage(2);
         }
            ...
            if (iVar12 == 0) {
               ...
               do {
                  if (( ( (uint)act.sa_mask.__val[2] & 0xd000 ) == 0x8000 ) && ( 0 < (long)act.sa_mask.__val[5] )) {
                     ...
                     uVar21 = 0x20000;
                     sVar49 = size_bound_0;
                     joined_r0x00109cae:size_bound_0 = sVar49;
                     if (size_bound_0 == 0) {
                        ...
                        if (( iVar12 == 0 ) && ( uVar28 = uVar28 < uVar36 )) {
                           uVar36 = uVar28;
                        }
                  ...
                  sVar49 = size_bound_0;
                  if (( uVar21 != uVar36 / ( local_3b8 + 1 ) ) || ( size_bound_0 - sVar48 <= uVar36 )) goto LAB_00109f17;
                  pcVar14 = pcVar14 + 1;
 ...
 while ( true );
            ...
            pcVar14 = *__ptr;
            pcVar15 = "stat failed";
            LAB_00108f97:pcVar15 = (char*)dcgettext(0, pcVar15, 5);
            /* WARNING: Subroutine does not return */
 ...
 while ( bVar53 );
      ...
      LAB_0010985c:if (( have_read_stdin != false ) && ( iVar12 = iVar12 == -1 )) {

undefined1 *IPAddressRange_it(void) {
   ...
   if (iVar3 <= (int)lVar5) {
      ...
      switchD_00100191_caseD_0:return -1;
   }
   goto LAB_001001e0;
   ...
   if (uVar4 < 8) {
      ...
      *param_1 = *puVar2;
      *(undefined8*)( (long)param_1 + ( (ulong)uVar4 - 8 ) ) = *(undefined8*)( (long)puVar2 + ( (ulong)uVar4 - 8 ) );
      ...
      if (7 < uVar4) {
         ...
         do {
            uVar5 = (ulong)uVar6;
            uVar6 = uVar6 + 8;
            *(undefined8*)( ( ( ulong )(param_1 + 1) & 0xfffffffffffffff8 ) + uVar5 ) = *(undefined8*)( (long)puVar2 + ( uVar5 - lVar7 ) );
         } while ( uVar6 < uVar4 );
      }
      LAB_001003c4:uVar4 = *param_2;
   }
   lVar7 = (long)(int)uVar4;
   ...
   LAB_0010030a:memset((undefined1*)( (long)param_1 + lVar7 ), (uint)param_4, (long)(int)( param_3 - (int)lVar7 ));
   return 1;
   ...
   if (( param_2 != 0 && param_3 != 0 ) && ( param_1 != (int*)0x0 )) {
      if (*param_1 == 0) {
         ...
         if (iVar1 != 0) {
            ...
            LAB_0010047d:iVar1 = addr_expand(param_3, uVar2, param_4, 0xff);
            return iVar1 != 0;
         }
      } else if (*param_1 == 1) {
         iVar1 = addr_expand(param_2, **(undefined8**)( param_1 + 2 ), param_4, 0);
   ...
   if (*piVar2 == 0) {
      ...
      if (iVar3 != 0) {
         ...
         LAB_0010051a:if (( iVar3 == 1 ) && ( iVar3 = addr_expand(local_48, **(undefined8**)( piVar1 + 2 ), 0x10, 0) ),iVar3 != 0) {
            iVar3 = 0x80;
            LAB_001005f8:iVar4 = memcmp(auStack_58, local_48, 0x10);
            if (iVar4 == 0) {
               iVar4 = iVar5 - iVar3;
            }
            goto LAB_00100530;
   ...
   } else if (( *piVar2 == 1 ) && ( iVar3 = addr_expand(auStack_58, **(undefined8**)( piVar2 + 2 ), 0x10, 0) ),iVar3 != 0) {
      iVar3 = *piVar1;
      iVar5 = 0x80;
      if (iVar3 != 0) goto LAB_0010051a;
      LAB_00100590:piVar1 = *(int**)( piVar1 + 2 );
   ...
   iVar4 = -1;
   LAB_00100530:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
   ...
   if (*param_4 < 0) {
      LAB_00100705:uVar3 = 0;
   } else {
      if (param_2 == 1) {
         iVar2 = addr_expand(local_58, param_4, 4, param_3);
         if (iVar2 == 0) goto LAB_00100705;
         BIO_printf(param_1, "%d.%d.%d.%d", (ulong)local_58[0], (ulong)local_58[1], (ulong)local_58[2], (ulong)local_58[3]);
      } else if (param_2 == 2) {
                        ...
                        if (( local_58[5] == '\0' ) && ( local_58[4] == '\0' )) {
                           if (( local_58[3] == 0 ) && ( local_58[2] == 0 )) {
                              if (( local_58[1] == 0 ) && ( local_58[0] == 0 )) {
                                 for (int i_1801 = 0; i_1801 < 2; i_1801++) {
                                    BIO_puts(param_1, ":");
                                 }
                                 goto LAB_001006da;
                              }
   ...
   if (*piVar2 == 0) {
      ...
      if (iVar3 != 0) {
         ...
         LAB_0010099a:if (( iVar3 == 1 ) && ( iVar3 = addr_expand(local_48, **(undefined8**)( piVar1 + 2 ), 4, 0) ),iVar3 != 0) {
            iVar3 = 0x20;
            LAB_00100a78:iVar4 = memcmp(auStack_58, local_48, 4);
            if (iVar4 == 0) {
               iVar4 = iVar5 - iVar3;
            }
            goto LAB_001009b0;
   ...
   } else if (( *piVar2 == 1 ) && ( iVar3 = addr_expand(auStack_58, **(undefined8**)( piVar2 + 2 ), 4, 0) ),iVar3 != 0) {
      iVar3 = *piVar1;
      iVar5 = 0x20;
      if (iVar3 != 0) goto LAB_0010099a;
      LAB_00100a10:piVar1 = *(int**)( piVar1 + 2 );
   ...
   if (( param_2 != 0 ) && ( param_2 != param_1 )) {
      ...
      for (; iVar2 = OPENSSL_sk_num(param_2),iVar5 < iVar2; iVar5 = iVar5 + 1) {
         ...
         while (true) {
            ...
            if (( iVar2 <= iVar6 ) || ( piVar4 = (int*)OPENSSL_sk_value(param_1, iVar6) ),piVar4 == (int*)0x0) goto LAB_00100b5e;
            if (*piVar4 == 0) {
   ...
   uVar3 = 1;
   LAB_00100b60:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return uVar3;
   ...
   return iVar1;
}/* WARNING: Unknown calling convention -- yet parameter storage is locked */IPAddressRange *IPAddressRange_new(void) {
   ASN1_ITEM *it;
   IPAddressRange *pIVar1;
   it = (ASN1_ITEM*)IPAddressRange_it();
   ...
   iVar1 = ASN1_item_i2d((ASN1_VALUE*)a, out, it);
   return iVar1;
}/* WARNING: Unknown calling convention -- yet parameter storage is locked */IPAddressOrRange *IPAddressOrRange_new(void) {
   ASN1_ITEM *it;
   IPAddressOrRange *pIVar1;
   it = (ASN1_ITEM*)IPAddressOrRange_it();
   ...
   if (param_4 == 0) {
      ...
      LAB_001011b6:iVar3 = ASN1_BIT_STRING_set(pAVar7, param_3, 0);
      if (iVar3 != 0) {
      ...
      if (param_2[__n - 1] == '\0') {
         ...
         LAB_00100f68:iVar3 = ASN1_BIT_STRING_set(pAVar7, param_2, 0);
         if (iVar3 == 0) goto LAB_00100f7a;
         ossl_asn1_string_set_bits_left(((a->u).addressRange)->min, 0);
         pAVar7 = (a->u).addressPrefix;
      } else {
         LAB_00101010:iVar3 = ASN1_BIT_STRING_set(pAVar7, param_2, iVar3);
         if (iVar3 == 0) goto LAB_00100f7a;
         ossl_asn1_string_set_bits_left(((a->u).addressRange)->min, 0);
         iVar3 = 1;
      ...
      if (iVar3 != 0) {
         ...
         *puVar1 = *puVar1 | uVar6;
         LAB_001011e0:*param_1 = a;
         return 1;
      }
   }
   LAB_00100f7a:IPAddressOrRange_free(a);
   return 0;
   ...
   iVar1 = ASN1_item_i2d((ASN1_VALUE*)a, out, it);
   return iVar1;
}/* WARNING: Unknown calling convention -- yet parameter storage is locked */IPAddressChoice *IPAddressChoice_new(void) {
   ASN1_ITEM *it;
   IPAddressChoice *pIVar1;
   it = (ASN1_ITEM*)IPAddressChoice_it();
   ...
   iVar1 = ASN1_item_i2d((ASN1_VALUE*)a, out, it);
   return iVar1;
}/* WARNING: Unknown calling convention -- yet parameter storage is locked */IPAddressFamily *IPAddressFamily_new(void) {
   ASN1_ITEM *it;
   IPAddressFamily *pIVar1;
   it = (ASN1_ITEM*)IPAddressFamily_it();
   ...
   for (iVar5 = 0; iVar1 = OPENSSL_sk_num(param_1),iVar5 < iVar1; iVar5 = iVar5 + 1) {
      ...
      if (( pIVar3->addressFamily->length == iVar2 ) && ( iVar1 = memcmp(pIVar3->addressFamily->data, &local_43, __n) ),iVar1 == 0) goto LAB_00101537;
   }
   ...
   if (a != (IPAddressFamily*)0x0) {
      ...
      if (( iVar2 != 0 ) && ( iVar2 = OPENSSL_sk_push(param_1, a) ),pIVar3 = a,iVar2 != 0) goto LAB_00101537;
   }
   LAB_0010159c:pIVar3 = (IPAddressFamily*)0x0;
   IPAddressFamily_free(a);
   LAB_00101537:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return pIVar3;
         ...
         if (2 < *(int*)*puVar5) {
            ...
            if (bVar1 == 0x40) {
               ...
               if (bVar1 == 3) {
                  ...
                  LAB_00101940:BIO_printf(param_3, " (Unknown SAFI %u)");
               }
            } else if (bVar1 == 0x42) {
            ...
            if (0 < iVar3) {
               do {
                  ...
                  if (*piVar6 == 0) {
                     ...
                     BIO_printf(param_3, "/%d\n", ( ulong )(**(int**)( piVar6 + 2 ) * 8 - ( ( uint ) * (undefined8*)( *(int**)( piVar6 + 2 ) + 4 ) & 7 )));
                  } else if (*piVar6 == 1) {
                     iVar3 = i2r_address(param_3, uVar4, 0, **(undefined8**)( piVar6 + 2 ));
                     if (iVar3 == 0) {
                        return 0;
   ...
   *(ASN1_NULL**)( piVar4 + 2 ) = pAVar3;
   ...
   piVar4 = *(int**)( lVar2 + 8 );
   LAB_00101a45:*piVar4 = 0;
   return 1;
}undefined8 X509v3_addr_add_prefix(undefined8 param_1, int param_2, undefined8 param_3, uchar *param_4, uint param_5) {
   byte *pbVar1;
   int *piVar2;
   undefined4 *puVar3;
   int iVar4;
   ...
   if (*piVar2 == 0) {
      ...
      LAB_00101aa8:lVar6 = OPENSSL_sk_new_null();
      if (lVar6 == 0) {
         return 0;
      }
      if (param_2 == 1) {
      ...
      if (( *piVar2 != 1 ) || ( lVar6 = lVar6 == 0 )) goto LAB_00101aa8;
      iVar4 = 0x20;
      if (param_2 != 1) {
   ...
   LAB_00101b9f:IPAddressOrRange_free(a);
   return 0;
}undefined8 X509v3_addr_add_range(undefined8 param_1, int param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5) {
   int *piVar1;
   undefined4 *puVar2;
   int iVar3;
   long lVar4;
   ...
   if (( lVar4 != 0 ) && ( piVar1 = *(int**)( lVar4 + 8 ) ),piVar1 != (int*)0x0) {
      if (*piVar1 == 0) {
         if (*(long*)( piVar1 + 2 ) == 0) {
            LAB_00101c7f:lVar5 = OPENSSL_sk_new_null();
            if (lVar5 != 0) {
               if (param_2 == 1) {
         ...
         if (( *piVar1 != 1 ) || ( lVar5 = lVar5 == 0 )) goto LAB_00101c7f;
         lVar4 = 4;
         if (param_2 != 1) {
            lVar4 = ( ulong )(param_2 == 2) << 4;
         }
         LAB_00101cd8:iVar3 = make_addressRange(&local_38, param_4, param_5, lVar4);
         if (iVar3 != 0) {
   ...
   uVar6 = 0;
   LAB_00101cec:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar6;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   if (( ( ( param_3 != 0 ) && ( param_1 != (uint*)0x0 ) ) && ( param_4 != 0 ) ) && ( ( ( iVar2 <= param_5 && ( *param_1 < 2 ) ) && ( iVar1 = extract_min_max() ),iVar1 != 0 ) )) {
      return iVar2;
   }
   return 0;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   LAB_00101eee:iVar3 = OPENSSL_sk_num(param_1);
   ...
   if (( puVar6 == (undefined8*)0x0 ) || ( piVar9 = (int*)puVar6[1] ),piVar9 == (int*)0x0) goto LAB_00101e62;
   if (*piVar9 != 0) {
      ...
      while (iVar5 = OPENSSL_sk_num(uVar2),iVar3 < iVar5 + -1) {
         ...
         if (( ( ( iVar3 == 0 ) || ( iVar3 = memcmp(local_88, local_68, __n) ),-1 < iVar3 ) ) || ( iVar3= memcmp(local_88,local_78,__n),0 < iVar3 )) goto LAB_00101e62;
         cVar1 = local_68[iVar11];
         local_68[iVar11] = cVar1 + -1;
         if (( ( ( ( cVar1 == '\0' ) && ( ( cVar1 = local_68[iVar11 + -1] ),local_68[iVar11 + -1] = cVar1 + -1,cVar1 == '\0' && ( cVar1 = local_68[iVar11 + -2] ),local_68[iVar11 + -2] = cVar1 + -1,cVar1 == '\0' ) ) ) ) && ( cVar1 = local_68[iVar11 + -3] ),local_68[iVar11 + -3] = cVar1 + -1,cVar1 == '\0') ( ( ( ( iVar11 != 3 && ( cVar1 = local_5d + -1 ),bVar13 = local_5d == '\0',local_5d = cVar1,bVar13 ) ) && ( cVar1 = local_5e + -1 ),bVar13 = local_5e == '\0',local_5e = cVar1,bVar13 ) ) && ( ( ( cVar1 = local_5f + -1 ),bVar13 = local_5f == '\0',local_5f = cVar1,bVar13 && ( cVar1 = local_60 + -1 ),bVar13 = local_60 == '\0',local_60 = cVar1,bVar13 ) ) && ( ( cVar1 = local_61 + -1 ),bVar13 = local_61 == '\0',local_61 = cVar1,bVar13 && ( ( cVar1 = local_62 + -1 ),bVar13 = local_62 == '\0',local_62 = cVar1,bVar13 && ( cVar1 = local_63 + -1 ),bVar13 = local_63 == '\0',local_63 = cVar1,bVar13 ) ) && ( ( cVar1 = local_64 + -1 ),bVar13 = local_64 == '\0',local_64 = cVar1,bVar13 && ( ( ( cVar1 = local_68[3] + -1 ),bVar13 = local_68[3] == '\0',local_68[3] = cVar1,bVar13 && ( cVar1 = local_68[2] + -1 ),bVar13 = local_68[2] == '\0',local_68[2] = cVar1,bVar13 ) ) && ( cVar1 = local_68[1] + -1 ),bVar13 = local_68[1] == '\0',local_68[1] = cVar1,bVar13 ))
             )))) {
        local_68[0] = local_68[0] + -1;
      };
      iVar3 = memcmp(local_78, local_68, __n);
      if (( -1 < iVar3 ) || ( ( iVar3 = iVar5 * piVar9 == 1 && ( iVar5 = range_should_be_prefix(local_88, local_78, uVar8) < iVar5 ) ) )) goto LAB_00101e62;
   }
   iVar3 = OPENSSL_sk_num(uVar2);
   piVar9 = (int*)OPENSSL_sk_value(uVar2, iVar3 + -1);
   if (( piVar9 != (int*)0x0 ) && ( *piVar9 == 1 )) {
      iVar3 = extract_min_max(piVar9, local_88, local_78, uVar8);
      if (( ( iVar3 == 0 ) || ( iVar3 = memcmp(local_88, local_78, __n) ),0 < iVar3 )) goto LAB_00101e62;
   }
}iVar12 = iVar12 + 1;goto LAB_00101eee;}undefined8 addr_validate_path_internal(ulong param_1, long param_2, long param_3) {
   int iVar1;
   int iVar2;
   int iVar3;
   undefined4 uVar4;
   ...
   long lVar9;
   undefined8 uVar10;
   if (( param_2 == 0 ) || ( iVar1 = iVar1 < 1 )) {
      if (param_1 == 0) {
         return 0;
      }
      LAB_00102495:*(undefined4*)( param_1 + 0xb0 ) = 1;
      return 0;
   }
   ...
   if (param_1 == 0) {
      if (param_3 == 0) {
         LAB_00102590:lVar6 = OPENSSL_sk_value(param_2, 0);
         ...
         if (iVar2 == 0) {
            LAB_00102344:*(int*)( param_1 + 0xac ) = iVar2;
            ...
            *(long*)( param_1 + 0xb8 ) = lVar6;
            ...
            if (iVar2 != 0) {
               ...
               LAB_00102396:OPENSSL_sk_sort(lVar5);
               LAB_0010239e:iVar2 = OPENSSL_sk_num(param_2);
                     ...
                     *(long*)( param_1 + 0xb8 ) = lVar6;
                     ...
                     if (iVar2 != 0) {
                        if (*(long*)( lVar6 + 0x128 ) == 0) {
                           LAB_001024f1:for (iVar2 = 0; iVar3 = OPENSSL_sk_num(lVar5),iVar2 < iVar3; iVar2 = iVar2 + 1) {
                           ...
                           LAB_00102400:for (iVar2 = 0; iVar3 = OPENSSL_sk_num(lVar5),iVar2 < iVar3; iVar2 = iVar2 + 1) {
                              puVar7 = (undefined8*)OPENSSL_sk_value(lVar5, iVar2);
                              ...
                              if (puVar8 == (undefined8*)0x0) {
                                 ...
                                 if (*(int*)puVar8[1] == 1) {
                                    if (*(int*)puVar7[1] != 0) {
                                       ...
                                       iVar3 = addr_contains(*(undefined8*)( puVar8[1] + 8 ), *(undefined8*)( puVar7[1] + 8 ), lVar9);
                                       if (iVar3 == 0) {
                                          *(int*)( param_1 + 0xac ) = iVar1;
                     ...
                     if (puVar8 == (undefined8*)0x0) {
                        ...
                        if (*(int*)puVar8[1] == 1) {
                           if (*(int*)puVar7[1] != 0) {
                              ...
                              iVar2 = addr_contains(*(undefined8*)( puVar8[1] + 8 ), *(undefined8*)( puVar7[1] + 8 ), iVar2);
      ...
      LAB_001026a0:ERR_new();
      ERR_set_debug("crypto/x509/v3_addr.c", 0x4f7, "addr_validate_path_internal");
      ERR_set_error(0x22, 0x8000f, 0);
      LAB_001026d0:*(undefined4*)( param_1 + 0xb0 ) = 0x11;
   }
   uVar10 = 0;
   lVar5 = 0;
   goto LAB_00102520;
   LAB_0010253d:*(int*)( param_1 + 0xac ) = iVar1;
   *(undefined4*)( param_1 + 0xb0 ) = 0x2e;
   *(long*)( param_1 + 0xb8 ) = lVar6;
   iVar2 = ( **(code**)( param_1 + 0x38 ) )(0, param_1);
   if (iVar2 == 0) goto LAB_0010251d;
   goto LAB_00102561;
   LAB_0010251d:uVar10 = 0;
   goto LAB_00102520;
   LAB_001027f8:lVar9 = *(long*)( lVar6 + 0x128 );
   uVar10 = 1;
   if (lVar9 != 0) {
      iVar2 = 0;
      if (param_1 == 0) {
         while (true) {
            ...
            if (( 1 < *(int*)*puVar7 - 2U ) || ( ( *(int*)puVar7[1] == 0 && ( iVar1 = OPENSSL_sk_find(lVar5) ),-1 < iVar1 ) )) goto LAB_0010251d;
         ...
         if (0 < iVar3) {
            do {
               ...
               if (1 < *(int*)*puVar7 - 2U) goto LAB_0010251d;
               if (( *(int*)puVar7[1] == 0 ) && ( iVar3 = -1 < iVar3 )) {
                  *(int*)( param_1 + 0xac ) = iVar1;
                  *(undefined4*)( param_1 + 0xb0 ) = 0x2e;
                  *(long*)( param_1 + 0xb8 ) = lVar6;
                  iVar3 = ( **(code**)( param_1 + 0x38 ) )(0, param_1);
   ...
   LAB_00102520:OPENSSL_sk_free(lVar5);
   return uVar10;
         ...
         if (*(int*)puVar6[1] == 1) {
            ...
            if (0 < iVar4 + -1) {
               do {
                  ...
                  if (( ( ( iVar5 == 0 ) || ( iVar5 = memcmp(local_88, local_78, __n) ),0 < iVar5 ) ) || ( iVar5= memcmp(local_68,local_58,__n),0 < iVar5 )) goto LAB_00102ab3;
                  if (iVar3 == -1) {
                     LAB_00102e20:iVar5 = make_addressRange(&local_90, local_88, local_58, local_d4);
                     if (iVar5 == 0) goto LAB_00102ab3;
                     ...
                     if (( ( ( ( cVar1 == '\0' ) && ( cVar1 = local_68[iVar3 + -1] ),local_68[iVar3 + -1] = cVar1 + -1,cVar1 == '\0' ) ) && ( ( cVar1 = local_68[iVar3 + -2] ),local_68[iVar3 + -2] = cVar1 + -1,cVar1 == '\0' && ( ( cVar1 = local_68[iVar3 + -3] ),local_68[iVar3 + -3] = cVar1 + -1,cVar1 == '\0' && ( iVar3 != 3 ) ) ) )) ( ( ( ( ( cVar1 = local_5e + -1 ),bVar9 = local_5e == '\0',local_5e = cVar1,bVar9 && ( cVar1 = local_5f + -1 ),bVar9 = local_5f == '\0',local_5f = cVar1,bVar9 ) ) && ( cVar1 = local_60 + -1 ),bVar9 = local_60 == '\0',local_60 = cVar1,bVar9 ) ) && ( ( cVar1 = local_61 + -1 ),bVar9 = local_61 == '\0',local_61 = cVar1,bVar9 && ( cVar1 = local_62 + -1 ),bVar9 = local_62 == '\0',local_62 = cVar1,bVar9 ) && ( ( ( cVar1 = local_63 + -1 ),bVar9 = local_63 == '\0',local_63 = cVar1,bVar9 && ( ( cVar1 = local_64 + -1 ),bVar9 = local_64 == '\0',local_64 = cVar1,bVar9 && ( cVar1 = local_68[3] + -1 ),bVar9 = local_68[3] == '\0',local_68[3] = cVar1,bVar9 ) ) ) && ( ( cVar1 = local_68[2] + -1 ),bVar9 = local_68[2] == '\0',local_68[2] = cVar1,bVar9 && ( cVar1 = local_68[1] + -1 ),bVar9 = local_68[1] == '\0',local_68[1] = cVar1,bVar9 )))))))) {
                local_68[0] = local_68[0] + -1;
                  }
   ...
   if (local_a8 == 0) {
      ...
      for (; iVar2 = OPENSSL_sk_num(param_3),iVar10 < iVar2; iVar10 = iVar10 + 1) {
         ...
         if (iVar2 != 0) {
            ...
            if (iVar2 == 0) {
               LAB_001031a6:if (*(char**)( lVar4 + 0x10 ) == (char*)0x0) {
                  ERR_new();
               ...
               if (( 0xff < (uint)uVar8 ) || ( pcVar5 = local_70 + 1 ),cVar1 = *local_70,local_70 = pcVar5,cVar1 != ':') {
                  ERR_new();
                  ERR_set_debug("crypto/x509/v3_addr.c", 0x3eb, "v2i_IPAddrBlocks");
                  ERR_set_error(0x22, 0xa4, 0);
                  ERR_add_error_data(4, "name=", *(undefined8*)( lVar4 + 8 ), ", value=", *(undefined8*)( lVar4 + 0x10 ));
                  goto LAB_001034c1;
               }
               sVar6 = strspn(pcVar5, " \t");
               local_70 = pcVar5 + sVar6;
            ...
            LAB_001034c1:pcVar5 = (char*)0x0;
            goto LAB_001030f9;
         }
         LAB_00102fa1:pcVar5 = CRYPTO_strdup(*(char**)( lVar4 + 0x10 ), "crypto/x509/v3_addr.c", 0x3f2);
         local_98 = (uint*)0x0;
         LAB_00102fd0:if (pcVar5 == (char*)0x0) goto LAB_001034c1;
         ...
         if (iVar2 != 0) {
            ...
            if (iVar3 == iVar9) {
               if (cVar1 == '-') {
                  ...
                  if (( ( ( pcVar5 + iVar2 != local_70 ) && ( *local_70 == '\0' ) ) && ( (int)uVar8 <= iVar9 * 8 ) ) && ( -1 < (int)uVar8 )) {
                  ...
                  if (cVar1 == '\0') {
                     ...
                     if (iVar2 != 0) {
                        LAB_00103277:CRYPTO_free(pcVar5);
                        goto LAB_00103018;
                     }
                     ERR_new();
                     uVar11 = 0x43a;
                     LAB_00103339:ERR_set_debug("crypto/x509/v3_addr.c", uVar11, "v2i_IPAddrBlocks");
            ...
            LAB_001030c9:ERR_set_error(0x22, uVar11, 0);
            ERR_add_error_data(4, "name=", *(undefined8*)( lVar4 + 8 ), ", value=", *(undefined8*)( lVar4 + 0x10 ));
            goto LAB_001030f9;
         }
         ...
         CRYPTO_free(pcVar5);
         LAB_00103018:}iVar10 = X509v3_addr_canonize(local_a8);
         if (iVar10 != 0) goto LAB_00103125;
         pcVar5 = (char*)0x0;
         LAB_001030f9:CRYPTO_free(pcVar5);
         OPENSSL_sk_pop_free(local_a8, IPAddressFamily_free);
      }
      local_a8 = 0;
      LAB_00103125:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Subroutine does not return */
         __stack_chk_fail();
      }
      return local_a8;

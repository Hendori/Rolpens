   ...
   *(void**)( param_7 + 0x60 ) = pvVar4;
   if (pvVar4 == (void*)0x0) {
      ...
      *(undefined8*)( param_7 + 8 ) = *param_1;
      for (int i_83 = 0; i_83 < 4; i_83++) {
         *(undefined8*)( param_7 + ( 16*i_83 + 16 ) ) = uVar6;
         uVar6 = param_1[( 2*i_83 + 3 )];
         *(undefined8*)( param_7 + ( 16*i_83 + 24 ) ) = param_1[( 2*i_83 + 2 )];
      }

...

{
  ...
  if (*(long *)(this + 0x5b0) == 0) {
    ...
    if (0 < iVar15) {
      ...
      uVar14 = 0;
      puVar11 = local_80;
      while (uVar13 = uVar14, lVar3 != 0) {
        lVar16 = *(long *)(lVar3 + -8);
        if (lVar16 <= (long)uVar14) goto LAB_001037c3;
        puVar1 = (undefined8 *)(lVar3 + uVar14 * 8);
        uVar2 = *puVar1;
        uVar5 = *puVar1;
        fVar17 = (float)uVar2;
        fVar18 = (float)((ulong)uVar2 >> 0x20);
        uVar13 = (ulong)(((int)uVar14 + 1) % iVar15);
        if (lVar16 <= (long)uVar13) goto LAB_001037c3;
        puVar1 = (undefined8 *)(lVar3 + uVar13 * 8);
        uVar2 = *puVar1;
        uVar6 = *puVar1;
        fVar20 = (float)uVar2;
        ...
        puVar11[2] = uVar5;
        puVar11[3] = uVar6;
        *puVar11 = CONCAT44(fVar18,fVar17);
        puVar11[1] = CONCAT44(fVar20 + fVar18,fVar17 - fVar19);
        if (iVar15 - 1 == uVar14) goto LAB_00103838;
        uVar14 = uVar14 + 1;
        puVar11 = puVar11 + 4;
        lVar3 = *(long *)(this + 0x5b0);
      }
...
LAB_00103838:
  ...
  if (local_80 == (undefined8 *)0x0) goto LAB_00103980;
  lVar3 = local_80[-1];
  if (lVar3 < 0) {
    _err_print_error("resize","./core/templates/cowdata.h",0x157,
                     "Condition \"p_size < 0\" is true. Returning: ERR_INVALID_PARAMETER",0,0);
  ...
  if (lVar3 == 0) goto LAB_00103980;
  uVar14 = lVar3 * 0x10;
  if ((uVar14 == 0) ||
     (uVar13 = uVar14 - 1 | uVar14 - 1 >> 1, uVar13 = uVar13 | uVar13 >> 2,
     uVar13 = uVar13 | uVar13 >> 4, uVar13 = uVar13 | uVar13 >> 8, uVar13 = uVar13 | uVar13 >> 0x10,
     uVar13 = uVar13 | uVar13 >> 0x20, uVar13 == 0xffffffffffffffff)) {
    _err_print_error("resize","./core/templates/cowdata.h",0x16a,
                     "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY"
                     ,0,0);
LAB_00103bb6:
    if (local_70 == (undefined1 (*) [16])0x0) goto LAB_00103980;
  }
  else {
    pauVar9 = (undefined1 (*) [16])Memory::alloc_static(uVar13 + 0x11,false);
    ...
    local_70 = pauVar9 + 1;
    *(undefined8 *)*pauVar9 = 1;
    uVar5 = _UNK_001139f8;
    uVar2 = __LC95;
    pauVar12 = pauVar9;
    if ((uVar14 & 0x10) == 0) goto LAB_00103930;
    *(undefined8 *)pauVar9[1] = __LC95;
    *(undefined8 *)((long)pauVar9[1] + 8) = uVar5;
    pauVar12 = local_70;
    while (pauVar9 + lVar3 != pauVar12) {
LAB_00103930:
      *(undefined8 *)pauVar12[1] = uVar2;
      *(undefined8 *)((long)pauVar12[1] + 8) = uVar5;
      *(undefined8 *)pauVar12[2] = uVar2;
      *(undefined8 *)((long)pauVar12[2] + 8) = uVar5;
      pauVar12 = pauVar12 + 2;
    }
    *(long *)((long)*pauVar9 + 8) = lVar3;
  }
...
LAB_00103952:
    ...
    *(long *)*pauVar9 = *(long *)*pauVar9 + -1;
    ...
    if (*(long *)*pauVar9 == 0) {
      local_70 = (undefined1 (*) [16])0x0;
      Memory::free_static(pauVar7 + -1,false);
      local_70 = pauVar12;
    }
  }
  lVar3 = *(long *)((long)local_70[-1] + 8);
...
LAB_00103980:
  ...
  pcVar4 = *(code **)(*plVar8 + 0x318);
  Dictionary::Dictionary(local_90);
  Array::Array(local_98);
  (*pcVar4)(plVar8,*(undefined8 *)(this + 0x5f8),1,local_a0,local_98,local_90,0x2000000);
  Array::~Array(local_98);
  Dictionary::~Dictionary(local_90);
  pcVar4 = *(code **)(*plVar8 + 0xf60);
  ...
  (*pcVar4)(plVar8,*(undefined8 *)(this + 0x5f0),this + 0x5f8,(Variant *)&local_58,&local_68,0);
  Array::~Array(local_a0);
  pauVar9 = local_70;
  if (local_70 != (undefined1 (*) [16])0x0) {
    LOCK();
  ...
  if (param_1 < 0x20) {
    if (10 < param_1) {
      ...
      case 0xb:
        ...
        if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x001041fa. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
LAB_00103fb0:
      ...
      case 0x1f:
        ...
        if (local_30 != *(long *)(in_FS_OFFSET + 0x28)) goto LAB_0010432f;
...
LAB_00103edd:
                    /* WARNING: Could not recover jumptable at 0x00103eed. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    ...
    if (param_1 == 0x232c) {
      ...
      if (cVar2 == '\0') goto switchD_00103e31_caseD_e;
    }
  }
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
...
LAB_0010785d:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_0010785d;
    StringName::StringName((StringName *)&local_80,(CowData<char32_t> *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)pLVar5;
      local_68 = local_80;
      goto joined_r0x0010787f;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
...
LAB_00107fbd:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_00107fbd;
    StringName::StringName((StringName *)&local_80,(CowData<char32_t> *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)param_1;
      local_68 = local_80;
      goto joined_r0x00107fdf;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
...
LAB_0010839d:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_0010839d;
    StringName::StringName((StringName *)&local_80,(CowData<char32_t> *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)param_1;
      local_68 = local_80;
      goto joined_r0x001083bf;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
...
LAB_00108b6d:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_00108b6d;
    StringName::StringName((StringName *)&local_80,(CowData<char32_t> *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)param_1;
      local_68 = local_80;
      goto joined_r0x00108b8f;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
...
LAB_00108ef5:
    ...
    local_40 = 6;
    if (local_50 != 0x11) goto LAB_00108ef5;
...
LAB_00109165:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_48,(CowData *)&local_80);
    local_40 = 6;
    if (local_50 != 0x11) goto LAB_00109165;
    StringName::StringName((StringName *)&local_70,(CowData<char32_t> *)&local_48,false);
    if (local_60._8_8_ == local_70) {
      if ((StringName::configured != '\0') && (local_70 != 0)) {
        StringName::unref();
...
LAB_001093d5:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_48,(CowData *)&local_80);
    local_40 = 6;
    if (local_50 != 0x11) goto LAB_001093d5;
    StringName::StringName((StringName *)&local_70,(CowData<char32_t> *)&local_48,false);
    if (local_60._8_8_ == local_70) {
      if ((StringName::configured != '\0') && (local_70 != 0)) {
        StringName::unref();
...
LAB_00109645:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_48,(CowData *)&local_80);
    local_40 = 6;
    if (local_50 != 0x11) goto LAB_00109645;
    StringName::StringName((StringName *)&local_70,(CowData<char32_t> *)&local_48,false);
    if (local_60._8_8_ == local_70) {
      if ((StringName::configured != '\0') && (local_70 != 0)) {
        StringName::unref();
...
LAB_001098b5:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_48,(CowData *)&local_80);
    local_40 = 6;
    if (local_50 != 0x11) goto LAB_001098b5;
    StringName::StringName((StringName *)&local_70,(CowData<char32_t> *)&local_48,false);
    if (local_60._8_8_ == local_70) {
      if ((StringName::configured != '\0') && (local_70 != 0)) {
        StringName::unref();
...
LAB_00109b25:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_48,(CowData *)&local_80);
    local_40 = 6;
    if (local_50 != 0x11) goto LAB_00109b25;
    StringName::StringName((StringName *)&local_70,(CowData<char32_t> *)&local_48,false);
    if (local_60._8_8_ == local_70) {
      if ((StringName::configured != '\0') && (local_70 != 0)) {
        StringName::unref();
...
LAB_0010b5a6:
    ...
    lVar4 = puVar7[-1];
    if (param_1 <= lVar4) goto LAB_0010b43f;
  }
  else {
    if (lVar4 != 0) {
      uVar3 = _realloc(this,lVar9);
...
LAB_0010b8d2:
    ...
    *(undefined8 *)(param_4 + 4) = uVar6;
    ...
    if (((pOVar10 == (Object *)0x0) ||
       ...
       (pOVar8 != (Object *)0x0)) goto LAB_0010b8d2;
  }
...
LAB_0010b995:
      ...
      if (pOVar10 != pOVar9) {
        ...
        if (pOVar10 != (Object *)0x0) goto LAB_0010b995;
      }
    }
  }
...
LAB_0010ba2b:
      ...
      if (pOVar10 != pOVar9) {
        ...
        if (pOVar10 != (Object *)0x0) goto LAB_0010ba2b;
      }
    }
  }
...
/* WARNING: Removing unreachable block (ram,0x0010bf00) */
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010c7e6. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Load size is inaccurate */
                    /* WARNING: Could not recover jumptable at 0x0010c9da. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010d23c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)
              ((long *)((long)param_2 + *(long *)(param_1 + 0x60)),
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010d41b. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010dcf1. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)
              ((long *)((long)param_2 + *(long *)(param_1 + 0x60)),
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010dec9. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)((long *)((long)param_2 + *(long *)(param_1 + 0x60)),*param_3);
    return;
  }
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010e6ae. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010e88d. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
    ...
    auVar2._0_4_ = (float)*(double *)(*(long *)param_3 + 8);
                    /* WARNING: Could not recover jumptable at 0x0010f082. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
    ...
    auVar2._0_4_ = (float)**param_3;
                    /* WARNING: Could not recover jumptable at 0x0010f261. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)(auVar2._0_8_,(long *)((long)param_2 + *(long *)(param_1 + 0x60)));
    return;
  }
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010f43d. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)
              ((long *)((long)param_2 + *(long *)(param_1 + 0x60)),
               *(undefined8 *)(*(long *)param_3 + 8));
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010f61c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)((long *)((long)param_2 + *(long *)(param_1 + 0x60)),**param_3);
    return;
  }
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010ffd2. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
LAB_0011161d:
    ...
    if (iVar6 <= iVar11) {
      if (uVar10 == 0) {
        lVar9 = (long)(iVar11 + -2);
        if (lVar2 <= lVar9) goto LAB_00111638;
        this = (Variant *)(lVar1 + lVar9 * 0x18);
      }
      else {
        this = (Variant *)*plVar8;
        if (uVar10 == 2) goto LAB_0011161d;
      }
...
LAB_00111555:
      *(undefined4 *)param_6 = 0;
      ...
      iVar6 = Variant::operator_cast_to_int(this);
                    /* WARNING: Could not recover jumptable at 0x001115dc. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
LAB_0011191b:
  *(undefined4 *)param_6 = 0;
  ...
  Variant::operator_cast_to_unsigned_int(this);
                    /* WARNING: Could not recover jumptable at 0x00111976. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
LAB_00111cab:
  *(undefined4 *)param_6 = 0;
  ...
  fVar9 = Variant::operator_cast_to_float(this);
                    /* WARNING: Could not recover jumptable at 0x00111d04. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*param_2)(fVar9);
  return;
}
...
LAB_0011203b:
  *(undefined4 *)param_6 = 0;
  ...
  Variant::operator_cast_to_bool(this);
                    /* WARNING: Could not recover jumptable at 0x00112097. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  iVar5 = *param_2;
  if (iVar5 != param_1) goto LAB_00112387;
  local_78 = 0;
  local_68 = &_LC17;
  local_80 = 0;
  auVar1._8_8_ = 0;
...
LAB_00112485:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_48,(CowData *)&local_80);
    local_40 = 6;
    if (local_50 != 0x11) goto LAB_00112485;
    StringName::StringName((StringName *)&local_70,(CowData<char32_t> *)&local_48,false);
    if (local_60._8_8_ == local_70) {
      if ((StringName::configured != '\0') && (local_70 != 0)) {
        StringName::unref();
...
LAB_0011273f:
    ...
    puVar5[10] = 6;
    if (puVar5[6] != 0x11) goto LAB_0011273f;
...

{
  ...
  *(undefined1 (*) [16])(pPVar5 + 8) = (undefined1  [16])0x0;
  ...
  if (in_EDX != local_8c) goto LAB_00112816;
  local_78 = 0;
  local_80 = 0;
  local_68 = &_LC17;
  auVar1._8_8_ = 0;
...
LAB_00112918:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_48,(CowData *)&local_80);
    local_40 = 6;
    if (local_50 != 0x11) goto LAB_00112918;
    StringName::StringName((StringName *)&local_70,(CowData<char32_t> *)&local_48,false);
    if (local_60._8_8_ == local_70) {
      if ((StringName::configured != '\0') && (local_70 != 0)) {
        StringName::unref();

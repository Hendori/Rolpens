/* graphite2::Segment::newSlot() [clone .part.0] */Slot * __thiscall graphite2::Segment::newSlot(Segment *this){
   byte bVar1;
   Slot *__ptr;
   short *__ptr_00;
   undefined8 *puVar2;
   ...
   *puVar5 = __ptr;
   ...
   if (puVar5 == *(undefined8**)( this + 0x30 )) {
      ...
      if (( ulong )(lVar6 >> 3) < uVar7) {
         if (uVar7 >> 0x3d != 0) {
            graphite2_Segment_newSlot:/* WARNING: Subroutine does not return */abort();
         }
   ...
   puVar2 = puVar5 + 1;
   LAB_0010012d:*(undefined8**)( this + 0x28 ) = puVar2;
   *puVar5 = __ptr_00;
   pSVar3 = (Slot*)0x0;
...
/* graphite2::Segment::~Segment() */void graphite2::Segment::~Segment(Segment *this) {
   void *pvVar1;
   undefined8 *puVar2;
   undefined8 *puVar3;
   undefined8 *puVar4;
 ...
 while ( puVar2 != puVar4 );
   ...
   free(__dest);
   for (int i = 0; i < 3; i++) {
      free(*(void**)( this + ( -24*i + 56 ) ));
   }

   return;
}
/* graphite2::Segment::appendSlot(int, int, int, int, unsigned long) */void graphite2::Segment::appendSlot(Segment *this, int param_1, int param_2, int param_3, int param_4, ulong param_5) {
   undefined8 *puVar1;
   long lVar2;
   undefined1 uVar3;
   byte bVar4;
...
/* graphite2::Segment::newSlot() */void graphite2::Segment::newSlot(Segment *this) {
   undefined8 *puVar1;
...
/* graphite2::Segment::freeSlot(graphite2::Slot*) */void graphite2::Segment::freeSlot(Segment *this, Slot *param_1) {
   long lVar1;
   uint uVar2;
   ulong uVar3;
   undefined8 *puVar4;
   ...
   do {
      if (lVar1 == 0) {
         LAB_0010057e:graphite2::Slot::Slot(param_1, *(short**)( param_1 + 0x70 ));
         ...
         if (uVar2 < 8) {
            ...
            *(undefined8*)( (long)puVar4 + ( uVar3 - 8 ) ) = 0;
            uVar3 = ( ulong )(uVar2 + ( (int)puVar4 - (int)(undefined8*)( ( ulong )(puVar4 + 1) & 0xfffffffffffffff8 ) ) >> 3);
...
/* graphite2::Segment::Segment(unsigned long, graphite2::Face const*, unsigned int, int) */void graphite2::Segment::Segment(Segment *this, ulong param_1, Face *param_2, uint param_3, int param_4) {
   byte bVar1;
   char cVar2;
   undefined8 uVar3;
   undefined8 *puVar4;
...
/* graphite2::Segment::newJustify() */void graphite2::Segment::newJustify(Segment *this) {
   long lVar1;
   undefined8 *puVar2;
   ulong uVar3;
   void *pvVar4;
 ...
 while ( lVar5 != -1 );
   ...
   *(void**)( this + 0x70 ) = pvVar4;
   ...
   if (puVar2 == *(undefined8**)( this + 0x48 )) {
      ...
      if (uVar3 >> 0x3d != 0) {
         graphite2_Segment_newJustify:/* WARNING: Subroutine does not return */abort();
      }
      ...
      *(undefined8**)( this + 0x48 ) = puVar6;
      ...
      LAB_00100925:puVar6 = puVar2 + 1;
   }

   *(undefined8**)( this + 0x40 ) = puVar6;
   *puVar2 = pvVar4;
   puVar2 = *(undefined8**)( this + 0x70 );
   LAB_00100884:*(undefined8*)( this + 0x70 ) = *puVar2;
   *puVar2 = 0;
   return;
}
/* graphite2::Segment::freeJustify(graphite2::SlotJustify*) */void graphite2::Segment::freeJustify(Segment *this, SlotJustify *param_1) {
   byte bVar1;
   undefined8 uVar2;
   long lVar3;
   ulong uVar4;
   ...
   *(undefined8*)( param_1 + lVar3 ) = 0;
   ...
   for (uVar4 = ( ulong )(( uint )((int)lVar3 + ( ( (int)param_1 + 8 ) - (int)(undefined8*)( ( ulong )(param_1 + 0x10) & 0xfffffffffffffff8 ) )) >> 3); uVar4 != 0; uVar4 = uVar4 - 1) {
      *puVar5 = 0;
      puVar5 = puVar5 + 1;
   }
...
/* graphite2::Segment::reverseSlots() */void graphite2::Segment::reverseSlots(Segment *this) {
   char cVar1;
   long lVar2;
   long *plVar3;
   long *plVar4;
   ...
   if (plVar6 != *(long**)( this + 0xa0 )) {
      for (; plVar6 != (long*)0x0; plVar6 = (long*)*plVar6) {
         ...
         if (cVar1 == -1) {
            ...
            *(undefined1*)( (long)plVar6 + 0x6e ) = 0;
            cVar1 = '\0';
            LAB_00100ac8:plVar8 = (long*)0x0;
            plVar5 = plVar6;
            goto LAB_00100afc;
         }

         LAB_00100a40:if (cVar1 != '\x10') {
            cVar1 = *(char*)( (long)plVar6 + 0x6e );
            LAB_00100ab8:local_40 = (undefined8*)plVar6[1];
            goto LAB_00100ac8;
         }
   ...
   return;
   LAB_00100afc:if (cVar1 == -1) {
      if (( *(ushort*)( plVar5 + 2 ) < *(ushort*)( *(long*)( *(long*)( this + 0x88 ) + 0x78 ) + 0x28 ) ) && ( lVar2 = graphite2::GlyphCache::glyph(( ushort ) * (long*)( *(long*)( this + 0x88 ) + 0x78 )) ),lVar2 != 0) {
         cVar1 = graphite2::sparse::operator []((short)lVar2 + 0x18);
         plVar3 = (long*)*plVar5;
      ...
      *(undefined1*)( (long)plVar5 + 0x6e ) = 0;
      plVar3 = (long*)*plVar5;
      LAB_00100adc:if (plVar8 != (long*)0x0) {
      ...
      *plVar5 = (long)plVar8;
      ...
      plVar3 = (long*)*plVar5;
      joined_r0x00100ada:if (cVar1 != '\x10') goto LAB_00100adc;
      for (; plVar3 != (long*)0x0; plVar3 = (long*)*plVar3) {
         cVar1 = *(char*)( (long)plVar3 + 0x6e );
         if (cVar1 == -1) {
            if (( *(ushort*)( plVar3 + 2 ) < *(ushort*)( *(long*)( *(long*)( this + 0x88 ) + 0x78 ) + 0x28 ) ) && ( lVar2 = graphite2::GlyphCache::glyph(( ushort ) * (long*)( *(long*)( this + 0x88 ) + 0x78 )) ),lVar2 != 0) {
               cVar1 = graphite2::sparse::operator []((short)lVar2 + 0x18);
            ...
            *(undefined1*)( (long)plVar3 + 0x6e ) = 0;
            LAB_00100c04:plVar4 = (long*)plVar3[1];
            goto LAB_00100c08;
         }

         LAB_00100b60:if (cVar1 != '\x10') goto LAB_00100c04;
      }

      plVar4 = *(long**)( this + 0xa0 );
      LAB_00100c08:lVar2 = *plVar8;
      plVar7 = plVar4;
      if (lVar2 != 0) {
         *(long**)( lVar2 + 8 ) = plVar4;
         plVar7 = plVar6;
...
/* graphite2::Segment::linkClusters(graphite2::Slot*, graphite2::Slot*) */void graphite2::Segment::linkClusters(Segment *this, Slot *param_1, Slot *param_2) {
   Slot *pSVar1;
   Slot *pSVar2;
   pSVar1 = *(Slot**)param_2;
   if (param_1 != pSVar1) {
...
/* graphite2::Segment::positionSlots(graphite2::Font const*, graphite2::Slot*, graphite2::Slot*,
   bool, bool) */undefined8 graphite2::Segment::positionSlots(Segment *this, Font *param_1, Slot *param_2, Slot *param_3, bool param_4, bool param_5) {
   Slot *pSVar1;
   Slot *pSVar2;
   bool bVar3;
   long in_FS_OFFSET;
   ...
   if (pSVar2 == (Slot*)0x0) {
      ...
      LAB_00100ed3:if (( pSVar2 == (Slot*)0x0 ) || ( param_3 == (Slot*)0x0 )) goto LAB_00100ee1;
   }
 else if (param_3 == (Slot*)0x0) {
      LAB_00100ecc:param_3 = *(Slot**)( this + 0xa0 );
      goto LAB_00100ed3;
   }
      ...
      if (pSVar2 != param_3) {
         do {
            if (*(long*)( (Segment*)param_3 + 0x28 ) == 0) {
               ...
               local_60 = graphite2::Slot::finalise((Segment*)param_3, (Font*)this, (Position*)param_1, (Rect*)&local_60, (uchar)local_58, (float*)0x0, SUB81(&local_64, 0), true, (uint)param_5);
      ...
      if (pSVar1 != pSVar2) {
         do {
            if (*(long*)( (Segment*)pSVar2 + 0x28 ) == 0) {
               local_64 = (undefined4)local_60;
               local_60 = graphite2::Slot::finalise((Segment*)pSVar2, (Font*)this, (Position*)param_1, (Rect*)&local_60, (uchar)local_58, (float*)0x0, SUB81(&local_64, 0), false, (uint)param_5);
            }
 ...
 while ( ( pSVar2 != (Slot*)0x0 ) && ( pSVar1 != pSVar2 ) );
   ...
   LAB_00100ee1:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
...
/* graphite2::Segment::associateChars(int, unsigned long) */void graphite2::Segment::associateChars(Segment *this, int param_1, ulong param_2) {
   int iVar1;
   long lVar2;
   ulong uVar3;
   code *pcVar4;
 ...
 while ( lVar10 != lVar7 );
   ...
   LAB_00100f71:plVar9 = *(long**)( this + 0x98 );
   iVar13 = 0;
   plVar12 = plVar9;
   if (plVar9 != (long*)0x0) {
      do {
...
/* graphite2::Segment::doMirror(unsigned short) */void graphite2::Segment::doMirror(ushort param_1) {
   short sVar1;
   ushort uVar2;
   long lVar3;
   Segment *pSVar4;
   ...
   do {
      ...
      while (( ( ( lVar3 = *(long*)( *(long*)( lVar5 + 0x88 ) + 0x78 ) * (ushort*)( lVar3 + 0x28 ) <= *(ushort*)( pSVar4 + 0x10 ) || ( lVar3 = graphite2::GlyphCache::glyph((ushort)lVar3) == 0 ) ) || ( uVar2 = graphite2::sparse::operator []((short)lVar3 + 0x18) ),uVar2 == 0 ) ) || ( ( ( ( *(byte*)( lVar5 + 0xc4 ) & 4 ) != 0 && ( lVar3 = *(long*)( *(long*)( lVar5 + 0x88 ) + 0x78 ) * (ushort*)( pSVar4 + 0x10 ) < *(ushort*)( lVar3 + 0x28 ) ) ) && ( ( lVar3 = graphite2::GlyphCache::glyph((ushort)lVar3) ),lVar3 != 0 && ( sVar1 = graphite2::sparse::operator []((short)lVar3 + 0x18) ),sVar1 != 0 ) ) )) {
...
/* graphite2::Segment::initCollisions() */undefined8 graphite2::Segment::initCollisions(Segment *this) {
   void *pvVar1;
   Slot *pSVar2;
...
/* graphite2::Segment::read_text(graphite2::Face const*, graphite2::FeatureVal const*, gr_encform,
   void const*, unsigned long) */undefined8 graphite2::Segment::read_text(Segment *this, long param_1, FeatureVal *param_2, int param_4, ushort *param_5, long param_6) {
   long lVar1;
   long lVar2;
   long *plVar3;
   code *pcVar4;
   ...
   if (*(long*)( this + 0x78 ) != 0) {
      if (param_4 == 2) {
         Vector<graphite2::FeatureVal>::push_back((Vector<graphite2::FeatureVal>*)( this + 0x50 ), param_2);
         ...
         if (param_6 != 0) {
            do {
               ...
               if (( pcVar4 == Cmap::operator [] ) || ( uVar5 = uVar5 == 0 )) {
                  uVar5 = graphite2::Face::findPseudo((uint)param_1);
               }

               lVar9 = lVar9 + 1;
               appendSlot(this, iVar8, uVar7, (uint)uVar5, (int)( lVar1 - lVar2 >> 5 ) + -1, (long)puVar6 - (long)param_5 >> 1);
 ...
 while ( param_6 != lVar9 );
         ...
         Vector<graphite2::FeatureVal>::push_back((Vector<graphite2::FeatureVal>*)( this + 0x50 ), param_2);
         process_utf_data<graphite2::_utf_iterator<unsigned_char_const>>(this, param_1, (int)( *(long*)( this + 0x58 ) - *(long*)( this + 0x50 ) >> 5 ) + -1, param_5, 1, param_6);
      }
...
/* graphite2::Cmap::operator[](unsigned int) const */undefined8 graphite2::Cmap::operator [](uint param_1) {
   return 0;
}
/* graphite2::Segment::newSlot() [clone .part.0] [clone .cold] */void graphite2::Segment::newSlot(void) {
   /* WARNING: Subroutine does not return */
   abort();
}
/* graphite2::Segment::newJustify() [clone .cold] */void graphite2::Segment::newJustify(void) {
   /* WARNING: Subroutine does not return */
   abort();
}
/* graphite2::Segment::associateChars(int, unsigned long) [clone .cold] */void graphite2::Segment::associateChars(int param_1, ulong param_2) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* graphite2::Vector<graphite2::FeatureVal>::push_back(graphite2::FeatureVal const&) */void graphite2::Vector<graphite2::FeatureVal>::push_back(Vector<graphite2::FeatureVal> *this, FeatureVal *param_1) {
   size_t __size;
   long lVar1;
   ulong uVar2;
   ulong uVar3;
   ...
   if (pauVar6 == *(undefined1(**) [16])( this + 0x10 )) {
      ...
      *(long*)( this + 0x10 ) = lVar7;
      ...
      LAB_00101532:*(undefined1(**) [16])( this + 8 ) = pauVar6 + 2;
 ...
 while ( lVar5 != lVar7 - lVar1 );
   ...
   LAB_00101648:/* WARNING: Subroutine does not return */abort();
}
/* void process_utf_data<graphite2::_utf_iterator<unsigned char const> >(graphite2::Segment&,
   graphite2::Face const&, int, graphite2::_utf_iterator<unsigned char const>, unsigned long) */void process_utf_data<graphite2::_utf_iterator<unsigned_char_const>>(Segment *param_1, long param_2, int param_3, byte *param_4, undefined8 param_5, long param_6) {
   long *plVar1;
   code *pcVar2;
   bool bVar3;
   ushort uVar4;
      ...
      do {
         ...
         if (bVar7 == 3) {
            ...
            LAB_001017cb:if (pbVar8[1] >> 6 == 2) {
               ...
               if (bVar7 == bVar11) {
                  LAB_001016cf:if (( uVar5 < 0x110000 ) && ( !bVar3 )) {
                     bVar7 = -bVar11;
                     if (bVar11 != 0) {
                        bVar7 = bVar11;
                     }
         ...
         LAB_00101700:pcVar2 = *(code**)( *plVar1 + 0x10 );
         if (( pcVar2 == graphite2::Cmap::operator [] ) || ( uVar4 = uVar4 == 0 )) {
            uVar4 = graphite2::Face::findPseudo((uint)param_2);
         }

         lVar14 = lVar14 + 1;
         graphite2::Segment::appendSlot(param_1, iVar13, uVar5, (uint)uVar4, param_3, (long)pbVar6 - (long)param_4);
         pbVar6 = pbVar8;
      }

undefined1 *file_settable_ctx_params(void) {
   ...
   if (( param_2 == (long*)0x0 ) || ( *param_2 == 0 )) {
      LAB_001002a0:uVar3 = 1;
   } else {
      if (*(int*)( param_1 + 2 ) == 1) {
         LAB_00100173:lVar2 = OSSL_PARAM_locate_const(param_2, "expect");
         if (lVar2 != 0) {
         ...
         if (lVar2 == 0) {
            LAB_00100129:lVar2 = OSSL_PARAM_locate_const(param_2, "input-type");
            if (lVar2 != 0) {
   ...
   CRYPTO_free(param_1);
   return;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined4 file_load(undefined8 *param_1, code *param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5) {
   byte *pbVar1;
   byte bVar2;
   int iVar3;
   undefined4 uVar4;
   ...
   if (*(int*)( param_1 + 2 ) == 0) {
      ...
      if (lVar10 != 0) {
         ...
         if ((int)lVar10 != 0) {
            ...
            uVar5 = (uint)uVar15;
            if (( ( 0 < (int)uVar5 ) && ( (ulong)(long)(int)uVar5 >> 0x17 == 0x3c ) ) && ( ( uVar5 & 0x7fffff ) == 0x8010c )) {
               ERR_pop_to_mark();
               goto LAB_001006aa;
            }
         }
      ...
      if (lVar10 == 0) {
         ...
         if (iVar3 == 0) {
            ...
            if (iVar3 == 0) {
               ...
               if (( iVar3 != 0 ) && ( iVar3 = OSSL_DECODER_CTX_set_cleanup(param_1[4], file_load_cleanup) ),iVar3 != 0) {
                  lVar10 = param_1[4];
                  goto LAB_001007b8;
               }
               ERR_new();
      ...
      LAB_00100863:ERR_set_debug("providers/implementations/storemgmt/file_store.c", uVar14, "file_setup_decoders");
      ...
      local_58 = 0;
      local_78 = __LC17;
      uStack_70 = _UNK_001012f8;
      local_50 = (undefined1[16])0x0;
      LAB_001003f0:pcVar18 = (char*)param_1[6];
      if (pcVar18 != (char*)0x0) {
         do {
            if (*pcVar18 != '.') {
               sVar6 = strlen((char*)( (long)param_1 + 0x24 ));
               if (*(char*)( (long)param_1 + 0x24 ) == '\0') {
                  LAB_001004a8:pcVar9 = (char*)param_1[1];
                  sVar6 = strlen(pcVar9);
                  if (( *pcVar9 == '\0' ) || ( local_e8 = &_LC10 ),pcVar9[sVar6 - 1] != '/') {
                     sVar6 = sVar6 + 1;
                     local_e8 = &_LC11;
                  }
                  sVar8 = strlen(pcVar18);
                  lVar10 = sVar6 + 1 + sVar8;
                  pcVar9 = (char*)CRYPTO_zalloc(lVar10, "providers/implementations/storemgmt/file_store.c", 0x25b);
                  if (pcVar9 == (char*)0x0) goto LAB_001006a8;
               ...
               if (( ( *(int*)( param_1 + 8 ) - 5U < 2 ) || ( *(int*)( param_1 + 8 ) == 0 ) ) && ( ( iVar3 = OPENSSL_strncasecmp(pcVar18, (char*)( (long)param_1 + 0x24 ), sVar6) ),iVar3 == 0 && ( pcVar18[sVar6] == '.' ) )) {
                  ...
                  if (bVar2 == 0x72) {
                     ...
                     LAB_00100470:ppuVar7 = __ctype_b_loc();
            ...
            iVar3 = *piVar11;
            *(int*)( param_1 + 7 ) = iVar3;
            if (( iVar3 != 0 ) || ( lVar10 != 0 )) goto LAB_001003f0;
            pcVar18 = (char*)param_1[6];
            *(undefined4*)( param_1 + 4 ) = 1;
   ...
   LAB_001006a8:uVar4 = 0;
   LAB_001006aa:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar4;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
...
}undefined8 file_close(void *param_1) {
   if (*(int*)( (long)param_1 + 0x10 ) == 0) {
      BIO_free(*(BIO**)( (long)param_1 + 0x18 ));
      *(undefined8*)( (long)param_1 + 0x18 ) = 0;
      ...
      if (*(long*)( (long)param_1 + 0x18 ) != 0) {
         OPENSSL_DIR_end((long)param_1 + 0x18);
      }
   }
   CRYPTO_free(*(void**)( (long)param_1 + 8 ));
   if (*(int*)( (long)param_1 + 0x10 ) != 1) {
   ...
   CRYPTO_free(param_1);
   return 1;
}undefined8 *file_open(undefined8 param_1, char *param_2) {
   int iVar1;
   BIO *a;
   undefined8 *puVar2;
   char *pcVar3;
   ...
   if (iVar1 == 0) {
      pcVar3 = param_2 + 5;
      lVar7 = 2;
      iVar1 = OPENSSL_strncasecmp(pcVar3, &_LC20, 2);
      lVar6 = 1;
      if (iVar1 == 0) {
         pcVar3 = param_2 + 7;
         iVar1 = OPENSSL_strncasecmp(pcVar3, "localhost/", 10);
         if (iVar1 == 0) {
            pcVar3 = param_2 + 0x10;
         } else {
            iVar1 = OPENSSL_strncasecmp(pcVar3, &_LC11, 1);
            if (iVar1 != 0) {
               ERR_clear_last_mark();
               ERR_new();
      ...
      local_f0[lVar6 * 0x10] = local_f0[lVar6 * 0x10] | 1;
      *(char**)( local_f0 + lVar6 * 0x10 + -8 ) = pcVar3;
   }
   lVar6 = 0;
   do {
      if (( ( local_f0[lVar6 * 0x10] & 1 ) != 0 ) && ( pcVar3 = *(char**)( local_f0 + lVar6 * 0x10 + -8 ) * pcVar3 != '/' )) {
         ERR_clear_last_mark();
         ERR_new();
         ERR_set_debug("providers/implementations/storemgmt/file_store.c", 0x102, "file_open");
         ERR_set_error(0x39, 0xdb, "Given path=%s", pcVar3);
         goto LAB_00100d8d;
      }
      pcVar3 = *(char**)( local_f0 + lVar6 * 0x10 + -8 );
      iVar1 = stat(pcVar3, &local_d8);
      if (-1 < iVar1) {
         ERR_pop_to_mark();
         if (( local_d8.st_mode & 0xf000 ) == 0x4000) {
            puVar2 = (undefined8*)CRYPTO_zalloc(0x48, "providers/implementations/storemgmt/file_store.c", 0x80);
            if (puVar2 == (undefined8*)0x0) {
               LAB_00100f7e:ERR_new();
               ERR_set_debug("providers/implementations/storemgmt/file_store.c", 0xae, "file_open_dir");
               ERR_set_error(0x39, 0x80039, 0);
               goto LAB_00100d8d;
            }
            if (param_2 != (char*)0x0) {
               pcVar4 = CRYPTO_strdup(param_2, "providers/implementations/storemgmt/file_store.c", 0x81);
               puVar2[1] = pcVar4;
               if (pcVar4 == (char*)0x0) {
                  free_file_ctx_part_0(puVar2);
                  goto LAB_00100f7e;
               }
            }
            *(undefined4*)( puVar2 + 2 ) = 1;
            *puVar2 = param_1;
            lVar7 = OPENSSL_DIR_read(puVar2 + 3, pcVar3);
            puVar2[6] = lVar7;
            piVar5 = __errno_location();
            iVar1 = *piVar5;
            *(int*)( puVar2 + 7 ) = iVar1;
            if (lVar7 != 0) goto LAB_00100cc8;
            if (iVar1 == 0) {
            ...
            ERR_set_error(2, *(undefined4*)( puVar2 + 7 ), "Calling OPENSSL_DIR_read(\"%s\")", pcVar3);
            file_close(puVar2);
         } else {
            a = BIO_new_file(pcVar3, "rb");
            if (a != (BIO*)0x0) {
               puVar2 = (undefined8*)CRYPTO_zalloc(0x48, "providers/implementations/storemgmt/file_store.c", 0x80);
               if (puVar2 != (undefined8*)0x0) {
                  if (param_2 != (char*)0x0) {
                     pcVar3 = CRYPTO_strdup(param_2, "providers/implementations/storemgmt/file_store.c", 0x81);
                     puVar2[1] = pcVar3;
                     if (pcVar3 == (char*)0x0) {
                        free_file_ctx_part_0(puVar2);
                        goto LAB_00100ea8;
      ...
      lVar6 = lVar6 + 1;
      piVar5 = __errno_location();
      ERR_set_error(2, *piVar5, "calling stat(%s)", pcVar3);
   } while ( lVar6 != lVar7 );
   ERR_clear_last_mark();
   LAB_00100d8d:puVar2 = (undefined8*)0x0;
   LAB_00100cc8:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return puVar2;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();

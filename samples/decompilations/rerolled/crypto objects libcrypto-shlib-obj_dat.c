void lh_ADDED_OBJ_hfn_thunk(undefined8 param_1, code *UNRECOVERED_JUMPTABLE) {
   for (int i_1193 = 0; i_1193 < 2; i_1193++) {
   ...
   for (int i_1194 = 0; i_1194 < 2; i_1194++) {
   ...
   for (int i_1195 = 0; i_1195 < 2; i_1195++) {
   ...
   for (int i_1196 = 0; i_1196 < 2; i_1196++) {
   ...
   *piVar1 = *piVar1 + -1;
      ...
      if (iVar2 == 0) {
         ...
         if (0 < iVar2) {
            ...
            do {
               bVar1 = *pbVar6;
               pbVar6 = pbVar6 + 1;
               uVar7 = uVar7 ^ (long)(int)( (uint)bVar1 << ( (char)uVar8 + (char)( uVar8 / 0x18 ) * -0x18 & 0x1fU ) );
               uVar4 = (uint)uVar7;
   ...
   if (( iVar1 - *(int*)( nid_objs + ( ulong ) * param_2 * 0x28 + 0x14 ) == 0 ) && ( iVar1 != 0 )) {
      iVar1 = memcmp(*(void**)( *param_1 + 0x18 ), *(void**)( nid_objs + ( ulong ) * param_2 * 0x28 + 0x18 ), (long)iVar1);
      return iVar1;
   }
   ...
   if (a != (ASN1_OBJECT*)0x0) {
      ...
      if (pvVar5 == (void*)0x0) {
         LAB_001004df:plVar8 = (long*)local_88;
      } else {
         ...
         LAB_00100540:uVar7 = OPENSSL_LH_new(added_obj_hash, added_obj_cmp);
         added = OPENSSL_LH_set_thunks(uVar7, 0x100000, lh_ADDED_OBJ_cfn_thunk, lh_ADDED_OBJ_doall_thunk, lh_ADDED_OBJ_doall_arg_thunk);
         if (added != 0) goto LAB_001003dc;
         ERR_new();
         ERR_set_debug("crypto/objects/obj_dat.c", 0x120, "ossl_obj_add_object");
         ERR_set_error(8, 0x8000f, 0);
         LAB_00100660:plVar8 = (long*)local_88;
         if (param_2 != 0) {
            CRYPTO_THREAD_unlock(ossl_obj_lock);
         }
      }
   ...
   iVar4 = 0;
   LAB_00100467:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar4;
   }
   ...
   lVar2 = 0;
   if (( n == 0 ) || ( ( n - 1U < 0x5ce && ( lVar2 = (long)n * (int*)( nid_objs + lVar2 * 0x28 + 0x10 ) != 0 ) ) )) {
   ...
   LAB_00100830:if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return pAVar3;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   ERR_set_error(8, 0xc010f, 0);
   LAB_00100960:if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar1;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   ERR_set_error(8, 0xc010f, 0);
   LAB_00100ab0:if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar1;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   LAB_00100c18:iVar1 = a2d_ASN1_OBJECT((uchar*)0x0, 0, s, -1);
   if (iVar1 < 1) {
      LAB_00100d20:pAVar2 = (ASN1_OBJECT*)0x0;
   } else {
   ...
   LAB_00100d24:/* WARNING: Subroutine does not return */__stack_chk_fail();
   ...
   if (sn == (char*)0x0 && oid == (char*)0x0) {
      if (ln == (char*)0x0) {
         ...
         LAB_00100f08:a = ASN1_OBJECT_new();
      ...
      LAB_00100e08:OPENSSL_init_crypto(0x40, 0);
      iVar2 = CRYPTO_THREAD_run_once(&ossl_obj_lock_init, obj_lock_initialise_ossl_);
      if (( ( iVar2 != 0 ) && ( obj_lock_initialise_ossl_ret_ != 0 ) ) && ( iVar2 = iVar2 != 0 )) {
         if (oid == (char*)0x0) {
            LAB_00100e67:iVar2 = new_nid_7;
            LOCK();
            UNLOCK();
            iVar1 = new_nid_7 + 1;
            a->nid = new_nid_7;
            ...
            if (a->nid == 0) {
               if (a->length != 0) {
                  ...
                  if (puVar3 == (uint*)0x0) {
                     ...
                     LAB_00100fc0:if (iVar2 != 0) goto LAB_00100fd0;
                  }
               }
               goto LAB_00100e67;
            }
            LAB_00100fd0:ERR_new();
            ERR_set_debug("crypto/objects/obj_dat.c", 0x334, "OBJ_create");
            ERR_set_error(8, 0x66, 0);
            LAB_00100e7c:iVar2 = 0;
         }
         CRYPTO_THREAD_unlock(ossl_obj_lock);
         ASN1_OBJECT_free(a);
         goto LAB_00100da8;
      ...
      LAB_00100d76:ERR_new();
      ERR_set_debug("crypto/objects/obj_dat.c", 0x319, "OBJ_create");
      ERR_set_error(8, 0x66, 0);
   }
   LAB_00100da6:iVar2 = 0;
   LAB_00100da8:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return iVar2;
   ...
   iVar4 = 0;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   LAB_00101098:iVar2 = BIO_gets(in, local_248, 0x200);
   if (0 < iVar2) {
      local_248[iVar2 + -1] = '\0';
      ...
      if (iVar2 != 0) {
         ...
         if (*sn != '\0') {
            *sn = '\0';
            ...
            pcVar3 = sn;
            if (cVar1 != '\0') {
               LAB_00101165:iVar2 = ossl_ctype_check((int)cVar1, 8);
   ...
   LAB_001011b0:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return iVar4;
   LAB_00101158:cVar1 = pcVar3[1];
   pcVar3 = pcVar3 + 1;
   if (cVar1 == '\0') goto LAB_001011a3;
   goto LAB_00101165;
   LAB_001011a3:ln = (char*)0x0;
   LAB_001010f6:if (( local_248[0] == '\0' ) || ( iVar2 = iVar2 == 0 )) goto LAB_001011b0;
   iVar4 = iVar4 + 1;
   goto LAB_00101098;
   ...
   iVar4 = 0;
   LAB_00101268:if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar4;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   if (( a == (ASN1_OBJECT*)0x0 ) || ( pbVar3 = a->data ),pbVar3 == (byte*)0x0) {
      ...
      if (no_name == 0) {
         iVar9 = OBJ_obj2nid(a);
         if (( iVar9 != 0 ) && ( ( pcVar4 = OBJ_nid2ln(iVar9) ),pcVar4 != (char*)0x0 || ( pcVar4 = OBJ_nid2sn(iVar9) ),pcVar4 != (char*)0x0 )) {
            if (buf != (char*)0x0) {
      ...
      if (iVar9 < 0x24b) {
         ...
         local_80 = 0;
         LAB_001017c8:BN_free(a_00);
      } else {
         LAB_00101551:a_00 = (BIGNUM*)0x0;
         LAB_0010149f:BN_free(a_00);
         local_80 = -1;
      }
   }
   LAB_001014af:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return local_80;
   code_r0x001014f1:if (bVar7) {
      if (w < 0x50) {
         LAB_001015e6:cVar8 = (char)( w / 0x28 );
         w = w - ( -(int)(w / 0x28) & 0x28 );
      } else {
      ...
      LAB_00101601:if (( local_78 != (char*)0x0 ) && ( 1 < local_7c )) {
         local_7c = local_7c + -1;
         local_78[1] = '\0';
         *local_78 = cVar8 + '0';
         local_78 = local_78 + 1;
      ...
      local_80 = local_80 + 1;
      if (!bVar7) {
         LAB_001016df:BIO_snprintf(local_68, 0x25, ".%lu", w);

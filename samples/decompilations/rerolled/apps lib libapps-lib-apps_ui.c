void ui_prompt_construct(UI *param_1, char *param_2, char *param_3) {
   ...
   if ((code*)CONCAT44(extraout_var, iVar1) != (code*)0x0) {
      for (int i_1612 = 0; i_1612 < 2; i_1612++) {
   ...
   if (( ( ( ( uVar1 & 2 ) != 0 ) && ( pvVar4 = UI_get0_user_data(param_1) ),pvVar4 != (void*)0x0 ) ) && ( UVar2 = UI_get_string_type(param_2) ),UVar2 - UIT_PROMPT < 2) {
      return 1;
   }
   ...
   for (int i_1613 = 0; i_1613 < 2; i_1613++) {
   ...
   if ((code*)CONCAT44(extraout_var, iVar3) != (code*)0x0) {
      for (int i_1614 = 0; i_1614 < 2; i_1614++) {
   ...
   result = "";
   LAB_00100167:UI_set_result(param_1, param_2, result);
   return 1;
   ...
   if ((code*)CONCAT44(extraout_var, iVar1) != (code*)0x0) {
      for (int i_1615 = 0; i_1615 < 2; i_1615++) {
   ...
   if (( ( ( ui_method != (UI_METHOD*)0x0 ) && ( iVar1 = UI_method_set_opener(ui_method, ui_open) ),iVar1 == 0 ) ) && ( iVar1 = iVar1 == 0 )) {
   ...
   return ui_method;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */ulong password_callback(char *param_1, uint param_2, int param_3, void *param_4) {
   int iVar1;
   int iVar2;
   UI *ui_method;
   char *pcVar3;
   ...
   if (ui_method != (UI*)0x0) {
      ...
      if (pcVar3 != (char*)0x0) {
         ...
         LAB_00100475:UI_free(ui_method);
         CRYPTO_free(pcVar3);
         return uVar5;
      }

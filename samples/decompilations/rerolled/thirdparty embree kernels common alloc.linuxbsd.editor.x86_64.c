   ...
   *(long*)( this + 0x10 ) = lVar10;
   ...
   if (this == (MutexSys*)0x0) {
      ...
      *(MutexSys**)( this + 0x40 ) = this;
      for (int i_864 = 0; i_864 < 6; i_864++) {
         *(undefined8*)( this + ( 8*i_864 + 72 ) ) = 0;
      }
      *(MutexSys**)( this + 0x80 ) = this;
      for (int i_865 = 0; i_865 < 6; i_865++) {
         *(undefined8*)( this + ( 8*i_865 + 136 ) ) = 0;
      }

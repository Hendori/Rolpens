...
/* GLES3::TextureStorage::render_target_get_render_region(RID) const */undefined1[16];GLES3::TextureStorage::render_target_get_render_region (TextureStorage *this,ulong param_2) {
   int iVar1;
   long lVar2;
   if (( param_2 != 0 ) && ( (uint)param_2 < *(uint*)( this + 0x194 ) )) {
      lVar2 = ( ( param_2 & 0xffffffff ) % ( ulong ) * (uint*)( this + 400 ) ) * 0xf0 + *(long*)( *(long*)( this + 0x180 ) + ( ( param_2 & 0xffffffff ) / ( ulong ) * (uint*)( this + 400 ) ) * 8 );
...
/* GLES3::TextureStorage::render_target_get_clear_request_color(RID) */undefined1[16];GLES3::TextureStorage::render_target_get_clear_request_color (TextureStorage *this,ulong param_2) {
   int iVar1;
   long lVar2;
   if (( param_2 != 0 ) && ( (uint)param_2 < *(uint*)( this + 0x194 ) )) {
      lVar2 = ( ( param_2 & 0xffffffff ) % ( ulong ) * (uint*)( this + 400 ) ) * 0xf0 + *(long*)( *(long*)( this + 0x180 ) + ( ( param_2 & 0xffffffff ) / ( ulong ) * (uint*)( this + 400 ) ) * 8 );
...
/* GLES3::TextureStorage::render_target_free(RID) */undefined1[16];GLES3::TextureStorage::render_target_free (TextureStorage *this,ulong param_2) {
   long *plVar1;
   int iVar2;
   int iVar3;
   ulong uVar4;
...
LAB_0010e4e8:
      ...
      *(undefined8 *)param_1 = 0;
      ...
      if (local_58 == (Object*)0x0) {
         ...
         if (pIVar7 != pIVar12) {
            local_68 = pIVar7;
            if (( pIVar7 != (Image*)0x0 ) && ( cVar4 = RefCounted::reference() ),cVar4 == '\0') goto LAB_0010df6d;
            goto LAB_0010df76;
         }
   ...
   if (( param_2 != 0 ) && ( (uint)param_2 < *(uint*)( this + 0xf4 ) )) {
      ...
      if (*(int*)( lVar14 + 0xe8 ) == (int)( param_2 >> 0x20 )) {
         if (*(int*)( lVar14 + 0x5c ) != 0x806f) {
            ...
            local_81 = '\0';
            if (( ( (char)RasterizerGLES3::gles_over_gl == '\0' ) && ( *(int*)( lVar14 + 0x5c ) == 0x8c1a ) ) && ( ( iVar4 = Image::get_format() ),iVar4 == 0x14 || ( iVar4 = Image::get_format() ),iVar4 == 0x15 )) {
               uVar12 = 1;
            }
            ...
            if (*(char*)( lVar14 + 0x71 ) != '\0') {
               ...
               if ((Image*)*param_3 == pIVar15) {
                  ...
                  if (local_58 == (Object*)0x0) {
                     ...
                     if (pIVar15 != pIVar7) {
                        local_70 = pIVar7;
                        if (( pIVar7 != (Image*)0x0 ) && ( cVar2 = RefCounted::reference() ),cVar2 == '\0') goto LAB_0010f04f;
                        goto LAB_0010f058;
                     }
 ...
 while ( true );
               ...
               if (uVar21 < *(uint*)( this + 0xf4 )) {
                  ...
                  if (*(int*)( lVar28 + 0xe8 ) < 0) {
                     ...
                     if (( *(long*)( lVar28 + 0x88 ) != 0 ) && ( cVar12 = RefCounted::unreference() ),cVar12 != '\0') {
 ...
 while ( lVar38 < *(long*)( lVar34 + -8 ) );
                     ...
                     if (uVar41 < *(uint*)( this + 0xf4 )) {
                        ...
                        if (*(int*)( lVar37 + 0xe8 ) < 0) {
                           ...
                           if (( *(long*)( lVar37 + 0x88 ) != 0 ) && ( cVar23 = RefCounted::unreference() ),cVar23 != '\0') {
         ...
         if ((char)RasterizerGLES3::gles_over_gl == '\0') {
            ...
            if (local_80 == 0) {
               ...
               *param_1 = 0;
               ...
               if (cVar2 == '\0') {
                  if (( *(int*)( lVar11 + 0x4c ) != 5 ) && ( cVar2 = Image::is_format_compressed() ),cVar2 == '\0') {
...
;
 ...
 while ( iVar7 < *(int*)( lVar11 + 0x3c ) );
            ...
            if (( *(int*)( lVar11 + 0x4c ) != *(int*)( lVar11 + 0x50 ) ) && ( cVar2 = Image::is_format_compressed() ),cVar2 == '\0') {
               ...
               do {
                  ...
                  if (iVar7 != *(int*)( lVar15 + 0x4c )) {
                     ...
                     if (local_68 == (Object*)0x0) {
                        ...
                        if (pIVar13 != pIVar10) {
                           if (( pIVar10 != (Image*)0x0 ) && ( cVar6 = RefCounted::reference() ),cVar6 == '\0') goto LAB_00114309;
                           goto LAB_0011430c;
                        }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GLES3::TextureStorage::TextureStorage() */void GLES3::TextureStorage::TextureStorage(TextureStorage *this) {
 ...
 while ( iVar23 != 0 );
   ...
   *(undefined8*)( this + 0x300 ) = uVar11;
   ...
   LAB_00116628:if (( pIVar22 != (Image*)0x0 ) && ( cVar9 = RefCounted::unreference() ),cVar9 != '\0') {
      memdelete<Image>(local_198);
   }
         ...
         do {
            ...
            if (0 < iVar9) {
               ...
               do {
                  ...
                  if (( *(int*)( in_RDX + 0x4c ) != 5 ) && ( cVar5 = Image::is_format_compressed() ),cVar5 == '\0') {

undefined8 ssl_ctx_srp_ctx_free_intern(long param_1) {
   ...
   if (param_1 != 0) {
      ...
      for (int i_1892 = 0; i_1892 < 8; i_1892++) {
         BN_free(*(BIGNUM**)( param_1 + ( 8*i_1892 + 872 ) ));
      }
   ...
   if (param_1 != 0) {
      ...
      for (int i_1893 = 0; i_1893 < 8; i_1893++) {
         BN_free(*(BIGNUM**)( param_1 + ( 8*i_1893 + 3064 ) ));
      }
   ...
   *(undefined4*)( param_1 + 0xc40 ) = *(undefined4*)( lVar1 + 0x3b0 );
   ...
   CRYPTO_free(*(void**)( param_1 + 0xc38 ));
   for (int i_1894 = 0; i_1894 < 8; i_1894++) {
      BN_free(*(BIGNUM**)( param_1 + ( 8*i_1894 + 3064 ) ));
   }
   *(undefined8*)( param_1 + 0xbd0 ) = 0;
   puVar7 = (undefined8*)( param_1 + 0xbd8U & 0xfffffffffffffff8 );
   *(undefined8*)( param_1 + 0xc48 ) = 0;
   ...
   *param_2 = 0x50;
   ...
   uVar4 = 0;
   for (int i_1895 = 0; i_1895 < 2; i_1895++) {

undefined8 EC_POINT_set_compressed_coordinates(undefined8 *param_1, undefined8 *param_2) {
   ...
   if (( *(code**)( pbVar1 + 0x88 ) == (code*)0x0 ) && ( ( *pbVar1 & 1 ) == 0 )) {
      ...
      if (( pbVar1 == (byte*)*param_2 ) && ( ( ( *(int*)( param_1 + 4 ) == 0 || ( *(int*)( param_2 + 1 ) == 0 ) ) || ( *(int*)( param_1 + 4 ) == *(int*)( param_2 + 1 ) ) ) )) {
         if (( *pbVar1 & 1 ) == 0) {
            for (int i_2014 = 0; i_2014 < 2; i_2014++) {
   ...
   EC_POINT_set_compressed_coordinates();
   return;
}size_t EC_POINT_point2oct(EC_GROUP *group, EC_POINT *p, point_conversion_form_t form, uchar *buf, size_t len, BN_CTX *ctx) {
   byte *pbVar1;
   size_t sVar2;
   ...
   if (p == (EC_POINT*)0x0) {
      ...
      if (( *(code**)( pbVar1 + 0x90 ) == (code*)0x0 ) && ( ( *pbVar1 & 1 ) == 0 )) {
         ...
         if (( pbVar1 == *(byte**)p ) && ( ( ( *(int*)( group + 0x20 ) == 0 || ( *(int*)( p + 8 ) == 0 ) ) || ( *(int*)( group + 0x20 ) == *(int*)( p + 8 ) ) ) )) {
            if (( *pbVar1 & 1 ) == 0) {
               for (int i_2015 = 0; i_2015 < 2; i_2015++) {
   ...
   if (( *(code**)( pbVar1 + 0x98 ) == (code*)0x0 ) && ( ( *pbVar1 & 1 ) == 0 )) {
      ...
      if (( pbVar1 == *(byte**)p ) && ( ( ( *(int*)( group + 0x20 ) == 0 || ( *(int*)( p + 8 ) == 0 ) ) || ( *(int*)( group + 0x20 ) == *(int*)( p + 8 ) ) ) )) {
         if (( *pbVar1 & 1 ) == 0) {
            for (int i_2016 = 0; i_2016 < 2; i_2016++) {
   ...
   return 0;
}size_t EC_POINT_point2buf(EC_GROUP *param_1, EC_POINT *param_2, point_conversion_form_t param_3, undefined8 *param_4, BN_CTX *param_5) {
   size_t sVar1;
   uchar *buf;
   sVar1 = EC_POINT_point2oct(param_1, param_2, param_3, (uchar*)0x0, 0, (BN_CTX*)0x0);
   if (( sVar1 != 0 ) && ( buf = (uchar*)CRYPTO_malloc((int)sVar1, "crypto/ec/ec_oct.c", 0x93) ),buf != (uchar*)0x0) {

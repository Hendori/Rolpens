...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int callback_copy_password(undefined1 (*param_1)[16], int param_2) {
   undefined8 uVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   undefined8 uVar4;
...
undefined8 write_callback(undefined8 param_1, undefined4 param_2, undefined4 param_3, char *param_4) {
   ...
   if (iVar1 != 0) {
      iVar1 = test_char_eq("test/bio_pw_callback_test.c", 0x8c, "cb_data->magic", "cb_magic", (int)*param_4, 0x70);
      if (iVar1 != 0) {
...
undefined8 read_callback(undefined8 param_1, undefined4 param_2, undefined4 param_3, char *param_4) {
   ...
   if (iVar1 != 0) {
      iVar1 = test_char_eq("test/bio_pw_callback_test.c", 0x76, "cb_data->magic", "cb_magic", (int)*param_4, 0x70);
      if (iVar1 != 0) {
...
undefined8 full_cycle_test(int param_1, undefined4 param_2, undefined4 param_3, int param_4) {
   ...
   if (( iVar1 == 0 ) || ( iVar1 = test_ptr("test/bio_pw_callback_test.c", 0xa5, "enc_data_size", &local_5c) ),iVar1 == 0) {
      ...
      if (iVar1 != 0) {
         ...
         if (param_1 == 1) {
            ...
            iVar1 = i2d_PKCS8PrivateKey_bio(pBVar2, original_pkey, pEVar3, (char*)0x0, 0, write_callback, local_48);
         }
 else {
            pEVar3 = EVP_aes_256_cbc();
            iVar1 = PEM_write_bio_PrivateKey(pBVar2, original_pkey, pEVar3, (uchar*)0x0, 0, write_callback, local_48);
         }

         local_70 = local_48;
         iVar1 = test_int_ne("test/bio_pw_callback_test.c", 0xb5, "w_ret", &_LC8, iVar1, 0);
         if (( ( iVar1 != 0 ) && ( iVar1 = test_char_eq("test/bio_pw_callback_test.c", 0xb7, "cb_data.magic", "cb_magic", (int)local_48[0], 0x70) ),iVar1 != 0 )) {
            ...
            if ((int)lVar4 != 0) {
               *(char**)&local_50->references = (char*)0x0;
               ...
               iVar1 = test_ptr("test/bio_pw_callback_test.c", 0xd1, "bio = BIO_new_mem_buf(enc_data, enc_data_size)", pBVar2);
               if (iVar1 != 0) {
                  local_48[0] = 'p';
                  local_44 = 0;
                  if (param_1 == 1) {
                  ...
                  if (( ( iVar1 != 0 ) && ( iVar1 = test_char_eq("test/bio_pw_callback_test.c", 0xe4, "cb_data.magic", "cb_magic", (int)local_48[0], 0x70) ),iVar1 != 0 )) {
   ...
   LAB_0010039e:uVar6 = 0;
   LAB_001003a0:CRYPTO_free(local_58);
   ...
   do {
      ...
      while (true) {
         if (iVar1 == 0) {
            ...
            pEVar2 = PEM_read_bio_PrivateKey(bp, (EVP_PKEY**)&original_pkey, callback_original_pw, (void*)0x0);
            iVar1 = test_ptr("test/bio_pw_callback_test.c", 0x176, "PEM_read_bio_PrivateKey(bio, &original_pkey, callback_original_pw, NULL)", pEVar2);
            if (iVar1 == 0) {
               return 0;
            }

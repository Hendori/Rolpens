...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<unsigned int, LocalVector<gd::Edge::Connection, unsigned int, false, false>,
   ...
   int, false, false> > > >::operator[](unsigned int const&) */undefined1[16];HashMap<unsigned_int,LocalVector<gd::Edge::Connection,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,LocalVector<gd::Edge::Connection,unsigned_int,false,false>>>>::operator [](HashMap<unsigned_int,LocalVector<gd::Edge::Connection,unsigned_int,false,false>,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,LocalVector<gd::Edge::Connection,unsigned_int,false,false>>>>
             *this,uint*param_1)

{
  ...
  undefined1 auVar57[16](ulong)(local_68 = = (void*)0x0) {
   uVar40 = uVar51 * 4;
   uVar48 = uVar51 * 8;
...
uVar38 = *param_1;pauVar42 = (undefined1(*) [16])operator_new(0x28, "");*(undefined8*)pauVar42[2] = 0;*(uint*)pauVar42[1] = uVar38;*(undefined8*)( pauVar42[1] + 8 ) = 0;*pauVar42 = (undefined1[16])0x0;puVar2 = *(undefined8**)( this + 0x20 );if (puVar2 == (undefined8*)0x0) {
...
*(undefined1(**) [16])( this + 0x20 ) = pauVar42;uVar38 = ( *param_1 >> 0x10 ^ *param_1 ) * -0x7a143595;uVar39 = ( uVar38 ^ uVar38 >> 0xd ) * -0x3d4d51cb;uVar38 = uVar39 ^ uVar39 >> 0x10;if (uVar39 == uVar39 >> 0x10) {
   uVar40 = 1;
   uVar38 = 1;
}
 else {
...
uVar53 = 0;lVar52 = *(long*)( this + 0x10 );uVar39 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );uVar51 = CONCAT44(0, uVar39);lVar46 = *(long*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( this + 0x28 ) * 8 );auVar12._8_8_ = 0;auVar12._0_8_ = uVar40 * lVar46;auVar28._8_8_ = 0;auVar28._0_8_ = uVar51;lStack_98 = SUB168(auVar12 * auVar28, 8);lVar47 = *(long*)( this + 8 );puVar1 = (uint*)( lVar52 + lStack_98 * 4 );iVar44 = SUB164(auVar12 * auVar28, 8);uVar37 = *puVar1;pauVar36 = pauVar42;while (uVar37 != 0) {
   auVar13._8_8_ = 0;

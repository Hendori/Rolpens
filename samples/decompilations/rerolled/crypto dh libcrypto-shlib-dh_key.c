undefined8 dh_init(long param_1) {
   ...
   *(long*)( param_1 + 200 ) = *(long*)( param_1 + 200 ) + 1;
   ...
   if (iVar1 < 0x2711) {
      if (( *(BIGNUM**)( param_3 + 0x10 ) == (BIGNUM*)0x0 ) || ( iVar1 = iVar1 < 0x2711 )) {
         iVar1 = BN_num_bits(*(BIGNUM**)( param_3 + 8 ));
         if (iVar1 < 0x200) {
            ERR_new();
            ...
            if (a_00 != (BIGNUM*)0x0) {
               ...
               if (lVar6 == 0) {
                  ...
                  if (( *(byte*)( param_3 + 0x80 ) & 1 ) != 0) {
                     pBVar5 = BN_MONT_CTX_set_locked((BN_MONT_CTX**)( param_3 + 0x88 ), (int)*(undefined8*)( param_3 + 0xc0 ), pBVar4, ctx);
                     BN_set_flags(*(undefined8*)( param_3 + 0x78 ), 4);
                     if (pBVar5 == (BN_MONT_CTX*)0x0) goto LAB_001002e0;
                     lVar6 = *(long*)( param_3 + 0x78 );
                     pBVar4 = *(BIGNUM**)( param_3 + 8 );
                  }
                  iVar1 = ( **(code**)( *(long*)( param_3 + 0xb8 ) + 0x18 ) )(param_3, a_00, param_2, lVar6, pBVar4, ctx);
                  if (iVar1 == 0) {
                     ERR_new();
                     ...
                     if (( pBVar4 != (BIGNUM*)0x0 ) && ( iVar1 = iVar1 != 0 )) {
                        pBVar4 = BN_value_one();
                        iVar1 = BN_cmp(a_00, pBVar4);
                        if (( 0 < iVar1 ) && ( iVar1 = iVar1 != 0 )) {
   ...
   return 1;
}void dh_bn_mod_exp(undefined8 param_1, BIGNUM *param_2, BIGNUM *param_3, BIGNUM *param_4, BIGNUM *param_5, BN_CTX *param_6, BN_MONT_CTX *param_7) {
   ...
   return iVar3;
}/* WARNING: Unknown calling convention -- yet parameter storage is locked */DH_METHOD *DH_OpenSSL(void) {
   return (DH_METHOD*)dh_ossl;
}/* WARNING: Unknown calling convention -- yet parameter storage is locked */DH_METHOD *DH_get_default_method(void) {
   ...
   if (( *(byte*)( param_2 + 0x80 ) & 1 ) == 0) {
      ...
      pBVar2 = BN_MONT_CTX_set_locked((BN_MONT_CTX**)( param_2 + 0x88 ), (int)*(undefined8*)( param_2 + 0xc0 ), *(BIGNUM**)( param_2 + 8 ), param_1);
   ...
   iVar1 = ( **(code**)( *(long*)( param_2 + 0xb8 ) + 0x18 ) )(param_2, param_4, *(undefined8*)( param_2 + 0x18 ), a, *(undefined8*)( param_2 + 8 ), param_1, pBVar2);
   bVar3 = iVar1 != 0;
   LAB_00100588:BN_clear_free(a);
   return bVar3;
   ...
   if (( *(BIGNUM**)( param_1 + 0x10 ) != (BIGNUM*)0x0 ) && ( iVar2 = 10000 < iVar2 )) {
      ERR_new();
   ...
   if (c == (BN_CTX*)0x0) {
      ...
      if (a == (BIGNUM*)0x0) {
         ...
         if (( a_00 != (BIGNUM*)0x0 ) || ( a_00 = BN_new() ),a_00 != (BIGNUM*)0x0) {
            ...
            if (iVar2 == 0) {
               if (*(long*)( param_1 + 0x10 ) == 0) {
                  ...
                  if (iVar2 == 0) {
                     LAB_001008a1:iVar2 = BN_num_bits(a_01);
                     iVar2 = iVar2 + -1;
                  } else {
                  ...
                  if (iVar2 != 0) {
                     ...
                     if (( iVar2 == 0 ) || ( iVar2 = iVar2 != 0 )) goto LAB_00100664;
               ...
               if (( *(BIGNUM**)( param_1 + 0x10 ) != (BIGNUM*)0x0 ) && ( iVar2 = *(int*)( param_1 + 0x68 ) ),iVar3 = BN_num_bits(*(BIGNUM**)( param_1 + 0x10 )),iVar2 <= iVar3) {
                  iVar2 = ossl_ffc_generate_private_key(c, param_1 + 8, *(undefined4*)( param_1 + 0x68 ), uVar1, a);
                  joined_r0x00100827:if (iVar2 != 0) goto LAB_00100664;
               }
            }
         }
      } else {
         ...
         LAB_00100664:iVar2 = ossl_dh_generate_public_key(c, param_1, a, a_00);
         if (iVar2 != 0) {
            *(long*)( param_1 + 200 ) = *(long*)( param_1 + 200 ) + 1;
   ...
   BN_free(a);
   uVar2 = 0;
   LAB_00100a4e:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
   ...
   uVar3 = 0;
   LAB_00100b18:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar3;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();

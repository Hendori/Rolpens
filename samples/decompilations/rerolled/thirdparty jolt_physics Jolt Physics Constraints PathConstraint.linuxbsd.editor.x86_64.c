/* JPH::PathConstraint::NotifyShapeChanged(JPH::BodyID const&, JPH::Vec3) */void JPH::PathConstraint::NotifyShapeChanged(undefined8 param_1_00, float param_2, long param_1, int *param_4) {
   float fVar1;
   fVar1 = (float)( (ulong)param_1_00 >> 0x20 );
   if (*(int*)( *(long*)( param_1 + 0x28 ) + 0x70 ) == *param_4) {
      *(undefined4*)( param_1 + 0x7c ) = 0x3f800000;
      *(ulong*)( param_1 + 0x70 ) = CONCAT44(*(float*)( param_1 + 0x74 ) - fVar1, *(float*)( param_1 + 0x70 ) - (float)param_1_00);
   ...
   *(ulong*)( param_1 + 0xb0 ) = CONCAT44(*(float*)( param_1 + 0xb4 ) - fVar1, *(float*)( param_1 + 0xb0 ) - (float)param_1_00);
   *(float*)( param_1 + 0xb8 ) = *(float*)( param_1 + 0xb8 ) - param_2;
   return;
}
/* JPH::PathConstraintSettings::sCreateRTTI(JPH::RTTI&) */void JPH::PathConstraintSettings::sCreateRTTI(RTTI *param_1) {
   int iVar1;
   iVar1 = JPH::GetRTTIOfType((TwoBodyConstraintSettings*)0x0);
   JPH::RTTI::AddBaseClass(param_1, iVar1);
   return;
}
/* JPH::PathConstraintSettings::SaveBinaryState(JPH::StreamOut&) const */void JPH::PathConstraintSettings::SaveBinaryState(PathConstraintSettings *this, StreamOut *param_1) {
...
/* JPH::PathConstraint::SaveState(JPH::StateRecorder&) const */void JPH::PathConstraint::SaveState(PathConstraint *this, StateRecorder *param_1) {
...
/* JPH::PathConstraint::RestoreState(JPH::StateRecorder&) */void JPH::PathConstraint::RestoreState(PathConstraint *this, StateRecorder *param_1) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* _FUN() */void JPH::GetRTTIOfType(JPH::PathConstraintSettings *) {
   lambda()
   #1
   {
      undefined8 uVar1;
   ...
   PathConstraint * __thiscallJPH::PathConstraint::GetConstraintSettings(PathConstraint * this);
   {
      *(undefined8*)this = 0;
      return this;
   }
   ...
   [clone .isra.0] */
   undefined8 JPH::AxisConstraintPart::SolveVelocityConstraint(undefined8 param_1_00, undefined8 param_2_00, float param_3, float param_4, float *param_1, float *param_2, char param_7, float *param_8, char param_9) {
      byte bVar1;
      bool bVar2;
      bool bVar3;
      bool bVar4;
      ...
      if (param_7 == '\x01') {
         ...
         fVar26 = param_8[0x16];
         fVar27 = param_1[0xf];
         fVar13 = ( ( ( (float)*(undefined8*)( param_2 + 6 ) * param_1[2] + (float)( ( ulong ) * (undefined8*)( param_2 + 4 ) >> 0x20 ) * param_1[1] + (float)*(undefined8*)( param_2 + 4 ) * *param_1 + 0.0 + ( param_2[2] - fVar17 ) * fVar19 + ( param_2[1] - fVar16 ) * fStack_14 + ( *param_2 - fVar14 ) * local_18 + 0.0 ) - ( (float)( ( ulong ) * (undefined8*)( param_8 + 4 ) >> 0x20 ) * param_1[4] + (float)*(undefined8*)( param_8 + 4 ) * param_1[3] + 0.0 + (float)*(undefined8*)( param_8 + 6 ) * param_1[5] ) ) - ( param_1[0xe] * fVar27 + param_1[0xd] ) ) * param_1[0xc] + fVar27;
         if (param_3 <= fVar13) {
            param_3 = fVar13;
         }
         ...
         if (param_7 == '\x02') {
            if (param_9 == '\x01') {
               ...
               fVar26 = param_2[0x16];
               fVar27 = param_1[0xf];
               fVar13 = ( ( ( (float)*(undefined8*)( param_2 + 6 ) * param_1[2] + (float)( ( ulong ) * (undefined8*)( param_2 + 4 ) >> 0x20 ) * param_1[1] + (float)*(undefined8*)( param_2 + 4 ) * *param_1 + 0.0 + ( fVar17 - param_8[2] ) * fVar19 + ( fVar16 - param_8[1] ) * fStack_14 + ( fVar14 - *param_8 ) * local_18 + 0.0 ) - ( (float)( ( ulong ) * (undefined8*)( param_8 + 4 ) >> 0x20 ) * param_1[4] + (float)*(undefined8*)( param_8 + 4 ) * param_1[3] + 0.0 + (float)*(undefined8*)( param_8 + 6 ) * param_1[5] ) ) - ( param_1[0xe] * fVar27 + param_1[0xd] ) ) * param_1[0xc] + fVar27;
               if (param_3 <= fVar13) {
                  param_3 = fVar13;
               }
               ...
               *param_2 = (float)( ( uint )(fVar14 - fVar26 * local_18) & -(uint)(auVar21._0_4_ == __LC7) );
               ...
               if (param_9 == '\x02') {
                  ...
                  fVar27 = param_2[0x16];
                  fVar14 = param_1[0xf];
                  fVar15 = ( ( ( (float)*(undefined8*)( param_2 + 6 ) * param_1[2] + (float)( ( ulong ) * (undefined8*)( param_2 + 4 ) >> 0x20 ) * param_1[1] + (float)*(undefined8*)( param_2 + 4 ) * *param_1 + 0.0 + ( fVar18 - param_8[2] ) * fVar19 + ( fVar17 - param_8[1] ) * fStack_14 + ( fVar16 - *param_8 ) * local_18 + 0.0 ) - ( (float)( ( ulong ) * (undefined8*)( param_8 + 4 ) >> 0x20 ) * param_1[4] + (float)*(undefined8*)( param_8 + 4 ) * param_1[3] + 0.0 + (float)*(undefined8*)( param_8 + 6 ) * param_1[5] ) ) - ( param_1[0xe] * fVar14 + param_1[0xd] ) ) * param_1[0xc] + fVar14;
                  if (param_3 <= fVar15) {
                     param_3 = fVar15;
                  }
                  ...
                  if (param_4 != 0.0) {
                     ...
                     *param_8 = (float)( ( uint )(local_18 * fVar26 + *param_8) & -(uint)(auVar22._0_4_ == iVar9) );
                     param_8[1] = (float)( ( uint )(fStack_14 * fVar26 + param_8[1]) & -(uint)(auVar22._4_4_ == iVar10) );
                     param_8[2] = (float)( ( uint )(fVar19 * fVar26 + param_8[2]) & -(uint)(auVar22._8_4_ == iVar11) );
                     param_8[3] = (float)( ( uint )(fVar23 * fVar26 + param_8[3]) & -(uint)(auVar22._12_4_ == iVar12) );
                     fVar19 = param_1[10];
                     fVar23 = param_1[0xb];
                     fVar26 = param_1[0xc];
               ...
               fVar26 = param_2[0x16];
               fVar27 = param_1[0xf];
               fVar14 = ( ( (float)*(undefined8*)( param_2 + 6 ) * param_1[2] + (float)( ( ulong ) * (undefined8*)( param_2 + 4 ) >> 0x20 ) * param_1[1] + (float)*(undefined8*)( param_2 + 4 ) * *param_1 + 0.0 + fVar19 * (float)*(undefined8*)( param_2 + 2 ) + fStack_14 * (float)( ( ulong ) * (undefined8*)param_2 >> 0x20 ) + local_18 * (float)*(undefined8*)param_2 + 0.0 ) - ( param_1[0xe] * fVar27 + param_1[0xd] ) ) * param_1[0xc] + fVar27;
               if (param_3 <= fVar14) {
                  param_3 = fVar14;
               }
         ...
         fVar26 = param_1[0xf];
         fVar27 = param_8[0x16];
         fVar13 = ( ( ( ( 0.0 - fVar17 ) * fVar19 + ( 0.0 - fVar16 ) * fStack_14 + ( 0.0 - fVar14 ) * local_18 + 0.0 ) - ( (float)( ( ulong ) * (undefined8*)( param_8 + 4 ) >> 0x20 ) * param_1[4] + (float)*(undefined8*)( param_8 + 4 ) * param_1[3] + 0.0 + (float)*(undefined8*)( param_8 + 6 ) * param_1[5] ) ) - ( param_1[0xe] * fVar26 + param_1[0xd] ) ) * param_1[0xc] + fVar26;
         if (param_3 <= fVar13) {
            param_3 = fVar13;
         }
   ...
   void JPH::PathConstraint::ResetWarmStart(PathConstraint *this) {
   ...
   undefined1 *JPH::PathConstraintSettings::GetRTTI(void) {
      ...
      if (GetRTTIOfType(JPH::PathConstraintSettings * ::rtti == '\0') {
         ...
         if (iVar1 != 0) {
            JPH::RTTI::RTTI((RTTI*)GetRTTIOfType(JPH::PathConstraintSettings * ::rtti, "PathConstraintSettings", 0x80, GetRTTIOfType(JPH::PathConstraintSettings * ::_FUN, GetRTTIOfType(JPH::PathConstraintSettings*)::{lambda(void*)#1}::_FUN,
                      sCreateRTTI);, __cxa_atexit(RTTI::~RTTI, GetRTTIOfType(JPH::PathConstraintSettings*)::rtti,&__dso_handle);, __cxa_guard_release(&GetRTTIOfType(JPH::PathConstraintSettings*)::rtti);
      return, GetRTTIOfType(JPH::PathConstraintSettings*)::rtti;
    }
  }
  return, GetRTTIOfType(JPH::PathConstraintSettings*)::rtti;
}, /* _FUN(void*) */, void, JPH::GetRTTIOfType(JPH::PathConstraintSettings*)::{lambda(void*)#1}::_FUN(void *param_1)
...
void __thiscall JPH::PathConstraint::WarmStartVelocityConstraint(PathConstraint *this,float param_1), {
                                          ...
                                          *(ulong*)( this + 0x200 ) = CONCAT44(fVar35, fVar29);
                                          ...
                                          if (( fVar27 * param_1 == 0.0 ) && ( *(float*)( this + 0x204 ) * param_1 == 0.0 )) {
                                             ...
                                             fVar28 = *(float*)( this + 300 );
                                             if (cVar1 != '\x02') {
                                                LAB_00100de0:fVar37 = pfVar7[0x16];
                                                LAB_00100de5:fVar36 = *(float*)( this + 0x24c ) * param_1;
                                             ...
                                             if (cVar2 != '\x02') {
                                                fVar37 = pfVar6[0x16];
                                                LAB_00100d04:fVar36 = *(float*)( this + 0x24c ) * param_1;
                                                *(float*)( this + 0x24c ) = fVar36;
                                                if (fVar36 != 0.0) {
                                                   fVar37 = fVar37 * fVar36;
                                                   bVar4 = *(byte*)( (long)pfVar6 + 0x7a );
                                             ...
                                             if (cVar1 == '\x02') {
                                                ...
                                                *pfVar6 = (float)( -(uint)(auVar33._0_4_ == __LC7) & ( uint )(*pfVar6 - fVar37 * fVar27) );
                                                ...
                                                pfVar6[4] = pfVar6[4] - ( *(float*)( this + 0x1c0 ) * fVar35 + *(float*)( this + 0x1b0 ) * fVar29 );
                                          ...
                                          *(float*)( this + 0x24c ) = fVar30;
                                          ...
                                          LAB_00100d2b:iVar5 = *(int*)( this + 0xc0 );
                                          if (iVar5 < 4) {
                                             if (iVar5 < 1) {
                                                return;
                                             }
                                             ...
                                             *(ulong*)( this + 0x370 ) = CONCAT44(fVar35, fVar29);
                                             if (( param_1 * *(float*)( this + 0x374 ) != 0.0 ) || ( fVar27 * param_1 != 0.0 )) {
                                                ...
                                                if (cVar1 == '\x02') {
                                                   ...
                                                   pfVar6[4] = pfVar6[4] - ( fVar27 * *(float*)( this + 0x2c0 ) + fVar28 * *(float*)( this + 0x2d0 ) + fVar29 * *(float*)( this + 0x2e0 ) );
                                                ...
                                                if (cVar2 == '\x02') {
                                                   ...
                                                   pfVar7[4] = fVar29 * *(float*)( this + 800 ) + fVar27 * *(float*)( this + 0x300 ) + fVar28 * *(float*)( this + 0x310 ) + pfVar7[4];
                                             ...
                                             *(float*)( this + 0x44c ) = param_1 * *(float*)( this + 0x44c );
                                             ...
                                             if (( ~uVar26 & 7 ) != 0) {
                                                if (cVar1 == '\x02') {
                                                   ...
                                                   pfVar6[4] = pfVar6[4] - ( fVar27 * *(float*)( this + 0x380 ) + fVar29 * *(float*)( this + 0x390 ) + fVar35 * *(float*)( this + 0x3a0 ) );
                                                ...
                                                if (cVar2 == '\x02') {
                                                   ...
                                                   pfVar7[4] = fVar35 * *(float*)( this + 0x3e0 ) + fVar27 * *(float*)( this + 0x3c0 ) + fVar29 * *(float*)( this + 0x3d0 ) + pfVar7[4];
...
, /* JPH::PathConstraintSettings::RestoreBinaryState(JPH::StreamIn&) */, void __thiscall
JPH::PathConstraintSettings::RestoreBinaryState(PathConstraintSettings *this, StreamIn * param_1) * plVar1 * plVar2 * local_48[2];
  long local_38[2] * (long*)( in_FS_OFFSET + 0x28 ) * this) * local_48)(( local_28 != '\x02' ) && ( plVar2 = *(long**)( this + 0x28 ) ), plVar2 != local_48[0]))(plVar2 != (long*)0x0), {
      LOCK() + 1 * (int*)plVar1 = (int)*plVar1 + -1, ;
      UNLOCK()((int)*plVar1 == 0)(**(code**)( *plVar2 + 0x18 ))() * (long**)( this + 0x28 ) = local_48[0](local_48[0] != (long*)0x0), {
      LOCK() * (int*)( local_48[0] + 1 ) = (int)local_48[0][1] + 1, ;
      UNLOCK());
         }
   ...
   void JPH::PathConstraint::DrawConstraint(PathConstraint *this, DebugRenderer *param_1) {
      ...
      if (pDVar3 != (DebugRenderer*)0x0) {
         ...
         do {
            ...
            *(float*)( (long)local_88 + lVar13 ) = fVar8 * (float)local_108 + fVar19 * ( ( _LC0 - fVar12 * fVar18 ) - fVar22 ) + fVar20 * ( fVar12 * fVar17 - fVar16 ) + fVar21 * ( fVar14 * fVar17 + fVar18 * fVar15 );
            *(float*)( (long)local_88 + lVar13 + 4 ) = fVar8 * local_108._4_4_ + fVar19 * ( fVar12 * fVar17 + fVar16 ) + fVar20 * ( ( _LC0 - fVar22 ) - fVar11 * fVar17 ) + fVar21 * ( fVar14 * fVar18 - fVar17 * fVar15 );
            *(float*)( (long)local_88 + lVar13 + 8 ) = fVar8 * fVar2 + fVar19 * ( fVar14 * fVar17 - fVar18 * fVar15 ) + fVar20 * ( fVar17 * fVar15 + fVar14 * fVar18 ) + fVar21 * ( ( _LC0 - fVar11 * fVar17 ) - fVar12 * fVar18 );
            *(float*)( (long)local_88 + lVar13 + 0xc ) = fVar8 * 1.0 + fVar19 * 0.0 + fVar20 * 0.0 + fVar21 * 0.0;
            lVar13 = lVar13 + 0x10;
         }
 while ( lVar13 != 0x40 );
         ...
         JPH::DebugRenderer::DrawMarker(CONCAT44(fVar11 + fVar16, fVar2 + fVar15), CONCAT44(fVar14 + fVar18, fVar12 + fVar17), param_1, (undefined4)Color::sYellow);
         JPH::DebugRenderer::DrawArrow(local_108, uStack_100, CONCAT44(fVar19 + *(float*)( this + 0x124 ), fVar22 + *(float*)( this + 0x120 )), CONCAT44(fVar21 + *(float*)( this + 300 ), fVar20 + *(float*)( this + 0x128 )), _LC9, param_1, (undefined4)Color::sBlue);
         JPH::DebugRenderer::DrawArrow(local_108, uStack_100, CONCAT44(fVar19 + *(float*)( this + 0x134 ), fVar22 + *(float*)( this + 0x130 )), CONCAT44(fVar21 + *(float*)( this + 0x13c ), fVar20 + *(float*)( this + 0x138 )), _LC9, param_1, (undefined4)Color::sRed);
         ...
         JPH::DebugRenderer::DrawArrow(uVar9, uVar10, local_108, uStack_100, _LC9, param_1, (undefined4)Color::sGreen);
         ...
         if (*(int*)( this + 0xe4 ) == 1) {
            ...
            uStack_100 = CONCAT44(*(float*)( this + 0x10c ) + pfVar5[3], *(float*)( this + 0x108 ) + pfVar5[2]);
            JPH::DebugRenderer::DrawArrow(local_108, uStack_100, CONCAT44(fVar2 * *(float*)( this + 0x124 ) + *(float*)( this + 0x104 ) + pfVar5[1], fVar2 * *(float*)( this + 0x120 ) + *(float*)( this + 0x100 ) + *pfVar5), CONCAT44(fVar2 * *(float*)( this + 300 ) + *(float*)( this + 0x10c ) + pfVar5[3], fVar2 * *(float*)( this + 0x128 ) + *(float*)( this + 0x108 ) + pfVar5[2]), _LC9, param_1, (undefined4)Color::sRed);
         }
 else if (*(int*)( this + 0xe4 ) == 2) {
            ( **(code**)( **(long**)( this + 0x38 ) + 0x30 ) )(*(long**)( this + 0x38 ), &local_d8, local_c8, local_b8, &local_a8);
            local_108 = CONCAT44(fStack_d0 * local_88[9] + local_d8 * local_88[1] + fStack_d4 * local_88[5] + local_88[0xd], fStack_d0 * local_88[8] + local_d8 * local_88[0] + fStack_d4 * local_88[4] + local_88[0xc]);
            uStack_100 = CONCAT44(fStack_d0 * local_88[0xb] + local_d8 * local_88[3] + fStack_d4 * local_88[7] + local_88[0xf], fStack_d0 * local_88[10] + local_d8 * local_88[2] + fStack_d4 * local_88[6] + local_88[0xe]);
            JPH::DebugRenderer::DrawMarker(local_108, uStack_100, param_1, (undefined4)Color::sYellow);
         }
   ...
   uint JPH::PathConstraint::SolveVelocityConstraint(float param_1) {
      ...
      if (*(float*)( in_RDI + 0x280 ) != 0.0) {
         ...
         uVar22 = AxisConstraintPart::SolveVelocityConstraint(*(undefined8*)( in_RDI + 0x120 ), *(undefined8*)( in_RDI + 0x128 ), in_RDI + 0x250, uVar28, BVar2, uVar23, pBVar5[0x78]);
      }

      LAB_001019ea:fVar34 = *(float*)( in_RDI + 0x130 );
      ...
      uVar23 = DualAxisConstraintPart::CalculateLagrangeMultiplier(*(undefined8*)( in_RDI + 0x130 ), *(undefined8*)( in_RDI + 0x138 ), *(undefined8*)( in_RDI + 0x140 ), *(undefined8*)( in_RDI + 0x148 ), in_RDI + 0x170, pBVar6, pBVar5, &local_38);
      pfVar27 = (float*)0x1;
      *(ulong*)( in_RDI + 0x200 ) = CONCAT44((float)( ( ulong ) * (undefined8*)( in_RDI + 0x200 ) >> 0x20 ) + fStack_34, (float)*(undefined8*)( in_RDI + 0x200 ) + local_38);
      ...
      if (bVar19 != 0) {
         ...
         if (pBVar6[0x78] == (Body)0x2) {
            ...
            *pfVar9 = (float)( -(uint)(auVar31._0_4_ == __LC7) & ( uint )(*pfVar9 - fVar1 * fVar34) );
            ...
            pfVar9[4] = pfVar9[4] - ( *(float*)( in_RDI + 0x1c0 ) * fStack_34 + *(float*)( in_RDI + 0x1b0 ) * local_38 );
         ...
         if (pBVar5[0x78] == (Body)0x2) {
            ...
            *pfVar27 = (float)( ( uint )(fVar1 * fVar34 + *pfVar27) & -(uint)(auVar36._0_4_ == __LC7) );
            ...
            pfVar27[4] = fStack_34 * *(float*)( in_RDI + 0x1e0 ) + local_38 * *(float*)( in_RDI + 0x1d0 ) + pfVar27[4];
      ...
      if (*(float*)( in_RDI + 0x240 ) == 0.0) {
         LAB_00101a93:iVar20 = *(int*)( in_RDI + 0xc0 );
         if (iVar20 < 4) goto LAB_00101bdb;
         LAB_00101aa2:if (iVar20 - 4U < 2) {
            BVar2 = pBVar5[0x78];
            ...
            if (BVar3 == (Body)0x0) {
               ...
               auVar30._0_4_ = fVar37 * *(float*)( in_RDI + 0x410 ) + fVar34 * *(float*)( in_RDI + 0x400 ) + fVar38 * *(float*)( in_RDI + 0x420 );
               auVar30._4_4_ = fVar37 * *(float*)( in_RDI + 0x414 ) + fVar34 * *(float*)( in_RDI + 0x404 ) + fVar38 * *(float*)( in_RDI + 0x424 );
               auVar30._8_4_ = fVar37 * *(float*)( in_RDI + 0x418 ) + fVar34 * *(float*)( in_RDI + 0x408 ) + fVar38 * *(float*)( in_RDI + 0x428 );
               fVar34 = fVar37 * *(float*)( in_RDI + 0x41c ) + fVar34 * *(float*)( in_RDI + 0x40c ) + fVar38 * *(float*)( in_RDI + 0x42c );
               ...
               *(float*)( in_RDI + 0x44c ) = *(float*)( in_RDI + 0x44c ) + fVar34;
               ...
               auVar30._0_4_ = fVar34 * *(float*)( in_RDI + 0x400 ) + fVar37 * *(float*)( in_RDI + 0x410 ) + fVar38 * *(float*)( in_RDI + 0x420 );
               auVar30._4_4_ = fVar34 * *(float*)( in_RDI + 0x404 ) + fVar37 * *(float*)( in_RDI + 0x414 ) + fVar38 * *(float*)( in_RDI + 0x424 );
               auVar30._8_4_ = fVar34 * *(float*)( in_RDI + 0x408 ) + fVar37 * *(float*)( in_RDI + 0x418 ) + fVar38 * *(float*)( in_RDI + 0x428 );
               fVar34 = fVar34 * *(float*)( in_RDI + 0x40c ) + fVar37 * *(float*)( in_RDI + 0x41c ) + fVar38 * *(float*)( in_RDI + 0x42c );
               *(float*)( in_RDI + 0x440 ) = *(float*)( in_RDI + 0x440 ) + auVar30._0_4_;
               *(float*)( in_RDI + 0x444 ) = *(float*)( in_RDI + 0x444 ) + auVar30._4_4_;
               *(float*)( in_RDI + 0x448 ) = *(float*)( in_RDI + 0x448 ) + auVar30._8_4_;
               *(float*)( in_RDI + 0x44c ) = *(float*)( in_RDI + 0x44c ) + fVar34;
               ...
               if (( ~uVar25 & 7 ) != 0) {
                  if (BVar3 == (Body)0x2) {
                     ...
                     *(float*)( lVar8 + 0x10 ) = *(float*)( lVar8 + 0x10 ) - ( auVar30._0_4_ * *(float*)( in_RDI + 0x380 ) + auVar30._4_4_ * *(float*)( in_RDI + 0x390 ) + auVar30._8_4_ * *(float*)( in_RDI + 0x3a0 ) );
                     *(float*)( lVar8 + 0x14 ) = *(float*)( lVar8 + 0x14 ) - ( auVar30._0_4_ * fVar34 + auVar30._4_4_ * fVar39 + auVar30._8_4_ * fVar14 );
                     *(float*)( lVar8 + 0x18 ) = *(float*)( lVar8 + 0x18 ) - ( auVar30._0_4_ * fVar37 + auVar30._4_4_ * fVar1 + auVar30._8_4_ * fVar15 );
                     *(float*)( lVar8 + 0x1c ) = *(float*)( lVar8 + 0x1c ) - ( auVar30._0_4_ * fVar38 + auVar30._4_4_ * fVar13 + auVar30._8_4_ * fVar16 );
                  }

                  LAB_00101d62:if (BVar2 == (Body)0x2) {
                     ...
                     *(float*)( lVar7 + 0x10 ) = fVar33 * *(float*)( in_RDI + 0x3e0 ) + fVar29 * *(float*)( in_RDI + 0x3c0 ) + fVar32 * *(float*)( in_RDI + 0x3d0 ) + *(float*)( lVar7 + 0x10 );
                     *(float*)( lVar7 + 0x14 ) = fVar33 * fVar14 + fVar29 * fVar34 + fVar32 * fVar39 + *(float*)( lVar7 + 0x14 );
                     *(float*)( lVar7 + 0x18 ) = fVar33 * fVar15 + fVar29 * fVar37 + fVar32 * fVar1 + *(float*)( lVar7 + 0x18 );
                     *(float*)( lVar7 + 0x1c ) = fVar33 * fVar16 + fVar29 * fVar38 + fVar32 * fVar13 + *(float*)( lVar7 + 0x1c );
                  }
         ...
         if (*(float*)( in_RDI + 0x160 ) <= 0.0) {
            uVar21 = AxisConstraintPart::SolveVelocityConstraint(*(undefined8*)( in_RDI + 0x120 ), *(undefined8*)( in_RDI + 0x128 ), in_RDI + 0x210, *(undefined8*)( pBVar6 + 0x48 ), pBVar6[0x78], uVar23, pBVar5[0x78]);
         ...
         LAB_00101bdb:if (0 < iVar20) {
            uVar25 = HingeRotationConstraintPart::SolveVelocityConstraint((HingeRotationConstraintPart*)( in_RDI + 0x290 ), pBVar6, pBVar5);
            goto LAB_00101c22;
         }
   ...
   undefined1 *JPH::GetRTTIOfType(PathConstraintSettings *param_1) {
      ...
      if (GetRTTIOfType(JPH::PathConstraintSettings * ::rtti == '\0') {
         iVar1 = __cxa_guard_acquire(&GetRTTIOfType(JPH::PathConstraintSettings * ::rtti));
         if (iVar1 != 0) {
            JPH::RTTI::RTTI((RTTI*)GetRTTIOfType(JPH::PathConstraintSettings * ::rtti, "PathConstraintSettings", 0x80, GetRTTIOfType(JPH::PathConstraintSettings*)::{lambda()#1}::_FUN,
...

{
  ...
  if (bVar5) {
    ...
    if (pBVar4[0x78] == (Body)0x2) {
      ...
      bVar7 = auVar16._12_4_ == _UNK_0010786c * (float*)pBVar4 = *(float*)pBVar4 - (float)( -(uint)(auVar16._0_4_ == __LC7) & ( uint )(fVar15 * fVar22) ) * (float*)( pBVar4 + 4 ) = *(float*)( pBVar4 + 4 ) - (float)( -(uint)bVar6 & ( uint )(fVar15 * fVar23) ) * (float*)( pBVar4 + 8 ) = *(float*)( pBVar4 + 8 ) - (float)( -(uint)bVar8 & ( uint )(fVar15 * fVar24) ) * (float*)( pBVar4 + 0xc ) = *(float*)( pBVar4 + 0xc ) - (float)( -(uint)bVar7 & ( uint )(fVar15 * fVar25) ) * *(float*)( this + 0x1c4 ) + fVar26 * *(float*)( this + 0x1b4 ), fVar21 * *(float*)( this + 0x1c0 ) + fVar26 * *(float*)( this + 0x1b0 )));
            uStack_60 = CONCAT44(fVar21 * *(float*)( this + 0x1cc ) + fVar26 * *(float*)( this + 0x1bc ), fVar21 * *(float*)( this + 0x1c8 ) + fVar26 * *(float*)( this + 0x1b8 ));
         ...
         if (pBVar3[0x78] == (Body)0x2) {
            ...
            *(float*)pBVar3 = (float)( ( uint )(fVar15 * fVar22) & -(uint)(auVar18._0_4_ == __LC7) ) + *(float*)pBVar3;
            *(float*)( pBVar3 + 4 ) = (float)( ( uint )(fVar15 * fVar23) & -(uint)bVar6 ) + *(float*)( pBVar3 + 4 );
            *(float*)( pBVar3 + 8 ) = (float)( ( uint )(fVar15 * fVar24) & -(uint)bVar8 ) + *(float*)( pBVar3 + 8 );
            *(float*)( pBVar3 + 0xc ) = (float)( ( uint )(fVar15 * fVar25) & -(uint)bVar7 ) + *(float*)( pBVar3 + 0xc );
            local_68 = CONCAT44(fVar21 * *(float*)( this + 0x1e4 ) + fVar26 * *(float*)( this + 0x1d4 ), fVar21 * *(float*)( this + 0x1e0 ) + fVar26 * *(float*)( this + 0x1d0 ));
            uStack_60 = CONCAT44(fVar21 * *(float*)( this + 0x1ec ) + fVar26 * *(float*)( this + 0x1dc ), fVar21 * *(float*)( this + 0x1e8 ) + fVar26 * *(float*)( this + 0x1d8 ));
            Body::AddRotationStep(local_68, uStack_60, pBVar3);
         }

      }

      if (( ( *(float*)( this + 0x240 ) == 0.0 ) || ( fVar21 = (float)( ( ulong ) * (undefined8*)( this + 0x120 ) >> 0x20 ) * *(float*)( this + 0x114 ) + (float)*(undefined8*)( this + 0x120 ) * *(float*)( this + 0x110 ) + 0.0 + *(float*)( this + 0x118 ) * *(float*)( this + 0x128 ) ),fVar21 == 0.0 )) {
         iVar2 = *(int*)( this + 0xc0 );
         if (iVar2 < 4) {
            if (iVar2 < 1) {
               uVar13 = 0;
               ...
               uVar13 = HingeRotationConstraintPart::SolvePositionConstraint((HingeRotationConstraintPart*)( this + 0x290 ), pBVar4, pBVar3, param_2);
            }
         ...
         if (pBVar4[0x78] == (Body)0x2) {
            ...
            *(float*)pBVar4 = *(float*)pBVar4 - (float)( ( uint )(fVar15 * fVar22) & -(uint)(auVar20._0_4_ == __LC7) );
            *(float*)( pBVar4 + 4 ) = *(float*)( pBVar4 + 4 ) - (float)( ( uint )(fVar15 * fVar24) & -(uint)bVar5 );
            *(float*)( pBVar4 + 8 ) = *(float*)( pBVar4 + 8 ) - (float)( ( uint )(fVar15 * fVar23) & -(uint)bVar6 );
            *(float*)( pBVar4 + 0xc ) = *(float*)( pBVar4 + 0xc ) - (float)( ( uint )(fVar15 * fVar25) & -(uint)bVar8 );
         ...
         if (pBVar3[0x78] == (Body)0x2) {
            ...
            *(float*)pBVar3 = (float)( ( uint )(fVar15 * fVar22) & -(uint)(auVar19._0_4_ == __LC7) ) + *(float*)pBVar3;
            *(float*)( pBVar3 + 4 ) = (float)( ( uint )(fVar15 * fVar24) & -(uint)bVar5 ) + *(float*)( pBVar3 + 4 );
            *(float*)( pBVar3 + 8 ) = (float)( ( uint )(fVar15 * fVar23) & -(uint)bVar6 ) + *(float*)( pBVar3 + 8 );
            *(float*)( pBVar3 + 0xc ) = (float)( ( uint )(fVar15 * fVar25) & -(uint)bVar8 ) + *(float*)( pBVar3 + 0xc );
         ...
         if (iVar2 < 4) {
            ...
            HingeRotationConstraintPart::SolvePositionConstraint((HingeRotationConstraintPart*)( this + 0x290 ), pBVar4, pBVar3, param_2);
            return 1;
         }
      ...
      uVar13 = RotationEulerConstraintPart::SolvePositionConstraint(*(undefined8*)( this + 0x150 ), *(undefined8*)( this + 0x158 ), this + 0x380, pBVar4, pBVar3);
      LAB_001041a5:if (bVar5) {
         return 1;
      }
   ...
   undefined1[16];
   JPH::Shape::GetCenterOfMass(void) {
      return ZEXT816(0);
   }
   ...
   ulong JPH::PathConstraint::IsActive(PathConstraint *this) {
      char cVar1;
      long lVar2;
      ulong uVar3;
   ...
   void JPH::PathConstraintSettings::~PathConstraintSettings(PathConstraintSettings *this) {
      long *plVar1;
      long *plVar2;
   ...
   /* JPH::PathConstraint::~PathConstraint() */
   void JPH::PathConstraint::~PathConstraint(PathConstraint *this) {
      long *plVar1;
      long *plVar2;
      *(undefined***)this = &PTR__PathConstraint_00107788;
 ...
 while ( lVar9 != 0x30 );
   ...
   void JPH::Body::AddRotationStep(undefined8 param_1, undefined8 param_2, long param_3) {
      ...
      fVar2 = (float)( __LC38 & ( ( (uint)fVar17 & uVar21 | ~uVar21 & (uint)fVar19 ) ^ _LC52 & iVar13 << 0x1e ^ iVar13 << 0x1f ) | ~__LC38 & ( uint )(auVar5._0_4_ * (float)( ( (uint)fVar11 ^ iVar13 << 0x1e ) & _LC52 ^ ( (uint)fVar19 & uVar21 | ~uVar21 & (uint)fVar17 ) )) );
      fVar18 = (float)( _UNK_00107894 & ( ( (uint)fVar18 & uVar23 | ~uVar23 & (uint)fVar20 ) ^ _UNK_00107884 & iVar14 << 0x1e ^ iVar14 << 0x1f ) | ~_UNK_00107894 & ( uint )(auVar5._4_4_ * (float)( ( (uint)fVar11 ^ iVar14 << 0x1e ) & _UNK_00107884 ^ ( (uint)fVar20 & uVar23 | ~uVar23 & (uint)fVar18 ) )) );
      fVar7 = (float)( _UNK_00107898 & ( ( (uint)fVar7 & uVar25 | ~uVar25 & (uint)fVar8 ) ^ _UNK_00107888 & iVar15 << 0x1e ^ iVar15 << 0x1f ) | ~_UNK_00107898 & ( uint )(auVar5._8_4_ * (float)( ( (uint)fVar11 ^ iVar15 << 0x1e ) & _UNK_00107888 ^ ( (uint)fVar8 & uVar25 | ~uVar25 & (uint)fVar7 ) )) );
      fVar9 = (float)( _UNK_0010789c & ( ( (uint)fVar9 & uVar27 | ~uVar27 & (uint)fVar10 ) ^ _UNK_0010788c & iVar16 << 0x1e ^ iVar16 << 0x1f ) | ~_UNK_0010789c & ( uint )(auVar5._12_4_ * (float)( ( (uint)fVar11 ^ iVar16 << 0x1e ) & _UNK_0010788c ^ ( (uint)fVar10 & uVar27 | ~uVar27 & (uint)fVar9 ) )) );
   ...
   void JPH::AxisConstraintPart::CalculateConstraintProperties(undefined8 param_1_00, float param_2, undefined8 param_3, float param_4, undefined8 param_5, float param_6, float param_7, float *param_1, long param_9, long param_10) {
      char cVar1;
      long lVar2;
      long in_FS_OFFSET;
      float fVar3;
         ...
         if (cVar1 == '\x02') {
            ...
            if (cVar1 == '\x01') {
               ...
               *param_1 = fVar12;
               ...
               param_1[10] = fVar15;
               param_1[0xb] = fVar16;
               fVar4 = fVar16 * fVar17 + fVar15 * fVar10 + fVar14 * fVar9 + 0.0 + fVar3 + fVar8 * fVar11 + fVar6 * fVar13 + fVar5 * fVar12 + 0.0 + fVar4;
            }
 else {
      ...
      LAB_00105618:param_1[0xf] = 0.0;
      fVar7 = 0.0;
      LAB_001053b1:param_1[0xc] = fVar7;
      if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Subroutine does not return */
         __stack_chk_fail();
      }
   ...
   void JPH::AxisConstraintPart::CalculateConstraintPropertiesWithSettings(float param_1, undefined8 param_2_00, float param_3, undefined8 param_4, float param_5, undefined8 param_6, float param_7, float param_8, float *param_2, long param_10, long param_11, char *param_12, undefined8 param_13, undefined8 param_14, float param_15) {
      char cVar1;
      long lVar2;
      float fVar3;
      long in_FS_OFFSET;
         ...
         LAB_00105e38:if (fVar5 != 0.0) {
            ...
            if (*param_12 == '\0') {
               ...
               if (fVar6 <= 0.0) {
                  ...
                  param_2[0xe] = fVar4;
                  *(ulong*)( param_2 + 0xc ) = CONCAT44(fVar8 * fVar4 * param_15 + param_8, fVar3 / ( fVar5 + fVar4 ));
               }
               ...
               *(ulong*)( param_2 + 0xc ) = CONCAT44(param_8, fVar3 / fVar5);
               ...
               param_2[0xe] = fVar4;
               *(ulong*)( param_2 + 0xc ) = CONCAT44(fVar6 * param_1 * fVar4 * param_15 + param_8, fVar3 / ( fVar5 + fVar4 ));
            }
         ...
         if (cVar1 == '\x02') {
            ...
            if (cVar1 == '\x01') {
               ...
               *param_2 = fVar12;
               ...
               param_2[10] = fVar7;
               param_2[0xb] = fVar8;
               fVar5 = fVar17 * fVar8 + fVar7 * fVar10 + fVar6 * fVar9 + 0.0 + fVar4 + fVar16 * fVar11 + fVar15 * fVar13 + fVar14 * fVar12 + 0.0 + fVar5;
            }
 else {
      ...
      LAB_00106120:param_2[0xc] = 0.0;
      param_2[0xf] = 0.0;
      LAB_0010612e:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Subroutine does not return */
         __stack_chk_fail();
      }
   ...
   void JPH::DualAxisConstraintPart::CalculateLagrangeMultiplier(undefined8 param_1_00, float param_2_00, undefined8 param_3, float param_4, float *param_1, long param_2, long param_7, undefined8 *param_8) {
      char cVar1;
      float *pfVar2;
      float *pfVar3;
      ...
      fVar9 = ( auVar4._8_4_ * param_1[2] + auVar4._4_4_ * param_1[1] + *param_1 * auVar4._0_4_ + 0.0 + fVar9 ) - ( auVar5._8_4_ * param_1[10] + auVar5._4_4_ * param_1[9] + param_1[8] * auVar5._0_4_ + 0.0 );
      auVar4 = SUB1612((undefined1[16])0x0, 0);
      if (*(char*)( param_2 + 0x78 ) != '\0') {
         auVar4 = SUB1612(*(undefined1(*) [16])( pfVar3 + 4 ), 0);
      }
      ...
      fVar6 = ( auVar4._8_4_ * param_1[6] + auVar4._4_4_ * param_1[5] + param_1[4] * auVar4._0_4_ + 0.0 + fVar8 * param_4 + (float)( (ulong)param_3 >> 0x20 ) * fVar7 + (float)param_3 * fVar6 + 0.0 ) - ( auVar5._8_4_ * param_1[0xe] + auVar5._4_4_ * param_1[0xd] + param_1[0xc] * auVar5._0_4_ + 0.0 );
      *param_8 = CONCAT44(fVar6 * (float)( ( ulong ) * (undefined8*)( param_1 + 0x22 ) >> 0x20 ) + (float)( ( ulong ) * (undefined8*)( param_1 + 0x20 ) >> 0x20 ) * fVar9 + 0.0, fVar6 * (float)*(undefined8*)( param_1 + 0x22 ) + (float)*(undefined8*)( param_1 + 0x20 ) * fVar9 + 0.0);
      return;
   }
   ...
   void JPH::HingeRotationConstraintPart::CalculateConstraintProperties(undefined8 param_1_00, undefined8 param_2_00, undefined8 param_3, undefined8 param_4, float *param_1, long param_2, undefined8 param_7, long param_8) {
      float *pfVar1;
      float *pfVar2;
      char cVar3;
      ...
      *(undefined8*)( param_1 + 2 ) = param_2_00;
      ...
      if (fVar8 <= _LC42) {
         ...
         fVar8 = auVar10._8_4_ * auVar10._8_4_ + auVar10._0_4_ * auVar10._0_4_ + 0.0 + auVar10._4_4_ * auVar10._4_4_;
         if (fVar8 < _LC14) {
            ...
            fVar8 = auVar10._0_4_ * auVar10._0_4_ + 0.0 + auVar10._4_4_ * auVar10._4_4_ + auVar10._8_4_ * auVar10._8_4_;
         }
         ...
         auVar13._0_4_ = SQRT(auVar29._8_4_ * auVar29._8_4_ + auVar29._4_4_ * auVar29._4_4_ + auVar29._0_4_ * auVar29._0_4_ + 0.0);
 ...
 while ( lVar7 != 0x40 );
   ...
   void JPH::HingeRotationConstraintPart::SolveVelocityConstraint(HingeRotationConstraintPart *this, Body *param_1, Body *param_2) {
      Body BVar1;
      Body BVar2;
      long lVar3;
      long lVar4;
      ...
      fVar17 = *(float*)( this + 0xb8 ) * fVar16 + *(float*)( this + 0xb4 ) * fVar15 + *(float*)( this + 0xb0 ) * fVar13 + 0.0;
      fVar13 = fVar16 * *(float*)( this + 200 ) + fVar15 * *(float*)( this + 0xc4 ) + fVar13 * *(float*)( this + 0xc0 ) + 0.0;
      fVar15 = fVar17 * (float)*(undefined8*)( this + 0xd0 ) + 0.0 + fVar13 * (float)*(undefined8*)( this + 0xd8 );
      fVar16 = fVar17 * (float)( ( ulong ) * (undefined8*)( this + 0xd0 ) >> 0x20 ) + 0.0 + fVar13 * (float)( ( ulong ) * (undefined8*)( this + 0xd8 ) >> 0x20 );
      *(ulong*)( this + 0xe0 ) = CONCAT44((float)( ( ulong ) * (undefined8*)( this + 0xe0 ) >> 0x20 ) + fVar16, (float)*(undefined8*)( this + 0xe0 ) + fVar15);
      if (*(float*)( this + 0xd8 ) * fVar13 + *(float*)( this + 0xd0 ) * fVar17 + 0.0 != 0.0 || fVar13 * *(float*)( this + 0xdc ) + fVar17 * *(float*)( this + 0xd4 ) + 0.0 != 0.0) {
         ...
         if (BVar2 == (Body)0x2) {
            ...
            *(float*)( lVar4 + 0x10 ) = *(float*)( lVar4 + 0x10 ) - ( fVar13 * *(float*)( this + 0x30 ) + fVar17 * *(float*)( this + 0x40 ) + fVar15 * *(float*)( this + 0x50 ) );
            *(float*)( lVar4 + 0x14 ) = *(float*)( lVar4 + 0x14 ) - ( fVar13 * fVar16 + fVar17 * fVar7 + fVar15 * fVar10 );
            *(float*)( lVar4 + 0x18 ) = *(float*)( lVar4 + 0x18 ) - ( fVar13 * fVar5 + fVar17 * fVar8 + fVar15 * fVar11 );
            *(float*)( lVar4 + 0x1c ) = *(float*)( lVar4 + 0x1c ) - ( fVar13 * fVar6 + fVar17 * fVar9 + fVar15 * fVar12 );
         }
         ...
         if (BVar1 == (Body)0x2) {
            ...
            *(float*)( lVar3 + 0x10 ) = fVar15 * *(float*)( this + 0x90 ) + fVar13 * *(float*)( this + 0x70 ) + fVar17 * *(float*)( this + 0x80 ) + *(float*)( lVar3 + 0x10 );
            *(float*)( lVar3 + 0x14 ) = fVar15 * fVar10 + fVar13 * fVar16 + fVar17 * fVar7 + *(float*)( lVar3 + 0x14 );
            *(float*)( lVar3 + 0x18 ) = fVar15 * fVar11 + fVar13 * fVar5 + fVar17 * fVar8 + *(float*)( lVar3 + 0x18 );
            *(float*)( lVar3 + 0x1c ) = fVar15 * fVar12 + fVar13 * fVar6 + fVar17 * fVar9 + *(float*)( lVar3 + 0x1c );
            return;
         }
   ...
   ulong JPH::HingeRotationConstraintPart::SolvePositionConstraint(HingeRotationConstraintPart *this, Body *param_1, Body *param_2, float param_3) {
      byte bVar1;
      undefined8 in_RAX;
      ulong uVar2;
      float fVar3;
      ...
      float fVar5;
      float fVar6;
      fVar6 = *(float*)( this + 0x18 ) * *(float*)( this + 8 ) + *(float*)( this + 0x14 ) * *(float*)( this + 4 ) + *(float*)( this + 0x10 ) * *(float*)this + 0.0;
      fVar3 = *(float*)( this + 8 ) * *(float*)( this + 0x28 ) + *(float*)( this + 4 ) * *(float*)( this + 0x24 ) + *(float*)this * *(float*)( this + 0x20 ) + 0.0;
      ...
      if (bVar1 != 0) {
         fVar4 = ( *(float*)( this + 0xd8 ) * fVar3 + *(float*)( this + 0xd0 ) * fVar6 + 0.0 ) * (float)( (uint)param_3 ^ _LC39 );
         fVar3 = (float)( (uint)param_3 ^ _LC39 ) * ( fVar3 * *(float*)( this + 0xdc ) + fVar6 * *(float*)( this + 0xd4 ) + 0.0 );
         ...
         if (param_1[0x78] == (Body)0x2) {
            Body::SubRotationStep(CONCAT44(fVar6 * *(float*)( this + 0x34 ) + fVar5 * *(float*)( this + 0x44 ) + fVar3 * *(float*)( this + 0x54 ), fVar6 * *(float*)( this + 0x30 ) + fVar5 * *(float*)( this + 0x40 ) + fVar3 * *(float*)( this + 0x50 )), CONCAT44(fVar6 * *(float*)( this + 0x3c ) + fVar5 * *(float*)( this + 0x4c ) + fVar3 * *(float*)( this + 0x5c ), fVar6 * *(float*)( this + 0x38 ) + fVar5 * *(float*)( this + 0x48 ) + fVar3 * *(float*)( this + 0x58 )), param_1);
            uVar2 = (ulong)bVar1;
         }

         if (param_2[0x78] == (Body)0x2) {
            Body::AddRotationStep(CONCAT44(fVar6 * *(float*)( this + 0x74 ) + fVar5 * *(float*)( this + 0x84 ) + fVar3 * *(float*)( this + 0x94 ), fVar6 * *(float*)( this + 0x70 ) + fVar5 * *(float*)( this + 0x80 ) + fVar3 * *(float*)( this + 0x90 )), CONCAT44(fVar6 * *(float*)( this + 0x7c ) + fVar5 * *(float*)( this + 0x8c ) + fVar3 * *(float*)( this + 0x9c ), fVar6 * *(float*)( this + 0x78 ) + fVar5 * *(float*)( this + 0x88 ) + fVar3 * *(float*)( this + 0x98 )), param_2);
            uVar2 = uVar2 & 0xff;
         }
   ...
   float) const */
   undefined8 JPH::RotationEulerConstraintPart::SolvePositionConstraint(undefined8 param_1_00, undefined8 param_2_00, uint param_3, float *param_1, long param_2, long param_6) {
      float *pfVar1;
      char cVar2;
      uint uVar3;
      long lVar4;
      ...
      fVar8 = (float)( ( uint )(( fVar11 * fVar7 + fVar21 * fVar17 + fVar20 * fVar15 ) - fVar19 * fVar14) ^ (uint)fVar16 & _LC52 );
      fVar9 = (float)( ( uint )(( fVar14 * fVar7 - fVar21 * fVar15 ) + fVar20 * fVar17 + fVar19 * fVar11) ^ (uint)fVar16 & _LC52 );
      fVar7 = (float)( ( uint )(( ( fVar15 * fVar7 + fVar21 * fVar14 ) - fVar20 * fVar11 ) + fVar19 * fVar17) ^ (uint)fVar16 & _LC52 );
 ...
 while ( lVar4 != 0x40 );
         ...
         if (*(char*)( param_2 + 0x78 ) == '\x02') {
            Body::SubRotationStep(CONCAT44(fVar16 * param_1[1] + fVar18 * param_1[5] + fVar7 * param_1[9], fVar16 * *param_1 + fVar18 * param_1[4] + fVar7 * param_1[8]), CONCAT44(fVar16 * param_1[3] + fVar18 * param_1[7] + fVar7 * param_1[0xb], fVar16 * param_1[2] + fVar18 * param_1[6] + fVar7 * param_1[10]));
         ...
         if (cVar2 == '\x02') {
            Body::AddRotationStep(CONCAT44(fVar16 * param_1[0x11] + fVar18 * param_1[0x15] + fVar7 * param_1[0x19], fVar16 * param_1[0x10] + fVar18 * param_1[0x14] + fVar7 * param_1[0x18]), CONCAT44(fVar16 * param_1[0x13] + fVar18 * param_1[0x17] + fVar7 * param_1[0x1b], fVar16 * param_1[0x12] + fVar18 * param_1[0x16] + fVar7 * param_1[0x1a]), param_6);
            uVar5 = 1;
         }
 else {
            uVar5 = 1;

void tls1_md5_final_raw(undefined4 *param_1, undefined1 *param_2) {
   ...
   *param_2 = (char)( ( uint ) * param_1 >> 0x18 );
   ...
   for (int i_784 = 0; i_784 < 4; i_784++) {
      param_2[( 4*i_784 + 4 )] = *(undefined1*)( (long)param_1 + ( 4*i_784 + 7 ) );
      param_2[( 4*i_784 + 5 )] = (char)*(undefined2*)( (long)param_1 + ( 4*i_784 + 6 ) );
      param_2[( 4*i_784 + 6 )] = (char)( (uint)param_1[( i_784 + 1 )] >> 8 );
      param_2[( 4*i_784 + 7 )] = (char)param_1[( i_784 + 1 )];
   }
   return;
   ...
   *param_2 = (char)( ( ulong ) * param_1 >> 0x38 );
   for (int i_786 = 0; i_786 < 6; i_786++) {
      param_2[( i_786 + 1 )] = (char)( ( ulong ) * param_1 >> ( -8*i_786 + 48 ) );
   }
   param_2[7] = (char)*param_1;
   for (int i_785 = 0; i_785 < 7; i_785++) {
      param_2[( 8*i_785 + 8 )] = *(undefined1*)( (long)param_1 + ( 8*i_785 + 15 ) );
      param_2[( 8*i_785 + 9 )] = (char)*(undefined2*)( (long)param_1 + ( 8*i_785 + 14 ) );
      param_2[( 8*i_785 + 10 )] = (char)( (ulong)param_1[( i_785 + 1 )] >> 40 );
      param_2[( 8*i_785 + 11 )] = (char)*(undefined4*)( (long)param_1 + ( 8*i_785 + 12 ) );
      param_2[( 8*i_785 + 12 )] = (char)( (ulong)param_1[( i_785 + 1 )] >> 24 );
      param_2[( 8*i_785 + 13 )] = (char)( (ulong)param_1[( i_785 + 1 )] >> 16 );
      param_2[( 8*i_785 + 14 )] = (char)( (ulong)param_1[( i_785 + 1 )] >> 8 );
      param_2[( 8*i_785 + 15 )] = (char)param_1[( i_785 + 1 )];
   }
   return;

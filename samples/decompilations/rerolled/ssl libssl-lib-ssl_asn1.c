int i2d_SSL_SESSION(SSL_SESSION *in, uchar **pp) {
   ...
   LAB_00100464:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar4;
   }
...
SSL_SESSION *d2i_SSL_SESSION_ex(long *param_1, undefined8 *param_2, long param_3, undefined8 param_4, undefined8 param_5) {
   SSL_SESSION *pSVar1;
   ushort uVar2;
   int iVar3;
   uint *puVar4;
   ...
   if (param_1 == (long*)0x0) {
      ...
      LAB_00100646:SSL_SESSION_free(ses);
   }
 else {
            ...
            if (( iVar3 >> 8 == 3 || iVar3 >> 8 == 0xfe ) || ( iVar3 == 0x100 )) {
               ...
               *(undefined4*)( ses[1].krb5_client_princ + 0x20 ) = *(undefined4*)( val + 0xb8 );
               if (**(int**)( val + 8 ) == 2) {
                  ...
                  *(ulong*)( ses[1].krb5_client_princ + 0x18 ) = ( ulong )(ushort)(uVar2 << 8 | uVar2 >> 8) | 0x3000000;
                  lVar9 = ssl3_get_cipher_by_id();
                  *(long*)( ses[1].krb5_client_princ + 0x10 ) = lVar9;
                  if (lVar9 != 0) {
                     puVar4 = *(uint**)( val + 0x20 );
                     if (puVar4 == (uint*)0x0) {
                        LAB_00100778:lVar9 = 0;
                     }
 else {
                        uVar8 = *puVar4;
                        uVar12 = (ulong)uVar8;
                        ...
                        if (uVar8 < 8) {
                           if (( uVar8 & 4 ) == 0) {
                              ...
                              *(undefined2*)( (long)&ses->tlsext_tick_lifetime_hint + uVar12 + 6 ) = *(undefined2*)( (long)piVar5 + ( uVar12 - 2 ) );
                              lVar9 = (long)(int)*puVar4;
                           }
 else {
                              pSVar1->ssl_version = *piVar5;
                              *(undefined4*)( (long)&ses->tlsext_tick_lifetime_hint + uVar12 + 4 ) = *(undefined4*)( (long)piVar5 + ( uVar12 - 4 ) );
                              lVar9 = (long)(int)*puVar4;
                           }
                           ...
                           *(undefined8*)( (long)&ses->tlsext_tick_lifetime_hint + (ulong)uVar8 ) = *(undefined8*)( (long)piVar5 + ( (ulong)uVar8 - 8 ) );
                           ...
                           if (7 < uVar8) {
                              ...
                              do {
                                 uVar15 = (ulong)uVar11;
                                 uVar11 = uVar11 + 8;
                                 *(undefined8*)( uVar12 + uVar15 ) = *(undefined8*)( (long)piVar5 + ( uVar15 - lVar9 ) );
                              }
 while ( uVar11 < uVar8 );
                           }

                           LAB_00100734:uVar8 = *puVar4;
                           LAB_00100736:lVar9 = (long)(int)uVar8;
                        }
                        ...
                        if (uVar8 < 8) {
                           if (( uVar8 & 4 ) == 0) {
                              if (uVar8 != 0) {
                                 *puVar13 = *puVar6;
                                 if (( uVar8 & 2 ) != 0) {
                                    *(undefined2*)( ses->session_id + (ulong)uVar8 + 6 ) = *(undefined2*)( puVar6 + ( (ulong)uVar8 - 2 ) );
                                    lVar9 = (long)(int)*puVar4;
                                    goto LAB_0010083a;
                                 }
                           ...
                           *(undefined4*)( ses->session_id + (ulong)uVar8 + 4 ) = *(undefined4*)( puVar6 + ( (ulong)uVar8 - 4 ) );
                           lVar9 = (long)(int)*puVar4;
                        }
 else {
                           *(undefined8*)( ses->session_id + 8 ) = *(undefined8*)puVar6;
                           *(undefined8*)( ses->session_id + uVar8 ) = *(undefined8*)( puVar6 + ( (ulong)uVar8 - 8 ) );
                           ...
                           uVar8 = *puVar4;
                           LAB_001007d0:lVar9 = (long)(int)uVar8;
                        }

                     }

                     LAB_0010083a:*(long*)ses->key_arg = lVar9;
                     if (*(long*)( val + 0x30 ) == 0) {
                     ...
                     *(long*)( ses[1].sid_ctx + 0x14 ) = lVar9;
                     ...
                     for (int i = 0; i < 4; i++) {
                        ses[1].sid_ctx[i] = (char)( (ulong)uVar10 >> ( 8*i + 32 ) );
                     }
                     ...
                     if (puVar4 == (uint*)0x0) {
                        ...
                        if (uVar8 < 8) {
                           if (( uVar8 & 4 ) == 0) {
                              ...
                              *(undefined2*)( ses[1].master_key + (ulong)uVar8 + 0x12 ) = *(undefined2*)( puVar6 + ( (ulong)uVar8 - 2 ) );
                              lVar9 = (long)(int)*puVar4;
                           }
 else {
                              *(undefined4*)puVar13 = *(undefined4*)puVar6;
                              *(undefined4*)( ses[1].master_key + (ulong)uVar8 + 0x10 ) = *(undefined4*)( puVar6 + ( (ulong)uVar8 - 4 ) );
                              lVar9 = (long)(int)*puVar4;
                           }
                           ...
                           *(undefined8*)( ses[1].master_key + (ulong)uVar8 + 0xc ) = *(undefined8*)( puVar6 + ( (ulong)uVar8 - 8 ) );
                           uVar12 = ( ulong )(ses[1].master_key + 0x1c) & 0xfffffffffffffff8;
                           lVar9 = (long)puVar13 - uVar12;
                           uVar8 = uVar8 + (int)lVar9 & 0xfffffff8;
                           if (uVar8 < 8) {
                              LAB_00100935:uVar8 = *puVar4;
                           }
 else {
                              uVar11 = 0;
                              do {
 ...
 while ( uVar11 < uVar8 );
                           ...
                           LAB_00100937:lVar9 = (long)(int)uVar8;
                        }
                     ...
                     *(long*)( ses[1].sid_ctx + 0xc ) = (long)*(int*)( val + 0x50 );
                     CRYPTO_free(pvVar7);
                     for (int i = 0; i < 8; i++) {
                        ses[1].krb5_client_princ[( i + 56 )] = '\0';
                     }

                     if (piVar5 != (int*)0x0) {
                        lVar9 = CRYPTO_strndup(*(undefined8*)( piVar5 + 2 ), (long)*piVar5, "ssl/ssl_asn1.c", 0xeb);
                     ...
                     *(undefined4*)( ses[1].krb5_client_princ + 0x58 ) = *(undefined4*)( val + 0x68 );
                     ...
                     if (piVar5 == (int*)0x0) {
                        for (int i = 0; i < 8; i++) {
                           ses[1].krb5_client_princ[( i + 64 )] = '\0';
                        }
                     ...
                     *(uint*)( ses[1].krb5_client_princ + 8 ) = uVar8;
                     ...
                     for (int i = 0; i < 8; i++) {
                        ses[1].krb5_client_princ[( i + 120 )] = '\0';
                     }
                     ...
                     *(undefined4*)( ses[1].krb5_client_princ + 0x5c ) = *(undefined4*)( val + 0x98 );
                     ...
                     if (piVar5 == (int*)0x0) {
                        for (int i = 0; i < 16; i++) {
                           ses[1].krb5_client_princ[( i + 128 )] = '\0';
                        }
         ...
         LAB_00100630:ASN1_item_free(val, (ASN1_ITEM*)local_it_1);

/* Label3D::get_aabb() const */void Label3D::get_aabb(void) {
   ...
   *(undefined***)this = &PTR__initialize_classv_0012f6d0;
   ...
   LAB_0010831f:if (( *(long*)( this + 0x658 ) != 0 ) && ( cVar4 = RefCounted::unreference() ),cVar4 != '\0') {
   ...
   if (this[0x753] == (Label3D)0x0) {
      ...
      if (lVar32 == 0) {
         ...
         do {
            ...
            if (( lVar32 <= (long)uVar31 ) || ( uVar31 = uVar29 ),lVar32 <= (long)uVar29) goto LAB_0010c769;
...
GetTypeInfo<Array,void>::get_class_info(GetTypeInfo<Array,void> *this){
   ...
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   ...
   long lVar2;
   for (int i = 0; i < 5; i++) {
      if (*(long*)( this + ( -16*i + 88 ) ) != 0) {
         LOCK();
         plVar1 = (long*)( *(long*)( this + ( -16*i + 88 ) ) + -16 );
         *plVar1 = *plVar1 + -1;
         UNLOCK();
         if (*plVar1 == 0) {
            lVar2 = *(long*)( this + ( -16*i + 88 ) );
            *(undefined8*)( this + ( -16*i + 88 ) ) = 0;

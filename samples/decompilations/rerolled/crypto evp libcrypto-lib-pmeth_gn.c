void pkey_fake_import(undefined8 *param_1, undefined8 param_2, undefined8 param_3) {
   for (int i_1634 = 0; i_1634 < 2; i_1634++) {
   ...
   LAB_001000b2:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar3;
   }
   ...
   *puVar1 = param_1;
   puVar1[1] = param_2;
   for (int i_1635 = 0; i_1635 < 2; i_1635++) {
   ...
   *param_2 = uVar1;
   ...
   LAB_001001a6:evp_pkey_ctx_free_old_ops(ctx);
   *(undefined4*)ctx = 0;
   return iVar2;
   ...
   LAB_001002c6:evp_pkey_ctx_free_old_ops(ctx);
   *(undefined4*)ctx = 0;
   return iVar2;
      ...
      if (( param_1->type & 6 ) != 0) {
         ...
         if (lVar6 == 0) {
            ...
            if (pEVar2 == (ENGINE*)0x0) {
               LAB_00100474:lVar6 = evp_keymgmt_util_gen(pEVar7, pcVar8, lVar6, ossl_callback_to_pkey_gencb, param_1);
               if (lVar6 != 0) {
               ...
               local_40[0] = pcVar8;
               uVar5 = evp_pkey_export_to_provider(pEVar2, *(undefined8*)&param_1->references, local_40, param_1->ameth);
               if (local_40[0] == (char*)0x0) goto LAB_001004e0;
               iVar4 = evp_keymgmt_gen_set_template((param_1->pkey).ptr, *(undefined8*)&param_1->save_parameters, uVar5);
               if (iVar4 != 0) {
                  lVar6 = *(long*)&param_1->save_parameters;
                  pEVar7 = (EVP_PKEY*)*param_2;
                  pcVar8 = (param_1->pkey).ptr;
   ...
   EVP_PKEY_free(pkey);
   LAB_00100444:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return iVar4;
   ...
   *(undefined1**)( ctx + 0x60 ) = cb;
   ...
   LAB_00100aa4:/* WARNING: Subroutine does not return */__stack_chk_fail();

...
int MuxSet(long param_1, undefined4 param_2, undefined8 param_3, undefined4 param_4) {
   ...
   if (iVar2 == 1) {
      LAB_00100110:iVar2 = ChunkSetHead(auStack_68, param_1);
      if (iVar2 != 1) {
   ...
   LAB_001000ca:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int SetAlphaAndImageChunks(undefined8 *param_1, undefined4 param_2, long param_3) {
   long lVar1;
   long lVar2;
   undefined4 uVar3;
   int iVar4;
   ...
   if (local_68._0_8_ == 0) {
      LAB_00100340:ChunkInit(local_58);
      iVar4 = ChunkAssignData(local_58, &local_78, param_2, uVar3);
      if (( iVar4 == 1 ) && ( iVar4 = iVar4 == 1 )) {
      ...
      if (( iVar4 == 1 ) && ( iVar4 = iVar4 == 1 )) goto LAB_00100340;
   }

   ChunkRelease(local_58);
   LAB_00100300:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 WebPMuxSetChunk(long param_1, long param_2, long *param_3, undefined4 param_4) {
   undefined4 uVar1;
   undefined8 uVar2;
   if (( ( ( param_2 == 0 || param_3 == (long*)0x0 ) || ( param_1 == 0 ) ) || ( *param_3 == 0 ) ) || ( 0xfffffff6 < (ulong)param_3[1] )) {
      uVar2 = 0xffffffff;
   }
 else {
...
int WebPMuxSetImage(long *param_1, long *param_2, undefined4 param_3) {
   ...
   long local_30;
   local_30 = *(long*)( in_FS_OFFSET + 0x28 );
   if (( ( ( param_1 == (long*)0x0 ) || ( param_2 == (long*)0x0 ) ) || ( *param_2 == 0 ) ) || ( 0xfffffff6 < (ulong)param_2[1] )) {
      iVar1 = -1;
   }
 else {
      lVar2 = *param_1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int WebPMuxPushFrame(undefined8 *param_1, long *param_2, undefined4 param_3) {
   uint uVar1;
   uint uVar2;
   uint uVar3;
   uint uVar4;
   ...
   long local_40;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (( ( ( ( param_1 == (undefined8*)0x0 ) || ( param_2 == (long*)0x0 ) ) || ( *(int*)( (long)param_2 + 0x1c ) != 3 ) ) || ( ( *param_2 == 0 || ( 0xfffffff6 < (ulong)param_2[1] ) ) ) ) || ( ( (undefined8*)*param_1 != (undefined8*)0x0 && ( ( puVar6 = *(undefined4**)*param_1 ),puVar6 == (undefined4*)0x0 || ( iVar7 = ChunkGetIdFromTag(*puVar6) * (int*)( (long)param_2 + 0x1c ) != iVar7 ) ) ) )) {
      iVar7 = -1;
   }
 else {
      ...
      if (iVar7 == 1) {
         ...
         if (( ( ( uVar1 | uVar2 ) & 0xfffffffe | uVar3 ) < 0x1000000 ) && ( uVar4 < 2 )) {
            ...
            if (puVar9 == (ulong*)0x0) {
               ...
               uVar10 = local_54 - 1;
               *puVar9 = ( ( ( ( ( ( ulong )(local_58 - 1U & 0xffff) << 8 | ( ulong )((int)uVar1 >> 0x11 & 0xff) ) << 8 | ( ulong )(( uint )((int)uVar1 >> 1) >> 8 & 0xff) ) << 8 | ( ulong )((int)uVar1 >> 1 & 0xff) ) << 8 | ( ulong )((int)uVar2 >> 0x11 & 0xff) ) << 8 | ( ulong )(( uint )((int)uVar2 >> 1) >> 8 & 0xff) ) << 8 | ( ulong )((int)uVar2 >> 1 & 0xff);
               puVar9[1] = ( ( ( ( ( ( ( ulong )(( uint )(iVar5 == 1) * 2 | uVar4 & 0xff) << 8 | ( ulong )((int)uVar3 >> 0x10 & 0xff) ) << 8 | ( ulong )(uVar3 >> 8 & 0xff) ) << 8 | ( ulong )(uVar3 & 0xff) ) << 8 | ( ulong )((int)uVar10 >> 0x10 & 0xff) ) << 8 | ( ulong )(uVar10 >> 8 & 0xff) ) << 8 | ( ulong )(uVar10 & 0xff) ) << 8 | ( ulong )(byte)(local_58 - 1U >> 0x10);
               local_a8 = puVar9;
               local_a0 = uVar8;
               ChunkInit(local_98);
               iVar7 = ChunkAssignData(local_98, &local_a8, 1, _DAT_00102084);
               if (( iVar7 == 1 ) && ( iVar7 = iVar7 == 1 )) {
                  WebPFree(local_a8);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 WebPMuxSetAnimationParams(long param_1, undefined4 *param_2) {
   undefined8 uVar1;
   long in_FS_OFFSET;
   undefined4 *local_38;
   undefined8 local_30;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 WebPMuxSetCanvasSize(long param_1, uint param_2, uint param_3) {
   undefined8 uVar1;
   if (param_1 != 0) {
      if (( ( ( param_2 < 0x1000001 ) && ( param_3 < 0x1000001 ) ) && ( ( ulong )((long)(int)param_2 * (long)(int)param_3) >> 0x20 == 0 ) ) && ( ( param_2 * param_3 != 0 || ( param_2 == 0 && param_3 == 0 ) ) )) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */ulong WebPMuxAssemble(long *param_1, undefined1 (*param_2)[16]) {
   int *piVar1;
   undefined8 *puVar2;
   byte *pbVar3;
   int iVar4;
   ...
   long local_40;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (( param_2 != (undefined1(*) [16])0x0 ) && ( *param_2 = (undefined1[16])0x0 ),param_1 != (long*)0x0) {
      ...
      if (local_6c == 1) {
         ...
         if ((int)uVar5 != 1) goto LAB_00100c3b;
         if (( *(long*)local_68 != 0 ) && ( ( param_1[7] == 0 || ( param_1[7] == *(long*)( local_68 + 0x20 ) ) ) )) {
            ChunkDelete();
            local_6c = 0;
            for (int i = 0; i < 8; i++) {
               local_68[i] = 0;
      ...
      if (( (int)uVar5 != 1 ) || ( ( ( 0 < (int)local_68 && ( local_6c == 0 ) ) && ( uVar5 = MuxDeleteAllNamedData(param_1, _WebPSafeFree) ),(int)uVar5 != 1 ) )) goto LAB_00100c3b;
      ...
      if (( ( puVar2 != (undefined8*)0x0 ) && ( puVar2[2] != 0 ) ) && ( *(long*)( puVar2[2] + 8 ) != 0 )) {
         ...
         if (plVar13[6] == 0) {
            ...
            do {
               ...
               iVar14 = (int)plVar13[4] + ( (uint)pbVar3[1] << 8 | (uint)pbVar3[2] << 0x10 | ( uint ) * pbVar3 ) * 2;
               if (iVar4 < iVar14) {
                  iVar4 = iVar14;
               }
 ...
 while ( plVar13 != (long*)0x0 );
         ...
         if (( ( iVar4 - 1U < 0x1000000 ) && ( iVar16 - 1U < 0x1000000 ) ) && ( ( iVar17 = iVar16 ),iVar14 = iVar4,param_1[7] == 0 || ( ( iVar14 = (int)param_1[7] ),iVar4 <= iVar14 && ( iVar17 = *(int*)( (long)param_1 + 0x3c ) ),iVar16 <= iVar17 ) )) {
   ...
   LAB_00100c36:uVar5 = 0xffffffff;
   LAB_00100c3b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar5;
   }

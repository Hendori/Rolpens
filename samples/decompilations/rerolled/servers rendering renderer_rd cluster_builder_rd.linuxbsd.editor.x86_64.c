/* ClusterBuilderRD::_clear() [clone .part.0] */void ClusterBuilderRD::_clear(ClusterBuilderRD *this) {
   undefined8 uVar1;
...
/* ClusterBuilderSharedDataRD::~ClusterBuilderSharedDataRD() */void ClusterBuilderSharedDataRD::~ClusterBuilderSharedDataRD(ClusterBuilderSharedDataRD *this) {
   undefined8 uVar1;
   uVar1 = RenderingDevice::get_singleton();
...
/* ClusterBuilderRD::_clear() */void ClusterBuilderRD::_clear(ClusterBuilderRD *this) {
...
/* ClusterBuilderRD::begin(Transform3D const&, Projection const&, bool) */void ClusterBuilderRD::begin(ClusterBuilderRD *this, Transform3D *param_1, Projection *param_2, bool param_3) {
   undefined8 uVar1;
   undefined8 uVar2;
   ...
   *(undefined4*)( this + 0xe0 ) = uVar4;
   ...
   this[0xe8] = CVar3;
   for (int i = 0; i < 8; i++) {
      *(undefined8*)( this + ( 8*i + 96 ) ) = *(undefined8*)( this + ( 8*i + 160 ) );
   }
...
/* ClusterBuilderRD::bake_cluster() */void ClusterBuilderRD::bake_cluster(ClusterBuilderRD *this) {
   long *plVar1;
   uint uVar2;
   code *pcVar3;
   undefined8 uVar4;
 ...
 while ( *(int*)( this + 0xec ) != 1 << ( (byte)iVar8 & 0x1f ) );
      ...
      uVar4 = RenderingDevice::get_singleton();
      RenderingDevice::buffer_update(uVar4, *(undefined8*)( this + 0x120 ), 0, *(int*)( this + 0x28 ) * 0x50, *(undefined8*)( this + 0x20 ));
      plVar1 = RenderingServerGlobals::utilities;
      if ((char)RenderingServerGlobals::utilities[1] != '\0') {
         pcVar3 = *(code**)( *RenderingServerGlobals::utilities + 0x68 );
         local_c0 = 0;
      ...
      uStack_a0 = 0;
      local_b8._8_8_ = 0;
      pvVar5 = (void*)RenderingDevice::draw_list_begin(uVar4, *(undefined8*)( this + 0x108 ), 0, local_b8, 0, &local_a8, 0);
      ...
      uVar4 = RenderingDevice::get_singleton();
      RenderingDevice::draw_list_bind_render_pipeline(uVar4, pvVar5, *(undefined8*)( *(long*)this + 0x1f8 + (ulong)(byte)this[0xf0] * 8 ));
      uVar4 = RenderingDevice::get_singleton();
      ...
      if (*(int*)( this + 0x28 ) != 0) {
         do {
            ...
            if (uVar2 == 1) {
               ...
               uVar4 = RenderingDevice::get_singleton();
               RenderingDevice::draw_list_bind_vertex_array(uVar4, pvVar5, *(undefined8*)( *(long*)this + 0x30 ));
               uVar4 = RenderingDevice::get_singleton();
               RenderingDevice::draw_list_bind_index_array(uVar4, pvVar5, *(undefined8*)( *(long*)this + 0x40 ));
            }
 else if (uVar2 < 2) {
               LAB_00100efe:uVar4 = RenderingDevice::get_singleton();
               RenderingDevice::draw_list_bind_vertex_array(uVar4, pvVar5, *(undefined8*)( *(long*)this + 8 ));
               uVar4 = RenderingDevice::get_singleton();
               RenderingDevice::draw_list_bind_index_array(uVar4, pvVar5, *(undefined8*)( *(long*)this + 0x18 ));
            }
 else if (uVar2 - 2 < 2) {
               uVar4 = RenderingDevice::get_singleton();
               RenderingDevice::draw_list_bind_vertex_array(uVar4, pvVar5, *(undefined8*)( *(long*)this + 0x58 ));
               uVar4 = RenderingDevice::get_singleton();
               RenderingDevice::draw_list_bind_index_array(uVar4, pvVar5, *(undefined8*)( *(long*)this + 0x68 ));
            }
 ...
 while ( uVar9 < *(uint*)( this + 0x28 ) );
      ...
      uVar4 = RenderingDevice::get_singleton();
      RenderingDevice::compute_list_bind_compute_pipeline(uVar4, pvVar5, *(undefined8*)( *(long*)this + 0x390 ));
      uVar4 = RenderingDevice::get_singleton();
      ...
      lVar7 = RenderingDevice::get_singleton();
      RenderingDevice::compute_list_dispatch_threads(lVar7, (uint)pvVar5, *(uint*)( this + 0x100 ), *(uint*)( this + 0x104 ));
      RenderingDevice::get_singleton();
...
/* ClusterBuilderRD::debug(ClusterBuilderRD::ElementType) */void ClusterBuilderRD::debug(ClusterBuilderRD *this, undefined4 param_2) {
   void *pvVar1;
   undefined8 uVar2;
   long lVar3;
   long in_FS_OFFSET;
   ...
   if (*(long*)( this + 0x148 ) == 0) {
      if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
         _err_print_error("debug", "servers/rendering/renderer_rd/cluster_builder_rd.cpp", 0x20e, "Condition \"debug_uniform_set.is_null()\" is true.", 0, 0);
         return;
      }
      ...
      RenderingDevice::compute_list_bind_compute_pipeline(uVar2, pvVar1, *(undefined8*)( *(long*)this + 0x520 ));
      uVar2 = RenderingDevice::get_singleton();
 ...
 while ( *(int*)( this + 0xec ) != 1 << ( (byte)local_48 & 0x1f ) );
      ...
      local_40 = CONCAT44((int)*(undefined8*)( this + 0xe0 ), (int)( ( ulong ) * (undefined8*)( this + 0xe0 ) >> 0x20 ));
      ...
      lVar3 = RenderingDevice::get_singleton();
      RenderingDevice::compute_list_dispatch_threads(lVar3, (uint)pvVar1, *(uint*)( this + 0xf8 ), *(uint*)( this + 0xfc ));
      RenderingDevice::get_singleton();
      RenderingDevice::compute_list_end();
      if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
...
/* ClusterBuilderRD::get_cluster_buffer() const */undefined8 ClusterBuilderRD::get_cluster_buffer(ClusterBuilderRD *this) {
   return *(undefined8*)( this + 0x118 );
}
/* ClusterBuilderRD::get_cluster_size() const */undefined4 ClusterBuilderRD::get_cluster_size(ClusterBuilderRD *this) {
   return *(undefined4*)( this + 0xec );
}
/* ClusterBuilderRD::get_max_cluster_elements() const */undefined4 ClusterBuilderRD::get_max_cluster_elements(ClusterBuilderRD *this) {
   return *(undefined4*)( this + 0x18 );
}
/* ClusterBuilderRD::set_shared(ClusterBuilderSharedDataRD*) */void ClusterBuilderRD::set_shared(ClusterBuilderRD *this, ClusterBuilderSharedDataRD *param_1) {
   *(ClusterBuilderSharedDataRD**)this = param_1;
   return;
}
/* ClusterBuilderRD::ClusterBuilderRD() */void ClusterBuilderRD::ClusterBuilderRD(ClusterBuilderRD *this) {
   long *plVar1;
   long lVar2;
   undefined8 uVar3;
   long in_FS_OFFSET;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ClusterBuilderSharedDataRD::ClusterBuilderSharedDataRD() */void ClusterBuilderSharedDataRD::ClusterBuilderSharedDataRD(ClusterBuilderSharedDataRD *this) {
   ShaderRD *this_00;
   long *plVar1;
   ShaderRD *this_01;
   ShaderRD *this_02;
   ...
   *(undefined1(*) [16])( this + 0x510 ) = (undefined1[16])0x0;
   uStack_e0 = 0;
   uStack_dc = 0;
   iVar10 = CowData<RenderingDeviceCommons::VertexAttribute>::resize<false>((CowData<RenderingDeviceCommons::VertexAttribute>*)&uStack_e0, 1);
   if (iVar10 == 0) {
      if (CONCAT44(uStack_dc, uStack_e0) == 0) {
         ...
         lVar25 = lVar17 + -1;
         if (-1 < lVar25) {
            CowData<RenderingDeviceCommons::VertexAttribute>::_copy_on_write((CowData<RenderingDeviceCommons::VertexAttribute>*)&uStack_e0);
            uVar6 = _UNK_00109268;
            uVar13 = __LC45;
      ...
      _err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar25, lVar17, "p_index", "size()", "", false, false);
   }
 else {
      _err_print_error("push_back", "./core/templates/vector.h", 0x142, "Condition \"err\" is true. Returning: true", 0, 0);
   }

   LAB_00101e9c:pVVar12 = (Vector*)RenderingDevice::get_singleton();
   ...
   if (cVar9 == '\0') {
      local_110[0] = 0;
      iVar10 = CowData<RenderingDevice::AttachmentFormat>::resize<false>((CowData<RenderingDevice::AttachmentFormat>*)local_110, 1);
      if (iVar10 == 0) {
         if (local_110[0] == 0) {
            lVar25 = -1;
            lVar17 = 0;
            ...
            lVar25 = lVar17 + -1;
            if (-1 < lVar25) {
               CowData<RenderingDevice::AttachmentFormat>::_copy_on_write((CowData<RenderingDevice::AttachmentFormat>*)local_110);
      ...
      LAB_001034b6:if (local_110[0] == 0) {
         lVar17 = 0;
         LAB_00103b13:_err_print_index_error("operator[]", "./core/templates/vector.h", 0x38, 0, lVar17, "p_index", "((Vector<T> *)(this))->_cowdata.size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
   ...
   if (*(long*)( this + 0x88 ) != 0) {
      ...
      if (pcVar3 != (char*)0x0) {
         ...
         if (( uVar14 == 0 ) || ( *(uint*)( this + 0x144 ) <= (uint)uVar14 )) {
            LAB_00103a1f:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
            uVar13 = 0;
            goto LAB_00102228;
         }

         lVar25 = ( ( uVar14 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x140 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x130 ) + ( ( uVar14 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x140 ) ) * 8 );
 ...
 while ( lVar17 != 0 );
         ...
         LAB_001039f3:lVar17 = 0;
         goto LAB_001036a4;
      }

      LAB_0010368b:lVar17 = 0;
      goto LAB_0010368e;
   }

   lVar17 = 0;
   LAB_00103724:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 0, lVar17, "p_variant", "variant_defines.size()", "", false, false);
   LAB_00103756:uVar13 = 0;
   LAB_00102228:*(undefined8*)( this + 0x1f0 ) = uVar13;
   uVar13 = RenderingDevice::get_singleton();
   local_150 = (void*)0x0;
   local_f8 = 0;
   local_e8 = 0;
   ...
   uVar13 = RenderingDevice::render_pipeline_create(uVar13, *(undefined8*)( this + 0x1f0 ), local_180, pVVar12, 5, (Vector<String>*)&local_148, (StrRange*)&local_118, &local_e8, local_98, 0, 0, (StrRange*)&local_158);
   lVar17 = local_100;
   ...
   *(ulong*)( this + 0x380 ) = uVar14;
   if (*(long*)( this + 0x220 ) != 0) {
      ...
      if (( uVar14 == 0 ) || ( *(uint*)( this + 0x2dc ) <= (uint)uVar14 )) {
         LAB_00103b89:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
         uVar13 = 0;
         goto LAB_0010272d;
      }

      lVar25 = ( ( uVar14 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x2d8 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x2c8 ) + ( ( uVar14 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x2d8 ) ) * 8 );
      if (*(int*)( lVar25 + 0x98 ) != (int)( uVar14 >> 0x20 )) {
         if (*(int*)( lVar25 + 0x98 ) + 0x80000000U < 0x7fffffff) {
            _err_print_error("get_or_null", "./core/templates/rid_owner.h", 0x103, "Method/function failed. Returning: nullptr", "Attempting to use an uninitialized RID", 0, 0);
         }
 ...
 while ( lVar17 != 0 );
   ...
   lVar17 = 0;
   LAB_00103763:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 0, lVar17, "p_variant", "variant_defines.size()", "", false, false);
   LAB_00103795:uVar13 = 0;
   LAB_0010272d:*(undefined8*)( this + 0x388 ) = uVar13;
   uVar13 = RenderingDevice::get_singleton();
   uStack_e0 = 0;
   uStack_dc = 0;
   ...
   *(ulong*)( this + 0x510 ) = uVar14;
   if (*(long*)( this + 0x3b0 ) == 0) {
      lVar17 = 0;
      LAB_00103ad5:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 0, lVar17, "p_variant", "variant_defines.size()", "", false, false);
   }
 else {
      ...
      if (( uVar14 == 0 ) || ( *(uint*)( this + 0x46c ) <= (uint)uVar14 )) {
         LAB_00103c32:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
         uVar13 = 0;
         goto LAB_001029be;
      }

      lVar25 = ( ( uVar14 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x468 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x458 ) + ( ( uVar14 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x468 ) ) * 8 );
      if (*(int*)( lVar25 + 0x98 ) != (int)( uVar14 >> 0x20 )) {
         if (*(int*)( lVar25 + 0x98 ) + 0x80000000U < 0x7fffffff) {
            _err_print_error("get_or_null", "./core/templates/rid_owner.h", 0x103, "Method/function failed. Returning: nullptr", "Attempting to use an uninitialized RID", 0, 0);
         }
 ...
 while ( lVar17 != 0 );
      ...
      lVar17 = *(long*)( puVar4 + -2 );
      if (lVar17 < 1) {
         LAB_0010368e:uVar14 = 0;
         LAB_001036a4:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar14, lVar17, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar5 = (code*)invalidInstructionException();
         ( *pcVar5 )();
   ...
   uVar13 = 0;
   LAB_001029be:*(undefined8*)( this + 0x518 ) = uVar13;
   uVar13 = RenderingDevice::get_singleton();
   uStack_e0 = 0;
   uStack_dc = 0;
   ...
   *(undefined8*)this = uVar13;
   ...
   memcpy((void*)CONCAT44(local_13c, uStack_140), &ClusterBuilderSharedDataRD(), ::icosphere_triangle_indices, sVar21);
   uVar13 = RenderingDevice::get_singleton();
   ...
   *(undefined8*)( this + 0x18 ) = uVar13;
   do {
      ...
      do {
         pfVar15 = pfVar16 + 3;
         lVar17 = ( ulong )(( uint )(ushort)(&ClusterBuilderSharedDataRD(), ::icosphere_triangle_indices)[uVar24] + ( uint )(ushort)(&ClusterBuilderSharedDataRD(), ::icosphere_triangle_indices)[uVar24] * 2) * 4;
         *(undefined8*)pfVar16 = *(undefined8*)( ClusterBuilderSharedDataRD() );
         pfVar16[2] = *(float*)( ClusterBuilderSharedDataRD() );
         pfVar16 = pfVar15;
         uVar24 = ( ulong )((int)uVar24 + 1);
      }
 while ( (float*)( (long)&uStack_48 + 4 ) != pfVar15 );
      fVar28 = ( (float)local_68 - local_60[1] ) * ( local_60[0] - (float)uStack_48 ) - ( (float)local_68 - (float)local_50 ) * ( local_60[0] - local_60[3] );
      fVar27 = ( local_68._4_4_ - local_50._4_4_ ) * ( local_60[0] - local_60[3] ) - ( local_60[0] - (float)uStack_48 ) * ( local_68._4_4_ - local_60[2] );
      fVar33 = ( (float)local_68 - (float)local_50 ) * ( local_68._4_4_ - local_60[2] ) - ( local_68._4_4_ - local_50._4_4_ ) * ( (float)local_68 - local_60[1] );
 ...
 while ( uVar11 != 0xf0 );
   ...
   *(undefined8*)( this + 0x28 ) = uVar13;
   ...
   CowData<unsigned_char>::_copy_on_write((CowData<unsigned_char>*)&uStack_140);
   memcpy((void*)CONCAT44(local_13c, uStack_140), &ClusterBuilderSharedDataRD(), ::cone_triangle_indices, sVar21);
   uVar13 = RenderingDevice::get_singleton();
   ...
   *(undefined8*)( this + 0x40 ) = uVar13;
   do {
      ...
      pfVar16 = (float*)&local_68;
      do {
         lVar17 = ( ulong )(( uint )(ushort)(&ClusterBuilderSharedDataRD(), ::cone_triangle_indices)[( uint )(iVar10 + iVar20)] + ( uint )(ushort)(&ClusterBuilderSharedDataRD(), ::cone_triangle_indices)[( uint )(iVar10 + iVar20)] * 2) * 4;
         *(undefined8*)pfVar16 = *(undefined8*)( ClusterBuilderSharedDataRD() );
         pfVar16[2] = *(float*)( ClusterBuilderSharedDataRD() );
 ...
 while ( iVar10 != 0xba );
   ...
   *(undefined8*)( this + 0x50 ) = uVar13;
   ...
   CowData<unsigned_char>::_copy_on_write((CowData<unsigned_char>*)&uStack_140);
   memcpy((void*)CONCAT44(local_13c, uStack_140), ClusterBuilderSharedDataRD(), ::box_triangle_indices, sVar21);
   uVar13 = RenderingDevice::get_singleton();
...
/* ClusterBuilderRD::setup(Vector2i, unsigned int, RID, RID, RID) */void ClusterBuilderRD::setup(ClusterBuilderRD *this, undefined8 param_2, uint param_3, undefined8 param_4, undefined8 param_5, long param_6) {
   long *plVar1;
   ulong uVar2;
   uint uVar3;
   uint uVar4;
   ...
   local_90 = param_2;
   if (param_3 == 0) {
      _err_print_error("setup", "servers/rendering/renderer_rd/cluster_builder_rd.cpp", 0x107, "Condition \"p_max_elements == 0\" is true.", 0, 0);
   }
 else {
      local_90._0_4_ = (int)param_2;
      if ((int)local_90 < 1) {
         _err_print_error("setup", "servers/rendering/renderer_rd/cluster_builder_rd.cpp", 0x108, "Condition \"p_screen_size.x < 1\" is true.", 0, 0);
      }
 else {
         local_90._4_4_ = (int)( (ulong)param_2 >> 0x20 );
         if (local_90._4_4_ < 1) {
            _err_print_error("setup", "servers/rendering/renderer_rd/cluster_builder_rd.cpp", 0x109, "Condition \"p_screen_size.y < 1\" is true.", 0, 0);
         }
 else {
            ...
            *(uint*)( this + 0x128 ) = ( ( uVar7 >> 5 ) + uVar7 ) * iVar8 * 4;
            ...
            local_70 = 0;
            uVar5 = RenderingDevice::storage_buffer_create(uVar5, *(undefined4*)( this + 0x128 ), &local_78, 0, 0);
            uVar2 = local_70;
            *(undefined8*)( this + 0x110 ) = uVar5;
            ...
            uVar5 = RenderingDevice::get_singleton();
            local_70 = 0;
            uVar5 = RenderingDevice::storage_buffer_create(uVar5, *(undefined4*)( this + 300 ), &local_78, 0, 0);
            uVar2 = local_70;
            ...
            *(undefined8*)( this + 0x20 ) = uVar5;
            uVar5 = RenderingDevice::get_singleton();
            local_70 = 0;
            uVar5 = RenderingDevice::storage_buffer_create(uVar5, *(int*)( this + 0x2c ) * 0x50, &local_78, 0, 0);
            uVar2 = local_70;
            *(undefined8*)( this + 0x120 ) = uVar5;
            ...
            Vector<RenderingDevice::Uniform>::push_back(local_88, &local_78);
            uVar5 = RenderingDevice::get_singleton();
            uVar5 = RenderingDevice::uniform_set_create<Vector<RenderingDevice::Uniform>>(uVar5, local_88, *(undefined8*)( *(long*)this + 0x1f0 ), 0, 0);
            *(undefined8*)( this + 0x130 ) = uVar5;
            ...
            uVar6 = RenderingDevice::uniform_set_create<Vector<RenderingDevice::Uniform>>(uVar6, local_88, *(undefined8*)( *(long*)this + 0x388 ), 0, 0);
            *(undefined8*)( this + 0x138 ) = uVar6;
            ...
            if (param_6 == 0) {
               *(undefined8*)( this + 0x148 ) = 0;
               ...
               Vector<RenderingDevice::Uniform>::push_back(local_88, &local_78);
               uVar5 = RenderingDevice::get_singleton();
               uVar5 = RenderingDevice::uniform_set_create<Vector<RenderingDevice::Uniform>>(uVar5, local_88, *(undefined8*)( *(long*)this + 0x518 ), 0, 0);
...
/* ClusterRenderShaderRD::~ClusterRenderShaderRD() */void ClusterRenderShaderRD::~ClusterRenderShaderRD(ClusterRenderShaderRD *this) {
...
/* ClusterStoreShaderRD::~ClusterStoreShaderRD() */void ClusterStoreShaderRD::~ClusterStoreShaderRD(ClusterStoreShaderRD *this) {
...
/* ClusterDebugShaderRD::~ClusterDebugShaderRD() */void ClusterDebugShaderRD::~ClusterDebugShaderRD(ClusterDebugShaderRD *this) {
...
/* CowData<RenderingDevice::AttachmentFormat>::_copy_on_write() [clone .isra.0] [clone .cold] */void CowData<RenderingDevice::AttachmentFormat>::_copy_on_write(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void FUN_001047d0(void) {
   code *pcVar1;
   _DAT_00000000 = 0;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<String>::resize<false>(long) */undefined8 CowData<String>::resize<false>(CowData<String> *this, long param_1) {
   ...
   if (param_1 * 8 == 0) {
      LAB_00104e60:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (lVar10 == lVar7) {
      LAB_00104ddf:puVar9 = *(undefined8**)this;
      if (puVar9 == (undefined8*)0x0) {
         LAB_00104eb6:/* WARNING: Does not return */pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<RID>::resize<false>(long) */undefined8 CowData<RID>::resize<false>(CowData<RID> *this, long param_1) {
   ...
   if (param_1 * 8 == 0) {
      LAB_00105170:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (lVar7 == lVar3) {
      LAB_001050dc:puVar9 = *(undefined8**)this;
      if (puVar9 == (undefined8*)0x0) {
         /* WARNING: Does not return */
         pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<RenderingDeviceCommons::PipelineColorBlendState::Attachment>::resize<false>(long)
   ...
   if (param_1 * 0x20 == 0) {
      LAB_001055e0:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (lVar11 == lVar4) {
      LAB_0010554c:puVar9 = *(undefined8**)this;
      if (puVar9 == (undefined8*)0x0) {
         /* WARNING: Does not return */
         pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<RenderingDeviceCommons::VertexAttribute>::resize<false>(long) */undefined8 CowData<RenderingDeviceCommons::VertexAttribute>::resize<false>(CowData<RenderingDeviceCommons::VertexAttribute> *this, long param_1) {
   ...
   lVar11 = param_1 * 0x14;
   if (lVar11 == 0) {
      LAB_00105920:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (lVar10 == lVar4) {
      LAB_0010588c:puVar9 = *(undefined8**)this;
      if (puVar9 == (undefined8*)0x0) {
         /* WARNING: Does not return */
         pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<RenderingDevice::AttachmentFormat>::resize<false>(long) */undefined8 CowData<RenderingDevice::AttachmentFormat>::resize<false>(CowData<RenderingDevice::AttachmentFormat> *this, long param_1) {
   ...
   lVar10 = param_1 * 0xc;
   if (lVar10 == 0) {
      LAB_00105c60:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (lVar9 == lVar3) {
      LAB_00105bcc:puVar8 = *(undefined8**)this;
      if (puVar8 == (undefined8*)0x0) {
         /* WARNING: Does not return */
         pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<RenderingDevice::Uniform>::resize<false>(long) */undefined8 CowData<RenderingDevice::Uniform>::resize<false>(CowData<RenderingDevice::Uniform> *this, long param_1) {
   ...
   if (param_1 * 0x28 == 0) {
      LAB_00106000:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (lVar11 == lVar9) {
      LAB_00105f73:puVar7 = *(undefined8**)this;
      if (puVar7 == (undefined8*)0x0) {
         LAB_00106056:/* WARNING: Does not return */pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
      }
 ...
 while ( puVar6 != puVar7 + param_1 * 5 );
   LAB_00105f50:puVar7[-1] = param_1;
   return 0;
}
/* WARNING: Control flow encountered bad instruction data *//* ClusterDebugShaderRD::~ClusterDebugShaderRD() */void ClusterDebugShaderRD::~ClusterDebugShaderRD(ClusterDebugShaderRD *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* ClusterStoreShaderRD::~ClusterStoreShaderRD() */void ClusterStoreShaderRD::~ClusterStoreShaderRD(ClusterStoreShaderRD *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* ClusterRenderShaderRD::~ClusterRenderShaderRD() */void ClusterRenderShaderRD::~ClusterRenderShaderRD(ClusterRenderShaderRD *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

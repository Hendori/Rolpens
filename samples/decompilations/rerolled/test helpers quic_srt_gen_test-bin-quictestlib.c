   ...
   *(void**)( param_7 + 0x60 ) = pvVar4;
   if (pvVar4 == (void*)0x0) {
      ...
      *(undefined8*)( param_7 + 8 ) = *param_1;
      for (int i_1284 = 0; i_1284 < 4; i_1284++) {
         *(undefined8*)( param_7 + ( 16*i_1284 + 16 ) ) = uVar6;
         uVar6 = param_1[( 2*i_1284 + 3 )];
         *(undefined8*)( param_7 + ( 16*i_1284 + 24 ) ) = param_1[( 2*i_1284 + 2 )];
      }
         ...
         if (iVar1 != 0) {
            ...
            if (iVar1 != 0) {
               ...
               if (iVar1 == 0) {
                  ...
                  for (int i_1285 = 0; i_1285 < 2; i_1285++) {
                     pBStack_80 = local_b0;
                  }

/* FileAccessCompressed::is_open() const */bool FileAccessCompressed::is_open(FileAccessCompressed *this) {
   ...
   *(undefined8*)( this + 0x1d0 ) = *(undefined8*)( this + 0x218 );
   ...
   ( *pcVar5 )();
}if (( *(long**)( this + 0x220 ) != (long*)0x0 ) && ( cVar9 = RefCounted::unreference() ),cVar9 != '\0') {
   ...
   *(undefined***)this = &PTR__initialize_classv_00104d80;
   ...
   undefined8 CowData<FileAccessCompressed::ReadBlock>::_realloc(CowData<FileAccessCompressed::ReadBlock> *this, long param_1) {
      undefined8 *puVar1;
      puVar1 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), param_1 + 0x10, false);
      if (puVar1 != (undefined8*)0x0) {
         *puVar1 = 1;
   ...
   undefined8 CowData<FileAccessCompressed::ReadBlock>::resize<false>(CowData<FileAccessCompressed::ReadBlock> *this, long param_1) {
      long *plVar1;
      code *pcVar2;
      long lVar3;
      ulong uVar4;

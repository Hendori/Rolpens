undefined1 *x942kdf_settable_ctx_params(void) {
   ...
   return puVar2;
}bool der_encode_sharedinfo(undefined8 param_1, long param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5, long param_6, undefined8 param_7, long param_8, undefined8 param_9, long param_10, undefined8 param_11, long param_12, undefined8 param_13, long param_14, undefined8 param_15, int param_16, long *param_17) {
   int iVar1;
   long lVar2;
   if (param_2 == 0) {
   ...
   if (( ( ( ( ( iVar1 != 0 ) && ( iVar1 = ossl_DER_w_begin_sequence(param_1, 0xffffffff) ),iVar1 != 0 ) ) && ( ( param_14 == 0 || ( iVar1 = ossl_DER_w_octet_string(param_1, 3, param_14, param_15) ),iVar1 != 0 ) ) ) ) && ( ( ( param_12 == 0 || ( iVar1 = ossl_DER_w_octet_string(param_1, 2, param_12, param_13) ),iVar1 != 0 ) ) && ( ( param_16 == 0 || ( iVar1 = ossl_DER_w_octet_string_uint32(param_1, 2, param_16) ),iVar1 != 0 ) ) )) ( ( ( param_10 == 0 || ( iVar1 = ossl_DER_w_octet_string(param_1, 1, param_10, param_11) ),iVar1 != 0 ) ) && ( ( param_8 == 0 || ( iVar1 = ossl_DER_w_octet_string(param_1, 0, param_8, param_9) ),iVar1 != 0 ) ) ) && ( ( ( ( param_6 == 0 || ( iVar1 = ossl_DER_w_precompiled(param_1, 0xffffffff, param_6, param_7) ),iVar1 != 0 ) ) && ( iVar1 = ossl_DER_w_begin_sequence(param_1, 0xffffffff) ),iVar1 != 0 ) ) && ( iVar1 = iVar1 != 0 )(param_17 != (long*)0x0);
   {
...
}return false;}void x942kdf_reset(undefined8 *param_1) {
   undefined8 uVar1;
   ulong uVar2;
   undefined8 *puVar3;
   byte bVar4;
   ...
   for (int i_942 = 0; i_942 < 4; i_942++) {
      CRYPTO_clear_free(param_1[( i_942 + 8 )], param_1[( i_942 + 12 )], "providers/implementations/kdfs/x942kdf.c", ( i_942 + 359 ));
   }
   param_1[0x13] = 0;
   param_1[1] = 0;
   puVar3 = (undefined8*)( ( ulong )(param_1 + 2) & 0xfffffffffffffff8 );
   for (uVar2 = ( ulong )(( (int)( param_1 + 1 ) - (int)(undefined8*)( ( ulong )(param_1 + 2) & 0xfffffffffffffff8 ) ) + 0x98U >> 3); uVar2 != 0; uVar2 = uVar2 - 1) {
      *puVar3 = 0;
   ...
   *(undefined4*)( param_1 + 0x13 ) = 1;
   ...
   if (( iVar2 != 0 ) && ( ptr = (undefined8*)CRYPTO_zalloc(0xa0, "providers/implementations/kdfs/x942kdf.c", 0x155) ),ptr != (undefined8*)0x0) {
      *ptr = uVar1;
      uVar1 = param_1[5];
      *(undefined4*)( ptr + 0x13 ) = 1;
      iVar2 = ossl_prov_memdup(param_1[4], uVar1, ptr + 4, ptr + 5);
      if (( ( iVar2 != 0 ) && ( ( ( iVar2 = ossl_prov_memdup(param_1[6], param_1[7], ptr + 6, ptr + 7) ),iVar2 != 0 && ( iVar2 = ossl_prov_memdup(param_1[8], param_1[0xc], ptr + 8, ptr + 0xc) ),iVar2 != 0 ) ) && ( iVar2 = ossl_prov_memdup(param_1[9], param_1[0xd], ptr + 9, ptr + 0xd) ),iVar2 != 0 )) {
   ...
   if (( param_2 == (long*)0x0 ) || ( *param_2 == 0 )) {
      LAB_00100980:uVar2 = 1;
   } else {
      lVar3 = OSSL_PARAM_locate_const(param_2, "digest");
      if (lVar3 == 0) {
         LAB_00100610:lVar3 = OSSL_PARAM_locate_const(param_2, "secret");
         if (( ( ( lVar3 != 0 ) || ( lVar3 = OSSL_PARAM_locate_const(param_2, &_LC4) ),lVar3 != 0 ) ) && ( *(long*)( lVar3 + 0x18 ) != 0 )) {
               ...
               if (lVar3 != 0) {
                  ...
                  do {
                     ...
                     if (iVar1 != 0) {
                        ...
                        param_1[0x11] = ( &PTR_ossl_der_oid_id_aes128_wrap_00101588 )[lVar5 * 4];
                        param_1[0x12] = ( &DAT_00101590 )[lVar5 * 4];
                        param_1[0x10] = ( &DAT_00101598 )[lVar5 * 4];
                        goto LAB_00100980;
                     }
                     lVar5 = lVar5 + 1;
                     ppuVar6 = ppuVar6 + 4;
   ...
   if (( iVar14 != 0 ) && ( iVar14 = iVar14 != 0 )) {
      if (( *(int*)( param_1 + 0x98 ) == 0 ) || ( *(long*)( param_1 + 0x50 ) == 0 )) {
         if (( *(long*)( param_1 + 0x30 ) == 0 ) || ( ( ( ( *(long*)( param_1 + 0x40 ) == 0 && ( *(long*)( param_1 + 0x48 ) == 0 ) ) && ( *(long*)( param_1 + 0x50 ) == 0 ) ) && ( *(long*)( param_1 + 0x58 ) == 0 ) ) )) {
                  ...
                  if (( lVar1 == 0 ) || ( lVar2 = lVar2 == 0 )) {
                     ...
                     if (( lVar3 == 0 ) || ( uVar4 < 0x40000000 )) {
                        ...
                        if (*(int*)( param_1 + 0x98 ) == 0) {
                           local_f4 = 0;
                           LAB_00100c1a:local_d0 = 0;
                           local_d8 = (char*)0x0;
                           iVar14 = der_encode_sharedinfo(local_c8, 0, 0, lVar1, lVar2, uVar12, uVar11, lVar3, uVar4, uVar10, uVar9, uVar8, uVar7, uVar6, uVar5, local_f4, 0);
                           if (( iVar14 != 0 ) && ( iVar14 = WPACKET_get_total_written(local_c8, &local_d0) ),iVar14 != 0) {
                              WPACKET_cleanup(local_c8);
                              d = (void*)CRYPTO_zalloc(local_d0, "providers/implementations/kdfs/x942kdf.c", 0xe8);
                              if (( d != (void*)0x0 ) && ( ( ( ( iVar14 = der_encode_sharedinfo(local_c8, d, local_d0, lVar1, lVar2, uVar12, uVar11, lVar3, uVar4, uVar10, uVar9, uVar8, uVar7, uVar6, uVar5, local_f4, &local_d8) ),iVar14 != 0 && ( pvVar16 = (void*)WPACKET_get_curr(local_c8) ),uVar4 = local_d0,pcVar13 = local_d8,d == pvVar16 ) ) && ( local_d8 != (char*)0x0 ) ) && ( ( *local_d8 == '\x04' && ( local_d8[1] == '\x04' ) ) )) {
                                 WPACKET_cleanup(local_c8);
                                 ...
                                 if (( cnt < 0x40000001 ) && ( ( uVar4 < 0x40000001 && ( param_3 - 1 < 0x40000000 ) ) )) {
                                    ...
                                    uVar17 = (ulong)iVar14;
                                    if (iVar14 < 1) goto LAB_00101065;
                                    out = (EVP_MD_CTX*)EVP_MD_CTX_new();
                                    ctx = (EVP_MD_CTX*)EVP_MD_CTX_new();
                                    if (( ( out != (EVP_MD_CTX*)0x0 ) && ( ctx != (EVP_MD_CTX*)0x0 ) ) && ( iVar14 = iVar14 != 0 )) {
                                       uVar18 = 1;
                                       while (true) {
                                          *(uint*)( pcVar13 + 2 ) = uVar18 >> 0x18 | ( uVar18 & 0xff0000 ) >> 8 | ( uVar18 & 0xff00 ) << 8 | uVar18 << 0x18;
                                          iVar14 = EVP_MD_CTX_copy_ex(out, ctx);
                                          if (( ( iVar14 == 0 ) || ( iVar14 = EVP_DigestUpdate(out, pvVar16, cnt) ),iVar14 == 0 )) goto LAB_00100fe9;
                                          if (param_3 < uVar17) break;
                                          iVar14 = EVP_DigestFinal_ex(out, param_2, (uint*)0x0);
                                          if (iVar14 == 0) goto LAB_00100fe9;
                                          param_2 = param_2 + uVar17;
                                          param_3 = param_3 - uVar17;
                                          if (param_3 == 0) goto LAB_001010e0;
                                          uVar18 = uVar18 + 1;
                                       };
                                       iVar14 = EVP_DigestFinal_ex(out, local_88, (uint*)0x0);
                                       if (iVar14 != 0) {
                                          memcpy(param_2, local_88, param_3);
                                          LAB_001010e0:uVar15 = 1;
                                          goto LAB_00100feb;
                                       }
                                    }
                                    LAB_00100fe9:uVar15 = 0;
                                    LAB_00100feb:EVP_MD_CTX_free(out);
                                    EVP_MD_CTX_free(ctx);
   ...
   uVar15 = 0;
   LAB_00100a5f:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {

   ...
   *(void**)( param_7 + 0x60 ) = pvVar4;
   if (pvVar4 == (void*)0x0) {
      ...
      *(undefined8*)( param_7 + 8 ) = *param_1;
      for (int i_1238 = 0; i_1238 < 4; i_1238++) {
         *(undefined8*)( param_7 + ( 16*i_1238 + 16 ) ) = uVar6;
         uVar6 = param_1[( 2*i_1238 + 3 )];
         *(undefined8*)( param_7 + ( 16*i_1238 + 24 ) ) = param_1[( 2*i_1238 + 2 )];
      }
         ...
         if (iVar1 != 0) {
            ...
            if (iVar1 != 0) {
               ...
               if (iVar1 == 0) {
                  ...
                  for (int i_1239 = 0; i_1239 < 2; i_1239++) {
                     pBStack_80 = local_b0;
                  }

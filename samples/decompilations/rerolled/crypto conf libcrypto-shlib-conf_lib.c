void lh_CONF_VALUE_doall_SECTION_NAMES_thunk(undefined8 param_1, undefined8 param_2, code *UNRECOVERED_JUMPTABLE) {
   for (int i_2358 = 0; i_2358 < 2; i_2358++) {
   ...
   if (conf != (CONF*)0x0) {
      for (int i_2359 = 0; i_2359 < 2; i_2359++) {
   ...
   if (conf != (CONF*)0x0) {
      for (int i_2360 = 0; i_2360 < 2; i_2360++) {
   ...
   int iVar1;
   if (conf != (CONF*)0x0) {
      for (int i_2361 = 0; i_2361 < 2; i_2361++) {
   ...
   int iVar1;
   if (conf != (CONF*)0x0) {
      for (int i_2362 = 0; i_2362 < 2; i_2362++) {
   ...
   int iVar1;
   if (conf != (CONF*)0x0) {
      for (int i_2363 = 0; i_2363 < 2; i_2363++) {

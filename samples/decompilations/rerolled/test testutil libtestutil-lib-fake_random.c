undefined8 fake_rand_instantiate(long param_1) {
   ...
   *param_3 = 0;
   ...
   return puVar1;
}undefined8 fake_rand_provider_init(undefined8 param_1, undefined8 param_2, undefined8 *param_3, undefined8 *param_4) {
   undefined8 uVar1;
   ...
   *param_4 = uVar1;
   ...
   iVar2 = test_true("test/testutil/fake_random.c", 0xc0, "OSSL_PROVIDER_add_builtin(libctx, \"fake-rand\", fake_rand_provider_init)", iVar2 != 0);
   if (iVar2 != 0) {
      iVar2 = RAND_set_DRBG_type(param_1, &_LC7, 0, 0, 0);
      iVar2 = test_true("test/testutil/fake_random.c", 0xc2, "RAND_set_DRBG_type(libctx, \"fake\", NULL, NULL, NULL)", iVar2 != 0);
      if (iVar2 != 0) {
         uVar3 = OSSL_PROVIDER_try_load(param_1, "fake-rand", 1);
         iVar2 = test_ptr("test/testutil/fake_random.c", 0xc3, "p = OSSL_PROVIDER_try_load(libctx, \"fake-rand\", 1)", uVar3);
         if (iVar2 != 0) {
            ...
            iVar2 = test_true("test/testutil/fake_random.c", 199, "check_rng(RAND_get0_primary(libctx), \"primary\")", iVar2 != 0);
            if (iVar2 != 0) {
               ...
               iVar2 = test_true("test/testutil/fake_random.c", 200, "check_rng(RAND_get0_private(libctx), \"private\")", iVar2 != 0);
               if (iVar2 != 0) {
                  ...
                  iVar2 = test_true("test/testutil/fake_random.c", 0xc9, "check_rng(RAND_get0_public(libctx), \"public\")", iVar2 != 0);
                  if (iVar2 != 0) {
                     return uVar3;
                  }
               }

...
undefined4 __thiscall EditorZoomWidget::get_zoom(EditorZoomWidget *this)
...
/* EditorZoomWidget::_notification(int) [clone .part.0] */

void EditorZoomWidget::_notification(int param_1)

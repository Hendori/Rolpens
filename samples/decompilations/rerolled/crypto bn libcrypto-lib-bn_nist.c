int BN_nist_mod_224(BIGNUM *r, BIGNUM *a, BIGNUM *p, BN_CTX *ctx) {
   ...
   if (iVar3 == 0) {
      ...
      if (iVar3 < 1) {
         ...
         if (iVar4 < 4) {
            ...
            *(undefined8*)( (long)auStack_90 + (ulong)uVar5 + (long)(int)uVar11 * 8 ) = 0;
            ...
            if (auStack_90 + 1 == puVar1 + 4) {
               auStack_90[1] = puVar1[3];
               auStack_90[2] = puVar1[4];
               LAB_0010015b:auStack_90[3] = puVar1[5];
               if (uVar11 == 3) goto LAB_0010017d;
               auStack_90[4] = puVar1[6];
            } else {
               for (int i_2316 = 0; i_2316 < 4; i_2316++) {
                  auStack_90[( i_2316 + 1 )] = puVar1[( i_2316 + 3 )];
               }
               if (( uVar11 & 1 ) != 0) {
         ...
         if ((int)uVar11 < 1) {
            if (( uVar11 == 0 ) || ( uVar8 = bn_add_words(rp, rp, (ulong*)( _nist_p_224 + (long)(int)~uVar11 * 0x20 ), 4) ),(int)uVar8 != 0) {
               bVar13 = 0;
               goto LAB_00100310;
            }
            bn_add_words(puVar1, rp, (ulong*)_nist_p_224, 4);
            LAB_00100330:puVar9 = puVar1;
         } else {
            bn_sub_words(rp, rp, (ulong*)( _nist_p_224 + (long)(int)( uVar11 - 1 ) * 0x20 ), 4);
            bVar13 = ( byte ) * (undefined4*)( (long)rp + 0x1c ) & 1;
            LAB_00100310:uVar8 = bn_sub_words(puVar1, rp, (ulong*)_nist_p_224, 4);
            if (( uVar8 == 0 ) || ( puVar9 = bVar13 != 0 )) goto LAB_00100330;
         }
         if (rp == puVar9 + 1) {
            uVar8 = *puVar9;
            for (int i_2317 = 0; i_2317 < 4; i_2317++) {
               puVar9[( i_2317 + 1 )] = uVar8;
            }
         } else {
            uVar8 = puVar9[1];
            *rp = *puVar9;
   ...
   LAB_00100366:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar11;
   }
   LAB_001004b8:/* WARNING: Subroutine does not return */__stack_chk_fail();
   ...
   if (iVar1 == 0) {
      ...
      if (iVar1 < 0) {
         ...
         if (iVar1 == 0) {
            ...
            if (iVar1 < 1) {
               ...
               if (a != r) {
                  ...
                  if (rp == puVar4 + 1) {
                     *rp = *puVar4;
                     for (int i_2318 = 0; i_2318 < 7; i_2318++) {
                        rp[( i_2318 + 1 )] = puVar4[( i_2318 + 1 )];
                     }
                     uVar6 = puVar4[8];
                  } else {
                     uVar6 = puVar4[1];
               ...
               if (iVar2 < 9) {
                  uVar7 = 0;
                  LAB_00100695:uVar6 = ( ulong )(9 - uVar7) << 3;
                  *(undefined8*)( (long)auStack_90 + ( uVar6 & 0xffffffff ) + (long)(int)uVar7 * 8 ) = 0;
                  ...
                  if (auStack_90 + 1 == puVar4 + 9) {
                     auStack_90[1] = puVar4[8];
                     auStack_90[2] = puVar4[9];
                     LAB_00100629:auStack_90[3] = puVar4[10];
                     if (( ( ( uVar7 == 3 ) || ( uStack_70 = puVar4[0xb] ),uVar7 == 4 ) ) || ( uStack_68 = uVar7 == 5 )) goto LAB_00100695;
                     ...
                     if (( uVar7 & 1 ) != 0) {
                        auStack_90[(long)(int)( uVar7 & 0xfffffffe ) + 1] = puVar4[( ulong )(uVar7 & 0xfffffffe) + 8];
                     }
                  }
               ...
               if (rp == puVar4 + 1) {
                  uVar6 = *puVar4;
                  for (int i_2319 = 0; i_2319 < 9; i_2319++) {
                     puVar4[( i_2319 + 1 )] = uVar6;
                  }
               } else {
                  uVar6 = puVar4[1];
                  *rp = *puVar4;
         ...
         LAB_001007d8:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            return uVar7;
         }
         goto LAB_00100945;
      }
   ...
   LAB_00100945:/* WARNING: Subroutine does not return */auStack_90[0] = 0x10094a;
   __stack_chk_fail();
   ...
   if (iVar1 == 0) {
      ...
      if (iVar1 < 1) {
         ...
         *(int*)( rp + 1 ) = (int)lVar4;
         lVar4 = (ulong)local_74 + ( lVar4 >> 0x20 ) + ( ulong ) * (uint*)( (long)rp + 0xc ) + (ulong)local_6c + uVar6;
         ...
         *(int*)( (long)rp + 0x14 ) = (int)lVar4;
         if (lVar4 >> 0x20 == 0) {
            ...
            uVar6 = bn_sub_words(rp, rp, (ulong*)( _nist_p_192 + (long)( (int)( (ulong)lVar4 >> 0x20 ) + -1 ) * 0x18 ), 3);
            bVar12 = (int)uVar6 == 0;
         }
         uVar6 = bn_sub_words(local_58, rp, (ulong*)_nist_p_192, 3);
         if (( uVar6 == 0 ) || ( puVar7 = bVar12 )) {
            puVar7 = local_58;
         }
         *rp = *puVar7;
         rp[1] = puVar7[1];
   ...
   LAB_00100ba8:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar10;
   }
   LAB_00100c41:/* WARNING: Subroutine does not return */__stack_chk_fail();
   ...
   if (iVar1 == 0) {
      ...
      if (iVar1 < 1) {
         ...
         *(int*)rp = (int)lVar4;
         ...
         lVar4 = ( ( ( ( ( ulong ) * (uint*)( (long)rp + 4 ) + ( lVar4 >> 0x20 ) + uVar17 + uVar15 ) - uVar13 ) - uVar9 ) - uVar11 ) - uVar16;
         *(int*)( (long)rp + 4 ) = (int)lVar4;
         lVar4 = ( ( ( ( lVar4 >> 0x20 ) + (ulong)(uint)rp[1] + uVar15 + uVar14 ) - uVar9 ) - uVar11 ) - uVar16;
         *(int*)( rp + 1 ) = (int)lVar4;
         lVar4 = ( ( ( ( lVar4 >> 0x20 ) + ( ulong ) * (uint*)( (long)rp + 0xc ) + uVar14 * 2 + uVar13 * 2 + uVar9 ) - uVar16 ) - uVar7 ) - uVar17;
         *(int*)( (long)rp + 0xc ) = (int)lVar4;
         lVar4 = ( ( ( lVar4 >> 0x20 ) + (ulong)(uint)rp[2] + uVar13 * 2 + uVar9 * 2 + uVar11 ) - uVar17 ) - uVar15;
         *(int*)( rp + 2 ) = (int)lVar4;
         lVar4 = ( ( ( lVar4 >> 0x20 ) + ( ulong ) * (uint*)( (long)rp + 0x14 ) + uVar9 * 2 + uVar11 * 2 + uVar16 ) - uVar15 ) - uVar14;
         *(int*)( (long)rp + 0x14 ) = (int)lVar4;
         lVar4 = ( ( ( lVar4 >> 0x20 ) + (ulong)(uint)rp[3] + uVar11 * 3 + uVar16 * 2 + uVar9 ) - uVar7 ) - uVar17;
         *(int*)( rp + 3 ) = (int)lVar4;
         lVar4 = ( ( ( ( uVar7 + ( lVar4 >> 0x20 ) + ( ulong ) * (uint*)( (long)rp + 0x1c ) + uVar16 * 3 ) - uVar15 ) - uVar14 ) - uVar13 ) - uVar9;
         *(int*)( (long)rp + 0x1c ) = (int)lVar4;
         uVar12 = ( uint )((ulong)lVar4 >> 0x20);
         if (lVar4 >> 0x20 < 1) {
            if (( lVar4 >> 0x20 == 0 ) || ( uVar7 = bn_add_words(rp, rp, (ulong*)( _nist_p_256 + (long)(int)~uVar12 * 0x20 ), 4) ),(int)uVar7 != 0) {
               bVar18 = false;
               goto LAB_00100f10;
            }
            bn_add_words(local_68, rp, (ulong*)_nist_p_256, 4);
            LAB_00100f35:puVar8 = local_68;
         } else {
            uVar7 = bn_sub_words(rp, rp, (ulong*)( _nist_p_256 + (long)(int)( uVar12 - 1 ) * 0x20 ), 4);
            bVar18 = (int)uVar7 == 0;
            LAB_00100f10:uVar7 = bn_sub_words(local_68, rp, (ulong*)_nist_p_256, 4);
            if (( uVar7 == 0 ) || ( puVar8 = bVar18 )) goto LAB_00100f35;
         }
         if (rp == puVar8 + 1) {
            uVar7 = *puVar8;
            for (int i_2320 = 0; i_2320 < 4; i_2320++) {
               puVar8[( i_2320 + 1 )] = uVar7;
            }
         } else {
            uVar7 = puVar8[1];
            *rp = *puVar8;
   ...
   LAB_00100f6b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar12;
   }
   LAB_00101058:/* WARNING: Subroutine does not return */__stack_chk_fail();
   ...
   if (iVar1 == 0) {
      ...
      if (iVar1 < 1) {
         ...
         if (a != r) {
            ...
            if (rp == puVar8 + 1) {
               *rp = *puVar8;
               for (int i_2321 = 0; i_2321 < 5; i_2321++) {
                  rp[( i_2321 + 1 )] = puVar8[( i_2321 + 1 )];
               }
            } else {
               uVar7 = puVar8[1];
               *rp = *puVar8;
         ...
         *(int*)rp = (int)lVar4;
         ...
         lVar4 = ( ( ( ulong ) * (uint*)( (long)rp + 4 ) + ( lVar4 >> 0x20 ) + uVar9 + uVar17 + uVar15 ) - uVar7 ) - uVar16;
         *(int*)( (long)rp + 4 ) = (int)lVar4;
         lVar4 = ( ( ( lVar4 >> 0x20 ) + (ulong)(uint)rp[1] + uVar11 + uVar15 ) - uVar9 ) - uVar18;
         *(int*)( rp + 1 ) = (int)lVar4;
         uVar14 = (ulong)local_9c;
         lVar4 = ( ( ( ( ulong ) * (uint*)( (long)rp + 0xc ) + ( lVar4 >> 0x20 ) + uVar14 + uVar7 + uVar16 + uVar18 ) - uVar11 ) - uVar17 ) - uVar15;
         *(int*)( (long)rp + 0xc ) = (int)lVar4;
         uVar13 = (ulong)local_98;
         lVar4 = ( ( ( lVar4 >> 0x20 ) + (ulong)(uint)rp[2] + uVar18 * 2 + uVar13 + uVar9 + uVar7 + uVar16 + uVar17 ) - uVar14 ) + uVar15 * -2;
         *(int*)( rp + 2 ) = (int)lVar4;
         uVar7 = (ulong)local_94;
         lVar4 = ( uVar9 + ( lVar4 >> 0x20 ) + ( ulong ) * (uint*)( (long)rp + 0x14 ) + uVar17 * 2 + uVar7 + uVar11 + uVar18 + uVar15 ) - uVar13;
         *(int*)( (long)rp + 0x14 ) = (int)lVar4;
         uVar9 = (ulong)local_90;
         lVar4 = ( uVar11 + (ulong)(uint)rp[3] + ( lVar4 >> 0x20 ) + uVar15 * 2 + uVar9 + uVar14 + uVar17 ) - uVar7;
         *(int*)( rp + 3 ) = (int)lVar4;
         uVar11 = (ulong)local_8c;
         lVar4 = ( uVar14 + ( lVar4 >> 0x20 ) + ( ulong ) * (uint*)( (long)rp + 0x1c ) + uVar11 + uVar13 + uVar15 ) - uVar9;
         *(int*)( (long)rp + 0x1c ) = (int)lVar4;
         lVar4 = ( uVar13 + ( lVar4 >> 0x20 ) + (ulong)(uint)rp[4] + uVar16 + uVar7 ) - uVar11;
         *(int*)( rp + 4 ) = (int)lVar4;
         lVar4 = ( uVar7 + ( ulong ) * (uint*)( (long)rp + 0x24 ) + ( lVar4 >> 0x20 ) + uVar18 + uVar9 ) - uVar16;
         *(int*)( (long)rp + 0x24 ) = (int)lVar4;
         lVar4 = ( uVar9 + ( lVar4 >> 0x20 ) + (ulong)(uint)rp[5] + uVar17 + uVar11 ) - uVar18;
         *(int*)( rp + 5 ) = (int)lVar4;
         lVar4 = ( uVar11 + uVar16 + uVar15 + ( ulong ) * (uint*)( (long)rp + 0x2c ) + ( lVar4 >> 0x20 ) ) - uVar17;
         *(int*)( (long)rp + 0x2c ) = (int)lVar4;
         iVar2 = (int)( (ulong)lVar4 >> 0x20 );
         if (lVar4 >> 0x20 < 1) {
            if (( lVar4 >> 0x20 == 0 ) || ( uVar7 = bn_add_words(rp, rp, (ulong*)( _nist_p_384 + ( iVar2 + 1U & 0x30 ) ), 6) ),(int)uVar7 != 0) {
               bVar19 = false;
               goto LAB_00101390;
            }
            bn_add_words(local_78, rp, (ulong*)_nist_p_384, 6);
            LAB_001013b5:puVar8 = local_78;
         } else {
            uVar7 = bn_sub_words(rp, rp, (ulong*)( _nist_p_384 + (long)( iVar2 + -1 ) * 0x30 ), 6);
            bVar19 = (int)uVar7 == 0;
            LAB_00101390:uVar7 = bn_sub_words(local_78, rp, (ulong*)_nist_p_384, 6);
            if (( uVar7 == 0 ) || ( puVar8 = bVar19 )) goto LAB_001013b5;
         }
         if (rp == puVar8 + 1) {
            uVar7 = *puVar8;
            for (int i_2322 = 0; i_2322 < 6; i_2322++) {
               puVar8[( i_2322 + 1 )] = uVar7;
            }
         } else {
            uVar7 = puVar8[1];
            *rp = *puVar8;
   ...
   LAB_001013f4:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar12;
   }
   LAB_00101500:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* WARNING: Unknown calling convention -- yet parameter storage is locked */BIGNUM *BN_get0_nist_prime_192(void) {
   return (BIGNUM*)ossl_bignum_nist_p_192;
}/* WARNING: Unknown calling convention -- yet parameter storage is locked */BIGNUM *BN_get0_nist_prime_224(void) {
   return (BIGNUM*)ossl_bignum_nist_p_224;
}/* WARNING: Unknown calling convention -- yet parameter storage is locked */BIGNUM *BN_get0_nist_prime_256(void) {
   return (BIGNUM*)ossl_bignum_nist_p_256;
}/* WARNING: Unknown calling convention -- yet parameter storage is locked */BIGNUM *BN_get0_nist_prime_384(void) {
   return (BIGNUM*)ossl_bignum_nist_p_384;
}/* WARNING: Unknown calling convention -- yet parameter storage is locked */BIGNUM *BN_get0_nist_prime_521(void) {

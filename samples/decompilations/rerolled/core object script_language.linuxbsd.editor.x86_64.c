   ...
   if (( ( *(code**)( *(long*)pOVar3 + 0x2d8 ) == Script::is_placeholder_fallback_enabled ) || ( ( cVar1 = ( **(code**)( *(long*)pOVar3 + 0x2d8 ) )(pOVar3) ),cVar1 == '\0' && ( pOVar3 = *(Object**)( param_1 + 0x80 ) ),pOVar3 != (Object*)0x0 ) )) {
      LAB_001023a8:do {
         ...
         if (local_38 == pOVar3) {
            cVar1 = RefCounted::unreference();
            pOVar5 = local_38;
            if (( cVar1 == '\0' ) || ( cVar1 = predelete_handler(local_38) ),cVar1 == '\0') goto LAB_001023a8;
...
;
      ...
      if (( cVar10 != '\0' ) && ( lVar14 = *(long*)( *(long*)( param_2 + 0x50 ) + (ulong)local_44 * 8 ) ),lVar14 != 0) {
...
/* ScriptLanguage::debug_get_current_stack_info() */ScriptLanguage * ScriptLanguage::debug_get_current_stack_info(ScriptLanguage * this) * (undefined8*)( this + 8 ) = 0 ;return this;}/* ScriptLanguage::handles_global_class_type(String const&) const */undefined8 ScriptLanguage::handles_global_class_type(String *param_1) {
   return 0;
}

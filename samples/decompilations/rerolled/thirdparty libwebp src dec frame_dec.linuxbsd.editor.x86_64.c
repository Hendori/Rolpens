/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void Dither8x8(int *param_1, undefined8 param_2, undefined4 param_3, int param_4) {
   int iVar1;
   int iVar2;
   int iVar3;
   int iVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void ReconstructRow(long param_1, int *param_2) {
   long lVar1;
   undefined8 *puVar2;
   undefined8 *puVar3;
   int iVar4;
 ...
 while ( puVar15 != (undefined4*)( lVar6 + 0x344 ) );
         ...
         if (iVar5 < 1) {
            ...
            if (( ( *(byte*)( lVar19 + 0x301 ) == 0 ) && ( uVar14 = (ulong)(int)uVar10 ),lVar26 == 0 )) {
               LAB_00100488:uVar14 = 5;
            }

            LAB_00100220:( **(code**)( &VP8PredLuma16 + uVar14 * 8 ) )(lVar1);
            if (uVar21 != 0) {
               puVar23 = &kScan;
               lVar24 = lVar19;
               do {
 ...
 while ( puVar23 != (ushort*)&_LC0 );
            ...
            *(undefined8*)( lVar6 + 0x238 ) = puVar25[3];
            ...
            LAB_001005f8:lVar24 = 0;
            for (int i = 0; i < 3; i++) {
               *(int*)( lVar6 + ( -128*i + 408 ) ) = iVar11;
            }
...
;
 ...
 while ( lVar24 != 0x10 );
         ...
         LAB_0010024a:uVar21 = *(uint*)( lVar19 + 0x318 );
         uVar18 = ( uint ) * (byte*)( lVar19 + 0x311 );
         if (( *(byte*)( lVar19 + 0x311 ) == 0 ) && ( uVar18 = lVar26 != 0 )) {
            uVar18 = uVar10;
         }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */ulong FinishRow(long param_1, int *param_2) {
   int iVar1;
   byte bVar2;
   byte bVar3;
   byte bVar4;
   ...
   if (*(int*)( param_1 + 0xe0 ) == 0) {
      LAB_0010080b:if (( *(int*)( param_1 + 0x338 ) != 0 ) && ( iVar9 = *(int*)( param_1 + 0x1a0 ) ),iVar9 < *(int*)( param_1 + 0x1a8 )) {
 ...
 while ( iVar9 < *(int*)( param_1 + 0x1a8 ) );
      ...
      if (iVar15 < *(int*)( param_1 + 0x1a8 )) {
         ...
         do {
            ...
            bVar4 = pbVar17[1];
            if (uVar10 != 0) {
               lVar21 = *(long*)( param_1 + 0xb28 ) + (long)( *(int*)( param_1 + 0xd8 ) * iVar8 * 0x10 ) + (long)( iVar15 << 4 );
               if (*(int*)( param_1 + 0xb68 ) == 1) {
                  ...
                  if (pbVar17[2] == 0) {
                     ...
                     LAB_00100cdf:( *_VP8SimpleVFilter16 )(lVar21, iVar8, uVar10 + 4);
                  }
 else {
                  ...
                  if (pbVar17[2] == 0) {
                     if (iVar9 < 1) goto LAB_00100c2c;
                     LAB_00100bac:( *_VP8VFilter16 )(lVar21, iVar8, uVar10 + 4, bVar4, bVar3);
 ...
 while ( iVar15 < *(int*)( param_1 + 0x1a8 ) );
   ...
   if (*(long*)( param_2 + 0x10 ) == 0) {
      ...
      *(long*)( param_2 + 10 ) = lVar11;
      ...
      if (*(long*)( param_1 + 0xb98 ) == 0) {
         iVar9 = param_2[0x20];
         if (iVar15 < iVar9) {
            LAB_00100eb9:lVar11 = *(long*)( param_2 + 0x26 );
            LAB_001008a6:iVar7 = *(int*)( param_1 + 0xb40 );
            iVar13 = iVar9 - iVar15;
   ...
   if (iVar6 < iVar1) {
      memcpy((void*)( *(long*)( param_1 + 0xb28 ) - __n_00 ), (void*)( lVar22 + ( *(int*)( param_1 + 0xb40 ) << 4 ) ), __n_00);
      memcpy((void*)( *(long*)( param_1 + 0xb30 ) - __n ), (void*)( lVar23 + ( *(int*)( param_1 + 0xb44 ) << 3 ) ), __n);
      memcpy((void*)( *(long*)( param_1 + 0xb38 ) - __n ), (void*)( lVar12 + ( *(int*)( param_1 + 0xb44 ) << 3 ) ), __n);
   }
...
void VP8InitDithering(long param_1, long param_2) {
 ...
 while ( puVar3 != (uint*)( param_2 + 0x4c0 ) );
   ...
   LAB_00100fbb:iVar1 = *(int*)( param_1 + 0x34 );
   iVar5 = 0;
   if (-1 < iVar1) {
      iVar5 = iVar1;
   }
...
ulong VP8ProcessRow(long param_1, undefined8 *param_2) {
   ...
   if (( uVar3 & 1 ) != 0) {
      ...
      *(undefined8*)( param_1 + 0x100 ) = uVar1;
      for (int i = 0; i < 8; i++) {
         uVar1 = param_2[( 2*i + 3 )];
         *(undefined8*)( param_1 + ( 16*i + 264 ) ) = param_2[( 2*i + 2 )];
         *(undefined8*)( param_1 + ( 16*i + 272 ) ) = uVar1;
      }
      ...
      *(ulong*)( param_1 + 0xd8 ) = CONCAT44((int)( ( ulong ) * (undefined8*)( param_1 + 0xb58 ) >> 0x20 ), (int)( ( ulong ) * (undefined8*)( param_1 + 200 ) >> 0x20 ));
      if (*(int*)( param_1 + 200 ) == 2) {
...
undefined4 VP8EnterCritical(undefined4 *param_1, long param_2) {
   ...
   int iVar13;
   char *pcVar14;
   if (( *(code**)( param_2 + 0x48 ) != (code*)0x0 ) && ( iVar3 = iVar3 == 0 )) {
   ...
   LAB_0010130b:iVar3 = param_1[0x21];
   iVar4 = param_1[0x18];
   pcVar14 = (char*)( param_1 + 0x25 );
   puVar12 = param_1;
   LAB_0010132a:if (iVar3 == 0) {
      iVar13 = param_1[0x16];
   }
 else {
      iVar13 = (int)*pcVar14;
      ...
      LAB_0010137a:do {
         if (iVar7 < 1) {
            ...
            *(bool*)( (long)puVar5 + 0xb6e ) = bVar2;
            if (bVar2) {
               LAB_0010142f:puVar12 = puVar12 + 2;
               pcVar14 = pcVar14 + 1;
            ...
            LAB_001013b8:iVar6 = param_1[0x17];
            iVar10 = 0x3f;
            if (iVar7 < 0x40) {
               iVar10 = iVar7;
            }
...
undefined8 VP8InitFrame(long param_1, long param_2) {
   ...
   *(undefined4*)( param_1 + 0xcc ) = 0;
   ...
   lVar11 = 0;
   lVar16 = ( (int)( ( ( uint ) * (byte*)( (long)&kFilterExtraRows + (long)(int)lVar8 ) + iVar15 ) * 3 ) / 2 ) * lVar14;
   if (*(long*)( param_1 + 0xb98 ) != 0) {
   ...
   *(long*)( param_1 + 3000 ) = lVar8;
   ...
   LAB_001017d6:uVar3 = *(undefined8*)( param_1 + 0xb28 );

/* position_around_base(hb_ot_shape_plan_t const*, hb_font_t*, hb_buffer_t*, unsigned int, unsigned
   int, bool) */void position_around_base(hb_ot_shape_plan_t *param_1, hb_font_t *param_2, hb_buffer_t *param_3, uint param_4, uint param_5, bool param_6) {
   uint uVar1;
   byte bVar2;
   byte bVar3;
   undefined4 uVar4;
   ...
   iVar9 = ( **(code**)( *(long*)( param_2 + 0x90 ) + 0x88 ) )(param_2, *(undefined8*)( param_2 + 0x98 ), *(undefined4*)( *(long*)( param_3 + 0x70 ) + lVar16 ), local_68, lVar15);
   uVar1 = param_4 + 1;
   if (iVar9 == 0) {
      ...
      if (uVar1 < param_5) {
         ...
         do {
            if (( *(ushort*)( lVar15 + 0x10 + lVar16 ) & 0x1f ) == 0xc) {
               ...
               if (param_6) {
                  puVar11[1] = CONCAT44((int)( (ulong)puVar11[1] >> 0x20 ) - (int)( ( ulong ) * puVar11 >> 0x20 ), (int)puVar11[1] - (int)*puVar11);
               }
               *puVar11 = 0;
            }
            lVar16 = lVar16 + 0x14;
      ...
      local_94 = ( **(code**)( *(long*)( param_2 + 0x90 ) + 0x48 ) )(param_2, *(undefined8*)( param_2 + 0x98 ), *(undefined4*)( *(long*)( param_3 + 0x70 ) + lVar16 ), lVar15);
      auVar5 = local_68;
      lVar15 = *(long*)( param_3 + 0x70 );
      ...
      if (uVar1 < param_5) {
         ...
         do {
            ...
            if (( uVar13 == 0 ) || ( uVar8 = uVar8 == 0 )) {
               ...
               if (local_80 < 2) {
                  LAB_0010044e:uVar13 = (uint)uVar8;
                  ...
                  if (( bVar3 & 0x10 ) == 0) {
                     ...
                     LAB_00100439:iVar10 = local_80 - 1;
                  } else {
                     iVar10 = -1;
                     joined_r0x00100433:if (bVar2 >> 5 == 0 || bVar3 >> 5 != bVar2 >> 5) goto LAB_00100439;
                  }
                  ...
                  uVar13 = 0;
                  LAB_00100299:local_94 = local_7c;
                  local_98 = local_90;
                  uVar22 = uVar13;
                  iVar21 = local_84;
                  iVar20 = local_88;
               ...
               iVar10 = ( **(code**)( *(long*)( param_2 + 0x90 ) + 0x88 ) )(param_2, *(undefined8*)( param_2 + 0x98 ), *(undefined4*)( *(long*)( param_3 + 0x70 ) + lVar16 ), local_58, lVar19);
               if (iVar10 == 0) {
                  puVar11 = (undefined8*)( *(long*)( param_3 + 0x80 ) + lVar16 );
               } else {
                  ...
                  if (uVar22 - 200 < 0x23) {
                     ...
                     if (( uVar18 & 0x100410000 ) != 0) {
                        ...
                        LAB_00100578:*(int*)( puVar11 + 1 ) = iVar14;
                        goto LAB_0010057b;
                     }
                     ...
                     LAB_0010039b:*(int*)( puVar11 + 1 ) = ( ( local_94 - local_58._8_4_ ) / 2 + local_98 ) - local_58._0_4_;
                     if (0xd5 < uVar22) goto LAB_00100588;
                     LAB_001003c4:if (( uVar22 & 0xfffffffd ) != 200) goto LAB_001004da;
                  } else {
                     *(int*)( puVar11 + 1 ) = ( ( local_94 - local_58._8_4_ ) / 2 + local_98 ) - local_58._0_4_;
                     if (0xea < uVar22) goto LAB_001004da;
                     LAB_0010057b:if (uVar22 < 0xd6) goto LAB_001003c4;
                     LAB_00100588:iVar14 = iVar10 + 0xf;
                     if (-1 < iVar10) {
                        iVar14 = iVar10;
                     }
                     ...
                     if (( uVar18 & 0x154000 ) != 0) {
                        ...
                        LAB_001005c6:iVar14 = ( iVar21 - local_58._12_4_ ) - local_58._4_4_;
   ...
   if (( param_5 ) || ( !param_4 )) {
      *(uint*)( this + 0xc0 ) = *(uint*)( this + 0xc0 ) | 0x20;
      if (( param_5 ) && ( this[0x5a] != (hb_buffer_t)0x0 )) {
         ...
         if (!param_4) {
            ...
            if (uVar11 < param_3) {
               ...
               if (( (int)puVar1 - (int)puVar5 & 4U ) != 0) {
                  *puVar5 = *puVar5 | param_1;
                  puVar5 = puVar5 + 5;
                  if (puVar1 == puVar5) goto LAB_00101200;
               }
               do {
                  *puVar5 = *puVar5 | param_1;
         ...
         if (uVar13 == param_3) {
            local_44 = 0xffffffff;
            if (param_2 == uVar11) goto LAB_00101200;
            if (iVar2 != 2) goto LAB_001013a5;
            LAB_0010160f:uVar7 = (ulong)param_2;
            uVar8 = local_44;
            if (param_2 < uVar11) {
               puVar5 = (uint*)( lVar9 + 8 + uVar7 * 0x14 );
               puVar1 = (uint*)( lVar9 + 0x1c + ( ( ( uVar11 - param_2 ) - 1 ) + uVar7 ) * 0x14 );
               if (( (int)puVar1 - (int)puVar5 & 4U ) == 0) goto LAB_00101658;
               if (*puVar5 < local_44) {
                  uVar8 = *puVar5;
               }
               for (puVar5 = puVar5 + 5; puVar5 != puVar1; puVar5 = puVar5 + 10) {
                  LAB_00101658:if (*puVar5 < uVar8) {
                     uVar8 = *puVar5;
                  }
                  if (puVar5[5] < uVar8) {
                     uVar8 = puVar5[5];
               ...
               if (param_2 != uVar11) goto LAB_0010167c;
            } else {
               LAB_0010167c:local_50 = uVar7 * 0x14;
               LAB_0010168d:if (param_2 < uVar11) {
            ...
            LAB_001016cd:if (param_3 == uVar13) goto LAB_00101200;
            LAB_001016d6:uVar10 = ( ulong )(param_3 - 1);
            uVar7 = (ulong)uVar13;
            LAB_001016dd:uVar11 = *(uint*)( lVar4 + 8 + uVar7 * 0x14 );
            uVar15 = *(uint*)( lVar4 + 8 + uVar10 * 0x14 );
            if (iVar2 != 2) goto LAB_00101493;
            LAB_001016fe:if (uVar13 < param_3) {
            ...
            if (iVar2 == 2) {
               if (uVar13 < param_3) {
                  ...
                  if (( (int)puVar1 - (int)puVar5 & 4U ) != 0) {
                     ...
                     puVar5 = puVar5 + 5;
                     if (puVar5 == puVar1) goto LAB_00101602;
                  }
                  do {
                     if (*puVar5 < local_44) {
                        local_44 = *puVar5;
               ...
               LAB_00101602:uVar8 = local_44;
               if (param_2 != uVar11) goto LAB_0010160f;
               goto LAB_001016d6;
            }
            ...
            local_44 = uVar8;
            if (param_2 == uVar11) goto LAB_001016dd;
            LAB_001013a5:lVar12 = lVar9 + ( ulong )(uVar11 - 1) * 0x14;
            uVar7 = (ulong)param_2;
            uVar8 = *(uint*)( lVar12 + 8 );
            ...
            uVar8 = *puVar5;
            if (param_2 == uVar11) goto LAB_001016cd;
            local_50 = uVar7 * 0x14;
            ...
            if (uVar8 != uVar15) {
               if (uVar8 == uVar3) {
                  if (uVar8 == uVar15) goto LAB_0010154d;
                  if (param_2 < uVar11) {
                     puVar5 = (uint*)( lVar9 + 4 + local_50 );
                     do {
            ...
            LAB_0010154d:if (param_2 < uVar11) {
               do {
               ...
               LAB_00101469:uVar13 = *(uint*)( this + 0x5c );
            }
            LAB_0010146d:if (uVar13 == param_3) goto LAB_00101200;
            uVar10 = ( ulong )(param_3 - 1);
            uVar7 = (ulong)uVar13;
            uVar11 = *(uint*)( lVar4 + 8 + uVar7 * 0x14 );
            uVar15 = *(uint*)( lVar4 + 8 + uVar10 * 0x14 );
            LAB_00101493:if (uVar11 != uVar8) {
               if (uVar15 != uVar8) goto LAB_001016fe;
               if (uVar11 != uVar8) {
                  if (uVar13 < param_3) {
                     puVar5 = (uint*)( lVar4 + 4 + uVar7 * 0x14 );
                     do {
      ...
      if (!param_4) {
         if (param_2 < param_3) {
            ...
            if (( (int)puVar1 - (int)puVar5 & 4U ) != 0) {
               *puVar5 = *puVar5 | param_1;
               puVar5 = puVar5 + 5;
               if (puVar5 == puVar1) goto LAB_00101200;
            }
            do {
               *puVar5 = *puVar5 | param_1;
               puVar5[5] = puVar5[5] | param_1;
   ...
   if (param_2 != param_3) {
      if (*(int*)( this + 0x1c ) == 2) {
         if (param_2 < param_3) {
            ...
            uVar11 = 0xffffffff;
            if (( (int)puVar1 - (int)puVar5 & 4U ) == 0) goto LAB_001017a0;
            uVar11 = 0xffffffff;
            if (*puVar5 != 0xffffffff) {
               uVar11 = *puVar5;
            }
            for (puVar5 = puVar5 + 5; puVar1 != puVar5; puVar5 = puVar5 + 10) {
               LAB_001017a0:if (*puVar5 < uVar11) {
                  uVar11 = *puVar5;
               }
               if (puVar5[5] < uVar11) {
                  uVar11 = puVar5[5];
   ...
   if (uVar3 != 0) {
      ...
      if (( ( ulong )((long)pIVar1 - *(long*)( param_1 + 8 )) <= ( ulong ) * (uint*)( param_1 + 0x18 ) ) && ( lVar8 = ( ulong )(( uint )(ushort)(*(ushort*)pIVar9 << 8 | *(ushort*)pIVar9 >> 8) * ( uint )(ushort)(*(ushort*)( pIVar9 + 2 ) << 8 | *(ushort*)( pIVar9 + 2 ) >> 8)) * 6 ),uVar3 = (uint)lVar8,(int)( (ulong)lVar8 >> 0x20 ) == 0) {
         ...
         if (( ( ulong )((long)pIVar1 - lVar8) <= uVar6 ) && ( ( uVar3 <= ( uint )((int)*(undefined8*)( param_1 + 0x10 ) - (int)pIVar1) && ( iVar5 = *(int*)( param_1 + 0x1c ) - uVar3 ),*(int*)( param_1 + 0x1c ) = iVar5,0 < iVar5 ) )) goto LAB_001019aa;
      }
   ...
   lVar8 = *(long*)( param_1 + 8 );
   uVar6 = ( ulong ) * (uint*)( param_1 + 0x18 );
   LAB_001019aa:if (( ( ( uVar6 < ( ulong )((long)pIVar7 - lVar8) ) || ( ( ulong ) * (uint*)( param_1 + 0x18 ) < ( ulong )((long)pIVar7 - *(long*)( param_1 + 8 )) ) ) || ( uVar3 = ( uint )(ushort)(*(ushort*)( this + 6 ) << 8 | *(ushort*)( this + 6 ) >> 8)(uint)((int)*(undefined8*)( param_1 + 0x10 ) - (int)pIVar7) < uVar3 * 4 ) ) || ( iVar5 = *(int*)( param_1 + 0x1c ) + uVar3 * -4 ),*(int*)( param_1 + 0x1c ) = iVar5,iVar5 < 1) {
      return 0;
   }
         ...
         if (uVar3 != 0) {
            ...
            if (( ( ( ulong )((long)pIVar1 - *(long*)( param_1 + 8 )) <= ( ulong ) * (uint*)( param_1 + 0x18 ) ) && ( ( ulong )((long)pIVar1 - *(long*)( param_1 + 8 )) <= ( ulong ) * (uint*)( param_1 + 0x18 ) ) ) && ( ( uVar3 = ( uint )(ushort)(*(ushort*)( pIVar9 + 4 ) << 8 | *(ushort*)( pIVar9 + 4 ) >> 8) ),uVar3 * 2 <= ( uint )((int)*(undefined8*)( param_1 + 0x10 ) - (int)pIVar1) && ( iVar5 = *(int*)( param_1 + 0x1c ) + uVar3 * -2 ),*(int*)( param_1 + 0x1c ) = iVar5,0 < iVar5 )) {
               ...
               if (uVar3 <= uVar10) {
                  ...
                  uVar3 = (uint)lVar8;
                  if (( ( (int)( (ulong)lVar8 >> 0x20 ) == 0 ) && ( ( ulong )((long)( pIVar9 + ( ulong )(uVar10 + 2 + (uint)uVar10) + 4 ) - *(long*)( param_1 + 8 )) <= ( ulong ) * (uint*)( param_1 + 0x18 ) ) ) && ( ( uVar3 <= ( uint )((int)*(undefined8*)( param_1 + 0x10 ) - (int)( pIVar9 + ( ulong )(uVar10 + 2 + (uint)uVar10) + 4 )) && ( iVar5 = *(int*)( param_1 + 0x1c ) - uVar3 ),*(int*)( param_1 + 0x1c ) = iVar5,0 < iVar5 ) )) goto LAB_00101a10;
               }
            }
            if (0x1f < *(uint*)( param_1 + 0x2c )) {
               return 0;
         ...
         if (*(short*)pAVar3 == 0x100) {
            if (pAVar3 + ( 4 - *(long*)( param_1 + 8 ) ) <= (AttachList*)( ulong ) * (uint*)( param_1 + 0x18 )) {
               ...
               if (pAVar3 + ( 4 - lVar7 ) <= pAVar2) {
                  ...
                  LAB_00101d8e:if (( uVar6 * 2 <= ( uint )((int)*(undefined8*)( param_1 + 0x10 ) - ( (int)pAVar3 + 4 )) ) && ( iVar5 = *(int*)( param_1 + 0x1c ) + uVar6 * -2 ),*(int*)( param_1 + 0x1c ) = iVar5,0 < iVar5) goto LAB_00101c21;
               }
            }
         } else {
            if (*(short*)pAVar3 != 0x200) goto LAB_00101c1a;
            if (pAVar3 + ( 4 - *(long*)( param_1 + 8 ) ) <= (AttachList*)( ulong ) * (uint*)( param_1 + 0x18 )) {
               lVar7 = *(long*)( param_1 + 8 );
               pAVar2 = (AttachList*)( ulong ) * (uint*)( param_1 + 0x18 );
               if (pAVar3 + ( 4 - lVar7 ) <= pAVar2) {
   ...
   LAB_00101c1a:lVar7 = *(long*)( param_1 + 8 );
   pAVar2 = (AttachList*)( ulong ) * (uint*)( param_1 + 0x18 );
   LAB_00101c21:pAVar3 = this + 4;
   ...
   if (uVar4 != 0) {
      ...
      do {
         ...
         if (uVar5 != 0) goto LAB_00101ef9;
         pLVar2 = pLVar2 + 2;
      } while ( this + ( ulong )(uVar4 - 1) * 2 + 6 != pLVar2 );
   }
   return 1;
   LAB_00101ef9:pLVar8 = this + ( ushort )(uVar5 << 8 | uVar5 >> 8);
   pLVar3 = pLVar2;
   if ((LigGlyph*)( ulong ) * (uint*)( param_1 + 0x18 ) < pLVar8 + ( 2 - *(long*)( param_1 + 8 ) )) {
      LAB_00101f78:uVar7 = *(uint*)( param_1 + 0x2c );
      LAB_00101f7b:if (0x1f < uVar7) {
         return 0;
      }
      ...
      *(ushort*)( pLVar2 + -2 ) = 0;
      ...
      if (sVar1 != 0x200) {
         if (sVar1 != 0x300) {
            if (sVar1 != 0x100) goto LAB_00101f30;
            goto LAB_00101f68;
         }
         if ((LigGlyph*)( ulong ) * (uint*)( param_1 + 0x18 ) < pLVar8 + ( 6 - *(long*)( param_1 + 8 ) )) goto LAB_00101f78;
         uVar5 = *(ushort*)( pLVar8 + 4 );
         if (uVar5 == 0) goto LAB_00101f30;
         ...
         if (pLVar9 + ( 6 - *(long*)( param_1 + 8 ) ) <= (LigGlyph*)( ulong ) * (uint*)( param_1 + 0x18 )) {
            ...
            if (( ushort )(( uVar5 << 8 | uVar5 >> 8 ) - 1) < 3) {
               ...
               if (( ( (LigGlyph*)( ulong ) * (uint*)( param_1 + 0x18 ) < pLVar9 + -*(long *)(param_1 + 8) ) || ( ( uint )((int)*(undefined8*)( param_1 + 0x10 ) - (int)pLVar9) < uVar7 ) ) || ( iVar6 = *(int*)( param_1 + 0x1c ) ),*(uint*)( param_1 + 0x1c ) = iVar6 - uVar7,(int)( iVar6 - uVar7 ) < 1) goto LAB_00102060;
            }
            goto LAB_00101f30;
         }
         LAB_00102060:if (0x1f < *(uint*)( param_1 + 0x2c )) {
            return 0;
         }
      ...
      LAB_00101f68:if ((LigGlyph*)( ulong ) * (uint*)( param_1 + 0x18 ) < pLVar8 + ( 4 - *(long*)( param_1 + 8 ) )) goto LAB_00101f78;
   }
   LAB_00101f30:do {
      pLVar2 = pLVar3 + 2;
         ...
         if (*(short*)pLVar8 == 0x100) {
            if (pLVar8 + ( 4 - *(long*)( param_1 + 8 ) ) <= (LigCaretList*)( ulong ) * (uint*)( param_1 + 0x18 )) {
               ...
               if (pLVar8 + ( 4 - lVar5 ) <= pLVar4) {
                  ...
                  LAB_00102236:if (( uVar7 * 2 <= ( uint )((int)*(undefined8*)( param_1 + 0x10 ) - ( (int)pLVar8 + 4 )) ) && ( iVar6 = *(int*)( param_1 + 0x1c ) + uVar7 * -2 ),*(int*)( param_1 + 0x1c ) = iVar6,0 < iVar6) goto LAB_001020eb;
               }
            }
         } else {
            if (*(short*)pLVar8 != 0x200) goto LAB_001020e4;
            if (pLVar8 + ( 4 - *(long*)( param_1 + 8 ) ) <= (LigCaretList*)( ulong ) * (uint*)( param_1 + 0x18 )) {
               lVar5 = *(long*)( param_1 + 8 );
               pLVar4 = (LigCaretList*)( ulong ) * (uint*)( param_1 + 0x18 );
               if (pLVar8 + ( 4 - lVar5 ) <= pLVar4) {
   ...
   LAB_001020e4:lVar5 = *(long*)( param_1 + 8 );
   pLVar4 = (LigCaretList*)( ulong ) * (uint*)( param_1 + 0x18 );
   LAB_001020eb:pLVar8 = this + 4;
   ...
   return 1;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* OT::MarkGlyphSetsFormat1::covers(unsigned int, unsigned int) const */undefined4 OT::MarkGlyphSetsFormat1::covers(MarkGlyphSetsFormat1 *this, uint param_1, uint param_2) {
   int iVar1;
   ushort uVar2;
   uint uVar3;
   uint uVar4;
   ...
   if (*(short*)pMVar5 == 0x100) {
      ...
      if (uVar2 != 0) {
         ...
         do {
            ...
            uVar3 = ( uint )(ushort)(*(ushort*)( pMVar5 + (ulong)uVar4 * 2 + 4 ) << 8 | *(ushort*)( pMVar5 + (ulong)uVar4 * 2 + 4 ) >> 8);
            if (param_2 < uVar3) {
               iVar7 = uVar4 - 1;
            } else {
               if (param_2 == uVar3) {
      ...
      if (uVar2 != 0) {
         ...
         do {
            while (true) {
               ...
               if (param_2 <= ( ushort )(*(ushort*)( pMVar6 + 2 ) << 8 | *(ushort*)( pMVar6 + 2 ) >> 8)) goto LAB_001023b3;
               iVar1 = uVar3 + 1;
               if (iVar7 < iVar1) goto LAB_0010238e;
            };
            iVar7 = uVar3 - 1;
         } while ( iVar1 <= iVar7 );
      }
      LAB_0010238e:uVar2 = __hb_Null_OT_RangeRecord << 8 | __hb_Null_OT_RangeRecord >> 8;
      if (uVar2 <= ( ushort )(_DAT_00105022 << 8 | _DAT_00105022 >> 8)) {
         pMVar6 = (MarkGlyphSetsFormat1*)&_hb_Null_OT_RangeRecord;
         LAB_001023b3:iVar7 = ( ( uint )(ushort)(*(ushort*)( pMVar6 + 4 ) << 8 | *(ushort*)( pMVar6 + 4 ) >> 8) - (uint)uVar2 ) + param_2;
   ...
   if (*(short*)this == 0x100) {
      pMVar6 = this + 4;
      for (int i_209 = 0; i_209 < 2; i_209++) {
         if (( ulong ) * (uint*)( param_1 + 24 ) < ( ulong )((long)pMVar6 - *(long*)( param_1 + 8 ))) {
            return 0;
         }
      }
               ...
               if (pMVar5 + ( 2 - *(long*)( param_1 + 8 ) ) <= (MarkGlyphSets*)( ulong ) * (uint*)( param_1 + 0x18 )) {
                  if (*(short*)pMVar5 == 0x100) {
                     if (( pMVar5 + ( 4 - *(long*)( param_1 + 8 ) ) <= (MarkGlyphSets*)( ulong ) * (uint*)( param_1 + 0x18 ) ) && ( pMVar5 + ( 4 - *(long*)( param_1 + 8 ) ) <= (MarkGlyphSets*)( ulong ) * (uint*)( param_1 + 0x18 ) )) {
                        ...
                        LAB_00102552:if (( uVar4 * 2 <= ( uint )((int)*(undefined8*)( param_1 + 0x10 ) - ( (int)pMVar5 + 4 )) ) && ( iVar3 = *(int*)( param_1 + 0x1c ) + uVar4 * -2 ),*(int*)( param_1 + 0x1c ) = iVar3,0 < iVar3) goto LAB_001024d0;
                     }
                  } else {
                     if (*(short*)pMVar5 != 0x200) goto LAB_001024d0;
                     if (( pMVar5 + ( 4 - *(long*)( param_1 + 8 ) ) <= (MarkGlyphSets*)( ulong ) * (uint*)( param_1 + 0x18 ) ) && ( pMVar5 + ( 4 - *(long*)( param_1 + 8 ) ) <= (MarkGlyphSets*)( ulong ) * (uint*)( param_1 + 0x18 ) )) {
                        uVar2 = *(ushort*)( pMVar5 + 2 ) << 8 | *(ushort*)( pMVar5 + 2 ) >> 8;
   ...
   uVar2 = *(ushort*)( this + 4 );
   if (uVar2 == 0) {
      LAB_001026c0:lVar5 = *(long*)( param_1 + 8 );
      ...
      if ((GDEFVersion1_2<OT::Layout::SmallTypes>*)( ulong ) * (uint*)( param_1 + 0x18 ) < pGVar4 + ( 2 - *(long*)( param_1 + 8 ) )) {
         LAB_00102808:if (0x1f < *(uint*)( param_1 + 0x2c )) {
            return 0;
         }
         *(uint*)( param_1 + 0x2c ) = *(uint*)( param_1 + 0x2c ) + 1;
         if (param_1[0x28] == (hb_sanitize_context_t)0x0) {
      ...
      if (*(short*)pGVar4 != 0x100) {
         if (*(short*)pGVar4 != 0x200) goto LAB_001026c0;
         pGVar8 = pGVar4 + 4;
      ...
      pGVar8 = pGVar4 + 6;
      if (( ulong ) * (uint*)( param_1 + 0x18 ) < ( ulong )((long)pGVar8 - *(long*)( param_1 + 8 ))) goto LAB_00102808;
      lVar5 = *(long*)( param_1 + 8 );
      pGVar6 = (GDEFVersion1_2<OT::Layout::SmallTypes>*)( ulong ) * (uint*)( param_1 + 0x18 );
      if (pGVar6 < pGVar8 + -lVar5) goto LAB_00102808;
      uVar3 = ( uint )(ushort)(*(ushort*)( pGVar4 + 4 ) << 8 | *(ushort*)( pGVar4 + 4 ) >> 8);
      LAB_001027e6:if (( ( uint )((int)*(undefined8*)( param_1 + 0x10 ) - (int)pGVar8) < uVar3 * 2 ) || ( iVar7 = *(int*)( param_1 + 0x1c ) + uVar3 * -2 ),*(int*)( param_1 + 0x1c ) = iVar7,iVar7 < 1) goto LAB_00102808;
   }
   ...
   if (pGVar4 + ( 2 - *(long*)( param_1 + 8 ) ) <= (GDEFVersion1_2<OT::Layout::SmallTypes>*)( ulong ) * (uint*)( param_1 + 0x18 )) {
      if (*(short*)pGVar4 == 0x100) {
         ...
         if (( ( ( ulong )((long)pGVar8 - *(long*)( param_1 + 8 )) <= ( ulong ) * (uint*)( param_1 + 0x18 ) ) && ( ( ulong )((long)pGVar8 - *(long*)( param_1 + 8 )) <= ( ulong ) * (uint*)( param_1 + 0x18 ) ) ) && ( uVar3 = ( uint )(ushort)(*(ushort*)( pGVar4 + 4 ) << 8 | *(ushort*)( pGVar4 + 4 ) >> 8) * 2 ),uVar3 <= ( uint )((int)*(undefined8*)( param_1 + 0x10 ) - (int)pGVar8)) {
            LAB_00102ac9:iVar7 = *(int*)( param_1 + 0x1c );
            *(uint*)( param_1 + 0x1c ) = iVar7 - uVar3;
            if (0 < (int)( iVar7 - uVar3 )) goto LAB_00102726;
         }
      } else {
         if (*(short*)pGVar4 != 0x200) goto LAB_00102726;
         pGVar8 = pGVar4 + 4;
         if (( ( ( ulong )((long)pGVar8 - *(long*)( param_1 + 8 )) <= ( ulong ) * (uint*)( param_1 + 0x18 ) ) && ( ( ulong )((long)pGVar8 - *(long*)( param_1 + 8 )) <= ( ulong ) * (uint*)( param_1 + 0x18 ) ) ) && ( uVar3 = ( uint )(ushort)(*(ushort*)( pGVar4 + 2 ) << 8 | *(ushort*)( pGVar4 + 2 ) >> 8) * 6 ),uVar3 <= ( uint )((int)*(undefined8*)( param_1 + 0x10 ) - (int)pGVar8)) goto LAB_00102ac9;
      }
   }
   if (0x1f < *(uint*)( param_1 + 0x2c )) {
      return 0;
   ...
   *(undefined2*)( this + 10 ) = 0;
   LAB_00102726:if (0x10001 < ( uint )(ushort)(*(ushort*)this << 8 | *(ushort*)this >> 8) * 0x10000 + ( uint )(ushort)(*(ushort*)( this + 2 ) << 8 | *(ushort*)( this + 2 ) >> 8)) {
   ...
   if (uVar28 != 0) {
      do {
         while (true) {
            ...
            LAB_00102e26:__hb_CrapPool = __hb_NullPool;
            ...
            if (sVar18 == 0x100) goto LAB_00102e63;
            LAB_00102bc3:if (sVar18 == 0x200) {
               pMVar25 = pMVar29 + 4;
               ...
               if (lVar5 != 0) {
                  do {
                     ...
                     if (*puVar13 == 0xffffffffffffffff) {
                        LAB_00102cca:uVar28 = puVar13[1];
                        uVar30 = puVar13[2];
                        bVar8 = false;
                        if (uVar28 == 0xffffffffffffffff) {
                           if (uVar30 == 0xffffffffffffffff) break;
                           LAB_00102cfd:bVar14 = 0;
                           LAB_00102c4d:bVar17 = (byte)uVar15 >> 1;
                           bVar20 = (byte)uVar4 >> 1;
                        ...
                        *puVar13 = ( ( 2L << ( bVar14 & 0x3f ) ) - uVar30 ) - ( ulong )(( ulong )(1L << ( bVar14 & 0x3f )) < uVar30) | *puVar13;
                        uVar30 = puVar13[2];
                        if (uVar28 != 0xffffffffffffffff) goto LAB_00102cdf;
                        if (uVar30 != 0xffffffffffffffff) goto LAB_00102cfd;
                     }
                     LAB_00102c76:pMVar25 = pMVar25 + 6;
                  } while ( pMVar29 != pMVar25 );
               }
            }
            LAB_00102d83:pMVar22 = pMVar22 + 4;
            if (pMVar2 == pMVar22) {
               return;
            }
         };
         ...
         if (uVar10 < uVar21) {
            ...
            if (0xaaaaaaa < uVar19) {
               LAB_00102e20:*(uint*)param_1 = ~uVar10;
               goto LAB_00102e26;
            }
            pvVar12 = realloc(*(void**)( param_1 + 8 ), (ulong)uVar19 * 0x18);
            if (pvVar12 == (void*)0x0) {
               uVar10 = *(uint*)param_1;
               if (uVar10 < uVar19) goto LAB_00102e20;
         ...
         *(uint*)( param_1 + 4 ) = uVar21;
         ...
         if (sVar18 != 0x100) goto LAB_00102bc3;
         LAB_00102e63:pMVar25 = pMVar29 + 4;
         uVar15 = *(ushort*)( pMVar29 + 2 ) << 8 | *(ushort*)( pMVar29 + 2 ) >> 8;
         if (uVar15 == 0) goto LAB_00102d83;
         uVar28 = *puVar13;
   ...
   *(undefined8*)( this + 0x210 ) = 0;
   ...
   while (true) {
      ...
      if ((ulong)local_60 < 4) goto LAB_0010320a;
      ...
      if (( local_4c == 0 ) || ( local_50 != '\0' )) goto LAB_0010320a;
      local_70._0_8_ = hb_blob_get_data_writable(phVar5, 0);
      local_70._8_8_ = ( ulong ) * (uint*)( phVar5 + 0x18 ) + local_70._0_8_;
      if (local_70._0_8_ == 0) goto LAB_0010320a;
      local_50 = '\x01';
   };
   if (local_4c == 0) {
      LAB_0010309e:hb_blob_destroy(local_48);
   } else {
      local_4c = 0;
      ...
      if (*(short*)this_00 != 0x100) goto LAB_0010309e;
      cVar3 = GDEFVersion1_2<OT::Layout::SmallTypes>::sanitize(this_00, (hb_sanitize_context_t*)local_78);
      lVar6 = local_48;
      if (local_4c != 0) {
         LAB_0010320a:hb_blob_destroy(lVar6);
         LAB_0010320f:hb_blob_destroy(phVar5);
         phVar5 = (hb_face_t*)hb_blob_get_empty();
         LAB_001030ab:*(hb_face_t**)this = phVar5;
   ...
   *(undefined8*)( this + 0xe8 ) = 0;
   ...
   do {
      while (true) {
         ...
         if (paVar18 != (accelerator_t*)0x0) goto LAB_00103473;
         phVar10 = *(hb_face_t**)( lVar14 + 0x70 );
         if (phVar10 == (hb_face_t*)0x0) goto LAB_001038ac;
   ...
   LAB_001038ac:paVar18 = (accelerator_t*)&_hb_NullPool;
   LAB_00103473:puVar15 = *(undefined**)paVar18;
   ...
   *(undefined**)( this + 0xf0 ) = puVar19;
   ...
   do {
      while (true) {
         paVar18 = (accelerator_t*)*plVar2;
         if (paVar18 != (accelerator_t*)0x0) goto LAB_001034b1;
         phVar10 = *(hb_face_t**)( lVar14 + 0x70 );
         if (phVar10 == (hb_face_t*)0x0) goto LAB_001038ca;
         paVar18 = (accelerator_t*)calloc(1, 0x218);
         if (paVar18 == (accelerator_t*)0x0) break;
         GDEF::accelerator_t::accelerator_t(paVar18, phVar10);
         LOCK();
   ...
   LAB_001038ca:paVar18 = (accelerator_t*)&_hb_NullPool;
   LAB_001034b1:psVar9 = *(short**)( this + 0xf0 );
   ...
   *(undefined**)( this + 0x100 ) = puVar15;
   if (( iVar6 == 1 ) && ( *(int*)( *(long*)( this + 0x90 ) + 0x78 ) != 0 )) {
      ...
      if (puVar17 != (undefined4*)0x0) {
         if (uVar12 != 0) {
            puVar1 = puVar17 + 1;
            puVar21 = puVar17;
            if (( (int)( puVar1 + ( uVar12 - 1 ) ) - (int)puVar17 & 4U ) == 0) goto LAB_00103720;
            *puVar17 = _LC3;
            for (puVar21 = puVar1; puVar21 != puVar1 + ( uVar12 - 1 ); puVar21 = puVar21 + 2) {
               LAB_00103720:*puVar21 = uVar7;
               puVar21[1] = uVar7;
            }
         }
         goto LAB_001034eb;
   ...
   LAB_001034eb:*(undefined4**)( this + 0x108 ) = puVar17;
   ...
   *(undefined1(*) [16])( this + 0x70 ) = (undefined1[16])0x0;
   ...
   unsigned int, bool) const */void OT::hb_kern_machine_t<hb_ot_shape_fallback_kern_driver_t>::kern(hb_kern_machine_t<hb_ot_shape_fallback_kern_driver_t> *this, hb_font_t *param_1, hb_buffer_t *param_2, uint param_3, bool param_4) {
   undefined4 *puVar1;
   uint *puVar2;
   uint uVar3;
   uint uVar4;
   ...
   if (local_110 == 1) {
      ...
      _local_176 = 1;
      _local_138 = 0x101;
      LAB_00103d8d:_local_138 = CONCAT12(cVar11, _local_138);
      local_59 = 0;
   } else {
      local_178 = '\0';
      if (local_110 != 0) {
         ...
         if (( param_3 & puVar1[1] ) != 0) {
            ...
            LAB_00103b44:do {
               ...
               if (( local_180 & uVar25 & 0xe ) == 0) {
                  if (( uVar25 & 8 ) == 0) {
                     LAB_00103b8a:uVar25 = (ushort)puVar2[4];
                     sVar18 = 0;
                     if (( ( uVar25 & 0x20 ) != 0 ) && ( ( puVar2[3] & 0x10 ) == 0 )) {
                        if (local_178 == '\0') {
                           if (( uVar25 & 0x1f ) == 1) {
                              sVar18 = 0;
                              if (( uVar25 & 0x200 ) != 0) goto LAB_00103bd0;
                              if (local_177 == '\0') goto LAB_00103efc;
                           }
                        } else if (( local_177 == '\0' ) && ( ( uVar25 & 0x1f ) == 1 )) {
                           LAB_00103efc:sVar18 = 0;
                           if (( uVar25 & 0x100 ) != 0) goto LAB_00103bd0;
                        }
                        if (local_176[0] == '\0') {
                     ...
                     if (( ( puVar2[1] & local_17c ) != 0 ) && ( ( cStack_174 == '\0' || ( cStack_174 == *(char*)( (long)puVar2 + 0xf ) ) ) )) {
                        if (local_170 == (code*)0x0) {
                           if (sVar18 != 0) goto LAB_00103db8;
                        } else {
                           cVar11 = ( *local_170 )(puVar2, uVar25, local_168._0_8_);
                           if (cVar11 == '\0') goto LAB_00103db0;
                        }
                        uVar5 = local_190;
                        if ((ushort*)local_168._8_8_ != (ushort*)0x0) {
                        ...
                        iVar23 = ( *pcVar16 )(lVar8, *(undefined8*)( lVar8 + 0x98 ), *puVar1, *(undefined4*)( lVar6 + (ulong)local_190 * 0x14 ), lVar26);
                        uVar19 = local_190;
                        if (iVar23 != 0) {
                           if (( uVar3 & 0xfffffffe ) == 4) {
                              if (param_4) {
                                 iVar23 = (int)( ( ulong )((long)(short)iVar23 * *(long*)( param_1 + 0x58 ) + 0x8000) >> 0x10 );
                              }
                              ...
                              if (param_4) {
                                 iVar23 = (int)( ( ulong )((long)(short)iVar23 * *(long*)( param_1 + 0x60 ) + 0x8000) >> 0x10 );
                              }
                              lVar20 = lVar20 + lVar7;
                              if (this[8] == (hb_kern_machine_t<hb_ot_shape_fallback_kern_driver_t>)0x0) {
                                 iVar13 = iVar23 - ( iVar23 >> 1 );
                        ...
                        goto joined_r0x00103cc8;
                     }
                     LAB_00103db0:if (sVar18 == 0) break;
                  } else {
                     uVar5 = *puVar2;
                     puVar10 = *(undefined8**)( local_188 + 0xf8 );
                     if (( local_180 & 0x10 ) == 0) {
                        cVar11 = (char)( local_180 >> 8 );
                        if (( cVar11 == '\0' ) || ( cVar11 == (char)( uVar25 >> 8 ) )) goto LAB_00103b8a;
                        goto LAB_00103b44;
                     }
                     ...
                     if (( ( ( 1L << ( ( byte )(uVar5 >> 4) & 0x3f ) & *local_1d8 ) == 0 ) || ( ( 1L << ( (byte)uVar5 & 0x3f ) & local_1d8[1] ) == 0 ) ) || ( ( 1L << ( ( byte )(uVar5 >> 9) & 0x3f ) & local_1d8[2] ) == 0 )) goto LAB_00103b44;
                     ...
                     if (( ( *psVar24 == 0x100 ) && ( 0x10001 < ( ushort )(psVar24[1] << 8 | (ushort)psVar24[1] >> 8) + 0x10000 ) ) && ( uVar25 = uVar25 != 0 )) {
                        this_00 = (MarkGlyphSetsFormat1*)( (long)psVar24 + ( ulong )(ushort)(uVar25 << 8 | uVar25 >> 8) );
                     } else {
                        this_00 = (MarkGlyphSetsFormat1*)&_hb_NullPool;
                     }
                     if (( *(short*)this_00 == 0x100 ) && ( cVar11 = MarkGlyphSetsFormat1::covers(this_00, uVar19, uVar5) ),cVar11 != '\0') goto LAB_00103b8a;
                  }
                  LAB_00103db8:uVar15 = (ulong)local_190;
               }
            } while ( true );
         }
         uVar19 = uVar22 + 1;
         joined_r0x00103cc8:uVar22 = uVar19;
      } while ( uVar22 < uVar4 );
   }
   ...
   LAB_00103d08:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return;

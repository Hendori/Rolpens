...
/* RendererRD::TextureStorage::render_target_get_render_region(RID) const */undefined1[16];RendererRD::TextureStorage::render_target_get_render_region (TextureStorage *this,ulong param_2) {
   int iVar1;
   long lVar2;
   if (( param_2 != 0 ) && ( (uint)param_2 < *(uint*)( this + 0x2ac ) )) {
      lVar2 = ( ( param_2 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x2a8 ) ) * 0x158 + *(long*)( *(long*)( this + 0x298 ) + ( ( param_2 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x2a8 ) ) * 8 );
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RendererRD::TextureStorage::render_target_get_clear_request_color(RID) */undefined1[16];RendererRD::TextureStorage::render_target_get_clear_request_color (TextureStorage *this,ulong param_2) {
...
/* RendererRD::TextureStorage::decal_instance_free(RID) */undefined1[16];RendererRD::TextureStorage::decal_instance_free (TextureStorage *this,ulong param_2) {
   int iVar1;
   code *pcVar2;
   uint uVar3;
   long lVar4;
   ...
   if (( param_2 != 0 ) && ( (uint)param_2 < *(uint*)( param_1 + 0x124 ) )) {
      ...
      if (piVar7[0x44] == (int)( param_2 >> 0x20 )) {
         ...
         if (*piVar7 == 1) {
            ...
            LAB_0010c514:if (( *(long*)( piVar7 + 0x22 ) != 0 ) && ( cVar3 = RefCounted::unreference() ),cVar3 != '\0') {
 ...
 while ( lVar23 < *(long*)( lVar22 + -8 ) );
                  ...
                  if (uVar20 < *(uint*)( this + 0x124 )) {
                     ...
                     if (*(int*)( lVar25 + 0x110 ) < 0) {
                        ...
                        if (( *(long*)( lVar25 + 0x88 ) != 0 ) && ( cVar12 = RefCounted::unreference() ),cVar12 != '\0') {
               ...
               do {
                  ...
                  if (iVar8 != piVar17[0x10]) {
                     ...
                     if (local_58 == (Object*)0x0) {
                        ...
                        if (pIVar14 != pIVar10) {
                           if (( pIVar10 != (Image*)0x0 ) && ( cVar7 = RefCounted::reference() ),cVar7 == '\0') goto LAB_001106a3;
                           goto LAB_001106a6;
                        }
...
;
 ...
 while ( !bVar18 );
   ...
   *(undefined8*)( param_1 + 8 ) = 0;
   ...
   LAB_001110f2:if (( local_a8 != (Image*)0x0 ) && ( cVar6 = RefCounted::unreference() ),cVar6 != '\0') {
      memdelete<Image>(local_a8);
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RendererRD::TextureStorage::texture_2d_initialize(RID, Ref<Image> const&) */void RendererRD::TextureStorage::texture_2d_initialize(TextureStorage *this, undefined8 param_2, long *param_3) {
 ...
 while ( !bVar11 );
   ...
   if (lVar9 == 0) {
      ...
      if (( (Image*)local_d0._0_8_ != (Image*)0x0 ) && ( cVar3 = RefCounted::unreference() ),cVar3 != '\0') {
...
;
 ...
 while ( uVar11 != 6 );
   ...
   LAB_00117947:if (( pIVar17 != (Image*)0x0 ) && ( cVar6 = RefCounted::unreference() ),cVar6 != '\0') {

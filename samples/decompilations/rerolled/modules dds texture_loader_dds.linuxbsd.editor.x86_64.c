   ...
   *(int*)( plVar1 + 2 ) = (int)plVar1[2] + 1;
   ...
   void ResourceFormatLoader::~ResourceFormatLoader(ResourceFormatLoader *this) {
      ...
      *(code**)this = Variant::Variant;
      if (bVar1) {
         for (int i_613 = 0; i_613 < 10; i_613++) {
            if (*(long*)( this + ( -24*i_613 + 624 ) ) != 0) {
               StringName::unref();
   ...
   for (int i_606 = 0; i_606 < 25; i_606++) {
   ...
   for (int i_607 = 0; i_607 < 25; i_607++) {

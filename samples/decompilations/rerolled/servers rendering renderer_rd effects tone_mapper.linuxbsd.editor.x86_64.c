/* CowData<RenderingDeviceCommons::PipelineColorBlendState::Attachment>::_copy_on_write() [clone
   ...
   *(undefined4*)( this + 0x2c ) = *(undefined4*)( param_4 + 0xc );
   for (int i_211 = 0; i_211 < 6; i_211++) {
      *(undefined4*)( this + ( 4*i_211 + 52 ) ) = *(undefined4*)( param_4 + ( 4*i_211 + 16 ) );
   }
   ...
   *(undefined8*)this = 0;
   ...
   if (( *(long*)( param_4 + 8 ) != 0 ) && ( uVar7 = ( uint ) * (undefined8*)( *(long*)( param_4 + 8 ) + -8 ) ),uVar7 != 0) goto LAB_001059fd;

/* CowData<int>::_ref(CowData<int> const&) [clone .part.0] */void CowData<int>::_ref(CowData<int> *this, CowData *param_1) {
   ...
   return;
}/* CowData<Vector4>::_ref(CowData<Vector4> const&) [clone .part.0] */void CowData<Vector4>::_ref(CowData<Vector4> *this, CowData *param_1) {
   long *plVar1;
   long lVar2;
   long lVar3;
   bool bVar4;
   ...
   return;
}/* Dictionary::get_key_list(List<Variant, DefaultAllocator>*) const */void Dictionary::get_key_list(Dictionary *this, List *param_1) {
   undefined8 uVar1;
   long *plVar2;
   ...
   return;
}/* Dictionary::get_key_at_index(int) const */Variant *Dictionary::get_key_at_index(int param_1) {
   int iVar1;
   int in_EDX;
   long *in_RSI;
   long *plVar2;
   ...
   LAB_0010063f:*(undefined4*)this = 0;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   return this;
}/* Dictionary::get_value_at_index(int) const */Variant *Dictionary::get_value_at_index(int param_1) {
   int iVar1;
   int in_EDX;
   long *in_RSI;
   long *plVar2;
   ...
   LAB_0010069f:*(undefined4*)this = 0;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   return this;
}/* Dictionary::size() const */undefined4 Dictionary::size(Dictionary *this) {
   return *(undefined4*)( *(long*)this + 0x3c );
}/* Dictionary::is_empty() const */undefined4 Dictionary::is_empty(Dictionary *this) {
   return CONCAT31(( int3 )(( uint ) * (int*)( *(long*)this + 0x3c ) >> 8), *(int*)( *(long*)this + 0x3c ) == 0);
}/* Dictionary::recursive_equal(Dictionary const&, int) const */undefined8 Dictionary::recursive_equal(Dictionary *this, Dictionary *param_1, int param_2) {
   uint uVar1;
   long lVar2;
   ...
   if (param_2 < 0x65) {
      ...
      if (plVar19 != (long*)0x0) {
         LAB_00100748:if (( *(long*)( lVar17 + 0x18 ) != 0 ) && ( *(int*)( lVar17 + 0x3c ) != 0 )) {
            ...
            if (uVar13 != 0) {
               ...
               do {
                  if (uVar14 == uVar13) {
                     cVar12 = StringLikeVariantComparator::compare((Variant*)( *(long*)( *(long*)( lVar17 + 0x18 ) + lVar16 * 8 ) + 0x10 ), (Variant*)( plVar19 + 2 ));
      ...
      _err_print_error("recursive_equal", "core/variant/dictionary.cpp", 0x106, "Max recursion reached", 0, 0);
   }
   return 1;
   LAB_00100869:lVar2 = *(long*)( *(long*)( lVar17 + 0x18 ) + (ulong)uVar15 * 8 );
   if (lVar2 == 0) {
      return 0;
   }
   cVar12 = Variant::hash_compare((Variant*)( plVar19 + 5 ), (int)lVar2 + 0x28, (bool)( (char)param_2 + '\x01' ));
   if (cVar12 == '\0') {
      return 0;
   }
   ...
   lVar17 = *(long*)param_1;
   goto LAB_00100748;
}/* Dictionary::TEMPNAMEPLACEHOLDERVALUE(Dictionary const&) const */void Dictionary::operator ==(Dictionary *this, Dictionary *param_1) {
   recursive_equal(this, param_1, 0);
   return;
}/* Dictionary::TEMPNAMEPLACEHOLDERVALUE(Dictionary const&) const */uint Dictionary::operator !=(Dictionary *this, Dictionary *param_1) {
   uint uVar1;
   uVar1 = recursive_equal(this, param_1, 0);
   return uVar1 ^ 1;
}/* Dictionary::clear() */void Dictionary::clear(Dictionary *this) {
   char cVar1;
   uint uVar2;
   long lVar3;
   void *pvVar4;
   ...
   _err_print_error("clear", "core/variant/dictionary.cpp", 0x125, "Condition \"_p->read_only\" is true.", "Dictionary is in read-only state.", 0, 0);
   return;
}/* Dictionary::sort() */undefined1  [16] __thiscallDictionary::sort(Dictionary *this) {
   long lVar1;
   long lVar2;
   undefined1 auVar3[16];
   long *plVar4;
   ...
   lVar1 = *(long*)this;
   if (*(long*)( lVar1 + 8 ) != 0) {
      _err_print_error(&_LC6, "core/variant/dictionary.cpp", 0x12a, "Condition \"_p->read_only\" is true.", "Dictionary is in read-only state.", 0);
      auVar3._8_8_ = 0;
   ...
   if (( *(long*)( lVar1 + 0x18 ) != 0 ) && ( 1 < *(uint*)( lVar1 + 0x3c ) )) {
      ...
      plVar8 = (long*)*in_RAX;
      LAB_00100a87:if (plVar8 != (long*)0x0) {
         lVar2 = plVar8[1];
         plVar4 = plVar8;
         while (lVar2 != 0) {
            lVar6 = 0;
            ...
            in_RAX = (long*)*plVar4;
            LAB_00100adc:in_RDX = (undefined8*)plVar4[1];
            *in_RDX = in_RAX;
            if (in_RAX == (long*)0x0) {
   ...
   LAB_00100b5b:auVar9._8_8_ = in_RDX;
   auVar9._0_8_ = in_RAX;
   return auVar9;
}/* Dictionary::_unref() const */void Dictionary::_unref(Dictionary *this) {
   uint uVar1;
   Object *pOVar2;
   char cVar3;
   int *piVar4;
   ...
   *piVar4 = *piVar4 + -1;
   ...
   if (pvVar7 == (void*)0x0) {
      LAB_00100d4c:Memory::free_static(pvVar6, false);
   } else {
   ...
   LAB_00100d56:*(undefined8*)this = 0;
   return;
}/* Dictionary::_ref(Dictionary const&) const */void Dictionary::_ref(Dictionary *this, Dictionary *param_1) {
   int iVar1;
   int iVar2;
   int *piVar3;
   bool bVar4;
   ...
   return;
}/* Dictionary::recursive_hash(int) const */uint Dictionary::recursive_hash(Dictionary *this, int param_1) {
   int iVar1;
   uint uVar2;
   long *plVar3;
   if (param_1 < 0x65) {
      ...
      if (plVar3 == (long*)0x0) {
         ...
         do {
            ...
            plVar3 = (long*)*plVar3;
            uVar2 = ( iVar1 * 0x16a88000 | ( uint )(iVar1 * -0x3361d2af) >> 0x11 ) * 0x1b873593 ^ ( uVar2 << 0xd | uVar2 >> 0x13 ) * 5 + 0xe6546b64;
   ...
   return 0;
}/* Dictionary::hash() const */void Dictionary::hash(Dictionary *this) {
   recursive_hash(this, 0);
   return;
}/* Dictionary::keys() const */void Dictionary::keys(void) {
   int iVar1;
   long lVar2;
   undefined8 *puVar3;
   Variant *this;
   ...
   if (iVar1 != 0) {
      Array::resize(uVar4);
      for (puVar3 = *(undefined8**)( *in_RSI + 0x28 ); puVar3 != (undefined8*)0x0; puVar3 = (undefined8*)*puVar3) {
   ...
   return;
}/* Dictionary::values() const */void Dictionary::values(void) {
   int iVar1;
   long lVar2;
   undefined8 *puVar3;
   Variant *this;
   ...
   return;
}/* Dictionary::make_read_only() */void Dictionary::make_read_only(Dictionary *this) {
   long lVar1;
   undefined4 *puVar2;
   ...
   *(undefined4**)( lVar1 + 8 ) = puVar2;
   return;
}/* Dictionary::is_read_only() const */undefined8 Dictionary::is_read_only(Dictionary *this) {
   ...
   const&, Variant const&) */void Dictionary::set_typed(uint param_1, StringName *param_2, Variant *param_3, uint param_4, StringName *param_5, Variant *param_6) {
   uint *puVar1;
   char cVar2;
   long lVar3;
   Object *pOVar4;
   ...
   if (*(long*)( puVar1 + 2 ) != 0) {
      ...
      uVar7 = 0x25b;
      LAB_001014be:_err_print_error("set_typed", "core/variant/dictionary.cpp", uVar7, pcVar6, pcVar9, 0);
      return;
   }
   if (puVar1[0xf] != 0) {
   ...
   if (( *(int*)( *plVar8 + 0x40 ) != 0 ) || ( *(int*)( *plVar8 + 0x60 ) != 0 )) {
      ...
      pcVar6 = "Condition \"_p->typed_key.type != Variant::NIL || _p->typed_value.type != Variant::NIL\" is true.";
      uVar7 = 0x25e;
      goto LAB_001014be;
   }
   if (( ( *(long*)param_3 != 0 ) && ( (int)param_2 != 0x18 ) ) || ( ( *(long*)param_6 != 0 && ( (int)param_5 != 0x18 ) ) )) {
      pcVar9 = "Class names can only be set for type OBJECT.";
      pcVar6 = "Condition \"(p_key_class_name != StringName() && p_key_type != Variant::OBJECT) || (p_value_class_name != StringName() && p_value_type != Variant::OBJECT)\" is true.";
      uVar7 = 0x25f;
      goto LAB_001014be;
   }
   ...
   if (( ( lVar3 == 0 ) || ( pOVar4 = (Object*)__dynamic_cast(lVar3, &Object::typeinfo, &Script::typeinfo, 0) ),pOVar4 == (Object*)0x0 )) {
      ...
      _err_print_error("set_typed", "core/variant/dictionary.cpp", 0x261, "Condition \"key_script.is_valid() && p_key_class_name == StringName()\" is true.", "Script class can only be set together with base class name.", 0, 0);
      goto LAB_0010151c;
   }
   lVar3 = Variant::get_validated_object();
   pOVar10 = (Object*)0x0;
   if (( ( lVar3 != 0 ) && ( pOVar5 = (Object*)__dynamic_cast(lVar3, &Object::typeinfo, &Script::typeinfo, 0) ),pOVar5 != (Object*)0x0 )) {
      _err_print_error("set_typed", "core/variant/dictionary.cpp", 0x263, "Condition \"value_script.is_valid() && p_value_class_name == StringName()\" is true.", "Script class can only be set together with base class name.", 0, 0);
   ...
   *(int*)( lVar3 + 0x40 ) = (int)param_2;
   ...
   lVar3 = *plVar8;
}*(char**)( lVar3 + 0x58 ) = "TypedDictionary.Key";*(int*)( lVar3 + 0x60 ) = (int)param_5;StringName::operator =((StringName*)( lVar3 + 0x68 ), (StringName*)param_6);lVar3 = *plVar8;pOVar5 = *(Object**)( lVar3 + 0x70 );if (pOVar10 == pOVar5) {
   LAB_001016c6:*(char**)( lVar3 + 0x78 ) = "TypedDictionary.Value";
   if (pOVar10 != (Object*)0x0) {
      LAB_0010147e:cVar2 = RefCounted::unreference();
   ...
   *(Object**)( lVar3 + 0x70 ) = pOVar10;
   if (pOVar10 != (Object*)0x0) {
      ...
      if (( pOVar5 != (Object*)0x0 ) && ( cVar2 = RefCounted::unreference() ),cVar2 != '\0') {
         LAB_001016a0:cVar2 = predelete_handler(pOVar5);
         if (cVar2 != '\0') {
            ( **(code**)( *(long*)pOVar5 + 0x140 ) )(pOVar5);
            Memory::free_static(pOVar5, false);
         }
   ...
   return;
}LAB_0010151c:cVar2 = RefCounted::unreference();if (( cVar2 != '\0' ) && ( cVar2 = predelete_handler(pOVar4) ),cVar2 != '\0') {
   ( **(code**)( *(long*)pOVar4 + 0x140 ) )(pOVar4);
   Memory::free_static(pOVar4, false);
   return;
}return;}/* Dictionary::set_typed(ContainerType const&, ContainerType const&) */void Dictionary::set_typed(Dictionary *this, ContainerType *param_1, ContainerType *param_2) {
   char cVar1;
   uint uVar2;
   long in_FS_OFFSET;
   int local_78[8];
   ...
   set_typed((uint)this, (StringName*)( ulong ) * (uint*)param_1, (Variant*)( param_1 + 8 ), (uint)local_78, (StringName*)(ulong)uVar2, (Variant*)( param_2 + 8 ));
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* Dictionary::is_typed() const */undefined4 Dictionary::is_typed(Dictionary *this) {
   int iVar1;
   undefined4 uVar2;
   uVar2 = 1;
   ...
   return uVar2;
}/* Dictionary::is_typed_key() const */undefined4 Dictionary::is_typed_key(Dictionary *this) {
   return CONCAT31(( int3 )(( uint ) * (int*)( *(long*)this + 0x40 ) >> 8), *(int*)( *(long*)this + 0x40 ) != 0);
}/* Dictionary::is_typed_value() const */undefined4 Dictionary::is_typed_value(Dictionary *this) {
   return CONCAT31(( int3 )(( uint ) * (int*)( *(long*)this + 0x60 ) >> 8), *(int*)( *(long*)this + 0x60 ) != 0);
}/* Dictionary::is_same_typed(Dictionary const&) const */bool Dictionary::is_same_typed(Dictionary *this, Dictionary *param_1) {
   long lVar1;
   long lVar2;
   bool bVar3;
   lVar1 = *(long*)param_1;
   lVar2 = *(long*)this;
   bVar3 = false;
   if (( ( ( *(int*)( lVar2 + 0x40 ) == *(int*)( lVar1 + 0x40 ) ) && ( *(long*)( lVar2 + 0x48 ) == *(long*)( lVar1 + 0x48 ) ) ) && ( *(long*)( lVar2 + 0x50 ) == *(long*)( lVar1 + 0x50 ) ) ) && ( ( bVar3 = false * (int*)( lVar2 + 0x60 ) == *(int*)( lVar1 + 0x60 ) && ( *(long*)( lVar2 + 0x68 ) == *(long*)( lVar1 + 0x68 ) ) ) )) {
      bVar3 = *(long*)( lVar2 + 0x70 ) == *(long*)( lVar1 + 0x70 );
   }
   return bVar3;
}/* Dictionary::is_same_typed_key(Dictionary const&) const */bool Dictionary::is_same_typed_key(Dictionary *this, Dictionary *param_1) {
   long lVar1;
   long lVar2;
   lVar1 = *(long*)param_1;
   lVar2 = *(long*)this;
   if (( *(int*)( lVar2 + 0x40 ) == *(int*)( lVar1 + 0x40 ) ) && ( *(long*)( lVar2 + 0x48 ) == *(long*)( lVar1 + 0x48 ) )) {
      return *(long*)( lVar2 + 0x50 ) == *(long*)( lVar1 + 0x50 );
   }
   return false;
}/* Dictionary::is_same_typed_value(Dictionary const&) const */bool Dictionary::is_same_typed_value(Dictionary *this, Dictionary *param_1) {
   long lVar1;
   long lVar2;
   lVar1 = *(long*)param_1;
   lVar2 = *(long*)this;
   if (( *(int*)( lVar2 + 0x60 ) == *(int*)( lVar1 + 0x60 ) ) && ( *(long*)( lVar2 + 0x68 ) == *(long*)( lVar1 + 0x68 ) )) {
      return *(long*)( lVar2 + 0x70 ) == *(long*)( lVar1 + 0x70 );
   }
   return false;
}/* Dictionary::get_key_type() const */void Dictionary::get_key_type(void) {
   long lVar1;
   Object *pOVar2;
   Object *pOVar3;
   char cVar4;
   ...
   *in_RDI = *(undefined4*)( lVar1 + 0x40 );
   ...
   return;
}/* Dictionary::get_value_type() const */void Dictionary::get_value_type(void) {
   long lVar1;
   Object *pOVar2;
   Object *pOVar3;
   char cVar4;
   ...
   *in_RDI = *(undefined4*)( lVar1 + 0x60 );
   ...
   return;
}/* Dictionary::get_typed_key_builtin() const */undefined4 Dictionary::get_typed_key_builtin(Dictionary *this) {
   return *(undefined4*)( *(long*)this + 0x40 );
}/* Dictionary::get_typed_value_builtin() const */undefined4 Dictionary::get_typed_value_builtin(Dictionary *this) {
   return *(undefined4*)( *(long*)this + 0x60 );
}/* Dictionary::get_typed_key_class_name() const */void Dictionary::get_typed_key_class_name(void) {
   long *in_RSI;
   StringName *in_RDI;
   StringName::StringName(in_RDI, (StringName*)( *in_RSI + 0x48 ));
   return;
}/* Dictionary::get_typed_value_class_name() const */void Dictionary::get_typed_value_class_name(void) {
   long *in_RSI;
   StringName *in_RDI;
   StringName::StringName(in_RDI, (StringName*)( *in_RSI + 0x68 ));
   return;
}/* Dictionary::get_typed_key_script() const */void Dictionary::get_typed_key_script(void) {
   long *in_RSI;
   Variant *in_RDI;
   Variant::Variant(in_RDI, *(Object**)( *in_RSI + 0x50 ));
   return;
}/* Dictionary::get_typed_value_script() const */void Dictionary::get_typed_value_script(void) {
   long *in_RSI;
   Variant *in_RDI;
   Variant::Variant(in_RDI, *(Object**)( *in_RSI + 0x70 ));
   return;
}/* Dictionary::TEMPNAMEPLACEHOLDERVALUE(Dictionary const&) */void Dictionary::operator =(Dictionary *this, Dictionary *param_1) {
   if (this != param_1) {
      _ref(this, param_1);
      return;
   }
   return;
}/* Dictionary::id() const */undefined8 Dictionary::id(Dictionary *this) {
   return *(undefined8*)this;
}/* Dictionary::Dictionary(Dictionary const&) */void Dictionary::Dictionary(Dictionary *this, Dictionary *param_1) {
   int iVar1;
   int iVar2;
   int *piVar3;
   bool bVar4;
   *(undefined8*)this = 0;
   ...
   return;
}/* Dictionary::Dictionary() */void Dictionary::Dictionary(Dictionary *this) {
   undefined4 *puVar1;
   ...
   *puVar1 = 1;
   ...
   _unref(this);
   return;
}/* Dictionary::has(Variant const&) const */ulong Dictionary::has(Dictionary *this, Variant *param_1) {
   long *plVar1;
   undefined8 uVar2;
   char *pcVar3;
   undefined1 auVar4[16];
   ...
   if (iVar20 == 0) {
      LAB_00101ee4:if (*(long*)( lVar28 + 0x18 ) != 0) {
         LAB_00101eeb:if (*(int*)( lVar28 + 0x3c ) != 0) {
            ...
            if (uVar14 != 0) {
               ...
               do {
                  if (uVar19 == uVar14) {
                     uVar15 = StringLikeVariantComparator::compare((Variant*)( *(long*)( *(long*)( lVar28 + 0x18 ) + lVar21 * 8 ) + 0x10 ), param_1);
               ...
               } while ( ( uVar14 != 0 ) && ( auVar6._8_8_ = 0 ),auVar6._0_8_ = (ulong)uVar14 * lVar16,auVar10._8_8_ = 0,auVar10._0_8_ = uVar23,auVar7._8_8_ = 0,auVar7._0_8_ = ( ulong )(( uVar24 + iVar20 ) - SUB164(auVar6 * auVar10, 8)) * lVar16,auVar11._8_8_ = 0,auVar11._0_8_ = uVar23,uVar22 <= SUB164(auVar7 * auVar11, 8) );
            }
         }
      }
   } else {
      if (iVar20 == local_78[0]) {
            ...
            if (( uVar15 >> 0x18 & 0x7fffffffff ) == ( *puVar25 & 0x7fffffffff )) {
               ...
               if (plVar1 != (long*)0x0) {
                  ...
                  if (local_b0 == *(long*)( lVar28 + 0x48 )) {
                     LAB_00102216:if (*(long*)( lVar28 + 0x50 ) == 0) {
                        if (( StringName::configured != '\0' ) && ( local_b0 != 0 )) {
                           StringName::unref();
                           LAB_00102080:lVar28 = *(long*)this;
                           goto LAB_00101ee4;
                        }
                        goto LAB_00101fdc;
                     }
                     ...
                     if (lVar16 == 0) {
                        LAB_001025b7:cVar12 = Variant::needs_deinit[local_58[0]];
                     } else {
                        ...
                        if (pOVar17 != (Object*)0x0) {
                           ...
                           if (cVar12 == '\0') {
                              ...
                              vformat<String,String,String>(&local_88, (StrRange*)&local_90, (StrRange*)&local_98, (StrRange*)&local_a0, &local_a8);
                              _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x92, "Condition \"!other_script->inherits_script(script)\" is true. Returning: false", &local_88, 0, 0);
                              for (int i = 0; i < 5; i++) {
                     ...
                     String::parse_latin1((StrRange*)&local_90);
                     vformat<String,String,String>(&local_88, (StrRange*)&local_90, (StrRange*)&local_98, (StrRange*)&local_a0, &local_a8);
                     _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x91, "Condition \"other_script.is_null()\" is true. Returning: false", &local_88, 0, 0);
                     for (int i = 0; i < 5; i++) {
                        CowData<char32_t>::_unref();
                     }
                  } else {
                     ...
                     ( **(code**)( *plVar1 + 0x48 ) )(&local_a0, plVar1);
                     local_88 = "use \'has\'";
                     local_98 = 0;
                     local_80 = 9;
                     String::parse_latin1((StrRange*)&local_98);
                     ...
                     local_80 = 0x53;
                     String::parse_latin1((StrRange*)&local_90);
                     vformat<String,String,char_const*,String>(&local_88, (StrRange*)&local_90, (StrRange*)&local_98, &local_a0, uVar2, &local_a8);
                     _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x87, "Condition \"!ClassDB::is_parent_class(object->get_class_name(), class_name)\" is true. Returning: false", &local_88, 0, 0);
                     for (int i = 0; i < 5; i++) {
                        CowData<char32_t>::_unref();
                     }
                  }
         ...
         local_80 = 0x4b;
         String::parse_latin1((StrRange*)&local_90);
         vformat<String,String>(&local_88, (StrRange*)&local_90, (StrRange*)&local_98, (StrRange*)&local_a0);
         _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x7a, "Parameter \"object\" is null.", &local_88, 0, 0);
         for (int i = 0; i < 4; i++) {
            CowData<char32_t>::_unref();
         }
      } else {
      ...
      LAB_00101e62:_err_print_error(&_LC51, "core/variant/dictionary.cpp", 0xd2, "Condition \"!_p->typed_key.validate(key, \"use \'has\'\")\" is true. Returning: false", 0, 0);
   }
   uVar15 = 0;
   LAB_00101e92:if (Variant::needs_deinit[local_78[0]] != '\0') {
      Variant::_clear_internal();
      uVar15 = uVar15 & 0xff;
   }
   LAB_00101ea5:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return uVar15;
}/* Dictionary::has_all(Array const&) const */undefined8 Dictionary::has_all(Dictionary *this, Array *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   ulong uVar4;
   ...
   if (0 < iVar7) {
      do {
         ...
         if (iVar7 == local_78[0]) {
            if (( iVar7 != 0x18 ) || ( uVar10 = Variant::operator_cast_to_ObjectID((Variant*)local_78) ),uVar10 == 0) goto LAB_00102e07;
               ...
               if (( uVar10 >> 0x18 & 0x7fffffffff ) == ( *puVar17 & 0x7fffffffff )) {
                  ...
                  if (plVar1 != (long*)0x0) {
                     ...
                     if (local_b0 == *(long*)( lVar2 + 0x48 )) {
                        LAB_00102f3e:if (*(long*)( lVar2 + 0x50 ) == 0) {
                           if (( StringName::configured != '\0' ) && ( local_b0 != 0 )) {
                              StringName::unref();
                           }
                           goto LAB_00102e07;
                        ...
                        if (lVar11 == 0) {
                           LAB_0010324b:if (Variant::needs_deinit[local_58[0]] != '\0') {
                              Variant::_clear_internal();
                           }
                        } else {
                           ...
                           if (pOVar12 != (Object*)0x0) {
                              ...
                              if (cVar5 != '\0') {
                                 ...
                                 if (cVar5 == '\0') {
                                    ...
                                    local_80 = 0x45;
                                    String::parse_latin1((StrRange*)&local_90);
                                    vformat<String,String,String>(&local_88, (StrRange*)&local_90, (StrRange*)&local_98, (StrRange*)&local_a0, local_d0);
                                    _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x92, "Condition \"!other_script->inherits_script(script)\" is true. Returning: false", &local_88, 0, 0);
                                    for (int i = 0; i < 5; i++) {
                                       CowData<char32_t>::_unref();
                                    }
                        ...
                        local_80 = 0x53;
                        String::parse_latin1((StrRange*)&local_90);
                        vformat<String,String,char_const*,String>(&local_88, (StrRange*)&local_90, (StrRange*)&local_98, &local_a0, uVar9, &local_a8);
                        _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x87, "Condition \"!ClassDB::is_parent_class(object->get_class_name(), class_name)\" is true. Returning: false", &local_88, 0, 0);
                        for (int i = 0; i < 5; i++) {
                           CowData<char32_t>::_unref();
                        }
            ...
            LAB_00102d94:_err_print_error("has_all", "core/variant/dictionary.cpp", 0xd9, "Condition \"!_p->typed_key.validate(key, \"use \'has_all\'\")\" is true. Returning: false", 0, 0);
            LAB_00102db9:if (Variant::needs_deinit[local_78[0]] != '\0') {
               Variant::_clear_internal();
            }
            uVar9 = 0;
            goto LAB_00102dce;
         ...
         if (local_78[0] == 0) {
            ...
            if (local_78[0] != 4) {
               LAB_00102bdd:Variant::get_type_name(&local_90);
               uVar9 = *(undefined8*)( lVar2 + 0x58 );
               Variant::get_type_name(&local_98, local_78[0]);
               local_88 = "use \'has_all\'";
               local_a0 = 0;
               ...
               local_80 = 0x3f;
               String::parse_latin1((StrRange*)&local_a8);
               vformat<String,String,char_const*,String>(&local_88, (StrRange*)&local_a8, (StrRange*)&local_a0, &local_98, uVar9, &local_90);
               _err_print_error("validate", "./core/variant/container_type_validate.h", 0x67, "Method/function failed. Returning: false", &local_88, 0, 0);
               pcVar3 = local_88;
               if (local_88 != (char*)0x0) {
                  LOCK();
         ...
         LAB_00102e07:cVar5 = has(this, (Variant*)local_78);
   ...
   uVar9 = 1;
   LAB_00102dce:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar9;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* Dictionary::find_key(Variant const&) const */Variant *Dictionary::find_key(Variant *param_1) {
   long *plVar1;
   int iVar2;
   undefined8 uVar3;
   undefined8 *puVar4;
   ...
   if (iVar2 == 0) {
      LAB_00103d20:for (puVar4 = *(undefined8**)( lVar16 + 0x28 ); puVar4 != (undefined8*)0x0; puVar4 = (undefined8*)*puVar4) {
      ...
      *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
      LAB_00103d5a:cVar7 = Variant::needs_deinit[local_78[0]];
         ...
         if (( uVar9 >> 0x18 & 0x7fffffffff ) == ( *puVar10 & 0x7fffffffff )) {
            ...
            if (plVar1 != (long*)0x0) {
               if (*(long*)( lVar16 + 0x68 ) == 0) {
                  LAB_00103d93:lVar16 = *in_RSI;
                  goto LAB_00103d20;
               }
               pSVar15 = (StringName*)( plVar1[1] + 0x20 );
               if (( plVar1[1] == 0 ) && ( pSVar15 = (StringName*)plVar1[0x23] ),pSVar15 == (StringName*)0x0) {
                  pSVar15 = (StringName*)( **(code**)( *plVar1 + 0x40 ) )(plVar1);
               }
               StringName::StringName((StringName*)&local_b0, pSVar15);
               if (local_b0 == *(long*)( lVar16 + 0x68 )) {
                  LAB_00104050:if (*(long*)( lVar16 + 0x70 ) == 0) {
                     if (( StringName::configured != '\0' ) && ( local_b0 != 0 )) {
                        StringName::unref();
                        LAB_00103e4d:lVar16 = *in_RSI;
                        goto LAB_00103d20;
                     }
                     goto LAB_00103d93;
                  }
                  ...
                  lVar11 = Variant::get_validated_object();
                  if (lVar11 == 0) {
                     LAB_0010430c:cVar7 = Variant::needs_deinit[local_58[0]];
                  } else {
                     ...
                     if (pOVar12 != (Object*)0x0) {
                        ...
                        if (cVar7 != '\0') {
                           ...
                           if (cVar7 == '\0') {
                              ...
                              local_80 = 0x45;
                              String::parse_latin1((StrRange*)&local_90);
                              vformat<String,String,String>(&local_88, (StrRange*)&local_90, (StrRange*)&local_98, (StrRange*)&local_a0, local_e8);
                              _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x92, "Condition \"!other_script->inherits_script(script)\" is true. Returning: false", &local_88, 0, 0);
                              for (int i = 0; i < 5; i++) {
                                 CowData<char32_t>::_unref();
                              }
                  ...
                  local_80 = 0x53;
                  String::parse_latin1((StrRange*)&local_90);
                  vformat<String,String,char_const*,String>(&local_88, (StrRange*)&local_90, (StrRange*)&local_98, &local_a0, uVar3, local_e8);
                  _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x87, "Condition \"!ClassDB::is_parent_class(object->get_class_name(), class_name)\" is true. Returning: false", &local_88, 0, 0);
                  for (int i = 0; i < 5; i++) {
                     CowData<char32_t>::_unref();
                  }
   ...
   LAB_00103cbf:_err_print_error("find_key", "core/variant/dictionary.cpp", 0xe3, "Condition \"!_p->typed_value.validate(value, \"find_key\")\" is true. Returning: Variant()", 0, 0);
   *(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   cVar7 = Variant::needs_deinit[local_78[0]];
   joined_r0x00103d65:if (cVar7 != '\0') {
      Variant::_clear_internal();
   }
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
   ...
   return param_1;
}/* Dictionary::getptr(Variant const&) */Variant * __thiscall Dictionary::getptr(Dictionary *this,Variant *param_1){
   long *plVar1;
   int iVar2;
   undefined8 uVar3;
   char *pcVar4;
   ...
   if (iVar2 == 0) {
      LAB_00104ae5:if (( *(long*)( lVar30 + 0x18 ) != 0 ) && ( *(int*)( lVar30 + 0x3c ) != 0 )) {
         ...
         if (uVar16 != 0) {
            ...
            do {
               if (uVar16 == uVar22) {
                  cVar14 = StringLikeVariantComparator::compare((Variant*)( *(long*)( *(long*)( lVar30 + 0x18 ) + lVar24 * 8 ) + 0x10 ), (Variant*)local_78);
                  if (cVar14 != '\0') {
            ...
            } while ( ( uVar16 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = (ulong)uVar16 * lVar19,auVar11._8_8_ = 0,auVar11._0_8_ = uVar18,auVar8._8_8_ = 0,auVar8._0_8_ = ( ulong )(( uVar26 + uVar23 ) - SUB164(auVar7 * auVar11, 8)) * lVar19,auVar12._8_8_ = 0,auVar12._0_8_ = uVar18,uVar25 <= SUB164(auVar8 * auVar12, 8) );
            pVVar17 = (Variant*)0x0;
            goto LAB_00104c34;
         }
      }
      LAB_00104ac3:pVVar17 = (Variant*)0x0;
   } else {
      if (iVar2 == local_78[0]) {
            ...
            if (( uVar18 >> 0x18 & 0x7fffffffff ) == ( *puVar27 & 0x7fffffffff )) {
               ...
               if (plVar1 != (long*)0x0) {
                  ...
                  if (local_b0 == *(long*)( lVar30 + 0x48 )) {
                     LAB_00104eb6:if (*(long*)( lVar30 + 0x50 ) == 0) {
                        if (( StringName::configured != '\0' ) && ( local_b0 != 0 )) {
                           StringName::unref();
                           LAB_00104d18:lVar30 = *(long*)this;
                           goto LAB_00104ae5;
                        }
                        goto LAB_00104be7;
                     }
                     ...
                     if (lVar19 == 0) {
                        LAB_00105223:cVar14 = Variant::needs_deinit[local_58[0]];
                     } else {
                        ...
                        if (pOVar20 != (Object*)0x0) {
                           ...
                           if (cVar14 != '\0') {
                              ...
                              if (cVar14 == '\0') {
                                 ...
                                 local_80 = 0x45;
                                 String::parse_latin1((StrRange*)&local_90);
                                 vformat<String,String,String>(&local_88, (StrRange*)&local_90, (StrRange*)&local_98, (StrRange*)&local_a0, local_d8);
                                 _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x92, "Condition \"!other_script->inherits_script(script)\" is true. Returning: false", &local_88, 0, 0);
                                 for (int i = 0; i < 5; i++) {
                                    CowData<char32_t>::_unref();
                                 }
                     ...
                     local_80 = 0x53;
                     String::parse_latin1((StrRange*)&local_90);
                     vformat<String,String,char_const*,String>(&local_88, (StrRange*)&local_90, (StrRange*)&local_98, &local_a0, uVar3, local_d8);
                     _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x87, "Condition \"!ClassDB::is_parent_class(object->get_class_name(), class_name)\" is true. Returning: false", &local_88, 0, 0);
                     for (int i = 0; i < 5; i++) {
                        CowData<char32_t>::_unref();
                     }
   ...
   LAB_00104c34:if (Variant::needs_deinit[local_78[0]] != '\0') {
      Variant::_clear_internal();
   }
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return pVVar17;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* Dictionary::next(Variant const*) const */long Dictionary::next(Dictionary *this, Variant *param_1) {
   long *plVar1;
   int iVar2;
   undefined8 uVar3;
   char *pcVar4;
   ...
   if (iVar2 == 0) {
      LAB_00105ad4:if (( *(long*)( lVar17 + 0x18 ) != 0 ) && ( *(int*)( lVar17 + 0x3c ) != 0 )) {
         ...
         if (uVar16 != 0) {
            ...
            do {
               if (uVar16 == uVar22) {
                  cVar14 = StringLikeVariantComparator::compare((Variant*)( *(long*)( *(long*)( lVar17 + 0x18 ) + lVar24 * 8 ) + 0x10 ), (Variant*)local_78);
                  if (cVar14 != '\0') {
                     plVar1 = *(long**)( *(long*)( lVar17 + 0x18 ) + (ulong)uVar23 * 8 );
                     if (( plVar1 != (long*)0x0 ) && ( lVar17 = lVar17 != 0 )) {
                        lVar17 = lVar17 + 0x10;
                        goto LAB_00105a82;
                     }
                     break;
               ...
               uVar16 = *(uint*)( lVar29 + lVar24 * 4 );
               uVar23 = SUB164(auVar6 * auVar10, 8);
               if (( uVar16 == 0 ) || ( auVar7._8_8_ = 0 ),auVar7._0_8_ = (ulong)uVar16 * lVar19,auVar11._8_8_ = 0,auVar11._0_8_ = uVar18,auVar8._8_8_ = 0,auVar8._0_8_ = ( ulong )(( uVar26 + uVar23 ) - SUB164(auVar7 * auVar11, 8)) * lVar19,auVar12._8_8_ = 0,auVar12._0_8_ = uVar18,SUB164(auVar8 * auVar12, 8) < uVar25) break;
            } while ( true );
         }
      }
   } else {
      if (iVar2 == local_78[0]) {
            ...
            if (( uVar18 >> 0x18 & 0x7fffffffff ) == ( *puVar27 & 0x7fffffffff )) {
               ...
               if (plVar1 != (long*)0x0) {
                  ...
                  if (local_b0 == *(long*)( lVar17 + 0x48 )) {
                     LAB_00105dc6:if (*(long*)( lVar17 + 0x50 ) == 0) {
                        if (( StringName::configured != '\0' ) && ( local_b0 != 0 )) {
                           StringName::unref();
                           LAB_00105c80:lVar17 = *(long*)this;
                           goto LAB_00105ad4;
                        }
                        goto LAB_00105abf;
                     }
                     ...
                     lVar19 = Variant::get_validated_object();
                     if (lVar19 == 0) {
                        LAB_00106123:cVar14 = Variant::needs_deinit[local_58[0]];
                     } else {
                        pOVar20 = (Object*)__dynamic_cast(lVar19, &Object::typeinfo, &Script::typeinfo, 0);
                        if (pOVar20 != (Object*)0x0) {
                           cVar14 = RefCounted::reference();
                           if (cVar14 != '\0') {
                              ...
                              if (cVar14 == '\0') {
                                 ...
                                 if (lVar19 == 0) {
                                    ...
                                    local_a0 = 0;
                                    if (*(char**)( lVar19 + 8 ) == (char*)0x0) {
                                       CowData<char32_t>::_ref((CowData<char32_t>*)&local_a0, (CowData*)( lVar19 + 0x10 ));
                                    } else {
                                 ...
                                 local_88 = (char*)0x0;
                                 String::parse_latin1((String_conflict*)&local_88, "Attempted to %s an object into a %s, that does not inherit from \'%s\'.");
                                 vformat<String,String,String>(&local_a8, (String_conflict*)&local_88, (String_conflict*)&local_90, (String_conflict*)&local_98, local_c8);
                                 _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x92, "Condition \"!other_script->inherits_script(script)\" is true. Returning: false", &local_a8, 0, 0);
                                 for (int i = 0; i < 5; i++) {
                                    CowData<char32_t>::_unref();
                                 }
                              }
                     ...
                     local_80 = 0x45;
                     String::parse_latin1((StrRange*)&local_90);
                     vformat<String,String,String>((String_conflict*)&local_88, (StrRange*)&local_90, (StrRange*)&local_98, (String_conflict*)&local_a0, &local_a8);
                     _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x91, "Condition \"other_script.is_null()\" is true. Returning: false", (String_conflict*)&local_88, 0, 0);
                     for (int i = 0; i < 5; i++) {
                        CowData<char32_t>::_unref();
                     }
                  } else {
                     ...
                     local_80 = 0x53;
                     String::parse_latin1((StrRange*)&local_90);
                     vformat<String,String,char_const*,String>((String_conflict*)&local_88, (StrRange*)&local_90, (StrRange*)&local_98, &local_a0, uVar3, &local_a8);
                     _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x87, "Condition \"!ClassDB::is_parent_class(object->get_class_name(), class_name)\" is true. Returning: false", (String_conflict*)&local_88, 0, 0);
                     for (int i = 0; i < 5; i++) {
                        CowData<char32_t>::_unref();
                     }
                  }
         ...
         local_80 = 0x4b;
         String::parse_latin1((StrRange*)&local_90);
         vformat<String,String>((String_conflict*)&local_88, (StrRange*)&local_90, (StrRange*)&local_98, (StrRange*)&local_a0);
         _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x7a, "Parameter \"object\" is null.", (String_conflict*)&local_88, 0, 0);
         for (int i = 0; i < 4; i++) {
            CowData<char32_t>::_unref();
         }
      } else {
      ...
      LAB_00105a5b:_err_print_error(&_LC58, "core/variant/dictionary.cpp", 0x221, "Condition \"!_p->typed_key.validate(key, \"next\")\" is true. Returning: nullptr", 0, 0);
   }
   lVar17 = 0;
   LAB_00105a82:if (Variant::needs_deinit[local_78[0]] != '\0') {
      Variant::_clear_internal();
   }
   LAB_00105a96:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return lVar17;
}/* Dictionary::getptr(Variant const&) const */long Dictionary::getptr(Dictionary *this, Variant *param_1) {
   long *plVar1;
   int iVar2;
   undefined8 uVar3;
   char *pcVar4;
   ...
   iVar2 = *(int*)( lVar17 + 0x40 );
   if (iVar2 == 0) {
      LAB_00106878:if (( *(long*)( lVar17 + 0x18 ) != 0 ) && ( *(int*)( lVar17 + 0x3c ) != 0 )) {
         ...
         if (uVar16 != 0) {
            ...
            do {
               ...
               uVar16 = *(uint*)( lVar28 + lVar24 * 4 );
               uVar23 = SUB164(auVar6 * auVar10, 8);
            } while ( ( uVar16 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = (ulong)uVar16 * lVar19,auVar11._8_8_ = 0,auVar11._0_8_ = uVar18,auVar8._8_8_ = 0,auVar8._0_8_ = ( ulong )(( uVar25 + uVar23 ) - SUB164(auVar7 * auVar11, 8)) * lVar19,auVar12._8_8_ = 0,auVar12._0_8_ = uVar18,uVar29 <= SUB164(auVar8 * auVar12, 8) );
            lVar17 = 0;
            goto LAB_001069ab;
         }
      }
      LAB_0010685d:lVar17 = 0;
   } else {
      if (local_78[0] == iVar2) {
         ...
         if (uVar25 < (uint)ObjectDB::slot_max) {
            ...
            if (( uVar18 >> 0x18 & 0x7fffffffff ) == ( *puVar26 & 0x7fffffffff )) {
               ...
               if (plVar1 != (long*)0x0) {
                  ...
                  if (local_b0 == *(long*)( lVar17 + 0x48 )) {
                     LAB_00106c41:if (*(long*)( lVar17 + 0x50 ) == 0) {
                        if (( StringName::configured != '\0' ) && ( local_b0 != 0 )) {
                           StringName::unref();
                           LAB_00106a90:lVar17 = *(long*)this;
                           goto LAB_00106878;
                        }
                        goto LAB_00106976;
                     }
                     ...
                     lVar19 = Variant::get_validated_object();
                     if (lVar19 == 0) {
                        LAB_00106f9d:cVar14 = Variant::needs_deinit[local_58[0]];
                     } else {
                        pOVar20 = (Object*)__dynamic_cast(lVar19, &Object::typeinfo, &Script::typeinfo, 0);
                        if (pOVar20 != (Object*)0x0) {
                           cVar14 = RefCounted::reference();
                           if (cVar14 != '\0') {
                              ...
                              if (cVar14 == '\0') {
                                 ...
                                 local_80 = 0x45;
                                 String::parse_latin1((StrRange*)&local_90);
                                 vformat<String,String,String>(&local_88, (StrRange*)&local_90, (StrRange*)&local_98, (StrRange*)&local_a0, local_e0);
                                 _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x92, "Condition \"!other_script->inherits_script(script)\" is true. Returning: false", &local_88, 0, 0);
                                 for (int i = 0; i < 5; i++) {
                                    CowData<char32_t>::_unref();
                                 }
                     ...
                     local_80 = 0x53;
                     String::parse_latin1((StrRange*)&local_90);
                     vformat<String,String,char_const*,String>(&local_88, (StrRange*)&local_90, (StrRange*)&local_98, &local_a0, uVar3, local_e0);
                     _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x87, "Condition \"!ClassDB::is_parent_class(object->get_class_name(), class_name)\" is true. Returning: false", &local_88, 0, 0);
                     for (int i = 0; i < 5; i++) {
                        CowData<char32_t>::_unref();
                     }
   ...
   LAB_001069ab:if (Variant::needs_deinit[local_78[0]] != '\0') {
      Variant::_clear_internal();
   }
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return lVar17;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* Dictionary::get(Variant const&, Variant const&) const */Variant *Dictionary::get(Variant *param_1, Variant *param_2) {
   long *plVar1;
   int iVar2;
   long lVar3;
   undefined8 uVar4;
   ...
   if (iVar2 == local_78[0]) {
      if (( iVar2 != 0x18 ) || ( uVar10 = Variant::operator_cast_to_ObjectID((Variant*)local_78) ),uVar10 == 0) goto LAB_00107868;
         ...
         if (( uVar10 >> 0x18 & 0x7fffffffff ) == ( *puVar15 & 0x7fffffffff )) {
            ...
            if (plVar1 != (long*)0x0) {
               ...
               if (local_b0 == *(long*)( lVar3 + 0x48 )) {
                  LAB_00107baa:if (*(long*)( lVar3 + 0x50 ) == 0) {
                     if (( StringName::configured != '\0' ) && ( local_b0 != 0 )) {
                        StringName::unref();
                     }
                     LAB_00107868:pVVar9 = (Variant*)getptr((Dictionary*)param_2, (Variant*)local_78);
                  ...
                  lVar11 = Variant::get_validated_object();
                  if (lVar11 == 0) {
                     LAB_00107eec:cVar7 = Variant::needs_deinit[local_58[0]];
                  } else {
                     pOVar12 = (Object*)__dynamic_cast(lVar11, &Object::typeinfo, &Script::typeinfo);
                     if (pOVar12 != (Object*)0x0) {
                        cVar7 = RefCounted::reference();
                  ...
                  local_80 = 0x53;
                  String::parse_latin1((StrRange*)&local_90);
                  vformat<String,String,char_const*,String>(&local_88, (StrRange*)&local_90, (StrRange*)&local_98, &local_a0, uVar4, local_e0);
                  _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x87, "Condition \"!ClassDB::is_parent_class(object->get_class_name(), class_name)\" is true. Returning: false", &local_88, 0, 0);
                  for (int i = 0; i < 5; i++) {
                     CowData<char32_t>::_unref();
                  }
   ...
   LAB_00107807:_err_print_error(&_LC60, "core/variant/dictionary.cpp", 0xa8, "Condition \"!_p->typed_key.validate(key, \"get\")\" is true. Returning: p_default", 0, 0);
   Variant::Variant(param_1, in_RCX);
   cVar7 = Variant::needs_deinit[local_78[0]];
   joined_r0x00107890:if (cVar7 != '\0') {
      Variant::_clear_internal();
   }
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* Dictionary::get_valid(Variant const&) const */Variant *Dictionary::get_valid(Variant *param_1) {
   long *plVar1;
   int iVar2;
   undefined8 uVar3;
   char *pcVar4;
   ...
   if (iVar2 == 0) {
      LAB_001088e8:lVar18 = *(long*)( lVar29 + 0x18 );
      joined_r0x001087d9:if (( lVar18 != 0 ) && ( *(int*)( lVar29 + 0x3c ) != 0 )) {
         ...
         if (uVar16 != 0) {
            ...
            do {
               if (uVar16 == uVar21) {
                  cVar14 = StringLikeVariantComparator::compare((Variant*)( *(long*)( *(long*)( lVar29 + 0x18 ) + lVar23 * 8 ) + 0x10 ), (Variant*)local_78);
                  if (cVar14 != '\0') {
               ...
               if (( uVar16 == 0 ) || ( auVar7._8_8_ = 0 ),auVar7._0_8_ = (ulong)uVar16 * lVar18,auVar11._8_8_ = 0,auVar11._0_8_ = uVar17,auVar8._8_8_ = 0,auVar8._0_8_ = ( ulong )(( uVar25 + uVar22 ) - SUB164(auVar7 * auVar11, 8)) * lVar18,auVar12._8_8_ = 0,auVar12._0_8_ = uVar17,SUB164(auVar8 * auVar12, 8) < uVar24) break;
            } while ( true );
         }
      }
      *(undefined4*)param_1 = 0;
      *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
      LAB_00108912:cVar14 = Variant::needs_deinit[local_78[0]];
   ...
   if (local_78[0] == iVar2) {
         ...
         if (( uVar17 >> 0x18 & 0x7fffffffff ) == ( *puVar26 & 0x7fffffffff )) {
            ...
            if (plVar1 != (long*)0x0) {
               ...
               if (local_b0 == *(long*)( lVar29 + 0x48 )) {
                  LAB_00108c26:if (*(long*)( lVar29 + 0x50 ) == 0) {
                     if (( StringName::configured != '\0' ) && ( local_b0 != 0 )) {
                        StringName::unref();
                        LAB_00108a20:lVar29 = *in_RSI;
                        goto LAB_001087d4;
                     }
                     goto LAB_001088df;
                  }
                  ...
                  if (lVar18 == 0) {
                     LAB_00108ef3:cVar14 = Variant::needs_deinit[local_58[0]];
                  } else {
      ...
      if (local_78[0] == 0) {
         ...
         if (local_78[0] == 0x15) {
            ...
            CowData<char32_t>::_unref();
            lVar29 = *in_RSI;
            LAB_001087d4:lVar18 = *(long*)( lVar29 + 0x18 );
   ...
   LAB_00108762:_err_print_error("get_valid", "core/variant/dictionary.cpp", 0x9d, "Condition \"!_p->typed_key.validate(key, \"get_valid\")\" is true. Returning: Variant()", 0, 0);
   *(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   cVar14 = Variant::needs_deinit[local_78[0]];
   joined_r0x0010891f:if (cVar14 != '\0') {
      Variant::_clear_internal();
   }
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
   ...
   return param_1;
}/* Dictionary::erase(Variant const&) */ulong Dictionary::erase(Dictionary *this, Variant *param_1) {
   long *plVar1;
   int iVar2;
   undefined8 uVar3;
   char *pcVar4;
   ...
   if (iVar2 == 0) {
      LAB_001096f0:if (*(long*)( lVar15 + 8 ) == 0) {
         uVar8 = HashMap<Variant,Variant,VariantHasher,StringLikeVariantComparator,DefaultTypedAllocator<HashMapElement<Variant,Variant>>>::erase((HashMap<Variant,Variant,VariantHasher,StringLikeVariantComparator,DefaultTypedAllocator<HashMapElement<Variant,Variant>>>*)( lVar15 + 0x10 ), (Variant*)local_78);
      } else {
         _err_print_error("erase", "core/variant/dictionary.cpp", 0xef, "Condition \"_p->read_only\" is true. Returning: false", "Dictionary is in read-only state.", 0, 0);
         uVar8 = 0;
      }
      goto LAB_00109707;
   }
         ...
         if (( uVar8 >> 0x18 & 0x7fffffffff ) == ( *puVar13 & 0x7fffffffff )) {
            ...
            if (plVar1 != (long*)0x0) {
               ...
               if (local_b0 == *(long*)( lVar15 + 0x48 )) {
                  LAB_001099e6:if (*(long*)( lVar15 + 0x50 ) == 0) {
                     if (( StringName::configured != '\0' ) && ( local_b0 != 0 )) {
                        StringName::unref();
                        LAB_001097e0:lVar15 = *(long*)this;
                        goto LAB_001096f0;
                     }
                     goto LAB_00109740;
                  }
                  ...
                  if (lVar9 == 0) {
                     LAB_00109cfc:cVar6 = Variant::needs_deinit[local_58[0]];
                  } else {
   ...
   LAB_001096b4:_err_print_error("erase", "core/variant/dictionary.cpp", 0xee, "Condition \"!_p->typed_key.validate(key, \"erase\")\" is true. Returning: false", 0, 0);
   uVar8 = 0;
   LAB_00109707:if (Variant::needs_deinit[local_78[0]] != '\0') {
      Variant::_clear_internal();
      uVar8 = uVar8 & 0xff;
   }
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   ...
   *(undefined8**)this = puVar3 + 2;
   ...
   if (param_1 * 0x18 != 0) {
      ...
      if (lVar11 != 0) {
         ...
         if (lVar11 == lVar9) {
            LAB_0010a693:puVar5 = *(undefined8**)this;
            if (puVar5 == (undefined8*)0x0) {
               /* WARNING: Does not return */
               pcVar1 = (code*)invalidInstructionException();
               ( *pcVar1 )();
         ...
         *(undefined1(*) [16])( puVar5 + lVar4 * 3 + 1 ) = (undefined1[16])0x0;
         ...
         LAB_0010a5ef:puVar5[-1] = param_1;
         return;
      }
   }
   uVar8 = 0x16a;
   pcVar6 = "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY";
   LAB_0010a722:_err_print_error("resize", "./core/templates/cowdata.h", uVar8, pcVar6, 0, 0);
   return;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Dictionary::operator[](Variant const&) */undefined8 Dictionary::operator [](Dictionary *this, Variant *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   undefined1 auVar4[16];
   ...
   if (iVar35 == local_78[0]) {
      if (iVar35 == 0x18) {
                  ...
                  if (plVar1 != (long*)0x0) {
                     if (*(long*)( lVar24 + 0x48 ) != 0) {
                        ...
                        if (local_b8 == *(long*)( lVar24 + 0x48 )) {
                           LAB_0010ad53:if (*(long*)( lVar24 + 0x50 ) == 0) {
                           ...
                           if (local_b0 != (Object*)0x0) {
                              ...
                              if (cVar21 == '\0') {
                                 ...
                                 local_88 = (char*)0x0;
                                 String::parse_latin1((String_conflict*)&local_88, "Attempted to %s an object into a %s, that does not inherit from \'%s\'.");
                                 vformat<String,String,String>(&local_a8, (String_conflict*)&local_88, (String_conflict*)&local_90, (String_conflict*)&local_98, local_d8);
                                 _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x92, "Condition \"!other_script->inherits_script(script)\" is true. Returning: false", &local_a8, 0, 0);
                                 for (int i = 0; i < 5; i++) {
                                    CowData<char32_t>::_unref();
                                 }
                           ...
                           String::parse_latin1((String_conflict*)&local_88, "Attempted to %s an object into a %s, that does not inherit from \'%s\'.");
                           vformat<String,String,String>(&local_a8, (String_conflict*)&local_88, (String_conflict*)&local_90, (String_conflict*)&local_98, local_d8);
                           _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x91, "Condition \"other_script.is_null()\" is true. Returning: false", &local_a8, 0, 0);
                           for (int i = 0; i < 5; i++) {
                              CowData<char32_t>::_unref();
                           }
                        } else {
                           pSVar39 = (StringName*)( plVar1[1] + 0x20 );
                           if (( plVar1[1] == 0 ) && ( pSVar39 = (StringName*)plVar1[0x23] ),pSVar39 == (StringName*)0x0) {
                              pSVar39 = (StringName*)( **(code**)( *plVar1 + 0x40 ) )(plVar1);
                           }
                           ...
                           ( **(code**)( *plVar1 + 0x48 ) )(&local_98, plVar1);
                           local_90 = 0;
                           String::parse_latin1((String_conflict*)&local_90, "use `operator[]`");
                           local_88 = (char*)0x0;
                           String::parse_latin1((String_conflict*)&local_88, "Attempted to %s an object of type \'%s\' into a %s, which does not inherit from \'%s\'.");
                           vformat<String,String,char_const*,String>(&local_a8, (String_conflict*)&local_88, (String_conflict*)&local_90, &local_98, uVar26, local_d8);
                           _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x87, "Condition \"!ClassDB::is_parent_class(object->get_class_name(), class_name)\" is true. Returning: false", &local_a8, 0, 0);
                           for (int i = 0; i < 5; i++) {
                              CowData<char32_t>::_unref();
                           }
                        }
         ...
         LAB_0010abbb:lVar24 = *(long*)this;
      }
      LAB_0010a985:piVar27 = *(int**)( lVar24 + 8 );
      if (piVar27 == (int*)0x0) {
         if (( *(long*)( lVar24 + 0x18 ) != 0 ) && ( *(int*)( lVar24 + 0x3c ) != 0 )) {
            ...
            if (uVar23 != 0) {
               ...
               do {
                  if (uVar34 == uVar23) {
                     cVar21 = StringLikeVariantComparator::compare((Variant*)( *(long*)( *(long*)( lVar24 + 0x18 ) + lVar36 * 8 ) + 0x10 ), (Variant*)local_78);
               ...
               } while ( ( uVar23 != 0 ) && ( auVar6._8_8_ = 0 ),auVar6._0_8_ = (ulong)uVar23 * lVar2,auVar13._8_8_ = 0,auVar13._0_8_ = uVar25,auVar7._8_8_ = 0,auVar7._0_8_ = ( ulong )(( uVar37 + iVar35 ) - SUB164(auVar6 * auVar13, 8)) * lVar2,auVar14._8_8_ = 0,auVar14._0_8_ = uVar25,uVar42 <= SUB164(auVar7 * auVar14, 8) );
            }
            lVar24 = *(long*)this;
         }
         iVar35 = *(int*)( lVar24 + 0x60 );
         piVar27 = (int*)HashMap<Variant,Variant,VariantHasher,StringLikeVariantComparator,DefaultTypedAllocator<HashMapElement<Variant,Variant>>>::operator []((HashMap<Variant,Variant,VariantHasher,StringLikeVariantComparator,DefaultTypedAllocator<HashMapElement<Variant,Variant>>>*)( lVar24 + 0x10 ), (Variant*)local_78);
        ...
        *piVar27 = 0x26;
         ...
         switchD_0010a9e8_caseD_5:uVar26 = HashMap<Variant,Variant,VariantHasher,StringLikeVariantComparator,DefaultTypedAllocator<HashMapElement<Variant,Variant>>>::operator []((HashMap<Variant,Variant,VariantHasher,StringLikeVariantComparator,DefaultTypedAllocator<HashMapElement<Variant,Variant>>>*)( *(long*)this + 0x10 ), (Variant*)local_78);
      } else {
         if (( *(long*)( lVar24 + 0x18 ) != 0 ) && ( *(int*)( lVar24 + 0x3c ) != 0 )) {
            uVar37 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( lVar24 + 0x38 ) * 4 );
            lVar2 = *(long*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( lVar24 + 0x38 ) * 8 );
            ...
            if (uVar23 != 0) {
               ...
               do {
                  if ((uint)uVar40 == uVar34) {
                     cVar21 = StringLikeVariantComparator::compare((Variant*)( *(long*)( *(long*)( lVar24 + 0x18 ) + lVar36 * 8 ) + 0x10 ), (Variant*)local_78);
                     if (cVar21 != '\0') {
                        pVVar32 = (Variant*)HashMap<Variant,Variant,VariantHasher,StringLikeVariantComparator,DefaultTypedAllocator<HashMapElement<Variant,Variant>>>::operator []((HashMap<Variant,Variant,VariantHasher,StringLikeVariantComparator,DefaultTypedAllocator<HashMapElement<Variant,Variant>>>*)( *(long*)this + 0x10 ), (Variant*)local_78);
               ...
               } while ( ( uVar23 != 0 ) && ( auVar9._8_8_ = 0 ),auVar9._0_8_ = uVar40 * lVar2,auVar17._8_8_ = 0,auVar17._0_8_ = uVar25,auVar10._8_8_ = 0,auVar10._0_8_ = ( ulong )(( uVar37 + iVar35 ) - SUB164(auVar9 * auVar17, 8)) * lVar2,auVar18._8_8_ = 0,auVar18._0_8_ = uVar25,uVar42 <= SUB164(auVar10 * auVar18, 8) );
            }
            lVar24 = *(long*)this;
        ...
        *piVar27 = 0x26;
         ...
         switchD_0010b050_caseD_5:uVar26 = *(undefined8*)( *(long*)this + 8 );
      }
   } else {
      if (local_78[0] == 0) {
      ...
      local_80 = 0x3f;
      String::parse_latin1((StrRange*)&local_a8);
      vformat<String,String,char_const*,String>(&local_88, (StrRange*)&local_a8, (StrRange*)&local_a0, &local_98, uVar26, &local_90);
      _err_print_error("validate", "./core/variant/container_type_validate.h", 0x67, "Method/function failed. Returning: false", &local_88, 0, 0);
      pcVar3 = local_88;
      if (local_88 != (char*)0x0) {
         LOCK();
      ...
      lVar24 = *(long*)this;
      LAB_0010a929:piVar27 = *(int**)( lVar24 + 0x80 );
      if (piVar27 == (int*)0x0) {
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* Dictionary::get_or_add(Variant const&, Variant const&) */Variant *Dictionary::get_or_add(Variant *param_1, Variant *param_2) {
   long *plVar1;
   int iVar2;
   long lVar3;
   ulong uVar4;
   ...
   if (iVar2 == local_98[0]) {
      if (( iVar2 != 0x18 ) || ( uVar10 = Variant::operator_cast_to_ObjectID((Variant*)local_98) ),uVar10 == 0) goto LAB_0010ce10;
      uVar16 = (uint)uVar10 & 0xffffff;
      if (uVar16 < (uint)ObjectDB::slot_max) {
         while (true) {
         ...
         if (( uVar10 >> 0x18 & 0x7fffffffff ) == ( *puVar11 & 0x7fffffffff )) {
            ...
            if (plVar1 != (long*)0x0) {
               ...
               if (local_d0 == *(Object**)( lVar3 + 0x48 )) {
                  LAB_0010d2da:if (*(long*)( lVar3 + 0x50 ) == 0) {
                  ...
                  if (lVar8 == 0) {
                     LAB_0010da72:cVar5 = Variant::needs_deinit[local_58[0]];
                  } else {
                     ...
                     if (pOVar9 != (Object*)0x0) {
                        ...
                        if (cVar5 != '\0') {
                           ...
                           if (cVar5 == '\0') {
                              ...
                              vformat<String,String,String>(&local_a8, (StrRange*)&local_b0, (StrRange*)&local_b8, (String_conflict*)&local_c0, local_108);
                              _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x92, "Condition \"!other_script->inherits_script(script)\" is true. Returning: false", &local_a8, 0, 0);
                              for (int i = 0; i < 5; i++) {
                                 CowData<char32_t>::_unref();
                              }
                  ...
                  local_a0 = 0x53;
                  String::parse_latin1((StrRange*)&local_b0);
                  vformat<String,String,char_const*,String>(&local_a8, (StrRange*)&local_b0, (StrRange*)&local_b8, &local_c0, uVar13, local_108);
                  _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x87, "Condition \"!ClassDB::is_parent_class(object->get_class_name(), class_name)\" is true. Returning: false", &local_a8, 0, 0);
                  for (int i = 0; i < 5; i++) {
                     CowData<char32_t>::_unref();
                  }
      ...
      local_a0 = 0x4b;
      String::parse_latin1((StrRange*)&local_b0);
      vformat<String,String>(&local_a8, (StrRange*)&local_b0, (StrRange*)&local_b8, (StrRange*)&local_c0);
      _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x7a, "Parameter \"object\" is null.", &local_a8, 0, 0);
      for (int i = 0; i < 4; i++) {
         CowData<char32_t>::_unref();
      }
      LAB_0010cdb0:_err_print_error("get_or_add", "core/variant/dictionary.cpp", 0xb3, "Condition \"!_p->typed_key.validate(key, \"get\")\" is true. Returning: p_default", 0, 0);
      Variant::Variant(param_1, in_RCX);
   ...
   if (local_98[0] == 0) {
      ...
      if (local_98[0] != 4) {
         LAB_0010cc53:Variant::get_type_name(&local_b0);
         uVar13 = *(undefined8*)( lVar3 + 0x58 );
         ...
         vformat<String,String,char_const*,String>(&local_a8, (StrRange*)&local_c8, (StrRange*)&local_c0, &local_b8, uVar13, &local_b0);
   ...
   LAB_0010ce10:pVVar7 = (Variant*)getptr((Dictionary*)param_2, (Variant*)local_98);
   if (pVVar7 == (Variant*)0x0) {
      Variant::Variant((Variant*)local_78, in_RCX);
      lVar3 = *(long*)param_2;
      iVar2 = *(int*)( lVar3 + 0x60 );
      if (iVar2 == 0) {
         LAB_0010d061:pVVar7 = (Variant*)operator[]((Dictionary*)param_2, (Variant*)local_98);
         ...
         *(undefined8*)( param_1 + 0x10 ) = uStack_68;
         ...
         if (iVar2 == local_78[0]) {
            if (( iVar2 != 0x18 ) || ( uVar10 = Variant::operator_cast_to_ObjectID((Variant*)local_78) ),uVar10 == 0) goto LAB_0010d061;
            this(String_conflict * ) & local_a8;
            uVar16 = (uint)uVar10 & 0xffffff;
            if (uVar16 < (uint)ObjectDB::slot_max) {
               while (true) {
                  uVar4 = (ulong)local_a8 >> 8;
               ...
               if (( uVar10 >> 0x18 & 0x7fffffffff ) == ( *puVar11 & 0x7fffffffff )) {
                  ...
                  if (plVar1 != (long*)0x0) {
                     ...
                     if (local_d8 == *(long*)( lVar3 + 0x68 )) {
                        LAB_0010d8a5:if (*(long*)( lVar3 + 0x70 ) == 0) {
                        ...
                        if (local_d0 != (Object*)0x0) {
                           ...
                           if (cVar5 == '\0') {
                              ...
                              local_a8 = (char*)0x0;
                              String::parse_latin1(this, "Attempted to %s an object into a %s, that does not inherit from \'%s\'.");
                              vformat<String,String,String>(&local_c8, this, (String_conflict*)&local_b0, (String_conflict*)&local_b8, local_110);
                              _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x92, "Condition \"!other_script->inherits_script(script)\" is true. Returning: false", &local_c8, 0, 0, this);
                              for (int i = 0; i < 5; i++) {
                                 CowData<char32_t>::_unref();
                              }
                           }
                        ...
                        local_a8 = (char*)0x0;
                        String::parse_latin1(this, "Attempted to %s an object into a %s, that does not inherit from \'%s\'.");
                        uVar13 = vformat<String,String,String>(&local_c8, this, (String_conflict*)&local_b0, (String_conflict*)&local_b8, local_110);
                        uVar15 = 0x91;
                        ...
                        String::parse_latin1((String_conflict*)&local_b0, "add");
                        local_a8 = (char*)0x0;
                        String::parse_latin1(this, "Attempted to %s an object of type \'%s\' into a %s, which does not inherit from \'%s\'.");
                        vformat<String,String,char_const*,String>(&local_c8, this, (String_conflict*)&local_b0, &local_b8, uVar13, local_110);
                        uVar15 = 0x87;
                        pcVar14 = "Condition \"!ClassDB::is_parent_class(object->get_class_name(), class_name)\" is true. Returning: false";
                     }
                     _err_print_error("validate_object", "./core/variant/container_type_validate.h", uVar15, pcVar14, &local_c8, 0, 0, uVar13);
                     for (int i = 0; i < 5; i++) {
                        CowData<char32_t>::_unref();
                     }
                     if (( StringName::configured != '\0' ) && ( local_d8 != 0 )) {
            ...
            String::parse_latin1((String_conflict*)&local_b0, "add");
            local_a8 = (char*)0x0;
            String::parse_latin1(this, "Attempted to %s an invalid (previously freed?) object instance into a \'%s\'.");
            vformat<String,String>(&local_c0, this, (String_conflict*)&local_b0, (String_conflict*)&local_b8);
            _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x7a, "Parameter \"object\" is null.", &local_c0, 0, 0);
            for (int i = 0; i < 4; i++) {
               CowData<char32_t>::_unref();
            }
         } else {
         ...
         LAB_0010d013:_err_print_error("get_or_add", "core/variant/dictionary.cpp", 0xb7, "Condition \"!_p->typed_value.validate(value, \"add\")\" is true. Returning: value", 0, 0);
         *(int*)param_1 = local_78[0];
         *(undefined8*)( param_1 + 8 ) = local_70;
         *(undefined8*)( param_1 + 0x10 ) = uStack_68;
      }
   ...
   return param_1;
}/* Dictionary::merge(Dictionary const&, bool) */void Dictionary::merge(Dictionary *this, Dictionary *param_1, bool param_2) {
   long *plVar1;
   int iVar2;
   undefined8 *puVar3;
   ulong uVar4;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (*(long*)( *(long*)this + 8 ) == 0) {
      for (puVar3 = *(undefined8**)( *(long*)param_1 + 0x28 ); puVar3 != (undefined8*)0x0; puVar3 = (undefined8*)*puVar3) {
         ...
         if (iVar2 != 0) {
                  ...
                  if (( uVar7 >> 0x18 & 0x7fffffffff ) == ( *puVar15 & 0x7fffffffff )) {
                     ...
                     if (plVar1 != (long*)0x0) {
                        ...
                        if (local_d0 == *(long*)( lVar17 + 0x48 )) {
                           LAB_0010f012:if (*(long*)( lVar17 + 0x50 ) == 0) {
                              if (( StringName::configured != '\0' ) && ( local_d0 != 0 )) {
                                 StringName::unref();
                              }
                              LAB_0010ece0:lVar17 = *(long*)this;
                              goto LAB_0010ea29;
                           }
                           ( **(code**)( *plVar1 + 0x98 ) )(local_58, plVar1);
                           lVar8 = Variant::get_validated_object();
                           if (lVar8 == 0) {
                              LAB_0010f081:cVar5 = Variant::needs_deinit[local_58[0]];
                           } else {
                              pOVar9 = (Object*)__dynamic_cast(lVar8, &Object::typeinfo, &Script::typeinfo, 0);
                              if (pOVar9 != (Object*)0x0) {
                                 cVar5 = RefCounted::reference();
                                 if (cVar5 != '\0') {
                                    ...
                                    if (cVar5 == '\0') {
                                       ...
                                       local_a0 = 0x45;
                                       String::parse_latin1((StrRange*)&local_b0);
                                       vformat<String,String,String>(&local_a8, (StrRange*)&local_b0, (StrRange*)&local_b8, (StrRange*)&local_c0, local_f0);
                                       _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x92, "Condition \"!other_script->inherits_script(script)\" is true. Returning: false", &local_a8, 0, 0);
                                       for (int i = 0; i < 5; i++) {
                                          CowData<char32_t>::_unref();
                                       }
                           ...
                           local_a0 = 0x45;
                           String::parse_latin1((StrRange*)&local_b0);
                           vformat<String,String,String>(&local_a8, (StrRange*)&local_b0, (StrRange*)&local_b8, (StrRange*)&local_c0, &local_c8);
                           ...
                           local_a0 = 0x53;
                           String::parse_latin1((StrRange*)&local_b0);
                           vformat<String,String,char_const*,String>(&local_a8, (StrRange*)&local_b0, (StrRange*)&local_b8, &local_c0, uVar13, &local_c8);
                           pcVar12 = "Condition \"!ClassDB::is_parent_class(object->get_class_name(), class_name)\" is true. Returning: false";
                           uVar13 = 0x87;
                        }
                        _err_print_error("validate_object", "./core/variant/container_type_validate.h", uVar13, pcVar12, &local_a8, 0, 0);
                        for (int i = 0; i < 5; i++) {
                           CowData<char32_t>::_unref();
                        }
                        if (( StringName::configured != '\0' ) && ( local_d0 != 0 )) {
            ...
            LAB_0010e9a6:_err_print_error("merge", "core/variant/dictionary.cpp", 0x133, "Condition \"!_p->typed_key.validate(key, \"merge\")\" is true.", 0, 0);
            LAB_0010e9c7:if (Variant::needs_deinit[local_78[0]] != '\0') {
               Variant::_clear_internal();
            }
            if (Variant::needs_deinit[local_98[0]] != '\0') {
               Variant::_clear_internal();
         ...
         LAB_0010ea29:iVar2 = *(int*)( lVar17 + 0x60 );
         if (iVar2 == 0) goto LAB_0010ebe1;
         if (iVar2 == local_78[0]) {
            if (( iVar2 != 0x18 ) || ( uVar7 = Variant::operator_cast_to_ObjectID((Variant*)local_78) ),uVar7 == 0) goto LAB_0010ebe1;
            uVar14 = (uint)uVar7 & 0xffffff;
            if (uVar14 < (uint)ObjectDB::slot_max) {
               while (true) {
                  uVar4 = (ulong)local_a8 >> 8;
               ...
               if (( uVar7 >> 0x18 & 0x7fffffffff ) == ( *puVar15 & 0x7fffffffff )) {
                  ...
                  if (plVar1 != (long*)0x0) {
                     ...
                     if (local_d0 == *(long*)( lVar17 + 0x68 )) {
                        LAB_0010f6f2:if (*(long*)( lVar17 + 0x70 ) == 0) {
                           if (( StringName::configured != '\0' ) && ( local_d0 != 0 )) {
                              StringName::unref();
                           }
                           goto LAB_0010ebe1;
                        ...
                        lVar8 = Variant::get_validated_object();
                        if (lVar8 == 0) {
                           LAB_0010f761:cVar5 = Variant::needs_deinit[local_58[0]];
                        } else {
                           pOVar9 = (Object*)__dynamic_cast(lVar8, &Object::typeinfo, &Script::typeinfo, 0);
                           if (pOVar9 != (Object*)0x0) {
                              cVar5 = RefCounted::reference();
            ...
            LAB_0010ebae:_err_print_error("merge", "core/variant/dictionary.cpp", 0x134, "Condition \"!_p->typed_value.validate(value, \"merge\")\" is true.", 0, 0);
            goto LAB_0010e9c7;
         }
         if (local_78[0] == 0) {
            ...
            if (( iVar2 != 3 ) || ( local_78[0] != 2 )) {
               LAB_0010ea55:Variant::get_type_name(&local_b0);
               uVar13 = *(undefined8*)( lVar17 + 0x78 );
               Variant::get_type_name(&local_b8, local_78[0]);
               local_c0 = 0;
               local_a8 = "merge";
         ...
         LAB_0010ebe1:if (( param_2 ) || ( cVar5 = has(this, (Variant*)local_98) ),cVar5 == '\0') {
      ...
      _err_print_error("merge", "core/variant/dictionary.cpp", 0x12f, "Condition \"_p->read_only\" is true.", "Dictionary is in read-only state.", 0, 0);
   }
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   ...
   return;
}/* Dictionary::recursive_duplicate(bool, int) const */Dictionary *Dictionary::recursive_duplicate(bool param_1, int param_2) {
   long lVar1;
   long lVar2;
   Object *pOVar3;
   Object *pOVar4;
...
}lVar5 = *plVar9;*(undefined8*)( lVar2 + 0x58 ) = *(undefined8*)( lVar1 + 0x58 );lVar1 = *(long*)this_00;*(undefined4*)( lVar1 + 0x60 ) = *(undefined4*)( lVar5 + 0x60 );StringName::operator =((StringName*)( lVar1 + 0x68 ), (StringName*)( lVar5 + 0x68 ));pOVar3 = *(Object**)( lVar5 + 0x70 );pOVar4 = *(Object**)( lVar1 + 0x70 );if (pOVar3 != pOVar4) {
   *(Object**)( lVar1 + 0x70 ) = pOVar3;
   ...
   if (( ( pOVar4 != (Object*)0x0 ) && ( cVar6 = RefCounted::unreference() ),cVar6 != '\0' )) &&( cVar6 = cVar6 != '\0' )(**(code**)( *(long*)pOVar4 + 0x140 ))(pOVar4);
   Memory::free_static(pOVar4, false);
}}*(undefined8*)( lVar1 + 0x78 ) = *(undefined8*)( lVar5 + 0x78 );if (in_ECX < 0x65) {
   puVar8 = *(undefined8**)( *plVar9 + 0x28 );
   if (in_DL == '\0') {
      for (; puVar8 != (undefined8*)0x0; puVar8 = (undefined8*)*puVar8) {
         this(Variant * this_00, (Variant*)( puVar8 + 2 ));
   ...
   _err_print_error("recursive_duplicate", "core/variant/dictionary.cpp", 0x244, "Max recursion reached", 0, 0);
}if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return this_00;
}/* WARNING: Subroutine does not return */__stack_chk_fail();}/* Dictionary::duplicate(bool) const */Dictionary * __thiscall Dictionary::duplicate(Dictionary *this,bool param_1){
   long lVar1;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* Dictionary::merged(Dictionary const&, bool) const */Dictionary *Dictionary::merged(Dictionary *param_1, bool param_2) {
   long lVar1;
   bool in_CL;
   Dictionary *in_RDX;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* Dictionary::Dictionary(std::initializer_list<KeyValue<Variant, Variant> >) */void Dictionary::Dictionary(Dictionary *this, Variant *param_2, long param_3) {
   Variant *pVVar1;
   undefined4 *puVar2;
   Variant *this_00;
   Variant *pVVar3;
   ...
   *puVar2 = 1;
   ...
   return;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Dictionary::operator[](Variant const&) const */undefined8 Dictionary::operator [](Dictionary *this, Variant *param_1) {
   long *plVar1;
   char *pcVar2;
   ulong uVar3;
   undefined8 uVar4;
   ...
   if (iVar20 == local_78[0]) {
      if (iVar20 == 0x18) {
               ...
               if (( uVar9 >> 0x18 & 0x7fffffffff ) == ( *puVar18 & 0x7fffffffff )) {
                  ...
                  if (plVar1 != (long*)0x0) {
                     ...
                     if (local_b0 == *(long*)( lVar7 + 0x48 )) {
                        LAB_00110e06:if (*(long*)( lVar7 + 0x50 ) == 0) {
                           if (( StringName::configured != '\0' ) && ( local_b0 != 0 )) {
                              StringName::unref();
                           }
                           goto LAB_00110b60;
                        ...
                        if (lVar10 == 0) {
                           LAB_001117a0:cVar5 = Variant::needs_deinit[local_58[0]];
                        } else {
                           ...
                           if (pOVar11 != (Object*)0x0) {
                              ...
                              if (cVar5 != '\0') {
                                 ...
                                 if (cVar5 == '\0') {
                                    ...
                                    local_80 = 0x45;
                                    String::parse_latin1((StrRange*)&local_90);
                                    vformat<String,String,String>(&local_88, (StrRange*)&local_90, (StrRange*)&local_98, (String_conflict*)&local_a0, local_e0);
                                    _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x92, "Condition \"!other_script->inherits_script(script)\" is true. Returning: false", &local_88, 0, 0);
                                    for (int i = 0; i < 5; i++) {
                                       CowData<char32_t>::_unref();
                                    }
                        ...
                        local_80 = 0x53;
                        String::parse_latin1((StrRange*)&local_90);
                        vformat<String,String,char_const*,String>(&local_88, (StrRange*)&local_90, (StrRange*)&local_98, &local_a0, uVar8, local_e0);
                        _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x87, "Condition \"!ClassDB::is_parent_class(object->get_class_name(), class_name)\" is true. Returning: false", &local_88, 0, 0);
                        for (int i = 0; i < 5; i++) {
                           CowData<char32_t>::_unref();
                        }
         ...
         LAB_00110c00:lVar7 = *(long*)this;
      }
      LAB_00110b00:uVar8 = HashMap<Variant,Variant,VariantHasher,StringLikeVariantComparator,DefaultTypedAllocator<HashMapElement<Variant,Variant>>>::operator []((HashMap<Variant,Variant,VariantHasher,StringLikeVariantComparator,DefaultTypedAllocator<HashMapElement<Variant,Variant>>>*)( lVar7 + 0x10 ), (Variant*)local_78);
   } else {
      if (local_78[0] == 0) {
      ...
      local_80 = 0x3f;
      String::parse_latin1((StrRange*)&local_a8);
      vformat<String,String,char_const*,String>(&local_88, (StrRange*)&local_a8, (StrRange*)&local_a0, &local_98, uVar8, &local_90);
      _err_print_error("validate", "./core/variant/container_type_validate.h", 0x67, "Method/function failed. Returning: false", &local_88, 0, 0);
      pcVar2 = local_88;
      if (local_88 != (char*)0x0) {
         LOCK();
      ...
      lVar7 = *(long*)this;
      LAB_00110aa3:piVar12 = *(int**)( lVar7 + 0x80 );
      if (piVar12 == (int*)0x0) {
   ...
   return uVar8;
}/* Dictionary::set(Variant const&, Variant const&) */undefined8 Dictionary::set(Dictionary *this, Variant *param_1, Variant *param_2) {
   long *plVar1;
   int iVar2;
   char *pcVar3;
   ulong uVar4;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (*(long*)( *(long*)this + 8 ) != 0) {
      _err_print_error(&_LC93, "core/variant/dictionary.cpp", 0xbf, "Condition \"_p->read_only\" is true. Returning: false", "Dictionary is in read-only state.", 0, 0);
      uVar8 = 0;
      goto LAB_0011234d;
   }
   ...
   if (iVar2 == local_98[0]) {
      if (( iVar2 != 0x18 ) || ( uVar7 = Variant::operator_cast_to_ObjectID((Variant*)local_98) ),uVar7 == 0) goto LAB_001120c8;
         ...
         if (( uVar7 >> 0x18 & 0x7fffffffff ) == ( *puVar13 & 0x7fffffffff )) {
            ...
            if (plVar1 != (long*)0x0) {
               ...
               if (local_d0 == *(long*)( lVar15 + 0x48 )) {
                  LAB_00112513:if (*(long*)( lVar15 + 0x50 ) == 0) {
                     if (( StringName::configured != '\0' ) && ( local_d0 != 0 )) {
                        StringName::unref();
                     }
                     goto LAB_001120c8;
                  ...
                  lVar9 = Variant::get_validated_object();
                  if (lVar9 == 0) {
                     LAB_00112ca4:cVar5 = Variant::needs_deinit[local_58[0]];
                  } else {
                     ...
                     if (pOVar10 != (Object*)0x0) {
                        ...
                        if (cVar5 != '\0') {
                           ...
                           if (cVar5 == '\0') {
                              ...
                              local_a8 = (char*)0x0;
                              String::parse_latin1((String_conflict*)&local_a8, "Attempted to %s an object into a %s, that does not inherit from \'%s\'.");
                              vformat<String,String,String>(&local_c8, (String_conflict*)&local_a8, (String_conflict*)&local_b0, (String_conflict*)&local_b8, local_f8);
                              _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x92, "Condition \"!other_script->inherits_script(script)\" is true. Returning: false", &local_c8, 0, 0);
                              for (int i = 0; i < 5; i++) {
                                 CowData<char32_t>::_unref();
                              }
                           }
                  ...
                  local_a0 = 0x45;
                  String::parse_latin1((StrRange*)&local_b0);
                  vformat<String,String,String>((String_conflict*)&local_a8, (StrRange*)&local_b0, (StrRange*)&local_b8, (String_conflict*)&local_c0, local_100);
                  _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x91, "Condition \"other_script.is_null()\" is true. Returning: false", (String_conflict*)&local_a8, 0, 0);
                  for (int i = 0; i < 5; i++) {
                     CowData<char32_t>::_unref();
                  }
               } else {
                  ...
                  local_a0 = 0x53;
                  String::parse_latin1((StrRange*)&local_b0);
                  vformat<String,String,char_const*,String>((String_conflict*)&local_a8, (StrRange*)&local_b0, (StrRange*)&local_b8, &local_c0, uVar8, local_100);
                  _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x87, "Condition \"!ClassDB::is_parent_class(object->get_class_name(), class_name)\" is true. Returning: false", (String_conflict*)&local_a8, 0, 0);
                  for (int i = 0; i < 5; i++) {
                     CowData<char32_t>::_unref();
                  }
               }
      ...
      local_a0 = 0x4b;
      String::parse_latin1((StrRange*)&local_b0);
      vformat<String,String>((String_conflict*)&local_a8, (StrRange*)&local_b0, (StrRange*)&local_b8, (StrRange*)&local_c0);
      _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x7a, "Parameter \"object\" is null.", (String_conflict*)&local_a8, 0, 0);
      for (int i = 0; i < 4; i++) {
         CowData<char32_t>::_unref();
      }
      LAB_0011208a:_err_print_error(&_LC93, "core/variant/dictionary.cpp", 0xc1, "Condition \"!_p->typed_key.validate(key, \"set\")\" is true. Returning: false", 0, 0);
      uVar8 = 0;
   } else {
      if (local_98[0] == 0) {
         ...
         if (local_98[0] != 4) {
            LAB_00111ed5:Variant::get_type_name(&local_b0);
            uVar8 = *(undefined8*)( lVar15 + 0x58 );
            Variant::get_type_name(&local_b8, local_98[0]);
            local_a8 = "set";
            local_c0 = 0;
            ...
            local_a0 = 0x3f;
            String::parse_latin1((StrRange*)&local_c8);
            vformat<String,String,char_const*,String>(&local_a8, (StrRange*)&local_c8, (StrRange*)&local_c0, &local_b8, uVar8, &local_b0);
            _err_print_error("validate", "./core/variant/container_type_validate.h", 0x67, "Method/function failed. Returning: false", &local_a8, 0, 0);
            pcVar3 = local_a8;
            if (local_a8 != (char*)0x0) {
               LOCK();
      ...
      LAB_001120c8:Variant::Variant((Variant*)local_78, param_2);
      lVar15 = *(long*)this;
      iVar2 = *(int*)( lVar15 + 0x60 );
      if (iVar2 == 0) {
         LAB_00112310:this_00 = (Variant*)HashMap<Variant,Variant,VariantHasher,StringLikeVariantComparator,DefaultTypedAllocator<HashMapElement<Variant,Variant>>>::operator []((HashMap<Variant,Variant,VariantHasher,StringLikeVariantComparator,DefaultTypedAllocator<HashMapElement<Variant,Variant>>>*)( lVar15 + 0x10 ), (Variant*)local_98);
         Variant::operator =(this_00, (Variant*)local_78);
         uVar8 = 1;
      } else {
         if (iVar2 == local_78[0]) {
            ...
            if (uVar12 < (uint)ObjectDB::slot_max) {
               ...
               if (( uVar7 >> 0x18 & 0x7fffffffff ) == ( *puVar13 & 0x7fffffffff )) {
                  ...
                  if (plVar1 != (long*)0x0) {
                     ...
                     pSVar14 = (StringName*)( plVar1[1] + 0x20 );
                     if (( plVar1[1] == 0 ) && ( pSVar14 = (StringName*)plVar1[0x23] ),pSVar14 == (StringName*)0x0) {
                        pSVar14 = (StringName*)( **(code**)( *plVar1 + 0x40 ) )(plVar1);
                     }
                     StringName::StringName((StringName*)&local_d0, pSVar14);
                     if (local_d0 == *(long*)( lVar15 + 0x68 )) {
                        LAB_00112a91:if (*(long*)( lVar15 + 0x70 ) == 0) {
                           if (( StringName::configured != '\0' ) && ( local_d0 != 0 )) {
                              StringName::unref();
                           }
                           goto LAB_00112309;
                        ...
                        lVar9 = Variant::get_validated_object();
                        if (lVar9 == 0) {
                           LAB_00112ec2:cVar5 = Variant::needs_deinit[local_58[0]];
                        } else {
                           pOVar10 = (Object*)__dynamic_cast(lVar9, &Object::typeinfo, &Script::typeinfo);
                           if (pOVar10 != (Object*)0x0) {
                              cVar5 = RefCounted::reference();
                        ...
                        String::parse_latin1((String_conflict*)&local_a8, "Attempted to %s an object into a %s, that does not inherit from \'%s\'.");
                        vformat<String,String,String>(&local_c8, (String_conflict*)&local_a8, (String_conflict*)&local_b0, (String_conflict*)&local_b8, local_f8);
                        _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x91, "Condition \"other_script.is_null()\" is true. Returning: false", &local_c8, 0, 0);
                        for (int i = 0; i < 5; i++) {
                           CowData<char32_t>::_unref();
                        }
                     } else {
         ...
         LAB_001122c7:_err_print_error(&_LC93, "core/variant/dictionary.cpp", 0xc3, "Condition \"!_p->typed_value.validate(value, \"set\")\" is true. Returning: false", 0, 0);
         uVar8 = 0;
      }
      if (Variant::needs_deinit[local_78[0]] != '\0') {
         Variant::_clear_internal();
   ...
   LAB_0011234d:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar8;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* Dictionary::assign(Dictionary const&) */void Dictionary::assign(Dictionary *this, Dictionary *param_1) {
   int *piVar1;
   uint uVar2;
   long lVar3;
   void *pvVar4;
   ...
   lVar28 = *(long*)param_1;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   iVar26 = *(int*)( lVar3 + 0x40 );
   if (( ( ( iVar26 == *(int*)( lVar28 + 0x40 ) ) && ( *(long*)( lVar28 + 0x48 ) == *(long*)( lVar3 + 0x48 ) ) ) && ( *(long*)( lVar3 + 0x50 ) == *(long*)( lVar28 + 0x50 ) ) ) || ( iVar26 == 0 )) {
      LAB_00113d00:iVar26 = *(int*)( lVar3 + 0x60 );
      if (( ( ( *(int*)( lVar28 + 0x60 ) == iVar26 ) && ( ( *(long*)( lVar3 + 0x68 ) == *(long*)( lVar28 + 0x68 ) && ( *(long*)( lVar3 + 0x70 ) == *(long*)( lVar28 + 0x70 ) ) ) ) ) || ( iVar26 == 0 ) ) || ( ( ( *(int*)( lVar28 + 0x60 ) == 0x18 && ( iVar26 == 0x18 ) ) && ( ( *(long*)( lVar3 + 0x68 ) == 0 || ( ( ( *(long*)( lVar28 + 0x68 ) != 0 && ( ( *(long*)( lVar3 + 0x68 ) == *(long*)( lVar28 + 0x68 ) || ( cVar7 = ClassDB::is_parent_class((StringName*)( lVar28 + 0x68 ), (StringName*)( lVar3 + 0x68 )) ),cVar7 != '\0' ) ) ) ) && ( ( *(long**)( lVar3 + 0x70 ) == (long*)0x0 || ( ( plVar24 = *(long**)( lVar28 + 0x70 ) ),plVar24 != (long*)0x0 && ( ( *(long**)( lVar3 + 0x70 ) == plVar24 || ( cVar7 = ( **(code**)( *plVar24 + 0x1e8 ) )(plVar24, lVar3 + 0x70) ),cVar7 != '\0' ) ) ) ) ) ) ) ) ) )) {
         if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            HashMap<Variant,Variant,VariantHasher,StringLikeVariantComparator,DefaultTypedAllocator<HashMapElement<Variant,Variant>>>::operator =((HashMap<Variant,Variant,VariantHasher,StringLikeVariantComparator,DefaultTypedAllocator<HashMapElement<Variant,Variant>>>*)( *(long*)this + 0x10 ), (HashMap*)( *(long*)param_1 + 0x10 ));
            return;
         }
         goto LAB_00114d8a;
      }
      LAB_00113d1e:lVar12 = *(long*)param_1;
   } else {
      lVar12 = lVar28;
      if (( iVar26 == 0x18 ) && ( *(int*)( lVar28 + 0x40 ) == 0x18 )) {
         if (*(long*)( lVar3 + 0x48 ) == 0) goto LAB_00113d00;
         if (*(long*)( lVar28 + 0x48 ) == 0) goto LAB_00113acf;
         if (( ( *(long*)( lVar3 + 0x48 ) == *(long*)( lVar28 + 0x48 ) ) || ( cVar7 = ClassDB::is_parent_class((StringName*)( lVar28 + 0x48 ), (StringName*)( lVar3 + 0x48 )) ),cVar7 != '\0' )) &&( ( *(long**)( lVar3 + 0x50 ) == (long*)0x0 || ( ( plVar24 = *(long**)( lVar28 + 0x50 ) ),plVar24 != (long*)0x0 && ( ( *(long**)( lVar3 + 0x50 ) == plVar24 || ( cVar7 = ( **(code**)( *plVar24 + 0x1e8 ) )(plVar24, lVar3 + 0x50) ),cVar7 != '\0' ) ) ) ) );
         goto LAB_00113d1e;
      }
   }
   LAB_00113acf:uVar2 = *(uint*)( lVar12 + 0x3c );
   local_60 = 0;
   uVar11 = 1;
   ...
   LAB_00113b5e:local_b0[0] = (Variant*)0x0;
   ...
   pVVar21 = local_a0;
   iVar26 = *(int*)( lVar3 + 0x40 );
   iVar9 = *(int*)( lVar28 + 0x40 );
   if (( ( ( iVar26 == iVar9 ) && ( *(long*)( lVar3 + 0x48 ) == *(long*)( lVar28 + 0x48 ) ) ) && ( *(long*)( lVar3 + 0x50 ) == *(long*)( lVar28 + 0x50 ) ) ) || ( iVar26 == 0 )) {
      LAB_00113d98:pVVar20 = pVVar6;
      for (puVar23 = *(undefined8**)( *(long*)param_1 + 0x28 ); puVar23 != (undefined8*)0x0; puVar23 = (undefined8*)*puVar23) {
         Variant::operator =(pVVar20, (Variant*)( puVar23 + 2 ));
         pVVar20 = pVVar20 + 0x18;
      }
      LAB_00113dce:uVar16 = *(uint*)( lVar3 + 0x60 );
      uStack_170 = (ulong)uVar16;
      uVar10 = *(uint*)( lVar28 + 0x60 );
      if (( ( ( uVar16 == uVar10 ) && ( *(long*)( lVar3 + 0x68 ) == *(long*)( lVar28 + 0x68 ) ) ) && ( *(long*)( lVar3 + 0x70 ) == *(long*)( lVar28 + 0x70 ) ) ) || ( uVar16 == 0 )) {
         LAB_00113ee0:for (puVar23 = *(undefined8**)( *(long*)param_1 + 0x28 ); puVar23 != (undefined8*)0x0; puVar23 = (undefined8*)*puVar23) {
         ...
         if (( uVar10 == 0x18 ) && ( uVar16 == 0x18 )) {
            ...
            if (uStack_170 != 0) {
               if (*(ulong*)( lVar28 + 0x68 ) == 0) goto LAB_00114db6;
               if (( ( uStack_170 != *(ulong*)( lVar28 + 0x68 ) ) && ( cVar7 = ClassDB::is_parent_class((StringName*)( lVar28 + 0x68 ), (StringName*)( lVar3 + 0x68 )) ),cVar7 == '\0' )) {
         ...
         LAB_00113df6:if (uVar10 != 0) {
            if (uVar10 == 0x18) {
               if ((int)uStack_170 == 0x18) {
                  uStack_170 = *(ulong*)( lVar28 + 0x68 );
                  if (uStack_170 != 0) {
                     if (*(ulong*)( lVar3 + 0x68 ) == 0) goto LAB_00115584;
                     if (( ( uStack_170 != *(ulong*)( lVar3 + 0x68 ) ) && ( cVar7 = ClassDB::is_parent_class((StringName*)( lVar3 + 0x68 ), (StringName*)( lVar28 + 0x68 )) ),uStack_170 = extraout_RDX_02,cVar7 == '\0' )) {
                        uStack_170 = ( ulong ) * (uint*)( lVar3 + 0x60 );
                        goto LAB_00115299;
                     }
                  }
               ...
               LAB_00115299:if ((int)uStack_170 == 0x18) {
                  LAB_00115584:uStack_170 = 0x18;
               } else if (*(int*)( lVar28 + 0x60 ) != 0x18) {
                  if (*(int*)( lVar28 + 0x60 ) == 0) goto LAB_00113e07;
                  ...
                  if (cVar7 == '\0') {
                     ...
                     Variant::get_type_name(&local_e0, *(undefined4*)( lVar28 + 0x60 ));
                     Variant::get_type_name(&local_e8, *(undefined4*)( lVar28 + 0x40 ));
                     local_98 = "Cannot assign contents of \"Dictionary[%s, %s]\" to \"Dictionary[%s, %s].";
                     local_c8 = 0;
                     uStack_c4 = 0;
                     local_90 = 0x46;
                     String::parse_latin1((StrRange*)&local_c8);
                     vformat<String,String,String,String>(&local_98, (StrRange*)&local_c8, &local_e8, &local_e0, &local_d8, &local_d0);
                     uVar19 = 0x20d;
                     goto LAB_001142b7;
                  }
                  plVar24 = *(long**)( *(long*)param_1 + 0x28 );
                  if (plVar24 != (long*)0x0) {
                     iVar26 = 0;
                     do {
                        local_e8 = (Variant*)( plVar24 + 5 );
                        iVar26 = iVar26 + 1;
                        local_c8 = 0;
                        uStack_c4 = 0;
                        uStack_c0 = 0;
                        ...
                        if (local_c8 != 0) {
                           ...
                           Variant::Variant((Variant*)local_58, pVVar6 + (long)iVar26 * 0x18 + -0x18);
                           local_98 = "Unable to convert value at key \"%s\" from \"%s\" to \"%s\".";
                           local_d0 = 0;
                           local_90 = 0x36;
                           String::parse_latin1((StrRange*)&local_d0);
                           vformat<Variant,String,String>(&local_98, (StrRange*)&local_d0, (Variant*)local_58, &local_e0, &local_d8);
                           uVar19 = 0x20a;
                           goto LAB_00115420;
                        }
            ...
            vformat<String,String,String,String>(&local_98, (StrRange*)&local_c8, &local_e8, &local_e0, &local_d8, &local_d0);
            uVar19 = 0x1f1;
            LAB_001142b7:_err_print_error("assign", "core/variant/dictionary.cpp", uVar19, "Method/function failed.", &local_98, 0, 0);
            CowData<char32_t>::_unref();
            CowData<char32_t>::_unref();
            LAB_001142dd:CowData<char32_t>::_unref();
            for (int i = 0; i < 3; i++) {
               CowData<char32_t>::_unref();
            }
         ...
         if ((int)uStack_170 == 0x18) {
            LAB_00114db6:iVar26 = 0;
            for (puVar23 = *(undefined8**)( *(long*)param_1 + 0x28 ); puVar23 != (undefined8*)0x0; puVar23 = (undefined8*)*puVar23) {
               if (*(int*)( puVar23 + 5 ) == 0) goto LAB_00115190;
               if (*(int*)( puVar23 + 5 ) != 0x18) {
                  LAB_0011501c:local_128 = (Variant*)local_58;
                  Variant::get_type_name(&local_d0, *(undefined4*)( lVar3 + 0x60 ), uStack_170);
                  Variant::get_type_name(&local_d8, *(undefined4*)( puVar23 + 5 ));
                  Variant::Variant(local_128, pVVar6 + (long)iVar26 * 0x18);
                  local_98 = "Unable to convert value at key \"%s\" from \"%s\" to \"%s\".";
                  local_c8 = 0;
                  uStack_c4 = 0;
                  local_90 = 0x36;
                  String::parse_latin1((StrRange*)&local_c8);
                  vformat<Variant,String,String>(&local_98, (StrRange*)&local_c8, local_128, &local_d8, &local_d0);
                  _err_print_error("assign", "core/variant/dictionary.cpp", 0x1ec, "Method/function failed.", &local_98, 0, 0);
                  CowData<char32_t>::_unref();
                  CowData<char32_t>::_unref();
                  if (Variant::needs_deinit[local_58[0]] != '\0') {
                     Variant::_clear_internal();
               ...
               if ((uint)ObjectDB::slot_max <= uVar16) {
                  _err_print_error("get_instance", "./core/object/object.h", 0x418, "Condition \"slot >= slot_max\" is true. Returning: nullptr", 0, 0);
                  LAB_00115b06:pcVar17 = *(char**)( lVar3 + 0x78 );
                  sVar15 = 0;
                  local_c8 = 0;
                  uStack_c4 = 0;
                  if (pcVar17 != (char*)0x0) {
                  ...
                  local_90 = 6;
                  String::parse_latin1((StrRange*)&local_d0);
                  local_98 = "Attempted to %s an invalid (previously freed?) object instance into a \'%s\'.";
                  local_d8 = 0;
                  local_90 = 0x4b;
                  String::parse_latin1((StrRange*)&local_d8);
                  vformat<String,String>(&local_98, (StrRange*)&local_d8, (StrRange*)&local_d0, (StrRange*)&local_c8);
                  _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x7a, "Parameter \"object\" is null.", &local_98, 0, 0);
                  for (int i = 0; i < 4; i++) {
                     CowData<char32_t>::_unref();
                  }
               ...
               ObjectDB::spin_lock._0_1_ = '\0';
               if (plVar24 == (long*)0x0) goto LAB_00115b06;
               if (*(long*)( lVar3 + 0x68 ) == 0) goto LAB_00115190;
               if (plVar24[1] == 0) {
                  pSVar25 = (StringName*)plVar24[0x23];
                  if (pSVar25 == (StringName*)0x0) {
                     pSVar25 = (StringName*)( **(code**)( *plVar24 + 0x40 ) )(plVar24);
                  }
               } else {
                  pSVar25 = (StringName*)( plVar24[1] + 0x20 );
               }
               StringName::StringName((StringName*)&local_e8, pSVar25);
               if (local_e8 != *(Variant**)( lVar3 + 0x68 )) {
                  ...
                  cVar7 = ClassDB::is_parent_class(pSVar25, (StringName*)( lVar3 + 0x68 ));
                  if (cVar7 != '\0') goto LAB_00114efe;
                  lVar28 = *(long*)( lVar3 + 0x68 );
                  if (lVar28 == 0) {
                     local_c8 = 0;
                     uStack_c4 = 0;
                  } else {
                     pcVar17 = *(char**)( lVar28 + 8 );
                     local_c8 = 0;
                     uStack_c4 = 0;
                     if (pcVar17 == (char*)0x0) {
                        if (*(long*)( lVar28 + 0x10 ) != 0) {
                           CowData<char32_t>::_ref((CowData<char32_t>*)&local_c8, (CowData*)( lVar28 + 0x10 ));
                        }
                     } else {
                  ...
                  ( **(code**)( *plVar24 + 0x48 ) )(&local_d0, plVar24);
                  local_98 = "assign";
                  local_d8 = 0;
                  local_90 = 6;
                  String::parse_latin1((StrRange*)&local_d8);
                  local_e0 = 0;
                  local_98 = "Attempted to %s an object of type \'%s\' into a %s, which does not inherit from \'%s\'.";
                  local_90 = 0x53;
                  String::parse_latin1((StrRange*)&local_e0);
                  uStack_170 = 0x1162ce;
                  vformat<String,String,char_const*,String>(&local_98, (StrRange*)&local_e0, (StrRange*)&local_d8, &local_d0, uVar19, &local_c8);
                  _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x87, "Condition \"!ClassDB::is_parent_class(object->get_class_name(), class_name)\" is true. Returning: false", &local_98, 0, 0);
                  for (int i = 0; i < 5; i++) {
                     CowData<char32_t>::_unref();
                  }
                  joined_r0x00116345:if (( StringName::configured != '\0' ) && ( local_e8 != (Variant*)0x0 )) {
                     StringName::unref();
                     uStack_170 = extraout_RDX_05;
                  }
                  goto LAB_0011501c;
               }
               LAB_00114efe:if (*(long*)( lVar3 + 0x70 ) != 0) {
                  ( **(code**)( *plVar24 + 0x98 ) )(local_58, plVar24);
                  lVar28 = Variant::get_validated_object();
                  if (lVar28 == 0) {
                     LAB_00115108:cVar7 = Variant::needs_deinit[local_58[0]];
                  } else {
                     pOVar13 = (Object*)__dynamic_cast(lVar28, &Object::typeinfo, &Script::typeinfo, 0);
                     if (pOVar13 != (Object*)0x0) {
                        ...
                        if (cVar7 != '\0') {
                           ...
                           if (cVar7 == '\0') {
                              plVar24 = *(long**)( lVar3 + 0x70 );
                              if (plVar24[1] == 0) {
                                 plVar14 = (long*)plVar24[0x23];
                                 if (plVar14 == (long*)0x0) {
                                    plVar14 = (long*)( **(code**)( *plVar24 + 0x40 ) )();
                                 }
                              } else {
                                 plVar14 = (long*)( plVar24[1] + 0x20 );
                              }
                              lVar28 = *plVar14;
                              if (lVar28 == 0) {
                                 local_c8 = 0;
                                 ...
                                 if (*(char**)( lVar28 + 8 ) == (char*)0x0) {
                                    ...
                                    String::parse_latin1((String_conflict*)&local_c8, *(char**)( lVar28 + 8 ));
                                 }
                              }
                              local_110 = &local_c8;
                              ...
                              local_90 = 0x45;
                              String::parse_latin1((StrRange*)&local_e0);
                              vformat<String,String,String>(&local_98, (StrRange*)&local_e0, (StrRange*)&local_d8, (StrRange*)&local_d0, local_110);
                              _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x92, "Condition \"!other_script->inherits_script(script)\" is true. Returning: false", &local_98, 0, 0);
                              for (int i = 0; i < 5; i++) {
                                 CowData<char32_t>::_unref();
                              }
                           }
                           ...
                           if (( cVar8 != '\0' ) && ( cVar8 = predelete_handler(pOVar13) ),uStack_170 = extraout_RDX_07,cVar8 != '\0') {
                  ...
                  local_90 = 0x45;
                  String::parse_latin1((StrRange*)&local_e0);
                  vformat<String,String,String>(&local_98, (StrRange*)&local_e0, (StrRange*)&local_d8, (StrRange*)&local_d0, &local_c8);
                  _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x91, "Condition \"other_script.is_null()\" is true. Returning: false", &local_98, 0, 0);
                  for (int i = 0; i < 5; i++) {
                     CowData<char32_t>::_unref();
                  }
               ...
               LAB_00115190:iVar26 = iVar26 + 1;
               Variant::operator =(pVVar21, (Variant*)( puVar23 + 5 ));
               uStack_170 = extraout_RDX_01;
               pVVar21 = pVVar21 + 0x18;
            }
         } else {
            LAB_00113e07:plVar24 = *(long**)( *(long*)param_1 + 0x28 );
            if (plVar24 != (long*)0x0) {
               lVar28 = 0;
               iVar26 = 1;
               LAB_00113ea3:local_e8 = (Variant*)( plVar24 + 5 );
               if ((int)uStack_170 != (int)plVar24[5]) {
                  cVar7 = Variant::can_convert_strict();
                  if (cVar7 == '\0') {
                     Variant::get_type_name(&local_d0, *(undefined4*)( lVar3 + 0x60 ));
                     Variant::get_type_name(&local_d8, *(undefined4*)local_e8);
                     Variant::Variant((Variant*)local_58, pVVar6 + lVar28);
                     local_98 = "Unable to convert value at key \"%s\" from \"%s\" to \"%s\".";
                     local_c8 = 0;
                     uStack_c4 = 0;
                     local_90 = 0x36;
                     String::parse_latin1((StrRange*)&local_c8);
                     vformat<Variant,String,String>(&local_98, (StrRange*)&local_c8, (Variant*)local_58, &local_d8, &local_d0);
                     _err_print_error("assign", "core/variant/dictionary.cpp", 0x1fd, "Method/function failed.", &local_98, 0, 0);
                     CowData<char32_t>::_unref();
                     CowData<char32_t>::_unref();
                     if (Variant::needs_deinit[local_58[0]] != '\0') {
                        Variant::_clear_internal();
                     ...
                     vformat<Variant,String,String>(&local_98, (StrRange*)&local_d0, (Variant*)local_58, &local_e0, &local_d8);
                     uVar19 = 0x201;
                     LAB_00115420:_err_print_error("assign", "core/variant/dictionary.cpp", uVar19, "Condition \"ce.error\" is true.", &local_98, 0, 0);
                     CowData<char32_t>::_unref();
                     CowData<char32_t>::_unref();
                     if (Variant::needs_deinit[local_58[0]] != '\0') {
                        Variant::_clear_internal();
                  ...
                  LAB_00114cb8:puVar23 = (undefined8*)local_80._0_8_;
                  goto LAB_00114cc0;
               }
               Variant::operator =(pVVar21, local_e8);
               LAB_00113e87:plVar24 = (long*)*plVar24;
               iVar26 = iVar26 + 1;
               pVVar21 = pVVar21 + 0x18;
               lVar28 = lVar28 + 0x18;
               if (plVar24 != (long*)0x0) goto code_r0x00113e9f;
            }
         }
      }
      LAB_00113f13:if (0 < (int)uVar2) {
         pVVar21 = pVVar6;
         do {
            pVVar20 = pVVar21 + 0x18;
            HashMap<Variant,Variant,VariantHasher,StringLikeVariantComparator,DefaultTypedAllocator<HashMapElement<Variant,Variant>>>::insert((Variant*)&local_98, local_88, SUB81(pVVar21, 0));
            pVVar21 = pVVar20;
         } while ( pVVar20 != pVVar6 + ( ulong )(uVar2 - 1) * 0x18 + 0x18 );
      }
      HashMap<Variant,Variant,VariantHasher,StringLikeVariantComparator,DefaultTypedAllocator<HashMapElement<Variant,Variant>>>::operator =((HashMap<Variant,Variant,VariantHasher,StringLikeVariantComparator,DefaultTypedAllocator<HashMapElement<Variant,Variant>>>*)( *(long*)this + 0x10 ), (HashMap*)local_88);
      ...
      if ((undefined8*)local_80._0_8_ != (undefined8*)0x0) {
         ...
         if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            LAB_00114056:Memory::free_static(piVar29, false);
            return;
         }
         goto LAB_00114d8a;
      }
   } else {
      if (( iVar9 == 0x18 ) && ( iVar26 == 0x18 )) {
         if (*(long*)( lVar3 + 0x48 ) != 0) {
            if (*(long*)( lVar28 + 0x48 ) == 0) goto LAB_001143cc;
            if (( ( *(long*)( lVar28 + 0x48 ) != *(long*)( lVar3 + 0x48 ) ) && ( cVar7 = ClassDB::is_parent_class((StringName*)( lVar28 + 0x48 ), (StringName*)( lVar3 + 0x48 )) ),cVar7 == '\0' )) {
               iVar9 = *(int*)( lVar28 + 0x40 );
               iVar26 = *(int*)( lVar3 + 0x40 );
               goto LAB_00113c12;
            }
      ...
      LAB_00113c12:if (iVar9 == 0) {
         if (iVar26 == 0x18) {
            LAB_001143cc:pVVar20 = pVVar6;
            for (puVar23 = *(undefined8**)( *(long*)param_1 + 0x28 ); puVar23 != (undefined8*)0x0; puVar23 = (undefined8*)*puVar23) {
               if (*(int*)( puVar23 + 2 ) == 0) goto LAB_001145a0;
               if (*(int*)( puVar23 + 2 ) != 0x18) {
                  LAB_0011484a:Variant::get_type_name(&local_d0, *(undefined4*)( lVar3 + 0x40 ));
                  Variant::get_type_name(&local_d8, *(undefined4*)( puVar23 + 2 ));
                  local_98 = "Unable to convert key from \"%s\" to \"%s\".";
                  local_c8 = 0;
                  uStack_c4 = 0;
                  local_90 = 0x28;
                  String::parse_latin1((StrRange*)&local_c8);
                  vformat<String,String>(&local_98, (StrRange*)&local_c8, &local_d8, &local_d0);
                  _err_print_error("assign", "core/variant/dictionary.cpp", 0x1b7, "Method/function failed.", &local_98, 0, 0);
                  for (int i = 0; i < 4; i++) {
                     CowData<char32_t>::_unref();
                  }
                  puVar23 = (undefined8*)local_80._0_8_;
               ...
               if ((uint)ObjectDB::slot_max <= uVar16) {
                  _err_print_error("get_instance", "./core/object/object.h", 0x418, "Condition \"slot >= slot_max\" is true. Returning: nullptr", 0, 0);
                  LAB_00115928:pcVar17 = *(char**)( lVar3 + 0x58 );
                  sVar15 = 0;
                  local_c8 = 0;
                  uStack_c4 = 0;
                  if (pcVar17 != (char*)0x0) {
               ...
               plVar24 = (long*)puVar18[1];
               ObjectDB::spin_lock._0_1_ = '\0';
               if (plVar24 == (long*)0x0) goto LAB_00115928;
               ...
               if (local_e8 != *(Variant**)( lVar3 + 0x48 )) {
                  ...
                  cVar7 = ClassDB::is_parent_class(pSVar25, (StringName*)( lVar3 + 0x48 ));
                  if (cVar7 != '\0') goto LAB_001144ac;
                  lVar28 = *(long*)( lVar3 + 0x48 );
                  if (lVar28 == 0) {
                     local_c8 = 0;
                     uStack_c4 = 0;
                  } else {
                  ...
                  String::parse_latin1((StrRange*)&local_e0);
                  vformat<String,String,char_const*,String>(&local_98, (StrRange*)&local_e0, (StrRange*)&local_d8, &local_d0, uVar19, &local_c8);
                  pcVar17 = "Condition \"!ClassDB::is_parent_class(object->get_class_name(), class_name)\" is true. Returning: false";
                  uVar19 = 0x87;
                  LAB_001147ed:_err_print_error("validate_object", "./core/variant/container_type_validate.h", uVar19, pcVar17, &local_98, 0, 0);
                  for (int i = 0; i < 5; i++) {
                     CowData<char32_t>::_unref();
                  }
                  if (( StringName::configured != '\0' ) && ( local_e8 != (Variant*)0x0 )) {
               ...
               LAB_001144ac:if (*(long*)( lVar3 + 0x50 ) != 0) {
                  ( **(code**)( *plVar24 + 0x98 ) )(local_58, plVar24);
                  lVar12 = Variant::get_validated_object();
                  if (lVar12 == 0) {
                     LAB_0011467b:cVar7 = Variant::needs_deinit[local_58[0]];
                  } else {
                     ...
                     if (pOVar13 != (Object*)0x0) {
                        ...
                        if (cVar7 != '\0') {
                           ...
                           if (cVar7 == '\0') {
                              ...
                              local_90 = 0x45;
                              String::parse_latin1((StrRange*)&local_e0);
                              vformat<String,String,String>(&local_98, (StrRange*)&local_e0, (StrRange*)&local_d8, (StrRange*)&local_d0, local_128);
                              _err_print_error("validate_object", "./core/variant/container_type_validate.h", 0x92, "Condition \"!other_script->inherits_script(script)\" is true. Returning: false", &local_98, 0, 0);
                              for (int i = 0; i < 5; i++) {
                                 CowData<char32_t>::_unref();
                              }
               ...
               LAB_001145a0:Variant::operator =(pVVar20, (Variant*)( puVar23 + 2 ));
               pVVar20 = pVVar20 + 0x18;
            }
         } else {
            LAB_00113c23:plVar24 = *(long**)( *(long*)param_1 + 0x28 );
            if (plVar24 != (long*)0x0) {
               pVVar20 = pVVar6;
               do {
                  local_e8 = (Variant*)( plVar24 + 2 );
                  if (iVar26 != (int)plVar24[2]) {
                     cVar7 = Variant::can_convert_strict();
                     if (cVar7 == '\0') {
                        Variant::get_type_name(&local_d0, *(undefined4*)( lVar3 + 0x40 ));
                        Variant::get_type_name(&local_d8, *(undefined4*)local_e8);
                        local_98 = "Unable to convert key from \"%s\" to \"%s\".";
                        local_c8 = 0;
                        uStack_c4 = 0;
                        ...
                        local_90 = 0x28;
                        String::parse_latin1((StrRange*)&local_d0);
                        vformat<String,String>(&local_98, (StrRange*)&local_d0, &local_e0, &local_d8);
                        pcVar17 = "Condition \"ce.error\" is true.";
                        uVar19 = 0x1cc;
                     }
                     _err_print_error("assign", "core/variant/dictionary.cpp", uVar19, pcVar17, &local_98, 0, 0);
                     for (int i = 0; i < 4; i++) {
                        CowData<char32_t>::_unref();
                     }
                     goto LAB_00114cb8;
                  ...
                  LAB_00113ca1:plVar24 = (long*)*plVar24;
                  pVVar20 = pVVar20 + 0x18;
      ...
      if (iVar9 != 0x18) {
         LAB_00114a3c:if (iVar26 == 0x18) {
            LAB_00115a8b:puVar23 = (undefined8*)0x0;
            goto LAB_001140b8;
         }
         if (*(int*)( lVar28 + 0x40 ) == 0x18) goto LAB_001140b0;
         if (*(int*)( lVar28 + 0x40 ) == 0) goto LAB_00113c23;
         cVar7 = Variant::can_convert_strict();
         if (cVar7 != '\0') {
            plVar24 = *(long**)( *(long*)param_1 + 0x28 );
            if (plVar24 != (long*)0x0) {
               ...
               do {
                  ...
                  if (local_c8 != 0) {
                     ...
                     String::parse_latin1((StrRange*)&local_d0);
                     vformat<String,String>(&local_98, (StrRange*)&local_d0, &local_e0, &local_d8);
                     _err_print_error("assign", "core/variant/dictionary.cpp", 0x1d5, "Condition \"ce.error\" is true.", &local_98, 0, 0);
                     goto LAB_001142dd;
                  }
                  plVar24 = (long*)*plVar24;
                  pVVar20 = pVVar20 + 0x18;
      ...
      if (iVar26 == 0x18) {
         if (*(long*)( lVar28 + 0x48 ) != 0) {
            ...
            if (( ( *(long*)( lVar28 + 0x48 ) != *(long*)( lVar3 + 0x48 ) ) && ( cVar7 = ClassDB::is_parent_class((StringName*)( lVar3 + 0x48 ), (StringName*)( lVar28 + 0x48 )) ),cVar7 == '\0' )) {
               iVar26 = *(int*)( lVar3 + 0x40 );
               goto LAB_00114a3c;
            }
         }
      ...
      LAB_001140b0:puVar23 = (undefined8*)local_80._0_8_;
      LAB_001140b8:Variant::get_type_name(&local_d0, *(undefined4*)( lVar3 + 0x60 ));
      Variant::get_type_name(&local_d8, *(undefined4*)( lVar3 + 0x40 ));
      Variant::get_type_name(&local_e0, *(undefined4*)( lVar28 + 0x60 ));
      Variant::get_type_name(&local_e8, *(undefined4*)( lVar28 + 0x40 ));
      local_98 = "Cannot assign contents of \"Dictionary[%s, %s]\" to \"Dictionary[%s, %s]\".";
      ...
      String::parse_latin1((StrRange*)&local_c8);
      vformat<String,String,String,String>(&local_98, (StrRange*)&local_c8, &local_e8, &local_e0, &local_d8, &local_d0);
      _err_print_error("assign", "core/variant/dictionary.cpp", 0x1bc, "Method/function failed.", &local_98, 0, 0);
      for (int i = 0; i < 6; i++) {
         CowData<char32_t>::_unref();
      }
      LAB_00114cc0:CowData<Variant>::_unref((CowData<Variant>*)&local_a0);
      CowData<Variant>::_unref((CowData<Variant>*)local_b0);
   ...
   LAB_00114d8a:/* WARNING: Subroutine does not return */__stack_chk_fail();
   code_r0x00113e9f:uStack_170 = ( ulong ) * (uint*)( lVar3 + 0x60 );
   goto LAB_00113ea3;
}/* Dictionary::Dictionary(Dictionary const&, unsigned int, StringName const&, Variant const&,
   unsigned int, StringName const&, Variant const&) */void Dictionary::Dictionary(Dictionary *this, Dictionary *param_1, uint param_2, StringName *param_3, Variant *param_4, uint param_5, StringName *param_6, Variant *param_7) {
   undefined4 *puVar1;
   puVar1 = (undefined4*)operator_new(0x88, "");
   *puVar1 = 0;
   *(char**)( puVar1 + 0x16 ) = "container";
   ...
   *(undefined4**)this = puVar1;
   *puVar1 = 1;
   set_typed((uint)this, (StringName*)(ulong)param_2, (Variant*)param_3, (uint)param_4, (StringName*)(ulong)param_5, (Variant*)param_6);
   assign(this, param_1);
   return;
...
PagedAllocator<Variant::Pools::BucketLarge,true,4096u>::alloc<>
   ...
   *(uint*)( this + 0x14 ) = uVar7;
   ...
   return pBVar4;
}/* WARNING: Removing unreachable block (ram,0x00118350) *//* WARNING: Removing unreachable block (ram,0x00118480) *//* WARNING: Removing unreachable block (ram,0x001185f8) *//* WARNING: Removing unreachable block (ram,0x0011848c) *//* WARNING: Removing unreachable block (ram,0x00118496) *//* WARNING: Removing unreachable block (ram,0x001185da) *//* WARNING: Removing unreachable block (ram,0x001184a2) *//* WARNING: Removing unreachable block (ram,0x001184ac) *//* WARNING: Removing unreachable block (ram,0x001185bc) *//* WARNING: Removing unreachable block (ram,0x001184b8) *//* WARNING: Removing unreachable block (ram,0x001184c2) *//* WARNING: Removing unreachable block (ram,0x0011859e) *//* WARNING: Removing unreachable block (ram,0x001184ce) *//* WARNING: Removing unreachable block (ram,0x001184d8) *//* WARNING: Removing unreachable block (ram,0x00118580) *//* WARNING: Removing unreachable block (ram,0x001184e4) *//* WARNING: Removing unreachable block (ram,0x001184ee) *//* WARNING: Removing unreachable block (ram,0x00118562) *//* WARNING: Removing unreachable block (ram,0x001184f6) *//* WARNING: Removing unreachable block (ram,0x00118500) *//* WARNING: Removing unreachable block (ram,0x00118547) *//* WARNING: Removing unreachable block (ram,0x00118508) *//* WARNING: Removing unreachable block (ram,0x0011851d) *//* WARNING: Removing unreachable block (ram,0x00118529) *//* String vformat<String, String, char const*, String>(String const&, String const, String const,
   ...
   *param_1 = local_100[0];
   ...
   return param_1;
}/* WARNING: Removing unreachable block (ram,0x00118770) *//* WARNING: Removing unreachable block (ram,0x001188a0) *//* WARNING: Removing unreachable block (ram,0x00118a19) *//* WARNING: Removing unreachable block (ram,0x001188ac) *//* WARNING: Removing unreachable block (ram,0x001188b6) *//* WARNING: Removing unreachable block (ram,0x001189fb) *//* WARNING: Removing unreachable block (ram,0x001188c2) *//* WARNING: Removing unreachable block (ram,0x001188cc) *//* WARNING: Removing unreachable block (ram,0x001189dd) *//* WARNING: Removing unreachable block (ram,0x001188d8) *//* WARNING: Removing unreachable block (ram,0x001188e2) *//* WARNING: Removing unreachable block (ram,0x001189bf) *//* WARNING: Removing unreachable block (ram,0x001188ee) *//* WARNING: Removing unreachable block (ram,0x001188f8) *//* WARNING: Removing unreachable block (ram,0x001189a1) *//* WARNING: Removing unreachable block (ram,0x00118904) *//* WARNING: Removing unreachable block (ram,0x0011890e) *//* WARNING: Removing unreachable block (ram,0x00118983) *//* WARNING: Removing unreachable block (ram,0x00118916) *//* WARNING: Removing unreachable block (ram,0x00118920) *//* WARNING: Removing unreachable block (ram,0x00118968) *//* WARNING: Removing unreachable block (ram,0x00118928) *//* WARNING: Removing unreachable block (ram,0x0011893e) *//* WARNING: Removing unreachable block (ram,0x0011894a) *//* String vformat<String, String>(String const&, String const, String const) */undefined8 *vformat<String,String>(undefined8 *param_1, bool *param_2, String_conflict *param_3, String_conflict *param_4) {
   Variant *pVVar1;
   Variant *pVVar2;
   int iVar3;
   long in_FS_OFFSET;
   ...
   *param_1 = local_d0[0];
   ...
   return param_1;
}/* WARNING: Removing unreachable block (ram,0x00118b98) *//* WARNING: Removing unreachable block (ram,0x00118cc8) *//* WARNING: Removing unreachable block (ram,0x00118e40) *//* WARNING: Removing unreachable block (ram,0x00118cd4) *//* WARNING: Removing unreachable block (ram,0x00118cde) *//* WARNING: Removing unreachable block (ram,0x00118e22) *//* WARNING: Removing unreachable block (ram,0x00118cea) *//* WARNING: Removing unreachable block (ram,0x00118cf4) *//* WARNING: Removing unreachable block (ram,0x00118e04) *//* WARNING: Removing unreachable block (ram,0x00118d00) *//* WARNING: Removing unreachable block (ram,0x00118d0a) *//* WARNING: Removing unreachable block (ram,0x00118de6) *//* WARNING: Removing unreachable block (ram,0x00118d16) *//* WARNING: Removing unreachable block (ram,0x00118d20) *//* WARNING: Removing unreachable block (ram,0x00118dc8) *//* WARNING: Removing unreachable block (ram,0x00118d2c) *//* WARNING: Removing unreachable block (ram,0x00118d36) *//* WARNING: Removing unreachable block (ram,0x00118daa) *//* WARNING: Removing unreachable block (ram,0x00118d3e) *//* WARNING: Removing unreachable block (ram,0x00118d48) *//* WARNING: Removing unreachable block (ram,0x00118d8f) *//* WARNING: Removing unreachable block (ram,0x00118d50) *//* WARNING: Removing unreachable block (ram,0x00118d65) *//* WARNING: Removing unreachable block (ram,0x00118d71) *//* String vformat<String, String, String>(String const&, String const, String const, String const)
   ...
   *param_1 = local_f0[0];
   ...
   DefaultTypedAllocator<HashMapElement<Variant, Variant> > >::erase(Variant const&) */char HashMap<Variant,Variant,VariantHasher,StringLikeVariantComparator,DefaultTypedAllocator<HashMapElement<Variant,Variant>>>::erase(HashMap<Variant,Variant,VariantHasher,StringLikeVariantComparator,DefaultTypedAllocator<HashMapElement<Variant,Variant>>> *this, Variant *param_1) {
   uint *puVar1;
   undefined8 *puVar2;
   undefined8 *puVar3;
   long *plVar4;
   ...
   if (*(int*)( this + 0x2c ) != 0) {
      ...
      if (uVar29 != 0) {
         ...
         do {
            if (uVar30 == uVar29) {
               cVar28 = StringLikeVariantComparator::compare((Variant*)( *(long*)( *(long*)( this + 8 ) + lVar32 * 8 ) + 0x10 ), param_1);
               if (cVar28 != '\0') {
                  ...
                  uVar30 = *puVar37;
                  if (( uVar30 == 0 ) || ( auVar13._8_8_ = 0 ),auVar13._0_8_ = (ulong)uVar30 * lVar32,auVar23._8_8_ = 0,auVar23._0_8_ = uVar35,auVar14._8_8_ = 0,auVar14._0_8_ = ( ulong )(( uVar5 + uVar29 ) - SUB164(auVar13 * auVar23, 8)) * lVar32,auVar24._8_8_ = 0,auVar24._0_8_ = uVar35,uVar38 = uVar31,SUB164(auVar14 * auVar24, 8) == 0) goto LAB_00119089;
                  goto LAB_0011903d;
               }
               lVar36 = *(long*)( this + 0x10 );
            }
         ...
         } while ( ( uVar29 != 0 ) && ( auVar10._8_8_ = 0 ),auVar10._0_8_ = (ulong)uVar29 * lVar6,auVar20._8_8_ = 0,auVar20._0_8_ = uVar35,auVar11._8_8_ = 0,auVar11._0_8_ = ( ulong )(( uVar5 + uVar31 ) - SUB164(auVar10 * auVar20, 8)) * lVar6,auVar21._8_8_ = 0,auVar21._0_8_ = uVar35,uVar38 <= SUB164(auVar11 * auVar21, 8) );
      }
   }
   return '\0';
   while (auVar15._8_8_ = 0,auVar15._0_8_ = (ulong)uVar30 * lVar32,auVar25._8_8_ = 0,auVar25._0_8_ = uVar35,auVar16._8_8_ = 0,auVar16._0_8_ = ( ulong )(( uVar29 + uVar5 ) - SUB164(auVar15 * auVar25, 8)) * lVar32,auVar26._8_8_ = 0,auVar26._0_8_ = uVar35,uVar38 = uVar31,SUB164(auVar16 * auVar26, 8) != 0) {
      LAB_0011903d:uVar31 = uVar29;
   ...
   LAB_00119089:uVar35 = (ulong)uVar31;
   ...
   *(long*)( this + 0x20 ) = plVar34[1];
   plVar34 = (long*)*plVar4;
   LAB_001190ab:if ((long*)plVar34[1] != (long*)0x0) {
   ...
   *(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + -1;
   return cVar28;
}/* WARNING: Removing unreachable block (ram,0x00119310) *//* WARNING: Removing unreachable block (ram,0x00119440) *//* WARNING: Removing unreachable block (ram,0x001195b8) *//* WARNING: Removing unreachable block (ram,0x0011944c) *//* WARNING: Removing unreachable block (ram,0x00119456) *//* WARNING: Removing unreachable block (ram,0x0011959a) *//* WARNING: Removing unreachable block (ram,0x00119462) *//* WARNING: Removing unreachable block (ram,0x0011946c) *//* WARNING: Removing unreachable block (ram,0x0011957c) *//* WARNING: Removing unreachable block (ram,0x00119478) *//* WARNING: Removing unreachable block (ram,0x00119482) *//* WARNING: Removing unreachable block (ram,0x0011955e) *//* WARNING: Removing unreachable block (ram,0x0011948e) *//* WARNING: Removing unreachable block (ram,0x00119498) *//* WARNING: Removing unreachable block (ram,0x00119540) *//* WARNING: Removing unreachable block (ram,0x001194a4) *//* WARNING: Removing unreachable block (ram,0x001194ae) *//* WARNING: Removing unreachable block (ram,0x00119522) *//* WARNING: Removing unreachable block (ram,0x001194b6) *//* WARNING: Removing unreachable block (ram,0x001194c0) *//* WARNING: Removing unreachable block (ram,0x00119507) *//* WARNING: Removing unreachable block (ram,0x001194c8) *//* WARNING: Removing unreachable block (ram,0x001194dd) *//* WARNING: Removing unreachable block (ram,0x001194e9) *//* String vformat<String, String, String, String>(String const&, String const, String const, String
   const, String const) */undefined8 *vformat<String,String,String,String>(undefined8 *param_1, bool *param_2, String_conflict *param_3, String_conflict *param_4, String_conflict *param_5, String_conflict *param_6) {
   Variant *pVVar1;
   int iVar2;
   Variant *pVVar3;
   int iVar4;
   ...
   *param_1 = local_100[0];
   ...
   return param_1;
}/* WARNING: Removing unreachable block (ram,0x00119738) *//* WARNING: Removing unreachable block (ram,0x00119868) *//* WARNING: Removing unreachable block (ram,0x001199e0) *//* WARNING: Removing unreachable block (ram,0x00119874) *//* WARNING: Removing unreachable block (ram,0x0011987e) *//* WARNING: Removing unreachable block (ram,0x001199c2) *//* WARNING: Removing unreachable block (ram,0x0011988a) *//* WARNING: Removing unreachable block (ram,0x00119894) *//* WARNING: Removing unreachable block (ram,0x001199a4) *//* WARNING: Removing unreachable block (ram,0x001198a0) *//* WARNING: Removing unreachable block (ram,0x001198aa) *//* WARNING: Removing unreachable block (ram,0x00119986) *//* WARNING: Removing unreachable block (ram,0x001198b6) *//* WARNING: Removing unreachable block (ram,0x001198c0) *//* WARNING: Removing unreachable block (ram,0x00119968) *//* WARNING: Removing unreachable block (ram,0x001198cc) *//* WARNING: Removing unreachable block (ram,0x001198d6) *//* WARNING: Removing unreachable block (ram,0x0011994a) *//* WARNING: Removing unreachable block (ram,0x001198de) *//* WARNING: Removing unreachable block (ram,0x001198e8) *//* WARNING: Removing unreachable block (ram,0x0011992f) *//* WARNING: Removing unreachable block (ram,0x001198f0) *//* WARNING: Removing unreachable block (ram,0x00119905) *//* WARNING: Removing unreachable block (ram,0x00119911) *//* String vformat<Variant, String, String>(String const&, Variant const, String const, String const)
    */undefined8 *vformat<Variant,String,String>(undefined8 *param_1, bool *param_2, Variant *param_3, String_conflict *param_4, String_conflict *param_5) {
   Variant *pVVar1;
   int iVar2;
   Variant *pVVar3;
   int iVar4;
   ...
   *param_1 = local_f0[0];
   ...
   return param_1;
}/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* CowData<char32_t>::_unref() */void CowData<char32_t>::_unref(void) {
   long *plVar1;
   long lVar2;
   long *in_RDI;
   if (*in_RDI == 0) {
   ...
   *(undefined8*)this = 0;
   ...
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void FUN_00119c3a(void) {
   code *pcVar1;
   _DAT_00000000 = 0;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ...
   *(undefined***)this = &PTR__PackedArrayRef_0011b610;
   ...
   operator_delete(this, 0x20);
   return;
}/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* CowData<Color>::_unref() */void CowData<Color>::_unref(void) {
   long *plVar1;
   long lVar2;
   long *in_RDI;
   if (*in_RDI == 0) {
   ...
   *(undefined8*)this = 0;
   ...
   DefaultTypedAllocator<HashMapElement<Variant, Variant> > >::_resize_and_rehash(unsigned int) */void HashMap<Variant,Variant,VariantHasher,StringLikeVariantComparator,DefaultTypedAllocator<HashMapElement<Variant,Variant>>>::_resize_and_rehash(HashMap<Variant,Variant,VariantHasher,StringLikeVariantComparator,DefaultTypedAllocator<HashMapElement<Variant,Variant>>> *this, uint param_1) {
   uint *puVar1;
   undefined8 *puVar2;
   uint uVar3;
   uint uVar4;
   ...
   *(void**)( this + 8 ) = __s_00;
   ...
   return;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<Variant, Variant, VariantHasher, StringLikeVariantComparator,
   DefaultTypedAllocator<HashMapElement<Variant, Variant> > >::operator[](Variant const&) */Variant * __thiscall
...
::operator[](HashMap<Variant,Variant,VariantHasher,StringLikeVariantComparator,DefaultTypedAllocator<HashMapElement<Variant,Variant>>>
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (*(long*)( this + 8 ) == 0) {
      LAB_0011a758:local_a0 = (undefined1[16])0x0;
      local_a8[0] = 0;
      local_a8[1] = 0;
      uVar35 = (ulong)uVar28;
      uVar36 = uVar35 * 4;
      ...
      *(void**)( this + 8 ) = __s_00;
      if (uVar28 != 0) {
         ...
         LAB_0011a62d:iVar32 = *(int*)( this + 0x2c );
         if (iVar32 != 0) {
            LAB_0011a63d:uVar38 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
            ...
            if (uVar39 != 0) {
               do {
                  if (uVar29 == uVar39) {
                     cVar27 = StringLikeVariantComparator::compare((Variant*)( *(long*)( *(long*)( this + 8 ) + lVar34 * 8 ) + 0x10 ), param_1);
                     if (cVar27 != '\0') {
                        Variant::operator =((Variant*)( *(long*)( *(long*)( this + 8 ) + (ulong)uVar43 * 8 ) + 0x28 ), (Variant*)local_a8);
               ...
               } while ( ( uVar39 != 0 ) && ( auVar13._8_8_ = 0 ),auVar13._0_8_ = (ulong)uVar39 * lVar2,auVar25._8_8_ = 0,auVar25._0_8_ = uVar36,auVar14._8_8_ = 0,auVar14._0_8_ = ( ulong )(( uVar38 + uVar43 ) - SUB164(auVar13 * auVar25, 8)) * lVar2,auVar26._8_8_ = 0,auVar26._0_8_ = uVar36,uVar44 <= SUB164(auVar14 * auVar26, 8) );
            }
      ...
      LAB_0011a31f:if (*(int*)( this + 0x28 ) == 0x1c) {
      ...
      if (*(int*)( this + 0x2c ) != 0) {
         ...
         if (uVar29 == 0) {
            ...
            do {
               if (uVar38 == uVar29) {
                  cVar27 = StringLikeVariantComparator::compare((Variant*)( *(long*)( lVar33 + lVar34 * 8 ) + 0x10 ), param_1);
                  if (cVar27 != '\0') {
            ...
            } while ( ( uVar29 != 0 ) && ( auVar9._8_8_ = 0 ),auVar9._0_8_ = (ulong)uVar29 * lVar2,auVar21._8_8_ = 0,auVar21._0_8_ = uVar36,auVar10._8_8_ = 0,auVar10._0_8_ = ( ulong )(( uVar39 + uVar28 ) - SUB164(auVar9 * auVar21, 8)) * lVar2,auVar22._8_8_ = 0,auVar22._0_8_ = uVar36,uVar43 <= SUB164(auVar10 * auVar22, 8) );
         }
         local_a8[0] = 0;
         local_a8[1] = 0;
      ...
      local_a0 = (undefined1[16])0x0;
      iVar32 = 0;
      LAB_0011a2fd:if ((float)uVar35 * __LC76 < (float)( iVar32 + 1 )) goto LAB_0011a31f;
   }
   ...
   *puVar37 = uVar29;
   *(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;
   LAB_0011a4e0:if (Variant::needs_deinit[local_a8[0]] != '\0') {
      Variant::_clear_internal();
   }
   LAB_0011a4f5:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return local_b8;
   ...
   const&, bool) */Variant * HashMap<Variant,Variant,VariantHasher,StringLikeVariantComparator,DefaultTypedAllocator<HashMapElement<Variant,Variant>>>
   ...
   if (*(long*)( param_2 + 8 ) == 0) {
      ...
      *(void**)( param_2 + 8 ) = __s_00;
      ...
      LAB_0011ab9a:if (*(int*)( param_2 + 0x28 ) == 0x1c) {
         _err_print_error("_insert", "./core/templates/hash_map.h", 0xdd, "Condition \"capacity_index + 1 == HASH_TABLE_SIZE_MAX\" is true. Returning: nullptr", "Hash table maximum capacity reached, aborting insertion.", 0, 0);
         local_a8 = (undefined8*)0x0;
         goto LAB_0011ad4c;
      }
      _resize_and_rehash((HashMap<Variant,Variant,VariantHasher,StringLikeVariantComparator,DefaultTypedAllocator<HashMapElement<Variant,Variant>>>*)param_2, *(int*)( param_2 + 0x28 ) + 1);
   } else {
      LAB_0011ab68:iVar27 = *(int*)( param_2 + 0x2c );
      if (iVar27 != 0) {
         LAB_0011ada0:uVar23 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( param_2 + 0x28 ) * 4 );
         ...
         if (uVar32 != 0) {
            do {
               if (uVar32 == uVar28) {
                  cVar22 = StringLikeVariantComparator::compare((Variant*)( *(long*)( *(long*)( param_2 + 8 ) + lVar31 * 8 ) + 0x10 ), (Variant*)CONCAT71(in_register_00000011, param_3));
                  if (cVar22 != '\0') {
                     Variant::operator =((Variant*)( *(long*)( *(long*)( param_2 + 8 ) + (ulong)uVar29 * 8 ) + 0x28 ), in_RCX);
            ...
            } while ( ( uVar32 != 0 ) && ( auVar10._8_8_ = 0 ),auVar10._0_8_ = (ulong)uVar32 * lVar3,auVar18._8_8_ = 0,auVar18._0_8_ = uVar26,auVar11._8_8_ = 0,auVar11._0_8_ = ( ulong )(( uVar23 + uVar29 ) - SUB164(auVar10 * auVar18, 8)) * lVar3,auVar19._8_8_ = 0,auVar19._0_8_ = uVar26,uVar35 <= SUB164(auVar11 * auVar19, 8) );
         }
         iVar27 = *(int*)( param_2 + 0x2c );
      }
      LAB_0011ab78:if ((float)uVar24 * __LC76 < (float)( iVar27 + 1 )) goto LAB_0011ab9a;
   }
   ...
   *(int*)( param_2 + 0x2c ) = *(int*)( param_2 + 0x2c ) + 1;
   LAB_0011ad4c:*(undefined8**)param_1 = local_a8;
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
   /* WARNING: Subroutine does not return */
   ...
   DefaultTypedAllocator<HashMapElement<Variant, Variant> > > const&) */void HashMap<Variant,Variant,VariantHasher,StringLikeVariantComparator,DefaultTypedAllocator<HashMapElement<Variant,Variant>>>::operator =(HashMap<Variant,Variant,VariantHasher,StringLikeVariantComparator,DefaultTypedAllocator<HashMapElement<Variant,Variant>>> *this, HashMap *param_1) {
   void *pvVar1;
   uint uVar2;
   uint uVar4;
   long *plVar5;
   ...
   ulong uVar3;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (this != (HashMap<Variant,Variant,VariantHasher,StringLikeVariantComparator,DefaultTypedAllocator<HashMapElement<Variant,Variant>>>*)param_1) {
      ...
      LAB_0011b119:if (( *(long*)( param_1 + 8 ) != 0 ) && ( plVar5 = *(long**)( param_1 + 0x18 ) ),plVar5 != (long*)0x0) {
         do {

...
/* hb_buffer_t::enlarge(unsigned int) */hb_buffer_t hb_buffer_t::enlarge(hb_buffer_t *this, uint param_1) {
   long lVar1;
   long lVar2;
   void *pvVar3;
   void *pvVar4;
      ...
      if (param_1 < 0xccccccd) {
         ...
         if ((int)( (ulong)uVar5 * 0x14 >> 0x20 ) == 0) {
            ...
            if (pvVar4 == (void*)0x0) {
               ...
               *(void**)( this + 0x70 ) = pvVar4;
               if (lVar1 == lVar2) {
                  LAB_001001d2:*(void**)( this + 0x78 ) = pvVar4;
                  return (hb_buffer_t)0x0;
               }
...
/* hb_buffer_t::make_room_for(unsigned int, unsigned int) */undefined8 hb_buffer_t::make_room_for(hb_buffer_t *this, uint param_1, uint param_2) {
   undefined8 uVar1;
   uint uVar2;
   ...
   if (uVar2 != 0) {
      ...
      if (( *(void**)( this + 0x78 ) == *(void**)( this + 0x70 ) ) && ( uVar2 = *(uint*)( this + 100 ) * (int*)( this + 0x5c ) + param_1 < param_2 + uVar2 )) {
...
/* hb_buffer_t::shift_forward(unsigned int) */undefined8 hb_buffer_t::shift_forward(hb_buffer_t *this, uint param_1) {
   int iVar1;
   undefined8 uVar2;
   uint uVar3;
   uint uVar4;
   ...
   memmove((void*)( *(long*)( this + 0x70 ) + ( (ulong)param_1 + (ulong)uVar5 ) * 0x14 ), (void*)( *(long*)( this + 0x70 ) + (ulong)uVar5 * 0x14 ), ( ulong )(iVar1 - uVar5) * 0x14);
...
/* hb_buffer_t::get_scratch_buffer(unsigned int*) */undefined8 hb_buffer_t::get_scratch_buffer(hb_buffer_t *this, uint *param_1) {
...
/* hb_buffer_t::similar(hb_buffer_t const&) */void hb_buffer_t::similar(hb_buffer_t *this, hb_buffer_t *param_1) {
   undefined8 uVar1;
...
/* hb_buffer_t::clear() */void hb_buffer_t::clear(hb_buffer_t *this) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* hb_buffer_t::reset() */void hb_buffer_t::reset(hb_buffer_t *this) {
   undefined8 uVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   hb_unicode_funcs_destroy(*(undefined8*)( this + 0x10 ));
...
/* hb_buffer_t::enter() */void hb_buffer_t::enter(hb_buffer_t *this) {
   uint uVar1;
   uint uVar2;
...
/* hb_buffer_t::leave() */void hb_buffer_t::leave(hb_buffer_t *this) {
   *(undefined8*)( this + 0xc4 ) = 0x1fffffff3fffffff;
   *(undefined2*)( this + 0xb8 ) = 0;
   return;
}
/* hb_buffer_t::add(unsigned int, unsigned int) */void hb_buffer_t::add(hb_buffer_t *this, uint param_1, uint param_2) {
   uint *puVar1;
   char cVar2;
   ulong uVar3;
   uint uVar4;
...
/* hb_buffer_t::add_info(hb_glyph_info_t const&) */void hb_buffer_t::add_info(hb_buffer_t *this, hb_glyph_info_t *param_1) {
   undefined8 *puVar1;
   undefined8 uVar2;
   char cVar3;
   ulong uVar4;
...
/* hb_buffer_t::clear_output() */void hb_buffer_t::clear_output(hb_buffer_t *this) {
...
/* hb_buffer_t::clear_positions() */void hb_buffer_t::clear_positions(hb_buffer_t *this) {
   *(undefined4*)( this + 100 ) = 0;
...
/* hb_buffer_t::sync() */hb_buffer_t hb_buffer_t::sync(hb_buffer_t *this) {
   char cVar1;
   long lVar2;
   long lVar3;
   int iVar4;
   ...
   if (hVar8 != (hb_buffer_t)0x0) {
      ...
      if (this[0x5a] == (hb_buffer_t)0x0) {
         ...
         if (( lVar3 != lVar2 ) || ( iVar7 = *(int*)( this + 100 ) * (int*)( this + 0x5c ) != iVar7 )) {
            ...
            memmove((void*)( *(long*)( this + 0x78 ) + ( ulong ) * (uint*)( this + 100 ) * 0x14 ), (void*)( *(long*)( this + 0x70 ) + ( ulong ) * (uint*)( this + 0x5c ) * 0x14 ), (ulong)uVar6 * 0x14);
            iVar7 = *(int*)( this + 100 );
            lVar3 = *(long*)( this + 0x78 );
            lVar2 = *(long*)( this + 0x70 );
   ...
   LAB_00100686:*(long*)( this + 0x78 ) = lVar2;
   this[0x5a] = (hb_buffer_t)0x0;
   *(undefined4*)( this + 100 ) = 0;
   *(undefined4*)( this + 0x5c ) = 0;
   return hVar8;
}
/* hb_buffer_t::sync_so_far() */int hb_buffer_t::sync_so_far(hb_buffer_t *this) {
   hb_buffer_t hVar1;
   int iVar2;
   char cVar3;
   int iVar4;
...
/* hb_buffer_t::move_to(unsigned int) */undefined8 hb_buffer_t::move_to(hb_buffer_t *this, uint param_1) {
   char cVar1;
   uint uVar2;
   int iVar3;
   uint uVar4;
   ...
   if (this[0x5a] == (hb_buffer_t)0x0) {
      *(uint*)( this + 0x5c ) = param_1;
      ...
      if (uVar4 < param_1) {
         ...
         memmove((void*)( *(long*)( this + 0x78 ) + ( ulong ) * (uint*)( this + 100 ) * 0x14 ), (void*)( *(long*)( this + 0x70 ) + ( ulong ) * (uint*)( this + 0x5c ) * 0x14 ), (ulong)uVar4 * 0x14);
         ...
         *(uint*)( this + 0x5c ) = uVar2 + iVar3;
         memmove((void*)( *(long*)( this + 0x70 ) + ( ulong )(uVar2 + iVar3) * 0x14 ), (void*)( *(long*)( this + 0x78 ) + uVar5 * 0x14 ), (ulong)uVar6 * 0x14);
         return 1;
      }
...
/* hb_buffer_t::set_masks(unsigned int, unsigned int, unsigned int, unsigned int) */void hb_buffer_t::set_masks(hb_buffer_t *this, uint param_1, uint param_2, uint param_3, uint param_4) {
   uint *puVar1;
   uint *puVar2;
...
/* hb_buffer_t::merge_clusters_impl(unsigned int, unsigned int) */void hb_buffer_t::merge_clusters_impl(hb_buffer_t *this, uint param_1, uint param_2) {
   long lVar1;
   uint uVar2;
   int iVar3;
   long lVar4;
   ...
   uVar12 = *(uint*)( lVar4 + 8 + (ulong)param_1 * 0x14 );
   uVar11 = uVar12;
   if (uVar10 < param_2) {
      lVar5 = lVar4 + (ulong)uVar10 * 0x14;
      lVar1 = lVar4 + 0x14 + ( (ulong)uVar10 + ( ulong )(( param_2 - 2 ) - param_1) ) * 0x14;
      if (( (int)lVar1 - (int)lVar5 & 4U ) == 0) goto LAB_00100960;
      uVar11 = *(uint*)( lVar5 + 8 );
      if (uVar12 <= *(uint*)( lVar5 + 8 )) {
         uVar11 = uVar12;
      }

      for (lVar5 = lVar5 + 0x14; lVar5 != lVar1; lVar5 = lVar5 + 0x28) {
         LAB_00100960:if (*(uint*)( lVar5 + 8 ) < uVar11) {
            uVar11 = *(uint*)( lVar5 + 8 );
         }

         if (*(uint*)( lVar5 + 0x1c ) < uVar11) {
            uVar11 = *(uint*)( lVar5 + 0x1c );
         }

      }

      uVar10 = *(uint*)( lVar4 + 8 + ( ulong )(param_2 - 1) * 0x14 );
      if (( uVar10 != uVar11 ) && ( uVar13 = param_2 < uVar13 )) goto LAB_00100992;
   }
 else {
      uVar10 = *(uint*)( lVar4 + 8 + ( ulong )(param_2 - 1) * 0x14 );
      if (( uVar12 == uVar10 ) || ( uVar13 = uVar13 <= param_2 )) goto LAB_00100a40;
      LAB_00100992:puVar8 = (uint*)( lVar4 + 8 + uVar9 * 0x14 );
      do {
         param_2 = (uint)uVar9;
         uVar2 = *puVar8;
 ...
 while ( param_2 != uVar13 );
   ...
   uVar12 = uVar11;
   if (bVar14) {
      piVar6 = (int*)( lVar4 + 8 + (ulong)param_1 * 0x14 );
      uVar10 = param_1;
      do {
         param_1 = uVar10;
         if (param_1 <= *(uint*)( this + 0x5c )) {
            if (param_1 == *(uint*)( this + 0x5c )) {
               lVar5 = lVar4 + (ulong)param_1 * 0x14;
               uVar10 = *(uint*)( lVar5 + 8 );
               if (( uVar10 != uVar11 ) && ( *(int*)( this + 100 ) != 0 )) {
                  lVar1 = *(long*)( this + 0x78 );
                  lVar7 = lVar1 + ( ulong )(*(int*)( this + 100 ) - 1) * 0x14;
                  goto LAB_00100a3b;
               }
 ...
 while ( *(int*)( lVar4 + 8 + ( ulong )(param_1 - 1) * 0x14 ) == iVar3 );
   }

   LAB_00100a40:if (param_1 < param_2) {
      puVar8 = (uint*)( lVar4 + 4 + (ulong)param_1 * 0x14 );
      do {
         if (uVar12 != puVar8[1]) {
 ...
 while ( (uint*)( lVar4 + 0x18 + ( ( ulong )(( param_2 - 1 ) - param_1) + (ulong)param_1 ) * 0x14 ) != puVar8 );
   }

   return;
   LAB_00100a3b:if (*(uint*)( lVar7 + 8 ) != uVar10) goto LAB_00100a40;
   if (uVar10 != uVar11) {
      *(uint*)( lVar7 + 4 ) = *(uint*)( lVar7 + 4 ) & 0xfffffff8;
   }

   *(uint*)( lVar7 + 8 ) = uVar11;
   if (lVar1 == lVar7) goto LAB_00100a40;
   uVar10 = *(uint*)( lVar5 + 8 );
   lVar7 = lVar7 + -0x14;
   goto LAB_00100a3b;
}
/* hb_buffer_t::merge_out_clusters(unsigned int, unsigned int) */void hb_buffer_t::merge_out_clusters(hb_buffer_t *this, uint param_1, uint param_2) {
   long lVar1;
   int iVar2;
   uint uVar3;
   long lVar4;
   ...
   uVar10 = param_1 + 1;
   uVar8 = *(uint*)( lVar4 + 8 + (ulong)param_1 * 0x14 );
   if (uVar10 < param_2) {
      lVar5 = lVar4 + (ulong)uVar10 * 0x14;
      lVar1 = lVar4 + 0x14 + ( (ulong)uVar10 + ( ulong )(( param_2 - param_1 ) - 2) ) * 0x14;
      if (( (int)lVar1 - (int)lVar5 & 4U ) != 0) {
         if (*(uint*)( lVar5 + 8 ) < uVar8) {
            uVar8 = *(uint*)( lVar5 + 8 );
         }

         lVar5 = lVar5 + 0x14;
         if (lVar5 == lVar1) goto LAB_00100b49;
      }
      ...
      do {
         ...
         if (*(uint*)( lVar5 + 0x1c ) < uVar8) {
            uVar8 = *(uint*)( lVar5 + 0x1c );
         }
 ...
 while ( lVar5 != lVar1 );
   ...
   LAB_00100b49:piVar6 = (int*)( lVar4 + 8 + (ulong)param_1 * 0x14 );
   do {
      uVar10 = param_1;
      if (uVar10 == 0) break;
      iVar2 = *piVar6;
 ...
 while ( *(int*)( lVar4 + 8 + ( ulong )(uVar10 - 1) * 0x14 ) == iVar2 );
   uVar3 = *(uint*)( this + 100 );
   if (param_2 < uVar3) {
      piVar6 = (int*)( lVar4 + 8 + (ulong)param_2 * 0x14 );
      do {
         if (*(int*)( lVar4 + 8 + ( ulong )(param_2 - 1) * 0x14 ) != *piVar6) goto LAB_00100bad;
         param_2 = param_2 + 1;
         piVar6 = piVar6 + 5;
      }
 while ( uVar3 != param_2 );
      ...
      LAB_00100bad:if (uVar3 != param_2) goto LAB_00100bb2;
   }

   uVar9 = *(uint*)( this + 0x5c );
   param_2 = uVar3;
   if (uVar9 < *(uint*)( this + 0x60 )) {
      puVar7 = (uint*)( *(long*)( this + 0x70 ) + 4 + (ulong)uVar9 * 0x14 );
      do {
         if (puVar7[1] != *(uint*)( lVar4 + ( ulong )(uVar3 - 1) * 0x14 + 8 )) break;
         if (uVar8 != puVar7[1]) {
            *puVar7 = *puVar7 & 0xfffffff8;
         }
 ...
 while ( uVar9 < *(uint*)( this + 0x60 ) );
   ...
   LAB_00100bb2:if (param_2 <= uVar10) {
      return;
   }

   puVar7 = (uint*)( lVar4 + 4 + (ulong)uVar10 * 0x14 );
   do {
      if (uVar8 != puVar7[1]) {
         *puVar7 = *puVar7 & 0xfffffff8;
      }
 ...
 while ( (uint*)( lVar4 + 0x18 + ( ( ulong )(( param_2 - uVar10 ) - 1) + (ulong)uVar10 ) * 0x14 ) != puVar7 );
   return;
}
/* hb_buffer_t::delete_glyph() */void hb_buffer_t::delete_glyph(hb_buffer_t *this) {
   long lVar1;
   uint uVar2;
   uint uVar3;
   long lVar4;
   ...
   if (uVar5 < *(uint*)( this + 0x60 )) {
      if (*(uint*)( *(long*)( this + 0x70 ) + 8 + (ulong)uVar5 * 0x14 ) == uVar3) goto LAB_00100ce0;
      iVar6 = *(int*)( this + 100 );
      if (iVar6 == 0) {
 ...
 while ( bVar8 );
   ...
   LAB_00100ce0:*(uint*)( this + 0x5c ) = uVar5;
   return;
}
/* hb_buffer_t::delete_glyphs_inplace(bool (*)(hb_glyph_info_t const*)) */void hb_buffer_t::delete_glyphs_inplace(hb_buffer_t *this, _func_bool_hb_glyph_info_t_ptr *param_1) {
   undefined8 *puVar1;
   long lVar2;
   uint uVar3;
   uint uVar4;
   ...
   if (uVar4 == 0) {
      LAB_00100e80:uVar13 = 0;
      LAB_00100e83:*(uint*)( this + 0x60 ) = uVar13;
      return;
   }
   ...
   do {
      ...
      if (bVar8) {
         ...
         if (uVar4 <= uVar3) {
            if (uVar13 == 0) goto LAB_00100e80;
            uVar10 = ( ulong )(uVar13 - 1);
            uVar12 = *(uint*)( lVar9 + 8 + ( ulong )(uVar13 - 1) * 0x14 );
            if (uVar5 < uVar12) {
               LAB_00100e17:uVar13 = *(uint*)( lVar9 + lVar11 + 4 );
...
;
         ...
         if (*(uint*)( lVar9 + 0x1c + lVar11 ) != uVar5) {
            if (uVar13 == 0) {
               ...
               if (uVar5 < uVar12) goto LAB_00100e17;
            }
         ...
         LAB_00100dec:uVar13 = (uint)uVar14;
         if (uVar4 == uVar3) goto LAB_00100e83;
         lVar9 = *(long*)( this + 0x70 );
      }
...
/* hb_buffer_t::guess_segment_properties() */void hb_buffer_t::guess_segment_properties(hb_buffer_t *this) {
   long lVar1;
   int iVar2;
   undefined8 uVar3;
   long lVar4;
   if (( *(int*)( this + 0x3c ) == 0 ) && ( *(int*)( this + 0x60 ) != 0 )) {
      ...
      do {
         ...
         iVar2 = ( **(code**)( lVar1 + 0x38 ) )(lVar1, *(undefined4*)( *(long*)( this + 0x70 ) + lVar4 * 0x14 ), *(undefined8*)( lVar1 + 0x78 ));
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */hb_buffer_t *hb_buffer_create(void) {
   undefined8 uVar1;
   hb_buffer_t *this;
   undefined8 uVar2;
   undefined8 uVar3;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void hb_buffer_reset(hb_buffer_t *param_1) {
   undefined8 uVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   if (*(int*)( param_1 + 4 ) != 0) {
...
;
 ...
 while ( true );
            ...
            __mutex[1].__align = 0;
            *(undefined8*)( (long)__mutex + 0x30 ) = 0;
            LAB_001011d0:pthread_mutex_destroy(__mutex);
            free(__mutex);
            param_1[2] = 0;
            param_1[3] = 0;
         }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */bool hb_buffer_set_user_data(int *param_1, long param_2, long param_3, long param_4, int param_5) {
   uint uVar1;
   long lVar2;
   code *pcVar3;
   long lVar4;
...
;
 ...
 while ( uVar8 != uVar5 );
   ...
   if (uVar8 == 0) {
      ...
      if (__mutex[1].__data.__lock < 1) {
         if (__mutex[1].__data.__lock != 0) goto LAB_00101558;
         uVar9 = 8;
         LAB_001014ec:plVar6 = (long*)realloc(plVar6, uVar9 * 0x18);
         if (plVar6 == (long*)0x0) {
 ...
 while ( uVar8 != uVar5 );
      ...
      if ((int)uVar1 <= (int)uVar8) {
         if (-1 < (int)uVar1) {
            uVar9 = (ulong)uVar1;
            if (uVar5 <= uVar1) goto LAB_001014b3;
            do {
               uVar8 = (int)( uVar9 >> 1 ) + 8 + (int)uVar9;
               uVar9 = (ulong)uVar8;
            }
 while ( uVar8 < uVar5 );
            if (uVar8 < 0xaaaaaab) goto LAB_001014ec;
            __mutex[1].__data.__lock = ~uVar1;
         }

         LAB_00101558:uVar11 = __hb_CrapPool;
   ...
   LAB_001014b3:*(uint*)( (long)__mutex + 0x2c ) = uVar5;
   plVar10 = plVar6 + uVar7 * 3;
   *plVar10 = param_2;
   plVar10[1] = param_3;
   plVar10[2] = param_4;
   LAB_001014ca:pthread_mutex_unlock(__mutex);
   LAB_00101305:return -1 < __mutex[1].__data.__lock && plVar10 != (long*)0x0;
}
...
void hb_buffer_add(hb_buffer_t *param_1, undefined4 param_2, undefined4 param_3) {
   ...
   *(int*)( param_1 + 0x60 ) = *(int*)( param_1 + 0x60 ) + 1;
   LAB_00101977:*(undefined4*)( param_1 + 0xb4 ) = 0;
   return;
}
bool hb_buffer_set_length(hb_buffer_t *param_1, uint param_2) {
   ...
   if (param_2 == 0) {
      ...
      *(undefined4*)( param_1 + 0xb0 ) = 0;
      ...
      if (( *(uint*)( param_1 + 0x68 ) <= param_2 ) && ( cVar1 = hb_buffer_t::enlarge(param_1, param_2) ),cVar1 == '\0') {
         return false;
      }
      ...
      if (uVar3 < param_2) {
         ...
         if (param_1[0x5b] != (hb_buffer_t)0x0) {
            ...
            if (uVar3 != 0) {
               memset((void*)( *(long*)( param_1 + 0x80 ) + ( ulong ) * (uint*)( param_1 + 0x60 ) * 0x14 ), 0, (ulong)uVar3);
            }
...
void hb_buffer_reverse_range(long param_1, uint param_2, uint param_3) {
   ...
   uVar7 = (uint)uVar14;
   if (( uVar7 + 2 <= uVar6 ) && ( uVar10 = uVar7 < uVar10 )) {
...
void hb_buffer_reverse_clusters(long param_1) {
   ...
   if (( uVar8 == 0 ) || ( uVar8 == 1 )) goto LAB_00101fe1;
   ...
   do {
      if (*(int*)( (long)puVar11 + lVar18 + -0xc ) == *(int*)( (long)puVar11 + lVar18 + 8 )) {
         ...
         if (( uVar8 + 2 <= uVar17 ) && ( uVar15 = uVar8 < uVar19 )) {
            do {
               uVar16 = (ulong)uVar15;
               uVar9 = (ulong)uVar8;
               uVar8 = uVar8 + 1;
 ...
 while ( uVar8 < uVar15 );
         ...
         if (*(char*)( param_1 + 0x5b ) != '\0') {
            ...
            if (( uVar13 + 2 <= uVar15 ) && ( uVar12 = uVar13 < uVar12 )) {
 ...
 while ( uVar8 < ( ( uVar15 - 1 ) + uVar19 ) - uVar8 );
         ...
         if (*(char*)( param_1 + 0x5b ) != '\0') {
            ...
            if (uVar19 + 2 <= uVar15) goto LAB_0010208a;
         }

      }
 else {
         if (*(char*)( param_1 + 0x5b ) == '\0') goto LAB_00101f8a;
         lVar18 = *(long*)( param_1 + 0x80 );
         LAB_0010208a:if (uVar19 < uVar15 - 1) {
            iVar4 = uVar19 - 1;
 ...
 while ( uVar13 < ( uVar8 - 1 ) - uVar13 );
      if (*(char*)( param_1 + 0x5b ) != '\0') {
         ...
         if (1 < uVar13) {
            ...
            puVar10 = (undefined8*)( (long)*(undefined8**)( param_1 + 0x80 ) + ( ulong )(uVar13 - 1) * 0x14 );
            do {
               uVar5 = puVar11[1];
               uVar2 = *(undefined4*)( puVar10 + 2 );
               uVar8 = uVar8 + 1;
 ...
 while ( uVar8 < ( uVar13 - 1 ) - uVar8 );
   ...
   LAB_00101fe1:if (lVar3 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
void hb_buffer_t::hb_buffer_guess_segment_properties(hb_buffer_t *this) {
...
void hb_buffer_add_utf8(hb_buffer_t *param_1, byte *param_2, int param_3, uint param_4, uint param_5) {
   ...
   if (*(int*)( param_1 + 4 ) != 0) {
      ...
      if (param_5 < 0x10000000) {
         ...
         if (( ( param_4 != 0 ) && ( iVar8 == 0 ) ) && ( *(undefined4*)( param_1 + 0xb0 ) = param_2 < pbVar10 )) {
            lVar9 = 1;
            pbVar14 = pbVar10;
            do {
               pbVar11 = pbVar14 + -1;
 ...
 while ( param_2 != pbVar7 + -1 );
                  ...
                  pbVar13 = pbVar7;
                  pbVar7 = param_2;
                  joined_r0x0010263f:uVar5 = (uint)bVar1;
                  uVar3 = uVar5;
                  if ((char)bVar1 < '\0') goto LAB_00102645;
                  joined_r0x00102564:if (pbVar13 == pbVar14) {
                     pbVar11 = pbVar7;
                     uVar12 = uVar3;
                  }
                  ...
                  LAB_00102645:if (0x1d < uVar5 - 0xc2) {
                     LAB_0010259f:if (uVar5 - 0xe0 < 0x10) {
                        uVar3 = uVar2;
                        if (( ( ( 1 < (long)pbVar14 - (long)pbVar13 ) && ( pbVar7[1] - 0x80 < 0x40 ) ) && ( pbVar7[2] - 0x80 < 0x40 ) ) && ( ( uVar5 = ( uVar5 & 0xf ) << 0xc | pbVar7[2] - 0x80 | ( pbVar7[1] - 0x80 ) * 0x40 ),0x7ff < uVar5 && ( 0x7ff < uVar5 - 0xd800 ) )) {
                           pbVar13 = pbVar7 + 3;
                           uVar3 = uVar5;
                        }
                        ...
                        uVar3 = uVar2;
                        if (( ( ( uVar5 - 0xf0 < 5 ) && ( 2 < (long)pbVar14 - (long)pbVar13 ) ) && ( ( pbVar7[1] - 0x80 < 0x40 && ( ( pbVar7[2] - 0x80 < 0x40 && ( pbVar7[3] - 0x80 < 0x40 ) ) ) ) ) ) && ( uVar5 = ( uVar5 & 7 ) << 0x12 | pbVar7[3] - 0x80 | ( pbVar7[1] - 0x80 ) * 0x1000 | ( pbVar7[2] - 0x80 ) * 0x40 ),uVar5 - 0x10000 < 0x100000) {
                           pbVar13 = pbVar7 + 4;
                           uVar3 = uVar5;
                        }
                     ...
                     goto joined_r0x00102564;
                  }

                  uVar3 = uVar2;
                  if (pbVar14 <= pbVar13) goto joined_r0x00102564;
               ...
               *(uint*)( param_1 + lVar9 * 4 + 0x84 ) = uVar12;
               lVar9 = lVar9 + 1;
               if (( pbVar11 <= param_2 ) || ( pbVar14 = lVar9 == 6 )) break;
            }
 while ( true );
         }
         ...
         while (pbVar11 = pbVar10,pbVar10 < pbVar14) {
            while (true) {
               ...
               if (uVar5 - 0xc2 < 0x1e) {
                  ...
                  uVar12 = uVar2;
                  if (0xf < uVar5 - 0xe0) {
                     if (( ( ( uVar5 - 0xf0 < 5 ) && ( 2 < (long)pbVar14 - (long)pbVar10 ) ) && ( pbVar11[1] - 0x80 < 0x40 ) ) && ( ( ( pbVar11[2] - 0x80 < 0x40 && ( pbVar11[3] - 0x80 < 0x40 ) ) && ( uVar5 = ( uVar5 & 7 ) << 0x12 | ( pbVar11[1] - 0x80 ) * 0x1000 | pbVar11[3] - 0x80 | ( pbVar11[2] - 0x80 ) * 0x40 ),uVar5 - 0x10000 < 0x100000 ) )) {
                        pbVar10 = pbVar11 + 4;
                        uVar12 = uVar5;
                     }
                  ...
                  if (( ( (long)pbVar14 - (long)pbVar10 < 2 ) || ( 0x3f < pbVar11[1] - 0x80 ) ) || ( ( 0x3f < pbVar11[2] - 0x80 || ( ( uVar5 = ( uVar5 & 0xf ) << 0xc | ( pbVar11[1] - 0x80 ) * 0x40 | pbVar11[2] - 0x80 ),uVar5 < 0x800 || ( uVar5 - 0xd800 < 0x800 ) ) ) )) break;
                  pbVar10 = pbVar11 + 3;
                  hb_buffer_t::add(param_1, uVar5, iVar8 - iVar15);
                  pbVar11 = pbVar10;
                  if (pbVar14 <= pbVar10) goto LAB_001022a0;
               }
...
;
         LAB_001022a0:param_2 = param_2 + param_3;
         lVar9 = 1;
         *(undefined4*)( param_1 + 0xb4 ) = 0;
         if (pbVar10 < param_2) {
            for (; iVar8 = (int)lVar9,lVar9 != 6; lVar9 = lVar9 + 1) {
               ...
               uVar12 = uVar5;
               if (uVar5 < 0x80) {
                  LAB_001022e7:*(int*)( param_1 + 0xb4 ) = iVar8;
                  *(uint*)( param_1 + lVar9 * 4 + 0x98 ) = uVar12;
                  ...
                  if (0x1d < uVar5 - 0xc2) {
                     uVar12 = uVar2;
                     if (uVar5 - 0xe0 < 0x10) {
                        if (( ( 1 < (long)param_2 - (long)pbVar14 ) && ( pbVar10[1] - 0x80 < 0x40 ) ) && ( ( pbVar10[2] - 0x80 < 0x40 && ( ( uVar5 = ( uVar5 & 0xf ) << 0xc | ( pbVar10[1] - 0x80 ) * 0x40 | pbVar10[2] - 0x80 ),0x7ff < uVar5 && ( 0x7ff < uVar5 - 0xd800 ) ) ) )) {
                           pbVar14 = pbVar10 + 3;
                           uVar12 = uVar5;
                        }

                     }
 else if (( ( ( ( uVar5 - 0xf0 < 5 ) && ( 2 < (long)param_2 - (long)pbVar14 ) ) && ( pbVar10[1] - 0x80 < 0x40 ) ) && ( ( pbVar10[2] - 0x80 < 0x40 && ( pbVar10[3] - 0x80 < 0x40 ) ) ) ) && ( uVar5 = ( uVar5 & 7 ) << 0x12 | ( pbVar10[1] - 0x80 ) * 0x1000 | pbVar10[3] - 0x80 | ( pbVar10[2] - 0x80 ) * 0x40 ),uVar5 - 0x10000 < 0x100000) {
                        pbVar14 = pbVar10 + 4;
                        uVar12 = uVar5;
                     }
...
;
      ...
      if (param_5 < 0x10000000) {
         ...
         if (( ( param_4 != 0 ) && ( iVar4 == 0 ) ) && ( *(undefined4*)( param_1 + 0xb0 ) = param_2 < puVar9 )) {
            lVar5 = 1;
            puVar6 = puVar9;
            do {
               uVar1 = puVar6[-1];
               puVar7 = puVar6 + -1;
               uVar8 = (uint)uVar1;
               if (( ( uVar1 - 0xd800 < 0x800 ) && ( uVar8 = uVar2 ),0xdbff < uVar1 )) {
                  ...
                  *(uint*)( param_1 + lVar5 * 4 + 0x84 ) = uVar2;
                  ...
                  LAB_00102990:*(int*)( param_1 + 0xb0 ) = (int)lVar5;
 ...
 while ( lVar5 != 6 );
         ...
         while (puVar7 = puVar9,puVar9 < puVar6) {
            while (true) {
               ...
               puVar9 = puVar7 + 1;
               uVar8 = (uint)uVar1;
               if (( ( 0x7ff < uVar1 - 0xd800 ) || ( uVar8 = 0xdbff < uVar1 ) ) || ( puVar6 <= puVar9 )) goto LAB_0010283b;
...
;
            ...
            LAB_0010283b:hb_buffer_t::add(param_1, uVar8, ( uint )((long)puVar7 - (long)param_2 >> 1));
         }
;
         lVar5 = 1;
         *(undefined4*)( param_1 + 0xb4 ) = 0;
         ...
         if (puVar9 < param_2) {
            do {
               ...
               puVar6 = puVar9 + 1;
               uVar8 = (uint)uVar1;
               if (( ( uVar1 - 0xd800 < 0x800 ) && ( uVar8 = uVar2 ),uVar1 < 0xdc00 )) {
                  ...
                  *(uint*)( param_1 + lVar5 * 4 + 0x98 ) = uVar2;
                  ...
                  LAB_00102870:*(int*)( param_1 + 0xb4 ) = (int)lVar5;
...
void hb_buffer_add_utf32(hb_buffer_t *param_1, uint *param_2, int param_3, uint param_4, uint param_5) {
 ...
 while ( uVar8 != 0 );
      ...
      if (param_5 < 0x10000000) {
         ...
         if (( ( param_4 != 0 ) && ( iVar3 == 0 ) ) && ( *(undefined4*)( param_1 + 0xb0 ) = param_2 < puVar5 )) {
            lVar4 = 1;
            puVar6 = puVar5;
            do {
               uVar8 = puVar6[-1];
 ...
 while ( ( ( ( ulong )((long)( param_2 + local_40 ) + ( -1 - (long)puVar5 )) >> 2 ) + 2 != lVar4 ) && ( lVar4 != 6 ) );
         }
...
void hb_buffer_add_latin1(hb_buffer_t *param_1, byte *param_2, int param_3, uint param_4, uint param_5) {
   ...
   if (param_5 < 0x10000000) {
      ...
      if (( ( param_4 != 0 ) && ( iVar3 == 0 ) ) && ( *(undefined4*)( param_1 + 0xb0 ) = param_2 < pbVar7 )) {
         lVar5 = 1;
         pbVar6 = pbVar7;
         do {
            bVar1 = pbVar6[-1];
...
void hb_buffer_add_codepoints(hb_buffer_t *param_1, uint *param_2, int param_3, uint param_4, uint param_5) {
   char cVar1;
   int iVar2;
   long lVar3;
   uint *puVar4;
...
;
   ...
   if (param_5 < 0x10000000) {
      ...
      if (( ( param_4 != 0 ) && ( iVar2 == 0 ) ) && ( *(undefined4*)( param_1 + 0xb0 ) = param_2 < puVar6 )) {
         lVar3 = 1;
         puVar4 = puVar6;
         do {
            uVar5 = puVar4[-1];
   ...
   if (param_3 < uVar6) {
      ...
      if (CARRY4(uVar5, uVar10)) {
         ...
         if (param_1[0x58] != (hb_buffer_t)0x0) {
            ...
            memcpy((void*)( (ulong)uVar5 * 0x14 + *(long*)( param_1 + 0x70 ) ), (void*)( *(long*)( param_2 + 0x70 ) + (ulong)param_3 * 0x14 ), (ulong)uVar10 * 0x14);
            if (param_1[0x5b] != (hb_buffer_t)0x0) {
               memcpy((void*)( *(long*)( param_1 + 0x80 ) + (ulong)uVar5 * 0x14 ), (void*)( *(long*)( param_2 + 0x80 ) + (ulong)param_3 * 0x14 ), (ulong)uVar10 * 0x14);
            }
...
void hb_buffer_normalize_glyphs(long param_1) {
   ...
   if (uVar3 == 0) {
      LAB_00103348:if (lVar6 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
 ...
 while ( iVar26 == *piVar9 );
   ...
   if (uVar17 == 0) goto LAB_00103621;
   LAB_001033b0:uVar8 = uVar17 - 1;
   uVar10 = (ulong)uVar18;
   iVar26 = 0;
   iVar27 = 0;
            ...
            do {
               ...
               do {
                  ...
                  if (*piVar22 <= piVar9[uVar20 * 5]) {
                     if (uVar18 == uVar8) goto LAB_00103765;
                     break;
                  }
 ...
 while ( uVar19 != 0 );
               ...
               *(undefined8*)( piVar1 + 2 ) = uVar7;
               ...
               LAB_00103765:uVar10 = ( ulong )(uVar18 + 1);
               puVar12 = (undefined8*)( (long)puVar12 + 0x14 );
               piVar1 = piVar22;
            }
 ...
 while ( puVar12 != (undefined8*)( lVar14 + 0x30 + ( ( ( uVar23 - 2 ) - uVar18 ) + uVar10 ) * 0x14 ) );
         }
         ...
         if (1 < uVar17) {
            ...
            do {
               ...
               do {
                  ...
                  uVar20 = (ulong)uVar19;
                  if (*piVar22 <= piVar9[uVar20 * 5]) {
                     if (uVar18 == uVar8) goto LAB_0010359e;
                     break;
                  }
 ...
 while ( uVar19 != 0 );
               ...
               *puVar11 = uVar2;
               puVar11[1] = uVar7;
               LAB_0010359e:uVar10 = ( ulong )(uVar18 + 1);
               piVar1 = piVar22;
               puVar12 = (undefined8*)( (long)puVar12 + 0x14 );
            }
 while ( uVar18 + 1 != uVar17 );
 ...
 while ( *(int*)( *(long*)( param_1 + 0x70 ) + 8 + uVar10 * 0x14 ) == *piVar9 );
      if (uVar3 <= uVar23) goto LAB_00103348;
      lVar13 = *(long*)( param_1 + 0x70 );
      lVar14 = *(long*)( param_1 + 0x80 );
      uVar18 = uVar23;
      if (uVar23 < uVar17) goto LAB_001033b0;
      LAB_00103621:iVar26 = 0;
      iVar27 = 0;
      uVar10 = (ulong)uVar18;
      uVar8 = uVar17 - 1;
      uVar23 = uVar17;
...
/* hb_buffer_t::sort(unsigned int, unsigned int, int (*)(hb_glyph_info_t const*, hb_glyph_info_t
   const*)) */void hb_buffer_t::sort(hb_buffer_t *this, uint param_1, uint param_2, _func_int_hb_glyph_info_t_ptr_hb_glyph_info_t_ptr *param_3) {
   undefined8 *puVar1;
   long lVar2;
   undefined4 uVar3;
   long lVar4;
   ...
   if (uVar10 < param_2) {
      ...
      LAB_00103828:do {
         uVar12 = uVar9;
         if (param_1 < uVar12) {
            iVar11 = ( *param_3 )((hb_glyph_info_t*)( *(long*)( this + 0x70 ) + ( ulong )(uVar12 - 1) * 0x14 ), (hb_glyph_info_t*)( *(long*)( this + 0x70 ) + lVar13 ));
            uVar9 = uVar12 - 1;
            if (0 < iVar11) goto LAB_00103828;
         }
         ...
         if (uVar12 != uVar8) {
            ...
            memmove((void*)( lVar5 + ( ulong )(uVar12 + 1) * 0x14 ), (void*)( lVar5 + lVar2 ), ( ulong )(uVar8 - uVar12) * 0x14);
            lVar5 = *(long*)( this + 0x70 );
 ...
 while ( piVar7 != piVar6 );
            if (*(int*)( param_1 + 0x30 ) == 2) {
               ...
               do {
                  ...
                  if (param_4 < uVar2) {
                     LAB_00103a57:return uVar4 | 0x80;
                  }

                  for (int i = 0; i < 3; i++) {
                     uVar2 = piVar6[( i + 1 )] - piVar5[( i + 1 )];
                     if ((int)uVar2 < 1) {
                        uVar2 = -uVar2;
                     }

                     if (param_4 < uVar2) goto LAB_00103a57;
                  }
...
void hb_buffer_set_message_func(long param_1, long param_2, undefined8 param_3, code *UNRECOVERED_JUMPTABLE) {
   if (*(int*)( param_1 + 4 ) == 0) {
      if (UNRECOVERED_JUMPTABLE != (code*)0x0) {
         /* WARNING: Could not recover jumptable at 0x00103b72. Too many branches */
...
/* hb_buffer_t::message_impl(hb_font_t*, char const*, __va_list_tag*) */bool hb_buffer_t::message_impl(hb_buffer_t *this, hb_font_t *param_1, char *param_2, __va_list_tag *param_3) {
   int iVar1;
   long in_FS_OFFSET;
...
/* hb_buffer_t::_set_glyph_flags(unsigned int, unsigned int, unsigned int, bool, bool) */void hb_buffer_t::_set_glyph_flags(hb_buffer_t *this, uint param_1, uint param_2, uint param_3, bool param_4, bool param_5) {
 ...
 while ( param_2 < *(uint*)( this + 100 ) );
            ...
            if (uVar11 < param_3) {
               ...
               if (( (int)puVar1 - (int)puVar5 & 4U ) != 0) {
                  *puVar5 = *puVar5 | param_1;
                  puVar5 = puVar5 + 5;
                  if (puVar1 == puVar5) goto LAB_00103ce0;
               }
 ...
 while ( puVar1 != puVar5 );
         ...
         if (uVar13 == param_3) {
            local_44 = 0xffffffff;
            if (param_2 == uVar11) goto LAB_00103ce0;
            if (iVar2 != 2) goto LAB_00103e85;
            LAB_001040ef:uVar7 = (ulong)param_2;
            uVar8 = local_44;
            if (param_2 < uVar11) {
               puVar5 = (uint*)( lVar9 + 8 + uVar7 * 0x14 );
               puVar1 = (uint*)( lVar9 + 0x1c + ( ( ( uVar11 - param_2 ) - 1 ) + uVar7 ) * 0x14 );
               if (( (int)puVar1 - (int)puVar5 & 4U ) == 0) goto LAB_00104138;
               if (*puVar5 < local_44) {
                  uVar8 = *puVar5;
               }

               for (puVar5 = puVar5 + 5; puVar5 != puVar1; puVar5 = puVar5 + 10) {
                  LAB_00104138:if (*puVar5 < uVar8) {
                     uVar8 = *puVar5;
                  }
               ...
               if (param_2 != uVar11) goto LAB_0010415c;
            }
 else {
               LAB_0010415c:local_50 = uVar7 * 0x14;
               LAB_0010416d:if (param_2 < uVar11) {
 ...
 while ( puVar5 != (uint*)( lVar9 + 0x18 + ( ( ulong )(( uVar11 - param_2 ) - 1) + (ulong)param_2 ) * 0x14 ) );
            ...
            LAB_001041ad:if (param_3 == uVar13) goto LAB_00103ce0;
            LAB_001041b6:uVar10 = ( ulong )(param_3 - 1);
            uVar7 = (ulong)uVar13;
            LAB_001041bd:uVar11 = *(uint*)( lVar4 + 8 + uVar7 * 0x14 );
            uVar15 = *(uint*)( lVar4 + 8 + uVar10 * 0x14 );
            if (iVar2 != 2) goto LAB_00103f73;
            LAB_001041de:if (uVar13 < param_3) {
            ...
            if (iVar2 == 2) {
               if (uVar13 < param_3) {
                  ...
                  if (( (int)puVar1 - (int)puVar5 & 4U ) != 0) {
                     ...
                     puVar5 = puVar5 + 5;
                     if (puVar5 == puVar1) goto LAB_001040e2;
                  }
 ...
 while ( puVar5 != puVar1 );
               ...
               LAB_001040e2:uVar8 = local_44;
               if (param_2 != uVar11) goto LAB_001040ef;
               goto LAB_001041b6;
            }
            ...
            local_44 = uVar8;
            if (param_2 == uVar11) goto LAB_001041bd;
            LAB_00103e85:lVar12 = lVar9 + ( ulong )(uVar11 - 1) * 0x14;
            uVar7 = (ulong)param_2;
            uVar8 = *(uint*)( lVar12 + 8 );
            ...
            uVar8 = *puVar5;
            if (param_2 == uVar11) goto LAB_001041ad;
            local_50 = uVar7 * 0x14;
            ...
            if (uVar8 != uVar15) {
               if (uVar8 == uVar3) {
                  if (uVar8 == uVar15) goto LAB_0010402d;
                  if (param_2 < uVar11) {
                     puVar5 = (uint*)( lVar9 + 4 + local_50 );
                     do {
 ...
 while ( puVar5 != (uint*)( lVar9 + 0x18 + ( ( ( uVar11 - param_2 ) - 1 ) + uVar7 ) * 0x14 ) );
            ...
            LAB_0010402d:if (param_2 < uVar11) {
               do {
 ...
 while ( lVar12 != lVar9 + -0x14 + lVar14 + ( ulong )(( uVar11 - param_2 ) - 1) * -0x14 );
               LAB_00103f49:uVar13 = *(uint*)( this + 0x5c );
            }

            LAB_00103f4d:if (uVar13 == param_3) goto LAB_00103ce0;
            uVar10 = ( ulong )(param_3 - 1);
            uVar7 = (ulong)uVar13;
            uVar11 = *(uint*)( lVar4 + 8 + uVar7 * 0x14 );
            uVar15 = *(uint*)( lVar4 + 8 + uVar10 * 0x14 );
            LAB_00103f73:if (uVar11 != uVar8) {
               if (uVar15 != uVar8) goto LAB_001041de;
               if (uVar11 != uVar8) {
                  if (uVar13 < param_3) {
                     puVar5 = (uint*)( lVar4 + 4 + uVar7 * 0x14 );
                     do {
      ...
      if (!param_4) {
         if (param_2 < param_3) {
            ...
            if (( (int)puVar1 - (int)puVar5 & 4U ) != 0) {
               *puVar5 = *puVar5 | param_1;
               puVar5 = puVar5 + 5;
               if (puVar5 == puVar1) goto LAB_00103ce0;
            }
 ...
 while ( puVar5 != puVar1 );
      ...
      if (param_3 - param_2 < 2) goto LAB_00103ce0;
      *(uint*)( this + 0xc0 ) = *(uint*)( this + 0xc0 ) | 0x20;
   }
   ...
   if (param_2 != param_3) {
      if (*(int*)( this + 0x1c ) == 2) {
         if (param_2 < param_3) {
            ...
            uVar11 = 0xffffffff;
            if (( (int)puVar1 - (int)puVar5 & 4U ) == 0) goto LAB_00104280;
            uVar11 = 0xffffffff;
            if (*puVar5 != 0xffffffff) {
               uVar11 = *puVar5;
            }
 ...
 while ( lVar4 + -0x14 + lVar14 + ( ulong )(( param_3 - param_2 ) - 1) * -0x14 != lVar9 );
   ...
   LAB_00103ce0:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }

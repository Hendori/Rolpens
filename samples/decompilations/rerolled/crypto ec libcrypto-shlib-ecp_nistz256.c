               ...
               do {
                  ...
                  if (iVar23 < 0x21) {
                     ...
                     if (uVar19 < 8) {
                        ...
                        for (int i_578 = 0; i_578 < 8; i_578++) {
                           pbVar20[i_578] = 0;
                        }
                        pbVar28 = pbVar20 + ( (ulong)uVar19 - 8 );
                        for (int i_579 = 0; i_579 < 8; i_579++) {
                           pbVar28[i_579] = 0;
                        }

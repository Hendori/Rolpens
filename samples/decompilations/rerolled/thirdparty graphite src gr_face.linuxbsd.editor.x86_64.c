Face *gr_make_face_with_ops(void *param_1, gr_face_ops *param_2) {
   ...
   if (param_2 != (gr_face_ops*)0x0) {
      ...
      if (( ( ( local_50 != 0 ) && ( cVar1 = graphite2::Face::readGlyphs((uint)this) ),cVar1 != '\0' ) ) && ( local_50 != 0 )) {
   ...
   this(Face * 0x0);
   LAB_001000a3:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}void gr_make_face_with_seg_cache_and_ops(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined4 param_4) {
   gr_make_face_with_ops(param_1, param_2, param_4);
   return;
}void gr_make_face_with_seg_cache(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined4 param_4) {
   long in_FS_OFFSET;
   undefined8 local_28;
   undefined8 local_20;
   undefined8 local_18;
   ...
   if (*(ushort*)( param_1 + 8 ) != 0) {
      ...
      uVar3 = 0;
      do {
         if (( ( *(byte*)( lVar2 + 0x21 ) & 8 ) == 0 ) && ( bVar4 = param_2 == uVar3 ),uVar3 = uVar3 + 1,bVar4) {
            return lVar2;
         }
         lVar2 = lVar2 + 0x28;
   ...
   if (param_1 != (long*)0x0) {
      for (int i_1005 = 0; i_1005 < 2; i_1005++) {

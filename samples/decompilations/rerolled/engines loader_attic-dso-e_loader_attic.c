...
long try_decode_PrivateKey(char *param_1, undefined8 param_2, uchar *param_3, long param_4, undefined8 param_5, int *param_6) {
   int iVar1;
   int iVar2;
   size_t sVar3;
            ...
            if (pEVar6 != (ENGINE_PKEY_ASN1_METHS_PTR)0x0) {
               ...
               if (0 < iVar1) {
                  ...
                  do {
                     ...
                     if (( ( iVar2 != 0 ) && ( iVar2 = EVP_PKEY_asn1_get0_info(&local_60, (int*)0x0, (int*)local_5c, (char**)0x0, (char**)0x0, local_50) ),iVar2 != 0 )) {
                        ERR_set_mark();
                        pEVar7 = (EVP_PKEY*)d2i_PrivateKey_ex(local_60, 0, &local_48, param_4, in_stack_00000020, in_stack_00000028);
 ...
 while ( e != (ENGINE*)0x0 );
      ...
      for (iVar1 = 0; iVar2 = EVP_PKEY_asn1_get_count(),iVar1 < iVar2; iVar1 = iVar1 + 1) {
         ...
         iVar2 = EVP_PKEY_asn1_get0_info((int*)&local_58, (int*)0x0, (int*)&local_50, (char**)0x0, (char**)0x0, pEVar4);
         if (( iVar2 != 0 ) && ( ( (ulong)local_50 & 1 ) == 0 )) {
            ERR_set_mark();
            pEVar7 = (EVP_PKEY*)d2i_PrivateKey_ex((ulong)local_58 & 0xffffffff, 0, &local_48, param_4, in_stack_00000020, in_stack_00000028);
            if (pEVar7 != (EVP_PKEY*)0x0) {
               if (local_80 != (EVP_PKEY*)0x0) {
                  EVP_PKEY_free(pEVar7);
                  pEVar7 = local_80;
      ...
      LAB_001001a8:if (local_80 != (EVP_PKEY*)0x0) {
      ...
      if (iVar1 == 0) {
         ...
         *param_6 = 1;
         ...
         if (0xc < (int)sVar3) {
            ...
            if (( ( param_1[lVar5] == ' ' ) && ( iVar1 = strcmp(param_1 + lVar5 + 1, "PRIVATE KEY") ),iVar1 == 0 )) &&( ( pEVar4 = EVP_PKEY_asn1_find_str((ENGINE**)0x0, param_1, (int)lVar5) ),pEVar4 != (EVP_PKEY_ASN1_METHOD*)0x0 && ( iVar1 = EVP_PKEY_asn1_get0_info((int*)&local_48, (int*)0x0, (int*)0x0, (char**)0x0, (char**)0x0, pEVar4) ),iVar1 != 0 ) * param_6 = 1;
            local_80 = (EVP_PKEY*)d2i_PrivateKey_ex((ulong)local_48 & 0xffffffff, 0, local_70, param_4, in_stack_00000020, in_stack_00000028);
            goto LAB_001001a8;
         }
...
lVar5 = 0;LAB_001001be:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return lVar5;}undefined8 try_decode_PUBKEY(char *param_1, undefined8 param_2, uchar *param_3, long param_4, undefined8 param_5, undefined4 *param_6) {
   int iVar1;
   EVP_PKEY *pEVar2;
   undefined8 uVar3;
   uchar *local_20[2];
...
long try_decode_X509CRL(char *param_1, undefined8 param_2, uchar *param_3, long param_4, undefined8 param_5, undefined4 *param_6) {
   int iVar1;
   X509_CRL *a;
   long lVar2;
   uchar *local_20[2];
...
long try_decode_X509Certificate(char *param_1, undefined8 param_2, uchar *param_3, long param_4, undefined8 param_5, undefined4 *param_6) {
   int iVar1;
   int iVar2;
   X509 *pXVar3;
   long lVar4;
   ...
   if (param_1 == (char*)0x0) {
      iVar1 = 1;
      LAB_001005c9:local_48 = (X509*)X509_new_ex(in_stack_00000020, in_stack_00000028);
   ...
   lVar4 = 0;
   LAB_00100619:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return lVar4;
   }
...
ulong file_eof(long param_1) {
   ...
   if (( *(long*)( param_1 + 0x20 ) != 0 ) && ( uVar1 = ( **(code**)( *(long*)( param_1 + 0x20 ) + 0x10 ) )(*(undefined8*)( param_1 + 0x28 )) ),(int)uVar1 == 0) {
      return uVar1;
   }
...
long try_decode_params(char *param_1, undefined8 param_2, ulong param_3, undefined8 param_4, undefined8 param_5, int *param_6) {
   int iVar1;
   int iVar2;
   size_t sVar3;
   EVP_PKEY_ASN1_METHOD *pEVar4;
   ...
   if (param_1 == (char*)0x0) {
      ...
      for (iVar1 = 0; iVar2 = EVP_PKEY_asn1_get_count(),iVar1 < iVar2; iVar1 = iVar1 + 1) {
         local_38 = local_50[0];
         pEVar4 = EVP_PKEY_asn1_get0(iVar1);
         iVar2 = EVP_PKEY_asn1_get0_info(&local_40, (int*)0x0, (int*)local_3c, (char**)0x0, (char**)0x0, pEVar4);
      ...
      if (*param_6 < 2) {
         LAB_001009e2:if (pkey != (EVP_PKEY*)0x0) {
      ...
      if (0xb < (int)sVar3) {
         ...
         if (( ( ( param_1[lVar5] == ' ' ) && ( iVar1 = strcmp(param_1 + lVar5 + 1, "PARAMETERS") ),iVar1 == 0 ) ) && ( pEVar4 = EVP_PKEY_asn1_find_str((ENGINE**)0x0, param_1, (int)lVar5) ),pEVar4 != (EVP_PKEY_ASN1_METHOD*)0x0) {
            *param_6 = 1;
   ...
   lVar5 = 0;
   LAB_001009fc:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 *file_attach(undefined8 param_1, undefined8 param_2, undefined8 param_3, char *param_4) {
   ...
   *(uint*)( ptr + 2 ) = *(uint*)( ptr + 2 ) | 2;
   ...
   CRYPTO_free((void*)*ptr);
   iVar1 = *(int*)( ptr + 1 );
   joined_r0x00100c7d:if (( iVar1 != 2 ) && ( ptr[4] != 0 )) {
...
char *file_get_pass(UI_METHOD *param_1, char *param_2, int param_3, char *param_4, char *param_5, void *param_6) {
   int iVar1;
   UI *ui;
   char *prompt;
   ui = UI_new();
   ...
   param_2 = (char*)0x0;
   LAB_00101048:CRYPTO_free(prompt);
   UI_free(ui);
   return param_2;
}
...
undefined8 try_decode_PKCS12(long param_1, undefined8 param_2, uchar *param_3, long param_4, long *param_5, undefined4 *param_6, undefined8 param_7, undefined8 param_8, undefined8 param_9) {
   bool bVar1;
   int iVar2;
   undefined8 uVar3;
   PKCS12 *p12;
   ...
   if (lVar5 == 0) {
      ...
      *param_6 = 1;
      ...
      __s = "";
      LAB_00101324:iVar2 = PKCS12_parse(p12, __s, &local_460, &local_458, &local_450);
      if (iVar2 == 0) {
         PKCS12_free(p12);
         goto LAB_001012a3;
      }
      ...
      if (lVar5 == 0) {
         ...
         if (local_460 == (EVP_PKEY*)0x0) {
            LAB_00101448:if (local_458 != (X509*)0x0) {
 ...
 while ( ( lVar6 != 0 ) && ( iVar2 = iVar2 != 0 ) );
            bVar1 = false;
            LAB_001014e7:lVar7 = 0;
            EVP_PKEY_free(local_460);
            X509_free(local_458);
            OSSL_STACK_OF_X509_free(local_450);
            OSSL_STORE_INFO_free(0);
            ...
            lVar7 = 0;
            LAB_001015fa:EVP_PKEY_free(local_460);
            X509_free(local_458);
            OSSL_STACK_OF_X509_free(local_450);
            if (( lVar6 != 0 ) && ( puVar9 = (undefined8*)OSSL_STORE_INFO_get0_data(0xffffffff, lVar6) ),puVar9 != (undefined8*)0x0) {
         ...
         LAB_00101510:OSSL_STORE_INFO_free(lVar7);
         if (( puVar9 != (undefined8*)0x0 ) && ( puVar10 = (undefined8*)OSSL_STORE_INFO_get0_data(0xffffffff, puVar9) ),puVar10 != (undefined8*)0x0) {
            BUF_MEM_free((BUF_MEM*)*puVar10);
            CRYPTO_free((void*)puVar10[1]);
            CRYPTO_free(puVar10);
         }
...
long try_decode_PKCS8Encrypted(char *param_1, undefined8 param_2, uchar *param_3, long param_4, undefined8 param_5, undefined4 *param_6, undefined8 param_7, undefined8 param_8, undefined8 param_9) {
   int *piVar1;
   int iVar2;
   X509_SIG *a;
   BUF_MEM *a_00;
   ...
   local_460 = param_3;
   if (param_1 == (char*)0x0) {
      LAB_001017d3:a = d2i_X509_SIG((X509_SIG**)0x0, &local_460, param_4);
      if (a != (X509_SIG*)0x0) {
         *param_6 = 1;
         a_00 = BUF_MEM_new();
         if (a_00 == (BUF_MEM*)0x0) {
            ...
            pcVar3 = (char*)file_get_pass(param_7, local_438, 0x400, "PKCS8 decrypt pass phrase", param_9, param_8);
            if (pcVar3 == (char*)0x0) {
               if (lib_code == 0) {
                  lib_code = ERR_get_next_error_library();
               }
               ...
               piVar1 = local_448;
               sVar4 = strlen(pcVar3);
               puVar5 = PKCS12_pbe_crypt(local_450, pcVar3, (int)sVar4, *(uchar**)( piVar1 + 2 ), *piVar1, &local_440, &local_454, 0);
               if (puVar5 != (uchar*)0x0) {
   ...
   lVar7 = 0;
   LAB_001018fe:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 *file_open_ex(undefined8 param_1, char *param_2, undefined8 param_3, char *param_4) {
   ...
   lVar2 = 0;
   do {
      if (( ( local_f0[lVar2 * 0x10] & 1 ) != 0 ) && ( pcVar4 = *(char**)( local_f0 + lVar2 * 0x10 + -8 ) * pcVar4 != '/' )) {
         if (lib_code == 0) {
            lib_code = ERR_get_next_error_library();
         }
      ...
      if (-1 < iVar1) {
         ...
         if (ptr != (undefined8*)0x0) {
            ...
            *ptr = pcVar3;
            if (pcVar3 != (char*)0x0) {
               if (( local_d8.st_mode & 0xf000 ) == 0x4000) {
                  ...
                  *(int*)( ptr + 7 ) = iVar1;
                  ...
                  LAB_00101ca8:if (param_4 != (char*)0x0) {
            ...
            LAB_00101e6c:CRYPTO_free((void*)ptr[10]);
            CRYPTO_free((void*)*ptr);
 ...
 while ( lVar2 != local_110 );
   puVar6 = (undefined8*)0x0;
   LAB_00101cd8:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return puVar6;
   }
...
long file_load(undefined8 *param_1, size_t *param_2, undefined8 param_3) {
   ...
   *(undefined4*)( (long)param_1 + 0xc ) = 0;
   if (*(int*)( param_1 + 1 ) == 2) {
      LAB_00102b86:pcVar20 = (char*)param_1[6];
      if (pcVar20 != (char*)0x0) {
         do {
            if (*pcVar20 != '.') {
               sVar12 = strlen((char*)( (long)param_1 + 0x24 ));
               if (*(char*)( (long)param_1 + 0x24 ) == '\0') {
                  LAB_00102c36:__s = (char*)*param_1;
                  sVar12 = strlen(__s);
               ...
               if (( ( ( *(int*)( param_1 + 8 ) - 5U < 2 ) || ( *(int*)( param_1 + 8 ) == 0 ) ) && ( iVar5 = OPENSSL_strncasecmp(pcVar20, (char*)( (long)param_1 + 0x24 ), sVar12) ),iVar5 == 0 )) {
                  ...
                  if (bVar2 == 0x72) {
                     ...
                     LAB_00102c07:ppuVar15 = __ctype_b_loc();
 ...
 while ( ( *(byte*)( (long)*ppuVar15 + ( ulong ) * pbVar1 * 2 + 1 ) & 8 ) != 0 );
            ...
            *(int*)( param_1 + 7 ) = iVar5;
            ...
            if (*(int*)( param_1 + 1 ) == 2) {
               ...
               if (( param_1[4] != 0 ) && ( iVar5 = ( **(code**)( param_1[4] + 0x10 ) )(param_1[5]) ),iVar5 == 0) goto LAB_00102b86;
 ...
 while ( true );
      ...
      LAB_00102dfb:lVar8 = 0;
      LAB_0010203a:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return lVar8;
      }
   ...
   do {
      ...
      if (param_1[4] != 0) {
         lVar8 = ( **(code**)( param_1[4] + 8 ) )(0, 0, 0, 0, param_1 + 5, &local_98, param_2, param_3, *param_1, param_1[9], param_1[10]);
         if (lVar8 != 0) goto LAB_0010203a;
         ( **(code**)( param_1[4] + 0x18 ) )(param_1 + 5);
         *(undefined1(*) [16])( param_1 + 4 ) = (undefined1[16])0x0;
      }
      ...
      do {
         ...
         if (*(int*)( param_1 + 1 ) == 1) {
            ...
            LAB_00102924:*(int*)( (long)param_1 + 0xc ) = *(int*)( (long)param_1 + 0xc ) + 1;
            iVar5 = -1;
         }
 else {
            local_cc = -1;
            ...
            if (( lVar8 < 1 ) || ( iVar5 = ossl_do_blob_header(&local_98, 0x10, &local_c8, &local_c4, &local_a0, &local_cc) ),iVar5 < 1) {
               iVar5 = 0;
               iVar6 = -1;
            }
 else {
               if (local_cc != 0) {
                  ...
                  LAB_00102256:lVar8 = OSSL_STORE_INFO_new_PKEY(pEVar10);
            ...
            if (( 0 < lVar8 ) && ( iVar7 = ossl_do_PVK_header(&local_98, 0x18, 0, &local_a0, &local_c8, &local_c4) ),iVar7 != 0) {
               local_88 = "PVK pass phrase";
               local_98 = param_2;
               local_90 = param_3;
               local_80 = uVar4;
               pEVar10 = b2i_PVK_bio(pBVar3, file_get_pem_pass, &local_98);
               if (( pEVar10 != (EVP_PKEY*)0x0 ) && ( lVar8 = lVar8 != 0 )) goto LAB_00102275;
               EVP_PKEY_free(pEVar10);
               iVar6 = iVar5;
            }
            ...
            if (iVar6 < 0) {
               *(int*)( (long)param_1 + 0xc ) = *(int*)( (long)param_1 + 0xc ) + 1;
               ...
               local_120 = local_b8;
               LAB_001023cc:local_e8 = (char*)0x0;
               ...
               while (true) {
                  ...
                  do {
                     ...
                     local_98 = (size_t*)0x0;
                     ERR_set_mark();
                     lVar9 = ( **(code**)( puVar21 + 8 ) )(local_140, local_120, local_138, local_130, &local_98, &local_c4, param_2, param_3, *param_1, param_1[9], param_1[10]);
                     uVar13 = ERR_peek_last_error();
                     if (( ( ( uVar13 & 0x80000000 ) == 0 ) && ( (char)( uVar13 >> 0x17 ) == '\r' ) ) && ( ( (uint)uVar13 & 0x7fffff ) == 0x8010a )) {
                        ERR_pop_to_mark();
                     }
 else {
                        ERR_clear_last_mark();
                     ...
                     if (0 < local_c4) {
                        ...
                        local_a0 = local_98;
                        if (1 < iVar5) {
                           if (( lVar8 != 0 ) && ( puVar11 = (undefined8*)OSSL_STORE_INFO_get0_data(0xffffffff, lVar8) ),puVar11 != (undefined8*)0x0) {
                           ...
                           if (( lVar9 != 0 ) && ( puVar11 = (undefined8*)OSSL_STORE_INFO_get0_data(0xffffffff, lVar9) ),puVar11 != (undefined8*)0x0) {
                              BUF_MEM_free((BUF_MEM*)*puVar11);
                              CRYPTO_free((void*)puVar11[1]);
                              CRYPTO_free(puVar11);
                           }
                        ...
                        if (( lVar8 == 0 ) && ( lVar8 = lVar9 == 0 )) goto LAB_00102635;
                     }
...
;
               CRYPTO_free(local_e8);
               BUF_MEM_free(local_e0);
               LAB_00102668:if (local_c0 == (char*)0x0) {
         ...
         if (*(int*)( param_1 + 1 ) == 2) {
            iVar5 = *(int*)( param_1 + 4 );
            LAB_00102141:if (iVar5 != 0) break;
         }
 else if (( param_1[4] == 0 ) || ( iVar5 = ( **(code**)( param_1[4] + 0x10 ) )(param_1[5]) ),iVar5 != 0) {
 ...
 while ( *(int*)( (long)param_1 + 0xc ) < 1 );
      ...
      iVar5 = *(int*)( param_1 + 8 );
      if (( iVar5 == 0 ) || ( iVar6 = iVar5 == iVar6 )) goto LAB_0010203a;
...
undefined8 bind_engine(ENGINE *param_1, char *param_2, long *param_3) {
   ...
   if (( param_2 == (char*)0x0 ) || ( iVar1 = iVar1 == 0 )) {
      ...
      if (( ( ( ( ( ( loader_attic != 0 ) && ( iVar1 = OSSL_STORE_LOADER_set_open_ex(loader_attic, file_open_ex) ),iVar1 != 0 ) ) && ( iVar1 = OSSL_STORE_LOADER_set_open(loader_attic, file_open) ),iVar1 != 0 ) ) && ( ( iVar1 = OSSL_STORE_LOADER_set_attach(loader_attic, file_attach) ),iVar1 != 0 && ( iVar1 = OSSL_STORE_LOADER_set_ctrl(loader_attic, file_ctrl) ),iVar1 != 0 ) )) ( ( iVar1 = OSSL_STORE_LOADER_set_expect(loader_attic, 0x100000) ),iVar1 != 0 && ( ( iVar1 = OSSL_STORE_LOADER_set_find(loader_attic, file_find) ),iVar1 != 0 && ( iVar1 = OSSL_STORE_LOADER_set_load(loader_attic, file_load) ),iVar1 != 0 ) ) && ( iVar1 = iVar1 != 0 ) && ( ( ( ( iVar1 = OSSL_STORE_LOADER_set_error(loader_attic, file_error) ),iVar1 != 0 && ( iVar1 = OSSL_STORE_LOADER_set_close(loader_attic, file_close) ),iVar1 != 0 ) ) && ( iVar1 = iVar1 != 0 ) ) && ( ( ( iVar1 = ENGINE_set_name(param_1, "\'file:\' loader") ),iVar1 != 0 && ( iVar1 = ENGINE_set_destroy_function(param_1, loader_attic_destroy) ),iVar1 != 0 ) ) && ( ( iVar1 = ENGINE_set_init_function(param_1, loader_attic_init) ),iVar1 != 0 && ( ( iVar1 = ENGINE_set_finish_function(param_1, loader_attic_finish) ),iVar1 != 0 && ( iVar1 = OSSL_STORE_register_loader(loader_attic) ),iVar1 != 0 ) );
   }

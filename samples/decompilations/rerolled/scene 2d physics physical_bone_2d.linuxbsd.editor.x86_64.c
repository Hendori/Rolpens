/* PhysicalBone2D::get_joint() const */

undefined8 __thiscall PhysicalBone2D::get_joint(PhysicalBone2D *this)
...
/* PhysicalBone2D::get_auto_configure_joint() const */

PhysicalBone2D __thiscall PhysicalBone2D::get_auto_configure_joint(PhysicalBone2D *this)
...
/* PhysicalBone2D::get_simulate_physics() const */

PhysicalBone2D __thiscall PhysicalBone2D::get_simulate_physics(PhysicalBone2D *this)
...
/* PhysicalBone2D::is_simulating_physics() const */

PhysicalBone2D __thiscall PhysicalBone2D::is_simulating_physics(PhysicalBone2D *this)
...
/* PhysicalBone2D::get_bone2d_index() const */

undefined4 __thiscall PhysicalBone2D::get_bone2d_index(PhysicalBone2D *this)
...
/* PhysicalBone2D::get_follow_bone_when_simulating() const */

PhysicalBone2D __thiscall PhysicalBone2D::get_follow_bone_when_simulating(PhysicalBone2D *this)
...
/* PhysicalBone2D::set_bone2d_nodepath(NodePath const&) */

void __thiscall PhysicalBone2D::set_bone2d_nodepath(PhysicalBone2D *this,NodePath *param_1)
...
/* PhysicalBone2D::get_bone2d_nodepath() const */

void PhysicalBone2D::get_bone2d_nodepath(void)
...
void __thiscall PhysicalBone2D::~PhysicalBone2D(PhysicalBone2D *this)
...
/* PhysicalBone2D::set_bone2d_index(int) */

void __thiscall PhysicalBone2D::set_bone2d_index(PhysicalBone2D *this,int param_1)

{
  ...
  if (param_1 < 0) {
    _err_print_error("set_bone2d_index","scene/2d/physics/physical_bone_2d.cpp",0xe5,
    ...
    if (((byte)this[0x2fa] & 0x40) != 0) {
      if (*(long *)(this + 0x6d0) == 0) {
        _err_print_error("set_bone2d_index","scene/2d/physics/physical_bone_2d.cpp",0xf2,
                         "Cannot verify bone index...",0,1);
        *(int *)(this + 0x6d8) = param_1;
        ...
        if (iVar1 <= param_1) {
          ...
          _err_print_index_error
                    ("set_bone2d_index","scene/2d/physics/physical_bone_2d.cpp",0xed,(long)param_1,
                     (long)iVar1,"p_bone_idx","parent_skeleton->get_bone_count()",
...
/* PhysicalBone2D::_auto_configure_joint() [clone .part.0] */

void __thiscall PhysicalBone2D::_auto_configure_joint(PhysicalBone2D *this)

{
  ...
  _err_print_error("_auto_configure_joint","scene/2d/physics/physical_bone_2d.cpp",0x8e,
                   "Cannot setup joint without a parent PhysicalBone2D node.",0,1);
LAB_00100363:
...
/* PhysicalBone2D::set_auto_configure_joint(bool) */

void __thiscall PhysicalBone2D::set_auto_configure_joint(PhysicalBone2D *this,bool param_1)
...
/* PhysicalBone2D::_find_skeleton_parent() */

void __thiscall PhysicalBone2D::_find_skeleton_parent(PhysicalBone2D *this)
...
/* PhysicalBone2D::_find_joint_child() */

void __thiscall PhysicalBone2D::_find_joint_child(PhysicalBone2D *this)
...
/* PhysicalBone2D::_auto_configure_joint() */
...
/* PhysicalBone2D::_position_at_bone2d() */

void __thiscall PhysicalBone2D::_position_at_bone2d(PhysicalBone2D *this)

{
  ...
  if (*(long *)(this + 0x6d0) != 0) {
    ...
    if (plVar1 == (long *)0x0) {
      ...
      itos((long)local_70);
      operator+((char *)local_68,"It\'s not possible to position the bone with ID: ");
      String::operator+((String *)&local_58,local_68);
      _err_print_error("_position_at_bone2d","scene/2d/physics/physical_bone_2d.cpp",0x4a,
                       "Parameter \"bone_to_use\" is null.",(String *)&local_58,0,0);
...
/* PhysicalBone2D::_start_physics_simulation() [clone .part.0] */

void __thiscall PhysicalBone2D::_start_physics_simulation(PhysicalBone2D *this)
...
/* PhysicalBone2D::_start_physics_simulation() */
...
/* PhysicalBone2D::_stop_physics_simulation() [clone .part.0] */

void __thiscall PhysicalBone2D::_stop_physics_simulation(PhysicalBone2D *this)
...
/* PhysicalBone2D::_stop_physics_simulation() */
...
/* PhysicalBone2D::set_simulate_physics(bool) */

void __thiscall PhysicalBone2D::set_simulate_physics(PhysicalBone2D *this,bool param_1)
...
/* PhysicalBone2D::set_follow_bone_when_simulating(bool) */

void __thiscall PhysicalBone2D::set_follow_bone_when_simulating(PhysicalBone2D *this,bool param_1)
...
/* PhysicalBone2D::_notification(int) */

void __thiscall PhysicalBone2D::_notification(PhysicalBone2D *this,int param_1)
...
/* PhysicalBone2D::_bind_methods() */

void PhysicalBone2D::_bind_methods(void)

{
  ...
  PropertyInfo::PropertyInfo
            ((PropertyInfo *)&local_98,2,(String *)&local_c8,1,(String *)&local_c0,6,&local_b8);
  local_d0 = 0;
  String::parse_latin1((String *)&local_d0,"PhysicalBone2D");
  StringName::StringName((StringName *)&local_a0,(String *)&local_d0,false);
  ClassDB::add_property
...
/* PhysicalBone2D::get_configuration_warnings() const */

void PhysicalBone2D::get_configuration_warnings(void)

{
  ...
  if (*(long *)(in_RSI + 0x6d0) == 0) {
    ...
    local_48 = 
    "A PhysicalBone2D only works with a Skeleton2D or another PhysicalBone2D as a parent node!";
    local_58 = 0;
    local_40 = 0x59;
  ...
  if (*(int *)(in_RSI + 0x6d8) < 0) {
    ...
    String::parse_latin1((StrRange *)&local_50);
    local_48 = 
    "A PhysicalBone2D needs to be assigned to a Bone2D node in order to function! Please set a Bone2D node in the inspector."
    ;
    local_58 = 0;
    local_40 = 0x77;
    String::parse_latin1((StrRange *)&local_58);
  ...
  lVar1 = *(long *)(in_RSI + 0x6f0);
joined_r0x001024fd:
  if (((lVar1 == 0) && (lVar1 = Node::get_parent(), lVar1 != 0)) &&
     (lVar1 = __dynamic_cast(lVar1,&Object::typeinfo,&typeinfo,0), lVar1 != 0)) {
    local_50 = 0;
    String::parse_latin1((String *)&local_50,"");
    local_58 = 0;
    String::parse_latin1
              ((String *)&local_58,
               "A PhysicalBone2D node should have a Joint2D-based child node to keep bones connected! Please add a Joint2D-based node as a child to this node!"
              );
    RTR((String *)&local_48,(String *)&local_58);
    Vector<String>::push_back();
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_48);
...
/* PhysicalBone2D::_property_can_revertv(StringName const&) const */

undefined8 PhysicalBone2D::_property_can_revertv(StringName *param_1)
...
/* PhysicalBone2D::_property_get_revertv(StringName const&, Variant&) const */

undefined8 PhysicalBone2D::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* MethodBindTRC<Joint2D*>::_gen_argument_type(int) const */

undefined8 MethodBindTRC<Joint2D*>::_gen_argument_type(int param_1)
...
/* MethodBindTRC<Joint2D*>::get_argument_meta(int) const */

undefined8 MethodBindTRC<Joint2D*>::get_argument_meta(int param_1)
...
/* MethodBindTRC<Joint2D*>::~MethodBindTRC() */

void __thiscall MethodBindTRC<Joint2D*>::~MethodBindTRC(MethodBindTRC<Joint2D*> *this)
...
/* PhysicalBone2D::_getv(StringName const&, Variant&) const */

undefined8 PhysicalBone2D::_getv(StringName *param_1,Variant *param_2)
...
/* PhysicalBone2D::_setv(StringName const&, Variant const&) */

undefined8 PhysicalBone2D::_setv(StringName *param_1,Variant *param_2)
...
/* PhysicalBone2D::_validate_propertyv(PropertyInfo&) const */

void PhysicalBone2D::_validate_propertyv(PropertyInfo *param_1)
...
/* PhysicalBone2D::is_class_ptr(void*) const */

ulong PhysicalBone2D::is_class_ptr(void *param_1)

{
  undefined4 in_EDX;
  undefined4 *in_RSI;
  
  if (in_RSI == &RigidBody2D::get_class_ptr_static()::ptr || in_RSI == &get_class_ptr_static()::ptr)
  {
    return CONCAT71(0x10ac,in_RSI == &RigidBody2D::get_class_ptr_static()::ptr ||
                           in_RSI == &get_class_ptr_static()::ptr);
  }
  return (ulong)((uint)CONCAT71(0x10ac,in_RSI == &CollisionObject2D::get_class_ptr_static()::ptr) |
                 (uint)CONCAT71(0x10ac,in_RSI == &PhysicsBody2D::get_class_ptr_static()::ptr) |
                 (uint)CONCAT71(0x10ac,in_RSI == &Node2D::get_class_ptr_static()::ptr) |
...
/* RigidBody2D::_notificationv(int, bool) [clone .part.0] */

void RigidBody2D::_notificationv(int param_1,bool param_2)

{
  ...
  CanvasItem::_notification(param_1);
  Node::_notification(param_1);
  return;
}



/* PhysicalBone2D::_get_class_namev() const */

undefined8 * PhysicalBone2D::_get_class_namev(void)
...
LAB_001032a3:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"PhysicalBone2D");
      goto LAB_0010330e;
    }
  }
  StringName::assign_static_unique_class_name
...
/* MethodBindTRC<Joint2D*>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTRC<Joint2D*>::_gen_argument_type_info(int param_1)
...
/* PhysicalBone2D::get_class() const */

void PhysicalBone2D::get_class(void)
...
/* PhysicalBone2D::_notificationv(int, bool) */

void __thiscall PhysicalBone2D::_notificationv(PhysicalBone2D *this,int param_1,bool param_2)
...
/* PhysicalBone2D::is_class(String const&) const */

undefined8 __thiscall PhysicalBone2D::is_class(PhysicalBone2D *this,String *param_1)
...
/* PhysicalBone2D::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void __thiscall PhysicalBone2D::_get_property_listv(PhysicalBone2D *this,List *param_1,bool param_2)
...
/* MethodBind* create_method_bind<PhysicalBone2D, Joint2D*>(Joint2D* (PhysicalBone2D::*)() const) */

MethodBind * create_method_bind<PhysicalBone2D,Joint2D*>(_func_Joint2D_ptr *param_1)
...
/* MethodBind* create_method_bind<PhysicalBone2D, bool>(bool (PhysicalBone2D::*)() const) */

MethodBind * create_method_bind<PhysicalBone2D,bool>(_func_bool *param_1)
...
/* MethodBind* create_method_bind<PhysicalBone2D, bool>(void (PhysicalBone2D::*)(bool)) */

MethodBind * create_method_bind<PhysicalBone2D,bool>(_func_void_bool *param_1)
...
MethodBind * create_method_bind<PhysicalBone2D,NodePath_const&>(_func_void_NodePath_ptr *param_1)
...
/* MethodBind* create_method_bind<PhysicalBone2D, NodePath>(NodePath (PhysicalBone2D::*)() const) */

MethodBind * create_method_bind<PhysicalBone2D,NodePath>(_func_NodePath *param_1)
...
/* MethodBind* create_method_bind<PhysicalBone2D, int>(void (PhysicalBone2D::*)(int)) */

MethodBind * create_method_bind<PhysicalBone2D,int>(_func_void_int *param_1)
...
/* MethodBind* create_method_bind<PhysicalBone2D, int>(int (PhysicalBone2D::*)() const) */

MethodBind * create_method_bind<PhysicalBone2D,int>(_func_int *param_1)
...
/* PhysicalBone2D::_bind_methods() [clone .cold] */
...
/* PhysicalBone2D::_initialize_classv() */

void PhysicalBone2D::_initialize_classv(void)

{
  ...
  if (initialize_class()::initialized == '\0') {
    if (RigidBody2D::initialize_class()::initialized == '\0') {
      ...
      RigidBody2D::initialize_class()::initialized = '\x01';
    }
    local_58 = "RigidBody2D";
    local_68 = 0;
    local_50 = 0xb;
...
/* MethodBindTRC<Joint2D*>::call(Object*, Variant const**, int, Callable::CallError&) const */

Object * MethodBindTRC<Joint2D*>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
/* MethodBindTRC<Joint2D*>::validated_call(Object*, Variant const**, Variant*) const */

void __thiscall
MethodBindTRC<Joint2D*>::validated_call
          (MethodBindTRC<Joint2D*> *this,Object *param_1,Variant **param_2,Variant *param_3)
...
/* MethodBindTRC<Joint2D*>::ptrcall(Object*, void const**, void*) const */

void __thiscall
MethodBindTRC<Joint2D*>::ptrcall
          (MethodBindTRC<Joint2D*> *this,Object *param_1,void **param_2,void *param_3)

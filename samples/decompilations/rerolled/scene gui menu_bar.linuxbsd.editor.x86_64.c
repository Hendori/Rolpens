            ...
            if (*(char*)( lVar9 + 0x19 + lVar1 ) == '\0') {
                  ...
                  if (iVar8 == param_1) {
                     ...
                     if (cVar6 == '\0') {
                        ...
                        iVar8 = __cxa_guard_acquire(&_draw_menu_item(int)::{lambda()#2}::operator()()::
                                               sname);
                  if (iVar8 != 0){_scs_create((char *)&_draw_menu_item(int)::{lambda()#2}::operator()()::sname,
                                true);
              ...
              if (cVar6 != '\0') {
                ...
                uStack_70 = *(undefined8 *)(this + 0xaf0);
                           ...
                           LAB_00102b42:if (iVar2 == param_1) {
                              if (cVar6 == '\0') {
                                 LAB_00102ef9:Ref<StyleBox>::operator =((Ref<StyleBox>*)&local_98, *(Ref**)( this + 0xa68 ));
                              }
 else {
                                 local_88 = 0;
                                 if (_draw_menu_item(int)::{lambda()
                                 ...
                                 iVar8 = __cxa_guard_acquire(&_draw_menu_item(int)::{lambda()#6}::operator()()::
                                                 sname);
                    if (iVar8 != 0){_scs_create((char *)&_draw_menu_item(int)::{lambda()#6}::operator()()::sname,
                                  true);
                      __cxa_atexit(StringName::~StringName,
                                   &_draw_menu_item(int)::{lambda()#6}::operator()()::sname,
                                   &__dso_handle);__cxa_guard_release(&_draw_menu_item(int)::{lambda()#6}, ::operator()(), ::sname);}}((StringName*)this, (StringName*)&_draw_menu_item(int)::{lambda()#6}, ::operator()(), ::sname)(cVar6 == '\0')(( StringName::configured != '\0' ) && ( local_88 != 0 )), {
                      StringName::unref());
                              }
...
, pOVar12 = local_98;
               ...
               if (cVar6 == '\0') {
                  ...
                  iVar8 = __cxa_guard_acquire(&_draw_menu_item(int)::{lambda()#7}::operator()()::
                                                 sname);
                    if (iVar8 != 0){_scs_create((char *)&_draw_menu_item(int)::{lambda()#7}::operator()()::sname,
                                  true);
                      __cxa_atexit(StringName::~StringName,
...
LAB_00102d99:
              ...
              local_88 = 0;
              if (_draw_menu_item(int)::{lambda()#4iVar8 = __cxa_guard_acquire(&_draw_menu_item(int)::{lambda()#4);if (iVar8 != 0) {
   _scs_create((char *)&_draw_menu_item(int)::{lambda()
   #4
   ;;
   __cxa_atexit(StringName::~StringName,
...
cVar6 = Control::has_theme_color
                              ((StringName *)this,
                               (StringName *)
                               &_draw_menu_item(int)::{lambda()#5if (( StringName::configured != '\0' ) && ( local_88 != 0 )) {
   StringName::unref();
}
pOVar12 = local_98;if (cVar6 == '\0') {
   local_78 = *(undefined8*)( this + 0xaa8 );
   uStack_70 = *(undefined8*)( this + 0xab0 );
}
 else {
   ...
   if (cVar6 == '\0') {
      LAB_001029f3:Ref<StyleBox>::operator =((Ref<StyleBox>*)&local_98, *(Ref**)( this + 0xa48 ));
   }
 else {
      local_88 = 0;
      if (_draw_menu_item(int)::{lambda()
...
pOVar12 = local_98;if (this[0x9f3] == (MenuBar)0x0) {
   ( **(code**)( *(long*)local_98 + 0x1d8 ) )(local_98, uVar3, local_68);
}
local_78 = *(undefined8*)( this + 0xab8 );uStack_70 = *(undefined8*)( this + 0xac0 );}fVar13 = (float)StyleBox::get_margin(pOVar12, 1);fVar14 = (float)StyleBox::get_margin(pOVar12, 0);local_58 = *(undefined8*)( this + 0xa98 );uStack_50 = *(undefined8*)( this + 0xaa0 );lVar9 = *(long*)( this + 0xa10 );local_80 = CONCAT44(local_68._4_4_ + fVar13, local_68._0_4_ + fVar14);if (( 0 < *(int*)( this + 0xa94 ) ) && ( uStack_50._4_4_ = (float)( (ulong)uStack_50 >> 0x20 ) ),bVar5 = 0.0 < uStack_50._4_4_,bVar5) {
   if (lVar9 == 0) goto LAB_00102c00;
   lVar11 = *(long*)( lVar9 + -8 );
   if (lVar11 <= lVar10) goto LAB_00102c03;

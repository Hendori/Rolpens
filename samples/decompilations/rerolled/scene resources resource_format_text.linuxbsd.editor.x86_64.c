...
CowData<char32_t>::_unref((CowData<char32_t>*)&local_70);LAB_001051a5:iVar31 = String::find((char*)&local_a0, 0x117725);if (( iVar31 == -1 ) && ( cVar29 = String::is_relative_path() ),cVar29 != '\0') {
   ProjectSettings::get_singleton();
   String::get_base_dir();
            ...
            do {
               if (*(int*)( local_88._8_8_ + lVar6 ) != 0) {
                  ...
                  *(int*)( local_88._8_8_ + lVar6 ) = 0;
                  if (( *(long*)( (long)pvVar8 + 0x18 ) != 0 ) && ( cVar4 = RefCounted::unreference() ),cVar4 != '\0') {
            ...
            do {
               if (*(int*)( local_b8._8_8_ + lVar6 ) != 0) {
                  ...
                  *(int*)( local_b8._8_8_ + lVar6 ) = 0;
                  if (( *(long*)( (long)pvVar8 + 0x10 ) != 0 ) && ( cVar4 = RefCounted::unreference() ),cVar4 != '\0') {
...
/* ResourceFormatLoader::_initialize_classv() */void ResourceFormatLoader::_initialize_classv(void) {
 ...
 while ( (int)plVar4[2] != 0 );
      ...
      void ResourceFormatSaver::_get_property_listv(ResourceFormatSaver *this, List *param_1, bool param_2) {
         long in_FS_OFFSET;
         CowData<char32_t> *local_b0;
         long local_98;
         long local_90;
   ...
   String&) */
      void ResourceLoaderText::_parse_ext_resources(void *param_1, Stream *param_2, Ref *param_3, int *param_4, String *param_5) {
         _parse_ext_resource((ResourceLoaderText*)param_1, param_2, param_3, param_4, param_5);
         return;
      }

      /* ResourceLoaderText::~ResourceLoaderText() */
      void ResourceLoaderText::~ResourceLoaderText(ResourceLoaderText *this) {
         uint uVar1;
         Object *pOVar2;
         char cVar3;
         long lVar4;
 ...
 while ( lVar4 != (ulong)uVar1 << 2 );
      ...
      void Ref<FileAccess>::unref(Ref<FileAccess> *this) {
         Object *pOVar1;
         char cVar2;
         if (*(long*)this != 0) {
            cVar2 = RefCounted::unreference();
      ...
      void Ref<PackedScene>::unref(Ref<PackedScene> *this) {
         Object *pOVar1;
         char cVar2;
         if (*(long*)this != 0) {
            cVar2 = RefCounted::unreference();
 ...
 while ( ( uVar11 != 0 ) && ( auVar5._8_8_ = 0 ),auVar5._0_8_ = (ulong)uVar11 * lVar2,auVar9._8_8_ = 0,auVar9._0_8_ = uVar16,auVar6._8_8_ = 0,auVar6._0_8_ = ( ulong )(( uVar1 + uVar14 ) - SUB164(auVar5 * auVar9, 8)) * lVar2,auVar10._8_8_ = 0,auVar10._0_8_ = uVar16,uVar18 <= SUB164(auVar6 * auVar10, 8) );
   ...
   DefaultTypedAllocator<HashMapElement<String, Variant> > >::operator[](String const&) */
      Variant * __thiscallHashMap<String,Variant,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Variant>>>::operator [](HashMap<String,Variant,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Variant>>> * this, String * param_1);
      {
         uint *puVar1;
         undefined8 *puVar2;
         uint uVar3;
...
;
      ...
      void Ref<SceneState>::unref(Ref<SceneState> *this) {
         Object *pOVar1;
         char cVar2;
         if (*(long*)this != 0) {
            cVar2 = RefCounted::unreference();
...
;
 ...
 while ( uVar31 != 0 );
      ...
      void Ref<Resource>::operator =(Ref<Resource> *this, Resource *param_1) {
         Object *pOVar1;
         char cVar2;
         pOVar1 = *(Object**)this;
      ...
      void Ref<MissingResource>::operator =(Ref<MissingResource> *this, Variant *param_1) {
         Object *pOVar1;
         char cVar2;
         Object *pOVar3;
      ...
      void Ref<MissingResource>::unref(Ref<MissingResource> *this) {
         Object *pOVar1;
         char cVar2;
         if (*(long*)this != 0) {
            cVar2 = RefCounted::unreference();
      ...
      void Ref<Resource>::operator =(Ref<Resource> *this, Variant *param_1) {
         Object *pOVar1;
         char cVar2;
         Object *pOVar3;
         pOVar3 = (Object*)Variant::get_validated_object();
      ...
      void List<PropertyInfo,DefaultAllocator>::sort_custom<Comparator<PropertyInfo>>(List<PropertyInfo,DefaultAllocator> *this) {
         size_t __n;
         int iVar1;
         undefined8 *puVar2;
         char cVar3;
...
;
 ...
 while ( __src + ( iVar1 - 2 ) != ppEVar7 );
   ...
   DefaultAllocator>::_Data::_create_root() */
      void RBMap<ResourceFormatSaverTextInstance::NonPersistentKey,Variant,Comparator<ResourceFormatSaverTextInstance::NonPersistentKey>,DefaultAllocator>::_Data::_create_root(_Data *this) {
         undefined8 uVar1;
         Object *pOVar2;
         char cVar3;
         undefined4 *puVar4;
      ...
      cVar3 = Variant::needs_deinit[(int)local_88];
      joined_r0x0011fa81:if (cVar3 != '\0') {
         Variant::_clear_internal();
      }

      uVar1 = *(undefined8*)( this + 8 );
      for (int i = 0; i < 3; i++) {
         *(undefined8*)( *(long*)this + ( 8*i + 8 ) ) = uVar1;
      }
   ...
   undefined8 HashSet<String,HashMapHasherDefault,HashMapComparatorDefault<String>>::_lookup_pos(HashSet<String,HashMapHasherDefault,HashMapComparatorDefault<String>> *this, String *param_1, uint *param_2) {
      uint uVar1;
      long lVar2;
      undefined1 auVar3[16];
      undefined1 auVar4[16];
 ...
 while ( uVar36 != 0 );
   ...
   /* CowData<int>::_unref() */
   void CowData<int>::_unref(CowData<int> *this) {
      long *plVar1;
      long lVar2;
      if (*(long*)this == 0) {
         return;
 ...
 while ( lVar3 != lVar7 );
   ...
   void CowData<StringName>::_unref(CowData<StringName> *this) {
      long *plVar1;
      long lVar2;
      code *pcVar3;
      long *plVar4;
 ...
 while ( lVar2 != lVar5 );
   ...
   void Vector<StringName>::sort_custom<StringName::AlphCompare,true>(Vector<StringName> *this) {
      long lVar1;
      code *pcVar2;
      StringName *pSVar3;
      undefined8 *puVar4;
 ...
 while ( lVar1 != lVar9 );
   ...
   void CowData<ResourceFormatSaverTextInstance::ResourceSort>::_unref(CowData<ResourceFormatSaverTextInstance::ResourceSort> *this) {
      long *plVar1;
      long *plVar2;
      long lVar3;
      long lVar4;
 ...
 while ( lVar3 != lVar9 );
   ...
   true>() */
   void Vector<ResourceFormatSaverTextInstance::ResourceSort>::sort_custom<_DefaultComparator<ResourceFormatSaverTextInstance::ResourceSort>,true>(Vector<ResourceFormatSaverTextInstance::ResourceSort> *this) {
      CowData<char32_t> *this_00;
      CowData *pCVar1;
      long lVar2;
      Object *pOVar3;
 ...
 while ( lVar8 != 1 );
         ...
         if (lVar2 < 0x11) {
            ...
            do {
               ...
               if (cVar6 < '\0') {
                  do if (*(long*)pCVar12 != *(long*)( (CowData<char32_t>*)pCVar12 + -0x10 )) pCVar12 = (CowData*)( (CowData<char32_t>*)pCVar12 + -0x10 ); while ( lVar7 != 0 );
                  ...
                  while (true) {
                     ...
                     if (pOVar3 != pOVar4) {
                        *(Object**)pRVar9 = pOVar3;
                        ...
                        if (( ( pOVar4 != (Object*)0x0 ) && ( cVar6 = RefCounted::unreference() ),cVar6 != '\0' )) &&( cVar6 = cVar6 != '\0' )(**(code**)( *(long*)pOVar4 + 0x140 ))(pOVar4);
                        Memory::free_static(pOVar4, false);
                     }
...
;
 ...
 while ( lVar2 != lVar8 );
            ...
            do {
               ...
               pCVar12 = (CowData*)pRVar10;
               if (cVar6 < '\0') {
                  do if (*(long*)pCVar12 != *(long*)( (CowData<char32_t>*)pCVar12 + -0x10 )) pCVar12 = pCVar1; while ( this_00 != (CowData<char32_t>*)pCVar1 );
                  Ref<Resource>::operator =((Ref<Resource>*)pRVar11, local_58);
                  CowData<char32_t>::_ref(this_00, (CowData*)local_50);
               }
 else {
...
;
 ...
 while ( local_a0 != 0x10 );
   ...
   void RBMap<ResourceFormatSaverTextInstance::NonPersistentKey,Variant,Comparator<ResourceFormatSaverTextInstance::NonPersistentKey>,DefaultAllocator>::_insert_rb_fix(RBMap<ResourceFormatSaverTextInstance::NonPersistentKey,Variant,Comparator<ResourceFormatSaverTextInstance::NonPersistentKey>,DefaultAllocator> *this, Element *param_1) {
      int iVar1;
      long lVar2;
      long lVar3;
      Element *pEVar4;
...
;
 ...
 while ( true );
   ...
   const&) */
   Element * __thiscallRBMap<ResourceFormatSaverTextInstance::NonPersistentKey,Variant,Comparator<ResourceFormatSaverTextInstance::NonPersistentKey>,DefaultAllocator>::_insert(RBMap<ResourceFormatSaverTextInstance::NonPersistentKey,Variant,Comparator<ResourceFormatSaverTextInstance::NonPersistentKey>,DefaultAllocator> * this, NonPersistentKey * param_1, Variant * param_2);
   {
      undefined8 uVar1;
      Ref *pRVar2;
      char cVar3;
 ...
 while ( *(Element**)( this + 8 ) != *(Element**)( pEVar6 + 8 ) );
   ...
   *(Element**)( pEVar6 + 0x20 ) = pEVar4;
   LAB_00121866:*(int*)( this + 0x10 ) = *(int*)( this + 0x10 ) + 1;
   _insert_rb_fix(this, pEVar4);
   pEVar6 = pEVar4;
   LAB_001218a9:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return pEVar6;
   }
...
/* CowData<ResourceFormatSaverTextInstance::ResourceSort>::_realloc(long) */undefined8 CowData<ResourceFormatSaverTextInstance::ResourceSort>::_realloc(CowData<ResourceFormatSaverTextInstance::ResourceSort> *this, long param_1) {
   undefined8 *puVar1;
   puVar1 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), param_1 + 0x10, false);
   if (puVar1 != (undefined8*)0x0) {
      *puVar1 = 1;

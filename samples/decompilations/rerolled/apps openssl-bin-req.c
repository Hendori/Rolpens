void lh_OPENSSL_STRING_hash_thunk(undefined8 param_1, code *UNRECOVERED_JUMPTABLE) {
   ...
   ( *UNRECOVERED_JUMPTABLE )();
   return;
}void lh_OPENSSL_STRING_doall_arg_thunk(undefined8 param_1, undefined8 param_2, code *UNRECOVERED_JUMPTABLE) {
   for (int i_1141 = 0; i_1141 < 2; i_1141++) {
      /* WARNING: Could not recover jumptable at 0x00100034. Too many branches */
   }
   ( *UNRECOVERED_JUMPTABLE )();
   return;
}/* WARNING: Unknown calling convention -- yet parameter storage is locked */int ext_name_cmp(char *__s1, char *__s2) {
   int iVar1;
   ...
   OPENSSL_LH_strhash();
   return;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 build_data_constprop_0(undefined8 param_1, char *param_2, char *param_3, uint param_4, uint param_5, char *param_6, undefined8 param_7, undefined8 param_8) {
   char cVar1;
   int iVar2;
   size_t sVar3;
   char *pcVar4;
   ...
   if (param_3 == (char*)0x0) {
      ...
      do {
         ...
         *param_6 = '\0';
         ...
         LAB_0010035d:BIO_printf(_bio_err, "%s [%s]:", param_1);
      } while ( true );
   }
   if (batch == 0) {
   ...
   if (cVar1 == '\n') {
      ...
      sVar3 = strlen(param_2);
      if (0x400 < sVar3 + 2) {
         LAB_00100228:BIO_printf(_bio_err, "%s \'%s\' too long\n", param_8, param_2);
         return 0;
      }
      memcpy(param_6, param_2, sVar3);
      ( param_6 + sVar3 )[0] = '\n';
   ...
   if (param_6[(long)(int)sVar3 + -1] == '\n') {
      ...
      LAB_00100400:BIO_printf(_bio_err, "Missing newline at end of input\n");
   }
   return 0;
}/* WARNING: Type propagation algorithm not settling *//* WARNING: Globals starting with '_' overlap smaller symbols at the same address */uint req_main(undefined4 param_1, undefined8 *param_2) {
   byte bVar1;
   byte bVar2;
   bool bVar3;
   bool bVar4;
   ...
   switchD_00100697_caseD_0:pcVar23 = local_678;
   pEVar30 = local_6b8;
   iVar7 = opt_next();
   joined_r0x00100677:if (iVar7 == 0) {
      ...
      if (local_68c == 0) {
         ...
         if (local_638 != 0) {
            BIO_printf(_bio_err, "Warning: Ignoring -not_before without -x509; not generating a certificate\n");
         }
         if (local_648 != 0) {
            BIO_printf(_bio_err, "Warning: Ignoring -not_after without -x509; not generating a certificate\n");
         }
         if (local_580 == 0) {
         ...
         if (local_670 == 0) {
            ...
            iVar7 = isatty(iVar7);
            if (iVar7 != 0) {
               BIO_printf(_bio_err, "Warning: Will read cert request from stdin since no -in option is given\n");
            }
         }
      } else if (local_670 == 0) {
         LAB_0010194c:uVar32 = 1;
      }
      ...
      if (local_6d0 == (BIO*)0x0) {
         ...
         LAB_00101986:pcVar15 = (char*)app_conf_try_string(req_conf, 0, "oid_file");
         if (pcVar15 != (char*)0x0) {
         ...
         if ((EVP_PKEY*)_default_config_file != local_6c0) {
            LAB_00101060:iVar7 = app_load_modules(req_conf);
            if (iVar7 == 0) goto LAB_001006e9;
         }
      ...
      if (local_668 == (char*)0x0) {
         ...
         LAB_001010bd:X509V3_set_ctx(&local_548, (X509*)0x0, (X509*)0x0, (X509_REQ*)0x0, (X509_CRL*)0x0, 1);
      ...
      if (( pcVar15 != (char*)0x0 ) && ( iVar7 = iVar7 == 0 )) {
         BIO_printf(_bio_err, "Invalid global string mask setting %s\n", pcVar15);
         goto LAB_0010070c;
      }
      if (( iVar8 == 0x1000 ) || ( ( pcVar15 = (char*)app_conf_try_string(req_conf, section, &_LC45) ),pcVar15 != (char*)0x0 && ( iVar7 = strcmp(pcVar15, "yes") ),iVar7 == 0 )) {
         iVar8 = 0x1000;
      }
      if (lVar19 != 0) {
         ...
         if (local_6b8 != (EVP_PKEY*)0x0) {
            BIO_printf(_bio_err, "Warning: Not generating key via given -newkey option since -key is given\n");
         }
      ...
      if (local_6b8 == (EVP_PKEY*)0x0) {
         ...
         pBVar34 = local_560;
         LAB_001021ff:local_6b0 = CRYPTO_strdup((char*)local_6b8, "apps/req.c", 0x631);
         LAB_00101c1f:if (local_6b0 == (char*)0x0) {
         ...
         if (pkey == (EVP_PKEY*)0x0) {
            if (local_6a8 == (ENGINE*)0x0) {
               ...
               LAB_00101c89:if (ctx != (EVP_PKEY_CTX*)0x0) {
                  ...
                  if (pBVar34 == (BIGNUM*)0xffffffffffffffff) {
                     ...
                     if (( iVar7 == 0 ) && ( iVar7 = iVar7 == 0 )) goto LAB_00101d46;
                     pBVar34 = local_560;
                     if (local_560 != (BIGNUM*)0xffffffffffffffff) goto LAB_00101cac;
                     LAB_00103672:iVar7 = EVP_PKEY_CTX_is_a(ctx, &_LC12);
                     if (( ( iVar7 != 0 ) || ( iVar7 = EVP_PKEY_CTX_is_a(ctx, "RSA-PSS") ),iVar7 != 0 )) {
                        BIO_printf(_bio_err, "Private key length too short, needs to be at least %d bits, not %ld.\n", 0x200, local_560);
                        goto LAB_0010211a;
                     }
                  } else {
                     LAB_00101cac:local_508 = (undefined1[16])0x0;
                     ...
                     LAB_00101d46:if ((long)local_560 < 0x200) goto LAB_00103672;
                  }
                  if (( 0x4000 < (long)local_560 ) && ( ( iVar7 = EVP_PKEY_CTX_is_a(ctx, &_LC12) ),iVar7 != 0 || ( iVar7 = EVP_PKEY_CTX_is_a(ctx, "RSA-PSS") ),iVar7 != 0 )) {
                     BIO_printf(_bio_err, "Warning: It is not recommended to use more than %d bit for RSA keys.\n         Your key size is %ld! Larger key size may behave not as expected.\n", 0x4000, local_560);
                  }
                  iVar7 = EVP_PKEY_CTX_is_a(ctx, &_LC62);
                  if (( iVar7 != 0 ) && ( 10000 < (long)local_560 )) {
                     BIO_printf(_bio_err, "Warning: It is not recommended to use more than %d bit for DSA keys.\n         Your key size is %ld! Larger key size may behave not as expected.\n", 10000);
                  }
                  iVar7 = 0;
         ...
         if (( byte )(*(char*)local_6b8 - 0x30U) < 10) {
            uVar21 = 0;
            local_6b8 = (EVP_PKEY*)&_LC12;
            LAB_00102233:pkey = (EVP_PKEY*)0x0;
            pBVar34 = (BIGNUM*)strtol((char*)pEVar30, (char**)0x0, 10);
            LAB_00101bf8:if (uVar21 == 0) goto LAB_001021ff;
         ...
         if (pkey == (EVP_PKEY*)0x0) {
            ...
            BIO_free(pBVar16);
            LAB_00101be5:pBVar34 = (BIGNUM*)0xffffffffffffffff;
            if (( local_6b8 != (EVP_PKEY*)0x0 ) || ( local_6b8 = (EVP_PKEY*)EVP_PKEY_get0_type_name(pkey) ),local_6b8 != (EVP_PKEY*)0x0) goto LAB_00101bf8;
            EVP_PKEY_free(pkey);
            BIO_puts(_bio_err, "Unable to determine key type\n");
         }
         LAB_001027ea:local_6b0 = (char*)0x0;
      }
      LAB_001027f2:local_6c8 = (X509_NAME*)0x0;
      req = (X509_REQ*)0x0;
...
switchD_00100697_caseD_9:
   ...
   switchD_00100697_caseD_ffffffff:BIO_printf(_bio_err, "%s: Use -help for summary.\n", uVar13);
   goto LAB_001006e9;
   LAB_00101dc7:iVar10 = OPENSSL_sk_num(local_6f8);
   ...
   iVar7 = iVar7 + 1;
   goto LAB_00101dc7;
   LAB_00101dd6:EVP_PKEY_CTX_set_app_data(ctx, _bio_err);
   if (bVar35) {
      EVP_PKEY_CTX_set_cb(ctx, &progress_cb);
   }
   local_6c0 = (EVP_PKEY*)app_keygen(ctx, local_6b0, (ulong)local_560 & 0xffffffff);
   if (local_6c0 == (EVP_PKEY*)0x0) {
      LAB_0010211a:local_6c8 = (X509_NAME*)0x0;
      req = (X509_REQ*)0x0;
      pBVar16 = (BIO*)0x0;
      local_6d8 = (X509*)0x0;
      local_6b8 = (EVP_PKEY*)0x0;
   ...
   if (local_678 == (char*)0x0) {
      ...
      LAB_00101e31:if (bVar5) {
         BIO_printf(_bio_err, "Writing private key to ");
         LAB_001020e0:BIO_printf(_bio_err, "\'%s\'\n", local_678);
      }
   }
   pBVar16 = (BIO*)bio_open_owner(local_678, local_578, uVar32);
   if (pBVar16 == (BIO*)0x0) {
      LAB_0010205e:req = (X509_REQ*)0x0;
      x_01 = (X509*)0x0;
      ctx = (EVP_PKEY_CTX*)0x0;
      uVar32 = 1;
      local_6c8 = (X509_NAME*)0x0;
      ...
      pEVar20 = local_650;
      if (( ( ( pcVar23 != (char*)0x0 ) || ( pcVar23 = (char*)app_conf_try_string(req_conf, section, "encrypt_key") ),pcVar23 != (char*)0x0 ) ) && ( *pcVar23 == 'n' )) {
         pEVar20 = local_650;
      }
      local_650 = pEVar20;
      ...
      iVar7 = 0;
      while (iVar10 = PEM_write_bio_PrivateKey(pBVar16, local_6c0, pEVar20, (uchar*)0x0, 0, (undefined1*)0x0, local_568),iVar10 == 0) {
      ...
      pcVar23 = local_678;
      local_678 = local_6b0;
      LAB_00101289:if (local_658 == 0) {
         local_6c8 = (X509_NAME*)0x0;
      } else {
         LAB_00101298:local_6c8 = (X509_NAME*)parse_name(local_658, iVar8, 1, "subject");
      ...
      if (uVar32 == 0) {
         ...
         local_6b0 = local_678;
         local_678 = pcVar23;
         LAB_00101307:req = (X509_REQ*)load_csr_autofmt(local_670, local_57c, local_6f0, "X509 request");
         if (req == (X509_REQ*)0x0) {
            LAB_001022e5:x_01 = (X509*)0x0;
            ctx = (EVP_PKEY_CTX*)0x0;
            pBVar16 = (BIO*)0x0;
            uVar32 = 1;
            local_6d8 = (X509*)0x0;
         ...
         if (local_670 != 0) {
            BIO_printf(_bio_err, "Warning: Ignoring -in option since -new or -newkey or -precert is given\n");
         }
         local_6b0 = local_678;
         req = (X509_REQ*)0x0;
         local_678 = pcVar23;
      ...
      if (local_628 == (stack_st_CONF_VALUE*)0x0) {
         ...
         LAB_00101373:local_6b8 = (EVP_PKEY*)load_key(local_628, 0, 0, local_570, local_6a0);
         if (local_6b8 == (EVP_PKEY*)0x0) {
            x_01 = (X509*)0x0;
            ctx = (EVP_PKEY_CTX*)0x0;
            pBVar16 = (BIO*)0x0;
         ...
         LAB_0010227d:if (( local_68c | uVar32 ) != 0) {
            if (local_6c0 == (EVP_PKEY*)0x0) {
               ctx = (EVP_PKEY_CTX*)0x0;
               ...
               if (iVar7 != 0) {
                  if (local_6c8 == (X509_NAME*)0x0) {
                     if (bVar35) {
                        ...
                        for (iVar7 = 0; iVar10 = OPENSSL_sk_num(local_628),iVar7 < iVar10; iVar7 = iVar7 + 1) {
                           ...
                           LAB_00102932:iVar10 = 0;
                           if (*pbVar33 == 0x2b) {
                              pbVar33 = pbVar33 + 1;
                              iVar10 = -1;
                           }
                           iVar10 = X509_NAME_add_entry_by_txt(pXVar18, (char*)pbVar33, iVar8, *(uchar**)( lVar24 + 0x10 ), -1, -1, iVar10);
                           if (iVar10 == 0) goto LAB_0010271c;
                        }
                        iVar7 = X509_NAME_entry_count(pXVar18);
                        if (iVar7 == 0) {
                           LAB_0010318b:BIO_printf(_bio_err, "Error: No objects specified in config file\n");
                        } else {
                           uVar12 = local_68c;
                           if (local_68c != 1) {
                              for (; iVar7 = OPENSSL_sk_num(local_5f0),(int)uVar12 < iVar7; uVar12 = uVar12 + 1) {
                                 lVar24 = OPENSSL_sk_value(local_5f0, uVar12);
                                 iVar7 = X509_REQ_add1_attr_by_txt(x, *(char**)( lVar24 + 8 ), iVar8, *(uchar**)( lVar24 + 0x10 ), -1);
                        ...
                        pXVar18 = (X509_NAME*)X509_REQ_get_subject_name(x);
                        if (batch == 0) {
                           BIO_printf(_bio_err, "You are about to be asked to enter information that will be incorporated\n");
                           BIO_printf(_bio_err, "into your certificate request.\n");
                           BIO_printf(_bio_err, "What you are about to enter is what is called a Distinguished Name or a DN.\n");
                        ...
                        if (iVar7 == 0) {
                           ...
                           LAB_00102a34:do {
                              ...
                              if (iVar7 <= local_5e8) {
                                 ...
                                 if (( ( local_5f0 != (stack_st_CONF_VALUE*)0x0 ) && ( iVar7 = OPENSSL_sk_num(local_5f0) ),0 < iVar7 )) {
                              ...
                              if (3 < sVar25) {
                                 ...
                                 if (( iVar7 == 0 ) || ( iVar7 = strcmp((char*)( pbVar31 + ( sVar25 - 4 ) ), "_max") ),iVar7 == 0) goto LAB_00102a34;
                                 if (sVar25 < 8) {
                              ...
                              LAB_00102b0b:do {
                                 ...
                                 pbVar33 = pbVar26 + 1;
                              } while ( ( 0x3a < bVar2 ) || ( ( 0x400500000000000U >> ( (ulong)bVar2 & 0x3f ) & 1 ) == 0 ) );
                              if (pbVar26[1] != 0) {
                                 pbVar31 = pbVar33;
                              }
                              LAB_00102b12:iVar7 = 0;
                              if (*pbVar31 == 0x2b) {
                                 pbVar31 = pbVar31 + 1;
                                 iVar7 = -1;
                              }
                              ...
                              *(undefined1*)( (long)&local_4b8 + sVar25 + 4 ) = 0;
                              ...
                              uVar12 = build_data_constprop_0(*(undefined8*)( lVar24 + 0x10 ), puVar27, uVar13, local_550 & 0xffffffff, local_548._0_8_ & 0xffffffff, local_448, "DN value", "DN default");
                              if (1 < uVar12) {
                     ...
                     if (iVar8 != 0) {
                        LAB_00102707:iVar8 = X509_REQ_set_pubkey(x, local_6c0);
            ...
            LAB_00101403:if (local_68c != 0) {
               local_660 = (EVP_PKEY*)X509_REQ_get0_pubkey(x);
               if (local_6d8 == (X509*)0x0) {
                  LAB_0010305b:local_688 = (X509_NAME*)X509_REQ_get_subject_name(x);
                  pEVar30 = local_6c0;
                  ...
                  local_680 = local_6c8;
                  if (local_6c8 == (X509_NAME*)0x0) {
                     LAB_00102df8:local_680 = (X509_NAME*)X509_REQ_get_subject_name(x);
                  }
                  bVar35 = local_6d8 != (X509*)0x0;
                  req = x;
                  if (( lVar19 != 0 ) && ( bVar35 )) {
                     BIO_printf(_bio_err, "Warning: Not using -key or -newkey for signing since -CA option is given\n");
                  }
               }
               uVar13 = app_get0_propq();
               uVar28 = app_get0_libctx();
               ...
               if (x_01 != (X509*)0x0) {
                  ...
                  if (( iVar8 != 0 ) && ( iVar8 = iVar8 != 0 )) {
                     ...
                     if (( ( ( iVar8 != 0 ) && ( iVar8 = X509_set_subject_name(x_01, local_680) ),iVar8 != 0 ) ) && ( local_660 != (EVP_PKEY*)0x0 )) {
                        if (local_580 == -1) {
                           if (local_670 != 0) {
                              BIO_printf(_bio_err, "Warning: No -copy_extensions given; ignoring any extensions in the request\n");
                           }
                        } else {
                        ...
                        X509V3_set_nconf(&local_548, req_conf);
                        if (( local_668 == (char*)0x0 ) || ( iVar8 = X509V3_EXT_add_nconf(req_conf, &local_548, local_668, x_01) ),iVar8 != 0) {
                           if (( addext_conf == (CONF*)0x0 ) || ( iVar8 = X509V3_EXT_add_nconf(addext_conf, &local_548, "default", x_01) ),iVar8 != 0) {
                              if (( bVar36 ) && ( iVar8 = iVar8 != 1 )) {
            ...
            X509V3_set_nconf(&local_548, req_conf);
            if (( local_668 == (char*)0x0 ) || ( iVar8 = X509V3_EXT_REQ_add_nconf(req_conf, &local_548, local_668, x) ),iVar8 != 0) {
               if (( addext_conf == (CONF*)0x0 ) || ( iVar8 = X509V3_EXT_REQ_add_nconf(addext_conf, &local_548, "default", x) ),iVar8 != 0) {
         ...
         local_6d8 = (X509*)0x0;
         local_6b8 = (EVP_PKEY*)0x0;
         LAB_00102192:if (local_658 == 0) {
            x_01 = (X509*)0x0;
         } else {
            LAB_001014d2:if (bVar5) {
               ...
               iVar8 = X509_REQ_set_subject_name(req, local_6c8);
               if (iVar8 == 0) {
                  LAB_001038ce:BIO_printf(_bio_err, "Error modifying subject of certificate request\n");
                  x = req;
                  goto LAB_00102494;
               }
            }
            LAB_001014f5:x_01 = (X509*)0x0;
         }
         LAB_001014fb:if (uVar9 == 0) {
            LAB_00101543:iVar8 = local_578;
            ...
            if (local_604 == 0) {
               ...
               if (local_63c != 0) {
                  uVar9 = local_68c;
                  if (local_68c == 0) {
                     LAB_00103ac3:pXVar18 = (X509_NAME*)X509_REQ_get_subject_name(req);
                     uVar9 = local_63c;
                  } else {
                     LAB_00101622:pXVar18 = X509_get_subject_name(x_01);
                  }
                  print_name(pBVar16, "subject=", pXVar18);
               }
               LAB_0010163c:if (bVar4) {
                  if (local_68c == 0) {
                  ...
                  LAB_0010396c:ctx = (EVP_PKEY_CTX*)0x0;
                  uVar32 = uVar9;
                  goto LAB_0010214b;
               }
               LAB_001016f8:if (local_68c == 0 && local_618 == 0) {
                  if (local_578 == 4) {
            ...
            LAB_0010173a:ctx = (EVP_PKEY_CTX*)0x0;
            goto LAB_0010073e;
         }
         pEVar30 = local_6c0;
         uVar32 = uVar9;
         if (( local_6c0 == (EVP_PKEY*)0x0 ) && ( pEVar30 = (EVP_PKEY*)X509_REQ_get0_pubkey(req) ),pEVar30 == (EVP_PKEY*)0x0) {
            ctx = (EVP_PKEY_CTX*)0x0;
            pBVar16 = (BIO*)0x0;
         } else {
         ...
         LAB_0010214b:if (uVar32 == 0) goto LAB_0010073e;
      }
   }
   goto LAB_00100732;
   LAB_001031c7:BIO_printf(_bio_err, "%s \'%s\' too long\n", &_LC98, s);
   goto LAB_0010271c;
   while (iVar7 = X509_REQ_add1_attr_by_NID(x, iVar7, iVar8, local_448, -1),iVar7 != 0) {
      LAB_00103326:do {
         local_630._0_4_ = (int)local_630 + 1;
         if (( local_5f0 == (stack_st_CONF_VALUE*)0x0 ) || ( iVar7 = OPENSSL_sk_num(local_5f0) ),iVar7 <= (int)local_630) goto LAB_00102707;
      ...
      *(undefined1*)( (long)&local_4b8 + sVar25 + 4 ) = 0;
      ...
      uVar12 = build_data_constprop_0(*(undefined8*)( lVar24 + 0x10 ), puVar27, uVar13, local_550 & 0xffffffff, local_548._0_8_ & 0xffffffff, local_448, "Attribute value", "Attribute default");
      if (uVar12 < 2) {
   ...
   LAB_0010271c:x_01 = (X509*)0x0;
   ctx = (EVP_PKEY_CTX*)0x0;
   uVar32 = 1;
   BIO_printf(_bio_err, "Error making certificate request\n");
   pBVar16 = (BIO*)0x0;
   req = x;
   LAB_00100732:ERR_print_errors(_bio_err);
   LAB_0010073e:NCONF_free(req_conf);

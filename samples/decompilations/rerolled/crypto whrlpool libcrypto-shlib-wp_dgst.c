int WHIRLPOOL_Init(WHIRLPOOL_CTX *c) {
   ...
   *psVar2 = *psVar2 + bits;
   ...
   if (uVar4 < 0x21) {
      ...
      if (uVar4 < 8) {
         if (( uVar4 & 4 ) == 0) {
            ...
            for (int i_2366 = 0; i_2366 < 4; i_2366++) {
               puVar7[i_2366] = '\0';
            }
            puVar7 = puVar7 + ( uVar6 - 4 );
            for (int i_2367 = 0; i_2367 < 4; i_2367++) {
               puVar7[i_2367] = '\0';
            }
         }
         goto LAB_001005d9;
      ...
      if (uVar4 < 0x40) {
         ...
         if (uVar4 < 8) {
            if (( uVar4 & 4 ) == 0) {
               ...
               for (int i_2368 = 0; i_2368 < 4; i_2368++) {
                  puVar7[i_2368] = '\0';
               }
               puVar7 = puVar7 + ( (ulong)uVar4 - 4 );
               for (int i_2369 = 0; i_2369 < 4; i_2369++) {
                  puVar7[i_2369] = '\0';
               }
            }
         } else {
            for (int i_2370 = 0; i_2370 < 8; i_2370++) {
               puVar7[i_2370] = '\0';
            }
            puVar1 = puVar7 + ( (ulong)uVar4 - 8 );
            for (int i_2371 = 0; i_2371 < 8; i_2371++) {
               puVar1[i_2371] = '\0';
            }
   ...
   for (int i_2364 = 0; i_2364 < 8; i_2364++) {
      puVar7[i_2364] = '\0';
   }
   puVar1 = puVar7 + ( uVar6 - 8 );
   for (int i_2365 = 0; i_2365 < 8; i_2365++) {
      puVar1[i_2365] = '\0';
   }
   ...
   *(ulong*)( c->data + 0x38 ) = uVar6 >> 0x38 | ( uVar6 & 0xff000000000000 ) >> 0x28 | ( uVar6 & 0xff0000000000 ) >> 0x18 | ( uVar6 & 0xff00000000 ) >> 8 | ( uVar6 & 0xff000000 ) << 8 | ( uVar6 & 0xff0000 ) << 0x18 | ( uVar6 & 0xff00 ) << 0x28 | uVar6 << 0x38;
   uVar6 = c->bitlen[1];
   *(ulong*)( c->data + 0x30 ) = uVar6 >> 0x38 | ( uVar6 & 0xff000000000000 ) >> 0x28 | ( uVar6 & 0xff0000000000 ) >> 0x18 | ( uVar6 & 0xff00000000 ) >> 8 | ( uVar6 & 0xff000000 ) << 8 | ( uVar6 & 0xff0000 ) << 0x18 | ( uVar6 & 0xff00 ) << 0x28 | uVar6 << 0x38;
   uVar6 = c->bitlen[2];
   *(ulong*)( c->data + 0x28 ) = uVar6 >> 0x38 | ( uVar6 & 0xff000000000000 ) >> 0x28 | ( uVar6 & 0xff0000000000 ) >> 0x18 | ( uVar6 & 0xff00000000 ) >> 8 | ( uVar6 & 0xff000000 ) << 8 | ( uVar6 & 0xff0000 ) << 0x18 | ( uVar6 & 0xff00 ) << 0x28 | uVar6 << 0x38;
   uVar6 = c->bitlen[3];
   *(ulong*)( c->data + 0x20 ) = uVar6 >> 0x38 | ( uVar6 & 0xff000000000000 ) >> 0x28 | ( uVar6 & 0xff0000000000 ) >> 0x18 | ( uVar6 & 0xff00000000 ) >> 8 | ( uVar6 & 0xff000000 ) << 8 | ( uVar6 & 0xff0000 ) << 0x18 | ( uVar6 & 0xff00 ) << 0x28 | uVar6 << 0x38;
   whirlpool_block(c, c->data, 1);
   if (md != (uchar*)0x0) {
      dVar2 = (c->H).q[1];
      *(double*)md = (c->H).q[0];

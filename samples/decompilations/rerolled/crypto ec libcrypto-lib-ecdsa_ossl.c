undefined8 ecdsa_sign_setup(EC_KEY *param_1, BN_CTX *param_2, undefined8 *param_3, undefined8 *param_4, long param_5, int param_6, int param_7, undefined8 param_8, undefined8 param_9, undefined8 param_10) {
   int iVar1;
   int iVar2;
   EC_GROUP *group;
   BIGNUM *pBVar3;
   ...
   ctx = param_2;
   if (( param_2 == (BN_CTX*)0x0 ) && ( ctx = (BN_CTX*)BN_CTX_new_ex(*(undefined8*)( param_1 + 0x50 )) ),ctx == (BN_CTX*)0x0) {
      ERR_new();
   ...
   if (( a == (BIGNUM*)0x0 || a_00 == (BIGNUM*)0x0 ) || ( a_01 == (BIGNUM*)0x0 )) {
      ...
      if (local_50 != (EC_POINT*)0x0) {
         ...
         if (( ( ( 0x3f < iVar1 ) && ( iVar2 = BN_set_bit(a, iVar1) ),iVar2 != 0 ) ) && ( iVar2 = iVar2 != 0 )) {
            r = a_00;
            if (param_5 == 0) {
               do {
                  do {
                  ...
                  if (iVar1 == 0) goto LAB_0010061a;
                  iVar1 = EC_POINT_get_affine_coordinates(group, local_50, a_01, 0);
                  if (iVar1 == 0) goto LAB_00100604;
                  a_00 = r;
                  iVar1 = BN_nnmod(r, a_01, a_02, ctx);
                  if (iVar1 == 0) goto LAB_001005cf;
                  iVar1 = BN_is_zero(r);
                  r = a_00;
               } while ( iVar1 != 0 );
            } else {
               ...
               if (param_7 == 1) {
                  do {
                     do {
                        uVar5 = param_9;
                        iVar1 = ossl_gen_deterministic_nonce_rfc6979(a, a_02, pBVar3, param_5, lVar4, param_8, param_9, param_10);
                        r = a_00;
                        if (iVar1 == 0) goto LAB_00100181;
                        iVar1 = ossl_bn_is_word_fixed_top(a, 0, uVar5);
                     } while ( iVar1 != 0 );
                     iVar1 = EC_POINT_mul(group, local_50, a, (EC_POINT*)0x0, (BIGNUM*)0x0, ctx);
                     r = a_00;
                     if (iVar1 == 0) goto LAB_0010061a;
                     iVar1 = EC_POINT_get_affine_coordinates(group, local_50, a_01, 0, ctx);
                     r = a_00;
                     if (iVar1 == 0) goto LAB_00100604;
   ...
   LAB_00100279:uVar5 = 0;
   BN_clear_free(a);
   BN_clear_free(a_00);
   LAB_0010028c:if (ctx != param_2) {
      BN_CTX_free(ctx);
   }
   EC_POINT_free(local_50);
   BN_clear_free(a_01);
   return uVar5;
   LAB_00100181:ERR_new();
   ERR_set_debug("crypto/ec/ecdsa_ossl.c", 0xd8, "ecdsa_sign_setup");
   ERR_set_error(0x10, 0x9e, 0);
   a_00 = r;
   goto LAB_00100279;
   LAB_0010061a:ERR_new();
   uVar5 = 0xdf;
   a_00 = r;
   goto LAB_00100409;
   LAB_00100604:ERR_new();
   uVar5 = 0xe4;
   a_00 = r;
   LAB_00100409:ERR_set_debug("crypto/ec/ecdsa_ossl.c", uVar5, "ecdsa_sign_setup");
   ERR_set_error(0x10, 0x80010, 0);
   goto LAB_00100279;
   LAB_001005cf:ERR_new();
   uVar5 = 0xe9;
   LAB_001005e0:ERR_set_debug("crypto/ec/ecdsa_ossl.c", uVar5, "ecdsa_sign_setup");
   ERR_set_error(0x10, 0x80003, 0);
   goto LAB_00100279;
   ...
   if (UNRECOVERED_JUMPTABLE != (code*)0x0) {
      for (int i_1896 = 0; i_1896 < 2; i_1896++) {
         /* WARNING: Could not recover jumptable at 0x00100667. Too many branches */
      }
   ...
   if (UNRECOVERED_JUMPTABLE != (code*)0x0) {
      for (int i_1897 = 0; i_1897 < 2; i_1897++) {
         /* WARNING: Could not recover jumptable at 0x001006c7. Too many branches */
      }
      uVar1 = ( *UNRECOVERED_JUMPTABLE )();
      return uVar1;
   }
   ...
   if (UNRECOVERED_JUMPTABLE != (code*)0x0) {
      for (int i_1898 = 0; i_1898 < 2; i_1898++) {
         /* WARNING: Could not recover jumptable at 0x00100727. Too many branches */
      }
      uVar1 = ( *UNRECOVERED_JUMPTABLE )();
      return uVar1;
   }
   ...
   ERR_set_error(0x10, 0xaa, 0);
   return 0;
}undefined8 ossl_ecdsa_sign(undefined8 param_1, uchar *param_2, int param_3, uchar ****param_4, int *param_5, BIGNUM *param_6, BIGNUM *param_7, EC_KEY *param_8) {
   int iVar1;
   ECDSA_SIG *sig;
   uchar ****pp;
   uchar ***local_20[2];
   ...
   return 1;
}bool ossl_ecdsa_deterministic_sign(uchar *param_1, int param_2, uchar *param_3, int *param_4, EC_KEY *param_5, undefined8 param_6, long param_7, undefined8 param_8, undefined8 param_9) {
   BIGNUM *a;
   BIGNUM *a_00;
   int iVar1;
   ECDSA_SIG *sig;
   ...
   if (param_3 == (uchar*)0x0) {
      ...
      *param_4 = 0;
      iVar1 = ecdsa_sign_setup(param_5, 0, &local_50, &local_48, param_1, param_2, param_6, param_7, param_8, param_9);
      a_00 = local_48;
      a = local_50;
      if (iVar1 == 0) {
         bVar2 = false;
   ...
   ecdsa_sign_setup();
   return;
}ECDSA_SIG *ossl_ecdsa_simple_sign_sig(uchar *param_1, int param_2, BIGNUM *param_3, BIGNUM *param_4, EC_KEY *param_5) {
   int iVar1;
   uint uVar2;
   int iVar3;
   EC_GROUP *pEVar4;
   ...
   if (( sig->r == (BIGNUM*)0x0 ) || ( pBVar6 == (BIGNUM*)0x0 )) {
      ...
      ERR_set_error(0x10, 0x80003, 0);
      local_90 = (BIGNUM*)0x0;
      LAB_00100ce6:ECDSA_SIG_free(sig);
      sig = (ECDSA_SIG*)0x0;
   } else {
      ctx = (BN_CTX*)BN_CTX_new_ex(*(undefined8*)( param_5 + 0x50 ));
      if (( ctx == (BN_CTX*)0x0 ) || ( local_90 = BN_new() ),local_90 == (BIGNUM*)0x0) {
         ERR_new();
         pBVar7 = (BIGNUM*)0x0;
      ...
      if ((int)uVar2 < param_2 * 8) {
         ...
         local_68 = local_68 >> 3;
         pBVar7 = BN_bin2bn(param_1, local_68, local_90);
         if (pBVar7 == (BIGNUM*)0x0) {
            LAB_00100e0c:ERR_new();
            pBVar7 = (BIGNUM*)0x0;
            ERR_set_debug("crypto/ec/ecdsa_ossl.c", 0x14b, "ossl_ecdsa_simple_sign_sig");
            ERR_set_error(0x10, 0x80003, 0);
         } else {
            if (( local_68 * 8 <= (int)uVar2 ) || ( iVar1 = BN_rshift(local_90, local_90, 8 - ( uVar2 & 7 )) ),iVar1 != 0) goto LAB_00100b46;
            ERR_new();
            pBVar7 = (BIGNUM*)0x0;
      ...
      pBVar7 = BN_bin2bn(param_1, param_2, local_90);
      local_68 = param_2;
      if (pBVar7 == (BIGNUM*)0x0) goto LAB_00100e0c;
      LAB_00100b46:if (( param_4 == (BIGNUM*)0x0 ) || ( param_3 == (BIGNUM*)0x0 )) {
         iVar1 = 10;
         do {
            if (param_4 == (BIGNUM*)0x0 || param_3 == (BIGNUM*)0x0) {
               iVar3 = ecdsa_sign_setup(param_5, ctx, &local_48, sig, param_1, local_68, 0, 0, 0, 0);
               pBVar7 = local_48;
               if (iVar3 == 0) {
                  ERR_new();
               ...
               pBVar7 = param_3;
               if (pBVar8 == (BIGNUM*)0x0) goto LAB_00100ffa;
            }
            iVar3 = bn_to_mont_fixed_top(pBVar6, sig->r, *(undefined8*)( pEVar4 + 0x90 ), ctx);
            if (( iVar3 == 0 ) || ( iVar3 = bn_mul_mont_fixed_top(pBVar6, pBVar6, pBVar5, *(undefined8*)( pEVar4 + 0x90 ), ctx) ),iVar3 == 0) goto LAB_00100f80;
            iVar3 = bn_mod_add_fixed_top(pBVar6, pBVar6, local_90, a);
            if (iVar3 == 0) goto LAB_00100fd8;
            iVar3 = bn_to_mont_fixed_top(pBVar6, pBVar6, *(undefined8*)( pEVar4 + 0x90 ), ctx);
            if (( iVar3 == 0 ) || ( iVar3 = BN_mod_mul_montgomery(pBVar6, pBVar6, pBVar7, *(BN_MONT_CTX**)( pEVar4 + 0x90 ), ctx) ),iVar3 == 0) goto LAB_00100fc0;
            iVar3 = BN_is_zero(pBVar6);
            pBVar7 = local_48;
            if (iVar3 == 0) goto LAB_00100cf0;
            iVar1 = iVar1 + -1;
         } while ( iVar1 != 0 );
         ERR_new();
      ...
      if (pBVar7 == (BIGNUM*)0x0) {
         LAB_00100ffa:ERR_new();
         uVar9 = 0x15e;
         LAB_00100f91:ERR_set_debug("crypto/ec/ecdsa_ossl.c", uVar9, "ossl_ecdsa_simple_sign_sig");
         ERR_set_error(0x10, 0x80003, 0);
         pBVar7 = local_48;
         goto LAB_00100ce6;
      }
      iVar1 = bn_to_mont_fixed_top(pBVar6, sig->r, *(undefined8*)( pEVar4 + 0x90 ), ctx);
      if (( iVar1 == 0 ) || ( iVar1 = bn_mul_mont_fixed_top(pBVar6, pBVar6, pBVar5, *(undefined8*)( pEVar4 + 0x90 ), ctx) ),iVar1 == 0) {
         LAB_00100f80:ERR_new();
         uVar9 = 0x16c;
         goto LAB_00100f91;
      }
      iVar1 = bn_mod_add_fixed_top(pBVar6, pBVar6, local_90, a);
      if (iVar1 == 0) {
         LAB_00100fd8:ERR_new();
         uVar9 = 0x170;
         goto LAB_00100f91;
      }
      iVar1 = bn_to_mont_fixed_top(pBVar6, pBVar6, *(undefined8*)( pEVar4 + 0x90 ), ctx);
      if (( iVar1 == 0 ) || ( iVar1 = BN_mod_mul_montgomery(pBVar6, pBVar6, param_3, *(BN_MONT_CTX**)( pEVar4 + 0x90 ), ctx) ),iVar1 == 0) {
         LAB_00100fc0:ERR_new();
         uVar9 = 0x179;
         goto LAB_00100f91;
      }
   ...
   LAB_00100cf0:BN_CTX_free(ctx);
   BN_clear_free(local_90);
   BN_clear_free(pBVar7);
   LAB_00100d0a:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return sig;
}int ossl_ecdsa_verify(undefined8 param_1, uchar *param_2, int param_3, uchar *param_4, int param_5, EC_KEY *param_6) {
   int iVar1;
   int iVar2;
   ECDSA_SIG *pEVar3;
   uchar *ptr;
   ...
   undefined8 uVar4;
   EC_POINT *local_68;
   if (( ( ( param_4 == (EC_KEY*)0x0 ) || ( group = EC_KEY_get0_group(param_4) ),group == (EC_GROUP*)0x0 ) ) || ( q = EC_KEY_get0_public_key(param_4) ),q == (EC_POINT*)0x0) {
      ERR_new();
   ...
   if (( ( ( iVar1 != 0 ) || ( iVar1 = BN_is_negative(*param_3) ),iVar1 != 0 ) ) || ( ( iVar1 = BN_ucmp((BIGNUM*)*param_3, b_00) ),-1 < iVar1 || ( ( iVar1 = BN_is_zero(param_3[1]) ),iVar1 != 0 || ( iVar1 = BN_is_negative(param_3[1]) ),iVar1 != 0 ) )) {
      ERR_new();
   ...
   if (iVar1 == 0) {
      ERR_new();
      uVar4 = 0x1f1;
      LAB_00101661:ERR_set_debug("crypto/ec/ecdsa_ossl.c", uVar4, "ossl_ecdsa_simple_verify_sig");
      ERR_set_error(0x10, 0x80003, 0);
   } else {
      ...
      if ((int)uVar2 < param_2 * 8) {
         ...
         if (pBVar3 == (BIGNUM*)0x0) {
            LAB_001016eb:ERR_new();
            uVar4 = 0x1fc;
         } else {
            if (( iVar1 * 8 <= (int)uVar2 ) || ( iVar1 = iVar1 != 0 )) goto LAB_00101576;
            ERR_new();
            uVar4 = 0x201;
         }
         goto LAB_00101661;
      ...
      if (pBVar3 == (BIGNUM*)0x0) goto LAB_001016eb;
      LAB_00101576:iVar1 = BN_mod_mul(r, ret, b, b_00, ctx);
      if (iVar1 == 0) {
         ERR_new();
         uVar4 = 0x206;
         goto LAB_00101661;
      ...
      if (local_68 != (EC_POINT*)0x0) {
         ...
         if (iVar1 == 0) {
            ERR_new();
            uVar4 = 0x214;
            LAB_0010176a:ERR_set_debug("crypto/ec/ecdsa_ossl.c", uVar4, "ossl_ecdsa_simple_verify_sig");
            ERR_set_error(0x10, 0x80010, 0);
         } else {

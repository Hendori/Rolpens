bool test_bf_set_key(int param_1) {
   ...
   iVar1 = test_mem_eq("test/bftest.c", 0x158, &_LC1, "&(key_out[n][0])", local_28, 8, &key_out + (long)param_1 * 8, 8);
   ...
   iVar1 = test_mem_eq("test/bftest.c", 0x145, "&(cipher_data[n][0])", &_LC1, &cipher_data + lVar3, 8, local_48, 8);
   BF_ecb_encrypt(local_48, local_48, &BStack_1098, 0);
   uVar2 = test_mem_eq("test/bftest.c", 0x149, "&(plain_data[n][0])", &_LC1, &plain_data + lVar3, 8, local_48, 8);
   if ((int)uVar2 != 0) {
      uVar2 = ( ulong )(iVar1 != 0);
   }
   ...
   iVar1 = test_mem_eq("test/bftest.c", 0x132, "&(bf_cipher[n][0])", "&(data[0])", bf_cipher + lVar4 * 8, 8, &local_1090, 8);
   BF_decrypt((uint*)&local_1090, &local_1088);
   uVar3 = test_mem_eq("test/bftest.c", 0x136, "&(bf_plain[n][0])", "&(data[0])", bf_plain + lVar4 * 8, 8, &local_1090, 8);
   if ((int)uVar3 != 0) {
      uVar3 = ( ulong )(iVar1 != 0);
   }
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   ...
   for (int i_2445 = 0; i_2445 < 4; i_2445++) {
      local_a0[i_2445] = ( -34*i_2445 + 254 );
   }
   local_a0[4] = 'v';
   local_a0[5] = 'T';
   local_a0[6] = '2';
   ...
   iVar1 = (int)sVar3;
   BF_ofb64_encrypt((uchar*)( cbc_data + 0xd ), local_68 + 0xd, ( ulong )(iVar1 - 0xc), &local_10e8, local_a0, &local_10ec);
   iVar5 = iVar1 + 1;
   iVar2 = test_mem_eq("test/bftest.c", 0x1aa, "cbc_out", "ofb64_ok", local_68, iVar5, &ofb64_ok, iVar5);
   local_10ec = 0;
   for (int i_2446 = 0; i_2446 < 4; i_2446++) {
      local_a0[i_2446] = ( -34*i_2446 + 254 );
   }
   local_a0[4] = 'v';
   local_a0[5] = 'T';
   local_a0[6] = '2';
   ...
   local_68 = (undefined1[16])0x0;
   local_58 = (undefined1[16])0x0;
   for (int i_2447 = 0; i_2447 < 4; i_2447++) {
      local_a0[i_2447] = ( -34*i_2447 + 254 );
   }
   local_a0[4] = 'v';
   local_a0[5] = 'T';
   local_a0[6] = '2';
   ...
   iVar1 = (int)sVar3;
   BF_cfb64_encrypt((uchar*)( cbc_data + 0xd ), local_68 + 0xd, ( ulong )(iVar1 - 0xc), &local_10e8, local_a0, &local_10ec, 1);
   iVar5 = iVar1 + 1;
   iVar2 = test_mem_eq("test/bftest.c", 0x18a, "cbc_out", "cfb64_ok", local_68, iVar5, &cfb64_ok, iVar5);
   for (int i_2448 = 0; i_2448 < 4; i_2448++) {
      local_a0[i_2448] = ( -34*i_2448 + 254 );
   }
   local_a0[4] = 'v';
   local_a0[5] = 'T';
   local_a0[6] = '2';
   ...
   BF_cfb64_encrypt(local_58 + 1, local_88 + 1, ( ulong )(iVar1 - 0x10), &local_10e8, local_a0, &local_10ec, 0);
   ...
   local_68 = (undefined1[16])0x0;
   local_58 = (undefined1[16])0x0;
   for (int i_2449 = 0; i_2449 < 4; i_2449++) {
      local_a0[i_2449] = ( -34*i_2449 + 254 );
   }
   local_a0[4] = 'v';
   local_a0[5] = 'T';
   local_a0[6] = '2';
   ...
   for (int i_2450 = 0; i_2450 < 4; i_2450++) {
      local_a0[i_2450] = ( -34*i_2450 + 254 );
   }
   local_a0[4] = 'v';
   local_a0[5] = 'T';
   local_a0[6] = '2';

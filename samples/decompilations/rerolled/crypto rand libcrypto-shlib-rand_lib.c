void random_conf_deinit(void) {
   ...
   if (( pRVar2 != (RAND_METHOD*)0x0 ) && ( pRVar2->pseudorand != (_func_3916*)0x0 )) {
      for (int i_1996 = 0; i_1996 < 2; i_1996++) {
   ...
   if (( pRVar2 != (RAND_METHOD*)0x0 ) && ( pRVar3 = pRVar2 != pRVar3 )) {
      ...
      for (int i_1997 = 0; i_1997 < 2; i_1997++) {
   ...
   if (( pRVar2 != (RAND_METHOD*)0x0 ) && ( pRVar3 = pRVar2 != pRVar3 )) {
      ...
      for (int i_1998 = 0; i_1998 < 2; i_1998++) {
   ...
   if (param_1 != (undefined8*)0x0) {
      ...
      for (int i_1999 = 0; i_1999 < 6; i_1999++) {
         CRYPTO_free((void*)param_1[( i_1999 + 6 )]);
      }
      CRYPTO_free(param_1);
      return;
   }
   ...
   if (( pRVar1 != (RAND_METHOD*)0x0 ) && ( pRVar1->seed != (_func_3912*)0x0 )) {
      for (int i_2000 = 0; i_2000 < 2; i_2000++) {
   ...
   if (( pRVar1 != (RAND_METHOD*)0x0 ) && ( pRVar1->add != (_func_3915*)0x0 )) {
      for (int i_2001 = 0; i_2001 < 2; i_2001++) {
   ...
   if (( pRVar2 != (RAND_METHOD*)0x0 ) && ( pRVar3 = pRVar2 != pRVar3 )) {
      ...
      for (int i_2002 = 0; i_2002 < 2; i_2002++) {

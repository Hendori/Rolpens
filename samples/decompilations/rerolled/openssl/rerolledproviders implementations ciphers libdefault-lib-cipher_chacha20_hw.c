undefined8 chacha20_initkey(long param_1, byte *param_2) {
   if (param_2 != (byte*)0x0) {
      *(uint*)( param_1 + 0xc0 ) = (uint)param_2[2] << 0x10 | (uint)param_2[1] << 8 | ( uint ) * param_2 | (uint)param_2[3] << 0x18;
      for (int i = 0; i < 6; i++) {
         *(uint*)( param_1 + ( 4*i + 196 ) ) = (uint)param_2[( 4*i + 5 )] << 8 | (uint)param_2[( 4*i + 6 )] << 16 | (uint)param_2[( 4*i + 4 )] | (uint)param_2[( 4*i + 7 )] << 24;
      }

      *(uint*)( param_1 + 0xdc ) = (uint)param_2[0x1f] << 0x18 | (uint)param_2[0x1d] << 8 | (uint)param_2[0x1e] << 0x10 | (uint)param_2[0x1c];
   }
...
;
         LAB_00100282:ChaCha20_ctr32(param_2, param_3, uVar2 * 0x40, param_1 + 0xc0, param_1 + 0xe0);
 ...
 while ( 0x3f < uVar6 );
   ...
   LAB_001002c3:if (( param_4 & 0x3f ) == 0) {
      return 1;
   }

   for (int i = 0; i < 4; i++) {
      *(undefined1(*) [16])( param_1 + ( 16*i + 240 ) ) = (undefined1[16])0;
   }

   ChaCha20_ctr32(param_1 + 0xf0, param_1 + 0xf0, 0x40, param_1 + 0xc0, param_1 + 0xe0);
   if (( ( uVar1 - 1 < 7 ) || ( ( ulong )((long)param_2 - (long)( (long)param_3 + 1 )) < 0xf ) ) || ( ( ulong )((long)param_2 - ( param_1 + 0xf1 )) < 0xf )) {
      uVar5 = 0;
      do {
         *(byte*)( (long)param_2 + uVar5 ) = *(byte*)( param_1 + 0xf0 + uVar5 ) ^ *(byte*)( (long)param_3 + uVar5 );
         uVar5 = uVar5 + 1;
      }
 while ( uVar1 != uVar5 );
      *(uint*)( param_1 + 0x130 ) = uVar1;
   ...
   if (uVar1 - 1 < 0xf) {
      uVar4 = 0;
      uVar8 = uVar1;
      LAB_00100459:uVar5 = (ulong)uVar4;
      *(ulong*)( (long)param_2 + uVar5 ) = *(ulong*)( (long)param_3 + uVar5 ) ^ *(ulong*)( param_1 + 0xf0 + uVar5 );
   ...
   uVar5 = (ulong)uVar4;
   *(byte*)( (long)param_2 + uVar5 ) = *(byte*)( (long)param_3 + uVar5 ) ^ *(byte*)( param_1 + 0xf0 + uVar5 );
   uVar5 = ( ulong )(uVar4 + 1);
   if (uVar4 + 1 < uVar1) {
      *(byte*)( (long)param_2 + uVar5 ) = *(byte*)( (long)param_3 + uVar5 ) ^ *(byte*)( param_1 + 0xf0 + uVar5 );
      uVar5 = ( ulong )(uVar4 + 2);
            ...
            if (uVar4 + 4 < uVar1) {
               *(byte*)( (long)param_2 + uVar5 ) = *(byte*)( (long)param_3 + uVar5 ) ^ *(byte*)( param_1 + 0xf0 + uVar5 );
               ...
               if (uVar4 + 5 < uVar1) {
                  ...
                  *(byte*)( (long)param_2 + uVar5 ) = *(byte*)( (long)param_3 + uVar5 ) ^ *(byte*)( param_1 + 0xf0 + uVar5 );
                  if (uVar4 + 6 < uVar1) {
                     *(byte*)( (long)param_2 + uVar6 ) = *(byte*)( (long)param_3 + uVar6 ) ^ *(byte*)( param_1 + 0xf0 + uVar6 );
                  }
   ...
   LAB_00100538:*(uint*)( param_1 + 0x130 ) = uVar1;
   return 1;
}

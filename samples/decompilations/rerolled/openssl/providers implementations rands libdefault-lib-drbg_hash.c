...
undefined8 drbg_hash_set_ctx_params_locked(long param_1, undefined8 param_2) {
   ...
   if (( ( lVar4 != 0 ) && ( *(int*)( lVar4 + 8 ) == 4 ) ) && ( lVar4 = ossl_provider_find(uVar3, *(undefined8*)( lVar4 + 0x10 ), 1) ),lVar4 != 0) {
   ...
   if (param_7 == (void*)0x0) {
      if (param_9 == (void*)0x0) {
         while (true) {
            ...
            if (( ( iVar2 == 0 ) || ( iVar2 = EVP_DigestUpdate(ctx, &local_46, cnt) ),iVar2 == 0 )) break;
...
undefined8 add_hash_to_v(long param_1, undefined1 param_2, void *param_3, size_t param_4) {
   ...
   if (( ( ( ( iVar4 != 0 ) && ( iVar4 = EVP_DigestUpdate(ctx, local_3c, 1) ),iVar4 != 0 ) ) && ( iVar4 = EVP_DigestUpdate(ctx, (void*)( lVar2 + 0x28 ), *(size_t*)( param_1 + 0xe0 )) ),iVar4 != 0 )) &&( ( param_3 == (void*)0x0 || ( iVar4 = EVP_DigestUpdate(ctx, param_3, param_4) ),iVar4 != 0 ) ) && ( iVar4 = iVar4 != 0 ) * (long*)( lVar2 + 0x20 );

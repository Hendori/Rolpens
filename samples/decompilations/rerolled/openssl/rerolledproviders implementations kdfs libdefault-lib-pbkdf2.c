...
undefined1(*)[16];kdf_pbkdf2_dup(undefined8 *param_1) {
   ...
   if (( iVar2 != 0 ) && ( ptr = (undefined1(*) [16])CRYPTO_zalloc(0x50, "providers/implementations/kdfs/pbkdf2.c", 0x4c) ),ptr != (undefined1(*) [16])0x0) {
      *(undefined8*)*ptr = uVar1;
      iVar2 = ossl_prov_memdup(param_1[3], param_1[4], ptr[1] + 8, ptr + 2);
      if (( iVar2 != 0 ) && ( ( iVar2 = ossl_prov_memdup(param_1[1], param_1[2], *ptr + 8, ptr + 1) ),iVar2 != 0 && ( iVar2 = ossl_prov_digest_copy(ptr + 3, param_1 + 6) ),iVar2 != 0 )) {
      ...
      CRYPTO_clear_free(*(undefined8*)( *ptr + 8 ), *(undefined8*)ptr[1], "providers/implementations/kdfs/pbkdf2.c", 0x65);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 *kdf_pbkdf2_new(undefined8 param_1) {
   int iVar1;
   undefined8 *puVar2;
   undefined8 uVar3;
   long in_FS_OFFSET;
   ...
   LAB_00100262:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return puVar2;
   }
...
void kdf_pbkdf2_free(undefined1 (*param_1)[16]) {
   if (param_1 != (undefined1(*) [16])0x0) {
      ...
      CRYPTO_clear_free(*(undefined8*)( *param_1 + 8 ), *(undefined8*)param_1[1], "providers/implementations/kdfs/pbkdf2.c", 0x65);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void kdf_pbkdf2_reset(undefined8 *param_1) {
   undefined8 *puVar1;
   int iVar2;
   undefined8 uVar3;
   long in_FS_OFFSET;
...
undefined8 kdf_pbkdf2_set_ctx_params(undefined8 *param_1, long *param_2) {
   ...
   if (( param_2 != (long*)0x0 ) && ( *param_2 != 0 )) {
      ...
      if (lVar4 != 0) {
         ...
         LAB_001004cd:uVar3 = 0;
         goto LAB_00100685;
      }

      LAB_001004f0:lVar4 = OSSL_PARAM_locate_const(param_2, "pkcs5");
      if (lVar4 != 0) {
 ...
 else if (( *(long*)( lVar4 + 0x10 ) != 0 ) && ( iVar2 = OSSL_PARAM_get_octet_string(lVar4, param_1 + 1, 0, param_1 + 2) ),iVar2 == 0) goto LAB_001004cd;
      }
 ...
 else if (( *(long*)( lVar4 + 0x10 ) != 0 ) && ( iVar2 = OSSL_PARAM_get_octet_string(lVar4, param_1 + 3, 0, param_1 + 4) ),iVar2 == 0) goto LAB_001004cd;
      }
   ...
   uVar3 = 1;
   LAB_00100685:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined4 kdf_pbkdf2_derive(long param_1, ulong *param_2, ulong param_3, undefined8 param_4) {
                     ...
                     if (( iVar8 == 0 ) || ( dctx = (HMAC_CTX*)HMAC_CTX_new() ),dctx == (HMAC_CTX*)0x0) {
                        ...
                        if (local_b0 != 0) {
                           ...
                           do {
                              ...
                              local_8c = uVar7 >> 0x18 | ( uVar7 & 0xff0000 ) >> 8 | ( uVar7 & 0xff00 ) << 8 | uVar7 << 0x18;
                              iVar8 = HMAC_CTX_copy(dctx, ctx);
                              if (( ( iVar8 == 0 ) || ( iVar8 = HMAC_Update(dctx, data, (long)iVar16) ),iVar8 == 0 )) goto LAB_00100947;
                              ...
                              if (1 < uVar3) {
                                 ...
                                 do {
                                    iVar8 = HMAC_CTX_copy(dctx, ctx);
                                    if (( ( iVar8 == 0 ) || ( iVar8 = HMAC_Update(dctx, (uchar*)local_88, (long)(int)uVar9) ),iVar8 == 0 )) goto LAB_00100947;
                                    if (0 < (int)uVar5) {
                                       if (uVar5 - 1 < 0xf) {
                                          uVar12 = 0;
                                          uVar10 = 0;
                                       ...
                                       if (6 < uVar15 - 1) {
                                          ...
                                          *(ulong*)( (long)param_2 + uVar12 ) = *(ulong*)( (long)param_2 + uVar12 ) ^ *(ulong*)( (long)local_88 + uVar12 );
 ...
 while ( local_b0 != 0 );
   ...
   uVar13 = 0;
   LAB_001007ef:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }

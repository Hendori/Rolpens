/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void gf_strong_reduce(ulong *param_1) {
   ulong uVar1;
   ulong uVar2;
   ulong uVar3;
   ulong uVar4;
   ...
   uVar6 = uVar11 >> 0x38;
   uVar9 = ( ( lVar7 >> 0x38 ) + (ulong)CARRY8(uVar9, uVar13) + -1 + ( ulong )(0xfffffffffffffe < uVar4) ) * 0x100;
   ...
   *param_1 = uVar13 + uVar3 & 0xffffffffffffff;
   ...
   param_1[7] = uVar13 + ( uVar11 & 0xffffffffffffff ) + ( uVar1 >> 0x38 | ( (ulong)CARRY8(uVar13, uVar2) + (ulong)CARRY8(uVar9, uVar6) ) * 0x100 ) & 0xffffffffffffff;
   return;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void gf_sub(ulong *param_1, long *param_2, long *param_3) {
   ulong uVar1;
   ulong uVar2;
   long lVar3;
   long lVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void gf_add(ulong *param_1, long *param_2, long *param_3) {
   long lVar1;
   long lVar2;
   long lVar3;
   long lVar4;

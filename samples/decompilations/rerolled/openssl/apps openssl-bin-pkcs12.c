...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void alg_print_isra_0(X509_ALGOR *param_1) {
   int iVar1;
   int n;
   uint uVar2;
   char *pcVar3;
      ...
      if (local_44 == 0x10) {
         ...
         if (a_00 != (PBE2PARAM*)0x0) {
            ...
            if (iVar1 == 0x45) {
               ...
               if (iVar1 != 0x3cd) {
                  LAB_00100241:PBE2PARAM_free(a_00);
                  goto LAB_0010011d;
               }
               ...
               if (local_44 == 0x10) {
                  ...
                  if (puVar7 != (undefined8*)0x0) {
                     ...
                     BIO_printf(_bio_err, ", Salt length: %d, Cost(N): %ld, Block size(r): %ld, Parallelism(p): %ld", (ulong)uVar2, lVar9, lVar8, lVar5);
   ...
   LAB_0010011d:BIO_puts(_bio_err, "\n");
      ...
      if (iVar1 == 0) {
         ...
         for (iVar1 = 0; iVar2 = OPENSSL_sk_num(param_2),iVar1 < iVar2; iVar1 = iVar1 + 1) {
            ...
            if (iVar2 == 0) {
               ...
               LAB_0010068c:BIO_printf(param_1, "<No Values>\n");
            }
 else {
               ...
               LAB_00100719:for (iVar2 = 0; iVar3 = X509_ATTRIBUTE_count(attr),iVar2 < iVar3; iVar2 = iVar2 + 1) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int dump_certs_pkeys_bag(BIO *param_1, PKCS12_SAFEBAG *param_2, char *param_3, int param_4, uint param_5, void *param_6, EVP_CIPHER *param_7) {
   undefined4 uVar1;
   int iVar2;
   undefined8 uVar3;
   undefined8 uVar4;
...
LAB_00100be0:
   ...
   iVar8 = 1;
   LAB_0010090e:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar8;
   }
...
undefined8 dump_certs_pkeys_bags(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined4 param_4, undefined4 param_5, undefined8 param_6, undefined8 param_7) {
   int iVar1;
   undefined8 uVar2;
   int iVar3;
   iVar3 = 0;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 dump_certs_keys_p12(undefined8 param_1, PKCS12 *param_2, char *param_3, int param_4, uint param_5, undefined8 param_6, undefined8 param_7) {
   int iVar1;
   int iVar2;
...
;
            ...
            LAB_00100d51:if (psVar4 != (stack_st_PKCS12_SAFEBAG*)0x0) goto LAB_00100d5a;
            LAB_00100df5:uVar5 = 0;
            goto LAB_00100e4d;
         }
...
;
      uVar5 = 1;
      LAB_00100e4d:OPENSSL_sk_pop_free(psVar3, &PKCS7_free);
   }

   return uVar5;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int pkcs12_main(undefined4 param_1, undefined8 param_2) {
   bool bVar1;
   uint iter;
   bool bVar2;
   bool bVar3;
   ...
   local_1150 = 0;
   iter = 0;
   switchD_00101107_caseD_0:do {
      iVar8 = opt_next();
      if (iVar8 == 0) {
         LAB_00101130:iVar9 = opt_check_rest_arg(0);
         ...
         if (bVar5) {
            ...
            if (uVar11 + 1 < 2) {
               if (local_1148 != (undefined*)0x0) {
                  LAB_0010194b:BIO_printf(_bio_err, "Warning: -%s option ignored without -export\n", "macalg");
               }

               if (local_1188 != 0) {
                  LAB_00101eb9:BIO_printf(_bio_err, "Warning: -%s option ignored without -export\n", "iter and -noiter");
               }

               if (iter == 1) {
                  LAB_00101e6d:BIO_printf(_bio_err, "Warning: -%s option ignored without -export\n", "nomaciter");
               }
         ...
         if (local_1138 == 0) {
            ...
            if (iVar9 != 0) {
               ...
               LAB_00101a39:local_1198 = local_1090;
               if (local_1090 == (uchar*)0x0) {
                  if (( bVar3 ) && ( iVar9 = EVP_read_pw_string((char*)local_848, 0x800, "Enter MAC Password:", 1) ),iVar9 != 0) {
                     LAB_001024dc:BIO_printf(_bio_err, "Can\'t read Password\n");
                     goto LAB_0010115c;
                  }
               ...
               if (( ~uVar22 & 3 ) == 0) {
                  ...
                  LAB_0010261e:local_1178 = (ASN1_OBJECT*)0x0;
                  key = (EVP_PKEY*)0x0;
                  bp_00 = (BIO*)0x0;
                  iVar8 = 1;
                  local_1190 = (X509*)0x0;
               ...
               if (( uVar22 & 2 ) == 0) {
                  if (( uVar22 & 1 ) == 0) {
                     LAB_00102042:pcVar20 = "private key from -inkey file";
                     if (local_1140 == 0) {
                  ...
                  if (( local_1190 != (X509*)0x0 ) && ( iVar9 = load_certs(local_1190, 0, &local_1058, local_10a0, "untrusted certificates") ),iVar9 == 0) goto LAB_0010261e;
               }
            ...
            if (iVar9 != 0) {
               LAB_00101c8c:if (local_1098 == (uchar*)0x0) {
                  if (( bVar3 ) && ( iVar9 = EVP_read_pw_string((char*)local_848, 0x800, "Enter MAC Password:", 0) ),iVar9 != 0) goto LAB_001024dc;
                  bVar1 = false;
                  puVar15 = local_848;
               ...
               if (bp != (BIO*)0x0) {
                  ...
                  if (( local_1088 == (PKCS12*)0x0 ) || ( local_1088 = d2i_PKCS12_bio(bp, &local_1088) ),local_1088 == (PKCS12*)0x0) {
                     ERR_print_errors(_bio_err);
                  }
 else {
                     if (( bVar1 ) || ( iVar9 = EVP_read_pw_string((char*)local_1048, 0x800, "Enter Import Password:", 0) ),iVar9 == 0) {
                        if (!bVar3) {
                           OPENSSL_strlcpy(local_848, local_1048, 0x800);
                        }

                        if (( ( uVar22 & 4 ) != 0 ) && ( iVar9 = iVar9 != 0 )) {
                        ...
                        if (local_1120 == 0) {
                           LAB_00101d54:puVar15 = (uchar*)0x0;
                        }
 else {
                           PKCS12_get0_mac(0, &local_1058, 0, 0, local_1088);
                           if (local_1058 == (ASN1_STRING*)0x0) {
                              LAB_00102c51:BIO_printf(_bio_err, "Warning: MAC is absent!\n");
                              goto LAB_00101d54;
                           }

                           X509_ALGOR_get0((ASN1_OBJECT**)&local_1050, (int*)0x0, (void**)0x0, (X509_ALGOR*)local_1058);
                           iVar9 = OBJ_obj2nid((ASN1_OBJECT*)local_1050);
                           if (iVar9 != 0xa2) {
                              uVar13 = app_get0_propq();
                              uVar17 = app_get0_libctx();
                              ...
                              puVar15 = (uchar*)0x0;
                              LAB_00102c9c:bp_00 = (BIO*)0x0;
                              goto LAB_00101172;
                           }

                           LAB_001027f9:if (( *puVar15 != '\0' ) || ( iVar9 = PKCS12_verify_mac(local_1088, (char*)0x0, 0) ),iVar9 == 0) {
                              iVar9 = PKCS12_verify_mac(local_1088, (char*)puVar15, -1);
                              if (iVar9 == 0) {
                                 uVar19 = ERR_peek_error();
                                 if (( ( ( uVar19 & 0x80000000 ) == 0 ) && ( (char)( uVar19 >> 0x17 ) == '#' ) ) && ( ( (uint)uVar19 & 0x7fffff ) == 0x6c )) goto LAB_00102c51;
                        ...
                        LAB_00101d5e:bp_00 = (BIO*)bio_open_owner(local_1128, 0x8005, 1);
                        if (bp_00 == (BIO*)0x0) {
                           local_1120 = 1;
                        }
 else {
                           pEVar12 = local_1080;
                           iVar9 = dump_certs_keys_p12(bp_00, local_1088, local_11a0, 0xffffffff, uVar22, local_1090);
                           local_1120 = iVar8;
                           if (iVar9 == 0) {
                              local_1120 = 1;
                              BIO_printf(_bio_err, "Error outputting keys and certificates\n", extraout_RDX, pEVar12);
                              ERR_print_errors(_bio_err);
                           }
...
;
 ...
 while ( true );
   LAB_00101b2a:iVar10 = OPENSSL_sk_num(local_1060);
   ...
   iVar9 = iVar9 + 1;
   goto LAB_00101b2a;
   LAB_00101b3c:BIO_printf(_bio_err, "No cert in -in file \'%s\' matches private key\n", local_1150);
   LAB_00101b56:local_1178 = (ASN1_OBJECT*)0x0;
   bp_00 = (BIO*)0x0;
   iVar8 = 1;
   local_1190 = (X509*)0x0;
   LAB_0010242b:EVP_PKEY_free(key);
   ...
   ERR_print_errors(_bio_err);
   goto LAB_0010247a;
   LAB_00102098:iVar9 = load_certs(local_1190, 0, &local_1058, local_10a0, "untrusted certificates");
   local_1190 = pXVar16;
   if (iVar9 == 0) goto LAB_001026c7;
   if (bVar6) {
      if (pXVar16 == (X509*)0x0) {
         LAB_001025e1:if (( local_1060 == (ASN1_STRING*)0x0 ) || ( pXVar16 = (X509*)OPENSSL_sk_value(local_1060, 0) ),pXVar16 == (X509*)0x0) {
      ...
      LAB_001020dd:store = (X509_STORE*)setup_verify(local_10e8, local_10d0, local_1110, local_10d4, local_10e0, local_10cc);
      chain = local_1058;
      ...
      if (( ctx == (X509_STORE_CTX*)0x0 ) || ( iVar9 = X509_STORE_CTX_init(ctx, store, pXVar16, (stack_st_X509*)chain) ),iVar9 == 0) {
         LAB_001026e9:X509_STORE_CTX_free(ctx);
      ...
      LAB_001026c7:local_1178 = (ASN1_OBJECT*)0x0;
      LAB_001026d0:bp_00 = (BIO*)0x0;
      iVar8 = 1;
      goto LAB_0010242b;
   }

   LAB_001021d9:if (( local_1118 != 0 ) && ( iVar9 = load_certs(local_1118, 0, &local_1060, local_10a0, "extra certificates from -certfile") ),iVar9 == 0) goto LAB_001026c7;
   ...
   if (( !bVar2 ) && ( ( ( local_1080 != (EVP_CIPHER*)0x0 || ( iter != 0xffffffff ) ) && ( iVar9 = EVP_read_pw_string((char*)local_1048, 0x800, "Enter Export Password:", 1) ),iVar9 != 0 ) )) {
      BIO_printf(_bio_err, "Can\'t read Password\n");
      goto LAB_001026c7;
   }
   ...
   uVar17 = app_get0_propq();
   uVar18 = app_get0_libctx();
   local_1088 = (PKCS12*)PKCS12_create_ex2(local_1158, local_1100, key, local_1190, local_1060, local_1164, uVar11, local_1188, 0xffffffffffffffff, local_1184, uVar18, uVar17, 0x100000, local_1178);
   if (local_1088 == (PKCS12*)0x0) {
      BIO_printf(_bio_err, "Error creating PKCS12 structure for %s\n", local_1128);
      goto LAB_001026d0;
   }

   if (( local_1148 != (undefined*)0x0 ) && ( iVar9 = iVar9 == 0 )) {
      switchD_00101107_caseD_ffffffff:BIO_printf(_bio_err, "%s: Use -help for summary.\n", uVar13);
      LAB_0010115c:bp_00 = (BIO*)0x0;
      bp = (BIO*)0x0;
      puVar15 = (uchar*)0x0;
      local_1120 = 1;
      goto LAB_00101172;
   ...
   if (iter != 0xffffffff) {
      if (bVar4) {
         iVar9 = PKCS12_set_pbmac1_pbkdf2(local_1088, local_1198, 0xffffffff, 0, local_111c, iter, local_1050, local_10c8);
         if (iVar9 == 0) {
   ...
   LAB_001023f8:bp_00 = (BIO*)bio_open_owner(local_1128, 6, 1);
   if (bp_00 != (BIO*)0x0) {
   ...
   iVar8 = 1;
   LAB_0010247a:bp = (BIO*)0x0;
   puVar15 = (uchar*)0x0;
   local_1120 = iVar8;
   LAB_00101172:PKCS12_free(local_1088);

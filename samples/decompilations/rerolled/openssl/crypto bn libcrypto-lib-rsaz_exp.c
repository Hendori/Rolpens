void RSAZ_1024_mod_exp_avx2(ulong *param_1, undefined8 param_2, byte *param_3, ulong *param_4, undefined8 param_5, undefined8 param_6) {
   ulong uVar1;
   ulong uVar2;
   undefined1 *puVar3;
   undefined1 *puVar4;
   ...
   for (int i = 0; i < 4; i++) {
      rsaz_1024_gather5_avx2(puVar3, local_1280, ( 2*i + 8 ));
      rsaz_1024_mul_avx2(puVar3, puVar3, puVar5, puVar4, param_6);
      rsaz_1024_scatter5_avx2(local_1280, puVar3, ( 2*i + 9 ));
      rsaz_1024_sqr_avx2(puVar3, puVar3, puVar4, param_6, 1);
      rsaz_1024_scatter5_avx2(local_1280, puVar3, ( 4*i + 18 ));
      rsaz_1024_mul_avx2(puVar3, puVar3, puVar5, puVar4, param_6);
      rsaz_1024_scatter5_avx2(local_1280, puVar3, ( 4*i + 19 ));
   }
   ...
   do {
      ...
      iVar7 = iVar6 + -5;
      rsaz_1024_gather5_avx2(puVar5, local_1280, (int)(uint)CONCAT11(param_3[(long)( iVar6 >> 3 ) + 1], param_3[iVar6 >> 3]) >> ( (byte)iVar6 & 7 ) & 0x1f);
      rsaz_1024_mul_avx2(puVar3, puVar3, puVar5, puVar4, param_6);
      iVar6 = iVar7;
   }
 while ( iVar7 != -1 );
...
void RSAZ_512_mod_exp(ulong *param_1, undefined8 param_2, byte *param_3, ulong *param_4, undefined8 param_5, undefined8 param_6) {
   byte bVar1;
   ulong uVar2;
   ulong uVar3;
   int iVar4;

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined4 do_revoke(X509 *param_1, long param_2, int param_3, char *param_4) {
   int iVar1;
   undefined4 uVar2;
   X509_NAME *a;
   char *pcVar3;
   ...
   if (pcStack_50 == (char*)0x0) {
      LAB_00100200:BIO_printf(_bio_err, "Memory allocation failure\n");
   }
 else {
      if (*pcStack_50 == '\0') {
            ...
            if (param_3 == -1) {
               ...
               if (param_3 == 2) {
                  ...
                  if (a_02 == (ASN1_OBJECT*)0x0) {
                     ...
                     LAB_001003ea:a_01 = X509_gmtime_adj((ASN1_TIME*)0x0, 0);
                     if (a_01 != (ASN1_TIME*)0x0) {
                        ...
                        LAB_0010049b:ASN1_UTCTIME_free(a_01);
 ...
 while ( ppuVar10 != &PTR__LC2_00107ec0 );
                     ...
                     LAB_001004f0:a_01 = X509_gmtime_adj((ASN1_TIME*)0x0, 0);
                     if (a_01 != (ASN1_TIME*)0x0) {
   ...
   LAB_0010021a:uVar2 = 0xffffffff;
   LAB_00100220:ppcVar9 = local_78;
   do {
      pcVar3 = *ppcVar9;
      ppcVar9 = ppcVar9 + 1;
      CRYPTO_free(pcVar3);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */char *lookup_conf(CONF *param_1, char *param_2, char *param_3) {
   char *pcVar1;
...
/* WARNING: Type propagation algorithm not settling *//* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 do_body_constprop_0(undefined8 *param_1, EVP_PKEY *param_2, X509 *param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6, int *param_7, BIGNUM *param_8, long param_9, undefined4 param_10, int param_11, undefined8 param_12, long param_13, ulong param_14, int param_15, int param_16, X509_REQ *param_17, char *param_18, CONF *param_19, ulong param_20, ulong param_21, int param_22, undefined4 param_23, int param_24, undefined8 param_25) {
   uchar uVar1;
   char cVar2;
   OPENSSL_STRING ptr;
   int iVar3;
   ...
   for (int i = 0; i < 3; i++) {
      apcStack_90[( i + 2 )] = (char*)0;
   }

   if (param_9 == 0) {
      LAB_00100844:if (param_22 != 0) {
      ...
      for (iVar19 = 0; iVar3 = X509_NAME_entry_count(pXVar7),iVar19 < iVar3; iVar19 = iVar19 + 1) {
         ...
         if (msie_hack == 0) {
            if (( iVar3 != 0x30 ) || ( ( ( (byte)param_11 ^ 1 ) & 1 ) == 0 )) {
               ...
               if (iVar3 == 0x30) {
                  if (iVar4 != 0x16) {
                     LAB_00100b86:BIO_printf(_bio_err, "\nemailAddress type needs to be of type IA5STRING\n");
                     goto LAB_00100b9b;
                  }

                  LAB_00100942:iVar3 = ASN1_PRINTABLE_type(s->data, s->length);
                  if (iVar3 == 0x14) {
                     if (s->type != 0x14) goto LAB_0010096a;
                  }
 else if (( iVar3 == 0x16 ) && ( s->type == 0x13 )) {
                     LAB_0010096a:BIO_printf(_bio_err, "\nThe string contains characters that are illegal for the ASN.1 type\n");
                     goto LAB_00100b9b;
                  }

               }
 else {
                  LAB_001008af:if (( iVar4 != 0x1e ) && ( iVar4 != 0xc )) goto LAB_00100942;
               }
...
;
 ...
 while ( puVar21 != puVar17 );
                  ...
                  LAB_00100a80:BIO_printf(_bio_err, "\'\n");
               }
         ...
         LAB_001008ce:}local_168 = X509_NAME_new();
         ...
         for (iVar19 = 0; iVar3 = OPENSSL_sk_num(param_6),iVar19 < iVar3; iVar19 = iVar19 + 1) {
            ...
            iVar3 = -1;
            LAB_00100d1c:iVar4 = X509_NAME_get_index_by_OBJ(pXVar7, pAVar9, iVar3);
            if (-1 < iVar4) {
               ...
               if (iVar4 == 0) {
                  if (ne != (X509_NAME_ENTRY*)0x0) {
                     ...
                     do {
                        ...
                        if (iVar5 < 0) {
                           if (iVar4 == -1) {
                              BIO_printf(_bio_err, "The %s field does not exist in the CA certificate,\nthe \'policy\' is misconfigured\n", *(undefined8*)( lVar11 + 8 ));
                              goto LAB_00100f90;
                           }
                           ...
                           if (iVar5 < 0) {
                              ...
                              BIO_printf(_bio_err, "The %s field is different between\nCA certificate (%s) and the request (%s)\n", *(undefined8*)( lVar11 + 8 ), puVar17, puVar21);
                              goto LAB_00100f90;
                           }
 ...
 while ( iVar6 != 0 );
            ...
            if (iVar3 == -1) {
               ...
               if (iVar3 != 0) {
                  ...
                  if (iVar19 == 0) {
                     LAB_00101632:BIO_printf(_bio_err, "The mandatory %s field was missing\n", *(undefined8*)( lVar11 + 8 ));
                  }
 else {
                     LAB_00100faf:BIO_printf(_bio_err, "%s:invalid type in \'policy\' configuration\n", pcVar18);
                  }
         ...
         if (pAVar13 == (ASN1_INTEGER*)0x0) {
            ...
            LAB_00101079:iVar19 = set_cert_times(x, param_12, param_13, param_14 & 0xffffffff, 0);
            if (iVar19 == 0) goto LAB_0010161c;
            if (param_13 != 0) {
            ...
            if (param_18 != (char*)0x0) {
               if (extfile_conf == (CONF*)0x0) {
                  ...
                  if (iVar19 != 0) {
                     ...
                     if (param_16 == 0) {
                        LAB_001011c6:iVar19 = copy_extensions(x, param_17, param_23);
                        if (iVar19 != 0) goto LAB_001011e2;
                     }
 else {
                        LAB_00101ac9:BIO_printf(_bio_err, pcVar18);
            ...
            iVar19 = copy_extensions(x, param_17, param_23);
            if (iVar19 == 0) {
               LAB_00101af3:pcVar18 = "ERROR: adding extensions from request\n";
               LAB_00101657:BIO_printf(_bio_err, pcVar18);
               goto LAB_0010161c;
            }

            if (param_16 != 0) {
               LAB_001019fb:BIO_printf(_bio_err, "The subject name appears to be ok, checking database for clashes\n");
            }

            LAB_001011e2:if (param_11 == 0) {
               iVar19 = -1;
...
;
            ...
            if (apcStack_90[2] == (char*)0x0) {
               LAB_0010182e:BIO_printf(_bio_err, "Memory allocation failure\n");
               goto LAB_0010161c;
            }
            ...
            if (*param_7 != 0) {
               ...
               LAB_0010170a:BIO_printf(_bio_err, "The matching entry has the following details\n");
               pcVar18 = "Revoked";
               cVar2 = **ppcVar15;
            ...
            LAB_00101300:ppcVar15 = TXT_DB_get_by_index(db, 3, value);
            if (ppcVar15 != (OPENSSL_STRING*)0x0) {
            ...
            BIO_printf(_bio_err, "\n");
            if (param_15 != 0) {
               LAB_001013f3:pEVar14 = (EVP_PKEY*)X509_get0_pubkey(x);
               iVar19 = EVP_PKEY_missing_parameters(pEVar14);
               if (( iVar19 != 0 ) && ( iVar19 = iVar19 == 0 )) {
               ...
               if (iVar19 != 0) {
                  ...
                  *(undefined1*)( (long)apcStack_90[0] + (long)*piVar16 ) = 0;
                  ...
                  if (( ( local_98 != (OPENSSL_STRING)0x0 ) && ( apcStack_90[3] != (char*)0x0 ) ) && ( apcStack_90[4] != (char*)0x0 )) {
 ...
 while ( lVar11 != 0x30 );
      ...
      else{pXVar7 = (X509_NAME*)parse_name(param_9, param_10, 1);
      if (pXVar7 != (X509_NAME*)0x0) {
      ...
      LAB_00100b9b:local_168 = (X509_NAME*)0x0;
      x = (X509*)0x0;
      local_160 = (X509_NAME*)0x0;
      LAB_00100bb0:ppcVar15 = (OPENSSL_STRING*)0x0;
      uVar20 = 0xffffffff;
      value = &local_98;
   }
 ...
 while ( value != local_68 );
   ...
   X509_NAME_free(local_168);
   X509_free(x);
   LAB_00100c15:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }

   return uVar20;
   LAB_00100df8:if (pXVar8 != (X509_NAME_ENTRY*)0x0) {
      LAB_00100d7b:iVar4 = X509_NAME_add_entry(local_168, pXVar8, -1, 0);
      if (iVar4 == 0) {
         BIO_printf(_bio_err, "Memory allocation failure\n");
         goto LAB_00100f90;
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined4 certify_constprop_0(undefined8 param_1, undefined8 param_2, undefined4 param_3, EVP_PKEY *param_4, undefined8 param_5, undefined8 param_6, undefined8 param_7, undefined8 param_8, undefined8 param_9, undefined8 param_10, undefined8 param_11, undefined8 param_12, undefined8 param_13, undefined4 param_14, undefined8 param_15, undefined8 param_16, undefined8 param_17, undefined4 param_18, undefined8 param_19, undefined8 param_20, int param_21, undefined8 param_22, ulong param_23, undefined4 param_24, undefined4 param_25, int param_26, undefined8 param_27) {
   int iVar1;
   undefined4 uVar2;
   X509_REQ *x;
   long lVar3;
   ...
   if (x != (X509_REQ*)0x0) {
      ...
      if (lVar3 != 0) {
         ...
         if (iVar1 < 0) {
            ...
            uVar2 = do_body_constprop_0(param_1, param_4, param_5, param_6, param_7, param_9, param_10, param_11, param_12, param_13, param_14, param_15, param_16, param_17, param_18, param_21, x, param_19, param_20, param_22, param_23, param_24, param_25, param_26, param_27);
         }
   ...
   uVar2 = 0xffffffff;
   LAB_00101cf9:ERR_print_errors(_bio_err);
   X509_REQ_free(x);
   return uVar2;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int do_updatedb(long param_1, time_t *param_2) {
   int iVar1;
   ASN1_TIME *s;
   ASN1_TIME *pAVar2;
   long *plVar3;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined4 unpack_revinfo(undefined8 *param_1, undefined4 *param_2, undefined8 *param_3, undefined8 *param_4, char *param_5) {
   int iVar1;
   char *__s;
   char *pcVar2;
   char *pcVar3;
   ...
   if (__s == (char*)0x0) {
      LAB_001021f9:BIO_printf(_bio_err, "memory allocation failure\n");
   }
 else {
      ...
      if (pcVar2 == (char*)0x0) {
         ...
         LAB_001020b4:s_00 = (ASN1_GENERALIZEDTIME*)0x0;
         uVar5 = 0xffffffff;
         LAB_00102080:if (param_2 != (undefined4*)0x0) {
            *param_2 = (int)uVar5;
         }
      ...
      *pcVar2 = '\0';
      ...
      if (param_1 != (undefined8*)0x0) {
         LAB_00101fac:s = ASN1_UTCTIME_new();
         *param_1 = s;
 ...
 while ( uVar5 != 0xb );
   ...
   LAB_00102022:s_00 = (ASN1_GENERALIZEDTIME*)0x0;
   uVar4 = 0;
   LAB_00102027:CRYPTO_free(__s);
   ASN1_GENERALIZEDTIME_free(s_00);
   return uVar4;
}
/* WARNING: Type propagation algorithm not settling *//* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 ca_main(undefined8 param_1, undefined8 param_2) {
   byte bVar1;
   char cVar2;
   byte bVar3;
   OPENSSL_STRING ptr;
   ...
   local_1308 = 0;
   local_12f8 = 0;
   switchD_00102506_caseD_0:while (true) {
      while (true) {
         iVar7 = opt_next();
...
LAB_001036cc:
   ...
   goto switchD_00102506_caseD_0;
   LAB_001031eb:iVar10 = OPENSSL_sk_num(*(undefined8*)( *(long*)( lVar19 + 8 ) + 8 ));
   ...
   if (*(char*)*puVar22 == 'R') {
      ...
      ASN1_TIME_free((ASN1_TIME*)local_1118._0_8_);
      pcVar38 = " in entry %d\n";
      LAB_00103836:BIO_printf(_bio_err, pcVar38, ( ulong )(iVar8 + 1));
      goto LAB_001032c9;
   }
   ...
   LAB_0010322b:iVar10 = ASN1_TIME_set_string((ASN1_TIME*)0x0, (char*)puVar22[1]);
   if (iVar10 == 0) {
   ...
   if (bVar1 != 0) {
      ...
      do {
         if (( *(byte*)( (long)*ppuVar23 + (ulong)bVar1 * 2 + 1 ) & 0x10 ) == 0) {
            BIO_printf(_bio_err, "entry %d: bad char 0%o \'%c\' in serial number\n", ( ulong )(iVar8 + 1), (ulong)(uint)(int)(char)bVar1, (ulong)(uint)(int)(char)bVar1);
            goto LAB_001032c9;
         }
 ...
 while ( bVar1 != 0 );
   ...
   iVar8 = iVar8 + 1;
   goto LAB_001031eb;
   switchD_00102506_caseD_ffffffff:BIO_printf(_bio_err, "%s: Use -help for summary.\n", uVar15);
   LAB_001025d5:local_12ac = 0;
   x509 = (X509*)0x0;
   x_02 = (X509_CRL*)0x0;
   lVar19 = 0;
   local_12d8 = (long*)0x0;
   ...
   if (bVar4) {
      ...
      if (uVar11 == 0) {
         ...
         if (( iVar8 == 0 ) || ( iVar8 = iVar8 == 0 )) goto LAB_001032c9;
         if (local_12dc != 0) {
   ...
   if (( iVar8 == 2 ) && ( iVar10 = iVar10 == 0 )) {
      local_12c0 = (long*)0x0;
   }
 else {
      if (( local_12c0 == (long*)0x0 ) && ( local_12c0 = (long*)lookup_conf(conf, pcVar38, "default_md") ),local_12c0 == (long*)0x0) {
         iVar10 = strcmp(local_1098, "UNDEF");
         if (iVar10 != 0) goto LAB_001032c9;
      }
 else {
         iVar10 = strcmp((char*)local_12c0, "default");
         if (( iVar10 != 0 ) && ( iVar10 = iVar10 != 0 )) goto LAB_00103989;
      }
   ...
   LAB_00103989:if (uVar14 == 0) {
      local_12d8 = (long*)0x0;
      goto LAB_0010497d;
   }

   if (( bVar39 == true ) && ( pcVar17 = (char*)app_conf_try_string(conf, pcVar38, "email_in_dn") ),pcVar17 != (char*)0x0) {
      iVar8 = strcmp(pcVar17, "no");
      bVar39 = iVar8 != 0;
   }

   if (local_12dc == 0) {
      if (( local_12a0 == (X509_REQ*)0x0 ) && ( local_12a0 = (X509_REQ*)lookup_conf(conf, pcVar38, "policy") ),local_12a0 == (X509_REQ*)0x0) goto LAB_001032c9;
      LAB_001039b9:lVar26 = app_conf_try_string(conf, pcVar38, "rand_serial");
      if (lVar26 == 0) {
      ...
      if (extfile_conf == (CONF*)0x0) {
         if (( local_12c8 != (char*)0x0 ) || ( local_12c8 = (char*)app_conf_try_string(conf, pcVar38, "x509_extensions") ),local_12c8 != (char*)0x0) {
      ...
      if (local_12b8 == 0) {
         ...
         if (local_12b8 == 0) {
            LAB_00105580:local_12b8 = 0;
         }
 else {
            LAB_001055ba:if (local_1140 != 0) goto LAB_00103a6d;
         }

      }
 else {
         if (local_1140 == 0) {
            LAB_001054b1:plVar35 = &local_1140;
         ...
         LAB_00103a6d:BIO_printf(_bio_err, "Warning: -enddate or -not_after option overriding -days option\n");
      }

      LAB_00103a82:if (local_1238 == 0) {
         plVar35 = (long*)0x0;
      ...
      local_1168 = BN_new();
      if (( local_1168 == (BIGNUM*)0x0 ) || ( iVar8 = iVar8 == 0 )) {
         BIO_printf(_bio_err, "error generating serial number\n");
         goto LAB_001032c9;
      }

      LAB_00103ab8:psVar27 = NCONF_get_section(conf, (char*)local_12a0);
      ...
      if (conf_00 == (lhash_st_CONF_VALUE*)0x0) {
         ...
         LAB_001043d7:x = (NETSCAPE_SPKI*)0x0;
         local_12a0 = (X509_REQ*)0x0;
         LAB_00103cc8:X509_REQ_free(local_12a0);
         CONF_free(conf_00);
         NETSCAPE_SPKI_free(x);
         X509_NAME_ENTRY_free((X509_NAME_ENTRY*)0x0);
         LAB_00103cee:x_02 = (X509_CRL*)0x0;
         pBVar18 = (BIO*)0x0;
      }
 else {
 ...
 while ( ( bVar4 ) || ( ( 0x400500000000000U >> ( uVar34 & 0x3f ) & 1 ) == 0 ) );
            ...
            LAB_00103c40:bytes = *(uchar**)( lVar26 + 0x10 );
            iVar10 = OBJ_txt2nid((char*)pbVar21);
            if (iVar10 == 0) {
               iVar10 = strcmp((char*)pbVar21, "SPKAC");
               if (( iVar10 == 0 ) && ( x = NETSCAPE_SPKI_b64_decode(*(char**)( lVar26 + 0x10 ), -1) ),x == (NETSCAPE_SPKI*)0x0) {
                  x = (NETSCAPE_SPKI*)0x0;
         ...
         LAB_00103e7b:if (local_1248 == 0) goto LAB_001040c8;
         get_nameopt();
         plVar35 = local_1158;
         x_00 = (X509*)load_cert_pass(local_1248, local_117c, 1);
         if (x_00 == (X509*)0x0) {
            LAB_00104520:X509_REQ_free((X509_REQ*)0x0);
            X509_free(x_00);
            goto LAB_00103cee;
         }
         ...
         if (-1 < iVar8) {
            ...
            LAB_001044b8:BIO_printf(_bio_err, "Memory allocation failure\n");
            goto LAB_00103cee;
         }

         BIO_printf(_bio_err, "Signature verification problems....\n");
         LAB_001044e0:X509_REQ_free((X509_REQ*)0x0);
         X509_free(x_00);
         LAB_001040c8:uVar15 = local_1160;
         uVar6 = local_1174;
         if (local_12e8 != 0) {
            uVar30 = get_nameopt();
            iVar9 = certify_constprop_0(&local_1130, local_12e8, local_1178, local_1310, pXVar32, local_12c0, local_1308, local_1300, psVar27, lVar19, local_1168, local_1270, iVar9, bVar39, local_1298, local_12b8, local_1140, uVar11, local_12c8, conf, local_12dc, local_1138, uVar30, local_1218, uVar6, local_1264, uVar15, plVar35);
         ...
         for (lVar26 = 0; (int)lVar26 < iVar7; lVar26 = lVar26 + 1) {
            ...
            LAB_001041c1:}iVar9 = OPENSSL_sk_num(local_12d8);
            if (0 < iVar9) {
               if (uVar11 != 0) {
                  LAB_001045de:uVar13 = OPENSSL_sk_num(local_12d8);
                  BIO_printf(_bio_err, "Write out database with %d new entries\n", (ulong)uVar13);
                  if (( ( local_1220 != 0 ) && ( iVar9 = save_serial(local_1220, &_LC144, local_1168, 0) ),iVar9 == 0 )) goto LAB_00103cee;
                  goto LAB_00104652;
               }

               BIO_printf(_bio_err, "\n%d out of %d certificate requests certified, commit? [y/n]", (ulong)uVar13);
               BIO_ctrl(_bio_err, 0xb, 0, (void*)0x0);
               local_10a8[5] = 0;
               ...
               x_02 = (X509_CRL*)0x0;
               pBVar18 = (BIO*)0x0;
               LAB_00105079:uVar15 = 0;
               goto LAB_00102616;
            }

            LAB_00104652:OPENSSL_strlcpy(local_1048, local_1278, 0x1000);
               ...
               if ((int)uVar14 < 1) {
                  *(undefined2*)pcVar17 = _LC190;
                  ...
                  do {
                     ...
                     local_1048[lVar37 * 2 + lVar16 + 1] = "0123456789ABCDEF"[*(byte*)( lVar26 + lVar37 ) & 0xf];
                     lVar37 = lVar37 + 1;
                  }
 while ( (int)lVar37 < (int)uVar14 );
               ...
               if (bVar5) {
                  ...
                  LAB_0010477c:PEM_write_bio_X509(pBVar18, pXVar32);
               }
 else {
                  ...
                  LAB_0010485d:i2d_X509_bio(pBVar18, pXVar32);
               }
            ...
            if (iVar9 != 0) {
               if (( ( local_1220 != 0 ) && ( iVar9 = rotate_serial(local_1220, &_LC144) ),iVar9 == 0 )) goto LAB_00103cee;
               BIO_printf(_bio_err, "Database updated\n");
            }

            LAB_0010497d:if (local_1268 == 0) {
               x_02 = (X509_CRL*)0x0;
               pBVar18 = (BIO*)0x0;
               LAB_00104fa4:if (local_12b0 == 0) goto LAB_00105079;
               if (local_12e8 == 0) {
                  BIO_printf(_bio_err, "no input files\n");
               }
 else {
                  pXVar32 = (X509*)load_cert_pass(local_12e8, local_1178, 1, local_1158, "certificate to be revoked");
               ...
               if (( local_12a8 != (char*)0x0 ) || ( local_12a8 = (char*)app_conf_try_string(conf, pcVar38, "crl_extensions") ),local_12a8 != (char*)0x0) {
                  X509V3_set_ctx(&local_1118, (X509*)0x0, (X509*)0x0, (X509_REQ*)0x0, (X509_CRL*)0x0, 1);
                  X509V3_set_nconf(&local_1118, conf);
                  ...
                  if (x_02 != (X509_CRL*)0x0) {
                     ...
                     if (iVar9 != 0) {
                        ...
                        if (iVar9 == 0) {
                           ...
                           uVar13 = 0;
                           for (iVar9 = 0; iVar7 = OPENSSL_sk_num(*(undefined8*)( *(long*)( lVar19 + 8 ) + 8 )),iVar9 < iVar7; iVar9 = iVar9 + 1) {
                              puVar22 = (undefined8*)OPENSSL_sk_value(*(undefined8*)( *(long*)( lVar19 + 8 ) + 8 ), iVar9);
                              if (*(char*)*puVar22 == 'R') {
                                 ...
                                 if (r_00 != (X509_REVOKED*)0x0) {
                                    ...
                                    if (( iVar7 == 0 ) || ( iVar8 = X509_REVOKED_set_revocationDate(r_00, (ASN1_TIME*)local_1118._0_8_) ),iVar7 = local_116c,iVar8 == 0) {
                                       LAB_00104d5a:a_02 = (ASN1_ENUMERATED*)0x0;
                                    }
 else {
                                       a_02 = (ASN1_ENUMERATED*)0x0;
                                       if (local_116c == -1) {
                                          LAB_00104c2f:a_00 = local_1120;
                                          if (( ( local_1120 == (ASN1_GENERALIZEDTIME*)0x0 ) || ( iVar8 = X509_REVOKED_add1_ext_i2d(r_00, 0x8e, local_1120, 0, 0) ),0 < iVar8 )) &&( ( a = local_1128 ),local_1128 == (ASN1_OBJECT*)0x0 || ( iVar8 = X509_REVOKED_add1_ext_i2d(r_00, 0x1ae, local_1128, 0, 0) ),0 < iVar8 )(iVar7 == -1);
                                          {
                                             CRYPTO_free((void*)0x0);
                                             ASN1_OBJECT_free(a);
                                    ...
                                    if (( iVar8 != 0 ) && ( iVar8 = X509_REVOKED_add1_ext_i2d(r_00, 0x8d, a_02, 0, 0) ),0 < iVar8) goto LAB_00104c2f;
                                 }
                           ...
                           LAB_00104db2:pBVar18 = (BIO*)0x0;
                           local_1318 = bn;
                           goto LAB_00102604;
                        }

                        LAB_00104b0a:}X509_CRL_sort(x_02);
                        if (local_12dc != 0) {
                        ...
                        if (lVar16 == 0 && local_12a8 == (char*)0x0) {
                           if (uVar13 != 0) {
                              ...
                              joined_r0x00104f16:if (iVar9 == 0) goto LAB_00104e7f;
                           }

                           LAB_00104f1c:BN_free(bn);
                           iVar9 = do_X509_CRL_sign(x_02, local_1310, local_12c0, local_1308);
                           if (iVar9 == 0) {
                              LAB_00102a2f:pBVar18 = (BIO*)0x0;
                           }
 else {
                              pBVar18 = (BIO*)bio_open_default(local_1260, 0x77, ( -(uint)(uVar12 == 0) & 0x7ffd ) + 4);
                              if (pBVar18 == (BIO*)0x0) goto LAB_00102ebf;
                              PEM_write_bio_X509_CRL(pBVar18, x_02);
                              if (( lVar16 == 0 ) || ( iVar9 = iVar9 != 0 )) goto LAB_00104fa4;
                           }
                        ...
                        if (local_12a8 == (char*)0x0) {
                           LAB_001050d2:pAVar33 = BN_to_ASN1_INTEGER(bn, (ASN1_INTEGER*)0x0);
                           if (pAVar33 != (ASN1_INTEGER*)0x0) {
                           ...
                           LAB_00104ee5:iVar9 = X509_CRL_set_version(x_02, 1);
                           if (iVar9 != 0) {
                              if (lVar16 != 0) {
      ...
      if (( local_12a0 != (X509_REQ*)0x0 ) || ( local_12a0 = (X509_REQ*)lookup_conf(conf, pcVar38, "policy") ),local_12a0 != (X509_REQ*)0x0) {
         BIO_printf(_bio_err, "policy is %s\n", local_12a0);
         goto LAB_001039b9;
      }

      LAB_001032c9:x_02 = (X509_CRL*)0x0;
      pBVar18 = (BIO*)0x0;
      local_12d8 = (long*)0x0;
   }

   LAB_00102604:uVar15 = 1;
   ERR_print_errors(_bio_err);
   LAB_00102616:BIO_free_all(pBVar18);
   BIO_free_all((BIO*)0x0);
   BIO_free_all((BIO*)0x0);
   ...
   LAB_00102664:BN_free(local_1168);
   BN_free(local_1318);
   free_index(lVar19);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 ca_main_cold(void) {
   BIO *unaff_RBP;
   X509 *unaff_R13;
   long in_FS_OFFSET;

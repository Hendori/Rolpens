   ...
   if (( ( out != (EVP_MD_CTX*)0x0 ) && ( ctx != (EVP_MD_CTX*)0x0 ) ) && ( iVar3 = iVar3 != 0 )) {
      ...
      if (param_6 == 0) {
         while (true) {
            ...
            if (( ( iVar2 == 0 ) || ( iVar2 = EVP_DigestUpdate(out, &local_8c, 4) ),iVar2 == 0 )) break;
...
undefined8 x963kdf_derive(long param_1, undefined8 param_2, undefined8 param_3, long *param_4) {
   ...
   iVar1 = ossl_prov_is_running();
   if (iVar1 != 0) {
      if (( ( param_4 != (long*)0x0 ) && ( *param_4 != 0 ) ) && ( iVar1 = sskdf_common_set_ctx_params(param_1, param_4) ),iVar1 == 0) {
         return 0;
      }
      ...
      if (*(long*)( param_1 + 0x28 ) == 0) {
         ...
         if (( uVar1 < 0x40000001 ) && ( uVar2 < 0x40000001 )) {
            ...
            if (puVar13 == (undefined3*)0x0) {
               ...
               if (( ( iVar5 == 0 ) || ( uVar8 = EVP_MAC_CTX_get_mac_size(uVar3) ),uVar8 == 0 )) goto LAB_00100dcb;
               ...
               while (true) {
                  ...
                  if (( ( lVar6 == 0 ) || ( iVar5 = EVP_MAC_update(lVar6, &local_8c, 4) ),iVar5 == 0 )) goto LAB_00100bff;
...
undefined8 *sskdf_dup(undefined8 *param_1) {
   ...
   *ptr = uVar1;
   ...
   if (( ( ( iVar2 != 0 ) && ( iVar2 = ossl_prov_memdup(param_1[9], param_1[10], ptr + 9, ptr + 10) ),iVar2 != 0 ) ) && ( iVar2 = ossl_prov_memdup(param_1[5], param_1[6], ptr + 5, ptr + 6) ),iVar2 != 0) {
      ptr[0xb] = param_1[0xb];

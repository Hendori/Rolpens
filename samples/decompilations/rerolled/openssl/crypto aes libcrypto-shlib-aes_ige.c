void AES_ige_encrypt(uchar *in, uchar *out, size_t length, AES_KEY *key, uchar *ivec, int enc) {
   ...
   if (length == 0) {
      LAB_0010013d:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   ...
   if (( ( ( in == (uchar*)0x0 ) || ( unaff_RBX = out ),out == (uchar*)0x0 ) ) || ( unaff_R12 = key ),key == (AES_KEY*)0x0) {
      OPENSSL_die("assertion failed: in && out && key && ivec", "crypto/aes/aes_ige.c", 0x3a);
      out = unaff_RBX;
      LAB_00100379:OPENSSL_die("assertion failed: (length % AES_BLOCK_SIZE) == 0", "crypto/aes/aes_ige.c", 0x3c);
   }
 else if ((uint)enc < 2) {
      if (( length & 0xf ) == 0) {
         uVar10 = length >> 4;
 ...
 while ( puVar24 != (ulong*)( out + uVar10 * 0x10 ) );
   ...
   OPENSSL_die("assertion failed: (AES_ENCRYPT == enc) || (AES_DECRYPT == enc)", "crypto/aes/aes_ige.c", 0x3b);
   lStack_d8 = *(long*)( in_FS_OFFSET + 0x28 );
   puStack_c8 = out;
   puStack_c0 = in;
   pAStack_b8 = unaff_R12;
   if (( ( (byte*)pcVar21 != (byte*)0x0 ) && ( (byte*)pcVar18 != (byte*)0x0 ) ) && ( ( key != (AES_KEY*)0x0 && ( pbVar16 != (byte*)0x0 ) ) )) {
      if (uStack_90 < 2) {
               ...
               if (0xf < extraout_RDX) {
                  ...
                  do {
                     *pbVar13 = bVar9 ^ *pcVar21;
                     for (int i = 0; i < 15; i++) {
                        pbVar13[( i + 1 )] = ( (byte*)pcVar21 )[( i + 1 )] ^ pbVar26[( i + 1 )];
                     }
                     ...
                     *pbVar13 = bVar9;
                     for (int i = 0; i < 15; i++) {
                        pbVar13[( i + 1 )] = pbVar13[( i + 1 )] ^ pbVar14[( i + 1 )];
                     }
 ...
 while ( pbVar23 != (byte*)pcVar18 + ( extraout_RDX - 0x10 & 0xfffffffffffffff0 ) + 0x10 );
                  ...
                  do {
                     ...
                     *pbVar13 = *pbVar13 ^ bVar9;
                     for (int i = 0; i < 15; i++) {
                        pbVar14[( i + -15 )] = pbVar14[( i + -15 )] ^ pbVar26[( i + 1 )];
                     }
                     ...
                     *pbVar13 = bVar9;
                     for (int i = 0; i < 14; i++) {
                        pbVar14[( i + -15 )] = pbVar14[( i + -15 )] ^ pbVar16[( i + 1 )];
                     }
 ...
 while ( (byte*)pcVar18 != pbVar13 );
               ...
               if (0xf < extraout_RDX) {
                  ...
                  do {
                     ...
                     uStack_100._0_3_ = CONCAT12(( byte )((ulong)uVar1 >> 0x10) ^ bStack_129, (undefined2)uStack_100);
                     uStack_100._0_5_ = CONCAT14(( byte )((ulong)uVar1 >> 0x20) ^ bVar5, CONCAT13(( byte )((ulong)uVar1 >> 0x18) ^ bVar22, (undefined3)uStack_100));
                     uStack_100._0_6_ = CONCAT15(( byte )((ulong)uVar1 >> 0x28) ^ bVar6, (undefined5)uStack_100);
                     uStack_100._0_7_ = CONCAT16(( byte )((ulong)uVar1 >> 0x30) ^ bVar19, (undefined6)uStack_100);
                     ...
                     uStack_f8._0_3_ = CONCAT12(( byte )((ulong)uVar2 >> 0x10) ^ bStack_12d, (undefined2)uStack_f8);
                     uStack_f8._0_4_ = CONCAT13(( byte )((ulong)uVar2 >> 0x18) ^ bStack_140, (undefined3)uStack_f8);
                     uStack_f8._0_5_ = CONCAT14(( byte )((ulong)uVar2 >> 0x20) ^ bStack_148, (undefined4)uStack_f8);
                     uStack_f8._0_6_ = CONCAT15(( byte )((ulong)uVar2 >> 0x28) ^ bVar17, (undefined5)uStack_f8);
 ...
 while ( pbVar26 != pbVar12 );
                  ...
                  do {
                     ...
                     uVar2 = *(undefined8*)( pbVar26 + 8 );
                     uStack_100._0_2_ = CONCAT11(bVar9 ^ ( byte )((ulong)uVar1 >> 8), bVar27 ^ (byte)uVar1);
                     uStack_100._0_3_ = CONCAT12(( byte )((ulong)uVar1 >> 0x10) ^ bVar22, (undefined2)uStack_100);
                     uStack_100._0_5_ = CONCAT14(( byte )((ulong)uVar1 >> 0x20) ^ bVar7, CONCAT13(( byte )((ulong)uVar1 >> 0x18) ^ bStack_12a, (undefined3)uStack_100));
                     uStack_100._0_6_ = CONCAT15(( byte )((ulong)uVar1 >> 0x28) ^ bStack_148, (undefined5)uStack_100);
                     uStack_100._0_7_ = CONCAT16(( byte )((ulong)uVar1 >> 0x30) ^ bStack_140, (undefined6)uStack_100);
                     uStack_100 = CONCAT17(( byte )((ulong)uVar1 >> 0x38) ^ bStack_12d, (undefined7)uStack_100);
                     uStack_f8._0_2_ = CONCAT11(bStack_12b ^ ( byte )((ulong)uVar2 >> 8), bStack_12c ^ (byte)uVar2);
                     ...
                     uStack_f8._0_5_ = CONCAT14(( byte )((ulong)uVar2 >> 0x20) ^ bVar19, (undefined4)uStack_f8);
                     uStack_f8._0_6_ = CONCAT15(( byte )((ulong)uVar2 >> 0x28) ^ bVar17, (undefined5)uStack_f8);
                     uStack_f8._0_7_ = CONCAT16(( byte )((ulong)uVar2 >> 0x30) ^ bVar20, (undefined6)uStack_f8);
 ...
 while ( pbVar14 != pbVar13 );
      ...
      OPENSSL_die("assertion failed: (AES_ENCRYPT == enc) || (AES_DECRYPT == enc)", "crypto/aes/aes_ige.c", 0xc9);
   }

   OPENSSL_die("assertion failed: in && out && key && ivec", "crypto/aes/aes_ige.c", 200);
   LAB_00100d0e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
void AES_bi_ige_encrypt(uchar *in, uchar *out, size_t length, AES_KEY *key, AES_KEY *key2, uchar *ivec, int enc) {
   undefined8 uVar1;
   undefined8 uVar2;
   byte *pbVar3;
   byte bVar4;
   ...
   long local_40;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (( ( ( in != (uchar*)0x0 ) && ( out != (uchar*)0x0 ) ) && ( key != (AES_KEY*)0x0 ) ) && ( ivec != (uchar*)0x0 )) {
      if ((uint)enc < 2) {
         if (( length & 0xf ) == 0) {
            if (enc == 1) {
               if (0xf < length) {
                  ...
                  do {
                     ...
                     *pbVar11 = bVar8;
                     for (int i = 0; i < 15; i++) {
                        pbVar11[( i + 1 )] = pbVar11[( i + 1 )] ^ pbVar12[( i + 1 )];
                     }
 ...
 while ( pbVar10 != out + ( length - 0x10 & 0xfffffffffffffff0 ) + 0x10 );
                  ...
                  do {
                     ...
                     *pbVar10 = *pbVar10 ^ bVar8;
                     for (int i = 0; i < 15; i++) {
                        pbVar12[( i + -15 )] = pbVar12[( i + -15 )] ^ pbVar3[( i + 1 )];
                     }
                     ...
                     *pbVar10 = bVar8;
                     for (int i = 0; i < 14; i++) {
                        pbVar12[( i + -15 )] = pbVar12[( i + -15 )] ^ pbVar11[( i + 1 )];
                     }
 ...
 while ( out != pbVar10 );
               ...
               if (0xf < length) {
                  ...
                  do {
                     ...
                     local_68._0_3_ = CONCAT12(( byte )((ulong)uVar1 >> 0x10) ^ local_91, (undefined2)local_68);
                     local_68._0_5_ = CONCAT14(( byte )((ulong)uVar1 >> 0x20) ^ bVar4, CONCAT13(( byte )((ulong)uVar1 >> 0x18) ^ bVar16, (undefined3)local_68));
                     ...
                     uStack_60._0_3_ = CONCAT12(( byte )((ulong)uVar2 >> 0x10) ^ local_95, (undefined2)uStack_60);
                     uStack_60._0_4_ = CONCAT13(( byte )((ulong)uVar2 >> 0x18) ^ local_a8, (undefined3)uStack_60);
                     uStack_60._0_5_ = CONCAT14(( byte )((ulong)uVar2 >> 0x20) ^ local_b0, (undefined4)uStack_60);
                     uStack_60._0_6_ = CONCAT15(( byte )((ulong)uVar2 >> 0x28) ^ bVar13, (undefined5)uStack_60);
 ...
 while ( puVar18 != puVar9 );
                  ...
                  do {
                     ...
                     local_68._0_5_ = CONCAT14(( byte )((ulong)uVar1 >> 0x20) ^ bVar6, CONCAT13(( byte )((ulong)uVar1 >> 0x18) ^ local_92, (undefined3)local_68));
                     local_68._0_6_ = CONCAT15(( byte )((ulong)uVar1 >> 0x28) ^ local_b0, (undefined5)local_68);
                     local_68._0_7_ = CONCAT16(( byte )((ulong)uVar1 >> 0x30) ^ local_a8, (undefined6)local_68);
                     local_68 = CONCAT17(( byte )((ulong)uVar1 >> 0x38) ^ local_95, (undefined7)local_68);
                     uStack_60._0_2_ = CONCAT11(local_93 ^ ( byte )((ulong)uVar2 >> 8), local_94 ^ (byte)uVar2);
                     ...
                     uStack_60._0_5_ = CONCAT14(( byte )((ulong)uVar2 >> 0x20) ^ bVar14, (undefined4)uStack_60);
                     uStack_60._0_6_ = CONCAT15(( byte )((ulong)uVar2 >> 0x28) ^ bVar13, (undefined5)uStack_60);
                     uStack_60._0_7_ = CONCAT16(( byte )((ulong)uVar2 >> 0x30) ^ bVar15, (undefined6)uStack_60);

...
bool shake_squeeze_no_absorb_test(void) {
   ...
   if (iVar1 != 0) {
      ...
      iVar1 = test_true("test/evp_xof_test.c", 0x201, "EVP_DigestFinalXOF(ctx, out, sizeof(out))", iVar1 != 0);
      if (iVar1 != 0) {
         ...
         if (iVar1 != 0) {
            ...
            iVar1 = test_true("test/evp_xof_test.c", 0x205, "EVP_DigestSqueeze(ctx, out2, sizeof(out2) / 2)", iVar1 != 0);
            if (iVar1 != 0) {
               iVar1 = EVP_DigestSqueeze(uVar2, local_224, 500);
               iVar1 = test_true("test/evp_xof_test.c", 0x206, "EVP_DigestSqueeze(ctx, out2 + sizeof(out2) / 2, sizeof(out2) / 2)", iVar1 != 0);
               if (iVar1 != 0) {
                  iVar1 = test_mem_eq("test/evp_xof_test.c", 0x20a, &_LC11, &_LC10, local_418, 1000, auStack_808, 1000);
                  bVar3 = iVar1 != 0;
                  goto LAB_00100117;
               }
   ...
   bVar3 = false;
   LAB_00100117:EVP_MD_CTX_free(uVar2);
...
undefined8 shake_absorb_test(void) {
   ...
   if (iVar1 == 0) {
      ...
      do {
         ...
         do {
            ...
            uVar5 = uVar4 + cnt;
            if (0x2ac < uVar5) {
               iVar1 = EVP_DigestUpdate(ctx, shake256_largemsg_input + uVar4, 0x2ac - uVar4);
               iVar1 = test_true("test/evp_xof_test.c", 0x12e, "EVP_DigestUpdate(ctx, shake256_largemsg_input + i, sz)", iVar1 != 0);
               if (iVar1 == 0) goto LAB_001003b4;
               break;
            }
 ...
 while ( uVar5 != 0x2ac );
         ...
         iVar1 = test_true("test/evp_xof_test.c", 0x132, "EVP_DigestFinalXOF(ctx, out, sizeof(out))", iVar1 != 0);
         if (( iVar1 == 0 ) || ( iVar1 = test_mem_eq("test/evp_xof_test.c", 0x133, &_LC10, "shake256_largemsg_output", auStack_68, 0x20, shake256_largemsg_output, 0x20) ),iVar1 == 0) {
            LAB_001003b4:uVar3 = 0;
            goto LAB_001003b7;
         }
 ...
 while ( lVar2 != 0x2ac );
      uVar3 = 1;
      LAB_001003b7:EVP_MD_CTX_free(ctx);
   }
...
uint shake_kat_test(void) {
   ...
   if (uVar1 == 0) goto LAB_00100557;
   iVar2 = EVP_DigestUpdate(ctx, shake256_input, 0x20);
   iVar2 = test_true("test/evp_xof_test.c", 0xba, "EVP_DigestUpdate(ctx, shake256_input, sizeof(shake256_input))", iVar2 != 0);
   if (iVar2 == 0) {
      LAB_001005e8:uVar1 = 0;
   }
 else {
      iVar2 = EVP_DigestFinalXOF(ctx, auStack_138, 0xfa);
      iVar2 = test_true("test/evp_xof_test.c", 0xbc, "EVP_DigestFinalXOF(ctx, out, sizeof(out))", iVar2 != 0);
      if (iVar2 == 0) goto LAB_001005e8;
      iVar2 = test_mem_eq("test/evp_xof_test.c", 0xbd, &_LC10, "shake256_output", auStack_138, 0xfa, shake256_output, 0xfa);
      if (iVar2 == 0) goto LAB_001005e8;
      iVar2 = EVP_DigestFinalXOF(ctx, auStack_138, 0xfa);
      iVar2 = test_false("test/evp_xof_test.c", 0xc0, "EVP_DigestFinalXOF(ctx, out, sizeof(out))", iVar2 != 0);
      if (iVar2 == 0) goto LAB_001005e8;
      iVar2 = EVP_DigestSqueeze(ctx, auStack_138, 0xfa);
      iVar2 = test_false("test/evp_xof_test.c", 0xc2, "EVP_DigestSqueeze(ctx, out, sizeof(out))", iVar2 != 0);
      uVar1 = ( uint )(iVar2 != 0);
   }

   EVP_MD_CTX_free(ctx);
   LAB_00100557:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar1;
   }
...
ulong do_shake_squeeze_test(int param_1, void *param_2, size_t param_3, undefined8 param_4, ulong param_5) {
   int iVar1;
   uint uVar2;
   EVP_MD_CTX *ctx;
   ulong uVar3;
   ...
   ulong uVar4;
   long lVar5;
   lVar5 = *(long*)( stride_tests + (long)param_1 * 0x10 );
   ctx = (EVP_MD_CTX*)shake_setup("SHAKE256");
   ...
   if (iVar1 != 0) {
      ...
      if (iVar1 != 0) {
         ...
         do {
            uVar4 = uVar3 + lVar5;
            if (param_5 < uVar4) {
               iVar1 = EVP_DigestSqueeze(ctx, uVar3 + (long)ptr, param_5 - uVar3);
               iVar1 = test_true("test/evp_xof_test.c", 0x185, "EVP_DigestSqueeze(ctx, out + i, sz)", iVar1 != 0);
               if (iVar1 == 0) goto LAB_00100800;
               break;
            }

            iVar1 = EVP_DigestSqueeze(ctx, uVar3 + (long)ptr, lVar5);
            iVar1 = test_true("test/evp_xof_test.c", 0x185, "EVP_DigestSqueeze(ctx, out + i, sz)", iVar1 != 0);
            if (iVar1 == 0) goto LAB_00100800;
            lVar5 = *(long*)( stride_tests + (long)param_1 * 0x10 + 8 );
            uVar3 = uVar4;
         }
 while ( uVar4 < param_5 );
         iVar1 = test_mem_eq("test/evp_xof_test.c", 0x18a, &_LC10, "expected_out", ptr, param_5, param_4, param_5);
         uVar2 = ( uint )(iVar1 != 0);
         goto LAB_00100802;
      }
   ...
   LAB_00100800:uVar2 = 0;
   LAB_00100802:CRYPTO_free(ptr);
   EVP_MD_CTX_free(ctx);
   return (ulong)uVar2;
}
int shake_squeeze_large_test(undefined4 param_1) {
   ...
   if (iVar1 == 0) goto LAB_001008f9;
   ctx = (EVP_MD_CTX*)shake_setup("SHAKE256");
   iVar1 = test_ptr("test/evp_xof_test.c", 0x1a7, "ctx = shake_setup(\"SHAKE256\")", ctx);
   if (iVar1 != 0) {
      iVar1 = EVP_DigestUpdate(ctx, auStack_818, 0x10);
      iVar1 = test_true("test/evp_xof_test.c", 0x1a8, "EVP_DigestUpdate(ctx, msg, sizeof(msg))", iVar1 != 0);
      if (iVar1 == 0) goto LAB_001008f9;
      iVar1 = EVP_DigestFinalXOF(ctx, local_808, 2000);
      iVar1 = test_true("test/evp_xof_test.c", 0x1a9, "EVP_DigestFinalXOF(ctx, out, sizeof(out))", iVar1 != 0);
      if (iVar1 != 0) {
   ...
   iVar1 = 0;
   LAB_001008f9:EVP_MD_CTX_free(ctx);
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar1;
   }
...
bool shake_kat_digestfinal_test(void) {
   ...
   if (iVar1 != 0) {
      ...
      iVar1 = test_true("test/evp_xof_test.c", 0xd4, "EVP_DigestUpdate(ctx, shake256_input, sizeof(shake256_input))", iVar1 != 0);
      if (iVar1 != 0) {
         ERR_set_mark();
         iVar1 = EVP_DigestFinal(pEVar2, local_148, &local_14c);
         iVar1 = test_false("test/evp_xof_test.c", 0xd8, "EVP_DigestFinal(ctx, out, &digest_length)", iVar1 != 0);
         if (iVar1 == 0) {
            ERR_clear_last_mark();
         }
 else {
            ...
            if (iVar1 != 0) {
               iVar1 = EVP_DigestUpdate(pEVar2, shake256_input, 0x20);
               iVar1 = test_true("test/evp_xof_test.c", 0xe2, "EVP_DigestUpdate(ctx, shake256_input, sizeof(shake256_input))", iVar1 != 0);
               if (iVar1 != 0) {
                  iVar1 = EVP_DigestFinalXOF(pEVar2, local_148, 0xfa);
                  iVar1 = test_true("test/evp_xof_test.c", 0xe5, "EVP_DigestFinalXOF(ctx, out, sizeof(out))", iVar1 != 0);
                  if (iVar1 == 0) {
                     LAB_00100c60:bVar3 = false;
                  }
 else {
                     iVar1 = test_mem_eq("test/evp_xof_test.c", 0xe6, &_LC10, "shake256_output", local_148, 0xfa);
                     if (iVar1 == 0) goto LAB_00100c60;
                     iVar1 = EVP_DigestFinalXOF(pEVar2, local_148, 0xfa, 0xfa);
                     iVar1 = test_false("test/evp_xof_test.c", 0xe8, "EVP_DigestFinalXOF(ctx, out, sizeof(out))", iVar1 != 0);
                     bVar3 = iVar1 != 0;
                  }
   ...
   bVar3 = false;
   LAB_00100a89:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return bVar3;
   }
...
uint shake_kat_digestfinal_xoflen_test(void) {
   ...
   if (iVar4 == 0) {
      LAB_00100dfd:uVar2 = 0;
   }
 else {
      uVar3 = EVP_MD_CTX_set_params(ctx, &local_198);
      iVar4 = test_int_eq("test/evp_xof_test.c", 0x107, "EVP_MD_CTX_set_params(ctx, params)", &_LC33, uVar3, 1);
      uVar1 = local_1a0;
      if (iVar4 == 0) goto LAB_00100dfd;
      uVar3 = EVP_MD_CTX_get_size_ex(ctx);
      iVar4 = test_int_eq("test/evp_xof_test.c", 0x108, "EVP_MD_CTX_size(ctx)", &_LC35, uVar3, uVar1 & 0xffffffff);
      if (iVar4 == 0) goto LAB_00100dfd;
      ...
      iVar4 = test_true("test/evp_xof_test.c", 0x10b, "EVP_DigestUpdate(ctx, shake256_input, sizeof(shake256_input))", iVar4 != 0);
      if (iVar4 == 0) goto LAB_00100dfd;
      iVar4 = EVP_DigestFinal(ctx, local_148, &local_1a4);
      iVar4 = test_true("test/evp_xof_test.c", 0x10d, "EVP_DigestFinal(ctx, out, &digest_length)", iVar4 != 0);
      if (iVar4 == 0) goto LAB_00100dfd;
      iVar4 = test_uint_eq("test/evp_xof_test.c", 0x10e, "digest_length", "(unsigned int)sz", local_1a4, local_1a0 & 0xffffffff);
      if (iVar4 == 0) goto LAB_00100dfd;
      iVar4 = test_mem_eq("test/evp_xof_test.c", 0x10f, &_LC10, "shake256_output", local_148, local_1a4, shake256_output, local_1a4);
      if (iVar4 == 0) goto LAB_00100dfd;
      iVar4 = test_uchar_eq("test/evp_xof_test.c", 0x111, "out[digest_length]", &_LC26, local_148[local_1a4], 0);
      uVar2 = ( uint )(iVar4 != 0);
   }

   EVP_MD_CTX_free(ctx);
   LAB_00100cdc:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar2;
   }
...
uint shake_squeeze_dup_test(int param_1) {
   ...
   if (iVar2 != 0) {
      ...
      iVar2 = test_true("test/evp_xof_test.c", 0x1ec, "EVP_DigestUpdate(ctx, msg, sizeof(msg))", iVar2 != 0);
      if (iVar2 != 0) {
         iVar2 = EVP_DigestFinalXOF(ctx, local_428, 1000);
         iVar2 = test_true("test/evp_xof_test.c", 0x1ed, "EVP_DigestFinalXOF(ctx, out, sizeof(out))", iVar2 != 0);
         if (iVar2 != 0) {
            ...
            if (iVar2 != 0) {
               ...
               if (iVar2 == 0) {
                  LAB_001012b8:uVar3 = 0;
               }
 else {
                  iVar2 = EVP_DigestUpdate(ctx_00, local_438, 0x10);
                  iVar2 = test_true("test/evp_xof_test.c", 0x1c7, "EVP_DigestUpdate(ctx, in, inlen)", iVar2 != 0);
                  if (iVar2 == 0) goto LAB_001012b8;
                  lVar6 = 10;
                  uVar5 = 0;
                  pEVar4 = ctx_00;
                  do {
                     ...
                     iVar2 = EVP_DigestSqueeze(pEVar4, (long)ptr + uVar5, lVar6);
                     iVar2 = test_true("test/evp_xof_test.c", 0x1cd, "EVP_DigestSqueeze(cur, out + i, sz)", iVar2 != 0);
                     if (iVar2 == 0) {
                        uVar3 = 0;
                        goto LAB_00101280;
                     }

                     if (( pEVar8 == (EVP_MD_CTX*)0x0 ) && ( uVar1 <= uVar7 )) {
 ...
 while ( uVar7 != 1000 );
                  iVar2 = test_mem_eq("test/evp_xof_test.c", 0x1d7, &_LC10, "expected_out", ptr, 1000, local_428, 1000);
                  uVar3 = ( uint )(iVar2 != 0);
               }

               LAB_00101280:CRYPTO_free(ptr);
               EVP_MD_CTX_free(ctx_00);
               EVP_MD_CTX_free(pEVar8);
               goto LAB_0010100f;
            }
   ...
   uVar3 = 0;
   LAB_0010100f:EVP_MD_CTX_free(ctx);
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }

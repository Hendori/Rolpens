uint sanitize_line(short *param_1, uint param_2, uint param_3, int param_4) {
   ...
   if (( param_4 == 0 ) || ( (int)param_2 < 4 )) {
      if (( param_3 & 2 ) != 0) {
         ...
         LAB_00100090:iVar5 = param_2 + 1;
         psVar11 = (short*)( (long)iVar5 + (long)param_1 );
         LAB_0010009a:uVar8 = iVar5 + 1;
         LAB_0010009e:lVar6 = (long)(int)uVar8;
         goto LAB_001000a1;
      }
      ...
      if (( *param_1 == -0x4411 ) && ( (char)param_1[1] == -0x41 )) {
         ...
         *(char*)( (long)param_1 + ( uVar7 - 3 ) ) = '\0';
         if (( param_3 & 2 ) != 0) {
            uVar7 = (ulong)param_2;
            LAB_0010006a:psVar3 = (short*)( (long)(int)uVar7 + (long)param_1 );
            do {
               psVar11 = psVar3;
               param_2 = (uint)uVar7;
...
void PEM_proc_type(char *buf, int type) {
   ...
   sVar1 = strlen(buf);
   pcVar2 = "MIC-ONLY";
   if (( ( type != 0x14 ) && ( pcVar2 = "MIC-CLEAR" ),type != 0x1e )) {
      pcVar2 = "BAD-TYPE";
   }
...
int PEM_do_header(EVP_CIPHER_INFO *cipher, uchar *data, long *len, undefined1 *callback, void *u) {
   ...
   LAB_00100592:iVar1 = 0;
   LAB_00100594:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar1;
   }
...
int PEM_write_bio(BIO *bp, char *name, char *hdr, uchar *data, long len) {
   ...
   if (ctx == (EVP_ENCODE_CTX*)0x0) {
      ...
      if (iVar1 == 0xb) {
         ...
         if (( iVar1 == iVar3 ) && ( iVar1 = iVar1 == 6 )) {
            if (hdr != (char*)0x0) {
               sVar4 = strlen(hdr);
               iVar1 = (int)sVar4;
               if (( 0 < iVar1 ) && ( ( iVar6 = BIO_write(bp, hdr, iVar1) ),iVar6 != iVar1 || ( iVar1 = BIO_write(bp, &_LC17, 1) ),iVar1 != 1 )) goto LAB_00100ba1;
            }
            ...
            if (len < 1) {
               ...
               do {
                  ...
                  if (( local_44 != 0 ) && ( iVar2 = iVar2 != local_44 )) goto LAB_00100d44;
                  len = len - lVar7;
 ...
 while ( 0 < len );
            ...
            if (( ( ( local_44 < 1 ) || ( iVar6 = BIO_write(bp, out, local_44) ),iVar6 == local_44 ) ) && ( iVar6 = iVar6 == 9 )) {
               iVar1 = iVar1 + local_44;
               goto LAB_00100bdb;
            }

            LAB_00100d44:uVar5 = 0x80020;
            goto LAB_00100bb0;
         }

      }

      LAB_00100ba1:uVar5 = 0x80020;
      out = (uchar*)0x0;
   }

   LAB_00100bb0:ERR_new();
   ERR_set_debug("crypto/pem/pem_lib.c", 700, "PEM_write_bio");
   iVar1 = 0;
   ERR_set_error(9, uVar5, 0);
   LAB_00100bdb:EVP_ENCODE_CTX_free(ctx);
...
bool PEM_ASN1_write_bio_internal(code *param_1, code *param_2, undefined8 param_3, char *param_4, BIO *param_5, undefined8 param_6, EVP_CIPHER *param_7, uchar *param_8, int param_9, code *param_10, void *param_11) {
   int iVar1;
   char *__s;
   EVP_MD *md;
   EVP_CIPHER_CTX *ctx;
   ...
   if (param_7 == (EVP_CIPHER*)0x0) {
      __s = (char*)0x0;
      LAB_00101003:if (param_2 == (code*)0x0 && param_1 == (code*)0x0) {
         ERR_new();
      ...
      if (0 < iVar1) {
         ...
         if (param_7 == (EVP_CIPHER*)0x0) {
            local_448[0] = '\0';
            ctx = (EVP_CIPHER_CTX*)0x0;
            LAB_001012c2:local_4a8 = PEM_write_bio(param_5, param_4, (char*)local_448, local_4e8, (long)local_4a8);
            bVar5 = 0 < local_4a8;
         }
 else {
            if (param_8 == (uchar*)0x0) {
               ...
               LAB_00101094:iVar1 = EVP_CIPHER_get_iv_length(param_7);
               ...
               if (0 < iVar1) {
                  ...
                  if (iVar1 != 0) {
                     ...
                     if (ctx != (EVP_CIPHER_CTX*)0x0) {
                        ...
                        if (( ( iVar1 == 0 ) || ( iVar1 = EVP_EncryptUpdate(ctx, local_4e8, &local_4a4, local_4e8, local_4a8) ),iVar1 == 0 )) {
                           bVar5 = false;
                           goto LAB_00100f8c;
                        }
      ...
      uVar3 = 0x71;
      uVar4 = 9;
      LAB_00100f5d:ERR_set_error(uVar4, uVar3, 0);
   }
   ...
   local_4e8 = (uchar*)0x0;
   local_4e0 = 0;
   LAB_00100f8c:OPENSSL_cleanse(local_488, 0x40);
...
int PEM_ASN1_write_bio(undefined1 *i2d, char *name, BIO *bp, void *x, EVP_CIPHER *enc, uchar *kstr, int klen, undefined1 *cb, void *u) {
   int iVar1;
   iVar1 = PEM_ASN1_write_bio_internal(i2d, 0, 0, name, bp, x, enc, kstr, klen, cb, u);
   return iVar1;
}
int PEM_ASN1_write(undefined1 *i2d, char *name, FILE *fp, void *x, EVP_CIPHER *enc, uchar *kstr, int klen, undefined1 *callback, void *u) {
   int iVar1;
   BIO_METHOD *type;
   BIO *bp;
   type = BIO_s_file();
...
void PEM_ASN1_write_bio_ctx(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6, undefined8 param_7, undefined4 param_8, undefined8 param_9, undefined8 param_10) {
   PEM_ASN1_write_bio_internal(0, param_1, param_2, param_3, param_4, param_5, param_6, param_7, param_8, param_9, param_10);
   return;
}
...
undefined4 PEM_read_bio_ex(BIO *param_1, undefined8 *param_2, long *param_3, long *param_4, long *param_5, uint param_6) {
   bool bVar1;
   bool bVar2;
   char *pcVar3;
   uint uVar4;
...
;
               ...
               if (uVar4 != 0) {
                  LAB_0010196b:CRYPTO_secure_clear_free(pcVar9, 0x100, "crypto/pem/pem_lib.c", 0x332);
                  goto LAB_00101981;
               }

               LAB_00101a68:CRYPTO_free(pcVar9);
            }
   ...
   LAB_00101a35:EVP_ENCODE_CTX_free(ctx);
   if (uVar4 == 0) {
      LAB_00101a49:CRYPTO_free(local_88);
      goto LAB_001019a9;
   }

   goto LAB_00101994;
   LAB_00101855:iVar6 = BIO_gets(param_1, pcVar9, 0xff);
   if (iVar6 < 1) {
      ERR_new();
      uVar14 = 0x35d;
      LAB_00101b0e:ERR_set_debug("crypto/pem/pem_lib.c", uVar14, "get_header_and_data");
   ...
   if (iVar7 == 0) {
      ...
      if (local_50 != 0) {
         ...
         if (ctx != (EVP_ENCODE_CTX*)0x0) {
            ...
            if (( iVar5 < 0 ) || ( iVar5 = EVP_DecodeFinal(ctx, (uchar*)( (long)local_50 + local_48[1] ), &local_4c) ),iVar5 < 0) {
               ERR_new();
               uVar16 = 0;
            ...
            *local_48 = (long)local_50;
            ...
            if (uVar4 == 0) {
               ...
               *param_4 = (long)pvVar12;
               if (( pvVar11 != (void*)0x0 ) && ( pvVar12 != (void*)0x0 )) goto LAB_00101e11;
               LAB_00101f6f:CRYPTO_free(pvVar11);
               *param_3 = 0;
               ...
               *param_4 = lVar10;
               if (( pvVar11 != (void*)0x0 ) && ( lVar10 != 0 )) {
                  LAB_00101e11:if (iVar5 == 0) {
                     LAB_00101e32:*(undefined1*)( (long)pvVar11 + (long)iVar5 ) = 0;
   ...
   if (( iVar7 < 0 ) || ( ( bVar1 = bVar17 ),iVar5 == 2 && ( bVar18 = iVar6 != 0x41 ),0x41 < iVar6 )) goto LAB_00101bb4;
   goto LAB_00101855;
   LAB_00101bb4:if (uVar4 == 0) {
      LAB_00101b38:CRYPTO_free(pcVar9);
      LAB_00101b49:uVar16 = 0;
      EVP_ENCODE_CTX_free(0);
      goto LAB_00101a49;
   }

   LAB_00101bc5:CRYPTO_secure_clear_free(pcVar9, 0x100, "crypto/pem/pem_lib.c", 0x3aa);
   LAB_00101bdb:uVar16 = 0;
   EVP_ENCODE_CTX_free(0);
   LAB_00101994:CRYPTO_secure_clear_free(local_88, 0, "crypto/pem/pem_lib.c", 0x403);
   LAB_001019a9:BIO_free(local_90);
   BIO_free(local_a8);
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
...
bool check_pem(char *param_1, char *param_2) {
   int iVar1;
   int iVar2;
   ...
   if (iVar1 == 0) goto LAB_001021e0;
   iVar1 = strcmp(param_2, "ANY PRIVATE KEY");
   if (iVar1 == 0) {
      iVar1 = strcmp(param_1, "ENCRYPTED PRIVATE KEY");
      if (( iVar1 == 0 ) || ( iVar1 = iVar1 == 0 )) goto LAB_001021e0;
      iVar1 = ossl_pem_check_suffix(param_1, "PRIVATE KEY");
      if (( 0 < iVar1 ) && ( pEVar3 = EVP_PKEY_asn1_find_str((ENGINE**)0x0, param_1, iVar1) ),pEVar3 != (EVP_PKEY_ASN1_METHOD*)0x0) {
         bVar4 = *(long*)( pEVar3 + 0xb8 ) != 0;
         goto LAB_001021e0;
      }

   }
 else {
      iVar1 = strcmp(param_2, "PARAMETERS");
      if (iVar1 == 0) {
         iVar1 = ossl_pem_check_suffix(param_1, "PARAMETERS");
         if (( 0 < iVar1 ) && ( pEVar3 = EVP_PKEY_asn1_find_str(&local_38, param_1, iVar1) ),pEVar3 != (EVP_PKEY_ASN1_METHOD*)0x0) {
            bVar4 = *(long*)( pEVar3 + 0x70 ) != 0;
         ...
         iVar1 = strcmp(param_1, "X9.42 DH PARAMETERS");
         if (( iVar1 == 0 ) && ( iVar1 = iVar1 == 0 )) goto LAB_001021e0;
         iVar1 = strcmp(param_1, "X509 CERTIFICATE");
         if (iVar1 == 0) {
            bVar4 = true;
            iVar2 = strcmp(param_2, "CERTIFICATE");
            if (iVar2 == 0) goto LAB_001021e0;
         }

         iVar2 = strcmp(param_1, "NEW CERTIFICATE REQUEST");
         if (iVar2 == 0) {
            bVar4 = true;
            iVar2 = strcmp(param_2, "CERTIFICATE REQUEST");
            if (iVar2 == 0) goto LAB_001021e0;
         }
         ...
         if (iVar2 == 0) {
            bVar4 = true;
            iVar1 = strcmp(param_2, "TRUSTED CERTIFICATE");
            if (( iVar1 == 0 ) || ( iVar1 = iVar1 == 0 )) goto LAB_001021e0;
            iVar1 = strcmp(param_2, "CMS");
            joined_r0x001023e8:bVar4 = true;
            if (iVar1 == 0) goto LAB_001021e0;
         }
 else {
            if (iVar1 == 0) {
            ...
            iVar1 = strcmp(param_1, "PKCS #7 SIGNED DATA");
            if (iVar1 == 0) {
               iVar1 = strcmp(param_2, "PKCS7");
               goto joined_r0x001023e8;
            }

         }

         iVar1 = strcmp(param_1, "PKCS7");
         if (iVar1 == 0) {
            iVar1 = strcmp(param_2, "CMS");
            bVar4 = iVar1 == 0;
            goto LAB_001021e0;
   ...
   bVar4 = false;
   LAB_001021e0:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return bVar4;
   }
...
undefined8 PEM_bytes_read_bio_secmem(undefined8 *param_1, long *param_2, undefined8 *param_3, undefined8 param_4, undefined8 param_5, undefined1 *param_6, void *param_7) {
   int iVar1;
   uint uVar2;
   ulong uVar3;
   undefined8 uVar4;
   ...
   local_60 = 0;
   do {
      CRYPTO_secure_clear_free(local_78, 0, "crypto/pem/pem_lib.c", 0xfe);
      CRYPTO_secure_clear_free(local_70, 0, "crypto/pem/pem_lib.c", 0xff);
      CRYPTO_secure_clear_free(local_68, local_60, "crypto/pem/pem_lib.c", 0x100);
      iVar1 = PEM_read_bio_ex(param_5, &local_78, &local_70, &local_68, &local_60, 3);
      if (iVar1 == 0) {
      ...
      iVar1 = check_pem(local_78);
   }
 while ( iVar1 == 0 );
   iVar1 = PEM_get_EVP_CIPHER_INFO(local_70, &local_58);
   if (( iVar1 == 0 ) || ( iVar1 = PEM_do_header(&local_58, local_68, &local_60, param_6, param_7) ),iVar1 == 0) {
      CRYPTO_secure_clear_free(local_78, 0, "crypto/pem/pem_lib.c", 0x116);
      CRYPTO_secure_clear_free(local_70, 0, "crypto/pem/pem_lib.c", 0x117);
      CRYPTO_secure_clear_free(local_68, local_60, "crypto/pem/pem_lib.c", 0x119);
      LAB_0010258b:uVar4 = 0;
   }
 else {
      *param_1 = local_68;
      *param_2 = local_60;
...
int PEM_bytes_read_bio(uchar **pdata, long *plen, char **pnm, char *name, BIO *bp, undefined1 *cb, void *u) {
   ...
   do {
      ...
      iVar1 = PEM_read_bio_ex(bp, &local_78, &local_70, &local_68, &local_60, 2);
      if (iVar1 == 0) {
         uVar3 = ERR_peek_error();
         uVar2 = (uint)uVar3 & 0x7fffffff;
         if (( uVar3 & 0x80000000 ) == 0) {
      ...
      iVar1 = check_pem(local_78, name);
   }
 while ( iVar1 == 0 );
   iVar1 = PEM_get_EVP_CIPHER_INFO(local_70, &local_58);
   if (( iVar1 == 0 ) || ( iVar1 = PEM_do_header(&local_58, local_68, &local_60, cb, u) ),iVar1 == 0) {
      CRYPTO_free(local_78);
      CRYPTO_free(local_70);
      CRYPTO_free(local_68);
      LAB_001027e2:iVar1 = 0;
   }
 else {
      *pdata = local_68;
      *plen = local_60;

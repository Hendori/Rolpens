...
undefined8 tls13_validate_record_header(long param_1, int *param_2) {
   ...
   if (iVar1 == 0x17) {
      ...
      if (iVar1 == 0x14) {
         ...
         joined_r0x001000a8:if (iVar1 != 0) goto LAB_00100044;
      }
 else if (iVar1 == 0x15) {
...
undefined8 tls13_add_record_padding(long param_1, char *param_2, undefined8 param_3, long param_4) {
   ...
   if (( *(int*)( param_1 + 0x10d0 ) == 0 ) || ( *param_2 == '\x15' )) {
      ...
      if (iVar3 == 0) {
         ERR_new();
         uVar6 = 0x14f;
         LAB_00100261:ERR_set_debug("ssl/record/methods/tls13_meth.c", uVar6, "tls13_add_record_padding");
...
bool tls13_post_process_record(undefined8 param_1, long param_2) {
 ...
 while ( uVar2 != 0 );
   ...
   LAB_0010034f:iVar1 = tls13_common_post_process_record(param_1);
   return iVar1 != 0;
}
bool tls13_cipher(long param_1, int *param_2, long param_3, int param_4) {
   ...
   if (param_3 == 1) {
      ...
      if (ctx != (EVP_CIPHER_CTX*)0x0) {
         if (param_2[1] == 0x15) {
            LAB_00100582:memmove(*(void**)( param_2 + 8 ), *(void**)( param_2 + 10 ), *(size_t*)( param_2 + 2 ));
         ...
         if (*(long*)( param_1 + 0x1028 ) == 0) {
            ...
            LAB_00100486:uVar5 = EVP_MAC_CTX_get_mac_size();
         }
         ...
         if (param_4 == 0) {
            ...
            LAB_00100531:bVar8 = false;
            goto LAB_00100538;
         }

         LAB_001004b1:if (uVar5 < 8) {
            ERR_new();
            uVar7 = 0x9d;
            goto LAB_001005b9;
         }
         ...
         __n = uVar5 - 8;
         memcpy(iv, __src, __n);
         pbVar1 = (byte*)( (long)__src + ( uVar5 - 7 ) );
         puVar2 = (ulong*)( iv + __n );
         if (( ( ulong )((long)puVar2 - ( param_1 + 0x1001 )) < 7 ) || ( ( ulong )((long)puVar2 - (long)pbVar1) < 7 )) {
            *(byte*)puVar2 = *(byte*)( (long)__src + __n ) ^ *(byte*)( param_1 + 0x1000 );
            iv[uVar5 - 7] = *pbVar1 ^ *(byte*)( param_1 + 0x1001 );
            for (int i = 0; i < 6; i++) {
               iv[uVar5 - ( 6 - i )] = *(byte*)( (long)__src + ( uVar5 - ( 6 - i ) ) ) ^ *(byte*)( param_1 + ( i + 4098 ) );
            }

         }
 else {
            *puVar2 = *(ulong*)( (long)__src + __n ) ^ *(ulong*)( param_1 + 0x1000 );
         }

         iVar3 = tls_increment_sequence_ctr(param_1);
         if (iVar3 == 0) goto LAB_00100531;
         iVar3 = WPACKET_init_static_len(local_c8, local_8d, 5);
         if (iVar3 != 0) {
            iVar3 = WPACKET_put_bytes__(local_c8, (long)param_2[1], 1);
            if (iVar3 != 0) {
               iVar3 = WPACKET_put_bytes__(local_c8, (long)*param_2, 2);
               if (iVar3 != 0) {
                  iVar3 = WPACKET_put_bytes__(local_c8, *(long*)( param_1 + 0x10d8 ) + *(long*)( param_2 + 2 ), 2);
                  if (iVar3 != 0) {
                     iVar3 = WPACKET_get_total_written(local_c8);
                     if (( iVar3 != 0 ) && ( local_d8 == 5 )) {
                        iVar3 = WPACKET_finish(local_c8);
                        if (iVar3 != 0) {
                           if (*(long*)( param_1 + 0x1028 ) == 0) {
                              lVar6 = EVP_CIPHER_CTX_get0_cipher(ctx);
                              if (lVar6 == 0) {
                                 ERR_new(0);
                                 uVar7 = 0xd2;
                                 goto LAB_001005b9;
                              ...
                              iVar3 = EVP_CIPHER_get_mode();
                              iVar4 = EVP_CipherInit_ex(ctx, (EVP_CIPHER*)0x0, (ENGINE*)0x0, (uchar*)0x0, iv, param_4);
                              if (iVar4 < 1) {
                                 LAB_00100a1d:ERR_new();
                                 uVar7 = 0xdb;
                                 goto LAB_001005b9;
                              }

                              if (param_4 == 0) {
                                 iVar4 = EVP_CIPHER_CTX_ctrl(ctx, 0x11, *(int*)( param_1 + 0x10d8 ), (void*)( *(long*)( param_2 + 2 ) + *(long*)( param_2 + 8 ) ));
                                 if (iVar4 < 1) goto LAB_00100a1d;
                              }

                              if (iVar3 == 7) {
                                 iVar3 = EVP_CipherUpdate(ctx, (uchar*)0x0, &local_dc, (uchar*)0x0, param_2[2]);
                                 if (iVar3 < 1) {
                                    bVar8 = false;
                                    goto LAB_00100538;
                                 }
                              ...
                              iVar3 = EVP_CipherUpdate(ctx, (uchar*)0x0, &local_dc, local_8d, 5);
                              if (0 < iVar3) {
                                 iVar3 = EVP_CipherUpdate(ctx, *(uchar**)( param_2 + 8 ), &local_dc, *(uchar**)( param_2 + 10 ), param_2[2]);
                                 if (0 < iVar3) {
                                    iVar3 = EVP_CipherFinal_ex(ctx, (uchar*)( (long)local_dc + *(long*)( param_2 + 8 ) ), local_d0);
                                    if (( 0 < iVar3 ) && ( (long)( local_d0[0] + local_dc ) == *(long*)( param_2 + 2 ) )) {
                                       if (param_4 != 0) {
                                          iVar3 = EVP_CIPHER_CTX_ctrl(ctx, 0x10, *(int*)( param_1 + 0x10d8 ), (void*)( (long)( local_d0[0] + local_dc ) + *(long*)( param_2 + 8 ) ));
                                          if (iVar3 < 1) {
                                             ERR_new();
                                             uVar7 = 0xf2;
                                             goto LAB_001005b9;
                           ...
                           lVar6 = EVP_MAC_CTX_dup();
                           if (lVar6 == 0) {
                              LAB_00100896:ERR_new();
                              ERR_set_debug("ssl/record/methods/tls13_meth.c", 0xbf, "tls13_cipher");
                              ossl_rlayer_fatal(param_1, 0x50, 0xc0103, 0);
                              bVar8 = false;
                           }
 else {
                              iVar3 = EVP_MAC_update(lVar6, iv, uVar5);
                              if (iVar3 == 0) goto LAB_00100896;
                              iVar3 = EVP_MAC_update(lVar6, local_8d, 5);
                              if (iVar3 == 0) goto LAB_00100896;
                              iVar3 = EVP_MAC_update(lVar6, *(undefined8*)( param_2 + 10 ), *(undefined8*)( param_2 + 2 ));
                              if (iVar3 == 0) goto LAB_00100896;
                              iVar3 = EVP_MAC_final(lVar6, local_88, local_d0, *(undefined8*)( param_1 + 0x10d8 ));
                              if (iVar3 == 0) goto LAB_00100896;
                              if (param_4 == 0) {
                                 iVar3 = CRYPTO_memcmp(local_88, (void*)( *(long*)( param_2 + 2 ) + *(long*)( param_2 + 8 ) ), *(size_t*)( param_1 + 0x10d8 ));
                                 bVar8 = iVar3 == 0;
                              }
 else {
                                 memcpy((void*)( *(long*)( param_2 + 2 ) + *(long*)( param_2 + 8 ) ), local_88, *(size_t*)( param_1 + 0x10d8 ));
                                 *(long*)( param_2 + 2 ) = *(long*)( param_2 + 2 ) + *(long*)( param_1 + 0x10d8 );
                                 bVar8 = true;
                              }
   ...
   LAB_001005b9:ERR_set_debug("ssl/record/methods/tls13_meth.c", uVar7, "tls13_cipher");
   ossl_rlayer_fatal(param_1, 0x50, 0xc0103, 0);
   bVar8 = false;
   LAB_00100538:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return bVar8;
   }
...
undefined8 tls13_set_crypto_state(undefined8 *param_1, undefined8 param_2, uchar *param_3, undefined8 param_4, void *param_5, size_t param_6, undefined8 param_7, undefined8 param_8, EVP_CIPHER *param_9, int param_10, int param_11, long param_12) {
   int iVar1;
   int iVar2;
   int iVar3;
   void *pvVar4;
      ...
      if (pvVar4 != (void*)0x0) {
         ...
         if (( ( iVar1 == 0 ) || ( param_11 != 0x357 ) ) || ( param_12 == 0 )) {
            ...
            if (ctx == (EVP_CIPHER_CTX*)0x0) {
               ...
               if (( ( ( 0 < iVar3 ) && ( iVar2 = EVP_CIPHER_CTX_ctrl(ctx, 9, iVar2, (void*)0x0) ),0 < iVar2 ) ) && ( ( iVar1 != 7 || ( iVar2 = EVP_CIPHER_CTX_ctrl(ctx, 0x11, param_10, (void*)0x0) ),0 < iVar2 ) )) {
                  LAB_00100cec:uVar7 = 1;
                  goto LAB_00100cf1;
               }
         ...
         LAB_00100c50:ERR_set_debug("ssl/record/methods/tls13_meth.c", uVar7, "tls13_set_crypto_state");

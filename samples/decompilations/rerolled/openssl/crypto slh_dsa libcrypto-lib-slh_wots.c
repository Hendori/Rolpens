undefined8 slh_wots_chain(long *param_1, undefined8 param_2, uint param_3, byte param_4, undefined8 param_5, undefined8 param_6, undefined8 param_7) {
   long lVar1;
   code *pcVar2;
   code *pcVar3;
   int iVar4;
 ...
 while ( iVar4 != 0 );
      ...
      uVar5 = 0;
      LAB_00100121:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return uVar5;
      }
...
int ossl_slh_wots_pk_gen(long *param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6) {
   uint uVar1;
   undefined4 uVar2;
   long lVar3;
   long lVar4;
 ...
 while ( local_9d0 < len * 2 + 3 );
      ...
      if (iVar10 == 0) {
         LAB_001003a3:iVar10 = 0;
      }
 else {
         ( **(code**)( lVar5 + 0x50 ) )(local_8c8, param_4);
         ( **(code**)( lVar5 + 0x10 ) )(local_8c8, 1);
         ( **(code**)( lVar5 + 0x20 ) )(local_8c8, param_4);
         iVar10 = ( **(code**)( lVar4 + 0x28 ) )(param_1, param_3, local_8c8, local_8a8, local_958, param_5, param_6);
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 ossl_slh_wots_sign(long *param_1, undefined1 (*param_2)[16], undefined8 param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6) {
   byte bVar1;
   long lVar2;
   long lVar3;
   code *pcVar4;
   ...
   if (uVar37 - 1 < 0xf) {
      ...
      do {
         ...
         auVar58[8] = auVar44[4];
         for (int i = 0; i < 3; i++) {
            auVar58[( -2*i + 7 )] = auVar50[( 3 - i )];
            auVar58[( -2*i + 6 )] = auVar44[( 3 - i )];
         }

         auVar58[0] = auVar44[0];
         auVar58[1] = auVar50[0];
         for (int i = 0; i < 8; i++) {
            pauVar39[1][( 2*i )] = auVar44[( i + 8 )];
            pauVar39[1][( 2*i + 1 )] = auVar50[( i + 8 )];
         }
 ...
 while ( (undefined1(*) [16])( *(undefined1(*) [16])&local_88 + uVar37 ) != pauVar40 );
      uVar38 = CONCAT26(sVar53 + sVar57, CONCAT24(sVar52 + sVar56, CONCAT22(sVar51 + sVar55, sVar49 + sVar54)));
   ...
   if (6 < uVar42 - 1) {
      ...
      uVar41 = ( uint )(ushort)(auVar24._8_2_ + ( (ushort)uVar43 & 0xff ) + (short)uVar38 + auVar12._12_2_ + auVar31._0_2_ + (short)( (ulong)uVar38 >> 0x20 ) + auVar18._10_2_ + auVar25._2_2_ + (short)( (ulong)uVar38 >> 0x10 ) + ( auVar9._13_2_ >> 8 ) + (short)Var27 + (short)( (ulong)uVar38 >> 0x30 ));
      if (( uVar42 & 7 ) == 0) goto LAB_0010092b;
   }

   uVar41 = uVar41 + *(byte*)( (long)&local_88 + uVar37 );
   if (( ( ( uVar37 + 1 < uVar6 ) && ( uVar41 = uVar41 + *(byte*)( (long)&local_88 + uVar37 + 1 ) ),uVar37 + 2 < uVar6 ) ) && ( uVar41 = uVar41 + *(byte*)( (long)&local_88 + uVar37 + 2 ) ),uVar37 + 3 < uVar6) {
   ...
   LAB_0010092b:iVar36 = (int)uVar6 * 0xf - uVar41;
   ...
   *(byte*)( (long)&local_88 + uVar6 + 1 ) = bVar1 >> 4;
   ...
   do {
      ...
      if (iVar36 == 0) {
         LAB_001009f2:uVar38 = 0;
         goto LAB_001009f4;
      }

      ( *pcVar4 )(param_5, uVar37 & 0xffffffff);
      iVar36 = slh_wots_chain(param_1, local_c8, 0, ( *(undefined1(*) [16])&local_88 )[uVar37], param_4, param_5);
 ...
 while ( uVar37 < uVar6 + 3 );
   uVar38 = 1;
   LAB_001009f4:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar38;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined4 ossl_slh_wots_pk_from_sig(long *param_1, long *param_2, undefined1 (*param_3)[16], undefined8 param_4, undefined8 param_5, undefined8 param_6, undefined8 param_7) {
   ulong uVar1;
   byte bVar2;
   char cVar3;
   long lVar4;
      ...
      if (uVar42 == 0) {
         ...
         if (uVar42 - 1 < 0xf) {
            ...
            do {
               ...
               auVar52[8] = auVar46[4];
               for (int i = 0; i < 3; i++) {
                  auVar52[( -2*i + 7 )] = auVar51[( 3 - i )];
                  auVar52[( -2*i + 6 )] = auVar46[( 3 - i )];
               }

               auVar52[0] = auVar46[0];
               auVar52[1] = auVar51[0];
               for (int i = 0; i < 8; i++) {
                  pauVar41[1][( 2*i )] = auVar46[( i + 8 )];
                  pauVar41[1][( 2*i + 1 )] = auVar51[( i + 8 )];
               }
 ...
 while ( param_3 != pauVar40 );
            ...
            LAB_00100d98:uVar44 = uVar8 & 0xfffffffffffffff0;
            pauVar40 = (undefined1(*) [16])&local_8f8;
 ...
 while ( (undefined1(*) [16])( *(undefined1(*) [16])&local_8f8 + uVar44 ) != pauVar40 );
            ...
            uVar43 = ( uint )(ushort)(auVar51._8_2_ + auVar51._0_2_ + auVar51._12_2_ + auVar51._4_2_ + auVar51._10_2_ + auVar51._2_2_ + auVar51._14_2_ + auVar51._6_2_);
         ...
         if (6 < uVar45 - 1) {
            ...
            uVar43 = ( uint )(ushort)(auVar26._8_2_ + ( (ushort)uVar1 & 0xff ) + sVar53 + auVar14._12_2_ + auVar33._0_2_ + sVar55 + auVar20._10_2_ + auVar27._2_2_ + sVar54 + ( auVar11._13_2_ >> 8 ) + (short)Var29 + sVar56);
            if (( uVar45 & 7 ) == 0) goto LAB_00100f08;
         }

         uVar43 = uVar43 + *(byte*)( (long)&local_8f8 + uVar44 );
         if (( ( ( uVar44 + 1 < uVar8 ) && ( uVar43 = uVar43 + *(byte*)( (long)&local_8f8 + uVar44 + 1 ) ),uVar44 + 2 < uVar8 ) ) && ( uVar43 = uVar43 + *(byte*)( (long)&local_8f8 + uVar44 + 2 ) ),uVar44 + 3 < uVar8) {
 ...
 while ( uVar44 < uVar8 + 3 );
      ...
      if (iVar38 == 0) {
         LAB_00101030:uVar39 = 0;
      }
 else {
         uVar39 = ( **(code**)( lVar5 + 0x28 ) )(param_1, param_4, local_918, local_8a8, local_960, param_6, param_7);
      }
   ...
   uVar39 = 0;
   LAB_00101040:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar39;
   }

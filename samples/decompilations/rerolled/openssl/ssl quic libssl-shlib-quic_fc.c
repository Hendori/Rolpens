void rxfc_on_retire_isra_0(ulong *param_1, long param_2, ulong param_3, ulong param_4) {
   ...
   if (SUB168(auVar4 * auVar8, 8) == 0) {
      ...
      LAB_0010016c:if (uVar12 <= uVar11) goto LAB_001000c2;
   }
 else {
      uVar13 = uVar14;
      if (uVar12 <= uVar14) {
      ...
      auVar9._8_8_ = 0;
      auVar9._0_8_ = uVar13;
      if (( ( SUB168(auVar5 * auVar9, 8) == 0 ) && ( auVar6._8_8_ = 0 ),auVar6._0_8_ = uVar13,auVar10._8_8_ = 0,auVar10._0_8_ = SUB168(auVar3 / auVar2, 0),uVar12 = SUB168(auVar6 * auVar10, 0),SUB168(auVar6 * auVar10, 8) == 0 )) &&( uVar13 = SUB168(auVar5 * auVar9, 0) / uVar11 ),uVar11 = uVar13 + uVar12,!CARRY8(uVar13,uVar12);
      uVar12 = param_4 * 4;
   ...
   uVar16 = uVar16 * 2;
   LAB_001000c2:if (param_3 < uVar16) {
      param_3 = uVar16;
   }
...
undefined8 ossl_quic_rxfc_init(undefined8 *param_1, long param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6) {
...
undefined8 ossl_quic_rxfc_init_standalone(long param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4) {
   undefined8 uVar1;
...
undefined8 ossl_quic_rxfc_on_rx_stream_frame(long *param_1, ulong param_2, int param_3) {
   ...
   if (*(char*)( (long)param_1 + 0x5a ) == '\0') {
      ...
      if (uVar1 < param_2) {
         LAB_001004ad:*(undefined1*)( param_1 + 0xb ) = 6;
         return 1;
      }
...
undefined8 ossl_quic_rxfc_on_retire(long param_1, long param_2, undefined8 param_3) {
   ...
   if (param_2 != 0) {
      ...
      if (*(char*)( param_1 + 0x5b ) == '\0') {
         rxfc_on_retire_isra_0(*(undefined8*)( param_1 + 0x50 ), param_2, *(undefined8*)( param_1 + 0x28 ), param_3);
      }

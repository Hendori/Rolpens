...
undefined8 *ripemd160_dupctx(undefined8 *param_1) {
   ...
   if (iVar12 != 0) {
      puVar13 = (undefined8*)CRYPTO_malloc(0x60, "providers/implementations/digests/ripemd_prov.c", 0x16);
...
undefined8 ripemd160_internal_final(RIPEMD160_CTX *param_1, uchar *param_2, undefined8 *param_3, ulong param_4) {
   int iVar1;

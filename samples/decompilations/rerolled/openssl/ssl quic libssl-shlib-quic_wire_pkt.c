...
bool ossl_quic_wire_encode_pkt_hdr(long param_1, ulong param_2, ushort *param_3, undefined1 (*param_4)[16]) {
   ...
   if (( ( ( iVar2 != 0 ) && ( iVar2 = WPACKET_put_bytes__(param_1, *(undefined4*)( param_3 + 2 ), 4) ),iVar2 != 0 ) ) && ( iVar2 = WPACKET_put_bytes__(param_1, (byte)param_3[4], 1) ),iVar2 != 0) {
      if (( byte ) * param_3 == 6) {
   ...
   switchD_001010ae_caseD_0:bVar6 = false;
   LAB_001010c2:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return bVar6;
   }

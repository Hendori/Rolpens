...
undefined8 kdf_sshkdf_set_ctx_params(undefined8 *param_1, long *param_2) {
   ...
   if (( param_2 == (long*)0x0 ) || ( *param_2 == 0 )) {
      LAB_00100340:uVar2 = 1;
   }
 else {
      lVar3 = OSSL_PARAM_locate_const(param_2, "digest");
      if (lVar3 == 0) {
         LAB_001001d8:lVar3 = OSSL_PARAM_locate_const(param_2, &_LC3);
         if (lVar3 != 0) {
...
undefined4 kdf_sshkdf_derive(long param_1, void *param_2, ulong param_3, undefined8 param_4) {
   ...
   uVar3 = 0;
   if (ctx == (EVP_MD_CTX*)0x0) goto LAB_00100400;
   iVar2 = EVP_DigestInit_ex(ctx, type, (ENGINE*)0x0);
   if (( iVar2 == 0 ) || ( iVar2 = iVar2 == 0 )) {
      LAB_001004e1:uVar3 = 0;
   }
 else {
      iVar2 = EVP_DigestUpdate(ctx, d_00, cnt_00);
      if (( iVar2 == 0 ) || ( ( iVar2 = EVP_DigestUpdate(ctx, &local_8d, 1) ),iVar2 == 0 || ( iVar2 = EVP_DigestUpdate(ctx, d_01, cnt) ),iVar2 == 0 )) goto LAB_001004e1;
      iVar2 = EVP_DigestFinal_ex(ctx, local_88, &local_8c);
      if (iVar2 == 0) goto LAB_001004e1;
      __n = (ulong)local_8c;
      if (param_3 < __n) {
         ...
         while (__n < param_3) {
            iVar2 = EVP_DigestInit_ex(ctx, type, (ENGINE*)0x0);
            if (( ( ( iVar2 == 0 ) || ( iVar2 = EVP_DigestUpdate(ctx, d, cnt_01) ),iVar2 == 0 ) ) || ( iVar2 = iVar2 == 0 )) goto LAB_001004e1;
            uVar1 = __n + local_8c;
            if (param_3 < uVar1) {
...
void kdf_sshkdf_free(undefined8 *param_1) {
   undefined8 uVar1;
...
undefined8 *kdf_sshkdf_dup(undefined8 *param_1) {
   ...
   uVar1 = *param_1;
   iVar2 = ossl_prov_is_running();
   if (( iVar2 != 0 ) && ( ptr = (undefined8*)CRYPTO_zalloc(0x58, "providers/implementations/kdfs/sshkdf.c", 0x3f) ),ptr != (undefined8*)0x0) {
      *ptr = uVar1;
      iVar2 = ossl_prov_memdup(param_1[4], param_1[5], ptr + 4, ptr + 5);
      if (( iVar2 != 0 ) && ( iVar2 = ossl_prov_memdup(param_1[6], param_1[7], ptr + 6, ptr + 7) ),iVar2 != 0) {
      ...
      uVar1 = *ptr;
      ossl_prov_digest_reset((undefined1(*) [16])( ptr + 1 ));
      CRYPTO_clear_free(ptr[4], ptr[5], "providers/implementations/kdfs/sshkdf.c", 0x56);
      CRYPTO_clear_free(ptr[6], ptr[7], "providers/implementations/kdfs/sshkdf.c", 0x57);
      CRYPTO_clear_free(ptr[9], ptr[10], "providers/implementations/kdfs/sshkdf.c", 0x58);
      for (int i = 0; i < 5; i++) {

...
bool cmd_DHParameters(long param_1, void *param_2) {
 ...
 while ( (int)lVar3 == 0 );
   ...
   BIO_free(bp);
   LAB_00100324:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 cmd_MinProtocol(long param_1, char *param_2) {
   ...
   uVar2 = ssl_set_version_bound(uVar4, *(int*)( versions_2 + lVar3 * 0x10 + 8 ), *(undefined8*)( param_1 + 0x50 ));
   return uVar2;
}
...
NoteGnuProperty_4 *ssl_conf_cmd_lookup(uint *param_1, char *param_2) {
   ...
   if (param_2 != (char*)0x0) {
      ...
      do {
         ...
         uVar1 = *param_1;
         if (( ( ( ( dVar3 & 8 ) == 0 ) || ( ( uVar1 & 8 ) != 0 ) ) && ( ( ( dVar3 & 4 ) == 0 || ( ( uVar1 & 4 ) != 0 ) ) ) ) && ( ( ( dVar3 & 0x20 ) == 0 || ( ( uVar1 & 0x20 ) != 0 ) ) )) {
            if (( ( uVar1 & 1 ) != 0 ) && ( ( *(char**)( (long)puVar5 + 0x10 ) != (char*)0x0 && ( iVar4 = strcmp(*(char**)( (long)puVar5 + 0x10 ), param_2) ),iVar4 == 0 ) )) {
               return (NoteGnuProperty_4*)puVar5;
            }

            if (( ( ( uVar1 & 2 ) != 0 ) && ( lVar2._0_4_ = ((NoteGnuProperty_4 *)puVar5)->type ),lVar2._4_1_ = ((NoteGnuProperty_4 *)puVar5)->name[0],lVar2._5_1_ = ((NoteGnuProperty_4 *)puVar5)->name[1],lVar2._6_1_ = ((NoteGnuProperty_4 *)puVar5)->name[2],lVar2._7_1_ = ((NoteGnuProperty_4 *)puVar5)->name[3],lVar2 != 0 )) {
               return (NoteGnuProperty_4*)puVar5;
            }
...
undefined8 cmd_MaxProtocol(long param_1, char *param_2) {
   ...
   uVar2 = ssl_set_version_bound(uVar4, *(int*)( versions_2 + lVar3 * 0x10 + 8 ), *(undefined8*)( param_1 + 0x58 ));
   return uVar2;
}
...
undefined8 ssl_set_option_list(char *param_1, int param_2, uint *param_3) {
   ...
   if (param_2 == -1) {
      ...
      LAB_00100f45:uVar5 = *param_3;
      uVar6 = 0;
      do {
         uVar4 = *(uint*)( (long)puVar3 + 0xc );
         if (( ( uVar5 & uVar4 & 0xc ) != 0 ) && ( iVar2 = iVar2 == 0 )) goto LAB_00100ec4;
         uVar6 = uVar6 + 1;
         puVar3 = puVar3 + 3;
      }
 while ( uVar6 != uVar8 );
      ...
      if (*param_1 == '+') {
         local_44 = 1;
         LAB_00100ff0:param_2 = param_2 + -1;
         param_1 = param_1 + 1;
         uVar8 = *(ulong*)( param_3 + 0x1a );
         puVar3 = *(undefined8**)( param_3 + 0x18 );
         if (uVar8 == 0) {
      ...
      uVar6 = 0;
      do {
         if (( ( *(uint*)( (long)puVar3 + 0xc ) & *param_3 & 0xc ) != 0 ) && ( *(int*)( puVar3 + 1 ) == param_2 )) {
            iVar2 = OPENSSL_strncasecmp(*puVar3, param_1, (long)param_2);
            if (iVar2 == 0) {
               uVar4 = *(uint*)( (long)puVar3 + 0xc );
               LAB_00100ec4:puVar1 = *(ulong**)( param_3 + 10 );
               if (puVar1 != (ulong*)0x0) {
                  uVar5 = uVar4 & 0xf00;
                  uVar8 = puVar3[2];
                  if (uVar5 == 0x100) {
...
bool cmd_VerifyCAFile(long param_1, long param_2) {
   ...
   LAB_00101117:pXVar5 = *(X509_STORE**)( lVar6 + 0x78 );
...
bool cmd_VerifyCAStore(long param_1, long param_2) {
   ...
   uVar7 = puVar2[0x8e];
   puVar2 = (undefined8*)*puVar2;
   LAB_001012d7:pXVar5 = *(X509_STORE**)( lVar6 + 0x78 );
   if (pXVar5 == (X509_STORE*)0x0) {
      pXVar5 = X509_STORE_new();
      *(X509_STORE**)( lVar6 + 0x78 ) = pXVar5;
      if (pXVar5 == (X509_STORE*)0x0) {
...
bool cmd_ChainCAStore(long param_1, long param_2) {
   ...
   uVar7 = puVar2[0x8e];
   puVar2 = (undefined8*)*puVar2;
   LAB_001013d7:pXVar5 = *(X509_STORE**)( lVar6 + 0x70 );
   if (pXVar5 == (X509_STORE*)0x0) {
      pXVar5 = X509_STORE_new();
...
bool cmd_ChainCAFile(long param_1, long param_2) {
   ...
   uVar7 = puVar2[0x8e];
   puVar2 = (undefined8*)*puVar2;
   LAB_001014d7:pXVar5 = *(X509_STORE**)( lVar6 + 0x70 );
   if (pXVar5 == (X509_STORE*)0x0) {
      pXVar5 = X509_STORE_new();
      *(X509_STORE**)( lVar6 + 0x70 ) = pXVar5;
      if (pXVar5 == (X509_STORE*)0x0) {
...
int SSL_CONF_cmd(uint *param_1, char *param_2, char *param_3) {
   ...
   if (__s2 == (char*)0x0) {
      ...
      LAB_00101649:puVar5 = (undefined8*)ssl_conf_cmd_lookup(param_1, param_2);
      ...
      if (( sVar4 <= uVar10 ) || ( ( ( uVar3 & 1 ) != 0 && ( iVar2 = strncmp(param_2, __s2, uVar10) ),iVar2 != 0 ) )) goto LAB_00101610;
      if (( uVar3 & 2 ) == 0) {
         LAB_00101646:param_2 = param_2 + uVar10;
         goto LAB_00101649;
      }
...
undefined8 SSL_CONF_CTX_finish(byte *param_1) {
   ...
   if (*(long*)( param_1 + 0x18 ) == 0) {
      ...
      if (puVar2 != (uint*)0x0) {
         if (*puVar2 == 0) {
            LAB_00101bc0:lVar5 = *(long*)( puVar2 + 0x220 );
            goto LAB_00101a85;
         }
      ...
      LAB_00101a85:if (( ( lVar5 != 0 ) && ( ( *param_1 & 0x40 ) != 0 ) ) && ( uVar3 = uVar3 != 0 )) {
         uVar4 = 0;
         do {
            while (( ( file = *(char**)( *(long*)( param_1 + 0x30 ) + uVar4 * 8 ) ),file == (char*)0x0 || ( *(long*)( *(long*)( lVar5 + 0x20 ) + uVar4 * 0x28 + 8 ) != 0 ) ) || ( ( *param_1 & 0x20 ) == 0 )) {
               LAB_00101aa8:uVar4 = uVar4 + 1;
...
;
            ...
            ssl = *(SSL**)( param_1 + 0x20 );
            if (ssl != (SSL*)0x0) {
               LAB_00101afa:iVar1 = SSL_use_PrivateKey_file(ssl, file, 1);
            }
 ...
 while ( uVar4 < uVar3 );
      ...
      LAB_00101b20:lVar5 = *(long*)( param_1 + 0x70 );
      if (lVar5 == 0) {
         return 1;
      }
      ...
      puVar2 = *(uint**)( param_1 + 0x20 );
      if (puVar2 != (uint*)0x0) {
         LAB_00101b32:SSL_set0_CA_list(puVar2, lVar5);
         goto LAB_00101b3d;
      }

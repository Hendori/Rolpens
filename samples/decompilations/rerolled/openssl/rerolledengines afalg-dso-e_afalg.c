...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 afalg_cipher_init(long param_1, void *param_2) {
   int iVar1;
   socklen_t __optlen;
   long lVar2;
   undefined4 *puVar3;
            ...
            if (( iVar1 - 0x1a3U < 9 ) && ( ( 0x111UL >> ( ( ulong )(iVar1 - 0x1a3U) & 0x3f ) & 1 ) != 0 )) {
               ...
               if (iVar1 == 0x10) {
                  *(undefined8*)( puVar3 + 1 ) = _LC2;
                  for (int i = 0; i < 8; i++) {
                     local_88.sa_data[i] = '\0';
                  }

                  local_38 = 0;
                  pcVar6 = local_88.sa_data + 6;
                  for (uVar5 = ( ulong )(( (int)local_88.sa_data - (int)( local_88.sa_data + 6 ) ) + 0x56U >> 3); uVar5 != 0; uVar5 = uVar5 - 1) {
                     for (int i = 0; i < 8; i++) {
                        pcVar6[i] = '\0';
                     }
                  ...
                  puVar3[2] = iVar1;
                  if (iVar1 == -1) {
                     __fprintf_chk(_stderr, 2, "ALG_PERR: %s(%d): Failed to open socket : ", "engines/e_afalg.c", 0x1c7);
                     perror((char*)0x0);
                     ...
                     if (iVar1 < 0) {
                        __fprintf_chk(_stderr, 2, "ALG_PERR: %s(%d): Failed to bind socket : ", "engines/e_afalg.c", 0x1ce);
                        perror((char*)0x0);
                        ...
                        if (-1 < iVar1) {
                           ...
                           if (0 < (int)__optlen) {
                              ...
                              if (iVar1 < 0) {
                                 __fprintf_chk(_stderr, 2, "ALG_PERR: %s(%d): Failed to set socket option : ", "engines/e_afalg.c", 0x1b1);
                                 perror((char*)0x0);
                                 ...
                                 *(undefined8*)( puVar3 + 6 ) = 0;
                                 ...
                                 if (-1 < (int)lVar2) {
                                    ...
                                    *(undefined8*)( puVar3 + 4 ) = 0xffffffff;
                                    uVar4 = 1;
                                    for (int i = 0; i < 4; i++) {
                                       *(undefined1(*) [16])( puVar3 + ( 4*i + 16 ) ) = (undefined1[16])0;
                                    }

                                    goto LAB_0010022a;
                                 }

                                 __fprintf_chk(_stderr, 2, "ALG_PERR: %s(%d): io_setup error : ", "engines/e_afalg.c", 0xfb);
                                 perror((char*)0x0);
                        ...
                        __fprintf_chk(_stderr, 2, "ALG_PERR: %s(%d): Socket Accept Failed : ", "engines/e_afalg.c", 0x1d5);
                        perror((char*)0x0);
   ...
   LAB_00100228:uVar4 = 0;
   LAB_0010022a:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar4;
   }
...
undefined8 afalg_ciphers(undefined8 param_1, long *param_2, undefined8 *param_3, int param_4) {
   ...
   LAB_00100593:*param_2 = lVar3;
   return 1;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 afalg_chk_platform(void) {
   int iVar1;
   undefined4 uVar2;
   char *pcVar3;
   undefined8 uVar4;
 ...
 while ( iVar1 < 3 && pcVar3 != (char*)0x0 );
   ...
   LAB_00100786:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar4;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 afalg_do_cipher(long param_1, long param_2, int *param_3, long param_4) {
   int iVar1;
   undefined4 uVar2;
   int iVar3;
   int *piVar4;
   ...
   if (( ( ( param_2 == 0 || param_3 == (int*)0x0 ) || ( param_1 == 0 ) ) || ( piVar4 = (int*)EVP_CIPHER_CTX_get_cipher_data() ),piVar4 == (int*)0x0 )) goto LAB_001009ae;
   ...
   if (sVar6 < 0) {
      ...
      if (piVar4[5] == 0) {
         ...
         if (lVar7 == 0) {
            ...
            piVar4[4] = (int)lVar7;
            if ((int)lVar7 == -1) {
               __fprintf_chk(_stderr, 2, "ALG_PERR: %s(%d): Failed to get eventfd : ", "engines/e_afalg.c", 0xe9);
               perror((char*)0x0);
            ...
            if (iVar3 == 0) {
               ...
               piVar4[4] = (int)uVar11;
               if ((int)uVar11 == -1) {
                  __fprintf_chk(_stderr, 2, "ALG_PERR: %s(%d): Failed to get eventfd : ", "engines/e_afalg.c", 0xd1);
                  perror((char*)0x0);
                  ERR_AFALG_error_constprop_0(0x6c, 0xd2);
                  goto LAB_001009ae;
               }

               iVar3 = ASYNC_WAIT_CTX_set_wait_fd(lVar7, "afalg", uVar11 & 0xffffffff, local_f8, afalg_waitfd_cleanup);
               if (iVar3 == 0) {
                  close(piVar4[4]);
                  goto LAB_001009ae;
               }
            ...
            while (true) {
               ...
               if (local_100 != 0) {
                  ...
                  if ((int)lVar7 < 1) {
                     ...
                     if (( local_98 != -0x10 ) || ( iVar3 = 2 < iVar1 )) {
                     ...
                     iVar1 = iVar3;
                     if ((int)lVar7 < 0) {
                        __fprintf_chk(_stderr, 2, "ALG_PERR: %s(%d): retry %d for io_read failed : ", "engines/e_afalg.c", 0x160, iVar3);
                        perror((char*)0x0);
                        goto LAB_001009ae;
                     }
...
;
 ...
 while ( *piVar8 == 0xb );
   ...
   LAB_00100cd2:__fprintf_chk(_stderr, 2, pcVar12, "engines/e_afalg.c", uVar9);
   perror((char*)0x0);
   LAB_001009ae:uVar9 = 0;
   LAB_001009b0:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 bind_engine(ENGINE *param_1, char *param_2, long *param_3) {
   ...
   if (( ( ( iVar1 == 0 ) || ( iVar1 = ENGINE_set_name(param_1, "AFALG engine support") ),iVar1 == 0 ) ) || ( iVar1 = ENGINE_set_destroy_function(param_1, afalg_destroy) ),iVar1 == 0) {
      if (lib_code == 0) {
         lib_code = ERR_get_next_error_library();
      }
   ...
   if (afalg_cipher_nids == 0x1a7) {
      puVar4 = (undefined4*)&DAT_00101670;
      LAB_001012c8:if (*(long*)( puVar4 + 2 ) != 0) {
         LAB_001012d3:if (DAT_00101694 == 0x1a7) {
            puVar4 = (undefined4*)&DAT_00101670;
         }
         ...
         if (*(long*)( puVar4 + 2 ) == 0) {
            ...
            *(long*)( puVar4 + 2 ) = lVar3;
            ...
            if (( ( ( iVar1 == 0 ) || ( iVar1 = EVP_CIPHER_meth_set_flags(*(undefined8*)( puVar4 + 2 ), 2) ),iVar1 == 0 ) ) || ( ( iVar1 = EVP_CIPHER_meth_set_init(*(undefined8*)( puVar4 + 2 ), afalg_cipher_init) ),iVar1 == 0 || ( ( iVar1 = EVP_CIPHER_meth_set_do_cipher(*(undefined8*)( puVar4 + 2 ), afalg_do_cipher) ),iVar1 == 0 || ( iVar1 = EVP_CIPHER_meth_set_cleanup(*(undefined8*)( puVar4 + 2 ), afalg_cipher_cleanup) ),iVar1 == 0 ) )) goto LAB_0010142a;
         ...
         if (*(long*)( puVar4 + 2 ) == 0) {
            ...
            *(long*)( puVar4 + 2 ) = lVar3;
            if (lVar3 == 0) goto LAB_001015a0;
            iVar1 = EVP_CIPHER_meth_set_iv_length(lVar3, 0x10);
            if (( ( ( ( iVar1 == 0 ) || ( iVar1 = EVP_CIPHER_meth_set_flags(*(undefined8*)( puVar4 + 2 ), 2) ),iVar1 == 0 ) ) || ( iVar1 = EVP_CIPHER_meth_set_init(*(undefined8*)( puVar4 + 2 ), afalg_cipher_init) ),iVar1 == 0 )) goto LAB_0010142a;
            if (*(long*)( puVar4 + 2 ) == 0) goto LAB_001011fe;
         }
      ...
      *(long*)( puVar4 + 2 ) = lVar3;
      if (lVar3 == 0) {
         LAB_001015a0:uVar5 = 0;
      }
 else {
         iVar1 = EVP_CIPHER_meth_set_iv_length(lVar3, 0x10);
         if (( ( iVar1 != 0 ) && ( iVar1 = EVP_CIPHER_meth_set_flags(*(undefined8*)( puVar4 + 2 ), 2) ),iVar1 != 0 )) &&( ( iVar1 = EVP_CIPHER_meth_set_init(*(undefined8*)( puVar4 + 2 ), afalg_cipher_init) ),iVar1 != 0 && ( ( ( iVar1 = EVP_CIPHER_meth_set_do_cipher(*(undefined8*)( puVar4 + 2 ), afalg_do_cipher) ),iVar1 != 0 && ( iVar1 = EVP_CIPHER_meth_set_cleanup(*(undefined8*)( puVar4 + 2 ), afalg_cipher_cleanup) ),iVar1 != 0 ) ) && ( iVar1 = EVP_CIPHER_meth_set_impl_ctx_size(*(undefined8*)( puVar4 + 2 ), 0x80) ),iVar1 != 0 )(*(long*)( puVar4 + 2 ) == 0);
         goto LAB_001011fe;
         goto LAB_001012d3;
      }

      LAB_0010142a:uVar5 = *(undefined8*)( puVar4 + 2 );
   }

   EVP_CIPHER_meth_free(uVar5);
   *(undefined8*)( puVar4 + 2 ) = 0;
}
else{if (afalg_cipher_nids == 0x1ab) {
      puVar4 = (undefined4 *)&DAT_00101680;
      goto LAB_001012c8;
    }puVar4 = &cbc_handle;if (afalg_cipher_nids == 0x1a3) goto LAB_001012c8;}LAB_001011fe:if (lib_code == 0) {
   lib_code = ERR_get_next_error_library();
}
ERR_new();ERR_set_debug("engines/e_afalg_err.c", 0x46, "ERR_AFALG_error");ERR_set_error(lib_code, 100, 0);ERR_set_debug("engines/e_afalg.c", 0x32e, 0);LAB_0010112a:if (error_loaded != 0) {
   ERR_unload_strings(lib_code, (ERR_STRING_DATA*)AFALG_str_reasons);
   error_loaded = 0;
}
EVP_CIPHER_meth_free(DAT_00101668);DAT_00101668 = 0;EVP_CIPHER_meth_free(DAT_00101678);DAT_00101678 = 0;EVP_CIPHER_meth_free(DAT_00101688);DAT_00101688 = 0;return 0;}

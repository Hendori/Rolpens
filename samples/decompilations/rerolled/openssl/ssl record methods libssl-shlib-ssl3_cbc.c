void tls1_md5_final_raw(undefined4 *param_1, undefined1 *param_2) {
   *param_2 = (char)*param_1;
   for (int i = 0; i < 3; i++) {
      param_2[( i + 1 )] = (char)( ( uint ) * param_1 >> ( 8*i + 8 ) );
   }

   for (int i = 0; i < 3; i++) {
      param_2[( 4*i + 4 )] = (char)param_1[( i + 1 )];
      param_2[( 4*i + 5 )] = (char)( (uint)param_1[( i + 1 )] >> 8 );
      param_2[( 4*i + 6 )] = (char)*(undefined2*)( (long)param_1 + ( 4*i + 6 ) );
      param_2[( 4*i + 7 )] = *(undefined1*)( (long)param_1 + ( 4*i + 7 ) );
   }
...
void tls1_sha1_final_raw(undefined4 *param_1, undefined1 *param_2) {
   *param_2 = (char)( ( uint ) * param_1 >> 0x18 );
   ...
   for (int i = 0; i < 4; i++) {
      param_2[( 4*i + 4 )] = *(undefined1*)( (long)param_1 + ( 4*i + 7 ) );
      param_2[( 4*i + 5 )] = (char)*(undefined2*)( (long)param_1 + ( 4*i + 6 ) );
      param_2[( 4*i + 6 )] = (char)( (uint)param_1[( i + 1 )] >> 8 );
      param_2[( 4*i + 7 )] = (char)param_1[( i + 1 )];
   }
...
void tls1_sha256_final_raw(ulong *param_1, char *param_2) {
   ...
   if (0x3e < ( ulong )((long)param_1 + ( 0x1f - (long)param_2 ))) {
      ...
      auVar46._8_8_ = 0;
      auVar46._0_8_ = _LC0;
      auVar41 = ZEXT716(CONCAT34(( int3 )(CONCAT16((char)( uVar2 >> 0x38 ), ( uint6 )(byte)(uVar2 >> 0x18) << 0x20) >> 0x20), (uint)CONCAT12((char)( uVar1 >> 0x38 ), ( ushort )(byte)(uVar1 >> 0x18)))) & auVar46;
      auVar33 = ZEXT716(CONCAT34(( int3 )(CONCAT16((char)( uVar4 >> 0x38 ), ( uint6 )(byte)(uVar4 >> 0x18) << 0x20) >> 0x20), (uint)CONCAT12((char)( uVar3 >> 0x38 ), ( ushort )(byte)(uVar3 >> 0x18)))) & auVar46;
      ...
      *param_2 = ( uVar23 != 0 ) * ( uVar23 < 0x100 ) * auVar41[0] - ( 0xff < uVar23 );
      ...
      uVar1 = CONCAT44(CONCAT22((short)( uVar2 >> 0x30 ), (short)( uVar2 >> 0x10 )), CONCAT22((short)( uVar1 >> 0x30 ), (short)( uVar1 >> 0x10 ))) & uVar5;
      param_2[0xc] = ( uVar35 != 0 ) * ( uVar35 < 0x100 ) * auVar41[6] - ( 0xff < uVar35 );
      uVar5 = CONCAT44(CONCAT22((short)( uVar4 >> 0x30 ), (short)( uVar4 >> 0x10 )), CONCAT22((short)( uVar3 >> 0x30 ), (short)( uVar3 >> 0x10 ))) & uVar5;
      sVar6 = (short)uVar1;
   ...
   *param_2 = (char)( (uint)(int)*param_1 >> 0x18 );
   ...
   for (int i = 0; i < 3; i++) {
      param_2[( 8*i + 7 )] = (char)*(undefined4*)( (long)param_1 + ( 8*i + 4 ) );
      param_2[( 8*i + 8 )] = *(char*)( (long)param_1 + ( 8*i + 11 ) );
      param_2[( 8*i + 9 )] = (char)*(undefined2*)( (long)param_1 + ( 8*i + 10 ) );
      param_2[( 8*i + 10 )] = (char)( (uint)(int)param_1[( i + 1 )] >> 8 );
      param_2[( 8*i + 11 )] = (char)(int)param_1[( i + 1 )];
      param_2[( 8*i + 12 )] = *(char*)( (long)param_1 + ( 8*i + 15 ) );
      param_2[( 8*i + 13 )] = (char)*(undefined2*)( (long)param_1 + ( 8*i + 14 ) );
      param_2[( 8*i + 14 )] = (char)( ( uint ) * (undefined4*)( (long)param_1 + ( 8*i + 12 ) ) >> 8 );
   }
...
void tls1_sha512_final_raw(undefined8 *param_1, undefined1 *param_2) {
   *param_2 = (char)( ( ulong ) * param_1 >> 0x38 );
   for (int i = 0; i < 6; i++) {
      param_2[( i + 1 )] = (char)( ( ulong ) * param_1 >> ( -8*i + 48 ) );
   }

   param_2[7] = (char)*param_1;
   for (int i = 0; i < 7; i++) {
      param_2[( 8*i + 8 )] = *(undefined1*)( (long)param_1 + ( 8*i + 15 ) );
      param_2[( 8*i + 9 )] = (char)*(undefined2*)( (long)param_1 + ( 8*i + 14 ) );
      param_2[( 8*i + 10 )] = (char)( (ulong)param_1[( i + 1 )] >> 40 );
      param_2[( 8*i + 11 )] = (char)*(undefined4*)( (long)param_1 + ( 8*i + 12 ) );
      for (int j = 0; j < 3; j++) {
         param_2[( 8*i + ( j + 12 ) )] = (char)( (ulong)param_1[( i + 1 )] >> ( -8*j + 24 ) );
      }

      param_2[( 8*i + 15 )] = (char)param_1[( i + 1 )];
   }

   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 ssl3_cbc_digest_record(EVP_MD *param_1, uchar *param_2, ulong *param_3, undefined8 *param_4, undefined8 *param_5, long param_6, ulong param_7, void *param_8, ulong param_9, char param_10) {
   byte *pbVar1;
         ...
         if (iVar8 == 0) {
            ...
            if (iVar8 == 0) {
               ...
               if (0 < iVar8) {
                  ...
                  local_318 = 0x28;
                  local_370 = tls1_sha256_final_raw;
                  LAB_0010079a:if (param_10 == '\0') goto LAB_00100925;
                  goto LAB_001007a8;
               }
            ...
            if (0 < iVar8) {
               ...
               if (param_10 != '\0') {
                  LAB_001007a8:local_3d8 = local_318 + 0xb + param_9;
                  ...
                  if (local_390 < 4) {
                     ...
                     local_3a8 = 0;
                     local_3c8 = 0;
                     LAB_00100ac2:if (!bVar5) goto LAB_0010083b;
                     LAB_00100acb:pbVar12 = local_218;
 ...
 while ( uVar10 < ( uVar9 & 0xfffffff8 ) );
                     ...
                     *(uint*)( (long)auStack_220 + local_368 + 4 ) = uVar17 >> 0x18 | ( uVar17 & 0xff0000 ) >> 8 | ( uVar17 & 0xff00 ) << 8 | uVar17 << 0x18;
                  }
 else {
                     local_3c8 = local_390 - 2;
                     local_3a8 = local_3c8 * uVar25;
                     if (bVar5) goto LAB_00100acb;
                     LAB_0010083b:uVar9 = 0;
                     do {
                        uVar15 = (ulong)uVar9;
                        uVar9 = uVar9 + 8;
 ...
 while ( uVar9 < (uint)local_368 );
                  ...
                  if (local_3a8 != 0) {
                     if (param_10 == '\0') {
                        ...
                        *(undefined8*)( (long)&uStack_143 + lVar26 ) = *(undefined8*)( (long)param_5 + lVar26 + -8 );
 ...
 while ( uVar23 != uVar15 );
                  ...
                  if (local_3c8 <= local_390) {
                     ...
                     do {
                        uVar13 = 0;
                        bVar7 = (char)( ~(byte)((local_3c8 ^ local_360) >> 0x38) & ( byte )(( local_3c8 ^ local_360 ) - 1 >> 0x38) ) >> 7;
                        bVar6 = (char)( ~(byte)((local_3c8 ^ local_358) >> 0x38) & ( byte )(( local_3c8 ^ local_358 ) - 1 >> 0x38) ) >> 7;
                        uVar19 = local_3a8;
                        uVar22 = ~uVar14;
                        do {
                           if (uVar19 < local_3d8) {
                           ...
                           local_c8[uVar13] = ~(~((char)(((byte)(uVar22 >> 0x38) | bVar4) ^ bVar4) >> 7) & bVar6) & ( ~bVar7 | bVar6 ) & ( bVar3 & 0x80 | ~bVar3 & bVar24 );
                           uVar13 = uVar13 + 1;
                           uVar22 = uVar22 + 1;
                        }
 while ( uVar13 < uVar15 );
                        if (uVar13 < uVar25) {
                           ...
                           do {
                              ...
                              bVar4 = ( byte )(uVar13 >> 0x38);
                              uVar19 = uVar19 + 1;
                              bVar3 = ~((char)(((byte)((ulong)(lVar11 + 1) >> 0x38) | bVar4) ^ bVar4) >> 7) & bVar6;
                              local_c8[uVar13] = ~(~((char)(((byte)((ulong)lVar11 >> 0x38) | bVar4) ^ bVar4) >> 7) & bVar6) & ( ~bVar7 | bVar6 ) & ( ~bVar3 & bVar24 | bVar3 & 0x80 ) & ~bVar7 | local_218[uVar13 + ( local_368 - uVar25 )] & bVar7;
                              uVar13 = uVar13 + 1;
                              lVar11 = lVar11 + 1;
                           }
 while ( uVar13 < uVar25 );
                        ...
                        if (uVar27 == 1) {
                           if (local_3b0 != 0x10) {
                              ...
                              lVar11 = 0x10;
                              LAB_00101363:local_208[uVar19] = local_208[uVar19] | local_c8[uVar19] & bVar7;
                              if (lVar11 + 3U < local_3b0) {
                                 ...
                                 if (lVar11 + 4U < local_3b0) {
                                    ...
                                    if (lVar11 + 5U < local_3b0) {
                                       local_208[lVar11 + 5] = local_208[lVar11 + 5] | local_c8[lVar11 + 5] & bVar7;
                                       if (lVar11 + 6U < local_3b0) {
                                          local_208[lVar11 + 6] = local_208[lVar11 + 6] | local_c8[lVar11 + 6] & bVar7;
                                       }
                           ...
                           if (( uVar27 == 2 ) || ( local_1e8 = uVar27 != 4 )) {
                              if (( local_3b0 & 0xc ) != 0) {
                                 uVar19 = local_3b0 - uVar23;
                                 LAB_001012e2:auVar29 = pshuflw(auVar29, ZEXT216(CONCAT11(bVar7, bVar7)), 0);
                                 *(ulong*)( local_208 + uVar23 ) = *(ulong*)( local_208 + uVar23 ) | *(ulong*)( local_c8 + uVar23 ) & auVar29._0_8_;
                                 if (( uVar19 & 7 ) != 0) {
                                    lVar11 = ( uVar19 & 0xfffffffffffffff8 ) + uVar23;
                                    local_208[lVar11] = local_208[lVar11] | local_c8[lVar11] & bVar7;
                                    if (lVar11 + 1U < local_3b0) {
                                       local_208[lVar11 + 1] = local_208[lVar11 + 1] | local_c8[lVar11 + 1] & bVar7;
                                       uVar19 = lVar11 + 2;
 ...
 while ( local_3c8 <= local_390 );
                  ...
                  if (( ctx == (EVP_MD_CTX*)0x0 ) || ( iVar8 = EVP_DigestInit_ex(ctx, param_1, (ENGINE*)0x0) ),iVar8 < 1) {
                     LAB_00101478:uVar16 = 0;
                  }
 else {
                     if (param_10 != '\0') {
                        puVar20 = &local_1c8;
                        ...
                        if (( 0 < iVar8 ) && ( iVar8 = EVP_DigestUpdate(ctx, &local_1c8, local_318) ),0 < iVar8) goto LAB_00101257;
                        goto LAB_00101478;
                     }
                     ...
                     LAB_00101257:iVar8 = EVP_DigestUpdate(ctx, local_208, local_3b0);
                     if (iVar8 < 1) goto LAB_00101478;
               ...
               LAB_00100925:local_388 = &local_2f8;
   ...
   LAB_00101698:uVar16 = 0;
   LAB_00101482:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {

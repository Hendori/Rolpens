...
void lh_ERR_STRING_DATA_comp_thunk(undefined8 param_1, undefined8 param_2, code *UNRECOVERED_JUMPTABLE) {
...
void lh_ERR_STRING_DATA_doall_arg_thunk(undefined8 param_1, undefined8 param_2, code *UNRECOVERED_JUMPTABLE) {
...
void do_err_strings_init_ossl_(void) {
   ...
   if (( iVar2 != 0 ) && ( err_string_lock = err_string_lock != 0 )) {
      uVar1 = OPENSSL_LH_new(err_string_data_hash, err_string_data_cmp);
      int_error_hash = OPENSSL_LH_set_thunks(uVar1, 0x100000, lh_ERR_STRING_DATA_comp_thunk, lh_ERR_STRING_DATA_doall_thunk, lh_ERR_STRING_DATA_doall_arg_thunk);
      if (int_error_hash != 0) {
...
ulong ossl_err_load_ERR_strings(void) {
   ...
   if (( (int)uVar2 != 0 ) && ( uVar2 = do_err_strings_init_ossl_ret_ != 0 )) {
...
void ERR_unload_strings(int lib, ERR_STRING_DATA *str) {
   ...
   if (( ( iVar1 != 0 ) && ( do_err_strings_init_ossl_ret_ != 0 ) ) && ( iVar1 = iVar1 != 0 )) {
...
char *ERR_lib_error_string(ulong e) {
   ...
   pcVar3 = (char*)0x0;
   LAB_00100632:if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return pcVar3;
   }
...
char *ERR_reason_error_string(ulong e) {
   ...
   if (( ( iVar1 != 0 ) && ( do_err_strings_init_ossl_ret_ != 0 ) ) && ( ( e & 0x80000000 ) == 0 )) {
      ...
      if (iVar1 != 0) {
         ...
         LAB_001006f8:pcVar3 = *(char**)( lVar2 + 8 );
         goto LAB_00100742;
      }

      LAB_00100700:local_38[0] = ( ulong )((uint)e & 0x7fffff);
      iVar1 = CRYPTO_THREAD_read_lock(err_string_lock);
      if (iVar1 != 0) {
         lVar2 = OPENSSL_LH_retrieve(int_error_hash, local_38);
         CRYPTO_THREAD_unlock(err_string_lock);
   ...
   pcVar3 = (char*)0x0;
   LAB_00100742:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
void ossl_err_string_int_part_0(ulong param_1, undefined8 param_2, char *param_3, size_t param_4) {
   ...
   LAB_001007da:BIO_snprintf(param_3, param_4, "error:%08lX:%s:%s:%s", param_1, buf, param_2, buf_00);
...
long ossl_err_get_state_int(void) {
   ...
   iVar1 = *piVar3;
   iVar2 = OPENSSL_init_crypto(0x40000, 0);
   if (( ( ( iVar2 != 0 ) && ( iVar2 = CRYPTO_THREAD_run_once(&err_init, err_do_init_ossl_) ),iVar2 != 0 ) ) && ( err_do_init_ossl_ret_ != 0 )) {
      if (lVar4 != 0) {
         LAB_00100a57:*piVar3 = iVar1;
         return lVar4;
      }
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked */void ERR_clear_error(void) {
   undefined1 *puVar1;
   void *ptr;
   long lVar2;
   long lVar3;
...
undefined8 ERR_get_error_all(undefined8 *param_1, undefined4 *param_2, undefined8 *param_3, long *param_4, undefined4 *param_5) {
   byte *pbVar1;
   long lVar2;
   undefined8 uVar3;
   undefined1 *puVar4;
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked */ulong ERR_peek_last_error(void) {
   byte *pbVar1;
   undefined1 *puVar2;
   int iVar3;
   long lVar4;
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked */ulong ERR_peek_error(void) {
   byte *pbVar1;
   undefined1 *puVar2;
   int iVar3;
   long lVar4;
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked */ulong ERR_get_error(void) {
   byte *pbVar1;
   long lVar2;
   ulong uVar3;
   undefined1 *puVar4;
...
undefined8 ERR_peek_last_error_all(undefined8 *param_1, undefined4 *param_2, undefined8 *param_3, long *param_4, undefined4 *param_5) {
   byte *pbVar1;
   undefined *puVar2;
   undefined1 *puVar3;
   int iVar4;
...
undefined8 ERR_peek_error_all(undefined8 *param_1, undefined4 *param_2, undefined8 *param_3, long *param_4, undefined4 *param_5) {
   byte *pbVar1;
   undefined *puVar2;
   undefined1 *puVar3;
   int iVar4;
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked */int ERR_get_next_error_library(void) {
   int iVar1;
   int iVar2;
   iVar1 = CRYPTO_THREAD_run_once(&err_string_init, do_err_strings_init_ossl_);
   if (( iVar1 != 0 ) && ( do_err_strings_init_ossl_ret_ != 0 )) {
...
void ERR_add_error_vdata(int num, va_list args) {
   ...
   if (( ~*(uint *)(lVar2 + lVar8 * 4) & 3 ) == 0) {
      ...
      *(undefined4*)( lVar2 + lVar8 * 4 ) = 0;
      ...
      LAB_00103e30:__s = (char*)CRYPTO_malloc(0x51, "crypto/err/err.c", 0x353);
      if (__s == (char*)0x0) {
         return;
      }
      ...
      do {
         ...
         if (uVar4 < 0x30) {
            *(uint*)args = uVar4 + 8;
            ...
            LAB_00103d1e:sVar3 = strlen(__s_00);
 ...
 while ( bVar10 );
   ...
   lVar7 = lVar7 + 0x30;
   LAB_00103e05:*(char**)( lVar2 + lVar8 * 8 ) = __s;

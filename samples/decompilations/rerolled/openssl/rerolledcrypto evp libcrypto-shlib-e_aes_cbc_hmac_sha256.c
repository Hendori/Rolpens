...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int aesni_cbc_hmac_sha256_cipher(long param_1, void *param_2, void *param_3, ulong param_4) {
   long lVar1;
   uchar *md;
   byte *pbVar2;
   undefined8 *puVar3;
   ...
   *(undefined8*)( lVar15 + 0x248 ) = 0xffffffffffffffff;
   ...
   if (iVar12 == 0) {
      ...
      if (uVar30 != 0xffffffffffffffff) {
         iVar37 = 0;
         uVar20 = ( ulong )(0x301 < CONCAT11(*(undefined1*)( lVar15 + 0x24c + uVar30 ), *(undefined1*)( lVar15 + 0x24d + uVar30 )));
         lVar16 = uVar20 * 0x10;
         ...
         *(undefined8*)( lVar15 + 0x1fc ) = uVar10;
         for (int i = 0; i < 8; i++) {
            *(undefined8*)( lVar15 + ( 8*i + 516 ) ) = *(undefined8*)( lVar15 + ( 8*i + 292 ) );
         }
         ...
         uVar27 = uVar27 >> 0x18 | ( uVar27 & 0xff0000 ) >> 8 | ( uVar27 & 0xff00 ) << 8 | uVar27 * 0x1000000;
         if (uVar30 != 0) {
            lVar19 = -lVar33;
            do {
               uVar18 = uVar14 + 1;
               bVar4 = ( byte )((ulong)lVar19 >> 0x38);
               *(byte*)( lVar15 + 0x1fc + (ulong)uVar14 ) = ~((byte)((ulong)-lVar19 >> 0x38) | bVar4) & 0x80 | *(byte*)( (long)local_d0 + lVar19 + lVar33 ) & bVar4;
               uVar20 = uVar30;
               if (uVar14 == 0x3f) {
 ...
 while ( true );
         ...
         uVar20 = 0;
         uVar18 = uVar14;
         LAB_0010077f:uVar32 = (ulong)uVar18;
         if (uVar18 < 0x40) {
            LAB_0010078c:puVar3 = (undefined8*)( lVar15 + 0x1fc + uVar32 );
            uVar17 = 0x40 - uVar32;
            uVar14 = (uint)uVar17;
            if (uVar14 < 8) {
               if (( uVar17 & 4 ) == 0) {
               ...
               *(undefined8*)( (long)puVar3 + ( ( uVar17 & 0xffffffff ) - 8 ) ) = 0;
               uVar14 = uVar14 + ( (int)puVar3 - (int)( ( ulong )(puVar3 + 1) & 0xfffffffffffffff8 ) ) & 0xfffffff8;
               if (7 < uVar14) {
                  uVar18 = 0;
                  do {
                     uVar17 = (ulong)uVar18;
 ...
 while ( uVar18 < uVar14 );
            ...
            LAB_001009fb:lVar19 = -0x49 - lVar33;
            ...
            *(uint*)( lVar15 + 0x238 ) = *(uint*)( lVar15 + 0x238 ) | uVar27 & (int)uVar14 >> 0x1f;
            ...
            for (int i = 0; i < 4; i++) {
               *(undefined1(*) [16])( lVar15 + ( 16*i + 508 ) ) = (undefined1[16])0;
            }
         ...
         *(uint*)( lVar15 + 0x238 ) = uVar27;
         ...
         auVar11._0_4_ = uVar31 >> 0x18 | ( uVar31 & 0xff0000 ) >> 8 | ( uVar31 & 0xff00 ) << 8 | uVar31 << 0x18;
         local_80._0_8_ = auVar11._0_8_ << 0x20;
         local_80._8_4_ = uVar29 >> 0x18 | ( uVar29 & 0xff0000 ) >> 8 | ( uVar29 & 0xff00 ) << 8 | uVar29 << 0x18;
         local_80._12_4_ = uVar28 >> 0x18 | ( uVar28 & 0xff0000 ) >> 8 | ( uVar28 & 0xff00 ) << 8 | uVar28 << 0x18;
         local_80._0_4_ = uVar18 >> 0x18 | ( uVar18 & 0xff0000 ) >> 8 | ( uVar18 & 0xff00 ) << 8 | uVar18 << 0x18;
         local_70._4_4_ = uVar21 >> 0x18 | ( uVar21 & 0xff0000 ) >> 8 | ( uVar21 & 0xff00 ) << 8 | uVar21 << 0x18;
         local_70._0_4_ = uVar24 >> 0x18 | ( uVar24 & 0xff0000 ) >> 8 | ( uVar24 & 0xff00 ) << 8 | uVar24 << 0x18;
         local_70._8_4_ = uVar27 >> 0x18 | ( uVar27 & 0xff0000 ) >> 8 | ( uVar27 & 0xff00 ) << 8 | uVar27 << 0x18;
         local_70._12_4_ = uVar14 >> 0x18 | ( uVar14 & 0xff0000 ) >> 8 | ( uVar14 & 0xff00 ) << 8 | uVar14 << 0x18;
 ...
 while ( pbVar26 != (byte*)( (long)local_d0 + uVar30 + 0x1f ) );
      ...
      local_e0 = param_2;
      local_d8 = param_4;
      if (( ( ( ( DAT_0010302b & 0x20 ) != 0 ) || ( ( ( _DAT_00103024 & 0x10000000 ) != 0 && ( ( _OPENSSL_ia32cap_P & 0x40000000 ) != 0 || ( _DAT_00103024 & 0x800 ) != 0 ) ) ) ) && ( uVar20 = lVar16 + ( ulong )(0x40 - iVar37) ),uVar20 < uVar30 )) {
         sha256_update(lVar15 + 0x1d4, pvVar22);
         aesni_cbc_sha256_enc(param_3, param_2, uVar32 >> 6, lVar15, param_1 + 0x28, lVar15 + 0x1d4, (long)param_3 + uVar20);
      ...
      if (uVar30 == param_4) {
         ...
         for (int i = 0; i < 14; i++) {
            *(undefined8*)( lVar15 + ( 8*i + 468 ) ) = *(undefined8*)( lVar15 + ( 8*i + 356 ) );
         }
         ...
         uVar20 = uVar30 + 0x20;
         if (uVar20 < param_4) {
            memset((void*)( uVar20 + (long)param_2 ), ( (uint)param_4 - 1 ) - (int)uVar20 & 0xff, ( param_4 - 0x20 ) - uVar30);
         }
   ...
   iVar37 = 1;
   LAB_00100153:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
...
uint aesni_cbc_hmac_sha256_init_key(undefined8 param_1, undefined8 param_2, undefined8 param_3, int param_4) {
   int iVar1;
   uint uVar2;
   long lVar3;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */long tls1_1_multi_block_encrypt(long param_1, undefined1 *param_2, ulong *param_3, uint param_4, int param_5) {
   ...
   *(undefined8*)( param_2 + 0xd ) = uStack_688;
   ...
   if ((int)uVar1 < 2) {
      ...
      LAB_001020d6:sha256_multi_block(&local_160, &local_728, 0);
      puVar30 = &local_568;
      for (lVar17 = 0x80; lVar17 != 0; lVar17 = lVar17 + -1) {
         *puVar30 = 0;
         puVar30 = puVar30 + (ulong)bVar36 * -2 + 1;
 ...
 while ( puVar34 != &local_568 + (ulong)uVar1 * 2 );
      ...
      do {
         ...
         *(uchar*)( (long)puVar30 + 0xc ) = (uchar)uVar14;
         ...
         puVar18[0x28] = uVar4;
         puVar18[0x30] = uVar6;
         uVar26 = ( uVar32 | uVar33 >> 0x28 | uVar22 >> 0x18 | uVar9 >> 8 | uVar10 << 8 | uVar11 << 0x18 | uVar12 << 0x28 | uVar13 ) + lVar17;
         *puVar30 = uVar26 >> 0x38 | ( uVar26 & 0xff000000000000 ) >> 0x28 | ( uVar26 & 0xff0000000000 ) >> 0x18 | ( uVar26 & 0xff00000000 ) >> 8 | ( uVar26 & 0xff000000 ) << 8 | ( uVar26 & 0xff0000 ) << 0x18 | ( uVar26 & 0xff00 ) << 0x28 | uVar26 << 0x38;
         *(uint*)( puVar30 + 1 ) = ( ( uVar14 & 0xff00 | (uint)bVar20 ) << 8 | (uint)bVar2 ) << 8 | (uint)bVar3;
         puVar34 = *ppuVar25;
         uVar26 = puVar34[1];
 ...
 while ( (uint)lVar29 < uVar1 );
      ...
      if (uVar27 < 0x840) {
         ...
         LAB_00101180:local_7d0 = local_6a8;
         local_800 = &local_7a8;
         uVar35 = uVar27 >> 6;
         do {
            sha256_multi_block(&local_160, &local_728, param_5);
 ...
 while ( 0x20 < uVar35 );
      ...
      while (true) {
         ...
         lVar29 = __memcpy_chk(puVar30, ( ulong )(uint)(*(int*)( (long)local_7a0 + lVar17 ) * 0x40) + *(long*)( (long)local_7a0 + lVar17 + -8 ), (ulong)uVar21, lVar17 * -8 + 0x400);
...
;
      ...
      while (true) {
         ...
         *puVar19 = uVar21 >> 0x18 | ( uVar21 & 0xff0000 ) >> 8 | ( uVar21 & 0xff00 ) << 8 | uVar21 << 0x18;
         for (int i = 0; i < 7; i++) {
            uVar21 = puVar18[( 8*i + 8 )];
            puVar19[( i + 1 )] = uVar21 >> 24 | ( uVar21 & 16711680 ) >> 8 | ( uVar21 & 65280 ) << 8 | uVar21 << 24;
         }
         ...
         if (uVar21 < 8) {
            ...
            *(long*)( (long)puVar19 + uVar32 + 0x18 ) = lVar17;
            uVar21 = uVar21 + ( (int)( puVar19 + 8 ) - (int)( ( ulong )(puVar19 + 10) & 0xfffffffffffffff8 ) ) & 0xfffffff8;
            if (7 < uVar21) {
               uVar31 = 0;
               do {
                  uVar33 = (ulong)uVar31;
...
;
   ...
   LAB_001015f2:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return local_818;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */ulong aesni_cbc_hmac_sha256_ctrl(undefined8 param_1, undefined4 param_2, uint param_3, undefined8 *param_4) {
   SHA256_CTX *c;
   long lVar1;
   undefined8 uVar2;
   ushort uVar3;
...
LAB_00102520:
   ...
   uVar7 = 0xffffffff;
   LAB_00102220:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar7;
   }

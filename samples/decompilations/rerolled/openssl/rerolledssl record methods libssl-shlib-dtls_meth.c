ulong satsub64be(ulong *param_1, ulong *param_2) {
   ...
   uVar1 = *param_1;
   uVar4 = *param_2;
   uVar3 = uVar1 >> 0x38 | ( uVar1 & 0xff000000000000 ) >> 0x28 | ( uVar1 & 0xff0000000000 ) >> 0x18 | ( uVar1 & 0xff00000000 ) >> 8 | ( uVar1 & 0xff000000 ) << 8 | ( uVar1 & 0xff0000 ) << 0x18 | ( uVar1 & 0xff00 ) << 0x28 | uVar1 << 0x38;
   uVar1 = uVar4 >> 0x38 | ( uVar4 & 0xff000000000000 ) >> 0x28 | ( uVar4 & 0xff0000000000 ) >> 0x18 | ( uVar4 & 0xff00000000 ) >> 8 | ( uVar4 & 0xff000000 ) << 8 | ( uVar4 & 0xff0000 ) << 0x18 | ( uVar4 & 0xff00 ) << 0x28 | uVar4 << 0x38;
   uVar4 = uVar3 - uVar1;
...
long dtls_get_max_record_overhead(long param_1) {
   ...
   lVar3 = 0;
   LAB_00100088:return lVar3 + 0xd + *(long*)( param_1 + 0x10d8 ) + *(long*)( param_1 + 0x1030 );
}
bool dtls_free(long param_1) {
   ...
   if (*(long*)( param_1 + 0x6c0 ) != 0) {
      uVar6 = BIO_write_ex(*(undefined8*)( param_1 + 0x48 ), *(long*)( param_1 + 0x6b8 ) + *(long*)( param_1 + 0x6a0 ), *(long*)( param_1 + 0x6c0 ), auStack_38);
...
int dtls_new_record_layer(undefined8 param_1, undefined8 param_2, uint param_3, undefined8 param_4, undefined8 param_5, undefined4 param_6, undefined2 param_7, undefined8 param_8, undefined8 param_9, undefined8 param_10, undefined8 param_11, undefined8 param_12, undefined8 param_13, undefined8 param_14, undefined8 param_15, undefined8 param_16, undefined8 param_17, undefined4 param_18, undefined8 param_19, undefined8 param_20) {
   long lVar1;
   long lVar2;
   int iVar3;
   pqueue p_Var4;
   ...
   *(undefined8**)( lVar2 + 0x1148 ) = puVar5;
   iVar3 = ( *(code*)*puVar5 )(lVar2, param_6, param_10, param_11, param_12, param_13, param_14, param_15, param_16, param_17, param_18, param_19, param_20);
   if (iVar3 == 1) {
      return 1;
   }

   LAB_00100392:dtls_free(*in_stack_000000d0);
   *in_stack_000000d0 = 0;
   return iVar3;
}
undefined8 dtls_get_more_records(long param_1) {
   ...
   *(undefined8*)( param_1 + 0xfe0 ) = 0;
   if (( *(long*)( param_1 + 0x6a0 ) == 0 ) && ( iVar11 = iVar11 == 0 )) {
      LAB_00100b62:uVar13 = 0xfffffffe;
      goto LAB_00100640;
   }
   ...
   LAB_00100548:do {
      ...
      if (( *(int*)( param_1 + 0xfe8 ) != 0xf1 ) || ( *(ulong*)( param_1 + 0xff8 ) < 0xd )) {
         uVar13 = ( **(code**)( *(long*)( param_1 + 0x1148 ) + 0x20 ) )(param_1, 0xd, *(undefined8*)( param_1 + 0x6b0 ), 0, 1, &local_a0);
         if (0 < (int)uVar13) {
            if (*(long*)( param_1 + 0xff8 ) == 0xd) {
               ...
               *(ulong*)( param_1 + 0x6d8 ) = ( ulong )(ushort)(*(ushort*)( pbVar5 + 0xb ) << 8 | *(ushort*)( pbVar5 + 0xb ) >> 8);
               if (*(code**)( param_1 + 0x1128 ) != (code*)0x0) {
                  ( **(code**)( param_1 + 0x1128 ) )(0, uVar18, 0x100, pbVar5, 0xd, *(undefined8*)( param_1 + 0x1118 ));
               }

               iVar11 = *(int*)( param_1 + 0x14 );
               if (( ( *(int*)( param_1 + 0x10d4 ) != 0 ) || ( *(int*)( param_1 + 0x6d4 ) == 0x15 ) ) || ( *(int*)( param_1 + 0x6d0 ) == iVar11 )) {
                  uVar10 = iVar11 >> 8;
                  if (iVar11 == 0x1ffff) {
                     uVar10 = 0xfe;
                  }
      ...
      if (*(ulong*)( param_1 + 0xff8 ) - 0xd < uVar16) {
         LAB_00100695:iVar11 = ( **(code**)( *(long*)( param_1 + 0x1148 ) + 0x20 ) )(param_1, uVar16, uVar16, 1, 1, &local_a0);
         if (( 0 < iVar11 ) && ( local_a0 == uVar16 )) goto LAB_00100800;
         goto LAB_001006c7;
      }

      LAB_00100800:bVar9 = false;
      *(undefined4*)( param_1 + 0xfe8 ) = 0xf0;
      ...
      if (( iVar11 < 1 ) && ( ( iVar11 < -0x3f || ( ( *puVar17 >> ( ( ulong )(uint) - iVar11 & 0x3f ) & 1 ) != 0 ) ) )) goto LAB_001006d5;
 ...
 while ( uVar16 == 0 );
      ...
      if (*(int*)( param_1 + 0x1110 ) != 0) {
         ...
         if (CONCAT44(extraout_var, iVar11) < 100) {
            ...
            *data = uVar13;
            ...
            data[9] = uVar7;
            for (int i = 0; i < 3; i++) {
               uVar13 = *(undefined8*)( param_1 + ( 16*i + 1768 ) );
               data[( 2*i + 10 )] = *(undefined8*)( param_1 + ( 16*i + 1760 ) );
               data[( 2*i + 11 )] = uVar13;
            }
            ...
            *(undefined8*)( param_1 + 0xff8 ) = 0;
            for (int i = 0; i < 3; i++) {
               *(undefined1(*) [16])( param_1 + ( 16*i + 1696 ) ) = (undefined1[16])0;
            }

            *(undefined8*)( param_1 + 0x710 ) = 0;
            *pauVar1 = (undefined1[16])0x0;
            for (int i = 0; i < 3; i++) {
               *(undefined1(*) [16])( param_1 + ( 16*i + 1760 ) ) = (undefined1[16])0;
            }
   ...
   *(long*)( param_1 + 0x6f8 ) = lVar15;
   if (uVar16 < 0x4541) {
      ...
      *(ulong*)( param_1 + 0x6e0 ) = uVar16;
         ...
         if (( *(int*)( param_1 + 0x10b0 ) != 0 ) && ( *(long*)( param_1 + 0x1038 ) != 0 )) {
            if (*(ulong*)( param_1 + 0x6e0 ) < len) {
               ...
               *(long*)( param_1 + 0x6d8 ) = lVar20;
               ...
               if (( iVar11 != 0 ) && ( iVar11 = CRYPTO_memcmp(local_88, (void*)( lVar15 + lVar20 ), len) ),iVar11 == 0) goto LAB_00100b18;
               ERR_new();
      ...
      if (iVar11 == 0) {
         ...
         LAB_00100c65:CRYPTO_free(local_98);
      }
 else {
         ERR_clear_last_mark();
         if (( ( *(int*)( param_1 + 0x10b0 ) == 0 ) && ( *(long*)( param_1 + 0x1020 ) != 0 ) ) && ( lVar15 = EVP_MD_CTX_get0_md(*(undefined8*)( param_1 + 0x1038 )) ),lVar15 != 0) {
            iVar11 = ( **(code**)( *(long*)( param_1 + 0x1148 ) + 0x10 ) )(param_1, pauVar1, local_88);
            if (( ( iVar11 == 0 ) || ( local_98 == (void*)0x0 ) ) || ( ( iVar11 = CRYPTO_memcmp(local_88, local_98, len) ),iVar11 != 0 || ( uVar16 = *(ulong*)( param_1 + 0x6d8 ) ),len + 0x4400 < uVar16 )) {
               *(undefined8*)( param_1 + 0x6d8 ) = 0;
               *(undefined8*)( param_1 + 0xff8 ) = 0;
         ...
         if (*(long*)( param_1 + 0x1040 ) == 0) {
            LAB_00100cb7:if (uVar16 <= *(uint*)( param_1 + 0x104c )) {
               ...
               *(undefined8*)( param_1 + 0xff8 ) = 0;
               ...
               if (( pcVar6 == (code*)0x0 ) || ( iVar11 = iVar11 != 0 )) goto LAB_00100626;
               goto LAB_00100b62;
            }
   ...
   LAB_001006c7:if (*(int*)( param_1 + 0x1008 ) != -1) goto LAB_00100b62;
   LAB_001006d5:*(undefined8*)( param_1 + 0x6d8 ) = 0;
   LAB_0010053d:*(undefined8*)( param_1 + 0xff8 ) = 0;
   goto LAB_00100548;
   code_r0x0010055c:plVar4 = (long*)ppVar12->data;
   ossl_tls_buffer_release(param_1 + 0x6a0);
   *(long*)( param_1 + 0xff0 ) = *plVar4;
   *(long*)( param_1 + 0xff8 ) = plVar4[1];
   for (int i = 0; i < 7; i++) {
      lVar2 = plVar4[( 2*i + 3 )];
      *(long*)( param_1 + ( 16*i + 1696 ) ) = plVar4[( 2*i + 2 )];
      *(long*)( param_1 + ( 16*i + 1704 ) ) = lVar2;
   }
   ...
   *(undefined2*)( param_1 + 0x1006 ) = *(undefined2*)( lVar2 + 9 );
   ...
   pitem_free(ppVar12);
   LAB_00100626:*(undefined8*)( param_1 + 0xfd0 ) = 1;
   uVar13 = 1;
...
undefined8 dtls_prepare_record_header(long param_1, undefined8 param_2, long param_3, undefined1 param_4, undefined8 *param_5) {
   long lVar1;
   int iVar2;
   undefined8 uVar3;
   long lVar4;
   ...
   *param_5 = 0;
   ...
   if (( ( ( ( ( iVar2 == 0 ) || ( iVar2 = WPACKET_put_bytes__(param_2, *(undefined4*)( param_3 + 4 ), 2) ),iVar2 == 0 ) ) || ( iVar2 = WPACKET_put_bytes__(param_2, *(undefined2*)( param_1 + 0x30 ), 2) ),iVar2 == 0 ) ) || ( ( iVar2 = WPACKET_memcpy(param_2, param_1 + 0x1002, 6) ),iVar2 == 0 || ( iVar2 = WPACKET_start_sub_packet_len__(param_2, 2) ),iVar2 == 0 )) {
      ERR_new();

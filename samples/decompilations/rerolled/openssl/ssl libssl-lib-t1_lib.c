...
undefined8 add_provider_groups(undefined8 param_1, long *param_2) {
   ...
   if (lVar6 == lVar5) {
      ...
      if (pvVar4 != (void*)0x0) {
         ...
         *puVar10 = 0;
         puVar10[0x45] = 0;
         uVar8 = ( ulong )(( (int)puVar10 - (int)(undefined8*)( ( ulong )(puVar10 + 1) & 0xfffffffffffffff8 ) ) + 0x230U >> 3);
      ...
      LAB_00100310:uVar9 = 0;
      goto LAB_001002c0;
   }

   LAB_00100211:pauVar1 = (undefined1(*) [16])( puVar2[0xce] + lVar5 * 0x38 );
   ...
   if (( lVar6 == 0 ) || ( *(int*)( lVar6 + 8 ) != 4 )) {
      ...
      *(char**)( *pauVar1 + 8 ) = pcVar7;
      ...
      if (( ( lVar6 == 0 ) || ( iVar3 = OSSL_PARAM_get_uint(lVar6, &local_38) ),iVar3 == 0 )) {
         ERR_new();
         uVar9 = 0x114;
         LAB_00100361:ERR_set_debug("ssl/t1_lib.c", uVar9, "add_provider_groups");
         ERR_set_error(0x14, 0x80106, 0);
         goto LAB_0010027a;
      }
      ...
      *(char**)pauVar1[1] = pcVar7;
      ...
      if (( lVar6 != 0 ) && ( ( iVar3 = OSSL_PARAM_get_uint(lVar6, &local_34) ),iVar3 == 0 || ( 1 < local_34 ) )) {
         ERR_new();
         uVar9 = 0x12a;
         goto LAB_00100361;
      }
   ...
   *pauVar1 = (undefined1[16])0x0;
   LAB_001002c0:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar9;
   }
...
undefined8 add_provider_sigalgs(undefined8 param_1, long *param_2) {
   ...
   if (lVar7 == lVar9) {
      ...
      *puVar12 = 0;
      puVar12[0x81] = 0;
      uVar11 = ( ulong )(( (int)puVar12 - (int)(undefined8*)( ( ulong )(puVar12 + 1) & 0xfffffffffffffff8 ) ) + 0x410U >> 3);
   ...
   if (pcVar8 == (char*)0x0) {
      ...
      *puVar12 = pcVar8;
      ...
      if (( ( lVar7 == 0 ) || ( iVar4 = OSSL_PARAM_get_uint(lVar7, &local_44) ),iVar4 == 0 )) {
         ERR_new();
         uVar13 = 0x1af;
         LAB_00100773:ERR_set_debug("ssl/t1_lib.c", uVar13, "add_provider_sigalgs");
         ERR_set_error(0x14, 0x80106, 0);
         LAB_0010078e:uVar13 = 0;
      }
 else {
         *(short*)( puVar12 + 1 ) = (short)local_44;
         lVar7 = OSSL_PARAM_locate_const(param_1, "tls-sigalg-sec-bits");
         if (( lVar7 == 0 ) || ( iVar4 = iVar4 == 0 )) {
            ERR_new();
            uVar13 = 0x1b7;
            goto LAB_00100773;
         }
         ...
         puVar12[3] = 0;
         LAB_00100a1c:lVar7 = OSSL_PARAM_locate_const(param_1, "tls-sigalg-sig-name");
         if (lVar7 == 0) {
            puVar12[4] = 0;
         }
 else {
         ...
         *(undefined8*)( (long)puVar12 + 0x5c ) = _LC24;
         ...
         if (( 1 < *(int*)( puVar12 + 0xc ) + 1U ) && ( *(int*)( (long)puVar12 + 0x5c ) < *(int*)( puVar12 + 0xc ) )) {
            ERR_new();
            uVar13 = 0x21f;
            goto LAB_00100773;
         }
         ...
         *(undefined8*)( (long)puVar12 + 0x5c ) = uVar13;
         ...
         if (iVar4 + 1U < 2) {
            if (( 1 < iVar5 + 1U ) && ( 0x304 < iVar5 )) {
               LAB_00100e65:*(undefined8*)( (long)puVar12 + 0x54 ) = uVar13;
            }

            LAB_00100e69:if (*(int*)( (long)puVar12 + 0x54 ) == -1) goto LAB_00100d1c;
         }
 else {
            if (iVar4 < iVar5) {
               ERR_new();
            ...
            *(undefined8*)( (long)puVar12 + 0x54 ) = uVar13;
            LAB_00100d1c:if (*(int*)( (long)puVar12 + 0x5c ) == -1) {
               uVar13 = 1;
               goto LAB_0010079a;
            }
         ...
         if (lVar7 == 0) {
            LAB_00100d6d:ERR_pop_to_mark();
            uVar13 = 1;
         }
 else {
            lVar9 = EVP_KEYMGMT_get0_provider(lVar7);
            if (lVar3 != lVar9) {
               LAB_00100d65:EVP_KEYMGMT_free(lVar7);
               goto LAB_00100d6d;
            }
   ...
   LAB_0010079a:CRYPTO_free((void*)*puVar12);
   *puVar12 = 0;
   for (int i = 0; i < 8; i++) {
      CRYPTO_free((void*)puVar12[( i + 2 )]);
      puVar12[( i + 2 )] = 0;
   }

   LAB_00100879:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
int tuple_cb(void *param_1, int param_2, void *param_3) {
   ...
   if (( param_1 == (void*)0x0 || param_2 < 1 ) || ( param_3 == (void*)0x0 )) {
      ...
      if (*(long*)( (long)param_3 + 0x28 ) == *(long*)( (long)param_3 + 0x20 )) {
         pvVar3 = CRYPTO_realloc(*(void**)( (long)param_3 + 0x30 ), (int)*(long*)( (long)param_3 + 0x20 ) * 8 + 0x100, "ssl/t1_lib.c", 0x603);
         if (pvVar3 == (void*)0x0) {
            return 0;
         }
...
bool tls1_check_sig_alg(long param_1, undefined8 param_2, int param_3) {
   ...
   long local_40;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (( param_3 == -1 ) || ( iVar2 = iVar2 != 0 )) {
      LAB_00101239:bVar8 = true;
   }
 else {
      iVar2 = X509_get_signature_nid(param_2);
      if (param_3 == 0) {
         if (( ( ( ( *(byte*)( *(long*)( *(int**)( param_1 + 0x18 ) + 0x36 ) + 0x50 ) & 8 ) == 0 ) && ( iVar3 = **(int**)( param_1 + 0x18 ) ),0x303 < iVar3 ) ) && ( iVar3 != 0x10000 )) {
...
;
               LAB_001012da:if (( *(int*)( lVar5 + 0x24 ) == iVar2 ) || ( ( ( *(int*)( lVar5 + 0x1c ) == 0x390 && ( iVar3 = OBJ_find_sigid_algs(iVar2, &local_48, &local_44) ),iVar3 != 0 ) ) && ( ( local_44 == 6 && ( *(int*)( lVar5 + 0x14 ) == local_48 ) ) ) )) goto LAB_00101239;
               lVar6 = lVar6 + 1;
            }
 while ( lVar7 != lVar6 );
         }
   ...
   LAB_0010123e:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
;
   *puVar9 = *puVar9 - 1;
   lVar16 = lVar15;
   LAB_001016bf:if (uVar17 <= uVar10) goto LAB_001016c4;
   LAB_001016c9:uVar17 = param_3[8];
   if (uVar17 != 0) {
      lVar16 = param_3[9];
      uVar10 = 0;
      do {
         if (*(short*)( lVar16 + uVar10 * 2 ) == sVar18) {
            uVar17 = uVar17 - 1;
            if (uVar10 < uVar17) {
               memmove((void*)( lVar16 + uVar10 * 2 ), (void*)( lVar16 + 2 + uVar10 * 2 ), ( uVar17 - uVar10 ) * 2);
            }
 ...
 while ( uVar17 != uVar10 );
   ...
   LAB_00101720:iVar5 = 1;
   goto LAB_00101726;
   LAB_001016c4:puVar2[lVar16] = puVar2[lVar16] - 1;
   goto LAB_001016c9;
   switchD_001014ab_caseD_2f:iVar5 = -1;
   LAB_00101726:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar5;
   }
      ...
      if (( *param_3 != 0x3e ) && ( param_2 < 0x28 )) {
         ...
         if (pcVar4 == (char*)0x0) {
            ...
            if (lVar6 == 0) {
               ...
               do {
                  puVar2 = *ppuVar12;
                  if (( ( ppuVar12[1] != (undefined*)0x0 ) && ( iVar3 = OPENSSL_strcasecmp(local_68) ),iVar3 == 0 )) {
                     lVar6 = *param_3;
...
;
 ...
 while ( lVar5 != lVar6 );
   ...
   bVar13 = false;
   LAB_00101c13:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 check_cert_usable_isra_0(long param_1, int param_2, undefined8 param_3, undefined8 param_4) {
 ...
 while ( lVar10 != lVar2 );
   ...
   LAB_00101f38:uVar6 = 0;
   LAB_00101f3a:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }

   return uVar6;
   LAB_00101f73:lVar9 = 0;
   lVar5 = *(long*)( *(long*)( param_1 + 8 ) + 0x660 );
   do {
      if (*(short*)( lVar5 + 0x10 ) == sVar8) {
         if (( ( *(int*)( lVar5 + 0x2c ) != 0 ) && ( *(int*)( lVar5 + 0x14 ) == local_38 ) ) && ( *(int*)( lVar5 + 0x1c ) == local_34 )) goto LAB_00101f9d;
         break;
      }
...
void ssl_load_groups(SSL_CTX *param_1) {
   ...
   SSL_CTX_ctrl(param_1, 0x5c, 0, "?*X25519MLKEM768 / ?*X25519:?secp256r1 / ?X448:?secp384r1:?secp521r1 / ?ffdhe2048:?ffdhe3072");
   return;
}
...
uint tls_valid_group(long param_1, undefined2 param_2, undefined4 param_3, int param_4, int param_5, uint *param_6) {
   uint uVar1;
   char *__s1;
   int iVar2;
   uint uVar3;
   ...
   if (lVar4 == 0) {
      ...
      if (-1 < (int)( uVar1 | uVar3 )) {
         ...
         if (( ( ( *(byte*)( *(long*)( *(long*)( param_1 + 0x18 ) + 0xd8 ) + 0x50 ) & 8 ) == 0 ) && ( ( param_6 != (uint*)0x0 & (byte)uVar5 ) != 0 ) ) && ( param_4 == 0x304 )) {
            *param_6 = ( uint )(uVar1 == 0 || 0x303 < (int)uVar1);
         }

         if (( ( param_5 != 0 ) && ( ( ( __s1 = *(char**)( lVar4 + 0x10 ) * __s1 != 'E' || ( __s1[1] != 'C' ) ) || ( __s1[2] != '\0' ) ) ) ) && ( iVar2 = iVar2 != 0 )) {
...
undefined8 tls1_get0_implemented_groups(int param_1, int param_2, long param_3, long param_4, long param_5, long param_6) {
   short sVar1;
   int iVar2;
   int iVar3;
   long lVar4;
   ...
   short sVar10;
   long lVar11;
   if (( ( param_3 == 0 ) || ( param_6 == 0 ) ) || ( lVar4 = lVar4 == 0 )) {
      return 0;
   }
   ...
   if (param_4 != 0) {
      ...
      lVar11 = 0;
      do {
         if (( ( *(int*)( param_3 + 0x20 ) <= iVar3 ) || ( param_2 < 1 ) ) && ( ( *(int*)( param_3 + 0x24 ) < 1 || param_1 <= *(int*)( param_3 + 0x24 ) || ( param_1 < 1 ) ) )) {
   ...
   if (uVar9 != 0) {
      ...
      if (param_5 == 0) {
         do {
            ...
            if (( sVar1 != sVar10 ) && ( iVar3 = OPENSSL_sk_push(param_6, *(undefined8*)*plVar5) ),sVar10 = sVar1,iVar3 < 1) goto LAB_00102920;
            uVar7 = uVar7 + 1;
         }
 while ( uVar9 != uVar7 );
      }
 ...
 while ( uVar9 != uVar7 );
   ...
   uVar8 = 1;
   LAB_00102922:OPENSSL_sk_pop_free(lVar4, free_wrapper);
   return uVar8;
   LAB_00102920:uVar8 = 0;
   goto LAB_00102922;
}
uint tls1_shared_group(long param_1, uint param_2) {
            ...
            do {
               if (uVar2 == *(ushort*)( local_58 + lVar6 * 2 )) {
                  ...
                  if (iVar4 != 0) {
                     ...
                     uVar8 = local_50;
                     if (( ( iVar4 != -1 ) && ( ( iVar5 == 0 || ( iVar5 = ssl_version_cmp(param_1, *(undefined4*)( param_1 + 0x48 )) ),uVar8 = local_50,-1 < iVar5 ) ) )) {
                        uVar7 = (uint)uVar2;
 ...
 while ( uVar10 < uVar8 );
   ...
   LAB_00102a87:uVar7 = 0;
   LAB_00102a89:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 tls1_set_groups(undefined8 *param_1, long *param_2, undefined8 *param_3, undefined8 *param_4, undefined8 *param_5, undefined8 *param_6, long param_7, long param_8) {
   ulong *puVar1;
   ulong uVar2;
   ushort uVar3;
   undefined2 *ptr;
   ...
   if (param_8 == 0) {
      ...
      if (( ptr == (undefined2*)0x0 ) || ( local_98 = (undefined2*)CRYPTO_malloc(2, "ssl/t1_lib.c", 0x44a) ),local_98 == (undefined2*)0x0) {
         local_90 = (long*)0x0;
 ...
 while ( param_8 != lVar6 );
      ...
      LAB_00102cd0:CRYPTO_free(ptr);
      CRYPTO_free(local_98);
      CRYPTO_free(local_90);
   }

   uVar4 = 0;
   LAB_00102d05:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar4;
   }
...
undefined8 tls1_set_groups_list(long param_1, undefined8 *param_2, undefined8 *param_3, undefined8 *param_4, undefined8 *param_5, undefined8 *param_6, undefined8 *param_7, byte *param_8) {
   byte bVar1;
   long lVar2;
   ...
   if (pvVar6 == (void*)0x0) {
      ...
      *puVar7 = 0;
      ...
      if (bVar1 != 0) {
         ...
         LAB_00102f61:if (( *(byte*)( (long)*ppuVar8 + (ulong)bVar1 * 2 + 1 ) & 0x20 ) != 0) goto LAB_00102f50;
 ...
 while ( uVar9 < (ulong)local_88._8_8_ );
      ...
      LAB_00103010:if (( ( ( param_2 != (undefined8*)0x0 ) && ( param_4 != (undefined8*)0x0 ) ) && ( param_6 != (undefined8*)0x0 ) ) && ( ( ( param_3 != (undefined8*)0x0 && ( param_5 != (undefined8*)0x0 ) ) && ( param_7 != (undefined8*)0x0 ) ) )) {
   ...
   LAB_001030c5:CRYPTO_free((void*)local_98._8_8_);
   CRYPTO_free((void*)local_78._0_8_);
   CRYPTO_free((void*)local_68._8_8_);
   LAB_001030fb:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }

   return uVar11;
   LAB_00102f50:bVar1 = param_8[1];
   param_8 = param_8 + 1;
...
undefined8 tls1_check_group_id(long param_1, short param_2, int param_3) {
   ...
   if (( ( *(uint*)( *(long*)( param_1 + 0x880 ) + 0x1c ) & 0x30000 ) == 0 ) || ( *(long*)( param_1 + 0x300 ) == 0 )) {
      LAB_00103290:if (param_3 == 0) {
         LAB_001032d0:iVar1 = tls_group_allowed(param_1, param_2, 0x20006);
         if (iVar1 != 0) {
            uVar2 = 1;
 ...
 while ( local_28 != lVar3 );
   ...
   LAB_00103260:uVar2 = 0;
   LAB_00103262:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 ssl_setup_sigalgs(undefined8 *param_1) {
   ...
   if (param_1 != (undefined8*)0x0) {
      ...
      if (( ( ptr == (undefined8*)0x0 ) || ( pkey == (EVP_PKEY*)0x0 ) ) || ( lVar16 = CRYPTO_zalloc(uVar1 * 2, "ssl/t1_lib.c", 0x88f) ),lVar16 == 0) {
         uVar21 = 0;
      }
 else {
         ERR_set_mark();
         ...
         do {
            ...
            *puVar18 = *ppuVar23;
            ...
            puVar18[6] = puVar12;
            puVar18[7] = puVar13;
            if (( ( iVar14 == 0 ) || ( param_1[(long)*(int*)( ppuVar23 + 3 ) + 0xae] != 0 ) ) && ( iVar14 = EVP_PKEY_set_type(pkey, *(int*)( (long)ppuVar23 + 0x1c )) ),iVar14 != 0) {
...
;
 ...
 while ( ppuVar8 != (undefined**)&DAT_00109698 );
      LAB_0010392d:EVP_PKEY_free(pkey);
   }
...
int sigalg_security_bits(long param_1, long param_2) {
   ...
   if (iVar1 != 0) {
      if (local_28 == 0) {
         iVar1 = 0x80;
         if (( *(short*)( param_2 + 0x10 ) == 0x807 ) || ( iVar1 = 0xe0 * (short*)( param_2 + 0x10 ) == 0x808 )) goto LAB_00103b02;
   ...
   iVar1 = 0;
   LAB_00103b02:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
         ...
         LAB_00103c60:do {
            ...
            do {
               if (*(short*)( lVar2 + 0x10 ) == *(short*)( lVar6 + lVar4 * 2 )) {
                  ...
                  if (( ( *(int*)( lVar2 + 0x1c ) == 0x198 ) && ( *(int*)( lVar2 + 0x28 ) != 0 ) ) && ( *(int*)( lVar2 + 0x28 ) == param_2 )) {
                     return 1;
                  }
...
bool ssl_cipher_disabled(long param_1, SSL_CIPHER *param_2, undefined4 param_3, int param_4) {
   ...
   if (( ( ( *(uint*)( (long)&param_2->algorithm_mkey + 4 ) & *(uint*)( param_1 + 0x410 ) ) == 0 ) && ( ( (uint)param_2->algorithm_auth & *(uint*)( param_1 + 0x414 ) ) == 0 ) ) && ( iVar1 = iVar1 != 0 )) {
      ...
      if (( iVar3 < 1 ) && ( iVar3 = ssl_version_cmp(param_1, uVar4, *(undefined4*)( param_1 + 0x418 )) ),-1 < iVar3) {
         iVar3 = ssl_security(param_1, param_3, *(undefined4*)( (long)&param_2->algo_strength + 4 ), 0, param_2);
         return iVar3 == 0;
      }
...
undefined8 tls12_sigalg_allowed(SSL *param_1, undefined4 param_2, long param_3) {
   ...
   if (( *(byte*)( *(long*)&param_1->wbio[1].ex_data.dummy + 0x50 ) & 8 ) == 0) {
      ...
      if (( iVar2 < 0x304 ) || ( iVar2 == 0x10000 )) {
         if (( *(int*)&param_1->s2 != 0 ) || ( *(int*)&param_1[1].psk_client_callback < 0x304 )) goto LAB_00103ee0;
         ...
         if (( *(int*)&param_1->s2 == 0 ) && ( 0x303 < *(int*)&param_1[1].psk_client_callback )) {
            LAB_00103f9a:if (( *(uint*)( param_3 + 0x18 ) == 10 ) || ( *(uint*)( param_3 + 0x18 ) < 2 )) goto LAB_00103fb0;
         }
      ...
      LAB_00103ee0:iVar2 = ssl_cert_is_disabled(param_1->method, (long)*(int*)( param_3 + 0x20 ));
      if (iVar2 == 0) {
         if (( 1 < *(int*)( param_3 + 0x1c ) - 0x3d3U ) && ( *(int*)( param_3 + 0x1c ) != 0x32b )) {
            LAB_00103f40:uVar3 = sigalg_security_bits(param_1->method, param_3);
         ...
         pBVar1 = param_1->wbio;
         if (*(int*)&param_1->s2 == 0) {
            if (( *(int*)&pBVar1->method != 0x10000 ) || ( *(int*)( (long)&param_1[1].psk_client_callback + 4 ) < 0x304 )) goto LAB_00103f40;
            if (( *(int*)&param_1[1].psk_client_callback < 0x304 ) && ( psVar7 = SSL_get_ciphers(param_1) ),psVar7 != (stack_st_SSL_CIPHER*)0x0) {
               iVar4 = OPENSSL_sk_num(psVar7);
               iVar2 = 0;
               if (iVar4 < 1) {
                  LAB_00104096:if (iVar4 != iVar2) goto LAB_00103f40;
               }
 else {
                  do {
 ...
 else if (( ( ( *(byte*)( *(long*)&pBVar1[1].ex_data.dummy + 0x50 ) & 8 ) != 0 ) || ( *(int*)&pBVar1->method == 0x10000 ) ) || ( *(int*)&pBVar1->method < 0x304 )) goto LAB_00103f40;
      }

   }

   LAB_00103fb0:uVar6 = 0;
   LAB_00103fb2:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined1 *tls1_get_legacy_sigalg(long param_1, ulong param_2) {
   ...
   if (iVar1 == -1) {
      if (*(int*)( param_1 + 0x78 ) == 0) {
         param_2 = ( **(long**)( param_1 + 0x880 ) - ( *(long**)( param_1 + 0x880 ) )[4] >> 3 ) * -0x3333333333333333;
         iVar1 = (int)param_2;
         goto LAB_001040c4;
      }
      ...
      param_2 = 0;
      while (( lVar3 = ssl_cert_lookup_by_idx(param_2, *(undefined8*)( param_1 + 8 )) ),lVar3 == 0 || ( ( *(uint*)( *(long*)( param_1 + 0x300 ) + 0x20 ) & *(uint*)( lVar3 + 4 ) ) == 0 )) {
         param_2 = param_2 + 1;
...
;
      ...
      LAB_001040c4:if (8 < (uint)param_2) {
         return (undefined1*)0x0;
      }

      if (( *(uint*)( *(long*)( *(long*)( param_1 + 0x18 ) + 0xd8 ) + 0x50 ) & 2 ) == 0 && (uint)param_2 == 0) {
         puVar5 = legacy_rsa_sigalg;
         LAB_00104138:iVar1 = tls12_sigalg_allowed(param_1, 0x5000b, puVar5);
         if (iVar1 == 0) {
            return (undefined1*)0x0;
         }
   ...
   LAB_001040f4:lVar3 = *(long*)( param_1 + 8 );
...
undefined8 tls1_set_peer_legacy_sigalg(long param_1, undefined8 param_2) {
   ...
   uVar2 = 0;
   LAB_001042bc:if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar2;
   }
...
bool tls_sigalg_compat(long param_1, long param_2) {
   ...
   if (( ( ( iVar1 != -1 ) && ( iVar2 != -1 ) ) && ( ( iVar1 == 0 || ( ( iVar4 == 0 || ( iVar4 = ssl_version_cmp(param_1) ),iVar4 < 1 ) ) ) ) )) {
...
long tls12_shared_sigalgs(long param_1, long *param_2, long param_3, long param_4, long param_5, long param_6) {
   int iVar1;
   long lVar2;
   long lVar3;
   long lVar4;
   ...
   LAB_00104443:do {
      ...
      do {
         if (*(short*)( param_3 + lVar5 * 2 ) == *(short*)( lVar4 + 0x10 )) {
            if (( ( *(int*)( lVar4 + 0x2c ) == 0 ) || ( iVar1 = tls12_sigalg_allowed(param_1, 0x5000c, lVar4) ),iVar1 == 0 )) goto LAB_001044a0;
            lVar3 = 0;
            goto LAB_001044e9;
         }
 ...
 while ( true );
   while (lVar3 = lVar3 + 1,param_6 != lVar3) {
      LAB_001044e9:if (*(short*)( param_3 + lVar5 * 2 ) == *(short*)( param_5 + lVar3 * 2 )) {
         local_48 = local_48 + 1;
...
void ssl_set_sig_mask(uint *param_1, long param_2, undefined4 param_3) {
   ...
   if (lVar2 == 0) {
      ...
      uVar6 = 0xb;
      lVar7 = 0;
      LAB_001045a8:lVar4 = *(long*)( param_2 + 8 );
      do {
         ...
         do {
            if (*local_48 == *(short*)( lVar5 + 0x10 )) {
               if (( ( ( *(int*)( lVar5 + 0x2c ) != 0 ) && ( lVar4 = ssl_cert_lookup_by_idx((long)*(int*)( lVar5 + 0x20 ), lVar4) ),lVar4 != 0 ) ) && ( ( uVar6 & *(uint*)( lVar4 + 4 ) ) != 0 )) {
 ...
 while ( lVar2 != lVar7 );
   ...
   LAB_00104620:*param_1 = *param_1 | uVar6;
      ...
      LAB_00104780:while (true) {
         ...
         do {
            if (*(short*)( param_3 + lVar6 * 2 ) == *(short*)( lVar4 + 0x10 )) {
               if (( *(int*)( lVar4 + 0x2c ) != 0 ) && ( iVar2 = iVar2 != 0 )) {
...
;
      LAB_0010482d:if (bVar5 != false) {
         return bVar5;
      }

   }

   LAB_0010485a:ERR_new();
...
undefined8 tls1_process_sigalgs(long param_1) {
   ...
   *(undefined8*)( param_1 + 0x1590 ) = 0;
   uVar8 = uVar8 & 0x30000;
   if (( *(int*)( param_1 + 0x78 ) == 0 ) && ( lVar9 = lVar9 != 0 )) {
      if (uVar8 == 0) {
      ...
      LAB_00104b94:uVar4 = *(undefined8*)( param_1 + 0x3f0 );
      ...
      *(long*)( param_1 + 0x1590 ) = lVar6;
      ...
      if (lVar6 != 0) {
         ...
         while (true) {
            ...
            if (( ( ( ( ( *(byte*)( *(long*)( *(int**)( param_1 + 0x18 ) + 0x36 ) + 0x50 ) & 8 ) != 0 ) || ( iVar2 = **(int**)( param_1 + 0x18 ) ),iVar2 < 0x304 ) ) || ( iVar2 == 0x10000 ) ) || ( *(int*)( lVar6 + 0x1c ) != 6 )) &&( ( piVar1 = (int*)( (long)__s + (long)*(int*)( lVar6 + 0x20 ) * 4 ) * piVar1 == 0 && ( iVar2 = ssl_cert_is_disabled(*(undefined8*)( param_1 + 8 )) == 0 ) ) ) * piVar1 = 0x102;
         }
;
         uVar7 = uVar7 + 1;
...
uVar4 = 1;LAB_00104b47:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return uVar4;}undefined8 tls1_set_server_sigalgs(long param_1) {
   int iVar1;
   undefined8 uVar2;
   long lVar3;
   long lVar4;
 ...
 while ( uVar6 < *(ulong*)( param_1 + 0x118 ) );
   ...
   uVar2 = 1;
   LAB_00104db3:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar2;
   }
...
ulong SSL_get_sigalgs(uint *param_1, int param_2, undefined4 *param_3, undefined4 *param_4, undefined4 *param_5, undefined1 *param_6, undefined1 *param_7) {
   short *psVar1;
   ulong uVar2;
   long lVar3;
   undefined4 uVar4;
...
uint SSL_get_shared_sigalgs(uint *param_1, int param_2, undefined4 *param_3, undefined4 *param_4, undefined4 *param_5, undefined1 *param_6, undefined1 *param_7) {
   long lVar1;
   if (param_1 == (uint*)0x0) {
      return 0;
   }
   ...
   if (( ( ( *(long*)( param_1 + 0x562 ) != 0 ) && ( -1 < param_2 ) ) && ( *(ulong*)( param_1 + 0x564 ) < 0x80000000 ) ) && ( param_2 < (int)*(ulong*)( param_1 + 0x564 ) )) {
...
undefined8 tls1_set_sigalgs_list(long param_1, long param_2, char *param_3, undefined4 param_4) {
   ...
   uVar2 = 0;
   LAB_00105287:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar2;
   }
...
undefined8 tls1_set_sigalgs(long param_1, long param_2, ulong param_3, int param_4) {
   ...
   if (( ( param_3 & 1 ) == 0 ) && ( ptr = CRYPTO_malloc((uint)param_3 & 0xfffffffe, "ssl/t1_lib.c", 0xf17) ),ptr != (void*)0x0) {
      if (param_3 != 0) {
         do {
            ppuVar1 = &sigalg_lookup_tbl;
            while (( *(int*)( (long)ppuVar1 + 0x14 ) != *(int*)( param_2 + uVar2 * 4 ) || ( *(int*)( (long)ppuVar1 + 0x1c ) != *(int*)( param_2 + 4 + uVar2 * 4 ) ) )) {
               ppuVar1 = ppuVar1 + 9;
...
long ssl_get_auto_dh(long param_1) {
   ...
   if (iVar3 < 0xc0) {
      ...
      LAB_001054d0:lVar4 = 0;
      ctx = (EVP_PKEY_CTX*)0x0;
      lVar5 = 0;
   }
 else {
      a = (BIGNUM*)BN_get_rfc3526_prime_8192(0);
      LAB_00105508:if (a == (BIGNUM*)0x0) goto LAB_001054d0;
      LAB_0010550d:ctx = (EVP_PKEY_CTX*)EVP_PKEY_CTX_new_from_name(*puVar1, &_LC44, puVar1[0x8e]);
      if (ctx == (EVP_PKEY_CTX*)0x0) goto LAB_001054d0;
      lVar4 = 0;
      iVar2 = EVP_PKEY_fromdata_init(ctx);
      lVar5 = 0;
      if (( ( ( iVar2 == 1 ) && ( lVar4 = OSSL_PARAM_BLD_new() ),lVar4 != 0 ) ) && ( iVar2 = OSSL_PARAM_BLD_push_BN(lVar4, &_LC45, a) ),lVar5 = 0,iVar2 != 0) {
   ...
   BN_free(a);
   lVar5 = local_38;
   LAB_00105564:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 ssl_security_cert(long param_1, undefined8 param_2, undefined8 param_3, int param_4, int param_5) {
   undefined4 uVar1;
   int iVar2;
   long lVar3;
   undefined8 uVar4;
   ...
   LAB_001056d8:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar4;
   }
...
undefined8 SSL_set_tlsext_max_fragment_length(uint *param_1, byte param_2) {
   ...
   puVar1 = param_1;
   if (*param_1 != 0) {
      if (( ( *param_1 & 0x80 ) == 0 ) || ( puVar1 = (uint*)ossl_quic_obj_get0_handshake_layer() ),puVar1 == (uint*)0x0) {
         return 0;
      }
   ...
   LAB_00105954:*(byte*)( puVar1 + 0x2cd ) = param_2;
   return 1;
}
...
undefined8 ssl_hmac_init(long *param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4) {
   ...
   LAB_00105bfd:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar2;
   }
...
uint tls_decrypt_ticket(long param_1, long *param_2, ulong param_3, void *param_4, size_t param_5, undefined8 *param_6) {
   long lVar1;
   undefined8 *puVar2;
   code *pcVar3;
   int iVar4;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (param_3 != 0) {
      if (( ( ( ( ( *(byte*)( *(long*)( *(int**)( param_1 + 0x18 ) + 0x36 ) + 0x50 ) & 8 ) != 0 ) || ( iVar4 = **(int**)( param_1 + 0x18 ) ),iVar4 < 0x304 ) ) || ( iVar4 == 0x10000 ) ) && ( *(long*)( param_1 + 0xae0 ) != 0 )) {
      ...
      if (( lVar6 == 0 ) || ( ctx = EVP_CIPHER_CTX_new() ),ctx == (EVP_CIPHER_CTX*)0x0) {
         ...
         if (local_c0 == (code*)0x0) {
            ...
            if (*param_2 != *(long*)( lVar1 + 0x240 ) || param_2[1] != *(long*)( lVar1 + 0x248 )) goto LAB_00106030;
            local_b4 = 0;
            cipher = (EVP_CIPHER*)EVP_CIPHER_fetch(*puVar2, "AES-256-CBC", puVar2[0x8e]);
            if (( ( cipher != (EVP_CIPHER*)0x0 ) && ( iVar4 = ssl_hmac_init(lVar6, *(undefined8*)( lVar1 + 0x250 ), 0x20, "SHA256") ),0 < iVar4 )) {
               EVP_CIPHER_free(cipher);
               lVar1 = *(long*)( *(int**)( param_1 + 0x18 ) + 0x36 );
               if (( *(byte*)( lVar1 + 0x50 ) & 8 ) == 0) {
                  iVar4 = **(int**)( param_1 + 0x18 );
                  local_b4 = ( uint )(0x303 < iVar4) & (uint)CONCAT71(( int7 )((ulong)lVar1 >> 8), iVar4 != 0x10000);
               }
            ...
            LAB_00105e3b:iVar4 = ( *local_c0 )(*(undefined8*)( param_1 + 0x40 ), param_2, param_2 + 2, ctx, uVar7, 0);
            if (-1 < iVar4) {
               if (iVar4 == 0) {
                  LAB_00106030:local_b4 = 4;
                  ses = (SSL_SESSION*)0x0;
                  goto LAB_00105d53;
               }

               local_b4 = ( uint )(iVar4 == 2);
               LAB_00105e76:len = ssl_hmac_size(lVar6);
               if (( len != 0 ) && ( iVar4 = -1 < iVar4 )) {
                  ...
                  if (0 < iVar5) {
                     ...
                     if (0 < iVar5) {
                        ...
                        if (( out != (uchar*)0x0 ) && ( iVar4 = EVP_DecryptUpdate(ctx, out, &local_98, local_90, (int)param_3) ),0 < iVar4) {
                           ...
                           local_90 = out;
                           ses = (SSL_SESSION*)d2i_SSL_SESSION_ex(0, &local_90, (long)local_98, *puVar2, puVar2[0x8e]);
   ...
   local_b4 = 3;
   ses = (SSL_SESSION*)0x0;
   LAB_00105d53:EVP_CIPHER_CTX_free(ctx);
   ssl_hmac_free(lVar6);
   ...
   if (pcVar3 == (code*)0x0) {
      ...
      iVar4 = ( *pcVar3 )(param_1, ses, param_2, uVar8, local_b4, *(undefined8*)( *(long*)( param_1 + 0xb88 ) + 0x438 ));
      if (iVar4 == 2) {
         if (1 < local_b4 - 3) {
            local_b4 = 4;
         }
         ...
         lVar1 = *(long*)( param_1 + 0xae0 );
         ses = (SSL_SESSION*)0x0;
         joined_r0x00105fc3:if (lVar1 == 0) goto LAB_00105f70;
      }
 else {
         if (iVar4 < 3) {
            ...
            LAB_00105fd0:lVar1 = *(long*)( param_1 + 0xae0 );
            local_b4 = 1;
         }

         joined_r0x00105fde:if (lVar1 == 0) goto LAB_00105db0;
      }

      LAB_00105d88:if (( ( ( *(byte*)( *(long*)( *(int**)( param_1 + 0x18 ) + 0x36 ) + 0x50 ) & 8 ) != 0 ) || ( iVar4 = **(int**)( param_1 + 0x18 ) ),iVar4 == 0x10000 )) goto LAB_00105db0;
      if (local_b4 < 5) {
         if (local_b4 < 3) goto LAB_00105db0;
      }
 else {
         LAB_00105f86:if (local_b4 != 6) {
            local_b4 = 5;
            goto LAB_00105db0;
         }
   ...
   LAB_00105f70:*(undefined4*)( param_1 + 0xa60 ) = 1;
   LAB_00105db0:*param_6 = ses;
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 tls_get_ticket_from_client(long param_1, long param_2, undefined8 *param_3) {
   ...
   *(undefined4*)( param_1 + 0xa60 ) = 0;
   ...
   if (( iVar2 != 0 ) && ( lVar1 = *(long*)( param_2 + 0x288 ) * (int*)( lVar1 + 0x100 ) != 0 )) {
      uVar3 = tls_decrypt_ticket(param_1, *(undefined8*)( lVar1 + 0xf0 ), *(undefined8*)( lVar1 + 0xf8 ), param_2 + 0x30, *(undefined8*)( param_2 + 0x28 ), param_3);
      return uVar3;
   }
...
undefined4 tls12_check_peer_sigalg(long param_1, ushort param_2, undefined8 param_3) {
   ...
   if (( ( ( *(byte*)( *(long*)( *(int**)( param_1 + 0x18 ) + 0x36 ) + 0x50 ) & 8 ) == 0 ) && ( iVar4 = **(int**)( param_1 + 0x18 ) ),0x303 < iVar4 )) {
      if (iVar3 != 0x74) {
         if (iVar3 == 6) {
            iVar3 = 0x390;
         }
      ...
      LAB_001065a0:lVar7 = *(long*)( *(long*)( param_1 + 8 ) + 0x650 );
      lVar10 = *(long*)( *(long*)( param_1 + 8 ) + 0x660 );
      lVar8 = 0;
      if (lVar7 != 0) {
         do {
            if (param_2 == *(ushort*)( lVar10 + 0x10 )) {
               if (( *(int*)( lVar10 + 0x2c ) != 0 ) && ( iVar4 = iVar4 != 0 )) {
                  if (iVar3 == -1) {
                     ...
                     if (( ( ( *(byte*)( *(long*)( *(int**)( param_1 + 0x18 ) + 0x36 ) + 0x50 ) & 8 ) == 0 ) && ( iVar4 = **(int**)( param_1 + 0x18 ) ),iVar4 != 0x10000 )) goto LAB_0010661c;
                     LAB_001066ff:uVar11 = *(undefined8*)( param_1 + 8 );
                     iVar4 = iVar3;
                     if (iVar3 == 0x390) {
                     ...
                     if (( ( ( *(byte*)( *(long*)( *(int**)( param_1 + 0x18 ) + 0x36 ) + 0x50 ) & 8 ) == 0 ) && ( iVar4 = **(int**)( param_1 + 0x18 ) ),0x303 < iVar4 )) {
                        LAB_0010661c:if (( *(int*)( lVar10 + 0x14 ) != 0x40 ) && ( *(int*)( lVar10 + 0x14 ) != 0x2a3 )) goto LAB_00106630;
                        LAB_0010664d:ERR_new();
                        uVar11 = 0xaaf;
                        goto LAB_00106671;
                     }

                     LAB_00106630:if (*(int*)( lVar10 + 0x1c ) == iVar3) goto LAB_001066ff;
                  ...
                  if (iVar3 == 0x198) {
                     ...
                     if (( *(byte*)( *(long*)( *(int**)( param_1 + 0x18 ) + 0x36 ) + 0x50 ) & 8 ) == 0) {
                        iVar3 = **(int**)( param_1 + 0x18 );
                        if (( ( iVar3 == 0x10000 ) || ( iVar3 < 0x304 ) ) && ( ( *(uint*)( *(long*)( param_1 + 0x880 ) + 0x1c ) & 0x30000 ) == 0 )) {
                           LAB_001069a2:if (( iVar3 != 0x10000 ) && ( 0x303 < iVar3 )) goto LAB_00106753;
                           goto LAB_001069b4;
                        }

                        LAB_00106976:iVar3 = ssl_get_EC_curve_nid(param_3);
                        if (( *(int*)( lVar10 + 0x28 ) == iVar3 ) || ( *(int*)( lVar10 + 0x28 ) == 0 )) {
                           if (( *(byte*)( *(long*)( *(int**)( param_1 + 0x18 ) + 0x36 ) + 0x50 ) & 8 ) != 0) goto LAB_001069b4;
                           iVar3 = **(int**)( param_1 + 0x18 );
                           goto LAB_001069a2;
                        }
                        ...
                        if (( *(uint*)( *(long*)( param_1 + 0x880 ) + 0x1c ) & 0x30000 ) != 0) goto LAB_00106976;
                        LAB_001069b4:uVar6 = ssl_get_EC_curve_nid(param_3);
                        if (uVar6 != 0) {
                        ...
                        if (iVar3 != 0) {
                           if (( ( *(uint*)( *(long*)( param_1 + 0x880 ) + 0x1c ) & 0x30000 ) == 0 ) || ( ( param_2 & 0xfeff ) == 0x403 )) goto LAB_00106753;
                           ERR_new();
                           uVar11 = 0xad7;
                           goto LAB_001068b6;
                        }
                  ...
                  LAB_00106753:lVar7 = tls12_get_psigalgs(param_1, 1, &local_60);
                  puVar9 = local_60;
 ...
 while ( lVar8 != lVar7 );
   ...
   LAB_00106671:ERR_set_debug("ssl/t1_lib.c", uVar11, "tls12_check_peer_sigalg");
   ossl_statem_fatal(param_1, 0x2f, 0x172, 0);
   goto LAB_00106693;
   while (true) {
      lVar8 = lVar8 + 1;
      ...
      LAB_00106796:if (*puVar9 == param_2) {
         if (bVar1) {
            local_60 = puVar9;
         }
...
;
   LAB_0010688b:local_60 = puVar9;
   if (( *(int*)( lVar10 + 0x14 ) == 0x40 ) && ( ( *(uint*)( *(long*)( param_1 + 0x880 ) + 0x1c ) & 0x30001 ) == 0 )) {
      LAB_001067ae:iVar3 = tls1_lookup_md(*(undefined8*)( param_1 + 8 ), lVar10, &local_58);
      if (iVar3 == 0) {
         ERR_new();
   ...
   LAB_001068b6:ERR_set_debug("ssl/t1_lib.c", uVar11, "tls12_check_peer_sigalg");
   ossl_statem_fatal(param_1, 0x28, 0x172, 0);
   LAB_00106693:uVar5 = 0;
   LAB_00106696:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
long find_sig_alg(long param_1, undefined8 param_2, long param_3) {
   ...
   if (uVar6 != 0) {
      if (param_3 == 0) {
         ...
         do {
            ...
            if (( ( ( *(int*)( lVar8 + 0x14 ) != 0x40 ) && ( *(int*)( lVar8 + 0x14 ) != 0x2a3 ) ) && ( *(int*)( lVar8 + 0x1c ) != 0x74 ) ) && ( *(int*)( lVar8 + 0x1c ) != 6 )) {
               iVar3 = tls_sigalg_compat(param_1, lVar8);
               if (( ( iVar3 != 0 ) && ( iVar3 = tls1_lookup_md(uVar1, lVar8, 0) ),iVar3 != 0 )) {
                  lVar5 = *(long*)( *(long*)( *(long*)( param_1 + 0x880 ) + 0x20 ) + (long)*(int*)( lVar8 + 0x20 ) * 0x28 + 8 );
                  if (*(int*)( lVar8 + 0x1c ) == 0x198) {
                     ...
                     uVar6 = *(ulong*)( param_1 + 0x1590 );
                     if (( *(int*)( lVar8 + 0x28 ) != iVar2 ) && ( *(int*)( lVar8 + 0x28 ) != 0 )) goto LAB_00106d90;
                     break;
                  }

                  if (*(int*)( lVar8 + 0x1c ) != 0x390) goto LAB_00106cc2;
                  if (( ( ( lVar5 != 0 ) && ( iVar3 = tls1_lookup_md(uVar1, lVar8, &local_48) ),iVar3 != 0 ) ) && ( CONCAT44(uStack_44, local_48) != 0 )) {
 ...
 while ( uVar7 < uVar6 );
         ...
         do {
            lVar8 = *(long*)( *(long*)( param_1 + 0x1588 ) + uVar7 * 8 );
            if (( ( *(int*)( lVar8 + 0x14 ) != 0x2a3 ) && ( *(int*)( lVar8 + 0x14 ) != 0x40 ) ) && ( ( *(int*)( lVar8 + 0x1c ) != 0x74 && ( *(int*)( lVar8 + 0x1c ) != 6 ) ) )) {
               iVar2 = tls_sigalg_compat(param_1, lVar8);
               if (( ( ( iVar2 != 0 ) && ( iVar2 = tls1_lookup_md(uVar1, lVar8, 0) ),iVar2 != 0 ) ) && ( lVar5 = ssl_cert_lookup_by_pkey(param_3, &local_48, *(undefined8*)( param_1 + 8 )) ),lVar5 != 0) {
                  if (*(int*)( lVar8 + 0x1c ) == 0x198) {
                     if (local_50 == -1) {
                     ...
                     uVar6 = *(ulong*)( param_1 + 0x1590 );
                     if (( local_50 != *(int*)( lVar8 + 0x28 ) ) && ( *(int*)( lVar8 + 0x28 ) != 0 )) goto LAB_00106c00;
                     break;
                  }

                  if (*(int*)( lVar8 + 0x1c ) != 0x390) goto LAB_00106cc2;
                  iVar2 = tls1_lookup_md(uVar1, lVar8, &local_48);
                  if (( ( iVar2 != 0 ) && ( CONCAT44(uStack_44, local_48) != 0 ) ) && ( iVar2= EVP_MD_get_size(),0 < iVar2 )) {
 ...
 while ( uVar7 < uVar6 );
   ...
   goto LAB_00106e4a;
   LAB_00106cc2:uVar6 = *(ulong*)( param_1 + 0x1590 );
   LAB_00106c0d:if (uVar7 != uVar6) goto LAB_00106c16;
   LAB_00106e4a:lVar8 = 0;
   LAB_00106c16:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 tls_choose_sigalg(long param_1, int param_2) {
   ...
   *(undefined1(*) [16])( param_1 + 0x3d0 ) = (undefined1[16])0x0;
   ...
   if (( ( ( uVar2 & 8 ) == 0 ) && ( iVar6 = **(int**)( param_1 + 0x18 ) ),iVar6 != 0x10000 )) {
      ...
      if (lVar11 == 0) {
         ...
         ERR_new();
         uVar14 = 0x1221;
         LAB_001073ae:ERR_set_debug("ssl/t1_lib.c", uVar14, "tls_choose_sigalg");
         ossl_statem_fatal(param_1, 0x28, 0x76, 0);
         uVar14 = 0;
         goto LAB_0010712d;
      }

      LAB_00107355:uVar12 = ( ulong ) * (int*)( lVar11 + 0x20 );
      LAB_0010719e:lVar10 = ( *(long**)( param_1 + 0x880 ) )[4] + uVar12 * 0x28;
      ...
      *(long*)( param_1 + 0x3d0 ) = lVar11;
      ...
      if (*(int*)( param_1 + 0x78 ) == 0) {
         ...
         if (( -1 < iVar6 ) && ( iVar6 < *(int*)( param_1 + 0x118 ) )) {
            ...
            if (( ( ( *(void**)( param_1 + 0x1598 ) != (void*)0x0 ) && ( pvVar8 = memchr(*(void**)( param_1 + 0x1598 ), 2, *(size_t*)( param_1 + 0x15a0 )) ),pvVar8 != (void*)0x0 ) ) || ( *plVar1 != 0 )) goto LAB_00106ef8;
         }

      }
 else {
         LAB_00106ef8:if (( uVar2 & 2 ) == 0) {
            ...
            if (lVar11 == 0) {
               ...
               if (lVar10 != 0) {
                  lVar13 = 0;
                  do {
                     if (( *(short*)( lVar11 + 0x10 ) == *local_48 ) && ( iVar6 = has_usable_cert(param_1, lVar11, *(undefined4*)( lVar11 + 0x20 )) ),iVar6 != 0) {
 ...
 while ( lVar10 != lVar13 );
            ...
            iVar6 = -1;
            if (( *(uint*)( *(long*)( param_1 + 0x880 ) + 0x1c ) & 0x30000 ) != 0) {
               iVar6 = ssl_get_EC_curve_nid(*(undefined8*)( *(long*)( *(long*)( param_1 + 0x880 ) + 0x20 ) + 0x80 ));
            }
            ...
            if (uVar7 != 0) {
               do {
                  while (lVar11 = *(long*)( *(long*)( param_1 + 0x1588 ) + uVar15 * 8 ),*(int*)( lVar11 + 0x2c ) != 0) {
                     ...
                     if (( ( ( iVar3 == 0 ) || ( ( iVar4 == 0 || ( iVar4 = ssl_version_cmp(param_1) ),iVar4 < 1 ) ) ) ) && ( ( iVar16 == 0 || ( ( iVar5 == 0 || ( iVar5 = ssl_version_cmp(param_1, iVar16, iVar5) ),-1 < iVar5 ) ) ) )) {
                        if (*(int*)( param_1 + 0x78 ) != 0) {
                           iVar5 = *(int*)( lVar11 + 0x20 );
                           uVar12 = (ulong)iVar5;
                           piVar9 = (int*)ssl_cert_lookup_by_idx(uVar12, *(undefined8*)( param_1 + 8 ));
                           if (( ( piVar9 != (int*)0x0 ) && ( ( piVar9[1] & *(uint*)( *(long*)( param_1 + 0x300 ) + 0x20 ) ) != 0 ) ) && ( ( *piVar9 != 0x390 || ( ( *(byte*)( *(long*)( param_1 + 0x300 ) + 0x1c ) & 1 ) == 0 ) ) )) {
                              if (*(int*)( param_1 + 0x78 ) == 0) {
                                 if (*(char*)( param_1 + 0xb50 ) == '\x02') goto LAB_0010727a;
                                 LAB_00107216:lVar10 = *(long*)( param_1 + 0x408 );
                                 LAB_0010721d:if (( *(byte*)( lVar10 + uVar12 * 4 ) & 1 ) == 0) goto LAB_0010722d;
                              }
 else {
                                 if (*(char*)( param_1 + 0xb52 ) != '\x02') goto LAB_00107216;
                                 LAB_0010727a:plVar1 = (long*)( *(long*)( *(long*)( param_1 + 0x880 ) + 0x20 ) + uVar12 * 0x28 );
                           ...
                           LAB_0010722d:uVar7 = *(ulong*)( param_1 + 0x1590 );
                           uVar12 = 0xffffffffffffffff;
                           break;
                        }

                        uVar12 = ( ulong ) * (int*)( lVar11 + 0x20 );
                        if (*(int*)( lVar11 + 0x20 ) != (int)( **(long**)( param_1 + 0x880 ) - ( *(long**)( param_1 + 0x880 ) )[4] >> 3 ) * -0x33333333) goto LAB_00107178;
                        LAB_00107016:iVar5 = has_usable_cert(param_1, lVar11, uVar12 & 0xffffffff);
                        if (iVar5 != 0) {
                           if (*(int*)( lVar11 + 0x1c ) != 0x390) {
                              LAB_00107038:uVar7 = *(ulong*)( param_1 + 0x1590 );
                              if (( iVar6 != -1 ) && ( *(int*)( lVar11 + 0x28 ) != iVar6 )) break;
                              goto LAB_0010718c;
                           }

                           lVar10 = *(long*)( *(long*)( *(long*)( param_1 + 0x880 ) + 0x20 ) + (long)(int)uVar12 * 0x28 + 8 );
                           if (( ( ( lVar10 != 0 ) && ( iVar5 = tls1_lookup_md(uVar14, lVar11, &local_48) ),iVar5 != 0 ) ) && ( local_48 != (short*)0x0 )) {
                     ...
                     LAB_00107178:uVar7 = *(ulong*)( param_1 + 0x1590 );
                     uVar15 = uVar15 + 1;
...
;
 ...
 while ( uVar15 < uVar7 );
               LAB_0010718c:if (uVar15 == uVar7) goto LAB_00107380;
               LAB_00107195:if ((int)uVar12 == -1) goto LAB_00107355;
               goto LAB_0010719e;
            }

            LAB_00107380:if (( *(byte*)( *(long*)( param_1 + 0x300 ) + 0x20 ) & 0xa0 ) != 0) {
               lVar11 = tls1_get_legacy_sigalg(param_1, 0xffffffff);
               if (lVar11 == 0) {
                  if (param_2 != 0) {
                     ERR_new();
   ...
   LAB_00107128:uVar14 = 1;
   LAB_0010712d:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
uint tls1_check_chain(SSL *param_1, X509 *param_2, long param_3, long param_4, uint param_5) {
   ...
   if (param_5 == 0xffffffff) {
      if (( ( param_2 == (X509*)0x0 ) || ( param_3 == 0 ) ) || ( lVar13 = ssl_cert_lookup_by_pkey(param_3, &local_48, param_1->method) ),lVar13 == 0) goto LAB_00107814;
      ...
      if (( uVar7 & 0x30000 ) == 0) {
         ...
         LAB_001076a0:iVar6 = SSL_version(param_1);
         if (( ( iVar6 >> 8 == 3 ) && ( iVar6 = SSL_version(param_1) ),uVar3 != 0 )) {
            LAB_00107bf4:local_60 = 0;
            uVar8 = uVar7;
            if (( param_1[1].generate_session_id == (GEN_SESSION_CB)0x0 ) && ( param_1[1].session == (SSL_SESSION*)0x0 )) {
               switch (uVar24) {
                  case 0:
            local_60 = 0x41;
            iVar6 = 6;
                     ...
                     do {
                        ...
                        do {
                           if (*(short*)( p_Var19 + 0x10 ) == *(short*)( puVar1[8] + lVar12 * 2 )) {
                              if (( ( *(int*)( p_Var19 + 0x2c ) != 0 ) && ( *(int*)( p_Var19 + 0x14 ) == 0x40 ) ) && ( *(int*)( p_Var19 + 0x1c ) == iVar6 )) {
 ...
 while ( lVar13 != lVar12 );
               ...
               LAB_00107fa1:if (uVar5 != 0) {
                  LAB_00107e31:lVar13 = X509_get0_pubkey(param_2);
                  if (lVar13 == 0) {
               ...
               LAB_00107faa:uVar5 = 0;
               goto LAB_0010793a;
            }

            LAB_00107c0a:if (( ( ( *(byte*)( *(long*)&param_1->wbio[1].ex_data.dummy + 0x50 ) & 8 ) == 0 ) && ( iVar6 = *(int*)&param_1->wbio->method ),iVar6 != 0x10000 )) {
            ...
            LAB_00107703:if (uVar5 == 0) goto LAB_0010793a;
            LAB_0010770c:iVar6 = *(int*)&param_1->s2;
            uVar8 = uVar7;
         }
 else {
            if (uVar5 != 0) {
               uVar7 = uVar7 | 0x30;
               LAB_00107bb4:lVar13 = X509_get0_pubkey(param_2);
               uVar8 = uVar7;
               if (lVar13 != 0) goto LAB_001076d6;
               goto LAB_0010770c;
            }
            ...
            if (iVar6 != 0) {
               ...
               if (iVar6 != 0) {
                  ...
                  if (iVar6 != 0) {
                     if (( *(uint*)( *(long*)&param_1[3].packet_length + 0x1c ) & 0x30000 ) == 0) goto LAB_00107a40;
                     if (uVar4 == 0x17) {
                        iVar6 = 0x31a;
                     }
 else {
                     ...
                     if (param_1[8].rbio != (BIO*)0x0) {
                        pBVar14 = (BIO*)0x0;
                        do {
                           if (*(int*)( *(long*)( &(param_1[8].method)->version + (long)pBVar14 * 2 ) + 0x24 ) == iVar6) goto LAB_00107a40;
 ...
 while ( param_1[8].rbio != pBVar14 );
            ...
            LAB_00107a40:iVar6 = *(int*)&param_1->s2;
            uVar8 = uVar7 | 0x40;
         }

         if (iVar6 == 0) {
            LAB_00107719:iVar6 = 0;
            goto LAB_0010771e;
         }

         if (uVar3 != 0) goto LAB_00107a61;
         LAB_0010772e:uVar8 = uVar8 | 0x600;
         LAB_00107734:if (uVar5 != 0) goto LAB_00107739;
      }
 else {
         ...
         uVar3 = 1;
         uVar8 = 0x30;
         joined_r0x00107d5b:if (iVar6 == 0) goto LAB_00107719;
         LAB_00107a61:uVar7 = uVar8 | 0x80;
         for (iVar6 = 0; iVar10 = OPENSSL_sk_num(param_4),iVar6 < iVar10; iVar6 = iVar6 + 1) {
            uVar15 = OPENSSL_sk_value(param_4, iVar6);
            lVar13 = X509_get0_pubkey(uVar15);
            if (lVar13 == 0) {
               LAB_00107b06:if (uVar5 == 0) goto LAB_0010793a;
            ...
            LAB_00107ad2:}iVar6 = *(int*)&param_1->s2;
            LAB_0010771e:uVar8 = uVar8 | 0x80;
            if (( uVar3 == 0 ) || ( iVar6 != 0 )) goto LAB_0010772e;
            LAB_00107b24:iVar6 = EVP_PKEY_is_a(param_3, &_LC31);
            cVar23 = '\x01';
            if (iVar6 == 0) {
               ...
               LAB_00107b7c:lVar13 = *(long*)&param_1[1].hit;
               uVar8 = uVar8 | 0x400;
               if (lVar13 != 0) goto LAB_00107b8b;
               LAB_00107ba1:uVar8 = uVar8 | 0x200;
               goto LAB_00107734;
            }

            LAB_00107b46:p_Var16 = param_1[1].msg_callback;
 ...
 while ( p_Var16 != p_Var22 );
            ...
            if (lVar13 == 0) {
               ...
               LAB_00107b8b:iVar6 = OPENSSL_sk_num(lVar13);
            ...
            LAB_00107739:uVar7 = uVar8;
            if (( ~uVar8 & uVar5 ) != 0) goto LAB_0010793a;
         }

         uVar7 = uVar8 | 1;
         iVar6 = SSL_version(param_1);
         joined_r0x00107759:if (( iVar6 >> 8 == 3 ) && ( iVar6 = 0x302 < iVar6 )) {
      ...
      if (( ( cVar23 != '\x02' ) || ( plVar20 = (long*)( lVar13 + lVar12 * 0x28 ) ),plVar20[1] == 0 )) {
         ...
         LAB_00107930:uVar7 = 0;
         uVar5 = 0;
         LAB_0010793a:iVar6 = SSL_version(param_1);
   ...
   LAB_00107814:uVar7 = 0;
   LAB_00107816:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
void tls1_set_cert_validity(undefined8 param_1) {
   for (int i = 0; i < 9; i++) {
      tls1_check_chain(param_1, 0, 0, 0, i);
   }
...
undefined8 tls13_set_encoded_pub_key(undefined8 param_1, char *param_2, ulong param_3) {
   ...
   if (iVar1 == 0) {
      ...
      if (( 0 < iVar1 ) && ( (ulong)(long)iVar1 >> 3 == param_3 )) {
         LAB_00108290:uVar2 = EVP_PKEY_set1_encoded_public_key(param_1, param_2, param_3);
         return uVar2;
      }

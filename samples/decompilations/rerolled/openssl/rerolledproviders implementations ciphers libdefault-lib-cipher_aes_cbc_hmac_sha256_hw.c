...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 aesni_cbc_hmac_sha256_tls1_multiblock_aad(long param_1, long param_2) {
   long lVar1;
   ushort uVar2;
   uint uVar3;
   undefined8 uVar4;
   ...
   uVar3 = (uint)uVar2;
   uVar4 = 0xffffffff;
   if (( ( *(byte*)( param_1 + 0x6c ) & 2 ) != 0 ) && ( 0x301 < ( ushort )(*(ushort*)( lVar1 + 9 ) << 8 | *(ushort*)( lVar1 + 9 ) >> 8) )) {
      if (uVar2 == 0) {
      ...
      for (int i = 0; i < 14; i++) {
         *(undefined8*)( param_1 + ( 8*i + 728 ) ) = *(undefined8*)( param_1 + ( 8*i + 504 ) );
      }
      ...
      *(uint*)( param_1 + 0x1dc ) = ( ( uVar3 + 0x30 & 0xfffffff0 ) + 0x15 + ( iVar6 << ( bVar7 & 0x1f ) ) ) - iVar6;
      uVar4 = 1;
   }

   return uVar4;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int aesni_cbc_hmac_sha256_cipher(long param_1, void *param_2, void *param_3, ulong param_4, undefined8 param_5) {
   SHA256_CTX *c;
   uchar *md;
   long lVar1;
   byte *pbVar2;
   ...
   *(undefined8*)( param_1 + 0x1b8 ) = 0xffffffffffffffff;
   ...
   if (( *(byte*)( param_1 + 0x6c ) & 2 ) == 0) {
      ...
      if (uVar22 != 0xffffffffffffffff) {
         iVar36 = 0;
         uVar18 = ( ulong )(0x301 < CONCAT11(*(undefined1*)( param_1 + 0x1bc + uVar22 ), *(undefined1*)( param_1 + 0x1bd + uVar22 )));
         lVar16 = uVar18 * 0x10;
         ...
         *(undefined8*)( param_1 + 0x300 ) = uVar10;
         for (int i = 0; i < 8; i++) {
            *(undefined8*)( param_1 + ( 8*i + 776 ) ) = *(undefined8*)( param_1 + ( 8*i + 552 ) );
         }
         ...
         uVar28 = uVar28 >> 0x18 | ( uVar28 & 0xff0000 ) >> 8 | ( uVar28 & 0xff00 ) << 8 | uVar28 * 0x1000000;
         if (uVar18 == 0) {
            uVar22 = 0;
         }
 else {
            ...
            do {
               while (true) {
                  ...
                  *(byte*)( param_1 + 0x300 + (ulong)uVar19 ) = ~((byte)((ulong)-lVar21 >> 0x38) | bVar4) & 0x80 | *(byte*)( (long)local_d0 + lVar21 + local_e0 ) & bVar4;
                  uVar22 = uVar18;
...
;
 ...
 while ( lVar21 != uVar18 - local_e0 );
         ...
         uVar31 = (ulong)uVar14;
         if (uVar14 < 0x40) {
            LAB_001008c2:puVar3 = (undefined8*)( param_1 + 0x300 + uVar31 );
            uVar17 = 0x40 - uVar31;
            uVar19 = (uint)uVar17;
            if (uVar19 < 8) {
               if (( uVar17 & 4 ) == 0) {
               ...
               *(undefined8*)( (long)puVar3 + ( ( uVar17 & 0xffffffff ) - 8 ) ) = 0;
               uVar19 = uVar19 + ( (int)puVar3 - (int)( ( ulong )(puVar3 + 1) & 0xfffffffffffffff8 ) ) & 0xfffffff8;
               if (7 < uVar19) {
                  uVar20 = 0;
                  do {
                     uVar17 = (ulong)uVar20;
 ...
 while ( uVar20 < uVar19 );
            ...
            LAB_00100c6b:uVar14 = ( uint )(( local_e0 + 8 ) - uVar22 >> 0x20);
            *(uint*)( param_1 + 0x33c ) = *(uint*)( param_1 + 0x33c ) | uVar28 & (int)uVar14 >> 0x1f;
            sha256_block_data_order(c, lVar16, 1);
            lVar21 = -0x49 - local_e0;
            lVar1 = uVar22 + lVar21;
            ...
            for (int i = 0; i < 4; i++) {
               *(undefined1(*) [16])( param_1 + ( 16*i + 768 ) ) = (undefined1[16])0;
            }
         ...
         *(uint*)( param_1 + 0x33c ) = uVar28;
         ...
         auVar11._0_4_ = uVar30 >> 0x18 | ( uVar30 & 0xff0000 ) >> 8 | ( uVar30 & 0xff00 ) << 8 | uVar30 << 0x18;
         local_80._0_8_ = auVar11._0_8_ << 0x20;
         local_80._8_4_ = uVar29 >> 0x18 | ( uVar29 & 0xff0000 ) >> 8 | ( uVar29 & 0xff00 ) << 8 | uVar29 << 0x18;
         ...
         auVar12._0_4_ = uVar28 >> 0x18 | ( uVar28 & 0xff0000 ) >> 8 | ( uVar28 & 0xff00 ) << 8 | uVar28 << 0x18;
         local_70._0_12_ = auVar12 << 0x20;
         local_70._12_4_ = uVar14;
         local_80._0_4_ = uVar20 >> 0x18 | ( uVar20 & 0xff0000 ) >> 8 | ( uVar20 & 0xff00 ) << 8 | uVar20 << 0x18;
         local_80._12_4_ = uVar26 >> 0x18 | ( uVar26 & 0xff0000 ) >> 8 | ( uVar26 & 0xff00 ) << 8 | uVar26 << 0x18;
         local_70._0_4_ = uVar23 >> 0x18 | ( uVar23 & 0xff0000 ) >> 8 | ( uVar23 & 0xff00 ) << 8 | uVar23 << 0x18;
         local_70._8_4_ = uVar19 >> 0x18 | ( uVar19 & 0xff0000 ) >> 8 | ( uVar19 & 0xff00 ) << 8 | uVar19 << 0x18;
 ...
 while ( pbVar27 != (byte*)( (long)local_d0 + uVar18 + 0x1f ) );
      ...
      if (( DAT_0010301b & 0x20 ) == 0) {
         ...
         LAB_00100367:uVar18 = lVar16 + ( ulong )(0x40 - *(uint*)( param_1 + 0x340 ));
         if (uVar18 < uVar22) {
            ...
            if (uVar31 < 0x40) {
               ...
               aesni_cbc_sha256_enc(param_3, param_2, uVar31 >> 6, param_1 + 0xc0, param_1 + 0x20, param_1 + 0x2d8, (long)param_3 + uVar18);
            ...
            LAB_00100748:uVar18 = param_1 + 0xc0;
         }
      ...
      if (uVar22 == param_4) {
         ...
         for (int i = 0; i < 14; i++) {
            *(undefined8*)( param_1 + ( 8*i + 728 ) ) = *(undefined8*)( param_1 + ( 8*i + 616 ) );
         }
         ...
         uVar18 = uVar22 + 0x20;
         if (uVar18 < param_4) {
            memset((void*)( uVar18 + (long)param_2 ), ( (uint)param_4 - 1 ) - (int)uVar18 & 0xff, ( param_4 - 0x20 ) - uVar22);
         }
   ...
   iVar36 = 1;
   LAB_001004d6:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */long tls1_multi_block_encrypt(long param_1, undefined1 *param_2, ulong *param_3, uint param_4, int param_5) {
   byte bVar1;
   byte bVar2;
   uint uVar3;
   uint uVar4;
   ...
   *(undefined8*)( param_2 + 0xd ) = uStack_688;
   ...
   if ((int)uVar34 < 2) {
      ...
      LAB_001022ff:sha256_multi_block(&local_160, &local_728, 0);
      puVar27 = &local_568;
      for (lVar16 = 0x80; lVar16 != 0; lVar16 = lVar16 + -1) {
         *puVar27 = 0;
         puVar27 = puVar27 + (ulong)bVar35 * -2 + 1;
 ...
 while ( puVar23 != &local_568 + (ulong)uVar34 * 2 );
      ...
      do {
         ...
         *(char*)( (long)puVar27 + 0xc ) = (char)uVar13;
         ...
         puVar17[0x28] = uVar28;
         puVar17[0x30] = uVar5;
         uVar24 = ( uVar29 | uVar30 >> 0x28 | uVar21 >> 0x18 | uVar8 >> 8 | uVar9 << 8 | uVar10 << 0x18 | uVar11 << 0x28 | uVar12 ) + lVar16;
         *puVar27 = uVar24 >> 0x38 | ( uVar24 & 0xff000000000000 ) >> 0x28 | ( uVar24 & 0xff0000000000 ) >> 0x18 | ( uVar24 & 0xff00000000 ) >> 8 | ( uVar24 & 0xff000000 ) << 8 | ( uVar24 & 0xff0000 ) << 0x18 | ( uVar24 & 0xff00 ) << 0x28 | uVar24 << 0x38;
         *(uint*)( puVar27 + 1 ) = ( ( uVar13 & 0xff00 | (uint)bVar19 ) << 8 | (uint)bVar1 ) << 8 | (uint)bVar2;
         puVar23 = *ppuVar22;
         uVar24 = puVar23[1];
 ...
 while ( (uint)lVar26 < uVar34 );
      ...
      if (uVar20 < 0x840) {
         ...
         LAB_00101372:local_7c8 = local_6a8;
         local_800 = &local_7a8;
         uVar32 = uVar20 >> 6;
         do {
            sha256_multi_block(&local_160, &local_728, param_5);
 ...
 while ( 0x20 < uVar32 );
      ...
      while (true) {
         ...
         lVar26 = __memcpy_chk(puVar27, ( ulong )(uint)(*(int*)( (long)local_7a0 + lVar16 ) * 0x40) + *(long*)( (long)local_7a0 + lVar16 + -8 ), (ulong)uVar31, lVar16 * -8 + 0x400);
...
;
      ...
      local_568 = CONCAT44(local_140 >> 0x18 | ( local_140 & 0xff0000 ) >> 8 | ( local_140 & 0xff00 ) << 8 | local_140 << 0x18, local_160 >> 0x18 | ( local_160 & 0xff0000 ) >> 8 | ( local_160 & 0xff00 ) << 8 | local_160 << 0x18);
      uStack_560 = local_120 >> 0x18 | ( local_120 & 0xff0000 ) >> 8 | ( local_120 & 0xff00 ) << 8 | local_120 << 0x18;
      uStack_55c = local_100 >> 0x18 | ( local_100 & 0xff0000 ) >> 8 | ( local_100 & 0xff00 ) << 8 | local_100 << 0x18;
      local_558._0_4_ = local_e0 >> 0x18 | ( local_e0 & 0xff0000 ) >> 8 | ( local_e0 & 0xff00 ) << 8 | local_e0 << 0x18;
      local_558._4_4_ = local_c0 >> 0x18 | ( local_c0 & 0xff0000 ) >> 8 | ( local_c0 & 0xff00 ) << 8 | local_c0 << 0x18;
      uStack_550 = local_a0 >> 0x18 | ( local_a0 & 0xff0000 ) >> 8 | ( local_a0 & 0xff00 ) << 8 | local_a0 << 0x18;
      uStack_54c = local_80 >> 0x18 | ( local_80 & 0xff0000 ) >> 8 | ( local_80 & 0xff00 ) << 8 | local_80 << 0x18;
      local_4e8 = local_15c >> 0x18 | ( local_15c & 0xff0000 ) >> 8 | ( local_15c & 0xff00 ) << 8 | local_15c << 0x18;
      local_4e4 = local_13c >> 0x18 | ( local_13c & 0xff0000 ) >> 8 | ( local_13c & 0xff00 ) << 8 | local_13c << 0x18;
      local_4e0 = local_11c >> 0x18 | ( local_11c & 0xff0000 ) >> 8 | ( local_11c & 0xff00 ) << 8 | local_11c << 0x18;
      local_4dc = local_fc >> 0x18 | ( local_fc & 0xff0000 ) >> 8 | ( local_fc & 0xff00 ) << 8 | local_fc << 0x18;
      local_4d8 = local_dc >> 0x18 | ( local_dc & 0xff0000 ) >> 8 | ( local_dc & 0xff00 ) << 8 | local_dc << 0x18;
      local_4d4 = local_bc >> 0x18 | ( local_bc & 0xff0000 ) >> 8 | ( local_bc & 0xff00 ) << 8 | local_bc << 0x18;
      local_4d0 = local_9c >> 0x18 | ( local_9c & 0xff0000 ) >> 8 | ( local_9c & 0xff00 ) << 8 | local_9c << 0x18;
      local_4cc = local_7c >> 0x18 | ( local_7c & 0xff0000 ) >> 8 | ( local_7c & 0xff00 ) << 8 | local_7c << 0x18;
      local_548 = 0x80;
      uStack_52c = 0x30000;
      local_4c8 = 0x80;
      local_4ac = 0x30000;
      if (2 < (int)uVar34) {
         local_448 = 0x80;
         local_468 = local_158 >> 0x18 | ( local_158 & 0xff0000 ) >> 8 | ( local_158 & 0xff00 ) << 8 | local_158 << 0x18;
         local_42c = 0x30000;
         local_464 = local_138 >> 0x18 | ( local_138 & 0xff0000 ) >> 8 | ( local_138 & 0xff00 ) << 8 | local_138 << 0x18;
         local_460 = local_118 >> 0x18 | ( local_118 & 0xff0000 ) >> 8 | ( local_118 & 0xff00 ) << 8 | local_118 << 0x18;
         local_45c = local_f8 >> 0x18 | ( local_f8 & 0xff0000 ) >> 8 | ( local_f8 & 0xff00 ) << 8 | local_f8 << 0x18;
         local_458 = local_d8 >> 0x18 | ( local_d8 & 0xff0000 ) >> 8 | ( local_d8 & 0xff00 ) << 8 | local_d8 << 0x18;
         local_454 = local_b8 >> 0x18 | ( local_b8 & 0xff0000 ) >> 8 | ( local_b8 & 0xff00 ) << 8 | local_b8 << 0x18;
         local_450 = local_98 >> 0x18 | ( local_98 & 0xff0000 ) >> 8 | ( local_98 & 0xff00 ) << 8 | local_98 << 0x18;
         local_44c = local_78 >> 0x18 | ( local_78 & 0xff0000 ) >> 8 | ( local_78 & 0xff00 ) << 8 | local_78 << 0x18;
         local_3e8 = local_154 >> 0x18 | ( local_154 & 0xff0000 ) >> 8 | ( local_154 & 0xff00 ) << 8 | local_154 << 0x18;
         local_3e4 = local_134 >> 0x18 | ( local_134 & 0xff0000 ) >> 8 | ( local_134 & 0xff00 ) << 8 | local_134 << 0x18;
         local_3e0 = local_114 >> 0x18 | ( local_114 & 0xff0000 ) >> 8 | ( local_114 & 0xff00 ) << 8 | local_114 << 0x18;
         local_3dc = local_f4 >> 0x18 | ( local_f4 & 0xff0000 ) >> 8 | ( local_f4 & 0xff00 ) << 8 | local_f4 << 0x18;
         local_3d8 = local_d4 >> 0x18 | ( local_d4 & 0xff0000 ) >> 8 | ( local_d4 & 0xff00 ) << 8 | local_d4 << 0x18;
         local_3d4 = local_b4 >> 0x18 | ( local_b4 & 0xff0000 ) >> 8 | ( local_b4 & 0xff00 ) << 8 | local_b4 << 0x18;
         local_3d0 = local_94 >> 0x18 | ( local_94 & 0xff0000 ) >> 8 | ( local_94 & 0xff00 ) << 8 | local_94 << 0x18;
         local_3cc = local_74 >> 0x18 | ( local_74 & 0xff0000 ) >> 8 | ( local_74 & 0xff00 ) << 8 | local_74 << 0x18;
         local_3c8 = 0x80;
         local_3ac = 0x30000;
         local_158 = uVar20;
         local_154 = uVar20;
         ...
         if (uVar34 == 4) {
            ...
            local_348 = 0x80;
            local_368 = local_150 >> 0x18 | ( local_150 & 0xff0000 ) >> 8 | ( local_150 & 0xff00 ) << 8 | local_150 << 0x18;
            local_32c = 0x30000;
            local_364 = local_130 >> 0x18 | ( local_130 & 0xff0000 ) >> 8 | ( local_130 & 0xff00 ) << 8 | local_130 << 0x18;
            local_360 = local_110 >> 0x18 | ( local_110 & 0xff0000 ) >> 8 | ( local_110 & 0xff00 ) << 8 | local_110 << 0x18;
            local_35c = local_f0 >> 0x18 | ( local_f0 & 0xff0000 ) >> 8 | ( local_f0 & 0xff00 ) << 8 | local_f0 << 0x18;
            local_358 = local_d0 >> 0x18 | ( local_d0 & 0xff0000 ) >> 8 | ( local_d0 & 0xff00 ) << 8 | local_d0 << 0x18;
            local_354 = local_b0 >> 0x18 | ( local_b0 & 0xff0000 ) >> 8 | ( local_b0 & 0xff00 ) << 8 | local_b0 << 0x18;
            local_350 = local_90 >> 0x18 | ( local_90 & 0xff0000 ) >> 8 | ( local_90 & 0xff00 ) << 8 | local_90 << 0x18;
            local_34c = local_70 >> 0x18 | ( local_70 & 0xff0000 ) >> 8 | ( local_70 & 0xff00 ) << 8 | local_70 << 0x18;
            local_2e8 = local_14c >> 0x18 | ( local_14c & 0xff0000 ) >> 8 | ( local_14c & 0xff00 ) << 8 | local_14c << 0x18;
            local_2e4 = local_12c >> 0x18 | ( local_12c & 0xff0000 ) >> 8 | ( local_12c & 0xff00 ) << 8 | local_12c << 0x18;
            local_2e0 = local_10c >> 0x18 | ( local_10c & 0xff0000 ) >> 8 | ( local_10c & 0xff00 ) << 8 | local_10c << 0x18;
            local_2c8 = 0x80;
            local_2ac = 0x30000;
            local_2dc = local_ec >> 0x18 | ( local_ec & 0xff0000 ) >> 8 | ( local_ec & 0xff00 ) << 8 | local_ec << 0x18;
            local_2d8 = local_cc >> 0x18 | ( local_cc & 0xff0000 ) >> 8 | ( local_cc & 0xff00 ) << 8 | local_cc << 0x18;
            local_2d4 = local_ac >> 0x18 | ( local_ac & 0xff0000 ) >> 8 | ( local_ac & 0xff00 ) << 8 | local_ac << 0x18;
            local_2d0 = local_8c >> 0x18 | ( local_8c & 0xff0000 ) >> 8 | ( local_8c & 0xff00 ) << 8 | local_8c << 0x18;
            local_2cc = local_6c >> 0x18 | ( local_6c & 0xff0000 ) >> 8 | ( local_6c & 0xff00 ) << 8 | local_6c << 0x18;
            local_268 = local_148 >> 0x18 | ( local_148 & 0xff0000 ) >> 8 | ( local_148 & 0xff00 ) << 8 | local_148 << 0x18;
            local_264 = local_128 >> 0x18 | ( local_128 & 0xff0000 ) >> 8 | ( local_128 & 0xff00 ) << 8 | local_128 << 0x18;
            local_260 = local_108 >> 0x18 | ( local_108 & 0xff0000 ) >> 8 | ( local_108 & 0xff00 ) << 8 | local_108 << 0x18;
            local_25c = local_e8 >> 0x18 | ( local_e8 & 0xff0000 ) >> 8 | ( local_e8 & 0xff00 ) << 8 | local_e8 << 0x18;
            local_258 = local_c8 >> 0x18 | ( local_c8 & 0xff0000 ) >> 8 | ( local_c8 & 0xff00 ) << 8 | local_c8 << 0x18;
            local_254 = local_a8 >> 0x18 | ( local_a8 & 0xff0000 ) >> 8 | ( local_a8 & 0xff00 ) << 8 | local_a8 << 0x18;
            local_250 = local_88 >> 0x18 | ( local_88 & 0xff0000 ) >> 8 | ( local_88 & 0xff00 ) << 8 | local_88 << 0x18;
            local_24c = local_68 >> 0x18 | ( local_68 & 0xff0000 ) >> 8 | ( local_68 & 0xff00 ) << 8 | local_68 << 0x18;
            local_248 = 0x80;
            local_22c = 0x30000;
            local_150 = uVar20;
            local_14c = uVar20;
            ...
            if (uVar34 == 8) {
               ...
               local_1c8 = 0x80;
               local_710 = 1;
               local_1dc = local_e4 >> 0x18 | ( local_e4 & 0xff0000 ) >> 8 | ( local_e4 & 0xff00 ) << 8 | local_e4 << 0x18;
               local_700 = 1;
               local_1d8 = local_c4 >> 0x18 | ( local_c4 & 0xff0000 ) >> 8 | ( local_c4 & 0xff00 ) << 8 | local_c4 << 0x18;
               local_6f0 = 1;
               local_1d4 = local_a4 >> 0x18 | ( local_a4 & 0xff0000 ) >> 8 | ( local_a4 & 0xff00 ) << 8 | local_a4 << 0x18;
               local_6e0 = 1;
               local_1d0 = local_84 >> 0x18 | ( local_84 & 0xff0000 ) >> 8 | ( local_84 & 0xff00 ) << 8 | local_84 << 0x18;
               local_6d0 = 1;
               local_1e8 = local_144 >> 0x18 | ( local_144 & 0xff0000 ) >> 8 | ( local_144 & 0xff00 ) << 8 | local_144 << 0x18;
               local_1e4 = local_124 >> 0x18 | ( local_124 & 0xff0000 ) >> 8 | ( local_124 & 0xff00 ) << 8 | local_124 << 0x18;
               local_1e0 = local_104 >> 0x18 | ( local_104 & 0xff0000 ) >> 8 | ( local_104 & 0xff00 ) << 8 | local_104 << 0x18;
               local_1cc = local_64 >> 0x18 | ( local_64 & 0xff0000 ) >> 8 | ( local_64 & 0xff00 ) << 8 | local_64 << 0x18;
               local_6c0 = 1;
               local_6b0 = 1;
               local_718 = &local_4e8;
               local_708 = &local_468;
      ...
      while (true) {
         ...
         *puVar18 = uVar32 >> 0x18 | ( uVar32 & 0xff0000 ) >> 8 | ( uVar32 & 0xff00 ) << 8 | uVar32 << 0x18;
         for (int i = 0; i < 7; i++) {
            uVar32 = puVar17[( 8*i + 8 )];
            puVar18[( i + 1 )] = uVar32 >> 24 | ( uVar32 & 16711680 ) >> 8 | ( uVar32 & 65280 ) << 8 | uVar32 << 24;
         }
         ...
         if (uVar32 < 8) {
            ...
            *(long*)( (long)puVar18 + uVar29 + 0x18 ) = lVar16;
            uVar32 = uVar32 + ( (int)( puVar18 + 8 ) - (int)( ( ulong )(puVar18 + 10) & 0xfffffffffffffff8 ) ) & 0xfffffff8;
            if (7 < uVar32) {
               uVar28 = 0;
               do {
                  uVar30 = (ulong)uVar28;
...
;
   ...
   *(long*)( param_1 + 0x1e8 ) = local_810;
   LAB_00101805:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return local_810;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int aesni_cbc_hmac_sha256_tls1_multiblock_max_bufsize(long param_1) {
   SHA256_CTX *c;
   size_t __n;
   char *__src;
   char *pcVar1;
   ...
   OPENSSL_die("assertion failed: ctx->multiblock_max_send_fragment != 0", "providers/implementations/ciphers/cipher_aes_cbc_hmac_sha256_hw.c", 0x2f8);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void aesni_cbc_hmac_sha256_set_mac_key(long param_1, void *param_2, size_t param_3) {
   SHA256_CTX *c;
   long in_FS_OFFSET;

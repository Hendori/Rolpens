         ...
         *param_1 = *param_2;
         if (( ( iVar3 != 1 ) && ( param_1[1] = param_2[1] ),iVar3 != 2 )) {
            ...
            while (iVar3 = iVar3 + -4,iVar3 != 0) {
               param_1[4] = param_2[4];
               if (( ( iVar3 == 1 ) || ( param_1[5] = iVar3 == 2 ) ) || ( param_1[6] = iVar3 == 3 )) break;
               param_1[7] = param_2[7];
               param_1 = param_1 + 4;
               param_2 = param_2 + 4;
            }
   ...
   *puVar4 = uVar2;
   while (true) {
      for (int i = 0; i < 3; i++) {
         ...
         uVar2 = bn_mul_add_words(param_1 + ( i + 1 ), param_4, num, puVar3[( i + 1 )]);
         puVar4[( i + 1 )] = uVar2;
      }
...
void bn_mul_recursive(ulong *param_1, long param_2, long param_3, int param_4, int param_5, int param_6, ulong *param_7) {
   long lVar1;
   long lVar2;
   ulong *rp;
   bool bVar3;
   ...
   if (( param_4 == 8 ) && ( param_5 == 0 )) {
      ...
      LAB_00100381:bn_mul_normal(param_1, param_2, param_4 + param_5, param_3, param_4 + param_6);
...
LAB_0010078e:
   ...
   LAB_001004a9:local_60 = rp + lVar10;
   ...
   LAB_001004ff:uVar8 = bn_add_words(param_7, param_1, param_1 + lVar10, param_4);
   if (bVar3) {
...
void bn_mul_part_recursive(ulong *param_1, long param_2, long param_3, int param_4, int param_5, int param_6, ulong *param_7) {
   long lVar1;
   long lVar2;
   ulong *puVar3;
   bool bVar4;
 ...
 while ( ( param_5 != iVar14 ) && ( param_6 != iVar14 ) );
   ...
   LAB_00100ab3:uVar9 = bn_add_words(param_7, param_1, bp, iVar5);
   if (bVar4) {
...
bool bn_mul_fixed_top(BIGNUM *param_1, BIGNUM *param_2, BIGNUM *param_3, BN_CTX *param_4) {
   ...
   if (( ( param_2 == param_1 ) || ( pBVar10 = param_1 ),param_3 == param_1 )) goto LAB_00100fe0;
   iVar7 = iVar2 - iVar3;
   if (iVar7 == 0) {
      if (iVar2 != 8) {
         if (( 0xf < iVar3 ) && ( 0xf < iVar2 )) goto LAB_00100e78;
         goto LAB_00100f50;
      }

      lVar9 = bn_wexpand(pBVar10, 0x10);
      if (lVar9 == 0) goto LAB_00100fe0;
      puVar4 = param_3->d;
      puVar5 = param_2->d;
      pBVar10->top = 0x10;
      bn_mul_comba8(pBVar10->d, puVar5, puVar4);
      LAB_00100f7f:bVar13 = true;
      ...
      if (( iVar2 < 0x10 ) || ( ( iVar3 < 0x10 || ( 2 < iVar7 + 1U ) ) )) {
         LAB_00100f50:lVar9 = bn_wexpand(pBVar10, iVar1);
         if (lVar9 != 0) {
            puVar4 = param_3->d;
            puVar5 = param_2->d;
            pBVar10->top = iVar1;
         ...
         if (iVar7 == -1) {
            ...
            LAB_00100e78:iVar7 = BN_num_bits_word((long)iVar2);
            cVar6 = (char)iVar7;
         }
         ...
         if (pBVar8 != (BIGNUM*)0x0) {
            ...
            if (iVar7 < iVar12) {
               ...
               if (( lVar9 != 0 ) && ( lVar9 = lVar9 != 0 )) {
                  bn_mul_part_recursive(pBVar10->d, param_2->d, param_3->d, iVar7, iVar2 - iVar7, iVar3 - iVar7, pBVar8->d);
                  LAB_00100f29:pBVar10->top = iVar1;
                  goto LAB_00100f7f;
               }
               ...
               lVar9 = bn_wexpand(pBVar8);
               if (( lVar9 != 0 ) && ( lVar9 = lVar9 != 0 )) {
                  bn_mul_recursive(pBVar10->d, param_2->d, param_3->d, iVar7, iVar2 - iVar7, iVar3 - iVar7, pBVar8->d);
                  goto LAB_00100f29;
               }

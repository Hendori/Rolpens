...
undefined8 memory_err_compare(long param_1, char *param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6) {
   int iVar1;
   undefined8 uVar2;
   if (( *(char**)( param_1 + 0x9b8 ) == (char*)0x0 ) || ( iVar1 = strcmp(*(char**)( param_1 + 0x9b8 ), param_2) ),iVar1 != 0) {
         ...
         if (ptr != (void*)0x0) {
            ...
            if (( iVar3 == 0 ) || ( *(int*)( puVar1 + 0x16 ) != 0 )) {
               LAB_00103990:if (( *(int*)( puVar1 + 8 ) == 0 ) || ( iVar3 = EVP_CIPHER_CTX_ctrl(ctx, 5, *(int*)( puVar1 + 8 ), (void*)0x0) ),0 < iVar3) {
                  ...
                  if (( puVar1[5] != 0 ) && ( iVar3 = EVP_CIPHER_CTX_ctrl(ctx, 3, (int)puVar1[5], (void*)0x0) ),iVar3 < 1) {
                     uVar11 = 0;
...
uint cipher_test_run(long param_1) {
   ...
   uVar5 = 0;
      ...
      if ((iVar4 < 1) ||
         (iVar4 = ctrl2params(param_1,puVar1[0x1e],0,local_98,2,alStack_b0 + 2), iVar4 != 0)){iVar4 = cipher_test_valid_fragmentation(puVar1);
...
LAB_00104e38:
            ...
            *(undefined8 *)(param_1 + 0x9b0) = 0;
            uVar5 = 1;
            gotoLAB_00104f2b;}uVar5 = cipher_test_enc(param_1,1,cVar8,lVar9,bVar15,cVar13,local_98);
          if (uVar5 != 1) goto LAB_00104ed8;
          if (*(int *)(puVar1 + 2) != 1) goto LAB_00104d10;
          if (lVar9 == 1) goto LAB_00104dc0;LAB_00104d41:lVar9 = 1;
          pcVar11 = "misaligned";
...
LAB_00104de8:
          puVar12 = &_LC158;
          if (bVar15 != false){puVar12 = &_LC19;}pcVar11 = "misaligned";
          if (cVar3 == '\0') {
            pcVar11 = "aligned";}lVar9 = 0;
          BIO_snprintf(aux_err_0,0x40,"%s in-place, %sfragmented",pcVar11,puVar12);}while( true );} * (char**)( param_1 + 0x9a8 ) = "NO_TAG"(local_40 != *(long*)( in_FS_OFFSET + 0x28 ));{
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
...
undefined8 pbe_test_run(long param_1) {
   ...
   if (( *(char**)( param_1 + 0x9b8 ) == (char*)0x0 ) || ( iVar3 = strcmp(*(char**)( param_1 + 0x9b8 ), "KEY_MISMATCH") ),iVar3 != 0) {
...
undefined8 oneshot_digestsign_test_run(long param_1) {
   ...
   if (iVar5 != 0) {
      ...
      if (iVar5 != 0) {
         ...
         if (( *(char**)( param_1 + 0x9b8 ) == (char*)0x0 ) || ( iVar5 = strcmp(*(char**)( param_1 + 0x9b8 ), "SIGNATURE_MISMATCH") ),iVar5 != 0) {
               ...
               if (iVar3 != 0) {
                  if (*(int*)( param_1 + 0x9d0 ) == 0) {
                     ...
                     if (( local_f4 != 1 ) && ( fips_indicator_callback_unapproved_count != 0 )) {
                        ...
                        lVar2 = plVar1[1];
                        if (( *(char**)( param_1 + 0x9b8 ) == (char*)0x0 ) || ( iVar3 = strcmp(*(char**)( param_1 + 0x9b8 ), "KDF_MISMATCH") ),iVar3 != 0) {
      ...
      if (iVar3 == 0) {
         ...
         if (iVar3 != 0) {
            ...
            if (iVar3 != 0) {
               ...
               while (( puVar15 != (undefined8*)0x0 && ( iVar3 = strcmp(pcVar11, (char*)*puVar15) ),iVar3 != 0 )) {
...
undefined8 encode_test_run(long param_1) {
 ...
 while ( uVar9 != 0 );
   ...
   lVar7 = plVar1[3];
   lVar2 = plVar1[2];
   if (( *(char**)( param_1 + 0x9b8 ) == (char*)0x0 ) || ( iVar6 = strcmp(*(char**)( param_1 + 0x9b8 ), "BAD_ENCODING") ),iVar6 != 0) {
...
;
      *(undefined8*)( param_1 + 0x9a8 ) = 0;
      ...
      lVar7 = plVar1[1];
      lVar2 = *plVar1;
      if (( *(char**)( param_1 + 0x9b8 ) == (char*)0x0 ) || ( iVar5 = strcmp(*(char**)( param_1 + 0x9b8 ), "BAD_DECODING") ),iVar5 != 0) {
...
undefined8 pkey_test_run(long param_1) {
   ...
   if (iVar5 < 1) {
      ...
      if (iVar5 != 0) {
         ...
         uVar2 = puVar1[8];
         uVar3 = puVar1[7];
         if (( *(char**)( param_1 + 0x9b8 ) == (char*)0x0 ) || ( iVar5 = strcmp(*(char**)( param_1 + 0x9b8 ), "KEYOP_MISMATCH") ),iVar5 != 0) {
...
undefined8 digest_test_run(long param_1) {
 ...
 while ( uVar11 < (ulong)puVar9[2] );
   ...
   uVar2 = puVar1[4];
   uVar12 = puVar1[3];
   if (( *(char**)( param_1 + 0x9b8 ) == (char*)0x0 ) || ( iVar8 = strcmp(*(char**)( param_1 + 0x9b8 ), "DIGEST_MISMATCH") ),iVar8 != 0) {
            ...
            if (iVar4 != 0) {
               ...
               if (iVar4 == 0) {
                  ...
                  if (iVar4 == 0) {
                     ...
                     pcVar8 = (char*)0x0;
                     if (( *(char**)( param_1 + 0x9b8 ) == (char*)0x0 ) || ( iVar4 = strcmp(*(char**)( param_1 + 0x9b8 ), "SIGNATURE_MISMATCH") ),iVar4 != 0) {
...
undefined8 mac_test_run_mac(long param_1) {
 ...
 while ( uVar14 != 0 );
                  ...
                  if (iVar4 != 0) {
                     ...
                     uVar6 = puVar1[0xb];
                     uVar2 = puVar1[10];
                     if (( *(char**)( param_1 + 0x9b8 ) == (char*)0x0 ) || ( iVar5 = strcmp(*(char**)( param_1 + 0x9b8 ), "TEST_MAC_ERR") ),iVar5 != 0) {
                  ...
                  if (iVar3 != 0) {
                     ...
                     if (iVar3 != 0) {
                        ...
                        if (iVar3 == 0) {
                           ...
                           if (( *(char**)( param_1 + 0x9b8 ) == (char*)0x0 ) || ( iVar3 = strcmp(*(char**)( param_1 + 0x9b8 ), "TEST_MAC_ERR") ),iVar3 != 0) {

undefined8 demux_ensure_free_urxe(long param_1, ulong param_2) {
   ...
   while (( uVar1 = *(ulong*)( param_1 + 0x10 ) ),uVar1<0xfffffffffffffed7 && ( puVar4 = (undefined8*)CRYPTO_malloc((int)uVar1 + 0x128, "ssl/quic/quic_demux.c", 0xa2) ),puVar4 != (undefined8*)0x0))){puVar2 = *(undefined8 **)(param_1 + 0x48);
    puVar4[3] = uVar1;
    puVar4[2] = 0;
    ...
    *(undefined8 **)(param_1 + 0x48) = puVar4;
    ...
    }else{lVar3 = *(long *)(param_1 + 0x50);
      *(undefined1 *)((long)puVar4 + 0x121) = 0;
      uVar1 = lVar3 + 1;
      *(ulong *)(param_1 + 0x50) = uVar1;
      if (param_2 <= uVar1){return1;}}} * demux_resize_urxe(long, param_1, undefined1(*param_2)[16], long, param_3){long * plVar1;long lVar2;
  long lVar3;
  long *plVar4;
...
;
   ...
   *param_2 = (undefined1[16])0x0;
   ...
   if (plVar4 == (long*)0x0) {
      ...
      *(undefined1(**) [16])( param_1 + 0x48 ) = param_2;
      LAB_0010023e:*(long*)( param_1 + 0x50 ) = *(long*)( param_1 + 0x50 ) + 1;
      return (long*)0x0;
   }
   ...
   *(long**)( param_1 + 0x48 ) = plVar4;
   LAB_0010019f:*(long*)( param_1 + 0x50 ) = *(long*)( param_1 + 0x50 ) + 1;
   plVar4[3] = param_3;
   return plVar4;
}
undefined8 demux_recv(long *param_1) {
   ...
   if (*param_1 == 0) {
      ...
      if (puVar6 != (undefined8*)0x0) {
         ...
         do {
            lVar11 = lVar4;
            if (( (ulong)puVar6[3] < (ulong)param_1[2] ) && ( puVar6 = (undefined8*)demux_resize_urxe(param_1, puVar6) ),puVar6 == (undefined8*)0x0) goto LAB_00100515;
...
;
      ...
      LAB_00100515:uVar7 = 0xfffffffe;
   }

   LAB_001004d2:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar7;
   }
...
undefined8 *ossl_quic_demux_new(BIO *param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4) {
   undefined8 *puVar1;
   long lVar2;
...
undefined8 ossl_quic_demux_pump(long param_1) {
   ...
   if (pauVar9 == (undefined1(*) [16])0x0) {
      ...
      do {
         while (true) {
            iVar5 = ossl_quic_wire_get_pkt_hdr_dst_conn_id(pauVar9[0x12] + 8, *(undefined8*)pauVar9[1], *(undefined8*)( param_1 + 8 ), auStack_38);
            lVar7 = *(long*)*pauVar9;
...
undefined8 ossl_quic_demux_inject(long param_1, void *param_2, ulong param_3, undefined8 *param_4, undefined8 *param_5) {
   long *plVar1;
   undefined8 *puVar2;
   code *pcVar3;
   int iVar4;
   ...
   if (iVar4 == 1) {
      ...
      uVar10 = 1;
      if (( param_3 <= *(ulong*)( pauVar7[1] + 8 ) ) || ( pauVar7 = (undefined1(*) [16])demux_resize_urxe(param_1, pauVar7, param_3) ),pauVar7 != (undefined1(*) [16])0x0) {
         ...
         *(ulong*)pauVar7[1] = param_3;
         if (param_4 == (undefined8*)0x0) {
            ...
            *(undefined8*)pauVar7[4] = uVar5;
            for (int i = 0; i < 6; i++) {
               uVar5 = param_4[( 2*i + 3 )];
               *(undefined8*)( pauVar7[( i + 4 )] + 8 ) = param_4[( 2*i + 2 )];
               *(undefined8*)pauVar7[( i + 5 )] = uVar5;
            }
         ...
         if (param_5 == (undefined8*)0x0) {
            ...
            *(undefined8*)pauVar7[0xb] = uVar5;
            for (int i = 0; i < 6; i++) {
               uVar5 = param_5[( 2*i + 3 )];
               *(undefined8*)( pauVar7[( i + 11 )] + 8 ) = param_5[( 2*i + 2 )];
               *(undefined8*)pauVar7[( i + 12 )] = uVar5;
            }
         ...
         *(long*)( param_1 + 0x68 ) = lVar6 + 1;
         pauVar7[0x12][1] = 1;
         do {
            iVar4 = ossl_quic_wire_get_pkt_hdr_dst_conn_id(pauVar9[0x12] + 8, *(undefined8*)pauVar9[1], *(undefined8*)( param_1 + 8 ), local_58);
            lVar6 = *(long*)*pauVar9;
            if (pauVar9 == *(undefined1(**) [16])( param_1 + 0x58 )) {
 ...
 while ( pauVar9 != (undefined1(*) [16])0x0 );
   ...
   uVar10 = 0;
   LAB_00100945:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar10;
   }

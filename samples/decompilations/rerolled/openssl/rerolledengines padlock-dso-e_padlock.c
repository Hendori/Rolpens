...
undefined8 padlock_aes_set_encrypt_key(uint *param_1, uint param_2, uint *param_3) {
   ...
   if (( param_2 & 0xffffffbf ) == 0x80) {
      ...
      if (param_2 == 0x80) {
         ...
         *param_3 = uVar8 >> 0x18 | ( uVar8 & 0xff0000 ) >> 8 | ( uVar8 & 0xff00 ) << 8 | uVar8 << 0x18;
         ...
         param_3[3] = uVar3;
         uVar8 = (uint)(byte)Te4[uVar8 >> 0x10 & 0xff] << 0x10 ^ (uint)bVar1 ^ (uint)(byte)Te4[uVar8 >> 0x18] << 8 ^ *param_3 ^ (uint)(byte)Te4[uVar8 >> 8 & 0xff] << 0x18 ^ 0x1000000;
         uVar10 = uVar10 ^ uVar8;
         param_3[4] = uVar8;
         param_3[5] = uVar10;
         ...
         param_3[7] = uVar3;
         uVar5 = (uint)(byte)Te4[uVar3 >> 8 & 0xff] << 0x10 ^ uVar8 ^ (uint)(byte)Te4[uVar3 >> 0x18] ^ (uint)(byte)Te4[uVar3 & 0xff] << 8 ^ (uint)(byte)Te4[uVar3 >> 0x10 & 0xff] << 0x18 ^ 0x2000000;
         uVar6 = uVar6 ^ uVar5;
         param_3[8] = uVar5;
         uVar8 = uVar3 ^ uVar6;
         ...
         param_3[10] = uVar6;
         uVar7 = (uint)bVar1 << 0x10 ^ uVar5 ^ (uint)(byte)Te4[uVar8 >> 0x18] ^ (uint)(byte)Te4[uVar8 & 0xff] << 8 ^ (uint)(byte)Te4[uVar8 >> 0x10 & 0xff] << 0x18 ^ 0x4000000;
         ...
         param_3[0xf] = uVar3;
         uVar5 = (uint)bVar1 << 0x10 ^ uVar7 ^ (uint)(byte)Te4[uVar3 >> 0x18] ^ (uint)(byte)Te4[uVar3 & 0xff] << 8 ^ (uint)(byte)Te4[uVar3 >> 0x10 & 0xff] << 0x18 ^ 0x8000000;
         uVar6 = uVar6 ^ uVar5;
         param_3[0x10] = uVar5;
         ...
         param_3[0x12] = uVar6;
         param_3[0x13] = uVar10;
         uVar10 = (uint)(byte)Te4[uVar10 >> 8 & 0xff] << 0x10 ^ uVar5 ^ (uint)(byte)Te4[uVar10 >> 0x18] ^ (uint)(byte)Te4[uVar10 & 0xff] << 8 ^ (uint)(byte)Te4[uVar10 >> 0x10 & 0xff] << 0x18 ^ 0x10000000;
         ...
         bVar1 = Te4[uVar3 >> 8 & 0xff];
         param_3[0x17] = uVar3;
         uVar5 = (uint)bVar1 << 0x10 ^ uVar10 ^ (uint)(byte)Te4[uVar3 >> 0x18] ^ (uint)(byte)Te4[uVar3 & 0xff] << 8 ^ (uint)(byte)Te4[uVar3 >> 0x10 & 0xff] << 0x18 ^ 0x20000000;
         uVar6 = uVar6 ^ uVar5;
         param_3[0x18] = uVar5;
         ...
         param_3[0x1a] = uVar6;
         param_3[0x1b] = uVar10;
         uVar10 = (uint)(byte)Te4[uVar10 >> 8 & 0xff] << 0x10 ^ uVar5 ^ (uint)(byte)Te4[uVar10 >> 0x18] ^ (uint)(byte)Te4[uVar10 & 0xff] << 8 ^ (uint)(byte)Te4[uVar10 >> 0x10 & 0xff] << 0x18 ^ 0x40000000;
         uVar8 = uVar8 ^ uVar5 ^ uVar10;
         param_3[0x1c] = uVar10;
         uVar3 = uVar3 ^ uVar8;
         param_3[0x1d] = uVar8;
         ...
         param_3[0x1f] = uVar3;
         uVar5 = ( (uint)(byte)Te4[uVar3 >> 8 & 0xff] << 0x10 ^ uVar10 ^ (uint)(byte)Te4[uVar3 >> 0x18] ^ (uint)(byte)Te4[uVar3 & 0xff] << 8 ^ (uint)(byte)Te4[uVar3 >> 0x10 & 0xff] << 0x18 ) + 0x80000000;
         uVar6 = uVar6 ^ uVar5;
         param_3[0x20] = uVar5;
         ...
         param_3[0x22] = uVar6;
         param_3[0x23] = uVar10;
         uVar10 = (uint)(byte)Te4[uVar10 >> 8 & 0xff] << 0x10 ^ uVar5 ^ (uint)(byte)Te4[uVar10 >> 0x18] ^ (uint)(byte)Te4[uVar10 & 0xff] << 8 ^ (uint)(byte)Te4[uVar10 >> 0x10 & 0xff] << 0x18 ^ 0x1b000000;
         uVar8 = uVar8 ^ uVar5 ^ uVar10;
         param_3[0x24] = uVar10;
         uVar3 = uVar3 ^ uVar8;
         param_3[0x25] = uVar8;
         ...
         bVar1 = Te4[uVar3 >> 8 & 0xff];
         param_3[0x27] = uVar3;
         uVar10 = (uint)bVar1 << 0x10 ^ uVar10 ^ (uint)(byte)Te4[uVar3 >> 0x18] ^ (uint)(byte)Te4[uVar3 & 0xff] << 8 ^ (uint)(byte)Te4[uVar3 >> 0x10 & 0xff] << 0x18 ^ 0x36000000;
         param_3[0x28] = uVar10;
   ...
   *param_3 = uVar7;
   ...
   param_3[5] = uVar10;
   if (param_2 == 0xc0) {
      uVar8 = (uint)(byte)Te4[uVar8 >> 0x10 & 0xff] << 0x10 ^ (uint)(byte)Te4[uVar8 & 0xff] ^ (uint)(byte)Te4[uVar8 >> 0x18] << 8 ^ *param_3 ^ (uint)(byte)Te4[uVar8 >> 8 & 0xff] << 0x18 ^ 0x1000000;
      uVar5 = uVar5 ^ uVar8;
      param_3[6] = uVar8;
      param_3[7] = uVar5;
      ...
      param_3[10] = uVar7;
      param_3[0xb] = uVar10;
      uVar11 = uVar8 ^ (uint)(byte)Te4[uVar10 >> 8 & 0xff] << 0x10 ^ (uint)(byte)Te4[uVar10 >> 0x18] ^ (uint)(byte)Te4[uVar10 & 0xff] << 8 ^ (uint)(byte)Te4[uVar10 >> 0x10 & 0xff] << 0x18 ^ 0x2000000;
      uVar6 = uVar6 ^ uVar11;
      param_3[0xc] = uVar11;
      ...
      param_3[0x11] = uVar8;
      param_3[0x10] = uVar7;
      uVar4 = uVar11 ^ (uint)(byte)Te4[uVar8 >> 8 & 0xff] << 0x10 ^ (uint)(byte)Te4[uVar8 >> 0x18] ^ (uint)(byte)Te4[uVar8 & 0xff] << 8 ^ (uint)(byte)Te4[uVar8 >> 0x10 & 0xff] << 0x18 ^ 0x4000000;
      ...
      uVar11 = (uint)(byte)Te4[uVar5 >> 8 & 0xff] << 0x10 ^ uVar4 ^ (uint)(byte)Te4[uVar5 >> 0x18] ^ (uint)(byte)Te4[uVar5 & 0xff] << 8 ^ (uint)(byte)Te4[uVar5 >> 0x10 & 0xff] << 0x18 ^ 0x8000000;
      uVar6 = uVar6 ^ uVar11;
      param_3[0x18] = uVar11;
      uVar4 = uVar7 ^ uVar6;
      ...
      param_3[0x1a] = uVar6;
      param_3[0x1c] = uVar4;
      uVar5 = (uint)bVar1 << 0x10 ^ uVar11 ^ (uint)(byte)Te4[uVar5 >> 0x18] ^ (uint)(byte)Te4[uVar5 & 0xff] << 8 ^ (uint)(byte)Te4[uVar5 >> 0x10 & 0xff] << 0x18 ^ 0x10000000;
      ...
      param_3[0x21] = uVar3;
      param_3[0x23] = uVar10;
      uVar4 = (uint)bVar1 << 0x10 ^ uVar5 ^ (uint)(byte)Te4[uVar10 >> 0x18] ^ (uint)(byte)Te4[uVar10 & 0xff] << 8 ^ (uint)(byte)Te4[uVar10 >> 0x10 & 0xff] << 0x18 ^ 0x20000000;
      uVar7 = uVar7 ^ uVar4;
      uVar6 = uVar6 ^ uVar4;
      param_3[0x24] = uVar4;
      uVar5 = uVar10 ^ uVar7;
      ...
      param_3[0x29] = uVar5;
      param_3[0x26] = uVar6;
      uVar5 = uVar4 ^ (uint)bVar1 << 0x10 ^ (uint)(byte)Te4[uVar5 >> 0x18] ^ (uint)(byte)Te4[uVar5 & 0xff] << 8 ^ (uint)(byte)Te4[uVar5 >> 0x10 & 0xff] << 0x18 ^ 0x40000000;
      ...
      uVar10 = ( (uint)bVar1 << 0x10 ^ uVar5 ^ (uint)(byte)Te4[uVar10 >> 0x18] ^ (uint)(byte)Te4[uVar10 & 0xff] << 8 ^ (uint)(byte)Te4[uVar10 >> 0x10 & 0xff] << 0x18 ) + 0x80000000;
      param_3[0x30] = uVar10;
      ...
      while (true) {
         uVar8 = puVar2[-1];
         uVar7 = uVar7 ^ (uint)(byte)Te4[uVar8 >> 0x18] ^ *puVar9 ^ (uint)(byte)Te4[uVar8 & 0xff] << 8 ^ (uint)(byte)Te4[uVar8 >> 0x10 & 0xff] << 0x18 ^ (uint)(byte)Te4[uVar8 >> 8 & 0xff] << 0x10;
         uVar5 = uVar5 ^ uVar7;
         uVar6 = uVar6 ^ uVar5;
         uVar3 = uVar3 ^ uVar6;
         ...
         *(ulong*)( puVar2 + 2 ) = CONCAT44(uVar3, uVar6);
         ...
         uVar10 = (uint)(byte)Te4[uVar3 & 0xff] ^ puVar2[-4] ^ (uint)(byte)Te4[uVar3 >> 0x18] << 0x18 ^ (uint)(byte)Te4[uVar3 >> 0x10 & 0xff] << 0x10 ^ (uint)(byte)Te4[uVar3 >> 8 & 0xff] << 8;
...
undefined8 padlock_rand_bytes(undefined1 *param_1, int param_2) {
 ...
 while ( ( uVar2 & 0x1f ) == 0 );
   ...
   uVar3 = 1;
   LAB_00100a32:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }

   return uVar3;
   LAB_00100a30:uVar3 = 0;
   goto LAB_00100a32;
}
undefined8 padlock_ciphers(undefined8 param_1, long *param_2, undefined8 *param_3, int param_4) {
   ...
   if (param_4 < 0x1ae) {
      ...
      lVar17 = lVar6;
      if (( _hidden_aes_192_ctr == 0 ) && ( ( ( ( ( ( _hidden_aes_192_ctr = EVP_CIPHER_meth_new(0x389, 1, 0x18) ),_hidden_aes_192_ctr == 0 || ( iVar16 = EVP_CIPHER_meth_set_iv_length(_hidden_aes_192_ctr, 0x10) ),iVar16 == 0 ) ) || ( iVar16 = EVP_CIPHER_meth_set_flags(_hidden_aes_192_ctr, 5) ),iVar16 == 0 ) ) || ( ( iVar16 = EVP_CIPHER_meth_set_init(_hidden_aes_192_ctr, padlock_aes_init_key) ),iVar16 == 0 || ( iVar16 = EVP_CIPHER_meth_set_do_cipher(_hidden_aes_192_ctr, padlock_ctr_cipher) ),iVar16 == 0 ) )) {
      ...
      lVar17 = lVar1;
      if (( _hidden_aes_256_ctr == 0 ) && ( ( ( ( _hidden_aes_256_ctr = EVP_CIPHER_meth_new(0x38a, 1, 0x20) ),_hidden_aes_256_ctr == 0 || ( iVar16 = EVP_CIPHER_meth_set_iv_length(_hidden_aes_256_ctr, 0x10) ),iVar16 == 0 ) ) || ( iVar16 = EVP_CIPHER_meth_set_flags(_hidden_aes_256_ctr, 5) ),iVar16 == 0 )) {
      ...
      lVar17 = lVar11;
      if (( _hidden_aes_128_ctr == 0 ) && ( ( ( ( _hidden_aes_128_ctr = EVP_CIPHER_meth_new(0x388, 1, 0x10) ),_hidden_aes_128_ctr == 0 || ( iVar16 = EVP_CIPHER_meth_set_iv_length(_hidden_aes_128_ctr, 0x10) ),iVar16 == 0 ) ) || ( iVar16 = EVP_CIPHER_meth_set_flags(_hidden_aes_128_ctr, 5) ),iVar16 == 0 )) {
...
undefined8 padlock_cfb_cipher(undefined8 param_1, byte *param_2, byte *param_3, ulong param_4) {
   ...
   if (uVar12 != 0) {
      ...
      if (iVar5 == 0) {
         if (param_4 == 0) {
            LAB_00102230:EVP_CIPHER_CTX_set_num(param_1, iVar4);
            return 1;
         }
 ...
 while ( param_4 != 0 );
   ...
   *puVar7 = *puVar8;
   ...
   if (( *(byte*)( (long)puVar7 + 0x11 ) & 2 ) == 0) {
      ...
      padlock_reload_key();
      if (( ( param_4 - 1 < 7 ) || ( puVar7 < pbVar15 + uVar12 + 0x10 && puVar8 < puVar7 + 2 || ( ulong )((long)puVar8 - (long)( param_3 + uVar12 + 1 )) < 0xf ) ) || ( ( ulong )((long)puVar7 - (long)( param_3 + uVar12 + 1 )) < 0xf )) {
         uVar12 = 0;
         do {
 ...
 while ( param_4 != uVar12 );
   ...
   if (param_4 - 1 < 0xf) {
      uVar11 = 0;
      puVar14 = puVar7;
      LAB_00101dec:uVar9 = *(ulong*)( param_3 + uVar11 + uVar12 );
 ...
 while ( uVar11 != uVar9 );
   ...
   *(byte*)puVar14 = bVar2;
   ...
   LAB_00101ed0:puVar8 = (ulong*)EVP_CIPHER_CTX_iv_noconst(param_1);
   uVar12 = puVar7[1];
   *puVar8 = *puVar7;
   puVar8[1] = uVar12;
   return 1;
...
undefined8 padlock_ofb_cipher(undefined8 param_1, byte *param_2, byte *param_3, ulong param_4) {
 ...
 while ( param_4 != 0 );
   ...
   *(undefined8*)( pbVar7 + 8 ) = uVar2;
   ...
   padlock_reload_key();
   if (( ( param_4 - 1 < 7 ) || ( ( ulong )((long)pbVar14 - (long)( param_3 + uVar13 + 1 )) < 0xf ) ) || ( ( ulong )((long)pbVar14 - (long)( pbVar7 + 1 )) < 0xf )) {
      uVar13 = 0;
      do {
 ...
 while ( param_4 != uVar13 );
   ...
   if (param_4 - 1 < 0xf) {
      uVar11 = 0;
      pbVar16 = pbVar7;
      LAB_001023bc:uVar12 = param_4 & 0xfffffffffffffff8;
      pbVar14 = pbVar14 + uVar12;
      pbVar15 = pbVar15 + uVar12;
      uVar9 = param_4 - uVar12;
      pbVar16 = pbVar16 + uVar12;
      *(ulong*)( param_2 + uVar13 + uVar11 ) = *(ulong*)( param_3 + uVar13 + uVar11 ) ^ *(ulong*)( pbVar7 + uVar11 );
 ...
 while ( uVar9 != uVar11 );
   ...
   *pbVar14 = *pbVar15 ^ *pbVar16;
   if (( ( ( uVar9 != 1 ) && ( pbVar14[1] = pbVar15[1] ^ pbVar16[1] ),uVar9 != 2 ) ) && ( ( pbVar14[2] = pbVar15[2] ^ pbVar16[2] ),uVar9 != 3 && ( ( pbVar14[3] = pbVar15[3] ^ pbVar16[3] ),uVar9 != 4 && ( pbVar14[4] = pbVar15[4] ^ pbVar16[4] ),uVar9 != 5 ) )) {
      pbVar14[6] = pbVar15[6] ^ pbVar16[6];
   }

   LAB_00102468:puVar8 = (undefined8*)EVP_CIPHER_CTX_iv_noconst(param_1);
...
bool padlock_ctr_cipher(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4) {
   ...
   if (-1 < iVar2) {
      ...
      CRYPTO_ctr128_encrypt_ctr32(param_3, param_2, param_4, lVar3 + ( ulong )(-iVar1 & 0xf), uVar5, uVar4, &local_44, padlock_ctr32_encrypt_glue);
...
void padlock_ctr32_encrypt_glue(undefined8 param_1, undefined8 param_2, long param_3, undefined8 *param_4, undefined8 *param_5) {
   undefined8 uVar1;
   uVar1 = param_5[1];
   *param_4 = *param_5;
   param_4[1] = uVar1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 padlock_aes_init_key(undefined8 param_1, undefined8 *param_2, undefined8 param_3, int param_4) {
   undefined4 uVar1;
   ...
   *(undefined8*)( (long)puVar16 + 0x10c ) = 0;
   ...
   for (uVar13 = ( ulong )(( (int)puVar16 - (int)(undefined8*)( ( ulong )(puVar16 + 1) & 0xfffffffffffffff8 ) ) + 0x114U >> 3); uVar13 != 0; uVar13 = uVar13 - 1) {
      *puVar18 = 0;
   ...
   if ((long)iVar6 - 4U < 2) {
      ...
      *(byte*)( (long)puVar16 + 0x11 ) = *(byte*)( (long)puVar16 + 0x11 ) & 0xf3 | ( byte )(( bVar12 & 3 ) << 2);
      if (( iVar19 - 0xc0U & 0xffffffb8 ) == 0) {
         LAB_001029f8:padlock_aes_set_encrypt_key(param_2, iVar19, puVar16 + 4);
         LAB_00102a0a:padlock_key_bswap(puVar16 + 4);
         iVar5 = 1;
         goto LAB_001029cc;
      }
      ...
      *(byte*)( puVar16 + 2 ) = *(byte*)( puVar16 + 2 ) & 0xf0 | bVar14 & 0xf;
      *(byte*)( (long)puVar16 + 0x11 ) = *(byte*)( (long)puVar16 + 0x11 ) & 0xf1 | ( iVar7 == 0 ) * '\x02' | ( bVar12 & 3 ) * '\x04';
      if (( iVar19 - 0xc0U & 0xffffffb8 ) == 0) {
         ...
         if (( -1 < iVar5 ) && ( iVar5= *(int *)(puVar16 + 0x22) * 4,0 < iVar5 )) {
            ...
            do {
               ...
               *puVar11 = uVar1;
               for (int i = 0; i < 3; i++) {
                  uVar1 = *(undefined4*)( (long)*pauVar15 + ( 4*i + 4 ) );
                  *(undefined4*)( (long)*pauVar15 + ( 4*i + 4 ) ) = puVar11[( i + 1 )];
                  puVar11[( i + 1 )] = uVar1;
               }
 ...
 while ( iVar5 - iVar6 < iVar6 );
            if (1 < *(int*)( puVar16 + 0x22 )) {
               ...
               do {
                  ...
                  *pauVar17 = auVar26 ^ auVar27 ^ auVar21 ^ auVar25 ^ auVar22 ^ auVar31 ^ auVar23 ^ auVar20 ^ auVar30;
               }
 while ( iVar5 < *(int*)( puVar16 + 0x22 ) );
   ...
   puVar16[4] = *param_2;
   puVar16[5] = uVar9;
   LAB_001029cc:*(byte*)( puVar16 + 2 ) = *(byte*)( puVar16 + 2 ) & 0x7f | ( byte )(iVar5 << 7);
   padlock_reload_key();
   return 1;
}
...
bool bind_engine(ENGINE *param_1, char *param_2, long *param_3) {
   ...
   if (( param_2 == (char*)0x0 ) || ( iVar1 = iVar1 == 0 )) {
      ...
      if (( ( ( iVar1 != 0 ) && ( iVar1 = ENGINE_set_name(param_1, padlock_name) ),iVar1 != 0 ) ) && ( iVar1 = ENGINE_set_init_function(param_1, padlock_init) ),iVar1 != 0) {

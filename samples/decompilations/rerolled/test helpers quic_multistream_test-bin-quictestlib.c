   ...
   *(void**)( param_7 + 0x60 ) = pvVar4;
   if (pvVar4 == (void*)0x0) {
      ...
      *(undefined8*)( param_7 + 8 ) = *param_1;
      for (int i_899 = 0; i_899 < 4; i_899++) {
         *(undefined8*)( param_7 + ( 16*i_899 + 16 ) ) = uVar6;
         uVar6 = param_1[( 2*i_899 + 3 )];
         *(undefined8*)( param_7 + ( 16*i_899 + 24 ) ) = param_1[( 2*i_899 + 2 )];
      }

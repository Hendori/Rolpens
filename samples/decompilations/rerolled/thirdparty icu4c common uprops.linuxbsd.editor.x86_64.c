/* (anonymous namespace)::ulayout_isAcceptable(void*, char const*, char const*, UDataInfo const*) */bool (anonymous_namespace)::ulayout_isAcceptable(void *param_1, char *param_2, char *param_3, UDataInfo *param_4) {
   if (( ( ( 0x13 < *(ushort*)param_4 ) && ( *(short*)( param_4 + 4 ) == 0 ) ) && ( *(short*)( param_4 + 8 ) == 0x614c ) ) && ( *(short*)( param_4 + 10 ) == 0x6f79 )) {
      return param_4[0xc] == (UDataInfo)0x1;
   }
   return false;
}/* isRegionalIndicator(BinaryProperty const&, int, UProperty) */bool isRegionalIndicator(undefined8 param_1, int param_2) {
   return param_2 - 0x1f1e6U < 0x1a;
}/* isIDSUnaryOperator(BinaryProperty const&, int, UProperty) */bool isIDSUnaryOperator(undefined8 param_1, int param_2) {
   return param_2 - 0x2ffeU < 2;
}/* isModifierCombiningMark(BinaryProperty const&, int, UProperty) */undefined8 isModifierCombiningMark(undefined8 param_1, int param_2) {
   int *piVar1;
   ...
   return 1;
}/* getMaxValueFromShift(IntProperty const&, UProperty) */undefined4 getMaxValueFromShift(long param_1) {
   return *(undefined4*)( param_1 + 8 );
}/* hasEmojiProperty(BinaryProperty const&, int, UProperty) */void hasEmojiProperty(undefined8 param_1, undefined4 param_2, undefined4 param_3) {
   icu_76_godot::EmojiProps::hasBinaryProperty(param_2, param_3);
   return;
}/* changesWhenCasefolded(BinaryProperty const&, int, UProperty) */uint changesWhenCasefolded(undefined8 param_1, uint param_2) {
   char cVar1;
   uint uVar2;
   undefined4 uVar3;
   int iVar4;
   ...
   if (local_104 < 1) {
      ...
      if (cVar1 != '\0') {
         if ((short)local_f0 < 0) {
            ...
            iVar4 = (int)sVar6;
            if (sVar6 < 3) {
               LAB_00100265:param_2 = icu_76_godot::UnicodeString::char32At((int)&local_f8);
      ...
      if (-1 < (int)param_2) {
         LAB_0010013c:uVar2 = ucase_toFullFolding_76_godot(param_2, local_100, 0);
         uVar2 = ~uVar2 >> 0x1f;
         goto LAB_00100151;
      }
   }
   uVar2 = 0;
   LAB_00100151:icu_76_godot::UnicodeString::~UnicodeString((UnicodeString*)&local_f8);
   if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return uVar2;
}/* isPOSIX_xdigit(BinaryProperty const&, int, UProperty) */void isPOSIX_xdigit(undefined8 param_1, undefined4 param_2) {
   u_isxdigit_76_godot(param_2);
   return;
}/* isPOSIX_print(BinaryProperty const&, int, UProperty) */void isPOSIX_print(undefined8 param_1, undefined4 param_2) {
   u_isprintPOSIX_76_godot(param_2);
   return;
}/* isPOSIX_graph(BinaryProperty const&, int, UProperty) */void isPOSIX_graph(undefined8 param_1, undefined4 param_2) {
   u_isgraphPOSIX_76_godot(param_2);
   return;
}/* isPOSIX_blank(BinaryProperty const&, int, UProperty) */void isPOSIX_blank(undefined8 param_1, undefined4 param_2) {
   u_isblank_76_godot(param_2);
   return;
}/* isPOSIX_alnum(BinaryProperty const&, int, UProperty) */void isPOSIX_alnum(undefined8 param_1, undefined4 param_2) {
   u_isalnumPOSIX_76_godot(param_2);
   return;
}/* isCanonSegmentStarter(BinaryProperty const&, int, UProperty) */bool isCanonSegmentStarter(void) {
   char cVar1;
   UErrorCode *pUVar2;
   long in_FS_OFFSET;
   bool bVar3;
   ...
   bVar3 = false;
   LAB_0010039d:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return bVar3;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* isNormInert(BinaryProperty const&, int, UProperty) */ulong isNormInert(undefined8 param_1, undefined4 param_2, int param_3) {
   char cVar1;
   long *plVar2;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* caseBinaryPropertyContains(BinaryProperty const&, int, UProperty) */void caseBinaryPropertyContains(undefined8 param_1, undefined4 param_2, undefined4 param_3) {
   ucase_hasBinaryProperty_76_godot(param_2, param_3);
   return;
}/* isJoinControl(BinaryProperty const&, int, UProperty) */void isJoinControl(undefined8 param_1, undefined4 param_2) {
   ubidi_isJoinControl_76_godot(param_2);
   return;
}/* isMirrored(BinaryProperty const&, int, UProperty) */void isMirrored(undefined8 param_1, undefined4 param_2) {
   ubidi_isMirrored_76_godot(param_2);
   return;
}/* isBidiControl(BinaryProperty const&, int, UProperty) */void isBidiControl(undefined8 param_1, undefined4 param_2) {
   ubidi_isBidiControl_76_godot(param_2);
   return;
}/* defaultContains(BinaryProperty const&, int, UProperty) */undefined4 defaultContains(undefined4 *param_1, undefined4 param_2) {
   uint uVar1;
   uVar1 = u_getUnicodeProperties_76_godot(param_2, *param_1);
   return CONCAT31(( int3 )(( uVar1 & param_1[1] ) >> 8), ( uVar1 & param_1[1] ) != 0);
}/* getIDStatusValue(IntProperty const&, int, UProperty) */bool getIDStatusValue(undefined8 param_1, undefined4 param_2) {
   uint uVar1;
   uVar1 = u_getUnicodeProperties_76_godot(param_2, 2);
   return 0xefffffff < uVar1;
}/* getHangulSyllableType(IntProperty const&, int, UProperty) */undefined4 getHangulSyllableType(undefined8 param_1, int param_2) {
   int iVar1;
   uint uVar2;
   if (0xffff < param_2) {
      return 0;
   ...
   return 0;
}/* defaultGetValue(IntProperty const&, int, UProperty) */int defaultGetValue(undefined4 *param_1, undefined4 param_2) {
   uint uVar1;
   uVar1 = u_getUnicodeProperties_76_godot(param_2, *param_1);
   return (int)( uVar1 & param_1[1] ) >> ( (byte)param_1[2] & 0x1f );
}/* getGeneralCategory(IntProperty const&, int, UProperty) */int getGeneralCategory(undefined8 param_1, undefined4 param_2) {
   char cVar1;
   cVar1 = u_charType_76_godot(param_2);
   return (int)cVar1;
}/* (anonymous namespace)::ulayout_load(UErrorCode&) */void (anonymous_namespace)::ulayout_load(UErrorCode *param_1) {
   int iVar1;
   int iVar2;
   uint uVar3;
   int *piVar4;
   ...
   if (0xb < iVar1) {
      ...
      iVar5 = iVar2 + iVar1 * -4;
      if (0xf < iVar5) {
         gInpcTrie = ucptrie_openFromBinary_76_godot(0xffffffff, 0xffffffff, (long)( iVar1 * 4 ) + (long)piVar4, iVar5, 0, param_1);
      }
      iVar1 = piVar4[2];
      if (0xf < iVar1 - iVar2) {
         gInscTrie = ucptrie_openFromBinary_76_godot(0xffffffff, 0xffffffff, (long)iVar2 + (long)piVar4, iVar1 - iVar2, 0, param_1);
      }
      if (0xf < piVar4[3] - iVar1) {
         gVoTrie = ucptrie_openFromBinary_76_godot(0xffffffff, 0xffffffff, (long)iVar1 + (long)piVar4, piVar4[3] - iVar1, 0, param_1);
      }
      uVar3 = piVar4[9];
   ...
   *(undefined4*)param_1 = 3;
   return;
}/* (anonymous namespace)::uprops_cleanup() */undefined8(anonymous_namespace) {
   ...
   UNLOCK();
   return 1;
}/* getBiDiPairedBracketType(IntProperty const&, int, UProperty) */void getBiDiPairedBracketType(undefined8 param_1, undefined4 param_2) {
   ubidi_getPairedBracketType_76_godot(param_2);
   return;
}/* getTrailCombiningClass(IntProperty const&, int, UProperty) */undefined1 getTrailCombiningClass(undefined8 param_1, undefined4 param_2) {
   undefined1 uVar1;
   uVar1 = unorm_getFCD16_76_godot(param_2);
   return uVar1;
}/* getLeadCombiningClass(IntProperty const&, int, UProperty) */undefined1 getLeadCombiningClass(undefined8 param_1, undefined4 param_2) {
   undefined1 extraout_AH;
   unorm_getFCD16_76_godot(param_2);
   return extraout_AH;
}/* getNormQuickCheck(IntProperty const&, int, UProperty) */void getNormQuickCheck(undefined8 param_1, undefined4 param_2, int param_3) {
   unorm_getQuickCheck_76_godot(param_2, param_3 + -0x100a);
   return;
}/* scriptGetMaxValue(IntProperty const&, UProperty) */uint scriptGetMaxValue(void) {
   uint uVar1;
   uVar1 = uprv_getMaxValues_76_godot(0);
   return uVar1 & 0x3ff;
}/* defaultGetMaxValue(IntProperty const&, UProperty) */uint defaultGetMaxValue(undefined4 *param_1) {
   uint uVar1;
   uVar1 = uprv_getMaxValues_76_godot(*param_1);
   return ( uVar1 & param_1[1] ) >> ( (byte)param_1[2] & 0x1f );
}/* blockGetMaxValue(IntProperty const&, UProperty) */uint blockGetMaxValue(void) {
   uint uVar1;
   uVar1 = uprv_getMaxValues_76_godot(0xc);
   return uVar1 & 0x3ff;
}/* getScript(IntProperty const&, int, UProperty) */void getScript(undefined8 param_1, undefined4 param_2) {
   long in_FS_OFFSET;
   undefined4 local_14;
   long local_10;
   local_10 = *(long*)( in_FS_OFFSET + 0x28 );
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* getNumericType(IntProperty const&, int, UProperty) */char getNumericType(undefined8 param_1, undefined4 param_2) {
   uint uVar1;
   char cVar2;
   uVar1 = u_getMainProperties_76_godot(param_2);
   cVar2 = '\0';
   uVar1 = uVar1 >> 6;
   if (( uVar1 != 0 ) && ( cVar2 = 10 < uVar1 )) {
      cVar2 = ( 0x14 < uVar1 ) + '\x02';
   }
   return cVar2;
}/* getJoiningType(IntProperty const&, int, UProperty) */void getJoiningType(undefined8 param_1, undefined4 param_2) {
   ubidi_getJoiningType_76_godot(param_2);
   return;
}/* getJoiningGroup(IntProperty const&, int, UProperty) */void getJoiningGroup(undefined8 param_1, undefined4 param_2) {
   ubidi_getJoiningGroup_76_godot(param_2);
   return;
}/* getCombiningClass(IntProperty const&, int, UProperty) */undefined1 getCombiningClass(undefined8 param_1, undefined4 param_2) {
   undefined1 uVar1;
   uVar1 = u_getCombiningClass_76_godot(param_2);
   return uVar1;
}/* getBlock(IntProperty const&, int, UProperty) */void getBlock(undefined8 param_1, undefined4 param_2) {
   ublock_getCode_76_godot(param_2);
   return;
}/* biDiGetMaxValue(IntProperty const&, UProperty) */void biDiGetMaxValue(undefined8 param_1, undefined4 param_2) {
   ubidi_getMaxValue_76_godot(param_2);
   return;
}/* getBiDiClass(IntProperty const&, int, UProperty) */void getBiDiClass(undefined8 param_1, undefined4 param_2) {
   u_charDirection_76_godot(param_2);
   return;
}/* isIDCompatMathContinue(BinaryProperty const&, int, UProperty) */undefined8 isIDCompatMathContinue(undefined8 param_1, int param_2) {
   int *piVar1;
   undefined8 uVar2;
   ...
   if (0x2201 < param_2) {
      ...
      LAB_001009e0:uVar2 = 1;
   }
   return uVar2;
}/* isIDCompatMathStart(BinaryProperty const&, int, UProperty) */undefined8 isIDCompatMathStart(undefined8 param_1, int param_2) {
   int *piVar1;
   undefined8 uVar2;
   uVar2 = 0;
   if (0x2201 < param_2) {
   ...
   return uVar2;
}/* getInPC(IntProperty const&, int, UProperty) */undefined8 getInPC(undefined8 param_1, undefined4 param_2) {
   char cVar1;
   undefined8 uVar2;
   long in_FS_OFFSET;
   int local_24;
   ...
   if ((anonymous_namespace)::gLayoutInitOnce == 2) {
      LAB_00100a5f:if (DAT_00101c44 < 1) goto LAB_00100ab7;
   } else {
      ...
      LAB_00100ab7:if (( local_24 < 1 ) && ( (anonymous_namespace)::gInpcTrie != 0 )) {
   ...
   LAB_00100ae8:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* getInSC(IntProperty const&, int, UProperty) */undefined8 getInSC(undefined8 param_1, undefined4 param_2) {
   char cVar1;
   undefined8 uVar2;
   long in_FS_OFFSET;
   int local_24;
   ...
   local_24 = 0;
   if ((anonymous_namespace)::gLayoutInitOnce == 2) {
      LAB_00100b1f:if (DAT_00101c44 < 1) goto LAB_00100b77;
   } else {
      cVar1 = icu_76_godot::umtx_initImplPreInit((UInitOnce*)&(anonymous_namespace)::gLayoutInitOnce);
      ...
      DAT_00101c44 = local_24;
      icu_76_godot::umtx_initImplPostInit((UInitOnce*)&(anonymous_namespace)::gLayoutInitOnce);
      LAB_00100b77:if (( local_24 < 1 ) && ( (anonymous_namespace)::gInscTrie != 0 )) {
         if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
   ...
   LAB_00100ba8:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* getVo(IntProperty const&, int, UProperty) */undefined8 getVo(undefined8 param_1, undefined4 param_2) {
   char cVar1;
   undefined8 uVar2;
   long in_FS_OFFSET;
   int local_24;
   ...
   local_24 = 0;
   if ((anonymous_namespace)::gLayoutInitOnce == 2) {
      LAB_00100bdf:if (DAT_00101c44 < 1) goto LAB_00100c37;
   } else {
      cVar1 = icu_76_godot::umtx_initImplPreInit((UInitOnce*)&(anonymous_namespace)::gLayoutInitOnce);
      ...
      DAT_00101c44 = local_24;
      icu_76_godot::umtx_initImplPostInit((UInitOnce*)&(anonymous_namespace)::gLayoutInitOnce);
      LAB_00100c37:if (( local_24 < 1 ) && ( (anonymous_namespace)::gVoTrie != 0 )) {
         if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
   ...
   LAB_00100c68:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* layoutGetMaxValue(IntProperty const&, UProperty) */undefined4 layoutGetMaxValue(undefined8 param_1, int param_2) {
   char cVar1;
   undefined4 uVar2;
   long in_FS_OFFSET;
   int local_24;
   ...
   local_20 = *(long*)( in_FS_OFFSET + 0x28 );
   local_24 = 0;
   if (( (anonymous_namespace)::gLayoutInitOnce == 2 ) || ( cVar1 = icu_76_godot::umtx_initImplPreInit((UInitOnce*)&(anonymous_namespace)::gLayoutInitOnce) ),cVar1 == '\0') {
      if (DAT_00101c44 < 1) goto LAB_00100cff;
   } else {
      (anonymous_namespace)::ulayout_load((UErrorCode*)&local_24);
      DAT_00101c44 = local_24;
      icu_76_godot::umtx_initImplPostInit((UInitOnce*)&(anonymous_namespace)::gLayoutInitOnce);
      LAB_00100cff:if (local_24 < 1) {
   ...
   uVar2 = 0;
   LAB_00100cb0:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return uVar2;
}/* hasFullCompositionExclusion(BinaryProperty const&, int, UProperty) */undefined8 hasFullCompositionExclusion(undefined8 param_1, uint param_2) {
   long *plVar1;
   long lVar2;
   int iVar3;
   long lVar4;
   ...
   if (local_24 < 1) {
      ...
      if (( param_2 & 0xfffffc00 ) != 0xd800) {
         ...
         lVar2 = plVar1[1];
         if (param_2 < 0x10000) {
            lVar6 = (long)(int)( ( uint ) * (ushort*)( *plVar1 + (long)( (int)param_2 >> 6 ) * 2 ) + ( param_2 & 0x3f ) ) * 2;
   ...
   uVar7 = 0;
   LAB_00100d8a:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar7;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* changesWhenNFKC_Casefolded(BinaryProperty const&, int, UProperty) */ushort changesWhenNFKC_Casefolded(undefined8 param_1, int param_2) {
   char cVar1;
   undefined8 uVar2;
   long lVar3;
   ushort uVar4;
   ...
   if (local_fc < 1) {
      ...
      if (cVar1 != '\0') {
         ...
         icu_76_godot::Normalizer2Impl::compose(uVar2, puVar6, puVar6 + lVar3 * 2, 0, 1, &local_f8, (UErrorCode*)&local_fc);
      }
      if (local_e8 != 0) {
   ...
   return uVar4;
}/* WARNING: Removing unreachable block (ram,0x00100428) */uint u_hasBinaryProperty_76_godot(uint param_1, uint param_2) {
   long lVar1;
   char cVar2;
   ushort uVar3;
   uint uVar4;
...
LAB_001009e0:
   ...
   if (iStack_104 < 1) {
      ...
      if (cVar2 != '\0') {
         ...
         if ((short)uStack_f0 < 0) {
            ...
            if (sVar16 == 1) {
               LAB_00100298:puVar17 = (ushort*)( (long)&uStack_f0 + 2 );
            ...
            iVar6 = (int)sVar16;
            if (sVar16 < 3) {
               LAB_00100265:param_1 = icu_76_godot::UnicodeString::char32At((int)&pcStack_f8);
      ...
      if (-1 < (int)param_1) {
         LAB_0010013c:uVar4 = ucase_toFullFolding_76_godot(param_1, auStack_100, 0);
         uVar4 = ~uVar4 >> 0x1f;
         goto LAB_00100151;
      }
   }
   uVar4 = 0;
   LAB_00100151:icu_76_godot::UnicodeString::~UnicodeString((UnicodeString*)&pcStack_f8);
   if (puStack_30 != (undefined*)*(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   ...
   return;
}/* WARNING: Removing unreachable block (ram,0x00100428) */uint u_stringHasBinaryProperty_76_godot(ushort *param_1, int param_2, uint param_3) {
   long lVar1;
   char cVar2;
   ushort uVar3;
   uint uVar4;
   ...
   if (param_2 != 1) {
      if (param_2 == 2) {
         if (( ( *param_1 & 0xfc00 ) != 0xd800 ) || ( uVar16 = ( uint ) * param_1 * 0x400 + -0x35fdc00 + (uint)param_1[1](param_1[1] & 0xfc00) != 0xdc00 )) goto LAB_00101122;
      } else {
         if (( -1 < param_2 ) || ( uVar3 = uVar3 == 0 )) {
            LAB_00101122:if (6 < param_3 - 0x41) {
               return 0;
            }
...
code_r0x00100074:
   ...
   code_r0x001000c4:puStack_30 = *(undefined**)( in_FS_OFFSET + 0x28 );
   uStack_f0 = (UnicodeString*)CONCAT62(uStack_f0._2_6_, 2);
   iStack_104 = 0;
   pcStack_f8 = ucase_toFullFolding_76_godot;
   plVar8 = (long*)icu_76_godot::Normalizer2::getNFCInstance((UErrorCode*)&iStack_104);
   if (iStack_104 < 1) {
      ...
      if (cVar2 != '\0') {
         ...
         if ((short)uStack_f0 < 0) {
            ...
            if (sVar17 == 1) {
               LAB_00100298:puVar18 = (ushort*)( (long)&uStack_f0 + 2 );
               if (( (ulong)uStack_f0 & 2 ) == 0) {
                  puVar18 = puStack_e0;
               }
               uVar4 = ( uint ) * puVar18;
            ...
            iVar6 = (int)sVar17;
            if (sVar17 < 3) {
               LAB_00100265:uVar4 = icu_76_godot::UnicodeString::char32At((int)&pcStack_f8);
      ...
      if (-1 < (int)uVar4) {
         LAB_0010013c:uVar4 = ucase_toFullFolding_76_godot(uVar4, auStack_100, 0);
         uVar4 = ~uVar4 >> 0x1f;
         goto LAB_00100151;
      }
   }
   ...
   if ((int)param_2 < 0x1000) {
      uVar5 = 0;
      if (param_2 < 0x4c) {
         cVar1 = ( *(code*)( &switchD_001010a8::switchdataD_00102168 )[(long)(int)param_2 * 2] )(&binProps + (long)(int)param_2 * 2, param_1);
...
LAB_00100c68:
   ...
   if (( (anonymous_namespace)::gLayoutInitOnce == 2 ) || ( cVar1 = icu_76_godot::umtx_initImplPreInit((UInitOnce*)&(anonymous_namespace)::gLayoutInitOnce) ),cVar1 == '\0') {
      ...
      DAT_00101c44 = iStack_24;
      icu_76_godot::umtx_initImplPostInit((UInitOnce*)&(anonymous_namespace)::gLayoutInitOnce);
      LAB_00100ab7:if (( iStack_24 < 1 ) && ( (anonymous_namespace)::gInpcTrie != 0 )) {
         if (puStack_20 == (undefined*)*(long*)( in_FS_OFFSET + 0x28 )) {
   ...
   return 0xffffffff;
   code_r0x00100c74:lStack_20 = *(long*)( in_FS_OFFSET + 0x28 );
   iStack_24 = 0;
   if ((anonymous_namespace)::gLayoutInitOnce == 2) {
      LAB_00100c9f:if (DAT_00101c44 < 1) goto LAB_00100cff;
   } else {
      cVar1 = icu_76_godot::umtx_initImplPreInit((UInitOnce*)&(anonymous_namespace)::gLayoutInitOnce);
   ...
   uVar3 = 0;
   LAB_00100cb0:if (lStack_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar3;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   if ((anonymous_namespace)::gLayoutInitOnce != 2) {
      ...
      if (cVar3 != '\0') {
         ...
         uStack_40 = 0x1014de;
         uVar5 = icu_76_godot::umtx_initImplPostInit((UInitOnce*)&(anonymous_namespace)::gLayoutInitOnce);
         goto LAB_001014e3;
      }
   }
   ...
   if (( (char)bVar1 < '\0' ) && ( uVar3 = uVar2 < 0x30 )) {
      return ( ulong )(( bVar1 & uVar2 ) != 0);
   }
   return uVar3 & 0xffffffff;
}/* WARNING: Type propagation algorithm not settling */int u_getIDTypes_76_godot(undefined8 param_1, uint *param_2, int param_3, int *param_4) {
   byte bVar1;
   uint uVar2;
   uint uVar3;
   int iVar4;
      ...
      if (param_3 != 0) {
        ...
        *param_4 = 3;
        ...
        uVar3 = 0xb;
         ...
         LAB_00101685:*param_2 = uVar3;
         return 1;
      }
      LAB_001016b0:*param_4 = 0xf;
      return 1;
   }
   if (uVar2 >> 0x1a == 0) {
   ...
   if (( uVar3 & 1 ) == 0) {
      ...
      iVar4 = iVar7;
      if (( uVar6 != 0 ) && ( iVar4 = iVar7 < param_3 )) {
         param_2[iVar7] = 6;
      }
         ...
         if (*(int*)param_4 < 1) {
            ...
            if (iVar5 < 0) {
               ...
               if (( param_1 & 0xfffffc00 ) == 0xd800) {
                  ...
                  lVar2 = plVar1[1];
                  if (param_1 < 0x10000) {
                     lVar10 = (long)(int)( ( uint ) * (ushort*)( *plVar1 + (long)( (int)param_1 >> 6 ) * 2 ) + ( param_1 & 0x3f ) ) * 2;
                  } else if (param_1 < 0x110000) {
                  ...
                  if (( *(ushort*)( lVar9 + 0x12 ) <= uVar4 ) && ( uVar4 < 0xfe02 )) {
                     LAB_00101b61:if (uVar4 < *(ushort*)( lVar9 + 0x1e )) {
               ...
               LAB_00101900:local_170 = (UnicodeString*)&local_148;
               local_108 = ucase_toFullFolding_76_godot;
               local_100 = 2;
               ( **(code**)( *(long*)pNVar7 + 0x18 ) )(pNVar7, local_170, (UnicodeString*)&local_108, param_4);
               ...
               if (*(int*)param_4 < 1) {
                  ...
                  local_150 = param_2;
                  uVar6 = icu_76_godot::UnicodeString::extract((UnicodeString*)&local_88, &local_150, param_3, param_4);
               } else {
                  LAB_00101993:uVar6 = u_terminateUChars_76_godot(param_2, param_3, 0, param_4);
               }
   ...
   uVar6 = 0;
   LAB_00101866:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return uVar6;

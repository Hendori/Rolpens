...
/* (anonymous namespace)::Intersect12(manifold::Manifold::Impl const&, manifold::Manifold::Impl
   ...
   4> > const&, manifold::SparseIndices&, bool) */_anonymous_namespace_ * __thiscall(anonymous_namespace)(_anonymous_namespace_ * this, Impl * param_1, Impl * param_2, Vec * param_3, SparseIndices * param_4, Vec * param_5, SparseIndices * param_6, Vec * param_7, Vec * param_8, SparseIndices * param_9, bool, param_10) * puVar1 ;uint uVar2int iVar3long *__ptr_anonymous_namespace_ *p_Var4long lVar5long lVar6long lVar7long lVar8long lVar9vec *pvVar10long lVar11undefined8 uVar12uint uVar13undefined8 uVar14double dVar15ulong *puVar16long lVar17int *piVar18ulong *puVar19int *piVar20void *pvVar21ulong *puVar22long *plVar23int iVar24vec *pvVar25int iVar26ulong uVar27long lVar28uint uVar29size_t __sizesize_t sVar30uint uVar31ulong uVar32ulong uVar33size_t __size_00int iVar34ulong uVar35ulong uVar36ulong uVar37long in_FS_OFFSETbool bVar38ulong *local_1e8long local_1e0Vec *local_188int *local_118ulong local_110ulong uStack_108ulong *local_f8ulong local_f0ulong local_e8int *local_d8ulong uStack_d0ulong uStack_c8ulong uStack_c0ulong local_b8undefined4 local_b0undefined1 local_ac[4]undefined1 local_a8[16]undefined1 local_98[16]undefined1 local_88[16]undefined1 local_78[16]undefined1 local_68[16]undefined1 local_58[16]long local_40uVar31 = (uint)param_10;local_40 = *(long*)( in_FS_OFFSET + 0x28 );local_118 = (int*)0x0;uStack_108 = 0;uVar33 = *(ulong*)( param_9 + 8 ) >> 3;if (uVar33 == 0) {
   local_110 = 0;
   local_f8 = (ulong*)0x0;
   local_e8 = 0;
   local_f0 = 0;
...
local_188 = (Vec*)&local_d8;manifold::Permute<linalg::vec<double,3>,int>((Vec*)&local_f8, local_188);manifold::Permute<int,int>((Vec*)&local_118, local_188);plVar23 = (long*)0x0;__ptr = *(long**)param_9;*(undefined1(*) [16])( param_9 + 8 ) = (undefined1[16])0x0;*(undefined8*)param_9 = 0;if (__size_00 != 0) {
   pvVar21 = malloc(__size_00);
   *(void**)param_9 = pvVar21;
   *(size_t*)( param_9 + 0x10 ) = __size_00;
   plVar23 = (long*)memset(pvVar21, 0xff, __size_00);
}
piVar18 = local_d8;*(size_t*)( param_9 + 8 ) = __size_00;manifold::gather<int*,long*,long*>(local_d8, local_d8 + uStack_d0, __ptr, plVar23);if (__ptr != (long*)0x0) {
   free(__ptr);
   piVar18 = local_d8;
}
if (piVar18 != (int*)0x0) {
...
uVar33 = local_f0;puVar16 = local_f8;puVar22 = (ulong*)0x0;*(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;*(undefined8*)this = 0;if (local_f0 != 0) {
...
uVar32 = local_110;piVar18 = local_118;piVar20 = (int*)0x0;*(ulong*)( this + 8 ) = uVar33;*(ulong*)( this + 0x10 ) = uVar33;*(undefined1(*) [16])( this + 0x20 ) = (undefined1[16])0x0;*(ulong**)this = puVar22;*(undefined8*)( this + 0x18 ) = 0;if (local_110 == 0) {
...
free(piVar18);LAB_0010257a:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return this;}/* manifold::Boolean3::Boolean3(manifold::Manifold::Impl const&, manifold::Manifold::Impl const&,

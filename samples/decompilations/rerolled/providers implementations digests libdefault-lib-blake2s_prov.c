...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 ossl_blake2s_init(ulong *param_1, ulong *param_2) {
   ulong uVar1;
   ulong uVar2;
   ulong uVar3;
   ulong uVar4;
   ...
   for (uVar5 = ( ulong )(( (int)param_1 - (int)(undefined8*)( ( ulong )(param_1 + 5) & 0xfffffffffffffff8 ) ) + 0x80U >> 3); uVar5 != 0; uVar5 = uVar5 - 1) {
      *puVar6 = 0;
      puVar6 = puVar6 + 1;
   }
...
undefined8 ossl_blake2s_update(long param_1, void *param_2, ulong param_3) {
   ...
   LAB_0010173a:memcpy((void*)( lVar1 + lVar2 ), __src, param_3);
   *(long*)( param_1 + 0x70 ) = *(long*)( param_1 + 0x70 ) + param_3;
   return 1;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 ossl_blake2s_init_key(ulong *param_1, ulong *param_2, undefined8 param_3) {
   ulong uVar1;
   ulong uVar2;
   ulong uVar3;
   ulong uVar4;
...
undefined8 ossl_blake2s_final(undefined8 *param_1, undefined8 *param_2) {
   ...
   if (( param_2[0xf] & 3 ) == 0) {
      *(undefined4*)( param_2 + 5 ) = 0xffffffff;
      ...
      LAB_0010199c:if (~(ulong)param_2 + (long)puVar8 < 0xf) {
      ...
      *puVar8 = *param_2;
      ...
      if (( uVar7 & 3 ) != 0) {
         ...
         *(undefined4*)( (long)puVar8 + (ulong)uVar5 * 4 ) = *puVar2;
         if (( (int)( uVar5 + 1 ) < (int)uVar6 ) && ( *(undefined4*)( (long)puVar8 + lVar3 + 4 ) = puVar2[1] ),(int)( uVar5 + 2 ) < (int)uVar6) {
            *(undefined4*)( puVar8 + 3 ) = puVar2[2];
         }

      }

      LAB_00101a06:if (param_1 == __src) goto LAB_00101a27;
   }
 else {
      *(undefined4*)( param_2 + 5 ) = 0xffffffff;
      memset((void*)( param_2[0xe] + (long)( param_2 + 6 ) ), 0, 0x40 - param_2[0xe]);
      ...
      if (0 < (int)uVar6) {
         ...
         LAB_00101aa7:*(undefined4*)puVar9 = *(undefined4*)param_2;
         __src = puVar9;
         if (( uVar6 != 1 ) && ( *(undefined4*)( (long)puVar9 + 4 ) = uVar6 == 3 )) {
            LAB_001019bd:*(undefined4*)( puVar9 + 1 ) = *(undefined4*)( param_2 + 1 );
            __src = puVar9;
            if (( ( 3 < (int)uVar6 ) && ( ( ( *(undefined4*)( (long)puVar9 + 0xc ) = *(undefined4*)( (long)param_2 + 0xc ) ),uVar6 != 4 && ( *(undefined4*)( puVar9 + 2 ) = *(undefined4*)( param_2 + 2 ) ),uVar6 != 5 ) ) && ( *(undefined4*)( (long)puVar9 + 0x14 ) = *(undefined4*)( (long)param_2 + 0x14 ) ),uVar6 != 6 )) {
   ...
   LAB_00101a27:OPENSSL_cleanse(param_2, 0x80);

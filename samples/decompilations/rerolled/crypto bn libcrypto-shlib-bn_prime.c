undefined1 *ossl_bn_get0_small_factors(void) {
   ...
   if (cb != (BN_GENCB*)0x0) {
      if (cb->ver != 1) {
         ...
         for (int i_1711 = 0; i_1711 < 2; i_1711++) {
   ...
   return 1;
}undefined4 ossl_bn_miller_rabin_is_prime(BIGNUM *param_1, int param_2, BN_CTX *param_3, BN_GENCB *param_4, int param_5, int *param_6) {
   int iVar1;
   int iVar2;
   int iVar3;
   BIGNUM *r;
   ...
   if (( ( ( ( a_02 != (BIGNUM*)0x0 ) && ( pBVar4 = BN_copy(a, param_1) ),pBVar4 != (BIGNUM*)0x0 ) ) && ( iVar1 = BN_sub_word(a, 1) ),iVar1 != 0 )) {
      iVar1 = 1;
      ...
      if (( iVar2 != 0 ) && ( local_80 = BN_MONT_CTX_new() ),local_80 != (BN_MONT_CTX*)0x0) {
         ...
         if (param_2 == 0) {
            ...
            LAB_00100295:local_58 = 0;
            do {
               iVar2 = BN_priv_rand_range_ex(a_02, a_00, 0, param_3);
               if (( iVar2 == 0 ) || ( iVar2 = iVar2 == 0 )) goto LAB_00100149;
               if (param_5 != 0) {
                  iVar2 = BN_gcd(r, a_02, param_1, param_3);
                  if (iVar2 == 0) goto LAB_00100149;
                  iVar2 = BN_is_one(r);
                  if (iVar2 != 0) goto LAB_00100320;
                  LAB_0010056e:param_5 = 1;
                  goto LAB_001003a5;
               }
               LAB_00100320:iVar2 = BN_mod_exp_mont(r_01, a_02, r_00, param_1, param_3, local_80);
               if (iVar2 == 0) goto LAB_00100149;
               iVar2 = BN_is_one(r_01);
               if (( iVar2 == 0 ) && ( iVar2 = iVar2 != 0 )) {
                  if (iVar1 == 1) {
                     LAB_00100492:pBVar4 = BN_copy(a_01, r_01);
                     if (( ( pBVar4 == (BIGNUM*)0x0 ) || ( iVar1 = BN_mod_mul(r_01, a_01, a_01, param_1, param_3) ),iVar1 == 0 )) goto LAB_00100149;
                     LAB_00100509:if (param_5 == 0) goto LAB_001003a5;
                     iVar1 = BN_sub_word(a_01, 1);
                     if (( iVar1 == 0 ) || ( iVar1 = iVar1 == 0 )) goto LAB_00100149;
                     param_5 = 2;
                     iVar1 = BN_is_one(r);
                  ...
                  while (true) {
                     ...
                     if (( pBVar4 == (BIGNUM*)0x0 ) || ( iVar3 = iVar3 == 0 )) goto LAB_00100149;
                     iVar3 = BN_cmp(r_01, a);
                     if (iVar3 == 0) break;
   ...
   return uVar5;
}ulong bn_is_prime_int(BIGNUM *param_1, undefined4 param_2, BN_CTX *param_3, int param_4, BN_GENCB *param_5) {
   int iVar1;
   int iVar2;
   BIGNUM *b;
   ulong uVar3;
   ...
   if (iVar1 < 1) {
      ...
      if (iVar1 == 0) {
         if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            uVar4 = 2;
            LAB_001006c9:uVar4 = BN_is_word(param_1, uVar4);
            return uVar4;
         }
         goto LAB_001007f0;
      }
      ...
      if (iVar1 == 0) {
         if (param_4 != 0) {
            iVar2 = BN_num_bits(param_1);
            iVar1 = 0x40;
            if (( ( 0x200 < iVar2 ) && ( iVar1 = 0x80 ),0x400 < iVar2 )) {
               iVar1 = 0x400;
               if (0x1000 < iVar2) {
                  iVar1 = 0x800;
               }
   ...
   LAB_0010068a:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar4;
   }
   LAB_001007f0:/* WARNING: Subroutine does not return */__stack_chk_fail();
}undefined8 BN_generate_prime_ex2(BIGNUM *param_1, int param_2, int param_3, BIGNUM *param_4, BIGNUM *param_5, BN_GENCB *param_6, BN_CTX *param_7) {
   uint uVar1;
   int iVar2;
   int iVar3;
   int iVar4;
   ...
   if (param_2 < 0x801) {
      if (param_2 < 2) {
         ERR_new();
         uVar8 = 0x87;
         LAB_00101170:ERR_set_debug("crypto/bn/bn_prime.c", uVar8, "BN_generate_prime_ex2");
   ...
   if (r != (BIGNUM*)0x0) {
      ...
      if (bVar13) {
         ...
         LAB_00100b3b:do {
            ...
            if (( iVar2 == 0 ) || ( (bVar14&&(iVar2 = BN_set_bit(param_1, 1), iVar2 = = 0)) )) goto LAB_00100a94;
      ...
      if (rem != (BIGNUM*)0x0) {
         ...
         while (( ( iVar2 = BN_rand_ex(param_1, param_2, 0, 1, 0, param_7) ),iVar2 != 0 && ( iVar2 = BN_div((BIGNUM*)0x0, rem, param_1, param_4, param_7) ),iVar2 != 0 )) {
            if (param_5 == (BIGNUM*)0x0) {
               iVar2 = BN_add_word(param_1, ( -(ulong)!bVar14 & 0xfffffffffffffffe ) + 3);
            } else {
               iVar2 = BN_add(param_1, param_1, param_5);
            }
            if (( iVar2 == 0 ) || ( ( ( iVar2 = BN_num_bits(param_1) ),iVar2<param_2 || ( uVar5 = BN_get_word(param_1) ),uVar5 < ( -(ulong)!bVar14 & 0xfffffffffffffffe ) + 5 ) ) && ( iVar2 = iVar2 == 0 )) break;
            puVar12 = (ushort*)( primes + 2 );
            puVar10 = (ushort*)( (long)ptr + 2 );
            do {
               uVar5 = BN_mod_word(param_1, ( ulong ) * puVar12);
   ...
   LAB_00100a94:uVar8 = 0;
   goto LAB_00100a96;
   LAB_00100d8c:iVar2 = BN_add_word(param_1, uVar5);
   if (iVar2 == 0) goto LAB_00100a94;
   iVar2 = BN_num_bits(param_1);
   if (param_2 == iVar2) goto LAB_00100f93;
   goto LAB_00100b3b;
   LAB_00100f68:iVar2 = BN_add_word(param_1, uVar5);
   if (iVar2 == 0) {
      LAB_00100a87:BN_CTX_end(param_7);
      goto LAB_00100a94;
   }
   BN_CTX_end(param_7);
   LAB_00100f93:iVar2 = local_a8 + 1;
   ...
   LAB_001011b8:uVar8 = 1;
   LAB_00100a96:CRYPTO_free(ptr);
   BN_CTX_end(param_7);
   return uVar8;
   ...
   return iVar1;
}ulong ossl_bn_check_generated_prime(BIGNUM *param_1, undefined4 param_2, BN_CTX *param_3, BN_GENCB *param_4) {
   int iVar1;
   int iVar2;
   uint uVar3;
   BIGNUM *b;
   ...
   if (iVar1 < 1) {
      ...
      if (iVar1 == 0) {
         if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            uVar5 = 2;
            LAB_001013c9:uVar5 = BN_is_word(param_1, uVar5);
            return uVar5;
         }
         goto LAB_00101499;
      }
      ...
      if (iVar1 == 0) {
         ...
         if (iVar1 == 0) {
            LAB_0010137b:uVar5 = 0xffffffff;
         } else {
            c = (BN_CTX*)0x0;
            pBVar6 = c;
            if (( param_3 == (BN_CTX*)0x0 ) && ( param_3 = BN_CTX_new() ),pBVar6 = param_3,param_3 == (BN_CTX*)0x0) {
               uVar3 = 0xffffffff;
            } else {
   ...
   LAB_00101499:/* WARNING: Subroutine does not return */__stack_chk_fail();
   ...
   if (iVar1 < 1) {
      ...
      if (iVar1 == 0) {
         if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            uVar5 = 2;
            LAB_001015b9:uVar5 = BN_is_word(param_1, uVar5);
            return uVar5;
         }
         goto LAB_001016e0;
      }
      ...
      if (iVar1 == 0) {
         if (param_4 != 0) {
            ...
            iVar1 = 0x40;
            if (( ( 0x200 < iVar3 ) && ( iVar1 = 0x80 ),0x400 < iVar3 )) {
               iVar1 = 0x400;
               if (0x1000 < iVar3) {
                  iVar1 = 0x800;
               }
   ...
   LAB_0010157a:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar5;
   }
   LAB_001016e0:/* WARNING: Subroutine does not return */__stack_chk_fail();

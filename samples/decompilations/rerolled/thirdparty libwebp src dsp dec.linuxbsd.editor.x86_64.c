void TransformOne_C(ulong *param_1, byte *param_2) {
   ...
   local_28 = CONCAT44(( auVar34._12_4_ - auVar15._12_4_ ) + iVar25, auVar15._12_4_ + auVar34._12_4_ + iVar12);
   local_20 = CONCAT44(( auVar15._12_4_ + auVar34._12_4_ ) - iVar12, ( auVar34._12_4_ - auVar15._12_4_ ) - iVar25);
   do {
      iVar12 = piVar10[0xc];
      iVar13 = piVar10[4];
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void TM8uv_C(long param_1) {
   byte bVar1;
   byte bVar2;
   long lVar3;
   long lVar4;
   ...
   do {
      ...
      lVar4 = 0;
      do {
         *(undefined1*)( lVar5 + lVar4 ) = *(undefined1*)( lVar3 + ( (ulong)bVar2 - (ulong)bVar1 ) + ( ulong ) * (byte*)( param_1 + -0x20 + lVar4 ) );
         lVar4 = lVar4 + 1;
      }
 while ( lVar4 != 8 );
      lVar5 = lVar5 + 0x20;
...
void VR4_C(undefined4 *param_1) {
   ...
   *(char*)( param_1 + 0x18 ) = (char)( (int)( uVar7 + 2 + ( uint ) * (byte*)( (long)param_1 + 0x3f ) + ( uint ) * (byte*)( (long)param_1 + 0x1f ) * 2 ) >> 2 );
   *param_1 = CONCAT13(uVar11, CONCAT12(uVar10, CONCAT11(uVar9, uVar8)));
   param_1[0x10] = ( ( ( uVar4 + uVar6 + 1 & 0x1fe ) << 7 | (int)( uVar5 + uVar4 + 1 ) >> 1 & 0xffU ) << 8 | (int)( uVar3 + uVar5 + 1 ) >> 1 & 0xffU ) << 8 | (int)( uVar3 + 2 + ( uint ) * (byte*)( (long)param_1 + 0x1f ) + uVar7 * 2 ) >> 2 & 0xffU;
...
void VL4_C(undefined1 *param_1) {
   ...
   *param_1 = (char)( iVar4 + 1 >> 1 );
   ...
   param_1[0x62] = uVar3;
   param_1[0x23] = uVar3;
   *(uint*)( param_1 + 0x40 ) = ( ( ( (byte)param_1[-0x1a] + 2 + uVar8 + uVar7 * 2 ) * 0x40 & 0xff00 | uVar6 & 0xff ) << 8 | uVar5 & 0xff ) << 8 | uVar2 & 0xff;
...
void HU4_C(uint *param_1) {
   ...
   *param_1 = ( ( uVar8 << 8 | uVar6 ) << 8 | (int)( bVar2 + 2 + iVar4 + (uint)bVar1 ) >> 2 & 0xffU ) << 8 | iVar4 + 1 >> 1 & 0xffU;
...
void HD4_C(uint *param_1) {
   ...
   *param_1 = ( ( ( uVar5 + ( uint ) * (byte*)( (long)param_1 + -0x1f ) * 2 + 2 + ( uint ) * (byte*)( (long)param_1 + -0x1e ) & 0x3fc ) << 6 | (int)( *(byte*)( (long)param_1 + -0x1f ) + 2 + (uint)bVar2 + uVar5 * 2 ) >> 2 & 0xffU ) << 8 | uVar6 ) << 8 | uVar11;
   ...
   param_1[0x18] = ( ( uVar5 << 8 | uVar9 ) << 8 | (int)( bVar1 + 2 + iVar10 + (uint)bVar3 ) >> 2 & 0xffU ) << 8 | iVar10 + 1 >> 1 & 0xffU;
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void FilterLoop26_C(byte *param_1, int param_2, int param_3, int param_4, int param_5, int param_6, int param_7) {
   long lVar1;
   byte bVar2;
   byte bVar3;
   byte bVar4;
   ...
   do {
      ...
      if ((int)( ( uint ) * (byte*)( lVar9 + lVar16 ) + ( uint ) * (byte*)( lVar9 + (int)( uVar17 - bVar2 ) ) * 4 ) <= param_5 * 2 + 1) {
         bVar4 = pbVar18[lVar1];
         if (( ( (int)( uint ) * (byte*)( lVar9 + (int)( (uint)param_1[lVar1] - (uint)bVar4 ) ) <= param_6 ) && ( (int)( uint ) * (byte*)( lVar9 + (int)( (uint)bVar4 - (uint)param_1[lVar13 * -2] ) ) <= param_6 ) ) && ( uVar10 = ( uint ) * (byte*)( lVar9 + (int)( uVar19 - *pbVar14 ) ) ),(int)uVar10 <= param_6) {
            bVar5 = param_1[param_2 * 2];
            if (( (int)( uint ) * (byte*)( lVar9 + (int)( (uint)param_1[param_2 * 3] - (uint)bVar5 ) ) <= param_6 ) && ( (int)( uint ) * (byte*)( lVar9 + (int)( (uint)bVar5 - (uint)bVar3 ) ) <= param_6 )) {
               ...
               if ((int)(uint)bVar6 <= param_6) {
                  ...
                  if (( param_7 < (int)uVar10 ) || ( param_7 < (int)(uint)bVar6 )) {
                     ...
                     *pbVar14 = *(byte*)( lVar8 + (int)( (int)*(char*)( _VP8ksclip2 + ( iVar11 + 3 >> 3 ) ) + uVar17 ) );
...
undefined8 VFilter16_C(undefined8 param_1, undefined8 param_2, undefined4 param_3, undefined4 param_4, undefined8 param_5) {
   FilterLoop26_C(param_1, param_2, 1, 0x10, param_3, param_4);
   return param_5;
}
undefined1[16];VFilter8_C(undefined8 param_1, undefined8 param_2, undefined4 param_3, undefined4 param_4, undefined4 param_5, ulong param_6) {
...
undefined1[16];HFilter8_C(undefined8 param_1, undefined8 param_2, ulong param_3, undefined4 param_4, undefined4 param_5, ulong param_6) {
   undefined1 auVar1[16];
...
void DC16_C(undefined4 *param_1) {
   ...
   do {
      lVar2 = lVar1 + 1;
      iVar3 = iVar3 + ( uint ) * (byte*)( (long)param_1 + lVar1 * 0x20 + -1 ) + ( uint ) * (byte*)( (long)param_1 + lVar1 + -0x20 );
      lVar1 = lVar2;
   }
 while ( lVar2 != 0x10 );
   uVar6 = ( undefined1 )(iVar3 >> 5);
   uVar7 = CONCAT11(uVar6, uVar6);
...
void DC4_C(int *param_1) {
   ...
   do {
      lVar3 = lVar2 + 1;
      uVar4 = uVar4 + ( uint ) * (byte*)( (long)param_1 + lVar2 * 0x20 + -1 ) + ( uint ) * (byte*)( (long)param_1 + lVar2 + -0x20 );
      lVar2 = lVar3;
   }
 while ( lVar3 != 4 );
   piVar1 = param_1 + 0x20;
...
void DC8uv_C(long *param_1) {
   ...
   do {
      lVar1 = lVar3 + 1;
      iVar2 = iVar2 + ( uint ) * (byte*)( (long)param_1 + lVar3 * 0x20 + -1 ) + ( uint ) * (byte*)( (long)param_1 + lVar3 + -0x20 );
      lVar3 = lVar1;
   }
 while ( lVar1 != 8 );
   lVar3 = ( ulong )(iVar2 >> 4 & 0xff) * 0x101010101010101;
   plVar4 = param_1;
   do {
      *plVar4 = lVar3;
      plVar5 = plVar4 + 8;
...
void VE4_C(undefined4 *param_1) {
   ...
   auVar34[0xe] = bVar40;
   auVar34[0xf] = 0;
   auVar17 = psllw(ZEXT716(CONCAT16(bVar40, (uint6)CONCAT14(bVar37, CONCAT22((ushort)bVar36 + _LC1._2_2_, ( (ushort)uVar1 & 0xff ) + (short)_LC1)))), 1);
   ...
   auVar20._14_2_ = ( undefined2 )(CONCAT19(( byte )(uVar42 >> 10), CONCAT18(( byte )(uVar30 >> 10), uVar13)) >> 0x40);
   ...
   auVar18._10_6_ = ( undefined6 )(CONCAT55(auVar19._11_5_, CONCAT14(( byte )(uVar29 >> 10), uVar4)) >> 0x20);
...
void HE4_C(int *param_1) {
   ...
   *param_1 = ( (int)( uVar2 + 2 + ( uint ) * (byte*)( (long)param_1 + -0x21 ) + ( uint ) * (byte*)( (long)param_1 + -1 ) * 2 ) >> 2 ) * 0x1010101;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void TM16_C(long param_1) {
   byte bVar1;
   byte bVar2;
   long lVar3;
   long lVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void TM4_C(long param_1) {
   byte bVar1;
   byte bVar2;
   long lVar3;
   long lVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void DC16NoTopLeft_C(undefined8 *param_1) {
   undefined8 uVar1;
   undefined8 uVar2;
   undefined8 *puVar3;
   undefined8 *puVar4;
...
void DC16NoLeft_C(undefined4 *param_1) {
   ...
   uVar29 = CONCAT13(0, CONCAT12(auVar1[9], (ushort)auVar1[8]));
   auVar2[0xd] = 0;
   ...
   auVar3._12_2_ = (short)Var17;
   uVar23 = CONCAT42(auVar3._10_4_, auVar18._0_2_);
   auVar19._6_8_ = 0;
   ...
   uVar26 = ( undefined1 )((int)( (uint)auVar13._8_2_ + ( auVar15._0_4_ & 0xffff ) + ( uVar29 & 0xffff ) + (uint)auVar1[0xc] + ( uVar6 >> 8 & 0xffff ) + (int)uVar23 + auVar10._8_4_ + (uint)auVar1[0xe] + (uint)auVar7._10_2_ + auVar8._4_4_ + auVar11._4_4_ + (uint)auVar1[0xd] + ( uVar6 >> 0x18 ) + ( auVar3._10_4_ >> 0x10 ) + ( uint )(uint3)(auVar9._10_3_ >> 0x10) + (uint)auVar1[0xf] + 8 ) >> 4);
   uVar27 = CONCAT11(uVar26, uVar26);
   uVar28 = CONCAT22(uVar27, uVar27);
   puVar24 = param_1;
   do {
      *puVar24 = uVar28;
      for (int i = 0; i < 3; i++) {
...
void DC16NoTop_C(undefined4 *param_1) {
 ...
 while ( pbVar2 != (byte*)( (long)param_1 + 0x1ff ) );
   uVar6 = ( undefined1 )(iVar5 >> 4);
   uVar7 = CONCAT11(uVar6, uVar6);
   uVar8 = CONCAT22(uVar7, uVar7);
   puVar3 = param_1;
   do {
...
void DC8uvNoLeft_C(long *param_1) {
   ...
   uVar39 = ( undefined1 )(uVar1 >> 0x20);
   auVar18[8] = uVar39;
   auVar18._0_8_ = uVar1;
   auVar18._9_6_ = auVar14._9_6_;
   auVar22._7_8_ = 0;
   ...
   auVar21[1] = 0;
   auVar21[0] = (byte)uVar1;
   auVar21._2_13_ = auVar19._2_13_;
   auVar2._8_6_ = 0;
   auVar2._0_8_ = uVar1;
   auVar2[0xe] = uVar42;
   auVar6._8_4_ = 0;
   ...
   auVar25._7_8_ = 0;
   auVar25._0_7_ = auVar15._8_7_;
   auVar26._8_7_ = 0;
   auVar26._0_8_ = SUB158(auVar25 << 0x40, 7);
   auVar27._9_6_ = 0;
   auVar27._0_9_ = SUB159(auVar26 << 0x38, 6);
   auVar28._10_5_ = 0;
   auVar28._0_10_ = SUB1510(auVar27 << 0x30, 5);
   auVar29._11_4_ = 0;
   auVar29._0_11_ = SUB1511(auVar28 << 0x28, 4);
   auVar34._12_3_ = 0;
   auVar34._0_12_ = SUB1512(auVar29 << 0x20, 3);
   auVar20._2_13_ = SUB1513(auVar34 << 0x18, 2);
   auVar20._0_2_ = (ushort)uVar1 & 0xff;
   Var38 = (unkuint10)auVar20._0_4_ << 0x40;
   uVar43 = (undefined2)Var23;
   auVar3._10_2_ = 0;
   auVar3._0_10_ = auVar21._0_10_;
   auVar3._12_2_ = uVar43;
   auVar4._10_2_ = 0;
   auVar4._0_10_ = auVar21._0_10_;
   auVar4._12_2_ = uVar43;
   auVar30._2_4_ = auVar4._10_4_;
   auVar30._0_2_ = auVar24._0_2_;
   auVar30._6_8_ = 0;
   auVar11._4_2_ = auVar19._2_2_;
   auVar11._0_4_ = auVar21._0_4_;
   auVar11._6_8_ = SUB148(auVar30 << 0x40, 6);
   auVar16._10_2_ = 0;
   auVar16._0_10_ = Var38;
   auVar16[0xc] = uVar42;
   auVar31._2_3_ = auVar16._10_3_;
   auVar31._0_2_ = auVar6._12_2_;
   auVar31._5_8_ = 0;
   auVar17._10_2_ = 0;
   auVar17._0_10_ = Var38;
   auVar17[0xc] = uVar42;
   lVar35 = ( ulong )((int)( ( auVar21._0_4_ & 0xffff ) + (int)CONCAT42(auVar3._10_4_, auVar24._0_2_) + (uint)auVar15._8_2_ + (int)CONCAT32(auVar17._10_3_, auVar6._12_2_) + 4 + auVar11._4_4_ + ( auVar3._10_4_ >> 0x10 ) + (int)CONCAT72(SUB137(auVar31 << 0x40, 6), auVar10._10_2_) + ( uint )(uint3)(auVar17._10_3_ >> 0x10) ) >> 3 & 0xff) * 0x101010101010101;
   plVar36 = param_1;
   do {
      *plVar36 = lVar35;
      plVar37 = plVar36 + 8;
...
void DC8uvNoTop_C(long *param_1) {
 ...
 while ( pbVar2 != (byte*)( (long)param_1 + 0xff ) );
   lVar6 = ( ulong )(iVar5 >> 3 & 0xff) * 0x101010101010101;
   plVar3 = param_1;
   do {
      *plVar3 = lVar6;
      plVar4 = plVar3 + 8;
 ...
 while ( param_1 + 0x20 != plVar4 );
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void SimpleHFilter16_C(byte *param_1, int param_2, int param_3) {
   byte bVar1;
   byte bVar2;
   char cVar3;
   long lVar4;
   ...
   do {
      while (true) {
         bVar1 = param_1[-1];
         bVar2 = *param_1;
         if ((int)( ( uint ) * (byte*)( lVar5 + (int)( (uint)param_1[-2] - (uint)param_1[1] ) ) + ( uint ) * (byte*)( lVar5 + (int)( (uint)bVar1 - (uint)bVar2 ) ) * 4 ) <= param_3 * 2 + 1) break;
...
;
      iVar8 = (int)*(char*)( lVar6 + (int)( (uint)param_1[-2] - (uint)param_1[1] ) ) + ( (uint)bVar2 - (uint)bVar1 ) * 3;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void SimpleVFilter16_C(byte *param_1, int param_2, int param_3) {
   byte bVar1;
   byte bVar2;
   char cVar3;
   long lVar4;
   ...
   do {
      while (true) {
         ...
         bVar2 = *pbVar8;
         if ((int)( ( uint ) * (byte*)( lVar5 + (int)( (uint)pbVar8[(long)param_2 * -2] - (uint)pbVar8[param_2] ) ) + ( uint ) * (byte*)( lVar5 + (int)( (uint)bVar1 - (uint)bVar2 ) ) * 4 ) <= param_3 * 2 + 1) break;
         pbVar8 = pbVar8 + 1;
...
;
      pbVar9 = pbVar8 + 1;
      iVar10 = ( (uint)bVar2 - (uint)bVar1 ) * 3 + (int)*(char*)( lVar6 + (int)( (uint)pbVar8[(long)param_2 * -2] - (uint)pbVar8[param_2] ) );
      cVar3 = *(char*)( lVar7 + ( iVar10 + 4 >> 3 ) );
      pbVar8[-param_2] = *(byte*)( lVar4 + (int)( (int)*(char*)( lVar7 + ( iVar10 + 3 >> 3 ) ) + (uint)bVar1 ) );
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void HFilter16i_C(byte *param_1, int param_2, int param_3, int param_4, int param_5) {
   byte *pbVar1;
   byte bVar2;
   byte bVar3;
   byte bVar4;
   ...
   do {
      ...
      do {
         while (true) {
            ...
            if (( ( ( ( (int)( ( uint ) * (byte*)( lVar9 + lVar13 ) + ( uint ) * (byte*)( lVar9 + (int)( (uint)bVar2 - (uint)bVar3 ) ) * 4 ) <= param_3 * 2 + 1 ) && ( (int)( uint ) * (byte*)( lVar9 + (int)( (uint)pbVar11[-4] - (uint)pbVar11[-3] ) ) <= param_4 ) ) && ( (int)( uint ) * (byte*)( lVar9 + (int)( (uint)pbVar11[-3] - (uint)pbVar11[-2] ) ) <= param_4 ) ) && ( ( bVar5 = *(byte*)( lVar9 + (int)( uVar16 - bVar2 ) ) ),(int)(uint)bVar5 <= param_4 && ( (int)( uint ) * (byte*)( lVar9 + (int)( (uint)pbVar11[3] - (uint)pbVar11[2] ) ) <= param_4 ) ) )) &&( (int)( uint ) * (byte*)( lVar9 + (int)( (uint)pbVar11[2] - (uint)bVar4 ) ) <= param_4 );
            LAB_00101ffa:pbVar11 = pbVar11 + param_2;
            local_4c = local_4c + -1;
            if (local_4c == 0) goto LAB_00102008;
         }
;
         bVar6 = *(byte*)( lVar9 + (int)( (uint)bVar4 - (uint)bVar3 ) );
         if (param_4 < (int)(uint)bVar6) goto LAB_00101ffa;
         uVar14 = (uint)bVar3;
         uVar15 = (uint)bVar2;
 ...
 while ( local_4c != 0 );
      LAB_00102008:if (param_1 == pbVar1) {
         return;
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void VFilter16i_C(byte *param_1, int param_2, int param_3, int param_4, int param_5) {
   byte bVar1;
   byte bVar2;
   byte bVar3;
   byte bVar4;
   ...
   do {
      ...
      do {
         ...
         if ((int)( ( uint ) * (byte*)( lVar8 + lVar15 ) + ( uint ) * (byte*)( lVar8 + (int)( uVar16 - bVar1 ) ) * 4 ) <= param_3 * 2 + 1) {
            if (( ( ( (int)( uint ) * (byte*)( lVar8 + (int)( (uint)pbVar10[param_2 * -4] - (uint)pbVar10[lVar6] ) ) <= param_4 ) && ( (int)( uint ) * (byte*)( lVar8 + (int)( (uint)pbVar10[lVar6] - (uint)pbVar11[lVar6] ) ) <= param_4 ) ) && ( bVar3 = *(byte*)( lVar8 + (int)( uVar18 - *pbVar17 ) ) ),(int)(uint)bVar3 <= param_4 )) &&( ( (int)( uint ) * (byte*)( lVar8 + (int)( (uint)pbVar10[param_2 * 3] - (uint)pbVar10[param_2 * 2] ) ) <= param_4 && ( (int)( uint ) * (byte*)( lVar8 + (int)( (uint)pbVar10[param_2 * 2] - (uint)bVar2 ) ) <= param_4 ) ) ) * (byte*)( lVar8 + (int)( (uint)bVar2 - (uint)bVar1 ) );
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void FilterLoop24_C(byte *param_1, int param_2, int param_3, int param_4, int param_5, int param_6, int param_7) {
   byte bVar1;
   byte bVar2;
   byte bVar3;
   byte bVar4;
   ...
   do {
      ...
      if ((int)( ( uint ) * (byte*)( lVar8 + lVar13 ) + ( uint ) * (byte*)( lVar8 + (int)( (uint)bVar3 - (uint)bVar1 ) ) * 4 ) <= param_5 * 2 + 1) {
         if (( ( ( (int)( uint ) * (byte*)( lVar8 + (int)( (uint)param_1[lVar11 * -4] - (uint)pbVar15[lVar11 * -4] ) ) <= param_6 ) && ( (int)( uint ) * (byte*)( lVar8 + (int)( (uint)pbVar15[lVar11 * -4] - (uint)param_1[lVar11 * -2] ) ) <= param_6 ) ) && ( bVar4 = *(byte*)( lVar8 + (int)( uVar16 - bVar3 ) ) ),(int)(uint)bVar4 <= param_6 )) &&( ( (int)( uint ) * (byte*)( lVar8 + (int)( (uint)param_1[param_2 * 3] - (uint)param_1[param_2 * 2] ) ) <= param_6 && ( (int)( uint ) * (byte*)( lVar8 + (int)( (uint)param_1[param_2 * 2] - (uint)bVar2 ) ) <= param_6 ) ) ) * (byte*)( lVar8 + (int)( (uint)bVar2 - (uint)bVar1 ) );
         if ((int)(uint)bVar5 <= param_6) {
            ...
            if (( param_7 < (int)(uint)bVar4 ) || ( param_7 < (int)(uint)bVar5 )) {
               ...
               *pbVar9 = *(byte*)( lVar7 + (int)( (int)*(char*)( _VP8ksclip2 + ( iVar12 + 3 >> 3 ) ) + uVar14 ) );
...
undefined1[16];VFilter8i_C(long param_1, long param_2, int param_3, undefined4 param_4, undefined4 param_5, ulong param_6) {
   undefined1 auVar1[16];
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void HFilter8i_C(long param_1, long param_2, int param_3, int param_4, int param_5, undefined8 param_6) {
   byte bVar1;
   byte bVar2;
   byte bVar3;
   byte bVar4;
   ...
   do {
      while (true) {
         ...
         if (( ( ( ( (int)( ( uint ) * (byte*)( lVar8 + lVar12 ) + ( uint ) * (byte*)( lVar8 + (int)( (uint)bVar1 - (uint)bVar2 ) ) * 4 ) <= param_4 * 2 + 1 ) && ( (int)( uint ) * (byte*)( lVar8 + (int)( (uint)pbVar10[-4] - (uint)pbVar10[-3] ) ) <= param_5 ) ) && ( (int)( uint ) * (byte*)( lVar8 + (int)( (uint)pbVar10[-3] - (uint)pbVar10[-2] ) ) <= param_5 ) ) && ( ( bVar4 = *(byte*)( lVar8 + (int)( uVar15 - bVar1 ) ) ),(int)(uint)bVar4 <= param_5 && ( (int)( uint ) * (byte*)( lVar8 + (int)( (uint)pbVar10[3] - (uint)pbVar10[2] ) ) <= param_5 ) ) )) &&( (int)( uint ) * (byte*)( lVar8 + (int)( (uint)pbVar10[2] - (uint)bVar3 ) ) <= param_5 );
         LAB_001027f8:pbVar10 = pbVar10 + param_3;
         local_3c = local_3c + -1;
         if (local_3c == 0) {
            return;
         }
...
;
      ...
      if (param_5 < (int)(uint)bVar5) goto LAB_001027f8;
      uVar13 = (uint)bVar2;
      uVar14 = (uint)bVar1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void HFilter16_C(byte *param_1, int param_2, int param_3, int param_4, int param_5) {
   byte bVar1;
   byte bVar2;
   byte bVar3;
   byte bVar4;
   ...
   do {
      while (true) {
         ...
         if ((int)( ( uint ) * (byte*)( lVar9 + lVar13 ) + ( uint ) * (byte*)( lVar9 + (int)( uVar14 - bVar1 ) ) * 4 ) <= param_3 * 2 + 1) break;
         LAB_00102a37:param_1 = param_1 + param_2;
         iVar16 = iVar16 + -1;
         if (iVar16 == 0) {
            return;
         }
...
;
      bVar3 = param_1[-3];
      if (( ( param_4 < (int)( uint ) * (byte*)( lVar9 + (int)( (uint)param_1[-4] - (uint)bVar3 ) ) ) || ( param_4 < (int)( uint ) * (byte*)( lVar9 + (int)( (uint)bVar3 - (uint)param_1[-2] ) ) ) ) || ( bVar4 = *(byte*)( lVar9 + (int)( uVar15 - param_1[-1] ) ) ),param_4 < (int)(uint)bVar4) goto LAB_00102a37;
      bVar5 = param_1[2];
      if (( param_4 < (int)( uint ) * (byte*)( lVar9 + (int)( (uint)param_1[3] - (uint)bVar5 ) ) ) || ( param_4 < (int)( uint ) * (byte*)( lVar9 + (int)( (uint)bVar5 - (uint)bVar2 ) ) )) goto LAB_00102a37;
      bVar6 = *(byte*)( lVar9 + (int)( (uint)bVar2 - (uint)bVar1 ) );
      if (param_4 < (int)(uint)bVar6) goto LAB_00102a37;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void VP8DspInit(void) {
   int iVar1;

   ...
   if (__ptr == (void*)0x0) {
      ...
      if (-1 < (int)uVar11) {
         ...
         do {
            ...
            if (( iVar6 != 0 ) || ( iVar6 = ( **(code**)( lVar2 + 0x40 ) )(lVar1, __ptr, uVar9) ),iVar6 != 0) goto LAB_001007c3;
            if (param_1[0x22] == 2) {
            ...
            if (( param_1[0x22] == 3 ) && ( iVar6 = ktxUncompressZLIBInt(local_58, &local_48, __ptr, uVar9) ),iVar6 != 0) goto LAB_00100650;

/* DirAccessUnix::current_is_dir() const */DirAccessUnix DirAccessUnix::current_is_dir(DirAccessUnix *this) {
   return this[0x198];
}
/* DirAccessUnix::current_is_hidden() const */DirAccessUnix DirAccessUnix::current_is_hidden(DirAccessUnix *this) {
   return this[0x199];
}
/* DirAccessUnix::drives_are_shortcuts() */undefined8 DirAccessUnix::drives_are_shortcuts(void) {
   return 1;
}
/* DirAccessUnix::list_dir_end() */void DirAccessUnix::list_dir_end(DirAccessUnix *this) {
...
/* DirAccessUnix::is_hidden(String const&) */undefined8 DirAccessUnix::is_hidden(DirAccessUnix *this, String *param_1) {
   char cVar1;
   undefined8 uVar2;
...
/* DirAccessUnix::get_filesystem_type() const */DirAccessUnix * __thiscall DirAccessUnix::get_filesystem_type(DirAccessUnix *this){
   long lVar1;
   long in_FS_OFFSET;
...
/* DirAccessUnix::get_space_left() */long DirAccessUnix::get_space_left(void) {
   long *plVar1;
   int iVar2;
   char *__file;
   long lVar3;
...
/* DirAccessUnix::list_dir_begin() */byte DirAccessUnix::list_dir_begin(DirAccessUnix *this) {
   long *plVar1;
   long lVar2;
   char *__name;
   DIR *pDVar3;
...
/* DirAccessUnix::~DirAccessUnix() */void DirAccessUnix::~DirAccessUnix(DirAccessUnix *this) {
   long *plVar1;
   long lVar2;
...
/* DirAccessUnix::is_writable(String) */ulong DirAccessUnix::is_writable(DirAccessUnix *this, long *param_2) {
   long *plVar1;
   long lVar2;
   long lVar3;
   char cVar4;
...
/* DirAccessUnix::is_readable(String) */ulong DirAccessUnix::is_readable(DirAccessUnix *this, long *param_2) {
   long *plVar1;
   long lVar2;
   long lVar3;
   char cVar4;
...
/* DirAccessUnix::make_dir(String) */undefined4 DirAccessUnix::make_dir(DirAccessUnix *this, long *param_2) {
   long *plVar1;
   long lVar2;
   long lVar3;
   char cVar4;
...
/* DirAccessUnix::dir_exists(String) */bool DirAccessUnix::dir_exists(DirAccessUnix *this, long *param_2) {
   long *plVar1;
   long lVar2;
   char cVar3;
   int iVar4;
...
/* DirAccessUnix::is_case_sensitive(String const&) const */uint DirAccessUnix::is_case_sensitive(DirAccessUnix *this, String *param_1) {
   long *plVar1;
   long lVar2;
   ulong uVar3;
   ulong uVar4;
 ...
 while ( !bVar9 );
   ...
   LAB_00100d75:cVar5 = String::is_absolute_path();
   if (cVar5 == '\0') {
      ( **(code**)( *(long*)this + 0x1b0 ) )(&local_40, this, 1);
      String::path_join((String*)&local_38);
      uVar4 = local_38;
...
/* DirAccessUnix::get_current_dir(bool) const */DirAccessUnix * __thiscall DirAccessUnix::get_current_dir(DirAccessUnix *this,bool param_1){
   long *plVar1;
   long lVar2;
   undefined *puVar3;
   char cVar4;
   ...
   if (local_70 == 0) {
      *(undefined8*)this = 0;
      ...
      LAB_0010107b:CowData<char32_t>::_ref((CowData<char32_t>*)this, (CowData*)( plVar5 + 0x34 ));
      LAB_0010108a:if (local_70 == 0) goto LAB_001010b5;
   }
 else {
   ...
   *plVar5 = *plVar5 + -1;
   ...
   LAB_001010b5:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return this;
   }
...
/* DirAccessUnix::file_exists(String) */bool DirAccessUnix::file_exists(DirAccessUnix *this, long *param_2) {
   long *plVar1;
   long lVar2;
   char cVar3;
   int iVar4;
...
/* DirAccessUnix::get_modified_time(String) */__time_t DirAccessUnix::get_modified_time(DirAccessUnix *this, long *param_2) {
   long *plVar1;
   long lVar2;
   char cVar3;
   int iVar4;
   ...
   if (iVar4 != 0) {
      _err_print_error("get_modified_time", "drivers/unix/dir_access_unix.cpp", 0x88, "Method/function failed. Returning: 0", 0, 0);
...
/* DirAccessUnix::create_link(String, String) */bool DirAccessUnix::create_link(DirAccessUnix *this, long *param_2, long *param_3) {
   long *plVar1;
   long lVar2;
   long lVar3;
   char cVar4;
...
/* DirAccessUnix::get_next() */void DirAccessUnix::get_next(void) {
   long *plVar1;
   uchar uVar2;
   code *pcVar3;
   undefined *puVar4;
   ...
   *(undefined8*)in_RDI = 0;
   ...
   LAB_00101b14:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* DirAccessUnix::change_dir(String) */undefined8 DirAccessUnix::change_dir(DirAccessUnix *this, CowData *param_2) {
   long *plVar1;
   long lVar2;
   undefined *puVar3;
   char cVar4;
   ...
   if (pcVar6 == (char*)0x0) {
      uVar9 = 0x2f;
      _err_print_error("change_dir", "drivers/unix/dir_access_unix.cpp", 0x158, "Parameter \"getcwd(real_current_dir_name, 2048)\" is null.", 0, 0);
      goto LAB_00101eab;
   }
   ...
   if (iVar5 == 0) {
      DirAccess::_get_root_path();
      if (( ( local_860 == (undefined*)0x0 ) || ( *(uint*)( local_860 + -8 ) < 2 ) ) || ( cVar4 = String::begins_with((String*)&local_868) ),cVar4 != '\0') {
         LAB_00101e0b:if (*(undefined**)( this + 0x1a0 ) != local_868) {
         ...
         uVar9 = 0;
         if (iVar5 != 0) {
            _err_print_error("change_dir", "drivers/unix/dir_access_unix.cpp", 0x179, "Condition \"chdir(prev_dir.utf8().get_data()) != 0\" is true. Returning: ERR_BUG", 0, 0);
            goto LAB_001021e5;
         }
         ...
         _err_print_error("change_dir", "drivers/unix/dir_access_unix.cpp", 0x16e, "Parameter \"getcwd(real_current_dir_name, 2048)\" is null.", 0, 0);
         LAB_001021e5:uVar9 = 0x2f;
      }
...
/* DirAccessUnix::is_link(String) */undefined4 DirAccessUnix::is_link(DirAccessUnix *this, long *param_2) {
   long *plVar1;
   long lVar2;
   char cVar3;
   int iVar4;
...
/* DirAccessUnix::read_link(String) */char *DirAccessUnix::read_link(char *param_1, long *param_2, long *param_3) {
   long *plVar1;
   long lVar2;
   char cVar3;
   char *pcVar4;
...
/* DirAccessUnix::remove(String) */undefined8 DirAccessUnix::remove(DirAccessUnix *this, long *param_2) {
   long *plVar1;
   code *pcVar2;
   char cVar3;
   int iVar4;
 ...
 while ( !bVar10 );
         ...
         LAB_00102ba1:cVar3 = ( *pcVar2 )(this);
         lVar8 = local_d0;
         if (cVar3 != '\0') {
            if (local_d0 != 0) {
               LOCK();
   ...
   uVar6 = 1;
   LAB_001029d5:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar6;
   }
...
/* DirAccessUnix::rename(String, String) */ulong DirAccessUnix::rename(DirAccessUnix *this, long *param_2, long *param_3) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   char cVar4;
 ...
 while ( !bVar9 );
         ...
         LAB_00103071:uVar7 = ( *pcVar3 )(this);
         lVar2 = local_48;
         if (local_48 != 0) {
            LOCK();
            plVar1 = (long*)( local_48 + -0x10 );
...
/* DirAccessUnix::DirAccessUnix() */void DirAccessUnix::DirAccessUnix(DirAccessUnix *this) {
   ...
   *(undefined1(*) [16])( this + 0x188 ) = (undefined1[16])0x0;
   ...
   if (pcVar4 == (char*)0x0) {
      _err_print_error("DirAccessUnix", "drivers/unix/dir_access_unix.cpp", 0x22b, "Parameter \"getcwd(real_current_dir_name, 2048)\" is null.", 0, 0);
   }
 else {
...
/* DirAccessUnix::get_drive(int) */CowData<char32_t> *DirAccessUnix::get_drive(int param_1) {
   uint uVar1;
   uint in_EDX;
   CowData *pCVar2;
 ...
 while ( in_EDX != uVar1 );
         ...
         LAB_00103e1f:*(undefined8*)this = 0;
         if (*(long*)pCVar2 != 0) {
      ...
      LAB_00103e60:lVar3 = 0;
   }

   LAB_00103e63:_err_print_index_error("get_drive", "drivers/unix/dir_access_unix.cpp", 0x122, (long)(int)in_EDX, lVar3, "p_drive", "list.size()", "", false, false);
   *(undefined8*)this = 0;
   local_38 = &_LC3;
   local_30 = 0;
   String::parse_latin1((StrRange*)this);
   LAB_00103e35:List<String,DefaultAllocator>::~List((List<String,DefaultAllocator>*)&local_40);
   if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return this;
   }
...
/* DirAccessUnix::get_drive_count() */undefined4 DirAccessUnix::get_drive_count(void) {
   undefined4 uVar1;
   long in_FS_OFFSET;
   long local_28;
   long local_20;
...
/* DirAccessUnix::get_current_drive() */int DirAccessUnix::get_current_drive(DirAccessUnix *this) {
   long *plVar1;
   long lVar2;
   char cVar3;
   int iVar4;
   ...
   do {
      ...
      if (iVar6 < (int)( iVar4 + -1 + ( uint )(iVar4 == 0) )) {
         LAB_001040b7:cVar3 = String::begins_with((String*)&local_58);
         if (cVar3 == '\0') {
...
/* DirAccess::is_class_ptr(void*) const */uint DirAccess::is_class_ptr(DirAccess *this, void *param_1) {
   return (uint)CONCAT71(0x1063, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1063, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1063, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
...
/* DirAccessUnix::fix_unicode_name(char const*) const */char *DirAccessUnix::fix_unicode_name(char *param_1) {
   long lVar1;
   int in_EDX;
   long in_FS_OFFSET;
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
...
/* SortArray<List<String, DefaultAllocator>::Element*, List<String,
   ...
   if (param_4 != 0) {
      ...
      local_68 = param_2;
      local_60 = param_4;
      LAB_001045b1:local_60 = local_60 + -1;
      ...
      LAB_0010460d:pSVar2 = (String*)*ppEVar10;
      lVar9 = local_68;
      local_78 = param_1;
      do {
         cVar4 = String::operator <((String*)param_3[local_78], pSVar2);
         if (cVar4 == '\0') {
            LAB_00104654:lVar9 = lVar9 + -1;
...
;
 ...
 while ( lVar7 < lVar12 );
         *ppEVar11 = (Element*)pSVar2;
         joined_r0x0010490d:if (lVar7 == 0) goto LAB_0010490f;
      }
 else {
         ppEVar5 = local_50;
         ppEVar11 = local_50;
         if (local_58 == lVar9) goto LAB_00104a4d;
         LAB_00104a9e:*ppEVar11 = (Element*)pSVar2;
      }
 ...
 while ( true );
   LAB_001046c0:introsort(local_78, local_68, param_3, local_60);
   ...
   goto LAB_001045b1;
   LAB_0010490f:ppEVar11 = param_3 + param_1;
...
/* DirAccess::_initialize_classv() */void DirAccess::_initialize_classv(void) {
   ...
   long local_40;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (initialize_class() != '\0') goto LAB_00104d2b;
   if (RefCounted::initialize_class() == '\0') {
      ...
      lVar2 = local_68;
      if (local_68 == 0) {
         LAB_00104e3a:if ((code*)PTR__bind_methods_00108008 != RefCounted::_bind_methods) {
            LAB_00104e4a:RefCounted::_bind_methods();
         }
   ...
   undefined8 DirAccess::is_class(DirAccess *this, String *param_1) {
      long *plVar1;
      long lVar2;
      char *pcVar3;
      long lVar4;
 ...
 while ( !bVar9 );
         ...
         LAB_00104f2f:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
 ...
 while ( !bVar9 );
            ...
            LAB_001050bb:cVar6 = String::operator ==(param_1, (String*)&local_60);
            lVar4 = local_60;
            if (local_60 != 0) {
               LOCK();
               plVar1 = (long*)( local_60 + -0x10 );
 ...
 while ( !bVar9 );
               ...
               LAB_0010519b:cVar6 = String::operator ==(param_1, (String*)&local_60);
               lVar4 = local_60;
               if (local_60 != 0) {
                  LOCK();
                  plVar1 = (long*)( local_60 + -0x10 );
      ...
      LAB_00104fe3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }

      LAB_00105244:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }
   ...
   void DirAccess::_get_property_listv(DirAccess *this, List *param_1, bool param_2) {
      long *plVar1;
      long lVar2;
      long lVar3;
      undefined1(*pauVar4)[16];
...
;
 ...
 while ( lVar9 + 1 != 0x10 );
         LAB_00105ee6:pEVar10 = (Element*)( lVar9 + 1 );
         do {
            pSVar8 = (String*)__src[(long)pEVar10];
            ppEVar5 = __src + (long)pEVar10;
            pEVar11 = pEVar10;
...
;
 ...
 while ( pEVar4 != pEVar10 );
      ...
      LAB_00106065:puVar2 = *(undefined8**)this;
      *puVar2 = pSVar8;

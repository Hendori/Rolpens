bool ssl_add_cert_to_wpacket(long param_1, undefined8 param_2, X509 *param_3, int param_4, int param_5) {
   ...
   if (param_5 == 0) {
      ...
      if (iVar1 < 0) {
         ...
         if (( iVar2 != 0 ) && ( iVar2 = iVar1 == iVar2 )) {
            piVar3 = *(int**)( param_1 + 0x18 );
            if (( *(byte*)( *(long*)( piVar3 + 0x36 ) + 0x50 ) & 8 ) == 0) {
               uVar4 = 0x1000;
               LAB_001001a5:if (( ( 0x303 < *piVar3 ) && ( *piVar3 != 0x10000 ) ) || ( param_5 != 0 )) goto LAB_001001bd;
            }
      ...
      if (-1 < iVar1) {
         ...
         if (( iVar2 != 0 ) && ( iVar2 = iVar1 == iVar2 )) {
            ...
            LAB_001001bd:iVar1 = tls_construct_extensions(param_1, param_2, uVar4, param_3, (long)param_4);
            bVar5 = iVar1 != 0;
            goto LAB_001000d2;
         }
   ...
   bVar5 = false;
   LAB_001000d2:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 get_cert_verify_tbs_data_constprop_0(long param_1, undefined8 *param_2, undefined8 *param_3, long *param_4) {
   undefined8 uVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   undefined8 uVar4;
   ...
   if (( ( ( *(byte*)( *(long*)( *(int**)( param_1 + 0x18 ) + 0x36 ) + 0x50 ) & 8 ) == 0 ) && ( iVar8 = **(int**)( param_1 + 0x18 ) ),iVar8 != 0x10000 )) &&( 0x303 < iVar8 ) * param_2 = __LC1;
   param_2[1] = uVar1;
   for (int i = 0; i < 3; i++) {
      param_2[( 2*i + 2 )] = uVar10;
      param_2[( 2*i + 3 )] = uVar1;
   }
...
else{lVar9 = BIO_ctrl(*(BIO**)( param_1 + 0x1a8 ), 3, 0, param_3);if (lVar9 < 1) {
   ERR_new();
   ERR_set_debug("ssl/statem/statem_lib.c", 0x12e, "get_cert_verify_tbs_data");
   ossl_statem_fatal(param_1, 0x50, 0xc0103, 0);
   LAB_0010034b:uVar10 = 0;
   goto LAB_0010025a;
}
*param_4 = lVar9;}uVar10 = 1;LAB_0010025a:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return uVar10;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}undefined8 ossl_statem_set_mutator(uint *param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4) {
   if (param_1 == (uint*)0x0) {
      return 0;
   }
   ...
   LAB_001003dd:*(undefined8*)( param_1 + 0x34 ) = param_2;
...
undefined8 ssl3_do_write(long param_1, char param_2) {
   ...
   local_48 = 0;
   if (( ( *(code**)( param_1 + 0xd0 ) == (code*)0x0 ) || ( ( *(byte*)( param_1 + 0xe8 ) & 1 ) != 0 ) ) || ( param_2 != '\x16' )) {
      iVar1 = ssl3_write_bytes(param_1, param_2, *(long*)( param_1 + 0x110 ) + *(long*)( lVar2 + 8 ), uVar4, &local_48);
      if (0 < iVar1) {
         if (param_2 == '\x16') goto LAB_001005c6;
         lVar2 = *(long*)( param_1 + 0x108 );
         if (lVar2 == local_48) {
            LAB_00100658:*(byte*)( param_1 + 0xe8 ) = *(byte*)( param_1 + 0xe8 ) & 0xfe;
            if (*(code**)( param_1 + 0x4f8 ) != (code*)0x0) {
               ( **(code**)( param_1 + 0x4f8 ) )(1, *(undefined4*)( param_1 + 0x48 ), param_2, *(undefined8*)( *(long*)( param_1 + 0xf8 ) + 8 ), lVar2 + *(long*)( param_1 + 0x110 ), uVar3, *(undefined8*)( param_1 + 0x500 ));
            }
         ...
         LAB_001004c1:*(long*)( param_1 + 0x110 ) = *(long*)( param_1 + 0x110 ) + local_48;
         uVar3 = 0;
      ...
      if (3 < uVar4) {
         iVar1 = ( **(code**)( param_1 + 0xd0 ) )(*(long*)( lVar2 + 8 ), uVar4, &local_40, &local_38, *(undefined8*)( param_1 + 0xe0 ));
         if (( ( iVar1 == 0 ) || ( local_38 < 4 ) ) || ( iVar1 = BUF_MEM_grow(*(BUF_MEM**)( param_1 + 0xf8 ), local_38) ),CONCAT44(extraout_var, iVar1) == 0) goto LAB_00100648;
      ...
      iVar1 = ssl3_write_bytes(param_1, 0x16, *(long*)( param_1 + 0x110 ) + *(long*)( lVar2 + 8 ), uVar4, &local_48);
      if (0 < iVar1) {
         LAB_001005c6:if (( ( ( ( *(byte*)( *(long*)( *(int**)( param_1 + 0x18 ) + 0x36 ) + 0x50 ) & 8 ) == 0 ) && ( iVar1 = **(int**)( param_1 + 0x18 ) ),iVar1 != 0x10000 ) ) && ( ( 0x303 < iVar1 && ( ( *(int*)( param_1 + 0xac ) - 0x2eU < 2 || ( *(int*)( param_1 + 0xac ) == 0x25 ) ) ) ) )) {
            lVar2 = *(long*)( param_1 + 0x108 );
            param_2 = '\x16';
   ...
   LAB_00100648:uVar3 = 0xffffffff;
   LAB_001004d4:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 tls_close_construct_packet(long param_1, undefined8 param_2, int param_3) {
   ...
   if (param_3 == 0x101) {
      LAB_001006e4:iVar1 = WPACKET_get_length(param_2, &local_28);
   ...
   uVar2 = 0;
   LAB_00100722:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar2;
   }
...
undefined8 tls_construct_cert_verify(long param_1, undefined8 param_2) {
   ...
   if (( lVar1 == 0 ) || ( *(long*)( param_1 + 0x3d8 ) == 0 )) {
      ERR_new();
      uVar7 = 0x145;
      LAB_001007e8:ERR_set_debug("ssl/statem/statem_lib.c", uVar7, "tls_construct_cert_verify");
      ossl_statem_fatal(param_1, 0x50, 0xc0103, 0);
      LAB_0010080d:sigret = (uchar*)0x0;
      ctx = (EVP_MD_CTX*)0x0;
   }
 else {
      lVar3 = *(long*)( *(long*)( param_1 + 0x3d8 ) + 8 );
      if (( lVar3 == 0 ) || ( iVar5 = iVar5 == 0 )) {
         ERR_new();
         uVar7 = 0x14b;
         goto LAB_001007e8;
      }
      ...
      if (iVar5 == 0) {
         LAB_00100a17:sigret = (uchar*)0x0;
      }
 else {
         if (( ( *(byte*)( *(long*)( *(long*)( param_1 + 0x18 ) + 0xd8 ) + 0x50 ) & 2 ) != 0 ) && ( iVar5 = WPACKET_put_bytes__(param_2, *(undefined2*)( lVar1 + 0x10 ), 2) ),iVar5 == 0) {
            ERR_new();
            ERR_set_debug("ssl/statem/statem_lib.c", 0x15c, "tls_construct_cert_verify");
            uVar7 = 0xc0103;
            LAB_00100aa8:ossl_statem_fatal(param_1, 0x50, uVar7, 0);
            goto LAB_00100a17;
         }
         ...
         if (iVar5 < 1) {
            ERR_new();
            uVar7 = 0x164;
            LAB_00100ba9:ERR_set_debug("ssl/statem/statem_lib.c", uVar7, "tls_construct_cert_verify");
            uVar7 = 0x80006;
            goto LAB_00100aa8;
         }

         if (( *(int*)( lVar1 + 0x1c ) == 0x390 ) && ( ( iVar5 = EVP_PKEY_CTX_set_rsa_padding(local_108, 6) ),iVar5 < 1 || ( iVar5 = iVar5 < 1 ) )) {
            ERR_new();
            uVar7 = 0x16c;
            goto LAB_00100ba9;
         }
         ...
         if (*(int*)( param_1 + 0x48 ) == 0x300) {
            ...
            if (( 0 < iVar5 ) && ( iVar5 = EVP_MD_CTX_ctrl(ctx, 0x1d, *(undefined4*)( *(long*)( param_1 + 0x900 ) + 8 ), *(long*)( param_1 + 0x900 ) + 0x50) ),0 < iVar5) {
               iVar5 = EVP_DigestSignFinal(ctx, (uchar*)0x0, &local_f8);
               if (0 < iVar5) {
                  sigret = (uchar*)CRYPTO_malloc((int)local_f8, "ssl/statem/statem_lib.c", 0x17e);
                  if (( sigret == (uchar*)0x0 ) || ( iVar5 = iVar5 < 1 )) {
                     ERR_new();
                     uVar7 = 0x181;
                     goto LAB_00100ad1;
                  }
         ...
         if (( sigret == (uchar*)0x0 ) || ( iVar5 = EVP_DigestSign(ctx, sigret, &local_f8, local_f0, uVar7) ),iVar5 < 1) {
            ERR_new();
            uVar7 = 400;
            LAB_00100ad1:ERR_set_debug("ssl/statem/statem_lib.c", uVar7, "tls_construct_cert_verify");
            ossl_statem_fatal(param_1, 0x50, 0x80006, 0);
         }
 else {
            LAB_0010097c:if (( *(int*)( lVar1 + 0x1c ) - 0x3d3U < 2 ) || ( *(int*)( lVar1 + 0x1c ) == 0x32b )) {
   ...
   EVP_MD_CTX_free(ctx);
   uVar7 = 0;
   LAB_0010082c:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 tls_construct_finished(long param_1, undefined8 param_2) {
   ...
   if (*(int*)( param_1 + 0x78 ) == 0) {
      ...
      if (( ( ( ( ( uVar1 & 8 ) == 0 ) && ( iVar2 = **(int**)( param_1 + 0x18 ) ),iVar2 != 0x10000 ) ) && ( 0x303 < iVar2 ) ) && ( ( *(int*)( param_1 + 0xf0 ) != 0 || ( ( *(byte*)( param_1 + 0x9b2 ) & 0x10 ) != 0 ) ) )) {
      ...
      LAB_00100e20:uVar5 = *(undefined8*)( lVar3 + 0x30 );
   ...
   if (__n != 0) {
      *(ulong*)( param_1 + 0x260 ) = __n;
      ...
      if (iVar2 == 0) {
         ...
         if (( ( ( ( *(byte*)( *(long*)( *(int**)( param_1 + 0x18 ) + 0x36 ) + 0x50 ) & 8 ) != 0 ) || ( iVar2 = **(int**)( param_1 + 0x18 ) ),iVar2 == 0x10000 ) ) || ( iVar2 < 0x304 )) {
            return 0;
         }
...
undefined8 tls_process_change_cipher_spec(long param_1, long param_2) {
   ...
   if (( *(byte*)( *(long*)( *(long*)( param_1 + 0x18 ) + 0xd8 ) + 0x50 ) & 8 ) == 0) {
      ...
      ERR_new();
      uVar4 = 799;
      LAB_0010119b:ERR_set_debug("ssl/statem/statem_lib.c", uVar4, "tls_process_change_cipher_spec");
      ...
      if (*(int*)( param_1 + 0x48 ) == 0x100) {
         ...
         LAB_0010118a:ERR_new();
         uVar4 = 0x31a;
         goto LAB_0010119b;
      }

      LAB_00101103:if (*(long*)( param_1 + 0x300 ) == 0) {
         ERR_new();
         ...
         *(undefined4*)( param_1 + 0x1b8 ) = 1;
         ...
         if (iVar3 != 0) {
            if (( ( *(byte*)( *(long*)( *(long*)( param_1 + 0x18 ) + 0xd8 ) + 0x50 ) & 8 ) != 0 ) && ( *(int*)( param_1 + 0x48 ) == 0x100 )) {
...
void tls_get_peer_pkey(long param_1) {
   long lVar1;
   if (( *(long*)( *(long*)( param_1 + 0x900 ) + 0x2b8 ) == 0 ) && ( lVar1 = *(long*)( *(long*)( param_1 + 0x900 ) + 0x2c0 ) ),lVar1 != 0) {
...
char tls_process_cert_verify(long param_1, long *param_2) {
   ...
   if (ctx == (EVP_MD_CTX*)0x0) {
      ERR_new();
      uVar8 = 0x1c7;
      LAB_001016c1:ERR_set_debug("ssl/statem/statem_lib.c", uVar8, "tls_process_cert_verify");
      ossl_statem_fatal(param_1, 0x50, 0x80006, 0);
   }
 else {
      ...
      if (lVar5 == 0) {
         ERR_new();
         uVar8 = 0x1cd;
         LAB_00101701:ERR_set_debug("ssl/statem/statem_lib.c", uVar8, "tls_process_cert_verify");
         ossl_statem_fatal(param_1, 0x50, 0xc0103, 0);
      }
 else {
         ...
         if (lVar6 == 0) {
            ...
            if (iVar4 == 0) {
               ...
               LAB_001013cc:iVar4 = tls1_lookup_md(puVar2, *(undefined8*)( param_1 + 0x400 ), &local_108);
               if (iVar4 == 0) {
                  ERR_new();
                  uVar8 = 0x1e9;
                  goto LAB_00101701;
               ...
               if (( *(byte*)( *(long*)( *(long*)( param_1 + 0x18 ) + 0xd8 ) + 0x50 ) & 2 ) == 0) {
                  ...
                  iVar4 = EVP_PKEY_get_id(lVar5);
                  if (( iVar4 != 0x32b ) && ( iVar4 = iVar4 != 0x3d3 )) {
                     uVar7 = param_2[1];
                     goto LAB_001015ea;
                  }

                  LAB_00101870:uVar7 = param_2[1];
                  num = (uint)uVar7;
                  LAB_0010142c:siz = (ulong)num;
                  if (uVar7 < siz) {
                     ERR_new();
                     uVar8 = 0x206;
                  }
                     ...
                     *param_2 = (long)( local_118 + siz );
                     if (uVar7 - siz == 0) {
                        ...
                        iVar4 = EVP_PKEY_get_id(lVar5);
                        if (( iVar4 - 0x3d3U < 2 ) || ( out = iVar4 == 0x32b )) {
                        ...
                        if (( ( *(long*)( param_1 + 0x400 ) == 0 ) || ( *(int*)( *(long*)( param_1 + 0x400 ) + 0x1c ) != 0x390 ) ) || ( ( iVar4 = EVP_PKEY_CTX_set_rsa_padding(local_f0, 6) ),0 < iVar4 && ( iVar4 = EVP_PKEY_CTX_set_rsa_pss_saltlen(local_f0, 0xffffffff) ),0 < iVar4 )) {
                           if (*(int*)( param_1 + 0x48 ) == 0x300) {
                              iVar4 = EVP_DigestVerifyUpdate(ctx, local_f8, local_100);
                              if (( iVar4 < 1 ) || ( iVar4 = EVP_MD_CTX_ctrl(ctx, 0x1d, *(undefined4*)( *(long*)( param_1 + 0x900 ) + 8 ), *(long*)( param_1 + 0x900 ) + 0x50) ),iVar4 < 1) {
                                 ERR_new();
                                 uVar8 = 0x238;
                                 goto LAB_00101950;
                              }
                              ...
                              if (0 < iVar4) {
                                 LAB_00101533:cVar9 = '\x03';
                                 if (( *(int*)( param_1 + 0x78 ) == 0 ) && ( ( *(byte*)( *(long*)( *(int**)( param_1 + 0x18 ) + 0x36 ) + 0x50 ) & 8 ) == 0 )) {
                           ...
                           ERR_new();
                           uVar8 = 0x22f;
                           LAB_00101950:ERR_set_debug("ssl/statem/statem_lib.c", uVar8, "tls_process_cert_verify");
                           ossl_statem_fatal(param_1, 0x50, 0x80006, 0);
                        }
   ...
   LAB_0010164e:cVar9 = '\0';
   out = (uchar*)0x0;
   LAB_00101654:BIO_free(*(BIO**)( param_1 + 0x1a8 ));
...
undefined8 tls_process_rpk(long param_1, long *param_2, undefined8 *param_3) {
   ...
   uVar9 = param_2[1];
   local_68 = (void*)0x0;
   if (( ( ( *(byte*)( *(long*)( *(int**)( param_1 + 0x18 ) + 0x36 ) + 0x50 ) & 8 ) != 0 ) || ( iVar8 = **(int**)( param_1 + 0x18 ) ),iVar8 < 0x304 )) goto LAB_00101a48;
   if (uVar9 == 0) {
      LAB_00101ca0:ERR_new();
      uVar11 = 0x4ae;
      LAB_00101cb1:ERR_set_debug("ssl/statem/statem_lib.c", uVar11, "tls_process_rpk");
      ossl_statem_fatal(param_1, 0x32, 0x11a, 0);
      LAB_00101ab9:uVar11 = 0;
      pkey = (EVP_PKEY*)0x0;
   }
 else {
      ...
      *param_2 = (long)( pbVar12 + uVar10 );
      ...
      if (*(void**)( param_1 + 0xbb0 ) != (void*)0x0) {
         if (( *(ulong*)( param_1 + 3000 ) != uVar10 ) || ( iVar8 = CRYPTO_memcmp(pbVar12, *(void**)( param_1 + 0xbb0 ), uVar10) ),iVar8 != 0) {
            ERR_new();
            uVar11 = 0x4b9;
            goto LAB_00101cb1;
         }
         ...
         uVar9 = param_2[1];
         LAB_00101a48:if (uVar9 < 3) {
            LAB_00101a83:ERR_new();
            uVar11 = 0x4c7;
            LAB_00101a94:ERR_set_debug("ssl/statem/statem_lib.c", uVar11, "tls_process_rpk");
            ossl_statem_fatal(param_1, 0x32, 0x9f, 0);
         }
 else {
            pbVar6 = (byte*)*param_2;
            ...
            *param_2 = (long)pbVar12;
            ...
            uVar13 = uVar14;
            if (( ( ( *(byte*)( *(long*)( *(int**)( param_1 + 0x18 ) + 0x36 ) + 0x50 ) & 8 ) != 0 ) || ( iVar8 = **(int**)( param_1 + 0x18 ) ),iVar8 == 0x10000 )) {
               LAB_00101c13:uVar11 = *puVar5;
               ...
               *param_2 = (long)( pbVar12 + uVar13 );
               ...
               if (( pkey == (EVP_PKEY*)0x0 ) || ( local_60 != pbVar12 + uVar13 )) {
                  ERR_new();
                  uVar11 = 0x4ef;
                  LAB_00101c70:ERR_set_debug("ssl/statem/statem_lib.c", uVar11, "tls_process_rpk");
                  ossl_statem_fatal(param_1, 0x32, 0x9f, 0);
               }
 else {
                  iVar8 = EVP_PKEY_missing_parameters(pkey);
                  if (iVar8 == 0) {
                     if (( ( ( *(byte*)( *(long*)( *(int**)( param_1 + 0x18 ) + 0x36 ) + 0x50 ) & 8 ) != 0 ) || ( iVar8 = **(int**)( param_1 + 0x18 ) ),iVar8 < 0x304 )) {
                        LAB_00101e00:uVar11 = 1;
                     ...
                     if (uVar13 == param_2[1]) {
                        if (( uVar13 < 2 ) || ( uVar4 = *(ushort*)*param_2 ),uVar13 = uVar13 - 2,uVar13 != ( ushort )(uVar4 << 8 | uVar4 >> 8)) {
                           ERR_new();
                           uVar11 = 0x500;
                           goto LAB_00101c70;
                        }
                        ...
                        *param_2 = (long)local_58 + uVar13;
                        ...
                        if (( iVar8 != 0 ) && ( iVar8 = tls_parse_all_extensions(param_1, 0x10000, local_68, 0, 0, 1) ),iVar8 != 0) goto LAB_00101e00;
                     }
 else {
                        ERR_new();
   ...
   LAB_00101abf:CRYPTO_free(local_68);
   EVP_PKEY_free(pkey);
   LAB_00101ad9:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 tls_output_rpk(long param_1, undefined8 param_2, long *param_3) {
   ...
   local_38 = (uchar*)0x0;
   if (param_3 == (long*)0x0) {
      LAB_001020b0:if (*(int*)( param_1 + 0x78 ) == 0) {
      ...
      LAB_001020e9:ERR_set_debug("ssl/statem/statem_lib.c", uVar4, "tls_output_rpk");
      ossl_statem_fatal(param_1, 0x50, 0xc0103, 0);
      LAB_00102107:uVar4 = 0;
   }
 else {
      lVar1 = *param_3;
      if (lVar1 == 0) {
      ...
      LAB_00102051:uVar4 = 1;
   }

   CRYPTO_free(local_38);
   LAB_0010206e:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 ssl3_output_cert_chain(long param_1, undefined8 param_2, undefined8 *param_3, int param_4) {
   ...
   if (iVar2 == 0) {
      ...
      if (( param_3 != (undefined8*)0x0 ) && ( x509 = (X509*)*param_3 ),x509 != (X509*)0x0) {
         ...
         if (( ( store == (X509_STORE*)0x0 ) && ( ( store = (X509_STORE*)puVar1[0x22](*(byte*)( param_1 + 0x9b8 ) & 8) == 0 && ( store == (X509_STORE*)0x0 ) ) ) ) && ( ( store = *(X509_STORE**)( *(long*)( param_1 + 0x880 ) + 0x70 ) ),store != (X509_STORE*)0x0 || ( store = (X509_STORE*)puVar1[5] ),store != (X509_STORE*)0x0 )) {
            ...
            if (ctx == (X509_STORE_CTX*)0x0) {
               ...
               ERR_new();
               uVar6 = 0x40b;
               LAB_00102482:ERR_set_debug("ssl/statem/statem_lib.c", uVar6, "ssl_add_cert_chain");
 ...
 while ( iVar2 != iVar3 );
            ...
            if (iVar2 != 1) {
               ...
               ERR_new();
               uVar6 = 0x43a;
               LAB_00102285:ERR_set_debug("ssl/statem/statem_lib.c", uVar6, "ssl_add_cert_chain");
...
undefined8 tls_finish_handshake(long param_1, undefined8 param_2, int param_3, int param_4) {
   ...
   if (( ( ( ( *(byte*)( *(long*)( piVar6 + 0x36 ) + 0x50 ) & 8 ) == 0 ) && ( 0x303 < *piVar6 ) ) && ( *piVar6 != 0x10000 ) ) && ( ( *(int*)( param_1 + 0x78 ) == 0 && ( *(int*)( param_1 + 0xba8 ) == 4 ) ) )) {
   ...
   if (iVar1 == 0) {
      ...
      if (( ( ( *(byte*)( *(long*)( *(int**)( param_1 + 0x18 ) + 0x36 ) + 0x50 ) & 8 ) == 0 ) && ( iVar1 = **(int**)( param_1 + 0x18 ) ),iVar1 != 0x10000 )) &&( ( 0x303 < iVar1 && ( ( *(long*)( param_1 + 0x260 ) != 0 && ( *(long*)( param_1 + 0x2e8 ) != 0 ) ) ) ) );
   }
 else {
      ...
      *(undefined4*)( param_1 + 0xa60 ) = 0;
      ...
      piVar6 = *(int**)( param_1 + 0x18 );
      if (*(int*)( param_1 + 0x78 ) == 0) {
         if (( ( ( *(byte*)( *(long*)( piVar6 + 0x36 ) + 0x50 ) & 8 ) == 0 ) && ( *piVar6 != 0x10000 ) ) && ( 0x303 < *piVar6 )) {
         ...
         *piVar6 = *piVar6 + 1;
         ...
         if (( ( ( *(byte*)( *(long*)( piVar6 + 0x36 ) + 0x50 ) & 8 ) != 0 ) || ( *piVar6 == 0x10000 ) ) || ( *piVar6 < 0x304 )) {
   ...
   ( *pcVar8 )(uVar2, 0x20, 1);
   joined_r0x001026f1:if (param_4 == 0) {
...
undefined8 tls_get_message_header(long param_1, uint *param_2) {
   ...
   LAB_00102920:do {
      ...
      while (3 < uVar2) {
         uVar4 = ( uint ) * pbVar1;
         if (( ( ( *(int*)( param_1 + 0x78 ) != 0 ) || ( *(int*)( param_1 + 0xac ) == 1 ) ) || ( *pbVar1 != 0 ) ) || ( pbVar1[1] != 0 )) {
            LAB_00102a28:*param_2 = uVar4;
            *(uint*)( param_1 + 0x2f8 ) = ( uint ) * pbVar1;
            iVar5 = RECORD_LAYER_is_sslv2_record(param_1 + 0xc58);
            if (iVar5 == 0) {
               *(ulong*)( param_1 + 0x2f0 ) = (ulong)pbVar1[1] << 0x10 | (ulong)pbVar1[2] << 8 | (ulong)pbVar1[3];
         ...
         *(undefined8*)( param_1 + 0x108 ) = 0;
         ...
         ( **(code**)( param_1 + 0x4f8 ) )(0, *(undefined4*)( param_1 + 0x48 ), 0x16, pbVar1, 4, uVar6, *(undefined8*)( param_1 + 0x500 ));
         uVar2 = *(ulong*)( param_1 + 0x108 );
      }
;
      iVar5 = ( **(code**)( *(long*)( param_1 + 0x18 ) + 0x80 ) )(param_1, 0x16, &local_39, pbVar1 + uVar2, 4 - uVar2, 0, &local_38);
      if (iVar5 < 1) {
         *(undefined4*)( param_1 + 0x68 ) = 3;
         LAB_00102aef:uVar6 = 0;
         LAB_00102a8c:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
            /* WARNING: Subroutine does not return */
            __stack_chk_fail();
         }
      ...
      if (local_39 == '\x14') {
         if (( ( *(long*)( param_1 + 0x108 ) == 0 ) && ( local_38 == 1 ) ) && ( *pbVar1 == 1 )) {
            if (( *(int*)( param_1 + 0xac ) == 0 ) && ( ( *(byte*)( param_1 + 0x161 ) & 8 ) != 0 )) goto LAB_00102aef;
...
undefined8 tls_get_message_body(long param_1, ulong *param_2) {
   ...
   for (lVar6 = *(long*)( param_1 + 0x2f0 ) - uVar5; lVar6 != 0; lVar6 = lVar6 - local_48) {
      iVar3 = ( **(code**)( *(long*)( param_1 + 0x18 ) + 0x80 ) )(param_1, 0x16, 0, lVar2 + uVar5, lVar6, 0, &local_48);
      if (iVar3 < 1) {
         *(undefined4*)( param_1 + 0x68 ) = 3;
         goto LAB_00102c8c;
      }
   ...
   if (( **(char**)( *(long*)( param_1 + 0xf8 ) + 8 ) == '\x14' ) && ( iVar3 = iVar3 == 0 )) {
      LAB_00102c8c:uVar5 = 0;
      uVar4 = 0;
   }
 else {
      ...
      if (iVar3 == 0) {
         ...
         if (( ( ( ( ( *(byte*)( *(long*)( *(int**)( param_1 + 0x18 ) + 0x36 ) + 0x50 ) & 8 ) != 0 ) || ( iVar1 = **(int**)( param_1 + 0x18 ) ),iVar1 < 0x304 ) ) || ( iVar1 == 0x10000 ) ) || ( ( iVar3 != 4 && ( iVar3 != 0x18 ) ) )) {
         ...
         if (*(code**)( param_1 + 0x4f8 ) != (code*)0x0) {
            ( **(code**)( param_1 + 0x4f8 ) )(0, *(undefined4*)( param_1 + 0x48 ), 0x16, *(undefined8*)( *(long*)( param_1 + 0xf8 ) + 8 ), uVar5 + 4, uVar4, *(undefined8*)( param_1 + 0x500 ));
            uVar5 = *(ulong*)( param_1 + 0x108 );
         }

      }
 else {
         iVar3 = ssl3_finish_mac(param_1, *(undefined8*)( *(long*)( param_1 + 0xf8 ) + 8 ), *(undefined8*)( param_1 + 0x108 ));
         if (iVar3 == 0) goto LAB_00102c8c;
         uVar5 = *(ulong*)( param_1 + 0x108 );
         if (*(code**)( param_1 + 0x4f8 ) != (code*)0x0) {
            ( **(code**)( param_1 + 0x4f8 ) )(0, 2, 0, *(undefined8*)( *(long*)( param_1 + 0xf8 ) + 8 ), uVar5, uVar4, *(undefined8*)( param_1 + 0x500 ));
            uVar5 = *(ulong*)( param_1 + 0x108 );
         }
...
uint ssl_method_error(long param_1, undefined4 *param_2) {
   ...
   if (( ( *(int*)( param_1 + 0x9bc ) == 0 ) || ( iVar2 = ssl_version_cmp(param_1, uVar1) ),-1 < iVar2 )) {
      ...
      uVar3 = 0x102;
      if (( ( *(ulong*)( param_1 + 0x9b0 ) & *(ulong*)( param_2 + 2 ) ) == 0 ) && ( uVar3 = 0(*(byte*)( param_2 + 1 ) & 2) != 0 )) {
...
bool ssl_version_supported(long param_1, ulong param_2, undefined8 *param_3) {
   ...
   do {
      ...
      if (( pcVar9 != (code*)0x0 ) && ( iVar3 = ssl_version_cmp(param_1, param_2 & 0xffffffff, *puVar8) ),iVar3 == 0) {
         uVar5 = ( *pcVar9 )();
         iVar3 = ssl_method_error(param_1, uVar5);
         if (iVar3 == 0) {
            if (( *(int*)( param_1 + 0x78 ) == 0 ) || ( (int)param_2 != 0x304 )) {
               LAB_001030f9:if (param_3 != (undefined8*)0x0) {
                  uVar5 = ( *pcVar9 )();
                  *param_3 = uVar5;
               }
            ...
            if (( *(long*)( param_1 + 8 ) != 0 ) && ( *(long*)( param_1 + 0xb88 ) != 0 )) {
               if (( ( ( *(long*)( *(long*)( param_1 + 8 ) + 0x230 ) != 0 ) || ( *(long*)( *(long*)( param_1 + 0xb88 ) + 0x230 ) != 0 ) ) || ( *(long*)( param_1 + 0x978 ) != 0 ) ) || ( ( *(long*)( param_1 + 0x980 ) != 0 || ( *(long*)( *(long*)( param_1 + 0x880 ) + 0x60 ) != 0 ) ) )) goto LAB_001030f9;
               uVar7 = *(ulong*)( param_1 + 0x118 );
               if (uVar7 != 0) {
                  uVar10 = 0;
                  do {
                     if (( ( uVar10 != 2 ) && ( 2 < uVar10 - 4 ) ) && ( ( iVar3 = (int)uVar10 ),-1 < iVar3 && ( iVar3 < (int)uVar7 ) )) {
                        if (*(int*)( param_1 + 0x78 ) == 0) {
                        ...
                        if (( ( ( pvVar6 != (void*)0x0 ) && ( pvVar6 = memchr(pvVar6, 2, __n) ),pvVar6 != (void*)0x0 ) ) || ( *plVar1 != 0 )) {
...
bool ssl_check_version_downgrade(long param_1) {
   ...
   LAB_001032e0:do {
      if (*(code**)( piVar5 + 4 ) != (code*)0x0) {
         ...
         uVar1 = *puVar4;
         if (( ( ( *(int*)( param_1 + 0x9bc ) == 0 ) || ( iVar2 = ssl_version_cmp(param_1, uVar1) ),-1 < iVar2 ) ) && ( iVar2 = iVar2 != 0 )) {
            if (( *(ulong*)( param_1 + 0x9b0 ) & *(ulong*)( puVar4 + 2 ) ) == 0) {
               if (( ( puVar4[1] & 2 ) == 0 ) || ( ( *(uint*)( *(long*)( param_1 + 0x880 ) + 0x1c ) & 0x30000 ) == 0 )) {
...
undefined8 ssl_choose_server_version(long param_1, long param_2, uint *param_3) {
 ...
 while ( (byte*)0x1 < pbVar4 + ( uVar14 - (long)pbVar13 ) );
         ...
         if (local_5c != 0) {
            if (*(int*)( param_1 + 0x8d0 ) == 0) {
               if (local_5c == 0x303) {
                  ...
                  uVar7 = 0;
                  if (( ( ( *(byte*)( *(long*)( *(long*)( param_1 + 0x18 ) + 0xd8 ) + 0x50 ) & 8 ) == 0 ) && ( local_5c < 0x303 ) ) && ( iVar8 = iVar8 != 0 )) {
                     uVar7 = 2;
                  }
      ...
      piVar12 = &tls_version_table;
      LAB_001034cb:if (*(int*)( param_1 + 0x8d0 ) == 0) {
         LAB_001034d5:iVar6 = ssl_version_cmp(param_1, iVar8, 0x304);
         if (-1 < iVar6) {
            iVar8 = 0x303;
         }
         ...
         if (*piVar12 != 0) {
            bVar5 = false;
            do {
               if (( *(long*)( piVar12 + 4 ) != 0 ) && ( iVar6 = -1 < iVar6 )) {
                  ...
                  if (iVar6 == 0) {
                     if (*piVar12 == 0x303) {
                        ...
                        if (( ( *(byte*)( *(long*)( *(long*)( param_1 + 0x18 ) + 0xd8 ) + 0x50 ) & 8 ) == 0 ) && ( *piVar12 < 0x303 )) {
                           iVar8 = ssl_version_supported(param_1, 0x303, 0);
                           uVar7 = 2;
                           if (iVar8 != 0) goto LAB_00103685;
                        }

                        LAB_00103683:uVar7 = 0;
                     }

                     LAB_00103685:*param_3 = uVar7;
                     iVar8 = *piVar12;
 ...
 while ( *piVar2 != 0 );
   ...
   LAB_0010354e:uVar9 = 0x102;
   LAB_00103553:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
         ...
         *param_3 = 0;
         ...
         LAB_00103908:do {
            if (*(code**)( piVar6 + 2 ) == (code*)0x0) {
               ...
               iVar3 = *piVar4;
               if (( ( ( ( *(int*)( param_1 + 0x9bc ) == 0 ) || ( iVar2 = ssl_version_cmp(param_1, iVar3) ),-1 < iVar2 ) ) && ( iVar2 = ssl_security(param_1, 9, 0, iVar3, 0) ),iVar2 != 0 )) &&( ( *(int*)( param_1 + 0x9c0 ) == 0 || ( iVar3 = ssl_version_cmp(param_1, iVar3) ),iVar3 < 1 ) ) && ( ( ( *(ulong*)( param_1 + 0x9b0 ) & *(ulong*)( piVar4 + 2 ) ) == 0 && ( ( ( *(byte*)( piVar4 + 1 ) & 2 ) == 0 || ( ( *(uint*)( *(long*)( param_1 + 0x880 ) + 0x1c ) & 0x30000 ) == 0 ) ) ) ) )(bVar1);
               {
...
undefined8 tls_setup_handshake(SSL *param_1) {
      ...
      *(undefined1(*) [16])( (long)&param_1[3].tlsext_hostname + 5 ) = (undefined1[16])0x0;
      ...
      if (iVar7 == 0) {
         if (pSVar4[6].ssl_shutdown == (_func_3061*)0x0) {
            iVar7 = ssl_version_cmp(param_1, local_34, ( -(uint)((*(uint *)(*(long *)&param_1->wbio[1].ex_data.dummy + 0x50)
                                         & 8) == 0) & 0xffff0403 ) + 0xfeff);
            if (iVar7 < 1) {
               ERR_new();
               ERR_set_debug("ssl/statem/statem_lib.c", 0xa7, "tls_setup_handshake");
               ossl_statem_fatal(param_1, 0x28, 0x129, "The max supported SSL/TLS version needs the MD5-SHA1 digest but it is not available in the loaded providers. Use (D)TLSv1.2 or above, or load different providers");
            }
 else {
               uVar9 = *(uint*)( *(long*)&param_1->wbio[1].ex_data.dummy + 0x50 ) & 8;
               iVar7 = ssl_version_cmp(param_1, local_38, ( -(uint)(uVar9 == 0) & 0xffff0406 ) + 0xfefd);
               if (( -1 < iVar7 ) || ( lVar12 = SSL_ctrl(param_1, 0x7b, ( -(ulong)(uVar9 == 0) & 0xffffffffffff0406 ) + 0xfefd, (void*)0x0) ),(int)lVar12 != 0) goto LAB_00103b14;
               ERR_new();
            ...
            LAB_00103b14:if (*(int*)&param_1->s2 == 0) {
               if (( param_1->tls_session_ticket_ext_cb_arg == (void*)0x0 ) || ( lVar12._0_4_ = param_1[1].server ),lVar12._4_4_ = param_1[1].new_session,lVar12 == 0) {
                  LOCK();
            ...
            for (iVar7 = 0; iVar8 = OPENSSL_sk_num(psVar11),iVar7 < iVar8; iVar7 = iVar7 + 1) {
               ...
               if (( -1 < iVar8 ) && ( iVar8 = iVar8 < 1 )) {
                  if (( param_1->tls_session_ticket_ext_cb_arg == (void*)0x0 ) || ( lVar6._0_4_ = param_1[1].server ),lVar6._4_4_ = param_1[1].new_session,lVar6 == 0) {
                     LOCK();
   ...
   uVar10 = 0;
   LAB_00103ab2:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 ssl_choose_client_version(long param_1, undefined4 param_2, undefined8 param_3) {
   undefined4 uVar1;
   int iVar2;
   undefined8 uVar3;
   int *piVar4;
   ...
   if (iVar2 == 0) {
      *(undefined4*)( param_1 + 0x48 ) = uVar1;
      ...
      if (iVar2 == 0x10000) {
         ...
         if (iVar2 != 0x1ffff) {
            if (iVar2 == *(int*)( param_1 + 0x48 )) {
               ...
               if (iVar2 != 0) {
                  LAB_00104026:uVar3 = 1;
                  goto LAB_00103ec9;
               }

               ERR_new();
               uVar3 = 0x923;
               LAB_001040f1:ERR_set_debug("ssl/statem/statem_lib.c", uVar3, "ssl_choose_client_version");
               ossl_statem_fatal(param_1, 0x50, 0xc0103, 0);
               goto LAB_00103ec7;
            }
      ...
      if (iVar2 == 0) {
         ...
         if (iVar2 < 0) {
            LAB_00104050:*(undefined4*)( param_1 + 0x48 ) = uVar1;
            ERR_new();
            uVar3 = 0x938;
         }
 else {
            ...
            if (iVar2 == 0x303) {
               if (( local_34 < 0x304 ) || ( *(long*)( param_1 + 0x180 ) != _tls12downgrade )) goto LAB_00103ff4;
               *(undefined4*)( param_1 + 0x48 ) = uVar1;
               ERR_new();
               uVar3 = 0x946;
               LAB_00103fb5:ERR_set_debug("ssl/statem/statem_lib.c", uVar3, "ssl_choose_client_version");
               ossl_statem_fatal(param_1, 0x2f, 0x175, 0);
               goto LAB_00103ec7;
            }

            if (( ( ( ( *(byte*)( *(long*)( *(long*)( param_1 + 0x18 ) + 0xd8 ) + 0x50 ) & 8 ) == 0 ) && ( iVar2 < 0x303 ) ) && ( iVar2 < local_34 ) ) && ( _tls11downgrade == *(long*)( param_1 + 0x180 ) )) {
               *(undefined4*)( param_1 + 0x48 ) = uVar1;
               ERR_new();
               uVar3 = 0x952;
               goto LAB_00103fb5;
            ...
            LAB_00103ff4:for (; *piVar4 != 0; piVar4 = piVar4 + 6) {
      ...
      *(undefined4*)( param_1 + 0x48 ) = uVar1;
      ERR_new();
      uVar3 = 0x910;
      LAB_00103ea5:ERR_set_debug("ssl/statem/statem_lib.c", uVar3, "ssl_choose_client_version");
      ossl_statem_fatal(param_1, 0x46, 0x10a, 0);
   }

   LAB_00103ec7:uVar3 = 0;
   LAB_00103ec9:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar3;
   }
...
undefined8 ssl_set_client_hello_version(long param_1) {
 ...
 else if (( local_14 == 0x100 ) && ( iVar2 = ssl_set_record_protocol_version(param_1, 0x100) ),iVar2 == 0) goto LAB_0010420e;
      *(int*)( param_1 + 0x9d4 ) = local_14;
   }

   LAB_0010420e:uVar3 = 0;
   LAB_00104210:if (local_10 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 check_in_list(undefined8 param_1, short param_2, long param_3, ulong param_4, int param_5, ulong *param_6) {
   int iVar1;
   ulong uVar2;
 ...
 while ( uVar2 < param_4 );
         ...
         uVar2 = 0;
         do {
            if (( param_2 == *(short*)( param_3 + uVar2 * 2 ) ) && ( iVar1 = iVar1 != 0 )) {
               if (param_6 != (ulong*)0x0) {
                  LAB_001042cf:*param_6 = uVar2;
               }
...
bool create_synthetic_message_hash(long param_1, undefined1 *param_2, undefined8 param_3, long param_4, undefined8 param_5) {
   int iVar1;
   long in_FS_OFFSET;
   bool bVar2;
   ...
   if (param_2 == (undefined1*)0x0) {
      ...
      LAB_00104370:iVar1 = ssl3_init_finished_mac(param_1);
      if (iVar1 != 0) {
         ...
         if (( iVar1 != 0 ) && ( iVar1 = ssl3_finish_mac(param_1, param_2, local_90[0]) ),iVar1 != 0) {
            ...
            if (iVar1 != 0) {
               iVar1 = ssl3_finish_mac(param_1, *(undefined8*)( *(long*)( param_1 + 0xf8 ) + 8 ), *(long*)( param_1 + 0x2f0 ) + 4);
               bVar2 = iVar1 != 0;
               goto LAB_0010437e;
            }
   ...
   bVar2 = false;
   LAB_0010437e:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 parse_ca_names(long param_1, long *param_2) {
 ...
 while ( iVar2 != 0 );
      ...
      ERR_new();
      uVar7 = 0xa75;
      LAB_00104591:ERR_set_debug("ssl/statem/statem_lib.c", uVar7, "parse_ca_names");
      ossl_statem_fatal(param_1, 0x32, 0x9f, 0);
   }

   LAB_001045b3:a = (X509_NAME*)0x0;
   LAB_001045b6:OPENSSL_sk_pop_free(lVar3, X509_NAME_free);
   X509_NAME_free(a);
   uVar7 = 0;
   LAB_001045cf:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar7;
   }
...
undefined8 construct_ca_names(long param_1, long param_2, undefined8 param_3) {
   ...
   if (iVar1 == 0) {
      ...
      if (( param_2 != 0 ) && ( ( *(byte*)( param_1 + 0x9b1 ) & 2 ) == 0 )) {
         for (iVar1 = 0; iVar3 = OPENSSL_sk_num(param_2),iVar1 < iVar3; iVar1 = iVar1 + 1) {
            ...
            if (( ( ( a == (X509_NAME*)0x0 ) || ( iVar3 = i2d_X509_NAME(a, (uchar**)0x0) ),iVar3 < 0 ) ) || ( iVar2 = WPACKET_sub_allocate_bytes__(param_3, (long)iVar3, &local_48, 2) ),iVar2 == 0) {
               ERR_new();
               uVar4 = 0xac6;
               goto LAB_00104861;
            }
   ...
   LAB_00104861:ERR_set_debug("ssl/statem/statem_lib.c", uVar4, "construct_ca_names");
   ossl_statem_fatal(param_1, 0x50, 0xc0103, 0);
   uVar4 = 0;
   LAB_00104831:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 tls_process_finished(long param_1, undefined8 *param_2) {
   ...
   if (*(int*)( param_1 + 0x78 ) == 0) {
      LAB_00104af0:if (( *(byte*)( *(long*)( *(int**)( param_1 + 0x18 ) + 0x36 ) + 0x50 ) & 8 ) == 0) {
         iVar4 = **(int**)( param_1 + 0x18 );
      ...
      LAB_00104b50:if (*(int*)( param_1 + 0x1b8 ) == 0) {
         ERR_new();
      ...
      if (( ( *(byte*)( *(long*)( *(int**)( param_1 + 0x18 ) + 0x36 ) + 0x50 ) & 8 ) != 0 ) || ( iVar4 = iVar4 == 0x10000 )) goto LAB_00104b50;
      if (0x303 < iVar4) {
      ...
      LAB_00104b38:if (( iVar4 == 0x10000 ) || ( iVar4 < 0x304 )) goto LAB_00104b50;
   }
   ...
   *(undefined4*)( param_1 + 0x1b8 ) = 0;
   ...
   if (len == param_2[1]) {
      ...
      if (( ( ( *(byte*)( lVar2 + 0x50 ) & 8 ) == 0 ) && ( iVar1 = **(int**)( param_1 + 0x18 ) ),iVar1 != 0x10000 )) {
         if (iVar4 == 0) {
            iVar4 = ( **(code**)( lVar2 + 8 ) )(param_1, param_1 + 0x5fc, param_1 + 0x5bc, 0, auStack_38);
            if (( iVar4 == 0 ) || ( iVar4 = ( **(code**)( *(long*)( *(long*)( param_1 + 0x18 ) + 0xd8 ) + 0x10 ) )(param_1, 0x111) ),iVar4 == 0) goto LAB_00104c5b;
 ...
 else if (( *(int*)( param_1 + 0xba8 ) != 4 ) && ( iVar4 = iVar4 == 0 )) {
            uVar5 = 0;
            goto LAB_00104c00;
         }
      ...
      if (( ( ( bVar6 ) && ( *(long*)( param_1 + 0x260 ) != 0 ) ) && ( *(long*)( param_1 + 0x2e8 ) != 0 ) ) && ( pcVar3 = *(code**)( *(long*)( param_1 + 0xc70 ) + 0x70 ) ),pcVar3 != (code*)0x0) {
         ( *pcVar3 )(*(undefined8*)( param_1 + 0xc80 ), 0);
      }
      ...
      LAB_00104c5b:uVar5 = 0;
   }

   LAB_00104c00:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }

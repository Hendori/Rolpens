int evp_cipher_get_asn1_aead_params(undefined8 param_1, long param_2, void *param_3) {
   ...
   *(undefined8*)( param_1 + 0x78 ) = param_2;
   ...
   if (param_1->cipher[2].get_asn1_parameters == (_func_1093*)0x0) {
      ...
      if (( ( uVar2 & 0x800 ) != 0 ) && ( iVar1 = EVP_CIPHER_CTX_ctrl(param_1, 0x25, 0, &local_84) ),iVar1 < 1) goto LAB_00100822;
   } else {
   ...
   *(int*)&param_1->field_0x6c = local_84;
   ...
   if (param_1[0xe] == 0) {
      ...
      if (puVar3 != (undefined8*)0x0) {
         ...
         *puVar3 = *param_1;
         for (int i_805 = 0; i_805 < 14; i_805++) {
            puVar3[( 2*i_805 + 1 )] = uVar2;
            uVar2 = param_1[( 2*i_805 + 3 )];
            puVar3[( 2*i_805 + 2 )] = param_1[( 2*i_805 + 2 )];
         }
         puVar3[0x1d] = uVar2;

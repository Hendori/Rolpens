int get_parent_reseed_count(long param_1) {
   ...
   if (( ( *(long*)( param_1 + 0x30 ) == 0 ) || ( *(code**)( param_1 + 0x40 ) == (code*)0x0 ) ) || ( iVar2 = iVar2 != 0 )) {
   ...
   uVar2 = 0;
   LAB_00100232:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar2;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   if (*(long*)( ctx + 0x60 ) == 0) {
      ...
      if (iVar2 != 0) {
         if (*(uint*)( local_40 + 0x78 ) <= local_34) {
            ...
            if (( *(long*)( local_40 + 0x30 ) != 0 ) && ( pcVar1 = *(code**)( local_40 + 0x48 ) ),pcVar1 != (code*)0x0) {
   ...
   LAB_00100428:sVar3 = 0;
   LAB_0010042a:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return sVar3;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   return;
}bool ossl_prov_drbg_instantiate(DRBG_CTX *param_1, uint param_2, undefined8 param_3, char *param_4, ulong param_5) {
   uint entropy;
   long lVar1;
   int iVar2;
   ulong uVar3;
         ...
         *(undefined4*)( param_1 + 0xe8 ) = 2;
         ...
         if (*(code**)( param_1 + 0x58 ) == (code*)0x0) {
            ...
            if (puVar6 == (undefined8*)0x0) {
               LAB_00100bc9:uVar3 = 0;
               if (*(long*)( param_1 + 0x98 ) != 0) goto LAB_00100bb3;
            } else {
               if (( ( ( *(long*)( param_1 + 0x30 ) == 0 ) || ( *(code**)( param_1 + 0x58 ) == (code*)0x0 ) ) || ( uVar3 = ( **(code**)( param_1 + 0x58 ) )(*(long*)( param_1 + 0x30 ), 0, 0, *(undefined8*)( param_1 + 0x98 ), *(undefined8*)( param_1 + 0xa0 )) ),uVar3 == 0 )) {
                  LAB_00100b3f:local_50[0] = 0;
                  local_58 = param_1;
                  iVar2 = CRYPTO_atomic_add(puVar6 + 1, 1, local_50, *puVar6);
                  if (iVar2 == 0) goto LAB_00100bc9;
                  uVar3 = ossl_prov_get_nonce(*(undefined8*)( param_1 + 8 ), &local_68, uVar4, lVar1, &local_58, 0x10);
                  ptr = local_68;
               } else {
                  uVar7 = ( **(code**)( param_1 + 0x58 ) )(*(undefined8*)( param_1 + 0x30 ), ptr, 0, *(undefined8*)( param_1 + 0x98 ), *(undefined8*)( param_1 + 0xa0 ));
                  if (uVar3 != uVar7) {
                     CRYPTO_free(ptr);
                     goto LAB_00100b3f;
                  }
               ...
               if (( uVar3 < *(ulong*)( param_1 + 0x98 ) ) || ( *(ulong*)( param_1 + 0xa0 ) < uVar3 )) {
                  LAB_00100bb3:ERR_new();
                  uVar8 = 0x1a9;
                  goto LAB_00100aa9;
               }
            }
            LAB_001007a2:iVar2 = *(int*)( param_1 + 0xd0 );
            ...
            if (( olen < min_len ) || ( local_98 < olen )) {
               ...
               if (iVar2 == 0) {
                  ...
                  ERR_new();
                  ERR_set_debug("providers/implementations/rands/drbg.c", 0x1c3, "ossl_prov_drbg_instantiate");
            ...
            if (local_68 == (void*)0x0) {
               ...
               uVar4 = ( **(code**)( param_1 + 0x58 ) )(*(undefined8*)( param_1 + 0x30 ), local_68, *(undefined4*)( param_1 + 0x78 ), *(undefined8*)( param_1 + 0x98 ), *(undefined8*)( param_1 + 0xa0 ));
               if (uVar4 == uVar3) goto LAB_001007a2;
               ERR_new();
               uVar8 = 0x192;
            }
            LAB_00100aa9:ERR_set_debug("providers/implementations/rands/drbg.c", uVar8, "ossl_prov_drbg_instantiate");
            ERR_set_error(0x39, 0xbe, 0);
         }
         goto LAB_0010084e;
      }
   ...
   LAB_00100960:uVar3 = 0;
   LAB_0010084e:if (local_68 != (void*)0x0) {
   ...
   *(undefined4*)( param_1 + 0xe8 ) = 0;
   return 1;
}uint ossl_prov_drbg_reseed(DRBG_CTX *param_1, undefined8 param_2, long param_3, ulong param_4, long param_5, ulong param_6) {
   uint uVar1;
   int iVar2;
   undefined4 uVar3;
   size_t olen;
   ...
   if (iVar2 == 0) {
      ...
      if (iVar2 != 1) {
         ...
         if (iVar2 == 0) {
            LAB_00100ef1:ossl_prov_drbg_instantiate(param_1, *(undefined4*)( param_1 + 0x78 ), 0, 0, 0);
      ...
      LAB_00100d40:if (param_3 == 0) {
         LAB_00100d5f:if (param_5 == 0) {
            param_6 = 0;
         ...
         *(undefined4*)( param_1 + 0xe8 ) = 2;
         ...
         olen = get_entropy(param_1, &local_48, *(int*)( param_1 + 0x78 ), *(size_t*)( param_1 + 0x88 ), *(size_t*)( param_1 + 0x90 ));
   ...
   LAB_00100e9c:if (*(long*)param_1 != 0) {
      CRYPTO_THREAD_unlock();
   }
   LAB_00100eb1:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar1;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}undefined8 ossl_prov_drbg_generate(DRBG_CTX *param_1, undefined8 param_2, ulong param_3, uint param_4, int param_5, long param_6, ulong param_7) {
   long lVar1;
   int iVar2;
   undefined4 uVar3;
   size_t olen;
   ...
   iVar2 = *(int*)( param_1 + 0xe8 );
   if (iVar2 == 1) {
      LAB_00101155:if (*(uint*)( param_1 + 0x78 ) < param_4) {
         ERR_new();
         uVar5 = 0;
         ...
         if (( *(uint*)( param_1 + 0xbc ) != 0 ) && ( *(uint*)( param_1 + 0xbc ) <= *(uint*)( param_1 + 0xb8 ) )) {
            bVar6 = true;
         }
         if (*(long*)( param_1 + 200 ) < 1) {
            LAB_001011bb:if (*(long*)( param_1 + 0x30 ) != 0) {
               LAB_001011c6:iVar2 = get_parent_reseed_count(param_1);
               if (iVar2 != *(int*)( param_1 + 0xd8 )) goto LAB_001011da;
            }
            if (bVar6 || param_5 != 0) goto LAB_001011da;
            LAB_00101481:iVar2 = ( **(code**)( param_1 + 0x28 ) )(param_1, param_2, param_3, param_6, param_7);
            if (iVar2 == 0) {
               *(undefined4*)( param_1 + 0xe8 ) = 2;
               uVar5 = 0;
               ERR_new();
            ...
            LAB_001011da:local_48 = (uchar*)0x0;
            iVar2 = ossl_prov_is_running();
            if (iVar2 != 0) {
               iVar2 = *(int*)( param_1 + 0xe8 );
               if (iVar2 != 1) {
                  if (iVar2 == 2) {
                     ...
                     LAB_001016c5:ERR_new();
                     ERR_set_debug("providers/implementations/rands/drbg.c", 500, "ossl_prov_drbg_reseed_unlocked");
                     ERR_set_error(0x39, 0xc0, 0);
                     goto LAB_00101303;
                  }
                  if (iVar2 == 0) {
                     LAB_001015a1:ossl_prov_drbg_instantiate(param_1, *(undefined4*)( param_1 + 0x78 ), 0, 0, 0);
   ...
   LAB_001013ba:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return uVar5;
}ulong ossl_drbg_get_seed(long param_1, long *param_2, int param_3, ulong param_4, ulong param_5, undefined4 param_6) {
   int iVar1;
   long lVar2;
   ulong uVar3;
   long in_FS_OFFSET;
   ...
   long local_30;
   local_30 = *(long*)( in_FS_OFFSET + 0x28 );
   if (( -1 < param_3 ) && ( uVar3 = param_4 < uVar3 )) {
      param_4 = uVar3;
   }
   if (param_5 <= param_4) {
      param_4 = param_5;
   ...
   if (lVar2 != 0) {
      iVar1 = ossl_prov_drbg_generate(local_38, lVar2, param_4, *(undefined4*)( local_38 + 0x78 ), param_6, &local_38);
      if (iVar1 != 0) {
         *param_2 = lVar2;
         goto LAB_001017f5;
      }
   ...
   param_4 = 0;
   LAB_001017f5:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_4;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   if (*param_1 == 0) {
      if (( (code*)param_1[7] != (code*)0x0 ) && ( iVar1 = iVar1 == 0 )) {
         ERR_new();
   ...
   return 1;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */long ossl_rand_drbg_new(undefined8 param_1, long param_2, int *param_3, code *param_4, code *param_5, undefined8 param_6, undefined8 param_7, undefined8 param_8, undefined8 param_9) {
   int *piVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   int iVar4;
   ...
   if (( iVar4 != 0 ) && ( lVar6 = CRYPTO_zalloc(0x120, "providers/implementations/rands/drbg.c", 0x324) ),lVar6 != 0) {
   ...
   lVar6 = 0;
   LAB_00101b47:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return lVar6;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   if (lVar2 == 0) {
      LAB_00101c3a:lVar2 = OSSL_PARAM_locate(param_2, "strength");
      if (lVar2 != 0) {
   ...
   if (( lVar2 != 0 ) && ( iVar1 = OSSL_PARAM_set_uint(lVar2, *(undefined4*)( param_1 + 0xd0 )) ),lVar4 = lVar3,iVar1 == 0) {
      return 0;
   }

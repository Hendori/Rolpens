void set_legacy_nid(char *param_1, int *param_2) {
   ...
   return;
}/* WARNING: Unknown calling convention -- yet parameter storage is locked */EVP_CIPHER_CTX *EVP_CIPHER_CTX_new(void) {
   ...
   return pEVar1;
}undefined8 EVP_CipherPipelineUpdate(long *param_1, undefined8 param_2, long param_3, undefined8 param_4, undefined8 param_5, long param_6) {
   long lVar1;
   code *pcVar2;
   ulong uVar3;
   undefined8 uVar4;
   ...
   if (param_3 == 0) {
      ...
      if (lVar1 == 0) {
         ...
         if (UNRECOVERED_JUMPTABLE != (code*)0x0) {
            ...
            for (int i_1292 = 0; i_1292 < 2; i_1292++) {
   ...
   return ( ( ulong ) - (long)param_3 < ( ulong )(param_1 - param_2) || ( ulong )(param_1 - param_2) < (ulong)(long)param_3 ) && ( 0 < param_3 && param_1 != param_2 );
}bool evp_EncryptDecryptUpdate(EVP_CIPHER_CTX *param_1, long param_2, uint *param_3, void *param_4, uint param_5) {
   ulong uVar1;
   int iVar2;
   EVP_CIPHER *pEVar3;
   uint uVar4;
   ...
   if (iVar2 == 0) {
      ...
      LAB_001003eb:iVar2 = ossl_is_partially_overlapping(param_1->buf_len + param_2, param_4, uVar4);
      if (iVar2 == 0) {
         ...
         if (iVar2 == 0) {
            ...
            if (0x20 < (int)uVar7) {
               LAB_0010075d:/* WARNING: Subroutine does not return */OPENSSL_die("assertion failed: bl <= (int)sizeof(ctx->buf)", "crypto/evp/evp_enc.c", 0x3a3);
            }
            *param_3 = 0;
            uVar7 = uVar7 - 1 & param_5;
            uVar4 = param_5 - uVar7;
            if (0 < (int)uVar4) {
               LAB_00100663:iVar2 = ( *param_1->cipher->cleanup )(param_1);
               if (iVar2 == 0) {
                  return false;
               }
            ...
            *param_3 = uVar7;
            ...
            LAB_001004a8:if (uVar7 == 0) goto LAB_001004b1;
         }
         memcpy(param_1->buf, (void*)( (long)param_4 + (long)(int)uVar4 ), (long)(int)uVar7);
         LAB_001004b1:param_1->buf_len = uVar7;
         return true;
      }
      ERR_new();
      uVar5 = 0x395;
      LAB_00100549:ERR_set_debug("crypto/evp/evp_enc.c", uVar5, "evp_EncryptDecryptUpdate");
      ...
      if (ctx->encrypt == 0) {
         ...
         if (pEVar1 == (EVP_CIPHER*)0x0) {
            ...
            if (( iVar2 < 1 ) || ( pEVar1[1].ctrl == (_func_1094*)0x0 )) {
               ERR_new();
               uVar3 = 0x3f0;
               LAB_00100849:ERR_set_debug("crypto/evp/evp_enc.c", uVar3, "EVP_EncryptUpdate");
               ERR_set_error(6, 0xbd, 0);
            } else {
   ...
   LAB_0010081a:if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar2;
   }
   LAB_0010095a:/* WARNING: Subroutine does not return */__stack_chk_fail();
      ...
      if (ctx->encrypt == 0) {
         ...
         if (pEVar6 == (EVP_CIPHER*)0x0) {
            ...
            if (inl < 1) {
               ...
               LAB_00100f70:if (uVar3 == 1) {
                  iVar2 = ossl_is_partially_overlapping(out, in, inl);
                  if (iVar2 != 0) {
                     ERR_new();
                     uVar11 = 0x49f;
                     LAB_0010100c:ERR_set_debug("crypto/evp/evp_enc.c", uVar11, "EVP_DecryptUpdate");
                     ERR_set_error(6, 0xa2, 0);
                     uVar3 = 0;
                     goto LAB_00100ceb;
                  }
               ...
               *outl = iVar2;
               ...
               LAB_00100e46:if (( ctx->flags & 0x100 ) != 0) {
                     ...
                     if (uVar3 < 8) {
                        if (( uVar3 & 4 ) == 0) {
                           if (( uVar3 != 0 ) && ( *out = ctx->final[0](uVar3 & 2) != 0 )) {
                              *(undefined2*)( out + ( (ulong)uVar3 - 2 ) ) = *(undefined2*)( ctx->final + ( (ulong)uVar3 - 2 ) );
                           }
                        } else {
                           *(undefined4*)out = *(undefined4*)ctx->final;
                           *(undefined4*)( out + ( (ulong)uVar3 - 4 ) ) = *(undefined4*)( ctx->final + ( (ulong)uVar3 - 4 ) );
                        }
                     } else {
                        *(undefined8*)out = *(undefined8*)ctx->final;
                        *(undefined8*)( out + ( (ulong)uVar3 - 8 ) ) = *(undefined8*)( ctx->final + ( (ulong)uVar3 - 8 ) );
                        ...
                        if (7 < uVar5) {
                           ...
                           do {
                              uVar10 = (ulong)uVar8;
                              uVar8 = uVar8 + 8;
                              *(undefined8*)( ( ( ulong )(out + 8) & 0xfffffffffffffff8 ) + uVar10 ) = *(undefined8*)( (long)ctx + uVar10 + ( 0x88 - lVar7 ) );
                           } while ( uVar8 < uVar5 );
                        }
                     }
                     out = out + (int)uVar3;
               ...
               LAB_00100eec:iVar4 = evp_EncryptDecryptUpdate(ctx, out, outl, in);
                  ...
                  if (uVar3 < 8) {
                     if (( uVar3 & 4 ) == 0) {
                        if (( uVar3 != 0 ) && ( ctx->final[0] = *puVar12(uVar3 & 2) != 0 )) {
                           *(undefined2*)( ctx->final + ( (ulong)uVar3 - 2 ) ) = *(undefined2*)( puVar12 + ( (ulong)uVar3 - 2 ) );
                        }
                     } else {
                        *(undefined4*)ctx->final = *(undefined4*)puVar12;
                        *(undefined4*)( ctx->final + ( (ulong)uVar3 - 4 ) ) = *(undefined4*)( puVar12 + ( (ulong)uVar3 - 4 ) );
                     }
                  } else {
                     *(undefined8*)ctx->final = *(undefined8*)puVar12;
                     uVar10 = ( ulong )(ctx->final + 8) & 0xfffffffffffffff8;
                     *(undefined8*)( ctx->final + ( (ulong)uVar3 - 8 ) ) = *(undefined8*)( puVar12 + ( (ulong)uVar3 - 8 ) );
            ...
            if (( iVar2 < 1 ) || ( p_Var1 == (_func_1094*)0x0 )) {
               ERR_new();
               uVar11 = 0x484;
               LAB_00100d21:ERR_set_debug("crypto/evp/evp_enc.c", uVar11, "EVP_DecryptUpdate");
               ERR_set_error(6, 0xbd, 0);
            } else {
               ptr = (void*)( (long)iVar2 + (long)inl );
               if (iVar2 == 1) {
   ...
   LAB_001011d4:/* WARNING: Subroutine does not return */__stack_chk_fail();
                  ...
                  if (( ctx->flags & 0x100 ) == 0) {
                     if (1 < uVar2) {
                        if (( ctx->buf_len == 0 ) && ( ctx->final_used != 0 )) {
                           if (0x20 < uVar2) {
                              /* WARNING: Subroutine does not return */
                              OPENSSL_die("assertion failed: b <= sizeof(ctx->final)", "crypto/evp/evp_enc.c", 0x537);
                           }
                           ...
                           if (( bVar1 != 0 ) && ( uVar9 = (ulong)uVar2 ),(int)(uint)bVar1 <= (int)uVar2) {
                              ...
                              if (iVar5 != 0) {
                                 if (( iVar5 - 1U < 7 ) || ( ( ulong )((long)outm - (long)( ctx->final + 1 )) < 0xf )) {
                                    ...
                                    iVar12 = 0;
                                    iVar8 = iVar5;
                                    LAB_00101609:iVar12 = iVar12 + 8;
                                    *(undefined8*)( outm + lVar7 ) = *(undefined8*)( ctx->final + lVar7 );
                                    if (iVar8 != 8) {
                                       LAB_0010161e:outm[iVar12] = ctx->final[iVar12];
                                       iVar8 = iVar12 + 1;
                                       if (iVar8 < iVar5) {
                           ...
                           ERR_new();
                           uVar11 = 0x53f;
                           LAB_001014fd:ERR_set_debug("crypto/evp/evp_enc.c", uVar11, "EVP_DecryptFinal_ex");
   ...
   LAB_001012f1:iVar5 = 0;
   LAB_001012f3:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return iVar5;
   ...
   if (pEVar1[1].do_cipher == (_func_1090*)0x0) {
      if ((code*)pEVar1->app_data != (code*)0x0) {
         type = ( *(code*)pEVar1->app_data )(ctx, CONCAT44(in_register_00000034, type), CONCAT44(in_register_00000014, arg), ptr);
         goto LAB_00101935;
      }
      ERR_new();
...
LAB_00101f04:
   ...
   LAB_001018f0:type = 0;
   LAB_001018f2:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return type;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   if (( param_1 != 0 ) && ( *(code**)( param_1 + 0xe8 ) != (code*)0x0 )) {
      for (int i_1293 = 0; i_1293 < 2; i_1293++) {
   ...
   code *UNRECOVERED_JUMPTABLE;
   undefined8 uVar1;
   if (( *param_1 != 0 ) && ( UNRECOVERED_JUMPTABLE = *(code**)( *param_1 + 0xf0 ) ),UNRECOVERED_JUMPTABLE != (code*)0x0) {
      for (int i_1294 = 0; i_1294 < 2; i_1294++) {
   ...
   if (UNRECOVERED_JUMPTABLE != (code*)0x0) {
      ...
      for (int i_1295 = 0; i_1295 < 2; i_1295++) {
   ...
   if (*(long*)( param_1 + 0x110 ) != 0) {
      uVar1 = EVP_CIPHER_get0_provider();
      uVar1 = ossl_provider_ctx(uVar1);
      for (int i_1296 = 0; i_1296 < 2; i_1296++) {
   ...
   if (x->cipher[1].do_cipher == (_func_1090*)0x0) {
      ...
      if (iVar1 != keylen) {
         ...
         LAB_0010245a:x->key_len = keylen;
      }
      LAB_0010245d:iVar1 = 1;
   } else {
      ...
      if (lVar3 == 0) {
         ERR_new();
         uVar2 = 0x55d;
         LAB_0010241d:ERR_set_debug("crypto/evp/evp_enc.c", uVar2, "EVP_CIPHER_CTX_set_key_length");
   ...
   LAB_001024b6:/* WARNING: Subroutine does not return */__stack_chk_fail();
   ...
   if (*(long*)( param_1 + 0x108 ) != 0) {
      uVar1 = EVP_CIPHER_get0_provider();
      uVar1 = ossl_provider_ctx(uVar1);
      for (int i_1297 = 0; i_1297 < 2; i_1297++) {
   ...
   if (*(long*)( *param_1 + 0x110 ) != 0) {
      uVar1 = EVP_CIPHER_get0_provider();
      uVar1 = ossl_provider_ctx(uVar1);
      for (int i_1298 = 0; i_1298 < 2; i_1298++) {
   ...
   if (*(long*)( *param_1 + 0x108 ) != 0) {
      uVar1 = EVP_CIPHER_get0_provider();
      uVar1 = ossl_provider_ctx(uVar1);
      for (int i_1299 = 0; i_1299 < 2; i_1299++) {
   ...
   evp_generic_fetch(param_1, 2, param_2, param_3, evp_cipher_from_algorithm, evp_cipher_up_ref, evp_cipher_free);
   return;
}void evp_cipher_fetch_from_prov(undefined8 param_1, undefined8 param_2, undefined8 param_3) {
   evp_generic_fetch_from_prov(param_1, 2, param_2, param_3, evp_cipher_from_algorithm, evp_cipher_up_ref, evp_cipher_free);
   return;
   ...
   *(int*)( param_1 + 0x80 ) = *(int*)( param_1 + 0x80 ) + 1;
   ...
   lVar1 = *param_1;
   if (lVar1 == 0) {
      LAB_001028fd:ptr = (void*)param_1[0xf];
   } else {
      ...
      if (( *(code**)( lVar1 + 0x30 ) != (code*)0x0 ) && ( uVar2 = ( **(code**)( lVar1 + 0x30 ) )() ),(int)uVar2 == 0) {
         return uVar2;
      }
   ...
   LAB_0010286a:*param_1 = 0;
   param_1[0x17] = 0;
   puVar4 = (undefined8*)( ( ulong )(param_1 + 1) & 0xfffffffffffffff8 );
   for (uVar3 = ( ulong )(( (int)param_1 - (int)(undefined8*)( ( ulong )(param_1 + 1) & 0xfffffffffffffff8 ) ) + 0xc0U >> 3); uVar3 != 0; uVar3 = uVar3 - 1) {
      *puVar4 = 0;
   ...
   *(undefined4*)( (long)param_1 + 0x6c ) = 0xffffffff;
   ...
   if (( in == (EVP_CIPHER_CTX*)0x0 ) || ( pEVar8 = in->cipher ),pEVar8 == (EVP_CIPHER*)0x0) {
      ...
      if (pEVar8[1].do_cipher == (_func_1090*)0x0) {
         if (( in->engine != (ENGINE*)0x0 ) && ( iVar4 = iVar4 == 0 )) {
            ERR_new();
         ...
         *(undefined8*)( out->final + 0x18 ) = *(undefined8*)( in->final + 0x18 );
         ...
         if (( ( pEVar8->flags & 0x400 ) != 0 ) && ( iVar4 = iVar4 == 0 )) {
            out->cipher = (EVP_CIPHER*)0x0;
            ERR_new();
...
}int EVP_CipherInit_SKEY(EVP_CIPHER_CTX *param_1, EVP_CIPHER *param_2, uchar *param_3, uchar *param_4, int param_5, int param_6) {
   ulong uVar1;
   code *pcVar2;
   int iVar3;
   ENGINE *pEVar4;
   ...
   if (param_2 == (EVP_CIPHER*)0x0) {
      ...
      ERR_set_error(6, 0x83, 0);
      LAB_00102ef3:iVar3 = 0;
   } else {
      if (( param_1->engine != (ENGINE*)0x0 ) || ( *(int*)&param_2->init == 2 )) {
         LAB_00102ec3:ERR_new();
         uVar6 = 0x1ff;
         LAB_00102ed4:ERR_set_debug("crypto/evp/evp_enc.c", uVar6, "evp_cipher_init_skey_internal");
         ERR_set_error(6, 0x86, 0);
         goto LAB_00102ef3;
      }
      ...
      if (pEVar5 != (EVP_CIPHER*)0x0) {
         ...
         CRYPTO_clear_free(param_1->cipher_data, (long)*(int*)&pEVar5->set_asn1_parameters, "crypto/evp/evp_enc.c", 0x209);
      ...
      LAB_00102dd6:if (param_2[1].do_cipher == (_func_1090*)0x0) {
         ERR_new();
         uVar6 = 0x21b;
         goto LAB_00102ed4;
      }
      ...
      if (( param_3 != (uchar*)0x0 ) && ( param_1->cipher[1].do_cipher != *(_func_1090**)( *(long*)( param_3 + 0x18 ) + 0x18 ) )) {
         ERR_new();
         uVar6 = 0x233;
         goto LAB_00102ed4;
      }
      if (( ( param_1->flags & 0x100 ) != 0 ) && ( iVar3 = iVar3 == 0 )) goto LAB_00102ef3;
      ...
      if (param_6 == 0) {
         ...
         if (UNRECOVERED_JUMPTABLE != (_func_1089*)0x0) {
            LAB_00102e67:if (param_3 != (uchar*)0x0) {
               param_3 = *(uchar**)( param_3 + 0x10 );
            }
            if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
               for (int i_1300 = 0; i_1300 < 2; i_1300++) {
                  /* WARNING: Could not recover jumptable at 0x00102ea6. Too many branches */
               }
               iVar3 = ( *UNRECOVERED_JUMPTABLE )((EVP_CIPHER_CTX*)param_1[1].engine, param_3, param_4, param_5);
               return iVar3;
            }
            goto LAB_00103140;
         }
   ...
   LAB_00103140:/* WARNING: Subroutine does not return */__stack_chk_fail();
}int evp_cipher_init_internal(EVP_CIPHER_CTX *param_1, EVP_CIPHER *param_2, ENGINE *param_3, ASN1_TYPE *param_4, uchar *param_5, int param_6, char param_7, long param_8) {
   undefined8 uVar1;
   code *pcVar2;
   _func_1090 *p_Var3;
   bool bVar4;
   ...
   if (param_6 == -1) {
      ...
      LAB_001035fd:pEVar9 = param_1->cipher;
   ...
   LAB_001031bb:if (param_7 == '\0') {
      if (param_1->engine == (ENGINE*)0x0) {
         if (param_3 == (ENGINE*)0x0) {
            LAB_00103359:local_c0 = ENGINE_get_cipher_engine(param_2->nid);
            if (param_1->engine == (ENGINE*)0x0) {
               pEVar9 = param_1->cipher;
               if (local_c0 != (ENGINE*)0x0) goto LAB_001031f4;
               LAB_0010337d:if (*(int*)&param_2->init != 2) {
                  pEVar12 = param_2;
                  ...
                  CRYPTO_clear_free(param_1->cipher_data, (long)*(int*)&pEVar9->set_asn1_parameters, "crypto/evp/evp_enc.c", 0xa7);
                  param_1->cipher_data = (void*)0x0;
                  goto LAB_001033d0;
               }
               ...
               LAB_0010370c:param_3 = (ENGINE*)0x0;
            } else {
               pEVar9 = param_1->cipher;
               ...
               LAB_00103700:param_3 = local_c0;
               if (local_c0 == (ENGINE*)0x0) goto LAB_0010370c;
               LAB_0010325d:param_2 = ENGINE_get_cipher(param_3, param_2->nid);
               if (param_2 == (EVP_CIPHER*)0x0) {
                  ERR_new();
                  uVar7 = 0x173;
                  goto LAB_001035a1;
            ...
            LAB_00103274:iVar5 = *(int*)&param_2->set_asn1_parameters;
            ...
            if (iVar5 < 1) {
               ...
               ERR_new();
               uVar7 = 0x192;
               LAB_001035a1:ERR_set_debug("crypto/evp/evp_enc.c", uVar7, "evp_cipher_init_internal");
               ERR_set_error(6, 0x86, 0);
               goto LAB_001035c0;
            }
         } else {
            pEVar9 = param_1->cipher;
            bVar4 = true;
            LAB_00103622:if (param_3 != (ENGINE*)0x0) {
               local_c0 = (ENGINE*)0x0;
               goto LAB_001031f9;
            }
         ...
         LAB_001032bb:pEVar9 = param_1->cipher;
         ...
         if (( pEVar9 == (EVP_CIPHER*)0x0 ) || ( param_2->nid != pEVar9->nid )) {
            ...
            local_c0 = (ENGINE*)0x0;
            LAB_001031f4:bVar4 = true;
            LAB_001031f9:if (*(EVP_CIPHER**)&param_1[1].encrypt == pEVar9) {
               param_1->cipher = (EVP_CIPHER*)0x0;
            }
            EVP_CIPHER_free();
            param_1[1].encrypt = 0;
            ...
            LAB_0010322a:if (param_1->cipher != (EVP_CIPHER*)0x0) {
               LAB_00103230:uVar8 = param_1->flags;
               EVP_CIPHER_CTX_reset(param_1);
               param_1->encrypt = uVar20;
               param_1->flags = uVar8;
            }
      ...
      LAB_001032c7:if (( ( pEVar9->block_size - 8U & 0xfffffff7 ) != 0 ) && ( pEVar9->block_size != 1 )) {
         /* WARNING: Subroutine does not return */
         OPENSSL_die("assertion failed: ctx->cipher->block_size == 1 || ctx->cipher->block_size == 8 || ctx->cipher->block_size == 16", "crypto/evp/evp_enc.c", 0x19e);
      }
      ...
      if (( uVar8 & 0x10 ) == 0) {
         ...
         if (iVar5 < 5) {
            ...
            if (0x10 < uVar6) {
               ERR_new();
               uVar7 = 0x1b9;
               LAB_00103d13:ERR_set_debug("crypto/evp/evp_enc.c", uVar7, "evp_cipher_init_internal");
               ...
               if (uVar6 < 8) {
                  if (( uVar6 & 4 ) == 0) {
                     if (( uVar6 != 0 ) && ( param_1->oiv[0] = *param_5(uVar6 & 2) != 0 )) {
                        *(undefined2*)( param_1->oiv + ( (ulong)uVar6 - 2 ) ) = *(undefined2*)( param_5 + ( (ulong)uVar6 - 2 ) );
                     }
                  } else {
                     *(undefined4*)param_1->oiv = *(undefined4*)param_5;
                     *(undefined4*)( param_1->oiv + ( (ulong)uVar6 - 4 ) ) = *(undefined4*)( param_5 + ( (ulong)uVar6 - 4 ) );
                  }
               } else {
                  uVar8 = ( ulong )(param_1->oiv + 8) & 0xfffffffffffffff8;
                  *(undefined8*)param_1->oiv = *(undefined8*)param_5;
                  *(undefined8*)( param_1->oiv + ( (ulong)uVar6 - 8 ) ) = *(undefined8*)( param_5 + ( (ulong)uVar6 - 8 ) );
            ...
            if (uVar6 < 8) {
               if (( uVar6 & 4 ) == 0) {
                  if (( uVar6 != 0 ) && ( param_1->iv[0] = param_1->oiv[0](uVar6 & 2) != 0 )) {
                     *(undefined2*)( param_1->oiv + (ulong)uVar6 + 0xe ) = *(undefined2*)( param_1->oiv + ( (ulong)uVar6 - 2 ) );
                  }
               } else {
                  *(undefined4*)param_1->iv = *(undefined4*)param_1->oiv;
                  *(undefined4*)( param_1->oiv + (ulong)uVar6 + 0xc ) = *(undefined4*)( param_1->oiv + ( (ulong)uVar6 - 4 ) );
               }
            } else {
               *(undefined8*)param_1->iv = *(undefined8*)param_1->oiv;
               *(undefined8*)( param_1->oiv + (ulong)uVar6 + 8 ) = *(undefined8*)( param_1->oiv + ( (ulong)uVar6 - 8 ) );
               ...
               if (7 < uVar6) {
                  ...
                  do {
                     uVar16 = (ulong)uVar15;
                     uVar15 = uVar15 + 8;
                     *(undefined8*)( uVar8 + uVar16 ) = *(undefined8*)( (long)param_1 + uVar16 + ( 0x18 - lVar19 ) );
                  } while ( uVar15 < uVar6 );
               }
            }
         } else {
               ...
               if (uVar6 < 8) {
                  if (( uVar6 & 4 ) == 0) {
                     if (( uVar6 != 0 ) && ( param_1->iv[0] = *param_5(uVar6 & 2) != 0 )) {
                        *(undefined2*)( param_1->oiv + (ulong)uVar6 + 0xe ) = *(undefined2*)( param_5 + ( (ulong)uVar6 - 2 ) );
                     }
                  } else {
                     *(undefined4*)param_1->iv = *(undefined4*)param_5;
                     *(undefined4*)( param_1->oiv + (ulong)uVar6 + 0xc ) = *(undefined4*)( param_5 + ( (ulong)uVar6 - 4 ) );
                  }
               } else {
      ...
      LAB_001032fe:pEVar9 = param_1->cipher;
      ...
      LAB_00103346:iVar5 = 1;
   } else {
      LAB_001033d0:pEVar12 = param_2;
      if (param_1->cipher != (EVP_CIPHER*)0x0) {
         uVar8 = param_1->flags;
         EVP_CIPHER_CTX_reset(param_1);
         param_1->encrypt = uVar20;
      ...
      LAB_001033ed:if (pEVar12[1].do_cipher == (_func_1090*)0x0) {
         pcVar18 = "NULL";
         if (pEVar12->nid != 0) {
      ...
      LAB_00103438:param_1->cipher = pEVar12;
      if (( param_7 == '\0' ) || ( iVar5 = iVar5 != 0 )) {
         ...
         if (( ( param_1->flags & 0x100 ) == 0 ) || ( iVar5 = iVar5 != 0 )) {
            if (param_8 != 0) {
               puVar10 = &local_b8;
            ...
            if (param_7 == '\0') {
               ...
               if (uVar20 == 0) {
                  ...
                  if (( param_4 == (ASN1_TYPE*)0x0 ) && ( UNRECOVERED_JUMPTABLE = pEVar9[3].init ),UNRECOVERED_JUMPTABLE != (_func_1089*)0x0) goto LAB_00103981;
                  ERR_new();
                  uVar7 = 0x143;
               } else {
                  UNRECOVERED_JUMPTABLE_00 = pEVar9[1].set_asn1_parameters;
                  if (UNRECOVERED_JUMPTABLE_00 != (_func_1092*)0x0) {
                     LAB_0010351d:if (param_5 != (uchar*)0x0) {
                     ...
                     if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
                        for (int i_1301 = 0; i_1301 < 2; i_1301++) {
                  ...
                  if (( param_4 == (ASN1_TYPE*)0x0 ) && ( UNRECOVERED_JUMPTABLE = (_func_1089*)pEVar9[3].flags ),UNRECOVERED_JUMPTABLE != (_func_1089*)0x0) {
                     LAB_00103981:iVar5 = 0;
                     if (param_5 != (uchar*)0x0) {
                        iVar5 = EVP_CIPHER_CTX_get_iv_length(param_1);
                     }
                     if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
                        for (int i_1302 = 0; i_1302 < 2; i_1302++) {
                           /* WARNING: Could not recover jumptable at 0x001039d4. Too many branches */
                        }
                        iVar5 = ( *UNRECOVERED_JUMPTABLE )((EVP_CIPHER_CTX*)param_1[1].engine, (uchar*)0x0, param_5, iVar5);
                        return iVar5;
                     }
                     goto LAB_00103e11;
                  }
      ...
      LAB_001035c0:iVar5 = 0;
   }
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar5;
   }
   LAB_00103e11:/* WARNING: Subroutine does not return */__stack_chk_fail();
}void EVP_CipherInit_ex2(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined4 param_5, undefined8 param_6) {
   ...
   return iVar1;
}undefined8 EVP_CipherPipelineEncryptInit(long *param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, ulong param_5, undefined8 param_6, undefined8 param_7) {
   int iVar1;
   undefined8 uVar2;
   if (param_5 < 0x21) {
      ...
      if (iVar1 != 0) {
         if (*(code**)( *param_1 + 0xb8 ) != (code*)0x0) {
            for (int i_1303 = 0; i_1303 < 2; i_1303++) {
               /* WARNING: Could not recover jumptable at 0x00103feb. Too many branches */
            }
            uVar2 = ( **(code**)( *param_1 + 0xb8 ) )(param_1[0x16], param_3, param_4, param_5, param_6, param_7);
            return uVar2;
         }
         ERR_new();
   ...
   return 0;
}undefined8 EVP_CipherPipelineDecryptInit(long *param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, ulong param_5, undefined8 param_6, undefined8 param_7) {
   int iVar1;
   undefined8 uVar2;
   if (param_5 < 0x21) {
      param_1[0x15] = param_5;
      ...
      if (iVar1 != 0) {
         if (*(code**)( *param_1 + 0xc0 ) != (code*)0x0) {
            for (int i_1304 = 0; i_1304 < 2; i_1304++) {
               /* WARNING: Could not recover jumptable at 0x001040f8. Too many branches */
            }
            uVar2 = ( **(code**)( *param_1 + 0xc0 ) )(param_1[0x16], param_3, param_4, param_5, param_6, param_7);
            return uVar2;
         }
         ERR_new();
   ...
   EVP_CIPHER_free();
   return;
}/* WARNING: Removing unreachable block (ram,0x001045e8) */int *evp_cipher_from_algorithm(int param_1, long param_2, long param_3) {
   int iVar1;
   int iVar2;
   int *piVar3;
   long lVar4;
   ...
   *(long*)( piVar3 + 0x1a ) = lVar4;
   if (lVar4 == 0) {
      LAB_001042ff:EVP_CIPHER_free(piVar3);
   } else {
      *(undefined8*)( piVar3 + 0x1c ) = *(undefined8*)( param_2 + 0x18 );
      ...
      if (iVar1 != 0) {
         ...
         do {
          ...
          break;
               for (int i_1305 = 0; i_1305 < 7; i_1305++) {
                  case 8:
          ...
          break;
               ...
               for (int i_1306 = 0; i_1306 < 4; i_1306++) {
                  case 0xf:
         ...
         if (iVar2 == 0) {
            ...
            LAB_0010427f:if (( ( 2 < iVar6 ) && ( *(long*)( piVar3 + 0x32 ) != 0 ) ) && ( *(long*)( piVar3 + 0x34 ) != 0 )) {
               LAB_001042a4:if (iVar7 == 2) {
            ...
            LAB_0010427b:if (iVar6 != 0) goto LAB_0010427f;
            goto LAB_001042a4;
         }
      }
      LAB_00104610:ERR_new();
   ...
   evp_generic_do_all(param_1, 2, param_2, param_3, evp_cipher_from_algorithm, evp_cipher_up_ref, evp_cipher_free);
   return;
}

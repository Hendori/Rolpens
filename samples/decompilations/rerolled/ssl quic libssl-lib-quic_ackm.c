void lh_OSSL_ACKM_TX_PKT_hfn_thunk(undefined8 param_1, code *UNRECOVERED_JUMPTABLE) {
   for (int i_1989 = 0; i_1989 < 2; i_1989++) {
   ...
   for (int i_1990 = 0; i_1990 < 2; i_1990++) {
   ...
   for (int i_1991 = 0; i_1991 < 2; i_1991++) {
   ...
   for (int i_1992 = 0; i_1992 < 2; i_1992++) {
         ...
         *(undefined8*)( param_1 + 0x168 ) = 0;
         if (*(code**)( param_1 + 0x940 ) != (code*)0x0) {
            if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
               for (int i_1993 = 0; i_1993 < 2; i_1993++) {

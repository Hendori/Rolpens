...
/* RemoteFilesystemClient::_remove_file(String const&) */undefined4 RemoteFilesystemClient::_remove_file(String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   undefined4 uVar4;
...
/* RemoteFilesystemClient::_update_cache_path(String&) */void RemoteFilesystemClient::_update_cache_path(RemoteFilesystemClient *this, String *param_1) {
   long *plVar1;
   char *pcVar2;
   long lVar3;
   char *pcVar4;
...
/* RemoteFilesystemClient::synchronize_with_server(String const&, int, String const&, String&) */undefined4 RemoteFilesystemClient::synchronize_with_server(String *param_1, int param_2, String *param_3, String *param_4) {
   long *plVar1;
   long *plVar2;
   long lVar3;
   undefined4 uVar4;
   ...
   if (*(int*)( param_1 + 0x34 ) != 0) {
      if (*(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( param_1 + 0x30 ) * 4 ) != 0) {
         memset(*(void**)( param_1 + 0x28 ), 0, ( ulong ) * (uint*)( hash_table_size_primes + ( ulong ) * (uint*)( param_1 + 0x30 ) * 4 ) << 2);
 ...
 while ( (uint)lVar5 < *(uint*)( param_1 + 0x34 ) );
   ...
   LAB_001004c0:Memory::free_static(pvVar6, false);
   ...
   *(undefined1(*) [16])( param_1 + 0x20 ) = (undefined1[16])0x0;
   LAB_00100492:*(undefined4*)( param_1 + 0x30 ) = 2;
   if (*(long*)( param_1 + 8 ) != 0) {
      LOCK();
...
/* RemoteFilesystemClient::_store_cache_file(Vector<RemoteFilesystemClient::FileCache> const&) */uint RemoteFilesystemClient::_store_cache_file(RemoteFilesystemClient *this, Vector *param_1) {
   long *plVar1;
   code *pcVar2;
   long lVar3;
   Object *pOVar4;
 ...
 while ( !bVar9 );
         ...
         _err_print_error("_store_cache_file", "core/io/remote_filesystem_client.cpp", 0x79, "Condition \"f.is_null()\" is true. Returning: ERR_FILE_CANT_OPEN", (String*)&local_58, 0, 0);
         pcVar5 = local_58;
         ...
         for (lVar7 = 0; ( local_ac = 0 ),lVar8 != 0 && ( lVar7 < *(long*)( lVar8 + -8 ) ); lVar7 = lVar7 + 1) {
            itos((long)&local_60);
            local_58 = "::";
            local_68 = 0;
            local_50 = 2;
            String::parse_latin1((StrRange*)&local_68);
            if (*(long*)( param_1 + 8 ) == 0) {
               LAB_00100940:lVar8 = 0;
               LAB_00100943:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar7, lVar8, "p_index", "size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
...
else{local_60 = 0;plVar1 = (long*)( local_a0 + -0x10 );if (local_a0 != 0) {
   do {
      lVar8 = *plVar1;
...
LAB_00100a4a:local_68 = 0;local_58 = "Unable to create base directory to store cache file: \'%s\'.";local_50 = 0x3a;String::parse_latin1((StrRange*)&local_68);vformat<String>((String*)&local_58, (StrRange*)&local_68, (StrRange*)&local_60);_err_print_error("_store_cache_file", "core/io/remote_filesystem_client.cpp", 0x76, "Condition \"err != OK && err != ERR_ALREADY_EXISTS\" is true. Returning: err", (String*)&local_58, 0, 0);pcVar5 = local_58;if (local_58 != (char*)0x0) {
   LOCK();
   plVar1 = (long*)( local_58 + -0x10 );
   *plVar1 = *plVar1 + -1;
   UNLOCK();
...
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* RemoteFilesystemClient::_store_file(String const&, LocalVector<unsigned char, unsigned int,
   false, false> const&, unsigned long&) */int RemoteFilesystemClient::_store_file(RemoteFilesystemClient *this, String *param_1, LocalVector *param_2, ulong *param_3) {
   long *plVar1;
   uint uVar2;
   long lVar3;
   ...
   *param_3 = 0;
   ...
   if (( *(long*)( this + 0x10 ) != 0 ) && ( *(int*)( this + 0x34 ) != 0 )) {
      ...
      if (uVar16 != 0) {
         ...
         do {
            if (uVar19 == uVar16) {
               cVar14 = String::operator ==((String*)( *(long*)( this + 0x10 ) + ( ulong ) * (uint*)( *(long*)( this + 0x18 ) + lVar20 * 4 ) * 8 ), (String*)&local_78);
 ...
 while ( ( uVar16 != 0 ) && ( auVar6._8_8_ = 0 ),auVar6._0_8_ = (ulong)uVar16 * lVar3,auVar10._8_8_ = 0,auVar10._0_8_ = uVar17,auVar7._8_8_ = 0,auVar7._0_8_ = ( ulong )(( uVar2 + iVar15 ) - SUB164(auVar6 * auVar10, 8)) * lVar3,auVar11._8_8_ = 0,auVar11._0_8_ = uVar17,uVar21 <= SUB164(auVar7 * auVar11, 8) );
      }
   ...
   LAB_00100dfb:FileAccess::open((String*)&local_70, (int)(String*)&local_80, (Error*)0x2);
 ...
 while ( !bVar22 );
      ...
      LAB_00101148:local_68 = 0;
      local_58 = "Unable to open file for writing to remote filesystem cache: \'%s\'.";
      local_50 = 0x41;
      String::parse_latin1((StrRange*)&local_68);
      vformat<String>((String*)&local_58, (StrRange*)&local_68, (StrRange*)&local_60);
      _err_print_error("_store_file", "core/io/remote_filesystem_client.cpp", 99, "Condition \"f.is_null()\" is true. Returning: ERR_FILE_CANT_OPEN", (String*)&local_58, 0, 0);
      pcVar13 = local_58;
      if (local_58 != (char*)0x0) {
         LOCK();
         plVar1 = (long*)( local_58 + -0x10 );
      ...
      ( **(code**)( *(long*)local_70 + 0x2d0 ) )(local_70, *(undefined8*)( param_2 + 8 ), *(undefined4*)param_2);
...
if (( ( local_70 != (Object*)0x0 ) && ( cVar14 = RefCounted::unreference() ),pOVar12 = local_70,cVar14 != '\0' )) &&( cVar14 = cVar14 != '\0' )(**(code**)( *(long*)pOVar12 + 0x140 ))(pOVar12);Memory::free_static(pOVar12, false);}lVar3 = local_78;if (local_78 != 0) {
   LOCK();
   plVar1 = (long*)( local_78 + -0x10 );
   *plVar1 = *plVar1 + -1;
   UNLOCK();
...
return iVar15;}/* CowData<String>::_copy_on_write() [clone .isra.0] */void CowData<String>::_copy_on_write(CowData<String> *this) {
   CowData *pCVar1;
   long lVar2;
   long lVar3;
   code *pcVar4;
...
/* CowData<RemoteFilesystemClient::FileCache>::_copy_on_write() [clone .isra.0] */void CowData<RemoteFilesystemClient::FileCache>::_copy_on_write(CowData<RemoteFilesystemClient::FileCache> *this) {
   long lVar1;
   code *pcVar2;
   undefined8 uVar3;
   undefined8 *puVar4;
...
/* Error CowData<unsigned char>::resize<false>(long) [clone .isra.0] */void CowData<unsigned_char>::resize<false>(CowData<unsigned_char> *this, long param_1) {
   ...
   LAB_001016fc:puVar8[-1] = param_1;
   return;
}
/* Vector<RemoteFilesystemClient::FileCache>::push_back(RemoteFilesystemClient::FileCache) [clone
   .isra.0] */void Vector<RemoteFilesystemClient::FileCache>::push_back(Vector<RemoteFilesystemClient::FileCache> *this, CowData *param_2) {
   CowData<char32_t> *this_00;
   undefined8 uVar1;
   int iVar2;
   long lVar3;
   ...
   iVar2 = CowData<RemoteFilesystemClient::FileCache>::resize<false>((CowData<RemoteFilesystemClient::FileCache>*)( this + 8 ), lVar3);
   if (iVar2 == 0) {
      if (*(long*)( this + 8 ) == 0) {
         lVar4 = -1;
         lVar3 = 0;
         ...
         lVar4 = lVar3 + -1;
         if (-1 < lVar4) {
            CowData<RemoteFilesystemClient::FileCache>::_copy_on_write((CowData<RemoteFilesystemClient::FileCache>*)( this + 8 ));
...
/* WARNING: Removing unreachable block (ram,0x00102ef4) *//* WARNING: Removing unreachable block (ram,0x00103992) *//* RemoteFilesystemClient::_synchronize_with_server(String const&, int, String const&, String&) */int RemoteFilesystemClient::_synchronize_with_server(RemoteFilesystemClient *this, String *param_1, int param_2, String *param_3, String *param_4) {
   Object *pOVar1;
   Object *pOVar2;
   String *pSVar3;
   undefined8 *puVar4;
 ...
 while ( !bVar38 );
   ...
   if (( ( local_108 != (Object*)0x0 ) && ( cVar14 = RefCounted::unreference() ),pOVar2 = local_108,cVar14 != '\0' )) &&( cVar14 = cVar14 != '\0' )(**(code**)( *(long*)pOVar2 + 0x140 ))(pOVar2);
   Memory::free_static(pOVar2, false);
}
this_00 = (StreamPeerTCP*)operator_new(0x1b0, "");StreamPeerTCP::StreamPeerTCP(this_00);postinitialize_handler((Object*)this_00);cVar14 = RefCounted::init_ref();local_1d8 = (Object*)0x0;if (cVar14 != '\0') {
...
;
 ...
 while ( uVar26 != 0x20 );
         ...
         if (iVar17 == 0) {
            ...
            local_e8 = "s3tc";
            LAB_00102331:local_108 = (Object*)0x0;
            pvStack_e0 = (void*)0x4;
            String::parse_latin1((StrRange*)&local_108);
            Vector<String>::push_back(local_168);
            pOVar2 = local_108;
 ...
 while ( lVar30 < *(long*)( lVar23 + -8 ) );
         ...
         local_140 = 0;
         if (( local_150[0] == 0 ) || ( lVar23 = lVar23 == 0 )) {
            StreamPeer::put_32(iVar16);
         }
 else {
            uVar26 = 0;
...
;
            ...
            if (local_108 == (Object*)0x0) {
               ...
               iVar17 = (int)*(long*)( local_108 + -8 ) + -1 + ( uint )((int)*(long*)( local_108 + -8 ) == 0);
            }
         ...
         if (iVar16 == 2) {
            ...
            iVar16 = StreamPeerTCP::get_status();
            if (iVar16 != 2) {
               _err_print_error("_synchronize_with_server", "core/io/remote_filesystem_client.cpp", 0xf2, "Condition \"tcp_client->get_status() != StreamPeerTCP::STATUS_CONNECTED\" is true. Returning: ERR_CONNECTION_ERROR", "Remote filesystem server disconnected while waiting for file list", 0, 0);
               goto LAB_001036d0;
            }
            ...
            if (uVar18 == 0) {
               ...
               do {
                  ...
                  if (cVar15 != '\0') {
                     _err_print_error("_synchronize_with_server", "core/io/remote_filesystem_client.cpp", 0xfb, "Condition \"file == String()\" is true. Returning: ERR_CONNECTION_ERROR", "Invalid file name received from remote filesystem.", 0, 0);
                     LAB_001033b6:pOVar2 = local_118;
                     if (local_118 != (Object*)0x0) {
                        LOCK();
                        pOVar1 = local_118 + -0x10;
                        *(long*)pOVar1 = *(long*)pOVar1 + -1;
                  ...
                  pOVar2 = local_118;
                  if (iVar16 != 2) {
                     _err_print_error("_synchronize_with_server", "core/io/remote_filesystem_client.cpp", 0xfd, "Condition \"tcp_client->get_status() != StreamPeerTCP::STATUS_CONNECTED\" is true. Returning: ERR_CONNECTION_ERROR", "Remote filesystem server disconnected while waiting for file info.", 0, 0);
                     goto LAB_001033b6;
                  }
                  ...
                  local_100 = lVar23;
                  if (local_118 == (Object*)0x0) {
                     LAB_00102e7c:local_108 = (Object*)0x0;
                     lStack_f8 = 0;
 ...
 while ( !bVar38 );
                     if (( lVar30 == -1 ) || ( local_108 = (Object*)0x0 ),local_118 == (Object*)0x0) goto LAB_00102e7c;
                     pOVar1 = local_118 + -0x10;
                     do {
                        lVar23 = *(long*)pOVar1;
 ...
 while ( !bVar38 );
                     ...
                     LAB_00102b06:uVar34 = *(ulong*)( local_120 + -8 );
                     if ((long)uVar34 <= (long)uVar26) goto LAB_001020a7;
                  }

                  if (plVar22[1] == 0 || cVar15 != '\0') {
                     ( **(code**)( *(long*)this + 0x18 ) )(this);
                     LAB_00102b32:lVar23 = local_180;
                     if (local_180 != 0) {
                        LOCK();
                     ...
                     if (uVar35 < (uint)local_138) {
                        ...
                        if (local_138._4_4_ < uVar35) {
                           ...
                           if (local_130 == (void*)0x0) {
                              _err_print_error("resize", "./core/templates/local_vector.h", 0xa3, "FATAL: Condition \"!data\" is true.", "Out of memory", 0, 0, in_R10);
                              _err_flush_stdout();
                              /* WARNING: Does not return */
 ...
 while ( !bVar38 );
                        ...
                        _err_print_error("_synchronize_with_server", "core/io/remote_filesystem_client.cpp", 0x11b, (String*)&local_108);
                        pOVar2 = local_108;
                        if (local_108 != (Object*)0x0) {
                           LOCK();
                           pOVar1 = local_108 + -0x10;
                        ...
                        LAB_001035b7:( **(code**)( *(long*)this + 0x18 ) )(this);
                        goto LAB_00102b32;
                     }
                     ...
                     if (*plVar22 == 0) {
                        local_100 = plVar22[1];
                        LAB_0010391d:local_108 = (Object*)0x0;
                        lStack_f8 = local_170;
                        Vector<RemoteFilesystemClient::FileCache>::push_back((Vector<RemoteFilesystemClient::FileCache>*)&local_118);
                     }
 else {
                        do {
                           lVar23 = *plVar37;
 ...
 while ( !bVar38 );
                        if (lVar30 == -1) {
                           LAB_0010396a:lStack_f8 = local_170;
                           Vector<RemoteFilesystemClient::FileCache>::push_back((Vector<RemoteFilesystemClient::FileCache>*)&local_118);
                        }
 else {
                           lStack_f8 = local_170;
               ...
               do {
                  ...
                  if (( local_1c0 != (char*)0x0 ) && ( local_c8._4_4_ != 0 )) {
                     ...
                     if (uVar19 != 0) {
                        ...
                        do {
                           if (( uVar35 == uVar19 ) && ( cVar14 = String::operator ==((String*)( local_1c0 + ( ulong ) * (uint*)( (long)pvStack_e0 + lVar30 * 4 ) * 8 ), pSVar3) ),cVar14 != '\0') goto LAB_00102ce5;
                           uVar36 = uVar36 + 1;
                           auVar6._8_8_ = 0;
 ...
 while ( ( uVar19 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = (ulong)uVar19 * lVar23,auVar11._8_8_ = 0,auVar11._0_8_ = uVar34,auVar8._8_8_ = 0,auVar8._0_8_ = ( ulong )(( uVar18 + iVar16 ) - SUB164(auVar7 * auVar11, 8)) * lVar23,auVar12._8_8_ = 0,auVar12._0_8_ = uVar34,uVar36 <= SUB164(auVar8 * auVar12, 8) );
                     }
                  ...
                  if (*plVar37 == 0) {
                     local_100 = plVar37[1];
                     lStack_f8 = plVar37[2];
                     Vector<RemoteFilesystemClient::FileCache>::push_back((Vector<RemoteFilesystemClient::FileCache>*)&local_118, (String*)&local_108);
                  }
 else {
                     do {
                        lVar23 = *plVar22;
 ...
 while ( !bVar38 );
                  ...
                  LAB_00102ce5:local_1c0 = local_e8;
                  uVar26 = uVar26 + 1;
               }
 while ( local_150[0] != 0 );
            }
            ...
            if (iVar16 == 0) {
               ...
               iVar16 = 0xc;
               _err_print_error("_synchronize_with_server", "core/io/remote_filesystem_client.cpp", 0x143, "Condition \"err != OK\" is true. Returning: ERR_FILE_CANT_OPEN", "Error writing the remote filesystem file cache.", 0, 0, ppOVar32);
            }

            CowData<RemoteFilesystemClient::FileCache>::_unref((CowData<RemoteFilesystemClient::FileCache>*)&local_110);
            LAB_00102d50:pcVar31 = local_e8;
            if (local_e8 != (char*)0x0) {
               if (local_c8._4_4_ != 0) {
                  if (*(uint*)( hash_table_size_primes + ( local_c8 & 0xffffffff ) * 4 ) != 0) {
                     memset((void*)local_d8._8_8_, 0, ( ulong ) * (uint*)( hash_table_size_primes + ( local_c8 & 0xffffffff ) * 4 ) * 4);
                  }
 ...
 while ( (uint)lVar23 < local_c8._4_4_ );
            ...
            LAB_00102df3:CowData<RemoteFilesystemClient::FileCache>::_unref((CowData<RemoteFilesystemClient::FileCache>*)&local_120);
            if (local_130 != (void*)0x0) {
               if ((uint)local_138 != 0) {
            ...
            _err_print_error("_synchronize_with_server", "core/io/remote_filesystem_client.cpp", 0xee, "Condition \"tcp_client->get_status() != StreamPeerTCP::STATUS_CONNECTED\" is true. Returning: ERR_CONNECTION_ERROR", "Remote filesystem server disconnected after sending header.", 0, 0);
            LAB_001036d0:iVar16 = 0x1b;
         }
         ...
         CowData<RemoteFilesystemClient::FileCache>::_unref((CowData<RemoteFilesystemClient::FileCache>*)local_150);
 ...
 while ( !bVar38 );
         ...
         LAB_00101bcb:local_108 = (Object*)0x0;
         ...
         _err_print_error("_synchronize_with_server", "core/io/remote_filesystem_client.cpp", 0xa5, "Method/function failed. Returning: ERR_CANT_CONNECT", (Variant*)&local_e8, 0, 0);
         pcVar31 = local_e8;
         if (local_e8 != (char*)0x0) {
            LOCK();
            plVar22 = (long*)( local_e8 + -0x10 );
 ...
 while ( !bVar38 );
      ...
      LAB_0010271e:local_108 = (Object*)0x0;
      local_e8 = "Unable to open connection to remote file server (%s, port %d) failed.";
      pvStack_e0 = (void*)0x45;
      String::parse_latin1((StrRange*)&local_108);
      vformat<String,int>((Variant*)&local_e8, (String*)&local_108, &local_118, param_2);
      _err_print_error("_synchronize_with_server", "core/io/remote_filesystem_client.cpp", 0x9d, "Condition \"err != OK\" is true. Returning: err", (Variant*)&local_e8, 0, 0);
      pcVar31 = local_e8;
      if (local_e8 != (char*)0x0) {
         LOCK();
         plVar22 = (long*)( local_e8 + -0x10 );
   ...
   LAB_00101d4c:local_108 = (Object*)0x0;
   plVar22 = (long*)( *(long*)param_1 + -0x10 );
   if (*(long*)param_1 != 0) {
      do {
         lVar23 = *plVar22;
 ...
 while ( !bVar38 );
   ...
   LAB_00101d8a:local_118 = (Object*)0x0;
   ...
   _err_print_error("_synchronize_with_server", "core/io/remote_filesystem_client.cpp", 0x9a, "Condition \"!ip.is_valid()\" is true. Returning: ERR_INVALID_PARAMETER", (Variant*)&local_e8, 0, 0);
   pcVar31 = local_e8;
   if (local_e8 != (char*)0x0) {
      LOCK();
      plVar22 = (long*)( local_e8 + -0x10 );
...
cVar14 = RefCounted::unreference();if (( cVar14 != '\0' ) && ( cVar14 = predelete_handler(local_1d8) ),cVar14 != '\0') {
   ( **(code**)( *(long*)local_1d8 + 0x140 ) )(local_1d8);
   Memory::free_static(local_1d8, false);
}
LAB_00101ca7:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return iVar16;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();LAB_00102536:uVar34 = 0;LAB_001020a7:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar26, uVar34, "p_index", "size()", "", false, true);_err_flush_stdout();/* WARNING: Does not return */pcVar25 = (code*)invalidInstructionException();( *pcVar25 )();}/* RemoteFilesystemClient::_load_cache_file() */RemoteFilesystemClient * __thiscall
RemoteFilesystemClient::_load_cache_file(RemoteFilesystemClient *this){
 ...
 while ( !bVar9 );
               ...
               LAB_00103dee:if (local_80 != (long*)0x0) {
                  lVar7 = local_80[-1];
                  goto LAB_00103e00;
               }

               lVar7 = 0;
               LAB_001040a3:lVar8 = 1;
               LAB_0010407d:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar8, lVar7, "p_index", "size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
               pcVar2 = (code*)invalidInstructionException();
               ( *pcVar2 )();
            ...
            LAB_00103e00:if (lVar7 < 2) goto LAB_001040a3;
            uVar6 = String::to_int();
            local_70._0_8_ = uVar6;
            if (local_80 == (long*)0x0) {
               lVar7 = 0;
               LAB_001040cb:lVar8 = 2;
               goto LAB_0010407d;
            }
...
;
      ...
      if (( ( local_b8 != (Object*)0x0 ) && ( cVar4 = RefCounted::unreference() ),cVar4 != '\0' )) &&( cVar4 = cVar4 != '\0' )(**(code**)( *(long*)local_b8 + 0x140 ))(local_b8);
...
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* RemoteFilesystemClient::_is_configured() */undefined8 RemoteFilesystemClient::_is_configured(RemoteFilesystemClient *this) {
   long lVar1;
   lVar1 = *(long*)( this + 8 );
   if (lVar1 != 0) {
...
/* CowData<RemoteFilesystemClient::FileCache>::_copy_on_write() [clone .isra.0] [clone .cold] */void CowData<RemoteFilesystemClient::FileCache>::_copy_on_write(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void FUN_00104280(void) {
   code *pcVar1;
   _DAT_00000000 = 0;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
...
/* RemoteFilesystemClient::~RemoteFilesystemClient() */void RemoteFilesystemClient::~RemoteFilesystemClient(RemoteFilesystemClient *this) {
   long *plVar1;
   long *plVar2;
   long lVar3;
   long lVar4;
   ...
   *(undefined***)this = &PTR__is_configured_00106a70;
   ...
   if (*(int*)( this + 0x34 ) != 0) {
      if (*(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x30 ) * 4 ) != 0) {
         memset(*(void**)( this + 0x28 ), 0, ( ulong ) * (uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x30 ) * 4 ) << 2);
...
/* RemoteFilesystemClient::~RemoteFilesystemClient() */void RemoteFilesystemClient::~RemoteFilesystemClient(RemoteFilesystemClient *this) {
 ...
 while ( (uint)lVar4 < *(uint*)( this + 0x34 ) );
   ...
   LAB_00104450:Memory::free_static(pvVar5, false);
   Memory::free_static(*(void**)( this + 0x20 ), false);
   Memory::free_static(*(void**)( this + 0x18 ), false);
   Memory::free_static(*(void**)( this + 0x28 ), false);
   LAB_0010442a:if (*(long*)( this + 8 ) != 0) {
      LOCK();
      plVar2 = (long*)( *(long*)( this + 8 ) + -0x10 );
      *plVar2 = *plVar2 + -1;
      UNLOCK();
...
/* WARNING: Removing unreachable block (ram,0x00104788) *//* WARNING: Removing unreachable block (ram,0x001048b8) *//* WARNING: Removing unreachable block (ram,0x00104a80) *//* WARNING: Removing unreachable block (ram,0x001048c4) *//* WARNING: Removing unreachable block (ram,0x001048ce) *//* WARNING: Removing unreachable block (ram,0x00104a60) *//* WARNING: Removing unreachable block (ram,0x001048da) *//* WARNING: Removing unreachable block (ram,0x001048e4) *//* WARNING: Removing unreachable block (ram,0x00104a40) *//* WARNING: Removing unreachable block (ram,0x001048f0) *//* WARNING: Removing unreachable block (ram,0x001048fa) *//* WARNING: Removing unreachable block (ram,0x00104a20) *//* WARNING: Removing unreachable block (ram,0x00104906) *//* WARNING: Removing unreachable block (ram,0x00104910) *//* WARNING: Removing unreachable block (ram,0x00104a00) *//* WARNING: Removing unreachable block (ram,0x0010491c) *//* WARNING: Removing unreachable block (ram,0x00104926) *//* WARNING: Removing unreachable block (ram,0x001049e0) *//* WARNING: Removing unreachable block (ram,0x00104932) *//* WARNING: Removing unreachable block (ram,0x0010493c) *//* WARNING: Removing unreachable block (ram,0x001049c0) *//* WARNING: Removing unreachable block (ram,0x00104944) *//* WARNING: Removing unreachable block (ram,0x0010495a) *//* WARNING: Removing unreachable block (ram,0x00104966) *//* String vformat<String>(String const&, String const) */undefined8 *vformat<String>(undefined8 *param_1, bool *param_2, String *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
;
   ...
   *(int*)( (long)in_RSI + 0x24 ) = iVar37;
   LAB_00105619:*(int*)( param_1 + 0xc ) = iVar31;
   *(long*)param_1 = lVar33;
   *(int*)( param_1 + 8 ) = iVar37;
   return param_1;
}
/* WARNING: Removing unreachable block (ram,0x00105a10) *//* WARNING: Removing unreachable block (ram,0x00105b40) *//* WARNING: Removing unreachable block (ram,0x00105cb9) *//* WARNING: Removing unreachable block (ram,0x00105b4c) *//* WARNING: Removing unreachable block (ram,0x00105b56) *//* WARNING: Removing unreachable block (ram,0x00105c9b) *//* WARNING: Removing unreachable block (ram,0x00105b62) *//* WARNING: Removing unreachable block (ram,0x00105b6c) *//* WARNING: Removing unreachable block (ram,0x00105c7d) *//* WARNING: Removing unreachable block (ram,0x00105b78) *//* WARNING: Removing unreachable block (ram,0x00105b82) *//* WARNING: Removing unreachable block (ram,0x00105c5f) *//* WARNING: Removing unreachable block (ram,0x00105b8e) *//* WARNING: Removing unreachable block (ram,0x00105b98) *//* WARNING: Removing unreachable block (ram,0x00105c41) *//* WARNING: Removing unreachable block (ram,0x00105ba4) *//* WARNING: Removing unreachable block (ram,0x00105bae) *//* WARNING: Removing unreachable block (ram,0x00105c23) *//* WARNING: Removing unreachable block (ram,0x00105bb6) *//* WARNING: Removing unreachable block (ram,0x00105bc0) *//* WARNING: Removing unreachable block (ram,0x00105c08) *//* WARNING: Removing unreachable block (ram,0x00105bc8) *//* WARNING: Removing unreachable block (ram,0x00105bde) *//* WARNING: Removing unreachable block (ram,0x00105bea) *//* String vformat<IPAddress, int>(String const&, IPAddress const, int const) */undefined8 *vformat<IPAddress,int>(undefined8 *param_1, bool *param_2, int param_3) {
   Variant *pVVar1;
   Variant *pVVar2;
   int iVar3;
   long in_FS_OFFSET;
...
/* WARNING: Removing unreachable block (ram,0x00105e30) *//* WARNING: Removing unreachable block (ram,0x00105f60) *//* WARNING: Removing unreachable block (ram,0x001060d9) *//* WARNING: Removing unreachable block (ram,0x00105f6c) *//* WARNING: Removing unreachable block (ram,0x00105f76) *//* WARNING: Removing unreachable block (ram,0x001060bb) *//* WARNING: Removing unreachable block (ram,0x00105f82) *//* WARNING: Removing unreachable block (ram,0x00105f8c) *//* WARNING: Removing unreachable block (ram,0x0010609d) *//* WARNING: Removing unreachable block (ram,0x00105f98) *//* WARNING: Removing unreachable block (ram,0x00105fa2) *//* WARNING: Removing unreachable block (ram,0x0010607f) *//* WARNING: Removing unreachable block (ram,0x00105fae) *//* WARNING: Removing unreachable block (ram,0x00105fb8) *//* WARNING: Removing unreachable block (ram,0x00106061) *//* WARNING: Removing unreachable block (ram,0x00105fc4) *//* WARNING: Removing unreachable block (ram,0x00105fce) *//* WARNING: Removing unreachable block (ram,0x00106043) *//* WARNING: Removing unreachable block (ram,0x00105fd6) *//* WARNING: Removing unreachable block (ram,0x00105fe0) *//* WARNING: Removing unreachable block (ram,0x00106028) *//* WARNING: Removing unreachable block (ram,0x00105fe8) *//* WARNING: Removing unreachable block (ram,0x00105ffe) *//* WARNING: Removing unreachable block (ram,0x0010600a) *//* String vformat<String, int>(String const&, String const, int const) */undefined8 *vformat<String,int>(undefined8 *param_1, bool *param_2, String *param_3, int param_4) {
   Variant *pVVar1;
   Variant *pVVar2;
   int iVar3;
   long in_FS_OFFSET;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<String>::resize<false>(long) */undefined8 CowData<String>::resize<false>(CowData<String> *this, long param_1) {
   ...
   if (param_1 * 8 == 0) {
      LAB_00106550:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (lVar10 == lVar7) {
      LAB_001064cf:puVar9 = *(undefined8**)this;
      if (puVar9 == (undefined8*)0x0) {
         LAB_001065a6:/* WARNING: Does not return */pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
      }
   ...
   LAB_001064ba:puVar9[-1] = param_1;
   return 0;
}
/* CowData<RemoteFilesystemClient::FileCache>::_unref() */void CowData<RemoteFilesystemClient::FileCache>::_unref(CowData<RemoteFilesystemClient::FileCache> *this) {
   long *plVar1;
   long *plVar2;
   long lVar3;
   long lVar4;
...
/* CowData<RemoteFilesystemClient::FileCache>::_realloc(long) */undefined8 CowData<RemoteFilesystemClient::FileCache>::_realloc(CowData<RemoteFilesystemClient::FileCache> *this, long param_1) {
   undefined8 *puVar1;
   puVar1 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), param_1 + 0x10, false);
   if (puVar1 != (undefined8*)0x0) {
      *puVar1 = 1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<RemoteFilesystemClient::FileCache>::resize<false>(long) */undefined8 CowData<RemoteFilesystemClient::FileCache>::resize<false>(CowData<RemoteFilesystemClient::FileCache> *this, long param_1) {
   long *plVar1;
   long *plVar2;
   code *pcVar3;
   undefined8 uVar4;
   ...
   if (param_1 * 0x18 == 0) {
      LAB_001069d0:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (lVar10 == lVar8) {
      LAB_0010695b:puVar7 = *(undefined8**)this;
      if (puVar7 == (undefined8*)0x0) {
         LAB_00106a26:/* WARNING: Does not return */pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
      }
...
/* WARNING: Control flow encountered bad instruction data *//* RemoteFilesystemClient::~RemoteFilesystemClient() */void RemoteFilesystemClient::~RemoteFilesystemClient(RemoteFilesystemClient *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

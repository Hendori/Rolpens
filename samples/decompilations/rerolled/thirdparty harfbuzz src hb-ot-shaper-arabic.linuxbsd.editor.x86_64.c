...
/* OT::ChainRuleSet<OT::Layout::SmallTypes>::apply(OT::hb_ot_apply_context_t*,
   OT::ChainContextApplyLookupContext const&) const */ulong OT::ChainRuleSet<OT::Layout::SmallTypes>::apply(ChainRuleSet<OT::Layout::SmallTypes> *this, hb_ot_apply_context_t *param_1, ChainContextApplyLookupContext *param_2) {
   uint *puVar1;
   uint *puVar2;
   int iVar3;
   code *pcVar4;
   ...
   uVar22 = (uint)uVar10;
   if (uVar10 < 5) {
      LAB_001136d0:if (uVar22 == 0) {
         return 0;
      }

   }
 else if (( param_1[0x13d] != (hb_ot_apply_context_t)0x0 ) && ( param_1[0x13e] != (hb_ot_apply_context_t)0x0 )) {
      ...
      *(undefined1(*) [16])( param_1 + 0x30 ) = (undefined1[16])0x0;
      ...
      while ((int)uVar13 < iVar3 + -1) {
         ...
         uVar13 = (ulong)uVar16;
         *(uint*)( param_1 + 8 ) = uVar16;
         puVar1 = (uint*)( *(long*)( *(long*)( *(long*)( param_1 + 0x10 ) + 0xa0 ) + 0x70 ) + uVar13 * 0x14 );
         uVar10 = (ushort)puVar1[3];
         uVar16 = *(uint*)( param_1 + 0x18 ) & (uint)uVar10;
         if (( uVar16 & 0xe ) == 0) {
            uVar17 = 0;
            if (( uVar10 & 8 ) == 0) {
               LAB_00113435:uVar10 = (ushort)puVar1[4];
               sVar14 = 0;
               if (( ( uVar10 & 0x20 ) != 0 ) && ( ( puVar1[3] & 0x10 ) == 0 )) {
                  if (param_1[0x20] == (hb_ot_apply_context_t)0x0) {
                     if (( uVar10 & 0x1f ) == 1) {
               ...
               LAB_00113444:puVar12 = *(ushort**)( param_1 + 0x38 );
               if (puVar12 != (ushort*)0x0) {
               ...
               if (( ( puVar1[1] & *(uint*)( param_1 + 0x1c ) ) != 0 ) && ( ( param_1[0x24] == (hb_ot_apply_context_t)0x0 || ( param_1[0x24] == *(hb_ot_apply_context_t*)( (long)puVar1 + 0xf ) ) ) )) {
                  ...
                  uVar10 = (ushort)puVar1[3];
                  if (( ( *(uint*)( param_1 + 0x18 ) & (uint)uVar10 & 0xe ) == 0 ) && ( ( ( uVar10 & 8 ) == 0 || ( cVar9 = hb_ot_apply_context_t::match_properties_mark(*(hb_ot_apply_context_t**)( *(long*)( param_1 + 0x10 ) + 0xf8 ), *puVar1, (uint)uVar10, *(uint*)( param_1 + 0x18 )) ),cVar9 != '\0' ) )) {
                     uVar17 = puVar1[4];
                     if (( ( uVar17 & 0x20 ) != 0 ) && ( ( puVar1[3] & 0x10 ) == 0 )) {
                        if (param_1[0x20] == (hb_ot_apply_context_t)0x0) {
                           ...
                           LAB_00113c69:if (( uVar17 & 0x100 ) != 0) goto LAB_00113500;
                        }

                        if (( param_1[0x22] != (hb_ot_apply_context_t)0x0 ) || ( ( uVar17 & 0x40 ) == 0 )) goto LAB_001136bd;
                     }

                     LAB_00113500:iVar3 = *(int*)( param_1 + 0x40 );
                     goto LAB_00113507;
                  }

                  LAB_001136bd:uVar22 = ( uint )(ushort)(*(ushort*)this << 8 | *(ushort*)this >> 8);
                  goto LAB_001136d0;
               }

               LAB_00113742:if (sVar14 == 0) break;
            }
 else {
               uVar17 = uVar16 & 0xe;
               cVar9 = hb_ot_apply_context_t::match_properties_mark(*(hb_ot_apply_context_t**)( *(long*)( param_1 + 0x10 ) + 0xf8 ), *puVar1, (uint)uVar10, *(uint*)( param_1 + 0x18 ));
               if (cVar9 != '\0') goto LAB_00113435;
            }

            LAB_00113888:uVar13 = ( ulong ) * (uint*)( param_1 + 8 );
         }
...
;
      ...
      while (true) {
         ...
         uVar10 = *(ushort*)( pCVar21 + ( ulong )(ushort)(*(ushort*)pCVar21 << 8 | *(ushort*)pCVar21 >> 8) * 2 + 2 );
         uVar10 = uVar10 << 8 | uVar10 >> 8;
         if (( ( uVar10 == 0 ) || ( uVar10 == 1 ) ) && ( *(ushort*)( pCVar21 + ( ulong )(ushort)(*(ushort*)pCVar21 << 8 | *(ushort*)pCVar21 >> 8) * 2 + 2 + 2 ) == 0 )) break;
         pCVar19 = pCVar19 + 2;
         uVar22 = uVar22 - 1;
         if (uVar22 == 0) {
            return 0;
...
;
      ...
      while (true) {
         ...
         do {
            ...
            uVar11 = *(ushort*)( pCVar21 + ( ulong )(ushort)(*(ushort*)pCVar21 << 8 | *(ushort*)pCVar21 >> 8) * 2 + 2 );
            uVar11 = uVar11 << 8 | uVar11 >> 8;
         }
 while ( ( ( uVar11 != 0 ) && ( uVar11 != 1 ) ) || ( *(ushort*)( pCVar21 + ( ulong )(ushort)(*(ushort*)pCVar21 << 8 | *(ushort*)pCVar21 >> 8) * 2 + 2 + 2 ) != 0 ) );
      }
;
      return uVar13;
   }
   ...
   while (true) {
      ...
      uVar13 = ChainRule<OT::Layout::SmallTypes>::apply((ChainRule<OT::Layout::SmallTypes>*)pCVar21, param_1, param_2);
      if ((char)uVar13 != '\0') break;
      pCVar19 = pCVar19 + 2;
...
;
   return uVar13;
   LAB_00113507 = (Coverage*)( (long)param_1 + ( ulong )(ushort)(uVar1 << 8 | uVar1 >> 8) );
}
uVar3 = Layout::Common::Coverage::get_coverage(this, *(uint*)( *(long*)( *(long*)( param_2 + 0xa0 ) + 0x70 ) + ( ulong ) * (uint*)( *(long*)( param_2 + 0xa0 ) + 0x5c ) * 0x14 ));uVar2 = 0;if (uVar3 != 0xffffffff) {
   puVar4 = (ushort*)&_hb_NullPool;
   if (uVar3 < ( ushort )(*(ushort*)( (long)param_1 + 4 ) << 8 | *(ushort*)( (long)param_1 + 4 ) >> 8)) {
      puVar4 = (ushort*)( (long)param_1 + (ulong)uVar3 * 2 + 6 );
   }
   ...
   if (uVar1 != 0) {
      this_00 = (ChainRuleSet<OT::Layout::SmallTypes>*)( (long)param_1 + ( ulong )(ushort)(uVar1 << 8 | uVar1 >> 8) );
   }
   ...
   uVar2 = ChainRuleSet<OT::Layout::SmallTypes>::apply(this_00, param_2, (ChainContextApplyLookupContext*)&local_58);
}
if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return (bool)uVar2;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* bool 
   OT::hb_accelerate_subtables_context_t::apply_cached_to<OT::ChainContextFormat2_5<OT::Layout::SmallTypes>
   >(void const*, OT::hb_ot_apply_context_t*) */bool OT::hb_accelerate_subtables_context_t::apply_cached_to<OT::ChainContextFormat2_5<OT::Layout::SmallTypes>>(void *param_1, hb_ot_apply_context_t *param_2) {
   uint *puVar1;
   byte bVar2;
   undefined1 uVar3;
   ushort uVar4;
 ...
 while ( iVar9 <= iVar5 );
            ...
            LAB_00114099:uVar6 = ( uint )(ushort)(puVar7[2] << 8 | puVar7[2] >> 8);
         }
 else {
            uVar6 = 0;
         }
      ...
      this_00 = (ChainRuleSet<OT::Layout::SmallTypes>*)&_hb_NullPool;
      if (uVar4 != 0) {
         this_00 = (ChainRuleSet<OT::Layout::SmallTypes>*)( (long)param_1 + ( ulong )(ushort)(uVar4 << 8 | uVar4 >> 8) );
      }

      uVar3 = ChainRuleSet<OT::Layout::SmallTypes>::apply(this_00, param_2, (ChainContextApplyLookupContext*)&local_68);
   }
...
/* bool 
   ...
   >(void const*, OT::hb_ot_apply_context_t*) */bool OT::hb_accelerate_subtables_context_t::apply_cached_to<OT::ChainContextFormat1_4<OT::Layout::SmallTypes>>(void *param_1, hb_ot_apply_context_t *param_2) {
   ushort uVar1;
   undefined1 uVar2;
   uint uVar3;
   ushort *puVar4;
...
/* bool 
   ...
   >(void const*, OT::hb_ot_apply_context_t*) */bool OT::hb_accelerate_subtables_context_t::apply_to<OT::ChainContextFormat2_5<OT::Layout::SmallTypes>>(void *param_1, hb_ot_apply_context_t *param_2) {
   undefined1 uVar1;
   ushort uVar2;
   int iVar3;
   ushort *puVar4;
 ...
 while ( iVar6 <= iVar3 );
         ...
         LAB_0011437f:uVar7 = ( uint )(ushort)(puVar4[2] << 8 | puVar4[2] >> 8);
      }
 else {
         uVar7 = 0;
      }
      ...
      this_00 = (ChainRuleSet<OT::Layout::SmallTypes>*)&_hb_NullPool;
      if (uVar2 != 0) {
         this_00 = (ChainRuleSet<OT::Layout::SmallTypes>*)( (long)param_1 + ( ulong )(ushort)(uVar2 << 8 | uVar2 >> 8) );
      }

      uVar1 = ChainRuleSet<OT::Layout::SmallTypes>::apply(this_00, param_2, (ChainContextApplyLookupContext*)&local_58);
   }
...
/* WARNING: Control flow encountered bad instruction data *//* hb_serialize_context_t::~hb_serialize_context_t() */void hb_serialize_context_t::~hb_serialize_context_t(hb_serialize_context_t *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

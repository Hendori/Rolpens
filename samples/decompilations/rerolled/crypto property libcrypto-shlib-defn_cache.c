void lh_PROPERTY_DEFN_ELEM_hfn_thunk(undefined8 param_1, code *UNRECOVERED_JUMPTABLE) {
   for (int i_716 = 0; i_716 < 2; i_716++) {
      /* WARNING: Could not recover jumptable at 0x00100004. Too many branches */
   }
   ( *UNRECOVERED_JUMPTABLE )();
   return;
}void lh_PROPERTY_DEFN_ELEM_cfn_thunk(undefined8 param_1, undefined8 param_2, code *UNRECOVERED_JUMPTABLE) {
   for (int i_717 = 0; i_717 < 2; i_717++) {
   ...
   for (int i_718 = 0; i_718 < 2; i_718++) {
      /* WARNING: Could not recover jumptable at 0x00100024. Too many branches */
   }
   ( *UNRECOVERED_JUMPTABLE )();
   return;
}void lh_PROPERTY_DEFN_ELEM_doall_arg_thunk(undefined8 param_1, undefined8 param_2, code *UNRECOVERED_JUMPTABLE) {
   for (int i_719 = 0; i_719 < 2; i_719++) {
   ...
   OPENSSL_LH_set_thunks(uVar1, 0x100000, lh_PROPERTY_DEFN_ELEM_cfn_thunk, lh_PROPERTY_DEFN_ELEM_doall_thunk, lh_PROPERTY_DEFN_ELEM_doall_arg_thunk);
   return;
   ...
   uVar3 = 0;
   LAB_00100173:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar3;
   }
   ...
   if (param_3 == (undefined8*)0x0) {
      ...
      LAB_001002da:uVar5 = 0;
      CRYPTO_free(ptr);
   }
   ossl_lib_ctx_unlock(param_1);
   LAB_00100239:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar5;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();

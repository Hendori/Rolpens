...
void __thiscall SurfaceUpgradeTool::~SurfaceUpgradeTool(SurfaceUpgradeTool *this)
...
/* SurfaceUpgradeDialog::_notification(int) [clone .part.0] */

void SurfaceUpgradeDialog::_notification(int param_1)

{
  ...
  create_custom_callable_function_pointer<SurfaceUpgradeTool>
            (aSStack_38,SurfaceUpgradeTool::singleton,
             (_func_void *)"&SurfaceUpgradeTool::prepare_upgrade");
  (*pcVar1)((long *)CONCAT44(in_register_0000003c,param_1),SceneStringNames::singleton + 0x268,
            aSStack_38,0);
...
/* SurfaceUpgradeDialog::_notification(int) */

void __thiscall SurfaceUpgradeDialog::_notification(SurfaceUpgradeDialog *this,int param_1)
...
void __thiscall SurfaceUpgradeTool::begin_upgrade(SurfaceUpgradeTool *this)
...
void __thiscall SurfaceUpgradeTool::_show_popup(SurfaceUpgradeTool *this)
...
/* SurfaceUpgradeTool::_try_show_popup() */

void SurfaceUpgradeTool::_try_show_popup(void)
  ...
  if ((singleton[0x1a0] == (SurfaceUpgradeTool)0x0) && (singleton[0x1a1] == (SurfaceUpgradeTool)0x0)
    ...
    if (((*(byte *)(lVar2 + 0x2fa) & 0x40) != 0) && (*(char *)(lVar2 + 0xa62) == '\0')) {
      if (*(char *)((long)EditorFileSystem::singleton + 0x452) == '\0') {
        ...
        create_custom_callable_function_pointer<SurfaceUpgradeTool>
                  (local_48,(char *)this,(_func_void *)"&SurfaceUpgradeTool::_show_popup");
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* SurfaceUpgradeDialog::popup_on_demand() */

void __thiscall SurfaceUpgradeDialog::popup_on_demand(SurfaceUpgradeDialog *this)
...
/* SurfaceUpgradeTool::_bind_methods() */
...
void __thiscall SurfaceUpgradeTool::finish_upgrade(SurfaceUpgradeTool *this)

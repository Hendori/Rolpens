...
/* Texture::initialize_class() [clone .part.0] */void Texture::initialize_class(void) {
 ...
 while ( lVar1 != lVar6 );
      ...
      void CompressedTextureLayered::initialize_class(void) {
         ...
         if (TextureLayered::initialize_class() == '\0') {
            ...
            TextureLayered::initialize_class() {
               StringName::unref();
            }
 ...
 while ( lVar1 != lVar6 );
         ...
         void CowData<Ref<Image>>::_copy_on_write(CowData<Ref<Image>> *this) {
            long lVar1;
            long lVar2;
            code *pcVar3;
            char cVar4;
 ...
 while ( lVar1 != lVar8 );
         ...
         void CowData<unsigned_char>::resize<false>(CowData<unsigned_char> *this, long param_1) {
         ...
         void Vector<Ref<Image>>::push_back(Vector<Ref<Image>> *this, long *param_2) {
            long *plVar1;
            Image *pIVar2;
            Image *pIVar3;
            char cVar4;
         ...
         CompressedTexture2D * CompressedTexture2D::load_image_from_file(CompressedTexture2D * this, undefined8 * param_2, int, param_3);
         {
            long *plVar1;
            code *pcVar2;
            Image *pIVar3;
 ...
 while ( lVar21 < lVar15 );
   ...
   int&, int) */
         undefined8 CompressedTexture2D::_load_data(CompressedTexture2D *this, String *param_1, int *param_2, int *param_3, Ref *param_4, bool *param_5, bool *param_6, bool *param_7, int *param_8, int param_9) {
            Object *pOVar1;
            byte bVar2;
            char cVar3;
            bool bVar4;
               ...
               if (( ( ( local_44 == 'G' ) && ( local_43 == 'S' ) ) && ( local_42 == 'T' ) ) && ( local_41 == '2' )) {
                  ...
                  if (uVar5 < 2) {
                     ...
                     *param_6 = bVar4;
                     ...
                     if (( *(long*)param_4 == 0 ) || ( cVar3 = Image::is_empty() ),cVar3 != '\0') goto LAB_00104c46;
                     uVar7 = 0;
                     goto LAB_0010493f;
                  }
      ...
      int CompressedTexture2D::load(CompressedTexture2D *this, String *param_1) {
         Image *pIVar1;
         char cVar2;
         int iVar3;
         undefined4 uVar4;
         ...
         *(undefined4*)( this + 0x2f8 ) = uVar4;
         ...
         LAB_00104f83:if (( local_40 != (Image*)0x0 ) && ( cVar2 = RefCounted::unreference() ),cVar2 != '\0') {
      ...
      void CompressedTexture2D::reload_from_file(CompressedTexture2D *this) {
         char cVar1;
         long in_FS_OFFSET;
         long local_30;
         long local_28;
   ...
   ResourceFormatLoader::CacheMode) */
      long *ResourceFormatLoaderCompressedTexture2D::load(long *param_1, undefined8 param_2, String *param_3, undefined8 param_4, int *param_5) {
         char cVar1;
         int iVar2;
         Texture2D *this;
         long lVar3;
   ...
   int&, bool&) */
      undefined8 CompressedTexture3D::_load_data(CompressedTexture3D *this, String *param_1, Vector *param_2, Format *param_3, int *param_4, int *param_5, int *param_6, bool *param_7) {
         Object *pOVar1;
         Image *pIVar2;
         char cVar3;
         uint uVar4;
                  ...
                  if (0 < *param_6 + iVar5) {
                     do {
                        ...
                        if (local_68 != (Object*)0x0) {
                           ...
                           cVar3 = RefCounted::unreference();
                           if (( cVar3 == '\0' ) || ( cVar3 = predelete_handler(pOVar1) ),cVar3 == '\0') goto LAB_00105583;
                           ( **(code**)( *(long*)pOVar1 + 0x140 ) )(pOVar1);
                           Memory::free_static(pOVar1, false);
 ...
 while ( iVar9 < *param_6 + iVar5 );
   ...
   int CompressedTexture3D::load(CompressedTexture3D *this, String *param_1) {
      long lVar1;
      int iVar2;
      long *plVar3;
      undefined8 uVar4;
   ...
   void CompressedTexture3D::reload_from_file(CompressedTexture3D *this) {
      char cVar1;
      long in_FS_OFFSET;
      long local_30;
      long local_28;
   ...
   ResourceFormatLoader::CacheMode) */
   long *ResourceFormatLoaderCompressedTexture3D::load(long *param_1, undefined8 param_2, String *param_3, undefined8 param_4, int *param_5) {
      char cVar1;
      int iVar2;
      CompressedTexture3D *this;
      long lVar3;
   ...
   undefined8 CompressedTextureLayered::_load_data(CompressedTextureLayered *this, String *param_1, Vector *param_2, int *param_3, int param_4) {
      code *pcVar1;
      Object *pOVar2;
      Ref *pRVar3;
      char cVar4;
...
/* CompressedTextureLayered::load(String const&) */int CompressedTextureLayered::load(CompressedTextureLayered *this, String *param_1) {
   code *pcVar1;
...
/* ResourceFormatLoaderCompressedTextureLayered::load(String const&, String const&, Error*, bool,
   ...
   *(undefined***)pCVar3 = ppuVar4;
   ...
   if (cVar1 == '\0') {
      ...
      if (( this != (CompressedTextureLayered*)0x0 ) && ( cVar1 = RefCounted::reference() ),cVar1 == '\0') {

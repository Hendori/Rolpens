   ...
   *(void**)( param_7 + 0x60 ) = pvVar4;
   if (pvVar4 == (void*)0x0) {
      ...
      *(undefined8*)( param_7 + 8 ) = *param_1;
      for (int i_1869 = 0; i_1869 < 4; i_1869++) {
         *(undefined8*)( param_7 + ( 16*i_1869 + 16 ) ) = uVar6;
         uVar6 = param_1[( 2*i_1869 + 3 )];
         *(undefined8*)( param_7 + ( 16*i_1869 + 24 ) ) = param_1[( 2*i_1869 + 2 )];
      }
         ...
         if (iVar1 != 0) {
            ...
            if (iVar1 != 0) {
               ...
               if (iVar1 == 0) {
                  ...
                  for (int i_1870 = 0; i_1870 < 2; i_1870++) {
                     pBStack_80 = local_b0;
                  }

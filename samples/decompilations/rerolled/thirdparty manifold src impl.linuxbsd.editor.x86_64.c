/* (anonymous namespace)::AtomicAddVec3(linalg::vec<double, 3>&, linalg::vec<double, 3> const&) */void (anonymous_namespace)::AtomicAddVec3(vec *param_1, vec *param_2) {
   int iVar1;
   double dVar2;
   vec *pvVar3;
   int *piVar4;
   ...
   local_28 = 2;
   local_30 = _LC9;
   LAB_00100042:iVar1 = *piVar4;
   pvVar3 = param_1;
   if (( iVar1 != 0 ) && ( pvVar3 = iVar1 != 1 )) {
      pvVar3 = param_1 + 0x10;
   }
...
/* std::_Rb_tree<int, std::pair<int const, manifold::Manifold::Impl::Relation>,
   ...
   >::_M_get_insert_unique_pos(int const&) [clone .isra.0] */undefined1[16];std::_Rb_tree<int,std::pair<int_const,manifold::Manifold::Impl::Relation>,std::_Select1st<std::pair<int_const,manifold::Manifold::Impl::Relation>>,std::less<int>,std::allocator<std::pair<int_const,manifold::Manifold::Impl::Relation>>>::_M_get_insert_unique_pos (_Rb_tree<int,std::pair<int_const,manifold::Manifold::Impl::Relation>,std::_Select1st<std::pair<int_const,manifold::Manifold::Impl::Relation>>,std::less<int>,std::allocator<std::pair<int_const,manifold::Manifold::Impl::Relation>>>
           *this,int *param_1) {
 ...
 while ( p_Var2 != (_Rb_tree_node_base*)0x0 );
   ...
   iVar5 = *(int*)( p_Var4 + 0x20 );
   LAB_00100108:p_Var3 = (_Rb_tree_node_base*)0x0;
   if (iVar5 < iVar6) {
      p_Var4 = p_Var3;
      p_Var3 = p_Var2;
   }
...
/* std::_Function_handler<void (manifold::VecView<linalg::vec<double, 3> >),
   ...
   std::_Any_data const&, std::_Manager_operation) */undefined8 std::_Function_handler<void(manifold::VecView<linalg::vec<double,3>>),manifold::Manifold::Impl::Warp(std::function<void(linalg::vec<double,3>&)>)::{lambda(manifold::VecView<linalg::vec<double,3>>)#1}>::_M_manager(undefined8 *param_1, undefined8 *param_2, int param_3) {
   if (param_3 != 0) {
      if (param_3 == 1) {
         *param_1 = param_2;
      }
   ...
   *param_1 = &manifold::Manifold::Impl::Warp(std::function<void(linalg::vec<double,3>&)>)::
              {lambda(manifold::VecView<linalg::vec<double,3>>)
   #1
   return 0;
}
/* std::_Rb_tree<int, std::pair<int const, manifold::Manifold::Impl::Relation>,
   ...
   manifold::Manifold::Impl::Relation> >, int const&) [clone .isra.0] */undefined1[16];std::_Rb_tree<int,std::pair<int_const,manifold::Manifold::Impl::Relation>,std::_Select1st<std::pair<int_const,manifold::Manifold::Impl::Relation>>,std::less<int>,std::allocator<std::pair<int_const,manifold::Manifold::Impl::Relation>>>::_M_get_insert_hint_unique_pos (_Rb_tree<int,std::pair<int_const,manifold::Manifold::Impl::Relation>,std::_Select1st<std::pair<int_const,manifold::Manifold::Impl::Relation>>,std::less<int>,std::allocator<std::pair<int_const,manifold::Manifold::Impl::Relation>>>
   ...
   if (( *(long*)( this + 0x28 ) == 0 ) || ( param_2 = *(_Rb_tree_node_base**)( this + 0x20 ) ),(int)param_3 <= *(int*)( param_2 + 0x20 )) {
      LAB_00100237:auVar5 = _M_get_insert_unique_pos(this, (int*)(ulong)param_3);
      return auVar5;
   }

   LAB_00100269:auVar1._8_8_ = 0;
   auVar1._0_8_ = param_2;
   return auVar1 << 0x40;
}
/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* int* std::__upper_bound<int*, int,
   ...
   __gnu_cxx::__ops::_Val_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,
   3> > const&)::{lambda(int const&, int const&)#1}>) [clone .isra.0] */int *std::__upper_bound<int*,int,__gnu_cxx::__ops::_Val_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(int *param_1, long param_2, int param_3, long *param_4) {
   long lVar1;
   long lVar2;
   ...
   do {
      ...
      while (true) {
         lVar1 = lVar2 >> 1;
         if (*(ulong*)( *param_4 + (long)param_3 * 8 ) < *(ulong*)( *param_4 + (long)param_1[lVar1] * 8 )) break;
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* int* std::__lower_bound<int*, int,
   __gnu_cxx::__ops::_Iter_comp_val<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,
   3> > const&)::{lambda(int const&, int const&)#1}> >(int*, int*, int const&,
   __gnu_cxx::__ops::_Iter_comp_val<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,
   3> > const&)::{lambda(int const&, int const&)#1}>) [clone .isra.0] */int *std::__lower_bound<int*,int,__gnu_cxx::__ops::_Iter_comp_val<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(int *param_1, long param_2, int param_3, long *param_4) {
   long lVar1;
   long lVar2;
   lVar1 = param_2 - (long)param_1 >> 2;
   do {
...
/* std::_Rb_tree_node<std::pair<int const, manifold::Manifold::Impl::Relation> >* std::_Rb_tree<int,
   ...
   std::pair<int const, manifold::Manifold::Impl::Relation>, std::_Select1st<std::pair<int const,
   manifold::Manifold::Impl::Relation> >, std::less<int>, std::allocator<std::pair<int const,
   manifold::Manifold::Impl::Relation> > >::_Reuse_or_alloc_node&) [clone .isra.0] */_Rb_tree_node *
std::
...
_M_copy<false,std::_Rb_tree<int,std::pair<int_const,manifold::Manifold::Impl::Relation>,std::_Select1st<std::pair<int_const,manifold::Manifold::Impl::Relation>>,std::less<int>,std::allocator<std::pair<int_const,manifold::Manifold::Impl::Relation>>>::_Reuse_or_alloc_node>
 ...
 while ( *(long*)( lVar16 + 0x18 ) != 0 );
      ...
      for (int i = 0; i < 7; i++) {
         uVar3 = *(undefined8*)( param_1 + ( 16*i + 40 ) );
         *(undefined8*)( p_Var15 + ( 16*i + 32 ) ) = *(undefined8*)( param_1 + ( 16*i + 32 ) );
         *(undefined8*)( p_Var15 + ( 16*i + 40 ) ) = uVar3;
      }
   ...
   *(undefined4*)p_Var15 = uVar1;
   if (p_Var13 != (_Rb_tree_node*)0x0) {
      p_Var13 = _M_copy<false,std::_Rb_tree<int,std::pair<int_const,manifold::Manifold::Impl::Relation>,std::_Select1st<std::pair<int_const,manifold::Manifold::Impl::Relation>>,std::less<int>,std::allocator<std::pair<int_const,manifold::Manifold::Impl::Relation>>>::_Reuse_or_alloc_node>(p_Var13, p_Var15, param_3);
 ...
 while ( *(long*)( lVar16 + 0x18 ) != 0 );
         ...
         for (int i = 0; i < 7; i++) {
            uVar3 = *(undefined8*)( puVar18 + ( 4*i + 10 ) );
            *(undefined8*)( p_Var17 + ( 16*i + 32 ) ) = *(undefined8*)( puVar18 + ( 4*i + 8 ) );
            *(undefined8*)( p_Var17 + ( 16*i + 40 ) ) = uVar3;
         }
         ...
         while (true) {
            ...
            *(_Rb_tree_node_base**)( p_Var14 + 8 ) = p_Var19;
            if (*(_Rb_tree_node**)( puVar18 + 6 ) != (_Rb_tree_node*)0x0) {
               p_Var13 = _M_copy<false,std::_Rb_tree<int,std::pair<int_const,manifold::Manifold::Impl::Relation>,std::_Select1st<std::pair<int_const,manifold::Manifold::Impl::Relation>>,std::less<int>,std::allocator<std::pair<int_const,manifold::Manifold::Impl::Relation>>>::_Reuse_or_alloc_node>(*(_Rb_tree_node**)( puVar18 + 6 ), p_Var14, param_3);
            ...
            LAB_001004fb:p_Var14 = (_Rb_tree_node_base*)operator_new(0x98);
            for (int i = 0; i < 7; i++) {
               uVar3 = *(undefined8*)( puVar18 + ( 4*i + 10 ) );
               *(undefined8*)( p_Var14 + ( 16*i + 32 ) ) = *(undefined8*)( puVar18 + ( 4*i + 8 ) );
               *(undefined8*)( p_Var14 + ( 16*i + 40 ) ) = uVar3;
            }
...
/* std::_Function_handler<void (manifold::VecView<linalg::vec<double, 3> >),
   ...
   manifold::VecView<linalg::vec<double, 3> >&&) */void std::_Function_handler<void(manifold::VecView<linalg::vec<double,3>>),manifold::Manifold::Impl::Warp(std::function<void(linalg::vec<double,3>&)>)::{lambda(manifold::VecView<linalg::vec<double,3>>)#1}>::_M_invoke(_Any_data *param_1, VecView *param_2) {
   code *pcVar1;
   code *pcVar2;
   long lVar3;
   long lVar4;
   ...
   if (*(code**)( lVar4 + 0x10 ) == (code*)0x0) {
      ...
      pcStack_40 = (code*)0x0;
      if (lVar3 != lVar5) {
         LAB_00100760:local_88 = local_48;
 ...
 while ( lVar4 != lVar5 );
      ...
      if (*(code**)( lVar4 + 0x10 ) == (code*)0x0) {
         pcVar2 = pcStack_40;
         if (lVar3 != lVar5) {
            LAB_0010084f:std::__throw_bad_function_call();
            goto LAB_00100854;
         }
   ...
   LAB_00100854:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* void std::__insertion_sort<int*,
   ...
   __gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,
   3> > const&)::{lambda(int const&, int const&)#1}>) */void std::__insertion_sort<int*,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(int *param_1, int *param_2, long *param_3) {
   int iVar1;
   long lVar2;
   ulong uVar3;
   ulong uVar4;
...
/* void manifold::transform<linalg::vec<double, 3> const*, linalg::vec<double, 3>*, (anonymous
   ...
   linalg::vec<double, 3>*, (anonymous namespace)::TransformNormals) */void manifold::transform<linalg::vec<double,3>const*,linalg::vec<double,3>*,(anonymous_namespace)::TransformNormals>(double *param_1, double *param_2, undefined1 (*param_3)[16]) {
   double dVar1;
   ...
   if (param_1 != param_2) {
      do {
         dVar1 = param_1[2];
         auVar2._0_8_ = param_1[1] * in_stack_00000020 + *param_1 * in_stack_00000008 + dVar1 * in_stack_00000038;
         auVar2._8_8_ = param_1[1] * in_stack_00000028 + *param_1 * in_stack_00000010 + dVar1 * in_stack_00000040;
         dVar4 = *param_1 * in_stack_00000018 + param_1[1] * in_stack_00000030 + dVar1 * in_stack_00000048;
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* int* std::__move_merge<int*, int*,
   __gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,
   3> > const&)::{lambda(int const&, int const&)#1}> >(int*, int*, int*, int*, int*,
   __gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,
   3> > const&)::{lambda(int const&, int const&)#1}>) */int *std::__move_merge<int*,int*,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(int *param_1, int *param_2, int *param_3, int *param_4, int *param_5, long *param_6) {
   int iVar1;
   long lVar2;
   size_t __n;
   size_t __n_00;
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* void std::__merge_sort_loop<int*, int*, long,
   __gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,
   3> > const&)::{lambda(int const&, int const&)#1}> >(int*, int*, int*, long,
   __gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,
   3> > const&)::{lambda(int const&, int const&)#1}>) */void std::__merge_sort_loop<int*,int*,long,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(long param_1, long param_2, int *param_3, long param_4, undefined8 param_5) {
   long lVar1;
   long lVar2;
   ...
   if (param_4 * 2 <= lVar1) {
      ...
      do {
         ...
         param_3 = __move_merge<int*,int*,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(lVar2, lVar1, lVar1, param_1, param_3, param_5);
         lVar1 = param_2 - param_1 >> 2;
         lVar2 = param_1;
      }
 while ( SBORROW8(lVar1, param_4 * 2) == lVar1 + param_4 * -2 < 0 );
   ...
   lVar1 = param_1 + param_4 * 4;
   __move_merge<int*,int*,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(param_1, lVar1, lVar1, param_2, param_3, param_5);
   return;
}
/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* void std::__merge_sort_with_buffer<int*, int*,
   __gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,
   3> > const&)::{lambda(int const&, int const&)#1}> >(int*, int*, int*,
   __gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,
   3> > const&)::{lambda(int const&, int const&)#1}>) */void std::__merge_sort_with_buffer<int*,int*,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(long param_1, long param_2, long param_3, undefined8 param_4) {
   long lVar1;
   long lVar2;
   long lVar3;
   ...
   lVar3 = param_1;
   if (lVar1 < 0x19) {
      __insertion_sort<int*,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(param_1, param_2, param_4);
      return;
   }

   do {
      lVar2 = lVar3 + 0x1c;
      __insertion_sort<int*,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(lVar3, lVar2, param_4);
      lVar3 = lVar2;
   }
 while ( 0x18 < param_2 - lVar2 );
   __insertion_sort<int*,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(lVar2, param_2, param_4);
   if (0x1c < lVar1) {
      lVar3 = 7;
      do {
         __merge_sort_loop<int*,int*,long,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(param_1, param_2, param_3, lVar3, param_4);
         lVar2 = lVar3 * 2;
         lVar3 = lVar3 * 4;
         __merge_sort_loop<int*,int*,long,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(param_3, param_3 + lVar1, param_1, lVar2, param_4);
      }
 while ( lVar3<lVar1> > 2 );
   }
...
/* void std::vector<linalg::vec<double, 3>, std::allocator<linalg::vec<double, 3> >
   ...
   linalg::vec<double, 3> const*, std::forward_iterator_tag) [clone .isra.0] */void std::vector<linalg::vec<double,3>,std::allocator<linalg::vec<double,3>>>::_M_assign_aux<linalg::vec<double,3>const*>(undefined8 *param_1, undefined8 *param_2, undefined8 *param_3) {
   undefined8 *puVar1;
   void *pvVar2;
   undefined8 uVar3;
   void *__dest;
 ...
 while ( param_3 != puVar5 );
            puVar7 = (undefined8*)( (long)puVar7 + ( (long)param_3 + ( -0x18 - (long)puVar1 ) & 0xfffffffffffffff8U ) + 0x18 );
         }
...
/* void std::vector<linalg::vec<int, 3>, std::allocator<linalg::vec<int, 3> >
   ...
   const*, std::forward_iterator_tag) [clone .isra.0] */void std::vector<linalg::vec<int,3>,std::allocator<linalg::vec<int,3>>>::_M_assign_aux<linalg::vec<int,3>const*>(undefined8 *param_1, undefined8 *param_2, undefined8 *param_3) {
   undefined8 *puVar1;
   void *pvVar2;
   void *__dest;
   undefined8 *puVar3;
 ...
 while ( param_3 != puVar4 );
            puVar6 = (undefined8*)( (long)puVar6 + ( (long)param_3 + ( -0xc - (long)puVar1 ) & 0xfffffffffffffffcU ) + 0xc );
         }
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* void std::__merge_adaptive<int*, long, int*,
   __gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,
   3> > const&)::{lambda(int const&, int const&)#1}> >(int*, int*, int*, long, long, int*,
   __gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,
   3> > const&)::{lambda(int const&, int const&)#1}>) */void std::__merge_adaptive<int*,long,int*,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(int *param_1, int *param_2, int *param_3, long param_4, long param_5, int *param_6, long *param_7) {
   int iVar1;
   long lVar2;
   int *piVar3;
   void *__dest;
...
;
      ...
      if (4 < (long)sVar5) {
         ...
         LAB_00101120:memmove(__dest, param_6, sVar5);
         return;
      }
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* void std::__stable_sort_adaptive<int*, int*,
   __gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,
   3> > const&)::{lambda(int const&, int const&)#1}> >(int*, int*, int*, int*,
   __gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,
   3> > const&)::{lambda(int const&, int const&)#1}>) */void std::__stable_sort_adaptive<int*,int*,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(long param_1, long param_2, long param_3, undefined8 param_4, undefined8 param_5) {
   __merge_sort_with_buffer<int*,int*,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(param_1, param_2, param_4, param_5);
   __merge_sort_with_buffer<int*,int*,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(param_2, param_3, param_4, param_5);
   __merge_adaptive<int*,long,int*,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(param_1, param_2, param_3, param_2 - param_1 >> 2, param_3 - param_2 >> 2, param_4, param_5);
   return;
}
/* int* std::_V2::__rotate<int*>(int*, int*, int*, std::random_access_iterator_tag) [clone .isra.0]
 ...
 while ( lVar10 != lVar9 );
      ...
      piVar7 = piVar8;
      if (lVar10 == 0) {
         LAB_00101370:return (int*)( (long)param_1 + ( (long)param_3 - (long)param_2 ) );
      }
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* void std::__merge_without_buffer<int*, long,
   __gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,
   3> > const&)::{lambda(int const&, int const&)#1}> >(int*, int*, int*, long, long,
   __gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,
   3> > const&)::{lambda(int const&, int const&)#1}>) */void std::__merge_without_buffer<int*,long,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(int *param_1, int *param_2, undefined8 param_3, long param_4, long param_5, long *param_6) {
   int iVar1;
   int *piVar2;
   int *piVar3;
   long lVar4;
   ...
   if (( param_5 != 0 ) && ( param_4 != 0 )) {
      if (param_5 + param_4 != 2) {
         ...
         do {
            ...
            piVar2 = __lower_bound<int*,int,__gnu_cxx::__ops::_Iter_comp_val<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(param_2, param_3, *piVar3, param_6);
            ...
            while (true) {
               ...
               __merge_without_buffer<int*,long,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(piVar2, piVar3, param_1, lVar4, lVar6, param_6);
               ...
               LAB_001014b7:lVar6 = param_5 / 2;
               piVar3 = __upper_bound<int*,int,__gnu_cxx::__ops::_Val_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(param_1, param_2, param_2[lVar6], param_6);
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* void std::__inplace_stable_sort<int*,
   __gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,
   3> > const&)::{lambda(int const&, int const&)#1}> >(int*, int*,
   __gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,
   3> > const&)::{lambda(int const&, int const&)#1}>) */void std::__inplace_stable_sort<int*,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(long param_1, long param_2, undefined8 param_3) {
   long lVar1;
   long lVar2;
   if (0x38 < param_2 - param_1) {
      lVar2 = ( param_2 - param_1 >> 3 ) * 4;
      lVar1 = param_1 + lVar2;
      __inplace_stable_sort<int*,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(param_1, lVar1);
      __inplace_stable_sort<int*,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(lVar1, param_2, param_3);
      __merge_without_buffer<int*,long,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(param_1, lVar1, param_2, lVar2 >> 2, param_2 - lVar1 >> 2, param_3);
      return;
   }
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* void std::__merge_adaptive_resize<int*, long, int*,
   __gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,
   3> > const&)::{lambda(int const&, int const&)#1}> >(int*, int*, int*, long, long, int*, long,
   __gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,
   3> > const&)::{lambda(int const&, int const&)#1}>) */void std::__merge_adaptive_resize<int*,long,int*,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(int *param_1, int *param_2, undefined8 param_3, long param_4, long param_5, int *param_6, long param_7, undefined8 param_8) {
   int iVar1;
   int *piVar2;
   int *__src;
   size_t sVar3;
   ...
   if (lVar6 <= param_7) {
      LAB_0010185a:__merge_adaptive<int*,long,int*,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(param_1, param_2, param_3, param_4, param_5, param_6);
      return;
   }

   local_78 = param_1;
   if (param_4 <= param_5) goto LAB_00101749;
   LAB_00101625:local_70 = param_4 / 2;
   __src = local_78 + local_70;
   piVar2 = __lower_bound<int*,int,__gnu_cxx::__ops::_Iter_comp_val<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(param_2, param_3, *__src, param_8);
   lVar6 = (long)piVar2 - (long)param_2 >> 2;
   ...
   do {
      ...
      LAB_001016f4:param_2 = piVar2;
      param_5 = param_5 - lVar6;
      __merge_adaptive_resize<int*,long,int*,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(local_78, __src, param_1, local_70, lVar6, param_6, param_7, param_8);
      lVar6 = param_5;
      if (param_4 <= param_5) {
         lVar6 = param_4;
      }
      ...
      LAB_00101749:lVar6 = param_5 / 2;
      piVar2 = param_2 + lVar6;
      __src = __upper_bound<int*,int,__gnu_cxx::__ops::_Val_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(local_78, param_2, *piVar2, param_8);
      local_70 = (long)__src - (long)local_78 >> 2;
      param_4 = param_4 - local_70;
   }
 while ( lVar6 < param_4 );
   LAB_0010179d:if (param_7 < param_4) {
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* void std::__stable_sort_adaptive_resize<int*, int*, long,
   __gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,
   3> > const&)::{lambda(int const&, int const&)#1}> >(int*, int*, int*, long,
   __gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,
   3> > const&)::{lambda(int const&, int const&)#1}>) */void std::__stable_sort_adaptive_resize<int*,int*,long,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(long param_1, long param_2, undefined8 param_3, long param_4, undefined8 param_5) {
   long lVar1;
   long lVar2;
   long lVar3;
   ...
   lVar1 = param_1 + lVar2;
   if (param_4 < lVar3) {
      __stable_sort_adaptive_resize<int*,int*,long,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(param_1, lVar1, param_3);
      __stable_sort_adaptive_resize<int*,int*,long,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(lVar1, param_2, param_3, param_4, param_5);
      __merge_adaptive_resize<int*,long,int*,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(param_1, lVar1, param_2, lVar2 >> 2, param_2 - lVar1 >> 2, param_3, param_4, param_5);
      return;
   }

   __stable_sort_adaptive<int*,int*,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(param_1, lVar1, param_2, param_3);
   return;
}
/* std::_Rb_tree<int, std::pair<int const, manifold::Manifold::Impl::Relation>,
   std::_Select1st<std::pair<int const, manifold::Manifold::Impl::Relation> >, std::less<int>,
   ...
   [clone .isra.0] */void std::_Rb_tree<int,std::pair<int_const,manifold::Manifold::Impl::Relation>,std::_Select1st<std::pair<int_const,manifold::Manifold::Impl::Relation>>,std::less<int>,std::allocator<std::pair<int_const,manifold::Manifold::Impl::Relation>>>::_M_erase(_Rb_tree_node *param_1) {
   void *pvVar1;
   void *pvVar2;
   void *pvVar3;
   void *pvVar4;
...
/* manifold::Manifold::Impl::ReserveIDs(unsigned int) */int manifold::Manifold::Impl::ReserveIDs(uint param_1) {
   int iVar1;
   LOCK();
...
/* manifold::Manifold::Impl::RemoveUnreferencedVerts() */void manifold::Manifold::Impl::RemoveUnreferencedVerts(Impl *this) {
   undefined8 *puVar1;
   undefined8 uVar2;
   int *piVar3;
   void *__ptr;
 ...
 while ( lVar6 != lVar5 );
   LAB_00101d27:if (__ptr == (void*)0x0) {
      return;
   }
...
/* manifold::Manifold::Impl::InitializeOriginal(bool) */void manifold::Manifold::Impl::InitializeOriginal(Impl *this, bool param_1) {
   ...
   *(int*)( this + 0xc0 ) = meshIDCounter_;
   ...
   if (*(ulong*)( this + 0x120 ) < uVar20) {
      ...
      *(undefined8**)( this + 0x110 ) = puVar11;
      *(ulong*)( this + 0x120 ) = uVar20;
      LAB_00101f88:lVar14 = uVar20 * 0x10 + *(long*)( this + 0x110 );
 ...
 while ( uVar10 < ( ( ulong )(( lVar14 + -0x10 ) - lVar17) >> 4 ) + 1 );
      *(ulong*)( this + 0x118 ) = uVar20;
      ...
      LAB_00101de0:if (uVar9 < uVar20) goto LAB_00101f88;
      LAB_00101de9:*(ulong*)( this + 0x118 ) = uVar20;
   }

   if (uVar13 <= ( SUB168(ZEXT816(0xaaaaaaaaaaaaaaab) * auVar23, 8) & 0xfffffffffffffffe )) goto LAB_00101df9;
   if (uVar2 < 3) {
      puVar7 = *(undefined8**)( this + 0x110 );
      puVar11 = (undefined8*)0x0;
      LAB_00101ff8:if (puVar7 == (undefined8*)0x0) {
         *(undefined8**)( this + 0x110 ) = puVar11;
         *(ulong*)( this + 0x120 ) = uVar20;
         goto LAB_00101df9;
      }
   ...
   *(undefined8*)( this + 0x120 ) = *(undefined8*)( this + 0x118 );
   LAB_00101df9:uVar2 = *(ulong*)( this + 0x68 );
   if (2 < uVar2) {
 ...
 while ( uVar2 / 3 != uVar13 );
   ...
   while (pvVar5 != (void*)0x0) {
      std::_Rb_tree<int,std::pair<int_const,manifold::Manifold::Impl::Relation>,std::_Select1st<std::pair<int_const,manifold::Manifold::Impl::Relation>>,std::less<int>,std::allocator<std::pair<int_const,manifold::Manifold::Impl::Relation>>>::_M_erase(*(_Rb_tree_node**)( (long)pvVar5 + 0x18 ));
      pvVar3 = *(void**)( (long)pvVar5 + 0x10 );
      operator_delete(pvVar5, 0x98);
      pvVar5 = pvVar3;
   }
;
   ...
   *(undefined2*)( p_Var8 + 0x76 ) = 0x3ff0;
   auVar23 = std::_Rb_tree<int,std::pair<int_const,manifold::Manifold::Impl::Relation>,std::_Select1st<std::pair<int_const,manifold::Manifold::Impl::Relation>>,std::less<int>,std::allocator<std::pair<int_const,manifold::Manifold::Impl::Relation>>>::_M_get_insert_hint_unique_pos((_Rb_tree<int,std::pair<int_const,manifold::Manifold::Impl::Relation>,std::_Select1st<std::pair<int_const,manifold::Manifold::Impl::Relation>>,std::less<int>,std::allocator<std::pair<int_const,manifold::Manifold::Impl::Relation>>>*)( this + 0xe0 ), p_Var1, iVar6);
   ...
   *(int*)( p_Var19 + 0x28 ) = iVar6;
   ...
   for (int i = 0; i < 3; i++) {
      *(undefined8*)( p_Var19 + ( 32*i + 48 ) ) = uVar4;
      *(undefined8*)( p_Var19 + ( 32*i + 56 ) ) = 0;
      *(undefined1(*) [16])( p_Var19 + ( 32*i + 64 ) ) = (undefined1[16])0;
   }

   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int, 3> > const&) */void manifold::Manifold::Impl::CreateHalfedges(Impl *this, Vec *param_1) {
   uint *puVar1;
   int *piVar2;
   uint uVar3;
   uint uVar4;
   ...
   *(undefined8*)( this + 0x68 ) = 0;
   ...
   if (lVar24 == 0) {
      uVar23 = 0;
      if (*(ulong*)( this + 0x70 ) < uVar17) {
         puVar14 = (undefined8*)malloc(uVar17 * 0xc);
         pvVar10 = *(void**)( this + 0x60 );
         if (pvVar10 != (void*)0x0) goto LAB_0010284c;
         *(undefined8**)( this + 0x60 ) = puVar14;
         uVar15 = *(ulong*)( this + 0x68 );
         *(ulong*)( this + 0x70 ) = uVar17;
         joined_r0x00102937:if (uVar15 < uVar17) {
            LAB_0010287a:puVar12 = (undefined8*)( (long)puVar14 + uVar15 * 0xc );
            puVar14 = (undefined8*)( (long)puVar14 + uVar17 * 0xc );
            if (puVar14 != puVar12) goto LAB_001026d8;
            *(ulong*)( this + 0x68 ) = uVar17;
            if (uVar23 <= uVar21) goto LAB_00102568;
            goto LAB_00102704;
         }

         LAB_00102564:*(ulong*)( this + 0x68 ) = uVar17;
      }
 else {
         if (uVar17 == 0) goto LAB_001021f2;
         puVar14 = (undefined8*)( (long)*(undefined8**)( this + 0x60 ) + uVar17 * 0xc );
 ...
 while ( puVar13 != puVar14 );
         LAB_001026ef:*(ulong*)( this + 0x68 ) = uVar17;
         if (uVar21 < uVar23) {
            LAB_00102704:sVar16 = uVar17 * 0xc;
 ...
 else if (puVar12 == (undefined8*)0x0) goto LAB_00102747;
            }
 else {
               memmove(puVar14, puVar12, sVar16);
            }

            free(puVar12);
            LAB_00102747:*(undefined8**)( this + 0x60 ) = puVar14;
      ...
      LAB_00102568:local_68 = malloc(uVar17 * 8);
      local_60 = uVar17;
      uStack_58 = uVar17;
      __ptr = (undefined4*)malloc(uVar17 * 4);
      uVar15 = 0;
      uVar21 = (long)( uVar17 * 4 ) >> 2;
      if (( uVar21 & 1 ) == 0) {
         LAB_001025c0:do {
            __ptr[uVar15] = (int)uVar15;
            lVar24 = uVar15 + 1;
            uVar15 = uVar15 + 2;
            __ptr[lVar24] = (int)lVar24;
         }
 while ( uVar15 != uVar21 );
      }
 else {
         uVar15 = 1;
         *__ptr = 0;
         if (uVar21 != 1) goto LAB_001025c0;
      }

      puVar27 = __ptr + uVar17;
      if (lVar29 != 0) goto LAB_0010220b;
   }
 else {
      if (*(void**)( this + 0x60 ) == (void*)0x0) {
         ...
         *(ulong*)( this + 0x70 ) = uVar23;
         if (uVar23 < uVar17) {
            ...
            if ((long)sVar16 < 0xd) {
               if (sVar16 == 0xc) {
                  pvVar10 = (void*)0x0;
                  *puVar14 = _DAT_00000000;
                  *(undefined4*)( puVar14 + 1 ) = _DAT_00000008;
                  goto LAB_0010284c;
               }

            }
 else {
               puVar14 = (undefined8*)memmove(puVar14, (void*)0x0, sVar16);
               pvVar10 = (void*)0x0;
               LAB_0010284c:free(pvVar10);
            }

            uVar15 = *(ulong*)( this + 0x68 );
            *(undefined8**)( this + 0x60 ) = puVar14;
            *(ulong*)( this + 0x70 ) = uVar17;
            if (uVar15 < uVar17) goto LAB_0010287a;
            goto LAB_001026ef;
         }
         ...
         *(ulong*)( this + 0x68 ) = uVar17;
         if (uVar21 < uVar23) {
            ...
            if (uVar17 != 0) goto LAB_00102704;
            goto LAB_00102747;
         }

         LAB_00102753:local_68 = (void*)0x0;
         uStack_58 = 0;
         if (uVar17 != 0) goto LAB_00102568;
      }

      LAB_001021f2:uStack_58 = 0;
      local_68 = (void*)0x0;
      local_60 = 0;
      puVar27 = (undefined4*)0x0;
      uVar21 = 0;
      __ptr = (undefined4*)0x0;
      if (lVar29 == 0) goto LAB_001024f6;
      LAB_0010220b:local_50 = _LC9;
      lVar24 = *(long*)param_1;
      lVar26 = 0;
      lVar11 = *(long*)( this + 0x60 );
      do {
         local_48 = 2;
         puVar1 = (uint*)( lVar24 + (long)(int)lVar26 * 0xc );
         piVar18 = (int*)&local_50;
         do {
            iVar30 = *piVar18;
            lVar25 = (long)( iVar30 + (int)lVar26 * 3 );
            puVar14 = (undefined8*)( lVar11 + lVar25 * 0xc );
            if (iVar30 == 0) {
               uVar7 = *(undefined8*)puVar1;
               *(undefined4*)( puVar14 + 1 ) = 0xffffffff;
               *puVar14 = uVar7;
               uVar3 = *puVar1;
               uVar4 = puVar1[1];
               LAB_001022a7:uVar15 = (ulong)(int)uVar3;
               ...
               uVar23 = ( ulong )((int)uVar3 < (int)uVar4) << 0x3f | (ulong)uVar9 << 0x20;
            }
 else {
               uVar3 = puVar1[2];
               if (iVar30 == 1) {
               ...
               if (iVar30 == 0) {
                  ...
                  *puVar14 = CONCAT44(uVar4, uVar3);
                  ...
                  uVar23 = (ulong)uVar9 << 0x20 | ( ulong )((int)uVar3 < (int)uVar4) << 0x3f;
               }
 else if (iVar30 == 1) {
                  uVar4 = puVar1[1];
                  *(undefined4*)( puVar14 + 1 ) = 0xffffffff;
                  *puVar14 = CONCAT44(uVar4, uVar3);
                  ...
                  uVar23 = (ulong)uVar9 << 0x20 | ( ulong )((int)uVar4 < (int)uVar3) << 0x3f;
                  uVar17 = (ulong)(int)uVar3;
               }
 else {
                  *(undefined4*)( puVar14 + 1 ) = 0xffffffff;
                  *puVar14 = CONCAT44(uVar3, uVar3);
                  uVar15 = (ulong)(int)puVar1[2];
                  uVar17 = (ulong)(int)puVar1[2];
                  uVar23 = uVar15 << 0x20;
               }
            ...
            piVar18 = piVar18 + 1;
            *(ulong*)( (long)local_68 + lVar25 * 8 ) = uVar17 | uVar23;
         }
 ...
 while ( lVar29 != lVar26 );
   ...
   if (__ptr != puVar27) {
      lVar24 = (long)( uVar21 + 1 ) >> 1;
      lVar29 = lVar24;
      while (true) {
         uVar21 = lVar29 * 4;
         pvVar10 = operator_new(uVar21, (nothrow_t*)&std::nothrow);
         if (pvVar10 != (void*)0x0) break;
         if (lVar29 == 1) {
            uVar21 = 0;
            std::__inplace_stable_sort<int*,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(__ptr, puVar27, &local_68);
            goto LAB_00102383;
         }
...
;
      if (lVar24 == lVar29) {
         std::__stable_sort_adaptive<int*,int*,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(__ptr, __ptr + lVar29, puVar27, pvVar10);
      }
 else {
         std::__stable_sort_adaptive_resize<int*,int*,long,__gnu_cxx::__ops::_Iter_comp_iter<manifold::Manifold::Impl::CreateHalfedges(manifold::Vec<linalg::vec<int,3>>const&)::_lambda(int_const&,int_const&)_1_>>(__ptr, puVar27, pvVar10, lVar29);
      }

      LAB_00102383:operator_delete(pvVar10, uVar21);
   }

   iVar30 = iVar6 / 2;
   if (iVar6 < 2) {
      if (iVar30 != 0) {
         lVar29 = *(long*)( this + 0x60 );
         goto LAB_001024a8;
      }
      ...
      lVar29 = *(long*)( this + 0x60 );
      iVar28 = 0;
      piVar18 = __ptr + iVar30;
      iVar19 = iVar30;
      do {
         iVar22 = piVar18[-(long)iVar30];
         piVar2 = (int*)( lVar29 + (long)iVar22 * 0xc );
         iVar8 = iVar22 + -2;
         if (0x55555554 < ( iVar22 + 1 ) * -0x55555555 + 0x2aaaaaaaU) {
            iVar8 = iVar22 + 1;
         }
         ...
         do {
            iVar5 = *piVar20;
            lVar24 = (long)iVar5 * 0xc;
            if (( ( (int*)( lVar29 + lVar24 ) )[1] != *piVar2 ) || ( *(int*)( lVar29 + lVar24 ) != piVar2[1] )) break;
            lVar11 = lVar24 + -0x18;
            if (0x55555554 < ( iVar5 + 1 ) * -0x55555555 + 0x2aaaaaaaU) {
               lVar11 = lVar24 + 0xc;
            }

            if (*(int*)( lVar29 + (long)iVar8 * 0xc + 4 ) == *(int*)( lVar29 + 4 + lVar11 )) {
               if (iVar22 != iVar19) {
                  iVar22 = *piVar18;
                  *piVar18 = iVar5;
                  *piVar20 = iVar22;
 ...
 while ( iVar28 < iVar30 );
      LAB_001024a8:lVar24 = 0;
      do {
         iVar6 = __ptr[(int)lVar24];
         piVar18 = (int*)( lVar29 + (long)iVar6 * 0xc );
         if (-1 < *piVar18) {
            iVar19 = __ptr[iVar30 + (int)lVar24];
            piVar18[2] = iVar19;
            *(int*)( lVar29 + 8 + (long)iVar19 * 0xc ) = iVar6;
         }
 ...
 while ( lVar24 != iVar30 );
   ...
   LAB_001024f6:if (local_68 != (void*)0x0) {
      free(local_68);
   }
...
/* manifold::Manifold::Impl::Update() */void manifold::Manifold::Impl::Update(Impl *this) {
   undefined8 *puVar1;
   int *piVar2;
   undefined8 *puVar3;
   int iVar4;
 ...
 while ( local_60._0_8_ * 0x30 != lVar13 );
   ...
   if (lVar13 == 0) goto LAB_00102a6d;
   __ptr = calloc(lVar13 * 4, 1);
   lVar10 = *(long*)( this + 0x158 );
   lVar11 = *(long*)( this + 0x170 );
   if (lVar13 * 4 == 0) {
      if (lVar13 != -1) goto LAB_00102ae4;
      LAB_00102bc8:if (__ptr == (void*)0x0) goto LAB_00102a6d;
   }
 else if (lVar13 != -1) {
      LAB_00102ae4:lVar17 = 0;
      do {
 ...
 while ( bVar18 );
   ...
   free(__ptr);
   LAB_00102a6d:if (local_48 != (void*)0x0) {
      free(local_48);
   }
...
/* WARNING: Removing unreachable block (ram,0x00102eb1) *//* manifold::Manifold::Impl::MarkFailure(manifold::Manifold::Error) */void manifold::Manifold::Impl::MarkFailure(Impl *this, undefined4 param_2) {
   Impl *pIVar1;
   long lVar2;
   void *pvVar3;
   undefined8 uVar4;
   ...
   *(undefined8*)( this + 0x28 ) = uVar4;
   ...
   for (int i = 0; i < 4; i++) {
      lVar2 = *(long*)( this + ( 24*i + 104 ) );
      *(undefined8*)( this + ( 24*i + 104 ) ) = 0;
      if (lVar2 != 0) {
         uVar4 = 0;
         if (*(void**)( this + ( 24*i + 96 ) ) != (void*)0) {
            free(*(void**)( this + ( 24*i + 96 ) ));
            uVar4 = *(undefined8*)( this + ( 24*i + 104 ) );
         }

         *(undefined8*)( this + ( 24*i + 96 ) ) = 0;
         *(undefined8*)( this + ( 24*i + 112 ) ) = uVar4;
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* manifold::Manifold::Impl::SetEpsilon(double, bool) */void manifold::Manifold::Impl::SetEpsilon(Impl *this, double param_1, bool param_2) {
   double dVar1;
   double dVar2;
   double dVar3;
   ...
   *(double*)( this + 0x30 ) = dVar1;
   dVar2 = dVar1;
   if (( param_2 ) && ( dVar2 = dVar3 * __LC30 <= dVar1 )) {
      dVar2 = dVar1;
   }
...
/* manifold::Manifold::Impl::Transform(linalg::mat<double, 3, 4> const&) const */mat *manifold::Manifold::Impl::Transform(mat *param_1) {
   ulong *puVar1;
   double dVar2;
   double dVar3;
   undefined4 uVar4;
   ...
   if (dVar46 == _LC5) {
      dVar50 = in_RDX[1];
      if (( dVar50 == 0.0 ) && ( dVar50 = dVar50 == 0.0 )) {
         if (in_RDX[3] != 0.0) goto LAB_001031b0;
         dVar60 = in_RDX[4];
         dVar61 = dVar46;
         dVar50 = dVar60;
         if (dVar60 == _LC5) {
            if (in_RDX[5] == 0.0) {
               if (in_RDX[6] != 0.0) goto LAB_001031b0;
               dVar50 = in_RDX[7];
               if (dVar50 == 0.0) {
                  dVar50 = in_RDX[8];
                  dVar61 = dVar60;
   ...
   if (*(int*)( in_RSI + 0x40 ) == 0) {
      if (( ( ( ( ( ( ( ( ( ( _LC6 < (double)( (ulong)in_RDX[1] & _LC14 ) || _LC6 < (double)( (ulong)dVar46 & _LC14 ) ) || _LC6 < (double)( (ulong)in_RDX[2] & _LC14 ) ) || _LC6 < (double)( (ulong)in_RDX[3] & _LC14 ) ) || _LC6 < (double)( (ulong)in_RDX[4] & _LC14 ) ) || _LC6 < (double)( (ulong)in_RDX[5] & _LC14 ) ) || _LC6 < (double)( (ulong)in_RDX[6] & _LC14 ) ) || _LC6 < (double)( (ulong)in_RDX[7] & _LC14 ) ) || _LC6 < (double)( (ulong)in_RDX[8] & _LC14 ) ) || _LC6 < (double)( (ulong)in_RDX[9] & _LC14 ) ) || _LC6 < (double)( (ulong)in_RDX[10] & _LC14 ) ) || ( _LC6 < (double)( _LC14 & (ulong)in_RDX[0xb] ) )) {
 ...
 while ( uVar40 < ( ulong )((long)sVar38 >> 3) );
         ...
         if (*(_Rb_tree_node**)( in_RSI + 0xf0 ) != (_Rb_tree_node*)0x0) {
            local_e8 = std::_Rb_tree<int,std::pair<int_const,manifold::Manifold::Impl::Relation>,std::_Select1st<std::pair<int_const,manifold::Manifold::Impl::Relation>>,std::less<int>,std::allocator<std::pair<int_const,manifold::Manifold::Impl::Relation>>>::_M_copy<false,std::_Rb_tree<int,std::pair<int_const,manifold::Manifold::Impl::Relation>,std::_Select1st<std::pair<int_const,manifold::Manifold::Impl::Relation>>,std::less<int>,std::allocator<std::pair<int_const,manifold::Manifold::Impl::Relation>>>::_Reuse_or_alloc_node>(*(_Rb_tree_node**)( in_RSI + 0xf0 ), (_Rb_tree_node_base*)local_f0, (_Reuse_or_alloc_node*)local_228);
            p_Var23 = local_e8;
            do {
 ...
 while ( *(_Rb_tree_node_base**)( local_d8 + 0x18 ) != (_Rb_tree_node_base*)0x0 );
            ...
            while (pvVar22 != (void*)0x0) {
               std::_Rb_tree<int,std::pair<int_const,manifold::Manifold::Impl::Relation>,std::_Select1st<std::pair<int_const,manifold::Manifold::Impl::Relation>>,std::less<int>,std::allocator<std::pair<int_const,manifold::Manifold::Impl::Relation>>>::_M_erase(*(_Rb_tree_node**)( (long)pvVar22 + 0x18 ));
...
;
         ...
         if ((ulong)local_128._8_8_ < uVar40) {
            ...
            if (uVar51 == 0) {
               ...
               uVar35 = uVar51;
               if (local_130 != (undefined8*)0x0) goto LAB_00104959;
            }

            local_128._0_8_ = uVar35;
            local_130 = puVar30;
            if (uVar35 < uVar40) goto LAB_00103680;
            joined_r0x001049b3:local_128._0_8_ = uVar40;
            if (uVar40 * 2 < (ulong)uVar51) {
               LAB_001049b9:puVar33 = local_130;
               sVar38 = uVar40 << 5;
               puVar30 = (undefined8*)malloc(sVar38);
               if ((long)sVar38 < 0x21) {
                  if (sVar38 != 0x20) goto LAB_00104385;
                  uVar51 = puVar33[1];
                  *puVar30 = *puVar33;
                  puVar30[1] = uVar51;
                  uVar51 = puVar33[3];
               ...
               LAB_001049f6:free(puVar33);
               LAB_0010438e:local_128._8_8_ = local_128._0_8_;
               local_130 = puVar30;
            }
            ...
            if ((ulong)local_128._0_8_ < uVar40) {
               LAB_00103680:pauVar25 = (undefined1(*) [16])( local_130 + local_128._0_8_ * 4 );
 ...
 while ( uVar35 < ( ( ulong )((long)( local_130 + uVar40 * 4 ) + ( -0x20 - (long)pauVar25 )) >> 5 ) + 1 );
               }

               goto joined_r0x001049b3;
            }

            local_128._0_8_ = uVar40;
            if (uVar40 * 2 < (ulong)uVar51) {
               if (uVar40 != 0) goto LAB_001049b9;
               puVar30 = (undefined8*)0x0;
               puVar33 = local_130;
               LAB_00104385:if (puVar33 != (undefined8*)0x0) goto LAB_001049f6;
               goto LAB_0010438e;
            }
         ...
         while (local_190 = pdVar32,p_Var27 != (_Rb_tree_node_base*)local_f0) {
            ...
            *(double*)( p_Var27 + 0x30 ) = dVar57 * dVar41 + dVar60 * dVar45 + dVar61 * dVar58 + dVar20 * 0.0;
            *(double*)( p_Var27 + 0x38 ) = dVar57 * dVar42 + dVar60 * dVar3 + dVar61 * dVar47 + dVar21 * 0.0;
            *(double*)( p_Var27 + 0x40 ) = dVar60 * dVar44 + dVar61 * dVar59 + dVar46 * dVar57 + dVar43 * 0.0;
            *(double*)( p_Var27 + 0x48 ) = dVar15 * dVar49 + dVar54 * dVar45 + dVar11 * dVar41 + dVar50 * 0.0;
            *(double*)( p_Var27 + 0x50 ) = dVar14 * dVar49 + dVar54 * dVar3 + dVar11 * dVar42 + dVar2 * 0.0;
            *(double*)( p_Var27 + 0x58 ) = dVar59 * dVar49 + dVar54 * dVar44 + dVar46 * dVar11 + dVar43 * 0.0;
            *(double*)( p_Var27 + 0x60 ) = dVar15 * dVar13 + dVar12 * dVar45 + dVar41 * dVar16 + dVar50 * 0.0;
            *(double*)( p_Var27 + 0x68 ) = dVar3 * dVar12 + dVar13 * dVar14 + dVar42 * dVar16 + dVar2 * 0.0;
            *(double*)( p_Var27 + 0x70 ) = dVar44 * dVar12 + dVar13 * dVar59 + dVar46 * dVar16 + dVar43 * 0.0;
...
;
         ...
         if ((ulong)local_188._8_8_ < uVar40) {
            ...
            if (uVar51 == 0) {
               ...
               uVar35 = uVar51;
               if (local_190 != (double*)0x0) goto LAB_00104b15;
            }

            local_188._0_8_ = uVar35;
            local_190 = pdVar37;
            if (uVar35 < uVar40) goto LAB_00104483;
            joined_r0x00104b65:local_188._0_8_ = uVar40;
            if (uVar40 * 2 < (ulong)uVar51) {
               LAB_00104b6b:pdVar32 = local_190;
               sVar38 = uVar40 * 0x18;
               pdVar37 = (double*)malloc(sVar38);
               if ((long)sVar38 < 0x19) {
                  if (sVar38 != 0x18) goto LAB_001039b2;
                  dVar46 = pdVar32[1];
                  *pdVar37 = *pdVar32;
                  pdVar37[1] = dVar46;
                  pdVar37[2] = pdVar32[2];
               ...
               LAB_00104ba8:free(pdVar32);
               LAB_001039bb:local_188._8_8_ = local_188._0_8_;
               local_190 = pdVar37;
            }
            ...
            if ((ulong)local_188._0_8_ < uVar40) {
               LAB_00104483:for (pauVar25 = (undefined1(*) [16])( local_190 + local_188._0_8_ * 3 ); (undefined1(*) [16])( local_190 + uVar40 * 3 ) != pauVar25; pauVar25 = (undefined1(*) [16])( pauVar25[1] + 8 )) {
                  *(undefined8*)pauVar25[1] = 0;
                  *pauVar25 = (undefined1[16])0x0;
               }

               goto joined_r0x00104b65;
            }

            local_188._0_8_ = uVar40;
            if (uVar40 * 2 < (ulong)uVar51) {
               if (uVar40 != 0) goto LAB_00104b6b;
               pdVar37 = (double*)0x0;
               LAB_001039b2:if (pdVar32 != (double*)0x0) goto LAB_00104ba8;
               goto LAB_001039bb;
            }
         ...
         if ((ulong)local_140._8_8_ < uVar40) {
            ...
            if (uVar51 == 0) {
               ...
               uVar35 = uVar51;
               if (local_148 != (undefined8*)0x0) goto LAB_00104a3c;
            }

            local_140._0_8_ = uVar35;
            local_148 = puVar30;
            if (uVar35 < uVar40) goto LAB_00104413;
            joined_r0x00104a8c:local_140._0_8_ = uVar40;
            if (uVar40 * 2 < (ulong)uVar51) {
               LAB_00104a92:puVar33 = local_148;
               sVar38 = uVar40 * 0x18;
               puVar30 = (undefined8*)malloc(sVar38);
               if ((long)sVar38 < 0x19) {
                  if (sVar38 != 0x18) goto LAB_00103a1f;
                  uVar51 = puVar33[1];
                  *puVar30 = *puVar33;
                  puVar30[1] = uVar51;
                  puVar30[2] = puVar33[2];
               ...
               LAB_00104acf:free(puVar33);
               LAB_00103a28:local_140._8_8_ = local_140._0_8_;
               local_148 = puVar30;
            }
            ...
            if ((ulong)local_140._0_8_ < uVar40) {
               LAB_00104413:for (pauVar25 = (undefined1(*) [16])( local_148 + local_140._0_8_ * 3 ); (undefined1(*) [16])( local_148 + uVar40 * 3 ) != pauVar25; pauVar25 = (undefined1(*) [16])( pauVar25[1] + 8 )) {
                  *(undefined8*)pauVar25[1] = 0;
                  *pauVar25 = (undefined1[16])0x0;
               }
            ...
            if (uVar40 * 2 < (ulong)uVar51) {
               if (uVar40 != 0) goto LAB_00104a92;
               puVar30 = (undefined8*)0x0;
               puVar33 = local_148;
               LAB_00103a1f:if (puVar33 != (undefined8*)0x0) goto LAB_00104acf;
               goto LAB_00103a28;
            }
         ...
         if ((ulong)local_158._8_8_ < uVar40) {
            ...
            if (uVar51 == 0) {
               ...
               uVar29 = uVar51;
               if (puVar33 != (undefined8*)0x0) goto LAB_00104bf5;
            }

            local_158._0_8_ = uVar29;
            local_160 = puVar30;
            if (uVar29 < uVar40) goto LAB_00103a7d;
            local_158._0_8_ = uVar40;
            if ((ulong)uVar51 <= uVar35) goto LAB_00103ad0;
            LAB_00104c4b:puVar33 = local_160;
            sVar38 = uVar40 * 0x18;
            puVar30 = (undefined8*)malloc(sVar38);
            if ((long)sVar38 < 0x19) {
               if (sVar38 == 0x18) {
               ...
               LAB_001043d0:if (puVar33 != (undefined8*)0x0) goto LAB_00104c7f;
            }
 else {
               puVar30 = (undefined8*)memmove(puVar30, puVar33, sVar38);
               LAB_00104c7f:free(puVar33);
            }
            ...
            LAB_00103a7d:for (pauVar25 = (undefined1(*) [16])( local_160 + local_158._0_8_ * 3 ); (undefined1(*) [16])( local_160 + uVar40 * 3 ) != pauVar25; pauVar25 = (undefined1(*) [16])( pauVar25[1] + 8 )) {
               *(undefined8*)pauVar25[1] = 0;
               *pauVar25 = (undefined1[16])0x0;
            }

            local_158._0_8_ = uVar40;
            if (uVar35 < (ulong)uVar51) goto LAB_00104c4b;
         }
 else {
            local_158._0_8_ = uVar40;
            if (uVar35 < (ulong)uVar51) {
               if (uVar40 != 0) goto LAB_00104c4b;
               puVar30 = (undefined8*)0x0;
               goto LAB_001043d0;
            }
         ...
         LAB_00103ad0:puVar33 = local_160;
         dVar43 = in_RDX[4];
         dVar58 = in_RDX[5];
 ...
 while ( pdVar32 != pdVar37 );
         ...
         dVar46 = ( dVar45 * dVar2 - dVar61 * dVar3 ) * local_2d8 + ( dVar60 * dVar61 - dVar50 * dVar45 ) * dVar41 + ( dVar50 * dVar3 - dVar60 * dVar2 ) * dVar59;
         ...
         transform<linalg::vec<double,3>const*,linalg::vec<double,3>*,(anonymous_namespace)::TransformNormals>(*(long*)( in_RSI + 0x90 ), *(long*)( in_RSI + 0x90 ) + *(long*)( in_RSI + 0x98 ) * 0x18, local_148);
         local_208 = local_258;
         ...
         local_218 = auVar52;
         local_1e8 = dVar46;
         transform<linalg::vec<double,3>const*,linalg::vec<double,3>*,(anonymous_namespace)::TransformNormals>(*(long*)( in_RSI + 0x78 ), *(long*)( in_RSI + 0x78 ) + *(long*)( in_RSI + 0x80 ) * 0x18, puVar33);
         dVar61 = in_RDX[6];
         dVar45 = in_RDX[7];
         dVar46 = in_RDX[8];
         dVar3 = *in_RDX;
         ...
         dVar58 = in_RDX[4];
         dVar60 = in_RDX[5];
         dVar47 = ( dVar46 * dVar58 - dVar60 * dVar45 ) * dVar3 + ( dVar60 * dVar61 - dVar46 * dVar43 ) * dVar2 + ( dVar45 * dVar43 - dVar58 * dVar61 ) * dVar50;
         if (lVar7 != 0) {
 ...
 while ( (ulong)local_170._0_8_ / 3 != uVar40 );
   ...
   while (p_Var23 != (_Rb_tree_node*)0x0) {
      std::_Rb_tree<int,std::pair<int_const,manifold::Manifold::Impl::Relation>,std::_Select1st<std::pair<int_const,manifold::Manifold::Impl::Relation>>,std::less<int>,std::allocator<std::pair<int_const,manifold::Manifold::Impl::Relation>>>::_M_erase(*(_Rb_tree_node**)( p_Var23 + 0x18 ));
...
;
   ...
   LAB_0010418c:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* manifold::Manifold::Impl::CalculateNormals() */void manifold::Manifold::Impl::CalculateNormals(Impl *this) {
   double *pdVar1;
   int iVar2;
   double *pdVar3;
   long lVar4;
   ...
   if (*(ulong*)( this + 0x88 ) < uVar29) {
      ...
      if (uVar28 == 0) {
         ...
         if (puVar22 != (undefined8*)0x0) goto LAB_00105fd1;
      }

      *(undefined1(**) [16])( this + 0x78 ) = pauVar17;
      *(ulong*)( this + 0x88 ) = uVar29;
      if (uVar16 < uVar29) goto LAB_00104f70;
      *(ulong*)( this + 0x80 ) = uVar29;
      if (uVar20 < uVar28) goto LAB_00105f75;
      pauVar19 = (undefined1(*) [16])( uVar29 * 0x18 + (long)pauVar17 );
   }
 else {
      if (uVar28 < uVar29) {
         pauVar17 = *(undefined1(**) [16])( this + 0x78 );
         LAB_00104f70:pauVar19 = (undefined1(*) [16])( (long)pauVar17 + uVar29 * 0x18 );
         pauVar12 = (undefined1(*) [16])( (long)pauVar17 + uVar16 * 0x18 );
         if (pauVar19 == pauVar12) {
            *(ulong*)( this + 0x80 ) = uVar29;
            if (uVar28 <= uVar20) goto LAB_00104fc2;
         }
 else {
            do {
 ...
 while ( pauVar19 != (undefined1(*) [16])( *pauVar17 + 8 ) );
            *(ulong*)( this + 0x80 ) = uVar29;
            if (uVar28 <= uVar20) goto LAB_00104fb6;
         }

         LAB_00105f75:sVar21 = uVar29 * 0x18;
         pauVar17 = (undefined1(*) [16])malloc(sVar21);
         puVar22 = *(undefined8**)( this + 0x78 );
         if ((long)sVar21 < 0x19) {
            if (sVar21 != 0x18) goto LAB_0010565f;
            uVar5 = puVar22[1];
            *(undefined8*)*pauVar17 = *puVar22;
            *(undefined8*)( *pauVar17 + 8 ) = uVar5;
            *(undefined8*)pauVar17[1] = puVar22[2];
         ...
         LAB_00105f9d:free(puVar22);
      }
 else {
         *(ulong*)( this + 0x80 ) = uVar29;
         if (uVar28 <= uVar20) {
            LAB_00104fb6:pauVar17 = *(undefined1(**) [16])( this + 0x78 );
            pauVar19 = (undefined1(*) [16])( (long)pauVar17 + uVar29 * 0x18 );
            goto LAB_00104fc2;
         }

         if (uVar29 != 0) goto LAB_00105f75;
         puVar22 = *(undefined8**)( this + 0x78 );
         pauVar17 = (undefined1(*) [16])0x0;
         LAB_0010565f:if (puVar22 != (undefined8*)0x0) goto LAB_00105f9d;
      }
   ...
   LAB_00104fc2:uVar29 = *(ulong*)( this + 0x68 );
   uVar5 = _LC9;
   dVar6 = _LC32;
   dVar32 = _LC28;
   for (pauVar12 = pauVar17; _LC9 = uVar5,_LC32 = dVar6,_LC28 = dVar32,pauVar12 != pauVar19; pauVar12 = (undefined1(*) [16])( pauVar12[1] + 8 )) {
      *(undefined8*)pauVar12[1] = 0;
      *pauVar12 = (undefined1[16])0x0;
      uVar5 = _LC9;
      dVar6 = _LC32;
   ...
   if (uVar28 == uVar20) {
      ...
      dVar30 = _LC6;
      uVar28 = _LC14;
      if (uVar29 < 3) goto joined_r0x001055a9;
      uVar29 = 0;
      do {
         for (int i = 0; i < 3; i++) {
            local_c8[i] = 0;
 ...
 while ( piVar13 != (int*)( local_88 + 0xc ) );
         ...
         do {
            ...
            pdVar26 = pdVar3;
            pdVar27 = pdVar3;
            if (( iVar2 != 0 ) && ( ( iVar2 == 1 || ( ( iVar23 = ( iVar2 + 1 ) % 3 ),pdVar26 = pdVar24,iVar23 != 0 && ( iVar23 != 1 ) ) ) )) {
               pdVar27 = pdVar24;
            }
            ...
            dVar30 = SQRT(dVar34 * dVar34 + auVar38._0_8_ * auVar38._0_8_ + 0.0 + auVar38._8_8_ * auVar38._8_8_);
 ...
 while ( &local_8c != local_178 );
         ...
         dVar40 = (double)local_58._0_8_ * (double)local_88._0_8_ + 0.0 + (double)local_58._8_8_ * stack0xffffffffffffff80 + local_48 * (double)local_78._0_8_;
         dVar34 = 0.0;
         local_98 = uVar5;
         if (( dVar32 < dVar40 ) && ( dVar34 = dVar40 < _LC5 )) {
            dVar34 = acos((double)( (ulong)dVar40 ^ _LC8 ));
         }

         dVar40 = (double)uVar7 * (double)local_78._8_8_ + 0.0 + dVar30 * (double)local_68._0_8_ + (double)uVar8 * (double)local_68._8_8_;
         dVar30 = 0.0;
         if (( dVar32 < dVar40 ) && ( dVar30 = dVar40 < _LC5 )) {
 ...
 while ( uVar20 != uVar29 );
      LAB_00105589:pauVar17 = *(undefined1(**) [16])( this + 0x78 );
   }
 else {
      uVar16 = uVar28;
      if (*(ulong*)( this + 0xa0 ) < uVar20) {
         ...
         if (uVar28 != 0) {
            ...
            if ((long)sVar21 < 0x19) {
               ...
               if (puVar22 != (undefined8*)0x0) goto LAB_00106097;
            }
 else {
               memmove(__dest, puVar22, sVar21);
               LAB_00106097:free(puVar22);
         ...
         *(undefined8**)( this + 0x90 ) = __dest;
         *(ulong*)( this + 0xa0 ) = uVar20;
         LAB_00105ed2:pauVar17 = (undefined1(*) [16])( *(long*)( this + 0x90 ) + uVar20 * 0x18 );
         pauVar19 = (undefined1(*) [16])( *(long*)( this + 0x90 ) + uVar16 * 0x18 );
         if (pauVar17 == pauVar19) goto LAB_0010502f;
         do {
 ...
 while ( pauVar17 != (undefined1(*) [16])( *pauVar12 + 8 ) );
         *(ulong*)( this + 0x98 ) = uVar20;
         if (uVar28 <= uVar20 * 2) goto LAB_00105040;
         LAB_00105f26:if (uVar29 < 3) {
            local_f0 = (undefined8*)0x0;
            puVar22 = *(undefined8**)( this + 0x90 );
            LAB_00105f44:if (puVar22 != (undefined8*)0x0) goto LAB_00106053;
         }
 else {
            sVar21 = uVar20 * 0x18;
            ...
            puVar22 = *(undefined8**)( this + 0x90 );
            if ((long)sVar21 < 0x19) {
               if (sVar21 != 0x18) goto LAB_00105f44;
               uVar5 = puVar22[1];
               *local_f0 = *puVar22;
               local_f0[1] = uVar5;
         ...
         *(undefined8**)( this + 0x90 ) = local_f0;
         ...
         LAB_00105026:if (uVar16 < uVar20) goto LAB_00105ed2;
         LAB_0010502f:*(ulong*)( this + 0x98 ) = uVar20;
         if (uVar20 * 2 < uVar28) goto LAB_00105f26;
         LAB_00105040:local_f0 = *(undefined8**)( this + 0x90 );
      }
 ...
 while ( (int*)( local_88 + 0xc ) != piVar13 );
            ...
            do {
               ...
               pdVar24 = pdVar3;
               pdVar26 = pdVar3;
               if (( iVar2 != 0 ) && ( ( iVar2 == 1 || ( ( iVar23 = ( iVar2 + 1 ) % 3 ),pdVar24 = pdVar1,iVar23 != 0 && ( iVar23 != 1 ) ) ) )) {
                  pdVar26 = pdVar1;
               }
               ...
               dVar30 = SQRT(dVar34 * dVar34 + auVar35._0_8_ * auVar35._0_8_ + 0.0 + auVar35._8_8_ * auVar35._8_8_);
 ...
 while ( piVar13 != &local_8c );
            ...
            uVar7 = local_88._0_8_;
            auVar39._0_8_ = (double)local_68._8_8_ * stack0xffffffffffffff80 - (double)local_78._0_8_ * (double)local_68._0_8_;
            auVar39._8_8_ = (double)local_78._8_8_ * (double)local_78._0_8_ - (double)local_68._8_8_ * (double)local_88._0_8_;
            dVar40 = (double)local_88._0_8_ * (double)local_68._0_8_ - stack0xffffffffffffff80 * (double)local_78._8_8_;
            dVar30 = SQRT(dVar40 * dVar40 + auVar39._0_8_ * auVar39._0_8_ + 0.0 + auVar39._8_8_ * auVar39._8_8_);
            ...
            *pauVar19 = auVar36;
            ...
            dVar40 = (double)uVar7 * (double)uVar9 + 0.0 + dVar34 * (double)uVar10 + (double)uVar11 * (double)uVar8;
            dVar34 = 0.0;
            if (( dVar32 < dVar40 ) && ( dVar34 = dVar40 < _LC5 )) {
               dVar34 = acos((double)( (ulong)dVar40 ^ _LC8 ));
            }
 ...
 while ( uVar29 / 3 != uVar28 );
   ...
   dVar30 = _LC6;
   uVar28 = _LC14;
   joined_r0x001055a9:for (; uVar29 = _LC14,dVar6 = _LC6,pauVar17 != pauVar19; pauVar17 = (undefined1(*) [16])( pauVar17[1] + 8 )) {
...
/* manifold::Manifold::Impl::IncrementMeshIDs() */void manifold::Manifold::Impl::IncrementMeshIDs(Impl *this) {
   _Rb_tree_node_base *p_Var1;
   ulong *puVar2;
   int *piVar3;
   void *pvVar4;
   ...
   if (lVar12 == 0) {
      ...
      if ((double)( (ulong)dVar20 & _LC14 ) < _LC34) {
         dVar20 = (double)( ( ulong )((double)(long)dVar20 + (double)( -(ulong)((double)(long)dVar20 < dVar20) & _LC5 )) | ~_LC14 & (ulong)dVar20 );
      }
      ...
      if ((double)( (ulong)dVar21 & _LC14 ) < _LC34) {
         dVar21 = (double)( ( ulong )((double)(long)dVar21 + (double)( -(ulong)((double)(long)dVar21 < dVar21) & _LC5 )) | ~_LC14 & (ulong)dVar21 );
      }
...
;
         ...
         while (pvVar4 != (void*)0x0) {
            std::_Rb_tree<int,std::pair<int_const,manifold::Manifold::Impl::Relation>,std::_Select1st<std::pair<int_const,manifold::Manifold::Impl::Relation>>,std::less<int>,std::allocator<std::pair<int_const,manifold::Manifold::Impl::Relation>>>::_M_erase(*(_Rb_tree_node**)( (long)pvVar4 + 0x18 ));
...
;
      ...
      if (*(_Rb_tree_node_base**)( this + 0xf0 ) == (_Rb_tree_node_base*)0x0) {
         LAB_0010637f:p_Var9 = (_Rb_tree_node_base*)operator_new(0x98);
         ...
         *(undefined2*)( p_Var9 + 0x76 ) = 0x3ff0;
         auVar22 = std::_Rb_tree<int,std::pair<int_const,manifold::Manifold::Impl::Relation>,std::_Select1st<std::pair<int_const,manifold::Manifold::Impl::Relation>>,std::less<int>,std::allocator<std::pair<int_const,manifold::Manifold::Impl::Relation>>>::_M_get_insert_hint_unique_pos((_Rb_tree<int,std::pair<int_const,manifold::Manifold::Impl::Relation>,std::_Select1st<std::pair<int_const,manifold::Manifold::Impl::Relation>>,std::less<int>,std::allocator<std::pair<int_const,manifold::Manifold::Impl::Relation>>>*)( this + 0xe0 ), p_Var18, iVar14);
         ...
         do {
            while (true) {
               ...
               p_Var18 = p_Var9;
               if (*(_Rb_tree_node_base**)( p_Var9 + 0x10 ) == (_Rb_tree_node_base*)0x0) goto LAB_00106370;
            }
;
            p_Var16 = *(_Rb_tree_node_base**)( p_Var9 + 0x18 );
         }
 while ( *(_Rb_tree_node_base**)( p_Var9 + 0x18 ) != (_Rb_tree_node_base*)0x0 );
         LAB_00106370:if (( p_Var1 == p_Var18 ) || ( iVar14 < *(int*)( p_Var18 + 0x20 ) )) goto LAB_0010637f;
      }
...
/* manifold::Manifold::Impl::EdgeCollisions(manifold::Manifold::Impl const&, bool) const */Impl *manifold::Manifold::Impl::EdgeCollisions(Impl *param_1, bool param_2) {
   uint *puVar1;
   double dVar2;
   double dVar3;
   uint uVar4;
   ...
   if (local_180 == 0) {
      ...
      do {
         ...
         if (dVar31 < dVar27) {
            dVar32 = dVar31;
            if (dVar2 < dVar26) {
               if (dVar29 < dVar3) goto LAB_00107512;
            }
 else {
               dVar30 = dVar29;
               dVar33 = dVar26;
            ...
            LAB_0010742a:if (dVar2 < dVar26) {
               LAB_001074e4:dVar2 = dVar26;
            }
      ...
      if (local_180 != 0) {
         do {
            ...
            LAB_00106ec8:while (true) {
               ...
               dVar27 = pdVar17[4];
               if (( ( ( dVar27 < pdVar8[1] ) || ( dVar2 = pdVar17[5] ),dVar2 < pdVar8[2] ) ) || ( pdVar8[3] < *pdVar17 )) {
                  if (*pdVar19 <= dVar31) goto LAB_00106f12;
                  goto LAB_00106f70;
               }
               ...
               if (( uVar4 & 1 ) == 0) {
                  ...
                  if ((ulong)local_160._8_8_ <= uVar21) {
                     if (local_160._8_8_ == 0) {
                        ...
                        if (uVar20 <= (ulong)local_160._8_8_) goto LAB_0010712e;
                     }

                     piVar15 = (int*)malloc(uVar20);
                     if (uVar7 == 0) {
                        LAB_001071d4:if (piVar18 != (int*)0x0) goto LAB_001072f1;
                     }
 else {
                        if ((long)uVar7 < 2) {
                           if (uVar7 != 1) goto LAB_001071d4;
                  ...
                  LAB_0010712e:local_160._0_8_ = uVar21;
                  *(ulong*)( (long)piVar18 + ( ( uVar21 & 0xfffffffffffffff8 ) - 8 ) ) = (long)( (int)uVar4 / 2 ) | uVar14;
               }

               bVar25 = (int)uVar4 % 2 == 1;
               if (( ( dVar31 < *pdVar19 ) || ( dVar27 < pdVar19[1] ) ) || ( ( dVar2 < pdVar19[2] || ( pdVar19[3] < *pdVar17 ) ) )) {
                  LAB_00106f60:uVar11 = uVar4;
                  if (!bVar25) goto LAB_00106f70;
               }
 else {
                  LAB_00106f3a:if (( pdVar19[4] < pdVar17[1] ) || ( pdVar19[5] < pdVar17[2] )) goto LAB_00106f60;
                  if (( uVar16 & 1 ) == 0) {
                     uVar7 = local_160._0_8_;
                     iVar23 = (int)uVar16;
                     uVar20 = uVar16 >> 0x1f;
                     ...
                     if ((ulong)local_160._8_8_ <= uVar21) {
                        if (local_160._8_8_ == 0) {
                           ...
                           if (__size <= (ulong)local_160._8_8_) goto LAB_001070ce;
                        }

                        piVar15 = (int*)malloc(__size);
                        if (uVar7 == 0) {
                           LAB_0010726d:if (piVar18 != (int*)0x0) goto LAB_00107396;
                        }
 else {
                           if ((long)uVar7 < 2) {
                              if (uVar7 != 1) goto LAB_0010726d;
                              *(char*)piVar15 = (char)*piVar18;
                           }
 else {
                              memmove(piVar15, piVar18, uVar7);
                     ...
                     LAB_001070ce:local_160._0_8_ = uVar21;
                     *(ulong*)( (long)piVar18 + ( ( uVar21 & 0xfffffffffffffff8 ) - 8 ) ) = (long)( (int)( ( (uint)uVar20 & 1 ) + iVar23 ) >> 1 ) | uVar14;
                  }

                  uVar11 = (uint)uVar16;
                  uVar6 = ( uint )(uVar16 >> 0x1f) & 1;
                  if (( uVar11 + uVar6 & 1 ) - uVar6 != 1) goto LAB_00106f60;
                  if (bVar25) {
                     iVar24 = iVar24 + 1;
...
;
            if (*pdVar19 <= dVar31) {
               dVar27 = pdVar17[4];
               LAB_00106f12:if (( ( pdVar19[1] <= dVar27 ) && ( pdVar19[2] <= pdVar17[5] ) ) && ( *pdVar17 <= pdVar19[3] )) {
                  bVar25 = false;
                  goto LAB_00106f3a;
               }
      ...
      do {
         ...
         LAB_00106830:do {
            ...
            if (dVar31 < *pdVar8) {
               if (*pdVar19 <= dVar31) {
                  dVar27 = pdVar17[4];
                  LAB_0010687a:if (( ( pdVar19[1] <= dVar27 ) && ( pdVar19[2] <= pdVar17[5] ) ) && ( *pdVar17 <= pdVar19[3] )) {
                     bVar25 = false;
                     goto LAB_0010689f;
                  }
            ...
            if (( ( dVar27 < pdVar8[1] ) || ( dVar2 = pdVar17[5] ),dVar2 < pdVar8[2] )) {
               if (*pdVar19 <= dVar31) goto LAB_0010687a;
               break;
            }
            ...
            if (( uVar4 & 1 ) == 0) {
               ...
               if ((ulong)local_160._8_8_ <= uVar16) {
                  if (local_160._8_8_ == 0) {
                     ...
                     if (uVar21 <= (ulong)local_160._8_8_) goto LAB_00106bb6;
                  }

                  piVar15 = (int*)malloc(uVar21);
                  if (uVar7 == 0) {
                     LAB_00106d04:if (piVar18 != (int*)0x0) goto LAB_00106e07;
                  }
 else {
                     if ((long)uVar7 < 2) {
                        if (uVar7 != 1) goto LAB_00106d04;
                        *(char*)piVar15 = (char)*piVar18;
                     }
 else {
                        memmove(piVar15, piVar18, uVar7);
               ...
               LAB_00106bb6:local_160._0_8_ = uVar16;
               *(ulong*)( (long)piVar18 + ( ( uVar16 & 0xfffffffffffffff8 ) - 8 ) ) = ( ulong )(uint)((int)uVar4 / 2) << 0x20 | (long)iVar24;
            }

            bVar25 = (int)uVar4 % 2 == 1;
            if (( ( ( *pdVar19 <= dVar31 ) && ( pdVar19[1] <= dVar27 ) ) && ( pdVar19[2] <= dVar2 ) ) && ( *pdVar17 <= pdVar19[3] )) {
               LAB_0010689f:if (( pdVar17[1] <= pdVar19[4] ) && ( pdVar17[2] <= pdVar19[5] )) {
                  if (( uVar14 & 1 ) == 0) {
                     uVar7 = local_160._0_8_;
                     iVar12 = (int)uVar14;
                     uVar21 = uVar14 >> 0x1f;
                     ...
                     if ((ulong)local_160._8_8_ <= uVar16) {
                        if (local_160._8_8_ == 0) {
                           ...
                           if (uVar20 <= (ulong)local_160._8_8_) goto LAB_00106b4e;
                        }

                        piVar15 = (int*)malloc(uVar20);
                        if (uVar7 == 0) {
                           LAB_00106c4d:if (piVar18 != (int*)0x0) goto LAB_00106d6d;
                        }
 else {
                           if ((long)uVar7 < 2) {
                              if (uVar7 != 1) goto LAB_00106c4d;
                              *(char*)piVar15 = (char)*piVar18;
                           }
 else {
                              memmove(piVar15, piVar18, uVar7);
                     ...
                     LAB_00106b4e:local_160._0_8_ = uVar16;
                     *(ulong*)( (long)piVar18 + ( ( uVar16 & 0xfffffffffffffff8 ) - 8 ) ) = ( ulong )(uint)((int)( ( (uint)uVar21 & 1 ) + iVar12 ) >> 1) << 0x20 | (long)iVar24;
                  }

                  uVar11 = (uint)uVar14;
                  uVar6 = ( uint )(uVar14 >> 0x1f) & 1;
                  if (( uVar11 + uVar6 & 1 ) - uVar6 != 1) goto LAB_001068c0;
                  if (bVar25) {
                     iVar23 = iVar23 + 1;
...
/* manifold::Manifold::Impl::VertexCollisionsZ(manifold::VecView<linalg::vec<double, 3> const>,
   bool) const */undefined8 *manifold::Manifold::Impl::VertexCollisionsZ(undefined8 *param_1, long param_2, long *param_3, char param_4) {
   double *pdVar1;
   uint *puVar2;
   uint uVar3;
   uint uVar4;
         ...
         do {
            ...
            LAB_00107908:do {
               while (true) {
                  ...
                  if (( ( ( dVar25 <= pdVar13[3] ) && ( *pdVar13 <= dVar25 ) ) && ( dVar26 <= pdVar13[4] ) ) && ( pdVar13[1] <= dVar26 )) break;
                  if (( ( pdVar19[3] < dVar25 ) || ( dVar25 < *pdVar19 ) ) || ( ( pdVar19[4] < dVar26 || ( dVar26 < pdVar19[1] ) ) )) goto LAB_001079bb;
                  bVar24 = false;
                  LAB_001079f1:if (( uVar16 & 1 ) == 0) {
                     iVar22 = (int)uVar16;
                     sVar9 = param_1[1];
                     uVar12 = uVar16 >> 0x1f;
                     uVar17 = sVar9 + 8;
                     uVar10 = param_1[2];
                     if (uVar17 < uVar10) {
                        LAB_00107a92:puVar15 = (undefined1*)*param_1;
                     }
 else {
                        if (uVar10 == 0) {
                           local_198 = 0x80;
                           ...
                           if (local_198 <= uVar10) goto LAB_00107a92;
                        }

                        puVar15 = (undefined1*)malloc(local_198);
                        puVar11 = (undefined1*)*param_1;
                        if (sVar9 == 0) {
                           LAB_00107ccc:if (puVar11 != (undefined1*)0x0) goto LAB_00107f10;
                        }
 else {
                           if ((long)sVar9 < 2) {
                              if (sVar9 != 1) goto LAB_00107ccc;
                              *puVar15 = *puVar11;
                           }
 else {
                     ...
                     param_1[1] = uVar17;
                     *(long*)( puVar15 + ( ( uVar17 & 0xfffffffffffffff8 ) - 8 ) ) = lVar21 << 0x20 | (long)( (int)( ( (uint)uVar12 & 1 ) + iVar22 ) >> 1 );
                  }

                  uVar3 = ( uint )(uVar16 >> 0x1f) & 1;
                  if (( (uint)uVar16 + uVar3 & 1 ) - uVar3 != 1) goto LAB_001079a0;
                  if (bVar24) {
                     iVar23 = iVar23 + 1;
...
;
               if (( uVar3 & 1 ) == 0) {
                  ...
                  uVar10 = param_1[2];
                  if (uVar17 < uVar10) {
                     LAB_00107b00:local_1b8 = (undefined1*)*param_1;
                  }
 else {
                     if (uVar10 == 0) {
                        local_198 = 0x80;
                        ...
                        if (local_198 <= uVar10) goto LAB_00107b00;
                     }

                     local_1b8 = (undefined1*)malloc(local_198);
                     puVar15 = (undefined1*)*param_1;
                     if (sVar9 == 0) {
                        LAB_00107d6b:if (puVar15 != (undefined1*)0x0) goto LAB_00107dd3;
                     }
 else {
                        if ((long)sVar9 < 2) {
                           if (sVar9 != 1) goto LAB_00107d6b;
                           *local_1b8 = *puVar15;
                        }
 else {
                  ...
                  param_1[1] = uVar17;
                  *(long*)( local_1b8 + ( ( uVar17 & 0xfffffffffffffff8 ) - 8 ) ) = lVar21 << 0x20 | (long)( (int)uVar3 / 2 );
               }

               bVar24 = (int)uVar3 % 2 == 1;
               if (( ( dVar25 <= pdVar19[3] ) && ( *pdVar19 <= dVar25 ) ) && ( ( dVar26 <= pdVar19[4] && ( pdVar19[1] <= dVar26 ) ) )) goto LAB_001079f1;
               LAB_001079a0:;
            }
 while ( bVar24 );
            LAB_001079bb:if (-1 < iVar23) {
               lVar14 = (long)iVar23;
               iVar23 = iVar23 + -1;
         ...
         do {
            ...
            LAB_00107660:do {
               while (true) {
                  ...
                  pdVar13 = (double*)( (long)(int)uVar3 * 0x30 + lVar6 );
                  if (( ( ( dVar25 <= pdVar13[3] ) && ( *pdVar13 <= dVar25 ) ) && ( dVar26 <= pdVar13[4] ) ) && ( pdVar13[1] <= dVar26 )) break;
                  if (( ( pdVar19[3] < dVar25 ) || ( dVar25 < *pdVar19 ) ) || ( ( pdVar19[4] < dVar26 || ( dVar26 < pdVar19[1] ) ) )) goto LAB_00107763;
                  bVar24 = false;
                  LAB_0010779d:if (( uVar16 & 1 ) == 0) {
                     iVar20 = (int)uVar16;
                     sVar9 = param_1[1];
                     uVar12 = uVar16 >> 0x1f;
                     uVar17 = sVar9 + 8;
                     uVar10 = param_1[2];
                     if (uVar17 < uVar10) {
                        LAB_0010782a:puVar15 = (undefined1*)*param_1;
                     }
 else {
                        if (uVar10 == 0) {
                           local_1a0 = 0x80;
                           ...
                           if (local_1a0 <= uVar10) goto LAB_0010782a;
                        }

                        puVar15 = (undefined1*)malloc(local_1a0);
                        puVar11 = (undefined1*)*param_1;
                        if (sVar9 == 0) {
                           LAB_00107c42:if (puVar11 != (undefined1*)0x0) goto LAB_00107fa3;
                        }
 else {
                           if ((long)sVar9 < 2) {
                              if (sVar9 != 1) goto LAB_00107c42;
                              *puVar15 = *puVar11;
                           }
 else {
                              memmove(puVar15, puVar11, sVar9);
                     ...
                     param_1[1] = uVar17;
                     *(ulong*)( puVar15 + ( ( uVar17 & 0xfffffffffffffff8 ) - 8 ) ) = ( ulong )(uint)((int)( ( (uint)uVar12 & 1 ) + iVar20 ) >> 1) << 0x20 | (long)iVar23;
                  }

                  uVar3 = ( uint )(uVar16 >> 0x1f) & 1;
                  if (( (uint)uVar16 + uVar3 & 1 ) - uVar3 != 1) goto LAB_00107708;
                  if (bVar24) {
                     iVar22 = iVar22 + 1;
...
;
               if (( uVar3 & 1 ) == 0) {
                  ...
                  uVar10 = param_1[2];
                  if (uVar17 < uVar10) {
                     LAB_00107890:local_1b8 = (undefined1*)*param_1;
                  }
 else {
                     if (uVar10 == 0) {
                        local_1a0 = 0x80;
                        ...
                        if (local_1a0 <= uVar10) goto LAB_00107890;
                     }

                     local_1b8 = (undefined1*)malloc(local_1a0);
                     puVar15 = (undefined1*)*param_1;
                     if (sVar9 == 0) {
                        LAB_00107bb4:if (puVar15 != (undefined1*)0x0) goto LAB_00107e72;
                     }
 else {
                        if ((long)sVar9 < 2) {
                           if (sVar9 != 1) goto LAB_00107bb4;
                           *local_1b8 = *puVar15;
                        }
 else {
                           memmove(local_1b8, puVar15, sVar9);
                  ...
                  param_1[1] = uVar17;
                  *(ulong*)( local_1b8 + ( ( uVar17 & 0xfffffffffffffff8 ) - 8 ) ) = ( ulong )(uint)((int)uVar3 / 2) << 0x20 | (long)iVar23;
               }

               bVar24 = (int)uVar3 % 2 == 1;
               if (( ( dVar25 <= pdVar19[3] ) && ( *pdVar19 <= dVar25 ) ) && ( ( dVar26 <= pdVar19[4] && ( pdVar19[1] <= dVar26 ) ) )) goto LAB_0010779d;
               LAB_00107708:;
            }
 while ( bVar24 );
            LAB_00107763:if (-1 < iVar22) {
               lVar14 = (long)iVar22;
               iVar22 = iVar22 + -1;
               uVar18 = (ulong)auStack_148[lVar14];
               goto LAB_00107660;
...
/* (anonymous namespace)::GetLabels(std::vector<int, std::allocator<int> >&,
   manifold::Vec<std::pair<int, int> > const&, int) [clone .constprop.0] */undefined4(anonymous_namespace) {
   int *piVar1;
   size_t __size;
   char cVar2;
   int iVar3;
   ...
   if (__nmemb == 0) {
      ...
      if (( __size & 4 ) != 0) {
         *__ptr = 0;
         lVar10 = 1;
         if ((long)__size >> 2 == 1) goto LAB_001080ec;
      }

      do {
         __ptr[lVar10] = (int)lVar10;
         lVar9 = lVar10 + 1;
         lVar10 = lVar10 + 2;
         __ptr[lVar9] = (int)lVar9;
      }
 while ( (long)__size >> 2 != lVar10 );
   }

   LAB_001080ec:piVar8 = *(int**)param_2;
 ...
 while ( iVar4 != iVar6 );
   ...
   uVar5 = manifold::UnionFind<int,unsigned_char>::connectedComponents((UnionFind<int,unsigned_char>*)&local_68, param_1);
...
/* manifold::Manifold::Impl::CreateFaces() */void manifold::Manifold::Impl::CreateFaces(Impl *this) {
   int *piVar1;
   double *pdVar2;
   double *pdVar3;
   ...
   if (local_130 == 0) {
      ...
      if (uVar25 == 0) {
         ...
         __ptr = (void*)0x0;
         LAB_0010898e:local_68 = (undefined1[16])0x0;
         uVar13 = *(ulong*)( this + 0xd0 );
         local_58 = 0.0;
         auVar7._8_8_ = 0;
         auVar7._0_8_ = uVar25;
         auVar8._8_8_ = 0;
         auVar8._0_8_ = uVar13;
         iVar12 = (anonymous_namespace)::GetLabels((vector*)local_68, (Vec*)&local_c8, SUB164(auVar8 / auVar7, 0));
         uVar28 = (ulong)iVar12;
         if (uVar28 >> 0x3d != 0) {
            /* WARNING: Subroutine does not return */
            std::__throw_length_error("cannot create std::vector larger than max_size()");
         ...
         if (uVar28 != 0) {
            uVar29 = uVar28 * 4;
            puVar17 = (undefined4*)operator_new(uVar29);
            *puVar17 = 0;
            if (uVar28 == 1) {
               uVar29 = 4;
            }
 else if (puVar17 + 1 != puVar17 + uVar28) {
               memset(puVar17 + 1, 0, uVar29 - 4);
            }
         ...
         if (uVar25 <= uVar13) {
            do {
               puVar17[*(int*)( local_68._0_8_ + uVar28 * 4 )] = (int)uVar28;
               uVar28 = uVar28 + 1;
            }
 while ( uVar28 < SUB168(auVar8 / auVar7, 0) );
         }

         uVar11 = _LC9;
         piVar21 = *(int**)( this + 0x128 );
         piVar1 = piVar21 + *(long*)( this + 0x130 ) * 3;
         if (piVar21 != piVar1) {
            do {
               local_50 = uVar11;
               local_48 = 2;
               ...
               do {
                  if (*piVar18 == 0) {
                     iVar12 = puVar17[*(int*)( local_68._0_8_ + (long)*piVar21 * 4 )];
                     piVar22 = piVar21;
                  }
 else if (*piVar18 == 1) {
                     iVar12 = puVar17[*(int*)( local_68._0_8_ + (long)piVar21[1] * 4 )];
                     piVar22 = piVar21 + 1;
                  }
 else {
                     iVar12 = puVar17[*(int*)( local_68._0_8_ + (long)piVar21[2] * 4 )];
                     piVar22 = piVar21 + 2;
                  }
 ...
 while ( piVar1 != piVar21 );
         ...
         if (puVar17 != (undefined4*)0x0) {
            operator_delete(puVar17, uVar29);
         }

         if ((void*)uVar10 != (void*)0x0) {
            operator_delete((void*)uVar10, (long)local_58 - uVar10);
         }

         local_108 = local_e8;
         local_fc = *(int*)( this + 0xc4 );
         lVar27 = *(long*)( this + 0x60 );
         local_120 = *(long*)( this + 0x48 );
         lVar32 = *(long*)( this + 0x110 );
         dVar47 = *(double*)( this + 0x30 );
         dVar34 = *(double*)( this + 0x38 );
         local_130 = *(ulong*)( this + 0x68 );
         local_118 = *(long*)( this + 0x128 );
         iVar12 = (int)( local_130 / 3 );
         if (local_130 != 0) goto LAB_00108b65;
         iVar12 = 0;
      }

   }
 else {
      local_108 = (undefined8*)malloc(local_130 * 8);
      uVar10 = _LC38;
      puVar5 = local_108 + local_130;
      if (puVar5 != local_108) {
         puVar14 = local_108;
         if (( (int)puVar5 - (int)local_108 & 8U ) != 0) {
            *local_108 = _LC38;
            puVar14 = local_108 + 1;
            if (puVar5 == puVar14) goto LAB_00108790;
         }
 ...
 while ( puVar5 != puVar15 );
      ...
      LAB_00108790:local_e0._8_8_ = local_130;
      local_e0._0_8_ = local_130;
      local_e8 = local_108;
      puVar14 = (undefined8*)malloc(local_130 * 8);
      uVar10 = _LC38;
      puVar5 = puVar14 + local_130;
      if (puVar5 != puVar14) {
         puVar15 = puVar14;
         if (( (int)puVar5 - (int)puVar14 & 8U ) != 0) {
            *puVar14 = _LC38;
            puVar15 = puVar14 + 1;
            if (puVar5 == puVar14 + 1) goto LAB_001087f0;
         }
 ...
 while ( puVar5 != puVar16 );
      ...
      LAB_001087f0:local_c0._8_8_ = local_130;
      local_c0._0_8_ = local_130;
      local_c8 = puVar14;
      if (local_130 < 3) {
         uVar25 = ( ulong ) * (int*)( this + 0xc4 );
         if (uVar25 != 0) {
            __ptr = (void*)0x0;
            goto LAB_00108841;
         }
         ...
         uVar25 = ( ulong ) * (int*)( this + 0xc4 );
         if (uVar25 != 0) {
            LAB_00108841:uVar13 = 0;
            lVar27 = *(long*)( this + 0x60 );
            lVar32 = *(long*)( this + 0x110 );
            do {
               while (true) {
                  iVar24 = (int)uVar13;
                  iVar12 = *(int*)( lVar27 + (long)iVar24 * 0xc + 8 );
                  lVar20 = (long)( iVar12 / 3 );
                  if (*(int*)( lVar32 + (long)( iVar24 / 3 ) * 0x10 ) == *(int*)( lVar32 + lVar20 * 0x10 )) break;
                  LAB_0010897c:uVar13 = uVar13 + 1;
                  if (local_130 == uVar13) goto LAB_0010898e;
               }
;
               iVar12 = iVar12 % 3;
               piVar1 = (int*)( *(long*)( this + 0x128 ) + (long)( iVar24 / 3 ) * 0xc );
               if (iVar24 % 3 == 0) {
                  iVar23 = *piVar1;
               }
 else if (iVar24 % 3 == 1) {
               ...
               piVar1 = (int*)( *(long*)( this + 0x128 ) + lVar20 * 0xc );
               if (( iVar12 == 2 ) || ( iVar12 == -1 )) {
                  iVar12 = *piVar1;
               }
 else if (iVar12 == 0) {
                  iVar12 = piVar1[1];
               ...
               if (iVar23 == iVar12) goto LAB_0010897c;
               uVar28 = 0;
               do {
                  if (*(double*)( (long)iVar23 * uVar25 * 8 + *(long*)( this + 200 ) + uVar28 * 8 ) != *(double*)( *(long*)( this + 200 ) + (long)iVar12 * uVar25 * 8 + uVar28 * 8 )) goto LAB_0010897c;
                  uVar28 = uVar28 + 1;
               }
 while ( uVar25 != uVar28 );
               uVar13 = uVar13 + 1;
               *(int*)( puVar14 + iVar24 ) = iVar23;
               *(int*)( (long)( puVar14 + iVar24 ) + 4 ) = iVar12;
            }
 while ( local_130 != uVar13 );
            goto LAB_0010898e;
         }
      ...
      local_118 = *(long*)( this + 0x128 );
      dVar34 = *(double*)( this + 0x38 );
      LAB_00108b65:uVar25 = 0;
      do {
         iVar26 = (int)uVar25;
         pauVar6 = (undefined1(*) [12])( lVar27 + (long)iVar26 * 0xc );
         iVar24 = *(int*)( *pauVar6 + 8 );
         pdVar2 = (double*)( lVar27 + (long)iVar24 * 0xc );
         local_88 = *pdVar2;
         dStack_80 = (double)CONCAT44(dStack_80._4_4_, *(undefined4*)( pdVar2 + 1 ));
         iVar9 = iVar24 / 3;
         iVar23 = iVar26 / 3;
         lVar20 = (long)iVar23;
         if (*(int*)( lVar32 + lVar20 * 0x10 ) != *(int*)( lVar32 + (long)iVar9 * 0x10 )) goto LAB_00108e98;
         local_a8._0_4_ = SUB124(*pauVar6, 0);
         pauVar4 = (undefined1(*) [16])( local_120 + (long)(int)local_a8._0_4_ * 0x18 );
         dVar35 = *(double*)*pauVar4;
         dVar37 = *(double*)( *pauVar4 + 8 );
         local_68 = *pauVar4;
         local_58 = *(double*)pauVar4[1];
         iVar24 = iVar24 % 3;
         iVar30 = iVar26 % 3;
         if (local_fc < 1) {
            LAB_00108bd5:local_a8._4_4_ = ( undefined4 )(( ulong ) * (undefined8*)*pauVar6 >> 0x20);
            if ((int)local_a8._0_4_ < (int)local_a8._4_4_) {
               ...
               pdVar2 = (double*)( local_120 + (long)local_88._0_4_ * 0x18 );
               dVar42 = *pdVar2 - dVar35;
               dVar43 = pdVar2[2] - local_58;
               dVar38 = pdVar2[1] - dVar37;
               pdVar2 = (double*)( local_120 + (long)*(int*)( lVar27 + (long)( iVar33 + iVar23 * 3 ) * 0xc ) * 0x18 );
               pdVar3 = (double*)( local_120 + (long)*(int*)( lVar27 + (long)( iVar30 + iVar9 * 3 ) * 0xc ) * 0x18 );
               dVar40 = *pdVar2 - dVar35;
               dVar41 = pdVar2[1] - dVar37;
               dVar35 = *pdVar3 - dVar35;
               dVar48 = pdVar2[2] - local_58;
               dVar37 = pdVar3[1] - dVar37;
               dVar44 = pdVar3[2] - local_58;
               dVar39 = SQRT(dVar40 * dVar40 + 0.0 + dVar41 * dVar41 + dVar48 * dVar48);
               dVar36 = SQRT(dVar42 * dVar42 + 0.0 + dVar38 * dVar38 + dVar43 * dVar43);
               if (dVar39 <= dVar36) {
                  dVar39 = dVar36;
               }

               dVar45 = SQRT(dVar35 * dVar35 + 0.0 + dVar37 * dVar37 + dVar44 * dVar44);
               if (dVar45 <= dVar36) {
                  dVar45 = dVar36;
               }

               dVar46 = dVar38 * dVar48 - dVar43 * dVar41;
               dVar48 = dVar43 * dVar40 - dVar48 * dVar42;
               dVar40 = dVar41 * dVar42 - dVar40 * dVar38;
               dVar36 = SQRT(dVar46 * dVar46 + 0.0 + dVar48 * dVar48 + dVar40 * dVar40);
               if (iVar26 * -0x55555555 + 0x2aaaaaaaU < 0x55555555) {
                  *(double*)( (long)__ptr + lVar20 * 8 ) = dVar36;
               }

               if (( dVar39 * dVar47 <= dVar36 ) && ( dVar39 = dVar43 * dVar37 - dVar38 * dVar44 ),dVar41 = dVar42 * dVar44 - dVar43 * dVar35,dVar38 = dVar38 * dVar35 - dVar42 * dVar37,dVar39 = SQRT(dVar38 * dVar38 + dVar41 * dVar41 + dVar39 * dVar39 + 0.0),dVar45 * dVar47 <= dVar39) {
                  if (dVar39 <= dVar36) {
                     dVar39 = dVar36;
                  }

                  if ((double)( ( ulong )(dVar35 * dVar46 + 0.0 + dVar37 * dVar48 + dVar44 * dVar40) & _LC14 ) <= dVar39 * dVar34) {
                     *(int*)( local_108 + iVar26 ) = iVar23;
                     *(int*)( (long)( local_108 + iVar26 ) + 4 ) = iVar9;
                  }
            ...
            piVar1 = (int*)( local_118 + lVar20 * 0xc );
            if (iVar30 == 0) {
               local_100 = *piVar1;
            }
 else if (iVar30 == 1) {
            ...
            piVar21 = (int*)( local_118 + (long)iVar9 * 0xc );
            if (iVar24 == 0) {
               if (piVar21[1] != local_100) goto LAB_00108e98;
               if (iVar30 != 0) goto LAB_001090c8;
               iVar33 = piVar1[1];
               LAB_001090dd:iVar31 = *piVar21;
               LAB_00108bcc:if (iVar31 == iVar33) goto LAB_00108bd5;
            }
 else if (iVar24 == 1) {
               if (local_100 == piVar21[2]) {
                  if (iVar30 != 0) goto LAB_001090c8;
                  iVar33 = piVar1[1];
                  goto LAB_00109113;
               }
 ...
 else if (*piVar21 == local_100) {
               if (iVar30 == 0) {
                  iVar33 = piVar1[1];
               }
 else {
                  LAB_001090c8:if (iVar30 == 1) {
                     iVar33 = piVar1[2];
                  }
 else {
                     iVar33 = *piVar1;
               ...
               LAB_00109113:iVar31 = piVar21[1];
               goto LAB_00108bcc;
            }

         }

         LAB_00108e98:uVar25 = uVar25 + 1;
      }
 while ( uVar25 != local_130 );
   }

   local_98 = 0;
   local_a8 = (undefined1[16])0x0;
   iVar12 = (anonymous_namespace)::GetLabels((vector*)local_a8, (Vec*)&local_e8, iVar12);
   if ((long)iVar12 != 0) {
      __size = (long)iVar12 * 4;
      pvVar19 = malloc(__size);
      __ptr_00 = memset(pvVar19, 0xff, __size);
      uVar25 = *(ulong*)( this + 0x68 );
      pvVar19 = (void*)local_a8._0_8_;
      if (2 < uVar25) goto LAB_001083ab;
      goto LAB_00108673;
   }
   ...
   pvVar19 = (void*)local_a8._0_8_;
   if (uVar25 < 3) {
      LAB_00108678:if (pvVar19 != (void*)0x0) {
         LAB_0010867d:operator_delete(pvVar19, local_98 - (long)pvVar19);
      }

      if (__ptr == (void*)0x0) goto LAB_00108695;
   }
 else {
      LAB_001083ab:uVar25 = uVar25 / 3;
      uVar13 = 0;
      do {
         lVar27 = (long)*(int*)( local_a8._0_8_ + uVar13 * 4 );
         dVar47 = *(double*)( (long)__ptr + uVar13 * 8 );
         piVar1 = (int*)( (long)__ptr_00 + lVar27 * 4 );
         iVar12 = *piVar1;
         if (( iVar12 < 0 ) || ( pdVar2 = (double*)( (long)__ptr + (long)iVar12 * 8 ) * pdVar2 <= dVar47 && dVar47 != *pdVar2 )) {
            *piVar1 = (int)uVar13;
            *(double*)( (long)__ptr + lVar27 * 8 ) = dVar47;
         }
 ...
 while ( uVar13 < uVar25 );
      ...
      dVar47 = *(double*)( this + 0x38 );
      uVar13 = 0;
      pvVar19 = (void*)local_a8._0_8_;
      LAB_00108418:do {
         iVar24 = (int)uVar13;
         piVar1 = (int*)( (long)__ptr_00 + (long)*(int*)( (long)pvVar19 + (long)iVar24 * 4 ) * 4 );
         iVar12 = *piVar1;
         if (( -1 < iVar12 ) && ( iVar12 != iVar24 )) {
            local_50 = uVar10;
            local_48 = 2;
            lVar20 = (long)( iVar12 * 3 + 2 );
            pdVar2 = (double*)( lVar32 + (long)*(int*)( lVar27 + (long)( iVar12 * 3 ) * 0xc ) * 0x18 );
            local_88 = *pdVar2;
            dStack_80 = pdVar2[1];
            local_78 = pdVar2[2];
            pdVar2 = (double*)( lVar32 + (long)*(int*)( lVar27 + lVar20 * 0xc ) * 0x18 );
            pdVar3 = (double*)( lVar32 + (long)*(int*)( lVar27 + -0xc + lVar20 * 0xc ) * 0x18 );
            piVar21 = (int*)&local_50;
            dVar39 = ( pdVar2[2] - local_78 ) * ( pdVar3[1] - dStack_80 ) - ( pdVar2[1] - dStack_80 ) * ( pdVar3[2] - local_78 );
            dVar37 = ( pdVar3[2] - local_78 ) * ( *pdVar2 - local_88 ) - ( pdVar2[2] - local_78 ) * ( *pdVar3 - local_88 );
            dVar35 = ( pdVar2[1] - dStack_80 ) * ( *pdVar3 - local_88 ) - ( *pdVar2 - local_88 ) * ( pdVar3[1] - dStack_80 );
            dVar34 = SQRT(dVar39 * dVar39 + 0.0 + dVar37 * dVar37 + dVar35 * dVar35);
            do {
               pauVar4 = (undefined1(*) [16])( lVar32 + (long)*(int*)( lVar27 + (long)( *piVar21 + iVar24 * 3 ) * 0xc ) * 0x18 );
               local_68 = *pauVar4;
               local_58 = *(double*)pauVar4[1];
               if (dVar47 < (double)( ( ulong )(( *(double*)*pauVar4 - local_88 ) * ( dVar39 / dVar34 ) + 0.0 + ( *(double*)( *pauVar4 + 8 ) - dStack_80 ) * ( dVar37 / dVar34 ) + ( local_58 - local_78 ) * ( dVar35 / dVar34 )) & uVar28 )) {
                  *piVar1 = -1;
                  uVar13 = uVar13 + 1;
                  pvVar19 = (void*)local_a8._0_8_;
                  if (uVar13 == uVar25) goto LAB_0010860d;
                  goto LAB_00108418;
               }

               piVar21 = piVar21 + 1;
            }
 while ( piVar21 != &local_44 );
         }

         uVar13 = uVar13 + 1;
      }
 while ( uVar13 != uVar25 );
      LAB_0010860d:uVar25 = *(ulong*)( this + 0x68 );
      local_108 = local_e8;
      uVar13 = 0;
      if (2 < uVar25) {
         do {
            iVar12 = *(int*)( (long)__ptr_00 + (long)*(int*)( (long)pvVar19 + uVar13 * 4 ) * 4 );
            if (-1 < iVar12) {
               *(int*)( uVar13 * 0x10 + *(long*)( this + 0x110 ) + 0xc ) = iVar12;
            }

            uVar13 = uVar13 + 1;
         }
 while ( uVar13 < uVar25 / 3 );
         if (__ptr_00 != (void*)0x0) goto LAB_00108673;
         goto LAB_0010867d;
      }

      if (__ptr_00 != (void*)0x0) {
         LAB_00108673:free(__ptr_00);
         goto LAB_00108678;
      }

      if (pvVar19 != (void*)0x0) goto LAB_0010867d;
   }

   free(__ptr);
   LAB_00108695:if (local_c8 != (undefined8*)0x0) {
      free(local_c8);
   }
...
/* manifold::Manifold::Impl::WarpBatch(std::function<void (manifold::VecView<linalg::vec<double, 3>
   >)>) */void manifold::Manifold::Impl::WarpBatch(Impl *this, long param_2) {
   long lVar1;
   long lVar2;
   char cVar3;
   undefined8 uVar4;
   ...
   if (*(long*)( param_2 + 0x10 ) == 0) {
      ...
      alStack_60[1] = 0;
      pcStack_50 = std::_Function_handler<void(manifold::VecView<linalg::vec<double,3>>),manifold::Manifold::Impl::Warp(std::function<void(linalg::vec<double,3>&)>)::{lambda(manifold::VecView<linalg::vec<double,3>>)#1}>::_M_manager;
      pcStack_48 = std::_Function_handler<void(manifold::VecView<linalg::vec<double,3>>),manifold::Manifold::Impl::Warp(std::function<void(linalg::vec<double,3>&)>)::{lambda(manifold::VecView<linalg::vec<double,3>>)#1}>::_M_invoke;
...
/* manifold::Manifold::Impl::Warp(std::function<void (linalg::vec<double, 3>&)>) */void manifold::Manifold::Impl::Warp(Impl *this, undefined8 param_2) {
   long in_FS_OFFSET;
   undefined8 local_38;
   undefined8 local_30;
   code *local_28;
   ...
   local_30 = 0;
   local_28 = std::_Function_handler<void(manifold::VecView<linalg::vec<double,3>>),manifold::Manifold::Impl::Warp(std::function<void(linalg::vec<double,3>&)>)::{lambda(manifold::VecView<linalg::vec<double,3>>)#1}>::_M_manager;
   pcStack_20 = std::_Function_handler<void(manifold::VecView<linalg::vec<double,3>>),manifold::Manifold::Impl::Warp(std::function<void(linalg::vec<double,3>&)>)::{lambda(manifold::VecView<linalg::vec<double,3>>)#1}>::_M_invoke;
   local_38 = param_2;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* manifold::Manifold::Impl::Impl(manifold::Manifold::Impl::Shape, linalg::mat<double, 3, 4>) */void manifold::Manifold::Impl::Impl(Impl *this, int param_2) {
   double dVar1;
   double dVar2;
   double dVar3;
   undefined8 uVar4;
   ...
   *(undefined8*)( this + 0x90 ) = 0;
   for (int i = 0; i < 4; i++) {
      *(undefined1(*) [16])( this + ( 24*i + 80 ) ) = (undefined1[16])0;
   }
   ...
   *(undefined1(*) [16])( this + 0x178 ) = (undefined1[16])0x0;
   ...
   if (param_2 == 1) {
      ...
      local_d8 = __LC12;
      uStack_d0 = _UNK_0010cf08;
      local_98 = __LC12;
      uStack_90 = _UNK_0010cf08;
      local_88 = __LC12;
      uStack_80 = _UNK_0010cf08;
      local_68 = __LC12;
      uStack_60 = _UNK_0010cf08;
      local_b8 = _LC5;
      uStack_b0 = _LC5;
      local_a8._8_8_ = 0;
      local_a8._0_8_ = _LC5;
      ...
      local_58 = _LC5;
      uStack_50 = _LC5;
      std::vector<linalg::vec<double,3>,std::allocator<linalg::vec<double,3>>>::_M_assign_aux<linalg::vec<double,3>const*>(local_168, local_108, local_48);
      puVar8 = &local_78;
      local_108._8_8_ = _UNK_0010cf98;
      local_108._0_8_ = __LC45;
      local_f8._8_8_ = _UNK_0010cfa8;
      local_f8._0_8_ = __LC46;
      local_e8._8_8_ = _UNK_0010cfb8;
      local_e8._0_8_ = __LC47;
      local_d8 = __LC48;
      uStack_d0 = _UNK_0010cfc8;
      local_c8._8_8_ = _UNK_0010cfd8;
      local_c8._0_8_ = __LC49;
      local_b8 = __LC50;
      uStack_b0 = _UNK_0010cfe8;
      local_a8._8_8_ = _UNK_0010cff8;
      local_a8._0_8_ = __LC51;
      local_98 = __LC52;
      uStack_90 = _UNK_0010d008;
      local_88 = __LC53;
      uStack_80 = _UNK_0010d018;
      LAB_00109622:std::vector<linalg::vec<int,3>,std::allocator<linalg::vec<int,3>>>::_M_assign_aux<linalg::vec<int,3>const*>(local_148, local_108, puVar8);
      ...
      lStack_118 = lVar10;
      if (lVar10 == 0) goto LAB_001096ae;
      local_120 = lVar10;
      pdVar7 = (double*)malloc(__size_00);
      local_128 = pdVar7;
      if (0x18 < (long)__size_00) {
         pdVar7 = (double*)memmove(pdVar7, pdVar11, __size_00);
         LAB_0010997b:if ((Impl*)&local_128 == this + 0x48) {
            LAB_00109990:free(pdVar7);
            goto LAB_00109998;
         }

         LAB_00109be0:__ptr = *(double**)( this + 0x48 );
         lVar12 = lVar10;
         goto LAB_001096d0;
      }
      ...
      if ((Impl*)&local_128 != this + 0x48) goto LAB_00109be0;
      if (pdVar7 != (double*)0x0) goto LAB_00109990;
      LAB_00109998:lVar10 = *(long*)( this + 0x50 );
      ...
      if (param_2 == 2) {
         ...
         local_f8._8_8_ = _UNK_0010d028;
         local_b8 = _LC55;
         uStack_b0 = 0;
         local_98 = _LC5;
         uStack_90 = 0;
         local_88 = __LC54;
         uStack_80 = _UNK_0010d028;
         std::vector<linalg::vec<double,3>,std::allocator<linalg::vec<double,3>>>::_M_assign_aux<linalg::vec<double,3>const*>(local_168, local_108, &local_78);
         puVar8 = (ulong*)local_a8;
         local_108._8_8_ = _UNK_0010d048;
         local_108._0_8_ = __LC56;
         local_f8._8_8_ = _UNK_0010d058;
         local_f8._0_8_ = __LC57;
         local_e8._8_8_ = _UNK_0010d068;
         local_e8._0_8_ = __LC58;
         local_d8 = __LC59;
         uStack_d0 = _UNK_0010d078;
         local_c8._8_8_ = _UNK_0010d088;
         local_c8._0_8_ = __LC60;
         local_b8 = __LC61;
         uStack_b0 = _UNK_0010d098;
         goto LAB_00109622;
      }
      ...
      if (param_2 == 0) {
         ...
         local_f8._8_8_ = _UNK_0010cf48;
         local_e8._0_8_ = __LC39;
         local_e8._8_8_ = _UNK_0010cf48;
         local_d8 = __LC39;
         ...
         local_b8 = _LC5;
         uStack_b0 = _LC5;
         std::vector<linalg::vec<double,3>,std::allocator<linalg::vec<double,3>>>::_M_assign_aux<linalg::vec<double,3>const*>(local_168, local_108, local_a8);
         puVar8 = &local_d8;
         local_108._8_8_ = _UNK_0010cf68;
         local_108._0_8_ = __LC42;
         local_f8._8_8_ = _UNK_0010cf78;
         local_f8._0_8_ = __LC43;
         local_e8._8_8_ = _UNK_0010cf88;
      ...
      local_178 = 0;
      LAB_001096ae:local_128 = (double*)0x0;
      __ptr = *(double**)( this + 0x48 );
      pdVar11 = (double*)local_168._0_8_;
      puVar9 = (undefined8*)local_148._0_8_;
      if ((Impl*)&local_128 == this + 0x48) {
         ...
         LAB_001096d0:if (__ptr != (double*)0x0) {
            free(__ptr);
         }
   ...
   for (; pdVar7 != __ptr; __ptr = __ptr + 3) {
      ...
      dVar3 = __ptr[1];
      dVar1 = __ptr[2];
      *__ptr = dVar3 * in_stack_00000020 + dVar2 * in_stack_00000008 + dVar1 * in_stack_00000038 + in_stack_00000050;
      __ptr[1] = dVar3 * in_stack_00000028 + dVar2 * in_stack_00000010 + dVar1 * in_stack_00000040 + in_stack_00000058;
      __ptr[2] = dVar2 * in_stack_00000018 + dVar3 * in_stack_00000030 + dVar1 * in_stack_00000048 + in_stack_00000060;
   }
      ...
      if ((long)__size < 0xd) {
         if (__size == 0xc) {
            ...
            *(undefined4*)( __dest + 1 ) = *(undefined4*)( puVar9 + 1 );
            ...
            CreateHalfedges(this, (Vec*)&local_128);
            if (__dest == (undefined8*)0x0) goto LAB_00109805;
         }
   ...
   LAB_00109805:manifold::Manifold::Impl::Finish();
...
/* (anonymous namespace)::JacobiConjugation(int, int, int, (anonymous namespace)::Symmetric3x3&,
   linalg::vec<double, 4>&) */void (anonymous_namespace)::JacobiConjugation(int param_1, int param_2, int param_3, Symmetric3x3 *param_4, vec *param_5) {
   vec *pvVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   undefined8 uVar4;
...
/* std::_Rb_tree_node<std::pair<int const, manifold::Manifold::Impl::Relation> >* std::_Rb_tree<int,
   ...
   std::pair<int const, manifold::Manifold::Impl::Relation>, std::_Select1st<std::pair<int const,
   manifold::Manifold::Impl::Relation> >, std::less<int>, std::allocator<std::pair<int const,
   manifold::Manifold::Impl::Relation> > >::_Alloc_node&) [clone .isra.0] */_Rb_tree_node *
std::
_Rb_tree<int,std::pair<int_const,manifold::Manifold::Impl::Relation>,std::_Select1st<std::pair<int_const,manifold::Manifold::Impl::Relation>>,std::less<int>,std::allocator<std::pair<int_const,manifold::Manifold::Impl::Relation>>>
::
_M_copy<false,std::_Rb_tree<int,std::pair<int_const,manifold::Manifold::Impl::Relation>,std::_Select1st<std::pair<int_const,manifold::Manifold::Impl::Relation>>,std::less<int>,std::allocator<std::pair<int_const,manifold::Manifold::Impl::Relation>>>::_Alloc_node>
   ...
   *(_Rb_tree_node_base**)( p_Var14 + 8 ) = param_2;
   if (p_Var15 != (_Rb_tree_node*)0x0) {
      p_Var15 = _M_copy<false,std::_Rb_tree<int,std::pair<int_const,manifold::Manifold::Impl::Relation>,std::_Select1st<std::pair<int_const,manifold::Manifold::Impl::Relation>>,std::less<int>,std::allocator<std::pair<int_const,manifold::Manifold::Impl::Relation>>>::_Alloc_node>(p_Var15, p_Var14, extraout_RDX);
      *(_Rb_tree_node**)( p_Var14 + 0x18 ) = p_Var15;
   }

   p_Var13 = p_Var14;
   for (puVar3 = *(undefined4**)( param_1 + 0x10 ); puVar3 != (undefined4*)0x0; puVar3 = *(undefined4**)( puVar3 + 4 )) {
      p_Var16 = (_Rb_tree_node_base*)operator_new(0x98);
      for (int i = 0; i < 7; i++) {
         uVar2 = *(undefined8*)( puVar3 + ( 4*i + 10 ) );
         *(undefined8*)( p_Var16 + ( 16*i + 32 ) ) = *(undefined8*)( puVar3 + ( 4*i + 8 ) );
         *(undefined8*)( p_Var16 + ( 16*i + 40 ) ) = uVar2;
      }
      ...
      *(_Rb_tree_node_base**)( p_Var16 + 8 ) = p_Var13;
      if (*(_Rb_tree_node**)( puVar3 + 6 ) != (_Rb_tree_node*)0x0) {
         p_Var15 = _M_copy<false,std::_Rb_tree<int,std::pair<int_const,manifold::Manifold::Impl::Relation>,std::_Select1st<std::pair<int_const,manifold::Manifold::Impl::Relation>>,std::less<int>,std::allocator<std::pair<int_const,manifold::Manifold::Impl::Relation>>>::_Alloc_node>(*(_Rb_tree_node**)( puVar3 + 6 ), p_Var16, extraout_RDX_00);
...
/* manifold::Collider::Transform(linalg::mat<double, 3, 4>) */char manifold::Collider::Transform(undefined8 *param_1) {
   int iVar1;
   bool bVar2;
   int *piVar3;
   double *pdVar4;
 ...
 while ( piVar5 != &local_54 );
   if (cVar7 != '\0') {
      ...
      for (; pdVar6 != pdVar4; pdVar6 = pdVar6 + 6) {
         ...
         dVar14 = pdVar6[2];
         dVar10 = pdVar6[3];
         dVar15 = in_stack_00000020 * dVar17 + in_stack_00000008 * dVar9 + in_stack_00000038 * dVar14 + in_stack_00000050;
         dVar12 = pdVar6[5];
         dVar13 = in_stack_00000028 * dVar17 + in_stack_00000010 * dVar9 + in_stack_00000040 * dVar14 + in_stack_00000058;
         dVar11 = dVar17 * in_stack_00000030 + dVar9 * in_stack_00000018 + dVar14 * in_stack_00000048 + in_stack_00000060;
         dVar9 = pdVar6[4];
         dVar14 = in_stack_00000020 * dVar9 + in_stack_00000008 * dVar10 + in_stack_00000038 * dVar12 + in_stack_00000050;
         dVar18 = in_stack_00000028 * dVar9 + in_stack_00000010 * dVar10 + in_stack_00000040 * dVar12 + in_stack_00000058;
         dVar12 = dVar9 * in_stack_00000030 + dVar10 * in_stack_00000018 + dVar12 * in_stack_00000048 + in_stack_00000060;
         dVar10 = dVar12;
         dVar9 = dVar12;
         dVar17 = dVar13;
         if (dVar15 < dVar14) {
            dVar16 = dVar15;
            if (dVar13 < dVar18) {
               if (dVar11 < dVar12) goto LAB_0010a722;
            }
 else {
               dVar9 = dVar11;
               dVar17 = dVar18;
            ...
            LAB_0010a55c:if (dVar13 < dVar18) {
               LAB_0010a6d7:dVar13 = dVar18;
            }
...
/* manifold::CreateTmpEdges(manifold::Vec<manifold::Halfedge> const&) */manifold * __thiscall manifold::CreateTmpEdges(manifold *this,Vec *param_1){
   ulong uVar1;
   undefined8 *puVar2;
   undefined8 *puVar3;
   ulong uVar4;
   ...
   *(undefined8*)( this + 0x10 ) = 0;
   ...
   if (uVar1 == 0) {
      *(undefined8*)( this + 8 ) = 0;
      ...
      uVar14 = 0;
      __size = 0;
      LAB_0010a7d9:uVar4 = *(ulong*)( this + 8 );
      if (uVar4 < uVar14) {
         puVar10 = *(undefined8**)this;
         LAB_0010a81c:for (puVar5 = (undefined4*)( (long)puVar10 + uVar4 * 0xc ); (undefined4*)( (long)puVar10 + __size ) != puVar5; puVar5 = puVar5 + 3) {
            *puVar5 = 0;
            puVar5[1] = 0;
            puVar5[2] = 0;
         }
 ...
 while ( uVar12 != uVar1 );
      ...
      if (0 < lVar8) {
         puVar13 = puVar6;
         do {
            if (*(int*)( puVar13 + 1 ) < 0) goto LAB_0010a96b;
 ...
 while ( puVar6 + lVar8 * 6 != puVar13 );
      ...
      puVar9 = puVar10;
      if (lVar8 == 0x18) {
         LAB_0010ab0b:if (-1 < *(int*)( puVar13 + 1 )) {
            puVar13 = (undefined8*)( (long)puVar13 + 0xc );
            LAB_0010aae8:if (-1 < *(int*)( puVar13 + 1 )) goto LAB_0010a9a1;
         }

         LAB_0010a96b:puVar9 = puVar13;
         puVar2 = puVar13;
         if (puVar10 != puVar13) {
            while (puVar3 = puVar2,puVar2 = (undefined8*)( (long)puVar3 + 0xc ),puVar9 = puVar13,puVar10 != puVar2) {
...
;
         ...
         if (lVar8 == 0xc) goto LAB_0010aae8;
      }

      LAB_0010a9a1:__size = (long)puVar9 - (long)puVar6;
      uVar14 = ( (long)__size >> 2 ) * -0x5555555555555555;
      uVar12 = ( (long)__size >> 2 ) * 0x5555555555555556;
      if (uVar14 <= uVar1) goto LAB_0010a7d9;
      ...
      if ((long)__size_00 < 0xd) {
         ...
         if (puVar6 != (undefined8*)0x0) goto LAB_0010aa10;
      }
 else {
         puVar10 = (undefined8*)memcpy(puVar10, puVar6, __size_00);
         LAB_0010aa10:free(puVar6);
      }

      uVar4 = *(ulong*)( this + 8 );
      *(undefined8**)this = puVar10;
      *(ulong*)( this + 0x10 ) = uVar14;
      if (uVar4 < uVar14) goto LAB_0010a81c;
      *(ulong*)( this + 8 ) = uVar14;
      joined_r0x0010aa55:if (uVar1 <= uVar12) {
         return this;
      }

      LAB_0010aa5b:puVar10 = (undefined8*)malloc(__size);
      puVar6 = *(undefined8**)this;
      if (0xc < (long)__size) {
   ...
   LAB_0010aa82:free(puVar6);
   *(undefined8**)this = puVar10;
   *(undefined8*)( this + 0x10 ) = *(undefined8*)( this + 8 );
   return this;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* manifold::SpectralNorm(linalg::mat<double, 3, 3>) */double manifold::SpectralNorm(void) {
   undefined8 __x;
   undefined8 __x_00;
   int iVar1;
   long in_FS_OFFSET;
   ...
   iVar1 = 0xc;
   local_20 = *(long*)( in_FS_OFFSET + 0x28 );
   local_58 = in_stack_00000010 * in_stack_00000010 + in_stack_00000008 * in_stack_00000008 + in_stack_00000018 * in_stack_00000018;
   dStack_50 = in_stack_00000010 * in_stack_00000028 + in_stack_00000008 * in_stack_00000020 + in_stack_00000030 * in_stack_00000018;
   local_48 = in_stack_00000028 * in_stack_00000028 + in_stack_00000020 * in_stack_00000020 + in_stack_00000030 * in_stack_00000030;
   dStack_40 = in_stack_00000010 * in_stack_00000040 + in_stack_00000008 * in_stack_00000038 + in_stack_00000018 * in_stack_00000048;
   local_38 = in_stack_00000038 * in_stack_00000020 + in_stack_00000040 * in_stack_00000028 + in_stack_00000048 * in_stack_00000030;
   dStack_30 = in_stack_00000038 * in_stack_00000038 + in_stack_00000040 * in_stack_00000040 + in_stack_00000048 * in_stack_00000048;
   local_78 = (undefined1[16])0x0;
   local_68 = __LC12;
   dStack_60 = _UNK_0010cf08;
   do {
 ...
 while ( iVar1 != 0 );
   ...
   dVar5 = dVar21;
   dVar6 = dVar20;
   LAB_0010b288:dVar7 = hypot(dVar5, dVar6);
...
/* manifold::Manifold::Impl::MeshRelationD::MeshRelationD(manifold::Manifold::Impl::MeshRelationD
   const&) */void manifold::Manifold::Impl::MeshRelationD::MeshRelationD(MeshRelationD *this, MeshRelationD *param_1) {
   ...
   *(undefined8*)this = uVar3;
   ...
   if (lVar4 == 0) {
      ...
      if (pMVar1 != (MeshRelationD*)&local_58) {
         ...
         LAB_0010b776:*(undefined8**)( this + 8 ) = puVar8;
      ...
      if ((long)sVar11 < 9) {
         p_Var9 = extraout_RDX;
         if (sVar11 != 8) {
            if (pMVar1 != (MeshRelationD*)&local_58) goto LAB_0010b776;
   ...
   LAB_0010b77e:*(undefined8*)( this + 0x30 ) = 0;
   ...
   *(undefined8*)( this + 0x48 ) = 0;
   if (p_Var6 != (_Rb_tree_node*)0x0) {
      p_Var7 = std::_Rb_tree<int,std::pair<int_const,manifold::Manifold::Impl::Relation>,std::_Select1st<std::pair<int_const,manifold::Manifold::Impl::Relation>>,std::less<int>,std::allocator<std::pair<int_const,manifold::Manifold::Impl::Relation>>>::_M_copy<false,std::_Rb_tree<int,std::pair<int_const,manifold::Manifold::Impl::Relation>,std::_Select1st<std::pair<int_const,manifold::Manifold::Impl::Relation>>,std::less<int>,std::allocator<std::pair<int_const,manifold::Manifold::Impl::Relation>>>::_Alloc_node>(p_Var6, p_Var2, p_Var9);
      p_Var6 = p_Var7;
      do {
         p_Var10 = p_Var6;
 ...
 while ( p_Var6 != (_Rb_tree_node*)0x0 );
   ...
   *(undefined1(*) [16])( this + 0x58 ) = (undefined1[16])0x0;
   ...
   if (lVar4 == 0) {
      if (pMVar1 != (MeshRelationD*)&local_58) {
         puVar8 = (undefined8*)0x0;
         LAB_0010b82f:*(undefined8**)( this + 0x50 ) = puVar8;
      ...
      if ((long)sVar11 < 0x11) {
         if (sVar11 != 0x10) {
            if (pMVar1 != (MeshRelationD*)&local_58) goto LAB_0010b82f;
            if (puVar8 != (undefined8*)0x0) {
               free(puVar8);
            }
   ...
   LAB_0010b837:*(undefined8*)( this + 0x68 ) = 0;
   pMVar1 = this + 0x68;
   ...
   *(undefined1(*) [16])( this + 0x70 ) = (undefined1[16])0x0;
   ...
   if (lVar4 == 0) {
      if (pMVar1 != (MeshRelationD*)&local_58) {
         puVar8 = (undefined8*)0x0;
         LAB_0010b87a:*(undefined8**)( this + 0x68 ) = puVar8;
         *(long*)( this + 0x70 ) = lVar4;
         *(long*)( this + 0x78 ) = lVar4;
      }

      LAB_0010b882:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
      ...
      if ((long)sVar11 < 0xd) {
         ...
         if (pMVar1 != (MeshRelationD*)&local_58) goto LAB_0010b87a;
         if (puVar8 == (undefined8*)0x0) goto LAB_0010b882;
      }
 else {
         puVar8 = (undefined8*)memmove(puVar8, puVar5, sVar11);
         LAB_0010b99e:if (pMVar1 != (MeshRelationD*)&local_58) goto LAB_0010b87a;
      }
...
/* manifold::Manifold::Impl::Impl(manifold::Manifold::Impl const&) */void manifold::Manifold::Impl::Impl(Impl *this, Impl *param_1) {
   Impl *pIVar1;
   undefined4 uVar2;
   long lVar3;
   undefined8 *puVar4;
   ...
   *(undefined8*)( this + 0x38 ) = uVar13;
   if (lVar3 == 0) {
      if (pIVar1 != (Impl*)&local_58) {
         puVar14 = (undefined8*)0x0;
         LAB_0010baf8:*(undefined8**)( this + 0x48 ) = puVar14;
      ...
      if ((long)sVar16 < 0x19) {
         if (sVar16 != 0x18) {
            if (pIVar1 != (Impl*)&local_58) goto LAB_0010baf8;
   ...
   LAB_0010bb00:*(undefined8*)( this + 0x60 ) = 0;
   pIVar1 = this + 0x60;
   ...
   *(undefined1(*) [16])( this + 0x68 ) = (undefined1[16])0x0;
   ...
   if (lVar3 == 0) {
      if (pIVar1 != (Impl*)&local_58) {
         puVar14 = (undefined8*)0x0;
         LAB_0010bb43:*(undefined8**)( this + 0x60 ) = puVar14;
      ...
      if ((long)sVar16 < 0xd) {
         if (sVar16 != 0xc) {
            if (pIVar1 != (Impl*)&local_58) goto LAB_0010bb43;
            if (puVar14 != (undefined8*)0x0) {
               free(puVar14);
            }
   ...
   LAB_0010bb4b:*(undefined8*)( this + 0x78 ) = 0;
   pIVar1 = this + 0x78;
   ...
   *(undefined1(*) [16])( this + 0x80 ) = (undefined1[16])0x0;
   ...
   if (lVar3 == 0) {
      if (pIVar1 != (Impl*)&local_58) {
         puVar14 = (undefined8*)0x0;
         LAB_0010bb94:*(undefined8**)( this + 0x78 ) = puVar14;
      ...
      if ((long)sVar16 < 0x19) {
         if (sVar16 != 0x18) {
            if (pIVar1 != (Impl*)&local_58) goto LAB_0010bb94;
            if (puVar14 != (undefined8*)0x0) {
               free(puVar14);
            }
   ...
   *(undefined1(*) [16])( this + 0x98 ) = (undefined1[16])0x0;
   ...
   if (lVar3 == 0) {
      if (pIVar1 != (Impl*)&local_58) {
         puVar14 = (undefined8*)0x0;
         LAB_0010bbf1:*(undefined8**)( this + 0x90 ) = puVar14;
      ...
      if ((long)sVar16 < 0x19) {
         if (sVar16 != 0x18) {
            if (pIVar1 != (Impl*)&local_58) goto LAB_0010bbf1;
            if (puVar14 != (undefined8*)0x0) {
               free(puVar14);
            }
   ...
   *(undefined1(*) [16])( this + 0xb0 ) = (undefined1[16])0x0;
   ...
   if (lVar3 == 0) {
      if (pIVar1 != (Impl*)&local_58) {
         puVar14 = (undefined8*)0x0;
         LAB_0010bc51:*(undefined8**)( this + 0xa8 ) = puVar14;
      ...
      if ((long)sVar16 < 0x21) {
         if (sVar16 != 0x20) {
            if (pIVar1 != (Impl*)&local_58) goto LAB_0010bc51;
            if (puVar14 != (undefined8*)0x0) {
               free(puVar14);
            }
   ...
   LAB_0010bc5f:MeshRelationD::MeshRelationD((MeshRelationD*)( this + 0xc0 ), (MeshRelationD*)( param_1 + 0xc0 ));
   pIVar1 = this + 0x140;
   *(undefined8*)( this + 0x140 ) = 0;
   *(undefined1(*) [16])( this + 0x148 ) = (undefined1[16])0x0;
   ...
   if (lVar3 == 0) {
      if (pIVar1 != (Impl*)&local_58) {
         puVar14 = (undefined8*)0x0;
         LAB_0010bcc4:*(undefined8**)( this + 0x140 ) = puVar14;
      ...
      if ((long)sVar16 < 0x31) {
         if (sVar16 != 0x30) {
            if (pIVar1 != (Impl*)&local_58) goto LAB_0010bcc4;
            if (puVar14 != (undefined8*)0x0) {
               free(puVar14);
            }
   ...
   LAB_0010bcd2:pIVar1 = this + 0x158;
   *(undefined8*)( this + 0x158 ) = 0;
   ...
   *(undefined1(*) [16])( this + 0x160 ) = (undefined1[16])0x0;
   ...
   if (lVar3 == 0) {
      if (pIVar1 != (Impl*)&local_58) {
         __ptr = (undefined4*)0x0;
         LAB_0010bd24:*(undefined4**)( this + 0x158 ) = __ptr;
      ...
      if ((long)sVar16 < 5) {
         if (sVar16 != 4) {
            if (pIVar1 != (Impl*)&local_58) goto LAB_0010bd24;
            if (__ptr != (undefined4*)0x0) {
               free(__ptr);
            }
   ...
   LAB_0010bd32:pIVar1 = this + 0x170;
   *(undefined8*)( this + 0x170 ) = 0;
   ...
   *(undefined1(*) [16])( this + 0x178 ) = (undefined1[16])0x0;
   ...
   lStack_48 = lVar5;
   if (lVar5 == 0) {
      if (pIVar1 != (Impl*)&local_58) goto LAB_0010bd80;
   }
 else {
      sVar16 = lVar5 * 8;
      ...
      if ((long)sVar16 < 1) {
         if (pIVar1 == (Impl*)&local_58) {
            if (local_58 == (undefined8*)0x0) goto LAB_0010bd8e;
            goto LAB_0010be0b;
         }
 ...
 while ( uVar15 < ( ulong )((long)sVar16 >> 3) );
         if (pIVar1 == (Impl*)&local_58) {
            LAB_0010be0b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
               free(local_58);
               return;
            }
      ...
      LAB_0010bd80:*(undefined8**)( this + 0x170 ) = local_58;
      *(long*)( this + 0x178 ) = lVar5;
      *(long*)( this + 0x180 ) = lVar5;
   }

   LAB_0010bd8e:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }

   LAB_0010c0b7:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* manifold::Manifold::Impl::Impl(manifold::Manifold::Impl&&) */void manifold::Manifold::Impl::Impl(Impl *this, Impl *param_1) {
   undefined8 uVar1;
   long lVar2;
   undefined8 uVar3;
   undefined8 uVar4;
...
/* std::vector<int, std::allocator<int> >::_M_default_append(unsigned long) */void std::vector<int,std::allocator<int>>::_M_default_append(vector<int,std::allocator<int>> *this, ulong param_1) {
   ulong uVar1;
   ulong uVar2;
   void *__dest;
   void *pvVar3;
   ...
   if (uVar2 < param_1) {
      ...
      *puVar6 = 0;
      if (param_1 - 1 != 0) goto LAB_0010c704;
      LAB_0010c718:if (sVar4 != 0) goto LAB_0010c7e8;
      if (pvVar3 == (void*)0x0) goto LAB_0010c72a;
      ...
      *puVar6 = 0;
      if (param_1 != 1) {
         LAB_0010c704:memset(puVar6 + 1, 0, ( param_1 - 1 ) * 4);
         goto LAB_0010c718;
      }

      LAB_0010c7e8:memmove(__dest, pvVar3, sVar4);
      uVar5 = *(long*)( this + 0x10 ) - (long)pvVar3;
   }

   operator_delete(pvVar3, uVar5);
   LAB_0010c72a:*(void**)this = __dest;
...
/* manifold::UnionFind<int, unsigned char>::connectedComponents(std::vector<int, std::allocator<int>
   >&) */int manifold::UnionFind<int,unsigned_char>::connectedComponents(UnionFind<int,unsigned_char> *this, vector *param_1) {
   long lVar1;
   int iVar2;
   long lVar3;
   undefined8 *puVar4;
   ...
   if (uVar9 < uVar16) {
      std::vector<int,std::allocator<int>>::_M_default_append((vector<int,std::allocator<int>>*)param_1, uVar16 - uVar9);
      uVar16 = *(ulong*)( this + 8 );
   }
 else if (( uVar16 < uVar9 ) && ( lVar1 = *(long*)param_1 + uVar16 * 4 * (long*)( param_1 + 8 ) != lVar1 )) {
      ...
      *(int*)( lVar3 + lVar1 ) = iVar14;
      ...
      if (uVar16 == 0) {
         for (; plVar10 != (long*)0x0; plVar10 = (long*)*plVar10) {
            if ((int)plVar10[1] == iVar14) goto LAB_0010c971;
         }
         ...
         if (puVar13 != (undefined8*)0x0) {
            ...
            while (iVar14 != iVar8) {
               ...
               if (( puVar4 == (undefined8*)0x0 ) || ( iVar8 = *(int*)( puVar4 + 1 ) ),puVar13 = puVar6,puVar6 = puVar4,uVar18 % local_70 != (ulong)(long)iVar8 % local_70) goto LAB_0010ca80;
            }
;
            plVar10 = (long*)*puVar13;
            if (plVar10 != (long*)0x0) goto LAB_0010c971;
         }

      }

      LAB_0010ca80:iVar8 = iVar17 + (int)uVar16;
      ...
      *(int*)( (long)plVar11 + 0xc ) = iVar8;
      ...
      if (local_60 == 0) {
         for (; plVar10 != (long*)0x0; plVar10 = (long*)*plVar10) {
            if ((int)plVar10[1] == iVar14) goto LAB_0010cb33;
         }
         ...
         if (plVar10 != (long*)0x0) {
            ...
            while (iVar2 != iVar14) {
               plVar5 = (long*)*plVar12;
               if (( plVar5 == (long*)0x0 ) || ( iVar2 = (int)plVar5[1] ),plVar10 = plVar12,plVar12 = plVar5,uVar18 % local_70 != (ulong)(long)iVar2 % local_70) goto LAB_0010cba6;
            }
;
            if (*plVar10 != 0) goto LAB_0010cb33;
         }

      }

      LAB_0010cba6:cVar7 = std::__detail::_Prime_rehash_policy::_M_need_rehash((ulong)local_58, local_70, local_60);
      if (cVar7 == '\0') {
         plVar10 = local_78 + uVar18 % local_70;
         plVar12 = (long*)*plVar10;
         if (plVar12 != (long*)0x0) goto LAB_0010cbf5;
         LAB_0010cd44:*plVar11 = (long)local_68;
         ...
         *plVar10 = (long)&local_68;
         ...
         while (uVar19 = uVar16,plVar12 = plVar10,plVar10 != (long*)0x0) {
            while (true) {
               ...
               *(long**)*plVar5 = plVar12;
               plVar12 = plVar10;
               if (plVar10 == (long*)0x0) goto LAB_0010cce0;
            }
;
...
;
         LAB_0010cce0:if (local_78 != &local_48) {
         ...
         if (plVar12 == (long*)0x0) goto LAB_0010cd44;
         LAB_0010cbf5:*plVar11 = *plVar12;
   ...
   __n = 8;
   iVar17 = 0;
   LAB_0010c9c7:memset(local_78, 0, __n);
   local_60 = 0;
   local_68 = (long*)0x0;
   ...
   LAB_0010cde5:/* WARNING: Subroutine does not return */__stack_chk_fail();
   LAB_0010c971:uVar9 = uVar9 + 1;
   *(undefined4*)( *(long*)param_1 + lVar1 ) = *(undefined4*)( (long)plVar10 + 0xc );
   if (*(ulong*)( this + 8 ) <= uVar9) goto LAB_0010c989;
   goto LAB_0010c8fd;
   LAB_0010cb33:operator_delete(plVar11, 0x10);
   LAB_0010cb4f:*(int*)( *(long*)param_1 + lVar1 ) = iVar8;
   uVar16 = local_60;
   LAB_0010c8ef:uVar9 = uVar9 + 1;
   if (*(ulong*)( this + 8 ) <= uVar9) goto LAB_0010c989;
   goto LAB_0010c8fd;
   LAB_0010c989:iVar17 = iVar17 + (int)uVar16;
   plVar10 = local_68;
...
/* WARNING: Control flow encountered bad instruction data *//* manifold::Manifold::Impl::Impl(manifold::Manifold::Impl&&) */void manifold::Manifold::Impl::Impl(Impl *this, Impl *param_1) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* manifold::Manifold::Impl::Impl(manifold::Manifold::Impl const&) */void manifold::Manifold::Impl::Impl(Impl *this, Impl *param_1) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* manifold::Manifold::Impl::MeshRelationD::MeshRelationD(manifold::Manifold::Impl::MeshRelationD
   const&) */void manifold::Manifold::Impl::MeshRelationD::MeshRelationD(MeshRelationD *this, MeshRelationD *param_1) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

...
ulong XXH64_finalize(ulong param_1, uint *param_2, uint param_3) {
   ...
   if (( param_3 & 0x18 ) != 0) {
      ...
      do {
         lVar3 = *(long*)param_2;
         param_2 = param_2 + 2;
         param_1 = ( lVar3 * -0x6c158a5880000000 | ( ulong )(lVar3 * -0x3d4d51c2d82b14b1) >> 0x21 ) * -0x61c8864e7a143579 ^ param_1;
...
void ZSTD_XXH32(int *param_1, ulong param_2, uint param_3) {
 ...
 while ( piVar3 < piVar1 );
      ...
      iVar5 = ( uVar9 * 0x779b1000 | param_3 >> 0x14 ) + ( uVar6 * 0x3c6ef362 | ( uint )(iVar5 < 0) ) + ( uVar8 * 0x1bbcd880 | uVar7 >> 0x19 ) + ( uVar10 >> 0xe | uVar11 * -0x193c0000 );
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 ZSTD_XXH32_reset(undefined1 (*param_1)[16], int param_2) {
   int iVar1;
   int iVar2;
   int iVar3;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 ZSTD_XXH32_update(uint *param_1, int *param_2, ulong param_3) {
   int *piVar1;
   int *piVar2;
   int *piVar3;
   uint uVar4;
 ...
 while ( piVar3 <= piVar1 + -4 );
   param_2 = (int*)( (long)param_2 + ( (long)( piVar1 + -4 ) - (long)param_2 & 0xfffffffffffffff0U ) + 0x10 );
   LAB_0010042e:if (param_2 < piVar1) {
...
void ZSTD_XXH32_digest(int *param_1) {
   ...
   if (param_1[1] != 0) {
      iVar2 = ( param_1[2] << 1 | ( uint )(param_1[2] < 0) ) + ( param_1[3] << 7 | (uint)param_1[3] >> 0x19 ) + ( uVar1 << 0xc | uVar1 >> 0x14 ) + ( (uint)param_1[5] >> 0xe | param_1[5] << 0x12 );
   }
...
void ZSTD_XXH64(long *param_1, ulong param_2, ulong param_3) {
 ...
 while ( plVar7 < plVar1 );
      ...
      lVar5 = ( ( ( uVar9 * -0x784349ab80000000 | uVar9 * -0x210ca4fef0869357 >> 0x21 ) * -0x61c8864e7a143579 ^ ( ( uVar4 * -0x784349ab80000000 | uVar4 * -0x210ca4fef0869357 >> 0x21 ) * -0x61c8864e7a143579 ^ ( ( uVar10 * 0x3c6ef3630bd7950e | ( ulong )(lVar5 < 0) ) + ( uVar4 * 0x1bbcd8c2f5e54380 | uVar3 >> 0x39 ) + ( uVar9 * 0x779b185ebca87000 | param_3 >> 0x34 ) + ( uVar2 * -0x1939e850d5e40000 | uVar11 >> 0x2e ) ^ ( uVar10 * -0x784349ab80000000 | uVar10 * -0x210ca4fef0869357 >> 0x21 ) * -0x61c8864e7a143579 ) * -0x61c8864e7a143579 + 0x85ebca77c2b2ae63 ) * -0x61c8864e7a143579 + 0x85ebca77c2b2ae63 ) * -0x61c8864e7a143579 + 0x85ebca77c2b2ae63 ^ ( uVar2 * -0x784349ab80000000 | uVar2 * -0x210ca4fef0869357 >> 0x21 ) * -0x61c8864e7a143579 ) * -0x61c8864e7a143579 + -0x7a1435883d4d519d;
   }
...
undefined8 ZSTD_XXH64_reset(undefined8 *param_1, long param_2) {
   ...
   *param_1 = 0;
   ...
   for (uVar1 = ( ulong )(( (int)param_1 - (int)(undefined8*)( ( ulong )(param_1 + 1) & 0xfffffffffffffff8 ) ) + 0x58U >> 3); uVar1 != 0; uVar1 = uVar1 - 1) {
      *puVar2 = 0;
      puVar2 = puVar2 + 1;
   }
...
undefined8 ZSTD_XXH64_update(long *param_1, long *param_2, size_t param_3) {
 ...
 while ( plVar4 <= plVar1 + -4 );
         param_2 = (long*)( (long)param_2 + ( (long)( plVar1 + -4 ) - (long)param_2 & 0xffffffffffffffe0U ) + 0x20 );
      }
...
void ZSTD_XXH64_digest(ulong *param_1) {
   ...
   if (0x1f < uVar2) {
      ...
      uVar4 = param_1[2];
      uVar5 = param_1[4];
      lVar6 = ( ( uVar5 * -0x6c158a5880000000 | uVar5 * -0x3d4d51c2d82b14b1 >> 0x21 ) * -0x61c8864e7a143579 ^ ( ( uVar1 * -0x6c158a5880000000 | uVar1 * -0x3d4d51c2d82b14b1 >> 0x21 ) * -0x61c8864e7a143579 ^ ( ( ( uVar4 << 7 | uVar4 >> 0x39 ) + ( uVar3 << 1 | ( ulong )((long)uVar3 < 0) ) + ( uVar1 << 0xc | uVar1 >> 0x34 ) + ( uVar5 << 0x12 | uVar5 >> 0x2e ) ^ ( uVar3 * -0x6c158a5880000000 | uVar3 * -0x3d4d51c2d82b14b1 >> 0x21 ) * -0x61c8864e7a143579 ) * -0x61c8864e7a143579 + 0x85ebca77c2b2ae63 ^ ( uVar4 * -0x6c158a5880000000 | uVar4 * -0x3d4d51c2d82b14b1 >> 0x21 ) * -0x61c8864e7a143579 ) * -0x61c8864e7a143579 + 0x85ebca77c2b2ae63 ) * -0x61c8864e7a143579 + 0x85ebca77c2b2ae63 ) * -0x61c8864e7a143579 + -0x7a1435883d4d519d;
   }
...
void ZSTD_XXH64_canonicalFromHash(ulong *param_1, ulong param_2) {
   *param_1 = param_2 >> 0x38 | ( param_2 & 0xff000000000000 ) >> 0x28 | ( param_2 & 0xff0000000000 ) >> 0x18 | ( param_2 & 0xff00000000 ) >> 8 | ( param_2 & 0xff000000 ) << 8 | ( param_2 & 0xff0000 ) << 0x18 | ( param_2 & 0xff00 ) << 0x28 | param_2 << 0x38;
   return;
}
ulong ZSTD_XXH64_hashFromCanonical(ulong *param_1) {
   ulong uVar1;
   uVar1 = *param_1;
   return uVar1 >> 0x38 | ( uVar1 & 0xff000000000000 ) >> 0x28 | ( uVar1 & 0xff0000000000 ) >> 0x18 | ( uVar1 & 0xff00000000 ) >> 8 | ( uVar1 & 0xff000000 ) << 8 | ( uVar1 & 0xff0000 ) << 0x18 | ( uVar1 & 0xff00 ) << 0x28 | uVar1 << 0x38;
}

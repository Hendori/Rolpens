undefined8 do_bio_cipher_constprop_0(EVP_CIPHER *param_1, uchar *param_2) {
   ...
   if (iVar1 != 0) {
      ...
      if (iVar1 != 0) {
         ...
         iVar1 = test_true("test/bio_enc_test.c", 0x38, "BIO_set_cipher(b, cipher, key, iv, ENCRYPT)", extraout_EAX != 0);
         if (iVar1 != 0) {
            ...
            if (iVar1 != 0) {
               ...
               if ((int)len < 2) {
                  ...
                  do {
                     ...
                     BIO_set_cipher(b, param_1, KEY, param_2, 1);
                     iVar1 = test_true("test/bio_enc_test.c", 0x46, "BIO_set_cipher(b, cipher, key, iv, ENCRYPT)", extraout_EAX_00 != 0);
                     if (iVar1 == 0) {
                        test_info("test/bio_enc_test.c", 0x47, "Split encrypt failed @ operation %d", uVar9 & 0xffffffff);
                        goto LAB_00100105;
                     }
                     ...
                     if (iVar1 < 0) goto LAB_00100105;
                     iVar2 = test_uchar_eq("test/bio_enc_test.c", 0x55, "out[i]", "(unsigned char)~ref[i]", local_888[uVar9], ~local_468[uVar9]);
                     if (iVar2 == 0) {
                        test_info("test/bio_enc_test.c", 0x56, "Encrypt overstep check failed @ operation %d", uVar9 & 0xffffffff);
                        goto LAB_00100105;
                     }
                     ...
                     BIO_free_all(b);
                     iVar1 = test_mem_eq("test/bio_enc_test.c", 0x60, &_LC11, &_LC10, local_888, (long)( iVar1 + iVar2 ), local_468, (long)(int)len);
                     if (iVar1 == 0) {
                        test_info("test/bio_enc_test.c", 0x61, "Encrypt compare failed @ operation %d", uVar9 & 0xffffffff);
                        goto LAB_00100074;
                     }
 ...
 while ( uVar9 != len );
                  ...
                  if ((int)len < 4) {
                     ...
                     do {
                        ...
                        BIO_set_cipher(b, param_1, KEY, param_2, 1);
                        iVar2 = test_true("test/bio_enc_test.c", 0x6d, "BIO_set_cipher(b, cipher, key, iv, ENCRYPT)", extraout_EAX_01 != 0);
                        if (iVar2 == 0) {
                           test_info("test/bio_enc_test.c", 0x6e, "Small chunk encrypt failed @ operation %d", iVar1);
                           goto LAB_00100105;
                        }
...
;
                        BIO_free_all(b);
                        iVar2 = test_mem_eq("test/bio_enc_test.c", 0x7b, &_LC11, &_LC10, local_888, (long)iVar2, local_468, (long)(int)len);
                        if (iVar2 == 0) {
                           test_info("test/bio_enc_test.c", 0x7c, "Small chunk encrypt compare failed @ operation %d", iVar1);
                           goto LAB_00100074;
                        }
 ...
 while ( iVar1 < local_8a4 );
               ...
               iVar1 = test_true("test/bio_enc_test.c", 0x87, "BIO_set_cipher(b, cipher, key, iv, DECRYPT)", extraout_EAX_02 != 0);
               if (iVar1 != 0) {
                  ...
                  if (iVar1 != 0) {
                     ...
                     BIO_free_all(b);
                     iVar1 = test_mem_eq("test/bio_enc_test.c", 0x93, &_LC16, &_LC11, inp_0, 0x400, local_888, (long)iVar1);
                     if (iVar1 != 0) {
                        if (1 < (int)len) {
                           uVar9 = 1;
                           do {
                              ...
                              if (iVar1 == 0) goto LAB_00100074;
                              BIO_set_cipher(b, param_1, KEY, param_2, 0);
                              iVar1 = test_true("test/bio_enc_test.c", 0x9b, "BIO_set_cipher(b, cipher, key, iv, DECRYPT)", extraout_EAX_03 != 0);
                              if (iVar1 == 0) {
                                 test_info("test/bio_enc_test.c", 0x9c, "Split decrypt failed @ operation %d", uVar9 & 0xffffffff);
                                 goto LAB_00100105;
                              }
                              ...
                              local_888[uVar9] = ~local_468[uVar9];
                              iVar1 = BIO_read(b, local_888, (int)uVar9);
                              iVar2 = test_uchar_eq("test/bio_enc_test.c", 0xa7, "out[i]", "(unsigned char)~ref[i]", local_888[uVar9], ~local_468[uVar9]);
                              if (iVar2 == 0) {
                                 test_info("test/bio_enc_test.c", 0xa8, "Decrypt overstep check failed @ operation %d", uVar9 & 0xffffffff);
                                 goto LAB_00100105;
                              }

                              iVar2 = BIO_read(b, local_888 + iVar1, 0x420 - iVar1);
                              BIO_free_all(b);
                              iVar1 = test_mem_eq("test/bio_enc_test.c", 0xae, &_LC16, &_LC11, inp_0, 0x400, local_888, (long)( iVar1 + iVar2 ));
                              if (iVar1 == 0) {
                                 test_info("test/bio_enc_test.c", 0xaf, "Decrypt compare failed @ operation %d", uVar9 & 0xffffffff);
                                 goto LAB_00100074;
                              }
 ...
 while ( uVar9 != len );
                        ...
                        for (iVar1 = 1; iVar1 < local_8a4; iVar1 = iVar1 + 1) {
                           ...
                           if (iVar2 == 0) goto LAB_00100074;
                           BIO_set_cipher(b, param_1, KEY, param_2, 0);
                           iVar2 = test_true("test/bio_enc_test.c", 0xbb, "BIO_set_cipher(b, cipher, key, iv, DECRYPT)", extraout_EAX_04 != 0);
                           if (iVar2 == 0) {
                              test_info("test/bio_enc_test.c", 0xbc, "Small chunk decrypt failed @ operation %d", iVar1);
                              goto LAB_00100105;
                           }
...
;
                           BIO_free_all(b);
                           iVar2 = test_mem_eq("test/bio_enc_test.c", 0xc9, &_LC16, &_LC11, inp_0, 0x400, local_888, (long)iVar2);
                           if (iVar2 == 0) {
                              test_info("test/bio_enc_test.c", 0xca, "Small chunk decrypt compare failed @ operation %d", iVar1);
                              goto LAB_00100074;
                           }
         ...
         LAB_00100105:BIO_free_all(b);
      }

   }

   LAB_00100074:uVar6 = 0;
   LAB_00100076:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {

bool tls_construct_client_hello(SSL *param_1, undefined8 param_2) {
   ...
   if (pcVar1 == (code*)0x0) {
      ...
      for (lVar6 = 0x20; lVar6 != 0; lVar6 = lVar6 + -1) {
         for (int i_1739 = 0; i_1739 < 8; i_1739++) {
            pcVar5[i_1739] = '\0';
         }
         pcVar5 = pcVar5 + 8;
      }
...
LAB_0010190f:
   ...
   LAB_00101705:if (( param_2 == 0x101 ) && ( bVar4 )) {
      ...
      for (int i_1740 = 0; i_1740 < 4; i_1740++) {
         param_1->sid_ctx[i_1740] = '\0';
      }
   ...
   *(undefined8*)( param_1 + 0x108 ) = 0;
   switch (*(undefined4*)( param_1 + 0xac )) {
    ...
    break;
      ...
      case 0x11:
      case 0x13:
      for (int i_1741 = 0; i_1741 < 25; i_1741++) {
         case 0x15:
      }
      case 0x2e:
    break;
...
LAB_001073d5:
   ...
   for (int i_1742 = 0; i_1742 < 2; i_1742++) {

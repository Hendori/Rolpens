uint setChannelFlags(uint param_1, undefined4 param_2) {
   ...
   *piVar1 = iVar4;
   ...
   piVar1[3] = uVar2;
   return;
}void writeSample(long param_1, int param_2, int param_3, int param_4, uint param_5, int param_6, uint param_7, undefined4 param_8) {
   uint *puVar1;
   uint uVar2;
   int iVar3;
   uint uVar4;
...
switchD_0010018a_caseD_9:
   ...
   return uVar3;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 *createDFDPackedShifted(int param_1, int param_2, long param_3, long param_4, long param_5, undefined4 param_6) {
   long lVar1;
   long lVar2;
   int *piVar3;
   int *piVar4;
   ...
   if (param_2 == 6) {
      ...
      *puVar11 = uVar6;
      ...
      do {
         ...
         writeSample(puVar11, uVar19 & 0xffffffff, *(undefined4*)( param_5 + uVar19 * 4 ), *(undefined4*)( param_3 + uVar19 * 4 ), iVar17, 1, 1, param_6);
   ...
   LAB_00100735:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return puVar11;
   }
   ...
   __stack_chk_fail();
}uint *createDFD422(undefined8 param_1, int param_2, long param_3, long param_4, long param_5, long param_6, long param_7) {
   int *piVar1;
   uint *puVar2;
   int *piVar3;
   byte bVar4;
   ...
   *piVar5 = uVar1 * 0x10 + 0x1c;
   ...
   return piVar5;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void createDFDDepthStencil(uint param_1, int param_2, undefined4 param_3) {
   undefined8 uVar1;
   long lVar2;
   ...
   LAB_00100c36:*(undefined8*)( lVar2 + 0x30 ) = 0;

/* VmaAddDetailedStatistics(VmaDetailedStatistics&, VmaDetailedStatistics const&) */void VmaAddDetailedStatistics(VmaDetailedStatistics *param_1, VmaDetailedStatistics *param_2) {
   long lVar1;
   long lVar2;
   ulong uVar3;
   lVar1 = *(long*)( param_2 + 8 );
   lVar2 = *(long*)( param_2 + 0x10 );
   *(ulong*)param_1 = CONCAT44((int)( ( ulong ) * (undefined8*)param_1 >> 0x20 ) + (int)( ( ulong ) * (undefined8*)param_2 >> 0x20 ), (int)*(undefined8*)param_1 + (int)*(undefined8*)param_2);
   ...
   *(ulong*)( param_1 + 0x38 ) = uVar3;
   return;
}/* VmaBlockMetadata_Linear::Init(unsigned long) */void VmaBlockMetadata_Linear::Init(VmaBlockMetadata_Linear *this, ulong param_1) {
   *(ulong*)( this + 8 ) = param_1;
   *(ulong*)( this + 0x28 ) = param_1;
   return;
}/* VmaBlockMetadata_Linear::Validate() const */bool VmaBlockMetadata_Linear::Validate(VmaBlockMetadata_Linear *this) {
   int iVar1;
   int iVar2;
   ulong uVar3;
   ulong uVar4;
   ...
   if (uVar16 == 0) {
      ...
      LAB_00100193:if (*(int*)( uVar11 * 0x20 + *(long*)( pVVar18 + 8 ) + -8 ) == 0) {
         return false;
      }
   }
   uVar15 = *(ulong*)( this + 0x78 );
   LAB_001000ec:bVar21 = false;
   if (( *(long*)( this + 0x80 ) + uVar15 <= uVar16 ) && ( uVar3 = uVar3 <= uVar11 )) {
      uVar6 = 0;
      lVar20 = 0;
      if (iVar1 == 1) {
         if (uVar11 == 0) {
            ...
            do {
               ...
               if (this[0x20] == (VmaBlockMetadata_Linear)0x0) {
                  ...
                  uVar6 = puVar13[1];
                  LAB_0010025d:lVar20 = lVar20 + uVar6;
               }
               uVar9 = uVar9 + 1;
               uVar6 = uVar6 + uVar19;
               puVar13 = puVar13 + 4;
      ...
      if (uVar15 < uVar16) {
         ...
         do {
            ...
            if (this[0x20] == (VmaBlockMetadata_Linear)0x0) {
               ...
               uVar6 = puVar13[1];
               LAB_00100339:lVar20 = lVar20 + uVar6;
            }
            uVar9 = uVar9 + 1;
            uVar6 = uVar6 + uVar19;
            puVar13 = puVar13 + 4;
            ...
            if (uVar11 != 0) {
               ...
               do {
                  ...
                  if (this[0x20] == (VmaBlockMetadata_Linear)0x0) {
                     ...
                     LAB_001004b0:lVar8 = *(long*)( lVar14 + -0x18 );
                     uVar11 = uVar11 + 1;
                  } else {
                     uVar16 = *(ulong*)( lVar14 + -0x20 );
                     if (uVar16 < uVar6) {
                     ...
                     LAB_00100475:lVar20 = lVar20 + lVar8;
                  }
                  lVar17 = lVar17 + -1;
                  uVar6 = lVar8 + uVar16;
                  lVar14 = lVar14 + -0x20;
   ...
   return bVar21;
}/* VmaBlockMetadata_Linear::GetAllocationCount() const */long VmaBlockMetadata_Linear::GetAllocationCount(VmaBlockMetadata_Linear *this) {
   if (*(int*)( this + 0x70 ) != 0) {
      return ( ( *(long*)( this + 0x60 ) - ( *(long*)( this + 0x80 ) + *(long*)( this + 0x78 ) ) ) - *(long*)( this + 0x88 ) ) + *(long*)( this + 0x40 );
   }
   return ( ( *(long*)( this + 0x40 ) - ( *(long*)( this + 0x80 ) + *(long*)( this + 0x78 ) ) ) - *(long*)( this + 0x88 ) ) + *(long*)( this + 0x60 );
}/* VmaBlockMetadata_Linear::GetFreeRegionsCount() const */undefined8 VmaBlockMetadata_Linear::GetFreeRegionsCount(void) {
   return 0xffffffffffffffff;
}/* VmaBlockMetadata_Linear::AddStatistics(VmaStatistics&) const */void VmaBlockMetadata_Linear::AddStatistics(VmaBlockMetadata_Linear *this, VmaStatistics *param_1) {
   int iVar1;
   ulong uVar2;
   ulong uVar3;
   long lVar4;
   ...
   *(ulong*)( param_1 + 8 ) = *(long*)( param_1 + 8 ) + uVar2;
   ...
   if (iVar1 == 1) {
      ...
      for (uVar9 = uVar7; ( uVar11<uVar5&&(uVar11 = uVar5, uVar9<uVar6));uVar9 = {while (*(long *)(*(long *)(pVVar13 + 8) + 0x10 + uVar9 * 0x20) == 0) {
        uVar9 = uVar9 + 1;
        if (uVar9 == uVar6) goto LAB_001005b0;
      }
      if (uVar6 <= uVar9) break;
      plVar8 = (long *)(*(long *)(pVVar13 + 8) + uVar9 * 0x20);
      *(int *)(param_1 + 4) = *(int *)(param_1 + 4) + 1;uVar11 = plVar8[1] + *plVar8;}(iVar1 == 2) = {if ((uVar12 <= uVar11) || (uVar11 = uVar12, uVar3 <= uVar7)) {
LAB_001005ed:
      if (iVar1 == 2) {
    ...
    *(int *)(param_1 + 4) = *(int *)(param_1 + 4) + 1;
    uVar7 = uVar7 + 1;uVar11 = plVar8[1] + *plVar8;} while( true );
} /* VmaBlockMetadata_TLSF::CheckCorruption(void const*) */ undefined8 VmaBlockMetadata_TLSF::CheckCorruption(void *param_1)

{
  return 0;
} /* VmaBlockMetadata_Linear::GetAllocationListBegin() const */ undefined8 VmaBlockMetadata_Linear::GetAllocationListBegin(void)

{
  return 0;
} /* VmaBlockMetadata_Linear::GetNextAllocation(VmaAllocHandle_T*) const */ undefined8 VmaBlockMetadata_Linear::GetNextAllocation(VmaAllocHandle_T *param_1)

{
  return 0;
} /* VmaBlockMetadata_Linear::GetNextFreeRegionSize(VmaAllocHandle_T*) const */ undefined8 VmaBlockMetadata_Linear::GetNextFreeRegionSize(VmaAllocHandle_T *param_1)
...
{
  undefined8 uVar1;
  undefined8 uVar2; uVar2 = *(undefined8 *)(param_1 + 8);
  uVar1 = *(undefined8 *)(param_1 + 0x28);
  *(undefined8 *)param_2 = *(undefined8 *)param_1;
  *(undefined8 *)(param_2 + 8) = uVar2;
  *(undefined8 *)(param_2 + 0x10) = uVar1;
  return;
} /* VmaBlockMetadata_TLSF::GetAllocationUserData(VmaAllocHandle_T*) const */ undefined8 __thiscall
...

{
  ...
  return lVar1;
} /* VmaBlockMetadata_TLSF::GetNextAllocation(VmaAllocHandle_T*) const */ void __thiscall
...

{
  ...
  return;
} /* VmaBlockMetadata_TLSF::GetNextFreeRegionSize(VmaAllocHandle_T*) const */ undefined8 __thiscall
...

{
  ...
  return uVar2;
} /* VmaBlockMetadata_TLSF::SetAllocationUserData(VmaAllocHandle_T*, void*) */ void __thiscall
...

{
  *(void **)(param_1 + 0x28) = param_2;
  return;
} /* VmaBlockMetadata_TLSF::AddStatistics(VmaStatistics&) const */ void __thiscall
...

{
  ...
  *(long *)(param_1 + 0x10) = *(long *)(param_1 + 0x10) + (lVar2 - lVar4);
  return;
   ...
   VmaSuballocationOffsetLess const&) [clone .isra.0] */ VmaSuballocation * VmaBinaryFindSorted<VmaSuballocationOffsetLess,VmaSuballocation*,VmaSuballocation>(VmaSuballocation * *param_1, VmaSuballocation * *param_2, VmaSuballocation * param_3, VmaSuballocationOffsetLess * param_4) * pVVar1(long) - (long)param_1 >> 5(uVar4 = uVar2, uVar3 < uVar4) = ( uVar4 - uVar3 >> 1 ) + uVar3(param_1[uVar2 * 4] < param_3) = uVar2 + 1(VmaSuballocation * )(param_1 + uVar3 * 4)(( (VmaSuballocation*)param_2 != pVVar1 ) && ( *(VmaSuballocation**)pVVar1 != param_3 )) = (VmaSuballocation*)param_2 * this, VmaAllocator_T *param_1, uint param_2){int iVar1;
  uint uVar2;
  ...
  if (*param_1 == (VmaAllocator_T)0x0) {
  ...
  }else{__mutex = (pthread_mutex_t *)(this + 0x20);
    ...
    uVar2 = *(uint *)(this + 0x54);
    if (uVar2 < param_2) gotoLAB_0010093c;} * (int*)( this + 0x50 ) * (uint*)( this + 0x54 ) = uVar2 - param_2(( uVar2 - param_2 ) + iVar1 == 0) * (undefined8*)( this + 0x58 ) = 0(**(code**)( param_1 + 0x1680 ))(*(undefined8*)( param_1 + 0x10 ), *(undefined8*)( this + 0x18 )) * (int*)( this + 0x50 );} = *(uint*)( this + 0x4c ) ); if(iVar1 == 0) * (uint*)( this + 0x4c ) = uVar2 + 1(*(uint*)( this + 0x48 ) < uVar2) * (uint*)( this + 0x48 ) = *(uint*)( this + 0x48 ) + 1(uVar2 != 0) * (ulong*)( this + 0x48 ) = CONCAT44(_LC0._4_4_ + (int)( ( ulong ) * (undefined8*)( this + 0x48 ) >> 0x20 ), (int)_LC0 + (int)*(undefined8*)( this + 0x48 ))(__mutex == (pthread_mutex_t*)0x0)) ;;
      return;
   }
   ...
   void std::__insertion_sort<VmaDeviceMemoryBlock**,__gnu_cxx::__ops::_Iter_comp_iter<VmaBlockVector::SortByFreeSize()::_lambda(VmaDeviceMemoryBlock*,VmaDeviceMemoryBlock*)_1_>>(undefined8 *param_1, undefined8 *param_2) {
      undefined8 uVar1;
      undefined8 *puVar2;
      undefined8 *puVar3;
      ulong uVar4;
   ...
   __gnu_cxx::__ops::_Iter_comp_iter<VmaBlockVector::SortByFreeSize()::{lambda(VmaDeviceMemoryBlock*,
   VmaDeviceMemoryBlock*)#1}>) */
   void std::__adjust_heap<VmaDeviceMemoryBlock**,long,VmaDeviceMemoryBlock*,__gnu_cxx::__ops::_Iter_comp_iter<VmaBlockVector::SortByFreeSize()::_lambda(VmaDeviceMemoryBlock*,VmaDeviceMemoryBlock*)_1_>>(long param_1, long param_2, ulong param_3, undefined8 *param_4) {
      undefined8 *puVar1;
      long lVar2;
      long lVar3;
      ulong uVar4;
      ...
      if (param_2 < lVar2) {
         ...
         LAB_00100c20:if ((long)( param_3 - 2 ) / 2 == lVar7) {
            lVar6 = lVar7 * 2;
            lVar7 = lVar6 + 1;
      ...
      LAB_00100bed:*puVar8 = param_4;
      return;
   }
   /* VmaDeviceMemoryBlock::Map(VmaAllocator_T*, unsigned int, void**) [clone .part.0] */
   int VmaDeviceMemoryBlock::Map(VmaDeviceMemoryBlock *this, VmaAllocator_T *param_1, uint param_2, void **param_3) {
      uint uVar1;
      int iVar2;
      int iVar3;
      pthread_mutex_t *__mutex;
      if (*param_1 == (VmaAllocator_T)0x0) {
         ...
         LAB_00100ca9:iVar2 = ( **(code**)( param_1 + 0x1678 ) )(*(undefined8*)( param_1 + 0x10 ), *(undefined8*)( this + 0x18 ), 0, 0xffffffffffffffff, 0, this + 0x58);
         ...
         if (*(int*)( this + 0x50 ) == 0) {
            ...
            *(ulong*)( this + 0x48 ) = CONCAT44(_LC0._4_4_ + (int)( ( ulong ) * (undefined8*)( this + 0x48 ) >> 0x20 ), (int)_LC0 + (int)*(undefined8*)( this + 0x48 ));
         }
         *(uint*)( this + 0x54 ) = param_2;
         ...
         LAB_00100d18:*param_3 = *(void**)( this + 0x58 );
      } else {
         ...
         LAB_00100cf7:uVar1 = *(uint*)( this + 0x4c );
         if (iVar3 == 0) {
            *(uint*)( this + 0x4c ) = uVar1 + 1;
            if (6 < uVar1 + 1) {
               *(undefined4*)( this + 0x50 ) = 1;
      ...
      iVar2 = 0;
      LAB_00100ccd:if (__mutex != (pthread_mutex_t*)0x0) {
         pthread_mutex_unlock(__mutex);
      }
      return iVar2;
   }
   /* VmaBlockMetadata_TLSF::AddDetailedStatistics(VmaDetailedStatistics&) const */
   void VmaBlockMetadata_TLSF::AddDetailedStatistics(VmaBlockMetadata_TLSF *this, VmaDetailedStatistics *param_1) {
      ulong uVar1;
      long lVar2;
      ulong uVar3;
   ...
   void VmaBlockMetadata_Linear::AddDetailedStatistics(VmaBlockMetadata_Linear *this, VmaDetailedStatistics *param_1) {
      int iVar1;
      ulong uVar2;
      ulong uVar3;
      ulong uVar4;
      ...
      *(ulong*)( param_1 + 8 ) = *(long*)( param_1 + 8 ) + uVar11;
      if (iVar1 == 1) {
         ...
         if (uVar10 != 0) {
            do {
               if (uVar3 <= uVar5) {
                  LAB_001011a8:*(int*)( param_1 + 0x18 ) = *(int*)( param_1 + 0x18 ) + 1;
      ...
      do {
         if (uVar4 <= uVar2) {
            LAB_00100fc0:*(int*)( param_1 + 0x18 ) = *(int*)( param_1 + 0x18 ) + 1;
            uVar9 = uVar10 - uVar9;
      ...
      LAB_001010b0:uVar11 = uVar11 - uVar9;
      *(int*)( param_1 + 0x18 ) = *(int*)( param_1 + 0x18 ) + 1;
      uVar4 = *(ulong*)( param_1 + 0x30 );
   ...
   __gnu_cxx::__ops::_Iter_comp_iter<VmaBlockVector::SortByFreeSize()::{lambda(VmaDeviceMemoryBlock*,
   VmaDeviceMemoryBlock*)#1}>) */
   void std::__introsort_loop<VmaDeviceMemoryBlock**,long,__gnu_cxx::__ops::_Iter_comp_iter<VmaBlockVector::SortByFreeSize()::_lambda(VmaDeviceMemoryBlock*,VmaDeviceMemoryBlock*)_1_>>(undefined8 *param_1, undefined8 *param_2, long param_3) {
      undefined8 *puVar1;
      undefined8 *puVar2;
      undefined8 uVar3;
      long lVar4;
      ...
      if (0x80 < lVar4) {
         if (param_3 != 0) {
            ...
            do {
               ...
               __introsort_loop<VmaDeviceMemoryBlock**,long,__gnu_cxx::__ops::_Iter_comp_iter<VmaBlockVector::SortByFreeSize()::_lambda(VmaDeviceMemoryBlock*,VmaDeviceMemoryBlock*)_1_>>(param_2, puVar10, local_48);
               lVar4 = (long)param_2 - (long)param_1;
               if (lVar4 < 0x81) {
                  return;
               }
         ...
         for (lVar8 = ( lVar4 >> 3 ) + -2 >> 1; __adjust_heap<VmaDeviceMemoryBlock**,long,VmaDeviceMemoryBlock*,__gnu_cxx::__ops::_Iter_comp_iter<VmaBlockVector::SortByFreeSize()::_lambda(VmaDeviceMemoryBlock*,VmaDeviceMemoryBlock*)_1_>>(param_1, lVar8, lVar4 >> 3, param_1[lVar8]),lVar8 != 0; lVar8 = lVar8 + -1) {}
         do {
            param_2 = param_2 + -1;
            uVar3 = *param_2;
            *param_2 = *param_1;
            __adjust_heap<VmaDeviceMemoryBlock**,long,VmaDeviceMemoryBlock*,__gnu_cxx::__ops::_Iter_comp_iter<VmaBlockVector::SortByFreeSize()::_lambda(VmaDeviceMemoryBlock*,VmaDeviceMemoryBlock*)_1_>>(param_1, 0, (long)param_2 - (long)param_1 >> 3, uVar3);
         } while ( 8 < (long)param_2 - (long)param_1 );
      }
      return;
   }
   /* VmaBufferImageUsage::VmaBufferImageUsage(VkBufferCreateInfo const&, bool) */
   void VmaBufferImageUsage::VmaBufferImageUsage(VmaBufferImageUsage *this, VkBufferCreateInfo *param_1, bool param_2) {
      int *piVar1;
      if (param_2) {
   ...
   void VmaBufferImageUsage::VmaBufferImageUsage(VmaBufferImageUsage *this, VkImageCreateInfo *param_1) {
      *(ulong*)this = ( ulong ) * (uint*)( param_1 + 0x38 );
      return;
   }
   /* VmaJsonWriter::VmaJsonWriter(VkAllocationCallbacks const*, VmaStringBuilder&) */
   void VmaJsonWriter::VmaJsonWriter(VmaJsonWriter *this, VkAllocationCallbacks *param_1, VmaStringBuilder *param_2) {
   ...
   void VmaJsonWriter::~VmaJsonWriter(VmaJsonWriter *this) {
      undefined8 *puVar1;
   ...
   void VmaDedicatedAllocationList::~VmaDedicatedAllocationList(VmaDedicatedAllocationList *this) {
      return;
   }
   /* VmaDedicatedAllocationList::Validate() */
   ulong VmaDedicatedAllocationList::Validate(VmaDedicatedAllocationList *this) {
      long lVar1;
      int iVar2;
      long lVar3;
      long lVar4;
      ...
      LAB_001015d1:return uVar5 & 0xffffffff;
   }
   /* VmaDedicatedAllocationList::AddDetailedStatistics(VmaDetailedStatistics&) */
   void VmaDedicatedAllocationList::AddDetailedStatistics(VmaDedicatedAllocationList *this, VmaDetailedStatistics *param_1) {
      int iVar1;
      ulong uVar2;
      int iVar3;
      ulong uVar4;
   ...
   void VmaDedicatedAllocationList::AddStatistics(VmaDedicatedAllocationList *this, VmaStatistics *param_1) {
      long *plVar1;
      int iVar2;
      long lVar3;
      pthread_rwlock_t *__rwlock;
      ...
      lVar3 = *(long*)( this + 0x40 );
      *(ulong*)param_1 = CONCAT44((int)( ( ulong ) * (undefined8*)param_1 >> 0x20 ) + *(int*)( this + 0x50 ), (int)*(undefined8*)param_1 + *(int*)( this + 0x50 ));
      if (lVar3 != 0) {
   ...
   ulong VmaDedicatedAllocationList::IsEmpty(VmaDedicatedAllocationList *this) {
      long lVar1;
      int iVar2;
      undefined7 uVar3;
   ...
   void VmaDedicatedAllocationList::Register(VmaDedicatedAllocationList *this, VmaAllocation_T *param_1) {
      long lVar1;
      int iVar2;
      long lVar3;
      if (*this == (VmaDedicatedAllocationList)0x0) {
   ...
   void VmaDedicatedAllocationList::Unregister(VmaDedicatedAllocationList *this, VmaAllocation_T *param_1) {
      long lVar1;
      long lVar2;
      undefined8 uVar3;
      int iVar4;
   ...
   void VmaBlockMetadata::VmaBlockMetadata(VmaBlockMetadata *this, VkAllocationCallbacks *param_1, ulong param_2, bool param_3) {
      *(undefined8*)( this + 8 ) = 0;
   ...
   void VmaBlockBufferImageGranularity::VmaBlockBufferImageGranularity(VmaBlockBufferImageGranularity *this, ulong param_1) {
      *(ulong*)this = param_1;
      *(undefined4*)( this + 8 ) = 0;
      *(undefined8*)( this + 0x10 ) = 0;
      return;
   ...
   void VmaBlockBufferImageGranularity::~VmaBlockBufferImageGranularity(VmaBlockBufferImageGranularity *this) {
      return;
   }
   /* VmaBlockBufferImageGranularity::Init(VkAllocationCallbacks const*, unsigned long) */
   void VmaBlockBufferImageGranularity::Init(VmaBlockBufferImageGranularity *this, VkAllocationCallbacks *param_1, ulong param_2) {
      ulong uVar1;
      ulong uVar2;
      ulong uVar3;
      void *__s;
   ...
   void VmaBlockBufferImageGranularity::Destroy(VmaBlockBufferImageGranularity *this, VkAllocationCallbacks *param_1) {
      void *__ptr;
   ...
   unsigned long&) const */
   void VmaBlockBufferImageGranularity::RoundupAllocRequest(VmaBlockBufferImageGranularity *this, uint param_2, ulong *param_3, ulong *param_4) {
      ulong uVar1;
      ulong uVar2;
      uVar1 = *(ulong*)this;
   ...
   ulong VmaBlockBufferImageGranularity::CheckConflictAndAlignUp(VmaBlockBufferImageGranularity *this, ulong *param_1, long param_2, long param_3, ulong param_4, uint param_6) {
      byte *pbVar1;
      byte bVar2;
      ulong uVar3;
      long lVar4;
...
switchD_00101b98_caseD_1:
    ...
    *param_1 = uVar9;
    ...
    if (uVar6 == 5) goto switchD_00101b98_caseD_1;
      ...
      switchD_00101b98_caseD_0:uVar9 = ( uVar3 - 1 ) + param_2 & uVar9;
      LAB_00101b16:uVar9 = uVar9 >> ( bStack_34 & 0x3f );
      iVar8 = (int)uVar9;
      LAB_00101b23:if (( iVar12 == iVar8 ) || ( pbVar1 = (byte*)( lVar4 + ( uVar9 & 0xffffffff ) * 4 ) * (short*)( pbVar1 + 2 ) == 0 )) {
         switchD_00101b60_caseD_0:uVar7 = 0;
      } else {
         bVar2 = *pbVar1;
         uVar7 = (ulong)bVar2;
         if ((int)(uint)bVar2 <= (int)param_6) {
...
switchD_00101b60_caseD_1:
   ...
   void VmaBlockBufferImageGranularity::AllocPages(VmaBlockBufferImageGranularity *this, uchar param_1, ulong param_2, ulong param_3) {
      uchar *puVar1;
      long lVar2;
      long lVar3;
      ulong uVar4;
   ...
   void VmaBlockBufferImageGranularity::FreePages(VmaBlockBufferImageGranularity *this, ulong param_1, ulong param_2) {
      short *psVar1;
      undefined1 *puVar2;
      long lVar3;
      long lVar4;
   ...
   void VmaBlockBufferImageGranularity::Clear(VmaBlockBufferImageGranularity *this) {
   ...
   VmaBlockBufferImageGranularity::StartValidation(VmaBlockBufferImageGranularity *this, VkAllocationCallbacks *param_1, bool param_2) {
      void *pvVar1;
      size_t __n;
   ...
   undefined8 VmaBlockBufferImageGranularity::Validate(VmaBlockBufferImageGranularity *this, ValidationContext *param_1, ulong param_2, ulong param_3) {
      short *psVar1;
      long lVar2;
      long lVar3;
      long lVar4;
   ...
   const */
   undefined8 VmaBlockBufferImageGranularity::FinishValidation(VmaBlockBufferImageGranularity *this, ValidationContext *param_1) {
      void *__ptr;
      undefined8 *puVar1;
      ulong uVar2;
      if (*(ulong*)this < 0x101) {
      ...
      LAB_00101f2d:*(undefined8*)( param_1 + 8 ) = 0;
      return 1;
   }
   /* VmaBlockBufferImageGranularity::OffsetToPageIndex(unsigned long) const */
   ulong VmaBlockBufferImageGranularity::OffsetToPageIndex(VmaBlockBufferImageGranularity *this, ulong param_1) {
      ulong uVar1;
      long lVar2;
      ulong uVar3;
      uVar1 = *(ulong*)this;
   ...
   char) */
   void VmaBlockBufferImageGranularity::AllocPage(VmaBlockBufferImageGranularity *this, RegionInfo *param_1, uchar param_2) {
   ...
   bool) */
   void VmaBlockMetadata_Linear::VmaBlockMetadata_Linear(VmaBlockMetadata_Linear *this, VkAllocationCallbacks *param_1, ulong param_2, bool param_3) {
      *(undefined8*)( this + 8 ) = 0;
      *(VkAllocationCallbacks**)( this + 0x10 ) = param_1;
      *(ulong*)( this + 0x18 ) = param_2;
   ...
   ulong * VmaBlockMetadata_Linear::FindSuballocation(VmaBlockMetadata_Linear * this, ulong, param_1);
   {
      long lVar1;
      long lVar2;
   ...
   void VmaBlockMetadata_Linear::GetAllocationInfo(VmaBlockMetadata_Linear *this, VmaAllocHandle_T *param_1, VmaVirtualAllocationInfo *param_2) {
      undefined8 uVar1;
      long lVar2;
   ...
   undefined8 VmaBlockMetadata_Linear::GetAllocationUserData(VmaBlockMetadata_Linear *this, VmaAllocHandle_T *param_1) {
      long lVar1;
   ...
   void VmaBlockMetadata_Linear::SetAllocationUserData(VmaBlockMetadata_Linear *this, VmaAllocHandle_T *param_1, void *param_2) {
      long lVar1;
      lVar1 = FindSuballocation(this, ( ulong )(param_1 + -1));
   ...
   ulong VmaBlockMetadata_Linear::ShouldCompact1st(VmaBlockMetadata_Linear *this) {
      ...
      if (0x20 < *(ulong*)( pVVar1 + 0x10 )) {
         ...
         uVar3 = CONCAT71(( int7 )((ulong)lVar2 >> 8), ( *(ulong*)( pVVar1 + 0x10 ) - lVar2 ) * 3 <= ( ulong )(lVar2 * 2));
      }
      return uVar3 & 0xffffffff;
   }
   ...
   undefined8 VmaBlockMetadata_Linear::CreateAllocationRequest_LowerAddress(VmaBlockMetadata_Linear *this, ulong param_1, ulong param_2, int param_4, undefined8 param_5, long *param_6) {
      long *plVar1;
      uint uVar2;
      ulong uVar3;
      int iVar4;
      ...
      if (( uVar2 & 0xfffffffd ) == 0) {
         ...
         if (uVar13 != 0) {
            ...
            if (( 1 < uVar3 ) && ( param_2 != uVar3 )) {
               ...
               uVar9 = uVar13;
               LAB_001022e0:if (( ( ( *(long*)( lVar11 + -0x20 ) + *(long*)( lVar11 + -0x18 ) ) - 1U ^ uVar10 ) & -uVar3 ) == 0) {
                  iVar6 = *(int*)( lVar11 + -8 );
                  iVar12 = iVar6;
                  iVar4 = param_4;
                  if (iVar6 <= param_4) {
...
switchD_00102316_caseD_1:
         ...
         LAB_00102340:uVar9 = uVar10 + param_1;
         if (uVar2 == 2) {
...
LAB_00102687:
         ...
         uVar13 = *(ulong*)( pVVar14 + 0x10 );
         LAB_0010238f:lVar11 = *(long*)( pVVar15 + 0x10 );
         uVar10 = param_2 - 1 & -param_2;
         if (lVar11 != 0) {
            ...
            if (( 1 < uVar3 ) && ( param_2 != uVar3 )) {
               lVar8 = *(long*)( pVVar15 + 8 ) + lVar11 * 0x20;
               LAB_001023e8:if (( ( ( *(long*)( lVar8 + -0x20 ) + *(long*)( lVar8 + -0x18 ) ) - 1U ^ uVar10 ) & -uVar3 ) == 0) {
                  iVar6 = *(int*)( lVar8 + -8 );
                  iVar12 = iVar6;
                  iVar4 = param_4;
                  if (iVar6 <= param_4) {
...
switchD_00102415_caseD_1:
         ...
         LAB_00102440:uVar9 = *(ulong*)( this + 0x78 );
         if (uVar9 == uVar13) {
            if (*(ulong*)( this + 8 ) < param_1 + uVar10) {
               LAB_0010261c:return 0;
            }
         } else {
            if (uVar13 <= uVar9) {
               return 0;
...
LAB_001025e7:
      ...
      *(undefined4*)( param_6 + 6 ) = uVar5;
      return 1;
      switchD_00102316_caseD_0:LAB_00102328:lVar11 = lVar11 + -0x20;
      uVar9 = uVar9 - 1;
      if (uVar9 == 0) goto LAB_00102340;
      goto LAB_001022e0;
      switchD_00102415_caseD_0:LAB_001025c8:lVar11 = lVar11 + -1;
      lVar8 = lVar8 + -0x20;
   ...
   VmaSuballocationType, unsigned int, VmaAllocationRequest*) */
   undefined4 VmaBlockMetadata_Linear::CreateAllocationRequest_UpperAddress(VmaBlockMetadata_Linear *this, ulong param_1, ulong param_2, int param_4, undefined8 param_5, long *param_6) {
      ulong uVar1;
      int iVar2;
      int iVar3;
      int iVar4;
      ...
      if (bVar9) {
         ...
         if (lVar7 == 0) {
            ...
            if (( param_2 != uVar1 ) && ( 1 < uVar1 )) {
               LAB_001027ff:lVar7 = *(long*)( pVVar6 + 0x10 );
               joined_r0x00102970:if (( lVar7 != 0 ) && ( plVar5 = (long*)( *(long*)( pVVar6 + 8 ) + -0x20 + lVar7 * 0x20 ) ),uVar8 < ( ulong )(plVar5[1] + *plVar5)) {
                  return uVar10;
               }
               goto LAB_00102824;
            }
            ...
            if (( param_2 != uVar1 ) && ( 1 < uVar1 )) {
               ...
               LAB_001027a8:if (( ( *(ulong*)( lVar12 + -0x20 ) ^ ( uVar8 - 1 ) + param_1 ) & -uVar1 ) == 0) {
                  iVar3 = *(int*)( lVar12 + -8 );
                  iVar4 = iVar3;
                  iVar2 = param_4;
                  if (iVar3 <= param_4) {
...
switchD_001027d2_caseD_1:
         ...
         lVar7 = *(long*)( pVVar6 + 0x10 );
         if (( lVar7 == 0 ) || ( plVar5 = (long*)( *(long*)( pVVar6 + 8 ) + -0x20 + lVar7 * 0x20 )(ulong)(plVar5[1] + *plVar5) <= uVar8 )) {
            if (uVar1 < 2) {
               LAB_0010289a:*(undefined4*)( param_6 + 6 ) = 2;
               *param_6 = uVar8 + 1;
               return 1;
            }
            LAB_00102824:lVar7 = lVar7 + -1;
            LAB_00102832:while (( lVar7 != -1 && ( plVar5 = (long*)( lVar7 * 0x20 + *(long*)( pVVar6 + 8 ) )(( ( *plVar5 + plVar5[1] ) - 1U ^ uVar8 ) & -uVar1) == 0 ) )) {
               iVar3 = (int)plVar5[3];
               iVar4 = param_4;
               if (param_4 <= iVar3) {
                  iVar4 = iVar3;
      ...
      switchD_0010286f_caseD_1:return uVar10;
      switchD_001027d2_caseD_0:LAB_00102920:lVar12 = lVar12 + -0x20;
      lVar7 = lVar7 + -1;
      if (lVar7 == 0) goto LAB_001027ff;
      goto LAB_001027a8;
      code_r0x001028ed:lVar7 = lVar7 + -1;
      goto LAB_00102832;
   }
   /* VmaBlockMetadata_Linear::CreateAllocationRequest(unsigned long, unsigned long, bool,
   VmaSuballocationType, unsigned int, VmaAllocationRequest*) */
   undefined8 VmaBlockMetadata_Linear::CreateAllocationRequest(VmaBlockMetadata_Linear *this, ulong param_1, undefined8 param_3_00, char param_3, undefined8 param_5, undefined8 param_6, long param_7) {
      undefined8 uVar1;
    ...
    */
   void VmaBlockMetadata_TLSF::VmaBlockMetadata_TLSF(VmaBlockMetadata_TLSF *this, VkAllocationCallbacks *param_1, ulong param_2, bool param_3) {
      *(undefined8*)( this + 8 ) = 0;
      *(VkAllocationCallbacks**)( this + 0x10 ) = param_1;
      *(ulong*)( this + 0x18 ) = param_2;
   ...
   int VmaBlockMetadata_TLSF::SizeToMemoryClass(VmaBlockMetadata_TLSF *this, ulong param_1) {
      long lVar1;
      int iVar2;
      iVar2 = 0;
      if (0x100 < param_1) {
   ...
   ulong VmaBlockMetadata_TLSF::SizeToSecondIndex(VmaBlockMetadata_TLSF *this, ulong param_1, uchar param_2) {
      if (param_2 != '\0') {
   ...
   uint VmaBlockMetadata_TLSF::GetListIndex(VmaBlockMetadata_TLSF *this, uchar param_1, ushort param_2) {
      uint uVar1;
      int iVar2;
      uVar1 = (uint)param_2;
      if (param_1 != '\0') {
   ...
   ulong VmaBlockMetadata_TLSF::GetListIndex(VmaBlockMetadata_TLSF *this, ulong param_1) {
      long lVar1;
      ulong uVar2;
      int iVar3;
      uint uVar4;
      ...
      iVar3 = ( ( 0x38 - uVar4 & 0xff ) - 1 ) * 0x20 + ( ( ( uint )(param_1 >> ( 0x3aU - (char)uVar4 & 0x3f )) ^ 0x20 ) & 0xffff );
      uVar4 = iVar3 + 0x20;
      if (this[0x20] == (VmaBlockMetadata_TLSF)0x0) {
         uVar4 = iVar3 + 4;
      }
   ...
   undefined8 VmaBlockMetadata_TLSF::Validate(VmaBlockMetadata_TLSF *this) {
      ...
      if (uVar9 <= *(ulong*)( this + 8 )) {
         ...
         if (*(uint*)( this + 0x130 ) != 0) {
            ...
            do {
               ...
               if (lVar10 != 0) {
                  local_58 = auVar3;
                  if (( *(long*)( lVar10 + 0x20 ) != 0 ) || ( local_58 = lVar10 == 0 )) goto LAB_00102ce8;
                  while (lVar2 = *(long*)( lVar10 + 0x28 ),lVar2 != 0) {
                     local_58 = auVar5;
                     if (( lVar10 != *(long*)( lVar2 + 0x20 ) ) || ( lVar10 = lVar2 ),local_58 = auVar4,lVar2 == *(long*)( lVar2 + 0x20 )) goto LAB_00102ce8;
                  };
               }
               plVar15 = plVar15 + 1;
         ...
         local_58 = VmaBlockBufferImageGranularity::StartValidation(this_00, *(VkAllocationCallbacks**)( this + 0x10 ), (bool)this[0x20]);
         ...
         if (*(long*)( uVar12 + 0x18 ) == 0) {
            ...
            if (puVar17 == (ulong*)0x0) {
               local_68 = 0;
               local_60 = 0;
               LAB_00102da9:if (this[0x20] == (VmaBlockMetadata_TLSF)0x0) {
                  cVar7 = VmaBlockBufferImageGranularity::FinishValidation(this_00, (ValidationContext*)local_58);
               ...
               do {
                  ...
                  if ((ulong*)puVar17[4] == puVar17) {
                     ...
                     if (this[0x20] == (VmaBlockMetadata_TLSF)0x0) {
                        cVar7 = VmaBlockBufferImageGranularity::Validate(this_00, (ValidationContext*)local_58, uVar14, uVar16);
                        if (cVar7 == '\0') break;
                     }
                     local_60 = local_60 + 1;
                  } else {
      ...
      LAB_00102ce8:uVar13 = 0;
      LAB_00102cea:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return uVar13;
      }
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   ...
   void VmaBlockMetadata_TLSF::RemoveFreeBlock(VmaBlockMetadata_TLSF *this, Block *param_1) {
      int iVar1;
         ...
         if (lVar8 == 0) {
            ...
            *(uint*)pVVar2 = *(uint*)pVVar2 & ( -2 << bVar5 | 0xfffffffeU >> 0x20 - bVar5 );
            if (*(uint*)pVVar2 == 0) {
               ...
               *(uint*)( this + 0x40 ) = *(uint*)( this + 0x40 ) & ( ( uint )(-2L << bVar5) | ( uint )(0xfffffffffffffffe >> 0x40 - bVar5) );
            }
         }
      } else {
   ...
   void VmaBlockMetadata_TLSF::InsertFreeBlock(VmaBlockMetadata_TLSF *this, Block *param_1) {
      undefined8 *puVar1;
      ulong uVar2;
      long lVar3;
      ushort uVar4;
      ...
      *(uint*)( this + (long)(int)uVar9 * 4 + 0x48 ) = *(uint*)( this + (long)(int)uVar9 * 4 + 0x48 ) | 1 << ( (byte)uVar5 & 0x1f );
      *(long*)( this + 0x30 ) = *(long*)( this + 0x30 ) + 1;
   ...
   undefined8 VmaBlockMetadata_TLSF::FindFreeBlock(VmaBlockMetadata_TLSF *this, ulong param_1, uint *param_2) {
      long lVar1;
      byte bVar2;
      int iVar3;
      byte bVar4;
   ...
   undefined8 VmaBlockMetadata_TLSF::CheckBlock(VmaBlockMetadata_TLSF *this, long *param_1, uint param_2, long param_3, long param_4, uint param_6, undefined8 *param_7) {
      long *plVar1;
      long lVar2;
      char cVar3;
      undefined8 uVar4;
      ...
      if (( (ulong)param_1[1] < ( param_3 - *param_1 ) + local_48 ) || ( ( this[0x20] == (VmaBlockMetadata_TLSF)0x0 && ( cVar3 = VmaBlockBufferImageGranularity::CheckConflictAndAlignUp((VmaBlockBufferImageGranularity*)( this + 0x178 ), &local_48, param_3) ),cVar3 != '\0' ) )) {
         uVar4 = 0;
      } else {
   ...
   VmaSuballocationType, unsigned int, VmaAllocationRequest*) */
   ulong VmaBlockMetadata_TLSF::CreateAllocationRequest(VmaBlockMetadata_TLSF *this, ulong param_1, undefined8 param_2, undefined8 param_4, undefined4 param_5, ulong param_6, undefined8 param_7) {
      uint uVar1;
      undefined8 *puVar2;
      undefined8 uVar3;
      uint uVar4;
      ...
      local_50 = param_1;
      if (this[0x20] == (VmaBlockMetadata_TLSF)0x0) {
         VmaBlockBufferImageGranularity::RoundupAllocRequest((VmaBlockBufferImageGranularity*)( this + 0x178 ), param_5, &local_50, &local_58);
      }
      uVar11 = local_50;
      if (*(code**)( *(long*)this + 0x30 ) == GetSumFreeSize) {
      ...
      if (uVar11 <= uVar8) {
         ...
         if (( param_6 & 0x20000 ) != 0) {
            ...
            if (lVar9 == 0) {
               ...
               cVar5 = CheckBlock();
               if (( cVar5 == '\0' ) && ( cVar5 = CheckBlock(this, *(undefined8*)( this + 0x170 ), uVar1, uVar11, uVar3, param_5, param_7) ),cVar5 == '\0') {
                  do {
                     cVar5 = CheckBlock(this, lVar9, uVar4, uVar11, uVar3, param_5, param_7);
                     if (cVar5 != '\0') goto LAB_00103590;
                     lVar9 = *(long*)( lVar9 + 0x28 );
                  } while ( lVar9 != 0 );
                  LAB_00103910:lVar9 = FindFreeBlock(this, uVar11, &uStack_44);
                  uVar4 = uStack_44;
         ...
         if (( param_6 & 0x10000 ) == 0) {
            if (( param_6 & 0x40000 ) != 0) {
               ...
               LAB_00103438:if (( puVar2 == (undefined8*)0x0 ) || ( (code*)puVar2[3] == (code*)0x0 )) {
                  free(pvStack_68);
                  uVar11 = (ulong)bVar6;
               } else {
            ...
            LAB_00103860:pvStack_68._0_4_ = uStack_48;
         } else {
            lVar9 = FindFreeBlock(this, uVar11, &uStack_44);
            uVar4 = uStack_44;
            for (; lVar9 != 0; lVar9 = *(long*)( lVar9 + 0x28 )) {
         ...
         if (uStack_48 < uVar1) {
            ...
            do {
               uVar4 = uStack_48;
               for (lVar10 = *(long*)( lVar9 + (ulong)uStack_48 * 8 ); lVar10 != 0; lVar10 = *(long*)( lVar10 + 0x28 )) {
      ...
      uVar11 = 0;
      LAB_00103495:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Subroutine does not return */
         __stack_chk_fail();
      }
      return uVar11;
   ...
   void VmaCurrentBudgetData::VmaCurrentBudgetData(VmaCurrentBudgetData *this) {
   ...
   void VmaCurrentBudgetData::AddAllocation(VmaCurrentBudgetData *this, uint param_1, ulong param_2) {
      LOCK();
      *(ulong*)( this + ( (ulong)param_1 + 0x20 ) * 8 ) = *(long*)( this + ( (ulong)param_1 + 0x20 ) * 8 ) + param_2;
      UNLOCK();
      LOCK();
   ...
   void VmaCurrentBudgetData::RemoveAllocation(VmaCurrentBudgetData *this, uint param_1, ulong param_2) {
      LOCK();
      *(ulong*)( this + ( (ulong)param_1 + 0x20 ) * 8 ) = *(long*)( this + ( (ulong)param_1 + 0x20 ) * 8 ) - param_2;
      UNLOCK();
      LOCK();
   ...
   void VmaAllocationObjectAllocator::Free(VmaAllocationObjectAllocator *this, VmaAllocation_T *param_1) {
      long lVar1;
   ...
   void VmaVirtualBlock_T::VmaVirtualBlock_T(VmaVirtualBlock_T *this, VmaVirtualBlockCreateInfo *param_1) {
      undefined8 uVar1;
      long lVar2;
      undefined8 uVar3;
      undefined8 uVar4;
      ...
      *this = ( VmaVirtualBlock_T )(puVar8 != (undefined8*)0x0);
      ...
      if (puVar8 == (undefined8*)0x0) {
         ...
         *(undefined8*)( this + 0x30 ) = uVar6;
         if (( uVar12 & 1 ) != 0) {
            ...
            LAB_00103d80:puVar8 = (undefined8*)aligned_alloc(8, 0x90);
            LAB_00103cc5:puVar8[0xe] = 0;
      ...
      LAB_00103bf0:*(undefined1*)( (long)puVar8 + 0x44 ) = 0;
      ...
      *(undefined8**)( this + 0x38 ) = puVar8;
      puVar8[1] = uVar11;
      if (*(char*)( puVar8 + 4 ) == '\0') {
         VmaBlockBufferImageGranularity::Init((VmaBlockBufferImageGranularity*)( puVar8 + 0x2f ), (VkAllocationCallbacks*)puVar8[2], uVar11);
      }
      pBVar9 = VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>::Alloc<>((VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>*)( puVar8 + 0x28 ));
      puVar8[0x2e] = pBVar9;
      ...
      *(undefined8*)( puVar8[0x2e] + 0x20 ) = 0;
      if (uVar11 < 0x101) {
         ...
         iVar7 = ( 0x38 - uVar12 & 0xff ) * 0x20 + -0x1f + ( ( ( uint )(uVar11 >> ( bVar10 & 0x3f )) ^ 0x20 ) & 0xffff );
      }
      uVar12 = iVar7 + 4;
      if (*(char*)( puVar8 + 4 ) != '\0') {
         uVar12 = iVar7 + 0x20;
      ...
      *(uint*)( puVar8 + 0x26 ) = uVar12;
      ...
      for (uVar11 = ( ulong )(( (int)puVar8 - (int)(undefined8*)( ( ulong )(puVar8 + 10) & 0xfffffffffffffff8 ) ) + 0x130U >> 3); uVar11 != 0; uVar11 = uVar11 - 1) {
         *puVar13 = 0;
   ...
   void VmaVirtualBlock_T::~VmaVirtualBlock_T(VmaVirtualBlock_T *this) {
      undefined8 *__ptr;
      char cVar1;
   ...
   VmaVirtualBlock_T * VmaVirtualBlock_T::GetAllocationCallbacks(VmaVirtualBlock_T * this);
   {
   ...
   void VmaVirtualBlock_T::GetAllocationInfo(VmaVirtualAllocation_T *param_1, VmaVirtualAllocationInfo *param_2) {
   ...
   unsigned long*) */
   undefined8 VmaVirtualBlock_T::Allocate(VmaVirtualBlock_T *this, VmaVirtualAllocationCreateInfo *param_1, VmaVirtualAllocation_T **param_2, ulong *param_3) {
      char cVar1;
      ulong uVar2;
      undefined8 uVar3;
      long lVar4;
      ...
      cVar1 = ( **(code**)( **(long**)( this + 0x38 ) + 0x88 ) )(*(long**)( this + 0x38 ), *(undefined8*)param_1, lVar4, *(uint*)( param_1 + 0x10 ) >> 6 & 1, 1, *(uint*)( param_1 + 0x10 ) & 0x70000, local_68);
      if (cVar1 == '\0') {
         *param_2 = (VmaVirtualAllocation_T*)0x0;
         ...
         ( **(code**)( **(long**)( this + 0x38 ) + 0x98 ) )(*(long**)( this + 0x38 ), local_68, 1, *(undefined8*)( param_1 + 0x18 ));
   ...
   void VmaVirtualBlock_T::GetStatistics(VmaVirtualBlock_T *this, VmaStatistics *param_1) {
      long *plVar1;
   ...
   void VmaVirtualBlock_T::CalculateDetailedStatistics(VmaVirtualBlock_T *this, VmaDetailedStatistics *param_1) {
      long *plVar1;
      long lVar2;
      undefined8 uVar3;
      undefined8 uVar4;
   ...
   void VmaDeviceMemoryBlock::VmaDeviceMemoryBlock(VmaDeviceMemoryBlock *this, VmaAllocator_T *param_1) {
      undefined8 uVar1;
      uVar1 = _LC3;
      *(undefined8*)this = 0;
   ...
   void VmaDeviceMemoryBlock::~VmaDeviceMemoryBlock(VmaDeviceMemoryBlock *this) {
      return;
   }
   ...
   void VmaDeviceMemoryBlock::Init(VmaDeviceMemoryBlock *this, VmaAllocator_T *param_1, VmaPool_T *param_2, uint param_3, VkDeviceMemory_T *param_4, ulong param_5, uint param_6, uint param_7, ulong param_8) {
      undefined8 *puVar1;
   ...
   void VmaDeviceMemoryBlock::PostAlloc(VmaDeviceMemoryBlock *this, VmaAllocator_T *param_1) {
      pthread_mutex_t *__mutex;
      uint uVar1;
      uint uVar2;
      int iVar3;
   ...
   void VmaDeviceMemoryBlock::PostFree(VmaDeviceMemoryBlock *this, VmaAllocator_T *param_1) {
      int iVar1;
      uint uVar2;
      pthread_mutex_t *__mutex;
      if (*param_1 == (VmaAllocator_T)0x0) {
   ...
   undefined8 VmaDeviceMemoryBlock::Validate(VmaDeviceMemoryBlock *this) {
      undefined8 uVar1;
   ...
   int VmaDeviceMemoryBlock::CheckCorruption(VmaDeviceMemoryBlock *this, VmaAllocator_T *param_1) {
      int iVar1;
      long in_FS_OFFSET;
      void *local_28;
      long local_20;
   ...
   undefined8 VmaDeviceMemoryBlock::Map(VmaDeviceMemoryBlock *this, VmaAllocator_T *param_1, uint param_2, void **param_3) {
      undefined8 uVar1;
      if (param_2 != 0) {
   ...
   void VmaDeviceMemoryBlock::Unmap(VmaDeviceMemoryBlock *this, VmaAllocator_T *param_1, uint param_2) {
      if (param_2 != 0) {
   ...
   long) */
   int VmaDeviceMemoryBlock::WriteMagicValueAfterAllocation(VmaAllocator_T *param_1, ulong param_2, ulong param_3) {
      int iVar1;
      long in_FS_OFFSET;
      void *pvStack_28;
      long local_20;
   ...
   long) */
   int VmaDeviceMemoryBlock::ValidateMagicValueAfterAllocation(VmaAllocator_T *param_1, ulong param_2, ulong param_3) {
      int iVar1;
      long in_FS_OFFSET;
      void *pvStack_28;
      long local_20;
   ...
   void VmaAllocation_T::VmaAllocation_T(VmaAllocation_T *this, bool param_1) {
      undefined8 uVar1;
      undefined8 uVar2;
      undefined8 uVar3;
      uVar3 = _UNK_001153a8;
   ...
   void VmaAllocation_T::~VmaAllocation_T(VmaAllocation_T *this) {
      return;
   }
   ...
   void VmaAllocation_T::InitBlockAllocation(VmaAllocation_T *this, undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined4 param_5, VmaAllocation_T param_7, char param_8) {
   ...
   void VmaAllocation_T::InitDedicatedAllocation(VmaAllocation_T *this, undefined8 param_1, undefined4 param_2, undefined8 param_3, VmaAllocation_T param_5, long param_6, undefined8 param_7) {
   ...
   void VmaAllocation_T::SetName(VmaAllocation_T *this, VmaAllocator_T *param_1, char *param_2) {
      size_t sVar1;
      void *pvVar2;
   ...
   VmaAllocation_T VmaAllocation_T::SwapBlockAllocation(VmaAllocation_T *this, VmaAllocator_T *param_1, VmaAllocation_T *param_2) {
      undefined8 uVar1;
      undefined8 uVar2;
      undefined8 uVar3;
      ...
      ( **(code**)( *(long*)**(undefined8**)this + 0xb0 ) )((long*)**(undefined8**)this, *(undefined8*)( this + 8 ), param_2);
      ...
      *(undefined8*)( param_2 + 8 ) = uVar2;
      ( **(code**)( *(long*)**(undefined8**)this + 0xb0 ) )((long*)**(undefined8**)this, *(undefined8*)( this + 8 ), this);
   ...
   undefined8 VmaAllocation_T::GetAllocHandle(VmaAllocation_T *this) {
      undefined8 uVar1;
      uVar1 = 0;
   ...
   undefined8 VmaAllocation_T::GetOffset(VmaAllocation_T *this) {
      code *UNRECOVERED_JUMPTABLE;
      undefined8 uVar1;
      if (this[0x4c] != (VmaAllocation_T)0x1) {
         return 0;
      ...
      /* WARNING: Treating indirect jump as call */
      uVar1 = ( *UNRECOVERED_JUMPTABLE )((long*)**(undefined8**)this, *(undefined8*)( this + 8 ), UNRECOVERED_JUMPTABLE);
      return uVar1;
   }
   /* VmaAllocation_T::GetParentPool() const */
   undefined8 VmaAllocation_T::GetParentPool(VmaAllocation_T *this) {
      if (this[0x4c] == (VmaAllocation_T)0x1) {
   ...
   undefined8 VmaAllocation_T::GetMemory(VmaAllocation_T *this) {
      if (this[0x4c] == (VmaAllocation_T)0x1) {
   ...
   long VmaAllocation_T::GetMappedData(VmaAllocation_T *this) {
      long lVar1;
      long *plVar2;
      long lVar3;
      if (this[0x4c] == (VmaAllocation_T)0x1) {
   ...
   void VmaAllocation_T::BlockAllocMap(VmaAllocation_T *this) {
   ...
   void VmaAllocation_T::BlockAllocUnmap(VmaAllocation_T *this) {
      if (this[0x4e] != (VmaAllocation_T)0x0) {
   ...
   undefined8 VmaAllocation_T::DedicatedAllocMap(VmaAllocation_T *this, VmaAllocator_T *param_1, void **param_2) {
      ...
      if (VVar1 == (VmaAllocation_T)0x0) {
         if (( (byte)this[0x4f] & 1 ) == 0) {
            uVar3 = ( **(code**)( param_1 + 0x1678 ) )(*(undefined8*)( param_1 + 0x10 ), *(undefined8*)( this + 8 ), 0, 0xffffffffffffffff, 0, param_2);
            if ((int)uVar3 != 0) {
               return uVar3;
            }
            pvVar2 = *param_2;
   ...
   void VmaAllocation_T::DedicatedAllocUnmap(VmaAllocation_T *this, VmaAllocator_T *param_1) {
      VmaAllocation_T VVar1;
      if (( ( this[0x4e] != (VmaAllocation_T)0x0 ) && ( VVar1 = ( VmaAllocation_T )((char)this[0x4e] + -1) ),this[0x4e] = VVar1,VVar1 == (VmaAllocation_T)0x0 )) &&( ( (byte)this[0x4f] & 1 ) == 0 ) * (undefined8*)( this + 0x10 ) = 0;
   ...
   return;
}/* VmaAllocation_T::FreeName(VmaAllocator_T*) */void VmaAllocation_T::FreeName(VmaAllocation_T *this, VmaAllocator_T *param_1) {
   void *__ptr;
   ...
   long, unsigned long, unsigned long, bool, unsigned int, float, unsigned long, void*) */void VmaBlockVector::VmaBlockVector(VmaBlockVector *this, VmaAllocator_T *param_1, VmaPool_T *param_2, uint param_3, ulong param_4, ulong param_5, ulong param_6, ulong param_7, bool param_8, uint param_9, float param_10, ulong param_11, void *param_12) {
   ...
   *(undefined1(*) [16])( this + 0xa0 ) = (undefined1[16])0x0;
   return;
}/* VmaBlockVector::AddStatistics(VmaStatistics&) */void VmaBlockVector::AddStatistics(VmaBlockVector *this, VmaStatistics *param_1) {
   long *plVar1;
   int iVar2;
   ulong uVar3;
   ulong uVar4;
   ...
   LAB_00104b1f:pthread_rwlock_unlock(__rwlock);
   return;
}/* VmaBlockVector::AddDetailedStatistics(VmaDetailedStatistics&) */void VmaBlockVector::AddDetailedStatistics(VmaBlockVector *this, VmaDetailedStatistics *param_1) {
   long *plVar1;
   int iVar2;
   ulong uVar3;
   ulong uVar4;
   ...
   LAB_00104bcf:pthread_rwlock_unlock(__rwlock);
   return;
}/* VmaBlockVector::IsEmpty() */ulong VmaBlockVector::IsEmpty(VmaBlockVector *this) {
   long lVar1;
   int iVar2;
   undefined7 uVar3;
   uVar3 = ( undefined7 )((ulong)this >> 8);
   ...
   /* WARNING: Subroutine does not return */
   std::__throw_system_error(0x23);
}/* VmaBlockVector::IsCorruptionDetectionEnabled() const */undefined8 VmaBlockVector::IsCorruptionDetectionEnabled(void) {
   return 0;
}/* VmaBlockVector::CalcMaxBlockSize() const */ulong VmaBlockVector::CalcMaxBlockSize(VmaBlockVector *this) {
   ulong uVar1;
   long lVar2;
   ulong uVar3;
   ...
   return uVar3;
}/* VmaBlockVector::IncrementallySortBlocks() */void VmaBlockVector::IncrementallySortBlocks(VmaBlockVector *this) {
   long lVar1;
   undefined8 uVar2;
   ulong uVar3;
   ulong uVar4;
   ...
   return;
}/* VmaBlockVector::SortByFreeSize() */void VmaBlockVector::SortByFreeSize(VmaBlockVector *this) {
   undefined8 *puVar1;
   undefined8 *puVar2;
   undefined8 *puVar3;
   long lVar4;
   ...
   uVar5 = lVar7 >> 3;
   if (uVar5 == 0) {
      std::__introsort_loop<VmaDeviceMemoryBlock**,long,__gnu_cxx::__ops::_Iter_comp_iter<VmaBlockVector::SortByFreeSize()::_lambda(VmaDeviceMemoryBlock*,VmaDeviceMemoryBlock*)_1_>>(puVar2, puVar1, 0xfffffffffffffffe);
   } else {
      lVar4 = 0x3f;
      if (uVar5 != 0) {
         for (; uVar5 >> lVar4 == 0; lVar4 = lVar4 + -1) {}
      }
      std::__introsort_loop<VmaDeviceMemoryBlock**,long,__gnu_cxx::__ops::_Iter_comp_iter<VmaBlockVector::SortByFreeSize()::_lambda(VmaDeviceMemoryBlock*,VmaDeviceMemoryBlock*)_1_>>(puVar2, puVar1, (long)(int)lVar4 * 2);
      if (0x80 < lVar7) {
         puVar9 = puVar2 + 0x10;
         std::__insertion_sort<VmaDeviceMemoryBlock**,__gnu_cxx::__ops::_Iter_comp_iter<VmaBlockVector::SortByFreeSize()::_lambda(VmaDeviceMemoryBlock*,VmaDeviceMemoryBlock*)_1_>>(puVar2, puVar9);
   ...
   std::__insertion_sort<VmaDeviceMemoryBlock**,__gnu_cxx::__ops::_Iter_comp_iter<VmaBlockVector::SortByFreeSize()::_lambda(VmaDeviceMemoryBlock*,VmaDeviceMemoryBlock*)_1_>>(puVar2, puVar1);
   return;
}/* VmaBlockVector::HasEmptyBlock() */undefined8 VmaBlockVector::HasEmptyBlock(VmaBlockVector *this) {
   long lVar1;
   undefined8 uVar2;
   long lVar3;
   lVar1 = *(long*)( this + 0xa0 );
   ...
   return 0;
}/* VmaBlockVector::CheckCorruption() */undefined8 VmaBlockVector::CheckCorruption(void) {
   return 0xfffffff8;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* VmaDefragmentationContext_T::VmaDefragmentationContext_T(VmaAllocator_T*, VmaDefragmentationInfo
   const&) */void VmaDefragmentationContext_T::VmaDefragmentationContext_T(VmaDefragmentationContext_T *this, VmaAllocator_T *param_1, VmaDefragmentationInfo *param_2) {
   VmaAllocator_T VVar1;
   ...
   *(undefined1(*) [16])( this + 0x88 ) = (undefined1[16])0x0;
   ...
   if (uVar9 != 2) {
      if (uVar9 == 8) {
         ...
         if (*(code**)( param_1 + 0x30 ) == (code*)0x0) {
            ...
            puVar7 = (undefined1*)( **(code**)( param_1 + 0x30 ) )(*(undefined8*)( param_1 + 0x28 ), ( ulong ) * (uint*)( this + 0x50 ) << 4, 8, 1);
         }
         *puVar7 = 1;
   ...
   if (*(code**)( param_1 + 0x30 ) == (code*)0x0) {
      ...
      puVar6 = (undefined8*)( **(code**)( param_1 + 0x30 ) )(*(undefined8*)( param_1 + 0x28 ), ( ulong ) * (uint*)( this + 0x50 ) << 4, 8, 1);
   }
   uVar3 = _UNK_001153b8;
   *puVar6 = __LC8;
   puVar6[1] = uVar3;
   *(undefined8**)( this + 0xa0 ) = puVar6;
   return;
}/* VmaDefragmentationContext_T::~VmaDefragmentationContext_T() */void VmaDefragmentationContext_T::~VmaDefragmentationContext_T(VmaDefragmentationContext_T *this) {
   long *plVar1;
   undefined8 *puVar2;
   long *plVar3;
   if (*(long*)( this + 0x58 ) == 0) {
   ...
   if (( *(void**)( this + 0xa0 ) != (void*)0x0 ) && ( ( *(int*)( this + 0x4c ) == 2 || ( *(int*)( this + 0x4c ) == 8 ) ) )) {
   ...
   free(*(void**)( this + 0x30 ));
   return;
}/* VmaDefragmentationContext_T::GetMoveData(VmaAllocHandle_T*, VmaBlockMetadata*) */VmaDefragmentationContext_T * __thiscall
VmaDefragmentationContext_T::GetMoveData
   ...
   *(uint*)( this + 0x14 ) = uVar4;
   return this;
}/* VmaDefragmentationContext_T::CheckCounters(unsigned long) */undefined8 VmaDefragmentationContext_T::CheckCounters(VmaDefragmentationContext_T *this, ulong param_1) {
   VmaDefragmentationContext_T VVar1;
   int iVar2;
   undefined8 uVar3;
   if (( *(code**)( this + 0x10 ) != (code*)0x0 ) && ( iVar2 = ( **(code**)( this + 0x10 ) )(*(undefined8*)( this + 0x18 )) ),iVar2 != 0) {
      return 2;
   }
   ...
   return uVar3;
}/* VmaDefragmentationContext_T::IncrementCounters(unsigned long) */bool VmaDefragmentationContext_T::IncrementCounters(VmaDefragmentationContext_T *this, ulong param_1) {
   int iVar1;
   long lVar2;
   bool bVar3;
   iVar1 = *(int*)( this + 0x98 );
   ...
   *(uint*)( this + 0x98 ) = iVar1 + 1U;
   ...
   VmaDefragmentationContext_T::StateBalanced&) */void VmaDefragmentationContext_T::UpdateVectorStatistics(VmaDefragmentationContext_T *this, VmaBlockVector *param_1, StateBalanced *param_2) {
   long *plVar1;
   long lVar2;
   long lVar3;
   code *pcVar4;
   ...
   *(undefined1(*) [16])param_2 = (undefined1[16])0x0;
   ...
   ( *pcVar4 )();
}/* VmaPool_T::VmaPool_T(VmaAllocator_T*, VmaPoolCreateInfo const&, unsigned long) */void VmaPool_T::VmaPool_T(VmaPool_T *this, VmaAllocator_T *param_1, VmaPoolCreateInfo *param_2, ulong param_3) {
   VmaAllocator_T VVar1;
   uint uVar2;
   uint uVar3;
   undefined8 uVar4;
   ...
   uVar8 = 1;
   if (( ( *(uint*)( param_1 + (ulong)uVar2 * 8 + 0x40c ) & 6 ) == 2 ) && ( uVar8 = uVar8 == 0 )) {
      uVar8 = 1;
   }
   ...
   *(undefined8*)( this + 0x88 ) = 0;
   for (int i = 0; i < 3; i++) {
      *(undefined1(*) [16])( this + ( 16*i + 88 ) ) = (undefined1[16])0;
   }
   VVar1 = param_1[0x20];
   ...
   *(undefined1(*) [16])( this + 0x118 ) = (undefined1[16])0x0;
   return;
}/* VmaPool_T::SetName(char const*) */void VmaPool_T::SetName(VmaPool_T *this, char *param_1) {
   long lVar1;
   size_t sVar2;
   void *pvVar3;
   lVar1 = *(long*)this;
   ...
   if (*(char*)( lVar1 + 0x20 ) == '\0') {
      ...
      sVar2 = sVar2 + 1;
      LAB_0010561c:pvVar3 = (void*)aligned_alloc(1, sVar2);
   } else {
      if (pvVar3 != (void*)0x0) {
   ...
   LAB_001055fc:*(void**)( this + 0x118 ) = pvVar3;
   return;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* VmaAllocator_T::ImportVulkanFunctions_Static() */void VmaAllocator_T::ImportVulkanFunctions_Static(VmaAllocator_T *this) {
   undefined8 uVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   undefined8 uVar4;
   ...
   *(undefined8*)( this + 0x16d0 ) = uVar3;
   ...
   return;
}/* VmaAllocator_T::ImportVulkanFunctions_Custom(VmaVulkanFunctions const*) */void VmaAllocator_T::ImportVulkanFunctions_Custom(VmaAllocator_T *this, VmaVulkanFunctions *param_1) {
   if (*(long*)param_1 != 0) {
      *(long*)( this + 0x1648 ) = *(long*)param_1;
   }
   for (int i = 0; i < 25; i++) {
      if (*(long*)( param_1 + ( 8*i + 8 ) ) != 0) {
         *(long*)( this + ( 8*i + 5712 ) ) = *(long*)( param_1 + ( 8*i + 8 ) );
      }
   }
   return;
}/* VmaAllocator_T::ImportVulkanFunctions_Dynamic() */void VmaAllocator_T::ImportVulkanFunctions_Dynamic(VmaAllocator_T *this) {
   long lVar1;
   uint uVar2;
   undefined8 uVar3;
   if (*(long*)( this + 0x1658 ) == 0) {
      uVar3 = ( **(code**)( this + 0x1648 ) )(*(undefined8*)( this + 0x18 ), "vkGetPhysicalDeviceProperties");
      *(undefined8*)( this + 0x1658 ) = uVar3;
   }
   if (*(long*)( this + 0x1660 ) == 0) {
      uVar3 = ( **(code**)( this + 0x1648 ) )(*(undefined8*)( this + 0x18 ), "vkGetPhysicalDeviceMemoryProperties");
   ...
   if (*(long*)( this + 0x1690 ) == 0) {
      uVar3 = ( **(code**)( this + 0x1650 ) )(*(undefined8*)( this + 0x10 ), "vkInvalidateMappedMemoryRanges");
   ...
   if (*(long*)( this + 0x16a8 ) == 0) {
      uVar3 = ( **(code**)( this + 0x1650 ) )(*(undefined8*)( this + 0x10 ), "vkGetBufferMemoryRequirements");
      *(undefined8*)( this + 0x16a8 ) = uVar3;
   }
   if (*(long*)( this + 0x16b0 ) == 0) {
      uVar3 = ( **(code**)( this + 0x1650 ) )(*(undefined8*)( this + 0x10 ), "vkGetImageMemoryRequirements");
   ...
   if (*(uint*)( this + 4 ) < 0x401000) {
      LAB_00105b90:if (( this[10] != (VmaAllocator_T)0x0 ) && ( *(long*)( this + 0x1700 ) == 0 )) {
         uVar3 = ( **(code**)( this + 0x1648 ) )(*(undefined8*)( this + 0x18 ), "vkGetPhysicalDeviceMemoryProperties2KHR");
         *(undefined8*)( this + 0x1700 ) = uVar3;
      }
   } else {
      if (*(long*)( this + 0x16e0 ) == 0) {
         uVar3 = ( **(code**)( this + 0x1650 ) )(*(undefined8*)( this + 0x10 ), "vkGetBufferMemoryRequirements2");
         *(undefined8*)( this + 0x16e0 ) = uVar3;
         if (*(long*)( this + 0x16e8 ) != 0) goto LAB_00105a7f;
         LAB_00105e2e:uVar3 = ( **(code**)( this + 0x1650 ) )(*(undefined8*)( this + 0x10 ), "vkGetImageMemoryRequirements2");
         *(undefined8*)( this + 0x16e8 ) = uVar3;
         if (*(long*)( this + 0x16f0 ) != 0) goto LAB_00105a8d;
         LAB_00105e54:uVar3 = ( **(code**)( this + 0x1650 ) )(*(undefined8*)( this + 0x10 ), "vkBindBufferMemory2");
         lVar1 = *(long*)( this + 0x16f8 );
         *(undefined8*)( this + 0x16f0 ) = uVar3;
      } else {
         if (*(long*)( this + 0x16e8 ) == 0) goto LAB_00105e2e;
         LAB_00105a7f:if (*(long*)( this + 0x16f0 ) == 0) goto LAB_00105e54;
         LAB_00105a8d:lVar1 = *(long*)( this + 0x16f8 );
      }
      if (lVar1 == 0) {
      ...
      if (*(long*)( this + 0x1700 ) == 0) {
         uVar3 = ( **(code**)( this + 0x1648 ) )(*(undefined8*)( this + 0x18 ), "vkGetPhysicalDeviceMemoryProperties2");
         *(undefined8*)( this + 0x1700 ) = uVar3;
      }
   }
   if (this[8] != (VmaAllocator_T)0x0) {
      if (*(long*)( this + 0x16e0 ) == 0) {
         uVar3 = ( **(code**)( this + 0x1650 ) )(*(undefined8*)( this + 0x10 ), "vkGetBufferMemoryRequirements2KHR");
      ...
      if (lVar1 == 0) {
         uVar3 = ( **(code**)( this + 0x1650 ) )(*(undefined8*)( this + 0x10 ), "vkGetImageMemoryRequirements2KHR");
         *(undefined8*)( this + 0x16e8 ) = uVar3;
      }
   }
   ...
   if (0x402fff < uVar2) {
      if (*(long*)( this + 0x1708 ) == 0) {
         uVar3 = ( **(code**)( this + 0x1650 ) )(*(undefined8*)( this + 0x10 ), "vkGetDeviceBufferMemoryRequirements");
      ...
      if (lVar1 == 0) {
         uVar3 = ( **(code**)( this + 0x1650 ) )(*(undefined8*)( this + 0x10 ), "vkGetDeviceImageMemoryRequirements");
         *(undefined8*)( this + 0x1710 ) = uVar3;
      }
   }
   LAB_00105b35:if (this[0xe] != (VmaAllocator_T)0x0) {
      if (*(long*)( this + 0x1708 ) == 0) {
         uVar3 = ( **(code**)( this + 0x1650 ) )(*(undefined8*)( this + 0x10 ), "vkGetDeviceBufferMemoryRequirementsKHR");
         lVar1 = *(long*)( this + 0x1710 );
         *(undefined8*)( this + 0x1708 ) = uVar3;
      } else {
         lVar1 = *(long*)( this + 0x1710 );
      ...
      if (lVar1 == 0) {
         uVar3 = ( **(code**)( this + 0x1650 ) )(*(undefined8*)( this + 0x10 ), "vkGetDeviceImageMemoryRequirementsKHR");
         *(undefined8*)( this + 0x1710 ) = uVar3;
         return;
      }
   }
   return;
}/* VmaAllocator_T::ImportVulkanFunctions(VmaVulkanFunctions const*) */void VmaAllocator_T::ImportVulkanFunctions(VmaAllocator_T *this, VmaVulkanFunctions *param_1) {
   ...
   return;
}/* VmaAllocator_T::VmaAllocator_T(VmaAllocatorCreateInfo const*) */void VmaAllocator_T::VmaAllocator_T(VmaAllocator_T *this, VmaAllocatorCreateInfo *param_1) {
   ...
   *(int*)( this + 4 ) = iVar11;
   for (int i = 0; i < 3; i++) {
      this[( 2*i + 8 )] = ( VmaAllocator_T )(( byte )(uVar2 >> ( 2*i + 1 )) & 1);
      this[( 2*i + 9 )] = ( VmaAllocator_T )(( byte )(uVar2 >> ( 2*i + 2 )) & 1);
   }
   ...
   *(undefined1(*) [16])( this + 0xb8 ) = (undefined1[16])0x0;
   ...
   do {
      *pVVar7 = (VmaAllocator_T)0x1;
      ...
      for (int i = 0; i < 3; i++) {
         *(undefined1(*) [16])( pVVar7 + ( 16*i + 8 ) ) = (undefined1[16])0;
      }
   ...
   *(undefined4*)( this + 0x1718 ) = 0xffffffff;
   for (int i = 0; i < 3; i++) {
      *(undefined8*)( this + ( 16*i + 5616 ) ) = extraout_XMM1_Qa;
      *(undefined8*)( this + ( 16*i + 5624 ) ) = extraout_XMM1_Qb;
   }
   ...
   *(undefined8*)( this + 0x400 ) = 0;
   ...
   for (uVar10 = ( ulong )(( (int)( this + 0xd0 ) - (int)(undefined8*)( ( ulong )(this + 0xd8) & 0xfffffffffffffff8 ) ) + 0x338U >> 3); uVar10 != 0; uVar10 = uVar10 - 1) {
      *puVar9 = 0;
   ...
   *(undefined8*)( this + 0x608 ) = 0;
   ...
   for (uVar10 = ( ulong )(( (int)( this + 0x408 ) - (int)(undefined8*)( ( ulong )(this + 0x410) & 0xfffffffffffffff8 ) ) + 0x208U >> 3); uVar10 != 0; uVar10 = uVar10 - 1) {
      *puVar9 = 0;
      puVar9 = puVar9 + (ulong)bVar16 * -2 + 1;
   }
   ...
   *(undefined8*)( this + 0x708 ) = 0;
   ...
   for (uVar10 = ( ulong )(( (int)this - (int)(undefined8*)( ( ulong )(this + 0x618) & 0xfffffffffffffff8 ) ) + 0x710U >> 3); uVar10 != 0; uVar10 = uVar10 - 1) {
      *puVar9 = 0;
      puVar9 = puVar9 + (ulong)bVar16 * -2 + 1;
   }
   ...
   *(undefined8*)( this + 0x1710 ) = 0;
   ...
   for (uVar10 = ( ulong )(( (int)this - (int)(undefined8*)( ( ulong )(this + 0x1650) & 0xfffffffffffffff8 ) ) + 0x1718U >> 3); uVar10 != 0; uVar10 = uVar10 - 1) {
      *puVar9 = 0;
      puVar9 = puVar9 + (ulong)bVar16 * -2 + 1;
   }
   ...
   *(undefined8*)( this + 0x15e8 ) = 0;
   ...
   for (uVar10 = ( ulong )(( (int)( this + 0x1570 ) - (int)(undefined8*)( ( ulong )(this + 0x1578) & 0xfffffffffffffff8 ) ) + 0x80U >> 3); uVar10 != 0; uVar10 = uVar10 - 1) {
      *puVar9 = 0;
      puVar9 = puVar9 + (ulong)bVar16 * -2 + 1;
   }
   ...
   *(uint*)( this + 0x1718 ) = uVar12;
   ...
   if (( lVar6 != 0 ) && ( uVar12 = uVar12 != 0 )) {
      pVVar7 = this + 0x510;
      uVar10 = 0;
      do {
         uVar4 = *(ulong*)( lVar6 + uVar10 * 8 );
         if (( uVar4 != 0xffffffffffffffff ) && ( *(uint*)( this + 200 ) = *(uint*)( this + 200 ) | 1 << ( (byte)uVar10 & 0x1f ) ),uVar4 < *(ulong*)pVVar7) {
            *(ulong*)pVVar7 = uVar4;
         }
         uVar10 = uVar10 + 1;
         pVVar7 = pVVar7 + 0x10;
   ...
   if (uVar2 != 0) {
      do {
         if (( *(uint*)( this + 0x1718 ) >> ( uVar12 & 0x1f ) & 1 ) != 0) {
            if (*(ulong*)( this + ( ulong ) * (uint*)( this + (ulong)uVar12 * 8 + 0x410 ) * 0x10 + 0x510 ) < 0x40000001) {
               pcVar8 = *(code**)( this + 0x30 );
               uVar10 = ( *(ulong*)( this + ( ulong ) * (uint*)( this + (ulong)uVar12 * 8 + 0x410 ) * 0x10 + 0x510 ) >> 3 ) + 0x1f & 0xffffffffffffffe0;
               if (pcVar8 == (code*)0x0) goto LAB_001065e4;
               LAB_001064a9:puVar9 = (undefined8*)( *pcVar8 )(*(undefined8*)( this + 0x28 ), 0xb8, 8, 1);
            } else {
               pcVar8 = *(code**)( this + 0x30 );
               uVar10 = *(long*)( this + 0x1558 ) + 0x1fU & 0xffffffffffffffe0;
               if (pcVar8 != (code*)0x0) goto LAB_001064a9;
               LAB_001065e4:puVar9 = (undefined8*)aligned_alloc(8, 0xb8);
            }
            lVar6 = 1;
            if (( ( *(uint*)( this + (ulong)uVar12 * 8 + 0x40c ) & 6 ) == 2 ) && ( lVar6 = lVar6 == 0 )) {
               lVar6 = 1;
            }
   ...
   return;
}/* VmaAllocator_T::CalcPreferredBlockSize(unsigned int) */ulong VmaAllocator_T::CalcPreferredBlockSize(VmaAllocator_T *this, uint param_1) {
   if (*(ulong*)( this + ( ulong ) * (uint*)( this + (ulong)param_1 * 8 + 0x410 ) * 0x10 + 0x510 ) < 0x40000001) {
      return ( *(ulong*)( this + ( ulong ) * (uint*)( this + (ulong)param_1 * 8 + 0x410 ) * 0x10 + 0x510 ) >> 3 ) + 0x1f & 0xffffffffffffffe0;
   }
   ...
   const */void VmaAllocator_T::GetBufferMemoryRequirements(VmaAllocator_T *this, VkBuffer_T *param_1, VkMemoryRequirements *param_2, bool *param_3, bool *param_4) {
   long in_FS_OFFSET;
   undefined4 local_88;
   undefined8 local_84;
   undefined4 local_7c;
    ...
    */void VmaAllocator_T::GetImageMemoryRequirements(VmaAllocator_T *this, VkImage_T *param_1, VkMemoryRequirements *param_2, bool *param_3, bool *param_4) {
   long in_FS_OFFSET;
   undefined4 local_88;
   undefined8 local_84;
   undefined4 local_7c;
   ...
   VmaBufferImageUsage, unsigned int*) const */undefined8 VmaAllocator_T::FindMemoryTypeIndex(VmaAllocator_T *this, uint param_1, uint *param_2, ulong param_4, uint *param_5) {
   int iVar1;
   uint uVar2;
   uint uVar3;
   uint uVar4;
   ...
   *param_5 = 0xffffffff;
   ...
   if (*(int*)( this + 0x408 ) != 0) {
      ...
      do {
         if (( uVar2 & uVar8 ) != 0) {
            ...
            if (( ( ( uVar4 & uVar9 ) == 0 ) && ( uVar4 = uVar4 & uVar7 ),uVar5 = *(uint*)( this + (ulong)uVar3 * 8 + 0x40c ) & uVar10,uVar4 = uVar4 - ( uVar4 >> 1 & 0x55555555 ),uVar4 = ( uVar4 >> 2 & 0x33333333 ) + ( uVar4 & 0x33333333 ),uVar4 = ( uVar4 >> 4 ) + uVar4 & 0xf0f0f0f,uVar11 = ( uVar4 >> 8 ) + uVar4 & 0xff00ff,uVar5 = uVar5 - ( uVar5 >> 1 ),uVar4 = ( uVar5 >> 2 & 0x33333333 ) + ( uVar5 & 0x33333333 ),uVar4 = ( uVar4 >> 4 ) + uVar4 & 0xf0f0f0f,uVar4 = ( uVar4 >> 8 ) + uVar4 & 0xff00ff,uVar4 = ( ( uVar4 >> 0x10 ) + uVar4 & 0xffff ) + ( ( uVar11 >> 0x10 ) + uVar11 & 0xffff ),uVar4 < uVar6 )) {
               return 0;
            }
         }
         uVar3 = uVar3 + 1;
   ...
   return 0xfffffff8;
}/* VmaAllocator_T::CalcAllocationParams(VmaAllocationCreateInfo&, bool, bool) */undefined8 VmaAllocator_T::CalcAllocationParams(VmaAllocationCreateInfo *param_1, bool param_2, bool param_3) {
   uint uVar1;
   int iVar2;
   long lVar3;
   uint uVar4;
   ...
   LAB_00106c1c:if (( uVar4 & 0xc00 ) == 0) {
      *(uint*)CONCAT71(in_register_00000031, param_2) = uVar4 | 0x800;
   }
   return 0;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* VmaAllocator_T::CalculateStatistics(VmaTotalStatistics*) */undefined8 VmaAllocator_T::CalculateStatistics(VmaAllocator_T *this, VmaTotalStatistics *param_1) {
   uint uVar1;
   undefined8 uVar2;
   int iVar3;
   ...
   *(undefined8*)( param_1 + 0xc38 ) = uVar2;
   ...
   if (*(int*)( this + 0x408 ) != 0) {
      do {
         if (*(VmaBlockVector**)( this + lVar10 * 8 + 0x610 ) != (VmaBlockVector*)0x0) {
            VmaBlockVector::AddDetailedStatistics(*(VmaBlockVector**)( this + lVar10 * 8 + 0x610 ), pVVar6);
         }
         lVar10 = lVar10 + 1;
         pVVar6 = pVVar6 + 0x40;
   ...
   if (*this == (VmaAllocator_T)0x0) {
      ...
      LAB_00106d98:do {
         ...
         VmaBlockVector::AddDetailedStatistics(this_01, (VmaDetailedStatistics*)( param_1 + (ulong)uVar1 * 0x40 ));
         VmaDedicatedAllocationList::AddDetailedStatistics((VmaDedicatedAllocationList*)( this_01 + 0xb8 ), (VmaDetailedStatistics*)( param_1 + (ulong)uVar1 * 0x40 ));
   ...
   LAB_00106ddb:this_00 = this + 0x710;
   uVar9 = 0;
   pVVar6 = (VmaDetailedStatistics*)param_1;
   if (*(int*)( this + 0x408 ) != 0) {
      do {
         uVar9 = ( ulong )((int)uVar9 + 1);
         VmaDedicatedAllocationList::AddDetailedStatistics((VmaDedicatedAllocationList*)this_00, pVVar6);
         pVVar6 = pVVar6 + 0x40;
      ...
      if (*(uint*)( this + 0x408 ) != 0) {
         lVar10 = 0;
         do {
            lVar10 = VmaAddDetailedStatistics((VmaDetailedStatistics*)( param_1 + ( ( ulong ) * (uint*)( this + lVar10 * 8 + 0x410 ) + 0x20 ) * 0x40 ), (VmaDetailedStatistics*)( param_1 + lVar10 * 0x40 ));
         } while ( (uint)lVar10 < *(uint*)( this + 0x408 ) );
      }
   }
   uVar8 = 0;
   ...
   return uVar8;
}/* VmaAllocator_T::GetAllocationInfo(VmaAllocation_T*, VmaAllocationInfo*) */void VmaAllocator_T::GetAllocationInfo(VmaAllocator_T *this, VmaAllocation_T *param_1, VmaAllocationInfo *param_2) {
   undefined8 uVar1;
   ...
   *(undefined4*)param_2 = *(undefined4*)( param_1 + 0x48 );
   if (param_1[0x4c] == (VmaAllocation_T)0x1) {
      ...
      *(undefined8*)( param_2 + 0x18 ) = uVar1;
      ...
      if (param_1[0x4c] == (VmaAllocation_T)0x2) {
         ...
         *(undefined8*)( param_2 + 0x18 ) = uVar1;
         LAB_00106ef3:lVar6 = *(long*)( param_1 + 0x10 );
         goto LAB_00106ef8;
      }
   ...
   lVar6 = 0;
   LAB_00106ef8:uVar1 = *(undefined8*)( param_1 + 0x38 );
   *(long*)( param_2 + 0x20 ) = lVar6;
   *(undefined8*)( param_2 + 0x28 ) = uVar1;
   *(undefined8*)( param_2 + 0x30 ) = *(undefined8*)( param_1 + 0x40 );
   return;
}/* VmaAllocator_T::GetAllocationInfo2(VmaAllocation_T*, VmaAllocationInfo2*) */void VmaAllocator_T::GetAllocationInfo2(VmaAllocator_T *this, VmaAllocation_T *param_1, VmaAllocationInfo2 *param_2) {
   undefined8 uVar1;
   ...
   *(undefined8*)( param_2 + 0x38 ) = *(undefined8*)( param_2 + 0x18 );
   return;
}/* VmaAllocator_T::GetPoolStatistics(VmaPool_T*, VmaStatistics*) */void VmaAllocator_T::GetPoolStatistics(VmaAllocator_T *this, VmaPool_T *param_1, VmaStatistics *param_2) {
   ...
   *(undefined1(*) [16])( param_2 + 8 ) = (undefined1[16])0x0;
   ...
   return;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* VmaAllocator_T::CalculatePoolStatistics(VmaPool_T*, VmaDetailedStatistics*) */void VmaAllocator_T::CalculatePoolStatistics(VmaAllocator_T *this, VmaPool_T *param_1, VmaDetailedStatistics *param_2) {
   undefined8 uVar1;
   undefined8 uVar2;
   *(undefined1(*) [16])( param_2 + 8 ) = (undefined1[16])0x0;
   uVar2 = _UNK_00115398;
   ...
   *(undefined8*)( param_2 + 0x38 ) = uVar2;
   ...
   VmaDedicatedAllocationList::AddDetailedStatistics((VmaDedicatedAllocationList*)( param_1 + 0xb8 ), param_2);
   return;
}/* VmaAllocator_T::CheckPoolCorruption(VmaPool_T*) */undefined8 VmaAllocator_T::CheckPoolCorruption(VmaPool_T *param_1) {
   return 0xfffffff8;
}/* VmaAllocator_T::CheckCorruption(unsigned int) */undefined8 VmaAllocator_T::CheckCorruption(uint param_1) {
   pthread_rwlock_t *__rwlock;
   int iVar1;
   ...
   /* WARNING: Subroutine does not return */
   std::__throw_system_error(0x23);
}/* VmaAllocator_T::AllocateVulkanMemory(VkMemoryAllocateInfo const*, VkDeviceMemory_T**) */int VmaAllocator_T::AllocateVulkanMemory(VmaAllocator_T *this, VkMemoryAllocateInfo *param_1, VkDeviceMemory_T **param_2) {
   VmaAllocator_T *pVVar1;
   ulong uVar2;
   int iVar3;
   ulong uVar4;
   ...
   *(int*)( this + 0x1550 ) = *(int*)( this + 0x1550 ) + 1;
   ...
   if (( *(uint*)( this + 200 ) >> ( *(uint*)( this + ( ulong ) * (uint*)( param_1 + 0x18 ) * 8 + 0x410 ) & 0x1f ) & 1 ) == 0) {
      LOCK();
      *(long*)( this + ( uVar7 + 0x252 ) * 8 ) = *(long*)( this + ( uVar7 + 0x252 ) * 8 ) + *(long*)( param_1 + 0x10 );
      UNLOCK();
   } else {
   ...
   *(int*)pVVar1 = *(int*)pVVar1 + 1;
   ...
   if (iVar3 == 0) {
      ...
      *(int*)( this + 0x1390 ) = *(int*)( this + 0x1390 ) + 1;
      ...
      if (*(code**)( this + 0x58 ) != (code*)0x0) {
         ( **(code**)( this + 0x58 ) )(this, *(undefined4*)( param_1 + 0x18 ), *param_2, *(undefined8*)( param_1 + 0x10 ), *(undefined8*)( this + 0x68 ));
      }
   } else {
      LOCK();
      *(int*)pVVar1 = *(int*)pVVar1 + -1;
   ...
   return iVar3;
}/* VmaAllocator_T::FreeVulkanMemory(unsigned int, unsigned long, VkDeviceMemory_T*) */void VmaAllocator_T::FreeVulkanMemory(VmaAllocator_T *this, uint param_1, ulong param_2, VkDeviceMemory_T *param_3) {
   uint uVar1;
   VmaAllocator_T *pVVar2;
   ...
   *(int*)( this + ( (ulong)uVar1 + 0x484 ) * 4 ) = *(int*)( this + ( (ulong)uVar1 + 0x484 ) * 4 ) + -1;
   UNLOCK();
   LOCK();
   *(ulong*)( this + ( (ulong)uVar1 + 0x252 ) * 8 ) = *(long*)( this + ( (ulong)uVar1 + 0x252 ) * 8 ) - param_2;
   UNLOCK();
   LOCK();
   *(int*)( this + 0x1550 ) = *(int*)( this + 0x1550 ) + -1;
   UNLOCK();
   return;
}/* VmaDeviceMemoryBlock::Destroy(VmaAllocator_T*) */void VmaDeviceMemoryBlock::Destroy(VmaDeviceMemoryBlock *this, VmaAllocator_T *param_1) {
   undefined8 *__ptr;
   char cVar1;
   ...
   VmaAllocator_T::FreeVulkanMemory(param_1, *(uint*)( this + 0x10 ), *(ulong*)( *(long*)this + 8 ), *(VkDeviceMemory_T**)( this + 0x18 ));
   ...
   *(undefined8*)this = 0;
   return;
}/* VmaBlockVector::~VmaBlockVector() */void VmaBlockVector::~VmaBlockVector(VmaBlockVector *this) {
   void *__ptr;
   code *pcVar1;
   undefined8 *puVar2;
   long lVar3;
   ...
   if (*(long*)( this + 0xa0 ) != 0) {
      ...
      LAB_00107393:do {
         VmaDeviceMemoryBlock::Destroy(*(VmaDeviceMemoryBlock**)( (long)__ptr_00 + lVar3 * 8 ), *(VmaAllocator_T**)this);
         __ptr_00 = *(void**)( this + 0x98 );
   ...
   free(__ptr_00);
   return;
}/* VmaPool_T::~VmaPool_T() */void VmaPool_T::~VmaPool_T(VmaPool_T *this) {
   long lVar1;
   void *__ptr;
   lVar1 = *(long*)this;
   ...
   VmaBlockVector::~VmaBlockVector((VmaBlockVector*)this);
   return;
}/* VmaAllocator_T::DestroyPool(VmaPool_T*) */void VmaAllocator_T::DestroyPool(VmaAllocator_T *this, VmaPool_T *param_1) {
   long lVar1;
   void *__ptr;
   code *UNRECOVERED_JUMPTABLE;
   int iVar2;
   ...
   *(long*)( this + 0x1638 ) = *(long*)( this + 0x1638 ) + -1;
   ...
   if (*(char*)( lVar1 + 0x20 ) == '\0') {
      ...
      LAB_00107560:VmaBlockVector::~VmaBlockVector((VmaBlockVector*)param_1);
   } else {
      ...
      LAB_00107585:free(__ptr);
      VmaBlockVector::~VmaBlockVector((VmaBlockVector*)param_1);
   }
   UNRECOVERED_JUMPTABLE = *(code**)( this + 0x40 );
   joined_r0x00107570:if (UNRECOVERED_JUMPTABLE == (code*)0x0) {
      free(param_1);
      return;
   }
   ...
   return;
}/* VmaAllocator_T::BindVulkanBuffer(VkDeviceMemory_T*, unsigned long, VkBuffer_T*, void const*) */undefined8 VmaAllocator_T::BindVulkanBuffer(VmaAllocator_T *this, VkDeviceMemory_T *param_1, ulong param_2, VkBuffer_T *param_3, void *param_4) {
   undefined8 uVar1;
   long in_FS_OFFSET;
   undefined8 local_38;
   void *local_30;
   ...
   if (param_4 == (void*)0x0) {
      ...
      if (( ( this[9] == (VmaAllocator_T)0x0 ) && ( *(uint*)( this + 4 ) < 0x401000 ) ) || ( *(code**)( this + 0x16f0 ) == (code*)0x0 )) {
         uVar1 = 0xfffffff9;
      } else {
         local_38 = 0x3b9d2f48;
         local_30 = param_4;
   ...
   VkBuffer_T*, void const*) */ulong VmaDeviceMemoryBlock::BindBufferMemory(VmaDeviceMemoryBlock *this, VmaAllocator_T *param_1, VmaAllocation_T *param_2, ulong param_3, VkBuffer_T *param_4, void *param_5) {
   int iVar1;
   uint uVar2;
   long lVar3;
   ulong uVar4;
   if (param_2[0x4c] == (VmaAllocation_T)0x1) {
      lVar3 = ( **(code**)( *(long*)**(undefined8**)param_2 + 0x48 ) )((long*)**(undefined8**)param_2, *(undefined8*)( param_2 + 8 ));
      param_3 = param_3 + lVar3;
   }
   if (*param_1 != (VmaAllocator_T)0x0) {
      iVar1 = pthread_mutex_lock((pthread_mutex_t*)( this + 0x20 ));
      if (iVar1 == 0) {
         uVar2 = VmaAllocator_T::BindVulkanBuffer(param_1, *(VkDeviceMemory_T**)( this + 0x18 ), param_3, param_4, param_5);
   ...
   uVar4 = VmaAllocator_T::BindVulkanBuffer(param_1, *(VkDeviceMemory_T**)( this + 0x18 ), param_3, param_4, param_5);
   return uVar4;
}/* VmaAllocator_T::BindVulkanImage(VkDeviceMemory_T*, unsigned long, VkImage_T*, void const*) */undefined8 VmaAllocator_T::BindVulkanImage(VmaAllocator_T *this, VkDeviceMemory_T *param_1, ulong param_2, VkImage_T *param_3, void *param_4) {
   undefined8 uVar1;
   long in_FS_OFFSET;
   undefined8 local_38;
   void *local_30;
   ...
   if (param_4 == (void*)0x0) {
      ...
      if (( ( this[9] == (VmaAllocator_T)0x0 ) && ( *(uint*)( this + 4 ) < 0x401000 ) ) || ( *(code**)( this + 0x16f8 ) == (code*)0x0 )) {
         uVar1 = 0xfffffff9;
      } else {
         local_38 = 0x3b9d2f49;
         local_30 = param_4;
   ...
   VkImage_T*, void const*) */ulong VmaDeviceMemoryBlock::BindImageMemory(VmaDeviceMemoryBlock *this, VmaAllocator_T *param_1, VmaAllocation_T *param_2, ulong param_3, VkImage_T *param_4, void *param_5) {
   int iVar1;
   uint uVar2;
   long lVar3;
   ulong uVar4;
   ...
   if (*param_1 != (VmaAllocator_T)0x0) {
      iVar1 = pthread_mutex_lock((pthread_mutex_t*)( this + 0x20 ));
      if (iVar1 == 0) {
         uVar2 = VmaAllocator_T::BindVulkanImage(param_1, *(VkDeviceMemory_T**)( this + 0x18 ), param_3, param_4, param_5);
         pthread_mutex_unlock((pthread_mutex_t*)( this + 0x20 ));
         return (ulong)uVar2;
      }
      /* WARNING: Subroutine does not return */
   ...
   uVar4 = VmaAllocator_T::BindVulkanImage(param_1, *(VkDeviceMemory_T**)( this + 0x18 ), param_3, param_4, param_5);
   return uVar4;
}/* VmaAllocator_T::Map(VmaAllocation_T*, void**) */ulong VmaAllocator_T::Map(VmaAllocator_T *this, VmaAllocation_T *param_1, void **param_2) {
   uint uVar1;
   long lVar2;
   ulong uVar3;
   void *pvVar4;
   ...
   if (param_1[0x4c] == (VmaAllocation_T)0x1) {
      ...
      if (uVar1 == 0) {
         if (param_1[0x4c] == (VmaAllocation_T)0x1) {
            lVar2 = ( **(code**)( *(long*)**(undefined8**)param_1 + 0x48 ) )((long*)**(undefined8**)param_1, *(undefined8*)( param_1 + 8 ));
   ...
   LAB_00107981:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* VmaAllocator_T::Unmap(VmaAllocation_T*) */void VmaAllocator_T::Unmap(VmaAllocator_T *this, VmaAllocation_T *param_1) {
   VmaAllocation_T VVar1;
   if (param_1[0x4c] == (VmaAllocation_T)0x1) {
   ...
   if (( ( param_1[0x4e] != (VmaAllocation_T)0x0 ) && ( VVar1 = ( VmaAllocation_T )((char)param_1[0x4e] + -1) ),param_1[0x4e] = VVar1,VVar1 == (VmaAllocation_T)0x0 )) &&( ( (byte)param_1[0x4f] & 1 ) == 0 ) * (undefined8*)( param_1 + 0x10 ) = 0;
   ...
   return;
}return;}/* VmaAllocator_T::BindBufferMemory(VmaAllocation_T*, unsigned long, VkBuffer_T*, void const*) */undefined8 VmaAllocator_T::BindBufferMemory(VmaAllocator_T *this, VmaAllocation_T *param_1, ulong param_2, VkBuffer_T *param_3, void *param_4) {
   undefined8 uVar1;
   if (param_1[0x4c] == (VmaAllocation_T)0x1) {
      uVar1 = VmaDeviceMemoryBlock::BindBufferMemory(*(VmaDeviceMemoryBlock**)param_1, this, param_1, param_2, param_3, param_4);
      return uVar1;
   }
   if (param_1[0x4c] != (VmaAllocation_T)0x2) {
      return 0xfffffff3;
   ...
   return uVar1;
}/* VmaAllocator_T::BindImageMemory(VmaAllocation_T*, unsigned long, VkImage_T*, void const*) */undefined8 VmaAllocator_T::BindImageMemory(VmaAllocator_T *this, VmaAllocation_T *param_1, ulong param_2, VkImage_T *param_3, void *param_4) {
   undefined8 uVar1;
   if (param_1[0x4c] == (VmaAllocation_T)0x1) {
      uVar1 = VmaDeviceMemoryBlock::BindImageMemory(*(VmaDeviceMemoryBlock**)param_1, this, param_1, param_2, param_3, param_4);
      return uVar1;
   }
   if (param_1[0x4c] != (VmaAllocation_T)0x2) {
      return 0xfffffff3;
   ...
   return uVar1;
}/* VmaAllocator_T::FreeDedicatedMemory(VmaAllocation_T*) */void VmaAllocator_T::FreeDedicatedMemory(VmaAllocator_T *this, VmaAllocation_T *param_1) {
   VmaAllocation_T VVar1;
   uint uVar2;
   ...
   VmaDedicatedAllocationList::Unregister((VmaDedicatedAllocationList*)( this + (ulong)uVar2 * 0x58 + 0x710 ), param_1);
   VVar1 = param_1[0x4c];
   joined_r0x00107b79:if (VVar1 == (VmaAllocation_T)0x1) {
   ...
   LOCK();
   *(long*)( this + ( (ulong)uVar2 + 0x20 ) * 8 + 0x1210 ) = *(long*)( this + ( (ulong)uVar2 + 0x20 ) * 8 + 0x1210 ) - *(long*)( param_1 + 0x30 );
   UNLOCK();
   LOCK();
   *(int*)( this + ( (ulong)uVar2 + 0x10 ) * 4 + 0x1210 ) = *(int*)( this + ( (ulong)uVar2 + 0x10 ) * 4 + 0x1210 ) + -1;
   UNLOCK();
   LOCK();
   *(int*)( this + 0x1390 ) = *(int*)( this + 0x1390 ) + 1;
   UNLOCK();
   ...
   return;
}/* VmaAllocator_T::CalculateGpuDefragmentationMemoryTypeBits() const */undefined4 VmaAllocator_T::CalculateGpuDefragmentationMemoryTypeBits(VmaAllocator_T *this) {
   int iVar1;
   VmaAllocator_T *pVVar2;
   undefined4 uVar3;
   long in_FS_OFFSET;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* VmaAllocator_T::CalculateGlobalMemoryTypeBits() const */uint VmaAllocator_T::CalculateGlobalMemoryTypeBits(VmaAllocator_T *this) {
   ulong uVar1;
   uint uVar2;
   uVar2 = 0xffffffff;
   ...
   VkMappedMemoryRange&) const */undefined8 VmaAllocator_T::GetFlushOrInvalidateRange(VmaAllocator_T *this, VmaAllocation_T *param_1, ulong param_2, ulong param_3, VkMappedMemoryRange *param_4) {
   long lVar1;
   long lVar2;
   undefined8 *puVar3;
   long *plVar4;
   ...
   VMA_CACHE_OPERATION) */undefined8 VmaAllocator_T::FlushOrInvalidateAllocation(VmaAllocator_T *this, VmaAllocation_T *param_1, ulong param_2, ulong param_3, int param_5) {
   char cVar1;
   undefined8 uVar2;
   long in_FS_OFFSET;
   ...
   local_20 = *(long*)( in_FS_OFFSET + 0x28 );
   for (int i = 0; i < 16; i++) {
      local_48[i] = (VkMappedMemoryRange)0;
   }
   ...
   long) */int VmaAllocator_T::CopyMemoryToAllocation(VmaAllocator_T *this, void *param_1, VmaAllocation_T *param_2, ulong param_3, ulong param_4) {
   char cVar1;
   int iVar2;
   long in_FS_OFFSET;
   void *local_70;
   ...
   if (iVar2 == 0) {
      ...
      Unmap(this, param_2);
      for (int i = 0; i < 16; i++) {
         local_68[i] = (VkMappedMemoryRange)0;
      }
      local_48 = 0;
      local_58 = (undefined1[16])0x0;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* VmaAllocator_T::CopyAllocationToMemory(VmaAllocation_T*, unsigned long, void*, unsigned long) */undefined8 VmaAllocator_T::CopyAllocationToMemory(VmaAllocator_T *this, VmaAllocation_T *param_1, ulong param_2, void *param_3, ulong param_4) {
   ...
   if (param_1[0x4c] == (VmaAllocation_T)0x1) {
      ...
      if (param_1[0x4c] == (VmaAllocation_T)0x1) {
         lVar4 = ( **(code**)( *(long*)**(undefined8**)param_1 + 0x48 ) )((long*)**(undefined8**)param_1, *(undefined8*)( param_1 + 8 ));
   ...
   if (( cVar2 == '\0' ) || ( uVar3 = ( **(code**)( this + 0x1690 ) )(*(undefined8*)( this + 0x10 ), 1, (VkMappedMemoryRange*)local_68) ),(int)uVar3 == 0) {
      memcpy(param_3, (void*)( (long)local_70 + param_2 ), param_4);
      Unmap(this, param_1);
      uVar3 = 0;
   }
   LAB_00107fff:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return uVar3;
}/* VmaAllocator_T::UpdateVulkanBudget() */void VmaAllocator_T::UpdateVulkanBudget(VmaAllocator_T *this) {
   long lVar1;
   int iVar2;
   long lVar3;
   ...
   if (*this == (VmaAllocator_T)0x0) {
      ...
      LAB_001081d6:pVVar4 = this + 0x1290;
      lVar3 = 0;
      pVVar7 = this + 0x510;
      do {
   ...
   pthread_rwlock_unlock(__rwlock);
   LAB_001082b5:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* VmaAllocator_T::Init(VmaAllocatorCreateInfo const*) */undefined8 VmaAllocator_T::Init(VmaAllocatorCreateInfo *param_1) {
   if (param_1[10] == (VmaAllocatorCreateInfo)0x0) {
      return 0;
   }
   UpdateVulkanBudget((VmaAllocator_T*)param_1);
   return 0;
}/* VmaAllocator_T::GetHeapBudgets(VmaBudget*, unsigned int, unsigned int) */void VmaAllocator_T::GetHeapBudgets(VmaAllocator_T *this, VmaBudget *param_1, uint param_2, uint param_3) {
   VmaAllocator_T VVar1;
   int iVar2;
   ulong uVar3;
   ulong uVar4;
   ...
   do {
      ...
      *(undefined8*)( param_1 + 8 ) = *(undefined8*)( this + ( uVar3 + 0x252 ) * 8 );
      *(undefined8*)( param_1 + 0x10 ) = *(undefined8*)( this + ( uVar3 + 0x252 ) * 8 + 0x80 );
      lVar6 = ( *(long*)( param_1 + 8 ) + *(long*)( this + uVar3 * 8 + 0x13d0 ) ) - *(ulong*)( this + uVar3 * 8 + 0x14d0 );
      if (( ulong )(*(long*)( param_1 + 8 ) + *(long*)( this + uVar3 * 8 + 0x13d0 )) <= *(ulong*)( this + uVar3 * 8 + 0x14d0 )) {
         lVar6 = 0;
      }
   ...
   LAB_00108434:pthread_rwlock_unlock(__rwlock);
   return;
}/* VmaAllocator_T::CalcMemTypeParams(VmaAllocationCreateInfo&, unsigned int, unsigned long, unsigned
   long) */undefined8 VmaAllocator_T::CalcMemTypeParams(VmaAllocator_T *this, VmaAllocationCreateInfo *param_1, uint param_2, ulong param_3, ulong param_4) {
   uint uVar1;
   undefined8 uVar2;
   long in_FS_OFFSET;
   ...
   uVar2 = 0;
   LAB_00108540:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar2;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* VmaAllocator_T::SetCurrentFrameIndex(unsigned int) */void VmaAllocator_T::SetCurrentFrameIndex(VmaAllocator_T *this, uint param_1) {
   LOCK();
   *(uint*)( this + 0x1568 ) = param_1;
   ...
   UpdateVulkanBudget(this);
   return;
}/* VmaAllocator_T::FillAllocation(VmaAllocation_T*, unsigned char) */void VmaAllocator_T::FillAllocation(VmaAllocation_T *param_1, uchar param_2) {
   return;
}/* VmaAllocator_T::GetGpuDefragmentationMemoryTypeBits() */void VmaAllocator_T::GetGpuDefragmentationMemoryTypeBits(VmaAllocator_T *this) {
   undefined4 uVar1;
   ...
   *(undefined4*)( param_1 + 0x1568 ) = param_2;
   ...
   return;
}void VmaAllocator_T::vmaCalculateStatistics(VmaAllocator_T *this, VmaTotalStatistics *param_1) {
   ...
   if (iVar1 != 0) {
      ...
      if (*(uint*)( param_1 + 0x408 ) != 0) {
         do {
            lVar2 = 0;
            do {
               while (( iVar4 != *(int*)( param_1 + lVar2 + 0x410 ) || ( ( (byte)param_1[lVar2 + 0x40c] & 0x10 ) == 0 ) )) {
                  lVar2 = lVar2 + 8;
   ...
   lVar5 = 0;
   LAB_0010879f:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return lVar5;
   ...
   return;
}ulong vmaFindMemoryTypeIndexForBufferInfo(VmaAllocator_T *param_1, long param_2, undefined8 param_3, undefined8 param_4) {
   undefined8 uVar1;
   int *piVar2;
   uint uVar3;
   ulong uVar4;
   ...
   if (*(code**)( param_1 + 0x1708 ) == (code*)0x0) {
      ...
      if ((int)uVar4 == 0) {
         ...
         LAB_001089e3:uVar3 = VmaAllocator_T::FindMemoryTypeIndex(param_1, uStack_48, param_3, uVar4, param_4);
         pVVar5 = (VmaAllocator_T*)0x0;
         if (param_1[0x20] != (VmaAllocator_T)0x0) {
            pVVar5 = param_1 + 0x28;
         }
      ...
      uVar4 = ( ulong ) * (uint*)( param_2 + 0x20 );
      LAB_001088e4:uVar4 = VmaAllocator_T::FindMemoryTypeIndex(param_1, uStack_38, param_3, uVar4, param_4);
   }
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar4;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}ulong vmaFindMemoryTypeIndexForImageInfo(VmaAllocator_T *param_1, long param_2, undefined8 param_3, undefined8 param_4) {
   undefined8 uVar1;
   uint uVar2;
   ulong uVar3;
   VmaAllocator_T *pVVar4;
   ...
   if (*(code**)( param_1 + 0x1710 ) == (code*)0x0) {
      ...
      if ((int)uVar3 == 0) {
         ...
         uVar2 = VmaAllocator_T::FindMemoryTypeIndex(param_1, uStack_48, param_3, *(undefined4*)( param_2 + 0x38 ), param_4);
         pVVar4 = (VmaAllocator_T*)0x0;
         if (param_1[0x20] != (VmaAllocator_T)0x0) {
            pVVar4 = param_1 + 0x28;
         }
      ...
      uVar3 = VmaAllocator_T::FindMemoryTypeIndex(param_1, uStack_38, param_3, *(undefined4*)( param_2 + 0x38 ), param_4);
   }
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar3;
   }
   ...
   *(undefined1(*) [16])( param_3 + 8 ) = (undefined1[16])0x0;
   ...
   return;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void vmaCalculatePoolStatistics(undefined8 param_1, VmaBlockVector *param_2, VmaDetailedStatistics *param_3) {
   undefined8 uVar1;
   undefined8 uVar2;
   *(undefined1(*) [16])( param_3 + 8 ) = (undefined1[16])0x0;
   uVar2 = _UNK_00115398;
   ...
   *(undefined8*)( param_3 + 0x38 ) = uVar2;
   ...
   VmaDedicatedAllocationList::AddDetailedStatistics((VmaDedicatedAllocationList*)( param_2 + 0xb8 ), param_3);
   return;
   ...
   *param_3 = *(undefined8*)( param_2 + 0x118 );
   ...
   if (*(char*)( lVar1 + 0x20 ) == '\0') {
      ...
      sVar2 = sVar2 + 1;
      LAB_00108d2c:pvVar3 = (void*)aligned_alloc(1, sVar2);
   } else {
      if (pvVar3 != (void*)0x0) {
         if (*(code**)( lVar1 + 0x40 ) == (code*)0x0) {
            free(pvVar3);
   ...
   LAB_00108d0c:param_2[0x23] = (long)pvVar3;
   return;
}void VmaAllocator_T::vmaGetAllocationInfo(VmaAllocator_T *this, VmaAllocation_T *param_1, VmaAllocationInfo *param_2) {
   GetAllocationInfo(this, param_1, param_2);
   return;
}void vmaGetAllocationInfo2(VmaAllocator_T *param_1, VmaAllocation_T *param_2, VmaAllocationInfo *param_3) {
   undefined8 uVar1;
   ...
   *param_3 = *(undefined4*)( param_1 + 0x40c + ( ulong ) * (uint*)( param_2 + 0x48 ) * 8 );
   ...
   if (param_2[0x4c] == (VmaAllocation_T)0x1) {
      ...
      if (uVar1 == 0) {
         if (param_2[0x4c] == (VmaAllocation_T)0x1) {
            lVar2 = ( **(code**)( *(long*)**(undefined8**)param_2 + 0x48 ) )((long*)**(undefined8**)param_2, *(undefined8*)( param_2 + 8 ));
            pvVar4 = (void*)( (long)pvVar4 + lVar2 );
         }
         *param_3 = pvVar4;
   ...
   LAB_00108f01:/* WARNING: Subroutine does not return */__stack_chk_fail();
   ...
   if (( ( *(char*)( (long)param_2 + 0x4e ) != '\0' ) && ( cVar1 = *(char*)( (long)param_2 + 0x4e ) + -1 ),*(char*)( (long)param_2 + 0x4e ) = cVar1,cVar1 == '\0' )) {
      param_2[2] = 0;
   ...
   return;
}undefined8 vmaFlushAllocation(VmaAllocator_T *param_1, VmaAllocation_T *param_2, ulong param_3, ulong param_4) {
   char cVar1;
   undefined8 uVar2;
   long in_FS_OFFSET;
   VkMappedMemoryRange local_48[16];
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}undefined8 vmaInvalidateAllocation(VmaAllocator_T *param_1, VmaAllocation_T *param_2, ulong param_3, ulong param_4) {
   char cVar1;
   undefined8 uVar2;
   long in_FS_OFFSET;
   VkMappedMemoryRange local_48[16];
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}undefined8 vmaCopyMemoryToAllocation(VmaAllocator_T *param_1, void *param_2, VmaAllocation_T *param_3, ulong param_4, ulong param_5) {
   undefined8 uVar1;
   if (param_5 == 0) {
      return 0;
   }
   ...
   return uVar1;
}undefined8 vmaCopyAllocationToMemory(VmaAllocator_T *param_1, VmaAllocation_T *param_2, ulong param_3, void *param_4, size_t param_5) {
   undefined1 auVar1[16];
   char cVar2;
   undefined8 uVar3;
   long lVar4;
   ...
   if (param_2[0x4c] == (VmaAllocation_T)0x1) {
      ...
      uVar3 = local_68._0_8_;
      if (param_2[0x4c] == (VmaAllocation_T)0x1) {
         lVar4 = ( **(code**)( *(long*)**(undefined8**)param_2 + 0x48 ) )((long*)**(undefined8**)param_2, *(undefined8*)( param_2 + 8 ));
         local_68._0_8_ = uVar3 + lVar4;
      }
      local_70 = (void*)local_68._0_8_;
      if (param_2[0x4e] != (VmaAllocation_T)0xff) {
   ...
   local_48 = 0;
   local_58 = (undefined1[16])0x0;
   cVar2 = VmaAllocator_T::GetFlushOrInvalidateRange(param_1, param_2, param_3, param_5, (VkMappedMemoryRange*)local_68);
   if (( cVar2 == '\0' ) || ( uVar3 = ( **(code**)( param_1 + 0x1690 ) )(*(undefined8*)( param_1 + 0x10 ), 1, (VkMappedMemoryRange*)local_68) ),(int)uVar3 == 0) {
   ...
   /* WARNING: Subroutine does not return */
   std::__throw_system_error(0x23);
}undefined8 vmaBeginDefragmentation(VmaAllocator_T *param_1, VmaDefragmentationInfo *param_2, undefined8 *param_3) {
   ...
   if (( *(long*)( param_2 + 8 ) == 0 ) || ( ( *(byte*)( *(long*)( param_2 + 8 ) + 0x3c ) & 4 ) == 0 )) {
      if (*(code**)( param_1 + 0x30 ) == (code*)0x0) {
         ...
         this(VmaDefragmentationContext_T * )(**(code**)( param_1 + 0x30 ))(*(undefined8*)( param_1 + 0x28 ), 0xa8, 8, 1);
      }
   ...
   undefined8 uVar1;
   if (param_2[0x4c] == (VmaAllocation_T)0x1) {
      uVar1 = VmaDeviceMemoryBlock::BindBufferMemory(*(VmaDeviceMemoryBlock**)param_2, param_1, param_2, 0, param_3, (void*)0x0);
      return uVar1;
   }
   if (param_2[0x4c] != (VmaAllocation_T)0x2) {
      return 0xfffffff3;
   ...
   /* WARNING: Treating indirect jump as call */
   uVar1 = ( **(code**)( param_1 + 0x1698 ) )(*(undefined8*)( param_1 + 0x10 ), param_3, *(undefined8*)( param_2 + 8 ), 0);
   return uVar1;
}undefined8 vmaBindBufferMemory2(VmaAllocator_T *param_1, VmaAllocation_T *param_2, ulong param_3, VkBuffer_T *param_4, void *param_5) {
   undefined8 uVar1;
   if (param_2[0x4c] == (VmaAllocation_T)0x1) {
      uVar1 = VmaDeviceMemoryBlock::BindBufferMemory(*(VmaDeviceMemoryBlock**)param_2, param_1, param_2, param_3, param_4, param_5);
      return uVar1;
   }
   if (param_2[0x4c] != (VmaAllocation_T)0x2) {
      return 0xfffffff3;
   }
   uVar1 = VmaAllocator_T::BindVulkanBuffer(param_1, *(VkDeviceMemory_T**)( param_2 + 8 ), param_3, param_4, param_5);
   return uVar1;
}undefined8 vmaBindImageMemory(VmaAllocator_T *param_1, VmaAllocation_T *param_2, VkImage_T *param_3) {
   undefined8 uVar1;
   if (param_2[0x4c] == (VmaAllocation_T)0x1) {
      uVar1 = VmaDeviceMemoryBlock::BindImageMemory(*(VmaDeviceMemoryBlock**)param_2, param_1, param_2, 0, param_3, (void*)0x0);
      return uVar1;
   }
   if (param_2[0x4c] != (VmaAllocation_T)0x2) {
      return 0xfffffff3;
   ...
   /* WARNING: Treating indirect jump as call */
   uVar1 = ( **(code**)( param_1 + 0x16a0 ) )(*(undefined8*)( param_1 + 0x10 ), param_3, *(undefined8*)( param_2 + 8 ), 0);
   return uVar1;
}undefined8 vmaBindImageMemory2(VmaAllocator_T *param_1, VmaAllocation_T *param_2, ulong param_3, VkImage_T *param_4, void *param_5) {
   undefined8 uVar1;
   if (param_2[0x4c] == (VmaAllocation_T)0x1) {
      uVar1 = VmaDeviceMemoryBlock::BindImageMemory(*(VmaDeviceMemoryBlock**)param_2, param_1, param_2, param_3, param_4, param_5);
      return uVar1;
   }
   if (param_2[0x4c] != (VmaAllocation_T)0x2) {
      return 0xfffffff3;
   }
   uVar1 = VmaAllocator_T::BindVulkanImage(param_1, *(VkDeviceMemory_T**)( param_2 + 8 ), param_3, param_4, param_5);
   return uVar1;
}ulong vmaCreateAliasingBuffer2(VmaAllocator_T *param_1, VmaAllocation_T *param_2, ulong param_3, long param_4, undefined8 *param_5) {
   long lVar1;
   uint uVar2;
   ulong uVar3;
   VmaAllocator_T *pVVar4;
   ...
   *param_5 = 0;
   ...
   if (( ( *(byte*)( param_4 + 0x22 ) & 2 ) == 0 ) || ( param_1[0xc] != (VmaAllocator_T)0x0 )) {
      ...
      if (-1 < (int)uVar3) {
         uVar2 = VmaAllocator_T::BindBufferMemory(param_1, param_2, param_3, (VkBuffer_T*)*param_5, (void*)0x0);
         if ((int)uVar2 < 0) {
            pVVar4 = (VmaAllocator_T*)0x0;
            if (param_1[0x20] != (VmaAllocator_T)0x0) {
               pVVar4 = param_1 + 0x28;
   ...
   return uVar3;
}void vmaCreateAliasingBuffer(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4) {
   vmaCreateAliasingBuffer2(param_1, param_2, 0, param_3, param_4);
   return;
}ulong vmaCreateAliasingImage2(VmaAllocator_T *param_1, VmaAllocation_T *param_2, ulong param_3, long param_4, undefined8 *param_5) {
   int iVar1;
   uint uVar2;
   ulong uVar3;
   VmaAllocator_T *pVVar4;
   ...
   *param_5 = 0;
   ...
   if (( ( ( *(int*)( param_4 + 0x20 ) == 0 ) || ( *(int*)( param_4 + 0x24 ) == 0 ) ) || ( *(int*)( param_4 + 0x28 ) == 0 ) ) || ( *(int*)( param_4 + 0x2c ) == 0 )) {
      uVar3 = 0xfffffffd;
   } else {
      pVVar4 = (VmaAllocator_T*)0x0;
      if (param_1[0x20] != (VmaAllocator_T)0x0) {
      ...
      if (-1 < (int)uVar3) {
         uVar2 = VmaAllocator_T::BindImageMemory(param_1, param_2, param_3, (VkImage_T*)*param_5, (void*)0x0);
         if ((int)uVar2 < 0) {
            pVVar4 = (VmaAllocator_T*)0x0;
            if (param_1[0x20] != (VmaAllocator_T)0x0) {
               pVVar4 = param_1 + 0x28;
   ...
   return uVar3;
}void vmaCreateAliasingImage(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4) {
   ...
   *param_2 = this;
   ...
   ( **(code**)( **(long**)( param_1 + 0x38 ) + 0x40 ) )();
   return;
}void VmaVirtualBlock_T::vmaVirtualAllocate(VmaVirtualBlock_T *this, VmaVirtualAllocationCreateInfo *param_1, VmaVirtualAllocation_T **param_2, ulong *param_3) {
   ...
   *(undefined1(*) [16])( param_2 + 1 ) = (undefined1[16])0x0;
   ...
   ( **(code**)( *plVar1 + 0x78 ) )();
   return;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void vmaCalculateVirtualBlockStatistics(long param_1, undefined8 *param_2) {
   long *plVar1;
   long lVar2;
   undefined8 uVar3;
   undefined8 uVar4;
   ...
   *(undefined4*)( param_2 + 3 ) = 0;
   ...
   free(param_2);
   return;
}/* VmaStringBuilder::Add(char const*) */void VmaStringBuilder::Add(VmaStringBuilder *this, char *param_1) {
   long lVar1;
   size_t __n;
   __n = strlen(param_1);
   if (__n == 0) {
   ...
   VmaVector<char,VmaStlAllocator<char>>::resize((VmaVector<char,VmaStlAllocator<char>>*)this, __n + lVar1);
   memcpy((void*)( *(long*)( this + 8 ) + lVar1 ), param_1, __n);
   return;
}/* VmaStringBuilder::AddNumber(unsigned int) */void VmaStringBuilder::AddNumber(VmaStringBuilder *this, uint param_1) {
   bool bVar1;
   char *pcVar2;
   long in_FS_OFFSET;
   char local_12[2];
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* VmaStringBuilder::AddNumber(unsigned long) */void VmaStringBuilder::AddNumber(VmaStringBuilder *this, ulong param_1) {
   bool bVar1;
   char *pcVar2;
   long in_FS_OFFSET;
   char local_15[5];
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* VmaStringBuilder::AddPointer(void const*) */void VmaStringBuilder::AddPointer(VmaStringBuilder *this, void *param_1) {
   long in_FS_OFFSET;
   char acStack_38[24];
   long local_20;
   local_20 = *(long*)( in_FS_OFFSET + 0x28 );
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* VmaJsonWriter::ContinueString_Pointer(void const*) */void VmaJsonWriter::ContinueString_Pointer(VmaJsonWriter *this, void *param_1) {
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* VmaJsonWriter::ContinueString(unsigned long) */void VmaJsonWriter::ContinueString(VmaJsonWriter *this, ulong param_1) {
   VmaStringBuilder *this_00;
   bool bVar1;
   char *pcVar2;
   long in_FS_OFFSET;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* VmaJsonWriter::ContinueString(unsigned int) */void VmaJsonWriter::ContinueString(VmaJsonWriter *this, uint param_1) {
   VmaStringBuilder *this_00;
   bool bVar1;
   char *pcVar2;
   long in_FS_OFFSET;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* VmaJsonWriter::ContinueString(char const*) */void VmaJsonWriter::ContinueString(VmaJsonWriter *this, char *param_1) {
   byte *pbVar1;
   byte bVar2;
   ...
   return;
}/* VmaJsonWriter::EndString(char const*) */void VmaJsonWriter::EndString(VmaJsonWriter *this, char *param_1) {
   VmaVector<char,VmaStlAllocator<char>> *this_00;
   long lVar1;
   ...
   *(undefined1*)( *(long*)( this_00 + 8 ) + lVar1 ) = 0x22;
   this[0x28] = (VmaJsonWriter)0x0;
   return;
}/* VmaJsonWriter::WriteIndent(bool) */void VmaJsonWriter::WriteIndent(VmaJsonWriter *this, bool param_1) {
   VmaVector<char,VmaStlAllocator<char>> *this_00;
   long lVar1;
   long lVar2;
   if (*(long*)( this + 0x18 ) == 0) {
   ...
   return;
}/* VmaJsonWriter::BeginValue(bool) */void VmaJsonWriter::BeginValue(bool param_1) {
   int *piVar1;
   ...
   piVar1[1] = piVar1[1] + 1;
   return;
}/* VmaJsonWriter::BeginString(char const*) */void VmaJsonWriter::BeginString(VmaJsonWriter *this, char *param_1) {
   VmaVector<char,VmaStlAllocator<char>> *this_00;
   long lVar1;
   ...
   *(undefined1*)( *(long*)( this_00 + 8 ) + lVar1 ) = 0x22;
   ...
   return;
}/* VmaJsonWriter::WriteString(char const*) */void VmaJsonWriter::WriteString(VmaJsonWriter *this, char *param_1) {
   VmaVector<char,VmaStlAllocator<char>> *this_00;
   long lVar1;
   ...
   *(undefined1*)( *(long*)( this_00 + 8 ) + lVar1 ) = 0x22;
   this[0x28] = (VmaJsonWriter)0x0;
   return;
}/* VmaJsonWriter::WriteNumber(unsigned int) */void VmaJsonWriter::WriteNumber(VmaJsonWriter *this, uint param_1) {
   VmaStringBuilder *this_00;
   uint uVar1;
   ulong uVar2;
   char *pcVar3;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* VmaJsonWriter::WriteNumber(unsigned long) */void VmaJsonWriter::WriteNumber(VmaJsonWriter *this, ulong param_1) {
   VmaStringBuilder *this_00;
   bool bVar1;
   char *pcVar2;
   long in_FS_OFFSET;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* VmaJsonWriter::WriteBool(bool) */void VmaJsonWriter::WriteBool(VmaJsonWriter *this, bool param_1) {
   char *pcVar1;
   BeginValue(SUB81(this, 0));
   pcVar1 = "false";
   if (param_1) {
   ...
   return;
}/* VmaJsonWriter::WriteNull() */void VmaJsonWriter::WriteNull(VmaJsonWriter *this) {
   int *piVar1;
   if (*(long*)( this + 0x18 ) != 0) {
      piVar1 = (int*)( *(long*)( this + 0x10 ) + -0xc + *(long*)( this + 0x18 ) * 0xc );
      if (( *piVar1 == 0 ) && ( ( piVar1[1] & 1U ) != 0 )) {
   ...
   return;
}/* VmaAllocation_T::PrintParameters(VmaJsonWriter&) const */void VmaAllocation_T::PrintParameters(VmaAllocation_T *this, VmaJsonWriter *param_1) {
   ...
   *(undefined1*)( *(long*)( pVVar1 + 8 ) + lVar2 ) = 0x22;
   ...
   VmaJsonWriter::BeginString(param_1, *(char**)( VMA_SUBALLOCATION_TYPE_NAMES + (ulong)(byte)this[0x4d] * 8 ));
   pVVar1 = *(VmaVector<char,VmaStlAllocator<char>>**)param_1;
   lVar2 = *(long*)( pVVar1 + 0x10 );
   VmaVector<char,VmaStlAllocator<char>>::resize(pVVar1, lVar2 + 1);
   *(undefined1*)( *(long*)( pVVar1 + 8 ) + lVar2 ) = 0x22;
   ...
   *(undefined1*)( *(long*)( pVVar1 + 8 ) + lVar2 ) = 0x22;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* VmaBlockMetadata_Linear::Clear() */void VmaBlockMetadata_Linear::Clear(VmaBlockMetadata_Linear *this) {
   *(undefined8*)( this + 0x28 ) = *(undefined8*)( this + 8 );
   VmaVector<VmaSuballocation,VmaStlAllocator<VmaSuballocation>>::resize((VmaVector<VmaSuballocation,VmaStlAllocator<VmaSuballocation>>*)( this + 0x30 ), 0);
   VmaVector<VmaSuballocation,VmaStlAllocator<VmaSuballocation>>::resize((VmaVector<VmaSuballocation,VmaStlAllocator<VmaSuballocation>>*)( this + 0x50 ), 0);
   *(undefined4*)( this + 0x74 ) = 0;
   *(undefined8*)( this + 0x88 ) = 0;
   *(undefined1(*) [16])( this + 0x78 ) = (undefined1[16])0x0;
   return;
}/* VmaBlockMetadata_Linear::CleanupAfterFree() */void VmaBlockMetadata_Linear::CleanupAfterFree(VmaBlockMetadata_Linear *this) {
   undefined8 *puVar1;
   undefined8 *puVar2;
   int iVar3;
   code *pcVar4;
   ...
   if (pcVar4 == IsEmpty) {
      ...
      if (pcVar4 == GetAllocationCount) {
         lVar7 = ( *(long*)( this_00 + 0x10 ) - ( *(long*)( this + 0x80 ) + *(long*)( this + 0x78 ) + *(long*)( this + 0x88 ) ) ) + *(long*)( (VmaVector<VmaSuballocation,VmaStlAllocator<VmaSuballocation>>*)this_01 + 0x10 );
      } else {
         lVar7 = ( *pcVar4 )(this);
      }
      if (lVar7 == 0) {
         LAB_0010a93c:VmaVector<VmaSuballocation,VmaStlAllocator<VmaSuballocation>>::resize(this_00, 0);
         VmaVector<VmaSuballocation,VmaStlAllocator<VmaSuballocation>>::resize((VmaVector<VmaSuballocation,VmaStlAllocator<VmaSuballocation>>*)this_01, 0);
         *(undefined4*)( this + 0x74 ) = 0;
         *(undefined8*)( this + 0x88 ) = 0;
         *(undefined1(*) [16])( this + 0x78 ) = (undefined1[16])0x0;
         return;
   ...
   while (lVar8 != 0) {
      ...
      *(long*)( this + 0x88 ) = lVar8 + -1;
      VmaVector<VmaSuballocation,VmaStlAllocator<VmaSuballocation>>::resize((VmaVector<VmaSuballocation,VmaStlAllocator<VmaSuballocation>>*)this_01, lVar9 - 1);
      LAB_0010a71a:lVar8 = *(long*)( this + 0x88 );
   };
   LAB_0010a726:uVar10 = *(ulong*)( this + 0x78 );
   pVVar13 = this + 0x50;
   if (*(int*)( this + 0x70 ) == 0) {
      pVVar13 = this + 0x30;
   }
   if (( 0x20 < *(ulong*)( pVVar13 + 0x10 ) ) && ( ( *(ulong*)( pVVar13 + 0x10 ) - ( *(long*)( this + 0x80 ) + uVar10 ) ) * 3 <= ( *(long*)( this + 0x80 ) + uVar10 ) * 2 )) {
   ...
   if (*(long*)( (VmaVector<VmaSuballocation,VmaStlAllocator<VmaSuballocation>>*)this_01 + 0x10 ) == 0) {
      *(undefined4*)( this + 0x74 ) = 0;
      uVar11 = *(ulong*)( this_00 + 0x10 );
   } else {
      uVar11 = *(ulong*)( this_00 + 0x10 );
   ...
   if (uVar11 == uVar10) {
      ...
      lVar7 = *(long*)( (VmaVector<VmaSuballocation,VmaStlAllocator<VmaSuballocation>>*)this_01 + 0x10 );
   ...
   return;
   LAB_0010a84f:if (*(int*)( (long)__dest + 0x18 ) != 0) goto LAB_0010a726;
   lVar9 = *(long*)( (VmaVector<VmaSuballocation,VmaStlAllocator<VmaSuballocation>>*)this_01 + 0x10 );
   *(long*)( this + 0x88 ) = lVar8 + -1;
   uVar10 = lVar9 - 1;
   if (uVar10 != 0) {
   ...
   VmaVector<VmaSuballocation,VmaStlAllocator<VmaSuballocation>>::resize((VmaVector<VmaSuballocation,VmaStlAllocator<VmaSuballocation>>*)this_01, uVar10);
   lVar8 = *(long*)( this + 0x88 );
   if (lVar8 == 0) goto LAB_0010a726;
   __dest = *(void**)( (VmaVector<VmaSuballocation,VmaStlAllocator<VmaSuballocation>>*)this_01 + 8 );
   goto LAB_0010a84f;
}/* VmaBlockMetadata_Linear::Free(VmaAllocHandle_T*) */void VmaBlockMetadata_Linear::Free(VmaBlockMetadata_Linear *this, VmaAllocHandle_T *param_1) {
   ...
   if (lVar3 != 0) {
      ...
      puVar8 = (undefined8*)( lVar9 * 0x20 + *(long*)( (VmaVector<VmaSuballocation,VmaStlAllocator<VmaSuballocation>>*)this_00 + 8 ) );
   ...
   if (iVar2 - 1U < 2) {
      lVar9 = *(long*)( (VmaVector<VmaSuballocation,VmaStlAllocator<VmaSuballocation>>*)this_01 + 0x10 );
      ppVVar14 = *(VmaSuballocation***)( (VmaVector<VmaSuballocation,VmaStlAllocator<VmaSuballocation>>*)this_01 + 8 );
      lVar13 = lVar9 * 0x20;
      ...
      pVVar12 = (VmaSuballocation*)( *(long*)( (VmaVector<VmaSuballocation,VmaStlAllocator<VmaSuballocation>>*)this_00 + 8 ) + lVar3 * 0x20 );
      pVVar4 = VmaBinaryFindSorted<VmaSuballocationOffsetLess,VmaSuballocation*,VmaSuballocation>((VmaSuballocation**)( *(long*)( (VmaVector<VmaSuballocation,VmaStlAllocator<VmaSuballocation>>*)this_00 + 8 ) + *(long*)( this + 0x78 ) * 0x20 ), (VmaSuballocation**)pVVar12, pVVar1, pVVar6);
      if (pVVar12 == pVVar4) {
         if (iVar2 != 1) goto LAB_0010aae3;
         pVVar12 = (VmaSuballocation*)( lVar13 + (long)ppVVar14 );
         pVVar4 = VmaBinaryFindSorted<VmaSuballocationOffsetLess,VmaSuballocation*,VmaSuballocation>(ppVVar14, (VmaSuballocation**)pVVar12, pVVar1, pVVar6);
         if (pVVar4 == pVVar12) {
            return;
         }
         goto LAB_0010ab5a;
      }
      LAB_0010aa19:*(undefined4*)( pVVar4 + 0x18 ) = 0;
      *(VmaSuballocation**)( pVVar4 + 0x10 ) = (VmaSuballocation*)0x0;
      *(long*)( this + 0x80 ) = *(long*)( this + 0x80 ) + 1;
   } else {
      pVVar6 = *(VmaSuballocationOffsetLess**)( (VmaVector<VmaSuballocation,VmaStlAllocator<VmaSuballocation>>*)this_00 + 8 );
      lVar9 = lVar3 * 0x20;
      if (iVar2 == 0) {
         if (*(VmaSuballocation**)( pVVar6 + lVar9 + -0x20 ) == pVVar1) {
            *(long*)( this + 0x28 ) = *(long*)( this + 0x28 ) + *(long*)( pVVar6 + lVar9 + -0x20 + 8 );
            VmaVector<VmaSuballocation,VmaStlAllocator<VmaSuballocation>>::resize((VmaVector<VmaSuballocation,VmaStlAllocator<VmaSuballocation>>*)this_00, lVar3 - 1);
            goto LAB_0010aa38;
         }
         pVVar11 = pVVar6 + lVar9;
         pVVar4 = VmaBinaryFindSorted<VmaSuballocationOffsetLess,VmaSuballocation*,VmaSuballocation>((VmaSuballocation**)( pVVar6 + *(long*)( this + 0x78 ) * 0x20 ), (VmaSuballocation**)pVVar11, pVVar1, pVVar6);
      ...
      ppVVar14 = *(VmaSuballocation***)( (VmaVector<VmaSuballocation,VmaStlAllocator<VmaSuballocation>>*)this_01 + 8 );
      lVar13 = *(long*)( (VmaVector<VmaSuballocation,VmaStlAllocator<VmaSuballocation>>*)this_01 + 0x10 ) << 5;
      LAB_0010aae3:uVar10 = 0;
      uVar5 = lVar13 >> 5;
      ...
      LAB_0010ab5a:*(undefined4*)( pVVar4 + 0x18 ) = 0;
      *(VmaSuballocation**)( pVVar4 + 0x10 ) = (VmaSuballocation*)0x0;
      *(long*)( this + 0x88 ) = *(long*)( this + 0x88 ) + 1;
   }
   *(VmaSuballocation**)( this + 0x28 ) = *(VmaSuballocation**)( pVVar4 + 8 ) + *(long*)( this + 0x28 );
   LAB_0010aa38:CleanupAfterFree(this);
   return;
}/* VmaBlockMetadata_Linear::Alloc(VmaAllocationRequest const&, VmaSuballocationType, void*) */void VmaBlockMetadata_Linear::Alloc(VmaBlockMetadata_Linear *this, long *param_1, undefined4 param_3, long param_4) {
   int iVar1;
   long lVar2;
   long lVar3;
   long lVar4;
   ...
   if (iVar1 == 3) {
      ...
      if (iVar1 != 4) {
         if (iVar1 == 2) {
            ...
            VmaVector<VmaSuballocation,VmaStlAllocator<VmaSuballocation>>::resize((VmaVector<VmaSuballocation,VmaStlAllocator<VmaSuballocation>>*)pVVar6, lVar4 + 1);
            plVar5 = (long*)( lVar4 * 0x20 + *(long*)( (VmaVector<VmaSuballocation,VmaStlAllocator<VmaSuballocation>>*)pVVar6 + 8 ) );
            plVar5[2] = param_4;
   ...
   *plVar5 = lVar2 + -1;
   plVar5[1] = lVar3;
   LAB_0010acdc:*(long*)( this + 0x28 ) = *(long*)( this + 0x28 ) - lVar3;
   return;
}/* VmaBlockMetadata_TLSF::Clear() */void VmaBlockMetadata_TLSF::Clear(VmaBlockMetadata_TLSF *this) {
   undefined8 uVar1;
   Block *pBVar2;
   void *__s;
   uint uVar3;
   ...
   *puVar6 = 0;
   ...
   if (pBVar5 != (Block*)0x0) {
      do {
         ...
         VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>::Free((VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>*)( this + 0x140 ), pBVar5);
         pBVar5 = pBVar2;
   ...
   if (uVar3 < 8) {
      ...
      *(undefined8*)( this + uVar4 + 0x40 ) = 0;
      ...
      for (uVar4 = ( ulong )(uVar3 + ( ( (int)this + 0x48 ) - (int)(undefined8*)( ( ulong )(this + 0x50) & 0xfffffffffffffff8 ) ) >> 3); uVar4 != 0; uVar4 = uVar4 - 1) {
         *puVar6 = 0;
         puVar6 = puVar6 + (ulong)bVar7 * -2 + 1;
      }
   }
   __s = *(void**)( this + 0x188 );
   joined_r0x0010ae05:if (__s == (void*)0x0) {
      return;
   }
    ...
    */void VmaBlockMetadata_TLSF::MergeBlock(VmaBlockMetadata_TLSF *this, Block *param_1, Block *param_2) {
   undefined8 uVar1;
   long lVar2;
   long lVar3;
   lVar2 = *(long*)( param_2 + 8 );
   ...
   *(long*)( param_1 + 8 ) = lVar2 + *(long*)( param_1 + 8 );
   ...
   VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>::Free((VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>*)( this + 0x140 ), param_2);
   return;
}/* VmaBlockMetadata_TLSF::Free(VmaAllocHandle_T*) */void VmaBlockMetadata_TLSF::Free(VmaBlockMetadata_TLSF *this, VmaAllocHandle_T *param_1) {
   undefined8 uVar1;
   Block *pBVar2;
   Block *pBVar3;
   long lVar4;
   ...
   if (this[0x20] == (VmaBlockMetadata_TLSF)0x0) {
      VmaBlockBufferImageGranularity::FreePages((VmaBlockBufferImageGranularity*)( this + 0x178 ), *(ulong*)param_1, *(ulong*)( param_1 + 8 ));
   }
   pBVar3 = *(Block**)( param_1 + 0x10 );
   *(long*)( this + 0x28 ) = *(long*)( this + 0x28 ) + -1;
   if (( ( pBVar3 != (Block*)0x0 ) && ( pBVar3 != *(Block**)( pBVar3 + 0x20 ) ) ) && ( *(long*)( pBVar3 + 8 ) != 0 )) {
      ...
      *(long*)( param_1 + 8 ) = lVar4 + *(long*)( param_1 + 8 );
      ...
      VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>::Free((VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>*)( this + 0x140 ), pBVar3);
   }
   if (pBVar2 != *(Block**)( pBVar2 + 0x20 )) {
      if (*(Block**)( this + 0x170 ) == pBVar2) {
         ...
         *(long*)( pBVar2 + 8 ) = lVar4 + *(long*)( pBVar2 + 8 );
         ...
         VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>::Free((VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>*)( this + 0x140 ), (Block*)param_1);
         return;
      }
   ...
   return;
}/* VmaJsonWriter::BeginArray(bool) */void VmaJsonWriter::BeginArray(VmaJsonWriter *this, bool param_1) {
   VmaVector<char,VmaStlAllocator<char>> *this_00;
   long lVar1;
   long lVar2;
   BeginValue(SUB81(this, 0));
   ...
   *(undefined1*)( *(long*)( this_00 + 8 ) + lVar1 ) = 0x5b;
   lVar1 = *(long*)( this + 0x18 );
   VmaVector<VmaJsonWriter::StackItem,VmaStlAllocator<VmaJsonWriter::StackItem>>::resize((VmaVector<VmaJsonWriter::StackItem,VmaStlAllocator<VmaJsonWriter::StackItem>>*)( this + 8 ), lVar1 + 1);
   lVar2 = *(long*)( this + 0x10 );
   ...
   *(bool*)( lVar2 + 8 + lVar1 * 0xc ) = param_1;
   ...
   long) const */void VmaBlockMetadata::PrintDetailedMap_Begin(VmaBlockMetadata *this, VmaJsonWriter *param_1, ulong param_2, ulong param_3, ulong param_4) {
   VmaVector<char,VmaStlAllocator<char>> *pVVar1;
   long lVar2;
   VmaStringBuilder *pVVar3;
   bool bVar4;
   ...
   *(undefined1*)( *(long*)( pVVar1 + 8 ) + lVar2 ) = 0x22;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* VmaJsonWriter::EndObject() */void VmaJsonWriter::EndObject(VmaJsonWriter *this) {
   VmaVector<char,VmaStlAllocator<char>> *this_00;
   long lVar1;
   ...
   *(undefined1*)( *(long*)( this_00 + 8 ) + lVar1 ) = 0x7d;
   VmaVector<VmaJsonWriter::StackItem,VmaStlAllocator<VmaJsonWriter::StackItem>>::resize((VmaVector<VmaJsonWriter::StackItem,VmaStlAllocator<VmaJsonWriter::StackItem>>*)( this + 8 ), *(long*)( this + 0x18 ) - 1);
   return;
}/* VmaJsonWriter::EndArray() */void VmaJsonWriter::EndArray(VmaJsonWriter *this) {
   VmaVector<char,VmaStlAllocator<char>> *this_00;
   long lVar1;
   WriteIndent(this, true);
   this_00 = *(VmaVector<char,VmaStlAllocator<char>>**)this;
   ...
   *(undefined1*)( *(long*)( this_00 + 8 ) + lVar1 ) = 0x5d;
   VmaVector<VmaJsonWriter::StackItem,VmaStlAllocator<VmaJsonWriter::StackItem>>::resize((VmaVector<VmaJsonWriter::StackItem,VmaStlAllocator<VmaJsonWriter::StackItem>>*)( this + 8 ), *(long*)( this + 0x18 ) - 1);
   return;
}/* VmaBlockMetadata::PrintDetailedMap_End(VmaJsonWriter&) const */void VmaBlockMetadata::PrintDetailedMap_End(VmaBlockMetadata *this, VmaJsonWriter *param_1) {
   VmaJsonWriter::EndArray(param_1);
   return;
}/* VmaJsonWriter::BeginObject(bool) */void VmaJsonWriter::BeginObject(VmaJsonWriter *this, bool param_1) {
   undefined8 *puVar1;
   VmaVector<char,VmaStlAllocator<char>> *this_00;
   long lVar2;
   BeginValue(SUB81(this, 0));
   ...
   *(undefined1*)( *(long*)( this_00 + 8 ) + lVar2 ) = 0x7b;
   ...
   VmaVector<VmaJsonWriter::StackItem,VmaStlAllocator<VmaJsonWriter::StackItem>>::resize((VmaVector<VmaJsonWriter::StackItem,VmaStlAllocator<VmaJsonWriter::StackItem>>*)( this + 8 ), lVar2 + 1);
   ...
   *(bool*)( puVar1 + 1 ) = param_1;
   ...
   void*) const */void VmaBlockMetadata::PrintDetailedMap_Allocation(VmaBlockMetadata *this, VmaJsonWriter *param_1, ulong param_2, ulong param_3, void *param_4) {
   VmaVector<char,VmaStlAllocator<char>> *pVVar1;
   long lVar2;
   VmaStringBuilder *pVVar3;
   bool bVar4;
   ...
   *(undefined1*)( *(long*)( pVVar1 + 8 ) + lVar2 ) = 0x22;
   ...
   const */void VmaBlockMetadata::PrintDetailedMap_UnusedRange(VmaBlockMetadata *this, VmaJsonWriter *param_1, ulong param_2, ulong param_3) {
   VmaVector<char,VmaStlAllocator<char>> *pVVar1;
   long lVar2;
   VmaStringBuilder *pVVar3;
   bool bVar4;
   ...
   *(undefined1*)( *(long*)( pVVar1 + 8 ) + lVar2 ) = 0x22;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* VmaBlockMetadata_Linear::PrintDetailedMap(VmaJsonWriter&) const */void VmaBlockMetadata_Linear::PrintDetailedMap(VmaBlockMetadata_Linear *this, VmaJsonWriter *param_1) {
   int iVar1;
   ulong uVar2;
   ulong uVar3;
   ulong uVar4;
   ...
   if (iVar1 == 1) {
      ...
      LAB_0010bd94:uVar15 = uVar2;
      if (uVar7 < uVar2) {
         LAB_0010b902:lVar13 = 0;
         do {
            if (uVar6 <= uVar5) {
               LAB_0010b970:uVar12 = uVar12 + 1;
               uVar7 = uVar15;
               break;
            }
      ...
      uVar12 = 0;
      uVar10 = 0;
      joined_r0x0010bc8c:while (uVar7 < uVar2) {
         uVar16 = uVar16 - 1;
         if (uVar16 == 0xffffffffffffffff) {
            LAB_0010bcf8:uVar12 = uVar12 + 1;
            break;
         }
      ...
      LAB_0010b981:uVar10 = uVar10 + lVar13;
   }
   VmaBlockMetadata::PrintDetailedMap_Begin((VmaBlockMetadata*)this, param_1, uVar2 - lVar11, uVar10, uVar12);
   uVar5 = 0;
   if (*(int*)( this + 0x74 ) == 1) {
      ...
      do {
         if (uVar8 <= uVar12) {
            LAB_0010bc10:VmaBlockMetadata::PrintDetailedMap_UnusedRange((VmaBlockMetadata*)this, param_1, uVar5, uVar7 - uVar5);
            uVar5 = uVar7;
            break;
         }
         ...
         uVar16 = *puVar14;
         if (uVar5 < uVar16) {
            VmaBlockMetadata::PrintDetailedMap_UnusedRange((VmaBlockMetadata*)this, param_1, uVar5, uVar16 - uVar5);
            uVar16 = *puVar14;
         }
         uVar12 = uVar12 + 1;
         VmaBlockMetadata::PrintDetailedMap_Allocation((VmaBlockMetadata*)this, param_1, uVar16, puVar14[1], (void*)puVar14[2]);
   ...
   uVar7 = uVar5;
   while (uVar7 < uVar15) {
      LAB_0010b9b8:if (uVar6 <= uVar16) {
         LAB_0010baf8:VmaBlockMetadata::PrintDetailedMap_UnusedRange((VmaBlockMetadata*)this, param_1, uVar7, uVar15 - uVar7);
         iVar1 = *(int*)( this + 0x74 );
         uVar7 = uVar15;
      ...
      uVar8 = *puVar14;
      if (uVar7 < uVar8) {
         VmaBlockMetadata::PrintDetailedMap_UnusedRange((VmaBlockMetadata*)this, param_1, uVar7, uVar8 - uVar7);
         uVar8 = *puVar14;
      }
      uVar16 = uVar16 + 1;
      VmaBlockMetadata::PrintDetailedMap_Allocation((VmaBlockMetadata*)this, param_1, uVar8, puVar14[1], (void*)puVar14[2]);
      uVar7 = puVar14[1] + *puVar14;
   };
   iVar1 = *(int*)( this + 0x74 );
   joined_r0x0010bb10:if (iVar1 == 2) {
      lVar11 = *(long*)( local_58 + 0x10 );
      while (uVar7 < uVar2) {
         lVar11 = lVar11 + -1;
         if (lVar11 == -1) {
            LAB_0010bad8:VmaBlockMetadata::PrintDetailedMap_UnusedRange((VmaBlockMetadata*)this, param_1, uVar7, uVar2 - uVar7);
            break;
         }
         ...
         uVar6 = *puVar14;
         if (uVar7 < uVar6) {
            VmaBlockMetadata::PrintDetailedMap_UnusedRange((VmaBlockMetadata*)this, param_1, uVar7, uVar6 - uVar7);
            uVar6 = *puVar14;
         }
         VmaBlockMetadata::PrintDetailedMap_Allocation((VmaBlockMetadata*)this, param_1, uVar6, puVar14[1], (void*)puVar14[2]);
         uVar7 = puVar14[1] + *puVar14;
      };
   }
   LAB_0010bb16:VmaJsonWriter::EndArray(param_1);
   return;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* VmaBlockMetadata_TLSF::PrintDetailedMap(VmaJsonWriter&) const */void VmaBlockMetadata_TLSF::PrintDetailedMap(VmaBlockMetadata_TLSF *this, VmaJsonWriter *param_1) {
   undefined8 *puVar1;
   long lVar2;
   ulong *puVar3;
   void *__ptr;
   ...
   uVar4 = uVar5;
   for (lVar2 = *(long*)( *(long*)( this + 0x170 ) + 0x10 ); lVar2 != 0; lVar2 = *(long*)( lVar2 + 0x10 )) {
      uVar4 = uVar4 - 1;
   ...
   VmaBlockMetadata::PrintDetailedMap_Begin((VmaBlockMetadata*)this, param_1, local_80._0_8_ - local_80._8_8_, local_88 >> 0x20, (ulong)local_70);
   if (uVar4 < uVar5) {
      do {
         while (true) {
            ...
            uVar4 = uVar4 + 1;
            VmaBlockMetadata::PrintDetailedMap_Allocation((VmaBlockMetadata*)this, param_1, *puVar3, puVar3[1], (void*)puVar3[5]);
            if (uVar5 == uVar4) goto LAB_0010becd;
         };
         uVar4 = uVar4 + 1;
         VmaBlockMetadata::PrintDetailedMap_UnusedRange((VmaBlockMetadata*)this, param_1, *puVar3, puVar3[1]);
      } while ( uVar5 != uVar4 );
   }
   LAB_0010becd:uVar5 = ( *(ulong**)( this + 0x170 ) )[1];
   if (uVar5 != 0) {
      VmaBlockMetadata::PrintDetailedMap_UnusedRange((VmaBlockMetadata*)this, param_1, **(ulong**)( this + 0x170 ), uVar5);
   }
   VmaJsonWriter::EndArray(param_1);
   if (( puVar1 == (undefined8*)0x0 ) || ( (code*)puVar1[3] == (code*)0x0 )) {
      free(__ptr);
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* VmaPrintDetailedStatistics(VmaJsonWriter&, VmaDetailedStatistics const&) */void VmaPrintDetailedStatistics(VmaJsonWriter *param_1, VmaDetailedStatistics *param_2) {
   VmaVector<char,VmaStlAllocator<char>> *pVVar1;
   long lVar2;
   VmaStringBuilder *pVVar3;
   bool bVar4;
   ...
   *(undefined1*)( *(long*)( pVVar1 + 8 ) + lVar2 ) = 0x22;
   ...
   VmaJsonWriter::EndObject(param_1);
   return;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* VmaVirtualBlock_T::BuildStatsString(bool, VmaStringBuilder&) const */void VmaVirtualBlock_T::BuildStatsString(VmaVirtualBlock_T *this, bool param_1, VmaStringBuilder *param_2) {
   long lVar1;
   ...
   uStack_50 = _UNK_00115398;
   local_88 = 0;
   ( **(code**)( **(long**)( this + 0x38 ) + 0x70 ) )(*(long**)( this + 0x38 ), (VmaDetailedStatistics*)&local_88);
   VmaJsonWriter::BeginString((VmaJsonWriter*)&local_b8, "Stats");
   pVVar2 = local_b8;
   lVar1 = *(long*)( local_b8 + 0x10 );
   VmaVector<char,VmaStlAllocator<char>>::resize((VmaVector<char,VmaStlAllocator<char>>*)local_b8, lVar1 + 1);
   *(undefined1*)( *(long*)( pVVar2 + 8 ) + lVar1 ) = 0x22;
   ...
   if (*param_1 == (VmaVirtualBlock_T)0x0) {
      ...
      if ((void*)local_58._8_8_ != (void*)0x0) {
         ...
         LAB_0010c7aa:__dest = (void*)aligned_alloc(1, lVar2);
         goto LAB_0010c70f;
      }
   } else {
      local_58._8_8_ = 0;
      ...
      if ((void*)local_58._8_8_ != (void*)0x0) {
         ...
         LAB_0010c70f:pvVar1 = memcpy(__dest, pvVar1, __n);
   ...
   *param_2 = 0;
   pvVar1 = (void*)0x0;
   joined_r0x0010c78e:if (( (undefined8*)local_58._0_8_ == (undefined8*)0x0 ) || ( *(code**)( local_58._0_8_ + 0x18 ) == (code*)0x0 )) {
      free(pvVar1);
   } else {
   ...
   return;
}/* VmaBlockVector::PrintDetailedMap(VmaJsonWriter&) */void VmaBlockVector::PrintDetailedMap(VmaBlockVector *this, VmaJsonWriter *param_1) {
   long lVar1;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* VmaDedicatedAllocationList::BuildStatsString(VmaJsonWriter&) */void VmaDedicatedAllocationList::BuildStatsString(VmaDedicatedAllocationList *this, VmaJsonWriter *param_1) {
   int iVar1;
   ...
   LAB_0010cae6:pthread_rwlock_unlock(__rwlock);
   return;
}/* VmaAllocator_T::PrintDetailedMap(VmaJsonWriter&) */void VmaAllocator_T::PrintDetailedMap(VmaAllocator_T *this, VmaJsonWriter *param_1) {
   VmaVector<char,VmaStlAllocator<char>> *pVVar1;
   VmaStringBuilder *pVVar2;
   long lVar3;
   bool bVar4;
   ...
   *(undefined1*)( *(long*)( pVVar1 + 8 ) + lVar13 ) = 0x22;
   ...
   VmaJsonWriter::BeginObject(param_1, false);
   if (*this == (VmaAllocator_T)0x0) {
      if (( *(long*)( this + 0x1638 ) == 0 ) || ( __rwlock = (pthread_rwlock_t*)0x0 * (int*)( this + 0x408 ) == 0 )) goto LAB_0010d12d;
      LAB_0010ce66:uVar8 = 0;
      do {
         uVar6 = 0;
         ...
         if (pVVar14 != (VmaBlockVector*)0x0) {
            do {
               ...
               *(undefined1*)( *(long*)( pVVar1 + 8 ) + lVar13 ) = 0x22;
               param_1[0x28] = (VmaJsonWriter)0x0;
               VmaDedicatedAllocationList::BuildStatsString((VmaDedicatedAllocationList*)( pVVar14 + 0xb8 ), param_1);
               VmaJsonWriter::EndObject(param_1);
               pVVar14 = *(VmaBlockVector**)( pVVar14 + 0x128 );
               bVar4 = false;
               uVar6 = uVar6 + 1;
            } while ( pVVar14 != (VmaBlockVector*)0x0 );
            LAB_0010d0fc:if (!bVar4) {
               VmaJsonWriter::EndArray(param_1);
            }
         }
         uVar8 = uVar8 + 1;
   ...
   pthread_rwlock_unlock(__rwlock);
   LAB_0010d12d:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   VmaJsonWriter::EndObject(param_1);
   ...
   *(undefined1*)( *(long*)( pVVar4 + 8 ) + lVar2 ) = 0x22;
   ...
   if (*(int*)( param_1 + 0x50c ) != 0) {
      ...
      do {
         ...
         *(undefined1*)( *(long*)( pVVar4 + 8 ) + lVar2 ) = 0x22;
         ...
         if (*(int*)( param_1 + 0x408 ) != 0) {
            do {
               while (*(uint*)( param_1 + uVar13 * 8 + 0x410 ) == local_f70) {
                  ...
                  *(undefined1*)( *(long*)( pVVar4 + 8 ) + lVar2 ) = 0x22;
                  local_f20 = 0;
                  VmaPrintDetailedStatistics((VmaJsonWriter*)&local_f48, (VmaDetailedStatistics*)( local_c98 + lVar9 ));
                  VmaJsonWriter::EndObject((VmaJsonWriter*)&local_f48);
         ...
         LAB_0010dff3:pVVar14 = pVVar14 + 0x10;
         VmaJsonWriter::EndObject((VmaJsonWriter*)&local_f48);
         VmaJsonWriter::EndObject((VmaJsonWriter*)&local_f48);
   ...
   if (param_1[0x20] == (VmaAllocator_T)0x0) {
      ...
      LAB_0010e519:pvVar5 = (void*)aligned_alloc(1, local_f58._0_8_ + 1);
   } else {
      if (local_f60 == (void*)0x0) goto LAB_0010e0c6;
      if (*(code**)( param_1 + 0x30 ) == (code*)0x0) goto LAB_0010e519;
      pvVar5 = (void*)( **(code**)( param_1 + 0x30 ) )(*(undefined8*)( param_1 + 0x28 ), local_f58._0_8_ + 1, 1, 1);
   }
   pvVar6 = memcpy(pvVar5, pvVar6, __n);
   *(undefined1*)( (long)pvVar6 + __n ) = 0;
   pvVar5 = local_f60;
   LAB_0010e0c6:*param_2 = pvVar6;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* VmaBlockVector::CreateBlock(unsigned long, unsigned long*) */undefined8 VmaBlockVector::CreateBlock(VmaBlockVector *this, ulong param_1, ulong *param_2) {
   uint uVar1;
   uint uVar2;
   uint uVar3;
   VmaAllocator_T *this_00;
   ...
   if (-1 < (int)uVar8) {
      ...
      *(uint*)( this + 0xb0 ) = uVar1 + 1;
      VmaDeviceMemoryBlock::Init(this_01, *(VmaAllocator_T**)this, *(VmaPool_T**)( this + 8 ), uVar3, local_c0, uStack_48, uVar1, uVar2, *(ulong*)( this + 0x30 ));
      lVar5 = *(long*)( this + 0xa0 );
      VmaVector<VmaDeviceMemoryBlock*,VmaStlAllocator<VmaDeviceMemoryBlock*>>::resize((VmaVector<VmaDeviceMemoryBlock*,VmaStlAllocator<VmaDeviceMemoryBlock*>>*)( this + 0x90 ), lVar5 + 1);
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* VmaBlockVector::CreateMinBlocks() */undefined8 VmaBlockVector::CreateMinBlocks(VmaBlockVector *this) {
   undefined8 uVar1;
   ulong uVar2;
   if (*(long*)( this + 0x20 ) == 0) {
      return 0;
   ...
   return 0;
}/* VmaAllocator_T::CreatePool(VmaPoolCreateInfo const*, VmaPool_T**) */ulong VmaAllocator_T::CreatePool(VmaAllocator_T *this, VmaPoolCreateInfo *param_1, VmaPool_T **param_2) {
   uint uVar1;
   ...
   if (*(ulong*)( this + ( ulong ) * (uint*)( this + (ulong)uVar1 * 8 + 0x410 ) * 0x10 + 0x510 ) < 0x40000001) {
      pcVar4 = *(code**)( this + 0x30 );
      uVar7 = ( *(ulong*)( this + ( ulong ) * (uint*)( this + (ulong)uVar1 * 8 + 0x410 ) * 0x10 + 0x510 ) >> 3 ) + 0x1f & 0xffffffffffffffe0;
      if (pcVar4 == (code*)0x0) goto LAB_0010e9b9;
      LAB_0010e8a9:pVVar5 = (VmaPool_T*)( *pcVar4 )(*(undefined8*)( this + 0x28 ), 0x130, 8, 1);
   } else {
      pcVar4 = *(code**)( this + 0x30 );
      uVar7 = *(long*)( this + 0x1558 ) + 0x1fU & 0xffffffffffffffe0;
      if (pcVar4 != (code*)0x0) goto LAB_0010e8a9;
      LAB_0010e9b9:pVVar5 = (VmaPool_T*)aligned_alloc(8, 0x130);
   }
   ...
   *param_2 = pVVar5;
   if (lVar2 != 0) {
      uVar8 = 0;
      do {
         uVar7 = VmaBlockVector::CreateBlock((VmaBlockVector*)pVVar5, *(ulong*)( pVVar5 + 0x18 ), (ulong*)0x0);
         if ((int)uVar7 != 0) {
            ...
            if (this_00 != (VmaBlockVector*)0x0) {
               ...
               if (*(char*)( lVar2 + 0x20 ) == '\0') {
                  ...
                  LAB_0010eaae:free(__ptr);
                  VmaBlockVector::~VmaBlockVector(this_00);
               } else if (__ptr == (void*)0x0) {
                  LAB_0010ea88:VmaBlockVector::~VmaBlockVector(this_00);
               } else {
   ...
   *(long*)( this + 0x1638 ) = lVar6;
   ...
   uVar7 = 0;
   LAB_0010e97f:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar7;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}void VmaAllocator_T::vmaCreatePool(VmaAllocator_T *this, VmaPoolCreateInfo *param_1, VmaPool_T **param_2) {
   CreatePool(this, param_1, param_2);
   return;
}/* VmaBlockVector::Remove(VmaDeviceMemoryBlock*) */void VmaBlockVector::Remove(VmaBlockVector *this, VmaDeviceMemoryBlock *param_1) {
   long *__dest;
   ulong uVar1;
   ulong uVar2;
   ...
   if (uVar1 != 0) {
      ...
      do {
         ...
         if ((VmaDeviceMemoryBlock*)*__dest == param_1) {
            ...
            VmaVector<VmaDeviceMemoryBlock*,VmaStlAllocator<VmaDeviceMemoryBlock*>>::resize((VmaVector<VmaDeviceMemoryBlock*,VmaStlAllocator<VmaDeviceMemoryBlock*>>*)( this + 0x90 ), uVar1);
            return;
         }
   ...
   return;
}/* VmaBlockVector::Free(VmaAllocation_T*) */void VmaBlockVector::Free(VmaBlockVector *this, VmaAllocation_T *param_1) {
   long *plVar1;
   int *piVar2;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   for (int i = 0; i < 16; i++) {
      local_68[i] = (VmaBudget)0;
   }
   local_48 = 0;
   local_58 = (undefined1[16])0x0;
   VmaAllocator_T::GetHeapBudgets(*(VmaAllocator_T**)this, local_68, *(uint*)( *(VmaAllocator_T**)this + ( ulong ) * (uint*)( this + 0x10 ) * 8 + 0x410 ), 1);
   uVar12 = local_48;
   ...
   if (cVar9 == '\0') {
      if (( uVar6 < uVar5 ) && ( cVar10 != '\0' )) {
         ...
         if (cVar10 != '\0') {
            VmaVector<VmaDeviceMemoryBlock*,VmaStlAllocator<VmaDeviceMemoryBlock*>>::resize((VmaVector<VmaDeviceMemoryBlock*,VmaStlAllocator<VmaDeviceMemoryBlock*>>*)( this + 0x90 ), *(long*)( this + 0xa0 ) - 1);
            goto LAB_0010edf4;
         }
      }
   } else if (( ( uVar12 <= (ulong)uVar8 ) || ( cVar10 != '\0' ) ) && ( uVar6 < uVar5 )) {
      Remove(this, this_00);
      LAB_0010edf4:IncrementallySortBlocks(this);
      if (__rwlock != (pthread_rwlock_t*)0x0) {
         pthread_rwlock_unlock(__rwlock);
      }
   ...
   *(int*)( lVar4 + 0x1390 ) = *(int*)( lVar4 + 0x1390 ) + 1;
   UNLOCK();
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      VmaAllocationObjectAllocator::Free((VmaAllocationObjectAllocator*)( *(long*)this + 0x70 ), param_1);
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* VmaAllocator_T::FreeMemory(unsigned long, VmaAllocation_T* const*) */void VmaAllocator_T::FreeMemory(VmaAllocator_T *this, ulong param_1, VmaAllocation_T **param_2) {
   ...
   return;
}/* VmaDefragmentationContext_T::DefragmentPassEnd(VmaDefragmentationPassMoveInfo&) */undefined8 VmaDefragmentationContext_T::DefragmentPassEnd(VmaDefragmentationContext_T *this, VmaDefragmentationPassMoveInfo *param_1) {
   int *piVar1;
   long *plVar2;
   uint *puVar3;
   undefined8 uVar4;
   ...
   if (*(int*)param_1 == 0) {
      ...
      LAB_0010f0b5:do {
         ...
         if (this_00 == (VmaBlockVector*)0x0) {
            ...
            LAB_0010f0e3:if (iVar9 == 2) {
               ...
               *(int*)( this + 0x98 ) = *(int*)( this + 0x98 ) + -1;
               ...
               if (**(char**)this_00 == '\0') {
                  ...
                  LAB_0010f597:pVVar18 = *(VmaAllocation_T**)( piVar1 + 4 );
               ...
               bVar8 = VmaAllocation_T::SwapBlockAllocation(*(VmaAllocation_T**)( piVar1 + 2 ), *(VmaAllocator_T**)this_00, *(VmaAllocation_T**)( piVar1 + 4 ));
               if (bVar8 != 0) {
                  pVVar12 = *(VmaAllocator_T**)this_00;
                  for (puVar21 = local_60; local_b0 = pVVar12,puVar21 != local_60 + local_58._0_8_ * 4; puVar21 = puVar21 + 4) {
                  ...
                  VmaVector<VmaDefragmentationContext_T::FragmentedBlock,VmaStlAllocator<VmaDefragmentationContext_T::FragmentedBlock>>::push_back((VmaVector<VmaDefragmentationContext_T::FragmentedBlock,VmaStlAllocator<VmaDefragmentationContext_T::FragmentedBlock>>*)&local_68, (FragmentedBlock*)local_98);
               }
               pVVar12 = *(VmaAllocator_T**)this_00;
               LAB_0010f435:ppVar23 = (pthread_rwlock_t*)( this_00 + 0x58 );
            ...
            LAB_0010f397:pVVar18 = *(VmaAllocation_T**)( piVar1 + 4 );
            ...
            *(long*)( this + 0x88 ) = *(long*)( this + 0x88 ) - lVar14;
            ...
            local_98[0] = local_bc;
            local_90 = **(long**)( piVar1 + 2 );
            VmaVector<VmaDefragmentationContext_T::FragmentedBlock,VmaStlAllocator<VmaDefragmentationContext_T::FragmentedBlock>>::push_back((VmaVector<VmaDefragmentationContext_T::FragmentedBlock,VmaStlAllocator<VmaDefragmentationContext_T::FragmentedBlock>>*)&local_88, (FragmentedBlock*)local_98);
            LAB_0010f0f4:local_c8 = 0;
            uVar17 = 0;
         }
            ...
            if (uVar15 != 0xffffffffffffffff) {
               if (uVar15 < local_c8 - uVar17) {
                  ...
                  *(long*)( lVar14 + 8 ) = lVar10;
                  if (lVar10 != 0) {
                     lVar20 = lVar20 + 1;
                     bVar8 = ( **(code**)( *(long*)**(undefined8**)( *(long*)( this_00 + 0x98 ) + -8 + lVar10 * 8 ) + 0x38 ) )();
   ...
   *(undefined8*)( param_1 + 8 ) = 0;
   VmaVector<VmaDefragmentationMove,VmaStlAllocator<VmaDefragmentationMove>>::resize((VmaVector<VmaDefragmentationMove,VmaStlAllocator<VmaDefragmentationMove>>*)( this + 0x28 ), 0);
   uVar4 = *(undefined8*)( this + 0x98 );
   *(undefined8*)( this + 0x98 ) = 0;
   *(ulong*)( this + 0x80 ) = CONCAT44((int)( (ulong)uVar4 >> 0x20 ) + (int)( ( ulong ) * (undefined8*)( this + 0x80 ) >> 0x20 ), (int)uVar4 + (int)*(undefined8*)( this + 0x80 ));
   ...
   *(undefined1(*) [16])( this + 0x88 ) = (undefined1[16])0x0;
   ...
   if (uVar17 != 0) {
      ...
      if (( *(int*)( this + 0x4c ) == 8 ) && ( lVar20 = lVar20 != 0 )) {
            ...
            do {
               ...
               if (*pcVar24 != '\x06') {
                  ...
                  if (*(char*)*puVar5 == '\0') {
                     ...
                     if (iVar9 == 0x23) {
                        LAB_0010f942:/* WARNING: Subroutine does not return */std::__throw_system_error(0x23);
                     }
                     lVar20 = *(long*)( this + 0x68 );
                     lVar14 = puVar5[0x14];
                     lVar10 = lVar14 - lVar20;
                     if (lVar10 != 0) {
                        LAB_0010f86c:plVar2 = (long*)puVar5[0x13];
               ...
               joined_r0x0010f807:local_80 = puVar21;
         ...
         for (; puVar22 != puVar3; puVar22 = puVar22 + 4) {
            ...
            if (*(char*)*puVar5 == '\0') {
               ...
               if (uVar17 < (ulong)puVar5[0x14]) {
                  LAB_0010f25a:lVar20 = *(long*)( puVar22 + 2 );
            ...
            LAB_0010f2ac:puVar21 = local_80;
         }
      }
   }
   LAB_0010f2be:puVar3 = local_60;
   puVar16 = local_60 + local_58._0_8_ * 4;
   for (puVar22 = local_60; puVar16 != puVar22; puVar22 = puVar22 + 4) {
      if (*puVar22 != 0) {
         VmaDeviceMemoryBlock::Map(*(VmaDeviceMemoryBlock**)( puVar22 + 2 ), local_b0, *puVar22, (void**)0x0);
      }
   }
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   LAB_0010f8f8:if (bVar7) {
      uVar19 = 5;
   }
   goto LAB_0010f2be;
}void vmaEndDefragmentationPass(undefined8 param_1, VmaDefragmentationContext_T *param_2, VmaDefragmentationPassMoveInfo *param_3) {
   VmaDefragmentationContext_T::DefragmentPassEnd(param_2, param_3);
   return;
}/* VmaBlockMetadata_TLSF::~VmaBlockMetadata_TLSF() */void VmaBlockMetadata_TLSF::~VmaBlockMetadata_TLSF(VmaBlockMetadata_TLSF *this) {
   undefined8 *puVar1;
   void *__ptr;
   long lVar2;
   *(undefined***)this = &PTR__VmaBlockMetadata_TLSF_00115280;
   ...
   VmaVector<VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>::ItemBlock,VmaStlAllocator<VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>::ItemBlock>>::resize((VmaVector<VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>::ItemBlock,VmaStlAllocator<VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>::ItemBlock>>*)( this + 0x150 ), 0);
   ...
   return;
}/* VmaBlockMetadata_TLSF::Init(unsigned long) */void VmaBlockMetadata_TLSF::Init(VmaBlockMetadata_TLSF *this, ulong param_1) {
   long lVar1;
   int iVar2;
   Block *pBVar3;
   void *__s;
   ...
   *(ulong*)( this + 8 ) = param_1;
   if (this[0x20] == (VmaBlockMetadata_TLSF)0x0) {
      VmaBlockBufferImageGranularity::Init((VmaBlockBufferImageGranularity*)( this + 0x178 ), *(VkAllocationCallbacks**)( this + 0x10 ), param_1);
   }
   pBVar3 = VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>::Alloc<>((VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>*)( this + 0x140 ));
   ...
   *(undefined8*)( *(long*)( this + 0x170 ) + 0x20 ) = 0;
   if (param_1 < 0x101) {
      ...
      iVar2 = ( 0x38 - uVar6 & 0xff ) * 0x20 + -0x1f + ( ( ( uint )(param_1 >> ( (byte)VVar4 & 0x3f )) ^ 0x20 ) & 0xffff );
   }
   uVar6 = iVar2 + 4;
   if (this[0x20] != (VmaBlockMetadata_TLSF)0x0) {
      uVar6 = iVar2 + 0x20;
   ...
   *(undefined8*)( this + 0x128 ) = 0;
   ...
   for (uVar5 = ( ulong )(( (int)this - (int)(undefined8*)( ( ulong )(this + 0x50) & 0xfffffffffffffff8 ) ) + 0x130U >> 3); uVar5 != 0; uVar5 = uVar5 - 1) {
      *puVar7 = 0;
   ...
   *(void**)( this + 0x138 ) = __s;
   memset(__s, 0, __n);
   return;
}/* VmaBlockMetadata_TLSF::Alloc(VmaAllocationRequest const&, VmaSuballocationType, void*) */void VmaBlockMetadata_TLSF::Alloc(VmaBlockMetadata_TLSF *this, undefined8 *param_1, undefined8 param_3, undefined8 param_4) {
   undefined8 uVar1;
   ...
   if (lVar7 == 0) {
      ...
      if (( pBVar10 == *(Block**)( pBVar10 + 0x20 ) ) || ( uVar11 = uVar11 == 0 )) {
         pBVar8 = VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>::Alloc<>((VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>*)( this + 0x140 ));
   ...
   if (lVar4 == lVar12) {
      if (*(Block**)( this + 0x170 ) == pBVar3) {
         pBVar10 = VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>::Alloc<>((VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>*)( this + 0x140 ));
         lVar4 = *(long*)pBVar3;
   ...
   VVar2 = this[0x20];
   *(undefined8*)( pBVar3 + 0x28 ) = param_4;
   joined_r0x0010fd76:if (VVar2 == (VmaBlockMetadata_TLSF)0x0) {
      VmaBlockBufferImageGranularity::AllocPages((VmaBlockBufferImageGranularity*)( this + 0x178 ), *(uchar*)( param_1 + 4 ), *(ulong*)pBVar3, *(ulong*)( pBVar3 + 8 ));
   }
   *(long*)( this + 0x28 ) = *(long*)( this + 0x28 ) + 1;
   return;
}/* VmaAllocator_T::~VmaAllocator_T() */void VmaAllocator_T::~VmaAllocator_T(VmaAllocator_T *this) {
   VmaBlockVector *this_00;
   void *__ptr;
   undefined8 *puVar1;
   ulong uVar2;
   ...
   do {
      while (true) {
         if (uVar2 == 0) {
            ...
            VmaVector<VmaPoolAllocator<VmaAllocation_T>::ItemBlock,VmaStlAllocator<VmaPoolAllocator<VmaAllocation_T>::ItemBlock>>::resize(( VmaVector<VmaPoolAllocator<VmaAllocation_T>::ItemBlock,VmaStlAllocator < VmaPoolAllocator<VmaAllocation_T>::ItemBlock> > * )(this + 0xa8), 0);
   ...
   long, unsigned int, void*, VmaSuballocationType, VmaAllocation_T**) */int VmaBlockVector::CommitAllocationRequest(VmaBlockVector *this, undefined8 *param_1, VmaDeviceMemoryBlock *param_2, undefined8 param_3, uint param_4, char *param_5, undefined4 param_7, long *param_8) {
   pthread_mutex_t *__mutex;
   int *piVar1;
   undefined8 uVar2;
   undefined4 uVar3;
   ...
   pVVar8 = VmaPoolAllocator<VmaAllocation_T>::Alloc<bool_const&>((VmaPoolAllocator<VmaAllocation_T>*)( lVar10 + 0x98 ), &local_41);
   pthread_mutex_unlock(__mutex);
   plVar4 = *(long**)param_2;
   lVar10 = *plVar4;
   *param_8 = (long)pVVar8;
   ...
   *(int*)( lVar6 + 0x1390 ) = *(int*)( lVar6 + 0x1390 ) + 1;
   UNLOCK();
   iVar7 = 0;
   LAB_00110195:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar7;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* VmaBlockVector::AllocateFromBlock(VmaDeviceMemoryBlock*, unsigned long, unsigned long, unsigned
   int, void*, VmaSuballocationType, unsigned int, VmaAllocation_T**) */undefined8 VmaBlockVector::AllocateFromBlock(VmaBlockVector *this, undefined8 *param_1, undefined8 param_2, undefined8 param_3, uint param_4, undefined8 param_5, undefined4 param_7, undefined4 param_8, undefined8 param_9) {
   char cVar1;
   undefined8 uVar2;
   long in_FS_OFFSET;
   undefined1 local_78[16];
   ...
   local_68 = (undefined1[16])0x0;
   local_58 = (undefined1[16])0x0;
   cVar1 = ( **(code**)( *(long*)*param_1 + 0x88 ) )((long*)*param_1, param_2, param_3, param_4 >> 6 & 1, param_7, param_8, local_78);
   if (cVar1 == '\0') {
      uVar2 = 0xfffffffe;
   } else {
   ...
   VmaSuballocationType, VmaAllocation_T**) */undefined8 VmaBlockVector::AllocatePage(VmaBlockVector *this, ulong param_1, undefined8 param_2, uint *param_3, undefined4 param_5, undefined8 param_6) {
   ulong uVar1;
   undefined1 auVar2[16];
   undefined1 auVar3[16];
   undefined1 auVar4[16];
   ...
   local_68 = (undefined1[16])0x0;
   local_58 = (undefined1[16])0x0;
   VmaAllocator_T::GetHeapBudgets(*(VmaAllocator_T**)this, (VmaBudget*)local_68, *(uint*)( *(VmaAllocator_T**)this + ( ulong ) * (uint*)( this + 0x10 ) * 8 + 0x410 ), 1);
   uVar17 = *param_3;
   uVar9 = 0;
   ...
   if (( uVar18 & 0x40 ) == 0) {
      if (param_1 <= *(ulong*)( this + 0x18 )) {
         ...
         if (uVar7 == 0x20000) {
            do {
               ...
               iVar8 = AllocateFromBlock(this, *(undefined8*)( *(long*)( this + 0x98 ) + lVar14 * 8 ), param_1, param_2, *param_3, *(undefined8*)( param_3 + 8 ), param_5, 0x20000, param_6);
            } while ( iVar8 != 0 );
            LAB_00110572:IncrementallySortBlocks(this);
            uVar11 = 0;
            goto LAB_00110495;
         }
         if (( *(byte*)( *(long*)this + 0x40c + ( ulong ) * (uint*)( this + 0x10 ) * 8 ) & 2 ) == 0) {
            uVar13 = 0;
            if (lVar14 != 0) {
               while (iVar8 = AllocateFromBlock(this, *(undefined8*)( *(long*)( this + 0x98 ) + uVar13 * 8 ), param_1, param_2, uVar17, *(undefined8*)( param_3 + 8 ), param_5, uVar7, param_6),iVar8 != 0) {
                  uVar13 = uVar13 + 1;
            ...
            do {
               ...
               do {
                  ...
                  if (( ( ( *(long*)( lVar14 + 0x58 ) != 0 ) == ( ( uVar17 & 0xc00 ) != 0 ) ) == (bool)( bVar6 ^ 1U ) ) && ( iVar8 = AllocateFromBlock(this, lVar14, param_1, param_2, *param_3, *(undefined8*)( param_3 + 8 ), param_5, uVar7, param_6) ),iVar8 == 0) goto LAB_00110572;
                  uVar13 = uVar13 + 1;
               } while ( uVar13 < *(ulong*)( this + 0xa0 ) );
               if (bVar6) break;
               LAB_0011079a:bVar6 = true;
            } while ( *(long*)( this + 0xa0 ) != 0 );
         }
         LAB_001103fc:if (local_78 == false) goto LAB_00110490;
         uVar13 = *(ulong*)( this + 0x18 );
         cVar16 = bVar19 || bVar20;
         if (this[0x38] == (VmaBlockVector)0x0) {
            uVar10 = CalcMaxBlockSize(this);
            uVar12 = uVar13 >> 1;
            if (( uVar10 < uVar12 ) && ( uVar1 = uVar1 <= uVar12 )) {
               uVar15 = uVar13 >> 2;
               ...
               uVar18 = 1;
               LAB_001108df:auVar5._8_8_ = 0;
               auVar5._0_8_ = local_68._8_8_;
               local_68 = auVar5 << 0x40;
               if (( uVar12 <= uVar9 ) || ( uVar13 = cVar16 != '\0' )) goto LAB_001105eb;
            } else {
               auVar4._8_8_ = 0;
            ...
            } while ( ( ( uVar18 < 3 ) && ( bVar19 != false ) ) && ( uVar13 = param_1 <= uVar13 ) );
         } else {
            auVar3._8_8_ = 0;
            auVar3._0_8_ = local_68._8_8_;
            local_68 = auVar3 << 0x40;
            if (( uVar9 < uVar13 ) && ( !bVar19 && !bVar20 )) goto LAB_00110490;
            LAB_001105e9:uVar18 = 0;
            uVar12 = uVar13;
            LAB_001105eb:iVar8 = CreateBlock(this, uVar12, (ulong*)local_68);
            if (( this[0x38] == (VmaBlockVector)0x0 ) && ( uVar13 = iVar8 < 0 )) goto LAB_00110620;
         }
         LAB_00110810:if (iVar8 == 0) {
            iVar8 = AllocateFromBlock(this, *(undefined8*)( *(long*)( this + 0x98 ) + local_68._0_8_ * 8 ), param_1, param_2, *param_3, *(undefined8*)( param_3 + 8 ), param_5, uVar7, param_6);
            if (iVar8 == 0) {
               IncrementallySortBlocks(this);
               uVar11 = 0;
               goto LAB_00110495;
      ...
      if (param_1 <= *(ulong*)( this + 0x18 )) {
         lVar14 = *(long*)( this + 0xa0 );
         LAB_001103f3:if (( lVar14 == 0 ) || ( iVar8 = AllocateFromBlock(this, *(undefined8*)( *(long*)( this + 0x98 ) + -8 + lVar14 * 8 ), param_1, param_2, uVar17, *(undefined8*)( param_3 + 8 ), param_5, uVar7, param_6) ),iVar8 != 0) goto LAB_001103fc;
         goto LAB_00110572;
      }
   }
   LAB_00110490:uVar11 = 0xfffffffe;
   LAB_00110495:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar11;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* VmaBlockVector::Allocate(unsigned long, unsigned long, VmaAllocationCreateInfo const&,
   VmaSuballocationType, unsigned long, VmaAllocation_T**) */int VmaBlockVector::Allocate(VmaBlockVector *this, undefined8 param_1, ulong param_2, undefined8 param_3, undefined4 param_5, ulong param_6, void *param_7) {
   int iVar1;
   ulong uVar2;
   void *pvVar3;
   ulong uVar4;
   ...
   LAB_00110a5a:pthread_rwlock_unlock(__rwlock);
   return 0;
}/* VmaDefragmentationContext_T::AllocInOtherBlock(unsigned long, unsigned long,
   VmaDefragmentationContext_T::MoveAllocationData&, VmaBlockVector&) */bool VmaDefragmentationContext_T::AllocInOtherBlock(VmaDefragmentationContext_T *this, ulong param_1, ulong param_2, MoveAllocationData *param_3, VmaBlockVector *param_4) {
   undefined8 *puVar1;
   long lVar2;
   long lVar3;
   long lVar4;
   ...
   while (true) {
      ...
      if (( *(ulong*)param_3 <= uVar7 ) && ( iVar6 = VmaBlockVector::AllocateFromBlock(param_4, puVar1, *(ulong*)param_3, *(undefined8*)( param_3 + 8 ), *(undefined4*)( param_3 + 0x14 ), this, *(undefined4*)( param_3 + 0x10 ), 0, param_3 + 0x28) ),iVar6 == 0) break;
      param_1 = param_1 + 1;
      if (param_2 == param_1) {
         return false;
      }
   ...
   VmaVector<VmaDefragmentationMove,VmaStlAllocator<VmaDefragmentationMove>>::resize((VmaVector<VmaDefragmentationMove,VmaStlAllocator<VmaDefragmentationMove>>*)( this + 0x28 ), lVar2 + 1);
   ...
   *(uint*)( this + 0x98 ) = iVar6 + 1U;
...
}/* VmaDefragmentationContext_T::ComputeDefragmentation_Fast(VmaBlockVector&) */undefined8 VmaDefragmentationContext_T::ComputeDefragmentation_Fast(VmaDefragmentationContext_T *this, VmaBlockVector *param_1) {
   ...
   if (*(ulong*)( this + 0x68 ) < uVar6) {
      do {
         ...
         for (pVVar4 = (VmaAllocHandle_T*)( **(code**)( *(long*)pVVar1 + 0x58 ) )(pVVar1); pVVar4 != (VmaAllocHandle_T*)0x0; pVVar4 = (VmaAllocHandle_T*)( **(code**)( *(long*)pVVar1 + 0x60 ) )(pVVar1, pVVar4)) {
            GetMoveData(aVStack_78, pVVar4, pVVar1);
            if (( ( this != *(VmaDefragmentationContext_T**)( local_58 + 0x38 ) ) && ( iVar3 = CheckCounters(this, *(ulong*)( local_58 + 0x30 )) ),iVar3 != 1 )) {
               uVar5 = 1;
               goto LAB_00110c6d;
            }
         }
   ...
   uVar5 = 0;
   LAB_00110c6d:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar5;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* VmaDefragmentationContext_T::MoveDataToFreeBlocks(VmaSuballocationType, VmaBlockVector&, unsigned
   long, bool&, bool&, bool&) */bool VmaDefragmentationContext_T::MoveDataToFreeBlocks(VmaDefragmentationContext_T *this, uint param_2, VmaBlockVector *param_3, ulong param_4, undefined1 *param_5, undefined1 *param_6, undefined1 *param_7) {
   uint uVar1;
   long lVar2;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (param_4 == 0) {
      LAB_00110e38:bVar9 = true;
   } else {
      uVar8 = param_4;
      do {
         uVar8 = uVar8 - 1;
         pVVar3 = (VmaBlockMetadata*)**(undefined8**)( *(long*)( param_3 + 0x98 ) + uVar8 * 8 );
         for (pVVar6 = (VmaAllocHandle_T*)( **(code**)( *(long*)pVVar3 + 0x58 ) )(pVVar3); pVVar6 != (VmaAllocHandle_T*)0x0; pVVar6 = (VmaAllocHandle_T*)( **(code**)( *(long*)pVVar3 + 0x60 ) )(pVVar3, pVVar6)) {
            GetMoveData(local_78, pVVar6, pVVar3);
            if (( this == *(VmaDefragmentationContext_T**)( local_58 + 0x38 ) ) || ( iVar5 = CheckCounters(this, *(ulong*)( local_58 + 0x30 )) ),iVar5 == 1) goto LAB_00110e00;
...
switchD_00110d8a_caseD_0:
          ...
          if (cVar4 != '\0') {
            ...
            joined_r0x00110eaf:if (( ( (int)local_68 < 6 ) && ( local_68 != 0 ) ) && ( local_68 != 5 )) {
               if ((int)local_68 < 3) {
                  if (( local_68 & 0xfffffffd ) == 0) goto LAB_00110e89;
               } else if (local_68 != 3) {
                  LAB_00110e89:*param_6 = 1;
                  goto LAB_00110e00;
               }
               *param_7 = 1;
            } else {
   ...
   LAB_00110e3d:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return bVar9;
}/* VmaDefragmentationContext_T::ReallocWithinBlock(VmaBlockVector&, VmaDeviceMemoryBlock*) */undefined8 VmaDefragmentationContext_T::ReallocWithinBlock(VmaDefragmentationContext_T *this, VmaBlockVector *param_1, VmaDeviceMemoryBlock *param_2) {
   undefined8 *puVar1;
   ...
   if (pVVar7 != (VmaAllocHandle_T*)0x0) {
      do {
         ...
         puVar1 = puStack_88;
         if (( this != (VmaDefragmentationContext_T*)puStack_88[7] ) && ( iVar6 = iVar6 != 1 )) {
            if (iVar6 == 2) {
               LAB_001110c0:uVar10 = 1;
               goto LAB_001110c5;
            }
            if (( ( *(char*)( (long)puVar1 + 0x4c ) == '\x01' ) && ( uVar8 = ( **(code**)( **(long**)*puVar1 + 0x48 ) )(*(long**)*puVar1, puVar1[1]) ),uVar8 != 0 )) {
               local_78 = (undefined1[16])0x0;
               local_68 = (undefined1[16])0x0;
               local_58 = (undefined1[16])0x0;
               local_48 = 0;
               cVar5 = ( **(code**)( *(long*)pVVar2 + 0x88 ) )(pVVar2, local_a8, local_a0, 0, local_98, 0x40000, local_78);
               if (cVar5 != '\0') {
                  uVar9 = ( **(code**)( *(long*)pVVar2 + 0x48 ) )(pVVar2, local_78._0_8_);
                  if (( uVar9 < uVar8 ) && ( iVar6 = VmaBlockVector::CommitAllocationRequest(param_1, local_78, param_2, uVar10, local_94, this, uVar4, &local_80) ),iVar6 == 0) {
                     lVar3 = *(long*)( this + 0x38 );
                     VmaVector<VmaDefragmentationMove,VmaStlAllocator<VmaDefragmentationMove>>::resize((VmaVector<VmaDefragmentationMove,VmaStlAllocator<VmaDefragmentationMove>>*)( this + 0x28 ), lVar3 + 1);
                     iVar6 = *(int*)( this + 0x98 );
                     ...
                     *(ulong*)( this + 0x88 ) = lVar3 + local_a8;
                     if (( *(uint*)( this + 8 ) <= iVar6 + 1U ) || ( *(ulong*)this <= lVar3 + local_a8 )) goto LAB_001110c0;
                  }
               }
            }
         }
   ...
   uVar10 = 0;
   LAB_001110c5:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return uVar10;
}/* VmaDefragmentationContext_T::ComputeDefragmentation_Balanced(VmaBlockVector&, unsigned long,
   bool) */undefined8 VmaDefragmentationContext_T::ComputeDefragmentation_Balanced(VmaDefragmentationContext_T *this, VmaBlockVector *param_1, ulong param_2, bool param_3) {
   undefined8 *puVar1;
   ulong uVar2;
   long lVar3;
   undefined8 *puVar4;
   ...
   do {
      ...
      if (*(ulong*)( this + 0x68 ) < uVar17) {
         do {
            ...
            while (pVVar11 != (VmaAllocHandle_T*)0x0) {
               ...
               uVar12 = uVar15;
               if (( this != (VmaDefragmentationContext_T*)puStack_88[7] ) && ( iVar9 = iVar9 != 1 )) {
                  if (iVar9 != 2) {
                     ...
                     if (cVar8 == '\0') {
                        ...
                        if (( ( ( *(char*)( (long)puStack_88 + 0x4c ) == '\x01' ) && ( uVar13 = ( **(code**)( **(long**)*puStack_88 + 0x48 ) )(*(long**)*puStack_88, puStack_88[1]) * (long*)( this + 0x38 ) == lVar6 ) ) && ( uVar13 != 0 ) ) && ( uVar14 = ( **(code**)( *(long*)pVVar5 + 0x30 ) )(pVVar5) ),uVar7 = local_98,uVar16 = local_a0,local_a8 <= uVar14) {
                           if (uVar15 <= uVar12) {
                              uVar15 = uVar12;
                           }
                           if (( ( uVar2 >> 1 <= uVar15 ) || ( local_a8 <= *(ulong*)pSVar10 ) ) || ( local_a8 <= *(ulong*)( pSVar10 + 8 ) )) {
                              local_78 = (undefined1[16])0x0;
                              local_68 = (undefined1[16])0x0;
                              local_58 = (undefined1[16])0x0;
                              local_48 = 0;
                              cVar8 = ( **(code**)( *(long*)pVVar5 + 0x88 ) )(pVVar5, local_a8, local_a0, 0, local_98, 0x40000, local_78);
                              if (cVar8 != '\0') {
                                 uVar15 = ( **(code**)( *(long*)pVVar5 + 0x48 ) )(pVVar5, local_78._0_8_);
                                 if (( uVar15 < uVar13 ) && ( iVar9 = VmaBlockVector::CommitAllocationRequest(param_1, local_78, puVar4, uVar16, local_94, this, uVar7, &local_80) ),iVar9 == 0) {
                                    lVar6 = *(long*)( this + 0x38 );
                                    VmaVector<VmaDefragmentationMove,VmaStlAllocator<VmaDefragmentationMove>>::resize((VmaVector<VmaDefragmentationMove,VmaStlAllocator<VmaDefragmentationMove>>*)( this + 0x28 ), lVar6 + 1);
                                    iVar9 = *(int*)( this + 0x98 );
                                    ...
                                    *(ulong*)( this + 0x88 ) = lVar6 + local_a8;
                                    if (( *(uint*)( this + 8 ) <= iVar9 + 1U ) || ( *(ulong*)this <= lVar6 + local_a8 )) goto LAB_00111470;
                                 }
                              }
                           }
                        }
                  ...
                  LAB_00111470:uVar16 = 1;
                  goto LAB_00111475;
               }
               LAB_0011122c:pVVar11 = (VmaAllocHandle_T*)( **(code**)( *(long*)pVVar5 + 0x60 ) )(pVVar5, pVVar11);
               uVar15 = uVar12;
            };
            uVar17 = uVar17 - 1;
      ...
      uVar16 = 0;
      if (param_3 != false) {
         LAB_00111475:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            return uVar16;
         }
         LAB_001114da:/* WARNING: Subroutine does not return */__stack_chk_fail();
      }
      *(undefined8*)( pSVar10 + 8 ) = 0xffffffffffffffff;
      if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) goto LAB_001114da;
      param_3 = false;
   } while ( true );
}/* VmaDefragmentationContext_T::ComputeDefragmentation_Full(VmaBlockVector&) */undefined8 VmaDefragmentationContext_T::ComputeDefragmentation_Full(VmaDefragmentationContext_T *this, VmaBlockVector *param_1) {
   undefined8 *puVar1;
   undefined8 *puVar2;
   VmaBlockMetadata *pVVar3;
   long lVar4;
   ...
   if (*(ulong*)( this + 0x68 ) < uVar12) {
      do {
         ...
         for (pVVar8 = (VmaAllocHandle_T*)( **(code**)( *(long*)pVVar3 + 0x58 ) )(pVVar3); pVVar8 != (VmaAllocHandle_T*)0x0; pVVar8 = (VmaAllocHandle_T*)( **(code**)( *(long*)pVVar3 + 0x60 ) )(pVVar3, pVVar8)) {
            GetMoveData((VmaDefragmentationContext_T*)&local_a8, pVVar8, pVVar3);
            if (( (VmaDefragmentationContext_T*)puStack_88[7] != this ) && ( iVar7 = iVar7 != 1 )) {
               if (iVar7 != 2) {
                  lVar4 = *(long*)( this + 0x38 );
                  cVar6 = AllocInOtherBlock(this, 0, uVar12, (MoveAllocationData*)&local_a8, param_1);
                  if (cVar6 == '\0') {
                     if (( ( ( *(char*)( (long)puStack_88 + 0x4c ) == '\x01' ) && ( uVar9 = ( **(code**)( **(long**)*puStack_88 + 0x48 ) )(*(long**)*puStack_88, puStack_88[1]) * (long*)( this + 0x38 ) == lVar4 ) ) && ( uVar9 != 0 ) ) && ( uVar10 = ( **(code**)( *(long*)pVVar3 + 0x30 ) )(pVVar3) ),uVar5 = local_98,uVar11 = local_a0,local_a8 <= uVar10) {
                        local_78 = (undefined1[16])0x0;
                        local_68 = (undefined1[16])0x0;
                        local_58 = (undefined1[16])0x0;
                        local_48 = 0;
                        cVar6 = ( **(code**)( *(long*)pVVar3 + 0x88 ) )(pVVar3, local_a8, local_a0, 0, local_98, 0x40000, local_78);
                        if (cVar6 != '\0') {
                           uVar10 = ( **(code**)( *(long*)pVVar3 + 0x48 ) )(pVVar3, local_78._0_8_);
                           if (( uVar10 < uVar9 ) && ( iVar7 = VmaBlockVector::CommitAllocationRequest(param_1, local_78, puVar2, uVar11, local_94, this, uVar5, &local_80) ),iVar7 == 0) {
                              lVar4 = *(long*)( this + 0x38 );
                              VmaVector<VmaDefragmentationMove,VmaStlAllocator<VmaDefragmentationMove>>::resize((VmaVector<VmaDefragmentationMove,VmaStlAllocator<VmaDefragmentationMove>>*)( this + 0x28 ), lVar4 + 1);
                              iVar7 = *(int*)( this + 0x98 );
                              ...
                              *(ulong*)( this + 0x88 ) = lVar4 + local_a8;
                              if (( *(uint*)( this + 8 ) <= iVar7 + 1U ) || ( *(ulong*)this <= lVar4 + local_a8 )) goto LAB_00111740;
                           }
                        }
                     }
                     goto LAB_001115b0;
   ...
   uVar11 = 0;
   LAB_00111745:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar11;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* VmaDefragmentationContext_T::ComputeDefragmentation_Extensive(VmaBlockVector&, unsigned long) */undefined8 VmaDefragmentationContext_T::ComputeDefragmentation_Extensive(VmaDefragmentationContext_T *this, VmaBlockVector *param_1, ulong param_2) {
   VmaBlockMetadata *pVVar1;
   long lVar2;
   char cVar3;
   int iVar4;
...
LAB_00111976:
   ...
   goto LAB_00111bd5;
   LAB_0011188a:uVar6 = 1;
   goto LAB_0011188f;
   while (lVar7 = lVar7 + -1,lVar7 != 0) {
      LAB_00111b92:cVar3 = ReallocWithinBlock(this, param_1, *(VmaDeviceMemoryBlock**)( *(long*)( param_1 + 0x98 ) + lVar7 * 8 ));
      if (cVar3 != '\0') goto LAB_0011188a;
   };
   if (lVar2 == *(long*)( this + 0x38 )) {
      LAB_00111bc5:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         LAB_00111b66:uVar6 = ComputeDefragmentation_Fast(this, param_1);
         return uVar6;
      }
      goto LAB_00111bd5;
   }
   LAB_00111a28:cVar3 = *pcVar8;
   switchD_001117e2_caseD_6:if (cVar3 == '\x06') {
      LAB_00111ac8:uVar9 = 0;
      lVar7 = *(long*)( this + 0x38 );
      if (*(long*)( param_1 + 0xa0 ) != 0) {
         do {
            cVar3 = ReallocWithinBlock(this, param_1, *(VmaDeviceMemoryBlock**)( *(long*)( param_1 + 0x98 ) + uVar9 * 8 ));
            if (cVar3 != '\0') goto LAB_0011188a;
            uVar9 = uVar9 + 1;
      ...
      *pcVar8 = '\a';
      ...
      switchD_001117e2_caseD_7:uVar6 = 0;
   }
   LAB_0011188f:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar6;
   }
   LAB_00111bd5:/* WARNING: Subroutine does not return */__stack_chk_fail();
}/* VmaDefragmentationContext_T::ComputeDefragmentation(VmaBlockVector&, unsigned long) */void VmaDefragmentationContext_T::ComputeDefragmentation(VmaDefragmentationContext_T *this, VmaBlockVector *param_1, ulong param_2) {
   int iVar1;
   iVar1 = *(int*)( this + 0x4c );
   if (iVar1 == 4) {
   ...
   return;
}/* VmaDefragmentationContext_T::DefragmentPassBegin(VmaDefragmentationPassMoveInfo&) */undefined8 VmaDefragmentationContext_T::DefragmentPassBegin(VmaDefragmentationContext_T *this, VmaDefragmentationPassMoveInfo *param_1) {
   undefined8 uVar1;
   char cVar2;
   int iVar3;
   ulong uVar4;
   ...
   if (pVVar5 == (VmaBlockVector*)0x0) {
         ...
         do {
            ...
            if (pVVar5 != (VmaBlockVector*)0x0) {
               if (**(char**)pVVar5 == '\0') {
                  ...
                  if (*(ulong*)( pVVar5 + 0xa0 ) < 2) {
                     if (*(ulong*)( pVVar5 + 0xa0 ) == 1) {
                        LAB_00111d93:cVar2 = ReallocWithinBlock(this, pVVar5, (VmaDeviceMemoryBlock*)**(undefined8**)( pVVar5 + 0x98 ));
                     ...
                     cVar2 = ComputeDefragmentation(this, pVVar5, uVar4);
                     if (cVar2 != '\0') {
                        LAB_00111d77:if (ppVar6 != (pthread_rwlock_t*)0x0) {
      ...
      iVar3 = pthread_rwlock_wrlock(ppVar6);
      if (iVar3 == 0x23) {
         LAB_00111e16:/* WARNING: Subroutine does not return */std::__throw_system_error(0x23);
      }
      pVVar5 = *(VmaBlockVector**)( this + 0x58 );
      if (*(ulong*)( pVVar5 + 0xa0 ) < 2) {
         if (*(ulong*)( pVVar5 + 0xa0 ) == 1) {
   ...
   *(undefined8*)( param_1 + 8 ) = 0;
   return 0;
}void vmaBeginDefragmentationPass(undefined8 param_1, VmaDefragmentationContext_T *param_2, VmaDefragmentationPassMoveInfo *param_3) {
   ...
   unsigned int, VkMemoryAllocateInfo const&, bool, bool, bool, void*, VmaAllocation_T**) */int VmaAllocator_T::AllocateDedicatedMemoryPage(VmaAllocator_T *this, undefined8 param_1, ulong param_2, VmaAllocation_T param_4, uint param_5, VkMemoryAllocateInfo *param_6, char param_7, char param_8, undefined1 param_9, char *param_10, long *param_11) {
   uint uVar1;
   int iVar2;
   ...
   if (-1 < iVar2) {
      local_48 = 0;
      if (param_7 != '\0') {
         iVar2 = ( **(code**)( this + 0x1678 ) )(*(undefined8*)( this + 0x10 ), local_50, 0, 0xffffffffffffffff, 0, &local_48);
         if (iVar2 < 0) {
      ...
      pVVar3 = VmaPoolAllocator<VmaAllocation_T>::Alloc<bool&>((VmaPoolAllocator<VmaAllocation_T>*)( this + 0x98 ), local_5c);
      ...
      *(undefined1(*) [16])( pVVar3 + 0x18 ) = (undefined1[16])0x0;
      ...
      LOCK();
      *(ulong*)( this + ( (ulong)uVar1 + 0x20 ) * 8 + 0x1210 ) = *(long*)( this + ( (ulong)uVar1 + 0x20 ) * 8 + 0x1210 ) + param_2;
      UNLOCK();
      LOCK();
      *(int*)( this + ( (ulong)uVar1 + 0x10 ) * 4 + 0x1210 ) = *(int*)( this + ( (ulong)uVar1 + 0x10 ) * 4 + 0x1210 ) + 1;
      UNLOCK();
      LOCK();
      *(int*)( this + 0x1390 ) = *(int*)( this + 0x1390 ) + 1;
      UNLOCK();
   ...
   LAB_00111fac:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar2;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   VkImage_T*, VmaBufferImageUsage, unsigned long, VmaAllocation_T**, void const*) */int VmaAllocator_T::AllocateDedicatedMemory(undefined4 param_1_00, VmaAllocator_T *this, undefined8 param_1, undefined8 param_2, undefined4 param_5, char *param_6, uint param_7, undefined1 param_8, undefined1 param_9, undefined1 param_10, char param_11, undefined8 param_12, long param_13, long param_14, ulong param_15, long param_16, void *param_17, undefined4 *param_18) {
   uint uVar1;
   VmaAllocation_T *pVVar2;
   long lVar3;
   long lVar4;
   ...
   if (( param_11 == '\0' ) && ( ( this[8] != (VmaAllocator_T)0x0 || ( 0x400fff < *(uint*)( this + 4 ) ) ) )) {
      if (param_13 == 0) {
         ...
         local_e4 = (undefined1[16])0x0;
         if (this[0xc] == (VmaAllocator_T)0x0) goto LAB_00112148;
         LAB_00112374:local_e4 = (undefined1[16])0x0;
         param_18 = puStack_80;
         if (( VmaBufferImageUsage::UNKNOWN != param_15 ) && ( ( param_15 & 0x20000 ) == 0 )) goto LAB_00112148;
      }
   } else {
      local_e4 = (undefined1[16])0x0;
      if (this[0xc] == (VmaAllocator_T)0x0) goto LAB_00112148;
   ...
   if (param_16 != 0) {
      ...
      do {
         lVar11 = lVar10;
         iVar7 = AllocateDedicatedMemoryPage(this, param_1, param_2, param_5, param_7, &local_88, param_8, param_9, param_10, param_12, pvVar12);
         if (iVar7 != 0) {
            while (lVar11 != 0) {
               lVar11 = lVar11 + -1;
               ...
               LOCK();
               *(long*)( this + (ulong)uVar1 * 8 + 0x1310 ) = *(long*)( this + (ulong)uVar1 * 8 + 0x1310 ) - *(long*)( pVVar2 + 0x30 );
               UNLOCK();
               LOCK();
               *(int*)( this + (ulong)uVar1 * 4 + 0x1250 ) = *(int*)( this + (ulong)uVar1 * 4 + 0x1250 ) + -1;
               UNLOCK();
               LOCK();
               *(int*)( this + 0x1390 ) = *(int*)( this + 0x1390 ) + 1;
               UNLOCK();
   ...
   iVar7 = 0;
   LAB_001123e5:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar7;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   VmaAllocation_T**) */int VmaAllocator_T::AllocateMemoryOfType(VmaAllocator_T *this, long param_1, ulong param_2, undefined8 param_3, char param_4, undefined8 param_5, undefined8 param_6, undefined8 param_8, ulong *param_9, uint param_10, undefined4 param_11, undefined8 param_12, VmaBlockVector *param_13, ulong param_14, undefined8 param_15) {
   int iVar1;
   int iVar2;
   long in_FS_OFFSET;
   ulong local_78;
   ...
   if (( local_78 & 1 ) == 0) {
      if (( ( local_78 & 2 ) == 0 ) && ( ( param_1 == 0 || ( param_13[0x38] == (VmaBlockVector)0x0 ) ) )) {
         if (*(ulong*)( param_13 + 0x18 ) >> 1 < param_2) {
            if (( *(uint*)( this + 0x21c ) < 0x3fffffff ) && ( ( uint )(*(int*)( this + 0x21c ) * 3) >> 2 < *(uint*)( this + 0x1550 ) )) {
               LAB_0011275f:iVar2 = VmaBlockVector::Allocate(param_13, param_2, param_3, (VmaAllocationCreateInfo*)&local_78, param_11, param_14, param_15);
               if (iVar2 == 0) goto LAB_00112720;
               goto LAB_00112792;
            }
         } else if (( ( *(uint*)( this + 0x21c ) < 0x3fffffff ) && ( ( uint )(*(int*)( this + 0x21c ) * 3) >> 2 < *(uint*)( this + 0x1550 ) ) ) || ( param_4 == '\0' )) goto LAB_0011275f;
         iVar2 = AllocateDedicatedMemory(pVStack_50._0_4_, this, param_1, param_2, param_11, param_12, param_10, (uint)local_78 >> 2 & 1, (uint)local_78 >> 5 & 1, ( local_78 & 0xc00 ) != 0, (uint)local_78 >> 9 & 1, local_58, param_5, param_6, param_8, param_14, param_15, *(undefined8*)( param_13 + 0x50 ));
         if (iVar2 == 0) goto LAB_00112720;
      }
      iVar2 = VmaBlockVector::Allocate(param_13, param_2, param_3, (VmaAllocationCreateInfo*)&local_78, param_11, param_14);
      if (iVar2 != 0) {
         iVar1 = iVar2;
      }
   } else {
      LAB_00112792:iVar1 = AllocateDedicatedMemory(pVStack_50._0_4_, this, param_1, param_2, param_11, param_12, param_10, (uint)local_78 >> 2 & 1, (uint)local_78 >> 5 & 1, ( (uint)local_78 & 0xc00 ) != 0, (uint)local_78 >> 9 & 1, local_58, param_5, param_6, param_8, param_14, param_15, *(undefined8*)( param_13 + 0x50 ));
   }
   LAB_00112720:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return iVar1;
   ...
   VmaAllocation_T**) */undefined8 VmaAllocator_T::AllocateMemory(VmaAllocator_T *this, long *param_1, bool param_2, byte param_3, undefined8 param_4, undefined8 param_5, undefined8 param_7, undefined8 *param_8, undefined4 param_9, long param_10, void *param_11) {
   uint uVar1;
   int iVar2;
   undefined8 uVar3;
   ulong uVar4;
         ...
         if (lStack_60 == 0) {
            ...
            if ((int)uVar3 == 0) {
               while (true) {
                  ...
                  uVar3 = AllocateMemoryOfType(this, 0, lVar6, param_1[1], param_3 | param_2, param_4, param_5, param_7, &local_78, uVar4, param_9, this + uVar4 * 0x58 + 0x710, *(undefined8*)( this + uVar4 * 8 + 0x610 ), param_10, param_11);
   ...
   return uVar3;
}ulong vmaAllocateMemory(VmaAllocator_T *param_1, undefined8 param_2, undefined8 param_3, undefined8 *param_4, VmaAllocationInfo *param_5) {
   ulong uVar1;
   uVar1 = VmaAllocator_T::AllocateMemory(param_1, param_2, 0, 0, 0, 0, VmaBufferImageUsage::UNKNOWN, param_3, 1, 1, param_4);
   if (( param_5 != (VmaAllocationInfo*)0x0 ) && ( (int)uVar1 == 0 )) {
      VmaAllocator_T::GetAllocationInfo(param_1, (VmaAllocation_T*)*param_4, param_5);
      return uVar1 & 0xffffffff;
   }
   return uVar1;
}undefined8 vmaAllocateMemoryPages(VmaAllocator_T *param_1, undefined8 param_2, undefined8 param_3, long param_4, long param_5, VmaAllocationInfo *param_6) {
   long lVar1;
   undefined8 uVar2;
   long lVar3;
   if (param_4 == 0) {
   ...
   uVar2 = VmaAllocator_T::AllocateMemory(param_1, param_2, 0, 0, 0, 0, VmaBufferImageUsage::UNKNOWN, param_3, 1, param_4, param_5);
   ...
   return uVar2;
}int vmaAllocateMemoryForBuffer(VmaAllocator_T *param_1, VkBuffer_T *param_2, undefined8 param_3, undefined8 *param_4, VmaAllocationInfo *param_5) {
   int iVar1;
   long in_FS_OFFSET;
   bool local_5a;
   bool local_59;
   ...
   local_59 = false;
   for (int i = 0; i < 16; i++) {
      local_58[i] = (VkMemoryRequirements)0;
   }
   VmaAllocator_T::GetBufferMemoryRequirements(param_1, param_2, local_58, &local_5a, &local_59);
   iVar1 = VmaAllocator_T::AllocateMemory(param_1, local_58, local_5a, local_59, param_2, 0, VmaBufferImageUsage::UNKNOWN, param_3, 2, 1, param_4);
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}int vmaAllocateMemoryForImage(VmaAllocator_T *param_1, VkImage_T *param_2, undefined8 param_3, undefined8 *param_4, VmaAllocationInfo *param_5) {
   int iVar1;
   long in_FS_OFFSET;
   bool local_5a;
   bool local_59;
   ...
   iVar1 = VmaAllocator_T::AllocateMemory(param_1, local_58, local_5a, local_59, 0, param_2, VmaBufferImageUsage::UNKNOWN, param_3, 3, 1, param_4);
   if (( param_5 != (VmaAllocationInfo*)0x0 ) && ( iVar1 == 0 )) {
      VmaAllocator_T::GetAllocationInfo(param_1, (VmaAllocation_T*)*param_4, param_5);
   }
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}int vmaCreateBuffer(VmaAllocator_T *param_1, long param_2, byte *param_3, undefined8 *param_4, VmaAllocation_T **param_5, VmaAllocationInfo *param_6) {
   VmaAllocator_T VVar1;
   code *pcVar2;
   int *piVar3;
   int iVar4;
   ...
   long local_40;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (( *(long*)( param_2 + 0x18 ) == 0 ) || ( ( ( *(byte*)( param_2 + 0x22 ) & 2 ) != 0 && ( param_1[0xc] == (VmaAllocator_T)0x0 ) ) )) {
      iVar4 = -3;
      goto LAB_00112df7;
   }
   pVVar6 = (VmaAllocator_T*)0x0;
   ...
   *param_5 = (VmaAllocation_T*)0x0;
   ...
   VmaAllocator_T::GetBufferMemoryRequirements(param_1, (VkBuffer_T*)*param_4, local_58, &local_5a, &local_59);
   if (param_1[0xf] != (VmaAllocator_T)0x0) {
   ...
   LAB_00112e84:iVar4 = VmaAllocator_T::AllocateMemory(param_1, local_58, local_5a, local_59, *param_4, 0, uVar5, param_3, 2, 1, param_5);
   if (iVar4 < 0) {
      VVar1 = param_1[0x20];
      pcVar2 = *(code**)( param_1 + 0x16c0 );
      joined_r0x00112f55:pVVar6 = (VmaAllocator_T*)0x0;
      if (VVar1 != (VmaAllocator_T)0x0) {
         pVVar6 = param_1 + 0x28;
      }
      ...
      *param_4 = 0;
      ...
      uVar5 = ( ulong ) * (uint*)( param_2 + 0x20 );
      LAB_00112f24:*(ulong*)( pVVar7 + 0x50 ) = uVar5;
      if (param_6 != (VmaAllocationInfo*)0x0) {
         VmaAllocator_T::GetAllocationInfo(param_1, pVVar7, param_6);
      }
      iVar4 = 0;
   }
   LAB_00112df7:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return iVar4;
}ulong vmaCreateBufferWithAlignment(VmaAllocator_T *param_1, long param_2, byte *param_3, ulong param_4, undefined8 *param_5, VmaAllocation_T **param_6, VmaAllocationInfo *param_7) {
   VmaAllocator_T VVar1;
   code *pcVar2;
   int *piVar3;
   uint uVar4;
   ...
   *param_6 = (VmaAllocation_T*)0x0;
   ...
   VmaAllocator_T::GetBufferMemoryRequirements(param_1, (VkBuffer_T*)*param_5, local_58, &local_5a, &local_59);
   uVar5 = uStack_50;
   ...
   uVar5 = ( ulong ) * (uint*)( param_2 + 0x20 );
   LAB_001130e3:uVar4 = VmaAllocator_T::AllocateMemory(param_1, local_58, local_5a, local_59, *param_5, 0, uVar5, param_3, 2, 1, param_6);
   if ((int)uVar4 < 0) {
      VVar1 = param_1[0x20];
      pcVar2 = *(code**)( param_1 + 0x16c0 );
      joined_r0x001131b5:pVVar6 = (VmaAllocator_T*)0x0;
      if (VVar1 != (VmaAllocator_T)0x0) {
         pVVar6 = param_1 + 0x28;
      }
      ...
      *param_5 = 0;
      ...
      uVar5 = ( ulong ) * (uint*)( param_2 + 0x20 );
      LAB_00113183:*(ulong*)( pVVar7 + 0x50 ) = uVar5;
      if (param_7 != (VmaAllocationInfo*)0x0) {
         VmaAllocator_T::GetAllocationInfo(param_1, pVVar7, param_7);
      }
      uVar5 = 0;
   }
   LAB_0011303f:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return uVar5;
}int vmaCreateImage(VmaAllocator_T *param_1, long param_2, byte *param_3, undefined8 *param_4, VmaAllocation_T **param_5, VmaAllocationInfo *param_6) {
   VmaAllocator_T VVar1;
   code *pcVar2;
   int iVar3;
   VmaAllocator_T *pVVar4;
   ...
   long local_40;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (( ( ( *(int*)( param_2 + 0x1c ) == 0 ) || ( *(int*)( param_2 + 0x20 ) == 0 ) ) || ( *(int*)( param_2 + 0x24 ) == 0 ) ) || ( ( *(int*)( param_2 + 0x28 ) == 0 || ( *(int*)( param_2 + 0x2c ) == 0 ) ) )) {
      iVar3 = -3;
      goto LAB_00113398;
   }
   pVVar4 = (VmaAllocator_T*)0x0;
   ...
   *param_5 = (VmaAllocation_T*)0x0;
   ...
   VmaAllocator_T::GetImageMemoryRequirements(param_1, (VkImage_T*)*param_4, local_58, &local_5a, &local_59);
   iVar3 = VmaAllocator_T::AllocateMemory(param_1, local_58, local_5a, local_59, 0, *param_4, *(undefined4*)( param_2 + 0x38 ), param_3, 5 - ( uint )(iVar3 != 0), 1, param_5);
   if (iVar3 < 0) {
      VVar1 = param_1[0x20];
      pcVar2 = *(code**)( param_1 + 0x16d0 );
      joined_r0x001133cd:pVVar4 = (VmaAllocator_T*)0x0;
      if (VVar1 != (VmaAllocator_T)0x0) {
         pVVar4 = param_1 + 0x28;
      }
   ...
   LAB_00113398:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar3;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* VmaAllocator_T::FlushOrInvalidateAllocations(unsigned int, VmaAllocation_T* const*, unsigned long
   const*, unsigned long const*, VMA_CACHE_OPERATION) */undefined4 VmaAllocator_T::FlushOrInvalidateAllocations(VmaAllocator_T *this, uint param_1, long param_2, long param_3, long param_4, int param_6) {
   undefined8 *puVar1;
   code *pcVar2;
   char cVar3;
   undefined4 uVar4;
   ...
   if (this[0x20] == (VmaAllocator_T)0x0) {
      ...
      if (param_1 == 0) {
         ...
         LAB_001134cc:local_50 = (undefined1[16])0x0;
         local_58 = (undefined1*)0x0;
         local_2e8 = 0;
         lVar8 = 0;
         do {
            while (true) {
               ...
               cVar3 = GetFlushOrInvalidateRange(this, *(VmaAllocation_T**)( param_2 + lVar8 ), uVar6, uVar5, (VkMappedMemoryRange*)&local_318);
               uVar6 = local_2e8;
               if (cVar3 == '\0') break;
               uVar5 = local_2e8 + 1;
               if (uVar5 < 0x11) {
                  if (0x10 < local_2e8) {
                     VmaVector<VkMappedMemoryRange,VmaStlAllocator<VkMappedMemoryRange>>::resize((VmaVector<VkMappedMemoryRange,VmaStlAllocator<VkMappedMemoryRange>>*)&local_60, 0);
                     uVar5 = 0;
                  }
                  puVar7 = local_2e0;
                  local_2e8 = uVar5;
               } else if (local_2e8 == 0x10) {
                  VmaVector<VkMappedMemoryRange,VmaStlAllocator<VkMappedMemoryRange>>::resize((VmaVector<VkMappedMemoryRange,VmaStlAllocator<VkMappedMemoryRange>>*)&local_60, 0x11);
                  if (local_2e8 == 0) {
                     local_2e8 = 0x11;
                     puVar7 = local_58;
                  } else {
                  ...
                  VmaVector<VkMappedMemoryRange,VmaStlAllocator<VkMappedMemoryRange>>::resize((VmaVector<VkMappedMemoryRange,VmaStlAllocator<VkMappedMemoryRange>>*)&local_60, uVar5);
                  puVar7 = local_58;
                  local_2e8 = uVar5;
               }
               lVar8 = lVar8 + 8;
         ...
         LAB_0011359c:if (local_2e8 == 0) {
            LAB_001135bb:uVar4 = 0;
         } else {
            if (param_6 == 0) {
   ...
   LAB_001136f0:free(local_58);
   LAB_001135e8:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar4;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   uVar1 = VmaAllocator_T::FlushOrInvalidateAllocations();
   return uVar1;
}/* VmaBlockMetadata::Init(unsigned long) */void VmaBlockMetadata::Init(VmaBlockMetadata *this, ulong param_1) {
   *(ulong*)( this + 8 ) = param_1;
   return;
}/* VmaBlockMetadata_Linear::GetSumFreeSize() const */undefined8 VmaBlockMetadata_Linear::GetSumFreeSize(VmaBlockMetadata_Linear *this) {
   return *(undefined8*)( this + 0x28 );
}/* VmaBlockMetadata_Linear::GetAllocationOffset(VmaAllocHandle_T*) const */VmaAllocHandle_T * __thiscall
VmaBlockMetadata_Linear::GetAllocationOffset
          (VmaBlockMetadata_Linear *this,VmaAllocHandle_T *param_1){
   return param_1 + -1;
}/* VmaBlockMetadata_TLSF::GetAllocationCount() const */undefined8 VmaBlockMetadata_TLSF::GetAllocationCount(VmaBlockMetadata_TLSF *this) {
   return *(undefined8*)( this + 0x28 );
}/* VmaBlockMetadata_TLSF::GetFreeRegionsCount() const */long VmaBlockMetadata_TLSF::GetFreeRegionsCount(VmaBlockMetadata_TLSF *this) {
   return *(long*)( this + 0x30 ) + 1;
}/* VmaBlockMetadata_TLSF::GetSumFreeSize() const */long VmaBlockMetadata_TLSF::GetSumFreeSize(VmaBlockMetadata_TLSF *this) {
   return *(long*)( this + 0x38 ) + *(long*)( *(long*)( this + 0x170 ) + 8 );
}/* VmaBlockMetadata_TLSF::IsEmpty() const */undefined8 VmaBlockMetadata_TLSF::IsEmpty(VmaBlockMetadata_TLSF *this) {
   return CONCAT71(( int7 )(( ulong ) * (long**)( this + 0x170 ) >> 8), **(long**)( this + 0x170 ) == 0);
}/* VmaBlockMetadata_TLSF::GetAllocationOffset(VmaAllocHandle_T*) const */undefined8 VmaBlockMetadata_TLSF::GetAllocationOffset(VmaBlockMetadata_TLSF *this, VmaAllocHandle_T *param_1) {
   return *(undefined8*)param_1;
}/* VmaBlockMetadata_Linear::IsEmpty() const */bool VmaBlockMetadata_Linear::IsEmpty(VmaBlockMetadata_Linear *this) {
   long lVar1;
   ...
   return lVar1 == 0;
}/* VmaBlockMetadata_Linear::~VmaBlockMetadata_Linear() */void VmaBlockMetadata_Linear::~VmaBlockMetadata_Linear(VmaBlockMetadata_Linear *this) {
   undefined8 *puVar1;
   void *__ptr;
   *(undefined***)this = &PTR__VmaBlockMetadata_Linear_001151b0;
   ...
   *(undefined***)this = &PTR__VmaBlockMetadata_Linear_001151b0;
   ...
   VmaDefragmentationContext_T::StateBalanced&) [clone .cold] */void VmaDefragmentationContext_T::UpdateVectorStatistics(VmaBlockVector *param_1, StateBalanced *param_2) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}/* VmaVector<char, VmaStlAllocator<char> >::resize(unsigned long) */void VmaVector<char,VmaStlAllocator<char>>::resize(VmaVector<char,VmaStlAllocator<char>> *this, ulong param_1) {
   undefined8 *puVar1;
   void *__dest;
   ulong uVar2;
   ulong uVar3;
   ...
   *(ulong*)( this + 0x10 ) = param_1;
   return;
}/* VmaVector<VmaSuballocation, VmaStlAllocator<VmaSuballocation> >::resize(unsigned long) */void VmaVector<VmaSuballocation,VmaStlAllocator<VmaSuballocation>>::resize(VmaVector<VmaSuballocation,VmaStlAllocator<VmaSuballocation>> *this, ulong param_1) {
   undefined8 *puVar1;
   void *__dest;
   ulong uVar2;
   ulong uVar3;
   ...
   *(ulong*)( this + 0x10 ) = param_1;
   return;
}/* VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>::Free(VmaBlockMetadata_TLSF::Block*) */void VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>::Free(VmaPoolAllocator<VmaBlockMetadata_TLSF::Block> *this, Block *param_1) {
   long lVar1;
   Block *pBVar2;
   ulong *puVar3;
   long lVar4;
   ...
   >::push_back(VmaDefragmentationContext_T::FragmentedBlock const&) */void VmaVector<VmaDefragmentationContext_T::FragmentedBlock,VmaStlAllocator<VmaDefragmentationContext_T::FragmentedBlock>>::push_back(VmaVector<VmaDefragmentationContext_T::FragmentedBlock,VmaStlAllocator<VmaDefragmentationContext_T::FragmentedBlock>> *this, FragmentedBlock *param_1) {
   ulong uVar1;
   ulong uVar2;
   undefined8 *puVar3;
   undefined8 uVar4;
   ...
   __dest = *(void**)( this + 8 );
   LAB_001144d4:uVar4 = *(undefined8*)param_1;
   ...
   *puVar3 = uVar4;
   ...
   long) */void VmaVector<VmaJsonWriter::StackItem,VmaStlAllocator<VmaJsonWriter::StackItem>>::resize(VmaVector<VmaJsonWriter::StackItem,VmaStlAllocator<VmaJsonWriter::StackItem>> *this, ulong param_1) {
   undefined8 *puVar1;
   void *__dest;
   ulong uVar2;
   ulong uVar3;
   ...
   *(ulong*)( this + 0x10 ) = param_1;
    ...
    */void VmaVector<VmaDeviceMemoryBlock*,VmaStlAllocator<VmaDeviceMemoryBlock*>>::resize(VmaVector<VmaDeviceMemoryBlock*,VmaStlAllocator<VmaDeviceMemoryBlock*>> *this, ulong param_1) {
   undefined8 *puVar1;
   void *__dest;
   ulong uVar2;
   ulong uVar3;
   ...
   *(ulong*)( this + 0x10 ) = param_1;
   ...
   long) */void VmaVector<VmaDefragmentationMove,VmaStlAllocator<VmaDefragmentationMove>>::resize(VmaVector<VmaDefragmentationMove,VmaStlAllocator<VmaDefragmentationMove>> *this, ulong param_1) {
   undefined8 *puVar1;
   void *__dest;
   ulong uVar2;
   ulong uVar3;
   ...
   *(ulong*)( this + 0x10 ) = param_1;
   ...
   long) */void VmaVector<VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>::ItemBlock,VmaStlAllocator<VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>::ItemBlock>>::resize(VmaVector<VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>::ItemBlock,VmaStlAllocator<VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>::ItemBlock>> *this, ulong param_1) {
   undefined8 *puVar1;
   void *__dest;
   ulong uVar2;
   ulong uVar3;
   ...
   *(ulong*)( this + 0x10 ) = param_1;
   return;
}/* VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>::CreateNewBlock() */long VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>::CreateNewBlock(VmaPoolAllocator<VmaBlockMetadata_TLSF::Block> *this) {
   uint uVar1;
   uint *puVar2;
   ulong uVar3;
   uint *puVar4;
   ...
   VmaVector<VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>::ItemBlock,VmaStlAllocator<VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>::ItemBlock>>::resize((VmaVector<VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>::ItemBlock,VmaStlAllocator<VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>::ItemBlock>>*)( this + 0x10 ), lVar7 + 1);
...
}/* VmaBlockMetadata_TLSF::Block* VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>::Alloc<>() */Block * __thiscall
VmaPoolAllocator<VmaBlockMetadata_TLSF::Block>::Alloc<>
   ...
   *(undefined1(*) [16])( pBVar3 + 0x20 ) = (undefined1[16])0x0;
   ...
   VmaStlAllocator<VmaPoolAllocator<VmaAllocation_T>::ItemBlock> >::resize(unsigned long) */void VmaVector<VmaPoolAllocator<VmaAllocation_T>::ItemBlock,VmaStlAllocator<VmaPoolAllocator<VmaAllocation_T>::ItemBlock>>::resize(VmaVector<VmaPoolAllocator<VmaAllocation_T>::ItemBlock,VmaStlAllocator<VmaPoolAllocator<VmaAllocation_T>::ItemBlock>> *this, ulong param_1) {
   undefined8 *puVar1;
   void *__dest;
   ulong uVar2;
   ulong uVar3;
   ...
   *(ulong*)( this + 0x10 ) = param_1;
   return;
}/* VmaPoolAllocator<VmaAllocation_T>::CreateNewBlock() */long VmaPoolAllocator<VmaAllocation_T>::CreateNewBlock(VmaPoolAllocator<VmaAllocation_T> *this) {
   uint uVar1;
   uint *puVar2;
   ulong uVar3;
   uint *puVar4;
   ...
   VmaVector<VmaPoolAllocator<VmaAllocation_T>::ItemBlock,VmaStlAllocator<VmaPoolAllocator<VmaAllocation_T>::ItemBlock>>::resize(( VmaVector<VmaPoolAllocator<VmaAllocation_T>::ItemBlock,VmaStlAllocator < VmaPoolAllocator<VmaAllocation_T>::ItemBlock> > * )(this + 0x10), lVar7 + 1);
   puVar8 = (undefined8*)( lVar7 * 0x10 + *(long*)( this + 0x18 ) );
   *puVar8 = puVar2;
   puVar8[1] = (ulong)uVar5;
   if (uVar5 != 1) {
   ...
   *puVar2 = 0xffffffff;
   return *(long*)( this + 0x18 ) + -0x10 + *(long*)( this + 0x20 ) * 0x10;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* VmaAllocation_T* VmaPoolAllocator<VmaAllocation_T>::Alloc<bool const&>(bool const&) */VmaAllocation_T * __thiscall
VmaPoolAllocator<VmaAllocation_T>::Alloc<bool_const&>
   ...
   *(undefined1(*) [16])( pVVar2 + 0x38 ) = (undefined1[16])0x0;
   ...
   pVVar2[0x4f] = (VmaAllocation_T)0x2;
   return pVVar2;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* VmaAllocation_T* VmaPoolAllocator<VmaAllocation_T>::Alloc<bool&>(bool&) */VmaAllocation_T * __thiscall
VmaPoolAllocator<VmaAllocation_T>::Alloc<bool&>
   ...
   *(undefined1(*) [16])( pVVar2 + 0x38 ) = (undefined1[16])0x0;
   ...
   pVVar2[0x4f] = (VmaAllocation_T)0x2;
   return pVVar2;
}/* VmaVector<VkMappedMemoryRange, VmaStlAllocator<VkMappedMemoryRange> >::resize(unsigned long) */void VmaVector<VkMappedMemoryRange,VmaStlAllocator<VkMappedMemoryRange>>::resize(VmaVector<VkMappedMemoryRange,VmaStlAllocator<VkMappedMemoryRange>> *this, ulong param_1) {
   undefined8 *puVar1;
   void *__dest;
   ulong uVar2;
   ulong uVar3;
   ...
   *(ulong*)( this + 0x10 ) = param_1;
   return;
}/* VmaVector<VkMappedMemoryRange, VmaStlAllocator<VkMappedMemoryRange> >::shrink_to_fit() */void VmaVector<VkMappedMemoryRange,VmaStlAllocator<VkMappedMemoryRange>>::shrink_to_fit(VmaVector<VkMappedMemoryRange,VmaStlAllocator<VkMappedMemoryRange>> *this) {
   ulong uVar1;
   undefined8 *puVar2;
   void *__ptr;
   void *__dest;
   ...
   return;
}/* VmaBufferImageUsage::UNKNOWN */void VmaBufferImageUsage::_GLOBAL__sub_I_UNKNOWN(void) {
   UNKNOWN = 0;
   return;
}/* WARNING: Control flow encountered bad instruction data *//* VmaBlockMetadata_Linear::~VmaBlockMetadata_Linear() */void VmaBlockMetadata_Linear::~VmaBlockMetadata_Linear(VmaBlockMetadata_Linear *this) {

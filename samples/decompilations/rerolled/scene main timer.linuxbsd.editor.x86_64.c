/* Timer::get_wait_time() const */undefined8 Timer::get_wait_time(Timer *this) {
   return *(undefined8*)( this + 0x408 );
}/* Timer::set_one_shot(bool) */void Timer::set_one_shot(Timer *this, bool param_1) {
   this[0x410] = (Timer)param_1;
   return;
}/* Timer::is_one_shot() const */Timer Timer::is_one_shot(Timer *this) {
   return this[0x410];
}/* Timer::set_autostart(bool) */void Timer::set_autostart(Timer *this, bool param_1) {
   this[0x411] = (Timer)param_1;
   return;
}/* Timer::has_autostart() const */Timer Timer::has_autostart(Timer *this) {
   return this[0x411];
}/* Timer::is_paused() const */Timer Timer::is_paused(Timer *this) {
   return this[0x413];
}/* Timer::set_ignore_time_scale(bool) */void Timer::set_ignore_time_scale(Timer *this, bool param_1) {
   this[0x414] = (Timer)param_1;
   return;
}/* Timer::is_ignoring_time_scale() */Timer Timer::is_ignoring_time_scale(Timer *this) {
   return this[0x414];
}/* Timer::is_stopped() const */bool Timer::is_stopped(Timer *this) {
   return *(double*)( this + 0x418 ) <= 0.0;
}/* Timer::get_time_left() const */double Timer::get_time_left(Timer *this) {
   if (0.0 < *(double*)( this + 0x418 )) {
      return *(double*)( this + 0x418 );
   }
   return 0.0;
}/* Timer::get_timer_process_callback() const */undefined4 Timer::get_timer_process_callback(Timer *this) {
   return *(undefined4*)( this + 0x420 );
}/* Timer::set_timer_process_callback(Timer::TimerProcessCallback) */void Timer::set_timer_process_callback(Timer *this, int param_2) {
   int iVar1;
   char cVar2;
   bool bVar3;
   ...
   return;
}/* Timer::set_wait_time(double) */void Timer::set_wait_time(Timer *this, double param_1) {
   if (0.0 < param_1) {
      *(double*)( this + 0x408 ) = param_1;
      Node::update_configuration_warnings();
      return;
   }
   _err_print_error("set_wait_time", "scene/main/timer.cpp", 0x5b, "Condition \"p_time <= 0\" is true.", "Time should be greater than zero.", 0, 0);
   return;
}/* Timer::stop() */void Timer::stop(Timer *this) {
   ...
   *(undefined2*)( this + 0x411 ) = 0;
   return;
}/* Timer::start(double) */undefined1  [16] __thiscallTimer::start(Timer *this, double param_1) {
   uint uVar1;
   ...
   _err_print_error("start", "scene/main/timer.cpp", 0x75, "Condition \"!is_inside_tree()\" is true.", "Timer was not added to the SceneTree. Either add it or set autostart to true.", 0);
   auVar2._8_8_ = 0;
   auVar2._0_8_ = uStack_10;
   return auVar2 << 0x40;
}/* Timer::set_paused(bool) */void Timer::set_paused(Timer *this, bool param_1) {
   Timer TVar1;
   ...
   return;
}/* Timer::_set_process(bool, bool) */void Timer::_set_process(bool param_1, bool param_2) {
   ...
   *(bool*)( lVar1 + 0x412 ) = param_2;
   return;
}/* Timer::_notification(int) */void Timer::_notification(Timer *this, int param_1) {
   long lVar1;
   char cVar2;
   int iVar3;
   long lVar4;
   ...
   if (param_1 == 0x19) {
      if (( ( this[0x412] == (Timer)0x0 ) || ( *(int*)( this + 0x420 ) == 0 ) ) || ( cVar2 = Node::is_processing_internal() ),cVar2 == '\0') goto LAB_001004e0;
      ...
      *(double*)( this + 0x418 ) = dVar7;
      ...
      pcVar5 = (char *)&_notification(int)::{lambda()
      #1
      if (_notification(int)::{lambda()
      #1
      puVar6 = &_notification(int)::{lambda()
      #1
      pcVar5 = (char *)&_notification(int)::{lambda()
      #1
      iVar3 = __cxa_guard_acquire(&_notification(int)::{lambda()
      #1
      joined_r0x0010067e:if (iVar3 != 0) {
    ...
    if (((this[0x412] == (Timer)0x0) || (*(int *)(this + 0x420) == 1)) ||
       (cVar2 = Node::is_physics_processing_internal(), cVar2 == '\0')) gotoLAB_001004e0;if (this[0x414] == (Timer)0x0) {
   dVar7 = (double)Node::get_physics_process_delta_time();
   dVar7 = *(double*)( this + 0x418 ) - dVar7;
} else {
   lVar4 = Engine::get_singleton();
   dVar7 = *(double*)( this + 0x418 ) - *(double*)( lVar4 + 0x20 );
}*(double*)( this + 0x418 ) = dVar7;if (0.0 <= dVar7) goto LAB_001004e0;if (this[0x410] == (Timer)0x0) {
   *(double*)( this + 0x418 ) = dVar7 + *(double*)( this + 0x408 );
} else {
   *(double*)( this + 0x418 ) = _LC5;
   _set_process(SUB81(this, 0), false);
   this[0x411] = (Timer)0x0;
}pcVar5 = (char *)&_notification(int)::{lambda()#2if (_notification(int)::{lambda()#2puVar6 = &_notification(int)::{lambda()#2pcVar5 = (char *)&_notification(int)::{lambda()#2iVar3 = __cxa_guard_acquire(&_notification(int)::{lambda()#2goto joined_r0x0010067e;}
  }( **(code**)( *(long*)this + 0xd0 ) )(this, pcVar5, 0, 0);if (Variant::needs_deinit[0] != '\0') {
   Variant::_clear_internal();
}LAB_001004e0:if (lVar1 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return;
}/* WARNING: Subroutine does not return */__stack_chk_fail();}/* Timer::Timer() */void Timer::Timer(Timer *this) {
   undefined8 uVar1;
   Node::Node((Node*)this);
   ...
   *(undefined8*)( this + 0x418 ) = uVar1;
   return;
}/* Timer::_bind_methods() */void Timer::_bind_methods(void) {
   char cVar1;
   long lVar2;
   code *pcVar3;
   ...
   if (local_128 == 0) {
      ...
      LAB_00101d8b:StringName::operator =((StringName*)local_e8, (StringName*)&local_120);
   } else {
   ...
   if (( ( ( StringName::configured != '\0' ) && ( ( local_120 == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) ) ) && ( ( local_118 == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) ) ) && ( local_110 != 0 )) {
      StringName::unref();
   }
   _scs_create((char*)&local_110, true);
   _scs_create((char*)&local_118, true);
   ...
   if (local_128 == 0) {
      local_d0 = CONCAT44(local_d0._4_4_, 6);
      LAB_00101ffb:StringName::operator =((StringName*)local_e8, local_150);
   } else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_d8, (CowData*)&local_128);
      local_d0 = CONCAT44(local_d0._4_4_, 6);
   ...
   if (local_128 == 0) {
      local_d0 = CONCAT44(local_d0._4_4_, 6);
      LAB_0010225b:StringName::operator =((StringName*)local_e8, local_150);
   } else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_d8, (CowData*)&local_128);
      local_d0 = CONCAT44(local_d0._4_4_, 6);
   ...
   if (local_128 == 0) {
      local_d0 = CONCAT44(local_d0._4_4_, 6);
      LAB_001024bb:StringName::operator =((StringName*)local_e8, local_150);
   } else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_d8, (CowData*)&local_128);
      local_d0 = CONCAT44(local_d0._4_4_, 6);
   ...
   if (local_128 == 0) {
      ...
      LAB_0010271b:StringName::operator =((StringName*)local_e8, local_150);
   } else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_d8, (CowData*)&local_128);
      local_d0 = local_d0 & 0xffffffff00000000;
   ...
   if (local_128 == 0) {
      local_d0 = CONCAT44(local_d0._4_4_, 6);
      LAB_0010297b:StringName::operator =((StringName*)local_e8, local_150);
   } else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_d8, (CowData*)&local_128);
      local_d0 = CONCAT44(local_d0._4_4_, 6);
   ...
   local_f0 = 0x15;
   String::parse_latin1((StrRange*)&local_118);
   GetTypeInfo<Timer::TimerProcessCallback,void>::get_class_info((GetTypeInfo<Timer::TimerProcessCallback,void>*)&local_f8);
   lVar2 = local_d8;
   ...
   return;
}/* Timer::get_configuration_warnings() const */void Timer::get_configuration_warnings(void) {
   long *plVar1;
   ...
   if (_LC82 < *(double*)( in_RSI + 0x408 ) || _LC82 == *(double*)( in_RSI + 0x408 )) goto LAB_001036bf;
   local_60 = 0;
   local_50 = 0;
   local_58 = "";
   String::parse_latin1((StrRange*)&local_60);
   local_58 = "Very low timer wait times (< 0.05 seconds) may behave in significantly different ways depending on the rendered or physics frame rate.\nConsider using a script\'s process loop instead of relying on a Timer for very low wait times.";
   local_68 = 0;
   local_50 = 0xe4;
   ...
   LAB_001037bd:CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
   lVar3 = local_68;
   if (local_68 != 0) {
      LOCK();
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
   LAB_001036bf:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   return 0;
}/* Timer::is_class_ptr(void*) const */uint Timer::is_class_ptr(Timer *this, void *param_1) {
   return (uint)CONCAT71(0x10b3, (undefined4*)param_1 == &Node::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10b3, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10b3, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}/* Timer::_getv(StringName const&, Variant&) const */undefined8 Timer::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}/* Timer::_setv(StringName const&, Variant const&) */undefined8 Timer::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}/* Timer::_property_can_revertv(StringName const&) const */undefined8 Timer::_property_can_revertv(StringName *param_1) {
   return 0;
}/* Timer::_property_get_revertv(StringName const&, Variant&) const */undefined8 Timer::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}/* MethodBindTRC<Timer::TimerProcessCallback>::_gen_argument_type(int) const */undefined8 MethodBindTRC<Timer::TimerProcessCallback>::_gen_argument_type(int param_1) {
   return 2;
}/* MethodBindTRC<Timer::TimerProcessCallback>::get_argument_meta(int) const */undefined8 MethodBindTRC<Timer::TimerProcessCallback>::get_argument_meta(int param_1) {
   return 0;
}/* MethodBindT<Timer::TimerProcessCallback>::_gen_argument_type(int) const */char MethodBindT<Timer::TimerProcessCallback>::_gen_argument_type(MethodBindT<Timer::TimerProcessCallback> *this, int param_1) {
   return ( param_1 == 0 ) * '\x02';
}/* MethodBindT<Timer::TimerProcessCallback>::get_argument_meta(int) const */undefined8 MethodBindT<Timer::TimerProcessCallback>::get_argument_meta(int param_1) {
   return 0;
   ...
   *(undefined***)this = &PTR__gen_argument_type_0010b128;
   ...
   operator_delete(this, 0x68);
   return;
}/* MethodBindT<Timer::TimerProcessCallback>::~MethodBindT() */void MethodBindT<Timer::TimerProcessCallback>::~MethodBindT(MethodBindT<Timer::TimerProcessCallback> *this) {
   ...
   *(undefined***)this = &PTR__gen_argument_type_0010b308;
   ...
   operator_delete(this, 0x68);
   return;
}/* MethodBindTRC<Timer::TimerProcessCallback>::~MethodBindTRC() */void MethodBindTRC<Timer::TimerProcessCallback>::~MethodBindTRC(MethodBindTRC<Timer::TimerProcessCallback> *this) {
   ...
   *(undefined***)this = &PTR__gen_argument_type_0010b368;
   ...
   operator_delete(this, 0x68);
   return;
}/* Timer::~Timer() */void Timer::~Timer(Timer *this) {
   *(undefined***)this = &PTR__initialize_classv_0010af00;
   Node::~Node((Node*)this);
   return;
}/* Timer::~Timer() */void Timer::~Timer(Timer *this) {
   *(undefined***)this = &PTR__initialize_classv_0010af00;
   ...
   return;
}/* Timer::_validate_propertyv(PropertyInfo&) const */void Timer::_validate_propertyv(PropertyInfo *param_1) {
   if ((code*)_GLOBAL_OFFSET_TABLE_ != Object::_validate_property) {
      Node::_validate_property(param_1);
      return;
   }
   return;
}/* Timer::_get_class_namev() const */undefined8 *Timer::_get_class_namev(void) {
   int iVar1;
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00104273:return &_get_class_namev();
      }
      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00104273;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "Timer");
         goto LAB_001042de;
      }
   }
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "Timer");
   LAB_001042de:return &_get_class_namev();
}/* Timer::get_class() const */void Timer::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
   ...
   *(undefined1(*) [16])( puVar3 + 2 ) = (undefined1[16])0x0;
   ...
   lVar2 = local_58;
   joined_r0x0010452c:local_58 = lVar2;
   if (lVar2 != 0) {
      LOCK();
   ...
   *(undefined1(*) [16])( puVar3 + 2 ) = (undefined1[16])0x0;
   ...
   StringName::operator =((StringName*)( puVar3 + 4 ), (StringName*)&local_50);
   lVar2 = local_58;
   joined_r0x001046ac:local_58 = lVar2;
   if (lVar2 != 0) {
      LOCK();
      plVar1 = (long*)( lVar2 + -0x10 );
      *plVar1 = *plVar1 + -1;
   ...
   *(undefined1(*) [16])( puVar3 + 2 ) = (undefined1[16])0x0;
   ...
   StringName::operator =((StringName*)( puVar3 + 4 ), (StringName*)&local_50);
   lVar2 = local_58;
   joined_r0x0010482c:local_58 = lVar2;
   if (lVar2 != 0) {
      LOCK();
      plVar1 = (long*)( lVar2 + -0x10 );
      *plVar1 = *plVar1 + -1;
   ...
   *(int*)( plVar1 + 2 ) = (int)plVar1[2] + 1;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* Timer::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Timer::_get_property_listv(Timer *this, List *param_1, bool param_2) {
   long *plVar1;
   long lVar2;
   long lVar3;
   undefined1(*pauVar4)[16];
   ...
   *(int*)( plVar1 + 2 ) = (int)plVar1[2] + 1;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* Timer::_notificationv(int, bool) */void Timer::_notificationv(Timer *this, int param_1, bool param_2) {
   if (!param_2) {
   ...
   *(undefined8*)this = 0;
   Memory::free_static((void*)( lVar2 + -0x10 ), false);
   return;
}/* Timer::is_class(String const&) const */undefined8 Timer::is_class(Timer *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long lVar4;
   ...
   for (lVar2 = *(long*)( this + 8 ); lVar2 != 0; lVar2 = *(long*)( lVar2 + 8 )) {
      ...
      LAB_001053ff:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
   ...
   if (cVar6 == '\0') {
      for (lVar2 = *(long*)( this + 8 ); lVar2 != 0; lVar2 = *(long*)( lVar2 + 8 )) {
         ...
         LAB_0010558b:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
      ...
      if (cVar6 == '\0') {
         for (lVar2 = *(long*)( this + 8 ); lVar2 != 0; lVar2 = *(long*)( lVar2 + 8 )) {
            ...
            LAB_00105667:cVar6 = String::operator ==(param_1, (String*)&local_60);
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
            if (cVar6 != '\0') goto LAB_001054b3;
         }
         if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   ...
   LAB_001054b3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }
   LAB_001056e1:/* WARNING: Subroutine does not return */__stack_chk_fail();
   ...
   *puVar5 = local_68._0_4_;
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)local_60);
   LAB_00105739:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return puVar5;
   ...
   *puVar5 = local_68._0_4_;
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)local_60);
   LAB_001059a9:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return puVar5;
}/* MethodBind* create_method_bind<Timer, double>(void (Timer::*)(double)) */MethodBind *create_method_bind<Timer,double>(_func_void_double *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
   ...
   *(undefined4*)( this + 0x34 ) = 1;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBind* create_method_bind<Timer, double>(double (Timer::*)() const) */MethodBind *create_method_bind<Timer,double>(_func_double *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
   ...
   *(undefined4*)( this + 0x34 ) = 0;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBind* create_method_bind<Timer, bool>(void (Timer::*)(bool)) */MethodBind *create_method_bind<Timer,bool>(_func_void_bool *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
   ...
   *(undefined4*)( this + 0x34 ) = 1;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBind* create_method_bind<Timer, bool>(bool (Timer::*)() const) */MethodBind *create_method_bind<Timer,bool>(_func_bool *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
   ...
   *(undefined4*)( this + 0x34 ) = 0;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBind* create_method_bind<Timer>(void (Timer::*)()) */MethodBind *create_method_bind<Timer>(_func_void *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
   ...
   *(undefined4*)( this + 0x34 ) = 0;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBind* create_method_bind<Timer, bool>(bool (Timer::*)()) */MethodBind *create_method_bind<Timer,bool>(_func_bool *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
   ...
   *(undefined4*)( this + 0x34 ) = 0;
   ...
   (Timer::*)(Timer::TimerProcessCallback)) */MethodBind *create_method_bind<Timer,Timer::TimerProcessCallback>(_func_void_TimerProcessCallback *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
   ...
   *(undefined4*)( this + 0x34 ) = 1;
   ...
   (Timer::*)() const) */MethodBind *create_method_bind<Timer,Timer::TimerProcessCallback>(_func_TimerProcessCallback *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
   ...
   *(undefined8*)this = 0;
   return;
}/* GetTypeInfo<Timer::TimerProcessCallback, void>::get_class_info() */GetTypeInfo<Timer::TimerProcessCallback,void> * __thiscall
GetTypeInfo<Timer::TimerProcessCallback,void>::get_class_info
   ...
   LAB_00106706:CowData<String>::_unref((CowData<String>*)&local_50);
   ...
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBindTRC<Timer::TimerProcessCallback>::_gen_argument_type_info(int) const */undefined8 MethodBindTRC<Timer::TimerProcessCallback>::_gen_argument_type_info(int param_1) {
   long lVar1;
   undefined4 in_register_0000003c;
   long in_FS_OFFSET;
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
   GetTypeInfo<Timer::TimerProcessCallback,void>::get_class_info((GetTypeInfo<Timer::TimerProcessCallback,void>*)CONCAT44(in_register_0000003c, param_1));
   if (lVar1 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return CONCAT44(in_register_0000003c, param_1);
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* MethodBindT<Timer::TimerProcessCallback>::_gen_argument_type_info(int) const */undefined4 *MethodBindT<Timer::TimerProcessCallback>::_gen_argument_type_info(int param_1) {
   long lVar1;
   int in_EDX;
   undefined4 in_register_0000003c;
   undefined4 *puVar2;
   ...
   *(undefined1(*) [16])( puVar2 + 2 ) = (undefined1[16])0x0;
   if (in_EDX == 0) {
      GetTypeInfo<Timer::TimerProcessCallback,void>::get_class_info((GetTypeInfo<Timer::TimerProcessCallback,void>*)local_48);
      *puVar2 = local_48[0];
   ...
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}/* Timer::_bind_methods() [clone .cold] */void Timer::_bind_methods(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   ...
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}/* Timer::_initialize_classv() */void Timer::_initialize_classv(void) {
   long *plVar1;
   long lVar2;
   long in_FS_OFFSET;
   long local_60;
   ...
   undefined8 CowData<String>::resize<false>(CowData<String> *this, long param_1) {
      ...
      if (param_1 * 8 == 0) {
         LAB_00107120:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
         return 6;
      }
      uVar8 = param_1 * 8 - 1;
      uVar8 = uVar8 >> 1 | uVar8;
      ...
      if (lVar10 == lVar7) {
         LAB_0010709f:puVar9 = *(undefined8**)this;
         if (puVar9 == (undefined8*)0x0) {
            LAB_00107176:/* WARNING: Does not return */pcVar3 = (code*)invalidInstructionException();
            ( *pcVar3 )();
         }
         lVar6 = puVar9[-1];
   ...
   Object *MethodBindTRC<Timer::TimerProcessCallback>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
      Variant *pVVar1;
      long lVar2;
      char *pcVar3;
      int iVar4;
      ...
      *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
      ...
      LAB_001076b0:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return param_1;
      }
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   ...
   const */
   void MethodBindTRC<Timer::TimerProcessCallback>::validated_call(MethodBindTRC<Timer::TimerProcessCallback> *this, Object *param_1, Variant **param_2, Variant *param_3) {
      uint uVar1;
      long *plVar3;
      long in_FS_OFFSET;
      long local_58;
      ...
      *(ulong*)( param_3 + 8 ) = (ulong)uVar1;
      LAB_001079a4:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   ...
   void MethodBindTRC<Timer::TimerProcessCallback>::ptrcall(MethodBindTRC<Timer::TimerProcessCallback> *this, Object *param_1, void **param_2, void *param_3) {
      uint uVar1;
      long *plVar3;
      long in_FS_OFFSET;
      long local_58;
      ...
      *(ulong*)param_3 = (ulong)uVar1;
      LAB_00107b63:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   ...
   const */
   void MethodBindT<Timer::TimerProcessCallback>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
      ...
      LAB_00107ea1:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }
   ...
   void MethodBindT<Timer::TimerProcessCallback>::ptrcall(Object *param_1, void **param_2, void *param_3) {
      ...
      LAB_00108081:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }
   ...
   Object *MethodBindTR<bool>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
      ...
      *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
      ...
      LAB_00108150:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return param_1;
      }
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   ...
   void MethodBindTR<bool>::validated_call(MethodBindTR<bool> *this, Object *param_1, Variant **param_2, Variant *param_3) {
      ...
      param_3[8] = VVar1;
      LAB_001083b2:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   ...
   Object *MethodBindT<>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
      ...
      LAB_001087e0:*(undefined4*)param_1 = 0;
      *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
      if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return param_1;
      }
   ...
   void MethodBindT<>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
      ...
      LAB_00108bb8:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }
   ...
   void MethodBindT<>::ptrcall(Object *param_1, void **param_2, void *param_3) {
      ...
      LAB_00108d6f:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }
   ...
   Object *MethodBindTRC<bool>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
      ...
      *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
      ...
      LAB_00108e40:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return param_1;
      }
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   ...
   void MethodBindTRC<bool>::validated_call(MethodBindTRC<bool> *this, Object *param_1, Variant **param_2, Variant *param_3) {
      ...
      VVar1 = ( Variant )(*pcVar2)(param_1 + *(long*)( this + 0x60 ));
      param_3[8] = VVar1;
      LAB_001090a2:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   ...
   void MethodBindTRC<bool>::ptrcall(MethodBindTRC<bool> *this, Object *param_1, void **param_2, void *param_3) {
      ...
      uVar1 = ( *pcVar2 )(param_1 + *(long*)( this + 0x60 ));
      *(undefined1*)param_3 = uVar1;
      LAB_00109251:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   ...
   void MethodBindT<bool>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
      ...
      LAB_00109591:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }
   ...
   void MethodBindT<bool>::ptrcall(Object *param_1, void **param_2, void *param_3) {
      ...
      LAB_00109779:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }
   ...
   Object *MethodBindTRC<double>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
      ...
      *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
      ...
      LAB_00109840:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return param_1;
      }
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   ...
   void MethodBindTRC<double>::validated_call(MethodBindTRC<double> *this, Object *param_1, Variant **param_2, Variant *param_3) {
      ...
      *(undefined8*)( param_3 + 8 ) = uVar3;
      LAB_00109aa4:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   ...
   void MethodBindTRC<double>::ptrcall(MethodBindTRC<double> *this, Object *param_1, void **param_2, void *param_3) {
      ...
      *(undefined8*)param_3 = uVar3;
      LAB_00109c53:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   ...
   void MethodBindT<double>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
      ...
      LAB_00109f91:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }
   ...
   void MethodBindT<double>::ptrcall(Object *param_1, void **param_2, void *param_3) {
      ...
      LAB_0010a171:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }
   ...
   void call_with_variant_args_dv<__UnexistingClass,Timer::TimerProcessCallback>(__UnexistingClass *param_1, _func_void_TimerProcessCallback *param_2, Variant **param_3, int param_4, CallError *param_5, Vector *param_6) {
      long lVar1;
      long lVar2;
      code *pcVar3;
      undefined8 uVar4;
      ...
      if (lVar1 == 0) {
         ...
         if ((int)lVar2 < (int)( uVar8 ^ 1 )) {
            LAB_0010a2d0:uVar6 = 4;
            LAB_0010a26d:*(undefined4*)param_6 = uVar6;
      ...
      LAB_0010a1eb:*(undefined4*)param_6 = 0;
      if (( (ulong)param_2 & 1 ) != 0) {
         param_2 = *(_func_void_TimerProcessCallback**)( param_2 + *(long*)( param_1 + (long)param_3 ) + -1 );
      }
   ...
   Callable::CallError&) const */
   Object *MethodBindT<Timer::TimerProcessCallback>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
      long lVar1;
      char *pcVar2;
      long *plVar3;
      undefined4 in_register_00000014;
      ...
      call_with_variant_args_dv<__UnexistingClass,Timer::TimerProcessCallback>(p_Var4, (_func_void_TimerProcessCallback*)param_2[0xb], (Variant**)param_2[0xc], (int)param_4, in_R8, in_R9);
      *(undefined4*)param_1 = 0;
      *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
      LAB_0010a336:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return param_1;
      }
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   ...
   void call_with_variant_args_dv<__UnexistingClass,bool>(__UnexistingClass *param_1, _func_void_bool *param_2, Variant **param_3, int param_4, CallError *param_5, Vector *param_6) {
      ...
      if (lVar1 == 0) {
         ...
         lVar2 = *(long*)( lVar1 + -8 );
         if ((int)lVar2 < (int)( uVar8 ^ 1 )) {
            LAB_0010a6a0:uVar6 = 4;
            LAB_0010a63d:*(undefined4*)param_6 = uVar6;
            *(undefined4*)( param_6 + 8 ) = 1;
            return;
         }
         if (uVar8 != 1) {
      ...
      this * (Variant**)CONCAT44(in_register_0000000c, param_4);
      LAB_0010a5bb:*(undefined4*)param_6 = 0;
      if (( (ulong)param_2 & 1 ) != 0) {
   ...
   Object *MethodBindT<bool>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
      ...
      *(undefined4*)param_1 = 0;
      *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
      LAB_0010a706:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return param_1;
      }
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   ...
   void call_with_variant_args_dv<__UnexistingClass,double>(__UnexistingClass *param_1, _func_void_double *param_2, Variant **param_3, int param_4, CallError *param_5, Vector *param_6) {
      ...
      if (lVar1 == 0) {
         ...
         lVar2 = *(long*)( lVar1 + -8 );
         if ((int)lVar2 < (int)( uVar8 ^ 1 )) {
            LAB_0010aa70:uVar6 = 4;
            LAB_0010aa0d:*(undefined4*)param_6 = uVar6;
            *(undefined4*)( param_6 + 8 ) = 1;
            return;
         }
         if (uVar8 != 1) {
      ...
      this * (Variant**)CONCAT44(in_register_0000000c, param_4);
      LAB_0010a98b:*(undefined4*)param_6 = 0;
      if (( (ulong)param_2 & 1 ) != 0) {
   ...
   Object *MethodBindT<double>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
      ...
      call_with_variant_args_dv<__UnexistingClass,double>(p_Var4, (_func_void_double*)param_2[0xb], (Variant**)param_2[0xc], (int)param_4, in_R8, in_R9);
      *(undefined4*)param_1 = 0;
      *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
      LAB_0010aad6:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return param_1;
      }
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   ...
   void MethodBindTRC<Timer::TimerProcessCallback>::~MethodBindTRC(MethodBindTRC<Timer::TimerProcessCallback> *this) {
      /* WARNING: Bad instruction - Truncating control flow here */
      halt_baddata();
   }
   /* WARNING: Control flow encountered bad instruction data */
   /* MethodBindT<Timer::TimerProcessCallback>::~MethodBindT() */
   void MethodBindT<Timer::TimerProcessCallback>::~MethodBindT(MethodBindT<Timer::TimerProcessCallback> *this) {
      /* WARNING: Bad instruction - Truncating control flow here */
      halt_baddata();
   }
   /* WARNING: Control flow encountered bad instruction data */

void CRYPTO_ccm128_init(byte *param_1, int param_2, char param_3, undefined8 param_4, undefined8 param_5) {
   ...
   *(undefined8*)( param_1 + 0x30 ) = param_4;
   for (int i_1204 = 0; i_1204 < 8; i_1204++) {
      param_1[( i_1204 + 1 )] = 0;
   }
   for (int i_1203 = 0; i_1203 < 8; i_1203++) {
      param_1[( i_1203 + 8 )] = 0;
   }
   for (int i_1202 = 0; i_1202 < 8; i_1202++) {
      param_1[( i_1202 + 32 )] = 0;
   }
   *param_1 = ( byte )(( param_2 - 2U >> 1 & 7 ) << 3) | param_3 - 1U & 7;
   ...
   if (( bVar1 & 7 ) < 3) {
      for (int i_1205 = 0; i_1205 < 8; i_1205++) {
         param_1[( i_1205 + 8 )] = 0;
      }
   } else {
   ...
   *(ulong*)( param_1 + 0x20 ) = uVar11;
   ...
   if (( bVar10 & 4 ) == 0) {
      ...
      for (int i_1206 = 0; i_1206 < 4; i_1206++) {
         pbVar21[i_1206] = 0;
      }
      pbVar21 = pbVar21 + ( (ulong)bVar10 - 4 );
      for (int i_1207 = 0; i_1207 < 4; i_1207++) {
         pbVar21[i_1207] = 0;
      }
   }
} else {
   for (int i_1208 = 0; i_1208 < 8; i_1208++) {
      pbVar21[i_1208] = 0;
   }
   pbVar1 = pbVar21 + ( (ulong)bVar10 - 8 );
   for (int i_1209 = 0; i_1209 < 8; i_1209++) {
      pbVar1[i_1209] = 0;
   }
   ...
   *param_1 = bVar3 & 7;
   ...
   if (bVar19 < 8) {
      if (( bVar19 & 4 ) == 0) {
         ...
         for (int i_1210 = 0; i_1210 < 4; i_1210++) {
            pbVar21[i_1210] = 0;
         }
         pbVar21 = pbVar21 + ( (ulong)bVar19 - 4 );
         for (int i_1211 = 0; i_1211 < 4; i_1211++) {
            pbVar21[i_1211] = 0;
         }
      }
   } else {
      for (int i_1212 = 0; i_1212 < 8; i_1212++) {
         pbVar21[i_1212] = 0;
      }
      pbVar1 = pbVar21 + ( (ulong)bVar19 - 8 );
      for (int i_1213 = 0; i_1213 < 8; i_1213++) {
         pbVar1[i_1213] = 0;
      }
   ...
   *pbVar11 = *pbVar11 ^ ( byte ) * param_2;
   ...
   if (( bVar3 & 4 ) == 0) {
      ...
      for (int i_1214 = 0; i_1214 < 4; i_1214++) {
         pbVar11[i_1214] = 0;
      }
      pbVar11 = pbVar11 + ( (ulong)bVar3 - 4 );
      for (int i_1215 = 0; i_1215 < 4; i_1215++) {
         pbVar11[i_1215] = 0;
      }
   }
} else {
   for (int i_1216 = 0; i_1216 < 8; i_1216++) {
      pbVar11[i_1216] = 0;
   }
   pbVar1 = pbVar11 + ( (ulong)bVar3 - 8 );
   for (int i_1217 = 0; i_1217 < 8; i_1217++) {
      pbVar1[i_1217] = 0;
   }
   ...
   *(byte*)( (long)param_1 + 0xf ) = 1;
   ...
   if (local_78 < 8) {
      if (( local_78 & 4 ) == 0) {
         ...
         for (int i_1218 = 0; i_1218 < 4; i_1218++) {
            pbVar22[i_1218] = 0;
         }
         pbVar22 = pbVar22 + ( (ulong)local_78 - 4 );
         for (int i_1219 = 0; i_1219 < 4; i_1219++) {
            pbVar22[i_1219] = 0;
         }
      }
   } else {
      for (int i_1220 = 0; i_1220 < 8; i_1220++) {
         pbVar22[i_1220] = 0;
      }
      pbVar1 = pbVar22 + ( (ulong)local_78 - 8 );
      for (int i_1221 = 0; i_1221 < 8; i_1221++) {
         pbVar1[i_1221] = 0;
      }

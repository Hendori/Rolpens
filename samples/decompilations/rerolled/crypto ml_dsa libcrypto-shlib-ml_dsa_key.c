...
bool keygen_internal_constprop_0(long param_1) {
   ...
   if (( ( ctx == (EVP_MD_CTX*)0x0 ) || ( iVar3 = ossl_ml_dsa_key_pub_alloc(param_1) ),iVar3 == 0 )) {
      ...
      if (( ( iVar3 != 1 ) || ( iVar3 = EVP_DigestUpdate(ctx, &local_f8, 0x22) ),iVar3 != 1 )) goto LAB_0010065c;
      ...
      *(undefined8*)( param_1 + 0x98 ) = uStack_50;
      ...
      iVar3 = EVP_DigestInit_ex2(ctx, *(undefined8*)( param_1 + 0x18 ), 0);
      if (( ( iVar3 != 1 ) || ( iVar3 = EVP_DigestUpdate(ctx, d, cnt) ),iVar3 != 1 )) goto LAB_0010065c;
...
bool ossl_ml_dsa_key_public_from_private(long param_1) {
   ...
   local_50 = lVar1;
   ctx = (EVP_MD_CTX*)EVP_MD_CTX_new();
   if (( ( ( ctx == (EVP_MD_CTX*)0x0 ) || ( iVar2 = ossl_ml_dsa_key_pub_alloc(param_1) ),iVar2 == 0 ) ) || ( iVar2 = public_from_private(param_1, ctx, param_1 + 0xc0, &local_58) ),iVar2 == 0) {

/* basisu::basis_compressor::encode_slices_to_uastc_hdr()::uastc_blk_desc::TEMPNAMEPLACEHOLDERVALUE(uastc_blk_desc
   const&) const */undefined4 uastc_blk_desc::operator <(uastc_blk_desc *this, uastc_blk_desc *param_1) {
   undefined4 uVar1;
   if (this == param_1) {
      return 0;
   }
   ...
   if (( *(uint*)param_1 <= *(uint*)this ) && ( uVar1 = 0 * (uint*)this == *(uint*)param_1 )) {
      uVar1 = 1;
      if (( *(uint*)( param_1 + 4 ) <= *(uint*)( this + 4 ) ) && ( uVar1 = 0 * (uint*)( this + 4 ) == *(uint*)( param_1 + 4 ) )) {
         uVar1 = 1;
         if (( *(uint*)( param_1 + 8 ) <= *(uint*)( this + 8 ) ) && ( uVar1 = 0 * (uint*)( this + 8 ) == *(uint*)( param_1 + 8 ) )) {
            uVar1 = 1;
            if (( *(uint*)( param_1 + 0xc ) <= *(uint*)( this + 0xc ) ) && ( uVar1 = 0 * (uint*)( this + 0xc ) == *(uint*)( param_1 + 0xc ) )) {
               return CONCAT31(( int3 )(*(uint*)( param_1 + 0x10 ) >> 8), *(uint*)( this + 0x10 ) < *(uint*)( param_1 + 0x10 ));
            }
...
/* buminiz::def_free_func(void*, void*) */void buminiz::def_free_func(void *param_1, void *param_2) {
   free(param_2);
   return;
}
/* buminiz::def_alloc_func(void*, unsigned long, unsigned long) */void buminiz::def_alloc_func(void *param_1, ulong param_2, ulong param_3) {
   malloc(param_2 * param_3);
   return;
}
/* buminiz::tdefl_flush_output_buffer(buminiz::tdefl_compressor*) */bool buminiz::tdefl_flush_output_buffer(tdefl_compressor *param_1) {
   long lVar1;
   ulong __n;
   bool bVar2;
   ...
   if (*(long**)( param_1 + 0xa0 ) != (long*)0x0) {
      ...
      memcpy((void*)( *(long*)( param_1 + 0xc0 ) + *(long*)( param_1 + 0x90 ) ), param_1 + ( ulong ) * (uint*)( param_1 + 0x70 ) + 0x392aa, __n);
      lVar1 = *(long*)( param_1 + 0xc0 );
      *(ulong*)( param_1 + 0xc0 ) = __n + lVar1;
      *(ulong*)( param_1 + 0x70 ) = CONCAT44((int)( ( ulong ) * (undefined8*)( param_1 + 0x70 ) >> 0x20 ) - (int)__n, (int)*(undefined8*)( param_1 + 0x70 ) + (int)__n);
...
/* buminiz::tdefl_output_buffer_putter(void const*, int, void*) */undefined8 buminiz::tdefl_output_buffer_putter(void *param_1, int param_2, void *param_3) {
   ulong uVar1;
   void *pvVar2;
   long lVar3;
   ulong __size;
   ...
   if (uVar1 <= __size) {
      ...
      LAB_001001c1:memcpy((void*)( (long)pvVar2 + lVar3 ), param_1, (long)param_2);
      *(ulong*)param_3 = uVar1;
      return 1;
   }
...
/* buminiz::tdefl_optimize_huffman_table(buminiz::tdefl_compressor*, int, int, int, int) */void buminiz::tdefl_optimize_huffman_table(tdefl_compressor *param_1, int param_2, int param_3, int param_4, int param_5) {
   ushort *puVar1;
   tdefl_compressor *ptVar2;
   uint uVar3;
   int iVar4;
   tdefl_compressor *ptVar5;
   uint *puVar6;
   int *piVar7;
   byte bVar8;
   ushort uVar9;
   ...
   *piVar17 = 0;
   if (param_5 != 0) {
      ptVar5 = param_1 + (long)puVar29 * 0x120;
      ptVar18 = ptVar5 + lVar25;
      do {
         ptVar2 = ptVar5 + 0x8f4a;
         ptVar5 = ptVar5 + 1;
         local_15d8[( byte ) * ptVar2] = local_15d8[( byte ) * ptVar2] + 1;
      }
 while ( ptVar18 != ptVar5 );
      uVar14 = param_4 + 1;
      goto LAB_00100290;
   }
   ...
   lVar11 = 0;
   do {
      if (*(ushort*)( param_1 + lVar11 * 2 + (long)puVar29 * 0x240 + 0x81ca ) != 0) {
         lVar19 = (long)iVar24;
         iVar24 = iVar24 + 1;
         local_1148[lVar19] = ( uint ) * (ushort*)( param_1 + lVar11 * 2 + (long)puVar29 * 0x240 + 0x81ca ) | (int)lVar11 << 0x10;
      }

      lVar11 = lVar11 + 1;
   }
 while ( lVar11 != lVar25 );
   local_15e0 = local_848;
   puVar6 = local_15e0;
   ...
   if (iVar24 == 0) {
      uVar12 = 0xffffffff;
      LAB_00100418:iVar4 = 1;
   }
 else {
      uVar12 = ( ulong )(iVar24 - 1);
      puVar6 = local_1148;
      do {
         uVar14 = *puVar6;
         puVar6 = puVar6 + 1;
 ...
 while ( local_1148 + uVar12 + 1 != puVar6 );
      if (iVar24 == local_448[0]) goto LAB_00100418;
      iVar4 = 2;
   }
   ...
   do {
      ...
      iVar15 = 0;
      do {
         *(int*)( (long)local_1548 + lVar11 ) = iVar15;
         iVar15 = iVar15 + *(int*)( (long)puVar6 + lVar11 );
         lVar11 = lVar11 + 4;
      }
 while ( lVar11 != 0x400 );
      puVar20 = puVar28;
      if (iVar24 != 0) {
         do {
            puVar21 = puVar20 + 1;
            uVar3 = (int)( uint )(ushort) * puVar20 >> ( (byte)iVar10 & 0x1f ) & 0xff;
            uVar14 = local_1548[uVar3];
            local_1548[uVar3] = uVar14 + 1;
            puVar23[uVar14] = *puVar20;
            puVar20 = puVar21;
         }
 while ( puVar28 + uVar12 + 1 != puVar21 );
      }
 ...
 while ( iVar10 != ( uint )(iVar4 != 1) * 8 + 8 );
   uVar13 = ( ulong )(param_4 + 1);
   if (iVar24 != 0) {
      if (iVar24 != 1) {
         uVar16 = (ushort)puVar23[1] + ( ushort ) * puVar23;
         *(ushort*)puVar23 = uVar16;
         if (1 < (int)uVar12) {
            iVar4 = 0;
            lVar11 = 1;
            iVar10 = 2;
            do {
               if (( iVar10 < iVar24 ) && ( uVar9 = uVar9 <= uVar16 )) {
                  iVar10 = iVar10 + 1;
                  *(ushort*)( puVar23 + lVar11 ) = uVar9;
                  if (iVar24 <= iVar10) goto LAB_0010056c;
                  LAB_001005b7:lVar19 = (long)iVar10;
                  if (iVar4 < (int)lVar11) {
                     puVar6 = puVar23 + iVar4;
                     uVar16 = ( ushort ) * puVar6;
                     if ((ushort)puVar23[lVar19] <= uVar16) goto LAB_001005d5;
                     goto LAB_00100578;
                  }

                  LAB_001005d5:iVar10 = iVar10 + 1;
                  *(ushort*)( puVar23 + lVar11 ) = uVar9 + (ushort)puVar23[lVar19];
               }
 else {
                  *(ushort*)( puVar23 + lVar11 ) = uVar16;
                  iVar15 = iVar4 + 1;
                  *(ushort*)( puVar23 + iVar4 ) = (ushort)lVar11;
                  uVar9 = (ushort)puVar23[lVar11];
                  iVar4 = iVar15;
                  if (iVar10 < iVar24) goto LAB_001005b7;
                  LAB_0010056c:puVar6 = puVar23 + iVar4;
                  uVar16 = ( ushort ) * puVar6;
                  LAB_00100578:*(ushort*)( puVar23 + lVar11 ) = uVar16 + uVar9;
                  iVar4 = iVar4 + 1;
                  *(ushort*)puVar6 = (ushort)lVar11;
               }

               if (uVar12 == lVar11 + 1U) goto LAB_001005eb;
               lVar11 = lVar11 + 1;
               uVar16 = (ushort)puVar23[iVar4];
            }
 while ( true );
         }

         *(ushort*)( puVar23 + (long)iVar24 + -2 ) = 0;
         LAB_00100622:uVar3 = 0;
         iVar4 = 1;
         uVar14 = iVar24 - 2U;
         do {
            iVar10 = 0;
            iVar15 = 0;
            if ((int)uVar14 < 0) {
               LAB_0010068d:iVar27 = (int)uVar12;
               puVar6 = puVar23 + iVar27;
               uVar16 = (ushort)uVar3;
               if (( (int)puVar6 - (int)( puVar23 + ( ( (long)iVar27 + -1 ) - ( ulong )(uint)(( iVar4 + -1 ) - iVar15) ) ) & 4U ) == 0) goto LAB_001006c8;
               *(ushort*)puVar6 = uVar16;
               for (puVar6 = puVar6 + -1; puVar23 + ( ( (long)iVar27 + -1 ) - ( ulong )(uint)(( iVar4 + -1 ) - iVar15) ) != puVar6; puVar6 = puVar6 + -2) {
                  LAB_001006c8:*(ushort*)puVar6 = uVar16;
                  *(ushort*)( puVar6 + -1 ) = uVar16;
               }

               uVar12 = ( ulong )(uint)(iVar27 + ( iVar15 - iVar4 ));
               if (iVar15 == 0) goto LAB_001007f2;
            }
 else {
               puVar6 = puVar23 + (int)uVar14;
               iVar15 = 0;
               do {
                  if (( ushort ) * puVar6 != uVar3) break;
                  uVar14 = uVar14 - 1;
                  iVar15 = iVar15 + 1;
                  puVar6 = puVar6 + -1;
               }
 while ( uVar14 != 0xffffffff );
               iVar10 = iVar15 * 2;
               if (iVar15 < iVar4) goto LAB_0010068d;
            }
 ...
 while ( true );
   ...
   goto LAB_00100704;
   LAB_001005eb:*(ushort*)( puVar23 + (long)iVar24 + -2 ) = 0;
   lVar11 = (long)( iVar24 + -3 );
   do {
      *(ushort*)( puVar23 + lVar11 ) = (ushort)puVar23[(ushort)puVar23[lVar11]] + 1;
      lVar11 = lVar11 + -1;
   }
 while ( -1 < (int)lVar11 );
   goto LAB_00100622;
   LAB_001007f2:uVar13 = ( ulong )(param_4 + 1);
   local_15e0 = puVar29;
   if (0 < iVar24) {
      local_15d8[( ushort ) * puVar23] = 1;
      puVar6 = puVar23 + 1;
      do {
         uVar14 = *puVar6;
         puVar6 = puVar6 + 1;
         local_15d8[(ushort)uVar14] = local_15d8[(ushort)uVar14] + 1;
      }
 while ( puVar23 + ( ulong )(iVar24 - 2U) + 2 != puVar6 );
      uVar13 = ( ulong )(param_4 + 1U);
      lVar11 = (long)(int)( param_4 + 1U );
      piVar17 = local_15d8 + param_4;
      iVar4 = *piVar17;
      do {
         iVar4 = iVar4 + local_15d8[lVar11];
         lVar11 = lVar11 + 1;
         *piVar17 = iVar4;
      }
 while ( (int)lVar11 != 0x21 );
      iVar10 = 0;
      uVar12 = 0;
      piVar7 = piVar17;
      do {
         ...
         bVar8 = (byte)iVar10;
         iVar10 = iVar10 + 1;
         uVar12 = ( ulong )(uint)((int)uVar12 + ( iVar15 << ( bVar8 & 0x1f ) ));
      }
 while ( param_4 != iVar10 );
      uVar26 = 1L << ( (byte)param_4 & 0x3f );
      if (uVar26 != uVar12) {
         do {
            *piVar17 = iVar4 + -1;
            piVar7 = (int*)( (long)&local_15e0 + (long)param_4 * 4 + 4 );
            lVar11 = (long)( param_4 + -1 );
            do {
               if (*piVar7 != 0) {
                  *piVar7 = *piVar7 + -1;
                  local_15d8[lVar11 + 1] = local_15d8[lVar11 + 1] + 2;
                  break;
               }
 ...
 while ( true );
   ...
   LAB_00100704:uVar14 = (uint)uVar13;
   uVar26 = 1;
   ptVar18 = param_1 + (long)puVar29 * 0x120 + 0x8f4a;
   *(undefined8*)ptVar18 = 0;
   *(undefined8*)( ptVar18 + 0x118 ) = 0;
   puVar22 = (undefined8*)( ( ulong )(ptVar18 + 8) & 0xfffffffffffffff8 );
   for (uVar12 = ( ulong )(( (int)ptVar18 - (int)(undefined8*)( ( ulong )(ptVar18 + 8) & 0xfffffffffffffff8 ) ) + 0x120U >> 3); uVar12 != 0; uVar12 = uVar12 - 1) {
      *puVar22 = 0;
      puVar22 = puVar22 + 1;
   }

   ptVar18 = param_1 + (long)puVar29 * 0x240 + 0x888a;
   *(undefined8*)ptVar18 = 0;
   *(undefined8*)( ptVar18 + 0x238 ) = 0;
   puVar22 = (undefined8*)( ( ulong )(ptVar18 + 8) & 0xfffffffffffffff8 );
   for (uVar12 = ( ulong )(( (int)ptVar18 - (int)(undefined8*)( ( ulong )(ptVar18 + 8) & 0xfffffffffffffff8 ) ) + 0x240U >> 3); uVar12 != 0; uVar12 = uVar12 - 1) {
      *puVar22 = 0;
      puVar22 = puVar22 + 1;
   }

   do {
      iVar4 = local_15d8[uVar26];
      if (0 < iVar4) {
         puVar6 = puVar23 + iVar24;
         do {
            puVar1 = (ushort*)( (long)puVar6 + -2 );
            puVar6 = puVar6 + -1;
            param_1[( ulong ) * puVar1 + 0x8f4a + (long)puVar29 * 0x120] = SUB81(uVar26, 0);
         }
 while ( puVar23 + ( ( (long)iVar24 + -1 ) - ( ulong )(iVar4 - 1) ) != puVar6 );
         iVar24 = iVar24 - iVar4;
      }
 ...
 while ( uVar13 != uVar26 );
   LAB_00100290:local_848[1] = 0;
   uVar12 = 2;
   uVar3 = 0;
   do {
      uVar3 = ( uVar3 + *(int*)( (long)&local_15e0 + uVar12 * 4 + 4 ) ) * 2;
      local_848[uVar12] = uVar3;
      uVar12 = uVar12 + 1;
   }
 while ( uVar12 != uVar14 );
   ptVar18 = param_1 + (long)puVar29 * 0x120;
   ptVar5 = ptVar18 + lVar25;
   do {
      while (uVar12 = (ulong)(byte)ptVar18[0x8f4a],ptVar18[0x8f4a] != (tdefl_compressor)0x0) {
         uVar14 = local_848[uVar12];
         local_848[uVar12] = uVar14 + 1;
         uVar3 = 0;
         uVar13 = (ulong)uVar14;
         do {
            uVar3 = uVar3 * 2 | (uint)uVar13 & 1;
            uVar14 = (int)uVar12 - 1;
            uVar12 = (ulong)uVar14;
            uVar13 = uVar13 >> 1;
         }
 while ( uVar14 != 0 );
         *(short*)( ( 0x888a - (long)param_1 ) + (long)ptVar18 * 2 ) = (short)uVar3;
         ptVar18 = ptVar18 + 1;
         if (ptVar18 == ptVar5) goto LAB_00100332;
      }
;
      ptVar18 = ptVar18 + 1;
   }
 while ( ptVar18 != ptVar5 );
   LAB_00100332:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* buminiz::tdefl_start_dynamic_block(buminiz::tdefl_compressor*) */void buminiz::tdefl_start_dynamic_block(tdefl_compressor *param_1) {
   ...
   *(undefined2*)( param_1 + 0x83ca ) = 1;
   uStack_2c0 = (undefined*)0x100973;
   tdefl_optimize_huffman_table(param_1, 0, 0x120, 0xf, 0);
   uStack_2c0 = (undefined*)0x10098d;
 ...
 while ( param_1[lVar3 + 0x8f49] == (tdefl_compressor)0x0 );
   ...
   uVar4 = (ulong)iVar2;
   iVar21 = iVar2 + -0x101;
   LAB_001009c1:ptVar10 = param_1 + 36999;
   uVar9 = 0x1e;
   do {
      uVar13 = uVar9 - 1;
      uVar15 = uVar9;
      if (*ptVar10 != (tdefl_compressor)0x0) goto LAB_001009f0;
      ptVar10 = ptVar10 + -1;
      uVar9 = uVar13;
   }
 while ( uVar13 != 1 );
   uVar13 = 0;
   uVar15 = 1;
   LAB_001009f0:ptVar10 = param_1 + 0x8f4a;
   ptVar17 = local_2b8;
   ...
   if (uVar15 < 8) {
      if (( uVar15 & 4 ) == 0) {
         if (( uVar15 != 0 ) && ( *ptVar10 = param_1[0x906a](uVar15 & 2) != 0 )) {
            *(undefined2*)( (long)&uStack_2c0 + uVar11 + uVar4 + 6 ) = *(undefined2*)( param_1 + uVar11 + 0x9068 );
         }

      }
 else {
         *(undefined4*)ptVar10 = *(undefined4*)( param_1 + 0x906a );
         *(undefined4*)( (long)&uStack_2c0 + uVar11 + uVar4 + 4 ) = *(undefined4*)( param_1 + uVar11 + 0x9066 );
      }

   }
 else {
      *(undefined8*)ptVar10 = *(undefined8*)( param_1 + 0x906a );
      *(undefined8*)( (long)&uStack_2c0 + uVar15 + uVar4 ) = *(undefined8*)( param_1 + (ulong)uVar15 + 0x9062 );
      ...
      if (7 < uVar15) {
         ...
         do {
            uVar11 = (ulong)uVar16;
            uVar16 = uVar16 + 8;
            *(undefined8*)( ( ( ulong )(auStack_2b0 + uVar4) & 0xfffffffffffffff8 ) + uVar11 ) = *(undefined8*)( param_1 + uVar11 + ( 0x906a - lVar12 ) );
         }
 while ( uVar16 < uVar15 );
      }
   ...
   *(undefined1(*) [16])( param_1 + 0x864a ) = (undefined1[16])0x0;
   ...
   do {
      while (true) {
         ...
         if (uVar8 != 0) {
            if (uVar8 < 3) {
               *(short*)( param_1 + (ulong)(byte)tVar1 * 2 + 0x864a ) = *(short*)( param_1 + (ulong)(byte)tVar1 * 2 + 0x864a ) + (short)uVar8;
               uVar14 = uVar15 + 1;
         ...
         LAB_00100b06:ptVar18 = ptVar18 + 1;
         tVar1 = tVar7;
         if (local_2b8 + ( ulong )(( uVar9 - 1 ) + iVar2) + 1 == ptVar18) goto LAB_00100bbe;
      }
;
      uVar14 = uVar15;
      if (uVar16 != 0) {
      ...
      uVar15 = (int)uVar4 + 1;
      *(short*)( param_1 + (ulong)(byte)tVar7 * 2 + 0x864a ) = *(short*)( param_1 + (ulong)(byte)tVar7 * 2 + 0x864a ) + 1;
      uVar16 = 0;
      uVar8 = 0;
      tVar1 = tVar7;
   }
 while ( local_2b8 + ( ulong )(( uVar9 - 1 ) + iVar2) + 1 != ptVar18 );
   LAB_00100bbe:if (uVar8 == 0) {
      if (uVar16 != 0) {
         if (uVar16 < 3) {
            *(short*)( param_1 + 0x864a ) = *(short*)( param_1 + 0x864a ) + (short)uVar16;
            local_178[uVar15] = (tdefl_compressor)0x0;
      ...
      *(short*)( param_1 + (ulong)(byte)tVar7 * 2 + 0x864a ) = *(short*)( param_1 + (ulong)(byte)tVar7 * 2 + 0x864a ) + (short)uVar8;
   ...
   if (uVar8 < 8) {
      ...
      *(uint*)( param_1 + 0x60 ) = uVar16;
      while (true) {
         ...
         *(uint*)( param_1 + 0x5c ) = uVar8;
         if (uVar8 < 8) break;
         LAB_00100cc0:puVar5 = *(undefined1**)( param_1 + 0x40 );
      }
;
   }
 else {
...
;
      ...
      *(uint*)( param_1 + 0x5c ) = uVar8;
      *(uint*)( param_1 + 0x60 ) = uVar16;
      if (7 < uVar8) goto LAB_00100cc0;
   }

   lVar12 = 0x12;
   do {
      if (param_1[( ulong )(byte)(&tinfl_decompress(buminiz::tinfl_decompressor_tag * unsigned_char_const * unsigned_long * unsigned_char * unsigned_char * unsigned_long * unsigned_int), ::s_length_dezigzag)[lVar12] + 0x918a] != (tdefl_compressor)0x0) {
         iVar2 = (int)lVar12;
         if (iVar2 < 3) {
            iVar2 = 3;
         }
...
;
      if (&tinfl_decompress(buminiz::tinfl_decompressor_tag * unsigned_char_const * unsigned_long * unsigned_char * unsigned_char * unsigned_long * unsigned_int) + iVar2 == pbVar19) break;
      uVar16 = *(uint*)( param_1 + 0x60 );
...
;
   ...
   while (ptVar18 = local_178 + uVar4,(uint)uVar4 < uVar15) {
      while (true) {
         ...
         uVar9 = ( uint ) * (ushort*)( param_1 + (ulong)(byte)tVar1 * 2 + 0x8d0a ) << ( ( byte ) * (int*)( param_1 + 0x5c ) & 0x1f ) | *(uint*)( param_1 + 0x60 );
...
;
         ...
         if (uVar15 <= uVar16) goto LAB_00100fbc;
      }
;
...
;
   LAB_00100fbc:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      uStack_2c0 = &UNK_00101154;
      __stack_chk_fail();
   }

   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* buminiz::tdefl_compress_block(buminiz::tdefl_compressor*, int) */bool buminiz::tdefl_compress_block(tdefl_compressor *param_1, int param_2) {
   ...
   if (param_2 == 0) {
      ...
      *(undefined8*)( param_1 + 0x8f52 ) = uVar6;
      for (int i = 0; i < 8; i++) {
         *(undefined8*)( param_1 + ( 16*i + 36698 ) ) = uVar5;
         *(undefined8*)( param_1 + ( 16*i + 36706 ) ) = uVar6;
      }
      ...
      *(undefined8*)( param_1 + 0x905a ) = 0x707070707070707;
      for (int i = 0; i < 7; i++) {
         *(undefined8*)( param_1 + ( 16*i + 36826 ) ) = uVar5;
         *(undefined8*)( param_1 + ( 16*i + 36834 ) ) = uVar6;
      }
      ...
      do {
         ...
         if (( uVar7 & 1 ) == 0) {
            ...
            if (( ( uVar7 & 2 ) == 0 ) && ( ptVar1 < ptVar4 )) {
               ptVar1 = ptVar22 + 2;
               uVar16 = uVar16 | ( ulong ) * (ushort*)( param_1 + (ulong)(byte)ptVar22[1] * 2 + 0x888a ) << ( (byte)uVar15 & 0x3f );
               uVar15 = uVar15 + (byte)param_1[(ulong)(byte)ptVar22[1] + 0x8f4a];
               uVar13 = uVar7 >> 2;
               uVar21 = uVar7 & 4;
               uVar7 = uVar20;
               if (( uVar21 == 0 ) && ( ptVar1 < ptVar4 )) {
                  uVar16 = uVar16 | ( ulong ) * (ushort*)( param_1 + (ulong)(byte)ptVar22[2] * 2 + 0x888a ) << ( (byte)uVar15 & 0x3f );
            ...
            iVar10 = (int)uVar14 + (uint)(byte)param_1[( ulong ) * (ushort*)( s_tdefl_len_sym + uVar8 * 2 ) + 0x8f4a];
            ...
            uVar16 = ( ulong )((uint)uVar3 & *(uint*)( mz_bitmasks + (ulong)(uint)bVar17 * 4 )) << ( (byte)iVar12 & 0x3f ) | ( ulong ) * (ushort*)( param_1 + (ulong)bVar9 * 2 + 0x8aca ) << ( (byte)iVar11 & 0x3f ) | ( ulong )(( uint )(byte) * ptVar22 & *(uint*)( mz_bitmasks + (ulong)(byte)s_tdefl_len_extra[uVar8] * 4 )) << ( (byte)iVar10 & 0x3f ) | ( ulong ) * (ushort*)( param_1 + ( ulong ) * (ushort*)( s_tdefl_len_sym + uVar8 * 2 ) * 2 + 0x888a ) << ( (byte)uVar14 & 0x3f ) | uVar16;
...
/* buminiz::tdefl_flush_block(buminiz::tdefl_compressor*, int) */int buminiz::tdefl_flush_block(tdefl_compressor *param_1, int param_2) {
   long lVar1;
   code *pcVar2;
   uint uVar3;
   int iVar4;
   ...
   if (( (byte)param_1[0x12] & 8 ) != 0) {
      bVar14 = ( uint )(*(int*)( param_1 + 0x24 ) - *(int*)( param_1 + 0x58 )) <= *(uint*)( param_1 + 0x2c );
   }

   if (( *(long*)param_1 == 0 ) && ( 0x14ccb < ( ulong )(**(long**)( param_1 + 0xa0 ) - *(long*)( param_1 + 0xc0 )) )) {
   ...
   **(byte**)( param_1 + 0x38 ) = ( byte )((int)( uint ) * *(byte**)( param_1 + 0x38 ) >> ( ( byte ) * (undefined4*)( param_1 + 0x50 ) & 0x1f ));
...
;
   if (bVar14) {
      if (( uint )(*(int*)( param_1 + 0x24 ) - *(int*)( param_1 + 0x58 )) <= *(uint*)( param_1 + 0x2c )) {
         LAB_001016d7:*(undefined1**)( param_1 + 0x40 ) = puVar13;
         *(uint*)( param_1 + 0x60 ) = uVar12;
         *(uint*)( param_1 + 0x5c ) = uVar3 + 2;
         if (uVar3 + 2 < 8) {
            LAB_00101b6c:*(undefined4*)( param_1 + 0x5c ) = 8;
            while (true) {
               if (puVar13 < *(undefined1**)( param_1 + 0x48 )) {
                  *(undefined1**)( param_1 + 0x40 ) = puVar13 + 1;
                  *puVar13 = (char)uVar12;
...
;
         ...
         if (uVar5 != 0xffff) {
            do {
               uVar3 = *(int*)( param_1 + 0x5c ) + 8;
               uVar12 = (uint)(byte)param_1[( ulong )(*(int*)( param_1 + 0x58 ) + uVar8 & 0x7fff) + 200] << ( ( byte ) * (int*)( param_1 + 0x5c ) & 0x1f ) | *(uint*)( param_1 + 0x60 );
               *(uint*)( param_1 + 0x60 ) = uVar12;
               *(uint*)( param_1 + 0x5c ) = uVar3;
               while (7 < uVar3) {
                  puVar13 = *(undefined1**)( param_1 + 0x40 );
...
;
 ...
 while ( uVar8 < *(uint*)( param_1 + 0x54 ) );
      ...
      if (( ( uVar8 != 0 ) && ( (long)(ulong)uVar8 <= ( *(long*)( param_1 + 0x40 ) - (long)puVar13 ) + 1 ) ) && ( ( uint )(*(int*)( param_1 + 0x24 ) - *(int*)( param_1 + 0x58 )) <= *(uint*)( param_1 + 0x2c ) )) goto LAB_001016d7;
      if (iVar4 != 0) goto joined_r0x001018ab;
   }
   ...
   *(uint*)( param_1 + 0x5c ) = uVar3;
   ...
   joined_r0x001018ab:if (param_2 != 0) {
      if (param_2 == 4) {
 ...
 while ( 7 < iVar4 - 8U );
         ...
         if (( (byte)param_1[0x11] & 0x10 ) != 0) {
            ...
            do {
               ...
               uVar3 = ( uVar8 >> 0x18 ) << ( ( byte ) * (int*)( param_1 + 0x5c ) & 0x1f ) | *(uint*)( param_1 + 0x60 );
...
;
   ...
   *(undefined8*)( param_1 + 0x8402 ) = 0;
   ...
   for (uVar6 = ( ulong )(( (int)param_1 - (int)(undefined8*)( ( ulong )(param_1 + 0x81d2) & 0xfffffffffffffff8 ) ) + 0x840aU >> 3); uVar6 != 0; uVar6 = uVar6 - 1) {
      *puVar9 = 0;
   ...
   *(undefined8*)( param_1 + 0x50 ) = 8;
   ...
   for (int i = 0; i < 3; i++) {
      *(undefined1(*) [16])( param_1 + ( 16*i + 33818 ) ) = (undefined1[16])0;
   }
   ...
   if (iVar4 != 0) {
      ...
      if (pcVar2 == (code*)0x0) {
         ...
         **(long**)( param_1 + 0x98 ) = *(long*)( param_1 + 0xb0 ) - *(long*)( param_1 + 0x88 );
         iVar4 = ( *pcVar2 )(param_1 + 0x392aa, lVar1 - (long)__src & 0xffffffff, *(undefined8*)( param_1 + 8 ));
         if (iVar4 == 0) {
...
/* std::_Function_handler<void (), basisu::basis_parallel_compress(unsigned int,
   ...
   std::_Any_data const&, std::_Manager_operation) */undefined8 std::_Function_handler<void(),basisu::basis_parallel_compress(unsigned_int,basisu::vector<basisu::basis_compressor_params>const&,basisu::vector<basisu::parallel_results>&)::{lambda()#1}>::_M_manager(long *param_1, long *param_2, int param_3) {
   undefined8 *puVar1;
   undefined8 uVar2;
   undefined8 *puVar3;
   if (param_3 != 0) {
...
/* std::_Function_handler<void (),
   ...
   std::_Any_data const&, std::_Manager_operation) */undefined8 std::_Function_handler<void(),basisu::basis_compressor::encode_slices_to_uastc()::{lambda()#1}>::_M_manager(long *param_1, long *param_2, int param_3) {
   undefined8 *puVar1;
   undefined8 uVar2;
   undefined8 *puVar3;
   if (param_3 != 0) {
   ...
   *param_1 = (long)&basisu::basis_compressor::encode_slices_to_uastc()::{lambda()
   #1
   return 0;
}
/* std::_Function_handler<void (),
   basisu::basis_compressor::encode_slices_to_uastc_hdr()::{lambda()#1}>::_M_manager(std::_Any_data&,
   std::_Any_data const&, std::_Manager_operation) */undefined8 std::_Function_handler<void(),basisu::basis_compressor::encode_slices_to_uastc_hdr()::{lambda()#1}>::_M_manager(long *param_1, long *param_2, int param_3) {
   undefined8 *puVar1;
   undefined8 uVar2;
   undefined8 *puVar3;
   if (param_3 != 0) {
   ...
   *param_1 = (long)&basisu::basis_compressor::encode_slices_to_uastc_hdr()::{lambda()
   #1
   return 0;
}
/* void std::__cxx11::string::_M_construct<char*>(char*, char*, std::forward_iterator_tag) [clone
   ...
   __dest = (undefined1*)*param_1;
   LAB_00101f24:param_1[1] = local_28;
   __dest[local_28] = 0;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* basisu::image::renormalize_normal_map() [clone .isra.0] */void basisu::image::renormalize_normal_map(image *this) {
   byte *pbVar1;
   uint uVar2;
   float fVar3;
   float fVar4;
      ...
      do {
         ...
         if (*(int*)this != 0) {
            do {
               ...
               fVar10 = _LC17;
               fVar9 = _LC16;
               pbVar1 = (byte*)( *(long*)( this + 0x10 ) + ( ulong )(*(int*)( this + 8 ) * uVar16 + uVar15) * 4 );
               if (( ( *pbVar1 != 0x80 ) || ( pbVar1[1] != 0x80 ) ) || ( pbVar1[2] != 0x80 )) {
                  ...
                  do {
                     fVar18 = *pfVar12;
                     fVar17 = _LC7;
                     if (( _LC7 <= fVar18 ) && ( fVar17 = fVar18 <= fVar3 )) {
                        fVar17 = fVar18;
                     }
 ...
 while ( pfVar12 != &local_14 );
                  ...
                  if (_LC12 <= fVar18) {
                     if (_LC12 < (float)( ( uint )(fVar18 - fVar3) & uVar2 )) {
                        ...
                        auVar19._12_4_ = _UNK_00122444;
                        auVar19._8_4_ = _LC8;
                        auVar20 = divps(auVar20, auVar19);
                        local_18 = local_18 / fVar18;
                        local_20 = auVar20._0_8_;
                        do {
                           fVar18 = ( *(float*)( (long)&local_20 + lVar13 * 4 ) + fVar3 ) * fVar9 * fVar10 + fVar10;
                           if ((float)( (uint)fVar18 & uVar2 ) < fVar11) {
                              fVar18 = (float)( ( uint )((float)(int)fVar18 - (float)( -(uint)(fVar18 < (float)(int)fVar18) & (uint)fVar3 )) | ~uVar2 & (uint)fVar18 );
                           }

                           bVar14 = 0;
                           if (( 0.0 <= fVar18 ) && ( bVar14 = fVar18 <= _LC16 )) {
...
/* void std::__cxx11::string::_M_construct<char const*>(char const*, char const*,
   ...
   memcpy(__dest, param_2, __n);
   __dest = (undefined1*)*param_1;
   LAB_00102274:param_1[1] = local_28;
   __dest[local_28] = 0;
   if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
...
/* WARNING: Removing unreachable block (ram,0x00102460) *//* WARNING: Removing unreachable block (ram,0x00102465) *//* WARNING: Removing unreachable block (ram,0x0010246b) *//* basisu::imagef::crop(unsigned int, unsigned int, unsigned int, basisu::vec<4u, float> const&)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* std::_Function_handler<void (),
   basisu::basis_compressor::encode_slices_to_uastc()::{lambda()#1}>::_M_invoke(std::_Any_data
   const&) */void std::_Function_handler<void(),basisu::basis_compressor::encode_slices_to_uastc()::{lambda()#1}>::_M_invoke(_Any_data *param_1) {
   long *plVar1;
   uint *puVar2;
   uint uVar3;
   int iVar4;
         ...
         if (( uVar13 < iVar4 + 4U ) || ( uVar11 < iVar17 + 4U )) {
            while (true) {
               ...
               while (true) {
                  ...
                  puVar8 = puVar7 + 4;
                  iVar19 = iVar19 + 1;
                  *(undefined4*)puVar7 = *(undefined4*)( lVar16 + ( ulong )(iVar12 * puVar2[2] + iVar14) * 4 );
...
;
 ...
 while ( puVar15 != local_48 );
         ...
         lVar16 = plVar1[5];
         basisu::encode_uastc(local_88, (uastc_block*)( *(long*)( lVar16 + 0x20 ) + ( ulong )(( *(int*)( lVar16 + 0xc ) * uVar20 + uVar3 ) * *(int*)( lVar16 + 0x1c )) * 8 ), uVar18);
         LOCK();
         *(int*)plVar1[6] = *(int*)plVar1[6] + 1;
         UNLOCK();
         if (( ( ~*(uint *)plVar1[6] & 0x3fff ) == 0 ) && ( *(char*)( *plVar1 + 0x8a ) != '\0' )) {
            basisu::debug_printf("basis_compressor::encode_slices_to_uastc: %3.1f%% done\n", (double)( ( (float)*(uint*)plVar1[6] * __LC21 ) / (float)*(uint*)( plVar1 + 3 ) ));
         }
...
/* std::_Rb_tree<basisu::basis_compressor::encode_slices_to_uastc_hdr()::uastc_blk_desc,
   ...
   .isra.0] */void std::_Rb_tree<basisu::basis_compressor::encode_slices_to_uastc_hdr()::uastc_blk_descvoid *pvVar2void *pvVar3void *pvVar4void *pvVar5void *pvVar6void *pvVar7void *pvVar8_Rb_tree_node *p_Var9void *pvVar10_Rb_tree_node *local_48local_48 = param_1;if (param_1 != (_Rb_tree_node*)0x0) {
   do {
...
return;}/* void basisu::append_vector<basisu::vector<unsigned char>, unsigned char>(basisu::vector<unsigned
   char>&, unsigned char const*, unsigned long) [clone .part.0] */void basisu::append_vector<basisu::vector<unsigned_char>,unsigned_char>(vector *param_1, uchar *param_2, ulong param_3) {
   ulong uVar1;
   uint uVar2;
   ulong uVar3;
   ulong uVar4;
...
/* std::_Rb_tree<basisu::basis_compressor::encode_slices_to_uastc_hdr()::uastc_blk_desc,
   ...
   if (*(_Rb_tree_node_base**)( this + 0x10 ) == (_Rb_tree_node_base*)0x0) {
      ...
      LAB_00102b24:if (*(_Rb_tree_node_base**)( this + 0x18 ) == p_Var5) {
         auVar1._8_8_ = 0;
         auVar1._0_8_ = p_Var5;
         return auVar1 << 0x40;
      }
      ...
      do {
         p_Var5 = p_Var4;
         p_Var3 = p_Var5 + 0x20;
         if (( param_1 == (uastc_blk_desc*)p_Var3 ) || ( ( *(uint*)( p_Var5 + 0x20 ) <= *(uint*)param_1 && ( ( *(uint*)param_1 != *(uint*)( p_Var5 + 0x20 ) || ( ( *(uint*)( p_Var5 + 0x24 ) <= *(uint*)( param_1 + 4 ) && ( ( *(uint*)( param_1 + 4 ) != *(uint*)( p_Var5 + 0x24 ) || ( ( *(uint*)( p_Var5 + 0x28 ) <= *(uint*)( param_1 + 8 ) && ( ( *(uint*)( param_1 + 8 ) != *(uint*)( p_Var5 + 0x28 ) || ( ( *(uint*)( p_Var5 + 0x2c ) <= *(uint*)( param_1 + 0xc ) && ( ( *(uint*)( param_1 + 0xc ) != *(uint*)( p_Var5 + 0x2c ) || ( *(uint*)( p_Var5 + 0x30 ) <= *(uint*)( param_1 + 0x10 ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )) {
 ...
 while ( p_Var4 != (_Rb_tree_node_base*)0x0 );
      p_Var4 = p_Var5;
      if (bVar2) goto LAB_00102b24;
   }

   if (param_1 == (uastc_blk_desc*)p_Var3) {
      LAB_00102b45:auVar6._8_8_ = 0;
      auVar6._0_8_ = p_Var4;
      return auVar6;
   }

   if (*(uint*)param_1 <= *(uint*)( p_Var4 + 0x20 )) {
      if (*(uint*)( p_Var4 + 0x20 ) != *(uint*)param_1) goto LAB_00102b45;
      if (*(uint*)( param_1 + 4 ) <= *(uint*)( p_Var4 + 0x24 )) {
         if (*(uint*)( p_Var4 + 0x24 ) != *(uint*)( param_1 + 4 )) goto LAB_00102b45;
         if (*(uint*)( param_1 + 8 ) <= *(uint*)( p_Var4 + 0x28 )) {
            if (*(uint*)( p_Var4 + 0x28 ) != *(uint*)( param_1 + 8 )) goto LAB_00102b45;
            if (*(uint*)( param_1 + 0xc ) <= *(uint*)( p_Var4 + 0x2c )) {
               if (*(uint*)( p_Var4 + 0x2c ) != *(uint*)( param_1 + 0xc )) goto LAB_00102b45;
   ...
   p_Var3 = p_Var5;
   LAB_00102b5a:auVar7._8_8_ = p_Var3;
   auVar7._0_8_ = p_Var4;
   return auVar7;
}
/* basisu::vector<unsigned char>::TEMPNAMEPLACEHOLDERVALUE(basisu::vector<unsigned char> const&)
   [clone .isra.0] */void basisu::vector<unsigned_char>::operator =(vector<unsigned_char> *this, vector *param_1) {
   uint uVar1;
   void *__ptr;
   if (this != (vector<unsigned_char>*)param_1) {
      ...
      if (*(uint*)( this + 0xc ) < uVar1) {
         ...
         basisu::elemental_vector::increase_capacity((uint)this, SUB41(uVar1, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
         uVar1 = *(uint*)( param_1 + 8 );
         __ptr = *(void**)this;
      }
...
/* basisu::vector<std::__cxx11::string
   >::TEMPNAMEPLACEHOLDERVALUE(basisu::vector<std::__cxx11::string > const&) [clone .isra.0] */void basisu::vector<std::__cxx11::string>::operator =(vector<std::__cxx11::string> *this, vector *param_1) {
   ulong __n;
   undefined1 *__src;
   ulong *__dest;
   ulong *__ptr;
 ...
 while ( puVar1 != __ptr );
         ...
         basisu::elemental_vector::increase_capacity((uint)this, SUB81(uVar3, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x20, true);
         uVar3 = ( ulong ) * (uint*)( param_1 + 8 );
         __ptr = *(ulong**)this;
      }
      ...
      if ((int)uVar3 != 0) {
         ...
         do {
            while (true) {
               ...
               *puVar1 = (ulong)__dest;
               puVar1[2] = local_48;
               LAB_00102d43:memcpy(__dest, __src, __n);
               puVar1[1] = local_48;
               *(undefined1*)( *puVar1 + local_48 ) = 0;
               puVar1 = puVar2;
               puVar4 = puVar4 + 4;
               if (puVar2 == __ptr + uVar3 * 4) goto LAB_00102d64;
            }
;
            if (__n == 1) {
               *(undefined1*)( puVar1 + 2 ) = *__src;
            }
 else if (__n != 0) goto LAB_00102d43;
            puVar1[1] = __n;
 ...
 while ( puVar2 != __ptr + uVar3 * 4 );
         LAB_00102d64:uVar3 = ( ulong ) * (uint*)( param_1 + 8 );
      }
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* void std::__unguarded_linear_insert<basist::ktx2_transcoder::key_value*,
   __gnu_cxx::__ops::_Val_less_iter>(basist::ktx2_transcoder::key_value*,
   __gnu_cxx::__ops::_Val_less_iter) [clone .isra.0] */void std::__unguarded_linear_insert<basist::ktx2_transcoder::key_value*,__gnu_cxx::__ops::_Val_less_iter>(undefined8 *param_1) {
   int iVar1;
   void *pvVar2;
   uint uVar3;
   uint uVar4;
   ...
   local_48 = (char*)0x0;
   local_40 = 0;
   basisu::elemental_vector::increase_capacity(( uint ) & local_48, SUB41(*(undefined4*)( param_1 + 1 ), 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
   ...
   local_38 = (void*)0x0;
   local_30 = 0;
   basisu::elemental_vector::increase_capacity(( uint ) & local_38, SUB41(*(undefined4*)( param_1 + 3 ), 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
   ...
   while (true) {
      ...
      if (*(uint*)( (long)param_1 + 0xc ) < uVar3) {
         ...
         basisu::elemental_vector::increase_capacity(uVar4, SUB41(uVar3, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
         uVar3 = *(uint*)( param_1 + -3 );
         pvVar2 = (void*)*param_1;
      }
      ...
      *(uint*)( param_1 + 1 ) = uVar3;
      ...
      if (*(uint*)( (long)param_1 + 0x1c ) < uVar3) {
         ...
         basisu::elemental_vector::increase_capacity(uVar4 + 0x10, SUB41(uVar3, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
         uVar3 = *(uint*)( param_1 + -1 );
         pvVar2 = (void*)param_1[2];
      }
...
;
   ...
   if (*(uint*)( (long)param_1 + 0xc ) < (uint)local_40) {
      ...
      basisu::elemental_vector::increase_capacity(uVar4, SUB41((uint)local_40, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
      pvVar2 = (void*)*param_1;
   }
 else if (*(int*)( param_1 + 1 ) != 0) {
      *(undefined4*)( param_1 + 1 ) = 0;
   ...
   *(uint*)( param_1 + 1 ) = uVar3;
   ...
   if (*(uint*)( (long)param_1 + 0x1c ) < (uint)local_30) {
      ...
      basisu::elemental_vector::increase_capacity(uVar4 + 0x10, SUB41((uint)local_30, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
      pvVar2 = (void*)param_1[2];
   }
 else if (*(int*)( param_1 + 3 ) != 0) {
      *(undefined4*)( param_1 + 3 ) = 0;
   ...
   *(uint*)( param_1 + 3 ) = uVar4;
   ...
   LAB_0010308e:if (local_48 != (char*)0x0) {
      free(local_48);
   }
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* void std::__insertion_sort<basist::ktx2_transcoder::key_value*,
   __gnu_cxx::__ops::_Iter_less_iter>(basist::ktx2_transcoder::key_value*,
   basist::ktx2_transcoder::key_value*, __gnu_cxx::__ops::_Iter_less_iter) [clone .isra.0] */void std::__insertion_sort<basist::ktx2_transcoder::key_value*,__gnu_cxx::__ops::_Iter_less_iter>(undefined8 *param_1, undefined8 *param_2) {
   int iVar1;
   void *pvVar2;
   undefined8 *puVar3;
   undefined8 *puVar5;
   ...
   if (( param_1 != param_2 ) && ( param_2 != param_1 + 4 )) {
      ...
      LAB_001031c1:do {
         ...
         if (iVar1 < 0) {
            local_68 = (void*)0x0;
            local_60 = 0;
            basisu::elemental_vector::increase_capacity(( uint ) & local_68, SUB41(*(undefined4*)( puVar5 + 1 ), 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
            ...
            local_58 = (void*)0x0;
            local_50 = 0;
            basisu::elemental_vector::increase_capacity(( uint ) & local_58, SUB41(*(undefined4*)( puVar5 + 3 ), 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
            ...
            if (0 < (long)puVar5 - (long)param_1) {
               ...
               do {
                  ...
                  if (*(uint*)( (long)puVar3 + -0x14 ) < *(uint*)( puVar3 + -7 )) {
                     ...
                     basisu::elemental_vector::increase_capacity((uint)puVar4, SUB41(*(undefined4*)( puVar3 + -7 ), 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
                  }
                  ...
                  *(undefined4*)( puVar3 + -3 ) = *(undefined4*)( puVar3 + -7 );
                  if (*(uint*)( (long)puVar3 + -4 ) < *(uint*)( puVar3 + -5 )) {
                     ...
                     basisu::elemental_vector::increase_capacity((int)puVar3 - 0x10, SUB41(*(undefined4*)( puVar3 + -5 ), 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
                  }
 ...
 while ( puVar4 != puVar5 + ( (long)puVar5 - (long)param_1 >> 5 ) * -4 + 4 );
            ...
            if (*(uint*)( (long)param_1 + 0xc ) < (uint)local_60) {
               ...
               basisu::elemental_vector::increase_capacity((uint)param_1, SUB41((uint)local_60, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
               pvVar2 = (void*)*param_1;
            }
 else if (*(int*)( param_1 + 1 ) != 0) {
               *(undefined4*)( param_1 + 1 ) = 0;
            ...
            *(uint*)( param_1 + 1 ) = uVar7;
            ...
            if (*(uint*)( (long)param_1 + 0x1c ) < (uint)local_50) {
               ...
               basisu::elemental_vector::increase_capacity((uint)param_1 + 0x10, SUB41((uint)local_50, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
               pvVar2 = (void*)param_1[2];
            }
 else if (*(int*)( param_1 + 3 ) != 0) {
               *(undefined4*)( param_1 + 3 ) = 0;
            ...
            uVar7 = (uint)local_50;
            if (pvVar2 == (void*)0x0) {
               LAB_001033ae:*(uint*)( param_1 + 3 ) = uVar7;
            ...
            __unguarded_linear_insert<basist::ktx2_transcoder::key_value*,__gnu_cxx::__ops::_Val_less_iter>(puVar5);
         }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* basisu::basis_compressor::encode_slices_to_uastc_hdr()::{lambda()#1}::TEMPNAMEPLACEHOLDERVALUE()
   const */void basisu::basis_compressor::encode_slices_to_uastc_hdr() {
   lambda()
   #1
   {
      ...
      local_2f8 = (void*)0x0;
      local_2f0 = 0;
      basisu::elemental_vector::increase_capacity((uint)(vector*)&local_2f8, false, 0, (_func_void_void_ptr_void_ptr_uint*)0xd0, false);
 ...
 while ( local_148 != pfVar27 );
            cVar12 = basisu::astc_hdr_enc_block(local_208, (astc_hdr_codec_options*)( *(long*)this + 0x260 ), (vector*)&local_2f8);
            if (cVar12 == '\0') {
               LAB_00103aa0:LOCK();
               **(undefined1**)( this + 0x38 ) = 1;
               ...
               if ((uint)local_2f0 == 0) {
                  ...
                  do {
                     ...
                     dVar41 = (double)basisu::compute_block_error(local_2c8, (ushort*)local_268, (astc_hdr_codec_options*)( *(long*)this + 0x260 ));
 ...
 while ( uVar16 < (uint)local_2f0 );
               ...
               if (*(int*)( *(long*)this + 0x2b4 ) == 0) {
                  ...
                  if (( cVar12 == '\0' ) && ( **(char**)( this + 0x38 ) == '\0' )) {
                     basisu::error_printf("basis_compressor::encode_slices_to_uastc_hdr: UASTC HDR block transcode check failed!\n");
                     goto LAB_00103aa0;
                  }
               ...
               if (cVar12 != '\0') {
                  ...
                  if (*(_Rb_tree_node_base**)( this_00 + 0x10 ) == (_Rb_tree_node_base*)0x0) {
                     LAB_00103d6d:p_Var20 = (_Rb_tree_node_base*)operator_new(0x38);
                     ...
                     *(undefined8*)( p_Var20 + 0x28 ) = uVar7;
                     if (lVar21 == 0) {
                        LAB_00103da7:auVar42 = std::_Rb_tree<basisu::basis_compressor::encode_slices_to_uastc_hdr()::uastc_blk_desc,std::pair<basisu::basis_compressor::encode_slices_to_uastc_hdr()::uastc_blk_desc_const,basisu::basis_compressor::encode_slices_to_uastc_hdr()::uastc_blk_desc_stats > std::_Select1st < std::pair<basisu::basis_compressor::encode_slices_to_uastc_hdr()::uastc_blk_desc_const,basisu::basis_compressor::encode_slices_to_uastc_hdr()::uastc_blk_desc_stats >> std::less<basisu::basis_compressor::encode_slices_to_uastc_hdr()::uastc_blk_desc > std::allocator < std::pair<basisu::basis_compressor::encode_slices_to_uastc_hdr()::uastc_blk_desc_const,basisu::basis_compressor::encode_slices_to_uastc_hdr()::uastc_blk_desc_stats >> ::_M_get_insert_unique_pos(this_00, this_01);
                     }
 else {
                        ...
                        auVar9._0_8_ = uVar30;
                        auVar42 = auVar9 << 0x40;
                        if (cVar12 == '\0') goto LAB_00103da7;
                     }

                     LAB_00103db8:p_Var22 = auVar42._8_8_;
                     p_Var38 = auVar42._0_8_;
                     if (p_Var22 != (_Rb_tree_node_base*)0x0) {
                        bVar39 = p_Var38 != (_Rb_tree_node_base*)0x0;
                        LAB_00103ebb:p_Var38 = p_Var22;
                        if (( p_Var1 == p_Var22 ) || ( bVar39 )) {
                           LAB_00103e81:uVar13 = true;
                        }
 else {
                           puVar32 = (uastc_blk_desc*)( p_Var22 + 0x20 );
                           LAB_00103eca:uVar13 = uastc_blk_desc::operator <(this_01, puVar32);
                           p_Var38 = p_Var22;
                        }
                     ...
                     do {
                        if (( *(uint*)( p_Var20 + 0x20 ) < uVar23 ) || ( ( uVar23 == *(uint*)( p_Var20 + 0x20 ) && ( ( *(uint*)( p_Var20 + 0x24 ) < uStack_2e4 || ( ( *(uint*)( p_Var20 + 0x24 ) == uStack_2e4 && ( ( *(uint*)( p_Var20 + 0x28 ) < uStack_2e0 || ( ( uStack_2e0 == *(uint*)( p_Var20 + 0x28 ) && ( ( *(uint*)( p_Var20 + 0x2c ) < uStack_2dc || ( ( uStack_2dc == *(uint*)( p_Var20 + 0x2c ) && ( *(uint*)( p_Var20 + 0x30 ) < local_2d8 ) ) ) ) ) ) ) ) ) ) ) ) ) ) )) {
 ...
 while ( p_Var22 != (_Rb_tree_node_base*)0x0 );
                     if (p_Var1 == p_Var38) goto LAB_00103d6d;
                     if (( *(uint*)( p_Var38 + 0x20 ) <= uVar23 ) && ( ( uVar23 != *(uint*)( p_Var38 + 0x20 ) || ( ( *(uint*)( p_Var38 + 0x24 ) <= uStack_2e4 && ( ( *(uint*)( p_Var38 + 0x24 ) != uStack_2e4 || ( ( *(uint*)( p_Var38 + 0x28 ) <= uStack_2e0 && ( ( uStack_2e0 != *(uint*)( p_Var38 + 0x28 ) || ( ( *(uint*)( p_Var38 + 0x2c ) <= uStack_2dc && ( ( uStack_2dc != *(uint*)( p_Var38 + 0x2c ) || ( *(uint*)( p_Var38 + 0x30 ) <= local_2d8 ) ) ) ) ) ) ) ) ) ) ) ) ) ) )) {
                     ...
                     *(undefined1(*) [16])( p_Var20 + 0x20 ) = auVar8;
                     if (this_01 != puVar32) {
                        if (uVar23 < *(uint*)( p_Var38 + 0x20 )) {
                           LAB_00103dee:if (p_Var38 != *(_Rb_tree_node_base**)( this_00 + 0x18 )) {
                              p_Var22 = (_Rb_tree_node_base*)std::_Rb_tree_decrement(p_Var38);
                              if (( this_01 == (uastc_blk_desc*)( p_Var22 + 0x20 ) ) || ( ( uVar23 <= *(uint*)( p_Var22 + 0x20 ) && ( ( uVar23 != *(uint*)( p_Var22 + 0x20 ) || ( ( uVar14 <= *(uint*)( p_Var22 + 0x24 ) && ( ( *(uint*)( p_Var22 + 0x24 ) != uVar14 || ( ( uVar16 <= *(uint*)( p_Var22 + 0x28 ) && ( ( uVar16 != *(uint*)( p_Var22 + 0x28 ) || ( ( uVar10 <= *(uint*)( p_Var22 + 0x2c ) && ( ( uVar10 != *(uint*)( p_Var22 + 0x2c ) || ( uVar11 <= *(uint*)( p_Var22 + 0x30 ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )) goto LAB_00103da7;
                              if (*(long*)( p_Var22 + 0x18 ) != 0) goto LAB_00103e81;
                              bVar39 = false;
                              goto LAB_00103ebb;
                           }
                        ...
                        if (uVar23 == *(uint*)( p_Var38 + 0x20 )) {
                           if (uVar14 < *(uint*)( p_Var38 + 0x24 )) goto LAB_00103dee;
                           if (*(uint*)( p_Var38 + 0x24 ) == uVar14) {
                              uVar5 = *(uint*)( p_Var38 + 0x28 );
                              if (( uVar16 < uVar5 ) || ( ( uVar16 == uVar5 && ( ( uVar10 < *(uint*)( p_Var38 + 0x2c ) || ( ( uVar10 == *(uint*)( p_Var38 + 0x2c ) && ( uVar11 < *(uint*)( p_Var38 + 0x30 ) ) ) ) ) ) ) )) goto LAB_00103dee;
                              if (( uVar16 <= uVar5 ) && ( ( uVar16 != uVar5 || ( ( uVar10 <= *(uint*)( p_Var38 + 0x2c ) && ( ( uVar10 != *(uint*)( p_Var38 + 0x2c ) || ( uVar11 <= *(uint*)( p_Var38 + 0x30 ) ) ) ) ) ) ) )) goto LAB_00103dc1;
                           }
                        ...
                        if (p_Var38 != *(_Rb_tree_node_base**)( this_00 + 0x20 )) {
                           ...
                           if (cVar12 != '\0') {
                              if (*(long*)( p_Var38 + 0x18 ) == 0) goto LAB_00103eca;
                              goto LAB_00103db8;
                           }
                  ...
                  LAB_00103dc1:operator_delete(p_Var20, 0x38);
                  *(int*)( p_Var38 + 0x34 ) = *(int*)( p_Var38 + 0x34 ) + 1;
                  pthread_mutex_unlock(__mutex);
               }
               ...
               **(int**)( this + 0x30 ) = **(int**)( this + 0x30 ) + 1;
               ...
               if (( ( ~**(uint **)(this + 0x30) & 0x3ff ) == 0 ) && ( *(char*)( *(long*)this + 0x8a ) != '\0' )) {
                  basisu::debug_printf("basis_compressor::encode_slices_to_uastc_hdr: %3.1f%% done\n", (double)( ( (float)**(uint**)( this + 0x30 ) * __LC21 ) / (float)*(uint*)( this + 0x18 ) ));
               }
 ...
 while ( local_344 < *(uint*)( this + 0xc ) );
      ...
      LAB_00103f6f:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }

   /* std::_Function_handler<void (),
   basisu::basis_compressor::encode_slices_to_uastc_hdr()::{lambda()#1}>::_M_invoke(std::_Any_data
   const&) */
   void std::_Function_handler<void(),basisu::basis_compressor::encode_slices_to_uastc_hdr()::{lambda()#1}>
     ::_M_invoke(_Any_data *param_1)

{
  basisu::basis_compressor::encode_slices_to_uastc_hdr()::{lambda()#1}::operator ()(*(_lambda___1_**)param_1);
   return;
}
/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* void std::__adjust_heap<basist::ktx2_transcoder::key_value*, long,
   basist::ktx2_transcoder::key_value,
   __gnu_cxx::__ops::_Iter_less_iter>(basist::ktx2_transcoder::key_value*, long, long,
   basist::ktx2_transcoder::key_value, __gnu_cxx::__ops::_Iter_less_iter) [clone .isra.0] */void std::__adjust_heap<basist::ktx2_transcoder::key_value*,long,basist::ktx2_transcoder::key_value,__gnu_cxx::__ops::_Iter_less_iter>(long param_1, long param_2, ulong param_3, undefined8 *param_4) {
   vector *pvVar1;
   int iVar2;
   long lVar3;
   long lVar4;
      ...
      do {
         ...
         if (this != pvVar9) {
            ...
            if (*(uint*)( pvVar9 + 0xc ) < uVar5) {
               ...
               basisu::elemental_vector::increase_capacity((uint)pvVar9, SUB41(uVar5, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
               uVar5 = *(uint*)( this + 8 );
               pvVar6 = *(void**)pvVar9;
            }
         ...
         if (pvVar9 + 0x10 != this + 0x10) {
            ...
            if (*(uint*)( pvVar9 + 0x1c ) < uVar5) {
               ...
               basisu::elemental_vector::increase_capacity(( uint )(pvVar9 + 0x10), SUB41(uVar5, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
               uVar5 = *(uint*)( this + 0x18 );
               pvVar6 = *(void**)( pvVar9 + 0x10 );
            }
 ...
 while ( lVar4 < lVar7 );
   ...
   local_68 = (char*)0x0;
   local_60 = 0;
   basisu::elemental_vector::increase_capacity((uint)(vector*)&local_68, SUB41(*(undefined4*)( param_4 + 1 ), 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
   ...
   local_58 = (void*)0x0;
   local_50 = 0;
   basisu::elemental_vector::increase_capacity(( uint ) & local_58, SUB41(*(undefined4*)( param_4 + 3 ), 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
   ...
   while (param_2 < lVar4) {
      ...
      if (pvVar9 != this) {
         ...
         if (*(uint*)( this + 0xc ) < uVar5) {
            ...
            basisu::elemental_vector::increase_capacity((uint)this, SUB41(uVar5, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
            uVar5 = *(uint*)( pvVar9 + 8 );
            pvVar6 = *(void**)this;
         }
 else if (*(int*)( this + 8 ) != 0) {
      ...
      if (this + 0x10 != pvVar9 + 0x10) {
         ...
         if (*(uint*)( this + 0x1c ) < uVar5) {
            ...
            basisu::elemental_vector::increase_capacity(( uint )(this + 0x10), SUB41(uVar5, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
            uVar5 = *(uint*)( pvVar9 + 0x18 );
            pvVar6 = *(void**)( this + 0x10 );
         }
...
;
   ...
   if (*(uint*)( this + 0x1c ) < (uint)local_50) {
      ...
      basisu::elemental_vector::increase_capacity((int)this + 0x10, SUB41((uint)local_50, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
   }
 else if (*(int*)( this + 0x18 ) != 0) {
      *(undefined4*)( this + 0x18 ) = 0;
   }
   ...
   *(uint*)( this + 0x18 ) = uVar5;
   ...
   LAB_00104460:if (local_68 != (char*)0x0) {
      free(local_68);
   }
...
/* basisu::string_get_filename(char const*, std::__cxx11::string&) [clone .isra.0] */void basisu::string_get_filename(char *param_1, string *param_2) {
   char cVar1;
   long in_FS_OFFSET;
   undefined1 *local_48;
   ulong local_40;
...
/* buminiz::mz_adler32(unsigned long, unsigned char const*, unsigned long) */int buminiz::mz_adler32(ulong param_1, uchar *param_2, ulong param_3) {
   int iVar1;
   byte *pbVar2;
   byte *pbVar3;
   int iVar4;
      ...
      if ((byte*)0x7 < pbVar3) {
         do {
            ...
            do {
               ...
               uVar7 = (ulong)uVar6;
               uVar9 = ( ulong )((int)uVar9 + iVar1 + iVar15 + iVar14 + iVar13 + iVar5 + iVar4 + iVar12 + uVar6);
               param_2 = pbVar2;
            }
...
;
 ...
 while ( param_3 != 0 );
      ...
      pbVar11 = pbVar2;
      pbVar10 = param_2;
      goto joined_r0x001046b7;
   }

   return (int)( param_1 >> 0x10 ) * 0x10000 + (int)uVar7;
}
/* buminiz::mz_crc32(unsigned long, unsigned char const*, unsigned long) */ulong buminiz::mz_crc32(ulong param_1, uchar *param_2, ulong param_3) {
   byte bVar1;
   ulong uVar2;
   byte *pbVar3;
   uint uVar4;
   ...
   if (param_2 == (uchar*)0x0) {
      ...
      if (param_3 != 0) {
         ...
         do {
            bVar1 = *param_2;
            param_2 = param_2 + 1;
            uVar4 = uVar4 >> 4 ^ *(uint*)( mz_crc32(unsigned_long,unsigned_char_const*,unsigned_long):: );
            uVar4 = uVar4 >> 4 ^ *(uint*)( mz_crc32(unsigned_long,unsigned_char_const*,unsigned_long):: );
         }
...
/* buminiz::mz_free(void*) */void buminiz::mz_free(void *param_1) {
   free(param_1);
   return;
}
/* buminiz::mz_version() */char *buminiz::mz_version(void) {
   return "9.1.15";
}
/* buminiz::mz_deflateEnd(buminiz::mz_stream_s*) */undefined8 buminiz::mz_deflateEnd(mz_stream_s *param_1) {
...
/* buminiz::mz_deflateBound(buminiz::mz_stream_s*, unsigned long) */ulong buminiz::mz_deflateBound(mz_stream_s *param_1, ulong param_2) {
   ulong uVar1;
...
/* buminiz::mz_compressBound(unsigned long) */ulong buminiz::mz_compressBound(ulong param_1) {
   ulong uVar1;
   undefined1 auVar2[16];
   ulong uVar3;
   auVar2._8_8_ = 0;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* buminiz::mz_inflateInit2(buminiz::mz_stream_s*, int) */undefined8 buminiz::mz_inflateInit2(mz_stream_s *param_1, int param_2) {
   undefined8 uVar1;
   undefined4 *puVar2;
   code *pcVar3;
   undefined8 uVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* buminiz::mz_inflateInit(buminiz::mz_stream_s*) */undefined8 buminiz::mz_inflateInit(mz_stream_s *param_1) {
   long lVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   undefined4 *puVar4;
...
/* buminiz::mz_inflateEnd(buminiz::mz_stream_s*) */undefined8 buminiz::mz_inflateEnd(mz_stream_s *param_1) {
   if (param_1 != (mz_stream_s*)0x0) {
      if (*(long*)( param_1 + 0x38 ) != 0) {
         ( **(code**)( param_1 + 0x48 ) )(*(undefined8*)( param_1 + 0x50 ));
         *(undefined8*)( param_1 + 0x38 ) = 0;
...
/* buminiz::mz_error(int) */undefined *buminiz::mz_error(int param_1) {
   uint uVar1;
   ulong uVar2;
   int *piVar3;
   uVar2 = 0;
   ...
   do {
      if (*piVar3 == param_1) {
         return ( &PTR__LC30_00122328 )[uVar2 * 2];
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* buminiz::tinfl_decompress(buminiz::tinfl_decompressor_tag*, unsigned char const*, unsigned long*,
   unsigned char*, unsigned char*, unsigned long*, unsigned int) */int buminiz::tinfl_decompress(tinfl_decompressor_tag *param_1, uchar *param_2, ulong *param_3, uchar *param_4, uchar *param_5, ulong *param_6, uint param_7) {
   ...
   if (uVar32 == 0) {
      ...
      if (( (ulong)local_110 & (ulong)puVar21 ) == 0) goto LAB_00104b19;
      LAB_00104d58:*param_6 = 0;
      *param_3 = 0;
      iVar10 = -3;
      goto LAB_00104d20;
   }
   ...
   puVar21 = (uchar*)0x0;
   LAB_00104b19:if (param_5 < param_4) goto LAB_00104d58;
...
LAB_00104fef:
      ...
      *(uint *)(param_1 + 8) = uVar9;
      ptVar42 = ptVar15;
      if (ptVar13 <= ptVar15) goto LAB_00105ab1;
...
LAB_001055a7:
   ...
   while (-1 < (int)uVar43) {
      ...
      *(undefined8*)( ptVar15 + 0x7f8 ) = 0;
      ...
      for (uVar14 = ( ulong )(( (int)ptVar15 - (int)(undefined8*)( ( ulong )(ptVar15 + 8) & 0xfffffffffffffff8 ) ) + 0x800U >> 3); uVar14 != 0; uVar14 = uVar14 - 1) {
         *puVar35 = 0;
         puVar35 = puVar35 + (ulong)bVar48 * -2 + 1;
      }
      ...
      *(undefined8*)( ptVar15 + 0x478 ) = 0;
      puVar35 = (undefined8*)( ( ulong )(ptVar15 + 8) & 0xfffffffffffffff8 );
      for (uVar14 = ( ulong )(( (int)ptVar15 - (int)(undefined8*)( ( ulong )(ptVar15 + 8) & 0xfffffffffffffff8 ) ) + 0x480U >> 3); uVar14 != 0; uVar14 = uVar14 - 1) {
         *puVar35 = 0;
         puVar35 = puVar35 + (ulong)bVar48 * -2 + 1;
      }
      ...
      if (uVar9 != 0) {
         ...
         do {
            ptVar1 = ptVar15 + 0x48;
            ptVar15 = ptVar15 + 1;
            *(int*)( local_c8 + ( ulong )(byte) * ptVar1 * 4 ) = *(int*)( local_c8 + ( ulong )(byte) * ptVar1 * 4 ) + 1;
         }
               ...
               if (uVar29 < 0xb) {
                  if (uVar11 < 0x400) {
                     do {
                        ...
                        *(ushort*)( param_1 + ( uVar43 + 0xb0 + lVar36 ) * 2 + 8 ) = (ushort)(byte)tVar4 << 9 | (ushort)uVar14;
                     }
 while ( uVar11 < 0x400 );
                  }
...
;
                  *(ushort*)( param_1 + ( (long)(int)~(iVar8 - (uVar12 >> 1 & 1)) + 0x4b0 + lVar36 ) * 2 + 8 ) = (ushort)uVar14;
               }
                        ...
                        if (*(short*)( param_1 + ( ulong )((uint)uVar47 & 0x3ff) * 2 + 0x1ca8 ) < 0) {
                           if (10 < uVar25) {
                              ...
                              do {
                                 uVar28 = ~uVar24;
                                 uVar34 = uVar9 + 1;
                                 uVar24 = ( uint ) * (short*)( param_1 + ( ( ulong )(( uint )(uVar47 >> ( (byte)uVar9 & 0x3f )) & 1) + 0x1250 + (long)(int)uVar28 ) * 2 + 8 );
                                 if (-1 < *(short*)( param_1 + ( ( ulong )(( uint )(uVar47 >> ( (byte)uVar9 & 0x3f )) & 1) + 0x1250 + (long)(int)uVar28 ) * 2 + 8 )) {
                                    uVar24 = ( uint ) * (short*)( param_1 + ( ulong )((uint)uVar47 & 0x3ff) * 2 + 0x1ca8 );
                                    goto LAB_00106155;
                                 }
 ...
 else if (( (int)uVar24 >> 9 ) - 1U < uVar25) goto LAB_00106084;
                        if (ptVar42 < ptVar13) {
                           tVar4 = *ptVar42;
                           ptVar42 = ptVar42 + 1;
                           uVar47 = uVar47 | (ulong)(byte)tVar4 << ( (byte)uVar25 & 0x3f );
 ...
 while ( uVar25 < 0xf );
                     ...
                     ptVar42 = ptVar42 + 2;
                     uVar25 = uVar25 + 0x10;
                     uVar47 = uVar47 | ( ulong )(byte) * ptVar15 << ( bVar16 + 8 & 0x3f ) | (ulong)(byte)tVar4 << ( bVar16 & 0x3f );
                  }
               ...
               uVar24 = ( uint ) * (short*)( param_1 + ( ulong )((uint)uVar47 & 0x3ff) * 2 + 0x1ca8 );
               if (*(short*)( param_1 + ( ulong )((uint)uVar47 & 0x3ff) * 2 + 0x1ca8 ) < 0) {
                  LAB_00106155:iVar10 = 10;
                  do {
                     uVar9 = ~uVar24;
                     iVar8 = iVar10 + 1;
                     bVar16 = (byte)iVar10;
                     uVar24 = ( uint ) * (short*)( param_1 + ( ( ulong )(( uint )(uVar47 >> ( bVar16 & 0x3f )) & 1) + 0x1250 + (long)(int)uVar9 ) * 2 + 8 );
                     iVar10 = iVar8;
                  }
 while ( *(short*)( param_1 + ( ( ulong )(( uint )(uVar47 >> ( bVar16 & 0x3f )) & 1) + 0x1250 + (long)(int)uVar9 ) * 2 + 8 ) < 0 );
               }
 else {
                  LAB_00106084:iVar8 = (int)uVar24 >> 9;
                  uVar24 = uVar24 & 0x1ff;
               }
                  ...
                  if (uVar25 < local_124) {
                     do {
                        while (ptVar42 < ptVar13) {
                           ...
                           uVar47 = uVar47 | (ulong)(byte)tVar4 << ( (byte)uVar25 & 0x3f );
                           uVar25 = uVar24;
                           if (local_124 <= uVar24) goto LAB_001050f5;
                        }
;
                        LAB_00105d95:if (( param_7 & 2 ) != 0) {
                           uVar43 = (long)puVar44 - (long)param_5;
                           uVar20 = 0x12;
                           iVar10 = 1;
                           uVar14 = (long)ptVar42 - (long)param_2;
                        ...
                        LAB_001050c2:uVar25 = uVar25 + 8;
                     }
 while ( uVar25 < local_124 );
                     LAB_001050f5:uVar43 = ( ulong )(local_128 - 0x10);
                  }
                  ...
                  uVar24 = (int)(char)( &_LC70 )[uVar43] + ( ( 1 << ( (byte)local_124 & 0x1f ) ) - 1U & uVar24 );
                  if (local_128 == 0x10) {
...
;
   joined_r0x001055fb:while (true) {
      local_130 = uVar23;
      bVar16 = (byte)uVar25;
      if (3 < (long)ptVar13 - (long)ptVar42) break;
      if (uVar25 < 0xf) {
         if (1 < (long)ptVar13 - (long)ptVar42) goto LAB_00106807;
         do {
            ...
            if (*(short*)( param_1 + ( ulong )((uint)uVar47 & 0x3ff) * 2 + 0x168 ) < 0) {
               if (10 < uVar25) {
                  ...
                  do {
                     uVar28 = ~uVar9;
                     uVar34 = uVar24 + 1;
                     uVar9 = ( uint ) * (short*)( param_1 + ( ( ulong )(( uint )(uVar47 >> ( (byte)uVar24 & 0x3f )) & 1) + 0x4b0 + (long)(int)uVar28 ) * 2 + 8 );
                     if (-1 < *(short*)( param_1 + ( ( ulong )(( uint )(uVar47 >> ( (byte)uVar24 & 0x3f )) & 1) + 0x4b0 + (long)(int)uVar28 ) * 2 + 8 )) {
                        uVar9 = ( uint ) * (short*)( param_1 + ( ulong )((uint)uVar47 & 0x3ff) * 2 + 0x168 );
                        goto LAB_0010625e;
                     }
 ...
 while ( uVar25 != uVar34 );
 ...
 else if (( (int)uVar9 >> 9 ) - 1U < uVar25) goto LAB_00105ef2;
            if (ptVar42 < ptVar13) {
               tVar4 = *ptVar42;
               ptVar42 = ptVar42 + 1;
               uVar47 = uVar47 | (ulong)(byte)tVar4 << ( (byte)uVar25 & 0x3f );
            ...
            LAB_00105437:uVar25 = uVar25 + 8;
         }
 while ( uVar25 < 0xf );
      }

      LAB_00105ed7:uVar9 = ( uint ) * (short*)( param_1 + ( ulong )((uint)uVar47 & 0x3ff) * 2 + 0x168 );
      if (*(short*)( param_1 + ( ulong )((uint)uVar47 & 0x3ff) * 2 + 0x168 ) < 0) {
         LAB_0010625e:iVar10 = 10;
         do {
            uVar24 = ~uVar9;
            iVar8 = iVar10 + 1;
            bVar16 = (byte)iVar10;
            uVar9 = ( uint ) * (short*)( param_1 + ( ( ulong )(( uint )(uVar47 >> ( bVar16 & 0x3f )) & 1) + 0x4b0 + (long)(int)uVar24 ) * 2 + 8 );
            iVar10 = iVar8;
         }
 while ( *(short*)( param_1 + ( ( ulong )(( uint )(uVar47 >> ( bVar16 & 0x3f )) & 1) + 0x4b0 + (long)(int)uVar24 ) * 2 + 8 ) < 0 );
      }
 else {
         LAB_00105ef2:iVar8 = (int)uVar9 >> 9;
         uVar9 = uVar9 & 0x1ff;
      }
      ...
      uVar47 = uVar47 >> ( (byte)iVar8 & 0x3f );
      uVar24 = uVar25;
      if (0xff < (int)uVar9) goto LAB_00105f13;
      LAB_00105994:if (puVar2 <= puVar44) {
         uVar43 = (long)puVar44 - (long)param_5;
...
;
   if ((long)puVar2 - (long)puVar44 < 2) {
      if (uVar25 < 0xf) {
         LAB_00106807:ptVar15 = ptVar42 + 1;
         tVar4 = *ptVar42;
         ptVar42 = ptVar42 + 2;
         uVar25 = uVar25 + 0x10;
         uVar47 = uVar47 | ( ulong )(byte) * ptVar15 << ( bVar16 + 8 & 0x3f ) | (ulong)(byte)tVar4 << ( bVar16 & 0x3f );
   ...
   if (( uVar9 & 0x100 ) == 0) {
      ...
      if (*(short*)( param_1 + ( ulong )((uint)uVar47 & 0x3ff) * 2 + 0x168 ) < 0) {
         ...
         do {
            ...
            iVar8 = iVar10 + 1;
            bVar16 = (byte)iVar10;
            uVar25 = ( uint ) * (short*)( param_1 + ( ( ulong )(( uint )(uVar47 >> ( bVar16 & 0x3f )) & 1) + 0x4b0 + (long)(int)uVar28 ) * 2 + 8 );
            iVar10 = iVar8;
         }
 while ( *(short*)( param_1 + ( ( ulong )(( uint )(uVar47 >> ( bVar16 & 0x3f )) & 1) + 0x4b0 + (long)(int)uVar28 ) * 2 + 8 ) < 0 );
      }
 else {
         iVar8 = (int)uVar25 >> 9;
      }
   ...
   LAB_00105f13:uVar9 = uVar9 & 0x1ff;
   uVar40 = (ulong)uVar9;
   if (uVar9 != 0x100) {
      ...
      if (local_124 != 0) {
         for (; uVar25 < local_124; uVar25 = uVar25 + 8) {
            ...
            LAB_001053e7:}uVar24 = uVar25 - local_124;
            uVar25 = (uint)uVar47;
            uVar47 = uVar47 >> ( (byte)local_124 & 0x3f );
               ...
               do {
                  ...
                  if (*(short*)( param_1 + ( ulong )((uint)uVar47 & 0x3ff) * 2 + 0xf08 ) < 0) {
                     if (10 < uVar25) {
                        ...
                        do {
                           uVar28 = uVar24 + 1;
                           uVar9 = ( uint ) * (short*)( param_1 + ( ( ulong )(( uint )(uVar47 >> ( (byte)uVar24 & 0x3f )) & 1) + 0xb80 + (long)(int)~uVar9 ) * 2 + 8 );
                           if (-1 < (int)uVar9) {
                              uVar9 = ( uint ) * (short*)( param_1 + ( ulong )((uint)uVar47 & 0x3ff) * 2 + 0xf08 );
                              goto LAB_00105fc3;
                           }
 ...
 while ( uVar25 != uVar28 );
                     ...
                     iVar10 = (int)uVar9 >> 9;
                     if (iVar10 - 1U < uVar25) goto LAB_00105b72;
                  }
 ...
 while ( uVar24 < 0xf );
         ...
         uVar25 = uVar24;
         if (*(short*)( param_1 + ( ulong )((uint)uVar47 & 0x3ff) * 2 + 0xf08 ) < 0) {
            LAB_00105fc3:uVar43 = (ulong)uVar9;
            iVar8 = 10;
            do {
               uVar24 = (uint)uVar43;
               iVar10 = iVar8 + 1;
               bVar16 = (byte)iVar8;
               uVar43 = (ulong)(uint)(int)*(short*)( param_1 + ( ( ulong )(( uint )(uVar47 >> ( bVar16 & 0x3f )) & 1) + 0xb80 + (long)(int)~uVar24 ) * 2 + 8 );
               iVar8 = iVar10;
            }
 while ( *(short*)( param_1 + ( ( ulong )(( uint )(uVar47 >> ( bVar16 & 0x3f )) & 1) + 0xb80 + (long)(int)~uVar24 ) * 2 + 8 ) < 0 );
         }
 else {
            iVar10 = (int)uVar9 >> 9;
            LAB_00105b72:uVar43 = ( ulong )(uVar9 & 0x1ff);
         }
            ...
            if (uVar24 < local_124) {
               do {
                  while (ptVar42 < ptVar13) {
                     ...
                     uVar47 = uVar47 | (ulong)(byte)tVar4 << ( (byte)uVar25 & 0x3f );
                     uVar25 = uVar24;
                     if (local_124 <= uVar24) goto LAB_00105202;
                  }
;
                  LAB_00105c81:if (( param_7 & 2 ) != 0) {
                  ...
                  LAB_001051cf:uVar24 = uVar25 + 8;
                  uVar25 = uVar24;
               }
 while ( uVar24 < local_124 );
            }

            LAB_00105202:uVar25 = uVar24 - local_124;
         ...
         if (puVar2 < puVar17 + uVar40) {
            while ((int)uVar40 != 0) {
               ...
               local_130 = uVar23;
               if (puVar2 <= puVar44) goto LAB_00105944;
               LAB_00105904:uVar23 = local_130 + 1;
...
;
 ...
 while ( 2 < (int)uVar24 );
   ...
   LAB_00105a2b:}while (( (byte)param_1[0x14] & 1 ) == 0) ;;;
   uVar43 = (long)puVar44 - (long)param_5;
   uVar25 = uVar24;
   if (( param_7 & 1 ) != 0) {
      for (; uVar32 = uVar25,uVar24 = uVar25 & 7,uVar25 < ( uVar25 & 7 ); uVar25 = uVar25 + 8) {
         ...
         LAB_0010574f:}uVar47 = uVar47 >> ( (byte)uVar24 & 0x3f );
         ...
         do {
            ...
            if (uVar25 == 0) {
               if (ptVar42 < ptVar13) {
                  ...
                  LAB_00105e50:uVar9 = (uint)uVar40;
                  uVar32 = param_7 & 2;
                  if (uVar32 != 0) {
               ...
               if (uVar25 < 8) {
                  do {
                     ...
                     LAB_001054af:uVar9 = (uint)uVar40;
                     uVar32 = uVar25 + 8;
                  }
 while ( uVar25 + 8 < 8 );
               }
            ...
            LAB_0010538f:uVar40 = ( ulong )(uVar9 + 1);
 ...
 while ( uVar9 + 1 < 4 );
      ...
      uVar14 = (long)ptVar42 - (long)param_2;
      LAB_00105829:*(undefined4*)param_1 = 0x22;
      iVar10 = 0;
      uVar24 = uVar25;
   }
 else {
      LAB_00104fbe:uVar40 = 1;
      uVar14 = (long)ptVar42 - (long)param_2;
      LAB_00104fca:*(undefined4*)param_1 = 0x24;
      uVar43 = 0;
      iVar10 = -1;
      uVar24 = uVar25;
   }
...
else{*(undefined4*)param_1 = 1;uVar43 = 0;uVar14 = 0;iVar10 = 1;}break;case 2:
    if (param_2 < ptVar13) {
      uVar28 = (uint)*param_2;
...
LAB_00104fb6:
    uVar25 = uVar24;
    if (uVar28 % 0x1f == 0) goto LAB_00105a5d;
    goto LAB_00104fbe;case 3:
    if (ptVar13 <= param_2) goto LAB_00105c23;
    ptVar42 = (tinfl_decompressor_tag *)(param_2 + 1);
    uVar47 = uVar47 | (ulong)*param_2 << (bVar16 & 0x3f);
    goto LAB_00104eab;default:
    uVar43 = 0;
    uVar14 = 0;
    iVar10 = -1;
    uVar24 = uVar25;
    break;case 5:
    if (ptVar13 <= param_2) goto LAB_00105bb7;
    ptVar42 = (tinfl_decompressor_tag *)(param_2 + 1);
    uVar47 = uVar47 | (ulong)*param_2 << (bVar16 & 0x3f);
    goto LAB_00104d92;case 6:
    if (ptVar13 <= param_2) goto LAB_00105d37;
    ptVar42 = (tinfl_decompressor_tag *)(param_2 + 1);
    uVar47 = uVar47 | (ulong)*param_2 << (bVar16 & 0x3f);
    goto LAB_001056ff;case 7:
    if (ptVar13 <= param_2) goto LAB_00105eb0;
    ptVar42 = (tinfl_decompressor_tag *)(param_2 + 1);
    param_1[uVar40 + 0x2928] = (tinfl_decompressor_tag)*param_2;
    goto LAB_00104dec;case 9:
    goto LAB_0010587f;case 10:
    uVar43 = 0;
    uVar14 = 0;
LAB_0010583d:
    *(undefined4 *)param_1 = 10;
    ...
    uVar24 = uVar25;
    break;case 0xb:
    if (ptVar13 <= param_2) goto LAB_00105c52;
    ptVar42 = (tinfl_decompressor_tag *)(param_2 + 1);
    uVar47 = uVar47 | (ulong)*param_2 << (bVar16 & 0x3f);
    goto LAB_00104f17;case 0xe:
    if (ptVar13 <= param_2) goto LAB_00105d66;
    ptVar42 = (tinfl_decompressor_tag *)(param_2 + 1);
    uVar47 = uVar47 | (ulong)*param_2 << (bVar16 & 0x3f);
    goto LAB_00105577;case 0x10:
    if (ptVar13 <= param_2) goto LAB_00105e23;
    ptVar42 = (tinfl_decompressor_tag *)(param_2 + 1);
    uVar47 = uVar47 | (ulong)*param_2 << (bVar16 & 0x3f);
    goto LAB_001057aa;case 0x11:
    uVar43 = 0;
    uVar14 = 0;
LAB_00105854:
    uVar20 = 0x11;
    iVar10 = -1;
    goto LAB_0010585f;case 0x12:
    if (ptVar13 <= param_2) goto LAB_00105d95;
    ptVar42 = (tinfl_decompressor_tag *)(param_2 + 1);
    uVar47 = uVar47 | (ulong)*param_2 << (bVar16 & 0x3f);
    goto LAB_001050c2;case 0x15:
    uVar43 = 0;
    uVar14 = 0;
LAB_001058c8:
    uVar20 = 0x15;
    iVar10 = -1;
    goto LAB_0010585f;case 0x17:
    if (ptVar13 <= param_2) goto LAB_00105e7e;
    ptVar42 = (tinfl_decompressor_tag *)(param_2 + 1);
    uVar47 = uVar47 | (ulong)*param_2 << (bVar16 & 0x3f);
    goto LAB_00105437;case 0x18:
    goto LAB_00105994;case 0x19:
    if (ptVar13 <= param_2) goto LAB_00105cb0;
    ptVar42 = (tinfl_decompressor_tag *)(param_2 + 1);
    uVar47 = uVar47 | (ulong)*param_2 << (bVar16 & 0x3f);
    goto LAB_001053e7;case 0x1a:
    if (ptVar13 <= param_2) goto LAB_00105dc2;
    ptVar42 = (tinfl_decompressor_tag *)(param_2 + 1);
    uVar47 = uVar47 | (ulong)*param_2 << (bVar16 & 0x3f);
    goto LAB_001054ff;case 0x1b:
    if (ptVar13 <= param_2) goto LAB_00105c81;
    ptVar42 = (tinfl_decompressor_tag *)(param_2 + 1);
    uVar47 = uVar47 | (ulong)*param_2 << (bVar16 & 0x3f);
    goto LAB_001051cf;case 0x20:
    if (param_2 < ptVar13) {
      ptVar42 = (tinfl_decompressor_tag *)(param_2 + 1);
      uVar43 = 0;
      uVar47 = uVar47 | (ulong)*param_2 << (bVar16 & 0x3f);
    ...
    uVar43 = 0;
    goto LAB_00105d0b;case 0x22:
    uVar43 = 0;
    uVar14 = 0;
    goto LAB_00105829;case 0x23:
    uVar43 = 0;
    uVar14 = 0;
LAB_00105967:
    uVar20 = 0x23;
...
LAB_0010597c:
    *(undefined4 *)param_1 = 0x28;
    ...
    uVar43 = 0;
    goto LAB_00105e50;case 0x33:
    if (ptVar13 <= param_2) goto LAB_00105df1;
    ptVar42 = (tinfl_decompressor_tag *)(param_2 + 1);
    uVar47 = uVar47 | (ulong)*param_2 << (bVar16 & 0x3f);
    goto LAB_00105344;case 0x34:
    puVar21 = param_5;
    goto LAB_00104e64;case 0x35:
    if (param_5 < puVar2) goto LAB_00105904;
LAB_00105944:
    uVar43 = (long)puVar44 - (long)param_5;
...
LAB_00105a22:
  uVar24 = uVar25;
  if ((int)uVar40 == 0) goto LAB_00105a2b;
LAB_0010587f:
  if (puVar2 <= puVar44) {
...
LAB_0010588d:
  if (ptVar13 <= ptVar42) {
    uVar43 = (long)puVar44 - (long)param_5;
    uVar14 = (long)ptVar42 - (long)param_2;
    if ((param_7 & 2) == 0) goto LAB_0010597c;
...
LAB_00106c22:
  ...
  if (param_2 == 1) {
    ...
    local_74 = param_2;
    if (((param_2 & 0xfffffffdU) != 0) && (param_2 != 4)) goto LAB_00106c22;
  }
...
LAB_00106c38:
      ...
      if (local_74 != 4) goto LAB_00106c22;
      *(uint *)(ptVar3 + 0x2b04) = *(uint *)(ptVar3 + 0x2b04) | 1;
      uVar10 = local_60;
      if (iVar4 != 0) goto LAB_00106ad0;
    }
    local_60 = uVar10;
      ...
      do {
        while( true ) {
          ...
          *(uint *)(ptVar3 + 11000) = uVar10;
          if (iVar4 < 0) goto LAB_00106c18;
          if ((iVar4 == 1) && (iVar8 == 0)) goto LAB_00106c38;
          if (local_74 != 4) break;
          if (iVar4 == 0) {
            if (iVar7 == 0) goto LAB_00106b54;
            goto LAB_00106c38;
          }
          if (*(int *)(param_1 + 0x20) == 0) goto LAB_00106c38;
          uVar10 = *(uint *)(param_1 + 8);
        }
...
LAB_00107ea6:
    if (param_5 == (long *)0x0) goto LAB_00107eb2;
  }
  else {
    uVar28 = *param_3;
...
LAB_0010726e:
    if ((param_5 == (long *)0x0) || ((*param_5 == 0 || (param_4 != 0)))) {
      *(uint *)(param_1 + 0x80) = uVar27 | param_6 == 4;
      if ((*(int *)(param_1 + 0x74) != 0) || (*(int *)(param_1 + 0x78) != 0)) goto LAB_00107740;
              ...
              do {
                ...
                if (uVar20 < 0x101) {
                  ...
                  if ((uVar21 & 4) == 0) {
                    if (uVar21 != 0) {
                      *ptVar12 = *ptVar18;
                      if ((uVar21 & 2) == 0) goto LAB_001083a0;
...
LAB_001083a0:
            ...
            if ((iVar14 == 0) && (uVar13 < 0x1000)) goto LAB_001084dc;
          }
          if (3 < uVar13) {
LAB_00107fda:
            do {
...
LAB_001081f3:
                    ...
                    if ((uVar9 < 3) || ((uVar9 == 3 && (0x1fff < uVar20)))) goto LAB_0010803a;
                    goto LAB_00108220;
                  }
                  ...
                  ptVar22 = ptVar22 + 8;
                  ptVar12 = ptVar12 + 8;
                  if (*(short *)ptVar22 != *(short *)ptVar12) goto LAB_001081f3;
                  local_5c = local_5c + -1;
                } while (local_5c != 0);
                if (uVar20 == 0) goto LAB_0010803a;
                uVar9 = 0x102;
LAB_00108220:
                uVar20 = uVar20 - 1;
                if (uVar13 <= uVar9) {
...
LAB_001072d5:
      if (uVar28 != 0) goto LAB_001075f5;
LAB_001072e0:
      if ((param_6 != 0) && (uVar13 = *(uint *)(param_1 + 0x28), uVar13 != 0)) {
        uVar15 = *(uint *)(param_1 + 0x2c);
        ptVar16 = ptVar17;
        if (uVar15 + uVar13 < 2) goto LAB_001076cd;
LAB_00107309:
...
LAB_00107912:
                ...
                do {
                  while( true ) {
                    ...
                    if (uVar5 == 0) goto joined_r0x00107b95;
                    uVar21 = uVar20 - uVar5 & 0xffff;
                    if (uVar15 < uVar21) goto joined_r0x00107b95;
                    uVar9 = uVar5 & 0x7fff;
                    uVar11 = (ulong)uVar9;
                    iVar25 = uVar26 - 1;
...
LAB_001079f5:
                    iVar7 = iVar7 + -1;
                    if (iVar7 == 0) goto joined_r0x00107b95;
                  }
                  if (uVar21 == 0) break;
                  ptVar12 = param_1 + uVar11 + 200;
                  ptVar18 = ptVar16;
                  if (*(short *)ptVar16 != *(short *)ptVar12) goto LAB_001079f5;
                  while (*(short *)(ptVar18 + 2) == *(short *)(ptVar12 + 2)) {
                    ...
                    ptVar18 = ptVar18 + 8;
                    ptVar12 = ptVar12 + 8;
                    if (*(short *)ptVar18 != *(short *)ptVar12) goto LAB_00107a99;
...
LAB_00107a99:
                  ...
                  if (uVar9 <= uVar26) goto LAB_001079f5;
                  uVar26 = uVar13;
                  if (uVar9 <= uVar13) {
                    uVar26 = uVar9;
                  }
...
joined_r0x00107b95:
                if (uVar26 != 3) {
LAB_00107ba0:
                  if (local_80 == uVar6) goto LAB_001077b0;
                  goto LAB_0010744c;
                }
                if (local_80 < 0x2000) {
LAB_00107b1a:
                  if (local_80 != uVar6) goto LAB_0010779b;
                }
LAB_001077b0:
                ptVar16 = *(tdefl_compressor **)(param_1 + 0x30);
                if (uVar24 != 0) goto LAB_00107833;
              }
              else {
...
LAB_00107435:
                if (uVar6 != 0) {
                  ...
                  uVar26 = 2;
LAB_0010744c:
                  if (((uVar27 & 0x20000) == 0) || (5 < uVar26)) goto LAB_0010745e;
                  goto LAB_001077b0;
                }
                ptVar16 = *(tdefl_compressor **)(param_1 + 0x30);
              }
              ...
              *(short *)(param_1 + (ulong)(byte)tVar2 * 2 + 0x81ca) =
              ...
              if ((uVar27 & 0x90000) == 0) {
                if (uVar24 < uVar13) {
                  ...
                  if (iVar7 != 0) goto LAB_00107912;
                  goto LAB_00107781;
                }
LAB_00107810:
                if (uVar24 != 3) goto LAB_00107da0;
...
LAB_0010745e:
                ptVar16 = *(tdefl_compressor **)(param_1 + 0x30);
                if (uVar24 == 0) {
                  if (local_80 == 0) goto LAB_001077b8;
                  ...
                  if (uVar26 <= uVar24) goto LAB_00107833;
                  *(int *)(param_1 + 0x54) = *(int *)(param_1 + 0x54) + 1;
                  *(tdefl_compressor **)(param_1 + 0x30) = ptVar16 + 1;
                ...
                if (uVar15 == 0) goto LAB_00107810;
                if ((uVar27 & 0x80000) == 0) goto LAB_00107e10;
LAB_00107781:
                if (uVar24 == 3) {
                  if (uVar6 == 0) goto LAB_0010782f;
                  local_80 = 0;
LAB_0010779b:
                  if ((uVar27 & 0x20000) != 0) goto LAB_001077b0;
                  goto LAB_00107e94;
                }
LAB_00107da0:
                if (uVar6 != 0) {
...
LAB_001075c8:
              ...
              *(ulong *)(param_1 + 0xb8) = uVar28;
              ...
              if ((*(uint *)(param_1 + 0x54) <=
                 ...
                 (uVar27 = *(uint *)(param_1 + 0x10), (uVar27 & 0x80000) != 0)) goto LAB_001075c8;
              goto LAB_001072d5;
            }
            uVar27 = *(uint *)(param_1 + 0x10);
            if (uVar28 == 0) goto LAB_001072e0;
LAB_001075f5:
            uVar13 = *(uint *)(param_1 + 0x28);
            uVar15 = *(uint *)(param_1 + 0x2c);
            uVar24 = uVar13 + uVar15;
            ptVar16 = ptVar17;
            if (1 < uVar24) goto LAB_00107309;
            iVar7 = (int)ptVar17;
            while (uVar13 < 0x102) {
...
LAB_001086e9:
      ...
      do {
        ...
        *(long *)(param_1 + 0x28) = lVar7;
        if (iVar3 < 0) goto LAB_00108810;
        if (iVar3 == 1) goto LAB_00108805;
        if (uVar4 == 0) goto LAB_001087c0;
  ...
  if (__ptr != (tdefl_compressor *)0x0) {
    ...
    if (iVar14 == 1) {
      ...
      *(ulong *)(local_88._0_8_ + 0x21) = CONCAT44(0x54414449,uStack_57);
      iVar14 = tdefl_output_buffer_putter(&DAT_0011f518,0x10,local_98);
      if (iVar14 != 0) {
...
LAB_00109fa1:
      bVar1 = this[2];
joined_r0x0010a1c6:
      if (bVar1 == (basis_compressor)0x0) goto LAB_00109fac;
      goto LAB_0010a1cc;
    }
    iVar4 = *(int *)(this + 0x20);
...
LAB_0010a0e7:
            iVar3 = (int)lVar6;
            if (iVar3 <= iVar4) goto LAB_0010a0f0;
            local_68 = (long *)&local_58;
            std::__cxx11::string::_M_construct<char*>
                      ((string *)&local_68,local_a8,local_a8 + local_a0);
            if (iVar3 == -2) {
...
LAB_0010a1cc:
  ...
  if (iVar4 != 0) {
    ...
    if (this[2] == (basis_compressor)0x0) goto LAB_00109fac;
  }
  ...
  if (*(int *)(this + 0x154) != 0) {
    ...
    if ((*(int *)(this + 0x154) != 2) ||
      ...
      do {
        ...
        if (uVar4 <= (uint)uVar2) {
          if ((uint)local_30 < 2) goto LAB_0010af88;
          uVar2 = 1;
          goto LAB_0010aefd;
        }
    ...
    do {
      ...
      do {
        ...
        if (0.0 <= fVar12) {
          ...
          if (fVar13 < 0.0) goto LAB_0010beb6;
LAB_0010bd58:
          fVar12 = _LC8;
          if (fVar13 <= _LC8) {
            fVar12 = fVar13;
          }
          if (fVar11 < 0.0) goto LAB_0010bec3;
LAB_0010bd70:
          fVar13 = _LC8;
          if (fVar11 <= _LC8) {
            fVar13 = fVar11;
          ...
          fVar14 = 0.0;
          if (0.0 <= fVar13) goto LAB_0010bd58;
LAB_0010beb6:
          fVar12 = 0.0;
          if (0.0 <= fVar11) goto LAB_0010bd70;
LAB_0010bec3:
          fVar13 = 0.0;
        }
  ...
  local_70 = 0;
  do {
    fVar12 = powf(_LC136,(float)iVar6);
...
LAB_0010c23a:
    ...
    if (uVar8 < 2) {
      if (local_38 == (int *)0x0) goto LAB_0010c2bc;
    }
    else {
      piVar4 = local_38 + 1;
      do {
...
LAB_0010db40:
          ...
          if ((uint)local_80 == 0) {
            if (*(int *)(this + 0x30) != 0) goto LAB_0010db32;
...
LAB_00110bcf:
          ...
          if ((0x3fffffffffffffffU - local_c0 < 0xc) ||
             (std::__cxx11::string::_M_append((char *)&local_c8,0x11aeac),
             0x3fffffffffffffffU - local_c0 < uVar24)) goto LAB_00110bcf;
          std::__cxx11::string::_M_append((char *)&local_c8,(ulong)puVar12);
          uVar24 = local_c0 + local_a0;
          uVar19 = local_98[0];
          if (local_c8 == &local_b8) {
            if ((0xf < uVar24) && (local_a8 != local_98)) goto LAB_0010e03f;
LAB_0010e04b:
            if (0x3fffffffffffffffU - local_c0 < local_a0) goto LAB_00110bcf;
            puVar10 = (undefined8 *)
            ...
            *(undefined1 *)(puVar10 + 2) = 0;
            ...
            if (uVar24 <= CONCAT71(uStack_b7,local_b8)) goto LAB_0010e04b;
            if (local_a8 == local_98) {
              uVar19 = 0xf;
            }
LAB_0010e03f:
            if (uVar19 < uVar24) goto LAB_0010e04b;
            puVar10 = (undefined8 *)
          ...
          *(undefined1 *)local_68 = 0;
          ...
          if (this[0x90] != (basis_compressor)0x0) {
            ...
            if ((0x3fffffffffffffffU - local_80 < uVar24) ||
               ...
               0x3fffffffffffffffU - local_80 < 0x1d)) goto LAB_00110bcf;
            std::__cxx11::string::_M_append((char *)&local_88,0x11b065);
            ...
            if (piVar26 != (image *)&local_2b8) {
              ...
              if (((image *)&uStack_2a8 != piVar26 + 0x10) &&
                ...
                if ((void *)CONCAT44(uStack_2a4,uStack_2a8) != (void *)0x0) {
                  ...
                  if (*(void **)(piVar26 + 0x10) == (void *)0x0) goto LAB_0010f7ea;
            ...
            if (puVar22[1] != 0) {
              ...
              if (piVar26 != (image *)&local_2b8) {
                ...
                if (((image *)&uStack_2a8 != piVar26 + 0x10) &&
                  ...
                  if ((void *)CONCAT44(uStack_2a4,uStack_2a8) != (void *)0x0) {
                    uVar13 = *(uint *)(piVar26 + 0x18);
                    if (*(void **)(piVar26 + 0x10) == (void *)0x0) goto LAB_0010fa03;
                    memcpy((void *)CONCAT44(uStack_2a4,uStack_2a8),*(void **)(piVar26 + 0x10),
                           (ulong)*(uint *)(piVar26 + 0x18) << 2);
                  }
                  uVar13 = *(uint *)(piVar26 + 0x18);
        ...
        do {
          ...
          if (this[0x90] != (basis_compressor)0x0) {
            ...
            if ((0x3fffffffffffffffU - local_220 < 0xc) ||
               (std::__cxx11::string::_M_append((char *)&local_228,0x11aeac),
               0x3fffffffffffffffU - local_220 < uVar27)) goto LAB_00110bcf;
            std::__cxx11::string::_M_append((char *)&local_228,(ulong)puVar12);
            uVar27 = local_220 + local_200;
            uVar24 = local_1f8[0];
            if (local_228 == &local_218) {
              if ((0xf < uVar27) && (local_208 != local_1f8)) goto LAB_0010e9ef;
LAB_0010e9fb:
              if (0x3fffffffffffffffU - local_220 < local_200) goto LAB_00110bcf;
              puVar10 = (undefined8 *)
...
LAB_0010ea3c:
              ...
              if (uVar27 <= CONCAT71(uStack_217,local_218)) goto LAB_0010e9fb;
              if (local_208 == local_1f8) {
                uVar24 = 0xf;
              }
LAB_0010e9ef:
              if (uVar24 < uVar27) goto LAB_0010e9fb;
              puVar10 = (undefined8 *)
                        std::__cxx11::string::_M_replace
              ...
              puVar14 = (ulong *)*puVar10;
              puVar12 = puVar10 + 2;
              if (puVar14 != puVar12) goto LAB_0010ea3c;
              uVar27 = puVar10[1] + 1;
              puVar17 = puVar12;
              puVar14 = local_68;
              if (7 < (uint)uVar27) {
...
LAB_0010ead8:
            ...
            *(undefined1 *)local_68 = 0;
            ...
            if ((0x3fffffffffffffffU - local_1e0 < uVar27) ||
               ...
               0x3fffffffffffffffU - local_1e0 < 9)) goto LAB_00110bcf;
            std::__cxx11::string::_M_append((char *)&local_1e8,0x11aeb9);
            ...
            if ((0x3fffffffffffffffU - local_1c0 < uVar27) ||
               ...
               0x3fffffffffffffffU - local_1c0 < 10)) goto LAB_00110bcf;
            std::__cxx11::string::_M_append((char *)&local_1c8,0x11aed7);
            ...
            if ((0x3fffffffffffffffU - local_1a0 < uVar27) ||
               ...
               0x3fffffffffffffffU - local_1a0 < 9)) goto LAB_00110bcf;
            std::__cxx11::string::_M_append((char *)&local_1a8,0x11aef7);
            ...
            if ((0x3fffffffffffffffU - local_180 < uVar27) ||
               ...
               0x3fffffffffffffffU - local_180 < 0x12)) goto LAB_00110bcf;
            std::__cxx11::string::_M_append((char *)&local_188,0x11af15);
            ...
            if ((0x3fffffffffffffffU - local_160 < uVar27) ||
               ...
               0x3fffffffffffffffU - local_160 < 0x12)) goto LAB_00110bcf;
            std::__cxx11::string::_M_append((char *)&local_168,0x11af3c);
            ...
            if ((0x3fffffffffffffffU - local_140 < uVar27) ||
               ...
               0x3fffffffffffffffU - local_140 < 7)) goto LAB_00110bcf;
            std::__cxx11::string::_M_append((char *)&local_148,0x11af4f);
            ...
            if ((0x3fffffffffffffffU - local_120 < uVar27) ||
               ...
               0x3fffffffffffffffU - local_120 < 0xe)) goto LAB_00110bcf;
            std::__cxx11::string::_M_append((char *)&local_128,0x11af57);
            ...
            if ((0x3fffffffffffffffU - local_100 < uVar27) ||
               ...
               0x3fffffffffffffffU - local_100 < 0xe)) goto LAB_00110bcf;
            std::__cxx11::string::_M_append((char *)&local_108,0x11af66);
        ...
        *(undefined4 *)(puVar3 + 1) = *(undefined4 *)(puVar5 + 1);
        if (puVar3 + 2 != puVar5 + 2) {
          ...
          if (uVar6 != 0) {
            ...
            if ((void *)puVar3[2] != (void *)0x0) {
              uVar6 = *(uint *)(puVar5 + 3);
              if ((void *)puVar5[2] == (void *)0x0) goto LAB_0011118e;
    ...
    *(uint *)(this + 0x310) = uVar16;
    basisu::debug_printf
              ("Total .basis output file size: %u, %3.3f bits/texel\n",(double)(fVar21 / fVar23),
               (ulong)uVar16);
    if (this[0x2c4] == (basis_compressor)0x0) goto LAB_0011137c;
...
LAB_001130d0:
              ...
              if (this[2] != (basis_compressor)0x0) goto LAB_001121b8;
            }
            if (((uint)uVar36 < *(uint *)(this + 0x20)) &&
              ...
              bVar30 = this[2];
              goto joined_r0x001121d2;
            }
LAB_00112847:
            if (this[0xea] != (basis_compressor)0x0) goto LAB_00112afc;
            goto LAB_00112855;
          }
          uVar31 = (uint)local_a8;
          uVar32 = local_a8._4_4_;
          if (this[0x8a] != (basis_compressor)0x0) goto LAB_001130d0;
LAB_001121b8:
          clean_hdr_image(this,(imagef *)&local_a8);
          bVar30 = this[2];
joined_r0x001121d2:
          if (bVar30 == (basis_compressor)0x0) goto LAB_00112847;
...
LAB_00112855:
      if (*(short *)(this + 0xe6) != 0x100) goto LAB_00112865;
      bVar30 = this[2];
LAB_0011300b:
      if (*(short *)(this + 0xe8) != 0x302) goto LAB_00112b1e;
      if (bVar30 == (basis_compressor)0x0) {
        if (this[0xe2] != (basis_compressor)0x0) goto LAB_001122a7;
        goto LAB_00113031;
      }
    }
    else {
LAB_00112afc:
      ...
      bVar30 = this[2];
      if (*(short *)(this + 0xe6) == 0x100) goto LAB_0011300b;
LAB_00112b1e:
      if (bVar30 == (basis_compressor)0x0) {
LAB_00112865:
        uVar31 = 0;
...
LAB_001121e8:
        fVar61 = _LC8;
        uVar52 = (ulong)local_a8 & 0xffffffff;
        if (local_a8._4_4_ == 0) goto LAB_001122c4;
        uVar28 = 0;
        iVar25 = 0;
        do {
          iVar40 = (int)uVar28;
    ...
    if (((int)uVar31 < 1) || (uVar32 = *(uint *)(this + 0x1fc), (int)uVar32 < 1)) {
      ...
      if (0.0 < fVar59) {
        if (this[2] != (basis_compressor)0x0) {
          ...
          local_78 = (void *)0x0;
          local_70 = 0;
          local_68 = (undefined4 **)CONCAT44(_UNK_00122524,__LC98);
          uStack_60 = (undefined4 *)CONCAT44(_UNK_0012252c,_UNK_00122528);
...
LAB_0011251c:
    ...
    if (puVar17 < (undefined4 *)0x10) {
      ...
      else if (puVar17 != (undefined4 *)0x0) goto LAB_00112a75;
    }
    else {
...
LAB_00112a75:
  ...
  if (this[2] == (basis_compressor)0x0) {
    if (*(uint *)(this + 0x50) == 0) goto LAB_00113480;
...
LAB_001136c2:
            if (this[2] == (basis_compressor)0x0) goto LAB_001147a6;
          }
        }
        else {
          lVar56 = 0;
...
LAB_00114b60:
              ...
              if ((image *)&local_98 == piVar54 + 0x10) goto LAB_00114b60;
...
LAB_0011452d:
        ...
        if (this[2] != (basis_compressor)0x0) goto LAB_00114729;
      }
      local_1d0 = 0;
      if ((uint)local_100 != 0) {
LAB_00113820:
...
LAB_00113a51:
        do {
          ...
          if (this[2] == (basis_compressor)0x0) {
            ...
            uVar28 = (ulong)uVar31;
            if (uVar45 != 0xffffffff) goto LAB_00113add;
LAB_001141c2:
            vector<basisu::image>::resize
...
LAB_00113add:
          ...
          *(uint *)(this + 0x330) = *(int *)(this + 0x330) + uVar31 * uVar45;
          ...
          if (bVar4 == (basis_compressor)0x0) goto LAB_00114078;
          ...
          if ((local_190 != 0) && (iVar25 != 0)) {
            ...
            if (local_1bc < uVar31) {
              if (uVar32 != 0) {
                ...
                if (uVar45 < uVar32) goto LAB_0011428a;
              }
            }
...
LAB_001140df:
    ...
    if (uVar45 < 2) {
      if (this[0x8a] != (basis_compressor)0x0) goto LAB_00114f71;
LAB_00114f8b:
      if (uVar45 != 0) {
...
LAB_00114c80:
      ...
      while( true ) {
        ...
        if (this[0x828] == (basis_compressor)0x0) {
          if (*(char *)(puVar17 + 0xb) != '\0') goto LAB_00113351;
        }
        else {
          if (this[2] != (basis_compressor)0x0) goto LAB_00113351;
          if (*this == (basis_compressor)0x0) {
            if (*(char *)(puVar17 + 0xb) == '\0') {
              if ((uVar52 & 1) != 0) goto LAB_00113351;
            }
            else if ((((((uVar52 & 1) == 0) ||
                    ...
                    (*(int *)(lVar56 + 0x18) != puVar17[6])) goto LAB_00113351;
          }
        }
...
LAB_00114078:
  ...
  *(undefined4 *)(piVar54 + 0x1c) = uVar60;
  if ((uint)local_100 <= uVar45) goto LAB_001140df;
  goto LAB_00113820;
}
...
LAB_00116901:
        ...
        lVar3 = (long)param_2 - (long)param_1;
        if (lVar3 < 0x201) goto LAB_00116ad2;
        pkVar9 = param_2;
      } while (local_a0 != 0);
    }
...
LAB_00117159:
              ...
              if (*(uint *)(this + 0x328) <= (uint)lVar21) goto LAB_0011721a;
            }
            puVar16 = (undefined8 *)(lVar21 * 0x10 + *(long *)(this + 0x808));
            uVar32 = *(uint *)(puVar16 + 1);
            if (uVar32 != 0) goto LAB_00117159;
LAB_00117106:
            lVar21 = lVar21 + 1;
        ...
        if (*(int *)(this + 0x328) != 0) {
          do {
            ...
            if (*(int *)(this + 0x154) == 2) {
              ...
              if (*(char *)(lVar13 + 0x2c) != '\0') goto LAB_00117e48;
              lVar9 = uVar27 * 0x14;
LAB_00117da9:
...
LAB_0011740a:
        ...
        if ((uint)local_180 != 0xffffffff) goto LAB_0011740a;
...
LAB_00117647:
      ...
      if ((char)local_ec == '\0') {
        ...
        if (uVar4 == 0) goto LAB_00118291;
        if (local_208 != 1) goto LAB_00117994;
LAB_001177f0:
        uVar22 = 0;
      }
      else {
LAB_00118291:
        ...
        if (*(void **)(this + 0x798) == (void *)0x0) {
          ...
          if (*(uint *)(this + 0x7a4) < uVar20) goto LAB_00118340;
...

{
  ...
  return 2;}/* basisu::basis_parallel_compress(unsigned int, basisu::vector<basisu::basis_compressor_params>
...
::{lambda()#1{
   ...
   local_b50 = (ulong*)0x0;
   local_b48 = 0;
   basisu::elemental_vector::increase_capacity(( uint ) & local_b50, SUB41(*(undefined4*)( puVar24 + 8 ), 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x20, true);
      ...
      do {
         while (true) {
            ...
            *puVar19 = (ulong)puVar16;
            ...
            LAB_00118b6d:memcpy(puVar16, puVar4, uVar17);
            puVar19[1] = local_c38[0];
            *(undefined1*)( *puVar19 + local_c38[0] ) = 0;
            puVar19 = puVar19 + 4;
            if (puVar18 == puVar22) goto LAB_00118b8f;
         }
;
         if (uVar17 == 1) {
            *(undefined1*)( puVar19 + 2 ) = *puVar4;
         }
 else if (uVar17 != 0) goto LAB_00118b6d;
         puVar19[1] = uVar17;
 ...
 while ( puVar18 != puVar22 );
   ...
   LAB_00118b8f:local_c48 = (interval_timer*)local_c38;
   local_b40 = (ulong*)0x0;
   local_b38 = 0;
   basisu::elemental_vector::increase_capacity(( uint ) & local_b40, SUB41(*(undefined4*)( puVar24 + 0x10 ), 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x20, true);
   ...
   if (uVar2 != 0) {
      do {
         while (true) {
            ...
            *puVar19 = (ulong)puVar16;
            puVar19[2] = local_c38[0];
            LAB_00118c6b:memcpy(puVar16, puVar4, uVar17);
            puVar19[1] = local_c38[0];
            *(undefined1*)( *puVar19 + local_c38[0] ) = 0;
            puVar19 = puVar19 + 4;
            if (puVar18 == puVar22) goto LAB_00118c8d;
         }
;
         if (uVar17 == 1) {
            *(undefined1*)( puVar19 + 2 ) = *puVar4;
         }
 else if (uVar17 != 0) goto LAB_00118c6b;
         puVar19[1] = uVar17;
         *(undefined1*)( (long)puVar16 + uVar17 ) = 0;
         puVar19 = puVar19 + 4;
      }
 while ( puVar18 != puVar22 );
   ...
   LAB_00118c8d:vector<basisu::image>::vector(local_b30, (vector*)( puVar24 + 0x14 ));
   vector<basisu::imagef>::vector(local_b20, (vector*)( puVar24 + 0x1c ));
   local_b10 = (vector<basisu::image>*)0x0;
   local_b08 = 0;
   basisu::elemental_vector::increase_capacity(( uint ) & local_b10, SUB41(*(undefined4*)( puVar24 + 0x28 ), 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x10, false);
 ...
 while ( pvVar20 != pvVar26 );
   ...
   local_af8 = 0;
   basisu::elemental_vector::increase_capacity(( uint ) & local_b00, SUB41(*(undefined4*)( puVar24 + 0x30 ), 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x10, false);
 ...
 while ( pvVar21 != pvVar27 );
   ...
   std::__cxx11::string::_M_construct<char*>(local_af0, *(long*)( puVar24 + 0x34 ), *(long*)( puVar24 + 0x38 ) + *(long*)( puVar24 + 0x34 ));
   ...
   std::__cxx11::string::_M_construct<char*>(local_a50, *(long*)( puVar24 + 0x84 ), *(long*)( puVar24 + 0x88 ) + *(long*)( puVar24 + 0x84 ));
   ...
   local_918 = 0;
   basisu::elemental_vector::increase_capacity(( uint ) & local_920, SUB41(*(undefined4*)( puVar24 + 0x120 ), 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x20, true);
   ...
   if (iVar15 != 0) {
      ...
      do {
         *puVar22 = 0;
         ...
         puVar22[1] = 0;
         basisu::elemental_vector::increase_capacity((uint)puVar22, SUB41(uVar3, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
         ...
         *(uint*)( puVar22 + 1 ) = uVar2;
         ...
         puVar22[2] = 0;
         puVar22[3] = 0;
         basisu::elemental_vector::increase_capacity((uint)puVar22 + 0x10, SUB41(*(undefined4*)( puVar18 + 3 ), 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
 ...
 while ( puVar23 != puVar22 );
   ...
   if (cVar14 == '\0') {
      ...
      **(undefined1**)( this + 0x18 ) = 0;
      ...
      if (( cVar14 == '\0' ) || ( cVar14 = basis_compressor::read_source_images(local_878) ),cVar14 == '\0') {
         if (local_4f != '\0') {
            LOCK();
            **(undefined1**)( this + 0x20 ) = 1;
            UNLOCK();
 ...
 while ( puVar18 != puVar22 );
                  ...
                  basisu::elemental_vector::increase_capacity((uint)this_00, SUB41(local_570, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x70, true);
               }
 else {
 ...
 while ( plVar29 != local_578 + uVar17 * 0xe );
   ...
   LAB_0011965d:uVar31 = basisu::interval_timer::get_elapsed_secs();
   *puVar23 = uVar31;
...
/* std::_Function_handler<void (), basisu::basis_parallel_compress(unsigned int,
   basisu::vector<basisu::basis_compressor_params> const&,
   basisu::vector<basisu::parallel_results>&)::{lambda()#1}>::_M_invoke(std::_Any_data const&) */void std::_Function_handler<void(),basisu::basis_parallel_compress(unsigned_int,basisu::vector<basisu::basis_compressor_params>const&,basisu::vector<basisu::parallel_results>&)::{lambda()#1}>
     ::_M_invoke(_Any_data *param_1)

{
  basisu::
  basis_parallel_compress(unsigned_int,basisu::vector<basisu::basis_compressor_params>const&,basisu::vector<basisu::parallel_results>&)
  ::{lambda()#1}::operator () = (*(_lambda___1_**)param_1)return;}/* basisu::basis_compress(basisu::vector<basisu::image> const*, basisu::vector<basisu::imagef>
   const*, unsigned int, float, unsigned long*, basisu::image_stats*) */void *basisu::basis_compress(vector *param_1, vector *param_2, uint param_3, float param_4, ulong *param_5, image_stats *param_6) {
   undefined4 uVar1;
   image_stats iVar2;
   int iVar3;
   undefined4 uVar4;
         ...
         *(undefined4*)( local_b20[0] + 1 ) = *(undefined4*)( puVar19 + 1 );
         if (local_b20[0] + 2 != puVar19 + 2) {
            ...
            if (*(uint*)( (long)local_b20[0] + 0x1c ) < uVar8) {
               ...
               basisu::elemental_vector::increase_capacity(( uint )(local_b20[0] + 2), SUB41(uVar8, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x10, true);
               uVar8 = *(uint*)( puVar19 + 3 );
               pvVar10 = (void*)local_b20[0][2];
            }
      ...
      if (1 < uVar8) {
         if (local_af8 != 1) {
            if (local_af8 < 2) {
               uVar8 = 0;
               if (local_af4 == 0) {
                  basisu::elemental_vector::increase_capacity(( uint ) & local_b00, true, 1, (_func_void_void_ptr_void_ptr_uint*)0x10, false);
                  uVar8 = local_af8;
               }
         ...
         *(undefined4*)( local_b30[0] + 1 ) = *(undefined4*)( puVar19 + 1 );
         if (local_b30[0] + 2 != puVar19 + 2) {
            ...
            if (*(uint*)( (long)local_b30[0] + 0x1c ) < uVar8) {
               ...
               basisu::elemental_vector::increase_capacity(( uint )(local_b30[0] + 2), SUB41(uVar8, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x4, false);
               pvVar10 = (void*)local_b30[0][2];
               uVar8 = *(uint*)( puVar19 + 3 );
            }
      ...
      if (1 < uVar8) {
         if (local_b08 != 1) {
            if (local_b08 < 2) {
               uVar8 = 0;
               if (local_b04 == 0) {
                  basisu::elemental_vector::increase_capacity(( uint ) & local_b10, true, 1, (_func_void_void_ptr_void_ptr_uint*)0x10, false);
                  uVar8 = local_b08;
               }
                  ...
                  *(undefined4*)( puVar16 + 1 ) = *(undefined4*)( puVar19 + 1 );
                  if (puVar16 + 2 != puVar19 + 2) {
                     ...
                     if (*(uint*)( (long)puVar16 + 0x1c ) < uVar8) {
                        ...
                        basisu::elemental_vector::increase_capacity(( uint )(puVar16 + 2), SUB41(uVar8, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x4, false);
                        uVar8 = *(uint*)( puVar19 + 3 );
                        pvVar10 = (void*)puVar16[2];
                     }
 ...
 while ( iVar3 + 2U < *(uint*)( param_1 + 8 ) );
   ...
   if (( param_2 == (vector*)0x0 ) && ( ( param_3 & 0x200000 ) == 0 )) {
      ...
      if (bVar20) {
         ...
         if (( local_9e4 <= param_4 ) && ( local_9e4 = param_4 <= local_9e0 )) {
            local_9e4 = param_4;
         }
   ...
   if (cVar7 == '\0') {
               ...
               *param_5 = __size;
               if (( param_6 != (image_stats*)0x0 ) && ( local_570 != 0 )) {
                  ...
                  *(undefined4*)( param_6 + 0x2c ) = uVar1;
                  for (int i = 0; i < 12; i++) {
                     *(undefined4*)( param_6 + ( 4*i + 48 ) ) = *(undefined4*)( local_578 + ( 4*i + 48 ) );
                  }
      ...
      pvVar10 = (void*)0x0;
      basisu::error_printf("basis_compress: basis_compressor::process() failed with error code %u\n", (ulong)uVar8);
   }

   LAB_00119bd4:basis_compressor::~basis_compressor(local_878);
   basis_compressor_params::~basis_compressor_params((basis_compressor_params*)&local_b58);
   basisu::job_pool::~job_pool(local_c18);
   LAB_00119bef:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* basisu::basis_compress(basisu::vector<basisu::image> const&, unsigned int, float, unsigned long*,
   basisu::image_stats*) */void basisu::basis_compress(vector *param_1, uint param_2, float param_3, ulong *param_4, image_stats *param_5) {
...
/* basisu::basis_compress(unsigned char const*, unsigned int, unsigned int, unsigned int, unsigned
   int, float, unsigned long*, basisu::image_stats*) */undefined8 basisu::basis_compress(uchar *param_1, uint param_2, uint param_3, uint param_4, uint param_5, float param_6, ulong *param_7, image_stats *param_8) {
   image *piVar1;
   ulong uVar2;
   undefined8 uVar3;
   image *piVar4;
   ...
   if (( ( ( param_1 == (uchar*)0x0 ) || ( param_2 == 0 ) ) || ( param_3 == 0 || param_4 < param_2 ) ) || ( param_7 == (ulong*)0x0 )) {
      basisu::error_printf("basis_compress: Invalid parameter\n");
   }
 else {
      *param_7 = 0;
      if (( param_2 < 0x4001 ) && ( param_3 < 0x4001 )) {
         local_58 = (image*)0x0;
         local_50 = 0;
         basisu::elemental_vector::increase_capacity((uint)(vector*)&local_58, true, 1, (_func_void_void_ptr_void_ptr_uint*)0x20, true);
         ...
         do {
            ...
            uVar2 = (ulong)uVar5;
            uVar5 = uVar5 + param_4;
            memcpy((void*)( *(long*)( local_58 + 0x10 ) + uVar6 * 4 ), param_1 + uVar2 * 4, (ulong)param_2 * 4);
 ...
 while ( uVar8 < param_3 );
   ...
   uVar3 = 0;
   LAB_0011a564:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* basisu::basis_benchmark_etc1s_opencl(bool*) */ulong basisu::basis_benchmark_etc1s_opencl(bool *param_1) {
   undefined4 *puVar1;
   uint *puVar2;
   undefined8 uVar3;
   undefined1 *puVar4;
   ...
   if (( ( *local_1468 != 0x400 ) || ( local_1468[1] != 0x400 ) ) || ( local_1468[2] != 0x400 )) {
      ...
      basisu::elemental_vector::increase_capacity(uVar5 + 0x10, false, 0, (_func_void_void_ptr_void_ptr_uint*)0x4, false);
      puVar2[6] = 0x100000;
      if (*(long*)puVar2 == 0) {
 ...
 while ( puVar1 + 0x100000 != puVar14 );
         ...
         do {
            uVar7 = 0;
            do {
               while (( puVar1 = (undefined4*)( *(long*)( puVar2 + 4 ) + ( ulong )(iVar21 + uVar7) * 4 ) * puVar2 <= uVar7 || ( puVar2[1] <= uVar6 ) )) {
                  uVar7 = uVar7 + 1;
                  *puVar1 = g_black_color;
                  if (uVar7 == 0x400) goto LAB_0011a998;
               }
;
 ...
 while ( lVar19 != 0x270 );
   iVar21 = 6000;
   do {
      uVar6 = std::uniform_int_distribution<int>::operator ()((uniform_int_distribution<int>*)&local_13c8, (mersenne_twister_engine*)0x0, (param_type*)0x3ff);
      uVar7 = std::uniform_int_distribution<int>::operator ()((uniform_int_distribution<int>*)&local_13c8, (mersenne_twister_engine*)0x0, (param_type*)0x3ff);
      uVar8 = std::uniform_int_distribution<int>::operator ()((uniform_int_distribution<int>*)&local_13c8, (mersenne_twister_engine*)0x1, (param_type*)0x4);
      uVar9 = std::uniform_int_distribution<int>::operator ()((uniform_int_distribution<int>*)&local_13c8, (mersenne_twister_engine*)0x1, (param_type*)0x4);
      iVar10 = std::uniform_int_distribution<int>::operator ()((uniform_int_distribution<int>*)&local_13c8, (mersenne_twister_engine*)0x80000000, (param_type*)0x7fffffff);
      iVar11 = std::uniform_int_distribution<int>::operator ()((uniform_int_distribution<int>*)&local_13c8, (mersenne_twister_engine*)0x80000000, (param_type*)0x7fffffff);
      iVar12 = std::uniform_int_distribution<int>::operator ()((uniform_int_distribution<int>*)&local_13c8, (mersenne_twister_engine*)0x80000000, (param_type*)0x7fffffff);
      puVar4 = local_1438;
      local_1438._4_4_ = SUB84(puVar4, 4);
      local_1438._0_4_ = CONCAT13(0xff, CONCAT12((char)iVar10, CONCAT11((char)iVar11, (char)iVar12)));
      iVar10 = std::uniform_int_distribution<int>::operator ()((uniform_int_distribution<int>*)&local_13c8, (mersenne_twister_engine*)0x20, (param_type*)0x7f);
      basisu::image::debug_text(uVar5, uVar6, uVar7, uVar8, (color_rgba*)(ulong)uVar9, (color_rgba*)&local_1438, false, (char*)0x0, &_LC349, (ulong)(uint)(int)(char)iVar10);
      iVar21 = iVar21 + -1;
   }
 while ( iVar21 != 0 );
   local_1430 = 0;
   ...
   while (true) {
      basisu::interval_timer::start();
      pvVar15 = (void*)basis_compress((vector*)&local_1468, (vector*)0x0, 0x22ff, _LC8, &local_1470, (image_stats*)&local_1438);
      dVar22 = (double)basisu::interval_timer::get_elapsed_secs();
...
;
   ...
   LAB_0011ab39:uVar16 = 0;
   LAB_0011aa94:if (local_1438 != &local_1428) {
   ...
   LAB_0011aaf4:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar16 & 0xffffffff;
   }

   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   LAB_0011a9fc:basisu::interval_timer::start();
   pvVar15 = (void*)basis_compress((vector*)&local_1468, (vector*)0x0, 0x23ff, _LC8, &local_1470, (image_stats*)&local_1438);
   if (local_13cc != '\0') goto LAB_0011ab40;
   dVar22 = (double)basisu::interval_timer::get_elapsed_secs();
   if (pvVar15 == (void*)0x0) {
      uVar16 = 0;
   ...
   iVar21 = 1;
   goto LAB_0011a9fc;
   LAB_0011ab40:basisu::error_printf("basis_benchmark_etc1s_opencl: OpenCL failed!\n");
   free(pvVar15);
   if (param_1 == (bool*)0x0) goto LAB_0011ab39;
   *param_1 = true;
   uVar16 = 0;
   goto LAB_0011aa94;
}
/* basisu::basis_compress(basisu::vector<basisu::imagef> const&, unsigned int, unsigned long*,
   basisu::image_stats*) */void basisu::basis_compress(vector *param_1, uint param_2, ulong *param_3, image_stats *param_4) {
   basis_compress((vector*)0x0, param_1, param_2, 0.0, param_3, param_4);
   return;
}
/* basisu::vector<basisu::vec<4u, float> >::object_mover(void*, void*, unsigned int) */void basisu::vector<basisu::vec<4u,float>>::object_mover(void *param_1, void *param_2, uint param_3) {
   undefined8 uVar1;
   void *pvVar2;
   long lVar3;
   ulong uVar4;
...
/* basisu::vector<basisu::pixel_block_hdr>::object_mover(void*, void*, unsigned int) */void basisu::vector<basisu::pixel_block_hdr>::object_mover(void *param_1, void *param_2, uint param_3) {
   undefined8 uVar1;
   long lVar2;
   void *pvVar3;
   void *pvVar4;
...
/* basisu::vector<basisu::imagef>::object_mover(void*, void*, unsigned int) */void basisu::vector<basisu::imagef>::object_mover(void *param_1, void *param_2, uint param_3) {
   uint uVar1;
   long lVar2;
   undefined8 uVar3;
   long lVar4;
         ...
         if (param_2 != param_1) {
            ...
            *(undefined4*)( (long)param_1 + 8 ) = *(undefined4*)( (long)param_2 + 8 );
            if ((undefined8*)( (long)param_1 + 0x10 ) == (undefined8*)( (long)param_2 + 0x10 )) {
               ...
               LAB_0011d43f:if (__ptr == (void*)0x0) goto LAB_0011d444;
            }
 else {
               if (*(int*)( (long)param_2 + 0x18 ) == 0) {
                  __ptr = *(void**)( (long)param_2 + 0x10 );
                  LAB_0011d438:*(undefined4*)( (long)param_1 + 0x18 ) = 0;
                  goto LAB_0011d43f;
               }

               basisu::elemental_vector::increase_capacity((uint)(undefined8*)( (long)param_1 + 0x10 ), SUB41(*(int*)( (long)param_2 + 0x18 ), 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x10, true);
               uVar1 = *(uint*)( (long)param_2 + 0x18 );
               lVar2 = *(long*)( (long)param_1 + 0x10 );
               __ptr = *(void**)( (long)param_2 + 0x10 );
               if (uVar1 == 0) goto LAB_0011d438;
               lVar4 = 0;
               do {
 ...
 while ( (ulong)uVar1 << 4 != lVar4 );
         ...
         LAB_0011d444:param_2 = (void*)( (long)param_2 + 0x20 );
...
/* basisu::vector<basisu::image>::object_mover(void*, void*, unsigned int) */void basisu::vector<basisu::image>::object_mover(void *param_1, void *param_2, uint param_3) {
   uint *puVar1;
   int iVar2;
   void *__ptr;
   undefined8 *puVar3;
      ...
      do {
         while (true) {
            ...
            *(undefined8*)( (long)param_1 + 0x18 ) = 0;
            ...
            LAB_0011d505:param_2 = (void*)( (long)param_2 + 0x20 );
            param_1 = (void*)( (long)param_1 + 0x20 );
...
;
         ...
         *(undefined4*)( (long)param_1 + 8 ) = *(undefined4*)( (long)param_2 + 8 );
         if ((undefined8*)( (long)param_1 + 0x10 ) == (undefined8*)( (long)param_2 + 0x10 )) {
            __ptr = *(void**)( (long)param_2 + 0x10 );
            LAB_0011d4fb:if (__ptr != (void*)0x0) {
               free(__ptr);
            }
         ...
         if (iVar2 == 0) {
            LAB_0011d4f4:__ptr = *(void**)( (long)param_2 + 0x10 );
            *(int*)( (long)param_1 + 0x18 ) = iVar2;
            goto LAB_0011d4fb;
         }

         basisu::elemental_vector::increase_capacity((uint)(undefined8*)( (long)param_1 + 0x10 ), SUB41(iVar2, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x4, false);
         if (*(void**)( (long)param_1 + 0x10 ) == (void*)0x0) {
            LAB_0011d4f1:iVar2 = *(int*)( (long)param_2 + 0x18 );
            goto LAB_0011d4f4;
         }
...
/* basisu::vector<basisu::gpu_image>::object_mover(void*, void*, unsigned int) */void basisu::vector<basisu::gpu_image>::object_mover(void *param_1, void *param_2, uint param_3) {
   undefined4 uVar1;
   uint uVar2;
   undefined8 uVar3;
   undefined8 uVar4;
   ...
   if ((undefined4*)param_2 != puVar6) {
      do {
         ...
         *(undefined8*)( (long)param_1 + 0x28 ) = 0;
         basisu::elemental_vector::increase_capacity((int)param_1 + 0x20, SUB41(uVar1, 0), 0, (_func_void_void_ptr_void_ptr_uint*)&DAT_00000008, false);
         uVar2 = *(uint*)( (long)param_2 + 0x28 );
         *(uint*)( (long)param_1 + 0x28 ) = uVar2;
         if (*(void**)( (long)param_1 + 0x20 ) == (void*)0x0) {
            LAB_0011d63e:if (*(void**)( (long)param_2 + 0x20 ) != (void*)0x0) {
   ...
   if ((undefined8*)param_2 != puVar3) {
      do {
         ...
         *(undefined8*)( (long)param_1 + 8 ) = 0;
         basisu::elemental_vector::increase_capacity((uint)param_1, SUB41(uVar1, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
         ...
         *(undefined8*)( (long)param_1 + 0x18 ) = 0;
         basisu::elemental_vector::increase_capacity((uint)param_1 + 0x10, SUB41(uVar1, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
         uVar2 = *(uint*)( (long)param_2 + 0x18 );
         *(uint*)( (long)param_1 + 0x18 ) = uVar2;
         if (*(void**)( (long)param_1 + 0x10 ) == (void*)0x0) {
            LAB_0011d721:if (*(void**)( (long)param_2 + 0x10 ) != (void*)0x0) {
...
/* basisu::vector<std::__cxx11::string >::object_mover(void*, void*, unsigned int) */void basisu::vector<std::__cxx11::string>::object_mover(void *param_1, void *param_2, uint param_3) {
   ulong __n;
   undefined1 *__src;
   ulong *__dest;
   undefined8 *puVar1;
...
/* basisu::vector<basisu::image_stats>::object_mover(void*, void*, unsigned int) */void basisu::vector<basisu::image_stats>::object_mover(void *param_1, void *param_2, uint param_3) {
   undefined1 uVar1;
   long lVar2;
   long *plVar3;
   long lVar4;
...
/* basisu::vector<basisu::parallel_results>::object_mover(void*, void*, unsigned int) */void basisu::vector<basisu::parallel_results>::object_mover(void *param_1, void *param_2, uint param_3) {
   undefined8 uVar1;
   undefined1 uVar2;
   undefined4 uVar3;
   undefined4 uVar4;
   ...
   if ((undefined8*)param_2 != puVar19) {
      do {
         ...
         *(undefined8*)param_1 = uVar1;
         basisu::elemental_vector::increase_capacity(iVar6 + 0x10, SUB41(uVar4, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
         uVar5 = *(uint*)( (long)param_2 + 0x18 );
         *(uint*)( (long)param_1 + 0x18 ) = uVar5;
         if (( *(void**)( (long)param_1 + 0x10 ) != (void*)0x0 ) && ( *(void**)( (long)param_2 + 0x10 ) != (void*)0x0 )) {
         ...
         *(undefined8*)( (long)param_1 + 0x28 ) = 0;
         basisu::elemental_vector::increase_capacity(iVar6 + 0x20, SUB41(uVar3, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
         uVar5 = *(uint*)( (long)param_2 + 0x28 );
         *(uint*)( (long)param_1 + 0x28 ) = uVar5;
         if (( *(void**)( (long)param_1 + 0x20 ) != (void*)0x0 ) && ( *(void**)( (long)param_2 + 0x20 ) != (void*)0x0 )) {
         ...
         *(undefined8*)( (long)param_1 + 0x38 ) = 0;
         basisu::elemental_vector::increase_capacity(iVar6 + 0x30, SUB41(uVar3, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x70, true);
...
/* basisu::string_get_extension(std::__cxx11::string const&) */basisu * __thiscall basisu::string_get_extension(basisu *this,string *param_1){
   ...
   if (lVar2 == -1) {
      ...
      LAB_0011dc68:*(basisu**)this = this + 0x10;
      ...
      iVar4 = (int)lVar2;
      if (lVar2 == -1) {
         if (-2 < iVar7) goto LAB_0011dc68;
         local_58 = &local_48;
         std::__cxx11::string::_M_construct<char*>(&local_58, *(long*)param_1, *(long*)( param_1 + 8 ) + *(long*)param_1);
      }
 else {
         LAB_0011dbeb:if (iVar4 <= iVar7) goto LAB_0011dc68;
         local_58 = &local_48;
         std::__cxx11::string::_M_construct<char*>(&local_58, *(long*)param_1, *(long*)( param_1 + 8 ) + *(long*)param_1);
         if (iVar4 == -2) {
            local_50 = 0;
         ...
         if (uVar1 < 8) {
            if (( uVar5 & 4 ) == 0) {
               if (uVar1 != 0) {
                  ...
                  if (( uVar5 & 2 ) != 0) {
                     *(undefined2*)( this + ( uVar5 & 0xffffffff ) + 0xe ) = *(undefined2*)( (long)&local_50 + ( uVar5 & 0xffffffff ) + 6 );
                  }
               ...
               *(undefined4*)( this + ( uVar5 & 0xffffffff ) + 0xc ) = *(undefined4*)( (long)&local_50 + ( uVar5 & 0xffffffff ) + 4 );
            }

         }
 else {
            *(ulong*)( this + 0x10 ) = CONCAT44(local_48._4_4_, (undefined4)local_48);
            *(undefined8*)( this + ( uVar5 & 0xffffffff ) + 8 ) = *(undefined8*)( (long)&local_50 + ( uVar5 & 0xffffffff ) );
            ...
            if (7 < uVar1) {
               ...
               do {
                  uVar5 = (ulong)uVar3;
                  uVar3 = uVar3 + 8;
                  *(undefined8*)( ( ( ulong )(this + 0x18) & 0xfffffffffffffff8 ) + uVar5 ) = *(undefined8*)( (long)&local_48 + ( uVar5 - lVar2 ) );
               }
 while ( uVar3 < uVar1 );
            }
...
/* basisu::string_split_path(char const*, std::__cxx11::string*, std::__cxx11::string*,
   std::__cxx11::string*, std::__cxx11::string*) */undefined8 basisu::string_split_path(char *param_1, string *param_2, string *param_3, string *param_4, string *param_5) {
   char cVar1;
   undefined4 uVar2;
   uint uVar3;
   size_t sVar4;
   ...
   if (uVar8 < 0x401) {
      ...
      if ((uint)uVar8 < 8) {
         if (( uVar8 & 4 ) == 0) goto LAB_0011e1cf;
         LAB_0011e230:*(undefined4*)pcVar6 = *(undefined4*)param_1;
         lVar10 = 4;
      }
 else {
         ...
         if (( uVar8 & 4 ) != 0) goto LAB_0011e230;
         LAB_0011e1cf:lVar10 = 0;
      }
   ...
   if (param_3 != (string*)0x0) {
      ...
      if (( lVar10 != 0 ) && ( *(char*)( *(long*)param_3 + -1 + lVar10 ) != '/' )) {
         if (lVar10 == 0x3fffffffffffffff) goto LAB_0011e578;
         std::__cxx11::string::_M_append((char*)param_3, 0x11dee9);
      }
   ...
   if (param_5 != (string*)0x0) {
      ...
      if (psVar9 == param_5 + 0x10) {
         if (local_868 == (string*)auStack_858) goto LAB_0011e370;
               ...
               *psVar9 = auStack_858[0]._0_1_;
               ...
               if (uVar3 < 8) {
                  if (( local_860 & 4 ) == 0) {
                     if (uVar3 != 0) {
                        *psVar9 = auStack_858[0]._0_1_;
                        if (( local_860 & 2 ) == 0) goto LAB_0011e3ae;
                        *(undefined2*)( psVar9 + ( uVar8 - 2 ) ) = *(undefined2*)( (long)auStack_858 + ( uVar8 - 2 ) );
                        psVar9 = *(string**)param_5;
                     }
                     ...
                     *(undefined4*)( psVar9 + ( uVar8 - 4 ) ) = *(undefined4*)( (long)auStack_858 + ( uVar8 - 4 ) );
                     psVar9 = *(string**)param_5;
                  }
                  ...
                  *(undefined8*)( psVar9 + ( ( local_860 & 0xffffffff ) - 8 ) ) = *(undefined8*)( (long)auStack_858 + ( ( local_860 & 0xffffffff ) - 8 ) );
                  ...
                  if (7 < uVar3) {
                     ...
                     do {
                        uVar13 = (int)uVar8 + 8;
                        *(undefined8*)( ( ( ulong )(psVar9 + 8) & 0xfffffffffffffff8 ) + uVar8 ) = *(undefined8*)( (string*)auStack_858 + ( uVar8 - lVar10 ) );
                        uVar8 = (ulong)uVar13;
                     }
 while ( uVar13 < uVar3 );
                  }

                  LAB_0011e3ae:psVar9 = *(string**)param_5;
               }
      ...
      *local_868 = (string)0x0;
      ...
      if (uVar8 != 0) {
         ...
         if (( local_860 == 0x3fffffffffffffff ) || ( std::__cxx11::string::_M_append((char*)&local_868, 0x11deeb),0x3fffffffffffffff - local_860 < uVar8 )) {
            LAB_0011e578:/* WARNING: Subroutine does not return */std::__throw_length_error("basic_string::append");
         }

         std::__cxx11::string::_M_append((char*)&local_868, uVar11);
         psVar9 = *(string**)param_5;
         if (param_5 + 0x10 == psVar9) {
            if (local_868 == (string*)auStack_858) goto LAB_0011e3f8;
            *(string**)param_5 = local_868;
            *(ulong*)( param_5 + 8 ) = local_860;
            *(ulong*)( param_5 + 0x10 ) = auStack_858[0];
            local_868 = (string*)auStack_858;
                  ...
                  *psVar9 = auStack_858[0]._0_1_;
                  ...
                  if (uVar3 < 8) {
                     if (( local_860 & 4 ) == 0) {
                        if (uVar3 != 0) {
                           *psVar9 = auStack_858[0]._0_1_;
                           if (( local_860 & 2 ) == 0) goto LAB_0011e436;
                           *(undefined2*)( psVar9 + ( uVar8 - 2 ) ) = *(undefined2*)( (long)auStack_858 + ( uVar8 - 2 ) );
                           psVar9 = *(string**)param_5;
                        }
 ...
 while ( uVar13 < uVar3 );
                     ...
                     LAB_0011e436:psVar9 = *(string**)param_5;
                  }
   ...
   uVar7 = 1;
   LAB_0011e168:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar7;
   }
...
/* basisu::image::crop(unsigned int, unsigned int, unsigned int, basisu::color_rgba const&, bool) */image * __thiscall
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* basisu::imagef::clean_astc_hdr_pixels(float) */undefined8 basisu::imagef::clean_astc_hdr_pixels(imagef *this, float param_1) {
   float *pfVar1;
   bool bVar2;
   bool bVar3;
   bool bVar4;
   ...
   if (*(int*)( this + 4 ) != 0) {
      ...
      do {
         ...
         if (*(int*)this != 0) {
            do {
               pfVar8 = (float*)( ( ulong )(uVar7 * *(int*)( this + 8 ) + uVar9) * 0x10 + *(long*)( this + 0x10 ) );
               pfVar1 = pfVar8 + 4;
               do {
                  fVar11 = *pfVar8;
                  if (NAN(fVar11)) {
                     ...
                     *pfVar8 = 0.0;
                     ...
                     if (param_1 < fVar11) {
                        *pfVar8 = param_1;
                        if (!bVar4) {
                           __fprintf_chk((double)param_1, _stderr, 2, "One or more pixels had to be clamped to %f.\n");
                           uVar13 = _LC20;
                        }
...
/* basisu::gpu_image::init(basisu::texture_format, unsigned int, unsigned int) */void basisu::gpu_image::init(gpu_image *this, uint param_2, int param_3, int param_4) {
   undefined8 uVar1;
   undefined8 uVar2;
   uint uVar3;
   uint uVar4;
   ...
   *(int*)( this + 8 ) = param_4;
   ...
   if (param_2 == 0x12) {
      ...
      *(undefined8*)( this + 0x14 ) = uVar1;
      uVar3 = 2;
      *(uint*)( this + 0xc ) = uVar4;
      if (0x21 < param_2) goto LAB_0011ebc3;
   }

   uVar3 = ( uint )((byte)CSWTCH_1179[param_2] >> 3);
   LAB_0011ebc3:*(uint*)( this + 0x1c ) = uVar3;
   if (*(int*)( this + 0x28 ) != 0) {
   ...
   if (*(uint*)( this + 0x2c ) < uVar5) {
      basisu::elemental_vector::increase_capacity((int)this + 0x20, SUB41(uVar5, 0), ( uint )(uVar5 == 1), (_func_void_void_ptr_void_ptr_uint*)&DAT_00000008, false);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* basisu::basis_compressor_params::basis_compressor_params() */void basisu::basis_compressor_params::basis_compressor_params(basis_compressor_params *this) {
   float fVar1;
   undefined8 uVar2;
   undefined4 uVar3;
   undefined8 uVar4;
   ...
   *(undefined8*)( this + 0xcc ) = uVar4;
   uVar4 = _UNK_00122448;
   uVar2 = CONCAT44(_UNK_00122444, _LC8);
   *(undefined4*)( this + 0xe0 ) = uVar3;
   *(undefined8*)( this + 0xf0 ) = uVar2;
   *(undefined8*)( this + 0xf8 ) = uVar4;
   uVar4 = _UNK_00122458;
   uVar2 = CONCAT44(_UNK_00122454, CONCAT22(_LC43._2_2_, (undefined2)_LC43));
   ...
   *(undefined8*)( this + 0x174 ) = uVar4;
   uVar4 = __LC53;
   uVar2 = CONCAT44(_LC62, _UNK_00122478);
 ...
 while ( __ptr != plVar9 );
   ...
   *(undefined4*)( this + 0xf0 ) = *(undefined4*)( this + 0xf4 );
   std::__cxx11::string::_M_replace(( ulong )(this + 0x108), 0, *(char**)( this + 0x110 ), 0x11ec59);
   fVar1 = *(float*)( this + 0xf8 );
   if (( *(float*)( this + 0xf8 ) <= _LC8 ) && ( fVar1 = *(float*)( this + 0xfc ) ),_LC8 <= *(float*)( this + 0xfc )) {
      fVar1 = _LC8;
   }
...
/* basisu::basis_compressor_params::~basis_compressor_params() */void basisu::basis_compressor_params::~basis_compressor_params(basis_compressor_params *this) {
   void *pvVar1;
   undefined8 *puVar2;
   void *pvVar3;
   undefined8 *puVar4;
...
/* basisu::basisu_frontend::~basisu_frontend() */void basisu::basisu_frontend::~basisu_frontend(basisu_frontend *this) {
   void *pvVar1;
   undefined8 *puVar2;
   undefined8 *puVar3;
   void *pvVar4;
   ...
   for (int i = 0; i < 3; i++) {
      puVar2 = *(undefined8**)( this + ( -32*i + 352 ) );
      if (puVar2 != (undefined8*)0) {
         puVar3 = puVar2 + ( ulong ) * (uint*)( this + ( -32*i + 360 ) ) * 2;
         if (puVar2 != puVar3) {
            do {
 ...
 while ( puVar3 != puVar2 );
            puVar3 = *(undefined8**)( this + ( -32*i + 352 ) );
         }

         free(puVar3);
      }

      if (*(void**)( this + ( -32*i + 336 ) ) != (void*)0) {
         free(*(void**)( this + ( -32*i + 336 ) ));
      }
 ...
 while ( pvVar4 != pvVar1 );
   ...
   for (int i = 0; i < 3; i++) {
      if (*(void**)( this + ( -16*i + 136 ) ) != (void*)0) {
         free(*(void**)( this + ( -16*i + 136 ) ));
      }
...
/* basist::basisu_lowlevel_etc1s_transcoder::~basisu_lowlevel_etc1s_transcoder() */void basist::basisu_lowlevel_etc1s_transcoder::~basisu_lowlevel_etc1s_transcoder(basisu_lowlevel_etc1s_transcoder *this) {
   ...
   while (pbVar2 != this + 0x110) {
      while (true) {
         ...
         free(*(void**)pbVar1);
         if (pbVar2 == this + 0x110) goto LAB_001207fc;
      }
;
   }
;
   LAB_001207fc:if (*(void**)( this + 0x100 ) != (void*)0x0) {
   ...
   for (int i = 0; i < 6; i++) {
      if (*(void**)( this + ( -32*i + 216 ) ) != (void*)0) {
         free(*(void**)( this + ( -32*i + 216 ) ));
      }

      if (*(void**)( this + ( -32*i + 200 ) ) != (void*)0) {
         free(*(void**)( this + ( -32*i + 200 ) ));
      }
...
/* basisu::vector<unsigned char>::resize(unsigned long, bool) */void basisu::vector<unsigned_char>::resize(vector<unsigned_char> *this, ulong param_1, bool param_2) {
   uint uVar1;
   uint uVar2;
   if (param_1 >> 0x20 == 0) {
      uVar1 = *(uint*)( this + 8 );
      ...
      if (uVar1 != uVar2) {
         if (uVar1 <= uVar2) {
            if (*(uint*)( this + 0xc ) < uVar2) {
               ...
               basisu::elemental_vector::increase_capacity((uint)this, SUB81(param_1, 0), (uint)param_2, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
               uVar1 = *(uint*)( this + 8 );
            }
...
/* basisu::vector<basisu::image>::~vector() */void basisu::vector<basisu::image>::~vector(vector<basisu::image> *this) {
   void *pvVar1;
   void *__ptr;
   pvVar1 = *(void**)this;
   if (pvVar1 == (void*)0x0) {
...
/* basisu::vector<basisu::imagef>::~vector() */void basisu::vector<basisu::imagef>::~vector(vector<basisu::imagef> *this) {
   void *pvVar1;
   void *__ptr;
   pvVar1 = *(void**)this;
   if (pvVar1 == (void*)0x0) {
...
/* basisu::vector<std::__cxx11::string >::clear() */void basisu::vector<std::__cxx11::string>::clear(vector<std::__cxx11::string> *this) {
   undefined8 *puVar1;
   undefined8 *__ptr;
...
/* basisu::vector<basisu::gpu_image>::resize(unsigned long, bool) */void basisu::vector<basisu::gpu_image>::resize(vector<basisu::gpu_image> *this, ulong param_1, bool param_2) {
   undefined4 *puVar1;
   uint uVar2;
   undefined4 *puVar3;
   long lVar4;
 ...
 while ( lVar6 != lVar4 );
            *(uint*)( this + 8 ) = uVar5;
            ...
            if (*(uint*)( this + 0xc ) < uVar5) {
               ...
               basisu::elemental_vector::increase_capacity((uint)this, SUB81(param_1, 0), (uint)param_2, (_func_void_void_ptr_void_ptr_uint*)0x30, true);
               uVar2 = *(uint*)( this + 8 );
            }
...
/* basisu::vector<basisu::vector<unsigned char> >::resize(unsigned long, bool) */void basisu::vector<basisu::vector<unsigned_char>>::resize(vector<basisu::vector<unsigned_char>> *this, ulong param_1, bool param_2) {
   undefined8 *puVar1;
   uint uVar2;
   undefined8 *puVar3;
   uint uVar4;
 ...
 while ( puVar1 != puVar3 );
            *(uint*)( this + 8 ) = uVar4;
            ...
            if (*(uint*)( this + 0xc ) < uVar4) {
               ...
               basisu::elemental_vector::increase_capacity((uint)this, SUB81(param_1, 0), (uint)param_2, (_func_void_void_ptr_void_ptr_uint*)0x10, false);
               uVar2 = *(uint*)( this + 8 );
            }
...
/* basisu::vector<basisu::image>::push_back(basisu::image const&) */void basisu::vector<basisu::image>::push_back(vector<basisu::image> *this, image *param_1) {
   uint uVar1;
   image *piVar2;
   uint uVar3;
   uVar3 = *(uint*)( this + 8 );
   if (*(uint*)( this + 0xc ) <= uVar3) {
      basisu::elemental_vector::increase_capacity((uint)this, (bool)( (char)uVar3 + '\x01' ), 1, (_func_void_void_ptr_void_ptr_uint*)0x20, true);
      uVar3 = *(uint*)( this + 8 );
   }
   ...
   *(undefined8*)( piVar2 + 0x18 ) = 0;
   if (piVar2 == param_1) goto LAB_00120d9f;
   *(undefined8*)piVar2 = *(undefined8*)param_1;
   *(undefined4*)( piVar2 + 8 ) = *(undefined4*)( param_1 + 8 );
   if (piVar2 + 0x10 == param_1 + 0x10) goto LAB_00120d9f;
   uVar1 = *(uint*)( param_1 + 0x18 );
   if (uVar1 != 0) {
      basisu::elemental_vector::increase_capacity(( uint )(piVar2 + 0x10), SUB41(uVar1, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x4, false);
      if (*(void**)( piVar2 + 0x10 ) == (void*)0x0) {
         LAB_00120d94:uVar1 = *(uint*)( param_1 + 0x18 );
      }
 else {
         uVar1 = *(uint*)( param_1 + 0x18 );
   ...
   *(uint*)( piVar2 + 0x18 ) = uVar1;
   LAB_00120d9f:*(uint*)( this + 8 ) = uVar3 + 1;
   return;
}
/* basisu::vector<basisu::imagef>::push_back(basisu::imagef const&) */void basisu::vector<basisu::imagef>::push_back(vector<basisu::imagef> *this, imagef *param_1) {
   long lVar1;
   long lVar2;
   undefined8 uVar3;
   long lVar4;
   ...
   uVar6 = *(uint*)( this + 8 );
   if (*(uint*)( this + 0xc ) <= uVar6) {
      basisu::elemental_vector::increase_capacity((uint)this, (bool)( (char)uVar6 + '\x01' ), 1, (_func_void_void_ptr_void_ptr_uint*)0x20, true);
      uVar6 = *(uint*)( this + 8 );
   }
   ...
   if (piVar5 != param_1) {
      ...
      *(undefined4*)( piVar5 + 8 ) = *(undefined4*)( param_1 + 8 );
      if (piVar5 + 0x10 != param_1 + 0x10) {
         ...
         if (uVar7 != 0) {
            basisu::elemental_vector::increase_capacity(( uint )(piVar5 + 0x10), SUB41(uVar7, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x10, true);
            uVar7 = *(uint*)( param_1 + 0x18 );
...
/* basisu::vector<basisu::image_stats>::resize(unsigned long, bool) */void basisu::vector<basisu::image_stats>::resize(vector<basisu::image_stats> *this, ulong param_1, bool param_2) {
   long *plVar1;
   uint uVar2;
   long *plVar3;
   undefined8 *puVar4;
 ...
 while ( puVar6 != puVar4 );
            *(uint*)( this + 8 ) = uVar5;
            ...
            if (*(uint*)( this + 0xc ) < uVar5) {
               ...
               basisu::elemental_vector::increase_capacity((uint)this, SUB81(param_1, 0), (uint)param_2, (_func_void_void_ptr_void_ptr_uint*)0x70, true);
               uVar2 = *(uint*)( this + 8 );
            }
            ...
            for (; plVar1 != plVar3; plVar1 = plVar1 + 0xe) {
               ...
               *plVar1 = (long)( plVar1 + 2 );
               ...
               plVar1[4] = 0;
               for (int i = 0; i < 4; i++) {
                  *(undefined1(*) [16])( plVar1 + ( 2*i + 5 ) ) = (undefined1[16])0;
               }
...
/* basisu::vector<basisu::image>::resize(unsigned long, bool) */void basisu::vector<basisu::image>::resize(vector<basisu::image> *this, ulong param_1, bool param_2) {
   long lVar1;
   undefined8 *puVar2;
   uint uVar3;
   undefined8 *puVar4;
 ...
 while ( lVar1 != lVar5 );
         *(uint*)( this + 8 ) = uVar6;
         ...
         if (*(uint*)( this + 0xc ) < uVar6) {
            ...
            basisu::elemental_vector::increase_capacity((uint)this, SUB81(param_1, 0), (uint)param_2, (_func_void_void_ptr_void_ptr_uint*)0x20, true);
            uVar3 = *(uint*)( this + 8 );
         }
...
/* basisu::vector<basisu::imagef>::resize(unsigned long, bool) */void basisu::vector<basisu::imagef>::resize(vector<basisu::imagef> *this, ulong param_1, bool param_2) {
   long lVar1;
   undefined8 *puVar2;
   uint uVar3;
   undefined8 *puVar4;
...
/* basisu::vector<basisu::image>::reserve(unsigned long) */void basisu::vector<basisu::image>::reserve(vector<basisu::image> *this, ulong param_1) {
   ulong uVar1;
   void *__ptr;
   uint uVar2;
   void *pvVar3;
   ...
   if (param_1 >> 0x20 == 0) {
      ...
      if (*(uint*)( this + 0xc ) < uVar5) {
         if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
            basisu::elemental_vector::increase_capacity((uint)this, SUB81(param_1, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x20, true);
            return;
         }
      ...
      if (uVar5 < *(uint*)( this + 0xc )) {
         ...
         basisu::elemental_vector::increase_capacity(( uint ) & local_38, SUB41(uVar2, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x20, true);
         operator=((vector<basisu::image> *)&
   ...
   LAB_0012139f:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* void basisu::append_vector<basisu::vector<unsigned char> >(basisu::vector<unsigned char>&,
   basisu::vector<unsigned char> const&) */void basisu::append_vector<basisu::vector<unsigned_char>>(vector *param_1, vector *param_2) {
   uint uVar1;
   uint uVar2;
   void *__src;
   uint uVar3;
      ...
      if (__n_00 + uVar5 >> 0x20 == 0) {
         ...
         if (!CARRY4(uVar2,uVar1)) {
            ...
            if (*(uint*)( param_1 + 0xc ) < uVar3) {
               basisu::elemental_vector::increase_capacity((uint)param_1, SUB41(uVar3, 0), ( uint )(uVar1 == 1), (_func_void_void_ptr_void_ptr_uint*)0x1, false);
...
/* basisu::vector<unsigned char>::push_back(unsigned char const&) */void basisu::vector<unsigned_char>::push_back(vector<unsigned_char> *this, uchar *param_1) {
   uint uVar1;
   uVar1 = *(uint*)( this + 8 );
   if (*(uint*)( this + 0xc ) <= uVar1) {
      basisu::elemental_vector::increase_capacity((uint)this, (bool)( (char)uVar1 + '\x01' ), 1, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
      uVar1 = *(uint*)( this + 8 );
   }
...
/* basisu::vector<basisu::parallel_results>::resize(unsigned long, bool) */void basisu::vector<basisu::parallel_results>::resize(vector<basisu::parallel_results> *this, ulong param_1, bool param_2) {
   undefined8 *puVar1;
   uint uVar2;
   uint uVar3;
   undefined8 *puVar4;
 ...
 while ( lVar6 != lVar5 );
            *(uint*)( this + 8 ) = uVar3;
            ...
            if (*(uint*)( this + 0xc ) < uVar3) {
               ...
               basisu::elemental_vector::increase_capacity((uint)this, SUB81(param_1, 0), (uint)param_2, (_func_void_void_ptr_void_ptr_uint*)0x50, true);
               uVar2 = *(uint*)( this + 8 );
            }
...
/* basisu::vector<basisu::image>::vector(basisu::vector<basisu::image> const&) */void basisu::vector<basisu::image>::vector(vector<basisu::image> *this, vector *param_1) {
   undefined8 *puVar1;
   undefined4 uVar2;
   int iVar3;
   undefined8 *puVar4;
   ...
   *(undefined8*)this = 0;
   *(undefined8*)( this + 8 ) = 0;
   basisu::elemental_vector::increase_capacity((uint)this, SUB41(uVar2, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x20, true);
   iVar3 = *(int*)( param_1 + 8 );
   puVar5 = *(undefined8**)param_1;
   *(int*)( this + 8 ) = iVar3;
         ...
         if (puVar4 != puVar5) {
            ...
            *(undefined4*)( puVar4 + 1 ) = *(undefined4*)( puVar5 + 1 );
            if (puVar4 + 2 != puVar5 + 2) {
               uVar6 = *(uint*)( puVar5 + 3 );
               if (uVar6 != 0) {
                  basisu::elemental_vector::increase_capacity(( uint )(puVar4 + 2), SUB41(uVar6, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x4, false);
                  if ((void*)puVar4[2] != (void*)0x0) {
                     uVar6 = *(uint*)( puVar5 + 3 );
                     if ((void*)puVar5[2] == (void*)0x0) goto LAB_0012173e;
               ...
               LAB_0012173e:*(uint*)( puVar4 + 3 ) = uVar6;
            }
...
/* basisu::vector<basisu::imagef>::vector(basisu::vector<basisu::imagef> const&) */void basisu::vector<basisu::imagef>::vector(vector<basisu::imagef> *this, vector *param_1) {
   undefined8 *puVar1;
   undefined4 uVar2;
   int iVar3;
   long lVar4;
         ...
         if (puVar9 != puVar8) {
            ...
            *(undefined4*)( puVar8 + 1 ) = *(undefined4*)( puVar9 + 1 );
            if (puVar8 + 2 != puVar9 + 2) {
               uVar10 = *(uint*)( puVar9 + 3 );
               if (uVar10 != 0) {
                  basisu::elemental_vector::increase_capacity(( uint )(puVar8 + 2), SUB41(uVar10, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x10, true);
                  uVar10 = *(uint*)( puVar9 + 3 );
                  lVar4 = puVar8[2];
                  lVar5 = puVar9[2];
                  if (uVar10 != 0) {
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* void std::__heap_select<basist::ktx2_transcoder::key_value*,
   __gnu_cxx::__ops::_Iter_less_iter>(basist::ktx2_transcoder::key_value*,
   basist::ktx2_transcoder::key_value*, basist::ktx2_transcoder::key_value*,
   __gnu_cxx::__ops::_Iter_less_iter) */void std::__heap_select<basist::ktx2_transcoder::key_value*,__gnu_cxx::__ops::_Iter_less_iter>(undefined8 *param_1, undefined8 *param_2, undefined8 *param_3) {
   int iVar1;
   long lVar2;
   long lVar3;
   undefined8 *puVar4;
   ...
   if (0x20 < (long)param_2 - (long)param_1) {
      ...
      while (true) {
         local_88 = (void*)0x0;
         local_80 = 0;
         basisu::elemental_vector::increase_capacity(( uint ) & local_88, SUB41(*(undefined4*)( puVar4 + 1 ), 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
         ...
         local_78 = (void*)0x0;
         local_70 = 0;
         basisu::elemental_vector::increase_capacity(( uint ) & local_78, SUB41(*(undefined4*)( puVar4 + 3 ), 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
         ...
         local_68 = (void*)0x0;
         local_60 = 0;
         basisu::elemental_vector::increase_capacity(( uint ) & local_68, SUB81(local_80, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
         local_60 = CONCAT44(local_60._4_4_, (undefined4)local_80);
         if (( local_68 != (void*)0x0 ) && ( local_88 != (void*)0x0 )) {
            memcpy(local_68, local_88, local_80 & 0xffffffff);
         }
         ...
         local_58 = (void*)0x0;
         local_50 = 0;
         basisu::elemental_vector::increase_capacity(( uint ) & local_58, SUB81(local_70, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
         local_50 = CONCAT44(local_50._4_4_, (undefined4)local_70);
         if (( local_58 != (void*)0x0 ) && ( local_78 != (void*)0x0 )) {
            memcpy(local_58, local_78, local_70 & 0xffffffff);
         }

         __adjust_heap<basist::ktx2_transcoder::key_value*,long,basist::ktx2_transcoder::key_value,__gnu_cxx::__ops::_Iter_less_iter>(param_1, lVar2, lVar3, &local_68);
         if (local_58 != (void*)0x0) {
            free(local_58);
         }
   ...
   if (param_2 < param_3) {
      do {
         while (iVar1 = strcmp((char*)*param_2, (char*)*param_1),-1 < iVar1) {
            LAB_00121c80:param_2 = param_2 + 4;
            if (param_3 <= param_2) goto LAB_00121ed0;
         }
;
         local_88 = (void*)0x0;
         local_80 = 0;
         basisu::elemental_vector::increase_capacity(( uint ) & local_88, SUB41(*(undefined4*)( param_2 + 1 ), 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
         ...
         local_78 = (void*)0x0;
         local_70 = 0;
         basisu::elemental_vector::increase_capacity(( uint ) & local_78, SUB41(*(undefined4*)( param_2 + 3 ), 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
         ...
         if (param_1 != param_2) {
            ...
            if (*(uint*)( (long)param_2 + 0xc ) < uVar5) {
               ...
               basisu::elemental_vector::increase_capacity((uint)param_2, SUB41(uVar5, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
               uVar5 = *(uint*)( param_1 + 1 );
               pvVar6 = (void*)*param_2;
            }
         ...
         if (param_2 + 2 != param_1 + 2) {
            ...
            if (*(uint*)( (long)param_2 + 0x1c ) < uVar5) {
               ...
               basisu::elemental_vector::increase_capacity(( uint )(param_2 + 2), SUB41(uVar5, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
               uVar5 = *(uint*)( param_1 + 3 );
               pvVar6 = (void*)param_2[2];
            }
         ...
         __adjust_heap<basist::ktx2_transcoder::key_value*,long,basist::ktx2_transcoder::key_value,__gnu_cxx::__ops::_Iter_less_iter>(param_1, 0, lVar3, &local_68);
         if (local_58 != (void*)0x0) {
            free(local_58);
         }
         ...
         if (local_88 == (void*)0x0) goto LAB_00121c80;
         free(local_88);
         param_2 = param_2 + 4;
      }
 while ( param_2 < param_3 );
   ...
   LAB_00121ed0:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* std::enable_if<std::__and_<std::__not_<std::__is_tuple_like<basist::ktx2_transcoder::key_value>
   ...
   basist::ktx2_transcoder::key_value&) */void std::swap<basist::ktx2_transcoder::key_value>(key_value *param_1, key_value *param_2) {
   void *pvVar1;
   uint uVar2;
   long in_FS_OFFSET;
   void *local_58;
   ...
   local_58 = (void*)0x0;
   local_50 = 0;
   basisu::elemental_vector::increase_capacity(( uint ) & local_58, SUB41(*(undefined4*)( param_1 + 8 ), 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
   ...
   local_48 = (void*)0x0;
   local_40 = 0;
   basisu::elemental_vector::increase_capacity(( uint ) & local_48, SUB41(*(undefined4*)( param_1 + 0x18 ), 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
   ...
   if (param_2 != param_1) {
      ...
      if (*(uint*)( param_1 + 0xc ) < uVar2) {
         ...
         basisu::elemental_vector::increase_capacity((uint)param_1, SUB41(uVar2, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
         uVar2 = *(uint*)( param_2 + 8 );
         pvVar1 = *(void**)param_1;
      }
   ...
   if (param_2 + 0x10 != param_1 + 0x10) {
      ...
      if (*(uint*)( param_1 + 0x1c ) < uVar2) {
         ...
         basisu::elemental_vector::increase_capacity(( uint )(param_1 + 0x10), SUB41(uVar2, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
         uVar2 = *(uint*)( param_2 + 0x18 );
         pvVar1 = *(void**)( param_1 + 0x10 );
      }
   ...
   if (*(uint*)( param_2 + 0xc ) < (uint)local_50) {
      ...
      basisu::elemental_vector::increase_capacity((uint)param_2, SUB41((uint)local_50, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
      pvVar1 = *(void**)param_2;
   }
 else if (*(int*)( param_2 + 8 ) != 0) {
      *(undefined4*)( param_2 + 8 ) = 0;
   ...
   *(uint*)( param_2 + 8 ) = uVar2;
   ...
   if (*(uint*)( param_2 + 0x1c ) < (uint)local_40) {
      ...
      basisu::elemental_vector::increase_capacity(( uint )(param_2 + 0x10), SUB41((uint)local_40, 0), 0, (_func_void_void_ptr_void_ptr_uint*)0x1, false);
      pvVar1 = *(void**)( param_2 + 0x10 );
   }
 else if (*(int*)( param_2 + 0x18 ) != 0) {
      *(undefined4*)( param_2 + 0x18 ) = 0;
   ...
   *(uint*)( param_2 + 0x18 ) = uVar2;
   ...
   LAB_001221b7:if (local_58 != (void*)0x0) {
      free(local_58);
   }
...
/* buminiz::mz_adler32(unsigned long, unsigned char const*, unsigned long) */void buminiz::_GLOBAL__sub_I_mz_adler32(void) {
   basisu::g_black_color = 0xff000000;
   return;
}
/* WARNING: Control flow encountered bad instruction data *//* basisu::vector<basisu::imagef>::~vector() */void basisu::vector<basisu::imagef>::~vector(vector<basisu::imagef> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* basisu::vector<basisu::image>::~vector() */void basisu::vector<basisu::image>::~vector(vector<basisu::image> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* basist::basisu_lowlevel_etc1s_transcoder::~basisu_lowlevel_etc1s_transcoder() */void basist::basisu_lowlevel_etc1s_transcoder::~basisu_lowlevel_etc1s_transcoder(basisu_lowlevel_etc1s_transcoder *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* basisu::basisu_frontend::~basisu_frontend() */void basisu::basisu_frontend::~basisu_frontend(basisu_frontend *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* basisu::basis_compressor_params::~basis_compressor_params() */void basisu::basis_compressor_params::~basis_compressor_params(basis_compressor_params *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* basisu::basis_compressor_params::basis_compressor_params() */void basisu::basis_compressor_params::basis_compressor_params(basis_compressor_params *this) {
...
/* WARNING: Control flow encountered bad instruction data *//* basisu::vector<basisu::imagef>::vector(basisu::vector<basisu::imagef> const&) */void basisu::vector<basisu::imagef>::vector(vector *param_1) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* basisu::vector<basisu::image>::vector(basisu::vector<basisu::image> const&) */void basisu::vector<basisu::image>::vector(vector *param_1) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

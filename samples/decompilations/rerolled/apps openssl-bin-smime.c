int smime_cb(int param_1, X509_STORE_CTX *param_2) {
   ...
   return param_1;
}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 smime_main(undefined4 param_1, undefined8 param_2) {
   bool bVar1;
   bool bVar2;
   int iVar3;
   int iVar4;
   ...
   if (pm != (X509_VERIFY_PARAM*)0x0) {
      ...
      local_150 = 0;
      local_120 = (CONF*)0x0;
      switchD_00100296_caseD_0:iVar3 = opt_next();
      if (iVar3 == 0) {
         iVar3 = opt_num_rest();
         plVar8 = (long*)opt_rest();
         iVar4 = app_RAND_load();
         if (iVar4 == 0) goto LAB_00100392;
         if (( ( local_118 != (BIO*)0x0 ) && ( iVar4 = opt_md(local_118, &local_50) ),iVar4 == 0 )) goto switchD_00100296_caseD_ffffffff;
         if (( uVar16 & 0x40 ) == 0) {
            ...
            if (local_138 == (BIO*)0x0) {
               ...
               LAB_00100a2c:if (( ( local_150 == 0 ) && ( local_150 = local_150 == 0 ) ) || ( ( iVar3 = OPENSSL_sk_push(local_150, local_130) ),iVar3 < 1 || ( ( local_148 == 0 && ( local_148 = OPENSSL_sk_new_null() ),local_148 == 0 ) ) )) goto LAB_00100392;
               if (local_138 != (BIO*)0x0) {
            ...
            iVar3 = app_passwd(local_f0, 0, &local_48);
            if (iVar3 == 0) {
               LAB_0010135a:BIO_printf(_bio_err, "Error getting password\n");
               goto LAB_00100392;
            }
            local_130 = (long*)0x0;
            local_138 = (BIO*)0x0;
         ...
         if (( uVar16 & 0x10 ) == 0) {
            if (( flags & 0x80 ) != 0) {
               local_78 = 2;
               if (uVar5 == 0) {
                  LAB_00101172:local_7c = 2;
                  goto LAB_0010117d;
               }
               goto LAB_00100af1;
            }
            if (uVar5 != 0) goto LAB_00100af1;
            LAB_0010117d:bVar1 = false;
            if (uVar16 == 0x11) {
      ...
      if (iVar3 < 0x7d1) {
         if (iVar3 < 0x645) {
            if (iVar3 < 0x641) {
               if (( iVar3 - 0x5ddU < 2 ) && ( iVar3 = iVar3 == 0 )) goto LAB_001002f0;
               goto switchD_00100296_caseD_0;
            }
      ...
      switch (iVar3) {
         for (int i_1639 = 0; i_1639 < 29; i_1639++) {
            case 0x7d1:
         }
         case 0x7ee:
   ...
   goto LAB_001000ee;
   code_r0x00100d9e:flags = uVar5;
   if (( ( uVar16 == 0x53 ) && ( ( uVar5 & 0x1000 ) == 0 ) ) && ( iVar3 = iVar3 == 0 )) {
      uVar17 = 3;
      ctx = (X509_STORE*)0x0;
      goto LAB_00100e9f;
   }
   joined_r0x00101511:if (local_68 == (PKCS7*)0x0) {
      LAB_00101517:ctx = (X509_STORE*)0x0;
      LAB_0010151a:uVar17 = 3;
      BIO_printf(_bio_err, "Error creating PKCS#7 structure\n");
      LAB_00100e9f:signcert = (X509*)0x0;
      pXVar12 = (X509*)0x0;
      goto LAB_00100ea4;
   }
   LAB_00100dc3:if (local_c0 != 0) {
   ...
   LAB_001003c2:uVar17 = 0;
   signcert = (X509*)0x0;
   pXVar12 = (X509*)0x0;
   goto LAB_001003ca;
   code_r0x0010028f:switch (iVar3) {
      default:
    goto switchD_00100296_caseD_0;
      case 1:
...
joined_r0x001006dc:
   ...
   goto LAB_00100392;
   switchD_00100296_caseD_ffffffff:BIO_printf(_bio_err, "%s: Use -help for summary.\n", uVar17);
   LAB_00100392:local_110 = (X509*)0x0;
   v = (X509_STORE*)0x0;
   local_108 = 0;
   local_140 = (EVP_PKEY*)0x0;
   local_138 = (BIO*)0x0;
   ...
   while (true) {
      ...
      plVar8 = plVar8 + 1;
      if (lVar14 == 0) break;
      LAB_001011f6:pXVar12 = (X509*)load_cert_pass(lVar14, 0, 1);
      if (pXVar12 == (X509*)0x0) {
         signcert = (X509*)0x0;
         uVar17 = 2;
         local_110 = (X509*)0x0;
   ...
   bVar1 = false;
   if (local_140 == (EVP_PKEY*)0x0) {
      LAB_00101a69:bVar1 = false;
      bVar2 = false;
      goto LAB_00100b65;
   }
   LAB_00100b0a:iVar3 = load_certs(local_140, 0, &local_60, 0, "certificates");
   if (iVar3 == 0) {
      LAB_00101496:uVar17 = 2;
      ctx = (X509_STORE*)0x0;
   ...
   LAB_00100b39:bVar18 = uVar16 == 0x22;
   ...
   if (uVar16 == 0x22) {
      ...
      local_110 = (X509*)0x0;
      LAB_001012e9:local_140 = (EVP_PKEY*)load_key(local_138, local_74, 0, local_48, local_128, "signing key");
      if (local_140 == (EVP_PKEY*)0x0) {
         local_138 = (BIO*)0x0;
         ctx = (X509_STORE*)0x0;
         uVar17 = 2;
      ...
      if (( uVar16 == 0x53 ) && ( ( local_110 = (X509*)0x0 ),local_138 != (BIO*)0x0 || ( local_138 = (BIO*)local_130 ),local_130 != (long*)0x0 )) goto LAB_001012e9;
      LAB_00100b65:bVar18 = bVar2;
      local_110 = (X509*)0x0;
      local_140 = (EVP_PKEY*)0x0;
   }
   local_118 = (BIO*)bio_open_default(local_f8, 0x72, local_7c);
   ...
   LAB_00100c65:local_138 = (BIO*)bio_open_default(local_b8, 0x77, local_78);
   ...
   while (true) {
      ...
      pkey = local_140;
      if (( signcert == (X509*)0x0 ) || ( pkey = (EVP_PKEY*)load_key(uVar17, local_74, 0, local_48, local_128, "signing key") ),pkey == (EVP_PKEY*)0x0) break;
   ...
   uVar17 = 3;
   local_140 = pkey;
   LAB_00101233:ctx = (X509_STORE*)0x0;
   LAB_00100ea4:ERR_print_errors(_bio_err);
   v = ctx;
   LAB_001003ca:OSSL_STACK_OF_X509_free(local_108);
   ...
   LAB_001000ee:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar17;
   }

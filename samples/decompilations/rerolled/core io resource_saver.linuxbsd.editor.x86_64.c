...
ResourceSaver::_find_custom_resource_format_saver(ResourceSaver *this,String *param_1){
   ...
   *(undefined8**)this = puVar5 + 2;
   ...
   goto LAB_0010297f;
}LAB_00102954:cVar4 = RefCounted::unreference();if (( cVar4 != '\0' ) && ( cVar4 = predelete_handler(pOVar12) ),cVar4 != '\0') {
   ...
   if (0 < saver_count) {
               ...
               *puVar1 = pOVar4;
               ...
               if (cVar2 == '\0') {
                  *puVar1 = 0;
                  ...
                  cVar2 = RefCounted::unreference();
                  joined_r0x0010964a:if (( cVar2 != '\0' ) && ( cVar2 = predelete_handler(this) ),cVar2 != '\0') goto LAB_00109539;
               }
               cVar2 = RefCounted::unreference();
               lVar5 = local_50[0];
            } else {
      ...
      if (( lVar5 != 0 ) && ( 0 < *(long*)( lVar5 + -8 ) )) {
         ...
         do {
            ...
            remove_resource_format_saver(local_60);
            cVar2 = RefCounted::unreference();
            if (( cVar2 == '\0' ) || ( cVar2 = predelete_handler(pOVar4) ),cVar2 == '\0') goto LAB_00109261;
            if (*(code**)( *(long*)pOVar4 + 0x140 ) == ResourceFormatSaver::~ResourceFormatSaver) {
               bVar8 = StringName::configured != '\0';
               *(undefined***)pOVar4 = &PTR__initialize_classv_0010e450;
               if (( ( ( bVar8 ) && ( ( *(long*)( pOVar4 + 0x1e0 ) == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) ) ) && ( ( *(long*)( pOVar4 + 0x1c8 ) == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) ) ) && ( ( ( ( *(long*)( pOVar4 + 0x1b0 ) == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) && ( ( *(long*)( pOVar4 + 0x198 ) == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) ) ) && ( *(long*)( pOVar4 + 0x180 ) != 0 ) ) )) {
...
GetTypeInfo<Error,void>::get_class_info(GetTypeInfo<Error,void> *this){
   ...
   *(undefined8*)this = 0;
   ...
   undefined8 CowData<Ref<ResourceFormatSaver>>::_realloc(CowData<Ref<ResourceFormatSaver>> *this, long param_1) {
      undefined8 *puVar1;
      puVar1 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), param_1 + 0x10, false);
      if (puVar1 != (undefined8*)0x0) {
         *puVar1 = 1;
   ...
   undefined8 CowData<Ref<ResourceFormatSaver>>::resize<false>(CowData<Ref<ResourceFormatSaver>> *this, long param_1) {
      long *plVar1;
      Object *this_00;
      code *pcVar2;
      char cVar3;
   ...
   void ResourceFormatSaver::~ResourceFormatSaver(ResourceFormatSaver *this) {
      /* WARNING: Bad instruction - Truncating control flow here */
      halt_baddata();
   }
   /* WARNING: Control flow encountered bad instruction data */

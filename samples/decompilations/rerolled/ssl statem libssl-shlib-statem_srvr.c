...
switchD_00102a40_caseD_23:
      ...
      if (( param_2 == 0x101 ) && ( uVar3 != 0 )) {
         ...
         for (int i_526 = 0; i_526 < 4; i_526++) {
            param_1->sid_ctx[i_526] = '\0';
         }
...
switchD_00102e88_caseD_27:
   ...
   switch (*(undefined4*)( param_1 + 0xac )) {
      case 0:
      case 2:
      for (int i_529 = 0; i_529 < 9; i_529++) {
         case 3:
         case 4:
      }
      case 0x16:
      for (int i_528 = 0; i_528 < 6; i_528++) {
         case 0x19:
         case 0x1a:
      }
      case 0x26:
      for (int i_527 = 0; i_527 < 9; i_527++) {
         case 0x28:
      }
      case 0x31:
    break;
...
LAB_001034d0:
   ...
   uVar1 = *(undefined4*)&param_1->field_0xac;
   param_1->sid_ctx_length = 0;
   for (int i_530 = 0; i_530 < 4; i_530++) {
      param_1->sid_ctx[i_530] = '\0';
   }
   switch (uVar1) {
      case 0x15:
    iVar5 = statem_flush();

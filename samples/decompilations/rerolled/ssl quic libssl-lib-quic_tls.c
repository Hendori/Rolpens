undefined8 quic_unprocessed_read_pending(void) {
   ...
   *(byte*)( in_stack_00000018 + 0xa8 ) = *(byte*)( in_stack_00000018 + 0xa8 ) | 8;
   ...
   undefined8 in_R8;
   long in_stack_00000018;
   for (int i_2074 = 0; i_2074 < 2; i_2074++) {
   ...
   if (uVar1 != 0) {
      ...
      if (( uVar3 <= uVar1 && param_3 <= uVar3 ) && ( param_1 == param_2 )) {
         if (uVar3 != param_3) {
            LAB_001002c7:param_1[9] = uVar3 - param_3;
            return 1;
         }
   ...
   *(undefined4*)( param_1 + 7 ) = 0x50;
   ERR_new();
   uVar4 = 0x1a6;
   LAB_00100318:ERR_set_debug("ssl/quic/quic_tls.c", uVar4, "quic_release_record");
   ...
   *(long*)( param_1 + 0x10 ) = param_2;
   return 1;
}undefined8 quic_read_record(long *param_1, undefined8 *param_2, undefined4 *param_3, undefined1 *param_4, undefined8 param_5, ushort *param_6) {
   long lVar1;
   int iVar2;
   undefined8 uVar3;
   long in_FS_OFFSET;
   ...
   uVar3 = 0xfffffffe;
   LAB_001004b5:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar3;
   }
   ...
   if (param_3 == 1) {
      BIO_clear_flags((BIO*)param_1[2], 0xf);
      if ((code*)param_1[10] == (code*)0x0) {
         LAB_001005e2:bVar3 = *param_2;
         if (bVar3 != 0x15) goto LAB_001005ee;
         LAB_0010068b:if (*(long*)( param_2 + 0x10 ) == 2) {
            iVar4 = ( **(code**)( *param_1 + 0x68 ) )(*(undefined8*)( *param_1 + 0x70 ), *(undefined1*)( *(long*)( param_2 + 8 ) + 1 ));
            if (iVar4 == 0) {
               *(undefined4*)( param_1 + 7 ) = 0x50;
               ERR_new();
         ...
         *(undefined4*)( param_1 + 7 ) = 0x50;
         ...
         local_28 = ( ( ( uint ) * (undefined8*)( param_2 + 0x10 ) & 0xff00 | *(uint*)( param_2 + 4 ) & 0xff ) << 8 | *(uint*)( param_2 + 4 ) >> 8 & 0xff ) << 8 | local_28;
         ...
         LAB_001005ee:if (bVar3 == 0x16) {
            iVar4 = ( **(code**)( *param_1 + 8 ) )(param_1[3] + *(long*)( param_2 + 8 ), *(long*)( param_2 + 0x10 ) - param_1[3], &local_30, *(undefined8*)( *param_1 + 0x10 ));
            if (iVar4 == 0) {
               *(undefined4*)( param_1 + 7 ) = 0x50;
               ERR_new();
      ...
      LAB_00100621:ERR_set_error(0x14, uVar6, 0);
      *(byte*)( *param_1 + 0xa8 ) = *(byte*)( *param_1 + 0xa8 ) | 2;
   } else {
      if (param_1 != (long*)0x0) {
         *(undefined4*)( param_1 + 7 ) = 0x50;
   ...
   uVar6 = 0xfffffffe;
   LAB_00100640:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar6;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   *ptr = in_stack_000000c8;
   if (( in_stack_00000088 == 0 ) || ( iVar3 = iVar3 != 0 )) {
      ...
      *in_stack_000000d0 = ptr;
      ...
      LAB_00100aa0:if (in_R9D == 0) {
         return 1;
      }
      lVar4 = *ptr;
      uVar5 = 0;
      if (*(int*)( lVar4 + 0x7c ) != 0) {
         iVar3 = EVP_CIPHER_is_a(in_stack_00000050, "AES-128-GCM");
         if (iVar3 == 0) {
            uVar5 = 2;
            iVar3 = EVP_CIPHER_is_a(in_stack_00000050, "AES-256-GCM");
            if (iVar3 != 0) goto LAB_00100bde;
            uVar5 = 3;
            iVar3 = EVP_CIPHER_is_a(in_stack_00000050, "CHACHA20-POLY1305");
            if (iVar3 != 0) goto LAB_00100bde;
         ...
         uVar5 = 1;
         LAB_00100bde:iVar3 = EVP_MD_up_ref(in_stack_00000078);
         if (iVar3 == 0) {
            *(undefined4*)( ptr + 7 ) = 0x50;
            ERR_new();
            uVar5 = 0xad;
      ...
      iVar3 = ( **(code**)( lVar4 + 0x38 ) )(in_R9D, in_R8D != 0, uVar5, in_stack_00000078, in_stack_00000010, in_stack_00000018);
      if (iVar3 != 0) {
         return 1;
      }
      *(undefined4*)( ptr + 7 ) = 0x50;
      ...
      *(undefined4*)( ptr + 7 ) = 0x50;
      ERR_new();
      uVar5 = 0x7b;
      LAB_00100b39:ERR_set_debug("ssl/quic/quic_tls.c", uVar5, "quic_new_record_layer");
      uVar5 = 0xc0103;
      LAB_00100b48:ERR_set_error(0x14, uVar5, 0);
      *(byte*)( *ptr + 0xa8 ) = *(byte*)( *ptr + 0xa8 ) | 2;
   }
   a = (BIO*)ptr[2];
   *in_stack_000000d0 = 0;
   ...
   CRYPTO_free(ptr);
   return 0;
}undefined8 quic_retry_write_records(long *param_1) {
   char cVar1;
   int iVar2;
   ulong uVar3;
   undefined8 uVar4;
   ...
   BIO_clear_flags((BIO*)param_1[2], 0xf);
   if ((code*)param_1[10] == (code*)0x0) {
      LAB_00100d94:cVar1 = (char)param_1[4];
      if (cVar1 != '\x15') goto LAB_00100da0;
      LAB_00100e3c:if (param_1[6] == 2) {
         iVar2 = ( **(code**)( *param_1 + 0x68 ) )(*(undefined8*)( *param_1 + 0x70 ), *(undefined1*)( param_1[5] + 1 ));
         if (iVar2 == 0) {
            *(undefined4*)( param_1 + 7 ) = 0x50;
            ERR_new();
            ERR_set_debug("ssl/quic/quic_tls.c", 0x130, "quic_write_records");
      ...
      *(undefined4*)( param_1 + 7 ) = 0x50;
      ...
      local_14 = (undefined1)param_1[6];
      local_18 = ( ( (uint)param_1[6] & 0xff00 | *(uint*)( (long)param_1 + 0x24 ) & 0xff ) << 8 | *(uint*)( (long)param_1 + 0x24 ) >> 8 & 0xff ) << 8 | local_18;
      ( *(code*)param_1[10] )(1, 0x304, 0x100, &local_18, 5, param_1[0xb]);
      if ((int)param_1[1] == 0) goto LAB_00100d94;
      ( *(code*)param_1[10] )(1, 0x304, 0x101, param_1 + 4, 1, param_1[0xb]);
      cVar1 = (char)param_1[4];
      if (cVar1 == '\x15') goto LAB_00100e3c;
      LAB_00100da0:if (cVar1 == '\x16') {
         iVar2 = ( **(code**)( *param_1 + 8 ) )(param_1[3] + param_1[5], param_1[6] - param_1[3], &local_20, *(undefined8*)( *param_1 + 0x10 ));
         if (iVar2 == 0) {
            *(undefined4*)( param_1 + 7 ) = 0x50;
            ERR_new();
            ERR_set_debug("ssl/quic/quic_tls.c", 0x13e, "quic_write_records");
            ...
            uVar3 = local_20 + param_1[3];
            if (uVar3 == param_1[6]) {
               param_1[3] = 0;
               goto LAB_00100e61;
            }
            if (uVar3 < (ulong)param_1[6]) {
               param_1[3] = uVar3;
               BIO_set_flags((BIO*)param_1[2], 10);
               uVar4 = 0;
               goto LAB_00100dee;
   ...
   LAB_00100dd3:ERR_set_error(0x14, uVar4, 0);
   *(byte*)( *param_1 + 0xa8 ) = *(byte*)( *param_1 + 0xa8 ) | 2;
   uVar4 = 0xfffffffe;
   LAB_00100dee:if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar4;
   }
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   ...
   if (pSVar3 != (SSL*)0x0) {
      ssl = pSVar3;
      if (pSVar3->version != 0) {
         if (( ( pSVar3->version & 0x80U ) == 0 ) || ( pSVar3 = (SSL*)ossl_quic_obj_get0_handshake_layer(pSVar3) ),pSVar3 == (SSL*)0x0) goto LAB_00101208;
         ssl = (SSL*)*param_1;
      }
      ...
      if (lVar2 != 0) {
         ...
         if (rbio != (BIO*)0x0) {
            ...
            iVar1 = ossl_tls_add_custom_ext_intern(0, *(long*)&pSVar3[3].packet_length + 0x80, (int)param_1[0xf] != 0, 0x39, 0x4a0, add_transport_params_cb, free_transport_params_cb, param_1, parse_transport_params_cb, param_1);
            if (iVar1 == 0) {
               return 0;
            }
   ...
   LAB_00101208:ERR_new();
   uVar4 = 0x2ca;
   LAB_00101219:ERR_set_debug("ssl/quic/quic_tls.c", uVar4, "ossl_quic_tls_configure");
   ERR_set_error(0x14, 0x189, "handshake layer error, error code %llu (0x%llx) (\"%s\")", 1, 1, "internal error");
   if (*(int*)( (long)param_1 + 0x7c ) != 0) {
   ...
   if (( *(byte*)( param_1 + 0x15 ) & 2 ) == 0) {
      ...
      if (( bVar1 & 1 ) == 0) {
         puVar4 = (uint*)*param_1;
         if (( puVar4 == (uint*)0x0 ) || ( ( *puVar4 != 0 && ( ( ( *puVar4 & 0x80 ) == 0 || ( puVar4 = (uint*)ossl_quic_obj_get0_handshake_layer(puVar4) ),puVar4 == (uint*)0x0 ) ) ) )) {
            ERR_new();
            uVar5 = 0x310;
         } else {
            if (*(int*)( param_1 + 0xf ) == 0) {
               if (( *(long*)( puVar4 + 700 ) == 0 ) || ( *(long*)( puVar4 + 0x2be ) == 0 )) {
                  ...
                  ERR_set_error(0x14, 0x189, "handshake layer error, error code %llu (0x%llx) (\"%s\")", 0x178, 0x178, "ALPN must be configured when using QUIC");
                  if (*(int*)( (long)param_1 + 0x7c ) != 0) {
                     OSSL_ERR_STATE_save_to_mark(param_1[0x12]);
                     *(byte*)( param_1 + 0x15 ) = *(byte*)( param_1 + 0x15 ) | 2;
                     param_1[0x13] = 0x178;
         ...
         LAB_00101499:ERR_set_debug("ssl/quic/quic_tls.c", uVar5, "ossl_quic_tls_tick");
         ERR_set_error(0x14, 0x189, "handshake layer error, error code %llu (0x%llx) (\"%s\")", 1, 1, "internal error");
         if (*(int*)( (long)param_1 + 0x7c ) != 0) {
            OSSL_ERR_STATE_save_to_mark(param_1[0x12]);
            *(byte*)( param_1 + 0x15 ) = *(byte*)( param_1 + 0x15 ) | 2;
         ...
         if (iVar2 < 1) {
            ...
            if (iVar2 < 5) {
               if (iVar2 < 2) {
                  LAB_001015fc:ERR_new();
                  uVar5 = 0x346;
                  goto LAB_00101499;
               }
            } else if (1 < iVar2 - 0xbU) goto LAB_001015fc;
            LAB_00101540:ERR_pop_to_mark();
            uVar5 = 1;
            goto LAB_001012e5;
         }
         if (( *(byte*)( param_1 + 0x15 ) & 4 ) != 0) goto LAB_00101540;
         ...
         ERR_set_error(0x14, 0x189, "handshake layer error, error code %llu (0x%llx) (\"%s\")", 0x178, 0x178, "no application protocol negotiated");
         if (*(int*)( (long)param_1 + 0x7c ) != 0) {
            OSSL_ERR_STATE_save_to_mark(param_1[0x12]);
            *(byte*)( param_1 + 0x15 ) = *(byte*)( param_1 + 0x15 ) | 2;
            param_1[0x13] = 0x178;
   ...
   LAB_001012e3:uVar5 = 0;
   LAB_001012e5:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   return uVar5;
   ...
   return bVar1;
}byte ossl_quic_tls_get_error(long param_1, undefined8 *param_2, undefined8 *param_3, undefined8 *param_4) {
   byte bVar1;
   ...
   uint *puVar2;
   puVar2 = (uint*)*param_1;
   if (( ( puVar2 != (uint*)0x0 ) && ( ( ( *puVar2 == 0 || ( ( ( *puVar2 & 0x80 ) != 0 && ( puVar2 = (uint*)ossl_quic_obj_get0_handshake_layer(puVar2) ),puVar2 != (uint*)0x0 ) ) ) ) && ( ( *(byte*)( (long)puVar2 + 0x161 ) & 0x20 ) != 0 ) ) )) {
      if (param_2 == 0) {
         puVar2[0x550] = 0;
         puVar2[0x3c] = 0;
      } else if (puVar2[0x1e] == 0) {
         if (( ( *(long*)( puVar2 + 0x240 ) == 0 ) || ( *(int*)( *(long*)( puVar2 + 0x240 ) + 0x344 ) != -1 ) ) && ( *(long*)( puVar2 + 0x262 ) == 0 )) {
            return 0;
         }
         puVar2[0x3c] = 2;
      } else {

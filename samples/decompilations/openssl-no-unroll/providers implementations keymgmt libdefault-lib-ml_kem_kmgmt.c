...
LAB_00100430:
      ...
      if ((param_1[10] != 0) || (param_1[0xc] == 0)) goto LAB_00100430;
      ptr = (void *)0x0;
LAB_00100360:
...

{
  ...
  uVar3 = 1;
  if ((param_2 & 3) == 0) goto LAB_00100c25;
...
LAB_00100d10:
    ...
    if ((param_2 & 1) == 0) {
      local_98 = __LC12;
      uStack_90 = _UNK_001025d8;
      local_a8 = __LC12;
      uStack_a0 = _UNK_001025d8;
    ...
    if (local_68._0_8_ != local_88 || local_68._8_8_ != local_80) goto LAB_00100d10;
    if (local_58._0_8_ != local_78 || local_58._8_8_ != local_70) goto LAB_00100d10;
    uVar3 = 1;
  }
  CRYPTO_free(ptr);
LAB_00100c25:
...

{
  ...
  if (((iVar6 != 0) && (param_1 != (long *)0x0)) && ((param_2 & 3) != 0)) {
    local_70 = (void *)0x0;
    local_68 = 0;
    local_60 = 0;
    local_58 = 0;
    ...
    if (param_1[8] == 0) {
      ...
      if ((param_2 & 1) == 0) {
LAB_00100f30:
        lVar8 = OSSL_PARAM_locate_const(param_3,&_LC3);
        if ((lVar8 == 0) ||
           (iVar6 = OSSL_PARAM_get_octet_string_ptr(lVar8,&local_70,&local_58), iVar6 == 1)) {
          uVar5 = local_48;
          lVar4 = local_50;
          lVar8 = local_68;
          if (local_58 == 0) {
...
LAB_00100fc3:
              iVar6 = ossl_ml_kem_parse_private_key(lVar8,lVar4,param_1);
              bVar3 = 0 < iVar6;
            }
            else {
              if (local_50 != 0) {
LAB_0010108e:
                if ((*(byte *)(param_1 + 0xd) & 4) == 0) goto LAB_00100fc3;
                plVar1 = (long *)(lVar8 + -0x20 + *(long *)(*param_1 + 8));
                if ((*(long *)(local_60 + 0x20) != *plVar1 ||
                     *(long *)(local_60 + 0x28) != plVar1[1]) ||
                   (*(long *)(local_60 + 0x30) != plVar1[2] ||
                    *(long *)(local_60 + 0x38) != plVar1[3])) {
                  ERR_new();
                  ERR_set_debug("providers/implementations/keymgmt/ml_kem_kmgmt.c",0x15e,
                                "check_seed");
                  ERR_set_error(0x39,0x9e,
                                "private %s key implicit rejection secret does not match seed",
                                *(undefined8 *)*param_1);
                  goto LAB_00100dff;
                }
              }
LAB_0010114b:
              lVar8 = ossl_ml_kem_set_seed(local_60,uVar5,param_1);
              if (((lVar8 == 0) || (iVar6 = ossl_ml_kem_genkey(0,0,param_1), iVar6 == 0)) ||
                 ((local_50 != 0 && (iVar6 = check_prvenc(local_68,param_1), iVar6 == 0))))
              goto LAB_00100dff;
              bVar3 = true;
              iVar6 = 1;
            }
            ...
            if (local_58 != puVar2[3]) {
              ERR_new();
              uVar9 = 0x1a9;
LAB_00100f08:
              ERR_set_debug("providers/implementations/keymgmt/ml_kem_kmgmt.c",uVar9,
                            "ml_kem_key_fromdata");
              ERR_set_error(0x39,0x69,0);
              goto LAB_00100dff;
            }
            if (local_48 != 0) {
              if (local_50 == 0) goto LAB_0010114b;
LAB_00100f93:
              iVar6 = memcmp(local_70,(void *)(((local_50 + -0x40) - local_58) + local_68),local_58)
              ;
              if (iVar6 == 0) {
                if (uVar5 != 0) goto LAB_0010108e;
                goto LAB_00100fc3;
              }
              ERR_new();
              ERR_set_debug("providers/implementations/keymgmt/ml_kem_kmgmt.c",0x1b8,
                            "ml_kem_key_fromdata");
              ERR_set_error(0x39,0x9e,"explicit %s public key does not match private",*puVar2);
              goto LAB_00100dff;
            }
            if (local_50 != 0) goto LAB_00100f93;
            iVar6 = ossl_ml_kem_parse_public_key(local_70,local_58,param_1);
            bVar3 = 0 < iVar6;
          }
          if ((((param_2 & 1) == 0) || (!bVar3)) ||
             (iVar7 = ml_kem_pairwise_test(param_1,(int)param_1[0xd]), iVar7 != 0))
          goto LAB_00100e08;
          ossl_ml_kem_key_reset(param_1);
        }
      }
      else {
        lVar8 = OSSL_PARAM_locate_const(param_3,&_LC1);
        if ((lVar8 == 0) ||
           (iVar6 = OSSL_PARAM_get_octet_string_ptr(lVar8,&local_60,&local_48), iVar6 == 1)) {
          if ((local_48 & 0xffffffffffffffbf) == 0) {
            lVar8 = OSSL_PARAM_locate_const(param_3,&_LC2);
            if ((lVar8 == 0) ||
               (iVar6 = OSSL_PARAM_get_octet_string_ptr(lVar8,&local_68,&local_50), iVar6 == 1)) {
              if ((local_50 == 0) || (local_50 == puVar2[1])) goto LAB_00100f30;
              ERR_new();
              uVar9 = 0x19e;
              goto LAB_00100f08;
            }
...
LAB_0010139c:
    ...
    if (iVar1 == 0) {
      if (plVar2[0xc] != 0) {
LAB_00101373:
        if ((*(byte *)(plVar2 + 0xd) & 4) != 0) {
          iVar1 = ossl_ml_kem_genkey(0,0,plVar2);
          if (iVar1 != 0) {
            iVar1 = check_prvenc(ptr,plVar2);
            goto joined_r0x00101415;
          }
          goto LAB_001013c4;
        }
      }
      ...
      lVar4 = *(long *)(*plVar2 + 8);
      plVar3 = (long *)((long)ptr + lVar4 + -0x20);
      if ((local_48 != *plVar3 || local_40 != plVar3[1]) ||
         (local_38 != plVar3[2] || local_30 != plVar3[3])) {
        ERR_new();
      ...
      if (plVar2[0xc] != 0) goto LAB_00101373;
    }
    iVar1 = ossl_ml_kem_parse_private_key(ptr,lVar4,plVar2);
    if (iVar1 == 0) {
      ERR_new();
...
undefined8 * ml_kem_768_gen_init(undefined8 param_1,uint param_2,long *param_3)

{
  ...
  if ((iVar1 != 0) && ((param_2 & 5) != 0)) {
    ...
    if (ptr != (undefined8 *)0x0) {
      ...
      *ptr = param_1;
      if ((param_3 == (long *)0x0) || (*param_3 == 0)) goto LAB_00101610;
      lVar2 = OSSL_PARAM_locate_const(param_3,"properties");
      if (lVar2 == 0) {
LAB_00101667:
        lVar2 = OSSL_PARAM_locate_const(param_3,&_LC1);
        if (lVar2 == 0) goto LAB_00101610;
        ptr[0xb] = ptr + 3;
        local_38 = 0x40;
        iVar1 = OSSL_PARAM_get_octet_string(lVar2,ptr + 0xb,0x40,&local_38);
        if ((iVar1 != 0) && (local_38 == 0x40)) goto LAB_00101610;
        ERR_new();
        ERR_set_debug("providers/implementations/keymgmt/ml_kem_kmgmt.c",0x2c3,
                      "ml_kem_gen_set_params");
        ERR_set_error(0x39,0x9a,0);
        ...
        if (*(int *)(lVar2 + 8) == 4) {
          ...
          pcVar3 = CRYPTO_strdup(*(char **)(lVar2 + 0x10),
                                 "providers/implementations/keymgmt/ml_kem_kmgmt.c",0x2b5);
          ptr[1] = pcVar3;
          if (pcVar3 != (char *)0x0) goto LAB_00101667;
        }
...
undefined8 * ml_kem_512_gen_init(undefined8 param_1,uint param_2,long *param_3)

{
  ...
  if ((iVar1 != 0) && ((param_2 & 5) != 0)) {
    ...
    if (ptr != (undefined8 *)0x0) {
      ...
      *ptr = param_1;
      if ((param_3 == (long *)0x0) || (*param_3 == 0)) goto LAB_001017c0;
      lVar2 = OSSL_PARAM_locate_const(param_3,"properties");
      if (lVar2 == 0) {
LAB_00101817:
        lVar2 = OSSL_PARAM_locate_const(param_3,&_LC1);
        if (lVar2 == 0) goto LAB_001017c0;
        ptr[0xb] = ptr + 3;
        local_38 = 0x40;
        iVar1 = OSSL_PARAM_get_octet_string(lVar2,ptr + 0xb,0x40,&local_38);
        if ((iVar1 != 0) && (local_38 == 0x40)) goto LAB_001017c0;
        ERR_new();
        ERR_set_debug("providers/implementations/keymgmt/ml_kem_kmgmt.c",0x2c3,
                      "ml_kem_gen_set_params");
        ERR_set_error(0x39,0x9a,0);
        ...
        if (*(int *)(lVar2 + 8) == 4) {
          ...
          pcVar3 = CRYPTO_strdup(*(char **)(lVar2 + 0x10),
                                 "providers/implementations/keymgmt/ml_kem_kmgmt.c",0x2b5);
          ptr[1] = pcVar3;
          if (pcVar3 != (char *)0x0) goto LAB_00101817;
        }
        if ((void *)ptr[0xb] != (void *)0x0) {
          OPENSSL_cleanse((void *)ptr[0xb],0x20);
        }
...
undefined8 * ml_kem_1024_gen_init(undefined8 param_1,uint param_2,long *param_3)

{
  ...
  if ((iVar1 != 0) && ((param_2 & 5) != 0)) {
    ...
    if (ptr != (undefined8 *)0x0) {
      ...
      *ptr = param_1;
      if ((param_3 == (long *)0x0) || (*param_3 == 0)) goto LAB_00101970;
      lVar2 = OSSL_PARAM_locate_const(param_3,"properties");
      if (lVar2 == 0) {
LAB_001019c7:
        lVar2 = OSSL_PARAM_locate_const(param_3,&_LC1);
        if (lVar2 == 0) goto LAB_00101970;
        ptr[0xb] = ptr + 3;
        local_38 = 0x40;
        iVar1 = OSSL_PARAM_get_octet_string(lVar2,ptr + 0xb,0x40,&local_38);
        if ((iVar1 != 0) && (local_38 == 0x40)) goto LAB_00101970;
        ERR_new();
        ERR_set_debug("providers/implementations/keymgmt/ml_kem_kmgmt.c",0x2c3,
                      "ml_kem_gen_set_params");
        ERR_set_error(0x39,0x9a,0);
        ...
        if (*(int *)(lVar2 + 8) == 4) {
          ...
          pcVar3 = CRYPTO_strdup(*(char **)(lVar2 + 0x10),
                                 "providers/implementations/keymgmt/ml_kem_kmgmt.c",0x2b5);
          ptr[1] = pcVar3;
          if (pcVar3 != (char *)0x0) goto LAB_001019c7;
        }
        if ((void *)ptr[0xb] != (void *)0x0) {
          OPENSSL_cleanse((void *)ptr[0xb],0x20);
        }

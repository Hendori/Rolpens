  ...
  if (*(long *)(param_1 + 0x198) + *(long *)(param_1 + 0x1a0) + *(long *)(param_1 + 0x1a8) == 0) {
    ...
    *param_2 = (uint)(*(char *)(param_1 + 0x1ca) != '\0');
    ...
    if ((*(long *)(param_1 + 0x198) != 0) &&
       ((uVar6 = uVar9 + *(ulong *)(param_1 + 0x138), CARRY8(uVar9,*(ulong *)(param_1 + 0x138)) ||
        (uVar6 == 0xffffffffffffffff)))) {
      uVar6 = 0xffffffffffffffff;
    }
    uVar10 = 0;
...
LAB_00100474:
    ...
    *(ulong *)(param_1 + 0x168) = uVar2;
    if (UNRECOVERED_JUMPTABLE != (code *)0x0) {
      ...
      if (local_10 == *(long *)(in_FS_OFFSET + 0x28)) {
LAB_0010042e:
                    /* WARNING: Could not recover jumptable at 0x00100433. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        (*UNRECOVERED_JUMPTABLE)(uVar2,uVar4);
        return;
      }
      goto LAB_0010049e;
    }
...

{
  ...
  if (((((param_2[2] != 0) &&
        (uVar7 = (ulong)uVar5, *(ulong *)(param_1 + 0x138 + uVar7 * 8) <= param_2[2])) &&
       (param_2[1] != 0)) &&
...
LAB_001011df:
    ...
    local_14 = 0;
LAB_00101292:
    if ((uVar3 <= uVar2) && (uVar3 < uVar2)) goto LAB_001011df;
  }
  *(ulong *)(param_1 + 0x168) = uVar2;
  if (*(code **)(param_1 + 0x940) != (code *)0x0) {
...
LAB_00101301:
    ...
    uVar6 = 0;
LAB_001013a2:
    if (uVar5 < uVar3) goto LAB_00101301;
  }

...
undefined8 ecdsa_sign_message_final(undefined8 *param_1,uchar *param_2,ulong *param_3,ulong param_4)

{
  ...
  if (((param_1 != (undefined8 *)0x0) && (iVar1 != 0)) &&
     ((EVP_MD_CTX *)param_1[0x2d] != (EVP_MD_CTX *)0x0)) {
...
LAB_00100392:
      ...
      iVar1 = EVP_DigestFinal_ex((EVP_MD_CTX *)param_1[0x2d],local_88,&local_90);
      dgstlen = local_90;
      if (iVar1 != 0) {
        iVar1 = ECDSA_size((EC_KEY *)param_1[2]);
        iVar2 = ossl_prov_is_running();
        if (((iVar2 != 0) && ((ulong)(long)iVar1 <= param_4)) &&
           ((param_1[0x2e] == 0 || ((ulong)dgstlen == param_1[0x2e])))) {
          if (*(int *)(param_1 + 0x33) == 0) {
            iVar1 = ECDSA_sign_ex(0,local_88,dgstlen,param_2,&local_8c,(BIGNUM *)param_1[0x31],
            ...
            iVar1 = ossl_ecdsa_deterministic_sign
                              (local_88,dgstlen,param_2,&local_8c,(EC_KEY *)param_1[2],
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  local_1a0 = 0;
  if (param_1 == 0) goto LAB_00100af0;
...

{
  ...
  if ((param_1 != 0) && (iVar1 != 0)) {
    if (param_2 == (EC_KEY *)0x0) {
      if (*(long *)(param_1 + 0x10) != 0) goto LAB_00100f37;
      ERR_new();
...

{
  ...
  if ((param_1 != 0) && (iVar1 != 0)) {
    if (param_2 == (EC_KEY *)0x0) {
      if (*(long *)(param_1 + 0x10) != 0) goto LAB_00100ff7;
      ERR_new();
      ERR_set_debug("providers/implementations/signature/ecdsa_sig.c",0x119,"ecdsa_signverify_init")
      ;
      ERR_set_error(0x39,0x72,0);
...
undefined8 ecdsa_digest_verify_init(long param_1,char *param_2,EC_KEY *param_3,undefined8 param_4)
...

{
  ...
  ptr = (undefined8 *)CRYPTO_zalloc(0x1a0,"providers/implementations/signature/ecdsa_sig.c",0x27d);
  ...
  *(undefined1 (*) [16])(ptr + 1) = (undefined1  [16])0x0;
  if ((((key == (EC_KEY *)0x0) || (iVar2 = EC_KEY_up_ref(key), iVar2 != 0)) && (param_1[0x31] == 0))
    ...
    if (lVar1 != 0) {
      ...
      ptr[0x2d] = out;
      if (out == (EVP_MD_CTX *)0x0) goto LAB_001012e7;
    ...
    pcVar3 = CRYPTO_strdup((char *)param_1[1],"providers/implementations/signature/ecdsa_sig.c",
                           0x298);
    ptr[1] = pcVar3;
    if (pcVar3 != (char *)0x0) {
      return ptr;
...
LAB_001012e0:
  out = (EVP_MD_CTX *)ptr[0x2d];
LAB_001012e7:
  EVP_MD_CTX_free(out);
  EVP_MD_free(ptr[0x2c]);
  CRYPTO_free((void *)ptr[1]);
  CRYPTO_free((void *)ptr[0x2f]);
  EC_KEY_free((EC_KEY *)ptr[2]);
  BN_clear_free((BIGNUM *)ptr[0x31]);
  BN_clear_free((BIGNUM *)ptr[0x32]);
  CRYPTO_free(ptr);
  return (undefined8 *)0x0;
}
...
undefined8 ecdsa_sha384_verify_init(long param_1,EC_KEY *param_2,undefined8 param_3)

{
  ...
  *(undefined4 *)(param_1 + 0x18) = 0x20;
  ...
  iVar1 = ecdsa_setup_md_isra_0(param_1,"SHA2-384",0);
  if (iVar1 == 0) {
    return 0;
  }
  lVar2 = *(long *)(param_1 + 0x168);
...
undefined8 ecdsa_digest_sign_init(long param_1,char *param_2,EC_KEY *param_3,undefined8 param_4)
...
undefined8
ecdsa_sign(undefined8 *param_1,uchar *param_2,ulong *param_3,ulong param_4,uchar *param_5,
          ulong param_6)

{
  ...
  if (*(int *)(param_1 + 3) == 0x4000) {
    if (param_2 == (uchar *)0x0) {
      ...
      iVar1 = EVP_DigestUpdate((EVP_MD_CTX *)param_1[0x2d],param_5,param_6);
      if (0 < iVar1) {
        if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
          uVar4 = ecdsa_sign_message_final(param_1,param_2,param_3,param_4);
          return uVar4;
        }
        goto LAB_0010180b;
      }
...
LAB_0010167d:
    ...
    iVar1 = ECDSA_size((EC_KEY *)param_1[2]);
    iVar2 = ossl_prov_is_running();
    if (iVar2 == 0) goto LAB_0010167d;
    if (param_2 != (uchar *)0x0) {
      if (((ulong)(long)iVar1 <= param_4) && ((param_1[0x2e] == 0 || (param_6 == param_1[0x2e])))) {
        if (*(int *)(param_1 + 0x33) == 0) {
...
undefined8 ecdsa_digest_sign_final(undefined8 *param_1,uchar *param_2,ulong *param_3,ulong param_4)

{
  ...
  if ((*(byte *)((long)param_1 + 0x1c) & 1) != 0) goto LAB_00101844;
  local_90 = 0;
  iVar1 = ossl_prov_is_running();
  if ((iVar1 == 0) || ((EVP_MD_CTX *)param_1[0x2d] == (EVP_MD_CTX *)0x0)) {
LAB_00101978:
    uVar4 = 0;
  }
  else {
    if (param_2 != (uchar *)0x0) {
      ...
      if (iVar1 != 0) {
        ...
        iVar2 = ossl_prov_is_running();
        if (((iVar2 != 0) && ((ulong)(long)iVar1 <= param_4)) &&
           (((ulong)dgstlen == param_1[0x2e] || (param_1[0x2e] == 0)))) {
          if (*(int *)(param_1 + 0x33) == 0) {
            iVar1 = ECDSA_sign_ex(0,local_88,dgstlen,param_2,&local_8c,(BIGNUM *)param_1[0x31],
                                  (BIGNUM *)param_1[0x32],(EC_KEY *)param_1[2]);
          }
...
undefined8 ecdsa_sha3_384_verify_init(long param_1,EC_KEY *param_2,undefined8 param_3)

{
  ...
  *(undefined4 *)(param_1 + 0x18) = 0x20;
  ...
  iVar1 = ecdsa_setup_md_isra_0(param_1,"SHA3-384",0);
  if (iVar1 == 0) {
    return 0;
  }
  lVar2 = *(long *)(param_1 + 0x168);
...
undefined8 ecdsa_sha3_384_verify_message_init(long param_1,EC_KEY *param_2,undefined8 param_3)
...
undefined8 ecdsa_sha3_512_sign_init(long param_1,EC_KEY *param_2,undefined8 param_3)

{
  ...
  *(undefined4 *)(param_1 + 0x18) = 0x10;
  ...
  iVar1 = ecdsa_setup_md_isra_0(param_1,"SHA3-512",0);
  if (iVar1 == 0) {
    return 0;
  }
  lVar2 = *(long *)(param_1 + 0x168);
...
undefined8 ecdsa_sha3_512_sign_message_init(long param_1,EC_KEY *param_2,undefined8 param_3)
...
undefined8 ecdsa_sha3_512_verify_init(long param_1,EC_KEY *param_2,undefined8 param_3)
...
undefined8 ecdsa_sha3_384_sign_message_init(long param_1,EC_KEY *param_2,undefined8 param_3)
...
undefined8 ecdsa_sha3_256_verify_message_init(long param_1,EC_KEY *param_2,undefined8 param_3)

{
  ...
  *(undefined4 *)(param_1 + 0x18) = 0x8000;
  ...
  iVar1 = ecdsa_setup_md_isra_0(param_1,"SHA3-256",0);
  if (iVar1 == 0) {
    return 0;
  }
  lVar2 = *(long *)(param_1 + 0x168);
...
undefined8 ecdsa_sha3_384_sign_init(long param_1,EC_KEY *param_2,undefined8 param_3)
...
undefined8 ecdsa_sha3_224_verify_message_init(long param_1,EC_KEY *param_2,undefined8 param_3)

{
  ...
  *(undefined4 *)(param_1 + 0x18) = 0x8000;
  ...
  iVar1 = ecdsa_setup_md_isra_0(param_1,"SHA3-224",0);
  if (iVar1 == 0) {
    return 0;
  }
  lVar2 = *(long *)(param_1 + 0x168);
...
undefined8 ecdsa_sha3_256_sign_init(long param_1,EC_KEY *param_2,undefined8 param_3)
...
undefined8 ecdsa_sha3_256_sign_message_init(long param_1,EC_KEY *param_2,undefined8 param_3)
...
undefined8 ecdsa_sha3_256_verify_init(long param_1,EC_KEY *param_2,undefined8 param_3)
...
undefined8 ecdsa_sha384_verify_message_init(long param_1,EC_KEY *param_2,undefined8 param_3)
...
undefined8 ecdsa_sha512_sign_init(long param_1,EC_KEY *param_2,undefined8 param_3)

{
  ...
  *(undefined4 *)(param_1 + 0x18) = 0x10;
  ...
  iVar1 = ecdsa_setup_md_isra_0(param_1,"SHA2-512",0);
  if (iVar1 == 0) {
    return 0;
  }
  lVar2 = *(long *)(param_1 + 0x168);
...
undefined8 ecdsa_sha512_sign_message_init(long param_1,EC_KEY *param_2,undefined8 param_3)
...
undefined8 ecdsa_sha512_verify_init(long param_1,EC_KEY *param_2,undefined8 param_3)
...
undefined8 ecdsa_sha512_verify_message_init(long param_1,EC_KEY *param_2,undefined8 param_3)
...
undefined8 ecdsa_sha3_224_sign_init(long param_1,EC_KEY *param_2,undefined8 param_3)
...
undefined8 ecdsa_sha3_224_sign_message_init(long param_1,EC_KEY *param_2,undefined8 param_3)
...
undefined8 ecdsa_sha3_224_verify_init(long param_1,EC_KEY *param_2,undefined8 param_3)
...
undefined8 ecdsa_sha3_512_verify_message_init(long param_1,EC_KEY *param_2,undefined8 param_3)
...
undefined8 ecdsa_sha1_sign_init(long param_1,EC_KEY *param_2,undefined8 param_3)

{
  ...
  *(undefined4 *)(param_1 + 0x18) = 0x10;
  ...
  iVar1 = ecdsa_setup_md_isra_0(param_1,&_LC17,0);
  if (iVar1 == 0) {
    return 0;
  }
  lVar2 = *(long *)(param_1 + 0x168);
...
undefined8 ecdsa_sha1_sign_message_init(long param_1,EC_KEY *param_2,undefined8 param_3)
...
undefined8 ecdsa_sha1_verify_init(long param_1,EC_KEY *param_2,undefined8 param_3)
...
undefined8 ecdsa_sha1_verify_message_init(long param_1,EC_KEY *param_2,undefined8 param_3)
...
undefined8 ecdsa_sha224_sign_init(long param_1,EC_KEY *param_2,undefined8 param_3)

{
  ...
  *(undefined4 *)(param_1 + 0x18) = 0x10;
  ...
  iVar1 = ecdsa_setup_md_isra_0(param_1,"SHA2-224",0);
  if (iVar1 == 0) {
    return 0;
  }
  lVar2 = *(long *)(param_1 + 0x168);
...
undefined8 ecdsa_sha224_sign_message_init(long param_1,EC_KEY *param_2,undefined8 param_3)
...
undefined8 ecdsa_sha224_verify_init(long param_1,EC_KEY *param_2,undefined8 param_3)
...
undefined8 ecdsa_sha224_verify_message_init(long param_1,EC_KEY *param_2,undefined8 param_3)
...
undefined8 ecdsa_sha256_sign_init(long param_1,EC_KEY *param_2,undefined8 param_3)

{
  ...
  *(undefined4 *)(param_1 + 0x18) = 0x10;
  ...
  iVar1 = ecdsa_setup_md_isra_0(param_1,"SHA2-256",0);
  if (iVar1 == 0) {
    return 0;
  }
  lVar2 = *(long *)(param_1 + 0x168);
...
undefined8 ecdsa_sha256_sign_message_init(long param_1,EC_KEY *param_2,undefined8 param_3)
...
undefined8 ecdsa_sha256_verify_init(long param_1,EC_KEY *param_2,undefined8 param_3)
...
undefined8 ecdsa_sha256_verify_message_init(long param_1,EC_KEY *param_2,undefined8 param_3)
...
undefined8 ecdsa_sha384_sign_init(long param_1,EC_KEY *param_2,undefined8 param_3)
...
undefined8 ecdsa_sha384_sign_message_init(long param_1,EC_KEY *param_2,undefined8 param_3)

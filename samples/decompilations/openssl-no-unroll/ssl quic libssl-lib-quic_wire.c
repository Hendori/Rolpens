...

{
  ...
  uVar10 = uVar11;
  if ((((((uVar1 == 0) ||
         (uVar2 = uVar5, uVar5 = uVar7, uVar6 = uVar12, uVar8 = uVar13, uVar10 = uVar3, uVar1 < 0x40
         )) || (uVar2 = uVar7, uVar5 = uVar12, uVar6 = uVar9, uVar8 = uVar4, uVar10 = uVar14,
               uVar1 < 0x4000)) ||
       ((uVar2 = uVar9, uVar5 = uVar13, uVar6 = uVar4, uVar8 = uVar11, uVar10 = uVar15,
        uVar1 < 0x40000000 ||
        (uVar2 = uVar11, uVar4 = 0, uVar5 = uVar3, uVar6 = uVar14, uVar8 = uVar15, uVar10 = uVar16,
        uVar1 >> 0x3e == 0)))) &&
      ((uVar4 = uVar2, (param_1[4] & 1) != 0 &&
       ((uVar1 = param_1[2], uVar4 = uVar5, 0x3f < uVar1 && (uVar4 = uVar6, 0x3fff < uVar1)))))) &&
     (uVar4 = uVar8, 0x3fffffff < uVar1)) {
    uVar2 = 0;
        ...
        if (uStack_30 != 0) {
          ...
          if (uVar4 <= uStack_30) {
            ...
            if (lVar2 != 0) {
              do {
                if ((uStack_30 == 0) ||
                   (uVar4 = (ulong)(uint)(1 << (*local_38 >> 6)), uStack_30 < uVar4))
                goto LAB_00101008;
                local_38 = local_38 + uVar4;
                uStack_30 = uStack_30 - uVar4;
                if ((uStack_30 == 0) ||
...

{
  ...
  uVar6 = local_48;
  if ((((iVar7 != 0) && ((local_48 & 0xfffffffffffffffe) == 2)) && (param_1[1] != 0)) &&
     (uVar16 = (ulong)(uint)(1 << (*(byte *)*param_1 >> 6)), uVar16 <= (ulong)param_1[1])) {
    ...
    *param_1 = (long)(lVar1 + uVar16);
    param_1[1] = uVar9;
    if ((uVar9 != 0) &&
       (uVar16 = (ulong)(uint)(1 << (*(byte *)(lVar1 + uVar16) >> 6)), uVar16 <= uVar9)) {
      ...
      *param_1 = (long)(lVar1 + uVar16);
      param_1[1] = uVar13;
      if ((uVar13 != 0) &&
         (uVar16 = (ulong)(uint)(1 << (*(byte *)(lVar1 + uVar16) >> 6)), uVar16 <= uVar13)) {
        ...
        *param_1 = (long)(lVar1 + uVar16);
        param_1[1] = uVar14;
        if ((uVar14 != 0) &&
           (uVar16 = (ulong)(uint)(1 << (*(byte *)(lVar1 + uVar16) >> 6)), uVar16 <= uVar14)) {
          ...
          if (uVar14 <= uVar8) {
            ...
            if (param_3 == (long *)0x0) {
              if (uVar13 != 0) {
                uVar8 = 0;
                do {
                  if ((uVar16 == 0) || (uVar9 = (ulong)(uint)(1 << (*pbVar17 >> 6)), uVar16 < uVar9)
                     ) goto LAB_00101192;
                  ...
                  *param_1 = (long)(lVar1 + uVar9);
                  param_1[1] = uVar11;
                  if ((uVar11 == 0) ||
                     (uVar16 = (ulong)(uint)(1 << (*(byte *)(lVar1 + uVar9) >> 6)), uVar11 < uVar16)
                     ) goto LAB_00101192;
                  uVar9 = ossl_quic_vlint_decode_unchecked();
                  pbVar17 = (byte *)(*param_1 + uVar16);
                  uVar16 = param_1[1] - uVar16;
              ...
              if ((auVar5._8_8_ != 0) ||
                 (auVar3._8_8_ = 0, auVar3._0_8_ = auVar5._0_8_, auVar5 = auVar3 * ZEXT816(1000),
                 auVar5._8_8_ != 0)) {
...
LAB_00101321:
                  ...
                  do {
                    if ((uVar16 == 0) ||
                       (uVar9 = (ulong)(uint)(1 << (*pbVar17 >> 6)), uVar16 < uVar9))
                    goto LAB_00101192;
                    lVar10 = ossl_quic_vlint_decode_unchecked(pbVar17);
                    lVar1 = *param_1;
                    uVar11 = param_1[1] - uVar9;
                    *param_1 = (long)(lVar1 + uVar9);
                    param_1[1] = uVar11;
                    if ((uVar11 == 0) ||
                       (uVar16 = (ulong)(uint)(1 << (*(byte *)(lVar1 + uVar9) >> 6)),
                       uVar11 < uVar16)) goto LAB_00101192;
                    uVar9 = ossl_quic_vlint_decode_unchecked();
                    pbVar17 = (byte *)(*param_1 + uVar16);
                    uVar16 = param_1[1] - uVar16;
...
LAB_0010142a:
              ...
              if (uVar6 == 3) {
LAB_0010156d:
                iVar7 = PACKET_get_quic_vlint(param_1,&local_58);
                if (((iVar7 == 0) || (iVar7 = PACKET_get_quic_vlint(param_1,&local_50), iVar7 == 0))
                   || (iVar7 = PACKET_get_quic_vlint(param_1,&local_48), iVar7 == 0))
                goto LAB_00101192;
                if (param_3 != (long *)0x0) {
...
undefined8 ossl_quic_wire_decode_frame_reset_stream(undefined8 param_1)

{
  ...
  iVar1 = ossl_quic_wire_skip_frame_header(param_1,auStack_38);
  if (iVar1 != 0) {
...
undefined8 ossl_quic_wire_decode_frame_stop_sending(undefined8 param_1)
...
undefined8 ossl_quic_wire_decode_frame_crypto(undefined8 param_1)
...
undefined8 ossl_quic_wire_decode_frame_new_token(undefined8 param_1)
...

{
  ...
  if ((((iVar3 != 0) && ((local_48 & 0xfffffffffffffff8) == 8)) && (param_1[1] != 0)) &&
     (uVar5 = (ulong)(uint)(1 << (*(byte *)*param_1 >> 6)), uVar5 <= (ulong)param_1[1])) {
    ...
    *param_1 = (long)pbVar7;
    ...
    if ((local_48 & 4) == 0) {
      ...
      if ((uVar5 == 0) || (uVar8 = (ulong)(uint)(1 << (*pbVar7 >> 6)), uVar5 < uVar8))
      goto LAB_001019f8;
...
undefined8 ossl_quic_wire_decode_frame_max_data(undefined8 param_1)

{
  ...
  local_20 = *(long *)(in_FS_OFFSET + 0x28);
  iVar1 = ossl_quic_wire_skip_frame_header(param_1,auStack_28);
  if (iVar1 != 0) {
                    /* WARNING: Unimplemented instruction - Truncating control flow here */
    halt_unimplemented();
  }
...
undefined8 ossl_quic_wire_decode_frame_max_stream_data(undefined8 param_1)
...
undefined8 ossl_quic_wire_decode_frame_data_blocked(undefined8 param_1)
...
undefined8 ossl_quic_wire_decode_frame_stream_data_blocked(undefined8 param_1)
...
undefined8 ossl_quic_wire_decode_frame_new_conn_id(undefined8 param_1)
...
undefined8 ossl_quic_wire_decode_frame_retire_conn_id(undefined8 param_1)
...
undefined8 ossl_quic_wire_decode_frame_path_challenge(undefined8 param_1)
...
undefined8 ossl_quic_wire_decode_frame_path_response(undefined8 param_1)
...
void ossl_quic_wire_decode_frame_handshake_done(undefined8 param_1)

{
  ...
  local_10 = *(long *)(in_FS_OFFSET + 0x28);
  iVar1 = ossl_quic_wire_skip_frame_header(param_1,auStack_18);
  if (iVar1 != 0) {
                    /* WARNING: Unimplemented instruction - Truncating control flow here */
    halt_unimplemented();
  }
        ...
        if (bVar2 < 8) {
          if ((bVar2 & 4) == 0) {
            if ((bVar2 != 0) &&
               ...
               (bVar2 & 2) != 0)) {
              *(undefined2 *)((long)param_2 + uVar12 + 0x27) =
                   *(undefined2 *)((long)puVar7 + uVar12 + 0x17);
            }
          }
          else {
            *(undefined4 *)((long)param_2 + 0x29) = *(undefined4 *)((long)puVar7 + 0x19);
            *(undefined4 *)((long)param_2 + uVar12 + 0x25) =
                 *(undefined4 *)((long)puVar7 + uVar12 + 0x15);
          }
        }
        else {
          uVar11 = (long)param_2 + 0x31U & 0xfffffffffffffff8;
          *(undefined8 *)((long)param_2 + 0x29) = *(undefined8 *)((long)puVar7 + 0x19);
          *(undefined8 *)((long)param_2 + uVar12 + 0x21) =
               *(undefined8 *)((long)puVar7 + uVar12 + 0x11);

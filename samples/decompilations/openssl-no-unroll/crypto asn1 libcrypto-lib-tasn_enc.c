...
ulong asn1_i2d_ex_primitive(long *param_1,uchar **param_2,char *param_3,int param_4,int param_5)

{
  ...
  if ((*(long *)(param_3 + 0x20) == 0) ||
     (pcVar2 = *(code **)(*(long *)(param_3 + 0x20) + 0x30), pcVar2 == (code *)0x0)) {
    plVar4 = param_1;
    if (*param_3 == '\0') {
      if (lVar7 == 1) {
        if ((int)*param_1 != -1) {
...
LAB_001001d6:
        ...
        if (local_4c + 1U < 0xc) {
          ...
          uVar6 = (*(code *)(&DAT_001013a0 + *(int *)(&DAT_001013a0 + (ulong)(local_4c + 1U) * 4)))
                            (param_1,plVar4,
                             &DAT_001013a0 + *(int *)(&DAT_001013a0 + (ulong)(local_4c + 1U) * 4));
          return uVar6;
        }
...
switchD_00100261_caseD_ffffffff:
        if (constructed == 0) {
...

{
  ...
  if (it->itype == '\0') {
    ...
    if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
LAB_0010080d:
      iVar2 = asn1_i2d_ex_primitive(pval,out,it,uVar4,uVar8);
      return iVar2;
    }
    goto LAB_00100a54;
  }

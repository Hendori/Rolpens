  ...
  if (enc == 0) {
    ...
    if (7 < length) {
      ...
      do {
        ...
        *(ulong *)output =
             (((((((ulong)(uVar7 >> 0x18) << 8 | (ulong)(uVar7 >> 0x10 & 0xff)) << 8 |
                 (ulong)(uVar7 >> 8 & 0xff)) << 8 | (ulong)(uVar7 & 0xff)) << 8 |
               (ulong)(uVar8 >> 0x18)) << 8 | (ulong)(uVar8 >> 0x10 & 0xff)) << 8 |
             (ulong)(uVar8 >> 8 & 0xff)) << 8 | (ulong)(uVar8 & 0xff);
        uVar12 = (ulong)uVar15;
...
switchD_00102d1f_caseD_3:
    puVar4[-1] = (char)(uVar8 >> 0x10);
    puVar9 = puVar4 + -1;
LAB_00102d57:
    puVar4 = puVar9 + -1;
    puVar9[-1] = (char)(uVar8 >> 8);
switchD_00102d1f_caseD_1:
    puVar4[-1] = (char)uVar8;
  ...
  if (-1 < (long)uVar3) {
    ...
    do {
      ...
      *(ulong *)output =
           (((((((ulong)(uVar11 >> 0x18) << 8 | (ulong)(uVar11 >> 0x10 & 0xff)) << 8 |
               (ulong)(uVar11 >> 8 & 0xff)) << 8 | (ulong)(uVar11 & 0xff)) << 8 |
             (ulong)((uint)local_48 >> 0x18)) << 8 | (ulong)((uint)local_48 >> 0x10 & 0xff)) << 8 |
...
LAB_00102e50:
  uVar15 = (puVar5[-1] | uVar7) ^ uVar15;
  auVar19[4] = (char)uVar11;
  auVar19[5] = (char)(uVar11 >> 8);
  auVar19[6] = (char)(uVar11 >> 0x10);
  auVar19[7] = (char)(uVar11 >> 0x18);
  auVar19[0] = (char)uVar15;
  auVar19[1] = (char)(uVar15 >> 8);
  auVar19[2] = (char)(uVar15 >> 0x10);
  auVar19[3] = (char)(uVar15 >> 0x18);
switchD_00102b6c_caseD_0:
  local_48 = auVar19;
  DES_encrypt1((uint *)&local_48,schedule,1);
...
LAB_00102d9a:
  *ivec = (DES_cblock)
          ((((((((ulong)(uVar7 >> 0x18) << 8 | (ulong)(uVar7 >> 0x10 & 0xff)) << 8 |
               (ulong)(uVar7 >> 8 & 0xff)) << 8 | (ulong)(uVar7 & 0xff)) << 8 |
             (ulong)(uVar15 >> 0x18)) << 8 | (ulong)bVar13) << 8 | (ulong)bVar6) << 8 | uVar3);
  ...
  if (enc == 0) {
    ...
    if (7 < length) {
      ...
      do {
        ...
        *puVar17 = (((((((ulong)(uVar10 >> 0x18) << 8 | (ulong)(uVar10 >> 0x10 & 0xff)) << 8 |
                       (ulong)(uVar10 >> 8 & 0xff)) << 8 | (ulong)(uVar10 & 0xff)) << 8 |
                     (ulong)(uVar18 >> 0x18)) << 8 | (ulong)(uVar18 >> 0x10 & 0xff)) << 8 |
                   (ulong)(uVar18 >> 8 & 0xff)) << 8 | (ulong)(uVar18 & 0xff);
        uVar11 = (ulong)uVar3;
        puVar17 = puVar17 + 1;
        uVar10 = uVar5;
...
switchD_0010333a_caseD_3:
    puVar6 = puVar7 + -1;
    puVar7[-1] = (uchar)(uVar18 >> 0x10);
LAB_00103370:
    puVar7 = puVar6 + -1;
    puVar6[-1] = (uchar)(uVar18 >> 8);
switchD_0010333a_caseD_1:
    puVar7[-1] = (uchar)uVar18;
  ...
  if (-1 < (long)uVar8) {
    ...
    do {
      ...
      *puVar12 = (((((((ulong)(uVar5 >> 0x18) << 8 | (ulong)(uVar5 >> 0x10 & 0xff)) << 8 |
...
LAB_00103437:
  uVar5 = (*(byte *)(lVar9 + -1) | uVar10) ^ uVar5;
  lVar16 = lVar9 + -1;
LAB_00103443:
  lVar9 = lVar16 + -1;
...
LAB_0010345e:
  uVar10 = (uint)*(byte *)(lVar9 + -1) << 8 | uVar10;
  lVar9 = lVar9 + -1;
LAB_0010346b:
  uVar10 = (*(byte *)(lVar9 + -1) | uVar10) ^ auVar19._0_4_;
  auVar19[4] = (char)uVar5;
  auVar19[5] = (char)(uVar5 >> 8);
  auVar19[6] = (char)(uVar5 >> 0x10);
  auVar19[7] = (char)(uVar5 >> 0x18);
  auVar19[0] = (char)uVar10;
  auVar19[1] = (char)(uVar10 >> 8);
  auVar19[2] = (char)(uVar10 >> 0x10);
  auVar19[3] = (char)(uVar10 >> 0x18);
switchD_00103144_caseD_0:
  local_48 = auVar19;
  DES_encrypt3((uint *)&local_48,ks1,ks2,ks3);
...
LAB_001033b1:
  *ivec = (DES_cblock)
          ((((((((ulong)uVar10 << 8 | (ulong)(uVar5 & 0xff)) << 8 | (ulong)uVar3) << 8 | uVar13) <<
              8 | (ulong)uVar18) << 8 | (ulong)bVar14) << 8 | (ulong)bVar4) << 8 | uVar8);
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
  }
                    /* WARNING: Subroutine does not return */

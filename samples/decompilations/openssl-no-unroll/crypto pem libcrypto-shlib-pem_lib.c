...

{
  ...
  if (iVar1 == 0) {
    ...
    if ((iVar1 == 0) || (iVar1 = strcmp(param_1,"PRIVATE KEY"), iVar1 == 0)) goto LAB_001021e0;
    ...
    if (iVar1 == 0) {
      ...
      if ((0 < iVar1) &&
         (pEVar3 = EVP_PKEY_asn1_find_str(&local_38,param_1,iVar1),
         pEVar3 != (EVP_PKEY_ASN1_METHOD *)0x0)) {
      ...
      if ((iVar1 == 0) && (iVar1 = strcmp(param_2,"DH PARAMETERS"), iVar1 == 0)) goto LAB_001021e0;
      ...
      if (iVar2 == 0) {
        ...
        if ((iVar1 == 0) || (iVar1 = strcmp(param_2,"PKCS7"), iVar1 == 0)) goto LAB_001021e0;
...
PEM_bytes_read_bio_secmem
          ...
          undefined8 param_5,undefined1 *param_6,void *param_7)

{
  ...
  if ((iVar1 == 0) ||
     (iVar1 = PEM_do_header(&local_58,local_68,&local_60,param_6,param_7), iVar1 == 0)) {

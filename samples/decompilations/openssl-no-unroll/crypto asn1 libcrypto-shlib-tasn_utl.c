...

{
  ...
  if (((param_3 != (long *)0x0) && (*param_3 != 0)) &&
    ...
    uVar3 = *(uint *)(lVar2 + 8) & 2;
    if (uVar3 != 0) {
      puVar1 = (undefined8 *)(*param_3 + (long)*(int *)(lVar2 + 0x20));
      uVar3 = 0;
      if (*(int *)(puVar1 + 2) == 0) {
        if (param_2 != (long *)0x0) {
          memcpy((void *)*param_2,(void *)*puVar1,puVar1[1]);

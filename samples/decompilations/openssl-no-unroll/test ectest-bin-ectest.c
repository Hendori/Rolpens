                      ...
                      if (uVar2 != 0) {
                        ...
                        if (uVar2 != 0) {
                          ...
                          iVar1 = test_int_eq("test/ectest.c",0x619,
                                              "EC_GROUP_check_named_curve(group, 0, NULL)",&_LC262,
                                              uVar3);
                          if (iVar1 != 0) {
                                          ...
                                          if (iVar2 != 0) {
                                            ...
                                            if (iVar2 != 0) {
                                              ...
                                              if (iVar2 != 0) {
                                                ...
                                                test_output_bignum(&_LC369,local_98);
                                                test_output_bignum(&_LC370,local_90);
                                                uVar1 = *(undefined4 *)
                                                ...
                                                if (iVar2 != 0) {
                                                  ...
                                                  if (iVar2 != 0) {
                                                    uVar3 = 1;
                                                    if (param_1 != 9) goto LAB_00107850;
                                                    iVar2 = EC_POINT_set_affine_coordinates
                                              ...
                                              if (iVar1 != 0) {
                                                ...
                                                if (iVar1 != 0) {
                                                  ...
                                                  if (iVar1 == 0) {
                                                    ...
                                                    test_output_bignum(&_LC369,local_b8);
                                                    test_output_bignum(&_LC370,local_b0);
                                                  }
                                                  else {
      ...
      if (iVar1 != 0) {
        ...
        if (iVar1 != 0) {
          ...
          if (uVar2 != 0) {
            ...
            uVar2 = test_size_t_eq("test/ectest.c",0x454,&_LC412,
                                            ...
                                            if (iVar1 == 0) {
                                              ...
                                              if (iVar1 != 0) {
                                                test_info("test/ectest.c",0xd3,
                                                          "Point is not on curve");
                                                test_output_bignum(&_LC369,local_100);
                                                test_output_bignum(&_LC370,local_f8);
                                              }
                                            }
                                            else {
                                              test_note("A cyclic subgroup:");
                                              iVar1 = 100;
                                              do {
                                                iVar2 = test_int_ne("test/ectest.c",0xdc,&_LC407,
                                                                    &_LC4,iVar1,0);
                                                if (iVar2 == 0) goto LAB_0010979b;
                                                iVar2 = EC_POINT_is_at_infinity(group,point);
                                                if (iVar2 == 0) {
                                                  iVar2 = EC_POINT_get_affine_coordinates
                                              ...
                                              if (iVar1 != 0) {
                                                ...
                                                if (iVar1 != 0) {
                                                  ...
                                                  ,iVar1 != 0);
                                                  if (iVar1 != 0) {
                                                    iVar1 = test_BN_eq("test/ectest.c",0x138,&_LC370
                                                                       ,&_LC454,local_f8,local_f0);
                                                    if (iVar1 != 0) {
                                                      iVar1 = EC_GROUP_get_degree(group);
                                                      iVar1 = test_int_eq("test/ectest.c",0x139,
                                                                                                                                                    
                                                  "EC_GROUP_get_degree(group)",&_LC455,iVar1,0xa0);
                                                  if (iVar1 != 0) {
                                                  ...
                                                  ,iVar1 != 0);
                                                  if (iVar1 != 0) {
                                                    iVar1 = test_BN_eq("test/ectest.c",0x156,&_LC370
                                                                       ,&_LC454,local_f8,local_f0);
                                                    if (iVar1 != 0) {
                                                      pBVar5 = BN_value_one();
                                                      iVar1 = BN_add(local_158,local_f8,pBVar5);
                                                  ...
                                                  ,iVar1 != 0);
                                                  if (iVar1 != 0) {
                                                    iVar1 = test_BN_eq("test/ectest.c",0x17b,&_LC370
                                                                       ,&_LC454,local_f8,local_f0);
                                                    if (iVar1 != 0) {
                                                      pBVar5 = BN_value_one();
                                                      iVar1 = BN_add(local_158,local_f8,pBVar5);
                                                  ...
                                                  ,iVar1 != 0);
                                                  if (iVar1 != 0) {
                                                    iVar1 = test_BN_eq("test/ectest.c",0x1a1,&_LC370
                                                                       ,&_LC454,local_f8,local_f0);
                                                    if (iVar1 != 0) {
                                                      pBVar5 = BN_value_one();
                                                      iVar1 = BN_add(local_158,local_f8,pBVar5);
                                                  ...
                                                  ,iVar1 != 0);
                                                  if (iVar1 != 0) {
                                                    iVar1 = test_BN_eq("test/ectest.c",0x1cd,&_LC370
                                                                       ,&_LC454,local_f8,local_f0);
                                                    if (iVar1 != 0) {
                                                      pBVar5 = BN_value_one();
                                                      iVar1 = BN_add(local_158,local_f8,pBVar5);
                                                  ...
                                                  ,iVar1 != 0);
                                                  if (iVar1 != 0) {
                                                    iVar1 = test_BN_eq("test/ectest.c",0x203,&_LC370
                                                                       ,&_LC454,local_f8,local_f0);
                                                    if (iVar1 != 0) {
                                                      pBVar5 = BN_value_one();
                                                      iVar1 = BN_add(local_158,local_f8,pBVar5);
  ...
  if (iVar1 != 0) {
    ...
    if (iVar1 != 0) {
      ...
      if (iVar1 != 0) {
        ...
        if (iVar1 != 0) {
          uVar2 = EC_GROUP_get0_cofactor(local_40);
          iVar1 = test_BN_eq("test/ectest.c",0x8ca,&_LC556,"EC_GROUP_get0_cofactor(group)",local_38,
                             uVar2);
          bVar3 = iVar1 != 0;
          goto LAB_0010c1be;
        }
...

{
  ...
  iVar3 = *(int *)((long)param_1 * 0x10 + curves);
  ctx = BN_CTX_new();
  iVar1 = test_ptr("test/ectest.c",0x9a0,"bnctx = BN_CTX_new()",ctx);
  if (iVar1 == 0) {
    uVar2 = 0;
    point = (EC_POINT *)0x0;
    group = (EC_GROUP *)0x0;
  ...
  if (uVar2 == 0) goto LAB_0010cea4;
  pEVar4 = EC_GROUP_get0_generator(group);
  uVar2 = test_ptr("test/ectest.c",0x9a2,"G = EC_GROUP_get0_generator(group)",pEVar4);
  if (uVar2 == 0) goto LAB_0010cea4;
  point = EC_POINT_dup(pEVar4,group);
  ...
  if (point == (EC_POINT *)0x0) {
    ...
    uVar2 = test_ptr("test/ectest.c",0x974,"Pinf = EC_POINT_new(group)",pEVar4);
    if (uVar2 != 0) {
      iVar3 = EC_POINT_set_to_infinity(group,pEVar4);
      uVar2 = test_true("test/ectest.c",0x975,"EC_POINT_set_to_infinity(group, Pinf)",iVar3 != 0);
      local_40 = pEVar4;
      if (uVar2 != 0) goto LAB_0010cf65;
    }
...
LAB_0010cf65:
    pEVar5 = (EC_POINT *)0x0;
    local_48 = (EC_POINT *)EC_POINT_point2hex(group,local_40,POINT_CONVERSION_COMPRESSED,ctx);
    uVar2 = test_ptr("test/ectest.c",0x97a,"hex = EC_POINT_point2hex(group, P, form, bnctx)",
                     local_48);
    if (uVar2 != 0) {
      pEVar5 = EC_POINT_hex2point(group,(char *)local_48,(EC_POINT *)0x0,ctx);
      uVar2 = test_ptr("test/ectest.c",0x97b,"Q = EC_POINT_hex2point(group, hex, NULL, bnctx)",
                       pEVar5);
      if (uVar2 != 0) {
        iVar3 = EC_POINT_cmp(group,pEVar5,local_40,ctx);
        uVar2 = test_int_eq("test/ectest.c",0x97c,&_LC4,"EC_POINT_cmp(group, Q, P, bnctx)",0,iVar3);
        if ((uVar2 != 0) && (uVar2 = 1, pEVar4 != (EC_POINT *)0x0)) {
          iVar3 = EC_POINT_is_at_infinity(group,pEVar5);
          iVar3 = test_true("test/ectest.c",0x986,"EC_POINT_is_at_infinity(group, Q)",iVar3 != 0);
          uVar2 = (uint)(iVar3 != 0);
        }
      }
    }
  ...
  if (iVar3 != 0) {
    pEVar4 = EC_POINT_new(group);
    iVar3 = test_ptr("test/ectest.c",0x974,"Pinf = EC_POINT_new(group)");
    if (iVar3 == 0) {
LAB_0010d7e0:
      local_48 = (EC_POINT *)0x0;
      pcVar6 = (char *)0x0;
      ...
      EC_POINT_set_to_infinity(group,pEVar4);
      iVar3 = test_true("test/ectest.c",0x975,"EC_POINT_set_to_infinity(group, Pinf)");
      if (iVar3 == 0) goto LAB_0010d7e0;
      pcVar6 = EC_POINT_point2hex(group,pEVar4,POINT_CONVERSION_COMPRESSED,ctx);
      uVar2 = test_ptr("test/ectest.c",0x97a,"hex = EC_POINT_point2hex(group, P, form, bnctx)",
                       pcVar6);
      local_48 = (EC_POINT *)0x0;
      if (uVar2 != 0) {
        local_48 = EC_POINT_hex2point(group,pcVar6,(EC_POINT *)0x0,ctx);
        iVar3 = test_ptr("test/ectest.c",0x97b,"Q = EC_POINT_hex2point(group, hex, NULL, bnctx)");
        if (iVar3 != 0) {
          iVar3 = EC_POINT_cmp(group,local_48,pEVar4,ctx);
          iVar3 = test_int_eq("test/ectest.c",0x97c,&_LC4,"EC_POINT_cmp(group, Q, P, bnctx)",0,iVar3
                             );
          if (iVar3 != 0) {
            uVar2 = 1;
            if (pEVar4 != (EC_POINT *)0x0) {
              iVar3 = EC_POINT_is_at_infinity(group,local_48);
              iVar3 = test_true("test/ectest.c",0x986,"EC_POINT_is_at_infinity(group, Q)",iVar3 != 0
                               );
              uVar2 = (uint)(iVar3 != 0);
            }
...
LAB_0010d238:
    ...
    if (iVar3 != 0) {
      ...
      if (point == (EC_POINT *)0x0) {
        ...
        uVar2 = test_ptr("test/ectest.c",0x974,"Pinf = EC_POINT_new(group)",local_48);
        if (uVar2 != 0) {
          iVar3 = EC_POINT_set_to_infinity(group,local_48);
          uVar2 = test_true("test/ectest.c",0x975,"EC_POINT_set_to_infinity(group, Pinf)",iVar3 != 0
                           );
          local_40 = local_48;
          if (uVar2 != 0) goto LAB_0010d293;
        }
        pcVar6 = (char *)0x0;
        pEVar4 = (EC_POINT *)0x0;
      }
...
LAB_0010d293:
        pEVar4 = (EC_POINT *)0x0;
        pcVar6 = EC_POINT_point2hex(group,local_40,POINT_CONVERSION_UNCOMPRESSED,ctx);
        uVar2 = test_ptr("test/ectest.c",0x97a,"hex = EC_POINT_point2hex(group, P, form, bnctx)",
                         pcVar6);
        if (uVar2 != 0) {
          pEVar4 = EC_POINT_hex2point(group,pcVar6,(EC_POINT *)0x0,ctx);
          uVar2 = test_ptr("test/ectest.c",0x97b,"Q = EC_POINT_hex2point(group, hex, NULL, bnctx)",
                           pEVar4);
          if (uVar2 != 0) {
            iVar3 = EC_POINT_cmp(group,pEVar4,local_40,ctx);
            uVar2 = test_int_eq("test/ectest.c",0x97c,&_LC4,"EC_POINT_cmp(group, Q, P, bnctx)",0,
                                iVar3);
            if ((uVar2 != 0) && (uVar2 = 1, local_48 != (EC_POINT *)0x0)) {
              iVar3 = EC_POINT_is_at_infinity(group,pEVar4);
              iVar3 = test_true("test/ectest.c",0x986,"EC_POINT_is_at_infinity(group, Q)",iVar3 != 0
                               );
              uVar2 = (uint)(iVar3 != 0);
            }
...
LAB_0010d808:
          ...
          EC_POINT_set_to_infinity(group,pEVar4);
          iVar3 = test_true("test/ectest.c",0x975,"EC_POINT_set_to_infinity(group, Pinf)");
          if (iVar3 == 0) goto LAB_0010d808;
          local_48 = (EC_POINT *)EC_POINT_point2hex(group,pEVar4,POINT_CONVERSION_UNCOMPRESSED,ctx);
          pEVar5 = (EC_POINT *)0x0;
          uVar2 = test_ptr("test/ectest.c",0x97a,"hex = EC_POINT_point2hex(group, P, form, bnctx)",
                           local_48);
          if (uVar2 != 0) {
            ...
            if (iVar3 != 0) {
              iVar3 = EC_POINT_cmp(group,pEVar5,pEVar4,ctx);
              iVar3 = test_int_eq("test/ectest.c",0x97c,&_LC4,"EC_POINT_cmp(group, Q, P, bnctx)",0,
                                  iVar3);
              if (iVar3 != 0) {
                uVar2 = 1;
                if (pEVar4 != (EC_POINT *)0x0) {
                  iVar3 = EC_POINT_is_at_infinity(group,pEVar5);
                  iVar3 = test_true("test/ectest.c",0x986,"EC_POINT_is_at_infinity(group, Q)",
                                    iVar3 != 0);
                  uVar2 = (uint)(iVar3 != 0);
                }
                goto LAB_0010d4e8;
...
LAB_0010d4e8:
        ...
        if (iVar3 != 0) {
          ...
          if (point == (EC_POINT *)0x0) {
            ...
            if (uVar2 != 0) {
              iVar3 = EC_POINT_set_to_infinity(group,pEVar4);
              uVar2 = test_true("test/ectest.c",0x975,"EC_POINT_set_to_infinity(group, Pinf)",
                                iVar3 != 0);
              if (uVar2 != 0) goto LAB_0010d53c;
            }
            a = (EC_POINT *)0x0;
            local_48 = (EC_POINT *)0x0;
          }
...
LAB_0010d53c:
            a = (EC_POINT *)0x0;
            local_48 = (EC_POINT *)EC_POINT_point2hex(group,pEVar4,POINT_CONVERSION_HYBRID,ctx);
            uVar2 = test_ptr("test/ectest.c",0x97a,"hex = EC_POINT_point2hex(group, P, form, bnctx)"
                             ,local_48);
            if (uVar2 != 0) {
              a = EC_POINT_hex2point(group,(char *)local_48,(EC_POINT *)0x0,ctx);
              uVar2 = test_ptr("test/ectest.c",0x97b,
                               "Q = EC_POINT_hex2point(group, hex, NULL, bnctx)",a);
              if (uVar2 != 0) {
                iVar3 = EC_POINT_cmp(group,a,pEVar4,ctx);
                uVar2 = test_int_eq("test/ectest.c",0x97c,&_LC4,"EC_POINT_cmp(group, Q, P, bnctx)",0
                                    ,iVar3);
                if ((uVar2 != 0) && (uVar2 = 1, pEVar5 != (EC_POINT *)0x0)) {
                  iVar3 = EC_POINT_is_at_infinity(group,a);
                  iVar3 = test_true("test/ectest.c",0x986,"EC_POINT_is_at_infinity(group, Q)",
                                    iVar3 != 0);
                  uVar2 = (uint)(iVar3 != 0);
                }
...
LAB_0010d883:
              ...
              EC_POINT_set_to_infinity(group,pEVar4);
              iVar3 = test_true("test/ectest.c",0x975,"EC_POINT_set_to_infinity(group, Pinf)");
              if (iVar3 == 0) goto LAB_0010d883;
              local_48 = (EC_POINT *)EC_POINT_point2hex(group,pEVar4,POINT_CONVERSION_HYBRID,ctx);
              pEVar5 = (EC_POINT *)0x0;
              uVar2 = test_ptr("test/ectest.c",0x97a,
                               "hex = EC_POINT_point2hex(group, P, form, bnctx)",local_48);
              if (uVar2 != 0) {
                pEVar5 = EC_POINT_hex2point(group,(char *)local_48,(EC_POINT *)0x0,ctx);
                iVar3 = test_ptr("test/ectest.c",0x97b,
                                 "Q = EC_POINT_hex2point(group, hex, NULL, bnctx)");
                if (iVar3 != 0) {
                  iVar3 = EC_POINT_cmp(group,pEVar5,pEVar4,ctx);
                  iVar3 = test_int_eq("test/ectest.c",0x97c,&_LC4,"EC_POINT_cmp(group, Q, P, bnctx)"
                                      ,0,iVar3);
                  if (iVar3 != 0) {
                    uVar2 = 1;
                    if (pEVar4 != (EC_POINT *)0x0) {

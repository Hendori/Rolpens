  ...
  *(undefined4 *)(param_3 + 0x18) = 0;
  ...
  if (lVar1 != 0) {
    ...
    if (*(int *)(param_3 + 0x1c) == 0) {
      iVar2 = (int)plVar3[2];
      do {
        if (((iVar2 == 0) && (*plVar3 == param_1)) &&
           (iVar2 = strcmp(param_2,(char *)plVar3[1]), iVar2 == 0)) {
LAB_00100071:
          *(undefined4 *)(param_3 + 0x18) = 1;
          return;
        }
        lVar4 = lVar4 + 1;
        if (lVar1 == lVar4) goto LAB_001000bf;
        iVar2 = (int)plVar3[5];
        plVar3 = plVar3 + 3;
      } while( true );
    }
    do {
      while (*plVar3 != param_1) {
        lVar4 = lVar4 + 1;
        plVar3 = plVar3 + 3;
        if (lVar4 == lVar1) goto LAB_001000bf;
      }
      iVar2 = strcmp(param_2,(char *)plVar3[1]);
      if (iVar2 == 0) goto LAB_00100071;
      lVar4 = lVar4 + 1;
      plVar3 = plVar3 + 3;
    } while (lVar4 != lVar1);
  }
  ...
  if (iVar1 != 0) {
    ...
    if (local_40 == 0) {
      ...
      if (local_40 == 0) {
        ...
        uVar4 = 1;
        ossl_sa_doall_arg(uVar2,0x100000,&local_58);
        if (local_40 != 0) goto LAB_00100232;

...

{
  ...
  if (iVar1 != 0) {
    *(byte *)(param_1 + 0x1b8) = *(byte *)(param_1 + 0x1b8) & 0xfe;
    if (param_2 != (void *)0x0) {
      ...
      memcpy((void *)(param_1 + 0x38),param_2,param_3);
    }
...
long ossl_aes128_gcm_siv_newctx(undefined8 param_1)

{
  ...
  if (iVar1 != 0) {
    ...
    if (lVar2 != 0) {
      *(undefined8 *)(lVar2 + 0x30) = 0x10;
      uVar3 = ossl_prov_cipher_hw_aes_gcm_siv(0x80);
...
long ossl_aes192_gcm_siv_newctx(undefined8 param_1)

{
  ...
  if (iVar1 != 0) {
    lVar2 = CRYPTO_zalloc(0x1c0,"providers/implementations/ciphers/cipher_aes_gcm_siv.c",0x22);
    if (lVar2 != 0) {
      *(undefined8 *)(lVar2 + 0x30) = 0x18;
      uVar3 = ossl_prov_cipher_hw_aes_gcm_siv(0xc0);
      *(undefined8 *)(lVar2 + 8) = uVar3;
      uVar3 = ossl_prov_ctx_get0_libctx(param_1);
      *(undefined8 *)(lVar2 + 0x20) = param_1;
      *(undefined8 *)(lVar2 + 0x18) = uVar3;
...
long ossl_aes256_gcm_siv_newctx(undefined8 param_1)

{
  ...
  if (iVar1 != 0) {
    lVar2 = CRYPTO_zalloc(0x1c0,"providers/implementations/ciphers/cipher_aes_gcm_siv.c",0x22);
    if (lVar2 != 0) {
      *(undefined8 *)(lVar2 + 0x30) = 0x20;
      uVar3 = ossl_prov_cipher_hw_aes_gcm_siv(0x100);
      *(undefined8 *)(lVar2 + 8) = uVar3;
      uVar3 = ossl_prov_ctx_get0_libctx(param_1);
      *(undefined8 *)(lVar2 + 0x20) = param_1;
      *(undefined8 *)(lVar2 + 0x18) = uVar3;

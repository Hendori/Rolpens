...
LAB_001007b4:
    ...
    BIO_puts(param_1,"\n");
    if (lVar4 == 0) goto LAB_001007b4;
LAB_001005e0:
    bVar1 = true;
    BIO_printf(param_1,"%*sRejected Uses:\n%*s",uVar7,&_LC6,(ulong)(param_3 + 2),&_LC6);
    local_9c = 0;
  ...
  if (puVar6 != (uchar *)0x0) {
    ...
    if (0 < local_a0) {
      do {
        while (local_9c == 0) {
          BIO_printf(param_1,"%s%02X",&_LC6,(ulong)puVar6[(int)local_9c]);
          local_9c = local_9c + 1;
          if (local_a0 <= (int)local_9c) goto LAB_00100745;
        }
        BIO_printf(param_1,"%s%02X",&_LC8,(ulong)puVar6[(int)local_9c]);
        local_9c = local_9c + 1;
...

{
  ...
  if (((uint)nmflag & 0xf0000) == 0x40000) {
    ...
    uVar7 = 0;
    uVar2 = 0;
    if ((cflag & 1) == 0) goto LAB_00100ac2;
joined_r0x001009d4:
    if ((cflag & 2) == 0) {
    ...
    if ((cflag & 0x10) == 0) {
      iVar1 = BIO_printf(bp,"        Issuer:%c",uVar6);
      if (0 < iVar1) {
        pXVar4 = X509_get_issuer_name(x);
        iVar1 = X509_NAME_print_ex(bp,pXVar4,local_64,nmflag);
        if (((int)uVar2 <= iVar1) && (iVar1 = BIO_write(bp,&_LC5,1), 0 < iVar1)) goto LAB_001009f5;
      }
    }
    else {
LAB_001009f5:
...
LAB_00100a07:
          ...
          if ((cflag & 0x1000) == 0) {
            ...
            if ((local_50 != (ASN1_STRING *)0x0) &&
               ((iVar1 = BIO_printf(bp,"%8sIssuer Unique ID: ",&_LC6), iVar1 < 1 ||
                (iVar1 = X509_signature_dump(bp,local_50,0xc), iVar1 == 0)))) goto LAB_00100a9f;
            if (local_48 != (ASN1_OBJECT *)0x0) {
              iVar1 = BIO_printf(bp,"%8sSubject Unique ID: ",&_LC6);
              if (iVar1 < 1) goto LAB_00100a9f;
        ...
        iVar1 = BIO_printf(bp,"        Subject:%c",uVar6);
        if (0 < iVar1) {

...

{
  ...
  if ((*param_3 != 0) &&
     (((*param_3 & 0x80) == 0 ||
      (puVar1 = (uint *)ossl_quic_obj_get0_handshake_layer(param_3), puVar1 == (uint *)0x0)))) {
    return 0;
  }
...
undefined8
yield_secret_cb(undefined4 param_1,undefined4 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  if ((param_7 != (uint *)0x0) &&
     ((puVar1 = param_7, *param_7 == 0 ||
      (((*param_7 & 0x80) != 0 &&
       (puVar1 = (uint *)ossl_quic_obj_get0_handshake_layer(param_7), puVar1 != (uint *)0x0)))))) {
                    /* WARNING: Could not recover jumptable at 0x0010014f. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    uVar2 = (**(code **)(puVar1 + 0x4e))
                      (param_7,param_1,param_2,param_5,param_6,*(undefined8 *)(puVar1 + 0x54));
    return uVar2;
  }
  return 0;
}
...

{
  ...
  if ((*param_2 != 0) &&
     (((*param_2 & 0x80) == 0 ||
      (puVar1 = (uint *)ossl_quic_obj_get0_handshake_layer(param_2), puVar1 == (uint *)0x0)))) {
    return 0;
  }
...

{
  ...
  if ((*param_4 != 0) &&
     (((*param_4 & 0x80) == 0 ||
      (puVar1 = (uint *)ossl_quic_obj_get0_handshake_layer(param_4), puVar1 == (uint *)0x0)))) {
    return 0;
  }
                    /* WARNING: Could not recover jumptable at 0x001002af. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  uVar2 = (**(code **)(puVar1 + 0x48))
                    (param_4,param_1,param_2,param_3,*(undefined8 *)(puVar1 + 0x54),
                     *(code **)(puVar1 + 0x48));
  return uVar2;
}
...

{
  ...
  puVar4 = (uint *)0x0;
  if (((param_1 == (uint *)0x0) || (puVar4 = param_1, *param_1 == 0)) ||
     (puVar4 = (uint *)0x0, (*param_1 & 0x80) == 0)) {
...
LAB_00100312:
    ...
    while (iVar2 != 0) {
      ...
      case 0x7d2:
        ...
        break;
      case 0x7d3:
        if (*(long *)(puVar4 + 0x4c) == 0) {
          *(undefined8 *)(puVar4 + 0x4c) = *(undefined8 *)(param_2 + 2);
        }
        break;
      case 0x7d4:
        if (*(long *)(puVar4 + 0x4e) == 0) {
          *(undefined8 *)(puVar4 + 0x4e) = *(undefined8 *)(param_2 + 2);
        }
        break;
      case 0x7d5:
        if (*(long *)(puVar4 + 0x50) == 0) {
          *(undefined8 *)(puVar4 + 0x50) = *(undefined8 *)(param_2 + 2);
        }
        break;
      case 0x7d6:
    ...
    if ((((lVar3 == 0) || (*(long *)(puVar4 + 0x4a) == 0)) ||
        ((*(long *)(puVar4 + 0x4c) == 0 ||
         ((*(long *)(puVar4 + 0x4e) == 0 || (*(long *)(puVar4 + 0x50) == 0)))))) ||
       (*(long *)(puVar4 + 0x52) == 0)) {
      ERR_new();
...

{
  ...
  puVar3 = (uint *)0x0;
  if (((param_1 == (uint *)0x0) || (puVar3 = param_1, *param_1 == 0)) ||
     (puVar3 = (uint *)0x0, (*param_1 & 0x80) == 0)) {
    iVar1 = SSL_is_tls();
  }
  else {

    ...
    *param_1 = 0x800;
    ...
    if (lVar5 != 0) {
      ...
      if (pkey == (EVP_PKEY *)0x0) {
        pkey = EVP_PKEY_new();
        if ((pkey != (EVP_PKEY *)0x0) &&
           (iVar3 = EVP_PKEY_set_type_by_keymgmt(pkey,*(undefined8 *)(param_1 + 8)), iVar3 != 0)) {
        ...
        uVar7 = 0xf1;
LAB_001007ce:
        ERR_set_debug("crypto/evp/exchange.c",uVar7,"EVP_PKEY_derive_init_ex");
        ERR_set_error(6,0x86,0);
      }
      else {
LAB_001004e9:
        if ((*(long *)&pkey[1].save_parameters == 0) || (*(long *)&pkey[1].save_parameters == lVar5)
           ) {
          lVar5 = evp_keymgmt_util_query_operation_name(lVar5,0xb);
          if (lVar5 != 0) {
            EVP_KEYEXCH_free(0);
            EVP_KEYMGMT_free(local_48);
            lVar6 = EVP_KEYEXCH_fetch(*(undefined8 *)(param_1 + 2),lVar5,
...
LAB_001009e7:
        ...
        if (((*param_1 - 0x200 & 0xfffffdff) == 0) || (*param_1 == 0x800)) {
          ...
          if (*(int **)(param_1 + 0x22) == (int *)0x0) {
            ...
            if ((iVar1 != 0) ||
               (iVar1 = EVP_PKEY_parameters_eq(*(undefined8 *)(param_1 + 0x22),param_2), iVar1 != 0)
               ) {
...
LAB_00100ce3:
                    /* WARNING: Could not recover jumptable at 0x00100ceb. Too many branches */
                    /* WARNING: Treating indirect jump as call */

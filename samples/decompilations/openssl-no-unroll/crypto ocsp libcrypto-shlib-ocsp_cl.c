...

{
  ...
  if (req[2].tbsRequest == (OCSP_REQINFO *)0x0) {
    ...
    if (pOVar2 == (OCSP_REQINFO *)0x0) {
      ...
      if (cert != (X509 *)0x0) {
        iVar1 = ossl_x509_add_cert_new(&pOVar2->requestExtensions,cert,1);
        return iVar1;
      }
      iVar1 = 1;
    }
...

{
  ...
  if (iVar4 != 0) {
    ...
    if (pOVar5 == (OCSP_REQINFO *)0x0) goto LAB_0010018f;
    if (key != (EVP_PKEY *)0x0) {
...
LAB_00100540:
    ...
    do {
      ...
      if (iVar2 <= last) goto LAB_00100540;
...
LAB_001006e8:
  ...
  if (nextupd == (ASN1_GENERALIZEDTIME *)0x0) goto LAB_00100775;

...
undefined8 dsa_main(undefined4 param_1,undefined8 param_2)
...
LAB_001003a9:
          ...
          if (local_b8 == 0) {
LAB_0010078c:
            if (local_c0 == 0xc) goto LAB_00100414;
          }
          else {
...
LAB_00100414:
    ...
    if (0x11 < iVar3) {
      if ((iVar3 - 0x641U < 4) && (iVar3 = opt_provider(iVar3), iVar3 == 0)) {
LAB_0010020e:
        uVar4 = 0;
        pkey = (EVP_PKEY *)0x0;
        out = (BIO *)0x0;
...
switchD_00100112_caseD_ffffffff:

      ...
      if (num != 0) {
        do {
          if ((lVar3 != *(long *)p[sVar4]) ||
             ((iVar1 = *(int *)(p[sVar4] + 8), iVar1 != 0 && (iVar2 != iVar1)))) goto LAB_00101fa2;
          sVar4 = sVar4 + 1;
        } while (sVar4 != num);
      }
      goto LAB_00101fda;
...

{
  ...
  iVar1 = EC_GROUP_get_field_type();
  iVar2 = 0;
  if ((((iVar1 == 0x197) && (*(int *)(param_1 + 0x48) != 0)) &&
      (iVar2 = 0, *(int *)(param_1 + 0x4c) != 0)) &&
     ((iVar2 = 0x2aa, *(int *)(param_1 + 0x50) != 0 && (iVar2 = 0, *(int *)(param_1 + 0x54) != 0))))
  {
...
/* WARNING: Removing unreachable block (ram,0x001032a3) */

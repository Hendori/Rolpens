...
LAB_001007fc:
    ...
    if (iVar40 == 0) {
      ...
      if (pBVar43 == (BIO *)0x0) {
LAB_00101108:
        pcVar50 = "Unable to create BIO\n";
LAB_00100932:
        BIO_printf(_bio_err,pcVar50);
        ERR_print_errors(_bio_err);
        goto LAB_0010094c;
      }
...
LAB_0010082d:
      if (s_nbio_test == 0) {
LAB_0010085d:
        SSL_set_bio(ssl,pBVar43,pBVar43);
...
switchD_00100dfd_caseD_4:
        ...
        if ((iVar40 == 0) && ((async == 0 || (iVar40 = SSL_waiting_for_async(ssl), iVar40 == 0)))) {
          ...
          *(ulong *)(local_c8 + lVar44 * 8) =
               *(ulong *)(local_c8 + lVar44 * 8) | 1L << (bVar39 & 0x3f);
...
LAB_00100fe2:
            if (s_quiet == 0 && s_brief == 0) {
              if (((int)uVar53 < 1) || (bVar39 = *buf, bVar39 == 0x51)) {
LAB_00101851:
...
LAB_00101479:
                ...
                if (6 < uVar46 - 1) {
                  ...
                  Var27 = CONCAT91(CONCAT81((long)(CONCAT72(auVar104._9_7_,CONCAT11(cVar92,bVar39))
                                                  >> 8),cVar64),-bVar4);
                  ...
                  iVar40 = ((((iVar41 - CONCAT22(-(ushort)bVar1,auVar103._0_2_)) - auVar110._8_4_) -
                            CONCAT22(-(ushort)(sVar63 < 0),sVar63)) - auVar88._8_4_) +
                           ((((iVar66 - auVar34._0_4_) - auVar111._12_4_) - auVar113._4_4_) -
                           auVar89._12_4_);
                ...
                do {
                  ...
                  uVar37 = CONCAT31(CONCAT21(uVar38,-(*pbVar15 == _LC47._6_1_)),
                                    -(*pbVar15 == _LC47._6_1_));
                  uVar36 = CONCAT51(CONCAT41(uVar37,-(*pbVar14 == _LC47._5_1_)),
                                    -(*pbVar14 == _LC47._5_1_));
                  Var35 = CONCAT72(CONCAT61(uVar36,-(*pbVar13 == _LC47._4_1_)),
                                   CONCAT11(-(*pbVar13 == _LC47._4_1_),cVar62));
                  lVar44 = (long)((unkuint9)Var35 >> 8);
                  Var27 = CONCAT91(CONCAT81(lVar44,-(*pbVar12 == _LC47._3_1_)),
                                   -(*pbVar12 == _LC47._3_1_));
                  ...
                  auVar58._0_8_ =
                       CONCAT26(-(ushort)(auVar57._10_2_ < 0),CONCAT24(auVar57._10_2_,iVar40));
                  ...
                  iVar41 = (((iVar41 - CONCAT22(-(ushort)bVar1,auVar79._0_2_)) - iVar72) -
                           CONCAT22(-(ushort)bVar2,CONCAT11(-bVar2,-bVar2))) - iVar40;
                  iVar66 = (((iVar66 - auVar28._0_4_) - (int)((ulong)auVar74._0_8_ >> 0x20)) -
                           auVar98._4_4_) - (int)((ulong)auVar58._0_8_ >> 0x20);
                  iVar70 = (((iVar70 - auVar120._8_4_) - auVar74._8_4_) - auVar100._8_4_) -
                           auVar58._8_4_;
                  iVar71 = (((iVar71 - auVar121._12_4_) - auVar80._12_4_) - auVar101._12_4_) -
                           auVar61._12_4_;
...
LAB_00101381:
          if (!bVar52) goto switchD_00100dfd_caseD_4;
        }
LAB_00100c46:
        if (((async != 0) && (iVar40 = SSL_waiting_for_async(ssl), iVar40 != 0)) ||
           (iVar40 = SSL_is_init_finished(ssl), iVar40 != 0)) {
LAB_00100dc0:
          while( true ) {
...
LAB_001012f3:
          ...
          } while ((iVar40 != 0) && (iVar41 = SSL_waiting_for_async(ssl), iVar41 != 0));
LAB_00100cfb:
          if (dtlslisten == 0) {
            if (stateless != 0) {
...
LAB_0010097d:
  ...
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return uVar49;
                    ...
                    /* WARNING: Subroutine does not return */
  __stack_chk_fail();
switchD_00100dfd_caseD_6:
  BIO_printf(bio_s_out,"DONE\n");
  BIO_ctrl(bio_s_out,0xb,0,(void *)0x0);
  goto LAB_0010094c;
switchD_00100dfd_caseD_1:
  BIO_printf(bio_s_out,"ERROR\n");
  BIO_ctrl(bio_s_out,0xb,0,(void *)0x0);
  ERR_print_errors(_bio_err);
LAB_0010094c:
  uVar49 = 1;
  goto LAB_00100958;
switchD_00100dfd_caseD_0:
  raw_write_stdout(buf,iVar40);
  BIO_ctrl(bio_s_out,0xb,0,(void *)0x0);
  iVar40 = SSL_has_pending(ssl);
...

{
  ...
  if ((((bp == (BIO *)0x0) || (pBVar4 == (BIO *)0x0)) ||
     ...
     (ssl = SSL_new(ctx), ssl == (SSL *)0x0)) goto LAB_00102a69;
  if (s_tlsextdebug != 0) {
    SSL_callback_ctrl(ssl,0x38,(_func_3375 *)&tlsext_cb);
    SSL_ctrl(ssl,0x39,0,bio_s_out);
  }
...
undefined8
alpn_cb(undefined8 param_1,uchar **param_2,byte *param_3,byte *param_4,uint param_5,
       undefined8 *param_6)
...
LAB_00103cfa:
        if (sk != (stack_st_OPENSSL_STRING *)0x0) goto LAB_00103d02;
      }
...
LAB_00105d20:
                  if (pkey_00 == (EVP_PKEY *)0x0) goto LAB_00106b08;
...
LAB_00106a9c:
                ...
                if (pcVar27 != (char *)0x0) {
                  pkey_00 = (EVP_PKEY *)
                            load_keyparams_suppress(pcVar27,0,0,&_LC195,"DH parameters",1);
                  goto LAB_00105d20;
                }
LAB_00106b08:
...
LAB_00105d7a:
                if (ctx2 != (SSL_CTX *)0x0) {
                  if ((local_198 == 0) ||
                     (pEVar30 = (EVP_PKEY *)
                                load_keyparams_suppress(pcVar36,0,0,&_LC195,"DH parameters",1),
...
joined_r0x001048b9:
  ...
  if (iVar18 == 0) goto switchD_0010478b_caseD_ffffffff;
  goto switchD_0010478b_caseD_0;
switchD_0010478b_caseD_ffffffff:

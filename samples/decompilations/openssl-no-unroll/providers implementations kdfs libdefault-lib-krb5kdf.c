...

{
  ...
  if ((iVar4 != 0) && (iVar4 = krb5kdf_set_ctx_params(param_1,param_4), iVar4 != 0)) {
    ...
    if (cipher == (EVP_CIPHER *)0x0) {
      ...
      if (uVar1 == param_3) {
        ...
        if (((iVar4 != 0x2c) || (uVar1 != 0x18)) || (bVar18 = false, param_3 != 0x15)) {
          ERR_new();
...
LAB_0010042f:
          ...
          local_b8 = (int)uVar1;
          if (((uVar1 != (long)iVar4) &&
              (iVar4 = EVP_CIPHER_CTX_set_key_length(ctx,local_b8), iVar4 < 1)) ||
             (iVar4 = EVP_CIPHER_CTX_set_padding(ctx,0), iVar4 == 0)) goto LAB_0010042f;
...
LAB_00100851:
          ...
          if (uVar13 == uVar16) {
            ...
            if (-1 < (int)uVar14) {
              do {
                ...
                uVar14 = (((uint)*(byte *)(lVar2 + (ulong)(uVar14 - 1) % uVar13) <<
                           (8 - bVar3 & 0x1f) |
                          (int)(uint)*(byte *)(lVar2 + (ulong)uVar14 % uVar13) >> bVar3) & 0xff) +
                         (uint)*pbVar9 + uVar6;
                *pbVar9 = (byte)uVar14;
                uVar6 = uVar14 >> 8;
                uVar16 = (ulong)uVar12;
              ...
              if ((uVar14 >> 8 != 0) && (-1 < (int)(inl - 1))) {
                ...
                do {
                  ...
                  *pbVar10 = (byte)iVar8;
                  pbVar10 = pbVar10 + -1;
                } while ((byte)((byte)((uint)iVar8 >> 8) &
                               (byte)~(byte)(((inl - 2) - (int)pbVar9) + iVar4 >> 0x18) >> 7) != 0);
              }
            }
          }
          local_b0 = local_88;
          if (param_3 != 0) {
            ...
            pbVar9 = local_b0;
            pbVar10 = local_68;
            while (out = pbVar10, iVar4 = EVP_EncryptUpdate(ctx,out,&local_8c,pbVar9,inl),
                  iVar4 != 0) {
              ...
              if (((iVar4 == 0) ||
                  (iVar4 = EVP_EncryptInit_ex(ctx,cipher,impl,puVar17,(uchar *)0x0), iVar4 == 0)) ||
                 (((iVar4 = EVP_CIPHER_CTX_get_key_length(ctx), uVar1 != (long)iVar4 &&
                   (iVar4 = EVP_CIPHER_CTX_set_key_length(ctx,local_b8), iVar4 < 1)) ||
                  (iVar4 = EVP_CIPHER_CTX_set_padding(ctx,0), iVar4 == 0)))) break;
              pbVar9 = out;
              pbVar10 = local_68;
              if (out != local_b0) {
                pbVar10 = local_b0;
...
LAB_001006db:
          ...
          if ((iVar4 == 0x2c) && (bVar18)) {
            ...
            do {
              ...
              puVar17 = puVar17 + -7;
              (*key)[7] = (*key)[0] * '\x02' & 2 | (*key)[1] * '\x04' & 4 | (*key)[6] << 7 |
                          (*key)[2] * '\b' & 8 | (byte)(((*key)[3] & 1) << 4) |
                          (byte)(((*key)[4] & 1) << 5) | (byte)(((*key)[5] & 1) << 6);
              DES_set_odd_parity(key);
              bVar18 = param_2 != key;
              key = key + -1;
            } while (bVar18);
            iVar4 = CRYPTO_memcmp(param_2,param_2 + 1,8);
            if ((iVar4 == 0) || (iVar4 = CRYPTO_memcmp(param_2 + 1,param_2 + 2,8), iVar4 == 0)) {
              ERR_new();
...

{
  ...
  if (iVar2 != 0) {
    ...
    if (ptr != (undefined8 *)0x0) {
      ...
      *(undefined1 (*) [16])(ptr + 3) = (undefined1  [16])0x0;
      *(undefined1 (*) [16])(ptr + 5) = (undefined1  [16])0x0;
      *ptr = uVar1;
      CRYPTO_free(ptr);
    }
  }

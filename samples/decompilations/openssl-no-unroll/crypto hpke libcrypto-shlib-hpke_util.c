...

{
  ...
  if (param_1 == 0) {
    ...
    if (param_1 == 0x11) {
      return (undefined1 *)0x1015a8;
    }
    if (param_1 == 0x12) {
      return (undefined1 *)0x1015f0;
    }
    if (param_1 == 0x20) {
      return (undefined1 *)0x101638;
    }
    if (param_1 == 0x21) {
      return (undefined1 *)0x101680;
    }
    ERR_new();
    uVar1 = 0xbc;
  }
...

{
  ...
  puVar1 = hpke_kdf_tab;
  if (((param_1 != 1) && (puVar1 = (undefined1 *)0x101478, param_1 != 2)) &&
     (puVar1 = (undefined1 *)0x101490, param_1 != 3)) {
    ERR_new();
...

{
  ...
  if ((((param_1 != 1) && (puVar1 = (undefined1 *)0x1014e8, param_1 != 2)) &&
      (puVar1 = (undefined1 *)0x101510, param_1 != 3)) &&
     (puVar1 = (undefined1 *)0x101538, param_1 != -1)) {
    ERR_new();
...

{
  ...
  local_10c = 1;
  OSSL_PARAM_construct_int(&local_148,&_LC1,&local_10c);
  local_108 = local_148;
  ...
  if (param_4 != 0) {
    puVar2 = local_b8;
    OSSL_PARAM_construct_octet_string(&local_148,&_LC2,param_4,param_5);
    local_c0 = local_128;
    local_e0 = local_148;
  ...
  if (param_6 != 0) {
    puVar3 = puVar2 + 5;
    OSSL_PARAM_construct_octet_string(&local_148,&_LC3,param_6,param_7);
    *puVar2 = local_148;
    puVar2[1] = uStack_140;
    puVar2[2] = local_138;
    puVar2[3] = uStack_130;
...

{
  ...
  if (param_4 != 0) {
    puVar2 = local_b8;
    OSSL_PARAM_construct_octet_string(&local_148,&_LC3,param_4,param_5);
    local_c0 = local_128;
    local_e0 = local_148;
    uStack_d8 = uStack_140;
    local_d0 = local_138;
  ...
  if (param_6 != 0) {
    puVar3 = puVar2 + 5;
    OSSL_PARAM_construct_octet_string(&local_148,&_LC4,param_6,param_7);
    *puVar2 = local_148;
    puVar2[1] = uStack_140;
    puVar2[2] = local_138;
    puVar2[3] = uStack_130;
              ...
              if (iVar9 != 1) {
                ...
                do {
                  ...
                  do {
                    ...
                    if (iVar9 == 0) {
                      if ((*psVar10 == 0) || (pcVar6 != (char *)0x0)) goto LAB_00100ec0;
                      param_2[2] = *psVar10;
                      uVar3 = 1;
                      *param_2 = sVar1;
                      param_2[1] = local_42;
...
LAB_00100f4a:
              ...
              if (iVar4 != 0) goto code_r0x00100f5b;
              local_42 = *psVar10;
              sVar2 = local_42;
joined_r0x00100f2b:
              if ((sVar2 == 0) || (iVar9 = iVar9 + 1, pcVar6 == (char *)0x0)) goto LAB_00100ec0;
              __s = pcVar6 + 1;
            }
            do {
              lVar11 = 0;
              do {
                ...
                if (iVar4 == 0) {
                  sVar1 = *psVar10;
                  sVar2 = sVar1;
                  goto joined_r0x00100f2b;
                }
                lVar11 = lVar11 + 1;
              } while (lVar11 != 4);
              psVar10 = psVar10 + 0x14;
            } while (psVar10 != (short *)&DAT_00101448);
          }
LAB_00100ec0:
          uVar3 = 0;
LAB_00100ec2:
...
code_r0x00100f5b:
  lVar11 = lVar11 + 1;
  if (lVar11 == 4) goto code_r0x00100f65;
  goto LAB_00100f4a;
code_r0x00100f65:
  psVar10 = psVar10 + 0x14;
  if (psVar10 == (short *)&DAT_00101378) goto LAB_00100ec0;
  goto LAB_00100f47;
}

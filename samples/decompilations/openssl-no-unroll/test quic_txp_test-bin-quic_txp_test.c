...

{
  ...
  iVar1 = test_uint64_t_eq("test/quic_txp_test.c",0x420,"h->frame.reset_stream.stream_id",&_LC0,
                           *(undefined8 *)(param_1 + 0x468),0x2a);
  if (iVar1 != 0) {
    iVar1 = test_uint64_t_eq("test/quic_txp_test.c",0x421,"h->frame.reset_stream.app_error_code",
                             &_LC3,*(undefined8 *)(param_1 + 0x470),0x11d8);
    if (iVar1 != 0) {
      iVar1 = test_uint64_t_eq("test/quic_txp_test.c",0x422,"h->frame.reset_stream.final_size",&_LC5
...

{
  ...
  uVar2 = test_uint64_t_eq("test/quic_txp_test.c",0x400,"h->frame.stop_sending.stream_id",&_LC0,
                           *(undefined8 *)(param_1 + 0x468),0x2a);
  if ((int)uVar2 != 0) {
    iVar1 = test_uint64_t_eq("test/quic_txp_test.c",0x401,"h->frame.stop_sending.app_error_code",
                             &_LC3,*(undefined8 *)(param_1 + 0x470),0x11d8);
    uVar2 = (ulong)(iVar1 != 0);
  }
  return uVar2;
...

{
  ...
  iVar1 = test_mem_eq("test/quic_txp_test.c",0x281,"h->frame.stream.data","stream_9",
                      *(undefined8 *)(param_1 + 0x480),*(undefined8 *)(param_1 + 0x478),&stream_9,8)
  ;
  return iVar1 != 0;
}
...

{
  ...
  iVar1 = test_mem_eq("test/quic_txp_test.c",0x216,"h->frame.new_token.token","token_1",
                      *(undefined8 *)(param_1 + 0x468),*(undefined8 *)(param_1 + 0x470),&token_1,6);
  return iVar1 != 0;
}
...

{
  ...
  iVar1 = test_uint64_t_eq("test/quic_txp_test.c",0x1ca,"h->frame.new_conn_id.seq_num",&_LC13,
                           *(undefined8 *)(param_1 + 0x468),0x929);
  if (iVar1 != 0) {
    iVar1 = test_uint64_t_eq("test/quic_txp_test.c",0x1cb,"h->frame.new_conn_id.retire_prior_to",
                             &_LC15,*(undefined8 *)(param_1 + 0x470),0x4d2);
    if (iVar1 != 0) {
      iVar1 = test_mem_eq("test/quic_txp_test.c",0x1cc,"&h->frame.new_conn_id.conn_id","&cid_1",
                          param_1 + 0x478,0x15,cid_1,0x15);
      if (iVar1 != 0) {
        iVar1 = test_mem_eq("test/quic_txp_test.c",0x1ce,
                            "&h->frame.new_conn_id.stateless_reset.token","reset_token_1",
                            param_1 + 0x48d,0x10,reset_token_1,0x10);
        return iVar1 != 0;
      }
    }
  }
...

{
  ...
  iVar1 = test_int_eq("test/quic_txp_test.c",0x450,"h->frame.conn_close.is_app",&_LC5,
                      *(byte *)(param_1 + 0x468) & 1,0);
  if (iVar1 != 0) {
    iVar1 = test_uint64_t_eq("test/quic_txp_test.c",0x451,"h->frame.conn_close.frame_type",
                             "OSSL_QUIC_FRAME_TYPE_HANDSHAKE_DONE",*(undefined8 *)(param_1 + 0x478),
                             0x1e);
    if (iVar1 != 0) {
      iVar1 = test_uint64_t_eq("test/quic_txp_test.c",0x453,"h->frame.conn_close.error_code",&_LC13,
                               *(undefined8 *)(param_1 + 0x470),0x929);
      if (iVar1 != 0) {
        iVar1 = test_mem_eq("test/quic_txp_test.c",0x454,"h->frame.conn_close.reason",
                            "\"Reason string\"",*(undefined8 *)(param_1 + 0x480),
                            *(undefined8 *)(param_1 + 0x488),"Reason string",0xd);
        return iVar1 != 0;
      }
    }
  }
...

{
  ...
  param_1[0x89] = 0;
  ossl_ackm_on_pkt_space_discarded(param_1[0x18],0);
  ossl_ackm_on_pkt_space_discarded(param_1[0x18],1);
  ossl_ackm_on_pkt_space_discarded(param_1[0x18],2);
  ...
  ossl_quic_sstream_free(param_1[0x25]);
  ossl_quic_sstream_free(param_1[0x26]);
  ossl_quic_sstream_free(param_1[0x27]);
...

{
  ...
  iVar1 = test_false("test/quic_txp_test.c",0x4ca,
                     "ossl_quic_tx_packetiser_set_initial_token(h->txp, big_token, sizeof(big_token), NULL, NULL)"
                     ,iVar1 != 0);
  if (iVar1 != 0) {
    lVar2 = 0x79d;
    while( true ) {
...
bool gen_conn_close(undefined8 *param_1)

{
  ...
  iVar1 = test_true("test/quic_txp_test.c",0x448,
                    "ossl_quic_tx_packetiser_schedule_conn_close(h->txp, &f)",iVar1 != 0);
...

{
  ...
  iVar1 = test_uint64_t_ge("test/quic_txp_test.c",0x3b2,"h->frame.stream.len",&_LC32,
                           *(undefined8 *)(param_1 + 0x478),5);
  if (iVar1 != 0) {
    iVar1 = test_uint64_t_le("test/quic_txp_test.c",0x3b3,"h->frame.stream.len",&_LC34,
                             *(undefined8 *)(param_1 + 0x478),200);
    if (iVar1 != 0) {
      iVar1 = test_mem_eq("test/quic_txp_test.c",0x3b6,"h->frame.stream.data",
                          "stream_10b + stream_10b_off",*(undefined8 *)(param_1 + 0x480),
                          *(undefined8 *)(param_1 + 0x478),stream_10b + stream_10b_off,
...

{
  ...
  iVar1 = test_uint64_t_ge("test/quic_txp_test.c",0x3a5,"h->frame.stream.len",&_LC32,
                           *(undefined8 *)(param_1 + 0x478),5);
  if (iVar1 != 0) {
    iVar1 = test_uint64_t_le("test/quic_txp_test.c",0x3a6,"h->frame.stream.len",&_LC34,
                             *(undefined8 *)(param_1 + 0x478),200);
    if (iVar1 != 0) {
      iVar1 = test_mem_eq("test/quic_txp_test.c",0x3a9,"h->frame.stream.data",
                          "stream_10a + stream_10a_off",*(undefined8 *)(param_1 + 0x480),
                          *(undefined8 *)(param_1 + 0x478),stream_10a + stream_10a_off,
                          *(undefined8 *)(param_1 + 0x478));
      return iVar1 != 0;
    }
  }
...

{
  ...
  iVar1 = test_uint64_t_ge("test/quic_txp_test.c",0x397,"h->frame.stream.len",&_LC37,
                           *(undefined8 *)(param_1 + 0x478),0x47e);
  if (iVar1 != 0) {
    iVar1 = test_uint64_t_le("test/quic_txp_test.c",0x398,"h->frame.stream.len",&_LC38,
                             *(undefined8 *)(param_1 + 0x478),0x4b0);
    if (iVar1 != 0) {
      iVar1 = test_mem_eq("test/quic_txp_test.c",0x39b,"h->frame.stream.data","stream_10b",
                          *(undefined8 *)(param_1 + 0x480),*(undefined8 *)(param_1 + 0x478),
                          stream_10b,*(undefined8 *)(param_1 + 0x478));
      if (iVar1 != 0) {
...

{
  ...
  iVar1 = test_uint64_t_ge("test/quic_txp_test.c",0x389,"h->frame.stream.len",&_LC37,
                           *(undefined8 *)(param_1 + 0x478),0x47e);
  if (iVar1 != 0) {
    iVar1 = test_uint64_t_le("test/quic_txp_test.c",0x38a,"h->frame.stream.len",&_LC38,
                             *(undefined8 *)(param_1 + 0x478),0x4b0);
    if (iVar1 != 0) {
      iVar1 = test_mem_eq("test/quic_txp_test.c",0x38d,"h->frame.stream.data","stream_10a",
                          *(undefined8 *)(param_1 + 0x480),*(undefined8 *)(param_1 + 0x478),
                          stream_10a,*(undefined8 *)(param_1 + 0x478));
      if (iVar1 != 0) {
...

{
  ...
  do {
    ...
    uVar2 = test_true("test/quic_txp_test.c",0x23c,"ossl_ackm_on_rx_packet(h->args.ackm, &rx_pkt)",
                      iVar1 != 0);
...

{
  ...
  if (iVar1 != 0) {
    ...
    if (iVar1 != 0) {
      ...
      iVar1 = test_true("test/quic_txp_test.c",0x1fa,
      ...
      if (iVar1 == 0) {
        ...
        iVar1 = test_true("test/quic_txp_test.c",0x202,"WPACKET_get_total_written(&wpkt, &l)",
                          iVar1 != 0);
        if (iVar1 != 0) {
          uVar2 = ossl_quic_cfq_add_frame
                            (*(undefined8 *)(param_1 + 0xb8),1,2,7,0,a->data,local_70,free_buf_mem,a
                            );
          iVar1 = test_ptr("test/quic_txp_test.c",0x205,
                           "cfq_item = ossl_quic_cfq_add_frame(h->args.cfq, 1, QUIC_PN_SPACE_APP, OSSL_QUIC_FRAME_TYPE_NEW_TOKEN, 0, (unsigned char *)buf_mem->data, l, free_buf_mem, buf_mem)"
                           ,uVar2);
          if (iVar1 != 0) {
            uVar2 = 1;
            goto LAB_00100b9e;
...
undefined8 schedule_cfq_new_conn_id(long param_1)

{
  ...
  if (iVar1 != 0) {
    ...
    if (iVar1 != 0) {
      ...
      iVar1 = test_true("test/quic_txp_test.c",0x1af,
                        "ossl_quic_wire_encode_frame_new_conn_id(&wpkt, &ncid)",iVar1 != 0);
      if (iVar1 == 0) {
        ...
        iVar1 = test_true("test/quic_txp_test.c",0x1b6,"WPACKET_get_total_written(&wpkt, &l)",
                          iVar1 != 0);
        if (iVar1 != 0) {
          uVar2 = ossl_quic_cfq_add_frame
                            (*(undefined8 *)(param_1 + 0xb8),1,2,0x18,0,a->data,local_b0,
                             free_buf_mem,a);
          iVar1 = test_ptr("test/quic_txp_test.c",0x1b9,
                           "cfq_item = ossl_quic_cfq_add_frame(h->args.cfq, 1, QUIC_PN_SPACE_APP, OSSL_QUIC_FRAME_TYPE_NEW_CONN_ID, 0, (unsigned char *)buf_mem->data, l, free_buf_mem, buf_mem)"
                           ,uVar2);
          if (iVar1 != 0) {
            uVar2 = 1;
            goto LAB_00100d8d;
...

{
  ...
  uVar3 = test_true("test/quic_txp_test.c",0x17c,
                    "ossl_quic_rxfc_on_rx_stream_frame(&h->stream_rxfc, cwm, 0)",iVar1 != 0);
  if ((int)uVar3 != 0) {
    iVar1 = ossl_quic_rxfc_on_retire(param_1,uVar2,1000000);
    iVar1 = test_true("test/quic_txp_test.c",0x17d,
                      "ossl_quic_rxfc_on_retire(&h->stream_rxfc, cwm, ossl_ticks2time(OSSL_TIME_MS))"
                      ,iVar1 != 0);
    uVar3 = (ulong)(iVar1 != 0);
  }
  return uVar3;
...
{
  if (((param_3 != (char *)0x0) && (*param_3 == '\b')) &&
     (*(long *)(param_3 + 1) == -0x5758595a5b5c5d5f)) {
...
undefined8 run_script(int param_1,int *param_2)

{
  ...
  iVar4 = test_true("test/quic_txp_test.c",0x82,"BIO_new_bio_dgram_pair(&h->bio1, 0, &h->bio2, 0)",
                    iVar4 != 0);
  if (iVar4 != 0) {
    local_490 = 0x4b0;
    local_498 = local_478;
    local_540 = ossl_qtx_new(local_4a8);
    iVar4 = test_ptr("test/quic_txp_test.c",0x88,"h->args.qtx = ossl_qtx_new(&h->qtx_args)",
                     local_540);
    if (iVar4 != 0) {
      ...
      if (iVar4 != 0) {
        ...
        if (iVar4 != 0) {
          ...
          iVar4 = test_true("test/quic_txp_test.c",0x91,"ossl_quic_txfc_init(&h->conn_txfc, NULL)",
                            iVar4 != 0);
          if (iVar4 != 0) {
            iVar4 = ossl_quic_rxfc_init(local_448,0,0x200000,0xa00000,fake_now,0);
            iVar4 = test_true("test/quic_txp_test.c",0x94,
                              "ossl_quic_rxfc_init(&h->conn_rxfc, NULL, 2 * 1024 * 1024, 10 * 1024 * 1024, fake_now, NULL)"
                              ,iVar4 != 0);
            if (iVar4 != 0) {
              iVar4 = ossl_quic_rxfc_init(local_3e8,local_448,0x100000,0x500000,fake_now,0);
              iVar4 = test_true("test/quic_txp_test.c",0x9b,
              ...
              if (iVar4 != 0) {
                ...
                iVar4 = test_true("test/quic_txp_test.c",0xa2,
                                  "ossl_quic_rxfc_init(&h->max_streams_bidi_rxfc, NULL, 100, 100, fake_now, NULL)"
                                  ,iVar4 != 0);
                if (iVar4 != 0) {
                  iVar4 = ossl_quic_rxfc_init(local_328,0,100,100,fake_now,0);
                  iVar4 = test_true("test/quic_txp_test.c",0xa8,
                                    "ossl_quic_rxfc_init(&h->max_streams_uni_rxfc, NULL, 100, 100, fake_now, NULL)"
                                    ,iVar4 != 0);
                  if (iVar4 == 0) {
                    iVar4 = ossl_statm_init(local_2c8);
                    iVar4 = test_true("test/quic_txp_test.c",0xad,"ossl_statm_init(&h->statm)",
                                      iVar4 != 0);
                  ...
                  iVar4 = test_ptr("test/quic_txp_test.c",0xb3,
                                   "h->cc_data = h->cc_method->new(fake_now, NULL)",local_2a0);
                  if (iVar4 != 0) {
                    local_528 = ossl_ackm_new(fake_now,0,local_2c8,puStack_298,local_2a0);
                    iVar4 = test_ptr("test/quic_txp_test.c",0xb6,
                                     "h->args.ackm = ossl_ackm_new(fake_now, NULL, &h->statm, h->cc_method, h->cc_data)"
                                     ,local_528);
                    if (iVar4 != 0) {
                      iVar4 = ossl_quic_stream_map_init(local_290,0,0,local_388,local_328,0);
                      iVar4 = test_true("test/quic_txp_test.c",0xbc,
                                        "ossl_quic_stream_map_init(&h->qsm, NULL, NULL, &h->max_streams_bidi_rxfc, &h->max_streams_uni_rxfc, 0)"
                                        ,iVar4 != 0);
                      if (iVar4 != 0) {
                        local_1ff = 1;
                        puVar8 = local_5e8;
                        do {
                          ...
                          puVar8[0x25] = uVar5;
                          iVar4 = test_ptr("test/quic_txp_test.c",0xc5,
                                           "h->args.crypto[i] = ossl_quic_sstream_new(4096)",uVar5);
                          if (iVar4 == 0) goto LAB_00101049;
                          puVar8 = puVar8 + 1;
                        ...
                        iVar4 = test_ptr("test/quic_txp_test.c",0xd4,
                                         "h->txp = ossl_quic_tx_packetiser_new(&h->args)",
                                         local_5e8[0]);
                        if (iVar4 != 0) {
                          ossl_quic_tx_packetiser_set_validated(local_5e8[0]);
                          local_1f8 = ossl_quic_demux_new(local_470,8,fake_now,0);
                          iVar4 = test_ptr("test/quic_txp_test.c",0xdd,
                                           "h->demux = ossl_quic_demux_new(h->bio2, 8, fake_now, NULL)"
                                           ,local_1f8);
                          if (iVar4 != 0) {
                            ossl_quic_demux_set_default_handler
                                      (local_1f8,demux_default_handler,local_5e8);
                            local_1d8 = local_1f8;
                            local_1d0 = __LC70;
                            uStack_1c8 = _UNK_00108c48;
                            local_1f0 = ossl_qrx_new(local_1e8);
                            iVar4 = test_ptr("test/quic_txp_test.c",0xe7,
                                             "h->qrx = ossl_qrx_new(&h->qrx_args)",local_1f0);
                            if (iVar4 != 0) {
                              lVar7 = 0;
                              ossl_qrx_allow_1rtt_processing(local_1f0);
                              iVar4 = *param_2;
joined_r0x00101563:
                              if (iVar4 == 0) goto LAB_001015fb;
                              switch(iVar4) {
                              case 1:
...
LAB_00101d95:
                                  iVar4 = test_ptr_null("test/quic_record_test_util.h",0x2c,
                                                        "a->token",*(undefined8 *)(puVar3 + 0x38));
                                  if (iVar4 != 0) {
                                    lVar6 = *(long *)(puVar2 + 0x40);
LAB_00101dc0:
                                    if (lVar6 == 0) goto LAB_001022fd;
                                  }
                                }
                                else {
                                  if (*(long *)(puVar2 + 0x40) != 0) {
                                    test_mem_eq("test/quic_record_test_util.h",0x29,"a->token",
                                                "b->token",*(undefined8 *)(puVar3 + 0x38),
                                                *(long *)(puVar3 + 0x40),
                                                *(undefined8 *)(puVar2 + 0x38),
                                                *(long *)(puVar2 + 0x40));
...
LAB_001022fd:
                                  test_ptr_null("test/quic_record_test_util.h",0x2d,"b->token",
                                                *(undefined8 *)(puVar2 + 0x38));
                                }
                                iVar4 = test_true("test/quic_txp_test.c",0x54f,
                                                  "cmp_pkt_hdr(h.qrx_pkt->hdr, op->buf, NULL, 0, 0)"
                                                 );
                                goto joined_r0x0010188b;
                              case 9:
...
LAB_001016dc:
                              uVar5 = 0;
                              test_error("test/quic_txp_test.c",0x64b,"script %d failed at op %zu",
                                         param_1 + 1,lVar7 + 1);
                              goto LAB_00101600;
                            }
                          }
...
LAB_00101049:
  uVar5 = 0;
  helper_cleanup(local_5e8);
  test_error("test/quic_txp_test.c",0x64b,"script %d failed at op %zu",param_1 + 1,1);
LAB_00101077:
...
undefined4 test_dyn_script_1(undefined8 param_1)

...
bool blake2b_part_0_constprop_0
               (undefined8 param_1,undefined8 param_2,uchar *param_3,undefined8 param_4,
               void *param_5)
  ...
  if (*(int *)(param_2 + 0x54) != 0) {
    ...
    do {
      ...
      *(undefined4 *)(param_1 + 0x40) = 0;
      blake2b_long_isra_0(*(undefined8 *)(param_2 + 0x88),*(undefined8 *)(param_2 + 0x90),local_448,
                          0x400,param_1,0x48);
      lVar5 = 0;
      puVar6 = (undefined8 *)
               ((ulong)(uVar7 * *(int *)(param_2 + 0x7c)) * 0x400 + *(long *)(param_2 + 0x68));
      if (puVar6 == puVar3) {
        do {
      ...
      *(undefined4 *)(param_1 + 0x40) = uVar4;
      ...
      lVar5 = 0;
      puVar6 = (undefined8 *)
               ((ulong)(*(int *)(param_2 + 0x7c) * uVar7 + 1) * 0x400 + *(long *)(param_2 + 0x68));
      if (puVar6 == puVar3) {
        do {
          *(undefined8 *)((long)puVar3 + lVar5) = *(undefined8 *)((long)local_448 + lVar5);
          lVar5 = lVar5 + 8;
...

{
  ...
  if (param_1 != 0) {
    ...
    do {
      ...
      auVar195._8_8_ =
           ...
           (CONCAT72(CONCAT61(CONCAT51(CONCAT41(CONCAT31(CONCAT21(CONCAT11((0 < sVar114) *
                                                                  ...
                                                                  * auVar233[10] - (0xff < sVar112))
                                                         ,(0 < sVar111) * (sVar111 < 0x100) *
                                                          auVar224[10] - (0xff < sVar111)),
                                                (0 < sVar110) * (sVar110 < 0x100) * auVar214[10] -
                                                (0xff < sVar110)),
                                       (0 < sVar109) * (sVar109 < 0x100) * auVar254[10] -
                                       (0xff < sVar109)),
                              (0 < sVar108) * (sVar108 < 0x100) * auVar251[10] - (0xff < sVar108)),
                     CONCAT11((0 < sVar107) * (sVar107 < 0x100) * auVar267[10] - (0xff < sVar107),
                              cVar11)) >> 8);
    ...
    blake2b_long_isra_0(*(undefined8 *)(param_1 + 0x88),*(undefined8 *)(param_1 + 0x90),param_2,
                        *(undefined4 *)(param_1 + 8),(undefined1 (*) [16])local_438,0x400);
  ...
  if (uVar18 < uVar17) {
    ...
    if (bVar20) {
      ...
      while( true ) {
        ...
        fill_block(puVar15,lVar6 + (((uVar12 + ((int)uVar7 - 1)) -
                                    (((ulong)uVar8 * (ulong)uVar8 >> 0x20) * uVar7 >> 0x20)) %
                                    uVar13 + uVar13 * uVar4) * 0x400,lVar6 + (ulong)uVar14 * 0x400,
                   *(int *)(param_1 + 0x5c) != 0x10 && param_2 != 0);
        uVar17 = *(uint *)(param_1 + 0x78);
        uVar18 = uVar18 + 1;
        uVar14 = uVar14 + 1;
      ...
      while( true ) {
        ...
        uVar18 = uVar18 + 1;
        uVar14 = uVar14 + 1;
        fill_block(puVar16,lVar6 + (((uVar5 + ((int)uVar10 - 1)) -
                                    (((uVar7 & 0xffffffff) * (uVar7 & 0xffffffff) >> 0x20) * uVar10
                                    >> 0x20)) % uVar13 + uVar13 * uVar12) * 0x400,
                   uVar11 * 0x400 + lVar6,*(int *)(param_1 + 0x5c) != 0x10 && param_2 != 0);
        uVar17 = *(uint *)(param_1 + 0x78);
        if (uVar17 <= uVar18) break;
        uVar13 = (ulong)*(uint *)(param_1 + 0x7c);
        uVar8 = *(uint *)(param_1 + 100);
...
LAB_00102265:
        ...
        if (lVar2 == 0) {
LAB_001022e0:
          lVar2 = OSSL_PARAM_locate_const(param_2,&_LC10);
          if (lVar2 == 0) {
LAB_00102357:
...

{
  ...
  if ((iVar2 != 0) && (iVar2 = kdf_argon2_set_ctx_params(param_1,param_4), iVar2 != 0)) {
    if (*(long *)(param_1 + 0x90) == 0) {
      lVar4 = EVP_MAC_fetch(*(undefined8 *)(param_1 + 0x80),"blake2bmac",
    ...
    if (*(long *)(param_1 + 0x88) == 0) {
      lVar4 = EVP_MD_fetch(*(undefined8 *)(param_1 + 0x80),"blake2b512",
                           *(undefined8 *)(param_1 + 0x98));
          ...
          if (*(uint *)(param_1 + 0x50) < uVar7 * 8) {
            ...
            *(long *)(param_1 + 0x68) = lVar4;
            if (lVar4 == 0) {
              ...
              ctx = (EVP_MD_CTX *)EVP_MD_CTX_new();
              if ((ctx != (EVP_MD_CTX *)0x0) &&
                 (iVar2 = EVP_DigestInit_ex(ctx,*(EVP_MD **)(param_1 + 0x88),(ENGINE *)0x0),
                 iVar2 == 1)) {
                local_ac = 0;
                while (local_8c = uVar11, iVar2 = EVP_DigestUpdate(ctx,&local_8c,4), iVar2 == 1) {
                  ...
                  if (6 < local_ac) {
                    if (*(void **)(param_1 + 0x10) != (void *)0x0) {
                      iVar2 = EVP_DigestUpdate(ctx,*(void **)(param_1 + 0x10),
                    ...
                    if ((iVar2 != 1) ||
                       ((*(void **)(param_1 + 0x20) != (void *)0x0 &&
                        (iVar2 = EVP_DigestUpdate(ctx,*(void **)(param_1 + 0x20),
                                                  (ulong)*(uint *)(param_1 + 0x28)), iVar2 != 1))))
                    break;
                    local_8c = *(undefined4 *)(param_1 + 0x38);
                    iVar2 = EVP_DigestUpdate(ctx,&local_8c,4);
                    if (iVar2 != 1) break;
                    if (*(void **)(param_1 + 0x30) != (void *)0x0) {
                      iVar2 = EVP_DigestUpdate(ctx,*(void **)(param_1 + 0x30),
                    ...
                    if ((iVar2 == 1) &&
                       ((*(void **)(param_1 + 0x40) == (void *)0x0 ||
                        (iVar2 = EVP_DigestUpdate(ctx,*(void **)(param_1 + 0x40),
                                                  (ulong)*(uint *)(param_1 + 0x48)), iVar2 == 1))))
                    {
                      local_ac = 0x40;
...
LAB_00103007:
              ...
              ptr_00 = (ulong *)CRYPTO_zalloc((ulong)*(uint *)(param_1 + 0x54) * 0x18,
                    ...
                    do {
                      ...
                      do {
                        if (*(uint *)(param_1 + 0x58) <= uVar3) {
                          ...
                          if ((iVar2 == 0) ||
                             (iVar2 = ossl_crypto_thread_clean
                                                (ptr[uVar3 - *(int *)(param_1 + 0x58)]), iVar2 == 0)
                             ) goto LAB_00102d50;
                          *plVar9 = 0;
                        }
                        puVar8[2] = param_1;
                      ...
                      if (uVar3 < uVar7) {
                        ...
                        do {
                          ...
                          if ((iVar2 == 0) ||
                             (iVar2 = ossl_crypto_thread_clean(*plVar9), iVar2 == 0))
                          goto LAB_00102d50;
                          uVar7 = *(uint *)(param_1 + 0x54);
                          uVar3 = uVar3 + 1;
                          *plVar9 = 0;
...
LAB_00102d3e:
    iVar2 = ossl_crypto_thread_join(*plVar9,0);
    if ((iVar2 == 0) || (iVar2 = ossl_crypto_thread_clean(*plVar9), iVar2 == 0)) break;
  }
LAB_00102d50:
  CRYPTO_free(ptr_00);
LAB_00102d5d:

...
undefined8 cast5_cbc_cipher(long param_1,uchar *param_2,uchar *param_3,ulong param_4)

{
  ...
  if (0x3fffffff < param_4) {
    ...
    do {
      ...
      CAST_cbc_encrypt(in,out,0x40000000,pCVar3,(uchar *)(param_1 + 0x28),iVar1);
      in = in + 0x40000000;
      out = puVar4;
  ...
  if (local_50 != 0) {
    iVar1 = EVP_CIPHER_CTX_is_encrypting(param_1);
    pCVar3 = (CAST_KEY *)EVP_CIPHER_CTX_get_cipher_data(param_1);
    CAST_cbc_encrypt(local_48,param_2,local_50,pCVar3,(uchar *)(param_1 + 0x28),iVar1);
  }
  return 1;
}
...
undefined8 cast5_ofb_cipher(long param_1,uchar *param_2,uchar *param_3,ulong param_4)

{
  ...
  if (0x3fffffff < param_4) {
    ...
    do {
      local_44 = EVP_CIPHER_CTX_get_num(param_1);
      pCVar2 = (CAST_KEY *)EVP_CIPHER_CTX_get_cipher_data(param_1);
      puVar3 = out + 0x40000000;
      CAST_ofb64_encrypt(in,out,0x40000000,pCVar2,(uchar *)(param_1 + 0x28),&local_44);
      in = in + 0x40000000;
      EVP_CIPHER_CTX_set_num(param_1,local_44);
      out = puVar3;
  ...
  if (local_60 != 0) {
    local_44 = EVP_CIPHER_CTX_get_num(param_1);
    pCVar2 = (CAST_KEY *)EVP_CIPHER_CTX_get_cipher_data(param_1);
    CAST_ofb64_encrypt(local_58,param_2,local_60,pCVar2,(uchar *)(param_1 + 0x28),&local_44);
    EVP_CIPHER_CTX_set_num(param_1,local_44);
  }
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */

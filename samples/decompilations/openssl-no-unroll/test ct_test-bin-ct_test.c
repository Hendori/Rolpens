...

{
  ...
  iVar2 = test_int_ge("test/ct_test.c",0xbe,"SCT_LIST_validate(scts, policy_ctx)",&_LC10,uVar1,0);
  if (iVar2 != 0) {
    iVar2 = 0;
    iVar6 = 0;
    iVar5 = 0;
...

{
  ...
  local_2008 = (void *)0x0;
  local_2000 = (void *)0x0;
  uVar6 = CT_POLICY_EVAL_CTX_new();
  if (*(long *)(param_1 + 0x58) != 0) {
    pcVar7 = (char *)test_mk_file_path(*(undefined8 *)(param_1 + 0x50));
    if (pcVar7 == (char *)0x0) {
      uVar11 = 0xffffffffffffffff;
    }
    else {
      uVar11 = 0xffffffffffffffff;
      pBVar8 = BIO_new_file(pcVar7,"r");
      if (pBVar8 != (BIO *)0x0) {
        iVar3 = BIO_read(pBVar8,local_1fe8,0x1f9f);
        uVar11 = (ulong)iVar3;
      }
      BIO_free(pBVar8);
    }
    CRYPTO_free(pcVar7);
    iVar3 = test_int_ge("test/ct_test.c",0xf1,"sct_text_len",&_LC10,uVar11 & 0xffffffff,0);
    if (iVar3 == 0) {
      a = (X509 *)0x0;
      x = (X509 *)0x0;
      iVar3 = 0;
  ...
  CT_POLICY_EVAL_CTX_set_shared_CTLOG_STORE(uVar6,*(undefined8 *)(param_1 + 0x10));
  CT_POLICY_EVAL_CTX_set_time(uVar6,*(undefined8 *)(param_1 + 8));
...
LAB_001008bd:
    ...
    uVar10 = o2i_SCT_LIST(&local_2008,&local_1ff8,*(undefined8 *)(param_1 + 0x40));
    iVar3 = test_ptr("test/ct_test.c",0x12f,"o2i_SCT_LIST(&scts, &p, fixture->tls_sct_list_len)",
                     uVar10);
    if ((iVar3 != 0) &&
       (((*(int *)(param_1 + 0x60) == 0 || (x == (X509 *)0x0)) ||
        (iVar3 = assert_validity(param_1,local_2008,uVar6), iVar3 != 0)))) {
      pvVar2 = local_2008;
      if (*(long *)(param_1 + 0x58) == 0) {
LAB_0010087c:
        iVar3 = i2o_SCT_LIST(local_2008,&local_2000);
        iVar3 = test_mem_eq("test/ct_test.c",0x13d,"fixture->tls_sct_list","tls_sct_list",
                            *(undefined8 *)(param_1 + 0x38),*(undefined8 *)(param_1 + 0x40),
                            local_2000,(long)iVar3);
        if (iVar3 != 0) goto LAB_001008bd;
      }
      else {
        local_1ff0 = 0;
        pBVar9 = BIO_s_mem();
        pBVar8 = BIO_new(pBVar9);
        iVar3 = test_ptr("test/ct_test.c",0x85,"text_buffer = BIO_new(BIO_s_mem())",pBVar8);
        if (iVar3 != 0) {
          SCT_LIST_print(pvVar2,pBVar8,0,&_LC22,0);
          iVar3 = BIO_write(pBVar8,&DAT_001018a0,1);
          iVar3 = test_true("test/ct_test.c",0x8b,"BIO_write(text_buffer, \"\\0\", 1)",iVar3 != 0);
          if (iVar3 != 0) {
            BIO_ctrl(pBVar8,3,0,&local_1ff0);
            iVar3 = test_str_eq("test/ct_test.c",0x8f,"actual_output","expected_output",local_1ff0,
                                local_1fe8);
            if (iVar3 != 0) {
              BIO_free(pBVar8);
              goto LAB_0010087c;
...
LAB_0010075e:
    ...
    x = (X509 *)0x0;
    pcVar7 = (char *)test_mk_file_path(*(undefined8 *)(param_1 + 0x18),*(long *)(param_1 + 0x20));
    if (pcVar7 != (char *)0x0) {
      pBVar8 = BIO_new_file(pcVar7,"r");
      if (pBVar8 != (BIO *)0x0) {
        x = PEM_read_bio_X509(pBVar8,(X509 **)0x0,(undefined1 *)0x0,(void *)0x0);
      }
      BIO_free(pBVar8);
    }
    a = (X509 *)0x0;
    CRYPTO_free(pcVar7);
    iVar3 = test_ptr("test/ct_test.c",0x100,
                     "cert = load_pem_cert(fixture->certs_dir, fixture->certificate_file)");
    if (iVar3 == 0) goto LAB_00100776;
    CT_POLICY_EVAL_CTX_set1_cert(uVar6,x);
    pXVar1 = *(X509 **)(param_1 + 0x28);
    a = pXVar1;
    if (pXVar1 != (X509 *)0x0) {
      a = (X509 *)0x0;
      pcVar7 = (char *)test_mk_file_path(*(undefined8 *)(param_1 + 0x18),pXVar1);
      if (pcVar7 != (char *)0x0) {
        pBVar8 = BIO_new_file(pcVar7,"r");
        if (pBVar8 != (BIO *)0x0) {
          a = PEM_read_bio_X509(pBVar8,(X509 **)0x0,(undefined1 *)0x0,(void *)0x0);
        }
        BIO_free(pBVar8);
      }
      CRYPTO_free(pcVar7);
      iVar3 = test_ptr("test/ct_test.c",0x107,
                       "issuer = load_pem_cert(fixture->certs_dir, fixture->issuer_file)",a);
      if (iVar3 == 0) goto LAB_00100776;
      CT_POLICY_EVAL_CTX_set1_issuer(uVar6,a);
    }
    iVar3 = X509_get_ext_by_NID(x,0x3b7,-1);
    ext = X509_get_ext(x,iVar3);
    if (*(int *)(param_1 + 0x30) < 1) {
      iVar3 = test_ptr_null("test/ct_test.c",0x127,"sct_extension",ext);
joined_r0x001008df:
      if (iVar3 != 0) goto LAB_001006bb;
    }
    else {
      iVar3 = test_ptr("test/ct_test.c",0x111);
      if (iVar3 != 0) {
        if (*(long *)(param_1 + 0x58) == 0) {
LAB_001009e0:
          local_2008 = X509V3_EXT_d2i(ext);
          for (iVar3 = 0; iVar5 = OPENSSL_sk_num(local_2008), iVar3 < iVar5; iVar3 = iVar3 + 1) {
            uVar10 = OPENSSL_sk_value(local_2008,iVar3);
            uVar4 = SCT_get_source(uVar10);
            iVar5 = test_int_eq("test/ct_test.c",0x11d,"SCT_get_source(sct_i)",
                                "SCT_SOURCE_X509V3_EXTENSION",uVar4,2);
            if (iVar5 == 0) goto LAB_00100763;
          }
          if (*(int *)(param_1 + 0x60) == 0) goto LAB_001006bb;
          iVar3 = assert_validity(param_1,local_2008,uVar6);
          goto joined_r0x001008df;
        }
        local_1ff0 = 0;
        pBVar9 = BIO_s_mem();
        pBVar8 = BIO_new(pBVar9);
        iVar3 = test_ptr("test/ct_test.c",0x9f,"text_buffer = BIO_new(BIO_s_mem())");
        if (iVar3 != 0) {
          iVar3 = X509V3_EXT_print(pBVar8,ext,0,0);
          iVar3 = test_true("test/ct_test.c",0xa0,
          ...
          iVar3 = BIO_write(pBVar8,&_LC22,1);
          iVar3 = test_true("test/ct_test.c",0xa5,"BIO_write(text_buffer, \"\\n\", 1)",iVar3 != 0);
          if (iVar3 != 0) {
            iVar3 = BIO_write(pBVar8,&DAT_001018a0,1);
            iVar3 = test_true("test/ct_test.c",0xa9,"BIO_write(text_buffer, \"\\0\", 1)",iVar3 != 0)
            ;
            if (iVar3 != 0) {
              BIO_ctrl(pBVar8,3,0,&local_1ff0);
              iVar3 = test_str_eq("test/ct_test.c",0xad,"actual_output","expected_output",local_1ff0
                                  ,local_1fe8);
              if (iVar3 == 0) {
                BIO_free(pBVar8);
                goto LAB_00100763;
...

{
  ...
  local_20 = *(long *)(in_FS_OFFSET + 0x28);
  local_a8 = __LC34;
  uStack_a0 = _UNK_001019f8;
  local_98 = __LC35;
  uStack_90 = _UNK_00101a08;
  local_88 = __LC36;
  uStack_80 = _UNK_00101a18;
  local_78 = __LC37;
  uStack_70 = _UNK_00101a28;
  local_68 = __LC38;
  uStack_60 = _UNK_00101a38;
  local_58 = __LC39;
  uStack_50 = _UNK_00101a48;
  local_48 = __LC40;
  uStack_40 = (undefined3)_UNK_00101a58;
  uStack_3d = (undefined5)__LC41;
  uStack_38 = (undefined3)((ulong)__LC41 >> 0x28);
  uStack_35 = _UNK_00101a68;
...

{
  ...
  if (ptr != (void *)0x0) {
    ...
    *(undefined8 *)((long)ptr + 0x30) = _LC47;
    uVar2 = execute_cert_test(ptr);
    CTLOG_STORE_free(*(undefined8 *)((long)ptr + 0x10));
    SCT_LIST_free(*(undefined8 *)((long)ptr + 0x48));
    CRYPTO_free(ptr);
...

{
  ...
  if (ptr != (void *)0x0) {
    ...
    *(char **)((long)ptr + 0x20) = "embeddedSCTs1.pem";
    *(char **)((long)ptr + 0x28) = "embeddedSCTs1_issuer.pem";
    *(undefined8 *)((long)ptr + 0x30) = _LC48;
    uVar2 = execute_cert_test(ptr);
    CTLOG_STORE_free(*(undefined8 *)((long)ptr + 0x10));
    SCT_LIST_free(*(undefined8 *)((long)ptr + 0x48));
    CRYPTO_free(ptr);
...

{
  ...
  local_b9 = 0;
  local_b8 = __LC54;
  uStack_b0 = _UNK_00101a78;
  local_a8 = __LC55;
  uStack_a0 = (undefined5)_UNK_00101a88;
  uStack_9b = (undefined3)_LC56._0_8_;
  uStack_98 = SUB85(_LC56._0_8_,3);
  acStack_93._0_8_ = _LC56._8_8_;
  local_88 = __LC57;
  uStack_80 = _UNK_00101aa8;
  local_78 = __LC58;
  uStack_70 = _UNK_00101ab8;
  local_68 = __LC59;
  uStack_60 = _UNK_00101ac8;
  local_58 = __LC60;
  uStack_50 = _UNK_00101ad8;
  local_48 = __LC61;
  uStack_40 = _UNK_00101ae8;
  local_38 = __LC62;
  uStack_30 = (undefined5)_UNK_00101af8;
  uStack_2b = 0x4a325a;

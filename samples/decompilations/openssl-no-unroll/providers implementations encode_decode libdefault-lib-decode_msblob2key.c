...
LAB_00100420:
    uVar2 = ossl_blob_length(local_148,local_140,local_13c);
    if (0x19000 < uVar2) {
      ERR_new();
    ...
    data = (undefined1 *)
           CRYPTO_malloc(uVar2,"providers/implementations/encode_decode/decode_msblob2key.c",0x86);
...
LAB_00100622:
            ...
            if (local_130 != 0) goto LAB_0010050e;
LAB_00100497:
            if (*(code **)(param_1[1] + 0x20) == (code *)0x0) goto LAB_00100220;
            local_138 = data;

...
LAB_00100184:
    param_1 = ossl_lib_ctx_get_data(*param_3,0xf);
    if (param_1 != 0) goto LAB_0010012d;
  }
  uVar2 = 0;
LAB_0010014a:
...
LAB_001004c0:
  ...
  ERR_set_error(0x2c,iVar8,"%s%s, Scheme (%s : %d), Properties (%s)",pcVar5,uVar6,param_2,iVar2,
                param_3);
  lVar3 = local_88;
LAB_001003a0:
      ...
      *(undefined4 *)((long)ptr + 0x80) = 1;
      ...
      if (iVar4 != 0) {
        ...
        *(undefined8 *)((long)ptr + 0x78) = uVar2;
        while (iVar4 != 0) {
          ...
          case 3:
            if (*(long *)((long)ptr + 0x98) == 0) {
              *(undefined8 *)((long)ptr + 0x98) = *(undefined8 *)(piVar7 + 2);
            }
            break;
          case 4:
            if (*(long *)((long)ptr + 0xa0) == 0) {
              *(undefined8 *)((long)ptr + 0xa0) = *(undefined8 *)(piVar7 + 2);
            }
            break;
          case 5:
            if (*(long *)((long)ptr + 0xa8) == 0) {
              *(undefined8 *)((long)ptr + 0xa8) = *(undefined8 *)(piVar7 + 2);
            }
            break;
          case 6:
            if (*(long *)((long)ptr + 0xb0) == 0) {
              *(undefined8 *)((long)ptr + 0xb0) = *(undefined8 *)(piVar7 + 2);
            }
            break;
          case 7:
            if (*(long *)((long)ptr + 0xb8) == 0) {
              *(undefined8 *)((long)ptr + 0xb8) = *(undefined8 *)(piVar7 + 2);
            }
            break;
          case 8:
            if (*(long *)((long)ptr + 0xc0) == 0) {
              *(undefined8 *)((long)ptr + 0xc0) = *(undefined8 *)(piVar7 + 2);
            }
            break;
          case 9:
            if (*(long *)((long)ptr + 200) == 0) {
              *(undefined8 *)((long)ptr + 200) = *(undefined8 *)(piVar7 + 2);
            }
            break;
          case 10:
        ...
        if ((((lVar6 != 0) || (*(long *)((long)ptr + 0x90) != 0)) &&
            (*(long *)((long)ptr + 0xa8) != 0)) &&
           ((*(long *)((long)ptr + 0xb0) != 0 && (*(long *)((long)ptr + 0xb8) != 0)))) {
          return ptr;
        }

...
/* WARNING: Removing unreachable block (ram,0x0010128b) */

void print_array(BIO *param_1,undefined8 param_2,uint param_3,byte *param_4)
    ...
    if (0 < (int)(param_3 - 1)) {
      ...
      do {
        ...
        while( true ) {
          ...
          pbVar2 = pbVar2 + 1;
          if (((uint)(iVar4 * -0x33333333) >> 1 | (uint)((iVar4 * -0x33333333 & 1U) != 0) << 0x1f) <
              0x1999999a) break;
          BIO_printf(param_1,"0x%02X, ",(ulong)*pbVar2);
        }
      } while( true );
...
bool do_X509_sign(X509 *param_1,int param_2,undefined8 param_3,undefined8 param_4,undefined8 param_5
                 ,undefined8 param_6)

{
  ...
  if (param_2 == 0) {
    ...
    if ((iVar1 != 0) &&
       (iVar1 = adapt_keyid_ext(param_1,param_6,"subjectKeyIdentifier",&_LC84,1), iVar1 != 0)) {
...

{
  ...
  if (a != (BIO *)0x0) {
    ...
    in = (BIO *)OSSL_HTTP_transfer(0,param_1,param_2,param_3,param_6 != 0,param_4,param_5,0,0,
                                   _GLOBAL_OFFSET_TABLE_,&local_68,0,param_7,param_8,a,param_11,1,
                                   0x19000,(undefined4)param_12,0);
    BIO_free(a);
...
undefined8 app_load_config_internal(char *param_1,int param_2)
...
LAB_001036e5:
  uVar3 = app_load_config_bio(a,param_1);
  BIO_free(a);
  return uVar3;
}
...
CONF * app_load_config_modules(long param_1)
...
undefined8
load_key_certs_crls(char *param_1,int param_2,int param_3,undefined8 param_4,char *param_5,
...
LAB_00104d13:
      if (*param_13 != 0) goto LAB_00104d1d;
      local_108 = "private key";
LAB_00104691:
      lVar6 = OPENSSL_sk_new_null();
      *param_13 = lVar6;
joined_r0x001046a1:
      if (lVar6 != 0) goto LAB_0010424c;
LAB_00104ad6:
      if (param_6 == 0) {
...
LAB_00104220:
      if (param_12 != (long *)0x0) goto LAB_0010422c;
joined_r0x00104240:
      if (param_13 != (long *)0x0) goto LAB_00104242;
      goto LAB_0010424c;
    }
    if (param_10 != (long *)0x0) {
LAB_0010445d:
...
LAB_00104908:
        ...
        local_f0 = 0;
LAB_00104378:
        if (param_7 != (long *)0x0 || param_8 != (long *)0x0) goto LAB_00104518;
LAB_00104384:
        if ((((param_11 != (long *)0x0 || param_13 != (long *)0x0) || param_9 != (long *)0x0) ||
            local_130 != (long *)0x0) || local_128 != (long *)0x0) {
          do {
...
LAB_001043c9:
        ...
        local_108 = "private key";
        if ((((param_7 == (long *)0x0) && (local_108 = "public key", param_8 == (long *)0x0)) &&
            (local_108 = "key parameters", param_9 == (long *)0x0)) &&
           (((local_108 = "certificate", local_128 == (long *)0x0 &&
             (local_108 = "certificates", param_11 == (long *)0x0)) &&
            (local_108 = "CRL", local_130 == (long *)0x0)))) {
          if (plVar7 != (long *)0x0) {
            local_108 = "CRLs";
            goto LAB_00104405;
          }
...
LAB_00104405:
        if (param_6 != 0) goto LAB_00104411;
...
/* WARNING: Removing unreachable block (ram,0x001055fb) */
/* WARNING: Removing unreachable block (ram,0x00105630) */
/* WARNING: Removing unreachable block (ram,0x0010560a) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
...

{
  ...
  if ((param_4 == 0) ||
     ((iVar1 = OPENSSL_strncasecmp(param_1,"http://",7), iVar1 != 0 &&
      (iVar1 = OPENSSL_strncasecmp(param_1,"https://",8), iVar1 != 0)))) {
...
BIO * bio_open_default(char *param_1,ulong param_2,undefined4 param_3)
...
LAB_00105eea:
        pBVar4 = (BIO *)PEM_read_bio_X509_REQ(pBVar2,(X509_REQ **)0x0,(undefined1 *)0x0,(void *)0x0)
        ;
      }
      else {
        pBVar2 = (BIO *)bio_open_default();
...
BIO * bio_open_default_quiet(char *param_1,undefined8 param_2,ulong param_3,ulong param_4)
    ...
    if (iVar2 == 0) {
      ...
      if (local_c0 == 0) {
        ...
        do {
          ...
          lVar4 = uVar5 * 4;
          uVar5 = uVar5 + 1;
          local_b8.fds_bits[lVar3] =
               local_b8.fds_bits[lVar3] | 1L << ((byte)*(undefined4 *)((long)ptr + lVar4) & 0x3f);
...
undefined8 * app_params_new_from_opts(long param_1,undefined8 param_2)

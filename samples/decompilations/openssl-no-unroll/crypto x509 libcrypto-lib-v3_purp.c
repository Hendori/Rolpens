...

{
  ...
  if (param_3 == 0) {
    if ((((((ulong)param_2[1].name & 2) != 0) && (((ulong)param_2[1].name & 0x8000000000) != 0)) &&
       ...
       (iVar3 = X509_get_ext_by_NID(param_2,0x53,-1), -1 < iVar3)) {
      ex = X509_get_ext(param_2,iVar3);
      iVar3 = X509_EXTENSION_get_critical(ex);
      if (((iVar3 != 0) && (((ulong)param_2[1].name & 4) != 0)) &&
         (psVar2 = param_2[1].ex_data.sk, ((ulong)psVar2 & 8) != 0)) {
    ...
    *(void **)&param_1[1].ex_data.dummy = pvVar8;
    ...
    if (iVar4 == 0) {
      *(uint *)&param_1[1].name = *(uint *)&param_1[1].name | 0x20;
      ...
      if ((iVar4 == 0) && (lVar6 = X509_get0_pubkey(param_1), lVar6 != 0)) {
        ...
        if (iVar4 != 0) {
          ...
          if ((iVar4 != 0) ||
             ((iVar4 = EVP_PKEY_is_a(lVar6,&_LC1), iVar4 != 0 && (local_34 == 0x390)))) {

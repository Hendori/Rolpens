...

{
  ...
  ptr = param_2 + 10;
  uVar4 = param_2[0x1a];
  *(undefined1 *)((long)param_2 + (ulong)uVar4 + 0x28) = 0x80;
  uVar2 = (ulong)uVar4 + 1;
  if (uVar2 < 0x39) {
    uVar5 = 0x38 - uVar2;
  ...
  *(ulong *)(param_2 + 0x18) =
  ...
  uVar4 = *param_2;
  *param_1 = uVar4 >> 0x18 | (uVar4 & 0xff0000) >> 8 | (uVar4 & 0xff00) << 8 | uVar4 << 0x18;
  uVar4 = param_2[1];
  param_1[1] = uVar4 >> 0x18 | (uVar4 & 0xff0000) >> 8 | (uVar4 & 0xff00) << 8 | uVar4 << 0x18;
  uVar4 = param_2[2];
  param_1[2] = uVar4 >> 0x18 | (uVar4 & 0xff0000) >> 8 | (uVar4 & 0xff00) << 8 | uVar4 << 0x18;
  uVar4 = param_2[3];
  param_1[3] = uVar4 >> 0x18 | (uVar4 & 0xff0000) >> 8 | (uVar4 & 0xff00) << 8 | uVar4 << 0x18;
  uVar4 = param_2[4];
  param_1[4] = uVar4 >> 0x18 | (uVar4 & 0xff0000) >> 8 | (uVar4 & 0xff00) << 8 | uVar4 << 0x18;
  uVar4 = param_2[5];
  param_1[5] = uVar4 >> 0x18 | (uVar4 & 0xff0000) >> 8 | (uVar4 & 0xff00) << 8 | uVar4 << 0x18;
  uVar4 = param_2[6];
  param_1[6] = uVar4 >> 0x18 | (uVar4 & 0xff0000) >> 8 | (uVar4 & 0xff00) << 8 | uVar4 << 0x18;
  uVar4 = param_2[7];
  param_1[7] = uVar4 >> 0x18 | (uVar4 & 0xff0000) >> 8 | (uVar4 & 0xff00) << 8 | uVar4 << 0x18;
  return 1;
}

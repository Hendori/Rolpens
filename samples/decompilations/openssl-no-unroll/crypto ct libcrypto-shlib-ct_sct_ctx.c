...

{
  ...
  if ((int)uVar1 < 0) {
    if (uVar1 != 0xffffffff) goto LAB_001001f3;
    if (param_3 == (X509 *)0x0) {
      iVar3 = i2d_X509(param_2,&local_50);
      lVar9 = (long)iVar3;
      if (iVar3 < 0) goto LAB_00100183;
      goto LAB_001001f6;
    }
LAB_00100183:
    x = (X509 *)0x0;
...
LAB_001001f6:
    ...
    if (-1 < (int)uVar2) {
      ...
      uVar4 = uVar1 & uVar4;
      uVar1 = uVar2;
      if ((int)uVar4 < 0) goto LAB_001002b7;
      goto LAB_00100183;
    }
...
LAB_001002b7:
    x = X509_dup(param_2);
    if (x == (X509 *)0x0) goto LAB_00100183;
...
joined_r0x00100479:
        ...
        if (lastpos < 0) {
          if ((-2 < lastpos) && (iVar3 < 0)) goto LAB_0010032b;
        }
        else {
...
undefined8 SCT_CTX_set1_issuer_pubkey(long param_1,X509_PUBKEY *param_2)

{
  ...
  local_38 = (uchar *)0x0;
  type = (EVP_MD *)
         EVP_MD_fetch(*(undefined8 *)(param_1 + 0x50),"SHA2-256",*(undefined8 *)(param_1 + 0x58));
  if ((type == (EVP_MD *)0x0) ||
     (((md = *(uchar **)(param_1 + 0x18), md == (uchar *)0x0 || (*(ulong *)(param_1 + 0x20) < 0x20))
      && (md = (uchar *)CRYPTO_malloc(0x20,"crypto/ct/ct_sct_ctx.c",0xd9), md == (uchar *)0x0)))) {
    md = (uchar *)0x0;
    uVar2 = 0;
  }
  else {
    iVar1 = i2d_X509_PUBKEY(param_2,&local_38);
    if ((iVar1 < 1) ||
       (iVar1 = EVP_Digest(local_38,(long)iVar1,md,&local_3c,type,(ENGINE *)0x0), iVar1 == 0)) {
      uVar2 = 0;
    }
    else {
      if (md != *(uchar **)(param_1 + 0x18)) {
        CRYPTO_free(*(uchar **)(param_1 + 0x18));
        *(uchar **)(param_1 + 0x18) = md;
        *(undefined8 *)(param_1 + 0x20) = 0x20;
      }
      md = (uchar *)0x0;
      uVar2 = 1;
    }
...

{
  ...
  if (pkey != (EVP_PKEY *)0x0) {
    local_48 = (uchar *)0x0;
    type = (EVP_MD *)EVP_MD_fetch(param_1[10],"SHA2-256",param_1[0xb]);
    if (type == (EVP_MD *)0x0) {
LAB_00100770:
      md = (uchar *)0x0;
    }
      ...
      md = (uchar *)param_1[1];
      if ((md == (uchar *)0x0) || ((ulong)param_1[2] < 0x20)) {
        md = (uchar *)CRYPTO_malloc(0x20,"crypto/ct/ct_sct_ctx.c",0xd9);
        if (md == (uchar *)0x0) goto LAB_00100770;
      }
      iVar1 = i2d_X509_PUBKEY(param_2,&local_48);
      if (0 < iVar1) {
        iVar1 = EVP_Digest(local_48,(long)iVar1,md,&local_4c,type,(ENGINE *)0x0);
        if (iVar1 != 0) {

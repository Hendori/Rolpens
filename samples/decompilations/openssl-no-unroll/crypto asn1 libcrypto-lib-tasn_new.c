...
switchD_00100266_caseD_0:
  param_2 = *(ulong **)(puVar1 + 0x10);
...
LAB_001002a2:
                    /* WARNING: Could not recover jumptable at 0x001002a9. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        (*UNRECOVERED_JUMPTABLE)(param_1,puVar1);
        return;
      }
    }
switchD_00100266_caseD_1:
    *param_1 = 0;
switchD_00100266_caseD_3:
    return;
  }
  goto LAB_00100244;
}

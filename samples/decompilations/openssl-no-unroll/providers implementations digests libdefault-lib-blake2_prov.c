...

{
  ...
  if ((((param_2 != (long *)0x0) && (*param_2 != 0)) &&
      (lVar2 = OSSL_PARAM_locate(param_2,&_LC0), lVar2 != 0)) &&
     (iVar1 = OSSL_PARAM_set_uint(lVar2,*(undefined1 *)(param_1 + 0x80)), iVar1 == 0)) {
    ERR_new();
    ERR_set_debug("providers/implementations/digests/blake2_prov.c",0xc5,
...

{
  ...
  if ((((param_2 != (long *)0x0) && (*param_2 != 0)) &&
      (lVar2 = OSSL_PARAM_locate(param_2,&_LC0), lVar2 != 0)) &&
     (iVar1 = OSSL_PARAM_set_uint(lVar2,*(undefined1 *)(param_1 + 0xf0)), iVar1 == 0)) {
    ERR_new();
    ERR_set_debug("providers/implementations/digests/blake2_prov.c",0xc6,
...

{
  ...
  if (iVar17 != 0) {
    puVar18 = (undefined8 *)
              CRYPTO_malloc(0xa0,"providers/implementations/digests/blake2_prov.c",0xc5);
...

{
  ...
  if (iVar1 != 0) {
    puVar2 = (undefined8 *)
             CRYPTO_malloc(0x130,"providers/implementations/digests/blake2_prov.c",0xc6);

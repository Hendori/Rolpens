...

{
  ...
  if ((*(uint *)(param_1 + 6) != 0) && (param_3 != 0)) {
    ...
    if (*(uint *)((long)param_1 + 0x2c) == param_3) {
      ...
      case 6:
        uVar6 = uVar6 | (ulong)*(byte *)((long)param_1 + 0x3d) << 0x28;
      case 5:
        uVar6 = uVar6 | (ulong)*(byte *)((long)param_1 + 0x3c) << 0x20;
      case 4:
        uVar6 = uVar6 | (ulong)*(byte *)((long)param_1 + 0x3b) << 0x18;
      case 3:
        uVar6 = uVar6 | (ulong)*(byte *)((long)param_1 + 0x3a) << 0x10;
      case 2:
        uVar6 = uVar6 | (ulong)*(byte *)((long)param_1 + 0x39) << 8;
      case 1:

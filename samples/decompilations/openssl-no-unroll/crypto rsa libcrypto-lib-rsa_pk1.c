...

{
  ...
  else if (fl + 1 != rsa_len) goto LAB_00100188;
  if (*f == '\x01') {
    iVar4 = fl + -1;
    iVar3 = 0;
    do {
      ...
      if (uVar1 != 0xff) {
        ...
        if (iVar3 == iVar4) goto LAB_00100132;
        if (iVar3 < 8) {
          ERR_new();
      ...
      if (0 < iVar1) {
        ...
        if (0 < iVar3) {
          ...
          do {
            while (*pcVar2 != '\0') {
              pcVar2 = pcVar2 + 1;
              if (pcVar4 == pcVar2) goto LAB_0010031e;
            }
            do {
...

{
  ...
  if (((int)param_3 < 1 || (int)param_5 < 1) || (param_6 != param_5)) {
    ...
    ptr = (uchar *)CRYPTO_malloc(param_5,"crypto/rsa/rsa_pk1.c",0x1aa);
    if (ptr != (uchar *)0x0) {
      if ((int)(param_5 * 8) < 0x10000) {
        local_14a = (short)param_5 << 0xb | (ushort)((short)param_5 * 8) >> 8;
        pHVar8 = (HMAC_CTX *)HMAC_CTX_new();
        if (pHVar8 == (HMAC_CTX *)0x0) {
LAB_00100b38:
          ERR_new();
        ...
        pEVar9 = (EVP_MD *)EVP_MD_fetch(param_1,"sha256",0);
        if (pEVar9 == (EVP_MD *)0x0) {
          ERR_new();
          ERR_set_debug("crypto/rsa/rsa_pk1.c",0x13e,"ossl_rsa_prf");
          ERR_set_error(4,0xc0103,0);
          HMAC_CTX_free(pHVar8);
          EVP_MD_free(0);
          goto LAB_00100b76;
        }
        iVar3 = HMAC_Init_ex(pHVar8,param_7,0x20,pEVar9,(ENGINE *)0x0);
        if (iVar3 < 1) {
          ERR_new();
          uVar14 = 0x143;
LAB_00100e00:
          ERR_set_debug("crypto/rsa/rsa_pk1.c",uVar14,"ossl_rsa_prf");
          ERR_set_error(4,0xc0103,0);
          HMAC_CTX_free(pHVar8);
          EVP_MD_free(pEVar9);
          goto LAB_00100b76;
        ...
        md = ptr;
        do {
          iVar4 = HMAC_Init_ex(pHVar8,(void *)0x0,0,(EVP_MD *)0x0,(ENGINE *)0x0);
          if (iVar4 < 1) {
            ERR_new();
            uVar14 = 0x149;
            goto LAB_00100e00;
          }
          local_14c = uVar16 << 8 | uVar16 >> 8;
          iVar4 = HMAC_Update(pHVar8,(uchar *)&local_14c,2);
          if (iVar4 < 1) {
            ERR_new();
            uVar14 = 0x151;
            goto LAB_00100e00;
          }
          iVar4 = HMAC_Update(pHVar8,(uchar *)"message",7);
          if (iVar4 < 1) {
            ERR_new();
            uVar14 = 0x155;
            goto LAB_00100e00;
          }
          iVar4 = HMAC_Update(pHVar8,(uchar *)&local_14a,2);
          if (iVar4 < 1) {
            ERR_new();
            uVar14 = 0x159;
            goto LAB_00100e00;
          ...
          local_150 = 0x20;
          if (iVar3 + 0x1f < (int)param_5) {
            iVar4 = HMAC_Final(pHVar8,md,&local_150);
            if (iVar4 < 1) {
              ERR_new();
              uVar14 = 0x16b;
              goto LAB_00100e00;
            ...
            iVar4 = HMAC_Final(pHVar8,(uchar *)&local_148,&local_150);
            if (iVar4 < 1) {
              ERR_new();
              uVar14 = 0x165;
              goto LAB_00100e00;
            ...
            if (uVar5 < 8) {
              if ((uVar5 & 4) == 0) {
                if (uVar5 != 0) {
                  *md = (uchar)local_148;
                  if ((uVar5 & 2) != 0) {
                    *(undefined2 *)(md + (uVar15 - 2)) = *(undefined2 *)((long)&local_14a + uVar15);
                  }
                }
              }
              else {
                *(undefined4 *)md = (undefined4)local_148;
                *(undefined4 *)(md + (uVar15 - 4)) = *(undefined4 *)((long)&local_14c + uVar15);
              }
            }
            else {
              *(ulong *)md = CONCAT44(local_148._4_4_,(undefined4)local_148);
              *(undefined8 *)(md + ((ulong)uVar5 - 8)) =
                   *(undefined8 *)((long)&local_150 + (ulong)uVar5);
              lVar17 = (long)md - (long)((ulong)(md + 8) & 0xfffffffffffffff8);
              puVar13 = (uchar *)((long)&local_148 + -lVar17);
              puVar11 = (undefined8 *)((ulong)(md + 8) & 0xfffffffffffffff8);
              for (uVar15 = (ulong)(uVar5 + (int)lVar17 >> 3); uVar15 != 0; uVar15 = uVar15 - 1) {
                *puVar11 = *(undefined8 *)puVar13;
                puVar13 = puVar13 + ((ulong)bVar18 * -2 + 1) * 8;
        ...
        local_14c = 8;
        pHVar8 = (HMAC_CTX *)HMAC_CTX_new();
        if (pHVar8 == (HMAC_CTX *)0x0) goto LAB_00100b38;
        pEVar9 = (EVP_MD *)EVP_MD_fetch(param_1,"sha256",0);
        if (pEVar9 == (EVP_MD *)0x0) {
          ERR_new();
          ERR_set_debug("crypto/rsa/rsa_pk1.c",0x13e,"ossl_rsa_prf");
...
LAB_00100b05:
        ...
        do {
          iVar3 = HMAC_Init_ex(pHVar8,(void *)0x0,0,(EVP_MD *)0x0,(ENGINE *)0x0);
          if (iVar3 < 1) {
            ERR_new();
            uVar14 = 0x149;
            goto LAB_00100b05;
          }
          local_14a = (ushort)(byte)lVar17 << 8;
          iVar3 = HMAC_Update(pHVar8,(uchar *)&local_14a,2);
          if (iVar3 < 1) {
            ERR_new();
            uVar14 = 0x151;
            goto LAB_00100b05;
          }
          iVar3 = HMAC_Update(pHVar8,(uchar *)"length",6);
          if (iVar3 < 1) {
            ERR_new();
            uVar14 = 0x155;
            goto LAB_00100b05;
          }
          iVar3 = HMAC_Update(pHVar8,(uchar *)&local_14c,2);
          if (iVar3 < 1) {
            ERR_new();
            uVar14 = 0x159;
            goto LAB_00100b05;
          ...
          puVar11 = &local_148;
          local_150 = 0x20;
          iVar3 = HMAC_Final(pHVar8,(uchar *)(puVar11 + lVar17 * 4),&local_150);
          if (iVar3 < 1) {
            ERR_new();
            uVar14 = 0x16b;
            goto LAB_00100b05;
        ...
        EVP_MD_free(pEVar9);
        uVar5 = param_5 - 10;
        uVar6 = uVar5 >> 1 & 0x7fff | uVar5;
        uVar6 = uVar6 >> 2 & 0x3fff | uVar6;
        uVar6 = uVar6 >> 4 & 0xfff | uVar6;
        uVar10 = 0;
        do {
          uVar2 = *(undefined1 *)puVar11;
          puVar1 = (undefined1 *)((long)puVar11 + 1);
          puVar11 = (undefined8 *)((long)puVar11 + 2);
          uVar12 = (uint)CONCAT11(uVar2,*puVar1) & (uVar6 >> 8 & 0xff | uVar6);
          uVar7 = (int)((uVar12 - (uVar5 & 0xffff) ^ uVar5 & 0xffff | (uVar12 ^ uVar5) & 0xffff) ^
                       uVar12) >> 0x1f;
          uVar10 = ~uVar7 & uVar10 | uVar12 & uVar7;
        ...
        if ((int)param_5 < 3) {
          ...
          uVar5 = 0;
          do {
            uVar12 = (int)(~(uint)param_4[uVar15] & param_4[uVar15] - 1) >> 0x1f;
            uVar7 = ~uVar5 & uVar12;
            uVar5 = uVar5 | uVar12;
            uVar12 = (uint)uVar15;
            uVar15 = uVar15 + 1;
            uVar6 = uVar7 & uVar12 | ~uVar7 & uVar6;
          } while (param_5 != uVar15);
          uVar5 = uVar6 + 1;
          param_6 = param_6 - uVar5;
          uVar6 = ~((int)((param_3 - param_6 ^ param_6 | param_6 ^ param_3) ^ param_3) >> 0x1f) &
                  ~((int)(uVar6 ^ (uVar6 - 10 ^ 10 | uVar6 ^ 10)) >> 0x1f) &
                  (int)(~(uint)*param_4 & *param_4 - 1 & ~(uint)(param_4[1] ^ 2) &
                       (param_4[1] ^ 2) - 1) >> 0x1f;
          uVar7 = ~uVar6;
        }
        uVar5 = uVar6 & uVar5 | param_5 - uVar10 & uVar7;
        if ((int)uVar5 < (int)param_5) {
          ...
          do {
            iVar3 = iVar3 + 1;
            iVar4 = (int)lVar17;
            *(byte *)((param_2 - (int)uVar5) + -1 + lVar17) =
                 param_4[lVar17 + -1] & (byte)uVar6 | ptr[lVar17 + -1] & ~(byte)uVar6;
            lVar17 = lVar17 + 1;
          } while (iVar4 < (int)param_5 && iVar3 < (int)param_3);
        }
        else {
          iVar3 = 0;
        }

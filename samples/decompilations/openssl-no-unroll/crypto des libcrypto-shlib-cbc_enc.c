...
switchD_00100326_caseD_3:
    puVar5[-1] = (char)(uVar11 >> 0x10);
    puVar5 = puVar5 + -1;
LAB_0010035e:
    puVar5[-1] = (char)(uVar11 >> 8);
    puVar5 = puVar5 + -1;
switchD_00100326_caseD_1:
    puVar5[-1] = (char)uVar11;
    goto switchD_00100326_caseD_0;
  }
  if (-1 < (long)uVar4) {
    lVar2 = (uVar4 >> 3) * 8 + 8;
...
LAB_001003be:
  uVar13 = (uint)puVar6[-1] << 0x10 | uVar13;
  puVar8 = puVar6 + -1;
LAB_001003cb:
  puVar6 = puVar8 + -1;
  uVar13 = (uint)puVar8[-1] << 8 | uVar13;
LAB_001003d8:
  uVar13 = (puVar6[-1] | uVar13) ^ auVar18._0_4_;
  auVar18[4] = (char)uVar11;
  auVar18[5] = (char)(uVar11 >> 8);
  auVar18[6] = (char)(uVar11 >> 0x10);
  auVar18[7] = (char)(uVar11 >> 0x18);
  auVar18[0] = (char)uVar13;
  auVar18[1] = (char)(uVar13 >> 8);
  auVar18[2] = (char)(uVar13 >> 0x10);
  auVar18[3] = (char)(uVar13 >> 0x18);
switchD_00100185_caseD_0:
  local_48 = auVar18;
  DES_encrypt1((uint *)&local_48,schedule,1);
  *(DES_cblock *)output = local_48;
switchD_00100326_caseD_0:

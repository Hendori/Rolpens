...

{
  ...
  if (iVar1 == 0) {
    uVar3 = OSSL_PROVIDER_load(libctx,&_LC6);
    iVar1 = test_ptr("test/pairwise_fail_test.c",0x4a,"prov = OSSL_PROVIDER_load(libctx, \"fips\")",
                     uVar3);
    if (iVar1 != 0) {
      iVar1 = 1;
      self_test_args = "Conditional_PCT";
      OSSL_SELF_TEST_set_callback(libctx,0x100000,&self_test_args);
    }
    OSSL_PROVIDER_unload(uVar3);
    uVar2 = test_true("test/pairwise_fail_test.c",0x61,"setup_selftest_pairwise_failure(type)",iVar1
                     );
    if (uVar2 != 0) {
      local_38 = (EVP_PKEY *)EVP_PKEY_Q_keygen(libctx,0,&_LC10,0x800);
...
LAB_001003f9:
    ...
    pcVar5 = "Conditional_KAT";
    iVar1 = strcmp(pcVar4,"eckat");
    if (iVar1 != 0) {
      pcVar5 = "Conditional_PCT";
    }
    uVar3 = OSSL_PROVIDER_load(libctx,&_LC6);
    iVar1 = test_ptr("test/pairwise_fail_test.c",0x4a,"prov = OSSL_PROVIDER_load(libctx, \"fips\")",
                     uVar3);
    if (iVar1 != 0) {
      iVar1 = 1;
      self_test_args = pcVar5;
      OSSL_SELF_TEST_set_callback(libctx,0x100000,&self_test_args);
    }
    OSSL_PROVIDER_unload(uVar3);
    uVar2 = test_true("test/pairwise_fail_test.c",0x68,"setup_selftest_pairwise_failure(type)",iVar1
                     );
    if (uVar2 != 0) {
      local_38 = (EVP_PKEY *)EVP_PKEY_Q_keygen(libctx,0,&_LC14,"P-256");
    ...
    OSSL_PROVIDER_unload(uVar3);
    uVar2 = test_true("test/pairwise_fail_test.c",0x6f,"setup_selftest_pairwise_failure(type)",iVar1
                     );
    if (uVar2 != 0) {
      ...
      if (iVar1 == 0) {
        ...
        if (iVar1 == 0) {
          ...
          if (uVar2 != 0) {
            ...
            uVar2 = test_int_eq("test/pairwise_fail_test.c",0x77,"EVP_PKEY_keygen_init(ctx)",&_LC21,
                                iVar1,1);
            pkey_00 = local_38;
            if (uVar2 != 0) {
              ...
              pkey_00 = local_38;
              if (uVar2 != 0) {
                iVar1 = test_ptr_null("test/pairwise_fail_test.c",0x7b,&_LC25,local_38);
                uVar2 = (uint)(iVar1 != 0);
                pkey_00 = local_38;
              }
            }
    ...
    OSSL_PROVIDER_unload(uVar3);
    uVar2 = test_true("test/pairwise_fail_test.c",0x7e,"setup_selftest_pairwise_failure(type)",iVar1
                     );
    if (uVar2 != 0) {
      ...
      if (uVar2 != 0) {
        iVar1 = EVP_PKEY_keygen_init(ctx);
        uVar2 = test_int_eq("test/pairwise_fail_test.c",0x82,"EVP_PKEY_keygen_init(ctx)",&_LC21,
                            iVar1,1);
        if (uVar2 != 0) {
          iVar1 = EVP_PKEY_keygen(ctx,&local_38);
          uVar2 = test_int_le("test/pairwise_fail_test.c",0x84,"EVP_PKEY_keygen(ctx, &pkey)",&_LC23,
                              iVar1,0);
          if (uVar2 != 0) {
            iVar1 = test_ptr_null("test/pairwise_fail_test.c",0x86,&_LC25,local_38);
            uVar2 = (uint)(iVar1 != 0);
          }
        }
      }

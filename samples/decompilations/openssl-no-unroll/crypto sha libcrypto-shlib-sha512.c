  ...
  *(undefined1 *)((long)c->h + (ulong)uVar8 + 0x50) = 0x80;
  ...
  if (uVar5 < 0x71) {
    ...
    if (uVar9 < 8) {
      ...
      puVar2[6] = '\0';
      puVar2[7] = '\0';
      if (7 < ((ulong)(puVar7 + (uVar9 - ((ulong)(puVar7 + 8) & 0xfffffffffffffff8))) &
              0xfffffffffffffff8)) {
        uVar5 = 0;
        do {
          *(undefined8 *)(((ulong)(puVar7 + 8) & 0xfffffffffffffff8) + uVar5) = 0;
          uVar5 = uVar5 + 8;
        } while (uVar5 < ((ulong)(puVar7 + (uVar9 - ((ulong)(puVar7 + 8) & 0xfffffffffffffff8))) &
                         0xfffffffffffffff8));
      }
    }
  ...
  (c->u).d[0xf] =
       (((((((uVar5 & 0xff) << 8 | uVar5 >> 8 & 0xff) << 8 | uVar5 >> 0x10 & 0xff) << 8 |
          uVar5 >> 0x18 & 0xff) << 8 | uVar5 >> 0x20 & 0xff) << 8 | uVar5 >> 0x28 & 0xff) << 8 |
       uVar5 >> 0x30 & 0xff) << 8 | uVar5 >> 0x38;
  sha512_block_data_order(c,p_Var1,1);
  if (md != (uchar *)0x0) {
    uVar8 = c->md_len;
    if (uVar8 == 0x30) {
      uVar5 = c->h[0];
      *(ulong *)md = uVar5 >> 0x38 | (uVar5 & 0xff000000000000) >> 0x28 |

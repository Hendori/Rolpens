...

{
  ...
  case 0x11:
    ...
    if (param_3 < 8) {
      ...
      *(undefined8 *)((long)param_1 + uVar11 + 0x30) = *(undefined8 *)((long)param_4 + (uVar11 - 8))
      ...
      uVar9 = (int)lVar8 + param_3 & 0xfffffff8;
      if (7 < uVar9) {
        uVar11 = 0;
        do {
          uVar10 = (int)uVar11 + 8;
          *(undefined8 *)(((ulong)(param_1 + 8) & 0xfffffffffffffff8) + uVar11) =
               *(undefined8 *)((long)param_4 + (uVar11 - lVar8));
          uVar11 = (ulong)uVar10;
        } while (uVar10 < uVar9);
      }
    }
  ...
  case 0x13:
    ...
    memcpy(param_4,(void *)(((long)(int)uVar9 - (long)(int)uVar10) + *(long *)(lVar5 + 0x2c0)),
           (long)(int)uVar10);
    lVar8 = *(long *)(lVar5 + 0x2c0);
    lVar7 = (long)*(int *)(lVar5 + 0x2c8);
    pcVar1 = (char *)(lVar8 + -1 + lVar7);
    *pcVar1 = *pcVar1 + '\x01';
    if (*pcVar1 == '\0') {
      pcVar1 = (char *)(lVar8 + -2 + lVar7);
      *pcVar1 = *pcVar1 + '\x01';
      if (*pcVar1 == '\0') {
        pcVar1 = (char *)(lVar8 + -3 + lVar7);
        *pcVar1 = *pcVar1 + '\x01';
        if (*pcVar1 == '\0') {
          pcVar1 = (char *)(lVar8 + -4 + lVar7);
          *pcVar1 = *pcVar1 + '\x01';
          if (*pcVar1 == '\0') {
            pcVar1 = (char *)(lVar8 + -5 + lVar7);
            *pcVar1 = *pcVar1 + '\x01';
            if (*pcVar1 == '\0') {
              pcVar1 = (char *)(lVar8 + -6 + lVar7);
              *pcVar1 = *pcVar1 + '\x01';
              if (*pcVar1 == '\0') {
                pcVar1 = (char *)(lVar8 + -7 + lVar7);
                *pcVar1 = *pcVar1 + '\x01';
                if (*pcVar1 == '\0') {
                  pcVar1 = (char *)(lVar8 + -8 + lVar7);
                  *pcVar1 = *pcVar1 + '\x01';
                }
              }
            }
...

{
  ...
  else if (iVar1 == 4) goto LAB_00102a6a;
  if ((param_4 & 7) != 0) {
    return 0xffffffff;
  }
LAB_00102a6a:
...

{
  ...
  if (param_2 == 0) {
    ...
    if (0 < (int)uVar7) goto LAB_00102e2e;
LAB_00102f82:
    ...
    iVar1 = 0;
    if (param_2 == 0) goto LAB_00102fab;
LAB_00102ebf:
    iVar2 = EVP_CIPHER_CTX_is_encrypting(param_1);
    lVar8 = param_4 - uVar6;
    if (iVar2 == 0) {
    ...
    uVar7 = *puVar9;
    if ((int)uVar7 < 1) goto LAB_00102f82;
LAB_00102e2e:
...
LAB_00103151:
    ...
    *puVar9 = 0;
    iVar1 = 0x10;
    uVar6 = (ulong)((uint)param_4 & 0xf);
    if (param_4 < 0x10) goto LAB_00103151;
LAB_00102fab:
    lVar8 = param_4 - uVar6;

...

{
  ...
  if (r_01 != (BIGNUM *)0x0) {
    if (*(int *)(param_3 + 0x28) == 0) {
        ...
        if (((iVar4 == 0) ||
           ...
           ((iVar4 = BN_mod_sub_quick(r_00,*(BIGNUM **)(param_3 + 0x10),r,m), iVar4 == 0 ||
            ((iVar4 = (*pcVar1)(param_1,r,a,r_00,param_4), iVar4 == 0 ||
             (iVar4 = BN_mod_lshift1_quick(a,r,m), iVar4 == 0)))))) goto LAB_00100d10;
      ...
      iVar4 = (*pcVar2)(param_1,a,*(undefined8 *)(param_3 + 0x10),param_4);
      if (((iVar4 == 0) || (iVar4 = BN_mod_lshift1_quick(r,a,m), iVar4 == 0)) ||
         (iVar4 = BN_mod_add_quick(a,a,r,m), iVar4 == 0)) goto LAB_00100d10;
...
LAB_00101e00:
    ...
    if (*(int *)(param_3 + 0x28) == 0) {
      ...
      if ((iVar3 == 0) ||
         ...
         local_48 = pBVar5, iVar3 == 0)) goto LAB_00101e00;
    }
    else {
    ...
    if (*(int *)(param_2 + 0x28) == 0) {
      ...
      if ((iVar3 == 0) ||
         ...
         b = pBVar6, iVar3 == 0)) goto LAB_00101e00;
    }
    else {
...

{
  ...
  if ((iVar3 == 0) || (iVar3 = BN_mod_sub_quick(r_00,a_01,a_03,m), iVar3 == 0)) goto LAB_00102250;
  iVar3 = BN_is_zero(r);
  if (iVar3 != 0) {

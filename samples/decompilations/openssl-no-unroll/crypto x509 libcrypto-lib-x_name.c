...
LAB_001002b0:
    ...
    if (local_68 < iVar3) {
      puVar7 = (undefined8 *)OPENSSL_sk_value(*param_1,local_68);
      if (*(int *)(puVar7 + 2) != local_64) {
        local_78 = OPENSSL_sk_new_null();
        if (local_78 == 0) goto LAB_001004d5;
        iVar3 = OPENSSL_sk_push(lVar6,local_78);
        if (iVar3 == 0) {
          OPENSSL_sk_free(local_78);
          ERR_new();
          uVar10 = 0x152;
          goto LAB_001004b6;
        }
...
LAB_00100550:
    ...
    iVar4 = 0;
    for (iVar3 = 0; iVar5 = OPENSSL_sk_num(lVar6), iVar3 < iVar5; iVar3 = iVar3 + 1) {
      local_48 = (ASN1_VALUE *)OPENSSL_sk_value(lVar6);
      iVar5 = ASN1_item_ex_i2d(&local_48,(uchar **)0x0,(ASN1_ITEM *)local_it_4,-1,-1);
      if ((iVar5 < 0) || (0x7fffffff - iVar5 < iVar4)) goto LAB_001004d5;
      iVar4 = iVar4 + iVar5;
    }
    if (-1 < iVar4) {
      *(int *)(param_1 + 4) = iVar4;
      local_50 = (uchar *)CRYPTO_malloc(iVar4,"crypto/x509/x_name.c",0x170);
      if (local_50 != (uchar *)0x0) {
        param_1[3] = local_50;
        iVar4 = 0;
        for (iVar3 = 0; iVar5 = OPENSSL_sk_num(lVar6), iVar3 < iVar5; iVar3 = iVar3 + 1) {
          local_48 = (ASN1_VALUE *)OPENSSL_sk_value(lVar6,iVar3);
          iVar5 = ASN1_item_ex_i2d(&local_48,&local_50,(ASN1_ITEM *)local_it_4,-1,-1);
          if ((iVar5 < 0) || (0x7fffffff - iVar5 < iVar4)) break;
          iVar4 = iVar4 + iVar5;
        }
        uVar10 = 1;
...
LAB_0010049d:
  dst->length = iVar3;
LAB_00100367:
  iVar3 = OPENSSL_sk_push(local_78,a);
  if (iVar3 == 0) {
    ERR_new();
    uVar10 = 0;
...
int x509_name_ex_d2i(undefined8 *param_1,undefined8 *param_2,long param_3,undefined8 param_4,
...

{
  ...
  a = local_48;
  if (iVar2 == 0) {
    if (local_48 != (X509_NAME *)0x0) goto LAB_00100bc6;
  }
  else {
    ...
    if (CONCAT44(extraout_var,iVar2) != 0) {
      ...
      for (iVar2 = 0; iVar3 = OPENSSL_sk_num(local_50), iVar2 < iVar3; iVar2 = iVar2 + 1) {
        uVar5 = OPENSSL_sk_value(local_50,iVar2);
        for (iVar3 = 0; iVar4 = OPENSSL_sk_num(uVar5), iVar3 < iVar4; iVar3 = iVar3 + 1) {
          lVar6 = OPENSSL_sk_value(uVar5,iVar3);
          psVar1 = a->entries;
          *(int *)(lVar6 + 0x10) = iVar2;
          iVar4 = OPENSSL_sk_push(psVar1,lVar6);
          if (iVar4 == 0) goto LAB_00100bc6;
          OPENSSL_sk_set(uVar5,iVar3,0);
        }
      }
...

{
  ...
  cVar1 = ptr[1];
  if (cVar1 == '/') goto LAB_00100e19;
LAB_00100da0:
  do {
    if (cVar1 != '\0') goto LAB_00100e0e;
    do {
...
LAB_00100dc6:
      ...
      if (iVar2 != 2) goto LAB_00100e60;
      data = pcVar3;
      if (pcVar3[-1] == '\0') goto LAB_00100dc6;
LAB_00100e0e:
      cVar1 = *pcVar3;
      pcVar3 = pcVar3 + 1;
      if (cVar1 != '/') goto LAB_00100da0;
LAB_00100e19:

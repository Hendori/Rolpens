...
LAB_001015ae:
      if (*param_13 != 0) goto LAB_001015b8;
      goto LAB_00101e30;
    }
...
LAB_00102022:
      if (*param_13 != 0) goto LAB_0010202c;
      local_108 = "private key";
LAB_00101e30:
      lVar6 = OPENSSL_sk_new_null();
      *param_13 = lVar6;
...
LAB_00101582:
      if (*param_11 != 0) goto LAB_0010158c;
LAB_00101d90:
      lVar6 = OPENSSL_sk_new_null();
      *param_11 = lVar6;
...
LAB_00101c50:
      ...
      if ((local_e0 == 0) || (iVar1 = OSSL_STORE_expect(lVar6,local_e0), iVar1 != 0)) {
        ...
        local_f0 = 0;
LAB_001016e0:
        if (param_7 != (long *)0x0 || param_8 != (long *)0x0) goto LAB_00101888;
LAB_001016ec:
...
LAB_0010176d:
        if (param_6 != 0) goto LAB_00101779;
...
/* WARNING: Removing unreachable block (ram,0x001028cd) */
...
/* WARNING: Removing unreachable block (ram,0x0010378b) */
...

{
  ...
  if (param_2 == 0) {
    ...
    if ((iVar1 != 0) &&
       (iVar1 = adapt_keyid_ext(param_1,param_6,"subjectKeyIdentifier",&_LC136,1), iVar1 != 0)) {
      ERR_set_mark();
...
uint * load_index(char *param_1,uint *param_2)
...
X509_REQ * load_csr(char *param_1,int param_2,long param_3)
...
LAB_0010619e:
      if (pXVar3 != (X509_REQ *)0x0) goto LAB_001061a3;
    }
    else {
      if (param_2 == 0x8005) {
...
X509_REQ *
load_csr_autofmt(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)
...
undefined8 app_load_config_verbose(char *param_1,int param_2)
...
LAB_001063e3:
  ...
  if (a != (BIO *)0x0) {
LAB_00106492:
    uVar4 = app_load_config_bio(a,param_1);
    BIO_free(a);
    return uVar4;
  }
  piVar3 = __errno_location();
...
BIO * bio_open_default(char *param_1,char param_2,undefined4 param_3)
...
LAB_00106ebc:
      iVar1 = ASN1_TIME_set_string_X509(0,param_3);
      if (iVar1 == 0) {
LAB_00106eca:
        BIO_printf(_bio_err,
                   "%s is invalid, it should be \"today\" or have format [CC]YYMMDDHHMMSSZ\n",
      ...
      if ((param_3 != (char *)0x0) && (iVar1 = strcmp(param_3,"today"), iVar1 != 0))
      goto LAB_00106ebc;
    }
    iVar1 = strcmp(param_2,"today");
    if (iVar1 == 0) {
...
LAB_00106fee:
  uVar2 = X509_get0_notBefore(param_1);

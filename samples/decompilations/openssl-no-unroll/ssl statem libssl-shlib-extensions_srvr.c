...
LAB_00100c11:
    ERR_set_debug("ssl/statem/extensions_srvr.c",uVar4,"tls_parse_ctos_status_request");
    ossl_statem_fatal(param_1,0x32,0x6e,0);
    uVar4 = 0;
  }
  else {
...

{
  ...
  uVar7 = 0x1d1;
LAB_00100f59:
  ERR_set_debug("ssl/statem/extensions_srvr.c",uVar7,"tls_parse_ctos_alpn");
  ossl_statem_fatal(param_1,0x32,0x6e,0);
  return 0;
}
...

{
  ...
  if (1 < (ulong)param_2[1]) {
    ...
    *param_2 = (long)local_48;
    if (((uVar6 & 0x100) == 0) && (uVar9 = (ulong)(ushort)(uVar6 << 8 | uVar6 >> 8), uVar9 <= uVar3)
       ) {
      *param_2 = (long)local_48 + uVar9;
...
joined_r0x00101179:
        uVar9 = uVar9 - 2;
        if (iVar1 < 1) {
          for (; uVar9 != 0; uVar9 = uVar9 - 2) {
          }
        }
        else {
          uVar6 = *local_48 << 8 | *local_48 >> 8;
          while( true ) {
            iVar8 = 0;
            do {
              pEVar4 = (EVP_MD_CTX *)OPENSSL_sk_value(psVar2,iVar8);
              if (pEVar4->engine == (ENGINE *)(ulong)uVar6) {
                param_1[4].read_hash = pEVar4;
                if (uVar9 == 0) goto LAB_001011e9;
                local_48 = local_48 + 1;
                iVar1 = iVar8;
                goto joined_r0x00101179;
              }
              iVar8 = iVar8 + 1;
            } while (iVar8 != iVar1);
            if (uVar9 == 0) break;
            ...
            if (ptr == (void *)0x0) {
              ...
              if (local_b8 != (void *)0x0) {
                ...
                while (local_a0 = lVar5, uVar16 != 0) {
                  if ((uVar16 == 1) || (uVar17 = *puVar12, uVar16 - 2 < 2)) {
LAB_00101790:
                    ERR_new();
...
LAB_00101a61:
                  ...
                  if (*(short *)(param_1 + 0x4de) != 0) {
                    ...
                    if (iVar6 != 0) goto LAB_001018a6;
                    goto LAB_001017bf;
                  }
                  iVar6 = check_in_list(param_1,uVar17,lVar18,local_70,1,0);
                  lVar5 = local_a0;
                  if (((iVar6 != 0) &&
                      (iVar6 = tls_group_allowed(param_1,uVar17,0x20004), iVar6 != 0)) &&
                     (iVar6 = tls_valid_group(param_1,uVar17,0x304,0x304,0,0), iVar6 != 0)) {
                    *(ushort *)((long)ptr + local_a0 * 2) = uVar17;
                    ...
                    *plVar1 = (long)local_58;
                    ...
                    if (local_a0 + 1 == local_98) {
                      ...
                      if ((pvVar9 == (void *)0x0) ||
                         (pvVar10 = CRYPTO_realloc(local_b8,iVar6 * 0x10,
                                                   "ssl/statem/extensions_srvr.c",0x2f8),
                         ptr = pvVar9, pvVar10 == (void *)0x0)) goto LAB_001017bf;
                      local_a0 = local_98;
                      local_b8 = pvVar10;
                      lVar5 = local_a0;
                      local_98 = lVar19;
                  ...
                  do {
                    ...
                    if ((*(byte *)(param_1 + 0x9b2) & 0x40) == 0) {
                      ...
                      if (local_82 != 0) {
                        iVar6 = (int)local_58;
LAB_00101a8e:
                        iVar6 = tls_accept_ksgroup(param_1,local_82,
                                                   (void *)((long)iVar6 * 0x10 + (long)local_b8));
                        if (iVar6 == 0) {
                          uVar7 = 0;
                          goto LAB_001018ab;
                        }
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if ((puVar3[0x1d] == 0) || ((*(byte *)(param_1 + 0x161) & 8) == 0)) goto LAB_00101e1c;
  uVar10 = param_2[1];
...
LAB_00101be8:
    ...
    uVar12 = 0x404;
LAB_00101bf9:
    ERR_set_debug("ssl/statem/extensions_srvr.c",uVar12,"tls_parse_ctos_cookie");
    ossl_statem_fatal(param_1,0x32,0x9f,0);
  }
  else {
    uVar5 = *puVar4 << 8 | *puVar4 >> 8;
    uVar14 = (ulong)uVar5;
    if (uVar10 - 2 != uVar14) goto LAB_00101be8;
    puVar1 = puVar4 + 1;
    param_2[1] = 0;
    *param_2 = (long)puVar1 + uVar14;
    ...
    pkey = (EVP_PKEY *)
           EVP_PKEY_new_raw_private_key_ex
                     (*puVar3,&_LC2,puVar3[0x8e],*(long *)(param_1 + 0xb88) + 0x300,0x20);
...
LAB_00101d4c:
      ...
      if ((iVar6 < 1) || (local_1190 != 0x20)) goto LAB_00101d2a;
      EVP_MD_CTX_free(lVar7);
      EVP_PKEY_free(pkey);
...
LAB_00101e6d:
        ...
        if (lVar7 != lVar8) goto LAB_00101e6d;
        uVar5 = puVar4[5];
        uVar10 = *(ulong *)((long)puVar4 + 0xb);
        uVar13 = (ulong)(ushort)(*(ushort *)((long)puVar4 + 0x13) << 8 |
                                *(ushort *)((long)puVar4 + 0x13) >> 8);
        if ((uVar14 - 0x13 < uVar13) || (lVar7 = (uVar14 - 0x13) - uVar13, lVar7 == 0)) {
LAB_00101f60:
          ERR_new();
          uVar12 = 0x465;
          goto LAB_00101bf9;
        ...
        uVar11 = (ulong)*pbVar2;
        if ((uVar9 < uVar11) || (uVar9 - uVar11 != 0x20)) goto LAB_00101f60;
        uVar9 = uVar10 >> 0x38 | (uVar10 & 0xff000000000000) >> 0x28 |
        ...
        if ((uVar10 < uVar9) || (600 < uVar10 - uVar9)) goto LAB_00101e1c;
          ...
          if (iVar6 != 0) {
            ...
            if (iVar6 != 0) {
              ...
              if (iVar6 != 0) {
                ...
                if (iVar6 != 0) {
                  iVar6 = WPACKET_sub_memcpy__
                                    (local_1178,param_1 + 0x928,*(undefined8 *)(param_1 + 0x948),1);
                  if (iVar6 != 0) {
                    iVar6 = (**(code **)(*(long *)(param_1 + 0x18) + 0xb0))
                      ...
                      if (iVar6 != 0) {
                        ...
                        if (iVar6 != 0) {
                          ...
                          if (iVar6 != 0) {
                            iVar6 = WPACKET_start_sub_packet_len__(local_1178,2);
                            if (iVar6 != 0) {
                              iVar6 = WPACKET_put_bytes__(local_1178,(long)*(int *)(param_1 + 0x48),
                                                          2);
                              if (iVar6 != 0) {
                                ...
                                if (iVar6 != 0) {
                                  if ((char)uVar5 == '\0') {
LAB_00102177:
                                    iVar6 = WPACKET_put_bytes__(local_1178,0x2c,2);
                                    if (iVar6 != 0) {
                                      iVar6 = WPACKET_start_sub_packet_len__(local_1178,2);
                                      if (iVar6 != 0) {
                                        ...
                                        if (iVar6 != 0) {
                                          ...
                                          if (iVar6 != 0) {
                                            ...
                                            if (iVar6 != 0) {
                                              iVar6 = WPACKET_close(local_1178);
                                              if (iVar6 != 0) {
                                                iVar6 = WPACKET_get_total_written
                                                                  (local_1178,&local_1188);
                                                if (iVar6 != 0) {
                                                  iVar6 = WPACKET_finish(local_1178);
                                                  if (iVar6 != 0) {
                                                    iVar6 = create_synthetic_message_hash
                                                                      (param_1,(long)puVar4 + 0x15,
                                                                       uVar13,local_1118,local_1188)
                                                    ;
                                                    if (iVar6 != 0) {
                                    ...
                                    if (iVar6 != 0) {
                                      iVar6 = WPACKET_start_sub_packet_len__(local_1178,2);
                                      if (iVar6 != 0) {
                                        iVar6 = WPACKET_put_bytes__(local_1178,
                                                                    *(undefined2 *)(param_1 + 0x4de)
                                                                    ,2);
                                        if (iVar6 != 0) {
                                          iVar6 = WPACKET_close(local_1178);
                                          if (iVar6 != 0) goto LAB_00102177;
                                        }
                                      }
                                    }
                                    WPACKET_cleanup(local_1178);
...

{
  ...
  if ((*(byte *)(param_1 + 0xb10) & 3) == 0) goto LAB_001028d0;
  if (1 < (ulong)param_2[1]) {
    uVar17 = *(ushort *)*param_2;
    uVar13 = param_2[1] - 2;
...
LAB_001026d6:
            pSVar7 = (SSL_SESSION *)ssl_session_dup(local_258,0);
            if (pSVar7 != (SSL_SESSION *)0x0) {
              SSL_SESSION_free(local_258);
              local_258 = pSVar7;
              memcpy(pSVar7[1].master_key + 0x14,(void *)(param_1 + 0x8e0),
            ...
            uVar15 = 0x57e;
LAB_00102d9f:
            ERR_set_debug("ssl/statem/extensions_srvr.c",uVar15,"tls_parse_ctos_psk");
            ossl_statem_fatal(param_1,0x50,0xc0103,0);
            goto LAB_00102953;
          }
          if ((*(long *)(param_1 + 0x978) != 0) && (uVar17 < 0x101)) {
            ...
            if (ptr == (void *)0x0) {
              ...
              if (uVar5 < 0x201) {
                if (uVar5 == 0) {
LAB_00102a56:
                  if (local_258 != (SSL_SESSION *)0x0) goto LAB_001026d6;
                  goto LAB_00102a64;
                }
                local_24a = 0x113;
                ...
                if (lVar12 != 0) {
                  ...
                  if ((((local_258 != (SSL_SESSION *)0x0) &&
                       (iVar4 = SSL_SESSION_set1_master_key(local_258,local_248,uVar10), iVar4 != 0)
                       ) && (iVar4 = SSL_SESSION_set_cipher(local_258,lVar12), iVar4 != 0)) &&
...
LAB_00102a64:
          if (((*(ulong *)(param_1 + 0x9b0) & 0x4000) == 0) &&
            ...
            if (uVar5 != 3) {
              if (1 < uVar5) {
                pSVar7 = local_258;
                if ((uVar5 - 2 & 0xfffffffd) != 0) goto LAB_00102ac6;
                goto LAB_00102be7;
              }
              ERR_new();
              uVar15 = 0x5a7;
...
LAB_00102e90:
          ...
          *(undefined4 *)(param_1 + 0xa60) = 1;
          if (uVar17 == 0) goto LAB_00102e90;
          if ((uVar17 == 0x20) &&
             (pSVar7 = (SSL_SESSION *)lookup_sess_in_cache(param_1,puVar14,0x20),
...
LAB_00102ac6:
            ...
            if ((*(int *)(param_1 + 0x1540) == 0) ||
               (((*(byte *)(param_1 + 0x9b3) & 1) != 0 ||
                ...
                iVar4 != 0)))) {
              pSVar7 = local_258;
              uVar10 = (ulong)(uVar16 >> 0x18 | (uVar16 & 0xff0000) >> 8 | (uVar16 & 0xff00) << 8 |
                              uVar16 << 0x18) * 1000000;
              ...
              if (uVar10 < 0xffffffffc4653600) {
                if ((local_298 == 0) &&
                   (((uVar10 < *(ulong *)(local_258[1].sid_ctx + 0x14) ||
                     (uVar10 <= *(ulong *)(local_258[1].sid_ctx + 0x14))) && (uVar13 <= uVar11))))
                goto LAB_00102b73;
              }
              else if ((local_298 == 0) &&
                      ((uVar10 < *(ulong *)(local_258[1].sid_ctx + 0x14) ||
...
LAB_00102b73:
                if ((uVar11 < uVar13 + 10000000000 || 0xfffffffdabf41bff < uVar13) ||
                   (uVar11 <= uVar13 + 10000000000)) {
                  *(undefined4 *)(param_1 + 0xb1c) = 1;
                }
              }
LAB_0010273f:
              lVar8 = ssl_md(uVar2,*(undefined4 *)
                                    (*(long *)(pSVar7[1].krb5_client_princ + 0x10) + 0x40));
              if (lVar8 == 0) {
                ERR_new();
                uVar15 = 0x5d4;
                goto LAB_00102d9f;
...
LAB_00102920:
              ...
              if (uVar6 < uVar13) goto LAB_00102920;
...
LAB_00102825:
                ...
                if (uVar13 - 1 < uVar6) goto LAB_00102825;
              ...
              if ((long)iVar4 == uVar6) {
                iVar4 = tls_psk_do_binder(param_1,lVar8,
                                          *(undefined8 *)(*(long *)(param_1 + 0xf8) + 8),
                                          lVar12 - lVar3,pbVar1,0,local_258,0,local_294,
                                          *(long *)(param_1 + 0xf8));
                if (iVar4 == 1) {
...

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  uVar3 = 2;
  if ((*(byte *)(param_1 + 0x161) & 8) == 0) goto LAB_001042ad;
...

{
  ...
  local_28 = 0x17020203;
  local_48 = __LC4;
  uStack_40 = _UNK_001056c8;
  local_38 = __LC5;
  uStack_30 = _UNK_001056d8;
...

{
  ...
  lVar3 = param_2[1];
  pbVar7 = (byte *)*param_2;
  if ((lVar3 == 0) || (uVar5 = lVar3 - 1, uVar5 != *pbVar7)) {
    ...
    *param_2 = (long)(pbVar7 + lVar3);
    if (uVar5 != 0) {
      ...
      uVar4 = 2;
LAB_00104cf4:
      *(undefined1 *)(param_1 + 0xb51) = uVar4;
      return 1;
    }
    *(undefined1 *)(param_1 + 0xb51) = 2;
    ERR_new();

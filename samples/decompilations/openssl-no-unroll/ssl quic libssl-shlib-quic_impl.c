...

{
  ...
  *(undefined8 *)(param_1 + 0xa0) = 0;
  if (lVar1 == 0) {
LAB_00100310:
    if (param_2 == 0) goto LAB_00100321;
  }
  else {
...
LAB_00101230:
    ...
    if (lVar5 != 0) {
      *(byte *)(lVar1 + 0x150) = *(byte *)(lVar1 + 0x150) | 0x10;
      ...
      ossl_quic_channel_set_incoming_stream_auto_reject
                (*(undefined8 *)(lVar1 + 0xa0),bVar9,*(undefined8 *)(lVar1 + 0x170));
      if (param_3 != 0) {
        uVar6 = ossl_quic_engine_get0_mutex(*(undefined8 *)(*param_1 + 0x58));
...
LAB_0010140d:
      ...
      if (bVar2 != 0) {
        if (param_6 == 0) {
          ...
          if (iVar5 == 0) {
            uVar6 = quic_raise_non_normal_error_constprop_1
...

{
  ...
  if ((*(byte *)(lVar3 + 0x150) & 0x20) == 0) {
    ...
    if ((iVar7 != 0) ||
       (iVar7 = ossl_quic_channel_is_active(*(undefined8 *)(lVar3 + 0xa0)), iVar7 == 0)) {
      lVar10 = *param_1;
      goto LAB_001016d5;
    }
    lVar10 = *param_1;
    ...
    if ((lVar3 == 0) || (*(long *)(lVar3 + 0x80) == 0)) {
      uVar9 = 0xc0103;
LAB_001017f6:
      iVar7 = quic_raise_non_normal_error_constprop_1
                        (lVar10,"ssl/quic/quic_impl.c",0xb58,"quic_read_actual",uVar9,0);
LAB_00101816:
      if (iVar7 != 0) {
LAB_0010181e:
        uVar8 = (ulong)(*(long *)param_1[4] != 0);
        goto LAB_00101700;
      }
    }
    else {
      bVar2 = *(byte *)(*(long *)(lVar3 + 0x80) + 0x102);
      if (bVar2 == 5) {
        uVar9 = ossl_quic_channel_get_qsm
                          (*(undefined8 *)(*(long *)(lVar3 + 0x78) + 0xa0),param_1[2],param_1[3]);
...
LAB_00101928:
      ...
      if (bVar2 != 4) {
        ...
        if ((int)param_1[5] == 0) {
          iVar7 = ossl_quic_rstream_read
                            (*(undefined8 *)(lVar5 + 0x78),param_1[2],param_1[3],plVar4,&local_6c);
          if (iVar7 != 0) {
            if (*plVar4 != 0) {
              ...
              if (iVar7 == 0) {
                iVar7 = quic_raise_non_normal_error_constprop_1
                                  (lVar10,"ssl/quic/quic_impl.c",0xb75,"quic_read_actual",0xc0103,0)
                ;
                goto LAB_00101816;
              }
            }
            if (local_6c != 0) {
              ...
              ossl_quic_stream_map_notify_totally_read
                        (uVar9,*(undefined8 *)(*(long *)(lVar10 + 0x20) + 0x80));
              if (*plVar4 != 0) goto LAB_001018d3;
              goto LAB_00101864;
            }
            if (*plVar4 != 0) {
LAB_001018d3:
              uVar9 = ossl_quic_channel_get_qsm(*(undefined8 *)(lVar6 + 0xa0));
          ...
          iVar7 = quic_raise_non_normal_error_constprop_1
                            (lVar10,"ssl/quic/quic_impl.c",0xb64,"quic_read_actual",0xc0103,0);
          goto LAB_00101816;
        }
        iVar7 = ossl_quic_rstream_peek();
        if (iVar7 == 0) {
          iVar7 = quic_raise_non_normal_error_constprop_1
                            (lVar10,"ssl/quic/quic_impl.c",0xb5f,"quic_read_actual",0xc0103,0);
          goto LAB_00101816;
        }
LAB_0010185d:
        if (*plVar4 == 0) {
...
LAB_001016d5:
    quic_raise_non_normal_error_constprop_1
              (lVar10,"ssl/quic/quic_impl.c",0xb92,"quic_read_again",0xcf,0);
  }
LAB_001016f8:
  uVar8 = 0xffffffff;
LAB_00101700:
...
LAB_00101ac1:
      uVar6 = quic_raise_non_normal_error_constprop_1
                        (param_1,"ssl/quic/quic_impl.c",uVar6,"qc_wait_for_default_xso_for_read",
                         uVar8,0);
      return uVar6;
    }
    goto LAB_00101e25;
...
LAB_00101b10:
    uVar6 = ossl_quic_channel_get_statm(*(undefined8 *)(lVar1 + 0xa0));
    ossl_statm_get_rtt_info(uVar6,local_58);
    uVar6 = ossl_quic_channel_get_qsm(*(undefined8 *)(lVar1 + 0xa0));
            ...
            if ((*(byte *)(lVar1 + 0x150) & 0x20) == 0) {
              ...
              if (iVar5 == 0) {
                ...
                if (iVar5 != 0) {
                  if (0 < iVar3) {
                    iVar3 = SSL_want(*(SSL **)(lVar1 + 0x78));
                    if ((1 < iVar3 - 7U) && (uVar8 = 1, iVar3 != 4)) goto LAB_00101e69;
                    goto LAB_00102062;
                  }
                  quic_raise_non_normal_error_constprop_1
...
LAB_00101e69:
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
    uVar8 = quic_raise_non_normal_error_constprop_1
...
LAB_001025b0:
    ...
    if (iVar2 != 0x80) {
      ...
      if ((uVar6 & 2) == 0) {
        uVar6 = uVar6 & 0x87;
        uVar7 = 0x1a6;
        if (((uVar6 != 0x80) && (uVar7 = 0x1a5, uVar6 != 4)) && (uVar7 = 0x8010c, uVar6 == 1)) {
          uVar7 = 0x164;
        }
        goto LAB_00102828;
      }
    ...
    if ((param_3 & 8) != 0) {
      ...
      if (lVar4 == 0) {
        if (((*(byte *)(param_1 + 0x54) & 0x20) != 0) ||
           (iVar2 = ossl_quic_channel_is_term_any(*(undefined8 *)(param_1 + 0x28)), iVar2 != 0)) {
          uVar7 = 0;
          quic_raise_non_normal_error_constprop_1
        ...
        if (((*(byte *)(lVar4 + 0x150) & 0x10) == 0) && (*(int *)(lVar4 + 0x154) != 0)) {
          ...
          if (*(long *)(lVar4 + 0xb0) == 0) {
            iVar2 = quic_raise_non_normal_error_constprop_1
          ...
          *(byte *)(lVar4 + 0x150) = *(byte *)(lVar4 + 0x150) | 0x10;
          ...
          ossl_quic_channel_set_incoming_stream_auto_reject
                    (*(undefined8 *)(lVar4 + 0xa0),iVar2 == 2,*(undefined8 *)(lVar4 + 0x170));
        }
        else {
          iVar2 = quic_raise_non_normal_error_constprop_1
...
LAB_00102649:
    uVar7 = 0x1a6;
    if ((((uVar6 & 0x87) != 0x80) && (uVar7 = 0x1a5, (uVar6 & 0x87) != 4)) &&
       (uVar7 = 0x163, (uVar6 & 0x86) != 2)) {
      uVar7 = 0x8010c;
    }
    quic_raise_non_normal_error_constprop_0(0,"ssl/quic/quic_impl.c",0xda,"wrong_type",uVar7,0);
    if (!bVar1) {
...
LAB_001026a8:
    uVar7 = 0;
LAB_0010258e:
    uVar3 = ossl_quic_engine_get0_mutex(*(undefined8 *)(*(long *)*param_2 + 0x58));
    ossl_crypto_mutex_unlock(uVar3);
  }
  return uVar7;
}
...
LAB_00103bb2:
    ...
    iVar1 = quic_raise_non_normal_error_constprop_1
...

{
  ...
  if ((int)uVar1 != 0) {
    if ((*(byte *)(local_40 + 0x150) & 1) == 0) {
      ...
      uVar1 = quic_raise_non_normal_error_constprop_1
...
LAB_00104f88:
          ...
          lVar9 = local_78[0];
          if (iVar4 == 0) {
            uVar5 = quic_raise_non_normal_error_constprop_1
            ...
            if (iVar4 == 0) {
              if (uVar2 == 0) {
                ...
                if ((*(byte *)(lVar13 + 0x88) & 4) != 0) {
                  if ((((*(uint *)(lVar13 + 0xa8) & 2) == 0) &&
                      (param_2 != *(long *)(lVar13 + 0x90))) ||
                     (param_3 != *(long *)(lVar13 + 0x98))) {
                    uVar6 = 0xa45;
...
LAB_00105327:
                  uVar6 = ossl_quic_channel_get_reactor
                                    (*(undefined8 *)(*(long *)(lVar13 + 0x78) + 0xa0));
                  ossl_quic_reactor_tick(uVar6,0);
                }
                else {
LAB_001053d4:
                  uVar6 = *(undefined8 *)(lVar13 + 0x80);
                  uVar7 = ossl_quic_channel_get_qsm
                                    (*(undefined8 *)(*(long *)(lVar13 + 0x78) + 0xa0));
                  ossl_quic_stream_map_update_state(uVar7,uVar6);
LAB_0010519c:
                  if (lVar11 == lVar10) goto LAB_001051a1;
LAB_001051ab:
                  if ((bVar3 & 3) != 2) goto LAB_00105327;
                }
...
LAB_00104e9d:
                ...
                *param_5 = local_b0;
                if (param_3 != local_b0) {
                  ...
                  if (iVar4 < 1) {
                    ...
                    if ((((*(byte *)(lVar13 + 0x150) & 0x20) == 0) &&
                        (iVar4 = ossl_quic_channel_is_term_any(*(undefined8 *)(lVar13 + 0xa0)),
                        iVar4 == 0)) &&
                       (iVar4 = ossl_quic_channel_is_active(*(undefined8 *)(lVar13 + 0xa0)),
                       iVar4 != 0)) {
                      uVar6 = 0xa09;
              ...
              *param_5 = 0;
              uVar5 = quic_raise_non_normal_error_constprop_1
                                (local_78,"ssl/quic/quic_impl.c",0x9e9,"quic_write_blocking",0xc0103
                                 ,0);
            }
          }
        }
...
LAB_00104da3:
        uVar5 = quic_raise_non_normal_error_constprop_1
                          (local_78,"ssl/quic/quic_impl.c",uVar6,pcVar8,uVar5,0);
      }
LAB_00104db7:
      uVar6 = ossl_quic_engine_get0_mutex(*(undefined8 *)(local_78[0] + 0x58));
      ossl_crypto_mutex_unlock(uVar6);
    ...
    if (iVar4 != 0) {
LAB_00104d55:
      if (local_58 != 0) goto LAB_00104d61;
LAB_00104f10:
      uVar2 = 0;
      lVar13 = 0;
      goto LAB_00104d6e;
...
LAB_0010561e:
    ...
    if (uVar3 != 0) {
      ...
      if (*param_4 == 0) {
        if ((bVar2 == 0) &&
           (iVar4 = ossl_quic_channel_is_term_any(*(undefined8 *)(local_50 + 0xa0)), iVar4 == 0)) {
          ...
          if (iVar4 == 0) {
            ...
            ossl_quic_reactor_tick(uVar5,0);
LAB_00105782:
            uVar3 = quic_read_actual(local_68,*(undefined8 *)(local_48 + 0x80),param_2,param_3,
                                     param_4,0);
            ...
            if (uVar3 == 0) {
              uVar3 = quic_raise_non_normal_error_constprop_1
                                (local_68,"ssl/quic/quic_impl.c",0xbe5,"quic_read",0xc0103,0);
            }
            else {
              uVar3 = ~uVar3 >> 0x1f;
            }
          ...
          uVar3 = quic_raise_non_normal_error_constprop_1
                            (local_68,"ssl/quic/quic_impl.c",0xbd4,"quic_read",0xcf,0);
        }
      }
      else {
        if ((bVar2 == 0) &&
           (iVar4 = ossl_quic_channel_is_term_any(*(undefined8 *)(local_50 + 0xa0)),
           lVar6 = local_68[0], iVar4 == 0)) {
          do {
            bVar2 = *(byte *)(lVar6 + 0x70) >> 5;
            if ((bVar2 & 3) != 0) {
              uVar3 = 1;
...
LAB_00105fa2:
        iVar5 = ossl_quic_channel_has_pending(*(undefined8 *)(local_40 + 0xa0));
        if (iVar5 == 0) {
...
LAB_00106929:
        ossl_quic_channel_set_incoming_stream_auto_reject(uVar2,1,uVar4);
        uVar2 = ossl_quic_engine_get0_mutex(*(undefined8 *)(local_58[0] + 0x58));
        ossl_crypto_mutex_unlock(uVar2);
          ...
          if (param_2 == ssl) {
            *(byte *)(local_40 + 0x150) = *(byte *)(local_40 + 0x150) | 0x10;
            ...
            if (*(int *)(local_40 + 0x168) == 0) {
              ...
              ossl_quic_channel_set_incoming_stream_auto_reject
                        (uVar3,*(int *)(local_40 + 0x168) == 2,uVar1);
            }
          }
          else {
            ...
            *(byte *)(local_40 + 0x150) = *(byte *)(local_40 + 0x150) | 0x10;
            ...
            ossl_quic_channel_set_incoming_stream_auto_reject
                      (*(undefined8 *)(local_40 + 0xa0),bVar4,*(undefined8 *)(local_40 + 0x170));
            if (ssl != (SSL *)0x0) {
              SSL_free(ssl);
            }
          }
...

{
  ...
  if (uVar1 != 0) {
    ...
    ossl_quic_channel_set_incoming_stream_auto_reject
              (*(undefined8 *)(local_60 + 0xa0),bVar3,param_3);
    uVar2 = ossl_quic_engine_get0_mutex(*(undefined8 *)(local_78[0] + 0x58));
    ossl_crypto_mutex_unlock(uVar2);
  }
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
...
LAB_00107190:
  ...
  uVar2 = quic_raise_non_normal_error_constprop_1
...

{
  ...
  if (*(int *)(local_50 + 0x168) == 0) {
    if (((*(long *)(local_50 + 0xb0) == 0) && ((*(byte *)(local_50 + 0x150) & 0x10) == 0)) ||
       (*(int *)(local_50 + 0x154) == 0)) goto LAB_00107284;
LAB_00107370:
    quic_raise_non_normal_error_constprop_1
...
LAB_00107284:
    ...
    if (lVar3 == 0) {
      ...
      if ((iVar1 == 0) || (uVar5 = *(undefined8 *)(local_68[0] + 0x58), (param_2 & 1) != 0))
      goto LAB_0010739b;
      local_80 = 0;
      local_88 = local_68;
      ossl_quic_engine_set_inhibit_tick(uVar5,0);
      ...
      if (iVar1 != 0) {
        if ((-1 < iVar1) && (lVar3 = local_80, local_80 != 0)) goto LAB_001072a7;
        goto LAB_00107418;
      }
      lVar4 = 0;
      quic_raise_non_normal_error_constprop_1
...
LAB_00107418:
        ...
        *(byte *)(local_50 + 0x150) = *(byte *)(local_50 + 0x150) | 0x10;
        ...
        ossl_quic_channel_set_incoming_stream_auto_reject
                  (*(undefined8 *)(local_50 + 0xa0),bVar6,*(undefined8 *)(local_50 + 0x170));
      }
    }
  }
  uVar2 = ossl_quic_engine_get0_mutex(*(undefined8 *)(local_68[0] + 0x58));

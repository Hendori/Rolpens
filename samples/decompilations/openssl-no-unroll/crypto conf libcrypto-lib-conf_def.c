...
LAB_001001b6:
      iVar2 = OPENSSL_strcasecmp(__s + (sVar4 - 4),&_LC2);
...
joined_r0x0010031b:
    do {
      if (-1 < cVar3) {
LAB_00100321:
        uVar2 = *(ushort *)(lVar7 + (long)cVar3 * 2);
        if ((uVar2 & 0x40) != 0) {
          lVar8 = (long)iVar4;
          pcVar9 = param_4;
          do {
            ...
            if (-1 < cVar12) {
              ...
              if ((uVar2 & 0x20) != 0) {
                cVar12 = pcVar9[2];
                param_4 = pcVar9 + 2;
                if ((-1 < cVar12) && ((*(byte *)(lVar7 + (long)cVar12 * 2) & 8) != 0))
                goto LAB_001005f8;
              }
            }
...
LAB_00100690:
  ...
  while( true ) {
    ...
    if (cVar12 < '\0') break;
LAB_00100470:
    if ((*(ushort *)(lVar7 + (long)cVar12 * 2) & 0x1107) == 0) goto LAB_001006e4;
  }
  goto LAB_0010048e;
LAB_001006e4:
  name = pcVar9;
...
LAB_0010048e:
  ...
  *local_60 = '\0';
  ...
  if (cVar3 == '\0') {
LAB_001007a2:
    __s = _CONF_get_string(param_1,param_2,name);
    local_60 = pcVar9;
  }
  else {
    pcVar11 = (char *)0x0;
...

{
  ...
  if ((iVar1 == 0) || (iVar1 = OPENSSL_strcasecmp(param_1,&_LC6), iVar1 == 0)) {
    *param_2 = 1;
  }
  else {
...
LAB_00101458:
    ...
    if (iVar6 == 0) {
      ...
      if (local_120 != (CONF_VALUE *)0x0) {
        ...
        pBVar11 = param_2;
        pcVar12 = (char *)0x0;
        while (iVar7 = BUF_MEM_grow(str,(long)(iVar6 + 0x200)), param_2 = pBVar11, pcVar27 = pcVar12
              , CONCAT44(extraout_var,iVar7) != 0) {
...
LAB_00100ed5:
            ...
            bVar28 = false;
LAB_00100d5b:
            iVar7 = BIO_gets(pBVar11,(char *)__s_01,0x1ff);
            param_2 = pBVar11;
            pcVar27 = pcVar12;
...
LAB_00100cd1:
            iVar6 = iVar6 + uVar18;
            if ((uVar8 == 0) || (bVar5 = true, !bVar28)) goto LAB_00100f98;
          }
          else {
LAB_00100ca4:
            uVar8 = (uint)uVar10;
...
LAB_00100f98:
            *(undefined1 *)((long)__s_01 + (long)(int)uVar18) = 0;
            ...
            if (iVar6 < 1) {
              ...
              pvVar21 = param_1->meth_data;
              if (((-1 < (char)bVar17) &&
                  ((*(byte *)((long)pvVar21 + (long)(char)bVar17 * 2) & 0x20) != 0)) &&
                 ((iVar6 == 1 ||
                  ((bVar17 = (pbVar26 + (long)iVar6 + -1)[-1], (char)bVar17 < '\0' ||
                   ((*(byte *)((long)pvVar21 + (long)(char)bVar17 * 2) & 0x20) == 0)))))) {
                iVar6 = iVar6 + -1;
                bVar5 = true;
                goto LAB_00100ceb;
...
LAB_0010100c:
                    do {
                      ...
                      if ((uVar3 & 0x40) != 0) {
                        do {
                          ...
                          do {
                            ...
                            bVar22 = pbVar20[1];
                            if ((-1 < (char)bVar22) &&
                               ((*(byte *)((long)pvVar21 + (long)(char)bVar22 * 2) & 8) != 0)) {
                              uVar10 = (ulong)bVar22;
                              goto LAB_00101004;
                            }
                            bVar22 = pbVar20[2];
                      ...
                      uVar10 = (ulong)bVar17;
                      if (((char)bVar17 < '\0') ||
                         ((*(byte *)((long)pvVar21 + (long)(char)bVar17 * 2) & 8) == 0)) {
...
joined_r0x00101041:
            ...
            if (-1 < (char)bVar2) {
              ...
              if (bVar2 == 0x5b) {
                bVar17 = pbVar26[1];
                while (((pbVar9 = pbVar26 + 1, pbVar20 = pbVar9, pCVar25 = param_1,
                        -1 < (char)bVar17 &&
                        (uVar3 = *(ushort *)((long)pvVar21 + (long)(char)bVar17 * 2),
                    ...
                    if (((uVar3 & 0x10) == 0) || ((uVar3 & 8) != 0)) {
                      if (bVar17 == 0x5d) {
                        *pbVar15 = 0;
                        ...
                        if ((local_120 != (CONF_VALUE *)0x0) ||
                           (local_120 = _CONF_new_section(param_1,(char *)pbVar9),
                           local_120 != (CONF_VALUE *)0x0)) goto LAB_00100ceb;
                ...
                } while ((pbVar26 != pbVar20) && (pbVar20 = pbVar26, bVar17 != 0));
                ERR_new();
...
LAB_00101bc5:
                bVar17 = pbVar9[1];
                while (((pbVar9 = pbVar9 + 1, pbVar26 = pbVar9, -1 < (char)bVar17 &&
                        (uVar3 = *(ushort *)((long)pvVar21 + (long)(char)bVar17 * 2),
                        (uVar3 & 0x10) != 0)) && ((uVar3 & 8) == 0))) {
                  bVar17 = pbVar9[1];
                }
              ...
              while (((char)*pbVar9 < '\0' ||
                     ((*(byte *)((long)pvVar21 + (long)(char)*pbVar9 * 2) & 8) == 0))) {
                pbVar9 = pbVar9 + 1;
              }
              pbVar9 = pbVar9 + -1;
              if (pbVar26 <= pbVar9) {
                do {
                  if (((char)*pbVar9 < '\0') ||
                     ((*(byte *)((long)pvVar21 + (long)(char)*pbVar9 * 2) & 0x10) == 0)) break;
                  pbVar9 = pbVar9 + -1;
              ...
              *pbVar9 = 0;
              pbVar20 = pbVar26;
              while (((char)*pbVar20 < '\0' ||
                     ((*(byte *)((long)param_1->meth_data + (long)(char)*pbVar20 * 2) & 8) == 0))) {
                pbVar20 = pbVar20 + 1;
              }
              pbVar20 = pbVar20 + -1;
              if (pbVar26 <= pbVar20) {
                do {
                  if (((char)*pbVar20 < '\0') ||
                     ((*(byte *)((long)param_1->meth_data + (long)(char)*pbVar20 * 2) & 0x10) == 0))
                  break;
                  pbVar20 = pbVar20 + -1;
              ...
              pbVar20[1] = 0;
              bVar17 = pbVar9[1];
              while (((pbVar20 = pbVar9 + 1, -1 < (char)bVar17 &&
...
LAB_00100d73:
              ...
              if (iVar6 == 0) {
LAB_00101120:
                if ((pbVar9 == pbVar26 + 8) && (bVar17 != 0x3d)) {
LAB_00101abc:
                  ERR_new();
                  ...
                  pbVar26 = pbVar9;
                  while (((char)*pbVar26 < '\0' ||
                         ((*(byte *)((long)param_1->meth_data + (long)(char)*pbVar26 * 2) & 8) == 0)
                         )) {
                    pbVar26 = pbVar26 + 1;
                  }
                  pbVar26 = pbVar26 + -1;
                  if (pbVar9 <= pbVar26) {
                    do {
                      if (((char)*pbVar26 < '\0') ||
                         ((*(byte *)((long)param_1->meth_data + (long)(char)*pbVar26 * 2) & 0x10) ==
                          0)) break;
                      pbVar26 = pbVar26 + -1;
...
LAB_00101a3b:
                          pcVar27 = __s_00;
                          if ((local_160 == 0) &&
                             (local_160 = OPENSSL_sk_new_null(), local_160 == 0)) {
                            ERR_new();
                            uVar23 = 0x1fe;
                          }
                          else {
...
LAB_00101a97:
              ...
              *pbVar20 = 0;
              bVar17 = pbVar9[1];
              pvVar21 = param_1->meth_data;
              while (((pbVar20 = pbVar9 + 1, pbVar19 = pbVar20, -1 < (char)bVar17 &&
                      (uVar3 = *(ushort *)((long)pvVar21 + (long)(char)bVar17 * 2),
                      (uVar3 & 0x10) != 0)) && ((uVar3 & 8) == 0))) {
                bVar17 = pbVar9[2];
                pbVar9 = pbVar20;
              }
              while (((char)*pbVar19 < '\0' ||
                     ((*(byte *)((long)pvVar21 + (long)(char)*pbVar19 * 2) & 8) == 0))) {
                pbVar19 = pbVar19 + 1;
              }
              pbVar19 = pbVar19 + -1;
              if (pbVar20 <= pbVar19) {
                do {
                  if (((char)*pbVar19 < '\0') ||
                     ((*(byte *)((long)pvVar21 + (long)(char)*pbVar19 * 2) & 0x10) == 0)) break;
                  pbVar19 = pbVar19 + -1;
              ...
              value->name = pcVar12;
              if ((pcVar12 == (char *)0x0) ||
                 (iVar6 = str_copy(param_1,pbVar15,&value->value,pbVar20), iVar6 == 0))
              goto LAB_00100d80;
              iVar6 = strcmp((char *)pbVar15,(char *)pbVar9);
              section = local_120;
              if ((iVar6 != 0) &&
                 ((section = _CONF_get_section(param_1,(char *)pbVar15),
                  section == (CONF_VALUE *)0x0 &&
                  (section = _CONF_new_section(param_1,(char *)pbVar15),
                  section == (CONF_VALUE *)0x0)))) {
                ERR_new();

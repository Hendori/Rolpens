...

{
  ...
  if (param_1[2] == 0) {
LAB_00100685:
    if (param_2[2] == 0) goto LAB_00100627;
LAB_0010068a:
    uVar1 = 1;
  }
  else {
...
LAB_00100627:
    if (*param_1 == 0) {
LAB_001006b8:
      if (*param_2 != 0) goto LAB_0010068a;
    }
    else {
      if (*param_2 == 0) {
        if (*param_1 != 0) {
    ...
    if (param_1[1] == 0) {
LAB_001006c5:
      if (param_2[1] != 0) goto LAB_0010068a;
    }
    else {
      if (param_2[1] == 0) {
        if (param_1[1] != 0) {
...
LAB_00100c82:
          uVar7 = OSSL_DECODER_CTX_get_cleanup(lVar10);
      ...
      if (((iVar2 != 0) &&
          (iVar2 = OSSL_DECODER_CTX_set_input_structure(lVar10,param_3), iVar2 != 0)) &&
         (iVar2 = OSSL_DECODER_CTX_set_selection(lVar10,param_5), iVar2 != 0)) {
              ...
              if (local_c8[4] == '\0') {
                ...
                if (local_c8[4] == '\0') {
                  ...
                  if (iVar2 == 0) {
                    ...
                    if (((iVar2 == 0) ||
                        (iVar2 = OSSL_DECODER_CTX_set_construct_data(lVar10,puVar8), iVar2 == 0)) ||
                       (iVar2 = OSSL_DECODER_CTX_set_cleanup
                                          (lVar10,decoder_clean_pkey_construct_arg), iVar2 == 0))
                    goto LAB_00100e94;
                  }
                  iVar2 = OSSL_DECODER_CTX_add_extra(lVar10,param_6,param_7);
                  if ((iVar2 == 0) ||
                     ((param_7 != (char *)0x0 &&
                      (iVar2 = OSSL_DECODER_CTX_set_params(lVar10,local_b8), iVar2 == 0))))
                  goto LAB_00100ee0;
                  puVar8 = (undefined8 *)
                           CRYPTO_zalloc(0x30,"crypto/encode_decode/decoder_pkey.c",0x34c);
                  if (puVar8 == (undefined8 *)0x0) {

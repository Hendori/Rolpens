...
LAB_00100107:
    sha1_block_data_order(c,data,len >> 6);
...

{
  ...
  *(ulong *)(c->data + 0xe) =
  ...
  uVar4 = c->h0;
  *(uint *)md = uVar4 >> 0x18 | (uVar4 & 0xff0000) >> 8 | (uVar4 & 0xff00) << 8 | uVar4 << 0x18;
  uVar4 = c->h1;
  *(uint *)(md + 4) =
...

{
  ...
  *(undefined1 (*) [16])(c->data + 0xd) = (undefined1  [16])0x0;
  ...
  uVar3 = _UNK_00100508;
  c->h1 = uVar1;
  _UNK_00100508 = (undefined4)uVar2;
  _UNK_0010050c = SUB84(uVar2,4);
  uVar1 = _UNK_0010050c;
  c->h2 = _UNK_00100508;
  _UNK_00100508 = uVar3;
  c->h3 = uVar1;
  ...
  if (param_2 == 0x1d) {
    if ((param_3 == 0x30) && (param_1 != (SHA_CTX *)0x0)) {
      ...
      if (0 < iVar1) {
        ...
        local_58 = __LC2;
        uStack_50 = _UNK_00100518;
        local_48 = __LC2;
        uStack_40 = _UNK_00100518;

...
void unreserved__start(generic64_t argument_0, generic64_t argument_1, struct_63 *argument_2) {
  int32_t _var_0;
...
_ABI(SystemV_x86_64)
void count_sheep(generic64_t argument_0, generic64_t argument_1, generic64_t argument_2, generic64_t argument_3) {
  ...
  *((uint8_t **) &_stack) = "%d ";
  ...
  _var_0 = puts_((const int8_t *) "ZzZzZz...");
}

_ABI(SystemV_x86_64)
struct_80 short_multiplication_table(generic64_t argument_0) {
  struct _PACKED struct_58 {
    uint8_t padding_at_0[16];
    generic64_t offset_16;
    uint8_t padding_at_24[16];
    generic64_t offset_40;
    uint8_t padding_at_48[8];
  } _stack;
  int32_t _var_0;
  int32_t _var_1;
  int32_t _var_2;
  ...
  int32_t _var_19;
  struct_80 _var_20;
  _stack.offset_40 = (pointer_or_number64_t) &segment_0x402000_Generic64_396.unreserved__rodata.offset_16 + 28;
  ...
  _var_0 = printf_((const int8_t *) ((pointer_or_number64_t) &segment_0x402000_Generic64_396.unreserved__rodata.offset_16 + 28));
...
generic64_t main(void) {
  struct_80 _var_0;
  _var_0 = short_multiplication_table(19);
  count_sheep(19, _undef_generic64_t(), _var_0.offset_8, _undef_generic64_t());
  return 0;
}

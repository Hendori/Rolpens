...
undefined8 wc_lines_avx2(undefined8 param_1,int param_2)

{
  ...
  lVar9 = 0;
  lVar12 = 0;
  *(undefined8 *)(puVar10 + -0x1028) = param_1;
  ...
  *(undefined8 *)(puVar10 + 0x3eff8) = *(undefined8 *)(in_FS_OFFSET + 0x28);
  while( true ) {
    *(undefined8 *)(puVar10 + -0x1048) = 0x100070;
    lVar5 = read(param_2,__buf,0x40000);
    if (lVar5 < 1) break;
    lVar9 = lVar9 + lVar5;
    pauVar8 = __buf;
    if (0x1f < lVar5) {
  ...
  *(long *)(piVar7 + 4) = lVar9;
  ...
  return *(undefined8 *)(puVar10 + -0x1028);
}

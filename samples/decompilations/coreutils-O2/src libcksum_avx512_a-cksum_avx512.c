...
LAB_00100384:
    ...
    do {
      ...
      *(undefined8 *)(puVar11 + -0x1088) = 0x10009a;
      ...
      auVar13 = vmovdqa64_avx512f(_DAT_001003c0);
      ...
      uVar10 = uVar10 + sVar5;
      if (bVar12) {
        *(undefined8 *)(puVar11 + -0x1088) = 0x10037e;
      ...
      if (0x1ff < sVar5) {
        ...
        auVar16 = vmovdqa64_avx512f(*(undefined1 (*) [64])(puVar11 + -0x1040));
        auVar2 = vpinsrd_avx((undefined1  [16])0x0,(int)uVar9,3);
        auVar14 = vmovdqa64_avx512f(*(undefined1 (*) [64])(puVar11 + -0x1000));
        auVar16 = vpshufb_avx512bw(auVar16,auVar13);
        auVar15 = vmovdqa64_avx512f(*(undefined1 (*) [64])(puVar11 + -0xfc0));
        vpshufb_avx512bw(auVar14,auVar13);
        vpshufb_avx512bw(auVar15,auVar13);
        vpxord_avx512f(ZEXT1664(auVar2),auVar16);
        auVar16 = vmovdqa64_avx512f(*(undefined1 (*) [64])(puVar11 + -0xf80));
        vpshufb_avx512bw(auVar16,auVar13);
                    /* WARNING: Bad instruction - Truncating control flow here */
        halt_baddata();
      }
      if (0x7f < sVar5) {
        auVar13 = vmovdqa64_avx512f(*(undefined1 (*) [64])(puVar11 + -0x1040));
        auVar16 = vmovdqa64_avx512f(_DAT_001003c0);
        auVar2 = vpinsrd_avx((undefined1  [16])0x0,(int)uVar9,3);
        auVar13 = vpshufb_avx512bw(auVar13,auVar16);
        vpxord_avx512f(ZEXT1664(auVar2),auVar13);
                    /* WARNING: Bad instruction - Truncating control flow here */
        halt_baddata();
      }
  ...
  if (*(long *)(puVar11 + 0xeff8) != *(long *)(in_FS_OFFSET + 0x28)) {
    ...
    *(undefined8 *)(puVar11 + -0x1088) = 0x10038d;
    __stack_chk_fail();
  }
  return uVar4;
}

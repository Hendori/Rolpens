...

{
  ...
  if (pcVar4 == (char *)0x0) {
    ...
    pcVar6 = " invocation";
    __printf_chk(2,uVar5,"https://www.gnu.org/software/coreutils/","unlink");
  }
  else {
    uVar5 = dcgettext(0,"\n%s online help: <%s>\n",5);
    __printf_chk(2,uVar5,"GNU coreutils","https://www.gnu.org/software/coreutils/");
...

{
  ...
  parse_gnu_standard_options_only
            (param_1,param_2,"unlink","GNU coreutils",_Version,1,0x100000,uVar2,0);
  if (param_1 <= _optind) {
  ...
  if (param_1 <= _optind + 1) {
    ...
    uVar2 = quotearg_style(4,param_2[_optind]);

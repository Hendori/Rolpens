...

{
  ...
  if (initialized_2 == 0) {
    ...
    is_utf8_1 = (uint)(iVar1 == 0);
    uVar2 = 1;
    if ((iVar1 != 0) &&
       (utf8_to_local_0 = iconv_open(__s1,"UTF-8"), uVar2 = is_utf8_1,
       utf8_to_local_0 == (iconv_t)0xffffffffffffffff)) {
      utf8_to_local_0 = iconv_open("ASCII","UTF-8");
      uVar2 = is_utf8_1;
    }
    initialized_2 = 1;
    if (uVar2 == 0) goto LAB_00100149;
LAB_00100297:
    if (param_1 < 0x80) {
      sVar4 = 1;
...
LAB_00100220:
      iVar1 = u8_uctomb_aux(local_6e,param_1,6);
      if (iVar1 < 0) {
      ...
      sVar4 = (size_t)iVar1;
      if (is_utf8_1 == 0) goto LAB_0010016e;
    }
    (*param_2)(local_6e,sVar4,param_4);
  }
  else {
    if (is_utf8_1 != 0) goto LAB_00100297;
LAB_00100149:
    ...
    if (0x7f < param_1) goto LAB_00100220;
    sVar4 = 1;
    local_6e[0] = (char)param_1;
LAB_0010016e:
    local_90 = local_6e;
...
void print_unicode_char(FILE *param_1,int param_2,int param_3)

{
  ...
  if (param_2 - 0x20U < 0x60) {
    ...
    pcVar1 = fallback_failure_callback;
    if (param_3 != 0) {
      pcVar1 = exit_failure_callback;
    }
    if (local_10 == *(long *)(in_FS_OFFSET + 0x28)) {
      unicode_to_mb(param_2,0x100000,pcVar1);
      return;
    }
  }
                    /* WARNING: Subroutine does not return */

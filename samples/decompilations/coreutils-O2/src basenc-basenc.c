...
void base2msbf_encode(char *param_1,long param_2,long param_3,long param_4)

{
  ...
  if ((param_2 != 0) && (param_4 != 0)) {
    ...
    do {
      ...
      param_1 = param_1 + 1;
      bVar6 = (char *)(param_3 + param_4) != pcVar5;
      pcVar5 = pcVar5 + 8;
    } while (param_1 != pcVar1 && bVar6);
  }
  return;
}
...
void base2lsbf_encode(byte *param_1,long param_2,long param_3,long param_4)
...
void z85_encode(undefined1 *param_1,long param_2,long param_3,long param_4)
  ...
  if (param_2 != 0) {
    ...
    do {
      while( true ) {
        ...
        iVar4 = iVar4 + 1;
        param_1 = param_1 + 1;
        *(undefined1 *)((long)&local_34 + lVar10) = uVar2;
        if (iVar4 != 4) break;
        uVar9 = (ulong)(local_34 >> 0x18 | (local_34 & 0xff0000) >> 8 | (local_34 & 0xff00) << 8 |
                       local_34 << 0x18);
        lVar10 = lVar11 + 4;
        do {
          if (lVar10 < param_4) {
            *(char *)((param_3 - lVar11) + lVar10) =
                 "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ.-:+=^!/*?&<>()[]{}@%$#"
                 [(int)uVar9 + (int)((long)uVar9 / 0x55) * -0x55];
          }
          bVar12 = lVar10 != lVar11;
          uVar9 = (long)uVar9 / 0x55;
          lVar10 = lVar10 + -1;
        } while (bVar12);
        param_3 = param_3 + 5;
        lVar11 = lVar11 + 5;
        iVar4 = 0;
        if (param_1 == puVar1) goto LAB_00100848;
      }
...
LAB_00100848:
    if (iVar4 != 0) {
      ...
      error(1,pcVar7,uVar5);
      iVar4 = rpl_fclose();
      if (iVar4 != 0) {
        if ((*pcVar7 == '-') && (pcVar7[1] == '\0')) {
          pcVar7 = (char *)dcgettext(0,"closing standard input",5);
          piVar8 = __errno_location();
          error(1,*piVar8,pcVar7);
        }
        uVar5 = quotearg_n_style_colon(0,3,pcVar7);
        piVar8 = __errno_location();
        error(1,*piVar8,&_LC5,uVar5);
      }
    ...
    do {
      while( true ) {
        ...
        *(char *)(lVar2 + lVar3) = "ABCDEFGHIJ:;<=>?@KLMNOPQRSTUVWXYZ234567"[cVar1 + -0x30];
        lVar3 = lVar3 + 1;
        if (param_3 == lVar3) goto LAB_00100b96;
      }
...
LAB_00101b24:
  do {
    ...
    if (iVar4 == -1) {
      ...
      lVar17 = (long)_optind;
      if (1 < param_1 - _optind) goto LAB_001023ea;
      if (_optind < param_1) {
        ...
        if (((char)local_b8 != '\0') && (0 < lVar17)) {
          ...
          do {
            while( true ) {
              ...
              if (lVar17 <= lVar10) goto LAB_00101dc3;
            }
            lVar17 = lVar17 + -1;
            piVar18 = local_c0;
            if (local_c0 < piVar12) {
...
LAB_00101dc3:
        ...
        if ((*puVar8 & 0x20) != 0) goto LAB_00102350;
        iVar6 = (*base_length)(0x1068);
...
LAB_00102045:
      ...
      if (sVar11 < local_70) goto LAB_001022b9;
      if ((char)uVar5 == '\0') {
...
LAB_00102350:
    ...
    if (iVar4 != 0x69) {
      if (iVar4 < 0x6a) {
        ...
        if ((1 < uVar5) || ((long)local_70 < 0)) goto LAB_0010237c;
        uVar21 = local_70;
        if (uVar5 == 1) {
          uVar21 = 0;
        }
      ...
      if (0 < (long)puVar14) {
        do {
          ...
          if (__n == 0) {
            ...
            pFVar20 = p_Var9;
            if (sVar11 < __n) goto LAB_001022b9;
...
LAB_0010220a:
        if ((uVar5 & 0x20) != 0) goto LAB_00102350;
        goto LAB_00102212;
      }
LAB_0010212c:
      piVar16 = (int *)0x0;
      ...
      if ((long)piVar16 < 1) goto LAB_001021fc;
      ...
      puVar14 = in_R10;
      pFVar13 = __stream;
      if (uVar21 == 0) goto code_r0x001021bd;
    } while( true );
  }
...
LAB_001023b9:
  ...
  piVar16 = __errno_location();
  lVar17 = error(1,*piVar16,&_LC5,param_2);
LAB_001023ea:

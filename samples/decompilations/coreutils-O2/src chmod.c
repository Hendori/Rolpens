...

{
  ...
  pcVar10 = *(char **)(param_2 + 0x30);
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  switch(*(undefined2 *)(param_2 + 0x68)) {
  case 2:
    cVar2 = cycle_warning_required();
    if (cVar2 == '\0') break;
...
LAB_0010024d:
  ...
  case 0xc:
    if (dereference == 1) {
      __buf = &local_178;
      iVar5 = fstatat(*(int *)(param_1 + 0x2c),pcVar10,__buf,0);
      if (iVar5 != 0) {
        if (force_silent == '\0') {
          uVar6 = quotearg_style(4,__s1);
...
LAB_001006a9:
  ...
  iVar3 = fchmodat(*(int *)(param_1 + 0x2c),pcVar10,__mode,(uint)(bVar11 ^ 1) << 8);
  iVar5 = verbosity;
  if (iVar3 == 0) {
    if (verbosity != 2) {
      uVar4 = __mode;
      if (((__mode & 0xe00) == 0) ||
         (iVar3 = fstatat(*(int *)(param_1 + 0x2c),pcVar10,&local_e8,0), uVar4 = local_e8.st_mode,
         iVar3 == 0)) {
        if (((uVar4 ^ uVar1) & 0xfff) != 0) {
          uVar6 = quotearg_style(4,__s1);
          strmode(__mode,&local_58);
          local_4e = 0;
          strmode(uVar1,&local_4c);
          local_42 = 0;
          uVar7 = dcgettext(0,"mode of %s changed from %04lo (%s) to %04lo (%s)\n",5);
          __printf_chk(2,uVar7,uVar6,uVar1 & 0xfff,local_4b,__mode & 0xfff,local_57);
          goto LAB_001001b1;
        }
      }
...
LAB_001001b1:
    cVar2 = diagnose_surprises;
    if (diagnose_surprises == '\0') {
      cVar2 = '\x01';
    }
    else {
      uVar4 = mode_adjust(uVar1,(uVar1 & 0xf000) == 0x4000,0,change,0);
      if ((~uVar4 & __mode) != 0) {
        strmode(__mode,&local_58);
...
LAB_00100250:
      ...
      if (verbosity == 2) goto LAB_0010077d;
      if (verbosity == 0) {
        uVar4 = 1;
        uVar6 = quotearg_style(4,__s1);
        strmode(__mode,&local_58);

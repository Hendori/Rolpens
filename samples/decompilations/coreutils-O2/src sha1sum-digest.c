...

{
  ...
  puVar26 = &switchD_001014f3::switchdataD_00102530;
  ...
  while( true ) {
    ...
    if (iVar4 < 0x62) {
      if (iVar4 == -0x83) {
        ...
        version_etc(_stdout,"sha1sum","GNU coreutils",_Version,uVar7,uVar6,uVar13,0);
                    /* WARNING: Subroutine does not return */
        exit(0);
      }
      if (iVar4 == -0x82) {
...
LAB_001017af:
                ...
                if (local_cd != 0) goto LAB_00101844;
              }
              ...
              print_filename(__stream,local_cc);
            }
            else {
...
LAB_00101844:
            ...
            do {
              ...
              pFVar28 = pFVar29;
              if (local_e0 <= pFVar29) goto LAB_001018c1;
              __stream = *(char **)pFVar29;
              puVar26 = (uint *)((ulong)pFVar11 & 0xffffffff);
LAB_0010176c:
              pFVar11 = (FILE *)digest_file_isra_0(__stream,param_2,local_e8);
          ...
          pcVar20 = _stdout->_IO_write_ptr;
          p_Var21 = _stdout;
          if (_stdout->_IO_write_end <= pcVar20) goto LAB_00102318;
          _stdout->_IO_write_ptr = pcVar20 + 1;
          *pcVar20 = '\\';
        } while( true );
      }
...
joined_r0x0010189a:
    ...
    if ((((ignore_missing != '\x01') ||
         ...
         local_cd != 0)) &&
        ((status_only != 1 ||
         (pcVar20 = "the --status option is meaningful only when verifying checksums", local_cd != 0
         )))) && ((warn != '\x01' ||
                  (pcVar20 = "the --warn option is meaningful only when verifying checksums",
                  local_cd != 0)))) {
      bVar2 = quiet ^ 1 | local_cd;
      uVar5 = (uint)bVar2;
      if (bVar2 == 0) {
    ...
    if (local_cd == 0) goto LAB_00101880;
  }
LAB_001018a0:
...
LAB_0010202b:
      bVar23 = (byte)pFVar22;
      if ((ignore_missing != '\0') && (local_69 != '\0')) goto LAB_00101cba;
      if (local_a8 == digest_hex_bytes) {
        uVar24 = (ulong)local_a8 >> 1;
        if (uVar24 != 0) {
          uVar16 = 0;
          do {
            ...
            if ((int)(char)bin2hex_0[*(byte *)(local_c0 + uVar16) >> 4] != uVar5) {
LAB_00102190:
              if (uVar24 != uVar16) goto LAB_00102051;
              break;
            }
            ...
            if ((int)(char)bin2hex_0[*(byte *)(local_c0 + uVar16) & 0xf] != uVar5)
            goto LAB_00102190;
            uVar16 = uVar16 + 1;
          } while (uVar24 != uVar16);
        }
        local_82 = status_only;
        if ((status_only != 0) || (local_82 = quiet, quiet != 0)) goto LAB_00101cba;
        local_82 = bVar23;
        if ((int)puVar27 != 0) goto LAB_001021cd;
        local_d8 = (FILE *)((ulong)pFVar22 & 0xff);
        print_filename(puVar15,0);
        pFVar22 = (FILE *)((ulong)pFVar22 & 0xff);
LAB_0010220e:
        if (quiet != 0) goto LAB_00101cba;
        pcVar20 = "OK";
      }
      else {
LAB_00102051:
        ...
        if (status_only != 0) goto LAB_00101cba;
        bVar23 = 0;
        if ((int)puVar27 == 0) {
          print_filename(puVar15,0);
        }
...
LAB_001021cd:
          ...
          local_d8 = (FILE *)(ulong)bVar23;
          print_filename(puVar15,1);
          pFVar22 = (FILE *)(ulong)bVar23;
          if (bVar23 != 0) goto LAB_0010220e;
        }
        pcVar20 = "FAILED";
      }
      uVar13 = dcgettext(0,pcVar20,5);
...
LAB_00101d03:
          if (-1 < iVar4) {
            pFVar14 = (FILE *)quotearg_n_style_colon(0,3,local_c8);
            puVar17 = &_LC4;
            if (iVar4 == 0) goto LAB_00102498;
            goto LAB_0010244d;
          }
          if (bVar23 == 0) {
            pFVar11 = (FILE *)quotearg_n_style_colon(0,3,local_c8);
...
LAB_0010240f:
            ...
            if (status_only == 0) {
              ...
              if (ignore_missing == '\0') goto LAB_00101da5;
              if (local_82 == 0) {
                pFVar11 = (FILE *)quotearg_n_style_colon(0,3,local_c8);
...
LAB_00101d5b:
              if (local_b0 == (FILE *)0x0 && local_b8 == (FILE *)0x0) {
                bVar23 = strict ^ 1 | local_98 == (FILE *)0x0;
                goto LAB_00101d7f;
              }
            }
            else {
...
LAB_0010196c:
        ...
        while (pFVar11 = (FILE *)__stream,
          ...
          *(char *)((long)local_68 + (long)puVar27) = '\0';
          ...
          if ((cVar3 == '\t') || (cVar3 == ' ')) {
            do {
              do {
                ...
                cVar3 = *(char *)((long)&((FILE *)puVar26)->_flags + (long)&local_68->_flags);
              } while (cVar3 == ' ');
            } while (cVar3 == '\t');
          }
          local_d8 = (FILE *)0x0;
          ...
          pFVar29 = (FILE *)((long)&((FILE *)puVar26)->_flags + (long)&local_68->_flags);
          iVar4 = strncmp((char *)pFVar29,"SHA1",4);
          if (iVar4 != 0) goto LAB_00101b28;
          cVar3 = (&((FILE *)puVar18)->field_0x4)[(long)puVar26];
          puVar15 = &((FILE *)puVar26)->field_0x4;
          if (cVar3 == ' ') {
            cVar3 = (&((FILE *)puVar18)->field_0x5)[(long)puVar26];
            puVar15 = &((FILE *)puVar26)->field_0x5;
          }
          if (cVar3 == '(') {
            ...
            if ((FILE *)puVar27 != (FILE *)0x0) {
              ...
              if ((*pcVar25 == ')') &&
                 ((bVar30 = (byte)local_d8 == '\0', bVar30 ||
                  (lVar9 = filename_unescape(pFVar11,pcVar20), local_d8 = pFVar11, lVar9 != 0)))) {
                *pcVar25 = '\0';
                cVar3 = ((char *)((long)&pFVar11->_flags + 1))[(long)pcVar20];
                lVar9 = (long)(pcVar20 + 1);
                if (cVar3 != ' ') goto LAB_00101e8d;
                do {
                  do {
                    lVar9 = lVar9 + 1;
...
LAB_00101ab3:
          if (warn != '\0') {
            puVar27 = (undefined1 *)quotearg_n_style_colon(0,3,local_c8);
...
LAB_00101adf:
          ...
          pFVar14 = (FILE *)puVar18;
          if (pFVar28 == (FILE *)0x0) {
            pFVar28 = (FILE *)quotearg_n_style_colon(0,3,local_c8);
                ...
                if ((FILE *)((long)pFVar14 - (long)puVar26) == digest_hex_bytes) {
                  ...
                  if (digest_hex_bytes != (FILE *)0x0) {
                    ...
                    do {
                      ...
                      if ((0x36 < (byte)uVar5) ||
                         ((0x7e0000007e03ffU >> ((ulong)uVar5 & 0x3f) & 1) == 0)) goto LAB_00101ab3;
                  ...
                  if ((char)pFVar19->_flags == '\0') {
                    ...
                    if ((byte)local_d8 != '\0') {
                      ...
                      local_d8 = pFVar11;
LAB_0010224a:
                      if (!bVar30) goto LAB_00101ab3;
                    }
                    if (((local_cc != 0) || ((char)pFVar11->_flags != '-')) ||
                      ...
                      uVar5 = digest_file_isra_0(pFVar11,local_c0,&local_69);
                      pFVar22 = (FILE *)(ulong)uVar5;
                      puVar15 = (undefined1 *)pFVar11;
                      local_d8 = pFVar11;
                      if ((char)uVar5 != '\0') goto LAB_0010202b;
                      if (status_only == 0) {
                        if ((int)puVar27 != 0) {
                          pcVar20 = _stdout->_IO_write_ptr;
                          if (pcVar20 < _stdout->_IO_write_end) {

...
LAB_001007a9:
        *(undefined8 *)(puVar21 + lVar2 + -8) = 0x1007b3;
        uVar8 = quotearg_style(4,uVar10);
        *(undefined8 *)(puVar21 + lVar2 + -8) = 0x1007c9;
        uVar14 = dcgettext(0,"%s exists but is not a directory",5);
        *(undefined8 *)(puVar21 + lVar2 + -8) = 0x1007da;
          ...
          *(undefined8 *)(puVar21 + lVar2 + -8) = 0x1004b3;
          ...
          if (iVar5 != 0) {
            *(undefined8 *)(puVar21 + lVar2 + -8) = 0x1004c0;
            ...
            iVar5 = *piVar12;
            if (*piVar12 == 0) goto LAB_001004cc;
LAB_001006c4:
            local_16c = iVar5;
...
LAB_00100667:
            ...
            *(undefined8 *)(puVar21 + lVar2 + -8) = 0x10088a;
            uVar8 = quotearg_style(4,local_180);
            pcVar22 = "failed to get attributes of %s";
          }
          else {
            *(undefined8 *)(puVar21 + lVar2 + -8) = 0x100843;
            uVar8 = quotearg_style(4,local_180);
            pcVar22 = "cannot make directory %s";
          }
          *(undefined8 *)(puVar21 + lVar2 + -8) = 0x100859;
          uVar14 = dcgettext(0,pcVar22,5);
          *(undefined8 *)(puVar21 + lVar2 + -8) = 0x100861;
          piVar12 = __errno_location();
          iVar4 = *piVar12;
          *(undefined8 *)(puVar21 + lVar2 + -8) = 0x100872;
          error(0,iVar4,uVar14,uVar8);
          uVar8 = 0;
          goto LAB_00100221;
        }
...
LAB_00100707:
        ...
        uVar10 = local_180;
        if ((local_168.st_mode & 0xf000) != 0x4000) goto LAB_001007a9;
        *local_188 = '\0';
LAB_00100446:

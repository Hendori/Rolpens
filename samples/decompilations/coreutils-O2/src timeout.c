...
LAB_00100950:
    ...
    if ((local_28 == param_1) || (dVar8 < 0.0)) goto LAB_001009c1;
    cVar1 = *local_28;
joined_r0x00100978:
    if (cVar1 == '\0') goto LAB_00100920;
    if (local_28[1] != '\0') goto LAB_001009c1;
    if (cVar1 != 'h') {
      if (cVar1 < 'i') {
        if (cVar1 == 'd') {
          dVar8 = dVar8 * __LC45;

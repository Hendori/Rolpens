...
undefined8 crc32_update_no_xor_pclmul(uint param_1,undefined1 (*param_2) [16],ulong param_3)

{
  ...
  if (param_3 < 0x80) {
    ...
    local_138 = (ulong)param_1;
    local_e8._0_8_ = local_138 ^ local_e8._0_8_;
    if (param_3 < 0x20) goto LAB_0010018d;
  }
  else {
    uVar36 = param_3 - 0x80;
    ...
    do {
      ...
      pauVar30 = pauVar31;
    } while (pauVar31 != (undefined1 (*) [16])(param_2[4] + (uVar36 & 0xffffffffffffffc0)));
    uVar32 = uVar36 & 0xffffffffffffffc0;
    param_3 = (param_3 - 0x40) - uVar32;
    memcpy(auStack_a8,param_2[8] + uVar32,uVar36 - uVar32);
    if (param_3 < 0x20) goto LAB_0010018d;
  }
  uVar36 = param_3 - 0x20 >> 4;
  ...
  param_3 = (param_3 - 0x10) + uVar36 * -0x10;
  __dest = pauVar30;
LAB_0010018d:
  if (param_3 == 0x10) {
    auVar38 = *__dest;
    ...
    if (uVar35 < 8) {
      if ((param_3 & 4) == 0) {
        if ((uVar35 != 0) && (*(undefined1 *)puVar1 = (*__dest)[0], (param_3 & 2) != 0)) {
          pauVar30 = __dest + -1;
          __dest = (undefined1 (*) [16])0x0;
          *(undefined2 *)((long)&uStack_110 + uVar36 + lVar37 + -0x2a) =
               *(undefined2 *)(*pauVar30 + uVar36 + 0xe);
        }
      }
      else {
        ...
        *(undefined4 *)((long)&uStack_110 + uVar36 + lVar37 + -0x2c) =
             *(undefined4 *)(*pauVar30 + uVar36 + 0xc);
      }
    }
    else {
      uVar36 = (long)&uStack_100 + lVar34 & 0xfffffffffffffff8;
      *puVar1 = *(undefined8 *)*__dest;
      *(undefined8 *)((long)&uStack_110 + (param_3 & 0xffffffff) + lVar37 + -0x30) =
           *(undefined8 *)(__dest[-1] + (param_3 & 0xffffffff) + 8);
      lVar34 = (long)puVar1 - uVar36;
      __dest = (undefined1 (*) [16])((long)__dest - lVar34);
      ...
      if (7 < uVar35) {
        ...
        do {
          uVar32 = (ulong)uVar33;
          uVar33 = uVar33 + 8;
          *(undefined8 *)(uVar36 + uVar32) = *(undefined8 *)((long)*__dest + uVar32);
        } while (uVar33 < uVar35);
      }
    }
    auVar28._8_8_ = 0;
  ...
  return CONCAT44((int)((ulong)__dest >> 0x20),auVar38._0_4_);
}

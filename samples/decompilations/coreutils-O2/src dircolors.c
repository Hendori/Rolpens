...
LAB_00100040:
      ...
      if (lsc_obstack._32_8_ == lsc_obstack._24_8_) goto LAB_001000b8;
    }
    else {
LAB_00100050:
      if (lsc_obstack._32_8_ == lsc_obstack._24_8_) {
...

{
  ...
  *(byte *)lsc_obstack._24_8_ = (-(print_ls_colors == '\0') & 0x34U) + 9;
  ...
  if (print_ls_colors == '\0') {
    cVar3 = ':';
    if (lsc_obstack._32_8_ != lsc_obstack._24_8_) goto LAB_001002ad;
LAB_00100340:
    rpl_obstack_newchunk(lsc_obstack,1);
  }
  else {
    append_quoted(&_LC1);
    if (lsc_obstack._32_8_ == lsc_obstack._24_8_) goto LAB_00100340;
  }
...
LAB_00100470:
  ...
  if (param_1 == (FILE *)0x0) goto LAB_001005c0;
LAB_0010047d:
...
LAB_001005a3:
        ...
        free(__pattern);
        pNVar18 = (NoteGnuProperty_4 *)pcVar6;
        if (param_1 != (FILE *)0x0) goto LAB_0010047d;
LAB_001005c0:
...

{
  ...
  while (iVar2 = getopt_long(param_1,param_2,&_LC44,&long_options,0), iVar2 != -1) {
    if (iVar2 == 99) {
      ...
      if (iVar2 != 0x80) goto LAB_00101855;
      print_ls_colors = '\x01';
    }
  }
...
LAB_0010192e:
    ...
    if (cVar12 == '\x02') goto LAB_0010165f;
LAB_001016b7:
...
LAB_0010165f:
    ...
    for (; pcVar8 + -0x101dc0 < (char *)0x15f0; pcVar8 = pcVar8 + sVar9 + 1) {
      puts(pcVar8);
      sVar9 = strlen(pcVar8);
    }
LAB_0010180a:

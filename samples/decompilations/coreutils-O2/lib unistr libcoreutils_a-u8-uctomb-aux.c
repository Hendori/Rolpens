...
undefined8 u8_uctomb_aux(byte *param_1,uint param_2,long param_3)
...
LAB_001000b0:
    ...
    if (param_2 < 0x800) {
      if (param_3 < 2) goto LAB_001000b0;
      uVar2 = 2;
    }
    else {
      if (param_2 < 0x10000) {
        ...
        if (param_3 < 3) goto LAB_001000b0;
        uVar2 = 3;
      }
      else {
        if (0x10ffff < param_2) {
        ...
        if (param_3 < 4) goto LAB_001000b0;
        uVar2 = 4;
        bVar1 = (byte)param_2;

  ...
  if (param_2 < 2) {
    ...
    do {
      while( true ) {
        ...
        bVar4 = *(byte *)(param_1 + uVar2 + lVar7);
        if (bVar4 - 0x41 < 0x1a) {
          bVar4 = bVar4 + 0x20;
        }
...
LAB_001000a4:
    *param_3 = lVar8;
    ...
    do {
      while( true ) {
        uVar5 = uVar1;
        bVar3 = *(byte *)(param_1 + uVar6);
        if (bVar3 - 0x41 < 0x1a) {
          bVar3 = bVar3 + 0x20;
        }
        bVar4 = *(byte *)(param_1 + lVar8 + uVar9);
        if (bVar4 - 0x41 < 0x1a) {
          bVar4 = bVar4 + 0x20;
        }
...
LAB_001000d7:
        ...
        uVar1 = uVar6;
        uVar6 = uVar5;
        if (param_2 <= uVar5) goto LAB_00100133;
      }
      if (bVar3 == bVar4) {
        if (lVar7 == lVar8) {
          uVar6 = uVar5 + lVar7;
...
LAB_001002f4:
      do {
        ...
        if ((lVar11 == 0) || (pvVar6 != (void *)0x0)) goto LAB_001004d8;
        ...
        if (uVar12 == 0) {
          ...
          if (uVar15 < local_880) {
            ...
            } while ((uVar9 == uVar2) && (uVar12 = uVar14, uVar15 != uVar14));
          }
          if (uVar12 < uVar15 + 1) {
...
LAB_00100426:
  do {
    ...
    if ((lVar10 == 0) || (pvVar6 != (void *)0x0)) goto LAB_001004d8;
    ...
    if (local_848[(int)uVar2] == 0) {
      ...
      for (uVar13 = local_880; uVar15 = local_880, uVar13 < param_4 - 1; uVar13 = uVar13 + 1) {
      ...
      do {
        if (uVar15 == 0) goto LAB_001004da;
        uVar15 = uVar15 - 1;
        bVar1 = param_3[uVar15];
        uVar2 = (uint)bVar1;
        if (bVar1 - 0x41 < 0x1a) {
          uVar2 = bVar1 + 0x20;
        }
        bVar1 = *(byte *)(lVar10 + uVar15);
        uVar9 = (uint)bVar1;
        if (bVar1 - 0x41 < 0x1a) {
          uVar9 = bVar1 + 0x20;
        }
...

{
  ...
  if (bVar2 == 0) {
    ...
    do {
      ...
      uVar11 = (uint)*pbVar12;
      pbVar1 = pbVar12;
      if (*pbVar12 == 0) goto joined_r0x00100687;
      pbVar7 = pbVar7 + 1;
      pbVar1 = pbVar12 + 1;
      if (uVar5 - 0x41 < 0x1a) {
        uVar5 = uVar5 + 0x20;
...
joined_r0x00100687:
      pbVar7 = param_1;
      if (!bVar3) {
        uVar13 = (long)pbVar1 - (long)param_2;
        pbVar7 = param_1 + 1;
        uVar16 = uVar13 - 1;
        if (uVar13 < 0x20) {
          if (uVar13 < 3) {
            ...
            uVar8 = critical_factorization_part_0(param_2,uVar13,&local_48);
            local_58 = local_48;
          }
          iVar6 = c_strncasecmp(param_2,param_2 + local_58,uVar8);
          if (iVar6 != 0) {
            uVar10 = uVar13 - uVar8;
            if (uVar13 - uVar8 < uVar8) {
              uVar10 = uVar8;
            }
            lVar17 = 0;
LAB_001008e3:
            do {
              uVar15 = uVar13 + lVar17;
              pvVar9 = memchr(pbVar7 + uVar16,0,uVar15 - uVar16);
              if ((uVar15 == 0) || (uVar14 = uVar8, pvVar9 != (void *)0x0)) goto LAB_001006f0;
              for (; uVar4 = uVar8, uVar16 = uVar15, uVar14 < uVar13; uVar14 = uVar14 + 1) {
                bVar2 = param_2[uVar14];
                uVar5 = (uint)bVar2;
                if (bVar2 - 0x41 < 0x1a) {
                  uVar5 = bVar2 + 0x20;
                }
                bVar2 = param_1[uVar14 + 1 + lVar17];
                uVar11 = (uint)bVar2;
                if (bVar2 - 0x41 < 0x1a) {
                  uVar11 = bVar2 + 0x20;
                }
              ...
              do {
                if (uVar4 == 0) {
                  pbVar7 = pbVar7 + lVar17;
                  goto LAB_001006f2;
                }
                bVar2 = param_2[uVar4 - 1];
                uVar5 = (uint)bVar2;
                if (bVar2 - 0x41 < 0x1a) {
                  uVar5 = bVar2 + 0x20;
                }
                bVar2 = param_1[uVar4 + lVar17];
                uVar11 = (uint)bVar2;
                if (bVar2 - 0x41 < 0x1a) {
                  uVar11 = bVar2 + 0x20;
                }
...
LAB_001007a8:
          do {
            uVar15 = uVar13 + lVar17;
            pvVar9 = memchr(pbVar7 + uVar16,0,uVar15 - uVar16);
            if ((uVar15 == 0) || (pvVar9 != (void *)0x0)) goto LAB_001006f0;
            uVar14 = uVar8;
            if (uVar8 <= uVar10) {
              uVar14 = uVar10;
            }
            ...
            if (uVar10 < uVar8) {
              do {
                ...
                bVar2 = param_1[uVar15 + lVar17];
                uVar11 = (uint)bVar2;
                if (bVar2 - 0x41 < 0x1a) {
                  uVar11 = bVar2 + 0x20;
                }
              } while ((uVar11 == uVar5) && (uVar15 = uVar14, uVar10 != uVar14));
            }
            if (uVar15 < uVar10 + 1) {
              pbVar7 = pbVar7 + lVar17;
              goto LAB_001006f2;
            ...
            uVar10 = uVar13 - local_58;
          } while( true );
        }
        if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
          pbVar7 = (byte *)two_way_long_needle(pbVar7,uVar16,param_2,uVar13);
          return pbVar7;
        }
        goto LAB_001009f7;
      }

...
{
  mpq_helper_canonicalize(param_1,param_1,param_1 + 0x10);
  return;
}
...
void mpq_cmp_ui(undefined8 param_1,long param_2,long param_3)

{
  ...
  local_34 = (uint)(param_2 != 0);
  local_20 = &local_40;
  local_38 = 0;
  local_28 = _LC4;
  local_48 = param_2;
  local_40 = param_3;
  mpq_cmp(param_1,&local_38);
...
void mpq_cmp_si(undefined8 param_1,long param_2,long param_3)
...
void mpq_div(undefined8 param_1,undefined8 param_2,long param_3)

{
  ...
  local_34 = *(undefined4 *)(param_3 + 0x14);
  local_10 = *(long *)(in_FS_OFFSET + 0x28);
  local_24 = *(undefined4 *)(param_3 + 4);
  local_30 = *(undefined8 *)(param_3 + 0x18);
  local_38 = 0;
  local_28 = 0;
  mpq_mul(param_1,param_2,&local_38);
  if (local_10 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
  }
                    /* WARNING: Subroutine does not return */
...

{
  ...
  if ((lVar3 == 1) || (lVar3 + 0x40U < uVar2)) {
    ...
    dVar5 = (double)mpz_get_d(local_48);
    mpz_clear(local_48);
    if ((uVar2 & 1) == 0) goto LAB_00100c88;
...
size_t mpq_out_str(FILE *param_1)

{
  ...
  sVar1 = 0;
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  __s = (char *)mpq_get_str(0);
  if (__s != (char *)0x0) {
    __n = strlen(__s);
    sVar1 = fwrite(__s,1,__n,param_1);
    mp_get_memory_functions(0,0,&local_38);
    (*local_38)(__s,__n + 1);
  }
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
    return sVar1;

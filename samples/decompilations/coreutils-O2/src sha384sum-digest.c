...

{
  ...
  *param_3 = 0;
  ...
  if (uVar1 == 0) {
    have_read_stdin = 1;
    fadvise(_stdin,2);
    iVar2 = sha384_stream(__stream,param_2);
    if (iVar2 == 0) {
    ...
    fadvise(lVar5,2);
    iVar2 = sha384_stream(lVar5,param_2);
    if (iVar2 == 0) {
...

{
  ...
  __printf_chk(2,uVar4,"SHA384",0x180);
  pFVar1 = _stdout;
  ...
  if (pcVar5 == (char *)0x0) {
    ...
    pcVar6 = " invocation";
    __printf_chk(2,uVar4,"https://www.gnu.org/software/coreutils/","sha384sum");
  }
  else {
    uVar4 = dcgettext(0,"\n%s online help: <%s>\n",5);
    __printf_chk(2,uVar4,"GNU coreutils","https://www.gnu.org/software/coreutils/");
...

{
  ...
  local_108 = (FILE *)CONCAT44(local_108._4_4_,0xffffffff);
  local_ed = 0;
  while( true ) {
    pFVar22 = (FILE *)0x0;
    ...
    if (iVar4 < 0x62) {
      if (iVar4 == -0x83) {
        ...
        version_etc(_stdout,"sha384sum","GNU coreutils",_Version,uVar7,uVar6,uVar13,0);
                    /* WARNING: Subroutine does not return */
        exit(0);
      }
      if (iVar4 == -0x82) {
...
LAB_0010179f:
                ...
                if (local_ed != 0) goto LAB_00101834;
              }
              ...
              print_filename(__stream,local_ec);
            }
            else {
              fwrite_unlocked("SHA384",1,6,_stdout);
...
LAB_00101834:
            ...
            if (pbVar1 < _stdout->_IO_write_end) {
              ...
              *pbVar1 = (byte)local_f8;
            }
            else {
              __overflow(_stdout,(uint)(byte)local_f8);
            }
            do {
              uVar5 = (uint)pFVar11;
              pFVar29 = (FILE *)&pFVar29->_IO_read_ptr;
              puVar15 = (undefined1 *)local_100;
              pFVar28 = pFVar29;
              if (local_100 <= pFVar29) goto LAB_001018b1;
              __stream = *(char **)pFVar29;
              puVar26 = (uint *)((ulong)pFVar11 & 0xffffffff);
LAB_0010175c:
              pFVar11 = (FILE *)digest_file_isra_0(__stream,param_2,local_108);
            } while ((char)pFVar11 == '\0');
            local_ec = 0;
            local_f8 = (FILE *)(ulong)digest_delim;
            pFVar11 = (FILE *)puVar26;
    ...
    case 0x83:
      ...
      break;
    case 0x84:
      local_108 = (FILE *)CONCAT44(local_108._4_4_,1);
      pFVar28 = (FILE *)0x1;
    }
  }
  min_digest_line_length = 0x62;
  digest_hex_bytes = (FILE *)0x60;
  local_a8 = (int)pFVar28;
  if ((int)local_108 == -1) {
    bVar23 = 0;
    if (digest_delim == 10) {
LAB_00101870:
...
joined_r0x0010188a:
    ...
    if ((((ignore_missing != '\x01') ||
      ...
      if (bVar2 == 0) {
        ...
        if (((local_ed ^ 1) & strict) == 0) {
          ...
          if (pFVar29 < puVar15) {
            __stream = *(char **)pFVar29;
            local_e8 = (FILE *)__stream;
            if (local_ed != 0) {
              local_b0 = (long)&local_78 + 7;
              local_a1 = local_ed;
              local_a0 = (FILE *)puVar15;
              goto LAB_0010190b;
            }
            local_108 = (FILE *)&local_80;
            puVar26 = (uint *)(ulong)uVar5;
            param_2 = &local_78;
            pFVar14 = (FILE *)&_LC73;
            local_100 = (FILE *)puVar15;
            local_ed = bVar23;
            goto LAB_0010175c;
          }
          goto LAB_001018b1;
    ...
    if (local_ed == 0) goto LAB_00101870;
  }
LAB_00101890:
...
LAB_001018b1:
  ...
  if (have_read_stdin != '\0') {
    local_108 = (FILE *)CONCAT71(local_108._1_7_,(char)uVar5);
...
LAB_0010201b:
      bVar23 = (byte)pFVar22;
      if ((ignore_missing != '\0') && (local_89 != '\0')) goto LAB_00101caa;
      if (local_c8 == digest_hex_bytes) {
        uVar24 = (ulong)local_c8 >> 1;
        if (uVar24 != 0) {
          uVar16 = 0;
          do {
            ...
            if ((int)(char)bin2hex_0[*(byte *)(local_e0 + uVar16) >> 4] != uVar5) {
LAB_00102180:
            ...
            if ((int)(char)bin2hex_0[*(byte *)(local_e0 + uVar16) & 0xf] != uVar5)
            goto LAB_00102180;
            uVar16 = uVar16 + 1;
          } while (uVar24 != uVar16);
        }
        local_a2 = status_only;
        if ((status_only != 0) || (local_a2 = quiet, quiet != 0)) goto LAB_00101caa;
        local_a2 = bVar23;
        if ((int)puVar27 != 0) goto LAB_001021bd;
        local_f8 = (FILE *)((ulong)pFVar22 & 0xff);
...
LAB_00101cf3:
          if (-1 < iVar4) {
            pFVar14 = (FILE *)quotearg_n_style_colon(0,3,local_e8);
            puVar17 = &_LC4;
            if (iVar4 == 0) goto LAB_00102488;
            goto LAB_0010243d;
          }
          if (bVar23 == 0) {
            pFVar11 = (FILE *)quotearg_n_style_colon(0,3,local_e8);
            ...
            if (status_only == 0) {
              if (local_b8 != (FILE *)0x0) {
                ...
                uVar13 = dcngettext(0,"WARNING: %ju line is improperly formatted",
                                    "WARNING: %ju lines are improperly formatted",local_b8);
                pFVar11 = local_b8;
                error(0,0,uVar13);
              }
              if (local_d0 != (FILE *)0x0) {
                ...
                uVar13 = dcngettext(0,"WARNING: %ju listed file could not be read",
                                    "WARNING: %ju listed files could not be read",local_d0);
                pFVar11 = local_d0;
                error(0,0,uVar13);
              }
              if (local_d8 != (FILE *)0x0) {
                ...
                uVar13 = dcngettext(0,"WARNING: %ju computed checksum did NOT match",
                                    "WARNING: %ju computed checksums did NOT match",local_d8);
                pFVar11 = local_d8;
                error(0,0,uVar13);
              }
...
LAB_00101d4b:
              if (local_d0 == (FILE *)0x0 && local_d8 == (FILE *)0x0) {
                bVar23 = strict ^ 1 | local_b8 == (FILE *)0x0;
                goto LAB_00101d6f;
              }
            }
            else {
LAB_00101d95:
              if (local_a2 != 0) goto LAB_00101d4b;
            }
            bVar23 = 0;
          }
LAB_00101d6f:
...
LAB_0010243d:
        ...
        while( true ) {
          ...
          local_e8 = *(FILE **)pFVar29;
LAB_0010190b:
          local_e0 = local_b0 & 0xfffffffffffffff8;
          local_ec = strcmp((char *)local_e8,"-");
          if (local_ec == 0) break;
          __stream = (char *)fopen_safer(local_e8,&_LC3);
        ...
        have_read_stdin = '\x01';
        local_e8 = (FILE *)dcgettext(0,"standard input",5);
        __stream = (char *)_stdin;
LAB_0010195c:
        pFVar22 = (FILE *)0x0;
        local_a2 = 0;
        puVar26 = (uint *)&local_80;
        local_108 = (FILE *)&local_88;
        local_88 = (FILE *)0x0;
        pFVar28 = (FILE *)0x1;
        local_80 = (char *)0x0;
        bVar23 = 0;
        ...
        local_b8 = (FILE *)0x0;
        pFVar14 = local_108;
        local_100 = (FILE *)puVar26;
        local_c0 = pFVar29;
        while (pFVar11 = (FILE *)__stream,
              _Var8 = __getdelim((char **)local_108,(size_t *)local_100,10,(FILE *)__stream),
              puVar18 = (undefined1 *)local_88, 0 < _Var8) {
          if ((char)local_88->_flags == '#') goto LAB_00101ac0;
          lVar9 = _Var8 - (ulong)(*(char *)((long)local_88 + _Var8 + -1) == '\n');
          pFVar11 = (FILE *)(ulong)(*(char *)((long)local_88 + (lVar9 - (ulong)(0 < lVar9))) == '\r'
                                   );
          puVar27 = (undefined1 *)(lVar9 - (long)pFVar11);
          if ((FILE *)puVar27 == (FILE *)0x0) goto LAB_00101ac0;
          *(char *)((long)local_88 + (long)puVar27) = '\0';
          puVar26 = (uint *)0x0;
          cVar3 = (char)local_88->_flags;
          if ((cVar3 == '\t') || (cVar3 == ' ')) {
            do {
              do {
                puVar26 = (uint *)((long)&((FILE *)puVar26)->_flags + 1);
                cVar3 = *(char *)((long)&((FILE *)puVar26)->_flags + (long)&local_88->_flags);
              } while (cVar3 == ' ');
            } while (cVar3 == '\t');
          }
          local_f8 = (FILE *)0x0;
          if (cVar3 == '\\') {
            puVar26 = (uint *)((long)&((FILE *)puVar26)->_flags + 1);
            local_f8 = (FILE *)(ulong)local_ed;
          }
          pFVar29 = (FILE *)((long)&((FILE *)puVar26)->_flags + (long)&local_88->_flags);
          iVar4 = strncmp((char *)pFVar29,"SHA384",6);
          ...
          if (cVar3 == '(') {
            ...
            if ((FILE *)puVar27 != (FILE *)0x0) {
              ...
              if ((*pcVar25 == ')') &&
                 ((bVar30 = (byte)local_f8 == '\0', bVar30 ||
                  (lVar9 = filename_unescape(pFVar11,pcVar20), local_f8 = pFVar11, lVar9 != 0)))) {
                *pcVar25 = '\0';
...
LAB_00101aa3:
          if (warn != '\0') {
            puVar27 = (undefined1 *)quotearg_n_style_colon(0,3,local_e8);
...
LAB_00101acf:
          ...
          pFVar14 = (FILE *)puVar18;
          if (pFVar28 == (FILE *)0x0) {
            pFVar28 = (FILE *)quotearg_n_style_colon(0,3,local_e8);
...
LAB_0010223a:
                    ...
                    if (((local_ec != 0) || ((char)pFVar11->_flags != '-')) ||
                      ...
                      uVar5 = digest_file_isra_0(pFVar11,local_e0,&local_89);

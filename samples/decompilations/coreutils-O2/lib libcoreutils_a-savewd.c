...
LAB_001005e2:
    if (*(char *)*puVar2 == '/') goto LAB_001005d0;
    if (iVar3 != 0) {
      local_50 = (long)iVar3;
      iVar4 = 0;
      puVar2 = param_2;
      do {
        if (((local_48 != 3) || (local_44 < 1)) &&
           (iVar1 = (*param_3)(*puVar2,&local_48,param_4), iVar4 < iVar1)) {
          iVar4 = iVar1;
        }
        if ((*(char *)puVar2[1] != '/') && (iVar1 = savewd_restore(&local_48,iVar4), iVar4 < iVar1))
        {
          iVar4 = iVar1;
        }
        puVar2 = puVar2 + 1;
      } while (puVar2 != param_2 + local_50);
      savewd_finish(&local_48);
      if (param_1 <= iVar3) goto LAB_001006bb;
      goto LAB_0010067f;
    }
    goto LAB_001006f0;
  }
...
LAB_001006f0:
  ...
  local_50 = 0;
LAB_0010067f:
  puVar2 = param_2 + local_50;
  do {
    iVar1 = (*param_3)(*puVar2,&local_48,param_4);
    if (iVar4 < iVar1) {
      iVar4 = iVar1;
    }
    puVar2 = puVar2 + 1;
  } while (puVar2 != param_2 + (ulong)(uint)(param_1 - iVar3) + local_50);
  goto LAB_001006bb;
}

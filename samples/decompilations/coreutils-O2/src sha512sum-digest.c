...

{
  ...
  *param_3 = 0;
  ...
  if (uVar1 == 0) {
    have_read_stdin = 1;
    fadvise(_stdin,2);
    iVar2 = sha512_stream(__stream,param_2);
    if (iVar2 == 0) {
  ...
  while( true ) {
    ...
    if (iVar4 < 0x62) {
      if (iVar4 == -0x83) {
        ...
        version_etc(_stdout,"sha512sum","GNU coreutils",_Version,uVar7,uVar6,uVar13,0);
                    /* WARNING: Subroutine does not return */
        exit(0);
      }
      if (iVar4 == -0x82) {
...
LAB_0010179f:
                ...
                if (local_fd != 0) goto LAB_00101834;
              }
              ...
              print_filename(__stream,local_fc);
            }
            else {
...
LAB_00101834:
            ...
            if (pbVar1 < _stdout->_IO_write_end) {
              ...
              *pbVar1 = (byte)local_108;
            }
            else {
              __overflow(_stdout,(uint)(byte)local_108);
            }
            do {
              uVar5 = (uint)pFVar11;
              pFVar29 = (FILE *)&pFVar29->_IO_read_ptr;
              puVar15 = (undefined1 *)local_110;
              pFVar28 = pFVar29;
              if (local_110 <= pFVar29) goto LAB_001018b1;
              __stream = *(char **)pFVar29;
              puVar26 = (uint *)((ulong)pFVar11 & 0xffffffff);
LAB_0010175c:
              pFVar11 = (FILE *)digest_file_isra_0(__stream,param_2,local_118);
  ...
  digest_hex_bytes = (FILE *)0x80;
  local_b8 = (int)pFVar28;
  if ((int)local_118 == -1) {
    bVar23 = 0;
    if (digest_delim == 10) {
LAB_00101870:
...
joined_r0x0010188a:
    ...
    if ((((ignore_missing != '\x01') ||
         ...
         local_fd != 0)) &&
        ((status_only != 1 ||
         (pcVar20 = "the --status option is meaningful only when verifying checksums", local_fd != 0
         )))) && ((warn != '\x01' ||
                  (pcVar20 = "the --warn option is meaningful only when verifying checksums",
                  local_fd != 0)))) {
      bVar2 = quiet ^ 1 | local_fd;
      uVar5 = (uint)bVar2;
      if (bVar2 == 0) {
        ...
        if (((local_fd ^ 1) & strict) == 0) {
          ...
          if (pFVar29 < puVar15) {
            __stream = *(char **)pFVar29;
            local_f8 = (FILE *)__stream;
            if (local_fd != 0) {
              local_c0 = (long)&local_88 + 7;
              local_b1 = local_fd;
              local_b0 = (FILE *)puVar15;
              goto LAB_0010190b;
            }
            local_118 = (FILE *)&local_90;
            puVar26 = (uint *)(ulong)uVar5;
            param_2 = &local_88;
            pFVar14 = (FILE *)&_LC73;
            local_110 = (FILE *)puVar15;
            local_fd = bVar23;
            goto LAB_0010175c;
          }
          goto LAB_001018b1;
    ...
    if (local_fd == 0) goto LAB_00101870;
  }
LAB_00101890:
...
LAB_001018b1:
  ...
  if (have_read_stdin != '\0') {
    local_118 = (FILE *)CONCAT71(local_118._1_7_,(char)uVar5);
...
LAB_0010201b:
      bVar23 = (byte)pFVar22;
      if ((ignore_missing != '\0') && (local_99 != '\0')) goto LAB_00101caa;
      if (local_d8 == digest_hex_bytes) {
        uVar24 = (ulong)local_d8 >> 1;
        if (uVar24 != 0) {
          uVar16 = 0;
          do {
            ...
            if ((int)(char)bin2hex_0[*(byte *)(local_f0 + uVar16) >> 4] != uVar5) {
LAB_00102180:
            ...
            if ((int)(char)bin2hex_0[*(byte *)(local_f0 + uVar16) & 0xf] != uVar5)
            goto LAB_00102180;
            uVar16 = uVar16 + 1;
          } while (uVar24 != uVar16);
        }
        local_b2 = status_only;
        if ((status_only != 0) || (local_b2 = quiet, quiet != 0)) goto LAB_00101caa;
        local_b2 = bVar23;
        if ((int)puVar27 != 0) goto LAB_001021bd;
        local_108 = (FILE *)((ulong)pFVar22 & 0xff);
...
LAB_00101cf3:
          if (-1 < iVar4) {
            pFVar14 = (FILE *)quotearg_n_style_colon(0,3,local_f8);
            puVar17 = &_LC4;
            if (iVar4 == 0) goto LAB_00102488;
            goto LAB_0010243d;
          }
          if (bVar23 == 0) {
            pFVar11 = (FILE *)quotearg_n_style_colon(0,3,local_f8);
...
LAB_00101d4b:
              if (local_e0 == (FILE *)0x0 && local_e8 == (FILE *)0x0) {
                bVar23 = strict ^ 1 | local_c8 == (FILE *)0x0;
                goto LAB_00101d6f;
              }
            }
            else {
...
LAB_0010243d:
        ...
        while( true ) {
          ...
          local_f8 = *(FILE **)pFVar29;
LAB_0010190b:
          local_f0 = local_c0 & 0xfffffffffffffff8;
...
LAB_0010195c:
        pFVar22 = (FILE *)0x0;
        local_b2 = 0;
        puVar26 = (uint *)&local_90;
        local_118 = (FILE *)&local_98;
        local_98 = (FILE *)0x0;
        pFVar28 = (FILE *)0x1;
        local_90 = (char *)0x0;
        bVar23 = 0;
        ...
        local_c8 = (FILE *)0x0;
        pFVar14 = local_118;
        local_110 = (FILE *)puVar26;
        local_d0 = pFVar29;
        while (pFVar11 = (FILE *)__stream,
              _Var8 = __getdelim((char **)local_118,(size_t *)local_110,10,(FILE *)__stream),
              puVar18 = (undefined1 *)local_98, 0 < _Var8) {
          if ((char)local_98->_flags == '#') goto LAB_00101ac0;
          lVar9 = _Var8 - (ulong)(*(char *)((long)local_98 + _Var8 + -1) == '\n');
          pFVar11 = (FILE *)(ulong)(*(char *)((long)local_98 + (lVar9 - (ulong)(0 < lVar9))) == '\r'
                                   );
          puVar27 = (undefined1 *)(lVar9 - (long)pFVar11);
          if ((FILE *)puVar27 == (FILE *)0x0) goto LAB_00101ac0;
          *(char *)((long)local_98 + (long)puVar27) = '\0';
          puVar26 = (uint *)0x0;
          cVar3 = (char)local_98->_flags;
          if ((cVar3 == '\t') || (cVar3 == ' ')) {
            do {
              do {
                puVar26 = (uint *)((long)&((FILE *)puVar26)->_flags + 1);
                cVar3 = *(char *)((long)&((FILE *)puVar26)->_flags + (long)&local_98->_flags);
              } while (cVar3 == ' ');
            } while (cVar3 == '\t');
          }
          local_108 = (FILE *)0x0;
          ...
          pFVar29 = (FILE *)((long)&((FILE *)puVar26)->_flags + (long)&local_98->_flags);
          iVar4 = strncmp((char *)pFVar29,"SHA512",6);
          ...
          if (cVar3 == '(') {
            ...
            if ((FILE *)puVar27 != (FILE *)0x0) {
              ...
              if ((*pcVar25 == ')') &&
                 ((bVar30 = (byte)local_108 == '\0', bVar30 ||
                  (lVar9 = filename_unescape(pFVar11,pcVar20), local_108 = pFVar11, lVar9 != 0)))) {
                *pcVar25 = '\0';
...
LAB_00101aa3:
          if (warn != '\0') {
            puVar27 = (undefined1 *)quotearg_n_style_colon(0,3,local_f8);
...
LAB_00101acf:
          ...
          pFVar14 = (FILE *)puVar18;
          if (pFVar28 == (FILE *)0x0) {
            pFVar28 = (FILE *)quotearg_n_style_colon(0,3,local_f8);
...
LAB_0010223a:
                    ...
                    if (((local_fc != 0) || ((char)pFVar11->_flags != '-')) ||
                      ...
                      uVar5 = digest_file_isra_0(pFVar11,local_f0,&local_99);

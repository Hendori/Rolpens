...
{
    int32_t r1 = arg1 * 2 + arg1 * arg1;
    int32_t r12 = arg1 + r1 * r1 + r1;
    int32_t r1_1 = arg1 + r12 * r12 + r12;
    int32_t r12_1 = arg1 + r1_1 * r1_1 + r1_1;
    int32_t r1_2 = arg1 + r12_1 * r12_1 + r12_1;
    int32_t r12_2 = arg1 + r1_2 * r1_2 + r1_2;
    return arg1 + r12_2 * r12_2 + r12_2;
}

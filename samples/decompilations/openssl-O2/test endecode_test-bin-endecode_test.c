...

{
  ...
  iVar1 = strcmp(param_6,"DER");
  pcVar4 = "PEM";
  if (iVar1 != 0) {
    pcVar4 = "DER";
  }
  bp = BIO_new_mem_buf(param_4,param_5);
  iVar1 = test_ptr(param_1,param_2,"encoded_bio = BIO_new_mem_buf(encoded, encoded_len)",bp);
  if (iVar1 == 0) {
    uVar5 = 0;
    ...
    local_60 = (EVP_PKEY *)0x0;
    while( true ) {
      uVar5 = OSSL_DECODER_CTX_new_for_pkey(&local_48,param_6,param_7,param_8,param_9,testctx,0);
      ...
      if (param_10 != (char *)0x0) {
        ...
        iVar2 = OSSL_DECODER_CTX_set_passphrase(uVar5,param_10,sVar6);
        if (iVar2 == 0) {
          uVar3 = 0;
          goto LAB_001002d7;
        }
      }
      uVar7 = BIO_ctrl(bp,1,0,(void *)0x0);
      iVar2 = test_int_gt(param_1,param_2,"BIO_reset(encoded_bio)",&_LC8,uVar7 & 0xffffffff,0);
      if (iVar2 == 0) break;
      uVar3 = OSSL_DECODER_from_bio(uVar5,bp);
      iVar2 = test_int_eq(param_1,param_2,"OSSL_DECODER_from_bio(dctx, encoded_bio)",
                          "(i == 2) ? 0 : 1",uVar3,iVar1 != 2);
      if (iVar2 == 0) break;
      ...
      if (iVar1 == 0) {
        ...
        if (param_9 == 4) {
          uVar3 = EVP_PKEY_parameters_eq(local_60,local_48);
          pcVar8 = "EVP_PKEY_parameters_eq(pkey, testpkey)";
        }
        else {
          uVar3 = EVP_PKEY_eq();
          pcVar8 = "EVP_PKEY_eq(pkey, testpkey)";
        }
        iVar1 = test_int_eq(param_1,param_2,pcVar8,&_LC12,uVar3,1);
        if (iVar1 == 0) {
          uVar3 = 0;
          uVar5 = 0;
          goto LAB_001002d7;
...

{
  ...
  if ((iVar1 == 0) && (iVar1 = param_1[1] - 0x48, iVar1 == 0)) {
    if (param_1[2] == 0) goto LAB_001016e3;
  }
  else if (iVar1 == 0) {
LAB_001016e3:
...
test_encode_decode_constprop_0
          ...
          char *param_6,long param_7,long param_8,code *param_9,code *param_10,code *param_11,
          code *param_12,uint param_13)

{
  ...
  if (iVar1 != 0) {
    if ((param_13 & 2) == 0) {
      iVar1 = (*param_11)("test/endecode_test.c",param_1,param_2);
...
LAB_0010210b:
                if ((param_7 != 0 || param_8 != 0) ||
                   (iVar1 = (*param_10)("test/endecode_test.c",param_1,local_70,local_68,local_50,
                                        local_48), iVar1 != 0)) {
                  uVar3 = 1;
                  pkey = local_58;
                  goto LAB_001021d1;
...
LAB_00102198:
  if ((local_70 != (void *)0x0) && (local_68 != 0)) {
    (*param_12)("|pkey| encoded");
  }
  if ((local_50 != (void *)0x0) && (local_48 != 0)) {
    (*param_12)("|pkey2| encoded");
  }
  uVar3 = 0;
  pkey = local_58;
  pkey_00 = local_60;
...
ulong test_protected_via_PVK(undefined8 param_1,undefined8 param_2)

{
  ...
  lVar2 = OSSL_PROVIDER_load(testctx,"legacy");
  if (lVar2 != 0) {
    uVar1 = test_encode_decode_constprop_0
                      (0x327,param_1,param_2,7,&_LC99,0,"the holy handgrenade of antioch",0,
                       encode_EVP_PKEY_PVK,test_mem,check_PVK,dump_der,0);
    OSSL_PROVIDER_unload(lVar2);
    return (ulong)uVar1;
  }
  uVar3 = test_skip("test/endecode_test.c",0x325,"Legacy provider not available");
  return uVar3;
}



void test_protected_RSA_via_PVK(void)

{
  test_protected_via_PVK(&_LC101,key_RSA);
  return;
}



void test_protected_DSA_via_PVK(void)

{
  test_protected_via_PVK(&_LC44,key_DSA);
  return;
}
...

{
  if ((default_libctx != 0) && (is_fips == 0)) {
    test_encode_decode_constprop_0
              (0x29d,&_LC101,key_RSA,7,&_LC4,"type-specific",0,0,encode_EVP_PKEY_legacy_PEM,
               test_text,check_unprotected_legacy_PEM,0x100000,0);
    return;
  }
...

{
  if ((default_libctx != 0) && (is_fips == 0)) {
    test_encode_decode_constprop_0
              (0x316,&_LC46,key_ECExplicitTriNamedCurve,7,&_LC4,"type-specific",
               "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_legacy_PEM,test_text,
               check_protected_legacy_PEM,0x100000,0);
    return;
  }
...
{
  test_encode_decode_constprop_0
            (0x27a,&_LC46,key_EC,4,&_LC5,"type-specific",0,0,encode_EVP_PKEY_prov,test_mem,
             check_params_DER,dump_der,1);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x283,&_LC46,key_EC,4,&_LC4,"type-specific",0,0,encode_EVP_PKEY_prov,test_text,
             check_params_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2b3,&_LC101,key_RSA,7,"MSBLOB",0,0,0,encode_EVP_PKEY_MSBLOB,test_mem,check_MSBLOB,
             dump_der,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x36c,&_LC101,key_RSA,6,"MSBLOB",0,0,0,encode_EVP_PKEY_MSBLOB,test_mem,
             check_public_MSBLOB,dump_der,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2c8,&_LC101,key_RSA,7,&_LC99,0,0,0,encode_EVP_PKEY_PVK,test_mem,check_PVK,dump_der,0)
  ;
  return;
}
...

{
  test_encode_decode_constprop_0
            (0x231,"SLH-DSA-SHAKE-128f",key_SLH_DSA_SHAKE_128f,0x87,&_LC5,"PrivateKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_mem,check_unprotected_PKCS8_DER,dump_der,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,"SLH-DSA-SHAKE-128s",key_SLH_DSA_SHAKE_128s,0x87,&_LC4,"PrivateKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_text,check_unprotected_PKCS8_PEM,0x100000,0);
  return;
}
...

{
  test_encode_decode_constprop_0
            (0x2e2,"ED25519",key_ED25519,7,&_LC5,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_mem,
             check_protected_PKCS8_DER,dump_der,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,&_LC110,key_SM2,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,2);
  return;
}
...

{
  test_encode_decode_constprop_0
            (0x33f,"SLH-DSA-SHAKE-128s",key_SLH_DSA_SHAKE_128s,0x86,&_LC5,"SubjectPublicKeyInfo",0,0
             ,encode_EVP_PKEY_prov,test_mem,check_public_DER,dump_der,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,"SLH-DSA-SHAKE-128s",key_SLH_DSA_SHAKE_128s,0x86,&_LC4,"SubjectPublicKeyInfo",0,0
             ,encode_EVP_PKEY_prov,test_text,check_public_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2b3,&_LC44,key_DSA,7,"MSBLOB",0,0,0,encode_EVP_PKEY_MSBLOB,test_mem,check_MSBLOB,
             dump_der,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x36c,&_LC44,key_DSA,6,"MSBLOB",0,0,0,encode_EVP_PKEY_MSBLOB,test_mem,
             check_public_MSBLOB,dump_der,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2c8,&_LC44,key_DSA,7,&_LC99,0,0,0,encode_EVP_PKEY_PVK,test_mem,check_PVK,dump_der,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x27a,&_LC44,key_DSA,4,&_LC5,"type-specific",0,0,encode_EVP_PKEY_prov,test_mem,
             check_params_DER,dump_der,1);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x283,&_LC44,key_DSA,4,&_LC4,"type-specific",0,0,encode_EVP_PKEY_prov,test_text,
             check_params_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x27a,&_LC112,key_DH,4,&_LC5,"type-specific",0,0,encode_EVP_PKEY_prov,test_mem,
             check_params_DER,dump_der,1);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x283,&_LC112,key_DH,4,&_LC4,"type-specific",0,0,encode_EVP_PKEY_prov,test_text,
             check_params_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x27a,"X9.42 DH",key_DHX,4,&_LC5,"type-specific",0,0,encode_EVP_PKEY_prov,test_mem,
             check_params_DER,dump_der,1);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x283,"X9.42 DH",key_DHX,4,&_LC4,"type-specific",0,0,encode_EVP_PKEY_prov,test_text,
             check_params_PEM,0x100000,0);
  return;
}
...

{
  if ((default_libctx != 0) && (is_fips == 0)) {
    test_encode_decode_constprop_0
              (0x29d,&_LC44,key_DSA,7,&_LC4,"type-specific",0,0,encode_EVP_PKEY_legacy_PEM,test_text
               ,check_unprotected_legacy_PEM,0x100000,0);
    return;
  }
  test_skip("test/endecode_test.c",0x29b,
            "Test not available if using a non-default library context or FIPS provider");
...

{
  if ((default_libctx != 0) && (is_fips == 0)) {
    test_encode_decode_constprop_0
              (0x29d,&_LC46,key_EC,7,&_LC4,"type-specific",0,0,encode_EVP_PKEY_legacy_PEM,test_text,
               check_unprotected_legacy_PEM,0x100000,0);
    return;
  }
  test_skip("test/endecode_test.c",0x29b,
...

{
  if ((default_libctx != 0) && (is_fips == 0)) {
    test_encode_decode_constprop_0
              (0x29d,&_LC46,key_ECExplicitPrime2G,7,&_LC4,"type-specific",0,0,
               encode_EVP_PKEY_legacy_PEM,test_text,check_unprotected_legacy_PEM,0x100000,0);
    return;
  }
  test_skip("test/endecode_test.c",0x29b,
            "Test not available if using a non-default library context or FIPS provider");
...

{
  if ((default_libctx != 0) && (is_fips == 0)) {
    test_encode_decode_constprop_0
              (0x29d,&_LC46,key_ECExplicitTriNamedCurve,7,&_LC4,"type-specific",0,0,
               encode_EVP_PKEY_legacy_PEM,test_text,check_unprotected_legacy_PEM,0x100000,0);
    return;
  }
  test_skip("test/endecode_test.c",0x29b,
...

{
  if ((default_libctx != 0) && (is_fips == 0)) {
    test_encode_decode_constprop_0
              (0x29d,&_LC46,key_ECExplicitTri2G,7,&_LC4,"type-specific",0,0,
               encode_EVP_PKEY_legacy_PEM,test_text,check_unprotected_legacy_PEM,0x100000,0);
    return;
  }
  test_skip("test/endecode_test.c",0x29b,
...

{
  if ((default_libctx != 0) && (is_fips == 0)) {
    test_encode_decode_constprop_0
              (0x29d,&_LC46,key_ECExplicitPrimeNamedCurve,7,&_LC4,"type-specific",0,0,
               encode_EVP_PKEY_legacy_PEM,test_text,check_unprotected_legacy_PEM,0x100000,0);
    return;
  }
  test_skip("test/endecode_test.c",0x29b,
...

{
  if ((default_libctx != 0) && (is_fips == 0)) {
    test_encode_decode_constprop_0
              (0x316,&_LC46,key_EC,7,&_LC4,"type-specific","the holy handgrenade of antioch",
               "AES-256-CBC",encode_EVP_PKEY_legacy_PEM,test_text,check_protected_legacy_PEM,
               0x100000,0);
    return;
  }
  test_skip("test/endecode_test.c",0x314,
...

{
  if ((default_libctx != 0) && (is_fips == 0)) {
    test_encode_decode_constprop_0
              (0x316,&_LC46,key_ECExplicitPrimeNamedCurve,7,&_LC4,"type-specific",
               "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_legacy_PEM,test_text,
               check_protected_legacy_PEM,0x100000,0);
    return;
  }
...

{
  if ((default_libctx != 0) && (is_fips == 0)) {
    test_encode_decode_constprop_0
              (0x316,&_LC44,key_DSA,7,&_LC4,"type-specific","the holy handgrenade of antioch",
               "AES-256-CBC",encode_EVP_PKEY_legacy_PEM,test_text,check_protected_legacy_PEM,
               0x100000,0);
    return;
  }
...

{
  if ((default_libctx != 0) && (is_fips == 0)) {
    test_encode_decode_constprop_0
              (0x316,&_LC46,key_ECExplicitTri2G,7,&_LC4,"type-specific",
               "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_legacy_PEM,test_text,
               check_protected_legacy_PEM,0x100000,0);
    return;
  }
...

{
  if ((default_libctx != 0) && (is_fips == 0)) {
    test_encode_decode_constprop_0
              (0x316,&_LC46,key_ECExplicitPrime2G,7,&_LC4,"type-specific",
               "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_legacy_PEM,test_text,
               check_protected_legacy_PEM,0x100000,0);
    return;
  }
...

{
  if ((default_libctx != 0) && (is_fips == 0)) {
    test_encode_decode_constprop_0
              (0x316,&_LC101,key_RSA,7,&_LC4,"type-specific","the holy handgrenade of antioch",
               "AES-256-CBC",encode_EVP_PKEY_legacy_PEM,test_text,check_protected_legacy_PEM,
               0x100000,0);
    return;
  }
...

{
  test_encode_decode_constprop_0
            (0x33f,&_LC46,key_ECExplicitTri2G,0x86,&_LC5,"SubjectPublicKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_mem,check_public_DER,dump_der,2);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x231,"X9.42 DH",key_DHX,0x87,&_LC5,"PrivateKeyInfo",0,0,encode_EVP_PKEY_prov,test_mem,
             check_unprotected_PKCS8_DER,dump_der,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,"X9.42 DH",key_DHX,0x87,&_LC4,"PrivateKeyInfo",0,0,encode_EVP_PKEY_prov,test_text
             ,check_unprotected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,&_LC110,key_SM2,0x87,&_LC4,"PrivateKeyInfo",0,0,encode_EVP_PKEY_prov,test_text,
             check_unprotected_PKCS8_PEM,0x100000,2);
  return;
}
...

{
  test_encode_decode_constprop_0
            (0x231,"RSA-PSS",key_RSA_PSS,0x87,&_LC5,"PrivateKeyInfo",0,0,encode_EVP_PKEY_prov,
             test_mem,check_unprotected_PKCS8_DER,dump_der,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,&_LC46,key_ECExplicitTriNamedCurve,0x87,&_LC4,"PrivateKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_text,check_unprotected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,&_LC46,key_ECExplicitPrime2G,0x86,&_LC4,"SubjectPublicKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_text,check_public_PEM,0x100000,2);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,&_LC46,key_ECExplicitTriNamedCurve,0x86,&_LC4,"SubjectPublicKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_text,check_public_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x33f,&_LC110,key_SM2,0x86,&_LC5,"SubjectPublicKeyInfo",0,0,encode_EVP_PKEY_prov,
             test_mem,check_public_DER,dump_der,2);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,&_LC110,key_SM2,0x86,&_LC4,"SubjectPublicKeyInfo",0,0,encode_EVP_PKEY_prov,
             test_text,check_public_PEM,0x100000,2);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,"ED25519",key_ED25519,0x87,&_LC4,"PrivateKeyInfo",0,0,encode_EVP_PKEY_prov,
             test_text,check_unprotected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,"ED25519",key_ED25519,0x86,&_LC4,"SubjectPublicKeyInfo",0,0,encode_EVP_PKEY_prov,
             test_text,check_public_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x231,"ED448",key_ED448,0x87,&_LC5,"PrivateKeyInfo",0,0,encode_EVP_PKEY_prov,test_mem,
             check_unprotected_PKCS8_DER,dump_der,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,"ED448",key_ED448,0x87,&_LC4,"PrivateKeyInfo",0,0,encode_EVP_PKEY_prov,test_text,
             check_unprotected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,"ED448",key_ED448,0x86,&_LC4,"SubjectPublicKeyInfo",0,0,encode_EVP_PKEY_prov,
             test_text,check_public_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x231,"X25519",key_X25519,0x87,&_LC5,"PrivateKeyInfo",0,0,encode_EVP_PKEY_prov,test_mem
             ,check_unprotected_PKCS8_DER,dump_der,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,"X25519",key_X25519,0x87,&_LC4,"PrivateKeyInfo",0,0,encode_EVP_PKEY_prov,
             test_text,check_unprotected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,"X25519",key_X25519,0x86,&_LC4,"SubjectPublicKeyInfo",0,0,encode_EVP_PKEY_prov,
             test_text,check_public_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x231,&_LC116,key_X448,0x87,&_LC5,"PrivateKeyInfo",0,0,encode_EVP_PKEY_prov,test_mem,
             check_unprotected_PKCS8_DER,dump_der,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,&_LC116,key_X448,0x87,&_LC4,"PrivateKeyInfo",0,0,encode_EVP_PKEY_prov,test_text,
             check_unprotected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,&_LC46,key_ECExplicitPrimeNamedCurve,0x86,&_LC4,"SubjectPublicKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_text,check_public_PEM,0x100000,0);
  return;
}
...

{
  test_encode_decode_constprop_0
            (0x231,&_LC46,key_ECExplicitPrime2G,0x87,&_LC5,"PrivateKeyInfo",0,0,encode_EVP_PKEY_prov
             ,test_mem,check_unprotected_PKCS8_DER,dump_der,2);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,&_LC46,key_ECExplicitPrime2G,0x87,&_LC4,"PrivateKeyInfo",0,0,encode_EVP_PKEY_prov
             ,test_text,check_unprotected_PKCS8_PEM,0x100000,2);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,&_LC46,key_ECExplicitTri2G,0x87,&_LC4,"PrivateKeyInfo",0,0,encode_EVP_PKEY_prov,
             test_text,check_unprotected_PKCS8_PEM,0x100000,2);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,&_LC46,key_EC,0x86,&_LC4,"SubjectPublicKeyInfo",0,0,encode_EVP_PKEY_prov,
             test_text,check_public_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x231,&_LC44,key_DSA,0x87,&_LC5,"PrivateKeyInfo",0,0,encode_EVP_PKEY_prov,test_mem,
             check_unprotected_PKCS8_DER,dump_der,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,&_LC44,key_DSA,0x87,&_LC4,"PrivateKeyInfo",0,0,encode_EVP_PKEY_prov,test_text,
             check_unprotected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x231,&_LC110,key_SM2,0x87,&_LC5,"PrivateKeyInfo",0,0,encode_EVP_PKEY_prov,test_mem,
             check_unprotected_PKCS8_DER,dump_der,2);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,&_LC46,key_ECExplicitPrimeNamedCurve,0x87,&_LC4,"PrivateKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_text,check_unprotected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,"X9.42 DH",key_DHX,0x86,&_LC4,"SubjectPublicKeyInfo",0,0,encode_EVP_PKEY_prov,
             test_text,check_public_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x33f,&_LC112,key_DH,0x86,&_LC5,"SubjectPublicKeyInfo",0,0,encode_EVP_PKEY_prov,
             test_mem,check_public_DER,dump_der,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,&_LC112,key_DH,0x86,&_LC4,"SubjectPublicKeyInfo",0,0,encode_EVP_PKEY_prov,
             test_text,check_public_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,&_LC46,key_EC,0x87,&_LC4,"PrivateKeyInfo",0,0,encode_EVP_PKEY_prov,test_text,
             check_unprotected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x33f,&_LC46,key_EC,0x86,&_LC5,"SubjectPublicKeyInfo",0,0,encode_EVP_PKEY_prov,test_mem
             ,check_public_DER,dump_der,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,&_LC44,key_DSA,0x86,&_LC4,"SubjectPublicKeyInfo",0,0,encode_EVP_PKEY_prov,
             test_text,check_public_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,&_LC46,key_ECExplicitTri2G,0x86,&_LC4,"SubjectPublicKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_text,check_public_PEM,0x100000,2);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,&_LC101,key_RSA,0x86,&_LC4,"SubjectPublicKeyInfo",0,0,encode_EVP_PKEY_prov,
             test_text,check_public_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x33f,&_LC101,key_RSA,0x86,&_LC5,"SubjectPublicKeyInfo",0,0,encode_EVP_PKEY_prov,
             test_mem,check_public_DER,dump_der,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,"RSA-PSS",key_RSA_PSS,0x87,&_LC4,"PrivateKeyInfo",0,0,encode_EVP_PKEY_prov,
             test_text,check_unprotected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x231,&_LC112,key_DH,0x87,&_LC5,"PrivateKeyInfo",0,0,encode_EVP_PKEY_prov,test_mem,
             check_unprotected_PKCS8_DER,dump_der,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,&_LC112,key_DH,0x87,&_LC4,"PrivateKeyInfo",0,0,encode_EVP_PKEY_prov,test_text,
             check_unprotected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,"ML-DSA-44",key_ML_DSA_44,0x87,&_LC4,"PrivateKeyInfo",0,0,encode_EVP_PKEY_prov,
             test_text,check_unprotected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x231,&_LC46,key_EC,0x87,&_LC5,"PrivateKeyInfo",0,0,encode_EVP_PKEY_prov,test_mem,
             check_unprotected_PKCS8_DER,dump_der,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,"RSA-PSS",key_RSA_PSS,0x86,&_LC4,"SubjectPublicKeyInfo",0,0,encode_EVP_PKEY_prov,
             test_text,check_public_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,"ML-DSA-44",key_ML_DSA_44,0x86,&_LC4,"SubjectPublicKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_text,check_public_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,"ML-DSA-65",key_ML_DSA_65,0x87,&_LC4,"PrivateKeyInfo",0,0,encode_EVP_PKEY_prov,
             test_text,check_unprotected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,"ML-DSA-65",key_ML_DSA_65,0x86,&_LC4,"SubjectPublicKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_text,check_public_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,"ML-DSA-87",key_ML_DSA_87,0x87,&_LC4,"PrivateKeyInfo",0,0,encode_EVP_PKEY_prov,
             test_text,check_unprotected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,"ML-DSA-87",key_ML_DSA_87,0x86,&_LC4,"SubjectPublicKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_text,check_public_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,"SLH-DSA-SHAKE-128f",key_SLH_DSA_SHAKE_128f,0x87,&_LC4,"PrivateKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_text,check_unprotected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,"SLH-DSA-SHAKE-128f",key_SLH_DSA_SHAKE_128f,0x86,&_LC4,"SubjectPublicKeyInfo",0,0
             ,encode_EVP_PKEY_prov,test_text,check_public_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,"SLH-DSA-SHAKE-192s",key_SLH_DSA_SHAKE_192s,0x87,&_LC4,"PrivateKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_text,check_unprotected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,"SLH-DSA-SHAKE-192s",key_SLH_DSA_SHAKE_192s,0x86,&_LC4,"SubjectPublicKeyInfo",0,0
             ,encode_EVP_PKEY_prov,test_text,check_public_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,"SLH-DSA-SHAKE-192f",key_SLH_DSA_SHAKE_192f,0x87,&_LC4,"PrivateKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_text,check_unprotected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,"SLH-DSA-SHAKE-192f",key_SLH_DSA_SHAKE_192f,0x86,&_LC4,"SubjectPublicKeyInfo",0,0
             ,encode_EVP_PKEY_prov,test_text,check_public_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,"SLH-DSA-SHAKE-256s",key_SLH_DSA_SHAKE_256s,0x87,&_LC4,"PrivateKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_text,check_unprotected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,"SLH-DSA-SHAKE-256s",key_SLH_DSA_SHAKE_256s,0x86,&_LC4,"SubjectPublicKeyInfo",0,0
             ,encode_EVP_PKEY_prov,test_text,check_public_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,"SLH-DSA-SHAKE-256f",key_SLH_DSA_SHAKE_256f,0x87,&_LC4,"PrivateKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_text,check_unprotected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,"SLH-DSA-SHAKE-256f",key_SLH_DSA_SHAKE_256f,0x86,&_LC4,"SubjectPublicKeyInfo",0,0
             ,encode_EVP_PKEY_prov,test_text,check_public_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x231,&_LC101,key_RSA,0x87,&_LC5,"PrivateKeyInfo",0,0,encode_EVP_PKEY_prov,test_mem,
             check_unprotected_PKCS8_DER,dump_der,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,&_LC101,key_RSA,0x87,&_LC4,"PrivateKeyInfo",0,0,encode_EVP_PKEY_prov,test_text,
             check_unprotected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x33f,&_LC116,key_X448,0x86,&_LC5,"SubjectPublicKeyInfo",0,0,encode_EVP_PKEY_prov,
             test_mem,check_public_DER,dump_der,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,&_LC116,key_X448,0x86,&_LC4,"SubjectPublicKeyInfo",0,0,encode_EVP_PKEY_prov,
             test_text,check_public_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,"ML-KEM-512",key_ML_KEM_512,0x87,&_LC4,"PrivateKeyInfo",0,0,encode_EVP_PKEY_prov,
             test_text,check_unprotected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,"ML-KEM-512",key_ML_KEM_512,0x86,&_LC4,"SubjectPublicKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_text,check_public_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,"ML-KEM-768",key_ML_KEM_768,0x87,&_LC4,"PrivateKeyInfo",0,0,encode_EVP_PKEY_prov,
             test_text,check_unprotected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,"ML-KEM-768",key_ML_KEM_768,0x86,&_LC4,"SubjectPublicKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_text,check_public_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,"ML-KEM-1024",key_ML_KEM_1024,0x87,&_LC4,"PrivateKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_text,check_unprotected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,"ML-KEM-1024",key_ML_KEM_1024,0x86,&_LC4,"SubjectPublicKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_text,check_public_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,"SLH-DSA-SHA2-128s",key_SLH_DSA_SHA2_128s,0x87,&_LC4,"PrivateKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_text,check_unprotected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,"SLH-DSA-SHA2-128s",key_SLH_DSA_SHA2_128s,0x86,&_LC4,"SubjectPublicKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_text,check_public_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,"SLH-DSA-SHA2-128f",key_SLH_DSA_SHA2_128f,0x87,&_LC4,"PrivateKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_text,check_unprotected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,"SLH-DSA-SHA2-128f",key_SLH_DSA_SHA2_128f,0x86,&_LC4,"SubjectPublicKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_text,check_public_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,"SLH-DSA-SHA2-192s",key_SLH_DSA_SHA2_192s,0x87,&_LC4,"PrivateKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_text,check_unprotected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,"SLH-DSA-SHA2-192s",key_SLH_DSA_SHA2_192s,0x86,&_LC4,"SubjectPublicKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_text,check_public_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,"SLH-DSA-SHA2-192f",key_SLH_DSA_SHA2_192f,0x87,&_LC4,"PrivateKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_text,check_unprotected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,"SLH-DSA-SHA2-192f",key_SLH_DSA_SHA2_192f,0x86,&_LC4,"SubjectPublicKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_text,check_public_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,"SLH-DSA-SHA2-256s",key_SLH_DSA_SHA2_256s,0x87,&_LC4,"PrivateKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_text,check_unprotected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,"SLH-DSA-SHA2-256s",key_SLH_DSA_SHA2_256s,0x86,&_LC4,"SubjectPublicKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_text,check_public_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x247,"SLH-DSA-SHA2-256f",key_SLH_DSA_SHA2_256f,0x87,&_LC4,"PrivateKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_text,check_unprotected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x355,"SLH-DSA-SHA2-256f",key_SLH_DSA_SHA2_256f,0x86,&_LC4,"SubjectPublicKeyInfo",0,0,
             encode_EVP_PKEY_prov,test_text,check_public_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,"SLH-DSA-SHAKE-128s",key_SLH_DSA_SHAKE_128s,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,"SLH-DSA-SHA2-128f",key_SLH_DSA_SHA2_128f,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,"SLH-DSA-SHA2-128s",key_SLH_DSA_SHA2_128s,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,"ML-KEM-1024",key_ML_KEM_1024,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,"ML-KEM-768",key_ML_KEM_768,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,"SLH-DSA-SHA2-256f",key_SLH_DSA_SHA2_256f,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,"SLH-DSA-SHA2-256s",key_SLH_DSA_SHA2_256s,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,"SLH-DSA-SHA2-192f",key_SLH_DSA_SHA2_192f,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,"SLH-DSA-SHA2-192s",key_SLH_DSA_SHA2_192s,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,"SLH-DSA-SHAKE-192f",key_SLH_DSA_SHAKE_192f,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,"SLH-DSA-SHAKE-192s",key_SLH_DSA_SHAKE_192s,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,"SLH-DSA-SHAKE-128f",key_SLH_DSA_SHAKE_128f,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,"ML-DSA-87",key_ML_DSA_87,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,"ML-KEM-512",key_ML_KEM_512,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2e2,&_LC101,key_RSA,7,&_LC5,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_mem,
             check_protected_PKCS8_DER,dump_der,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,&_LC116,key_X448,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,"SLH-DSA-SHAKE-256f",key_SLH_DSA_SHAKE_256f,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,"SLH-DSA-SHAKE-256s",key_SLH_DSA_SHAKE_256s,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,0);
  return;
}
...

{
  test_encode_decode_constprop_0
            (0x2e2,&_LC46,key_EC,7,&_LC5,"EncryptedPrivateKeyInfo","the holy handgrenade of antioch"
             ,"AES-256-CBC",encode_EVP_PKEY_prov,test_mem,check_protected_PKCS8_DER,dump_der,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,&_LC46,key_EC,7,&_LC4,"EncryptedPrivateKeyInfo","the holy handgrenade of antioch"
             ,"AES-256-CBC",encode_EVP_PKEY_prov,test_text,check_protected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,&_LC44,key_DSA,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,"X9.42 DH",key_DHX,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2e2,&_LC112,key_DH,7,&_LC5,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_mem,
             check_protected_PKCS8_DER,dump_der,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,&_LC112,key_DH,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,"ML-DSA-44",key_ML_DSA_44,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,"ML-DSA-65",key_ML_DSA_65,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,"RSA-PSS",key_RSA_PSS,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,&_LC101,key_RSA,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,&_LC46,key_ECExplicitPrime2G,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,2);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,&_LC46,key_ECExplicitPrimeNamedCurve,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,0);
  return;
}
...

{
  test_encode_decode_constprop_0
            (0x2e2,&_LC46,key_ECExplicitPrime2G,7,&_LC5,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_mem,
             check_protected_PKCS8_DER,dump_der,2);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,"X25519",key_X25519,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2e2,&_LC116,key_X448,7,&_LC5,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_mem,
             check_protected_PKCS8_DER,dump_der,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,"ED448",key_ED448,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,&_LC46,key_ECExplicitTriNamedCurve,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,0);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,&_LC46,key_ECExplicitTri2G,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,2);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2e2,&_LC110,key_SM2,7,&_LC5,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_mem,
             check_protected_PKCS8_DER,dump_der,2);
  return;
}
...
{
  test_encode_decode_constprop_0
            (0x2f9,"ED25519",key_ED25519,7,&_LC4,"EncryptedPrivateKeyInfo",
             "the holy handgrenade of antioch","AES-256-CBC",encode_EVP_PKEY_prov,test_text,
             check_protected_PKCS8_PEM,0x100000,0);
  return;
}
...

{
  ...
  local_b0 = 2;
  local_a0 = __LC135;
  uStack_98 = _UNK_0010f118;
  local_78 = __LC135;
  uStack_70 = _UNK_0010f118;
  local_88 = 2;
  local_68 = 0;
  local_60 = 0;
  local_b8 = "pbits";
...
LAB_00108335:
        ...
        if (is_fips == 0) goto LAB_00108335;
                        ...
                        if (((iVar1 != 0) &&
                          ...
                          if (iVar1 != 0) {
                            ...
                            if (iVar1 != 0) {
                              ...
                              template_DH = make_template(&_LC112,0);
...
LAB_00108685:
                                bVar5 = false;
                                if (is_fips_lt_3_5 != 0) goto LAB_001090a1;
LAB_00108692:
...
LAB_001086be:
                                ...
                                key_DH = make_key_constprop_0(&_LC112,template_DH);
                                iVar1 = test_ptr("test/endecode_test.c",0x5b9,
                                                 "key_DH = make_key(\"DH\", template_DH, NULL)",
                                                 key_DH);
                                if (iVar1 == 0) goto LAB_00108645;
                                ...
                                iVar1 = test_ptr("test/endecode_test.c",0x5c7,
                                                 ...
                                                 ,key_ECExplicitTri2G);
                                if (iVar1 == 0) goto LAB_00108685;
                                key_SM2 = make_key_constprop_0(&_LC110,0);
                                ...
                                if (is_fips_lt_3_5 == 0) {
                                  ...
                                  iVar1 = test_ptr("test/endecode_test.c",0x5d7,
                                                  ...
                                                  ,key_ML_DSA_87);
                                  if (is_fips_lt_3_5 != 0) goto LAB_00109098;
                                  if (iVar1 != 0) {
...
LAB_00108733:
    ...
    if (5 < iVar1) {
      if (5 < iVar1 - 500U) goto LAB_00108731;
      goto LAB_00108270;
    }
    if (iVar1 < 1) goto LAB_00108731;
    switch(iVar1) {
    default:
      goto switchD_001082a1_caseD_1;
    case 2:
      uVar4 = opt_arg();
      goto LAB_00108270;
    case 3:

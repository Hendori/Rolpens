...
LAB_00101098:
    ...
    while (lVar10 != 0) {
      cVar2 = *pcVar8;
      if ((lVar10 - 1U < 2) || (uVar3 = *(ushort *)(pcVar8 + 1), lVar10 - 3U < 2))
      goto LAB_00101098;
      uVar7 = (ulong)(ushort)(*(ushort *)(pcVar8 + 3) << 8 | *(ushort *)(pcVar8 + 3) >> 8);
      if (lVar10 - 5U < uVar7) goto LAB_00101098;
      pcVar1 = pcVar8 + uVar7 + 5;
      lVar10 = (lVar10 - 5U) - uVar7;
      if (cVar2 == '\x16') {
        if (((uVar7 == 0) || (uVar7 - 1 < 3)) ||
           (uVar9 = (ulong)(byte)pcVar8[6] << 0x10 | (ulong)(byte)pcVar8[7] << 8 |
                    (ulong)(byte)pcVar8[8], uVar7 - 4 < uVar9)) goto LAB_00101098;
        if (pcVar8[5] != '\x01') {
          if (pcVar8[5] != '\x02') goto LAB_00101063;
          shseen = shseen + 1;
          if ((0x22 < uVar9) && (__n = (size_t)(byte)pcVar8[0x2b], __n <= uVar9 - 0x23)) {
joined_r0x0010121e:
            if ((chsessidlen != __n) ||
               ((__n != 0 && (iVar5 = memcmp(chsessid,pcVar8 + 0x2c,__n), iVar5 != 0)))) {
              badsessid = 1;
            }
            goto LAB_00101063;
          }
        ...
        chseen = chseen + 1;
        if (uVar9 < 0x23) goto LAB_00101098;
        __n = (size_t)(byte)pcVar8[0x2b];
        if (uVar9 - 0x23 < __n) goto LAB_00101098;
        if (chseen != 1) goto joined_r0x0010121e;
        chsessidlen = __n;
        __memcpy_chk(chsessid,pcVar8 + 0x2c,__n,0x20);
        uVar4 = 0x301;
      }
      else {
        if (cVar2 == '\x14') {
          if (s_to_c_fbio == param_1) {
            ...
            if (shseen == 1) {
              if (ccsaftersh != 0) goto LAB_00101180;
              ccsaftersh = 1;
            }
            else {
              if (shseen != 0 || ccsbeforesh != 0) goto LAB_00101180;
              ccsbeforesh = 1;
            }
          }
          else {
...
LAB_00101063:
      ...
      pcVar8 = pcVar1;
      if (uVar4 != (ushort)(uVar3 << 8 | uVar3 >> 8)) {
        badvers = 1;
      }
    }
    iVar5 = BIO_write(b,param_2,param_3);
    if ((iVar5 < 1) && (iVar6 = BIO_test_flags(b,2), iVar6 != 0)) {

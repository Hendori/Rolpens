...

{
  ...
  if (psVar1 != (stack_st_GENERAL_NAME *)0x0) {
    ppcVar6 = (psVar1->stack).data;
    iVar3 = 0;
    if (ppcVar6 != (char **)0x0) {
      for (; iVar2 = OPENSSL_sk_num(ppcVar6), iVar3 < iVar2; iVar3 = iVar3 + 1) {
        pAVar4 = (ASN1_OBJECT *)OPENSSL_sk_value((psVar1->stack).data,iVar3);
    ...
    if (lVar5 != 0) {
      while( true ) {
        ...
        pAVar4 = (ASN1_OBJECT *)OPENSSL_sk_value(*(undefined8 *)&psVar1->stack,iVar3);
        iVar2 = OBJ_obj2nid(pAVar4);
  ...
  if (((((param_3 & 8) != 0) && (iVar3 = X509_check_purpose(param_2,-1,0), iVar3 == 1)) &&

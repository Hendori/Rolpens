...
LAB_001000a8:
  if (!bVar2) {
    ...
    if (iVar5 != 0) {
      ...
      bVar1 = *pbVar11;
      pbVar12 = pbVar11;
      if (!bVar3) goto joined_r0x0010033f;
      goto LAB_001002ae;
    }
...
LAB_001003cd:
  ...
  if (pcVar8 == (char *)0x0) goto LAB_001003cd;
...
LAB_001002ae:
  uVar6 = *pbVar11 - 0x30;
  if (0x36 < (byte)uVar6) {
    if (*pbVar11 != 0) goto LAB_00100388;
    iVar5 = BN_hex2bn(&local_48,(char *)pbVar12);
    while( true ) {
      if (iVar5 == 0) goto LAB_00100388;
...
joined_r0x0010033f:
      ...
      if (bVar1 != 0) goto LAB_00100388;
      iVar5 = BN_dec2bn(&local_48,(char *)pbVar12);
    }
    goto LAB_001002ae;
  }
  if ((0x7e0000007e03ffU >> ((ulong)uVar6 & 0x3f) & 1) == 0) goto LAB_00100388;
  pbVar11 = pbVar11 + 1;
  goto LAB_001002ae;
LAB_00100388:

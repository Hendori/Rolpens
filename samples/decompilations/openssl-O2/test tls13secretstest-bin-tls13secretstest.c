...
undefined8 ssl_handshake_hash_part_0(undefined8 *param_1,undefined8 *param_2)

{
  ...
  if (full_hash != 0) {
    *param_1 = hs_full_hash._0_8_;
    param_1[1] = uVar1;
    uVar1 = hs_full_hash._24_8_;
    param_1[2] = hs_full_hash._16_8_;
    param_1[3] = uVar1;
    *param_2 = 0x20;
    return 1;
  }
  *param_1 = hs_start_hash._0_8_;
  param_1[1] = uVar2;
  uVar1 = hs_start_hash._24_8_;
  param_1[2] = hs_start_hash._16_8_;
  param_1[3] = uVar1;
  *param_2 = 0x20;
  return 1;
}
...

{
  ...
  pEVar2 = EVP_sha256();
  iVar1 = ssl_handshake_hash_part_0(local_88,&local_f0);
  if (iVar1 == 0) {
    test_error("test/tls13secretstest.c",0xff,"Failed to get hash");
  }
  else {
    iVar1 = tls13_hkdf_expand(param_1,pEVar2,param_2,param_3,param_4);
    if (iVar1 == 0) {
      test_error("test/tls13secretstest.c",0x105,"Secret generation failed");
    }
    else {
      iVar1 = test_mem_eq("test/tls13secretstest.c",0x109,"gensecret","ref_secret",local_c8,local_f0
                          ,param_5);
      if (iVar1 != 0) {
        iVar1 = tls13_derive_key(param_1,pEVar2,local_c8,local_d8,0x10,local_f0);
        if (iVar1 == 0) {
          test_error("test/tls13secretstest.c",0x10d,"Key generation failed");
        }
        else {
          iVar1 = test_mem_eq("test/tls13secretstest.c",0x111,&_LC7,"ref_key",local_d8,0x10,param_6,
                              0x10);
          if (iVar1 != 0) {
            iVar1 = tls13_derive_iv(param_1,pEVar2,local_c8,local_e4,0xc);
            if (iVar1 != 0) {
              iVar1 = test_mem_eq("test/tls13secretstest.c",0x119,&_LC10,"ref_iv",local_e4,0xc,
                                  param_7,0xc);
              bVar3 = iVar1 != 0;
              goto LAB_0010020a;
            }
...

{
  ...
  iVar2 = test_ptr("test/tls13secretstest.c",0x12a,&_LC11,ctx);
  if (iVar2 != 0) {
    ssl = SSL_new(ctx);
    iVar2 = test_ptr("test/tls13secretstest.c",0x12e,&_LC12,ssl);
    if (iVar2 != 0) {
      pSVar6 = (SSL *)0x0;
...

{
  ...
  if (0x1f < param_3) {
    uVar1 = ssl_handshake_hash_part_0(param_2,param_4);
    return uVar1;
  }
  return 0;
}

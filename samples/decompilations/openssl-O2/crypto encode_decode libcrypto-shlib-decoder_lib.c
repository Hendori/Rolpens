...

{
  ...
  if (*(long *)(param_1 + 0x18) != 0) {
    ...
    if (lVar3 != 0) {
      OSSL_DECODER_do_all_provided(param_2,0x100000,lVar3);
...
LAB_00100b47:
      ...
      do {
        if (local_120 < uVar9) {
          do {
            uVar9 = 0;
            uVar4 = OPENSSL_sk_value(*(undefined8 *)(param_1 + 0x18),local_120 & 0xffffffff);
            uVar4 = OSSL_DECODER_INSTANCE_get_input_type(uVar4);
            local_d0._8_4_ = 0;
            local_d0._0_8_ = uVar4;
            if (uVar10 != 0) {
              do {
                while( true ) {
                  lVar5 = OPENSSL_sk_value(lVar3,uVar9 & 0xffffffff);
                  uVar4 = OSSL_DECODER_get0_provider(lVar5);
                  uVar4 = OSSL_PROVIDER_get0_provider_ctx(uVar4);
                  iVar1 = ossl_decoder_fast_is_a(lVar5,local_d0._0_8_,local_d0 + 8);
                  if (iVar1 != 0) break;
joined_r0x00100d9d:
                  uVar9 = uVar9 + 1;
                  if (uVar10 == uVar9) goto LAB_00100c39;
                }
                uVar11 = local_c0._0_8_;
                if ((ulong)local_c0._0_8_ < (ulong)local_b0._8_8_) {
                  do {
                    plVar6 = (long *)OPENSSL_sk_value(*(undefined8 *)(local_d8 + 0x18),
                                                      uVar11 & 0xffffffff);
                    if (*(long *)(lVar5 + 0x18) == *(long *)(*plVar6 + 0x18))
                    goto joined_r0x00100d9d;
                    uVar11 = uVar11 + 1;
                  } while (uVar11 < (ulong)local_b0._8_8_);
                }
                lVar7 = (**(code **)(lVar5 + 0x30))(uVar4);
                if (lVar7 == 0) goto joined_r0x00100d9d;
                if ((*(long *)(lVar5 + 0x50) != 0) && (*(long *)(local_d8 + 8) != 0)) {
                  ...
                  iVar1 = (**(code **)(lVar5 + 0x50))(lVar7,local_98);
                  if (iVar1 != 0) goto LAB_00100d21;
LAB_00100d90:
                  (**(code **)(lVar5 + 0x38))(lVar7);
                  goto joined_r0x00100d9d;
                }
LAB_00100d21:
                lVar8 = ossl_decoder_instance_new(lVar5,lVar7);
                if (lVar8 == 0) goto LAB_00100d90;
                if (local_d0._12_4_ == 0) {
                  uVar4 = OSSL_DECODER_INSTANCE_get_input_type(lVar8);
                  iVar1 = ossl_decoder_fast_is_a(lVar5,uVar4,lVar8 + 0x20);
joined_r0x00100dc9:
                  if (iVar1 != 0) goto LAB_00100d5c;
LAB_00100dcb:
                  ossl_decoder_instance_free(lVar8);
                  goto joined_r0x00100d9d;
                }
...
LAB_00100d5c:
                iVar1 = ossl_decoder_ctx_add_decoder_inst(local_d8,lVar8);
                if (iVar1 == 0) goto LAB_00100dcb;
...
LAB_00100c39:
        ...
        uVar2 = local_d0._12_4_ + 1;
        local_d0._12_4_ = uVar2;
        if (1 < uVar2) goto LAB_00100de5;
        local_120 = local_c0._0_8_;
...
LAB_00100de5:
  ...
  local_c0 = local_b0;
  if ((local_b0._8_8_ == local_b0._0_8_) || (10 < local_110)) goto LAB_00100e1b;
  goto LAB_00100b47;
LAB_00100e1b:
  OPENSSL_sk_pop_free(lVar3,OSSL_DECODER_free);
LAB_00100e2a:
  uVar4 = 1;
LAB_00100e2f:
      ...
      if ((long)iVar3 < 0) {
        ...
        if (lVar6 != 0) {
          ...
          if (uVar11 != 0) {
            do {
              uVar11 = uVar11 - 1;
              lVar7 = OPENSSL_sk_value(plVar1[3],uVar11 & 0xffffffff);
              ...
              if (local_d0 == 0) {
                if ((*plVar1 == 0) || (iVar4 = OPENSSL_strcasecmp(*plVar1,uVar9), iVar4 == 0)) {
LAB_001010f3:
                  if ((local_78 == 0) || (iVar4 = OSSL_DECODER_is_a(lVar8), iVar4 != 0)) {
                    if (local_70 == 0) {
                      if (((*(byte *)(param_2 + 4) & 4) == 0) && (lVar7 = lVar10, plVar1[1] != 0)) {
joined_r0x001012db:
                        if (lVar7 != 0) {
                          *(byte *)(param_2 + 4) = *(byte *)(param_2 + 4) | 4;
                          iVar4 = OPENSSL_strcasecmp(lVar10);
                          if (iVar4 != 0) goto LAB_00101236;
                        }
                      }
                    }
                    else {
                      ...
                      if ((*(byte *)(param_2 + 4) & 4) == 0) {
                        lVar7 = plVar1[1];
                        goto joined_r0x001012db;
                      }
                    }
                    BIO_ctrl(local_b0,0x80,(long)iVar3,(void *)0x0);
  ...
  if (param_2 == (BIO *)0x0) {
    ...
    if (iVar1 != 0) {
      ...
      if ((int)lVar4 < 0) {
        ...
        b = BIO_new(type);
        if (b == (BIO *)0x0) goto LAB_001016e5;
        ...
        if ((local_48 & 2) == 0) goto LAB_00101556;
...
LAB_00101556:
        ...
        if (puVar7 == (undefined *)0x0) {
          ...
          puVar7 = &_LC12;
          local_70 = &_LC12;
          if (puVar8 == (undefined *)0x0) goto LAB_001017a0;

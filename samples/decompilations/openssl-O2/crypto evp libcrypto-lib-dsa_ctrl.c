...
int dsa_paramgen_check(byte *param_1)
...
void EVP_PKEY_CTX_set_dsa_paramgen_gindex(undefined8 param_1,undefined4 param_2)
...
void EVP_PKEY_CTX_set_dsa_paramgen_seed(undefined8 param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  iVar1 = dsa_paramgen_check();
  if (0 < iVar1) {
    OSSL_PARAM_construct_octet_string(&local_b8,&_LC3,param_2,param_3);
    local_68 = local_98;
    local_88 = local_b8;
    uStack_80 = uStack_b0;
    local_78 = local_a8;
    ...
    local_50 = local_a8;
    uStack_48 = uStack_a0;
    EVP_PKEY_CTX_set_params(param_1,&local_88);
  }
...
void EVP_PKEY_CTX_set_dsa_paramgen_bits(undefined8 param_1,int param_2)

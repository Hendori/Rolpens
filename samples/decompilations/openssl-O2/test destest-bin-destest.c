...
void pt(long param_1,long param_2)

{
  ...
  lVar1 = 0;
  do {
    *(char *)(param_2 + lVar1 * 2) = "0123456789ABCDEF"[*(byte *)(param_1 + lVar1) >> 4];
    *(char *)(param_2 + 1 + lVar1 * 2) = "0123456789ABCDEF"[*(byte *)(param_1 + lVar1) & 0xf];
    lVar1 = lVar1 + 1;
  } while (lVar1 != 8);
...

{
  ...
  uVar1 = test_ptr("test/destest.c",0x35c,"cipher = EVP_CIPHER_fetch(NULL, \"DES-EDE-ECB\", NULL)",
                   cipher);
  if (uVar1 == 0) goto LAB_00100098;
...

{
  ...
  test_int_eq("test/destest.c",0x351,"DES_check_key_parity(key)","bad_parity_keys[n].expect",iVar2,
              uVar1);
  return;
}
...

{
  ...
  if (iVar2 == 0) {
    ...
    iVar2 = test_ptr("test/destest.c",0x2dc,"cipher = EVP_CIPHER_fetch(NULL, \"DES3-WRAP\", NULL)",
                     cipher);
    if (iVar2 != 0) {
      ctx = (EVP_CIPHER_CTX *)0x0;
      iVar2 = EVP_CIPHER_get_block_size(cipher);
      uVar3 = test_int_eq("test/destest.c",0x2dd,"bs = EVP_CIPHER_get_block_size(cipher)",&_LC13,
                          iVar2,8);
      if (uVar3 == 0) goto LAB_0010024d;
      ...
      if (iVar4 != 0) {
        ...
        if (iVar4 != 0) {
          ...
          if (iVar4 != 0) {
            ...
            iVar4 = test_true("test/destest.c",0x2ee,"EVP_EncryptInit(ctx, cipher, key, NULL)",
                              iVar4 != 0);
            if (iVar4 != 0) {
              iVar4 = EVP_EncryptUpdate(ctx,local_1d8,&local_278,local_248,iVar5);
              iVar4 = test_true("test/destest.c",0x2ef,
                                "EVP_EncryptUpdate(ctx, c_txt, &clen_upd, in, in_bytes)",iVar4 != 0)
              ;
              if (iVar4 != 0) {
                iVar5 = iVar5 + -1 + iVar2;
                uVar3 = test_int_eq("test/destest.c",0x2f4,"clen_upd","expect",local_278,
                                    (iVar5 - iVar5 % iVar2) + iVar2 * 2);
                if (uVar3 == 0) goto LAB_0010024d;
                local_274 = 200 - local_278;
                iVar5 = EVP_EncryptFinal(ctx,local_1d8 + local_278,&local_274);
                iVar5 = test_true("test/destest.c",0x2f8,
                                  "EVP_EncryptFinal(ctx, c_txt + clen_upd, &clen_fin)",iVar5 != 0);
                if (iVar5 != 0) {
                  iVar4 = test_int_eq("test/destest.c",0x2f9,"clen_fin",&_LC23,local_274,0);
                  iVar2 = local_274;
                  iVar5 = local_278;
                  if (iVar4 != 0) {
                    local_270 = 200;
                    iVar4 = EVP_DecryptInit(ctx,cipher,(uchar *)&local_268,(uchar *)0x0);
                    iVar4 = test_true("test/destest.c",0x2ff,
                                      "EVP_DecryptInit(ctx, cipher, key, NULL)",iVar4 != 0);
                    if (iVar4 != 0) {
                      iVar5 = EVP_DecryptUpdate(ctx,local_108,&local_270,local_1d8,iVar2 + iVar5);
                      iVar5 = test_true("test/destest.c",0x300,
                                        "EVP_DecryptUpdate(ctx, p_txt, &plen_upd, c_txt, clen)",
                                        iVar5 != 0);
                      if (iVar5 != 0) {
                        local_26c = 200 - local_270;
                        iVar5 = EVP_DecryptFinal(ctx,local_108 + local_270,&local_26c);
                        iVar5 = test_true("test/destest.c",0x304,
                                          "EVP_DecryptFinal(ctx, p_txt + plen_upd, &plen_fin)",
                                          iVar5 != 0);
                        if (iVar5 != 0) {
                          iVar5 = test_mem_eq("test/destest.c",0x308,&_LC29,"p_txt",local_248,lVar6,
                                              local_108,(long)(local_26c + local_270));
                          uVar3 = (uint)(iVar5 != 0);
                          goto LAB_0010024d;
                        }
                      }
...

{
  ...
  iVar1 = test_str_eq("test/destest.c",0x1e3,"\"efGnQx2725bI2\"","DES_crypt(\"testing\", \"ef\")",
                      "efGnQx2725bI2",pcVar2);
  if (iVar1 != 0) {
    pcVar2 = DES_crypt("bca76;23","yA");
    iVar1 = test_str_eq("test/destest.c",0x1e5,"\"yA1Rp/1hZXIJk\"","DES_crypt(\"bca76;23\", \"yA\")"
                        ,"yA1Rp/1hZXIJk",pcVar2);
    if (iVar1 != 0) {
      pcVar2 = DES_crypt("testing",&_LC40);
...

{
  ...
  iVar2 = test_uint_eq("test/destest.c",699,&_LC47,"0x70d7a63aL",uVar1,0x70d7a63a);
  if (iVar2 != 0) {
...

{
  ...
  iVar2 = test_uint_eq("test/destest.c",0x2af,&_LC47,"cbc_cksum_ret",uVar1,0xf7fe62b4);
  if (iVar2 != 0) {
    test_mem_eq("test/destest.c",0x2b1,&_LC57,"cbc_cksum_data",&local_28,8,&cbc_cksum_data,8);
  }
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
  }
...

{
  ...
  DES_ede3_cfb64_encrypt
            (plain,cfb_buf1,0xc,&local_c8,&local_c8,&local_c8,(DES_cblock *)&cfb_tmp,&local_cc,1);
  DES_ede3_cfb64_encrypt
            (plain + 0xc,cfb_buf1 + 0xc,0xc,&local_c8,&local_c8,&local_c8,(DES_cblock *)&cfb_tmp,
             &local_cc,1);
  iVar1 = test_mem_eq("test/destest.c",0x25c,"cfb_cipher64","cfb_buf1",cfb_cipher64,0x18,cfb_buf1,
                      0x18);
  if (iVar1 != 0) {
    local_cc = 0;
    cfb_tmp = 0xefcdab9078563412;
    DES_ede3_cfb64_encrypt
              (cfb_buf1,cfb_buf2,0x11,&local_c8,&local_c8,&local_c8,(DES_cblock *)&cfb_tmp,&local_cc
               ,0);
    DES_ede3_cfb64_encrypt
              (cfb_buf1 + 0x11,cfb_buf2 + 0x11,7,&local_c8,&local_c8,&local_c8,
               (DES_cblock *)&cfb_tmp,&local_cc,0);
...
void cfb_test(int param_1,undefined8 param_2)

{
  int iVar1;
  long in_FS_OFFSET;
  DES_key_schedule DStack_c8;
  long local_40;
  
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  DES_set_key_checked((const_DES_cblock *)&cfb_key,&DStack_c8);
  cfb_tmp = 0xefcdab9078563412;
  DES_cfb_encrypt(plain,cfb_buf1,param_1,0x18,&DStack_c8,(DES_cblock *)&cfb_tmp,1);
  iVar1 = test_mem_eq("test/destest.c",0x20d,"cfb_cipher","cfb_buf1",param_2,0x18,cfb_buf1,0x18);
  if (iVar1 != 0) {
    cfb_tmp = 0xefcdab9078563412;
    DES_cfb_encrypt(cfb_buf1,cfb_buf2,param_1,0x18,&DStack_c8,(DES_cblock *)&cfb_tmp,0);
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  iVar1 = cfb_test(0x40,cfb_cipher64);
  if (iVar1 != 0) {
    DES_set_key_checked((const_DES_cblock *)&cfb_key,&local_c8);
    local_cc = 0;
    cfb_tmp = 0xefcdab9078563412;
    ...
    iVar1 = test_mem_eq("test/destest.c",0x238,"cfb_cipher64","cfb_buf1",cfb_cipher64,0x18,cfb_buf1,
                        0x18);
    if (iVar1 != 0) {
      local_cc = 0;
      cfb_tmp = 0xefcdab9078563412;
      DES_cfb64_encrypt(cfb_buf1,cfb_buf2,0x11,&local_c8,(DES_cblock *)&cfb_tmp,&local_cc,0);
      DES_cfb64_encrypt(cfb_buf1 + 0x11,cfb_buf2 + 0x11,7,&local_c8,(DES_cblock *)&cfb_tmp,&local_cc
                        ,0);
      ...
      if (iVar1 != 0) {
        ...
        iVar1 = test_mem_eq("test/destest.c",0x246,"cfb_cipher8","cfb_buf1",cfb_cipher8,0x18,
                            cfb_buf1,0x18);
        if (iVar1 != 0) {
          cfb_tmp = 0xefcdab9078563412;
          puVar3 = cfb_buf2;
          ...
          do {
            puVar4 = puVar5 + 1;
            DES_cfb_encrypt(puVar5,puVar3,8,1,&local_c8,(DES_cblock *)&cfb_tmp,0);
            puVar3 = puVar3 + 1;
            puVar5 = puVar4;
...

{
  ...
  uVar3 = test_int_eq("test/destest.c",0x1db,"DES_set_key_checked(&cbc_key, &ks)",&_LC23,iVar1,0);
  if ((int)uVar3 != 0) {
...

{
  ...
  local_48 = (undefined1  [16])0x0;
  iVar1 = DES_set_key_checked((const_DES_cblock *)&cbc_key,&DStack_e8);
  uVar3 = test_int_eq("test/destest.c",0x1cc,"DES_set_key_checked(&cbc_key, &ks)",&_LC23,iVar1,0);
  if ((int)uVar3 != 0) {
...

{
  ...
  iVar1 = test_int_eq("test/destest.c",0x17c,"DES_set_key_checked(&cbc_key, &ks)",&_LC23,iVar1,0);
  if (iVar1 != 0) {
...

{
  ...
  if (iVar1 != 0) {
    ...
    DES_ede3_ofb64_encrypt
              (ofb_buf1,ofb_buf2,0x18,&local_c8,&local_c8,&local_c8,(DES_cblock *)&ofb_tmp,&local_cc
              );
...

{
  ...
  iVar1 = test_int_eq("test/destest.c",0x1f8,"DES_set_key_checked(&cbc_key, &ks)",&_LC23,iVar1,0);
  if (iVar1 != 0) {
...

{
  ...
  sVar2 = strlen(cbc_data);
  iVar1 = DES_set_key_checked((const_DES_cblock *)&cbc_key,&local_128);
  iVar1 = test_int_eq("test/destest.c",0x194,"DES_set_key_checked(&cbc_key, &ks)",&_LC23,iVar1,0);
  if (iVar1 != 0) {
    length = sVar2 + 1;
    local_48 = 0;
    local_68 = (undefined1  [16])0x0;
    ...
    local_88 = (undefined1  [16])0x0;
    local_78 = 0;
    DES_xcbc_encrypt((uchar *)cbc_data,local_68,length,&local_128,&local_a0,
                     (const_DES_cblock *)&cbc2_key,(const_DES_cblock *)&cbc3_key,1);
    ...
    if (iVar1 != 0) {
      ...
      local_a0[6] = cbc_iv[6];
      local_a0[7] = cbc_iv[7];
      DES_xcbc_encrypt(local_68,local_98,length,&local_128,&local_a0,(const_DES_cblock *)&cbc2_key,
                       (const_DES_cblock *)&cbc3_key,0);
      uVar3 = test_mem_eq("test/destest.c",0x1a0,"cbc_data","cbc_data",cbc_data,length,cbc_data,
                          length);
      goto LAB_00101acc;
    }
  }
...

{
  ...
  iVar2 = test_mem_eq("test/destest.c",0x167,&_LC75,"cipher_ecb2[i]",&local_88,8,cipher_ecb2 + lVar1
                      ,8);
  if (iVar2 == 0) {
    pt(&local_90,local_58);
    uVar3 = pt(key,local_78);
    test_info("test/destest.c",0x168,"Encryption error %2d k=%s p=%s",param_1 + 1,uVar3);
    uVar3 = 0;
  }
  else {
    uVar4 = 8;
    iVar2 = test_mem_eq("test/destest.c",0x16c,&_LC29,"outin",&local_90,8,&local_80);
    uVar3 = 1;
    if (iVar2 == 0) {
      pt(&local_88,local_58,0,uVar4);
      uVar3 = pt(key,local_78);
      test_info("test/destest.c",0x16d,"Decryption error %2d k=%s p=%s ",param_1 + 1,uVar3);
      uVar3 = 0;
    }
  }
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
...

{
  ...
  iVar1 = test_int_eq("test/destest.c",0x1ac,"DES_set_key_checked(&cbc_key, &ks)",&_LC23,iVar1,0);
  if (iVar1 != 0) {
    iVar1 = DES_set_key_checked((const_DES_cblock *)&cbc2_key,&local_1a8);
    iVar1 = test_int_eq("test/destest.c",0x1ae,"DES_set_key_checked(&cbc2_key, &ks2)",&_LC23,iVar1,0
                       );
    if (iVar1 != 0) {
      iVar1 = DES_set_key_checked((const_DES_cblock *)&cbc3_key,&local_128);
      iVar1 = test_int_eq("test/destest.c",0x1b0,"DES_set_key_checked(&cbc3_key, &ks3)",&_LC23,iVar1
                          ,0);
      if (iVar1 != 0) {
        local_a0[0] = cbc_iv[0];
        local_a0[1] = cbc_iv[1];
        ...
        DES_ede3_cbc_encrypt
                  ((uchar *)cbc_data,local_68,0x10,&local_228,&local_1a8,&local_128,&local_a0,1);
        DES_ede3_cbc_encrypt
                  ((uchar *)(cbc_data + 0x10),local_58,sVar2 - 0xf,&local_228,&local_1a8,&local_128,
                   &local_a0,1);
        ...
        if (iVar1 != 0) {
          ...
          local_a0[7] = cbc_iv[7];
          DES_ede3_cbc_encrypt
                    (local_68,local_98,length,&local_228,&local_1a8,&local_128,&local_a0,0);
          uVar3 = test_mem_eq("test/destest.c",0x1c0,"cbc_in","cbc_data",local_98,length,cbc_data,
                              length);
          goto LAB_00101edf;
        }
      }
...

{
  ...
  iVar2 = test_mem_eq("test/destest.c",0x14b,&_LC75,"cipher_data[i]",&local_88,8,cipher_data + lVar1
                      ,8);
  if (iVar2 == 0) {
    pt(&local_90,local_58);
    uVar3 = pt(key,local_78);
    test_info("test/destest.c",0x14c,"Encryption error %2d k=%s p=%s",param_1 + 1,uVar3);
    uVar3 = 0;
  }
  else {
    uVar4 = 8;
    iVar2 = test_mem_eq("test/destest.c",0x150,&_LC29,"outin",&local_90,8,&local_80);
    uVar3 = 1;
    if (iVar2 == 0) {
      pt(&local_88,local_58,0,uVar4);
      uVar3 = pt(key,local_78);
      test_info("test/destest.c",0x151,"Decryption error %2d k=%s p=%s",param_1 + 1,uVar3);
      uVar3 = 0;
    }
  }
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
...

{
  ...
  add_test("test_des_two_key",test_des_two_key);
  return 1;
}

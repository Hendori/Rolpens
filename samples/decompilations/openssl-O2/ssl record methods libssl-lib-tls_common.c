...
bool tls_allow_compression(long param_1)

{
  ...
  if ((*(byte *)(param_1 + 0x52) & 2) == 0) {
    ...
    if (*(code **)(param_1 + 0x1130) != (code *)0x0) {
      iVar2 = (**(code **)(param_1 + 0x1130))(*(undefined8 *)(param_1 + 0x1118),0xf,0,0,0);
      return iVar2 != 0;
    }
  }
  return bVar1;
...
{
                    /* WARNING: Could not recover jumptable at 0x0010011b. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  ...
  if (*(int *)(param_1 + 0x20) == 3) {
    ...
    if (lVar2 != 0) {
      ...
      if (iVar1 == 0) {
        ...
        uVar3 = 0x4da;
LAB_001002f9:
        ERR_set_debug("ssl/record/methods/tls_common.c",uVar3,"tls_set_options");
...

{
  ...
  if (*(ulong *)(param_1 + 0x690) < uVar2) {
    if ((uVar2 != 1) || (*(ulong *)(param_1 + 0x690) != 0)) {
      return 0;
    }
  ...
  else if (uVar2 == 0) goto LAB_00100558;
...
LAB_0010065c:
  *(undefined8 *)((long)param_1 + 0x698) = 0;
...

{
  ...
  if (param_1 == 0) {
    ...
    uVar1 = 1;
    if (*(long *)(param_1 + 0x6c0) != 0) {
      uVar1 = BIO_write_ex(*(undefined8 *)(param_1 + 0x48),
                           *(long *)(param_1 + 0x6b8) + *(long *)(param_1 + 0x6a0),
                           *(long *)(param_1 + 0x6c0),auStack_28);
    }
...
void ossl_rlayer_fatal(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...
undefined8
tls_read_record(long param_1,long *param_2,undefined4 *param_3,undefined1 *param_4,long *param_5,
               undefined8 *param_6,undefined2 *param_7,undefined8 *param_8)
  ...
  if ((param_2 == param_1 + 0x6d0 + uVar2 * 0x48) && (uVar2 < *(ulong *)(param_1 + 0xfd8))) {
    ...
    if (param_3 <= uVar3) {
      ...
      *(ulong *)(lVar4 + 0x6d8) = uVar3 - param_3;
      if ((((uVar3 - param_3 == 0) &&
           (lVar4 = *(long *)(param_1 + 0xfe0) + 1, *(long *)(param_1 + 0xfe0) = lVar4,
           lVar4 == *(long *)(param_1 + 0xfd8))) && ((*(byte *)(param_1 + 0x58) & 0x10) != 0)) &&
         (*(long *)(param_1 + 0x6c0) == 0)) {
        if ((*(byte *)(param_1 + 0x50) & 2) != 0) {
          OPENSSL_cleanse(*(void **)(param_1 + 0x6a0),*(size_t *)(param_1 + 0x6b0));
        }
        CRYPTO_free(*(void **)(param_1 + 0x6a0));
...
LAB_00100cd4:
        ...
        *(long *)(param_1 + 0x690) = lVar7;
        ...
        if (lVar9 != 0) {
          puVar10 = (undefined8 *)((lVar12 * 3 + 6) * 0x10 + param_1);
          do {
            lVar9 = lVar9 + -1;
            if (*(int *)(puVar10 + 5) == 0) {
              CRYPTO_free((void *)*puVar10);
            }
            else {
      ...
      iVar4 = BIO_write(b,(void *)(*(long *)(lVar7 + 0x78) + *(long *)(lVar7 + 0x60)),
                        *(int *)(lVar7 + 0x80));
      if (iVar4 < 0) {
...
LAB_00100cd2:
      ...
      if (iVar4 == 0) {
        ...
        else if (lVar7 != 0) goto LAB_00100cd2;
      }
      else {
        plVar1 = (long *)(param_1 + 0x78 + lVar12);
        lVar9 = plVar1[1];
        lVar7 = (long)iVar4;
        uVar8 = *(ulong *)(param_1 + 0x690);
        if (lVar7 != lVar9) {
          plVar2 = (long *)(param_1 + 0x78 + lVar12);
          *plVar2 = *plVar1 + lVar7;
          plVar2[1] = lVar9 - lVar7;
          uVar11 = uVar8;
          goto LAB_00100be1;
        }
      }
    ...
    if ((uVar11 == uVar8) && ((*(byte *)(param_1 + 0x58) & 0x10) != 0)) {
      if (uVar8 != 0) {
        puVar10 = (undefined8 *)((lVar7 * 3 + 6) * 0x10 + param_1);
        do {
          uVar8 = uVar8 - 1;
          if (*(int *)(puVar10 + 5) == 0) {
            CRYPTO_free((void *)*puVar10);
...

{
  ...
  if ((*(ulong *)(param_1 + 0x690) < *(ulong *)(param_1 + 0x698)) &&
     (*(long *)(param_1 + 0x80 + *(ulong *)(param_1 + 0x690) * 0x30) != 0)) {
    ERR_new();
...
ulong tls_increment_sequence_ctr(long param_1)

{
  ...
  do {
    ...
    cVar2 = *(char *)(param_1 + 0xfff + uVar1) + '\x01';
    *(char *)(param_1 + 0xfff + uVar1) = cVar2;
    uVar3 = uVar1 - 1;
  } while (cVar2 == '\0');
...
undefined8 rlayer_early_data_count_ok_constprop_0(long param_1,long param_2,int param_3)

{
  ...
  if (*(int *)(param_1 + 0x1050) == 0) {
    ...
    uVar1 = param_2 + *(long *)(param_1 + 0x1058);
    if (uVar1 <= (uint)(*(int *)(param_1 + 0x1050) + param_3)) {
      *(ulong *)(param_1 + 0x1058) = uVar1;
      return 1;
    }
    ERR_new();
    uVar2 = 0x200;
  }
  ERR_set_debug("ssl/record/methods/tls_common.c",uVar2,"rlayer_early_data_count_ok");
...
bool ossl_set_tls_provider_parameters
...

{
  ...
  if ((((uVar2 & 0x200000) == 0) && (*(int *)(param_1 + 0x10b0) == 0)) &&
     (iVar1 = EVP_MD_get_size(param_4), 0 < iVar1)) {
    local_a0 = (long)iVar1;
  }
...

{
  ...
  if ((param_3 == 0) || ((1 < param_2 && (param_4 == 0)))) {
    uVar3 = -(ulong)(*(int *)(param_1 + 0x10) == 0) & 0xfffffffffffffff7;
    lVar1 = uVar3 + 0x15 +
            (ulong)*(uint *)(param_1 + 0x104c) + *(long *)(param_1 + 0x1030) +
            (ulong)(*(int *)(param_1 + 0x14) == 0x304);
    iVar2 = tls_allow_compression(param_1);
    lVar5 = lVar1 + 0x450;
    if (iVar2 == 0) {
      lVar5 = lVar1 + 0x50;
    }
    if ((*(byte *)(param_1 + 0x51) & 8) == 0) {
      lVar5 = uVar3 + 0x65 + lVar5;
    }
  }
  else {
    lVar5 = 0;
  ...
  if (param_2 == 0) {
    ...
    do {
      ...
      if (*(long *)pauVar6[1] == param_3) {
        if (ptr == (void *)0x0) goto LAB_001013a0;
      }
      else {
        CRYPTO_free(ptr);
        *(undefined8 *)*pauVar6 = 0;
LAB_001013a0:
        ptr = CRYPTO_malloc((int)param_3,"ssl/record/methods/tls_common.c",0xc4);
        if (ptr == (void *)0x0) {
          if (*(ulong *)(param_1 + 0x698) < uVar3) {
            *(ulong *)(param_1 + 0x698) = uVar3;
          }
          ERR_new();
  ...
  uVar3 = *(ulong *)(param_1 + 0x698);
  if (uVar7 < uVar3) {
    puVar4 = (undefined8 *)((uVar3 * 3 + 3) * 0x10 + param_1);
    do {
      while (uVar3 = uVar3 - 1, *(int *)(puVar4 + 5) == 0) {
        CRYPTO_free((void *)*puVar4);
        *puVar4 = 0;
        puVar4 = puVar4 + -6;
        if (uVar3 <= uVar7) goto LAB_00101484;
      }
...

{
  ...
  lVar5 = (ulong)(*(int *)(param_1 + 0x104c) + 0x140) +
          (-(ulong)(*(int *)(param_1 + 0x10) == 0) & 0xfffffffffffffff8) + 0xd;
  iVar1 = tls_allow_compression();
  uVar2 = lVar5 + 0x407;
  if (iVar1 == 0) {
    uVar2 = lVar5 + 7;
  }
  if (1 < *(ulong *)(param_1 + 0x1140)) {
    uVar2 = uVar2 * *(ulong *)(param_1 + 0x1140);
  }
  uVar4 = *(ulong *)(param_1 + 0x6a8);
  if (*(ulong *)(param_1 + 0x6a8) <= uVar2) {
    uVar4 = uVar2;
  }
  pvVar3 = CRYPTO_malloc((int)uVar4,"ssl/record/methods/tls_common.c",0x105);
  if (pvVar3 == (void *)0x0) {
    ERR_new();
    ...
    *(ulong *)(param_1 + 0x6b0) = uVar4;
    *(void **)(param_1 + 0x6a0) = pvVar3;
  }
...

{
  ...
  else if ((*(ulong *)(param_1 + 0xfd0) <= *(ulong *)(param_1 + 0xfd8)) &&
          (*(long *)(param_1 + 0x6c0) == 0)) {
...
undefined8
tls_default_read_n(long param_1,ulong param_2,ulong param_3,int param_4,int param_5,ulong *param_6)
...
LAB_00101710:
    if (uVar8 < param_2) {
      ...
      if (uVar3 < param_2) {
        ...
        uVar5 = 0x17a;
LAB_00101961:
        ERR_set_debug("ssl/record/methods/tls_common.c",uVar5,"tls_default_read_n");
        ossl_rlayer_fatal(param_1,0x50,0xc0103,0);
        return 0xfffffffe;
      }
      if (param_3 <= param_2) {
      ...
      do {
        ...
        if (b == (BIO *)0x0) {
          b = *(BIO **)(param_1 + 0x40);
          *piVar4 = 0;
          if (b != (BIO *)0x0) goto LAB_00101768;
          ERR_new();
...
LAB_00101768:
        ...
        if (iVar2 < 1) {
          ...
          if (iVar2 == 0) {
            ...
            uVar5 = 0xfffffffd;
            if ((int)lVar6 != 0) goto LAB_001018a2;
            goto LAB_001017f4;
          }
    ...
    lVar6 = 0;
    if (param_2 <= uVar8) goto LAB_00101710;
  }
  param_2 = uVar8;
  *(long *)(param_1 + 0xff8) = *(long *)(param_1 + 0xff8) + param_2;
  *(long *)(param_1 + 0x6b8) = *(long *)(param_1 + 0x6b8) + param_2;
...

{
  ...
  if ((*(long *)(param_1 + 0x6a0) != 0) || (iVar4 = tls_setup_read_buffer(), iVar4 != 0)) {
    ...
    do {
      ...
      if ((*(int *)(param_1 + 0xfe8) == 0xf1) && (4 < *(ulong *)(param_1 + 0xff8))) {
        ...
        if (*puVar11 != 2) goto LAB_00101bcf;
LAB_00101e0e:
        lVar12 = lVar7 + -3;
        if (lVar12 != 0) goto LAB_00101e18;
        *(undefined4 *)(param_1 + 0xfe8) = 0xf0;
        lVar12 = *(long *)(param_1 + 0xff0) + 2;
      }
      else {
        uVar6 = (**(code **)(*(long *)(param_1 + 0x1148) + 0x20))
                          (param_1,5,*(undefined8 *)(param_1 + 0x6b0),0,local_c8 == 0,local_90);
        if ((int)uVar6 < 1) goto LAB_00101dc1;
        ...
        *(undefined4 *)(param_1 + 0xfe8) = 0xf1;
        ...
        if (uVar8 < 3) {
          ...
          uVar6 = 600;
LAB_00101f49:
          ERR_set_debug("ssl/record/methods/tls_common.c",uVar6,"tls_get_more_records");
          ossl_rlayer_fatal(param_1,0x32,0xc0103,0);
          break;
        }
        if ((((*(int *)(param_1 + 0x18) == 1) && (*(int *)(param_1 + 0x10d4) != 0)) &&
            (uVar10 = *puVar3 << 8 | *puVar3 >> 8, (byte)puVar3[1] == 1)) && ((short)uVar10 < 0)) {
...
LAB_00101ed0:
          ...
          uVar10 = *(ushort *)((long)puVar3 + 1);
          uVar15 = uVar10 << 8 | uVar10 >> 8;
          if (uVar8 - 3 < 2) {
          ...
          *puVar11 = (uint)uVar15;
          uVar8 = (ulong)(ushort)(uVar1 << 8 | uVar1 >> 8);
          *(ulong *)(puVar11 + 2) = uVar8;
          if (uVar10 == 0x200) {
            ERR_new();
          ...
          if (*(code **)(param_1 + 0x1128) != (code *)0x0) {
            (**(code **)(param_1 + 0x1128))
                      (0,uVar15,0x100,puVar3,5,*(undefined8 *)(param_1 + 0x1118));
        ...
        if (iVar4 == 0) break;
        lVar7 = *(long *)(puVar11 + 2);
        if (*puVar11 == 2) goto LAB_00101e0e;
LAB_00101bcf:
        lVar12 = lVar7;
        if (lVar7 == 0) {
          *(undefined4 *)(param_1 + 0xfe8) = 0xf0;
          lVar12 = *(long *)(param_1 + 0xff0);
          lVar7 = 0;
        }
        else {
LAB_00101e18:
          uVar6 = (**(code **)(*(long *)(param_1 + 0x1148) + 0x20))
                            (param_1,lVar12,lVar12,1,0,local_90);
          if ((int)uVar6 < 1) goto LAB_00101dc1;
          uVar2 = *puVar11;
          lVar12 = *(long *)(param_1 + 0xff0);
          *(undefined4 *)(param_1 + 0xfe8) = 0xf0;
...
LAB_00101bf2:
      *(long *)(puVar11 + 4) = lVar7;
      local_c8 = local_c8 + 1;
      *(long *)(puVar11 + 8) = lVar12;
      *(long *)(puVar11 + 10) = lVar12;
      *(undefined8 *)(param_1 + 0xff8) = 0;
      *(undefined4 *)(param_1 + 0x10d4) = 0;
      if ((((local_c8 == lVar16) || (puVar11[1] != 0x17)) ||
          ((uVar2 = *(uint *)(param_1 + 0x14), (uVar2 & 0xfffffffd) != 0xfefd && uVar2 != 0x100 &&
           (1 < uVar2 - 0x302)))) || (*(long *)(param_1 + 0x1020) == 0)) goto LAB_00101c97;
      uVar6 = EVP_CIPHER_CTX_get0_cipher();
      uVar8 = EVP_CIPHER_get_flags(uVar6);
      if ((((uVar8 & 0x800000) == 0) || (*(long *)(param_1 + 0x6a0) == 0)) ||
         ((*(ulong *)(param_1 + 0x6c0) < 5 ||
          ((pcVar9 = (char *)(*(long *)(param_1 + 0x6a0) + *(long *)(param_1 + 0x6b8)),
           *pcVar9 != '\x17' ||
           (uVar10 = *(ushort *)(pcVar9 + 3), puVar17 = puVar11 + 0x12,
           *(ulong *)(param_1 + 0x6c0) < (ulong)(ushort)(uVar10 << 8 | uVar10 >> 8) + 5))))))
      goto LAB_00101c97;
    } while( true );
  }
LAB_00101f2b:
...
LAB_00101c97:
  if ((local_c8 != 1) ||
     (((puVar11[1] != 0x14 || (*(int *)(param_1 + 0x14) != 0x304)) ||
      (*(int *)(param_1 + 0x1048) == 0)))) {
...
LAB_00101cf6:
          ...
          do {
            ...
            *(long *)(puVar17 + 2) = lVar12;
            ...
            if ((iVar4 == 0) ||
               (iVar4 = CRYPTO_memcmp(local_88,(void *)(lVar12 + lVar7),len), iVar4 != 0)) {
              ERR_new();
          ...
          } while (puVar13 + local_c8 * 0x12 != puVar17);
        }
        goto LAB_00102020;
      }
      ...
      goto LAB_00101cf6;
      local_b8 = (undefined8 *)
                 CRYPTO_zalloc(local_c8 * 0x10,"ssl/record/methods/tls_common.c",0x32f);
    ...
    if (iVar4 == 0) {
      if (*(int *)(param_1 + 0x1008) == -1) {
        if (((local_c8 == 1) && (*(code **)(param_1 + 0x1120) != (code *)0x0)) &&
           (iVar4 = (**(code **)(param_1 + 0x1120))(*(undefined8 *)(param_1 + 0x1118)), iVar4 != 0))
        {
          ERR_pop_to_mark();
          iVar4 = rlayer_early_data_count_ok_constprop_0
                            (param_1,*(undefined8 *)(param_1 + 0x6d8),0x68);
          if (iVar4 != 0) {
...
LAB_001020b8:
      ...
      ERR_clear_last_mark();
      if (((*(long *)(param_1 + 0x1020) != 0) && (*(int *)(param_1 + 0x10b0) == 0)) &&
         (lVar16 = EVP_MD_CTX_get0_md(*(undefined8 *)(param_1 + 0x1038)), lVar16 != 0)) {
        puVar14 = local_b8;
        puVar17 = puVar13;
        do {
          iVar5 = (**(code **)(*(long *)(param_1 + 0x1148) + 0x10))(param_1,puVar17,local_88,0);
          if (((iVar5 == 0) || (puVar14 == (undefined8 *)0x0)) ||
             (((void *)*puVar14 == (void *)0x0 ||
              (iVar5 = CRYPTO_memcmp(local_88,(void *)*puVar14,len), iVar5 != 0)))) {
            iVar4 = 0;
          }
      ...
      do {
        ...
        if (iVar4 == 0) goto LAB_001020b8;
        if ((*(uint *)(param_1 + 0x104c) != 0x4000) &&
           ((ulong)*(uint *)(param_1 + 0x104c) < *(ulong *)(puVar13 + 2))) {
          ERR_new();
      ...
      if (((*(int *)(param_1 + 0x20) == 1) && (*(int *)(param_1 + 0x6d4) == 0x17)) &&
         (iVar4 = rlayer_early_data_count_ok_constprop_0(param_1,*(undefined8 *)(param_1 + 0x6d8),0)
         , iVar4 == 0)) goto LAB_001020b8;
...
LAB_001024c6:
  ...
  if ((*(long *)(puVar11 + 2) == 1) && (**(char **)(puVar11 + 8) == '\x01')) {
    if (*(code **)(param_1 + 0x1128) != (code *)0x0) {
      (**(code **)(param_1 + 0x1128))
                (0,0x304,0x14,*(char **)(puVar11 + 8),1,*(undefined8 *)(param_1 + 0x1118));
    }
...

{
  if (*param_2 == *(int *)(param_1 + 0x14)) {
    if (*(ulong *)(param_2 + 2) <=
        (-(ulong)(*(long *)(param_1 + 0x1040) == 0) & 0xfffffffffffffc00) + 0x4540) {
      return 1;
    }
    ERR_new();
...

{
  ...
  iVar1 = COMP_compress_block(*(COMP_CTX **)(param_1 + 0x1040),*(uchar **)(param_2 + 0x20),
...

{
  ...
  iVar1 = COMP_expand_block(*(COMP_CTX **)(param_1 + 0x1040),out,0x4000,*(uchar **)(param_2 + 0x20),
                            *(int *)(param_2 + 8));
  if (iVar1 < 0) {
    return 0;
  }
...

{
  ...
  if (uVar1 < 3) {
    if (*(code **)(param_1 + 0x1128) != (code *)0x0) {
      (**(code **)(param_1 + 0x1128))
                (0,*(undefined4 *)(param_1 + 0x14),0x101,param_2 + 4,1,
...
tls_int_new_record_layer
          ...
          undefined4 param_5,int param_6,undefined8 param_7,undefined8 param_8,undefined8 param_9,
          undefined8 param_10,long param_11,undefined8 param_12,long param_13,undefined8 *param_14,
          undefined8 param_15,int *param_16,undefined8 param_17,long *param_18)
  ...
  if (puVar3 != (undefined8 *)0x0) {
    ...
    *(ulong *)((long)puVar3 + 0x1c) = CONCAT44(param_6,param_5);
    ...
    if (((iVar2 != 0) && ((param_11 == 0 || (iVar2 = BIO_up_ref(param_11), iVar2 != 0)))) &&
       ((puVar3[7] = param_11, param_13 == 0 || (iVar2 = BIO_up_ref(param_13), iVar2 != 0)))) {
      puVar3[9] = param_13;
      ...
      if (iVar2 != 0) {
        if (((((*(byte *)((long)puVar3 + 0x51) & 8) == 0) && (*(int *)((long)puVar3 + 0x14) < 0x302)
             ) && (iVar2 = EVP_CIPHER_is_a(param_7,&_LC22), iVar2 == 0)) &&
           (iVar2 = EVP_CIPHER_is_a(param_7,&_LC23), iVar2 == 0)) {
          *(undefined4 *)(puVar3 + 0x203) = 1;
        }
      ...
      uVar4 = 0x553;
LAB_00102b38:
      ERR_set_debug("ssl/record/methods/tls_common.c",uVar4,"tls_int_new_record_layer");
      ERR_set_error(0x14,0x13c,0);
    }
LAB_00102b57:
    tls_int_free(puVar3);
    ...
    *(undefined **)(lVar3 + 0x1148) = &tls_1_3_funcs;
    ...
    if (param_3 == 0x300) {
      ...
      *(undefined **)(lVar3 + 0x1148) = &ssl_3_0_funcs;
      ...
      if (2 < param_3 - 0x301U) goto LAB_00103020;
      lVar3 = *in_stack_000000d0;
...
LAB_00103020:
  ...
  uVar1 = (*(code *)*puVar2)(lVar3,param_6,in_stack_00000020,in_stack_00000028,in_stack_00000030,
...
LAB_00102f90:
  tls_int_free(*in_stack_000000d0);
  *in_stack_000000d0 = 0;
...
ulong tls_get_max_records_default
...

{
  ...
  if (*(long *)(param_1 + 0x1020) != 0) {
    ...
    if (((uVar3 & 0x800000) != 0) &&
       (((uVar1 = *(uint *)(param_1 + 0x14), (uVar1 & 0xfffffffd) == 0xfefd || uVar1 == 0x100 ||
         (uVar1 - 0x302 < 2)) && (param_3 != 0)))) {
...
tls_initialise_write_packets_default
          (undefined8 param_1,byte *param_2,long param_3,undefined8 param_4,long param_5,
    ...
    do {
      *(uint *)((long)param_6 + 0x2c) = (uint)*param_2;
      ...
      if (iVar1 == 0) {
        ...
        uVar2 = 0x634;
LAB_00103205:
        ERR_set_debug("ssl/record/methods/tls_common.c",uVar2,"tls_initialise_write_packets_default"
                     );
        ossl_rlayer_fatal(param_1,0x50,0xc0103,0);
        return 0;
      }
  ...
  *param_5 = 0;
  ...
  if ((((iVar2 != 0) &&
     ...
     (((*(long *)(param_1 + 0x1030) == 0 ||
      ...
      ((lVar3 == 0 || (iVar2 = WPACKET_reserve_bytes(param_2,lVar3,param_5), iVar2 != 0)))))) {
    return 1;
  }
  ERR_new();
  ERR_set_debug("ssl/record/methods/tls_common.c",0x657,"tls_prepare_record_header_default");
  ossl_rlayer_fatal(param_1,0x50,0xc0103,0);
  return 0;
}
...
undefined8
tls_prepare_for_encryption_default(long param_1,long param_2,undefined8 param_3,long param_4)
...
LAB_001033ad:
    iVar1 = WPACKET_reserve_bytes(param_3,0x50 - param_2,0);
    if (iVar1 != 0) {
...
tls_post_encryption_processing_default
          (long param_1,long param_2,undefined1 *param_3,undefined8 param_4,undefined4 *param_5)
...
LAB_001035e0:
    ...
    if (((local_50 + 0x50) - param_2 < uVar1) || (uVar1 < local_50)) goto LAB_001035e0;
    if (local_50 < uVar1) {
      iVar2 = WPACKET_allocate_bytes(param_4,uVar1 - local_50,0);
      if (iVar2 == 0) goto LAB_001035e0;
    }
    if ((*(int *)(param_1 + 0x10b0) == 0) || (param_2 == 0)) {
LAB_00103538:
      iVar2 = WPACKET_get_length(param_4,&local_48);
      if (iVar2 != 0) {
        ...
        if (iVar2 != 0) {
          if (*(long *)(param_1 + 0x1128) != 0) {
            ...
            (**(code **)(param_1 + 0x1128))
                      (1,*param_5,0x100,lVar3 - (local_48 + lVar5),lVar5,
                       *(undefined8 *)(param_1 + 0x1118));
            if ((*(int *)(param_1 + 0x14) == 0x304) && (*(long *)(param_1 + 0x1020) != 0)) {
              local_51 = *param_3;
              (**(code **)(param_1 + 0x1128))
                        (1,*param_5,0x101,&local_51,1,*(undefined8 *)(param_1 + 0x1118));
            }
          }
...
LAB_001035f1:
  ERR_set_debug("ssl/record/methods/tls_common.c",uVar4,"tls_post_encryption_processing_default");
  ossl_rlayer_fatal(param_1,0x50,0xc0103,0);
  uVar4 = 0;
LAB_00103615:
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
...
/* WARNING: Removing unreachable block (ram,0x00103802) */
/* WARNING: Removing unreachable block (ram,0x00103808) */

undefined8 tls_write_records_default(long param_1,long param_2,long param_3)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  local_10f8 = 0;
  if ((*(long *)(param_1 + 0x1038) == 0) || (lVar4 = EVP_MD_CTX_get0_md(), lVar4 == 0)) {
    iVar2 = 0;
LAB_00103858:
    iVar3 = (**(code **)(*(long *)(param_1 + 0x1148) + 0x50))(param_1,param_2,param_3,&local_10f8);
    if (iVar3 != 0) {
      puVar13 = local_10c8;
      iVar3 = (**(code **)(*(long *)(param_1 + 0x1148) + 0x58))
                        (param_1,param_2,param_3,local_10e8,puVar13,param_1 + 0x60);
      if (iVar3 != 0) {
        puVar8 = local_988;
        puVar5 = puVar8;
          ...
          do {
            ...
            *puVar5 = (ulong)CONCAT14(uVar1,*(undefined4 *)(puVar11 + 4));
            ...
            if (lVar4 == 0) {
              ...
              if ((iVar3 == 0) || (iVar3 = WPACKET_allocate_bytes(puVar7,puVar5[1],0), iVar3 == 0))
              {
                ERR_new();
        ...
        if (0 < iVar2) {
          ...
          if (param_3 + local_10f8 != 0) {
            do {
              ...
              iVar2 = (**(code **)(*(long *)(param_1 + 0x1148) + 0x80))
                                (param_1,lVar12,puVar7,puVar13,puVar8);
    ...
    if (-1 < iVar2) goto LAB_00103858;
    ERR_new();
    uVar9 = 0x6e4;
LAB_001037c8:
    ERR_set_debug("ssl/record/methods/tls_common.c",uVar9,"tls_write_records_default");
    ossl_rlayer_fatal(param_1,0x50,0xc0103,0);
  }
LAB_001037f0:
  uVar9 = 0;

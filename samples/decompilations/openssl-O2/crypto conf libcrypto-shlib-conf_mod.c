...

{
  ...
  if (cnf != (CONF *)0x0) {
    ...
    uVar16 = flags & 0xffffffffffffffe8;
    if (uVar3 == 0) {
      uVar16 = flags;
    }
    ERR_set_mark();
...
LAB_0010096b:
      ...
      if (pcVar7 == (char *)0x0) {
        if ((uVar16 & 0x20) != 0) goto LAB_0010094c;
        goto LAB_0010096b;
      }
    }
...
LAB_00100900:
        ...
        if (uVar15 == 0) goto LAB_00100900;
LAB_0010064c:
        ptr = (ulong *)CRYPTO_malloc(0x28,"crypto/conf/conf_mod.c",0x1b7);
        if (ptr == (ulong *)0x0) {
LAB_001007d2:
          if ((uVar16 & 4) != 0) goto LAB_001005e0;
          ERR_new();
          ...
          if ((uVar16 & 1) != 0) goto LAB_001005eb;
          goto LAB_00100826;
        }
        *ptr = uVar15;
        ...
        ptr_00 = (void *)ptr[1];
        ptr[2] = (ulong)pcVar10;
        if ((pcVar10 == (char *)0x0) || (ptr_00 == (void *)0x0)) {
LAB_001007a4:
          CRYPTO_free(ptr_00);
          CRYPTO_free((void *)ptr[2]);
          CRYPTO_free(ptr);
        ...
        if (*(code **)(uVar15 + 0x10) != (code *)0x0) {
          ...
          if (pcVar13 == (code *)0x0) goto LAB_001007a0;
LAB_0010079b:
          (*pcVar13)(ptr);
LAB_001007a0:
          ptr_00 = (void *)ptr[1];
        ...
        iVar4 = CRYPTO_THREAD_run_once(&init_module_list_lock,do_init_module_list_lock_ossl_);
        if ((iVar4 == 0) || (do_init_module_list_lock_ossl_ret_ == 0)) goto LAB_001007a0;
        bVar1 = false;
LAB_0010070b:
        ossl_rcu_write_lock(module_list_lock);
...
LAB_00100a67:
          ...
          ERR_set_error(0xe,0x8000f,0);
          pcVar13 = *(code **)(uVar15 + 0x18);
          if ((pcVar13 != (code *)0x0) && (bVar1)) goto LAB_0010079b;
          goto LAB_001007a0;
        }
...

{
  ...
  if (iVar1 != 0) {
    ...
    if (local_48 == 0) {
      ...
      if (-1 < iVar1) {
        do {
          plVar4 = (long *)OPENSSL_sk_value(local_48,iVar1);
          if ((((int)plVar4[4] < 1) && (*plVar4 != 0)) || (all != 0)) {
            OPENSSL_sk_delete(local_48,iVar1);
            OPENSSL_sk_push(uVar3,plVar4);
          }
          bVar5 = iVar1 != 0;
          iVar1 = iVar1 + -1;
        } while (bVar5);
...

{
  ...
  if (param_2 == (char *)0x0) {
    ...
    if (file == (char *)0x0) {
      ...
      if (conf != (CONF *)0x0) goto LAB_00100e6e;
      uVar2 = 0;
    }
LAB_00100f79:
    CRYPTO_free(file);
...
LAB_00100e6e:
      ...
      if (param_2 == (char *)0x0) goto LAB_00100f79;
      goto LAB_00100ea5;
    }
    NCONF_free((CONF *)0x0);
    if (((param_4 & 2) == 0) || (local_3c != 0)) {

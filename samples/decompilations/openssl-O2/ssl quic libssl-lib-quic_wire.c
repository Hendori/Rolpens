...

{
  ...
  if (lVar2 != 0) {
    ...
    if ((((iVar6 != 0) && (iVar6 = WPACKET_quic_write_vlint(param_1,lVar4), iVar6 != 0)) &&
        (iVar6 = WPACKET_quic_write_vlint(param_1,uVar3 / 1000 >> (param_2 & 0x3f)), iVar6 != 0)) &&
       ((iVar6 = WPACKET_quic_write_vlint(param_1,lVar2 + -1), iVar6 != 0 &&
        (iVar6 = WPACKET_quic_write_vlint(param_1,lVar4 - lVar7), iVar6 != 0)))) {
      if (lVar2 != 1) {
        lVar7 = 1;
        do {
          ...
          lVar4 = plVar1[1];
          lVar5 = *plVar1;
          iVar6 = WPACKET_quic_write_vlint
                            (param_1,(*(long *)(*param_3 + -0x10 + lVar7 * 0x10) + -2) - lVar4);
          if (iVar6 == 0) {
            return false;
          }
...

{
  ...
  if (uVar1 < 0x40) {
    ...
    if (uVar1 < 0x4000) {
      ...
      if (0x3fffffff < uVar1) {
        if (uVar2 < 0x40) {
          return (ulong)(~-(uint)(0x3fffffffffffffff < uVar1) & 10);
        }
        if (uVar2 < 0x4000) {
          return (ulong)(~-(uint)(0x3fffffffffffffff < uVar1) & 0xb);
        }
        if (uVar2 < 0x40000000) {
          return (ulong)(~-(uint)(0x3fffffffffffffff < uVar1) & 0xd);
        }
        lVar3 = (ulong)(uVar1 < 0x4000000000000000) << 3;
        bVar4 = 0x3fffffffffffffff < uVar1;
        goto LAB_0010040e;
      }
      if (uVar2 < 0x40) {
        return 6;
...

{
  ...
  if ((iVar1 == 0) ||
     (iVar1 = WPACKET_allocate_bytes(param_1,*(undefined8 *)(param_2 + 8),&local_28), iVar1 == 0)) {
    pvVar2 = (void *)0x0;
  }
  else {
    pvVar2 = local_28;
...

{
  ...
  uVar2 = (ulong)(*(byte *)(param_2 + 4) & 1) * 2 |
          (-(ulong)(param_2[1] == 0) & 0xfffffffffffffffc) + 0xc;
  ...
  if (((iVar1 == 0) || (iVar1 = WPACKET_quic_write_vlint(param_1,*param_2), iVar1 == 0)) ||
     ((param_2[1] != 0 && (iVar1 = WPACKET_quic_write_vlint(param_1), iVar1 == 0)))) {
    bVar3 = false;
  }
  else {
    bVar3 = true;
...
long ossl_quic_wire_get_encoded_frame_len_stream_hdr(ulong *param_1)
...

{
  ...
  if ((iVar1 == 0) ||
     (iVar1 = WPACKET_allocate_bytes(param_1,*(undefined8 *)(param_2 + 0x10),&local_28), iVar1 == 0)
     ) {
    pvVar2 = (void *)0x0;
  }
  else {
...
bool ossl_quic_wire_encode_frame_max_stream_data
...
bool ossl_quic_wire_encode_frame_stream_data_blocked
               (undefined8 param_1,undefined8 param_2,undefined8 param_3)
...
ulong ossl_quic_wire_encode_frame_streams_blocked
...

{
  ...
  if ((((iVar1 != 0) && (iVar1 = WPACKET_quic_write_vlint(param_1,*param_2), iVar1 != 0)) &&
      (iVar1 = WPACKET_quic_write_vlint(param_1,param_2[1]), iVar1 != 0)) &&
     ((iVar1 = WPACKET_put_bytes__(param_1,*(undefined1 *)(param_2 + 2),1), iVar1 != 0 &&
      (iVar1 = WPACKET_memcpy(param_1,(long)param_2 + 0x11,*(undefined1 *)(param_2 + 2)), iVar1 != 0
      )))) {
...

{
  ...
  if ((iVar1 != 0) &&
     (iVar1 = WPACKET_quic_write_vlint(param_1,*(undefined8 *)(param_2 + 8)), iVar1 != 0)) {
    if (((*param_2 & 1) == 0) &&
       (iVar1 = WPACKET_quic_write_vlint(param_1,*(undefined8 *)(param_2 + 0x10)), iVar1 == 0)) {
      return false;
    }
...
void * ossl_quic_wire_encode_transport_param_bytes
...

{
  ...
  if ((iVar1 == 0) || (iVar1 = WPACKET_quic_write_vlint(param_1,param_4), iVar1 == 0)) {
LAB_00100cc0:
    pvVar2 = (void *)0x0;
  }
  else {
...

{
  ...
  if (iVar1 != 0) {
    lVar2 = 1;
    if (((0x3f < param_3) && (lVar2 = 2, 0x3fff < param_3)) && (lVar2 = 4, 0x3fffffff < param_3)) {
  ...
  if (param_1[1] != 0) {
    ...
    if (uVar4 <= (ulong)param_1[1]) {
      ...
      *param_2 = uVar1;
      if (param_3 != (uint *)0x0) {
        uVar2 = 1;
        if (((0x3f < uVar1) && (uVar2 = 2, 0x3fff < uVar1)) && (uVar2 = 4, 0x3fffffff < uVar1)) {
...

{
  ...
  if ((((iVar1 != 0) && ((local_40 & 0xfffffffffffffffe) == 2)) && (uStack_30 != 0)) &&
     (uVar4 = (ulong)(uint)(1 << (*local_38 >> 6)), uVar4 <= uStack_30)) {
    local_38 = local_38 + uVar4;
    uStack_30 = uStack_30 - uVar4;
    if ((uStack_30 != 0) && (uVar4 = (ulong)(uint)(1 << (*local_38 >> 6)), uVar4 <= uStack_30)) {
      local_38 = local_38 + uVar4;
      uStack_30 = uStack_30 - uVar4;
      if ((uStack_30 != 0) && (uVar4 = (ulong)(uint)(1 << (*local_38 >> 6)), uVar4 <= uStack_30)) {
        ...
        if (lVar2 != 0) {
          do {
            if ((uStack_30 == 0) ||
               (uVar4 = (ulong)(uint)(1 << (*local_38 >> 6)), uStack_30 < uVar4)) goto LAB_00100ee0;
            local_38 = local_38 + uVar4;
            uStack_30 = uStack_30 - uVar4;
            if ((uStack_30 == 0) ||
               (uVar4 = (ulong)(uint)(1 << (*local_38 >> 6)), uStack_30 < uVar4)) goto LAB_00100ee0;
...

{
  ...
  iVar5 = ossl_quic_wire_skip_frame_header(param_1,&local_48);
  uVar16 = local_48;
  if ((((iVar5 != 0) && ((local_48 & 0xfffffffffffffffe) == 2)) && (param_1[1] != 0)) &&
     (uVar15 = (ulong)(uint)(1 << (*(byte *)*param_1 >> 6)), uVar15 <= (ulong)param_1[1])) {
    uVar6 = ossl_quic_vlint_decode_unchecked();
    lVar12 = *param_1;
    uVar7 = param_1[1] - uVar15;
    *param_1 = (long)(lVar12 + uVar15);
    param_1[1] = uVar7;
    if ((uVar7 != 0) &&
       (uVar15 = (ulong)(uint)(1 << (*(byte *)(lVar12 + uVar15) >> 6)), uVar15 <= uVar7)) {
      uVar7 = ossl_quic_vlint_decode_unchecked();
      lVar12 = *param_1;
      uVar13 = param_1[1] - uVar15;
      *param_1 = (long)(lVar12 + uVar15);
      param_1[1] = uVar13;
      if ((uVar13 != 0) &&
         (uVar15 = (ulong)(uint)(1 << (*(byte *)(lVar12 + uVar15) >> 6)), uVar15 <= uVar13)) {
        uVar13 = ossl_quic_vlint_decode_unchecked();
        lVar12 = *param_1;
        uVar14 = param_1[1] - uVar15;
        *param_1 = (long)(lVar12 + uVar15);
        param_1[1] = uVar14;
        if ((uVar14 != 0) &&
           (uVar15 = (ulong)(uint)(1 << (*(byte *)(lVar12 + uVar15) >> 6)), uVar15 <= uVar14)) {
          uVar14 = ossl_quic_vlint_decode_unchecked();
          *param_1 = *param_1 + uVar15;
          uVar15 = param_1[1] - uVar15;
          param_1[1] = uVar15;
          if (uVar14 <= uVar6) {
            uVar14 = uVar6 - uVar14;
            if (param_3 == (long *)0x0) {
              if (uVar13 != 0) goto LAB_001011ec;
LAB_0010133c:
              if (param_4 != (ulong *)0x0) {
                *param_4 = uVar13 + 1;
              }
              if (uVar16 == 3) goto LAB_00101359;
            }
            else {
              auVar1._8_8_ = 0;
              auVar1._0_8_ = 1L << (param_2 & 0x3f);
              auVar3._8_8_ = 0;
              auVar3._0_8_ = uVar7;
              auVar4 = auVar1 * auVar3;
              if ((auVar4._8_8_ != 0) ||
                 (auVar2._8_8_ = 0, auVar2._0_8_ = auVar4._0_8_, auVar4 = auVar2 * ZEXT816(1000),
                 auVar4._8_8_ != 0)) {
                auVar4._8_8_ = auVar4._8_8_;
                auVar4._0_8_ = 0xffffffffffffffff;
              }
              param_3[2] = auVar4._0_8_;
              if (param_3[1] == 0) {
                uVar6 = 1;
                if (uVar13 != 0) {
LAB_001011ec:
                  ...
                  do {
                    if ((uVar15 == 0) ||
                       (uVar7 = (ulong)(uint)(1 << (*(byte *)*param_1 >> 6)), uVar15 < uVar7))
                    goto LAB_00101072;
                    lVar8 = ossl_quic_vlint_decode_unchecked();
                    lVar12 = *param_1;
                    uVar9 = param_1[1] - uVar7;
                    *param_1 = (long)(lVar12 + uVar7);
                    param_1[1] = uVar9;
                    if ((uVar9 == 0) ||
                       (uVar15 = (ulong)(uint)(1 << (*(byte *)(lVar12 + uVar7) >> 6)),
                       uVar9 < uVar15)) goto LAB_00101072;
                    uVar7 = ossl_quic_vlint_decode_unchecked();
                    *param_1 = *param_1 + uVar15;
                    uVar15 = param_1[1] - uVar15;
                    uVar9 = (uVar14 - 2) - lVar8;
                    param_1[1] = uVar15;
                    if ((uVar14 < lVar8 + 2U) || (uVar9 < uVar7)) goto LAB_00101072;
                    uVar6 = uVar6 + 1;
                    if ((param_3 != (long *)0x0) && (uVar6 < (ulong)param_3[1])) {
                      uVar14 = uVar9 - uVar7;
                      puVar10 = (ulong *)(uVar6 * 0x10 + *param_3);
                      *puVar10 = uVar14;
                      puVar10[1] = uVar9;
                    }
                  } while (uVar6 < uVar13);
                  if (param_3 == (long *)0x0) goto LAB_0010133c;
                  goto LAB_001012f5;
                }
              }
              else {
...
LAB_00101359:
                if ((param_1[1] != 0) &&
                   (uVar16 = (ulong)(uint)(1 << (*(byte *)*param_1 >> 6)),
                   uVar16 <= (ulong)param_1[1])) {
                  lVar12 = ossl_quic_vlint_decode_unchecked();
                  *param_1 = *param_1 + uVar16;
                  param_1[1] = param_1[1] - uVar16;
                  iVar5 = PACKET_get_quic_vlint(param_1,&local_50);
                  if ((iVar5 != 0) && (iVar5 = PACKET_get_quic_vlint(param_1,&local_48), iVar5 != 0)
                     ) {
                    if (param_3 != (long *)0x0) {
        ...
        if (uVar6 <= uVar4) {
          ...
          *param_1 = lVar3;
          ...
          if (lVar1 + uVar4 >> 0x3e == 0) {
            if (param_2 == 0) {
              if (uVar6 < uVar4) goto LAB_0010163c;
              param_3[2] = lVar3;
              *param_1 = lVar3 + uVar4;
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  iVar2 = ossl_quic_wire_skip_frame_header(param_1,&local_48);
  if ((((iVar2 != 0) && ((local_48 & 0xfffffffffffffff8) == 8)) && (param_1[1] != 0)) &&
     (uVar6 = (ulong)(uint)(1 << (*(byte *)*param_1 >> 6)), uVar6 <= (ulong)param_1[1])) {
    uVar3 = ossl_quic_vlint_decode_unchecked();
    lVar1 = *param_1;
    *param_3 = uVar3;
    uVar4 = param_1[1] - uVar6;
    *param_1 = (long)(lVar1 + uVar6);
    ...
    if ((local_48 & 4) == 0) {
      ...
      if ((uVar4 == 0) ||
         (uVar6 = (ulong)(uint)(1 << (*(byte *)(lVar1 + uVar6) >> 6)), uVar4 < uVar6))
      goto LAB_00101828;
      uVar3 = ossl_quic_vlint_decode_unchecked();
      param_3[1] = uVar3;
    ...
    *(byte *)(param_3 + 4) =
         ((byte)local_48 & 1) * '\x02' | (byte)(local_48 >> 1) & 1 | *(byte *)(param_3 + 4) & 0xfc;
    if ((local_48 >> 1 & 1) == 0) {
      if (param_2 == 0) {
        uVar4 = param_1[1];
        param_3[2] = uVar4;
        if (param_3[1] + uVar4 >> 0x3e == 0) {
          lVar5 = *param_1;
          param_3[3] = lVar5;
          uVar6 = uVar4;
LAB_001019bf:
...
LAB_001018eb:
      ...
      *param_1 = lVar5;
      param_1[1] = uVar6;
      if (lVar1 + uVar4 >> 0x3e == 0) {
        if (param_2 != 0) goto LAB_001018e3;
        param_3[3] = lVar5;
        if (uVar4 <= uVar6) goto LAB_001019bf;
      }
    }
  }
LAB_00101828:
...
undefined8
ossl_quic_wire_decode_frame_max_stream_data(long *param_1,undefined8 *param_2,undefined8 *param_3)
...

{
  ...
  if ((((iVar3 != 0) && (local_38 == 0x18)) && (param_1[1] != 0)) &&
     (uVar7 = (ulong)(uint)(1 << (*(byte *)*param_1 >> 6)), uVar7 <= (ulong)param_1[1])) {
    ...
    *param_1 = (long)(lVar11 + uVar7);
    param_1[1] = uVar5;
    if ((uVar5 != 0) &&
       (uVar7 = (ulong)(uint)(1 << (*(byte *)(lVar11 + uVar7) >> 6)), uVar7 <= uVar5)) {
      uVar5 = ossl_quic_vlint_decode_unchecked();
      lVar11 = *param_1;
      param_2[1] = uVar5;
      ...
      *param_1 = (long)pbVar8;
      ...
      if ((uVar5 <= *param_2) && (lVar11 != 0)) {
        ...
        *param_1 = (long)(pbVar8 + 1);
        param_1[1] = lVar11 - 1U;
        if ((bVar1 - 1 < 0x14) && (*(byte *)(param_2 + 2) = bVar1, uVar7 <= lVar11 - 1U)) {
          uVar10 = (uint)bVar1;
          if (uVar10 < 8) {
            if ((bVar1 & 4) == 0) {
          ...
          if (bVar1 != 0x14) {
            ...
            if (uVar10 < 8) {
              ...
              *(undefined8 *)((long)puVar9 + ((ulong)uVar10 - 8)) = 0;
              uVar10 = uVar10 + ((int)puVar9 - (int)((ulong)(puVar9 + 1) & 0xfffffffffffffff8)) &
                       0xfffffff8;
              if (7 < uVar10) {
                uVar7 = 0;
                do {
...

{
  ...
  if (((iVar3 == 0) || (local_28 != 0x1a)) || ((ulong)param_1[1] < 8)) {
    ...
    *param_2 = uVar5;
    uVar5 = (ulong)pbVar2[2] << 0x28 | uVar5;
    *param_2 = uVar5;
    uVar5 = (ulong)pbVar2[3] << 0x20 | uVar5;
    *param_2 = uVar5;
    uVar5 = (ulong)pbVar2[4] << 0x18 | uVar5;
    *param_2 = uVar5;
    uVar5 = (ulong)pbVar2[5] << 0x10 | uVar5;
    *param_2 = uVar5;
    uVar5 = (ulong)pbVar2[6] << 8 | uVar5;
    *param_2 = uVar5;
  ...
  if (((iVar1 != 0) && ((local_38 & 0xfffffffffffffffe) == 0x1c)) && (param_1[1] != 0)) {
    ...
    if (uVar5 <= (ulong)param_1[1]) {
      ...
      *param_2 = *param_2 & 0xfe | (byte)local_38 & 1;
      if ((local_38 & 1) == 0) {
        if (uVar4 != 0) {
          uVar5 = (ulong)(uint)(1 << (*(byte *)(lVar3 + uVar5) >> 6));
          if (uVar5 <= uVar4) {
            uVar2 = ossl_quic_vlint_decode_unchecked();
...

{
  ...
  if (uVar5 <= (ulong)param_1[1]) {
    ...
    *param_1 = (long)(lVar3 + uVar5);
    param_1[1] = uVar2;
    if ((uVar2 != 0) &&
       (uVar5 = (ulong)(uint)(1 << (*(byte *)(lVar3 + uVar5) >> 6)), uVar5 <= uVar2)) {
      uVar2 = ossl_quic_vlint_decode_unchecked();
      uVar4 = param_1[1] - uVar5;
      lVar3 = *param_1 + uVar5;
      param_1[1] = uVar4;
...
bool ossl_quic_wire_decode_transport_param_int
               (undefined8 param_1,undefined8 param_2,undefined8 *param_3)
...
undefined8
ossl_quic_wire_decode_transport_param_cid(undefined8 param_1,undefined8 param_2,undefined1 *param_3)
...

{
  ...
  if (((puVar7 != (undefined4 *)0x0) && (local_38 - 0x29U < 0x15)) && (local_40 == 0xd)) {
    ...
    *(undefined8 *)(param_2 + 8) = uVar5;
    ...
    if (bVar2 < 0x15) {
      uVar13 = (ulong)bVar2;
      if (uVar13 <= local_38 - 0x19U) {
        if (bVar2 < 8) {
          if ((bVar2 & 4) == 0) {
            if ((bVar2 != 0) &&
               (*(undefined1 *)((long)param_2 + 0x29) = *(undefined1 *)((long)puVar7 + 0x19),
               (bVar2 & 2) != 0)) {
              *(undefined2 *)((long)param_2 + uVar13 + 0x27) =
                   *(undefined2 *)((long)puVar7 + uVar13 + 0x17);
            }
          }
          else {
            *(undefined4 *)((long)param_2 + 0x29) = *(undefined4 *)((long)puVar7 + 0x19);
            *(undefined4 *)((long)param_2 + uVar13 + 0x25) =
                 *(undefined4 *)((long)puVar7 + uVar13 + 0x15);
          }
        }
        else {
          uVar11 = (long)param_2 + 0x31U & 0xfffffffffffffff8;
          *(undefined8 *)((long)param_2 + 0x29) = *(undefined8 *)((long)puVar7 + 0x19);
          *(undefined8 *)((long)param_2 + uVar13 + 0x21) =
               *(undefined8 *)((long)puVar7 + uVar13 + 0x11);
          ...
          if (7 < uVar9) {
            ...
            do {
              uVar14 = (ulong)uVar12;
              uVar12 = uVar12 + 8;
              *(undefined8 *)(uVar11 + uVar14) =
                   *(undefined8 *)((long)puVar7 + uVar14 + (0x19 - lVar10));
            } while (uVar12 < uVar9);
          }
        }
        if (0xf < (local_38 - 0x19U) - uVar13) {
          puVar1 = (undefined8 *)((long)puVar7 + uVar13 + 0x19);
          uVar5 = *puVar1;
          uVar6 = puVar1[1];

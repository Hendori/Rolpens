...
undefined8
aes_ocb_init(long param_1,long param_2,long param_3,long param_4,long param_5,undefined8 param_6,
            byte param_7)
...
long aes_ocb_newctx_constprop_0(undefined8 param_1)

{
  ...
  if (iVar1 != 0) {
    ...
    if (lVar2 != 0) {
      uVar3 = ossl_prov_cipher_hw_aes_ocb(param_1);
      ossl_cipher_generic_initkey(lVar2,param_1,0x80,0x60,0x10003,3,uVar3,0);
...
void aes_128_ocb_newctx(void)

{
  aes_ocb_newctx_constprop_0(0x80);
  return;
}



void aes_192_ocb_newctx(void)

{
  aes_ocb_newctx_constprop_0(0xc0);
  return;
}



void aes_256_ocb_newctx(void)

{
  aes_ocb_newctx_constprop_0(0x100);
  return;
}

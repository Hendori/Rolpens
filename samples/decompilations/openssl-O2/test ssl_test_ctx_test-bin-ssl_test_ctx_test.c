...

{
  ...
  if (iVar1 != 0) {
    *ptr = param_1;
    uVar2 = SSL_TEST_CTX_new(0);
    ptr[2] = uVar2;
    iVar1 = test_ptr("test/ssl_test_ctx_test.c",0x75,
                     "fixture->expected_ctx = SSL_TEST_CTX_new(NULL)",uVar2);
    if (iVar1 != 0) {
      return ptr;
    }
    CRYPTO_free(ptr);
...

{
  ...
  uVar1 = 0;
  ptr = (void *)set_up("test_empty_configuration");
  if (ptr != (void *)0x0) {
    *(char **)((long)ptr + 8) = "ssltest_default";
    *(undefined4 *)(*(long *)((long)ptr + 0x10) + 0x1a8) = 0;
    uVar1 = execute_test(ptr);
    SSL_TEST_CTX_free(*(undefined8 *)((long)ptr + 0x10));
    CRYPTO_free(ptr);
  }
  return uVar1;
}
...

{
  ...
  ptr = (void *)set_up("test_good_configuration");
  if (ptr != (void *)0x0) {
    *(char **)((long)ptr + 8) = "ssltest_good";
    uVar3 = _LC68;
    puVar1 = *(undefined8 **)((long)ptr + 0x10);
    ...
    *(undefined4 *)(puVar1 + 0x3b) = 1;
    ...
    puVar1[5] = pcVar6;
    iVar4 = test_ptr("test/ssl_test_ctx_test.c",0xb8,
                     "fixture->expected_ctx->extra.client.npn_protocols",
                     *(undefined8 *)(*(long *)((long)ptr + 0x10) + 0x28));
    if (iVar4 != 0) {
      ...
      *(char **)(lVar2 + 0x178) = pcVar6;
      iVar4 = test_ptr("test/ssl_test_ctx_test.c",0xc2,
                       "fixture->expected_ctx->resume_extra.server2.alpn_protocols",
                       *(undefined8 *)(*(long *)((long)ptr + 0x10) + 0x178));
      if (iVar4 != 0) {
        *(undefined4 *)(*(long *)((long)ptr + 0x10) + 0x100) = 2;
        uVar5 = execute_test(ptr);
        SSL_TEST_CTX_free(*(undefined8 *)((long)ptr + 0x10));
        CRYPTO_free(ptr);
        return uVar5;
      }

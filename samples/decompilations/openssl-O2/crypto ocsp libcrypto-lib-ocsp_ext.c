...
bool ocsp_add1_nonce(stack_st_X509_EXTENSION **param_1,void *param_2,int param_3)

{
  ...
  bVar2 = false;
  local_48[0] = ASN1_object_size(0,param_3,4);
  if (local_48[0] < 0) goto LAB_001000d5;
...
LAB_00100108:
    ...
    local_50 = local_40;
    ASN1_put_object(&local_50,0,param_3,4,0);
    if (param_2 == (void *)0x0) {
      iVar1 = RAND_bytes(local_50,param_3);
      if (iVar1 < 1) goto LAB_00100108;
    }
    else {
      memcpy(local_50,param_2,(long)param_3);
    }
    iVar1 = X509V3_add1_i2d(param_1,0x16e,local_48,0,2);
    bVar2 = 0 < iVar1;
  }
...

{
  ...
  iVar1 = ocsp_add1_nonce(&req[1].optionalSignature);
  return iVar1;
}
...

{
  ...
  iVar1 = ocsp_add1_nonce(&resp[1].signatureAlgorithm);
  return iVar1;
}
    ...
    if (oids != (char **)0x0) {
      for (; *oids != (char *)0x0; oids = oids + 1) {
        ...
        if (((iVar1 != 0) && (pAVar2 = OBJ_nid2obj(iVar1), pAVar2 != (ASN1_OBJECT *)0x0)) &&
           (iVar1 = OPENSSL_sk_push(ext_struc), iVar1 == 0)) goto LAB_001005f8;
      }
    }
    ...
    if (pXVar3 != (X509_NAME *)0x0) {
      if (urls != (char **)0x0) {
        if (*urls != (char *)0x0) {
          ...
          a->locator = psVar4;
          if (psVar4 == (stack_st_ACCESS_DESCRIPTION *)0x0) goto LAB_001006f0;
        }
        for (; *urls != (char *)0x0; urls = urls + 1) {
          a_00 = ACCESS_DESCRIPTION_new();
          if (a_00 == (ACCESS_DESCRIPTION *)0x0) goto LAB_001006f0;
...
LAB_001007b2:
          ...
          str = ASN1_IA5STRING_new();
          if (str == (ASN1_IA5STRING *)0x0) goto LAB_001007b0;

...
LAB_001000ab:
    uVar12 = param_4 * 4;
    if (param_4 >> 0x3e == 0) {
      if (uVar12 < uVar11) goto LAB_001000be;
    }
    else {
...
LAB_00100124:
    ...
    if (((SUB168(auVar5 * auVar9,8) == 0) &&
        (auVar6._8_8_ = 0, auVar6._0_8_ = uVar13, auVar10._8_8_ = 0, auVar10._0_8_ = uVar12 / uVar11
        , uVar12 = SUB168(auVar6 * auVar10,0), SUB168(auVar6 * auVar10,8) == 0)) &&
       (uVar13 = SUB168(auVar5 * auVar9,0) / uVar11, uVar11 = uVar12 + uVar13,
       !CARRY8(uVar12,uVar13))) goto LAB_001000ab;
    uVar12 = param_4 * 4;
    bVar1 = param_4 >> 0x3e != 0;
    uVar11 = (ulong)bVar1;
    if (!bVar1) goto LAB_00100124;
  }
  uVar16 = uVar16 * 2;
LAB_001000be:
  if (param_3 < uVar16) {
...
LAB_001004bd:
    ...
    if (param_2 != uVar1) goto LAB_001004bd;
    *(undefined1 *)((long)param_1 + 0x5a) = 1;
  }
  return 1;
}

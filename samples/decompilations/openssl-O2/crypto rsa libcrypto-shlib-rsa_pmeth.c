...

{
  ...
  pBVar7 = *(BIGNUM **)(puVar2 + 2);
  *puVar3 = *puVar2;
  if (pBVar7 != (BIGNUM *)0x0) {
    pBVar7 = BN_dup(pBVar7);
    *(BIGNUM **)(puVar3 + 2) = pBVar7;
    if (pBVar7 == (BIGNUM *)0x0) {
      return 0;
    }
  }
  ...
  uVar5 = *(undefined8 *)(puVar2 + 10);
  puVar3[0xc] = puVar2[0xc];
  uVar1 = puVar2[0x14];
  *(undefined8 *)(puVar3 + 8) = uVar4;
  *(undefined8 *)(puVar3 + 10) = uVar5;
  puVar3[0x14] = uVar1;
  if (lVar8 != 0) {
    CRYPTO_free(*(void **)(puVar3 + 0x10));
    lVar8 = CRYPTO_memdup(*(undefined8 *)(puVar2 + 0x10),*(undefined8 *)(puVar2 + 0x12),
                          "crypto/rsa/rsa_pmeth.c",0x6a);
    *(long *)(puVar3 + 0x10) = lVar8;
    if (lVar8 == 0) {
      return 0;
    }
    *(undefined8 *)(puVar3 + 0x12) = *(undefined8 *)(puVar2 + 0x12);
  }
  return 1;
}
  ...
  if (*(int *)(lVar1 + 0x1c) == 4) {
    ...
    if (pvVar4 == (void *)0x0) {
      ...
      *(void **)(lVar1 + 0x38) = pvVar4;
      if (pvVar4 != (void *)0x0) goto LAB_0010126d;
    }
    else {
LAB_0010126d:
      iVar3 = RSA_padding_add_PKCS1_OAEP_mgf1
                        (pvVar4,iVar2,param_4,param_5,*(undefined8 *)(lVar1 + 0x40),
...
LAB_0010152e:
  ...
  if ((int)m_length < 1) {
    ...
    uVar6 = 0x98;
LAB_00101721:
    ERR_set_debug("crypto/rsa/rsa_pmeth.c",uVar6,"pkey_rsa_sign");
    ERR_set_error(4,0x8f,0);
  }
  else {
      ...
      if (iVar2 == 6) {
        ...
        if (puVar5 == (uchar *)0x0) {
          ...
          *(uchar **)(lVar1 + 0x38) = puVar5;
          if (puVar5 == (uchar *)0x0) goto LAB_00101700;
        }
        iVar2 = RSA_padding_add_PKCS1_PSS_mgf1
                          (rsa,puVar5,param_4,*(EVP_MD **)(lVar1 + 0x20),*(EVP_MD **)(lVar1 + 0x28),
                           *(int *)(lVar1 + 0x30));
        if (iVar2 != 0) {
          puVar5 = *(uchar **)(lVar1 + 0x38);
          iVar2 = RSA_size(rsa);
...
joined_r0x00101877:
    if (local_48[0] < 0) goto LAB_0010183c;
    ...
    *param_3 = __n;
    ...
    if (*(int *)(lVar2 + 0x1c) == 5) {
      ...
      if (to == (uchar *)0x0) {
        ...
        *(uchar **)(lVar2 + 0x38) = to;
        if (to == (uchar *)0x0) goto LAB_00101980;
      }
...
LAB_00101980:
      ...
      if (0 < iVar4) goto joined_r0x00101877;
    }
    local_48[0] = 0;
  }
LAB_0010183c:
...

{
  ...
  if (*(long *)(lVar1 + 0x20) == 0) {
    ...
    if (puVar5 == (uchar *)0x0) {
      ...
      puVar5 = (uchar *)CRYPTO_malloc(iVar2,"crypto/rsa/rsa_pmeth.c",0x77);
      *(uchar **)(lVar1 + 0x38) = puVar5;
      if (puVar5 == (uchar *)0x0) goto LAB_00101bc0;
    }
...
LAB_00101af0:
    ...
    if (iVar2 < 1) {
      ...
      uVar6 = 0x11c;
LAB_00101c21:
      ERR_set_debug("crypto/rsa/rsa_pmeth.c",uVar6,"pkey_rsa_verify");
      ERR_set_error(4,0x8f,0);
    }
    else {

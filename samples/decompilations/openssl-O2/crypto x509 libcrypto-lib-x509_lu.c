  ...
  if (-1 < iVar1) {
    ...
    if (iVar1 < iVar2) {
      do {
        ...
        if (iVar3 != 0) break;
        if (x->type == 1) {
          iVar3 = X509_cmp((pXVar4->data).x509,(x->data).x509);
        }
        else {
          if (x->type != 2) goto LAB_001011e0;
          iVar3 = X509_CRL_match((pXVar4->data).crl,(x->data).crl);
        }
        if (iVar3 == 0) goto LAB_001011e0;
        iVar1 = iVar1 + 1;
      } while (iVar2 != iVar1);
    }
  }
...
int x509_store_add(long param_1,char *param_2,int param_3)

{
  ...
  if (param_2 != (char *)0x0) {
    ...
    a->type = iVar1;
    X509_OBJECT_up_ref_count(a);
    if ((extraout_EAX != 0) && (iVar1 = X509_STORE_lock(param_1), iVar1 != 0)) {
      pXVar2 = X509_OBJECT_retrieve_match(*(stack_st_X509_OBJECT **)(param_1 + 8),a);
      if (pXVar2 == (X509_OBJECT *)0x0) {
        iVar1 = OPENSSL_sk_push(*(undefined8 *)(param_1 + 8),a);
        X509_STORE_unlock(param_1);
        if (iVar1 != 0) {
          return 1;
        }

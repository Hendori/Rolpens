...
void mac_hmac_newctx(undefined8 param_1,undefined8 param_2)

{
  mac_newctx(param_1,param_2,&_LC1);
  return;
}



void mac_siphash_newctx(undefined8 param_1,undefined8 param_2)

{
  mac_newctx(param_1,param_2,"SIPHASH");
  return;
}



void mac_poly1305_newctx(undefined8 param_1,undefined8 param_2)

{
  mac_newctx(param_1,param_2,"POLY1305");
  return;
}



void mac_cmac_newctx(undefined8 param_1,undefined8 param_2)

{
  mac_newctx(param_1,param_2,&_LC4);
  return;
}
...

{
  ...
  uVar1 = ossl_prov_ctx_get0_libctx(param_2);
  lVar2 = EVP_MAC_fetch(uVar1,&_LC4,0);
  if (lVar2 != 0) {
    uVar1 = EVP_MAC_settable_ctx_params(lVar2);
    EVP_MAC_free(lVar2);
    return uVar1;
...

{
  ...
  *(undefined1 (*) [16])(ptr + 1) = (undefined1  [16])0x0;
  if (pcVar4 != (char *)0x0) {
    ...
    ptr[1] = pcVar4;
    if (pcVar4 == (char *)0x0) goto LAB_00100570;
  }
  lVar5 = param_1[2];
  if (lVar5 != 0) {
    iVar3 = ossl_mac_key_up_ref();
    if (iVar3 == 0) goto LAB_00100570;
    lVar5 = param_1[2];
  }
  ptr[2] = lVar5;
  if (param_1[3] == 0) {

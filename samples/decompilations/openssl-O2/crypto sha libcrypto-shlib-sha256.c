...

{
  ...
  ptr = c->data;
  uVar7 = c->num;
  *(undefined1 *)((long)c->data + (ulong)uVar7) = 0x80;
  uVar3 = (ulong)uVar7 + 1;
  if (uVar3 < 0x39) {
    uVar6 = 0x38 - uVar3;
...
LAB_001002d3:
  ...
  if (uVar7 < 8) {
    if ((uVar6 & 4) == 0) {
      if ((uVar7 != 0) && (*(undefined1 *)puVar4 = 0, (uVar6 & 2) != 0)) {
    ...
    *(undefined8 *)((long)puVar4 + ((uVar6 & 0xffffffff) - 8)) = 0;
    uVar7 = uVar7 + ((int)puVar4 - (int)((ulong)(puVar4 + 2) & 0xfffffffffffffff8)) & 0xfffffff8;
    if (7 < uVar7) {
      uVar2 = 0;
      do {
        uVar3 = (ulong)uVar2;

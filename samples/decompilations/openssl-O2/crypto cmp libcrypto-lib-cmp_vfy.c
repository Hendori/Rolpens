...
undefined8
check_name(undefined8 param_1,uint param_2,undefined8 param_3,X509_NAME *param_4,undefined8 param_5,
          X509_NAME *param_6)
  ...
  if (param_4 == (X509_NAME *)0x0) {
    ...
    if (iVar1 == 0) {
      if ((pcVar2 != (char *)0x0) && ((param_2 & 1) != 0)) {
        ossl_cmp_print_log(6,param_1,"check_name","crypto/cmp/cmp_vfy.c",0xb2,&_LC3,
                           " %s matches %s: %s",param_3,param_5,pcVar2);
      }
      CRYPTO_free(pcVar2);
      return 1;
    }
    if (pcVar2 != (char *)0x0) {
      ossl_cmp_print_log(6,param_1,"check_name","crypto/cmp/cmp_vfy.c",0xb9,&_LC3,
                         " actual name in %s = %s",param_3,pcVar2);
    }
    CRYPTO_free(pcVar2);
    pcVar2 = X509_NAME_oneline(param_6,(char *)0x0,0);
    if (pcVar2 != (char *)0x0) {
      ossl_cmp_print_log(6,param_1,"check_name","crypto/cmp/cmp_vfy.c",0xbc,&_LC3,
                         " does not match %s = %s",param_5,pcVar2);
    }
    CRYPTO_free(pcVar2);
  }
  return 0;
  ...
  if ((param_2 != (long *)0x0 && param_3 != (X509 *)0x0) && (param_1 != (undefined8 *)0x0)) {
    ...
    if (a != (BIO *)0x0) {
      if ((*(int *)(param_1 + 0x17) == 0) &&
         (uVar7 = X509_get_key_usage(param_3), (uVar7 & 0x80) == 0)) {
        ERR_new();
...
LAB_00100386:
        pkey = (EVP_PKEY *)0x0;
LAB_001002b4:
        iVar5 = ossl_x509_print_ex_brief(a,param_3,0x100);
        ERR_new();
...
check_transactionID_or_nonce
          (ASN1_OCTET_STRING *param_1,ASN1_OCTET_STRING *param_2,undefined4 param_3)
...
undefined8
cert_acceptable(long param_1,undefined8 param_2,undefined8 param_3,X509 *param_4,undefined8 param_5,
...

{
  ...
  if (iVar1 == 0) {
    ossl_cmp_print_log(6,param_1,"cert_acceptable","crypto/cmp/cmp_vfy.c",0x100,&_LC3,
                       " considering %s%s %s with..","self-issued ",param_2,param_3);
    ...
    if (pcVar4 == (char *)0x0) {
      ...
      ossl_cmp_print_log(6,param_1,"cert_acceptable","crypto/cmp/cmp_vfy.c",0x103,&_LC3,
                         "  subject = %s",pcVar4);
      CRYPTO_free(pcVar4);
    }
  }
    ...
    ossl_cmp_print_log(6,param_1,"cert_acceptable","crypto/cmp/cmp_vfy.c",0x100,&_LC3,
                       " considering %s%s %s with..",&_LC25,param_2,param_3);
    pXVar3 = X509_get_subject_name(param_4);
    pcVar4 = X509_NAME_oneline(pXVar3,(char *)0x0,0);
    if (pcVar4 == (char *)0x0) {
      CRYPTO_free((void *)0x0);
    ...
    pcVar4 = X509_NAME_oneline(pXVar3,(char *)0x0,0);
    if (pcVar4 != (char *)0x0) {
      ossl_cmp_print_log(6,param_1,"cert_acceptable","crypto/cmp/cmp_vfy.c",0x108,&_LC3,
                         "  issuer  = %s",pcVar4);
    }
    CRYPTO_free(pcVar4);
  }
...
LAB_001006a0:
    if (iVar1 < 1) {
      ...
      if (b != (ASN1_OCTET_STRING *)0x0) {
        ...
        if (iVar1 != 0) {
          if (pcVar4 != (char *)0x0) {
            ossl_cmp_print_log(6,param_1,"check_kid","crypto/cmp/cmp_vfy.c",0xd9,&_LC3,
                               " cert Subject Key Identifier = %s",pcVar4);
          }
          CRYPTO_free(pcVar4);
          pcVar4 = i2s_ASN1_OCTET_STRING((X509V3_EXT_METHOD *)0x0,b);
          if (pcVar4 != (char *)0x0) {
            ossl_cmp_print_log(6,param_1,"check_kid","crypto/cmp/cmp_vfy.c",0xdc,&_LC3,
                               " does not match senderKID    = %s",pcVar4);
          }
          CRYPTO_free(pcVar4);
          return 0;
        }
        if (pcVar4 != (char *)0x0) {
          ossl_cmp_print_log(6,param_1,"check_kid","crypto/cmp/cmp_vfy.c",0xd3,&_LC3,
                             " subjectKID matches senderKID: %s",pcVar4);
        }
        CRYPTO_free(pcVar4);
      }
      ...
      if (iVar1 == 0) {
        ...
        if (iVar1 != 0) {
          ossl_cmp_print_log(6,param_1,"cert_acceptable","crypto/cmp/cmp_vfy.c",0x130,&_LC3,&_LC15,
                             " cert seems acceptable");
          return 1;
        }
        uVar6 = 300;
...
LAB_00100b7e:
      ossl_cmp_print_log(4,param_1,local_58,"crypto/cmp/cmp_vfy.c",uVar6,&_LC0,&_LC15,pcVar4);
      return 0;
    }
  }
LAB_00100a60:
  ossl_cmp_print_log(6,param_1,"cert_acceptable","crypto/cmp/cmp_vfy.c",0x10e,&_LC3,&_LC15,
                     " cert has already been checked");
  return 0;
}
...

{
  ...
  if ((ctx != (X509_STORE_CTX *)0x0) &&
     (iVar1 = X509_STORE_CTX_init(ctx,param_2,param_3,(stack_st_X509 *)param_1[0x16]), iVar1 != 0))
  {
    uVar5 = 1;
...

{
  ...
  if (v != (X509_STORE *)0x0) {
    ...
    if (iVar1 != 0) {
      ...
      if (iVar1 != 0) {
        uVar3 = ossl_cmp_certrepmessage_get0_certresponse
                          (*(undefined8 *)(*(long *)(param_2 + 8) + 8),0);
        a = (X509 *)ossl_cmp_certresponse_get1_cert(param_1,uVar3);
        uVar2 = OSSL_CMP_validate_cert_path(param_1,v,a);
        X509_free(a);
        goto LAB_00100d87;
      }
      ossl_cmp_print_log(4,param_1,"check_cert_path_3gpp","crypto/cmp/cmp_vfy.c",0x157,&_LC0,&_LC15,
...

{
  ...
  if (iVar1 != 0) {
    ...
    ossl_cmp_print_log(4,param_1,"check_cert_path","crypto/cmp/cmp_vfy.c",0x13a,&_LC0,&_LC15,
...

{
  ...
  if (iVar1 < 1) {
    ...
    for (iVar1 = 0; iVar2 = OPENSSL_sk_num(param_2), iVar1 < iVar2; iVar1 = iVar1 + 1) {
      ...
      iVar2 = cert_acceptable(param_1,"cert from",param_3,lVar3,param_4,param_5);
      if (iVar2 != 0) {
        if (param_7 == 0) {
          iVar2 = OSSL_CMP_validate_cert_path(param_1,*(undefined8 *)(param_1 + 0xa8),lVar3);
          if (iVar2 != 0) {
LAB_00101028:
            uVar4 = ossl_cmp_ctx_set1_validatedSrvCert(param_1,lVar3);
            return uVar4;
          }
          ossl_cmp_print_log(4,param_1,"check_cert_path","crypto/cmp/cmp_vfy.c",0x13a,&_LC0,&_LC15,
                             "msg signature validates but cert path validation failed");
                ...
                (iVar2 = check_cert_path_3gpp_part_0(param_1,param_6,lVar3), iVar2 != 0))
        goto LAB_00101028;
        local_3c = local_3c + 1;
      }
    }
  ...
  ossl_cmp_print_log(4,param_1,"check_msg_with_certs","crypto/cmp/cmp_vfy.c",uVar4,&_LC0,pcVar5,
                     param_3);
  return 0;
}
...

{
  ...
  if ((*(int *)(param_1 + 0xbc) == 0) || (iVar1 = OSSL_CMP_MSG_get_bodytype(param_2), iVar1 != 1)) {
    if (param_3 != 0) {
      return 0;
    }
  }
  ...
  iVar1 = check_msg_with_certs
                    (param_1,*(undefined8 *)(param_2 + 0x18),"extraCerts",0,0,param_2,param_3);
  if ((iVar1 == 0) &&
     (iVar1 = check_msg_with_certs
                        (param_1,*(undefined8 *)(param_1 + 0xb0),"untrusted certs",
                         *(undefined8 *)(param_2 + 0x18),0,param_2,param_3), iVar1 == 0)) {
    if (*(long *)(param_1 + 0xa8) == 0) {
      pcVar4 = "no trusted store";
      if (param_3 != 0) {
        pcVar4 = "no self-issued extraCerts";
      }
      ossl_cmp_print_log(4,param_1,"check_msg_all_certs","crypto/cmp/cmp_vfy.c",0x1bb,&_LC0,&_LC15,
                         pcVar4);
      return 0;
    }
    ...
    uVar2 = check_msg_with_certs
                      (param_1,uVar3,pcVar4,*(undefined8 *)(param_2 + 0x18),
                       *(undefined8 *)(param_1 + 0xb0),param_2,param_3);
...

{
  ...
  ossl_cmp_print_log(7,param_1,"OSSL_CMP_validate_msg","crypto/cmp/cmp_vfy.c",0x237,"DEBUG",&_LC15,
                     "validating CMP message");
  ...
  if (iVar4 == 0x30e) {
    if (*(long *)(param_1 + 0xe8) == 0) {
      ossl_cmp_print_log(6,param_1,"OSSL_CMP_validate_msg","crypto/cmp/cmp_vfy.c",0x248,&_LC3,&_LC15
...
LAB_0010154c:
      ossl_cmp_print_log(4,param_1,"OSSL_CMP_validate_msg","crypto/cmp/cmp_vfy.c",0x26a,&_LC0,&_LC15
                         ,"verifying PBM-based CMP message protection failed");
      return 0;
    }
    plVar2 = (long *)param_2[2];
    if (((plVar2 == (long *)0x0) || ((int)*plVar2 < 0)) ||
       ((lVar1._0_4_ = a->length, lVar1._4_4_ = a->type, *plVar2 != lVar1 ||
        (iVar4 = CRYPTO_memcmp((void *)plVar2[1],a->data,(long)a->length), iVar4 != 0)))) {
      ...
      if ((uVar5 & 0x8214) == 0) {
        if ((uVar5 & 1) != 0) {
          return 0;
              ...
              (iVar4 = ossl_cmp_X509_STORE_add1_certs
                                 (*(long *)(param_1 + 0xa8),**(undefined8 **)(param_2[1] + 8),0),
              iVar4 == 0)) {
        return 0;
      }
    }
  ...
  if (lVar1 != 0) {
    ...
    if (iVar4 == 0) {
      ossl_cmp_print_log(4,param_1,"OSSL_CMP_validate_msg","crypto/cmp/cmp_vfy.c",0x28c,&_LC0,&_LC15
    ...
    ossl_cmp_print_log(7,param_1,"OSSL_CMP_validate_msg","crypto/cmp/cmp_vfy.c",0x288,"DEBUG",&_LC15
                       ,
  ...
  if ((*(long *)(param_1 + 0xa8) == 0) && (*(long *)(param_1 + 0xe8) != 0)) {
    ossl_cmp_print_log(6,param_1,"OSSL_CMP_validate_msg","crypto/cmp/cmp_vfy.c",0x27c,&_LC3,&_LC15,
  ...
  *(undefined8 *)(param_1 + 0x10) = 0;
  if (lVar1 == 0) {
LAB_00101803:
    iVar4 = check_msg_all_certs(param_1,param_2,0);
    if ((iVar4 == 0) && (iVar4 = check_msg_all_certs(param_1,param_2,1), iVar4 == 0)) {
      *(undefined8 *)(param_1 + 0x10) = uVar6;
      ...
      if (*(long *)(param_1 + 0x10) != 0) {
        ossl_cmp_print_log(6,param_1,"check_msg_find_cert","crypto/cmp/cmp_vfy.c",0x207,&_LC3,&_LC15
                           ,"trying to verify msg signature with a valid cert that..");
        if (pcVar7 != (char *)0x0) {
          ossl_cmp_print_log(6,param_1,"check_msg_find_cert","crypto/cmp/cmp_vfy.c",0x209,&_LC3,
                             "matches msg sender    = %s",pcVar7);
        }
        if (local_48 == (ASN1_OCTET_STRING *)0x0) {
          uVar6 = 0x20d;
          pcVar8 = "%s";
    ...
    *(undefined8 *)(param_1 + 0x10) = uVar6;
    ...
    if (iVar4 == 0) {
      ...
      ossl_cmp_print_log(6,param_1,"check_msg_find_cert","crypto/cmp/cmp_vfy.c",500,&_LC3,&_LC15,
...
LAB_001014f0:
  ossl_cmp_print_log(7,param_1,"OSSL_CMP_validate_msg","crypto/cmp/cmp_vfy.c",uVar6,"DEBUG",&_LC15,
                     pcVar7);
  return 1;
}
...
bool ossl_cmp_msg_check_update(long param_1,long *param_2,code *param_3,undefined4 param_4)

{
  ...
  if ((pXVar7 != (X509_NAME *)0x0) ||
     ((*(X509 **)(param_1 + 0x90) != (X509 *)0x0 &&
      (pXVar7 = X509_get_subject_name(*(X509 **)(param_1 + 0x90)), pXVar7 != (X509_NAME *)0x0)))) {
    if (**(int **)(lVar5 + 8) != 4) {
      ERR_new();
  ...
  if (10 < (int)uVar6) {
    ossl_cmp_print_log(4,param_1,"ossl_cmp_msg_check_update","crypto/cmp/cmp_vfy.c",0x2e9,&_LC0,
                       "received CMP message contains %d extraCerts",uVar6);
  }
  iVar2 = 0;
  ...
  if (*(long *)(lVar5 + 0x20) == 0) {
    if (param_3 != (code *)0x0) {
      ...
      if (iVar2 < 1) {
        ...
        goto joined_r0x00101f00;
      }
      goto LAB_00101c38;
    }
    if ((*(int *)(param_1 + 0x8c) == 0) || (iVar2 = iVar4 + -1, iVar4 < 1)) goto LAB_00101ea0;
    bVar1 = false;
LAB_00101c60:
    do {
      pXVar8 = (X509 *)OPENSSL_sk_shift(*(undefined8 *)(param_1 + 0xb0));
    ...
    if (bVar1) {
LAB_00101d40:
      iVar2 = ossl_cmp_hdr_get_pvno(lVar5);
      if ((iVar2 == 2) || (iVar2 = ossl_cmp_hdr_get_pvno(lVar5), iVar2 == 3)) {
        ...
        if (iVar2 < 0) {
          ...
          iVar2 = check_transactionID_or_nonce
                            (*(undefined8 *)(param_1 + 0x118),*(undefined8 *)(lVar5 + 0x38),0x98);
          if (iVar2 != 0) {
            ERR_set_mark();
            iVar2 = check_transactionID_or_nonce
                              (*(undefined8 *)(param_1 + 0x120),*(undefined8 *)(lVar5 + 0x48),0x94);
            if ((iVar2 == 0) &&
               (((*(long *)(param_1 + 0x130) == 0 ||
                 (iVar2 = OSSL_CMP_MSG_get_bodytype(param_2), iVar2 == 0x1a)) ||
                (iVar2 = check_transactionID_or_nonce
                                   (*(undefined8 *)(param_1 + 0x130),*(undefined8 *)(lVar5 + 0x48),
                                    0x94), iVar2 == 0)))) {
              ERR_clear_last_mark();
            }
            else {
              ...
              if (((*(long *)(param_1 + 0x118) != 0) ||
                  (iVar2 = OSSL_CMP_CTX_set1_transactionID(param_1,*(undefined8 *)(lVar5 + 0x38)),
                  iVar2 != 0)) &&
                 (iVar2 = ossl_cmp_ctx_set1_recipNonce(param_1,*(undefined8 *)(lVar5 + 0x40)),
                 iVar2 != 0)) {
                iVar2 = ossl_cmp_hdr_get_protection_nid(lVar5);
                if (((iVar2 == 0x30e) &&
                    (uVar9 = OSSL_CMP_MSG_get_bodytype(param_2), (uint)uVar9 < 0xf)) &&
                   (((0x410aUL >> (uVar9 & 0x3f) & 1) != 0 && (*(long *)(param_1 + 0xa8) != 0)))) {
                  iVar2 = ossl_cmp_X509_STORE_add1_certs
                                    (*(long *)(param_1 + 0xa8),**(undefined8 **)(param_2[1] + 8),0);
                  return iVar2 != 0;
                }
                return true;
    ...
    if ((iVar2 != 0) ||
       ((param_3 != (code *)0x0 && (iVar2 = (*param_3)(param_1,param_2,1,param_4), 0 < iVar2)))) {
LAB_00101c38:
      if (*(int *)(param_1 + 0x8c) == 0) goto LAB_00101d40;
      iVar2 = iVar4 + -1;
      bVar1 = true;
      if (iVar4 < 1) goto LAB_00101d40;
      goto LAB_00101c60;
    }
    iVar2 = *(int *)(param_1 + 0x8c);
joined_r0x00101f00:
...
LAB_00102075:
      iVar6 = OSSL_CRMF_MSGS_verify_popo(*(undefined8 *)(puVar2 + 2),0,param_3,*param_1,param_1[1]);
      return iVar6 != 0;
    }
  }
  else if (uVar1 == 7) goto LAB_00102075;
  ERR_new();

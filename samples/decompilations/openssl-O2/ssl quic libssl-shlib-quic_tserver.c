...

{
  ...
  if (((param_1[3] == 0) || (param_1[4] == 0)) ||
    ...
    *(long *)(ptr[6] + 8) = lVar8;
    if (lVar8 != 0) {
      pSVar12 = (SSL_CTX *)param_1[2];
      if (pSVar12 == (SSL_CTX *)0x0) {
        uVar11 = TLS_method();
        pSVar12 = (SSL_CTX *)SSL_CTX_new_ex(*(undefined8 *)*ptr,*(undefined8 *)(*ptr + 8),uVar11);
        *(SSL_CTX **)ptr[7] = pSVar12;
        if (pSVar12 == (SSL_CTX *)0x0) goto LAB_00100280;
      }
      else {
        *(SSL_CTX **)ptr[7] = pSVar12;
      }
      if ((param_2 == (char *)0x0) ||
         (iVar7 = SSL_CTX_use_certificate_file(pSVar12,param_2,1), 0 < iVar7)) {
        pSVar12 = *(SSL_CTX **)ptr[7];
        if (param_3 != (char *)0x0) {
          iVar7 = SSL_CTX_use_PrivateKey_file(pSVar12,param_3,1);
          if (iVar7 < 1) goto LAB_00100280;
          pSVar12 = *(SSL_CTX **)ptr[7];
        }
        SSL_CTX_set_alpn_select_cb(pSVar12,0x100000,ptr);

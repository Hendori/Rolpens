...

{
  ...
  puVar8 = (undefined8 *)CRYPTO_zalloc(0x48,"providers/implementations/exchange/dh_exch.c",0x126);
  ...
  *(undefined1 (*) [16])(puVar8 + 1) = (undefined1  [16])0x0;
  if (pDVar11 != (DH *)0x0) {
    iVar7 = DH_up_ref(pDVar11);
    if (iVar7 == 0) goto LAB_00100740;
    pDVar11 = (DH *)param_1[1];
  }
  puVar8[1] = pDVar11;
  pDVar11 = (DH *)param_1[2];
  if (pDVar11 != (DH *)0x0) {
    iVar7 = DH_up_ref(pDVar11);
    if (iVar7 == 0) goto LAB_00100740;
    pDVar11 = (DH *)param_1[2];
  ...
  if ((param_1[5] != 0) && (param_1[6] != 0)) {
    lVar10 = CRYPTO_memdup(param_1[5],param_1[6],"providers/implementations/exchange/dh_exch.c",
                           0x142);
    puVar8[5] = lVar10;
    if (lVar10 == 0) goto LAB_00100740;
  }
  if ((char *)param_1[8] == (char *)0x0) {
    return puVar8;
  }
  pcVar9 = CRYPTO_strdup((char *)param_1[8],"providers/implementations/exchange/dh_exch.c",0x149);
  puVar8[8] = pcVar9;
  if (pcVar9 != (char *)0x0) {
    return puVar8;
  }
...

{
  ...
  if ((int)uVar3 == 0) goto LAB_00100ad8;

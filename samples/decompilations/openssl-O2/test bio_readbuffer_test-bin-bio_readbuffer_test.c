...
uint test_readbuffer_file_bio(int param_1)

{
  ...
  if (iVar1 == 0) {
    ...
    if ((uVar3 == 0) ||
      ...
      b = BIO_new(type);
      iVar1 = test_ptr("test/bio_readbuffer_test.c",0x2c,"readbuf_bio = BIO_new(BIO_f_readbuffer())"
                       ,b);
      if (iVar1 == 0) {
        append = (BIO *)0x0;
        a = (BIO *)0x0;
        ...
        if (uVar3 != 0) {
          ...
          iVar1 = test_int_eq("test/bio_readbuffer_test.c",0x33,"BIO_tell(in_bio)",&_LC9,
                              uVar6 & 0xffffffff,0);
          if (iVar1 != 0) {
            iVar1 = 4;
            if (param_1 != 0) {
              do {
                lVar7 = BIO_ctrl(append,2,0,(void *)0x0);
...
joined_r0x001004b0:
                  if (iVar4 == 0) goto LAB_001004c0;
                }
                else {
                  iVar5 = test_int_gt("test/bio_readbuffer_test.c",0x3e,&_LC13,&_LC9,iVar4,0);
                  if (((iVar5 == 0) ||
                      (iVar5 = test_int_le("test/bio_readbuffer_test.c",0x3f,&_LC13,
                                           "(int)sizeof(buf) - 1",iVar4), iVar5 == 0)) ||
                     (iVar5 = test_true("test/bio_readbuffer_test.c",0x41,"buf[len] == 0"),
                     iVar5 == 0)) goto LAB_001004c0;
                  if (((1 < iVar4) && (lVar7 = BIO_ctrl(append,2,0,(void *)0x0), iVar4 != 0xfe)) &&
                     ((int)lVar7 == 0)) {
                    iVar4 = test_true("test/bio_readbuffer_test.c",0x46,"buf[len - 1] == \'\\n\'");
                    goto joined_r0x001004b0;
                  }
                }
              } while ((param_1 != 1) || (iVar1 = iVar1 + -1, iVar1 != 0));
            }
            ...
            if (iVar1 != 0) {
              uVar6 = 0;
              uVar2 = 8;
              while (lVar7 = BIO_ctrl(append,2,0,(void *)0x0), (int)lVar7 == 0) {
                ...
                if (iVar1 == 0) break;
                iVar1 = test_mem_eq("test/bio_readbuffer_test.c",0x54,&_LC20,"expected + count",
                                    local_1148,local_1150,local_1048 + uVar6,local_1150);
                if (iVar1 == 0) goto LAB_001004c0;
                uVar6 = uVar6 + local_1150;
                uVar2 = 0xff;
              }
              iVar1 = test_int_eq("test/bio_readbuffer_test.c",0x59,"count","readbytes",
                                  uVar6 & 0xffffffff,local_1158 & 0xffffffff);
              uVar3 = (uint)(iVar1 != 0);
              b = (BIO *)0x0;
              a = (BIO *)0x0;
              goto LAB_0010008d;

...
undefined8 cmp_ctx_set_md(undefined8 *param_1,long *param_2,int param_3)

{
  ...
  uVar1 = param_1[1];
  pcVar2 = OBJ_nid2sn(param_3);
  lVar3 = EVP_MD_fetch(*param_1,pcVar2,uVar1);
  if (lVar3 != 0) {
    EVP_MD_free(*param_2);
    *param_2 = lVar3;
    return 1;
...
undefined8
ossl_cmp_print_log(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
                  undefined8 param_5,undefined8 param_6,undefined8 param_7,undefined8 param_8,
                  int param_9,long param_10,char *param_11,char *param_12,undefined4 param_13,
...

{
  ...
  uVar2 = 1;
  if ((((param_10 != 0) && (*(long *)(param_10 + 0x10) != 0)) &&
      (param_9 <= *(int *)(param_10 + 0x18))) && (uVar2 = 0, param_15 != (char *)0x0)) {
...

{
  ...
  if (param_1 != (void *)0x0) {
    if (*(long *)((long)param_1 + 0x30) != 0) {
      ...
      ossl_cmp_print_log(7,param_1,"OSSL_CMP_CTX_free","crypto/cmp/cmp_ctx.c",0xc9,"DEBUG",&_LC5,
                         "disconnected from CMP server");
    }
    ...
    ASN1_OCTET_STRING_free(*(ASN1_OCTET_STRING **)((long)param_1 + 0x118));
    ASN1_OCTET_STRING_free(*(ASN1_OCTET_STRING **)((long)param_1 + 0x120));
    ASN1_OCTET_STRING_free(*(ASN1_OCTET_STRING **)((long)param_1 + 0x128));
    ASN1_OCTET_STRING_free(*(ASN1_OCTET_STRING **)((long)param_1 + 0x130));
    ...
    OSSL_STACK_OF_X509_free(*(undefined8 *)((long)param_1 + 0x1f0));
    OSSL_STACK_OF_X509_free(*(undefined8 *)((long)param_1 + 0x1f8));
    OSSL_STACK_OF_X509_free(*(undefined8 *)((long)param_1 + 0x200));
    CRYPTO_free(param_1);
    return;
  }
  return;
  ...
  if (puVar3 != (undefined8 *)0x0) {
    *puVar3 = param_1;
    if (param_2 != (char *)0x0) {
      ...
      puVar3[1] = pcVar4;
      if (pcVar4 == (char *)0x0) goto LAB_00100b2c;
    }
    uVar1 = _LC6;
    ...
    *(undefined4 *)((long)puVar3 + 0x6c) = 0xffffffff;
    ...
    if (lVar5 == 0) {
      ...
      puVar3[0x1e] = 0x10;
      iVar2 = cmp_ctx_set_md(puVar3,puVar3 + 0x1f,0x2a0);
      if (iVar2 != 0) {
        puVar3[0x20] = _LC7;
        iVar2 = cmp_ctx_set_md(puVar3,puVar3 + 0x22,0x2a0);
        if (iVar2 != 0) {
...

{
  ...
  if ((param_2 != (X509_NAME *)0x0) &&
     (param_2 = X509_NAME_dup(param_2), param_2 == (X509_NAME *)0x0)) {
    return 0;
  }
...

{
  ...
  if ((param_2 != (ASN1_INTEGER *)0x0) &&
     (param_2 = ASN1_INTEGER_dup(param_2), param_2 == (ASN1_INTEGER *)0x0)) {
    return 0;
  }
...

{
  ...
  if (param_1 == 0) {
    ...
    if (((param_2 != (stack_st_X509_EXTENSION *)0x0) && (0 < iVar1)) &&
       (iVar1 = X509v3_get_ext_by_NID(param_2,0x55,-1), -1 < iVar1)) {
      ERR_new();
...

{
  ...
  if (param_1 == (undefined8 *)0x0) {
    ...
    if (iVar1 != 0) {
      ossl_cmp_print_log(7,param_1,"OSSL_CMP_CTX_build_cert_chain","crypto/cmp/cmp_ctx.c",0x2ca,
                         "DEBUG");
      lVar2 = X509_build_chain(param_1[0x19],param_1[0x16],param_2,0,*param_1,param_1[1]);
      if (lVar2 != 0) {
        ossl_cmp_print_log(7,param_1,"OSSL_CMP_CTX_build_cert_chain","crypto/cmp/cmp_ctx.c",0x2d1,
                           "DEBUG",&_LC5,"success building chain for own CMP signer cert");
        param_1[0x1a] = lVar2;
        return 1;
      }
      ERR_new();
...

{
  ...
  if ((lVar1 == 0) && (lVar1 = *(long *)(param_1 + 200), lVar1 == 0)) {
    return *(long *)(param_1 + 0xd8);
  }
...

{
  ...
  if (param_1 == 0) {
    ...
    *(undefined8 *)(param_1 + 0x1c8) = 0;
    ...
    if ((((((iVar1 != 0) && (iVar1 = ossl_cmp_ctx_set0_newCert(param_1,0), iVar1 != 0)) &&
          (iVar1 = ossl_cmp_ctx_set1_newChain(param_1,0), iVar1 != 0)) &&
         ((iVar1 = ossl_cmp_ctx_set1_caPubs(param_1,0), iVar1 != 0 &&
          (iVar1 = ossl_cmp_ctx_set1_extraCertsIn(param_1,0), iVar1 != 0)))) &&
        ((iVar1 = ossl_cmp_ctx_set1_validatedSrvCert(param_1,0), iVar1 != 0 &&
         ((iVar1 = ossl_cmp_ctx_set1_first_senderNonce(param_1,0), iVar1 != 0 &&
          (iVar1 = OSSL_CMP_CTX_set1_transactionID(param_1,0), iVar1 != 0)))))) &&
       (iVar1 = OSSL_CMP_CTX_set1_senderNonce(param_1,0), iVar1 != 0)) {
...
LAB_00102430:
    ...
    if (param_2 != (char *)0x0) {
      ...
      if (param_2 == (char *)0x0) goto LAB_00102430;
    }
...
LAB_001024d0:
    ...
    if (param_2 != (char *)0x0) {
      ...
      if (param_2 == (char *)0x0) goto LAB_001024d0;
    }
...
LAB_00102570:
    ...
    if (param_2 != (char *)0x0) {
      ...
      if (param_2 == (char *)0x0) goto LAB_00102570;
    }
...
LAB_001028a0:
    ...
    if (param_2 != (char *)0x0) {
      ...
      if (param_2 == (char *)0x0) goto LAB_001028a0;
    }
...
bool OSSL_CMP_CTX_set_option(long param_1,int param_2,int param_3)

{
  ...
  if (param_2 == 0x18) {
    if (param_3 < -1) goto LAB_001029e0;
    if (param_3 < 4) {
...
LAB_001029e0:
    ...
    case 0x1a:
      *(int *)(param_1 + 0x14c) = param_3;
      break;
    case 0x1b:
      goto switchD_00102998_caseD_1b;
    case 0x1e:
    ...
    case 0x1f:
      *(int *)(param_1 + 0x88) = param_3;
      break;
    case 0x20:
      iVar1 = cmp_ctx_set_md(param_1,param_1 + 0xf8);
      return iVar1 != 0;
    case 0x21:
      *(int *)(param_1 + 0x104) = param_3;
      break;
    case 0x22:
      iVar1 = cmp_ctx_set_md(param_1,param_1 + 0x110);
      return iVar1 != 0;
    case 0x23:
  ...
  if (param_3 < -1) goto LAB_001029e0;
switchD_00102998_caseD_1b:
  if (param_3 < 0xb) {
    *(int *)(param_1 + 0x1c0) = param_3;
    return true;
  }
  ERR_new();
  uVar2 = 0x3cb;
LAB_00102b7e:
  ERR_set_debug("crypto/cmp/cmp_ctx.c",uVar2,"OSSL_CMP_CTX_set_option");

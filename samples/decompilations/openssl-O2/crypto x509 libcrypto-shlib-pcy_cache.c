...
LAB_00100442:
      ...
      do {
        ...
        if (iVar5 != 0x2ea) {
          ...
          if (-1 < iVar5) goto LAB_0010040e;
          iVar5 = OPENSSL_sk_push(plVar1[1],lVar7);
          if (iVar5 != 0) goto LAB_0010020d;
          ERR_new();
...
LAB_00100395:
      ...
      if (pAVar9 == (ASN1_INTEGER *)0x0) {
        ...
        if (pAVar9->type == 0x102) goto LAB_001002eb;
      ...
      if (pAVar11 == (ASN1_INTEGER *)0x0) {
        ...
        if (pAVar11 != (ASN1_INTEGER *)0x0) goto LAB_00100319;
      }
      else if (pAVar11->type != 0x102) {
        lVar7 = ASN1_INTEGER_get(pAVar11);
        *(long *)(pauVar6[1] + 8) = lVar7;
        pAVar11 = a->inhibitPolicyMapping;
        if (pAVar11 == (ASN1_INTEGER *)0x0) goto LAB_0010019c;
LAB_00100319:

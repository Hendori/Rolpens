...
LAB_001001d0:
    if ((uVar1 & 0x600) == 0) goto LAB_0010018d;
    lVar2 = *(long *)(param_1 + 0xc);
  }
  if (lVar2 != 0) {
    return 2;
...
LAB_0010018d:
  if (((uVar1 & 6) != 0) && (*(long *)(param_1 + 10) != 0)) {
    return 2;
  }
  if ((uVar1 & 0x3000) == 0) {
    return 1;
  ...
  if (param_4 == -1) {
    if ((param_5 == (char *)0x0) ||
       ((iVar1 = strcmp(param_5,"distid"), iVar1 != 0 &&
        (iVar1 = strcmp(param_5,"hexdistid"), iVar1 != 0)))) goto LAB_00100360;
  }
  else if (param_4 != 0xf) {
LAB_00100360:
    ERR_new();
...
LAB_00100371:
  ...
  if ((param_3 == 0xffffffff) || ((param_3 & *param_1) != 0)) {
    ...
    *(undefined1 (*) [16])(param_1 + 0xe) = (undefined1  [16])0x0;
    if (param_5 != (char *)0x0) {
      pcVar3 = CRYPTO_strdup(param_5,"crypto/evp/pmeth_lib.c",0x5de);
    ...
    if (param_7 != 0) {
      lVar4 = CRYPTO_memdup(param_6,param_7,"crypto/evp/pmeth_lib.c",0x5e3);
...
ulong evp_pkey_ctx_ctrl_int
                (uint *param_1,int param_2,uint param_3,undefined4 param_4,undefined4 param_5,
                undefined8 param_6)

{
  ...
  if ((*(long *)(param_1 + 0x1e) == 0) || (*(long *)(*(long *)(param_1 + 0x1e) + 0xf8) == 0)) {
    if (*param_1 == 0) {
      ...
      if ((param_3 == 0xffffffff) || ((*param_1 & param_3) != 0)) goto LAB_00100492;
      ERR_new();
...
LAB_00100492:
    iVar2 = evp_pkey_ctx_state(param_1);
    if (iVar2 < 2) {
      if (-1 < iVar2) {
...
LAB_001008da:
      if (param_4 == (char *)0x0) {
        if (param_3 == (ENGINE *)0x0) goto LAB_00100b4d;
LAB_00100b10:
        ERR_new();
      ...
      if ((iVar3 != 0) && (param_6 = iVar3, iVar3 != -1)) goto LAB_00100833;
      if (param_3 != (ENGINE *)0x0) goto LAB_00100b10;
    }
    else {
...
LAB_00100900:
    ...
    if (param_2 == (int *)0x0) {
LAB_00100bf8:
      local_158 = EVP_KEYMGMT_fetch(param_1,param_4,param_5);
    }
    else {
LAB_0010090c:
      if (*(long *)(param_2 + 0x18) == 0) goto LAB_00100bf8;
    ...
    if (local_158 != 0) {
      ...
      iVar1 = iVar3;
      if (((iVar2 == 0) || (iVar1 = iVar2, iVar3 == -1)) || (iVar1 = iVar3, iVar2 == iVar3)) {
        ctx = (EVP_PKEY_CTX *)CRYPTO_zalloc(0xb0,"crypto/evp/pmeth_lib.c",0x129);
        if ((ctx == (EVP_PKEY_CTX *)0x0) ||
           ((pEVar4 == (EVP_PKEY_METHOD *)0x0 && (ctx == (EVP_PKEY_CTX *)0x0)))) goto LAB_001008a7;
        param_3 = (ENGINE *)0x0;
        goto LAB_00100998;
      }
      ERR_new();
...
LAB_00100833:
    if (param_3 == (ENGINE *)0x0) {
      if (param_2 != (int *)0x0) {
        ...
        if (e != (ENGINE *)0x0) goto LAB_0010084f;
        if ((*(byte *)(param_2 + 0x13) & 1) == 0) goto LAB_00100bc4;
        pEVar4 = EVP_PKEY_meth_find(iVar3);
        if (param_4 == (char *)0x0) goto LAB_00100a9f;
        goto LAB_0010090c;
      }
      param_4 = OBJ_nid2sn(iVar3);
      e = ENGINE_get_pkey_meth_engine(iVar3);
...
LAB_00100bc4:
      if ((app_pkey_methods == 0) ||
         (local_148[0] = iVar3, iVar1 = OPENSSL_sk_find(app_pkey_methods,local_148), iVar1 < 0))
      goto LAB_00100be7;
      pEVar4 = (EVP_PKEY_METHOD *)OPENSSL_sk_value(app_pkey_methods,iVar1);
      if (pEVar4 == (EVP_PKEY_METHOD *)0x0) {
        param_6 = iVar3;
        if (param_4 != (char *)0x0) goto LAB_00100900;
LAB_00100a9f:
        if (pEVar4 == (EVP_PKEY_METHOD *)0x0) goto LAB_00100b4d;
      }
LAB_00100ab0:
      ctx = (EVP_PKEY_CTX *)CRYPTO_zalloc(0xb0,"crypto/evp/pmeth_lib.c",0x129);
      if (ctx == (EVP_PKEY_CTX *)0x0) {
        if (param_3 == (ENGINE *)0x0) goto LAB_0010089e;
        goto LAB_00100896;
      }
      local_158 = 0;
      iVar1 = iVar3;
LAB_00100998:
      ...
      *(undefined4 *)ctx = 0;
      if ((param_2 == (int *)0x0) || (iVar3 = EVP_PKEY_up_ref(param_2), iVar3 != 0)) {
        *(int **)(ctx + 0x88) = param_2;
        if ((pEVar4 == (EVP_PKEY_METHOD *)0x0) ||
           ((*(code **)(pEVar4 + 8) == (code *)0x0 ||
            (iVar3 = (**(code **)(pEVar4 + 8))(ctx), 0 < iVar3)))) goto LAB_00100a23;
...
LAB_0010084f:
        pEVar4 = ENGINE_get_pkey_meth(e,iVar3);
        param_3 = e;
        if (pEVar4 != (EVP_PKEY_METHOD *)0x0) goto LAB_00100ab0;
        ERR_new();
        ERR_set_debug("crypto/evp/pmeth_lib.c",0x127,"int_ctx_new");
        ERR_set_error(6,0x9c,0);
LAB_00100896:
        ENGINE_finish(param_3);
LAB_0010089e:
        local_158 = 0;
LAB_001008a7:
        EVP_KEYMGMT_free(local_158);
...
void EVP_PKEY_CTX_new_from_name(undefined8 param_1,undefined8 param_2,undefined8 param_3)

{
  int_ctx_new(param_1,0,0,param_2,param_3,0xffffffff);
  return;
}
...

{
  ...
  if ((*(ENGINE **)(ctx + 0x80) != (ENGINE *)0x0) &&
     (iVar3 = ENGINE_init(*(ENGINE **)(ctx + 0x80)), iVar3 == 0)) {
    ERR_new();
      ...
      *(undefined8 *)(ctx_00 + 0x18) = uVar1;
      if (pcVar5 != (char *)0x0) {
        ...
        *(char **)(ctx_00 + 0x10) = pcVar5;
        if (pcVar5 == (char *)0x0) goto LAB_001010c0;
        uVar4 = *(uint *)ctx;
      }
      *(undefined4 *)(ctx_00 + 0x74) = *(undefined4 *)(ctx + 0x74);
      if ((uVar4 & 0x800) == 0) {
        if ((uVar4 & 0xc1f0) == 0) {
          if ((uVar4 & 0x600) == 0) {
            if ((uVar4 & 0x3000) == 0) {
              if ((uVar4 & 6) == 0) goto LAB_00101107;
            }
            else {
              if (*(long *)(ctx + 0x28) == 0) goto LAB_00101100;
              *(long *)(ctx_00 + 0x28) = *(long *)(ctx + 0x28);
              iVar3 = EVP_KEM_up_ref();
              if (iVar3 != 0) {
                if (*(long *)(ctx + 0x30) == 0) goto LAB_00101107;
                if (*(long *)(ctx + 0x28) != 0) {
          ...
          *(long *)(ctx_00 + 0x90) = lVar6;
          if (lVar7 == 0) {
            if (*(int *)ctx_00 == 0) {
              ...
              lVar6 = evp_pkey_export_to_provider
                                (*(undefined8 *)(ctx + 0x88),*(undefined8 *)(ctx + 8),&local_28,
                                 *(undefined8 *)(ctx + 0x10));
              if ((lVar6 != 0) && (iVar3 = EVP_KEYMGMT_up_ref(local_28), iVar3 != 0)) {
...

{
  ...
  uVar2 = 0x268;
LAB_00101379:
  ERR_set_debug("crypto/evp/pmeth_lib.c",uVar2,"EVP_PKEY_meth_add0");
...

{
  ...
  if ((uVar1 & 0x800) == 0) {
    if ((uVar1 & 0xc1f0) != 0) {
      ...
      if (lVar4 == 0) goto LAB_001015b0;
LAB_0010154b:
      UNRECOVERED_JUMPTABLE_00 = *(code **)(lVar4 + 0xf0);
      if (UNRECOVERED_JUMPTABLE_00 != (code *)0x0) {
LAB_00101557:
                    /* WARNING: Could not recover jumptable at 0x00101564. Too many branches */
...
LAB_00101607:
    if (((uVar1 & 0x600) == 0) || (lVar4 = *(long *)(param_1 + 10), lVar4 == 0)) goto LAB_001015b0;
  }
  else {
    lVar4 = *(long *)(param_1 + 10);
    if (lVar4 == 0) {
      if ((uVar1 & 0xc1f0) != 0) goto LAB_001015b0;
      goto LAB_00101607;
    }
    UNRECOVERED_JUMPTABLE_00 = *(code **)(lVar4 + 0x58);
    if (UNRECOVERED_JUMPTABLE_00 != (code *)0x0) goto LAB_00101557;
    if ((uVar1 & 0xc1f0) != 0) goto LAB_0010154b;
LAB_001015a1:
    if ((uVar1 & 0x600) == 0) goto LAB_001015b0;
  }
...

{
  ...
  uVar1 = *param_1;
  if (((uVar1 & 0x800) == 0) || (lVar4 = *(long *)(param_1 + 10), lVar4 == 0)) {
    if ((uVar1 & 0xc1f0) == 0) {
      if ((uVar1 & 0x600) == 0) goto LAB_001016bc;
    }
    else {
      lVar4 = *(long *)(param_1 + 10);
      if (lVar4 != 0) goto LAB_00101709;
      if ((uVar1 & 0x600) != 0) goto LAB_00101728;
LAB_001016bc:
      if ((uVar1 & 0x3000) == 0) goto LAB_00101728;
    }
    lVar4 = *(long *)(param_1 + 10);
    if (lVar4 == 0) goto LAB_00101728;
  }
  else {
    UNRECOVERED_JUMPTABLE = *(code **)(lVar4 + 0x68);
    if (UNRECOVERED_JUMPTABLE != (code *)0x0) goto LAB_0010169d;
    if ((uVar1 & 0xc1f0) != 0) {
LAB_00101709:
      UNRECOVERED_JUMPTABLE = *(code **)(lVar4 + 0xe0);
      if (UNRECOVERED_JUMPTABLE != (code *)0x0) {
LAB_0010169d:
                    /* WARNING: Could not recover jumptable at 0x001016aa. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        uVar3 = (*UNRECOVERED_JUMPTABLE)(*(undefined8 *)(param_1 + 0xc),param_2);
        return uVar3;
      }
    }
    if ((uVar1 & 0x600) == 0) goto LAB_001016bc;
  ...
  if (*(code **)(lVar4 + 0x60) != (code *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x001016e0. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  uVar1 = *param_1;
  if (((uVar1 & 0x800) == 0) || (lVar3 = *(long *)(param_1 + 10), lVar3 == 0)) {
    if ((uVar1 & 0xc1f0) == 0) {
      if ((uVar1 & 0x600) != 0) {
        if (*(long *)(param_1 + 10) == 0) goto LAB_001017c0;
        lVar3 = *(long *)(*(long *)(param_1 + 10) + 0x68);
        goto joined_r0x00101867;
      }
    }
    else {
      lVar3 = *(long *)(param_1 + 10);
      if (lVar3 != 0) goto LAB_0010179e;
      if ((uVar1 & 0x600) != 0) goto LAB_001017c0;
    }
  }
  else {
    if (*(long *)(lVar3 + 0x70) != 0) {
      ...
      uVar2 = ossl_provider_ctx(uVar2);
                    /* WARNING: Could not recover jumptable at 0x001018cd. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
joined_r0x00101867:
      if (lVar3 == 0) goto LAB_001017c0;
      uVar2 = EVP_ASYM_CIPHER_get0_provider();
      goto LAB_00101832;
    }
  }
  if ((((uVar1 & 0x3000) == 0) || (*(long *)(param_1 + 10) == 0)) ||
     (*(long *)(*(long *)(param_1 + 10) + 0x68) == 0)) {
LAB_001017c0:
...
LAB_00101832:
  uVar2 = ossl_provider_ctx(uVar2);
                    /* WARNING: Could not recover jumptable at 0x0010184a. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if ((uVar1 & 0x800) == 0) {
    if ((uVar1 & 0xc1f0) == 0) {
LAB_0010199f:
      if (((uVar1 & 0x600) != 0) && (*(long *)(param_1 + 10) != 0)) {
    ...
    lVar4 = *(long *)(param_1 + 10);
    if (lVar4 == 0) {
      if ((uVar1 & 0xc1f0) == 0) goto LAB_0010199f;
    }
    else {
      if (*(long *)(lVar4 + 0x60) != 0) {
        uVar3 = EVP_KEYEXCH_get0_provider();
        uVar3 = ossl_provider_ctx(uVar3);
                    /* WARNING: Could not recover jumptable at 0x00101a45. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
joined_r0x00101988:
        if (lVar2 != 0) {
          ...
          uVar3 = ossl_provider_ctx(uVar3);
                    /* WARNING: Could not recover jumptable at 0x001019e8. Too many branches */
                    /* WARNING: Treating indirect jump as call */
          uVar3 = (**(code **)(*(long *)(param_1 + 10) + 0xf8))
...
joined_r0x001019ba:
  ...
  if ((((uVar1 & 6) != 0) && (*(long *)(param_1 + 8) != 0)) &&
     (*(long *)(*(long *)(param_1 + 8) + 0x88) != 0)) {
    uVar3 = EVP_KEYMGMT_get0_provider();
    uVar3 = ossl_provider_ctx(uVar3);
                    /* WARNING: Could not recover jumptable at 0x00101a20. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    uVar3 = (**(code **)(*(long *)(param_1 + 8) + 0x88))(*(undefined8 *)(param_1 + 10),uVar3);
    return uVar3;
  }
  if ((((uVar1 & 0x3000) == 0) || (*(long *)(param_1 + 10) == 0)) ||
     (*(long *)(*(long *)(param_1 + 10) + 0x78) == 0)) {
    return 0;
  }
  uVar3 = EVP_KEM_get0_provider();
LAB_00101955:
  uVar3 = ossl_provider_ctx(uVar3);
                    /* WARNING: Could not recover jumptable at 0x0010196d. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  local_20 = *(long *)(in_FS_OFFSET + 0x28);
  if ((param_1 == (uint *)0x0) || (param_3 = param_2, param_2 == 0)) {
...
{
  evp_pkey_ctx_set1_octet_string
            (param_1,*(long *)(param_1 + 0x30) == 0,&_LC6,0x800,0x1002,param_2,param_3);
  return;
}



void EVP_PKEY_CTX_set1_hkdf_salt(long param_1,undefined8 param_2,undefined8 param_3)

{
  evp_pkey_ctx_set1_octet_string
            (param_1,*(long *)(param_1 + 0x30) == 0,&_LC7,0x800,0x1004,param_2,param_3);
  return;
}
...
{
  evp_pkey_ctx_set1_octet_string
            (param_1,*(long *)(param_1 + 0x30) == 0,&_LC8,0x800,0x1005,param_2,param_3);
  return;
}



void EVP_PKEY_CTX_set1_pbe_pass(long param_1,undefined8 param_2,undefined8 param_3)

{
  evp_pkey_ctx_set1_octet_string
            (param_1,*(long *)(param_1 + 0x30) == 0,&_LC9,0x800,0x1008,param_2,param_3);
  return;
}



void EVP_PKEY_CTX_set1_scrypt_salt(long param_1,undefined8 param_2,undefined8 param_3)

{
  evp_pkey_ctx_set1_octet_string
            (param_1,*(long *)(param_1 + 0x30) == 0,&_LC7,0x800,0x1009,param_2,param_3);
  return;
}
...
{
  evp_pkey_ctx_set1_octet_string(param_1,*(long *)(param_1 + 0x28) == 0,&_LC10,4,6,param_2,param_3);
  return;
}
...

{
  ...
  if ((param_1 == (EVP_PKEY_CTX *)0x0) || ((*(uint *)param_1 & 0x800) == 0)) {
    ...
    OSSL_PARAM_construct_int(&local_b8,&_LC11,&local_7c);
    local_58 = local_98;
    local_78 = local_b8;
    uStack_70 = uStack_b0;
    local_68 = local_a8;
...

{
  ...
  if ((*(uint *)param_1 & 0x800) == 0) {
    ERR_new();
    ERR_set_debug("crypto/evp/pmeth_lib.c",0x40f,"evp_pkey_ctx_add1_octet_string");
    ERR_set_error(6,0x93,0);
    iVar2 = -2;
    goto LAB_001024f7;
  }
  ...
  if (param_3 < 0) {
    ...
    if (param_3 != 0) {
      ...
      if (lVar3 != 0) {
        lVar3 = OSSL_PARAM_locate_const(lVar3,&_LC12);
        if (lVar3 != 0) {
          OSSL_PARAM_construct_octet_string(&local_c8,&_LC12,0,0);
          local_78 = local_a8;
          local_98 = local_c8;
          uStack_90 = uStack_c0;
          local_88 = local_b8;
          ...
          if (((iVar2 != 0) && (local_78 != -1)) && (lVar3 = local_78 + __n, lVar3 != 0)) {
            lVar4 = CRYPTO_zalloc(lVar3,"crypto/evp/pmeth_lib.c",0x434);
            lVar1 = local_78;
            if (lVar4 != 0) {
              OSSL_PARAM_construct_octet_string(&local_c8,&_LC12,lVar4,lVar3);
              local_78 = local_a8;
              local_98 = local_c8;
              uStack_90 = uStack_c0;
              local_88 = local_b8;
...
LAB_0010270b:
      ...
      iVar2 = evp_pkey_ctx_set1_octet_string(param_1,0,&_LC12,0x800,0x1006,param_2,__n);
    }
  }
LAB_001024f7:
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
...
LAB_001028b8:
    ...
    puVar2 = &_LC13;
    if (param_2 != (void *)0x0) {
      puVar2 = (undefined *)EVP_MD_get0_name(param_2,uVar3,&_LC13);
    }
...
void EVP_PKEY_CTX_set_hkdf_md(long param_1,undefined8 param_2)

{
  evp_pkey_ctx_set_md_constprop_0(param_1,param_2,*(long *)(param_1 + 0x30) == 0,0x800,0x1003);
  return;
}
...
void EVP_PKEY_CTX_set_signature_md(long param_1,undefined8 param_2)

{
  evp_pkey_ctx_set_md_constprop_0(param_1,param_2,*(long *)(param_1 + 0x30) == 0,0xc1f0,1);
  return;
}
...
void EVP_PKEY_CTX_set_scrypt_maxmem_bytes(undefined8 param_1,undefined8 param_2)

{
  evp_pkey_ctx_set_uint64_constprop_0(param_1,"maxmem_bytes",0x100d,param_2);
  return;
}



void EVP_PKEY_CTX_set_scrypt_p(undefined8 param_1,undefined8 param_2)

{
  evp_pkey_ctx_set_uint64_constprop_0(param_1,&_LC15,0x100c,param_2);
  return;
}



void EVP_PKEY_CTX_set_scrypt_r(undefined8 param_1,undefined8 param_2)

{
  evp_pkey_ctx_set_uint64_constprop_0(param_1,&_LC16,0x100b,param_2);
  return;
}



void EVP_PKEY_CTX_set_scrypt_N(undefined8 param_1,undefined8 param_2)

{
  evp_pkey_ctx_set_uint64_constprop_0(param_1,&_LC17,0x100a,param_2);
  return;
}
...

{
  ...
  if (sVar1 < 0x80000000) {
    UNRECOVERED_JUMPTABLE = *(code **)(*(long *)(param_1 + 0x78) + 0xc0);
                    /* WARNING: Could not recover jumptable at 0x00102c1b. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    ...
    if (iVar1 < 2) {
      if (-1 < iVar1) {
        if ((*(long *)(param_1 + 0x78) != 0) &&
          ...
          if (iVar1 != 0) {
                    /* WARNING: Could not recover jumptable at 0x00102df2. Too many branches */
                    /* WARNING: Treating indirect jump as call */
            uVar2 = (*UNRECOVERED_JUMPTABLE)(param_1,param_2,param_3);
            return uVar2;
          }
          uVar2 = EVP_PKEY_CTX_md(param_1,0xc7f0,1,param_3);
          return uVar2;
        }
        ERR_new();
        uVar2 = 0x571;
...
void ossl_rsa_pkey_method(void)
...
void ossl_dsa_pkey_method(void)
...
void ossl_rsa_pss_pkey_method(void)
...
void ossl_dhx_pkey_method(void)
...
void ossl_ecx25519_pkey_method(void)
...
void ossl_ecx448_pkey_method(void)
...
void ossl_ed25519_pkey_method(void)
...
void ossl_ed448_pkey_method(void)

...

{
  ...
  lVar11 = lVar10 * 0xa0;
  puVar18 = (undefined8 *)(test_stanzas + lVar11);
  iVar6 = test_ptr("test/endecoder_legacy_test.c",0x202,"test_stanza = &test_stanzas[idx]",puVar18);
  if (iVar6 != 0) {
    __s2 = (char *)*puVar18;
    lVar19 = 0;
    ppuVar16 = &keys;
    do {
      iVar6 = strcmp(*ppuVar16,__s2);
      if (iVar6 == 0) {
        ppuVar16 = &keys + lVar19 * 4;
        goto LAB_00100a15;
      }
      lVar19 = lVar19 + 1;
      ppuVar16 = ppuVar16 + 4;
    ...
    if (iVar6 != 0) {
      ...
      if (iVar6 != 0) {
        ...
        if ((iVar6 != 0) &&
          ...
          if (iVar6 != 0) {
            pvVar12 = EVP_PKEY_get0(local_50);
            iVar6 = test_ptr("test/endecoder_legacy_test.c",0x20b,
                             "legacy_obj = EVP_PKEY_get0(downgraded_pkey)",pvVar12);
            if (iVar6 != 0) {
              local_b0 = 1;
              lVar19 = lVar10 * 0xa0;
              if (*(long *)(test_stanzas + lVar19 + 0x40) != 0) {
                puVar17 = puVar18;
                do {
                  uVar2 = puVar17[1];
                  test_info("test/endecoder_legacy_test.c",0x217,
                            "Test OSSL_ENCODER against PEM_write_bio_{TYPE}PrivateKey for %s, %s",
                            *(undefined8 *)(test_stanzas + lVar19),uVar2);
                  iVar6 = *(int *)(ppuVar16 + 1);
                  puVar3 = *ppuVar16;
                  local_48 = (EVP_PKEY *)0x0;
                  pcVar4 = *(code **)(test_stanzas + lVar19 + 0x80);
                  pcVar5 = *(code **)(test_stanzas + lVar19 + 0x40);
                  pBVar13 = BIO_s_mem();
                  a = BIO_new(pBVar13);
...
LAB_00100c5b:
                    EVP_PKEY_free(pkey);
                    EVP_PKEY_free(local_48);
                    OSSL_ENCODER_CTX_free(local_a0);
                    OSSL_DECODER_CTX_free(uVar15);
                    BIO_free(local_a8);
                    BIO_free(a);
                    local_b0 = 0;
                  }
                    ...
                    pBVar13 = BIO_s_mem();
                    local_a8 = BIO_new(pBVar13);
                    iVar8 = test_ptr("test/endecoder_legacy_test.c",0x13e,
                                     "membio_provided = BIO_new(BIO_s_mem())",local_a8);
                    if (iVar8 == 0) {
                      local_a0 = 0;
                      pkey = (EVP_PKEY *)0x0;
                      uVar15 = 0;
                    ...
                    local_a0 = OSSL_ENCODER_CTX_new_for_pkey(puVar1,0x87,&_LC8,uVar2,0);
...
LAB_00100c55:
                    ...
                    iVar8 = OSSL_ENCODER_to_bio(local_a0,local_a8);
                    iVar8 = test_true("test/endecoder_legacy_test.c",0x145,
                                      "OSSL_ENCODER_to_bio(ectx, membio_provided)",iVar8 != 0);
                    if (iVar8 == 0) goto LAB_00100c55;
                    iVar8 = (*pcVar5)(a,pvVar12,0,0,0,0,0);
                    iVar8 = test_true("test/endecoder_legacy_test.c",0x146,
                                      "pem_write_bio(membio_legacy, legacy_key, NULL, NULL, 0, NULL, NULL)"
                                      ,iVar8 != 0);
                    if ((iVar8 == 0) || (iVar8 = test_membio_str_eq(local_a8,a), iVar8 == 0))
                    goto LAB_00100c55;
                    if (pcVar4 != (code *)0x0) {
                      pkey = EVP_PKEY_new();
                      uVar15 = 0;
                      uVar14 = test_ptr("test/endecoder_legacy_test.c",0x14e,
                                        "decoded_legacy_pkey = EVP_PKEY_new()",pkey);
                      if ((int)uVar14 != 0) {
                        uVar20 = 0;
                        uVar15 = OSSL_DECODER_CTX_new_for_pkey(&local_48,&_LC8,uVar2,puVar3,0x87);
                        iVar8 = test_ptr("test/endecoder_legacy_test.c",0x14f,
                                         "dctx = OSSL_DECODER_CTX_new_for_pkey(&decoded_provided_pkey, \"PEM\", structure, keytype, selection, NULL, NULL)"
                                         ,uVar15);
                        if (iVar8 != 0) {
                          iVar8 = OSSL_DECODER_from_bio(uVar15,local_a8,uVar20,uVar14);
                          iVar8 = test_true("test/endecoder_legacy_test.c",0x154,
                                            "OSSL_DECODER_from_bio(dctx, membio_provided)",
                                            iVar8 != 0);
                          if (iVar8 != 0) {
                            key = (void *)(*pcVar4)(a,0,0,0);
...
LAB_00101422:
                  ...
                  puVar17 = puVar17 + 1;
                } while (puVar17 != (undefined8 *)(test_stanzas + lVar11 + 0x10));
              }
              lVar19 = lVar10 * 0xa0;
              if (*(long *)(test_stanzas + lVar19 + 0x48) != 0) {
                puVar17 = puVar18;
                do {
                  uVar2 = puVar17[1];
                  ...
                  iVar8 = test_unprotected_PEM
                                    (*ppuVar16,*(undefined4 *)(ppuVar16 + 1),pvVar12,
                                     *(undefined8 *)(test_stanzas + lVar19 + 0x48),
                                     *(undefined8 *)(test_stanzas + lVar19 + 0x88),EVP_PKEY_eq,
              ...
              lVar19 = lVar10 * 0xa0;
              if (*(long *)(test_stanzas + lVar19 + 0x50) != 0) {
                puVar17 = puVar18;
                do {
                  uVar2 = puVar17[1];
                  ...
                  iVar8 = test_unprotected_PEM
                                    (*ppuVar16,*(undefined4 *)(ppuVar16 + 1),pvVar12,
                                     *(undefined8 *)(test_stanzas + lVar19 + 0x50),
                                     *(undefined8 *)(test_stanzas + lVar19 + 0x90),
              ...
              lVar19 = lVar10 * 0xa0;
              if (*(long *)(test_stanzas + lVar19 + 0x58) == 0) {
LAB_00100ee5:
                iVar6 = local_b0;
              }
              else {
                test_info("test/endecoder_legacy_test.c",0x250,
                          ...
                          *(undefined8 *)(test_stanzas + lVar19),"SubjectPublicKeyInfo");
                iVar6 = test_unprotected_PEM
                                  (*ppuVar16,*(undefined4 *)(ppuVar16 + 1),pvVar12,
                                   *(undefined8 *)(test_stanzas + lVar19 + 0x58),
                                   *(undefined8 *)(test_stanzas + lVar19 + 0x98),EVP_PKEY_eq,
                                   _GLOBAL_OFFSET_TABLE_,puVar1,0x86,"SubjectPublicKeyInfo");
                if (iVar6 != 0) goto LAB_00100ee5;
              }
              lVar19 = lVar10 * 0xa0;
              if (*(long *)(test_stanzas + lVar19 + 0x20) != 0) {
                puVar17 = puVar18;
                do {
                  uVar2 = puVar17[1];
                  test_info("test/endecoder_legacy_test.c",0x262,
                            ...
                            *(undefined8 *)(test_stanzas + lVar19),uVar2);
                  iVar8 = test_DER(*ppuVar16,*(undefined4 *)(ppuVar16 + 1),pvVar12,
                                   *(undefined8 *)(test_stanzas + lVar19 + 0x20),
                                   *(undefined8 *)(test_stanzas + lVar19 + 0x60),EVP_PKEY_eq,
              ...
              lVar19 = lVar10 * 0xa0;
              if (*(long *)(test_stanzas + lVar19 + 0x28) != 0) {
                puVar17 = puVar18;
                do {
                  uVar2 = puVar17[1];
                  test_info("test/endecoder_legacy_test.c",0x276,
                            ...
                            *(undefined8 *)(test_stanzas + lVar19),uVar2);
                  iVar8 = test_DER(*ppuVar16,*(undefined4 *)(ppuVar16 + 1),pvVar12,
                                   *(undefined8 *)(test_stanzas + lVar19 + 0x28),
                                   *(undefined8 *)(test_stanzas + lVar19 + 0x68),EVP_PKEY_eq,
                                   &EVP_PKEY_print_public,puVar1,0x86,uVar2);
                  if (iVar8 == 0) {
                    iVar6 = 0;
                  }
              ...
              lVar19 = lVar10 * 0xa0;
              if (*(long *)(test_stanzas + lVar19 + 0x30) != 0) {
                do {
                  uVar2 = puVar18[1];
                  test_info("test/endecoder_legacy_test.c",0x288,
                            ...
                            *(undefined8 *)(test_stanzas + lVar19),uVar2);
                  iVar8 = test_DER(*ppuVar16,*(undefined4 *)(ppuVar16 + 1),pvVar12,
                                   *(undefined8 *)(test_stanzas + lVar19 + 0x30),
                                   *(undefined8 *)(test_stanzas + lVar19 + 0x70),
                  ...
                  puVar18 = puVar18 + 1;
                } while (puVar18 != (undefined8 *)(test_stanzas + lVar11 + 0x10));
              }
              lVar10 = lVar10 * 0xa0;
              if (*(long *)(test_stanzas + lVar10 + 0x38) == 0) goto LAB_001009a4;
              test_info("test/endecoder_legacy_test.c",0x299,
                        "Test OSSL_ENCODER against i2d_{TYPE}_PUBKEY for %s, %s",
                        *(undefined8 *)(test_stanzas + lVar10),"SubjectPublicKeyInfo");
              iVar8 = test_DER(*ppuVar16,*(undefined4 *)(ppuVar16 + 1),pvVar12,
                               *(undefined8 *)(test_stanzas + lVar10 + 0x38),
                               *(undefined8 *)(test_stanzas + lVar10 + 0x78),EVP_PKEY_eq,
                               _GLOBAL_OFFSET_TABLE_,puVar1,0x86,"SubjectPublicKeyInfo");
              if (iVar8 != 0) goto LAB_001009a4;
            }
          }
        }
      }
...
/* WARNING: Removing unreachable block (ram,0x00101753) */
...
LAB_00101600:
              ...
              ctx = (EVP_PKEY_CTX *)EVP_PKEY_CTX_new_from_name(0,puVar5,0);
              if (ctx == (EVP_PKEY_CTX *)0x0) goto LAB_00101600;
              iVar2 = EVP_PKEY_paramgen_init(ctx);
              if (((0 < iVar2) &&
                  ((*(long *)pEVar1 == 0 || (iVar2 = EVP_PKEY_CTX_set_params(ctx,pEVar1), 0 < iVar2)
                   ))) && (iVar2 = EVP_PKEY_generate(ctx), 0 < iVar2)) goto LAB_0010173d;
            }

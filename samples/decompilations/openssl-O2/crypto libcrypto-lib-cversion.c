...

{
  ...
  case 1:
    return 
    "compiler: /usr/bin/gcc -fPIC -pthread -m64 -Wa,--noexecstack -Wall -O2 -DOPENSSL_USE_NODELETE -DL_ENDIAN -DOPENSSL_PIC -DOPENSSL_BUILDING_OPENSSL -DNDEBUG"
    ;
  case 2:
    return "built on: Tue Feb 10 05:49:33 2026 UTC";
  case 3:

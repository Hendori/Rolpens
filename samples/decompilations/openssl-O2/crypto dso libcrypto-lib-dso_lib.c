...
DSO * DSO_new_method_isra_0(void)
  ...
  if (dso == (DSO *)0x0) {
    ...
    if ((dso->meth != (DSO_METHOD *)0x0) &&
       (UNRECOVERED_JUMPTABLE = dso->meth->dso_bind_func, UNRECOVERED_JUMPTABLE != (_func_3877 *)0x0
                    ...
                    /* WARNING: Could not recover jumptable at 0x001003b5. Too many branches */
...
LAB_001005d8:
      ...
      if (iVar3 == 0) {
        ...
        if (dso->filename == (char *)0x0) goto LAB_001005d8;
...

{
  ...
  if (pDVar2->pathbyaddr != (_func_3881 *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00100a2a. Too many branches */
                    /* WARNING: Treating indirect jump as call */

...
int gen_init(int *param_1,int param_2)

{
  ...
  if (param_1 == (int *)0x0) goto LAB_00100150;
  evp_pkey_ctx_free_old_ops();
  lVar4 = *(long *)(param_1 + 8);
  *param_1 = param_2;
  if ((lVar4 != 0) && (*(long *)(lVar4 + 0x60) != 0)) {
    if (param_2 == 2) {
      lVar4 = evp_keymgmt_gen_init(lVar4,0x84,0);
      *(long *)(param_1 + 10) = lVar4;
    }
    else if (param_2 == 4) {
      lVar4 = evp_keymgmt_gen_init(lVar4,3,0);
      *(long *)(param_1 + 10) = lVar4;
    }
    else {
...
LAB_00100150:
    ...
    if (param_2 == 2) {
      if (*(long *)(lVar4 + 0x28) != 0) goto LAB_001000f7;
      goto LAB_00100150;
    }
    if (param_2 == 4) {
      if (*(long *)(lVar4 + 0x38) == 0) goto LAB_00100150;
      ...
      if (lVar6 == 0) {
        if ((pEVar2 == (ENGINE *)0x0) || (*(long *)(pEVar2 + 0x60) == 0)) {
          if (param_1->type == 2) {
            ...
            if (param_1->type != 4) goto LAB_00100440;
            iVar4 = (**(code **)(*(long *)&param_1[2].references + 0x38))(param_1);
          }
          if (0 < iVar4) goto LAB_001003a1;
        }
        else {
          ERR_new(pEVar2,pEVar7);
          iVar4 = -1;
...
LAB_001003d0:
          lVar6 = evp_keymgmt_util_gen(*param_2,pcVar8,lVar6,ossl_callback_to_pkey_gencb,param_1);
          if (lVar6 != 0) {
          ...
          if (local_40[0] == (char *)0x0) goto LAB_00100440;

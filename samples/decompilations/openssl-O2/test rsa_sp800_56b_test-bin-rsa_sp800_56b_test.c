                ...
                if (iVar1 != 0) {
                  ...
                  if (iVar1 != 0) {
                    ...
                    iVar1 = test_int_eq("test/rsa_sp800_56b_test.c",0x130,
                                        ...
                                        &_LC26,uVar2,1);
                    if (iVar1 != 0) {
                      uVar3 = test_BN_eq_word("test/rsa_sp800_56b_test.c",0x131,"key->n",&_LC27,r->e
                                              ,0xff);
                      if (uVar3 == 0) goto LAB_0010064a;
                      iVar1 = test_BN_eq_word("test/rsa_sp800_56b_test.c",0x132,"key->dmp1",&_LC29,
                                              r->dmq1,3);
                      if (iVar1 != 0) {
                        iVar1 = test_BN_eq_word("test/rsa_sp800_56b_test.c",0x133,"key->dmq1",&_LC31
                                                ,r->iqmp,0xd);
                        if (iVar1 != 0) {
                          iVar1 = test_BN_eq_word("test/rsa_sp800_56b_test.c",0x134,"key->iqmp",
                                                  &_LC33,(r->ex_data).sk,8);
                          if (iVar1 != 0) {

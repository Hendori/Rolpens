                                                    ...
                                                    if (iVar2 != 0) {
                                                      ...
                                                      if (iVar2 != 0) {
                                                        iVar2 = test_mem_eq("test/test_test.c",0x1f2
                                                                            ,&_LC64,"\"3456\"",
                                                                            &DAT_0010424e,5,&_LC60,5
                                                                           );
                                                        if (iVar2 != 0) {
                                                          iVar2 = test_mem_ne("test/test_test.c",499
                                                                              ,&_LC49,"\"456\"",
                                                                              &DAT_0010424e,4,&_LC62
                                                                              ,4);
                                                          if (iVar2 != 0) {
...
undefined8 test_case_part_0(undefined4 param_1,undefined8 param_2)
...

{
  ...
  *(undefined2 *)(pcVar9 + 4) = _LC321._316_2_;
  ...
  local_238 = __LC339;
  uStack_230 = _UNK_001061a8;
  local_228 = __LC340;
  uStack_220 = _UNK_001061b8;
  local_218 = __LC341;
  uStack_210 = _UNK_001061c8;
  local_208 = __LC342;
  uStack_200 = _UNK_001061d8;
  local_288 = __LC343;
  uStack_280 = _UNK_001061e8;
  local_278 = __LC344;
  uStack_270 = _UNK_001061f8;
  local_268 = __LC345;
  uStack_260 = _UNK_00106208;
  local_258 = __LC346;
  uStack_250 = _UNK_00106218;
...
LAB_00103e90:
    ...
    if ((((iVar1 == 0) || (iVar1 = test_case_part_0(0,"TEST_BN_le(b, c)"), iVar1 != 0)) &&
        ((iVar1 = test_BN_gt("test/test_test.c",0x16f,&_LC327,&_LC334,local_58,local_48), iVar1 == 1
         || (iVar1 = test_case_part_0(1,"TEST_BN_gt(a, c)"), iVar1 != 0)))) &&
       ((((iVar1 = test_BN_gt("test/test_test.c",0x170,&_LC334,&_LC326,local_48,local_50),
          iVar1 == 0 || (iVar1 = test_case_part_0(0,"TEST_BN_gt(c, b)"), iVar1 != 0)) &&
         ((iVar1 = test_BN_gt("test/test_test.c",0x171,&_LC326,&_LC334,local_50,local_48),
          iVar1 == 1 || (iVar1 = test_case_part_0(1,"TEST_BN_gt(b, c)"), iVar1 != 0)))) &&
        (((iVar1 = test_BN_ge("test/test_test.c",0x172,&_LC327,&_LC334,local_58,local_48),
          iVar1 == 1 || (iVar1 = test_case_part_0(1,"TEST_BN_ge(a, c)"), iVar1 != 0)) &&
         ((iVar1 = test_BN_ge("test/test_test.c",0x173,&_LC334,&_LC326,local_48,local_50),
          iVar1 == 0 || (iVar1 = test_case_part_0(0,"TEST_BN_ge(c, b)"), iVar1 != 0)))))))) {
      uVar2 = test_BN_ge("test/test_test.c",0x174,&_LC326,&_LC334,local_50,local_48);
      if (uVar2 != 1) {
        iVar1 = test_case_part_0(1,"TEST_BN_ge(b, c)");
        uVar2 = (uint)(iVar1 != 0);
      }
      goto LAB_00103e44;
    }

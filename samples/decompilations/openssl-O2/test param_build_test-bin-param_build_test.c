...

{
  ...
  local_50 = (BIGNUM *)0x0;
  local_48 = (BIGNUM *)0x0;
  piVar4 = (int *)CRYPTO_secure_malloc(0x30,"test/param_build_test.c",0xfb);
  iVar2 = test_ptr("test/param_build_test.c",0xfb,"data1 = OPENSSL_secure_malloc(data1_size)",piVar4
                  );
  if (iVar2 == 0) {
    local_a0 = (BIGNUM *)0x0;
    uVar6 = 0;
    ...
    puVar5 = (undefined8 *)CRYPTO_secure_malloc(0x14,"test/param_build_test.c",0xfc);
    iVar2 = test_ptr("test/param_build_test.c",0xfc,"data2 = OPENSSL_secure_malloc(data2_size)",
                     puVar5);
    if (iVar2 == 0) {
      local_a0 = (BIGNUM *)0x0;
      uVar6 = 0;
      ...
      uVar6 = OSSL_PARAM_BLD_new();
      iVar2 = test_ptr("test/param_build_test.c",0xfd,"bld = OSSL_PARAM_BLD_new()",uVar6);
      auVar1 = __LC89;
      if (iVar2 != 0) {
        piVar7 = piVar4;
        auVar14 = __LC85;
        do {
          auVar15._0_4_ = auVar14._0_4_ + auVar1._0_4_;
          auVar15._4_4_ = auVar14._4_4_ + auVar1._4_4_;
          auVar15._8_4_ = auVar14._8_4_ + auVar1._8_4_;
          auVar15._12_4_ = auVar14._12_4_ + auVar1._12_4_;
          piVar8 = piVar7 + 4;
          *piVar7 = auVar14._0_4_ * -0x10;
          piVar7[1] = auVar14._4_4_ * -0x10;
          piVar7[2] = auVar14._8_4_ * -0x10;
          piVar7[3] = auVar14._12_4_ * -0x10;
          uVar17 = _UNK_00105118;
          uVar12 = __LC90;
          piVar7 = piVar8;
          auVar14 = auVar15;
        } while (piVar8 != piVar4 + 0xc);
        *(undefined4 *)(puVar5 + 2) = 8;
        *puVar5 = uVar12;
        puVar5[1] = uVar17;
        iVar2 = OSSL_PARAM_BLD_push_uint(uVar6,&_LC2,6);
        iVar2 = test_true("test/param_build_test.c",0x105,"OSSL_PARAM_BLD_push_uint(bld, \"i\", 6)",
                          iVar2 != 0);
        if (iVar2 != 0) {
          iVar2 = OSSL_PARAM_BLD_push_ulong(uVar6,&_LC4,0x2a);
          iVar2 = test_true("test/param_build_test.c",0x106,
                            "OSSL_PARAM_BLD_push_ulong(bld, \"l\", 42)",iVar2 != 0);
          if (iVar2 != 0) {
            iVar2 = OSSL_PARAM_BLD_push_uint32(uVar6,&_LC6,0x5fc);
            iVar2 = test_true("test/param_build_test.c",0x107,
                              "OSSL_PARAM_BLD_push_uint32(bld, \"i32\", 1532)",iVar2 != 0);
            if (iVar2 != 0) {
              iVar2 = OSSL_PARAM_BLD_push_uint64(uVar6,&_LC8,9999999);
              iVar2 = test_true("test/param_build_test.c",0x108,
                                "OSSL_PARAM_BLD_push_uint64(bld, \"i64\", 9999999)",iVar2 != 0);
              if (iVar2 != 0) {
                iVar2 = OSSL_PARAM_BLD_push_size_t(uVar6,&_LC10,0x10001);
                iVar2 = test_true("test/param_build_test.c",0x109,
                                  "OSSL_PARAM_BLD_push_size_t(bld, \"st\", 65537)",iVar2 != 0);
                if (iVar2 != 0) {
                  local_90 = (BIGNUM *)BN_secure_new();
                  iVar2 = test_ptr("test/param_build_test.c",0x10a,"zbn = BN_secure_new()",local_90)
                  ;
                  if (iVar2 != 0) {
                    iVar2 = OSSL_PARAM_BLD_push_BN(uVar6,"zeronumber",local_90);
                    iVar2 = test_true("test/param_build_test.c",0x10b,
                                      "OSSL_PARAM_BLD_push_BN(bld, \"zeronumber\", zbn)",iVar2 != 0)
                    ;
                    if (iVar2 != 0) {
                      local_98 = (BIGNUM *)BN_secure_new();
                      iVar2 = test_ptr("test/param_build_test.c",0x10c,"pbn = BN_secure_new()",
                                       local_98);
                      if (iVar2 != 0) {
                        iVar2 = BN_set_word(local_98,0x6c1);
                        iVar2 = test_true("test/param_build_test.c",0x10d,"BN_set_word(pbn, 1729)",
                                          iVar2 != 0);
                        if (iVar2 != 0) {
                          iVar2 = OSSL_PARAM_BLD_push_BN(uVar6,"bignumber",local_98);
                          iVar2 = test_true("test/param_build_test.c",0x10e,
                                            "OSSL_PARAM_BLD_push_BN(bld, \"bignumber\", pbn)",
                                            iVar2 != 0);
                          if (iVar2 != 0) {
                            local_a0 = (BIGNUM *)BN_secure_new();
                            iVar2 = test_ptr("test/param_build_test.c",0x10f,"nbn = BN_secure_new()"
                                             ,local_a0);
                            if (iVar2 != 0) {
                              iVar2 = BN_set_word(local_a0,0x6c5);
                              iVar2 = test_true("test/param_build_test.c",0x110,
                                                "BN_set_word(nbn, 1733)",iVar2 != 0);
                              if (iVar2 != 0) {
                                BN_set_negative(local_a0,1);
                                iVar2 = test_true("test/param_build_test.c",0x111,
                                                  "(BN_set_negative(nbn, 1), 1)",1);
                                if (iVar2 != 0) {
                                  iVar2 = OSSL_PARAM_BLD_push_BN(uVar6,"negativebignumber",local_a0)
                                  ;
                                  iVar2 = test_true("test/param_build_test.c",0x112,
                                                                                                        
                                                  "OSSL_PARAM_BLD_push_BN(bld, \"negativebignumber\", nbn)"
                                                  ,iVar2 != 0);
                                  if (iVar2 != 0) {
                                    iVar2 = OSSL_PARAM_BLD_push_octet_string
                                                      (uVar6,"oct_s",piVar4,0x30);
                                    iVar2 = test_true("test/param_build_test.c",0x113,
                                                                                                            
                                                  "OSSL_PARAM_BLD_push_octet_string(bld, \"oct_s\", data1, data1_size)"
                                                  ,iVar2 != 0);
                                    if (iVar2 != 0) {
                                      iVar2 = OSSL_PARAM_BLD_push_octet_ptr
                                                        (uVar6,"oct_p",puVar5,0x14);
                                      iVar2 = test_true("test/param_build_test.c",0x115,
                                                                                                                
                                                  "OSSL_PARAM_BLD_push_octet_ptr(bld, \"oct_p\", data2, data2_size)"
                                                  ,iVar2 != 0);
                                      if (iVar2 != 0) {
                                        lVar9 = OSSL_PARAM_BLD_to_param(uVar6);
                                        iVar2 = test_ptr("test/param_build_test.c",0x117,
                                        ...
                                        if (iVar2 == 0) {
                                          ...
                                          if (param_1 == 2) {
                                            ...
                                            if (param_1 == 0) {
                                              ...
                                              if (param_1 != 1) goto LAB_00102608;
                                              lVar10 = OSSL_PARAM_merge(lVar9,params_empty);
                                              uVar12 = 0;
                                            }
                                          }
                                          else if (param_1 == 3) {
                                            uVar12 = OSSL_PARAM_merge(lVar9,params_empty);
                                            lVar10 = OSSL_PARAM_dup(uVar12);
                                          }
                                          else {
LAB_00102608:
                                            uVar12 = OSSL_PARAM_dup(lVar9);
                                            lVar10 = OSSL_PARAM_merge(uVar12,params_empty);
                                          }
                                          puVar11 = (undefined8 *)OSSL_PARAM_locate(lVar10,&_LC2);
                                          iVar2 = test_ptr("test/param_build_test.c",0x12d,
                                                           "p = OSSL_PARAM_locate(params, \"i\")",
                                                           puVar11);
                                          if (iVar2 != 0) {
                                            iVar2 = CRYPTO_secure_allocated(puVar11[2]);
                                            iVar2 = test_false("test/param_build_test.c",0x12e,
                                                               "CRYPTO_secure_allocated(p->data)",
                                                               iVar2 != 0);
                                            if (iVar2 != 0) {
                                              iVar2 = OSSL_PARAM_get_uint(puVar11,&local_78);
                                              iVar2 = test_true("test/param_build_test.c",0x12f,
                                                                "OSSL_PARAM_get_uint(p, &i)",
                                                                iVar2 != 0);
                                              if (iVar2 != 0) {
                                                iVar2 = test_str_eq("test/param_build_test.c",0x130,
                                                                    "p->key",&_LC31,*puVar11,&_LC2);
                                                if (iVar2 != 0) {
                                                  iVar2 = test_uint_eq("test/param_build_test.c",
                                                                       0x131,"p->data_type",
                                                                       "OSSL_PARAM_UNSIGNED_INTEGER"
                                                                       ,*(undefined4 *)(puVar11 + 1)
                                                                       ,2);
                                                  if (iVar2 != 0) {
                                                    iVar2 = test_size_t_eq("test/param_build_test.c"
                                                                           ,0x132,"p->data_size",
                                                                           "sizeof(int)",puVar11[3],
                                                                           4);
                                                    if (iVar2 != 0) {
                                                      iVar2 = test_uint_eq("test/param_build_test.c"
                                                                           ,0x133,&_LC2,&_LC37,
                                                      ...
                                                      if (iVar2 != 0) {
                                                        puVar11 = (undefined8 *)
                                                                  OSSL_PARAM_locate(lVar10,&_LC6);
                                                        iVar2 = test_ptr("test/param_build_test.c",
                                                                         0x135,
                                                  "p = OSSL_PARAM_locate(params, \"i32\")",puVar11);
                                                  if (iVar2 != 0) {
                                                    iVar2 = CRYPTO_secure_allocated(puVar11[2]);
                                                    iVar2 = test_false("test/param_build_test.c",
                                                                       0x136,
                                                  "CRYPTO_secure_allocated(p->data)",iVar2 != 0);
                                                  if (iVar2 != 0) {
                                                    iVar2 = OSSL_PARAM_get_uint32(puVar11,&local_74)
                                                    ;
                                                    iVar2 = test_true("test/param_build_test.c",
                                                                      0x137,
                                                  "OSSL_PARAM_get_uint32(p, &i32)",iVar2 != 0);
                                                  if (iVar2 != 0) {
                                                    iVar2 = test_str_eq("test/param_build_test.c",
                                                                        0x138,"p->key","\"i32\"",
                                                                        *puVar11,&_LC6);
                                                    if (iVar2 != 0) {
                                                      iVar2 = test_uint_eq("test/param_build_test.c"
                                                  ...
                                                  *(undefined4 *)(puVar11 + 1),2);
                                                  if (iVar2 != 0) {
                                                    ...
                                                    if (iVar2 != 0) {
                                                      iVar2 = test_uint_eq("test/param_build_test.c"
                                                                           ,0x13b,
                                                  "(unsigned int)i32",&_LC106,local_74,0x5fc);
                                                  if (iVar2 != 0) {
                                                    puVar11 = (undefined8 *)
                                                              OSSL_PARAM_locate(lVar10,&_LC8);
                                                    iVar2 = test_ptr("test/param_build_test.c",0x13d
                                                                     ,
                                                  "p = OSSL_PARAM_locate(params, \"i64\")",puVar11);
                                                  if (iVar2 != 0) {
                                                    iVar2 = CRYPTO_secure_allocated(puVar11[2]);
                                                    iVar2 = test_false("test/param_build_test.c",
                                                                       0x13e,
                                                  ...
                                                  *(undefined4 *)(puVar11 + 1),2);
                                                  if (iVar2 != 0) {
                                                    iVar2 = test_size_t_eq("test/param_build_test.c"
                                                                           ...
                                                                           puVar11[3],8);
                                                    if (iVar2 != 0) {
                                                      iVar2 = OSSL_PARAM_get_uint64
                                                                        (puVar11,&local_68);
                                                      iVar2 = test_true("test/param_build_test.c",
                                                                        0x142,
                                                  "OSSL_PARAM_get_uint64(p, &i64)",iVar2 != 0);
                                                  if (iVar2 != 0) {
                                                    iVar2 = test_ulong_eq("test/param_build_test.c",
                                                                          0x143,"(unsigned long)i64"
                                                                          ,"9999999",local_68,
                                                                          9999999);
                                                    if (iVar2 != 0) {
                                                      puVar11 = (undefined8 *)
                                                                OSSL_PARAM_locate(lVar10,&_LC4);
                                                      iVar2 = test_ptr("test/param_build_test.c",
                                                                       0x145,
                                                  "p = OSSL_PARAM_locate(params, \"l\")",puVar11);
                                                  if (iVar2 != 0) {
                                                    iVar2 = CRYPTO_secure_allocated(puVar11[2]);
                                                    iVar2 = test_false("test/param_build_test.c",
                                                                       0x146,
                                                  ...
                                                  *(undefined4 *)(puVar11 + 1),2);
                                                  ...
                                                  "sizeof(unsigned long int)",puVar11[3],8);
                                                  if (iVar2 != 0) {
                                                    iVar2 = OSSL_PARAM_get_ulong(puVar11,&local_70);
                                                    iVar2 = test_true("test/param_build_test.c",
                                                                      0x14a,
                                                  "OSSL_PARAM_get_ulong(p, &l)",iVar2 != 0);
                                                  if (iVar2 != 0) {
                                                    iVar2 = test_ulong_eq("test/param_build_test.c",
                                                                          0x14b,&_LC4,&_LC54,
                                                                          local_70,0x2a);
                                                    if (iVar2 != 0) {
                                                      puVar11 = (undefined8 *)
                                                                OSSL_PARAM_locate(lVar10,&_LC10);
                                                      iVar2 = test_ptr("test/param_build_test.c",
                                                                       0x14d,
                                                  "p = OSSL_PARAM_locate(params, \"st\")",puVar11);
                                                  if (iVar2 != 0) {
                                                    iVar2 = CRYPTO_secure_allocated(puVar11[2]);
                                                    iVar2 = test_false("test/param_build_test.c",
                                                                       0x14e,
                                                  ...
                                                  *(undefined4 *)(puVar11 + 1),2);
                                                  if (iVar2 != 0) {
                                                    iVar2 = test_size_t_eq("test/param_build_test.c"
                                                                           ...
                                                                           puVar11[3],8);
                                                    if (iVar2 != 0) {
                                                      iVar2 = OSSL_PARAM_get_size_t
                                                                        (puVar11,&local_60);
                                                      iVar2 = test_true("test/param_build_test.c",
                                                                        0x152,
                                                  "OSSL_PARAM_get_size_t(p, &st)",iVar2 != 0);
                                                  if (iVar2 != 0) {
                                                    iVar2 = test_size_t_eq("test/param_build_test.c"
                                                                           ,0x153,&_LC10,"65537",
                                                                           local_60,0x10001);
                                                    if (iVar2 != 0) {
                                                      puVar11 = (undefined8 *)
                                                                OSSL_PARAM_locate(lVar10,"oct_s");
                                                      iVar2 = test_ptr("test/param_build_test.c",
                                                                       0x155,
                                                  "p = OSSL_PARAM_locate(params, \"oct_s\")",puVar11
                                                  );
                                                  if (iVar2 != 0) {
                                                    iVar2 = CRYPTO_secure_allocated(puVar11[2]);
                                                    iVar2 = test_true("test/param_build_test.c",
                                                  ...
                                                  puVar11[2],puVar11[3],piVar4,0x30);
                                                  if (iVar2 != 0) {
                                                    puVar11 = (undefined8 *)
                                                              OSSL_PARAM_locate(lVar10,"oct_p");
                                                    iVar2 = test_ptr("test/param_build_test.c",0x15b
                                                                     ,
                                                  "p = OSSL_PARAM_locate(params, \"oct_p\")",puVar11
                                                  );
                                                  if (iVar2 != 0) {
                                                    iVar2 = CRYPTO_secure_allocated(puVar11[2]);
                                                    iVar2 = test_false("test/param_build_test.c",
                                                  ...
                                                  "*(void **)p->data","data2",
                                                  *(undefined8 *)puVar11[2],puVar11[3]);
                                                  if (iVar2 != 0) {
                                                    puVar11 = (undefined8 *)
                                                              OSSL_PARAM_locate(lVar10,"zeronumber",
                                                                                puVar16,uVar17);
                                                    iVar2 = test_ptr("test/param_build_test.c",0x162
                                                                     ,
                                                  ...
                                                  *(undefined4 *)(puVar11 + 1),2);
                                                  if (iVar2 != 0) {
                                                    iVar2 = OSSL_PARAM_get_BN(puVar11,&local_58);
                                                    iVar2 = test_true("test/param_build_test.c",
                                                                      0x166,
                                                  "OSSL_PARAM_get_BN(p, &zbn_res)",iVar2 != 0);
                                                  if (iVar2 != 0) {
                                                    uVar3 = BN_get_flags(local_98,8);
                                                    iVar2 = test_int_eq("test/param_build_test.c",
                                                                        0x167,
                                                  "BN_get_flags(pbn, BN_FLG_SECURE)","BN_FLG_SECURE"
                                                  ,uVar3,8);
                                                  if (iVar2 != 0) {
                                                    iVar2 = test_BN_eq("test/param_build_test.c",
                                                                       0x168,"zbn_res",&_LC113,
                                                                       local_58,local_90);
                                                    if (iVar2 != 0) {
                                                      puVar11 = (undefined8 *)
                                                                OSSL_PARAM_locate(lVar10,"bignumber"
                                                                                 );
                                                      iVar2 = test_ptr("test/param_build_test.c",
                                                                       0x16a,
                                                  ...
                                                  *(undefined4 *)(puVar11 + 1),2);
                                                  if (iVar2 != 0) {
                                                    iVar2 = OSSL_PARAM_get_BN(puVar11,&local_50);
                                                    iVar2 = test_true("test/param_build_test.c",
                                                                      0x16e,
                                                  "OSSL_PARAM_get_BN(p, &pbn_res)",iVar2 != 0);
                                                  if (iVar2 != 0) {
                                                    uVar3 = BN_get_flags(local_98,8);
                                                    iVar2 = test_int_eq("test/param_build_test.c",
                                                                        0x16f,
                                                  ...
                                                  if (iVar2 != 0) {
                                                    iVar2 = test_BN_eq("test/param_build_test.c",
                                                                       0x170,"pbn_res",&_LC118,
                                                                       local_50,local_98);
                                                    if (iVar2 != 0) {
                                                      puVar11 = (undefined8 *)
                                                                OSSL_PARAM_locate(lVar10,
                                                  "negativebignumber");
                                                  iVar2 = test_ptr("test/param_build_test.c",0x172,
                                                    ...
                                                    if (iVar2 != 0) {
                                                      iVar2 = test_uint_eq("test/param_build_test.c"
                                                                           ...
                                                                           *(undefined4 *)
                                                                            (puVar11 + 1),1);
                                                      if (iVar2 != 0) {
                                                        iVar2 = OSSL_PARAM_get_BN(puVar11,&local_48)
                                                        ;
                                                        iVar2 = test_true("test/param_build_test.c",
                                                                          0x176,
                                                  "OSSL_PARAM_get_BN(p, &nbn_res)",iVar2 != 0);
                                                  if (iVar2 != 0) {
                                                    uVar3 = BN_get_flags(local_a0,8);
                                                    iVar2 = test_int_eq("test/param_build_test.c",
                                                                        0x177,
...
LAB_0010175a:
                                        OSSL_PARAM_free(uVar12);
                                        if (lVar10 != lVar9) {
                                          OSSL_PARAM_free(lVar10);
                                        }
                                        goto LAB_001011ce;
                                      }
                                    }
...
LAB_001011ce:
  ...
  OSSL_PARAM_BLD_free(uVar6);
  CRYPTO_secure_free(piVar4,"test/param_build_test.c",0x181);
  CRYPTO_secure_free(puVar5,"test/param_build_test.c",0x182);
  BN_free(local_90);
  BN_free(local_58);
  BN_free(local_98);
  BN_free(local_50);
              ...
              if (iVar1 != 0) {
                ...
                if (iVar1 != 0) {
                  ...
                  if (iVar1 != 0) {
                    ...
                    if (iVar1 != 0) {
                      iVar1 = test_BN_eq("test/param_build_test.c",0x49,"zbn_res",&_LC113,local_48,a
                                        );
                      bVar6 = iVar1 != 0;
                      goto LAB_001026ec;
                    }
            ...
            if (iVar1 != 0) {
              ...
              if (iVar1 != 0) {
                ...
                iVar1 = test_true("test/param_build_test.c",0x26,"OSSL_PARAM_get_BN(p, &zbn_res)",
                                  iVar1 != 0);
                if (iVar1 != 0) {
                  iVar1 = test_BN_eq("test/param_build_test.c",0x27,"zbn_res",&_LC113,local_48,a);
                  bVar6 = iVar1 != 0;
                  goto LAB_0010298f;
                }
              }
...
LAB_00102bea:
    ...
    if (iVar1 == 0) goto LAB_00102bea;
    iVar1 = OSSL_PARAM_BLD_push_time_t(uVar3,&_LC133,0x2bd8);
    iVar1 = test_true("test/param_build_test.c",0x6b,"OSSL_PARAM_BLD_push_time_t(bld, \"t\", 11224)"
                      ,iVar1 != 0);
    if (iVar1 == 0) goto LAB_00102bea;
    iVar1 = OSSL_PARAM_BLD_push_double(_LC135,uVar3,&_LC136);
            ...
            if (iVar1 != 0) {
              ...
              if (iVar1 != 0) {
                ...
                iVar1 = test_true("test/param_build_test.c",0x75,
                                  ...
                                  iVar1 != 0);
                if (iVar1 != 0) {
                  iVar1 = OSSL_PARAM_BLD_push_utf8_string(uVar3,"utf8_s",&_LC139,4);
...
LAB_001031b9:
                            ...
                            if (param_1 != 0) {
                              if (param_1 != 1) goto LAB_001031b9;
                          ...
                          if (uVar2 != 0) {
                            ...
                            if (iVar1 != 0) {
                              ...
                              if (iVar1 != 0) {
                                ...
                                if (iVar1 != 0) {
                                  iVar1 = test_int_eq("test/param_build_test.c",0x97,&_LC2,&_LC147,
                                                      local_90,0xfffffffa);
                                  if (iVar1 != 0) {
                                            ...
                                            if (iVar1 != 0) {
                                              ...
                                              if (iVar1 != 0) {
                                                ...
                                                if (iVar1 != 0) {
                                                  ...
                                                  if (iVar1 != 0) {
                                                    iVar1 = test_double_eq(local_60,_LC135,

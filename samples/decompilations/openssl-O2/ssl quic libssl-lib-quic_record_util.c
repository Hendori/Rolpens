    ...
    if (lVar3 != 0) {
      ...
      iVar1 = ossl_quic_hkdf_extract
                        (param_1,param_2,lVar3,quic_v1_initial_salt,0x14,param_3 + 1,*param_3,
                         local_a8,0x20);
      if (iVar1 == 0) goto LAB_00100418;
      if (param_6 == 0) {
        if (param_5 == 0) goto LAB_0010029e;
        if (local_c8 == local_88) {
          pcVar4 = quic_client_in_label;
LAB_00100481:
          iVar1 = tls13_hkdf_expand_ex(param_1,param_2,lVar3,local_a8,pcVar4,9,0,0,local_c8,0x20,1);
          if (iVar1 == 0) goto LAB_00100418;
        }
        else {
LAB_001003a7:
        ...
        iVar1 = ossl_qrx_provide_secret(param_5,0,1,lVar3,local_c8,0x20);
        if (iVar1 != 0) {
...
LAB_001003dc:
      ...
      else if (local_d0 == local_88) {
        iVar1 = tls13_hkdf_expand_ex
                          (param_1,param_2,lVar3,local_a8,quic_client_in_label,9,0,0,local_d0,0x20,1
                          );
        if (iVar1 == 0) goto LAB_00100418;
LAB_001003a2:
        if (param_5 != 0) goto LAB_001003a7;
LAB_001003ec:
        iVar1 = ossl_qtx_provide_secret(param_6,0,1,lVar3,local_d0,0x20);
        if (iVar1 != 0) goto LAB_0010029e;
      }
      else {
        if ((param_5 == 0) || (local_c8 != local_88)) {
          if (local_d0 != local_68) goto LAB_001003a2;
        }
        else {
          iVar1 = tls13_hkdf_expand_ex
                            (param_1,param_2,lVar3,local_a8,quic_client_in_label,9,0,0,local_88,0x20
                             ,1);
          if (iVar1 == 0) goto LAB_00100418;
          if (local_d0 != local_68) goto LAB_001003a7;
        }
        iVar1 = tls13_hkdf_expand_ex

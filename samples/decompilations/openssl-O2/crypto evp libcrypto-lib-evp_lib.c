...

{
  ...
  if (0 < iVar1) {
    ...
    *(int *)(param_1 + 8) = (int)local_1c0;
    ...
    lVar3 = OSSL_PARAM_locate_const(uVar2,"algorithm-id-params");
    if (lVar3 != 0) {
...

{
  ...
  if (param_1->cipher[2].get_asn1_parameters == (_func_1093 *)0x0) {
    ...
    if (((uVar2 & 0x800) != 0) && (iVar1 = EVP_CIPHER_CTX_ctrl(param_1,0x25,0,&local_84), iVar1 < 1)
       ) goto LAB_00100822;
  }
  else {
...
LAB_00100822:
      ...
      if ((iVar1 != 0) && (iVar1 = OSSL_PARAM_get_int(local_78,&local_84), iVar1 == 0))
      goto LAB_00100822;
    }
  }
...

{
  ...
  if (param_1[0xe] == 0) {
    puVar3 = (undefined8 *)
             EVP_MD_meth_new(*(undefined4 *)param_1,*(undefined4 *)((long)param_1 + 4));
...

{
  ...
  if ((lVar2 == 0) || (lVar2 = OSSL_PARAM_locate_const(lVar2,&_LC16), lVar2 == 0)) {
    ...
    uVar3 = 0xffffffff;
    if ((iVar1 == 1) && (uVar3 = 0xffffffff, local_80 - 1 < 0xfffffffffffffffe)) {
...

{
  ...
  if (iVar2 != 0) {
    ...
    if ((iVar2 == 0) || (local_b8[4] == 0)) {
      ...
      if ((iVar2 == 0) || (local_120 = local_b8[9], local_b8[9] == 0)) goto LAB_0010253d;
      local_100 = 1;
    }
    else {
      iVar2 = OSSL_PARAM_modified(local_b8 + 5);
    ...
    if (ptr != (uchar *)0x0) {
      ...
      iVar2 = EVP_CIPHER_CTX_get_params(param_1,local_b8);
      if (((iVar2 == 0) ||
          (iVar2 = OSSL_PARAM_modified((long)local_b8 + (ulong)(-(int)local_100 & 0x28)), iVar2 == 0
          )) || (pAVar3 = d2i_ASN1_TYPE(&local_c8,&local_c0,(long)(int)local_120),
      ...
      if ((uVar3 & 0x1000000) == 0) {
        ...
        if (iVar2 != 0x10001) {
          if (iVar2 < 0x10002) {
            ...
            if (iVar2 != 0x10003) {
LAB_001028dd:
              iVar2 = EVP_CIPHER_set_asn1_iv(param_1,param_2);
              goto LAB_00102784;
            }
          }
        }
...
LAB_00102af0:
  ...
  if (param_2 == (X509_ALGOR **)0x0) goto LAB_00102af0;
  local_a0 = (uchar *)0x0;
...
LAB_00102a75:
    ...
    local_a0 = ptr;
    iVar1 = EVP_CIPHER_CTX_get_params(param_1,&local_98);
    if (iVar1 == 0) goto LAB_00102a75;
    iVar1 = OSSL_PARAM_modified(&local_98);
    if (iVar1 == 0) goto LAB_00102a75;
    pXVar2 = d2i_X509_ALGOR(param_2,&local_a0,len);
    if (pXVar2 == (X509_ALGOR *)0x0) goto LAB_00102a75;
    uVar3 = 1;
  }
  CRYPTO_free(ptr);
LAB_00102a8e:
...

{
  ...
  if (iVar1 != 0) {
    ...
    iVar1 = OSSL_PARAM_modified(&local_98);
    if (((len != 0) && (iVar1 != 0)) &&
       (ptr = (uchar *)CRYPTO_malloc((int)len,"crypto/evp/evp_lib.c",0x59a), ptr != (uchar *)0x0)) {
      local_a0 = ptr;
      ...
      uStack_80 = uStack_c0;
      iVar1 = EVP_PKEY_CTX_get_params(param_1,&local_98);
      if (((iVar1 == 0) || (iVar1 = OSSL_PARAM_modified(&local_98), iVar1 == 0)) ||
         (pAVar2 = d2i_ASN1_TYPE(&local_a8,&local_a0,len), pAVar2 == (ASN1_TYPE *)0x0)) {
        uVar3 = 0xffffffff;
      }
      else {
        uVar3 = 1;
...
LAB_00103010:
  ...
  if (param_2 == (X509_ALGOR **)0x0) goto LAB_00103010;
  local_a0 = (uchar *)0x0;
...
LAB_00102f95:
    ...
    local_a0 = ptr;
    iVar1 = EVP_PKEY_CTX_get_params(param_1,&local_98);
    if (iVar1 == 0) goto LAB_00102f95;
    iVar1 = OSSL_PARAM_modified(&local_98);
    if (iVar1 == 0) goto LAB_00102f95;
    pXVar2 = d2i_X509_ALGOR(param_2,&local_a0,len);
    if (pXVar2 == (X509_ALGOR *)0x0) goto LAB_00102f95;
    uVar3 = 1;
  }
  CRYPTO_free(ptr);
LAB_00102fae:

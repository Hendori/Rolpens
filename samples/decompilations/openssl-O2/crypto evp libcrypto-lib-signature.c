...
joined_r0x00100770:
            if (lVar2 != 0) {
LAB_001001ee:
              if (((*(long *)(ptr + 0x20) == 0) || (*(long *)(ptr + 0x22) != 0)) &&
                 (((*(long *)(ptr + 0x24) == 0 || (*(long *)(ptr + 0x2a) != 0)) ||
                  ((*(long *)(ptr + 0x26) != 0 && (*(long *)(ptr + 0x28) != 0)))))) {
                if (*(long *)(ptr + 0x2c) == 0) {
                  return ptr;
                }
                if (*(long *)(ptr + 0x32) != 0) {
...
LAB_00100750:
              if (*(long *)(ptr + 0x1a) == 0) {
                if (((lVar2 == 0) && (*(long *)(ptr + 0x1c) == 0)) && (*(long *)(ptr + 0x1e) == 0))
                goto LAB_001001ee;
              }
              else {
  ...
  if (param_2 == 0) {
    ...
    if (lVar6 != 0) {
      ...
      if (lVar10 != 0) {
        ...
        param_2 = EVP_SIGNATURE_fetch(*(undefined8 *)(param_1 + 2),lVar10,
...
LAB_00100b27:
    ...
    *param_1 = 0;
    ...
    if (lVar6 == 0) {
      ...
      lVar7 = evp_pkey_export_to_provider
                        (*(undefined8 *)(param_1 + 0x22),*(undefined8 *)(param_1 + 2),&local_48,
                         *(undefined8 *)(param_1 + 4));
      if (local_48 == 0) {
...
LAB_001009f7:
        iVar3 = EVP_SIGNATURE_up_ref(param_2);
...
LAB_00100a84:
          iVar3 = evp_pkey_ctx_use_cached_data(param_1);
        }
        goto LAB_00100a8f;
      }
    }
    ...
    if (*param_1 == 0x4000) {
      ...
      if (param_2 != 0) {
        uVar1 = *param_3;
                    ...
                    /* WARNING: Treating indirect jump as call */
      uVar1 = (**(code **)(*(long *)(param_1 + 10) + 0x50))
                        (*(undefined8 *)(param_1 + 0xc),param_2,param_3,uVar1);
      return uVar1;
    }
    ERR_new();
    ...
    if ((*(int *)ctx == 0x10) || (*(int *)ctx == 0x4000)) {
      if (*(long *)(ctx + 0x30) == 0) {
           ...
           (UNRECOVERED_JUMPTABLE = *(code **)(lVar1 + 0x48), UNRECOVERED_JUMPTABLE != (code *)0x0))
        {
          if ((*(byte *)(lVar1 + 4) & 2) == 0) {
LAB_00101450:
                    /* WARNING: Could not recover jumptable at 0x0010145b. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    ...
    if (*(int *)ctx == 0x40) {
      if (*(long *)(ctx + 0x30) == 0) {
           ...
           (UNRECOVERED_JUMPTABLE = *(code **)(lVar1 + 0x68), UNRECOVERED_JUMPTABLE != (code *)0x0))
        {
          if ((*(byte *)(lVar1 + 4) & 2) == 0) {
LAB_00101b10:
                    /* WARNING: Could not recover jumptable at 0x00101b1b. Too many branches */
                    /* WARNING: Treating indirect jump as call */
            iVar2 = (*UNRECOVERED_JUMPTABLE)(ctx);
            return iVar2;
          }

...

{
  ...
  if (param_2 == 1) {
    ...
    local_180 = param_3;
    str = BUF_MEM_new();
    if (str != (BUF_MEM *)0x0) goto LAB_001000cd;
LAB_00100353:
    ERR_new();
    uVar5 = 0;
    ...
    if (param_2 == 2) {
      ...
      local_1b0 = param_3;
      str = BUF_MEM_new();
      if (str == (BUF_MEM *)0x0) goto LAB_00100353;
LAB_001000cd:
      ...
      if (local_27c != 0) {
        ...
        while (iVar3 = OPENSSL_sk_num(*(undefined8 *)(pcVar1 + 8)), local_27c < iVar3) {
          ...
          local_298 = 0;
          uVar10 = 0;
          if ((param_2 == 2) && (local_298 = puVar6[2], local_298 != 0)) {
            local_268[0] = uVar5;
            ...
            local_298 = 0;
            if (-1 < iVar3) {
              local_298 = OPENSSL_sk_value(puVar6[2],iVar3);
              uVar10 = (ulong)*(uint *)(local_298 + 8);
            }
          ...
          while( true ) {
            ...
            if (iVar3 < 0) break;
            if (param_2 == 1) {
              iVar3 = X509_load_cert_file_ex(param_1,str->data,*(int *)(puVar6 + 1),param_5,param_6)
              ;
            }
            else {
              iVar3 = X509_load_crl_file(param_1,str->data,*(int *)(puVar6 + 1));
            }
            if (iVar3 == 0) break;
          ...
          if (0 < iVar9) {
            ...
            if (param_2 == 2) {
              ...
              if (local_298 == 0) {
                ...
                local_298 = OPENSSL_sk_value(puVar6[2],uVar4);
                if (local_298 != 0) goto LAB_00100267;
...
LAB_00100267:
                if (*(int *)(local_298 + 8) < iVar9) {
                  *(int *)(local_298 + 8) = iVar9;
                }
              }
              CRYPTO_THREAD_unlock(*(undefined8 *)(pcVar1 + 0x10));
            }

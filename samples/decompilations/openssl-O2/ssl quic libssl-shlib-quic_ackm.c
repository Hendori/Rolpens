...
void lh_OSSL_ACKM_TX_PKT_cfn_thunk
...
void lh_OSSL_ACKM_TX_PKT_doall_arg_thunk
               (undefined8 param_1,undefined8 param_2,code *UNRECOVERED_JUMPTABLE)
...

{
  ...
  uVar10 = uVar9 + local_48[0];
  if (CARRY8(uVar9,local_48[0])) {
    uVar10 = 0xffffffffffffffff;
  }
  uVar12 = *(uint *)(param_1 + 0x118);
  ...
  if (*(long *)(param_1 + 0x1a0) + *(long *)(param_1 + 0x198) + *(long *)(param_1 + 0x1a8) == 0) {
    ...
    *param_2 = (uint)(*(char *)(param_1 + 0x1ca) != '\0');
    uVar11 = (**(code **)(param_1 + 0xf0))(uVar2);
    uVar10 = uVar11 + uVar9;
    ...
    do {
      uVar12 = (uint)uVar13;
      if (*(long *)(param_1 + 0x198 + uVar8 * 8) != 0) {
        if (uVar8 == 2) {
          if (*(char *)(param_1 + 0x1c8) == '\0') break;
          if (*(ulong *)(param_1 + 0x930) != 0xffffffffffffffff) {
            auVar4._8_8_ = 0;
            auVar4._0_8_ = *(ulong *)(param_1 + 0x930);
            auVar6._8_8_ = 0;
            auVar6._0_8_ = uVar11;
            uVar7 = SUB168(auVar4 * auVar6,0);
            if (SUB168(auVar4 * auVar6,8) != 0) {
              uVar7 = 0xffffffffffffffff;
            }
            bVar14 = CARRY8(uVar7,uVar9);
            uVar9 = uVar7 + uVar9;
            if (bVar14) {
              uVar9 = 0xffffffffffffffff;
            }
        ...
        puVar1 = (ulong *)(param_1 + 0x138 + uVar8 * 8);
        uVar7 = uVar9 + *puVar1;
        if ((uVar7 <= uVar10 && !CARRY8(uVar9,*puVar1)) && (uVar7 < uVar10)) {
      ...
      if ((bVar2 & 4) != 0) {
        ...
        *(long *)(param_1 + 400) = *(long *)(param_1 + 400) - lVar4;
        ...
        if (param_3 == 0) {
          ...
          (**(code **)(*(long *)(param_1 + 0x108) + 0x50))
                    (*(undefined8 *)(param_1 + 0x110),local_68);
        }
      }
...

{
  ...
  if (((((uVar3 == 0) || (uVar5 = uVar3, uVar1 < uVar3)) && (uVar5 = uVar1, uVar1 == 0)) ||
      ((uVar2 <= uVar5 && (uVar3 = uVar5, uVar2 < uVar5)))) &&
     (local_14 = 2, uVar5 = uVar2, uVar2 == 0)) {
    if ((*(long *)(param_1 + 0x1a0) + *(long *)(param_1 + 0x198) + *(long *)(param_1 + 0x1a8) == 0)
       && (*(char *)(param_1 + 0x1c9) != '\0')) {
      *(undefined8 *)(param_1 + 0x168) = 0;
      if (*(code **)(param_1 + 0x940) != (code *)0x0) {
        if (local_10 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00100459. Too many branches */
                    /* WARNING: Treating indirect jump as call */
      ...
      uVar3 = ackm_get_pto_time_and_space(param_1,&local_14);
    ...
    *(ulong *)(param_1 + 0x168) = uVar3;
    if (UNRECOVERED_JUMPTABLE != (code *)0x0) {
      ...
      if (local_10 == *(long *)(in_FS_OFFSET + 0x28)) {
LAB_001003ae:
                    /* WARNING: Could not recover jumptable at 0x001003b3. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
LAB_00100627:
        puVar8 = local_70;
        puVar7 = puVar2;
        if (puVar2 == (ulong *)0x0) goto LAB_00100695;
      }
      uVar4 = puVar7[2];
...
undefined1 (*) [16]
ossl_ackm_new(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
             undefined8 param_5)
    ...
    do {
      ...
      *pauVar5 = (undefined1  [16])0x0;
      ...
      lVar3 = OPENSSL_LH_set_thunks
                        (uVar2,0x100000,lh_OSSL_ACKM_TX_PKT_cfn_thunk,
                         lh_OSSL_ACKM_TX_PKT_doall_thunk,lh_OSSL_ACKM_TX_PKT_doall_arg_thunk);
...

{
  ...
  if (param_1 != (undefined1 (*) [16])0x0) {
    ...
    pauVar2 = param_1;
    do {
      if (param_1[0x1c][lVar1 + 10] == '\0') {
        OPENSSL_LH_free(*(undefined8 *)(pauVar2[1] + 8));
        *(undefined8 *)(pauVar2[1] + 8) = 0;
        *(undefined8 *)pauVar2[1] = 0;
        *pauVar2 = (undefined1  [16])0x0;
        ossl_uint_set_destroy(pauVar3);
      }
      lVar1 = lVar1 + 1;
      pauVar2 = pauVar2 + 3;
      pauVar3 = pauVar3 + 2;
...

{
  ...
  uVar6 = (byte)param_2[4] & 3;
  if (((((param_2[2] != 0) &&
        (uVar7 = (ulong)uVar6, *(ulong *)(param_1 + 0x138 + uVar7 * 8) <= param_2[2])) &&
       (param_2[1] != 0)) &&
      ((((byte)param_2[4] & 0xc) != 8 &&
       (lVar8 = uVar7 * 0x30 + param_1, *(ulong *)(lVar8 + 0x20) <= *param_2)))) &&
     ((lVar4 = OPENSSL_LH_retrieve(*(undefined8 *)(lVar8 + 0x18)), lVar4 == 0 &&
      ((param_2[9] == 0 && (param_2[10] == 0)))))) {
    OPENSSL_LH_insert(*(undefined8 *)(lVar8 + 0x18),param_2);
    plVar5 = (long *)((ulong)uVar6 * 0x30 + param_1);
    uVar2 = plVar5[1];
    if (uVar2 != 0) {
    ...
    uVar3 = *param_2;
    plVar5 = (long *)(param_1 + 0x10 + uVar7 * 0x30);
    *plVar5 = *plVar5 + 1;
    uVar2 = *param_2;
    plVar5 = (long *)(param_1 + 0x20 + uVar7 * 0x30);
    *plVar5 = uVar3 + 1;
    plVar5[1] = uVar2;
...
LAB_00100dcd:
    ...
    while( true ) {
      ...
      while (uVar12 < *puVar9) {
        if (puVar9[1] < uVar12) goto LAB_00100bfd;
        uVar16 = uVar16 + 1;
        puVar9 = puVar9 + 2;
        if (uVar16 == param_2[1]) goto LAB_00100c40;
      }
      if (uVar12 <= puVar9[1]) {
...
LAB_00100c40:
    plVar13 = local_b8;
    if (local_b8 == (long *)0x0) goto LAB_00100dcd;
    plVar11 = local_b8;
      ...
      if (*(ulong *)(lVar10 + 0x1b0) < (ulong)param_2[5]) {
        *(long *)(lVar10 + 0x1b0) = param_2[5];
        ...
        if (lVar10 != 0) {
          ...
          (**(code **)(*(long *)(param_1 + 0x108) + 0x68))
                    (*(undefined8 *)(param_1 + 0x110),&local_b8);
          plVar11 = local_b8;
        }
      }
    }
      ...
      *pauVar8 = (undefined1  [16])0x0;
      ...
      do {
        ...
        if ((*(byte *)(lVar5 + 0x20) & 4) != 0) {
          lVar3 = *(long *)(lVar5 + 8);
          *(long *)(param_1 + 400) = *(long *)(param_1 + 400) - lVar3;
          lVar6 = lVar6 + lVar3;
        }
...

{
  *(undefined2 *)(param_1 + 0x1c8) = 0x101;
  ackm_set_loss_detection_timer_isra_0();
  return 1;
}
...
LAB_001010f1:
    ...
    uVar6 = 0;
LAB_00101192:
    if (uVar5 < uVar3) goto LAB_001010f1;
  }
...

{
  ...
  if (iVar2 == 1) {
    ...
    if ((*(long *)(lVar12 + 0x1f0) == 0) ||
       (puVar7 = *(ulong **)(lVar12 + 0x1e8), puVar7[1] < local_68)) {
LAB_001015b4:
      bVar13 = false;
    }
    else {
      lVar12 = *(long *)(param_1 + 0x1f0 + (ulong)(bVar10 & 3) * 0x38);
      bVar13 = true;
      if (lVar12 != 0) {
        lVar15 = 0;
        do {
          if ((*puVar7 <= local_68) && (local_68 <= puVar7[1])) goto LAB_001015b4;
          lVar15 = lVar15 + 1;
          puVar7 = puVar7 + 2;
        } while (lVar12 != lVar15);
      }
    ...
    if (*(ulong *)(lVar12 + 0xa8) <= local_68) {
      ...
      if (0x20 < (ulong)plVar1[2]) {
        ...
        do {
          ...
          uVar16 = uStack_50;
          if ((uVar11 != 0xffffffffffffffff) && (uVar16 = uVar11, uVar11 < uStack_50)) {
            uVar16 = uStack_50;
          }
    ...
    if ((bVar10 & 4) != 0) {
      ...
      if (*(char *)(param_1 + 0x1cd + uVar11) == '\0') {
        ...
        *(uint *)(param_1 + 8 + (uVar11 + 0x240) * 4) = uVar6;
        if (((*(char *)(param_1 + 0x1d0 + uVar11) == '\0' || 1 < uVar6) || (bVar13)) ||
           ((*(long *)(uVar11 * 0x20 + 0xa0 + param_1) != 0 &&
            (((lVar12 = param_1 + uVar11 * 0x38, *(long *)(lVar12 + 0x1f0) != 0 &&
              (lVar15 = *(long *)(param_1 + 0x98 + uVar11 * 0x20), uVar8 = *(ulong *)(lVar15 + 0x10)
              , uVar8 == *(ulong *)(lVar15 + 0x18))) &&
             (*(long *)(*(long *)(lVar12 + 0x1e8) + 8) + 1U < uVar8)))))) {
          *(undefined1 *)(param_1 + 0x1cd + uVar11) = 1;
          pcVar14 = *(code **)(param_1 + 0x950);
          *(undefined8 *)(param_1 + 0x918 + uVar11 * 8) = 0xffffffffffffffff;
          if (pcVar14 != (code *)0x0) goto LAB_00101763;
        }
        else {
          ...
          if (pcVar14 == (code *)0x0) goto LAB_001016b2;
LAB_00101763:

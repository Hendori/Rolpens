...

{
  ...
  if ((param_4 & 1) == 0) goto LAB_0010057f;
LAB_0010039a:
...
LAB_001003d7:
  ...
  if ((iVar4 == 0 && iVar5 == 0) && (uVar7 == 0xffffffffffffffff)) goto LAB_001003d7;
...
LAB_001005a8:
    ...
    if (piVar8 == (int *)0x0) goto LAB_001006d0;
    iVar6 = *piVar8;
    uVar11 = 0xffffffff;
    if (iVar6 == 0) goto LAB_00100674;
LAB_001005d0:
    if ((iVar6 != 1) || (uVar1 = piVar8[2], uVar1 == 0xffffffff)) goto LAB_001005a8;
    local_48 = 0;
    if (uVar1 != uVar11) {
    ...
    if (iVar5 == 0) {
      local_58._0_4_ = uVar11;
      local_58[5] = 0;
      if (((int)uVar11 < 0) || (!(bool)local_58[4])) goto LAB_001006a6;
    }
    else {
      local_58._0_6_ = (uint6)CONCAT14(local_58[4],uVar11) | 0x400000000;
      if ((int)uVar11 < 0) goto LAB_001006a6;
    }
    nVar12 = 2;
    __nfds = 1;
    if (local_6c < 0) {
LAB_00100725:
    ...
    if ((*piVar9 != 1) || (uVar11 = piVar9[2], uVar11 == 0xffffffff)) goto LAB_001005a8;
    if ((piVar8 != (int *)0x0) && (iVar6 = *piVar8, iVar6 != 0)) goto LAB_001005d0;
    local_48 = 0;
    local_58._6_10_ = SUB1610((undefined1  [16])0x0,6);
    local_58[4] = iVar4 != 0;
    local_58._0_4_ = uVar11;
...
LAB_001004f0:
      ...
      iVar4 = 0;
      if (uVar7 < uVar10) goto LAB_001004f0;
      iVar4 = poll((pollfd *)local_58,__nfds,(int)((uVar7 - uVar10) / 1000000));
    }
    if (iVar4 != -1) break;
    piVar8 = __errno_location();
    if (*piVar8 != 4) {
      if (lVar2 != 0) {
        ossl_crypto_mutex_lock(lVar2);
      }
      goto LAB_001005a8;
    }
  } while( true );

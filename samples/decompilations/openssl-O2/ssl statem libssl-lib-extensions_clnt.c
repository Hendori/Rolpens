  ...
  if (*(int *)(param_1 + 0x48) != 0x300) {
    ...
    if (0 < iVar2) {
      ...
      do {
        ...
        if (((*(uint *)(lVar4 + 0x1c) & 0x84) != 0 || (*(uint *)(lVar4 + 0x20) & 8) != 0) ||
...

{
  ...
  if (param_4 < *(ulong *)(param_1 + 0x338)) {
    if ((*(int *)(param_1 + 0x8d0) != 1) ||
       (pkey = *(EVP_PKEY **)(param_1 + (param_4 + 0x62) * 8), pkey == (EVP_PKEY *)0x0)) {
      ERR_new();
...
LAB_001001ae:
    lVar3 = EVP_PKEY_get1_encoded_public_key(pkey,&local_48);
    if (lVar3 == 0) {
      ERR_new();
...

{
  ...
  if (*(int *)(param_1 + 0xba0) == 0) {
    if (((*(byte *)(*(long *)(*(long *)(param_1 + 0x18) + 0xd8) + 0x50) & 8) == 0) &&
       ((0x303 < *(int *)(param_1 + 0x9bc) ||
        ((iVar1 = ssl_security(param_1,9,0,0x301,0), iVar1 != 0 &&
         (*(int *)(param_1 + 0x9bc) < 0x302)))))) {
      return 2;
    }
    ...
    iVar1 = WPACKET_put_bytes__(param_2,0xff01,2);
    if ((((iVar1 != 0) && (iVar1 = WPACKET_start_sub_packet_len__(param_2,2), iVar1 != 0)) &&
        (iVar1 = WPACKET_sub_memcpy__(param_2,param_1 + 0x420,*(undefined8 *)(param_1 + 0x460),1),
...

{
  ...
  if ((((iVar1 != 0) && (iVar1 = WPACKET_start_sub_packet_len__(param_2,2), iVar1 != 0)) &&
      (iVar1 = WPACKET_put_bytes__(param_2,*(undefined1 *)(param_1 + 0xb34),1), iVar1 != 0)) &&
     (iVar1 = WPACKET_close(param_2), iVar1 != 0)) {
    return 1;
  }
  ERR_new();
...

{
  ...
  if (iVar2 == 0) {
    ...
    if ((iVar2 == 0) &&
       ((uVar3 = 2, (*(byte *)(*(long *)(*(long *)(param_1 + 0x18) + 0xd8) + 0x50) & 8) != 0 ||
        (local_58 < 0x304)))) goto LAB_00100a39;
    tls1_get_supported_groups(param_1,&local_50,&local_48);
    iVar2 = WPACKET_put_bytes__(param_2,10,2);
    if ((iVar2 == 0) ||
       (((iVar2 = WPACKET_start_sub_packet_len__(param_2,2), iVar2 == 0 ||
         (iVar2 = WPACKET_start_sub_packet_len__(param_2,2), iVar2 == 0)) ||
        (iVar2 = WPACKET_set_flags(param_2,1), iVar2 == 0)))) {
      ERR_new();
      uVar3 = 0xf7;
    }
    else {
...
LAB_00100b92:
          if (local_58 != 0x304) goto LAB_00100ba0;
          ERR_new();
          uVar3 = 0x114;
        }
...

{
  ...
  if (*(int *)(param_1 + 0x7c) == 0) {
    ...
    if (piVar1 == (int *)0x0) {
LAB_00100d20:
      if ((*(long *)(param_1 + 0xac8) != 0) && (*(long *)(*(long *)(param_1 + 0xac8) + 8) == 0)) {
        return 2;
      }
    }
    else {
LAB_00100ca6:
      puVar2 = *(ushort **)(param_1 + 0xac8);
...
LAB_00100d3a:
  ...
  if ((iVar3 != 0) &&
     (iVar3 = WPACKET_sub_memcpy__
                        (param_2,*(undefined8 *)(*(long *)(param_1 + 0x900) + 0x328),__n,2),
     iVar3 != 0)) {
    return 1;
  }
  ERR_new();
...

{
  ...
  if ((*(byte *)(*(long *)(piVar1 + 0x36) + 0x50) & 8) == 0) {
    uVar3 = 2;
    if ((iVar2 < 0x303) || ((*piVar1 != 0x10000 && (*(int *)(param_1 + 0x48) < 0x303))))
    goto LAB_00100f15;
  }
  else if (((iVar2 == 0x100) || (0xfefd < iVar2)) ||
          ((*piVar1 != 0x1ffff &&
           ((*(int *)(param_1 + 0x48) == 0x100 || (0xfefd < *(int *)(param_1 + 0x48))))))) {
    uVar3 = 2;
    goto LAB_00100f15;
  }
  ...
  if (((iVar2 != 0) &&
      (((iVar2 = WPACKET_start_sub_packet_len__(param_2,2), iVar2 != 0 &&
        (iVar2 = WPACKET_start_sub_packet_len__(param_2,2), iVar2 != 0)) &&
       (iVar2 = tls12_copy_sigalgs(param_1,param_2,local_28,uVar3), iVar2 != 0)))) &&
...
LAB_00101070:
    ...
    for (; iVar1 = OPENSSL_sk_num(*(undefined8 *)(param_1 + 0xa40)), iVar3 < iVar1;
        iVar3 = iVar3 + 1) {
      a = (OCSP_RESPID *)OPENSSL_sk_value(*(undefined8 *)(param_1 + 0xa40));
      iVar1 = i2d_OCSP_RESPID(a,(uchar **)0x0);
      if (((iVar1 < 1) ||
          (iVar2 = WPACKET_sub_allocate_bytes__(param_2,(long)iVar1,&puStack_48,2), iVar2 == 0)) ||
         (iVar2 = i2d_OCSP_RESPID(a,&puStack_48), iVar2 != iVar1)) {
        ERR_new();
        uVar4 = 0x18d;
        goto LAB_00101081;
      }
...
LAB_001011ec:
      ...
      if (iVar1 < 0) {
        ...
        if ((iVar3 != 0) &&
           (iVar3 = i2d_X509_EXTENSIONS(*(X509_EXTENSIONS **)(param_1 + 0xa48),&puStack_48),
           iVar3 == iVar1)) goto LAB_001011ec;
        ERR_new();
        uVar4 = 0x1a1;
      }
    }
    ...
    if ((iVar1 != 0) &&
       (((iVar1 = WPACKET_start_sub_packet_len__(param_2,2), iVar1 != 0 &&
         (iVar1 = WPACKET_sub_memcpy__
                            (param_2,*(undefined8 *)(param_1 + 0xaf0),
                             *(undefined8 *)(param_1 + 0xaf8),2), iVar1 != 0)) &&
        (iVar1 = WPACKET_close(param_2), iVar1 != 0)))) {
...

{
  ...
  {
    *(uint *)(param_1 + 0xb10) = 3 - (uint)((uVar1 & 0x400) == 0);
    return 1;
  }
  ERR_new();
  ERR_set_debug("ssl/statem/extensions_clnt.c",0x277,"tls_construct_ctos_psk_kex_modes");
  ossl_statem_fatal(param_1,0x50,0xc0103,0);
  return 0;
}
...

{
  ...
  if (((iVar2 == 0) || (iVar2 = WPACKET_start_sub_packet_len__(param_2,2), iVar2 == 0)) ||
    ...
    uVar4 = 0x2d2;
LAB_00101a92:
    ERR_set_debug("ssl/statem/extensions_clnt.c",uVar4,"tls_construct_ctos_key_share");
    ossl_statem_fatal(param_1,0x50,0xc0103,0);
  }
  else {
    bVar1 = false;
    tls1_get_requested_keyshare_groups(param_1,&local_48,&local_50);
    if (local_50 == 1) {
      if (*local_48 == 0) {
        bVar1 = true;
        tls1_get_supported_groups(param_1,&local_48,&local_50);
        goto LAB_00101b1b;
      }
LAB_00101b24:
      if ((*(short *)(param_1 + 0x4de) == 0) || (*(long *)(param_1 + 0x308) != 0)) {
        ...
        uVar3 = 0;
        do {
          iVar2 = tls_group_allowed(param_1,local_48[uVar3],0x20004);
          if ((iVar2 != 0) &&
             (iVar2 = tls_valid_group(param_1,local_48[uVar3],0x304,0x304,0,0), iVar2 != 0)) {
            if (local_48[uVar3] == 0) {
              ERR_new();
              uVar4 = 0x2fa;
              goto LAB_00101c61;
            }
            iVar2 = add_key_share(param_1,param_2,local_48[uVar3],lVar5);
            if (iVar2 == 0) goto LAB_00101ab4;
            if (bVar1) break;
            lVar5 = lVar5 + 1;
          }
          uVar3 = uVar3 + 1;
        ...
        *(undefined8 *)(param_1 + 0x338) = 0;
        iVar2 = add_key_share(param_1,param_2,*(short *)(param_1 + 0x4de),0);
        if (iVar2 == 0) goto LAB_00101ab4;
      }
      iVar2 = WPACKET_close(param_2);
      if ((iVar2 != 0) && (iVar2 = WPACKET_close(param_2), iVar2 != 0)) {
...
LAB_00101b1b:
    if (local_50 != 0) goto LAB_00101b24;
    ERR_new();
    uVar4 = 0x2de;
LAB_00101c61:
    ERR_set_debug("ssl/statem/extensions_clnt.c",uVar4,"tls_construct_ctos_key_share");
...

{
  ...
  if (*(long *)(param_1 + 0xb28) != 0) {
    ...
    if ((((iVar1 == 0) || (iVar1 = WPACKET_start_sub_packet_len__(param_2,2), iVar1 == 0)) ||
        (iVar1 = WPACKET_sub_memcpy__
                           (param_2,*(undefined8 *)(param_1 + 0xb20),
                            *(undefined8 *)(param_1 + 0xb28),2), iVar1 == 0)) ||
       (iVar1 = WPACKET_close(param_2), iVar1 == 0)) {
      ERR_new();
      uVar2 = 0;
...

{
  ...
  if (*(int *)(param_1 + 0x8d0) == 1) {
    ...
    if (pcVar8 != (code *)0x0) goto LAB_00101e39;
    if (local_358 == (SSL_SESSION *)0x0) goto LAB_00101fe8;
    goto LAB_00101e6e;
  }
  pcVar8 = *(code **)(param_1 + 0x988);
  uVar4 = 0;
  if (pcVar8 != (code *)0x0) {
LAB_00101e39:
    iVar1 = (*pcVar8)(uVar6,uVar4,&local_368,&local_360,&local_358);
    if (iVar1 != 0) {
      if (local_358 == (SSL_SESSION *)0x0) goto LAB_00101fe8;
      if (local_358->ssl_version == 0x304) goto LAB_00101e6e;
    }
...
LAB_00101fe8:
  pcVar8 = *(code **)(param_1 + 0x970);
  if (pcVar8 == (code *)0x0) goto LAB_00101e6e;
  pcVar7 = local_348;
  ...
  *pcVar7 = '\0';
  ...
  if (uVar5 == 0) {
LAB_00101e6e:
    SSL_SESSION_free(*(SSL_SESSION **)(param_1 + 0x908));
    *(SSL_SESSION **)(param_1 + 0x908) = local_358;
    ...
    if (*(int *)(param_1 + 0xf0) == 2) {
      ...
      if ((iVar1 != 0) ||
         ((local_358 != (SSL_SESSION *)0x0 &&
          (iVar1 = *(int *)(local_358[1].krb5_client_princ + 0x5c), pSVar9 = local_358, iVar1 != 0))
         )) {
        pcVar7 = *(char **)(pSVar9[1].krb5_client_princ + 0x38);
        *(int *)(param_1 + 0x1540) = iVar1;
        if ((pcVar7 != (char *)0x0) &&
           ((*(char **)(param_1 + 0xa20) == (char *)0x0 ||
            (iVar1 = strcmp(*(char **)(param_1 + 0xa20),pcVar7), iVar1 != 0)))) {
          ERR_new();
...
LAB_00102300:
            ...
            uVar5 = (ulong)*pbVar10;
            a = pbVar10 + 1;
            if (lVar3 - 1U < uVar5) goto LAB_00102300;
            pbVar10 = a + uVar5;
            lVar3 = (lVar3 - 1U) - uVar5;
          } while ((*(ulong *)(pSVar9[1].krb5_client_princ + 0x68) != uVar5) ||
                  (iVar1 = CRYPTO_memcmp(a,*(void **)(pSVar9[1].krb5_client_princ + 0x60),uVar5),
                  iVar1 != 0));
        }
    ...
    *(undefined4 *)(param_1 + 0x1540) = 0;
    ...
    if (lVar3 != 0) {
      ...
      if ((((local_358 == (SSL_SESSION *)0x0) ||
           (iVar1 = SSL_SESSION_set1_master_key(local_358,local_238,uVar5), iVar1 == 0)) ||
          (iVar1 = SSL_SESSION_set_cipher(local_358,lVar3), iVar1 == 0)) ||
         (iVar1 = SSL_SESSION_set_protocol_version(local_358,0x304), iVar1 == 0)) {
        ERR_new();
...

{
  ...
  local_20 = *(long *)(in_FS_OFFSET + 0x28);
  uVar3 = 2;
  if ((*(byte *)(param_1 + 0x9b0) & 0x10) == 0) goto LAB_001023ce;
  iVar2 = WPACKET_get_total_written(param_2,&local_28);
  if (iVar2 == 0) {
    ERR_new();
    uVar3 = 0x3ec;
LAB_001024d1:
    ERR_set_debug("ssl/statem/extensions_clnt.c",uVar3,"tls_construct_ctos_padding");
    ossl_statem_fatal(param_1,0x50,0xc0103,0);
  }
  else {
    piVar1 = *(int **)(param_1 + 0x900);
    sVar4 = local_28;
    if ((((*piVar1 != 0x304) || (*(long *)(piVar1 + 0xcc) == 0)) || (*(long *)(piVar1 + 0xbe) == 0))
       || (lVar5 = ssl_md(*(undefined8 *)(param_1 + 8),
                          *(undefined4 *)(*(long *)(piVar1 + 0xbe) + 0x40)), sVar4 = local_28,
          lVar5 == 0)) {
LAB_001023b9:
      if (sVar4 - 0x100 < 0x100) {
        local_28 = 1;
        if (4 < 0x200 - sVar4) {
        ...
        if ((iVar2 == 0) ||
           (iVar2 = WPACKET_sub_allocate_bytes__(param_2,local_28,&local_30,2), iVar2 == 0)) {
          ERR_new();
          uVar3 = 0x419;
          goto LAB_001024d1;
        }
...
LAB_001027d0:
  ...
  if (*(long *)(piVar7 + 0xcc) == 0) {
    ...
    if (lVar6 == 0) goto LAB_001027d0;
    if (*(int *)(param_1 + 0x8d0) == 1) goto LAB_00102980;
    bVar2 = false;
    lVar8 = 0;
    lVar10 = 0;
    local_6c = 0;
    local_74 = 0;
LAB_001025c3:
    lVar6 = ssl_md(uVar11,*(undefined4 *)(*(long *)(lVar6 + 0x2f8) + 0x40));
    if (lVar6 == 0) {
      ERR_new();
      uVar11 = 0x49d;
    }
  ...
  if (*(int *)(param_1 + 0x8d0) == 1) {
LAB_00102980:
    lVar10 = ssl_handshake_md(param_1);
    piVar7 = *(int **)(param_1 + 0x900);
    if (*(long *)(piVar7 + 0xcc) != 0) goto LAB_00102648;
    local_6c = 0;
    lVar6 = *(long *)(param_1 + 0x908);
    lVar8 = 0;
    local_74 = 0;
...
LAB_001027bd:
    ...
    if (uVar9 < uVar1) {
      ...
      if (local_74 != 0) {
        uVar5 = local_74 - 1;
        param_4 = (ulong)uVar5;
        if (*(ulong *)(lVar6 + 0x338) < param_4) goto LAB_001027a6;
    ...
    *(int *)(param_1 + 0xb38) = *(int *)(param_1 + 0xb38) + 1;
    bVar2 = true;
    if (lVar6 != 0) goto LAB_001025c3;
    iVar3 = 0;
    lVar6 = 0;
LAB_00102703:
    iVar4 = WPACKET_put_bytes__(param_2,0x29,2);
    if (((iVar4 == 0) || (iVar4 = WPACKET_start_sub_packet_len__(param_2,2), iVar4 == 0)) ||
      ...
      if (bVar2) {
        param_4 = 2;
        iVar4 = WPACKET_sub_memcpy__
                          (param_2,*(undefined8 *)(*(long *)(param_1 + 0x900) + 0x328),
                           *(undefined8 *)(*(long *)(param_1 + 0x900) + 0x330));
        if ((iVar4 == 0) || (iVar4 = WPACKET_put_bytes__(param_2,local_74,4), iVar4 == 0)) {
          ERR_new();
          uVar11 = 0x4bd;
          goto LAB_0010273f;
        }
      ...
      if (*(long *)(param_1 + 0x908) != 0) {
        param_4 = 2;
        iVar4 = WPACKET_sub_memcpy__
                          (param_2,*(undefined8 *)(param_1 + 0x910),*(undefined8 *)(param_1 + 0x918)
                          );
        if ((iVar4 == 0) || (iVar4 = WPACKET_put_bytes__(param_2,0,4), iVar4 == 0)) {
          ERR_new();
          uVar11 = 0x4c6;
          goto LAB_0010273f;
        }
      ...
      if (((iVar4 != 0) && (iVar4 = WPACKET_get_total_written(param_2,&local_60), iVar4 != 0)) &&
        ...
        if (((iVar3 != 0) && (iVar3 = WPACKET_close(param_2), iVar3 != 0)) &&
          ...
          if ((bVar2) &&
             (iVar3 = tls_psk_do_binder(param_1,lVar8,local_58,local_60,0,local_50,
                                        *(undefined8 *)(param_1 + 0x900),1,0,param_4),
             uVar11 = extraout_RDX, iVar3 != 1)) {
            uVar12 = 0;
          }
            ...
            iVar3 = tls_psk_do_binder(param_1,lVar6,local_58,local_60,0,local_48,
                                      *(long *)(param_1 + 0x908),1,1,uVar11);
            uVar12 = iVar3 == 1;
          }
          goto LAB_001027d5;
        }
...

{
  ...
  if (param_2[1] != 0) {
    uVar4 = param_2[1] - 1;
    if (uVar4 == *pbVar5) {
      *param_2 = (long)(pbVar5 + (ulong)*pbVar5 + 1);
      ...
      *(ulong *)(param_1 + 0xa78) = uVar4;
      if (num < 8) {
        if ((uVar4 & 4) != 0) {
          ...
          *(undefined4 *)(pbVar2 + ((uVar4 & 0xffffffff) - 4)) =
               *(undefined4 *)(pbVar5 + ((uVar4 & 0xffffffff) - 3));
          return 1;
        }
        if (num == 0) {
          return 1;
        ...
        *(undefined2 *)(pbVar2 + ((uVar4 & 0xffffffff) - 2)) =
             *(undefined2 *)(pbVar5 + ((uVar4 & 0xffffffff) - 1));
        return 1;
      }
      *(undefined8 *)pbVar2 = *(undefined8 *)(pbVar5 + 1);
      *(undefined8 *)(pbVar2 + ((uVar4 & 0xffffffff) - 8)) =
           *(undefined8 *)(pbVar5 + ((uVar4 & 0xffffffff) - 7));
...

{
  ...
  if ((*(code **)(param_1 + 0xad0) != (code *)0x0) &&
     (iVar1 = (**(code **)(param_1 + 0xad0))
                         ...
                         *(undefined8 *)(param_1 + 0xad8)), iVar1 == 0)) {
    ERR_new();
...
undefined8
tls_parse_stoc_status_request(long param_1,long param_2,int param_3,undefined8 param_4,long param_5)
...
bool tls_parse_stoc_sct(long param_1,long *param_2,uint param_3,undefined8 param_4,
                       undefined8 param_5)
...
LAB_001036fd:
    if (lVar3 == 0) {
      iVar2 = (*pcVar1)(*(undefined8 *)(param_1 + 0x40),&local_28,&local_29,(byte *)*param_2,
                        param_2[1],*(undefined8 *)(*(long *)(param_1 + 8) + 0x2f8));
        ...
        *(undefined8 **)(param_1 + 0xb00) = puVar4;
        if (puVar4 != (undefined8 *)0x0) {
          ...
          if (local_29 < 8) {
            if ((local_29 & 4) == 0) {
              if ((local_29 != 0) &&
                 (*(undefined1 *)puVar4 = *(undefined1 *)local_28, (local_29 & 2) != 0)) {
                *(undefined2 *)((long)puVar4 + (uVar8 - 2)) =
                     *(undefined2 *)((long)local_28 + (uVar8 - 2));
              }
            }
            else {
              *(undefined4 *)puVar4 = *(undefined4 *)local_28;
              *(undefined4 *)((long)puVar4 + (uVar8 - 4)) =
                   *(undefined4 *)((long)local_28 + (uVar8 - 4));
            }
          }
          else {
            *puVar4 = *local_28;
            *(undefined8 *)((long)puVar4 + (uVar8 - 8)) =
                 *(undefined8 *)((long)local_28 + (uVar8 - 8));
    ...
    uVar8 = (ulong)*pbVar6;
    if (uVar8 <= lVar3 - 1U) goto LAB_001036f0;
    goto LAB_0010370e;
  }
  ERR_new();
...
LAB_00103743:
  ...
  return uVar5;
LAB_001036f0:
  pbVar6 = pbVar6 + uVar8 + 1;
  lVar3 = (lVar3 - 1U) - uVar8;
  if (uVar8 == 0) goto LAB_0010370e;
  goto LAB_001036fd;
LAB_0010370e:
  ERR_new();
...

{
  ...
  if (1 < uVar8) {
    ...
    *param_2 = (long)(puVar3 + 1);
    uVar14 = uVar8 - 2;
    param_2[1] = uVar14;
    if (((ushort)(uVar2 << 8 | uVar2 >> 8) == uVar14) && (uVar14 != 0)) {
      bVar1 = (byte)puVar3[1];
      uVar14 = (ulong)bVar1;
      *param_2 = (long)puVar3 + 3;
      param_2[1] = uVar8 - 3;
      if (uVar8 - 3 == uVar14) {
        lVar13 = *(long *)(param_1 + 0xaf8);
...
LAB_00103a51:
          ...
          uVar8 = (ulong)*pbVar4;
          __s2 = pbVar4 + 1;
          if (lVar13 - 1U < uVar8) goto LAB_00103a51;
          pbVar4 = __s2 + uVar8;
          lVar13 = (lVar13 - 1U) - uVar8;
        } while ((uVar14 != uVar8) ||
                (iVar6 = memcmp((void *)((long)puVar3 + 3),__s2,uVar14), iVar6 != 0));
          ...
          if (bVar1 < 8) {
            if ((bVar1 & 4) == 0) {
              if ((bVar1 != 0) && (*(undefined1 *)__s2_00 = *(undefined1 *)puVar5, (bVar1 & 2) != 0)
                ...
                *(undefined2 *)((long)__s2_00 + (uVar14 - 2)) =
                     *(undefined2 *)((long)puVar5 + (uVar14 - 2));
              }
            }
            else {
              *(undefined4 *)__s2_00 = *(undefined4 *)puVar5;
              *(undefined4 *)((long)__s2_00 + (uVar14 - 4)) =
                   *(undefined4 *)((long)puVar5 + (uVar14 - 4));
            }
          }
          else {
            *__s2_00 = *puVar5;
            *(undefined8 *)((long)__s2_00 + (uVar14 - 8)) =
                 *(undefined8 *)((long)puVar5 + (uVar14 - 8));
            lVar13 = (long)__s2_00 - (long)((ulong)(__s2_00 + 1) & 0xfffffffffffffff8);
            puVar11 = (undefined8 *)((long)puVar5 - lVar13);
            puVar12 = (undefined8 *)((ulong)(__s2_00 + 1) & 0xfffffffffffffff8);
            for (uVar9 = (ulong)((int)lVar13 + (uint)bVar1 >> 3); uVar9 != 0; uVar9 = uVar9 - 1) {
              *puVar12 = *puVar11;
              puVar11 = puVar11 + (ulong)bVar15 * -2 + 1;
              puVar12 = puVar12 + (ulong)bVar15 * -2 + 1;
            }
          }
          *param_2 = (long)((long)puVar5 + uVar14);
          param_2[1] = uVar8 - uVar14;
          lVar13 = *(long *)(param_1 + 0x900);
          *(ulong *)(param_1 + 0x4c0) = uVar14;
          if (*(void **)(lVar13 + 0x348) == (void *)0x0) {
            *(undefined4 *)(param_1 + 0xb1c) = 0;
            if (*(int *)(param_1 + 0x508) != 0) {
              return 1;
            }
            uVar10 = CRYPTO_memdup(__s2_00,uVar14,"ssl/statem/extensions_clnt.c",0x6d0);
            *(undefined8 *)(lVar13 + 0x348) = uVar10;
            lVar13 = *(long *)(param_1 + 0x900);
            if (*(long *)(lVar13 + 0x348) != 0) {
              *(undefined8 *)(lVar13 + 0x350) = *(undefined8 *)(param_1 + 0x4c0);
              return 1;
            }
            *(undefined8 *)(lVar13 + 0x350) = 0;
            ERR_new();
            uVar10 = 0x6d3;
          }
          else {
            iVar6 = *(int *)(param_1 + 0x508);
            if ((*(ulong *)(lVar13 + 0x350) != uVar14) ||
               (iVar7 = memcmp(*(void **)(lVar13 + 0x348),__s2_00,uVar14), iVar7 != 0)) {
              *(undefined4 *)(param_1 + 0xb1c) = 0;
            }
            if (iVar6 != 0) {
              return 1;
...

{
  ...
  if (((((*(byte *)(param_1 + 0x9b2) & 8) == 0) &&
       (*(int *)(*(long *)(param_1 + 0x300) + 0x28) != 0x40)) &&
      (iVar1 = *(int *)(*(long *)(param_1 + 0x300) + 0x24),
      (iVar1 != 0x400 && iVar1 != 4) && iVar1 != 0x40000)) &&
...

{
  ...
  if ((ulong)param_2[1] < 2) {
    ...
    uVar6 = 0x762;
LAB_001042e1:
    ERR_set_debug("ssl/statem/extensions_clnt.c",uVar6,"tls_parse_stoc_key_share");
    ossl_statem_fatal(param_1,0x32,0x9f,0);
  }
  else {
    lVar5 = param_2[1] - 2;
    ...
    *param_2 = (long)((ushort *)*param_2 + 1);
    ...
    if ((param_3 & 0x800) == 0) {
      ...
      if (*(long *)(param_1 + 0x338) != 0) {
        do {
          if (*(ushort *)(param_1 + 0x330 + lVar5 * 2) == uVar8) {
            pEVar3 = *(EVP_PKEY **)(param_1 + 0x310 + lVar5 * 8);
            *(ushort *)(param_1 + 0x4de) = uVar8;
            *(EVP_PKEY **)(param_1 + 0x308) = pEVar3;
            if (uVar2 != 0) {
              lVar5 = *(long *)(param_1 + 0x900);
              uVar9 = (uint)uVar8;
              if (*(int *)(param_1 + 0x508) == 0) {
                *(uint *)(lVar5 + 0x308) = uVar9;
              }
              else if (*(uint *)(lVar5 + 0x308) != uVar9) {
                lVar5 = ssl_session_dup(lVar5,0);
                if (lVar5 == 0) {
                  ERR_new();
                ...
                *(long *)(param_1 + 0x900) = lVar5;
                *(uint *)(lVar5 + 0x308) = uVar9;
              }
              lVar5 = tls1_group_id_lookup(*(undefined8 *)(param_1 + 8),uVar8);
              if (lVar5 == 0) {
                ERR_new();
                uVar6 = 0x7c6;
                goto LAB_00104129;
              ...
              if (1 < (ulong)param_2[1]) {
                ...
                if (uVar10 <= uVar11) {
                  ...
                  if (uVar10 == uVar11) {
                    *param_2 = (long)puVar1 + uVar10;
                    param_2[1] = 0;
                    if (uVar10 != 0) {
                      if (*(char *)(lVar5 + 0x30) != '\0') {
                        iVar4 = ssl_decapsulate(param_1,pEVar3,puVar1,uVar10,1);
                        if (iVar4 == 0) goto LAB_0010407a;
LAB_001042bc:
                      ...
                      to = EVP_PKEY_new();
                      if ((to == (EVP_PKEY *)0x0) ||
                         (iVar4 = EVP_PKEY_copy_parameters(to,pEVar3), iVar4 < 1)) {
                        ERR_new();
                        ERR_set_debug("ssl/statem/extensions_clnt.c",0x7d4,
                                      "tls_parse_stoc_key_share");
                        uVar6 = 0x128;
                        uVar7 = 0x50;
LAB_001044e7:
                        ossl_statem_fatal(param_1,uVar7,uVar6,0);
                      }
                      else {
                        iVar4 = tls13_set_encoded_pub_key(to,puVar1,uVar10);
                        if (iVar4 < 1) {
                          ERR_new();
                          ERR_set_debug("ssl/statem/extensions_clnt.c",0x7db,
                                        "tls_parse_stoc_key_share");
                          uVar6 = 0x132;
                          uVar7 = 0x2f;
                          goto LAB_001044e7;
          ...
          lVar5 = lVar5 + 1;
        } while (lVar5 != *(long *)(param_1 + 0x338));
      }
      ERR_new();
      uVar6 = 0x7aa;
    }
      ...
      if (local_38 != 0) {
        uVar11 = 0;
        do {
          if (*(ushort *)(local_40 + uVar11 * 2) == uVar8) {
            if (((uVar11 < local_38) &&
                (iVar4 = tls_group_allowed(param_1,uVar8,0x20004), iVar4 != 0)) &&
               (iVar4 = tls_valid_group(param_1,uVar8,0x304,0x304,0,0), iVar4 != 0)) {
              *(ushort *)(param_1 + 0x4de) = uVar8;
              uVar11 = 0;
              if (*(long *)(param_1 + 0x338) != 0) {
                do {
                  pEVar3 = *(EVP_PKEY **)(param_1 + 0x310 + uVar11 * 8);
                  if (pEVar3 != (EVP_PKEY *)0x0) {
                    EVP_PKEY_free(pEVar3);
                    *(undefined8 *)(param_1 + 0x310 + uVar11 * 8) = 0;
                  }
                  uVar11 = uVar11 + 1;
                } while (uVar11 < *(ulong *)(param_1 + 0x338));
              }
              *(undefined8 *)(param_1 + 0x338) = 0;
              uVar6 = 1;
    ...
    if (uVar5 <= uVar3) {
      ...
      if (uVar5 == uVar3) {
        *param_2 = (long)puVar1 + uVar5;
        ptr = *(void **)(param_1 + 0xb20);
        param_2[1] = 0;
        CRYPTO_free(ptr);
        *(undefined8 *)(param_1 + 0xb20) = 0;
        *(undefined8 *)(param_1 + 0xb28) = 0;
        if (uVar5 != 0) {
          lVar4 = CRYPTO_memdup(puVar1,uVar5,"include/internal/packet.h",0x1cf);
          *(long *)(param_1 + 0xb20) = lVar4;
          if (lVar4 == 0) goto LAB_00104630;
          *(ulong *)(param_1 + 0xb28) = uVar5;
        }
        return 1;
      }
    }
  ...
  if (1 < (ulong)param_2[1]) {
    ...
    *param_2 = (ushort *)*param_2 + 1;
    ...
    if (lVar2 == 0) {
      ...
      if (uVar3 == 0) {
        if ((ses == (SSL_SESSION *)0x0) || (*(uint *)(param_1 + 0xb38) == 2)) {
      ...
      if ((((*(uint *)(param_1 + 0xf0) & 0xfffffffb) != 3) ||
          ...
          *(int *)(ses_00[1].krb5_client_princ + 0x5c) != 0)) ||
         (*(int *)(ses[1].krb5_client_princ + 0x5c) == 0)) {
...

{
  ...
  *(undefined1 *)(param_1 + 0xb51) = 0;
  ...
  if ((((iVar1 != 0) && (iVar1 = WPACKET_start_sub_packet_len__(param_2,2), iVar1 != 0)) &&
      (iVar1 = WPACKET_sub_memcpy__
                         (param_2,*(undefined8 *)(param_1 + 0x1598),
                          *(undefined8 *)(param_1 + 0x15a0),1), iVar1 != 0)) &&
     (iVar1 = WPACKET_close(param_2), iVar1 != 0)) {
...

{
  ...
  *(undefined1 *)(param_1 + 0xb53) = 0;
  ...
  if ((((iVar1 != 0) && (iVar1 = WPACKET_start_sub_packet_len__(param_2,2), iVar1 != 0)) &&
      (iVar1 = WPACKET_sub_memcpy__
                         (param_2,*(undefined8 *)(param_1 + 0x15a8),
                          *(undefined8 *)(param_1 + 0x15b0),1), iVar1 != 0)) &&
     (iVar1 = WPACKET_close(param_2), iVar1 != 0)) {

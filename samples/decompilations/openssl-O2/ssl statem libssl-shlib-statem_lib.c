...
LAB_001013db:
              if (uVar7 == 0x80) {
                ...
                if (iVar4 == 0x3d4) goto LAB_00101890;
                uVar7 = param_2[1];
              }
              goto LAB_001013e7;
            }
              ...
              *param_2 = (long)(local_118 + siz);
              if (uVar7 - siz == 0) {
                ...
                if ((iVar4 - 0x3d3U < 2) || (out = (uchar *)0x0, iVar4 == 0x32b)) {
                  ...
                  if (out == (uchar *)0x0) goto LAB_001015f6;
...

{
  ...
  local_68 = (void *)0x0;
  if ((((*(byte *)(*(long *)(*(int **)(param_1 + 0x18) + 0x36) + 0x50) & 8) != 0) ||
      (iVar7 = **(int **)(param_1 + 0x18), iVar7 == 0x10000)) || (iVar7 < 0x304)) goto LAB_00101a46;
  if (uVar9 == 0) {
LAB_00101db0:
    ERR_new();
    uVar13 = 0x4ae;
LAB_00101c21:
    ERR_set_debug("ssl/statem/statem_lib.c",uVar13,"tls_process_rpk");
...
LAB_00101aaf:
    ...
    uVar14 = (ulong)*pbVar8;
    pbVar15 = pbVar8 + 1;
    if (uVar9 - 1 < uVar14) goto LAB_00101db0;
    iVar7 = *(int *)(param_1 + 0x78);
    pbVar8 = pbVar15 + uVar14;
    uVar9 = (uVar9 - 1) - uVar14;
    *param_2 = (long)pbVar8;
    param_2[1] = uVar9;
    if (iVar7 == 0) {
      if (uVar14 == 0) goto LAB_00101a46;
      ERR_new();
      uVar13 = 0x4bf;
      goto LAB_00101c21;
    }
    if (*(void **)(param_1 + 0xbb0) != (void *)0x0) {
      if ((*(ulong *)(param_1 + 3000) != uVar14) ||
         (iVar7 = CRYPTO_memcmp(pbVar15,*(void **)(param_1 + 0xbb0),uVar14), iVar7 != 0)) {
        ERR_new();
        uVar13 = 0x4b9;
        goto LAB_00101c21;
      }
...
LAB_00101a8a:
        ...
        *param_2 = (long)pbVar15;
        uVar11 = (ulong)bVar1 << 0x10 | (ulong)bVar2 << 8 | (ulong)bVar3;
        uVar14 = uVar9 - 3;
        param_2[1] = uVar14;
        if (uVar11 != uVar14) goto LAB_00101a79;
        uVar13 = 1;
        if (uVar11 == 0) goto LAB_00101acf;
        uVar12 = uVar11;
        if ((((*(byte *)(*(long *)(*(int **)(param_1 + 0x18) + 0x36) + 0x50) & 8) != 0) ||
            (iVar7 = **(int **)(param_1 + 0x18), iVar7 < 0x304)) || (iVar7 == 0x10000)) {
LAB_00101b32:
          uVar13 = *puVar5;
          param_2[1] = uVar14 - uVar12;
          uVar6 = puVar5[0x8e];
          *param_2 = (long)(pbVar15 + uVar12);
          local_60 = pbVar15;
          pkey = (EVP_PKEY *)d2i_PUBKEY_ex(0,&local_60,uVar12,uVar13,uVar6);
          if ((pkey == (EVP_PKEY *)0x0) || (local_60 != pbVar15 + uVar12)) {
            ERR_new();
            uVar13 = 0x4ef;
LAB_00101b8f:
            ERR_set_debug("ssl/statem/statem_lib.c",uVar13,"tls_process_rpk");
            ...
            iVar7 = EVP_PKEY_missing_parameters(pkey);
            if (iVar7 == 0) {
              if ((((*(byte *)(*(long *)(*(int **)(param_1 + 0x18) + 0x36) + 0x50) & 8) != 0) ||
                  (iVar7 = **(int **)(param_1 + 0x18), iVar7 < 0x304)) || (iVar7 == 0x10000)) {
LAB_00101e68:
              ...
              uVar12 = (uVar11 - 3) - uVar12;
              if (uVar12 == param_2[1]) {
                if (1 < uVar12) {
                  uVar4 = *(ushort *)*param_2;
                  uVar12 = uVar12 - 2;
                  uVar9 = (ulong)(ushort)(uVar4 << 8 | uVar4 >> 8);
                  if (uVar9 <= uVar12) {
                    puVar10 = (ushort *)*param_2 + 1;
                    if (uVar9 == uVar12) {
                      *param_2 = (long)puVar10 + uVar9;
                      param_2[1] = 0;
                      local_58 = puVar10;
                      local_50 = uVar12;
                      iVar7 = tls_collect_extensions(param_1,&local_58,0x10000,&local_68,0,1);
                      if ((iVar7 != 0) &&
                         (iVar7 = tls_parse_all_extensions(param_1,0x10000,local_68,0,0,1),
                         iVar7 != 0)) goto LAB_00101e68;
                      goto LAB_00101bb4;
                    }
                  }
                }
...
LAB_00101bb4:
        ...
        *param_2 = (long)pbVar15;
        uVar14 = uVar9 - 6;
        param_2[1] = uVar14;
        uVar12 = (ulong)bVar3 | (ulong)bVar1 << 0x10 | (ulong)bVar2 << 8;
        if (uVar12 != 0) {
          if (uVar12 <= uVar14) goto LAB_00101b32;
          ERR_new();
          uVar13 = 0x4e9;
          goto LAB_00101a8a;
        }
...
LAB_00102117:
    ...
    lVar1 = *param_3;
    if (lVar1 == 0) {
      if ((EVP_PKEY *)param_3[1] == (EVP_PKEY *)0x0) goto LAB_001020c0;
...

{
  ...
  if (iVar1 == 0) {
    ...
    if (pcVar8 == (code *)0x0) {
      ...
      if (pcVar8 == (code *)0x0) goto joined_r0x00102701;
    }
    else {
      ossl_statem_set_in_init(param_1,0);
    }
...
LAB_00102a38:
      ...
      if (pbVar1[3] != 0) goto LAB_00102a38;
      *(undefined8 *)(param_1 + 0x108) = 0;
      if (*(code **)(param_1 + 0x4f8) == (code *)0x0) goto LAB_00102930;
      (**(code **)(param_1 + 0x4f8))
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (*(int *)(param_1 + 0x2f8) == 0x101) goto LAB_00102ca1;
        ...
        if ((*(long *)(param_1 + 8) != 0) && (*(long *)(param_1 + 0xb88) != 0)) {
          if ((((*(long *)(*(long *)(param_1 + 8) + 0x230) != 0) ||
             ...
             ((*(long *)(param_1 + 0x980) != 0 ||
              (*(long *)(*(long *)(param_1 + 0x880) + 0x60) != 0)))) goto LAB_00103109;
...
void check_for_downgrade(long param_1,int param_2,undefined4 *param_3)

{
  ...
  if (param_2 == 0x303) {
    iVar2 = ssl_version_supported(param_1,0x304,0);
    if (iVar2 != 0) {
      *param_3 = 1;
      return;
    }
  }
  else if (((*(byte *)(*(long *)(*(long *)(param_1 + 0x18) + 0xd8) + 0x50) & 8) == 0) &&
          (param_2 < 0x303)) {
    iVar2 = ssl_version_supported(param_1,0x303,0);
    uVar1 = 2;
    if (iVar2 != 0) goto LAB_001032d7;
  }
  uVar1 = 0;
LAB_001032d7:
  *param_3 = uVar1;
...

{
  ...
  do {
    if (*(code **)(piVar4 + 4) != (code *)0x0) {
      uVar3 = (**(code **)(piVar4 + 4))();
      iVar1 = ssl_method_error(param_1,uVar3);
      if (iVar1 == 0) {
        return *(int *)(param_1 + 0x48) == *piVar4;
      }
    }
    piVar2 = piVar4 + 6;
    piVar4 = piVar4 + 6;
...
undefined8 ssl_choose_server_version(long param_1,long param_2,undefined4 *param_3)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  iVar4 = *piVar1;
  *(int *)(param_1 + 0x9d4) = iVar5;
  if (iVar4 == 0x10000) {
    piVar9 = &tls_version_table;
LAB_00103486:
    lVar7 = *(long *)(param_2 + 0x288);
    if (*(int *)(lVar7 + 0x308) == 0) goto LAB_0010349d;
    if ((*(byte *)(*(long *)(piVar1 + 0x36) + 0x50) & 8) == 0) {
LAB_001035c1:
      local_48 = 0;
      *(undefined4 *)(lVar7 + 0x30c) = 1;
      if (*(long *)(lVar7 + 0x300) != 0) {
        uVar10 = (ulong)**(byte **)(lVar7 + 0x2f8);
        puVar12 = (ushort *)(*(byte **)(lVar7 + 0x2f8) + 1);
        if (*(long *)(lVar7 + 0x300) - 1U == uVar10) {
          *(byte **)(lVar7 + 0x2f8) = (byte *)((long)puVar12 + uVar10);
          *(undefined8 *)(lVar7 + 0x300) = 0;
          ...
          if (0x300 < iVar5) {
            ...
            do {
              local_54 = uVar3;
              puVar11 = (ushort *)((uVar10 & 0xfffffffffffffffe) + (long)puVar12);
              do {
                if (puVar11 == puVar12) {
                  if (uVar10 != 0) goto LAB_001035fc;
                  uVar6 = 0x102;
                  if (local_54 == 0) goto LAB_0010351e;
                  if (*(int *)(param_1 + 0x8d0) == 0) {
                    check_for_downgrade(param_1,local_54,param_3);
                    *(uint *)(param_1 + 0x48) = local_54;
                    *(undefined8 *)(param_1 + 0x18) = local_48;
                    iVar5 = ssl_set_record_protocol_version(param_1,local_54);
                    if (iVar5 != 0) goto LAB_001035a1;
                    uVar6 = 0xc0103;
                  }
                  else if (local_54 == 0x304) {
                    uVar6 = 0;
                  }
                  goto LAB_0010351e;
                }
                ...
                iVar5 = ssl_version_cmp(param_1,uVar8,local_54);
              } while (iVar5 < 1);
              iVar5 = ssl_version_supported(param_1,uVar8,&local_48);
              uVar3 = (uint)uVar8;
              if (iVar5 == 0) {
                uVar3 = local_54;
              }
...
LAB_001034a7:
    iVar4 = ssl_version_cmp(param_1,iVar5,0x304);
    if (-1 < iVar4) {
      iVar5 = 0x303;
    }
    bVar2 = false;
    if (*piVar9 != 0) {
      do {
        if ((*(long *)(piVar9 + 4) != 0) && (iVar4 = ssl_version_cmp(param_1,iVar5), -1 < iVar4)) {
          uVar6 = (**(code **)(piVar9 + 4))();
          iVar4 = ssl_method_error(param_1,uVar6);
          if (iVar4 == 0) {
            check_for_downgrade(param_1,*piVar9,param_3);
            iVar5 = *piVar9;
            *(undefined8 *)(param_1 + 0x18) = uVar6;
            *(int *)(param_1 + 0x48) = iVar5;
            iVar5 = ssl_set_record_protocol_version(param_1);
            uVar6 = 0xc0103;
            if (iVar5 != 0) {
              uVar6 = 0;
            }
      ...
      if (bVar2) goto LAB_00103519;
    }
    uVar6 = 0x18c;
  }
  else {
    if (iVar4 == 0x1ffff) {
      piVar9 = &dtls_version_table;
      goto LAB_00103486;
    }
    if (((*(byte *)(*(long *)(piVar1 + 0x36) + 0x50) & 8) != 0) || (iVar4 < 0x304)) {
      iVar5 = ssl_version_cmp(param_1,iVar5,*(undefined4 *)(param_1 + 0x48));
      uVar6 = 0x10a;
      if (-1 < iVar5) {
        *param_3 = 0;
LAB_001035a1:
    ...
    lVar7 = *(long *)(param_2 + 0x288);
    if (*(int *)(lVar7 + 0x308) != 0) goto LAB_001035c1;
    piVar9 = &tls_version_table;
LAB_0010349d:
    if (*(int *)(param_1 + 0x8d0) == 0) goto LAB_001034a7;
LAB_00103519:
    uVar6 = 0x102;
  }
LAB_0010351e:
    ...
    *param_2 = 0;
    ...
    if (*piVar6 == 0) {
      *param_3 = 0;
      ...
      iVar5 = 0;
      do {
        while (*(code **)(piVar6 + 2) == (code *)0x0) {
          bVar1 = true;
          iVar5 = 0;
LAB_00103824:
          piVar3 = piVar6 + 6;
          piVar6 = piVar6 + 6;
          if (*piVar3 == 0) goto LAB_0010386b;
        }
        piVar3 = (int *)(**(code **)(piVar6 + 2))();
        if ((iVar5 == 0) && (bVar1)) {
          iVar5 = *piVar6;
          bVar1 = true;
          iVar2 = ssl_method_error(param_1,piVar3);
          if (iVar2 == 0) {
LAB_00103807:
        ...
        if (bVar1) goto LAB_00103807;
        piVar6 = piVar6 + 6;
        *param_2 = *piVar3;
      } while (*piVar6 != 0);
LAB_0010386b:
      *param_3 = local_44;
      if (local_44 != 0) goto LAB_0010387a;
    }
    uVar4 = 0xbf;
  }
  else {
    ...
    if (iVar7 == 0) {
      if (pSVar4[6].ssl_shutdown == (_func_3061 *)0x0) {
        ...
        if (iVar7 < 1) {
          ...
          iVar8 = (-(uint)((*(uint *)(*(long *)&param_1->wbio[1].ex_data.dummy + 0x50) & 8) == 0) &
                  0xffff0406) + 0xfefd;
          iVar7 = ssl_version_cmp(param_1,local_38,iVar8);
          if ((-1 < iVar7) ||
             (lVar11 = SSL_ctrl(param_1,0x7b,(long)iVar8,(void *)0x0), (int)lVar11 != 0))
          goto LAB_00103984;
          ERR_new();
...
LAB_00103984:
        if (*(int *)&param_1->s2 == 0) {
          if ((param_1->tls_session_ticket_ext_cb_arg == (void *)0x0) ||
             (lVar11._0_4_ = param_1[1].server, lVar11._4_4_ = param_1[1].new_session, lVar11 == 0))
          {
            LOCK();
          ...
          *(undefined1 (*) [16])&(param_1->ex_data).dummy = (undefined1  [16])0x0;
          lVar11 = *(long *)&pBVar5[1].ex_data.dummy;
...
LAB_001039f0:
        ...
        for (iVar7 = 0; iVar8 = OPENSSL_sk_num(psVar10), iVar7 < iVar8; iVar7 = iVar7 + 1) {
          lVar11 = OPENSSL_sk_value(psVar10,iVar7);
          if ((*(byte *)(*(long *)&param_1->wbio[1].ex_data.dummy + 0x50) & 8) == 0) {
            uVar3 = *(undefined4 *)(lVar11 + 0x30);
            iVar8 = ssl_version_cmp(param_1,local_34,*(undefined4 *)(lVar11 + 0x2c));
          }
          else {
            uVar3 = *(undefined4 *)(lVar11 + 0x38);
            iVar8 = ssl_version_cmp(param_1,local_34,*(undefined4 *)(lVar11 + 0x34));
          }
...

{
  ...
  if ((*(long *)(param_1 + 0x260) == 0) || (*(long *)(param_1 + 0x2e8) == 0)) {
    ...
    if ((int)uVar3 != 0) goto LAB_00104070;
    lVar1 = *(long *)(*(long *)(param_1 + 0x18) + 0xd8);
    ...
    if ((*(byte *)(lVar1 + 0x50) & 8) == 0) {
      if (0x303 < local_14) {
        local_14 = 0x303;
            ...
            (iVar2 = ssl_set_record_protocol_version(param_1,0x100), iVar2 == 0)) goto LAB_0010406e;
...

{
  ...
  if ((param_3 != 0) && (param_4 != 0)) {
    uVar4 = 0;
    do {
      while (sVar1 = *(short *)(param_3 + uVar4 * 2), sVar1 == param_2) {
        uVar3 = uVar4;
        if (param_5 == 0) {
LAB_00104150:
        ...
        do {
          uVar4 = uVar3;
          iVar2 = tls_group_allowed(param_1,sVar1,0x20006);
          if (iVar2 != 0) goto LAB_00104150;
          uVar3 = uVar4 + 1;
          if (param_4 <= uVar3) {
            return 0;
          }
          sVar1 = *(short *)(param_3 + uVar3 * 2);
        } while (sVar1 == param_2);
        uVar4 = uVar4 + 2;
        if (param_4 <= uVar4) {
          return 0;
...
LAB_001041c0:
    ...
    if (iVar1 != 0) {
      ...
      if ((iVar1 != 0) && (iVar1 = ssl3_finish_mac(param_1,param_2,local_90[0]), iVar1 != 0)) {
        bVar2 = true;
        if (param_4 == 0) goto LAB_001041ce;
...

{
  ...
  if (lVar3 == 0) {
    ...
    if (1 < (ulong)param_2[1]) {
      uVar1 = *(ushort *)*param_2;
      uVar4 = param_2[1] - 2;
      puVar7 = (ushort *)*param_2 + 1;
      uVar6 = (ulong)(ushort)(uVar1 << 8 | uVar1 >> 8);
      if (uVar6 <= uVar4) {
        *param_2 = (long)puVar7 + uVar6;
...
LAB_001043d0:
          ...
          if (uVar6 - 2 < uVar4) goto LAB_001043d0;
          local_48 = puVar7 + 1;
          uVar6 = (uVar6 - 2) - uVar4;
          puVar7 = (ushort *)((long)local_48 + uVar4);
    ...
    uVar5 = 0xa75;
LAB_001043e1:
    ERR_set_debug("ssl/statem/statem_lib.c",uVar5,"parse_ca_names");
    ossl_statem_fatal(param_1,0x32,0x9f,0);
  }
LAB_00104403:
  a = (X509_NAME *)0x0;
...

{
  ...
  if (*(long *)(param_1 + 0x260) != 0) {
    bVar7 = *(long *)(param_1 + 0x2e8) == 0;
  }
  if (*(int *)(param_1 + 0x78) == 0) {
LAB_00104940:
    piVar5 = *(int **)(param_1 + 0x18);
    if ((*(byte *)(*(long *)(piVar5 + 0x36) + 0x50) & 8) != 0) goto LAB_001049a0;
    if ((0x303 < *piVar5) && (*piVar5 != 0x10000)) {
...
LAB_00104988:
    if ((*piVar5 == 0x10000) || (*piVar5 < 0x304)) goto LAB_001049a0;
  }
  else {
    ...
    piVar5 = *(int **)(param_1 + 0x18);
    if ((*(byte *)(*(long *)(piVar5 + 0x36) + 0x50) & 8) == 0) {
      if ((*piVar5 != 0x10000) && (0x303 < *piVar5)) {
...
LAB_001049a0:
  ...
  *(undefined4 *)(param_1 + 0x1b8) = 0;
  ...
  if (len == param_2[1]) {
    ...
    if ((((bVar7) && (*(long *)(param_1 + 0x260) != 0)) && (*(long *)(param_1 + 0x2e8) != 0)) &&

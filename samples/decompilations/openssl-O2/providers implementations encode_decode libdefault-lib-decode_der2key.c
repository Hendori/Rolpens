  ...
  if ((param_3 == 8) && (UNRECOVERED_JUMPTABLE != (code *)0x0)) {
    ...
    if (*(int *)(param_1 + 0x110) == 0) {
      iVar1 = 0x87;
                    ...
                    /* WARNING: Could not recover jumptable at 0x001000e7. Too many branches */
...
LAB_00100491:
            if (local_e0 != (EC_KEY *)0x0) goto LAB_0010037b;
          }
          if (*(int *)(param_1 + 0x22) != 0) goto LAB_001004b0;
        }
        if ((uVar7 & 0x84) != 0) {
          local_f0 = local_f8;
          if ((*(code **)(param_1[0x21] + 0x30) != (code *)0x0) &&
             (local_e0 = (EC_KEY *)(**(code **)(param_1[0x21] + 0x30))(0,&local_f0,local_e8),
             local_e0 != (EC_KEY *)0x0)) goto LAB_0010037b;
          if (*(int *)(param_1 + 0x22) != 0) goto LAB_001004b0;
        }
        ERR_clear_last_mark();
      }
...
LAB_00100447:
      if (local_e0 != (EC_KEY *)0x0) goto LAB_0010037b;
      if (*(int *)(param_1 + 0x22) == 0) goto LAB_0010045a;
LAB_001004b0:
      ERR_clear_last_mark();
      goto LAB_001001a9;
    }
    local_e0 = (EC_KEY *)(*pcVar1)(&local_f0,local_e8,param_1);
    if ((*(byte *)((long)param_1 + 0x114) & 1) == 0) goto LAB_00100447;
    ERR_clear_last_mark();
    uVar3 = 0;
  }
  (**(code **)(param_1[0x21] + 0x58))(local_e0);
  ...
  if (p8 != (PKCS8_PRIV_KEY_INFO *)0x0) {
    ...
    if (iVar1 != 0) {
      ...
      if (iVar1 != *(int *)(param_3[0x21] + 0x18)) {
        iVar1 = OBJ_obj2nid(local_28->algorithm);
        if ((iVar1 != 0x198) || (*(int *)(param_3[0x21] + 0x18) != 0x494)) goto LAB_001006a0;
      }
      uVar2 = ossl_prov_ctx_get0_libctx(*param_3);
      uVar2 = (*param_4)(p8,uVar2,param_3 + 1);
      goto LAB_001006a2;
    }
  }
LAB_001006a0:
...
LAB_00100a67:
    ...
    if (iVar1 != *(int *)(*(undefined8 **)(param_3 + 0x108) + 3)) goto LAB_00100a67;
    lVar3 = ossl_slh_dsa_key_new(uVar2,param_3 + 8,**(undefined8 **)(param_3 + 0x108));
    if (lVar3 == 0) goto LAB_00100a67;
...
LAB_00100bba:
        ...
        if (local_50 != (undefined8 *)0x0) goto LAB_00100bef;
      }
    }
    else {
      ERR_new();
      ...
      if (local_50 == (undefined8 *)0x0) goto LAB_00100c20;
LAB_00100bef:
      ASN1_OBJECT_free((ASN1_OBJECT *)*local_50);
      ASN1_BIT_STRING_free((ASN1_BIT_STRING *)local_50[1]);
      CRYPTO_free(local_50);
...

{
  ...
  if ((int)uVar2 == 0) {
    if (*(int *)(*(long *)(param_2 + 0x108) + 0x18) == 6) goto LAB_00100e3d;
  }
  else {
    if ((int)uVar2 != 0x1000) {
      return 0;

...
LAB_001000cc:
    ...
    if (iVar11 <= iVar2) {
      ...
      do {
        ...
        if ((((local_a0 == (int)uVar9) && ((char)uVar15 != '\x01')) &&
            ((byte)(uVar16 - 0x2b) < 0x30)) &&
           ((0x800000000005U >> ((ulong)(uVar16 - 0x2b) & 0x3f) & 1) != 0)) goto LAB_00100222;
...
LAB_0010046b:
            ...
            if ((int)local_68._0_4_ < 2) goto LAB_0010046b;
            iVar13 = (int)uVar16 % 100;
            iVar19 = *(int *)(ydays_1 + (long)(int)local_68._0_4_ * 4) + iVar6;
            if ((0xa3d70a < (uVar16 * -0x3d70a3d7 + 0x51eb850 >> 4 | uVar16 * -0x70000000)) &&
               (iVar19 = iVar7, iVar13 != 0)) {
              iVar19 = iVar7 + (uint)((uVar16 & 3) == 0);
            }
            iVar18 = local_68._0_4_ + 2;
            iVar7 = iVar19;
          }
          ...
          local_68._8_4_ =
               ((iVar19 >> 2) + (iVar18 * 0xd) / 5 + iVar6 + iVar13 + (int)uVar16 / 400 + 6 +
               ((int)uVar16 / 100) * 5) % 7;
          ...
          do {
            ...
            if (iVar7 == 0) {
              if ((iVar2 != iVar11) && (iVar5 != iVar11)) {
                uVar16 = (uint)*(byte *)(lVar3 + iVar11);
                if (*(byte *)(lVar3 + iVar11) != 0x5a) goto LAB_001004b8;
                goto LAB_00100690;
              }
              break;
            }
...
LAB_001004b8:
        if (((uVar16 - 0x2b & 0xfd) == 0) && (bVar20 = (char)uVar16 == '-', iVar11 + 5 == iVar2)) {
          local_8c = 0;
          ...
          while (iVar7 != 0) {
            ...
            if (param_1 != (undefined8 *)0x0) {
              if (iVar12 == iVar5) {
                local_8c = iVar11 * 0xe10;
              }
              else if ((iVar12 != 6) + 7 == iVar5) {
                local_8c = local_8c + iVar11 * 0x3c;
              }
            }
            iVar5 = iVar5 + 1;
            if (iVar5 == iVar12 + 2) {
              if ((local_8c == 0) ||
                 (iVar5 = OPENSSL_gmtime_adj(local_78,0,
                                             (long)(int)(local_8c * ((bVar20 - 1) + (uint)bVar20))),
                 iVar5 != 0)) {
                iVar11 = (int)lVar4;
                goto LAB_00100694;
              }
...

{
  ...
  if (param_3 != -1) {
    if (param_3 == 0x17) {
      if (param_2[5] - 0x32 < 100) goto LAB_00100763;
    }
    else if (param_3 == 0x18) {
LAB_00100763:
      if (param_1 == (ASN1_STRING *)0x0) goto LAB_0010084b;
      goto LAB_0010076c;
    }
...
LAB_0010084b:
    ...
    if (iVar5 == 0) goto LAB_001007c2;
    uVar7 = param_2[4];
    buf = param_1->data;
    param_1->type = param_3;
    if (uVar7 == 0x7fffffff) goto LAB_001007c2;
    uVar6 = param_2[5];
    if (param_3 == 0x18) {
      if (0x7ffff893 < (int)uVar6) goto LAB_001007c2;
      goto LAB_001008a5;
    }
  }
  else {
...

{
  ...
  local_60 = t;
  lVar1 = OPENSSL_gmtime(&local_60,local_58);
  if (lVar1 == 0) {
    ERR_new();
    ...
    pAVar2 = (ASN1_TIME *)ossl_asn1_time_from_tm(s,lVar1,0xffffffff);
  }
...

{
  ...
  if (t == (ASN1_TIME *)0x0) {
    ...
    lVar3 = OPENSSL_gmtime(&local_60,local_58);
    if (lVar3 == 0) goto LAB_00100b4e;
  }
  else {
    iVar1 = ossl_asn1_time_to_tm(local_58,t);
    if (iVar1 == 0) {
LAB_00100b4e:
  ...
  if (out == (ASN1_GENERALIZEDTIME **)0x0) {
    pAVar2 = (ASN1_GENERALIZEDTIME *)ossl_asn1_time_from_tm(0,local_58,0x18);
  }
  else {
    pAVar2 = (ASN1_GENERALIZEDTIME *)ossl_asn1_time_from_tm(*out,local_58,0x18);
...
LAB_00100ce8:
      ...
      if (local_44 - 0x32U < 100) {
        ...
        if (local_78.data == (uchar *)0x0) goto LAB_00100ce8;
...
undefined8 ASN1_TIME_diff(undefined8 param_1,undefined8 param_2,long param_3,undefined8 param_4)
...

{
  ...
  iVar1 = ossl_asn1_time_print_ex(fp,a,0);
  return (int)(0 < iVar1);
}
...

{
  ...
  local_20 = *(long *)(in_FS_OFFSET + 0x28);
  if (param_1 != 0) {
    iVar1 = ossl_asn1_time_to_tm(auStack_58,param_1);
    if (iVar1 != 0) {
...
int ASN1_TIME_compare(undefined8 param_1,long param_2)

{
  ...
  if (param_2 == 0) {
    ...
    lVar2 = OPENSSL_gmtime(local_58,local_98);
    if (lVar2 != 0) {
      iVar1 = ASN1_TIME_to_tm(param_1,local_58);
      goto joined_r0x0010136b;
    }
  }
  else {
...
joined_r0x0010136b:
      if ((iVar1 != 0) &&
         (iVar1 = OPENSSL_gmtime_diff(&local_a0,&local_9c,local_98,local_58), iVar1 != 0)) {
        iVar1 = 1;
        if ((local_a0 < 1) && (local_9c < 1)) {
          iVar1 = -(uint)(local_a0 != 0 || local_9c != 0);
        }

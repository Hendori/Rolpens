    ...
    if (iVar3 == 0) {
      if (param_1[0x1d] == 0) {
        if (((X509 *)param_1[0x19] == (X509 *)0x0) || ((EVP_PKEY *)param_1[0x1b] == (EVP_PKEY *)0x0)
          ...
          iVar3 = X509_check_private_key((X509 *)param_1[0x19],(EVP_PKEY *)param_1[0x1b]);
          if (iVar3 == 0) {
            ERR_new();
            ...
            *(X509_ALGOR **)(lVar6 + 0x20) = pXVar5;
            if (pXVar5 != (X509_ALGOR *)0x0) {
              lVar6 = X509_get0_subject_key_id(param_1[0x19]);
              if ((lVar6 != 0) || (lVar6 = param_1[0x1c], lVar6 != 0)) goto LAB_00100960;
              goto LAB_001008b0;
            }
          }
        }
        ...
        lVar6 = *param_2;
        uVar2 = EVP_MD_get_type(param_1[0x1f]);
        lVar4 = OSSL_CRMF_pbmp_new(*param_1,param_1[0x1e],uVar2,(long)iVar3,uVar1);
        str = ASN1_STRING_new();
        if ((((lVar4 == 0) || (str == (ASN1_STRING *)0x0)) ||
            (iVar3 = i2d_OSSL_CRMF_PBMPARAMETER(lVar4,&local_48), iVar3 < 0)) ||
           ((iVar3 = ASN1_STRING_set(str,local_48,iVar3), iVar3 == 0 ||
            (lVar8 = ossl_X509_ALGOR_from_nid(0x30e,0x10,str), lVar8 == 0)))) {
          ...
          *(long *)(lVar6 + 0x20) = lVar8;
          if ((lVar4 == 0) || (iVar3 = ossl_cmp_hdr_set1_senderKID(*param_2), iVar3 != 0))
          goto LAB_001008b0;
        }
      }
    }
      ...
      if (lVar6 != 0) {
LAB_00100960:
        iVar3 = ossl_cmp_hdr_set1_senderKID(*param_2,lVar6);
        if (iVar3 == 0) goto LAB_001007ef;
LAB_001008b0:
        if (*(int *)(param_1 + 0x18) == 0) {
          lVar6 = ossl_cmp_calc_protection(param_1,param_2);
          param_2[2] = lVar6;
          if (lVar6 == 0) goto LAB_001007ef;
        }
      }
      iVar3 = ossl_cmp_msg_add_extraCerts(param_1,param_2);
      if (iVar3 != 0) {
        iVar3 = ossl_cmp_general_name_is_NULL_DN(*(undefined8 *)(*param_2 + 8));
        uVar7 = 1;
        if ((iVar3 == 0) || (*(long *)(*param_2 + 0x28) != 0)) goto LAB_00100819;
        ERR_new();

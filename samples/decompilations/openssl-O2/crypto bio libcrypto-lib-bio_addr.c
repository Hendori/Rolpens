...

{
  ...
  if ((param_1 != 0) && (lVar2 = BIO_ADDR_new(), lVar2 != 0)) {
  ...
  if (param_2 == 1) {
    ...
    *(undefined8 *)(param_1 + 0x33) = 0;
    ...
    for (uVar2 = (ulong)(((int)(param_1 + 1) -
                         (int)(undefined8 *)((ulong)(param_1 + 5) & 0xfffffffffffffff8)) + 0x6cU >>
...

{
  ...
  sVar1 = *param_1;
  iVar2 = 0x10;
  if ((sVar1 != 2) && (iVar2 = 0x1c, sVar1 != 10)) {
...
LAB_00100c18:
    ...
    if (param_4 == 1) {
      sVar4 = strlen(param_1);
      paVar5 = (addrinfo *)CRYPTO_zalloc(0x30,"crypto/bio/bio_addr.c",0x260);
      *param_7 = paVar5;
      if (paVar5 != (addrinfo *)0x0) {
        ...
        lVar6 = BIO_ADDR_new();
        if (lVar6 != 0) {
          BIO_ADDR_rawmake(lVar6,1,param_1,sVar4,0);
          paVar5 = *param_7;
          psVar7 = (sockaddr *)BIO_ADDR_sockaddr_noconst(lVar6);
          paVar5->ai_addr = psVar7;
        }
...
LAB_00100c0f:
  ...
  while( true ) {
    ...
    if (__ecode == -0xb) {
      ...
      ERR_set_error(2,*piVar9,"calling getaddrinfo()");
      ERR_new();
  ...
  uVar8 = 0x2ec;
LAB_00100e01:
  ERR_set_debug("crypto/bio/bio_addr.c",uVar8,"BIO_lookup_ex");
  if (iVar3 != 0) {
    __ecode = iVar3;
  }
  pcVar10 = gai_strerror(__ecode);
  ERR_set_error(0x20,0x80002,pcVar10);
  uVar8 = 0;
LAB_00100bcf:
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return uVar8;

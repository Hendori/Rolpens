...
joined_r0x001003e1:
    if (pBVar2 == (BIGNUM *)0x0) goto LAB_00100370;
  }
  else {
    iVar1 = ossl_ffc_params_copy(&dh->p,param_1 + 8);
    if (iVar1 == 0) goto LAB_00100370;
    *(undefined4 *)&dh->meth = *(undefined4 *)(param_1 + 0x80);
...

{
  ...
  if ((local_44 == 0x10) &&
    ...
    if (iVar2 == 0x1c) {
      ...
      if (iVar2 != 0x398) goto LAB_0010046b;
      dh = (DH *)d2i_DHxparams(0,&local_38,(long)iVar1);
    }
    if (dh == (DH *)0x0) goto LAB_0010046b;
    ...
    if ((iVar1 == 0) || (iVar1 = DH_generate_key(dh), iVar1 == 0)) goto LAB_0010049d;
  }
  else {
    ai = (ASN1_INTEGER *)0x0;
LAB_0010046b:

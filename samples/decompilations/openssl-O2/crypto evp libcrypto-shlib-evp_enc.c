...

{
  ...
  if (iVar2 == 0) {
    ...
    if ((pEVar3->flags & 0x100000) == 0) {
      if ((int)param_5 < 1) goto LAB_00100597;
      goto LAB_001003eb;
    }
LAB_001004d0:
    if (uVar7 == 1) {
    ...
    if ((int)param_5 < 1) {
      if (param_5 == 0) {
        if ((uVar1 & 0x100000) == 0) goto LAB_00100597;
        uVar4 = 0;
      }
      else {
        if ((uVar1 & 0x100000) == 0) {
LAB_00100597:
    ...
    if ((uVar1 & 0x100000) != 0) goto LAB_001004d0;
LAB_001003eb:
...
LAB_0010064b:
        ...
        if (0x20 < (int)uVar7) goto LAB_0010074d;
        iVar6 = uVar7 - iVar2;
...
LAB_00100af0:
          ...
          if (pcVar4 == (code *)0x0) goto LAB_00100af0;
          if (iVar5 == 1) {
            iVar5 = 0;
          }
    ...
    *outl = 0;
    if (ctx->encrypt == 0) {
      ...
      if (pEVar6 == (EVP_CIPHER *)0x0) {
        ...
        if (inl < 1) {
          if (inl == 0) {
            if ((uVar10 & 0x100000) == 0) goto LAB_00100fb9;
          }
          else {
...
LAB_00100ffc:
          ...
          *outl = iVar2;
          ...
          if (0x7ffffff6 < inl) {
            if ((uVar10 & 0x100000) == 0) goto LAB_00100e36;
            ...
            if ((ctx->flags & 0x100) == 0) {
              if (1 < uVar2) {
                if ((ctx->buf_len == 0) && (ctx->final_used != 0)) {
                  ...
                  if ((bVar1 != 0) && (uVar7 = (ulong)uVar2, (int)(uint)bVar1 <= (int)uVar2)) {
                    do {
                      uVar8 = (int)uVar7 - 1;
                      uVar7 = (ulong)uVar8;
                      if (bVar1 != ctx->final[uVar7]) {
                        ERR_new();
                        uVar9 = 0x544;
                        goto LAB_001014ed;
                      }
                    } while ((int)(uVar2 - uVar8) < (int)(uint)bVar1);
                    iVar5 = uVar2 - bVar1;
                    if (iVar5 != 0) {
                      do {
                  ...
                  uVar9 = 0x53f;
LAB_001014ed:
                  ERR_set_debug("crypto/evp/evp_enc.c",uVar9,"EVP_DecryptFinal_ex");
...

{
  ...
  case 1:
    if (-1 < arg) {
      if (ctx->key_len == arg) goto LAB_001017c2;
  ...
  case 6:
    ...
    goto LAB_00101923;
  default:
    goto switchD_00101785_caseD_7;
  case 9:
    if (-1 < arg) {
      type = 1;
      if (*(int *)&ctx->field_0x6c == arg) goto LAB_001017c2;
...
LAB_0010187f:
    type = evp_do_ciph_ctx_setparams(ctx->cipher,ctx[1].engine,local_d8);
LAB_00101805:
    if (type != -1) goto LAB_001017c2;
switchD_00101785_caseD_7:
    ERR_new();
...

{
  ...
  if ((param_1 != 0) && (*(code **)(param_1 + 0xe8) != (code *)0x0)) {
                    /* WARNING: Could not recover jumptable at 0x00102048. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if ((*param_1 != 0) &&
     (UNRECOVERED_JUMPTABLE = *(code **)(*param_1 + 0xf0), UNRECOVERED_JUMPTABLE != (code *)0x0)) {
                    /* WARNING: Could not recover jumptable at 0x0010212f. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (UNRECOVERED_JUMPTABLE != (code *)0x0) {
    ...
    uVar1 = ossl_provider_ctx(uVar1);
                    /* WARNING: Could not recover jumptable at 0x0010216a. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (*(long *)(param_1 + 0x110) != 0) {
    uVar1 = EVP_CIPHER_get0_provider();
    uVar1 = ossl_provider_ctx(uVar1);
                    /* WARNING: Could not recover jumptable at 0x001021b1. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
LAB_0010232d:
    ...
    local_38 = (undefined1  [16])0x0;
    iVar1 = EVP_CIPHER_CTX_get_key_length();
    if (iVar1 == keylen) goto LAB_0010232d;
...

{
  ...
  if (*(long *)(param_1 + 0x108) != 0) {
    uVar1 = EVP_CIPHER_get0_provider();
    uVar1 = ossl_provider_ctx(uVar1);
                    /* WARNING: Could not recover jumptable at 0x001023c1. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (*(long *)(*param_1 + 0x110) != 0) {
    uVar1 = EVP_CIPHER_get0_provider();
    uVar1 = ossl_provider_ctx(uVar1);
                    /* WARNING: Could not recover jumptable at 0x0010241c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (*(long *)(*param_1 + 0x108) != 0) {
    uVar1 = EVP_CIPHER_get0_provider();
    uVar1 = ossl_provider_ctx(uVar1);
                    /* WARNING: Could not recover jumptable at 0x0010246c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (param_2 == (EVP_CIPHER *)0x0) {
    ...
    if (param_2 != (EVP_CIPHER *)0x0) {
      if ((param_1->engine != (ENGINE *)0x0) || (*(int *)&param_2->init == 2)) goto LAB_00102d93;
      goto LAB_00102ca6;
    }
    ERR_new();
...
LAB_00102ca6:
    ...
    if (((param_1->flags & 0x100) != 0) &&
       (iVar3 = EVP_CIPHER_CTX_set_padding(param_1,0), iVar3 == 0)) goto LAB_00102dc3;
...
LAB_00102d37:
        ...
        if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00102d76. Too many branches */
                    /* WARNING: Treating indirect jump as call */
      ...
      if (UNRECOVERED_JUMPTABLE != (_func_1089 *)0x0) goto LAB_00102d37;
      local_50 = (ASN1_TYPE *)0x0;
      local_48 = 0;
      if (param_3 != (uchar *)0x0) {
        iVar3 = EVP_SKEY_get0_raw_key(param_3,&local_50,&local_48);
...

{
  ...
  if (param_6 == -1) {
    ...
    if (param_2 != (EVP_CIPHER *)0x0) goto LAB_0010308b;
LAB_001034cd:
    ...
    if (pEVar9 != (EVP_CIPHER *)0x0) {
      ...
      if (param_7 == '\0') {
        bVar4 = false;
        if (param_1->engine == (ENGINE *)0x0) goto LAB_001034f2;
        goto LAB_00103197;
      }
      goto LAB_001032bd;
    }
  ...
  param_1->encrypt = (uint)(param_6 != 0);
  if (param_2 == (EVP_CIPHER *)0x0) goto LAB_001034cd;
LAB_0010308b:
  if (param_7 == '\0') {
...
LAB_00103229:
        ...
        if (param_1->engine == (ENGINE *)0x0) {
          pEVar9 = param_1->cipher;
          if (local_c0 != (ENGINE *)0x0) goto LAB_001030c4;
LAB_0010324d:
          if (*(int *)&param_2->init != 2) {
            pEVar12 = param_2;
            if (pEVar9 == (EVP_CIPHER *)0x0) goto LAB_001032bd;
            if (*(code **)&pEVar9->ctx_size != (code *)0x0) {
              iVar5 = (**(code **)&pEVar9->ctx_size)(param_1);
              if (iVar5 == 0) goto LAB_00103490;
              pEVar9 = param_1->cipher;
            }
...
LAB_001035dc:
          ...
          if (*(EVP_CIPHER **)&param_1[1].encrypt == param_1->cipher) {
            param_1->cipher = (EVP_CIPHER *)0x0;
            EVP_CIPHER_free();
            param_1[1].encrypt = 0;
            param_1[1].buf_len = 0;
          ...
          param_1[1].encrypt = 0;
          param_1[1].buf_len = 0;
          if (pEVar9 != (EVP_CIPHER *)0x0) goto LAB_00103100;
LAB_001035d0:
          param_3 = local_c0;
          if (local_c0 == (ENGINE *)0x0) goto LAB_001035dc;
LAB_0010312d:
...
LAB_00103144:
        ...
        if ((pEVar9->flags & 0x40) == 0) goto LAB_00103197;
...
LAB_001034f2:
        ...
        if (bVar4) goto LAB_0010324d;
        pEVar12 = pEVar9;
        if ((pEVar9 == (EVP_CIPHER *)0x0) || (*(int *)&pEVar9->init != 2)) goto LAB_001032bd;
        if (*(EVP_CIPHER **)&param_1[1].encrypt == pEVar9) {
          param_1->cipher = (EVP_CIPHER *)0x0;
          EVP_CIPHER_free();
          param_1[1].encrypt = 0;
...
LAB_0010318b:
      pEVar9 = param_1->cipher;
      if (pEVar9 == (EVP_CIPHER *)0x0) goto LAB_00103490;
    }
    else {
      pEVar9 = param_1->cipher;
      if ((pEVar9 == (EVP_CIPHER *)0x0) || (param_2->nid != pEVar9->nid)) {
        if (param_3 == (ENGINE *)0x0) goto LAB_00103229;
        local_c0 = (ENGINE *)0x0;
LAB_001030c4:
        bVar4 = true;
LAB_001030c9:
...
LAB_00103100:
        ...
        if (param_3 == (ENGINE *)0x0) goto LAB_001035d0;
        iVar5 = ENGINE_init(param_3);
        if (iVar5 != 0) goto LAB_0010312d;
        ERR_new();
        uVar7 = 0x163;
        goto LAB_00103471;
      }
...
LAB_001032bd:
    if (pEVar12[1].do_cipher == (_func_1090 *)0x0) {
      ...
      if (pEVar12 == (EVP_CIPHER *)0x0) goto LAB_00103490;
      ...
      *(EVP_CIPHER **)&param_1[1].encrypt = pEVar12;
      if (p_Var3 != (_func_1090 *)0x0) goto LAB_00103308;
      ERR_new();
      uVar7 = 0xcf;
      goto LAB_00103471;
    }
      ...
      if (((param_1->flags & 0x100) == 0) ||
        ...
        if (param_8 != 0) {
          ...
          if (puVar10 == (undefined8 *)0x0) {
            ...
            puVar10 = &local_b8;
            if (puVar11 != (undefined8 *)0x0) goto LAB_0010339d;
          }
          else {
            local_b8 = *puVar10;
            uStack_b0 = puVar10[1];
...
LAB_0010339d:
        ...
        if (param_7 == '\0') {
          ...
          if (uVar20 == 0) {
            ...
            if (UNRECOVERED_JUMPTABLE_00 != (_func_1092 *)0x0) goto LAB_001033ed;
...
LAB_001033ed:
              ...
              if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00103457. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
LAB_00103851:
              ...
              if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x001038a4. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  ...
  if (param_5 < 0x21) {
    ...
    if (iVar1 != 0) {
      if (*(code **)(*param_1 + 0xb8) != (code *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00103ebb. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  ...
  if (param_5 < 0x21) {
    ...
    if (iVar1 != 0) {
      if (*(code **)(*param_1 + 0xc0) != (code *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00103fc8. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
LAB_001041cf:
    ...
    *(undefined8 *)(piVar3 + 0x1c) = *(undefined8 *)(param_2 + 0x18);
    ...
    if (iVar1 != 0) {
      ...
      if (iVar2 == 0) {
        if (*(long *)(piVar3 + 0x2c) != 0) goto LAB_0010414b;
        if (iVar6 == 0) goto LAB_001044e0;
LAB_0010414f:

...
void tear_down_part_0(void *param_1)

{
  OSSL_CMP_CTX_free(*(undefined8 *)((long)param_1 + 8));
  OSSL_CMP_MSG_free(*(undefined8 *)((long)param_1 + 0x10));
  OSSL_CMP_PKISI_free(*(undefined8 *)((long)param_1 + 0x18));
  CRYPTO_free(*(void **)((long)param_1 + 0x28));
  OPENSSL_sk_free(*(undefined8 *)((long)param_1 + 0x40));
  OPENSSL_sk_free(*(undefined8 *)((long)param_1 + 0x48));
  CRYPTO_free(param_1);
  return;
}
...

{
  ...
  puVar2 = (undefined8 *)CRYPTO_zalloc(0x60,"test/cmp_protect_test.c",0x3a);
  iVar1 = test_ptr("test/cmp_protect_test.c",0x3a,"fixture = OPENSSL_zalloc(sizeof(*fixture))",
                   puVar2);
  if (iVar1 != 0) {
    *puVar2 = param_1;
    uVar3 = OSSL_CMP_CTX_new(libctx,0);
    puVar2[1] = uVar3;
...

{
  ...
  lVar3 = set_up("test_X509_STORE");
  if (lVar3 != 0) {
    *(undefined4 *)(lVar3 + 0x54) = 0;
    uVar4 = OPENSSL_sk_new_null();
    *(undefined8 *)(lVar3 + 0x40) = uVar4;
    iVar1 = test_ptr("test/cmp_protect_test.c",0x1ee,"fixture->certs = sk_X509_new_null()",uVar4);
    if ((((iVar1 != 0) &&
         (iVar1 = OPENSSL_sk_push(*(undefined8 *)(lVar3 + 0x40),endentity1), iVar1 != 0)) &&
        (iVar1 = OPENSSL_sk_push(*(undefined8 *)(lVar3 + 0x40),endentity2), iVar1 != 0)) &&
       ((iVar1 = OPENSSL_sk_push(*(undefined8 *)(lVar3 + 0x40),root), iVar1 != 0 &&
        (iVar1 = OPENSSL_sk_push(*(undefined8 *)(lVar3 + 0x40),intermediate), iVar1 != 0)))) {
      uVar4 = OPENSSL_sk_dup(*(undefined8 *)(lVar3 + 0x40));
      *(undefined8 *)(lVar3 + 0x48) = uVar4;
      iVar1 = test_ptr("test/cmp_protect_test.c",499,"fixture->chain = sk_X509_dup(fixture->certs)",
                       uVar4);
      if (iVar1 != 0) {
        uVar2 = execute_X509_STORE_test(lVar3);
        tear_down_part_0(lVar3);
...

{
  ...
  lVar3 = set_up("test_cmp_build_cert_chain_no_certs");
  if (lVar3 != 0) {
    *(undefined4 *)(lVar3 + 0x58) = 0;
    *(undefined4 *)(lVar3 + 0x50) = 0;
    *(undefined8 *)(lVar3 + 0x38) = endentity2;
    uVar4 = OPENSSL_sk_new_null();
    *(undefined8 *)(lVar3 + 0x40) = uVar4;
    iVar1 = test_ptr("test/cmp_protect_test.c",0x1ca,"fixture->certs = sk_X509_new_null()",uVar4);
    if (iVar1 != 0) {
      uVar4 = OPENSSL_sk_new_null();
      *(undefined8 *)(lVar3 + 0x48) = uVar4;
      iVar1 = test_ptr("test/cmp_protect_test.c",0x1cb,"fixture->chain = sk_X509_new_null()",uVar4);
      if (iVar1 != 0) {
        iVar1 = OPENSSL_sk_push(*(undefined8 *)(lVar3 + 0x48),endentity2);
        iVar1 = test_true("test/cmp_protect_test.c",0x1cc,"sk_X509_push(fixture->chain, endentity2)"
                          ,iVar1 != 0);
        if (iVar1 != 0) {
          uVar2 = execute_cmp_build_cert_chain_test(lVar3);
          tear_down_part_0(lVar3);
          return uVar2;
        }
      }
...

{
  ...
  lVar3 = set_up("test_cmp_build_cert_chain_missing_intermediate");
  if (lVar3 != 0) {
    *(undefined4 *)(lVar3 + 0x58) = 0;
    *(undefined4 *)(lVar3 + 0x50) = 0;
    *(undefined8 *)(lVar3 + 0x38) = endentity2;
    uVar4 = OPENSSL_sk_new_null();
    *(undefined8 *)(lVar3 + 0x40) = uVar4;
    iVar1 = test_ptr("test/cmp_protect_test.c",0x194,"fixture->certs = sk_X509_new_null()",uVar4);
    if (iVar1 != 0) {
      uVar4 = OPENSSL_sk_new_null();
      *(undefined8 *)(lVar3 + 0x48) = uVar4;
      iVar1 = test_ptr("test/cmp_protect_test.c",0x195,"fixture->chain = sk_X509_new_null()",uVar4);
      if (iVar1 != 0) {
        iVar1 = OPENSSL_sk_push(*(undefined8 *)(lVar3 + 0x40),endentity1);
        iVar1 = test_true("test/cmp_protect_test.c",0x196,"sk_X509_push(fixture->certs, endentity1)"
                          ,iVar1 != 0);
        if (iVar1 != 0) {
          iVar1 = OPENSSL_sk_push(*(undefined8 *)(lVar3 + 0x40),root);
...

{
  ...
  lVar3 = set_up("test_cmp_build_cert_chain_no_root");
  if (lVar3 != 0) {
    ...
    *(undefined8 *)(lVar3 + 0x38) = endentity2;
    uVar4 = OPENSSL_sk_new_null();
    *(undefined8 *)(lVar3 + 0x40) = uVar4;
    iVar1 = test_ptr("test/cmp_protect_test.c",0x1a6,"fixture->certs = sk_X509_new_null()",uVar4);
    if (iVar1 != 0) {
      uVar4 = OPENSSL_sk_new_null();
      *(undefined8 *)(lVar3 + 0x48) = uVar4;
      iVar1 = test_ptr("test/cmp_protect_test.c",0x1a7,"fixture->chain = sk_X509_new_null()",uVar4);
      if (iVar1 != 0) {
        iVar1 = OPENSSL_sk_push(*(undefined8 *)(lVar3 + 0x40),endentity1);
        iVar1 = test_true("test/cmp_protect_test.c",0x1a8,"sk_X509_push(fixture->certs, endentity1)"
                          ,iVar1 != 0);
        if (iVar1 != 0) {
          iVar1 = OPENSSL_sk_push(*(undefined8 *)(lVar3 + 0x40),intermediate);
          ...
          if (iVar1 != 0) {
            ...
            iVar1 = test_true("test/cmp_protect_test.c",0x1aa,
                              "sk_X509_push(fixture->chain, endentity2)",iVar1 != 0);
            if (iVar1 != 0) {
              iVar1 = OPENSSL_sk_push(*(undefined8 *)(lVar3 + 0x48),intermediate);
...

{
  ...
  lVar3 = set_up("test_cmp_build_cert_chain_only_root");
  if (lVar3 != 0) {
    *(undefined4 *)(lVar3 + 0x58) = 1;
    *(undefined4 *)(lVar3 + 0x50) = 0;
    *(undefined8 *)(lVar3 + 0x38) = root;
    uVar4 = OPENSSL_sk_new_null();
    *(undefined8 *)(lVar3 + 0x40) = uVar4;
    iVar1 = test_ptr("test/cmp_protect_test.c",0x1b9,"fixture->certs = sk_X509_new_null()",uVar4);
    if (iVar1 != 0) {
      uVar4 = OPENSSL_sk_new_null();
      *(undefined8 *)(lVar3 + 0x48) = uVar4;
      iVar1 = test_ptr("test/cmp_protect_test.c",0x1ba,"fixture->chain = sk_X509_new_null()",uVar4);
      if (iVar1 != 0) {
        iVar1 = OPENSSL_sk_push(*(undefined8 *)(lVar3 + 0x40),root);
...

{
  ...
  lVar3 = set_up("test_cmp_build_cert_chain");
  if (lVar3 != 0) {
    *(undefined4 *)(lVar3 + 0x58) = 1;
    *(undefined4 *)(lVar3 + 0x50) = 0;
    *(undefined8 *)(lVar3 + 0x38) = endentity2;
    uVar4 = OPENSSL_sk_new_null();
    *(undefined8 *)(lVar3 + 0x40) = uVar4;
    iVar1 = test_ptr("test/cmp_protect_test.c",0x17a,"fixture->certs = sk_X509_new_null()",uVar4);
    if (iVar1 != 0) {
      uVar4 = OPENSSL_sk_new_null();
      *(undefined8 *)(lVar3 + 0x48) = uVar4;
      iVar1 = test_ptr("test/cmp_protect_test.c",0x17b,"fixture->chain = sk_X509_new_null()",uVar4);
      if (iVar1 != 0) {
        iVar1 = OPENSSL_sk_push(*(undefined8 *)(lVar3 + 0x40),endentity1);
        iVar1 = test_true("test/cmp_protect_test.c",0x17c,"sk_X509_push(fixture->certs, endentity1)"
                          ,iVar1 != 0);
        if (iVar1 != 0) {
          iVar1 = OPENSSL_sk_push(*(undefined8 *)(lVar3 + 0x40),root);
            ...
            if (iVar1 != 0) {
              ...
              if (iVar1 != 0) {
                ...
                iVar1 = test_true("test/cmp_protect_test.c",0x180,
                                  "sk_X509_push(fixture->chain, intermediate)",iVar1 != 0);
                if (iVar1 != 0) {
                  iVar1 = execute_cmp_build_cert_chain_test(lVar3);
                  *(undefined4 *)(lVar3 + 0x50) = 1;
                  if (iVar1 != 0) {
                    iVar2 = OPENSSL_sk_push(*(undefined8 *)(lVar3 + 0x48),root);
...
undefined4 test_MSG_protect_pbmac_no_sender(int param_1)

{
  ...
  lVar3 = set_up("test_MSG_protect_pbmac_no_sender");
  if (lVar3 != 0) {
    *(int *)(lVar3 + 0x58) = param_1;
    ...
    *(undefined8 *)(lVar3 + 0x10) = uVar4;
    ...
    if ((((iVar1 != 0) &&
         (iVar1 = OSSL_CMP_CTX_set_option(*(undefined8 *)(lVar3 + 8),0x1e,0), iVar1 != 0)) &&
        (iVar1 = ossl_cmp_hdr_set1_sender(**(undefined8 **)(lVar3 + 0x10),0), iVar1 != 0)) &&
       (iVar1 = OSSL_CMP_CTX_set1_secretValue(*(undefined8 *)(lVar3 + 8),&secret_10,4), iVar1 != 0))
    {
      puVar5 = &ref_9;
      if (param_1 == 0) {
        puVar5 = (undefined4 *)0x0;
      }
      iVar1 = OSSL_CMP_CTX_set1_referenceValue(*(undefined8 *)(lVar3 + 8),puVar5,4);
      if (iVar1 != 0) {
        uVar2 = ossl_cmp_msg_protect(*(undefined8 *)(lVar3 + 8),*(undefined8 *)(lVar3 + 0x10));
...
void test_MSG_protect_pbmac_no_sender_no_ref(void)

{
  test_MSG_protect_pbmac_no_sender(0);
  return;
}



void test_MSG_protect_pbmac_no_sender_with_ref(void)

{
  test_MSG_protect_pbmac_no_sender(1);
  return;
}
...

{
  ...
  local_25 = 0x74736e69;
  local_21 = 0x61;
  lVar3 = set_up("test_cmp_calc_protection_pbmac");
  if (lVar3 != 0) {
    iVar1 = OSSL_CMP_CTX_set1_secretValue(*(undefined8 *)(lVar3 + 8),&local_25,5);
    iVar1 = test_true("test/cmp_protect_test.c",0xb5,
                      "OSSL_CMP_CTX_set1_secretValue(fixture->cmp_ctx, sec_insta, sizeof(sec_insta))"
                      ,iVar1 != 0);
    if (iVar1 != 0) {
      uVar4 = load_pkimsg(ip_PBM_f,libctx);
      *(undefined8 *)(lVar3 + 0x10) = uVar4;
      iVar1 = test_ptr("test/cmp_protect_test.c",0xb7,"fixture->msg = load_pkimsg(ip_PBM_f, libctx)"
                       ,uVar4);
      if (iVar1 != 0) {
        a = (ASN1_BIT_STRING *)
            ossl_cmp_calc_protection(*(undefined8 *)(lVar3 + 8),*(undefined8 *)(lVar3 + 0x10));
        uVar2 = test_ptr("test/cmp_protect_test.c",0x5e,"protection",a);
        if (uVar2 != 0) {
          iVar1 = ASN1_STRING_cmp(a,*(ASN1_STRING **)(*(long *)(lVar3 + 0x10) + 0x10));
          iVar1 = test_true("test/cmp_protect_test.c",0x5f,
                            "ASN1_STRING_cmp(protection, fixture->msg->protection) == 0",iVar1 == 0)
          ;
          uVar2 = (uint)(iVar1 != 0);
        }
...

{
  ...
  lVar3 = set_up("test_MSG_add_extraCerts");
  if (lVar3 != 0) {
    uVar4 = OSSL_CMP_MSG_dup(ir_protected);
    *(undefined8 *)(lVar3 + 0x10) = uVar4;
    iVar1 = test_ptr("test/cmp_protect_test.c",0x148,"fixture->msg = OSSL_CMP_MSG_dup(ir_protected)"
                     ,uVar4);
    if (iVar1 != 0) {
      iVar1 = ossl_cmp_msg_add_extraCerts(*(undefined8 *)(lVar3 + 8),*(undefined8 *)(lVar3 + 0x10));
...

{
  ...
  lVar3 = set_up("test_cmp_calc_protection_pkey_Ed");
  if (lVar3 != 0) {
    *(undefined8 *)(lVar3 + 0x20) = prot_Ed_key;
    iVar1 = OSSL_CMP_CTX_set1_pkey(*(undefined8 *)(lVar3 + 8));
    iVar1 = test_true("test/cmp_protect_test.c",0xa6,
                      "OSSL_CMP_CTX_set1_pkey(fixture->cmp_ctx, prot_Ed_key)",iVar1 != 0);
    if (iVar1 != 0) {
      uVar4 = load_pkimsg(genm_prot_Ed_f,libctx);
      *(undefined8 *)(lVar3 + 0x10) = uVar4;
      iVar1 = test_ptr("test/cmp_protect_test.c",0xa7,
                       "fixture->msg = load_pkimsg(genm_prot_Ed_f, libctx)",uVar4);
      if (iVar1 != 0) {
        uVar2 = execute_calc_protection_signature_test(lVar3);
        tear_down_part_0(lVar3);
        return uVar2;
      }
    }
...

{
  ...
  lVar3 = set_up("test_cmp_calc_protection_pkey");
  if (lVar3 != 0) {
    *(undefined8 *)(lVar3 + 0x20) = prot_RSA_key;
    iVar1 = OSSL_CMP_CTX_set1_pkey(*(undefined8 *)(lVar3 + 8));
...

{
  ...
  lVar4 = set_up("test_cmp_calc_protection_no_key_no_secret");
  if (lVar4 != 0) {
    uVar5 = load_pkimsg(ir_unprotected_f,libctx);
    *(undefined8 *)(lVar4 + 0x10) = uVar5;
    iVar2 = test_ptr("test/cmp_protect_test.c",0x89,
                     "fixture->msg = load_pkimsg(ir_unprotected_f, libctx)",uVar5);
    if (iVar2 != 0) {
      lVar1 = **(long **)(lVar4 + 0x10);
      pXVar6 = X509_ALGOR_new();
      *(X509_ALGOR **)(lVar1 + 0x20) = pXVar6;
      iVar2 = test_ptr("test/cmp_protect_test.c",0x8a,
                       "fixture->msg->header->protectionAlg = X509_ALGOR_new()",pXVar6);
      if (iVar2 != 0) {
        a = (ASN1_BIT_STRING *)
            ossl_cmp_calc_protection(*(undefined8 *)(lVar4 + 8),*(undefined8 *)(lVar4 + 0x10));
        uVar3 = test_ptr_null("test/cmp_protect_test.c",0x54,"protection",a);
        ASN1_BIT_STRING_free(a);
        tear_down_part_0(lVar4);
        return uVar3;
      }
    }
    tear_down_part_0(lVar4);
...

{
  ...
  lVar3 = set_up("test_MSG_protect_unprotected_request");
  if (lVar3 != 0) {
    *(undefined4 *)(lVar3 + 0x58) = 1;
    uVar4 = OSSL_CMP_MSG_dup(ir_unprotected);
    *(undefined8 *)(lVar3 + 0x10) = uVar4;
    iVar1 = test_ptr("test/cmp_protect_test.c",0xcb,
                     "fixture->msg = OSSL_CMP_MSG_dup(ir_unprotected)",uVar4);
    if (iVar1 != 0) {
      iVar1 = OSSL_CMP_CTX_set_option(*(undefined8 *)(lVar3 + 8),0x1e,1);
...

{
  ...
  lVar3 = set_up("test_MSG_protect_no_key_no_secret");
  if (lVar3 != 0) {
    *(undefined4 *)(lVar3 + 0x58) = 0;
    uVar4 = OSSL_CMP_MSG_dup(ir_unprotected);
    *(undefined8 *)(lVar3 + 0x10) = uVar4;
    iVar1 = test_ptr("test/cmp_protect_test.c",0x116,
                     "fixture->msg = OSSL_CMP_MSG_dup(ir_unprotected)",uVar4);
    if (iVar1 != 0) {
      iVar1 = OSSL_CMP_CTX_set_option(*(undefined8 *)(lVar3 + 8),0x1e,0);
...

{
  ...
  lVar4 = set_up("test_MSG_protect_certificate_based_without_cert");
  if (lVar4 != 0) {
    *(undefined4 *)(lVar4 + 0x58) = 0;
    uVar1 = *(undefined8 *)(lVar4 + 8);
    uVar5 = OSSL_CMP_MSG_dup(ir_unprotected);
    *(undefined8 *)(lVar4 + 0x10) = uVar5;
    iVar2 = test_ptr("test/cmp_protect_test.c",0x106,
                     "fixture->msg = OSSL_CMP_MSG_dup(ir_unprotected)",uVar5);
    if (iVar2 != 0) {
      iVar2 = OSSL_CMP_CTX_set_option(uVar1,0x1e,0);
      iVar2 = test_true("test/cmp_protect_test.c",0x108,"SET_OPT_UNPROTECTED_SEND(ctx, 0)",
                        iVar2 != 0);
      if (iVar2 != 0) {
        iVar2 = EVP_PKEY_up_ref(server_key);
        iVar2 = test_true("test/cmp_protect_test.c",0x109,"EVP_PKEY_up_ref(server_key)",iVar2 != 0);
        if (iVar2 != 0) {
          iVar2 = OSSL_CMP_CTX_set0_newPkey(uVar1,1,server_key);
          iVar2 = test_true("test/cmp_protect_test.c",0x10a,
                            "OSSL_CMP_CTX_set0_newPkey(ctx, 1, server_key)",iVar2 != 0);
          if (iVar2 != 0) {
            uVar3 = ossl_cmp_msg_protect(*(undefined8 *)(lVar4 + 8),*(undefined8 *)(lVar4 + 0x10));
            uVar3 = test_int_eq("test/cmp_protect_test.c",0xc0,"fixture->expected",
                                "ossl_cmp_msg_protect(fixture->cmp_ctx, fixture->msg)",
...

{
  ...
  lVar3 = set_up("test_MSG_protect_with_certificate_and_key");
  if (lVar3 != 0) {
    *(undefined4 *)(lVar3 + 0x58) = 1;
    uVar4 = OSSL_CMP_MSG_dup(ir_unprotected);
    *(undefined8 *)(lVar3 + 0x10) = uVar4;
    ...
    if (iVar1 != 0) {
      ...
      iVar1 = test_true("test/cmp_protect_test.c",0xf4,
                        "SET_OPT_UNPROTECTED_SEND(fixture->cmp_ctx, 0)",iVar1 != 0);
      if (iVar1 != 0) {
        iVar1 = OSSL_CMP_CTX_set1_pkey(*(undefined8 *)(lVar3 + 8),server_key);
        iVar1 = test_true("test/cmp_protect_test.c",0xf5,
                          "OSSL_CMP_CTX_set1_pkey(fixture->cmp_ctx, server_key)",iVar1 != 0);
        if (iVar1 != 0) {
          iVar1 = OSSL_CMP_CTX_set1_cert(*(undefined8 *)(lVar3 + 8),server_cert);
...

{
  ...
  lVar3 = set_up("test_MSG_protect_with_msg_sig_alg_protection_plus_rsa_key");
  if (lVar3 != 0) {
    *(undefined4 *)(lVar3 + 0x58) = 1;
    uVar4 = OSSL_CMP_MSG_dup(ir_unprotected);
    *(undefined8 *)(lVar3 + 0x10) = uVar4;
    ...
    if (iVar1 != 0) {
      ...
      iVar1 = test_true("test/cmp_protect_test.c",0xdc,
                        "SET_OPT_UNPROTECTED_SEND(fixture->cmp_ctx, 0)",iVar1 != 0);
      if (iVar1 != 0) {
        iVar1 = OSSL_CMP_CTX_set1_referenceValue(*(undefined8 *)(lVar3 + 8),rand_data,8);
        iVar1 = test_true("test/cmp_protect_test.c",0xe1,
                          "OSSL_CMP_CTX_set1_referenceValue(fixture->cmp_ctx, rand_data, size)",
                          iVar1 != 0);
        if (iVar1 != 0) {
          iVar1 = OSSL_CMP_CTX_set1_secretValue(*(undefined8 *)(lVar3 + 8),0x1021b8,8);

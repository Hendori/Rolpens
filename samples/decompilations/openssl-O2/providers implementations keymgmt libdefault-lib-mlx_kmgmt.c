...
undefined8 * mlx_kem_key_new(uint param_1,undefined8 param_2,void *param_3)

{
  ...
  if (((param_1 < 4) && (iVar1 != 0)) &&
     (puVar2 = (undefined8 *)
               CRYPTO_malloc(0x38,"providers/implementations/keymgmt/mlx_kmgmt.c",0x53),
     puVar2 != (undefined8 *)0x0)) {
    *puVar2 = param_2;
    uVar3 = ossl_ml_kem_get_vinfo(*(undefined4 *)(hybrid_vtable + (ulong)param_1 * 0x30 + 0x2c));
    puVar2[3] = hybrid_vtable + (ulong)param_1 * 0x30;
    puVar2[2] = uVar3;
...
void mlx_p256_kem_new(long param_1)

{
  if (param_1 != 0) {
    param_1 = ossl_prov_ctx_get0_libctx();
  }
  mlx_kem_key_new(0,param_1,0);
  return;
}



void mlx_p384_kem_new(long param_1)

{
  if (param_1 != 0) {
    param_1 = ossl_prov_ctx_get0_libctx();
  }
  mlx_kem_key_new(1,param_1,0);
  return;
}



void mlx_x25519_kem_new(long param_1)

{
  if (param_1 != 0) {
    param_1 = ossl_prov_ctx_get0_libctx();
  }
  mlx_kem_key_new(2,param_1,0);
  return;
}



void mlx_x448_kem_new(long param_1)

{
  if (param_1 != 0) {
    param_1 = ossl_prov_ctx_get0_libctx();
  }
  mlx_kem_key_new(3,param_1,0);
  return;
}
...
undefined8 * mlx_kem_gen_init(undefined4 param_1,undefined8 param_2,uint param_3,undefined8 param_4)

{
  ...
  iVar1 = ossl_prov_is_running();
  if (((iVar1 != 0) && ((param_3 & 5) != 0)) &&
     (ptr = (undefined8 *)CRYPTO_zalloc(0x18,"providers/implementations/keymgmt/mlx_kmgmt.c",0x296),
     ptr != (undefined8 *)0x0)) {
    *(undefined4 *)((long)ptr + 0x14) = param_1;
    *ptr = param_2;
    *(uint *)(ptr + 2) = param_3;
    iVar1 = mlx_kem_gen_set_params(ptr,param_4);
    if (iVar1 != 0) {
      return ptr;
    }
...
void mlx_p256_kem_gen_init(long param_1,undefined4 param_2,undefined8 param_3)

{
  if (param_1 != 0) {
    param_1 = ossl_prov_ctx_get0_libctx();
  }
  mlx_kem_gen_init(0,param_1,param_2,param_3);
  return;
}



void mlx_p384_kem_gen_init(long param_1,undefined4 param_2,undefined8 param_3)

{
  if (param_1 != 0) {
    param_1 = ossl_prov_ctx_get0_libctx();
  }
  mlx_kem_gen_init(1,param_1,param_2,param_3);
  return;
}



void mlx_x25519_kem_gen_init(long param_1,undefined4 param_2,undefined8 param_3)

{
  if (param_1 != 0) {
    param_1 = ossl_prov_ctx_get0_libctx();
  }
  mlx_kem_gen_init(2,param_1,param_2,param_3);
  return;
}



void mlx_x448_kem_gen_init(long param_1,undefined4 param_2,undefined8 param_3)

{
  if (param_1 != 0) {
    param_1 = ossl_prov_ctx_get0_libctx();
  }
  mlx_kem_gen_init(3,param_1,param_2,param_3);
  return;
}
...
LAB_00100897:
          if ((local_78._0_8_ != 0) && (local_78._12_4_ == 2)) {
            ...
            if (iVar1 == 0) goto LAB_001009c5;
          }
          lVar6 = OSSL_PARAM_BLD_to_param(lVar4);
          if (lVar6 == 0) goto LAB_001009c5;
    ...
    if (lVar5 != 0) {
      if (*(int *)(lVar5 + 8) == 5) {
        ...
        *(ulong *)(lVar5 + 0x20) = uVar8;
        if (*(long *)(lVar5 + 0x10) == 0) goto LAB_00100c08;
        ...
        if ((1 < *(uint *)(param_1 + 0x30)) &&
           (lVar6 = OSSL_PARAM_locate(param_2,&_LC3), lVar6 != 0)) goto LAB_00100c36;
        bVar7 = 0;
        lVar6 = 0;
        goto LAB_00100b3e;
      }
...

{
  ...
  if ((param_1 != (undefined8 *)0x0) && ((*(uint *)(param_1 + 2) & 3) != 2)) {
    uVar1 = param_1[1];
    param_1[1] = 0;
    ptr = (undefined8 *)mlx_kem_key_new(*(undefined4 *)((long)param_1 + 0x14),*param_1,uVar1);
    if (ptr != (undefined8 *)0x0) {
      if ((*(byte *)(param_1 + 2) & 3) == 0) {
        return ptr;
      }
      uVar1 = EVP_PKEY_Q_keygen(*ptr,ptr[1],*(undefined8 *)ptr[2]);
      ptr[4] = uVar1;
      lVar2 = EVP_PKEY_Q_keygen(*ptr,ptr[1],*(undefined8 *)ptr[3],((undefined8 *)ptr[3])[1]);
      ptr[5] = lVar2;
      if ((ptr[4] != 0) && (lVar2 != 0)) {
        *(undefined4 *)(ptr + 6) = 2;
        return ptr;
...
undefined8
load_keys(undefined8 *param_1,undefined8 param_2,long param_3,undefined8 param_4,long param_5)
...
LAB_00100fc6:
    ...
    while (iVar1 = load_slot_constprop_0
                             (*param_1,param_1[1],&_LC0,param_1,iVar4,param_2,
                              *(undefined8 *)(param_1[2] + 0x18),*(undefined8 *)(param_1[3] + 0x10))
          , iVar1 != 0) {
      if (iVar4 == 1) goto LAB_00100fc1;
      iVar4 = 1;
    }
  }
  else {
    iVar4 = 0;
    while (iVar1 = load_slot_constprop_0
                             (*param_1,param_1[1],&_LC3,param_1,iVar4,param_4,
                              *(undefined8 *)(param_1[2] + 8),*(undefined8 *)(param_1[3] + 0x18)),
          iVar1 != 0) {
      if (iVar4 == 1) {
        uVar3 = 2;
        if (param_5 == 0) goto LAB_00100fc1;
        goto LAB_00100fc6;
      }
      iVar4 = 1;
    }
...
ulong mlx_kem_import(long param_1,uint param_2,undefined8 param_3)

{
  ...
  if ((param_1 == 0) || (iVar5 == 0)) goto LAB_00101144;
  uVar7 = (ulong)(param_2 & 3);
  if ((param_2 & 3) == 0) goto LAB_001010ef;
  local_60 = 0;
  local_58 = 0;
  local_50 = 0;
  local_48 = 0;
  if (*(int *)(param_1 + 0x30) == 0) {
    ...
    lVar6 = OSSL_PARAM_locate_const(param_3,&_LC0);
    if ((lVar6 == 0) ||
       (iVar5 = OSSL_PARAM_get_octet_string_ptr(lVar6,&local_60,&local_50), iVar5 == 1)) {
      if ((((param_2 & 1) != 0) && (lVar6 = OSSL_PARAM_locate_const(param_3,&_LC3), lVar6 != 0)) &&
         (iVar5 = OSSL_PARAM_get_octet_string_ptr(lVar6,&local_58,&local_48), iVar5 != 1)) {
        uVar7 = 0;
        goto LAB_001010ef;
      }
      if (local_50 == 0) {
        if (local_48 == 0) {
          ERR_new();
          ERR_set_debug("providers/implementations/keymgmt/mlx_kmgmt.c",0x1b7,"mlx_kem_key_fromdata"
                       );
          ERR_set_error(0x39,0x80,0);
          uVar7 = 0;
          goto LAB_001010ef;
...
LAB_001011b5:
        if ((lVar3 + lVar4 == local_48) || (local_48 == 0)) {
          uVar7 = load_keys(param_1,local_60,local_50,local_58);
          goto LAB_001010ef;
        }
        ERR_new();
        uVar8 = 0x1c5;
        ...
        if (lVar2 + lVar1 == local_50) goto LAB_001011b5;
        ERR_new();
        uVar8 = 0x1c1;
      }
      ERR_set_debug("providers/implementations/keymgmt/mlx_kmgmt.c",uVar8,"mlx_kem_key_fromdata");
...
undefined8 mlx_kem_set_params(long param_1,long *param_2)
...
LAB_00101342:
        ...
        lVar2 = *(long *)(*(long *)(param_1 + 0x18) + 0x10) +
                *(long *)(*(long *)(param_1 + 0x10) + 0x18);
        if (lVar2 == local_28) {
          uVar3 = load_keys(param_1,local_30,lVar2,0,0);
        }
        else {
          ERR_new();

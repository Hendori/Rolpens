...
void lh_SSL_SESSION_doall_arg_thunk
...
undefined8 can_renegotiate(long param_1)
...

{
  ...
  if (param_1 != (uint *)0x0) {
    ...
    if ((*param_1 & 0x80) != 0) {
      ...
      if (lVar1 != 0) {
                    /* WARNING: Could not recover jumptable at 0x0010035d. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  puVar1 = (uint *)*param_1;
  if ((puVar1 != (uint *)0x0) &&
     ((puVar2 = puVar1, *puVar1 == 0 ||
      (((*puVar1 & 0x80) != 0 &&
       (puVar2 = (uint *)ossl_quic_obj_get0_handshake_layer(puVar1), puVar2 != (uint *)0x0)))))) {
                    /* WARNING: Could not recover jumptable at 0x001003cb. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
undefined8 set_cert_type(long *param_1,ulong *param_2,long param_3,ulong param_4)
...
LAB_0010043e:
  ...
  if ((param_3 != 0) && (param_4 != 0)) {
    ...
    lVar4 = CRYPTO_memdup(param_3,param_4,"ssl/ssl_lib.c",0x202e);
    if (lVar4 != 0) goto LAB_0010043e;
  }
  return 0;
}
...

{
  ...
  if ((param_1 == (uint *)0x0) ||
     ((puVar2 = param_1, *param_1 != 0 &&
      (((*param_1 & 0x80) == 0 ||
       (puVar2 = (uint *)ossl_quic_obj_get0_handshake_layer(), puVar2 == (uint *)0x0)))))) {
    local_34 = 0;
    goto LAB_0010055a;
  }
...
undefined8
ssl_peek_internal(uint *param_1,undefined8 param_2,undefined8 param_3,undefined8 *param_4)
...
LAB_00100705:
          if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010072b. Too many branches */
                    /* WARNING: Treating indirect jump as call */
            uVar2 = (**(code **)(*(long *)(param_1 + 6) + 0x58))();
            return uVar2;
          }
          goto LAB_001007d5;
        }
        if (puVar3 != (uint *)0x0) goto LAB_001006bc;
      }
      goto LAB_00100734;
    }
LAB_001006bc:
    if (*(long *)(puVar3 + 0x1c) == 0) {
      ERR_new();
      ...
      if ((puVar3[0x21] & 2) != 0) goto LAB_00100734;
      if (((*(byte *)((long)puVar3 + 0x9b9) & 1) == 0) ||
         (lVar1 = ASYNC_get_current_job(), lVar1 != 0)) goto LAB_00100705;
      local_28 = *(undefined8 *)(*(long *)(param_1 + 6) + 0x58);
      local_30 = 0;
      local_48 = param_1;
      local_40 = param_2;
      local_38 = param_3;
      uVar2 = ssl_start_async_job(param_1,&local_48,ssl_io_intern);
...
undefined8
nss_keylog_int(char *param_1,long param_2,long param_3,long param_4,long param_5,long param_6)

{
  ...
  if (*(long *)(lVar3 + 0x3f8) != 0) {
    __n = strlen(param_1);
    lVar2 = __n + 3 + (param_4 + param_6) * 2;
    ...
    *puVar1 = 0x20;
    ...
    do {
      lVar5 = lVar6;
      *(ushort *)(puVar1 + lVar5 * 2 + 1) =
           CONCAT11("0123456789abcdef"[*(byte *)(param_3 + lVar5) & 0xf],
                    "0123456789abcdef"[*(byte *)(param_3 + lVar5) >> 4]);
      lVar6 = lVar5 + 1;
    } while (param_4 != lVar5 + 1);
    puVar1[param_4 * 2 + 1] = 0x20;
    puVar7 = puVar1 + lVar5 * 2 + 4;
    if (param_6 != 0) {
      lVar6 = 0;
      do {
        *(ushort *)(puVar1 + lVar6 * 2 + lVar5 * 2 + 4) =
             CONCAT11("0123456789abcdef"[*(byte *)(param_5 + lVar6) & 0xf],
                      "0123456789abcdef"[*(byte *)(param_5 + lVar6) >> 4]);
        lVar6 = lVar6 + 1;
      } while (param_6 != lVar6);
      puVar7 = puVar7 + param_6 * 2;
    }
    *puVar7 = 0;
    pcVar4 = *(code **)(lVar3 + 0x3f8);
    if (pcVar4 != (code *)0x0) {
      (*pcVar4)(*(undefined8 *)(param_2 + 0x40),__dest);
    }
...

{
  ...
  if (s->wbio != (BIO *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00100ced. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (((psVar1 != psVar3) &&
      (psVar1 = ctx->cipher_list, psVar3 = (stack_st_SSL_CIPHER *)OSSL_QUIC_client_thread_method(),
      psVar1 != psVar3)) &&
     (psVar1 = ctx->cipher_list, psVar3 = (stack_st_SSL_CIPHER *)OSSL_QUIC_server_method(),
     psVar1 != psVar3)) {
    ...
    if (iVar2 == 0) {
      ...
      lVar6 = ssl_create_cipher_list
                        (ctx,ctx->sessions,&ctx->cipher_list_by_id,&ctx->cert_store,uVar5,uVar4);
...

{
  ...
  if (ctx == (SSL_CTX *)0x0) {
    ...
    if (ctx->cipher_list != (stack_st_SSL_CIPHER *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x001010ee. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if ((*param_1 != 0) &&
     ((((*param_1 & 0x80) == 0 ||
       (puVar1 = (uint *)ossl_quic_obj_get0_handshake_layer(), *param_1 - 0x80 < 2)) ||
      (puVar1 == (uint *)0x0)))) {
    return 0;
  }
...

{
  ...
  if (sid_ctx_len < 0x21) {
    ...
    if (sid_ctx_len < 8) {
      if ((sid_ctx_len & 4) == 0) {
        if ((sid_ctx_len != 0) &&
           (*(uchar *)&ctx->quiet_shutdown = *sid_ctx, (sid_ctx_len & 2) != 0)) {
          *(undefined2 *)((undefined1 *)((long)&ctx->param + 6) + (long)pXVar4) =
               *(undefined2 *)(sid_ctx + -2 + (long)pXVar4);
        }
      }
      else {
        ctx->quiet_shutdown = *(int *)sid_ctx;
        *(undefined4 *)((undefined1 *)((long)&ctx->param + 4) + (long)pXVar4) =
             *(undefined4 *)(sid_ctx + -4 + (long)pXVar4);
      }
    }
    else {
      ...
      *(undefined8 *)((long)&ctx->param + (long)pXVar4) =
           *(undefined8 *)(sid_ctx + -8 + (long)pXVar4);
...

{
  ...
  if ((ssl->version == 0) ||
     (((ssl->version & 0x80U) != 0 &&
      (ssl = (SSL *)ossl_quic_obj_get0_handshake_layer(), ssl != (SSL *)0x0)))) {
    if (sid_ctx_len < 0x21) {
      ...
      if (sid_ctx_len < 8) {
        if ((sid_ctx_len & 4) == 0) {
          if ((sid_ctx_len != 0) && (*(uchar *)ppEVar1 = *sid_ctx, (sid_ctx_len & 2) != 0)) {
            *(undefined2 *)(ssl[3].sid_ctx + (uVar3 - 0x3e)) =
                 *(undefined2 *)(sid_ctx + (uVar3 - 2));
          }
        }
        else {
...

{
  ...
  if (((param_1->version == 0) ||
     ...
     (uVar1._0_4_ = param_1->rwstate, uVar1._4_4_ = param_1->in_handshake,
     iVar3 = CRYPTO_THREAD_write_lock(uVar1), iVar3 != 0)) {
...

{
  ...
  if (ssl != (SSL *)0x0) {
    if (ssl->version != 0) {
      if ((ssl->version & 0x80U) == 0) goto LAB_00101644;
      ...
      if (id_len < 8) {
        if ((id_len & 4) == 0) {
          if (id_len != 0) {
            ...
            if ((id_len & 2) != 0) {
              *(undefined2 *)((long)local_170 + (local_178 - 2)) =
                   *(undefined2 *)(id + (local_178 - 2));
            }
          }
        }
        else {
...

{
  ...
  iVar1 = X509_VERIFY_PARAM_set_purpose
                    ((X509_VERIFY_PARAM *)s[1].tls_session_ticket_ext_cb_arg,purpose);
  return iVar1;
}
...

{
  ...
  if ((ptr_00 == (void *)0x0) || (ptr == (void *)0x0)) {
    ...
    do {
      if (*(int *)(pbVar4 + 4) != 0) {
        name = OBJ_nid2sn(*(int *)(pbVar4 + 4));
        pEVar2 = EVP_get_digestbyname(name);
        if (pEVar2 != (EVP_MD *)0x0) {
          bVar1 = *pbVar4;
          *(EVP_MD **)((long)ptr + (ulong)bVar1 * 8) = pEVar2;
          *(byte *)((long)ptr_00 + (ulong)bVar1) = pbVar4[1];
        }
      }
      pbVar4 = pbVar4 + 8;
    } while (pbVar4 != (byte *)"unsupported domain flag requested");
...

{
  ...
  if (*param_1 != 0) {
    if ((*param_1 & 0x80) != 0) {
      param_1 = (uint *)ossl_quic_obj_get0_handshake_layer();
      if (param_1 != (uint *)0x0) goto LAB_00101b6e;
    }
    return 0;
  }
LAB_00101b6e:
  uVar1 = *(ulong *)(param_1 + 0x154);
...

{
  ...
  if (*param_1 != 0) {
    if ((*param_1 & 0x80) != 0) {
      param_1 = (uint *)ossl_quic_obj_get0_handshake_layer();
      if (param_1 != (uint *)0x0) goto LAB_00101bce;
    }
    return 0;
  }
LAB_00101bce:
...

{
  ...
  if ((((*param_1 == 0) ||
       (((*param_1 & 0x80) != 0 &&
        (param_1 = (uint *)ossl_quic_obj_get0_handshake_layer(), param_1 != (uint *)0x0)))) &&
      (iVar2 = OPENSSL_sk_num(*(undefined8 *)(param_1 + 0x148)), 0 < iVar2)) &&
     (*(long *)(param_1 + 0x266) == 0)) {
...
uint SSL_get0_dane_tlsa(uint *param_1,undefined1 *param_2,undefined1 *param_3,undefined1 *param_4,
...

{
  ...
  if ((((*param_1 == 0) ||
       (((*param_1 & 0x80) != 0 &&
        (param_1 = (uint *)ossl_quic_obj_get0_handshake_layer(), param_1 != (uint *)0x0)))) &&
      (iVar1 = OPENSSL_sk_num(*(undefined8 *)(param_1 + 0x148)), 0 < iVar1)) &&
     (*(long *)(param_1 + 0x266) == 0)) {
...
undefined8
SSL_dane_tlsa_add(uint *param_1,uint param_2,byte param_3,byte param_4,uchar *param_5,size_t param_6
                 )
                        ...
                        if (lVar7 != 0) {
                          ...
                          if (lVar7 == 0) {
                            ...
                            *(long *)(param_1 + 0x14a) = lVar7;
                            if (lVar7 != 0) goto LAB_001024a7;
                          }
                          else {
LAB_001024a7:
                            iVar3 = OPENSSL_sk_push(lVar7,local_50);
                            if (iVar3 != 0) goto LAB_001021c0;
                          }
                          ERR_new();
                    ...
                    do {
                      ...
                      if ((*pbVar6 <= bVar1) &&
                         ((*pbVar6 < bVar1 ||
                          ((pbVar6[1] <= param_3 &&
                           ((pbVar6[1] < param_3 ||
                            (*(byte *)(*(long *)(*(long *)(param_1 + 0x146) + 8) + (ulong)pbVar6[2])
                             <= *(byte *)(*(long *)(*(long *)(param_1 + 0x146) + 8) + (ulong)param_4
                                         ))))))))) break;
                      iVar2 = iVar2 + 1;
                    } while (iVar3 != iVar2);
                  }
...
LAB_001022e0:
          ...
          else if ((*(byte *)(*(long **)(param_1 + 0x146) + 2) < param_4) ||
                  (*(long *)(**(long **)(param_1 + 0x146) + (ulong)param_4 * 8) == 0)) {
            ERR_new();
            ...
            if ((0 < iVar2) && (param_6 == (long)iVar2)) goto LAB_00101fb0;
            ERR_new();
      ...
      if (pvVar4 != (void *)0x0) {
        ...
        *(void **)(param_1 + 0x3c8) = pvVar4;
        ...
        if (uVar7 < uVar2) {
          ...
          if (((void *)((long)pvVar4 + lVar5) < (void *)((long)pvVar3 + lVar6 * 8)) &&
             ((void *)((long)pvVar3 + lVar5 * 8) < (void *)(lVar6 + (long)pvVar4))) {
...

{
  ...
  if (*param_1 != 0) {
    if ((*param_1 & 0x80) != 0) {
      ...
      if (puVar1 != (uint *)0x0) goto LAB_00102932;
    }
    return;
  }
LAB_00102932:
  BIO_free_all(*(BIO **)(puVar1 + 0x14));
  *(undefined8 *)(puVar1 + 0x14) = param_2;
                    /* WARNING: Could not recover jumptable at 0x0010295a. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (*param_1 != 0) {
    if ((*param_1 & 0x80) != 0) {
      ...
      if (puVar1 != (uint *)0x0) goto LAB_001029c8;
    }
    return;
  }
LAB_001029c8:
  ...
  *(BIO **)(puVar1 + 0x16) = param_2;
  if (*(BIO **)(puVar1 + 0x18) != (BIO *)0x0) {
    ...
    *(BIO **)(puVar1 + 0x16) = param_2;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00102a1b. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (s->version != 0) {
    if ((s->version & 0x80U) != 0) {
      ...
      if (pSVar1 != (SSL *)0x0) goto LAB_00102ae2;
    }
    return (BIO *)0x0;
  }
LAB_00102ae2:
  if (*(BIO **)&pSVar1->init_num != (BIO *)0x0) {
...

{
  ...
  if ((rbio == pBVar2) && (pBVar2 = SSL_get_wbio(s), wbio == pBVar2)) {
    return;
  }
  if (((rbio != (BIO *)0x0) && (rbio == wbio)) && (iVar1 = BIO_up_ref(rbio), iVar1 == 0)) {
    return;
  }
  pBVar2 = SSL_get_rbio(s);
  if (rbio != pBVar2) {
...
LAB_00102e77:
    ...
    uVar2 = s->version;
    iVar3 = 0x515;
    if ((uVar2 & 0x80) == 0) goto LAB_00102e77;
  }
  if (uVar2 == 0x81) {
    ERR_new();
...
LAB_00102ff7:
    ...
    uVar2 = s->version;
    iVar3 = 0x515;
    if ((uVar2 & 0x80) == 0) goto LAB_00102ff7;
  }
  if (uVar2 == 0x81) {
    ERR_new();
...

{
  ...
  if (s != (SSL *)0x0) {
    if (s->version == 0) {
LAB_0010310d:
      pvVar1 = s->tls_session_ticket_ext_cb_arg;
      if (pvVar1 <= count) {
        count = (size_t)pvVar1;
      }
    ...
    if ((s->version & 0x80U) != 0) {
      ...
      if (s != (SSL *)0x0) goto LAB_0010310d;
    }
  }
  return 0;
}
...
LAB_0010317d:
    ...
    if ((s->version & 0x80U) != 0) {
      s = (SSL *)ossl_quic_obj_get0_handshake_layer();
      if (s != (SSL *)0x0) goto LAB_0010317d;
    }
  }
  return 0;
}
...
LAB_00103570:
        iVar2 = RECORD_LAYER_processed_read_pending(param_1 + 0x316);
        if (iVar2 == 0) {
          if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
        ...
        do {
          ...
          if (ppVar3 == (pitem *)0x0) goto LAB_00103570;
...

{
  ...
  if ((ctx == (SSL *)0x0) ||
     ((ctx->version != 0 &&
      (((ctx->version & 0x80U) == 0 ||
       (ctx = (SSL *)ossl_quic_obj_get0_handshake_layer(), ctx == (SSL *)0x0)))))) {
    ERR_new();
      ...
      if ((*param_1 & 0x80) != 0) {
        ...
        if ((lVar1 != 0) && (*(long *)(lVar1 + 0x1530) != 0)) {
          uVar2 = ASYNC_WAIT_CTX_get_changed_fds
                            (*(long *)(lVar1 + 0x1530),param_2,param_3,param_4,param_5);
          return uVar2;
        }
      }
      return 0;
...

{
  ...
  if (*param_1 != 0) {
    if ((*param_1 & 0x80) != 0) {
      param_1 = (uint *)ossl_quic_obj_get0_handshake_layer();
      if (param_1 != (uint *)0x0) goto LAB_00103b74;
    }
    return 0;
  }
LAB_00103b74:
  *(undefined8 *)(param_1 + 0x55e) = param_2;
  return 1;
}
...

{
  ...
  if (*param_1 != 0) {
    if ((*param_1 & 0x80) != 0) {
      param_1 = (uint *)ossl_quic_obj_get0_handshake_layer();
      if (param_1 != (uint *)0x0) goto LAB_00103bc4;
    }
    return 0;
  }
LAB_00103bc4:
  *(undefined8 *)(param_1 + 0x560) = param_2;
  return 1;
}
...
undefined8
ssl_read_internal(uint *param_1,undefined8 param_2,undefined8 param_3,undefined8 *param_4)
...
LAB_00103cf9:
          if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00103d2d. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        ...
        if (puVar4 != (uint *)0x0) goto LAB_00103cb2;
      }
      goto LAB_00103d38;
    }
LAB_00103cb2:
    if (*(long *)(puVar4 + 0x1c) == 0) {
      ERR_new();
    ...
    if ((puVar4[0x21] & 2) == 0) {
      if ((puVar4[0x3c] == 1) || (puVar4[0x3c] == 8)) {
        ...
        if (iVar1 == 0) goto LAB_00103d38;
        if (((*(byte *)((long)puVar4 + 0x9b9) & 1) == 0) ||
           (lVar3 = ASYNC_get_current_job(), lVar3 != 0)) goto LAB_00103cf9;
...

{
  ...
  if (num < 0) {
    ...
    iVar1 = ssl_peek_internal(ssl,buf,(long)num,local_18);
    if (0 < iVar1) {
      iVar1 = local_18[0];
    }
  }
...
int SSL_peek_ex(void)

{
  int iVar1;
  
  iVar1 = ssl_peek_internal();
  if (iVar1 < 0) {
    iVar1 = 0;
  }
  return iVar1;
...
undefined8
ssl_write_internal(uint *param_1,undefined8 param_2,undefined8 param_3,long param_4,
                  undefined8 *param_5)
...
LAB_00104091:
    ...
    if (*param_1 != 0) {
      if ((*param_1 & 0x80) != 0) {
        ...
        if (puVar2 != (uint *)0x0) goto LAB_00104022;
      }
      goto LAB_00104091;
    }
LAB_00104022:
...
LAB_001041f6:
      ...
      if (iVar1 == 0) goto LAB_001041f6;
      if (((*(byte *)((long)puVar2 + 0x9b9) & 1) == 0) ||
         (lVar3 = ASYNC_get_current_job(), lVar3 != 0)) {
        if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010413c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
LAB_0010448c:
    ...
    if (s->version != 0) {
      if ((s->version & 0x80U) != 0) {
        ...
        if (pSVar3 != (SSL *)0x0) goto LAB_0010442b;
      }
      goto LAB_0010448c;
    }
LAB_0010442b:
    ...
    if (((pSVar3[3].references & 0x100) == 0) || (lVar2 = ASYNC_get_current_job(), lVar2 != 0)) {
      if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00104482. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if ((((*(byte *)(*(long *)(*(int **)(param_1 + 6) + 0x36) + 0x50) & 8) == 0) &&
      (iVar1 = **(int **)(param_1 + 6), iVar1 != 0x10000)) && (0x303 < iVar1)) {
    if (param_2 < 2) {
...

{
  ...
  if (s->version == 0) {
    iVar2 = can_renegotiate();
    if (iVar2 != 0) {
      pBVar1 = s->wbio;
      *(undefined4 *)((long)&s->s2 + 4) = 1;
      *(undefined4 *)&s[4].expand = 1;
                    /* WARNING: Could not recover jumptable at 0x00104836. Too many branches */
                    /* WARNING: Treating indirect jump as call */
      iVar2 = (*(code *)pBVar1[1].method)(s);
      return iVar2;
    }
  }
  return 0;
...

{
  ...
  if (s->version == 0) {
    ...
    if (iVar2 != 0) {
      ...
      *(undefined4 *)&s[4].expand = 1;
                    /* WARNING: Could not recover jumptable at 0x00104896. Too many branches */
                    /* WARNING: Treating indirect jump as call */
      iVar2 = (*(code *)pBVar1[1].method)(s);
      return iVar2;
    }
...

{
  ...
  if (param_1 != (uint *)0x0) {
    ...
    if ((((*param_1 == 0) ||
         (((*param_1 & 0x80) != 0 &&
          (puVar2 = (uint *)ossl_quic_obj_get0_handshake_layer(), puVar2 != (uint *)0x0)))) &&
        ((iVar1 = SSL_in_init(param_1), iVar1 == 0 || (puVar2[0x299] != 0)))) &&
       (((((*(long *)(puVar2 + 0x98) != 0 && (*(long *)(puVar2 + 0xba) != 0)) && (puVar2[0x1e] != 0)
          ) && (((*(byte *)(*(long *)(*(int **)(puVar2 + 6) + 0x36) + 0x50) & 8) == 0 &&
                (iVar1 = **(int **)(puVar2 + 6), 0x303 < iVar1)))) && (iVar1 != 0x10000)))) {
  ...
  if (param_1->version != 0) {
    if ((param_1->version & 0x80U) != 0) {
      ...
      if ((param_5 != 0) || ((param_1->version & 0x80) == 0)) {
        if (ssl == (SSL *)0x0) goto LAB_00104a14;
        switch(param_2) {
        case 0x21:
          goto switchD_00104a08_caseD_21;
        default:
          ...
          break;
        case 0x28:
          goto switchD_00104a08_caseD_28;
        case 0x29:
          goto switchD_00104a08_caseD_29;
        case 0x32:
          goto switchD_00104a08_caseD_32;
        case 0x33:
          goto switchD_00104a08_caseD_33;
        case 0x34:
          goto switchD_00104a08_caseD_34;
        case 0x4c:
          goto switchD_00104a08_caseD_4c;
        case 0x4e:
          goto switchD_00104a08_caseD_4e;
        case 99:
          goto switchD_00104a08_caseD_63;
        case 100:
          goto switchD_00104a08_caseD_64;
        case 0x6e:
          goto switchD_00104a08_caseD_6e;
        case 0x7a:
          goto switchD_00104e5e_caseD_7a;
        case 0x7b:
          goto switchD_00104e5e_caseD_7b;
        case 0x7c:
          goto switchD_00104e5e_caseD_7c;
        case 0x7d:
          goto switchD_00104a08_caseD_7d;
        case 0x7e:
          goto switchD_00104a08_caseD_7e;
        case 0x82:
          goto switchD_00104a08_caseD_82;
        case 0x83:
          goto switchD_00104a08_caseD_83;
        case 0x88:
          goto switchD_00104a08_caseD_88;
        }
      }
switchD_00104a08_caseD_22:
      if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00104aae. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
switchD_00104a08_caseD_21:
    ...
    break;
  default:
    goto switchD_00104a08_caseD_22;
  case 0x28:
switchD_00104a08_caseD_28:
    uVar5 = (ulong)*(int *)&ssl[4].tlsext_debug_arg;
    break;
  case 0x29:
switchD_00104a08_caseD_29:
    uVar5 = (ulong)*(int *)&ssl[4].tlsext_debug_arg;
    *(uint *)&ssl[4].tlsext_debug_arg = uVar3;
    break;
  case 0x32:
switchD_00104a08_caseD_32:
    uVar5 = ssl[3].mode;
    break;
  case 0x33:
switchD_00104a08_caseD_33:
    if ((long)param_3 < 0) goto LAB_00104a14;
    uVar5 = ssl[3].mode;
    ssl[3].mode = (ulong)param_3;
    break;
  case 0x34:
switchD_00104a08_caseD_34:
    if ((code *)0x3e00 < param_3 + -0x200) goto LAB_00104a14;
...
switchD_00104e5e_caseD_7c:
    ...
    break;
  case 0x7d:
switchD_00104a08_caseD_7d:
    if ((*(_func_3155 **)&ssl[3].max_send_fragment < param_3) || (param_3 == (_func_3155 *)0x0))
    goto LAB_00104a14;
    *(_func_3155 **)&ssl[3].first_packet = param_3;
    goto LAB_00104abf;
  case 0x7e:
switchD_00104a08_caseD_7e:
    if ((code *)0x1f < param_3 + -1) goto LAB_00104a14;
    uVar5 = ssl[4].options;
    ...
    goto LAB_00104abf;
  case 0x82:
switchD_00104a08_caseD_82:
    uVar5 = (ulong)*(int *)&ssl[3].field_0x1ac;
    break;
  case 0x83:
switchD_00104a08_caseD_83:
    uVar5 = (ulong)(int)ssl[3].options;
    break;
  case 0x88:
switchD_00104a08_caseD_88:
...

{
  ...
  if (pSVar4[1].tls_session_secret_cb_arg == (void *)0x0) {
    if ((pSVar4[3].tlsext_ocsp_resp == (uchar *)0x0) &&
       (lVar5 = SSL_ctrl(param_1,0x37,0,param_2), lVar5 == 0)) {
      ERR_new();
      uVar6 = 0x4e4;
    }
    else {
...

{
  ...
  long in_R9;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00105098. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  case 0x10:
    ...
    goto LAB_001051d0;
  default:
                    /* WARNING: Could not recover jumptable at 0x00105148. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  ...
  case 0x34:
    ...
    if ((ulong)larg < ctx->tlsext_status_cb) goto LAB_00105244;
    goto LAB_001051d0;
  case 0x4e:
    uVar2 = ~uVar2 & *(uint *)&ctx->msg_callback;
    psVar4 = (ssl_session_st *)(ulong)uVar2;
...

{
  ...
  if (param_2 != 0xf) {
                    /* WARNING: Could not recover jumptable at 0x001053bd. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if ((s->version == 0) ||
     (((s->version & 0x80U) != 0 &&
      (pSVar1 = (SSL *)ossl_quic_obj_get0_handshake_layer(), pSVar1 != (SSL *)0x0)))) {
...

{
  ...
  if (((param_1 == (SSL *)0x0) ||
      (((pSVar3 = param_1, param_1->version != 0 &&
        (((param_1->version & 0x80U) == 0 ||
         (pSVar3 = (SSL *)ossl_quic_obj_get0_handshake_layer(), pSVar3 == (SSL *)0x0)))) ||
       (psVar4 = SSL_get_ciphers(param_1), psVar4 == (stack_st_SSL_CIPHER *)0x0)))) ||
     (iVar1 = ssl_set_client_disabled(pSVar3), iVar1 == 0)) {
LAB_001055b3:
    lVar6 = 0;
  }
  else {
    ...
    for (iVar1 = 0; iVar2 = OPENSSL_sk_num(psVar4), iVar1 < iVar2; iVar1 = iVar1 + 1) {
      ...
      if (iVar2 == 0) {
        if ((lVar6 == 0) && (lVar6 = OPENSSL_sk_new_null(), lVar6 == 0)) goto LAB_001055b3;
...

{
  ...
  if ((s->version == 0) ||
     (((s->version & 0x80U) != 0 &&
      (pSVar4 = (SSL *)ossl_quic_obj_get0_handshake_layer(), pSVar4 != (SSL *)0x0)))) {
    pSVar1 = s->method;
    lVar5 = ssl_create_cipher_list
                      (pSVar1,pSVar4[2].rbio,pSVar4 + 2,&pSVar4[2].method,str,
                       *(undefined8 *)&pSVar4[3].packet_length);
    if (lVar5 != 0) {
...

{
  ...
  if ((((s != (SSL *)0x0) &&
       ((pSVar6 = s, s->version == 0 ||
        (((s->version & 0x80U) != 0 &&
         (pSVar6 = (SSL *)ossl_quic_obj_get0_handshake_layer(), pSVar6 != (SSL *)0x0)))))) &&
      (*(int *)&pSVar6->s2 != 0)) &&
     ((((lVar1._0_4_ = pSVar6[1].tlsext_hb_seq, lVar1._4_4_ = pSVar6[1].renegotiate, 1 < len &&
        (lVar1 != 0)) && (psVar4 = SSL_get_ciphers(s), psVar4 != (stack_st_SSL_CIPHER *)0x0)) &&
      ((iVar2 = OPENSSL_sk_num(lVar1), iVar2 != 0 && (iVar2 = OPENSSL_sk_num(psVar4), iVar2 != 0))))
     )) {
    iVar2 = 0;
    __dest = buf;
    do {
...

{
  ...
  if ((s->version == 0) ||
     (((s->version & 0x80U) != 0 &&
      (pSVar3 = (SSL *)ossl_quic_obj_get0_handshake_layer(), pSVar3 != (SSL *)0x0)))) {
    if (*(long *)&pSVar3->packet_length == 0) {
      if (type != 0) goto LAB_00105a58;
    }
    else {
      if (type != 0) goto LAB_00105a58;
      if (*(int *)&pSVar3->s2 != 0) {
        if ((*(int *)&pSVar3[1].tls_session_ticket_ext_cb != 0) &&
           ((((*(byte *)(*(long *)&pSVar3->wbio[1].ex_data.dummy + 0x50) & 8) != 0 ||
             (iVar2 = *(int *)&pSVar3->wbio->method, iVar2 < 0x304)) || (iVar2 == 0x10000)))) {
    ...
    if (iVar2 == 0) {
      if (((((*(byte *)(*(long *)&pSVar3->wbio[1].ex_data.dummy + 0x50) & 8) == 0) &&
           (iVar2 = *(int *)&pSVar3->wbio->method, iVar2 != 0x10000)) && (0x303 < iVar2)) ||
         ((*(int *)&pSVar3[1].tls_session_ticket_ext_cb == 0 ||
          (pEVar4 = pSVar3[3].write_hash[0x10].pctx, pEVar4 == (EVP_PKEY_CTX *)0x0)))) {
LAB_00105a2a:
        return (char *)pSVar3[3].tlsext_ocsp_resp;
      }
    }
    else {
      pEVar4 = (EVP_PKEY_CTX *)pSVar3[3].tlsext_ocsp_resp;
      if (((pEVar4 == (EVP_PKEY_CTX *)0x0) &&
          (pEVar1 = pSVar3[3].write_hash, pEVar1 != (EVP_MD_CTX *)0x0)) &&
         (*(int *)&pEVar1->digest != 0x304)) {
...

{
  ...
  if (uVar7 != 0) {
    bVar2 = *client;
    if (((ulong)bVar2 <= uVar7 - 1) && ((ulong)bVar2 != 0)) {
      uVar8 = (ulong)inlen;
      *out = client + 1;
      *outlen = bVar2;
      do {
        ...
        while (uVar3 != 0) {
          ...
          uVar6 = (uVar6 - 1) - uVar5;
          uVar3 = uVar6;
          if ((uVar5 == len) && (iVar4 = CRYPTO_memcmp(a,b,len), iVar4 == 0)) {
            *out = b;
            *outlen = bVar2;
            return 1;
          }
...

{
  ...
  if (s != (SSL *)0x0) {
    if (s->version == 0) {
LAB_00105c9c:
      puVar1 = *(uchar **)&s[4].quiet_shutdown;
      *data = puVar1;
      if (puVar1 != (uchar *)0x0) {
        *len = s[4].state;
        return;
    ...
    if ((s->version & 0x80U) != 0) {
      s = (SSL *)ossl_quic_obj_get0_handshake_layer();
      if (s != (SSL *)0x0) goto LAB_00105c9c;
    }
  }
  *data = (uchar *)0x0;
LAB_00105cc8:
...

{
  ...
  if ((param_3 != 0) && (param_2 != 0)) {
    if (param_3 != 1) {
      ...
      if ((param_3 == uVar2) &&
         (lVar1 = CRYPTO_memdup(param_2,uVar3,"ssl/ssl_lib.c",0xec8), lVar1 != 0)) {
...
LAB_00105fbc:
    ...
    if ((*param_1 & 0x80) != 0) {
      param_1 = (uint *)ossl_quic_obj_get0_handshake_layer();
      if (param_1 != (uint *)0x0) goto LAB_00105fbc;
    }
  }
  *param_2 = 0;
LAB_00105fe8:
...

{
  ...
  if ((s[3].write_hash != (EVP_MD_CTX *)0x0) && ((0x300 < s->state || (s->state == 0x100)))) {
                    /* WARNING: Could not recover jumptable at 0x0010609e. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (((*(int *)(param_1 + 0x78) != 0) && (*(long *)(c[1].master_key + 0xc) == 0)) &&
     ((*(byte *)(param_1 + 0x950) & 1) != 0)) {
    return;
  }
  s = *(SSL_CTX **)(param_1 + 0xb88);
  uVar1 = *(uint *)&s->new_session_cb;
  if ((uVar1 & param_2) == 0) goto LAB_00106580;
...
LAB_0010662a:
    ...
    if ((uVar1 & 0x200) == 0) {
LAB_00106610:
      if (((iVar3 == 0x10000 || iVar3 < 0x304) || (*(int *)(param_1 + 0x78) == 0)) ||
         (((*(int *)(param_1 + 0x1540) != 0 && ((*(byte *)(param_1 + 0x9b3) & 1) == 0)) ||
          ((lVar2._0_4_ = (s->stats).sess_connect, lVar2._4_4_ = (s->stats).sess_connect_renegotiate
           , lVar2 != 0 || ((*(byte *)(param_1 + 0x9b1) & 0x40) != 0)))))) goto LAB_0010662a;
    }
  }
  if (((s->get_session_cb != (_func_3089 *)0x0) && (iVar3 = SSL_SESSION_up_ref(), iVar3 != 0)) &&
     (iVar3 = (**(code **)(*(long *)(param_1 + 0xb88) + 0x60))
                        (*(undefined8 *)(param_1 + 0x40),*(undefined8 *)(param_1 + 0x900)),
     iVar3 == 0)) {
...

{
  ...
  if ((method != pSVar4) &&
     (pSVar4 = (SSL_METHOD *)OSSL_QUIC_client_thread_method(), method != pSVar4)) {
...

{
  ...
  pSVar3 = s;
  if (((s->version != 0) && (pSVar3 = (SSL *)0x0, (s->version & 0x80U) != 0)) &&
     (pSVar3 = (SSL *)ossl_quic_obj_get0_handshake_layer(), (s->version & 0x80) != 0)) {
    if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
...
LAB_001068f4:
    ...
    if ((iVar2 == 0) && (iVar2 = SSL_in_before(s), iVar2 == 0)) {
      ...
      if (((pSVar3[3].references & 0x100) == 0) || (lVar4 = ASYNC_get_current_job(), lVar4 != 0)) {
        if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00106815. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  ...
  if (ssl->version != 0) {
    if ((ssl->version & 0x80U) != 0) {
      ...
      if ((ssl->version & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x001069dc. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        iVar1 = (*(code *)ssl->wbio->prev_bio)();
        return iVar1;
      }
      if (pSVar2 != (SSL *)0x0) goto LAB_0010698a;
    }
    return 0;
  }
LAB_0010698a:
  if (*(long *)&pSVar2->packet_length == 0) {
...
undefined1
SSL_read_early_data(SSL *param_1,undefined8 param_2,undefined8 param_3,undefined8 *param_4)
...
LAB_00106ac9:
    ...
    if (iVar2 == 8) {
LAB_00106a6c:
      *(undefined4 *)&param_1->write_hash = 9;
...

{
  ...
  if (ssl->version != 0) {
    if ((ssl->version & 0x80U) != 0) {
      pSVar2 = (SSL *)ossl_quic_obj_get0_handshake_layer();
      if ((ssl->version & 0x80) != 0) {
                    /* WARNING: Could not recover jumptable at 0x00106c4c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        iVar1 = (**(code **)&ssl->wbio->references)();
        return iVar1;
      }
      if (pSVar2 != (SSL *)0x0) goto LAB_00106bfa;
    }
    return 0;
  }
LAB_00106bfa:
...

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  if ((param_1 == (SSL *)0x0) || (param_1->version != 0)) goto LAB_00106db0;
  ...
  case 0:
    if (((*(int *)&param_1->s2 == 0) && (iVar3 = SSL_in_before(param_1), iVar3 != 0)) &&
       (((param_1[3].write_hash != (EVP_MD_CTX *)0x0 &&
        ...
        (param_1[3].ctx != (SSL_CTX *)0x0)))) goto switchD_00106cde_caseD_1;
    ERR_new();
    uVar4 = 0xaa1;
    break;
  case 1:
switchD_00106cde_caseD_1:
...

{
  ...
  uVar3 = 0;
  if ((uVar1 != 0) && (uVar2 = *(ulong *)(param_1 + 0x24), uVar2 != 0)) {
    if (uVar2 < uVar1) {
      return 0xffffffff;
    }
...

{
  ...
  if ((s != (SSL *)0x0) && (s->version == 0)) {
    ...
    uVar1._4_4_ = s[4].client_version;
                    /* WARNING: Could not recover jumptable at 0x001072f7. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (ssl->version != 0) {
    ...
    iVar2 = 1;
    if ((1 < ssl->version - 0x80U) && (iVar2 = 0, lVar3 != 0)) {
...
LAB_001076ac:
    ...
    if ((((pBVar9 != (BIO *)0x0) &&
         (pvVar6 = memchr(pBVar9,2,(size_t)pBVar7), pvVar6 != (void *)0x0)) ||
        (*(long *)(lVar14 + 200) != 0)) && (*(long *)(lVar14 + 0xd0) != 0)) {
      uVar13 = 0x80;
      uVar10 = 0x210;
    }
LAB_0010770f:
    ...
    if ((((pBVar9 == (BIO *)0x0) ||
         (pvVar6 = memchr(pBVar9,2,(size_t)pBVar7), pvVar6 == (void *)0x0)) &&
        (*(long *)(lVar14 + 0xa0) == 0)) || (*(long *)(lVar14 + 0xa8) == 0)) {
      uVar8 = uVar8 | uVar10;
    }
    else {
      uVar13 = uVar13 | 0x20;
  ...
  if ((local_64 & 1) == 0) {
    if (1 < iVar5) {
      ...
      if ((((pBVar9 != (BIO *)0x0) &&
           (pvVar6 = memchr(pBVar9,2,(size_t)pBVar7), pvVar6 != (void *)0x0)) ||
          (*(long *)(lVar14 + 0x28) != 0)) &&
         ((*(long *)(lVar14 + 0x30) != 0 && ((*(byte *)((long)puVar2 + 5) & 1) != 0)))) {
        iVar5 = SSL_version(param_1);
        if (iVar5 >> 8 == 3) {
          iVar5 = SSL_version(param_1);
          local_64 = *puVar2;
          local_60 = puVar2[3];
          if (iVar5 == 0x303) goto LAB_0010777e;
        }
        else {
          local_64 = *puVar2;
          local_60 = puVar2[3];
...
LAB_0010777e:
  ...
  if ((iVar5 >> 8 == 3) && (iVar5 = SSL_version(param_1), iVar5 == 0x303)) {
    ...
    if (((*(byte *)((long)puVar2 + 0x1d) & 0x10) != 0) ||
       ((*(byte *)((long)puVar2 + 0x21) & 0x10) != 0)) {
      uVar13 = uVar13 | 8;
    }
  }
  if (uVar4 != 0) {
  ...
  uVar4 = (uint)uVar13;
  if (((uVar13 & 8) != 0) || (iVar5 = (int)*(undefined8 *)(param_1->sid_ctx + 0xc), iVar5 < 8))
  goto LAB_001078c8;
  if (*(int *)&param_1->s2 == 0) {
    pBVar9 = param_1[8].wbio;
    pBVar7 = param_1[8].bbio;
  ...
  if ((pBVar9 == (BIO *)0x0) || (pvVar6 = memchr(pBVar9,2,(size_t)pBVar7), pvVar6 == (void *)0x0)) {
    ...
    if (*(long *)(lVar1 + 0x118) != 0) {
      ...
      goto joined_r0x00107845;
    }
  }
  else {
    lVar1 = *(long *)(*(long *)(*(long *)&param_1[3].packet_length + 0x20) + 0x120);
joined_r0x00107845:
    if ((lVar1 != 0) && ((*(byte *)((long)puVar2 + 0x1d) & 1) != 0)) {
      iVar5 = SSL_version(param_1);
      if ((iVar5 >> 8 == 3) && (iVar5 = SSL_version(param_1), iVar5 == 0x303)) {
        uVar4 = uVar4 | 8;
        goto LAB_001078c8;
  ...
  if (8 < iVar5) {
    ...
    {
      lVar1 = *(long *)(*(long *)&param_1[3].packet_length + 0x20);
      if (*(long *)(lVar1 + 0x140) == 0) goto LAB_001078c8;
      lVar1 = *(long *)(lVar1 + 0x148);
    }
    else {
      lVar1 = *(long *)(*(long *)(*(long *)&param_1[3].packet_length + 0x20) + 0x148);
    }
    if (((lVar1 != 0) && ((*(byte *)((long)puVar2 + 0x21) & 1) != 0)) &&
       (iVar5 = SSL_version(param_1), iVar5 >> 8 == 3)) {
      iVar5 = SSL_version(param_1);
      if (iVar5 == 0x303) {
        uVar4 = uVar4 | 8;
      }
...
LAB_001078c8:
  *(uint *)((long)&param_1[1].kssl_ctx + 4) = uVar4 | 0x10;
  uVar4 = uVar8 | 0x4c;
  if (uVar12 == 0) {
    uVar4 = uVar8 | 0xc;
  }
...

{
  ...
  if (*param_1 != 0) {
    ...
    lVar3 = ossl_quic_obj_get0_handshake_layer();
    uVar2 = 1;
    if ((1 < *param_1 - 0x80) && (uVar2 = 0, lVar3 != 0)) {
...

{
  ...
  iVar1 = X509_STORE_set_default_paths_ex
                    (ctx->session_cache_size,ctx->method,ctx[1].psk_client_callback);
  return iVar1;
}
...

{
  ...
  if (*param_1 != 0) {
    if ((*param_1 & 0x80) != 0) {
      param_1 = (uint *)ossl_quic_obj_get0_handshake_layer();
      if (param_1 != (uint *)0x0) goto LAB_00108030;
    }
    return 0;
  }
LAB_00108030:
    ...
    if (uVar3 < 8) {
      if ((uVar2 & 4) == 0) {
        if ((uVar3 != 0) && (*(char *)param_2 = (char)*puVar1, (uVar2 & 2) != 0)) {
          *(undefined2 *)((long)param_2 + (uVar4 - 2)) =
               *(undefined2 *)((long)param_1 + uVar4 + 0x186);
        }
      }
      else {
        *param_2 = *puVar1;
        *(undefined4 *)((long)param_2 + (uVar4 - 4)) =
             *(undefined4 *)((long)param_1 + uVar4 + 0x184);
      }
    }
    else {
      *(undefined8 *)param_2 = *(undefined8 *)(param_1 + 0x62);
      *(undefined8 *)((long)param_2 + ((uVar2 & 0xffffffff) - 8)) =
           *(undefined8 *)((long)param_1 + (uVar2 & 0xffffffff) + 0x180);
      ...
      if (7 < uVar3) {
        ...
        do {
          uVar4 = (ulong)uVar5;
          uVar5 = uVar5 + 8;
          *(undefined8 *)(((ulong)(param_2 + 2) & 0xfffffffffffffff8) + uVar4) =
               *(undefined8 *)((long)puVar1 + (uVar4 - lVar6));
        } while (uVar5 < uVar3);
      }
    }
  }
...

{
  ...
  if (*param_1 != 0) {
    if ((*param_1 & 0x80) != 0) {
      param_1 = (uint *)ossl_quic_obj_get0_handshake_layer();
      if (param_1 != (uint *)0x0) goto LAB_00108120;
    }
    return 0;
  }
LAB_00108120:
  ...
  if (param_3 != 0) {
    ...
    if (uVar3 < 8) {
      if ((uVar2 & 4) == 0) {
        if ((uVar3 != 0) && (*(char *)param_2 = (char)*puVar1, (uVar2 & 2) != 0)) {
          *(undefined2 *)((long)param_2 + (uVar4 - 2)) =
               *(undefined2 *)((long)param_1 + uVar4 + 0x166);
        }
      }
      else {
        *param_2 = *puVar1;
        *(undefined4 *)((long)param_2 + (uVar4 - 4)) =
             *(undefined4 *)((long)param_1 + uVar4 + 0x164);
      }
    }
    else {
      *(undefined8 *)param_2 = *(undefined8 *)(param_1 + 0x5a);
      *(undefined8 *)((long)param_2 + ((uVar2 & 0xffffffff) - 8)) =
           *(undefined8 *)((long)param_1 + (uVar2 & 0xffffffff) + 0x160);
      lVar6 = (long)param_2 - ((ulong)(param_2 + 2) & 0xfffffffffffffff8);
      uVar3 = uVar3 + (int)lVar6 & 0xfffffff8;
      if (7 < uVar3) {
        uVar5 = 0;
...

{
  ...
  if (param_1->version == 0) {
    ...
    pSVar3 = param_1;
    if (param_3 != 0) goto LAB_00108520;
  }
  else {
    if ((param_1->version & 0x80U) == 0) {
      return (uint)(param_2 < 1);
    ...
    if ((param_1->version & 0x80) == 0) {
      ...
      if (param_3 == 0) goto LAB_001083d3;
LAB_00108520:
    ...
    if ((param_1->version & 0x80U) != 0) goto LAB_001083f5;
  }
LAB_001083d3:
...
LAB_0010879d:
    ...
    if ((s->version & 0x80U) != 0) {
      s = (SSL *)ossl_quic_obj_get0_handshake_layer();
      if (s != (SSL *)0x0) goto LAB_0010879d;
    }
    uVar2 = 0;
  }
  return uVar2;
...

{
  ...
  if (((lVar1 == lVar2) ||
      (lVar1 = *(long *)(param_1 + 8), lVar2 = OSSL_QUIC_client_thread_method(), lVar1 == lVar2)) ||
     (lVar1 = *(long *)(param_1 + 8), lVar2 = OSSL_QUIC_server_method(), lVar1 == lVar2)) {
    if (1 < (param_2 | param_3)) {
      return 0;
    }
    *(undefined8 *)(param_1 + 0x418) = 0;
    if (param_3 != 1) goto LAB_00108bfa;
  }
  else {
    if (param_2 == 1) {
      param_2 = 0;
...

{
  ...
  if (*param_1 != 0) {
    ...
    if ((*param_1 & 0x80) != 0) {
      ...
      puVar1[0x33e] = 0;
      puVar1[0x33f] = 0;
      if (param_3 == 1) goto LAB_00108e08;
      goto LAB_00108da3;
    }
  }
  if (param_2 == 1) {
...

{
  ...
  if (*param_1 != 0) {
    if ((*param_1 & 0x80) != 0) {
      param_1 = (uint *)ossl_quic_obj_get0_handshake_layer();
      if (param_1 != (uint *)0x0) goto LAB_00108e54;
    }
    return 0;
  }
LAB_00108e54:
  *(undefined8 *)(param_1 + 0x554) = param_2;
  return 1;
}
...
LAB_001096d4:
    ...
    if (*param_1 != 0) {
      if ((*param_1 & 0x80) != 0) {
        ...
        if (puVar1 != (uint *)0x0) goto LAB_00109606;
      }
      goto LAB_001096d4;
    }
LAB_00109606:
    *(ulong *)(puVar1 + 0x26c) = *(ulong *)(puVar1 + 0x26c) & ~param_2;
...
LAB_0010997b:
          ...
          resp = d2i_OCSP_RESPONSE((OCSP_RESPONSE **)0x0,&local_48,
                                   (long)(int)*(long *)(param_1 + 0x296));
          if (resp == (OCSP_RESPONSE *)0x0) goto LAB_00109978;
          bs = OCSP_response_get1_basic(resp);
          if (bs == (OCSP_BASICRESP *)0x0) goto LAB_0010997b;
          idx = 0;
          pvVar4 = (void *)0x0;
          iVar1 = 0;
          while( true ) {
        ...
        if ((*(long *)(param_1 + 0x240) != 0) &&
           (x = *(X509 **)(*(long *)(param_1 + 0x240) + 0x2c0), x != (X509 *)0x0)) {
    ...
    if ((*param_1 & 0x80) != 0) {
      param_1 = (uint *)ossl_quic_obj_get0_handshake_layer();
      if (param_1 != (uint *)0x0) goto LAB_001097f0;
    }
  }
LAB_00109840:
  uVar3 = 0;
...

{
  ...
  if (((((*(long *)(param_1 + 0xb68) != 0) && (lVar4 != 0)) && (*(long *)(param_1 + 0x998) == 0)) &&
      ((*(long *)(param_1 + 0x990) != 0 && (iVar1 = OPENSSL_sk_num(), 1 < iVar1)))) &&
     ((iVar1 = OPENSSL_sk_num(*(undefined8 *)(param_1 + 0x520)), iVar1 < 1 ||
      ((*(byte **)(param_1 + 0x530) == (byte *)0x0 || (1 < **(byte **)(param_1 + 0x530) - 2)))))) {
    lVar2 = CT_POLICY_EVAL_CTX_new_ex
    ...
    if (lVar2 == 0) {
      ...
      CT_POLICY_EVAL_CTX_set_shared_CTLOG_STORE
                (lVar2,*(undefined8 *)(*(long *)(param_1 + 8) + 0x1d0));
...
undefined8
SSL_client_hello_get1_extensions_present(uint *param_1,undefined8 *param_2,ulong *param_3)

{
  ...
  if ((((*param_1 != 0) &&
       (((*param_1 & 0x80) == 0 ||
        (param_1 = (uint *)ossl_quic_obj_get0_handshake_layer(), param_1 == (uint *)0x0)))) ||
      (lVar1 = *(long *)(param_1 + 0x2d6), lVar1 == 0)) ||
     ((param_2 == (undefined8 *)0x0 || (param_3 == (ulong *)0x0)))) {
    return 0;
  }
  ...
  if (uVar2 != 0) {
    uVar5 = 0;
    piVar4 = (int *)(*(long *)(lVar1 + 0x288) + 0x10);
    do {
      uVar5 = (uVar5 + 1) - (ulong)(*piVar4 == 0);
      piVar4 = piVar4 + 10;
    } while (piVar4 != (int *)(*(long *)(lVar1 + 0x288) + 0x10 + uVar2 * 0x28));
    if (uVar5 != 0) {
      ptr = CRYPTO_malloc((int)uVar5 * 4,"ssl/ssl_lib.c",0x1ab1);
      if (ptr == (void *)0x0) {
        return 0;
      }
      ...
      if (lVar1 != 0) {
        lVar3 = 0;
        piVar4 = (int *)(*(long *)(*(long *)(param_1 + 0x2d6) + 0x288) + 0x10);
        do {
          if (*piVar4 != 0) {
            if (uVar5 <= *(ulong *)(piVar4 + 4)) {
              CRYPTO_free(ptr);
              return 0;
            }
            *(int *)((long)ptr + *(ulong *)(piVar4 + 4) * 4) = piVar4[2];
          }
          lVar3 = lVar3 + 1;
          piVar4 = piVar4 + 10;
        } while (lVar1 != lVar3);
...
undefined8 SSL_client_hello_get_extension_order(uint *param_1,long param_2,ulong *param_3)

{
  ...
  if ((((*param_1 == 0) ||
       (((*param_1 & 0x80) != 0 &&
        (param_1 = (uint *)ossl_quic_obj_get0_handshake_layer(), param_1 != (uint *)0x0)))) &&
      (lVar3 = *(long *)(param_1 + 0x2d6), lVar3 != 0)) && (param_3 != (ulong *)0x0)) {
    lVar1 = *(long *)(lVar3 + 0x280);
    if (lVar1 == 0) {
      uVar5 = 0;
    }
    else {
      piVar4 = (int *)(*(long *)(lVar3 + 0x288) + 0x10);
      uVar5 = 0;
      piVar2 = piVar4;
      do {
        uVar5 = (uVar5 + 1) - (ulong)(*piVar2 == 0);
        piVar2 = piVar2 + 10;
      ...
      if ((uVar5 != 0) && (param_2 != 0)) {
        ...
        do {
          if (*piVar4 != 0) {
            ...
            *(short *)(param_2 + *(ulong *)(piVar4 + 4) * 2) = (short)piVar4[2];
          }
          lVar3 = lVar3 + 1;
          piVar4 = piVar4 + 10;
        } while (lVar3 != lVar1);
...
undefined8
SSL_client_hello_get0_ext(uint *param_1,int param_2,undefined8 *param_3,undefined8 *param_4)
...

{
  ...
  if (7 < param_3) {
    uVar1 = nss_keylog_int(&_LC21,param_1,param_2,8,param_4,param_5);
    return uVar1;
  }
  ERR_new();
...
void ssl_log_secret(long param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  nss_keylog_int(param_2,param_1,param_1 + 0x188,0x20,param_3,param_4);
  return;
}
...

{
  ...
  if (param_2[1] == 0) {
    ...
    uVar7 = (ulong)(int)(3 - (uint)(param_3 == 0));
    if ((ulong)param_2[1] % uVar7 == 0) {
      ...
      *(undefined8 *)(param_1 + 0x3a8) = 0;
      if (param_3 == 0) {
        ...
        *(undefined8 *)(param_1 + 0x3a0) = 0;
        if (lVar8 != 0) {
          lVar3 = CRYPTO_memdup(*param_2,lVar8,"include/internal/packet.h",0x1cf);
          *(long *)(param_1 + 0x3a0) = lVar3;
          if (lVar3 == 0) {
            ERR_new();
      ...
      uVar6 = param_2[1];
      pcVar4 = (char *)*param_2;
      puVar2 = (undefined2 *)CRYPTO_malloc((int)(uVar6 / uVar7) * 2,"ssl/ssl_lib.c",0x1ba7);
      *(undefined2 **)(param_1 + 0x3a0) = puVar2;
      if (puVar2 == (undefined2 *)0x0) {
        ...
        *(undefined8 *)(param_1 + 0x3a8) = 0;
        ...
        lVar8 = uVar6 - 3;
        uVar6 = uVar6 - 1;
        if (*pcVar4 == '\0') goto LAB_0010a7ba;
        while (pcVar4 = pcVar5, lVar3 = lVar8, 1 < uVar6) {
          while( true ) {
            puVar2 = puVar2 + 1;
            pcVar5 = pcVar4 + 3;
            lVar8 = lVar3 + -3;
            ...
            if (*pcVar4 != '\0') break;
LAB_0010a7ba:
            if (uVar6 < 2) goto LAB_0010a7c4;
            uVar1 = *(undefined2 *)(pcVar5 + -2);
    ...
    if ((ulong)param_2[1] % uVar12 == 0) {
      ...
      if ((lVar3 == 0) || (lVar4 == 0)) {
        if (param_6 == 0) {
          ...
          uVar5 = 0x1bfb;
LAB_0010ad31:
          ERR_set_debug("ssl/ssl_lib.c",uVar5,"ossl_bytes_to_cipher_list");
          ERR_set_error(0x14,0x8000f,0);
        }
        else {
          ERR_new();
        ...
        if (uVar12 <= uVar10) {
          ...
          do {
            if (uVar9 != 0) {
              ...
              do {
                uVar1 = (int)uVar7 + 1;
                local_43[uVar7] = *(char *)(lVar11 + uVar7);
                uVar7 = (ulong)uVar1;
              } while (uVar1 < uVar9);
            }
            ...
            *param_2 = lVar11;
            param_2[1] = uVar10;
            if ((param_5 == 0) || (local_43[0] == '\0')) {
              piVar8 = (int *)ssl_get_cipher_by_char(param_1,pcVar6,1);
              if (piVar8 != (int *)0x0) {
                if (*piVar8 == 0) {
LAB_0010ac2d:
                  iVar2 = OPENSSL_sk_push(lVar4,piVar8);
                  if (iVar2 != 0) goto LAB_0010ac42;
                }
                else {
                  iVar2 = OPENSSL_sk_push(lVar3,piVar8);
                  if (iVar2 != 0) {
                    if (*piVar8 != 0) goto LAB_0010ac42;
                    goto LAB_0010ac2d;
                  }
                }
                if (param_6 != 0) {
...
SSL_bytes_to_cipher_list
          (uint *param_1,undefined8 param_2,long param_3,undefined4 param_4,undefined8 param_5,
          undefined8 param_6)
...
LAB_0010ae3b:
      ...
      param_1 = (uint *)ossl_quic_obj_get0_handshake_layer();
      if (param_1 != (uint *)0x0) goto LAB_0010ae3b;
    }
  }
  uVar1 = 0;
LAB_0010ae62:
...

{
  ...
  if ((*(long *)(param_1 + 0x900) != 0) &&
     (bVar1 = *(char *)(*(long *)(param_1 + 0x900) + 0x358) - 1, bVar1 < 4)) {
...

{
  ...
  if ((((*(long *)(param_1 + 0x900) == 0) ||
       (bVar1 = *(char *)(*(long *)(param_1 + 0x900) + 0x358) - 1, 3 < bVar1)) ||
      (uVar3 = 0x200 << (bVar1 & 0x1f), uVar4 = (ulong)uVar3, uVar2 <= uVar3)) &&
     (uVar4 = *(ulong *)(param_1 + 0x9e0) & 0xffffffff, uVar2 <= *(ulong *)(param_1 + 0x9e0))) {
    uVar4 = uVar2 & 0xffffffff;
  }
  return uVar4;
}
...

{
  ...
  if ((param_1->version == 0) && (iVar1 = SSL_clear(param_1), iVar1 != 0)) {
    ERR_clear_error();
...

{
  ...
  if ((((*(byte *)(*(long *)(*(int **)(param_1 + 6) + 0x36) + 0x50) & 8) == 0) &&
      (iVar2 = **(int **)(param_1 + 6), iVar2 != 0x10000)) && (0x303 < iVar2)) {
    if (param_1[0x1e] == 0) {
      ERR_new();
  ...
  uVar4 = 0x1cc2;
LAB_0010b221:
  ERR_set_debug("ssl/ssl_lib.c",uVar4,"SSL_verify_client_post_handshake");
  ERR_set_error(0x14,0x10a,0);
  return 0;
}
...
undefined8
SSL_CTX_set_session_ticket_cb(long param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)
...

{
  ...
  *piVar1 = *piVar1 + -1;
  ...
  param_1[1].sid_ctx[8] = '\0';
  param_1[1].sid_ctx[9] = '\0';
  param_1[1].sid_ctx[10] = '\0';
  param_1[1].sid_ctx[0xb] = '\0';
  param_1[1].sid_ctx[0xc] = '\0';
  param_1[1].sid_ctx[0xd] = '\0';
  param_1[1].sid_ctx[0xe] = '\0';
  param_1[1].sid_ctx[0xf] = '\0';
  CRYPTO_free(pvVar4);
  psVar8 = param_1->session_cache_head;
  param_1[1].sid_ctx[0x10] = '\0';
  param_1[1].sid_ctx[0x11] = '\0';
  param_1[1].sid_ctx[0x12] = '\0';
  param_1[1].sid_ctx[0x13] = '\0';
  param_1[1].sid_ctx[0x14] = '\0';
  param_1[1].sid_ctx[0x15] = '\0';
  param_1[1].sid_ctx[0x16] = '\0';
  param_1[1].sid_ctx[0x17] = '\0';
  param_1[1].sid_ctx[0x18] = '\0';
  ...
  do {
    ...
    ssl_evp_cipher_free(pvVar4);
           ...
           (stack_st_SRTP_PROTECTION_PROFILE **)&param_1[2].default_passwd_callback_userdata);
  do {
    psVar6 = *ppsVar9;
    ppsVar9 = ppsVar9 + 1;
    ssl_evp_md_free(psVar6);
  } while (ppsVar9 != (stack_st_SRTP_PROTECTION_PROFILE **)&param_1[2].mode);
  ...
  if (*(long *)param_1[2].tlsext_tick_aes_key != 0) {
    ...
    do {
      ...
      CRYPTO_free(*(void **)(*(long *)(param_1[2].tlsext_tick_hmac_key + 8) + 0x10 + lVar2));
      CRYPTO_free(*(void **)(*(long *)(param_1[2].tlsext_tick_hmac_key + 8) + 0x18 + lVar2));
      CRYPTO_free(*(void **)(*(long *)(param_1[2].tlsext_tick_hmac_key + 8) + 0x20 + lVar2));
      CRYPTO_free(*(void **)(*(long *)(param_1[2].tlsext_tick_hmac_key + 8) + 0x28 + lVar2));
      CRYPTO_free(*(void **)(*(long *)(param_1[2].tlsext_tick_hmac_key + 8) + 0x30 + lVar2));
      CRYPTO_free(*(void **)(*(long *)(param_1[2].tlsext_tick_hmac_key + 8) + 0x38 + lVar2));
      CRYPTO_free(*(void **)(*(long *)(param_1[2].tlsext_tick_hmac_key + 8) + 0x40 + lVar2));
      CRYPTO_free(*(void **)(*(long *)(param_1[2].tlsext_tick_hmac_key + 8) + 0x48 + lVar2));
      uVar10 = uVar11;
  ...
  if (iVar15 == 0) {
    ...
    *(long *)&ssl[3].packet_length = lVar18;
    ...
    if (lVar18 != 0) {
      ...
      *(ulong *)&ssl[3].mac_flags = uVar3;
      if (0x20 < uVar3) goto LAB_0010bf5f;
      ...
      *(undefined8 *)(ssl[3].sid_ctx + 4) = uVar1;
      ...
      if (((lVar18 == lVar19) ||
          (lVar18 = *(long *)(param_1 + 8), lVar19 = OSSL_QUIC_client_thread_method(),
          lVar18 == lVar19)) ||
         (lVar18 = *(long *)(param_1 + 8), lVar19 = OSSL_QUIC_server_method(), lVar18 == lVar19)) {
        uVar16 = 0;
      }
      else {
      ...
      *(undefined8 *)&ssl[3].max_send_fragment = uVar6;
      ...
      if (iVar15 == 0) goto LAB_0010bf5f;
      lVar18 = *(long *)(param_1 + 0x288);
      *(long *)&ssl[4].mac_flags = param_1;
      if (lVar18 != 0) {
        pvVar20 = (void *)CRYPTO_memdup(lVar18,*(undefined8 *)(param_1 + 0x280),"ssl/ssl_lib.c",
                                        0x342);
      ...
      if (*(long *)(param_1 + 0x298) != 0) {
        puVar21 = (uchar *)CRYPTO_memdup(*(long *)(param_1 + 0x298),
                                         (*(long *)(param_1 + 0x290) +
                                         (ulong)(*(long *)(param_1 + 0x290) == 0)) * 2,
                                         "ssl/ssl_lib.c",0x352);
      ...
      if (*(long *)(param_1 + 0x2a8) != 0) {
        lVar18 = CRYPTO_memdup(*(long *)(param_1 + 0x2a8),
                               (*(long *)(param_1 + 0x2a0) +
                               (ulong)(*(long *)(param_1 + 0x2a0) == 0)) * 2,"ssl/ssl_lib.c");
      ...
      if (*(long *)(param_1 + 0x2b8) != 0) {
        lVar18 = CRYPTO_memdup(*(long *)(param_1 + 0x2b8),
                               (*(long *)(param_1 + 0x2b0) +
                               (ulong)(*(long *)(param_1 + 0x2b0) == 0)) * 8,"ssl/ssl_lib.c",0x372);
      ...
      if (lVar18 != 0) {
        __dest = (_func_3149 *)
                 CRYPTO_malloc((int)*(undefined8 *)(param_1 + 0x2d8),"ssl/ssl_lib.c",0x381);
      ...
      if (iVar15 != 0) {
        *(uint *)&ssl->s2 = (uint)(*(code **)(param_3 + 0x10) != ssl_undefined_function);
        ...
        if (iVar15 != 0) {
          ...
          ssl[3].ctx = pSVar10;
          if (lVar18 != 0) {
            pBVar17 = (BIO *)CRYPTO_memdup(lVar18,*(undefined8 *)(param_1 + 0x6b8),"ssl/ssl_lib.c",
                                           0x3af);
            ssl[8].wbio = pBVar17;
            if (pBVar17 == (BIO *)0x0) goto LAB_0010bf33;
            ssl[8].bbio = *(BIO **)(param_1 + 0x6b8);
          }
          if (*(long *)(param_1 + 0x6c0) != 0) {
            lVar18 = CRYPTO_memdup(*(long *)(param_1 + 0x6c0),*(undefined8 *)(param_1 + 0x6c8),
                                   "ssl/ssl_lib.c",0x3b6);
            ssl[8].rwstate = (int)lVar18;
            ssl[8].in_handshake = (int)((ulong)lVar18 >> 0x20);
            if (lVar18 == 0) goto LAB_0010bf33;
            ssl[8].handshake_func = *(_func_3149 **)(param_1 + 0x6c8);
          }
          iVar15 = SSL_set_ct_validation_callback
                             (ssl,*(undefined8 *)(param_1 + 0x1d8),*(undefined8 *)(param_1 + 0x1e0))
          ;
          if (iVar15 != 0) {
  ...
  if (s->version == 0) {
    ...
    if (iVar2 != 0) {
        ...
        *(undefined8 *)((long)&s[1].srtp_profiles + 4) = 0xffffffffffffffff;
        ...
        if (0 < iVar2) {
          do {
            ...
            iVar3 = SSL_dane_tlsa_add(s,*puVar7,puVar7[1],puVar7[2],*(undefined8 *)(puVar7 + 8),
                                      *(undefined8 *)(puVar7 + 0x10));
            if (iVar3 < 1) goto LAB_0010c5c8;
            iVar5 = iVar5 + 1;
          } while (iVar2 != iVar5);
        }
      }
      ...
      *(undefined8 *)(s[3].sid_ctx + 4) = *(undefined8 *)(ssl[3].sid_ctx + 4);
      ...
      iVar2 = CRYPTO_dup_ex_data(0,(CRYPTO_EX_DATA *)&s->handshake_func,
                                 (CRYPTO_EX_DATA *)&ssl->handshake_func);
      if (iVar2 != 0) {
        iVar2 = *(int *)&ssl->s2;
        ...
        *(undefined4 *)&s[1].tls_session_ticket_ext_cb =
             *(undefined4 *)&ssl[1].tls_session_ticket_ext_cb;
        ...
        if (ssl[2].method != (SSL_METHOD *)0x0) {
          ...
          s[2].method = pSVar9;
          if (pSVar9 == (SSL_METHOD *)0x0) goto LAB_0010c5c8;
        }
        iVar2 = dup_ca_names(&s[3].ex_data,ssl[3].ex_data.sk);
        if ((iVar2 != 0) &&
           (iVar2 = dup_ca_names(&s[3].ex_data.dummy,*(undefined8 *)&ssl[3].ex_data.dummy),
           iVar2 != 0)) {
          return s;
        }
      }
  ...
  *(undefined4 *)((long)&obj->app_verify_arg + 4) = 1;
  ...
  if (lVar3 == 0) {
    ...
    if (param_2 != (char *)0x0) {
      ...
      if (p_Var4 == (_func_3101 *)0x0) goto LAB_0010d010;
    }
    ...
    *(undefined4 *)&obj->generate_session_id = 0;
    ...
    psVar7 = (ssl_session_st *)
             OPENSSL_LH_set_thunks
                       (uVar6,0x100000,lh_SSL_SESSION_cfn_thunk,lh_SSL_SESSION_doall_thunk,
...
LAB_0010d0b1:
        ...
        *(long *)obj->sid_ctx = lVar3;
        ...
        lVar3 = ssl_create_cipher_list
                          (obj,obj->sessions,&obj->cipher_list_by_id,&obj->cert_store,uVar6,lVar3);
        if ((lVar3 == 0) || (iVar2 = OPENSSL_sk_num(obj->cipher_list_by_id), iVar2 < 1)) {
          ERR_new();
            ...
            if (pcVar12 == (cert_st *)0x0) {
              ...
              if (iVar2 != 0) {
                ...
                if (pvVar13 != (void *)0x0) {
                  ...
                  pvVar13 = _UNK_0010f2f8;
                  obj->tlsext_status_cb = __LC24;
                  obj->tlsext_status_arg = pvVar13;
                  iVar2 = RAND_bytes_ex(param_1,&obj->next_protos_advertised_cb_arg,0x10,0);
                  if (((iVar2 < 1) ||
                      (iVar2 = RAND_priv_bytes_ex(param_1,obj->next_proto_select_cb_arg,0x20,0),
                      iVar2 < 1)) ||
                     (iVar2 = RAND_priv_bytes_ex(param_1,(long)obj->next_proto_select_cb_arg + 0x20,
                                                 0x20,0), iVar2 < 1)) {
                    *(ulong *)&obj->read_ahead = *(ulong *)&obj->read_ahead | 0x4000;
                  }
                  ...
                  if (iVar2 < 1) {
                    ...
                    *(undefined4 *)&obj[1].cert_store = 0xffffffff;
                    ...
                    if (param_3 == psVar14) {
                      ...
                      if (p_Var15 == (_func_3102 *)0x0) goto LAB_0010d010;
                    }
                    ...
                    if (((param_3 == psVar14) ||
                        ...
                        param_3 == psVar14)) ||
                       (psVar14 = (stack_st_SSL_CIPHER *)OSSL_QUIC_server_method(),
                       param_3 == psVar14)) {
                      psVar14 = (stack_st_SSL_CIPHER *)OSSL_QUIC_client_thread_method();
                      obj[2].psk_client_callback =
                           (_func_3101 *)((ulong)(param_3 != psVar14) * 4 + 0xe);
                    }
      ...
      if ((iVar4 != 0) && (*(ulong *)&ssl[3].mac_flags < 0x21)) {
        ...
        if (iVar4 != 0) {
          ...
          if ((pSVar1 != (SSL_METHOD *)0x0) &&
             (*(_func_3072 **)&ssl[3].mac_flags == pSVar1[1].ssl_pending)) {
            iVar4 = memcmp(&ssl[3].enc_read_ctx,&pSVar1[1].num_ciphers,
                           (size_t)*(_func_3072 **)&ssl[3].mac_flags);
            if (iVar4 == 0) {
...
undefined8 SSL_get_event_timeout(SSL *param_1,undefined8 *param_2,undefined4 *param_3)

{
  ...
  if (param_1 != (SSL *)0x0) {
    ...
    if (((param_1->version == 0) &&
        ((*(byte *)(*(long *)&param_1->wbio[1].ex_data.dummy + 0x50) & 8) != 0)) &&
       (lVar1 = SSL_ctrl(param_1,0x49,0,param_2), lVar1 != 0)) {
      *param_3 = 0;
      return 1;
    }
  }
...

{
  ...
  if (((lVar1 != lVar3) &&
      (lVar1 = *(long *)(param_1 + 8), lVar3 = OSSL_QUIC_client_thread_method(), lVar1 != lVar3)) &&
     (lVar1 = *(long *)(param_1 + 8), lVar3 = OSSL_QUIC_server_method(), lVar1 != lVar3)) {
    ERR_new();
...
undefined8 SSL_set1_client_cert_type(uint *param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  if (*param_1 != 0) {
    if ((*param_1 & 0x80) != 0) {
      param_1 = (uint *)ossl_quic_obj_get0_handshake_layer();
      if (param_1 != (uint *)0x0) goto LAB_0010e2ad;
    }
    return 0;
  }
LAB_0010e2ad:
  uVar1 = set_cert_type(param_1 + 0x566,param_1 + 0x568,param_2,param_3);
  return uVar1;
}



undefined8 SSL_set1_server_cert_type(uint *param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  if (*param_1 != 0) {
    if ((*param_1 & 0x80) != 0) {
      param_1 = (uint *)ossl_quic_obj_get0_handshake_layer();
      if (param_1 != (uint *)0x0) goto LAB_0010e31d;
    }
    return 0;
  }
LAB_0010e31d:
  uVar1 = set_cert_type(param_1 + 0x56a,param_1 + 0x56c,param_2,param_3);
  return uVar1;
}



void SSL_CTX_set1_client_cert_type(long param_1,undefined8 param_2,undefined8 param_3)

{
  set_cert_type(param_1 + 0x6b0,param_1 + 0x6b8,param_2,param_3);
  return;
}



void SSL_CTX_set1_server_cert_type(long param_1,undefined8 param_2,undefined8 param_3)

{
  set_cert_type(param_1 + 0x6c0,param_1 + 0x6c8,param_2,param_3);
  return;
}
...
LAB_0010e3ad:
      *param_2 = *(undefined8 *)(param_1 + 0x566);
      *param_3 = *(undefined8 *)(param_1 + 0x568);
      return 1;
           ...
           (param_1 = (uint *)ossl_quic_obj_get0_handshake_layer(),
           param_2 != (undefined8 *)0x0 && param_3 != (undefined8 *)0x0)) &&
          (param_1 != (uint *)0x0)) goto LAB_0010e3ad;
  return 0;
}
...

{
  ...
  if (*param_1 == 0) {
    if ((param_2 != (undefined8 *)0x0) && (param_3 != (undefined8 *)0x0)) {
LAB_0010e43d:
      *param_2 = *(undefined8 *)(param_1 + 0x56a);
      *param_3 = *(undefined8 *)(param_1 + 0x56c);
      return 1;
           ...
           (param_1 = (uint *)ossl_quic_obj_get0_handshake_layer(),
           param_2 != (undefined8 *)0x0 && param_3 != (undefined8 *)0x0)) &&
          (param_1 != (uint *)0x0)) goto LAB_0010e43d;
  return 0;
}
...
void SSL_set_accept_state_cold(void)
...
void SSL_set_connect_state_cold(void)

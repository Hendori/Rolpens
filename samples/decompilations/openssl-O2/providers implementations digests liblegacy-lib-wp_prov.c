...
undefined8
wp_internal_final(WHIRLPOOL_CTX *param_1,uchar *param_2,undefined8 *param_3,ulong param_4)

{
  int iVar1;
  
  iVar1 = ossl_prov_is_running();
  if (((0x3f < param_4) && (iVar1 != 0)) && (iVar1 = WHIRLPOOL_Final(param_2,param_1), iVar1 != 0))
  {
    *param_3 = 0x40;
    return 1;
  }

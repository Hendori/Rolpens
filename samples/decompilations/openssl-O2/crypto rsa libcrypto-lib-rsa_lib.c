...

{
  ...
  if (param_2 == -1) {
    iVar1 = EVP_PKEY_CTX_is_a(param_1,&_LC1);
    if (iVar1 == 0) {
      iVar1 = EVP_PKEY_CTX_is_a(param_1,"RSA-PSS");
      goto joined_r0x00100175;
    }
  }
  else {
...

{
  ...
  *(uint *)((long)&r->mt_blinding + 4) = pRVar3->flags & 0xfffffbff;
  if (param_1 == (BIGNUM *)0x0) {
    ...
    r->n = param_1;
    if (param_1 != (BIGNUM *)0x0) goto LAB_00100547;
...
LAB_00100547:
      ...
      r->engine = (ENGINE *)pRVar3;
      if (pRVar3 != (RSA_METHOD *)0x0) goto LAB_0010055c;
      ERR_new();
      uVar4 = 0x6f;
    }
...

{
  ...
  if (param_1 < 0x1801) {
    uVar6 = 0x80;
    if ((((param_1 == 0xc00) || (uVar6 = 0x98, param_1 == 0x1000)) ||
        (uVar6 = 0x70, param_1 == 0x800)) || (uVar6 = 0, param_1 < 8)) {
      return uVar6;
    }
...
LAB_0010091e:
  ...
  if (0 < iVar3) {
    ...
    if (iVar3 + 1 < iVar4) goto LAB_0010091e;
  }
  return 0;
}
...
LAB_00100a15:
    ...
    *(BIGNUM **)(param_1 + 0x28) = param_2;
    ...
    if (param_2 != (BIGNUM *)0x0) goto LAB_00100a15;
  }
  else {
    if (param_2 != (BIGNUM *)0x0) goto LAB_001009ec;
joined_r0x001009f8:
    if (param_3 == 0) goto LAB_00100998;
    param_2 = *(BIGNUM **)(param_1 + 0x30);
  }
  BN_free(param_2);
...
LAB_00100ab7:
    ...
    if (*(long *)(param_1 + 0x48) != 0) {
      if (param_2 != (BIGNUM *)0x0) goto LAB_00100a9c;
joined_r0x00100ab5:
      if (param_3 == 0) goto LAB_00100a6b;
      goto LAB_00100ab7;
    }
    if (param_3 == 0) {
      return 0;
    }
    if (param_2 != (BIGNUM *)0x0) goto LAB_00100ae5;
  }
...
undefined8 RSA_set0_crt_params(long param_1,long param_2,BIGNUM *param_3,long param_4)

{
  ...
  if (a == (BIGNUM *)0x0) {
    ...
    if (*(long *)(param_1 + 0x58) == 0) {
      ...
      if (*(long *)(param_1 + 0x60) != 0) goto LAB_00100bb3;
    }
    else if (*(long *)(param_1 + 0x60) != 0) goto LAB_00100c10;
    if (param_4 == 0) {
      return 0;
    }
    goto LAB_00100c10;
  ...
  if (*(BIGNUM **)(param_1 + 0x58) == (BIGNUM *)0x0) {
    ...
    if ((*(long *)(param_1 + 0x60) == 0) && (param_4 == 0)) {
      return 0;
    }
    a_00 = (BIGNUM *)0x0;
    if (param_2 != 0) {
...
LAB_00100bc9:
    ...
    *(BIGNUM **)(param_1 + 0x58) = param_3;
    BN_set_flags(param_3,4);
LAB_00100b59:
    if (param_4 == 0) goto LAB_00100b7b;
LAB_00100b5e:
    param_3 = *(BIGNUM **)(param_1 + 0x60);
  }
  else {
    if (*(long *)(param_1 + 0x60) != 0) {
      if (param_2 != 0) goto LAB_00100c10;
LAB_00100b54:
      if (param_3 != (BIGNUM *)0x0) goto LAB_00100bc9;
      goto LAB_00100b59;
    }
    if (param_4 == 0) {
      return 0;
  ...
  if ((((param_2 != 0) && (param_3 != 0)) && (param_4 != 0)) &&
    ...
    if (0 < param_5) {
      ...
      do {
        ...
        if (puVar6 == (undefined8 *)0x0) goto LAB_00100dd1;
        if (((*(long *)(param_2 + lVar7) == 0) || (*(long *)(param_3 + lVar7) == 0)) ||
           (*(long *)(param_4 + lVar7) == 0)) {
...
LAB_00100fd0:
          ...
          *(undefined8 *)(param_2 + uVar4 * 8) = *(undefined8 *)(lVar3 + 8);
          if (param_3 != 0) goto LAB_00100fd0;
        }
        uVar4 = uVar4 + 1;
...

{
  ...
  if ((((param_1 != (EVP_PKEY_CTX *)0x0) && (*(int **)(param_1 + 0x78) != (int *)0x0)) &&
      (iVar1 = **(int **)(param_1 + 0x78), iVar1 != 0x390)) && (iVar1 != 6)) {
    return -1;
  }
      ...
      if (iVar2 != 2) {
        ...
        do {
          ...
          if (((lVar7 == 0 || lVar8 == 0) || (lVar9 == 0)) ||
             (plVar10 = (long *)CRYPTO_zalloc(0x28,"crypto/rsa/rsa_lib.c",0x339),
             plVar10 == (long *)0x0)) goto LAB_00101273;
          *plVar10 = lVar7;
          plVar10[2] = lVar9;
          plVar10[1] = lVar8;
...
LAB_00101273:
          OPENSSL_sk_pop_free(lVar6,&ossl_rsa_multip_info_free_ex);
          return 0;
        }
      }
      if (lVar1 != 0) {
...
LAB_00101698:
    ...
    if (lVar6 == 0) {
      ...
      if (lVar6 != 0) {
LAB_0010159b:
        pBVar7 = (BIGNUM *)RSA_get0_d(param_1);
        iVar2 = BN_num_bits(pBVar7);
      }
      iVar9 = iVar1;
      if (iVar1 < iVar2) goto LAB_00101698;
    }
    for (iVar1 = 0; iVar2 = OPENSSL_sk_num(lVar4), iVar1 < iVar2; iVar1 = iVar1 + 1) {
      ...
      if (iVar9 < iVar2) goto LAB_00101698;
    }
...
void EVP_PKEY_CTX_set_rsa_pss_keygen_md_name
               (undefined8 param_1,undefined8 param_2,undefined8 param_3)

{
  int_set_rsa_md_name(param_1,0x390,4,"digest",param_2,"properties",param_3);
  return;
}
...
void EVP_PKEY_CTX_get_rsa_oaep_md_name(undefined8 param_1,undefined8 param_2,undefined8 param_3)

{
  int_get_rsa_md_name(param_1,6,0x600,"digest",param_2,param_3);
  return;
}
...
void EVP_PKEY_CTX_set_rsa_mgf1_md_name(undefined8 param_1,undefined8 param_2,undefined8 param_3)

{
  int_set_rsa_md_name(param_1,0xffffffff,0xc7f0,"mgf1-digest",param_2,"mgf1-properties",param_3);
  return;
}



void EVP_PKEY_CTX_get_rsa_mgf1_md_name(undefined8 param_1,undefined8 param_2,undefined8 param_3)

{
  int_get_rsa_md_name(param_1,0xffffffff,0xc7f0,"mgf1-digest",param_2,param_3);
  return;
}
...
void EVP_PKEY_CTX_set_rsa_pss_keygen_mgf1_md_name(undefined8 param_1,undefined8 param_2)

{
  int_set_rsa_md_name(param_1,0x390,4,"mgf1-digest",param_2,0,0);
  return;
}
...

{
  ...
  if ((param_1 == (uint *)0x0) || ((*param_1 & 0x600) == 0)) {
    ...
    if (iVar1 == 0) {
      ...
      if ((param_2 != (undefined *)0x0) || (puVar3 = &_LC8, param_3 != 0)) {
        puVar3 = param_2;
      }
...

{
  ...
  if ((param_1 == (uint *)0x0) || ((*param_1 & 0x600) == 0)) {
    ...
    if (iVar1 != 0) {
      ...
      if ((iVar1 != 0) && (uVar2 = local_58, local_58 < 0x80000000)) goto LAB_00101b9c;
    }
    uVar2 = 0xffffffff;
  }
LAB_00101b9c:

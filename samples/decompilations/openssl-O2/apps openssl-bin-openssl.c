...

{
  ...
  if (prog_inited_1 == 0) {
    ...
    ret_0 = OPENSSL_LH_set_thunks
                      (uVar3,0x100000,lh_FUNCTION_cfn_thunk,lh_FUNCTION_doall_thunk,
...
undefined8 help_main(undefined8 param_1,undefined8 param_2)

{
  ...
  uVar4 = opt_init(param_1,param_2,help_options);
  do {
    iVar3 = opt_next();
    if (iVar3 == 0) {
      iVar3 = opt_num_rest();
      ...
      if (iVar3 != 0) {
        ...
        BIO_printf(bio_err,"%s:\n\nStandard commands",uVar4);
        iVar6 = 0;
        piVar8 = (int *)&functions;
        if (_qsort == 0) goto LAB_001005b0;
        goto LAB_00100514;
      }
...
LAB_001004d7:
    ...
    BIO_printf(bio_err,"%-*s",(ulong)local_5c,*(undefined8 *)(piVar8 + 2));
    plVar1 = (long *)(piVar8 + 0xe);
    piVar8 = piVar8 + 0xc;
  } while (*plVar1 != 0);
LAB_001005b0:
  BIO_printf(bio_err,"\n\n");
...
/* WARNING: Removing unreachable block (ram,0x00100c71) */
...
LAB_0010099e:
    ...
    if (((pcVar6 != (char *)0x0) && (iVar1 = strcmp(pcVar6,"1"), iVar1 == 0)) &&
       (lVar4 = app_create_libctx(), lVar4 == 0)) goto LAB_0010099e;
    lVar4 = prog_init();
    if (lVar4 != 0) {
...
LAB_00100b01:
          ...
          if ((iVar1 != 1) && (!bVar7)) {
            if (bVar8) {
              opt_appname("version");
LAB_00100c15:
              iVar1 = do_cmd(lVar4,1,version_argv);
              goto LAB_001009d1;
            }
            goto LAB_00100b01;
          }
          opt_appname(&_LC21);
          if (bVar7) goto LAB_00100ad7;
          if (bVar8) goto LAB_00100c15;
        }
        param_2 = param_2 + 1;
      }
      else {
        *param_2 = uVar3;
        ...
        if (param_1 == 0) {
LAB_00100ad7:
          iVar1 = do_cmd(lVar4,1,help_argv);
          goto LAB_001009d1;
        }
      }
...
LAB_001009d1:
  CRYPTO_free(default_config_file);
  OPENSSL_LH_free();

...

{
  ...
  uVar15 = *(ulong *)(*(long *)(param_1 + 8) + 0x28);
  uVar14 = *(ulong *)(*(long *)(param_1 + 8) + 0x20);
  iVar5 = (int)uVar15;
  iVar3 = (int)uVar14;
  ...
  if (ptr == (void *)0x0) {
    ...
    local_50 = local_60;
    local_48 = local_70;
    iVar5 = ossl_ml_dsa_matrix_expand_A(param_2,*(undefined8 *)(param_1 + 0x10),param_1 + 0x20);
    if (iVar5 != 0) {
      ...
      if (local_70 != 0) {
        do {
          uVar14 = uVar15 + 1;
          ossl_ml_dsa_poly_ntt((void *)(uVar15 * 0x400 + (long)local_78));
          uVar15 = uVar14;
      ...
      if (local_60 != 0) {
        do {
          uVar14 = uVar15 + 1;
          ossl_ml_dsa_poly_ntt_inverse((void *)(uVar15 * 0x400 + (long)local_68));
          uVar15 = uVar14;
        ...
        if (local_60 != 0) {
          ...
          do {
            lVar9 = 0;
            do {
              uVar10 = *(int *)(lVar12 + lVar9) + *(int *)((long)pvVar11 + lVar9);
              uVar6 = (int)((uVar10 ^ 0x7fe001 | uVar10 - 0x7fe001 ^ 0x7fe001) ^ uVar10) >> 0x1f;
              *(uint *)((long)pvVar11 + lVar9) = uVar10 & uVar6 | uVar10 - 0x7fe001 & ~uVar6;
              lVar9 = lVar9 + 4;
            } while (lVar9 != 0x400);
            pvVar11 = (void *)((long)pvVar11 + 0x400);
            lVar12 = lVar12 + 0x400;
          } while ((void *)(local_60 * 0x400 + (long)local_68) != pvVar11);
          uVar15 = 0;
          do {
            pvVar11 = local_68;
            lVar12 = *param_4;
            ...
            do {
              lVar4 = lVar13 + lVar8;
              lVar1 = lVar12 + lVar8 + lVar13;
              lVar2 = lVar9 + lVar8 + lVar13;
              lVar13 = lVar13 + 4;
              ossl_ml_dsa_key_compress_power2_round
                        (*(undefined4 *)((long)pvVar11 + lVar4),lVar2,lVar1);
            } while (lVar13 != 0x400);
            uVar15 = uVar15 + 1;
...

{
  ...
  if (((ctx == (EVP_MD_CTX *)0x0) || (iVar3 = ossl_ml_dsa_key_pub_alloc(param_1), iVar3 == 0)) ||
     (iVar3 = ossl_ml_dsa_key_priv_alloc(param_1), iVar3 == 0)) {
LAB_0010057c:
    bVar4 = false;
  }
  else {
    ...
    if (((iVar3 != 1) || (iVar3 = EVP_DigestUpdate(ctx,&local_f8,0x22), iVar3 != 1)) ||
       (iVar3 = EVP_DigestSqueeze(ctx,&local_c8,0x80), iVar3 != 1)) goto LAB_0010057c;
    ...
    *(undefined8 *)(param_1 + 0x98) = uStack_50;
    iVar3 = ossl_ml_dsa_vector_expand_S
                      (ctx,*(undefined8 *)(param_1 + 0x18),*(undefined4 *)(lVar1 + 0x30),local_a8,
                       param_1 + 0xf0,param_1 + 0xe0);
    if (((iVar3 == 0) ||
        (iVar3 = public_from_private(param_1,ctx,param_1 + 0xc0,param_1 + 0xd0), iVar3 == 0)) ||
       (iVar3 = ossl_ml_dsa_pk_encode(param_1), iVar3 == 0)) goto LAB_0010057c;
    d = *(void **)(param_1 + 0xa0);
    cnt = *(size_t *)(*(long *)(param_1 + 8) + 0x48);
    iVar3 = EVP_DigestInit_ex2(ctx,*(undefined8 *)(param_1 + 0x18),0);
    if (((iVar3 != 1) || (iVar3 = EVP_DigestUpdate(ctx,d,cnt), iVar3 != 1)) ||
       (iVar3 = EVP_DigestSqueeze(ctx,param_1 + 0x40,0x40), iVar3 != 1)) goto LAB_0010057c;
...

{
  ...
  *(undefined8 *)(param_1 + 0xa0) = 0;
  if (*(long *)(param_1 + 0xa8) != 0) {
    CRYPTO_clear_free(*(long *)(param_1 + 0xa8),*(undefined8 *)(*(long *)(param_1 + 8) + 0x40),
                      "crypto/ml_dsa/ml_dsa_key.c",0xa4);
  }
...

{
  ...
  if ((param_1 == (undefined8 *)0x0) ||
     (((param_1[0x14] == 0 && ((param_1[0x15] != 0 || (param_1[0x16] != 0)))) ||
      (puVar14 = (undefined8 *)CRYPTO_zalloc(0x100,"crypto/ml_dsa/ml_dsa_key.c",0xbf),
  ...
  *(undefined4 *)(puVar14 + 0x17) = *(undefined4 *)(param_1 + 0x17);
  if ((param_2 & 3) != 0) {
    ...
    if (lVar16 != 0) {
      ...
      puVar14[0x14] = lVar15;
      if (lVar15 == 0) goto LAB_00100ca0;
    }
    if ((param_2 & 1) == 0) goto LAB_00100c50;
    lVar15 = param_1[0x15];
    if (lVar15 != 0) {
      uVar2 = param_1[0x11];
      uVar3 = param_1[0x12];
      ...
      if (lVar16 != 0) {
        ...
        if (iVar13 == 0) goto LAB_00100ca0;
        memcpy((void *)puVar14[0x1e],(void *)param_1[0x1e],param_1[0x1f] << 10);
        memcpy((void *)puVar14[0x1c],(void *)param_1[0x1c],param_1[0x1d] << 10);
        memcpy((void *)puVar14[0x1a],(void *)param_1[0x1a],param_1[0x1b] << 10);
        lVar15 = param_1[0x15];
      }
      lVar15 = CRYPTO_memdup(lVar15,*(undefined8 *)(param_1[1] + 0x40),"crypto/ml_dsa/ml_dsa_key.c",
                             0xdd);
      puVar14[0x15] = lVar15;
      if (lVar15 == 0) goto LAB_00100ca0;
    }
    if (param_1[0x16] != 0) {
      ...
      if (lVar15 == 0) {
LAB_00100ca0:
        ossl_ml_dsa_key_free(puVar14);
        return (undefined8 *)0x0;
      }
    }
  }
LAB_00100c50:
  EVP_MD_up_ref(param_1[2]);
...

{
  ...
  if ((lVar1 == *(long *)(param_2 + 8)) && (bVar3 = true, (param_3 & 3) != 0)) {
    if (((param_3 & 2) == 0) ||
       ((*(void **)(param_1 + 0xa0) == (void *)0x0 || (*(void **)(param_2 + 0xa0) == (void *)0x0))))
    {
      bVar3 = (bool)(param_3 & 1);
      if ((param_3 & 1) != 0) {
        if ((*(void **)(param_1 + 0xa8) == (void *)0x0) ||
           (*(void **)(param_2 + 0xa8) == (void *)0x0)) {
          bVar3 = false;
        }
        else {
          iVar2 = memcmp(*(void **)(param_1 + 0xa8),*(void **)(param_2 + 0xa8),
                         *(size_t *)(lVar1 + 0x40));
          bVar3 = iVar2 == 0;
        }
      }
...

{
  ...
  local_50 = lVar1;
  ctx = (EVP_MD_CTX *)EVP_MD_CTX_new();
  if ((((ctx == (EVP_MD_CTX *)0x0) || (iVar2 = ossl_ml_dsa_key_pub_alloc(param_1), iVar2 == 0)) ||
      (iVar2 = public_from_private(param_1,ctx,param_1 + 0xc0,&local_58), iVar2 == 0)) ||
...
LAB_00100dc5:
    ...
    if ((iVar2 != 1) || (iVar2 = EVP_DigestUpdate(ctx,pvVar3,cnt), iVar2 != 1)) goto LAB_00100dc5;
...

{
  ...
  if (((*(long *)(param_1 + 0xa0) == 0) || (*(long *)(param_1 + 0xa8) == 0)) ||
     (ptr = CRYPTO_malloc((int)uVar4 << 0xb,"crypto/ml_dsa/ml_dsa_key.c",0x17f), ptr == (void *)0x0)
     ) {
    uVar6 = 0;
    goto LAB_00100fea;
  }
...
LAB_00100fcb:
    ...
    if ((iVar1 == 0) || (uVar4 != *(ulong *)(param_1 + 200))) goto LAB_00100fcb;
    if (uVar4 == 0) {
      if (*(long *)(param_1 + 0xd8) != 0) goto LAB_00100fcb;
    }
    else {
      lVar5 = 0;
      do {
        iVar1 = CRYPTO_memcmp((void *)((long)ptr + lVar5),
                              (void *)(*(long *)(param_1 + 0xc0) + lVar5),0x400);
        if (iVar1 != 0) goto LAB_00100fcb;
        lVar5 = lVar5 + 0x400;
      } while (lVar3 != lVar5);
      if (uVar4 != *(ulong *)(param_1 + 0xd8)) goto LAB_00100fcb;
      lVar5 = 0;
      do {
        iVar1 = CRYPTO_memcmp((void *)(lVar3 + (long)ptr + lVar5),
                              (void *)(*(long *)(param_1 + 0xd0) + lVar5),0x400);
        uVar6 = 0;
        if (iVar1 != 0) goto LAB_00100fce;
        lVar5 = lVar5 + 0x400;
      } while (lVar3 != lVar5);
    }
    uVar6 = 1;

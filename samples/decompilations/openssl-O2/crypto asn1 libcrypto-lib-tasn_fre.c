...
LAB_00100349:
        ...
        if (pcVar6 != (code *)0x0) goto LAB_00100393;
      }
      goto LAB_001003a3;
    }
LAB_00100168:
...
LAB_00100171:
    *param_1 = 0;
    ...
    case '\x06':
      ...
      if (pcVar6 == (code *)0x0) goto LAB_00100326;
      uStack_50 = 0x1001da;
      ...
      ossl_asn1_enc_free(param_1,param_2);
      lVar7 = *(long *)(param_2 + 0x10) + *(long *)(param_2 + 0x18) * 0x28;
      if (0 < *(long *)(param_2 + 0x18)) goto LAB_00100349;
LAB_00100393:
      uStack_50 = 0x1003a3;
...
LAB_001003a3:
      ...
      goto LAB_00100171;
    case '\x02':
      if (pcVar6 == (code *)0x0) goto LAB_001003e0;
      uStack_50 = 0x100249;
      iVar2 = (*pcVar6)(2,param_1,param_2,0);
      if (iVar2 == 2) {
        return;

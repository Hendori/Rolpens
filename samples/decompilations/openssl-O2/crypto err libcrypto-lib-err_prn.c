...
LAB_001003df:
        if (uVar9 <= uVar12) {
          ...
          pvVar10 = (void *)CRYPTO_strndup(param_2,pcVar8 + (-(long)param_2 - sVar7),
...
LAB_00100478:
    if (param_2 != __haystack) {
      pvVar10 = (void *)CRYPTO_strndup(param_2,(long)__haystack - (long)param_2,

...

{
  ...
  if (0 < param_3) {
    ...
    do {
      iVar3 = *piVar12;
      if (param_3 == iVar3) {
        piVar12 = (int *)(&PTR__EC_SECG_PRIME_112R1_001056c8)[lVar11 * 4];
        pcVar2 = (code *)(&DAT_001056d0)[lVar11 * 4];
        if (piVar12 == (int *)0x0) {
          uVar7 = 0;
          if (pcVar2 != (code *)0x0) {
            uVar7 = (*pcVar2)();
...

{
  ...
  if ((r != (EC_builtin_curve *)0x0) && (nitems != 0)) {
    ...
    ppuVar1 = &PTR_s_SECG_WTLS_curve_over_a_112_bit_p_001056d8;
    pEVar2 = r;
    do {
      pEVar3 = pEVar2 + 1;
...

{
  ...
  if (__s1 != (void *)0x0) {
    ...
    do {
      ...
      *puVar10 = pBVar8;
      if (pBVar8 == (BIGNUM *)0x0) goto LAB_00100ab0;
      puVar10 = puVar10 + 1;
    ...
    if ((iVar6 != 0) && (pEVar9 = EC_GROUP_get0_generator(param_1), pEVar9 != (EC_POINT *)0x0)) {
      ...
      if (iVar6 != 0) {
        ...
        if (iVar6 != 0) {
          pvVar11 = __s1;
          do {
            iVar6 = BN_bn2binpad(*puVar14,pvVar11,iVar5);
            if (iVar6 < 1) goto LAB_00100ab0;
            puVar14 = puVar14 + 1;
          ...
          while( true ) {
            ...
            if ((((iVar3 == iVar4) && (*(int *)(lVar1 + 8) == iVar5)) &&
              ...
              if (((__n == 0) ||
                 ...
                 iVar6 == 0)) goto LAB_00100ab6;
            }
            if (piVar12 == (int *)0x1060e0) break;
            iVar6 = (*(int **)(piVar12 + 10))[1];
            iVar4 = **(int **)(piVar12 + 10);
            piVar12 = piVar12 + 8;
          }
          iVar13 = 0;
          goto LAB_00100ab6;

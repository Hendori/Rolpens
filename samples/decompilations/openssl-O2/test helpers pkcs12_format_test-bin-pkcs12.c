...
ulong check_p12_mac(PKCS12 *param_1,long param_2)

{
  ...
  uVar2 = test_true("test/helpers/pkcs12.c",0x108,"PKCS12_mac_present(p12)",iVar1 != 0);
  if ((int)uVar2 == 0) {
    return uVar2;
  }
  __s = *(char **)(param_2 + 8);
  sVar3 = strlen(__s);
  iVar1 = PKCS12_verify_mac(param_1,__s,(int)sVar3);
...

{
  ...
  if (legacy == 0) {
    ...
    iVar1 = test_ptr("test/helpers/pkcs12.c",0xd8,&_LC15,local_38);
...
LAB_00100590:
    ...
    BIO_free(param_1);
    iVar1 = test_ptr("test/helpers/pkcs12.c",0xdd,&_LC15,local_38);
    if (iVar1 != 0) {
      if (param_2 == 0) {
        ...
        iVar1 = check_p12_mac(local_38,param_2);
        pPVar2 = local_38;
      }
      local_38 = pPVar2;
      if (iVar1 != 0) goto LAB_001005e0;
    }
  }
...

{
  ...
  a = bp;
  if (bp != (BIO *)0x0) {
    a = (BIO *)d2i_PKCS12_bio(bp,(PKCS12 **)0x0);
    BIO_free(bp);
    iVar1 = test_ptr("test/helpers/pkcs12.c",0xf7,&_LC15,a);
    if (iVar1 != 0) {
      if (param_2 == 0) {
        iVar1 = PKCS12_mac_present(a);
        iVar1 = test_false("test/helpers/pkcs12.c",0xfa,"PKCS12_mac_present(p12)",iVar1 != 0);
      }
      else {
        iVar1 = check_p12_mac(a,param_2);
      }
      if (iVar1 != 0) {
        return a;
      }
...

{
  ...
  iVar1 = test_ptr("test/helpers/pkcs12.c",0x13b,&_LC17,p7);
  if (iVar1 != 0) {
    ...
    iVar1 = test_ptr("test/helpers/pkcs12.c",0x148,&_LC21,psVar3);
    if (iVar1 != 0) {
      return psVar3;
    }
  }
...
void generate_p12(undefined8 *param_1,int *param_2)

{
  ...
  pBVar3 = BIO_new(type);
  param_1[2] = pBVar3;
  iVar2 = test_ptr("test/helpers/pkcs12.c",0x9b,"pb->p12bio",pBVar3);
  if (iVar2 == 0) {
  ...
  iVar2 = test_ptr("test/helpers/pkcs12.c",0xa3,&_LC15);
  if (iVar2 == 0) {
    *(undefined4 *)(param_1 + 1) = 0;
    goto LAB_001008e1;
  }
  ...
  if (param_2 == (int *)0x0) {
    ...
    if (write_files == 0) goto LAB_001008e1;
    md_type = (EVP_MD *)0x0;
    bVar6 = false;
LAB_00100a5f:
    pBVar3 = BIO_new_file((char *)*param_1,"w");
    if (pBVar3 != (BIO *)0x0) {
      iVar2 = i2d_PKCS12_bio(pBVar3,p12);
    ...
    if (legacy == 0) {
      pcVar4 = OBJ_nid2sn(*param_2);
      md_type = (EVP_MD *)EVP_MD_fetch(test_ctx,pcVar4,uVar1);
    }
    else {
      pcVar4 = OBJ_nid2sn(*param_2);
      md_type = EVP_get_digestbyname(pcVar4);
    }
    pcVar4 = *(char **)(param_2 + 2);
    sVar5 = strlen(pcVar4);
    iVar2 = PKCS12_set_mac(p12,pcVar4,(int)sVar5,(uchar *)0x0,0,param_2[4],md_type);
    iVar2 = test_true("test/helpers/pkcs12.c",0xaf,
                      "PKCS12_set_mac(p12, mac->pass, strlen(mac->pass), NULL, 0, mac->iter, md)",
                      iVar2 != 0);
    bVar6 = md_type != (EVP_MD *)0x0;
    if (iVar2 == 0) {
      *(undefined4 *)(param_1 + 1) = 0;
    }
    else {
      i2d_PKCS12_bio((BIO *)param_1[2],p12);
      if (write_files != 0) goto LAB_00100a5f;
    }
  }
  if ((legacy == 0) && (bVar6)) {
    EVP_MD_free(md_type);
...

{
  ...
  iVar1 = test_ptr("test/helpers/pkcs12.c",0x6a,&_LC26,puVar2);
  if (iVar1 != 0) {
    *puVar2 = param_1;
...

{
  ...
  generate_p12(param_1,0);
  return;
}



void end_pkcs12_with_mac(long param_1)
...

{
  ...
  iVar1 = test_ptr("test/helpers/pkcs12.c",0x2a3,&_LC15,p12);
  if (iVar1 == 0) {
    *(undefined4 *)(param_1 + 8) = 0;
    return;
  }
...

{
  ...
  iVar1 = test_ptr("test/helpers/pkcs12.c",0x2b7,&_LC15,p12);
  if (iVar1 == 0) {
    *(undefined4 *)(param_1 + 8) = 0;
    return;
  }
...

{
  ...
  iVar1 = test_ptr("test/helpers/pkcs12.c",0x2cb,&_LC15,p12);
  if (iVar1 == 0) {
    *(undefined4 *)(param_1 + 1) = 0;
    return;
  }
...

{
  ...
  iVar1 = test_ptr("test/helpers/pkcs12.c",0x2df,&_LC15,p12);
  if (iVar1 == 0) {
    *(undefined4 *)(param_1 + 1) = 0;
    return;
  }

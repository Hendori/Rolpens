...

{
  ...
  if (param_1 < 0xf) {
    ...
    uVar1 = iVar3 + 0x7fe003;
    uVar4 = iVar3 + 2;
    uVar2 = (int)((uVar1 ^ 0x7fe001 | uVar4 ^ 0x7fe001) ^ uVar1) >> 0x1f;
    *param_2 = uVar1 & uVar2 | uVar4 & ~uVar2;
  }
  return param_1 < 0xf;
}
...
LAB_001002bc:
          ...
          iVar1 = 0;
          puVar5 = local_e8;
          while ((uVar2 = ((byte)puVar5[1] & 0x7f) << 0x10 | (uint)*puVar5,
                 *(uint *)(lVar6 + (long)iVar1 * 4) = uVar2, 0x7fe000 < uVar2 ||
                 (iVar1 = iVar1 + 1, iVar1 < 0x100))) {
            puVar5 = (ushort *)((long)puVar5 + 3);
            if ((puVar5 == (ushort *)local_40) &&
               (iVar3 = EVP_DigestSqueeze(param_1,local_e8,0xa8), puVar5 = local_e8, iVar3 == 0))
            goto LAB_001002bc;
          }
          uVar8 = uVar8 + 1;
          lVar6 = lVar7;
        } while (uVar8 < (ulong)param_4[2]);
      }
      local_128 = local_128 + 1;
    } while (local_128 < (ulong)param_4[1]);
  }
  uVar4 = 1;
LAB_001002be:
  if (local_40[0] != *(long *)(in_FS_OFFSET + 0x28)) {

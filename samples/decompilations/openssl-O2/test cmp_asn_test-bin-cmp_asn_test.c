...
undefined8 execute_CMP_ASN1_OCTET_STRING_set1_test(long param_1)

{
  ...
  uVar1 = ossl_cmp_asn1_octet_string_set1(param_1 + 0x18,*(undefined8 *)(param_1 + 0x10));
  uVar3 = test_int_eq("test/cmp_asn_test.c",0x52,"fixture->expected",
                      "ossl_cmp_asn1_octet_string_set1(&fixture->tgt_string, fixture->src_string)",
                      *(undefined4 *)(param_1 + 8),uVar1);
  if (((int)uVar3 != 0) && (uVar3 = 1, *(int *)(param_1 + 8) != 0)) {
    iVar2 = ASN1_OCTET_STRING_cmp
                      (*(ASN1_OCTET_STRING **)(param_1 + 0x18),
                       *(ASN1_OCTET_STRING **)(param_1 + 0x10));
    uVar3 = test_int_eq("test/cmp_asn_test.c",0x57,&_LC4,
                        "ASN1_OCTET_STRING_cmp(fixture->tgt_string, fixture->src_string)",0,iVar2);
    return uVar3;
  }
  return uVar3;
}
...
undefined4 test_ASN1_OCTET_STRING_set(void)
    ...
    if (iVar1 != 0) {
      ...
      if (iVar1 != 0) {
        ...
        iVar1 = test_true("test/cmp_asn_test.c",0x62,
                          ...
                          ,iVar1 != 0);
        if (iVar1 != 0) {
          uVar2 = execute_CMP_ASN1_OCTET_STRING_set1_test(ptr);
...
undefined4 test_ASN1_OCTET_STRING_set_tgt_is_src(void)
...

{
  ...
  add_test("test_ASN1_OCTET_STRING_set",test_ASN1_OCTET_STRING_set);

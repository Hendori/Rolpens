...

{
  ...
  if ((*(long *)(param_1 + 0x10) != 0) &&
     (iVar1 = ossl_param_build_set_octet_string
                        (param_2,param_3,&_LC1,*(long *)(param_1 + 0x10),
                         *(undefined8 *)(param_1 + 0x18)), iVar1 == 0)) {
    return false;
  }
...

{
  ...
  if (((iVar1 != 0) && (param_1 != 0)) && ((param_2 & 1) != 0)) {
    ...
    if (lVar3 != 0) {
      iVar1 = key_to_params(param_1,lVar3,0);
...
void mac_get_params(undefined8 param_1,undefined8 param_2)

{
  key_to_params(param_1,0,param_2);
  return;
}
...
LAB_001003da:
    ...
    if (lVar2 != 0) {
      ...
      param_1[7] = pcVar3;
      if (pcVar3 == (char *)0x0) goto LAB_00100371;
    }
    if (*(int *)(param_1 + 8) != 0) {
...

{
  ...
  if (iVar1 != 0) {
    ...
    if (*(long *)(param_1 + 0x20) == 0) {
      ...
      if (a == (void *)0x0) goto LAB_001005bf;
    }
...

{
  ...
  if ((iVar1 != 0) &&
    ...
    *(undefined4 *)(ptr + 1) = param_2;
    iVar1 = cmac_gen_set_params(ptr,param_3);
    if (iVar1 != 0) {
      return ptr;
    }
    CRYPTO_secure_clear_free

...

{
  ...
  create_ssl_ctx_pair(0,uVar4,uVar3,0x301,0,&local_50,&local_58,uVar1,uVar8);
  iVar2 = test_true("test/recordlentest.c",0x68,
...
LAB_001002e6:
    iVar2 = create_ssl_objects(local_50,local_58,&local_40,&local_48,0,0);
    iVar2 = test_true("test/recordlentest.c",0x7a,
                      "create_ssl_objects(sctx, cctx, &serverssl, &clientssl, NULL, NULL)",
                      iVar2 != 0);
    if (iVar2 != 0) {
      pBVar5 = SSL_get_rbio(local_40);
LAB_00100335:
      iVar2 = create_ssl_connection(local_40,local_48,0);
      iVar2 = test_true("test/recordlentest.c",0x95,
                        "create_ssl_connection(serverssl, clientssl, SSL_ERROR_NONE)",iVar2 != 0);
      if (iVar2 != 0) {
        bVar10 = (param_1 - 3 & 0xfffffffd) == 0;
        if (bVar10) {
          lVar9 = lVar9 + 1;
        }
        param_1 = (uint)bVar10;
        iVar2 = write_record(pBVar5,lVar9,0x17,0x303);
        iVar2 = test_true("test/recordlentest.c",0xa3,
                          "write_record(serverbio, len, SSL3_RT_APPLICATION_DATA, recversion)",
                          iVar2 != 0);
        if (iVar2 != 0) {
          iVar2 = SSL_read_ex(local_40,&local_59,1,local_38);
          iVar2 = test_false("test/recordlentest.c",0xa7,
                             "SSL_read_ex(serverssl, &buf, sizeof(buf), &written)",iVar2 != 0);
          if (iVar2 != 0) {
            uVar6 = ERR_peek_error();
            bVar10 = false;
            if (((uVar6 & 0x80000000) == 0) && ((char)(uVar6 >> 0x17) == '\x14')) {
              bVar10 = ((uint)uVar6 & 0x7fffff) == 0x96;
            }
            uVar8 = 0xaa;
            pcVar7 = "fail_due_to_record_overflow(1)";
            goto LAB_001004aa;
          }
        }
      }
...
LAB_00100290:
    ...
    iVar2 = write_record(pBVar5,(ulong)(param_1 == 1) + 0x4000,0x16,0x301);
    iVar2 = test_true("test/recordlentest.c",0x87,
                      "write_record(serverbio, len, SSL3_RT_HANDSHAKE, TLS1_VERSION)",iVar2 != 0);
    if (iVar2 == 0) goto LAB_00100290;
    iVar2 = SSL_accept(local_40);
    iVar2 = test_int_le("test/recordlentest.c",0x8b,"SSL_accept(serverssl)",&_LC4,iVar2,0);
    if (iVar2 == 0) goto LAB_00100290;
    uVar6 = ERR_peek_error();
    bVar10 = false;
    if (((uVar6 & 0x80000000) == 0) && ((char)(uVar6 >> 0x17) == '\x14')) {
      bVar10 = ((uint)uVar6 & 0x7fffff) == 0x92;
    }
    uVar8 = 0x8f;
    pcVar7 = "fail_due_to_record_overflow(0)";
LAB_001004aa:
    iVar2 = test_int_eq("test/recordlentest.c",uVar8,pcVar7,"overf_expected",bVar10,param_1);
    bVar10 = iVar2 != 0;
  }
  SSL_free(local_40);
  SSL_free(local_48);

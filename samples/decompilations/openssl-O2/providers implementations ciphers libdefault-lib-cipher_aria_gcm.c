...
void aria128gcm_newctx(undefined8 param_1)

{
  aria_gcm_newctx(param_1,0x80);
  return;
}



void aria192gcm_newctx(undefined8 param_1)

{
  aria_gcm_newctx(param_1,0xc0);
  return;
}



void aria256gcm_newctx(undefined8 param_1)

{
  aria_gcm_newctx(param_1,0x100);
  return;
}

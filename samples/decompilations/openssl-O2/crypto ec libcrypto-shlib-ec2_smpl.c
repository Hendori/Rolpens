...
undefined8
ossl_ec_GF2m_simple_points_make_affine(long *param_1,long param_2,long param_3,undefined8 param_4)
...
bool ec_GF2m_simple_ladder_step
  ...
  if (((((iVar1 != 0) &&
      ...
      (((iVar1 = (**(code **)(*param_1 + 0x100))
                           (param_1,*(undefined8 *)(param_2 + 0x20),*(undefined8 *)(param_2 + 0x10),
                            param_5), iVar1 != 0 &&
        (iVar1 = BN_GF2m_add(*(undefined8 *)(param_3 + 0x20),*(undefined8 *)(param_2 + 0x18),
     ...
     ((iVar1 = BN_GF2m_add(*(undefined8 *)(param_3 + 0x10),*(undefined8 *)(param_3 + 0x10),
    ...
    iVar1 = BN_GF2m_add(*(undefined8 *)(param_2 + 0x10),*(undefined8 *)(param_2 + 0x18),
...

{
  ...
  if (iVar1 == 0) {
    ...
    if ((((iVar1 == 0) || (iVar1 = BN_GF2m_add(pBVar4,pBVar4,a_01), iVar1 == 0)) ||
        ...
        ) || (iVar1 = BN_GF2m_add(pBVar2,pBVar2,pBVar4), iVar1 == 0)) goto LAB_00100c58;
...
undefined8
ec_GF2m_simple_ladder_pre(long *param_1,long param_2,long param_3,long param_4,undefined8 param_5)
  ...
  if (iVar1 != 0) {
    do {
      ...
      if (iVar1 == 0) {
        ...
        uVar3 = 0x2ed;
LAB_00100ef4:
        ERR_set_debug("crypto/ec/ec2_smpl.c",uVar3,"ec_GF2m_simple_ladder_pre");
        ERR_set_error(0x10,0x80003,0);
        return 0;
      }
    ...
    if ((((iVar1 != 0) &&
         (iVar1 = (**(code **)(*param_1 + 0x100))
                            (param_1,*(undefined8 *)(param_2 + 0x10),*(undefined8 *)(param_2 + 0x20)
                             ,param_5), iVar1 != 0)) &&
        (iVar1 = BN_GF2m_add(*(undefined8 *)(param_2 + 0x10),*(undefined8 *)(param_2 + 0x10),
                             param_1[0xd]), iVar1 != 0)) &&
       ((iVar1 = (**(code **)(*param_1 + 0xf8))
                           (param_1,*(undefined8 *)(param_2 + 0x20),*(undefined8 *)(param_2 + 0x20),
...

{
  ...
  if (1 < param_4) {
LAB_001010f1:
    uVar2 = ossl_ec_wNAF_mul(param_1,param_2,param_3,param_4,param_5);
    return uVar2;
  }
  iVar1 = BN_is_zero(*(undefined8 *)(param_1 + 0x10));
  if (iVar1 != 0) goto LAB_001010f1;
  ...
  if (param_3 != 0) {
    ...
    if (param_3 != 0) goto LAB_00101147;
  }
  if ((param_4 & 1) == 0) {
LAB_00101147:
...

{
  ...
  if (iVar1 == 0) {
    ...
    if (uVar2 == 0) {
      ...
      uVar3 = BN_GF2m_add(*(undefined8 *)(param_2 + 0x18),*(undefined8 *)(param_2 + 0x10),

...

{
  ...
  if ((param_1 != 0) && (key = *(EC_KEY **)(param_1 + 0x20), key != (EC_KEY *)0x0)) {
    pEVar5 = EC_KEY_get0_group(key);
    if (pEVar5 != (EC_GROUP *)0x0) {
      lVar6 = OSSL_PARAM_BLD_new();
      if (lVar6 != 0) {
...
LAB_00100358:
          ...
          if (pEVar8 != (EC_POINT *)0x0) {
            ...
            if (lVar9 != 0) {
              uVar11 = 6;
              iVar1 = OSSL_PARAM_BLD_push_octet_string(lVar6,&_LC1,local_50,lVar9);
              if (iVar1 != 0) goto LAB_001002ad;
            }
            goto LAB_00100358;
          }
          uVar11 = 4;
LAB_001002ad:
          if (pBVar7 != (BIGNUM *)0x0) {
            ...
            if (0 < iVar1) {
              iVar1 = OSSL_PARAM_BLD_push_BN_pad(lVar6,&_LC2,pBVar7,(long)(iVar1 + 7 >> 3));
              if (iVar1 != 0) {
...

{
  ...
  if (param_4 == 2) {
    lVar6 = 0;
    local_60 = 0;
    local_68 = "ECDSA-Parameters";
LAB_0010052a:
    iVar1 = BIO_indent(param_1,param_3,0x80);
    if (iVar1 == 0) goto LAB_001005d0;
    uVar2 = EC_GROUP_order_bits(x);
    iVar1 = BIO_printf(param_1,"%s: (%d bit)\n",local_68,(ulong)uVar2);
    if (((iVar1 < 1) ||
        ((lVar6 != 0 &&
         ((iVar1 = BIO_printf(param_1,"%*spriv:\n",(ulong)param_3,&_LC8), iVar1 < 1 ||
          (iVar1 = ASN1_buf_print(param_1,local_50,lVar6,param_3 + 4), iVar1 == 0)))))) ||
       ((local_60 != 0 &&
        ((iVar1 = BIO_printf(param_1,"%*spub:\n",(ulong)param_3,&_LC8), iVar1 < 1 ||
         (iVar1 = ASN1_buf_print(param_1,local_48,local_60,param_3 + 4), iVar1 == 0))))))
    goto LAB_001005d0;
    uVar7 = 1;
...
LAB_00100690:
      ...
      if (param_4 == 0) {
        ...
        if ((pBVar5 != (BIGNUM *)0x0) && (lVar6 = EC_KEY_priv2buf(param_2,&local_50), lVar6 == 0))
        goto LAB_00100778;
    ...
    local_60 = EC_KEY_key2buf(param_2,pVar3,&local_48,0);
    if (local_60 != 0) goto LAB_00100690;
LAB_00100778:
    lVar6 = 0;
LAB_001005d0:
    ERR_new();
...
void eckey_priv_print(undefined8 param_1,long param_2,undefined8 param_3)

{
  do_EC_KEY_print(param_1,*(undefined8 *)(param_2 + 0x20),param_3,0);
  return;
}
...

{
  ...
  if (key == (EC_KEY *)0x0) {
    ...
    *(EC_KEY **)(param_1 + 0x20) = key;
    if (key == (EC_KEY *)0x0) goto LAB_0010087b;
  }

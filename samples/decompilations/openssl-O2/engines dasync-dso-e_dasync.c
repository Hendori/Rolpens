...
int dasync_cipher_ctrl_helper
              (undefined8 param_1,undefined4 param_2,int param_3,undefined8 *param_4,uint param_5,
              undefined8 param_6)

{
  ...
  puVar2 = (undefined8 *)EVP_CIPHER_CTX_get_cipher_data();
  if (puVar2 != (undefined8 *)0x0) {
    ...
    case 8:
      ...
      pvVar6 = memcpy(pvVar6,(void *)*puVar2,(long)iVar1);
      *puVar2 = pvVar6;
      break;
    default:
      goto LAB_001001b2;
    case 0x16:
      ...
      if (0x1f < *(uint *)(puVar2 + 0x39)) {
        return -1;
      }
      puVar3 = (undefined8 *)((ulong)*(uint *)(puVar2 + 0x39) * 0xd + 0x28 + (long)puVar2);
      *puVar3 = *param_4;
      *(undefined8 *)((long)puVar3 + 5) = *(undefined8 *)((long)param_4 + 5);
      *(int *)(puVar2 + 0x39) = *(int *)(puVar2 + 0x39) + 1;
      uVar7 = *(ushort *)((long)param_4 + 0xb) << 8 | *(ushort *)((long)param_4 + 0xb) >> 8;
      uVar8 = (uint)uVar7;
      iVar1 = EVP_CIPHER_CTX_is_encrypting(param_1);
      if (iVar1 != 0) {
        if (0x301 < (ushort)(*(ushort *)((long)param_4 + 9) << 8 |
    ...
    case 0x17:
      ...
      EVP_CIPHER_CTX_set_cipher_data(param_1,*puVar2);
      pEVar4 = EVP_aes_128_cbc_hmac_sha1();
      pcVar5 = (code *)EVP_CIPHER_meth_get_ctrl(pEVar4);
...
void dasync_aes128_cbc_hmac_sha1_ctrl
...

{
  ...
  dasync_cipher_ctrl_helper(param_1,param_2,param_3,param_4,1,pEVar1);
  return;
}
...

{
  ...
  plVar3 = (long *)EVP_CIPHER_CTX_get_cipher_data();
  lVar5 = *plVar3;
  if (lVar5 == 0) {
    iVar2 = EVP_CIPHER_impl_ctx_size(param_5);
    if (iVar2 == 0) {
      lVar5 = *plVar3;
    }
    else {
      iVar2 = EVP_CIPHER_impl_ctx_size(param_5);
      lVar5 = CRYPTO_zalloc((long)iVar2,"engines/e_dasync.c",0x2d4);
      *plVar3 = lVar5;
      if (lVar5 == 0) {
        return 0;
      }
  ...
  *(undefined4 *)(plVar3 + 0x39) = 0;
  EVP_CIPHER_CTX_set_cipher_data(param_1,lVar5);
  pcVar4 = (code *)EVP_CIPHER_meth_get_init(param_5);
  uVar1 = (*pcVar4)(param_1,param_2,param_3,param_4);
...
void dasync_aes128_cbc_hmac_sha1_init_key
               (undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined4 param_4)

{
  ...
  pEVar1 = EVP_aes_128_cbc_hmac_sha1();
  dasync_cipher_init_key_helper(param_1,param_2,param_3,param_4,pEVar1);
  return;
}



void dasync_aes256_ctr_ctrl
               (undefined8 param_1,undefined4 param_2,undefined4 param_3,undefined8 param_4)

{
  ...
  dasync_cipher_ctrl_helper(param_1,param_2,param_3,param_4,0,pEVar1);
  return;
}
...

{
  if (pctrl_11 == (code *)0x0) {
    EVP_PKEY_meth_get_ctrl(dasync_rsa_orig,&pctrl_11,0);
                    ...
                    /* WARNING: Could not recover jumptable at 0x001009c0. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  ...
  if (pdecrypt_init_9 == (code *)0x0) {
    ...
    if (pdecrypt_init_9 == (code *)0x0) {
      return 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00100a78. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  if (pencryptfn_8 == (code *)0x0) {
    EVP_PKEY_meth_get_encrypt(dasync_rsa_orig,0,&pencryptfn_8);
                    ...
                    /* WARNING: Could not recover jumptable at 0x00100ae2. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  ...
  if (pencrypt_init_7 == (code *)0x0) {
    ...
    if (pencrypt_init_7 == (code *)0x0) {
      return 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00100b38. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  if (pkeygen_6 != (code *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00100b98. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*pkeygen_6)(param_1,param_2);
    return;
  }
  EVP_PKEY_meth_get_keygen(dasync_rsa_orig,0,&pkeygen_6);
                    /* WARNING: Could not recover jumptable at 0x00100bc8. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*pkeygen_6)(param_1,param_2);
  return;
}
  ...
  if (pkeygen_init_5 == (code *)0x0) {
    ...
    if (pkeygen_init_5 == (code *)0x0) {
      return 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00100be8. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  ...
  if (pparamgen_init_3 == (code *)0x0) {
    ...
    if (pparamgen_init_3 == (code *)0x0) {
      return 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00100c98. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  EVP_PKEY_meth_get_cleanup(dasync_rsa_orig,&pcleanup_2);
                    /* WARNING: Could not recover jumptable at 0x00100d0e. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*pcleanup_2)(param_1);
  return;
}
...
{
  if (pinit_1 != (code *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00100d28. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*pinit_1)(param_1);
    return;
  }
  EVP_PKEY_meth_get_init(dasync_rsa_orig,&pinit_1);
                    /* WARNING: Could not recover jumptable at 0x00100d4e. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*pinit_1)(param_1);
  return;
}
  ...
  if (lVar3 != 0) {
    ...
    if ((iVar1 == 0) || (local_50 == (code *)0x0)) {
      ...
      if (iVar1 == 0) {
        ...
        if (local_40 == (int *)0x0) goto LAB_00101489;
...

{
  ...
  UNRECOVERED_JUMPTABLE = (code *)EVP_MD_meth_get_final(pEVar1);
                    /* WARNING: Could not recover jumptable at 0x001015ee. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  UNRECOVERED_JUMPTABLE = (code *)EVP_MD_meth_get_update(pEVar1);
                    /* WARNING: Could not recover jumptable at 0x00101620. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  UNRECOVERED_JUMPTABLE = (code *)EVP_MD_meth_get_init(pEVar1);
                    /* WARNING: Could not recover jumptable at 0x0010164e. Too many branches */
                    /* WARNING: Treating indirect jump as call */

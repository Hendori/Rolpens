...
bool ossl_store_register_init(void)

{
  undefined8 uVar1;
  
  if (loader_register != 0) {
    return loader_register != 0;
  }
...

{
  ...
  if (iVar1 == 0) {
    ...
    if (*pcVar5 == '\0') goto LAB_00100286;
    iVar1 = ossl_ctype_check((int)*pcVar5,3);
    if (iVar1 == 0) goto LAB_0010039f;
    do {
      do {
        do {
          pcVar3 = pcVar5 + 1;
          pcVar5 = pcVar5 + 1;
          if (*pcVar3 == '\0') goto LAB_00100286;
...
LAB_00100286:
  if ((((param_1[2] == 0) || (param_1[7] == 0)) || (param_1[8] == 0)) ||
    ...
    if ((iVar1 == 0) || (do_registry_init_ossl_ret_ == 0)) {
      ...
      if (iVar1 != 0) {
        uVar2 = ossl_store_register_init();
        if (uVar2 != 0) {
          uVar2 = 1;

...
void lh_QUIC_STREAM_doall_arg_thunk
...

{
  ...
  uVar3 = OPENSSL_LH_set_thunks
                    (uVar2,0x100000,lh_QUIC_STREAM_cfn_thunk,lh_QUIC_STREAM_doall_thunk,
...
bool ossl_quic_stream_map_is_local_allowed_by_stream_limit
...

{
  ...
  if (*(uint *)(param_1 + 0x88) == ((byte)param_2[0x10][0] & 1)) {
    iVar4 = ossl_quic_stream_map_is_local_allowed_by_stream_limit
                      (param_1,*(ulong *)(param_2[3] + 8) >> 2,(byte)param_2[0x10][0] >> 1 & 1);
  }
  if ((param_2[0x10][1] == '\x03') &&
     (iVar5 = ossl_quic_sstream_is_totally_acked(*(undefined8 *)param_2[7]), iVar5 != 0)) {
    ...
    if ((*(ulong *)param_2[0x10] & 0x800000ff00) == 0x8000000200) {
      ...
      bVar2 = param_2[0x10][4];
      if ((iVar5 == 0) || (-1 < (char)bVar2)) goto LAB_001005da;
...
LAB_001005da:
  if ((bVar2 & 0x40) == 0) {
    ...
    *(long *)(param_2[2] + 8) = param_1 + 0x28;
    if ((iVar4 == 0) || (uVar3 = (uint)(byte)param_2[0x10][4], (param_2[0x10][4] & 0x40) != 0))
    goto LAB_00100688;
LAB_00100631:
    if ((param_2[0x10][2] == '\x01') &&
       (((uVar3 & 2) != 0 || (iVar4 = ossl_quic_rxfc_has_cwm_changed(param_2 + 10,0), iVar4 != 0))))
    {
LAB_00100646:
      bVar2 = param_2[0x10][3];
LAB_00100650:
      if ((bVar2 & 1) == 0) {
    ...
    bVar2 = param_2[0x10][3];
    if ((param_2[0x10][4] & 0xc) != 0) goto LAB_00100650;
    if (((bVar2 & 8) == 0) && ((byte)param_2[0x10][1] - 1 < 3)) {
      local_90 = 2;
      iVar4 = ossl_quic_sstream_get_stream_frame
                        (*(undefined8 *)param_2[7],0,local_88,local_58,&local_90);
      if (iVar4 != 0) {
        lVar6 = ossl_quic_txfc_get_credit(param_2 + 8,0);
        lVar7 = ossl_quic_txfc_get_swm(param_2 + 8);
        if ((((local_68 & 2) != 0) && (local_78 == 0)) || (local_80 < (ulong)(lVar6 + lVar7)))
        goto LAB_00100646;
      }
      goto LAB_00100688;
    }
...
LAB_00100688:
  ...
  if ((bVar2 & 1) == 0) goto LAB_001006b9;
  pauVar1 = *(undefined1 (**) [16])(*param_2 + 8);
  if (param_2 == *(undefined1 (**) [16])(param_1 + 0x60)) {
    pauVar9 = pauVar1;
    if ((pauVar1 == (undefined1 (*) [16])(param_1 + 8)) &&
       (pauVar9 = *(undefined1 (**) [16])(*pauVar1 + 8), pauVar9 == pauVar1)) {
...
bool ossl_quic_stream_map_notify_reset_recv_part
...
LAB_00100b3e:
    ...
    if (bVar1 - 2 < 5) {
      ...
      if ((iVar3 != 0) && (local_28 != param_4)) goto LAB_00100b3e;
    }
...
undefined8
ossl_quic_stream_map_stop_sending_recv_part(undefined8 param_1,long param_2,undefined8 param_3)
...

{
  ...
  lVar2 = lVar1;
  if ((lVar1 == param_1 + 0x18) && (lVar2 = *(long *)(lVar1 + 8), lVar1 == lVar2)) {
    return 0;
  }
  return lVar2 + -0x10;
}
...

{
  ...
  *param_1 = param_2;
  ...
  if (((param_3 != 0) && (lVar2 != 0)) &&
     (uVar1 = *(long *)(param_2 + 0x40) + 1, *(ulong *)(param_2 + 0x40) = uVar1,

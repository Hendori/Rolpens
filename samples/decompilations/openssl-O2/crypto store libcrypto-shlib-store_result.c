...
long try_key_value_legacy_constprop_0_isra_0
               (uchar *param_1,long param_2,undefined8 *param_3,long param_4,undefined8 param_5,
...

{
  ...
  if (a != (X509_SIG *)0x0) {
    ...
    if (iVar1 == 0) {
      ...
      PKCS12_pbe_crypt(local_458,local_448,(int)local_460,*(uchar **)(local_450 + 2),*local_450,
                       &local_468,&local_474,0);
...
undefined4 try_pkcs12_isra_0(int *param_1,undefined8 *param_2,long param_3)

{
  ...
  if (p12 == (PKCS12 *)0x0) {
    ...
    *param_1 = -1;
    ...
    uVar7 = 0;
    if ((iVar1 == 0) || (iVar1 = PKCS12_verify_mac(p12,(char *)0x0,0), iVar1 != 0)) {
      pcVar6 = (char *)0x0;
LAB_00100331:
      iVar1 = PKCS12_parse(p12,pcVar6,&local_4b0,&local_4a8,&local_4a0);
      if (iVar1 != 0) {
...
LAB_0010050c:
            if (local_4a8 != (X509 *)0x0) {
              lVar4 = OSSL_STORE_INFO_new_CERT();
              if (lVar4 == 0) goto LAB_001005f0;
              local_4a8 = (X509 *)0x0;
              iVar1 = OPENSSL_sk_push(lVar3,lVar4);
              if (iVar1 == 0) goto LAB_001005f2;
            }
            local_4c8 = 0;
            do {
              iVar1 = OPENSSL_sk_num(local_4a0);
              if (iVar1 < 1) goto LAB_001005b1;
              uVar2 = OPENSSL_sk_value(local_4a0,0);
              lVar5 = OSSL_STORE_INFO_new_CERT(uVar2);
              if (lVar5 == 0) goto LAB_00100658;
              lVar4 = OPENSSL_sk_shift(local_4a0);
            } while ((lVar4 != 0) && (iVar1 = OPENSSL_sk_push(lVar3), iVar1 != 0));
            lVar4 = 0;
          }
          else {
            local_4c8 = OSSL_STORE_INFO_new_PKEY();
            if (local_4c8 == 0) {
LAB_001005f0:
              lVar4 = 0;
LAB_001005f2:
...
LAB_00100658:
      ...
      if (iVar1 == 0) {
        ...
        pcVar6 = "maybe wrong password";
        if (local_4b8 == 0) {
          pcVar6 = "empty password";
        }
        ERR_set_error(0x2c,0x71,pcVar6);
      }
    }
    local_4d0 = local_448;
...
/* WARNING: Removing unreachable block (ram,0x00100e18) */

bool ossl_store_handle_load_result(undefined8 param_1,long *param_2)

{
  ...
  if ((((((lVar6 == 0) || (iVar2 = OSSL_PARAM_get_int(lVar6,local_98), iVar2 != 0)) &&
        ((lVar6 = OSSL_PARAM_locate_const(param_1,"data-type"), lVar6 == 0 ||
         (iVar2 = OSSL_PARAM_get_utf8_string_ptr(lVar6,local_98 + 8), iVar2 != 0)))) &&
       ((((lVar6 = OSSL_PARAM_locate_const(param_1,&_LC9), lVar6 == 0 ||
          (iVar2 = OSSL_PARAM_get_octet_string_ptr(lVar6,local_78 + 8,local_68), iVar2 != 0)) ||
         (iVar2 = OSSL_PARAM_get_utf8_string_ptr(lVar6,local_78), iVar2 != 0)) &&
        ((lVar6 = OSSL_PARAM_locate_const(param_1,"data-structure"), lVar6 == 0 ||
         (iVar2 = OSSL_PARAM_get_utf8_string_ptr(lVar6,local_88 + 8), iVar2 != 0)))))) &&
      ((lVar6 = OSSL_PARAM_locate_const(param_1,"input-type"), lVar6 == 0 ||
       (iVar2 = OSSL_PARAM_get_utf8_string_ptr(lVar6,local_88), iVar2 != 0)))) &&
     (((lVar6 = OSSL_PARAM_locate_const(param_1,"reference"), lVar6 == 0 ||
       (iVar2 = OSSL_PARAM_get_octet_string_ptr(lVar6,local_68 + 8,local_58), iVar2 != 0)) &&
      ((lVar6 = OSSL_PARAM_locate_const(param_1,&_LC13), lVar6 == 0 ||
       (iVar2 = OSSL_PARAM_get_utf8_string_ptr(lVar6,local_58 + 8), iVar2 != 0)))))) {
    ERR_set_mark();
    if ((*param_2 == 0) && (local_98._0_4_ == 1)) {
      if (local_78 != (undefined1  [8])0x0) {
        ptr = CRYPTO_strdup((char *)local_78,"crypto/store/store_result.c",0xac);
        if ((ptr == (char *)0x0) ||
           ((ptr_00 = (char *)local_58._8_8_, (char *)local_58._8_8_ != (char *)0x0 &&
            (ptr_00 = CRYPTO_strdup((char *)local_58._8_8_,"crypto/store/store_result.c",0xae),
            ptr_00 == (char *)0x0)))) {
          ptr_00 = (char *)0x0;
        }
        else {
...
LAB_00100ccf:
          ...
          if (iVar2 == 3) {
            iVar2 = 0x86;
LAB_00100a67:
            uVar8 = OSSL_DECODER_CTX_new_for_pkey
                              (&local_c8,local_88._0_8_,local_88._8_8_,local_98._8_8_,iVar2,uVar5,
                               uVar1);
            ...
            pkey = local_c8;
LAB_00100ae5:
            iVar3 = evp_keymgmt_util_has(pkey,1);
            if (iVar3 == 0) {
...
LAB_00100c99:
            pkey = (EVP_PKEY *)
                   try_key_value_legacy_constprop_0_isra_0
                             (puStack_70,local_68._0_8_,&local_d0,lVar7,lVar7 + 0x48,uVar5);
      ...
      if (local_98._8_8_ != 0) {
        ...
        if (pXVar11 != (X509 *)0x0) {
          ...
          while( true ) {
            ...
            local_b8 = pXVar11;
            if ((pcVar9 != (code *)0x0) &&
               ((*pcVar9)(*(undefined8 *)(lVar7 + 0x10),local_68._8_8_,local_58._0_8_,
                          &evp_keymgmt_util_try_import,&local_b8), lVar6 = local_b0, local_b0 != 0))
            goto LAB_00100e9c;
...
LAB_00100880:
      ...
      if (local_98._8_8_ == 0) {
        ...
        if (pXVar10 == (X509 *)0x0) {
LAB_00100e48:
          pXVar10 = d2i_X509(&local_b8,(uchar **)(local_78 + 8),local_68._0_8_);
...
LAB_00100895:
      ...
      ERR_pop_to_mark();
      ERR_set_mark();
      if ((*param_2 != 0) || (iVar2 = try_pkcs12_isra_0(local_98,param_2,lVar7), iVar2 != 0)) {
        ERR_pop_to_mark();
        lVar7 = *param_2;
        if (lVar7 == 0) {
          ERR_new();

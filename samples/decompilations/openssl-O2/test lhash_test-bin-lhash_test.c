    ...
    if (bVar10 == 3) {
      ...
      if (iVar6 == 1) {
        *(undefined4 *)(&test_mt_entries + uVar12) = 0;
        CRYPTO_atomic_add(uVar12 * 8 + 0x101a04,1,local_a0,uVar2);
      }
      iVar5 = ossl_ht_delete(m_ht,&local_88);
      if (iVar5 != iVar6) {
        test_info("test/lhash_test.c",0x275,
...
LAB_00100309:
      ...
      if ((bVar4 & 3) != 0) {
        ...
        if (uVar7 != uVar13) {
          ...
          test_info("test/lhash_test.c",0x259,
                    "Iteration %d Expected rc %d on %s of element %u which is %s\n",local_9c,uVar13,
                    pcVar11,uVar12,pcVar8);
      ...
      if (((local_68 == (undefined8 *)0x0) ||
          (local_98 = (undefined8 *)ossl_rcu_uptr_deref(&local_68), local_98 == (undefined8 *)0x0))
         || ((undefined8 *)local_98[1] != &mt_TEST_MT_ENTRY_id)) {
        ...
        if ((local_98 != (undefined8 *)0x0) && (&test_mt_entries + uVar12 != local_98)) {
          ...
          test_info("test/lhash_test.c",0x244,
                    "Iteration %d Read unexpected value %p when %p expected",local_9c);
        }
      }
      ossl_ht_read_unlock(m_ht);
      lVar1 = (&worker_exits)[local_a4];
    }
    if ((lVar1 != 0) || (lVar14 = lVar14 + -1, lVar14 == 0)) goto LAB_001005b0;
  } while( true );
}
...
LAB_00100787:
    ...
    iVar1 = test_ptr("test/lhash_test.c",0x2a0,"testrand_lock = CRYPTO_THREAD_lock_new()",
                     testrand_lock);
  ...
  if (iVar1 != 0) {
    ...
    do {
      ...
      *piVar5 = iVar3;
      ...
      iVar3 = test_int_eq("test/lhash_test.c",0x1bb,
                          "ossl_ht_test_int_insert(h, TO_HT_KEY(&key), p, NULL)",&_LC23,uVar2,1);
      if (iVar3 == 0) {
    ...
    if (iVar1 != 0) {
      uVar9 = 4;
      do {
        iVar1 = (uVar9 % 2500000) * 3 + 1;
        local_98[0] = CONCAT44(local_98[0]._4_4_,iVar1);
        if (param_1 == 0) {
          uVar2 = ossl_ht_delete(uVar4,&local_a8);
          iVar3 = test_int_eq("test/lhash_test.c",0x1cd,"(ossl_ht_delete(h, TO_HT_KEY(&key)))",
                              &_LC23,uVar2,1);
          if (iVar3 == 0) {
...
LAB_00100c18:
            ...
            if ((puVar6 == (undefined8 *)0x0) || ((undefined8 *)puVar6[1] != &test_int_id))
            goto LAB_00100c18;
            puVar8 = (undefined4 *)*puVar6;
          }
          iVar3 = test_ptr("test/lhash_test.c",0x1d3,
                           "p = ossl_ht_test_int_get(h, TO_HT_KEY(&key), &v)",puVar8);
          if (iVar3 != 0) {
            iVar3 = test_int_eq("test/lhash_test.c",0x1d4,&_LC33,&_LC32,*puVar8,iVar1);
            if (iVar3 != 0) goto LAB_00100b84;
          }
          test_info("test/lhash_test.c",0x1d5,"hashtable didn\'t get key %d\n",iVar1);
          goto LAB_00100956;
        }
LAB_00100b84:
        uVar9 = uVar9 + 7;
      } while (uVar9 != 0x10b0764);
      uVar7 = 1;
      goto LAB_00100958;
    }
  }
...

{
  ...
  uVar4 = OPENSSL_LH_set_thunks
                    (uVar4,0x100000,lh_int_cfn_thunk,lh_int_doall_thunk,lh_int_doall_arg_thunk);
  ...
  if (iVar1 != 0) {
    ...
    iVar1 = test_int_eq("test/lhash_test.c",0x70,"(size_t)lh_int_num_items(h)","n_int_tests",uVar2,
                        0x15);
    if (iVar1 != 0) {
      puVar10 = &int_tests;
      iVar1 = 0;
      do {
        ...
        iVar3 = test_int_eq("test/lhash_test.c",0x75,"*lh_int_retrieve(h, int_tests + i)",
                            "int_tests[i]",*puVar6,uVar2);
        if (iVar3 == 0) {
      ...
      do {
        ...
        iVar1 = test_ptr_eq("test/lhash_test.c",0x7a,"lh_int_retrieve(h, int_tests + i)",
                            "int_tests + i",uVar5,&int_tests + uVar9);
        if (iVar1 == 0) {
      ...
      iVar1 = test_ptr_eq("test/lhash_test.c",0x7f,"lh_int_retrieve(h, &j)","int_tests + 2",uVar5,
                          &DAT_001018e8);
      if (iVar1 != 0) {
        local_44 = 0xd;
        ...
        if (iVar1 != 0) {
          iVar1 = test_ptr_eq("test/lhash_test.c",0x86,&_LC21,"int_tests + 1",uVar5,&DAT_001018e4);
          if (iVar1 != 0) {
            uVar5 = OPENSSL_LH_retrieve(uVar4,&DAT_001018e4);
            iVar1 = test_ptr_eq("test/lhash_test.c",0x88,"lh_int_retrieve(h, int_tests + 1)",&_LC48,
                                uVar5,&local_44);
            if (iVar1 != 0) {
              _DAT_00102230 = SUB1610((undefined1  [16])0x0,0);
              uVar9 = 0;
              int_not_found = 0;
              _int_found = (undefined1  [16])0x0;
              _DAT_0010223a = 0;
              Ram0000000000102240 = SUB1610((undefined1  [16])0x0,6);
              OPENSSL_LH_doall(uVar4,int_doall);
              iVar1 = test_int_eq("test/lhash_test.c",0x8f,"int_not_found",&_LC50,(int)int_not_found
                                  ,0);
              if (iVar1 == 0) {
                test_info("test/lhash_test.c",0x90,
                          "lhash int doall encountered a not found condition");
              }
              else {
                do {
                  iVar1 = test_int_eq("test/lhash_test.c",0x94,"int_found[i]",&_LC23,
                                      (int)(short)(&int_found)[uVar9],1);
                  if (iVar1 == 0) {
                ...
                iVar1 = test_int_eq("test/lhash_test.c",0x9d,"int_not_found",&_LC50,
                                    (int)int_not_found,0);
                uVar9 = 0;
                if (iVar1 != 0) {
                  do {
                    iVar1 = test_int_eq("test/lhash_test.c",0xa2,"int_found[i]",&_LC23,
                                        (int)(short)(&int_found)[uVar9],1);
                    if (iVar1 == 0) {
                  ...
                  do {
                    ...
                    iVar3 = test_int_eq("test/lhash_test.c",0xaa,"b ^ dels[i].null",&_LC50,
                                        (uint)(lVar7 == 0) ^ *(uint *)(puVar11 + 4),0);
                    if (iVar3 == 0) {
                ...
                test_info("test/lhash_test.c",0x9e,
...
{
                    /* WARNING: Could not recover jumptable at 0x001011a4. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*UNRECOVERED_JUMPTABLE)();
  return;
}
  ...
  if (iVar1 != 0) {
    ...
    if (iVar1 != 0) {
      ...
      do {
        ...
        iVar2 = test_int_eq("test/lhash_test.c",0x17b,&_LC33,&_LC32,*ptr,local_44);
        if (iVar2 == 0) {
...
undefined8 test_int_hashtable(void)

{
  ...
  do {
    ...
    iVar2 = test_int_eq("test/lhash_test.c",0xfc,
                        "ossl_ht_test_int_insert(ht, TO_HT_KEY(&key), &int_tests[i], NULL)",&_LC23,
                        uVar1,1);
    if (iVar2 == 0) {
...
LAB_001015c2:
    ...
    do {
      iVar2 = test_int_eq("test/lhash_test.c",0x111,"int_found[i]",&_LC23,
                          (int)(short)(&int_found)[lVar7],1);
      if (iVar2 == 0) {
    ...
    iVar2 = test_int_eq("test/lhash_test.c",0x118,"(size_t)list->list_len","n_int_tests",*puVar6,
                        0x15);
    if (iVar2 == 0) goto LAB_001015c2;
    puVar8 = &dels_1;
    ...
    do {
      ...
      puVar8 = puVar8 + 2;
    } while ((NoteGnuProperty_4 *)puVar8 != &NoteGnuProperty_4_00102ab0);
    uVar5 = 1;
  }
  ossl_ht_free(lVar4);
LAB_001015cc:

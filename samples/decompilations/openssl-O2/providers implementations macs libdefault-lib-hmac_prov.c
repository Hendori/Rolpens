...
int hmac_init(long param_1,long param_2,undefined8 param_3)

{
  ...
  iVar1 = ossl_prov_is_running();
  if (iVar1 != 0) {
    iVar1 = hmac_set_ctx_params(param_1);
    if (iVar1 != 0) {
      if (param_2 != 0) {
        iVar1 = hmac_setkey(param_1,param_2,param_3);
        return iVar1;
      }
      iVar1 = HMAC_Init_ex(*(HMAC_CTX **)(param_1 + 8),(void *)0x0,0,(EVP_MD *)0x0,(ENGINE *)0x0);
      return iVar1;
    }
  }
  return 0;
...

{
  ...
  if ((iVar4 != 0) && (ptr = (undefined8 *)hmac_new(*param_1), ptr != (undefined8 *)0x0)) {
    ...
    *(undefined1 (*) [16])(ptr + 2) = (undefined1  [16])0x0;
    ...
    ptr[0x13] = uVar3;
    ptr[4] = 0;
    iVar4 = HMAC_CTX_copy(dctx,(HMAC_CTX *)param_1[1]);
    if ((iVar4 != 0) && (iVar4 = ossl_prov_digest_copy(puVar1,param_1 + 2), iVar4 != 0)) {
      if (param_1[5] != 0) {
        ...
        __dest = (void *)CRYPTO_secure_malloc
                                   (lVar5,"providers/implementations/macs/hmac_prov.c",0x83);
        ptr[5] = __dest;
        if (__dest == (void *)0x0) {
          HMAC_CTX_free(ptr[1]);

...
undefined8 keygen_ml_dsa_real_key_helper(undefined8 *param_1,long *param_2,undefined8 *param_3)
    ...
    if (iVar2 == 0) {
      ...
      *param_3 = pEVar3;
      if (pEVar3 != (EVP_PKEY *)0x0) {
        uVar4 = 1;
        iVar2 = EVP_PKEY_generate(ctx,param_3);
        if (iVar2 != 0) goto LAB_0010083f;
...

{
  ...
  iVar1 = keygen_ml_dsa_real_key_helper();
  if (iVar1 != 0) {
    iVar1 = keygen_ml_dsa_real_key_helper(param_1,param_2,param_4);
    if (iVar1 != 0) {
      return;
    }
  }
...
joined_r0x00100aad:
  ...
  case 2:
    ...
    break;
  case 3:
    if ((puVar2[1] & 1) == 0) goto LAB_00100970;
    iVar3 = 0x21;
    pcVar6 = "ML-DSA-33";
    lVar5 = 0x21;
    break;
  case 4:
    ...
    *param_2 = lVar5 + -4;
    ...
    if ((puVar2[2] & 1) == 0) {
      if (lVar5 != 0x520) {
        if (lVar5 != 0x7a0) goto LAB_00100970;
        pcVar6 = "ML-DSA-87";
        goto LAB_00100a11;
      }
      pcVar6 = "ML-DSA-87";

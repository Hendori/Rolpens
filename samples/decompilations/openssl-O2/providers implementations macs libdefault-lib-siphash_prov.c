...
LAB_001002fa:
      ...
      if ((*(int *)(lVar3 + 8) == 5) && (*(long *)(lVar3 + 0x18) == 0x10)) {
        ...
        if (iVar2 != 0) {
          *(undefined8 *)(param_1 + 0x48) = *(undefined8 *)(param_1 + 8);
...
undefined8 siphash_init(long param_1,long param_2,long param_3,undefined8 param_4)

{
  ...
  if ((iVar2 != 0) && (iVar2 = siphash_set_params(param_1,param_4), iVar2 != 0)) {
    if (param_2 == 0) {
      ...
      *(undefined8 *)(param_1 + 0x20) = *(undefined8 *)(param_1 + 0x60);

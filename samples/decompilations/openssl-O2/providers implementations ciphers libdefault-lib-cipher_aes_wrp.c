...
undefined8
aes_wrap_init(long param_1,uchar *param_2,long param_3,long param_4,undefined8 param_5,
...

{
  ...
  bVar1 = *(byte *)(param_1 + 0x6c);
  *(byte *)(param_1 + 0x6c) = bVar1 & 0xfd | ((byte)param_7 & 1) * '\x02';
  if ((bVar1 & 1) == 0) {
    if (param_7 == 0) {
  ...
  *(undefined **)(param_1 + 0x1b8) = puVar3;
  ...
  if (param_2 == (uchar *)0x0) goto LAB_00100714;
...
LAB_001007b8:
  ...
  else if ((bVar1 & 2) != 0) goto LAB_001007b8;

...
undefined8
get_dh_from_pg(undefined8 param_1,undefined8 param_2,uchar *param_3,int param_4,uchar *param_5,
              int param_6,BIGNUM *param_7,int param_8)

{
  ...
  a = BN_bin2bn(param_3,param_4,(BIGNUM *)0x0);
  a_00 = BN_bin2bn(param_5,param_6,(BIGNUM *)0x0);
...
LAB_001001c8:
    ...
    if (param_7 != (BIGNUM *)0x0) {
      param_7 = BN_bin2bn((uchar *)param_7,param_8,(BIGNUM *)0x0);
      if (param_7 == (BIGNUM *)0x0) goto LAB_001001c8;
    }
    uVar1 = get_dh_from_pg_bn(param_1,param_2,a,a_00,param_7);
  }
  BN_free(a);
  BN_free(a_00);
  BN_free(param_7);
...
void get_dh512(undefined8 param_1)

{
  get_dh_from_pg(param_1,&_LC3,dh512_p_6,0x40,&dh512_g_5,1,0,0);
  return;
}



void get_dhx512(undefined8 param_1)

{
  get_dh_from_pg(param_1,"X9.42 DH",dhx512_p_4,0x41,dhx512_g_3,0x41,dhx512_q_2,0x15);
  return;
}



void get_dh1024dsa(undefined8 param_1)

{
  get_dh_from_pg(param_1,&_LC3,dh1024_p_1,0x80,dh1024_g_0,0x80,0,0);
  return;
}

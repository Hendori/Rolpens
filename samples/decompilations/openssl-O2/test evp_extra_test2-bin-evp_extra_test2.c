...
bool do_fromdata_key_is_equal(undefined8 param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  ctx = (EVP_PKEY_CTX *)EVP_PKEY_CTX_new_from_name(mainctx,param_3,0);
...

{
  ...
  ctx = (EVP_PKEY_CTX *)EVP_PKEY_CTX_new_from_name(mainctx,&_LC74,0);
...

{
  ...
  uStack_80 = uStack_c0;
  local_78 = local_b8;
  OSSL_PARAM_construct_utf8_string(&local_d8,&_LC87,"generator",0);
  local_70 = local_d8;
  uStack_68 = uStack_d0;
  local_60 = local_c8;
  uStack_58 = uStack_c0;
  ...
  uStack_30 = uStack_c0;
  local_28 = local_b8;
  pEVar3 = (EVP_PKEY_CTX *)EVP_PKEY_CTX_new_from_name(mainctx,&_LC88,0);
  ...
  if (iVar1 != 0) {
    ...
    if (iVar1 != 0) {
      ...
      if (iVar1 != 0) {
        ...
        if ((iVar1 != 0) &&
           (iVar1 = test_ptr("test/evp_extra_test2.c",0x186,&_LC92,local_a0), iVar1 != 0)) {
...

{
  ...
  if (iVar1 != 0) {
    ...
    if (iVar1 != 0) {
      iVar1 = test_int_eq("test/evp_extra_test2.c",0x432,&_LC100,"expected",local_24,param_3);
      bVar3 = iVar1 != 0;
      goto LAB_00101eee;
    }
  }
...

{
  ...
  local_118 = 0;
  local_68 = __LC117;
  uStack_60 = (undefined4)_UNK_00106fb8;
  local_110 = dsa_key;
  uStack_5c = (undefined4)__LC118;
  uStack_58 = (undefined4)((ulong)__LC118 >> 0x20);
  uStack_54 = _UNK_00106fc8;
  local_120 = 0x13f;
  local_11c = 5;
  OSSL_PARAM_construct_octet_string(&local_158,&_LC101,&local_68,0x1c);
  local_e8 = local_138;
  local_108 = local_158;
  uStack_100 = uStack_150;
  local_f8 = local_148;
  uStack_f0 = uStack_140;
  OSSL_PARAM_construct_int(&local_158,"gindex",&local_11c);
  local_c0 = local_138;
  local_e0 = local_158;
  uStack_d8 = uStack_150;
  local_d0 = local_148;
  uStack_c8 = uStack_140;
  OSSL_PARAM_construct_int(&local_158,"pcounter",&local_120);
  local_98 = local_138;
  local_b8 = local_158;
  ...
  pkey = (EVP_PKEY *)d2i_AutoPrivateKey_ex(0,&local_110,0x352,mainctx,0);
  iVar1 = test_ptr("test/evp_extra_test2.c",0x45c,
                   "pkey = d2i_AutoPrivateKey_ex(NULL, &pkeydata, sizeof(dsa_key), mainctx, NULL)",
                   pkey);
  if (iVar1 != 0) {
    uVar2 = EVP_PKEY_todata(pkey,0x87,&local_118);
    iVar1 = test_int_eq("test/evp_extra_test2.c",0x45e,
                        "EVP_PKEY_todata(pkey, EVP_PKEY_KEYPAIR, &to_params)",&_LC50,uVar2,1);
    if (iVar1 != 0) {
      iVar1 = do_check_bn(local_118,&_LC106,dsa_p,0x101);
      if (iVar1 != 0) {
        iVar1 = do_check_bn(local_118,&_LC107,dsa_q,0x1d);
        if (iVar1 != 0) {
          iVar1 = do_check_bn(local_118,&_LC108,dsa_g,0x101);
          if (iVar1 != 0) {
            iVar1 = do_check_bn(local_118,&_LC109,dsa_pub,0x100);
            if (iVar1 != 0) {
              iVar1 = do_check_bn(local_118,&_LC110,dsa_priv,0x1c);
              if (iVar1 != 0) {
                iVar1 = do_check_int(local_118,"gindex",0xffffffff);
                if (iVar1 != 0) {
                  iVar1 = do_check_int(local_118,"pcounter",0xffffffff);
                  if (iVar1 != 0) {
                    iVar1 = do_check_int(local_118,"hindex",0);
                    if (iVar1 != 0) {
                      iVar1 = do_check_int(local_118,"validate-pq",1);
                      if (iVar1 != 0) {
                        iVar1 = do_check_int(local_118,"validate-g",1);
                        if (iVar1 != 0) {
                          iVar1 = do_check_int(local_118,"validate-legacy",0);
                          if (iVar1 != 0) {
                            uVar4 = OSSL_PARAM_locate(local_118,&_LC101);
                            iVar1 = test_ptr_null("test/evp_extra_test2.c",0x46c,
                                                  "OSSL_PARAM_locate(to_params, OSSL_PKEY_PARAM_FFC_SEED)"
                                                  ,uVar4);
                            if (iVar1 != 0) {
                              iVar1 = do_fromdata_key_is_equal(local_118,pkey,&_LC74);
                              if (iVar1 != 0) {
                                uVar4 = OSSL_PARAM_merge(local_118,&local_108);
                                uVar3 = test_ptr("test/evp_extra_test2.c",0x472,
                                                 "all_params = OSSL_PARAM_merge(to_params, gen_params)"
                                                 ,uVar4);
                                if (uVar3 != 0) {
                                  iVar1 = do_check_params(uVar4,1);
                                  if (iVar1 != 0) {
                                    OSSL_PARAM_construct_int(&local_158,"gindex",&local_11c);
                                    puVar6 = &local_158;
                                    puVar7 = &local_e0;
...

{
  ...
  if (iVar4 != 0) {
    iVar4 = test_ptr_eq("test/evp_extra_test2.c",0x25e,&_LC106,"input + input_len",local_80,
                        lVar3 + lVar2);
    if (iVar4 != 0) {
...
LAB_00102d93:
        ...
        if (iVar6 == 0x40a) {
          iVar6 = EVP_PKEY_get_octet_string_param(pkey,&_LC110,local_58,0x20,local_60);
...
undefined8 test_pkey_export_cb(undefined8 param_1,long param_2)

{
  undefined8 uVar1;
  
  if (param_2 != 0) {
    uVar1 = do_fromdata_key_is_equal(param_1,param_2,&_LC34);
    return uVar1;
  }
  return 0;
}
            ...
            if (iVar1 != 0) {
              ...
              if (iVar1 != 0) {
                ...
                iVar1 = test_int_eq("test/evp_extra_test2.c",0x1c0,
                                    ...
                                    &_LC28,uVar2,0);
                if (iVar1 != 0) {
                  uVar2 = set_fromdata_uint(ctx,&_LC101);
...

{
  ...
  uVar1 = test_ptr("test/evp_extra_test2.c",0x43b,
                   ...
                   pkey);
  if (uVar1 != 0) {
    iVar2 = do_pkey_tofrom_data_select(pkey,&_LC74);
...

{
  ...
  pkey = (EVP_PKEY *)EVP_PKEY_Q_keygen(mainctx,0,&_LC190);
  uVar1 = test_ptr("test/evp_extra_test2.c",0x238,"key = EVP_PKEY_Q_keygen(mainctx, NULL, \"SM2\")",
                   pkey);
  if (uVar1 != 0) {
    iVar2 = do_pkey_tofrom_data_select(pkey,&_LC190);
...

{
  ...
  local_50 = local_b8;
  uStack_48 = uStack_b0;
  ctx = (EVP_PKEY_CTX *)EVP_PKEY_CTX_new_from_name(mainctx,&_LC197,0);
    ...
    if (iVar1 != 0) {
      ...
      if (iVar1 != 0) {
        ...
        iVar1 = test_int_gt("test/evp_extra_test2.c",0x169,"EVP_PKEY_generate(gctx, &key)",&_LC28,
                            uVar2,0);
        if (iVar1 != 0) {
          iVar1 = do_pkey_tofrom_data_select(local_90,&_LC197);
          ...
          if (iVar1 != 0) {
            ...
            if (iVar1 != 0) {
              ...
              if (iVar1 != 0) {
                iVar1 = BN_num_bits(a);
                iVar1 = test_int_le("test/evp_extra_test2.c",0x16e,"BN_num_bits(privkey)",&_LC204,
                                    iVar1,0xe1);
                bVar4 = iVar1 != 0;
                goto LAB_00103b40;
              }

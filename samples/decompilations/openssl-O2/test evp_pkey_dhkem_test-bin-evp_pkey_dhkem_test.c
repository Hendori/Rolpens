...
uint do_ec_curve_failtest(undefined8 param_1)

{
  ...
  ctx = (EVP_PKEY_CTX *)0x0;
  pkey = (EVP_PKEY *)EVP_PKEY_Q_keygen(libctx,0,&_LC8,param_1);
  uVar1 = test_ptr("test/evp_pkey_dhkem_test.c",0x242,
                   "key = EVP_PKEY_Q_keygen(libctx, NULL, \"EC\", curve)",pkey);
  if (uVar1 != 0) {
    ctx = (EVP_PKEY_CTX *)EVP_PKEY_CTX_new_from_pkey(libctx,pkey,0);
    iVar2 = test_ptr("test/evp_pkey_dhkem_test.c",0x243,
                     "ctx = EVP_PKEY_CTX_new_from_pkey(libctx, key, NULL)",ctx);
    if (iVar2 != 0) {
      uVar3 = EVP_PKEY_encapsulate_init(ctx,0);
      iVar2 = test_int_eq("test/evp_pkey_dhkem_test.c",0x244,"EVP_PKEY_encapsulate_init(ctx, NULL)",
                          &_LC7,uVar3,0xfffffffe);
      if (iVar2 != 0) {
        uVar3 = EVP_PKEY_decapsulate_init(ctx,0);
        iVar2 = test_int_eq("test/evp_pkey_dhkem_test.c",0x245,
                            "EVP_PKEY_decapsulate_init(ctx, NULL)",&_LC7,uVar3,0xfffffffe);
        uVar1 = (uint)(iVar2 != 0);
        goto LAB_0010026e;
      }
...
void test_ec_curve_unsupported(void)

{
  do_ec_curve_failtest("P-224");
  return;
}



void test_ec_curve_nonnist(void)

{
  do_ec_curve_failtest("secp256k1");
  return;
}
...

{
  ...
  pkey = (EVP_PKEY *)EVP_PKEY_Q_keygen(libctx,0,&_LC12);
  uVar3 = test_ptr("test/evp_pkey_dhkem_test.c",0x2f8,
                   "auth = EVP_PKEY_Q_keygen(libctx, NULL, \"X448\")",pkey);
  if ((int)uVar3 != 0) {
    uVar1 = EVP_PKEY_auth_encapsulate_init(DAT_001041a8,pkey,opparam);
...

{
  ...
  pkey = (EVP_PKEY *)EVP_PKEY_Q_keygen(libctx,0,&_LC8,"P-521");
  ...
  if ((int)uVar3 != 0) {
    ...
    uVar2 = test_int_eq("test/evp_pkey_dhkem_test.c",0xfe,
                        "EVP_PKEY_auth_encapsulate_init(rctx[0], auth, opparam)",&_LC14,uVar1,0);
    EVP_PKEY_free(pkey);
    uVar3 = (ulong)uVar2;
  }
  return uVar3;
...

{
  ...
  test_int_eq("test/evp_pkey_dhkem_test.c",0x109,
              "EVP_PKEY_auth_encapsulate_init(rctx[id1], rkey[id2], opparam)",&_LC14,uVar1,0);
  return;
}
      ...
      if (iVar5 != 0) {
        ...
        if (iVar5 != 0) {
          ...
          iVar5 = test_int_eq("test/evp_pkey_dhkem_test.c",0x2e4,
                              ...
                              ,&_LC0,uVar6,1);
          if (iVar5 != 0) {
            uVar6 = EVP_PKEY_get_octet_string_param(local_170,&_LC28,local_c8,0x40,&local_160);
...

{
  ...
  local_298 = local_2d8;
  OSSL_PARAM_construct_octet_string(&local_2f8,&_LC36,local_238,0x10);
  local_270 = local_2d8;
  local_290 = local_2f8;
  ...
  if ((int)uVar4 != 0) {
    ...
    iVar3 = test_int_eq("test/evp_pkey_dhkem_test.c",0xc9,
                        "EVP_PKEY_encapsulate(ctx, enc, &enclen, secret, &secretlen)",&_LC14,uVar2,0
                       );
    uVar4 = (ulong)(iVar3 != 0);
  }
...

{
  ...
  local_2a8 = local_2e8;
  OSSL_PARAM_construct_octet_string
            (&local_308,&_LC36,*(undefined8 *)(param_1 + 8),*(undefined8 *)(param_1 + 0x10));
  local_280 = local_2e8;
  local_2a0 = local_308;
    ...
    if (iVar1 != 0) {
      ...
      if (iVar1 != 0) {
        ...
        iVar1 = test_int_eq("test/dhkem_test.inc",0x2a6,
                            ...
                            uVar2,1);
        if ((iVar1 != 0) &&
           (iVar1 = test_mem_eq("test/dhkem_test.inc",0x2a8,&_LC46,"t->expected_enc",local_148,
...

{
  ...
  local_20 = *(long *)(in_FS_OFFSET + 0x28);
  local_1e8 = 0xc4;
  uStack_220 = _UNK_00106a58;
  local_230 = 0x100;
  local_218 = __LC52;
  uStack_210 = _UNK_00106a68;
  _local_228 = CONCAT71((int7)((ulong)__LC51 >> 8),0xff);
  local_208 = __LC53;
  uStack_200 = _UNK_00106a78;
  local_1f8 = __LC54;
  uStack_1f0 = _UNK_00106a88;
...

{
  ...
  iVar4 = test_int_eq("test/evp_pkey_dhkem_test.c",0x14a,
                      "EVP_PKEY_auth_encapsulate_init(ctx, NULL, opparam)",&_LC14,uVar3,0);
  if (iVar4 != 0) {
    uVar3 = EVP_PKEY_auth_decapsulate_init(uVar2,0,opparam);
    iVar4 = test_int_eq("test/evp_pkey_dhkem_test.c",0x14b,
                        "EVP_PKEY_auth_decapsulate_init(ctx, NULL, opparam)",&_LC14,uVar3,0);
    if (iVar4 != 0) {
        ...
        if (iVar4 != 0) {
          ...
          if (iVar4 != 0) {
            ...
            iVar4 = test_int_eq("test/evp_pkey_dhkem_test.c",0x153,
                                "EVP_PKEY_encapsulate(ctx, NULL, NULL, NULL, NULL)",&_LC14,uVar3,0);
            return iVar4 != 0;
          }
        }
      }
  ...
  if (iVar2 != 0) {
    ...
    if (iVar2 != 0) {
      ...
      iVar2 = test_int_eq("test/evp_pkey_dhkem_test.c",0xde,
                          "EVP_PKEY_encapsulate(ctx, enc, &enclen, sec, &seclen)",&_LC14,uVar1,0);
      if (iVar2 != 0) {
        local_250 = local_250 + 1;
        ...
        if (iVar2 != 0) {
          ...
          if (iVar2 != 0) {
            ...
            iVar2 = test_int_eq("test/evp_pkey_dhkem_test.c",0xeb,
                                "EVP_PKEY_decapsulate(ctx, sec, &seclen, enc, enclen)",&_LC14,uVar1,
                                0);
            if (iVar2 != 0) {
              local_258 = local_258 + 1;
              local_250 = local_250 + -1;
              ...
              uVar3 = test_int_eq("test/evp_pkey_dhkem_test.c",0xf0,
                                  "EVP_PKEY_decapsulate(ctx, sec, &seclen, enc, enclen)",&_LC14,
                                  uVar1,0);
              goto LAB_0010117e;
            }
          }
...

{
  ...
  if (*param_1 == 'X') {
    ...
    if (ctx == (EVP_PKEY_CTX *)0x0) goto LAB_001018b4;
  }
  else {
    ctx = (EVP_PKEY_CTX *)EVP_PKEY_CTX_new_from_name(libctx,&_LC8,0);
...
LAB_001018b4:
  ...
  OSSL_PARAM_construct_octet_string(&local_e8,&_LC71,param_2,param_3);
  *puVar3 = local_e8;
  puVar3[1] = uStack_e0;
  puVar3[2] = local_d8;
  puVar3[3] = uStack_d0;
...

{
  ...
  if (*param_1 == 'X') {
    ctx = (EVP_PKEY_CTX *)EVP_PKEY_CTX_new_from_name(libctx,param_1,0);
    if (ctx == (EVP_PKEY_CTX *)0x0) goto LAB_00101ab8;
    lVar2 = OSSL_PARAM_BLD_new();
    if (lVar2 != 0) {
      iVar1 = OSSL_PARAM_BLD_push_octet_string(lVar2,&_LC28,param_2,param_3);
      a = (BIGNUM *)0x0;
      if (iVar1 != 0) goto joined_r0x00101a10;
      goto LAB_00101966;
    }
LAB_00101aa8:
    a = (BIGNUM *)0x0;
...
joined_r0x00101a10:
    if ((param_4 != 0) &&
       (iVar1 = OSSL_PARAM_BLD_push_octet_string(lVar2,&_LC71,param_4,param_5), iVar1 == 0))
    goto LAB_00101966;
    lVar3 = OSSL_PARAM_BLD_to_param(lVar2);
    if (((lVar3 == 0) || (iVar1 = EVP_PKEY_fromdata_init(ctx), iVar1 < 1)) ||
       (iVar1 = EVP_PKEY_fromdata(ctx,&local_48,0x87,lVar3), iVar1 < 1)) goto LAB_00101969;
  }
  BN_free(a);
...

{
  ...
  if ((param_1 & 1) == 0) {
    ...
    iVar3 = test_int_eq("test/evp_pkey_dhkem_test.c",0x29c,
                        "EVP_PKEY_encapsulate(ctx, enc, &enclen, secret, &secretlen)",&_LC14,uVar4,0
                       );
    if (iVar3 == 0) goto LAB_00101bc3;
LAB_00101cf6:
    uVar5 = ERR_get_error();
    ...
    if ((param_1 & 1) == 0) {
      ...
      if (iVar2 != 0) {
        ...
        iVar2 = test_int_eq("test/evp_pkey_dhkem_test.c",0x271,
                            "EVP_PKEY_encapsulate(ctx, enc , &enclen, secret, &secretlen)",&_LC14,
                            uVar3,0);
        goto joined_r0x00102020;
      }
    }
    else {
    ...
    if (iVar3 != 0) {
      ...
      if (iVar3 != 0) {
        ...
        iVar3 = test_int_eq("test/evp_pkey_dhkem_test.c",0x134,
                            "EVP_PKEY_encapsulate(keyctx, e, &elen, s, &slen)",&_LC14,uVar4,0);
        if (iVar3 != 0) {
            ...
            if (iVar3 != 0) {
              ...
              if (iVar3 != 0) {
                ...
                iVar3 = test_int_eq("test/evp_pkey_dhkem_test.c",0x13c,
                                    "EVP_PKEY_encapsulate(ctx, e, &elen, s, &slen)",&_LC14,uVar4,0);
                uVar2 = (uint)(iVar3 != 0);
                goto LAB_001020d3;
              }
            }
...

{
  ...
  if (lVar2 == 0) {
    test_note("Test %s %s Decapsulate",uVar6,&_LC100);
    pEVar4 = (EVP_PKEY *)
    ...
    test_note("Test %s %s Decapsulate",uVar6,&_LC103);
    pkey = (EVP_PKEY *)
           new_raw_private_key(uVar6,*(undefined8 *)(ec_encapdata + lVar1 + 0x28),
                               *(undefined8 *)(ec_encapdata + lVar1 + 0x30),
                               *(undefined8 *)(ec_encapdata + lVar1 + 0x18),
          ...
          if (iVar1 != 0) {
            ...
            if (iVar1 != 0) {
              ...
              iVar1 = test_int_eq("test/evp_pkey_dhkem_test.c",0x92,
                                  "EVP_PKEY_generate(genctx, &pkey)",&_LC14,uVar2,0);
              if (iVar1 != 0) {
...
LAB_00103101:
      ...
      if (iVar3 != 0) {
        ...
        if (iVar3 != 0) goto LAB_001031cf;
      }
      goto LAB_00103183;
    }
  }
  else {
    pkey = (EVP_PKEY *)EVP_PKEY_Q_keygen(libctx,0,&_LC8,pcVar6);
    uVar2 = test_ptr("test/evp_pkey_dhkem_test.c",0x21a,
                     "recip = EVP_PKEY_Q_keygen(libctx, NULL, \"EC\", curve)",pkey);
    if (uVar2 != 0) {
      if (bVar1) {
        pkey_00 = (EVP_PKEY *)EVP_PKEY_Q_keygen(libctx,0,&_LC8,pcVar6);
      ...
      if (iVar1 != 0) {
        ...
        if (iVar1 != 0) {
          ...
          iVar1 = test_true("test/evp_pkey_dhkem_test.c",0x1e7,
                            ...
                            ,iVar1 != 0);
          if (iVar1 != 0) {
            iVar1 = EVP_PKEY_get_bn_param(local_1b0,&_LC28,&local_1a0);
            ...
            if (iVar1 != 0) {
              ...
              iVar3 = test_int_gt("test/evp_pkey_dhkem_test.c",0x1ec,
                                  "privkeylen = BN_bn2bin(priv, privkey)",&_LC14,iVar1,0);
              if (iVar3 != 0) {
...

{
  ...
  if (iVar2 != 0) {
    ...
    iVar2 = test_int_eq("test/evp_pkey_dhkem_test.c",0x167,
                        "EVP_PKEY_encapsulate_init(ctx, badparams)",&_LC14,uVar1,0);
    if (iVar2 != 0) {
      ...
      iVar2 = test_int_eq("test/evp_pkey_dhkem_test.c",0x16e,
                          "EVP_PKEY_encapsulate_init(ctx, badparams)",&_LC14,uVar1,0);
      if (iVar2 != 0) {
        OSSL_PARAM_construct_int(&local_128,&_LC36,&local_ec);
        local_c8 = local_108;
        local_e8 = local_128;
        uStack_e0 = uStack_120;
        local_d8 = local_118;
        ...
        iVar2 = test_int_eq("test/evp_pkey_dhkem_test.c",0x174,
                            "EVP_PKEY_encapsulate_init(ctx, badparams)",&_LC14,uVar1,0);
        if (iVar2 != 0) {
          OSSL_PARAM_construct_octet_string(&local_128,&_LC36,0,0);
          local_c8 = local_108;
          local_e8 = local_128;
          uStack_e0 = uStack_120;
          local_d8 = local_118;
...

{
  ...
  if (iVar2 != 0) {
    ...
    if (iVar2 != 0) {
      ...
      {
        lVar4 = OSSL_PARAM_locate_const(uVar3,&_LC36);
    ...
    if (iVar1 != 0) {
      ...
      if (iVar1 != 0) {
        ...
        iVar1 = test_ptr("test/evp_pkey_dhkem_test.c",0x327,
                         ...
                         ,rctx);
        if (iVar1 != 0) {
          DAT_001041a8 = EVP_PKEY_CTX_new_from_pkey(libctx,DAT_001041b8,0);
...
{
  EVP_PKEY_free(DAT_001041b8);
  EVP_PKEY_free(rkey);
  EVP_PKEY_CTX_free(DAT_001041a8);

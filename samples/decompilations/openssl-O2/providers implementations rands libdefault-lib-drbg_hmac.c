...
undefined8
drbg_hmac_update(undefined8 param_1,undefined8 param_2,long param_3,undefined8 param_4,long param_5,
...
undefined8
ossl_drbg_hmac_init(long *param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  if (*param_1 != 0) {
    __n = param_1[4];
    memset(param_1 + 5,0,__n);
    memset(param_1 + 0xd,1,__n);
    uVar1 = drbg_hmac_update(param_1,param_2,param_3,param_4,param_5,param_6);
    return uVar1;
  }
  ERR_new();
...

{
  ...
  if (((param_4 == 0) || (param_5 == 0)) ||
     (iVar2 = drbg_hmac_update(param_1,param_4,param_5,0,0,0,0), iVar2 != 0)) {
    lVar3 = param_1[4];
    puVar4 = __src;
    while( true ) {
      __dest = param_2;
    ...
    if (iVar2 != 0) {
      ...
      iVar2 = drbg_hmac_update(param_1,param_4,param_5,0,0,0,0);
      return iVar2 != 0;
    }
  }
  return false;

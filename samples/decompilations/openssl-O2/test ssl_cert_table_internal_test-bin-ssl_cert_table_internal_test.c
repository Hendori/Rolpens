...

{
  ...
  iVar1 = test_size_t_eq("test/ssl_cert_table_internal_test.c",0x2f,"OSSL_NELEM(ssl_cert_info)",
                         "SSL_PKEY_NUM",9,9);
  if (((((iVar1 != 0) && (iVar1 = do_test_cert_table(6,1,0,"SSL_PKEY_RSA"), iVar1 != 0)) &&
       (iVar1 = do_test_cert_table(0x74,2,2,"SSL_PKEY_DSA_SIGN"), iVar1 != 0)) &&
      ((iVar1 = do_test_cert_table(0x198,8,3,"SSL_PKEY_ECC"), iVar1 != 0 &&
       (iVar1 = do_test_cert_table(0x32b,0x20,4,"SSL_PKEY_GOST01"), iVar1 != 0)))) &&
     ((iVar1 = do_test_cert_table(0x3d3,0x80,5,"SSL_PKEY_GOST12_256"), iVar1 != 0 &&
      ((iVar1 = do_test_cert_table(0x3d4,0x80,6,"SSL_PKEY_GOST12_512"), iVar1 != 0 &&
       (iVar1 = do_test_cert_table(0x43f,8,7,"SSL_PKEY_ED25519"), iVar1 != 0)))))) {

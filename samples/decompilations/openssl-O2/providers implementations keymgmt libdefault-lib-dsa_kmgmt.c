...
bool dsa_key_todata(long param_1,undefined8 param_2,undefined8 param_3,int param_4)
...
LAB_00100208:
    ...
    if ((param_4 != 0) && (local_30 != 0)) {
      iVar1 = ossl_param_build_set_bn(param_2,param_3,&_LC0);
      if (iVar1 == 0) goto LAB_00100208;
    }
    bVar2 = true;
    if (local_28 != 0) {
      iVar1 = ossl_param_build_set_bn(param_2,param_3,&_LC1);
      bVar2 = iVar1 != 0;
    }
  }
...
LAB_001004f7:
    ...
    if ((pBVar2 == (BIGNUM *)0x0) || (pBVar3 == (BIGNUM *)0x0)) goto LAB_001004f7;
    iVar1 = BN_cmp(pBVar2,pBVar3);
  }
  else {
    pBVar2 = (BIGNUM *)DSA_get0_pub_key(param_1);
    pBVar3 = (BIGNUM *)DSA_get0_pub_key(param_2);
    if ((pBVar2 == (BIGNUM *)0x0) || (pBVar3 == (BIGNUM *)0x0)) goto LAB_001004f2;
    iVar1 = BN_cmp(pBVar2,pBVar3);
  }
  if ((param_3 & 4) == 0) {
    return iVar1 == 0;
      ...
      if ((((*(byte *)(param_1 + 2) & 4) == 0) ||
         ...
         ((ossl_ffc_params_enable_flags(plVar3,4,*(int *)((long)param_1 + 0x3c) == 1), pDVar4 = a,
          ...
          ((((*plVar3 != 0 && (plVar3[1] != 0)) && (plVar3[2] != 0)) &&
           (iVar1 = DSA_generate_key(a), 0 < iVar1)))))) goto LAB_00100922;
    }
  }
  else {
    if (*(uint *)((long)param_1 + 0x3c) < 3) goto LAB_00100821;
    ERR_new();
    lVar2 = 0;
...

{
  ...
  if ((param_2 != (long *)0x0) && (*param_2 != 0)) {
    lVar3 = OSSL_PARAM_locate_const(param_2,&_LC11);
    if (lVar3 != 0) {
      if (*(int *)(lVar3 + 8) != 4) {
LAB_00100b65:
        ERR_new();
      ...
      if (iVar2 == 0) {
        ...
        if (iVar2 == 0) {
          ...
          if (iVar2 != 0) goto LAB_00100b65;
          lVar3 = 2;
        }
      }
      if (*(int *)(dsatype2id + lVar3 * 0x10 + 8) == -1) goto LAB_00100b65;
    ...
    lVar3 = OSSL_PARAM_locate_const(param_2,&_LC18);
    if (lVar3 != 0) {
      if (*(int *)(lVar3 + 8) != 5) {
        return false;
      }
...
void dsa_gen_cleanup_part_0(void *param_1)
...
void dsa_gen_cleanup(long param_1)

{
  if (param_1 != 0) {
    dsa_gen_cleanup_part_0();
    return;
  }
  return;
}
...

{
  ...
  if ((iVar3 != 0) && ((param_2 & 7) != 0)) {
    puVar5 = (undefined8 *)CRYPTO_zalloc(0x68,"providers/implementations/keymgmt/dsa_kmgmt.c",0x1a1)
    ;
    uVar2 = _UNK_00101a78;
    uVar1 = __LC23;
    if (puVar5 == (undefined8 *)0x0) {
      ...
      *puVar5 = uVar4;
      ...
      puVar5[7] = __LC24;
      puVar5[8] = uVar4;
      iVar3 = dsa_gen_set_params(puVar5,param_3);
      if (iVar3 != 0) {
        return puVar5;
      }
      dsa_gen_cleanup_part_0(puVar5);
    }
  }

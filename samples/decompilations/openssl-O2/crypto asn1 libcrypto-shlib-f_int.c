...

{
  ...
  uVar3 = a->type & 0x100;
  if ((uVar3 == 0) || (uVar3 = BIO_write(bp,&_LC0,1), uVar3 == 1)) {
    if (a->length != 0) {
      lVar2 = 0;
      if (0 < a->length) {
        do {

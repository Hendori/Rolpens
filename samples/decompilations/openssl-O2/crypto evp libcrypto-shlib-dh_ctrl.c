...
undefined8 dh_paramgen_check(byte *param_1)

{
  ...
  if ((**(int **)(param_1 + 0x78) != 0x1c) && (**(int **)(param_1 + 0x78) != 0x398)) {
    return 0xffffffff;
  }
  return 1;
}
...
void EVP_PKEY_CTX_set_dh_paramgen_gindex(undefined8 param_1,undefined4 param_2)

{
  ...
  if (0 < iVar1) {
    ...
    local_40 = local_a8;
    uStack_38 = uStack_a0;
    evp_pkey_ctx_set_params_strict(param_1,&local_78);
  }
...

{
  ...
  iVar1 = dh_paramgen_check();
  if (0 < iVar1) {
    OSSL_PARAM_construct_octet_string(&local_b8,&_LC2,param_2,param_3);
    local_68 = local_98;
    local_88 = local_b8;
    uStack_80 = uStack_b0;
    local_78 = local_a8;
...
void EVP_PKEY_CTX_set_dh_paramgen_prime_len(undefined8 param_1,int param_2)
...
void EVP_PKEY_CTX_set_dh_paramgen_subprime_len(undefined8 param_1,int param_2)
...
void EVP_PKEY_CTX_set_dh_paramgen_generator(undefined8 param_1,undefined4 param_2)
...
LAB_00100afa:
    ...
    if ((param_1 == (uint *)0x0) || ((*param_1 & 0x800) == 0)) {
      ...
      if (((*(long *)(param_1 + 8) == 0) && (**(int **)(param_1 + 0x1e) != 0x1c)) &&
         (**(int **)(param_1 + 0x1e) != 0x398)) goto LAB_00100afa;
...

{
  ...
  if ((param_1 == (uint *)0x0) || ((*param_1 & 0x800) == 0)) {
    ...
    if (((*(long *)(param_1 + 8) != 0) || (**(int **)(param_1 + 0x1e) == 0x1c)) ||
      ...
      else if ((iVar1 == 1) && (uVar2 = local_58, local_58 < 0x80000000)) goto LAB_00100c58;
    }
    uVar2 = 0xffffffff;
  }
LAB_00100c58:

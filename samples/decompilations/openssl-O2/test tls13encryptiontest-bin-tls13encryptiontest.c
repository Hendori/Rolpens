...

{
  ...
  lVar7 = 0;
  do {
    sVar6 = strlen((char *)param_1[lVar7]);
    uVar9 = uVar9 + sVar6;
    if ((uVar9 & 1) != 0) goto LAB_001000c9;
    lVar7 = lVar7 + 1;
  } while (lVar7 != 3);
  ptr = CRYPTO_malloc((int)(uVar9 >> 1),"test/tls13encryptiontest.c",0xda);
  if (ptr == (void *)0x0) {
LAB_001000c9:
    ptr = (void *)0x0;
  }
    ...
    do {
      ...
      while (cVar2 != '\0') {
        ...
        uVar5 = OPENSSL_hexchar2int(*(undefined1 *)(*param_1 + 1 + lVar8));
        ...
        lVar8 = lVar8 + 2;
        lVar3 = *param_1;
        *(byte *)((long)ptr + lVar7) = (byte)(uVar4 << 4) | (byte)uVar5;
        lVar7 = lVar7 + 1;
        cVar2 = *(char *)(lVar3 + lVar8);
      }
      param_1 = param_1 + 1;
...
LAB_00100698:
    ...
    pvStack_80 = local_88;
    if (local_88 == (void *)0x0) goto LAB_00100698;
    local_a0 = __n;

...
undefined8 cms_signed_data_init_part_0(undefined8 *param_1)
...

{
  ...
  if (*(long *)(cms + 8) == 0) {
    lVar2 = cms_signed_data_init_part_0();
  }
  else {
...

{
  ...
  if (0 < iVar4) {
    ...
    if ((iVar4 == 2) && ((local_98 != 0x45444e55 || (pcVar2 = (char *)0x0, local_94 != 0x46)))) {
      if (*(int *)(si + 0x60) == 0) goto LAB_0010096e;
LAB_00100988:
...
LAB_00100be7:
              ...
              if (0 < iVar4) {
                ...
                if (0 < iVar4) {
                  ...
                  if (local_e8 == (uchar *)0x0) goto LAB_00100be7;
      ...
      buf = pcVar2;
      if (*(int *)(si + 0x60) != 0) goto LAB_00100988;
LAB_0010096e:
      iVar4 = CMS_signed_get_attr_by_NID(si,0x34,-1);
      if (-1 < iVar4) goto LAB_00100988;
...
LAB_00100e01:
    ...
    si = (CMS_SignerInfo *)OPENSSL_sk_value(psVar2,iVar5);
    local_d4 = param_4;
    ctx_00 = (EVP_MD_CTX *)EVP_MD_CTX_new();
    uVar3 = ossl_cms_get0_cmsctx(param_1);
...
LAB_00100dff:
    ...
    iVar1 = ossl_cms_DigestAlgorithm_find_ctx(ctx_00,param_2,*(undefined8 *)(si + 0x10));
    if ((iVar1 == 0) ||
       ((*(long *)(si + 0x50) != 0 && (iVar1 = cms_sd_asn1_ctrl(si,0), iVar1 == 0)))) {
LAB_00100df0:
      EVP_MD_CTX_free();
      EVP_PKEY_CTX_free((EVP_PKEY_CTX *)0x0);
      goto LAB_00100dff;
    ...
    if (iVar1 < 0) {
      ctx = *(EVP_PKEY_CTX **)(si + 0x50);
      if (ctx == (EVP_PKEY_CTX *)0x0) {
        if (param_3 == (uchar *)0x0) {
          iVar1 = EVP_PKEY_get_size(*(undefined8 *)(si + 0x40));
          local_d0 = CONCAT44(local_d0._4_4_,iVar1);
          if ((iVar1 != 0) &&
            ...
            iVar1 = EVP_SignFinal_ex(ctx_00,ptr,&local_d0,*(undefined8 *)(si + 0x40),uVar3,uVar4);
            if (iVar1 != 0) {
              ASN1_STRING_set0(*(ASN1_STRING **)(si + 0x28),ptr,(int)local_d0);
              goto LAB_00100f70;
            }
            ERR_new();
      ...
      *(undefined8 *)(si + 0x50) = 0;
      ...
      if (param_3 == (uchar *)0x0) {
        md = local_88;
        iVar1 = EVP_DigestFinal_ex(ctx_00,md,&local_d4);
        if (iVar1 != 0) goto LAB_00100ea3;
      }
      else {
LAB_00100ea3:
        iVar1 = EVP_PKEY_get_size(*(undefined8 *)(si + 0x40));
        local_d0 = (size_t)iVar1;
        if ((local_d0 != 0) &&
           (sig = (uchar *)CRYPTO_malloc(iVar1,"crypto/cms/cms_sd.c",0x31c), sig != (uchar *)0x0)) {
          iVar1 = EVP_PKEY_sign(ctx,sig,&local_d0,md,(ulong)local_d4);
          if (0 < iVar1) {
            ASN1_STRING_set0(*(ASN1_STRING **)(si + 0x28),sig,(int)local_d0);
    ...
    if ((param_3 == (uchar *)0x0) &&
       (iVar1 = EVP_DigestFinal_ex(ctx_00,local_c8,&local_d4), iVar1 == 0)) {
      EVP_MD_CTX_free();
      EVP_PKEY_CTX_free((EVP_PKEY_CTX *)0x0);
      goto LAB_00100dff;
    }
    iVar1 = CMS_signed_add1_attr_by_NID(si,0x33,4,bytes,local_d4);
    if (((iVar1 == 0) ||
        (iVar1 = CMS_signed_add1_attr_by_NID
                           (si,0x32,6,(void *)**(undefined8 **)(*(long *)(param_1 + 8) + 0x10),-1),
        iVar1 < 1)) || (iVar1 = CMS_SignerInfo_sign(si), iVar1 == 0)) goto LAB_00100df0;
LAB_00100f70:
    EVP_MD_CTX_free();
    EVP_PKEY_CTX_free((EVP_PKEY_CTX *)0x0);
LAB_00100f7f:
    ...
    if (iVar4 != 0) {
      ...
      if (ctx == (EVP_MD_CTX *)0x0) {
        ...
        *(EVP_MD_CTX **)(si + 0x48) = ctx;
        if (ctx != (EVP_MD_CTX *)0x0) goto LAB_0010123f;
        ERR_new();
...

{
  ...
  if (keysize < 1) {
    ...
    a = ASN1_INTEGER_new();
    if (a == (ASN1_INTEGER *)0x0) goto LAB_00101cf8;
    iVar1 = ASN1_INTEGER_set(a,(long)keysize);
    uVar3 = 2;
    if (iVar1 == 0) goto LAB_00101cf8;
  }
...
LAB_00101cf8:
  ...
  if (psVar2 == (stack_st_X509_ALGOR *)0x0) {
    ...
    *algs = psVar2;
    if (psVar2 == (stack_st_X509_ALGOR *)0x0) goto LAB_00101d29;
  }
...

{
  ...
  char *name;
  X509_ALGOR *pXVar10;
  stack_st_CMS_SignerInfo *psVar11;
  ...
  if (iVar1 == 0) {
    ...
    if (*(long *)(cms + 8) == 0) {
      piVar8 = (int *)cms_signed_data_init_part_0(cms);
LAB_001020ab:
      if (piVar8 == (int *)0x0) goto LAB_00102380;
      pAVar5 = (ASN1_ITEM *)CMS_SignerInfo_it();
      si = ASN1_item_new(pAVar5);
      if (si == (ASN1_VALUE *)0x0) {
        ERR_new();
        si = (ASN1_VALUE *)0x0;
        ERR_set_debug("crypto/cms/cms_sd.c",0x16b,"CMS_add1_signer");
        ERR_set_error(0x2e,0x8000d,0);
      }
      else {
        ...
        iVar1 = X509_up_ref(signer);
        if (iVar1 != 0) {
          iVar1 = EVP_PKEY_up_ref(pk);
          if (iVar1 == 0) {
            X509_free(signer);
          }
          else {
            *(X509 **)(si + 0x38) = signer;
            *(undefined8 *)(si + 0x58) = uVar4;
            *(EVP_PKEY **)(si + 0x40) = pk;
            lVar6 = EVP_MD_CTX_new();
            *(undefined8 *)(si + 0x50) = 0;
            *(long *)(si + 0x48) = lVar6;
            *(undefined4 *)(si + 0x60) = 0;
            if (lVar6 == 0) {
              ERR_new();
              ...
              iVar1 = ossl_cms_set1_SignerIdentifier(*(undefined8 *)(si + 8),signer,uVar9,uVar4);
              if (iVar1 != 0) {
                if (md == (EVP_MD *)0x0) {
                  iVar1 = EVP_PKEY_get_default_digest_nid(pk,(int *)&local_80);
                  if (iVar1 < 1) {
                    ERR_new();
                    ERR_set_debug("crypto/cms/cms_sd.c",0x195,"CMS_add1_signer");
                    uVar3 = EVP_PKEY_get_id(pk);
                    ERR_set_error(0x2e,0x80,"pkey nid=%d",uVar3);
                  }
                  else {
                    name = OBJ_nid2sn((int)local_80);
                    md = EVP_get_digestbyname(name);
                    if (md != (EVP_MD *)0x0) goto LAB_00102171;
                    ERR_new();
...
LAB_00102171:
                  ...
                  for (iVar1 = 0; iVar2 = OPENSSL_sk_num(*(undefined8 *)(piVar8 + 2)), iVar1 < iVar2
                      ; iVar1 = iVar1 + 1) {
                    pXVar10 = (X509_ALGOR *)OPENSSL_sk_value(*(undefined8 *)(piVar8 + 2));
                    X509_ALGOR_get0(&local_80,(int *)0x0,(void **)0x0,pXVar10);
                    OBJ_obj2txt(local_78,0x32,local_80,0);
                    iVar2 = EVP_MD_is_a(md,local_78);
                    if (iVar2 != 0) break;
                  }
                  iVar2 = OPENSSL_sk_num(*(undefined8 *)(piVar8 + 2));
                  if (iVar2 == iVar1) {
                    ...
                    X509_ALGOR_set_md(pXVar10,md);
                    iVar1 = OPENSSL_sk_push(*(undefined8 *)(piVar8 + 2),pXVar10);
                    if (iVar1 != 0) goto LAB_00102208;
                    X509_ALGOR_free(pXVar10);
                    ERR_new();
                    uVar4 = 0x1b7;
LAB_001022b3:
                    ERR_set_debug("crypto/cms/cms_sd.c",uVar4,"CMS_add1_signer");
...
LAB_00102208:
                    ...
                    if ((flags & 0x40000) == 0) {
                      iVar1 = cms_sd_asn1_ctrl(si,0);
                      if (iVar1 == 0) {
                        ERR_new();
                        ERR_set_debug("crypto/cms/cms_sd.c",0x1bd,"CMS_add1_signer");
                        uVar3 = EVP_PKEY_get_id(pk);
                        ERR_set_error(0x2e,0xc3,"pkey nid=%d",uVar3);
                        goto LAB_001022d8;
                      }
                      if ((flags & 0x100) != 0) {
LAB_001026d0:
                        if (((flags & 2) != 0) || (iVar1 = CMS_add1_cert(cms,signer), iVar1 != 0))
                        goto LAB_00102288;
                        goto LAB_001026ee;
                      }
LAB_001023e8:
...
LAB_0010242e:
                            if (((flags & 2) == 0) &&
                               (iVar1 = CMS_add1_cert(cms,signer), iVar1 == 0)) goto LAB_001026ee;
                            if (local_a8 != 0) {
                              uVar9 = ossl_cms_ctx_get0_propq(uVar4);
                              uVar4 = ossl_cms_ctx_get0_libctx(uVar4);
                              uVar7 = EVP_MD_get0_name(md);
                              iVar1 = EVP_DigestSignInit_ex
                                                (*(undefined8 *)(si + 0x48),si + 0x50,uVar7,uVar4,
                                                 uVar9,pk,0);
                              if (iVar1 < 1) {
                                *(undefined8 *)(si + 0x50) = 0;
                                goto LAB_001022d8;
                              }
                              EVP_MD_CTX_set_flags(*(EVP_MD_CTX **)(si + 0x48),0x400);
                            }
LAB_00102288:
                            lVar6 = *(long *)(piVar8 + 10);
                            if (lVar6 == 0) {
                              lVar6 = OPENSSL_sk_new_null();
                              *(long *)(piVar8 + 10) = lVar6;
                              if (lVar6 != 0) goto LAB_00102296;
                            }
                            else {
LAB_00102296:
                              iVar1 = OPENSSL_sk_push(lVar6,si);
                              if (iVar1 != 0) goto LAB_001022ea;
                            }
                            ERR_new();
                            uVar4 = 0x225;
                            goto LAB_001022b3;
                          }
                          psVar11 = CMS_get0_SignerInfos(cms);
                          for (iVar1 = 0; iVar2 = OPENSSL_sk_num(psVar11), iVar1 < iVar2;
                              iVar1 = iVar1 + 1) {
                            si_00 = (CMS_SignerInfo *)OPENSSL_sk_value(psVar11,iVar1);
                            if (((si != (ASN1_VALUE *)si_00) &&
                                (iVar2 = CMS_signed_get_attr_count(si_00), -1 < iVar2)) &&
                               (iVar2 = OBJ_cmp((ASN1_OBJECT *)**(undefined8 **)(si + 0x10),
                                                (ASN1_OBJECT *)**(undefined8 **)(si_00 + 0x10)),
                               iVar2 == 0)) {
                              pAVar12 = OBJ_nid2obj(0x33);
                              bytes = CMS_signed_get0_data_by_OBJ(si_00,pAVar12,-3,4);
                              if (bytes == (void *)0x0) {
                                ERR_new();
                              ...
                              iVar1 = CMS_signed_add1_attr_by_NID
                                                ((CMS_SignerInfo *)si,0x33,4,bytes,-1);
                              if ((iVar1 == 0) ||
                                 (iVar1 = CMS_signed_add1_attr_by_NID
                                                    ((CMS_SignerInfo *)si,0x32,6,
                                                     (void *)**(undefined8 **)
                                                               (*(long *)(cms + 8) + 0x10),-1),
                                 iVar1 < 1)) goto LAB_001022d8;
                              if ((flags & 0x44000) != 0) goto LAB_0010242e;
                              iVar1 = CMS_SignerInfo_sign((CMS_SignerInfo *)si);
                              if (iVar1 == 0) goto LAB_001022d8;
                              goto LAB_001026d0;
                            }
                          }
                          ERR_new();
                          ...
                          iVar1 = EVP_MD_is_a(md,&_LC8);
                          if (iVar1 == 0) {
                            lVar6 = OSSL_ESS_signing_cert_v2_new_init(md,signer,0,1);
                            if (lVar6 != 0) {
                              iVar1 = i2d_ESS_SIGNING_CERT_V2(lVar6,0);
                              if ((0 < iVar1) &&
                                 (pAVar12 = (ASN1_OBJECT *)
                                            CRYPTO_malloc(iVar1,"crypto/cms/cms_sd.c",0x147),
                                 pAVar12 != (ASN1_OBJECT *)0x0)) {
                                local_80 = pAVar12;
                                i2d_ESS_SIGNING_CERT_V2(lVar6,&local_80);
                                pAVar13 = ASN1_STRING_new();
                                if ((pAVar13 != (ASN1_STRING *)0x0) &&
                                   (iVar1 = ASN1_STRING_set(pAVar13,pAVar12,iVar1), iVar1 != 0)) {
                                  CRYPTO_free(pAVar12);
                                  iVar1 = CMS_signed_add1_attr_by_NID
                                                    ((CMS_SignerInfo *)si,0x43e,0x10,pAVar13,-1);
                                  ASN1_STRING_free(pAVar13);
                                  ESS_SIGNING_CERT_V2_free(lVar6);
                                  goto LAB_0010288a;
                                }
                                ASN1_STRING_free(pAVar13);
                                CRYPTO_free(pAVar12);
                            ...
                            lVar6 = OSSL_ESS_signing_cert_new_init(signer,0,1);
                            if (lVar6 != 0) {
                              iVar1 = i2d_ESS_SIGNING_CERT(lVar6,0);
                              if ((0 < iVar1) &&
                                 (pAVar12 = (ASN1_OBJECT *)
                                            CRYPTO_malloc(iVar1,"crypto/cms/cms_sd.c",0x12e),
                                 pAVar12 != (ASN1_OBJECT *)0x0)) {
                                local_80 = pAVar12;
                                i2d_ESS_SIGNING_CERT(lVar6,&local_80);
                                pAVar13 = ASN1_STRING_new();
                                if ((pAVar13 != (ASN1_STRING *)0x0) &&
                                   (iVar1 = ASN1_STRING_set(pAVar13,pAVar12,iVar1), iVar1 != 0)) {
                                  CRYPTO_free(pAVar12);
                                  iVar1 = CMS_signed_add1_attr_by_NID
                                                    ((CMS_SignerInfo *)si,0xdf,0x10,pAVar13,-1);
                                  ASN1_STRING_free(pAVar13);
                                  ESS_SIGNING_CERT_free(lVar6);
LAB_0010288a:
                                  if (iVar1 != 0) goto LAB_00102420;
                                  goto LAB_001022d8;
                                }
                                ASN1_STRING_free(pAVar13);
                                CRYPTO_free(pAVar12);
                      ...
                      iVar1 = CMS_add_standard_smimecap((stack_st_X509_ALGOR **)&local_80);
                      if (iVar1 == 0) {
                        OPENSSL_sk_pop_free(local_80,X509_ALGOR_free);
                      }
                      else {
                        iVar1 = CMS_add_smimecap((CMS_SignerInfo *)si,
                                                 (stack_st_X509_ALGOR *)local_80);
                        OPENSSL_sk_pop_free(local_80,X509_ALGOR_free);
                        if (iVar1 != 0) goto LAB_00102401;
                      }
                      ERR_new();
                      uVar4 = 0x1d6;
                    }
                    else {
                      if ((flags & 0x100) == 0) goto LAB_001023e8;
                      if (((flags & 2) != 0) || (iVar1 = CMS_add1_cert(cms,signer), iVar1 != 0)) {
                        uVar7 = ossl_cms_ctx_get0_propq(uVar4);
                        uVar9 = *(undefined8 *)(si + 0x40);
                        uVar4 = ossl_cms_ctx_get0_libctx(uVar4);
                        ctx = (EVP_PKEY_CTX *)EVP_PKEY_CTX_new_from_pkey(uVar4,uVar9,uVar7);
                        *(EVP_PKEY_CTX **)(si + 0x50) = ctx;
                        if (((ctx == (EVP_PKEY_CTX *)0x0) ||
                            (iVar1 = EVP_PKEY_sign_init(ctx), iVar1 < 1)) ||
                           (iVar1 = EVP_PKEY_CTX_set_signature_md(*(undefined8 *)(si + 0x50),md),
                           iVar1 < 1)) goto LAB_001022d8;
                        goto LAB_00102288;
                      }
LAB_001026ee:

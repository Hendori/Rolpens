...

{
  ...
  if (p7 == (PKCS7 *)0x0) {
    ...
    if (iVar2 == 0x16) {
      ...
      if ((lVar4 == 0) || (indata != (BIO *)0x0)) {
        if (((flags & 0x10000U) == 0) ||
           ((lVar4 = PKCS7_ctrl(p7,2,0,(char *)0x0), lVar4 != 0 || (indata == (BIO *)0x0)))) {
          psVar5 = PKCS7_get_signer_info(p7);
          if ((psVar5 == (stack_st_PKCS7_SIGNER_INFO *)0x0) ||
             (iVar2 = OPENSSL_sk_num(psVar5), iVar2 == 0)) {
            ERR_new();
            ...
            if (psVar6 != (stack_st_X509 *)0x0) {
              uVar7 = ossl_pkcs7_get0_ctx(p7);
              uVar8 = ossl_pkcs7_ctx_get0_propq(uVar7);
              uVar7 = ossl_pkcs7_ctx_get0_libctx(uVar7);
              ctx = (X509_STORE_CTX *)X509_STORE_CTX_new_ex(uVar7,uVar8);
              if (ctx != (X509_STORE_CTX *)0x0) {
                uVar1 = flags & 0x20;
                if ((flags & 0x20U) == 0) {
                  iVar2 = ossl_x509_add_certs_new(&local_48,certs,4);
                  if (iVar2 != 0) {
                    uVar7 = pkcs7_get0_certificates(p7);
                    local_58._0_4_ = flags & 8;
                    if (((flags & 8U) != 0) ||
                       (iVar2 = ossl_x509_add_certs_new(&local_48,uVar7,4), iVar2 != 0)) {
                      for (; iVar2 = OPENSSL_sk_num(psVar6), (int)uVar1 < iVar2; uVar1 = uVar1 + 1)
                      {
                        pXVar9 = (X509 *)OPENSSL_sk_value(psVar6,uVar1);
                        iVar2 = X509_STORE_CTX_init(ctx,store,pXVar9,local_48);
                        if (iVar2 == 0) {
                          ERR_new();
                          b = (BIO *)0x0;
                        ...
                        if (((uint)local_58 == 0) &&
                           (iVar2 = X509_STORE_CTX_set_default(ctx,"smime_sign"), iVar2 == 0))
                        goto LAB_00100cec;
                        if ((flags & 0x2000U) == 0) {
                        ...
                        if (iVar2 < 1) {
                          ...
                          pcVar10 = X509_verify_cert_error_string((long)iVar2);
                          ERR_set_error(0x21,0x75,"Verify error: %s",pcVar10);
                          goto LAB_00100cec;
                        }
                      }
                      goto LAB_00100d88;
...
LAB_00100d88:
                  ...
                  if (b != (BIO *)0x0) {
                    ...
                    if ((flags & 1U) == 0) {
LAB_00100dda:
                      local_78 = CRYPTO_malloc(0x1000,"crypto/pkcs7/pk7_smime.c",0x143);
                      if (local_78 != (void *)0x0) {
                        while (iVar2 = BIO_read(b,local_78,0x1000), 0 < iVar2) {
                          if (local_58 == (BIO *)0x0) goto LAB_00100e30;
                          BIO_write(local_58,local_78,iVar2);
                        }
                        goto LAB_00100e46;
                      }
                    }
                      ...
                      type = BIO_s_mem();
                      local_58 = BIO_new(type);
                      if (local_58 != (BIO *)0x0) {
                        BIO_ctrl(local_58,0x82,0,(void *)0x0);
                        goto LAB_00100dda;
                      }
                      ERR_new();
...
LAB_00100e30:
  do {
    iVar2 = BIO_read(b,local_78,0x1000);
  } while (0 < iVar2);
LAB_00100e46:
  if ((flags & 1U) == 0) {
LAB_00100e4f:
    if ((flags & 4U) == 0) {
      for (iVar2 = 0; iVar3 = OPENSSL_sk_num(psVar5), iVar2 < iVar3; iVar2 = iVar2 + 1) {
        si = (PKCS7_SIGNER_INFO *)OPENSSL_sk_value(psVar5,iVar2);
        pXVar9 = (X509 *)OPENSSL_sk_value(psVar6,iVar2);
        iVar3 = PKCS7_signatureVerify(b,p7,si,pXVar9);
        if (iVar3 < 1) {
          ERR_new();

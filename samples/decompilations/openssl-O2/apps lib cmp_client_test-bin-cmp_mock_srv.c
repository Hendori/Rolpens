...
bool refcert_cmp(X509 *param_1,X509_NAME *param_2,ASN1_INTEGER *param_3)

{
  ...
  y = (ASN1_INTEGER *)X509_get0_serialNumber(param_1);
  if (b != (X509_NAME *)0x0) {
  ...
  if (y != (ASN1_INTEGER *)0x0) {
    iVar1 = ASN1_INTEGER_cmp(param_3,y);
    return iVar1 == 0;
  }
  return true;
}
...
undefined8 process_rr(undefined8 param_1,long param_2,long param_3,long param_4)
  ...
  if ((puVar3 == (undefined8 *)0x0) || (param_2 == 0)) {
    ...
    if ((iVar2 != 1) && (iVar1 = OSSL_CMP_MSG_get_bodytype(param_2), iVar2 != iVar1)) {
      if ((param_4 != 0 || param_3 != 0) &&
         (iVar2 = refcert_cmp(*puVar3,param_3,param_4), iVar2 == 0)) {
        ERR_new();
...
LAB_00100c52:
    ...
    *param_8 = 0;
    ...
    if (iVar2 == 2) {
      iVar2 = 0;
      uVar6 = OSSL_CMP_MSG_get0_header(param_2);
      uVar6 = OSSL_CMP_HDR_get0_geninfo_ITAVs(uVar6);
      while( true ) {
        iVar3 = OPENSSL_sk_num(uVar6);
        if (iVar3 <= iVar2) break;
        uVar7 = OPENSSL_sk_value(uVar6,iVar2);
        o = (ASN1_OBJECT *)OSSL_CMP_ITAV_get0_type(uVar7);
        iVar3 = OBJ_obj2nid(o);
        if (iVar3 == 0x4e7) {
          iVar2 = OSSL_CMP_ITAV_get0_certProfile(uVar7,&local_48);
          if (iVar2 == 0) goto LAB_00100c52;
          iVar2 = OPENSSL_sk_num(local_48);
          if (iVar2 < 1) {
            ERR_new();
            uVar6 = 0x152;
LAB_00100e67:
            ERR_set_debug("apps/lib/cmp_mock_srv.c",uVar6,"process_cert_request");
            ERR_set_error(0x3a,0xc4,0);
            goto LAB_00100c52;
          }
          lVar5 = OPENSSL_sk_value(local_48,0);
          if (lVar5 != 0) {
            __s1 = (char *)ASN1_STRING_get0_data(lVar5);
            if (__s1 != (char *)0x0) {
    ...
    if (((iVar1 == 7) && (param_4 != 0)) && (*plVar4 != 0)) {
      ...
      if (lVar5 == 0) {
        ...
        uVar6 = OSSL_CRMF_CERTID_get0_serialNumber();
        uVar7 = OSSL_CRMF_CERTID_get0_issuer(lVar5);
        iVar1 = refcert_cmp(*plVar4,uVar7,uVar6);
        if (iVar1 != 0) goto LAB_00100baa;
        ERR_new();
...
LAB_00100baa:
    if ((X509 *)plVar4[1] != (X509 *)0x0) {
      a = X509_dup((X509 *)plVar4[1]);
      *param_6 = a;
      if (a != (X509 *)0x0) goto LAB_00100bc1;
LAB_00100c24:
      X509_free(a);
      *param_6 = 0;
...
LAB_00100ec0:
        ...
        pkey = (EVP_PKEY *)EVP_PKEY_dup();
        if (pkey == (EVP_PKEY *)0x0) goto LAB_00100ec0;
        uVar6 = OSSL_CMP_SRV_CTX_get0_cmp_ctx(param_1);
        iVar1 = OSSL_CMP_CTX_set0_newPkey(uVar6,1,pkey);
        if (iVar1 != 0) goto LAB_00100bdd;
      }
      EVP_PKEY_free(pkey);
      a = (X509 *)*param_6;
      goto LAB_00100c24;
...
LAB_00100bdd:
    ...
    if (plVar4[9] == 0) goto LAB_00100c52;
...
void mock_srv_ctx_free_part_0(undefined8 *param_1)

{
  OSSL_CMP_PKISI_free(param_1[9]);
  X509_free((X509 *)*param_1);
  X509_free((X509 *)param_1[1]);
  OSSL_STACK_OF_X509_free(param_1[4]);
  OSSL_STACK_OF_X509_free(param_1[5]);
  OSSL_CMP_MSG_free(param_1[0xb]);
  CRYPTO_free(param_1);
  return;
}
...

{
  ...
  lVar3 = CRYPTO_zalloc(0x70,"apps/lib/cmp_mock_srv.c",0x35);
  if (lVar3 != 0) {
    lVar4 = OSSL_CMP_PKISI_new();
    *(long *)(lVar3 + 0x48) = lVar4;
    if ((((lVar4 != 0) && (*(undefined4 *)(lVar3 + 0x50) = 0xffffffff, lVar2 != 0)) &&
        (iVar1 = OSSL_CMP_SRV_CTX_init
                           (lVar2,lVar3,process_cert_request,process_rr,process_genm,process_error),
        iVar1 != 0)) &&
       (iVar1 = OSSL_CMP_SRV_CTX_init_trans(lVar2,delayed_delivery,clean_transaction,0x100000),
       iVar1 != 0)) {
      return lVar2;
    }
    mock_srv_ctx_free_part_0(lVar3);
  }
...

{
  ...
  if (param_1 != 0) {
    lVar1 = OSSL_CMP_SRV_CTX_get0_custom_ctx();
    if (lVar1 != 0) {
      mock_srv_ctx_free_part_0(lVar1);
    }
  }

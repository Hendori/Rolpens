...
ulong check_purpose_smime_sign(undefined8 param_1,long param_2,int param_3)
...
ulong check_purpose_code_sign(undefined8 param_1,X509 *param_2,int param_3)

{
  ...
  if (param_3 != 0) {
    uVar3 = check_ca(param_2);
    return uVar3;
  }
  if (((((ulong)param_2[1].name & 2) != 0) && (((ulong)param_2[1].name & 0x8000000000) != 0)) &&
     (((ulong)param_2[1].name & 0x600000000) == 0)) {
    iVar2 = X509_get_ext_by_NID(param_2,0x53,-1);
    if (-1 < iVar2) {
      ex = X509_get_ext(param_2,iVar2);
      iVar2 = X509_EXTENSION_get_critical(ex);
      if (((iVar2 != 0) && (((ulong)param_2[1].name & 4) != 0)) &&
         (psVar1 = param_2[1].ex_data.sk, ((ulong)psVar1 & 8) != 0)) {
        return (ulong)(((ulong)psVar1 & 0x101) == 0);
      }
    }
  }
  return 0;
...
ulong check_purpose_ssl_server(undefined8 param_1,long param_2,int param_3)

{
  ...
  if (((*(uint *)(param_2 + 0xe8) & 4) == 0) || (uVar1 = 0, (*(byte *)(param_2 + 0xf0) & 0x11) != 0)
    ...
    if (param_3 == 0) {
      if (((*(uint *)(param_2 + 0xe8) & 8) == 0) ||
         (uVar1 = 0, (*(byte *)(param_2 + 0xf4) & 0x40) != 0)) {
        return (ulong)((*(ulong *)(param_2 + 0xe8) & 0xa800000002) != 2);
      }
    }
    else {
      uVar1 = check_ca(param_2);
...
ulong check_purpose_smime_encrypt(undefined8 param_1,long param_2,int param_3)
  ...
  if (((*(uint *)(param_2 + 0xe8) & 4) == 0) || (uVar1 = 0, (*(byte *)(param_2 + 0xf0) & 0x11) != 0)
    ...
    if (param_3 == 0) {
      ...
      if ((*(ulong *)(param_2 + 0xe8) & 0xa800000002) != 2) {
        return (ulong)((*(ulong *)(param_2 + 0xe8) & 0x2000000002) != 2);
      }
    }
    else {
      uVar1 = check_ca(param_2);
...

{
  ...
  if ((purpose != 0) && (iVar1 = X509_PURPOSE_get_by_id(purpose), iVar1 == -1)) {
    ERR_new();
...

{
  ...
  if (iVar1 == -1) {
    ...
    pcVar3 = ptr->name;
    ptr->sname = pcVar4;
    if ((pcVar4 == (char *)0x0) || (pcVar3 == (char *)0x0)) goto LAB_00100c11;
    local_3c = 0;
  }
  else {
    ptr = X509_PURPOSE_get0(iVar1);
    local_3c = ptr->purpose;
    if ((id != local_3c) && (iVar2 = X509_PURPOSE_get_by_id(id), iVar2 != -1)) {
      ERR_new();
      uVar5 = 0xd4;
LAB_00100ad6:
  ...
  if ((xptable == 0) && (xptable = OPENSSL_sk_new(0x100000), xptable == 0)) {
    ERR_new(0);
    uVar5 = 0xf1;
  }
  else {
...

{
  ...
  if (((akid->keyid != (ASN1_OCTET_STRING *)0x0) &&
      (b = *(ASN1_OCTET_STRING **)&issuer[1].ex_data.dummy, b != (ASN1_OCTET_STRING *)0x0)) &&
...
LAB_00100eeb:
    uVar3 = (*(uint *)&param_1[1].name >> 7 ^ 1) & 1;
    goto LAB_00100efa;
  }
...
LAB_0010101e:
        *(uint *)&param_1[1].name = uVar3 | 0x80;
      }
      lVar6 = -1;
    ...
    if (pvVar8 == (void *)0x0) {
      ...
      *(uint *)&param_1[1].name = *(uint *)&param_1[1].name | 4;
      ...
      while (iVar4 = OPENSSL_sk_num(pvVar8), local_38 < iVar4) {
        ...
        if (iVar4 < 0xb5) {
          if (iVar4 < 0x81) goto switchD_0010113d_caseD_86;
          switch(iVar4) {
          case 0x81:
          ...
          case 0x85:
            *(uint *)&param_1[1].ex_data.sk = *(uint *)&param_1[1].ex_data.sk | 0x40;
            ...
            break;
          default:
            goto switchD_0010113d_caseD_86;
          case 0x89:
          case 0x8b:
    ...
    *(void **)&param_1[1].ex_data.dummy = pvVar8;
    ...
    if (iVar4 == 0) {
      *(uint *)&param_1[1].name = *(uint *)&param_1[1].name | 0x20;
      ...
      if (iVar4 == 0) {
        uVar15 = X509_get0_pubkey(param_1);
        iVar4 = check_sig_alg_match(uVar15,param_1);
        if (iVar4 == 0) {
      ...
      *(uint *)&param_1[1].name = *(uint *)&param_1[1].name | 0x80;
      ...
      while (iVar4 = OPENSSL_sk_num(pvVar8), local_34 < iVar4) {
        ...
        if (piVar13 == (int *)0x0) {
          ...
          piVar13 = (int *)*puVar11;
          if (piVar12 != (int *)0x0) goto LAB_00101385;
          uVar3 = 0x807f;
LAB_001013ac:
          *(uint *)(puVar11 + 3) = uVar3;
          if (piVar13 != (int *)0x0) goto LAB_001013b4;
        }
        else {
          piVar12 = (int *)puVar11[1];
          if (piVar12 != (int *)0x0) {
...
LAB_001013b4:
          ...
          if (*piVar13 == 1) {
            ...
            if (0 < iVar5) {
              do {
                ...
                if (*piVar13 == 4) {
                  ...
                  if (pXVar10 != (X509_NAME *)0x0) goto LAB_00101408;
                  break;
                }
                iVar4 = iVar4 + 1;
                iVar5 = OPENSSL_sk_num(puVar11[2]);
            ...
            pXVar10 = X509_get_issuer_name(param_1);
LAB_00101408:
            iVar4 = DIST_POINT_set_dpname((DIST_POINT_NAME *)*puVar11,pXVar10);
            if (iVar4 == 0) break;
          }
        }
        local_34 = local_34 + 1;
  ...
  if (iVar1 != 0) {
    ...
    if (iVar1 != -1) {
      pXVar2 = X509_PURPOSE_get0(iVar1);
                    /* WARNING: Could not recover jumptable at 0x00101952. Too many branches */

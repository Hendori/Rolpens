...

{
  ...
  if (iVar1 != 0) {
    ...
    if (ptr != (undefined8 *)0x0) {
      *ptr = param_1;
      iVar1 = ml_dsa_gen_set_params(ptr,param_3);
      if (iVar1 != 0) {
        return ptr;
      }
      CRYPTO_free(ptr);
...

{
  ...
  iVar1 = ossl_prov_is_running();
  if ((param_1 == 0) || (iVar1 == 0)) goto LAB_001007f0;
  uVar2 = param_2 & 3;
  if ((param_2 & 3) == 0) goto LAB_0010078b;
...
LAB_001008c5:
          ...
          if (local_40 != 0) goto LAB_00100aa1;
          if (local_48 != 0) goto LAB_001008ad;
        }
        uVar2 = 1;
        goto LAB_0010078b;
      }
...
undefined1  [16] ossl_prov_ml_dsa_new(undefined8 param_1,undefined8 param_2,undefined4 param_3)

{
  ...
  if (iVar2 != 0) {
    ...
    auVar7 = ossl_ml_dsa_key_new(uVar4,param_2,param_3);
    uVar5 = auVar7._8_8_;
    if (auVar7._0_8_ != 0) {
      uVar6 = 2;
      uVar3 = ossl_prov_ctx_get_bool_param(param_1,"ml-dsa.retain_seed",1);
      if (uVar3 != 0) {
        uVar6 = 0;
        uVar3 = 2;
      }
      iVar2 = ossl_prov_ctx_get_bool_param(param_1,"ml-dsa.prefer_seed",1);
      if (iVar2 == 0) {
        uVar6 = uVar6 | 1;
      }
      else {
      ...
      ossl_ml_dsa_set_prekey(auVar7._0_8_,uVar3,uVar6,0,0,0,0);
      auVar7._8_8_ = 0x100d00;
      return auVar7;
    }
  }
  auVar1._8_8_ = 0;
...
long ml_dsa_gen(undefined8 *param_1,undefined4 param_2)

{
  ...
  lVar2 = ossl_prov_ml_dsa_new(*param_1,param_1[1],param_2);
  if (lVar2 != 0) {
    if ((param_1[6] == 0) ||
...
void ml_dsa_44_gen(undefined8 param_1)

{
  ml_dsa_gen(param_1,0x5b1);
  return;
}



void ml_dsa_65_gen(undefined8 param_1)

{
  ml_dsa_gen(param_1,0x5b2);
  return;
}



void ml_dsa_87_gen(undefined8 param_1)

{
  ml_dsa_gen(param_1,0x5b3);
  return;
}

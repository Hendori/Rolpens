  ...
  if (param_1->engine != (ENGINE *)0x0) {
    ...
    if ((param_1->pctx != (EVP_PKEY_CTX *)0x0) && (0 < *(int *)(param_1->engine + 0x4c))) {
      ...
      if ((param_2 != 0) || (iVar1 == 0)) {
        CRYPTO_clear_free(param_1->pctx,(long)*(int *)(param_1->engine + 0x4c),"crypto/evp/digest.c"
                          ,0x26);
...

{
  ...
  if (((ulong)ctx->md_data & 0x800) == 0) {
    p_Var2 = ctx->update;
    if (((p_Var2 == (_func_1088 *)0x0) || (uVar1 = *(uint *)p_Var2, (uVar1 & 0xc1f0) == 0)) ||
       (*(long *)(p_Var2 + 0x30) == 0)) {
      pEVar3 = ctx->engine;
      if (((pEVar3 == (ENGINE *)0x0) || (*(long *)(pEVar3 + 0x70) == 0)) ||
...

{
  ...
  if (piVar1 != (int *)0x0) {
    if ((((*piVar1 - 0x80U & 0xffffff7f) == 0) && (*(long *)(piVar1 + 0xc) != 0)) &&
       (*(code **)(*(long *)(piVar1 + 10) + 0x110) != (code *)0x0)) {
  ...
  if ((*(long *)(param_1 + 8) != 0) &&
     (UNRECOVERED_JUMPTABLE = *(code **)(*(long *)(param_1 + 8) + 0xd0),
  ...
  if (pEVar3 == (ENGINE *)0x0) {
    ...
    if (*(long *)(pEVar3 + 0x98) == 0) {
      ...
      if (((ulong)param_1->md_data & 0x800) == 0) {
        ...
        if (-1 < iVar1) {
          uVar2 = (**(code **)(param_1->engine + 0x98))
                            (param_1[1].engine,param_2,&local_90,local_90);
        }
...

{
  ...
  if (piVar1 != (int *)0x0) {
    if ((((*piVar1 - 0x80U & 0xffffff7f) == 0) && (*(long *)(piVar1 + 0xc) != 0)) &&
       (*(code **)(*(long *)(piVar1 + 10) + 0x118) != (code *)0x0)) {
...

{
  ...
  if (piVar1 != (int *)0x0) {
    if ((((*piVar1 - 0x80U & 0xffffff7f) == 0) && (*(long *)(piVar1 + 0xc) != 0)) &&
       (*(code **)(*(long *)(piVar1 + 10) + 0x100) != (code *)0x0)) {
...

{
  ...
  if (piVar1 != (int *)0x0) {
    if ((((*piVar1 - 0x80U & 0xffffff7f) == 0) && (*(long *)(piVar1 + 0xc) != 0)) &&
       (*(code **)(*(long *)(piVar1 + 10) + 0x108) != (code *)0x0)) {
...

{
  ...
  if (param_2 == (EVP_MD *)0x0) {
    ...
    param_2 = pEVar5;
    if (pEVar6 != (ENGINE *)0x0) goto LAB_0010109b;
LAB_001010a6:
...
LAB_0010141f:
          ...
          if (param_2->md_ctrl != (_func_1085 *)0x0) goto LAB_0010141f;
          pcVar8 = "NULL";
          if (param_2->type != 0) {
...
LAB_00101307:
        ...
        if ((code *)param_2[1].flags != (code *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00101342. Too many branches */
                    /* WARNING: Treating indirect jump as call */
          iVar4 = (*(code *)param_2[1].flags)(param_1[1].engine,param_3);
          return iVar4;
        }
        ERR_new();
        uVar9 = 0x12a;
...
LAB_001010bc:
    ...
    if (param_4 == (ENGINE *)0x0) {
      ...
      if (pEVar6 != (ENGINE *)0x0) goto LAB_001010ff;
    }
    else {
      ...
      if (iVar4 == 0) {
        ...
        uVar9 = 0x137;
LAB_001013b9:
        ERR_set_debug("crypto/evp/digest.c",uVar9,"evp_md_init_internal");
        ERR_set_error(6,0x86,0);
        return 0;
      }
LAB_001010ff:
      pcVar8 = (char *)(ulong)(uint)param_2->type;
    ...
    if ((EVP_MD *)param_1->engine == param_2) goto LAB_001011e0;
    pcVar8 = (char *)0x1;
    ...
    if (((ulong)param_1->md_data & 0x100) == 0) {
      ...
      if (ctx == (EVP_PKEY_CTX *)0x0) goto LAB_00101175;
    }
    else {
      ctx = (EVP_PKEY_CTX *)param_1->update;
      if (ctx == (EVP_PKEY_CTX *)0x0) {
    ...
    uVar1 = *(uint *)ctx;
joined_r0x00101156:
    if (((uVar1 & 0xc1f0) == 0) || (*(long *)(ctx + 0x28) == 0)) {
    ...
    if ((pEVar6 == (ENGINE *)0x0) || (pEVar5 = (EVP_MD *)param_1->engine, pEVar5 == (EVP_MD *)0x0))
    goto LAB_001010a6;
LAB_0010109b:
    sVar7 = extraout_RDX;
    if (param_2->type != pEVar5->type) goto LAB_001010a6;
LAB_001011e0:
    ctx = (EVP_PKEY_CTX *)param_1->update;
    if (ctx != (EVP_PKEY_CTX *)0x0) {
      uVar1 = *(uint *)ctx;
      goto joined_r0x00101156;
    }
  }
  if (((ulong)param_1->md_data & 0x100) != 0) {
    return 1;
...
LAB_00101175:
                    ...
                    /* WARNING: Treating indirect jump as call */
  iVar4 = (*param_2->update)(param_1,pcVar8,sVar7);
  return iVar4;
}
...

{
  ...
  if (pEVar5 == (ENGINE *)0x0) {
    ...
    if ((*(long *)(pEVar5 + 0x70) == 0) || (((ulong)in->md_data & 0x100) != 0)) {
      ...
      if ((in->pctx != (EVP_PKEY_CTX *)0x0) && (iVar4 = *(int *)(out->engine + 0x4c), iVar4 != 0)) {
      ...
      if (*(code **)(out->engine + 0x38) == (code *)0x0) {
        return 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00101801. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    ...
    if (*(long *)(pEVar5 + 0xc0) == 0) {
      ...
      uVar7 = 0x268;
LAB_00101971:
      ERR_set_debug("crypto/evp/digest.c",uVar7,"EVP_MD_CTX_copy_ex");
...
int * evp_md_from_algorithm(int param_1,long param_2,long param_3)
...
LAB_001020c0:
          ...
          if (iVar4 == 0) goto LAB_001020b0;
          if ((iVar4 != 5) && (iVar4 != 6)) goto LAB_001020c0;
        }
...

{
  evp_generic_fetch_from_prov
            (param_1,1,param_2,param_3,evp_md_from_algorithm,evp_md_up_ref,evp_md_free);
  return;
}
...

{
  ...
  lVar1 = 0;
  do {
    if ((&DAT_00102444)[lVar1 * 2] == param_1) {
...

{
  ...
  lVar1 = 0;
  do {
    if ((&ossl_hmacmd_pairs)[lVar1 * 2] == param_1) {
      return (&DAT_00102444)[lVar1 * 2];
    }
    lVar1 = lVar1 + 1;
  } while (lVar1 != 0xf);
  return 0;

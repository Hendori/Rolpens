...

{
  ...
  if ((*param_2 == 0) ||
     ((((iVar1 = BIO_printf(param_3,"%*sadmissionAuthority:\n",(ulong)param_4,&_LC2), 0 < iVar1 &&
        (iVar1 = BIO_printf(param_3,"%*s  ",(ulong)param_4,&_LC2), 0 < iVar1)) &&
       (iVar1 = GENERAL_NAME_print(param_3,(GENERAL_NAME *)*param_2), 0 < iVar1)) &&
      (iVar1 = BIO_printf(param_3,"\n"), 0 < iVar1)))) {
    uVar11 = (ulong)param_4;
    uVar9 = 0;
    while (iVar1 = OPENSSL_sk_num(param_2[1]), (int)uVar9 < iVar1) {
      uVar8 = uVar9 + 1;
      plVar3 = (long *)OPENSSL_sk_value(param_2[1],uVar9);
      iVar1 = BIO_printf(param_3,"%*sEntry %0d:\n",uVar11,&_LC2,(ulong)uVar8);
      if ((iVar1 < 1) ||
         (((*plVar3 != 0 &&
           (((iVar1 = BIO_printf(param_3,"%*s  admissionAuthority:\n",uVar11,&_LC2), iVar1 < 1 ||
             (iVar1 = BIO_printf(param_3,"%*s    ",uVar11,&_LC2), iVar1 < 1)) ||
      ...
      goto LAB_001005e0;
      local_f0 = 0;
      while (iVar1 = OPENSSL_sk_num(plVar3[2]), uVar9 = uVar8, (int)local_f0 < iVar1) {
        uVar9 = local_f0 + 1;
        plVar4 = (long *)OPENSSL_sk_value(plVar3[2],local_f0);
        iVar1 = BIO_printf(param_3,"%*s  Profession Info Entry %0d:\n",uVar11,&_LC2,(ulong)uVar9);
        if (((iVar1 < 1) ||
            ((plVar4[3] != 0 &&
             (((iVar1 = BIO_printf(param_3,"%*s    registrationNumber: ",uVar11,&_LC2), iVar1 < 1 ||
        ...
        if (plVar4[2] != 0) {
          ...
          for (iVar1 = 0; iVar2 = OPENSSL_sk_num(plVar4[2]), iVar1 < iVar2; iVar1 = iVar1 + 1) {
            ...
            iVar2 = BIO_printf(param_3,"%*s      %s%s%s%s\n",uVar11,&_LC2,pcVar5,puVar10,local_c8,
                               puVar6);
            if (iVar2 < 1) goto LAB_001005e0;
          }
        }
      }
    }

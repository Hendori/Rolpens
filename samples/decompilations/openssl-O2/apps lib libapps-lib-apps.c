...

{
  ...
  if (((uVar7 & 0x80000000) != 0) || ((char)(uVar7 >> 0x17) != '\x14')) {
    ...
    uVar2 = (uint)uVar7;
    if (((uVar7 & 0x80000000) != 0) || ((char)(uVar7 >> 0x17) != '\x14')) goto LAB_001003e8;
  }
  ...
  if (uVar2 == 0x10b) {
    ...
    if (uVar2 == 0x86) {
      ...
      if (uVar2 != 0xfc) goto LAB_001003e8;
    }
  }
  else if (uVar2 == 0x410) {
    pcVar8 = 
    ...
    ;
    if (uVar2 != 0x418) goto LAB_001003e8;
  }
...
LAB_00100723:
    ...
    if (param_6 != 0) goto LAB_00100723;
  }
  return true;
}
...

{
  ...
  lVar1 = local_38;
  pCVar4 = conf;
  if (0 < iVar2) goto LAB_00100940;
  if (local_38 < 1) {
    uVar3 = opt_getprog();
    BIO_printf(_bio_err,"%s: Can\'t load ",uVar3);
    if (param_2 == 0) goto LAB_001009ea;
LAB_0010099e:
    ...
    if (param_2 != 0) goto LAB_0010099e;
LAB_001009ea:
...

{
  ...
  if (bVar3 != 0) {
    ...
    do {
      if ((*(byte *)((long)*ppuVar5 + (ulong)bVar3 * 2 + 1) & 0x20) == 0) {
...

{
  ...
  iVar1 = OPENSSL_strcasecmp(param_2,&_LC32);
  if (iVar1 == 0) {
    *param_1 = 0;
  }
  else {
  ...
  if (0 < (int)param_3) {
    do {
      while( true ) {
        ...
        if ((int)param_3 == lVar3) goto LAB_0010145b;
      }
      lVar3 = lVar3 + 1;
      BIO_printf(param_1,"0x%02X, ",(ulong)*pbVar1);
...

{
  ...
  if (v != (X509_STORE *)0x0) {
    if ((param_1 != 0) || (param_2 == 0)) {
      ...
      if (pXVar5 == (X509_LOOKUP *)0x0) goto LAB_001015a0;
      if (param_1 == 0) {
...

{
  ...
  if (iVar6 < 0xfa) {
    ...
    if (iVar6 < 0) {
      ...
      if (iVar6 < 0) {
        piVar4 = __errno_location();
        if ((*piVar4 == 0x14) || (*piVar4 == 2)) goto LAB_00102103;
        BIO_printf(_bio_err,"Unable to rename %s to %s\n",local_148,local_248);
        perror("reason");
      }
      else {
...
LAB_001023c0:
        ...
        *puVar8 = uVar1;
        uVar1 = *str;
        if (uVar1 != '\0') goto code_r0x001023d7;
        goto LAB_001023db;
      }
      uVar5 = opt_getprog();
...
LAB_00102479:
        ...
        uVar1 = *str;
        if (uVar1 == '\0') goto LAB_00102617;
        puVar11 = s;
        if (uVar1 != '=') goto LAB_001023c0;
LAB_001024db:
        *s = '\0';
        puVar8 = s + 1;
        puVar11 = s;
...
LAB_001027a0:
      ...
      if (iVar1 == 0) goto LAB_001027d8;
      iVar2 = BIO_write(b,auStack_448,iVar1);
      if (iVar2 != iVar1) goto LAB_001027a0;
      if (param_2 != -1) goto LAB_00102740;
      iVar1 = 0x400;
    } while( true );
  }
  uVar3 = 0xffffffff;
...
LAB_00102740:
  ...
  if (param_2 == 0) goto LAB_001027d8;
  goto LAB_0010274a;
LAB_001027d8:
...

{
  ...
  if (sVar2 - 1 < 0xfffe) {
    ...
    sVar3 = 0;
    while( true ) {
      if ((sVar3 == sVar2) || (pcVar1 = param_2 + sVar3, *pcVar1 == ',')) {
        if (sVar3 == sVar4) {
          sVar3 = sVar4 + 1;
          uVar6 = uVar6 + 1;
          sVar4 = sVar3;
...

{
  ...
  if ((param_1 == 0) || (param_8 == (ASN1_ITEM *)0x0)) {
    ...
    if (iVar1 != 0) {
      if (local_7c == 0) {
        if (param_4 == 0) goto LAB_001030f0;
        ERR_new();
        pvVar3 = (void *)0x0;
...

{
  ...
  if ((param_1 == (char *)0x0) || ((*param_1 == '-' && (param_1[1] == '\0')))) {
    ...
    if (param_4 != 0) goto LAB_00103720;
    if (pBVar2 != (BIO *)0x0) {
      return pBVar2;
    }
    ...
    pcVar1 = (char *)modestr((int)param_2,param_3);
    pBVar2 = BIO_new_file(param_1,pcVar1);
    if (param_4 != 0) {
LAB_00103720:
      ERR_clear_error();
      return pBVar2;
    ...
    pcVar1 = strerror(*piVar3);
    pcVar4 = "reading";
    if (((param_2 != 'r') && (pcVar4 = "writing", param_2 != 'w')) &&
       (pcVar4 = "appending", param_2 != 'a')) {
      pcVar4 = "(doing something)";
    }
    BIO_printf(_bio_err,"Can\'t open \"%s\" for %s, %s\n",param_1,pcVar4,pcVar1);
  }
  ERR_print_errors(_bio_err);
  return (BIO *)0x0;
}
...
LAB_00103e04:
  ...
  if (iVar1 == 0) {
    ...
    if (iVar1 == 0) {
      ...
      if (pwdbio_5 != (BIO *)0x0) goto LAB_00103d30;
...

{
  ...
  if (param_7 == (long *)0x0) {
    if (param_8 != (long *)0x0) {
      ...
      pcVar13 = "public key";
      *param_8 = 0;
      if (param_9 != (long *)0x0) goto LAB_001042ab;
      if (param_10 != (long *)0x0) goto LAB_001042ba;
      if (param_11 != (long *)0x0) goto LAB_001042cf;
      if (param_12 != (long *)0x0) goto LAB_001042e2;
      if (param_13 == (long *)0x0) {
        local_e0 = 3;
        goto LAB_00104305;
      }
      if (*param_13 == 0) goto LAB_001046f8;
LAB_001042fd:
      local_e0 = 0;
      goto LAB_00104305;
    }
...
LAB_00104937:
  ...
  *param_7 = 0;
  if (param_8 == (long *)0x0) {
    if (param_9 != (long *)0x0) goto LAB_001042a4;
    if (param_10 != (long *)0x0) goto LAB_00104504;
    if (param_11 == (long *)0x0) {
      if (param_12 != (long *)0x0) goto LAB_00104c2e;
      if (param_13 == (long *)0x0) {
        local_e0 = 4;
        pcVar13 = "private key";
        goto LAB_00104305;
...
LAB_001042d9:
      if (param_12 != (long *)0x0) goto LAB_001042e2;
joined_r0x001042f1:
      if (param_13 != (long *)0x0) goto LAB_001042f3;
      goto LAB_001042fd;
    }
LAB_00104a78:
    lVar6 = OPENSSL_sk_new_null();
    *param_11 = lVar6;
    if (lVar6 != 0) goto LAB_001042d9;
LAB_00104ba6:
    if (param_6 == 0) {
...
LAB_001042ba:
      ...
      if (param_11 != (long *)0x0) {
LAB_001042cf:
        if (*param_11 == 0) goto LAB_00104a78;
      }
      goto LAB_001042d9;
    }
    if (param_10 != (long *)0x0) {
LAB_00104504:
    ...
    if (param_11 != (long *)0x0) goto LAB_00104a61;
    if (param_12 != (long *)0x0) {
LAB_00104c2e:
      pcVar13 = "private key";
      goto LAB_001042e2;
    }
    if (param_13 != (long *)0x0) goto LAB_00104d10;
LAB_00104d1a:
    local_e0 = 0;
    pcVar13 = "private key";
LAB_00104305:
...
LAB_00104343:
      ...
      if (param_2 < 0xd) {
        if (param_2 == 4) {
          ...
          if (param_2 != 0xb) goto LAB_001043bb;
        }
        goto LAB_00104343;
      }
      puVar12 = (undefined8 *)0x0;
      pcVar11 = "PEM";
      if (param_2 == 0x8005) goto LAB_00104343;
    }
LAB_001043bb:
    if (param_1 == (char *)0x0) {
      if (param_3 == 0) {
      ...
      if (a != (BIO *)0x0) {
        uVar5 = get_ui_method();
        lVar6 = OSSL_STORE_attach(a,&_LC144,uVar3,uVar4,uVar5,&local_a8,puVar12,0,0);
        BIO_free(a);
        local_108 = "<stdin>";
        goto LAB_001043f9;
      }
...
LAB_00104668:
    ...
    if (param_6 == 0) {
      ...
      OSSL_STORE_close(lVar6);
      if (pcVar13 != (char *)0x0) goto LAB_001048b0;
    }
    else {
      OSSL_STORE_close(lVar6);
      if (pcVar13 != (char *)0x0) goto LAB_001044b5;
    }
LAB_0010446f:
    pcVar13 = "private key";
    if (0 < local_e0) {
...
/* WARNING: Removing unreachable block (ram,0x001055db) */
/* WARNING: Removing unreachable block (ram,0x00105610) */
/* WARNING: Removing unreachable block (ram,0x001055ea) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
...

{
  ...
  if ((param_4 == 0) ||
    ...
    uVar3 = get_passwd(param_5,param_6);
    iVar1 = load_key_certs_crls(param_1,0,0,uVar3,param_6,0,0,0,0,param_2,param_3,0,0);
    clear_free(uVar3);
    if (iVar1 != 0) {
      ...
      uVar3 = *param_3;
      for (iVar5 = 0; iVar2 = OPENSSL_sk_num(uVar3), iVar5 < iVar2; iVar5 = iVar5 + 1) {
        uVar4 = OPENSSL_sk_value(uVar3,iVar5);
        warn_cert(param_1,uVar4,1,param_7);
      }
      return iVar1;
    }
    if (param_3 != (undefined8 *)0x0) {
  ...
  if (param_1 != 0) {
    if (lVar2 != 0) {
      do {
        ...
        if (iVar1 == 0) goto LAB_001058a3;
        iVar1 = X509_add_certs(lVar2,local_48,5);
        if (iVar1 == 0) goto LAB_001058e0;
...
LAB_00105b9a:
    ...
    if (bp == (BIO *)0x0) goto LAB_00105c40;
    if (param_2 != 4) {
      if (param_2 != 0x8005) {
...

{
  ...
  if ((param_1 != (char *)0x0) && ((*param_1 != '-' || (param_1[1] != '\0')))) {
    ...
    pBVar1 = BIO_new_file(param_1,mode);
    ERR_clear_error();
    return pBVar1;
  }
  if (param_2 != 'r') {
    pBVar1 = (BIO *)dup_bio_out();
    ERR_clear_error();
    return pBVar1;
  }
  pBVar1 = (BIO *)dup_bio_in(param_3);
  ERR_clear_error();
  return pBVar1;
}
...

{
  ...
  if ((int)lVar2 < 1) {
    ...
    if (b == (BIO *)0x0) {
      ...
      if ((-1 < iVar1) && (uVar3 = 1, (long)iVar1 == *local_28)) goto LAB_0010603b;
...

{
  ...
  if ((param_2 == (char *)0x0) || (iVar1 = strcmp(param_2,"today"), iVar1 == 0)) {
    ...
    if (pAVar2 == (ASN1_TIME *)0x0) goto LAB_0010639b;
  }
  else {
...
LAB_0010639b:
  ...
  if ((param_3 == (char *)0x0) || (param_4 = strcmp(param_3,"today"), param_4 == 0)) {
    ...
    if (pAVar2 == (ASN1_TIME *)0x0) goto LAB_001063db;
  }
  else {
...

{
  ...
  if (s != (ASN1_TIME *)0x0) {
    if (param_2 == 0) {
      ...
      if (pAVar2 == (ASN1_TIME *)0x0) goto LAB_00106487;
    }
    else {
      iVar1 = ASN1_TIME_set_string_X509(s,param_2);
      if (iVar1 == 0) goto LAB_00106487;
    }
...
LAB_00106530:
    ...
    if (param_2 == 0) {
      ...
      if (pAVar2 == (ASN1_TIME *)0x0) goto LAB_00106530;
    }
    else {
      iVar1 = ASN1_TIME_set_string_X509(s,param_2);
      if (iVar1 == 0) goto LAB_00106530;
    }

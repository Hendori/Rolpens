...

{
  ...
  if ((param_5 == (BN_CTX *)0x0) &&
     (param_5 = (BN_CTX *)BN_CTX_new_ex(param_1[0x15]), local_40 = param_5, param_5 == (BN_CTX *)0x0
     )) {
    return 0;
  }
...
LAB_00100556:
    ...
    if (pcVar4 != (code *)0x0) {
      ...
      if (param_3 != (BIGNUM *)0x0) {
        ...
        if ((uVar1 == 0) || (uVar1 = 1, param_4 == (BIGNUM *)0x0)) goto LAB_0010051e;
        pcVar4 = *(code **)(*param_1 + 0x120);
      }
...
LAB_001006d9:
        ...
        if ((((iVar2 != 0) && (iVar2 = BN_mod_mul(r_00,r,a,m,param_2), iVar2 != 0)) &&
            (iVar2 = BN_lshift(r,r_00,2), iVar2 != 0)) &&
           (((iVar2 = BN_mod_sqr(r_00,a_00,m,param_2), iVar2 != 0 &&
             (iVar2 = BN_mul_word(r_00,0x1b), iVar2 != 0)) &&
            (iVar2 = BN_mod_add(a,r,r_00,m,param_2), iVar2 != 0)))) {
          iVar2 = BN_is_zero(a);
          uVar1 = (uint)(iVar2 == 0);
          goto LAB_00100723;
        }
        ...
        if ((*(code **)(*(long *)param_1 + 0x120) == (code *)0x0) ||
          ...
          if (iVar2 == 0) {
            ...
            if (pcVar1 == (code *)0x0) {
              ...
              if ((param_3 != (BIGNUM *)0x0) &&
                 (iVar2 = (*pcVar1)(param_1,param_3,*(undefined8 *)(param_2 + 0x10),param_5),
                 iVar2 == 0)) goto LAB_001009e0;
              if (param_4 != (BIGNUM *)0x0) {
...

{
  ...
  r = BN_CTX_get(param_5);
  r_00 = BN_CTX_get(param_5);
  if (r_00 == (BIGNUM *)0x0) goto LAB_00100ee0;
  ...
  if (*(int *)(param_3 + 0x28) == 0) {
    ...
    if (((iVar3 == 0) ||
        ((iVar3 = (*pcVar1)(param_1,a_02,*(undefined8 *)(param_4 + 0x10),a,param_5), iVar3 == 0 ||
         (iVar3 = (*pcVar1)(param_1,a,a,*(undefined8 *)(param_3 + 0x20),param_5), iVar3 == 0)))) ||
       (iVar3 = (*pcVar1)(param_1,a_03,*(undefined8 *)(param_4 + 0x18),a,param_5), iVar3 == 0))
    goto LAB_00100ee0;
  }
  else {
  ...
  if ((iVar3 == 0) || (iVar3 = BN_mod_sub_quick(r_00,a_01,a_03,m), iVar3 == 0)) goto LAB_00100ee0;
  iVar3 = BN_is_zero(r);
  if (iVar3 != 0) {
  ...
  if (*(int *)(param_3 + 0x28) == 0) {
    if (*(int *)(param_4 + 0x28) != 0) {
      ...
      goto joined_r0x0010126c;
    }
    iVar3 = (*pcVar1)(param_1,a,*(BIGNUM **)(param_3 + 0x20),*(undefined8 *)(param_4 + 0x20),param_5
                     );
    if (iVar3 == 0) goto LAB_00100ee0;
LAB_00101039:
    iVar3 = (*pcVar1)(param_1,*(undefined8 *)(param_2 + 0x20),a,r,param_5);
    if (iVar3 == 0) goto LAB_00100ee0;
  }
  else {
    if (*(int *)(param_4 + 0x28) == 0) {
...
joined_r0x0010126c:
      if (pBVar5 == (BIGNUM *)0x0) goto LAB_00100ee0;
      goto LAB_00101039;
    }
  ...
  *(undefined4 *)(param_2 + 0x28) = 0;
  ...
  if ((((((iVar3 != 0) && (iVar3 = (*pcVar2)(param_1,a_03,r,param_5), iVar3 != 0)) &&
       ...
       ((iVar3 = BN_mod_sub_quick(*(BIGNUM **)(param_2 + 0x10),a,a_02,m), iVar3 != 0 &&
        (iVar3 = BN_mod_lshift1_quick(a,*(BIGNUM **)(param_2 + 0x10),m), iVar3 != 0)))) &&
...

{
  ...
  if (r_01 != (BIGNUM *)0x0) {
    if (*(int *)(param_3 + 0x28) == 0) {
        ...
        if (((iVar4 == 0) ||
           ...
           ((iVar4 = BN_mod_sub_quick(r_00,*(BIGNUM **)(param_3 + 0x10),r,m), iVar4 == 0 ||
            ((iVar4 = (*pcVar1)(param_1,r,a,r_00,param_4), iVar4 == 0 ||
             (iVar4 = BN_mod_lshift1_quick(a,r,m), iVar4 == 0)))))) goto LAB_00101350;
      ...
      iVar4 = (*pcVar2)(param_1,a,*(undefined8 *)(param_3 + 0x10),param_4);
      if (((iVar4 == 0) || (iVar4 = BN_mod_lshift1_quick(r,a,m), iVar4 == 0)) ||
         (iVar4 = BN_mod_add_quick(a,a,r,m), iVar4 == 0)) goto LAB_00101350;
    ...
    if (iVar4 != 0) {
      if (*(int *)(param_3 + 0x28) == 0) {
        iVar4 = (*pcVar1)(param_1,a,*(BIGNUM **)(param_3 + 0x18),*(undefined8 *)(param_3 + 0x20),
                          param_4);
        if (iVar4 == 0) goto LAB_00101350;
      }
      else {
        pBVar5 = BN_copy(a,*(BIGNUM **)(param_3 + 0x18));
        if (pBVar5 == (BIGNUM *)0x0) goto LAB_00101350;
      }
...

{
  ...
  c = (BN_CTX *)0x0;
  if ((param_4 == (BN_CTX *)0x0) &&
     (param_4 = (BN_CTX *)BN_CTX_secure_new_ex(param_1[0x15]), c = param_4, param_4 == (BN_CTX *)0x0
     )) {
    return false;
  }
  BN_CTX_start(param_4);
...
LAB_00102440:
    ...
    if (*(int *)(param_3 + 0x28) == 0) {
      ...
      if ((iVar3 == 0) ||
         ...
         local_48 = pBVar5, iVar3 == 0)) goto LAB_00102440;
    }
    else {
    ...
    if (*(int *)(param_2 + 0x28) == 0) {
      ...
      if ((iVar3 == 0) ||
         ...
         b = pBVar6, iVar3 == 0)) goto LAB_00102440;
    }
    else {
...

{
  ...
  if ((param_3 == (BN_CTX *)0x0) &&
     (param_3 = (BN_CTX *)BN_CTX_new_ex(*(undefined8 *)(param_1 + 0xa8)), local_60 = param_3,
     param_3 == (BN_CTX *)0x0)) {
    return 0xffffffff;
  }
  BN_CTX_start(param_3);
...
joined_r0x001028de:
            if (((iVar3 != 0) &&
                (iVar3 = (*pcVar1)(param_1,r,r,*(undefined8 *)(param_2 + 0x10),param_3), iVar3 != 0)
                     ...
                     , pBVar4 = r_00, iVar3 != 0)) goto LAB_001027a8;
          }
        }
        else {
...

{
  ...
  local_78 = param_4;
  if ((param_4 == (BN_CTX *)0x0) &&
     (local_78 = (BN_CTX *)BN_CTX_new_ex(param_1[0x15]), local_68 = local_78,
     local_78 == (BN_CTX *)0x0)) {
    return 0;
  }
...
LAB_00102bb9:
      ...
      do {
        ...
        if (iVar3 == 0) {
          iVar3 = (**(code **)(*param_1 + 0xf8))
                            (param_1,*puVar9,*puVar2,*(undefined8 *)(*plVar6 + 0x20),local_78);
    ...
    if (iVar3 != 0) {
      lVar7 = lVar8;
      if ((*(code **)(*param_1 + 0x118) == (code *)0x0) ||
         ((iVar3 = (**(code **)(*param_1 + 0x118))(param_1,b,b,local_78), iVar3 != 0 &&
          (iVar3 = (**(code **)(*param_1 + 0x118))(param_1,b,b,local_78), iVar3 != 0)))) {
        for (; lVar7 != 0; lVar7 = lVar7 + -1) {
          iVar3 = BN_is_zero(*(undefined8 *)(param_3[lVar7] + 0x20));
          if ((iVar3 == 0) &&
             (((iVar3 = (**(code **)(*param_1 + 0xf8))(param_1,pBVar4,ptr[lVar7 + -1],b,local_78),
               iVar3 == 0 ||
               (iVar3 = (**(code **)(*param_1 + 0xf8))
                                  (param_1,b,b,*(undefined8 *)(param_3[lVar7] + 0x20),local_78),
               iVar3 == 0)) ||
              (pBVar5 = BN_copy(*(BIGNUM **)(param_3[lVar7] + 0x20),pBVar4), pBVar5 == (BIGNUM *)0x0
              )))) goto LAB_00102b03;
        }
        iVar3 = BN_is_zero(*(undefined8 *)(*param_3 + 0x20));
        if ((iVar3 != 0) ||
          ...
          do {
            ...
            if (iVar3 == 0) {
              iVar3 = (**(code **)(*param_1 + 0x100))
                                (param_1,b,*(undefined8 *)(lVar1 + 0x20),local_78);
              if (((iVar3 == 0) ||
                  (iVar3 = (**(code **)(*param_1 + 0xf8))
                                     (param_1,*(undefined8 *)(lVar1 + 0x10),
                                      *(undefined8 *)(lVar1 + 0x10),b,local_78), iVar3 == 0)) ||
                 ((iVar3 = (**(code **)(*param_1 + 0xf8))
                                     (param_1,b,b,*(undefined8 *)(lVar1 + 0x20),local_78),
                  iVar3 == 0 ||
                  (iVar3 = (**(code **)(*param_1 + 0xf8))
                                     (param_1,*(undefined8 *)(lVar1 + 0x18),
                                      *(undefined8 *)(lVar1 + 0x18),b,local_78), iVar3 == 0))))
              goto LAB_00102b03;
              if (*(code **)(*param_1 + 0x128) == (code *)0x0) {

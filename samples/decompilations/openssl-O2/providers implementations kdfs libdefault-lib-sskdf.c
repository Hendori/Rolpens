...
bool sskdf_common_get_ctx_params(long param_1,long *param_2)
...
bool sskdf_get_ctx_params(undefined8 param_1,long *param_2)

{
  int iVar1;
  
  if ((param_2 != (long *)0x0) && (*param_2 != 0)) {
    iVar1 = sskdf_common_get_ctx_params();
    return iVar1 != 0;
  }
  return true;
}
...
bool x963kdf_get_ctx_params(void)
...

{
  ...
  if ((param_2 == (long *)0x0) || (*param_2 == 0)) goto LAB_00100310;
...
LAB_001001f8:
    ...
    if (lVar4 == 0) {
LAB_00100260:
      iVar1 = ossl_param_get1_octet_string(param_2,"secret",param_1 + 5,param_1 + 6);
      if (iVar1 == -1) {
        iVar1 = ossl_param_get1_octet_string(param_2,&_LC6,param_1 + 5,param_1 + 6);
      }
      if (((iVar1 != 0) &&
          (iVar1 = ossl_param_get1_concat_octet_string(param_2,&_LC7,param_1 + 7,param_1 + 8,0),
          iVar1 != 0)) &&
         (iVar1 = ossl_param_get1_octet_string(param_2,&_LC8,param_1 + 9,param_1 + 10), iVar1 != 0))
      {
        lVar4 = OSSL_PARAM_locate_const(param_2,"maclen");
        if (lVar4 != 0) {
          iVar1 = OSSL_PARAM_get_size_t(lVar4,&local_38);
          if ((iVar1 == 0) || (local_38 == 0)) goto LAB_00100223;
...
bool sskdf_set_ctx_params(undefined8 param_1,long *param_2)

{
  int iVar1;
  
  if ((param_2 != (long *)0x0) && (*param_2 != 0)) {
    iVar1 = sskdf_common_set_ctx_params();
    return iVar1 != 0;
  }
  return true;
}
...
undefined4
SSKDF_hash_kdm(EVP_MD *param_1,void *param_2,ulong param_3,void *param_4,ulong param_5,int param_6,
...

{
  ...
  if ((((param_3 < 0x40000001) && (param_5 < 0x40000001)) && (param_8 - 1 < 0x40000000)) &&
     (iVar2 = EVP_MD_get_size(), 0 < iVar2)) {
    out = (EVP_MD_CTX *)EVP_MD_CTX_new();
    ctx = (EVP_MD_CTX *)EVP_MD_CTX_new();
    if (((out != (EVP_MD_CTX *)0x0) && (ctx != (EVP_MD_CTX *)0x0)) &&
       (iVar3 = EVP_DigestInit(ctx,param_1), iVar3 != 0)) {
      uVar1 = 1;
      uVar5 = (ulong)iVar2;
      while( true ) {
        ...
        if (iVar2 == 0) break;
        if (param_6 == 0) {
          iVar2 = EVP_DigestUpdate(out,&local_8c,4);
          if (iVar2 == 0) break;
        ...
        if ((iVar2 == 0) || (iVar2 = EVP_DigestUpdate(out,param_4,param_5), iVar2 == 0)) break;
        if (param_8 < uVar5) {
          iVar2 = EVP_DigestFinal_ex(out,local_88,(uint *)0x0);
          if (iVar2 != 0) {
...
LAB_0010067c:
        ...
        if (param_8 == 0) goto LAB_0010067c;
        uVar1 = uVar1 + 1;
      }
    }
    uVar4 = 0;
...

{
  ...
  CRYPTO_clear_free(param_1[5],param_1[6],"providers/implementations/kdfs/sskdf.c",0x14a);
  CRYPTO_clear_free(param_1[7],param_1[8],"providers/implementations/kdfs/sskdf.c",0x14b);
  CRYPTO_clear_free(param_1[9],param_1[10],"providers/implementations/kdfs/sskdf.c",0x14c);
  param_1[1] = 0;
...
bool x963kdf_set_ctx_params(undefined8 param_1,long *param_2)
...
LAB_001008f3:
    ...
    if ((param_4 != (long *)0x0) && (*param_4 != 0)) {
      iVar1 = sskdf_common_set_ctx_params(param_1,param_4);
      if (iVar1 == 0) goto LAB_001008f3;
    }
    if (*(long *)(param_1 + 0x28) == 0) {
      ...
      if (lVar2 == 0) {
        ...
        uVar3 = SSKDF_hash_kdm(lVar2,*(undefined8 *)(param_1 + 0x28),*(undefined8 *)(param_1 + 0x30)
                               ,*(undefined8 *)(param_1 + 0x38),*(undefined8 *)(param_1 + 0x40),1,
                               param_2,param_3);
      }
    }
    else {
...

{
  ...
  if ((iVar5 != 0) &&
     (((param_4 == (long *)0x0 || (*param_4 == 0)) ||
      (iVar5 = sskdf_common_set_ctx_params(param_1,param_4), iVar5 != 0)))) {
    if (*(long *)(param_1 + 0x28) == 0) {
      ERR_new();
      ...
      if (*(long *)(param_1 + 8) == 0) {
        if (lVar6 != 0) {
          uVar8 = SSKDF_hash_kdm(lVar6,*(undefined8 *)(param_1 + 0x28),
                                 *(undefined8 *)(param_1 + 0x30),*(undefined8 *)(param_1 + 0x38),
                                 *(undefined8 *)(param_1 + 0x40),0,param_2,param_3);
          goto LAB_00100a4f;
        }
        ERR_new();
        uVar7 = 0x1d9;
LAB_00100f21:
        ERR_set_debug("providers/implementations/kdfs/sskdf.c",uVar7,"sskdf_derive");
        ERR_set_error(0x39,0x81,0);
      }
      else {
...
LAB_00100b67:
            ...
            if ((uVar1 < 0x40000001) && (uVar2 < 0x40000001)) {
              uVar8 = 0;
              if (0x3fffffff < param_3 - 1) goto LAB_00100a4f;
...
LAB_00100d3a:
                ...
                if (((iVar5 == 0) || (uVar9 = EVP_MAC_CTX_get_mac_size(uVar3), uVar9 == 0)) ||
                   (0x40 < uVar9)) goto LAB_00100f86;
                puVar10 = (undefined1 *)0x0;
                local_130 = local_88;
LAB_00100d98:
                uVar11 = 1;
                while( true ) {
                  local_8c = uVar11 >> 0x18 | (uVar11 & 0xff0000) >> 8 | (uVar11 & 0xff00) << 8 |
                             uVar11 << 0x18;
                  lVar6 = EVP_MAC_CTX_dup(uVar3);
                  if (((lVar6 == 0) || (iVar5 = EVP_MAC_update(lVar6,&local_8c,4), iVar5 == 0)) ||
                     ((iVar5 = EVP_MAC_update(lVar6,uVar4,uVar1), iVar5 == 0 ||
                      (iVar5 = EVP_MAC_update(lVar6,uVar7,uVar2), iVar5 == 0)))) goto LAB_00100e5f;
                  if (param_3 < uVar9) break;
                  iVar5 = EVP_MAC_final(lVar6,param_2,0,param_3);
                  if (iVar5 == 0) goto LAB_00100e5f;
                  param_2 = (void *)((long)param_2 + uVar9);
                  param_3 = param_3 - uVar9;
                  if (param_3 == 0) goto LAB_00101042;
                  uVar11 = uVar11 + 1;
                  EVP_MAC_CTX_free(lVar6);
                }
                iVar5 = EVP_MAC_final(lVar6,local_130,0,uVar9);
                if (iVar5 != 0) {
...
LAB_00100e5f:
                uVar11 = 0;
LAB_00100e61:
                if (puVar10 == (undefined1 *)0x0) goto LAB_00100f8a;
LAB_00100e71:
                CRYPTO_clear_free(puVar10,uVar8,"providers/implementations/kdfs/sskdf.c",0x12d);
              }
              else {
                ...
                if (iVar5 != 0) {
                  ...
                  iVar5 = EVP_MAC_CTX_set_params(uVar3,&local_e8);
                  if (0 < iVar5) {
                    if (local_f0 < 0x41) goto LAB_00100d3a;
                    puVar10 = (undefined1 *)
                              CRYPTO_zalloc(local_f0,"providers/implementations/kdfs/sskdf.c",0xde);
                    if (puVar10 != (undefined1 *)0x0) {
                      iVar5 = EVP_MAC_init(uVar3,lVar6,lVar12,0);
                      if ((iVar5 != 0) &&
                         (uVar9 = EVP_MAC_CTX_get_mac_size(uVar3), local_130 = puVar10, uVar9 != 0))
                      goto LAB_00100d98;
                      uVar11 = 0;
                      lVar6 = 0;
                      goto LAB_00100e71;

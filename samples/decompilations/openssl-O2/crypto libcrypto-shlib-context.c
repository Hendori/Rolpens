...
undefined8 * get_default_context(void)
...

{
  ...
  CRYPTO_THREAD_cleanup_local(&DAT_00100ce0);
  CRYPTO_THREAD_cleanup_local(&default_context_thread_local);
...
long OSSL_LIB_CTX_set0_default(undefined8 *param_1)

{
  long lVar1;
  
  lVar1 = get_default_context();
  if ((lVar1 != 0) && (param_1 != (undefined8 *)0x0)) {
...
long ossl_lib_ctx_get_concrete(long param_1)
...
bool ossl_lib_ctx_is_default(long param_1)

    ...
    if (bVar1 == 0) {
      if (param_3 < 0x2b) {
        ...
        *(ulong *)(puVar4 + 10) = uVar6;
        uVar6 = (ulong)local_48[0x22] << 0x28 | uVar6;
        *(ulong *)(puVar4 + 10) = uVar6;
        uVar6 = (ulong)local_48[0x23] << 0x20 | uVar6;
        *(ulong *)(puVar4 + 10) = uVar6;
        uVar6 = (ulong)local_48[0x24] << 0x18 | uVar6;
        *(ulong *)(puVar4 + 10) = uVar6;
        uVar6 = (ulong)local_48[0x25] << 0x10 | uVar6;
        *(ulong *)(puVar4 + 10) = uVar6;
        uVar6 = (ulong)local_48[0x26] << 8 | uVar6;
        *(ulong *)(puVar4 + 10) = uVar6;
...
LAB_0010098e:
    ...
    if (iVar6 == -1) {
      ...
      pvVar5 = CRYPTO_malloc(iVar6,"crypto/ct/ct_oct.c",0x149);
      *param_2 = (long)pvVar5;
      if (pvVar5 != (void *)0x0) {
        bVar1 = true;
        goto LAB_0010098e;

...
bool tdes_init(void *param_1,long param_2,long param_3,long param_4,undefined8 param_5,
...

{
  ...
  if (iVar2 != 0) {
    ...
    *(byte *)((long)param_1 + 0x6c) = bVar1 & 0xfd | (param_7 & 1) * '\x02';
    if (param_4 == 0) {

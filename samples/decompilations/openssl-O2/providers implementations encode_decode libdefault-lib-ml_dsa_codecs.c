...

{
  ...
  uVar3 = ossl_prov_ctx_get0_libctx(param_4);
  puVar4 = (undefined8 *)ossl_ml_dsa_params_get(param_3);
  if (puVar4 != (undefined8 *)0x0) {
    if (param_3 == 0x5b2) {
      ppuVar6 = &PTR_ml_dsa_65_spkifmt_001010b0;
    }
    else if (param_3 == 0x5b3) {
      ppuVar6 = &PTR_ml_dsa_87_spkifmt_001010c0;
    }
    else {
      ppuVar6 = &codecs;
      if (param_3 != 0x5b1) {
    ...
    if ((((long)param_2 == puVar4[9] + 0x16) &&
        (plVar1 = (long *)*ppuVar6, *param_1 == *plVar1 && param_1[1] == plVar1[1])) &&
       (*(long *)((long)param_1 + 0xe) == *(long *)((long)plVar1 + 0xe))) {
      lVar5 = ossl_ml_dsa_key_new(uVar3,param_5,param_3);
      if (lVar5 != 0) {
        iVar2 = ossl_ml_dsa_pk_decode(lVar5,(long)param_1 + 0x16,(long)(param_2 + -0x16));
        if (iVar2 == 0) {
          ERR_new();
          ERR_set_debug("providers/implementations/encode_decode/ml_dsa_codecs.c",0x80,
                        "ossl_ml_dsa_d2i_PUBKEY");
          ERR_set_error(0x39,0x8d,"errror parsing %s public key from input SPKI",*puVar4);
          ossl_ml_dsa_key_free(lVar5);
          return 0;
        }
        return lVar5;
      }
...

{
  ...
  if (param_3 == 0x5b2) {
    ppuVar14 = &PTR_ml_dsa_65_spkifmt_001010b0;
  }
  else if (param_3 == 0x5b3) {
    ppuVar14 = &PTR_ml_dsa_87_spkifmt_001010c0;
  }
  else {
    ppuVar14 = &codecs;
...
LAB_001001f9:
    ...
    ptr = (long *)ossl_ml_common_pkcs8_fmt_order(*puVar6,ppuVar14[1],"input",uVar7);
...

{
  ...
  iVar11 = *(int *)(puVar3 + 1);
  if (iVar11 == 0x5b2) {
    ppuVar12 = &PTR_ml_dsa_65_spkifmt_001010b0;
  }
  else if (iVar11 == 0x5b3) {
    ppuVar12 = &PTR_ml_dsa_87_spkifmt_001010c0;
  }
  else {
    ppuVar12 = &codecs;
    if (iVar11 != 0x5b1) {
  ...
  ptr = (long *)ossl_ml_common_pkcs8_fmt_order(*puVar3,ppuVar12[1],"output",uVar6);
  if (ptr == (long *)0x0) {
    return 0;
  }
  lVar10 = *ptr;

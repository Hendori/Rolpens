...
int key2blob_encode_isra_0(undefined8 param_1,EC_KEY *param_2,undefined8 param_3)
...
undefined8 sm22blob_encode(undefined8 param_1,undefined8 param_2,undefined8 param_3,long param_4)

{
  ...
  uVar1 = key2blob_encode_isra_0(param_1,param_3,param_2);
  return uVar1;
}

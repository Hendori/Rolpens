...
int ossl_obj_obj2nid(long param_1,int param_2)

{
  ...
  if (param_1 != 0) {
    ...
    if (iVar4 != 0) goto LAB_00100d60;
    if (*(int *)(param_1 + 0x14) != 0) {
      puVar2 = (uint *)OBJ_bsearch_(&local_40,obj_objs,0x540,4,obj_cmp_BSEARCH_CMP_FN);
      if (puVar2 != (uint *)0x0) {
        ...
        if ((iVar1 != 0) && (obj_lock_initialise_ossl_ret_ != 0)) {
          ...
          if (iVar1 != 0) {
            if (added != 0) {
              local_38[0] = 0;
              local_30 = local_40;
              lVar3 = OPENSSL_LH_retrieve(added,local_38);
              if (lVar3 != 0) {
...
LAB_00101080:
    ...
    if (((sn != (char *)0x0) && (iVar2 = OBJ_sn2nid(sn), iVar2 != 0)) ||
       ((ln != (char *)0x0 && (iVar2 = OBJ_ln2nid(ln), iVar2 != 0)))) goto LAB_00100f08;
    if (oid == (char *)0x0) goto LAB_00101080;
    a = OBJ_txt2obj(oid,1);
    if (a == (ASN1_OBJECT *)0x0) {
      return 0;
    }
  ...
  if ((oid == (char *)0x0) || (iVar2 = ossl_obj_obj2nid(a,0), iVar2 == 0)) {
    iVar2 = new_nid_7;
    LOCK();
    UNLOCK();
    iVar1 = new_nid_7 + 1;
...
LAB_001013e8:
          if (bVar6) {
            ...
            if (iVar2 == 0) goto LAB_0010144f;
            if (-1 < (char)uVar12) goto code_r0x001014a1;
LAB_00101423:
            ...
            w = w | uVar12 & 0x7f;
            if (-1 < (char)uVar12) {
              if (!bVar7) goto LAB_0010168f;
              bVar7 = false;
              if (w < 0x50) goto LAB_00101596;
              w = w - 0x50;
              cVar8 = '\x02';
              goto LAB_001015b1;
            }
          ...
          iVar9 = iVar9 + -1;
          pbVar3 = pbVar11;
          if ((iVar9 == 0) && ((char)bVar1 < '\0')) goto LAB_0010144f;
          goto LAB_001013e8;
        }
        goto LAB_0010144f;
      }
...
LAB_0010168f:
  ...
  if (pcVar4 == (char *)0x0) goto LAB_0010144f;
  sVar5 = strlen(pcVar4);
  iVar2 = (int)sVar5;

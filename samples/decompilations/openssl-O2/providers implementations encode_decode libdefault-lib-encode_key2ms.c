...

{
  ...
  if (((pk == (EVP_PKEY *)0x0) || (iVar2 = (*param_5)(pk,param_2), iVar2 == 0)) ||
    ...
    if (bVar1) {
      iVar2 = i2b_PublicKey_bio(out,pk);
    }
    else {
      iVar2 = i2b_PrivateKey_bio(out,pk);
    }
    BIO_free(out);
  }
  EVP_PKEY_free(pk);
...

{
  ...
  uVar1 = key2msblob_encode_isra_0(param_1,param_3,param_5,param_2,&EVP_PKEY_set1_DSA);
  return uVar1;
}
...
undefined8
rsa2msblob_encode(undefined8 param_1,undefined8 param_2,undefined8 param_3,long param_4,
                 undefined4 param_5)

{
  ...
  uVar1 = key2msblob_encode_isra_0(param_1,param_3,param_5,param_2,&EVP_PKEY_set1_RSA);
  return uVar1;
}

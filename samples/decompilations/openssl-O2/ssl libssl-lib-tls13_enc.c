...

{
  ...
  if (((~param_2 & 0x12) == 0) || ((~param_2 & 0x21) == 0)) {
    if ((param_2 & 0x40) == 0) {
      ...
      if (0 < (int)local_174) goto LAB_00101283;
      ERR_new();
...
LAB_00101490:
    ...
    if ((param_2 & 0x80) != 0) {
      ...
      if (0 < (int)local_174) goto LAB_00101097;
      ERR_new();
...
LAB_00101283:
    ...
    if (pcVar9 == "s ap traffic") {
      ...
      uVar8 = 0xc;
      if (pcVar9 != "s hs traffic") goto LAB_001010e0;
...
LAB_001011a0:
      ...
      if (uVar3 != 0) {
        if (local_170 != 0) {
          uVar8 = ssl_handshake_md(param_1);
          iVar2 = tls13_derive_finishedkey(param_1,uVar8,local_c8,local_170,(long)(int)local_174);
          if (iVar2 == 0) goto LAB_001017a6;
        }
        if ((param_2 & 2) != 0) {
...
LAB_0010132a:
    if ((param_2 & 0x40) != 0) goto LAB_00101490;
  }
  local_1a0 = local_108;

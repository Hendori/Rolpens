...
undefined8
eckem_init(undefined8 *param_1,int param_2,EC_KEY *param_3,EC_KEY *param_4,undefined8 param_5)

{
  ...
  if ((iVar1 != 0) && (iVar1 = eckey_check(param_3,param_2 == 0x2000), iVar1 != 0)) {
    EC_KEY_free((EC_KEY *)*param_1);
    *param_1 = 0;
...
LAB_0010055c:
      *(int *)((long)param_1 + 0x24) = param_2;
      uVar4 = eckem_set_ctx_params(param_1,param_5);
      return uVar4;
    }
    pEVar2 = EC_KEY_get0_group(param_3);
    b = EC_KEY_get0_group(param_4);
    uVar4 = ossl_ec_key_get_libctx(param_3);
    ...
    if (ctx != (BN_CTX *)0x0) {
      if (((pEVar2 == (EC_GROUP *)0x0) || (b == (EC_GROUP *)0x0)) ||
        ...
        BN_CTX_free(ctx);
        iVar1 = eckey_check(param_4,param_2 == 0x1000);
        if (iVar1 != 0) {
          EC_KEY_free((EC_KEY *)param_1[1]);
          param_1[1] = 0;
          iVar1 = EC_KEY_up_ref(param_4);
          if (iVar1 != 0) {
            param_1[1] = param_4;
            goto LAB_0010055c;
          }
...
void eckem_auth_decapsulate_init
               (undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  eckem_init(param_1,0x2000,param_2,param_3,param_4);
  return;
}



void eckem_auth_encapsulate_init
               (undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  eckem_init(param_1,0x1000,param_2,param_3,param_4);
  return;
}



void eckem_decapsulate_init(undefined8 param_1,undefined8 param_2,undefined8 param_3)

{
  eckem_init(param_1,0x2000,param_2,0,param_3);
  return;
}



void eckem_encapsulate_init(undefined8 param_1,undefined8 param_2,undefined8 param_3)

{
  eckem_init(param_1,0x1000,param_2,0,param_3);
  return;
}
...
LAB_00101153:
    ...
    do {
      ...
      if (pBVar7 == (BIGNUM *)0x0) goto LAB_00101153;
      if (local_cb == -1) {
        ERR_new();

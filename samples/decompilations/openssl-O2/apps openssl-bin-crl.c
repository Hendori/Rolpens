    ...
    while( true ) {
      ...
      if (iVar6 == 0) {
        ...
        if ((iVar6 != 0) && (iVar6 = opt_md(uVar15,&local_a0), iVar6 != 0)) {
          ...
          v = (X509_STORE *)0x0;
          if (bVar2) {
            v = (X509_STORE *)setup_verify(local_f0,local_c0,local_e8,local_c4,local_e0,local_fc);
            if (v == (X509_STORE *)0x0) goto LAB_00100ae6;
            m = X509_LOOKUP_file();
          ...
          if (local_110 != 0) {
            ...
            a_00 = (X509_CRL *)load_crl(local_110,local_ac,0,"other CRL");
            if (a_00 == (X509_CRL *)0x0) goto LAB_00100ae6;
            pEVar11 = (EVP_PKEY *)load_key(local_108,local_a4,0,0,0,"CRL signing key");
            if (pEVar11 == (EVP_PKEY *)0x0) {
              bp = (BIO *)0x0;
              X509_CRL_free(a_00);
              goto LAB_001001a0;
...
LAB_00100863:
  bp = (BIO *)bio_open_default(local_f8,0x77,local_a8);
  if (bp == (BIO *)0x0) {
LAB_00100ae6:
    bp = (BIO *)0x0;
  }

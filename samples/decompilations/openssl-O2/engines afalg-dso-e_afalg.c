...

{
  ...
  iVar1 = (int)param_1;
  if (iVar1 == 0x1a7) {
    puVar4 = (undefined4 *)&DAT_001010f0;
  }
  else {
    if (iVar1 == 0x1ab) {
      puVar4 = &DAT_00101100;
...
LAB_00100070:
  lVar2 = EVP_CIPHER_meth_new(param_1,0x10,*puVar4);
  *(long *)(puVar4 + 2) = lVar2;
  if (lVar2 != 0) {
...

{
  ...
  local_1b0 = -1;
  uStack_1c0 = (undefined *)0x1002c8;
  iVar1 = uname(&local_1a8);
  if (iVar1 == 0) {
    uStack_1c0 = (undefined *)0x1002e7;
    ...
    if (pcVar3 == (char *)0x0) {
      ...
      if (0x400ff < (int)local_1b8 * 0x10000 + local_1b8._4_4_ * 0x100 + iVar6) {
        uStack_1c0 = (undefined *)0x10036d;
        iVar1 = socket(0x26,5,0);
        if (iVar1 == -1) {
          uStack_1c0 = (undefined *)0x10043f;
          ERR_AFALG_error_constprop_0(0x6d,0x373);
          uVar4 = 0;
        }
        else {
          uStack_1c0 = (undefined *)0x10037d;
          close(iVar1);
          uVar4 = 1;
        }
        goto LAB_00100382;
    ...
    uStack_1c0 = (undefined *)0x1003ee;
    __fprintf_chk(_stderr,2,"ALG_ERR: ASYNC AFALG not supported this kernel(%d.%d.%d)\n",uVar5,iVar1
                  ,iVar8);
    uStack_1c0 = (undefined *)0x100412;
    __fprintf_chk(_stderr,2,"ALG_ERR: ASYNC AFALG requires kernel version %d.%d.%d or later\n",4,1,0
                 );
    uStack_1c0 = (undefined *)0x100421;
    ERR_AFALG_error_constprop_0(0x6b,0x36b);
    uVar4 = 0;
  }
  else {
    uStack_1c0 = (undefined *)0x1003b7;
    ERR_AFALG_error_constprop_0(0x6f,0x35a);
    uVar4 = 0;
  }
LAB_00100382:
...

{
  ...
  if ((((param_2 == 0 || param_3 == (int *)0x0) || (param_1 == 0)) ||
     ...
     (*piVar4 != 0x1890671)) goto LAB_001004ae;
  ...
  if (sVar6 < 0) {
    ...
    if (sVar6 != param_4) goto LAB_001004ae;
    iVar1 = piVar4[1];
    local_100 = 0;
    local_e8 = (undefined1  [16])0x0;
    if (piVar4[5] == 0) {
          ...
          if (local_100 != 0) {
            ...
            if ((int)lVar7 < 1) {
              ...
              if ((local_98 != -0x10) || (iVar3 = iVar1 + 1, 2 < iVar1)) {
                ...
                if (local_98 == -0xc) {
                  ERR_AFALG_error_constprop_0(0x70,0x17b);
                  ERR_add_error_data(3,"-ENOMEM ( code ",local_88,&_LC15);
                }
                else {
                  ERR_AFALG_error_constprop_0(0x70,0x17f);
...

{
  ...
  EVP_CIPHER_meth_free(DAT_001010e8);
  DAT_001010e8 = 0;
  EVP_CIPHER_meth_free(DAT_001010f8);
  DAT_001010f8 = 0;
  EVP_CIPHER_meth_free(DAT_00101108);
  DAT_00101108 = 0;
  return 1;
}
...

{
  ...
  if (((param_2 == (char *)0x0) || (iVar1 = strcmp(param_2,"afalg"), iVar1 == 0)) &&
     (iVar1 = afalg_chk_platform(), iVar1 != 0)) {
    if (lib_code == 0) {
      lib_code = ERR_get_next_error_library();
    }
    if (error_loaded == 0) {
    ...
    if (((iVar1 == 0) || (iVar1 = ENGINE_set_name(param_1,"AFALG engine support"), iVar1 == 0)) ||
      ...
      ERR_AFALG_error_constprop_0(100,0x323);
    }
    else {
      puVar4 = &afalg_cipher_nids;
      do {
        lVar3 = afalg_aes_cbc(*puVar4);
        if (lVar3 == 0) {
          ERR_AFALG_error_constprop_0(100,0x32e);
          goto LAB_00100f51;
        }
        puVar4 = puVar4 + 1;
      } while (puVar4 != &error_loaded);
      iVar1 = ENGINE_set_ciphers(param_1,afalg_ciphers);
      if (iVar1 != 0) {
        return 1;
      }
      ERR_AFALG_error_constprop_0(100,0x334);
    }
LAB_00100f51:
    if (error_loaded != 0) {
      ERR_unload_strings(lib_code,(ERR_STRING_DATA *)AFALG_str_reasons);

...

{
  ...
  pcVar2 = (char *)*param_1;
  iVar1 = strncmp(pcVar2,"DER:",4);
  if (iVar1 == 0) {
    pcVar2 = pcVar2 + 4;
    uVar3 = 1;
  }
  else {
    iVar1 = strncmp(pcVar2,"ASN1:",5);
    if (iVar1 != 0) {
      return 0;
    }
    pcVar2 = pcVar2 + 5;
...
LAB_001003f3:
    ...
    if (num < 0) {
      ...
      uVar3 = 0x98;
LAB_001003d1:
      ERR_set_debug("crypto/x509/v3_conf.c",uVar3,"do_ext_i2d");
      ERR_set_error(0x22,0x8000d,0);
      goto LAB_001003f3;
    }
LAB_001002f9:
...

{
  ...
  iVar1 = v3_check_generic(local_40);
  pcVar3 = local_40[0];
  if (iVar1 == 0) {
    iVar1 = OBJ_sn2nid(param_4);
    lVar2 = do_ext_nconf(param_1,param_2,iVar1,uVar4,pcVar3);
    if (lVar2 == 0) {
      if (param_3 == 0) {
        ERR_new();
        ERR_set_debug("crypto/x509/v3_conf.c",0x34,"X509V3_EXT_nconf_int");
        ERR_set_error(0x22,0x80,"name=%s, value=%s",param_4,pcVar3);
      }
      else {
        ERR_new();
        ERR_set_debug("crypto/x509/v3_conf.c",0x30,"X509V3_EXT_nconf_int");
        ERR_set_error(0x22,0x80,"section=%s, name=%s, value=%s",param_3,param_4,pcVar3);
      }
    }
  }
  else {
    lVar2 = v3_generic_extension(param_4,local_40[0],uVar4,iVar1,param_2);
  }
  return lVar2;
}
...

{
  ...
  if (iVar1 == 0) {
    while (iVar1 = ossl_ctype_check((int)*pcVar4,8), iVar1 != 0) {
      pcVar4 = pcVar4 + 1;
    }
    uVar5 = 1;
    local_30 = pcVar4;
    iVar1 = v3_check_generic(&local_30);
    pcVar4 = local_30;
  }
  else {
    uVar5 = 0;
  ...
  if (iVar1 != 0) {
    ...
    pXVar3 = (X509_EXTENSION *)v3_generic_extension(pcVar2,pcVar4,uVar5,iVar1,ctx);
    return pXVar3;
  }
  pXVar3 = (X509_EXTENSION *)do_ext_nconf(conf,ctx,ext_nid,uVar5,pcVar4);
  return pXVar3;
}
...

{
  ...
  for (iVar7 = 0; iVar1 = OPENSSL_sk_num(psVar3), iVar7 < iVar1; iVar7 = iVar7 + 1) {
    ...
    iVar1 = iVar7;
    if ((iVar2 != 0) && (iVar2 = strcmp(__s1,"subjectKeyIdentifier"), iVar1 = iVar9, iVar2 == 0)) {
      iVar8 = iVar7;
    }
    iVar9 = iVar1;
  }
  ...
  while( true ) {
    ...
    if ((iVar9 < iVar8) && (-1 < iVar9)) {
      if (iVar7 == iVar9) {
        puVar6 = (undefined8 *)OPENSSL_sk_value(psVar3,iVar8);
      }
      else if (iVar7 == iVar8) {
        puVar6 = (undefined8 *)OPENSSL_sk_value(psVar3,iVar9);
      }
    }
...

{
  ...
  if ((str != (char *)0x0) &&
     (UNRECOVERED_JUMPTABLE = ctx->db_meth->free_string, UNRECOVERED_JUMPTABLE != (_func_4289 *)0x0)
                    ...
                    /* WARNING: Could not recover jumptable at 0x00100dfa. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if ((section != (stack_st_CONF_VALUE *)0x0) &&
     (UNRECOVERED_JUMPTABLE = ctx->db_meth->free_section, UNRECOVERED_JUMPTABLE != (_func_4290 *)0x0
                    ...
                    /* WARNING: Could not recover jumptable at 0x00100e2a. Too many branches */
                    /* WARNING: Treating indirect jump as call */

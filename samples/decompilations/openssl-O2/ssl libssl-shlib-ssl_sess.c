...
void SSL_SESSION_list_remove(long param_1,long param_2)

{
  long lVar1;
  long lVar2;
  
  lVar1 = *(long *)(param_2 + 0x390);
  if ((lVar1 != 0) && (lVar2 = *(long *)(param_2 + 0x388), lVar2 != 0)) {
...

{
  ...
  if ((*(long *)(param_2 + 0x390) != 0) && (*(long *)(param_2 + 0x388) != 0)) {
    SSL_SESSION_list_remove();
  }
  lVar1 = *(long *)(param_1 + 0x40);
  if (lVar1 != 0) {
    uVar2 = *(ulong *)(param_2 + 0x2e8);
    if (uVar2 < *(ulong *)(lVar1 + 0x2e8)) {
      lVar3 = *(long *)(param_1 + 0x48);
      if (uVar2 < *(ulong *)(lVar3 + 0x2e8)) {
        *(long *)(param_2 + 0x388) = lVar3;
        *(long *)(lVar3 + 0x390) = param_2;
        *(long *)(param_2 + 0x390) = param_1 + 0x48;
        *(long *)(param_1 + 0x48) = param_2;
      }
      else {
        for (lVar1 = *(long *)(lVar1 + 0x390); lVar1 != param_1 + 0x48;
            lVar1 = *(long *)(lVar1 + 0x390)) {
          if (*(ulong *)(lVar1 + 0x2e8) <= uVar2) {
            lVar3 = *(long *)(lVar1 + 0x388);
            *(long *)(param_2 + 0x388) = lVar3;
            *(long *)(param_2 + 0x390) = lVar1;
            *(long *)(lVar3 + 0x390) = param_2;
            *(long *)(lVar1 + 0x388) = param_2;
...

{
  ...
  *(undefined1 (*) [16])(ses[1].session_id + 0x18) = (undefined1  [16])0x0;
  ...
  ses[1].krb5_client_princ[0xb1] = '\0';
  ses[1].krb5_client_princ[0xb2] = '\0';
  ses[1].krb5_client_princ[0xb3] = '\0';
  UNLOCK();
  ...
  if (iVar1 == 0) {
    ...
    uVar6 = 0xb5;
LAB_00100671:
    ERR_set_debug("ssl/ssl_sess.c",uVar6,"ssl_session_dup_intern");
...
LAB_0010048c:
      ...
      if ((char *)param_1[0x54] != (char *)0x0) {
        ...
        *(char **)ses[1].session_id = pcVar2;
        if (pcVar2 == (char *)0x0) goto LAB_00100648;
      }
      ...
      if ((param_2 == 0) || (param_1[0x65] == 0)) {
        ses[1].krb5_client_princ[0x48] = '\0';
        ses[1].krb5_client_princ[0x49] = '\0';
        ses[1].krb5_client_princ[0x4a] = '\0';
        ses[1].krb5_client_princ[0x4b] = '\0';
        ses[1].krb5_client_princ[0x4c] = '\0';
        ses[1].krb5_client_princ[0x4d] = '\0';
        ses[1].krb5_client_princ[0x4e] = '\0';
        ses[1].krb5_client_princ[0x4f] = '\0';
        ses[1].krb5_client_princ[0x50] = '\0';
        ses[1].krb5_client_princ[0x51] = '\0';
        ses[1].krb5_client_princ[0x52] = '\0';
        ses[1].krb5_client_princ[0x53] = '\0';
        ses[1].krb5_client_princ[0x54] = '\0';
        ses[1].krb5_client_princ[0x55] = '\0';
        ses[1].krb5_client_princ[0x56] = '\0';
        ses[1].krb5_client_princ[0x57] = '\0';
      }
      else {
      ...
      *(long *)(ses[1].krb5_client_princ + 0x80) = lVar3;
      ...
      if (iVar1 != 0) {
        ...
        ses[1].sid_ctx[0] = (char)((ulong)uVar6 >> 0x20);
        ses[1].sid_ctx[1] = (char)((ulong)uVar6 >> 0x28);
        ses[1].sid_ctx[2] = (char)((ulong)uVar6 >> 0x30);
        ses[1].sid_ctx[3] = (char)((ulong)uVar6 >> 0x38);
        goto LAB_0010048c;
      }
      ERR_new();
      uVar6 = 0xbb;
...
undefined8 remove_session_lock(long param_1,long param_2,int param_3)

{
  ...
  if (*(long *)(param_2 + 0x250) != 0) {
    if (param_3 == 0) {
      lVar4 = OPENSSL_LH_retrieve(*(undefined8 *)(param_1 + 0x30));
      if (lVar4 != 0) {
        ses = (SSL_SESSION *)OPENSSL_LH_delete(*(undefined8 *)(param_1 + 0x30),lVar4);
        SSL_SESSION_list_remove(param_1,ses);
...
joined_r0x001007f4:
      ...
      *(undefined4 *)(param_2 + 0x2b0) = 1;
      ...
      lVar4 = OPENSSL_LH_retrieve(*(undefined8 *)(param_1 + 0x30),param_2);
      if (lVar4 != 0) {
        ses = (SSL_SESSION *)OPENSSL_LH_delete(*(undefined8 *)(param_1 + 0x30),lVar4);
        SSL_SESSION_list_remove(param_1,ses);
        uVar2 = *(undefined8 *)(param_1 + 0x3f0);
        *(undefined4 *)(param_2 + 0x2b0) = 1;
        CRYPTO_THREAD_unlock(uVar2);
        pcVar1 = *(code **)(param_1 + 0x68);
        goto joined_r0x001007f4;
      }
      *(undefined4 *)(param_2 + 0x2b0) = 1;
...

{
  ...
  if ((iVar1 != 0) &&
     (obj = (SSL_SESSION *)CRYPTO_zalloc(0x3a0,"ssl/ssl_sess.c",0x6d), obj != (SSL_SESSION *)0x0)) {
    obj[1].krb5_client_princ[0x70] = 0xff;
    obj[1].sid_ctx[0xc] = '\x01';
    obj[1].sid_ctx[0xd] = '\0';
    obj[1].sid_ctx[0xe] = '\0';
    obj[1].sid_ctx[0xf] = '\0';
    obj[1].sid_ctx[0x10] = '\0';
    obj[1].sid_ctx[0x11] = '\0';
    obj[1].sid_ctx[0x12] = '\0';
    obj[1].sid_ctx[0x13] = '\0';
    obj[1].sid_ctx[0x14] = '\0';
    obj[1].sid_ctx[0x15] = 0xe0;
    obj[1].sid_ctx[0x16] = 0xcf;
    obj[1].sid_ctx[0x17] = 199;
    obj[1].sid_ctx[0x18] = 'F';
    obj[1].sid_ctx[0x19] = '\0';
    obj[1].sid_ctx[0x1a] = '\0';
    obj[1].sid_ctx[0x1b] = '\0';
    uVar2 = ossl_time_now();
    *(undefined8 *)(obj[1].sid_ctx + 0x1c) = uVar2;
    ssl_session_calculate_timeout(obj);
    LOCK();
    obj[1].krb5_client_princ[0xb0] = '\x01';
    obj[1].krb5_client_princ[0xb1] = '\0';
    obj[1].krb5_client_princ[0xb2] = '\0';
    obj[1].krb5_client_princ[0xb3] = '\0';
    UNLOCK();
...

{
  ...
  if (iVar3 == 0xfefd) {
LAB_00100aa1:
    iVar3 = *(int *)&param_1[3].tlsext_session_ticket;
    *(undefined8 *)(param_2 + 0x250) = 0x20;
    if (iVar3 == 0) {
      ...
      if ((pcVar5 == (code *)0x0) &&
         (pcVar5 = *(code **)(*(long *)&param_1[4].mac_flags + 0x1b8), pcVar5 == (code *)0x0)) {
    ...
    if (iVar3 < 0xfefe) {
      if ((iVar3 == 0x100) || (iVar3 - 0x300U < 5)) goto LAB_00100aa1;
    }
    else if (iVar3 == 0xfeff) goto LAB_00100aa1;
    ERR_new();
  ...
  *(undefined8 *)(param_1 + 0x900) = 0;
  ...
  if (*(ulong *)(param_1 + 0x8d8) < 0x21) {
    ...
    *(SSL_SESSION **)(param_1 + 0x900) = ses;
    ...
    ses[1].sid_ctx[0xe] = '\0';
    ses[1].sid_ctx[0xf] = '\0';
    ses[1].sid_ctx[0x10] = '\0';
    ses[1].sid_ctx[0x11] = '\0';
    ses[1].sid_ctx[0x12] = '\0';
    ses[1].sid_ctx[0x13] = '\0';
...

{
  ...
  iVar1 = remove_session_lock(param_1,c,1);
  return iVar1;
}
...

{
  ...
  if (iVar3 != 0) {
    ...
    if ((pSVar4 == (SSL_SESSION *)0x0) || (iVar3 = SSL_SESSION_up_ref(pSVar4), iVar3 == 0)) {
...

{
  ...
  iVar2 = SSL_SESSION_up_ref(c);
  if (iVar2 == 0) {
    return 0;
  }
  uVar4._0_4_ = s[1].quiet_shutdown;
  uVar4._4_4_ = s[1].max_send_fragment;
  iVar2 = CRYPTO_THREAD_write_lock(uVar4);
  if (iVar2 == 0) {
    SSL_SESSION_free(c);
    return 0;
  }
  ses = (SSL_SESSION *)OPENSSL_LH_insert(s->session_cache_head,c);
  if (ses == (SSL_SESSION *)0x0) {
LAB_001010d0:
    lVar5 = OPENSSL_LH_retrieve(s->session_cache_head,c);
    if (lVar5 != 0) goto LAB_00100ffb;
    if (((ulong)s->new_session_cb & 0x400) != 0) {
      uVar4 = ossl_time_now();
      *(undefined8 *)(c[1].sid_ctx + 0x1c) = uVar4;
      ssl_session_calculate_timeout(c);
    }
    ses = c;
    if (c != (SSL_SESSION *)0x0) goto LAB_00100fbc;
  }
  else {
    if (c == ses) {
      if (ses == (SSL_SESSION *)0x0) goto LAB_001010d0;
      if (((ulong)s->new_session_cb & 0x400) != 0) {
        uVar4 = ossl_time_now();
        *(undefined8 *)(c[1].sid_ctx + 0x1c) = uVar4;
        ssl_session_calculate_timeout(c);
...
LAB_00100ffb:
  ...
  if (0 < lVar5) {
    while( true ) {
      ...
      if ((lVar5 < lVar3) || (iVar2 = remove_session_lock(s,s->session_timeout,0), iVar2 == 0))
      break;
      LOCK();
  ...
  SSL_SESSION_list_add(s,c);
LAB_00100fd1:
  uVar1._0_4_ = s[1].quiet_shutdown;
...

{
  ...
  if ((*(byte *)(lVar5 + 0x51) & 1) == 0) {
    ...
    if (param_3 < 0x21) {
      ...
      if (iVar3 != 0) {
        pSVar4 = (SSL_SESSION *)
                 OPENSSL_LH_retrieve(*(undefined8 *)(*(long *)(param_1 + 0xb88) + 0x30),local_3d8);
...
LAB_00101240:
    if (*(code **)(lVar5 + 0x70) != (code *)0x0) {
      local_3dc = 1;
      ses = (SSL_SESSION *)
            (**(code **)(lVar5 + 0x70))
                      (*(undefined8 *)(param_1 + 0x40),param_2,param_3 & 0xffffffff,&local_3dc);
      pSVar4 = ses;
      if (ses == (SSL_SESSION *)0x0) goto LAB_001011dd;
      if (*(int *)(ses[1].session_id + 0x10) == 0) {
        LOCK();
        piVar1 = (int *)(*(long *)(param_1 + 0xb88) + 0xa0);
        *piVar1 = *piVar1 + 1;
        UNLOCK();
        if ((local_3dc == 0) || (iVar3 = SSL_SESSION_up_ref(ses), iVar3 != 0)) {
...

{
  ...
  if ((((*(byte *)(*(long *)(*(int **)(param_1 + 0x18) + 0x36) + 0x50) & 8) == 0) &&
    ...
    *(undefined4 *)(param_1 + 0xa60) = 1;
    ...
    if ((iVar3 != 0) &&
       (iVar3 = tls_parse_extension(param_1,0x1c,0x80,*(undefined8 *)(param_2 + 0x288),0,0),
       iVar3 != 0)) {
...
LAB_00101520:
  ...
  if (iVar3 < 2) {
    if (iVar3 < 0) goto LAB_0010138f;
    ERR_new();
    ERR_set_debug("ssl/ssl_sess.c",0x26a,"ssl_get_prev_session");
    uVar7 = 0xffffffff;
    ossl_statem_fatal(param_1,0x50,0xc0103,0);
    if (local_38 == (SSL_SESSION *)0x0) goto LAB_00101520;
LAB_0010145e:
...
LAB_00101698:
    ...
    if (((local_38->ssl_version == *(int *)(param_1 + 0x48)) &&
        (__n = *(size_t *)(local_38[1].master_key + 0xc), __n == *(size_t *)(param_1 + 0x8d8))) &&
       (iVar3 = memcmp(local_38[1].master_key + 0x14,(void *)(param_1 + 0x8e0),__n), iVar3 == 0)) {
      if (((*(byte *)(param_1 + 0x950) & 1) == 0) || (__n != 0)) {
        ...
        if (uVar4 <= *(ulong *)ses[1].krb5_client_princ) {
          if ((local_38[1].krb5_client_princ[0x90] & 1) == 0) {
            ses = local_38;
            if ((*(ulong *)(param_1 + 0x160) & 0x200) != 0) goto LAB_001013be;
          }
        ...
        *piVar1 = *piVar1 + 1;
        ...
        if (bVar2) {
          ...
          uVar7 = 0;
          if (local_38 != (SSL_SESSION *)0x0) goto LAB_0010145e;
        }
        goto LAB_00101698;
      }
      ERR_new();
  ...
  *(ulong *)(param_1 + 0x250) = uVar3;
  if (((undefined8 *)(param_1 + 600) != param_2) && (param_3 != 0)) {
    if (param_3 < 8) {
      if ((param_3 & 4) == 0) {
        if ((param_3 != 0) &&
           (*(undefined1 *)(param_1 + 600) = *(undefined1 *)param_2, (param_3 & 2) != 0)) {
    ...
    if (*(long *)(s[1].krb5_client_princ + 0x98) == 0) {
      *(long *)(s[1].sid_ctx + 0x14) = t * 1000000000;
      ...
      iVar1 = CRYPTO_THREAD_write_lock
                        (*(undefined8 *)(*(long *)(s[1].krb5_client_princ + 0x98) + 0x3f0));
      if (iVar1 == 0) {
        return 0;
      }
      *(long *)(s[1].sid_ctx + 0x14) = t * 1000000000;
...

{
  ...
  if (s->version != 0) {
    if ((s->version & 0x80U) != 0) {
      ...
      if (s != (SSL *)0x0) goto LAB_00101e1c;
    }
    return 0;
  }
LAB_00101e1c:
  s[4].bbio = (BIO *)tls_session_secret_cb;
...

{
  ...
  if (s->version != 0) {
    if ((s->version & 0x80U) != 0) {
      s = (SSL *)ossl_quic_obj_get0_handshake_layer();
      if (s != (SSL *)0x0) goto LAB_00101e8c;
    }
    return 0;
  }
LAB_00101e8c:
...

{
  ...
  if (((s->version == 0) ||
      (((s->version & 0x80U) != 0 &&
       (s = (SSL *)ossl_quic_obj_get0_handshake_layer(), s != (SSL *)0x0)))) && (0x300 < s->state))
  {
...

{
  ...
  iVar2 = CRYPTO_THREAD_write_lock(*(undefined8 *)(param_1 + 0x3f0));
  if (iVar2 == 0) {
    return;
  }
  lVar3 = OPENSSL_sk_new_null();
  uVar4 = OPENSSL_LH_get_down_load(*(undefined8 *)(param_1 + 0x30));
  OPENSSL_LH_set_down_load(*(undefined8 *)(param_1 + 0x30),0);
  ses = *(SSL_SESSION **)(param_1 + 0x48);
  if (ses != (SSL_SESSION *)0x0) {
    do {
      if ((param_2 != 0) && ((ulong)(param_2 * 1000000000) <= *(ulong *)ses[1].krb5_client_princ))
      break;
      OPENSSL_LH_delete(*(undefined8 *)(param_1 + 0x30),ses);
      SSL_SESSION_list_remove(param_1,ses);
      pcVar1 = *(code **)(param_1 + 0x68);
      ses[1].session_id[0x10] = '\x01';
      ses[1].session_id[0x11] = '\0';
      ses[1].session_id[0x12] = '\0';
      ses[1].session_id[0x13] = '\0';
      if (pcVar1 != (code *)0x0) {
        (*pcVar1)();
      }
      if ((lVar3 == 0) || (iVar2 = OPENSSL_sk_push(lVar3,ses), iVar2 == 0)) {
        SSL_SESSION_free(ses);
      }
      ses = *(SSL_SESSION **)(param_1 + 0x48);
    } while (ses != (SSL_SESSION *)0x0);
  }
  OPENSSL_LH_set_down_load(*(undefined8 *)(param_1 + 0x30),uVar4);
  CRYPTO_THREAD_unlock(*(undefined8 *)(param_1 + 0x3f0));
  OPENSSL_sk_pop_free(lVar3,SSL_SESSION_free);
  return;
}
...

{
  ...
  if ((to->version == 0) ||
     (((to->version & 0x80U) != 0 &&
      (pSVar2 = (SSL *)ossl_quic_obj_get0_handshake_layer(), pSVar2 != (SSL *)0x0)))) {
    if (session == (SSL_SESSION *)0x0) {
      ssl_clear_bad_session(pSVar2);
      if (((SSL_METHOD *)to->rbio != (SSL_METHOD *)to->wbio) &&
         (iVar1 = SSL_set_ssl_method(to,(SSL_METHOD *)to->rbio), iVar1 == 0)) {
LAB_00102204:
      ...
      if (iVar1 == 0) goto LAB_001021cc;
      ssl_clear_bad_session(pSVar2);
      if (((SSL_METHOD *)to->rbio != (SSL_METHOD *)to->wbio) &&
         (iVar1 = SSL_set_ssl_method(to,(SSL_METHOD *)to->rbio), iVar1 == 0)) goto LAB_00102204;

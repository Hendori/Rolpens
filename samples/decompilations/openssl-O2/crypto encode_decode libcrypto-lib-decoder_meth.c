...

{
  ...
  if (auVar4._0_8_ != 0) {
    ...
    if (auVar4._0_4_ != 0) {
      ...
      auVar5._0_8_ = ossl_method_store_add
                               (param_1,param_3,auVar4._0_8_ & 0xffffffff,param_5,param_2,
                                ossl_decoder_up_ref);
...
LAB_001001b0:
    if (((param_1 != 0) || (param_1 = ossl_lib_ctx_get_data(*param_3,0xb), param_1 != 0)) &&
       (iVar1 = ossl_method_store_fetch(param_1,iVar1,param_3[3],param_2,&local_38),
       uVar4 = local_38, iVar1 != 0)) goto LAB_001001d1;
  }
  uVar4 = 0;
LAB_001001d1:
...
long inner_ossl_decoder_fetch_constprop_0(undefined8 *param_1,char *param_2,char *param_3)

{
  ...
  lVar3 = ossl_lib_ctx_get_data(*param_1,0xb);
  ...
  if ((param_2 == (char *)0x0) || (iVar2 = ossl_namemap_name2num(lVar4,param_2), iVar2 == 0)) {
    ...
    *(undefined4 *)(param_1 + 1) = 0;
    ...
    local_88 = ossl_method_construct(*param_1,0x15,&local_80,0,&local_78,param_1);
    if (local_88 == 0) {
      bVar9 = param_2 != (char *)0x0;
    }
    else if (param_2 != (char *)0x0) {
      iVar2 = ossl_namemap_name2num(lVar4,param_2);
      if (iVar2 != 0) goto LAB_001005fb;
      uVar6 = ~(uint)*(byte *)(param_1 + 5) & 1;
      goto LAB_0010048d;
    }
    bVar1 = *(byte *)(param_1 + 5);
    lVar3 = local_88;
    if (!bVar9) goto LAB_00100428;
    iVar2 = 0;
LAB_00100640:
    lVar3 = local_88;
    if (local_88 != 0) goto LAB_00100428;
    iVar7 = 0x8010d - (~(uint)bVar1 & 1);
    if (param_2 != (char *)0x0) goto LAB_0010049b;
    ...
    iVar7 = ossl_method_store_cache_get(lVar3,0,iVar2,pcVar8,&local_88);
    if (iVar7 == 0) {
      *(byte *)(param_1 + 5) = *(byte *)(param_1 + 5) & 0xfe;
      *(int *)(param_1 + 1) = iVar2;
      param_1[2] = param_2;
...
LAB_001005fb:
        ossl_method_store_cache_set
                  (lVar3,local_80,iVar2,pcVar8,local_88,up_ref_decoder,free_decoder);
        bVar1 = *(byte *)(param_1 + 5);
      }
      goto LAB_00100640;
    }
...
LAB_0010049b:
  ...
  ERR_set_error(0x3c,iVar7,"%s, Name (%s : %d), Properties (%s)",uVar5,param_2,iVar2,param_3);
  lVar3 = local_88;
LAB_00100428:
...
joined_r0x00100a4a:
    ...
    if (lVar3 == 0) {
      if (lVar7 != 0) goto LAB_00100a61;
    }
    else if (lVar7 == 0) goto LAB_00100a61;
    if (plVar6[0xd] == 0) {
LAB_00100a61:
      OSSL_DECODER_free(plVar6);
      ERR_new();
      ERR_set_debug("crypto/encode_decode/decoder_meth.c",0x11c,"ossl_decoder_from_algorithm");
      ERR_set_error(0x3c,0xc0108,0);
      return (long *)0x0;
    }
    if ((param_3 == 0) || (iVar4 = ossl_provider_up_ref(param_3), iVar4 != 0)) {
      *plVar6 = param_3;
      return plVar6;
    }
  }
...
undefined8 OSSL_DECODER_fetch(undefined8 param_1)

{
  ...
  local_28 = 0;
  local_48[0] = param_1;
  uVar1 = inner_ossl_decoder_fetch_constprop_0(local_48);
  if (local_28 != 0) {
...
void OSSL_DECODER_do_all_provided(undefined8 param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  local_38 = 0;
  local_58[0] = param_1;
  inner_ossl_decoder_fetch_constprop_0(local_58,0,0);
  local_68 = param_2;
  local_60 = param_3;
  if (local_38 != 0) {
    ossl_method_store_do_all(local_38,0x100000,&local_68);
  }
  uVar1 = ossl_lib_ctx_get_data(param_1,0xb);
...

{
  ...
  if (*(long *)(param_1 + 0x48) != 0) {
    ...
    uVar1 = ossl_provider_ctx(uVar1);
                    /* WARNING: Could not recover jumptable at 0x00100f89. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if ((param_1 != 0) && (*(code **)(param_1 + 0x40) != (code *)0x0)) {
                    /* WARNING: Could not recover jumptable at 0x00100fb5. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (*(long *)(param_1 + 0x58) != 0) {
    uVar1 = OSSL_DECODER_get0_provider();
    uVar1 = ossl_provider_ctx(uVar1);
                    /* WARNING: Could not recover jumptable at 0x00100ff9. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    ...
    if (*(long *)(param_1 + 0x18) != 0) {
      ...
      if ((long)iVar1 != 0) {
        ...
        do {
          ...
          if (((lVar5 != 0) && (*(code **)(lVar4 + 0x50) != (code *)0x0)) &&
             (iVar2 = (**(code **)(lVar4 + 0x50))(lVar5,param_2), iVar2 == 0)) {
            uVar6 = 0;
          }
          uVar7 = uVar7 + 1;

...
LAB_001002d0:
  ...
  *param_4 = lVar8;
  if ((lVar8 != 0) && (lVar8 = OSSL_LIB_CTX_new_child(param_1,param_2), lVar8 != 0)) {
...
void ERR_set_error(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,

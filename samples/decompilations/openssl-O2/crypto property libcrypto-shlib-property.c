...
void ossl_method_cache_flush(long param_1,int param_2)

{
  long lVar1;
  long lVar2;
  
  lVar1 = ossl_sa_get(*(undefined8 *)(param_1 + 8),(long)param_2);
  if (lVar1 != 0) {
    lVar2 = OPENSSL_LH_num_items(*(undefined8 *)(lVar1 + 0x10));
    *(long *)(param_1 + 0x20) = *(long *)(param_1 + 0x20) - lVar2;
    OPENSSL_LH_doall(*(undefined8 *)(lVar1 + 0x10),impl_cache_free);
    OPENSSL_LH_flush(*(undefined8 *)(lVar1 + 0x10));
    return;
  }
  return;
}
...

{
  ...
  *ptr = param_2;
  ...
  ossl_method_cache_flush(param_1,param_3);
...
LAB_001006e2:
    ptr_00 = (int *)ossl_sa_get(param_1[1],(long)param_3);
    if (ptr_00 == (int *)0x0) {
      ...
      if (ptr_00 != (int *)0x0) {
        ...
        *(long *)(ptr_00 + 2) = lVar3;
        if (lVar3 != 0) {
          uVar5 = OPENSSL_LH_new(query_hash,query_cmp);
          lVar3 = OPENSSL_LH_set_thunks
                            (uVar5,0x100000,lh_QUERY_cfn_thunk,lh_QUERY_doall_thunk,
                             lh_QUERY_doall_arg_thunk);
          *(long *)(ptr_00 + 4) = lVar3;
          if (lVar3 != 0) {
            *ptr_00 = param_3;
            iVar1 = ossl_sa_set(param_1[1],(long)param_3,ptr_00);
            if (iVar1 != 0) goto LAB_001006fe;
          }
        }
        CRYPTO_THREAD_unlock(param_1[2]);
...
LAB_001006fe:
      ...
      while ((iVar2 = OPENSSL_sk_num(*(undefined8 *)(ptr_00 + 2)), iVar1 < iVar2 &&
             ((plVar4 = (long *)OPENSSL_sk_value(*(undefined8 *)(ptr_00 + 2),iVar1), *plVar4 != *ptr
              || (plVar4[1] != ptr[1]))))) {
        iVar1 = iVar1 + 1;
      }
...

{
  ...
  if (((param_3 != 0 && param_1 != 0) && (0 < param_2)) &&
    ...
    ossl_method_cache_flush(param_1,param_2);
    iVar1 = 0;
...

{
  ...
  if (param_3 == 0) {
    ...
    if (plVar6 != (long *)0x0) {
      local_58 = *plVar6;
      local_68 = 0;
      if (local_58 != 0) goto LAB_00100cb3;
    }
LAB_00100d6d:
    for (iVar2 = 0; iVar7 = OPENSSL_sk_num(*(undefined8 *)(lVar4 + 8)), iVar2 < iVar7;
        iVar2 = iVar2 + 1) {
      local_48 = (long *)OPENSSL_sk_value(*(undefined8 *)(lVar4 + 8),iVar2);
      if ((local_48 != (long *)0x0) && ((lVar9 == 0 || (*local_48 == lVar9)))) {
        local_68 = 0;
        goto LAB_00100de8;
      }
    }
LAB_00100dad:
    ...
    if ((plVar6 == (long *)0x0) || (*plVar6 == 0)) {
      local_58 = lVar5;
      if (lVar5 == 0) goto LAB_00100d6d;
    }
    else {
      local_58 = *plVar6;
      if (lVar5 != 0) {
        local_68 = ossl_property_merge(lVar5);
        ossl_property_free(lVar5);
        local_58 = local_68;
        if (local_68 == 0) goto LAB_00100dad;
      }
    }
LAB_00100cb3:
    iVar2 = ossl_property_has_optional(local_58);
    local_5c = -1;
    bVar1 = false;
    local_48 = (long *)0x0;
    for (iVar7 = 0; iVar3 = OPENSSL_sk_num(*(undefined8 *)(lVar4 + 8)), iVar7 < iVar3;
      ...
      if ((plVar6 != (long *)0x0) &&
         (((lVar9 == 0 || (*plVar6 == lVar9)) &&
          (iVar3 = ossl_property_match_count(local_58,plVar6[1]), local_5c < iVar3)))) {
        local_48 = plVar6;
...
LAB_00100f90:
        ...
        if (lVar2 == 0) goto LAB_00100f90;
        iVar1 = (**(code **)(lVar2 + 0x18))(*(undefined8 *)(lVar2 + 0x10));
        if (iVar1 == 0) goto LAB_00100f90;
        uVar3 = 1;
...
LAB_00101196:
    ...
    if (ptr == (long *)0x0) goto LAB_00101194;
    *ptr = param_2;
    ptr[1] = (long)(ptr + 5);
    ptr[4] = param_7;
    ptr[2] = param_5;

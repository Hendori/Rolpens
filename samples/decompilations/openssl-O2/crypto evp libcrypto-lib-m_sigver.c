...
LAB_00100229:
      evp_pkey_ctx_free_old_ops(p_Var14);
      *(int *)p_Var14 = 0;
...
LAB_001001cb:
          ...
          if (lVar6 == 0) {
            ...
            uVar8 = 0x70;
LAB_00100558:
            ERR_set_debug("crypto/evp/m_sigver.c",uVar8,"do_sigver_init");
            ERR_set_error(6,0x86,0);
            goto LAB_00100229;
          }
          EVP_SIGNATURE_free(lVar7);
          EVP_KEYMGMT_free(local_a0);
          lVar7 = EVP_SIGNATURE_fetch(*(undefined8 *)(p_Var14 + 8),lVar6,
          ...
          do {
            ...
            if (lVar10 == 0) {
              ...
              bVar16 = true;
LAB_00100401:
              EVP_KEYMGMT_free(lVar10);
            }
            else {
              local_d8 = (EVP_PKEY *)
                         evp_pkey_export_to_provider
                                   (*(undefined8 *)(p_Var14 + 0x88),*(undefined8 *)(p_Var14 + 8),
                                    &local_a0,*(undefined8 *)(p_Var14 + 0x10));
...
joined_r0x00100a06:
        ...
        if (param_4 == (char *)0x0 && param_3 == (EVP_MD *)0x0) {
          ...
          if ((local_e8 == (char *)0x0) || (iVar4 = strcmp(local_e8,"UNDEF"), iVar4 == 0)) {
...
LAB_001007d8:
          ...
          param_1->digest = pEVar12;
          param_1->engine = (ENGINE *)pEVar12;
          if (pEVar12 != (EVP_MD *)0x0) goto LAB_001007d8;
          ERR_clear_last_mark();
          ERR_new();
          uVar8 = 0xf6;
          goto LAB_00100558;
...
LAB_00100483:
        ...
        if (param_3 == (EVP_MD *)0x0) {
          if (param_4 != (char *)0x0) goto LAB_00100795;
          if (!bVar16) {
            local_e8 = local_98;
            iVar4 = evp_keymgmt_util_get_deflt_digest_name(local_a0,local_d8,local_e8,0x50);
            if ((0 < iVar4) && (iVar4 = strcmp(local_e8,"UNDEF"), iVar4 != 0)) goto LAB_00100795;
          }
LAB_001008a0:
          local_e8 = (char *)0x0;
        }
          ...
          if ((param_4 == (char *)0x0) &&
             ((local_e8 = (char *)EVP_MD_get0_name(param_3), local_e8 == (char *)0x0 ||
              (iVar4 = strcmp(local_e8,"UNDEF"), iVar4 == 0)))) goto LAB_001008a0;
        }
LAB_001004ae:
        if (param_9 == 0) {
...
LAB_00100163:
        if (param_9 == 0) {
          if (*(code **)(lVar6 + 0x70) == (code *)0x0) {
            uVar13 = 0x10;
            if (*(long *)(lVar6 + 0xd0) != 0) goto LAB_001007f5;
...
LAB_00100675:
          iVar4 = EVP_PKEY_CTX_set_signature_md(pEVar5,local_e0);
          if (0 < iVar4) {
            if (param_2 != (undefined8 *)0x0) {
...
LAB_00100586:
              iVar4 = evp_pkey_ctx_use_cached_data(p_Var14);
              bVar16 = 0 < iVar4;
              goto LAB_00100594;
            }
          }
...
LAB_00100f18:
    uVar3 = 0;
          ...
          (lVar1 = *(long *)(pEVar7 + 0x28), lVar1 != 0)) {
    if (sigret == (uchar *)0x0) {
...
LAB_00100f5e:
      ...
      if (((ulong)ctx->md_data & 0x200) == 0) {
        ...
        if (ctx_00 != (EVP_PKEY_CTX *)0x0) {
          uVar3 = (**(code **)(*(long *)(ctx_00 + 0x28) + 0xa0))
                            (*(undefined8 *)(ctx_00 + 0x30),sigret,siglen,*siglen);
          goto LAB_00100f5e;
        }
...
LAB_00101077:
          iVar4 = EVP_PKEY_sign(pEVar7,sigret,siglen,tbs,tbslen);
          uVar3 = (uint)(0 < iVar4);
        }
      }
...

{
  ...
  if (p_Var1 == (_func_1088 *)0x0) {
    ...
    if (((ulong)pvVar2 & 0x800) == 0) {
      ...
      if ((param_2 != (uchar *)0x0) &&
         (iVar4 = EVP_DigestSignUpdate(param_1,param_4,param_5), iVar4 < 1)) {
        return 0;
      }
...
LAB_001014f8:
      ...
      if (((*(int *)ctx_00 == 0x100) && (lVar6 = *(long *)(ctx_00 + 0x30), lVar6 != 0)) &&
         (lVar5 = *(long *)(ctx_00 + 0x28), lVar5 != 0)) {
        if (((ulong)pvVar1 & 0x200) == 0) {
          ctx_01 = EVP_PKEY_CTX_dup(ctx_00);
          if (ctx_01 != (EVP_PKEY_CTX *)0x0) {
            iVar3 = (**(code **)(*(long *)(ctx_01 + 0x28) + 0xc0))
                              (*(undefined8 *)(ctx_01 + 0x30),sig,siglen);
...
LAB_00101498:
        ...
        if (out != (EVP_MD_CTX *)0x0) {
          ...
          if (iVar3 != 0) {
            if (bVar2) {
              iVar3 = (**(code **)(*(long *)(out->update + 0x78) + 0x88))

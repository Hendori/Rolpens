...

{
  ...
  uVar4 = OSSL_ENCODER_CTX_new_for_pkey(param_1,param_4,&_LC2,0,0);
  ...
  if (iVar2 == 0) {
    ...
    if (uVar3 != 0xfffffffe) goto LAB_00100141;
  }
  if (param_5 == (code *)0x0) {
...

{
  ...
  if (param_1 != 0) {
    ...
    if ((*(long *)(param_1 + 8) != 0) &&
       (pcVar1 = *(code **)(*(long *)(param_1 + 8) + 0x60), pcVar1 != (code *)0x0)) {
      uVar2 = (*pcVar1)();
    }
    if (0 < (int)uVar2) {
      return uVar2;
...

{
  ...
  if (param_1 != 0) {
    ...
    if ((*(long *)(param_1 + 8) != 0) &&
       (pcVar1 = *(code **)(*(long *)(param_1 + 8) + 0x68), pcVar1 != (code *)0x0)) {
      uVar2 = (*pcVar1)();
    }
    if (0 < (int)uVar2) {
      return uVar2;
  ...
  if (pkey != (EVP_PKEY *)0x0) {
    ...
    if ((*(long *)&pkey->references != 0) &&
       ...
       UNRECOVERED_JUMPTABLE != (code *)0x0)) {
                    /* WARNING: Could not recover jumptable at 0x00100515. Too many branches */
...

{
  ...
  if (param_4 != 0) {
    ...
    if (lVar2 != 0) {
      ctx = (EVP_PKEY_CTX *)EVP_PKEY_CTX_new_from_name(0,&_LC6,0);
...

{
  ...
  lVar1 = 0;
  piVar3 = &standard_name2type;
  do {
    if (*piVar3 == param_1) {
      return (&PTR_DAT_00104628)[lVar1 * 2];
    }
    lVar1 = lVar1 + 1;
    piVar3 = piVar3 + 4;
  } while (lVar1 != 0xc);
...

{
  ...
  iVar1 = print_pkey_constprop_0(pkey,out,indent,0x85,uVar2,pctx);
  return iVar1;
}
...

{
  ...
  uVar2 = 0;
  if (*(long *)&pkey->references != 0) {
    uVar2 = *(undefined8 *)(*(long *)&pkey->references + 0x98);
  }
  iVar1 = print_pkey_constprop_0(pkey,out,indent,0x84,uVar2,pctx);
  return iVar1;
}
...
LAB_00101406:
  ...
  if (param_4 == (char *)0x0) {
    ...
    if (param_3 != 0) {
      ...
      bVar4 = (bool)(bVar4 & pEVar2 == (EVP_PKEY_ASN1_METHOD *)0x0);
    }
  }
  else {
    ...
    if (param_6 == 0) {
      ...
      *(ulong *)param_1 = CONCAT44(param_3,param_3);
      ...
      if (iVar1 == 0) {
        ...
        uVar3 = 0x656;
LAB_00101417:
        ERR_set_debug("crypto/evp/p_lib.c",uVar3,"pkey_set_type");
...

{
  ...
  if ((pkey == (EVP_PKEY *)0x0) || (iVar2 = EVP_PKEY_set_type(pkey,type), iVar2 == 0)) {
    return 0;
  }
  iVar2 = pkey->type;
  ...
  if (iVar2 == 0x198) {
    ...
    if (iVar2 != 0x390) {
      if (iVar2 == 0x494) goto LAB_001017e6;
LAB_0010179a:
      pbVar1 = (byte *)((long)&pkey[1].ameth + 4);
      *pbVar1 = *pbVar1 & 0xfe;
      goto LAB_001017e6;
    }
LAB_00101800:
  ...
  if (param_5 == 0) {
    ...
    if (param_2 == (char *)0x0) {
      if (param_4 == 0) {
        ...
        pEVar3 = EVP_PKEY_asn1_find(&local_a0,param_4);
        if (local_a0 != (ENGINE *)0x0) goto LAB_00101d70;
        ENGINE_finish((ENGINE *)0x0);
      }
LAB_00101e1b:
      pcVar4 = OBJ_nid2sn(param_4);
    }
    else {
...
LAB_00101d70:
        ...
        if (pEVar3 != (EVP_PKEY_ASN1_METHOD *)0x0) goto LAB_00101b92;
        if (param_2 == (char *)0x0) goto LAB_00101e1b;
      }
    }
    ctx = (EVP_PKEY_CTX *)EVP_PKEY_CTX_new_from_name(param_1,pcVar4,param_3);
    if (ctx != (EVP_PKEY_CTX *)0x0) {
      ERR_set_mark();
      ...
      OSSL_PARAM_construct_octet_string(local_d8,puVar6,param_6,param_7);
      local_78._0_8_ = local_b8;
      iVar2 = EVP_PKEY_fromdata(ctx,&local_a8,0x87,local_98);
      if (iVar2 == 1) goto LAB_00101cff;
      ERR_new();
      uVar5 = 0x1d4;
      goto LAB_00101ccd;
    }
      ...
      if ((iVar2 != 0) && (lVar1 = *(long *)&local_a8->references, lVar1 != 0)) {
        if (param_8 == 0) {
          ...
          if (*(code **)(lVar1 + 0xf8) == (code *)0x0) {
            ...
            uVar5 = 0x1f2;
LAB_00101ec1:
            ERR_set_debug("crypto/evp/p_lib.c",uVar5,"new_raw_key_int");
            ERR_set_error(6,0x96,0);
            goto LAB_00101cf1;
          }
...
void EVP_PKEY_new_raw_private_key_ex(void)
...
{
  new_raw_key_int(0,0,0,param_1,param_2,param_3,param_4,1);
  return;
}



void EVP_PKEY_new_raw_public_key_ex(void)
...
{
  new_raw_key_int(0,0,0,param_1,param_2,param_3,param_4,0);
  return;
}
...

{
  ...
  if (*param_1 == 0) {
    if (*(long *)(param_1 + 0x18) != 0) goto LAB_00101fe6;
  }
  else {
    if (*(long *)(param_1 + 0x18) == 0) {
      if ((*(long *)(param_1 + 2) == 0) ||
...

{
  ...
  if (param_1 != 0) {
    ...
    if ((*(long *)(param_1 + 8) != 0) &&
       (pcVar1 = *(code **)(*(long *)(param_1 + 8) + 0x58), pcVar1 != (code *)0x0)) {
      uVar2 = (*pcVar1)();
    }
    if (0 < (int)uVar2) {
      return uVar2;
...

{
  ...
  if (((*(long *)(param_1 + 0x60) == 0) ||
      (lVar1 = *(long *)(*(long *)(param_1 + 0x60) + 0x18), lVar1 == 0)) &&
...

{
  ...
  if (param_3 == (long *)0x0) {
LAB_00102390:
    ctx = (EVP_PKEY_CTX *)EVP_PKEY_CTX_new_from_pkey(param_2,param_1,param_4);
    if (ctx != (EVP_PKEY_CTX *)0x0) {
      lVar1 = *(long *)(ctx + 0x20);
...
LAB_00102258:
      ...
      if ((iVar2 != 0) && (lVar5 = evp_keymgmt_newdata(lVar1), lVar5 != 0)) {
        iVar2 = (**(code **)(*(long *)(param_1 + 2) + 0x120))
                          (param_1,lVar5,*(undefined8 *)(lVar1 + 200),param_2,param_4);
        if ((iVar2 == 0) || (iVar2 = EVP_KEYMGMT_up_ref(lVar1), iVar2 == 0)) {
LAB_00102480:
          lVar3 = 0;
        ...
        if (iVar2 != 0) {
          ...
          if ((lVar6 != *(long *)(param_1 + 0x20)) &&
             (iVar2 = evp_keymgmt_util_clear_operation_cache(param_1), iVar2 == 0)) {
            CRYPTO_THREAD_unlock(*(undefined8 *)(param_1 + 0xe));
            lVar3 = 0;
            evp_keymgmt_freedata(lVar1,lVar5);
...
LAB_00102665:
        ...
        pcVar6 = OBJ_nid2sn(*param_1);
        iVar2 = EVP_KEYMGMT_is_a(*(undefined8 *)(param_2 + 0x18),pcVar6);
        if (iVar2 == 0) goto LAB_001026e0;
        iVar2 = *param_2;
        lVar5 = *(long *)(param_2 + 0x18);
        if (iVar2 == 0) {
          lVar7 = *(long *)(param_1 + 0x18);
      ...
      if ((lVar1 != 0) &&
         (lVar5 = evp_pkey_export_to_provider(param_1,0,&local_38,0), lVar7 = local_40, lVar5 != 0))
      {
        local_40 = local_38;
        bVar9 = false;
        lVar7 = local_38;
...
LAB_0010263e:
      if (lVar7 != 0) goto LAB_00102554;
    }
  }
  else {
    if (lVar5 != 0) {
      uVar4 = evp_keymgmt_util_match(param_1);
      goto LAB_00102590;
    }
    iVar2 = *param_2;
    if (iVar2 != 0) {
LAB_001026a0:
      ...
      iVar2 = EVP_KEYMGMT_is_a(*(undefined8 *)(param_1 + 0x18),pcVar6);
      if (iVar2 == 0) {
LAB_001026e0:
        uVar4 = 0xffffffff;
        goto LAB_00102590;
...
LAB_00102554:
    ...
    if ((*(long *)(lVar7 + 0xc0) == 0) ||
       (lVar3 = evp_pkey_export_to_provider(param_2,0,&local_40,0), lVar7 = local_40, lVar3 == 0)) {
      bVar9 = local_38 != lVar7;
    }
    else {
      local_38 = local_40;
      bVar9 = false;
...
LAB_001025c0:
    if ((lVar7 != 0) && (!bVar9)) {
      uVar4 = evp_keymgmt_match(lVar7,lVar5,lVar8,param_3);
      goto LAB_00102590;
    }
  }
  uVar4 = 0xfffffffe;
...

{
  ...
  if ((*(long *)(param_1 + 2) != 0) &&
     ...
     UNRECOVERED_JUMPTABLE != (code *)0x0)) {
                    /* WARNING: Could not recover jumptable at 0x0010273b. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if ((*(long *)(param_1 + 0x18) != 0) || (*(long *)(param_2 + 0x18) != 0)) {
    ...
    if ((iVar1 == 0) || (iVar1 = evp_keymgmt_util_has(param_2,2), iVar1 == 0)) {
      uVar3 = 7;
    }
    else {
      uVar3 = 6;
    }
    uVar3 = evp_pkey_cmp_any(param_1,param_2,uVar3);
    return uVar3;
  }
  if (*param_1 != *param_2) {
    return 0xffffffff;
  ...
  if (lVar2 != 0) {
    ...
    if (*(code **)(lVar2 + 0x30) != (code *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x0010280a. Too many branches */
                    /* WARNING: Treating indirect jump as call */
      uVar3 = (**(code **)(lVar2 + 0x30))(param_1,param_2);
      return uVar3;
    }
  }
  return 0xfffffffe;
...

{
  ...
  if (*(long *)(*(long *)(*param_1 + 8) + 0x128) == 0) {
    ...
    if (ctx == (EVP_PKEY_CTX *)0x0) {
      ...
      iVar4 = evp_keymgmt_export(lVar1,lVar2,0x87,*(undefined8 *)(*(long *)(*param_1 + 8) + 0x128),
                                 ctx);
      if (iVar4 != 0) {
        lVar1 = *param_1;
...

{
  ...
  if (iVar2 == 0) {
LAB_00102c60:
    if (*(long *)&to[1].save_parameters != 0) goto LAB_00102bd2;
...

{
  ...
  if ((param_1 != 0) &&
     ((pcVar2 = *(char **)(param_1 + 0x20), pcVar2 != (char *)0x0 ||
      (*(long *)(param_1 + 0x68) != 0)))) {
    if (*(long *)(param_1 + 0x60) == 0) goto LAB_00102ebf;
    ...
    if (iVar1 != 0) {
      ...
      if (iVar1 != 0) {
        if (pcVar2 == (char *)0x0) {
          ...
          if ((iVar1 != 0) &&
             (iVar1 = CRYPTO_THREAD_write_lock(*(undefined8 *)(param_1 + 0x38)), iVar1 != 0)) {
...
void ossl_evp_pkey_get1_X25519(undefined8 param_1)

{
  evp_pkey_get1_ECX_KEY(param_1,0x40a);
  return;
}



void ossl_evp_pkey_get1_X448(undefined8 param_1)

{
  evp_pkey_get1_ECX_KEY(param_1,0x40b);
  return;
}



void ossl_evp_pkey_get1_ED25519(undefined8 param_1)

{
  evp_pkey_get1_ECX_KEY(param_1,0x43f);
  return;
}



void ossl_evp_pkey_get1_ED448(undefined8 param_1)

{
  evp_pkey_get1_ECX_KEY(param_1,0x440);
  return;
}
...

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  if (((param_3 != (BIGNUM *)0x0 && param_1 != 0) && (param_2 != 0)) &&
...

{
  ...
  if ((param_2 != 0) && (param_3 != 0)) {
    ...
    if (((iVar2 != 0) && (local_878 != 0)) &&
       (ptr = (void *)CRYPTO_zalloc(local_878,"crypto/evp/p_lib.c",0x8c9), ptr != (void *)0x0)) {
      sStack_880 = sVar1;
      local_888 = ptr;
      iVar2 = EVP_PKEY_get_params(param_1,&local_898);
      uVar3 = 0;
      if ((iVar2 != 0) && (iVar2 = OSSL_PARAM_modified(&local_898), iVar2 != 0)) {
        uVar3 = OSSL_PARAM_get_BN(&local_898,param_3);
      }
      iVar2 = OSSL_PARAM_modified(&local_898);
      if (iVar2 == 0) {
...
ulong EVP_PKEY_get_octet_string_param
...
LAB_00104060:
    ...
    if (iVar1 == 0) goto LAB_00104060;
    if ((CONCAT17((undefined1)iStack_61,CONCAT25(uStack_63,CONCAT14(uStack_64,local_68))) ==
         0x6572706d6f636e75) &&
       (CONCAT26(uStack_5d,CONCAT42(iStack_61,uStack_63)) == 0x64657373657270)) {
      pVar2 = POINT_CONVERSION_UNCOMPRESSED;
    }
    else if ((CONCAT17((undefined1)iStack_61,CONCAT25(uStack_63,CONCAT14(uStack_64,local_68))) !=
              0x73736572706d6f63) || (pVar2 = POINT_CONVERSION_COMPRESSED, iStack_61 != 0x646573)) {
      if ((local_68 != 0x72627968) || (CONCAT22(uStack_63,CONCAT11(uStack_64,0x72)) != 0x646972))
      goto LAB_00104060;
...
LAB_001041aa:
    ...
    if (iVar1 == 0) goto LAB_001041aa;
    if ((local_68 != 0x69662d656d697270) || (uVar2 = 0x196, local_60 != 0x646c65)) {
      if ((local_68 == 0x6574636172616863 && CONCAT44(uStack_5c,local_60) == 0x742d636974736972) &&
         (CONCAT17(uStack_58,CONCAT43(uStack_5c,local_60._1_3_)) == 0x77742d6369747369 &&
          local_57 == 0x646c6569662d6f)) goto LAB_001041aa;
      uVar2 = 0x197;
    }
  }
  if (local_10 == *(long *)(in_FS_OFFSET + 0x28)) {

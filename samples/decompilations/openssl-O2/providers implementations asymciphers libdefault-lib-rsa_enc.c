...

{
  ...
  if (param_1 != (undefined8 *)0x0) {
    if ((param_2 == (long *)0x0) || (*param_2 == 0)) goto LAB_001003b8;
...
LAB_001003b8:
        ...
        if (iVar1 != 0) {
          ...
          param_1[4] = lVar3;
          if (lVar3 != 0) goto LAB_001002c3;
        }
      }
      else {
        local_180 = 0;
        if (*(int *)(lVar3 + 8) == 1) {
          iVar2 = OSSL_PARAM_get_int(lVar3,&local_180);
          iVar1 = local_180;
          if (iVar2 != 0) {
LAB_00100204:
            local_180 = iVar1;
            if (local_180 != 6) {
              iVar1 = local_180;
              if ((local_180 == 4) && (param_1[3] == 0)) {
                lVar3 = EVP_MD_fetch(*param_1,&_LC3,local_138);
                param_1[3] = lVar3;
                iVar1 = local_180;
...
LAB_0010021f:
          ...
          iVar1 = 1;
          do {
            iVar2 = strcmp(__s1,*(char **)(puVar5 + 8));
            if (iVar2 == 0) goto LAB_00100204;
            iVar1 = *(int *)(puVar5 + 0x10);
            puVar5 = puVar5 + 0x10;
          } while (iVar1 != 0);
          goto LAB_0010021f;
        }
    ...
    if (*(int *)(lVar2 + 8) == 1) {
      ...
      do {
        if (*(int *)(param_1 + 0x10) == iVar1) {
          if (*(long *)(padding_item + (long)iVar4 * 0x10 + 8) != 0) {
...
LAB_001004d8:
  ...
  if (lVar2 != 0) {
    ...
    if (*(long *)(param_1 + 0x18) != 0) {
      puVar5 = (undefined *)EVP_MD_get0_name(*(long *)(param_1 + 0x18),&_LC11);
    }
    iVar1 = OSSL_PARAM_set_utf8_string(lVar2,puVar5);
    if (iVar1 == 0) {
      return false;
    }
  }
  ...
  if (lVar2 != 0) {
    if ((*(long *)(param_1 + 0x20) != 0) || (puVar5 = &_LC11, *(long *)(param_1 + 0x18) != 0)) {
      puVar5 = (undefined *)EVP_MD_get0_name();
    }
    iVar1 = OSSL_PARAM_set_utf8_string(lVar2,puVar5);
    if (iVar1 == 0) {
      return false;
...
LAB_00100d33:
    ...
    if (param_2 == (uchar *)0x0) {
      ...
      if (*(int *)(param_1 + 2) == 4) {
        ...
        if (from == (uchar *)0x0) goto LAB_00100d33;
        lVar3 = param_1[3];
        uVar4 = *param_1;
        if (lVar3 == 0) {
...
bool rsa_init_isra_0(long param_1,RSA *param_2,undefined8 param_3,undefined4 param_4)

{
  ...
  if (((iVar1 != 0) && (param_1 != 0)) && (param_2 != (RSA *)0x0)) {
    iVar1 = ossl_rsa_key_op_get_protect(param_2,param_4,&local_34);
    if (iVar1 != 0) {

...

{
  ...
  if (ks1[3].ks[0] == (_union_772)0x0) {
    ...
    if (0x3fffffff < param_4) {
      ...
      do {
        ...
        DES_ede3_cbc_encrypt
                  (input,param_2,0x40000000,ks1,ks1 + 1,ks1 + 2,(DES_cblock *)(param_1 + 0x28),
                   (int)lVar2);
        param_2 = puVar3;
    ...
    if (param_4 != 0) {
      ...
      DES_ede3_cbc_encrypt
                (local_50,output,param_4,ks1,ks1 + 1,ks1 + 2,(DES_cblock *)(param_1 + 0x28),enc);
    }
  }
  else {
...

{
  ...
  if (0x3fffffff < param_4) {
    ...
    do {
      ...
      DES_ede3_cfb64_encrypt
                (in,param_2,0x40000000,pDVar5,(DES_key_schedule *)(lVar4 + 0x80),
                 (DES_key_schedule *)(lVar3 + 0x100),(DES_cblock *)(param_1 + 0x28),&local_44,iVar1)
      ;
  ...
  if (local_60 != 0) {
    ...
    pDVar5 = (DES_key_schedule *)EVP_CIPHER_CTX_get_cipher_data(param_1);
    DES_ede3_cfb64_encrypt
              (local_58,local_78,local_60,pDVar5,(DES_key_schedule *)(lVar3 + 0x80),
               (DES_key_schedule *)(lVar2 + 0x100),(DES_cblock *)(param_1 + 0x28),&local_44,iVar1);
    EVP_CIPHER_CTX_set_num(param_1,local_44);
  }
...

{
  ...
  if ((DES_cblock *)0x3fffffff < param_4) {
    ...
    do {
      ...
      DES_ede3_ofb64_encrypt
                (in,(uchar *)out,0x40000000,pDVar4,(DES_key_schedule *)(lVar3 + 0x80),
                 (DES_key_schedule *)(lVar2 + 0x100),(DES_cblock *)(param_1 + 0x28),&local_44);
      EVP_CIPHER_CTX_set_num(param_1,local_44);
      puVar6 = extraout_RDX;
      out = piVar7;
      in = in + 0x40000000;
  ...
  if (local_60 != (DES_cblock *)0x0) {
    ...
    pDVar4 = (DES_key_schedule *)EVP_CIPHER_CTX_get_cipher_data(param_1);
    DES_ede3_ofb64_encrypt
              (local_58,(uchar *)out_00,(long)local_60,pDVar4,(DES_key_schedule *)(lVar3 + 0x80),
               (DES_key_schedule *)(lVar2 + 0x100),(DES_cblock *)(param_1 + 0x28),&local_44);
    EVP_CIPHER_CTX_set_num(param_1,local_44);
  }
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
  ...
  if (param_4 != 0) {
    ...
    do {
      ...
      DES_ede3_cfb_encrypt
                (&local_42,&local_41,1,1,ks1,(DES_key_schedule *)(lVar4 + 0x80),
                 (DES_key_schedule *)(lVar3 + 0x100),(DES_cblock *)param_1->iv,iVar2);
      bVar5 = (byte)uVar6 & 7;
      uVar6 = uVar6 + 1;
...

{
  ...
  if (0x3fffffff < param_4) {
    ...
    do {
      ...
      puVar6 = param_2 + 0x40000000;
      DES_ede3_cfb_encrypt
                (in,param_2,8,0x40000000,pDVar5,(DES_key_schedule *)(lVar4 + 0x80),
                 (DES_key_schedule *)(lVar3 + 0x100),(DES_cblock *)(param_1 + 0x28),iVar1);
      param_2 = puVar6;
      in = in + 0x40000000;
  ...
  if (local_50 != 0) {
    ...
    pDVar5 = (DES_key_schedule *)EVP_CIPHER_CTX_get_cipher_data(param_1);
    DES_ede3_cfb_encrypt
              (local_48,local_60,8,local_50,pDVar5,(DES_key_schedule *)(lVar3 + 0x80),
               (DES_key_schedule *)(lVar2 + 0x100),(DES_cblock *)(param_1 + 0x28),iVar1);
  }
  return 1;
}
...

{
  ...
  if ((param_4 < 0x40000000) && ((param_4 & 7) == 0)) {
    ...
    if (iVar3 == 0) {
      if (0x17 < param_4) {
        iVar3 = iVar2 + -0x10;
        if (param_2 == (uchar *)0x0) goto LAB_00100af0;

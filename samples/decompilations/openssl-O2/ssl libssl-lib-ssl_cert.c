...
undefined8 add_ca_name(long *param_1,X509 *param_2)
...
void xname_sk_cmp(undefined8 *param_1,undefined8 *param_2)

{
  xname_cmp(*param_1,*param_2);
  return;
}
...

{
  ...
  if (bp == (BIO *)0x0) {
    ...
    if (0 < (int)lVar2) {
      while (pXVar3 = PEM_read_bio_X509(bp,&local_38,(undefined1 *)0x0,(void *)0x0),
            pXVar3 != (X509 *)0x0) {
        pXVar4 = X509_get_subject_name(local_38);
        if ((pXVar4 == (X509_NAME *)0x0) ||
           (pXVar4 = X509_NAME_dup(pXVar4), pXVar4 == (X509_NAME *)0x0)) goto LAB_00100350;
...
undefined4 add_uris_recursive(undefined8 param_1,undefined8 param_2,int param_3)
...
LAB_00100403:
  ...
  do {
    ...
    while( true ) {
      if ((iVar1 != 0) || (iVar1 = OSSL_STORE_error(lVar3), iVar1 != 0)) {
        ERR_clear_error();
        goto LAB_00100403;
      }
      ...
      if (iVar1 == 1) {
        if (param_3 != 0) {
          uVar5 = OSSL_STORE_INFO_get0_NAME(lVar4);
          uVar2 = add_uris_recursive(param_1,uVar5,param_3 + -1);
        }
      }
      else if (iVar1 == 5) {
        a = (X509 *)OSSL_STORE_INFO_get0_CERT(lVar4);
        if (((a == (X509 *)0x0) || (pXVar6 = X509_get_subject_name(a), pXVar6 == (X509_NAME *)0x0))
           || (pXVar6 = X509_NAME_dup(pXVar6), pXVar6 == (X509_NAME *)0x0)) {
LAB_001004b0:
          uVar2 = 0;
          OSSL_STORE_INFO_free(lVar4);
          goto LAB_00100403;
        }
        iVar1 = OPENSSL_sk_find(param_1,pXVar6);
        if (iVar1 < 0) {
          iVar1 = OPENSSL_sk_push(param_1,pXVar6);
          if (iVar1 == 0) {
...
int ssl_verify_internal(void *param_1,stack_st_X509 *param_2,long param_3)

{
  ...
  if (param_2 == (stack_st_X509 *)0x0) {
    iVar2 = X509_STORE_CTX_init_rpk(ctx,store,param_3);
    if (iVar2 != 0) goto LAB_001005bc;
    ERR_new();
    uVar7 = 0x1d1;
LAB_00100789:
    ERR_set_debug("ssl/ssl_cert.c",uVar7,"ssl_verify_internal");
    ERR_set_error(0x14,0x8000b,0);
  }
  else {
...
LAB_001005bc:
    ...
    X509_STORE_CTX_set_flags
              (ctx,(ulong)(*(uint *)(*(long *)((long)param_1 + 0x880) + 0x1c) & 0x30000));
    ...
    if (iVar2 != 0) {
      ...
      *(undefined8 *)((long)param_1 + 0x990) = 0;
      if ((param_2 != (stack_st_X509 *)0x0) && (lVar5 = X509_STORE_CTX_get0_chain(ctx), lVar5 != 0))
      {
...

{
  ...
  *(int *)(ptr + 3) = (int)param_1[3];
  ...
  if (param_1[8] == 0) {
    ptr[8] = 0;
    if (param_1[10] != 0) goto LAB_00100c5a;
LAB_00100df4:
    ptr[10] = 0;
  }
  else {
    ...
    ptr[8] = (long)pvVar4;
    if (pvVar4 == (void *)0x0) goto LAB_00100dcc;
    lVar3 = param_1[9];
    memcpy(pvVar4,(void *)param_1[8],lVar3 * 2);
    lVar1 = param_1[10];
    ptr[9] = lVar3;
    if (lVar1 == 0) goto LAB_00100df4;
LAB_00100c5a:
    pvVar4 = CRYPTO_malloc((int)param_1[0xb] * 2,"ssl/ssl_cert.c",0xb8);
    ptr[10] = (long)pvVar4;
    if (pvVar4 == (void *)0x0) goto LAB_00100dcc;
    lVar3 = param_1[0xb];
...

{
  ...
  plVar2 = plVar3;
  do {
    if (((X509 *)*plVar2 == param_2) && (plVar2[1] != 0)) goto LAB_00101104;
    lVar4 = lVar4 + 1;
    plVar2 = plVar2 + 5;
  } while (lVar4 != param_1[5]);
  uVar5 = 0;
  while (((plVar2 = plVar3 + uVar5 * 5, plVar2[1] == 0 || ((X509 *)*plVar2 == (X509 *)0x0)) ||
         (iVar1 = X509_cmp((X509 *)*plVar2,param_2), iVar1 != 0))) {
    uVar5 = uVar5 + 1;
    if ((ulong)param_1[5] <= uVar5) {
      return 0;
    }
    plVar3 = (long *)param_1[4];
  }
...
void ssl_verify_rpk(undefined8 param_1,undefined8 param_2)

{
  ssl_verify_internal(param_1,0,param_2);
  return;
}



void ssl_verify_cert_chain(undefined8 param_1,undefined8 param_2)

{
  ssl_verify_internal(param_1,param_2,0);
  return;
}
...

{
  ...
  if (*param_1 != 0) {
    if ((*param_1 & 0x80) != 0) {
      ...
      if (param_1 != (uint *)0x0) goto LAB_0010136d;
    }
    return;
  }
LAB_0010136d:
...

{
  ...
  if (s->version != 0) {
    if ((s->version & 0x80U) != 0) {
      ...
      if (s != (SSL *)0x0) goto LAB_001014dd;
    }
    return;
  }
LAB_001014dd:
  OPENSSL_sk_pop_free(*(undefined8 *)&s[3].ex_data.dummy,X509_NAME_free);
...
undefined8 SSL_add1_to_CA_list(uint *param_1,undefined8 param_2)

{
  ...
  if (*param_1 != 0) {
    if ((*param_1 & 0x80) != 0) {
      lVar1 = ossl_quic_obj_get0_handshake_layer();
      if (lVar1 != 0) {
        uVar2 = add_ca_name(lVar1 + 0x9a0,param_2);
        return uVar2;
      }
    }
    return 0;
  }
  uVar2 = add_ca_name(param_1 + 0x268);
  return uVar2;
}



void SSL_CTX_add1_to_CA_list(long param_1)

{
  add_ca_name(param_1 + 0x128);
  return;
}
...

{
  ...
  if (ssl->version != 0) {
    if ((ssl->version & 0x80U) != 0) {
      ...
      if (lVar2 != 0) {
        iVar1 = add_ca_name(lVar2 + 0x9a8,x);
        return iVar1;
      }
    }
    return 0;
  }
  iVar1 = add_ca_name(&ssl[3].ex_data.dummy);
  return iVar1;
}
...

{
  ...
  lVar3 = OPENSSL_LH_set_thunks
                    (uVar2,0x100000,lh_X509_NAME_cfn_thunk,lh_X509_NAME_doall_thunk,
...

{
  ...
  lVar4 = OPENSSL_LH_set_thunks
                    (uVar3,0x100000,lh_X509_NAME_cfn_thunk,lh_X509_NAME_doall_thunk,
                     lh_X509_NAME_doall_arg_thunk);
  if (lVar4 == 0) {
    ERR_new();
...
undefined4 SSL_add_store_cert_subjects_to_stack(undefined8 param_1,undefined8 param_2)

{
  ...
  uVar1 = add_uris_recursive(param_1,param_2,1);
...

{
  ...
  if (*plVar11 == 0) {
    ...
    ctx = (X509_STORE *)0x0;
LAB_00101fb0:
    if ((param_3 & 4) == 0) goto LAB_00101fbc;
  }
  else {
    if ((param_3 & 4) == 0) {
...
LAB_00101eb2:
      local_48 = (X509_STORE_CTX *)X509_STORE_CTX_new_ex(*puVar10,puVar10[0x8e]);
    ...
    if (ctx != (X509_STORE *)0x0) {
      for (iVar1 = 0; iVar9 = OPENSSL_sk_num(plVar11[2]), iVar1 < iVar9; iVar1 = iVar1 + 1) {
        ...
        if (iVar9 == 0) goto LAB_00102060;
      }
      psVar3 = (stack_st_X509 *)0x0;
      iVar1 = X509_STORE_add_cert(ctx,(X509 *)*plVar11);
      if (iVar1 != 0) goto LAB_00101eb2;
    }
LAB_00102060:
    local_48 = (X509_STORE_CTX *)0x0;
    iVar1 = 0;
...
bool ssl_security_default_callback
               (uint *param_1,undefined8 param_2,int param_3,int param_4,int param_5,long param_6)
...
LAB_0010242c:
          if ((*(byte *)(*(long *)(*(long *)(param_1 + 6) + 0xd8) + 0x50) & 8) == 0) {
            if (param_5 < 0x303) goto LAB_001024ed;
          }
...
LAB_0010245b:
        ...
        if ((*param_1 & 0x80) != 0) {
          ...
          if (param_1 != (uint *)0x0) goto LAB_0010242c;
        }
      }
LAB_001024c0:
      bVar2 = false;
    ...
    bVar2 = local_34 < 3;
    if (param_3 == 10) goto LAB_001023aa;
  }
  else if (param_3 - 0x10001U < 3) {
    if ((((param_4 < iVar1) || ((*(byte *)(param_6 + 0x20) & 4) != 0)) ||
        ((*(uint *)(param_6 + 0x28) & 1) != 0)) ||
       ((0xa0 < iVar1 && ((*(uint *)(param_6 + 0x28) & 2) != 0)))) goto LAB_001024c0;
...
{
  (**(code **)(*(long *)(param_1 + 0x880) + 0x90))
            (*(undefined8 *)(param_1 + 0x40),0,param_2,param_3,param_4,param_5,
             *(undefined8 *)(*(long *)(param_1 + 0x880) + 0xa0));
  return;
}
...
{
  (**(code **)(*(long *)(param_1 + 0x158) + 0x90))
            (0,param_1,param_2,param_3,param_4,param_5,
             *(undefined8 *)(*(long *)(param_1 + 0x158) + 0xa0));
  return;
}
...

{
  ...
  lVar1 = 0;
  do {
    if ((&ssl_cert_info)[lVar1 * 2] == param_1) goto LAB_001025c2;
    lVar1 = lVar1 + 1;
  } while (lVar1 != 9);

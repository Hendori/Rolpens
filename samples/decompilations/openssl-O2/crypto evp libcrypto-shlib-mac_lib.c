...
undefined8 get_size_t_ctx_param(long *param_1,undefined8 param_2)

{
  ...
  if (param_1[1] != 0) {
    ...
    OSSL_PARAM_construct_size_t(local_a8,param_2,&local_70);
    local_48._0_8_ = local_88;
    pcVar1 = *(code **)(*param_1 + 0x78);
    if (pcVar1 == (code *)0x0) {
      pcVar1 = *(code **)(*param_1 + 0x70);
      if (pcVar1 == (code *)0x0) goto LAB_00100095;
...

{
  ...
  if ((param_1[1] != 0) &&
     (ptr = (long *)CRYPTO_malloc(0x10,"crypto/evp/mac_lib.c",0x39), ptr != (long *)0x0)) {
    lVar1 = param_1[1];
    lVar3 = *param_1;
    *ptr = *param_1;
    ptr[1] = lVar1;
...
void EVP_MAC_CTX_get_mac_size(undefined8 param_1)

{
  get_size_t_ctx_param(param_1,&_LC1);
  return;
}



void EVP_MAC_CTX_get_block_size(undefined8 param_1)

{
  get_size_t_ctx_param(param_1,"block-size");
  return;
}
...

{
  ...
  if ((UNRECOVERED_JUMPTABLE != (code *)0x0) &&
     (*(long *)(*(long *)(param_2 + 0x18) + 0x18) == *(long *)*param_1)) {
...
{
                    /* WARNING: Could not recover jumptable at 0x001003e2. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (*(code **)(param_1 + 0x70) != (code *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00100400. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (*(code **)(*param_1 + 0x78) != (code *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00100424. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (*(code **)(*param_1 + 0x80) != (code *)0x0) {
                    /* WARNING: Could not recover jumptable at 0x00100457. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if ((param_1 == (long *)0x0) || (*param_1 == 0)) {
    ...
    if (param_3 == 0) {
      ...
      if (local_9c[0] != 0) {
        OSSL_PARAM_construct_int(&local_d8,&_LC3,local_9c);
        local_68 = local_b8;
        local_88 = local_d8;
        uStack_80 = uStack_d0;
        local_78 = local_c8;
      ...
      uVar3 = (**(code **)(*param_1 + 0x50))(param_1[1],param_3,&local_90,param_5);
      if (param_4 != (ulong *)0x0) {
        *param_4 = local_90;
      }
    }
...
void EVP_MAC_final(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  evp_mac_final(param_1,0,param_2,param_3,param_4);
  return;
}



void EVP_MAC_finalXOF(undefined8 param_1,undefined8 param_2,undefined8 param_3)

{
  evp_mac_final(param_1,1,param_2,0,param_3);
  return;
}

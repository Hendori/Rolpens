...

{
  ...
  if (0x3fffffff < param_4) {
    ...
    do {
      ...
      DES_ede3_ofb64_encrypt
                (in,out,0x40000000,(DES_key_schedule *)(param_1 + 0xc0),
  ...
  if (param_4 != 0) {
    DES_ede3_ofb64_encrypt
              (param_3,param_2,param_4,(DES_key_schedule *)(param_1 + 0xc0),
               (DES_key_schedule *)(param_1 + 0x140),(DES_key_schedule *)(param_1 + 0x1c0),
               (DES_cblock *)(param_1 + 0x20),&local_44);
  }
...

{
  ...
  if (0x3fffffff < param_4) {
    ...
    do {
      puVar2 = out + 0x40000000;
      DES_ede3_cfb_encrypt
                (in,out,8,0x40000000,(DES_key_schedule *)(param_1 + 0xc0),
                 (DES_key_schedule *)(param_1 + 0x140),(DES_key_schedule *)(param_1 + 0x1c0),
                 (DES_cblock *)(param_1 + 0x20),*(byte *)(param_1 + 0x6c) >> 1 & 1);
      in = in + 0x40000000;
      out = puVar2;
  ...
  if (param_4 != 0) {
    DES_ede3_cfb_encrypt
              (param_3,param_2,8,param_4,(DES_key_schedule *)(param_1 + 0xc0),
               (DES_key_schedule *)(param_1 + 0x140),(DES_key_schedule *)(param_1 + 0x1c0),
               (DES_cblock *)(param_1 + 0x20),*(byte *)(param_1 + 0x6c) >> 1 & 1);
  }
  return 1;

...

{
  ...
  uVar15 = (param_1 + param_2) % 0x101;
  for (puVar14 = (undefined8 *)(&hash_table)[uVar15]; puVar14 != (undefined8 *)0x0;
      puVar14 = (undefined8 *)*puVar14) {
    if ((*(ushort *)((long)puVar14 + 0x1c) == param_1) && (*(int *)(puVar14 + 3) == param_2))
    goto LAB_001000ab;
  }
  puVar14 = (undefined8 *)app_malloc(0x20,"hash bucket");
  uVar4 = nilbucket_1._24_8_;
  uVar3 = nilbucket_1._16_8_;
  uVar13 = nilbucket_1._8_8_;
  *puVar14 = nilbucket_1._0_8_;
  puVar14[1] = uVar13;
  puVar14[2] = uVar3;
  puVar14[3] = uVar4;
  uVar13 = (&hash_table)[uVar15];
  *(short *)((long)puVar14 + 0x1c) = (short)param_1;
  *puVar14 = uVar13;
  *(int *)(puVar14 + 3) = param_2;
  (&hash_table)[uVar15] = puVar14;
LAB_001000ab:
  plVar2 = (long *)puVar14[1];
  if (plVar2 == (long *)0x0) {
LAB_00100110:
    uVar1 = *(ushort *)((long)puVar14 + 0x1e);
  }
  else {
    sVar16 = (size_t)evpmdsize;
    local_48 = plVar2;
    if (param_4 == (void *)0x0) {
      do {
        iVar11 = strcmp(param_3,(char *)local_48[1]);
        if (iVar11 == 0) goto LAB_001000d4;
    ...
    do {
      while( true ) {
        plVar17 = plVar2;
        iVar11 = memcmp(param_4,(void *)((long)plVar17 + 0x13),sVar16);
        if (iVar11 == 0) {
          pcVar12 = "CRL";
          if (param_1 == 0) {
            pcVar12 = "certificate";
          ...
          uVar13 = opt_getprog();
          BIO_printf(_bio_err,"%s: warning: skipping duplicate %s in %s\n",uVar13,pcVar12,param_3);
          return 0;
        }
        iVar11 = strcmp(param_3,(char *)plVar17[1]);
        plVar2 = (long *)*plVar17;
        if (iVar11 == 0) break;
        if (plVar2 == (long *)0x0) goto LAB_00100300;
      }
      local_48 = plVar17;
    } while (plVar2 != (long *)0x0);
LAB_00100300:
    if (local_48 != (long *)0x0) goto LAB_001000d4;
    uVar1 = *(ushort *)((long)puVar14 + 0x1e);
  }
  if (uVar1 < 0x100) {
    local_48 = (long *)app_malloc(0x58,"collision bucket");
    uVar10 = nilhentry_0._72_8_;
    uVar9 = nilhentry_0._64_8_;
    uVar8 = nilhentry_0._56_8_;
    uVar7 = nilhentry_0._48_8_;
    uVar6 = nilhentry_0._40_8_;
    uVar5 = nilhentry_0._32_8_;
    uVar4 = nilhentry_0._24_8_;
    uVar3 = nilhentry_0._16_8_;
    uVar13 = nilhentry_0._8_8_;
    *local_48 = nilhentry_0._0_8_;
    local_48[1] = uVar13;
    local_48[2] = uVar3;
    local_48[3] = uVar4;
    local_48[4] = uVar5;
    ...
    local_48[8] = uVar9;
    local_48[9] = uVar10;
    uVar13 = nilhentry_0._80_8_;
    *(undefined2 *)(local_48 + 2) = 0xffff;
    local_48[10] = uVar13;
    pcVar12 = CRYPTO_strdup(param_3,"apps/rehash.c",0xa8);
    local_48[1] = (long)pcVar12;
    if (pcVar12 != (char *)0x0) {
      if ((undefined8 *)puVar14[2] != (undefined8 *)0x0) {
        *(undefined8 *)puVar14[2] = local_48;
      }
      if (puVar14[1] == 0) {
        puVar14[1] = local_48;
      }
      puVar14[2] = local_48;
LAB_001000d4:
      if (param_6 < *(ushort *)(local_48 + 2)) {
        *(ushort *)(local_48 + 2) = param_6;
      }
      if ((param_5 != 0) && (*(char *)((long)local_48 + 0x12) == '\0')) {
        *(undefined1 *)((long)local_48 + 0x12) = 1;
        sVar16 = (size_t)evpmdsize;
        *(short *)((long)puVar14 + 0x1e) = *(short *)((long)puVar14 + 0x1e) + 1;
        memcpy((void *)((long)local_48 + 0x13),param_4,sVar16);
      }
      return 0;
    }
...

{
  ...
  pbVar7 = param_1;
  do {
    if ((*(byte *)((long)*ppuVar2 + (ulong)*pbVar7 * 2 + 1) & 0x10) == 0) goto LAB_00100478;

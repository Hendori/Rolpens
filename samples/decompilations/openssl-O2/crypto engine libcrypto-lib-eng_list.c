...

{
  ...
  if (*(long *)(param_1 + 0xd8) == 0) {
    ...
    if (param_3 != 0) {
      ...
      if (engine_dyn_list_head != 0) goto LAB_0010005c;
      uVar4 = 0;
      if (*(long *)(param_1 + 0xd8) != 0) goto LAB_001000e7;
LAB_0010008a:
...
LAB_001000b7:
    ...
    *(undefined8 *)(param_1 + 0xd0) = 0;
    ...
    if ((param_3 != 0) && (iVar1 = CRYPTO_THREAD_write_lock(_global_engine_lock), iVar1 == 0)) {
      return 0;
    }
    lVar3 = engine_dyn_list_head;
    lVar2 = engine_dyn_list_head;
...
LAB_00100091:
      if (lVar3 == 0) {
        if (engine_dyn_list_tail == 0) goto LAB_00100164;
      }
...
LAB_0010005c:
        if (param_2 == *(long *)(lVar2 + 0xd8)) goto LAB_00100065;
      }
      if (*(long *)(param_1 + 0xd8) == 0) goto LAB_0010008a;
    }
LAB_00100065:
    uVar4 = 0;
  }
...
LAB_00100787:
    ...
    do {
      ...
      if (iVar3 == 0) goto LAB_00100718;
    } while (pEVar4 != (ENGINE *)0x0);
    if (iVar3 != 0) goto LAB_001005e7;
LAB_00100718:
    ERR_new();
  ...
  if (e == (ENGINE *)0x0) {
    ...
    if (iVar3 != 0) {
      ...
      if ((e != engine_list_head) && (engine_list_head != (ENGINE *)0x0)) {
        do {
          pEVar4 = *(ENGINE **)(pEVar4 + 0xc0);
          if (pEVar4 == (ENGINE *)0x0) goto LAB_001008c0;
        } while (e != pEVar4);
      }

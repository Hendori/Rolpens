  ...
  do {
    while ((iVar1 = test_true("test/constant_time_test.c",0xb1,
           ...
           && (iVar1 = test_true("test/constant_time_test.c",0xb3,
              ...
              iVar1 != 0))) {
      puVar2 = puVar2 + 1;
      if (puVar2 == (undefined4 *)&DAT_00101be4) {
        return local_40;
      }
    }
    puVar2 = puVar2 + 1;
    local_40 = 0;
  } while (puVar2 != (undefined4 *)&DAT_00101be4);
  return 0;
}
  ...
  do {
    while( true ) {
      ...
      if ((iVar3 == 0) ||
         ...
         iVar3 == 0)) break;
      puVar4 = puVar4 + 1;
      if (puVar4 == &DAT_00101ca1) {
        return local_40;
      }
    }
    puVar4 = puVar4 + 1;
    local_40 = 0;
  } while (puVar4 != &DAT_00101ca1);
  return 0;
}
            ...
            if ((iVar2 != 0) &&
               ((iVar2 = test_uint_eq("test/constant_time_test.c",0x41,"op(a, b)","CONSTTIME_TRUE",
                ...
                (iVar2 = test_uint_eq("test/constant_time_test.c",0x43,"op(a, b)","CONSTTIME_FALSE",
                                      ~uVar4,0), iVar2 != 0)))) goto LAB_00100dec;
          }
          else {
...
LAB_00100c60:
    if (pNVar8 == &NoteGnuProperty_4_00101ce8) {
      return local_54;
    }
    dVar5 = pNVar8->namesz;
  ...
  do {
    ...
    if ((iVar2 == 0) ||
       (iVar2 = test_uint_eq("test/constant_time_test.c",0xbc,
                             "constant_time_select_s(CONSTTIME_FALSE_S, a, b)",&_LC7,(int)uVar7,
                             uVar7 & 0xffffffff), iVar2 == 0)) {
LAB_00101250:
      local_6c = 0;
    }
      ...
      if (uVar1 != uVar7) {
        ...
        iVar2 = test_int_eq("test/constant_time_test.c",0xe8,"constant_time_eq_s(a, b)",
                            "CONSTTIME_FALSE_S",(long)(~uVar5 & uVar5 - 1) >> 0x3f,0);
        if (iVar2 != 0) {
          uVar6 = (long)((uVar1 - uVar7 ^ uVar7 | uVar5) ^ uVar1) >> 0x3f;
          if (uVar1 < uVar7) {
            iVar2 = test_size_t_eq("test/constant_time_test.c",0x58,"op(a, b)","CONSTTIME_TRUE_S",
                                   uVar6,0xffffffffffffffff);
            if (iVar2 != 0) goto LAB_00101138;
          }
          else {
            iVar2 = test_uint_eq("test/constant_time_test.c",0x5a,"op(a, b)","CONSTTIME_FALSE_S",
                                 uVar6 & 0xffffffff,0);
            if (iVar2 != 0) {
              uVar3 = (long)((uVar7 - uVar1 ^ uVar1 | uVar5) ^ uVar7) >> 0x3f;
              iVar2 = test_size_t_eq("test/constant_time_test.c",0x58,"op(a, b)","CONSTTIME_TRUE_S",
                                     uVar3,0xffffffffffffffff);
              if ((iVar2 != 0) &&
                 (iVar2 = test_size_t_eq("test/constant_time_test.c",0x58,"op(a, b)",
                                         "CONSTTIME_TRUE_S",~uVar6,0xffffffffffffffff), iVar2 != 0))
              {
                uVar3 = ~uVar3;
LAB_001013e2:
                iVar2 = test_uint_eq("test/constant_time_test.c",0x5a,"op(a, b)","CONSTTIME_FALSE_S"
                                     ,uVar3,0);
                if (iVar2 != 0) goto LAB_001011fc;
              }
            }
          }
        }
      ...
      iVar2 = test_size_t_eq("test/constant_time_test.c",0xe6,"constant_time_eq_s(a, b)",
                             "CONSTTIME_TRUE_S",0xffffffffffffffff,0xffffffffffffffff);
      if ((iVar2 == 0) ||
         (iVar2 = test_uint_eq("test/constant_time_test.c",0x5a,"op(a, b)","CONSTTIME_FALSE_S",0,0),
         iVar2 == 0)) goto LAB_00101250;
      uVar5 = 0;
LAB_00101138:
      uVar6 = (uVar7 - uVar1 ^ uVar1 | uVar5) ^ uVar7;
      uVar3 = (long)uVar6 >> 0x3f;
      iVar2 = test_uint_eq("test/constant_time_test.c",0x5a,"op(a, b)","CONSTTIME_FALSE_S",
                           (int)((long)uVar6 >> 0x3f),0);
      if (iVar2 == 0) goto LAB_00101250;
      uVar6 = ~((long)((uVar1 - uVar7 ^ uVar7 | uVar5) ^ uVar1) >> 0x3f);
      if (uVar7 <= uVar1) {
        iVar2 = test_size_t_eq("test/constant_time_test.c",0x58,"op(a, b)","CONSTTIME_TRUE_S",uVar6,
                               0xffffffffffffffff);
        if (iVar2 != 0) {
          uVar3 = ~uVar3;
          if (uVar7 < uVar1) goto LAB_001013e2;
          iVar2 = test_size_t_eq("test/constant_time_test.c",0x58,"op(a, b)","CONSTTIME_TRUE_S",
                                 uVar3,0xffffffffffffffff);
          if (((iVar2 != 0) &&
              (iVar2 = test_size_t_eq("test/constant_time_test.c",0x58,"op(a, b)","CONSTTIME_TRUE_S"
      ...
      iVar2 = test_uint_eq("test/constant_time_test.c",0x5a,"op(a, b)","CONSTTIME_FALSE_S",uVar6,0);
      if ((iVar2 == 0) ||
         (iVar2 = test_size_t_eq("test/constant_time_test.c",0x58,"op(a, b)","CONSTTIME_TRUE_S",
                                 ~uVar3,0xffffffffffffffff), iVar2 == 0)) goto LAB_00101250;
LAB_001011fc:
      uVar7 = ~uVar5 & uVar5 - 1;
      iVar2 = test_uint_eq("test/constant_time_test.c",0x5a,"op(a, b)","CONSTTIME_FALSE_S",
                           (long)uVar7 >> 0x3f & 0xffffffff,0);
      if ((iVar2 == 0) ||
         (iVar2 = test_uint_eq("test/constant_time_test.c",0x5a,"op(a, b)","CONSTTIME_FALSE_S",
                               (int)((long)uVar7 >> 0x3f),0), iVar2 == 0)) goto LAB_00101250;
    }
LAB_00101258:
    if (puVar4 == (ulong *)&DAT_00101c50) {
      return local_6c;
    }
    uVar7 = *puVar4;
    puVar4 = puVar4 + 1;

  ...
  *(undefined1 (*) [16])(param_1 + 0x58) = (undefined1  [16])0x0;
  if (param_3 == 0x18) {
    ...
    *(undefined8 *)(param_1 + 0x60) = uVar2;
    auVar5 = EVP_CIPHER_fetch(uVar1,"AES-192-CTR",0);
    uVar4 = auVar5._8_8_;
    lVar3 = *(long *)(param_1 + 0x60);
    *(long *)(param_1 + 0x58) = auVar5._0_8_;
  }
  else if (param_3 == 0x20) {
    uVar2 = EVP_CIPHER_fetch(uVar1,"AES-256-CBC",0);
    *(undefined8 *)(param_1 + 0x60) = uVar2;
    auVar5 = EVP_CIPHER_fetch(uVar1,"AES-256-CTR",0);
    uVar4 = auVar5._8_8_;
    lVar3 = *(long *)(param_1 + 0x60);
    *(long *)(param_1 + 0x58) = auVar5._0_8_;
  }
    ...
    uVar4 = extraout_RDX;
    if (param_3 != 0x10) goto LAB_001002a0;
    uVar2 = EVP_CIPHER_fetch(uVar1,"AES-128-CBC",0);
    *(undefined8 *)(param_1 + 0x60) = uVar2;
    auVar5 = EVP_CIPHER_fetch(uVar1,"AES-128-CTR",0);
    uVar4 = auVar5._8_8_;
    lVar3 = *(long *)(param_1 + 0x60);
    *(long *)(param_1 + 0x58) = auVar5._0_8_;
  }
  if ((lVar3 != 0) && (*(long *)(param_1 + 0x58) != 0)) {
    auVar6._0_8_ = ossl_siv128_init(param_1 + 0x18,param_2,param_3 & 0xffffffff,lVar3,
                                    *(long *)(param_1 + 0x58),uVar1);
    auVar6._8_8_ = 0;
    return auVar6;
  }
LAB_001002a0:

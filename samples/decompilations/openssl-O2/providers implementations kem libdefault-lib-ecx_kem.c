...
undefined8 ecxkem_init(long *param_1,int param_2,long param_3,long param_4,undefined8 param_5)

{
  ...
  if ((iVar1 != 0) && ((*(long *)(param_3 + 0x50) != 0 || (param_2 != 0x2000)))) {
...
LAB_0010020d:
        *(int *)((long)param_1 + 0x24) = param_2;
        uVar3 = ecxkem_set_ctx_params(param_1,param_5);
        return uVar3;
      }
      if (((*(int *)(param_4 + 0x60) == *(int *)(param_3 + 0x60)) &&
          (*(long *)(param_4 + 0x58) == *(long *)(param_3 + 0x58))) &&
         ((*(long *)(param_4 + 0x50) != 0 || (param_2 != 0x1000)))) {
        ossl_ecx_key_free(param_1[1]);
        param_1[1] = 0;
        iVar1 = ossl_ecx_key_up_ref(param_4);
        if (iVar1 != 0) {
          param_1[1] = param_4;
          goto LAB_0010020d;
        }
...
void ecxkem_auth_decapsulate_init
               (undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  ecxkem_init(param_1,0x2000,param_2,param_3,param_4);
  return;
}



void ecxkem_auth_encapsulate_init
               (undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  ecxkem_init(param_1,0x1000,param_2,param_3,param_4);
  return;
}
...

{
  ...
  if (lVar6 != 0) {
    local_1a8 = 0;
    iVar4 = ossl_ecx_compute_key
                      (param_6,param_5,*(undefined8 *)(param_5 + 0x58),local_158 + uVar2,&local_1a8,
                       0x70 - uVar2);
    if (iVar4 == 0) {
      lVar6 = 0;
      uVar5 = 0;
    ...
    if (lVar3 != 0) {
      lVar9 = lVar3 + 0x11;
      uVar10 = uVar2 * 2;
      if ((*(byte *)(lVar3 + 0x10) & 1) != 0) goto LAB_0010045e;
    }
    ERR_new();
    lVar6 = 0;
  ...
  lVar9 = 0;
LAB_0010045e:
  if (uVar10 + uVar2 < 0xa9) {
    __memcpy_chk(local_e8,param_7,uVar2,0xa8);
    uVar7 = 0xa8;
    if (0xa7 < uVar2) {
      uVar7 = uVar2;
    }
    __memcpy_chk(local_e8 + uVar2,param_8,uVar2,uVar7 - uVar2);
    if (lVar6 != 0) {
      uVar7 = uVar2 * 2;
      uVar8 = 0xa8;
      if (0xa7 < uVar7) {
      ...
      if (iVar4 == 0) {
        ...
        iVar4 = ossl_hpke_labeled_expand
                          (lVar6,param_2,uVar7,local_198,uVar7,&LABEL_KEM,&local_19a,2,
                           "shared_secret",local_e8,uVar10 + uVar2);
        if (iVar4 == 0) {
          OPENSSL_cleanse(local_198,uVar7);
          uVar5 = 0;
        }
  ...
  uVar5 = 0;
LAB_00100410:
  OPENSSL_cleanse(local_158,uVar10);
...
LAB_00100ef8:
        ...
        if (iVar4 == 0) goto LAB_00100ef8;
        iVar4 = ossl_ecx_public_from_private(lVar5);
        if (iVar4 == 0) goto LAB_00100ef8;
        *(byte *)(lVar5 + 0x10) = *(byte *)(lVar5 + 0x10) | 1;
LAB_00100d08:
        __src = (void *)(lVar5 + 0x11);
        if ((*(byte *)(lVar5 + 0x10) & 1) == 0) goto LAB_00100ebb;
      }
      lVar2 = *param_1;
      if ((lVar2 == 0) || ((*(byte *)(lVar2 + 0x10) & 1) == 0)) {
        ERR_new();

...

{
  ...
  ISSUING_DIST_POINT *pIVar14;
  void *pvVar15;
  X509_EXTENSION *pXVar16;
  ASN1_OBJECT *pAVar17;
  undefined8 uVar18;
  X509_REVOKED *x;
  ASN1_INTEGER *a;
...
LAB_00100cf8:
  ...
  case 4:
    ...
    if ((pcVar6 != (code *)0x0) && (iVar9 = (*pcVar6)(data), iVar9 == 0)) goto LAB_00100cf8;
    AUTHORITY_KEYID_free((AUTHORITY_KEYID *)data[1].signature);
    ISSUING_DIST_POINT_free(*(ISSUING_DIST_POINT **)&data[1].references);
    ASN1_INTEGER_free((ASN1_INTEGER *)data[1].idp);
    ASN1_INTEGER_free(*(ASN1_INTEGER **)&data[1].idp_flags);
  ...
  case 5:
    ...
    *(undefined8 **)&data[1].references = puVar12;
    if (puVar12 == (undefined8 *)0x0) {
      if (local_48 != -1) goto LAB_00100c40;
    }
    else {
      ...
      *(uint *)&data[1].akid = uVar10 | 1;
      if (0 < iVar9) {
        *(uint *)&data[1].akid = uVar10 | 5;
      }
      if (*(int *)((long)puVar12 + 0xc) < 1) {
        if (0 < *(int *)((long)puVar12 + 0x1c)) {
          uVar10 = *(uint *)&data[1].akid | 0x10;
          goto LAB_00100d96;
        }
      }
      else {
        uVar10 = *(uint *)&data[1].akid | 8;
        uVar21 = *(uint *)&data[1].akid | 0x18;
        if (*(int *)((long)puVar12 + 0x1c) < 1) {
LAB_00100d96:
          *(uint *)&data[1].akid = uVar10;
          uVar21 = uVar10;
          if (0 >= iVar9) goto LAB_00100950;
        }
        *(uint *)&data[1].akid = uVar21 | 2;
      }
LAB_00100950:
      if (0 < *(int *)(puVar12 + 3)) {
      ...
      iVar9 = DIST_POINT_set_dpname((DIST_POINT_NAME *)*puVar12,iname);
      if (iVar9 == 0) {
LAB_00100c40:
        puVar1 = (uint *)((long)&data[1].sig_alg + 4);
        *puVar1 = *puVar1 | 0x80;
    ...
    pAVar13 = (ASN1_BIT_STRING *)X509_CRL_get_ext_d2i(data,0x5a,&local_48,(int *)0x0);
    data[1].signature = pAVar13;
    if ((pAVar13 == (ASN1_BIT_STRING *)0x0) && (local_48 != -1)) {
      puVar1 = (uint *)((long)&data[1].sig_alg + 4);
      *puVar1 = *puVar1 | 0x80;
    }
    pIVar14 = (ISSUING_DIST_POINT *)X509_CRL_get_ext_d2i(data,0x58,&local_48,(int *)0x0);
    data[1].idp = pIVar14;
    if ((pIVar14 == (ISSUING_DIST_POINT *)0x0) && (local_48 != -1)) {
      puVar1 = (uint *)((long)&data[1].sig_alg + 4);
      *puVar1 = *puVar1 | 0x80;
    }
    pvVar15 = X509_CRL_get_ext_d2i(data,0x8c,&local_48,(int *)0x0);
    *(void **)&data[1].idp_flags = pvVar15;
    if (pvVar15 == (void *)0x0) {
      if (local_48 != -1) goto LAB_00100d34;
    }
...
LAB_00100d34:
    ...
    pAVar20 = data->crl_number;
    iVar22 = 0;
    iVar9 = OPENSSL_sk_num(pAVar20);
    if (0 < iVar9) {
      do {
        pXVar16 = (X509_EXTENSION *)OPENSSL_sk_value(pAVar20,iVar22);
        pAVar17 = X509_EXTENSION_get_object(pXVar16);
        iVar9 = OBJ_obj2nid(pAVar17);
        if (iVar9 == 0x359) {
          puVar1 = (uint *)((long)&data[1].sig_alg + 4);
          *puVar1 = *puVar1 | 0x1000;
          iVar9 = X509_EXTENSION_get_critical(pXVar16);
          if (iVar9 != 0) goto LAB_00100d1a;
        }
        else {
          iVar11 = X509_EXTENSION_get_critical(pXVar16);
          if (((iVar11 != 0) && (iVar9 != 0x302 && iVar9 != 0x5a)) && (iVar9 != 0x8c)) {
LAB_00100d1a:
            puVar1 = (uint *)((long)&data[1].sig_alg + 4);
            *puVar1 = *puVar1 | 0x200;
            break;
    ...
    uVar18 = X509_CRL_get_REVOKED(data);
    pAVar20 = (ASN1_INTEGER *)0x0;
    for (iVar9 = 0; iVar22 = OPENSSL_sk_num(uVar18), iVar9 < iVar22; iVar9 = iVar9 + 1) {
      x = (X509_REVOKED *)OPENSSL_sk_value(uVar18,iVar9);
      a = (ASN1_INTEGER *)X509_REVOKED_get_ext_d2i(x,0x303,&local_44,(int *)0x0);
      if (a != (ASN1_INTEGER *)0x0) {
        pAVar20 = data[1].crl_number;
        if (pAVar20 == (ASN1_INTEGER *)0x0) {
          pAVar20 = (ASN1_INTEGER *)OPENSSL_sk_new_null();
          data[1].crl_number = pAVar20;
          if (pAVar20 != (ASN1_INTEGER *)0x0) goto LAB_00100b27;
        }
        else {
LAB_00100b27:
          iVar22 = OPENSSL_sk_push(pAVar20,a);
          if (iVar22 != 0) goto LAB_00100b3a;
        }
...
LAB_00100b3a:
      ...
      if (a_00 == (ASN1_ENUMERATED *)0x0) {
        if (local_44 != -1) goto LAB_00100ca3;
        *(undefined4 *)&x[1].revocationDate = 0xffffffff;
      }
      else {
        lVar19 = ASN1_ENUMERATED_get(a_00);
        *(int *)&x[1].revocationDate = (int)lVar19;
      ...
      while (iVar22 = OPENSSL_sk_num(uVar5), local_44 < iVar22) {
        pXVar16 = (X509_EXTENSION *)OPENSSL_sk_value(uVar5);
        iVar22 = X509_EXTENSION_get_critical(pXVar16);
        if (iVar22 != 0) {
          pAVar17 = X509_EXTENSION_get_object(pXVar16);

...

{
  ...
  if (rand_engine_lock != 0) {
    ...
    if ((rand_meth_lock != 0) && (iVar1 = ossl_rand_pool_init(), iVar1 != 0)) {
      rand_inited = 1;
...
long rand_get0_private(undefined8 param_1,long param_2)

{
  ...
  lVar2 = CRYPTO_THREAD_get_local(param_2 + 0x2c);
  if ((((lVar2 == 0) && (lVar3 = rand_get0_primary(param_1,param_2), lVar3 != 0)) &&
      (lVar4 = ossl_lib_ctx_get_concrete(param_1), lVar4 != 0)) &&
     ((lVar5 = CRYPTO_THREAD_get_local(param_2 + 0x28), lVar5 != 0 ||
      (iVar1 = ossl_init_thread_start(0,lVar4,rand_delete_thread_state), iVar1 != 0)))) {
    lVar2 = rand_new_drbg(lVar4,lVar3,0x10000,0x1a4);
    CRYPTO_THREAD_set_local(param_2 + 0x2c,lVar2);
    return lVar2;
  }
  return lVar2;
}
...
long rand_get0_public(undefined8 param_1,long param_2)

{
  ...
  if (param_2 != 0) {
    lVar2 = CRYPTO_THREAD_get_local(param_2 + 0x28);
    if (lVar2 != 0) {
      return lVar2;
    }
    lVar2 = rand_get0_primary(param_1,param_2);
    if ((lVar2 != 0) && (lVar3 = ossl_lib_ctx_get_concrete(param_1), lVar3 != 0)) {
      lVar4 = CRYPTO_THREAD_get_local(param_2 + 0x2c);
      if ((lVar4 == 0) &&
         (iVar1 = ossl_init_thread_start(0,lVar3,rand_delete_thread_state), iVar1 == 0)) {
        return 0;
      }
      lVar2 = rand_new_drbg(lVar3,lVar2,0x10000,0x1a4);
      CRYPTO_THREAD_set_local(param_2 + 0x28,lVar2);
      return lVar2;
    }
  }
  return 0;
...
bool set_random_provider_name(long param_1,char *param_2)

{
  ...
  CRYPTO_free(ptr);
  pcVar2 = CRYPTO_strdup(param_2,"crypto/rand/rand_lib.c",0x82);
...

{
  ...
  iVar1 = CRYPTO_THREAD_run_once(&rand_init,do_rand_init_ossl_);
  if (((iVar1 != 0) && (do_rand_init_ossl_ret_ != 0)) &&
     (iVar1 = CRYPTO_THREAD_read_lock(rand_meth_lock), pRVar2 = default_RAND_meth, iVar1 != 0)) {
    CRYPTO_THREAD_unlock(rand_meth_lock);
...

{
  ...
  if (engine == (ENGINE *)0x0) {
    ...
    if (pRVar2 == (RAND_METHOD *)0x0) goto LAB_00100ca0;
  }
...

{
  ...
  if ((pRVar2 != (RAND_METHOD *)0x0) && (pRVar2->pseudorand != (_func_3916 *)0x0)) {
                    /* WARNING: Could not recover jumptable at 0x00100d0d. Too many branches */
...

{
  ...
  if ((pRVar2 != (RAND_METHOD *)0x0) && (pRVar3 = (RAND_METHOD *)RAND_OpenSSL(), pRVar2 != pRVar3))
  {
    if (pRVar2->bytes == (_func_3913 *)0x0) {
      ...
      return -1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x00100d99. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  ...
  if (lVar4 != 0) {
    ...
    lVar4 = rand_get0_private(param_1,lVar4);
    if (lVar4 != 0) {
...

{
  ...
  if (lVar4 != 0) {
    ...
    lVar4 = rand_get0_public(param_1,lVar4);
    if (lVar4 != 0) {
      iVar1 = EVP_RAND_generate(lVar4,param_2,param_3,param_4,0,0,0);
      return iVar1;
    }
...
undefined8 RAND_get0_primary(undefined8 param_1)

{
  ...
  lVar1 = ossl_lib_ctx_get_data(param_1,5);
  if (lVar1 != 0) {
    uVar2 = rand_get0_primary(param_1,lVar1);
    return uVar2;
  }
  return 0;
}
...

{
  ...
  if ((pRVar1 != (RAND_METHOD *)0x0) && (pRVar1->seed != (_func_3912 *)0x0)) {
                    /* WARNING: Could not recover jumptable at 0x0010123c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*pRVar1->seed)(buf,num);
    return;
  }
...

{
  ...
  if ((pRVar1 != (RAND_METHOD *)0x0) && (pRVar1->add != (_func_3915 *)0x0)) {
                    /* WARNING: Could not recover jumptable at 0x001013f3. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
undefined8 RAND_get0_public(undefined8 param_1)

{
  ...
  lVar1 = ossl_lib_ctx_get_data(param_1,5);
  if (lVar1 != 0) {
    uVar2 = rand_get0_public(param_1,lVar1);
    return uVar2;
  }
  return 0;
}
...
undefined8 RAND_get0_private(undefined8 param_1)

{
  ...
  lVar1 = ossl_lib_ctx_get_data(param_1,5);
  if (lVar1 != 0) {
    uVar2 = rand_get0_private(param_1,lVar1);
    return uVar2;
  }
  return 0;
}
...
undefined8
RAND_set_DRBG_type(undefined8 param_1,char *param_2,char *param_3,char *param_4,char *param_5)

{
  ...
  if (lVar1 != 0) {
    if (*(long *)(lVar1 + 0x10) == 0) {
      if ((param_2 == (char *)0x0) ||
         (param_2 = CRYPTO_strdup(param_2,"crypto/rand/rand_lib.c",0x3b8), param_2 != (char *)0x0))
      {
        CRYPTO_free(*(void **)(lVar1 + 0x30));
        *(char **)(lVar1 + 0x30) = param_2;
        if ((param_3 == (char *)0x0) ||
           (param_3 = CRYPTO_strdup(param_3,"crypto/rand/rand_lib.c",0x3b8), param_3 != (char *)0x0)
           ) {
          CRYPTO_free(*(void **)(lVar1 + 0x48));
          *(char **)(lVar1 + 0x48) = param_3;
          if ((param_4 == (char *)0x0) ||
             (param_4 = CRYPTO_strdup(param_4,"crypto/rand/rand_lib.c",0x3b8),
             param_4 != (char *)0x0)) {
            CRYPTO_free(*(void **)(lVar1 + 0x38));
            *(char **)(lVar1 + 0x38) = param_4;
            if ((param_5 == (char *)0x0) ||
               (param_5 = CRYPTO_strdup(param_5,"crypto/rand/rand_lib.c",0x3b8),
               param_5 != (char *)0x0)) {
...

{
  ...
  if (param_2 == 0) {
    ...
    *(undefined1 (*) [16])(lVar2 + 0x18) = (undefined1  [16])0x0;
    ...
    uVar3 = OSSL_PROVIDER_get0_name(param_2);
    iVar1 = set_random_provider_name(lVar2,uVar3);
    if (iVar1 == 0) {
      return 0;
    }
    ...
    if (lVar3 != 0) {
      do {
        ...
        if (iVar1 == 0) {
          ...
          if ((pcVar4 != (char *)0x0) &&
             (pcVar4 = CRYPTO_strdup(pcVar4,"crypto/rand/rand_lib.c",0x3b8), pcVar4 == (char *)0x0))
          {
            return 0;
          }
          ...
          if (iVar1 == 0) {
            ...
            *(char **)(lVar3 + 0x38) = pcVar4;
            ...
            if (iVar1 == 0) {
              pcVar4 = *(char **)(lVar6 + 0x10);
              if ((pcVar4 != (char *)0x0) &&
                 (pcVar4 = CRYPTO_strdup(pcVar4,"crypto/rand/rand_lib.c",0x3b8),
                 pcVar4 == (char *)0x0)) {
                return 0;
              }
                  ...
                  if (iVar1 == 0) {
                    ...
                    *(char **)(lVar3 + 0x58) = pcVar4;
                    ...
                    if (iVar1 == 0) {
                      ...
                      if (lVar7 == 0) {
                        iVar1 = set_random_provider_name(lVar3,*(undefined8 *)(lVar6 + 0x10));
                        if (iVar1 == 0) {
                          return 0;
                        }
                      }
                      ...
                      ERR_set_error(0xf,0x78,"name=%s, value=%s",*(undefined8 *)(lVar6 + 8),

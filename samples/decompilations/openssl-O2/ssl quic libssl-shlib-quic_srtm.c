...
undefined8 srtm_remove_from_rev(long param_1,long *param_2)

{
  ...
  plVar2 = (long *)OPENSSL_LH_retrieve(*(undefined8 *)(param_1 + 0x10));
  if (param_2 == plVar2) {
    if (*param_2 == 0) {
      OPENSSL_LH_delete(*(undefined8 *)(param_1 + 0x10),param_2);
    }
    else {
      OPENSSL_LH_insert();
        ...
        if (pEVar4 != (EVP_CIPHER_CTX *)0x0) {
          ...
          if (iVar1 != 0) {
            ...
            lVar3 = OPENSSL_LH_set_thunks
                              (uVar5,0x100000,lh_SRTM_ITEM_cfn_thunk,lh_SRTM_ITEM_doall_thunk,
...
undefined8
ossl_quic_srtm_add(undefined8 *param_1,int ****param_2,int ****param_3,undefined8 *param_4)

{
  ...
  if ((*(byte *)(param_1 + 3) & 1) == 0) {
    ...
    for (pppppiVar5 = pppppiVar4; pppppiVar5 != (int *****)0x0;
        pppppiVar5 = (int *****)pppppiVar5[1]) {
      if (param_3 == pppppiVar5[3]) goto LAB_00100388;
    ...
    if (pppppiVar5 != (int *****)0x0) {
      ...
      iVar3 = EVP_EncryptUpdate(ctx,(uchar *)(pppppiVar5 + 6),(int *)&local_90,
                                (uchar *)(pppppiVar5 + 4),0x10);
      if ((iVar3 != 0) && ((int)local_90 == 0x10)) {
        if (pppppiVar4 == (int *****)0x0) {
          ...
          pppppiVar8 = &local_90;
          do {
            if (pppppiVar6[3] <= pppppiVar5[3]) {
              pppppiVar6 = (int *****)*pppppiVar8;
              break;
            }
            pppppiVar8 = pppppiVar6 + 1;
            pppppiVar6 = (int *****)pppppiVar6[1];
          } while (pppppiVar6 != (int *****)0x0);
          pppppiVar5[1] = (int ****)pppppiVar6;
          *pppppiVar8 = (int ****)pppppiVar5;
        ...
        if (pppppiVar4 == (int *****)0x0) {
          uVar7 = param_1[2];
LAB_00100520:
          OPENSSL_LH_insert(uVar7,pppppiVar5);
          ...
          local_90 = (int ****)pppppiVar4;
          pppppiVar8 = pppppiVar4;
          pppppiVar6 = &local_90;
          do {
            pppppiVar9 = pppppiVar8;
            if (pppppiVar9[2] <= pppppiVar5[2]) {
              pppppiVar8 = (int *****)*pppppiVar6;
              pppppiVar9 = pppppiVar6;
              break;
            }
            pppppiVar8 = (int *****)*pppppiVar9;
            pppppiVar6 = pppppiVar9;
          } while (pppppiVar8 != (int *****)0x0);
          *pppppiVar5 = (int ****)pppppiVar8;
...

{
  ...
  if (((*(byte *)(param_1 + 0x18) & 1) == 0) &&
     (local_58 = param_2, ptr = (void *)OPENSSL_LH_retrieve(*(undefined8 *)(param_1 + 8),auStack_68)
     , ptr != (void *)0x0)) {
    pvVar4 = (void *)0x0;
    while (param_3 != *(ulong *)((long)ptr + 0x18)) {
      if ((*(ulong *)((long)ptr + 0x18) < param_3) ||
         (plVar1 = (long *)((long)ptr + 8), pvVar4 = ptr, ptr = (void *)*plVar1,
         (void *)*plVar1 == (void *)0x0)) goto LAB_00100602;
    }
    if (pvVar4 == (void *)0x0) {
      if (*(long *)((long)ptr + 8) == 0) {
        ...
        OPENSSL_LH_insert();
        iVar2 = OPENSSL_LH_error(*(undefined8 *)(param_1 + 8));
        if (iVar2 != 0) {
          *(byte *)(param_1 + 0x18) = *(byte *)(param_1 + 0x18) | 1;
          uVar3 = 0;
          goto LAB_0010068a;
      ...
      *(long *)((long)pvVar4 + 8) = *(long *)((long)ptr + 8);
    }
    iVar2 = srtm_remove_from_rev(param_1,ptr);
    if (iVar2 != 0) {
      CRYPTO_free(ptr);
      uVar3 = 1;
      goto LAB_0010068a;
...

{
  ...
  local_68 = param_2;
  if ((*(byte *)(param_1 + 0x18) & 1) == 0) {
    ptr = (void *)OPENSSL_LH_retrieve(*(undefined8 *)(param_1 + 8),auStack_78);
    ptr_00 = ptr;
    if (ptr != (void *)0x0) {
      do {
        pvVar1 = *(void **)((long)ptr_00 + 8);
        if (ptr != ptr_00) {
          srtm_remove_from_rev(param_1,ptr_00);
          CRYPTO_free(ptr_00);
        }
        ptr_00 = pvVar1;
      } while (pvVar1 != (void *)0x0);
      OPENSSL_LH_delete(*(undefined8 *)(param_1 + 8),ptr);
      srtm_remove_from_rev(param_1,ptr);
      CRYPTO_free(ptr);
    }
    uVar2 = 1;
  }
...
ossl_quic_srtm_lookup
          (undefined8 *param_1,uchar *param_2,long param_3,undefined8 *param_4,undefined8 *param_5)

{
  ...
  if ((*(byte *)(param_1 + 3) & 1) == 0) {
    ...
    if (((iVar1 != 0) && (local_7c == 0x10)) &&
       (puVar2 = (undefined8 *)OPENSSL_LH_retrieve(param_1[2],local_78), puVar2 != (undefined8 *)0x0
       )) {
      if (param_3 != 0) {
        puVar2 = (undefined8 *)*puVar2;
        for (param_3 = param_3 + -1; param_3 != 0; param_3 = param_3 + -1) {
          if (puVar2 == (undefined8 *)0x0) goto LAB_001007e6;
          puVar2 = (undefined8 *)*puVar2;
        }
      }
      if (puVar2 != (undefined8 *)0x0) {

...

{
  ...
  uVar10 = 0;
  lVar4 = OSSL_STORE_open_ex(param_1,param_13,uVar3,param_2,param_3,0,0,0);
  if (lVar4 == 0) {
    BIO_printf(_bio_err,"Couldn\'t open file or uri %s\n",param_1,uVar10);
    ERR_print_errors(_bio_err);
    return 1;
  }
  if ((param_4 == 0) || (iVar2 = OSSL_STORE_expect(lVar4,param_4), iVar2 != 0)) {
    if (param_5 != 0) {
...
LAB_0010022c:
    while (lVar6 = OSSL_STORE_load(lVar4), lVar6 != 0) {
      ...
      if (iVar1 == 1) {
        ...
        if (lVar5 != 0) {
          indent_printf(param_10,_bio_out,&_LC7,lVar5);
        }
        if ((out == (BIO *)0x0) &&
...
switchD_001008aa_caseD_ffffffff:
    BIO_printf(_bio_err,"%s: Use -help for summary.\n",uVar5);
  }
  else {
    if (0x10 < iVar2) {
      if (3 < iVar2 - 0x641U) goto switchD_001008aa_caseD_0;
      iVar2 = opt_provider();
      if (iVar2 == 0) goto LAB_00100a32;
      iVar2 = opt_next();
      goto joined_r0x0010088f;
    }
    if (iVar2 < -1) goto switchD_001008aa_caseD_0;
    switch(iVar2) {
    default:
      goto switchD_001008aa_caseD_0;
    case 1:
      lVar7 = 0;
      uVar3 = 0;
...
LAB_00100cdd:
      ...
      break;
    case 0xc:
      if ((uVar9 & 5) != 0) goto LAB_00100cdd;
...
LAB_00100bb5:
    ...
    case 0xd:
      ...
      if (a == (ASN1_INTEGER *)0x0) {
        ...
        if (a != (ASN1_INTEGER *)0x0) goto LAB_00100bb5;
...
LAB_00100d65:
    ...
    case 0x10:
      ...
      goto switchD_001008aa_caseD_0;
    case -1:
      goto switchD_001008aa_caseD_ffffffff;
    }
  }
LAB_00100a32:
  lVar7 = 0;

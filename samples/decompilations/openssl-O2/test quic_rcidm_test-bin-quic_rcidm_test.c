...
bool ossl_quic_conn_id_eq(byte *param_1,byte *param_2)
                          ...
                          if (iVar1 != 0) {
                            ...
                            if (iVar1 != 0) {
                              ...
                              iVar1 = test_true("test/quic_rcidm_test.c",0x53,
                                                ...
                                                ,iVar1 != 0);
                              if (iVar1 != 0) {
                                iVar1 = ossl_quic_conn_id_eq(&local_d8,cid8_2);
                                  ...
                                  if (iVar1 != 0) {
                                    ...
                                    if (iVar1 != 0) {
                                      ...
                                      iVar1 = test_size_t_eq("test/quic_rcidm_test.c",0x58,
                                                  ...
                                                  "ossl_quic_rcidm_get_num_retiring(rcidm)",&_LC7,
                                                  uVar4,0);
                                      if (iVar1 != 0) {
                                            ...
                                            if (iVar1 != 0) {
                                              ...
                                              if (iVar1 != 0) {
                                                ...
                                                if (iVar1 != 0) {
                                                  ...
                                                  ,iVar1 != 0);
                                                  if (iVar1 != 0) {
                                                    iVar1 = ossl_quic_conn_id_eq(&local_d8,cid8_3);
                                                  ...
                                                  ,iVar1 != 0);
                                                  if (iVar1 != 0) {
                                                    iVar1 = ossl_quic_conn_id_eq(&local_d8,cid8_4);
                                                    iVar1 = test_true("test/quic_rcidm_test.c",0x70,
...
{
  add_all_tests("test_rcidm",test_rcidm,3,1);
  return 1;
}

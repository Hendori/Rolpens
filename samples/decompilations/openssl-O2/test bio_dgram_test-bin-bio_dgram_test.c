...

{
  ...
  if (iVar3 == iVar4) {
    ...
    local_70 = uVar6;
    uVar5 = BIO_ADDR_rawaddress(param_1,local_88,&local_70);
    ...
    if (iVar3 != 0) {
      ...
      iVar3 = test_int_eq("test/bio_dgram_test.c",0x34,"BIO_ADDR_rawaddress(b, pb, &tmplen)",&_LC0,
                          uVar5,1);
      if (iVar3 != 0) {
        iVar3 = test_mem_eq("test/bio_dgram_test.c",0x37,&_LC5,&_LC4,local_88,uVar6);
        if (iVar3 != 0) {
...

{
  ...
  if (param_1 == 2) {
    ...
    local_2a18 = &local_29f4;
    local_2a28 = 4;
LAB_00101799:
    __memset_chk(local_2a18,0,local_2a28);
        ...
        if (iVar1 == 0) {
          ...
          if (iVar1 == 0) {
            ...
            if (iVar1 != 0) {
              ...
              if (iVar1 != 0) {
                uVar2 = BIO_ADDR_rawmake(pcVar5,param_1,local_2a18,local_2a28,0);
                iVar1 = test_int_eq("test/bio_dgram_test.c",0xa5,
                                    "BIO_ADDR_rawmake(addr1, af, pina, inal, 0)",&_LC0,uVar2,1);
                if (iVar1 != 0) {
                  uVar2 = BIO_ADDR_rawmake(parg,param_1,local_2a18,local_2a28,0);
                                        ...
                                        if ((iVar3 != 0) &&
                                          ...
                                          if (iVar3 != 0) {
                                            ...
                                            iVar3 = test_int_eq("test/bio_dgram_test.c",0xdf,
                                                                ...
                                                                uVar2,1);
                                            if (iVar3 != 0) {
                                              uVar2 = BIO_ADDR_rawmake(parg_00,param_1,local_2a18,
                                                                       local_2a28,0);

...
LAB_001000a7:
  switch(uVar3) {
  default:
    goto switchD_001000b4_caseD_0;
  case 1:
    break;
  case 2:
    goto switchD_001000b4_caseD_2;
  case 3:
    goto switchD_001000b4_caseD_3;
  case 4:
    goto switchD_001000b4_caseD_4;
  case 5:
    uVar12 = 1;
    goto switchD_001000b4_caseD_0;
  case 6:
...
switchD_001000b4_caseD_2:
  ...
  iVar2 = BIO_lookup(*(undefined8 *)(param_2 + 4),*(undefined8 *)(param_2 + 6),0,uVar8,param_2[2],
                     param_2 + 10);
  if (iVar2 == 0) goto switchD_001000b4_caseD_0;
...
switchD_001000b4_caseD_3:
  ...
  uVar6 = BIO_socket(uVar5,uVar4,uVar3);
  uVar12 = (ulong)uVar6;
  if (uVar6 == 0xffffffff) {
    ERR_new();
...
joined_r0x0010042c:
    if (iVar2 == 2) {
      ...
      *(BIO **)(param_2 + 0x10) = pBVar10;
      if (pBVar10 == (BIO *)0x0) {
        *param_2 = 7;
        if (UNRECOVERED_JUMPTABLE != (code *)0x0) goto LAB_00100458;
switchD_001000b4_caseD_7:
LAB_001001a3:
        ERR_new();
...
LAB_001001cd:
    uVar12 = 0;
switchD_001000b4_caseD_0:
    if (UNRECOVERED_JUMPTABLE == (code *)0x0) {
      return uVar12;
    }
                    /* WARNING: Could not recover jumptable at 0x001000e8. Too many branches */
  ...
  *(long *)(param_2 + 0xc) = lVar9;
  if (lVar9 == 0) {
    ...
    *param_2 = 7;
    if (UNRECOVERED_JUMPTABLE == (code *)0x0) goto LAB_001001a3;
LAB_00100458:
    uVar3 = 7;
    goto LAB_00100398;
  }
  ...
  *param_2 = 3;
  ...
  uVar3 = *param_2;
LAB_0010010e:
  if (UNRECOVERED_JUMPTABLE != (code *)0x0) goto LAB_00100398;
  goto LAB_001000a7;
LAB_00100398:
...
void conn_puts(undefined8 param_1,char *param_2)

{
  size_t sVar1;
  
  sVar1 = strlen(param_2);
  conn_write(param_1,param_2,sVar1 & 0xffffffff);
  return;
}

        ...
        if (lVar5 == 0) {
          ...
          if ((ulong)(lVar9 * 2) < 0x200) {
            if (((uVar1 & 0xfffffffd) == 1) &&
               (((param_1[0x13] == 0 || (param_1[0x14] == 0)) || (param_1[0x12] == 0)))) {
            ...
            local_450 = (((*(ushort *)((long)param_1 + 0x16) & 0xff) << 8 |
                         (uint)(byte)(*(ushort *)((long)param_1 + 0x16) >> 8)) << 8 |
                        (uint)(byte)*(undefined2 *)((long)param_1 + 0x14)) << 8 |
                        (uint)(byte)((ushort)*(undefined2 *)((long)param_1 + 0x14) >> 8);
            local_44c = *(ushort *)(param_1 + 3) << 8 | *(ushort *)(param_1 + 3) >> 8;
            iVar3 = ossl_hpke_labeled_extract
                              (lVar6,local_447,lVar9,0,0,&OSSL_HPKE_SEC51LABEL,&local_450,6,
                               "psk_id_hash",__s,sVar7);
            if (iVar3 == 1) {
              iVar3 = ossl_hpke_labeled_extract
                                (lVar6,local_447 + lVar9,lVar9,0,0,&OSSL_HPKE_SEC51LABEL,&local_450,
                                 6,"info_hash",param_2,param_3);
              if (iVar3 != 1) {
                ERR_new();
                uVar10 = 0x2d7;
                goto LAB_0010039a;
              ...
              iVar3 = ossl_hpke_labeled_extract
                                (lVar6,local_248,uVar2,param_1[10],param_1[0xb],
                                 &OSSL_HPKE_SEC51LABEL,&local_450,6,"secret",param_1[0x13],
                                 param_1[0x14]);
              if (iVar3 != 1) {
                ERR_new();
                uVar10 = 0x2e6;
              ...
              if (*(short *)(param_1 + 3) != -1) {
                ...
                param_1[0xe] = pvVar8;
                if (pvVar8 != (void *)0x0) {
                  iVar3 = ossl_hpke_labeled_expand
                                    (lVar6,pvVar8,param_1[0xf],local_248,uVar2,&OSSL_HPKE_SEC51LABEL
                                     ,&local_450,6,"base_nonce",&local_448,lVar9);
                  if (iVar3 == 1) {
                    ...
                    iVar3 = ossl_hpke_labeled_expand
                                      (lVar6,pvVar8,param_1[0xd],local_248,uVar2,
                                       &OSSL_HPKE_SEC51LABEL,&local_450,6,&OSSL_HPKE_KEY_LABEL,
                                       &local_448,lVar9);
...
LAB_001005e3:
                  ERR_set_debug("crypto/hpke/hpke.c",uVar10,"hpke_do_middle");
                  ERR_set_error(0xf,0xc0103,0);
                }
                goto LAB_001003c1;
              }
LAB_0010069f:
              ...
              if (pvVar8 == (void *)0x0) goto LAB_001003c1;
              iVar3 = ossl_hpke_labeled_expand
                                (lVar6,pvVar8,param_1[0x11],local_248,uVar2,&OSSL_HPKE_SEC51LABEL,
                                 &local_450,6,&OSSL_HPKE_EXP_LABEL,&local_448,lVar9);
              if (iVar3 != 1) {
                ERR_new();
                uVar10 = 0x30d;
                goto LAB_001005e3;
...
undefined8 hpke_seqnonce2buf_constprop_0(long param_1,undefined8 *param_2)

{
  ...
  if ((param_1 != 0) && (*(long *)(param_1 + 0x78) == 0xc)) {
    uVar3 = *(ulong *)(param_1 + 0x48);
    *param_2 = 0;
    puVar1 = (undefined1 *)((long)param_2 + 0xb);
    *(undefined4 *)(param_2 + 1) = 0;
    do {
      *puVar1 = (char)uVar3;
      puVar1 = puVar1 + -1;
      uVar3 = uVar3 >> 8;
    } while (puVar1 != (undefined1 *)((long)param_2 + 3));
    lVar2 = 0;
    do {
      *(byte *)((long)param_2 + lVar2) =
           *(byte *)((long)param_2 + lVar2) ^ *(byte *)(*(long *)(param_1 + 0x70) + lVar2);
      lVar2 = lVar2 + 1;
    } while (lVar2 != 0xc);
    return 0xc;
  }
...
undefined8 *
OSSL_HPKE_CTX_new(uint param_1,ulong param_2,uint param_3,undefined8 param_4,char *param_5)
      ...
      if (lVar3 != 0) {
        ...
        *ptr = param_4;
        if (param_5 != (char *)0x0) {
          ...
          ptr[1] = pcVar4;
          if (pcVar4 == (char *)0x0) goto LAB_001009ee;
        }
        if (sVar6 != -1) {
...
LAB_00100844:
  ERR_set_debug("crypto/hpke/hpke.c",uVar7,"OSSL_HPKE_CTX_new");
  ERR_set_error(0xf,0x80106,0);
  return (undefined8 *)0x0;
}
...

{
  if (param_1 != (void *)0x0) {
    ...
    CRYPTO_clear_free(*(undefined8 *)((long)param_1 + 0x80),*(undefined8 *)((long)param_1 + 0x88),
                      "crypto/hpke/hpke.c",0x357);
    CRYPTO_free(*(void **)((long)param_1 + 0x90));
    CRYPTO_clear_free(*(undefined8 *)((long)param_1 + 0x98),*(undefined8 *)((long)param_1 + 0xa0),
                      "crypto/hpke/hpke.c",0x359);
    CRYPTO_clear_free(*(undefined8 *)((long)param_1 + 0x60),*(undefined8 *)((long)param_1 + 0x68),
                      "crypto/hpke/hpke.c",0x35a);
    CRYPTO_clear_free(*(undefined8 *)((long)param_1 + 0x70),*(undefined8 *)((long)param_1 + 0x78),
                      "crypto/hpke/hpke.c",0x35b);
    CRYPTO_clear_free(*(undefined8 *)((long)param_1 + 0x50),*(undefined8 *)((long)param_1 + 0x58),
                      "crypto/hpke/hpke.c",0x35c);
    CRYPTO_clear_free(*(undefined8 *)((long)param_1 + 0xc0),*(undefined8 *)((long)param_1 + 200),
                      "crypto/hpke/hpke.c",0x35d);
      ...
      if (sVar1 < 0x43) {
        if (*param_2 == '\0') {
          ...
          if ((*(uint *)(param_1 + 0x10) & 0xfffffffd) == 1) {
            CRYPTO_clear_free(*(undefined8 *)(param_1 + 0x98),*(undefined8 *)(param_1 + 0xa0),
                              "crypto/hpke/hpke.c",899);
  ...
  if ((param_1 == 0) || (param_2 == 0)) {
    ...
    if (param_3 - 1U < 0x42) {
      if (*(int *)(param_1 + 0x40) == 0) {
        CRYPTO_clear_free(*(undefined8 *)(param_1 + 0xc0),*(undefined8 *)(param_1 + 200),
                          "crypto/hpke/hpke.c",0x3a2);
  ...
  if ((param_2 == 0 || param_3 == 0) || (param_1 == (undefined8 *)0x0)) {
    ...
    if (*(int *)(param_1 + 2) - 2U < 2) {
      if (*(int *)(param_1 + 8) == 1) {
        ...
        if (lVar3 == 0) goto LAB_00101128;
        lVar4 = ossl_HPKE_KEM_INFO_find_id(*(undefined2 *)((long)param_1 + 0x14));
        if ((lVar4 == 0) || (*(long *)(lVar4 + 0x10) == 0)) {
          pkey = (EVP_PKEY *)
                 EVP_PKEY_new_raw_public_key_ex
                           (*param_1,*(undefined8 *)(lVar3 + 8),param_1[1],param_2,param_3);
        }
        else {
          pkey = (EVP_PKEY *)
                 evp_pkey_new_raw_nist_public_key
                           (*param_1,param_1[1],*(undefined8 *)(lVar3 + 0x10),param_2,param_3);
        }
...
undefined4
OSSL_HPKE_seal(long param_1,uchar *param_2,ulong *param_3,uchar *param_4,long param_5,uchar *param_6
              ,ulong param_7)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if ((((param_2 == (uchar *)0x0 || param_3 == (ulong *)0x0) || (param_1 == 0)) || (*param_3 == 0))
     || ((param_6 == (uchar *)0x0 || (param_7 == 0)))) {
    ERR_new();
    uVar3 = 0x48a;
LAB_00101519:
    ERR_set_debug("crypto/hpke/hpke.c",uVar3,"OSSL_HPKE_seal");
    ERR_set_error(0xf,0x80106,0);
  }
  else {
    if (*(int *)(param_1 + 0x40) != 0) {
    ...
    if (*(long *)(param_1 + 0x48) == -1) {
      ...
      lVar4 = param_1;
      lVar2 = hpke_seqnonce2buf_constprop_0(param_1,local_64);
      if (lVar2 == 0) {
        ERR_new();
      ...
      __n = *(ulong *)(*(long *)(lVar4 + 0x30) + 0x10);
      if ((__n < *param_3) && (param_7 <= *param_3 - __n)) {
        if (0x10 < __n) {
          ERR_new();
          uVar3 = 0xea;
          goto LAB_001015a9;
        ...
        if (ctx != (EVP_CIPHER_CTX *)0x0) {
          iVar1 = EVP_EncryptInit_ex(ctx,*(EVP_CIPHER **)(param_1 + 0x38),(ENGINE *)0x0,(uchar *)0x0
                                     ,(uchar *)0x0);
          if (iVar1 == 1) {
            iVar1 = EVP_CIPHER_CTX_ctrl(ctx,9,*(int *)(param_1 + 0x78),(void *)0x0);
            if (iVar1 == 1) {
              iVar1 = EVP_EncryptInit_ex(ctx,(EVP_CIPHER *)0x0,(ENGINE *)0x0,
                                         *(uchar **)(param_1 + 0x60),local_64);
              if (iVar1 == 1) {
                if (((param_5 == 0) || (param_4 == (uchar *)0x0)) ||
                   (iVar1 = EVP_EncryptUpdate(ctx,(uchar *)0x0,&local_68,param_4,(int)param_5),
                   iVar1 == 1)) {
                  local_78 = &local_68;
                  iVar1 = EVP_EncryptUpdate(ctx,param_2,local_78,param_6,(int)param_7);
                  if (iVar1 == 1) {
                    *param_3 = (long)local_68;
                    iVar1 = EVP_EncryptFinal_ex(ctx,param_2 + local_68,local_78);
                    if (iVar1 == 1) {
                      *param_3 = *param_3 + (long)local_68;
                      iVar1 = EVP_CIPHER_CTX_ctrl(ctx,0x10,(int)__n,local_58);
                      if (iVar1 == 1) {
                        memcpy(param_2 + *param_3,local_58,__n);
                        *param_3 = *param_3 + __n;
                        EVP_CIPHER_CTX_free(ctx);
                        *(long *)(param_1 + 0x48) = *(long *)(param_1 + 0x48) + 1;
                        OPENSSL_cleanse(local_64,0xc);
                        uVar5 = 1;
                        goto LAB_0010153b;
                      }
                      ERR_new();
          ...
          ERR_set_debug("crypto/hpke/hpke.c",uVar3,"hpke_aead_enc");
          ERR_set_error(0xf,0xc0103,0);
...
undefined8
OSSL_HPKE_open(long param_1,uchar *param_2,ulong *param_3,uchar *param_4,long param_5,uchar *param_6
              ,ulong param_7)

{
  ...
  if ((((param_2 == (uchar *)0x0 || param_3 == (ulong *)0x0) || (param_1 == 0)) || (*param_3 == 0))
    ...
    uVar4 = 0x4b4;
LAB_001019d9:
    ERR_set_debug("crypto/hpke/hpke.c",uVar4,"OSSL_HPKE_open");
    ERR_set_error(0xf,0x80106,0);
  }
  else {
    ...
    if (*(long *)(param_1 + 0x48) == -1) {
      ...
      lVar5 = param_1;
      lVar3 = hpke_seqnonce2buf_constprop_0(param_1,local_4c);
      if (lVar3 == 0) {
        ERR_new();
        ...
        local_50 = 0;
        uVar1 = *(ulong *)(*(long *)(lVar5 + 0x30) + 0x10);
        if ((uVar1 < param_7) && (param_7 - uVar1 <= *param_3)) {
          ctx = EVP_CIPHER_CTX_new();
          if (ctx != (EVP_CIPHER_CTX *)0x0) {
            iVar2 = EVP_DecryptInit_ex(ctx,*(EVP_CIPHER **)(param_1 + 0x38),(ENGINE *)0x0,
                                       (uchar *)0x0,(uchar *)0x0);
            if (iVar2 == 1) {
              iVar2 = EVP_CIPHER_CTX_ctrl(ctx,9,*(int *)(param_1 + 0x78),(void *)0x0);
              if (iVar2 == 1) {
                iVar2 = EVP_DecryptInit_ex(ctx,(EVP_CIPHER *)0x0,(ENGINE *)0x0,
                                           *(uchar **)(param_1 + 0x60),local_4c);
                if (iVar2 == 1) {
                  if (((param_5 == 0) || (param_4 == (uchar *)0x0)) ||
                     (iVar2 = EVP_DecryptUpdate(ctx,(uchar *)0x0,&local_50,param_4,(int)param_5),
                     iVar2 == 1)) {
                    local_70 = &local_50;
                    iVar2 = EVP_DecryptUpdate(ctx,param_2,local_70,param_6,(int)param_7 - (int)uVar1
                                             );
                    if (iVar2 == 1) {
                      *param_3 = (long)local_50;
                      iVar2 = EVP_CIPHER_CTX_ctrl(ctx,0x11,(int)uVar1,param_6 + (param_7 - uVar1));
                      if (iVar2 == 0) {
                        ERR_new();
                        uVar4 = 0xbc;
                      }
                      else {
                        iVar2 = EVP_DecryptFinal_ex(ctx,param_2 + local_50,local_70);
                        if (0 < iVar2) {
                          EVP_CIPHER_CTX_free(ctx);
                          *(long *)(param_1 + 0x48) = *(long *)(param_1 + 0x48) + 1;
                          OPENSSL_cleanse(local_4c,0xc);
                          uVar4 = 1;
                          goto LAB_001019fb;
                        }
                        ERR_new();
            ...
            ERR_set_debug("crypto/hpke/hpke.c",uVar4,"hpke_aead_dec");
            ERR_set_error(0xf,0xc0103,0);
            OPENSSL_cleanse(param_2,*param_3);
            EVP_CIPHER_CTX_free(ctx);
          }
...
LAB_00101ef1:
    ...
    if (param_1[0x10] == 0) {
      ...
      if (lVar2 == 0) {
        ...
        if (lVar2 != 0) {
          local_48 = (((*(ushort *)((long)param_1 + 0x16) & 0xff) << 8 |
                      (uint)(byte)(*(ushort *)((long)param_1 + 0x16) >> 8)) << 8 |
                     *(ushort *)((long)param_1 + 0x14) & 0xff) << 8 |
                     (uint)(byte)(*(ushort *)((long)param_1 + 0x14) >> 8);
          local_44 = *(ushort *)(param_1 + 3) << 8 | *(ushort *)(param_1 + 3) >> 8;
          iVar1 = ossl_hpke_labeled_expand
                            (lVar2,param_2,param_3,param_1[0x10],param_1[0x11],&OSSL_HPKE_SEC51LABEL
                             ,&local_48,6,&OSSL_HPKE_EXP_SEC_LABEL,param_4,param_5);
...
undefined4
OSSL_HPKE_keygen(ulong param_1,long param_2,long *param_3,undefined8 *param_4,long param_5,
    ...
    if (lVar3 != 0) {
      ...
      if (lVar4 != 0) {
        ...
        if (lVar4 != 0) {
          ...
          if ((lVar4 == 0) || (*(long *)(lVar4 + 0x10) == 0)) {
            ctx = (EVP_PKEY_CTX *)
                  EVP_PKEY_CTX_new_from_name(param_7,*(undefined8 *)(lVar3 + 8),param_8);
            puVar6 = &local_b8;
          }
          else {
...
LAB_00102360:
            ...
            uVar5 = 0x52e;
LAB_00102371:
            ERR_set_debug("crypto/hpke/hpke.c",uVar5,"OSSL_HPKE_keygen");
            ERR_set_error(0xf,0xc0103,0);
LAB_00102390:
            ...
            *puVar7 = local_108;
            ...
            iVar1 = EVP_PKEY_get_octet_string_param
                              (local_c0,"encoded-pub-key",param_2,*param_3,param_3);
            if (iVar1 != 1) {
              ERR_new();
...
OSSL_HPKE_get_grease_value
          (undefined4 *param_1,undefined4 *param_2,long param_3,ulong *param_4,long param_5,
...
LAB_001025d0:
    ...
    if ((param_5 == 0 || param_6 == 0) || (param_2 == (undefined4 *)0x0)) goto LAB_001025d0;
    if (param_1 == (undefined4 *)0x0) {
      ...
      local_74 = *param_1;
LAB_00102508:
      lVar4 = ossl_HPKE_KEM_INFO_find_id((short)local_74);
      if (lVar4 != 0) {
            ...
            *param_2 = local_74;
            if (uVar2 < param_6) {
              if (*param_4 < *(ulong *)(lVar4 + 0x30)) {
                ...
                iVar3 = OSSL_HPKE_keygen(CONCAT26(uStack_4a,CONCAT24(uVar1,local_74)),param_3,
                                         param_4,&local_48,0,0,param_7);
                if (iVar3 == 1) {
                  EVP_PKEY_free(local_48);
                  iVar3 = RAND_bytes_ex(param_7,param_5,param_6,0);
                  uVar8 = 1;
                  if (0 < iVar3) goto LAB_00102603;
                  ERR_new();
                  uVar7 = 0x58b;
                }
                else {
...
LAB_00102641:
    ERR_set_debug("crypto/hpke/hpke.c",uVar7,"OSSL_HPKE_get_grease_value");
    ERR_set_error(0xf,0xc0103,0);
  }
  uVar8 = 0;
LAB_00102603:
...
undefined8
OSSL_HPKE_encap(undefined8 *param_1,long param_2,ulong *param_3,long param_4,long param_5,
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if ((((param_2 == 0 || param_3 == (ulong *)0x0) || (param_1 == (undefined8 *)0x0)) ||
      (*param_3 == 0)) || ((param_4 == 0 || (param_5 == 0)))) {
    ERR_new();
    uVar7 = 0x42a;
LAB_00102959:
    ERR_set_debug("crypto/hpke/hpke.c",uVar7,"OSSL_HPKE_encap");
    ERR_set_error(0xf,0x80106,0);
  }
  else {
    if (*(int *)(param_1 + 8) != 0) {
    ...
    if (param_1[10] == 0) {
      ...
      if (lVar3 == 0) {
        ...
        if ((lVar4 == 0) || (*(long *)(lVar4 + 0x10) == 0)) {
          pkey = (EVP_PKEY *)
                 EVP_PKEY_new_raw_public_key_ex
                           (*param_1,*(undefined8 *)(lVar3 + 8),param_1[1],param_4,param_5);
        }
        else {
          pkey = (EVP_PKEY *)
                 evp_pkey_new_raw_nist_public_key(*param_1,param_1[1],*(undefined8 *)(lVar3 + 0x10))
          ;
        }
        if (pkey == (EVP_PKEY *)0x0) {
          ERR_new();
          ...
          if (ctx == (EVP_PKEY_CTX *)0x0) {
            ...
            *puVar5 = local_f8;
            ...
            if (*(int *)(param_1 + 2) - 2U < 2) {
              ...
              if (iVar1 == 1) goto LAB_00102c73;
              ERR_new();
              uVar7 = 0x1f5;
LAB_00102dc8:
              ERR_set_debug("crypto/hpke/hpke.c",uVar7,"hpke_encap");
              uVar7 = 0xc0103;
LAB_00102dd7:
...
undefined8
OSSL_HPKE_decap(undefined8 *param_1,long param_2,ulong param_3,long param_4,long param_5,
               ulong param_6)

{
  ...
  if ((((param_1 == (undefined8 *)0x0) || (param_2 == 0)) || (param_3 == 0)) || (param_4 == 0)) {
    ...
    uVar5 = 0x459;
LAB_00103021:
    ERR_set_debug("crypto/hpke/hpke.c",uVar5,"OSSL_HPKE_decap");
    ERR_set_error(0xf,0x80106,0);
  }
  else {
    if (*(int *)(param_1 + 8) != 1) {
        ...
        if (*(int *)(param_1 + 2) - 2U < 2) {
          ...
          if (lVar2 == 0) {
            ...
            if ((lVar3 == 0) || (*(long *)(lVar3 + 0x10) == 0)) {
              local_e8 = (EVP_PKEY *)
                         EVP_PKEY_new_raw_public_key_ex
                                   (*param_1,*(undefined8 *)(lVar2 + 8),param_1[1],param_1[0x16],
                                    param_1[0x17]);
            }
            else {
              local_e8 = (EVP_PKEY *)
                         evp_pkey_new_raw_nist_public_key
                                   (*param_1,param_1[1],*(undefined8 *)(lVar2 + 0x10),param_1[0x16],
                                    param_1[0x17]);
            }
            if (local_e8 != (EVP_PKEY *)0x0) {
              iVar1 = EVP_PKEY_auth_decapsulate_init(ctx,local_e8,&local_98);
              if (iVar1 == 1) goto LAB_001031ec;
              ERR_new();
              uVar5 = 0x259;
              goto LAB_00103241;
            }
          ...
          if (iVar1 == 1) {
LAB_001031ec:
            iVar1 = EVP_PKEY_decapsulate(ctx,0,&local_a0,param_2,param_3);
            if (iVar1 == 1) {

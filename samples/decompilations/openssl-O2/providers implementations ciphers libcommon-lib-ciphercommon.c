...
LAB_00100504:
      if (param_6 == 0) {
LAB_001005f5:
        if (local_48 == 0) goto LAB_001005fe;
      }
      else {
        if (((*(byte *)(param_1 + 0x6c) & 3) != 1) || (local_48 != param_6)) goto LAB_0010051c;
        if (param_6 < uVar2) {
          ERR_new();
          uVar8 = 0x185;
          goto LAB_001007e1;
        ...
        uVar5 = uVar5 + param_6;
        if (param_4 < uVar5) goto LAB_001007d0;
        if (param_6 != 0) goto LAB_00100528;
      }
...
LAB_00100b50:
      ...
      if ((bVar1 & 1) == 0) {
        if (*(ulong *)(param_1 + 0x60) == 0) goto LAB_00100b50;
...

{
  ...
  *(byte *)((long)param_1 + 0x6c) =
       *(byte *)((long)param_1 + 0x6c) & 0xed | param_7 * '\x02' & 0x12U;
  iVar1 = ossl_prov_is_running();
  if (iVar1 == 0) {
    return 0;
  }
  ...
  if (param_2 != 0) {
    if ((*(byte *)((long)param_1 + 0x6c) & 0x20) == 0) {
      if (*(long *)((long)param_1 + 0x48) != param_3) {
        ERR_new();
...
void ossl_cipher_generic_einit(void)
...
void ossl_cipher_generic_dinit(void)
...
void ossl_cipher_generic_skey_einit
               (undefined8 param_1,long param_2,undefined8 param_3,undefined8 param_4,
               undefined8 param_5)

{
  cipher_generic_init_internal
            (param_1,*(undefined8 *)(param_2 + 0x10),*(undefined8 *)(param_2 + 0x18),param_3,param_4
             ,param_5,1);
  return;
}
...
void ossl_cipher_generic_skey_dinit
               (undefined8 param_1,long param_2,undefined8 param_3,undefined8 param_4,
               undefined8 param_5)

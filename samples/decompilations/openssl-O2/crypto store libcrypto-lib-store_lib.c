...

{
  ...
  if ((param_3 != 0) && (uVar1 = (**(code **)(param_1 + 0xa0))(param_2,param_3), (int)uVar1 == 0))
  goto LAB_0010006b;
  if (param_4 != 0) {
...
undefined4 ossl_store_close_it(long *param_1)

{
  ...
  if (param_1[1] != 0) {
    ...
    if (param_1[1] != 0) goto LAB_0010014b;
    lVar2 = *param_1;
    lVar3 = param_1[2];
  }
  uVar1 = (**(code **)(lVar2 + 0x50))(lVar3);
LAB_0010014b:
...
long * OSSL_STORE_open_ex(undefined8 param_1,undefined8 param_2,char *param_3,long param_4,
      ...
      if (lVar5 == 0) {
        ...
        if (lVar8 == 0) {
          ...
          if (*(code **)(lVar8 + 0xd0) == (code *)0x0) {
            if ((*(code **)(lVar8 + 0x88) != (code *)0x0) &&
               (lVar6 = (**(code **)(lVar8 + 0x88))(uVar9,param_1), lVar6 != 0)) {
...
LAB_001006f1:
            ...
            lVar6 = (**(code **)(lVar8 + 0xd0))
                              (uVar9,param_1,param_6,&ossl_pw_passphrase_callback_dec,local_208);
            bVar13 = false;
            if (lVar6 == 0) goto LAB_001006f1;
          }
LAB_00100585:
          bVar2 = false;
          ossl_pw_clear_passphrase_cache(local_208);
          lVar8 = lVar5;
        }
      }
      else {
...
LAB_0010066d:
      ...
      if ((param_3 != (char *)0x0) &&
         (param_3 = CRYPTO_strdup(param_3,"crypto/store/store_lib.c",0xbd), param_3 == (char *)0x0))
      {
        ERR_clear_last_mark();
        goto LAB_0010066d;
      }
...
LAB_00100670:
      ...
      local_1d0 = lVar8;
      local_1c8 = lVar6;
      ossl_store_close_it(&local_1d8);
    }
  }
  else {
    iVar3 = ossl_pw_set_ui_method(local_208,param_4,param_5);
    if ((iVar3 != 0) && (iVar3 = ossl_pw_enable_passphrase_caching(local_208), iVar3 != 0))
    goto LAB_0010037f;
    param_3 = (char *)0x0;
    lVar8 = 0;
    ERR_new();
...
void OSSL_STORE_open(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
                    undefined8 param_5)
  ...
  if (param_1[1] == 0) {
    if (*(code **)(*param_1 + 0x20) != (code *)0x0) {
      if (local_10 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010084f. Too many branches */
...
void OSSL_STORE_ctrl(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  if ((param_1 == (long *)0x0) || (6 < local_6c)) {
    ...
    *(uint *)(param_1 + 5) = local_6c;
    uVar1 = 1;
    if (param_1[1] != 0) {
      if (*(long *)(param_1[1] + 0xa0) == 0) goto LAB_00100a78;
      local_68 = (undefined1  [16])0x0;
      local_58 = (undefined1  [16])0x0;
      local_48 = (undefined1  [16])0x0;
      local_38 = (undefined1  [16])0x0;
      ...
      if (param_1[1] != 0) goto LAB_00100a78;
    }
  ...
  if ((int)param_1[7] == 0) {
    ...
    if (param_1[1] == 0) {
      if (*(code **)(*param_1 + 0x30) != (code *)0x0) {
        if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00100c74. Too many branches */
                    /* WARNING: Treating indirect jump as call */
      ...
      uVar5 = 0x199;
LAB_00100d31:
      ERR_set_debug("crypto/store/store_lib.c",uVar5,"OSSL_STORE_find");
    ...
    if (iVar1 == 3) {
      ...
      if ((iVar1 == 0) ||
         (iVar1 = OSSL_PARAM_BLD_push_octet_string
                            (lVar3,"fingerprint",*(undefined8 *)(param_2 + 8),
                             *(undefined8 *)(param_2 + 10)), iVar1 == 0)) goto LAB_00100bf0;
LAB_00100ce8:
      a = (BIGNUM *)0x0;
LAB_00100cea:
      uVar5 = OSSL_PARAM_BLD_to_param(lVar3);
      ...
      if (iVar1 < 4) {
        if (iVar1 == 1) {
          ...
          if (0 < iVar1) {
            ...
            goto joined_r0x00100ce2;
          }
        }
        else if (((iVar1 == 2) &&
                 (iVar1 = i2d_X509_NAME(*(X509_NAME **)(param_2 + 2),&local_38), 0 < iVar1)) &&
                (a = ASN1_INTEGER_to_BN(*(ASN1_INTEGER **)(param_2 + 4),(BIGNUM *)0x0),
                a != (BIGNUM *)0x0)) {
          iVar1 = OSSL_PARAM_BLD_push_octet_string(lVar3,&_LC6,local_38,(long)iVar1);
          if ((iVar1 != 0) && (iVar1 = OSSL_PARAM_BLD_push_BN(lVar3,"serial",a), iVar1 != 0))
          goto LAB_00100cea;
          goto LAB_00100bf2;
        }
      }
        ...
        iVar1 = OSSL_PARAM_BLD_push_utf8_string
                          (lVar3,"alias",*(undefined8 *)(param_2 + 8),*(undefined8 *)(param_2 + 10))
        ;
joined_r0x00100ce2:
        if (iVar1 != 0) goto LAB_00100ce8;
      }
LAB_00100bf0:
      a = (BIGNUM *)0x0;
    }
...
undefined4
OSSL_STORE_delete(undefined8 param_1,undefined8 param_2,undefined8 param_3,long param_4,
...
LAB_00100f76:
      ...
      if ((lVar4 != 0) && (*(long *)(lVar4 + 200) != 0)) {
        ...
        uVar2 = (**(code **)(lVar4 + 200))
                          (uVar5,param_1,param_6,&ossl_pw_passphrase_callback_dec,local_178);
      }
...
undefined4 OSSL_STORE_close(void *param_1)

{
  undefined4 uVar1;
  
  uVar1 = ossl_store_close_it();
  CRYPTO_free(param_1);
  return uVar1;
}
...
LAB_0010149e:
  ...
  if (iVar3 == 0) {
    if (param_1[8] != 0) {
      ...
      if (param_1[8] == 0) goto LAB_001014bb;
      lVar5 = OPENSSL_sk_shift();
LAB_00101442:
      pcVar4 = (code *)param_1[3];
      if (pcVar4 == (code *)0x0) goto LAB_00101540;
LAB_0010144f:
      if (lVar5 != 0) goto code_r0x00101458;
      lVar5 = 0;
...
LAB_001014bb:
    ...
    if (param_1[1] != 0) {
      ...
      *(undefined4 *)((long)param_1 + 0x3c) = 0;
      local_30 = param_1;
      iVar3 = (**(code **)(param_1[1] + 0xa8))
                        (lVar5,&ossl_store_handle_load_result,&local_38,
                         &ossl_pw_passphrase_callback_dec,plVar1);
      if (iVar3 == 0) {
      ...
      lVar5 = local_38;
      if (param_1[1] != 0) goto LAB_00101442;
      lVar5 = param_1[2];
    }
    lVar5 = (**(code **)(*param_1 + 0x38))(lVar5,param_1[10],param_1[0xb]);
    pcVar4 = (code *)param_1[3];
    if (pcVar4 != (code *)0x0) goto LAB_0010144f;
LAB_00101540:
    ossl_pw_clear_passphrase_cache(plVar1);
    if (lVar5 != 0) goto LAB_00101471;
  }
  lVar5 = 0;
LAB_00101558:
  ...
  return lVar5;
code_r0x00101458:
  lVar5 = (*pcVar4)(lVar5,param_1[4]);
  if (lVar5 != 0) {
    ossl_pw_clear_passphrase_cache(plVar1);
LAB_00101471:
    if ((((int)param_1[5] == 0) || (uVar2 = OSSL_STORE_INFO_get_type(lVar5), uVar2 < 2)) ||
       (*(uint *)(param_1 + 5) == uVar2)) goto LAB_00101558;
    ...
    if (*(code **)(param_1[1] + 0x98) != (code *)0x0) {
      ...
      if (param_2 == 3) {
        ...
        if (param_2 == 1) {
          ...
          uVar7 = 0;
          if (param_2 == 2) {
            uVar7 = (ulong)((uint)(lVar4 != 0) &
                           (uint)CONCAT71((int7)((ulong)param_4 >> 8),lVar3 != 0));
          }
        }
      }
      else {
      ...
      if (param_1[1] != 0) goto LAB_00101a6a;
      goto LAB_00101a50;
    }
  }
  uVar7 = 0;
...
long * OSSL_STORE_attach(undefined8 param_1,undefined *param_2,undefined8 param_3,undefined8 param_4
...

{
  ...
  if (lVar2 == 0) {
    ...
    if (lVar4 == 0) goto LAB_00101ed2;
    uVar5 = OSSL_STORE_LOADER_get0_provider(lVar4);
    uVar5 = OSSL_PROVIDER_get0_provider_ctx(uVar5);
    lVar6 = ossl_core_bio_new_from_bio(param_1);
    if (((lVar6 == 0) || (*(code **)(lVar4 + 0x90) == (code *)0x0)) ||
       (lVar3 = (**(code **)(lVar4 + 0x90))(uVar5,lVar6), lVar3 == 0)) {
      OSSL_STORE_LOADER_free(lVar4);

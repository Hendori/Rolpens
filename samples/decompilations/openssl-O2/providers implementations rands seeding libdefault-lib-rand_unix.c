...

{
  ...
  if (*param_1 != -1) {
    ...
    if ((((iVar1 != -1) && (*(__dev_t *)(param_1 + 2) == local_a8.st_dev)) &&
        (*(__ino_t *)(param_1 + 4) == local_a8.st_ino)) && ((param_1[6] ^ local_a8.st_mode) < 0x200)
       ) {
...

{
  ...
  iVar1 = seeded_1;
  if (seeded_1 != 0) goto LAB_001000ca;
  ...
  if (iVar1 == -1) {
    ...
    if (iVar1 == 0) {
      ...
      iVar1 = 0;
      if (pcVar4 == (char *)0x0) {
        if (4 < iVar2) goto LAB_001000ca;
      }
      else {
        iVar3 = __isoc23_strtol(pcVar4 + 1,0,10);
        if ((4 < iVar2) || ((iVar2 == 4 && (7 < iVar3)))) goto LAB_001000ca;
      }
    }
...
LAB_00100226:
  close(iVar2);
  iVar1 = seeded_1;
  if (iVar3 != 1) goto LAB_001000ca;
  seeded_1 = 1;
  iVar1 = shmget(0x72,1,0x324);
  if (iVar1 != -1) goto LAB_00100110;
LAB_00100260:
  iVar1 = 1;
LAB_001000ca:
...

{
  ...
  DAT_00100868 = 0xffffffff;
  _DAT_00100890 = 0xffffffff;
  _DAT_001008b8 = 0xffffffff;
  return 1;
}
  ...
  do {
    if (*piVar2 != -1) {
      ...
      if ((((iVar1 != -1) && (*(__dev_t *)(piVar2 + 2) == local_b8.st_dev)) &&
         ...
         (((piVar2[6] ^ local_b8.st_mode) < 0x200 && (*(__dev_t *)(piVar2 + 8) == local_b8.st_rdev))
         )) {
        close(*piVar2);
      }
    }
  ...
  if (local_e8 == 0) {
    ...
    if (iVar2 != 0) {
      ...
      if (__nbytes != 0) {
        local_e8 = 0;
        do {
          iVar2 = check_random_device(piVar5);
          if (iVar2 == 0) {
            ...
            if (iVar2 != -1) {
              do {
                while( true ) {
                  ...
                  if (__nbytes == 0) goto LAB_001006ad;
                  iVar1 = 2;
                }
                if ((sVar8 != 0) && (piVar7 = __errno_location(), *piVar7 != 4)) goto LAB_001006b7;
                bVar9 = iVar1 != 0;
                iVar1 = iVar1 + -1;
              } while (bVar9);
              if (sVar8 == 0) {
LAB_001006ad:
                if (keep_random_devices_open == 0) goto LAB_001006b7;
              }
              else {
LAB_001006b7:
                iVar2 = check_random_device(piVar5);
      ...
      local_e8 = ossl_rand_pool_entropy_available(param_1);
      if (local_e8 != 0) goto LAB_00100529;
    }

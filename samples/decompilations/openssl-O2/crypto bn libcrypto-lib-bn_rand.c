...
LAB_001002a3:
    ...
    CRYPTO_clear_free(s,lVar3,"crypto/bn/bn_rand.c",0x5b);
    goto LAB_0010007f;
  }
  ERR_new();
    ...
    if ((param_3->neg == 0) && (iVar1 = BN_is_zero(param_3), iVar1 == 0)) {
      ...
      if (iVar1 == 1) {
        ...
        if ((iVar2 == 0) && (iVar2 = BN_is_bit_set(param_3,iVar1 + -3), iVar2 == 0)) {
          iVar2 = 100;
          do {
            iVar3 = bnrand(param_1,param_2,iVar1 + 1,0xffffffff,0,param_4,param_5);
            if (iVar3 == 0) {
              return 0;
            }
            ...
            if (iVar2 == 0) {
              ...
              uVar4 = 0xb2;
LAB_00100511:
              ERR_set_debug("crypto/bn/bn_rand.c",uVar4,"bnrand_range");
          ...
          iVar2 = 100;
          do {
            iVar3 = bnrand(param_1,param_2,iVar1,0xffffffff,0,param_4);
            if (iVar3 == 0) {
              return 0;
            }
            iVar2 = iVar2 + -1;
...
void BN_rand_ex(undefined8 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
               undefined4 param_5,undefined8 param_6)

{
  bnrand(0,param_1,param_2,param_3,param_4,param_5,param_6);
  return;
}
...
void BN_priv_rand_ex(undefined8 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
                    undefined4 param_5,undefined8 param_6)

{
  bnrand(2,param_1,param_2,param_3,param_4,param_5,param_6);
  return;
}



void BN_priv_rand(undefined8 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  bnrand(2,param_1,param_2,param_3,param_4,0,0);
  return;
}



void BN_rand_range_ex(undefined8 param_1,undefined8 param_2,undefined4 param_3,undefined8 param_4)

{
  bnrand_range(0,param_1,param_2,param_3,param_4);
  return;
}
...
{
  bnrand_range(2,param_1,param_2,0,0);
  return;
}
...
undefined8 ossl_bn_priv_rand_range_fixed_top(BIGNUM *param_1,BIGNUM *param_2,undefined4 param_3)
  ...
  if (param_1 == (BIGNUM *)0x0) {
    ...
    if ((param_2->neg == 0) && (iVar1 = BN_is_zero(param_2), iVar1 == 0)) {
      ...
      if (iVar1 == 1) {
        ...
        do {
          iVar2 = bnrand(2,param_1,iVar1 + 1,0,0,param_3);
          if (iVar2 == 0) {
            return 0;
          }
          iVar3 = iVar3 + -1;
      ...
      if (iVar3 < 0) {
        ...
        if (local_190 == (EVP_MD *)0x0) {
          ...
          do {
            ...
            if (pBVar7 == (BIGNUM *)0x0) goto LAB_00100b20;
            BN_set_flags(param_1,4);

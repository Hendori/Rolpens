...
undefined8
depack_do_implicit_stream_create(long param_1,ulong param_2,undefined8 param_3,long *param_4)
...
LAB_00100236:
        ossl_quic_channel_raise_protocol_error_loc
                  (param_1,1,param_3,pcVar4,0,"ssl/quic/quic_rx_depack.c",uVar8,
      ...
      if (iVar1 != 0) {
        ossl_quic_channel_raise_protocol_error_loc
                  (param_1,4,param_3,"exceeded maximum allowed streams",0,
                   "ssl/quic/quic_rx_depack.c",0x1b6,"depack_do_implicit_stream_create");
        return 0;
      }
      uVar3 = *puVar6;
      while (uVar3 <= uVar7) {
      ...
      if (uVar3 <= uVar7) {
        ossl_quic_channel_raise_protocol_error_loc
                  (param_1,5,param_3,"STREAM frame for nonexistent stream",0,
                   "ssl/quic/quic_rx_depack.c",0x1dd,"depack_do_implicit_stream_create");
        return 0;
      }
    }
  }
...

{
  ...
  if (param_1 != (undefined8 *)0x0) {
    *(byte *)((long)param_1 + 0x623) = *(byte *)((long)param_1 + 0x623) & 0xef;
    ...
    if ((**(byte **)param_2 - 1 < 5) &&
       (uVar4 = *(uint *)(CSWTCH_93 + (ulong)(**(byte **)param_2 - 1) * 4), uVar4 < 4)) {
      pcVar12 = param_2;
      if (uVar4 == 0) {
...
LAB_00100970:
        ...
        ossl_quic_tx_packetiser_add_unvalidated_credit(param_1[0x1b],uVar16);
        pcVar17 = *(char **)param_2;
        if (*(long *)(pcVar17 + 0x48) < 0) goto LAB_00100970;
        cVar2 = *pcVar17;
        uVar7 = 2;
        local_e8 = *(undefined8 *)(pcVar17 + 0x50);
        local_e0 = *(long *)(pcVar17 + 0x48);
...
LAB_0010133e:
          ...
          uVar14 = 0;
          ossl_quic_channel_raise_protocol_error_loc
                    (param_1,10,0,pcVar17,0,"ssl/quic/quic_rx_depack.c",uVar16);
        }
        else {
          do {
...
LAB_001013ce:
              ossl_quic_channel_raise_protocol_error_loc
                        (param_1,10,local_100,pcVar12,0,"ssl/quic/quic_rx_depack.c",uVar16,
            ...
            case 3:
              ...
              if ((iVar10 != 0) && (local_f0 >> 0x3c == 0)) {
                ...
                if ((ulong)param_1[199] < local_f0) {
                  ...
                  if (pcVar12 == (char *)0x0) goto LAB_001012f8;
...
LAB_00101a01:
              ...
              if ((local_98 & 2) != 0) {
                if (*(byte *)(lVar5 + 0x102) != 1) {
                  pcVar17 = (char *)0x101edb;
                  iVar10 = ossl_quic_rxfc_get_final_size(lVar1,0);
                  pcVar12 = extraout_RDX_66;
                  if (iVar10 != 0) goto LAB_0010072c;
                }
                pcVar17 = (char *)0x101e28;
...
LAB_001012db:
            ...
            if ((code *)param_1[0x86] != (code *)0x0) {
              uVar16 = 0x204;
              if ((local_100 != 0) &&
                 (((local_100 & 0xfffffffffffffff8) == 8 || (uVar16 = 0x202, local_100 == 6)))) {
                uVar16 = 0x203;
              }
              pcVar12 = pcVar17;
...
LAB_00100590:
      ossl_ackm_on_rx_packet(param_1[0x83],&local_d8,pcVar12);
      goto LAB_0010032c;
    }
  }
  uVar14 = 0;

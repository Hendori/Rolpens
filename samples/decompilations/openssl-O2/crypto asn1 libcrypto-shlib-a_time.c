    ...
    if (iVar11 <= iVar2) {
      ...
      do {
        ...
        if ((((local_a0 == (int)uVar9) && ((char)uVar15 != '\x01')) &&
           ...
           ((0x800000000005U >> ((ulong)(uVar16 - 0x2b) & 0x3f) & 1) != 0)) goto LAB_00100282;
...
LAB_001004cb:
            ...
            if ((int)local_68._0_4_ < 2) goto LAB_001004cb;
            iVar13 = (int)uVar16 % 100;
          ...
          do {
            ...
            if (iVar7 == 0) {
              if ((iVar2 != iVar11) && (iVar5 != iVar11)) {
                uVar16 = (uint)*(byte *)(lVar3 + iVar11);
                if (*(byte *)(lVar3 + iVar11) != 0x5a) goto LAB_00100518;
                goto LAB_001006f0;
              }
              break;
            }
...

{
  ...
  if (param_3 != -1) {
    if (param_3 == 0x17) {
      if (param_2[5] - 0x32 < 100) goto LAB_001007c3;
    }
    else if (param_3 == 0x18) {
LAB_001007c3:
      if (param_1 == (ASN1_STRING *)0x0) goto LAB_001008ab;
      goto LAB_001007cc;
    }
...
LAB_001008ab:
    ...
    if (iVar5 == 0) goto LAB_00100822;
    uVar7 = param_2[4];
    buf = param_1->data;
    param_1->type = param_3;
    if (uVar7 == 0x7fffffff) goto LAB_00100822;
    uVar6 = param_2[5];
    if (param_3 == 0x18) {
      if (0x7ffff893 < (int)uVar6) goto LAB_00100822;
      goto LAB_00100905;
    }
  }
  else {
...
LAB_00100bd8:
      ...
      if (local_44 - 0x32U < 100) {
        ...
        if (local_78.data == (uchar *)0x0) goto LAB_00100bd8;

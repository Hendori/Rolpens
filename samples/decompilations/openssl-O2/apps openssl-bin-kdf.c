...
LAB_0010012c:
  ...
  if (iVar2 != 0) {
    ...
    if (8 < iVar2) {
      if (iVar2 < 0x645) {
        if (iVar2 < 0x641) {
          if (iVar2 != 0x640) goto LAB_001001e5;
        }
        else {
...
LAB_00100381:
      ...
      goto LAB_00100389;
    case 2:
      if ((local_48 == 0) && (local_48 = OPENSSL_sk_new_null(), lVar5 = local_48, local_48 == 0))
      goto LAB_001001e5;
      lVar5 = local_48;
      opt_arg();
      iVar2 = OPENSSL_sk_push(lVar5);
      lVar5 = local_48;
      if (iVar2 == 0) goto LAB_001001e5;
      goto LAB_0010012c;
    case 3:
      bVar1 = true;
      goto LAB_0010012c;
    ...
    lVar5 = local_48;
    if (pvVar11 == (void *)0x0) goto LAB_001001e5;
    goto LAB_0010012c;
  }
  iVar2 = opt_num_rest();

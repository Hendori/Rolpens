...

{
  ...
  UNRECOVERED_JUMPTABLE =
       (code *)ossl_prov_get_keymgmt_export(*(undefined8 *)(*(long *)(param_1 + 0x108) + 0x10));
...

{
  ...
  puVar1 = (undefined8 *)
           CRYPTO_zalloc(0x118,"providers/implementations/encode_decode/decode_pvk2key.c",0x46);
...

{
  ...
  *(uint *)(param_1 + 0x22) = param_3;
  if (param_3 == 0) {
    if (*(long *)(param_1[0x21] + 0x18) == 0) goto LAB_001002aa;
LAB_00100213:
    ...
    if (iVar2 != 0) {
      ...
      uVar4 = (uint)uVar6;
      if ((((int)uVar4 < 0) || ((ulong)(long)(int)uVar4 >> 0x17 != 9)) ||
    ...
    if (((param_3 & 1) != 0) && (*(long *)(param_1[0x21] + 0x18) != 0)) goto LAB_00100213;
LAB_001002aa:
    uVar3 = 1;
    BIO_free(a);
    a = local_120;

...
LAB_001008da:
      do {
        ...
        *(undefined4 *)(puVar7 + 6) = 0;
        ...
        __dest = (void *)((long)puVar7 + uVar14 + 0x38);
        if (sVar15 + uVar14 < 0x1005) {
          memcpy(__dest,local_58,sVar15);
          uVar14 = *puVar7;
          *puVar7 = uVar14 + sVar15;
          if ((0x1003 < uVar14 + sVar15) && (iVar5 = block_out(param_1), iVar5 == 0))
          goto LAB_00100bb0;
          break;
        }
        iVar5 = 0x1004 - (int)uVar14;
        sVar15 = (size_t)iVar5;
        memcpy(__dest,local_58,sVar15);
        uVar14 = *puVar7;
    ...
    if (0 < iVar5) {
      ...
      if ((iVar6 != 0) && (iVar5 = RAND_bytes(buf,iVar5), 0 < iVar5)) {
        memcpy((void *)((long)plVar9 + *plVar9 + 0x38),buf,uVar14);
        lVar1 = *plVar9;
        uVar8 = 0;
        uVar3 = *(undefined1 *)((long)plVar9 + lVar1 + 0x38);
        uVar12 = *(undefined1 *)((long)plVar9 + lVar1 + 0x3b);
        ...
        *(undefined1 *)((long)plVar9 + lVar1 + 0x38) = uVar13;
        *(undefined1 *)((long)plVar9 + lVar1 + 0x3b) = uVar12;
        *(undefined1 *)((long)plVar9 + lVar1 + 0x39) = uVar11;

...
int32_t all_badges()
{
    uint32_t r2_6 = data_2109c - data_210a0 + data_21085 - data_21089 + data_2106e - data_21072 + data_21040 - data_21044 + data_21057 - data_2105b;
    /* tailcall */
    return printf("We can open every door with badg…", data_210b3 - data_210b7 + r2_6, r2_6);
}

...
{
    int32_t rdx = arg1;
    int32_t rax_2 = arg1 * arg1 + (arg1 << 1);
    int32_t rcx_3 = rax_2 * rax_2 + rdx + rax_2;
    int32_t rax_6 = rcx_3 * rcx_3 + rdx + rcx_3;
    int32_t rcx_7 = rax_6 * rax_6 + rdx + rax_6;
    int32_t rax_10 = rcx_7 * rcx_7 + rdx + rcx_7;
    int32_t rcx_11 = rax_10 * rax_10 + rdx + rax_10;
...
int64_t __do_global_ctors()
{
    ...
    if (rcx)
    {
        ...
        do
        {
            (*i)();
            i -= 8;
        } while (i != ((rax_1 - (rcx - 1)) << 3) + 0x140007d08);
    }
...
int __pformat_wputchars(short unsigned int const* s, int count, struct { void* dest; int flags; int width; int precision; int rplen; short unsigned int rpchr; __padding char _1a[0x2];int thousands_chr_len; short unsigned int thousands_chr; __padding char _22[0x2];int count; int quota; int expmin; }* stream)
{
    ...
    if (width > count_2)
    {
        ...
        {
            if (count_2 > 0)
                goto label_1400028c0;
            
            stream->width = rax_6 - 1;
            goto label_140002960;
        }
...
int __pformat_putchars(char const* s, int count, struct { void* dest; int flags; int width; int precision; int rplen; short unsigned int rpchr; __padding char _1a[0x2];int thousands_chr_len; short unsigned int thousands_chr; __padding char _22[0x2];int count; int quota; int expmin; }* stream)
{
    ...
    if (width > count_3)
    {
        ...
        if (!(*flags[1] & 4))
        {
            ...
            goto label_140002a03;
        }
        
        if (!count_3)
        {
            stream->width = rax_2 - 1;
            goto label_140002a81;
        }
    }
    else
    {
...
int64_t __pformat_xint(int fmt, union value, struct { void* dest; int flags; int width; int precision; int rplen; short unsigned int rpchr; __padding char _1a[0x2];int thousands_chr_len; short unsigned int thousands_chr; __padding char _22[0x2];int count; int quota; int expmin; }* stream, union value)
{
    ...
    if (fmt != 0x6f)
    {
        ...
        if (!(rdi & 0x1000))
        {
            ...
            goto label_140002c71;
        }
        
        rcx = 4;
        
        if (stream_1[4])
            goto label_140002e12;
    ...
    if (rdi & 0x1000)
    {
        ...
        if (stream)
            goto label_140002caf;
        
        goto label_140002e66;
    }
    ...
    if (stream)
    {
        ...
        if (r15 <= 0)
            goto label_140002f9c;
        
        goto label_140002ccc;
    }
    ...
    if (r15 <= 0)
    {
        ...
        if (rsi != r13 || !r15)
            goto label_140002cfa;
        
        goto label_140002e94;
    }
    ...
    if (rsi != r13)
    {
        ...
        if (i < r12)
            goto label_140002eb0;
        
        goto label_140002d06;
    }
    ...
    if (fmt == 0x6f)
    {
        if (r15 < 0 && (rdi_1 & 0x600) == 0x200)
        {
            ...
            if (fmt == 0x6f || !(rdi_1 & 0x800))
                goto label_140002eed;
            
            goto label_140002ee2;
        }
    ...
    else
    {
        if (rdi_1 & 0x800)
        {
            ...
            *rsi = fmt;
            ...
            if (rdi_1 & 0x400)
                goto label_140002ff5;
            
            goto label_140002f05;
        }
...
int64_t __pformat_int(union value, struct { void* dest; int flags; int width; int precision; int rplen; short unsigned int rpchr; __padding char _1a[0x2];int thousands_chr_len; short unsigned int thousands_chr; __padding char _22[0x2];int count; int quota; int expmin; }* stream, union value)
{
    ...
    if (stream < 0)
    {
        ...
        if (_Size_2 > 0)
        {
            ...
            if (_Size_1 <= 0)
                goto label_140003240;
            
            goto label_14000322a;
        }
        
        if (&var_68 - rax_3 + 0x20 == rdi_1)
            goto label_1400033c9;
    }
    else
    {
        r12 &= 0x7f;
        ...
        if (rsi_1 > 0)
        {
            if (!(r12 & 0x1c0))
            {
                if (_Size_2 < 0 && (r12 & 0x600) == 0x200)
                    goto label_14000340a;
                
                goto label_140003272;
            }
...
int __pformat_emit_float(int sign, char* value, int len, struct { void* dest; int flags; int width; int precision; int rplen; short unsigned int rpchr; __padding char _1a[0x2];int thousands_chr_len; short unsigned int thousands_chr; __padding char _22[0x2];int count; int quota; int expmin; }* stream)
{
    ...
    if (len > 0)
    {
        ...
        if (*stream->flags[1] & 0x10 && stream->thousands_chr)
        {
            ...
            goto label_140003660;
        }
        
        label_1400036aa:
        
        if (!sign)
            goto label_1400036b2;
        ...
        else
        {
            ...
            if (!sign)
            {
                ...
                if (flags & 0x1c0)
                {
                    ...
                    if (rax == 1 || *flags[1] & 6)
                        goto label_1400036b5;
                    
                    goto label_14000368b;
                }
...
int64_t __pformat_emit_xfloat(union value, struct { void* dest; int flags; int width; int precision; int rplen; short unsigned int rpchr; __padding char _1a[0x2];int thousands_chr_len; short unsigned int thousands_chr; __padding char _22[0x2];int count; int quota; int expmin; }* stream, union value)
{
    ...
    if (precision_1 <= 0xe)
    {
        ...
        if (stream_4 || stream_2)
            goto label_140003fd7;
        
        goto label_140003ded;
    }
    ...
    if (cond:0 || stream_2)
    {
        ...
        if (i_1 == &var_58)
        {
            if (stream_1->precision <= 0)
                goto label_140003df7;
            
            goto label_140004086;
        }
    }
    else
    {
                ...
                if (rax_4 - 0x20 > 0x5a)
                {
                    ...
                    switch (rax_4)
                    {
                        ...
                        case 0x30:
                        {
                            ...
                            {
                                if (r14_1 > 3)
                                    goto label_140004b25;
                                
                                rcx = 0x30;
                                label_140004aca:
                                
                                if (r14_1 != 2)
                                    goto label_14000434c;
                        ...
                        case 0x41:
                        {
                            ...
                            if (rax_15 & 4)
                                goto label_14000453d;
                            
                            goto label_1400048c2;
                        }
                        case 0x43:
                        {
                            stream.quota = 0xffffffff;
                        ...
                        case 0x45:
                        {
                            ...
                            if (stream.thousands_chr & 4)
                                goto label_140004643;
                            
                            goto label_1400049aa;
                        }
                        case 0x46:
                        {
                            rdx_11 = *argv_1;
                            ...
                            if (stream.thousands_chr & 4)
                                goto label_1400046d9;
                            
                            goto label_1400049e2;
                        }
                        case 0x47:
                        {
                            rdx_13 = *argv_1;
        ...
        if (!rdi_2)
        {
            ...
            if (rax_7 - 1 <= 1)
            {
                ...
                if (mode_1 > 9)
                {
                    ...
                    if (be_1 < 0)
                    {
                        ...
                        if (k_7 <= 0)
                        {
                            ...
                            if (rdx_24 && fpi->emin + 1 < be)
                                goto label_1400063db;
                            
                            goto label_14000579b;
                        }
                        ...
                        if (!var_7c_1)
                        {
                            ...
                            if (i_1 <= 0 && rbp_3)
                                goto label_140005827;
                            
                            k_12 = k_11 + 1;
                            
                            if (!var_90_1)
                                goto label_140005e74;
                            
                            goto label_140005ae7;
                        }
                        
                        if (__cmp_D2A(r13_1, b_9) >= 0)
                            goto label_140005812;
                        ...
                        {
                            if (var_88_2 == 2)
                                goto label_14000614d;
                            
                            if (*(r13_1 + 0x14) > 1 || r13_1[3])
                                goto label_140005ef3;
                        }
                    ...
                    if (k_11 > fpi->int_max)
                    {
                        ...
                        if (be_1 - r12_1 >= emin || !((mode_1 - 3) & 0xfffffffd))
                            goto label_140005f30;
                        
                        goto label_140005658;
                    }
                ...
                else
                {
                    ...
                    if (i_7 + 1 <= 0)
                    {
                        ...
                        if (!var_7c_1 || !(0x3ff0000000000000 > zmm0_3))
                        {
                            ...
                            if (!var_90_1)
                            {
                                ...
                                if (zmm1 > zmm2)
                                    goto label_140005546;
                                
                                zmm0_3 = zmm0_3 - zmm4_2;
                                
                                if (zmm0_3 <= zmm1)
                                    goto label_140005a49;
                    ...
                    {
                        if (var_90_1)
                            goto label_140005625;
                        
                        k_5 = k;
                        e_11 = e_13;
                        r12_2 = nullptr;
                        goto label_1400056c6;
                    }
...
struct __Bigint* __i2b_D2A(int i)
{
    ...
    if (!pmem_next_1)
    {
        ...
        if (((pmem_next_1 - &private_mem) >> 3) + 5 <= 0x120)
        {
            ...
            if (cond:1_1)
                goto label_140006b3d;
            
            goto label_140006baf;
        }
        
        pmem_next_1 = malloc(0x28);
        
        if (pmem_next_1)
            goto label_140006b96;
    }
    else
    {
        bool cond:0_1 = dtoa_CS_init == 2;

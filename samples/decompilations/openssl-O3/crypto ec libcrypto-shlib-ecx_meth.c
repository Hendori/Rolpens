...
undefined8 x448_import_from(undefined8 param_1,EVP_PKEY_CTX *param_2)

{
  ...
  key = (void *)ossl_ecx_key_new(*(undefined8 *)(param_2 + 8),1,0,*(undefined8 *)(param_2 + 0x10));
  if (key == (void *)0x0) {
    ERR_new();
    ...
    iVar1 = ossl_ecx_key_fromdata(key,param_1,1);
    if (iVar1 != 0) {
      iVar1 = EVP_PKEY_assign(pkey,0x40b,key);
      if (iVar1 != 0) {
        return 1;
      }
    }
...
undefined8 pkey_ecx_derive25519(long param_1,long param_2,undefined8 *param_3)

{
  ...
  if ((*(long *)(param_1 + 0x88) == 0) || (*(long *)(param_1 + 0x90) == 0)) {
    ...
    lVar2 = evp_pkey_get_legacy();
    lVar3 = evp_pkey_get_legacy(*(undefined8 *)(param_1 + 0x90));
    if ((lVar2 == 0) || (*(long *)(lVar2 + 0x50) == 0)) {
      ...
      ERR_set_error(0x10,0x85,0);
            ...
            (iVar1 = ossl_x25519(param_2,*(long *)(lVar2 + 0x50),lVar3 + 0x11), iVar1 != 0)) {
      *param_3 = 0x20;
      return 1;
    }
  }
...
bool ecx_pub_print(BIO *param_1,long param_2,uint param_3)

{
  ...
  if (lVar1 == 0) {
    iVar2 = BIO_printf(param_1,"%*s<INVALID PUBLIC KEY>\n",uVar5,&_LC3);
    return 0 < iVar2;
  }
...
bool ecx_priv_print(BIO *param_1,long param_2,uint param_3)

{
  ...
  if ((lVar1 == 0) || (*(long *)(lVar1 + 0x50) == 0)) {
    iVar2 = BIO_printf(param_1,"%*s<INVALID PRIVATE KEY>\n",uVar5,&_LC3);
    return 0 < iVar2;
  }
  iVar2 = BIO_printf(param_1,"%*s%s Private-Key:\n",uVar5,&_LC3,pcVar3);
  if ((0 < iVar2) && (iVar2 = BIO_printf(param_1,"%*spriv:\n",(ulong)param_3,&_LC3), 0 < iVar2)) {
    iVar2 = **(int **)(param_2 + 8);
    if ((iVar2 == 0x40a) || (iVar2 == 0x43f)) {
      cVar4 = ' ';
    }
    ...
    if ((iVar2 != 0) && (iVar2 = BIO_printf(param_1,"%*spub:\n",uVar5,&_LC3), 0 < iVar2)) {
      iVar2 = **(int **)(param_2 + 8);
      if ((iVar2 == 0x40a) || (iVar2 == 0x43f)) {
        cVar4 = ' ';
      }
...
undefined8 pkey_ecx_derive448(long param_1,long param_2,undefined8 *param_3)
  ...
  if ((*(long *)(param_1 + 0x88) == 0) || (*(long *)(param_1 + 0x90) == 0)) {
    ...
    if ((lVar2 == 0) || (*(long *)(lVar2 + 0x50) == 0)) {
      ...
      ERR_set_error(0x10,0x85,0);
            ...
            (iVar1 = ossl_x448(param_2,*(long *)(lVar2 + 0x50),lVar3 + 0x11), iVar1 != 0)) {
      *param_3 = 0x38;
      return 1;
    }
  }
...
undefined8 ed25519_import_from(undefined8 param_1,EVP_PKEY_CTX *param_2)

{
  ...
  pkey = EVP_PKEY_CTX_get0_pkey(param_2);
  key = (void *)ossl_ecx_key_new(*(undefined8 *)(param_2 + 8),2,0,*(undefined8 *)(param_2 + 0x10));
  if (key == (void *)0x0) {
    ERR_new();
    ERR_set_debug("crypto/ec/ecx_meth.c",0x189,"ecx_generic_import_from");
    ERR_set_error(5,0x80010,0);
    ...
    iVar1 = ossl_ecx_key_fromdata(key,param_1,1);
    if (iVar1 != 0) {
      iVar1 = EVP_PKEY_assign(pkey,0x43f,key);
      if (iVar1 != 0) {
        return 1;
      }
    }
...
undefined8 ed448_import_from(undefined8 param_1,EVP_PKEY_CTX *param_2)

{
  ...
  pkey = EVP_PKEY_CTX_get0_pkey(param_2);
  key = (void *)ossl_ecx_key_new(*(undefined8 *)(param_2 + 8),3,0,*(undefined8 *)(param_2 + 0x10));
  if (key == (void *)0x0) {
    ERR_new();
    ERR_set_debug("crypto/ec/ecx_meth.c",0x189,"ecx_generic_import_from");
    ERR_set_error(5,0x80010,0);
    ...
    iVar1 = ossl_ecx_key_fromdata(key,param_1,1);
    if (iVar1 != 0) {
      iVar1 = EVP_PKEY_assign(pkey,0x440,key);
      if (iVar1 != 0) {
        return 1;
      }
    }
...
undefined8 x25519_import_from(undefined8 param_1,EVP_PKEY_CTX *param_2)

{
  ...
  pkey = EVP_PKEY_CTX_get0_pkey(param_2);
  key = (void *)ossl_ecx_key_new(*(undefined8 *)(param_2 + 8),0,0,*(undefined8 *)(param_2 + 0x10));
  if (key == (void *)0x0) {
    ERR_new();
    ERR_set_debug("crypto/ec/ecx_meth.c",0x189,"ecx_generic_import_from");
    ERR_set_error(5,0x80010,0);
    ...
    iVar1 = ossl_ecx_key_fromdata(key,param_1,1);
    if (iVar1 != 0) {
      iVar1 = EVP_PKEY_assign(pkey,0x40a,key);
      if (iVar1 != 0) {
        return 1;
      }
    }

...
switchD_001002a5_caseD_2b:
    uVar5 = equal_nocase(param_1,param_2,param_3,param_4,param_5);
    return uVar5;
  }
  iVar3 = 0;
  pbVar9 = (byte *)0x0;
...
switchD_001002a5_caseD_30:
      if (((uVar10 & 1) != 0) && (3 < (ulong)(param_2 - lVar6))) {
  ...
  if ((param_4 < pbVar8 + lVar6) ||
     (iVar3 = equal_nocase(param_1,lVar6,param_3,lVar6,param_5), iVar3 == 0)) {
    return 0;
  }
...
LAB_001009f5:
              uVar4 = do_check_string(uVar8,local_4c,pcVar10,uVar9,param_2,local_60,param_6);
              if (uVar4 != 0) {
LAB_00100a78:
      ...
      for (; iVar2 = OPENSSL_sk_num(a), iVar3 < iVar2; iVar3 = iVar3 + 1) {
        ...
        if (iVar2 == 2) {
          if (param_5 == 2) {
LAB_00100942:
            uVar4 = do_check_string(*(undefined8 *)(piVar7 + 2),local_4c,pcVar10,uVar9,param_2,
                                    local_60,param_6);
...

{
  ...
  if (value == (char *)0x0) {
    pvVar3 = (void *)0x0;
    if ((name != (char *)0x0) &&
       (name = CRYPTO_strdup(name,"crypto/x509/v3_utl.c",0x2f), (char **)name == (char **)0x0))
    goto LAB_001010ac;
LAB_00101023:
    ptr = (stack_st_CONF_VALUE *)CRYPTO_malloc(0x18,"crypto/x509/v3_utl.c",0x39);
    ...
    *extlist = psVar4;
    ...
    if ((name == (char *)0x0) ||
      ...
      if ((pvVar3 == (void *)0x0) &&
         (pvVar3 = (void *)CRYPTO_strndup(value,__n,"crypto/x509/v3_utl.c",0x35),
         pvVar3 != (void *)0x0)) goto LAB_00101023;
      pvVar3 = (void *)0x0;
    }
    else {
LAB_001010ac:
...
LAB_0010122b:
    ...
    *extlist = psVar4;
    ...
    if ((name == (char *)0x0) ||
      ...
      if ((pvVar3 == (void *)0x0) &&
         (pvVar3 = (void *)CRYPTO_strndup(value,__n,"crypto/x509/v3_utl.c",0x35),
         pvVar3 != (void *)0x0)) goto LAB_0010122b;
      pvVar3 = (void *)0x0;
    }
    else {
LAB_001012b4:
    ...
    if ((((iVar2 == 0) || (iVar2 = strcmp(__s1,"true"), iVar2 == 0)) ||
      ...
      *asn1_bool = 0xff;
      ...
      if (((((iVar2 != 0) && (iVar2 = strcmp(__s1,"false"), iVar2 != 0)) &&
         ...
         ((*__s1 != 'n' || ((__s1[1] != 'o' || (__s1[2] != '\0')))))) goto LAB_00101af0;
      *asn1_bool = 0;
    }
    return 1;
  }
  ...
  do {
    while( true ) {
      do {
        ...
        } while (((pAVar3->type != 0x16) || (__s = pAVar3->data, __s == (uchar *)0x0)) ||
                (pAVar3->length == 0));
...
LAB_001021a3:
  ...
  if ((*piVar5 == 1) && (iVar2 = append_ia5(&local_48,*(undefined8 *)(piVar5 + 2)), iVar2 == 0))
  goto LAB_001021ce;
  iVar1 = iVar1 + 1;
  goto LAB_001021a3;
LAB_001021ce:
...
LAB_0010237b:
    if (param_2[__n] == '\0') goto LAB_00102386;
  }
  __n = param_3;
LAB_00102386:
...
LAB_00102452:
    if (param_2[__n] == '\0') goto LAB_0010245d;
  }
  __n = param_3;
LAB_0010245d:

...
char * evp_generic_fetch(undefined8 param_1,uint param_2,char *param_3,char *param_4,
...

{
  ...
  if ((int)param_2 < 1) {
    ...
    uVar6 = 0x11f;
LAB_001008a1:
    ERR_set_debug("crypto/evp/evp_fetch.c",uVar6,"inner_evp_generic_fetch");
    ERR_set_error(6,0xc0103,0);
    pcVar5 = (char *)0x0;
    goto LAB_00100781;
  }
  if ((param_3 == (char *)0x0) || (iVar1 = ossl_namemap_name2num(lVar4,param_3), iVar1 == 0)) {
    local_98 = 0x100000;
...
LAB_001007e9:
        if (param_2 - 1 < 0xff) {
          ossl_method_store_cache_set
                    (lVar3,local_d8,iVar1 << 8 | param_2,pcVar5,local_d0,param_6,param_7);
        }
        goto LAB_00100828;
      }
      goto LAB_001009a8;
...
char * evp_generic_fetch_from_prov
                 (undefined8 param_1,uint param_2,char *param_3,char *param_4,undefined8 param_5,
...
void evp_generic_do_all(undefined8 param_1,uint param_2,undefined8 param_3,undefined8 param_4,
                       undefined8 param_5,undefined8 param_6,code *param_7)
    ...
    if (lVar4 != 0) {
      ...
      if (iVar1 == 0) {
        ...
        if ((iVar1 - 1U < 0x7fffff) && (uVar6 = (ulong)(param_2 - 1), param_2 - 1 < 0xff)) {
          ossl_method_store_cache_set
                    (lVar2,local_d0,iVar1 << 8 | param_2,&_LC1,lVar4,param_6,param_7);
          uVar6 = 0x10169d;
        }
      }
    }

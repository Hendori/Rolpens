...

{
  ...
  *(undefined4 *)((long)ptr + 8) = 1;
  ...
  iVar1 = test_ptr("test/cmp_hdr_test.c",0x13a,&_LC23,lVar3);
  if (iVar1 != 0) {
...

{
  ...
  *(undefined4 *)((long)ptr + 8) = 1;
  ...
  iVar1 = test_ptr("test/cmp_hdr_test.c",0x119,&_LC26,str);
...

{
  ...
  *(undefined4 *)((long)ptr + 8) = 1;
  str = ASN1_UTF8STRING_new();
  iVar1 = test_ptr("test/cmp_hdr_test.c",0xf8,&_LC26,str);
  if (iVar1 != 0) {
...

{
  ...
  ptr = (void *)set_up();
  if (ptr == (void *)0x0) goto LAB_00100b8e;
  *(undefined4 *)((long)ptr + 8) = 1;
  ...
  if (ptr != (void *)0x0) {
    *(undefined4 *)((long)ptr + 8) = 1;
    ...
    if (uVar2 != 0) {
      ...
      iVar3 = test_int_eq("test/cmp_hdr_test.c",0x37,"ossl_cmp_hdr_get_pvno(fixture->hdr)",&_LC51,
                          uVar1,0x4d);
      uVar2 = (uint)(iVar3 != 0);
    }
    OSSL_CMP_PKIHEADER_free(*(undefined8 *)((long)ptr + 0x18));
  ...
  if (ptr != (void *)0x0) {
    *(undefined4 *)((long)ptr + 8) = 1;
    ...
    if (iVar1 != 0) {
      ...
      if (iVar1 != 0) {
        iVar1 = OSSL_CMP_CTX_set1_subjectName(*(undefined8 *)((long)ptr + 0x10),name,uVar3,0x1010b9)
        ;
...

{
  ...
  if (ptr == (void *)0x0) goto LAB_0010125c;
  *(undefined4 *)((long)ptr + 8) = 1;
  ...
  if (iVar1 == 0) goto LAB_00101238;
  iVar1 = test_ptr("test/cmp_hdr_test.c",0x15f,&_LC57,pAVar3);
  if (iVar1 == 0) {
LAB_001012cf:
    ASN1_INTEGER_free(a);
LAB_00101238:

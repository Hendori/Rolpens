...
LAB_00100188:
  ...
  if (bVar1) {
    ...
    if (bio != (BIO *)0x0) {
      ...
      if (nitems != 0) {
        do {
          pcVar19 = pEVar22->comment;
          pcVar15 = OBJ_nid2sn(pEVar22->nid);
          if (pcVar19 == (char *)0x0) {
            pcVar19 = "CURVE DESCRIPTION NOT AVAILABLE";
          }
          if (pcVar15 == (char *)0x0) {
            BIO_printf(bio,"  %-10s: ",&_LC10);
            BIO_printf(bio,"%s\n",pcVar19);
          }
          else {
...
LAB_00100362:
    if ((!bVar2) || (iVar8 = EVP_PKEY_set_octet_string_param(local_f8,&_LC28,0), iVar8 != 0)) {
      ...
      if (local_fc == 4) {
        ...
        uVar11 = OSSL_ENCODER_CTX_new_for_pkey(local_f8,4,&_LC3,0,0);
        iVar10 = OSSL_ENCODER_to_bio(uVar11,bio);
        if (iVar10 == 0) goto LAB_00100a8f;
      }
      else {
        uVar11 = 0;
        if (!bVar6) {
...
LAB_0010098c:
    ...
    pcVar19 = "unable to clear seed\n";
  }
  else {
    iVar8 = strcmp(pcVar19,"secp192r1");
    if (iVar8 == 0) {
      pcVar19 = "prime192v1";
      BIO_printf(_bio_err,"using curve name prime192v1 instead of secp192r1\n");
    }
    else {
      iVar8 = strcmp(pcVar19,"secp256r1");
      if (iVar8 == 0) {
        pcVar19 = "prime256v1";
    ...
    puVar20 = &local_c0;
    OSSL_PARAM_construct_utf8_string(&local_138,"group",pcVar19);
    local_e8 = local_138;
    ...
    *puVar21 = local_138;
    ...
    puVar21[4] = local_118;
    iVar8 = OPENSSL_strcasecmp(pcVar19,&_LC18);
    if (iVar8 == 0) {
      uVar11 = app_get0_propq();
      uVar12 = app_get0_libctx();
    ...
    pcVar19 = "unable to generate key\n";
  }
  BIO_printf(_bio_err,pcVar19);
  bio = (BIO *)0x0;
  uVar11 = 0;
  uVar12 = 0;
  ctx_00 = (EVP_PKEY_CTX *)0x0;

...
LAB_00100126:
  n->top = (uVar2 ^ uVar1) & (uint)((long)(uVar11 - lVar12) >> 0x3f) ^ uVar1;
LAB_00100138:
  iVar7 = bn_mul_mont_fixed_top(n,n,r,lVar3);
...
LAB_00100495:
    if (b != (BN_BLINDING *)0x0) goto LAB_0010049e;
  }

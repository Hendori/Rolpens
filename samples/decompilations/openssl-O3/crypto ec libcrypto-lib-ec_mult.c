...
LAB_00100fa1:
      if (param_3 == (BIGNUM *)0x0) goto LAB_00100fac;
      goto LAB_001009ec;
    }
...
LAB_001013ce:
        uVar12 = ossl_ec_scalar_mul_ladder(param_1,param_2,param_3,uVar11,param_7);
        return uVar12;
      }
      goto LAB_0010194a;
    }
...
LAB_00100be0:
      ...
      if (local_78 == 0) {
LAB_00100d40:
        local_d8 = (undefined8 *)CRYPTO_malloc((int)lVar16 * 8 + 8,"crypto/ec/ec_mult.c",0x28e);
        ...
        if (local_d8 + lVar16 == puVar17) {
            ...
            do {
              ...
              if (1 < *(ulong *)(ptr + uVar18 * 2)) {
                iVar4 = EC_POINT_dbl(param_1,local_90,
                                     (EC_POINT *)**(undefined8 **)((long)local_a8 + uVar18 * 8),
                                     param_7);
                if (iVar4 == 0) goto LAB_00100e68;
                if (ptr[uVar18 * 2] != 1) {
                  uVar22 = 1;
                  do {
                    ...
                    iVar4 = EC_POINT_add(param_1,*(EC_POINT **)(lVar7 + uVar22 * 8),
                                         *(EC_POINT **)(lVar7 + -8 + uVar22 * 8),local_90,param_7);
                    if (iVar4 == 0) goto LAB_00100e68;
                    uVar22 = uVar22 + 1;
          ...
          if ((*(code **)(*(long *)param_1 + 0xd8) == (code *)0x0) ||
             (iVar4 = (**(code **)(*(long *)param_1 + 0xd8))(param_1,lVar16,local_d8,param_7),
             iVar4 == 0)) {
LAB_001018e1:
            uVar15 = 0;
          }
...
LAB_00101794:
                          iVar4 = EC_POINT_copy(param_2,*(EC_POINT **)
                                                         (*(long *)((long)local_a8 + uVar18 * 8) +
                                                         (long)((int)(uVar10 & 0xff) >> 1) * 8));
                          if (iVar4 == 0) goto LAB_00100e68;
...
LAB_00101850:
                          iVar4 = EC_POINT_add(param_1,param_2,param_2,
                                               *(EC_POINT **)
                                                (*(long *)((long)local_a8 + uVar18 * 8) +
                                                (long)((int)(uVar10 & 0xff) >> 1) * 8),param_7);
                          if (iVar4 == 0) goto LAB_00100e68;
                        }
                        bVar3 = false;
                      }
          ...
          if (pvVar8 != (void *)0x0) {
            if (uVar12 < local_48) {
              if ((local_48 < local_78 * local_50) &&
                 (uVar18 = ((local_50 - 1) + local_48) / local_50, local_88 = param_4 + uVar18,
                 *(ulong *)(local_90 + 0x10) < uVar18)) {
                ERR_new();
...
LAB_001009e1:
    if (param_3 == (BIGNUM *)0x0) goto LAB_00100fd0;
LAB_001009ec:

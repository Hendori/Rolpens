...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (param_2 != 0) {
    uVar4 = OSSL_PARAM_locate_const(param_1,&_LC57);
    iVar1 = test_ptr("test/keymgmt_internal_test.c",0x6d,
                     "p = OSSL_PARAM_locate_const(params, OSSL_PKEY_PARAM_RSA_N)",uVar4);
    if (iVar1 != 0) {
      local_48 = (BIGNUM *)0x0;
      iVar1 = OSSL_PARAM_get_BN(uVar4,&local_48);
      uVar2 = test_true("test/keymgmt_internal_test.c",0x5e,"OSSL_PARAM_get_BN(p, &n)",iVar1 != 0);
      if (uVar2 != 0) {
        uVar3 = BN_bn2nativepad(local_48,param_2,8);
        iVar1 = test_int_ge("test/keymgmt_internal_test.c",0x5f,
                            "BN_bn2nativepad(n, (unsigned char *)goal, sizeof(*goal))",&_LC50,uVar3,
                            0);
        uVar2 = (uint)(iVar1 != 0);
      }
      BN_free(local_48);
      iVar1 = test_true("test/keymgmt_internal_test.c",0x6e,"get_ulong_via_BN(p, &keydata[N])",uVar2
                       );
      if (iVar1 != 0) {
        uVar4 = OSSL_PARAM_locate_const(param_1,&_LC60);
        iVar1 = test_ptr("test/keymgmt_internal_test.c",0x6f,
                         "p = OSSL_PARAM_locate_const(params, OSSL_PKEY_PARAM_RSA_E)",uVar4);
        if (iVar1 != 0) {
          local_48 = (BIGNUM *)0x0;
          iVar1 = OSSL_PARAM_get_BN(uVar4,&local_48);
          uVar2 = test_true("test/keymgmt_internal_test.c",0x5e,"OSSL_PARAM_get_BN(p, &n)",
                            iVar1 != 0);
          if (uVar2 != 0) {
            uVar3 = BN_bn2nativepad(local_48,param_2 + 8,8);
            iVar1 = test_int_ge("test/keymgmt_internal_test.c",0x5f,
                                "BN_bn2nativepad(n, (unsigned char *)goal, sizeof(*goal))",&_LC50,
                                uVar3,0);
            uVar2 = (uint)(iVar1 != 0);
          }
          BN_free(local_48);
          iVar1 = test_true("test/keymgmt_internal_test.c",0x70,"get_ulong_via_BN(p, &keydata[E])",
                            uVar2);
          if (iVar1 != 0) {
            uVar4 = OSSL_PARAM_locate_const(param_1,&_LC63);
            iVar1 = test_ptr("test/keymgmt_internal_test.c",0x71,
                             "p = OSSL_PARAM_locate_const(params, OSSL_PKEY_PARAM_RSA_D)",uVar4);
            if (iVar1 != 0) {
              local_48 = (BIGNUM *)0x0;
              iVar1 = OSSL_PARAM_get_BN(uVar4,&local_48);
              uVar2 = test_true("test/keymgmt_internal_test.c",0x5e,"OSSL_PARAM_get_BN(p, &n)",
                                iVar1 != 0);
              if (uVar2 != 0) {
                uVar3 = BN_bn2nativepad(local_48,param_2 + 0x10,8);
                iVar1 = test_int_ge("test/keymgmt_internal_test.c",0x5f,
                                    "BN_bn2nativepad(n, (unsigned char *)goal, sizeof(*goal))",
                                    &_LC50,uVar3,0);
                uVar2 = (uint)(iVar1 != 0);
              }
              BN_free(local_48);
              iVar1 = test_true("test/keymgmt_internal_test.c",0x72,
                                "get_ulong_via_BN(p, &keydata[D])",uVar2);
              if (iVar1 != 0) {
                uVar4 = OSSL_PARAM_locate_const(param_1,"rsa-factor1");
                ...
                if (iVar1 != 0) {
                  ...
                  uVar2 = test_true("test/keymgmt_internal_test.c",0x5e,"OSSL_PARAM_get_BN(p, &n)",
                                    iVar1 != 0);
                  if (uVar2 != 0) {
                    uVar3 = BN_bn2nativepad(local_48,param_2 + 0x18,8);
                    iVar1 = test_int_ge("test/keymgmt_internal_test.c",0x5f,
                                        "BN_bn2nativepad(n, (unsigned char *)goal, sizeof(*goal))",
                                        &_LC50,uVar3,0);
                    uVar2 = (uint)(iVar1 != 0);
                  ...
                  iVar1 = test_true("test/keymgmt_internal_test.c",0x76,
                                    "get_ulong_via_BN(p, &keydata[P])",uVar2);
                  if (iVar1 != 0) {
                    uVar4 = OSSL_PARAM_locate_const(param_1,"rsa-factor2");
                    ...
                    if (iVar1 != 0) {
                      local_48 = (BIGNUM *)0x0;
                      iVar1 = OSSL_PARAM_get_BN(uVar4,&local_48);
                      uVar2 = test_true("test/keymgmt_internal_test.c",0x5e,
                                        "OSSL_PARAM_get_BN(p, &n)",iVar1 != 0);
                      if (uVar2 != 0) {
                        uVar3 = BN_bn2nativepad(local_48,param_2 + 0x20,8);
                        iVar1 = test_int_ge("test/keymgmt_internal_test.c",0x5f,
                                            "BN_bn2nativepad(n, (unsigned char *)goal, sizeof(*goal))"
                                            ,&_LC50,uVar3,0);
                        uVar2 = (uint)(iVar1 != 0);
                                        ...
                                        if (iVar1 != 0) {
                                          ...
                                          if (iVar1 != 0) {
                                            ...
                                            iVar1 = test_ptr("test/keymgmt_internal_test.c",0x87,
                                                  ...
                                                  ,uVar4);
                                            if (iVar1 != 0) {
                                              iVar1 = get_ulong_via_BN(uVar4,param_2 + 0x50);

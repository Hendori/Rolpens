...
LAB_0010055d:
    ...
    if ((iVar1 != 0) && (iVar1 = X509_STORE_add_cert(ctx,param_2), iVar1 != 0)) goto LAB_0010048f;
    uVar2 = 0;
    OPENSSL_sk_pop_free(local_48,X509_free);
  }
  X509_STORE_free(ctx);
...
LAB_00100bfc:
                  ossl_cmp_print_log(4,param_1,"ossl_X509_check","crypto/cmp/cmp_genm.c",0x34,&_LC4,
                                     "certificate from \'%s\' with subject \'%s\' %s",&_LC19,pcVar14
                                     ,"is not a CA cert");
                  CRYPTO_free(pcVar14);
                  goto LAB_00100b7f;
                }
                ...
                ossl_cmp_print_log(4,param_1,"ossl_X509_check","crypto/cmp/cmp_genm.c",0x2e,&_LC4,
                                   "certificate from \'%s\' with subject \'%s\' %s",&_LC19,pcVar9,
                                   pcVar14);
                CRYPTO_free(pcVar9);
                if ((uVar4 & 0x50) == 0) {
                  pXVar13 = X509_get_subject_name(pXVar10);
            ...
            for (; iVar3 = OPENSSL_sk_num(lVar7), iVar2 < iVar3; iVar2 = iVar2 + 1) {
              ...
              if (iVar3 == 0) {
                if ((uVar4 & 0x50) == 0) {
                  ...
                  pcVar14 = X509_NAME_oneline(pXVar13,(char *)0x0,0);
LAB_00100994:
                  ossl_cmp_print_log(3,param_1,"ossl_X509_check","crypto/cmp/cmp_genm.c",0x34,&_LC17
                                     ,"certificate from \'%s\' with subject \'%s\' %s",&_LC19,
                                     pcVar14,"is not a CA cert");
                  CRYPTO_free(pcVar14);
                  goto LAB_0010090f;
                }
              }
                ...
                pXVar13 = X509_get_subject_name(pXVar10);
                pcVar9 = X509_NAME_oneline(pXVar13,(char *)0x0,0);
                ossl_cmp_print_log(3,param_1,"ossl_X509_check","crypto/cmp/cmp_genm.c",0x2e,&_LC17,
                                   "certificate from \'%s\' with subject \'%s\' %s",&_LC19,pcVar9,
                                   pcVar14);
                CRYPTO_free(pcVar9);
                if ((uVar4 & 0x50) == 0) {

...
LAB_001004e5:
          ...
          *plVar10 = puVar16[2];
          uVar17 = 0x10;
          if ((sVar1 != 2) && (uVar17 = 0x1c, sVar1 != 10)) goto LAB_001004e5;
        }
        lVar4 = puVar16[3];
      ...
      do {
        *puVar16 = *puVar11;
        ...
        if ((iVar6 == 0) && (puVar11[2] != 0)) {
          ...
          *plVar10 = puVar11[2];
          uVar17 = 0x10;
          if ((sVar1 != 2) && (uVar17 = 0x1c, sVar1 != 10)) goto LAB_00100136;
        }
        else {
          *plVar10 = 0;
LAB_00100136:
          ...
          *(undefined4 *)(plVar10 + 6) = 0;
          ...
          if (sVar1 == 10) {
            ...
            *puVar15 = 0x24;
            if ((sVar1 == 0) || (sVar1 == *(short *)(lVar3 + 0x72))) {
              if ((*(int *)(lVar4 + 0x18) == 0) ||
                 (*(int *)(lVar4 + 0x18) == *(int *)(lVar3 + 0x88))) goto LAB_0010020f;
              ERR_new();
              uVar7 = 0x505;
            }
            else {
...
LAB_001002cd:
            ERR_set_debug("crypto/bio/bss_dgram.c",uVar7,"pack_local");
            ERR_set_error(0x20,0x96,0);
          }
          ERR_new();
          uVar7 = 0x56a;
LAB_0010019d:
          ERR_set_debug("crypto/bio/bss_dgram.c",uVar7,"dgram_sendmmsg");
...
LAB_00100227:
    iVar6 = sendmmsg(*(undefined4 *)(param_1 + 0x38),local_1048);
    if (iVar6 < 0) {
      ERR_new();
    ...
    if (*(char *)(lVar5 + 0x104) == '\0') {
      ...
      do {
        ...
        if ((iVar10 == 0) && ((void *)puVar27[2] != (void *)0x0)) {
          ...
          sVar30 = 0x10;
          if ((sVar1 != 2) && (sVar30 = 0x1c, sVar1 != 10)) goto LAB_00100b04;
        }
        else {
      ...
      if (iVar10 == 0) {
        ...
        do {
          ...
          while( true ) {
            ...
            pmVar18 = pmVar17;
LAB_001008da:
            (pmVar18->msg_hdr).msg_namelen = sVar30;
...
LAB_001006f0:
    iVar10 = recvmmsg(*(int *)(param_1 + 0x38),local_1048,(uint)uVar24,0,(timespec *)0x0);
    if (iVar10 < 0) {
      ERR_new();
            ...
            if (*(short *)(lVar5 + 0x70) == 2) {
              if (puVar12 != (ulong *)0x0) {
                while( true ) {
                  ...
                  if (((uVar28 < uVar21) || (uVar28 - uVar21 < uVar8)) ||
                     (puVar12 = (ulong *)((long)puVar12 + (uVar8 + 7 & 0xfffffffffffffff8)),
                     puVar12 == (ulong *)0x0)) break;
                }
              }
            }
            else if (*(short *)(lVar5 + 0x70) == 10) {
              for (; puVar12 != (ulong *)0x0;
                  puVar12 = (ulong *)((long)puVar12 + (uVar8 + 7 & 0xfffffffffffffff8))) {
...

{
  ...
  *piVar4 = 0;
  ...
  if (pbVar2[2].cb_arg != (char *)0x0) {
    ...
    uVar5 = 1000;
    if ((pcVar6 <= pbVar2[2].cb_arg) &&
       (uVar5 = (long)pbVar2[2].cb_arg - (long)pcVar6, uVar5 < 1000)) {
      uVar5 = 1000;
    }
  ...
  uVar5 = recvfrom(*(int *)&param_1->next_bio,param_2,(long)param_3,(uint)(iVar3 != 0) * 2,__addr,
                   &local_d0);
  iVar3 = (int)uVar5;
...
LAB_00101703:
      if ((iVar3 + 1U < 2) && (iVar3 = BIO_dgram_non_fatal_error(*piVar4), iVar3 != 0)) {

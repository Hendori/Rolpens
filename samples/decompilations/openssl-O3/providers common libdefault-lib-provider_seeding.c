...

{
  ...
  if ((c_get_user_entropy == (code *)0x0) &&
     (UNRECOVERED_JUMPTABLE = c_get_entropy, c_get_entropy == (code *)0x0)) {
    return 0;
  }
...

{
  ...
  if ((c_cleanup_user_entropy == (code *)0x0) &&
     (UNRECOVERED_JUMPTABLE = c_cleanup_entropy, c_cleanup_entropy == (code *)0x0)) {
    return;
  }
...

{
  ...
  if ((c_get_user_nonce == (code *)0x0) &&
     (UNRECOVERED_JUMPTABLE = c_get_nonce, c_get_nonce == (code *)0x0)) {
    return 0;
  }
...

{
  ...
  if ((c_cleanup_user_nonce == (code *)0x0) &&
     (UNRECOVERED_JUMPTABLE = c_cleanup_nonce, c_cleanup_nonce == (code *)0x0)) {
    return;
  }

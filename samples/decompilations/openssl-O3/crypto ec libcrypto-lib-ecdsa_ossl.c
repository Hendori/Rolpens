...
LAB_00100e0c:
        ...
        if ((local_68 * 8 <= (int)uVar2) ||
           (iVar1 = BN_rshift(local_90,local_90,8 - (uVar2 & 7)), iVar1 != 0)) goto LAB_00100b46;
        ERR_new();
        pBVar7 = (BIGNUM *)0x0;
...
LAB_00100b46:
    if ((param_4 == (BIGNUM *)0x0) || (param_3 == (BIGNUM *)0x0)) {
      ...
      do {
        ...
        if ((iVar3 == 0) ||
           (iVar3 = bn_mul_mont_fixed_top(pBVar6,pBVar6,pBVar5,*(undefined8 *)(pEVar4 + 0x90),ctx),
           iVar3 == 0)) goto LAB_00100f80;
        ...
        if ((iVar3 == 0) ||
           (iVar3 = BN_mod_mul_montgomery(pBVar6,pBVar6,pBVar7,*(BN_MONT_CTX **)(pEVar4 + 0x90),ctx)
           , iVar3 == 0)) goto LAB_00100fc0;
...
LAB_00100f91:
    ...
    if ((iVar1 == 0) ||
       (iVar1 = bn_mul_mont_fixed_top(pBVar6,pBVar6,pBVar5,*(undefined8 *)(pEVar4 + 0x90),ctx),
       iVar1 == 0)) {
LAB_00100f80:
      ERR_new();
      uVar9 = 0x16c;
...
LAB_00100fd8:
    ...
    if ((iVar1 == 0) ||
       (iVar1 = BN_mod_mul_montgomery(pBVar6,pBVar6,param_3,*(BN_MONT_CTX **)(pEVar4 + 0x90),ctx),
       iVar1 == 0)) {
LAB_00100fc0:
      ERR_new();
      uVar9 = 0x179;

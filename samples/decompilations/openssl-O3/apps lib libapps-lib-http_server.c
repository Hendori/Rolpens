...

{
  ...
  if (0 < n_responders) {
    do {
      while (__pid = *(__pid_t *)((long)param_2 + lVar2 * 4), __pid != 0) {
        lVar2 = lVar2 + 1;
        kill(__pid,0xf);
        iVar1 = n_responders;
        if (n_responders <= (int)lVar2) goto LAB_00100048;
      }
      lVar2 = lVar2 + 1;
...
LAB_00100da3:
        ...
        local_1098 = (BIO *)0x0;
        if (sVar7 == 3) {
          local_1098 = BIO_new_mem_buf(pbVar15,iVar4);
          ...
          *pcVar13 = '\0';
          ...
          if (local_848[0] == '\0') {
            ...
            if (val == (ASN1_VALUE *)0x0) {
              ...
              pcVar13 = CRYPTO_strdup((char *)pbVar15,"apps/lib/http_server.c",0x1d9);
              *param_3 = pcVar13;
              if (pcVar13 == (char *)0x0) {

...

{
  ...
  *(undefined4 *)(param_1 + 0xb4) = param_2;
  if ((*(long *)(param_1 + 0xc70) != 0) &&
     (UNRECOVERED_JUMPTABLE = *(code **)(*(long *)(param_1 + 0xc70) + 0x80),
...
void ossl_statem_fatal(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...
joined_r0x001007b8:
    if (((bVar2 & 8) == 0) && (iVar6 = SSL_clear(param_1), iVar6 == 0)) goto LAB_00100b90;
  }
  else {
...
LAB_00100ca6:
      ...
      if (((uVar7 & 0xff00) == 0xfe00) || (((uVar7 & 0xff00) == 0x100 && ((param_2 & 1) == 0))))
      goto LAB_001006ee;
      ERR_new();
      uVar15 = 0x1a3;
LAB_00100cf4:
      ERR_set_debug("ssl/statem/statem.c",uVar15,"state_machine");
      ...
      if ((((param_1->tls_session_ticket_ext_cb_arg == (void *)0x0) ||
         ...
         ((iVar6 = *(int *)&param_1->wbio->method, iVar6 < 0x304 || (iVar6 == 0x10000)))) {
...
LAB_001006ee:
      iVar6 = ssl_security(param_1,9,0,uVar7,0);
      if (iVar6 == 0) {
        ERR_new();
        uVar15 = 0x1ae;
        goto LAB_00100cf4;
      ...
      *(undefined4 *)&param_1->mode = 0;
      ...
      if (iVar6 != 0) {
        if ((param_1->tls_session_ticket_ext_cb_arg != (void *)0x0) &&
           (lVar5._0_4_ = param_1[1].server, lVar5._4_4_ = param_1[1].new_session, lVar5 != 0))
        goto LAB_00100788;
        *(undefined4 *)&param_1->cipher_list = 1;
        goto LAB_00100788;
      }
    }
switchD_0010050a_caseD_4:
    iVar6 = -1;
    str = (COMP_CTX *)0x0;
  }
  else {
...
LAB_001004cf:
        ...
        uVar15 = 0x3c2;
LAB_001005e1:
        ERR_set_debug("ssl/statem/statem.c",uVar15,pcVar12);
...
LAB_00100644:
  ...
  return iVar6;
LAB_001009b9:
  uVar8 = *(undefined4 *)&param_1->msg_callback_arg;
LAB_001009c0:
  uVar8 = (*pcVar14)(param_1,uVar8);
...
switchD_00100c53_default:
  iVar6 = *(int *)((long)&param_1->msg_callback_arg + 4);
  if (iVar6 == 1) {
...
LAB_00100872:
  ...
  if ((*(byte *)(*(long *)&param_1->wbio[1].ex_data.dummy + 0x50) & 8) == 0) {
    if (*(long *)&param_1[1].quiet_shutdown == 0) {
      ...
      *(undefined4 *)((long)&param_1->msg_callback_arg + 4) = 1;
LAB_001007f1:
      if ((uVar7 & 8) != 0) goto LAB_001007f9;
    }
    ...
    *(undefined4 *)((long)&param_1->msg_callback_arg + 4) = 1;
LAB_001007f9:
    iVar6 = dtls_get_message_body(param_1,&local_80);
  }
  if (iVar6 == 0) goto switchD_0010050a_caseD_4;
  pcVar4 = param_1->cert;
...
LAB_00100c26:
      iVar6 = (*pcVar16)(param_1,param_1->hit);
      param_1->hit = iVar6;
      switch(iVar6) {
      case 0:
        if ((*(int *)((long)&param_1->param + 4) == 0) || (*(int *)&param_1->msg_callback != 1)) {
...
switchD_00100c53_caseD_2:
    *(undefined4 *)((long)&param_1->msg_callback_arg + 4) = 0;
    goto LAB_00100872;
  }
switchD_00100c53_caseD_1:
  if ((*(byte *)(*(long *)&param_1->wbio[1].ex_data.dummy + 0x50) & 8) != 0) {
    dtls1_stop_timer(param_1);
  }
LAB_00100788:
  param_1->msg_callback = (_func_3150 *)0x3;
  goto LAB_00100478;
LAB_001010cd:
  WPACKET_cleanup(&local_78);
LAB_00100c01:
...

{
  ...
  if (((*(int *)(param_1 + 0x98) != 0) && (uVar2 = *(uint *)(param_1 + 0x1d8), uVar2 != 0)) &&
     (uVar2 = *(uint *)(param_1 + 0x1d0), uVar2 != 0)) {
    iVar1 = *(int *)(param_1 + 0xac);
    if (*(int *)(param_1 + 0x78) != 0) {

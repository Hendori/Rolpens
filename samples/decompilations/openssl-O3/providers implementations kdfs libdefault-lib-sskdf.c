...

{
  ...
  if ((((0x40000000 < param_3) || (0x40000000 < param_5)) || (0x3fffffff < param_8 - 1)) ||
     (iVar2 = EVP_MD_get_size(), iVar2 < 1)) {
    uVar4 = 0;
    goto LAB_001003ed;
  }
  ...
  if (((out != (EVP_MD_CTX *)0x0) && (ctx != (EVP_MD_CTX *)0x0)) &&
    ...
    if (param_6 == 0) {
      while( true ) {
        ...
        if (((iVar2 == 0) || (iVar2 = EVP_DigestUpdate(out,&local_8c,4), iVar2 == 0)) ||
           ((iVar2 = EVP_DigestUpdate(out,param_2,param_3), iVar2 == 0 ||
            (iVar2 = EVP_DigestUpdate(out,param_4,param_5), iVar2 == 0)))) break;
      ...
      while( true ) {
        local_8c = uVar1 >> 0x18 | (uVar1 & 0xff0000) >> 8 | (uVar1 & 0xff00) << 8 | uVar1 << 0x18;
        iVar2 = EVP_MD_CTX_copy_ex(out,ctx);
        if ((((iVar2 == 0) || (iVar2 = EVP_DigestUpdate(out,param_2,param_3), iVar2 == 0)) ||
            (iVar2 = EVP_DigestUpdate(out,&local_8c,4), iVar2 == 0)) ||
           (iVar2 = EVP_DigestUpdate(out,param_4,param_5), iVar2 == 0)) break;
        if (param_8 < uVar5) goto LAB_001005f9;
        iVar2 = EVP_DigestFinal_ex(out,param_7,(uint *)0x0);
        if (iVar2 == 0) break;
...

{
  ...
  if (iVar1 != 0) {
    if (((param_4 != (long *)0x0) && (*param_4 != 0)) &&
       (iVar1 = sskdf_common_set_ctx_params(param_1,param_4), iVar1 == 0)) {
      return 0;
    }
...

{
  ...
  if ((iVar5 != 0) &&
    ...
    if (*(long *)(param_1 + 0x28) == 0) {
      ...
      if (*(long *)(param_1 + 8) == 0) {
        if (lVar6 != 0) {
          uVar9 = SSKDF_hash_kdm(lVar6,*(undefined8 *)(param_1 + 0x28),
...
LAB_00100add:
          ...
          if (((iVar5 == 0) || (uVar8 = EVP_MAC_CTX_get_mac_size(uVar3), uVar8 == 0)) ||
             (0x40 < uVar8)) goto LAB_00100dcb;
          ...
          while( true ) {
            ...
            if (((lVar6 == 0) || (iVar5 = EVP_MAC_update(lVar6,&local_8c,4), iVar5 == 0)) ||
               ((iVar5 = EVP_MAC_update(lVar6,uVar4,uVar1), iVar5 == 0 ||
                (iVar5 = EVP_MAC_update(lVar6,uVar7,uVar2), iVar5 == 0)))) goto LAB_00100bff;
...
LAB_00100bff:
          uVar11 = 0;
LAB_00100c01:
          if (puVar10 == (undefined1 *)0x0) goto LAB_00100dcf;
LAB_00100c11:
          CRYPTO_clear_free(puVar10,uVar9,"providers/implementations/kdfs/sskdf.c",0x12d);
        }
        else {
          ...
          if (iVar5 != 0) {
            ...
            if (0 < iVar5) {
              ...
              if (puVar10 != (undefined1 *)0x0) {
                iVar5 = EVP_MAC_init(uVar3,lVar6,lVar12,0);
                if ((iVar5 != 0) &&
                   (uVar8 = EVP_MAC_CTX_get_mac_size(uVar3), local_130 = puVar10, uVar8 != 0))
                goto LAB_00100b3b;
                uVar11 = 0;
                lVar6 = 0;
                goto LAB_00100c11;
...

{
  ...
  if (((param_2 == (long *)0x0) || (*param_2 == 0)) ||
     (uVar2 = ossl_prov_ctx_get0_libctx(*param_1), *param_2 == 0)) goto LAB_001012b8;
  iVar1 = ossl_prov_macctx_load_from_params(param_1 + 1,param_2,0,0,0,uVar2);
  if (iVar1 != 0) {
    if (param_1[1] != 0) {
      uVar3 = EVP_MAC_CTX_get0_mac();
...

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  if (((param_2 == (long *)0x0) || (*param_2 == 0)) ||
     (uVar2 = ossl_prov_ctx_get0_libctx(*param_1), *param_2 == 0)) goto LAB_001014f8;
  iVar1 = ossl_prov_macctx_load_from_params(param_1 + 1,param_2,0,0,0,uVar2);
  if (iVar1 != 0) {
    if (param_1[1] != 0) {
      uVar3 = EVP_MAC_CTX_get0_mac();

...

{
  ...
  if ((((iVar2 == 4) && (iVar2 = bn_get_top(*(undefined8 *)(param_1 + 0x18)), iVar2 == 4)) &&
      (puVar3 = (ulong *)bn_get_words(*(undefined8 *)(param_1 + 0x10)),
      uVar4 = puVar3[3] ^ 0x18905f76a53755c6 |
              puVar3[2] ^ 0x79fb732b77622510 |
              puVar3[1] ^ 0x75ba95fc5fedb601 | *puVar3 ^ 0x79e730d418a9143c,
      -1 < (long)(-uVar4 | uVar4))) &&
     (puVar3 = (ulong *)bn_get_words(*(undefined8 *)(param_1 + 0x18)),
     uVar4 = puVar3[3] ^ 0x8571ff1825885d85 |
             puVar3[2] ^ 0xd2e88688dd21f325 |
             puVar3[1] ^ 0x8b4ab8e4ba19e45c | *puVar3 ^ 0xddf25357ce95560a,
     -1 < (long)(-uVar4 | uVar4))) {
...
/* WARNING: Removing unreachable block (ram,0x001024ba) */
...

{
  ...
  if (param_3 != (BIGNUM *)0x0) {
    ...
    if (b != (EC_POINT *)0x0) {
      ...
      if (((iVar12 == 0) ||
          (iVar12 = bn_set_words(*(undefined8 *)(b + 0x18),&local_c0,4), iVar12 == 0)) ||
         (iVar12 = bn_set_words(*(undefined8 *)(b + 0x20),ONE,4), iVar12 == 0)) {
        EC_POINT_free(b);
      }
      else {
        *(undefined4 *)(b + 0x28) = 1;
        ...
        if (iVar12 != 0) {
          EC_POINT_free(b);
LAB_00101e43:
          iVar12 = ecp_nistz256_is_affine_G(a);
          if (iVar12 != 0) {
...
LAB_00101ebe:
          ...
          if (0 < iVar12 * 8) {
            do {
              ...
              *(undefined8 *)(local_70 + lVar17) =
                   *(undefined8 *)(lVar15 + (long)((int)lVar17 >> 3) * 8);
              lVar17 = lVar17 + 8;
              iVar12 = bn_get_top();
          ...
          uVar16 = local_e0[0] | local_e0[1] | local_e0[2] | local_e0[3] | uStack_a8 | uStack_b8 |
                   local_b0 | local_c0;
          ...
          while( true ) {
            ...
            uVar25 = uVar19 + 7;
            uVar19 = (ushort)(CONCAT11(local_70[(uVar19 >> 3) + 1],bVar8) >> ((byte)uVar19 & 7)) &
                     0xff;
            uVar22 = uVar19 >> 7;
...
LAB_0010135f:
    ...
    local_188 = (undefined8 *)0x0;
LAB_0010137d:
    iVar12 = bn_set_words(*(undefined8 *)(param_2 + 0x10),local_e0,4);
    ...
    if (iVar12 != 0) {
      ...
      uVar19 = 0;
      if (iVar12 == 4) {
        uVar16 = puVar13[3] ^ 0xfffffffe |
                 ~puVar13[2] | puVar13[1] ^ 0xffffffff00000000 | *puVar13 ^ 1;
      ...
      if (local_1a0 == (byte *)0x0) {
        ...
        if (local_1d0 != (undefined8 *)0x0) {
          ...
          do {
            ...
            if ((iVar12 < 0x101) && (iVar12 = BN_is_negative(*local_160), iVar12 == 0)) {
              *puVar26 = *local_160;
            }
            else {
              pBVar14 = BN_CTX_get(param_7);
            ...
            while( true ) {
              ...
              *(undefined8 *)(local_170 + lVar17) =
                   *(undefined8 *)(lVar15 + (long)(iVar23 >> 3) * 8);
              lVar17 = lVar17 + 8;
            }
            if (iVar23 < 0x21) {
              uVar19 = 0x21 - iVar23;
              ...
              if (uVar19 < 8) {
                ...
                pbVar28[6] = 0;
                pbVar28[7] = 0;
                uVar19 = uVar19 + ((int)pbVar20 - (int)((ulong)(pbVar20 + 8) & 0xfffffffffffffff8))
                         & 0xfffffff8;
                if (7 < uVar19) {
                  uVar22 = 0;
                  do {
...
LAB_001022c7:
            ...
            if ((iVar12 == 0) ||
               (iVar12 = bn_copy_words(puVar7 + 8,*(undefined8 *)(*local_168 + 0x20),4), iVar12 == 0
               )) goto LAB_001022c7;
            puVar2 = puVar7 + 0xc;
          ...
          ecp_nistz256_gather_w5
                    (puVar7,puVar13,(local_1a0[0x1f] >> 6 & 1) - ((char)local_1a0[0x1f] >> 7));
          uVar16 = puVar7[1];
          uVar21 = puVar7[6];
          uVar18 = puVar7[7];
          iVar12 = 0xff;
          *local_1e0 = *puVar7;
          ...
          do {
            ...
            do {
              ...
              uVar22 = (ushort)(CONCAT11(pbVar20[(uVar19 + 1) - uVar21],*pbVar20) >> (byte)local_158
                               ) & 0x3f;
              uVar25 = uVar22 >> 5;
          ...
          do {
            ...
            ecp_nistz256_gather_w5
                      (puVar7,puVar13,
                       ((uVar22 - 1 & uVar19 | uVar25) >> 1) + (uVar25 & 1) & 0x7fffffff);
            ecp_nistz256_neg(puVar7 + 0x10,puVar1);
            uVar16 = (ulong)uVar22 - 1;
            uVar21 = -(ulong)uVar22;
...

{
  ...
  if ((((pEVar3 != (EC_POINT *)0x0) &&
       (iVar2 = bn_get_top(*(undefined8 *)(pEVar3 + 0x10)), iVar2 == 4)) &&
      (iVar2 = bn_get_top(*(undefined8 *)(pEVar3 + 0x18)), iVar2 == 4)) &&
     ((puVar4 = (ulong *)bn_get_words(*(undefined8 *)(pEVar3 + 0x10)),
      uVar5 = puVar4[3] ^ 0x18905f76a53755c6 |
              puVar4[2] ^ 0x79fb732b77622510 |
              puVar4[1] ^ 0x75ba95fc5fedb601 | *puVar4 ^ 0x79e730d418a9143c,
      -1 < (long)(-uVar5 | uVar5) &&
      (puVar4 = (ulong *)bn_get_words(*(undefined8 *)(pEVar3 + 0x18)),
      uVar5 = puVar4[3] ^ 0x8571ff1825885d85 |
              puVar4[2] ^ 0xd2e88688dd21f325 |
              puVar4[1] ^ 0x8b4ab8e4ba19e45c | *puVar4 ^ 0xddf25357ce95560a,
      -1 < (long)(-uVar5 | uVar5))))) {
    uVar1 = *(undefined8 *)(pEVar3 + 0x20);
    puVar4 = (ulong *)bn_get_words(uVar1);
    iVar2 = bn_get_top(uVar1);
    if ((iVar2 == 4) &&
       (uVar5 = puVar4[3] ^ 0xfffffffe | ~puVar4[2] | puVar4[1] ^ 0xffffffff00000000 | *puVar4 ^ 1,
       -1 < (long)(-uVar5 | uVar5))) {
      return true;
    }
  }
...
LAB_00102ad0:
  ...
  if ((param_1 == (EC_GROUP *)0x0) ||
     ...
     puVar4 == (undefined8 *)0x0)) goto LAB_00102ad0;
  *puVar4 = param_1;
  puVar4[1] = 6;
  LOCK();

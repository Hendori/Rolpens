...

{
  ...
  local_20 = *(long *)(in_FS_OFFSET + 0x28);
  uVar1 = __isoc99_sscanf(&_LC44,&_LC43,&local_5c);
  iVar2 = test_int_eq("test/http_test.c",0x124,"sscanf(exp_port, \"%d\", &exp_num)",&_LC25,uVar1,1);
  if (iVar2 != 0) {
    iVar2 = OSSL_HTTP_parse_url("https://1.2.3.4/p/q",&local_54,&local_50,&local_48,&local_40,
                                &local_58,&local_38,&local_30,&local_28);
    iVar2 = test_true("test/http_test.c",0x126,
                      "OSSL_HTTP_parse_url(url, &ssl, &user, &host, &port, &num, &path, &query, &frag)"
                      ,iVar2 != 0);
    if ((((((iVar2 == 0) ||
           (iVar2 = test_str_eq("test/http_test.c",0x128,&_LC27,"exp_host",local_48,"1.2.3.4"),
           iVar2 == 0)) ||
          (iVar2 = test_str_eq("test/http_test.c",0x129,&_LC28,"exp_port",local_40,&_LC44),
          iVar2 == 0)) ||
         ((iVar2 = test_int_eq("test/http_test.c",0x12a,&_LC52,"exp_num",local_58,local_5c),
          iVar2 == 0 ||
          (iVar2 = test_str_eq("test/http_test.c",299,&_LC29,"exp_path",local_38,&_LC53), iVar2 == 0
          )))) || ((iVar2 = test_int_eq("test/http_test.c",300,&_LC56,"exp_ssl",local_54,1),
                   iVar2 == 0 ||
                   ((iVar2 = 1, *local_50 != '\0' &&
                    (iVar2 = test_str_eq("test/http_test.c",0x12e,&_LC59,"\"user:pass\"",local_50,
                                         "user:pass"), iVar2 == 0)))))) ||
       ((*local_28 != '\0' &&
        (iVar2 = test_str_eq("test/http_test.c",0x130,&_LC62,&_LC61,local_28,&_LC60), iVar2 == 0))))
    {
      iVar2 = 0;
    }
    else if (*local_30 != '\0') {
      iVar2 = test_str_eq("test/http_test.c",0x132,"query",&_LC64,local_30,&_LC63);
    }
...
LAB_00101209:
    iVar5 = test_true("test/http_test.c",0x38,"count >= 5 && CHECK_AND_SKIP_PREFIX(hdr, \"POST \")",
                      uVar13);
    bVar4 = false;
    if (iVar5 != 0) goto LAB_00101231;
  }
  else {
    iVar5 = strncmp(local_50,"GET ",4);
    if (iVar5 != 0) {
      if (lVar9 == 4) goto LAB_00101207;
...
LAB_00101231:
    ...
    if (((((pcVar10 != (char *)0x0) &&
          (iVar5 = test_strn_eq("test/http_test.c",0x4b,"++hdr","\"HTTP/1.\"",pcVar10 + 1,7,
                                "HTTP/1.",7), iVar5 != 0)) &&
         (iVar5 = test_char_le("test/http_test.c",0x4f,&_LC78,&_LC77,0x30,(int)pcVar10[8]),
         iVar5 != 0)) &&
        ((iVar5 = test_char_le("test/http_test.c",0x4f,"*hdr++",&_LC79,(int)pcVar10[8],0x31),
         iVar5 != 0 &&
         (iVar5 = test_char_eq("test/http_test.c",0x51,"*hdr++",&_LC81,(int)pcVar10[9],0xd),
         iVar5 != 0)))) &&
       (iVar5 = test_char_eq("test/http_test.c",0x51,"*hdr++",&_LC82,(int)pcVar10[10],10),
       iVar5 != 0)) {
      pcVar12 = pcVar10 + 0xb;
          ...
          if (0 < iVar5) {
            ...
            if (!bVar4) {
              ...
              if (iVar5 == 0) {
                ...
                if (pcVar12 == (char *)0x0) goto LAB_001012c0;
                pcVar12 = pcVar12 + 2;
              }
...

{
  ...
  local_20 = *(long *)(in_FS_OFFSET + 0x28);
  uVar1 = __isoc99_sscanf(&_LC92,&_LC43,&local_5c);
  iVar2 = test_int_eq("test/http_test.c",0x124,"sscanf(exp_port, \"%d\", &exp_num)",&_LC25,uVar1,1);
  if (iVar2 != 0) {
    iVar2 = OSSL_HTTP_parse_url("http://[FF01::101]:6",&local_54,&local_50,&local_48,&local_40,
                                &local_58,&local_38,&local_30,&local_28);
    iVar2 = test_true("test/http_test.c",0x126,
                      "OSSL_HTTP_parse_url(url, &ssl, &user, &host, &port, &num, &path, &query, &frag)"
                      ,iVar2 != 0);
    if ((((((iVar2 == 0) ||
           (iVar2 = test_str_eq("test/http_test.c",0x128,&_LC27,"exp_host",local_48,"[FF01::101]"),
           iVar2 == 0)) ||
          (iVar2 = test_str_eq("test/http_test.c",0x129,&_LC28,"exp_port",local_40,&_LC92),
          iVar2 == 0)) ||
         ((iVar2 = test_int_eq("test/http_test.c",0x12a,&_LC52,"exp_num",local_58,local_5c),
          iVar2 == 0 ||
          (iVar2 = test_str_eq("test/http_test.c",299,&_LC29,"exp_path",local_38,&_LC41), iVar2 == 0
          )))) || ((iVar2 = test_int_eq("test/http_test.c",300,&_LC56,"exp_ssl",local_54,0),
                   iVar2 == 0 ||
                   ((iVar2 = 1, *local_50 != '\0' &&
                    (iVar2 = test_str_eq("test/http_test.c",0x12e,&_LC59,"\"user:pass\"",local_50,
                                         "user:pass"), iVar2 == 0)))))) ||
...

{
  ...
  local_20 = *(long *)(in_FS_OFFSET + 0x28);
  uVar1 = __isoc99_sscanf("65535",&_LC43,&local_5c);
  iVar2 = test_int_eq("test/http_test.c",0x124,"sscanf(exp_port, \"%d\", &exp_num)",&_LC25,uVar1,1);
  if (iVar2 != 0) {
    iVar2 = OSSL_HTTP_parse_url("host:65535/path",&local_54,&local_50,&local_48,&local_40,&local_58,
                                &local_38,&local_30,&local_28);
    iVar2 = test_true("test/http_test.c",0x126,
                      "OSSL_HTTP_parse_url(url, &ssl, &user, &host, &port, &num, &path, &query, &frag)"
                      ,iVar2 != 0);
    if ((((((iVar2 == 0) ||
           (iVar2 = test_str_eq("test/http_test.c",0x128,&_LC27,"exp_host",local_48), iVar2 == 0))
          || (iVar2 = test_str_eq("test/http_test.c",0x129,&_LC28,"exp_port",local_40,"65535"),
             iVar2 == 0)) ||
         ((iVar2 = test_int_eq("test/http_test.c",0x12a,&_LC52,"exp_num",local_58,local_5c),
          iVar2 == 0 ||
          (iVar2 = test_str_eq("test/http_test.c",299,&_LC29,"exp_path",local_38,"/path"),
          iVar2 == 0)))) ||
        ((iVar2 = test_int_eq("test/http_test.c",300,&_LC56,"exp_ssl",local_54,0), iVar2 == 0 ||
         ((iVar2 = 1, *local_50 != '\0' &&
          (iVar2 = test_str_eq("test/http_test.c",0x12e,&_LC59,"\"user:pass\"",local_50,"user:pass")
          , iVar2 == 0)))))) ||
       ((*local_28 != '\0' &&
        (iVar2 = test_str_eq("test/http_test.c",0x130,&_LC62,&_LC61,local_28,&_LC60), iVar2 == 0))))
    {
...
int test_http_url_userinfo_query_fragment(void)

{
  ...
  local_20 = *(long *)(in_FS_OFFSET + 0x28);
  uVar1 = __isoc99_sscanf(&_LC97,&_LC43,&local_5c);
  iVar2 = test_int_eq("test/http_test.c",0x124,"sscanf(exp_port, \"%d\", &exp_num)",&_LC25,uVar1,1);
  if (iVar2 != 0) {
    iVar2 = OSSL_HTTP_parse_url("user:pass@host/p?q#fr",&local_54,&local_50,&local_48,&local_40,
                                &local_58,&local_38,&local_30,&local_28);
    iVar2 = test_true("test/http_test.c",0x126,
                      "OSSL_HTTP_parse_url(url, &ssl, &user, &host, &port, &num, &path, &query, &frag)"
                      ,iVar2 != 0);
    if ((((((iVar2 == 0) ||
           (iVar2 = test_str_eq("test/http_test.c",0x128,&_LC27,"exp_host",local_48), iVar2 == 0))
          || (iVar2 = test_str_eq("test/http_test.c",0x129,&_LC28,"exp_port",local_40,&_LC97),
             iVar2 == 0)) ||
         ((iVar2 = test_int_eq("test/http_test.c",0x12a,&_LC52,"exp_num",local_58,local_5c),
          iVar2 == 0 ||
          (iVar2 = test_str_eq("test/http_test.c",299,&_LC29,"exp_path",local_38,&_LC99), iVar2 == 0
          )))) || ((iVar2 = test_int_eq("test/http_test.c",300,&_LC56,"exp_ssl",local_54,0),
                   iVar2 == 0 ||
                   ((iVar2 = 1, *local_50 != '\0' &&
                    (iVar2 = test_str_eq("test/http_test.c",0x12e,&_LC59,"\"user:pass\"",local_50,

...

{
  ...
  iVar5 = test_ptr("test/sm2_internal_test.c",0x2a,"fake_rand_bytes",fake_rand_bytes);
  if ((iVar5 == 0) ||
     (iVar5 = test_size_t_gt("test/sm2_internal_test.c",0x2a,"fake_rand_size",&_LC2,fake_rand_size,0
                            ), puVar4 = fake_rand_bytes, uVar3 = fake_rand_size, iVar5 == 0)) {
    uVar6 = 0;
  }
  else {
    if (param_2 != 0) {
      uVar1 = fake_rand_bytes_offset;
      puVar2 = param_1;
      do {
        while (uVar3 <= uVar1) {
          *puVar2 = *puVar4;
          if (puVar2 + 1 == param_1 + param_2) {
        ...
        fake_rand_bytes_offset = uVar1 + 1;
        puVar7 = puVar2 + 1;
        *puVar2 = puVar4[uVar1];
        uVar1 = fake_rand_bytes_offset;
        puVar2 = puVar7;
...
bool test_sm2_crypt_constprop_0
               (EC_GROUP *param_1,undefined8 param_2,char *param_3,char *param_4,undefined8 param_5)

{
  ...
  if (iVar1 != 0) {
    ...
    if (iVar1 != 0) {
      key = EC_KEY_new();
      iVar1 = test_ptr("test/sm2_internal_test.c",0x9d,&_LC18,key);
      if (iVar1 == 0) {
        ptr_01 = (void *)0x0;
        ptr_00 = (void *)0x0;
        r = (EC_POINT *)0x0;
      ...
      if (iVar1 != 0) {
        ...
        if (iVar1 != 0) {
          ...
          iVar1 = test_ptr("test/sm2_internal_test.c",0xa3,&_LC21);
          if (iVar1 != 0) {
            ...
            if (iVar1 != 0) {
              ...
              if (iVar1 != 0) {
                ...
                if (iVar1 != 0) {
                  ...
                  fake_rand_bytes = (void *)OPENSSL_hexstr2buf(param_4,0);
...
int test_sm2_sign_constprop_0
              (EC_GROUP *param_1,char *param_2,char *param_3,char *param_4,char *param_5,
...

{
  ...
  key = EC_KEY_new();
  iVar1 = test_ptr("test/sm2_internal_test.c",0x146,&_LC18,key);
  if (iVar1 != 0) {
    iVar1 = EC_KEY_set_group(key,param_1);
    ...
    if (iVar1 != 0) {
      if (param_7 == 0) {
        r = EC_POINT_new(param_1);
        iVar1 = test_ptr("test/sm2_internal_test.c",0x14d,&_LC21);
        if (iVar1 != 0) {

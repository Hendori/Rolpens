...

{
  ...
  if ((iVar2 != 0) &&
     (ptr = (undefined1 (*) [16])CRYPTO_zalloc(0x48,"providers/implementations/kdfs/pbkdf1.c",0x68),
...
LAB_00100543:
    ...
    if ((((iVar2 == 0) || (iVar2 = EVP_DigestUpdate(ctx,d_00,cnt_00), iVar2 == 0)) ||
       ...
       (iVar2 = EVP_MD_get_size(type), iVar2 < 1)) goto LAB_00100543;
    ...
    if (1 < uVar1) {
      do {
        ...
        if (((iVar4 == 0) || (iVar4 = EVP_DigestUpdate(ctx,local_88,(long)iVar2), iVar4 == 0)) ||
           (iVar4 = EVP_DigestFinal_ex(ctx,local_88,(uint *)0x0), iVar4 == 0)) goto LAB_00100543;
        uVar5 = uVar5 + 1;
      } while (uVar1 != uVar5);
    }

...

{
  ...
  local_30 = param_6;
  do {
    uVar3 = ossl_property_name(0,param_1,1);
    iVar4 = test_int_ne("test/property_test.c",0x23,"ossl_property_name(NULL, n, 1)",&_LC2,uVar3,0,
                        uVar8);
    if (iVar4 == 0) {
      uVar6 = 0;
    }
    local_70 = (long *)&stack0x00000008;
    if (0x2f < uVar7) goto LAB_001005d0;
    uVar5 = (ulong)uVar7;
    uVar7 = uVar7 + 8;
    param_1 = *(long *)((long)local_58 + uVar5);
  } while (param_1 != 0);
LAB_001005ab:
...
LAB_001005d0:
  while( true ) {
    plVar1 = local_70 + 1;
    if (*local_70 == 0) break;
    uVar8 = ossl_property_name(0,*local_70,1);
    iVar4 = test_int_ne("test/property_test.c",0x23,"ossl_property_name(NULL, n, 1)",&_LC2,uVar8,0);
    local_70 = plVar1;
    if (iVar4 == 0) {
      uVar6 = 0;
    }
...
LAB_00100843:
      ...
      *(undefined1 **)(puVar5 + -0x1cb0) = puVar5 + -0x1ca0;
      do {
        *(undefined8 *)(puVar5 + -0x1cc0) = 0x100891;
        BIO_snprintf(buf,0x32,"n=%d\n",uVar6);
        *(undefined8 *)(puVar5 + -0x1cc0) = 0x1008a6;
      ...
      *(undefined8 *)(puVar5 + -0x1cc0) = 0x1008ed;
      iVar2 = test_int_gt("test/property_test.c",599,"errors",&_LC31,iVar1,10);
      if (iVar2 != 0) {
        *(undefined8 *)(puVar5 + -0x1cc0) = 0x100917;
...
LAB_0010097e:
    ...
    do {
      ...
      iVar1 = test_true("test/property_test.c",0x1d3,
                        ...
                        ,iVar1 != 0);
      if (iVar1 == 0) {
        test_note("iteration %zd",lVar5,down_ref,0x1009d6);
        goto LAB_0010097e;
      }
      ppuVar4 = ppuVar4 + 4;
    } while (lVar5 != 6);
    ...
    do {
      ...
      if ((iVar1 == 0) ||
         (iVar1 = test_str_eq("test/property_test.c",0x1e5,"(char *)result","queries[i].expected",
                              local_50,*(undefined8 *)(puVar6 + 4)), iVar1 == 0)) goto LAB_00100c54;
      puVar6 = puVar6 + 8;
...
LAB_00100c50:
      ...
      if ((iVar1 == 0) ||
         (iVar1 = test_ptr_eq("test/property_test.c",0x1f8,"fake_prov1","&fake_provider1",
                              fake_prov1_4,&fake_provider1_3), iVar1 == 0)) goto LAB_00100c50;
      iVar1 = test_str_eq("test/property_test.c",0x1f9,"(char *)result","queries[i].expected",
                          local_50,ppuVar4[3]);
joined_r0x00100b7e:
      if (iVar1 == 0) goto LAB_00100c50;
      lVar5 = lVar5 + 1;
      ppuVar4 = ppuVar4 + 4;
      ossl_property_free(0);
    } while (lVar5 != 0xb);
...
LAB_00100c54:
      ...
      if (((iVar1 == 0) ||
         ...
         (iVar1 = test_str_eq("test/property_test.c",0x219,"(char *)result","queries[i].expected",
                              local_50,ppuVar7[3]), iVar1 == 0)) goto LAB_00100dd8;
LAB_00100d1a:
      lVar5 = lVar5 + 1;
      ppuVar7 = ppuVar7 + 4;
      ossl_property_free(0);
    ...
    if (iVar2 != 0) {
      ...
      do {
        ...
        iVar2 = test_true("test/property_test.c",0x189,
                          ...
                          ,iVar2 != 0);
        if (iVar2 == 0) {
          test_note("iteration %zd",lVar8,down_ref,0x100e98);
          goto LAB_00100e56;
        }
        puVar5 = puVar5 + 6;
      } while (lVar8 != 4);
      ...
      while( true ) {
        ...
        puVar6 = (&PTR__LC55_00103c10)[uVar4 * 3];
        lVar8 = lVar1;
      }
...

{
  ...
  if (iVar3 != 0) {
    ...
    if (iVar3 != 0) {
      uVar8 = 0;
      lVar1 = (long)param_1 * 0x18;
      uVar7 = ossl_parse_property(0,*(undefined8 *)(parser_tests + lVar1),(long)param_1 * 3,0x1012ac
                                 );

...
undefined8 * kdf_scrypt_newctx(undefined8 param_1)
  ...
  if (iVar1 != 0) {
    ...
    if (ptr != (undefined8 *)0x0) {
      *ptr = param_1;
      ...
      lVar3 = EVP_KDF_fetch(uVar2,"SCRYPT",0);
      if (lVar3 != 0) {
...

{
  ...
  uVar1 = ossl_prov_ctx_get0_libctx(param_2);
  lVar2 = EVP_KDF_fetch(uVar1,&_LC3,0);
  if (lVar2 != 0) {
    uVar1 = EVP_KDF_settable_ctx_params(lVar2);
    EVP_KDF_free(lVar2);
    return uVar1;
...
undefined8 * kdf_tls1_prf_newctx(undefined8 param_1)

{
  ...
  if (iVar1 != 0) {
    ...
    if (ptr != (undefined8 *)0x0) {
      *ptr = param_1;
      uVar2 = ossl_prov_ctx_get0_libctx(param_1);
      lVar3 = EVP_KDF_fetch(uVar2,"TLS1-PRF",0);
      if (lVar3 != 0) {
        uVar2 = EVP_KDF_CTX_new(lVar3);
        ptr[1] = uVar2;
        EVP_KDF_free(lVar3);
...
undefined8 * kdf_hkdf_newctx(undefined8 param_1)

{
  ...
  if (iVar1 != 0) {
    ...
    if (ptr != (undefined8 *)0x0) {
      *ptr = param_1;
      uVar2 = ossl_prov_ctx_get0_libctx(param_1);
      lVar3 = EVP_KDF_fetch(uVar2,&_LC3,0);
      if (lVar3 != 0) {
        uVar2 = EVP_KDF_CTX_new(lVar3);
        ptr[1] = uVar2;
        EVP_KDF_free(lVar3);

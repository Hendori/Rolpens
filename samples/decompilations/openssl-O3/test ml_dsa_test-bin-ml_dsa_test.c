...

{
  ...
  *puVar5 = local_e8;
  ...
  iVar2 = test_ptr("test/ml_dsa_test.c",0x49,"ctx = EVP_PKEY_CTX_new_from_name(lib_ctx, name, NULL)"
                   ,ctx);
  if (iVar2 != 0) {
    uVar3 = EVP_PKEY_fromdata_init(ctx);
    iVar2 = test_int_eq("test/ml_dsa_test.c",0x4a,"EVP_PKEY_fromdata_init(ctx)",&_LC4,uVar3,1);
    if (iVar2 != 0) {
      uVar3 = EVP_PKEY_fromdata(ctx,param_1,uVar6,&local_b8);
      iVar2 = test_int_eq("test/ml_dsa_test.c",0x4b,
                          "EVP_PKEY_fromdata(ctx, pkey, selection, params)","expected",uVar3,param_7
                         );
      bVar7 = iVar2 != 0;
      goto LAB_00100121;
    }
...

{
  ...
  if (iVar1 != 0) {
    *ptr = DAT_001048e0;
    ...
    ptr[0x1f7] = DAT_00105898;
    puVar4 = (undefined8 *)((long)&DAT_001048e0 - lVar2);
...

{
  ...
  puVar5 = &local_90;
  OSSL_PARAM_construct_int(&local_f8,"message-encoding",&DAT_0010d340);
  local_b8 = local_f8;
  uStack_b0 = uStack_f0;
  local_98 = local_d8;
  local_a8 = local_e8;
  ...
  if (_DAT_0010d330 != 0) {
    puVar5 = local_68;
    OSSL_PARAM_construct_octet_string(&local_f8,"context-string",_DAT_0010d330,_DAT_0010d338);
    local_70 = local_d8;
    local_90 = local_f8;
    uStack_88 = uStack_f0;
    local_80 = local_e8;
  ...
  *puVar5 = local_f8;
  ...
  if (iVar1 != 0) {
    ...
    uVar3 = test_int_eq("test/ml_dsa_test.c",0x1da,
                        ...
                        ,&_LC4,uVar2,1);
    if ((uVar3 == 0) || (uVar3 = 1, ptr = (void *)0x0, _DAT_0010d344 == 0)) goto LAB_0010087f;
    uVar2 = EVP_DigestSign(uVar4,0,&local_c0,sig_params,DAT_0010d328);
    ...
    if (iVar1 != 0) {
      ...
      if (iVar1 != 0) {
        local_c0 = local_c0 + -1;
        uVar2 = EVP_DigestSign(uVar4,ptr,&local_c0,sig_params,DAT_0010d328);
        uVar6 = 0x100b59;
        ...
        if (iVar1 != 0) {
          ...
          uVar3 = test_int_eq("test/ml_dsa_test.c",0x1e8,
                              ...
                              ,&_LC4,uVar2,1);
          if (uVar3 == 0) goto LAB_0010087f;
          uVar2 = EVP_DigestSign(uVar4,ptr,&local_c0,sig_params,DAT_0010d328,uVar6);
          ...
          if (iVar1 != 0) {
            ...
            if ((int)uVar6 != 0) {
              ...
              iVar1 = test_int_eq("test/ml_dsa_test.c",0x1ef,
                                  ...
                                  ,&_LC4,uVar2,1);
              if (iVar1 != 0) {
                uVar2 = EVP_DigestVerify(uVar4,ptr,local_c0,sig_params,DAT_0010d328);
...

{
  ...
  if (iVar2 == 0) {
    ...
    lVar8 = lVar6 * 0x28;
    puVar9 = &local_90;
    OSSL_PARAM_construct_int(&local_f8,"message-encoding",&DAT_0010d340 + lVar8);
    local_b8 = local_f8;
    uStack_b0 = uStack_f0;
    local_98 = local_d8;
    local_a8 = local_e8;
    uStack_a0 = uStack_e0;
    if (*(long *)(&DAT_0010d330 + lVar8) != 0) {
      puVar9 = local_68;
      OSSL_PARAM_construct_octet_string
                (&local_f8,"context-string",*(long *)(&DAT_0010d330 + lVar8),
                 *(undefined8 *)(&DAT_0010d338 + lVar8));
      local_70 = local_d8;
      local_90 = local_f8;
      uStack_88 = uStack_f0;
      local_80 = local_e8;
    ...
    *puVar9 = local_f8;
    ...
    if (iVar2 == 0) {
      ...
      if (iVar2 != 0) {
        ...
        uVar5 = *(undefined4 *)(&DAT_0010d344 + lVar6 * 0x28);
        ...
        if (*(int *)(&DAT_0010d344 + lVar6 * 0x28) == 0) {
          sig = (uchar *)0x0;
          ctx_00 = (EVP_PKEY_CTX *)0x0;
          uVar4 = 1;
          goto LAB_0010100d;
        }
        iVar2 = EVP_PKEY_sign(ctx,(uchar *)0x0,&local_c0,*ppuVar1,(&DAT_0010d328)[lVar6 * 5]);
        ...
        if (iVar2 != 0) {
          ...
          if (iVar2 != 0) {
            local_c0 = local_c0 - 1;
            iVar2 = EVP_PKEY_sign(ctx,sig,&local_c0,*ppuVar1,(&DAT_0010d328)[lVar6 * 5]);
...

{
  ...
  if (iVar2 == 0) {
    ...
    uVar5 = 0;
    ctx = (EVP_PKEY_CTX *)EVP_PKEY_CTX_new_from_pkey(lib_ctx,local_a0,0,0x101515);
        ...
        if (iVar1 != 0) {
          ...
          if (iVar1 != 0) {
            ...
            if (iVar1 != 0) {
              ...
              ptr_00 = (void *)0x0;
              if ((int)uVar3 == 0) goto LAB_00101748;

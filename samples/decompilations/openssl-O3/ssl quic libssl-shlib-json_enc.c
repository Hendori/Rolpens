      ...
      if (iVar2 == 0) {
        ...
        while( true ) {
          ...
          if (*(ulong *)(param_1 + 0x38) == uVar4) {
            ...
            if (uVar4 != 0) {
              do {
                iVar2 = BIO_write_ex(*(undefined8 *)(param_1 + 0x28),
                                     *(long *)(param_1 + 0x30) + uVar8,uVar4 - uVar8,&local_48);
                if (iVar2 == 0) {
                  memmove(*(void **)(param_1 + 0x30),
                          (void *)((long)*(void **)(param_1 + 0x30) + uVar8),
                          *(long *)(param_1 + 0x40) - uVar8);
                  param_1[0x40] = 0;
                  param_1[0x41] = 0;
                  param_1[0x42] = 0;
                  param_1[0x43] = 0;
...
LAB_0010050f:
      ...
      if (uVar3 != 0) {
        do {
          iVar1 = BIO_write_ex(*(undefined8 *)(param_1 + 0x28),*(long *)(param_1 + 0x30) + uVar4,
                               uVar3 - uVar4,&local_38);
          if (iVar1 == 0) {
            memmove(*(void **)(param_1 + 0x30),(void *)((long)*(void **)(param_1 + 0x30) + uVar4),
...
LAB_00100687:
    ...
    if (*(ulong *)(param_1 + 0x38) == uVar4) {
      ...
      if (uVar4 != 0) {
        do {
          iVar2 = BIO_write_ex(*(undefined8 *)(param_1 + 0x28),*(long *)(param_1 + 0x30) + uVar5,
                               uVar4 - uVar5,&local_38);
          if (iVar2 == 0) {
            memmove(*(void **)(param_1 + 0x30),(void *)((long)*(void **)(param_1 + 0x30) + uVar5),
...

{
  ...
  else if ((*(byte *)(*(long *)(param_1 + 8) + lVar2) >> (bVar4 - 1 & 0x1f) & 1) != 0)
  goto LAB_0010095f;
  if (param_1[6] == 1) {
LAB_0010095f:
    param_1[4] = 1;
...

{
  ...
  if (param_1[5] == 0) {
    ...
    uVar6 = param_1[5] - 1;
LAB_00100ba2:
    if ((*(byte *)(*(long *)(param_1 + 8) + lVar4) >> (uVar6 & 0x1f) & 1) == 0) {
      bVar1 = param_1[6];
      if (bVar1 == 2) {
        iVar3 = ossl_json_in_error(param_1);
        if (iVar3 == 0) {
...
LAB_00100d91:
                ...
                if ((byte)(bVar1 + 0x20) < 0x10) {
                  if (uVar5 < 3) {
LAB_00100ef0:
                    local_44 = (bVar7 >> 4) + 0x57;
                    goto LAB_00100d98;
                  }
                  bVar7 = *(byte *)((long)param_2 + 1);
                  if ((0x3f < (byte)(bVar7 + 0x80)) ||
                     (0x3f < (byte)(*(byte *)((long)param_2 + 2) + 0x80))) goto LAB_00100d91;
                  if (bVar1 == 0xe0) {
                    if (bVar7 < 0xa0) {
                      bVar7 = 0;
                      local_44 = 'e';
...
LAB_00100f8f:
                  ...
                  if (((0x3f < (byte)(bVar2 + 0x80)) ||
                      (0x3f < (byte)(*(byte *)((long)param_2 + 2) + 0x80))) ||
                     (0x3f < (byte)(*(byte *)((long)param_2 + 3) + 0x80))) goto LAB_00100ef0;
                  if (bVar1 == 0xf0) {
                    if (bVar2 < 0x90) {
                      bVar7 = 0;
                      local_44 = 'f';
...
LAB_00100e65:
      ...
      if (iVar3 == 0) {
        ...
        if (((*param_1 & 2) != 0) && (iVar3 = ossl_json_in_error(param_1), iVar3 == 0)) {
...
LAB_001012ec:
        if ((*(byte *)(*(long *)(param_1 + 2) + lVar4) >> (uVar5 & 0x1f) & 1) == 0)
        goto LAB_00101448;
        iVar3 = ossl_json_in_error(param_1);
        if (iVar3 == 0) {
          json_write_char_part_0(param_1,0x2c);
...
LAB_00101591:
    ...
    if (((bVar2) && (iVar3 = ossl_json_in_error(param_1), iVar3 == 0)) &&
       (iVar3 = ossl_json_in_error(param_1), iVar3 == 0)) {
      if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
        json_write_char_part_0(param_1,0x22);
        return;
      }
...
void ossl_json_f64(double param_1,byte *param_2)

{
  ...
  if (param_2[6] == 1) {
LAB_00101824:
    if (((double)((ulong)param_1 & __LC15) <= __LC16) && (!NAN(param_1))) {
    ...
    if (param_2[5] == 0) {
      ...
      if (((*param_2 & 1) != 0) && (iVar1 = ossl_json_in_error(param_2), iVar1 == 0)) {
      ...
      uVar3 = param_2[5] - 1;
LAB_001017ae:
      if ((*(byte *)(*(long *)(param_2 + 8) + lVar2) >> (uVar3 & 0x1f) & 1) == 0) goto LAB_00101880;
      iVar1 = ossl_json_in_error(param_2);
      if (iVar1 == 0) {
...
switchD_001019fb_caseD_b:
            if ((byte)(bVar1 + 0x3e) < 0x1e) {
              ...
              if ((byte)(bVar1 + 0x20) < 0x10) {
                ...
                bVar2 = *(byte *)((long)param_2 + 1);
                if ((0x3f < (byte)(bVar2 + 0x80)) ||
                   (0x3f < (byte)(*(byte *)((long)param_2 + 2) + 0x80))) goto LAB_00101c16;
                if (bVar1 == 0xe0) {
...
LAB_00101d08:
              ...
              if (((0x3f < (byte)(bVar2 + 0x80)) ||
                  (0x3f < (byte)(*(byte *)((long)param_2 + 2) + 0x80))) ||
                 (0x3f < (byte)(*(byte *)((long)param_2 + 3) + 0x80))) goto LAB_00101b42;
              if (bVar1 == 0xf0) {
                if (bVar2 < 0x90) {
                  bVar3 = 0;
                  local_44 = 'f';
...
switchD_00101e0c_caseD_b:
              if ((byte)(bVar1 + 0x3e) < 0x1e) {
                ...
                if ((byte)(bVar1 + 0x20) < 0x10) {
                  ...
                  bVar2 = *(byte *)((long)param_2 + 1);
                  if ((0x3f < (byte)(bVar2 + 0x80)) ||
                     (0x3f < (byte)(*(byte *)((long)param_2 + 2) + 0x80))) goto LAB_0010202e;
                  if (bVar1 == 0xe0) {
...
LAB_00102130:
                ...
                if (((0x3f < (byte)(bVar2 + 0x80)) ||
                    (0x3f < (byte)(*(byte *)((long)param_2 + 2) + 0x80))) ||
                   (0x3f < (byte)(*(byte *)((long)param_2 + 3) + 0x80))) goto LAB_00101f5a;
                if (bVar1 == 0xf0) {
                  if (bVar2 < 0x90) {
                    bVar3 = 0;
                    local_44 = 'f';

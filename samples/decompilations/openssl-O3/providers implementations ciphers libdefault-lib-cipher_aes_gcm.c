...
long aes256gcm_newctx(undefined8 param_1)

{
  ...
  if (iVar1 != 0) {
    ...
    if (lVar2 != 0) {
      uVar3 = ossl_prov_aes_hw_gcm(0x100);
...
long aes192gcm_newctx(undefined8 param_1)

{
  ...
  if (iVar1 != 0) {
    lVar2 = CRYPTO_zalloc(0x3c0,"providers/implementations/ciphers/cipher_aes_gcm.c",0x1e);
    if (lVar2 != 0) {
      uVar3 = ossl_prov_aes_hw_gcm(0xc0);
...
long aes128gcm_newctx(undefined8 param_1)

{
  ...
  if (iVar1 != 0) {
    lVar2 = CRYPTO_zalloc(0x3c0,"providers/implementations/ciphers/cipher_aes_gcm.c",0x1e);
    if (lVar2 != 0) {
      uVar3 = ossl_prov_aes_hw_gcm(0x80);

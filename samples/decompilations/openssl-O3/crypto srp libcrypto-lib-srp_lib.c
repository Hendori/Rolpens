...
BIGNUM * SRP_Calc_u_ex(BIGNUM *param_1,BIGNUM *param_2,BIGNUM *param_3,undefined8 param_4,
                      undefined8 param_5)

{
  ...
  if (((param_1 == param_3) || (iVar2 = BN_ucmp(param_1,param_3), iVar2 < 0)) &&
     ((param_2 == param_3 || (iVar2 = BN_ucmp(param_2,param_3), iVar2 < 0)))) {
    iVar2 = iVar1 + 0xe;
    if (-1 < iVar1 + 7) {
      iVar2 = iVar1 + 7;
    }
    iVar2 = iVar2 >> 3;
    data = CRYPTO_malloc(iVar2 * 2,"crypto/srp/srp_lib.c",0x2a);
    if (data == (void *)0x0) goto LAB_00100205;
    iVar1 = BN_bn2binpad(param_1,data,iVar2);
    if (iVar1 < 0) {
LAB_00100310:
      pBVar3 = (BIGNUM *)0x0;
      ...
      pBVar3 = (BIGNUM *)0x0;
      iVar1 = BN_bn2binpad(param_2,(long)iVar2 + (long)data,iVar2);
      if (-1 < iVar1) {
        iVar1 = EVP_Digest(data,(long)(iVar2 * 2),local_58,(uint *)0x0,type,(ENGINE *)0x0);
        if (iVar1 == 0) goto LAB_00100310;
        pBVar3 = BN_bin2bn(local_58,0x14,(BIGNUM *)0x0);
      }
    }
  }
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  iVar1 = BN_num_bits(param_3);
  type = (EVP_MD *)EVP_MD_fetch(0,&_LC0,0);
  if (type == (EVP_MD *)0x0) {
    pBVar3 = (BIGNUM *)0x0;
    goto LAB_001003ba;
  }
  if (((param_1 == param_3) || (iVar2 = BN_ucmp(param_1,param_3), iVar2 < 0)) &&
    ...
    iVar2 = iVar2 >> 3;
    data = CRYPTO_malloc(iVar2 * 2,"crypto/srp/srp_lib.c",0x2a);
    if (data == (void *)0x0) goto LAB_0010039d;
    iVar1 = BN_bn2binpad(param_1,data,iVar2);
    if (iVar1 < 0) {
LAB_001004a0:
      pBVar3 = (BIGNUM *)0x0;
...
LAB_001009a0:
        ...
        type = (EVP_MD *)EVP_MD_fetch(param_4,&_LC0,param_5);
        if (type == (EVP_MD *)0x0) goto LAB_001009a0;
...

{
  ...
  if (param_2 != (BIGNUM *)0x0) {
    ppuVar2 = &PTR_ossl_bn_generator_19_00100fa8;
    lVar3 = 0;
    do {
...

{
  ...
  if (iVar1 == 0) {
    ...
    iVar1 = strcmp(PTR_DAT_00100fb8,param_1);
    if (iVar1 == 0) {
      lVar2 = 1;
    }
    else {
      iVar1 = strcmp(PTR_DAT_00100fd0,param_1);
      if (iVar1 == 0) {
        lVar2 = 2;
      }
      else {
        iVar1 = strcmp(PTR_DAT_00100fe8,param_1);
        if (iVar1 == 0) {
          lVar2 = 3;
        }
        else {
          iVar1 = strcmp(PTR_DAT_00101000,param_1);
          if (iVar1 == 0) {
            lVar2 = 4;
          }
          else {
            iVar1 = strcmp(PTR_DAT_00101018,param_1);
            if (iVar1 == 0) {
              lVar2 = 5;
            }
            else {
              iVar1 = strcmp(PTR_DAT_00101030,param_1);
              if (iVar1 != 0) {
                return (undefined **)0x0;
              }
              lVar2 = 6;

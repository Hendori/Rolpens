  ...
  if (param_1 != (int *)0x0) {
    ...
    do {
      if ((int)lVar2 < 0x10) {
        ...
        if (((pvVar4 != (void *)0x0) &&
            (pvVar4 = *(void **)((long)pvVar4 + lVar2 * 8), pvVar4 != (void *)0x0)) &&
           (iVar3 < *param_1 + -1)) {
          iVar3 = iVar3 + 1;
          lVar1 = (long)iVar3;
          local_e8[lVar1] = 0;
...

{
  ...
  do {
    if (iVar1 < 0x10) {
      ...
      if ((pvVar4 != (void *)0x0) &&
         (pvVar4 = *(void **)((long)pvVar4 + (long)iVar1 * 8), pvVar4 != (void *)0x0)) {
        if (iVar2 < *param_1 + -1) {
          iVar2 = iVar2 + 1;
          lVar3 = (long)iVar2;
          local_f8[lVar3] = 0;
  ...
  if (param_1 != (int *)0x0) {
    ...
    if (param_2 == (code *)0x0) {
      ...
      do {
        ...
        while (((lVar3 != 0 && (lVar3 = *(long *)(lVar3 + lVar5 * 8), lVar3 != 0)) &&
               (iVar4 < *param_1 + -1))) {
          iVar4 = iVar4 + 1;
          lVar6 = (long)iVar4;
          local_108[iVar4] = 0;
    ...
    do {
      if ((int)uVar2 < 0x10) {
        ...
        if ((lVar3 != 0) && (lVar3 = *(long *)(lVar3 + uVar2 * 8), lVar3 != 0)) {

...
LAB_00101248:
  ...
  if (iVar1 != 0) {
    ...
    if (iVar1 != 0) {
      ...
      if ((iVar1 != 0) && (iVar1 = BN_bn2nativepad(app_p3,bignumbin,0x1000), -1 < iVar1)) {
      ...
      if (((iVar1 == 0) ||
          ...
          iVar1 == 0)) ||
         (iVar1 = test_double_eq(app_p2,_LC46,"test/params_test.c",0x1cd,"app_p2","app_p2_init"),
         iVar1 == 0)) {
LAB_0010109d:
        cVar5 = true;
      }
      ...
      if ((((iVar1 == 0) ||
           ...
           iVar1 == 0)) ||
          ((iVar1 = test_double_eq(*(undefined8 *)(ptr + 2),_LC38,"test/params_test.c",0x1ea,
      ...
      if (iVar1 != 0) {
        ...
        if (((iVar1 != 0) &&
            ...
            iVar1 != 0)) &&
           (iVar1 = test_double_eq(app_p2,_LC46,"test/params_test.c",0x200,"app_p2","app_p2_init"),
           iVar1 != 0)) {
          lVar3 = OSSL_PARAM_locate(param_1,&_LC1);
              ...
              if (((iVar1 != 0) &&
                ...
                if (((iVar1 != 0) &&
                   ...
                   ((iVar1 = test_str_eq("test/params_test.c",0x20c,"app_p6","app_p6_init",app_p6,
                                         "Cookie"), iVar1 != 0 &&
                    (iVar1 = test_char_eq("test/params_test.c",0x20d,"foo[0]","app_foo_init",
                                          (int)foo,0x7a), iVar1 != 0)))) {
                  uVar4 = OSSL_PARAM_locate(param_1,&_LC5);

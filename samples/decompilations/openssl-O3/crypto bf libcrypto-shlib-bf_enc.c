...
LAB_00100b3c:
  *(ulong *)ivec =
       (((((((ulong)(uVar6 & 0xff) << 8 | (ulong)(uVar16 & 0xff)) << 8 | (ulong)(uVar15 & 0xff)) <<
           8 | (ulong)uVar9) << 8 | (ulong)(uVar8 & 0xff)) << 8 | uVar4 & 0xff) << 8 |
       (ulong)(uVar14 & 0xff)) << 8 | (ulong)uVar11;

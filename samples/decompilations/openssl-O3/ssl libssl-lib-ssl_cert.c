    ...
    if (0 < (int)lVar2) {
      while (pXVar3 = PEM_read_bio_X509(bp,&local_38,(undefined1 *)0x0,(void *)0x0),
        ...
        if ((pXVar4 == (X509_NAME *)0x0) ||
           (pXVar4 = X509_NAME_dup(pXVar4), pXVar4 == (X509_NAME *)0x0)) goto LAB_001002c0;
...

{
  ...
  if ((param_2 == (stack_st_X509 *)0x0) || (iVar2 = OPENSSL_sk_num(param_2), iVar2 == 0)) {
    return 0;
  }
  puVar1 = *(undefined8 **)((long)param_1 + 8);
      ...
      if (iVar1 == 1) {
        ...
        if (lVar5 != 0) {
          do {
            ...
            while( true ) {
              if ((iVar1 != 0) || (iVar1 = OSSL_STORE_error(lVar5), iVar1 != 0)) {
                ERR_clear_error();
                uVar9 = 1;
                goto LAB_00102128;
              }
              ...
              if (iVar1 == 5) {
                ...
                if (((pXVar7 == (X509 *)0x0) ||
                    (pXVar8 = X509_get_subject_name(pXVar7), pXVar8 == (X509_NAME *)0x0)) ||
                   (pXVar8 = X509_NAME_dup(pXVar8), pXVar8 == (X509_NAME *)0x0)) {
LAB_00102200:
                  uVar9 = 0;
...

{
  ...
  if (*plVar11 == 0) {
    ...
    ctx = (X509_STORE *)0x0;
LAB_001023d8:
    if ((param_3 & 4) == 0) goto LAB_001023e4;
  }
  else {
    if ((param_3 & 4) == 0) {
...
LAB_001028e0:
    ...
    if ((((param_4 < iVar1) || ((*(byte *)(param_6 + 0x20) & 4) != 0)) ||
       ...
       ((0xa0 < iVar1 && ((*(uint *)(param_6 + 0x28) & 2) != 0)))) goto LAB_001028e0;

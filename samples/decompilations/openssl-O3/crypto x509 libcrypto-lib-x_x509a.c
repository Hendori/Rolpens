...

{
  ...
  if (x != (X509 *)0x0) {
    ...
    if (pXVar2 == (X509_CERT_AUX *)0x0) {
      ...
      if (pXVar2 == (X509_CERT_AUX *)0x0) goto LAB_0010033e;
      psVar3 = pXVar2->trust;
    }
    else {
      psVar3 = pXVar2->trust;
    ...
    if (psVar3 == (stack_st_ASN1_OBJECT *)0x0) {
      ...
      pXVar2->trust = psVar3;
      if (psVar3 == (stack_st_ASN1_OBJECT *)0x0) goto LAB_0010033e;
    }
    if ((obj == (ASN1_OBJECT *)0x0) || (iVar1 = OPENSSL_sk_push(psVar3,obj), iVar1 != 0)) {
      return 1;
    }
  }
LAB_0010033e:
...

{
  ...
  if (x != (X509 *)0x0) {
    ...
    if (pXVar3 == (X509_CERT_AUX *)0x0) {
      pXVar3 = X509_CERT_AUX_new();
      x[1].altname = (stack_st_GENERAL_NAME *)pXVar3;
      if (pXVar3 == (X509_CERT_AUX *)0x0) goto LAB_00100408;
    }
    ...
    if (psVar2 == (stack_st_ASN1_OBJECT *)0x0) {
      ...
      if (psVar2 == (stack_st_ASN1_OBJECT *)0x0) goto LAB_00100408;
    }

...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if ((((param_2 == (uchar *)0x0 || param_3 == (ulong *)0x0) || (param_1 == 0)) ||
      (uVar2 = *param_3, uVar2 == 0)) || ((param_6 == (uchar *)0x0 || (param_7 == 0)))) {
    ERR_new();
    uVar11 = 0x48a;
LAB_001013e1:
    ERR_set_debug("crypto/hpke/hpke.c",uVar11,"OSSL_HPKE_seal");
    ERR_set_error(0xf,0x80106,0);
  }
  else {
    if (*(int *)(param_1 + 0x40) != 0) {
    ...
    if (lVar3 == -1) {
      ...
      if ((*(long *)(param_1 + 0x60) == 0) ||
         (puVar4 = *(ulong **)(param_1 + 0x70), puVar4 == (ulong *)0x0)) {
        ERR_new();
        uVar11 = 0x497;
        goto LAB_001013e1;
      }
      ...
      if ((ulong)((long)local_68 - ((long)puVar4 + 1)) < 7) {
        ...
        uVar1 = *puVar4;
        uVar5 = (ulong)CONCAT13(bVar7,CONCAT12(bVar9,(ushort)bVar8 |
                                                     (ushort)((ulong)lVar3 >> 0x28) & 0xff00)) <<
                0x20 ^ uVar1;
        local_68[0] = (uchar)uVar1;
        local_68[1] = (uchar)(uVar1 >> 8);
        local_68[2] = (uchar)(uVar1 >> 0x10);
        local_68[3] = (uchar)(uVar1 >> 0x18);
        bStack_64 = (byte)(uVar5 >> 0x20);
        bStack_63 = (byte)(uVar5 >> 0x28);
        bStack_62 = (byte)(uVar5 >> 0x30);
        bStack_61 = (byte)(uVar5 >> 0x38);
        uVar13 = CONCAT13(bStack_5d,
                          CONCAT12(bVar6,(ushort)((ulong)lVar3 >> 0x18) & 0xff |
                                         (ushort)((ulong)lVar3 >> 8) & 0xff00)) ^ (uint)puVar4[1];
      ...
      if ((uVar1 < uVar2) && (param_7 <= uVar2 - uVar1)) {
        ...
        if (ctx != (EVP_CIPHER_CTX *)0x0) {
          iVar10 = EVP_EncryptInit_ex(ctx,*(EVP_CIPHER **)(param_1 + 0x38),(ENGINE *)0x0,
                                      (uchar *)0x0,(uchar *)0x0);
          if (iVar10 == 1) {
            iVar10 = EVP_CIPHER_CTX_ctrl(ctx,9,*(int *)(param_1 + 0x78),(void *)0x0);
            if (iVar10 == 1) {
              iVar10 = EVP_EncryptInit_ex(ctx,(EVP_CIPHER *)0x0,(ENGINE *)0x0,
                                          *(uchar **)(param_1 + 0x60),local_68);
              if (iVar10 == 1) {
                if (((param_5 == 0) || (param_4 == (uchar *)0x0)) ||
                   (iVar10 = EVP_EncryptUpdate(ctx,(uchar *)0x0,&local_6c,param_4,(int)param_5),
                   iVar10 == 1)) {
...

{
  ...
  if ((((param_2 == (uchar *)0x0 || param_3 == (ulong *)0x0) || (param_1 == 0)) || (*param_3 == 0))
    ...
    uVar10 = 0x4b4;
LAB_001019f1:
    ERR_set_debug("crypto/hpke/hpke.c",uVar10,"OSSL_HPKE_open");
    ERR_set_error(0xf,0x80106,0);
  }
  else {
    ...
    if (lVar2 == -1) {
      ...
      if ((*(long *)(param_1 + 0x60) == 0) ||
         (puVar3 = *(ulong **)(param_1 + 0x70), puVar3 == (ulong *)0x0)) {
        ERR_new();
        uVar10 = 0x4c1;
        goto LAB_001019f1;
      }
      if (*(long *)(param_1 + 0x78) == 0xc) {
        ...
        if ((ulong)((long)local_50 - ((long)puVar3 + 1)) < 7) {
          ...
          local_50[1] = *(undefined1 *)((long)puVar3 + 1);
          local_50[2] = *(undefined1 *)((long)puVar3 + 2);
          local_50[3] = *(undefined1 *)((long)puVar3 + 3);
          ...
          uVar1 = *puVar3;
          uVar4 = (ulong)CONCAT13(bVar6,CONCAT12(bVar8,(ushort)bVar7 |
                                                       (ushort)((ulong)lVar2 >> 0x28) & 0xff00)) <<
                  0x20 ^ uVar1;
          local_50[0] = (uchar)uVar1;
          local_50[1] = (uchar)(uVar1 >> 8);
          local_50[2] = (uchar)(uVar1 >> 0x10);
          local_50[3] = (uchar)(uVar1 >> 0x18);
          bStack_4c = (byte)(uVar4 >> 0x20);
          bStack_4b = (byte)(uVar4 >> 0x28);
          bStack_4a = (byte)(uVar4 >> 0x30);
          bStack_49 = (byte)(uVar4 >> 0x38);
          uVar12 = CONCAT13(bStack_45,
                            CONCAT12(bVar5,(ushort)((ulong)lVar2 >> 0x18) & 0xff |
                                           (ushort)((ulong)lVar2 >> 8) & 0xff00)) ^ (uint)puVar3[1];
        ...
        if ((uVar1 < param_7) && (param_7 - uVar1 <= *param_3)) {
          ctx = EVP_CIPHER_CTX_new();
          if (ctx != (EVP_CIPHER_CTX *)0x0) {
            iVar9 = EVP_DecryptInit_ex(ctx,*(EVP_CIPHER **)(param_1 + 0x38),(ENGINE *)0x0,
                                       (uchar *)0x0,(uchar *)0x0);
            if (iVar9 == 1) {
              iVar9 = EVP_CIPHER_CTX_ctrl(ctx,9,*(int *)(param_1 + 0x78),(void *)0x0);
              if (iVar9 == 1) {
                iVar9 = EVP_DecryptInit_ex(ctx,(EVP_CIPHER *)0x0,(ENGINE *)0x0,
                                           *(uchar **)(param_1 + 0x60),local_50);
                if (iVar9 == 1) {
                  if (((param_5 == 0) || (param_4 == (uchar *)0x0)) ||
                     (iVar9 = EVP_DecryptUpdate(ctx,(uchar *)0x0,&local_54,param_4,(int)param_5),
                     iVar9 == 1)) {
                    local_68 = &local_54;

...
void log_packet(undefined8 param_1,byte *param_2,undefined8 param_3,long *param_4,long param_5,
               undefined8 param_6)
...

{
  ...
  iVar1 = ossl_qlog_event_try_begin
                    (param_1,1,"connectivity","connection_started","connectivity:connection_started"
                    );
  if (iVar1 == 0) {
    return;
  }
...

{
  ...
  iVar1 = ossl_qlog_event_try_begin
                    (param_1,2,"connectivity","connection_state_updated",
  ...
  if (param_3 == 3) {
    ...
    if (param_3 == 1) {
      ...
      if ((param_5 == 0) && (pcVar2 = "handshake_complete", param_4 == 0)) {
        pcVar2 = "attempted";
      }
    }
    else {
...

{
  ...
  iVar2 = ossl_qlog_event_try_begin
                    (param_1,3,"connectivity","connection_closed","connectivity:connection_closed");
  if (iVar2 == 0) {
...
LAB_00100ea3:
  ossl_qlog_str_len(param_1,"reason",param_2[2],param_2[3]);
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
    ossl_qlog_event_end(param_1);
    return;
  }
...

{
  ...
  iVar1 = ossl_qlog_event_try_begin
                    (param_1,6,"transport","packet_received","transport:packet_received");
  if (iVar1 == 0) {
    return;
  }
  log_packet(param_1,param_2,param_3,param_4,param_5,param_6);

      ...
      *pcVar2 = '\0';
      ...
      if (iVar1 == -2) {
        *(char **)(param_1 + 0x9a8) = "PKEY_CTRL_INVALID";
        ...
        if ((iVar1 == 0) || (iVar1 = OPENSSL_strncasecmp(pcVar2,&_LC27,3), iVar1 == 0)) {
...
LAB_00102e0c:
      uVar6 = parse_bin(param_3,lVar5,lVar7);
      return uVar6;
    }
    goto LAB_0010312a;
  }
LAB_00102e60:
  iVar3 = strcmp(param_2,"Operation");
  if (iVar3 == 0) {
...
LAB_001032bb:
    ...
    *(undefined8 *)(lVar7 + 0x50) = uVar6;
    ...
    if (((pcVar5 == param_2) || (pcVar5[1] == '\0')) ||
       (lVar7 = (long)pcVar5 - (long)param_2, 0x32 < lVar7)) {
      ...
      if ((int)uVar6 != 0) {
        ...
        *(undefined8 *)(lVar7 + 8) = uVar6;
        iVar4 = test_ptr("test/evp_test.c",0x9fb,
                         "kdata->sigalgo = EVP_SIGNATURE_fetch(libctx, algoname, propquery)",uVar6);
        if (iVar4 == 0) {
        ...
        if (iVar1 != 0) {
          ...
          if (iVar1 < 1) {
            *(char **)(param_1 + 0x9a8) = "TEST_DECAPSULATE_ERROR";
            ...
            iVar1 = test_mem_eq("test/evp_test.c",0x928,&_LC109,"expected",pvVar5,local_b0[1],
                                param_6,param_7);
            ...
            if (puVar1[6] != 0) {
              ...
              if ((iVar3 == 0) ||
                 ((uVar4 = EVP_CIPHER_get_flags(*puVar1), (uVar4 & 0x10) == 0 &&
                  (iVar3 = test_mem_eq("test/evp_test.c",0x4c0,"expected->iv",&_LC126,puVar1[6],
                    ...
                    *(char **)(param_1 + 0x9a8) = "CIPHERFINAL_ERROR";
                    ...
                    if (iVar2 != 0) {
                      if (*(int *)(param_1 + 0x9d0) == 0) {
                        if ((local_11c != 0) && (fips_indicator_callback_unapproved_count < 1))
                        goto LAB_001045f9;
                          ...
                          if (param_2 == 0) {
                            if (*(int *)(puVar1 + 0x16) != 0) {
                              if ((0x301 < *(int *)((long)puVar1 + 0xb4)) &&
                                 ((iVar2 = EVP_CIPHER_is_a(*puVar1,"AES-128-CBC-HMAC-SHA1"),
                                  iVar2 != 0 ||
                                  (iVar2 = EVP_CIPHER_is_a(*puVar1,"AES-256-CBC-HMAC-SHA1"),
                                  iVar2 != 0)))) {
                                lVar9 = puVar1[9];
                            ...
                            iVar2 = memory_err_compare(param_1,"VALUE_MISMATCH",local_170,local_178,
...
LAB_0010464c:
                                ...
                                if ((iVar2 == 0) ||
                                   ((uVar4 = EVP_CIPHER_get_flags(*puVar1), (uVar4 & 0x10) == 0 &&
                                    (iVar2 = test_mem_eq("test/evp_test.c",0x5ac,"expected->next_iv"
                                                         ,&_LC126,puVar1[7],puVar1[9],local_c8,
                                                         puVar1[9]), iVar2 == 0)))) {
                            ...
                            if (iVar2 != 0) {
                              if ((*(int *)((long)puVar1 + 0x14) == 0) ||
                                 (*(int *)(puVar1 + 0x16) != 0)) goto LAB_0010464c;
                              ...
                              if (iVar2 == 0) {
                                *(char **)(param_1 + 0x9a8) = "TAG_LENGTH_INTERNAL_ERROR";
                                ...
                                iVar2 = EVP_CIPHER_CTX_ctrl(local_198,0x10,*(int *)(puVar1 + 0x19),
                                                            local_c8);
                                if (0 < iVar2) {
                                  iVar2 = memory_err_compare(param_1,"TAG_VALUE_MISMATCH",
                                                             puVar1[0x17],puVar1[0x19],local_c8,
                                                             puVar1[0x19]);
                      ...
                      if (iVar2 != 0) {
                        ...
                        if (uVar4 < 3) {
                          ...
                          iVar2 = EVP_CipherUpdate(local_198,(uchar *)0x0,&local_124,
                                                   (uchar *)(puVar1[0xe] + 1),(int)uVar4 + -2);
                        ...
                        if ((uVar4 < 2) ||
                           (iVar2 = EVP_CipherUpdate(local_198,(uchar *)0x0,&local_124,
                                                     (uchar *)(lVar9 + puVar1[0xe]),1), iVar2 != 0))
                        {
...
LAB_00104316:
                      if (puVar1[0x13] != 0) {
                        ...
                        if (iVar2 != 0) {
                          ...
                          if (2 < uVar4) {
                            iVar2 = EVP_CipherUpdate(local_198,(uchar *)0x0,&local_124,
                                                     (uchar *)(lVar9 + puVar1[0xf]),(int)uVar4 + -2)
                            ;
                            if (iVar2 == 0) goto LAB_001043e6;
                            uVar4 = puVar1[0x13];
                            lVar9 = (uVar4 - 2) + lVar9;
                          ...
                          if ((uVar4 < 2) ||
                             (iVar2 = EVP_CipherUpdate(local_198,(uchar *)0x0,&local_124,
                                                       (uchar *)(lVar9 + puVar1[0xf]),1), iVar2 != 0
                             )) goto LAB_00104325;
                        }
                        goto LAB_001043e6;
                      }
LAB_00104325:
                      if ((uchar *)puVar1[0x10] == (uchar *)0x0) goto LAB_00103fb3;
                      if (puVar1[0x14] == 0) {
LAB_00104345:
                        if ((uchar *)puVar1[0x11] == (uchar *)0x0) goto LAB_00103fb3;
                        iVar2 = EVP_CipherUpdate(local_198,(uchar *)0x0,&local_124,
                                                 (uchar *)puVar1[0x11],1);
                        if (iVar2 == 0) goto LAB_00103db0;
                        lVar13 = lVar9 + 1;
                        if (2 < (ulong)puVar1[0x15]) {
                          iVar2 = EVP_CipherUpdate(local_198,(uchar *)0x0,&local_124,
                                                   (uchar *)(puVar1[0x11] + lVar13),
                                                   (int)puVar1[0x15] + -2);
                          if (iVar2 == 0) goto LAB_001043e6;
                          lVar13 = lVar9 + -1 + puVar1[0x15];
                        }
                        EVP_CipherUpdate(local_198,(uchar *)0x0,&local_124,
                                         (uchar *)(puVar1[0x11] + lVar13),1);
                      }
                      else {
                        iVar2 = EVP_CipherUpdate(local_198,(uchar *)0x0,&local_124,
                                                 (uchar *)puVar1[0x10],1);
                        if (iVar2 != 0) {
                          ...
                          if (2 < uVar4) {
                            iVar2 = EVP_CipherUpdate(local_198,(uchar *)0x0,&local_124,
                                                     (uchar *)(lVar9 + puVar1[0x10]),(int)uVar4 + -2
                                                    );
                            if (iVar2 == 0) goto LAB_001043e6;
                            uVar4 = puVar1[0x14];
                            lVar9 = (uVar4 - 2) + lVar9;
                          ...
                          if ((uVar4 < 2) ||
                             (iVar2 = EVP_CipherUpdate(local_198,(uchar *)0x0,&local_124,
                                                       (uchar *)(lVar9 + puVar1[0x10]),1),
                             iVar2 != 0)) goto LAB_00104345;
                        }
                      }
LAB_001043e6:
                      uVar11 = 0;
...

{
  ...
  if (param_2 == 0) {
    ...
    if ((iVar4 == 0) || (iVar4 = parse_bin(param_1,ptr,ptr + 1), iVar4 != 1)) {
LAB_00105280:
      if (ptr == (long *)0x0) {
        uVar6 = 0;
        goto LAB_00105148;
...

{
  ...
  if (iVar1 == 0) {
    ...
    if (((lVar4 != 0) && (0 < (int)lVar3)) && (iVar1 = OPENSSL_sk_num(lVar4), iVar1 != 0)) {
...

{
  ...
  if (iVar3 == 0) {
LAB_00105878:
    uVar6 = parse_bin(param_3,piVar8,piVar7);
    return uVar6;
  }
...
joined_r0x001058aa:
    ...
    if (iVar3 != 3) {
      ...
      cVar1 = *param_2;
      if ((((cVar1 != 'N') || (piVar7 = piVar2 + 2, param_2[1] != '\0')) &&
          ((cVar1 != 'p' || (piVar7 = piVar2 + 6, param_2[1] != '\0')))) &&
         ((cVar1 != 'r' || (piVar7 = piVar2 + 4, param_2[1] != '\0')))) {
        ...
        do {
          if ((int)plVar11[1] == 5) {
            ...
            if (((iVar4 == 0) || (plVar11[3] != local_f0)) ||
               (iVar4 = test_mem_eq("test/evp_test.c",0x1105,"p->data",&_LC185,plVar11[2],local_f0,
    ...
    *(char **)(param_1 + 0x9a8) = "INTERNAL_ERROR";
    ...
    if (iVar2 < 1) {
      *(char **)(param_1 + 0x9a8) = "KDF_DERIVE_ERROR";
      ...
      iVar2 = test_mem_eq("test/evp_test.c",0x1029,"expected->output",&_LC31,puVar1[1],puVar1[2],key
                          ,local_38);
      pcVar3 = "KDF_MISMATCH";
      if (iVar2 != 0) {
        pcVar3 = (char *)0x0;
...
LAB_00106541:
    ...
    if (*(long *)(lVar5 + 0x68) != 0) {
      ...
      OSSL_PARAM_construct_octet_string
                (&local_228,&_LC198,*(long *)(lVar5 + 0x68),*(undefined8 *)(lVar5 + 0x70));
...
LAB_001069d4:
        if (puVar1[2] == 0) {
          ...
          if ((iVar3 != 0) && (*(long *)(param_1 + 0x9a8) == 0)) {
            if ((!bVar2) && (iVar3 = 1, puVar1[0xb] == 0)) goto LAB_00106a20;
            iVar3 = 1;
    ...
    if (iVar3 != 0) {
      ...
      if (-1 < *(int *)(puVar9 + 2)) {
        ...
        do {
          ...
          iVar3 = test_true("test/evp_test.c",0xe83,
...
LAB_00107f34:
          ...
          iVar3 = EVP_RAND_instantiate
                            (*puVar9,uVar4,*(undefined4 *)((long)puVar9 + 0x14),puVar8,puVar10[0xc],
                             0);
          iVar3 = test_true("test/evp_test.c",0xe88,
          ...
          if (puVar10[1] != 0) {
            ...
            iVar3 = test_true("test/evp_test.c",0xe93,
                              "EVP_RAND_CTX_set_params(expected->parent, params)",iVar3 != 0);
            if (iVar3 != 0) {
              iVar3 = EVP_RAND_reseed(*puVar9,*(undefined4 *)((long)puVar9 + 0x14),0,0,puVar10[4],
                                      puVar10[0x13]);
              iVar3 = test_true("test/evp_test.c",0xe96,
...
LAB_00107c67:
          if (puVar10[7] != 0) {
            ...
            uStack_148 = uStack_200;
            iVar3 = EVP_RAND_CTX_set_params(puVar9[1],local_188);
            iVar3 = test_true("test/evp_test.c",0xea1,
                              "EVP_RAND_CTX_set_params(expected->parent, params)",iVar3 != 0);
            if (iVar3 == 0) goto LAB_00107f34;
          }
          iVar3 = EVP_RAND_generate(*puVar9,pvVar6,num,uVar4,*(undefined4 *)((long)puVar9 + 0x14),
                                    puVar10[5],puVar10[0xd]);
          iVar3 = test_true("test/evp_test.c",0xea4,
          ...
          if (puVar10[8] != 0) {
            ...
            uStack_148 = uStack_200;
            iVar3 = EVP_RAND_CTX_set_params(puVar9[1],local_188);
            iVar3 = test_true("test/evp_test.c",0xeaf,
                              "EVP_RAND_CTX_set_params(expected->parent, params)",iVar3 != 0);
            if (iVar3 == 0) goto LAB_00107f34;
          }
          iVar3 = EVP_RAND_generate(*puVar9,pvVar6,num,uVar4,*(undefined4 *)((long)puVar9 + 0x14),
                                    puVar10[6],puVar10[0xe]);
          iVar3 = test_true("test/evp_test.c",0xeb2,
                            "EVP_RAND_generate (expected->ctx, got, got_len, strength, expected->prediction_resistance, item->addinB, item->addinB_len)"
                            ,iVar3 != 0);
          if (iVar3 == 0) goto LAB_00107f34;
          uVar14 = puVar10[9];
          iVar3 = test_mem_eq("test/evp_test.c",0xeb7,&_LC31,"item->output",pvVar6,num,uVar14,
                              puVar10[0x11]);
          if (iVar3 == 0) goto LAB_00107f34;
          uVar2 = *puVar9;
          local_1e4 = 1;
          ...
          if (iVar3 == 0) goto LAB_00107f34;
          if (*(int *)(param_1 + 0x9d0) == 0) {
            if ((local_1e4 != 0) && (fips_indicator_callback_unapproved_count < 1))
            goto LAB_00107f9e;
            test_error("test/evp_test.c",0x81,"Test is expected to be FIPS approved");
            goto LAB_00107f34;
          }
...
LAB_00107f9e:
          iVar3 = EVP_RAND_uninstantiate(*puVar9);
          iVar3 = test_true("test/evp_test.c",0xebb,"EVP_RAND_uninstantiate(expected->ctx)",
                            iVar3 != 0);
          if (iVar3 == 0) goto LAB_00107f34;
          iVar3 = EVP_RAND_uninstantiate(puVar9[1]);
          iVar3 = test_true("test/evp_test.c",0xebc,"EVP_RAND_uninstantiate(expected->parent)",
                            iVar3 != 0);
          if (iVar3 == 0) goto LAB_00107f34;
          iVar3 = EVP_RAND_verify_zeroization(*puVar9);
          iVar3 = test_true("test/evp_test.c",0xebd,"EVP_RAND_verify_zeroization(expected->ctx)",
                            iVar3 != 0);
          if (iVar3 == 0) goto LAB_00107f34;
          uVar5 = EVP_RAND_get_state(*puVar9);
          iVar3 = test_int_eq("test/evp_test.c",0xebe,"EVP_RAND_get_state(expected->ctx)",
                              "EVP_RAND_STATE_UNINITIALISED",uVar5,0);
          if (iVar3 == 0) goto LAB_00107f34;
          iVar1 = iVar1 + 1;
...

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  pcVar5 = strchr(param_2,0x3a);
  if ((((param_2 == pcVar5) || (pcVar5 == (char *)0x0)) || (pcVar5[1] == '\0')) ||
     (lVar7 = (long)pcVar5 - (long)param_2, 0x32 < lVar7)) {
    test_info("test/evp_test.c",0x9ea,"Can\'t extract algorithm or key name from \'%s\'",param_2);
    uVar6 = 0;
  }
...

{
  ...
  if ((iVar2 != 0) && (iVar2 = OPENSSL_strncasecmp(pcVar3,&_LC27,3), iVar2 != 0)) {
    pcVar3 = CRYPTO_strdup(param_3,"test/evp_test.c",0xcb);
    if (pcVar3 == (char *)0x0) {
      return 0;
    }
...
LAB_00108b98:
  ...
  if ((*(char **)(param_1 + 0x9b8) == (char *)0x0) ||
     (iVar3 = strcmp(*(char **)(param_1 + 0x9b8),"KEY_MISMATCH"), iVar3 != 0)) {
...

{
  ...
  if (iVar5 != 0) {
    iVar5 = EVP_DigestSign(*(undefined8 *)(lVar1 + 0x10),0,&local_48,*(undefined8 *)(lVar1 + 0x28),
                           *(undefined8 *)(lVar1 + 0x30));
    if (iVar5 != 0) {
      ...
      local_48 = local_48 << 1;
      iVar5 = EVP_DigestSign(*(undefined8 *)(lVar1 + 0x10),ptr,&local_48,
      ...
      if ((*(char **)(param_1 + 0x9b8) == (char *)0x0) ||
         (iVar5 = strcmp(*(char **)(param_1 + 0x9b8),"SIGNATURE_MISMATCH"), iVar5 != 0)) {
...

{
  ...
  if (iVar3 < 1) {
LAB_00109ebf:
    iVar3 = EVP_KDF_CTX_set_params(*plVar1,plVar1 + 3);
    if (iVar3 != 0) {
      lVar4 = 1;
      if (lVar6 != 0) {
        lVar4 = lVar6;
      ...
      iVar3 = test_ptr("test/evp_test.c",0xf9c,"got = OPENSSL_malloc(got_len == 0 ? 1 : got_len)",
                       ptr_00);
      pcVar5 = "INTERNAL_ERROR";
      if (iVar3 != 0) {
        iVar3 = fips_provider_version_gt(libctx,3,0,0);
        if ((iVar3 == 0) || (lVar4 = EVP_KDF_CTX_dup(*plVar1), lVar4 == 0)) {
          lVar4 = *plVar1;
        }
        else {
        ...
        if (0 < iVar3) {
          ...
          if (iVar3 != 0) {
            if (*(int *)(param_1 + 0x9d0) == 0) {
              if ((local_f4 != 0) && (fips_indicator_callback_unapproved_count < 1))
              goto LAB_0010a093;
              test_error("test/evp_test.c",0x81,"Test is expected to be FIPS approved");
            }
            else {
...
LAB_0010a093:
                ...
                lVar2 = plVar1[1];
                if ((*(char **)(param_1 + 0x9b8) == (char *)0x0) ||
                   (iVar3 = strcmp(*(char **)(param_1 + 0x9b8),"KDF_MISMATCH"), iVar3 != 0)) {
                  iVar3 = test_mem_eq("test/evp_test.c",0x14f,"expected",&_LC31,lVar2,lVar4,ptr_00,
                                      lVar6);
                  if (iVar3 != 0) goto LAB_0010a151;
                }
                else {
                  iVar3 = test_mem_ne("test/evp_test.c",0x14d,"expected",&_LC31,lVar2,lVar4,ptr_00,
                                      lVar6);
                  if (iVar3 == 0) {
LAB_0010a151:
                    pcVar5 = (char *)0x0;
...
LAB_0010a270:
      uVar9 = BIO_ctrl((BIO *)ptr_00[1],2,0,(void *)0x0);
      uVar17 = uVar9 & 0xffffffff;
      if ((int)uVar9 == 0) {
        fips_indicator_callback_unapproved_count = 0;
LAB_0010a2cd:
        lVar10 = BIO_ctrl((BIO *)ptr_00[1],2,0,(void *)0x0);
        if ((int)lVar10 == 0) {
          clear_test(ptr_00);
          ...
          if (pcVar11 == (char *)0x0) {
            ...
            if (pcVar13 != (char *)0x0) {
              test_info("test/evp_test.c",0x133c,"%s:%d: Succeeded but was expecting %s",*ptr_00,
                        *(undefined4 *)((long)ptr_00 + 0x14),pcVar13);
              goto LAB_0010a553;
            }
            goto LAB_0010a270;
          }
...
LAB_0010a31e:
          if (pcVar13 == (char *)0x0) {
            if (ptr_00[0x136] == 0) {
              test_info("test/evp_test.c",0x1336,"%s:%d: Source of above error; unexpected error %s"
                        ,*ptr_00,*(undefined4 *)((long)ptr_00 + 0x14),pcVar11);
            }
            else {
              test_info("test/evp_test.c",0x1333,
                        "%s:%d: Source of above error (%s); unexpected error %s",*ptr_00,
                        *(undefined4 *)((long)ptr_00 + 0x14),ptr_00[0x136],pcVar11);
            }
          }
          else {
            ...
            if (iVar3 == 0) {
              ...
              if (uVar9 == 0) {
                ...
                test_info("test/evp_test.c",0x1362,"%s:%d: Expected error \"%s\", got \"%s\"",
                          *ptr_00,*(undefined4 *)((long)ptr_00 + 0x14),pcVar13,pcVar11);
              }
            }
            else {
              test_info("test/evp_test.c",0x1342,"%s:%d: Expected %s got %s",*ptr_00,
                        *(undefined4 *)((long)ptr_00 + 0x14),pcVar13,pcVar11);
            }
          }
LAB_0010a553:
          test_openssl_errors();
...
LAB_0010a404:
    ...
    if (iVar3 == 0) {
      ...
      if ((uVar9 & 0x80000000) == 0) {
        ...
        if (((uVar6 != 0x9c && uVar6 != 0x72 || (char)(uVar9 >> 0x17) != '\x06') &&
            ((uVar5 & 0x7fffff) != 0x8010c)) &&
           ((((uint)(uVar9 >> 0x17) & 0xff) != 0x10 || ((uVar6 != 0x81 && (uVar6 != 0x8d)))))) {
LAB_0010a721:
          EVP_PKEY_free((EVP_PKEY *)0x0);
          uVar8 = 0x141d;
...
LAB_0010a817:
          pcVar11 = strchr((char *)puVar14[-1],0x3a);
          if (pcVar11 != (char *)0x0) {
            *pcVar11 = '\0';
            pcVar11 = pcVar11 + 1;
              ...
              *pcVar13 = '\0';
              ...
              if (local_60 == 0) {
                ...
                if ((uVar9 & 0x80000000) == 0) {
                  ...
                  if ((((uVar6 == 0x9c || uVar6 == 0x72) && (char)(uVar9 >> 0x17) == '\x06') ||
                      ((uVar5 & 0x7fffff) == 0x8010c)) ||
                     ((((uint)(uVar9 >> 0x17) & 0xff) == 0x10 &&
                      ((uVar6 == 0x81 || (uVar6 == 0x8d)))))) {
LAB_0010ad67:
                    ERR_clear_error();
                    goto LAB_0010a8bc;
                  }
...
LAB_0010a8bc:
        ...
        if (iVar3 == 0) {
          ...
          test_info("test/evp_test.c",0x145b,"skipping, \'%s\' provider not available: %s:%d",
                    puVar14[-1],*ptr_00,*(undefined4 *)((long)ptr_00 + 0x14));
        ...
        if (iVar3 != 0) {
          ...
          while ((puVar15 != (undefined8 *)0x0 &&
                 (iVar3 = strcmp(pcVar11,(char *)*puVar15), iVar3 != 0))) {
                        ...
                        if (iVar4 == 0) {
                          ...
                          if (iVar7 == 0) {
                            test_info("test/evp_test.c",0x14b4,
                                      "skipping, \'%s\' threads not available: %s:%d",puVar14[1],
                                      *ptr_00,*(undefined4 *)((long)ptr_00 + 0x14));
                            iVar7 = *(int *)((long)ptr_00 + 0x24);
                            *(undefined4 *)(ptr_00 + 0x133) = 1;
                          }
...
LAB_0010afb6:
                          ...
                          if (iVar4 == 0) {
                            *(undefined4 *)(ptr_00 + 0x13a) = 1;
                            ...
                            if (extended_tests == 0) {
                              test_info("test/evp_test.c",0x14bc,"skipping extended test: %s:%d",
                                        *ptr_00,*(undefined4 *)((long)ptr_00 + 0x14));
                              iVar7 = *(int *)((long)ptr_00 + 0x24);
                              *(undefined4 *)(ptr_00 + 0x133) = 1;
                            }
...
LAB_0010a739:
        test_info("test/evp_test.c",uVar8,pcVar11);
        test_openssl_errors();
        iVar3 = *(int *)(ptr_00 + 0x133);
joined_r0x0010b12d:
        if (iVar3 == 0) {
...
LAB_0010a598:
  ...
  for (puVar12 = (undefined8 *)*puVar15; puVar12 != (undefined8 *)0x0;
    ...
    *(undefined8 *)(param_1 + 0x9a8) = 0;
    ...
    if (0 < iVar4) {
      ...
      if (iVar4 != 0) {
        ...
        if ((0 < iVar4) &&
           (iVar4 = test_size_t_ne("test/evp_test.c",0xbe7,"got_len",&_LC339,local_48,0), iVar4 != 0
           )) {
          ...
          if ((iVar4 == 0) || (iVar4 = EVP_PKEY_derive(ctx,key,&local_48), iVar4 < 1)) {
            *(char **)(param_1 + 0x9a8) = "DERIVE_ERROR";
            ...
            uVar3 = puVar1[7];
            if ((*(char **)(param_1 + 0x9b8) == (char *)0x0) ||
               (iVar4 = strcmp(*(char **)(param_1 + 0x9b8),"SHARED_SECRET_MISMATCH"), iVar4 != 0)) {
              puVar5 = key;
              ...
              if (iVar4 == 0) {
LAB_0010b42f:
                iVar4 = pkey_check_fips_approved(ctx,param_1,puVar5);
...

{
  ...
  local_80 = (uchar *)CRYPTO_malloc(((SUB164(auVar3 * ZEXT816(0xaaaaaaaaaaaaaaab),8) & 0xfffffffe) +
                                     0x29 + (int)((ulong)plVar1[1] / 0x30)) * 2,"test/evp_test.c",
                                    0xd45);
  iVar4 = test_ptr("test/evp_test.c",0xd44,
...
LAB_0010b826:
  ...
  do {
    if (data_chunk_size == 0) {
      ...
      iVar6 = test_true("test/evp_test.c",0xd52,
  ...
  lVar2 = plVar1[2];
  if ((*(char **)(param_1 + 0x9b8) == (char *)0x0) ||
     (iVar6 = strcmp(*(char **)(param_1 + 0x9b8),"BAD_ENCODING"), iVar6 != 0)) {
    ...
    if (iVar4 != 0) {
LAB_0010b995:
      *(char **)(param_1 + 0x9a8) = "BAD_ENCODING";
      goto LAB_0010b826;
    }
  }
LAB_0010b4d3:
  ...
  do {
    if (data_chunk_size == 0) {
      iVar5 = EVP_DecodeUpdate(ctx,(uchar *)((long)iVar4 + (long)__s),&local_44,
                               (uchar *)(plVar1[2] + lVar7),(int)uVar9);
    ...
    iVar5 = EVP_DecodeUpdate(ctx,(uchar *)((long)iVar4 + (long)__s),&local_44,
                             (uchar *)(plVar1[2] + lVar7),(int)uVar8);
    if (iVar5 < 0) goto LAB_0010b6b7;
    lVar7 = lVar7 + uVar8;
    iVar4 = iVar4 + local_44;
    uVar9 = uVar9 - uVar8;
...
LAB_0010b9d0:
    ...
    *(undefined8 *)(param_1 + 0x9a8) = 0;
    ...
    lVar2 = *plVar1;
    if ((*(char **)(param_1 + 0x9b8) == (char *)0x0) ||
       (iVar5 = strcmp(*(char **)(param_1 + 0x9b8),"BAD_DECODING"), iVar5 != 0)) {
...
LAB_0010bdb0:
      ...
      uVar3 = puVar1[7];
      if ((*(char **)(param_1 + 0x9b8) == (char *)0x0) ||
         (iVar5 = strcmp(*(char **)(param_1 + 0x9b8),"KEYOP_MISMATCH"), iVar5 != 0)) {
...
LAB_0010bc70:
          *(undefined8 *)(param_1 + 0x9a8) = 0;
          ...
          if ((*(char **)(param_1 + 0x9b8) == (char *)0x0) ||
            ...
            if (iVar5 == 0) {
LAB_0010bd60:
              pkey_check_fips_approved(*puVar1,param_1,pvVar6);
              goto LAB_0010baf2;
            }
          }
        }
...

{
  ...
  *puVar9 = local_128;
  ...
  if (bVar5 || iVar7 != 0) {
    ...
    if ((iVar8 == 0) ||
       (iVar8 = test_str_eq("test/evp_test.c",0x2ea,&_LC364,"\"touch\"",&local_46,"touch"),
       iVar8 == 0)) {
LAB_0010c564:
      EVP_MD_CTX_free(out);
    }
...
LAB_0010c330:
  iVar8 = test_int_eq("test/evp_test.c",0x33b,"expected->output_len","got_len",
  ...
  uVar12 = puVar1[3];
  if ((*(char **)(param_1 + 0x9b8) == (char *)0x0) ||
     (iVar8 = strcmp(*(char **)(param_1 + 0x9b8),"DIGEST_MISMATCH"), iVar8 != 0)) {
    ...
    if (iVar8 != 0) {
LAB_0010c548:
      *(char **)(param_1 + 0x9a8) = "DIGEST_MISMATCH";
      goto LAB_0010bed6;
    }
  }
  *(undefined8 *)(param_1 + 0x9a8) = 0;
  ...
  if ((iVar8 == 1) && (!bVar5 && iVar7 == 0)) {
    ...
    iVar7 = test_ptr("test/evp_test.c",0x34a,"inbuf = sk_EVP_TEST_BUFFER_value(expected->input, 0)",
                     puVar9);
    if ((iVar7 == 0) && (*(int *)(puVar9 + 3) == 0)) {
      ...
      iVar7 = test_true("test/evp_test.c",0x34d,
                        "EVP_Q_digest(libctx, EVP_MD_get0_name(expected->fetched_digest), NULL, inbuf->buf, inbuf->buflen, got, &size)"
                        ,iVar7 != 0);
      if ((iVar7 == 0) ||
         (iVar7 = test_mem_eq("test/evp_test.c",0x351,&_LC31,"expected->output",md,local_f0,
                              puVar1[3],puVar1[4]), iVar7 == 0)) {
...
LAB_0010c622:
      if (*(long *)(param_1 + 0x9a8) == 0) {
        for (iVar4 = 0; iVar5 = OPENSSL_sk_num(*(undefined8 *)(lVar1 + 0x60)), iVar4 < iVar5;
            iVar4 = iVar4 + 1) {
        ...
        if (iVar4 != 0) {
          ...
          if (iVar4 == 0) {
            ...
            if (iVar4 == 0) {
              ...
              pcVar8 = (char *)0x0;
              if ((*(char **)(param_1 + 0x9b8) == (char *)0x0) ||
                 (iVar4 = strcmp(*(char **)(param_1 + 0x9b8),"SIGNATURE_MISMATCH"), iVar4 != 0)) {
                iVar4 = test_mem_eq("test/evp_test.c",0x14f,"expected",&_LC31,uVar2,uVar6,sigret,
                                    sVar3);
                if (iVar4 == 0) goto LAB_0010c8ec;
              }
              else {
                iVar4 = test_mem_ne("test/evp_test.c",0x14d,"expected",&_LC31,uVar2,uVar6,sigret,
                                    sVar3);
                if (iVar4 != 0) {
LAB_0010c8ec:
                  pcVar8 = "SIGNATURE_MISMATCH";
                }
              }
            }
          }
...
LAB_0010cf95:
  ...
  if ((iVar4 != 0) &&
     ((lVar7 = OSSL_PARAM_locate(local_388 + uVar13 * 5,&_LC355), lVar7 == 0 ||
      (iVar4 = OSSL_PARAM_get_size_t(lVar7,&local_468), iVar4 != 0)))) {
    ...
    if (lVar7 != 0) {
      ...
      if (iVar4 == 0) {
        ...
        iVar4 = test_false("test/evp_test.c",0x7ab,"size_before_init == 0 && size_after_init == 0",
                           lVar11 == 0 && lVar9 == 0);
        if (iVar4 == 0) {
          local_4e0 = (undefined8 *)0x0;
...
LAB_0010cf57:
            ...
            if (iVar4 != 0) {
              ...
              iVar5 = test_ptr("test/evp_test.c",0x7e4,"got = OPENSSL_malloc(expected->output_len)",
                               puVar10);
              if (iVar5 == 0) {
LAB_0010d740:
                *(char **)(param_1 + 0x9a8) = "TEST_FAILURE";
...
LAB_0010d1b5:
              ...
              uVar2 = puVar1[10];
              if ((*(char **)(param_1 + 0x9b8) == (char *)0x0) ||
                 (iVar5 = strcmp(*(char **)(param_1 + 0x9b8),"TEST_MAC_ERR"), iVar5 != 0)) {
                iVar5 = test_mem_eq("test/evp_test.c",0x14f,"expected",&_LC31,uVar2,uVar6,puVar10,
                                    uVar6);
                if (iVar5 == 0) goto LAB_0010d1b5;
              }
              else {
                iVar5 = test_mem_ne("test/evp_test.c",0x14d,"expected",&_LC31,uVar2,uVar6,puVar10,
                                    uVar6);
                if (iVar5 != 0) goto LAB_0010d1b5;
              }
LAB_0010d200:
              if (((int)local_4e0 == 1) ||
                 (iVar5 = fips_provider_version_gt(libctx,3,0,0), iVar5 == 0)) {
LAB_0010d661:
                *(undefined8 *)(param_1 + 0x9a8) = 0;
                if (iVar4 == 0) {
                  OPENSSL_cleanse(puVar10,local_478);
                  lVar11 = EVP_Q_mac(libctx,*puVar1,0,puVar1[3],local_388,puVar1[4],puVar1[5],
                                     puVar1[8],puVar1[9],puVar10,local_478,&local_470);
                  iVar4 = test_true("test/evp_test.c",0x829,
                                    ...
                                    ,lVar11 != 0);
                  if ((iVar4 == 0) ||
                     (iVar4 = test_mem_eq("test/evp_test.c",0x82e,&_LC31,"expected->output",puVar10,
                                          local_470,puVar1[10],puVar1[0xb]), iVar4 == 0)) {
...
LAB_0010d47e:
                  ...
                  if (lVar11 != 0) {
                    ...
                    if (*(int *)(param_1 + 0x9d0) == 0) {
                      if ((local_47c != 0) && (fips_indicator_callback_unapproved_count < 1))
                      goto LAB_0010d200;
                      test_error("test/evp_test.c",0x81,"Test is expected to be FIPS approved");
                      goto LAB_0010ccbc;
                    }
...
LAB_0010d330:
          ...
          *puVar15 = local_4b8;
          ...
          if (iVar4 == 0) {
            ...
            if (((*(int *)(puVar1 + 0x12) < 0) ||
                (iVar4 = test_int_eq("test/evp_test.c",0x7c8,"output_size","expected->output_size",
                                     local_480), iVar4 != 0)) &&
               ((*(int *)((long)puVar1 + 0x94) < 0 ||
                (iVar4 = test_int_eq("test/evp_test.c",0x7cd,"block_size","expected->block_size",
                                     local_484), iVar4 != 0)))) goto LAB_0010cefe;
            pcVar8 = "TEST_FAILURE";
          }
        }
        else {
          if (local_468 == 0) {
            iVar4 = test_size_t_eq("test/evp_test.c",0x7b1,"size_before_init","size_after_init",
                                   lVar11,lVar9);
            if (iVar4 != 0) {
...
LAB_0010ce61:
            iVar4 = test_size_t_eq("test/evp_test.c",0x7b6,"size_val","size_after_init",local_468,
                                   lVar9);
...

{
  ...
  if (*(int *)(lVar1 + 0x80) == 0) {
    ...
    if (*(int *)(lVar1 + 0x10) == 0x37e) {
      ...
      if (lVar8 == 0) {
LAB_0010d898:
        local_70 = EVP_CIPHER_fetch(libctx,lVar8,propquery);
        iVar3 = test_ptr("test/evp_test.c",0x6f4,
                         "cipher = EVP_CIPHER_fetch(libctx, expected->alg, propquery)",local_70);
        if (iVar3 != 0) {
...
LAB_0010ddda:
                  ...
                  if ((*(char **)(param_1 + 0x9b8) == (char *)0x0) ||
                     (iVar3 = strcmp(*(char **)(param_1 + 0x9b8),"TEST_MAC_ERR"), iVar3 != 0)) {
                    iVar3 = test_mem_eq("test/evp_test.c",0x14f,"expected",&_LC31,uVar2,uVar5,sigret
                                        ,local_48);
                    if (iVar3 == 0) goto LAB_0010ddda;
                  }
                  else {
                    iVar3 = test_mem_ne("test/evp_test.c",0x14d,"expected",&_LC31,uVar2,uVar5,sigret
                                        ,local_48);
                    if (iVar3 != 0) goto LAB_0010ddda;
                  }
                  pcVar6 = (char *)0x0;

...

{
  ...
  local_58 = __LC34;
  uStack_50 = (undefined5)_UNK_00102038;
  uStack_4b = 0;
    ...
    if (iVar6 != 0) {
      ...
      if (iVar6 != 0) {
        ...
        if (param_1 < iVar11) {
          ...
          if (local_70 < param_1) {
            uVar12 = 1;
            param_1 = param_1 - local_6c;
          }
        }
        BIO_ctrl(pBVar10,0x8000,uVar12,(void *)0x0);
        ...
        if (iVar5 != 0) {
          if (session != (SSL_SESSION *)0x0) {
            ...
            if (iVar5 == 0) goto LAB_00101059;
          }
          uVar12 = BIO_ctrl(pBVar10,0x18000,0,(void *)0x0);
          iVar5 = test_int_eq("test/dtlstest.c",0x125,
                              "(int)BIO_ctrl(mempackbio, MEMPACKET_CTRL_GET_DROP_REC, 0, NULL)",
                              &_LC42,uVar12 & 0xffffffff,0xffffffff);
          uVar4 = (uint)(iVar5 != 0);
          goto LAB_00100fd5;
        }
      }

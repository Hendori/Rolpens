...
void ossl_dh_generate_ffc_parameters
...

{
  ...
  if (param_2 == 1) {
    iVar1 = ossl_ffc_params_FIPS186_2_generate
                      (*(undefined8 *)(param_1 + 0xb0),param_1 + 8,1,(long)param_3,(long)param_4,
                       local_14,param_5);
  }
  else {
...
joined_r0x00100429:
        ...
        if ((((iVar2 != 0) &&
             (iVar2 = BN_generate_prime_ex2(dh->p,prime_len,1,a,a_00,cb,ctx), iVar2 != 0)) &&
            (iVar2 = BN_GENCB_call(cb,3,0), iVar2 != 0)) &&
           (iVar2 = BN_set_word((BIGNUM *)dh->length,(long)generator), iVar2 != 0)) {

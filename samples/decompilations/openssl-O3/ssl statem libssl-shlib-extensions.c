...
LAB_00101926:
      if (param_6 != 0) {
        puVar14 = &ext_defs;
        do {
          if (((*(long *)(puVar14 + 2) != 0) && ((puVar14[1] & param_3) != 0)) &&
             ((iVar4 = extension_is_relevant(param_1,puVar14[1],param_3), iVar4 != 0 &&
              (iVar4 = (**(code **)(puVar14 + 2))(param_1,param_3), iVar4 == 0))))
          goto LAB_0010168f;
          puVar14 = puVar14 + 0xe;
...
LAB_0010158f:
              puVar6 = (undefined8 *)((long)ptr + lVar10);
              if (*(int *)(puVar6 + 2) != 1) {
                if (uVar12 == 0x29) {
                  ...
                  uVar8 = (int)((long)puVar6 - (long)ptr >> 3) * -0x33333333;
                  if ((((uVar8 < 0x1d) && ((param_3 & 0x6080) == 0)) && (uVar12 != 0x2c)) &&
                     ((uVar12 != 0x12 && (uVar12 != 0xff01)))) {
LAB_001018bf:
                    if ((*(byte *)(param_1 + 0x9f0 + (ulong)uVar8) & 2) == 0) goto LAB_001019eb;
                  }
                }
LAB_001015d8:
                *puVar6 = puVar16;
                ...
                *(uint *)(puVar6 + 3) = (uint)uVar12;
                ...
                if (*(code **)(param_1 + 0xa10) != (code *)0x0) {
                  (**(code **)(param_1 + 0xa10))
                            (*(undefined8 *)(param_1 + 0x40),*(int *)(param_1 + 0x78) == 0,
                             (uint)uVar12,puVar16,uVar15,*(undefined8 *)(param_1 + 0xa18));
                }
                lVar17 = lVar17 + 1;
                goto LAB_00101630;
              }
...
LAB_001016f0:
        ...
        if (uVar8 == 0x29) {
          ...
          if (uVar2 == 0) {
            ...
            if (((0x1c < (uint)uVar11) || ((param_3 & 0x6080) != 0)) ||
               ((*(byte *)(param_1 + 0x9f0 + (uVar11 & 0xffffffff)) & 2) != 0)) goto LAB_00101630;
          }
          else {
            if (lVar13 != 0) goto LAB_001016f0;
            uVar8 = (int)(-(long)ptr >> 3) * -0x33333333;
            if (((0x1c < uVar8) || ((param_3 & 0x6080) != 0)) ||
               ((*(byte *)(param_1 + 0x9f0 + (ulong)uVar8) & 2) != 0)) goto LAB_00101926;
          }
LAB_001019eb:
          if (((param_3 & 0x100) == 0) || (uVar12 != 65000)) goto LAB_00101842;
          if (puVar6 != (undefined8 *)0x0) goto LAB_001015d8;
        }
        else {
          uVar3 = (int)(-(long)ptr >> 3) * -0x33333333;
          if (((uVar3 < 0x1d) && ((param_3 & 0x6080) == 0)) &&
             (((uVar8 != 0x2c &&
               (((uVar8 != 0x12 && (uVar8 != 0xff01)) &&
                ((*(byte *)(param_1 + 0x9f0 + (ulong)uVar3) & 2) == 0)))) &&
              (((param_3 & 0x100) == 0 || (uVar8 != 65000)))))) {
LAB_00101842:
            ERR_new();

...
LAB_001001c1:
                    ...
                    bVar4 = false;
                    for (iVar5 = 0;
                        (iVar6 = OPENSSL_sk_num(psVar9), uVar10 < uVar14 && (iVar5 < iVar6));
                        iVar5 = iVar5 + 1) {
...
LAB_00100351:
    ERR_set_debug("ssl/statem/statem_clnt.c",uVar15,pcVar13);
...
switchD_00101bb6_caseD_13:
        *(undefined4 *)(param_1 + 0xac) = 0x14;
        return 1;
      }
      goto LAB_00101f38;
    }
switchD_00101c48_caseD_2:
    ERR_new();
    pcVar5 = "ossl_statem_client13_write_transition";
    uVar6 = 0x1c5;
LAB_00101bf1:
  ...
  if (bVar7) {
    if (0x1f < uVar10) {
      if ((_hrrrandom != *(long *)(puVar5 + 1) ||
         ...
         (_ssl3_comp_find != *(long *)(puVar5 + 9) ||
          _tls_parse_all_extensions != *(long *)(puVar5 + 0xd))) goto LAB_00102508;
      ...
      *(undefined4 *)(param_1 + 0x8d0) = 1;
      ...
      uVar19 = 0x5d3;
LAB_00102dde:
      ERR_set_debug("ssl/statem/statem_clnt.c",uVar19,"tls_process_server_hello");
      ossl_statem_fatal(param_1,0x50,0xc0103,0);
      goto LAB_0010284e;
    }
LAB_00102818:
...
LAB_001025e9:
      ...
      if ((iVar9 == 0) || (iVar9 = ssl_choose_client_version(param_1,uVar15,local_68), iVar9 == 0))
      goto LAB_0010284e;
      piVar14 = *(int **)(param_1 + 0x18);
      if ((((*(uint *)(*(long *)(piVar14 + 0x36) + 0x50) & 8) == 0) && (0x303 < *piVar14)) &&
         ((bVar21 = 0, *piVar14 != 0x10000 || (bVar7)))) goto LAB_00102a8a;
LAB_00102678:
      uVar17 = 0x100;
      uVar18 = 0x100;
LAB_00102682:
      iVar9 = tls_validate_all_contexts(param_1,uVar18,local_68);
      if (iVar9 == 0) {
        ERR_new();
...
LAB_00102785:
            if (*(int *)(param_1 + 0x508) == 0) goto LAB_00102bec;
            goto LAB_00102793;
          }
        }
        else {
...
LAB_00102fe5:
          ...
          *piVar14 = iVar9;
          if (((((*(byte *)(lVar11 + 0x50) & 8) != 0) || (iVar4 = *piVar6, iVar4 == 0x10000)) ||
              (iVar4 < 0x304)) && (*(ulong *)(piVar14 + 0x94) = __n, __n != 0)) {
            ...
            if (bVar3 < 8) {
              if ((bVar3 & 4) == 0) {
                if (bVar3 != 0) {
                  ...
                  *(undefined2 *)((long)piVar14 + __n + 0x256) =
                       *(undefined2 *)(pbVar16 + (__n - 1));
                  piVar14 = *(int **)(param_1 + 0x900);
                }
              }
              else {
...
LAB_00102caf:
                *(long *)(param_1 + 0x390) = lVar11;
                ...
                if (iVar9 != 0) {
                  ...
                  if (((((*(byte *)(puVar20 + 10) & 8) != 0) ||
                       (iVar9 = **(int **)(param_1 + 0x18), iVar9 == 0x10000)) || (iVar9 < 0x304))
                     || (((iVar9 = (*(code *)*puVar20)(param_1), iVar9 != 0 &&
          ...
          iVar9 = (**(code **)(param_1 + 0xae0))
                            (uVar19,piVar14 + 0x14,&local_6c,0,&local_60,
...
LAB_00102b65:
          iVar9 = memcmp(__s1,piVar14 + 0x96,__n);
          if (iVar9 == 0) {
            *(undefined4 *)(param_1 + 0x508) = 1;
          }
          else if (*(int *)(param_1 + 0x508) == 0) goto LAB_00102fe5;
LAB_00102793:
          if ((*(size_t *)(param_1 + 0x8d8) == *(size_t *)(piVar14 + 0x9e)) &&
             (iVar9 = memcmp(piVar14 + 0xa0,(void *)(param_1 + 0x8e0),*(size_t *)(param_1 + 0x8d8)),
             iVar9 == 0)) {
LAB_001027ce:
            iVar9 = *piVar14;
      ...
      if ((lVar11 != 1) &&
         (uVar10 = uVar10 - 5,
         uVar10 == (ushort)(*(ushort *)(pbVar1 + 3) << 8 | *(ushort *)(pbVar1 + 3) >> 8))) {
        local_58 = pbVar1 + 5;
                    ...
                    *param_2 = (long)local_58 + uVar16;
                    ...
                    if ((iVar9 != 0) &&
                       (iVar9 = tls_parse_all_extensions
                                          (param_1,0x1000,local_60,local_70,lVar14,param_2[1] == 0),
                       iVar9 != 0)) {
                      CRYPTO_free(local_60);
                      goto LAB_001036e0;
                    }
...
LAB_00103fe0:
    ...
    uVar7 = 0xa52;
LAB_00103ff1:
    ERR_set_debug("ssl/statem/statem_clnt.c",uVar7,"tls_process_certificate_request");
    ossl_statem_fatal(param_1,0x32,0x9f,0);
  }
  else {
...
LAB_00104990:
    ...
    lVar10 = *(long *)(param_1 + 0x900);
LAB_001044f7:
    lVar10 = ssl_session_dup(lVar10,0);
    if (lVar10 == 0) {
      ERR_new();
    ...
    *(ulong *)(lVar10 + 0x330) = uVar18;
    if ((((*(byte *)(lVar5 + 0x50) & 8) == 0) && (iVar8 = *piVar3, iVar8 != 0x10000)) &&
      ...
      *param_2 = (long)local_58 + uVar13;
      ...
      if ((iVar8 == 0) ||
         (iVar8 = tls_parse_all_extensions(param_1,0x2000,local_60,0,0), iVar8 == 0))
      goto LAB_00104676;
    }
    ...
    iVar8 = EVP_Digest(*(void **)(*(long *)(param_1 + 0x900) + 0x328),uVar18,
    ...
    if (iVar8 != 0) {
      ...
      *(ulong *)(lVar10 + 0x250) = (ulong)local_58 & 0xffffffff;
      ...
      if (iVar8 < 1) {
        ...
        iVar9 = tls13_hkdf_expand(param_1,uVar14,param_1 + 0x63c,"resumption",10,local_80,local_88,
                                  *(long *)(param_1 + 0x900) + 0x50,(long)iVar8,1);
        if (iVar9 != 0) {
                ...
                if (uVar21 <= uVar16 - 2) {
                  ...
                  *param_2 = (long)(puVar2 + 1) + uVar21;
                  ...
                  if ((pBVar14 == (BIGNUM *)0x0 || a == (BIGNUM *)0x0) || (a_00 == (BIGNUM *)0x0)) {
                    ...
                    if ((((local_88 == 0) ||
                         (iVar11 = OSSL_PARAM_BLD_push_BN(local_88,&_LC5,pBVar14), iVar11 == 0)) ||
                      ...
                      local_78 = (EVP_PKEY_CTX *)
                                 EVP_PKEY_CTX_new_from_name(*puVar7,&_LC8,puVar7[0x8e]);
                      if (local_78 == (EVP_PKEY_CTX *)0x0) {
                        ...
                        if ((iVar11 < 1) ||
                          ...
                          local_78 = (EVP_PKEY_CTX *)
                                     EVP_PKEY_CTX_new_from_pkey(*puVar7,local_48,puVar7[0x8e]);
                          if (((local_78 == (EVP_PKEY_CTX *)0x0) ||
                              (iVar11 = EVP_PKEY_param_check_quick(local_78), iVar11 != 1)) ||
                             (iVar11 = EVP_PKEY_public_check(local_78), pEVar9 = local_48,
                             iVar11 != 1)) {
                            ERR_new();
...
LAB_001062f7:
      if ((uVar10 & 0x44) != 0 || (uVar5 & 0x1c8) != 0) goto LAB_00106089;
      goto LAB_00106308;
    }
    local_90 = tls_get_peer_pkey(param_1);
    *(uint *)(*(long *)(param_1 + 0x900) + 0x308) = (uint)uVar26;
...

{
  ...
  if (param_2 == 4) {
    ...
    if (((iVar2 == 0) || (*(long *)(param_1[1].sid_ctx + 0x14) == 0)) ||
       (((*(uint *)(*(long *)&param_1[3].packet_length + 0x1c) & 0x30001) != 0 &&
        (iVar2 = tls1_check_chain(param_1,0,0,0,0xfffffffe), iVar2 == 0)))) goto LAB_00107741;
LAB_001077df:
...
LAB_00107789:
      ...
      if (((iVar2 == 0) || (*(long *)(param_1[1].sid_ctx + 0x14) == 0)) ||
         (((*(uint *)(*(long *)&param_1[3].packet_length + 0x1c) & 0x30001) != 0 &&
          (iVar2 = tls1_check_chain(param_1,0,0,0,0xfffffffe), iVar2 == 0)))) goto LAB_00107894;
LAB_001077c0:
      if (((((*(byte *)(*(long *)&param_1->wbio[1].ex_data.dummy + 0x50) & 8) != 0) ||

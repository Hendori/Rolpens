...

{
  ...
  if (iVar2 == 0) {
    ...
    if (iVar2 != 0) {
      ...
      uVar3 = test_int_eq("test/destest.c",0x2dd,"bs = EVP_CIPHER_get_block_size(cipher)",&_LC12,
                          iVar2,8);
                    ...
                    if (iVar4 != 0) {
                      ...
                      if (iVar5 != 0) {
                        ...
                        iVar5 = test_true("test/destest.c",0x304,
                                          ...
                                          iVar5 != 0);
                        if (iVar5 != 0) {
                          iVar5 = test_mem_eq("test/destest.c",0x308,&_LC28,"p_txt",local_248,lVar6,
...

{
  ...
  if (iVar1 != 0) {
    ...
    if (iVar1 != 0) {
      ...
      ;
      iVar1 = test_mem_eq("test/destest.c",0x238,"cfb_cipher64","cfb_buf1",cfb_cipher64,0x18,
                          cfb_buf1,0x18);
      if (iVar1 != 0) {
        local_cc = 0;
        cfb_tmp = 0xefcdab9078563412;
        DES_cfb64_encrypt(cfb_buf1,cfb_buf2,0x11,&local_c8,(DES_cblock *)&cfb_tmp,&local_cc,0);
        DES_cfb64_encrypt(cfb_buf1 + 0x11,cfb_buf2 + 0x11,7,&local_c8,(DES_cblock *)&cfb_tmp,
                          &local_cc,0);
...

{
  ...
  if (iVar1 != 0) {
    ...
    if (iVar1 != 0) {
      ...
      iVar1 = test_int_eq("test/destest.c",0x1b0,"DES_set_key_checked(&cbc3_key, &ks3)",&_LC22,iVar1
                          ,0);
      if (iVar1 != 0) {
        local_a0[0] = cbc_iv[0];
        local_a0[1] = cbc_iv[1];
...

{
  ...
  iVar2 = test_mem_eq("test/destest.c",0x167,&_LC77,"cipher_ecb2[i]",&local_88,8,cipher_ecb2 + lVar1
                      ,8);
  if (iVar2 == 0) {
    local_58 = CONCAT71(CONCAT61(CONCAT51(CONCAT41(CONCAT31(CONCAT21(CONCAT11("0123456789ABCDEF"
                                                                              [local_90[3] & 0xf],
                                                                              "0123456789ABCDEF"
                                                                              [local_90[3] >> 4]),
                                                                     "0123456789ABCDEF"
                                                                     [local_90[2] & 0xf]),
                                                            "0123456789ABCDEF"[local_90[2] >> 4]),
                                                   "0123456789ABCDEF"[local_90[1] & 0xf]),
                                          "0123456789ABCDEF"[local_90[1] >> 4]),
                                 "0123456789ABCDEF"[local_90[0] & 0xf]),
                        "0123456789ABCDEF"[local_90[0] >> 4]);
    uStack_50 = CONCAT71(CONCAT61(CONCAT51(CONCAT41(CONCAT31(CONCAT21(CONCAT11("0123456789ABCDEF"
                                                                               [local_90[7] & 0xf],
                                                                               "0123456789ABCDEF"
                                                                               [local_90[7] >> 4]),
                                                                      "0123456789ABCDEF"
                                                                      [local_90[6] & 0xf]),
                                                             "0123456789ABCDEF"[local_90[6] >> 4]),
                                                    "0123456789ABCDEF"[local_90[5] & 0xf]),
                                           "0123456789ABCDEF"[local_90[5] >> 4]),
                                  "0123456789ABCDEF"[local_90[4] & 0xf]),
                         "0123456789ABCDEF"[local_90[4] >> 4]);
    local_48 = 0;
    local_78 = CONCAT71(CONCAT61(CONCAT51(CONCAT41(CONCAT31(CONCAT21(CONCAT11("0123456789ABCDEF"
                                                                              [(byte)key_data[lVar1 
                                                  + 3] & 0xf],
                                                  "0123456789ABCDEF"[(byte)key_data[lVar1 + 3] >> 4]
                                                  ),"0123456789ABCDEF"
                                                    [(byte)key_data[lVar1 + 2] & 0xf]),
                                                  "0123456789ABCDEF"[(byte)key_data[lVar1 + 2] >> 4]
                                                  ),"0123456789ABCDEF"
                                                    [(byte)key_data[lVar1 + 1] & 0xf]),
                                          "0123456789ABCDEF"[(byte)key_data[lVar1 + 1] >> 4]),
                                 "0123456789ABCDEF"[(*key)[0] & 0xf]),
                        "0123456789ABCDEF"[(*key)[0] >> 4]);
    local_68 = 0;
    uStack_70 = CONCAT71(CONCAT61(CONCAT51(CONCAT41(CONCAT31(CONCAT21(CONCAT11("0123456789ABCDEF"
                                                                               [(byte)key_data[lVar1
                                                                                               + 7]
                                                                                & 0xf],
                                                  "0123456789ABCDEF"[(byte)key_data[lVar1 + 7] >> 4]
                                                  ),"0123456789ABCDEF"
                                                    [(byte)key_data[lVar1 + 6] & 0xf]),
                                                  "0123456789ABCDEF"[(byte)key_data[lVar1 + 6] >> 4]
                                                  ),"0123456789ABCDEF"
                                                    [(byte)key_data[lVar1 + 5] & 0xf]),
                                           "0123456789ABCDEF"[(byte)key_data[lVar1 + 5] >> 4]),
                                  "0123456789ABCDEF"[(byte)key_data[lVar1 + 4] & 0xf]),
                         "0123456789ABCDEF"[(byte)key_data[lVar1 + 4] >> 4]);
    test_info("test/destest.c",0x168,"Encryption error %2d k=%s p=%s",param_1 + 1,&local_78,
              &local_58);
    uVar3 = 0;
  }
  else {
    ...
    if (iVar2 == 0) {
      local_58 = CONCAT71(CONCAT61(CONCAT51(CONCAT41(CONCAT31(CONCAT21(CONCAT11("0123456789ABCDEF"
                                                                       ...
                                                                       "0123456789ABCDEF"
                                                                       [local_88[2] & 0xf]),
                                                              "0123456789ABCDEF"[local_88[2] >> 4]),
                                                     "0123456789ABCDEF"[local_88[1] & 0xf]),
                                            "0123456789ABCDEF"[local_88[1] >> 4]),
                                   "0123456789ABCDEF"[local_88[0] & 0xf]),
                          "0123456789ABCDEF"[local_88[0] >> 4]);
      uStack_50 = CONCAT71(CONCAT61(CONCAT51(CONCAT41(CONCAT31(CONCAT21(CONCAT11("0123456789ABCDEF"
                                                                                 [local_88[7] & 0xf]
                                                                                 ,"0123456789ABCDEF"
                                                                                  [local_88[7] >> 4]
                                                                        ...
                                                                        "0123456789ABCDEF"
                                                                        [local_88[6] & 0xf]),
                                                               "0123456789ABCDEF"[local_88[6] >> 4])
                                                      ,"0123456789ABCDEF"[local_88[5] & 0xf]),
                                             "0123456789ABCDEF"[local_88[5] >> 4]),
                                    "0123456789ABCDEF"[local_88[4] & 0xf]),
                           "0123456789ABCDEF"[local_88[4] >> 4]);
      local_48 = 0;
      local_78 = CONCAT71(CONCAT61(CONCAT51(CONCAT41(CONCAT31(CONCAT21(CONCAT11("0123456789ABCDEF"
                                                                                [(byte)key_data[
                                                  lVar1 + 3] & 0xf],
      ...
      uStack_70 = CONCAT71(CONCAT61(CONCAT51(CONCAT41(CONCAT31(CONCAT21(CONCAT11("0123456789ABCDEF"
                                    ...
                                    "0123456789ABCDEF"[(byte)key_data[lVar1 + 4] & 0xf]),
                           "0123456789ABCDEF"[(byte)key_data[lVar1 + 4] >> 4]);
      test_info("test/destest.c",0x16d,"Decryption error %2d k=%s p=%s ",param_1 + 1,&local_78,
                &local_58);
      uVar3 = 0;
    }
  }
...

{
  ...
  iVar2 = test_mem_eq("test/destest.c",0x14b,&_LC77,"cipher_data[i]",&local_88,8,cipher_data + lVar1
                      ,8);
  if (iVar2 == 0) {
    local_58 = CONCAT71(CONCAT61(CONCAT51(CONCAT41(CONCAT31(CONCAT21(CONCAT11("0123456789ABCDEF"
                                                                              [local_90[3] & 0xf],
    ...
    uStack_70 = CONCAT71(CONCAT61(CONCAT51(CONCAT41(CONCAT31(CONCAT21(CONCAT11("0123456789ABCDEF"
                                  ...
                                  "0123456789ABCDEF"[(byte)key_data[lVar1 + 4] & 0xf]),
                         "0123456789ABCDEF"[(byte)key_data[lVar1 + 4] >> 4]);
    test_info("test/destest.c",0x14c,"Encryption error %2d k=%s p=%s",param_1 + 1,&local_78,
              &local_58);
    uVar3 = 0;
  }
  else {
    ...
    if (iVar2 == 0) {
      ...
      uStack_70 = CONCAT71(CONCAT61(CONCAT51(CONCAT41(CONCAT31(CONCAT21(CONCAT11("0123456789ABCDEF"
                                    ...
                                    "0123456789ABCDEF"[(byte)key_data[lVar1 + 4] & 0xf]),
                           "0123456789ABCDEF"[(byte)key_data[lVar1 + 4] >> 4]);
      test_info("test/destest.c",0x151,"Decryption error %2d k=%s p=%s",param_1 + 1,&local_78,
                &local_58);
      uVar3 = 0;
    }
  }

...

{
  ...
  if (param_1 != 0) {
    ...
    BN_free(*(BIGNUM **)(param_1 + 0x380));
    BN_free(*(BIGNUM **)(param_1 + 0x388));
    BN_free(*(BIGNUM **)(param_1 + 0x390));
    BN_free(*(BIGNUM **)(param_1 + 0x398));
    BN_free(*(BIGNUM **)(param_1 + 0x3a0));
...
LAB_0010042b:
    if (*(char **)(lVar1 + 0x3a8) == (char *)0x0) {
LAB_0010045c:
      *(undefined8 *)(param_1 + 0xc48) = *(undefined8 *)(lVar1 + 0x3b8);
      return 1;
    }
...

{
  ...
  *param_2 = 0x50;
  if ((((lVar6 != 0) && (*(long *)(param_1 + 0xc00) != 0)) && (*(long *)(param_1 + 0xc08) != 0)) &&
    ...
    if (0 < iVar3) {
      ...
      *(BIGNUM **)(param_1 + 0xc28) = pBVar5;
      ...
      lVar6 = SRP_Calc_B_ex(*(undefined8 *)(param_1 + 0xc28),*(undefined8 *)(param_1 + 0xbf8),
...
LAB_001007c4:
  uVar1 = ssl_srp_server_param_with_username_intern(param_1,param_2);
  return uVar1;
}
...
undefined8
SSL_set_srp_server_param_pw(uint *param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  if (((*param_1 == 0) ||
     ...
     (lVar4 = SRP_get_default_gN(param_4), lVar4 != 0)) {
    ...
    *(BIGNUM **)(puVar3 + 0x300) = pBVar6;
    ...
    puVar3[0x302] = 0;
    puVar3[0x303] = 0;
    iVar2 = SRP_create_verifier_BN_ex
                      (param_2,param_3,puVar3 + 0x302,puVar3 + 0x30c,*(undefined8 *)(puVar3 + 0x2fe)
                       ,*(undefined8 *)(puVar3 + 0x300),*puVar1,puVar1[0x8e]);
    if (iVar2 != 0) {
      return 1;
    }
  }
...
SSL_set_srp_server_param
          (uint *param_1,BIGNUM *param_2,BIGNUM *param_3,BIGNUM *param_4,BIGNUM *param_5,
          char *param_6)

{
  ...
  if ((*param_1 == 0) ||
    ...
    if ((((*(long *)(param_1 + 0x2fe) != 0) && (*(long *)(param_1 + 0x300) != 0)) &&
        (*(long *)(param_1 + 0x302) != 0)) && (*(long *)(param_1 + 0x30c) != 0)) {
      return 1;
    }
  }
  return 0xffffffff;
  ...
  if (iVar2 != 0) {
    a = (BIGNUM *)
        SRP_Calc_u_ex(*(undefined8 *)(param_1 + 0xc18),*(undefined8 *)(param_1 + 0xc10),
                      *(undefined8 *)(param_1 + 0xbf8),*puVar1,puVar1[0x8e]);
    if (a != (BIGNUM *)0x0) {
      uVar4 = 0;
      a_00 = (BIGNUM *)
...
LAB_00100d32:
    ...
    __s = (char *)(**(code **)(param_1 + 0xbe8))
                            (*(undefined8 *)(param_1 + 0x40),*(undefined8 *)(param_1 + 0xbd0));
    if (__s != (char *)0x0) {
      a_00 = (BIGNUM *)

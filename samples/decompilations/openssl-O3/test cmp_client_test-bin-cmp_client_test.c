...
bool test_exec_GENM_ses_poll_total_timeout(void)

{
  ...
  if (ptr != (void *)0x0) {
    *(undefined8 *)((long)ptr + 0x18) = _LC18;
    ossl_cmp_mock_srv_set_checkAfterTime(*(undefined8 *)((long)ptr + 0x10),2);
    ossl_cmp_mock_srv_set_pollCount(*(undefined8 *)((long)ptr + 0x10),3);
    OSSL_CMP_CTX_set_option(*(undefined8 *)((long)ptr + 8),0xc,3);
    iVar1 = execute_exec_GENM_ses_test_single(ptr);
    if ((iVar1 == 0) || (iVar1 = OSSL_CMP_CTX_reinit(*(undefined8 *)((long)ptr + 8)), iVar1 == 0)) {
      bVar2 = false;
    }
    else {
      iVar1 = execute_exec_GENM_ses_test_single(ptr);
...

{
  ...
  if (ptr == (void *)0x0) goto LAB_001008df;
  ...
  *(undefined4 *)((long)ptr + 0x1c) = 1;
  ...
  iVar2 = test_int_eq("test/cmp_client_test.c",0x195,&_LC20,
...
LAB_001008b2:
    ...
    iVar2 = test_ptr_eq("test/cmp_client_test.c",0x197,"OSSL_CMP_CTX_get0_newCert(ctx)",&_LC21,uVar3
                        ,0);
...

{
  ...
  if (ptr == (void *)0x0) goto LAB_00100a89;
  ...
  *(undefined4 *)((long)ptr + 0x1c) = 1;
  ...
  iVar3 = test_int_eq("test/cmp_client_test.c",0x178,&_LC20,
...
LAB_00100a5c:
    ...
    iVar3 = test_ptr_eq("test/cmp_client_test.c",0x17a,"OSSL_CMP_CTX_get0_newCert(ctx)",&_LC21,uVar4
                        ,0);
    if (iVar3 == 0) goto LAB_00100a5c;
    uVar2 = OSSL_CMP_try_certreq(uVar1,7,0,&local_44);
    iVar3 = test_int_eq("test/cmp_client_test.c",0x17b,&_LC20,
                        "OSSL_CMP_try_certreq(ctx, TYPE, NULL, &check_after)",0xffffffff,uVar2);
    if ((iVar3 == 0) || (local_44 != 0)) goto LAB_00100a5c;
    uVar4 = OSSL_CMP_CTX_get0_newCert(uVar1);
    iVar3 = test_ptr_eq("test/cmp_client_test.c",0x17d,"OSSL_CMP_CTX_get0_newCert(ctx)",&_LC21,uVar4
                        ,0);
    if (iVar3 == 0) goto LAB_00100a5c;
...
bool test_exec_RR_ses_receive_error(void)

{
  ...
  *(undefined4 *)((long)ptr + 0x1c) = 2;
  uVar1 = OSSL_CMP_CTX_get_status(*(undefined8 *)((long)ptr + 8));
  ...
  if (iVar2 != 0) {
    iVar2 = *(int *)((long)ptr + 0x1c);
    uVar1 = OSSL_CMP_exec_RR_ses(*(undefined8 *)((long)ptr + 8));
    ...
    if (iVar2 != 0) {
      uVar1 = *(undefined4 *)((long)ptr + 0x1c);
      uVar3 = OSSL_CMP_CTX_get_status(*(undefined8 *)((long)ptr + 8));
...
bool test_exec_RR_ses_request_error(void)
...
undefined4 test_exec_IR_ses_poll_ok(void)

{
  ...
  if (ptr != (void *)0x0) {
    *(undefined8 *)((long)ptr + 0x18) = 0;
    ossl_cmp_mock_srv_set_checkAfterTime(*(undefined8 *)((long)ptr + 0x10),1);
    ossl_cmp_mock_srv_set_pollCount(*(undefined8 *)((long)ptr + 0x10),2);
    OSSL_CMP_CTX_set_option(*(undefined8 *)((long)ptr + 8),0xc,0);
    uVar1 = execute_exec_certrequest_ses_test(ptr);
    OSSL_CMP_CTX_free(*(undefined8 *)((long)ptr + 8));
    ossl_cmp_mock_srv_free(*(undefined8 *)((long)ptr + 0x10));
    OPENSSL_sk_free(*(undefined8 *)((long)ptr + 0x20));
...
undefined4 test_exec_IR_ses_poll_no_timeout(void)

{
  ...
  if (ptr != (void *)0x0) {
    *(undefined8 *)((long)ptr + 0x18) = 0;
    ossl_cmp_mock_srv_set_checkAfterTime(*(undefined8 *)((long)ptr + 0x10),1);
    ossl_cmp_mock_srv_set_pollCount(*(undefined8 *)((long)ptr + 0x10),2);
    OSSL_CMP_CTX_set_option(*(undefined8 *)((long)ptr + 8),0xc,5);
    uVar1 = execute_exec_certrequest_ses_test(ptr);
    OSSL_CMP_CTX_free(*(undefined8 *)((long)ptr + 8));
    ossl_cmp_mock_srv_free(*(undefined8 *)((long)ptr + 0x10));
    OPENSSL_sk_free(*(undefined8 *)((long)ptr + 0x20));
...

{
  ...
  bVar2 = true;
  if (ptr != (void *)0x0) {
    *(undefined8 *)((long)ptr + 0x18) = _LC38;
    ossl_cmp_mock_srv_set_checkAfterTime(*(undefined8 *)((long)ptr + 0x10),2);
    ossl_cmp_mock_srv_set_pollCount(*(undefined8 *)((long)ptr + 0x10),3);
    OSSL_CMP_CTX_set_option(*(undefined8 *)((long)ptr + 8),0xc,7);
    iVar1 = execute_exec_certrequest_ses_test(ptr);
    OSSL_CMP_CTX_free(*(undefined8 *)((long)ptr + 8));
    ossl_cmp_mock_srv_free(*(undefined8 *)((long)ptr + 0x10));
    OPENSSL_sk_free(*(undefined8 *)((long)ptr + 0x20));
    CRYPTO_free(ptr);
...
bool test_exec_CR_ses_explicit_confirm(void)

{
  int iVar1;
  void *pvVar2;
  
  pvVar2 = (void *)set_up("test_exec_CR_ses");
  if (pvVar2 != (void *)0x0) {
    *(undefined4 *)((long)pvVar2 + 0x18) = 2;
    OSSL_CMP_CTX_set_option(*(undefined8 *)((long)pvVar2 + 8),0x19,0);
    OSSL_CMP_SRV_CTX_set_grant_implicit_confirm(*(undefined8 *)((long)pvVar2 + 0x10),0);
    ossl_cmp_mock_srv_set_sendError(*(undefined8 *)((long)pvVar2 + 0x10),0xffffffff);
    *(undefined4 *)((long)pvVar2 + 0x1c) = 0;
    iVar1 = execute_exec_certrequest_ses_test(pvVar2);
    OSSL_CMP_CTX_free(*(undefined8 *)((long)pvVar2 + 8));
    ossl_cmp_mock_srv_free(*(undefined8 *)((long)pvVar2 + 0x10));
    OPENSSL_sk_free(*(undefined8 *)((long)pvVar2 + 0x20));
    CRYPTO_free(pvVar2);
    if (iVar1 != 0) {
      pvVar2 = (void *)set_up("test_exec_CR_ses");
      if (pvVar2 != (void *)0x0) {
        *(undefined4 *)((long)pvVar2 + 0x18) = 2;
        OSSL_CMP_CTX_set_option(*(undefined8 *)((long)pvVar2 + 8),0x19,0);
        OSSL_CMP_SRV_CTX_set_grant_implicit_confirm(*(undefined8 *)((long)pvVar2 + 0x10),0);
        ossl_cmp_mock_srv_set_sendError(*(undefined8 *)((long)pvVar2 + 0x10),0x18);
        *(undefined4 *)((long)pvVar2 + 0x1c) = 2;
        iVar1 = execute_exec_certrequest_ses_test(pvVar2);
        OSSL_CMP_CTX_free(*(undefined8 *)((long)pvVar2 + 8));
        ossl_cmp_mock_srv_free(*(undefined8 *)((long)pvVar2 + 0x10));
        OPENSSL_sk_free(*(undefined8 *)((long)pvVar2 + 0x20));
...
bool test_exec_CR_ses_implicit_confirm(void)

{
  ...
  if (pvVar2 != (void *)0x0) {
    *(undefined4 *)((long)pvVar2 + 0x18) = 2;
    OSSL_CMP_CTX_set_option(*(undefined8 *)((long)pvVar2 + 8),0x19,1);
    OSSL_CMP_SRV_CTX_set_grant_implicit_confirm(*(undefined8 *)((long)pvVar2 + 0x10),0);
    ossl_cmp_mock_srv_set_sendError(*(undefined8 *)((long)pvVar2 + 0x10),0xffffffff);
    *(undefined4 *)((long)pvVar2 + 0x1c) = 0;
    iVar1 = execute_exec_certrequest_ses_test(pvVar2);
    ...
    if (iVar1 != 0) {
      ...
      if (pvVar2 != (void *)0x0) {
        *(undefined4 *)((long)pvVar2 + 0x18) = 2;
        OSSL_CMP_CTX_set_option(*(undefined8 *)((long)pvVar2 + 8),0x19,1);
        OSSL_CMP_SRV_CTX_set_grant_implicit_confirm(*(undefined8 *)((long)pvVar2 + 0x10),1);
        ossl_cmp_mock_srv_set_sendError(*(undefined8 *)((long)pvVar2 + 0x10),0xffffffff);
        *(undefined4 *)((long)pvVar2 + 0x1c) = 0;
        iVar1 = execute_exec_certrequest_ses_test(pvVar2);
        OSSL_CMP_CTX_free(*(undefined8 *)((long)pvVar2 + 8));
...
bool test_exec_GENM_ses_poll_ok(void)
...
bool test_exec_GENM_ses_poll_no_timeout(void)

{
  ...
  if (ptr != (void *)0x0) {
    *(undefined8 *)((long)ptr + 0x18) = 0x15;
    ossl_cmp_mock_srv_set_checkAfterTime(*(undefined8 *)((long)ptr + 0x10),1);
    ossl_cmp_mock_srv_set_pollCount(*(undefined8 *)((long)ptr + 0x10),1);
    OSSL_CMP_CTX_set_option(*(undefined8 *)((long)ptr + 8),0xc,2);
    iVar1 = execute_exec_GENM_ses_test_single(ptr);
    if ((iVar1 == 0) || (iVar1 = OSSL_CMP_CTX_reinit(*(undefined8 *)((long)ptr + 8)), iVar1 == 0)) {
      bVar2 = false;
    }
                ...
                if (iVar1 != 0) {
                  ...
                  if (iVar1 != 0) {
                    ...
                    if (iVar1 != 0) {
                      ...
                      iVar1 = test_int_eq("test/cmp_client_test.c",0x226,&_LC53,

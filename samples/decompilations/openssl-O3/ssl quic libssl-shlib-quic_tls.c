...

{
  ...
  *ptr = in_stack_000000c8;
  if ((in_stack_00000088 == 0) || (iVar3 = BIO_up_ref(in_stack_00000088), iVar3 != 0)) {
    BIO_free((BIO *)ptr[2]);
...
LAB_00100aa0:
    ...
    if (*(int *)(lVar4 + 0x7c) != 0) {
      ...
      uVar5 = 1;
LAB_00100bde:
      iVar3 = EVP_MD_up_ref(in_stack_00000078);
      if (iVar3 == 0) {
        *(undefined4 *)(ptr + 7) = 0x50;
        ERR_new();
        uVar5 = 0xad;
    ...
    iVar3 = (**(code **)(lVar4 + 0x38))
                      (in_R9D,in_R8D != 0,uVar5,in_stack_00000078,in_stack_00000010,
                       in_stack_00000018);
    if (iVar3 != 0) {
      return 1;
    }
    ...
    *(undefined4 *)(ptr + 7) = 0x50;
    ...
    uVar5 = 0x7b;
LAB_00100b39:
    ERR_set_debug("ssl/quic/quic_tls.c",uVar5,"quic_new_record_layer");
    uVar5 = 0xc0103;
LAB_00100b48:
...
LAB_00100e3c:
    if (param_1[6] == 2) {
      iVar2 = (**(code **)(*param_1 + 0x68))
                        (*(undefined8 *)(*param_1 + 0x70),*(undefined1 *)(param_1[5] + 1));
      if (iVar2 == 0) {
        *(undefined4 *)(param_1 + 7) = 0x50;
        ERR_new();
        ERR_set_debug("ssl/quic/quic_tls.c",0x130,"quic_write_records");
...
LAB_00100e61:
    ...
    *(undefined4 *)(param_1 + 7) = 0x50;
    ...
    local_18 = (((uint)param_1[6] & 0xff00 | *(uint *)((long)param_1 + 0x24) & 0xff) << 8 |
               *(uint *)((long)param_1 + 0x24) >> 8 & 0xff) << 8 | local_18;
...
LAB_00100da0:
    if (cVar1 == '\x16') {
      iVar2 = (**(code **)(*param_1 + 8))
                        (param_1[3] + param_1[5],param_1[6] - param_1[3],&local_20,
                         *(undefined8 *)(*param_1 + 0x10));
      if (iVar2 == 0) {
        *(undefined4 *)(param_1 + 7) = 0x50;
        ERR_new();

...
LAB_00101c2f:
      ...
      while( true ) {
        ...
        if ((iVar2 != 0) &&
           (iVar2 = tls_valid_group(param_1,local_38[uVar4],0x304,0x304,0,0), iVar2 != 0)) break;
        uVar4 = uVar4 + 1;
...
LAB_00101b46:
          ...
          do {
            iVar2 = tls_group_allowed(param_1,local_38[uVar4],0x20004);
            if ((iVar2 != 0) &&
               (iVar2 = tls_valid_group(param_1,local_38[uVar4],0x304,0x304,0,0), iVar2 != 0)) {
...
LAB_00101ce9:
        iVar2 = add_key_share(param_1,param_2,sVar3,0);
...

{
  ...
  lVar3 = param_2[1];
  pbVar5 = (byte *)*param_2;
  if ((lVar3 == 0) || (uVar4 = lVar3 - 1, uVar4 != *pbVar5)) {
    ERR_new();
...
LAB_00103b79:
          ...
          pbVar4 = __s2 + uVar8;
                ...
                (iVar6 = memcmp((void *)((long)puVar3 + 3),__s2,uVar13), iVar6 != 0));
          ...
          if (bVar1 < 8) {
            if ((bVar1 & 4) == 0) {
              if ((bVar1 != 0) && (*(undefined1 *)__s2_00 = *(undefined1 *)puVar5, (bVar1 & 2) != 0)
                ...
                *(undefined2 *)((long)__s2_00 + (uVar13 - 2)) =
                     *(undefined2 *)((long)puVar5 + (uVar13 - 2));
              }
            }
            else {
              *(undefined4 *)__s2_00 = *(undefined4 *)puVar5;
              *(undefined4 *)((long)__s2_00 + (uVar13 - 4)) =
                   *(undefined4 *)((long)puVar5 + (uVar13 - 4));
            }
          }
          else {
            *__s2_00 = *puVar5;
            *(undefined8 *)((long)__s2_00 + (uVar13 - 8)) =
                 *(undefined8 *)((long)puVar5 + (uVar13 - 8));
          ...
          *(ulong *)(param_1 + 0x4c0) = uVar13;
          if (*(void **)(lVar14 + 0x348) == (void *)0x0) {
            ...
            *(undefined8 *)(lVar14 + 0x350) = 0;
            ...
            if ((*(ulong *)(lVar14 + 0x350) != uVar13) ||
               (iVar7 = memcmp(*(void **)(lVar14 + 0x348),__s2_00,uVar13), iVar7 != 0)) {
              *(undefined4 *)(param_1 + 0xb1c) = 0;
            }
            if (iVar6 != 0) {
              return 1;
      ...
      if (lVar7 != 0) {
        if (uVar10 == *(ushort *)(param_1 + 0x330)) {
          ...
          if (*(ushort *)(param_1 + 0x332) == uVar9) {
            ...
            else if ((lVar7 == 3) || (lVar7 = 3, *(ushort *)(param_1 + 0x336) != uVar9))
            goto LAB_00104369;
          }
        }
...
LAB_00104574:
                ...
                if ((to == (EVP_PKEY *)0x0) ||
                  ...
                  uVar8 = 0x50;
LAB_00104611:
                  ossl_statem_fatal(param_1,uVar8,uVar6,0);
                }
                else {
...
LAB_00104369:
      ...
      lVar7 = *(long *)(param_1 + 0x338);
      if ((lVar7 == 0) ||
         ((uVar10 != *(ushort *)(param_1 + 0x330) &&
          ((lVar7 == 1 ||
           ((uVar10 != *(ushort *)(param_1 + 0x332) &&
            ((lVar7 == 2 ||
             ((uVar10 != *(ushort *)(param_1 + 0x334) &&
              ((lVar7 == 3 || (*(ushort *)(param_1 + 0x336) != uVar9)))))))))))))) {
        ...
        if (local_38 != 0) {
          ...
          do {
            if (*(ushort *)(local_40 + uVar5 * 2) == uVar9) {
              if (((uVar5 < local_38) &&
                  (iVar4 = tls_group_allowed(param_1,uVar9,0x20004), iVar4 != 0)) &&
                 (iVar4 = tls_valid_group(param_1,uVar9,0x304,0x304,0,0), iVar4 != 0)) {

...

{
  evp_generic_fetch_from_prov
            (param_1,0xe,param_2,param_3,evp_kem_from_algorithm,evp_kem_up_ref,evp_kem_free);
  return;
}
...
LAB_00100908:
          ...
          do {
            ...
            if (lVar8 != 0) {
              ...
              local_78 = evp_pkey_export_to_provider
                                   (param_4,*(undefined8 *)(param_1 + 2),&local_48,
...
LAB_001008ad:
              ...
              *(long *)(param_1 + 0xc) = lVar4;
              ...
              if (local_78 == 0) {
                ...
                if (pcVar10 != (code *)0x0) {
LAB_00100b41:
                  iVar3 = (*pcVar10)(lVar4,lVar9,local_78,param_3);
LAB_00100b4d:
                  EVP_KEYMGMT_free(local_48);
                  local_48 = 0;

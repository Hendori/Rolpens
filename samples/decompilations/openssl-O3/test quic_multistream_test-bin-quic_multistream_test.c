...
LAB_0010121c:
    ...
    if (iVar2 != 0) {
      iVar2 = test_uint64_t_eq("test/quic_multistream_test.c",0x15a7,&_LC27,"hl->check_op->arg2",
...

{
  ...
  uVar2 = test_true("test/quic_multistream_test.c",0x1540,
                    ...
                    ,iVar1 != 0);
  if ((int)uVar2 != 0) {
    iVar1 = test_uint64_t_eq("test/quic_multistream_test.c",0x1545,&_LC27,"hl->check_op->arg2",
                             local_28,*(undefined8 *)(*(long *)(param_2 + 0x18) + 0x28));
    uVar2 = (ulong)(iVar1 != 0);
  }
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
...

{
  ...
  iVar1 = test_uint64_t_ge("test/quic_multistream_test.c",0x135c,"h->fail_count",&_LC32,
  ...
  if (iVar1 != 0) {
    ...
    if (iVar1 != 0) {
      ...
      iVar1 = test_true("test/quic_multistream_test.c",0x1531,
                        ...
                        iVar1 != 0);
      if (iVar1 != 0) {
        iVar1 = test_uint64_t_eq("test/quic_multistream_test.c",0x1536,&_LC27,"hl->check_op->arg2",
                                 local_28,*(undefined8 *)(*(long *)(param_2 + 0x18) + 0x28));
        bVar2 = iVar1 != 0;
        goto LAB_0010158f;
      }
...

{
  ...
  iVar1 = test_size_t_gt("test/quic_multistream_test.c",0x147b,"new_session_count",&_LC39,
                         new_session_count,0);
  return iVar1 != 0;
}
...
/* WARNING: Removing unreachable block (ram,0x001024fc) */
...

{
  ...
  uVar2 = test_uint64_t_gt("test/quic_multistream_test.c",0xe98,"h->scratch0",&_LC39,
                           *(undefined8 *)(param_1 + 0x100),0);
  if ((int)uVar2 != 0) {
    iVar1 = test_uint64_t_eq("test/quic_multistream_test.c",0xe9c,"h->scratch1",&_LC39,
...

{
  ...
  iVar1 = test_uint64_t_lt("test/quic_multistream_test.c",0x1c3,&_LC81,"hl->check_op->arg2",uVar2,
                           *(undefined8 *)(*(long *)(param_2 + 0x18) + 0x28));
  return iVar1 != 0;
}
...
LAB_0010303b:
    ...
    if (((uVar1 & 0xfffffffb) == 1) && (bVar4 = true, iVar2 == 1)) goto LAB_00102ffd;
    if ((uVar1 != 2) || (iVar2 != 3)) {
      if ((uVar1 == 3) && (bVar4 = true, iVar2 == 2)) goto LAB_00102ffd;
      if ((uVar1 != 0xb) || (iVar2 != 7)) {
        if ((uVar1 == 4) && (bVar4 = true, iVar2 == 4)) goto LAB_00102ffd;
        goto LAB_0010303b;
      }
    }
    bVar4 = true;
...

{
  ...
  if (lVar2 == 0) {
    *(undefined4 *)(param_1 + 200) = 1;
    ...
    iVar1 = test_size_t_ge("test/quic_multistream_test.c",0x11a9,"tc->reason_len",&_LC32,
...
LAB_00104990:
  ...
  iVar1 = test_ptr("test/quic_multistream_test.c",0x15b5,
                   "c_a = helper_local_get_c_stream(hl, \"a\")",uVar3);
  if (iVar1 != 0) {
    ...
    if (iVar1 != 0) {
      ...
      if (iVar1 != 0) {
        ...
        if (iVar1 != 0) {
          iVar1 = test_uint64_t_ge("test/quic_multistream_test.c",0x15bb,&_LC121,"avail",local_58,
                                   local_48[0]);
          if (iVar1 != 0) {
            iVar1 = test_uint64_t_ge("test/quic_multistream_test.c",0x15bc,&_LC121,&_LC122,local_58,
                                     local_50);
            if (iVar1 != 0) {
              iVar1 = test_uint64_t_eq("test/quic_multistream_test.c",0x15bd,"avail + used",&_LC121,
                                       local_48[0] + local_50,local_58);
              if (iVar1 != 0) {
                iVar1 = test_uint64_t_eq("test/quic_multistream_test.c",0x15c0,&_LC122,
                                         "hl->check_op->arg1",local_50,
...
LAB_00104de0:
  ...
  iVar2 = test_ptr("test/quic_multistream_test.c",0x1610,
                   "c_a = helper_local_get_c_stream(hl, \"a\")",uVar8);
  if (iVar2 != 0) {
...
LAB_00104e30:
    ...
    iVar2 = test_ptr("test/quic_multistream_test.c",0x1611,
                     "c_b = helper_local_get_c_stream(hl, \"b\")",uVar9);
    if (iVar2 != 0) {
...
LAB_00104e80:
      ...
      iVar2 = test_ptr("test/quic_multistream_test.c",0x1612,
                       "c_c = helper_local_get_c_stream(hl, \"c\")",local_148);
      if (iVar2 != 0) {
        uVar7 = *(undefined8 *)(param_2 + 8);
...
LAB_00104e38:
        ...
        iVar2 = test_ptr("test/quic_multistream_test.c",0x1613,
                         "c_d = helper_local_get_c_stream(hl, \"d\")",uVar7);
        if (iVar2 != 0) {
          local_a0 = local_148;
          ...
          if (uVar4 != 0) {
            iVar2 = test_size_t_eq("test/quic_multistream_test.c",0x164d,"result_count",
                                   "expected_result_count",local_138[0],5);
            uVar4 = (uint)(iVar2 != 0);
          }
          lVar6 = 0;
          do {
            iVar2 = test_uint64_t_eq("test/quic_multistream_test.c",0x1651,"items[i].revents",
                                     "expected_revents[i]",(&uStack_d0)[lVar6 * 4],
                                     *(undefined8 *)(local_118 + lVar6 * 8));
            if (iVar2 == 0) {
              uVar4 = 0;
              test_error("test/quic_multistream_test.c",0x1652,
                         "mismatch at index %zu in poll results, mode %d",lVar6,uVar1 & 0xffffffff);
            }
            lVar6 = lVar6 + 1;
          } while (lVar6 != 5);
          goto LAB_00104aaa;
  ...
  if (uVar20 != 0) {
    if (param_4 < 0) {
      ...
      local_160 = OPENSSL_LH_set_thunks
                            (uVar33,0x100000,lh_STREAM_INFO_cfn_thunk,lh_STREAM_INFO_doall_thunk,
                             lh_STREAM_INFO_doall_arg_thunk);
      iVar21 = test_ptr("test/quic_multistream_test.c",0x362,
                        "hl->c_streams = lh_STREAM_INFO_new(stream_info_hash, stream_info_cmp)",
                        local_160);
      uVar20 = (uint)(iVar21 != 0);
    }
  }
  iVar21 = test_true("test/quic_multistream_test.c",0x41a,"helper_local_init(hl, h, thread_idx)",
                     uVar20);
  if (iVar21 == 0) {
    local_178 = 0;
    local_1b0 = 0;
...
LAB_001051ec:
  ...
  iVar21 = test_int_le("test/quic_multistream_test.c",0x443,
                       "ossl_time_compare(ossl_time_now(), op_deadline)",&_LC39,iVar21,0);
  if (iVar21 == 0) {
    iVar21 = 0;
    test_error("test/quic_multistream_test.c",0x444,"op %zu timed out on thread %d",local_1b0 + 1,
               param_4);
    goto LAB_00105483;
  }
  ...
  if (pcVar35 == (char *)0x0) {
joined_r0x00105216:
    if (-1 < param_4) goto LAB_0010519a;
LAB_0010521c:
...
LAB_001053c0:
  ...
  if (param_4 < 0) {
    ...
    iVar21 = test_ptr("test/quic_multistream_test.c",0x37a,"stream_name",pcVar35);
    if ((iVar21 == 0) || (iVar21 = strcmp(pcVar35,"DEFAULT"), iVar21 == 0)) goto LAB_0010521c;
    local_138._0_8_ = pcVar35;
...
switchD_0010526e_caseD_35:
  ...
  goto LAB_00105088;
switchD_001051d8_caseD_0:
  iVar21 = test_size_t_eq("test/quic_multistream_test.c",0x486,"repeat_stack_len",&_LC39,local_178,0
                         );
  if (iVar21 == 0) {
LAB_001058bf:
    iVar21 = 0;
    ...
    if ((param_4 < 0) && (uVar25 = *(ulong *)(param_1 + 0x88), uVar25 != 0)) {
      uVar40 = 0;
      bVar6 = false;
      do {
          ...
          if (iVar21 == 0) {
            if (!bVar6) {
              test_info("test/quic_multistream_test.c",0x498,
                        "still waiting for other threads to finish (%zu)",uVar40);
            }
            piVar24 = (int *)(param_1 + 0x138);
            if (-1 < local_158) {
              piVar24 = (int *)((long)local_158 * 0x40 + *(long *)(param_1 + 0x80) + 0x38);
    ...
    if (local_178 != 0) {
      ...
      do {
        ...
        test_info("test/quic_multistream_test.c",0x7ea,
                  "while repeating, iteration %zu of %zu, starting at script op %zu",*plVar34,
                  *plVar4,*plVar3);
    ...
    if (*(long *)(param_1 + 0x70) != 0) {
      ...
      if (iVar22 != 0) {
        ...
        test_info("test/quic_multistream_test.c",0x7fd,
                  ...
                  ,puVar26,local_138._8_8_,puVar27,pcVar30,pcVar35,puVar31);
      }
    }
    if ((*(long *)(param_1 + 0x38) != 0) &&
       (puVar28 = (undefined8 *)ossl_quic_tserver_get_terminate_cause(),
      ...
      test_info("test/quic_multistream_test.c",0x816,
                "server side is closed: %llu(%s)/%llu(%s), %s, %s, reason: \"%s\"",*puVar28,puVar26,
                puVar28[1],puVar27,pcVar30,pcVar35,puVar31);
    }
  }
  CRYPTO_free(local_190);
...
LAB_001083d0:
    ...
    if ((iVar2 == 0) || (iVar2 = BIO_up_ref(local_200), iVar2 == 0)) goto LAB_001083d0;
    ...
    *(undefined8 *)(lVar5 + 8) = local_150;
    ...
    iVar2 = test_true("test/quic_multistream_test.c",0x314,
                      "BIO_dgram_set_peer(h->c_net_bio, h->s_net_bio_addr)",(int)lVar5 != 0);
    if (iVar2 == 0) goto LAB_001083d0;
    ...
    iVar2 = test_true("test/quic_multistream_test.c",0x323,
                      "ossl_quic_set_override_now_cb(h->c_conn, get_time, h)");
    if (iVar2 == 0) goto LAB_001083d0;
  ...
  if (iVar2 != 0) {
    ...
    if (iVar2 != 0) {
      ...
      iVar2 = test_true("test/quic_multistream_test.c",0x837,
                        "join_threads(h.threads, h.num_threads)",uVar8);
      bVar9 = iVar2 != 0;
      goto LAB_001083f4;
    }
  }

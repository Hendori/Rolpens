...
LAB_00100619:
    ...
    if (iVar2 != 0) {
LAB_0010062e:
      if (*(long *)(param_2 + 0x40) != 0) goto LAB_00100637;
      goto LAB_0010068d;
    }
  }
  else {
...
LAB_00100e4b:
                ...
                if (iVar3 != 0) {
                  ...
                  if (iVar3 != 0) {
                    ...
                    if ((iVar3 != 0) &&
                       (iVar3 = test_mem_eq("test/quic_record_test.c",0xb1f,&_LC66,"t->expected",ptr
                                            ,local_190,*(undefined8 *)(pcVar1 + 0x58),
                                            *(undefined8 *)(pcVar1 + 0x60)), iVar3 != 0)) {
                      if (*(long *)(pcVar1 + 0x90) == -1) goto LAB_00100d22;
                      ...
                      if (iVar5 != 0) {
                        ...
                        iVar5 = test_ptr("test/quic_record_test.c",0xb31,&_LC68,__dest);
                        bVar16 = false;
                        if (iVar5 != 0) {
                          ...
                          if (iVar5 != 0) {
                            ...
                            for (uVar15 = 0; uVar15 < *(ulong *)(pcVar1 + 0x60); uVar15 = uVar15 + 1
                              ...
                              if (uVar15 == 0) {
                                ...
                                pcVar12 = pcVar14;
                                uVar11 = (uint)bVar10;
                                if (*pcVar1 != '\x05') goto LAB_001010fb;
                                bVar2 = 0xe0;
                                goto LAB_001010fb;
                              }
...
LAB_001010fb:
                                  ...
                                  do {
                                    ...
                                    if ((bVar2 >> ((uint)uVar8 & 0x1f) & 1) == 0) {
                                      if (0x24 < lVar7 + uVar8) goto LAB_001011da;
                              ...
                              iVar5 = test_int_eq(pcVar14,0xb5b,"d & rej_mask",&_LC71,
                                                  uVar6 & uVar11 & 0xff,0);
                              if (iVar5 == 0) goto LAB_001010b1;
                            }
                            ...
                            iVar5 = test_true(pcVar14,0xb60,
                                              ...
                                              iVar5 != 0);
                            if (iVar5 != 0) {
                              iVar5 = test_mem_eq(pcVar14,0xb63,&_LC68,"t->expected",__dest,
...

{
  ...
  if (param_1 == 0xf0) {
    do {
      lVar7 = 0;
      do {
        iVar2 = test_uint_gt("test/quic_record_test.c",0xb94,"counts_u[cipher][i]",&_LC71,
                             puVar4[lVar7],0);
        if (iVar2 == 0) {
          return 0;
        }
        iVar2 = test_uint_gt("test/quic_record_test.c",0xb96,"counts_c[cipher][i]",&_LC71,
                             puVar5[lVar7],0);
        if (iVar2 == 0) {
          return 0;
        }
      ...
      puVar4 = puVar4 + 0x25;
      puVar5 = puVar5 + 0x25;
    } while (puVar4 != (undefined4 *)&DAT_001022bc);
  }
  else {
    iVar2 = param_1 / 3;
    iVar3 = iVar2 + 3;
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  local_d0 = (long *)0x0;
  pcVar8 = *(char **)(rx_scripts + (long)param_1 * 8);
  plVar7 = local_c8;
  ...
  if (cVar1 == '\0') {
    ...
    do {
      ...
      case '\x01':
        ...
        local_a0 = (ulong)*(uint *)(pcVar8 + 0x20);
        break;
      case '\x02':
        if (local_68 != (SSL *)0x0) {
          SSL_free(local_68);
        ...
        local_90 = *(undefined8 *)(pcVar8 + 0x28);
        uStack_88 = local_90;
        local_80 = local_90;
        break;
      case '\x03':
        iVar4 = rx_state_ensure(local_c8);
        iVar4 = test_true("test/quic_record_test.c",0x71e,"rx_state_ensure(&s)",iVar4 != 0);
        if (iVar4 == 0) goto LAB_00101505;
        puVar3 = *(undefined8 **)(pcVar8 + 0x30);
        local_60 = *puVar3;
        uStack_58 = (undefined5)puVar3[1];
        uStack_53 = (undefined3)*(undefined8 *)((long)puVar3 + 0xd);
        uStack_50 = (undefined5)((ulong)*(undefined8 *)((long)puVar3 + 0xd) >> 0x18);
        break;
      case '\x04':
        iVar4 = rx_state_ensure(local_c8);
        iVar4 = test_true("test/quic_record_test.c",0x73a,"rx_state_ensure(&s)",iVar4 != 0);
        if (iVar4 == 0) goto LAB_00101505;
        iVar4 = ossl_quic_demux_inject
                          (local_c8[0],*(undefined8 *)(pcVar8 + 8),*(undefined8 *)(pcVar8 + 0x10),0,
                           0);
        iVar4 = test_true("test/quic_record_test.c",0x73c,
      ...
      case '\x05':
        iVar4 = rx_state_ensure(local_c8);
        iVar4 = test_true("test/quic_record_test.c",0x723,"rx_state_ensure(&s)",iVar4 != 0);
        if (iVar4 == 0) goto LAB_00101505;
        iVar4 = ossl_qrx_provide_secret
                          (local_c8[1],*(undefined4 *)(pcVar8 + 0x20),*(undefined4 *)(pcVar8 + 0x24)
                           ,0,*(undefined8 *)(pcVar8 + 8));
        iVar4 = test_true("test/quic_record_test.c",0x725,
      ...
      case '\x06':
        iVar4 = rx_state_ensure(local_c8);
        iVar4 = test_true("test/quic_record_test.c",0x72c,"rx_state_ensure(&s)",iVar4 != 0);
        if (iVar4 == 0) goto LAB_00101505;
        iVar4 = ossl_quic_provide_initial_secret(0,0,*(undefined8 *)(pcVar8 + 0x30),0,local_c8[1],0)
        ;
        iVar4 = test_true("test/quic_record_test.c",0x72e,
      ...
      case '\a':
        iVar4 = rx_state_ensure(local_c8);
        iVar4 = test_true("test/quic_record_test.c",0x734,"rx_state_ensure(&s)",iVar4 != 0);
        if (iVar4 == 0) goto LAB_00101505;
        iVar4 = ossl_qrx_discard_enc_level(local_c8[1],*(undefined4 *)(pcVar8 + 0x20));
        iVar4 = test_true("test/quic_record_test.c",0x736,
                          "ossl_qrx_discard_enc_level(s.qrx, op->enc_level)",iVar4 != 0);
        if (iVar4 == 0) {
          iVar4 = 0;
          goto LAB_00101505;
        }
      ...
      case '\b':
        iVar4 = rx_state_ensure(local_c8);
        iVar4 = test_true("test/quic_record_test.c",0x742,"rx_state_ensure(&s)",iVar4 != 0);
        if (iVar4 == 0) goto LAB_00101505;
        iVar4 = ossl_qrx_read_pkt(local_c8[1],&local_d0);
        iVar4 = test_true("test/quic_record_test.c",0x745,"ossl_qrx_read_pkt(s.qrx, &pkt)",
                          iVar4 != 0);
        if ((((iVar4 == 0) ||
             (iVar4 = test_ptr("test/quic_record_test.c",0x748,&_LC84,local_d0), iVar4 == 0)) ||
            (iVar4 = test_ptr("test/quic_record_test.c",0x748,"pkt->hdr",*local_d0), iVar4 == 0)) ||
           (iVar4 = test_mem_eq("test/quic_record_test.c",0x74b,"pkt->hdr->data","op->buf",
                                *(undefined8 *)(*local_d0 + 0x50),*(undefined8 *)(*local_d0 + 0x48),
                                *(undefined8 *)(pcVar8 + 8),*(undefined8 *)(pcVar8 + 0x10)),
           iVar4 == 0)) goto LAB_00101505;
        iVar4 = cmp_pkt_hdr_constprop_0
                          (*local_d0,*(undefined8 *)(pcVar8 + 0x18),*(undefined8 *)(pcVar8 + 8),
                           *(undefined8 *)(pcVar8 + 0x10));
        iVar4 = test_true("test/quic_record_test.c",0x74f,
                          "cmp_pkt_hdr(pkt->hdr, op->hdr, op->buf, op->buf_len, 1)",iVar4 != 0);
        if (iVar4 == 0) goto LAB_00101505;
        lVar6 = local_d0[7];
      ...
      case '\t':
        iVar4 = rx_state_ensure(local_c8);
        iVar4 = test_true("test/quic_record_test.c",0x759,"rx_state_ensure(&s)",iVar4 != 0);
        if (iVar4 == 0) goto LAB_00101505;
        iVar4 = ossl_qrx_read_pkt(local_c8[1],&local_d0);
        iVar4 = test_false("test/quic_record_test.c",0x75c,"ossl_qrx_read_pkt(s.qrx, &pkt)",
                           iVar4 != 0);
        if (iVar4 == 0) {
          iVar4 = 0;
          goto LAB_00101505;
      ...
      case '\n':
        iVar4 = rx_state_ensure(local_c8);
        iVar4 = test_true("test/quic_record_test.c",0x761,"rx_state_ensure(&s)",iVar4 != 0);
        if (iVar4 == 0) goto LAB_00101505;
        uVar2 = *(undefined8 *)(pcVar8 + 0x28);
        uVar5 = ossl_qrx_get_key_epoch(local_c8[1]);
        iVar4 = test_uint64_t_eq("test/quic_record_test.c",0x764,"ossl_qrx_get_key_epoch(s.qrx)",
                                 "op->largest_pn",uVar5,uVar2);
        if (iVar4 == 0) {
          iVar4 = 0;
          goto LAB_00101505;
        }
      ...
      case '\v':
        iVar4 = rx_state_ensure(local_c8);
        iVar4 = test_true("test/quic_record_test.c",0x772,"rx_state_ensure(&s)",iVar4 != 0);
        if (iVar4 == 0) goto LAB_00101505;
        iVar4 = ossl_qrx_key_update_timeout(local_c8[1],*(undefined4 *)(pcVar8 + 0x20));
        iVar4 = test_true("test/quic_record_test.c",0x775,
                          "ossl_qrx_key_update_timeout(s.qrx, op->enc_level)",iVar4 != 0);
        if (iVar4 == 0) {
          iVar4 = 0;
          goto LAB_00101505;
        }
      ...
      case '\f':
        ...
        local_78 = (undefined1)*(undefined4 *)(pcVar8 + 0x20);
        break;
      case '\r':
        iVar4 = rx_state_ensure(local_c8);
        iVar4 = test_true("test/quic_record_test.c",0x76a,"rx_state_ensure(&s)",iVar4 != 0);
        if (iVar4 != 0) {
          iVar4 = test_uint64_t_eq("test/quic_record_test.c",0x76d,"last_key_epoch","op->largest_pn"
                                   ,lVar6,*(undefined8 *)(pcVar8 + 0x28));
          goto joined_r0x00101484;
        }
        goto LAB_00101505;
      case '\x0e':
        local_48 = 1;
        iVar4 = rx_state_ensure(local_c8);
        iVar4 = test_true("test/quic_record_test.c",0x781,"rx_state_ensure(&s)",iVar4 != 0);
joined_r0x00101484:
        if (iVar4 == 0) goto LAB_00101505;
        break;
      default:

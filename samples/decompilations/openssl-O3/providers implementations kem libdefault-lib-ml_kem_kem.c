...
undefined8 ml_kem_encapsulate_init(long *param_1,long param_2,long *param_3)
    ...
    if (iVar1 != 0) {
      ...
      *(undefined4 *)(param_1 + 6) = 0x1000;
      if ((param_3 != (long *)0x0) && (*param_3 != 0)) {
        ...
        if (lVar2 != 0) {
          param_1[5] = (long)(param_1 + 1);
          local_28 = 0x20;
          iVar1 = OSSL_PARAM_get_octet_string(lVar2,param_1 + 5,0x20,&local_28);
          if ((iVar1 != 0) && (uVar3 = 1, local_28 == 0x20)) goto LAB_0010055b;
          ERR_new();
          ERR_set_debug("providers/implementations/kem/ml_kem_kem.c",0x7f,"ml_kem_set_ctx_params");
          ERR_set_error(0x39,0x9a,0);
          param_1[5] = 0;
...
undefined8 ml_kem_decapsulate_init(long *param_1,long param_2,long *param_3)
  ...
  if (*(long *)(param_2 + 0x50) == 0) {
    ...
    if (iVar1 != 0) {
      ...
      *(undefined4 *)(param_1 + 6) = 0x2000;
      ...
      if (((param_3 != (long *)0x0) && (*param_3 != 0)) && ((int)param_1[6] == 0x1000)) {
        lVar3 = OSSL_PARAM_locate_const(param_3,&_LC0);
        if (lVar3 != 0) {
          param_1[5] = (long)(param_1 + 1);
          local_28 = 0x20;
          iVar1 = OSSL_PARAM_get_octet_string(lVar3,param_1 + 5,0x20,&local_28);
          if ((iVar1 != 0) && (uVar2 = 1, local_28 == 0x20)) goto LAB_001006b7;
          ERR_new();
          ERR_set_debug("providers/implementations/kem/ml_kem_kem.c",0x7f,"ml_kem_set_ctx_params");
          ERR_set_error(0x39,0x9a,0);
          param_1[5] = 0;

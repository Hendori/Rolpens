...
long ossl_cmp_genm_new(long param_1)

{
  ...
  lVar3 = ossl_cmp_msg_create(param_1,0x15);
  if (lVar3 != 0) {
    if (((lVar1 == 0) || (iVar2 = ossl_cmp_msg_gen_push1_ITAVs(lVar3,lVar1), iVar2 != 0)) &&
       (iVar2 = ossl_cmp_msg_protect(param_1,lVar3), iVar2 != 0)) {
      return lVar3;
    }
    ERR_new();
    ERR_set_debug("crypto/cmp/cmp_msg.c",0x2ff,"gen_new");
    ERR_set_error(0x3a,0x77,0);
    OSSL_CMP_MSG_free(lVar3);
  }
  return 0;
}
...
long ossl_cmp_genp_new(long param_1,long param_2)

{
  ...
  lVar2 = ossl_cmp_msg_create(param_1,0x16);
  if (lVar2 != 0) {
...
LAB_001019c7:
      ...
      goto LAB_00101918;
      if (pcVar7 != (char *)0x0) goto LAB_001019c7;
    }
    if (param_4 != 0) goto LAB_001018e6;
  }
  else {
LAB_001018c8:
    if (param_4 != 0) {
...
LAB_00101bf8:
        ...
        if (iVar1 == 0) goto LAB_00101bf8;
        *(undefined8 *)(lVar3 + 0x18) = 0;
        a = (ASN1_OCTET_STRING *)
            X509_digest_sig(*(undefined8 *)(param_1 + 0x1e8),&local_48,&local_4c);
        if (a == (ASN1_OCTET_STRING *)0x0) goto LAB_00101bf8;
        if (local_4c == 0) {
LAB_00101ba4:
...
undefined1  [16] ossl_cmp_pollrepcontent_get0_pollrep(long param_1,int param_2)

{
  ...
  if (param_1 != 0) {
    if (param_2 == -1) {
      ...
      if (0 < iVar3) {
        auVar4 = OPENSSL_sk_value(param_1,0);
        return auVar4;
      }
    }
    else {
      ...
      while( true ) {
        ...
        else if (param_2 == iVar1) goto LAB_00102002;
        iVar3 = iVar3 + 1;
      }
    }
    ERR_new();
...
undefined1  [16] ossl_cmp_certrepmessage_get0_certresponse(long param_1,int param_2)

{
  ...
  if ((param_1 != 0) && (lVar4 = *(long *)(param_1 + 8), lVar4 != 0)) {
    if (param_2 == -1) {
      iVar3 = OPENSSL_sk_num();
      if (0 < iVar3) {
        auVar5 = OPENSSL_sk_value(*(undefined8 *)(param_1 + 8),0);
        return auVar5;
      }
    }
    else {
      ...
      while( true ) {
        ...
        else if (param_2 == iVar1) goto LAB_001020fb;

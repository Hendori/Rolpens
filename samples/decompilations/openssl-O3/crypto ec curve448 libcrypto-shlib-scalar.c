...

{
  ...
  do {
    ...
    auVar28._8_8_ = 0;
    auVar28._0_8_ =
         SUB168(ZEXT816(0x2378c292ab5844f3) * auVar15,8) +
         (ulong)CARRY8(uVar46,SUB168(ZEXT816(0x2378c292ab5844f3) * auVar15,0));
  ...
  uVar48 = ((long)uVar48 >> 0x3f) + (ulong)CARRY8(uVar48,local_d8) + -1 +
           (ulong)(0x216cc2728dc58f54 < uVar48 + local_d8);
  uVar53 = local_c8 + uVar48 + 0x3bb124b65129c970;
  uVar48 = ((long)uVar48 >> 0x3f) + (ulong)CARRY8(local_c8,uVar48) + -1 +
           (ulong)(0xc44edb49aed6368f < local_c8 + uVar48);
  uVar51 = uVar48 + local_a8 + 0x8335dc17;
  uVar48 = ((long)uVar48 >> 0x3f) + (ulong)CARRY8(uVar48,local_a8) + -1 +
           (ulong)(0xffffffff7cca23e8 < uVar48 + local_a8);
  uVar52 = local_98 + uVar48 + 1;
  uVar48 = ((long)uVar48 >> 0x3f) + (ulong)CARRY8(local_98,uVar48) + -1 +
           (ulong)(0xfffffffffffffffe < local_98 + uVar48);
  uVar49 = local_b0 + uVar48 + 1;
  uVar50 = ((long)uVar48 >> 0x3f) + (ulong)CARRY8(local_b0,uVar48) + -1 +
           (ulong)(0xfffffffffffffffe < local_b0 + uVar48);
  local_b8 = local_b8 +
             ((long)uVar50 >> 0x3f) + (ulong)CARRY8(local_f8,uVar50) + -1 +
             (ulong)(0x3ffffffffffffffe < local_f8 + uVar50);
  ...
  *param_1 = local_e8 + 0xdc873d6d54a7bb0d + (local_b8 & 0x2378c292ab5844f3);
  ...
  param_1[6] = (ulong)CARRY8(uVar49,uVar46) + (ulong)CARRY8(uVar48,local_b8) +
               local_f8 + uVar50 + 0xc000000000000001 + (local_b8 & 0x3fffffffffffffff);
  return;
}
...

{
  ...
  *param_1 = (uVar1 - uVar2) + (uVar10 & 0x2378c292ab5844f3);
  ...
  param_1[6] = (uVar8 - uVar5) + (ulong)CARRY8(uVar2,uVar9) + (ulong)CARRY8(uVar10,uVar1) +
...

{
  ...
  uVar3 = ((long)uVar3 >> 0x3f) + (ulong)CARRY8(uVar10,uVar3) + -1 +
          (ulong)(0x216cc2728dc58f54 < uVar9);
  uVar9 = uVar12 + uVar3;
  uVar13 = uVar9 + 0x3bb124b65129c970;
  uVar10 = ((long)uVar3 >> 0x3f) + (ulong)CARRY8(uVar12,uVar3) + -1 +
           (ulong)(0xc44edb49aed6368f < uVar9);
  uVar3 = uVar4 + uVar10;
  uVar9 = uVar3 + 0x8335dc17;
  uVar3 = ((long)uVar10 >> 0x3f) + (ulong)CARRY8(uVar4,uVar10) + -1 +
          (ulong)(0xffffffff7cca23e8 < uVar3);
  uVar4 = uVar3 + uVar5;
  uVar12 = uVar4 + 1;
  uVar4 = ((long)uVar3 >> 0x3f) + (ulong)CARRY8(uVar3,uVar5) + -1 +
          (ulong)(0xfffffffffffffffe < uVar4);
  uVar3 = uVar4 + uVar6;
  uVar10 = uVar3 + 1;
  uVar3 = ((long)uVar4 >> 0x3f) + (ulong)CARRY8(uVar4,uVar6) + -1 +
          (ulong)(0xfffffffffffffffe < uVar3);
  uVar5 = uVar3 + uVar1;
  uVar1 = (ulong)CARRY8(param_3[6],param_2[6]) + (ulong)CARRY8(uVar7,uVar8) +
          ((long)uVar3 >> 0x3f) + (ulong)CARRY8(uVar3,uVar1) + -1 +
          (ulong)(0x3ffffffffffffffe < uVar5);
  ...
  *param_1 = uVar2 + (uVar1 & 0x2378c292ab5844f3);
  ...
  param_1[6] = uVar5 + 0xc000000000000001 + (ulong)CARRY8(uVar10,uVar9) + (ulong)CARRY8(uVar3,uVar1)
...

{
  ...
  if (lVar9 != 5) {
    ...
    *(undefined8 *)((long)puVar2 + ((uVar7 & 0xffffffff) - 8)) = 0;
    uVar6 = (int)uVar7 + ((int)puVar2 - (int)((ulong)(puVar2 + 1) & 0xfffffffffffffff8)) &
            0xfffffff8;
    if (7 < uVar6) {
      uVar4 = 0;
      do {
...
LAB_00100b76:
  uVar7 = (ulong)(0x2378c292ab5844f2 < *param_1) - 1;
  uVar7 = ((long)uVar7 >> 0x3f) + (ulong)CARRY8(uVar7,param_1[1]) + -1 +
          (ulong)(0x216cc2728dc58f54 < uVar7 + param_1[1]);
  uVar7 = ((long)uVar7 >> 0x3f) + (ulong)CARRY8(uVar7,param_1[2]) + -1 +
          (ulong)(0xc44edb49aed6368f < uVar7 + param_1[2]);
  uVar7 = ((long)uVar7 >> 0x3f) + (ulong)CARRY8(uVar7,param_1[3]) + -1 +
          (ulong)(0xffffffff7cca23e8 < uVar7 + param_1[3]);
  uVar7 = ((long)uVar7 >> 0x3f) + (ulong)CARRY8(uVar7,param_1[4]) + -1 +
          (ulong)(0xfffffffffffffffe < uVar7 + param_1[4]);
  uVar8 = ((long)uVar7 >> 0x3f) + (ulong)CARRY8(uVar7,param_1[5]) + -1 +
          (ulong)(0xfffffffffffffffe < uVar7 + param_1[5]);
  uVar7 = param_1[6];
  uVar5 = param_1[6];
...

{
  *param_1 = (char)*param_2;
  ...
  param_1[8] = (char)param_2[1];
  param_1[9] = (char)((ulong)param_2[1] >> 8);
  param_1[10] = (char)((ulong)param_2[1] >> 0x10);
  param_1[0xb] = (char)((ulong)param_2[1] >> 0x18);
  param_1[0xc] = (char)*(undefined4 *)((long)param_2 + 0xc);
  param_1[0xd] = (char)((ulong)param_2[1] >> 0x28);
  param_1[0xe] = (char)*(undefined2 *)((long)param_2 + 0xe);
  param_1[0xf] = *(undefined1 *)((long)param_2 + 0xf);
  param_1[0x10] = (char)param_2[2];
  param_1[0x11] = (char)((ulong)param_2[2] >> 8);
  param_1[0x12] = (char)((ulong)param_2[2] >> 0x10);
  param_1[0x13] = (char)((ulong)param_2[2] >> 0x18);
  param_1[0x14] = (char)*(undefined4 *)((long)param_2 + 0x14);
  param_1[0x15] = (char)((ulong)param_2[2] >> 0x28);
  param_1[0x16] = (char)*(undefined2 *)((long)param_2 + 0x16);
  param_1[0x17] = *(undefined1 *)((long)param_2 + 0x17);
  param_1[0x18] = (char)param_2[3];
  param_1[0x19] = (char)((ulong)param_2[3] >> 8);
  param_1[0x1a] = (char)((ulong)param_2[3] >> 0x10);
  param_1[0x1b] = (char)((ulong)param_2[3] >> 0x18);
  param_1[0x1c] = (char)*(undefined4 *)((long)param_2 + 0x1c);
  param_1[0x1d] = (char)((ulong)param_2[3] >> 0x28);
  param_1[0x1e] = (char)*(undefined2 *)((long)param_2 + 0x1e);
  param_1[0x1f] = *(undefined1 *)((long)param_2 + 0x1f);
  param_1[0x20] = (char)param_2[4];
  param_1[0x21] = (char)((ulong)param_2[4] >> 8);
  param_1[0x22] = (char)((ulong)param_2[4] >> 0x10);
  param_1[0x23] = (char)((ulong)param_2[4] >> 0x18);
  param_1[0x24] = (char)*(undefined4 *)((long)param_2 + 0x24);
  param_1[0x25] = (char)((ulong)param_2[4] >> 0x28);
  param_1[0x26] = (char)*(undefined2 *)((long)param_2 + 0x26);
  param_1[0x27] = *(undefined1 *)((long)param_2 + 0x27);
  param_1[0x28] = (char)param_2[5];
  param_1[0x29] = (char)((ulong)param_2[5] >> 8);
  param_1[0x2a] = (char)((ulong)param_2[5] >> 0x10);
  param_1[0x2b] = (char)((ulong)param_2[5] >> 0x18);
  param_1[0x2c] = (char)*(undefined4 *)((long)param_2 + 0x2c);
  param_1[0x2d] = (char)((ulong)param_2[5] >> 0x28);
  param_1[0x2e] = (char)*(undefined2 *)((long)param_2 + 0x2e);
  param_1[0x2f] = *(undefined1 *)((long)param_2 + 0x2f);
  param_1[0x30] = (char)param_2[6];
  param_1[0x31] = (char)((ulong)param_2[6] >> 8);
  param_1[0x32] = (char)((ulong)param_2[6] >> 0x10);
  param_1[0x33] = (char)((ulong)param_2[6] >> 0x18);
  param_1[0x34] = (char)*(undefined4 *)((long)param_2 + 0x34);
  param_1[0x35] = (char)((ulong)param_2[6] >> 0x28);
  param_1[0x36] = (char)*(undefined2 *)((long)param_2 + 0x36);
  param_1[0x37] = *(undefined1 *)((long)param_2 + 0x37);
  return;
}
...

{
  ...
  *param_1 = *param_1 >> 1 | param_1[1] << 0x3f;
  ...
  uVar6 = param_1[6];
  param_1[6] = uVar2 >> 1 |
               (ulong)CARRY8(uVar1 & 0x3fffffffffffffff,uVar3) + (ulong)CARRY8(uVar4,uVar5) << 0x3f;

...

{
  ...
  if (param_3 < 0) {
    ...
    if ((((((bVar1 ^ (byte)pbVar2->num_write) & 4) != 0) && (pbVar2 != pbVar3)) &&
        (pbVar9 != pbVar13)) && (iVar6 = CRYPTO_THREAD_write_lock(pbVar13->num_read), iVar6 != 0)) {
...
LAB_0010036a:
          ...
          if (((pbVar9 == (bio_st *)0x0) ||
              ((pbVar13 = pbVar9, pbVar9->method != (BIO_METHOD *)0x0 &&
               (pbVar13 = (bio_st *)pbVar9->method->destroy, pbVar13 == (bio_st *)0x0)))) ||
             (pbVar13->callback == (_func_603 *)0x0)) goto LAB_00100338;
          ...
          uVar12 = local_128[0];
          if ((local_128[0] < uVar11) || (uVar12 = uVar11, local_128[0] <= uVar11)) {
...
LAB_00100338:
            ...
            if ((uVar11 != uVar8) ||
               (lVar7 = dgram_pair_read_inner(pbVar13,0,local_128[0] - uVar11),
               local_128[0] - uVar11 != lVar7)) goto LAB_00100338;
          }
        }
...
LAB_00100687:
        iVar1 = ring_buf_resize(param_1 + 8,uVar4);
        if (iVar1 == 0) {
          return local_40;
        }
        uVar2 = *(ulong *)(param_1 + 0x10);
...
LAB_001006b5:
        ...
        *(ulong *)(param_1 + 0x20) = uVar4;
        ...
        uVar2 = *(ulong *)(param_1 + 0x10);
        uVar4 = *(ulong *)(param_1 + 0x20);
        if ((__n <= uVar2 - uVar4) && (uVar3 = *(long *)(param_1 + 0x18) + __n, uVar3 <= uVar2))
        goto LAB_001006b5;
      }
...
LAB_001009ad:
        ...
        if (puVar3 == (undefined8 *)0x0) {
          ...
          local_128[1] = *puVar3;
          local_128[2] = puVar3[1];
          local_128[3] = puVar3[2];
          local_128[4] = puVar3[3];
          local_128[5] = puVar3[4];
          local_128[6] = puVar3[5];
          local_128[7] = puVar3[6];
          local_128[8] = puVar3[7];
          local_128[9] = puVar3[8];
          local_128[10] = puVar3[9];
          local_128[0xb] = puVar3[10];
          local_128[0xc] = puVar3[0xb];
          local_128[0xd] = puVar3[0xc];
          local_128[0xe] = puVar3[0xd];
        }
        iVar7 = pbVar2->init;
  ...
  if (param_2 != 0x8a) {
    if (param_2 == 0x8b) {
      ...
      *(undefined4 *)(param_1 + 0x28) = 0;
      BIO_ADDR_free(lVar4);
      lVar4 = *plVar1;
      if ((lVar4 != 0) && (plVar2 = *(long **)(lVar4 + 0x40), param_1 == *plVar2)) {
  ...
  if (param_1 != 0) {
    ...
    if (ptr == (long *)0x0) {
      ...
      *(undefined4 *)(param_1 + 0x28) = 0;
      BIO_ADDR_free(lVar1);
      lVar1 = *ptr;
      if ((lVar1 != 0) && (plVar2 = *(long **)(lVar1 + 0x40), param_1 == *plVar2)) {
        CRYPTO_free((void *)plVar2[1]);
        plVar2[1] = 0;
        *(undefined1 (*) [16])(plVar2 + 2) = (undefined1  [16])0x0;
...
undefined4
dgram_pair_sendmmsg(long param_1,long *param_2,long param_3,long param_4,undefined8 param_5,
                   long *param_6)
...
LAB_001015fc:
        ...
        if (puVar2 != (undefined8 *)0x0) {
          if ((*(byte *)(plVar7 + 8) & 2) != 0) {
            ...
            local_128[0x10] = puVar2[1];
            local_128[0x11] = puVar2[2];
            local_128[0x12] = puVar2[3];
            local_128[0x13] = puVar2[4];
            local_128[0x14] = puVar2[5];
            local_128[0x15] = puVar2[6];
            local_128[0x16] = puVar2[7];
            local_128[0x17] = puVar2[8];
            local_128[0x18] = puVar2[9];
            local_128[0x19] = puVar2[10];
            local_128[0x1a] = puVar2[0xb];
            local_128[0x1b] = puVar2[0xc];
            local_128[0x1c] = puVar2[0xd];
...
LAB_0010150a:
          local_128[1] = *puVar9;
          local_128[2] = puVar9[1];
          local_128[3] = puVar9[2];
          local_128[4] = puVar9[3];
          local_128[5] = puVar9[4];
          local_128[6] = puVar9[5];
          local_128[7] = puVar9[6];
          local_128[8] = puVar9[7];
          local_128[9] = puVar9[8];
          local_128[10] = puVar9[9];
          local_128[0xb] = puVar9[10];
          local_128[0xc] = puVar9[0xb];
          local_128[0xd] = puVar9[0xc];
          local_128[0xe] = puVar9[0xd];
        }
        lVar3 = plVar12[3];
        lVar4 = plVar12[4];
        local_128[0] = lVar13;
...
undefined8
dgram_pair_recvmmsg(long param_1,long *param_2,long param_3,long param_4,undefined8 param_5,
                   long *param_6)
...
LAB_00101c9b:
          ...
          uVar12 = local_128;
          if ((local_128 < uVar10) || (uVar12 = uVar10, local_128 <= uVar10)) {
            ...
            if ((uVar10 != uVar8) ||
               (lVar9 = dgram_pair_read_inner(plVar14,0,lVar7), lVar7 != lVar9)) goto LAB_00101ae0;
          }
...
LAB_00101b03:
        uVar11 = 1;
LAB_00101b08:
        CRYPTO_THREAD_unlock(plVar13[10]);
        goto LAB_00101b11;
      }
      ERR_new();
...
LAB_00101eb2:
        ...
        if ((pbVar11 == (bio_st *)0x0) || (pbVar11->callback == (_func_603 *)0x0))
        goto LAB_00101e80;
LAB_00101d98:
        ...
        uVar10 = local_128[0];
        if ((local_128[0] < uVar9) || (uVar10 = uVar9, local_128[0] <= uVar9)) {
          ...
          if ((uVar9 != uVar7) ||
             (lVar6 = dgram_pair_read_inner(pbVar11,0,local_128[0] - uVar9),
             local_128[0] - uVar9 != lVar6)) goto LAB_00101e80;
        }
      }
      CRYPTO_THREAD_unlock(pbVar1->num_read);
      goto LAB_00101e2c;

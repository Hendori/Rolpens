...

{
  ...
  if ((uVar2 & 0x48) != 0) {
    ...
    local_e0 = 0;
LAB_00100590:
    if (((*(byte *)(lVar19 + 0x20) & 0x44) == 0) && ((*(uint *)(lVar19 + 0x1c) & 0x1c8) == 0)) {
LAB_0010090d:
      if (local_100 != 0) goto LAB_001005a3;
      ERR_new();
      uVar9 = 0;
...
LAB_0010061b:
        ...
        if ((uVar2 & 0x102) == 0) {
          do {
            ...
            if ((iVar7 == 0) || (iVar7 = WPACKET_close(param_2), iVar7 == 0)) goto LAB_001012da;
            lVar1 = lVar19 * 8;
            lVar19 = lVar19 + 1;
      ...
      if (__s == (char *)0x0) {
        sVar14 = 0;
LAB_001005e8:
        iVar7 = WPACKET_sub_memcpy__(param_2,__s,sVar14,2);
...
LAB_00100afa:
    ...
    do {
      ...
      if ((iVar8 == 0) || (iVar8 = WPACKET_close(param_2), iVar8 == 0)) goto LAB_001012da;
      a = (BIGNUM *)*plVar18;
      iVar7 = iVar7 + 1;
      plVar18 = plVar18 + 1;
...
LAB_001006ba:
    if ((uVar2 & 0x84) != 0) {
      ...
      if ((((iVar7 == 0) || (iVar7 = WPACKET_put_bytes__(param_2,0,1), iVar7 == 0)) ||
          (iVar7 = WPACKET_put_bytes__(param_2,uVar10,1), iVar7 == 0)) ||
         (iVar7 = WPACKET_sub_memcpy__(param_2,local_b0,local_e0,1), iVar7 == 0)) {
        ERR_new();
        uVar16 = 0xace;
        goto LAB_00100723;
      }
...
LAB_0010153a:
    ...
    local_70 = (uchar *)0x0;
    if ((lVar19 == 0) || (iVar7 = tls1_lookup_md(puVar3,local_100,&local_90), iVar7 == 0)) {
      ERR_new();
      uVar16 = 0xade;
      goto LAB_00100723;
    }
    ...
    if (((*(byte *)(*(long *)(*(long *)(param_1 + 0x18) + 0xd8) + 0x50) & 2) != 0) &&
       (iVar7 = WPACKET_put_bytes__(param_2,*(undefined2 *)(local_100 + 0x10),2), iVar7 == 0)) {
      ERR_new();
      uVar16 = 0xae8;
      goto LAB_00100723;
    }
    ...
    if ((*(int *)(local_100 + 0x1c) == 0x390) &&
       ((iVar7 = EVP_PKEY_CTX_set_rsa_padding(local_a8,6), iVar7 < 1 ||
        (iVar7 = EVP_PKEY_CTX_set_rsa_pss_saltlen(local_a8,0xffffffff), iVar7 < 1)))) {
      ERR_new();
      ERR_set_debug("ssl/statem/statem_srvr.c",0xaf6,"tls_construct_server_key_exchange");
      ossl_statem_fatal(param_1,0x50,0x80006,0);
    }
    else {
      lVar19 = construct_key_exchange_tbs
                         (param_1,&local_78,local_98 + *(long *)(*(long *)(param_1 + 0xf8) + 8),
                          local_a0);
      if (lVar19 != 0) {
        iVar7 = EVP_DigestSign(lVar13,0,&local_70,local_78,lVar19);
        if ((((0 < iVar7) &&
             (iVar7 = WPACKET_sub_reserve_bytes__(param_2,local_70,&local_88,2), iVar7 != 0)) &&
            (iVar7 = EVP_DigestSign(lVar13,local_88,&local_70,local_78,lVar19), 0 < iVar7)) &&
           ((iVar7 = WPACKET_sub_allocate_bytes__(param_2,local_70,&local_80,2), iVar7 != 0 &&
            (local_88 == local_80)))) {
...
LAB_0010083b:
  ...
  *(long *)(param_1 + 0x308) = lVar19;
  ...
  if (((iVar7 != 0) &&
      (iVar7 = EVP_PKEY_get_bn_param(*(undefined8 *)(param_1 + 0x308),&_LC2,local_68 + 8),
      iVar7 != 0)) &&
     (iVar7 = EVP_PKEY_get_bn_param(*(undefined8 *)(param_1 + 0x308),&_LC3,local_58), iVar7 != 0)) {
    bVar5 = true;
    lVar19 = *(long *)(param_1 + 0x300);
    uVar10 = 0;
    local_e0 = 0;
...
LAB_00102230:
        ...
        if (iVar4 != 0) {
          ...
          *(undefined4 *)(lVar8 + 0x340) = local_74;
          ...
          iVar4 = tls13_hkdf_expand(param_1,uVar11,param_1 + 0x63c,"resumption",10,&local_70,8,
                                    lVar8 + 0x50,(long)iVar3,1);
          if (iVar4 != 0) {
            lVar8 = *(long *)(param_1 + 0x900);
            ...
            *(undefined8 *)(lVar8 + 0x2e0) = uVar7;
            ...
            if (*(long *)(param_1 + 0x4b8) != 0) {
              ...
              lVar8 = *(long *)(param_1 + 0x900);
              uVar11 = CRYPTO_memdup(*(undefined8 *)(param_1 + 0x4b8),
...
LAB_001020be:
      ...
      if (local_f8 == (EVP_CIPHER_CTX *)0x0) {
        ...
        if (local_f0 == 0) {
          ...
          uVar11 = 0x80014;
LAB_001023c0:
          ossl_statem_fatal(param_1,0x50,uVar11,0);
LAB_001023cf:
          iVar3 = 0;
        }
        else {
...
LAB_00101f4d:
                iVar3 = (*pcVar6)(uVar11,&local_58,local_68,local_f8,uVar7,1);
                if (iVar3 == 0) {
                  if ((((*(byte *)(*(long *)(*(int **)(param_1 + 0x18) + 0x36) + 0x50) & 8) == 0) &&
...
LAB_0010274a:
              ...
              if (((iVar5 < 1) ||
                  (iVar5 = EVP_EncryptInit_ex(local_f8,cipher,(ENGINE *)0x0,
                                              (uchar *)(*(long *)(lVar12 + 0x250) + 0x20),local_68),
                  iVar5 == 0)) ||
                 (iVar5 = ssl_hmac_init(local_f0,*(undefined8 *)(lVar12 + 0x250),0x20,"SHA256"),
                 iVar5 == 0)) goto LAB_0010274a;
              EVP_CIPHER_free(cipher);
              local_58 = *(undefined8 *)(lVar12 + 0x240);
              uStack_50 = *(undefined8 *)(lVar12 + 0x248);
LAB_00101f99:
              iVar5 = create_ticket_prequel(param_1,param_2,uVar10,&local_70);
              if (iVar5 != 0) {
                iVar5 = WPACKET_get_total_written(param_2,&local_88);
                if (((iVar5 != 0) && (iVar5 = WPACKET_memcpy(param_2,&local_58,0x10), iVar5 != 0))
                   && (iVar3 = WPACKET_memcpy(param_2,local_68,(long)iVar3), iVar3 != 0)) {
                  iVar3 = WPACKET_reserve_bytes(param_2,(long)(iVar4 + 0x20),&local_b8);
                  if ((iVar3 != 0) &&
                     (iVar3 = EVP_EncryptUpdate(local_f8,local_b8,&local_c8,in,iVar4), iVar3 != 0))
                  {
                    iVar3 = WPACKET_allocate_bytes(param_2,(long)local_c8,&local_b0);
                    if (((((iVar3 != 0) &&
                          ((local_b8 == local_b0 &&
                           (iVar3 = EVP_EncryptFinal(local_f8,local_b8 + local_c8,&local_c4),
                           iVar3 != 0)))) &&
                        ...
                        (((((local_b0 == local_b8 + local_c8 &&
                          ...
                          ((iVar3 = ssl_hmac_update(local_f0,local_88 +
                                                             *(long *)(*(long *)(param_1 + 0xf8) + 8
                                                                      ),local_80 - local_88),
                           iVar3 != 0 &&
                           (iVar3 = WPACKET_reserve_bytes(param_2,0x40,&local_a8), iVar3 != 0)))) &&
                         ((iVar3 = ssl_hmac_final(local_f0,local_a8,&local_90,0x40), iVar3 != 0 &&
                          ((local_90 < 0x41 &&
                           (iVar3 = WPACKET_allocate_bytes(param_2,local_90,&local_a0), iVar3 != 0))
                          )))))) && (local_a8 == local_a0)) {
                      iVar3 = 1;
...
LAB_001020d0:
    ...
    pcVar6 = *(code **)(lVar12 + 0x428);
    if (pcVar6 == (code *)0x0) goto LAB_00101e1a;
LAB_00101d21:
    iVar3 = (*pcVar6)(*(undefined8 *)(param_1 + 0x40));
    if (iVar3 != 0) {
LAB_00101d36:
      if ((*(byte *)(*(long *)(*(int **)(param_1 + 0x18) + 0x36) + 0x50) & 8) != 0) {
LAB_00102390:
      ...
      iVar3 = WPACKET_memcpy(param_2,*(long *)(param_1 + 0x900) + 600,
...
LAB_00102160:
    ...
    uVar11 = 0x10b0;
LAB_001021a9:
    ERR_set_debug("ssl/statem/statem_srvr.c",uVar11,pcVar9);
    ossl_statem_fatal(param_1,0x50,0xc0103,0);
  }
LAB_00101dc0:
  uVar10 = 0;
...
switchD_00102a40_caseD_22:
  if (param_2 == 0x14) {
LAB_00102c31:
    *(undefined4 *)&param_1->field_0xac = 0x24;
    return 1;
  }
switchD_00102a40_caseD_2:
  ERR_new();
            ...
            if (bVar1 < 8) {
              if ((bVar1 & 4) == 0) {
                if ((bVar1 != 0) && (*pbVar12 = pbVar17[0x23], (bVar1 & 2) != 0)) {
                  *(undefined2 *)((long)ptr + uVar10 + 0x2e) =
                       *(undefined2 *)(pbVar17 + uVar10 + 0x21);
                }
              }
              else {
                *(undefined4 *)pbVar12 = *(undefined4 *)(pbVar17 + 0x23);
                *(undefined4 *)((long)ptr + uVar10 + 0x2c) =
                     *(undefined4 *)(pbVar17 + uVar10 + 0x1f);
              }
            }
            else {
              ...
              *(undefined8 *)((long)ptr + uVar10 + 0x28) = *(undefined8 *)(pbVar17 + uVar10 + 0x1b);
              ...
              for (uVar10 = (ulong)((uint)bVar1 + (int)lVar13 >> 3); uVar10 != 0;
                  uVar10 = uVar10 - 1) {
...
LAB_00104400:
                        ...
                        *(ulong *)(ptr + 0x5a) = uVar11;
                        ...
                        if (uVar15 < 8) {
                          if ((uVar11 & 4) == 0) {
                            if ((uVar15 != 0) && (*pbVar12 = *pbVar17, (uVar11 & 2) != 0)) {
                              *(undefined2 *)((long)ptr + uVar11 + 0x16e) =
                                   *(undefined2 *)(pbVar17 + (uVar11 - 2));
                            }
                          }
                          else {
                            *(undefined4 *)pbVar12 = *(undefined4 *)pbVar17;
                            *(undefined4 *)((long)ptr + uVar11 + 0x16c) =
                                 *(undefined4 *)(pbVar17 + (uVar11 - 4));
                          }
                        }
                        else {
                          *(undefined8 *)pbVar12 = *(undefined8 *)pbVar17;
                          *(undefined8 *)((long)ptr + uVar11 + 0x168) =
                               *(undefined8 *)(pbVar17 + (uVar11 - 8));
                          ...
                          for (uVar11 = (ulong)(uVar15 + (int)lVar13 >> 3); uVar11 != 0;
                              uVar11 = uVar11 - 1) {
                            *puVar18 = *(undefined8 *)pbVar17;
                            pbVar17 = pbVar17 + ((ulong)bVar21 * -2 + 1) * 8;
                            puVar18 = puVar18 + (ulong)bVar21 * -2 + 1;
                        ...
                        iVar6 = tls_collect_extensions
                                          (param_1,&local_48,0x80,ptr + 0xa2,ptr + 0xa0,1);
                        if (iVar6 != 0) {
                  ...
                  if (bVar1 < 8) {
                    if ((bVar1 & 4) == 0) {
                      if ((bVar1 != 0) && (*pbVar12 = *pbVar17, (bVar1 & 2) != 0)) {
                        *(undefined2 *)((long)ptr + uVar10 + 0x56) =
                             *(undefined2 *)((long)puVar19 + (uVar10 - 1));
                      }
                    }
                    else {
                      *(undefined4 *)pbVar12 = *(undefined4 *)pbVar17;
                      *(undefined4 *)((long)ptr + uVar10 + 0x54) =
                           *(undefined4 *)((long)puVar19 + (uVar10 - 3));
                    }
                  }
                  else {
                    *(undefined8 *)(ptr + 0x16) = *(undefined8 *)((long)puVar19 + 1);
                    *(undefined8 *)((long)ptr + uVar10 + 0x50) =
                         *(undefined8 *)((long)puVar19 + (uVar10 - 7));
                    lVar13 = (long)pbVar12 - (long)((ulong)(ptr + 0x18) & 0xfffffffffffffff8);
                    pbVar17 = pbVar17 + -lVar13;
                    puVar18 = (undefined8 *)((ulong)(ptr + 0x18) & 0xfffffffffffffff8);
                    for (uVar11 = (ulong)((uint)bVar1 + (int)lVar13 >> 3); uVar11 != 0;
                        uVar11 = uVar11 - 1) {
                      *puVar18 = *(undefined8 *)pbVar17;
                      pbVar17 = pbVar17 + ((ulong)bVar21 * -2 + 1) * 8;
                      puVar18 = puVar18 + (ulong)bVar21 * -2 + 1;
                ...
                if (uVar8 < 8) {
                  if ((uVar4 & 4) == 0) {
                    if ((uVar8 != 0) && (*pbVar12 = *pbVar17, (uVar4 & 2) != 0)) {
                      *(undefined2 *)((long)ptr + uVar9 + 0x2e) =
                           *(undefined2 *)(pbVar17 + (uVar9 - 2));
                    }
                  }
                  else {
                    *(undefined4 *)pbVar12 = *(undefined4 *)pbVar17;
                    *(undefined4 *)((long)ptr + uVar9 + 0x2c) =
                         *(undefined4 *)(pbVar17 + (uVar9 - 4));
                  }
                }
                else {
                  ...
                  *(undefined8 *)((long)ptr + uVar9 + 0x28) = *(undefined8 *)(pbVar17 + (uVar9 - 8))
                  ...
                  if (7 < uVar15) {
                    ...
                    do {
                      uVar20 = (ulong)uVar7;
                      uVar7 = uVar7 + 8;
                      *(undefined8 *)(((ulong)(ptr + 0xe) & 0xfffffffffffffff8) + uVar20) =
                           *(undefined8 *)(pbVar17 + (uVar20 - lVar13));
                    } while (uVar7 < uVar15);
                  }
                }
                      ...
                      *(undefined8 *)(ptr + 8) = *(undefined8 *)(pbVar17 + (uVar11 - 8));
                      ...
                      if (7 < uVar15) {
                        ...
                        do {
                          uVar10 = (ulong)uVar7;
                          uVar7 = uVar7 + 8;
                          *(undefined8 *)(uVar11 + uVar10) =
                               *(undefined8 *)(pbVar17 + (uVar10 - lVar13));
                        } while (uVar7 < uVar15);
                      }
                    }
                    ptr[0x9c] = 0;
...
LAB_00104b37:
              ...
              if (iVar12 < 0x304) {
LAB_00105680:
                if ((iVar12 == 0x10000) || (iVar12 < 0x304)) goto LAB_00104b51;
              }
              else {
                if (iVar12 != 0x10000) {
...
LAB_00104b51:
                if (*(int *)&param_1[1].tls_session_ticket_ext_cb != 0) goto LAB_0010556e;
              }
LAB_00104b61:
...
LAB_00105a93:
                          ...
                          if ((((*(byte *)(*(long *)&pBVar23[1].ex_data.dummy + 0x50) & 8) == 0) &&
                              (*(int *)&pBVar23->method != 0x10000)) &&
                             (0x303 < *(int *)&pBVar23->method)) goto LAB_00104c44;
                          goto LAB_00104c98;
                        }
...
LAB_00104d80:
      ...
      *(undefined4 *)((long)&param_1[3].tlsext_ecpointformatlist + 4) = 0;
      ...
      if (((((*(byte *)(*(long *)&param_1->wbio[1].ex_data.dummy + 0x50) & 8) == 0) &&
           (iVar12 = *(int *)&param_1->wbio->method, iVar12 != 0x10000)) && (0x303 < iVar12)) ||
         (iVar12 = tls_handle_alpn(param_1), iVar12 != 0)) goto LAB_00104e21;
    }
LAB_00104eb0:
    uVar16 = 0;
  }
            ...
            if ((uVar2 & 0x200) == 0) {
              ...
              if (iVar3 == 0) {
                ...
                if (iVar4 < 1) {
                  ...
                  if ((lVar17 == 0) && (lVar17 = *(long *)(lVar15 + 0xd0), lVar17 == 0)) {
                    ERR_new();
            ...
            if (pEVar5 == (EVP_PKEY_CTX *)0x0) {
              ...
              if (iVar3 < 1) {
                ...
                if ((pEVar11 != (EVP_PKEY *)0x0) &&
                   (iVar3 = EVP_PKEY_derive_set_peer(pEVar5,pEVar11), iVar3 < 1)) {
                  ERR_clear_error();
                }
                local_110 = *param_2;
                plVar12 = (long *)d2i_GOST_KX_MESSAGE(0,&local_110,param_2[1]);
                if (((plVar12 == (long *)0x0) || ((ASN1_TYPE *)*plVar12 == (ASN1_TYPE *)0x0)) ||
                   (iVar3 = ASN1_TYPE_get((ASN1_TYPE *)*plVar12), iVar3 != 0x10)) {
                  ERR_new();
                  uVar6 = 0xcce;
LAB_00106921:
          ...
          if (uVar8 - uVar14 == 0) {
            if (pEVar11 != (EVP_PKEY *)0x0) {
              ...
              if ((pEVar10 == (EVP_PKEY *)0x0) ||
                 (iVar3 = EVP_PKEY_copy_parameters(pEVar10,pEVar11), iVar3 < 1)) {
                ERR_new();
        ...
        if (uVar8 == (ushort)(uVar16 << 8 | uVar16 >> 8)) {
          ...
          if (uVar8 != 0) {
            ...
            *param_2 = (long)puVar19 + uVar8;
            pEVar10 = EVP_PKEY_new();
            if ((pEVar10 == (EVP_PKEY *)0x0) ||
               (iVar3 = EVP_PKEY_copy_parameters(pEVar10,pEVar11), iVar3 == 0)) {
              ERR_new();
...
LAB_00106479:
              ...
              *puVar7 = local_148;
              ...
              if ((iVar3 == 0) ||
                 (iVar3 = EVP_PKEY_decrypt(pEVar5,out,&local_110,(uchar *)puVar19,uVar8), iVar3 < 1)
                 ) {
                ERR_new();
                uVar6 = 0xbe6;
                goto LAB_00106479;
...
LAB_001074d0:
                  ...
                  uVar10 = (ulong)(byte)*puVar14 << 0x10 | (ulong)*(byte *)((long)puVar14 + 1) << 8
                           | (ulong)(byte)puVar14[1];
                  ...
                  if ((((*(byte *)(*(long *)(*(int **)(param_1 + 0x18) + 0x36) + 0x50) & 8) == 0) &&
                    ...
                    if (1 < uVar12) {
                      ...
                      if (uVar10 <= uVar12 - 2) {
                        ...
                        local_50 = uVar10;
                        iVar3 = tls_collect_extensions
                                          (param_1,&local_58,0x1000,&local_60,0,lVar11 == 0);
                        if (iVar3 != 0) {
                          iVar3 = tls_parse_all_extensions
                                            (param_1,0x1000,local_60,local_70,lVar11,uVar12 == 0);
                          if (iVar3 != 0) {
...
LAB_00107a8d:
                    ...
                    if ((((*(byte *)(*(long *)(*(int **)(param_1 + 0x18) + 0x36) + 0x50) & 8) == 0)
                        && (iVar3 = **(int **)(param_1 + 0x18), iVar3 != 0x10000)) &&
                       (0x303 < iVar3)) {

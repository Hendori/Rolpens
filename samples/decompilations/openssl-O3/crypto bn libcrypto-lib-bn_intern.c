    ...
    if (param_2 - 1U < 7) {
      ...
      if ((param_1->d != (ulong *)0x0) && (param_1->top != 0)) {
        ...
        if (puVar7 != (undefined1 *)0x0) {
          ...
          do {
            if (uVar11 == 0) {
              if (uVar6 <= (ulong)(param_2 + lVar12)) {
                if (lVar12 - 1U <= uVar6 + 1) {
                  *param_3 = lVar12 - 1U;
                  return puVar7;
                }
                ERR_new();
              ...
              if ((uVar11 & 1) != 0) {
                ...
                if ((uVar11 & uVar10) == 0) {
LAB_00100169:
                  if ((int)-uVar10 < (int)uVar8) goto LAB_00100176;
                }
                else {
                  if ((ulong)(param_2 + lVar12) < uVar6) {
                    uVar8 = uVar11 + uVar10 * -2;
                    goto LAB_00100169;
                  }
                  uVar8 = (int)(uVar1 - 1) >> 1 & uVar11;
LAB_00100176:
                  if (((int)uVar8 < (int)uVar10) && ((uVar8 & 1) != 0)) {
                    uVar11 = uVar11 - uVar8;
                    if ((uVar11 == 0 || uVar1 == uVar11) || (uVar10 == uVar11)) {
                      iVar4 = (int)uVar11 >> 1;
                      cVar2 = ((-(iVar3 == 0) & 2U) - 1) * (char)uVar8;
                      goto LAB_00100118;
                    }
                    ERR_new();
                    uVar9 = 0x6d;
...
LAB_00100118:
            puVar7[lVar12 + -1] = cVar2;
            iVar5 = (int)lVar12;
            lVar12 = lVar12 + 1;
            iVar5 = BN_is_bit_set(param_1,param_2 + iVar5);
            uVar11 = iVar4 + (iVar5 << ((byte)param_2 & 0x1f));

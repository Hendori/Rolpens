...

{
  ...
  local_a0 = 1;
  local_90 = __LC15;
  uStack_88 = _UNK_00104a68;
  local_68 = __LC15;
  uStack_60 = _UNK_00104a68;
  local_78 = 1;
  local_58 = 0;
  local_50 = 0;
  local_a8 = &_LC0;
...
LAB_00100ea0:
    ...
    do {
      uVar2 = *(undefined8 *)(&DAT_00104a28 + uVar4 * 8);
    ...
    if (iVar2 != 0) {
      ...
      if (iVar2 != 0) {
        if (uVar1 < 5) {
          ...
          iVar2 = test_mem_eq("test/params_api_test.c",0x96,&_LC105,&_LC104,local_58,4,param_2,4);
          if (iVar2 == 0) goto LAB_00101a20;
        }
        local_90 = local_58;
        local_58[0] = local_68;
        iVar2 = test_mem_eq("test/params_api_test.c",0x9b,&_LC105,&_LC104,local_90,param_3);
        if (iVar2 != 0) {
          if ((uVar1 < 9) && (iVar3 != 1)) {
            uVar4 = 0xa0;
            local_58[0] = local_60;
...
LAB_001019ec:
      ...
      if (iVar3 != 0) {
        ...
        local_58[0] = local_68;
LAB_00101b8e:
        iVar3 = test_mem_eq("test/params_api_test.c",uVar4,&_LC105,&_LC104,local_58,param_3,param_2,
                            param_3);
        if (iVar3 != 0) {
          if (param_3 == 8) goto LAB_00101cb0;
LAB_00101baa:
          local_a0 = &local_68;
...

{
  ...
  local_90 = __LC109;
  uStack_88 = _UNK_00104a78;
  iVar3 = test_int_eq("test/params_api_test.c",0x219,"test_param_type_null(&param)",&_LC7,1,1);
  if (iVar3 == 0) goto LAB_00101e32;
  local_90 = 0x14;
  local_98 = local_58;
  a = (BIGNUM *)BN_signed_lebin2bn(lVar6 + 0x104848,uVar2 & 0xffffffff,0);
...
LAB_00101ea3:
    ...
    cVar1 = *(char *)(lVar6 + 0x104847 + uVar2);
    ...
    iVar3 = test_mem_eq("test/params_api_test.c",0x228,"raw_values[n].value",&_LC105,
                        lVar6 + 0x104848,uVar2);
    if (iVar3 == 0) goto LAB_00101ea3;
    local_90 = uStack_88;
...
LAB_00101fcb:
    ...
    iVar3 = test_BN_eq("test/params_api_test.c",0x22c,&_LC1,&_LC116,a,local_b0);
    if (iVar3 == 0) goto LAB_00101fcb;
    iVar3 = 1;
  }
  BN_free(a);
  BN_free(local_b0);
...

{
  ...
  if (iVar1 != 0) {
    local_38 = &local_50;
    iVar1 = OSSL_PARAM_set_double(_LC119,&local_48);
    iVar1 = test_true("test/params_api_test.c",0x241,"OSSL_PARAM_set_double(&param, 3.14159)",
                      iVar1 != 0);
    if (iVar1 != 0) {
      iVar1 = test_double_eq(local_50,_LC119,"test/params_api_test.c",0x242,&_LC122,"3.14159");
      bVar2 = iVar1 != 0;
      goto LAB_00102081;
    }
  }
...

{
  ...
  if (iVar3 != 0) {
    ...
    if (iVar3 != 0) {
      ...
      iVar3 = test_mem_eq("test/params_api_test.c",0xd5,&_LC104,"raw_values[n].value",&local_5c,
                          uVar4,puVar1,uVar4);
      if (iVar3 != 0) {
        local_94 = 0;
        ...
        if (iVar3 != 0) {
          local_5c = local_94;
          uVar5 = 4;
          iVar3 = test_mem_eq("test/params_api_test.c",0xdb,&_LC104,"raw_values[n].value",&local_5c,
                              4,puVar1);
          if (iVar3 != 0) {
            local_78 = local_90;
...

{
  ...
  uVar4 = test_int_eq("test/params_api_test.c",0x1f7,"test_param_type_null(&param)",&_LC7,iVar3 == 0
                      ,1);
  if (uVar4 == 0) goto LAB_001023b3;
  lVar1 = (long)param_1 * 0x20 + 0x104848;
  local_90 = 0x14;
  local_98 = local_58;
...
LAB_00102423:
    ...
    if (iVar3 == 0) goto LAB_00102423;
    uVar5 = __memcpy_chk(local_78,local_58,uVar2,0x14);
    iVar3 = test_mem_eq("test/params_api_test.c",0x203,"raw_values[n].value",&_LC105,lVar1,uVar2);
    if (iVar3 == 0) goto LAB_00102423;
    local_90 = uStack_88;
    ...
    if (iVar3 == 0) goto LAB_00102423;
    iVar3 = test_BN_eq("test/params_api_test.c",0x207,&_LC1,&_LC116,a,local_b8);
    uVar4 = (uint)(iVar3 != 0);
  }
  BN_free(a);
  BN_free(local_b8);
...

{
  ...
  if (iVar3 != 0) {
    ...
    if (iVar3 != 0) {
      ...
      iVar3 = test_mem_eq("test/params_api_test.c",0xf3,&_LC104,"raw_values[n].value",&local_60,
                          uVar4,puVar1,uVar4);
      if (iVar3 != 0) {
        local_98 = 0;
        ...
        if (iVar3 != 0) {
          local_60 = local_98;
          uVar5 = 8;
          iVar3 = test_mem_eq("test/params_api_test.c",0xf9,&_LC104,"raw_values[n].value",&local_60,
                              8,puVar1);
          if (iVar3 != 0) {
            local_78 = &local_90;
...

{
  ...
  if (iVar3 != 0) {
    ...
    if (iVar3 != 0) {
      ...
      iVar3 = test_mem_eq("test/params_api_test.c",0x12e,&_LC104,"raw_values[n].value",&local_60,
                          uVar4,puVar1,uVar4);
      if (iVar3 != 0) {
        local_98 = 0;
        ...
        if (iVar3 != 0) {
          local_60 = local_98;
          uVar5 = 8;
          iVar3 = test_mem_eq("test/params_api_test.c",0x134,&_LC104,"raw_values[n].value",&local_60
                              ,8,puVar1);
          if (iVar3 != 0) {
            local_78 = &local_90;
            uVar5 = test_param_type_extra(&local_88,puVar1,8,uVar5);
...

{
  ...
  if (iVar3 != 0) {
    ...
    if (iVar3 != 0) {
      ...
      iVar3 = test_mem_eq("test/params_api_test.c",0x188,&_LC104,"raw_values[n].value",&local_60,
                          uVar4,puVar1,uVar4);
      if (iVar3 != 0) {
        local_98 = 0;
        ...
        if (iVar3 != 0) {
          local_60 = local_98;
          uVar5 = 8;
          iVar3 = test_mem_eq("test/params_api_test.c",0x18e,&_LC104,"raw_values[n].value",&local_60
                              ,8,puVar1);
          if (iVar3 != 0) {
            local_78 = &local_90;
            uVar5 = test_param_type_extra(&local_88,puVar1,8,uVar5);
...

{
  ...
  if (iVar3 != 0) {
    ...
    if (iVar3 != 0) {
      ...
      iVar3 = test_mem_eq("test/params_api_test.c",0x1a6,&_LC104,"raw_values[n].value",&local_60,
                          uVar4,puVar1,uVar4);
      if (iVar3 != 0) {
        local_98 = 0;
        ...
        if (iVar3 != 0) {
          local_60 = local_98;
          uVar5 = 8;
          iVar3 = test_mem_eq("test/params_api_test.c",0x1ac,&_LC104,"raw_values[n].value",&local_60
                              ,8,puVar1);
          if (iVar3 != 0) {
            local_78 = &local_90;
            uVar5 = test_param_type_extra(&local_88,puVar1,8,uVar5);
...

{
  ...
  if (iVar3 != 0) {
    ...
    if (iVar3 != 0) {
      ...
      iVar3 = test_mem_eq("test/params_api_test.c",0x1c4,&_LC104,"raw_values[n].value",&local_60,
                          uVar4,puVar1,uVar4);
      if (iVar3 != 0) {
        local_98 = 0;
        ...
        if (iVar3 != 0) {
          local_60 = local_98;
          uVar5 = 8;
          iVar3 = test_mem_eq("test/params_api_test.c",0x1ca,&_LC104,"raw_values[n].value",&local_60
                              ,8,puVar1);
          if (iVar3 != 0) {
            local_78 = &local_90;
            uVar5 = test_param_type_extra(&local_88,puVar1,8,uVar5);
...

{
  ...
  if (iVar3 != 0) {
    ...
    if (iVar3 != 0) {
      ...
      iVar3 = test_mem_eq("test/params_api_test.c",0x1e2,&_LC104,"raw_values[n].value",&local_60,
                          uVar4,puVar1,uVar4);
      if (iVar3 != 0) {
        local_98 = 0;
        ...
        if (iVar3 != 0) {
          local_60 = local_98;
          uVar5 = 8;
          iVar3 = test_mem_eq("test/params_api_test.c",0x1e8,&_LC104,"raw_values[n].value",&local_60
                              ,8,puVar1);
          if (iVar3 != 0) {
            local_78 = &local_90;
            uVar5 = test_param_type_extra(&local_88,puVar1,8,uVar5);
...

{
  ...
  if (iVar3 != 0) {
    ...
    if (iVar3 != 0) {
      ...
      iVar3 = test_mem_eq("test/params_api_test.c",0x14c,&_LC104,"raw_values[n].value",&local_5c,
                          uVar4,puVar1,uVar4);
      if (iVar3 != 0) {
        local_94 = 0;
        ...
        if (iVar3 != 0) {
          local_5c = local_94;
          uVar5 = 4;
          iVar3 = test_mem_eq("test/params_api_test.c",0x152,&_LC104,"raw_values[n].value",&local_5c
                              ,4,puVar1);
          if (iVar3 != 0) {
            local_78 = local_90;
            uVar5 = test_param_type_extra(&local_88,puVar1,4,uVar5);
...

{
  ...
  if (iVar3 != 0) {
    ...
    if (iVar3 != 0) {
      ...
      iVar3 = test_mem_eq("test/params_api_test.c",0x16a,&_LC104,"raw_values[n].value",&local_5c,
                          uVar4,puVar1,uVar4);
      if (iVar3 != 0) {
        local_94 = 0;
        ...
        if (iVar3 != 0) {
          local_5c = local_94;
          uVar5 = 4;
          iVar3 = test_mem_eq("test/params_api_test.c",0x170,&_LC104,"raw_values[n].value",&local_5c
                              ,4,puVar1);
          if (iVar3 != 0) {
            local_78 = local_90;
            uVar5 = test_param_type_extra(&local_88,puVar1,4,uVar5);
...

{
  ...
  if (iVar3 != 0) {
    ...
    if (iVar3 != 0) {
      ...
      iVar3 = test_mem_eq("test/params_api_test.c",0x110,&_LC104,"raw_values[n].value",&local_5c,
                          uVar4,puVar1,uVar4);
      if (iVar3 != 0) {
        local_94 = 0;
        ...
        if (iVar3 != 0) {
          local_5c = local_94;
          uVar5 = 4;
          iVar3 = test_mem_eq("test/params_api_test.c",0x116,&_LC104,"raw_values[n].value",&local_5c
                              ,4,puVar1);
          if (iVar3 != 0) {
            local_78 = local_90;
            uVar5 = test_param_type_extra(&local_88,puVar1,4,uVar5);

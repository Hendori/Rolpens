...
LAB_001012d0:
    ...
    if ((iVar1 == 0) ||
       (iVar1 = test_mem_eq("test/evp_kdf_test.c",0x418,"result","outputs[i]",local_58,0x10,puVar6,
                            0x10), iVar1 == 0)) goto LAB_001012d0;
    EVP_KDF_CTX_free(uVar4);
    puVar5 = puVar5 + 5;
    puVar6 = puVar6 + 0x10;
  } while (puVar5 != &DAT_00107bbf);
  uVar3 = 1;
LAB_001012d7:
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
...
uint test_kdf_hkdf_gettables(void)

{
  ...
  if (uVar1 != 0) {
    ...
    if (iVar2 != 0) {
      ...
      iVar2 = test_true("test/evp_kdf_test.c",0x100,"EVP_KDF_CTX_set_params(kctx, params)",
                        iVar2 != 0);
      if (iVar2 != 0) {
        ...
        if (iVar2 != 0) {
          ...
          if (iVar2 != 0) {
            ...
            iVar2 = test_int_eq("test/evp_kdf_test.c",0x10c,
                                "EVP_KDF_CTX_get_params(kctx, params_get)",&_LC64,uVar3,1);
            if (iVar2 != 0) {
              iVar2 = test_size_t_eq("test/evp_kdf_test.c",0x10d,&_LC67,
...
LAB_001018c8:
    ...
    if ((iVar1 == 0) ||
       (iVar1 = test_mem_eq("test/evp_kdf_test.c",0x45a,"result","outputs[i]",local_68,0x20,puVar6,
                            0x20), iVar1 == 0)) goto LAB_001018c8;
    EVP_KDF_CTX_free(uVar4);
    puVar5 = puVar5 + 5;
    puVar6 = puVar6 + 0x20;
  } while (puVar5 != &DAT_00107c4f);
  uVar3 = 1;
LAB_001018cf:
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
...

{
  ...
  if (uVar1 != 0) {
    if (param_2 == 4) {
      OSSL_PARAM_construct_utf8_string(&local_b8,param_1,&_LC70,0);
    }
    else {
...

{
  ...
  local_20 = *(long *)(in_FS_OFFSET + 0x28);
  uVar3 = EVP_KDF_fetch(0,&_LC59,0);
  uVar4 = EVP_KDF_CTX_new(uVar3);
  EVP_KDF_free(uVar3);
  iVar1 = test_ptr("test/evp_kdf_test.c",0x175,"kctx = get_kdfbyname(OSSL_KDF_NAME_HKDF)",uVar4);
  if (iVar1 == 0) {
LAB_00101d88:
    EVP_KDF_CTX_free(uVar4);
  }
  else {
    OSSL_PARAM_construct_octet_string(&local_a8,&_LC6,local_22,2);
    local_58 = local_88;
    local_78 = local_a8;
    uStack_70 = uStack_a0;
    local_68 = local_98;
    ...
    local_40 = local_98;
    uStack_38 = uStack_90;
    uVar2 = EVP_KDF_CTX_set_params(uVar4,&local_78);
    iVar1 = test_int_eq("test/evp_kdf_test.c",0x17d,"EVP_KDF_CTX_set_params(kctx, params)",&_LC42,
                        uVar2,0);
    if (iVar1 == 0) goto LAB_00101d88;
    EVP_KDF_CTX_free(uVar4);
    iVar1 = do_kdf_hkdf_set_invalid_param(&_LC3,4);
    if (iVar1 != 0) {
      iVar1 = do_kdf_hkdf_set_invalid_param(&_LC2,4);
      if (iVar1 != 0) {
...

{
  ...
  local_20 = *(long *)(in_FS_OFFSET + 0x28);
  OSSL_PARAM_construct_utf8_string(&local_108,"digest",&_LC78,0);
  local_d8 = local_108;
  uStack_d0 = uStack_100;
  local_c8 = local_f8;
  uStack_c0 = uStack_f0;
...

{
  ...
  local_20 = *(long *)(in_FS_OFFSET + 0x28);
  OSSL_PARAM_construct_utf8_string(&local_158,&_LC22,&_LC87,0);
  local_128 = local_158;
...

{
  ...
  local_80 = local_138;
  OSSL_PARAM_construct_utf8_string(&local_158,&_LC90,&local_119,1);
  local_78 = local_158;
...

{
  ...
  uStack_130 = uStack_160;
  local_118 = local_148;
  OSSL_PARAM_construct_utf8_string(&local_168,&_LC22,&_LC87,0);
  local_100 = local_158;
  uStack_f8 = uStack_150;
  local_110 = local_168;
  uStack_108 = uStack_160;
...

{
  ...
  uStack_140 = uStack_170;
  local_128 = local_158;
  OSSL_PARAM_construct_utf8_string(&local_178,&_LC22,&_LC87,0);
  local_110 = local_168;
  uStack_108 = uStack_160;
  local_120 = local_178;
  uStack_118 = uStack_170;
...

{
  ...
  local_34 = 0;
  ptr = (void *)construct_pbkdf2_params_constprop_0
                          (&_LC107,"saltSALTsaltSALTsaltSALTsaltSALTsalt",&local_38,&local_34);
...

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  local_34 = 0x20;
  ptr = (void *)construct_kbkdf_params_constprop_0(&_LC107,&_LC87,&key_8,1,&local_34);
...

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  local_34 = 0x20;
  ptr = (void *)construct_kbkdf_params_constprop_0("sha256",&_LC107,&key_9,1,&local_34);
...

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  local_34 = 0x1f;
  ptr = (void *)construct_kbkdf_params_constprop_0("sha256",&_LC87,&key_10,1,&local_34);
...

{
  ...
  local_48 = (undefined1  [16])0x0;
  local_5c = 0x20;
  ptr = (void *)construct_kbkdf_params_constprop_0("sha256",&_LC87,&key_13,1,&local_5c);
...

{
  ...
  if (iVar1 != 0) {
    ...
    if (iVar1 != 0) {
      ...
      uStack_1a0 = uStack_1e0;
      local_198 = local_1d8;
      OSSL_PARAM_construct_utf8_string(&local_1f8,&_LC22,&_LC87,0);
      local_190 = local_1f8;
      uStack_188 = uStack_1f0;
      local_180 = local_1e8;
      uStack_178 = uStack_1e0;
...

{
  ...
  if (iVar1 != 0) {
    ...
    if (iVar1 != 0) {
      ...
      iVar1 = test_int_eq("test/evp_kdf_test.c",0x68c,"EVP_KDF_CTX_set_params(kctx, params)",&_LC64,
                          uVar2,1);
      if (iVar1 != 0) {
...

{
  ...
  local_80 = 0x1000;
  local_58 = __LC113;
  uStack_50 = (undefined1)_UNK_00109758;
  local_7c = 0;
  uStack_4f = (undefined7)__LC114;
  uStack_48 = (undefined1)((ulong)__LC114 >> 0x38);
  uStack_47 = _UNK_00109768;
  ptr = (void *)construct_pbkdf2_params_constprop_0
...

{
  ...
  local_48 = (undefined1  [16])0x0;
  local_5c = 0x20;
  ptr = (void *)construct_kbkdf_params_constprop_0("sha256",&_LC87,&key_11,1,&local_5c);
  uVar1 = test_ptr("test/evp_kdf_test.c",0x502,"params",ptr);
  if (uVar1 == 0) goto LAB_00104f6f;
  uVar4 = EVP_KDF_fetch(0,"KBKDF",0);
  uVar5 = EVP_KDF_CTX_new(uVar4);
  EVP_KDF_free(uVar4);
...

{
  ...
  local_48 = (undefined1  [16])0x0;
  local_5c = 0x20;
  ptr = (void *)construct_kbkdf_params_constprop_0("sha256",&_LC87,&key_12,0,&local_5c);
  uVar1 = test_ptr("test/evp_kdf_test.c",0x4d2,"params",ptr);
  if (uVar1 == 0) goto LAB_001050dc;
  uVar4 = EVP_KDF_fetch(0,"KBKDF",0);
  uVar5 = EVP_KDF_CTX_new(uVar4);
  EVP_KDF_free(uVar4);
...

{
  ...
  uVar4 = 0;
  ptr = (void *)construct_tls1_prf_params(&_LC107,"secret",&_LC8);
...

{
  ...
  uStack_190 = uStack_1d0;
  local_188 = local_1c8;
  OSSL_PARAM_construct_octet_string(&local_1e8,&_LC2,&_LC119,4);
  local_180 = local_1e8;
  uStack_178 = uStack_1e0;
  local_170 = local_1d8;
  uStack_168 = uStack_1d0;
  local_160 = local_1c8;
  OSSL_PARAM_construct_uint(&local_1e8,&_LC120,&local_1b8);
  local_158 = local_1e8;
  uStack_150 = uStack_1e0;
  local_148 = local_1d8;
  uStack_140 = uStack_1d0;
  ...
  uStack_118 = uStack_1d0;
  local_110 = local_1c8;
  OSSL_PARAM_construct_uint(&local_1e8,&_LC121,&local_1b0);
  local_108 = local_1e8;
  uStack_100 = uStack_1e0;
  local_f8 = local_1d8;
  uStack_f0 = uStack_1d0;
...

{
  ...
  uVar4 = 0;
  ptr = (void *)construct_hkdf_params(&_LC107,"secret",6,&_LC2,"label");
...

{
  ...
  uVar5 = 0;
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  ptr = (void *)construct_tls1_prf_params("sha256","secret",&_LC64);
...

{
  ...
  uVar5 = 0;
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  ptr = (void *)construct_tls1_prf_params("sha256",&_LC127,&_LC8);
...

{
  ...
  uVar5 = 0;
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  ptr = (void *)construct_tls1_prf_params("sha256",&_LC64,&_LC8);
...

{
  ...
  uVar5 = 0;
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  ptr = (void *)construct_hkdf_params("sha256",&_LC127,0,&_LC2,"label");
...

{
  ...
  uVar5 = 0;
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  ptr = (void *)construct_hkdf_params("sha256",&_LC64,1,&_LC2,"label");
...

{
  ...
  uVar5 = 0;
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  ptr = (void *)construct_hkdf_params("sha256","secret",6,&_LC127,"label");
...

{
  ...
  uVar5 = 0;
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  ptr = (void *)construct_tls1_prf_params("sha256","secret",&_LC127);
  ...
  if (iVar3 != 0) {
    ...
    if (iVar3 != 0) {
      ...
      if (iVar3 != 0) {
        ...
        uStack_110 = uStack_1a0;
        local_108 = local_198;
        OSSL_PARAM_construct_utf8_string(&local_1b8,"properties",&_LC127,0);
        local_e0 = local_198;
        local_100 = local_1b8;
        uStack_f8 = uStack_1b0;
        local_f0 = local_1a8;
          ...
          if (iVar3 != 0) {
            ...
            if (((iVar3 != 0) &&
               ...
               (iVar3 = test_mem_eq("test/evp_kdf_test.c",0x782,"macname","\"HMAC\"",local_68,
                                    local_130,&_LC87,4), iVar3 != 0)) {
              uVar4 = EVP_KDF_derive(uVar6,local_a8,0x20,0);
              iVar3 = test_int_eq("test/evp_kdf_test.c",0x786,
                                  "EVP_KDF_derive(kctx, out, sizeof(out), NULL)",&_LC64,uVar4,1);
              if (iVar3 != 0) {
...
uint test_kdf_hkdf_gettables_no_digest(void)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  local_a0 = 0;
  ptr = (void *)construct_hkdf_params(0,"secret",6,&_LC2,0);
  uVar1 = test_ptr("test/evp_kdf_test.c",0xfb,
                   "params = construct_hkdf_params( has_digest ? \"sha256\" : NULL, \"secret\", 6, \"salt\", expand_only ? NULL : \"label\")"
                   ,ptr);
  if (uVar1 != 0) {
...
uint test_kdf_hkdf_gettables_expandonly(void)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  local_a0 = 0;
  ptr = (void *)construct_hkdf_params("sha256","secret",6,&_LC2,0);
  uVar1 = test_ptr("test/evp_kdf_test.c",0xfb,
                   "params = construct_hkdf_params( has_digest ? \"sha256\" : NULL, \"secret\", 6, \"salt\", expand_only ? NULL : \"label\")"
                   ,ptr);
  if (uVar1 != 0) {
      ...
      if (iVar2 != 0) {
        ...
        if (iVar2 != 0) {
          ...
          if (iVar2 != 0) {
            ...
            if (iVar2 != 0) {
              iVar2 = test_size_t_eq("test/evp_kdf_test.c",0x10d,&_LC67,
                                     "expand_only ? SHA256_DIGEST_LENGTH : SIZE_MAX",local_a0,0x20);
              if (iVar2 != 0) {
                OSSL_PARAM_construct_end(&local_d8);
                local_98 = local_d8;
                uStack_90 = uStack_d0;

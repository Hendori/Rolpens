...

{
  ...
  if (param_1 != (undefined8 *)0x0) {
    ...
    while (pvVar2 != (void *)0x0) {
      ...
      if (*(code **)((long)pvVar2 + 0x28) != (code *)0x0) {
        (**(code **)((long)pvVar2 + 0x28))
                  (*(undefined8 *)((long)pvVar2 + 0x20),*(undefined8 *)((long)pvVar2 + 0x40),
                   *(undefined8 *)((long)pvVar2 + 0x30));
        *(undefined8 *)((long)pvVar2 + 0x28) = 0;
        *(undefined8 *)((long)pvVar2 + 0x20) = 0;
        *(undefined8 *)((long)pvVar2 + 0x40) = 0;
      }
      *(undefined4 *)((long)pvVar2 + 0x54) = 0xffffffff;
      CRYPTO_free(pvVar2);
      pvVar2 = pvVar1;
    }

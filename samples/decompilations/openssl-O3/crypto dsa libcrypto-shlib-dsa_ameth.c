...

{
  ...
  if (((iVar2 != 0) && (iVar2 = OSSL_PARAM_BLD_push_BN(lVar9,&_LC2,lVar6), iVar2 != 0)) &&
    ...
    if (((lVar8 == 0) ||
        (iVar2 = OSSL_PARAM_BLD_push_BN(lVar9,&_LC5,lVar8), uVar3 = uVar10, iVar2 != 0)) &&
       (lVar4 = OSSL_PARAM_BLD_to_param(lVar9), lVar4 != 0)) {
      uVar3 = (*param_3)(param_2,uVar3,lVar4);
...
bool dsa_priv_print(BIO *param_1,long param_2,int param_3)

{
  ...
  if (*(long *)(lVar1 + 8) != 0) {
    uVar2 = DSA_bits(lVar1);
    uVar4 = (ulong)uVar2;
  }
  num = *(BIGNUM **)(lVar1 + 0x70);
  num_00 = *(BIGNUM **)(lVar1 + 0x68);
  if (num == (BIGNUM *)0x0) {
  ...
  if (((0 < iVar3) && (iVar3 = ASN1_bn_print(param_1,"priv:",num,(uchar *)0x0,param_3), iVar3 != 0))
     && (iVar3 = ASN1_bn_print(param_1,"pub: ",num_00,(uchar *)0x0,param_3), iVar3 != 0)) {
    iVar3 = ossl_ffc_params_print(param_1,lVar1 + 8,param_3);
    return iVar3 != 0;
  }
  return false;
}
...
LAB_00100bb1:
      ...
      r = DSA_new();
      if (r != (DSA *)0x0) goto LAB_00100bb1;
      ERR_new();
      ai = (ASN1_INTEGER *)0x0;
...
bool dsa_pub_print(BIO *param_1,long param_2,int param_3)

{
  ...
  lVar1 = *(long *)(param_2 + 0x20);
  if (*(long *)(lVar1 + 8) != 0) {
    uVar2 = DSA_bits(lVar1,param_2,0);
    uVar4 = (ulong)uVar2;
  }
  num = *(BIGNUM **)(lVar1 + 0x68);
  iVar3 = BIO_printf(param_1,"Public-Key: (%d bit)\n",uVar4);
  if (0 < iVar3) {
    iVar3 = ASN1_bn_print(param_1,"priv:",(BIGNUM *)0x0,(uchar *)0x0,param_3);
    if (iVar3 != 0) {
      iVar3 = ASN1_bn_print(param_1,"pub: ",num,(uchar *)0x0,param_3);
      if (iVar3 != 0) {
        iVar3 = ossl_ffc_params_print(param_1,lVar1 + 8,param_3);
        return iVar3 != 0;
      }
...
bool dsa_param_print(BIO *param_1,long param_2,int param_3)

{
  ...
  if (0 < iVar3) {
    iVar3 = ASN1_bn_print(param_1,"priv:",(BIGNUM *)0x0,(uchar *)0x0,param_3);
    if (iVar3 != 0) {
      iVar3 = ASN1_bn_print(param_1,"pub: ",(BIGNUM *)0x0,(uchar *)0x0,param_3);
      if (iVar3 != 0) {
        iVar3 = ossl_ffc_params_print(param_1,lVar1 + 8,param_3);
        return iVar3 != 0;
      }

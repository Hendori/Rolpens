...
ulong general_allocate_boolean_constprop_0
                (long param_1,long param_2,undefined8 param_3,char *param_4,char *param_5,
...
LAB_0010033c:
  ERR_set_debug("crypto/ui/ui_lib.c",uVar6,pcVar5);
...

{
  ...
  if (text == (char *)0x0) {
    ...
    if ((pcVar2 != (char *)0x0) &&
       (ptr = (int *)CRYPTO_zalloc(0x48,"crypto/ui/ui_lib.c",0x6b), ptr != (int *)0x0)) {
      lVar3 = *(long *)(ui + 8);
      *(char **)(ptr + 2) = pcVar2;
      ptr[0x10] = 1;
      ptr[4] = 0;

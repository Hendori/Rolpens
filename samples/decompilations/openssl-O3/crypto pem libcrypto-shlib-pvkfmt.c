...

{
  ...
  if (iVar2 == 0) {
    ...
    if ((((uVar3 & 7) == 0) && (iVar2 = BN_num_bits(local_60), iVar2 == 0xa0)) &&
       (iVar2 = BN_num_bits(local_58), iVar2 <= (int)uVar3)) {
      if (param_3 == 0) {
...
LAB_00100f90:
      ...
      if ((iVar3 == 0) ||
         ...
         cipher == (EVP_CIPHER *)0x0)) goto LAB_00100f90;
      if (param_3 == 1) {
        local_463 = 0;
        uStack_45c = 0;
      }
      ...
      if (iVar3 != 0) {
        ...
        if ((iVar2 != 0) &&
           (iVar2 = EVP_EncryptFinal_ex(ctx,puVar4 + local_474,&local_474), iVar2 != 0))
        goto LAB_00100f02;
      }
    }
    local_4ac = -1;
...
long do_PVK_body_key_isra_0
               (undefined8 *param_1,uint param_2,uint param_3,code *param_4,void *param_5,
               int *param_6,undefined4 *param_7,undefined8 param_8,undefined8 param_9)
...
LAB_00101cb0:
    ...
    if ((*(int *)(puVar3 + 1) != 0x32415352) && (*(int *)(puVar3 + 1) != 0x32535344)) {
      ...
      iVar1 = EVP_DecryptInit_ex(a,cipher,(ENGINE *)0x0,local_468,(uchar *)0x0);
      if ((iVar1 != 0) &&
         (iVar1 = EVP_DecryptUpdate(a,out,(int *)&local_470,in,param_3 - 8), iVar1 != 0)) {
        iVar1 = EVP_DecryptFinal_ex(a,out + (int)local_470,(int *)&local_470);
        if (iVar1 != 0) {
          if ((*(int *)(puVar3 + 1) != 0x32415352) && (*(int *)(puVar3 + 1) != 0x32535344)) {
            ERR_new();
...

{
  ...
  uVar4 = 6;
  if ((local_34 != 0) && (uVar4 = 0, local_34 == 1)) {
    uVar4 = 0x74;
  }
...
undefined8
b2i_DSA_PVK_bio_ex(BIO *param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
                  undefined8 param_5)
      ...
      if (data != (undefined1 *)0x0) {
        ...
        if (iVar1 == iVar2) {
          uVar3 = do_PVK_body_key_isra_0
                            (local_60,local_68,local_64,param_2,param_3,&local_70,&local_6c,param_4,
                             param_5);
        }
        else {
          ERR_new();
...
undefined8
b2i_RSA_PVK_bio_ex(BIO *param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
                  undefined8 param_5)
...
void b2i_PVK_bio_ex(BIO *param_1,undefined8 param_2,undefined8 param_3)
  ...
  if (iVar1 == 0x18) {
    ...
    if (iVar1 != 0) {
      ...
      if (data != (undefined1 *)0x0) {
        ...
        if (iVar1 == iVar2) {
          uVar3 = do_PVK_body_key_isra_0
                            (local_60,local_70[2],local_64,param_2,param_3,local_70,local_70 + 1,0,0
                            );
        }
        else {
          ERR_new();
...
LAB_00102a5b:
  uVar4 = 6;
  if ((local_70[0] != 0) && (uVar4 = 0, local_70[0] == 1)) {
    uVar4 = 0x74;
  }

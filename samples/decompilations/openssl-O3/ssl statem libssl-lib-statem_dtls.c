...
LAB_00100210:
    ...
    if (ppVar11 == (pitem *)0x0) {
      ...
      if (ptr != (undefined8 *)0x0) {
        pvVar14 = (void *)0x0;
        if ((lVar13 == 0) ||
           (pvVar14 = CRYPTO_malloc((int)lVar13,"ssl/statem/statem_dtls.c",0x48),
           pvVar14 != (void *)0x0)) {
          ptr[8] = pvVar14;
    ...
    if (ptr[9] == 0) {
      do {
        ...
        iVar8 = (**(code **)(*(long *)(param_1 + 0x18) + 0x80))
                          (param_1,0x16,0,local_148,uVar9,0,&local_158);
...
LAB_001002c3:
    iVar8 = (**(code **)(*(long *)(param_1 + 0x18) + 0x80))
                      (param_1,0x16,0,param_2[3] + ptr[8],uVar17,0,&local_158);
    if ((0 < iVar8) && (local_158 == uVar17)) {
      ...
      if ((long)uVar17 < 9) {
        ...
        *(byte *)(lVar13 + ptr[9]) =
             *(byte *)(lVar13 + ptr[9]) |
             *(byte *)((long)&bitmask_end_values + (ulong)((uint)lVar12 & 7));
      }
      lVar13 = param_2[1];
      if (lVar13 == 0) goto LAB_001003b8;
      pvVar14 = (void *)ptr[9];
      lVar12 = lVar13 + -1 >> 3;
      if (*(char *)((long)pvVar14 + lVar12) ==
          *(char *)((long)&bitmask_end_values + (ulong)((uint)lVar13 & 7))) {
        lVar12 = lVar12 + -1;
        if (-1 < lVar12) {
          do {
...
LAB_00100374:
      if ((ppVar11 != (pitem *)0x0) ||
         ((ppVar11 = pitem_new(local_150,ptr), ppVar11 != (pitem *)0x0 &&
          (ppVar11 = pqueue_insert(*(pqueue *)(*(long *)(param_1 + 0x4f0) + 0x118),ppVar11),
          ppVar11 != (pitem *)0x0)))) goto LAB_00100210;
      goto LAB_001002a0;
    }
LAB_001003b8:
    if (ppVar11 == (pitem *)0x0) goto LAB_001002a0;
  }
LAB_001002a8:
  uVar10 = 0xffffffff;
LAB_00100215:
...

{
  ...
  if (((iVar8 == 0) ||
      ...
      uVar10 = dtls1_min_mtu(param_1), uVar16 < uVar10)) ||
     ((*(long *)(param_1->sid_ctx + 4) == 0 &&
      ((param_2 == '\x16' &&
       (lVar11._0_4_ = param_1->sid_ctx_length, lVar11._4_1_ = param_1->sid_ctx[0],
       lVar11._5_1_ = param_1->sid_ctx[1], lVar11._6_1_ = param_1->sid_ctx[2],
       lVar11._7_1_ = param_1->sid_ctx[3],
       lVar11 != *(long *)((long)param_1[1].tlsext_opaque_prf_input + 0x140) + 0xc)))))) {
LAB_00100890:
    uVar16 = 0xffffffff;
  }
  else {
      ...
      if (param_2 == '\x16') {
        ...
        while( true ) {
          while( true ) {
            ...
            if ((uVar16 <= uVar10) || (uVar16 = uVar16 - uVar10, uVar16 < 0xd)) {
            ...
            *puVar14 = *(undefined1 *)((long)pvVar5 + 0x138);
            ...
            iVar8 = dtls1_write_bytes(param_1,0x16,
                                      *(long *)(param_1->sid_ctx + 4) +
                                      param_1->compress->compress_in,uVar10,&local_48);
            if (iVar8 < 1) break;
          ...
          if (((lVar12 < 1) || (uVar16 = SSL_get_options(param_1), (uVar16 & 0x1000) != 0)) ||
             (iVar8 = dtls1_query_mtu(param_1), iVar8 == 0)) goto LAB_00100890;
          lVar12._0_4_ = param_1->sid_ctx_length;
          lVar12._4_1_ = param_1->sid_ctx[0];
          lVar12._5_1_ = param_1->sid_ctx[1];
          lVar12._6_1_ = param_1->sid_ctx[2];
        ...
        while( true ) {
          while( true ) {
            ...
            iVar8 = dtls1_write_bytes(param_1,param_2,
                                      *(long *)(param_1->sid_ctx + 4) +
                                      param_1->compress->compress_in,uVar16,&local_48);
            if (iVar8 < 1) break;
...
LAB_00100c53:
  if ((code *)param_1[1].tlsext_opaque_prf_input_len != (code *)0x0) {
    (*(code *)param_1[1].tlsext_opaque_prf_input_len)
               ...
               *(long *)(param_1->sid_ctx + 4) + uVar10,uVar2,param_1[1].tlsext_session_ticket);
  }
  uVar16 = 1;
...

{
  ...
  if (*(long *)(param_1 + 0x110) == 0) {
    ...
    if (ptr != (undefined1 *)0x0) {
      __dest = (void *)0x0;
      if ((lVar4 != 0) &&
         (__dest = CRYPTO_malloc((int)lVar4,"ssl/statem/statem_dtls.c",0x48), __dest == (void *)0x0)
         ) {
        CRYPTO_free(ptr);
        uVar7 = 0;
        goto LAB_00101035;
...
LAB_00101494:
  local_1a0 = pqueue_iterator(*(pqueue *)(lVar8 + 0x118));
...
LAB_0010165a:
      if ((*(long *)((long)pvVar7 + 0x48) == 0) &&
         ((*(short *)(*(long *)(param_1 + 0x4f0) + 0x110) == *(short *)((long)pvVar7 + 0x10) ||
          (bVar2)))) {
        ...
        if (*(size_t *)((long)pvVar7 + 0x20) != 0) {
          memcpy((void *)(*(long *)(*(long *)(param_1 + 0xf8) + 8) + 0xc +
                         *(long *)((long)pvVar7 + 0x18)),*(void **)((long)pvVar7 + 0x40),
                 *(size_t *)((long)pvVar7 + 0x20));
        }
        dtls1_hm_fragment_free(pvVar7);
        pitem_free(ppVar5);
    ...
    if (((*(int *)(param_1 + 0x78) != 0 && uVar9 == 1) && (*(ushort *)((long)pvVar7 + 0x10) == 0))
       && (*(int *)(param_1 + 0xac) == 0x17)) {
  ...
  iVar3 = (**(code **)(*(long *)(param_1 + 0x18) + 0x80))
                    (param_1,0x16,&local_1a9,pcVar11,0xc,0,pppVar14);
  if (iVar3 < 1) {
LAB_00101b34:
    ...
    if (local_188 == *(ushort *)(lVar8 + 0x110)) {
      if ((ppStack_190 <= local_178) || (local_178 == (pitem *)0x0)) {
        if (*(int *)(param_1 + 0x78) == 0) {
          bVar2 = false;
          if (((*(long *)(lVar8 + 400) != 0) || (*(int *)(param_1 + 0xac) == 1)) ||
             (*pcVar11 != '\0')) goto LAB_00101842;
          if (((pcVar11[1] == '\0') && (pcVar11[2] == '\0')) && (pcVar11[3] == '\0'))
          goto code_r0x001017d2;
          ERR_new();
          uVar10 = 0x39e;
LAB_001018dd:
          ERR_set_debug("ssl/statem/statem_dtls.c",uVar10,"dtls_get_reassembled_message");
          ossl_statem_fatal(param_1,10,0xf4,0);
        }
        else {
          bVar2 = false;
LAB_00101842:
          iVar3 = dtls1_preprocess_fragment(param_1,&local_198);
          if (iVar3 != 0) {
            if (local_178 != (pitem *)0x0) {
              iVar3 = (**(code **)(*(long *)(param_1 + 0x18) + 0x80))
                                (param_1,0x16,0,pcVar11 + lStack_180 + 0xc,local_178,0);
...
LAB_00101618:
      uVar4 = dtls1_reassemble_fragment(param_1,&local_198);
      goto LAB_00101623;
    }
    uVar9 = local_188;
...
LAB_00101ab3:
      if (ppVar5 == (pitem *)0x0) goto LAB_00101aa6;
      goto LAB_00101acf;
    }
    uVar9 = *(ushort *)(*(long *)(param_1 + 0x4f0) + 0x110);
    if (local_188 <= uVar9) {
    ...
    ppVar6 = (pitem *)0x0;
    if ((uVar9 + 10 < (uint)local_188) || ((uVar9 == 0 && (local_198 == '\x14'))))
    goto LAB_00101ab3;
    ...
    if ((ppVar6 < ppVar5) ||
       (ptr = (undefined8 *)CRYPTO_zalloc(0x50,"ssl/statem/statem_dtls.c",0x44),
       ptr == (undefined8 *)0x0)) goto LAB_00101b22;
    if (ppVar5 == (pitem *)0x0) {
    ...
    if (pvVar7 != (void *)0x0) {
      ...
      iVar3 = (**(code **)(*(long *)(param_1 + 0x18) + 0x80))
                        (param_1,0x16,0,pvVar7,ppVar5,0,&local_1a0,pppVar14);
      if ((iVar3 < 1) || (ppVar5 != local_1a0)) goto LAB_00101b25;
LAB_00101a73:
      ppVar5 = pitem_new((uchar *)&local_150,ptr);
      if ((ppVar5 == (pitem *)0x0) ||
         (ppVar5 = pqueue_insert(*(pqueue *)(*(long *)(param_1 + 0x4f0) + 0x118),ppVar5),
         ppVar5 == (pitem *)0x0)) goto LAB_00101b25;
      goto LAB_00101aa6;
    }
    CRYPTO_free(ptr);
    goto LAB_00101b22;
...
code_r0x001017d2:
  if (*(code **)(param_1 + 0x4f8) != (code *)0x0) {
    (**(code **)(param_1 + 0x4f8))
              (0,*(undefined4 *)(param_1 + 0x48),0x16,pcVar11,0xc,uVar10,
...
LAB_00101acf:
    ...
    iVar3 = (**(code **)(*(long *)(param_1 + 0x18) + 0x80))
                      (param_1,0x16,0,local_148,ppVar13,0,&local_1a0);
    if (iVar3 < 1) {
      if (ppVar6 == (pitem *)0x0) {
LAB_00101b22:
        ptr = (undefined8 *)0x0;
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  *(undefined1 (*) [16])(lVar5 + 0x178) = (undefined1  [16])0x0;
  *(undefined1 (*) [16])(lVar5 + 0x188) = (undefined1  [16])0x0;
  *(undefined1 (*) [16])(lVar5 + 0x198) = (undefined1  [16])0x0;
  *(undefined1 (*) [16])(lVar5 + 0x1a8) = (undefined1  [16])0x0;
  do {
    ...
    if ((int)uVar8 != 0) {
      ...
      *param_2 = iVar4;
      ...
      if (iVar4 == 0x101) {
        if (*(code **)(param_1 + 0x4f8) != (code *)0x0) {
          (**(code **)(param_1 + 0x4f8))
                    (0,*(undefined4 *)(param_1 + 0x48),0x14,puVar7,1,*(undefined8 *)(param_1 + 0x40)
                     ,*(undefined8 *)(param_1 + 0x500));
        }
      }
      else {
        ...
        *puVar7 = ((((uint)uVar8 & 0xff) << 8 | (uint)(byte)((ulong)uVar8 >> 8)) << 8 |
                  (uint)((ulong)uVar8 >> 0x10) & 0xff) << 8 | (uint)*(byte *)(lVar5 + 0x178);

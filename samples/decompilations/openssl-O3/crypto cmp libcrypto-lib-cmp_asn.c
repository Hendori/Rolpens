...

{
  ...
  if (param_1 != (X509 *)0x0) {
    ...
    if (pXVar2 == (X509 *)0x0) goto LAB_00100e98;
    if (param_2 != (X509 *)0x0) {
...
LAB_00101908:
    pDVar3 = (DIST_POINT_NAME *)X509_get_ext_d2i(param_2,0x67,(int *)0x0,(int *)0x0);
    iVar11 = 0;
    pGVar6 = (GENERAL_NAMES *)0x0;
    if (param_3 == 0) {
      iVar2 = OPENSSL_sk_num(pDVar3);
      if (0 < iVar2) {
        do {
          plVar4 = (long *)OPENSSL_sk_value(pDVar3,iVar11);
          if (plVar4 != (long *)0x0) {
            pDVar9 = (DIST_POINT_NAME *)*plVar4;
            if (pDVar9 != (DIST_POINT_NAME *)0x0) goto LAB_00101bd0;
            if (((GENERAL_NAMES *)plVar4[2] != (GENERAL_NAMES *)0x0) &&
               (pGVar6 == (GENERAL_NAMES *)0x0)) {
              pGVar6 = (GENERAL_NAMES *)plVar4[2];
            }
          }
          iVar11 = iVar11 + 1;
          iVar2 = OPENSSL_sk_num(pDVar3);
      ...
      for (; iVar2 = OPENSSL_sk_num(pDVar3), iVar11 < iVar2; iVar11 = iVar11 + 1) {
        plVar4 = (long *)OPENSSL_sk_value(pDVar3,iVar11);
        if (plVar4 != (long *)0x0) {
          pDVar9 = (DIST_POINT_NAME *)*plVar4;
          if (pDVar9 != (DIST_POINT_NAME *)0x0) goto LAB_00101bd0;
          lVar1 = plVar4[2];
          if ((((lVar1 != 0) && (iVar2 = OPENSSL_sk_num(), iVar2 == 1)) &&
              (piVar8 = (int *)OPENSSL_sk_value(lVar1,0), *piVar8 == 4)) &&
             (pGVar6 == (GENERAL_NAMES *)0x0)) {
            pGVar6 = (GENERAL_NAMES *)plVar4[2];
          }
        }
    ...
    if (pGVar6 == (GENERAL_NAMES *)0x0) {
      a = (AUTHORITY_KEYID *)X509_get_ext_d2i(param_2,0x5a,(int *)0x0,(int *)0x0);
      pDVar9 = (DIST_POINT_NAME *)0x0;
      if ((a == (AUTHORITY_KEYID *)0x0) || (pGVar6 = a->issuer, pGVar6 == (GENERAL_NAMES *)0x0)) {
LAB_001019cc:
        pXVar5 = X509_get_issuer_name(param_2);
        local_48 = 0;
        pGVar6 = (GENERAL_NAMES *)OPENSSL_sk_new_reserve(0,1);
        if (pGVar6 != (GENERAL_NAMES *)0x0) {
          iVar11 = GENERAL_NAME_set1_X509_NAME(&local_48,pXVar5);
          if (iVar11 != 0) {
            a_00 = (ISSUING_DIST_POINT *)0x0;
            OPENSSL_sk_push(pGVar6,local_48);
            pGVar10 = pGVar6;
            goto LAB_00101bde;
          }
...
LAB_00101cb3:
      ...
      if (param_3 != 0) {
        ...
        if ((iVar11 != 1) || (piVar8 = (int *)OPENSSL_sk_value(pGVar6,0), *piVar8 != 4))
        goto LAB_001019cc;
        pGVar6 = a->issuer;
        if ((pGVar6 == (GENERAL_NAMES *)0x0) && (param_1 != (X509_CRL *)0x0)) goto LAB_00101cb3;
        a_00 = (ISSUING_DIST_POINT *)0x0;
        goto LAB_00101c49;
      }
      a_00 = (ISSUING_DIST_POINT *)0x0;
  ...
  local_58 = X509_CRL_get0_lastUpdate();
  if (param_2 != (X509 *)0x0) goto LAB_00101908;
  a_00 = (ISSUING_DIST_POINT *)X509_CRL_get_ext_d2i(param_1,0x302,(int *)0x0,(int *)0x0);
  if (a_00 == (ISSUING_DIST_POINT *)0x0) {
    pDVar3 = (DIST_POINT_NAME *)0x0;
  }
  else {
    pDVar9 = a_00->distpoint;
    pDVar3 = pDVar9;
...
LAB_00101ac1:
  a = (AUTHORITY_KEYID *)X509_CRL_get_ext_d2i(param_1,0x5a,(int *)0x0,(int *)0x0);
  if ((a != (AUTHORITY_KEYID *)0x0) && (pGVar6 = a->issuer, pGVar6 != (GENERAL_NAMES *)0x0)) {
    if (param_3 != 0) {
      iVar11 = OPENSSL_sk_num(pGVar6);
      if ((iVar11 != 1) || (piVar8 = (int *)OPENSSL_sk_value(pGVar6,0), *piVar8 != 4))
      goto LAB_00101b03;
      pGVar6 = a->issuer;
LAB_00101c49:
...
LAB_00101b03:
  uVar7 = X509_CRL_get_issuer(param_1);
  local_48 = 0;
  pGVar6 = (GENERAL_NAMES *)OPENSSL_sk_new_reserve(0,1);
  if (pGVar6 != (GENERAL_NAMES *)0x0) {
    iVar11 = GENERAL_NAME_set1_X509_NAME(&local_48,uVar7);
    if (iVar11 != 0) {
      pDVar9 = (DIST_POINT_NAME *)0x0;
      OPENSSL_sk_push(pGVar6,local_48);
      pGVar10 = pGVar6;
...
LAB_00101bd0:
  ...
  a = (AUTHORITY_KEYID *)0x0;
LAB_00101bde:
  uVar7 = OSSL_CMP_CRLSTATUS_new1(pDVar9,pGVar6,local_58);
LAB_00101bf1:
  OPENSSL_sk_pop_free(pDVar3,&DIST_POINT_free);
  ISSUING_DIST_POINT_free(a_00);
  AUTHORITY_KEYID_free(a);
  OPENSSL_sk_pop_free(pGVar10,&GENERAL_NAME_free);
LAB_00101ba8:
...

{
  ...
  if (iVar1 == 0) {
    ...
    if (local_18 < 0x80000000) goto LAB_00101fbf;
    ERR_new();

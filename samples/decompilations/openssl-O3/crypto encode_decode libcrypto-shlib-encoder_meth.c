...
LAB_001001b0:
    if (((param_1 != 0) || (param_1 = ossl_lib_ctx_get_data(*param_3,10), param_1 != 0)) &&
...
LAB_00100533:
      ossl_method_store_cache_set(lVar3,local_80,iVar2,pcVar7,local_88,up_ref_encoder,free_encoder);
    }
    bVar1 = *(byte *)(param_1 + 5);
    lVar3 = local_88;
    if (((iVar2 == 0) && (param_2 == (char *)0x0)) || (local_88 != 0)) goto LAB_0010041f;
LAB_00100455:
    iVar6 = 0x8010d - (~(uint)bVar1 & 1);

...

{
  ...
  local_60 = (BIGNUM *)0x0;
  local_60 = BN_new();
  iVar2 = test_ptr("test/bntest.c",0x78f,"bn = BN_new()",local_60);
  if (iVar2 != 0) {
    lVar5 = (long)param_1 * 0x18;
    iVar2 = BN_asc2bn(&local_60,*(char **)(kSignedTests_BE + lVar5));
    iVar2 = test_true("test/bntest.c",0x790,"BN_asc2bn(&bn, test->base10)",iVar2 != 0);
    if (iVar2 != 0) {
      uVar6 = *(undefined8 *)(kSignedTests_BE + lVar5 + 0x10);
      uVar3 = BN_signed_bn2bin(local_60,&local_4a,10);
      iVar2 = test_int_eq("test/bntest.c",0x799,"BN_signed_bn2bin(bn, scratch, sizeof(scratch))",
                          "sizeof(scratch)",uVar3,10);
      if (iVar2 != 0) {
        local_50 = local_4a << 8 | local_4a >> 8;
        local_58 = local_48 >> 0x38 | (local_48 & 0xff000000000000) >> 0x28 |
                   (local_48 & 0xff0000000000) >> 0x18 | (local_48 & 0xff00000000) >> 8 |
                   (local_48 & 0xff000000) << 8 | (local_48 & 0xff0000) << 0x18 |
                   (local_48 & 0xff00) << 0x28 | local_48 << 0x38;
        iVar2 = test_true("test/bntest.c",0x79b,"copy_reversed(reversed, scratch, sizeof(scratch))",
                          1);
        if (iVar2 != 0) {
          uVar1 = *(undefined8 *)(kSignedTests_BE + lVar5 + 8);
          lVar5 = (long)(10 - (int)uVar6);
          iVar2 = test_mem_eq("test/bntest.c",0x79c,"test->mpi","scratch + i",uVar1,uVar6,
                              lVar5 + (long)&local_4a,uVar6);
          if (iVar2 != 0) {
            a = (BIGNUM *)BN_signed_bin2bn(&local_4a,10,0);
            iVar2 = test_ptr("test/bntest.c",0x79f,
                             "bn2 = BN_signed_bin2bn(scratch, sizeof(scratch), NULL)",a);
            if (iVar2 != 0) {
              iVar2 = test_BN_eq("test/bntest.c",0x7a0,&_LC172,&_LC171,local_60,a);
              if (iVar2 != 0) {
                BN_free(a);
                a = (BIGNUM *)BN_signed_lebin2bn(&local_58,10,0);
                iVar2 = test_ptr("test/bntest.c",0x7a7,
                                 "bn2 = BN_signed_lebin2bn(reversed, sizeof(reversed), NULL)",a);
                if (iVar2 != 0) {
                  iVar2 = test_BN_eq("test/bntest.c",0x7a8,&_LC172,&_LC171,local_60,a);
                  if (iVar2 != 0) {
                    BN_free(a);
                    uVar3 = BN_signed_bn2lebin(local_60,&local_4a,10);
                    iVar2 = test_int_eq("test/bntest.c",0x7b4,
                                        "BN_signed_bn2lebin(bn, scratch, sizeof(scratch))",
                                        "sizeof(scratch)",uVar3,10);
                    if (iVar2 != 0) {
                      local_50 = local_4a << 8 | local_4a >> 8;
                      local_58 = local_48 >> 0x38 | (local_48 & 0xff000000000000) >> 0x28 |
                                 (local_48 & 0xff0000000000) >> 0x18 |
                                 (local_48 & 0xff00000000) >> 8 | (local_48 & 0xff000000) << 8 |
                                 (local_48 & 0xff0000) << 0x18 | (local_48 & 0xff00) << 0x28 |
                                 local_48 << 0x38;
                      iVar2 = test_true("test/bntest.c",0x7b6,
                                        "copy_reversed(reversed, scratch, sizeof(scratch))",1);
                      if (iVar2 != 0) {
                        iVar2 = test_mem_eq("test/bntest.c",0x7b7,"test->mpi","reversed + i",uVar1,
                                            uVar6,lVar5 + (long)&local_58);
                        if (iVar2 != 0) {
                          a = (BIGNUM *)BN_signed_lebin2bn(&local_4a,10,0,uVar6);
                          iVar2 = test_ptr("test/bntest.c",0x7ba,
                                           "bn2 = BN_signed_lebin2bn(scratch, sizeof(scratch), NULL)"
                                           ,a);
                          if (iVar2 != 0) {
                            iVar2 = test_BN_eq("test/bntest.c",0x7bb,&_LC172,&_LC171,local_60,a);
                            if (iVar2 != 0) {
                              BN_free(a);
                              a = (BIGNUM *)BN_signed_bin2bn(&local_58,10,0);
                              uVar4 = test_ptr("test/bntest.c",0x7c2,
                                               "bn2 = BN_signed_bin2bn(reversed, sizeof(reversed), NULL)"
                                               ,a);
                              if (uVar4 != 0) {
                                iVar2 = test_BN_eq("test/bntest.c",0x7c3,&_LC172,&_LC171,local_60,a)
                                ;
                                uVar4 = (uint)(iVar2 != 0);
                              }
                              goto LAB_00104f5e;
...
LAB_001097c8:
      ...
      do {
        ...
        ppuVar6 = ppuVar6 + 2;
        if (ppuVar6 == (undefined **)ModExpTests) goto LAB_00109856;
        iVar2 = *(int *)((long)ptr + 0x24);
      } while( true );
    }
    CRYPTO_free(ptr);
...

{
  ...
  if (iVar1 == 0) {
    ...
    if (iVar1 == 0) {
      ...
      r = (BIGNUM *)0x0;
      a_00 = (BIGNUM *)getBN(param_1,&_LC397);
...

{
  ...
  if (iVar1 == 0) {
    ...
    if (iVar1 == 0) {
      ...
      r = (BIGNUM *)0x0;
      a_00 = (BIGNUM *)getBN(param_1,&_LC404);
...

{
  ...
  if (iVar1 == 0) goto LAB_0010a78e;
  r = BN_new();
  iVar1 = test_ptr("test/bntest.c",0x567,"ret = BN_new()",r);
  if (iVar1 == 0) goto LAB_0010a815;
  pBVar3 = (BIGNUM *)getBN(param_1,&_LC423);
  iVar1 = test_ptr("test/bntest.c",0x77,"ret = getBN(s, attribute)",pBVar3);
  if (iVar1 != 0) {
    uVar4 = BN_get_word(pBVar3);
    iVar1 = test_ulong_le("test/bntest.c",0x78,"word = BN_get_word(ret)","INT_MAX",uVar4,0x7fffffff)
    ;
    if (iVar1 != 0) {
      BN_free(pBVar3);
      iVar1 = BN_lshift(r,a,(int)uVar4);
      iVar1 = test_true("test/bntest.c",0x56b,"BN_lshift(ret, a, n)",iVar1 != 0);
      if (iVar1 == 0) {
LAB_0010a815:
        iVar1 = 0;
      }
...

{
  ...
  local_50 = (BIGNUM *)0x0;
  local_48 = (BIGNUM *)0x0;
  local_58 = (BIGNUM *)getBN(param_1,&_LC393);
...

{
  ...
  if (iVar1 == 0) goto LAB_0010b15e;
  r = BN_new();
  iVar1 = test_ptr("test/bntest.c",0x580,"ret = BN_new()",r);
  if (iVar1 == 0) goto LAB_0010b2e5;
  a_01 = (BIGNUM *)getBN(param_1,&_LC423);
  iVar1 = test_ptr("test/bntest.c",0x77,"ret = getBN(s, attribute)",a_01);
  if (iVar1 == 0) {
LAB_0010b2e0:
    BN_free(a_01);
  }
  else {
    uVar2 = BN_get_word(a_01);
    iVar1 = test_ulong_le("test/bntest.c",0x78,"word = BN_get_word(ret)","INT_MAX",uVar2,0x7fffffff)
    ;
    if (iVar1 == 0) goto LAB_0010b2e0;
    BN_free(a_01);
    iVar1 = BN_rshift(r,a,(int)uVar2);
    iVar1 = test_true("test/bntest.c",0x584,"BN_rshift(ret, a, n)",iVar1 != 0);
    if (iVar1 != 0) {
      iVar1 = BN_cmp(a_00,r);
      if (iVar1 == 0) {
        if ((int)uVar2 == 1) {

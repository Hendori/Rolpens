...
LAB_0010014b:
    ...
    if (((uVar1 & 0xfffffffb) == 1) && (bVar4 = true, iVar2 == 1)) goto LAB_0010010d;
    if ((uVar1 != 2) || (iVar2 != 3)) {
      if ((uVar1 == 3) && (bVar4 = true, iVar2 == 2)) goto LAB_0010010d;
      if ((uVar1 != 0xb) || (iVar2 != 7)) {
        if ((uVar1 == 4) && (bVar4 = true, iVar2 == 4)) goto LAB_0010010d;
        goto LAB_0010014b;
      }
    }
    bVar4 = true;
...

{
  ...
  if ((iVar1 == 0) ||
     (iVar1 = test_ptr("test/radix/quic_bindings.c",0x6f,&_LC26,param_2), iVar1 == 0)) {
LAB_00100a20:
...
LAB_00100ad8:
        OPENSSL_LH_insert(DAT_00108e68,ptr);
...

{
  ...
  if (iVar4 == 0) {
    ...
    BIO_printf(param_2,"%sType:          %s\n","          ",&_LC59);
    if ((iVar3 == 0) || (iVar3 = SSL_get_conn_close_info(uVar1,local_68,0x28), iVar3 == 0))
    goto LAB_00100be5;
    bVar2 = false;
LAB_00100d38:
    puVar8 = (undefined *)ossl_quic_err_to_string(local_68._0_8_);
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  iVar1 = test_size_t_ge("test/radix/terp.c",0x275,"terp->stk_end - terp->stk_cur","buf_len",
                         *(long *)(lVar3 + 0x70) - *(long *)(lVar3 + 0x68),8);
  if (iVar1 != 0) {
  ...
  iVar1 = test_true("test/radix/quic_ops.c",0x129,
  ...
  if (iVar1 != 0) {
    ...
    iVar1 = test_true("test/radix/quic_ops.c",0x129,
                      "TERP_stk_pop(((fctx->terp)), &(((flags))), sizeof(((flags))))",iVar1);
    if (iVar1 != 0) {
      lVar3 = *param_1;
      uVar5 = 0;
      iVar1 = test_size_t_ge("test/radix/terp.c",0x275,"terp->stk_end - terp->stk_cur","buf_len",
      ...
      iVar1 = test_true("test/radix/quic_ops.c",0x12a,
                        "TERP_stk_pop((fctx->terp), &((stream_name)), sizeof((stream_name)))",iVar1)
      ;
      if (iVar1 != 0) {
        uVar6 = 0;
        ...
        if (iVar1 != 0) {
          ...
          iVar1 = test_ptr_null("test/radix/quic_ops.c",0x12d,
                                "RADIX_PROCESS_get_obj(RP(), stream_name)",uVar4);
          if (iVar1 != 0) {
            if (lVar7 == 0) {
...
LAB_00104a5b:
              ...
              if (iVar1 != 0) {
LAB_00104a2d:
                iVar1 = RADIX_PROCESS_set_ssl_constprop_0(uVar5,ssl);
                iVar1 = test_true("test/radix/quic_ops.c",0x13f,
                                  "RADIX_PROCESS_set_ssl(RP(), stream_name, stream)",iVar1 != 0);
...

{
  ...
  iVar1 = test_true("test/radix/quic_ops.c",0x1bd,
                    "TERP_stk_pop((fctx->terp), &((mode)), sizeof((mode)))",iVar1 != 0);
  if (iVar1 != 0) {
    uVar5 = 0;
    uVar2 = test_size_t_lt("test/radix/quic_bindings.c",0x29e,&_LC112,"NUM_SLOTS",0,8);
    if (uVar2 != 0) {
    ...
    if (iVar1 != 0) {
      ...
      iVar1 = test_true("test/radix/quic_ops.c",0x1c0,
                        "SSL_set_default_stream_mode(ssl, (uint32_t)mode)",iVar1 != 0);
      return iVar1 != 0;
    }
  }
  return false;
              ...
              if (iVar2 != 0) {
                ...
                if (iVar2 != 0) {
                  ...
                  iVar2 = test_int_ge("test/radix/quic_ops.c",0x3c8,
                                      "ntohs(BIO_ADDR_rawport(src_addr))",&_LC10,
                                      uVar1 << 8 | uVar1 >> 8,0);
                  if (iVar2 != 0) {
                    lVar4 = BIO_ctrl(bp,0x2c,0,parg);
                    iVar2 = test_true("test/radix/quic_ops.c",0x3cf,
                                      "BIO_dgram_set_peer(dst_bio, src_addr)",(int)lVar4 != 0);
                    bVar5 = iVar2 != 0;
                    goto LAB_001056b5;
                  }
                }
...

{
  ...
  iVar1 = test_true("test/radix/quic_ops.c",0x22a,
                    "TERP_stk_pop(((fctx->terp)), &(((buf_len))), sizeof(((buf_len))))",iVar1 != 0);
  if (iVar1 != 0) {
    lVar4 = *param_1;
    uVar6 = 0;
    iVar1 = test_size_t_ge("test/radix/terp.c",0x275,"terp->stk_end - terp->stk_cur","buf_len",
    ...
    iVar1 = test_true("test/radix/quic_ops.c",0x22a,
                      "TERP_stk_pop(((fctx->terp)), &(((buf))), sizeof(((buf))))",iVar1);
    if (iVar1 != 0) {
      uVar5 = 0;
      uVar2 = test_size_t_lt("test/radix/quic_bindings.c",0x29e,&_LC112,"NUM_SLOTS",0,8);
      if (uVar2 != 0) {
      ...
      if (iVar1 != 0) {
        ...
        if (iVar3 != 0) {
          ...
          if (iVar1 != 0) {
            iVar1 = test_size_t_eq("test/radix/quic_ops.c",0x230,"bytes_written","buf_len",local_48,
                                   uVar7);
            bVar8 = iVar1 != 0;
            goto LAB_001059a4;
          }
...

{
  ...
  iVar3 = test_true("test/radix/quic_tests.c",0x53,
                    "TERP_stk_pop((fctx->terp), &((mode)), sizeof((mode)))",iVar3 != 0);
  if (iVar3 != 0) {
    ...
    if (iVar3 != 0) {
      ...
      iVar3 = test_true("test/radix/quic_tests.c",0x54,"expect_slot_ssl(fctx, (1), &((Lax[0])))",
                        uVar4);
      if (iVar3 != 0) {
        local_1e0 = 0;
        ...
        iVar3 = test_true("test/radix/quic_tests.c",0x54,"expect_slot_ssl(fctx, (2), &((Lax[1])))",
                          uVar4);
        if (iVar3 != 0) {
          local_1d8 = 0;
          ...
          iVar3 = test_true("test/radix/quic_tests.c",0x54,"expect_slot_ssl(fctx, (3), &((Lax[2])))"
                            ,uVar4);
          if (iVar3 != 0) {
            local_1d0 = 0;
            ...
            iVar3 = test_true("test/radix/quic_tests.c",0x54,
                              "expect_slot_ssl(fctx, (4), &((Lax[3])))",uVar4);
            if (iVar3 != 0) {
              local_1c8[0] = 2;
              ...
              iVar3 = test_true("test/radix/quic_tests.c",0x88,
                                "SSL_poll(items, OSSL_NELEM(items), sizeof(SSL_POLL_ITEM), p_timeout, 0, &result_count)"
                                ,iVar3 != 0);
              if (iVar3 != 0) {
                ossl_time_now();
                iVar3 = test_size_t_eq("test/radix/quic_tests.c",0x8d,"result_count",
                                       "expected_result_count",local_210,uVar10);
                if (iVar3 != 0) {
                  lVar5 = 0x18;
                  do {
                    iVar3 = test_uint64_t_eq("test/radix/quic_tests.c",0x91,"items[i].revents",
                                             "expected_items[i].revents",
                                             *(undefined8 *)((long)local_1c8 + lVar5),
                                             *(undefined8 *)((long)local_108 + lVar5));
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  iVar1 = test_size_t_ge("test/radix/terp.c",0x275,"terp->stk_end - terp->stk_cur","buf_len",
                         *(long *)(lVar5 + 0x70) - *(long *)(lVar5 + 0x68),8);
  if (iVar1 != 0) {
  ...
  iVar1 = test_true("test/radix/quic_ops.c",0x150,
                    "TERP_stk_pop(((fctx->terp)), &(((flags))), sizeof(((flags))))",iVar1 != 0);
  if (iVar1 != 0) {
    lVar5 = *param_1;
    uVar6 = 0;
    iVar1 = test_size_t_ge("test/radix/terp.c",0x275,"terp->stk_end - terp->stk_cur","buf_len",
    ...
    iVar1 = test_true("test/radix/quic_ops.c",0x150,
                      "TERP_stk_pop(((fctx->terp)), &(((conn_name))), sizeof(((conn_name))))",iVar1)
    ;
    if (iVar1 != 0) {
      uVar7 = 0;
      uVar2 = test_size_t_lt("test/radix/quic_bindings.c",0x29e,&_LC112,"NUM_SLOTS",0,8);
      ...
      iVar1 = test_true("test/radix/quic_ops.c",0x151,"expect_slot_ssl(fctx, (0), &((listener)))",
                        uVar2);
      if (iVar1 != 0) {
        local_58[0] = uVar6;
        uVar3 = OPENSSL_LH_retrieve(DAT_00108e68,local_58);
        iVar1 = test_ptr_null("test/radix/quic_ops.c",0x153,"RADIX_PROCESS_get_obj(RP(), conn_name)"
                              ,uVar3);
        if (iVar1 != 0) {
          ...
          iVar1 = test_true("test/radix/quic_ops.c",0x15a,
                            "RADIX_PROCESS_set_ssl(RP(), conn_name, conn)",iVar1 != 0);
          if (iVar1 == 0) goto LAB_001064c0;
          if (check_pending_match != 0) {
            if ((pending_cb_called != 0) && (hello_cb_called != 0)) {
              iVar1 = test_ptr_eq("test/radix/quic_ops.c",0x163,"pending_ssl_obj",
                                  "client_hello_ssl_obj",pending_ssl_obj,client_hello_ssl_obj);
              if (iVar1 != 0) {
                iVar1 = test_ptr_eq("test/radix/quic_ops.c",0x167,"pending_ssl_obj",&_LC115,
                                    pending_ssl_obj,ssl);
...

{
  ...
  iVar1 = test_true("test/radix/quic_ops.c",0x269,
                    "TERP_stk_pop(((fctx->terp)), &(((buf_len))), sizeof(((buf_len))))",iVar1 != 0);
  if (iVar1 != 0) {
    lVar4 = *param_1;
    uVar7 = 0;
      ...
      if (iVar1 != 0) {
        if ((lVar9 != 0) &&
          ...
          *(void **)(lVar4 + 0x10) = pvVar8;
          iVar1 = test_ptr("test/radix/quic_ops.c",0x26d,"RT()->tmp_buf = OPENSSL_malloc(buf_len)",
                           pvVar8);
        ...
        if (iVar3 != 0) {
          if (iVar1 != 0) {
            ...
            if (local_48 + *(long *)(lVar4 + 0x18) == lVar9) {
              if (lVar9 != 0) {
                lVar4 = CRYPTO_THREAD_get_local(&radix_thread);
                iVar1 = test_mem_eq("test/radix/quic_ops.c",0x27f,"RT()->tmp_buf",&_LC185,
    ...
    if (iVar5 == 0) {
      ...
      if (iVar5 != 0) {
        test_info("test/radix/terp.c",0x20f,"%s: script \'%s\' (%s)","executing script",
                  param_1->method,param_1->callback,puVar13);
...
LAB_00107ea2:
  ...
  goto LAB_00107740;
code_r0x00108256:
  if (iVar5 != 1) goto code_r0x0010825f;
  goto LAB_001073b5;
code_r0x0010825f:
...
LAB_00107539:
  ...
  lVar12 = local_88._0_8_;
LAB_0010758c:
  test_output_memory("Final state of stack",local_98._8_8_,lVar12 - local_98._8_8_);
...
LAB_0010838b:
    ...
    DAT_00108e68 = OPENSSL_LH_set_thunks
    ...
    iVar4 = test_ptr("test/radix/quic_bindings.c",0x9d,
                     "rp->objs = lh_RADIX_OBJ_new(RADIX_OBJ_hash, RADIX_OBJ_cmp)",DAT_00108e68);
    ...
    if ((filename != (char *)0x0) && (*filename != '\0')) {
      ...
      iVar4 = test_ptr("test/radix/quic_bindings.c",0xa6,
                       "rp->keylog_out = BIO_new_file(keylog_path, \"a\")",DAT_00108e78);
      if (iVar4 == 0) goto LAB_0010838b;
    }
    uVar5 = 1;
    _DAT_00108e80 = 0;
  ...
  if (iVar4 != 0) {
    ...
    if (iVar4 != 0) {
      ...
      if (_DAT_00108e80 == 0) {
        local_d8 = 1;
        uVar10 = 1;
        for (uVar9 = 1; iVar4 = OPENSSL_sk_num(DAT_00108e58), pBVar3 = _bio_err,
        ...
        for (uVar9 = 1; iVar4 = OPENSSL_sk_num(DAT_00108e58), uVar9 < (ulong)(long)iVar4;
            uVar9 = uVar9 + 1) {
          ...
          BIO_printf(pBVar3,
                     ...
                     ,radix_process,DAT_00108e48,*(undefined8 *)(lVar6 + 0x20),
      ...
      iVar4 = test_true("test/radix/quic_bindings.c",0x261,
                        "RADIX_PROCESS_join_all_threads(&radix_process, &testresult_child)",uVar10);
      pBVar3 = _bio_err;
      if (iVar4 != 0) {
        ...
        if (iVar4 != 0) {
          ...
          test_true("test/radix/quic_bindings.c",0x247,
                    "CRYPTO_THREAD_set_local(&radix_thread, NULL)",iVar4 != 0);
        }
        for (uVar9 = 0; iVar4 = OPENSSL_sk_num(DAT_00108e58), uVar9 < (ulong)(long)iVar4;
            uVar9 = uVar9 + 1) {

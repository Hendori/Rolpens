...
bool self_test_on_demand_fail(undefined8 param_1,int *param_2)
...
undefined8 self_test_on_load(undefined8 param_1,int *param_2)
...
undefined8 self_test_on_demand(undefined8 param_1,int *param_2)

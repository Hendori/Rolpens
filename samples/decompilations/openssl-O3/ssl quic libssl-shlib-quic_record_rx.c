...

{
  ...
  if (((((param_7 | param_4) < 0x80000000) && (lVar4 != 0)) && (*(uint *)(lVar4 + 100) < param_4))
     && (uVar6 = *(ulong *)(param_1 + 0x3f0),
        uVar5 = ossl_qrl_get_suite_max_forged_pkt(*(undefined4 *)(lVar4 + 0x60)), uVar6 < uVar5)) {
    if (param_9 == 3) {
      ...
      if (cVar1 == '\x03') {
        ...
        *param_11 = lVar8;
        ...
        if (cVar1 == '\x01') {
          *param_11 = (ulong)((uint)*(long *)(lVar4 + 0x50) & 1 ^ param_10 & 0xff) +
                      *(long *)(lVar4 + 0x50);
        }
        else if (((cVar1 == '\x02') &&
                 (uVar7 = (uint)*(long *)(lVar4 + 0x50) & 1,
                 *param_11 = *(long *)(lVar4 + 0x50) - (ulong)(uVar7 ^ param_10 & 0xff),
                 uVar7 != (param_10 & 0xff))) && (*(ulong *)(param_1 + 0x3f8) <= param_8))
        goto LAB_00100131;
      }
    }
    else {
    ...
    if (7 < iVar3) {
      ...
      *(ulong *)((long)&local_60 + lVar8) =
           *(ulong *)((long)&local_60 + lVar8) ^
           (param_8 >> 0x38 | (param_8 & 0xff000000000000) >> 0x28 |
            (param_8 & 0xff0000000000) >> 0x18 | (param_8 & 0xff00000000) >> 8 |
            (param_8 & 0xff000000) << 8 | (param_8 & 0xff0000) << 0x18 | (param_8 & 0xff00) << 0x28
           | param_8 << 0x38);
      iVar3 = EVP_CipherInit_ex(ctx,(EVP_CIPHER *)0x0,(ENGINE *)0x0,(uchar *)0x0,iv,0);
      if ((iVar3 == 1) &&
         (iVar3 = EVP_CIPHER_CTX_ctrl(ctx,0x11,*(uint *)(lVar4 + 100),
                                      param_3 + (param_4 - *(uint *)(lVar4 + 100))), iVar3 == 1)) {
        iVar3 = EVP_CipherUpdate(ctx,(uchar *)0x0,(int *)&local_60,param_6,(int)param_7);
        if ((iVar3 == 1) &&
           (iVar3 = EVP_CipherUpdate(ctx,param_2,(int *)&local_60,param_3,
                                     (int)param_4 - *(int *)(lVar4 + 100)), iVar3 == 1)) {
...

{
  ...
  *(undefined1 (*) [16])(param_2 + 0x20) = (undefined1  [16])0x0;
  if (-1 < lVar23) {
    ...
    local_78 = lVar1;
    local_70 = lVar23;
    if ((lVar21 != 0) || (lVar21 = qrx_ensure_free_rxe_part_0(param_1,lVar23), lVar21 != 0)) {
      uVar28 = 0;
      ...
      if ((iVar20 != 0) && ((*(char *)(lVar21 + 0x70) == '\x01' && (*(uint *)(lVar21 + 0x74) < 2))))
      {
        ...
        if (iVar20 == 1) {
          ...
          if (*(char *)(lVar21 + 0x70) == '\x01') {
            ...
            if (local_98 != 0) {
              if ((*(ulong *)(lVar21 + 0x60) < local_98) &&
                 (lVar21 = qrx_resize_rxe(param_1 + 0x60,lVar21), lVar21 == 0)) goto LAB_001009a0;
          ...
          if (iVar20 != 0) {
            *(ulong *)(param_2 + 0x28) = *(ulong *)(param_2 + 0x28) | 1;
            ...
            if (iVar20 == 1) {
              ...
              iVar20 = ossl_quic_wire_decode_pkt_hdr_pn
                                 (lVar21 + 0xa2,*(byte *)(lVar21 + 0x71) >> 2 & 0xf,
                                  *(undefined8 *)(param_1 + 0x90 + (long)iVar20 * 8),lVar21 + 200);
              if (iVar20 != 0) {
                ...
                iVar20 = qrx_decrypt_pkt_body_constprop_0
                                   (param_1,lVar2,lVar25,lVar24,&local_88,lVar1,lVar4 - lVar1,
                                    *(undefined8 *)(lVar21 + 200),0,
                                    *(byte *)(lVar21 + 0x71) >> 1 & 1,&local_80);
                if (iVar20 != 0) {
                  cVar26 = '\0';
                  bVar19 = *(char *)(lVar21 + 0x70) - 2;
                  ...
                  if ((*(code **)(param_1 + 0x400) == (code *)0x0) ||
                     (iVar20 = (**(code **)(param_1 + 0x400))
                                         (*(undefined8 *)(lVar21 + 200),cVar26,
                                          *(undefined8 *)(param_1 + 0x408)), iVar20 != 0)) {
  ...
  if (iVar21 == 0) {
    ...
    while (pauVar4 != (undefined1 (*) [16])0x0) {
      ...
      *(long *)(param_1 + 1000) = *(long *)(param_1 + 1000) + uVar5;
      ...
      uStack_4b = 0;
      if (((long)uVar5 < 0) ||
         (local_88 = (undefined8 *)(pauVar4[0x12] + 8), local_80 = uVar5, uVar5 < 7)) {
        bVar17 = false;
        lVar28 = *(long *)*pauVar4;
LAB_00101ba3:
        ...
        do {
          ...
          if ((lVar28 != 0) || (lVar28 = qrx_ensure_free_rxe_part_0(param_1,local_80), lVar28 != 0))
          {
            ...
            iVar21 = ossl_quic_wire_decode_pkt_hdr
                               (&local_88,*(undefined8 *)(param_1 + 0x18),bVar37,0,lVar28 + 0x70,
                                local_78,0);
            puVar18 = local_88;
            bVar19 = (byte)uVar33;
            if (iVar21 == 0) {
...
LAB_001011ac:
                    ...
                    if (*(char *)(lVar28 + 0x70) == '\x01') {
                      ...
                      if (local_f0 != 0) {
                        if ((*(ulong *)(lVar28 + 0x60) < local_f0) &&
                           (lVar28 = qrx_resize_rxe(param_1 + 0x60,lVar28), lVar28 == 0))
                        goto LAB_00101265;
                      ...
                      if (iVar22 != 0) {
                        *(ulong *)(pauVar4[2] + 8) = *(ulong *)(pauVar4[2] + 8) | uVar36;
                        iVar22 = ossl_quic_wire_decode_pkt_hdr
                                           (&local_88,*(undefined8 *)(param_1 + 0x18),0,0,
                                            lVar28 + 0x70,0,0);
...
LAB_00101478:
                      ...
                      iVar22 = 0;
                      if ((bVar19 < 4) &&
                         (iVar22 = 0, *(int *)(CSWTCH_147 + (ulong)bVar19 * 4) != 0)) {
                        iVar22 = (*(int *)(CSWTCH_147 + (ulong)bVar19 * 4) != 2) + 1;
                      }
                      iVar22 = ossl_quic_wire_decode_pkt_hdr_pn
                                         (lVar28 + 0xa2,*(byte *)(lVar28 + 0x71) >> 2 & 0xf,
                                          *(undefined8 *)(param_1 + 0x90 + (long)iVar22 * 8));
                      if (iVar22 != 0) {
                        if (*(code **)(param_1 + 0x428) != (code *)0x0) {
                          (**(code **)(param_1 + 0x428))
                                    (0,1,0x201,puVar7,
                                     (undefined1 *)
                                     ((long)puVar18 + (-*(long *)(lVar28 + 0xb8) - (long)puVar7)),
                                     *(undefined8 *)(param_1 + 0x438),
                                     *(undefined8 *)(param_1 + 0x430));
                        }
                        ...
                        iVar21 = qrx_decrypt_pkt_body_constprop_0
                                           (param_1,lVar1,lVar31,lVar35,&local_98,puVar7,
                                            lVar26 - (long)puVar7,*(undefined8 *)(lVar28 + 200),
                                            iVar21,*(byte *)(lVar28 + 0x71) >> 1 & 1,&local_90);
                        if (iVar21 != 0) {
                          cVar20 = *(char *)(lVar28 + 0x70);
                          if ((byte)(cVar20 - 2U) < 4) {
                            cVar34 = '\0';
                            if (*(int *)(CSWTCH_147 + (ulong)(byte)(cVar20 - 2U) * 4) != 0) {
                              cVar34 = (*(int *)(CSWTCH_147 + (ulong)(byte)(cVar20 - 2U) * 4) != 2)
                                       + '\x01';
                            }
...
LAB_001015e6:
                              ...
                              if (iVar21 != 0) {
                                *(undefined8 *)(param_1 + 0x3f8) = uVar25;
                                if (*(code **)(param_1 + 0x410) != (code *)0x0) {
                                  (**(code **)(param_1 + 0x410))
                                            (uVar25,*(undefined8 *)(param_1 + 0x418));
                                }
                              }
                            }
                          }
                            ...
                            if (pcVar29 != (code *)0x0) {
LAB_001015c2:
                              iVar21 = (*pcVar29)(*(undefined8 *)(lVar28 + 200),cVar34,
                                                  *(undefined8 *)(param_1 + 0x408));
                          ...
                          *(undefined8 *)(lVar28 + 0x100) = uVar9;
                          *(undefined8 *)(lVar28 + 0x108) = uVar10;
                          uVar9 = *(undefined8 *)(pauVar4[8] + 8);
                          uVar10 = *(undefined8 *)pauVar4[9];
                          *(undefined8 *)(lVar28 + 0xf0) = uVar8;
                          *(undefined8 *)(lVar28 + 0xf8) = uVar11;
                          uVar8 = *(undefined8 *)(pauVar4[7] + 8);
                          uVar11 = *(undefined8 *)pauVar4[8];
                          *(undefined8 *)(lVar28 + 0x120) = uVar9;
                          *(undefined8 *)(lVar28 + 0x128) = uVar10;
                          uVar9 = *(undefined8 *)(pauVar4[10] + 8);
                          uVar10 = *(undefined8 *)pauVar4[0xb];
                          *(undefined8 *)(lVar28 + 0x110) = uVar8;
                          *(undefined8 *)(lVar28 + 0x118) = uVar11;
                          uVar8 = *(undefined8 *)(pauVar4[9] + 8);
                          uVar11 = *(undefined8 *)pauVar4[10];
                          *(undefined8 *)(lVar28 + 0x140) = uVar9;
                          *(undefined8 *)(lVar28 + 0x148) = uVar10;
                          uVar9 = *(undefined8 *)(pauVar4[0xc] + 8);
                          uVar10 = *(undefined8 *)pauVar4[0xd];
                          *(undefined8 *)(lVar28 + 0x130) = uVar8;
                          *(undefined8 *)(lVar28 + 0x138) = uVar11;
                          uVar8 = *(undefined8 *)(pauVar4[0xb] + 8);
                          uVar11 = *(undefined8 *)pauVar4[0xc];
                          *(undefined8 *)(lVar28 + 0x160) = uVar9;
                          *(undefined8 *)(lVar28 + 0x168) = uVar10;
                          uVar9 = *(undefined8 *)(pauVar4[0xe] + 8);
                          uVar10 = *(undefined8 *)pauVar4[0xf];
                          *(undefined8 *)(lVar28 + 0x150) = uVar8;
                          *(undefined8 *)(lVar28 + 0x158) = uVar11;
                          uVar8 = *(undefined8 *)(pauVar4[0xd] + 8);
                          uVar11 = *(undefined8 *)pauVar4[0xe];
                          *(undefined8 *)(lVar28 + 0x180) = uVar9;
                          *(undefined8 *)(lVar28 + 0x188) = uVar10;
                          uVar9 = *(undefined8 *)(pauVar4[0x10] + 8);
                          uVar10 = *(undefined8 *)pauVar4[0x11];
                          *(undefined8 *)(lVar28 + 0x170) = uVar8;
                          *(undefined8 *)(lVar28 + 0x178) = uVar11;
                          uVar8 = *(undefined8 *)(pauVar4[0xf] + 8);
                          uVar11 = *(undefined8 *)pauVar4[0x10];
...
LAB_001012b8:
      ...
      *pauVar4 = (undefined1  [16])0x0;
      if (bVar17) {
        ...
        if ((cVar20 == '\0') && (*(ulong *)(param_1 + 0x20) <= *(ulong *)(param_1 + 0x28)))
        goto LAB_00101a97;
...
LAB_00101a97:
        ossl_quic_demux_release_urxe(*(undefined8 *)(param_1 + 0x10),pauVar4);
      }
      pauVar4 = *(undefined1 (**) [16])(param_1 + 0x30);
    }

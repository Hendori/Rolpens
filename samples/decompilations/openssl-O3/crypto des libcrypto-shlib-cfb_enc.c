...
switchD_001004fc_caseD_5:
      pbVar22[-1] = (byte)uVar15;
      pbVar22 = pbVar22 + -1;
LAB_0010052c:
      pbVar22[-1] = (byte)(uVar20 >> 0x18);
      pbVar13 = pbVar22 + -1;
      goto LAB_00100538;
    }
    uVar23 = length - 4;
    ...
    while( true ) {
      ...
      puVar12[-1] = (uchar)(uVar16 >> 0x18);
      puVar12[-2] = (uchar)(uVar16 >> 0x10);
      puVar12[-3] = (uchar)(uVar16 >> 8);
      if (uVar23 < 4) break;
      uVar23 = uVar23 - 4;
      puVar12 = puVar12 + 4;
      local_60 = uVar7;
      ...
      DES_encrypt1(&local_60,schedule,1);
      uVar20 = (uint)*pbVar22 |
               (uint)pbVar22[1] << 8 | (uint)pbVar22[2] << 0x10 | (uint)pbVar22[3] << 0x18;
...
switchD_00100849_caseD_6:
    ...
    while( true ) {
      ...
      puVar12[-1] = (uchar)(uVar14 >> 0x18);
      puVar12[-2] = (uchar)(uVar14 >> 0x10);
      puVar12[-3] = (uchar)(uVar14 >> 8);
      if (uVar23 < 4) break;
      uVar23 = uVar23 - 4;
      puVar12 = puVar12 + 4;
      local_60 = uVar7;
      ...
      pbVar22 = pbVar22 + 4;
      uVar7 = uVar14;
      uVar14 = ((uint)*pbVar2 << 8 | (uint)*pbVar1 << 0x10 | (uint)*pbVar13 << 0x18 | (uint)bVar6) ^
               local_60;
    }
    uVar21 = (ulong)uVar14;
    uVar11 = (ulong)uVar7;
...
LAB_00100210:
  local_58 = auVar4;
  *ivec = (DES_cblock)
          ((((((((uVar21 >> 0x18) << 8 | uVar21 >> 0x10 & 0xff) << 8 | uVar21 >> 8 & 0xff) << 8 |
              uVar21 & 0xff) << 8 | uVar11 >> 0x18 & 0xff) << 8 | uVar11 >> 0x10 & 0xff) << 8 |
           (uVar11 & 0xffffffff) >> 8 & 0xff) << 8 | uVar11 & 0xff);
LAB_0010027f:
...
LAB_0010044c:
  ...
  uVar20 = (uint)*pbVar22 << 0x18;
LAB_00100457:
  uVar20 = (uint)puVar12[-1] << 0x10 | uVar20;
  puVar12 = puVar12 + -1;
LAB_00100464:
  puVar18 = puVar12 + -1;
...
LAB_00100c55:
  auVar4 = local_58;
  bVar6 = 8 - sVar3;
  bVar19 = (byte)((int)(uint)(byte)local_58[(long)iVar10 + 1] >> (bVar6 & 0x1f)) |
           (char)*puVar8 << sVar3;
  local_58[0] = bVar19;
  local_58._2_14_ = auVar4._2_14_;
  local_58[1] = (byte)((int)(uint)(byte)local_58[(long)iVar10 + 2] >> (bVar6 & 0x1f)) |
                local_58[(long)iVar10 + 1] << sVar3;
  local_58._3_13_ = auVar4._3_13_;
  local_58[2] = (byte)((int)(uint)(byte)local_58[(long)iVar10 + 3] >> (bVar6 & 0x1f)) |
                local_58[(long)iVar10 + 2] << sVar3;
  local_58._4_12_ = auVar4._4_12_;
  local_58[3] = (byte)((int)(uint)(byte)local_58[(long)iVar10 + 4] >> (bVar6 & 0x1f)) |
                local_58[(long)iVar10 + 3] << sVar3;
  local_58._5_11_ = auVar4._5_11_;
  local_58[4] = (byte)((int)(uint)(byte)local_58[(long)iVar10 + 5] >> (bVar6 & 0x1f)) |
                local_58[(long)iVar10 + 4] << sVar3;
  local_58._6_10_ = auVar4._6_10_;
...
LAB_001007e3:
  uVar15 = (uint)pbVar22[-1] << 0x10 | uVar15;
  pbVar22 = pbVar22 + -1;
LAB_001007f0:
  pbVar13 = pbVar22 + -1;
  pbVar22 = pbVar22 + -1;

...
/* GodotPinJoint3D::solve(float) */

void __thiscall GodotPinJoint3D::solve(GodotPinJoint3D *this,float param_1)

{
  ...
  fVar19 = *(float *)(lVar6 + 0x60) * fVar18 + *(float *)(lVar6 + 100) * fVar23 +
           *(float *)(lVar6 + 0x68) * fVar1 + fVar21;
  fVar20 = *(float *)(lVar6 + 0x54) * fVar18 + *(float *)(lVar6 + 0x58) * fVar23 +
           *(float *)(lVar6 + 0x5c) * fVar1 + fVar28;
  fVar26 = *(float *)(lVar6 + 0x6c);
  fVar22 = *(float *)(this + 0x124);
  fVar25 = *(float *)(this + 0x128);
  local_40[0] = 0.0;
  local_40[1] = 0.0;
  fVar14 = fVar18 * *(float *)(lVar6 + 0x48) + fVar23 * *(float *)(lVar6 + 0x4c) +
           fVar1 * *(float *)(lVar6 + 0x50) + fVar26;
  ...
  fVar15 = *(float *)(lVar7 + 100) * fVar25 + *(float *)(lVar7 + 0x60) * fVar22 +
           *(float *)(lVar7 + 0x68) * fVar23 + fVar17;
  fVar1 = *(float *)(this + 0x48);
  fVar2 = *(float *)(this + 0x4c);
  fVar16 = *(float *)(lVar7 + 0x54) * fVar22 + *(float *)(lVar7 + 0x58) * fVar25 +
           *(float *)(lVar7 + 0x5c) * fVar23 + fVar18;
  fVar3 = *(float *)(this + 0x50);
  fVar27 = *(float *)(lVar7 + 0x6c);
  fVar24 = (float)((uint)fVar3 ^ _LC1);
  fVar23 = fVar22 * *(float *)(lVar7 + 0x48) + fVar25 * *(float *)(lVar7 + 0x4c) +
           fVar23 * *(float *)(lVar7 + 0x50) + fVar27;
  while( true ) {
    *pfVar13 = 1.0;
    ...
    fVar21 = (((float)((uint)((fVar20 - fVar16) * local_40[1] + (fVar14 - fVar23) * local_40[0] +
                             (fVar19 - fVar15) * local_40[2]) ^ uVar11) * fVar1) / param_1) *
             (_LC2 / *(float *)pGVar12) -
             ((((fVar26 * fStack_74 - *(float *)(lVar6 + 0xe4) * fVar25) + *(float *)(lVar6 + 0xdc))
              - ((fVar27 * *(float *)(lVar7 + 0xec) - *(float *)(lVar7 + 0xe4) * fVar21) +
                *(float *)(lVar7 + 0xdc))) * local_40[1] +
              (((*(float *)(lVar6 + 0xe8) * fVar25 - fStack_74 * fVar22) + local_88) -
              ((fVar21 * *(float *)(lVar7 + 0xe8) - *(float *)(lVar7 + 0xec) * fVar18) +
              *(float *)(lVar7 + 0xd8))) * local_40[0] +
             (((*(float *)(lVar6 + 0xe4) * fVar22 - *(float *)(lVar6 + 0xe8) * fVar26) +
              *(float *)(lVar6 + 0xe0)) -
             ((fVar18 * *(float *)(lVar7 + 0xe4) - fVar27 * *(float *)(lVar7 + 0xe8)) +
             *(float *)(lVar7 + 0xe0))) * local_40[2]) * fVar2 * (_LC2 / *(float *)pGVar12);
    fVar18 = fVar21;
    if (((0.0 < fVar3) && (fVar18 = fVar24, fVar24 <= fVar21)) && (fVar18 = fVar3, fVar21 <= fVar3))
    {
      fVar18 = fVar21;
    }
    ...
    *(float *)(this + 0x54) = *(float *)(this + 0x54) + fVar18;
    if (GVar4 != (GodotPinJoint3D)0x0) {
      ...
      *(ulong *)(lVar6 + 0xe8) =
           CONCAT44((float)((ulong)*(undefined8 *)(lVar6 + 0x1c8) >> 0x20) * fVar28 +
                    *(float *)(lVar6 + 0x1c8) * fVar22 + *(float *)(lVar6 + 0x1d0) * fVar26 +
                    fStack_74,
                    (float)*(undefined8 *)(lVar6 + 0x1c0) * fVar28 +
                    *(float *)(lVar6 + 0x1bc) * fVar22 + *(float *)(lVar6 + 0x1c4) * fVar26 +
                    (float)uVar8);
      ...
      *(float *)(lVar6 + 0xe4) =
           fVar26 * *(float *)(lVar6 + 0x1b8) +
           fVar28 * *(float *)(lVar6 + 0x1b4) + fVar22 * *(float *)(lVar6 + 0x1b0) + fStack_7c;
    }
    if (GVar5 != (GodotPinJoint3D)0x0) {
      ...
      fVar22 = fVar22 * fVar27 - fVar25 * fVar17;
      *(ulong *)(lVar7 + 0xd8) =
           CONCAT44(fVar17 * fVar18 + *(float *)(lVar7 + 0xdc),
                    fVar21 * fVar18 + *(float *)(lVar7 + 0xd8));
      *(ulong *)(lVar7 + 0xe0) =
           CONCAT44(fVar28 * *(float *)(lVar7 + 0x1b4) + fVar22 * *(float *)(lVar7 + 0x1b0) +
                    fVar26 * *(float *)(lVar7 + 0x1b8) + *(float *)(lVar7 + 0xe4),
                    fVar18 * fVar27 + *(float *)(lVar7 + 0xe0));
      *(ulong *)(lVar7 + 0xe8) =
           CONCAT44((float)((ulong)*(undefined8 *)(lVar7 + 0xe8) >> 0x20) +
                    (float)((ulong)*(undefined8 *)(lVar7 + 0x1cc) >> 0x20) * fVar26 +
                    *(float *)(lVar7 + 0x1cc) * fVar28 +
                    (float)((ulong)*(undefined8 *)(lVar7 + 0x1c4) >> 0x20) * fVar22,
                    (float)*(undefined8 *)(lVar7 + 0xe8) +
                    (float)*(undefined8 *)(lVar7 + 0x1c4) * fVar26 +
                    *(float *)(lVar7 + 0x1c0) * fVar28 +
                    (float)*(undefined8 *)(lVar7 + 0x1bc) * fVar22);
    }
...
/* GodotPinJoint3D::setup(float) */

ulong GodotPinJoint3D::setup(float param_1)
    ...
    *(undefined4 *)(in_RDI + 0x54) = 0;
    do {
      ...
      *(undefined4 *)puVar13 = 0x3f800000;
      ...
      fVar18 = ((*(float *)(lVar4 + 0x60) * fVar16 + *(float *)(lVar4 + 100) * fVar21 +
                 *(float *)(lVar4 + 0x68) * fVar23 + *(float *)(lVar4 + 0x74)) -
               *(float *)(lVar4 + 0x74)) - local_fc;
      local_104._4_4_ = (float)((ulong)uVar5 >> 0x20);
      fVar17 = ((*(float *)(lVar4 + 0x54) * fVar16 + *(float *)(lVar4 + 0x58) * fVar21 +
                 *(float *)(lVar4 + 0x5c) * fVar23 + *(float *)(lVar4 + 0x70)) -
               *(float *)(lVar4 + 0x70)) - local_104._4_4_;
      local_104._0_4_ = (float)uVar5;
      fVar20 = ((fVar16 * *(float *)(lVar4 + 0x48) + fVar21 * *(float *)(lVar4 + 0x4c) +
                 fVar23 * *(float *)(lVar4 + 0x50) + *(float *)(lVar4 + 0x6c)) -
               *(float *)(lVar4 + 0x6c)) - (float)local_104;
      ...
      fVar22 = ((*(float *)(lVar3 + 0x60) * fVar21 + *(float *)(lVar3 + 100) * fVar23 +
                 *(float *)(lVar3 + 0x68) * fVar16 + *(float *)(lVar3 + 0x74)) -
               *(float *)(lVar3 + 0x74)) - local_108;
      local_110._4_4_ = (float)((ulong)uVar6 >> 0x20);
      fVar19 = ((*(float *)(lVar3 + 0x54) * fVar21 + *(float *)(lVar3 + 0x58) * fVar23 +
                 *(float *)(lVar3 + 0x5c) * fVar16 + *(float *)(lVar3 + 0x70)) -
               *(float *)(lVar3 + 0x70)) - local_110._4_4_;
      local_110._0_4_ = (float)uVar6;
      fVar15 = ((fVar21 * *(float *)(lVar3 + 0x48) + fVar23 * *(float *)(lVar3 + 0x4c) +
                 fVar16 * *(float *)(lVar3 + 0x50) + *(float *)(lVar3 + 0x6c)) -
               *(float *)(lVar3 + 0x6c)) - (float)local_110;
      local_110 = uVar6;
      local_104 = uVar5;
      Basis::transposed();
      ...
      *(ulong *)(pfVar12 + 0xd) = CONCAT44(fVar15,fVar16);
      fVar21 = fVar23 * fVar21 + fVar16 * fVar17 + fVar15 * fVar18 +
               fVar14 * fVar24 + fVar22 * fVar25 + fVar19 * fVar20 + fVar1 + fVar2;
      pfVar12[0xf] = fVar21;
      if (fVar21 <= 0.0) {
...
void __thiscall GodotPinJoint3D::~GodotPinJoint3D(GodotPinJoint3D *this)
...
/* GodotPinJoint3D::set_param(PhysicsServer3D::PinJointParam, float) */

void __thiscall GodotPinJoint3D::set_param(undefined4 param_1,GodotPinJoint3D *this,int param_3)
...
/* GodotPinJoint3D::get_param(PhysicsServer3D::PinJointParam) const */

void __thiscall GodotPinJoint3D::get_param(undefined8 param_1,int param_2)
...
/* GodotPinJoint3D::GodotPinJoint3D(GodotBody3D*, Vector3 const&, GodotBody3D*, Vector3 const&) */

void __thiscall
GodotPinJoint3D::GodotPinJoint3D
          (GodotPinJoint3D *this,GodotBody3D *param_1,Vector3 *param_2,GodotBody3D *param_3,
          Vector3 *param_4)

{
  ...
  *(undefined ***)this = &PTR_get_soft_body_ptr_00101e90;
  ...
  do {
    ...
    *(undefined8 *)(pGVar5 + 0xc) = 0;
    *(undefined4 *)(pGVar5 + 0x14) = 0;
    *(undefined8 *)(pGVar5 + 0x18) = 0;
    *(undefined4 *)(pGVar5 + 0x20) = 0;
    *(undefined8 *)(pGVar5 + 0x24) = 0;
    *(undefined4 *)(pGVar5 + 0x2c) = 0;
    *(undefined8 *)(pGVar5 + 0x30) = 0;
    *(undefined4 *)(pGVar5 + 0x38) = 0;
  ...
  *puVar7 = 0;
  ...
  puVar7 = (undefined4 *)
           HashMap<GodotConstraint3D*,int,HashMapHasherDefault,HashMapComparatorDefault<GodotConstraint3D*>,DefaultTypedAllocator<HashMapElement<GodotConstraint3D*,int>>>
           ::operator[]((HashMap<GodotConstraint3D*,int,HashMapHasherDefault,HashMapComparatorDefault<GodotConstraint3D*>,DefaultTypedAllocator<HashMapElement<GodotConstraint3D*,int>>>
                         *)(lVar3 + 0x2f0),(GodotConstraint3D **)&local_28);
  *puVar7 = 1;
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
  }
...
/* GodotPinJoint3D::get_type() const */

undefined8 GodotPinJoint3D::get_type(void)
...
LAB_0010178b:
  if ((float)uVar55 * __LC6 < (float)(iVar43 + 1)) {

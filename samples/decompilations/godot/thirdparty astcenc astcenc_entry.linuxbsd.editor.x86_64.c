...
/* std::_Function_handler<void (), astcenc_compress_image(astcenc_context*, astcenc_image*,
   astcenc_swizzle const*, unsigned char*, unsigned long, unsigned
   int)::{lambda()#2}>::_M_invoke(std::_Any_data const&) */
...
undefined8 validate_flags(int param_1,uint param_2)

{
  ...
  if ((((uVar1 + (uVar1 >> 4) & 0xf0f0f0f0f0f0f0f) * 0x101010101010101 >> 0x38 == 0) &&
      (uVar1 = ((ulong)(param_2 & 0x41) & 0x3333333333333333) + (ulong)((param_2 & 0x41) >> 2),
      (uVar1 + (uVar1 >> 4) & 0xf0f0f0f0f0f0f0f) * 0x101010101010101 >> 0x38 != 2)) &&
     (((param_2 & 2) == 0 || (uVar2 = 0xb, 1 < param_1 - 2U)))) {
    uVar2 = 0;
  }
  return uVar2;
}
...
/* compress_image(astcenc_context&, unsigned int, astcenc_image const&, astcenc_swizzle const&,
   unsigned char*) */

void compress_image(astcenc_context *param_1,uint param_2,astcenc_image *param_3,
                   astcenc_swizzle *param_4,uchar *param_5)

{
  ...
  if (iVar18 == 0) {
    ...
    if ((((*(int *)param_4 == 0) && (*(int *)(param_4 + 4) == 1)) && (*(int *)(param_4 + 8) == 2))
       && (((*(int *)(param_4 + 0xc) == 3 && (1 < iVar6 - 2U)) &&
           ((uVar28 == 1 && (*(int *)(param_3 + 0xc) == 0)))))) {
          ...
          if (bVar22) {
            ...
            if (iVar30 < iVar14) {
              ...
              do {
                ...
                bVar15 = bVar16;
                if (iVar18 < iVar13) {
                  pfVar21 = (float *)(*(long *)(param_1 + 0x88) +
                                     ((long)iVar18 + (long)(iVar8 * iVar26)) * 4);
                  do {
                    iVar27 = iVar14;
                    bVar15 = bVar22;
                    if (_LC4 / ((float)(int)((uVar31 + iVar3) * (iVar3 + uVar29)) * __LC3) <
                        *pfVar21) break;
                    pfVar21 = pfVar21 + 1;
                    iVar27 = iVar26;
                    bVar15 = bVar16;
                  } while ((float *)(*(long *)(param_1 + 0x88) +
                                    ((long)(iVar8 * iVar26) +
                                    (ulong)(uint)(iVar13 - iVar18) + (long)iVar18) * 4) != pfVar21);
                }
                iVar26 = iVar27 + 1;
                bVar16 = bVar15;
              } while (iVar26 < iVar14);
...
LAB_0010043f:
            (*local_1060)(iVar6,param_3,local_1018,pbVar9,iVar18,iVar30,uVar28 * uVar23,param_4);
            if (((byte)param_1[4] & 4) != 0) {
              fVar34 = _LC5 * (float)local_228._12_4_;
              local_218 = CONCAT44(*(float *)(param_1 + 0x18) * fVar34,
                                   *(float *)(param_1 + 0x14) * fVar34);
              uStack_210 = CONCAT44(*(undefined4 *)(param_1 + 0x20),
                                    fVar34 * *(float *)(param_1 + 0x1c));
            }
          }
          uVar19 = uVar19 + 1;
          compress_block((astcenc_contexti *)param_1,local_1018,
                         param_5 + (int)(((uVar23 * iVar17 + iVar32) * iVar33 + iVar25) * 0x10),
                         (compression_working_buffers *)((ulong)param_2 * 0x38940 + lVar11));
        } while (uVar19 != uVar2);
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* astcenc_config_init(astcenc_profile, unsigned int, unsigned int, unsigned int, float, unsigned
   int, astcenc_config*) */

int astcenc_config_init(float param_1,uint param_2,uint param_3,uint param_4,uint param_5,

...

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_0010bae0;
  if (bVar1) {
    singleton = this;
      ...
      if (cVar4 != '\0') {
        ...
        if (cVar4 != '\0') {
          if (*(code **)(*(long *)this_00 + 0x140) == NavigationMesh::~NavigationMesh) {
            ...
            *(undefined ***)this_00 = &PTR__initialize_classv_0010b908;
...
LAB_00100e10:
          ...
          if (*(code **)(*(long *)pOVar4 + 0x140) == NavigationMesh::~NavigationMesh) {
            ...
            *(undefined ***)pOVar4 = &PTR__initialize_classv_0010b908;
    ...
    if (cVar6 != '\0') {
      ...
      if (((this != (Object *)0x0) && (cVar6 = RefCounted::unreference(), cVar6 != '\0')) &&
        ...
        if (*(code **)(*(long *)this + 0x140) == NavigationMesh::~NavigationMesh) {
          ...
          *(undefined ***)this = &PTR__initialize_classv_0010b908;
...

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_0010b730;
  NavigationMeshSourceGeometryData3D::clear();
  CowData<NavigationMeshSourceGeometryData3D::ProjectedObstruction>::_unref
...

{
  ...
  *(undefined ***)param_1 = &PTR__initialize_classv_0010b730;
  NavigationMeshSourceGeometryData3D::clear();
  CowData<NavigationMeshSourceGeometryData3D::ProjectedObstruction>::_unref
...

{
  ...
  if (*(code **)(*(long *)param_1 + 0x140) == NavigationMesh::~NavigationMesh) {
    bVar5 = StringName::configured != '\0';
    *(undefined ***)param_1 = &PTR__initialize_classv_0010b908;
...
LAB_0010b3f2:
      ...
      while( true ) {
        ...
        uVar10 = uVar10 + 1;
        if (*(ulong *)(lVar7 + -8) <= uVar10) goto LAB_0010b3f2;
      }
      LOCK();
...
LAB_0010b5b6:
    ...
    lVar7 = puVar8[-1];
    if (param_1 <= lVar7) goto LAB_0010b4b9;
  }
  else {
    if (lVar7 != 0) {
      uVar4 = _realloc(this,lVar11);
  ...
  if (((int)puVar12 - (int)puVar5 & 0x10U) != 0) {
    puVar5[1] = 0;
    puVar6 = puVar5 + 2;
    if (puVar5 + 2 == puVar12) goto LAB_0010b4b9;
  }
  do {
    puVar6[1] = 0;
    puVar5 = puVar6 + 4;

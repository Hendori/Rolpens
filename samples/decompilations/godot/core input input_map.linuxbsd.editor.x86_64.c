...
/* List<Ref<InputEvent>, DefaultAllocator>::push_back(Ref<InputEvent> const&) [clone .isra.0] */

void __thiscall
List<Ref<InputEvent>,DefaultAllocator>::push_back
          (List<Ref<InputEvent>,DefaultAllocator> *this,Ref *param_1)
...
/* InputMap::has_action(StringName const&) const */

undefined8 __thiscall InputMap::has_action(InputMap *this,StringName *param_1)

{
  ...
  if (*(int *)(this + 0x1a4) != 0) {
    ...
    if (uVar14 != 0) {
      ...
      do {
        if ((uVar11 == uVar14) &&
           (*(long *)(*(long *)(*(long *)(this + 0x180) + lVar13 * 8) + 0x10) == *(long *)param_1))
        {
          return 1;
        }
        uVar16 = uVar16 + 1;
...
/* InputMap::_action_get_events(StringName const&) */

StringName * InputMap::_action_get_events(StringName *param_1)

{
  ...
  if ((*(long *)(in_RSI + 0x180) != 0) && (*(int *)(in_RSI + 0x1a4) != 0)) {
    ...
    if (uVar16 != 0) {
      uVar17 = 0;
      while ((uVar16 != uVar13 ||
             (*(long *)(*(long *)(*(long *)(in_RSI + 0x180) + lVar15 * 8) + 0x10) != *in_RDX))) {
        uVar17 = uVar17 + 1;
        auVar6._8_8_ = 0;
        ...
        if ((uVar16 == 0) ||
           (auVar7._8_8_ = 0, auVar7._0_8_ = (ulong)uVar16 * lVar3, auVar11._8_8_ = 0,
           auVar11._0_8_ = uVar18, auVar8._8_8_ = 0,
           auVar8._0_8_ = (ulong)((uVar2 + uVar14) - SUB164(auVar7 * auVar11,8)) * lVar3,
           auVar12._8_8_ = 0, auVar12._0_8_ = uVar18, SUB164(auVar8 * auVar12,8) < uVar17))
        goto LAB_0010054c;
      }
      lVar3 = *(long *)(*(long *)(in_RSI + 0x180) + (ulong)uVar14 * 8);
      if ((lVar3 != 0) && (puVar4 = *(undefined8 **)(lVar3 + 0x20), puVar4 != (undefined8 *)0x0)) {
        for (puVar4 = (undefined8 *)*puVar4; puVar4 != (undefined8 *)0x0;
...
/* InputMap::get_actions() const */

void InputMap::get_actions(void)
...

{
  ...
  if (*(long *)param_2 == 0) {
    _err_print_error("_find_event","core/input/input_map.cpp",0xa1,
                     "Condition \"p_event.is_null()\" is true. Returning: nullptr",0,0);
  }
  else if ((*(long **)(param_1 + 8) != (long *)0x0) &&
          (puVar5 = (undefined8 *)**(long **)(param_1 + 8), puVar5 != (undefined8 *)0x0)) {
    iVar4 = 0;
    do {
      iVar3 = InputEvent::get_device();
      if (((ALL_DEVICES == iVar3) || (iVar2 = InputEvent::get_device(), iVar2 == iVar3)) &&
         (cVar1 = (**(code **)(*(long *)*puVar5 + 0x1e0))
                            (*(undefined4 *)(param_1 + 4),(long *)*puVar5,param_2,param_3,param_4,
...
/* InputMap::action_get_events(StringName const&) */

long __thiscall InputMap::action_get_events(InputMap *this,StringName *param_1)
...
/* InputMap::get_action_map() const */

InputMap * __thiscall InputMap::get_action_map(InputMap *this)
...
/* InputMap::get_builtin_display_name(String const&) const */

String * InputMap::get_builtin_display_name(String *param_1)
...
undefined8 __thiscall InputMap::InputMap(InputMap *this)

{
  ...
  *(undefined1 (*) [16])(this + 0x1f0) = (undefined1  [16])0x0;
  ...
  _err_print_error("InputMap","core/input/input_map.cpp",0x35e,"Condition \"singleton\" is true.",
                   "Singleton in InputMap already exist.",0);
  return 0;
}



/* InputMap::_get_actions() */

InputMap * __thiscall InputMap::_get_actions(InputMap *this)
...
void __thiscall InputMap::~InputMap(InputMap *this)
        ...
        do {
          if (*(int *)(*(long *)(this + 0x1e8) + lVar5) != 0) {
            ...
            *(int *)(*(long *)(this + 0x1e8) + lVar5) = 0;
            List<Ref<InputEvent>,DefaultAllocator>::clear
                      ((List<Ref<InputEvent>,DefaultAllocator> *)((long)pvVar6 + 0x18));
        ...
        do {
          if (*(int *)(*(long *)(this + 0x188) + lVar5) != 0) {
            ...
            *(int *)(*(long *)(this + 0x188) + lVar5) = 0;
            List<Ref<InputEvent>,DefaultAllocator>::clear
                      ((List<Ref<InputEvent>,DefaultAllocator> *)((long)pvVar6 + 0x20));
...
/* InputMap::add_action(StringName const&, float) */

void __thiscall InputMap::add_action(InputMap *this,StringName *param_1,float param_2)

{
  HashMap<StringName,InputMap::Action,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,InputMap::Action>>>
  *this_00;
  uint uVar1;
  char *__s;
  ...
  this_00 = (HashMap<StringName,InputMap::Action,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,InputMap::Action>>>
             *)(this + 0x178);
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if ((*(long *)(this + 0x180) != 0) && (*(int *)(this + 0x1a4) != 0)) {
    ...
    if (uVar16 != 0) {
      ...
      do {
        if ((uVar10 == uVar16) &&
           (lVar15 = *(long *)(*(long *)(*(long *)(this + 0x180) + lVar15 * 8) + 0x10),
           lVar15 == *(long *)param_1)) {
          if (lVar15 == 0) {
LAB_001013f2:
            local_68 = 0;
          ...
          _err_print_error("add_action","core/input/input_map.cpp",0x77,
                           "Condition \"input_map.has(p_action)\" is true.",
        ...
        iVar14 = SUB164(auVar3 * auVar7,8);
              ...
              (auVar4._8_8_ = 0, auVar4._0_8_ = (ulong)uVar16 * lVar13, auVar8._8_8_ = 0,
              auVar8._0_8_ = uVar18, auVar5._8_8_ = 0,
              auVar5._0_8_ = (ulong)((uVar1 + iVar14) - SUB164(auVar4 * auVar8,8)) * lVar13,
  ...
  *puVar11 = 0;
  List<Ref<InputEvent>,DefaultAllocator>::clear
            ((List<Ref<InputEvent>,DefaultAllocator> *)(puVar11 + 1));
  puVar11[1] = 0;
  ...
  iVar14 = add_action(StringName_const&,float)::last_id;
  piVar12 = (int *)HashMap<StringName,InputMap::Action,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,InputMap::Action>>>
                   ::operator[](this_00,param_1);
  *piVar12 = iVar14;
  lVar13 = HashMap<StringName,InputMap::Action,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,InputMap::Action>>>
           ::operator[](this_00,param_1);
  add_action(StringName_const&,float)::last_id = add_action(StringName_const&,float)::last_id + 1;
  *(float *)(lVar13 + 4) = param_2;
LAB_0010136a:
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    __stack_chk_fail();
...
/* InputMap::_add_action_bind_compat_97281(StringName const&, float) */

void __thiscall
InputMap::_add_action_bind_compat_97281(InputMap *this,StringName *param_1,float param_2)
...
/* InputMap::get_argument_options(StringName const&, int, List<String, DefaultAllocator>*) const */

void __thiscall
InputMap::get_argument_options(InputMap *this,StringName *param_1,int param_2,List *param_3)

{
  ...
  if (lVar8 == 0) {
    local_78 = 0;
LAB_00101494:
    if (param_2 != 0) goto LAB_00101499;
LAB_00101508:
    cVar4 = String::operator==((String *)&local_78,"has_action");
    if (((((cVar4 == '\0') &&
          (cVar4 = String::operator==((String *)&local_78,"erase_action"), cVar4 == '\0')) &&
         (cVar4 = String::operator==((String *)&local_78,"action_set_deadzone"), cVar4 == '\0')) &&
        ((cVar4 = String::operator==((String *)&local_78,"action_get_deadzone"), cVar4 == '\0' &&
         (cVar4 = String::operator==((String *)&local_78,"action_has_event"), cVar4 == '\0')))) &&
       ((cVar4 = String::operator==((String *)&local_78,"action_add_event"), cVar4 == '\0' &&
        ((cVar4 = String::operator==((String *)&local_78,"action_get_events"), cVar4 == '\0' &&
         (cVar4 = String::operator==((String *)&local_78,"action_erase_event"), cVar4 == '\0'))))))
    {
...
LAB_00101499:
    if (param_2 != 1) goto LAB_001014a3;
    cVar4 = String::operator==((String *)&local_78,"event_is_action");
joined_r0x00101852:
    if (cVar4 == '\0') goto LAB_001014a3;
  }
  local_70 = (long *)0x0;
...
/* InputMap::suggest_actions(StringName const&) const */

StringName * InputMap::suggest_actions(StringName *param_1)
...
LAB_0010197c:
        fVar8 = (float)String::similarity((String *)&local_68);
        lVar2 = local_60;
        if (local_60 != 0) {
          LOCK();
...
/* InputMap::erase_action(StringName const&) */

void __thiscall InputMap::erase_action(InputMap *this,StringName *param_1)

{
  ...
  if ((*(long *)(this + 0x180) != 0) && (*(int *)(this + 0x1a4) != 0)) {
    ...
    if (uVar44 != 0) {
      ...
      do {
        if ((uVar39 == uVar44) &&
           (lVar41 = *(long *)(*(long *)(*(long *)(this + 0x180) + lVar41 * 8) + 0x10),
           lVar41 == *(long *)param_1)) {
        ...
        iVar40 = SUB164(auVar11 * auVar25,8);
              ...
              (auVar12._8_8_ = 0, auVar12._0_8_ = (ulong)uVar44 * lVar6, auVar26._8_8_ = 0,
              auVar26._0_8_ = uVar42, auVar13._8_8_ = 0,
              auVar13._0_8_ = (ulong)((uVar5 + iVar40) - SUB164(auVar12 * auVar26,8)) * lVar6,
              auVar27._8_8_ = 0, auVar27._0_8_ = uVar42, uVar48 <= SUB164(auVar13 * auVar27,8)));
    }
  }
  suggest_actions(local_48);
  _err_print_error("erase_action","core/input/input_map.cpp",0x80,
                   "Condition \"!input_map.has(p_action)\" is true.",local_48,0,0);
  ...
  while( true ) {
    ...
    if ((uVar44 == 0) ||
       (auVar16._8_8_ = 0, auVar16._0_8_ = (ulong)uVar44 * lVar6, auVar30._8_8_ = 0,
       auVar30._0_8_ = uVar42, auVar17._8_8_ = 0,
       auVar17._0_8_ = (ulong)((uVar5 + uVar48) - SUB164(auVar16 * auVar30,8)) * lVar6,
       auVar31._8_8_ = 0, auVar31._0_8_ = uVar42, SUB164(auVar17 * auVar31,8) < uVar49)) break;
LAB_00101e11:
    uVar43 = (ulong)uVar48;
    if ((uVar39 == uVar44) &&
       (lVar7 = *(long *)(this + 0x180),
       *(long *)(*(long *)(lVar7 + lVar41 * 8) + 0x10) == *(long *)param_1)) {
      uVar5 = *(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x1a0) * 4);
      ...
      if ((*puVar52 != 0) &&
         (auVar19._8_8_ = 0, auVar19._0_8_ = uVar47 * lVar6, auVar33._8_8_ = 0,
         auVar33._0_8_ = uVar50, auVar20._8_8_ = 0,
         auVar20._0_8_ = (ulong)((uVar5 + uVar39) - SUB164(auVar19 * auVar33,8)) * lVar6,
         auVar34._8_8_ = 0, auVar34._0_8_ = uVar50, uVar38 = (ulong)uVar39, uVar45 = uVar43,
         SUB164(auVar20 * auVar34,8) != 0)) {
        while( true ) {
          uVar43 = uVar38;
          ...
          *puVar3 = uVar8;
          ...
          uVar47 = (ulong)*puVar52;
          if ((*puVar52 == 0) ||
             (auVar21._8_8_ = 0, auVar21._0_8_ = uVar47 * lVar6, auVar35._8_8_ = 0,
             auVar35._0_8_ = uVar50, auVar22._8_8_ = 0,
             auVar22._0_8_ =
                  (ulong)((SUB164(auVar23 * auVar37,8) + uVar5) - SUB164(auVar21 * auVar35,8)) *
                  lVar6, auVar36._8_8_ = 0, auVar36._0_8_ = uVar50, SUB164(auVar22 * auVar36,8) == 0
             )) break;
      ...
      *(undefined4 *)(lVar46 + uVar43 * 4) = 0;
      ...
      List<Ref<InputEvent>,DefaultAllocator>::clear
                ((List<Ref<InputEvent>,DefaultAllocator> *)(plVar51 + 4));
...
/* InputMap::action_get_deadzone(StringName const&) */

void __thiscall InputMap::action_get_deadzone(InputMap *this,StringName *param_1)

{
  ...
  if ((*(long *)(this + 0x180) != 0) && (*(int *)(this + 0x1a4) != 0)) {
    ...
    if (uVar14 != 0) {
      ...
      do {
        ...
        {
          HashMap<StringName,InputMap::Action,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,InputMap::Action>>>
          ::operator[]((HashMap<StringName,InputMap::Action,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,InputMap::Action>>>
                        *)(this + 0x178),param_1);
          goto LAB_001021e3;
        }
        uVar15 = uVar15 + 1;
  ...
  _err_print_error("action_get_deadzone","core/input/input_map.cpp",0xb9,
                   "Condition \"!input_map.has(p_action)\" is true. Returning: 0.0f",aSStack_48,0,0)
  ;
...
/* InputMap::action_set_deadzone(StringName const&, float) */

void __thiscall InputMap::action_set_deadzone(InputMap *this,StringName *param_1,float param_2)

{
    ...
    if (uVar14 != 0) {
      ...
      do {
        if ((uVar10 == uVar14) &&
           (*(long *)(*(long *)(*(long *)(this + 0x180) + lVar13 * 8) + 0x10) == *(long *)param_1))
        {
          lVar11 = HashMap<StringName,InputMap::Action,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,InputMap::Action>>>
                   ::operator[]((HashMap<StringName,InputMap::Action,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,InputMap::Action>>>
                                 *)(this + 0x178),param_1);
  ...
  suggest_actions(local_48);
  _err_print_error("action_set_deadzone","core/input/input_map.cpp",0xbf,
                   "Condition \"!input_map.has(p_action)\" is true.",local_48,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)local_48);
LAB_001023a1:
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
...
/* InputMap::action_add_event(StringName const&, Ref<InputEvent> const&) */

void __thiscall InputMap::action_add_event(InputMap *this,StringName *param_1,Ref *param_2)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (*(long *)param_2 == 0) {
    _err_print_error("action_add_event","core/input/input_map.cpp",0xc5,
                     "Condition \"p_event.is_null()\" is true.",
                     "It\'s not a reference to a valid InputEvent object.",0,0);
  }
  else {
    if ((*(long *)(this + 0x180) != 0) && (*(int *)(this + 0x1a4) != 0)) {
      uVar1 = *(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x1a0) * 4);
        ...
        do {
          if ((uVar10 == uVar15) &&
            ...
            pAVar11 = (Action *)
                      ...
                      ::operator[]((HashMap<StringName,InputMap::Action,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,InputMap::Action>>>
                                    *)(this + 0x178),param_1);
            lVar12 = _find_event(this,pAVar11,param_2,true,(bool *)0x0,(float *)0x0,(float *)0x0,
                                 (int *)0x0);
            if (lVar12 != 0) goto LAB_00102619;
            lVar12 = HashMap<StringName,InputMap::Action,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,InputMap::Action>>>
                     ::operator[]((HashMap<StringName,InputMap::Action,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,InputMap::Action>>>
                                   *)(this + 0x178),param_1);
            if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
              List<Ref<InputEvent>,DefaultAllocator>::push_back
                        ((List<Ref<InputEvent>,DefaultAllocator> *)(lVar12 + 8),param_2);
              return;
            }
            goto LAB_00102685;
          }
    ...
    suggest_actions(local_48);
    _err_print_error("action_add_event","core/input/input_map.cpp",0xc6,
                     "Condition \"!input_map.has(p_action)\" is true.",local_48,0,0);
    CowData<char32_t>::_unref((CowData<char32_t> *)local_48);
  }
LAB_00102619:
...
void __thiscall InputMap::load_from_project_settings(InputMap *this)
      ...
      do {
        if (*(int *)(*(long *)(this + 0x188) + lVar12) != 0) {
          *(int *)(*(long *)(this + 0x188) + lVar12) = 0;
          ...
          List<Ref<InputEvent>,DefaultAllocator>::clear
                    ((List<Ref<InputEvent>,DefaultAllocator> *)((long)pvVar4 + 0x20));
...
LAB_001029bb:
            if (pOVar13 != (Object *)0x0) {
              ...
              if (((local_88 != (Object *)0x0) &&
                  (cVar8 = RefCounted::unreference(), pOVar7 = local_88, cVar8 != '\0')) &&
...
LAB_00102ab0:
            ...
            pOVar11 = (Object *)__dynamic_cast(pOVar11,&Object::typeinfo,&InputEvent::typeinfo,0);
            ...
            if (pOVar11 != (Object *)0x0) {
              ...
              if ((pOVar7 == (Object *)0x0) ||
                 (cVar8 = RefCounted::unreference(), pOVar13 = local_88, cVar8 == '\0'))
              goto LAB_001029bb;
              goto LAB_00102ab0;
            }
LAB_001029a1:
            if (pOVar7 != (Object *)0x0) goto LAB_001029a6;
          }
        }
        ...
        if (local_a0 != 0) {
          ...
          *plVar2 = *plVar2 + -1;
          UNLOCK();
          if (*plVar2 == 0) goto code_r0x00102b49;
        }
      }
...
/* InputMap::action_has_event(StringName const&, Ref<InputEvent> const&) */

bool __thiscall InputMap::action_has_event(InputMap *this,StringName *param_1,Ref *param_2)

{
  ...
  suggest_actions(local_48);
  _err_print_error("action_has_event","core/input/input_map.cpp",0xcf,
                   "Condition \"!input_map.has(p_action)\" is true. Returning: false",local_48,0,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)local_48);
  bVar18 = false;
LAB_00102de1:
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
...
/* InputMap::action_erase_events(StringName const&) */

void __thiscall InputMap::action_erase_events(InputMap *this,StringName *param_1)

{
    ...
    if (uVar14 != 0) {
      ...
      do {
           ...
           (*(long *)(*(long *)(*(long *)(this + 0x180) + lVar13 * 8) + 0x10) == *(long *)param_1))
        {
          ...
          if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
            List<Ref<InputEvent>,DefaultAllocator>::clear
                      ((List<Ref<InputEvent>,DefaultAllocator> *)(lVar11 + 8));
            return;
          }
          goto LAB_0010303d;
        }
  ...
  suggest_actions(aSStack_48);
  _err_print_error("action_erase_events","core/input/input_map.cpp",0xe1,
                   "Condition \"!input_map.has(p_action)\" is true.",aSStack_48,0,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)aSStack_48);
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
  }
...
InputMap::event_get_action_status
          (InputMap *this,Ref *param_1,StringName *param_2,bool param_3,bool *param_4,float *param_5
          ,float *param_6,int *param_7)

{
  ...
  if ((*(long *)(this + 0x180) != 0) && (*(int *)(this + 0x1a4) != 0)) {
    ...
    if (uVar17 != 0) {
      uVar18 = 0;
      while ((uVar17 != uVar12 ||
             (*(long *)(*(long *)(*(long *)(this + 0x180) + lVar16 * 8) + 0x10) != *(long *)param_2)
             )) {
        uVar18 = uVar18 + 1;
        auVar3._8_8_ = 0;
        ...
        if ((uVar17 == 0) ||
           (auVar4._8_8_ = 0, auVar4._0_8_ = (ulong)uVar17 * lVar14, auVar8._8_8_ = 0,
           auVar8._0_8_ = uVar19, auVar5._8_8_ = 0,
           auVar5._0_8_ = (ulong)((uVar1 + uVar15) - SUB164(auVar4 * auVar8,8)) * lVar14,
           auVar9._8_8_ = 0, auVar9._0_8_ = uVar19, SUB164(auVar5 * auVar9,8) < uVar18))
        goto LAB_001032d8;
      }
      ...
      if (lVar14 != 0) {
        if (*(long *)param_1 != 0) {
          pOVar13 = (Object *)
                    __dynamic_cast(*(long *)param_1,&Object::typeinfo,&InputEventAction::typeinfo,0)
          ;
          if (pOVar13 != (Object *)0x0) {
        ...
        lVar14 = _find_event(this,(Action *)(lVar14 + 0x18),param_1,param_3,param_4,param_5,param_6,
                             param_7);
        bVar20 = lVar14 != 0;
        goto LAB_001031fb;
      }
...
LAB_001032d8:
  suggest_actions((StringName *)&local_48);
  _err_print_error("event_get_action_status","core/input/input_map.cpp",0x107,
                   "Condition \"!E\" is true. Returning: false",(StringName *)&local_48,0,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_48);
  bVar20 = false;
LAB_001031fb:
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
...
/* InputMap::event_is_action(Ref<InputEvent> const&, StringName const&, bool) const */

void __thiscall
InputMap::event_is_action(InputMap *this,Ref *param_1,StringName *param_2,bool param_3)

{
  event_get_action_status
            (this,param_1,param_2,param_3,(bool *)0x0,(float *)0x0,(float *)0x0,(int *)0x0);
  return;
}



/* InputMap::event_get_index(Ref<InputEvent> const&, StringName const&, bool) const */

int __thiscall
InputMap::event_get_index(InputMap *this,Ref *param_1,StringName *param_2,bool param_3)

{
  ...
  local_14 = -1;
  cVar1 = event_get_action_status
                    (this,param_1,param_2,param_3,(bool *)0x0,(float *)0x0,(float *)0x0,&local_14);
  iVar2 = local_14;
  if (cVar1 == '\0') {
    iVar2 = -1;
  }
...
/* InputMap::_bind_compatibility_methods() */

void InputMap::_bind_compatibility_methods(void)
...
/* InputMap::_bind_methods() */

void InputMap::_bind_methods(void)

{
  ...
  auStack_70 = (undefined1  [16])0x0;
  local_78 = (Variant **)0x0;
  pMVar6 = create_method_bind<InputMap,bool,StringName_const&,Ref<InputEvent>const&>
                     (action_has_event);
  ClassDB::bind_methodfi(1,pMVar6,false,(MethodDefinition *)local_168,(Variant **)0x0,0);
  if (Variant::needs_deinit[(int)local_78] != '\0') {
    Variant::_clear_internal();
  ...
  pMVar6 = create_method_bind<InputMap,bool,Ref<InputEvent>const&,StringName_const&,bool>
                     (event_is_action);
...
/* InputMap::action_erase_event(StringName const&, Ref<InputEvent> const&) */

void __thiscall InputMap::action_erase_event(InputMap *this,StringName *param_1,Ref *param_2)

{
  ...
  if ((*(long *)(this + 0x180) != 0) && (*(int *)(this + 0x1a4) != 0)) {
    ...
    if (uVar19 != 0) {
      ...
      do {
        if ((uVar19 == uVar13) &&
           (*(long *)(*(long *)(*(long *)(this + 0x180) + lVar18 * 8) + 0x10) == *(long *)param_1))
        {
          pAVar14 = (Action *)
                    HashMap<StringName,InputMap::Action,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,InputMap::Action>>>
                    ::operator[]((HashMap<StringName,InputMap::Action,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,InputMap::Action>>>
                                  *)(this + 0x178),param_1);
          this_00 = (Ref<InputEvent> *)
                    _find_event(this,pAVar14,param_2,true,(bool *)0x0,(float *)0x0,(float *)0x0,
                                (int *)0x0);
          if (this_00 == (Ref<InputEvent> *)0x0) goto LAB_00104a1d;
          lVar15 = HashMap<StringName,InputMap::Action,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,InputMap::Action>>>
                   ::operator[]((HashMap<StringName,InputMap::Action,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,InputMap::Action>>>
                                 *)(this + 0x178),param_1);
        ...
        iVar17 = SUB164(auVar5 * auVar9,8);
              ...
              auVar7._0_8_ = (ulong)((uVar1 + iVar17) - SUB164(auVar6 * auVar10,8)) * lVar15,
              auVar11._8_8_ = 0, auVar11._0_8_ = uVar21, uVar20 <= SUB164(auVar7 * auVar11,8)));
    }
  }
  suggest_actions(local_48);
  _err_print_error("action_erase_event","core/input/input_map.cpp",0xd4,
                   "Condition \"!input_map.has(p_action)\" is true.",local_48,0,0);
  CowData<char32_t>::_unref((CowData<char32_t> *)local_48);
LAB_00104a1d:
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
...
/* InputMap::get_builtins() [clone .part.0] */

List * __thiscall InputMap::get_builtins(InputMap *this)

{
  ...
  List<Ref<InputEvent>,DefaultAllocator>::push_back
            ((List<Ref<InputEvent>,DefaultAllocator> *)&local_58,(Ref *)&local_48);
  ...
  HashMap<String,List<Ref<InputEvent>,DefaultAllocator>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,List<Ref<InputEvent>,DefaultAllocator>>>>
  ::insert((String *)&local_48,pLVar5,bVar4);
...
/* InputMap::get_builtins() */

InputMap * __thiscall InputMap::get_builtins(InputMap *this)
...
/* InputMap::get_builtins_with_feature_overrides_applied() [clone .part.0] */

InputMap * __thiscall InputMap::get_builtins_with_feature_overrides_applied(InputMap *this)
...
LAB_00108c13:
      bVar31 = SUB81((CowData<char32_t> *)&local_a0,0);
...
LAB_00108c91:
          if (local_98 != 0) {
            if (1 < *(uint *)(local_98 + -8)) {
              ...
              if (cVar18 != '\0') {
                lVar22 = HashMap<String,Vector<String>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Vector<String>>>>
                         ::operator[](local_78,pSVar15);
                local_90 = 0;
                if (local_98 != 0) {
                ...
                if (iVar19 == 0) {
                  ...
                  _err_print_index_error
                            ("set","./core/templates/cowdata.h",0xcf,lVar24,lVar26,"p_index",
                             "size()","",false,false);
                }
                else {
...
LAB_00108ce3:
          _err_print_index_error
                    ("get","./core/templates/cowdata.h",0xdb,0,lVar22,"p_index","size()","",false,
                     true);
          _err_flush_stdout();
                    /* WARNING: Does not return */
...
LAB_00109045:
          HashMap<String,List<Ref<InputEvent>,DefaultAllocator>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,List<Ref<InputEvent>,DefaultAllocator>>>>
          ::insert((String *)&local_90,(List *)(this + 0x1d8),SUB81(pSVar15,0));
        }
        else {
...
joined_r0x0010902f:
            if (local_50._4_4_ != 0) {
              ...
              if (uVar20 != 0) {
                ...
                do {
                  if ((uVar25 == uVar20) &&
                     (cVar18 = String::operator==((String *)(*(long *)(uVar16 + lVar26 * 8) + 0x10),
                                                  pSVar15), cVar18 != '\0')) {
                  ...
                  iVar19 = SUB164(auVar6 * auVar10,8);
                        ...
                        (auVar7._8_8_ = 0, auVar7._0_8_ = (ulong)uVar20 * lVar22, auVar11._8_8_ = 0,
                        auVar11._0_8_ = uVar14, auVar8._8_8_ = 0,
                        auVar8._0_8_ = (ulong)((uVar3 + iVar19) - SUB164(auVar7 * auVar11,8)) *
                                       lVar22, auVar12._8_8_ = 0, auVar12._0_8_ = uVar14,
...
void __thiscall InputMap::load_default(InputMap *this)

{
  ...
  if (5 < *(uint *)(hash_table_size_primes + (ulong)*(uint *)(pIVar6 + 0x28) * 4)) {
    do {
      if (*(uint *)(hash_table_size_primes + (ulong)*(uint *)(pIVar6 + 0x28) * 4) <=
...
LAB_00109320:
  if ((*(int *)(pIVar6 + 0x2c) != 0) &&
     (plVar10 = *(long **)(pIVar6 + 0x18), plVar10 != (long *)0x0)) {
    do {
      HashMap<String,List<Ref<InputEvent>,DefaultAllocator>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,List<Ref<InputEvent>,DefaultAllocator>>>>
      ::insert((String *)&local_80,local_78,(bool)((char)plVar10 + '\x10'));
...
joined_r0x00109417:
          if (pRVar12 != (Ref *)0x0) {
            do {
              if (((*(long *)pRVar12 != 0) &&
                  (pOVar8 = (Object *)
                            __dynamic_cast(*(long *)pRVar12,&Object::typeinfo,
                                           &InputEventKey::typeinfo,0), pOVar8 != (Object *)0x0)) &&
    ...
    if ((void *)local_70._0_8_ != (void *)0x0) {
      ...
      if ((local_50._4_4_ != 0) &&
         (uVar2 = *(uint *)(hash_table_size_primes + (local_50 & 0xffffffff) * 4), uVar2 != 0)) {
        lVar11 = 0;
        do {
          if (*(int *)(local_70._8_8_ + lVar11) != 0) {
            *(int *)(local_70._8_8_ + lVar11) = 0;
            ...
            pvVar3 = (void *)*puVar14;
            List<Ref<InputEvent>,DefaultAllocator>::clear
                      ((List<Ref<InputEvent>,DefaultAllocator> *)((long)pvVar3 + 0x18));
...
/* InputMap::is_class_ptr(void*) const */

uint __thiscall InputMap::is_class_ptr(InputMap *this,void *param_1)

{
  return (uint)CONCAT71(0x1166,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1166,(undefined4 *)param_1 == &get_class_ptr_static()::ptr);
}



/* InputMap::_getv(StringName const&, Variant&) const */

undefined8 InputMap::_getv(StringName *param_1,Variant *param_2)
...
/* InputMap::_setv(StringName const&, Variant const&) */

undefined8 InputMap::_setv(StringName *param_1,Variant *param_2)
...
/* InputMap::_validate_propertyv(PropertyInfo&) const */

void InputMap::_validate_propertyv(PropertyInfo *param_1)
...
/* InputMap::_property_can_revertv(StringName const&) const */

undefined8 InputMap::_property_can_revertv(StringName *param_1)
...
/* InputMap::_property_get_revertv(StringName const&, Variant&) const */

undefined8 InputMap::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* InputMap::_notificationv(int, bool) */

void InputMap::_notificationv(int param_1,bool param_2)
...
undefined8 __thiscall
MethodBindTRC<bool,Ref<InputEvent>const&,StringName_const&,bool>::_gen_argument_type
          (MethodBindTRC<bool,Ref<InputEvent>const&,StringName_const&,bool> *this,int param_1)
...
undefined8
MethodBindTRC<bool,Ref<InputEvent>const&,StringName_const&,bool>::get_argument_meta(int param_1)
...
/* MethodBindTR<TypedArray<InputEvent>, StringName const&>::_gen_argument_type(int) const */

int __thiscall
MethodBindTR<TypedArray<InputEvent>,StringName_const&>::_gen_argument_type
          (MethodBindTR<TypedArray<InputEvent>,StringName_const&> *this,int param_1)
...
/* MethodBindTR<TypedArray<InputEvent>, StringName const&>::get_argument_meta(int) const */

undefined8 MethodBindTR<TypedArray<InputEvent>,StringName_const&>::get_argument_meta(int param_1)
...
/* MethodBindTR<bool, StringName const&, Ref<InputEvent> const&>::_gen_argument_type(int) const */

int __thiscall
MethodBindTR<bool,StringName_const&,Ref<InputEvent>const&>::_gen_argument_type
          (MethodBindTR<bool,StringName_const&,Ref<InputEvent>const&> *this,int param_1)
...
/* MethodBindTR<bool, StringName const&, Ref<InputEvent> const&>::get_argument_meta(int) const */

undefined8
MethodBindTR<bool,StringName_const&,Ref<InputEvent>const&>::get_argument_meta(int param_1)
...
/* MethodBindT<StringName const&, Ref<InputEvent> const&>::_gen_argument_type(int) const */

int __thiscall
MethodBindT<StringName_const&,Ref<InputEvent>const&>::_gen_argument_type
          (MethodBindT<StringName_const&,Ref<InputEvent>const&> *this,int param_1)
...
/* MethodBindT<StringName const&, Ref<InputEvent> const&>::get_argument_meta(int) const */

undefined8 MethodBindT<StringName_const&,Ref<InputEvent>const&>::get_argument_meta(int param_1)
...
/* MethodBindTR<float, StringName const&>::_gen_argument_type(int) const */

char __thiscall
MethodBindTR<float,StringName_const&>::_gen_argument_type
          (MethodBindTR<float,StringName_const&> *this,int param_1)
...
/* MethodBindTR<float, StringName const&>::get_argument_meta(int) const */

uint __thiscall
MethodBindTR<float,StringName_const&>::get_argument_meta
          (MethodBindTR<float,StringName_const&> *this,int param_1)
...
/* MethodBindTR<TypedArray<StringName>>::_gen_argument_type(int) const */

undefined8 MethodBindTR<TypedArray<StringName>>::_gen_argument_type(int param_1)
...
/* MethodBindTR<TypedArray<StringName>>::get_argument_meta(int) const */

undefined8 MethodBindTR<TypedArray<StringName>>::get_argument_meta(int param_1)
...
/* MethodBindT<StringName const&, float>::_gen_argument_type(int) const */

char __thiscall
MethodBindT<StringName_const&,float>::_gen_argument_type
          (MethodBindT<StringName_const&,float> *this,int param_1)
...
/* MethodBindT<StringName const&, float>::get_argument_meta(int) const */

char __thiscall
MethodBindT<StringName_const&,float>::get_argument_meta
          (MethodBindT<StringName_const&,float> *this,int param_1)
...
/* MethodBindT<StringName const&, float>::~MethodBindT() */

void __thiscall
MethodBindT<StringName_const&,float>::~MethodBindT(MethodBindT<StringName_const&,float> *this)
...
void __thiscall
MethodBindTR<TypedArray<StringName>>::~MethodBindTR(MethodBindTR<TypedArray<StringName>> *this)
...
/* MethodBindTR<float, StringName const&>::~MethodBindTR() */

void __thiscall
MethodBindTR<float,StringName_const&>::~MethodBindTR(MethodBindTR<float,StringName_const&> *this)
...
/* MethodBindTR<bool, StringName const&, Ref<InputEvent> const&>::~MethodBindTR() */

void __thiscall
MethodBindTR<bool,StringName_const&,Ref<InputEvent>const&>::~MethodBindTR
          (MethodBindTR<bool,StringName_const&,Ref<InputEvent>const&> *this)
...
/* MethodBindT<StringName const&, Ref<InputEvent> const&>::~MethodBindT() */

void __thiscall
MethodBindT<StringName_const&,Ref<InputEvent>const&>::~MethodBindT
          (MethodBindT<StringName_const&,Ref<InputEvent>const&> *this)
...
/* MethodBindTR<TypedArray<InputEvent>, StringName const&>::~MethodBindTR() */

void __thiscall
MethodBindTR<TypedArray<InputEvent>,StringName_const&>::~MethodBindTR
          (MethodBindTR<TypedArray<InputEvent>,StringName_const&> *this)
...
/* MethodBindTRC<bool, Ref<InputEvent> const&, StringName const&, bool>::~MethodBindTRC() */

void __thiscall
MethodBindTRC<bool,Ref<InputEvent>const&,StringName_const&,bool>::~MethodBindTRC
          (MethodBindTRC<bool,Ref<InputEvent>const&,StringName_const&,bool> *this)
...
/* InputMap::_get_class_namev() const */

undefined8 * InputMap::_get_class_namev(void)
...
LAB_00109cd3:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"InputMap");
      goto LAB_00109d3e;
    }
  }
  StringName::assign_static_unique_class_name
...
/* InputMap::get_class() const */

void InputMap::get_class(void)
...
/* MethodBindTR<TypedArray<StringName>>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTR<TypedArray<StringName>>::_gen_argument_type_info(int param_1)
...
/* InputMap::is_class(String const&) const */

undefined8 __thiscall InputMap::is_class(InputMap *this,String *param_1)
...
void __thiscall
List<Ref<InputEvent>,DefaultAllocator>::clear(List<Ref<InputEvent>,DefaultAllocator> *this)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* HashMap<StringName, InputMap::Action, HashMapHasherDefault, HashMapComparatorDefault<StringName>,
    ...
    *(void **)(this + 8) = __s_00;
    ...
    if (*(int *)(this + 0x2c) == 0) {
      ...
      if (uVar53 != 0) {
        ...
        do {
          if ((uVar53 == uVar40) &&
             (*(long *)(*(long *)(lVar56 + lVar47 * 8) + 0x10) == *(long *)param_1)) {
          ...
          uVar54 = SUB164(auVar7 * auVar23,8);
                ...
                (auVar8._8_8_ = 0, auVar8._0_8_ = (ulong)uVar53 * lVar48, auVar24._8_8_ = 0,
                auVar24._0_8_ = uVar41, auVar9._8_8_ = 0,
                auVar9._0_8_ = (ulong)((uVar54 + uVar39) - SUB164(auVar8 * auVar24,8)) * lVar48,
                auVar25._8_8_ = 0, auVar25._0_8_ = uVar41, uVar55 <= SUB164(auVar9 * auVar25,8)));
      }
      local_70 = (void *)0x0;
      uVar41 = (ulong)*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x28) * 4);
        ...
        do {
          if ((uVar53 == uVar40) &&
            ...
            *(undefined8 *)(lVar56 + 0x18) = 0;
            List<Ref<InputEvent>,DefaultAllocator>::clear
                      ((List<Ref<InputEvent>,DefaultAllocator> *)(lVar56 + 0x20));
          ...
          uVar54 = SUB164(auVar11 * auVar27,8);
                ...
                (auVar12._8_8_ = 0, auVar12._0_8_ = (ulong)uVar53 * lVar56, auVar28._8_8_ = 0,
                auVar28._0_8_ = uVar45, auVar13._8_8_ = 0,
                auVar13._0_8_ = (ulong)((uVar39 + uVar54) - SUB164(auVar12 * auVar28,8)) * lVar56,
                auVar29._8_8_ = 0, auVar29._0_8_ = uVar45, uVar55 <= SUB164(auVar13 * auVar29,8)));
      }
      iVar46 = *(int *)(this + 0x2c);
    }
LAB_0010b843:
    if ((float)uVar41 * __LC16 < (float)(iVar46 + 1)) goto LAB_0010b869;
  }
  local_68 = (undefined1  [16])0x0;
  StringName::StringName((StringName *)&local_58,param_1);
  local_50 = 0;
  local_48 = (long *)0x0;
  puVar50 = (undefined8 *)operator_new(0x28,"");
  *puVar50 = local_68._0_8_;
  puVar50[1] = local_68._8_8_;
  StringName::StringName((StringName *)(puVar50 + 2),(StringName *)&local_58);
  puVar50[4] = 0;
  puVar50[3] = local_50;
  if ((local_48 != (long *)0x0) && (plVar58 = (long *)*local_48, plVar58 != (long *)0x0)) {
...
LAB_0010bbb6:
  List<Ref<InputEvent>,DefaultAllocator>::clear((List<Ref<InputEvent>,DefaultAllocator> *)&local_48)
  ;
  ...
  *(undefined8 **)(lVar47 + lVar49 * 8) = puVar5;
  *puVar1 = uVar39;
  *(int *)(this + 0x2c) = *(int *)(this + 0x2c) + 1;
LAB_0010bd17:
  puVar50 = puVar50 + 3;
  List<Ref<InputEvent>,DefaultAllocator>::clear((List<Ref<InputEvent>,DefaultAllocator> *)&local_70)
  ;
...
/* WARNING: Removing unreachable block (ram,0x0010c148) */
/* WARNING: Removing unreachable block (ram,0x0010c2dd) */
/* WARNING: Removing unreachable block (ram,0x0010c2e9) */
...
/* WARNING: Removing unreachable block (ram,0x0010c5ed) */
/* WARNING: Removing unreachable block (ram,0x0010c5f9) */
...
void __thiscall
MethodBindTR<float,StringName_const&>::validated_call
          (MethodBindTR<float,StringName_const&> *this,Object *param_1,Variant **param_2,
          Variant *param_3)
...
/* MethodBindTR<float, StringName const&>::ptrcall(Object*, void const**, void*) const */

void __thiscall
MethodBindTR<float,StringName_const&>::ptrcall
          (MethodBindTR<float,StringName_const&> *this,Object *param_1,void **param_2,void *param_3)
...
Object * MethodBindTR<TypedArray<StringName>>::call
...
void MethodBindT<StringName_const&,float>::validated_call
               (Object *param_1,Variant **param_2,Variant *param_3)

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
    ...
    auVar2._0_4_ = (float)*(double *)(*(long *)(param_3 + 8) + 8);
                    ...
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)
              (auVar2._0_8_,(long *)((long)param_2 + *(long *)(param_1 + 0x60)),*(long *)param_3 + 8
              );
    return;
  }
LAB_0010dde1:
...
/* MethodBindT<StringName const&, float>::ptrcall(Object*, void const**, void*) const */

void MethodBindT<StringName_const&,float>::ptrcall(Object *param_1,void **param_2,void *param_3)
...
void __thiscall
MethodBindTR<bool,StringName_const&,Ref<InputEvent>const&>::validated_call
          (MethodBindTR<bool,StringName_const&,Ref<InputEvent>const&> *this,Object *param_1,
...
void MethodBindT<StringName_const&,Ref<InputEvent>const&>::validated_call
               (Object *param_1,Variant **param_2,Variant *param_3)
...
void __thiscall
MethodBindTRC<bool,Ref<InputEvent>const&,StringName_const&,bool>::validated_call
          (MethodBindTRC<bool,Ref<InputEvent>const&,StringName_const&,bool> *this,Object *param_1,
          Variant **param_2,Variant *param_3)
...
void __thiscall
MethodBindTR<bool,StringName_const&,Ref<InputEvent>const&>::ptrcall
          (MethodBindTR<bool,StringName_const&,Ref<InputEvent>const&> *this,Object *param_1,
...
void MethodBindT<StringName_const&,Ref<InputEvent>const&>::ptrcall
...
void __thiscall
MethodBindTRC<bool,Ref<InputEvent>const&,StringName_const&,bool>::ptrcall
          (MethodBindTRC<bool,Ref<InputEvent>const&,StringName_const&,bool> *this,Object *param_1,
          void **param_2,void *param_3)
...
void __thiscall
MethodBindTR<TypedArray<InputEvent>,StringName_const&>::validated_call
          (MethodBindTR<TypedArray<InputEvent>,StringName_const&> *this,Object *param_1,
          Variant **param_2,Variant *param_3)
...
void __thiscall
MethodBindTR<TypedArray<InputEvent>,StringName_const&>::ptrcall
          (MethodBindTR<TypedArray<InputEvent>,StringName_const&> *this,Object *param_1,
          void **param_2,void *param_3)
...
void __thiscall
MethodBindTR<TypedArray<StringName>>::validated_call
          (MethodBindTR<TypedArray<StringName>> *this,Object *param_1,Variant **param_2,
          Variant *param_3)
...
void __thiscall
MethodBindTR<TypedArray<StringName>>::ptrcall
          (MethodBindTR<TypedArray<StringName>> *this,Object *param_1,void **param_2,void *param_3)
...
Object * MethodBindTR<float,StringName_const&>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
Object * MethodBindTR<TypedArray<InputEvent>,StringName_const&>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
LAB_00110470:
    ...
    *in_R9 = 0;
    ...
    Variant::operator_cast_to_StringName((Variant *)&local_68);
    (*(code *)pVVar11)((Array *)&local_70,(Variant *)((long)plVar9 + (long)pVVar1),
                       (Variant *)&local_68);
...
Object * MethodBindTRC<bool,Ref<InputEvent>const&,StringName_const&,bool>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
LAB_0011083a:
      ...
      bVar7 = (bool)(*(code *)pVVar17)((Variant *)((long)plVar14 + (long)pVVar1),&local_88,
...
/* InputMap::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void InputMap::_get_property_listv(List *param_1,bool param_2)
...
MethodBind *
create_method_bind<InputMap,StringName_const&,float>(_func_void_StringName_ptr_float *param_1)
...
/* InputMap::_bind_compatibility_methods() [clone .cold] */
...
/* InputMap::_bind_methods() [clone .cold] */
...
MethodBind * create_method_bind<InputMap,bool,StringName_const&>(_func_bool_StringName_ptr *param_1)
...
MethodBind * create_method_bind<InputMap,TypedArray<StringName>>(_func_TypedArray *param_1)
...
MethodBind * create_method_bind<InputMap,StringName_const&>(_func_void_StringName_ptr *param_1)
...
MethodBind *
create_method_bind<InputMap,float,StringName_const&>(_func_float_StringName_ptr *param_1)
...
/* MethodBind* create_method_bind<InputMap, StringName const&, Ref<InputEvent> const&>(void
   (InputMap::*)(StringName const&, Ref<InputEvent> const&)) */

MethodBind *
create_method_bind<InputMap,StringName_const&,Ref<InputEvent>const&>
          (_func_void_StringName_ptr_Ref_ptr *param_1)
...
MethodBind *
create_method_bind<InputMap,bool,StringName_const&,Ref<InputEvent>const&>
          (_func_bool_StringName_ptr_Ref_ptr *param_1)
...
/* MethodBind* create_method_bind<InputMap, TypedArray<InputEvent>, StringName
   const&>(TypedArray<InputEvent> (InputMap::*)(StringName const&)) */

MethodBind *
create_method_bind<InputMap,TypedArray<InputEvent>,StringName_const&>
          (_func_TypedArray_StringName_ptr *param_1)
...
/* MethodBind* create_method_bind<InputMap, bool, Ref<InputEvent> const&, StringName const&,
   bool>(bool (InputMap::*)(Ref<InputEvent> const&, StringName const&, bool) const) */

MethodBind *
create_method_bind<InputMap,bool,Ref<InputEvent>const&,StringName_const&,bool>
          (_func_bool_Ref_ptr_StringName_ptr_bool *param_1)
...
/* MethodBind* create_method_bind<InputMap>(void (InputMap::*)()) */

MethodBind * create_method_bind<InputMap>(_func_void *param_1)
...
/* InputMap::_initialize_classv() */

void InputMap::_initialize_classv(void)
...
Object * MethodBindTR<bool,StringName_const&,Ref<InputEvent>const&>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
LAB_0011248d:
    ...
    *(void **)(this + 8) = __s_00;
    ...
    iVar45 = 0;
LAB_00112467:
    if ((float)uVar48 * __LC16 < (float)(iVar45 + 1)) goto LAB_0011248d;
  }
  local_58[0] = 0;
  local_68 = (undefined1  [16])0x0;
  if (*(long *)param_1 == 0) {
...
/* HashMap<String, List<Ref<InputEvent>, DefaultAllocator>, HashMapHasherDefault,
   ...
   List<Ref<InputEvent>, DefaultAllocator> > > >::_resize_and_rehash(unsigned int) */
...
/* HashMap<String, List<Ref<InputEvent>, DefaultAllocator>, HashMapHasherDefault,
   ...
   DefaultAllocator> const&, bool) */

String * HashMap<String,List<Ref<InputEvent>,DefaultAllocator>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,List<Ref<InputEvent>,DefaultAllocator>>>>
         ::insert(String *param_1,List *param_2,bool param_3)
...
LAB_00113330:
    ...
    _resize_and_rehash((HashMap<String,List<Ref<InputEvent>,DefaultAllocator>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,List<Ref<InputEvent>,DefaultAllocator>>>>
        ...
        do {
          if (uVar33 == uVar34) {
            ...
            if (cVar19 != '\0') {
              ...
              List<Ref<InputEvent>,DefaultAllocator>::clear
                        ((List<Ref<InputEvent>,DefaultAllocator> *)(lVar1 + 0x18));
              if (((long *)*in_RCX != (long *)0x0) &&
                 (plVar37 = *(long **)*in_RCX, plVar37 != (long *)0x0)) {
          ...
          uVar27 = SUB164(auVar8 * auVar16,8);
                ...
                (auVar9._8_8_ = 0, auVar9._0_8_ = (ulong)uVar34 * lVar1, auVar17._8_8_ = 0,
                auVar17._0_8_ = uVar25, auVar10._8_8_ = 0,
                auVar10._0_8_ = (ulong)((uVar20 + uVar27) - SUB164(auVar9 * auVar17,8)) * lVar1,
                auVar18._8_8_ = 0, auVar18._0_8_ = uVar25, uVar38 <= SUB164(auVar10 * auVar18,8)));
      }
      iVar26 = *(int *)(param_2 + 0x2c);
    }
LAB_0011330e:
    if ((float)uVar21 * __LC16 < (float)(iVar26 + 1)) goto LAB_00113330;
  }
  local_58 = 0;
  if (*(long *)pSVar28 != 0) {
...
/* WARNING: Removing unreachable block (ram,0x00113d19) */
/* WARNING: Removing unreachable block (ram,0x00113d22) */
/* WARNING: Removing unreachable block (ram,0x00113d32) */
/* WARNING: Removing unreachable block (ram,0x00113d42) */
/* void call_with_variant_args_dv<__UnexistingClass, StringName const&, Ref<InputEvent>
...
void call_with_variant_args_dv<__UnexistingClass,StringName_const&,Ref<InputEvent>const&>
               (__UnexistingClass *param_1,_func_void_StringName_ptr_Ref_ptr *param_2,
...
LAB_00113d68:
    ...
    *(undefined4 *)param_6 = 0;
    if (((ulong)param_2 & 1) != 0) {
      param_2 = *(_func_void_StringName_ptr_Ref_ptr **)
    ...
    if ((((lVar7 != 0) && (lVar7 != 0)) &&
        (pOVar8 = (Object *)__dynamic_cast(lVar7,&Object::typeinfo,&InputEvent::typeinfo,0),
        pOVar8 != (Object *)0x0)) &&
...
/* MethodBindT<StringName const&, Ref<InputEvent> const&>::call(Object*, Variant const**, int,
   Callable::CallError&) const */

Object * MethodBindT<StringName_const&,Ref<InputEvent>const&>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)

{
  ...
  call_with_variant_args_dv<__UnexistingClass,StringName_const&,Ref<InputEvent>const&>
            (p_Var3,(_func_void_StringName_ptr_Ref_ptr *)param_2[0xb],(Variant **)param_2[0xc],
...
void call_with_variant_args_dv<__UnexistingClass,StringName_const&,float>
               (__UnexistingClass *param_1,_func_void_StringName_ptr_float *param_2,
               Variant **param_3,int param_4,CallError *param_5,Vector *param_6)
...
LAB_001141b8:
    ...
    *(undefined4 *)param_6 = 0;
    if (((ulong)param_2 & 1) != 0) {
      param_2 = *(_func_void_StringName_ptr_float **)
                 (param_2 + *(long *)(param_1 + (long)param_3) + -1);
    }
...
Object * MethodBindT<StringName_const&,float>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)

{
  ...
  call_with_variant_args_dv<__UnexistingClass,StringName_const&,float>
            (p_Var3,(_func_void_StringName_ptr_float *)param_2[0xb],(Variant **)param_2[0xc],
             (int)param_4,in_R8,in_R9);
  *(undefined4 *)param_1 = 0;
  *(undefined1 (*) [16])(param_1 + 8) = (undefined1  [16])0x0;
LAB_00114256:
...
/* void call_get_argument_type_info_helper<Ref<InputEvent> const&>(int, int&, PropertyInfo&) */

void call_get_argument_type_info_helper<Ref<InputEvent>const&>
...
/* MethodBindTR<float, StringName const&>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTR<float,StringName_const&>::_gen_argument_type_info(int param_1)
...
/* MethodBindTR<TypedArray<InputEvent>, StringName const&>::_gen_argument_type_info(int) const */

undefined4 *
MethodBindTR<TypedArray<InputEvent>,StringName_const&>::_gen_argument_type_info(int param_1)
...
/* MethodBindT<StringName const&, float>::_gen_argument_type_info(int) const */

PropertyInfo * MethodBindT<StringName_const&,float>::_gen_argument_type_info(int param_1)
...
undefined4 *
MethodBindTR<bool,StringName_const&,Ref<InputEvent>const&>::_gen_argument_type_info(int param_1)

{
  ...
  if (in_EDX < 2) {
    ...
    call_get_argument_type_info_helper<Ref<InputEvent>const&>
              (in_EDX,(int *)&local_70,(PropertyInfo *)&local_68);
    uVar3 = local_60._0_8_;
    uVar4 = local_60._8_8_;
    auVar1._8_8_ = 0;
...
undefined4 *
MethodBindTRC<bool,Ref<InputEvent>const&,StringName_const&,bool>::_gen_argument_type_info
          (int param_1)
...
/* MethodBindT<StringName const&, Ref<InputEvent> const&>::_gen_argument_type_info(int) const */

PropertyInfo *
MethodBindT<StringName_const&,Ref<InputEvent>const&>::_gen_argument_type_info(int param_1)

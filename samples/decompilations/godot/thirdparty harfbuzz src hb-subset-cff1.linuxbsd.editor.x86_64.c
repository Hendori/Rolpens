...
LAB_001099a1:
                    /* WARNING: Could not recover jumptable at 0x001099b1. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        (*(code *)(&DAT_00109e18 + *(int *)(&DAT_00109e18 + (ulong)param_1 * 4)))();
        return;
      }
LAB_00109a70:
...

{
  ...
  *local_11e8;
  ...
  uVar41 = (uint)uVar43;
  if (lVar31 == 0) {
    cVar9 = hb_vector_t<CFF::parsed_cs_str_t,false>::alloc
...
LAB_0010a792:
          pvVar10 = realloc(pvVar10,uVar43 << 3);
...
LAB_0010a7db:
    *(hb_vector_t<CFF::parsed_cs_str_t,false> **)(this + 0x78) = phVar12;
    *(hb_vector_t<CFF::parsed_cs_str_vec_t,false> **)(this + 0x80) = this_00;
    if ((((-1 < *(int *)(this + 0xd0)) && (-1 < *(int *)(this + 0x68))) &&
        (-1 < *(int *)(this + 0xe0))) && ((-1 < *(int *)phVar12 && (-1 < *(int *)(this + 0x58))))) {
...
LAB_0010a990:
            uVar21 = 0;
LAB_0010a993:
            if (*(uint *)(lVar32 + 0x90) <= (uint)uVar21) goto LAB_0010a960;
          }
          else {
            if (*pcVar7 == '\0') {
            ...
            if (-1 < iVar38) {
              ...
              do {
                ...
                if (uVar41 < (ushort)(*(ushort *)((long)puVar25 + 3) << 8 |
                                     *(ushort *)((long)puVar25 + 3) >> 8)) goto LAB_0010a948;
                iVar42 = uVar19 + 1;
              } while (iVar42 <= iVar38);
            }
LAB_0010a915:
...
LAB_0010b826:
              ...
              if ((((uint)local_11c0 < local_11c0._4_4_) || ((char)local_11b8 != '\0')) ||
                 (local_125c = local_125c + -1, local_125c == 0)) goto LAB_0010a960;
              uVar30 = local_11c0._4_4_;
            } while (local_190 == '\0');
...
LAB_0010b29c:
                if (puVar20 == (undefined *)0x0) goto LAB_0010b258;
                pcVar33 = pcVar33 + 0x18;
...
LAB_0010b389:
              ...
              cVar9 = drop_hints_in_str(ppVar40,(subr_subset_param_t *)&local_1208,
...
LAB_0010b39c:
            ...
            *puVar34 = *puVar45;
            ...
            cVar9 = hb_vector_t<CFF::parsed_cs_op_t,false>::alloc
      ...
      if (((lVar31 == 0) && ((*(byte *)(*(long *)(this + 8) + 0x14) & 1) == 0)) ||
         (cVar9 = closure_subroutines(this,*(parsed_cs_str_vec_t **)(this + 0x78),
                                      *(hb_vector_t **)(this + 0x80)), cVar9 != '\0')) {
        lVar31 = 0;
            ...
            if (1 < uVar41) {
              ...
              do {
                ...
                if ((((((int)plVar26[1] == 10) || ((int)plVar26[1] == 0x1d)) ||
                     ((int)plVar11[1] == 10)) ||
                    (((int)plVar11[1] == 0x1d ||
                     (*(char *)((long)plVar26 + 0xd) != *(char *)((long)plVar11 + 0xd))))) ||
                   ((bVar49 = *(byte *)((long)plVar26 + 0xc), *plVar11 != (ulong)bVar49 + *plVar26
                    || (bVar5 = *(byte *)((long)plVar11 + 0xc), 0xff < (uint)bVar49 + (uint)bVar5)))
                   ) {
...
LAB_0010ac60:
                        pvVar10 = realloc(pvVar10,(long)(int)uVar36 << 4);
                        if (pvVar10 != (void *)0x0) {
LAB_0010ac75:
                          *(void **)(lVar28 + 0x10) = pvVar10;
...
LAB_0010ac80:
          ...
          if (phVar12 != (hb_vector_t<CFF::parsed_cs_str_t,false> *)0x0) {
            ...
            *(undefined8 *)(phVar12 + 8) = 0;
            *(undefined8 *)(phVar12 + 0x10) = 0;
            *(undefined8 *)(phVar12 + 0x18) = 0;
            *(undefined8 *)(phVar12 + 0x20) = 0;
...
LAB_0010bce2:
            ...
            hb_vector_t<CFF::parsed_cs_str_t,false>::alloc
                      (phVar12 + 0x10,*(uint *)(this + 0xf4),true);
...
LAB_0010bfa2:
                  pvVar10 = realloc(pvVar10,(ulong)uVar36 << 4);
                  if (pvVar10 != (void *)0x0) {
LAB_0010bfc2:
                    *(void **)(phVar12 + 0x28) = pvVar10;
                              ...
                              if (pvVar10 != (void *)0x0) {
                                *(void **)(puVar34 + 4) = pvVar10;
                                ...
                                do {
                                  ...
                                  *(undefined8 *)((long)pvVar10 + sVar27) =
...
LAB_0010c99d:
          ...
          uVar19 = *local_90;
          if (*(undefined2 **)(param_2 + 0x10) == puVar23 ||
              (long)*(undefined2 **)(param_2 + 0x10) - (long)puVar23 < 0) goto LAB_0010cbd8;
...
LAB_0010d340:
          uVar7 = 0;
LAB_0010d342:
          if (*(uint *)(lVar11 + 0x90) <= uVar7) goto LAB_0010d328;
        }
        else {
          if (*pcVar4 == '\0') {
          ...
          if (-1 < iVar16) {
            ...
            do {
              ...
              if (uVar7 < (ushort)(*(ushort *)((long)puVar14 + 3) << 8 |
                                  *(ushort *)((long)puVar14 + 3) >> 8)) goto LAB_0010d310;
              iVar18 = uVar13 + 1;
            } while (iVar18 <= iVar16);
          }
LAB_0010d2db:
...

{
  ...
  uVar9 = hb_vector_t<hb_vector_t<unsigned_char,false>,false>::resize
...
LAB_0010e368:
            cVar8 = hb_vector_t<unsigned_char,false>::alloc(this_00,uVar10 + 1,false);
            if (cVar8 != '\0') {
...
LAB_0010ddf8:
            uVar12 = 0;
LAB_0010ddfa:
            if (*(uint *)(lVar20 + 0x90) <= (uint)uVar12) goto LAB_0010dd70;
          }
          else {
            if (*pcVar5 == '\0') {
            ...
            if (-1 < iVar26) {
              ...
              do {
                ...
                if (uVar10 < (ushort)(*(ushort *)((long)puVar22 + 3) << 8 |
                                     *(ushort *)((long)puVar22 + 3) >> 8)) goto LAB_0010dd50;
                iVar30 = uVar18 + 1;
              } while (iVar30 <= iVar26);
            }
LAB_0010dd1d:
                    ...
                    while( true ) {
                      ...
                      if ((int)uVar18 < *(int *)this_01) {
                        ...
                        *(undefined1 *)(*(long *)(this_01 + 8) + (ulong)uVar18) = 0xff;
                        ...
                        cVar8 = hb_vector_t<unsigned_char,false>::alloc
...
LAB_0010e450:
                      ...
                      *(uint *)(this_01 + 4) = uVar25;
                      *(char *)(*(long *)(this_01 + 8) + (ulong)uVar18) = (char)iVar26;
                      if (pcVar32 == (cff1_cs_interp_env_t *)(&local_11c0 + uVar10 + uVar12))
                      goto LAB_0010e246;
                    }
...
LAB_0010e246:
            ...
            if ((((uint)local_11c0 < local_11c0._4_4_) || ((char)local_11b8 != '\0')) ||
               (local_1208 = local_1208 + -1, local_1208 == 0)) goto LAB_0010dd70;

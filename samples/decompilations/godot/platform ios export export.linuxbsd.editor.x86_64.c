...
/* WARNING: Removing unreachable block (ram,0x0010006f) */
/* WARNING: Removing unreachable block (ram,0x00100210) */
/* WARNING: Removing unreachable block (ram,0x00100222) */
/* WARNING: Unknown calling convention -- yet parameter storage is locked */
/* register_ios_exporter() */

void register_ios_exporter(void)

{
  long lVar1;
  Ref *pRVar2;
  char cVar3;
  EditorExportPlatformIOS *this;
  Object *pOVar4;
  EditorExportPlatformIOS *pEVar5;
  long in_FS_OFFSET;
  Object *local_28;
  
  lVar1 = *(long *)(in_FS_OFFSET + 0x28);
  this = (EditorExportPlatformIOS *)operator_new(0x218,"");
  EditorExportPlatformIOS::EditorExportPlatformIOS(this);
...
LAB_0010005b:
    ...
    if (cVar3 == '\0') {
      ...
      if (cVar3 != '\0') {
        ...
        pEVar5 = (EditorExportPlatformIOS *)0x0;
        if (cVar3 != '\0') goto LAB_0010019f;
      }
      goto LAB_0010005b;
    }
    cVar3 = RefCounted::unreference();
    if ((cVar3 != '\0') && (cVar3 = predelete_handler((Object *)this), pEVar5 = this, cVar3 != '\0')
       ) {
LAB_0010019f:
      (**(code **)(*(long *)this + 0x140))(this);
      Memory::free_static(this,false);
      this = pEVar5;
      if (pEVar5 == (EditorExportPlatformIOS *)0x0) goto LAB_0010005b;
    }
    pRVar2 = EditorExport::singleton;
    local_28 = (Object *)0x0;
    pOVar4 = (Object *)__dynamic_cast(this,&Object::typeinfo,&EditorExportPlatform::typeinfo,0);
...
LAB_00100128:
      ...
      if (this != (EditorExportPlatformIOS *)0x0) goto LAB_00100128;
    }
  }
  if (lVar1 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
...
void register_ios_exporter_types(void)

{
  ClassDB::register_class<EditorExportPlatformIOS>(true);
  return;
}
...
/* Object* ClassDB::creator<EditorExportPlatformIOS>(bool) */

Object * ClassDB::creator<EditorExportPlatformIOS>(bool param_1)
  ...
  if (pvVar5 != (void *)0x0) {
    if (*(int *)(this + 0x3c) != 0) {
      ...
      if (uVar2 == 0) {
        ...
        *(undefined4 *)(this + 0x3c) = 0;
        *(undefined1 (*) [16])(this + 0x28) = (undefined1  [16])0x0;
        if (pvVar5 == (void *)0x0) goto LAB_001004a4;
      }
    }
    Memory::free_static(pvVar5,false);
...
/* void ClassDB::register_class<EditorExportPlatformIOS>(bool) */

void ClassDB::register_class<EditorExportPlatformIOS>(bool param_1)

{
  ...
  _global_lock();
  if (EditorExportPlatformIOS::initialize_class()::initialized == '\0') {
    ...
    StringName::StringName((StringName *)&local_60,(String *)&local_68,false);
    local_70 = 0;
    local_58 = "EditorExportPlatformIOS";
    local_50 = 0x17;
    String::parse_latin1((StrRange *)&local_70);
    StringName::StringName((StringName *)&local_58,(String *)&local_70,false);
    ClassDB::_add_class2((StringName *)&local_58,(StringName *)&local_60);
    ...
    EditorExportPlatformIOS::initialize_class()::initialized = '\x01';
  }
  local_58 = "EditorExportPlatformIOS";
  local_60 = 0;
  local_50 = 0x17;
  ...
  if ((CONCAT44(current_api._4_4_,(undefined4)current_api) != 0) && (_DAT_001020f4 != 0)) {
    ...
    if (uVar17 != 0) {
      ...
      do {
        if ((uVar17 == uVar13) &&
          ...
          if (local_60 == 0) goto LAB_00100a0f;
          goto LAB_001009e5;
        }
        uVar18 = uVar18 + 1;
        auVar5._8_8_ = 0;
...
LAB_00100a0f:
        ...
        *(code **)(puVar16 + 0xa4) = creator<EditorExportPlatformIOS>;
        *(bool *)((long)puVar16 + 0x28b) = param_1;
        *(undefined4 **)(puVar16 + 4) = &EditorExportPlatformIOS::get_class_ptr_static()::ptr;
        *puVar16 = (undefined4)current_api;
        if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) goto LAB_00100c37;
        goto LAB_00100a57;
      }
    }
  }

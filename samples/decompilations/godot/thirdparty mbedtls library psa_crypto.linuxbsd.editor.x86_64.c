...

{
  ...
  if ((param_2 & 0xffffef00) == 0x6000300) {
    ...
    if (((((param_2 & 0xffffff00) != 0x6000200) && ((param_2 & 0xfffffe00) != 0x6000600)) &&
        ((param_2 & 0xffffff00) != 0x6000900)) && ((param_2 & 0xfffffe00) != 0x6000400)) {
...
LAB_00100208:
      ...
      if ((param_3 & 0x8000) != 0) {
        return CONCAT22((ushort)((param_2 & 0xffc07fff) >> 0x10) | (ushort)uVar3 & 0x3f,
                        (short)(param_2 & 0xffc07fff)) | 0x8000;
      }
      if (uVar4 <= uVar7) {
        return param_3;
      }
  ...
  if ((((param_3 & 0xffffff00) != 0x6000200) && ((param_3 & 0xfffffc00) != 0x6000400)) &&
     ((param_3 & 0xffffff00) != 0x6000900)) {
    return 0;
  }
LAB_001000e0:
  uVar3 = 0;
  if (((param_2 ^ param_3) < 0x100) &&
     ((((param_2 & 0xff) == 0 || (uVar3 = param_3, (param_2 & 0xff | 0x2000000) != 0x20000ff)) &&
      (uVar3 = param_3 & 0xff, uVar3 != 0)))) {
    uVar6 = 0;
...

{
  ...
  if (param_1 == 0) {
    if ((((((param_2 & 0xfffffe00) != 0x6000200) && (uVar1 != 0x6001300)) &&
         ((param_2 & 0xfffffc00) != 0x6000400)) && (uVar1 != 0x6000900)) || ((param_2 & 0xff) == 0))
    {
      return 0;
    }
  }
  else {
    if ((((param_2 & 0xffffef00) != 0x6000300) && (uVar1 != 0x6000200)) &&
       (((param_2 & 0xfffffc00) != 0x6000400 && (uVar1 != 0x6000900)))) {
      return 0xffffff79;
    }
    if ((param_2 & 0xff) == 0) {
      return 0xffffff79;
...

{
  ...
  if ((param_1 & 0x7f000000) == 0x5000000) {
    if (((((param_1 & 0xfffffe00) != 0x6000200) && ((param_1 & 0xffffff00) != 0x6001300)) &&
        ((param_1 & 0xfffffc00) != 0x6000400)) && ((param_1 & 0xffffff00) != 0x6000900)) {
...
psa_export_key_buffer_internal
          (void *param_1,ulong param_2,void *param_3,ulong param_4,ulong *param_5)
...

{
  ...
  *param_3 = 0;
  ...
  if ((char)uVar1 == '\0') {
    if (iVar4 == 0) {
LAB_001008bd:
      if ((*(uint *)(param_1 + 1) & 0xffff00fc) == 0) {
...

{
  ...
  if (((((uVar3 & 0xfffffe00) == 0x6000200) || ((uVar3 & 0xffffff00) == 0x6001300)) ||
      ((uVar3 & 0xfffffc00) == 0x6000400)) || ((uVar3 & 0xffffff00) == 0x6000900)) {
    if (((param_2 & 0xfffffe00) == 0x6000200) || ((param_2 & 0xffffff00) == 0x6001300)) {
      if ((param_2 & 0xff) == 0) {
        return false;
      }
    }
    else if ((((param_2 & 0xfffffc00) != 0x6000400) && ((param_2 & 0xffffff00) != 0x6000900)) ||
            ((param_2 & 0xff) == 0)) goto LAB_00100c07;
...
LAB_00100c07:
  ...
  if (((param_2 & 0x7f000000) != 0x3000000) || ((uVar3 & 0x7f000000) != 0x3000000))
  goto LAB_00100c07;
  if (((uVar3 ^ param_2) & 0xffc07fff) != 0) {
    return false;
  }
  ...
  else if ((((param_2 & 0x7fc00000) != 0x3c00000) || ((uVar6 & 0x7000) != 0x2000)) ||
          ((param_1 & 0x700) == 0)) {
    return false;
  }
...
undefined4
psa_get_and_lock_key_slot_with_policy_part_0(undefined8 *param_1,uint param_2,uint param_3)
...
LAB_00100f50:
        if (param_3 != 0x20000ff) goto LAB_00100f73;
      }
      else {
...
LAB_00100f59:
    ...
    if ((param_3 & 0xff) != 0) {
LAB_00100f67:
      if ((param_3 & 0xff | 0x2000000) == 0x20000ff) goto LAB_00100f59;
    }
LAB_00100f73:
    uVar5 = (ulong)*puVar1;
    ...
    iVar2 = psa_key_algorithm_permits
                      (uVar5 & 0xffffffff,*(undefined4 *)(puVar1 + 8),uVar4 & 0xffffffff);
    if (iVar2 != 0) {
      return 0;
    }
  }
...
int psa_mac_compute_internal
              (undefined8 param_1,undefined4 param_2,undefined8 param_3,undefined8 param_4,
              void *param_5,ulong param_6,ulong *param_7,int param_8)

{
  ...
  if (iVar1 == 0) {
    iVar1 = psa_get_and_lock_key_slot_with_policy_part_0
                      (&local_48,(-(uint)(param_8 == 0) & 0x400) + 0x400,param_2);
    puVar2 = local_48;
    if ((iVar1 == 0) &&
       (iVar1 = psa_mac_finalize_alg_and_key_validation_isra_0(param_2,*local_48,&local_49),
       iVar1 == 0)) {
      iVar1 = -0x8a;
      if (local_49 <= param_6) {
        if (*(uint *)(puVar2 + 2) >> 8 == 0) {
          iVar1 = mbedtls_psa_mac_compute
                            (puVar2,*(undefined8 *)(puVar2 + 0x14),*(undefined8 *)(puVar2 + 0x18),
                             param_2,param_3,param_4,param_5,(ulong)local_49,param_7);
          puVar2 = local_48;
          if (iVar1 == 0) {
            if (param_6 != 0) {
...

{
  ...
  if (iVar2 == 0) {
    ...
    if (((iVar1 == 0) &&
        (iVar1 = psa_get_and_lock_key_slot_with_policy_part_0
                           (&local_48,(-(uint)(param_4 == 0) & 0x400) + 0x400,param_3), iVar1 == 0))
       && (puVar3 = local_48,
          iVar1 = psa_mac_finalize_alg_and_key_validation_isra_0(param_3,*local_48,param_1 + 1),
          iVar1 == 0)) {
      *(byte *)((long)param_1 + 5) = *(byte *)((long)param_1 + 5) & 0xfe | (byte)param_4 & 1;
      if (param_4 == 0) {
        if (*(uint *)(puVar3 + 2) >> 8 != 0) goto LAB_001012fe;
        iVar1 = mbedtls_psa_mac_verify_setup
                          (param_1 + 2,puVar3,*(undefined8 *)(puVar3 + 0x14),
...
LAB_001012fe:
        ...
        iVar1 = mbedtls_psa_mac_sign_setup
                          (param_1 + 2,puVar3,*(undefined8 *)(puVar3 + 0x14),
                           *(undefined8 *)(puVar3 + 0x18),param_3);
      }
      if (iVar1 == 0) {
...

{
  ...
  if (iVar6 == 0) {
    ...
    if ((param_3 & 0x7f000000) == 0x4000000) {
      ...
      if ((iVar5 == 0) &&
         (iVar5 = psa_get_and_lock_key_slot_with_policy_part_0(&local_48,uVar7,param_3), iVar5 == 0)
         ) {
...
LAB_00101478:
          ...
          *(byte *)(param_1 + 1) = bVar3 | 1;
          if ((((uVar2 & 0x7000) != 0x2000) || ((uVar2 & 0x700) == 0)) ||
             ((((uVar4 = (undefined1)(1 << ((byte)(uVar2 >> 8) & 7)),
                (param_3 & 0xfffffeff) != 0x4c01000 && (param_3 != 0x4c01200)) &&
               (param_3 != 0x440ff00)) && ((param_3 & 0xfffffeff) != 0x4404000)))) {
LAB_00101406:
            if ((uVar2 != 0x2004) || (uVar4 = 0xc, param_3 != 0x4800100)) {
        ...
        *(undefined1 *)((long)param_1 + 5) = uVar4;
        if (param_4 == 1) {
          ...
          iVar5 = mbedtls_psa_cipher_encrypt_setup
                            (param_1 + 2,local_48,*(undefined8 *)(local_48 + 0x14),
                             *(undefined8 *)(local_48 + 0x18),param_3);
        }
        else {
...
switchD_001015cd_caseD_ffffff8e:
    return 0xffffff7a;
  }
  if ((int)param_1 < -0x15) {
    if (-0x27 < (int)param_1) {
...
switchD_001015cd_caseD_ffffff8f:
  return 0xffffff7c;
}
...
LAB_00101bdb:
            return -(uint)((param_2 & 7) != 0) & 0xffffff79;
          }
        }
...
ulong psa_import_key_into_slot
                (ushort *param_1,void *param_2,size_t param_3,void *param_4,undefined8 param_5,
...

{
  ...
  uVar1 = *param_1;
  if (((((uVar1 & 0x7000) - 0x1000 & 0xe000) != 0) && ((uVar1 & 0xcfff) != 0x4001)) &&
     (((uVar1 & 0xffffcf00) - 0x4100 & 0xfffffe00) != 0)) {
    return 0xffffff7a;
  }
...
int psa_copy_key(undefined8 param_1,ushort *param_2,undefined4 *param_3)
  ...
  *param_3 = 0;
  ...
  if (iVar6 == 0) {
    ...
    if ((*param_2 == 0) || (*local_78 == *param_2)) {
      ...
      ;
      if (((iVar6 != 0 && iVar4 != 0) && (iVar7 == 0)) ||
         ((iVar2 != 0 && iVar5 != 0 && (iVar8 == 0)))) goto LAB_00102350;
      ...
      if (uVar1 >> 8 == *(uint *)(local_78 + 2) >> 8) {
        if (local_58._4_4_ >> 8 == 0) {
          iVar6 = psa_copy_key_material_into_slot
                            (local_70[0],*(undefined8 *)(local_78 + 0x14),
                             *(undefined8 *)(local_78 + 0x18));
          if ((iVar6 == 0) &&
             (((char)uVar1 == '\0' ||
              (iVar6 = psa_save_persistent_key
                                 (lVar3,*(undefined8 *)(lVar3 + 0x28),*(undefined8 *)(lVar3 + 0x30))
              , lVar11 = local_70[0], iVar6 == 0)))) {
...
LAB_00102350:
      ...
      lVar11 = local_70[0];
LAB_00102136:
      if (lVar11 == 0) goto LAB_00102298;
    }
LAB_0010213f:
    psa_wipe_key_slot(lVar11);
...

{
  ...
  if (iVar2 == 0) {
    ...
    if ((param_2 & 0x7f000000) == 0x2000000) {
      ...
      for (uVar3 = (ulong)(((int)(param_1 + 2) -
                           (int)(undefined8 *)((ulong)(param_1 + 4) & 0xfffffffffffffff8)) + 0xe0U
...

{
  ...
  *(undefined8 *)(param_1 + 0x230) = 0;
  ...
  if (((param_2 & 0xfffffe00) != 0x8000200 && uVar8 != 0x8000500) &&
     (uVar8 != 0x8000100 && uVar8 != 0x8000400)) {
...
switchD_001025a1_caseD_2000006:
    iVar1 = -0x86;
  }
LAB_00102554:
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
...
psa_sign_message_builtin
          (long param_1,undefined8 param_2,undefined8 param_3,uint param_4,undefined8 param_5,
...

{
  ...
  if (((((param_4 & 0xfffffe00) == 0x6000200) || ((param_4 & 0xffffff00) == 0x6001300)) ||
      ((param_4 & 0xfffffc00) == 0x6000400)) || ((param_4 & 0xffffff00) == 0x6000900)) {
    uVar2 = param_4 & 0xff;
    if (uVar2 != 0) {
    ...
    if ((int)uVar1 == 0) {
      if (*(uint *)(param_1 + 4) >> 8 == 0) {
        uVar1 = psa_sign_hash_builtin
                          (param_1,param_2,param_3,param_4,local_88,local_90,param_7,param_8,param_9
                          );
      }
      else {
        uVar1 = 0xffffff79;
...
int psa_sign_internal_part_0_constprop_0
              (undefined8 param_1,int param_2,undefined4 param_3,undefined8 param_4,
              undefined8 param_5,void *param_6,size_t param_7,long *param_8)

{
  ...
  if ((iVar1 == 0) &&
     (iVar1 = psa_get_and_lock_key_slot_with_policy_part_0
                        (&local_48,(-(uint)(param_2 == 0) & 0xc00) + 0x400,param_3),
     puVar2 = local_48, iVar1 == 0)) {
    if ((~*local_48 & 0x7000) == 0) {
      if (param_2 == 0) {
        if (*(uint *)(local_48 + 2) >> 8 != 0) goto LAB_001029f1;
        iVar1 = psa_sign_hash_builtin
                          (local_48,*(undefined8 *)(local_48 + 0x14),
                           *(undefined8 *)(local_48 + 0x18),param_3,param_4,param_5,param_6,param_7,
                           param_8);
      }
      else {
        iVar1 = psa_sign_message_builtin
                          (local_48,*(undefined8 *)(local_48 + 0x14),
                           *(undefined8 *)(local_48 + 0x18),param_3,param_4,param_5,param_6,param_7,
                           param_8);
      }
...
undefined8
psa_verify_hash_builtin(ushort *param_1,undefined8 param_2,undefined8 param_3,uint param_4)
...

{
  ...
  if (((((param_4 & 0xfffffe00) == 0x6000200) || ((param_4 & 0xffffff00) == 0x6001300)) ||
    ...
    if ((int)uVar1 == 0) {
      if (*(uint *)(param_1 + 4) >> 8 == 0) {
        uVar1 = psa_verify_hash_builtin
                          (param_1,param_2,param_3,param_4,local_88,local_90,param_7,param_8);
      }
      else {
        uVar1 = 0xffffff79;
      }
        ...
        if ((uVar7 & 4) == 0) {
          if ((uVar2 != 0) && (*(undefined1 *)param_2 = *(undefined1 *)puVar3, (uVar7 & 2) != 0)) {
            *(undefined2 *)((long)param_2 + (uVar7 - 2)) =
                 *(undefined2 *)((long)puVar3 + (uVar7 - 2));
          }
        }
        else {
        ...
        if (7 < uVar2) {
          ...
          do {
            ...
            *(undefined8 *)(((ulong)(param_2 + 1) & 0xfffffffffffffff8) + uVar6) =
                 *(undefined8 *)((long)puVar3 + (uVar6 - lVar4));
            uVar6 = (ulong)uVar5;
          } while (uVar5 < uVar2);
        }
      }
...

{
  ...
  if (*param_1 != 0) {
    ...
    for (uVar2 = (ulong)(((int)param_1 -
                         (int)(undefined8 *)((ulong)(param_1 + 2) & 0xfffffffffffffff8)) + 0x1d8U >>
...

{
  ...
  if (iVar4 == 0) {
    if ((*param_1 == 0) && ((*(byte *)(param_1 + 8) & 0xf) == 0)) {
      ...
      if (iVar4 == 0) {
        iVar4 = psa_get_and_lock_key_slot_with_policy_part_0
                          (&local_48,(-(uint)(param_2 == 0) & 0x100) + 0x100,param_4 & 0xffffffff);
        if (iVar4 == 0) {
...
LAB_00103393:
              uVar1 = *(undefined8 *)(local_48 + 0x18);
              uVar2 = *(undefined8 *)(local_48 + 0x14);
              if (param_2 == 0) {
                if (*(uint *)(local_48 + 2) >> 8 != 0) goto LAB_001034e8;
                *param_1 = 1;
                iVar4 = mbedtls_psa_aead_decrypt_setup
                                  (param_1 + 10,local_48,uVar2,uVar1,param_4 & 0xffffffff);
              }
              else {
                if (*(uint *)(local_48 + 2) >> 8 != 0) {
LAB_001034e8:
                ...
                *param_1 = 1;
                iVar4 = mbedtls_psa_aead_encrypt_setup
                                  (param_1 + 10,local_48,uVar2,uVar1,param_4 & 0xffffffff);
              }
              puVar7 = local_48;
              if (iVar4 == 0) {
                *(undefined2 *)(param_1 + 2) = *local_48;
                ...
                iVar6 = 0x5500100;
                if ((uVar8 != 0x5400100) && (iVar6 = 0x5500200, uVar8 != 0x5400200)) {
                  iVar6 = 0x5100500;
                }
                param_1[1] = iVar6;
...
LAB_00103474:
    psa_unregister_read_under_mutex(puVar7);
  }
...
LAB_001036ca:
    if ((uVar1 >> 8 == 0x80004) || ((uVar1 & 0xfffffb00) == 0x8000100)) {
      free(*(void **)(param_1 + 4));
      if (param_1[0x2a] != 0) {
        if (param_1[0x2a] == 1) {
      ...
      if (*(long *)(param_1 + 6) != 0) {
        mbedtls_zeroize_and_free(*(long *)(param_1 + 6),*(undefined8 *)(param_1 + 8));
      }
      if (*(long *)(param_1 + 10) != 0) {
        mbedtls_zeroize_and_free(*(long *)(param_1 + 10),*(undefined8 *)(param_1 + 0xc));
      }
      if (*(long *)(param_1 + 0xe) != 0) {
        mbedtls_zeroize_and_free(*(long *)(param_1 + 0xe),*(undefined8 *)(param_1 + 0x10));
      }
...
int psa_generate_key_custom
              (ushort *param_1,int *param_2,undefined8 param_3,long param_4,undefined4 *param_5)

{
  ...
  *param_5 = 0;
  local_58[0] = 0;
  local_58[1] = 0;
  if ((((uVar1 == 0) || ((*param_1 & 0x7000) == 0x4000)) || ((*param_1 != 0x7001 && (param_4 != 0)))
      ) || (*param_2 != 0)) {
    iVar3 = -0x87;
    goto LAB_00103d2d;
  }
    ...
    if (sVar9 == 0) {
      if (uVar8 >> 8 == 0) {
        ...
        if (((uVar1 & 0x7000) - 0x1000 & 0xe000) == 0) {
          ...
          if (iVar3 == 0) {
LAB_00103c34:
            uVar8 = (uVar8 & 0xffff) + 7 >> 3;
LAB_00103c3d:
            local_58[2] = (long)uVar8;
            goto LAB_00103c42;
          }
        }
        else {
...
LAB_00103c7b:
    ...
    if ((*param_2 == 0) && (param_4 == 0)) {
      if (uVar8 >> 8 == 0) {
LAB_00103c9f:
        iVar4 = psa_generate_key_internal(param_1,param_2,param_3,param_4,pvVar5,sVar9,lVar6 + 0x30)
        ;
        lVar6 = local_58[0];
        if (iVar4 == 0) {
          if ((*(char *)(local_58[0] + 4) == '\0') ||
             (iVar3 = psa_save_persistent_key
                                (local_58[0],*(undefined8 *)(local_58[0] + 0x28),
                                 *(undefined8 *)(local_58[0] + 0x30)), lVar7 = local_58[0],
             iVar3 == 0)) {
...
LAB_00103d20:
    if (lVar7 == 0) goto LAB_00103d2d;
  }
LAB_00103d25:
  psa_wipe_key_slot(lVar7);
LAB_00103d2d:
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    __stack_chk_fail();
...
LAB_0010402e:
      iVar3 = psa_initialize_key_slots();
...
LAB_00103fda:
    if ((DAT_0010ad01 == '\0') && ((global_data & 1) != 0)) {
...
psa_crypto_driver_pake_get_password
          (undefined8 *param_1,void *param_2,ulong param_3,undefined8 *param_4)
...
undefined8
psa_crypto_driver_pake_get_user(long param_1,void *param_2,ulong param_3,undefined8 *param_4)
...
undefined8
psa_crypto_driver_pake_get_peer(long param_1,void *param_2,ulong param_3,undefined8 *param_4)
...
LAB_001042fb:
  ...
  for (uVar3 = (ulong)(((int)param_1 -
                       (int)(undefined8 *)((ulong)(param_1 + 2) & 0xfffffffffffffff8)) + 0x390U >> 3
    ...
    if ((*param_2 & 0x7f000000) == 0xa000000) {
      ...
      if ((param_2[2] & 0x7f000000) == 0x2000000) {
        ...
        *(undefined8 *)(param_1 + 0x70) = 0;
        ...
        uVar1 = *param_2;
        *(ulong *)(param_1 + 4) =
             CONCAT44((uint)(byte)param_2[1] << 0x18 | (uint)*(byte *)((long)param_2 + 5) << 0x10 |
                      (uint)*(ushort *)((long)param_2 + 6),uVar1);
...
LAB_00104a4c:
        ...
        if (iVar3 == 0) {
          ...
          if (local_60 < 0xfff9) {
            if (((*param_1 != 0) && (*param_1 != *local_70)) ||
               ((param_1[1] != 0 && (param_1[1] != local_70[1])))) goto LAB_001049c2;
            if (((char)local_70[2] == '\0') ||
               (iVar2 = psa_save_persistent_key
                                  (local_70,*(undefined8 *)(local_70 + 0x14),
                                   *(undefined8 *)(local_70 + 0x18)), iVar2 == 0)) {
  ...
  if (iVar2 == 0) {
    ...
    if (iVar1 == 0) {
      if (iVar2 == 1) {
        ...
        if ((iVar1 == 0) || (iVar2 = *param_1, iVar2 == 0)) goto LAB_00104c87;
        goto LAB_00104c6d;
      }
      iVar1 = -0x89;
    }
...
LAB_00104c87:
  mbedtls_zeroize_and_free(uVar3,local_40);
LAB_00104c0b:
  if (local_30 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    __stack_chk_fail();
...
LAB_00104db0:
  mbedtls_zeroize_and_free(uVar3,uVar2);
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return iVar1;
  }
                    /* WARNING: Subroutine does not return */
...
uint psa_hash_compare(uint param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
                     long param_5)
...

{
  ...
  if ((*(byte *)((long)param_1 + 5) & 1) == 0) {
    ...
    iVar2 = -0x95;
    if ((uVar5 != param_3) ||
       (iVar1 = psa_crypto_local_input_alloc(param_2,uVar5,&local_58), uVar4 = local_58,
       iVar2 = iVar1, iVar1 != 0)) goto LAB_0010518c;
    if (iVar3 != 1) {
      iVar2 = -0x87;
      iVar1 = -0x87;
      goto LAB_001051aa;
...
int psa_mac_verify(undefined4 param_1,undefined4 param_2,undefined8 param_3,undefined8 param_4,
  ...
  if (iVar1 == 0) {
    ...
    if (iVar1 == 0) {
      if (local_b0 == param_6) {
        ...
        uVar3 = local_90;
        if ((iVar1 == 0) &&
           (iVar1 = mbedtls_ct_memcmp(local_98,local_88,param_6), uVar2 = extraout_RDX_01,
           uVar3 = local_90, iVar1 != 0)) {
          iVar1 = -0x95;
...
int psa_verify_message(undefined4 param_1,undefined4 param_2,undefined8 param_3,undefined8 param_4,
                      undefined8 param_5,undefined8 param_6)

{
  ...
  if (iVar1 == 0) {
    ...
    if ((iVar1 == 0) &&
       (iVar1 = psa_sign_verify_check_alg(1,param_2), uVar3 = extraout_RDX_01, iVar1 == 0)) {
      iVar1 = psa_get_and_lock_key_slot(param_1,&local_70);
      uVar3 = extraout_RDX_02;
      if ((iVar1 == 0) &&
         (iVar1 = psa_get_and_lock_key_slot_with_policy_part_0(&local_70,0x800,param_2),
         uVar3 = extraout_RDX_03, iVar1 == 0)) {
        uVar3 = local_58;
        iVar1 = psa_verify_message_builtin
                          (local_70,*(undefined8 *)(local_70 + 0x28),
                           *(undefined8 *)(local_70 + 0x30),param_2,local_68,param_4,local_58,
                           param_6);
...
int psa_verify_hash(undefined4 param_1,undefined4 param_2,undefined8 param_3,undefined8 param_4,
                   undefined8 param_5,undefined8 param_6)

{
  ...
  if (iVar1 == 0) {
    ...
    uVar5 = local_50;
    if ((iVar1 == 0) &&
       (iVar1 = psa_sign_verify_check_alg(0,param_2), uVar3 = extraout_RDX_01, uVar5 = local_50,
       iVar1 == 0)) {
      iVar1 = psa_get_and_lock_key_slot(param_1,&local_70);
      uVar3 = extraout_RDX_02;
      if ((iVar1 == 0) &&
         (iVar1 = psa_get_and_lock_key_slot_with_policy_part_0(&local_70,0x2000,param_2),
         uVar3 = extraout_RDX_03, iVar1 == 0)) {
        if (*(uint *)(local_70 + 4) >> 8 == 0) {
          ...
          psa_unregister_read_under_mutex
                    (local_70,*(undefined8 *)(local_70 + 0x28),*(undefined8 *)(local_70 + 0x30));
...
int psa_sign_hash_start(int *param_1,uint param_2,undefined4 param_3,undefined8 param_4,
                       undefined8 param_5)
...
int psa_verify_hash_start
              (int *param_1,uint param_2,undefined4 param_3,undefined8 param_4,undefined8 param_5,
...

{
  ...
  if ((*(byte *)(param_1 + 1) & 3) == 1) {
    iVar1 = -0x87;
    if ((0x10 < param_3) ||
       (iVar1 = psa_crypto_local_input_alloc(param_2,param_3,&local_48), uVar3 = local_48,
       iVar1 != 0)) goto LAB_00105b31;
    if (iVar2 == 1) {
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if ((param_1[1] != 0xa000100) || (uVar7 = 0, param_1[2] != 0)) {
...
LAB_00106068:
    if (cVar4 != '\x02') goto LAB_00106160;
    if (param_4 - 1U < uVar7) {
      if (param_1[1] == 0xa000100) {
...
LAB_001060c8:
          iVar6 = (uint)(param_1[5] != 1) * 3 + 7;
        }
        else {
          if (param_1[5] != 0) goto LAB_00106160;
          if (uVar1 != 0) goto LAB_001060c8;
LAB_001061d2:
          iVar6 = (-(uint)((char)param_1[6] == '\0') & 0xfffffffd) + 4;
        }
...
undefined8
psa_crypto_local_output_alloc(undefined8 param_1,size_t param_2,undefined1 (*param_3) [16])
      ...
      if (((uVar1 & 0x7000) == 0x4000) || ((local_60[4] & 1) != 0)) {
        ...
        if (pvVar6 == (void *)0x0) {
          ...
          if (*(uint *)(puVar2 + 2) >> 8 == 0) {
            if (((((uVar1 & 0x7000) - 0x1000 & 0xe000) == 0) || ((uVar1 & 0xcfff) == 0x4001)) ||
               (((uVar1 & 0xffffcf00) - 0x4100 & 0xfffffe00) == 0)) {
              uVar3 = psa_export_key_buffer_internal
                                (*(undefined8 *)(puVar2 + 0x14),*(undefined8 *)(puVar2 + 0x18),
                                 pvVar6,param_3,param_4);
            }
            else {
              uVar3 = 0xffffff7a;
            }
...
ulong psa_export_public_key
                (undefined8 param_1,undefined8 param_2,size_t param_3,undefined8 *param_4)
    ...
    if ((int)uVar3 == 0) {
      ...
      if (pvVar4 == (void *)0x0) {
        ...
        if ((*local_40 & 0x4000) != 0) {
          uVar2 = psa_driver_wrapper_export_public_key
                            (local_40,*(undefined8 *)(local_40 + 0x14),
                             *(undefined8 *)(local_40 + 0x18),pvVar4,param_3,param_4);
        }
      }
      uVar1 = psa_unregister_read_under_mutex(local_40);
      uVar3 = psa_crypto_local_output_free(local_38);
      if (((int)uVar3 == 0) && (uVar3 = (ulong)uVar1, uVar2 != 0)) {
        uVar3 = (ulong)uVar2;
      }
    }
  }
...
LAB_0010672a:
  iVar2 = psa_crypto_local_output_free(local_48);
  if (iVar2 == 0) {
    iVar2 = iVar1;
  }
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
...
int psa_hash_compute(uint param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
                    size_t param_5,undefined8 *param_6)
...
LAB_0010696c:
  ...
  if (((int)uVar4 == 0) && (uVar4 = uVar5, uVar6 != 0)) {
    uVar4 = (ulong)uVar6;
  }
LAB_001069bb:
  if (local_30 != *(long *)(in_FS_OFFSET + 0x28)) {
...

{
  ...
  *param_1 = (char)uVar2;
  ...
  uVar1 = psa_key_derivation_start_hmac
                    (local_1d8,uVar4,*(undefined8 *)(param_1 + 8),*(undefined8 *)(param_1 + 0x10));
  uVar6 = (ulong)uVar1;
  if (uVar1 == 0) {
    if (param_1[1] == '\x01') {
      uVar1 = psa_mac_update(local_1d8,*(undefined8 *)(param_1 + 0x28),
                             *(undefined8 *)(param_1 + 0x30));
      uVar6 = (ulong)uVar1;
      if (uVar1 != 0) goto joined_r0x00106c26;
      uVar1 = psa_mac_update(local_1d8,*(undefined8 *)(param_1 + 0x18),
    ...
    if (uVar1 == 0) {
      ...
      if (local_1e0 == uVar2) {
        if (uVar1 == 0) {
          uVar4 = psa_key_derivation_start_hmac
                            (local_1d8,uVar4,*(undefined8 *)(param_1 + 8),
          ...
          if (uVar4 == 0) {
            ...
            uVar6 = (ulong)uVar4;
            if (uVar4 == 0) {
              uVar4 = psa_mac_update(local_1d8,*(undefined8 *)(param_1 + 0x28),
                                     *(undefined8 *)(param_1 + 0x30));
              uVar6 = (ulong)uVar4;
              if (uVar4 == 0) {
                uVar4 = psa_mac_update(local_1d8,*(undefined8 *)(param_1 + 0x18),
                                       *(undefined8 *)(param_1 + 0x20));
                uVar6 = (ulong)uVar4;
                if (uVar4 == 0) {
...
int psa_key_derivation_input_internal
              (uint *param_1,ushort param_2,short param_3,char *param_4,ulong param_5)
...
LAB_00106dbd:
        ...
        if (((uVar14 & 0xfffffb00) == 0x8000100) || (uVar9 == 0x8000400)) {
          if (param_2 == 0x202) {
            ...
            if (uVar9 != 0x8000500) {
              ...
              iVar4 = psa_key_derivation_start_hmac
                                (param_1 + 0x2a,uVar14 & 0xff | 0x2000000,param_4,param_5);
              if (iVar4 == 0) {
                iVar4 = 0;
            ...
            if ((param_2 == 0x203) && (uVar9 != 0x8000400)) {
              ...
              if (((uVar9 != 0x8000500) || (bVar2 != 0)) &&
                 ((bVar2 != 3 && ((*(byte *)((long)param_1 + 0x22) & 4) == 0)))) {
    ...
    if (param_2 != 0x101) {
      if ((param_2 != 0x102) || ((param_3 != 0x1200 && param_3 != 0x1203 && (param_3 != 0))))
      goto LAB_00106f40;
      goto LAB_00106df6;
    }
...
LAB_001072a8:
      ...
      *(byte *)((long)param_1 + 0x22) = *(byte *)((long)param_1 + 0x22) & 0xfc | 1;
LAB_00107136:
      iVar4 = psa_mac_update(param_1 + 0x2a,param_4,local_48);
      if (iVar4 == 0) {
          ...
          *(ushort *)((long)param_1 + 0x21) = *(ushort *)((long)param_1 + 0x21) & 0xfc00 | 0x200;
          if (uVar9 == 0x8000400) {
            ...
            if (uVar14 < 8) {
              if ((uVar12 & 4) == 0) {
                if ((uVar14 != 0) &&
                   (*(undefined1 *)((long)param_1 + 0x23) = *(undefined1 *)((long)param_1 + 99),
                   (uVar12 & 2) != 0)) {
                  *(undefined2 *)((long)param_1 + uVar11 + 0x21) =
                       *(undefined2 *)((long)param_1 + uVar11 + 0x61);
                }
              }
              else {
                *(undefined4 *)((long)param_1 + 0x23) = *(undefined4 *)((long)param_1 + 99);
                *(undefined4 *)((long)param_1 + uVar11 + 0x1f) =
                     *(undefined4 *)((long)param_1 + uVar11 + 0x5f);
              }
            }
            else {
              *(undefined8 *)((long)param_1 + 0x23) = *(undefined8 *)((long)param_1 + 99);
              *(undefined8 *)((long)param_1 + (uVar12 & 0xffffffff) + 0x1b) =
                   *(undefined8 *)((long)param_1 + (uVar12 & 0xffffffff) + 0x5b);
              ...
              if (7 < uVar14) {
                ...
                do {
                  uVar9 = (int)uVar11 + 8;
                  *(undefined8 *)(uVar12 + uVar11) =
                       *(undefined8 *)((((long)param_1 + 99) - lVar7) + uVar11);
                  uVar11 = (ulong)uVar9;
                } while (uVar9 < uVar14);
              }
            }
...
LAB_00106e1a:
        if (uVar9 == 0x8000200) {
LAB_00107314:
          iVar4 = psa_tls12_prf_input(param_1 + 4,param_2,param_4,param_5);
          goto LAB_00107326;
        }
        if (uVar9 == 0x8000300) {
...
int psa_key_derivation_input_bytes
              (undefined8 param_1,undefined2 param_2,undefined8 param_3,undefined8 param_4)
  ...
  if (iVar2 == 0) {
    ...
    if (iVar2 == 0) {
      if (*(uint *)(local_38 + 2) >> 8 == 0) {
        ...
        iVar2 = psa_key_derivation_input_internal
                          (param_1,param_2,*local_38,*(undefined8 *)(local_38 + 0x14),
...
int psa_key_derivation_key_agreement
              (uint *param_1,short param_2,undefined4 param_3,undefined8 param_4,undefined8 param_5)

{
  ...
  if ((iVar4 != 0) ||
     (iVar4 = psa_get_and_lock_key_slot_with_policy_part_0(&local_a8,0x4000,uVar1), lVar2 = local_a8
     , iVar4 != 0)) goto LAB_00107881;
  ...
  if (iVar4 == 0) {
    ...
    if ((*param_1 & 0xf6000000) == 0) {
      if ((*(uint *)(lVar2 + 4) >> 8 != 0) || ((*param_1 & 0xf6ff0000 | 0x9000000) != 0x9020000))
      goto LAB_001079d0;
      iVar4 = mbedtls_psa_key_agreement_ecdh
                        (lVar2,*(undefined8 *)(lVar2 + 0x28),*(undefined8 *)(lVar2 + 0x30),0x9020000
                         ,local_98,param_5,local_88,0x42,&local_a0);
      if (iVar4 == 0) {
...
int psa_mac_compute(undefined4 param_1,undefined4 param_2,undefined8 param_3,undefined8 param_4,
                   undefined8 param_5,size_t param_6,undefined8 param_7)
...
int psa_sign_message(undefined4 param_1,undefined4 param_2,undefined8 param_3,undefined8 param_4,
                    undefined8 param_5,size_t param_6,undefined8 *param_7)
...
int psa_sign_hash(undefined4 param_1,undefined4 param_2,undefined8 param_3,undefined8 param_4,
                 undefined8 param_5,size_t param_6,undefined8 *param_7)
...
ulong psa_asymmetric_encrypt
                (undefined8 param_1,uint param_2,undefined8 param_3,undefined8 param_4,
                undefined8 param_5,long param_6,undefined8 param_7,size_t param_8,
                undefined8 *param_9)
    ...
    if (uVar3 == 0) {
      ...
      if (uVar3 == 0) {
        ...
        if (*(uint *)(puVar6 + 2) >> 8 == 0) {
          uVar3 = mbedtls_psa_asymmetric_encrypt
                            (puVar6,*(undefined8 *)(puVar6 + 0x14),*(undefined8 *)(puVar6 + 0x18),
                             param_2,uVar1,param_4,uVar7,param_6,pvVar5,param_8,param_9);
          puVar6 = local_80;
        }
        else {
          uVar3 = 0xffffff79;
...
LAB_00107f00:
  uVar2 = psa_unregister_read_under_mutex(puVar6);
  ...
  if (((int)uVar4 == 0) && (uVar4 = (ulong)uVar2, uVar3 != 0)) {
    uVar4 = (ulong)uVar3;
  }
LAB_00107f3d:
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
  ...
  if ((~*local_80 & 0x7000) == 0) {
    ...
    if (uVar3 == 0) {
      ...
      if (uVar3 == 0) {
        ...
        if (*(uint *)(puVar6 + 2) >> 8 == 0) {
          uVar3 = mbedtls_psa_asymmetric_decrypt
                            (puVar6,*(undefined8 *)(puVar6 + 0x14),*(undefined8 *)(puVar6 + 0x18),
                             param_2,uVar1,param_4,uVar7,param_6,pvVar5,param_8,param_9);
          puVar6 = local_80;
        }
...
int psa_cipher_update(int *param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
                     size_t param_5,undefined8 param_6)
...
LAB_00108455:
    ...
    if (iVar2 == 1) {
      ...
      if ((iVar1 == 0) || (iVar2 = *param_1, iVar2 == 0)) goto LAB_00108478;
      goto LAB_00108455;
    }
    iVar1 = -0x87;
  }
  ...
  *param_1 = 0;
LAB_00108478:
  mbedtls_zeroize_and_free(uVar4,local_60);
  iVar2 = psa_crypto_local_output_free(local_58);
  if (iVar2 == 0) {
    iVar2 = iVar1;
  }
...
int psa_cipher_encrypt(undefined8 param_1,uint param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  if ((param_2 & 0x7f000000) == 0x4000000) {
    ...
    if ((iVar2 == 0) &&
       (iVar2 = psa_get_and_lock_key_slot_with_policy_part_0(&local_90,0x100,param_2),
       puVar13 = local_90, iVar2 == 0)) {
      uVar1 = *local_90;
      if ((((uVar1 & 0x7000) == 0x2000) && ((uVar1 & 0x700) != 0)) &&
         (((((param_2 & 0xfffffeff) == 0x4c01000 || (param_2 == 0x4c01200)) ||
           (param_2 == 0x440ff00)) || ((param_2 & 0xfffffeff) == 0x4404000)))) {
...
LAB_00108944:
        if (*(uint *)(puVar13 + 2) >> 8 == 0) {
          iVar2 = mbedtls_psa_cipher_encrypt
                            (puVar13,*(undefined8 *)(puVar13 + 0x14),*(undefined8 *)(puVar13 + 0x18)
                             ,param_2,local_58,uVar11,uVar8,param_4,puVar6,uVar7,param_7);
                ...
                if ((uVar11 & 4) == 0) {
                  if (uVar10 != 0) {
                    *(undefined1 *)puVar5 = (undefined1)local_58[0];
                    if ((uVar11 & 2) != 0) {
                      *(undefined2 *)((long)puVar5 + (uVar11 - 2)) =
                           *(undefined2 *)((long)local_58 + (uVar11 - 2));
                    }
                  }
                }
                else {
                  *puVar5 = (undefined4)local_58[0];
                  *(undefined4 *)((long)puVar5 + (uVar11 - 4)) =
                       *(undefined4 *)((long)local_58 + (uVar11 - 4));
                }
              }
              else {
                *(undefined8 *)((long)puVar5 + (uVar11 - 8)) =
                     *(undefined8 *)((long)&uStack_60 + uVar11);
                if (7 < uVar10 - 1) {
                  uVar4 = 0;
                  do {
                    uVar7 = (ulong)uVar4;
...
int psa_cipher_decrypt(undefined8 param_1,uint param_2,undefined8 param_3,ulong param_4,
                      undefined8 param_5,size_t param_6,undefined8 *param_7)

{
  ...
  if ((param_2 & 0x7f000000) == 0x4000000) {
    ...
    if ((iVar3 == 0) &&
       (iVar3 = psa_get_and_lock_key_slot_with_policy_part_0(&local_70,0x200,param_2),
       puVar2 = local_70, iVar3 == 0)) {
      uVar1 = *local_70;
      if ((((uVar1 & 0x7000) == 0x2000) && ((uVar1 & 0x700) != 0)) &&
         (((param_2 & 0xfffffeff) == 0x4c01000 ||
          (((param_2 == 0x4c01200 || (param_2 == 0x440ff00)) ||
           ((param_2 & 0xfffffeff) == 0x4404000)))))) {
...
LAB_00108c56:
      ...
      if (iVar3 == 0) {
        ...
        if (*(uint *)(puVar2 + 2) >> 8 == 0) {
          iVar3 = mbedtls_psa_cipher_decrypt
                            (puVar2,*(undefined8 *)(puVar2 + 0x14),*(undefined8 *)(puVar2 + 0x18),
                             param_2,uVar8,param_4,pvVar6,param_6,param_7);
          iVar4 = psa_unregister_read_under_mutex(local_70);
          uVar7 = local_60;
          if ((iVar3 == 0) && (iVar3 = iVar4, iVar4 == 0)) goto LAB_00108b22;
        }
        else {
...
LAB_00108b1b:
  ...
  *param_7 = 0;
LAB_00108b22:
  mbedtls_zeroize_and_free(uVar8,uVar7);
...
int psa_aead_encrypt(uint param_1,ulong param_2,undefined8 param_3,long param_4,undefined8 param_5,
                    undefined8 param_6,undefined8 param_7,undefined8 param_8,undefined8 param_9,
                    size_t param_10,undefined8 *param_11)
...
LAB_001090a5:
          if (*(uint *)(local_90 + 4) >> 8 == 0) {
            iVar4 = mbedtls_psa_aead_encrypt
                              (local_90,*(undefined8 *)(local_90 + 0x28),
                               *(undefined8 *)(local_90 + 0x30),param_2 & 0xffffffff,uVar1,param_4,
                               uVar7,param_6,uVar2,param_8,__s,param_10,param_11);
          }
          else {
            iVar4 = -0x87;
          }
...
LAB_00108f07:
  mbedtls_zeroize_and_free(uVar1,local_80);
...
int psa_aead_decrypt(uint param_1,ulong param_2,undefined8 param_3,long param_4,undefined8 param_5,
                    undefined8 param_6,undefined8 param_7,undefined8 param_8,undefined8 param_9,
                    size_t param_10,undefined8 *param_11)
...
LAB_00109465:
          if (*(uint *)(local_90 + 4) >> 8 == 0) {
            iVar4 = mbedtls_psa_aead_decrypt
                              (local_90,*(undefined8 *)(local_90 + 0x28),
                               *(undefined8 *)(local_90 + 0x30),param_2 & 0xffffffff,uVar1,param_4,
                               uVar7,param_6,uVar2,param_8,__s,param_10,param_11);
          }
...
int psa_aead_generate_nonce(int *param_1,undefined8 param_2,size_t param_3,ulong *param_4)
...
LAB_001095c0:
      iVar2 = psa_generate_random_internal(&local_4d,uVar8);
...
LAB_00109625:
  psa_aead_abort(param_1);
LAB_0010962d:
  iVar3 = psa_crypto_local_output_free(local_68);
  if (iVar3 == 0) {
    iVar3 = iVar2;
  }
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
...
int psa_aead_update(int *param_1,undefined8 param_2,ulong param_3,undefined8 param_4,size_t param_5,
                   undefined8 *param_6)
...
int psa_aead_finish(int *param_1,undefined8 param_2,size_t param_3,undefined8 *param_4,
                   undefined8 param_5,size_t param_6,size_t *param_7)
...
int psa_aead_verify(int *param_1,undefined8 param_2,size_t param_3,undefined8 *param_4,
                   undefined8 param_5,long param_6)
...
LAB_00109cfd:
      mbedtls_platform_zeroize(local_58,0x10,uVar5);
      goto LAB_00109c2d;
    }
  }
  iVar2 = -0x87;
...
LAB_00109fca:
      if ((1 < (*(byte *)((long)param_1 + 0x22) & 3)) &&
         (((*(byte *)((long)param_1 + 0x22) & 4) != 0 || (uVar4 == 0x8000400)))) {
        ...
        if (param_3 != 0) {
          ...
          while( true ) {
            ...
            if (uVar5 < 8) {
              if ((uVar6 & 4) == 0) {
                if ((uVar5 != 0) &&
                   (*(undefined1 *)puVar15 = *(undefined1 *)puVar13, (uVar6 & 2) != 0)) {
                  *(undefined2 *)((long)puVar15 + (uVar9 - 2)) =
                       *(undefined2 *)((long)puVar13 + (uVar9 - 2));
                }
              }
              else {
                *(undefined4 *)puVar15 = *(undefined4 *)puVar13;
                *(undefined4 *)((long)puVar15 + (uVar9 - 4)) =
                     *(undefined4 *)((long)puVar13 + (uVar9 - 4));
              }
            }
            else {
              *puVar15 = *puVar13;
              *(undefined8 *)((long)puVar15 + ((uVar6 & 0xffffffff) - 8)) =
                   *(undefined8 *)((long)puVar13 + ((uVar6 & 0xffffffff) - 8));
            ...
            *(char *)((long)param_1 + 0x21) = *(char *)((long)param_1 + 0x21) + '\x01';
            ...
            if ((uVar4 != 0) ||
               ((((*(char *)((long)param_1 + 0x21) != '\x01' &&
                  (uVar4 = psa_mac_update(puVar1,lVar8,cVar2), uVar4 != 0)) ||
                 (uVar4 = psa_mac_update(puVar1,*(undefined8 *)(param_1 + 4),
                                         *(undefined8 *)(param_1 + 6)), uVar4 != 0)) ||
                ((uVar4 = psa_mac_update(puVar1,(long)param_1 + 0x21,1), uVar4 != 0 ||
                 (uVar4 = psa_mac_sign_finish(puVar1,lVar8,0x40,&local_60), uVar4 != 0))))))
            goto LAB_0010a158;
          }
          uVar4 = 0xffffff77;
LAB_0010a158:
            ...
            if (iVar4 == 0) {
              ...
              if (pbVar5 == (byte *)0x0) {
                ...
                while (local_134 != 0) {
                  ...
                  if ((iVar4 != 0) ||
                     (iVar4 = mbedtls_mpi_lt_mpi_ct(local_118,local_128,&local_134), iVar3 = iVar4,
                     iVar4 != 0)) goto LAB_0010a631;
                }
                iVar4 = mbedtls_mpi_add_int(local_128,local_128,1);
                if ((iVar4 == 0) &&
                   (iVar4 = mbedtls_mpi_write_binary(local_128,pbVar5,local_160), iVar4 == 0))
                goto LAB_0010a63b;
              }
            }
          }
...
LAB_0010a631:
        iVar3 = mbedtls_to_psa_error(iVar4);
LAB_0010a63b:
        if (iVar3 == 0) {
          mbedtls_mpi_free(local_128);
          mbedtls_mpi_free(local_118);
LAB_0010a410:
          param_1[1] = (ushort)local_140;
          if ((*(uint *)(param_1 + 2) >> 8 == 0) ||
             (iVar3 = psa_driver_wrapper_get_key_buffer_size(param_1,&local_130), iVar3 == 0)) {
            uVar2 = local_130;
            if (*(long *)(param_1 + 0x14) == 0) {
              ...
              *(ulong *)(param_1 + 0x18) = uVar2;
              if (*(uint *)(param_1 + 2) >> 8 == 0) {
                iVar3 = psa_import_key_into_slot
                                  (param_1,pbVar5,__size,pvVar6,uVar2,param_1 + 0x18,&local_140);
              }
              else {
                iVar3 = -0x87;
              }
...
LAB_0010a657:
          mbedtls_zeroize_and_free(pbVar5,local_160);
          mbedtls_mpi_free(local_128);
          mbedtls_mpi_free(local_118);
          pbVar5 = (byte *)0x0;
        }
...
LAB_0010a498:
      mbedtls_zeroize_and_free(pbVar5,__size);
      goto LAB_0010a4a3;
    }
    if (((uVar1 & 0x7000) - 0x1000 & 0xe000) != 0) {
      iVar3 = -0x86;
...
int psa_key_derivation_output_key_custom
...

{
  ...
  *param_6 = 0;
  ...
  if (((sVar1 == 0) || (*param_3 != 0)) || (param_5 != 0)) {
    ...
    if (((iVar3 == 0) &&
        (iVar4 = psa_generate_derived_key_internal(local_40[0],*(undefined2 *)(param_1 + 2),param_2)
        , lVar2 = local_40[0], iVar3 = iVar4, iVar4 == 0)) &&
       ((*(char *)(local_40[0] + 4) == '\0' ||
        (iVar3 = psa_save_persistent_key
                           (local_40[0],*(undefined8 *)(local_40[0] + 0x28),
                            *(undefined8 *)(local_40[0] + 0x30)), iVar3 == 0)))) {
      *param_6 = *(undefined4 *)(lVar2 + 0x14);
      if (*(int *)(lVar2 + 0x18) == 1) {
...
LAB_0010a8c6:
  if (local_40[2] != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    __stack_chk_fail();
  }
  return iVar4;
...
void psa_key_derivation_output_key_ext(void)
  ...
  if (param_6 == 0) {
    if ((param_1 & 0x7f000000) == 0x9000000) {
      ...
      if (uVar2 == 0) {
        ...
        pvVar4 = (void *)0x0;
LAB_0010aa62:
        uVar2 = psa_get_and_lock_key_slot_with_policy_part_0(&local_70,0x4000,param_1);
        puVar6 = local_70;
        if (uVar2 == 0) {
          if (*(uint *)(local_70 + 2) >> 8 == 0) {
            if ((((uint)(byte)((ushort)*local_70 >> 8) * 0x100 - 0x7100 & 0xfffffe00) == 0) &&
               (param_6 < (ushort)local_70[1] + 7 >> 3)) {
              uVar7 = 0;
              uVar8 = 0;
              uVar2 = 0xffffff76;
            }
              ...
              if (uVar2 == 0) {
                if ((param_1 & 0xff00ffff) == 0x9000000) {
                  if (param_1 == 0x9020000) {
                    uVar2 = mbedtls_psa_key_agreement_ecdh
                                      (puVar6,*(undefined8 *)(puVar6 + 0x14),
                                       *(undefined8 *)(puVar6 + 0x18),0x9020000,local_68,param_4,
                                       pvVar4,param_6,param_7);
...
LAB_0010ab59:
      psa_generate_random_internal(pvVar4,param_6);
      *param_7 = param_6;
      puVar6 = local_70;
      goto LAB_0010ab6c;
    }
  ...
  *param_7 = 0;
LAB_0010ab6c:
  uVar3 = psa_unregister_read_under_mutex(puVar6);
  mbedtls_zeroize_and_free(uVar7,uVar8);
  uVar5 = psa_crypto_local_output_free(local_58);
  if (((int)uVar5 == 0) && (uVar5 = (ulong)uVar3, uVar2 != 0)) {
    uVar5 = (ulong)uVar2;
  }
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */

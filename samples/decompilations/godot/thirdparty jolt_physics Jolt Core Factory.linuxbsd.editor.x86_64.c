...
void JPH::
     HashTable<unsigned_int,std::pair<unsigned_int,JPH::RTTI_const*>,JPH::UnorderedMapDetail<unsigned_int,JPH::RTTI_const*>,JPH::Hash<unsigned_int>,std::equal_to<unsigned_int>>
     ::rehash(uint param_1)
      ...
      if (*(char *)(lVar13 + lVar11) == '\x7f') {
        ...
        do {
          ...
          while( true ) {
            ...
            uVar8 = (ushort)(SUB161(auVar28 >> 7,0) & 1) |
            ...
            *pcVar15 = cVar23;
            if (cVar5 == '\0') {
              *(char *)(plVar18[1] +
                       (ulong)((*(int *)((long)plVar18 + 0x14) - 1U & uVar10 - 0xf) + 0xf)) = cVar23
              ;
...
void JPH::
     HashTable<std::basic_string_view<char,std::char_traits<char>>,std::pair<std::basic_string_view<char,std::char_traits<char>>,JPH::RTTI_const*>,JPH::UnorderedMapDetail<std::basic_string_view<char,std::char_traits<char>>,JPH::RTTI_const*>,JPH::Hash<std::basic_string_view<char,std::char_traits<char>>>,std::equal_to<std::basic_string_view<char,std::char_traits<char>>>>
     ::rehash(uint param_1)
      ...
      if (*(char *)(lVar14 + lVar10) == '\x7f') {
        ...
        do {
          ...
          while( true ) {
            ...
            uVar6 = (ushort)(SUB161(auVar28 >> 7,0) & 1) |
                    (ushort)(SUB161(auVar28 >> 0xf,0) & 1) << 1 |
                    (ushort)(SUB161(auVar28 >> 0x17,0) & 1) << 2 |
                    (ushort)(SUB161(auVar28 >> 0x1f,0) & 1) << 3 |
                    (ushort)(SUB161(auVar28 >> 0x27,0) & 1) << 4 |
            ...
            if (((uVar9 - uVar26 ^ (int)lVar10 - uVar26) & uVar17 & 0xfffffff0) == 0) {
              ...
              *(char *)(plVar18[1] + (ulong)((*(int *)((long)plVar18 + 0x14) - 1U & uVar22) + 0xf))
                   = cVar23;
              uVar19 = (ulong)*(uint *)((long)plVar18 + 0x14);
              goto LAB_00100358;
            }
            ...
            *(char *)(lVar14 + uVar25) = cVar23;
            if (cVar3 == '\0') {
              *(char *)(plVar18[1] +
                       (ulong)((*(int *)((long)plVar18 + 0x14) - 1U & uVar9 - 0xf) + 0xf)) = cVar23;
              *(undefined1 *)(plVar18[1] + lVar10) = 0;
              *(undefined1 *)
               (plVar18[1] + (ulong)((*(int *)((long)plVar18 + 0x14) - 1U & uVar22) + 0xf)) = 0;
              lVar14 = *plVar18;
              uVar19 = (ulong)*(uint *)((long)plVar18 + 0x14);
              ...
              *puVar12 = *(undefined8 *)(lVar14 + lVar21);
              puVar12[1] = uVar4;
              *(undefined8 *)(lVar14 + 0x10 + uVar25 * 0x18) =
                   *(undefined8 *)(lVar14 + 0x10 + lVar21);
              goto LAB_00100358;
            }
            *(char *)(plVar18[1] +
                     (ulong)((*(int *)((long)plVar18 + 0x14) - 1U & uVar9 - 0xf) + 0xf)) = cVar23;
...
/* JPH::Factory::Find(char const*) */

size_t __thiscall JPH::Factory::Find(Factory *this,char *param_1)
    ...
    while( true ) {
      ...
      if (uVar7 != 0) {
        ...
        do {
          ...
          if ((__n == *psVar2) &&
             ((__n == 0 || (iVar27 = memcmp((void *)psVar2[1],param_1,__n), iVar27 == 0)))) {
            if (uVar3 == uVar30) {
              return 0;
            }
            return psVar2[2];
      ...
      if ((((((((((((((((auVar33 >> 7 & (undefined1  [16])0x1) != (undefined1  [16])0x0 ||
          ...
          (auVar33 >> 0x77 & (undefined1  [16])0x1) != (undefined1  [16])0x0) || bVar25 == 0) break;
...
/* JPH::Factory::CreateObject(char const*) */

undefined8 __thiscall JPH::Factory::CreateObject(Factory *this,char *param_1)
...
/* JPH::Factory::Find(unsigned int) */

undefined8 __thiscall JPH::Factory::Find(Factory *this,uint param_1)

{
  ...
  if (*(int *)(this + 0x30) != 0) {
    ...
    while( true ) {
      ...
      auVar15[1] = -(bVar13 == pbVar1[1]);
      auVar15[2] = -(bVar13 == pbVar1[2]);
      auVar15[3] = -(bVar13 == pbVar1[3]);
      auVar15[4] = -(bVar13 == pbVar1[4]);
      auVar15[5] = -(bVar13 == pbVar1[5]);
      auVar15[6] = -(bVar13 == pbVar1[6]);
      auVar15[7] = -(bVar13 == pbVar1[7]);
      auVar15[8] = -(bVar13 == pbVar1[8]);
      auVar15[9] = -(bVar13 == pbVar1[9]);
      auVar15[10] = -(bVar13 == pbVar1[10]);
      auVar15[0xb] = -(bVar13 == pbVar1[0xb]);
      auVar15[0xc] = -(bVar13 == pbVar1[0xc]);
      auVar15[0xd] = -(bVar13 == pbVar1[0xd]);
      auVar15[0xe] = -(bVar13 == pbVar1[0xe]);
      ...
      auVar14[0] = -(*pbVar1 == 0);
      auVar14[1] = -(pbVar1[1] == 0);
      auVar14[2] = -(pbVar1[2] == 0);
      auVar14[3] = -(pbVar1[3] == 0);
      auVar14[4] = -(pbVar1[4] == 0);
      auVar14[5] = -(pbVar1[5] == 0);
      auVar14[6] = -(pbVar1[6] == 0);
      auVar14[7] = -(pbVar1[7] == 0);
      auVar14[8] = -(pbVar1[8] == 0);
      auVar14[9] = -(pbVar1[9] == 0);
      auVar14[10] = -(pbVar1[10] == 0);
      auVar14[0xb] = -(pbVar1[0xb] == 0);
      auVar14[0xc] = -(pbVar1[0xc] == 0);
      auVar14[0xd] = -(pbVar1[0xd] == 0);
      auVar14[0xe] = -(pbVar1[0xe] == 0);
      auVar14[0xf] = -(bVar6 == 0);
      if ((((((((((((((((auVar14 >> 7 & (undefined1  [16])0x1) != (undefined1  [16])0x0 ||
          ...
          (auVar14 >> 0x77 & (undefined1  [16])0x1) != (undefined1  [16])0x0) || bVar6 == 0) break;
      uVar12 = uVar12 + 0x10;
    }
  }
  return 0;
...
void __thiscall JPH::Factory::Clear(Factory *this)
...
/* JPH::Factory::GetAllClasses() const */

void JPH::Factory::GetAllClasses(void)
...
/* JPH::Factory::Register(JPH::RTTI const*) */

undefined8 __thiscall JPH::Factory::Register(Factory *this,RTTI *param_1)

{
  ...
  if (lVar6 == 0) {
    local_48 = strlen(__s);
    pcStack_40 = __s;
    bVar2 = HashTable<std::basic_string_view<char,std::char_traits<char>>,std::pair<std::basic_string_view<char,std::char_traits<char>>,JPH::RTTI_const*>,JPH::UnorderedMapDetail<std::basic_string_view<char,std::char_traits<char>>,JPH::RTTI_const*>,JPH::Hash<std::basic_string_view<char,std::char_traits<char>>>,std::equal_to<std::basic_string_view<char,std::char_traits<char>>>>
            ::InsertKey<false>((HashTable<std::basic_string_view<char,std::char_traits<char>>,std::pair<std::basic_string_view<char,std::char_traits<char>>,JPH::RTTI_const*>,JPH::UnorderedMapDetail<std::basic_string_view<char,std::char_traits<char>>,JPH::RTTI_const*>,JPH::Hash<std::basic_string_view<char,std::char_traits<char>>>,std::equal_to<std::basic_string_view<char,std::char_traits<char>>>>
                                *)this,(basic_string_view *)&local_48,&local_4c);
    if (bVar2) {
    ...
    local_4c = uVar4;
    bVar2 = HashTable<unsigned_int,std::pair<unsigned_int,JPH::RTTI_const*>,JPH::UnorderedMapDetail<unsigned_int,JPH::RTTI_const*>,JPH::Hash<unsigned_int>,std::equal_to<unsigned_int>>
            ::InsertKey<false>((HashTable<unsigned_int,std::pair<unsigned_int,JPH::RTTI_const*>,JPH::UnorderedMapDetail<unsigned_int,JPH::RTTI_const*>,JPH::Hash<unsigned_int>,std::equal_to<unsigned_int>>
                                *)(this + 0x20),&local_4c,(uint *)&local_48);
    if (!bVar2) {
LAB_00100b10:
      uVar7 = 0;
      goto LAB_00100a1b;
...
/* JPH::Factory::Register(JPH::RTTI const**, unsigned int) */

undefined8 __thiscall JPH::Factory::Register(Factory *this,RTTI **param_1,uint param_2)
...
/* JPH::HashTable<std::basic_string_view<char, std::char_traits<char> >,
   ...
   JPH::UnorderedMapDetail<std::basic_string_view<char, std::char_traits<char> >, JPH::RTTI const*>,
   JPH::Hash<std::basic_string_view<char, std::char_traits<char> > >,
   std::equal_to<std::basic_string_view<char, std::char_traits<char> > > >::GrowTable() */
...
LAB_00100e6e:
                    /* WARNING: Could not recover jumptable at 0x00100e7f. Too many branches */
...
HashTable<std::basic_string_view<char,std::char_traits<char>>,std::pair<std::basic_string_view<char,std::char_traits<char>>,JPH::RTTI_const*>,JPH::UnorderedMapDetail<std::basic_string_view<char,std::char_traits<char>>,JPH::RTTI_const*>,JPH::Hash<std::basic_string_view<char,std::char_traits<char>>>,std::equal_to<std::basic_string_view<char,std::char_traits<char>>>>
::InsertKey<false>(HashTable<std::basic_string_view<char,std::char_traits<char>>,std::pair<std::basic_string_view<char,std::char_traits<char>>,JPH::RTTI_const*>,JPH::UnorderedMapDetail<std::basic_string_view<char,std::char_traits<char>>,JPH::RTTI_const*>,JPH::Hash<std::basic_string_view<char,std::char_traits<char>>>,std::equal_to<std::basic_string_view<char,std::char_traits<char>>>>
                   *this,basic_string_view *param_1,uint *param_2)

{
  ...
  while( true ) {
    ...
    if (uVar6 != 0) {
      ...
      do {
        ...
        if ((*puVar2 == __n) &&
           ((__n == 0 || (iVar27 = memcmp((void *)puVar2[1],__s2,__n), iVar27 == 0)))) {
          bVar25 = false;
          goto LAB_0010103d;
        }
        uVar28 = uVar28 + 1;
    ...
    if (local_40 == 0xffffffff) {
      ...
      iVar7 = 0;
      uVar30 = (uint)(ushort)((ushort)(SUB161(auVar35 >> 7,0) & 1) |
  ...
  *(byte *)(lVar3 + (ulong)uVar28) = bVar31;
  bVar25 = true;
  *(byte *)(*(long *)(this + 8) + (ulong)((*(int *)(this + 0x14) - 1U & uVar28 - 0xf) + 0xf)) =
       bVar31;
  *(int *)(this + 0x10) = *(int *)(this + 0x10) + 1;
LAB_0010103d:
  *param_2 = uVar28;
...
JPH::
HashTable<unsigned_int,std::pair<unsigned_int,JPH::RTTI_const*>,JPH::UnorderedMapDetail<unsigned_int,JPH::RTTI_const*>,JPH::Hash<unsigned_int>,std::equal_to<unsigned_int>>
::GrowTable(HashTable<unsigned_int,std::pair<unsigned_int,JPH::RTTI_const*>,JPH::UnorderedMapDetail<unsigned_int,JPH::RTTI_const*>,JPH::Hash<unsigned_int>,std::equal_to<unsigned_int>>
            *this)
...
void JPH::Factory::_GLOBAL__sub_I_sInstance(void)

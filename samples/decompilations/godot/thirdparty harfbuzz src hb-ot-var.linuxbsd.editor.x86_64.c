...
LAB_00101c04:
  ...
  if ((__ptr != (float *)0x0) && (uVar12 != 0)) {
    pfVar4 = __ptr + 1;
    pfVar11 = __ptr;
    if (((int)(pfVar4 + (uVar12 - 1)) - (int)__ptr & 4U) == 0) goto LAB_00101de0;
    *__ptr = _LC5;
    for (pfVar11 = pfVar4; pfVar4 + (uVar12 - 1) != pfVar11; pfVar11 = pfVar11 + 2) {
LAB_00101de0:
      *pfVar11 = fVar35;
      pfVar11[1] = fVar35;
    }
                      ...
                      if ((uVar20 != 0) && (iVar13 != iVar25)) {
                        if (iVar13 != 0) {
                          ...
                          if (((iVar25 < iVar17) || (iVar22 < iVar25)) ||
                             (((short)uVar20 < 0 && (0 < (short)uVar27)))) goto LAB_0010265c;
...
LAB_0010267b:
                    ...
                    else if (uVar20 != 0) goto LAB_0010267b;
LAB_0010265c:
                    uVar26 = uVar26 + 1;
                    paVar10 = paVar10 + 6;
                  } while (uVar21 != uVar26);
                  if (__ptr != (float *)0x0) goto LAB_001026d8;
                }
              }
              else {
                pfVar4 = __ptr + uVar20;
...
LAB_00102696:
          ...
          if (uVar2 < uVar8) goto LAB_00102010;
        }
        else {
                      ...
                      if ((uint)uVar3 < param_2) {
                        ...
                        if ((uVar6 != 0) && (iVar13 != iVar25)) {
                          if (iVar13 != 0) {
                            ...
                            if (((iVar25 < iVar17) || (iVar22 < iVar25)) ||
                               (((short)uVar6 < 0 && (0 < (short)uVar21)))) goto LAB_0010218c;
                            if ((iVar17 < iVar13) && (iVar13 < iVar22)) {
                              if (iVar13 < iVar25) {
                                fVar34 = (float)(iVar13 - iVar17) / (float)(iVar25 - iVar17);
                              }
...
LAB_001021ab:
                      ...
                      else if (uVar6 != 0) goto LAB_001021ab;
LAB_0010218c:
                      uVar3 = uVar3 + 1;
                      paVar10 = paVar10 + 6;
                    } while (uVar20 != uVar3);
                    if (__ptr != (float *)0x0) goto LAB_001021fe;
                  }
                }
                else {
                  pfVar4 = __ptr + uVar6;
                    ...
                    if ((uint)uVar3 < param_2) {
                      ...
                      if ((uVar6 != 0) && (iVar13 != iVar25)) {
                        if (iVar13 != 0) {
                          ...
                          iVar22 = (int)(short)uVar21;
                          if (((iVar25 < iVar17) || (iVar22 < iVar25)) ||
                             (((short)uVar6 < 0 && (0 < (short)uVar21)))) goto LAB_001023a4;
                          if ((iVar17 < iVar13) && (iVar13 < iVar22)) {
                            if (iVar13 < iVar25) {
                              fVar34 = (float)(iVar13 - iVar17) / (float)(iVar25 - iVar17);
                            }
...
LAB_001023c3:
                    ...
                    else if (uVar6 != 0) goto LAB_001023c3;
LAB_001023a4:
                    uVar3 = uVar3 + 1;
                    paVar10 = paVar10 + 6;
                  } while (uVar20 != uVar3);
                  if (__ptr != (float *)0x0) goto LAB_0010240e;
                }
              }
              else {
                pfVar4 = __ptr + uVar6;
...

{
  ...
  while( true ) {
    ...
    if ((ulong)local_50 < 4) goto LAB_00102e03;
  ...
  if (uVar11 != 0) {
    ...
    do {
      ...
      if (((ulong)local_50 < (ulong)((long)paVar1 - (long)puVar2)) ||
         ((ulong)local_50 < (ulong)((long)paVar1 - (long)puVar2))) goto LAB_00102c6a;
      uVar3 = (uint)(ushort)(*(ushort *)paVar9 << 8 | *(ushort *)paVar9 >> 8);
      uVar6 = uVar3 * 4;
      if (((uint)((int)local_60._8_8_ - (int)paVar1) < uVar6) ||
         (local_4c = local_4c + uVar3 * -4, (int)local_4c < 1)) goto LAB_00102c6a;
      uVar10 = uVar10 + 1;
...
LAB_00102ccf:
  ...
  if (cVar4 == '\0') goto LAB_00102c6a;
  if (local_3c == 0) goto LAB_00102ccf;
  local_3c = 0;
...
LAB_00102e03:
  ...
  while( true ) {
    ...
    if (((uint)(local_60._8_4_ - (int)paVar9) < uVar6) ||
       (local_4c = local_4c + uVar3 * -4, (int)local_4c < 1)) goto LAB_00102e03;
    uVar10 = uVar10 + 1;
    this = this + (uVar6 + 2);
...
LAB_00102dcf:
    ...
    if (((ulong)local_50 < (ulong)((long)paVar9 - local_60._0_8_)) ||
       ((ulong)local_50 < (ulong)((long)paVar9 - local_60._0_8_))) goto LAB_00102e03;
  }
  uVar5 = *puVar2;
LAB_00102e36:
...
LAB_00102ce1:
  ...
  lVar8 = local_38;
  if (local_3c != 0) goto LAB_00102e03;
  hb_blob_destroy(local_38);
  local_38 = 0;
  local_50 = 0;
  local_60 = (undefined1  [16])0x0;
  if (cVar4 != '\0') goto LAB_00102cd9;
LAB_00102e08:
  hb_blob_destroy(lVar7);
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
    lVar8 = hb_blob_get_empty();

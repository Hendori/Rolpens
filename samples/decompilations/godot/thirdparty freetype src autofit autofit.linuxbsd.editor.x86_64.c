...

{
  ...
  bVar18 = 0;
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  plVar9 = (long *)ft_mem_qalloc(*(undefined8 *)(param_1 + 0xb8),
  ...
  for (uVar14 = (ulong)(((int)plVar9 - (int)(undefined8 *)((ulong)(plVar9 + 5) & 0xfffffffffffffff8)
                        ) + 0x2d8U >> 3); uVar14 != 0; uVar14 = uVar14 - 1) {
    *puVar15 = 0;
...
LAB_00103adb:
  iVar7 = FT_Select_Charmap(param_1,0x756e6963);
  if (iVar7 == 0) {
...
LAB_00103cbf:
  iVar7 = *(int *)(plVar9[0x61] + 0x18);
  if ((iVar7 != 0x3fff) && (uVar8 = *(uint *)(plVar9 + 1), uVar8 != 0)) {
    plVar13 = plVar9;
    do {
...
LAB_00105268:
  ...
  if (((*(code **)(lVar25 + 0x30) != (code *)0x0) &&
     ...
     , iVar14 = iVar15, iVar15 != 0)) goto LAB_00104e98;
  if ((uStack_3330 == 1) &&
...
LAB_00105986:
        if ((0 < local_3388) && (local_3388 != *(long *)(uVar4 + 0x2e8))) goto LAB_00105730;
      }
      else {
...
LAB_00106c53:
            ...
            while( true ) {
              ...
              if ((bVar26 & 4) == 0) break;
LAB_00106d02:
              if (uVar1 <= uVar24) goto LAB_00106558;
            }
          } while( true );
        }
      }
...
code_r0x001081a5:
  if (uVar9 == 0 && local_41c == 0) goto LAB_0010834b;
  plVar32 = local_1d8 + 1;
  uVar42 = 1;
  plVar30 = plVar32;
  plVar41 = plVar32;

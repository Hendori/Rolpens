...
void __thiscall
OpenXRDisplayRefreshRateExtension::~OpenXRDisplayRefreshRateExtension
          (OpenXRDisplayRefreshRateExtension *this)
...
/* OpenXRDisplayRefreshRateExtension::on_instance_destroyed() */

void __thiscall
OpenXRDisplayRefreshRateExtension::on_instance_destroyed(OpenXRDisplayRefreshRateExtension *this)

{
  this[8] = (OpenXRDisplayRefreshRateExtension)0x0;
  return;
}
...
/* OpenXRDisplayRefreshRateExtension::on_instance_created(XrInstance_T*) */

void OpenXRDisplayRefreshRateExtension::on_instance_created(XrInstance_T *param_1)

{
  ...
  iVar1 = OpenXRAPI::get_instance_proc_addr
                    (OpenXRAPI::singleton,(_func_void *)"xrEnumerateDisplayRefreshRatesFB");
  if (iVar1 < 0) {
    _err_print_error("on_instance_created",
                     "modules/openxr/extensions/openxr_fb_display_refresh_rate_extension.cpp",0x3a,
                     "Condition \"((get_instance_proc_addr_result) < 0)\" is true.",0,0);
    return;
  }
  iVar1 = OpenXRAPI::get_instance_proc_addr
                    (OpenXRAPI::singleton,(_func_void *)"xrGetDisplayRefreshRateFB");
  if (iVar1 < 0) {
    _err_print_error("on_instance_created",
                     "modules/openxr/extensions/openxr_fb_display_refresh_rate_extension.cpp",0x3b,
                     "Condition \"((get_instance_proc_addr_result) < 0)\" is true.",0,0);
    return;
  }
  iVar1 = OpenXRAPI::get_instance_proc_addr
                    (OpenXRAPI::singleton,(_func_void *)"xrRequestDisplayRefreshRateFB");
  if (-1 < iVar1) {
    return;
  }
  _err_print_error("on_instance_created",
                   "modules/openxr/extensions/openxr_fb_display_refresh_rate_extension.cpp",0x3c,
                   "Condition \"((get_instance_proc_addr_result) < 0)\" is true.",0,0);
  return;
}
...
/* OpenXRDisplayRefreshRateExtension::on_event_polled(XrEventDataBuffer const&) */

undefined8 __thiscall
OpenXRDisplayRefreshRateExtension::on_event_polled
          (OpenXRDisplayRefreshRateExtension *this,XrEventDataBuffer *param_1)

{
  if (*(int *)param_1 != 0x3b9c5488) {
    return 0;
  }
  if (*OpenXRAPI::singleton != 0) {
    OpenXRInterface::on_refresh_rate_changes(*(float *)(param_1 + 0x14));
    return 1;
  }
  return 1;
}
...
/* OpenXRDisplayRefreshRateExtension::get_singleton() */

undefined8 OpenXRDisplayRefreshRateExtension::get_singleton(void)
...
{
  this[8] = (OpenXRDisplayRefreshRateExtension)0x0;
  *(undefined ***)this = &PTR_get_requested_extensions_00101b30;
...
/* OpenXRDisplayRefreshRateExtension::get_requested_extensions() */

void OpenXRDisplayRefreshRateExtension::get_requested_extensions(void)

{
  ...
  *(undefined1 (*) [16])(in_RDI + 0x18) = (undefined1  [16])0x0;
  local_38 = "XR_FB_display_refresh_rate";
  local_40 = 0;
  local_30 = 0x1a;
...
/* OpenXRDisplayRefreshRateExtension::get_available_refresh_rates() const */

void OpenXRDisplayRefreshRateExtension::get_available_refresh_rates(void)

{
  ...
  Array::Array(in_RDI);
  if (*(char *)(in_RSI + 8) == '\0') goto LAB_00100307;
  local_64 = 0;
  if (*(code **)(in_RSI + 0x10) == (code *)0x0) {
    iVar2 = -0xc;
LAB_00100338:
    OpenXRAPI::get_error_string(&local_60,OpenXRAPI::singleton,iVar2);
    Variant::Variant((Variant *)local_58,"OpenXR: Failed to obtain refresh rates count [");
    print_line<String,char_const*>((Variant *)local_58,&local_60,&_LC17);
    ...
    iVar2 = (**(code **)(in_RSI + 0x10))(*(undefined8 *)(OpenXRAPI::singleton + 0xf8),0,&local_64,0)
    ;
    if (iVar2 < 0) goto LAB_00100338;
  }
  if (local_64 == 0) goto LAB_00100307;
  pvVar3 = (void *)Memory::alloc_static((ulong)local_64 << 2,false);
  if (pvVar3 == (void *)0x0) {
    OpenXRAPI::get_error_string(&local_60,OpenXRAPI::singleton,iVar2);
    Variant::Variant((Variant *)local_58,"OpenXR: Failed to obtain refresh rates memory buffer [");
    print_line<String,char_const*>((Variant *)local_58,&local_60,&_LC17);
    if (Variant::needs_deinit[local_58[0]] != '\0') {
      Variant::_clear_internal();
    }
...
LAB_00100480:
    ...
    iVar2 = (**(code **)(in_RSI + 0x10))
                      (*(undefined8 *)(OpenXRAPI::singleton + 0xf8),local_64,&local_64,pvVar3);
    if (iVar2 < 0) goto LAB_00100480;
    lVar4 = 0;
    if (local_64 != 0) {
      do {
        Variant::Variant((Variant *)local_58,*(float *)((long)pvVar3 + lVar4 * 4));
        Array::push_back((Variant *)in_RDI);
        if (Variant::needs_deinit[local_58[0]] != '\0') {
          Variant::_clear_internal();
        }
        lVar4 = lVar4 + 1;
      } while ((uint)lVar4 < local_64);
    }
  }
...
/* OpenXRDisplayRefreshRateExtension::set_refresh_rate(float) */

void OpenXRDisplayRefreshRateExtension::set_refresh_rate(float param_1)

{
  ...
  if (*(char *)(in_RDI + 8) != '\0') {
    if (*(code **)(in_RDI + 0x20) == (code *)0x0) {
      ...
      iVar3 = (**(code **)(in_RDI + 0x20))(*(undefined8 *)(OpenXRAPI::singleton + 0xf8));
      param_1 = extraout_XMM0_Da;
      if (-1 < iVar3) goto LAB_00100728;
    }
    OpenXRAPI::get_error_string(param_1,&local_50,OpenXRAPI::singleton,iVar3);
    Variant::Variant((Variant *)local_38,"OpenXR: Failed to set refresh rate [");
    local_40 = 0;
    plVar1 = (long *)(local_50 + -0x10);
    if (local_50 != 0) {
      do {
        lVar2 = *plVar1;
        if (lVar2 == 0) goto LAB_0010066d;
        LOCK();
        lVar4 = *plVar1;
        bVar5 = lVar2 == lVar4;
        if (bVar5) {
...
LAB_0010066d:
    stringify_variants<String,char_const*>((String *)&local_48,(Variant *)local_38,&local_40,&_LC17)
    ;
...
/* OpenXRDisplayRefreshRateExtension::get_refresh_rate() const */

void __thiscall
OpenXRDisplayRefreshRateExtension::get_refresh_rate(OpenXRDisplayRefreshRateExtension *this)

{
  ...
  local_20 = *(long *)(in_FS_OFFSET + 0x28);
  if (this[8] != (OpenXRDisplayRefreshRateExtension)0x0) {
    if (*(code **)(this + 0x18) == (code *)0x0) {
      iVar3 = -0xc;
    }
    else {
      iVar3 = (**(code **)(this + 0x18))(*(undefined8 *)(OpenXRAPI::singleton + 0xf8),local_54);
      if (-1 < iVar3) goto LAB_001007b6;
    }
    OpenXRAPI::get_error_string(&local_50,OpenXRAPI::singleton,iVar3);
    Variant::Variant((Variant *)local_38,"OpenXR: Failed to obtain refresh rate [");
    local_40 = 0;
    plVar1 = (long *)(local_50 + -0x10);
    if (local_50 != 0) {
      do {
        lVar2 = *plVar1;
        if (lVar2 == 0) goto LAB_0010083a;
        LOCK();
        lVar4 = *plVar1;
        bVar5 = lVar2 == lVar4;
        if (bVar5) {
...
LAB_00101376:
    ...
    iVar45 = *(int *)(this + 0x2c);
    if (pvVar43 == (void *)0x0) goto LAB_00100e54;
    if (iVar45 != 0) goto LAB_00101376;
LAB_00100e7a:
    ...
    *(void **)(this + 8) = __s_00;
    ...
    if (iVar45 != 0) {
      ...
      uVar55 = *(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x28) * 4);
      if (*(long *)(this + 8) == 0) goto LAB_001014d8;
LAB_0010136a:
      iVar45 = *(int *)(this + 0x2c);
      goto LAB_0010136e;
    }
LAB_00100e54:
    if ((float)uVar39 * __LC6 < (float)(iVar45 + 1)) goto LAB_00100e7a;
  }
  local_58[0] = 0;
  if (*(long *)param_1 == 0) {
...
LAB_00101103:
    ...
    if (puVar42 != (undefined8 *)0x0) goto LAB_00101110;
LAB_00101345:
    ...
    *plVar1 = *plVar1 + -1;
    UNLOCK();
    if (*plVar1 != 0) goto LAB_00101103;
    Memory::free_static((void *)(local_58[0] + -0x10),false);
    puVar42 = *(undefined8 **)(this + 0x20);
    if (puVar42 == (undefined8 *)0x0) goto LAB_00101345;
LAB_00101110:
    *puVar42 = pauVar41;

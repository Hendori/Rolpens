...
/* UPNPMiniUPNP::get_device_count() const */

undefined4 __thiscall UPNPMiniUPNP::get_device_count(UPNPMiniUPNP *this)
...
/* UPNPMiniUPNP::set_discover_local_port(int) */

void __thiscall UPNPMiniUPNP::set_discover_local_port(UPNPMiniUPNP *this,int param_1)
...
/* UPNPMiniUPNP::get_discover_local_port() const */

undefined4 __thiscall UPNPMiniUPNP::get_discover_local_port(UPNPMiniUPNP *this)
...
/* UPNPMiniUPNP::set_discover_ipv6(bool) */

void __thiscall UPNPMiniUPNP::set_discover_ipv6(UPNPMiniUPNP *this,bool param_1)
...
/* UPNPMiniUPNP::is_discover_ipv6() const */

UPNPMiniUPNP __thiscall UPNPMiniUPNP::is_discover_ipv6(UPNPMiniUPNP *this)
...
/* UPNPMiniUPNP::set_discover_multicast_if(String const&) */

void __thiscall UPNPMiniUPNP::set_discover_multicast_if(UPNPMiniUPNP *this,String *param_1)
...
/* UPNPMiniUPNP::get_discover_multicast_if() const */

void UPNPMiniUPNP::get_discover_multicast_if(void)
...
void UPNPMiniUPNP::make_default(void)
...
/* UPNPMiniUPNP::is_common_device(String const&) const */

bool __thiscall UPNPMiniUPNP::is_common_device(UPNPMiniUPNP *this,String *param_1)
...
/* UPNPMiniUPNP::load_description(String const&, int*, int*) const */

undefined8 __thiscall
UPNPMiniUPNP::load_description(UPNPMiniUPNP *this,String *param_1,int *param_2,int *param_3)
...
/* UPNPMiniUPNP::parse_igd(Ref<UPNPDevice>, UPNPDev*) */

void __thiscall UPNPMiniUPNP::parse_igd(undefined8 param_1,undefined8 *param_2,undefined8 param_3)
...
/* UPNPMiniUPNP::upnp_result(int) */

int UPNPMiniUPNP::upnp_result(int param_1)
...
/* UPNPMiniUPNP::clear_devices() */

void __thiscall UPNPMiniUPNP::clear_devices(UPNPMiniUPNP *this)
...
/* UPNPMiniUPNP::query_external_address() const */

void UPNPMiniUPNP::query_external_address(void)
...
/* UPNPMiniUPNP::delete_port_mapping(int, String) const */

undefined4 __thiscall
UPNPMiniUPNP::delete_port_mapping(UPNPMiniUPNP *this,undefined4 param_1,long *param_3)
...
LAB_00100a71:
    uVar5 = (*pcVar2)(local_30,param_1,&local_28);
    lVar3 = local_28;
    if (local_28 != 0) {
      LOCK();
      plVar1 = (long *)(local_28 + -0x10);
    ...
    if ((local_30 != (UPNPDevice *)0x0) && (cVar4 = RefCounted::unreference(), cVar4 != '\0')) {
      memdelete<UPNPDevice>(local_30);
    }
  }
...
/* UPNPMiniUPNP::add_port_mapping(int, int, String, String, int) const */

undefined4 __thiscall
UPNPMiniUPNP::add_port_mapping
          (UPNPMiniUPNP *this,undefined4 param_1,undefined4 param_2,long *param_4,long *param_5,
          undefined4 param_6)
...
LAB_00100bc6:
    uVar5 = (*pcVar2)(local_48,param_1,param_2,&local_40,&local_38,param_6);
    lVar3 = local_40;
    if (local_40 != 0) {
      LOCK();
    ...
    if ((local_48 != (UPNPDevice *)0x0) && (cVar4 = RefCounted::unreference(), cVar4 != '\0')) {
...
/* CowData<Ref<UPNPDevice> >::_copy_on_write() [clone .isra.0] */

void __thiscall CowData<Ref<UPNPDevice>>::_copy_on_write(CowData<Ref<UPNPDevice>> *this)
...
/* UPNPMiniUPNP::set_device(int, Ref<UPNPDevice>) */

void __thiscall UPNPMiniUPNP::set_device(UPNPMiniUPNP *this,int param_1,long *param_3)

{
  ...
  if (param_1 < 0) {
    ...
    if (lVar6 < lVar5) {
      if (*param_3 == 0) {
        _err_print_error("set_device","modules/upnp/upnp_miniupnp.cpp",0xfb,
                         "Condition \"device.is_null()\" is true.",0,0);
        return;
      }
...
LAB_00100e79:
  _err_print_index_error
            ("set_device","modules/upnp/upnp_miniupnp.cpp",0xfa,lVar6,lVar5,"index","devices.size()"
             ,"",false,false);
  return;
}
...
/* UPNPMiniUPNP::get_gateway() const */

void UPNPMiniUPNP::get_gateway(void)

{
  ...
  lVar3 = in_RSI[0x33];
  if (lVar3 == 0) {
    _err_print_error("get_gateway","modules/upnp/upnp_miniupnp.cpp",0x10b,
                     "Condition \"devices.is_empty()\" is true. Returning: nullptr",
                     "Couldn\'t find any UPNPDevices.",0,0);
    *in_RDI = 0;
  }
  else {
LAB_00100f54:
...
/* UPNPMiniUPNP::get_device(int) const */

long * UPNPMiniUPNP::get_device(int param_1)
...
LAB_00101279:
  _err_print_index_error
            ("get_device","modules/upnp/upnp_miniupnp.cpp",0xee,lVar3,lVar5,"index","devices.size()"
             ,"",false,false);
  *plVar4 = 0;
  return plVar4;
}
...
/* UPNPMiniUPNP::remove_device(int) */

void __thiscall UPNPMiniUPNP::remove_device(UPNPMiniUPNP *this,int param_1)
...
LAB_00101338:
            ...
            *(UPNPDevice **)(lVar5 + lVar4 * 8) = pUVar1;
            if ((pUVar1 != (UPNPDevice *)0x0) && (cVar3 = RefCounted::reference(), cVar3 == '\0')) {
              *(undefined8 *)(lVar5 + lVar4 * 8) = 0;
            }
            if ((pUVar2 == (UPNPDevice *)0x0) || (cVar3 = RefCounted::unreference(), cVar3 == '\0'))
            goto LAB_00101338;
            lVar4 = lVar4 + 1;
...
LAB_0010138e:
      CowData<Ref<UPNPDevice>>::resize<false>((CowData<Ref<UPNPDevice>> *)(this + 0x198),lVar6);
      return;
    }
    goto LAB_001013b1;
  }
...
LAB_001013b1:
  _err_print_index_error
            ("remove_device","modules/upnp/upnp_miniupnp.cpp",0x101,lVar4,lVar5,"index",
             "devices.size()","",false,false);
  return;
}



/* Vector<Ref<UPNPDevice> >::push_back(Ref<UPNPDevice>) [clone .isra.0] */

void __thiscall Vector<Ref<UPNPDevice>>::push_back(Vector<Ref<UPNPDevice>> *this,long *param_2)

{
  ...
  if (*(long *)(this + 8) == 0) {
    ...
    if (-1 < lVar7) {
      ...
      *plVar1 = (long)pUVar2;
      if ((pUVar2 != (UPNPDevice *)0x0) && (cVar4 = RefCounted::reference(), cVar4 == '\0')) {
        *plVar1 = 0;
      }
      if (pUVar3 == (UPNPDevice *)0x0) {
        return;
...
/* UPNPMiniUPNP::add_device(Ref<UPNPDevice>) */

void __thiscall UPNPMiniUPNP::add_device(UPNPMiniUPNP *this,undefined8 *param_2)

{
  ...
  if (pUVar1 == (UPNPDevice *)0x0) {
    if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
      _err_print_error("add_device","modules/upnp/upnp_miniupnp.cpp",0xf4,
                       "Condition \"device.is_null()\" is true.",0,0);
      return;
    }
  }
...
/* UPNPMiniUPNP::add_device_to_list(UPNPDev*, UPNPDev*) */

void __thiscall
UPNPMiniUPNP::add_device_to_list(UPNPMiniUPNP *this,UPNPDev *param_1,UPNPDev *param_2)
  ...
  *(undefined1 (*) [16])(this_00 + 400) = (undefined1  [16])0x0;
  ...
  if ((cVar4 != '\0') && (cVar4 = predelete_handler((Object *)this_00), cVar4 != '\0')) {
    if (*(code **)(*(long *)this_00 + 0x140) == UPNPDeviceMiniUPNP::~UPNPDeviceMiniUPNP) {
      *(code **)this_00 = StringName::StringName;
      if (*(long *)(this_00 + 0x1a0) != 0) {
        LOCK();
        plVar1 = (long *)(*(long *)(this_00 + 0x1a0) + -0x10);
        *plVar1 = *plVar1 + -1;
        UNLOCK();
        if (*plVar1 == 0) {
          lVar3 = *(long *)(this_00 + 0x1a0);
          *(undefined8 *)(this_00 + 0x1a0) = 0;
          Memory::free_static((void *)(lVar3 + -0x10),false);
        }
      }
      if (*(long *)(this_00 + 0x198) != 0) {
        LOCK();
        plVar1 = (long *)(*(long *)(this_00 + 0x198) + -0x10);
        *plVar1 = *plVar1 + -1;
        UNLOCK();
        if (*plVar1 == 0) {
          lVar3 = *(long *)(this_00 + 0x198);
      ...
      if (*(long *)(this_00 + 400) != 0) {
        LOCK();
        plVar1 = (long *)(*(long *)(this_00 + 400) + -0x10);
        *plVar1 = *plVar1 + -1;
        UNLOCK();
        if (*plVar1 == 0) {
          lVar3 = *(long *)(this_00 + 400);
      ...
      if (*(long *)(this_00 + 0x188) != 0) {
        LOCK();
        plVar1 = (long *)(*(long *)(this_00 + 0x188) + -0x10);
        *plVar1 = *plVar1 + -1;
        UNLOCK();
        if (*plVar1 == 0) {
          lVar3 = *(long *)(this_00 + 0x188);
      ...
      if (*(long *)(this_00 + 0x180) != 0) {
        LOCK();
        plVar1 = (long *)(*(long *)(this_00 + 0x180) + -0x10);
        *plVar1 = *plVar1 + -1;
        UNLOCK();
        if (*plVar1 == 0) {
          lVar3 = *(long *)(this_00 + 0x180);
...
/* UPNPMiniUPNP::discover(int, int, String const&) */

int __thiscall UPNPMiniUPNP::discover(UPNPMiniUPNP *this,int param_1,int param_2,String *param_3)

{
  ...
  if (param_1 < 0) {
    ...
    if ((uint)param_2 < 0x100) {
      ...
      if (cVar2 == '\0') {
        pUVar3 = (UPNPDev *)
                 upnpDiscoverAll(param_1,lVar5,0,*(undefined4 *)(this + 0x188),this[0x18c],param_2);
...
LAB_00101c93:
        ...
        pUVar3 = (UPNPDev *)
                 upnpDiscover(param_1,lVar5,0,*(undefined4 *)(this + 0x188),this[0x18c],param_2,
                              &local_54);
...
LAB_00101db0:
              add_device_to_list(this,pUVar7,pUVar3);
            }
            else {
              String::utf8();
...
/* UPNPMiniUPNP::is_class_ptr(void*) const */

uint __thiscall UPNPMiniUPNP::is_class_ptr(UPNPMiniUPNP *this,void *param_1)

{
  return (uint)CONCAT71(0x1050,(undefined4 *)param_1 == &UPNP::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1050,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1050,(undefined4 *)param_1 == &RefCounted::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1050,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr);
}



/* UPNPMiniUPNP::_getv(StringName const&, Variant&) const */

undefined8 UPNPMiniUPNP::_getv(StringName *param_1,Variant *param_2)
...
/* UPNPMiniUPNP::_setv(StringName const&, Variant const&) */

undefined8 UPNPMiniUPNP::_setv(StringName *param_1,Variant *param_2)
...
/* UPNPMiniUPNP::_validate_propertyv(PropertyInfo&) const */

void UPNPMiniUPNP::_validate_propertyv(PropertyInfo *param_1)
...
/* UPNPMiniUPNP::_property_can_revertv(StringName const&) const */

undefined8 UPNPMiniUPNP::_property_can_revertv(StringName *param_1)
...
/* UPNPMiniUPNP::_property_get_revertv(StringName const&, Variant&) const */

undefined8 UPNPMiniUPNP::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* UPNPMiniUPNP::_notificationv(int, bool) */

void UPNPMiniUPNP::_notificationv(int param_1,bool param_2)
...
/* UPNPMiniUPNP::_get_class_namev() const */

undefined8 * UPNPMiniUPNP::_get_class_namev(void)
...
LAB_001020e3:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"UPNPMiniUPNP");
      goto LAB_0010214e;
    }
  }
  StringName::assign_static_unique_class_name
...
/* UPNPMiniUPNP::_create(bool) */

RefCounted * UPNPMiniUPNP::_create(bool param_1)
...
/* UPNPMiniUPNP::get_class() const */

void UPNPMiniUPNP::get_class(void)
...
/* UPNPMiniUPNP::is_class(String const&) const */

undefined8 __thiscall UPNPMiniUPNP::is_class(UPNPMiniUPNP *this,String *param_1)
...
/* UPNPDeviceMiniUPNP::~UPNPDeviceMiniUPNP() */

void __thiscall UPNPDeviceMiniUPNP::~UPNPDeviceMiniUPNP(UPNPDeviceMiniUPNP *this)
...
/* UPNPMiniUPNP::_initialize_classv() */

void UPNPMiniUPNP::_initialize_classv(void)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (initialize_class()::initialized == '\0') {
    if (UPNP::initialize_class()::initialized == '\0') {
      ...
      UPNP::initialize_class()::initialized = '\x01';
    }
    local_58 = "UPNP";
    local_68 = 0;
    local_50 = 4;
...
/* UPNP::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void __thiscall UPNP::_get_property_listv(UPNP *this,List *param_1,bool param_2)
...
/* UPNPMiniUPNP::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void __thiscall UPNPMiniUPNP::_get_property_listv(UPNPMiniUPNP *this,List *param_1,bool param_2)
...
/* void memdelete<UPNPDeviceMiniUPNP>(UPNPDeviceMiniUPNP*) */

void memdelete<UPNPDeviceMiniUPNP>(UPNPDeviceMiniUPNP *param_1)
...
/* void memdelete<UPNPDevice>(UPNPDevice*) */

void memdelete<UPNPDevice>(UPNPDevice *param_1)
...
/* CowData<Ref<UPNPDevice> >::_unref() */

void __thiscall CowData<Ref<UPNPDevice>>::_unref(CowData<Ref<UPNPDevice>> *this)
...
/* UPNPMiniUPNP::~UPNPMiniUPNP() */

void __thiscall UPNPMiniUPNP::~UPNPMiniUPNP(UPNPMiniUPNP *this)
...
/* CowData<Ref<UPNPDevice> >::_copy_on_write() [clone .isra.0] [clone .cold] */

void CowData<Ref<UPNPDevice>>::_copy_on_write(void)
...
/* UPNPMiniUPNP::add_device_to_list(UPNPDev*, UPNPDev*) [clone .cold] */

void UPNPMiniUPNP::add_device_to_list(UPNPDev *param_1,UPNPDev *param_2)
...
/* CowData<Ref<UPNPDevice> >::_realloc(long) */

undefined8 __thiscall
CowData<Ref<UPNPDevice>>::_realloc(CowData<Ref<UPNPDevice>> *this,long param_1)
...
/* Error CowData<Ref<UPNPDevice> >::resize<false>(long) */

undefined8 __thiscall
CowData<Ref<UPNPDevice>>::resize<false>(CowData<Ref<UPNPDevice>> *this,long param_1)

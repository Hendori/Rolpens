...
/* ScriptInstance::call_const(StringName const&, Variant const**, int, Callable::CallError&) */

StringName *
ScriptInstance::call_const(StringName *param_1,Variant **param_2,int param_3,CallError *param_4)
...
/* ScriptInstance::property_set_fallback(StringName const&, Variant const&, bool*) */

void ScriptInstance::property_set_fallback(StringName *param_1,Variant *param_2,bool *param_3)
...
/* ScriptInstance::property_get_fallback(StringName const&, bool*) */

void ScriptInstance::property_get_fallback(StringName *param_1,bool *param_2)
...
/* ScriptInstance::get_rpc_config() const */

void ScriptInstance::get_rpc_config(void)

{
  ...
  if (*(code **)(*in_RSI + 0x90) == PlaceHolderScriptInstance::get_script) {
    ...
    if ((local_28 == (Object *)0x0) || (cVar2 = RefCounted::reference(), cVar2 == '\0')) {
      local_28 = (Object *)0x0;
    }
  }
  else {
...
/* ScriptInstance::get_method_argument_count(StringName const&, bool*) const */

undefined4 __thiscall
ScriptInstance::get_method_argument_count(ScriptInstance *this,StringName *param_1,bool *param_2)
...
LAB_001002f6:
      if (((local_40 != (Object *)0x0) &&
          (cVar2 = RefCounted::unreference(), pOVar4 = local_40, cVar2 != '\0')) &&
    ...
    (**(code **)(*(long *)this + 0x90))(&local_40);
LAB_001001b9:
    if (local_40 == (Object *)0x0) goto LAB_00100349;
    do {
      local_41 = '\0';
...
void __thiscall ScriptInstance::~ScriptInstance(ScriptInstance *this)
...
/* ScriptInstance::get_property_state(List<Pair<StringName, Variant>, DefaultAllocator>&) */

void __thiscall ScriptInstance::get_property_state(ScriptInstance *this,List *param_1)

{
  ...
  local_78 = (long *)0x0;
  (**(code **)(*(long *)this + 0x10))();
  if ((local_78 != (long *)0x0) && (lVar5 = *local_78, lVar5 != 0)) {
LAB_0010044d:
    do {
...
/* ScriptInstance::get_owner() */

undefined8 ScriptInstance::get_owner(void)
...
/* ScriptInstance::is_placeholder() const */

undefined8 ScriptInstance::is_placeholder(void)

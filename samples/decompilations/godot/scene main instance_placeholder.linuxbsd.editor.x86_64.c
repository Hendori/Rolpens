...
/* InstancePlaceholder::get_instance_path() const */

void InstancePlaceholder::get_instance_path(void)
...
/* InstancePlaceholder::_set(StringName const&, Variant const&) */

undefined8 __thiscall
InstancePlaceholder::_set(InstancePlaceholder *this,StringName *param_1,Variant *param_2)
...
/* InstancePlaceholder::_get(StringName const&, Variant&) const */

long * __thiscall
InstancePlaceholder::_get(InstancePlaceholder *this,StringName *param_1,Variant *param_2)

{
  long *plVar1;
  
  if ((*(long **)(this + 0x410) != (long *)0x0) &&
     (plVar1 = (long *)**(long **)(this + 0x410), plVar1 != (long *)0x0)) {
    do {
...
/* InstancePlaceholder::_get_property_list(List<PropertyInfo, DefaultAllocator>*) const */

void __thiscall InstancePlaceholder::_get_property_list(InstancePlaceholder *this,List *param_1)

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  if ((*(long **)(this + 0x410) != (long *)0x0) &&
     (plVar10 = (long *)**(long **)(this + 0x410), plVar10 != (long *)0x0)) {
    do {
      local_68 = 0;
      local_50 = 0;
...
/* InstancePlaceholder::set_instance_path(String const&) */

void __thiscall InstancePlaceholder::set_instance_path(InstancePlaceholder *this,String *param_1)
...
/* InstancePlaceholder::try_get_node(InstancePlaceholder*, Node*, NodePath const&) */

void InstancePlaceholder::try_get_node(InstancePlaceholder *param_1,Node *param_2,NodePath *param_3)
...
void __thiscall InstancePlaceholder::InstancePlaceholder(InstancePlaceholder *this)
...
/* InstancePlaceholder::set_value_on_instance(InstancePlaceholder*, Node*,
   InstancePlaceholder::PropSet const&) */

void __thiscall
InstancePlaceholder::set_value_on_instance
          (InstancePlaceholder *this,InstancePlaceholder *param_1,Node *param_2,PropSet *param_3)

{
  ...
  if (local_b8[0] == 0x1c) {
    ...
    if (cVar3 != '\0') {
      ...
      String::parse_latin1
                ((String *)&local_d0,
                 "Array Property \'%s\' with type \'%s\' could not be set when creating instance of \'%s\'."
                );
      vformat<StringName,String,StringName>
                ((CowData<char32_t> *)local_c0,(String *)&local_d0,&local_c8,local_e0,&local_d8);
      _err_print_error("set_value_on_instance","scene/main/instance_placeholder.cpp",0x9d,
                       (CowData<char32_t> *)local_c0,0,1);
    ...
    local_58[0] = 0;
    Variant::evaluate((Operator *)local_c0,(Variant *)local_98,(Variant *)local_78,
                      (Variant *)local_58,(bool *)local_128);
    ...
    if (local_f9 == '\0') {
      ...
      vformat<StringName,String,StringName>
                ((Array *)local_c0,(String *)&local_d0,local_128,local_e0,&local_d8);
      _err_print_error("set_value_on_instance","scene/main/instance_placeholder.cpp",0xd2,
                       (Array *)local_c0,0,1);
      CowData<char32_t>::_unref((CowData<char32_t> *)local_c0);
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_d0);
      if ((StringName::configured != '\0') && (CONCAT71(uStack_c7,local_c8) != 0)) {
  ...
  local_c8 = (StringName)0x1;
  local_58[0] = 0;
  Variant::evaluate((Operator *)local_c0,(Variant *)local_98,(Variant *)local_78,(Variant *)local_58
                    ,(bool *)&local_c8);
  bVar2 = Variant::operator_cast_to_bool((Variant *)local_58);
  if (Variant::needs_deinit[local_58[0]] != '\0') {
    Variant::_clear_internal();
  ...
  if (bVar2) {
    ...
    vformat<StringName,String,StringName>
              ((Operator *)local_c0,(String *)&local_d0,&local_c8,local_e0,&local_d8);
    uVar10 = 0x8d;
  }
  else {
    if (iVar11 == 0) {
...
LAB_00100e88:
  ...
  _err_print_error("set_value_on_instance","scene/main/instance_placeholder.cpp",uVar10,
                   (Operator *)local_c0,0,1);
  CowData<char32_t>::_unref((CowData<char32_t> *)local_c0);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_d0);
  if ((StringName::configured != '\0') && (CONCAT71(uStack_c7,local_c8) != 0)) {
    StringName::unref();
...
/* InstancePlaceholder::create_instance(bool, Ref<PackedScene> const&) */
...

{
  ...
  if (((byte)this[0x2fa] & 0x40) == 0) {
    pSVar8 = (String *)0x0;
    _err_print_error("create_instance","scene/main/instance_placeholder.cpp",0x4a,
...
LAB_00101383:
    pSVar8 = (String *)PackedScene::instantiate(pOVar7);
    if (pSVar8 != (String *)0x0) {
      ...
      if (*(undefined8 **)(this + 0x410) != (undefined8 *)0x0) {
        for (pPVar3 = (PropSet *)**(undefined8 **)(this + 0x410); pPVar3 != (PropSet *)0x0;
            pPVar3 = *(PropSet **)(pPVar3 + 0x20)) {
...
/* InstancePlaceholder::_bind_methods() */

void InstancePlaceholder::_bind_methods(void)

{
  ...
  pVStack_b0 = local_70;
  pMVar3 = create_method_bind<InstancePlaceholder,Node*,bool,Ref<PackedScene>const&>
                     (create_instance);
...
/* InstancePlaceholder::get_stored_values(bool) */

Dictionary * InstancePlaceholder::get_stored_values(bool param_1)

{
  ...
  local_90 = 0;
  if ((*(long **)(in_RSI + 0x410) != (long *)0x0) &&
     (pSVar6 = (StringName *)**(long **)(in_RSI + 0x410), pSVar6 != (StringName *)0x0)) {
    do {
...
LAB_00101cb8:
          iVar2 = CowData<String>::resize<false>((CowData<String> *)&local_90,1);
...
LAB_00101bb1:
          if (local_90 == 0) goto LAB_00101cb8;
LAB_00101bbf:
...
LAB_00101daa:
            _err_print_index_error
                      ("set","./core/templates/cowdata.h",0xcf,lVar5,lVar7,"p_index","size()","",
                       false,false);
          }
          else {
...
/* InstancePlaceholder::is_class_ptr(void*) const */

uint __thiscall InstancePlaceholder::is_class_ptr(InstancePlaceholder *this,void *param_1)

{
  return (uint)CONCAT71(0x106c,(undefined4 *)param_1 == &Node::get_class_ptr_static()::ptr) |
...
/* InstancePlaceholder::_property_can_revertv(StringName const&) const */

undefined8 InstancePlaceholder::_property_can_revertv(StringName *param_1)
...
/* InstancePlaceholder::_property_get_revertv(StringName const&, Variant&) const */

undefined8 InstancePlaceholder::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* MethodBindTR<Node*, bool, Ref<PackedScene> const&>::_gen_argument_type(int) const */

int __thiscall
MethodBindTR<Node*,bool,Ref<PackedScene>const&>::_gen_argument_type
          (MethodBindTR<Node*,bool,Ref<PackedScene>const&> *this,int param_1)
...
/* MethodBindTR<Node*, bool, Ref<PackedScene> const&>::get_argument_meta(int) const */

undefined8 MethodBindTR<Node*,bool,Ref<PackedScene>const&>::get_argument_meta(int param_1)
...
/* MethodBindTR<Dictionary, bool>::_gen_argument_type(int) const */

int __thiscall
MethodBindTR<Dictionary,bool>::_gen_argument_type(MethodBindTR<Dictionary,bool> *this,int param_1)
...
/* MethodBindTR<Dictionary, bool>::get_argument_meta(int) const */

undefined8 MethodBindTR<Dictionary,bool>::get_argument_meta(int param_1)
...
/* MethodBindTR<Dictionary, bool>::~MethodBindTR() */

void __thiscall MethodBindTR<Dictionary,bool>::~MethodBindTR(MethodBindTR<Dictionary,bool> *this)
...
/* MethodBindTR<Node*, bool, Ref<PackedScene> const&>::~MethodBindTR() */

void __thiscall
MethodBindTR<Node*,bool,Ref<PackedScene>const&>::~MethodBindTR
          (MethodBindTR<Node*,bool,Ref<PackedScene>const&> *this)
...
/* InstancePlaceholder::_validate_propertyv(PropertyInfo&) const */

void InstancePlaceholder::_validate_propertyv(PropertyInfo *param_1)
...
/* InstancePlaceholder::_notificationv(int, bool) */

void __thiscall
InstancePlaceholder::_notificationv(InstancePlaceholder *this,int param_1,bool param_2)
...
/* InstancePlaceholder::_getv(StringName const&, Variant&) const */

long * __thiscall
InstancePlaceholder::_getv(InstancePlaceholder *this,StringName *param_1,Variant *param_2)
...
/* InstancePlaceholder::_get_class_namev() const */

undefined8 * InstancePlaceholder::_get_class_namev(void)
...
LAB_00102213:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"InstancePlaceholder");
      goto LAB_0010227e;
    }
  }
  StringName::assign_static_unique_class_name
...
/* InstancePlaceholder::get_class() const */

void InstancePlaceholder::get_class(void)
...
/* InstancePlaceholder::_setv(StringName const&, Variant const&) */

void __thiscall
InstancePlaceholder::_setv(InstancePlaceholder *this,StringName *param_1,Variant *param_2)
...
/* List<InstancePlaceholder::PropSet, DefaultAllocator>::~List() */

void __thiscall
List<InstancePlaceholder::PropSet,DefaultAllocator>::~List
          (List<InstancePlaceholder::PropSet,DefaultAllocator> *this)
...

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_00106978;
  List<InstancePlaceholder::PropSet,DefaultAllocator>::~List
            ((List<InstancePlaceholder::PropSet,DefaultAllocator> *)(this + 0x410));
...
/* WARNING: Removing unreachable block (ram,0x00102a70) */
/* String vformat<StringName, String, StringName>(String const&, StringName const, String const,
   StringName const) */

undefined8 *
vformat<StringName,String,StringName>
          (undefined8 *param_1,bool *param_2,StringName *param_3,String *param_4,StringName *param_5
          )
...
/* InstancePlaceholder::is_class(String const&) const */

undefined8 __thiscall InstancePlaceholder::is_class(InstancePlaceholder *this,String *param_1)
...
/* InstancePlaceholder::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void __thiscall
InstancePlaceholder::_get_property_listv(InstancePlaceholder *this,List *param_1,bool param_2)
...
/* MethodBind* create_method_bind<InstancePlaceholder, Dictionary, bool>(Dictionary
   (InstancePlaceholder::*)(bool)) */

MethodBind * create_method_bind<InstancePlaceholder,Dictionary,bool>(_func_Dictionary_bool *param_1)
...
/* MethodBind* create_method_bind<InstancePlaceholder, Node*, bool, Ref<PackedScene> const&>(Node*
   (InstancePlaceholder::*)(bool, Ref<PackedScene> const&)) */

MethodBind *
create_method_bind<InstancePlaceholder,Node*,bool,Ref<PackedScene>const&>
          (_func_Node_ptr_bool_Ref_ptr *param_1)
...
MethodBind * create_method_bind<InstancePlaceholder,String>(_func_String *param_1)
...
/* InstancePlaceholder::_initialize_classv() */

void InstancePlaceholder::_initialize_classv(void)
...
void __thiscall
MethodBindTR<Dictionary,bool>::validated_call
          (MethodBindTR<Dictionary,bool> *this,Object *param_1,Variant **param_2,Variant *param_3)
...
void __thiscall
MethodBindTR<Dictionary,bool>::ptrcall
          (MethodBindTR<Dictionary,bool> *this,Object *param_1,void **param_2,void *param_3)
...
void __thiscall
MethodBindTR<Node*,bool,Ref<PackedScene>const&>::validated_call
          (MethodBindTR<Node*,bool,Ref<PackedScene>const&> *this,Object *param_1,Variant **param_2,
          Variant *param_3)
...
void __thiscall
MethodBindTR<Node*,bool,Ref<PackedScene>const&>::ptrcall
          (MethodBindTR<Node*,bool,Ref<PackedScene>const&> *this,Object *param_1,void **param_2,
          void *param_3)
...
Object * MethodBindTR<Dictionary,bool>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
Object * MethodBindTR<Node*,bool,Ref<PackedScene>const&>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)

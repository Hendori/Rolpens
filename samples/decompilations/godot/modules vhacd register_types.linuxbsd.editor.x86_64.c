...
LAB_001010d4:
      puVar15 = (undefined8 *)Memory::alloc_static(uVar24 + 0x11,false);
...
LAB_0010105e:
            ...
            if (puVar14 == (undefined8 *)0x0) {
              pfVar17 = (float *)convex_decompose((float *)this_01,(int)lVar26,(uint *)0x0,iVar21,
                                                  pRVar28,pVVar29);
              return pfVar17;
            }
            goto LAB_00100872;
...
LAB_00100c73:
      _err_print_index_error
                ("operator[]","./core/templates/vector.h",0x38,uVar24,(long)pRVar28,"p_index",
...
LAB_00100d6b:
          if (*(long *)(lVar31 + 8) == 0) {
            pfVar17 = (float *)convex_decompose((float *)pCVar27,(int)pCVar25,puVar23,uVar5,pRVar28,
                                                pVVar29);
            return pfVar17;
          }
    ...
    if (local_68 != 0) {
      ...
      do {
        lVar31 = 0;
        do {
          *(float *)(lVar30 + lVar31 * 4) =
               (float)*(double *)(local_78 + (ulong)(uint)(iVar21 + (int)lVar31) * 8);
          lVar31 = lVar31 + 1;
        } while (lVar31 != 3);
        iVar21 = iVar21 + 3;
        lVar30 = lVar30 + 0xc;
...
LAB_00100ddf:
          iVar21 = CowData<unsigned_int>::_realloc(this_00,lVar30);

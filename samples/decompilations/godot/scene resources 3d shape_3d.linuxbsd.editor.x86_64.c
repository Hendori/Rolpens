...

{
  ...
  if (*(long *)(in_RSI + 600) == 0) {
    ...
    *(undefined ***)this = &PTR__initialize_classv_001082d0;
...

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_001084d0;
  uVar1 = _LC17;
  ...
  if (cVar7 == '\0') {
    ...
    if (pOVar13 != (Object *)0x0) {
      ...
      if (cVar7 != '\0') {
        ...
        if (cVar7 != '\0') goto LAB_00101a04;
      }
    }
  }
  else {
    pOVar13 = (Object *)in_RSI[0x4a];
    pAVar18 = (ArrayMesh *)pOVar13;
    if (this != (ArrayMesh *)pOVar13) {
      ...
      if (((pOVar13 != (Object *)0x0) && (cVar7 = RefCounted::unreference(), cVar7 != '\0')) &&
         (cVar7 = predelete_handler(pOVar13), cVar7 != '\0')) {
LAB_00101a04:
    ...
    cVar7 = RefCounted::unreference();
    if ((cVar7 != '\0') && (cVar7 = predelete_handler((Object *)pAVar18), cVar7 != '\0')) {
      (**(code **)(*(long *)pAVar18 + 0x140))(pAVar18);
      Memory::free_static(pAVar18,false);
    }
  }
LAB_00101a28:
  if (local_90 != 0) {
    ...
    local_70 = (long *)0x0;
    if (local_90 != 0) {
      lVar1 = *(long *)(local_90 + -8);
      if (lVar1 < 0) {
        _err_print_error("resize","./core/templates/cowdata.h",0x157,
                         "Condition \"p_size < 0\" is true. Returning: ERR_INVALID_PARAMETER",0,0);
        goto LAB_001022b0;
      }
      if (lVar1 == 0) goto LAB_00101bab;
      uVar19 = lVar1 * 0x10;
      if ((uVar19 == 0) ||
         (uVar9 = uVar19 - 1 | uVar19 - 1 >> 1, uVar9 = uVar9 | uVar9 >> 2,
        ...
        _err_print_error("resize","./core/templates/cowdata.h",0x16a,
                         ...
                         ,0,0);
LAB_001022b0:
        if (local_70 != (long *)0x0) goto LAB_00101b44;
      }
      else {
        plVar10 = (long *)Memory::alloc_static(uVar9 + 0x11,false);
        if (plVar10 == (long *)0x0) {
        ...
        *plVar10 = 1;
        ...
        lVar11 = __LC41;
        plVar16 = plVar10;
        if ((uVar19 & 0x10) == 0) goto LAB_00101b30;
        plVar10[2] = __LC41;
        plVar10[3] = lVar4;
        plVar16 = local_70;
        while (plVar16 != plVar10 + lVar1 * 2) {
LAB_00101b30:
          plVar16[2] = lVar11;
          plVar16[3] = lVar4;
          plVar16[4] = lVar11;
...
LAB_00101b44:
        if (1 < (ulong)local_70[-2]) {
          ...
          puVar15 = (undefined8 *)Memory::alloc_static(uVar19,false);
          plVar10 = local_70;
      ...
      if ((local_90 != 0) && (lVar1 = *(long *)(local_90 + -8), 0 < lVar1)) {
        lVar11 = 0;
        plVar10 = local_70;
        do {
          lVar4 = in_RSI[0x4c];
          lVar5 = in_RSI[0x4d];
          *(undefined8 *)(lVar2 + lVar11) = *(undefined8 *)(local_90 + lVar11);
          *(undefined4 *)(lVar2 + 8 + lVar11) = *(undefined4 *)(local_90 + 8 + lVar11);
          lVar11 = lVar11 + 0xc;
          *plVar10 = lVar4;
          plVar10[1] = lVar5;
          plVar10 = plVar10 + 2;
        } while (lVar1 * 0xc != lVar11);
      }
    }
LAB_00101bab:
    ...
    if (pVVar12 == (Variant *)&local_58) {
      ...
      *(int *)pVVar12 = (int)local_58;
      *(undefined8 *)(pVVar12 + 8) = local_50._0_8_;
      *(undefined8 *)(pVVar12 + 0x10) = local_50._8_8_;
    }
    ...
    if (local_a0 == (Object *)0x0) {
      ...
      pOVar13 = (Object *)__dynamic_cast(local_a0,&Object::typeinfo,&StandardMaterial3D::typeinfo,0)
      ;
      if ((pOVar13 != (Object *)0x0) && (cVar7 = RefCounted::reference(), cVar7 == '\0')) {
        pOVar13 = (Object *)0x0;
      }
      cVar7 = RefCounted::unreference();
      if ((cVar7 != '\0') && (cVar7 = predelete_handler(local_a0), cVar7 != '\0')) {
    ...
    Array::set_typed(uVar17,(StringName *)0x1c,(Variant *)&local_a0);
    ...
    ArrayMesh::add_surface_from_arrays(lVar2,1,local_c8,local_b0,local_a8,0);
    Array::~Array(local_b0);
    Dictionary::~Dictionary(local_a8);
    ...
    if (((pOVar13 != (Object *)0x0) &&
        ...
        pOVar14 != (Object *)0x0)) &&
       (local_a0 = pOVar14, cVar7 = RefCounted::reference(), cVar7 == '\0')) {
      local_a0 = (Object *)0x0;
    }
    (*pcVar3)(plVar10,0,(Variant *)&local_a0);
    if (((local_a0 != (Object *)0x0) &&
        (cVar7 = RefCounted::unreference(), pOVar14 = local_a0, cVar7 != '\0')) &&
       (cVar7 = predelete_handler(local_a0), cVar7 != '\0')) {
      (**(code **)(*(long *)pOVar14 + 0x140))();
      Memory::free_static(pOVar14,false);
    }
    if ((char)in_RSI[0x4e] != '\0') {
      pcVar3 = *(code **)(*in_RSI + 0x1d8);
      local_68 = __LC42;
      uStack_60 = _UNK_00108898;
      local_58 = Color::operator*((Color *)(in_RSI + 0x4c),(Color *)&local_68);
      local_50._0_8_ = in_XMM1_Qa;
      (*pcVar3)(&local_c0);
      if (local_c0 != (Object *)0x0) {
        iVar8 = (**(code **)(*(long *)local_c0 + 0x1c8))();
        if (0 < iVar8) {
          ...
          ArrayMesh::add_surface_from_arrays(lVar2,3,local_b8,local_b0,local_a8,0);
          Array::~Array(local_b0);
          Dictionary::~Dictionary(local_a8);
          plVar10 = (long *)in_RSI[0x4a];
          pcVar3 = *(code **)(*plVar10 + 0x208);
          ...
          (*pcVar3)(plVar10,1,(Variant *)&local_a0);
          if (((local_a0 != (Object *)0x0) &&
              (cVar7 = RefCounted::unreference(), pOVar14 = local_a0, cVar7 != '\0')) &&
             (cVar7 = predelete_handler(local_a0), cVar7 != '\0')) {
        ...
        if (((local_c0 != (Object *)0x0) && (cVar7 = RefCounted::unreference(), cVar7 != '\0')) &&
    ...
    if (local_70 != (long *)0x0) {
      ...
      *plVar16 = *plVar16 + -1;
      ...
      if (*plVar16 == 0) {
        local_70 = (long *)0x0;
        Memory::free_static(plVar10 + -2,false);
      }
    }
    lVar2 = local_80;
    if (local_80 != 0) {
...

{
  ...
  return (uint)CONCAT71(0x1087,in_RSI == &BaseMaterial3D::get_class_ptr_static()::ptr) |
         ...
         (uint)CONCAT71(0x1088,in_RSI == &Resource::get_class_ptr_static()::ptr) |
...
LAB_001040a8:
    ...
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_001040a8;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)pLVar6;
      local_68 = local_80;
      goto joined_r0x001040c9;
    }
...
LAB_00104ded:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_00104ded;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)param_1;
      local_68 = local_80;
      goto joined_r0x00104e0f;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
...
LAB_00105200:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_00105200;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)param_1;
      local_68 = local_80;
      goto joined_r0x00105222;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
...
LAB_00105628:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_00105628;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)param_1;
      local_68 = local_80;
      goto joined_r0x0010564a;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
...
LAB_00105a3d:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_00105a3d;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)param_1;
      local_68 = local_80;
      goto joined_r0x00105a5f;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
...
LAB_00105e05:
    ...
    local_40 = 6;
    if (local_50 != 0x11) goto LAB_00105e05;
...
/* WARNING: Removing unreachable block (ram,0x001069fd) */
/* WARNING: Removing unreachable block (ram,0x00106a09) */
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
    ...
    auVar2._0_4_ = (float)*(double *)(*(long *)param_3 + 8);
                    /* WARNING: Could not recover jumptable at 0x00107242. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
    ...
    auVar2._0_4_ = (float)**param_3;
                    /* WARNING: Could not recover jumptable at 0x00107421. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)(auVar2._0_8_,(long *)((long)param_2 + *(long *)(param_1 + 0x60)));
    return;
  }
...

{
  ...
  if (local_48 == (Object *)0x0) {
                    /* WARNING: Load size is inaccurate */
    pOVar5 = *param_3;
    if (pOVar5 == (Object *)0x0) goto LAB_00107936;
  ...
  if (pOVar5 != pOVar3) {
    *(Object **)param_3 = pOVar3;
    if (pOVar3 == (Object *)0x0) {
      if (pOVar5 != (Object *)0x0) goto LAB_00107979;
    }
    else {
...
LAB_00107979:
      ...
      if (local_48 == (Object *)0x0) goto LAB_00107936;
    }
  }
  cVar1 = RefCounted::unreference();
  pOVar5 = local_48;
...
LAB_00107deb:
  *(undefined4 *)param_6 = 0;
  ...
  fVar9 = Variant::operator_cast_to_float(this);
                    /* WARNING: Could not recover jumptable at 0x00107e44. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*param_2)(fVar9);
  return;
}

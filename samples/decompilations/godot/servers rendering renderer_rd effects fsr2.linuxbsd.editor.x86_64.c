...
/* get_device_capabilities_rd(FfxFsr2Interface*, FfxDeviceCapabilities*, void*) */

undefined8
get_device_capabilities_rd(FfxFsr2Interface *param_1,FfxDeviceCapabilities *param_2,void *param_3)
...
/* destroy_pipeline_rd(FfxFsr2Interface*, FfxPipelineState*) */

undefined8 destroy_pipeline_rd(FfxFsr2Interface *param_1,FfxPipelineState *param_2)
...
/* schedule_gpu_job_rd(FfxFsr2Interface*, FfxGpuJobDescription const*) */

undefined8 schedule_gpu_job_rd(FfxFsr2Interface *param_1,FfxGpuJobDescription *param_2)

{
  ...
  if (param_1 == (FfxFsr2Interface *)0x0) {
    _err_print_error("schedule_gpu_job_rd","servers/rendering/renderer_rd/effects/fsr2.cpp",0x15e,
                     "Parameter \"p_backend_interface\" is null.",0,0);
  }
  else {
    ...
    _err_print_error("schedule_gpu_job_rd","servers/rendering/renderer_rd/effects/fsr2.cpp",0x15f,
                     "Parameter \"p_job\" is null.",0,0);
  }
  uVar4 = 0x8000000a;
LAB_001000c5:
...
/* get_resource_description_rd(FfxFsr2Interface*, FfxResourceInternal) */

undefined1 (*) [16]
get_resource_description_rd(undefined1 (*param_1) [16],long param_2,uint param_3)
...
/* destroy_backend_context_rd(FfxFsr2Interface*) */

undefined8 destroy_backend_context_rd(FfxFsr2Interface *param_1)
...
/* create_pipeline_rd(FfxFsr2Interface*, FfxFsr2Pass, FfxPipelineDescription const*,
   FfxPipelineState*) */

undefined8 create_pipeline_rd(long param_1,int param_2,byte *param_3,long *param_4)
...
LAB_001006ed:
      _err_print_index_error
                ("version_get_shader","./servers/rendering/renderer_rd/shader_rd.h",0xa6,
                 (long)(int)uVar8,lVar9,"p_variant","variant_defines.size()","",false,false);
      *(undefined8 *)(lVar3 + 0x10 + lVar18 * 0x58) = 0;
LAB_001005c9:
      _err_print_error("create_pipeline_rd","servers/rendering/renderer_rd/effects/fsr2.cpp",0x133,
                       "Condition \"effect_pass.root_signature.shader_rid.is_null()\" is true. Returning: FFX_ERROR_BACKEND_API_ERROR"
                       ,0,0);
    }
    else {
      uVar11 = (ulong)uVar8;
...
LAB_00100910:
      ...
      lVar9 = ((uVar5 & 0xffffffff) % (ulong)*(uint *)(pVVar4 + 0xd0)) * 0xa0 +
              *(long *)(*(long *)(pVVar4 + 0xc0) +
                       ((uVar5 & 0xffffffff) / (ulong)*(uint *)(pVVar4 + 0xd0)) * 8);
      ...
      *(long *)(lVar3 + 0x10 + lVar18 * 0x58) = lVar9;
      ...
      _err_print_error("create_pipeline_rd","servers/rendering/renderer_rd/effects/fsr2.cpp",0x136,
                       "Condition \"effect_pass.pipeline.pipeline_rid.is_null()\" is true. Returning: FFX_ERROR_BACKEND_API_ERROR"
                       ,0,0);
    }
    uVar10 = 0x8000000d;
    goto LAB_00100573;
  ...
  *param_4 = lVar19 + lVar3;
  ...
  if (pvVar6 == (void *)0x0) {
    *(undefined4 *)((long)param_4 + 0x14) = 0;
    sVar13 = 0;
LAB_001004e0:
    memcpy((void *)((long)param_4 + 0x85c),pvVar6,sVar13);
    ...
    if (pvVar6 == (void *)0x0) {
      ...
      *(uint *)(param_4 + 2) = uVar8;
      if (8 < uVar8) {
        _err_print_error("create_pipeline_rd","servers/rendering/renderer_rd/effects/fsr2.cpp",0x143
                         ,
                         "Condition \"p_out_pipeline->uavCount > 8\" is true. Returning: FFX_ERROR_OUT_OF_RANGE"
                         ,0,0);
        goto LAB_001007ad;
      }
    ...
    if (pvVar6 == (void *)0x0) {
      ...
      *(uint *)(param_4 + 3) = uVar8;
      if (2 < uVar8) {
        _err_print_error("create_pipeline_rd","servers/rendering/renderer_rd/effects/fsr2.cpp",0x147
                         ,
                         "Condition \"p_out_pipeline->constCount > 2\" is true. Returning: FFX_ERROR_OUT_OF_RANGE"
                         ,0,0);
        goto LAB_001007ad;
      }
      sVar13 = (uVar5 & 0xffffffff) * 0x108;
    ...
    *(uint *)((long)param_4 + 0x14) = uVar8;
    ...
    _err_print_error("create_pipeline_rd","servers/rendering/renderer_rd/effects/fsr2.cpp",0x13f,
                     "Condition \"p_out_pipeline->srvCount > 16\" is true. Returning: FFX_ERROR_OUT_OF_RANGE"
                     ,0,0);
LAB_001007ad:
    uVar10 = 0x8000000b;
  }
...
/* get_resource_rd(RID*, wchar_t const*) */

RID * get_resource_rd(RID *param_1,wchar_t *param_2)
...
/* create_backend_context_rd(FfxFsr2Interface*, void*) */

undefined8 create_backend_context_rd(FfxFsr2Interface *param_1,void *param_2)
...
LAB_00100ba0:
  ...
  _err_print_error("create_backend_context_rd","servers/rendering/renderer_rd/effects/fsr2.cpp",0xb5
                   ,
                   "Condition \"scratch.ubo_ring_buffer[i].is_null()\" is true. Returning: FFX_ERROR_BACKEND_API_ERROR"
                   ,0,0);
  uVar4 = 0x8000000d;
  goto LAB_00100ba0;
}
...
/* CowData<FfxResourceBinding>::_ref(CowData<FfxResourceBinding> const&) [clone .part.0] */

void __thiscall
CowData<FfxResourceBinding>::_ref(CowData<FfxResourceBinding> *this,CowData *param_1)
...
/* CowData<FfxResourceBinding>::_copy_on_write() [clone .isra.0] */

void __thiscall CowData<FfxResourceBinding>::_copy_on_write(CowData<FfxResourceBinding> *this)
...
/* destroy_resource_rd(FfxFsr2Interface*, FfxResourceInternal) */

undefined8 destroy_resource_rd(long param_1,uint param_2)

{
  ...
  if (*(uint *)this <= param_2) {
    _err_print_index_error
              ("operator[]","./core/templates/local_vector.h",0xb2,(ulong)param_2,
               (ulong)*(uint *)this,"p_index","count","",false,true);
    _err_flush_stdout();
                    /* WARNING: Does not return */
  ...
  _err_print_index_error
            ("operator[]","./core/templates/local_vector.h",0xb2,uVar3,(ulong)*(uint *)this,
             "p_index","count","",false,true);
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar1 = (code *)invalidInstructionException();
...
/* unregister_resources_rd(FfxFsr2Interface*) */

undefined8 unregister_resources_rd(FfxFsr2Interface *param_1)

{
  ...
  if (uVar1 != 0) {
    ...
    uVar4 = uVar4 >> 4 | uVar4;
    uVar4 = uVar4 | uVar4 >> 8;
    puVar5 = (uint *)Memory::realloc_static
                               ((void *)0x0,(ulong)((uVar4 | uVar4 >> 0x10) + 1) << 2,false);
    if (puVar5 == (uint *)0x0) {
...
/* RendererRD::FSR2Effect::~FSR2Effect() */

void __thiscall RendererRD::FSR2Effect::~FSR2Effect(FSR2Effect *this)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* RendererRD::FSR2Effect::upscale(RendererRD::FSR2Effect::Parameters const&) */

void __thiscall RendererRD::FSR2Effect::upscale(FSR2Effect *this,Parameters *param_1)

{
  ...
  if (iVar2 != 0) {
    _err_print_error("upscale","servers/rendering/renderer_rd/effects/fsr2.cpp",0x376,
                     "Condition \"result != FFX_OK\" is true.",0,0);
  }
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
  }
...
/* register_resource_rd(FfxFsr2Interface*, FfxResource const*, FfxResourceInternal*) */

undefined8
register_resource_rd(FfxFsr2Interface *param_1,FfxResource *param_2,FfxResourceInternal *param_3)

{
  ...
  if (plVar1 == (long *)0x0) {
    *(undefined4 *)param_3 = 0xffffffff;
    ...
    if (*plVar1 == 0) {
      _err_print_error("register_resource_rd","servers/rendering/renderer_rd/effects/fsr2.cpp",0x104
                       ,"Condition \"rid.is_null()\" is true. Returning: FFX_ERROR_INVALID_ARGUMENT"
                       ,0,0);
      return 0x8000000a;
    }
    uVar2 = RendererRD::FSR2Context::Resources::add
                      (*(undefined8 *)(param_1 + 0x60),*plVar1,1,0xffffffff,in_R8,in_R9,
                       *(undefined8 *)(param_2 + 0x108),(int)*(undefined8 *)(param_2 + 0x110),
                       (int)((ulong)*(undefined8 *)(param_2 + 0x114) >> 0x20),
                       (int)((ulong)*(undefined8 *)(param_2 + 0x11c) >> 0x20));
...
/* RendererRD::FSR2Context::~FSR2Context() */

void __thiscall RendererRD::FSR2Context::~FSR2Context(FSR2Context *this)

{
  ...
  if (*(long *)(this + 0x18) != 0) {
    LocalVector<LocalVector<RID,unsigned_int,false,false>,unsigned_int,false,false>::resize
              ((LocalVector<LocalVector<RID,unsigned_int,false,false>,unsigned_int,false,false> *)
               (this + 0x10),0);
...
/* RendererRD::FSR2Effect::create_context(Vector2i, Vector2i) */
...

{
  ...
  *(undefined8 *)(this_00 + 0x4e8) = 0;
  ...
  for (uVar2 = (ulong)(((int)this_00 -
                       (int)(undefined8 *)((ulong)(this_00 + 0x78) & 0xfffffffffffffff8)) + 0x4f0U
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* execute_gpu_job_compute_rd(RendererRD::FSR2Context::Scratch&, FfxComputeJobDescription const&) */

undefined8 execute_gpu_job_compute_rd(Scratch *param_1,FfxComputeJobDescription *param_2)

{
  ...
  if (UniformSetCacheRD::singleton == (UniformSetCacheRD *)0x0) {
    _err_print_error("execute_gpu_job_compute_rd","servers/rendering/renderer_rd/effects/fsr2.cpp",
                     0x185,"Parameter \"uniform_set_cache\" is null.",0,0);
    uVar8 = 0x8000000d;
  }
  else {
    plVar4 = *(long **)param_2;
    if (*plVar4 == 0) {
      _err_print_error("execute_gpu_job_compute_rd","servers/rendering/renderer_rd/effects/fsr2.cpp"
                       ,0x188,
                       "Condition \"root_signature.shader_rid.is_null()\" is true. Returning: FFX_ERROR_INVALID_ARGUMENT"
                       ,0,0);
    }
    else {
        ...
        if ((char)*in_FS_OFFSET == '\0') {
          ...
          *(undefined1 *)in_FS_OFFSET = 1;
          __cxa_thread_atexit(LocalVector<RenderingDevice::Uniform,unsigned_int,false,false>::
                              ~LocalVector,uVar8,&__dso_handle);
          uVar21 = *in_FS_OFFSET;
        }
        else {
          uVar21 = *in_FS_OFFSET;
...
LAB_0010279f:
          ...
          local_88 = lVar22;
          local_58 = lVar15;
          uVar13 = UniformSetCacheRD::get_cache<RenderingDevice::Uniform,RenderingDevice::Uniform>
                             (pUVar7,*plVar4,0,&local_98,&local_68);
          ...
          RenderingDevice::compute_list_dispatch
                    (lVar22,(uint)uVar8,*(uint *)(param_2 + 0x1af0),*(uint *)(param_2 + 0x1af4));
          RenderingDevice::get_singleton();
        ...
        lVar22 = 0;
LAB_00102354:
        uVar21 = *(uint *)(param_2 + lVar22 * 4 + 0x2b3c);
        uVar17 = (ulong)*(uint *)param_1;
...
LAB_00102260:
            _err_print_index_error
                      ("operator[]","./core/templates/local_vector.h",0xb2,uVar11,uVar17,"p_index",
                       "count","",false,true);
            _err_flush_stdout();
                    /* WARNING: Does not return */
            pcVar6 = (code *)invalidInstructionException();
            ...
            if (uVar16 != 0) {
              ...
              if (puVar19[1] < uVar16) {
                ...
                *(long *)(puVar19 + 2) = lVar9;
                if (lVar9 == 0) {
                  _err_print_error("resize","./core/templates/local_vector.h",0xa3,
                                   "FATAL: Condition \"!data\" is true.","Out of memory",0,0,pvVar12
                                  );
                  _err_flush_stdout();
                    /* WARNING: Does not return */
                  pcVar6 = (code *)invalidInstructionException();
...
LAB_001023e4:
                memset((void *)(*(long *)(puVar19 + 2) + (ulong)uVar21 * 8),0,
                       (ulong)(uVar18 - uVar21) * 8 + 8);
              }
              *puVar19 = uVar16;
              goto LAB_00102430;
            }
...
LAB_00102430:
            if (uVar14 < uVar16) {
              ...
              if (lVar9 == 0) {
                ...
                lVar9 = RenderingDevice::texture_create_shared_from_slice
                                  (uVar8,&local_68,lVar15,0,
                                   *(undefined4 *)(param_2 + lVar22 * 4 + 0x2b5c),1,0,0);
                ...
                if (uVar21 < *puVar19) {
                  *(long *)(*(long *)(puVar19 + 2) + (ulong)uVar21 * 8) = lVar9;
                  ...
                  _err_print_error("execute_gpu_job_compute_rd",
                                   "servers/rendering/renderer_rd/effects/fsr2.cpp",0x1a8,
                                   "Condition \"mip_slice_rids[p_job.uavMip[i]].is_null()\" is true. Returning: FFX_ERROR_BACKEND_API_ERROR"
                                   ,0,0);
                  uVar8 = 0x8000000d;
                  goto LAB_001026d2;
                }
          ...
          _err_print_error("execute_gpu_job_compute_rd",
                           "servers/rendering/renderer_rd/effects/fsr2.cpp",0x1a2,
                           "Condition \"p_job.uavMip[i] >= mip_slice_rids.size()\" is true. Returning: FFX_ERROR_INVALID_ARGUMENT"
                           ,0,0);
          uVar8 = 0x8000000a;
          goto LAB_001026d2;
        }
LAB_001024f3:
      ...
      _err_print_error("execute_gpu_job_compute_rd","servers/rendering/renderer_rd/effects/fsr2.cpp"
                       ,0x18b,
                       "Condition \"backend_pipeline.pipeline_rid.is_null()\" is true. Returning: FFX_ERROR_INVALID_ARGUMENT"
                       ,0,0);
    }
    uVar8 = 0x8000000a;
  }
...
/* execute_gpu_jobs_rd(FfxFsr2Interface*, void*) */

undefined8 execute_gpu_jobs_rd(FfxFsr2Interface *param_1,void *param_2)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (param_1 == (FfxFsr2Interface *)0x0) {
    _err_print_error("execute_gpu_jobs_rd","servers/rendering/renderer_rd/effects/fsr2.cpp",0x1cb,
                     "Parameter \"p_backend_interface\" is null.",0,0);
    uVar9 = 0x8000000a;
  }
  else {
...
LAB_00102b9b:
          ...
          if (uVar14 <= uVar3) goto LAB_00102d1d;
          if (*piVar2 == 0) {
            _err_print_error("execute_gpu_job_copy_rd",
                             "servers/rendering/renderer_rd/effects/fsr2.cpp",0x179,
                             "Condition \"src_desc.type == FFX_RESOURCE_TYPE_BUFFER\" is true. Returning: FFX_ERROR_INVALID_ARGUMENT"
                             ,0,0);
            goto LAB_00102aa4;
          }
          if (*(int *)(*(long *)(pSVar4 + 0x38) + uVar17 * 0x1c) == 0) {
            _err_print_error("execute_gpu_job_copy_rd",
                             "servers/rendering/renderer_rd/effects/fsr2.cpp",0x17a,
                             "Condition \"dst_desc.type == FFX_RESOURCE_TYPE_BUFFER\" is true. Returning: FFX_ERROR_INVALID_ARGUMENT"
                             ,0,0);
            goto LAB_00102aa4;
          }
          if (piVar2[5] != 0) {
            ...
            do {
              ...
              uVar14 = uVar7 + 1;
              RenderingDevice::texture_copy
                        (uVar12,uVar9,uVar11,&local_58,&local_68,puVar18,uVar7,uVar7,0,0,puVar18);
              uVar7 = uVar14;
...
LAB_00102d1d:
          _err_print_index_error
                    ("operator[]","./core/templates/local_vector.h",0xb2,uVar10,uVar16,"p_index",
                     "count","",false,true);
          _err_flush_stdout();
                    /* WARNING: Does not return */
          pcVar6 = (code *)invalidInstructionException();
        ...
        _err_print_error("execute_gpu_job_clear_float_rd",
                         "servers/rendering/renderer_rd/effects/fsr2.cpp",0x16b,
                         "Condition \"desc.type == FFX_RESOURCE_TYPE_BUFFER\" is true. Returning: FFX_ERROR_INVALID_ARGUMENT"
                         ,0,0);
      }
LAB_00102aa4:
      uVar9 = 0x8000000a;
LAB_00102aa9:
      if (*(int *)(pSVar4 + 0x60) != 0) {
        *(undefined4 *)(pSVar4 + 0x60) = 0;
      }
    }
  }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* create_resource_rd(FfxFsr2Interface*, FfxCreateResourceDescription const*, FfxResourceInternal*)
    */

undefined8
create_resource_rd(FfxFsr2Interface *param_1,FfxCreateResourceDescription *param_2,
                  FfxResourceInternal *param_3)
    ...
    if (iVar4 - 1U < 3) {
      ...
      if (iVar19 == 0) {
        ...
        if ((double)((ulong)dVar22 & _LC125) < _LC121) {
          iVar19 = (int)(long)((double)((ulong)((double)(long)dVar22 -
                                               (double)(-(ulong)(dVar22 < (double)(long)dVar22) &
                                                       (ulong)_LC123)) | ~_LC125 & (ulong)dVar22) +
                              _LC123);
        }
        else {
...
LAB_00103538:
        ...
        iVar9 = CowData<Vector<unsigned_char>>::resize<false>
                          ((CowData<Vector<unsigned_char>> *)&local_d0,lVar11);
        if (iVar9 == 0) {
          if (local_d0 == 0) {
            lVar20 = -1;
            lVar11 = 0;
            ...
            if (-1 < lVar20) {
              CowData<Vector<unsigned_char>>::_copy_on_write
                        ((CowData<Vector<unsigned_char>> *)&local_d0);
              lVar11 = lVar20 * 0x10 + local_d0;
              if (*(ulong **)(lVar11 + 8) != local_100) {
                CowData<unsigned_char>::_ref
                          ((CowData<unsigned_char> *)(lVar11 + 8),(CowData *)&uStack_80);
              }
              goto LAB_001032ea;
            }
          }
          _err_print_index_error
                    ("set","./core/templates/cowdata.h",0xcf,lVar20,lVar11,"p_index","size()","",
                     false,false);
        }
        else {
          _err_print_error("push_back","./core/templates/vector.h",0x142,
...
LAB_001032ea:
      ...
      if (lVar11 == 0) {
        uVar17 = 0x8000000d;
        _err_print_error("create_resource_rd","servers/rendering/renderer_rd/effects/fsr2.cpp",0xf1,
                         "Condition \"texture.is_null()\" is true. Returning: FFX_ERROR_BACKEND_API_ERROR"
                         ,0,0);
      }
      else {
        local_e0[0] = 0;
        ...
        uVar17 = 0;
        uVar8 = RendererRD::FSR2Context::Resources::add
                          (uVar6,lVar11,0,*(undefined4 *)(param_2 + 0x3c));
    ...
    _err_print_error("create_resource_rd","servers/rendering/renderer_rd/effects/fsr2.cpp",0xd7,
                     "Condition \"res_desc.type != FFX_RESOURCE_TYPE_TEXTURE1D && res_desc.type != FFX_RESOURCE_TYPE_TEXTURE2D && res_desc.type != FFX_RESOURCE_TYPE_TEXTURE3D\" is true. Returning: FFX_ERROR_INVALID_ARGUMENT"
                     ,0,0);
  }
  else {
    _err_print_error("create_resource_rd","servers/rendering/renderer_rd/effects/fsr2.cpp",0xd0,
                     "Condition \"p_create_resource_description->heapType != FFX_HEAP_TYPE_DEFAULT\" is true. Returning: FFX_ERROR_INVALID_ARGUMENT"
                     ,0,0);
  }
  uVar17 = 0x8000000a;
LAB_00103114:
...

{
  ...
  bVar19 = 0;
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  {unnamed_type#1}::FSR2Effect((_unnamed_type_1_ *)this);
  pFVar7 = this + 0xd38;
  do {
    *(undefined4 *)(pFVar7 + 0x18) = 0;
    pFVar8 = pFVar7 + 0x58;
    *(undefined1 (*) [16])(pFVar7 + 8) = (undefined1  [16])0x0;
    *(undefined8 *)(pFVar7 + 0x20) = 0;
    *(undefined8 *)(pFVar7 + 0x30) = 0;
    *(undefined8 *)(pFVar7 + 0x40) = 0;
    *(undefined8 *)(pFVar7 + 0x50) = 0;
    pFVar7 = pFVar8;
...
LAB_00105c83:
        ...
        *puVar12 = *puVar15;
        ...
        for (uVar14 = (ulong)((int)lVar13 + 0x108U >> 3); puVar15 = puStack_ce0, uVar14 != 0;
            uVar14 = uVar14 - 1) {
          *puVar12 = *puVar16;
...
LAB_00105501:
  ...
  *(undefined8 *)(this + 0xe48) = uVar9;
  puStack_ce0 = (undefined8 *)0x0;
  iVar6 = CowData<FfxResourceBinding>::resize<false>
                    ((CowData<FfxResourceBinding> *)&puStack_ce0,0xc);
  puVar15 = puStack_ce0;
  if (iVar6 == 0) {
    lVar10 = 0;
    lVar17 = 0;
...
LAB_001057a9:
  ...
  *(undefined8 *)(this + 0xe98) = *(undefined8 *)(this + 0xe40);
  *(undefined8 *)(this + 0xea0) = *(undefined8 *)(this + 0xe48);
  *(undefined8 *)(this + 0xea8) = *(undefined8 *)(this + 0xe50);
  *(undefined4 *)(this + 0xeb0) = *(undefined4 *)(this + 0xe58);
  *(undefined8 *)(this + 0xeb8) = *(undefined8 *)(this + 0xe60);
  if (*(long *)(this + 0xec8) != *(long *)(this + 0xe70)) {
    CowData<FfxResourceBinding>::_ref
              ((CowData<FfxResourceBinding> *)(this + 0xec8),(CowData *)(this + 0xe70));
  }
  if (*(long *)(this + 0xed8) != *(long *)(this + 0xe80)) {
    CowData<FfxResourceBinding>::_ref
              ((CowData<FfxResourceBinding> *)(this + 0xed8),(CowData *)(this + 0xe80));
  }
  if (*(long *)(this + 0xee8) != *(long *)(this + 0xe90)) {
    CowData<FfxResourceBinding>::_ref
              ((CowData<FfxResourceBinding> *)(this + 0xee8),(CowData *)(this + 0xe90));
  }
  lVar10 = local_d10;
...
LAB_0010534f:
    ...
    *(long *)(this + 0x1060) = lVar10;
    if (lVar10 == 0) {
      _err_print_error("FSR2Effect","servers/rendering/renderer_rd/effects/fsr2.cpp",0x319,
                       "Condition \"device.point_clamp_sampler.is_null()\" is true.",0,0);
    }
    else {
      ...
      *(long *)(this + 0x1068) = lVar10;
      if (lVar10 == 0) {
        _err_print_error("FSR2Effect","servers/rendering/renderer_rd/effects/fsr2.cpp",0x31e,
                         "Condition \"device.linear_clamp_sampler.is_null()\" is true.",0,0);
      }
    }
...
void __thiscall
Fsr2DepthClipPassShaderRD::~Fsr2DepthClipPassShaderRD(Fsr2DepthClipPassShaderRD *this)
...
void __thiscall
Fsr2ReconstructPreviousDepthPassShaderRD::~Fsr2ReconstructPreviousDepthPassShaderRD
          (Fsr2ReconstructPreviousDepthPassShaderRD *this)
...
void __thiscall Fsr2LockPassShaderRD::~Fsr2LockPassShaderRD(Fsr2LockPassShaderRD *this)
...
void __thiscall
Fsr2AccumulatePassShaderRD::~Fsr2AccumulatePassShaderRD(Fsr2AccumulatePassShaderRD *this)
...
void __thiscall Fsr2RcasPassShaderRD::~Fsr2RcasPassShaderRD(Fsr2RcasPassShaderRD *this)
...
void __thiscall
Fsr2ComputeLuminancePyramidPassShaderRD::~Fsr2ComputeLuminancePyramidPassShaderRD
          (Fsr2ComputeLuminancePyramidPassShaderRD *this)
...
void __thiscall
Fsr2AutogenReactivePassShaderRD::~Fsr2AutogenReactivePassShaderRD
          (Fsr2AutogenReactivePassShaderRD *this)
...
void __thiscall
Fsr2TcrAutogenPassShaderRD::~Fsr2TcrAutogenPassShaderRD(Fsr2TcrAutogenPassShaderRD *this)
...
void __thiscall RendererRD::FSR2Context::Resources::remove(Resources *this,uint param_1)

{
  ...
  *(uint *)((long)pvVar5 + (ulong)uVar9 * 4) = param_1;
          ...
          if (uVar9 != 0) {
            do {
              if (*(uint *)(lVar2 + uVar6 * 4) == param_1) {
                ...
                if (uVar9 <= (uint)uVar6) {
                  _err_print_index_error
                            ("remove_at","./core/templates/local_vector.h",0x4c,uVar6,(ulong)uVar9,
  ...
  _err_print_index_error
            ("operator[]","./core/templates/local_vector.h",0xb2,uVar8,uVar6,"p_index","count","",
             false,true);
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar3 = (code *)invalidInstructionException();
...
void __thiscall RendererRD::FSR2Effect::{unnamed_type#1}::FSR2Effect(_unnamed_type_1_ *this)
...
void __thiscall
LocalVector<LocalVector<RID,unsigned_int,false,false>,unsigned_int,false,false>::resize
          (LocalVector<LocalVector<RID,unsigned_int,false,false>,unsigned_int,false,false> *this,
          uint param_1)
...
uint RendererRD::FSR2Context::Resources::add
               (uint *param_1,undefined8 param_2,char param_3,undefined4 param_4,undefined8 param_5,
               undefined8 param_6,undefined8 param_7,undefined8 param_8,undefined1 param_9 [16])
...
LAB_00107994:
        memset((void *)(*(long *)(param_1 + 2) + (ulong)uVar3 * 8),0,(ulong)(uVar10 - uVar3) * 8 + 8
              );
      }
      *param_1 = uVar7;
      LocalVector<LocalVector<RID,unsigned_int,false,false>,unsigned_int,false,false>::resize
...
void __thiscall RendererRD::FSR2Context::Scratch::~Scratch(Scratch *this)
...
LAB_00109ec1:
  ...
  if ((*(long *)(param_4 + 8) != 0) &&
     (uVar7 = (uint)*(undefined8 *)(*(long *)(param_4 + 8) + -8), uVar7 != 0)) goto LAB_00109ead;
LAB_00109d50:
  lVar19 = local_48;
  lVar13 = local_58;
...
joined_r0x0010a903:
                  if (local_e8 != 0) goto LAB_0010a126;
                }
LAB_0010a5ea:
                lVar19 = local_58;
...
undefined8 __thiscall
CowData<FfxResourceBinding>::_realloc(CowData<FfxResourceBinding> *this,long param_1)
...
undefined8 __thiscall
CowData<FfxResourceBinding>::resize<false>(CowData<FfxResourceBinding> *this,long param_1)
...
void RendererRD::FSR2Effect::{unnamed_type#1}::FSR2Effect(void)

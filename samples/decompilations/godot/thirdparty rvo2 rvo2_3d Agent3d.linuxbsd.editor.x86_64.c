...
/* RVO3D::Agent3D::Agent3D() */

void __thiscall RVO3D::Agent3D::Agent3D(Agent3D *this)
...
/* RVO3D::Agent3D::computeNeighbors(RVO3D::RVOSimulator3D*) */

void __thiscall RVO3D::Agent3D::computeNeighbors(Agent3D *this,RVOSimulator3D *param_1)

{
  ...
  RVO3D::KdTree3D::computeAgentNeighbors
            (*(Agent3D **)(param_1 + 8),*(float *)(this + 0x4c) * *(float *)(this + 0x4c));
  return;
}



/* RVO3D::Agent3D::update(RVO3D::RVOSimulator3D*) */

void __thiscall RVO3D::Agent3D::update(Agent3D *this,RVOSimulator3D *param_1)

{
  ...
  *(ulong *)(this + 0xc) =
       CONCAT44((float)((ulong)*(undefined8 *)(this + 0xc) >> 0x20) +
                fVar1 * (float)((ulong)uVar2 >> 0x20),
                (float)*(undefined8 *)(this + 0xc) + fVar1 * (float)uVar2);
  return;
}
...
/* RVO3D::linearProgram1(std::vector<RVO3D::Plane, std::allocator<RVO3D::Plane> > const&, unsigned
   long, RVO3D::Line3D const&, float, RVO3D::Vector3 const&, bool, RVO3D::Vector3&) */

undefined8
RVO3D::linearProgram1
          (vector *param_1,ulong param_2,Line3D *param_3,float param_4,Vector3 *param_5,bool param_6
          ,Vector3 *param_7)

{
  ...
  if (0.0 <= fVar6) {
    ...
    if (param_2 != 0) {
      ...
      fVar13 = fVar12;
      do {
        fVar10 = (*pfVar3 - fVar1) * pfVar3[3] + (pfVar3[1] - fVar15) * pfVar3[4] +
                 (pfVar3[2] - fVar11) * pfVar3[5];
    ...
    if (param_6) {
      if (*(float *)param_5 * fVar8 + *(float *)(param_5 + 4) * fVar17 +
          *(float *)(param_5 + 8) * fVar2 <= 0.0) {
      ...
      fVar8 = (*(float *)param_5 - fVar1) * fVar8 + (*(float *)(param_5 + 4) - fVar15) * fVar17 +
              (*(float *)(param_5 + 8) - fVar11) * fVar2;
      if (fVar12 <= fVar8) {
        if (fVar8 <= fVar6) {
...
/* RVO3D::linearProgram2(std::vector<RVO3D::Plane, std::allocator<RVO3D::Plane> > const&, unsigned
   long, float, RVO3D::Vector3 const&, bool, RVO3D::Vector3&) */

undefined8
RVO3D::linearProgram2
          (vector *param_1,ulong param_2,float param_3,Vector3 *param_4,bool param_5,
          Vector3 *param_6)
...
LAB_00100768:
    ...
    if (param_5) {
      ...
      fVar14 = (*pfVar1 - fVar15) * fVar14 + (pfVar1[1] - fVar16) * fVar13 +
               (pfVar1[2] - fVar12) * fVar2;
    ...
    if (param_2 != 0) {
      ...
      do {
        ...
        fVar2 = pfVar7[4];
        fVar9 = pfVar7[5];
        if (0.0 < (*pfVar7 - *(float *)param_6) * fVar14 +
                  (pfVar7[1] - *(float *)(param_6 + 4)) * fVar2 +
                  (pfVar7[2] - *(float *)(param_6 + 8)) * fVar9) {
          fVar11 = pfVar1[3];
          fVar13 = pfVar1[4];
          fVar18 = pfVar1[5];
          ...
          fVar14 = ((*pfVar7 - *pfVar1) * fVar14 + (pfVar7[1] - pfVar1[1]) * fVar2 +
                   (pfVar7[2] - pfVar1[2]) * fVar9) /
                   (fVar14 * fVar13 + fVar2 * fVar11 + fVar9 * fVar12);
          fStack_3c = fVar13 * fVar14 + *pfVar1;
          local_38 = fVar11 * fVar14 + pfVar1[1];
          local_34 = fVar14 * fVar12 + pfVar1[2];
          cVar3 = linearProgram1(param_1,uVar5,(Line3D *)&local_48,param_3,param_4,SUB81(uVar6,0),
                                 param_6);
...
/* RVO3D::linearProgram3(std::vector<RVO3D::Plane, std::allocator<RVO3D::Plane> > const&, float,
   RVO3D::Vector3 const&, bool, RVO3D::Vector3&) */

ulong RVO3D::linearProgram3
                (vector *param_1,float param_2,Vector3 *param_3,bool param_4,Vector3 *param_5)
  ...
  *(float *)(param_5 + 8) = fVar8;
  ...
  if (uVar4 != 0) {
    ...
    do {
      ...
      if ((0.0 < (*pfVar6 - fVar1) * pfVar6[3] + (pfVar6[1] - fVar8) * pfVar6[4] +
                 (pfVar6[2] - fVar9) * pfVar6[5]) &&
         (cVar3 = linearProgram2(param_1,uVar5,param_2,param_3,param_4,param_5), cVar3 == '\0')) {
        *(float *)param_5 = fVar1;
...
/* RVO3D::linearProgram4(std::vector<RVO3D::Plane, std::allocator<RVO3D::Plane> > const&, unsigned
   long, float, RVO3D::Vector3&) */

void RVO3D::linearProgram4(vector *param_1,ulong param_2,float param_3,Vector3 *param_4)
...
LAB_00100fd0:
  ...
  do {
    ...
    pfVar4 = pfVar2;
    if (fVar12 < (pfVar5[1] - *(float *)(param_4 + 4)) * pfVar5[4] +
                 (*pfVar5 - *(float *)param_4) * pfVar5[3] +
                 (pfVar5[2] - *(float *)(param_4 + 8)) * pfVar5[5]) {
...
LAB_00100ca1:
          ...
          fVar13 = ((*pfVar5 - *pfVar4) * fVar10 + (pfVar5[1] - pfVar4[1]) * fVar15 +
                   (pfVar5[2] - pfVar4[2]) * fVar16) /
                   (fVar15 * fVar19 + fVar10 * fVar11 + fVar16 * fVar14);
...
LAB_00100c23:
          ...
          uVar8 = uVar8 + 1;
          std::vector<RVO3D::Plane,std::allocator<RVO3D::Plane>>::
          _M_realloc_insert<RVO3D::Plane_const&>
                    ((vector<RVO3D::Plane,std::allocator<RVO3D::Plane>> *)local_78,puVar6,&local_58)
          ;
          pfVar2 = *(float **)param_1;
          pfVar4 = pfVar2 + param_2 * 6;
          puVar3 = local_68;
...
LAB_00100e68:
      ...
      fVar12 = (*pfVar4 - local_98) * pfVar4[3] + (pfVar4[1] - fStack_94) * pfVar4[4] +
               (pfVar4[2] - fVar12) * pfVar4[5];
      if (pvVar9 == (void *)0x0) {
        lVar7 = *(long *)(param_1 + 8);
        pfVar4 = pfVar2;
      }
...
/* RVO3D::Agent3D::computeNewVelocity(RVO3D::RVOSimulator3D*) */

void __thiscall RVO3D::Agent3D::computeNewVelocity(Agent3D *this,RVOSimulator3D *param_1)

{
  ...
  if (*(long *)(this + 0x68) != lVar4) {
    ...
    do {
      ...
      fVar18 = (float)((ulong)*(undefined8 *)(lVar4 + 0x10) >> 0x20) -
      ...
      if (fVar22 < fVar12) {
        ...
        fVar22 = fVar16 * fVar16 -
                 ((fVar11 * fVar11 + fVar7 * fVar7 + fVar9 * fVar9) -
                 (fVar20 * fVar20 + fVar15 * fVar15 + fVar21 * fVar21) / (fVar12 - fVar22)) * fVar12
        ;
        if (fVar22 < 0.0) {
          fVar22 = sqrtf(fVar22);
        }
...
LAB_00101281:
      ...
      if (pfVar3 == *(float **)(this + 0x88)) {
        std::vector<RVO3D::Plane,std::allocator<RVO3D::Plane>>::
        _M_realloc_insert<RVO3D::Plane_const&>
                  ((vector<RVO3D::Plane,std::allocator<RVO3D::Plane>> *)pvVar1,pfVar3,&local_48);
      }
      else {
        *pfVar3 = local_48;
        pfVar3[1] = fStack_44;
...
/* RVO3D::Agent3D::insertAgentNeighbor(RVO3D::Agent3D const*, float&) */

void __thiscall RVO3D::Agent3D::insertAgentNeighbor(Agent3D *this,Agent3D *param_1,float *param_2)

{
  ...
  if ((((this != param_1) && ((*(uint *)(this + 0x98) & *(uint *)(param_1 + 0x94)) != 0)) &&
      (*(float *)(this + 0x9c) < *(float *)(param_1 + 0x9c) ||
       *(float *)(this + 0x9c) == *(float *)(param_1 + 0x9c))) &&
     (fVar9 = (*(float *)(this + 0x10) - *(float *)(param_1 + 0x10)) *
              (*(float *)(this + 0x10) - *(float *)(param_1 + 0x10)) +
              (*(float *)(this + 0xc) - *(float *)(param_1 + 0xc)) *
              (*(float *)(this + 0xc) - *(float *)(param_1 + 0xc)) +
              (*(float *)(this + 0x14) - *(float *)(param_1 + 0x14)) *
              (*(float *)(this + 0x14) - *(float *)(param_1 + 0x14)), fVar9 < *param_2)) {
    ...
    if (uVar5 < uVar8) {
      ...
      if (puVar1 == *(undefined8 **)(this + 0x70)) {
        std::
        vector<std::pair<float,RVO3D::Agent3D_const*>,std::allocator<std::pair<float,RVO3D::Agent3D_const*>>>
        ::_M_realloc_insert<std::pair<float,RVO3D::Agent3D_const*>>
                  ((vector<std::pair<float,RVO3D::Agent3D_const*>,std::allocator<std::pair<float,RVO3D::Agent3D_const*>>>
                    *)(this + 0x60),puVar1,&local_38);
...
/* void std::vector<RVO3D::Plane, std::allocator<RVO3D::Plane> >::_M_realloc_insert<RVO3D::Plane
   const&>(__gnu_cxx::__normal_iterator<RVO3D::Plane*, std::vector<RVO3D::Plane,
   std::allocator<RVO3D::Plane> > >, RVO3D::Plane const&) */

void __thiscall
std::vector<RVO3D::Plane,std::allocator<RVO3D::Plane>>::_M_realloc_insert<RVO3D::Plane_const&>
          (vector<RVO3D::Plane,std::allocator<RVO3D::Plane>> *this,undefined8 *param_2,
          undefined8 *param_3)
...
LAB_001017fb:
  ...
  *puVar7 = uVar2;
  ...
  if (param_2 != puVar1) {
    uVar5 = 0;
    uVar9 = ((ulong)((long)param_2 + (-0x18 - (long)puVar1)) >> 3) * 0xaaaaaaaaaaaaaab &
            0x1fffffffffffffff;
    puVar10 = puVar1;
    puVar7 = puVar6;
    do {
  ...
  if (param_2 != puVar8) {
    uVar5 = 0;
    uVar9 = (((ulong)((long)puVar8 + (-0x18 - (long)param_2)) >> 3) * 0xaaaaaaaaaaaaaab &
...
/* WARNING: Control flow encountered bad instruction data */
/* void std::vector<std::pair<float, RVO3D::Agent3D const*>, std::allocator<std::pair<float,
   ...
   RVO3D::Agent3D const*> > > >, std::pair<float, RVO3D::Agent3D const*>&&) */

...
LAB_00101aa7:
    if (uVar4 == 0x10) goto LAB_00101b60;
...
joined_r0x00101b9a:
    if ((lVar10 != 0) && (lVar10 = *(long *)(lVar10 + 8), lVar10 != 0)) goto LAB_00101bad;
  }
  else {
...
LAB_00101b93:
    ...
    if ((*(long *)(pTVar7 + 0x60) == 0) ||
       (lVar10 = *(long *)(*(long *)(pTVar7 + 0x60) + 8), lVar10 == 0)) goto LAB_00101c5a;
LAB_00101bad:
    piVar5 = *(int **)(lVar10 + 8);
...
LAB_0010e57b:
        if (uVar16 == 0x10) goto LAB_0010e62e;
...
LAB_0010e67f:
              if (uVar11 == 0x10) goto LAB_0010e73d;
...
LAB_0010e794:
                    if (uVar19 == 0x10) goto LAB_0010e85a;
...
LAB_0010e8b2:
                          if (uVar12 == 0x10) goto LAB_0010e988;
...
LAB_0010e9e1:
                                if (uVar15 == 0x10) goto LAB_0010eab0;
...
LAB_0010eb06:
                                      if (uVar24 == 0x10) goto LAB_0010ebd0;
...
LAB_0010ec26:
                                            if (uVar14 == 0x10) goto LAB_0010ecf0;
                                          ...
                                          if ((plVar9[0xc] != 0) &&
                                            ...
                                            if (iVar13 < 1) {
                                              ...
                                              if (((int)(piVar1 + (ulong)(iVar13 - 1) * 4) -
                                                   (int)piVar17 & 0x10U) == 0) goto LAB_0010eca2;
                                              iVar18 = *piVar17;
                                              for (piVar17 = piVar1;
...
/* WARNING: Removing unreachable block (ram,0x00111c7e) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
    ...
    if ((0x7fffffffffffffff - local_58 < uVar11) ||
       (std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::
        _M_append((basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> *)
                  &local_68,pcVar3,uVar11), uVar11 = local_58, uVar4 = _UNK_00115e48,
       0x7fffffffffffffff - local_58 < 0x10)) goto LAB_001118ab;
    uVar9 = local_58 + 0x10;
    uVar10 = local_50[0];
      ...
      if ((((*(int *)((long)param_2 + 0x24) != -1) ||
        ...
        if (((((*(char *)((long)param_2 + 0x3c) == '\0') &&
          ...
          if (((uVar16 & 0x3fff0) == 0) &&
             ...
             (uVar7 & 0x7ffc) == 0)) goto LAB_00112845;
        }
        goto LAB_00112510;
      }
    }
...
LAB_00112870:
      if (-1 < (char)bVar6) goto LAB_00112878;
LAB_001149b0:
      uVar20 = *(ulong *)(param_1 + 0x10);
...
LAB_00112868:
      if ((bVar6 & 0x40) == 0) goto LAB_00112870;
LAB_00114994:
      std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::append
                (param_1," smooth");
...
LAB_001128c2:
      if ((bVar6 & 0x20) == 0) goto LAB_001128ca;
LAB_00114435:
      std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::append
                (param_1," sample");
...
LAB_001128d7:
      if ((bVar6 & 8) == 0) goto LAB_001128df;
LAB_001144b9:
      uVar20 = *(ulong *)(param_1 + 0x10);
...
LAB_001128e7:
      if ((bVar6 & 0x20) == 0) goto LAB_001128ef;
LAB_00114594:
      uVar4 = _UNK_00115e68;
      uVar9 = __LC500;
      uVar20 = *(ulong *)(param_1 + 0x10);
...
LAB_001128f7:
      if (-1 < (char)bVar6) goto LAB_001128ff;
LAB_00114665:
      std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::append
                (param_1," shadercallcoherent");
      if ((*(byte *)((long)param_2 + 0x1f) & 1) != 0) goto LAB_0011467f;
LAB_0011290a:
      if ((*(byte *)((long)param_2 + 0x1e) & 4) == 0) goto LAB_00112915;
LAB_00114699:
      std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::append
                (param_1," volatile");
      bVar6 = *(byte *)((long)param_2 + 0x1d);
...
LAB_00112922:
      if (-1 < (char)bVar6) goto LAB_0011292a;
LAB_001146d1:
      uVar20 = *(ulong *)(param_1 + 0x10);
      if (0x7fffffffffffffff - uVar20 < 9) goto LAB_00115757;
      if (pbVar1 == *(basic_string<char,std::char_traits<char>,glslang::std::allocator<char>> **)
...
LAB_001128ba:
      if ((bVar6 & 0x10) == 0) goto LAB_001128c2;
LAB_00114419:
      std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::append
                (param_1," patch");
...
LAB_001128df:
      if ((bVar6 & 0x10) == 0) goto LAB_001128e7;
LAB_0011452b:
      uVar4 = _UNK_00115e58;
      uVar9 = __LC499;
      uVar20 = *(ulong *)(param_1 + 0x10);
...
LAB_001128ef:
      if ((bVar6 & 0x40) == 0) goto LAB_001128f7;
LAB_001145ff:
      uVar4 = _UNK_00115e78;
      uVar9 = __LC501;
      uVar20 = *(ulong *)(param_1 + 0x10);
...
LAB_001128ff:
      if ((*(byte *)((long)param_2 + 0x1f) & 1) == 0) goto LAB_0011290a;
LAB_0011467f:
      std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::append
                (param_1," nonprivate");
...
LAB_0011292a:
      if ((*(byte *)((long)param_2 + 0x1e) & 1) == 0) goto LAB_00112935;
LAB_00114737:
      std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::append
                (param_1," writeonly");
      bVar6 = *(byte *)((long)param_2 + 0x1c);
...
LAB_00112942:
      if ((bVar6 & 2) == 0) goto LAB_0011294a;
LAB_001147c3:
      uVar20 = *(ulong *)(param_1 + 0x10);
        ...
        while (_UNK_00115e98 = uVar9, lVar13 != 0) {
          ...
          if (iVar18 == 0 && (int)lVar21 == 0) {
            ...
            *(undefined1 *)(*(long *)(param_1 + 8) + 0x17 + uVar20) = 0;
            ...
            if (iVar18 == 0) {
LAB_0011308a:
              if (0x7fffffffffffffff - uVar20 < 8) goto LAB_00115757;
              if (pbVar1 == *(basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>
                              **)(param_1 + 8)) {
                uVar14 = 0xf;
              }
...
LAB_001136ff:
      if (param_2[0xd] == 0) goto LAB_00113950;
      uVar20 = 0;
      std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::append
                (param_1," ");
      std::__cxx11::basic_string<char,std::char_traits<char>,glslang::std::allocator<char>>::append
...

{
  ...
  if ((*(uint *)(in_RSI + 0xbc) == 0) ||
     (*(uint *)(in_RSI + 0xbc) == (*(byte *)(in_RSI + 0x3b) >> 1 & 7))) goto LAB_00115a38;

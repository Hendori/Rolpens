...

{
  ...
  if (uVar2 + 2 < 4) {
    if (uVar2 + 2 == 2) goto LAB_001015f0;
    goto LAB_001015de;
  }
  iVar3 = uVar2 - 2;
  dVar5 = dVar5 * _LC1;
  if (3 < iVar3) {
    if ((uVar2 - 2 >> 2 & 1) != 0) {
      iVar3 = uVar2 - 6;
      dVar5 = dVar5 * _LC1;
      if (iVar3 < 4) goto LAB_00101580;
    }
    do {
      iVar3 = iVar3 + -8;
      dVar5 = dVar5 * _LC1 * _LC1;
    } while (3 < iVar3);
  }
LAB_00101580:
  uVar1 = uVar2 - 2 & 3;
...

{
  ...
  if (param_1 < 0xd800) {
    ...
    lVar3 = 0x2618;
    if (0x10ffff < param_1) goto LAB_0010172d;
    lVar3 = (long)(int)((uint)*(ushort *)
                               (propsTrie_index + (long)(((int)param_1 >> 0xb) + 0x820) * 2) +
                       (uVar2 & 0x3f));
  }
...

{
  ...
  (*(code *)param_1[1])(*param_1,0x34f);
                    /* WARNING: Could not recover jumptable at 0x00101bcb. Too many branches */

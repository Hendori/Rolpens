...
LAB_00100e00:
        ...
        do {
          ...
          *(uint *)(param_1 + uVar7 * 4) =
               ...
               (int)((float)((((param_4 + -1) - iVar3) + 0x7f) * 0x800000) * param_5[uVar7] +
                    (float)(~uVar11 & uVar1 | uVar2 & uVar11)) & 0xffffffU;
          uVar7 = uVar7 + 1;
        } while (param_3 != uVar7);
      }
    ...
    if (param_6 == 0) {
      ...
      if (param_3 != 0) {
        do {
          iVar6 = 0;
          if ((param_5[uVar7] != 0.0) &&
             (iVar6 = ((uint)param_5[uVar7] >> 0x17 & 0xff) - 0x7e, iVar6 < -100)) {
            iVar6 = -100;
          }
      ...
      if (param_3 != 0) {
        do {
          iVar6 = 0;
          if ((param_5[uVar7] != 0.0) &&
             (iVar6 = ((uint)param_5[uVar7] >> 0x17 & 0xff) - 0x7e, iVar6 < 0)) {
            iVar6 = 0;
          }
          local_138[uVar7] = iVar6;
          uVar7 = uVar7 + 1;

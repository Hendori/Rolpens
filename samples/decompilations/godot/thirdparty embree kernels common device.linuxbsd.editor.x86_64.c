...
/* std::ios::widen(char) const [clone .isra.0] */

code * __thiscall std::ios::widen(ios *this,char param_1)
...
_M_emplace_hint_unique<std::piecewise_construct_t_const&,std::tuple<embree::Device*&&>,std::tuple<>>
          (long param_1,_Rb_tree_node_base *param_2,undefined8 *param_3)
  ...
  *(ulong *)(p_Var5 + 0x20) = uVar3;
  ...
  if (p_Var1 == param_2) {
    if ((*(long *)(param_1 + 0x28) == 0) ||
       (uVar3 <= *(ulong *)(*(_Rb_tree_node_base **)(param_1 + 0x20) + 0x20))) {
...
LAB_001004da:
          param_2 = (_Rb_tree_node_base *)std::_Rb_tree_decrement(p_Var9);
  ...
  bVar10 = uVar3 < uVar8;
LAB_0010039a:
  std::_Rb_tree_insert_and_rebalance(bVar10,p_Var5,param_2,p_Var1);
        ...
        if (plVar1 != (long *)0x0) {
          ...
          if (local_138 != &local_128) {
            operator_delete(local_138,
                            CONCAT17(uStack_121,CONCAT43(uStack_125,CONCAT21(uStack_127,local_128)))
                            + 1);
          }
          std::__ostream_insert<char,std::char_traits<char>>
                    ...
                    do {
                      ...
                      if (uVar8 < 1000000) {
                        std::__cxx11::string::_M_construct
                                  ((ulong)&local_138,('\x05' - cVar4) + (char)uVar11);
                        goto LAB_00100f2a;
                      }
                      if (uVar8 < 10000000) {
                        uVar12 = uVar11 + 6;
...
LAB_00100ef8:
                  std::__cxx11::string::_M_construct((ulong)&local_138,(char)uVar12 - cVar4);
                  uVar12 = uVar11;
LAB_00100f2a:
                  pcVar9 = local_138 + lVar7;
                  local_118 = __LC39;
                  ...
                  do {
                    ...
                    uVar13 = (uVar8 >> 2) / 0x19;
                    lVar7 = (uVar8 + ((SUB168(auVar3 * ZEXT816(0x28f5c28f5c28f5c3),8) &
                                      0xfffffffffffffffc) + uVar13) * -0x14) * 2;
            ...
            if (local_138 != &local_128) {
              operator_delete(local_138,
                              CONCAT17(uStack_121,
                                       CONCAT43(uStack_125,CONCAT21(uStack_127,local_128))) + 1);
            }
            std::__ostream_insert<char,std::char_traits<char>>
                      ((ostream *)&std::cout,"    ISA     : ",0xe);
            embree::stringOfCPUFeatures_abi_cxx11_(iVar10);
            ...
            if (plVar1 != (long *)0x0) {
              ...
              if (plVar1 != (long *)0x0) {
                ...
                if (((uVar15 == 0) || (uVar14 == 0)) &&
                  ...
                  poVar6 = std::endl<char,std::char_traits<char>>(poVar6);
                  std::__ostream_insert<char,std::char_traits<char>>
                            (poVar6,"           thread the following way:",0x24);
                  poVar6 = std::endl<char,std::char_traits<char>>(poVar6);
                  poVar6 = std::endl<char,std::char_traits<char>>(poVar6);
                  std::__ostream_insert<char,std::char_traits<char>>
                            (poVar6,"           #include \"xmmintrin.h\"",0x21);
                  poVar6 = std::endl<char,std::char_traits<char>>(poVar6);
                  std::__ostream_insert<char,std::char_traits<char>>
                            (poVar6,"           #include \"pmmintrin.h\"",0x21);
                  poVar6 = std::endl<char,std::char_traits<char>>(poVar6);
                  poVar6 = std::endl<char,std::char_traits<char>>(poVar6);
                  std::__ostream_insert<char,std::char_traits<char>>
                            (poVar6,"           _MM_SET_FLUSH_ZERO_MODE(_MM_FLUSH_ZERO_ON);",0x36);
                  poVar6 = std::endl<char,std::char_traits<char>>(poVar6);
                  std::__ostream_insert<char,std::char_traits<char>>
                            (poVar6,"           _MM_SET_DENORMALS_ZERO_MODE(_MM_DENORMALS_ZERO_ON);"
                             ,0x3e);
                  std::endl<char,std::char_traits<char>>(poVar6);
                  std::__ostream_insert<char,std::char_traits<char>>
                            ((ostream *)&std::cout,
...
LAB_00101ae1:
      if ((lVar5 == 0x1023e8) || (this < *(Device **)(lVar5 + 0x20))) goto LAB_00101a20;
    }
...
LAB_001019f9:
    if ((lVar5 == 0x1023e8) || (this < *(Device **)(lVar5 + 0x20))) goto LAB_00101990;
  }
  p_Var2 = (_Rb_tree_node_base *)g_num_threads_map._24_8_;

...
LAB_00109800:
        do {
          ...
          if (param_1 == 0) {
LAB_00109850:
            if (*(int *)(param_2 + 0x90) == 0x62697473) goto LAB_001099c9;
            goto LAB_00109860;
          }
...

{
  ...
  *(undefined1 (*) [16])(lVar3 + 0x110) = (undefined1  [16])0x0;
  ...
  if (((plVar15 == (long *)0x0) || ((param_3 & 0x8002) != 0)) ||
     (((uint)*(undefined8 *)(param_1 + 0x10) & 0x2001) != 1)) goto LAB_00109ba4;
  if ((param_3 & 0x800) == 0) {
...
LAB_00109de0:
  if (((param_3 & 0x20) == 0) && ((*(ulong *)*plVar4 & 0x400) != 0)) {
    ...
    if (((((uVar10 & 8) == 0) || (*(long *)(param_1 + 0x4f8) == 0)) ||
       ...
       ((*(long *)(param_1 + 0x458) != 0 || (*(long *)(param_1 + 0x468) != 0)))) goto LAB_00109ba4;
  }
  else {
LAB_00109deb:
    uVar10 = *(ulong *)(param_1 + 0x10);
...
LAB_0010b0d9:
                  if (*(long *)(psVar13 + 8) < 0) goto LAB_0010aebd;
                }
...
LAB_0010ab30:
        if ((char)uVar9 == '\x02') goto LAB_0010ab38;
      }
      uVar16 = uVar9 & 0xff;
...
LAB_0010b53d:
          if ((-1 < (long)param_3) && (param_3 == uVar10)) goto LAB_0010b682;
          uVar12 = uVar12 + 1;
        } while (uVar3 != uVar12);
        local_44 = 0x8e;
LAB_0010b62f:
          ...
          do {
            ...
            *(ulong *)(param_2 + 0x10) = uVar16;
            ...
            if (((local_64 != 0) || (0x7fffffff < uVar16)) ||
               (uVar4 = FT_Stream_ReadUShort(param_2,&local_64), local_64 != 0)) goto LAB_0010be3a;

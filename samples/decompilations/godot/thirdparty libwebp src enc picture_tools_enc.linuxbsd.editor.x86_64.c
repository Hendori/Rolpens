...
void WebPReplaceTransparentPixels(int *param_1,uint param_2)
      ...
      while( true ) {
        ...
        if (0 < iVar9) {
          do {
            ...
            if (bVar1 != 0xff) {
              *(char *)(lVar10 + lVar7) =
                   (char)(((uint)bVar1 * (uint)*(byte *)(lVar10 + lVar7) +
                          (0xff - (uint)bVar1) *
                          ((int)(uVar13 * 0x41c7 + uVar2 * 0x8123 + 0x108000 + param_2 * 0x1914) >>
                          0x10)) * 0x101 + 0x100 >> 0x10);
            }
            lVar7 = lVar7 + 1;
        ...
        if ((uVar11 & 1) == 0) {
          ...
          if (0 < iVar15) {
            lVar7 = 0;
            do {
              iVar9 = (uint)*(byte *)((long)pvVar14 + lVar7 * 2) +
                      (uint)*(byte *)((long)pvVar8 + lVar7 * 2 + 1) +
                      (uint)*(byte *)((long)pvVar8 + lVar7 * 2) +
                      (uint)*(byte *)((long)pvVar14 + lVar7 * 2 + 1);
              *(char *)(lVar18 + lVar7) =
                   (char)(((0x3fc - iVar9) * iVar3 + (uint)*(byte *)(lVar18 + lVar7) * iVar9) *
                          0x101 + 0x400 >> 0x12);
              *(char *)(lVar16 + lVar7) =
                   (char)(((0x3fc - iVar9) * iVar4 + (uint)*(byte *)(lVar16 + lVar7) * iVar9) *
                          0x101 + 0x400 >> 0x12);
              lVar7 = lVar7 + 1;
            } while (lVar6 != lVar7);
          }
          ...
          if ((__n & 1) != 0) {
            iVar5 = (uint)*(byte *)((long)pvVar8 + (long)(iVar17 * 2)) +
                    (uint)*(byte *)((long)pvVar14 + (long)(iVar17 * 2));
            iVar9 = iVar5 * 2;
            iVar5 = iVar5 * -2 + 0x3fc;
            *(byte *)(lVar18 + lVar6) =
                 (byte)((iVar3 * iVar5 + (uint)*(byte *)(lVar18 + lVar6) * iVar9) * 0x101 + 0x400 >>
                       0x12);
            *(byte *)(lVar16 + lVar6) =
                 (byte)(((uint)*(byte *)(lVar16 + lVar6) * iVar9 + iVar5 * iVar4) * 0x101 + 0x400 >>
                       0x12);
            __n = (size_t)param_1[2];
          }
        }
...
LAB_001008eb:
            ...
            if (uVar12 != 0) {
              iVar17 = 0xff - uVar12;
              *(uint *)(lVar10 + lVar18 * 4) =
                   ((int)(((uVar11 >> 8 & 0xff) * uVar12 + iVar17 * uVar2) * 0x101 + 0x100) >> 0x10)
                   << 8 | (int)(((uVar11 & 0xff) * uVar12 + iVar17 * param_2) * 0x101 + 0x100) >>
                          0x10 | ((uVar11 >> 0x10 & 0xff) * uVar12 + iVar17 * uVar13) * 0x101 +
                                 0x100 & 0xffff0000 | 0xff000000;
              goto LAB_001008eb;
            }

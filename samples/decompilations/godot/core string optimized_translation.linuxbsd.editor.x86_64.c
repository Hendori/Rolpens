...
LAB_0010372a:
              if ((uVar35 != (uint)uVar31) ||
                 (uVar14 != *(uint *)(*(long *)(lVar34 + lVar32 * 8) + 0x10))) goto LAB_001036e0;
              lVar32 = 0;
              if (uVar28 != 0) {
                while( true ) {
...
LAB_001036e0:
  ...
  goto LAB_0010372a;
LAB_00104056:
  if ((long)puVar20[-1] <= (long)uVar19) goto LAB_00104377;
  if (*plVar43 == 0) {
    iVar29 = 0;
  }
  else {
...
{
  return (uint)CONCAT71(0x10a3,(undefined4 *)param_1 == &Translation::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x10a2,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x10a3,(undefined4 *)param_1 == &Resource::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x10a3,(undefined4 *)param_1 == &RefCounted::get_class_ptr_static()::ptr) |

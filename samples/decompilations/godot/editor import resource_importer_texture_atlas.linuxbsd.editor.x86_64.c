...

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_0010df78;
  return;
}
        ...
        if (iVar42 == 0) {
          ...
          *pauVar48 = auVar94;
          ...
          CowData<EditorAtlasPacker::Chart::Face>::_unref
                    ((CowData<EditorAtlasPacker::Chart::Face> *)&local_60);
          CowData<Vector2>::_unref((CowData<Vector2> *)&local_70);
          CowData<EditorAtlasPacker::Chart::Face>::_unref
                    ((CowData<EditorAtlasPacker::Chart::Face> *)&local_90);
...
{
  *(undefined ***)this = &PTR__initialize_classv_0010de18;
...
void __thiscall
CowData<EditorAtlasPacker::Chart::Face>::_unref(CowData<EditorAtlasPacker::Chart::Face> *this)
...
LAB_0010d970:
  ...
  if (param_1 <= lVar5) {
    while (lVar5 = *(long *)this, lVar5 != 0) {
      ...
      CowData<Vector2>::_unref((CowData<Vector2> *)(lVar5 + 8 + uVar9 * 0x10));
      uVar9 = uVar9 + 1;
    }
    goto LAB_0010d9c6;
  }
...
LAB_0010d9c6:
    ...
    lVar5 = puVar6[-1];
    if (param_1 <= lVar5) goto LAB_0010d849;
  }
  else {
    if (lVar5 != 0) {
      uVar4 = _realloc(this,lVar10);
  ...
  if (((int)puVar11 - (int)puVar2 & 0x10U) != 0) {
    puVar2[1] = 0;
    puVar2 = puVar2 + 2;
    if (puVar2 == puVar11) goto LAB_0010d849;
  }
  do {
    puVar2[1] = 0;
    puVar3 = puVar2 + 4;
...
LAB_0010dd66:
    ...
    lVar10 = puVar7[-1];
    if (param_1 <= lVar10) goto LAB_0010dbb1;
  }
  else {
    if (lVar10 != 0) {
      uVar6 = _realloc(this,lVar11);

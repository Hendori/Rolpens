...

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_00112080;
  return;
}
...
{
  RefCounted::RefCounted((RefCounted *)this);
  *(undefined ***)this = &PTR__initialize_classv_00112208;
  return;
}
    ...
    if (local_98 != (undefined8 *)0x0) {
      for (plVar7 = (long *)*local_98; plVar7 != (long *)0x0; plVar7 = (long *)plVar7[1]) {
        while( true ) {
          ...
          *(undefined ***)this_01 = &PTR__initialize_classv_00111cc0;
...
{
  *(undefined ***)this = &PTR__initialize_classv_00111ac0;
...
{
  *(undefined ***)this = &PTR__initialize_classv_00111960;
...

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_00111cc0;
...

{
  ...
  *(undefined ***)this_00 = &PTR__initialize_classv_00111ea8;
...

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_00111ea8;
...
LAB_0011130c:
    ...
    lVar4 = puVar10[-1];
    if (param_1 <= lVar4) goto LAB_001112a0;
  }
  else {
    if (lVar12 != 0) {
  ...
  if (((param_1 - lVar4) * 0x10 & 0x10U) != 0) {
    *puVar7 = __LC78;
    puVar7[1] = uVar3;
    puVar6 = puVar7 + 2;
    if (puVar7 + (param_1 - lVar4) * 2 == puVar7 + 2) goto LAB_001112a0;
  }
  do {
    *puVar6 = uVar9;
    puVar6[1] = uVar3;
...
LAB_001115d2:
      ...
      while( true ) {
        ...
        uVar10 = uVar10 + 1;
        if (*(ulong *)(lVar7 + -8) <= uVar10) goto LAB_001115d2;
      }
      LOCK();
...
LAB_00111796:
    ...
    lVar7 = puVar8[-1];
    if (param_1 <= lVar7) goto LAB_00111699;
  }
  else {
    if (lVar7 != 0) {
      uVar4 = _realloc(this,lVar11);
  ...
  if (((int)puVar12 - (int)puVar5 & 0x10U) != 0) {
    puVar5[1] = 0;
    puVar6 = puVar5 + 2;
    if (puVar5 + 2 == puVar12) goto LAB_00111699;
  }
  do {
    puVar6[1] = 0;
    puVar5 = puVar6 + 4;

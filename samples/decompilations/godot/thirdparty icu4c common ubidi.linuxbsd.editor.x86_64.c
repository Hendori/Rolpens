...
LAB_00101e5b:
      if ((byte)((char)UVar16 - 0x14U) < 2) goto LAB_00101ed8;
      puVar15 = impTabProps + uVar26 * 0x10;
...
LAB_00103647:
                if ((char)bVar37 < '\0') goto LAB_001036f3;
LAB_0010364f:
          ...
          do {
            ...
            if ((char)piVar35[1] != '\0') {
              ...
              if (iVar11 <= iVar9) {
                lVar19 = (long)iVar9;
LAB_001045a6:
                if (*(byte *)(lVar13 + lVar19) != 0) goto LAB_00104598;
...
LAB_00104598:
  if (((0x2002UL >> ((ulong)*(byte *)(lVar13 + lVar19) & 0x3f) & 1) != 0) ||
     (lVar19 = lVar19 + -1, (int)lVar19 < iVar11)) goto LAB_00104550;
  goto LAB_001045a6;
}

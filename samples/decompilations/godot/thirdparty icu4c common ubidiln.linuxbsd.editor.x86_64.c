...
LAB_001005e5:
  if (0 < *(int *)(param_1 + 0x1a4)) {
    ...
    if (piVar23 < piVar1) {
      ...
      do {
        if (*(int *)(param_1 + 0x128) < 1) goto code_r0x00101ded;
        puVar13 = puVar10;
        uVar17 = 0;
        while( true ) {
          puVar19 = puVar13 + 1;
...

{
  ...
  if ((param_1 != 0) && (0 < param_2)) {
    ...
    do {
      ...
      pbVar6 = pbVar6 + -1;
    } while (pbVar6 != (byte *)((param_1 + lVar4 + -2) - (ulong)(param_2 - 1)));
    lVar5 = (lVar4 + -2) - (ulong)(param_2 - 1);
    if (((int)lVar7 - (int)lVar5 & 1U) == 0) goto LAB_00100e7e;
    *(int *)(param_3 + lVar7 * 4) = (int)lVar7;
    lVar7 = lVar4;
    while (lVar7 = lVar7 + -2, lVar7 != lVar5) {
LAB_00100e7e:
      *(int *)(param_3 + lVar7 * 4) = (int)lVar7;
      *(int *)(param_3 + (lVar7 + -1) * 4) = (int)(lVar7 + -1);
    }
      ...
      do {
        ...
        do {
          ...
          if (*(byte *)(param_1 + lVar7) < bVar10) {
            ...
            while (lVar5 = lVar4,
                  *(int *)(param_3 + lVar7 * 4) =
                       (iVar9 + -1 + iVar2) - *(int *)(param_3 + lVar7 * 4), (int)lVar5 + -1 < iVar3
                  ) {
              lVar7 = lVar5;
              lVar4 = lVar5 + 1;
            }
...

{
  ...
  if ((param_1 != 0) && (0 < param_2)) {
    ...
    lVar5 = (lVar4 + -2) - (ulong)(param_2 - 1);
    if (((int)lVar9 - (int)lVar5 & 1U) == 0) goto LAB_00100fc6;
    *(int *)(param_3 + lVar9 * 4) = (int)lVar9;
    lVar9 = lVar4;
    while (lVar9 = lVar9 + -2, lVar9 != lVar5) {
LAB_00100fc6:
      *(int *)(param_3 + lVar9 * 4) = (int)lVar9;
      *(int *)(param_3 + (lVar9 + -1) * 4) = (int)(lVar9 + -1);
    }
        ...
        do {
          ...
          if (*(byte *)(param_1 + lVar9) < bVar8) {
            ...
            do {
              ...
              iVar10 = iVar3 + 1;
              if (param_2 <= iVar10) {
                if (iVar11 < iVar3) goto LAB_00101026;
                goto LAB_0010104f;
              }
              bVar1 = *pbVar6;
              pbVar6 = pbVar6 + 1;
...
LAB_00101026:
              ...
              while( true ) {
                lVar7 = lVar4;
                uVar2 = *(undefined4 *)(param_3 + lVar9 * 4);
                *(undefined4 *)(param_3 + lVar9 * 4) = *(undefined4 *)(param_3 + lVar5 * 4);
                *(undefined4 *)(param_3 + lVar5 * 4) = uVar2;
                lVar5 = lVar5 + -1;
...
LAB_00101456:
  if ((int)param_1[0x25] < 0xb) {
    ...
    if ((int)uVar14 < 0) goto LAB_00101576;
  }
  else {
    iVar7 = 0;
    ...
    do {
      ...
      if (iVar5 == 0) {
        uVar14 = *puVar3;
        puVar6 = puVar3;
        if (-1 < (int)uVar14) goto LAB_00101499;
        goto LAB_00101576;
      }
      iVar15 = iVar5;
  ...
  if ((*param_3 < 1) && (ubidi_countRuns_76_godot(param_1,param_3), *param_3 < 1)) {
    if (param_2 == (void *)0x0) {
      *param_3 = 1;
      ...
      puVar12 = *(uint **)(param_1 + 0x130);
      if (0 < iVar10) {
        if (*(int *)(param_1 + 0x18) < iVar10) {
          memset(param_2,0xff,(long)iVar10 * 4);
        }
        if (0 < *(int *)(param_1 + 0x128)) {
          ...
          do {
            uVar13 = puVar15[1];
            uVar5 = *puVar15 & 0x7fffffff;
            if ((int)*puVar15 < 0) {
              piVar9 = (int *)((long)param_2 + (long)(int)(uVar5 + (uVar13 - iVar10)) * 4);
              iVar7 = iVar10;
              do {
                iVar6 = iVar7 + 1;
                piVar9 = piVar9 + -1;
              ...
              piVar9 = (int *)((long)param_2 + (ulong)uVar5 * 4);
              iVar7 = iVar10;
              do {
                iVar6 = iVar7 + 1;
                *piVar9 = iVar7;
          ...
          if (*(int *)(param_1 + 0x1a4) < 1) {
            if ((0 < *(int *)(param_1 + 0x1b8)) && (0 < iVar7)) {
              uVar5 = 0;
              puVar15 = puVar12 + (long)iVar7 * 3;
              uVar13 = 0;
              do {
                uVar3 = puVar12[1];
                uVar13 = uVar3 - uVar13;
                if (puVar12[2] != uVar5) {
                  uVar8 = *puVar12;
                  uVar11 = uVar8 & 0x7fffffff;
                  uVar14 = uVar11 + uVar13;
                  if (puVar12[2] == 0) {
                    if ((int)uVar11 < (int)uVar14) {
                      piVar9 = (int *)((long)param_2 + (ulong)uVar11 * 4);
                      piVar1 = (int *)((long)param_2 + ((ulong)uVar13 + (ulong)uVar11) * 4);
                      if (((int)piVar1 - (int)piVar9 & 4U) != 0) {
                        *piVar9 = *piVar9 - uVar5;
                        piVar9 = piVar9 + 1;
                        if (piVar1 == piVar9) goto LAB_00101980;
                      }
                      do {
                        *piVar9 = *piVar9 - uVar5;
                        piVar9[1] = piVar9[1] - uVar5;
                        piVar9 = piVar9 + 2;
                      } while (piVar1 != piVar9);
                    }
                  }
                    ...
                    do {
                      ...
                      piVar9 = (int *)((long)param_2 + (long)(int)uVar13 * 4);
                      uVar2 = *(ushort *)(lVar4 + (long)(int)uVar13 * 2);
                      if ((((uVar2 & 0xfffffffc) == 0x200c) || (uVar2 - 0x202a < 5)) ||
                         (uVar2 - 0x2066 < 4)) {
                        uVar5 = uVar5 + 1;
                        iVar16 = -1;
                      }
...
LAB_00101980:
            ...
            do {
              uVar5 = puVar12[2];
              uVar3 = puVar12[1];
              iVar10 = (iVar10 + 1) - (uint)((uVar5 & 5) == 0);
              if (0 < iVar10) {
                uVar13 = uVar3 - uVar13;
                uVar8 = *puVar12 & 0x7fffffff;
                if ((int)uVar8 < (int)(uVar8 + uVar13)) {
                  piVar9 = (int *)((long)param_2 + (long)(int)uVar8 * 4);
                  piVar1 = (int *)((long)param_2 + ((ulong)uVar13 + (long)(int)uVar8) * 4);
                  if (((int)piVar1 - (int)piVar9 & 4U) != 0) {
                    *piVar9 = *piVar9 + iVar10;
                    piVar9 = piVar9 + 1;
                    if (piVar1 == piVar9) goto LAB_00101790;
                  }
                  do {
                    *piVar9 = *piVar9 + iVar10;
                    piVar9[1] = piVar9[1] + iVar10;
                    piVar9 = piVar9 + 2;
                  } while (piVar1 != piVar9);
                }
              }
LAB_00101790:
              iVar10 = (iVar10 + 1) - (uint)((uVar5 & 10) == 0);
              puVar12 = puVar12 + 3;
              uVar13 = uVar3;
            } while (puVar12 != puVar15);
          }

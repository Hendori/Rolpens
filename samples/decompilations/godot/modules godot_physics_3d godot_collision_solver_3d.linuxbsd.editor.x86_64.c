...
void GodotCollisionSolver3D::soft_body_contact_callback
...

{
  ...
  *(int *)((long)param_6 + 0x1c) = *(int *)((long)param_6 + 0x1c) + 1;
  if (UNRECOVERED_JUMPTABLE != (code *)0x0) {
    ...
    local_20 = CONCAT44((uint)((ulong)*(undefined8 *)param_5 >> 0x20) ^ (uint)((ulong)_LC1 >> 0x20),
                        (uint)*(undefined8 *)param_5 ^ (uint)_LC1);
    (*UNRECOVERED_JUMPTABLE)
              (param_3,*param_6,param_1,param_2,&local_20,*(undefined8 *)((long)param_6 + 0x10));
  }
  if (local_10 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
  }
...
/* GodotCollisionSolver3D::soft_body_concave_callback(void*, GodotShape3D*) */

bool GodotCollisionSolver3D::soft_body_concave_callback(void *param_1,GodotShape3D *param_2)

{
  ...
  *(GodotShape3D **)((long)param_1 + 8) = param_2;
  ...
  GodotSoftBody3D::query_aabb
            (*param_1,(_func_bool_uint_void_ptr *)local_58,soft_body_query_callback);
...
/* GodotCollisionSolver3D::concave_callback(void*, GodotShape3D*) */

undefined1  [16] GodotCollisionSolver3D::concave_callback(void *param_1,GodotShape3D *param_2)

{
  ...
  *(int *)((long)param_1 + 0x2c) = *(int *)((long)param_1 + 0x2c) + 1;
                    /* WARNING: Load size is inaccurate */
  uVar2 = sat_calculate_penetration
                    (*(GodotShape3D **)((long)param_1 + 8),*param_1,param_2,
                     *(Transform3D **)((long)param_1 + 0x10),
                     *(_func_void_Vector3_ptr_int_Vector3_ptr_int_Vector3_ptr_void_ptr **)
                      ((long)param_1 + 0x18),*(void **)((long)param_1 + 0x20),
                     *(bool *)((long)param_1 + 0x28),(Vector3 *)0x0,*(float *)((long)param_1 + 0x38)
                     ,*(float *)((long)param_1 + 0x3c));
  if ((char)uVar2 != '\0') {
...
/* GodotCollisionSolver3D::concave_distance_callback(void*, GodotShape3D*) */

void GodotCollisionSolver3D::concave_distance_callback(void *param_1,GodotShape3D *param_2)

{
  ...
  *(int *)((long)param_1 + 0x2c) = *(int *)((long)param_1 + 0x2c) + 1;
  ...
  local_1c = 0;
  local_14 = 0.0;
  bVar1 = gjk_epa_calculate_distance
                    (*(GodotShape3D **)((long)param_1 + 8),*param_1,param_2,
                     *(Transform3D **)((long)param_1 + 0x10),(Vector3 *)&local_28,
                     (Vector3 *)&local_1c);
...
LAB_001002fc:
    ...
    *(float *)((long)param_1 + 0x54) = local_14;
    ...
    if (((float)local_1c - (float)local_28) * ((float)local_1c - (float)local_28) +
        (local_1c._4_4_ - local_28._4_4_) * (local_1c._4_4_ - local_28._4_4_) +
        (local_14 - local_20) * (local_14 - local_20) <
        fVar2 * fVar2 + fVar4 * fVar4 + fVar3 * fVar3) goto LAB_001002fc;
  }
  *(int *)((long)param_1 + 0x30) = *(int *)((long)param_1 + 0x30) + 1;
LAB_00100323:
  if (local_10 != *(long *)(in_FS_OFFSET + 0x28)) {
...
/* GodotCollisionSolver3D::solve_static_world_boundary(GodotShape3D const*, Transform3D const&,
   GodotShape3D const*, Transform3D const&, void (*)(Vector3 const&, int, Vector3 const&, int,
   Vector3 const&, void*), void*, bool, float) */

undefined8
GodotCollisionSolver3D::solve_static_world_boundary
...
LAB_00100416:
    ...
    fVar38 = *(float *)(param_4 + 8) * fVar29 + *(float *)(param_4 + 0x14) * fVar33 +
             *(float *)(param_4 + 0x20) * fVar25;
    auVar34._0_4_ =
         (float)*(undefined8 *)(param_4 + 0xc) * fVar33 + (float)*(undefined8 *)param_4 * fVar29 +
         (float)*(undefined8 *)(param_4 + 0x18) * fVar25;
    auVar34._4_4_ =
         (float)((ulong)*(undefined8 *)(param_4 + 0xc) >> 0x20) * fVar33 +
         (float)((ulong)*(undefined8 *)param_4 >> 0x20) * fVar29 +
         (float)((ulong)*(undefined8 *)(param_4 + 0x18) >> 0x20) * fVar25;
    ...
    (**(code **)(*(long *)param_3 + 0x28))
              (param_3,(Vector3 *)local_118,0x10,pVVar21,&local_130,&local_12c);
    fVar33 = local_100;
    if (local_12c == 3) {
      if (local_130 != 3) {
        _err_print_error("solve_static_world_boundary",
                         "modules/godot_physics_3d/godot_collision_solver_3d.cpp",0x37,
                         "Condition \"support_count != 3\" is true. Returning: false",0,0);
        uVar20 = 0;
        goto LAB_00100420;
      }
      iVar18 = 1;
      ...
      local_108 = CONCAT44((local_f8 - fVar45) + fVar45 + (fStack_ec - fVar45) * 0.0,
                           (fStack_fc - fVar40) + fVar40 + (local_f0 - fVar40) * 0.0);
      ...
      while( true ) {
        ...
        *(ulong *)(pVVar22 + 0xc) =
             CONCAT44(fVar38 * (local_f8 - fVar45) + fVar45 + fVar39 * (fStack_ec - fVar45),
                      fVar38 * (fStack_fc - fVar40) + fVar40 + fVar39 * (local_f0 - fVar40));
        if (iVar18 != 1) break;
        iVar18 = 2;
        pVVar22 = pVVar22 + 0xc;
      }
    ...
    do {
      ...
      fVar39 = *(float *)(param_4 + 0x18) * fVar40 + fVar45 * *(float *)(param_4 + 0x1c) +
               *(float *)(param_4 + 0x20) * fVar33 + *(float *)(param_4 + 0x2c);
      ...
      *(float *)(pVVar21 + 8) = fVar39;
      ...
      fVar33 = fVar45 * fVar38 + (float)((ulong)uVar13 >> 0x20) * fVar40 +
               (float)((ulong)uVar15 >> 0x20) * fVar33 + (float)((ulong)uVar16 >> 0x20);
      fVar29 = fVar46 * 0.0 + fVar46 * 0.0 + 0.0 + 0.0;
      fVar40 = fVar47 * 0.0 + fVar47 * 0.0 + 0.0 + 0.0;
      *(ulong *)pVVar21 = CONCAT44(fVar33,fVar25);
      fVar45 = (*(float *)pVVar21 * fVar36 + fVar33 * fVar35 + fVar32 * fVar39) -
               ((fVar6 * fVar24 + fVar3 * fVar48 + fVar9 * fVar28 + fVar11) * fVar35 +
                (fVar24 * fVar8 + fVar48 * fVar4 + fVar28 * fVar10 + fVar12) * fVar36 +
               (fVar1 * fVar24 + fVar2 * fVar48 + fVar5 * fVar28 + fVar7) * fVar32);
      if (fVar45 < 0.0) {
...
undefined4
GodotCollisionSolver3D::solve_separation_ray
          (GodotShape3D *param_1,Transform3D *param_2,GodotShape3D *param_3,Transform3D *param_4,
          _func_void_Vector3_ptr_int_Vector3_ptr_int_Vector3_ptr_void_ptr *param_5,void *param_6,
          bool param_7,float param_8)

{
  ...
  fStack_e4 = (float)((ulong)*(undefined8 *)(param_2 + 0x10) >> 0x20) * fVar3 +
  ...
  uVar2 = (**(code **)(*(long *)param_3 + 0x38))
                    (param_3,&local_f8,&local_e8,&local_c8,&local_b8,&local_fc);
  if ((char)uVar2 != '\0') {
    if (((((float)local_b8 == 0.0) && (local_b8._4_4_ == 0.0)) && (local_b0 == 0.0)) ||
       ((double)(((float)local_f8 - local_e8) * (float)local_b8 +
                 (local_f8._4_4_ - fStack_e4) * local_b8._4_4_ + (local_f0 - local_e0) * local_b0) <
        _LC11)) {
      uVar2 = 0;
    }
    else {
      ...
      local_a0 = *(float *)(param_4 + 0x18) * fVar3 + *(float *)(param_4 + 0x1c) * fVar10 +
                 *(float *)(param_4 + 0x20) * local_c0 + *(float *)(param_4 + 0x2c);
      local_a8 = CONCAT44((float)((ulong)*(undefined8 *)(param_4 + 8) >> 0x20) * fVar3 +
                          fVar10 * *(float *)(param_4 + 0x10) +
                          (float)((ulong)*(undefined8 *)(param_4 + 0x10) >> 0x20) * local_c0 +
                          (float)((ulong)*(undefined8 *)(param_4 + 0x24) >> 0x20),
                          (float)*(undefined8 *)param_4 * fVar3 + fVar10 * *(float *)(param_4 + 4) +
                          (float)*(undefined8 *)(param_4 + 8) * local_c0 +
      ...
      if (cVar1 != '\0') {
        ...
        fVar5 = SQRT((local_a0 - local_d0) * (local_a0 - local_d0) +
                     ((float)local_a8 - local_d8) * ((float)local_a8 - local_d8) +
                     (local_a8._4_4_ - fStack_d4) * (local_a8._4_4_ - fStack_d4));
        local_a0 = fVar5 * fVar3 + local_d0;
        local_a8 = CONCAT44(fVar5 * (float)((ulong)uVar11 >> 0x20) + fStack_d4,
                            fVar5 * (float)uVar11 + local_d8);
      }
      if (param_5 != (_func_void_Vector3_ptr_int_Vector3_ptr_int_Vector3_ptr_void_ptr *)0x0) {
        ...
        if (param_7) {
          ...
          local_88 = CONCAT44((uint)((ulong)local_98 >> 0x20) ^ (uint)((ulong)_LC1 >> 0x20),
                              (uint)local_98 ^ (uint)_LC1);
...
ulong GodotCollisionSolver3D::solve_soft_body
...

{
  ...
  if (cVar4 == '\0') {
    ...
    local_198[1] = 0.0;
    local_198[2] = 0.0;
    local_1b8 = CONCAT44((float)((ulong)*(undefined8 *)(param_1 + 0x1c) >> 0x20) +
                         (float)((ulong)*(undefined8 *)(param_1 + 0x10) >> 0x20),
                         (float)*(undefined8 *)(param_1 + 0x1c) +
                         (float)*(undefined8 *)(param_1 + 0x10));
    ...
    GodotSoftBody3D::query_aabb
              (pAVar2,(_func_bool_uint_void_ptr *)&local_178,soft_body_query_callback);
  }
  else {
    local_178 = 0;
    fVar13 = fVar1 + fVar1;
    ...
    afStack_16c[1] = 0.0;
    afStack_16c[2] = 0.0;
    local_188 = CONCAT44(fVar13 + (float)((ulong)*(undefined8 *)(pAVar2 + 0x230) >> 0x20),
                         fVar13 + (float)*(undefined8 *)(pAVar2 + 0x230));
    local_198[0] = *(float *)(pAVar2 + 0x220) - fVar1;
    local_198[1] = *(float *)(pAVar2 + 0x224) - fVar1;
    local_198[2] = *(float *)(pAVar2 + 0x228) - fVar1;
    ...
    do {
      pTVar10 = pTVar7 + 4;
      fVar1 = pfVar8[3];
      fVar14 = _LC2 / SQRT(*(float *)pTVar7 * *(float *)pTVar7 +
                           *(float *)(pTVar7 + 0xc) * *(float *)(pTVar7 + 0xc) +
                           *(float *)(pTVar7 + 0x18) * *(float *)(pTVar7 + 0x18));
      fVar13 = *pfVar8;
    ...
    (**(code **)(*(long *)param_1 + 0x70))
              (param_1,&local_178,soft_body_concave_callback,(Variant *)&local_e8,1);
  }
...
/* GodotCollisionSolver3D::solve_concave(GodotShape3D const*, Transform3D const&, GodotShape3D
   const*, Transform3D const&, void (*)(Vector3 const&, int, Vector3 const&, int, Vector3 const&,
   void*), void*, bool, float, float) */

undefined1
GodotCollisionSolver3D::solve_concave
          (GodotShape3D *param_1,Transform3D *param_2,GodotShape3D *param_3,Transform3D *param_4,
          _func_void_Vector3_ptr_int_Vector3_ptr_int_Vector3_ptr_void_ptr *param_5,void *param_6,
          bool param_7,float param_8,float param_9)
...
/* GodotCollisionSolver3D::solve_static(GodotShape3D const*, Transform3D const&, GodotShape3D
   const*, Transform3D const&, void (*)(Vector3 const&, int, Vector3 const&, int, Vector3 const&,
   void*), void*, Vector3*, float, float) */

undefined8
GodotCollisionSolver3D::solve_static
          (GodotShape3D *param_1,Transform3D *param_2,GodotShape3D *param_3,Transform3D *param_4,
          _func_void_Vector3_ptr_int_Vector3_ptr_int_Vector3_ptr_void_ptr *param_5,void *param_6,
          Vector3 *param_7,float param_8,float param_9)

{
  ...
  if (iVar10 == 0) {
    if (iVar11 == 0) {
      if (solve_static(GodotShape3D_const*,Transform3D_const&,GodotShape3D_const*,Transform3D_const&,void(*)(Vector3_const&,int,Vector3_const&,int,Vector3_const&,void*),void*,Vector3*,float,float)
          ::first_print != '\0') {
        _err_print_error("solve_static","modules/godot_physics_3d/godot_collision_solver_3d.cpp",
                         0x179,"Collisions between world boundaries are not supported.",0,1);
      ...
      if (solve_static(GodotShape3D_const*,Transform3D_const&,GodotShape3D_const*,Transform3D_const&,void(*)(Vector3_const&,int,Vector3_const&,int,Vector3_const&,void*),void*,Vector3*,float,float)
          ::first_print != '\0') {
        _err_print_error("solve_static","modules/godot_physics_3d/godot_collision_solver_3d.cpp",
                         0x17d,"Collisions between world boundaries and rays are not supported.",0,1
                        );
        solve_static(GodotShape3D_const*,Transform3D_const&,GodotShape3D_const*,Transform3D_const&,void(*)(Vector3_const&,int,Vector3_const&,int,Vector3_const&,void*),void*,Vector3*,float,float)
        ::first_print = 0;
        return 0;
      ...
      if (iVar11 != 9) {
        ...
        uVar6 = solve_static_world_boundary
                          (param_3,param_4,pGVar8,pTVar7,param_5,param_6,bVar1,param_8);
        return uVar6;
      }
      if (solve_static(GodotShape3D_const*,Transform3D_const&,GodotShape3D_const*,Transform3D_const&,void(*)(Vector3_const&,int,Vector3_const&,int,Vector3_const&,void*),void*,Vector3*,float,float)
          ::first_print != '\0') {
        _err_print_error("solve_static","modules/godot_physics_3d/godot_collision_solver_3d.cpp",
                         0x181,
                         "Collisions between world boundaries and soft bodies are not supported.",0,
                         1);
        solve_static(GodotShape3D_const*,Transform3D_const&,GodotShape3D_const*,Transform3D_const&,void(*)(Vector3_const&,int,Vector3_const&,int,Vector3_const&,void*),void*,Vector3*,float,float)
        ::first_print = 0;
        return 0;
    ...
    if (iVar11 != 1) {
      ...
      uVar6 = solve_separation_ray
                        (param_1,param_2,pGVar8,pTVar7,param_5,param_6,iVar5 < iVar4,param_8);
      return uVar6;
    }
    if (solve_static(GodotShape3D_const*,Transform3D_const&,GodotShape3D_const*,Transform3D_const&,void(*)(Vector3_const&,int,Vector3_const&,int,Vector3_const&,void*),void*,Vector3*,float,float)
        ::first_print != '\0') {
      _err_print_error("solve_static","modules/godot_physics_3d/godot_collision_solver_3d.cpp",0x18d
                       ,"Collisions between rays are not supported.",0,1);
      solve_static(GodotShape3D_const*,Transform3D_const&,GodotShape3D_const*,Transform3D_const&,void(*)(Vector3_const&,int,Vector3_const&,int,Vector3_const&,void*),void*,Vector3*,float,float)
      ::first_print = 0;
      return 0;
    }
    ...
    if (solve_static(GodotShape3D_const*,Transform3D_const&,GodotShape3D_const*,Transform3D_const&,void(*)(Vector3_const&,int,Vector3_const&,int,Vector3_const&,void*),void*,Vector3*,float,float)
        ::first_print != '\0') {
      _err_print_error("solve_static","modules/godot_physics_3d/godot_collision_solver_3d.cpp",0x199
                       ,"Collisions between soft bodies are not supported.",0,1);
      solve_static(GodotShape3D_const*,Transform3D_const&,GodotShape3D_const*,Transform3D_const&,void(*)(Vector3_const&,int,Vector3_const&,int,Vector3_const&,void*),void*,Vector3*,float,float)
      ::first_print = 0;
      return 0;
    }
    ...
    if (cVar9 == '\0') {
      uVar6 = sat_calculate_penetration
                        (param_1,param_2,param_3,param_4,param_5,param_6,false,param_7,param_8,
                         param_9);
      return uVar6;
    }
    if (cVar3 == '\0') {
      ...
      uVar6 = solve_concave(param_1,param_2,pGVar8,pTVar7,param_5,param_6,iVar5 < iVar4,param_8,
                            param_9);
      return uVar6;
    }
    if (solve_static(GodotShape3D_const*,Transform3D_const&,GodotShape3D_const*,Transform3D_const&,void(*)(Vector3_const&,int,Vector3_const&,int,Vector3_const&,void*),void*,Vector3*,float,float)
        ::first_print != '\0') {
      _err_print_error("solve_static","modules/godot_physics_3d/godot_collision_solver_3d.cpp",0x1a5
...
/* GodotCollisionSolver3D::soft_body_query_callback(unsigned int, void*) */

char GodotCollisionSolver3D::soft_body_query_callback(uint param_1,void *param_2)

{
  ...
  *(uint *)((long)param_2 + 0x78) = param_1;
  ...
  local_38 = 0x3f800000;
  local_2c = *(float *)((long)param_2 + 0x60) * fVar2 + *(float *)((long)param_2 + 100) * fVar4 +
             *(float *)((long)param_2 + 0x68) * extraout_XMM1_Da + *(float *)((long)param_2 + 0x74);
  local_34 = CONCAT44((float)((ulong)*(undefined8 *)((long)param_2 + 0x50) >> 0x20) * fVar2 +
                      fVar4 * *(float *)((long)param_2 + 0x58) +
                      (float)((ulong)*(undefined8 *)((long)param_2 + 0x58) >> 0x20) *
                      extraout_XMM1_Da +
                      (float)((ulong)*(undefined8 *)((long)param_2 + 0x6c) >> 0x20),
                      (float)*(undefined8 *)((long)param_2 + 0x48) * fVar2 +
                      fVar4 * *(float *)((long)param_2 + 0x4c) +
                      (float)*(undefined8 *)((long)param_2 + 0x50) * extraout_XMM1_Da +
                      (float)*(undefined8 *)((long)param_2 + 0x6c));
  cVar1 = solve_static(*(GodotShape3D **)((long)param_2 + 8),(Transform3D *)((long)param_2 + 0x18),
                       *(GodotShape3D **)((long)param_2 + 0x10),local_58,soft_body_contact_callback,
                       (void *)((long)param_2 + 0x78),(Vector3 *)0x0,0.0,0.0);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GodotCollisionSolver3D::solve_distance_world_boundary(GodotShape3D const*, Transform3D const&,
   GodotShape3D const*, Transform3D const&, Vector3&, Vector3&) */

ulong GodotCollisionSolver3D::solve_distance_world_boundary
                (GodotShape3D *param_1,Transform3D *param_2,GodotShape3D *param_3,
...

{
  ...
  fVar23 = (fVar35 + fVar11 * fVar24 + fVar22 * fVar32 + fVar17 * fVar8) * fVar33 +
           (fVar36 * fVar11 + fVar31 * fVar22 + fVar37 * fVar17 + fVar13) * fVar29 +
           (fVar23 * fVar11 + fVar12 * fVar22 + fVar26 * fVar17 + fVar14) * fVar30;
  fVar31 = *(float *)(param_4 + 8) * fVar34 + *(float *)(param_4 + 0x14) * fVar18 +
           *(float *)(param_4 + 0x20) * fVar25;
  auVar27._0_4_ =
       (float)*(undefined8 *)param_4 * fVar34 + (float)*(undefined8 *)(param_4 + 0xc) * fVar18 +
       (float)*(undefined8 *)(param_4 + 0x18) * fVar25;
  auVar27._4_4_ =
       (float)((ulong)*(undefined8 *)param_4 >> 0x20) * fVar34 +
       (float)((ulong)*(undefined8 *)(param_4 + 0xc) >> 0x20) * fVar18 +
       (float)((ulong)*(undefined8 *)(param_4 + 0x18) >> 0x20) * fVar25;
  ...
  if (local_130 == 0) {
    ...
    fVar26 = *(float *)(param_4 + 0x18) * fVar12 + *(float *)(param_4 + 0x1c) * fVar32 +
             *(float *)(param_4 + 0x20) * extraout_XMM1_Da + *(float *)(param_4 + 0x2c);
    fVar31 = (float)*(undefined8 *)param_4 * fVar12 + fVar32 * *(float *)(param_4 + 4) +
             (float)*(undefined8 *)(param_4 + 8) * extraout_XMM1_Da +
             (float)*(undefined8 *)(param_4 + 0x24);
    fVar12 = (float)((ulong)*(undefined8 *)(param_4 + 8) >> 0x20) * fVar12 +
             fVar32 * *(float *)(param_4 + 0x10) +
             (float)((ulong)*(undefined8 *)(param_4 + 0x10) >> 0x20) * extraout_XMM1_Da +
             (float)((ulong)*(undefined8 *)(param_4 + 0x24) >> 0x20);
  ...
  if (local_12c == 3) {
    if (local_130 != 3) {
      _err_print_error("solve_distance_world_boundary",
                       "modules/godot_physics_3d/godot_collision_solver_3d.cpp",0x1e2,
                       "Condition \"support_count != 3\" is true. Returning: false",0,0);
      uVar6 = 0;
      goto LAB_0010269f;
    }
    ...
    local_108 = CONCAT44((local_f8 - fVar36) + fVar36 + (fStack_ec - fVar36) * 0.0,
                         (fStack_fc - fVar26) + fVar26 + (local_f0 - fVar26) * 0.0);
    ...
    while( true ) {
      ...
      *(undefined8 *)((long)puVar7 + 0xc) =
           CONCAT44(fVar14 * (local_f8 - fVar36) + fVar36 + fVar24 * (fStack_ec - fVar36),
                    fVar14 * (fStack_fc - fVar26) + fVar26 + fVar24 * (local_f0 - fVar26));
      if (iVar4 != 1) break;
      iVar4 = 2;
      puVar7 = (undefined8 *)((long)puVar7 + 0xc);
    }
LAB_001024b7:
    fVar12 = *(float *)(param_4 + 0x1c);
    ...
    do {
      ...
      fVar25 = fVar22 * fVar36 + fVar11 * (float)((ulong)uVar15 >> 0x20) +
               fVar13 * (float)((ulong)uVar2 >> 0x20) + (float)((ulong)uVar3 >> 0x20);
      ...
      *(float *)(puVar9 + 1) = fVar13;
      ...
      if (((iVar4 == 0) || (fVar11 < fVar37)) &&
         (fVar24 = fVar13, fVar37 = fVar11, fVar35 = fVar25, fVar8 = fVar17, fVar11 <= 0.0)) {
        uVar6 = 1;
      }
      iVar4 = iVar4 + 1;
...
/* GodotCollisionSolver3D::solve_distance(GodotShape3D const*, Transform3D const&, GodotShape3D
   const*, Transform3D const&, Vector3&, Vector3&, AABB const&, Vector3*) */

ulong GodotCollisionSolver3D::solve_distance
                (GodotShape3D *param_1,Transform3D *param_2,GodotShape3D *param_3,
                Transform3D *param_4,Vector3 *param_5,Vector3 *param_6,AABB *param_7,
                Vector3 *param_8)

{
  ...
  if (iVar2 == 0) {
    ...
    uVar3 = solve_distance_world_boundary
                      (param_3,param_4,param_1,param_2,(Vector3 *)&local_c8,(Vector3 *)&local_98);
    uVar4 = (ulong)(uVar3 ^ 1);
    ...
    if (cVar1 == '\0') {
      ...
      do {
        ...
        if (cVar1 == '\0') {
          ...
          fVar10 = ABS(fVar7) * _LC21 * local_114 + ABS(fVar8) * _LC21 * local_118 +
                   ABS(local_f0) * _LC21 * local_120;
          fVar8 = (_LC21 * local_114 + local_110) * fVar7 + (_LC21 * local_118 + local_10c) * fVar8
                  + (_LC21 * local_120 + local_11c) * local_f0;
          fVar7 = fVar8 - fVar10;
          fVar8 = fVar10 + fVar8;
        }
        pAVar6 = pAVar5 + 4;
      ...
      (**(code **)(*(long *)param_3 + 0x70))
                (param_3,(AABB *)&local_e8,concave_distance_callback,&local_98,0);
      if (local_70._1_1_ == 0) {

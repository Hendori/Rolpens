...
void __thiscall
(anonymous_namespace)::TNoContractionAssigneeCheckingTraverser::
~TNoContractionAssigneeCheckingTraverser(TNoContractionAssigneeCheckingTraverser *this)
...
(anonymous_namespace)::TSymbolDefinitionCollectingTraverser::visitAggregate
          (TSymbolDefinitionCollectingTraverser *this,undefined8 param_2,long *param_3)
...
/* (anonymous namespace)::TSymbolDefinitionCollectingTraverser::visitBranch(glslang::TVisit,
   glslang::TIntermBranch*) */

undefined8 __thiscall
(anonymous_namespace)::TSymbolDefinitionCollectingTraverser::visitBranch
          (TSymbolDefinitionCollectingTraverser *this,undefined8 param_2,ulong param_3)

{
  ...
  if ((*(long *)(param_3 + 0x28) != 0) && (plVar6 = *(long **)(this + 0x78), plVar6 != (long *)0x0))
  {
    ...
    if ((*(byte *)((long)plVar6 + 0xc) & 0x10) != 0) {
      ...
      if (plVar6[3] == 0) {
        for (puVar3 = (undefined8 *)plVar6[2]; puVar3 != (undefined8 *)0x0;
        ...
        if (plVar5 != (long *)0x0) {
          ...
          while (uVar11 != param_3) {
            plVar9 = (long *)*plVar7;
            if ((plVar9 == (long *)0x0) ||
               (uVar11 = plVar9[1], plVar5 = plVar7, plVar7 = plVar9,
               uVar11 % (ulong)plVar6[1] != uVar8)) goto LAB_00100258;
          }
...
::find(_Hashtable<glslang::TIntermTyped*,std::pair<glslang::TIntermTyped*const,std::__cxx11::string>,std::allocator<std::pair<glslang::TIntermTyped*const,std::__cxx11::string>>,std::__detail::_Select1st,std::equal_to<glslang::TIntermTyped*>,std::hash<glslang::TIntermTyped*>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>>
       *this,TIntermTyped **param_1)

{
  TIntermTyped **ppTVar1;
  undefined8 *puVar2;
  undefined8 *puVar3;
  undefined8 *puVar4;
  ulong uVar5;
  ...
  if (*(long *)(this + 0x18) == 0) {
    for (puVar4 = *(undefined8 **)(this + 0x10);
        (puVar4 != (undefined8 *)0x0 && ((TIntermTyped **)puVar4[1] != param_1));
    ...
    if (puVar4 != (undefined8 *)0x0) {
      ...
      do {
        ...
        puVar2 = (undefined8 *)*puVar3;
              ...
              (ppTVar1 = (TIntermTyped **)puVar2[1], puVar4 = puVar3, puVar3 = puVar2,
              uVar5 == (ulong)ppTVar1 % *(ulong *)(this + 8)));
...
/* (anonymous namespace)::getFrontElement(std::__cxx11::string const&) */
...
/* (anonymous
   namespace)::TNoContractionAssigneeCheckingTraverser::visitSymbol(glslang::TIntermSymbol*) */
...

{
  ...
  pTVar2 = (TIntermSymbol *)
           std::
           _Hashtable<glslang::TIntermTyped*,std::pair<glslang::TIntermTyped*const,std::__cxx11::string>,std::allocator<std::pair<glslang::TIntermTyped*const,std::__cxx11::string>>,std::__detail::_Select1st,std::equal_to<glslang::TIntermTyped*>,std::hash<glslang::TIntermTyped*>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>>
           ::find(*(_Hashtable<glslang::TIntermTyped*,std::pair<glslang::TIntermTyped*const,std::__cxx11::string>,std::allocator<std::pair<glslang::TIntermTyped*const,std::__cxx11::string>>,std::__detail::_Select1st,std::equal_to<glslang::TIntermTyped*>,std::hash<glslang::TIntermTyped*>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>>
                    **)(this + 0x38),(TIntermTyped **)param_1);
...
/* (anonymous namespace)::TNoContractionPropagator::visitUnary(glslang::TVisit,
   glslang::TIntermUnary*) */

undefined8 __thiscall
(anonymous_namespace)::TNoContractionPropagator::visitUnary
...
/* (anonymous
   namespace)::TSymbolDefinitionCollectingTraverser::~TSymbolDefinitionCollectingTraverser() */

void __thiscall
(anonymous_namespace)::TSymbolDefinitionCollectingTraverser::~TSymbolDefinitionCollectingTraverser
          (TSymbolDefinitionCollectingTraverser *this)

{
  *(undefined ***)this = &PTR__TSymbolDefinitionCollectingTraverser_00104ca8;
  if (*(TSymbolDefinitionCollectingTraverser **)(this + 0x50) != this + 0x60) {
    operator_delete(*(TSymbolDefinitionCollectingTraverser **)(this + 0x50),
                    *(long *)(this + 0x60) + 1);
    return;
  }
  return;
...

{
  ...
  if (*(ulong *)(param_1 + 0x18) < 0x15) {
    for (plVar9 = *(long **)(param_1 + 0x10); plVar9 != (long *)0x0; plVar9 = (long *)*plVar9) {
      if ((plVar9[2] == uVar12) &&
         ((uVar12 == 0 || (iVar7 = memcmp(__s1,(void *)plVar9[1],uVar12), iVar7 == 0)))) {
        uVar6 = 0;
        goto LAB_00100858;
      }
    }
  ...
  if ((0x14 < *(ulong *)(param_1 + 0x18)) &&
     (puVar16 = *(undefined8 **)(*(long *)param_1 + uVar11 * 8), puVar16 != (undefined8 *)0x0)) {
    uVar10 = ((undefined8 *)*puVar16)[5];
    puVar2 = (undefined8 *)*puVar16;
    while (((puVar13 = puVar2, uVar8 != uVar10 ||
            (__n = *(size_t *)(param_2 + 8), __n != puVar13[2])) ||
           ((__n != 0 && (iVar7 = memcmp(*(void **)param_2,(void *)puVar13[1],__n), iVar7 != 0)))))
    {
      puVar2 = (undefined8 *)*puVar13;
      if ((puVar2 == (undefined8 *)0x0) ||
         (uVar10 = puVar2[5], puVar16 = puVar13, uVar11 != uVar10 % uVar12)) goto LAB_00100918;
    }
    plVar9 = (long *)*puVar16;
    uVar6 = 0;
...
LAB_00100918:
  ...
  *plVar9 = 0;
  ...
  cVar5 = std::__detail::_Prime_rehash_policy::_M_need_rehash
                    ((ulong)(param_1 + 0x20),*(ulong *)(param_1 + 8),*(ulong *)(param_1 + 0x18));
  if (cVar5 == '\0') {
    __s = *(string **)param_1;
    plVar9[5] = uVar8;
    psVar1 = __s + uVar11 * 8;
...
undefined8 __thiscall
(anonymous_namespace)::TNoContractionPropagator::visitAggregate
          (TNoContractionPropagator *this,undefined8 param_2,long *param_3)
  ...
  if (*(long *)(this + 0x80) == 0) {
    ...
    if ((int)param_3[0x17] == 0x241) {
      ...
      if (lVar6 == -1) {
        ...
        if (uVar4 < uVar7) {
          ...
          if (((byte)pTVar10[0xc] & 0x10) == 0) {
            ...
            if ((__n != 0) &&
               (iVar2 = memcmp(*(void **)(lVar6 + 0x10),(void *)*puVar11,__n), iVar2 != 0)) {
              return 0;
            }
          }
          if (*(code **)(*extraout_RDX + 0xf8) == glslang::TIntermTyped::getWritableType) {
        ...
        std::__cxx11::string::_M_construct<char_const*>
                  (&local_a8,*(long *)(this + 0x78) + uVar7,uVar4 + *(long *)(this + 0x78));
      }
      local_88[0] = local_78;
      ...
      std::__cxx11::string::_M_construct<char*>
                (local_60,*(long *)(this + 0x78),*(long *)(this + 0x80) + *(long *)(this + 0x78));
...
undefined8 __thiscall
(anonymous_namespace)::TNoContractionAssigneeCheckingTraverser::visitBinary
          (TNoContractionAssigneeCheckingTraverser *this,undefined8 param_2,TIntermTyped **param_3)

{
  ...
  if (((byte)pTVar4[0xc] & 0x10) == 0) {
    ...
    if ((__n != 0) && (iVar1 = memcmp(*(void **)(lVar2 + 0x10),(void *)*puVar6,__n), iVar1 != 0)) {
      return 0;
    }
  }
  if (*(code **)(*param_3 + 0xf8) == glslang::TIntermTyped::getWritableType) {
...
void __thiscall
(anonymous_namespace)::TNoContractionPropagator::~TNoContractionPropagator
          (TNoContractionPropagator *this)
...
void __thiscall
(anonymous_namespace)::TSymbolDefinitionCollectingTraverser::visitSymbol
          (TSymbolDefinitionCollectingTraverser *this,TIntermSymbol *param_1)
...
LAB_00101213:
    ...
    if (uVar17 < 100) {
      ...
      acStack_57[0] = _LC19[8];
      acStack_57[1] = _LC19[9];
      acStack_57[2] = _LC19[10];
      acStack_57[3] = _LC19[0xb];
      acStack_57[4] = _LC19[0xc];
      acStack_57[5] = _LC19[0xd];
      acStack_57[6] = _LC19[0xe];
      acStack_57[7] = _LC19[0xf];
    }
    else {
      if (uVar17 < 1000) {
        uVar10 = 2;
...
LAB_001010ca:
      ...
      do {
        ...
        lVar19 = (uVar15 + ((SUB168(auVar3 * ZEXT816(0x28f5c28f5c28f5c3),8) & 0xfffffffffffffffc) +
                           uVar17) * -0x14) * 2;
        ...
        if ((TSymbolDefinitionCollectingTraverser *)*puVar6 == pTVar9) {
          ...
          if (7 < (uint)uVar15) {
            ...
            do {
              uVar16 = (int)uVar17 + 8;
              uVar12 = (ulong)uVar16;
              *(undefined8 *)((TSymbolDefinitionCollectingTraverser *)local_188 + uVar17) =
                   *(undefined8 *)(pTVar9 + uVar17);
              uVar17 = uVar12;
            } while (uVar16 < ((uint)uVar15 & 0xfffffff8));
                ...
                if (uVar16 < 8) {
                  if ((local_190 & 4) == 0) {
                    if (uVar16 != 0) {
                      ...
                      *(undefined2 *)(pTVar11 + (uVar15 - 2)) =
                           *(undefined2 *)((long)local_188 + (uVar15 - 2));
                      pTVar9 = *(TSymbolDefinitionCollectingTraverser **)(this + 0x50);
                    }
                  }
                  else {
                    *(undefined4 *)pTVar11 = (undefined4)local_188[0];
                    *(undefined4 *)(pTVar11 + (uVar15 - 4)) =
                         *(undefined4 *)((long)local_188 + (uVar15 - 4));
                    pTVar9 = *(TSymbolDefinitionCollectingTraverser **)(this + 0x50);
                  }
                }
                else {
                  *(long *)pTVar11 = local_188[0];
                  *(undefined8 *)(pTVar11 + ((local_190 & 0xffffffff) - 8)) =
                       *(undefined8 *)((long)local_188 + ((local_190 & 0xffffffff) - 8));
                  ...
                  if (7 < uVar16) {
                    ...
                    do {
                      uVar15 = (ulong)uVar10;
                      uVar10 = uVar10 + 8;
                      *(undefined8 *)(((ulong)(pTVar11 + 8) & 0xfffffffffffffff8) + uVar15) =
                           *(undefined8 *)
                            ((TSymbolDefinitionCollectingTraverser *)local_188 + (uVar15 - lVar19));
                    } while (uVar10 < uVar16);
                  }
LAB_00101707:
                  pTVar9 = *(TSymbolDefinitionCollectingTraverser **)(this + 0x50);
...
LAB_001013d5:
        ...
        *local_198 = (TSymbolDefinitionCollectingTraverser)0x0;
        ...
        psVar7 = (string *)
                 ...
                 ::operator[](*(_Map_base<glslang::TIntermTyped*,std::pair<glslang::TIntermTyped*const,std::__cxx11::string>,std::allocator<std::pair<glslang::TIntermTyped*const,std::__cxx11::string>>,std::__detail::_Select1st,std::equal_to<glslang::TIntermTyped*>,std::hash<glslang::TIntermTyped*>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>,true>
                                **)(this + 0x70),(TIntermTyped **)&local_1a0);
        if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
...
undefined8 __thiscall
(anonymous_namespace)::TNoContractionPropagator::visitBinary
          (TNoContractionPropagator *this,undefined8 param_2,TIntermTyped **param_3)
...
LAB_00101a33:
    ...
    if (lVar5 != 0) {
      ...
      local_88 = local_78;
      std::__cxx11::string::_M_construct<char*>
                ((string *)&local_88,*(long *)(lVar5 + 0x10),
...
LAB_00101aba:
        ...
        if (auVar9._0_8_ == 0) {
          ...
          ::
          _M_insert_unique<std::__cxx11::string_const&,std::__cxx11::string_const&,std::__detail::_AllocNode<std::allocator<std::__detail::_Hash_node<std::__cxx11::string,true>>>>
                    (*(string **)(this + 0x38),(string *)&local_88,auVar9._8_8_);
          uStack_b0 = 0x101c4f;
          std::
          _Hashtable<std::__cxx11::string,std::__cxx11::string,std::allocator<std::__cxx11::string>,std::__detail::_Identity,std::equal_to<std::__cxx11::string>,std::hash<std::__cxx11::string>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,true,true>>
          ::
          _M_insert_unique<std::__cxx11::string_const&,std::__cxx11::string_const&,std::__detail::_AllocNode<std::allocator<std::__detail::_Hash_node<std::__cxx11::string,true>>>>
                    ((string *)(this + 0x40),(string *)&local_88,extraout_RDX);
        }
...
LAB_00101ed3:
        ...
        std::__cxx11::string::_M_construct<char*>
                  ((string *)&plStack_130,*(long *)(lVar5 + 0x10),
                   *(long *)(lVar5 + 0x18) + *(long *)(lVar5 + 0x10));
        ...
        if (uVar1 == 0) {
          ...
          *(byte *)((long)ppTVar7 + 0xc) = *(byte *)((long)ppTVar7 + 0xc) | 0x10;
          ...
          if (((uStack_108 == 0x3fffffffffffffff) ||
              (std::__cxx11::string::_M_append((char *)&puStack_110,(ulong)&uStack_131),
              0x3fffffffffffffff - uStack_108 < uVar1)) ||
             (std::__cxx11::string::_M_append((char *)&puStack_110,uVar2),
             0x3fffffffffffffffU - lStack_128 < uStack_108)) {
            std::__throw_length_error("basic_string::append");
            goto LAB_00101ed3;
          }
        ...
        auVar9 = std::
                 _Hashtable<std::__cxx11::string,std::__cxx11::string,std::allocator<std::__cxx11::string>,std::__detail::_Identity,std::equal_to<std::__cxx11::string>,std::hash<std::__cxx11::string>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,true,true>>
                 ::find((_Hashtable<std::__cxx11::string,std::__cxx11::string,std::allocator<std::__cxx11::string>,std::__detail::_Identity,std::equal_to<std::__cxx11::string>,std::hash<std::__cxx11::string>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,true,true>>
                         *)(pcVar8 + 0x40),(string *)&plStack_130);
        if (auVar9._0_8_ == 0) {
          std::
          _Hashtable<std::__cxx11::string,std::__cxx11::string,std::allocator<std::__cxx11::string>,std::__detail::_Identity,std::equal_to<std::__cxx11::string>,std::hash<std::__cxx11::string>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,true,true>>
          ::
          _M_insert_unique<std::__cxx11::string_const&,std::__cxx11::string_const&,std::__detail::_AllocNode<std::allocator<std::__detail::_Hash_node<std::__cxx11::string,true>>>>
                    (*(string **)(pcVar8 + 0x38),(string *)&plStack_130,auVar9._8_8_);
          std::
          _Hashtable<std::__cxx11::string,std::__cxx11::string,std::allocator<std::__cxx11::string>,std::__detail::_Identity,std::equal_to<std::__cxx11::string>,std::hash<std::__cxx11::string>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,true,true>>
          ::
          _M_insert_unique<std::__cxx11::string_const&,std::__cxx11::string_const&,std::__detail::_AllocNode<std::allocator<std::__detail::_Hash_node<std::__cxx11::string,true>>>>
                    ((string *)(pcVar8 + 0x40),(string *)&plStack_130,extraout_RDX_00);
        }
...
void __thiscall
(anonymous_namespace)::TNoContractionPropagator::visitSymbol
          (TNoContractionPropagator *this,TIntermSymbol *param_1)

{
  ...
  lVar3 = std::
          _Hashtable<glslang::TIntermTyped*,std::pair<glslang::TIntermTyped*const,std::__cxx11::string>,std::allocator<std::pair<glslang::TIntermTyped*const,std::__cxx11::string>>,std::__detail::_Select1st,std::equal_to<glslang::TIntermTyped*>,std::hash<glslang::TIntermTyped*>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>>
          ::find(*(_Hashtable<glslang::TIntermTyped*,std::pair<glslang::TIntermTyped*const,std::__cxx11::string>,std::allocator<std::pair<glslang::TIntermTyped*const,std::__cxx11::string>>,std::__detail::_Select1st,std::equal_to<glslang::TIntermTyped*>,std::hash<glslang::TIntermTyped*>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>>
                   **)(this + 0x98),(TIntermTyped **)param_1);
  if (lVar3 != 0) {
    local_88 = local_78;
    std::__cxx11::string::_M_construct<char*>
              ((string *)&local_88,*(long *)(lVar3 + 0x10),
...
LAB_00101d6c:
      ...
      if (auVar5._0_8_ == 0) {
        ...
        ::
        _M_insert_unique<std::__cxx11::string_const&,std::__cxx11::string_const&,std::__detail::_AllocNode<std::allocator<std::__detail::_Hash_node<std::__cxx11::string,true>>>>
                  (*(string **)(this + 0x38),(string *)&local_88,auVar5._8_8_);
        std::
        _Hashtable<std::__cxx11::string,std::__cxx11::string,std::allocator<std::__cxx11::string>,std::__detail::_Identity,std::equal_to<std::__cxx11::string>,std::hash<std::__cxx11::string>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,true,true>>
        ::
        _M_insert_unique<std::__cxx11::string_const&,std::__cxx11::string_const&,std::__detail::_AllocNode<std::allocator<std::__detail::_Hash_node<std::__cxx11::string,true>>>>
...
undefined8 glslang::PropagateNoContraction(TIntermediate *param_1)
        ...
        if (ppppppplVar16 != (long *******)0x0) {
          ...
          do {
            ...
            ppppppplVar2 = (long *******)*ppppppplVar21;
                  ...
                  (pppppplVar4 = ppppppplVar2[1], ppppppplVar16 = ppppppplVar21,
                  ppppppplVar21 = ppppppplVar2, uVar25 == (ulong)pppppplVar4 % local_270));
        }
      }
      while( true ) {
...
LAB_001024e4:
      ...
      else if ((ppppppplVar21 != (long *******)0x0) &&
              (uVar25 != (ulong)ppppppplVar21[1] % local_270)) {
        local_278[(ulong)ppppppplVar21[1] % local_270] = ppppppplVar16;
        ppppppplVar21 = (long *******)*pppppplVar29;
      }
LAB_0010251d:
...
LAB_0010323c:
    ...
    local_198 = plVar17;
    std::__cxx11::string::_M_construct<char*>
              (psVar20,local_230[1],(long)local_230[2] + (long)local_230[1]);
    ...
    if (local_1b8 < 0x15) {
      ...
      puVar18 = (undefined8 *)
                ...
                ::_M_find_before_node
                          ((_Hashtable<std::__cxx11::string,std::pair<std::__cxx11::string_const,glslang::TIntermOperator*>,std::allocator<std::pair<std::__cxx11::string_const,glslang::TIntermOperator*>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::string>,std::hash<std::__cxx11::string>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,false>>
                            *)&local_1d0,uVar25 % local_1c8,(string *)local_3b0,uVar25);
      if ((puVar18 != (undefined8 *)0x0) &&
         (puVar18 = (undefined8 *)*puVar18, puVar18 != (undefined8 *)0x0)) {
LAB_001026da:
        puVar34 = (undefined8 *)*puVar18;
        if (puVar34 != (undefined8 *)0x0) {
          lVar11 = puVar18[6];
          do {
            if ((lVar11 != puVar34[6]) || (sVar3 = puVar18[2], sVar3 != puVar34[2])) {
LAB_001026fa:
              if (puVar18 == puVar34) goto LAB_00102bfd;
              break;
            }
            if (sVar3 != 0) {
...
LAB_00102932:
            ppTVar14 = (TIntermTyped **)plVar10[0x18];
            p_Var12 = local_290;
          }
          else {
LAB_00102b61:
...
LAB_0010365f:
                      ...
                      acStack_42f[0] = _LC19[8];
                      acStack_42f[1] = _LC19[9];
                      acStack_42f[2] = _LC19[10];
                      acStack_42f[3] = _LC19[0xb];
                      acStack_42f[4] = _LC19[0xc];
                      acStack_42f[5] = _LC19[0xd];
                      acStack_42f[6] = _LC19[0xe];
                      acStack_42f[7] = _LC19[0xf];
                      uVar26 = (ulong)uVar22;
                      do {
                        uVar33 = uVar22;
                        uVar25 = uVar26;
                        ...
                        *(undefined1 *)((long)puStack_520 + (ulong)uVar24) =
                             *(undefined1 *)((long)&uStack_4f0 + (ulong)(uVar23 + 1));
                        uVar23 = uVar24 - 1;
                        uVar24 = uVar24 - 2;
                      ...
                      if (uVar33 < 1000) {
LAB_001037a0:
                        cVar32 = (char)uVar22 + '0';
                      }
                      else {
LAB_001039d0:
                        cVar32 = *(char *)((long)&uStack_4f0 + (ulong)(uVar22 * 2));
                        *(undefined1 *)((long)puStack_520 + 1) =
                             *(undefined1 *)((long)&uStack_4f0 + (ulong)(uVar22 * 2 + 1));
                      }
                      ...
                      if (0x3fffffffffffffffU - *(long *)(pcVar30 + 0x58) < uStack_518) {
                        ...
                        **(undefined1 **)(pcVar31 + 0x50) = 0;
                        ...
                        if ((*(byte *)(auVar37._0_8_ + 0xc) & 0x10) != 0) {
                          ...
                          ::
                          _M_insert_unique<std::__cxx11::string_const&,std::__cxx11::string_const&,std::__detail::_AllocNode<std::allocator<std::__detail::_Hash_node<std::__cxx11::string,true>>>>
                                    (*(string **)(pcVar31 + 0x40),(string *)(pcVar31 + 0x50),
                                     auVar37._8_8_);
                        }
                        (anonymous_namespace)::getFrontElement
                                  ((_anonymous_namespace_ *)&plStack_5c8,(string *)(pcVar31 + 0x50))
                        ;
                        p_Var5 = *(_Hashtable<std::__cxx11::string,std::pair<std::__cxx11::string_const,glslang::TIntermOperator*>,std::allocator<std::pair<std::__cxx11::string_const,glslang::TIntermOperator*>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::string>,std::hash<std::__cxx11::string>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,false>>
                                   **)(pcVar31 + 0x38);
                        puStack_5a8 = auStack_598;
                        std::__cxx11::string::_M_construct<char*>
                                  (&puStack_5a8,plStack_5c8,lStack_5c0 + (long)plStack_5c8);
                          ...
                          if (uVar22 < 8) {
                            if ((uVar25 & 4) == 0) {
                              if (uVar22 != 0) {
                                ...
                                if ((uVar25 & 2) != 0) {
                                  *(undefined2 *)(p_Var19 + (uVar25 & 0xffffffff) + 0x16) =
                                       *(undefined2 *)
                                        ((long)&uStack_5a0 + (uVar25 & 0xffffffff) + 6);
                                }
                              }
                            }
                            else {
                              *(uint *)(p_Var19 + 0x18) = auStack_598[0];
                              *(undefined4 *)(p_Var19 + (uVar25 & 0xffffffff) + 0x14) =
                                   *(undefined4 *)((long)&uStack_5a0 + (uVar25 & 0xffffffff) + 4);
                            }
                          }
                          else {
                            *(ulong *)(p_Var19 + 0x18) = CONCAT44(auStack_598[1],auStack_598[0]);
                            *(undefined8 *)(p_Var19 + (uVar25 & 0xffffffff) + 0x10) =
                                 *(undefined8 *)((long)&uStack_5a0 + (uVar25 & 0xffffffff));
                            lVar11 = (long)(p_Var19 + 0x18) -
                                     ((ulong)(p_Var19 + 0x20) & 0xfffffffffffffff8);
                            ...
                            if (7 < uVar22) {
                              ...
                              do {
                                ...
                                uVar24 = uVar24 + 8;
                                *(undefined8 *)
                                 (((ulong)(p_Var19 + 0x20) & 0xfffffffffffffff8) + uVar25) =
                                     *(undefined8 *)((long)auStack_598 + (uVar25 - lVar11));
                              } while (uVar24 < uVar22);
                            }
                          }
                        }
                        ...
                        *(long **)(p_Var19 + 0x28) = plStack_588;
                        ...
                        auVar35 = std::
                                  _Hashtable<std::__cxx11::string,std::pair<std::__cxx11::string_const,glslang::TIntermOperator*>,std::allocator<std::pair<std::__cxx11::string_const,glslang::TIntermOperator*>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::string>,std::hash<std::__cxx11::string>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,false>>
                                  ::_M_compute_hash_code(p_Var5,0,p_Var19 + 8);
                        std::
                        _Hashtable<std::__cxx11::string,std::pair<std::__cxx11::string_const,glslang::TIntermOperator*>,std::allocator<std::pair<std::__cxx11::string_const,glslang::TIntermOperator*>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::string>,std::hash<std::__cxx11::string>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,false>>
                        ::_M_insert_multi_node(p_Var5,auVar35._0_8_,auVar35._8_8_,p_Var19);
                        if (puStack_5a8 != auStack_598) {
...
LAB_001034f6:
                      puStack_558 = (uint *)0x103509;
                      pTStack_548 = extraout_RDX;
                      psVar20 = (string *)
                                std::__detail::
                                _Map_base<glslang::TIntermTyped*,std::pair<glslang::TIntermTyped*const,std::__cxx11::string>,std::allocator<std::pair<glslang::TIntermTyped*const,std::__cxx11::string>>,std::__detail::_Select1st,std::equal_to<glslang::TIntermTyped*>,std::hash<glslang::TIntermTyped*>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>,true>
                                ::operator[](*(_Map_base<glslang::TIntermTyped*,std::pair<glslang::TIntermTyped*const,std::__cxx11::string>,std::allocator<std::pair<glslang::TIntermTyped*const,std::__cxx11::string>>,std::__detail::_Select1st,std::equal_to<glslang::TIntermTyped*>,std::hash<glslang::TIntermTyped*>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>,true>
                                               **)(pcVar30 + 0x70),&pTStack_548);
                ...
                if ((*(byte *)(auVar36._0_8_ + 0xc) & 0x10) != 0) {
                  ...
                  ::
                  _M_insert_unique<std::__cxx11::string_const&,std::__cxx11::string_const&,std::__detail::_AllocNode<std::allocator<std::__detail::_Hash_node<std::__cxx11::string,true>>>>
                            (*(string **)(pcVar30 + 0x40),(string *)(pcVar30 + 0x50),auVar36._8_8_);
                }
                puStack_558 = (uint *)0x1033a3;
                (anonymous_namespace)::getFrontElement
                          ((_anonymous_namespace_ *)&plStack_540,(string *)(pcVar30 + 0x50));
                p_Var5 = *(_Hashtable<std::__cxx11::string,std::pair<std::__cxx11::string_const,glslang::TIntermOperator*>,std::allocator<std::pair<std::__cxx11::string_const,glslang::TIntermOperator*>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::string>,std::hash<std::__cxx11::string>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,false>>
                           **)(pcVar30 + 0x38);
                puStack_558 = (uint *)0x1033c3;
                puStack_520 = auStack_510;
                std::__cxx11::string::_M_construct<char*>
                          (&puStack_520,plStack_540,lStack_538 + (long)plStack_540);
                  ...
                  if (uVar22 < 8) {
                    if ((uVar25 & 4) == 0) {
                      if (uVar22 != 0) {
                        ...
                        if ((uVar25 & 2) != 0) {
                          *(undefined2 *)(p_Var19 + (uVar25 & 0xffffffff) + 0x16) =
                               *(undefined2 *)((long)&uStack_518 + (uVar25 & 0xffffffff) + 6);
                        }
                      }
                    }
                    else {
                      ...
                      *(undefined4 *)(p_Var19 + (uVar25 & 0xffffffff) + 0x14) =
                           *(undefined4 *)((long)&uStack_518 + (uVar25 & 0xffffffff) + 4);
                    }
                  }
                  else {
                    *(ulong *)(p_Var19 + 0x18) = CONCAT44(auStack_510[1],auStack_510[0]);
                    *(undefined8 *)(p_Var19 + (uVar25 & 0xffffffff) + 0x10) =
                         *(undefined8 *)((long)&uStack_518 + (uVar25 & 0xffffffff));
                    ...
                    if (7 < uVar22) {
                      ...
                      do {
                        uVar25 = (ulong)uVar24;
                        uVar24 = uVar24 + 8;
                        *(undefined8 *)(((ulong)(p_Var19 + 0x20) & 0xfffffffffffffff8) + uVar25) =
                             *(undefined8 *)((long)auStack_510 + (uVar25 - lVar11));
                      } while (uVar24 < uVar22);
                    }
                  }
                }
...
LAB_001034b4:
                if (lStack_418 == *(long *)(in_FS_OFFSET + 0x28)) {
                  return 0;
                }
                    /* WARNING: Subroutine does not return */
              ...
              local_138 = local_3c8;
              std::__cxx11::string::_M_construct<char_const*>
                        (&local_138,(long)local_198 + (long)(local_150 + 1U),
                         (long)local_190 + (long)local_198);
            }
            else {
              local_3c8 = (_Hashtable<glslang::TIntermTyped*,std::pair<glslang::TIntermTyped*const,std::__cxx11::string>,std::allocator<std::pair<glslang::TIntermTyped*const,std::__cxx11::string>>,std::__detail::_Select1st,std::equal_to<glslang::TIntermTyped*>,std::hash<glslang::TIntermTyped*>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>>
                           *)local_128;
              ...
              local_138 = local_3c8;
              std::__cxx11::string::_M_construct<char*>
                        (&local_138,local_198,(long)local_190 + (long)local_198);
            }
            p_Var12 = (_Hashtable<glslang::TIntermTyped*,std::pair<glslang::TIntermTyped*const,std::__cxx11::string>,std::allocator<std::pair<glslang::TIntermTyped*const,std::__cxx11::string>>,std::__detail::_Select1st,std::equal_to<glslang::TIntermTyped*>,std::hash<glslang::TIntermTyped*>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>>
                       *)local_108;
            local_118 = p_Var12;
          ...
          if (p_Var12 ==
            ...
            if (plVar17 != (long *)0x0) {
              ...
              if (uVar22 < 0xb3) {
                if (0xae < uVar22) {
LAB_00102ec0:
                  if (*(code **)(*plVar17 + 0xf8) == TIntermTyped::getWritableType) {
                    p_Var12 = (_Hashtable<glslang::TIntermTyped*,std::pair<glslang::TIntermTyped*const,std::__cxx11::string>,std::allocator<std::pair<glslang::TIntermTyped*const,std::__cxx11::string>>,std::__detail::_Select1st,std::equal_to<glslang::TIntermTyped*>,std::hash<glslang::TIntermTyped*>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>>
                               *)(plVar17 + 4);
                  }
                  else {
...
LAB_00102a50:
            if (*(code **)(*(long *)local_3c8 + 0xf8) == TIntermTyped::getWritableType) {
              p_Var12 = local_3c8 + 0x20;
            }
            else {
              psStack_3e0 = (string *)0x103175;
              p_Var12 = (_Hashtable<glslang::TIntermTyped*,std::pair<glslang::TIntermTyped*const,std::__cxx11::string>,std::allocator<std::pair<glslang::TIntermTyped*const,std::__cxx11::string>>,std::__detail::_Select1st,std::equal_to<glslang::TIntermTyped*>,std::hash<glslang::TIntermTyped*>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>>
                         *)(**(code **)(*(long *)local_3c8 + 0xf8))(local_3c8);
            }
LAB_00102a6e:
            if (*(code **)(*(long *)p_Var12 + 0x50) == TType::getQualifier) {
              p_Var12 = p_Var12 + 0x10;
            }
            else {
              psStack_3e0 = (string *)0x103162;
              p_Var12 = (_Hashtable<glslang::TIntermTyped*,std::pair<glslang::TIntermTyped*const,std::__cxx11::string>,std::allocator<std::pair<glslang::TIntermTyped*const,std::__cxx11::string>>,std::__detail::_Select1st,std::equal_to<glslang::TIntermTyped*>,std::hash<glslang::TIntermTyped*>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>>
                         *)(**(code **)(*(long *)p_Var12 + 0x50))();
            }
            p_Var12[0xc] = (_Hashtable<glslang::TIntermTyped*,std::pair<glslang::TIntermTyped*const,std::__cxx11::string>,std::allocator<std::pair<glslang::TIntermTyped*const,std::__cxx11::string>>,std::__detail::_Select1st,std::equal_to<glslang::TIntermTyped*>,std::hash<glslang::TIntermTyped*>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>>
                            )((byte)p_Var12[0xc] | 0x10);
          }
        }
LAB_0010282c:
        if (local_118 !=
...
LAB_00102c40:
      ...
      ppppppplVar16 =
           ...
           std::
           _Hashtable<std::__cxx11::string,std::__cxx11::string,std::allocator<std::__cxx11::string>,std::__detail::_Identity,std::equal_to<std::__cxx11::string>,std::hash<std::__cxx11::string>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,true,true>>
           ::_M_find_before_node(local_3a8,uVar26,local_3c0,uVar25);
      if (ppppppplVar16 != (long *******)0x0) {
        pppppplVar29 = *ppppppplVar16;
LAB_00102c86:
        ppppppplVar21 = (long *******)*pppppplVar29;
        ...
        if (ppppppplVar16 == ppppppplVar2) {
          ...
          ppppppplVar21 = (long *******)*pppppplVar29;
                ...
                (uVar26 != (ulong)ppppppplVar21[5] % local_238)) {
          local_240[(ulong)ppppppplVar21[5] % local_238] = ppppppplVar16;
          ppppppplVar21 = (long *******)*pppppplVar29;
        }
LAB_00102cc2:
        pppppplVar4 = (long ******)pppppplVar29[1];
        *ppppppplVar16 = (long ******)ppppppplVar21;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* (anonymous namespace)::TSymbolDefinitionCollectingTraverser::visitBinary(glslang::TVisit,
   glslang::TIntermBinary*) */

undefined8 __thiscall
(anonymous_namespace)::TSymbolDefinitionCollectingTraverser::visitBinary
          (TSymbolDefinitionCollectingTraverser *this,undefined8 param_2,TIntermTyped *param_3)
...
LAB_0010365f:
            ...
            do {
              ...
              *(undefined1 *)((long)local_148 + (ulong)uVar9) =
                   *(undefined1 *)((long)&local_118 + (ulong)(uVar8 + 1));
              uVar8 = uVar9 - 1;
              uVar9 = uVar9 - 2;
        ...
        if (0x3fffffffffffffffU - *(long *)(this + 0x58) < local_140) {
          ...
          **(undefined1 **)(pcVar13 + 0x50) = 0;
          ...
          if ((*(byte *)(auVar16._0_8_ + 0xc) & 0x10) != 0) {
            ...
            ::
            _M_insert_unique<std::__cxx11::string_const&,std::__cxx11::string_const&,std::__detail::_AllocNode<std::allocator<std::__detail::_Hash_node<std::__cxx11::string,true>>>>
                      (*(string **)(pcVar13 + 0x40),(string *)(pcVar13 + 0x50),auVar16._8_8_);
          }
          ...
          std::__cxx11::string::_M_construct<char*>
                    (&puStack_1d0,plStack_1f0,lStack_1e8 + (long)plStack_1f0);
            ...
            if (uVar7 < 8) {
              if ((uVar12 & 4) == 0) {
                if (uVar7 != 0) {
                  ...
                  if ((uVar12 & 2) != 0) {
                    *(undefined2 *)(p_Var3 + (uVar12 & 0xffffffff) + 0x16) =
                         *(undefined2 *)((long)&uStack_1c8 + (uVar12 & 0xffffffff) + 6);
                  }
                }
              }
              else {
                *(uint *)(p_Var3 + 0x18) = auStack_1c0[0];
                *(undefined4 *)(p_Var3 + (uVar12 & 0xffffffff) + 0x14) =
                     *(undefined4 *)((long)&uStack_1c8 + (uVar12 & 0xffffffff) + 4);
              }
            }
            else {
              *(ulong *)(p_Var3 + 0x18) = CONCAT44(auStack_1c0[1],auStack_1c0[0]);
              *(undefined8 *)(p_Var3 + (uVar12 & 0xffffffff) + 0x10) =
                   *(undefined8 *)((long)&uStack_1c8 + (uVar12 & 0xffffffff));
              ...
              if (7 < uVar7) {
                ...
                do {
                  uVar12 = (ulong)uVar9;
                  uVar9 = uVar9 + 8;
                  *(undefined8 *)(((ulong)(p_Var3 + 0x20) & 0xfffffffffffffff8) + uVar12) =
                       *(undefined8 *)((long)auStack_1c0 + (uVar12 - lVar10));
                } while (uVar9 < uVar7);
              }
            }
          }
          ...
          *(long **)(p_Var3 + 0x28) = plStack_1b0;
          ...
          auVar16 = std::
                    _Hashtable<std::__cxx11::string,std::pair<std::__cxx11::string_const,glslang::TIntermOperator*>,std::allocator<std::pair<std::__cxx11::string_const,glslang::TIntermOperator*>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::string>,std::hash<std::__cxx11::string>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,false>>
                    ::_M_compute_hash_code(p_Var2,0,p_Var3 + 8);
          std::
          _Hashtable<std::__cxx11::string,std::pair<std::__cxx11::string_const,glslang::TIntermOperator*>,std::allocator<std::pair<std::__cxx11::string_const,glslang::TIntermOperator*>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::string>,std::hash<std::__cxx11::string>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,false>>
          ::_M_insert_multi_node(p_Var2,auVar16._0_8_,auVar16._8_8_,p_Var3);
          if (puStack_1d0 != auStack_1c0) {
...
LAB_001032d7:
  ...
  if ((*(byte *)(auVar17._0_8_ + 0xc) & 0x10) != 0) {
    ...
    ::
    _M_insert_unique<std::__cxx11::string_const&,std::__cxx11::string_const&,std::__detail::_AllocNode<std::allocator<std::__detail::_Hash_node<std::__cxx11::string,true>>>>
              (*(string **)(this + 0x40),(string *)(this + 0x50),auVar17._8_8_);
  }
    ...
    if (uVar7 < 8) {
      if ((uVar12 & 4) == 0) {
        if (uVar7 != 0) {
          ...
          if ((uVar12 & 2) != 0) {
            *(undefined2 *)(p_Var3 + (uVar12 & 0xffffffff) + 0x16) =
                 *(undefined2 *)((long)&local_140 + (uVar12 & 0xffffffff) + 6);
          }
        }
      }
      else {
        ...
        *(undefined4 *)(p_Var3 + (uVar12 & 0xffffffff) + 0x14) =
             *(undefined4 *)((long)&local_140 + (uVar12 & 0xffffffff) + 4);
      }
    }
    else {
      *(ulong *)(p_Var3 + 0x18) = CONCAT44(local_138[1],local_138[0]);
      *(undefined8 *)(p_Var3 + (uVar12 & 0xffffffff) + 0x10) =
           *(undefined8 *)((long)&local_140 + (uVar12 & 0xffffffff));
      lVar10 = (long)(p_Var3 + 0x18) - ((ulong)(p_Var3 + 0x20) & 0xfffffffffffffff8);
      uVar7 = uVar7 + (int)lVar10 & 0xfffffff8;
      if (7 < uVar7) {
        uVar9 = 0;
        do {
          ...
          uVar9 = uVar9 + 8;
          *(undefined8 *)(((ulong)(p_Var3 + 0x20) & 0xfffffffffffffff8) + uVar12) =
               *(undefined8 *)((long)local_138 + (uVar12 - lVar10));
        } while (uVar9 < uVar7);
      }
    }
  }
...
undefined8 __thiscall
(anonymous_namespace)::TSymbolDefinitionCollectingTraverser::visitUnary
          (TSymbolDefinitionCollectingTraverser *this,undefined8 param_2,long *param_3)

{
  ...
  **(undefined1 **)(this + 0x50) = 0;
  ...
  if ((*(byte *)(auVar7._0_8_ + 0xc) & 0x10) != 0) {
    ...
    ::
    _M_insert_unique<std::__cxx11::string_const&,std::__cxx11::string_const&,std::__detail::_AllocNode<std::allocator<std::__detail::_Hash_node<std::__cxx11::string,true>>>>
              (*(string **)(this + 0x40),(string *)(this + 0x50),auVar7._8_8_);
  }
    ...
    if (uVar3 < 8) {
      if ((uVar6 & 4) == 0) {
        if (uVar3 != 0) {
          ...
          if ((uVar6 & 2) != 0) {
            *(undefined2 *)(p_Var1 + (uVar6 & 0xffffffff) + 0x16) =
      ...
      *(undefined8 *)(p_Var1 + (uVar6 & 0xffffffff) + 0x10) =
      ...
      if (7 < uVar3) {
        ...
        do {
          uVar6 = (ulong)uVar4;
          uVar4 = uVar4 + 8;
          *(undefined8 *)(((ulong)(p_Var1 + 0x20) & 0xfffffffffffffff8) + uVar6) =
  ...
  *(long **)(p_Var1 + 0x28) = local_38;
  ...
  auVar7 = std::
           _Hashtable<std::__cxx11::string,std::pair<std::__cxx11::string_const,glslang::TIntermOperator*>,std::allocator<std::pair<std::__cxx11::string_const,glslang::TIntermOperator*>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::string>,std::hash<std::__cxx11::string>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,false>>
           ::_M_compute_hash_code(this_00,0,p_Var1 + 8);
  std::
  _Hashtable<std::__cxx11::string,std::pair<std::__cxx11::string_const,glslang::TIntermOperator*>,std::allocator<std::pair<std::__cxx11::string_const,glslang::TIntermOperator*>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::string>,std::hash<std::__cxx11::string>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,false>>
  ::_M_insert_multi_node(this_00,auVar7._0_8_,auVar7._8_8_,p_Var1);
  if (local_58 != local_48) {
  ...
  *p_Var11;
  ...
  if (plVar6 != (long *)0x0) {
    ...
    while (pTVar1 != pTVar2) {
      plVar9 = (long *)*plVar8;
      if ((plVar9 == (long *)0x0) ||
         (pTVar2 = (TIntermTyped *)plVar9[1], plVar6 = plVar8, plVar8 = plVar9,
         uVar7 != (ulong)pTVar2 % *(ulong *)(this + 8))) goto LAB_00104290;
    }
    if (*plVar6 != 0) {
...
LAB_00104397:
    if (*(_Map_base<glslang::TIntermTyped*,std::pair<glslang::TIntermTyped*const,std::__cxx11::string>,std::allocator<std::pair<glslang::TIntermTyped*const,std::__cxx11::string>>,std::__detail::_Select1st,std::equal_to<glslang::TIntermTyped*>,std::hash<glslang::TIntermTyped*>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>,true>
          **)this != this + 0x30) {
  ...
  if (plVar5 != (long *)0x0) {
    ...
    do {
      ...
      plVar1 = (long *)*plVar4;
            ...
            (uVar3 = plVar1[5], plVar5 = plVar4, param_1 == uVar3 % *(ulong *)(this + 8)));
    plVar5 = (long *)0x0;
  }
  return plVar5;
}
...
/* std::_Hashtable<std::__cxx11::string, std::pair<std::__cxx11::string const,
   ...
   glslang::TIntermOperator*>, false, true>, std::__cxx11::string const&) const */

undefined1  [16] __thiscall
std::
_Hashtable<std::__cxx11::string,std::pair<std::__cxx11::string_const,glslang::TIntermOperator*>,std::allocator<std::pair<std::__cxx11::string_const,glslang::TIntermOperator*>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::string>,std::hash<std::__cxx11::string>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,false>>
::_M_compute_hash_code
          (_Hashtable<std::__cxx11::string,std::pair<std::__cxx11::string_const,glslang::TIntermOperator*>,std::allocator<std::pair<std::__cxx11::string_const,glslang::TIntermOperator*>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::string>,std::hash<std::__cxx11::string>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,false>>
...
LAB_00104638:
    for (plVar3 = *(long **)(this + 0x10); param_2 != plVar3; plVar3 = (long *)*plVar3) {
      while (plVar3[2] == __n) {
...
LAB_00104684:
  uVar2 = std::_Hash_bytes(__s1,__n,0xc70f6907);
  auVar4._8_8_ = uVar2;
...
/* std::_Hashtable<std::__cxx11::string, std::pair<std::__cxx11::string const,
   ...
   std::__cxx11::string const&, unsigned long) const */
...
::_M_insert_multi_node
          (_Hashtable<std::__cxx11::string,std::pair<std::__cxx11::string_const,glslang::TIntermOperator*>,std::allocator<std::pair<std::__cxx11::string_const,glslang::TIntermOperator*>>,std::__detail::_Select1st,std::equal_to<std::__cxx11::string>,std::hash<std::__cxx11::string>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<true,false,false>>
           *this,_Hash_node *param_1,ulong param_2,_Hash_node *param_3)

{
  ...
  *__s;
  ...
  cVar7 = std::__detail::_Prime_rehash_policy::_M_need_rehash
                    ((ulong)(this + 0x20),*(ulong *)(this + 8),*(ulong *)(this + 0x18));
  if (cVar7 == '\0') {
    local_58 = *(ulong *)(this + 8);
LAB_001047a3:
    *(ulong *)(param_3 + 0x30) = param_2;
...
LAB_0010484b:
      ...
      *(undefined8 *)(this + 0x10) = 0;
      if (plVar2 != (long *)0x0) {
        ...
        do {
          ...
          if (bVar5) {
            ...
            *plVar15 = (long)plVar14;
            ...
            if (((bVar6) && (*plVar15 != 0)) &&
               (uVar12 = *(ulong *)(*plVar15 + 0x30) % extraout_RDX, uVar12 != uVar11)) {
        ...
        if (((bVar16 && bVar17) && (*plVar14 != 0)) &&
           (uVar11 = *(ulong *)(*plVar14 + 0x30) % extraout_RDX, uVar13 != uVar11)) {
...
LAB_00104a73:
    sVar4 = *(size_t *)(param_3 + 0x10);
    if (sVar4 == *(size_t *)(p_Var10 + 0x10)) {
      if ((sVar4 != 0) &&
         (iVar8 = memcmp(*(void **)(param_3 + 8),*(void **)(p_Var10 + 8),sVar4), iVar8 != 0))
      goto LAB_0010498f;
...
LAB_0010498f:
      p_Var10 = (_Hash_node *)_M_find_before_node(this,uVar11,unaff_R14,param_2);
    ...
    if (lVar3 != 0) {
      ...
      if ((param_2 == uVar13) &&
         (sVar4 = *(size_t *)(param_3 + 0x10), sVar4 == *(size_t *)(lVar3 + 0x10))) {
        if ((sVar4 == 0) ||
           (iVar8 = memcmp(*(void **)(param_3 + 8),*(void **)(lVar3 + 8),sVar4), iVar8 == 0))
        goto LAB_001047ea;
      }

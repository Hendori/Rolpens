...
ulong __thiscall
(anonymous_namespace)::isSpecialTypeCodepoints
          (_anonymous_namespace_ *this,_anonymous_namespace_ *param_2)
...
LAB_00100058:
  return CONCAT71((int7)(uVar2 >> 8),iVar3 - 4U < 3);
}
...
bool __thiscall
(anonymous_namespace)::isSpecialTypeReorderCode(_anonymous_namespace_ *this,char *param_2)
...
bool __thiscall
(anonymous_namespace)::isSpecialTypeRgKeyValue(_anonymous_namespace_ *this,byte *param_2)
...
/* (anonymous namespace)::initFromResourceBundle(UErrorCode&) */

void (anonymous_namespace)::initFromResourceBundle(UErrorCode *param_1)

{
  ...
  gLocExtKeyMap =
       uhash_open_76_godot(&uhash_hashIStringView_76_godot,&uhash_compareIStringView_76_godot,0,
                           param_1);
  ...
  if (gKeyTypeStringPool == (int *)0x0) {
    ...
    *(undefined1 *)(gKeyTypeStringPool + 5) = 0;
    gLocExtKeyDataEntries =
         (int *)icu_76_godot::UMemory::operator_new((UMemory *)0x58,(ulong)pcVar27);
        ...
        *(undefined1 *)(gLocExtTypeEntries + 5) = 0;
        ...
        if (gTypeAliasEntries != (int *)0x0) {
          ...
          *(undefined1 *)(gTypeAliasEntries + 5) = 0;
          local_150 = 0;
LAB_00100580:
          cVar1 = ures_hasNext_76_godot(lVar5);
          if ((cVar1 != '\0') &&
             (local_150 = ures_getNextResource_76_godot(lVar5,local_150,param_1),
             *(int *)param_1 < 1)) {
...
LAB_00100859:
                  pUVar11 = (UnicodeString *)
                            icu_76_godot::UMemory::operator_new((UMemory *)0x40,(ulong)pUVar28);
...
LAB_001006d5:
              iVar2 = strcmp(pcVar27,"timezone");
              sVar10 = uhash_open_76_godot(&uhash_hashIStringView_76_godot,
                                           &uhash_compareIStringView_76_godot,0,param_1);
              if (0 < *(int *)param_1) goto LAB_00100680;
              if (lVar7 == 0) {
LAB_0010074c:
                lVar22 = 0;
                ...
                do {
                  while( true ) {
                    while( true ) {
                      ...
                      while( true ) {
                        if ((cVar1 == '\0') ||
                           (lVar12 = ures_getNextResource_76_godot(lVar25,lVar12,param_1),
                           0 < *(int *)param_1)) goto LAB_00100eb2;
...
LAB_001015a1:
                          ...
                          iVar30 = iVar3 * 2;
                          if ((0 < iVar30) &&
                             (lVar23 = uprv_malloc_76_godot((long)iVar30 << 3), lVar23 != 0)) {
...
LAB_001015ef:
                        plVar21 = (long *)icu_76_godot::UMemory::operator_new((UMemory *)0x40,uVar9)
                        ;
                        if (plVar21 != (long *)0x0) {
                          ...
                          *(undefined4 *)(plVar21 + 7) = 0;
                          icu_76_godot::CharString::append
                                    ((char *)plVar21,(int)local_d8,(UErrorCode *)(ulong)local_d0);
                          iVar3 = *piVar29;
                          iVar30 = *(int *)param_1;
                          *piVar29 = iVar3 + 1;
...
LAB_00100b58:
                  psVar19 = (size_t *)
                            icu_76_godot::UMemory::operator_new((UMemory *)0x20,(ulong)pUVar28);
...
LAB_00101238:
                            ...
                            iVar30 = iVar3 * 2;
                            if ((0 < iVar30) &&
                               (lVar17 = uprv_malloc_76_godot((long)iVar30 << 3), lVar17 != 0)) {
                              lVar24 = (long)iVar30;
...
LAB_0010128a:
                          psVar18 = (size_t *)
                                    icu_76_godot::UMemory::operator_new((UMemory *)0x10,sVar20);
...
LAB_001013b4:
                              plVar21 = (long *)icu_76_godot::UMemory::operator_new
                                                          ((UMemory *)0x40,uVar9);
                              if (plVar21 != (long *)0x0) {
                                icu_76_godot::StringPiece::StringPiece
                                          ((StringPiece *)&local_d8,pcVar13);
                                *(undefined2 *)((long)plVar21 + 0xc) = 0;
                                *plVar21 = (long)plVar21 + 0xd;
                                *(undefined4 *)(plVar21 + 1) = 0x28;
                                *(undefined4 *)(plVar21 + 7) = 0;
                                icu_76_godot::CharString::append
                                          ((char *)plVar21,(int)local_d8,
                                           (UErrorCode *)(ulong)local_d0);
                                iVar3 = *(int *)param_1;
                                iVar30 = *piVar29;
                                *piVar29 = iVar30 + 1;
...
LAB_00100c08:
                  if (local_198 != 0) {
                    ...
                    while (cVar1 = ures_hasNext_76_godot(local_198), cVar1 != '\0') {
                      ...
                      if (0 < *(int *)param_1) goto LAB_00100e98;
                      sVar20 = psVar19[3];
                      iVar3 = uprv_compareInvAscii_76_godot
                                        (0,sVar20,(int)psVar19[2],uVar15,local_d8 & 0xffffffff);
                      if (iVar3 == 0) {
                        pcVar13 = (char *)ures_getKey_76_godot(lVar23);
                        piVar29 = gTypeAliasEntries;
                        sVar16 = strlen(pcVar13);
...
LAB_00100f2d:
        ...
        iVar3 = iVar2 * 2;
        if ((0 < iVar3) && (lVar12 = uprv_malloc_76_godot((long)iVar3 << 3), lVar12 != 0)) {
...
LAB_00100f6f:
      psVar19 = (size_t *)icu_76_godot::UMemory::operator_new((UMemory *)0x30,uVar9);
...
/* ulocimp_toBcpKey_76_godot(std::basic_string_view<char, std::char_traits<char> >) */

undefined8 * ulocimp_toBcpKey_76_godot(undefined8 *param_1,undefined8 param_2,undefined8 param_3)
...
LAB_00101b59:
    if (DAT_00101fbc < 1) goto LAB_00101bb7;
  }
  else {
...
/* ulocimp_toLegacyKey_76_godot(std::basic_string_view<char, std::char_traits<char> >) */

undefined8 * ulocimp_toLegacyKey_76_godot(undefined8 *param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  if (gLocExtKeyMapInitOnce == 2) {
LAB_00101c29:
    if (DAT_00101fbc < 1) goto LAB_00101c87;
  }
  else {
    cVar3 = icu_76_godot::umtx_initImplPreInit((UInitOnce *)&gLocExtKeyMapInitOnce);
...
undefined8 *
ulocimp_toBcpType_76_godot
          (undefined8 *param_1,undefined8 param_2,undefined8 param_3,_anonymous_namespace_ *param_4,
          undefined8 param_5)

{
  ...
  local_30 = param_3;
  if ((gLocExtKeyMapInitOnce == 2) ||
     (cVar3 = icu_76_godot::umtx_initImplPreInit((UInitOnce *)&gLocExtKeyMapInitOnce), cVar3 == '\0'
     )) {
    ...
    icu_76_godot::umtx_initImplPostInit((UInitOnce *)&gLocExtKeyMapInitOnce);
LAB_00101d5f:
    if ((local_24 < 1) && (lVar4 = uhash_get_76_godot(gLocExtKeyMap,&local_38), lVar4 != 0)) {
      ...
      if (uVar6 != 0) {
        if (((uVar6 & 1) == 0) ||
           (cVar3 = (anonymous_namespace)::isSpecialTypeCodepoints(local_48,uStack_40),
           cVar3 == '\0')) {
          uVar6 = (uint)uVar7;
          if ((uVar7 & 2) != 0) {
          ...
          if (((uVar6 & 4) == 0) ||
             (cVar3 = (anonymous_namespace)::isSpecialTypeRgKeyValue(local_48,uStack_40),
             cVar3 == '\0')) goto LAB_00101d0d;
        }
LAB_00101dcd:
        *(undefined1 *)(param_1 + 2) = 1;
        *param_1 = local_48;

...
void BrotliBuildCodeLengthsHuffmanTable(undefined1 *param_1,long param_2,long param_3)

{
  ...
  do {
    iVar5 = local_a8[pbVar10[5]];
    local_a8[pbVar10[5]] = iVar5 + -1;
    *(int *)((long)&local_88 + (long)iVar5 * 2 * 2) = iVar4 + -1;
    iVar5 = local_a8[pbVar10[4]];
    local_a8[pbVar10[4]] = iVar5 + -1;
    *(int *)((long)&local_88 + (long)iVar5 * 2 * 2) = iVar4 + -2;
    iVar5 = local_a8[pbVar10[3]];
    local_a8[pbVar10[3]] = iVar5 + -1;
    *(int *)((long)&local_88 + (long)iVar5 * 2 * 2) = iVar4 + -3;
    iVar5 = local_a8[pbVar10[2]];
    local_a8[pbVar10[2]] = iVar5 + -1;
    *(int *)((long)&local_88 + (long)iVar5 * 2 * 2) = iVar4 + -4;
...
uint BrotliBuildSimpleHuffmanTable
               (undefined1 *param_1,byte param_2,ushort *param_3,undefined4 param_4)

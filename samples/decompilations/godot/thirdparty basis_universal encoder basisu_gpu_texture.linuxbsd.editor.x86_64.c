          ...
          do {
            ...
            if (uVar21 != 0) {
              do {
                ...
                uVar16 = uVar16 + 1;
                *(undefined8 *)((long)local_2a8 + (ulong)uVar21 * 8) =
                     *(undefined8 *)((long)local_2d0 + (ulong)uVar24 * 8);
                uVar24 = local_2a0._12_4_;
                uVar21 = local_2a0._8_4_;
          ...
          if ((uVar16 != 0) && (uVar24 != 0)) {
            ...
            do {
              ...
              do {
                ...
                uVar19 = uVar19 + 1;
                *(undefined8 *)((long)pvVar3 + (ulong)uVar17 * 8) =
                     *(undefined8 *)((long)pvVar5 + (ulong)uVar22 * 8);
              } while (uVar19 < uVar16);
              uVar20 = uVar20 + 1;
        ...
        if (uVar24 != 0) {
          do {
            cVar8 = unpack_block(*(undefined4 *)this,
                                 *(long *)(this + 0x20) +
                                 (ulong)((uVar24 * uVar21 + uVar20) * *(int *)(this + 0x1c)) * 8,
                                 local_288);
            iVar9 = *(int *)(this + 0x18);
            if (cVar8 == '\0') {
              uVar23 = 0;
                ...
                do {
                  ...
                  do {
                    ...
                    if ((uVar17 < *(uint *)param_1) && (uVar16 < *(uint *)(param_1 + 4))) {
                      *(undefined4 *)
                       (*(long *)(param_1 + 0x10) +
                       (ulong)(*(int *)(param_1 + 8) * uVar16 + uVar17) * 4) = *puVar12;
                    }
                    uVar17 = uVar17 + 1;
                    puVar12 = puVar13;
...
/* WARNING: Removing unreachable block (ram,0x001045be) */
...

{
  ...
  if ((uVar18 == uVar16) &&
     ((uVar19 == *(uint *)(param_1 + 4) && (uVar16 == *(uint *)(param_1 + 8))))) {
LAB_00104565:
...
LAB_0010463d:
    if ((uVar18 != 0) && (*(int *)(param_1 + 4) != 0)) {
      ...
      if (*(int *)(this + 0x10) != 0) {
        ...
        do {
          ...
          if (uVar16 != 0) {
            do {
              cVar7 = unpack_block_hdr(*(undefined4 *)this,
                                       *(long *)(this + 0x20) +
                                       (ulong)((uVar16 * uVar18 + uVar19) * *(int *)(this + 0x1c)) *
                                       8,local_948);
              ...
              if (iVar21 != 0) {
                ...
                if (iVar1 == 0) {
                  ...
                  do {
                    do {
                      if (((uVar8 < uVar2) && (uVar16 < *(uint *)(param_1 + 4))) &&
                         (puVar14 = (undefined8 *)
                                    ((ulong)(*(int *)(param_1 + 8) * uVar16 + uVar8) * 0x10 +
                                    *(long *)(param_1 + 0x10)), puVar9 != puVar14)) {
                        uVar5 = puVar9[1];
                        *puVar14 = *puVar9;
                        puVar14[1] = uVar5;
                      }
    ...
    if ((*(int *)(this + 4) != 0) && (*(int *)(this + 8) != 0)) {
      ...
      *(undefined8 *)(param_1 + 0x10) = 0;
      if (iVar21 != 0) {
        basisu::elemental_vector::increase_capacity
                  ((int)param_1 + 0x10,SUB41(iVar21,0),(uint)(iVar21 == 1),
      ...
      do {
        uVar15 = 0;
        do {
          while ((puVar9 = (undefined8 *)((ulong)(uVar15 + iVar21) * 0x10 + lVar13), uVar15 < uVar16
                 && (uVar17 < *(uint *)(param_1 + 4)))) {
            puVar12 = (undefined8 *)
                      ((ulong)(*(int *)(param_1 + 8) * uVar17 + uVar15) * 0x10 + (long)__ptr);
            if (puVar12 != puVar9) {
              uVar4 = puVar12[1];
              *puVar9 = *puVar12;
              puVar9[1] = uVar4;

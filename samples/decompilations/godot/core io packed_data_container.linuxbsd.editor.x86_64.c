...
/* PackedDataContainer::_get_data() const */

void PackedDataContainer::_get_data(void)
...
/* PackedDataContainer::_set_data(Vector<unsigned char> const&) */

void __thiscall PackedDataContainer::_set_data(PackedDataContainer *this,Vector *param_1)
...
/* PackedDataContainer::_get_at_ofs(unsigned int, unsigned char const*, bool&) const */

Variant * PackedDataContainer::_get_at_ofs(uint param_1,uchar *param_2,bool *param_3)

{
  ...
  if (uVar7 < iVar5 + 4U) {
    _err_print_error("_get_at_ofs","core/io/packed_data_container.cpp",0x66,
                     "Condition \"p_ofs + 4 > (uint32_t)data.size()\" is true. Returning: Variant()"
                     ,0,0);
  ...
  if (uVar7 < 0xfffffffe) {
    ...
    iVar5 = decode_variant((Variant *)local_48,puVar1,*(int *)(param_2 + 0x250) - iVar5,(int *)0x0,
                           false,0);
    if (iVar5 == 0) {
      ...
      *in_R8 = 1;
      _err_print_error("_get_at_ofs","core/io/packed_data_container.cpp",0x76,
...
LAB_0010047c:
      ...
      *(uchar **)((Object *)this + 0x180) = param_2;
      ...
      if (((pOVar3 == (Object *)0x0) || (cVar4 = RefCounted::unreference(), cVar4 == '\0')) ||
         (cVar4 = predelete_handler(pOVar3), cVar4 == '\0')) goto LAB_0010047c;
LAB_001005a7:
...
/* PackedDataContainer::_type_at_ofs(unsigned int) const */

uint __thiscall PackedDataContainer::_type_at_ofs(PackedDataContainer *this,uint param_1)

{
  ...
  if (lVar2 == 0) {
    if (param_1 == 0xfffffffc) {
      _err_print_error("_type_at_ofs","core/io/packed_data_container.cpp",0x7f,
                       "Parameter \"rd\" is null.",0,0);
      return 0;
    }
  }
  ...
  _err_print_error("_type_at_ofs","core/io/packed_data_container.cpp",0x7d,
                   "Condition \"p_ofs + 4 > (uint32_t)data.size()\" is true. Returning: 0",0,0);
  return 0;
}



/* PackedDataContainer::_size(unsigned int) const */

uint __thiscall PackedDataContainer::_size(PackedDataContainer *this,uint param_1)

{
  ...
  if (lVar6 == 0) {
    if (param_1 == 0xfffffffc) {
      _err_print_error("_size","core/io/packed_data_container.cpp",0x89,"Parameter \"rd\" is null.",
                       0,0);
      return 0;
    }
  }
  ...
  _err_print_error("_size","core/io/packed_data_container.cpp",0x87,
                   "Condition \"p_ofs + 4 > (uint32_t)data.size()\" is true. Returning: 0",0,0);
  return 0;
}
...
/* PackedDataContainer::size() const */

void __thiscall PackedDataContainer::size(PackedDataContainer *this)
...
/* PackedDataContainer::_iter_init_ofs(Array const&, unsigned int) */

Array * PackedDataContainer::_iter_init_ofs(Array *param_1,uint param_2)
...
/* PackedDataContainer::_iter_init(Array const&) */

PackedDataContainer * __thiscall
...
/* PackedDataContainerRef::_iter_init(Array const&) */

PackedDataContainerRef * __thiscall
...
/* PackedDataContainer::_iter_next_ofs(Array const&, unsigned int) */

Array * PackedDataContainer::_iter_next_ofs(Array *param_1,uint param_2)
...
/* PackedDataContainer::_iter_next(Array const&) */
...
/* PackedDataContainerRef::_iter_next(Array const&) */
...
/* PackedDataContainerRef::size() const */

void __thiscall PackedDataContainerRef::size(PackedDataContainerRef *this)
...
/* PackedDataContainer::_iter_get_ofs(Variant const&, unsigned int) */

Variant * PackedDataContainer::_iter_get_ofs(Variant *param_1,uint param_2)
...
LAB_00100c9d:
    ...
    *(undefined1 (*) [16])(param_1 + 8) = (undefined1  [16])0x0;
    ...
    if (uVar9 == 0xfffffffe) {
      ...
      if (uVar9 != 0xffffffff) {
        _err_print_error("_iter_get_ofs","core/io/packed_data_container.cpp",0x61,
                         "Method/function failed. Returning: Variant()",0,0);
        goto LAB_00100c9d;
      }
      uVar9 = 0 << bVar4;
      lVar8 = 0;
...
/* PackedDataContainer::_iter_get(Variant const&) */
...
/* PackedDataContainerRef::_iter_get(Variant const&) */
...
/* PackedDataContainer::_key_at_ofs(unsigned int, Variant const&, bool&) const */

undefined4 * PackedDataContainer::_key_at_ofs(uint param_1,Variant *param_2,bool *param_3)
...
/* PackedDataContainer::getvar(Variant const&, bool*) const */

Variant * PackedDataContainer::getvar(Variant *param_1,bool *param_2)
...
/* PackedDataContainerRef::getvar(Variant const&, bool*) const */

Variant * PackedDataContainerRef::getvar(Variant *param_1,bool *param_2)

{
  ...
  lVar1 = *(long *)(in_FS_OFFSET + 0x28);
  PackedDataContainer::_key_at_ofs
            ((uint)param_1,*(Variant **)(param_2 + 0x180),(bool *)(ulong)*(uint *)(param_2 + 0x17c))
  ;
  if (in_RCX != (undefined1 *)0x0) {
    *in_RCX = 1;
  }
...
/* PackedDataContainerRef::_bind_methods() */

void PackedDataContainerRef::_bind_methods(void)
...
/* PackedDataContainer::_pack(Variant const&, Vector<unsigned char>&, HashMap<String, unsigned int,
   ...
   DefaultTypedAllocator<HashMapElement<String, unsigned int> > >&) */

ulong __thiscall
PackedDataContainer::_pack
          (PackedDataContainer *this,Variant *param_1,Vector *param_2,HashMap *param_3)

{
  ...
  if (uVar17 < 0x19) {
    ...
    if ((uVar19 & 0x67caaf) == 0) {
          ...
          do {
            if (uVar18 == uVar15) {
              cVar14 = String::operator==((String *)
                                          (*(long *)(*(long *)(param_3 + 8) + lVar27 * 8) + 0x10),
                                          (String *)&local_70);
              if (cVar14 != '\0') {
                puVar24 = (uint *)HashMap<String,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,unsigned_int>>>
                                  ::operator[]((HashMap<String,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,unsigned_int>>>
                                                *)param_3,(String *)&local_70);
                pauVar21 = local_70;
            ...
            iVar26 = SUB164(auVar6 * auVar10,8);
                  ...
                  (auVar7._8_8_ = 0, auVar7._0_8_ = (ulong)uVar15 * lVar25, auVar11._8_8_ = 0,
                  auVar11._0_8_ = uVar19, auVar8._8_8_ = 0,
                  auVar8._0_8_ = (ulong)((uVar17 + iVar26) - SUB164(auVar7 * auVar11,8)) * lVar25,
                  auVar12._8_8_ = 0, auVar12._0_8_ = uVar19, uVar30 <= SUB164(auVar8 * auVar12,8)));
        }
      }
      ...
      puVar23 = (undefined4 *)
                HashMap<String,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,unsigned_int>>>
                ::operator[]((HashMap<String,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,unsigned_int>>>
                              *)param_3,(String *)local_c0);
      pauVar21 = local_70;
      *puVar23 = uVar16;
      if (local_70 != (undefined1 (*) [16])0x0) {
        LOCK();
...
LAB_00101daa:
    ...
    CowData<unsigned_char>::resize<false>
              ((CowData<unsigned_char> *)(param_2 + 8),(int)local_70 + lVar25);
    if (*(long *)(param_2 + 8) == 0) {
      lVar25 = 0;
LAB_00102229:
      _err_print_index_error
                ("operator[]","./core/templates/vector.h",0x38,uVar19,lVar25,"p_index",
...
LAB_00102404:
    List<PackedDataContainer::DictKey,DefaultAllocator>::
    sort_custom<Comparator<PackedDataContainer::DictKey>>
              ((List<PackedDataContainer::DictKey,DefaultAllocator> *)&local_70);
  }
  else {
...
/* PackedDataContainer::pack(Variant const&) */

undefined8 __thiscall PackedDataContainer::pack(PackedDataContainer *this,Variant *param_1)

{
  ...
  if (1 < *(int *)param_1 - 0x1bU) {
    _err_print_error(&_LC60,"core/io/packed_data_container.cpp",0x143,
                     "Condition \"p_data.get_type() != Variant::ARRAY && p_data.get_type() != Variant::DICTIONARY\" is true. Returning: ERR_INVALID_DATA"
                     ,"PackedDataContainer can pack only Array and Dictionary type.",0,0);
    uVar5 = 0x1e;
    goto LAB_00102596;
  }
  local_70 = (void *)0x0;
...
/* PackedDataContainer::_bind_methods() */

void PackedDataContainer::_bind_methods(void)

{
  ...
  ClassDB::set_method_error_return_values
            ((StringName *)&local_98,(StringName *)&local_b0,(Vector *)&local_a8);
  if ((StringName::configured != '\0') && (local_98 != (char *)0x0)) {
    StringName::unref();
  }
  lVar3 = local_b8;
...
{
  return (uint)CONCAT71(0x10d5,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr) |
...
/* PackedDataContainer::is_class_ptr(void*) const */

uint __thiscall PackedDataContainer::is_class_ptr(PackedDataContainer *this,void *param_1)
...
/* PackedDataContainer::_getv(StringName const&, Variant&) const */

undefined8 PackedDataContainer::_getv(StringName *param_1,Variant *param_2)
...
/* PackedDataContainer::_setv(StringName const&, Variant const&) */

undefined8 PackedDataContainer::_setv(StringName *param_1,Variant *param_2)
...
/* PackedDataContainer::_validate_propertyv(PropertyInfo&) const */

void PackedDataContainer::_validate_propertyv(PropertyInfo *param_1)
...
/* PackedDataContainer::_property_can_revertv(StringName const&) const */

undefined8 PackedDataContainer::_property_can_revertv(StringName *param_1)
...
/* PackedDataContainer::_property_get_revertv(StringName const&, Variant&) const */

undefined8 PackedDataContainer::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* PackedDataContainer::_notificationv(int, bool) */

void PackedDataContainer::_notificationv(int param_1,bool param_2)
...
/* PackedDataContainerRef::is_class_ptr(void*) const */

uint __thiscall PackedDataContainerRef::is_class_ptr(PackedDataContainerRef *this,void *param_1)

{
  return (uint)CONCAT71(0x10d5,(undefined4 *)param_1 == &RefCounted::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x10d5,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x10d5,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr);
}
...
/* PackedDataContainerRef::_getv(StringName const&, Variant&) const */

undefined8 PackedDataContainerRef::_getv(StringName *param_1,Variant *param_2)
...
/* PackedDataContainerRef::_setv(StringName const&, Variant const&) */

undefined8 PackedDataContainerRef::_setv(StringName *param_1,Variant *param_2)
...
/* PackedDataContainerRef::_validate_propertyv(PropertyInfo&) const */

void PackedDataContainerRef::_validate_propertyv(PropertyInfo *param_1)
...
/* PackedDataContainerRef::_property_can_revertv(StringName const&) const */

undefined8 PackedDataContainerRef::_property_can_revertv(StringName *param_1)
...
/* PackedDataContainerRef::_property_get_revertv(StringName const&, Variant&) const */

undefined8 PackedDataContainerRef::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* PackedDataContainerRef::_notificationv(int, bool) */

void PackedDataContainerRef::_notificationv(int param_1,bool param_2)
...
/* MethodBindTR<Error, Variant const&>::_gen_argument_type(int) const */

char __thiscall
MethodBindTR<Error,Variant_const&>::_gen_argument_type
          (MethodBindTR<Error,Variant_const&> *this,int param_1)
...
/* MethodBindTR<Error, Variant const&>::get_argument_meta(int) const */

undefined8 MethodBindTR<Error,Variant_const&>::get_argument_meta(int param_1)
...
/* MethodBindTR<Variant, Array const&>::_gen_argument_type(int) const */

byte __thiscall
MethodBindTR<Variant,Array_const&>::_gen_argument_type
          (MethodBindTR<Variant,Array_const&> *this,int param_1)
...
/* MethodBindTR<Variant, Array const&>::get_argument_meta(int) const */

undefined8 MethodBindTR<Variant,Array_const&>::get_argument_meta(int param_1)
...
/* MethodBindTR<Variant, Array const&>::~MethodBindTR() */

void __thiscall
MethodBindTR<Variant,Array_const&>::~MethodBindTR(MethodBindTR<Variant,Array_const&> *this)
...
/* MethodBindTR<Error, Variant const&>::~MethodBindTR() */

void __thiscall
MethodBindTR<Error,Variant_const&>::~MethodBindTR(MethodBindTR<Error,Variant_const&> *this)
...
void __thiscall PackedDataContainerRef::~PackedDataContainerRef(PackedDataContainerRef *this)
...
/* PackedDataContainerRef::_get_class_namev() const */

undefined8 * PackedDataContainerRef::_get_class_namev(void)
...
LAB_00103ac3:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"PackedDataContainerRef");
      goto LAB_00103b2e;
    }
  }
  StringName::assign_static_unique_class_name
...
/* PackedDataContainer::_get_class_namev() const */

undefined8 * PackedDataContainer::_get_class_namev(void)
...
LAB_00103c93:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      goto LAB_00103c93;
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"PackedDataContainer");
      goto LAB_00103cfe;
    }
  }
  StringName::assign_static_unique_class_name
...
void SortArray<List<PackedDataContainer::DictKey,DefaultAllocator>::Element*,List<PackedDataContainer::DictKey,DefaultAllocator>::AuxiliaryComparator<Comparator<PackedDataContainer::DictKey>>,true>
...
void __thiscall PackedDataContainer::~PackedDataContainer(PackedDataContainer *this)
...
/* PackedDataContainer::get_class() const */

void PackedDataContainer::get_class(void)
...
/* PackedDataContainerRef::get_class() const */

void PackedDataContainerRef::get_class(void)
...
/* PackedDataContainerRef::is_class(String const&) const */

undefined8 __thiscall PackedDataContainerRef::is_class(PackedDataContainerRef *this,String *param_1)
...
/* PackedDataContainer::is_class(String const&) const */

undefined8 __thiscall PackedDataContainer::is_class(PackedDataContainer *this,String *param_1)
...
/* PackedDataContainerRef::_bind_methods() [clone .cold] */
...
/* PackedDataContainer::_bind_methods() [clone .cold] */
...
/* PackedDataContainerRef::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void __thiscall
PackedDataContainerRef::_get_property_listv(PackedDataContainerRef *this,List *param_1,bool param_2)
...
/* MethodBindTR<Variant, Array const&>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTR<Variant,Array_const&>::_gen_argument_type_info(int param_1)
...
/* PackedDataContainer::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void __thiscall
PackedDataContainer::_get_property_listv(PackedDataContainer *this,List *param_1,bool param_2)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* HashMap<String, unsigned int, HashMapHasherDefault, HashMapComparatorDefault<String>,
   DefaultTypedAllocator<HashMapElement<String, unsigned int> > >::operator[](String const&) */
...
LAB_001070f4:
    if ((float)uVar39 * __LC31 < (float)(iVar45 + 1)) goto LAB_0010711a;
  }
  local_58 = 0;
  if (*(long *)param_1 == 0) {
...
/* List<PackedDataContainer::DictKey, DefaultAllocator>::~List() */

void __thiscall
List<PackedDataContainer::DictKey,DefaultAllocator>::~List
          (List<PackedDataContainer::DictKey,DefaultAllocator> *this)
...
/* void List<PackedDataContainer::DictKey,
   DefaultAllocator>::sort_custom<Comparator<PackedDataContainer::DictKey> >() */
...

{
  ...
  SortArray<List<PackedDataContainer::DictKey,DefaultAllocator>::Element*,List<PackedDataContainer::DictKey,DefaultAllocator>::AuxiliaryComparator<Comparator<PackedDataContainer::DictKey>>,true>
...
/* MethodBind* create_method_bind<PackedDataContainer, Vector<unsigned char> const&>(void
   (PackedDataContainer::*)(Vector<unsigned char> const&)) */

MethodBind *
create_method_bind<PackedDataContainer,Vector<unsigned_char>const&>(_func_void_Vector_ptr *param_1)
...
/* MethodBind* create_method_bind<PackedDataContainer, Vector<unsigned char>>(Vector<unsigned char>
   (PackedDataContainer::*)() const) */

MethodBind * create_method_bind<PackedDataContainer,Vector<unsigned_char>>(_func_Vector *param_1)
...
/* MethodBind* create_method_bind<PackedDataContainer, Variant, Array const&>(Variant
   (PackedDataContainer::*)(Array const&)) */

MethodBind *
create_method_bind<PackedDataContainer,Variant,Array_const&>(_func_Variant_Array_ptr *param_1)
...
/* MethodBind* create_method_bind<PackedDataContainer, Variant, Variant const&>(Variant
   (PackedDataContainer::*)(Variant const&)) */

MethodBind *
create_method_bind<PackedDataContainer,Variant,Variant_const&>(_func_Variant_Variant_ptr *param_1)
...
MethodBind *
create_method_bind<PackedDataContainer,Error,Variant_const&>(_func_Error_Variant_ptr *param_1)
...
/* MethodBind* create_method_bind<PackedDataContainer, int>(int (PackedDataContainer::*)() const) */

MethodBind * create_method_bind<PackedDataContainer,int>(_func_int *param_1)
...
/* MethodBind* create_method_bind<PackedDataContainerRef, Variant, Array const&>(Variant
   (PackedDataContainerRef::*)(Array const&)) */

MethodBind *
create_method_bind<PackedDataContainerRef,Variant,Array_const&>(_func_Variant_Array_ptr *param_1)
...
/* MethodBind* create_method_bind<PackedDataContainerRef, Variant, Variant const&>(Variant
   (PackedDataContainerRef::*)(Variant const&)) */

MethodBind *
create_method_bind<PackedDataContainerRef,Variant,Variant_const&>
          (_func_Variant_Variant_ptr *param_1)
...
/* PackedDataContainerRef::_initialize_classv() */

void PackedDataContainerRef::_initialize_classv(void)

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  if (initialize_class()::initialized != '\0') goto LAB_00108a89;
...
/* PackedDataContainer::_initialize_classv() */

void PackedDataContainer::_initialize_classv(void)
...
/* WARNING: Removing unreachable block (ram,0x001092b8) */
/* WARNING: Removing unreachable block (ram,0x001093e8) */
/* WARNING: Removing unreachable block (ram,0x001095b0) */
/* WARNING: Removing unreachable block (ram,0x001093f4) */
/* WARNING: Removing unreachable block (ram,0x001093fe) */
/* WARNING: Removing unreachable block (ram,0x00109590) */
/* WARNING: Removing unreachable block (ram,0x0010940a) */
/* WARNING: Removing unreachable block (ram,0x00109414) */
/* WARNING: Removing unreachable block (ram,0x00109570) */
/* WARNING: Removing unreachable block (ram,0x00109420) */
/* WARNING: Removing unreachable block (ram,0x0010942a) */
/* WARNING: Removing unreachable block (ram,0x00109550) */
/* WARNING: Removing unreachable block (ram,0x00109436) */
/* WARNING: Removing unreachable block (ram,0x00109440) */
/* WARNING: Removing unreachable block (ram,0x00109530) */
/* WARNING: Removing unreachable block (ram,0x0010944c) */
/* WARNING: Removing unreachable block (ram,0x00109456) */
/* WARNING: Removing unreachable block (ram,0x00109510) */
...
/* WARNING: Removing unreachable block (ram,0x00109474) */
...
/* MethodBindTR<Error, Variant const&>::validated_call(Object*, Variant const**, Variant*) const */

void __thiscall
MethodBindTR<Error,Variant_const&>::validated_call
          (MethodBindTR<Error,Variant_const&> *this,Object *param_1,Variant **param_2,
          Variant *param_3)
...
/* MethodBindTR<Error, Variant const&>::ptrcall(Object*, void const**, void*) const */

void __thiscall
MethodBindTR<Error,Variant_const&>::ptrcall
          (MethodBindTR<Error,Variant_const&> *this,Object *param_1,void **param_2,void *param_3)
...
/* MethodBindTR<Variant, Array const&>::validated_call(Object*, Variant const**, Variant*) const */

void __thiscall
MethodBindTR<Variant,Array_const&>::validated_call
          (MethodBindTR<Variant,Array_const&> *this,Object *param_1,Variant **param_2,
          Variant *param_3)
...
/* MethodBindTR<Variant, Array const&>::ptrcall(Object*, void const**, void*) const */

void __thiscall
MethodBindTR<Variant,Array_const&>::ptrcall
          (MethodBindTR<Variant,Array_const&> *this,Object *param_1,void **param_2,void *param_3)
...
Object * MethodBindTR<Error,Variant_const&>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
Object * MethodBindTR<Variant,Array_const&>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
/* MethodBindTR<Error, Variant const&>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTR<Error,Variant_const&>::_gen_argument_type_info(int param_1)

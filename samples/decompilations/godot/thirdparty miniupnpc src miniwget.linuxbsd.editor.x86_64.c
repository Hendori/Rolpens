...
LAB_001009fe:
    *param_2 = -1;
    ...
    uVar22 = 0;
LAB_001000e0:
    iVar6 = receivedata(param_1,local_848,0x800,5000);
    uVar21 = uVar22;
      ...
      do {
        ...
        if (*(char *)((long)local_8b8 + (long)iVar6) == '\r') {
          if (*(char *)((long)local_8b8 + (long)iVar27) == '\n') {
            if ((iVar6 + 2 < (int)uVar18) &&
               (*(char *)((long)local_8b8 + (long)(iVar6 + 2)) == '\r')) {
              if ((iVar6 + 3 < (int)uVar18) &&
                 (*(char *)((long)local_8b8 + (long)(iVar6 + 3)) == '\n')) {
                iVar6 = iVar6 + 4;
                bVar28 = iVar6 == 0;
                local_8a8 = iVar6;
              }
...
LAB_001002c0:
                ...
                if ((iVar27 < (int)uVar13) && (iVar16 = (int)uVar12, (int)uVar13 < iVar16)) {
                  iVar7 = strncasecmp((char *)((long)local_8b8 + lVar9),"content-length",
                                      (long)(int)(uVar13 - iVar27));
                  if (iVar7 == 0) {
                    lVar9 = strtol((char *)((long)iVar16 + (long)local_8b8),(char **)0x0,10);
                    local_8b0 = (uint)lVar9;
                  }
                  else {
                    iVar27 = strncasecmp((char *)((long)local_8b8 + lVar9),"transfer-encoding",
                                         (long)(int)(uVar13 - iVar27));
                    if (iVar27 == 0) {
...
LAB_00100770:
            ...
            while( true ) {
              if (((*(byte *)((long)puVar3 + (long)(char)*pbVar11 * 2 + 1) & 0x10) == 0) ||
                 (0x1e < (uint)uVar14)) goto LAB_0010067d;
...
undefined8
miniwget3_constprop_0
          (undefined8 param_1,undefined2 param_2,undefined8 param_3,undefined4 *param_4,
          char *param_5,socklen_t param_6,undefined4 param_7,undefined8 param_8)
...
undefined8
parseURL(char *param_1,undefined1 (*param_2) [16],short *param_3,undefined8 *param_4,uint *param_5)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (((((param_1 == (char *)0x0) || (pcVar7 = strstr(param_1,"://"), pcVar7 == (char *)0x0)) ||
       (*param_1 != 'h')) || ((param_1[1] != 't' || (param_1[2] != 't')))) || (param_1[3] != 'p')) {
LAB_00100c2d:
    uVar9 = 0;
  }
  else {
    ...
    *param_2 = (undefined1  [16])0x0;
    ...
    if (pcVar7[3] == '[') {
      ...
      if (((pcVar7 != (char *)0x0) && (pcVar8 != (char *)0x0)) &&
         ((pcVar7 < pcVar8 && (param_5 != (uint *)0x0)))) {
        pcVar11 = pcVar7 + 1;
...
undefined8
miniwget_getaddr(undefined8 param_1,undefined4 *param_2,undefined1 *param_3,undefined4 param_4,
...

{
  ...
  *param_2 = 0;
  ...
  uVar2 = 0;
  if (iVar1 != 0) {
    uVar2 = miniwget3_constprop_0
                      (local_78,local_82,local_80,param_2,param_3,param_4,local_8c[0],param_6);
  }

...
/* JoltArea3D::_get_broad_phase_layer() const */

undefined1 __thiscall JoltArea3D::_get_broad_phase_layer(JoltArea3D *this)
...
/* JoltArea3D::can_interact_with(JoltBody3D const&) const */

undefined4 __thiscall JoltArea3D::can_interact_with(JoltArea3D *this,JoltBody3D *param_1)
...
/* JoltArea3D::can_interact_with(JoltSoftBody3D const&) const */

undefined8 JoltArea3D::can_interact_with(JoltSoftBody3D *param_1)
...
/* JoltArea3D::can_interact_with(JoltArea3D const&) const */

uint __thiscall JoltArea3D::can_interact_with(JoltArea3D *this,JoltArea3D *param_1)

{
  JoltArea3D JVar1;
  
  JVar1 = param_1[0x178];
  if (((JVar1 == (JoltArea3D)0x0) || ((*(uint *)(this + 0x38) & *(uint *)(param_1 + 0x34)) == 0)) &&
     (JVar1 = this[0x178], JVar1 != (JoltArea3D)0x0)) {
    return CONCAT31((int3)((*(uint *)(param_1 + 0x38) & *(uint *)(this + 0x34)) >> 8),
                    (*(uint *)(param_1 + 0x38) & *(uint *)(this + 0x34)) != 0);
  }
...
/* JoltArea3D::get_velocity_at_position(Vector3 const&) const */

undefined1  [16] JoltArea3D::get_velocity_at_position(Vector3 *param_1)
...
/* JoltArea3D::_get_object_layer() const */

undefined8 __thiscall JoltArea3D::_get_object_layer(JoltArea3D *this)

{
  ...
  if (*(long *)(this + 0x28) != 0) {
    uVar1 = JoltSpace3D::map_to_object_layer
                      (*(long *)(this + 0x28),'\x04' - (char)this[0x178],
                       *(undefined4 *)(this + 0x34),*(undefined4 *)(this + 0x38));
    return uVar1;
  }
  _err_print_error("_get_object_layer","modules/jolt_physics/objects/jolt_area_3d.cpp",0x3a,
...
/* JoltArea3D::_add_to_space() */

void __thiscall JoltArea3D::_add_to_space(JoltArea3D *this)
...
/* JoltArea3D::_enqueue_call_queries() */

void __thiscall JoltArea3D::_enqueue_call_queries(JoltArea3D *this)
...
/* JoltArea3D::_dequeue_call_queries() */

void __thiscall JoltArea3D::_dequeue_call_queries(JoltArea3D *this)
...
JoltArea3D::_remove_shape_pair
          (JoltArea3D *this,Overlap *param_1,SubShapeID *param_2,SubShapeID *param_3)

{
  ...
  uVar44 = 0;
  while (((uVar46 != uVar38 ||
          (lVar41 = *(long *)(lVar50 + lVar41 * 8), iVar6 != *(int *)(lVar41 + 0x10))) ||
         (iVar5 != *(int *)(lVar41 + 0x14)))) {
    uVar44 = uVar44 + 1;
    auVar9._8_8_ = 0;
    ...
    auVar11._8_8_ = 0;
    auVar11._0_8_ =
         (((&hash_table_size_primes)[*(uint *)(param_1 + 0x28)] + uVar45) -
         SUB164(auVar10 * auVar24,8)) * uVar39;
    auVar25._8_8_ = 0;
  ...
  if (*(int *)(param_1 + 0x2c) != 0) {
    ...
    if (uVar38 != 0) {
      ...
      do {
        uVar40 = (ulong)uVar44;
        if (((uVar45 == uVar38) &&
            (lVar42 = *(long *)(lVar50 + lVar42 * 8), *(int *)(lVar42 + 0x10) == iVar5)) &&
           (*(int *)(lVar42 + 0x14) == iVar6)) {
          auVar16._8_8_ = 0;
          ...
          uVar38 = *puVar52;
          if ((uVar38 != 0) &&
             (auVar17._8_8_ = 0, auVar17._0_8_ = uVar38 * uVar39, auVar31._8_8_ = 0,
             auVar31._0_8_ = uVar51, auVar18._8_8_ = 0,
             auVar18._0_8_ = ((uVar45 + uVar46) - SUB164(auVar17 * auVar31,8)) * uVar39,
             auVar32._8_8_ = 0, auVar32._0_8_ = uVar51, uVar37 = (ulong)uVar45, uVar47 = uVar40,
             SUB164(auVar18 * auVar32,8) != 0)) {
            while( true ) {
              uVar40 = uVar37;
              ...
              *puVar2 = uVar7;
              ...
              uVar38 = *puVar52;
              if ((uVar38 == 0) ||
                 (auVar19._8_8_ = 0, auVar19._0_8_ = uVar38 * uVar39, auVar33._8_8_ = 0,
                 auVar33._0_8_ = uVar51, auVar20._8_8_ = 0,
                 auVar20._0_8_ =
                      ((SUB164(auVar21 * auVar35,8) + uVar46) - SUB164(auVar19 * auVar33,8)) *
                      uVar39, auVar34._8_8_ = 0, auVar34._0_8_ = uVar51,
        ...
        uVar44 = SUB164(auVar13 * auVar27,8);
              ...
              (auVar14._8_8_ = 0, auVar14._0_8_ = uVar38 * uVar39, auVar28._8_8_ = 0,
              auVar28._0_8_ = uVar51, auVar15._8_8_ = 0,
              auVar15._0_8_ = ((uVar46 + uVar44) - SUB164(auVar14 * auVar28,8)) * uVar39,
              auVar29._8_8_ = 0, auVar29._0_8_ = uVar51, uVar49 <= SUB164(auVar15 * auVar29,8)));
    }
  }
LAB_00100835:
  if (*(SelfList **)(this + 0x28) != (SelfList *)0x0) {
...
/* JoltArea3D::_notify_body_entered(JPH::BodyID const&) */

void JoltArea3D::_notify_body_entered(BodyID *param_1)
...
/* JoltArea3D::_notify_body_exited(JPH::BodyID const&) */

void JoltArea3D::_notify_body_exited(BodyID *param_1)
...
/* JoltArea3D::_force_bodies_entered() */

void __thiscall JoltArea3D::_force_bodies_entered(JoltArea3D *this)
    ...
    if (*(int *)((long)puVar2 + 0x44) != 0) {
      ...
      while (puVar3 != (undefined8 *)0x0) {
        ...
        if (uVar1 != 0) {
          uVar6 = 0;
          do {
            if ((*(int *)(lVar4 + uVar6 * 8) == (int)uVar9) &&
               (*(int *)(lVar4 + 4 + uVar6 * 8) == (int)((ulong)uVar9 >> 0x20))) {
              uVar8 = (uint)uVar6;
              if (uVar8 < uVar1) {
                *(uint *)(puVar2 + 0xb) = uVar1 - 1;
                if (uVar8 < uVar1 - 1) {
                  memmove((void *)(lVar4 + uVar6 * 8),(void *)(lVar4 + (ulong)(uVar8 + 1) * 8),
                          (ulong)((uVar1 - 2) - uVar8) * 8 + 8);
                  uVar9 = puVar3[3];
                }
              }
              else {
                _err_print_index_error
                          ("remove_at","./core/templates/local_vector.h",0x4c,uVar6,(ulong)uVar1,
...
/* JoltArea3D::_force_bodies_exited(bool) */

void __thiscall JoltArea3D::_force_bodies_exited(JoltArea3D *this,bool param_1)
    ...
    if (*(int *)((long)puVar2 + 0x44) != 0) {
      ...
      while (puVar3 != (undefined8 *)0x0) {
        ...
        if (uVar1 != 0) {
          uVar5 = 0;
          do {
            if ((*(int *)(lVar8 + uVar5 * 8) == (int)uVar9) &&
               (*(int *)(lVar8 + 4 + uVar5 * 8) == (int)((ulong)uVar9 >> 0x20))) {
              uVar7 = (uint)uVar5;
              if (uVar7 < uVar1) {
                *(uint *)(puVar2 + 9) = uVar1 - 1;
                if (uVar7 < uVar1 - 1) {
                  memmove((void *)(lVar8 + uVar5 * 8),(void *)(lVar8 + (ulong)(uVar7 + 1) * 8),
                          (ulong)((uVar1 - 2) - uVar7) * 8 + 8);
                  uVar9 = puVar3[3];
                }
              }
              else {
                _err_print_index_error
                          ("remove_at","./core/templates/local_vector.h",0x4c,uVar5,(ulong)uVar1,
                           "p_index","count","",false,false);
                uVar9 = puVar3[3];
              }
              break;
...
/* JoltArea3D::_force_areas_entered() */

void __thiscall JoltArea3D::_force_areas_entered(JoltArea3D *this)
...
/* JoltArea3D::_force_areas_exited(bool) */

void __thiscall JoltArea3D::_force_areas_exited(JoltArea3D *this,bool param_1)
...
/* JoltArea3D::_update_group_filter() */

void __thiscall JoltArea3D::_update_group_filter(JoltArea3D *this)

{
  ...
  if ((*(long *)(this + 0x28) != 0) && (*(int *)(this + 0x30) != -1)) {
    ...
    if (local_28 == 0) {
      _err_print_error("_update_group_filter","modules/jolt_physics/objects/jolt_area_3d.cpp",0x127,
...
/* JoltArea3D::_space_changed() */

void __thiscall JoltArea3D::_space_changed(JoltArea3D *this)
...
/* JoltArea3D::_update_default_gravity() */

void __thiscall JoltArea3D::_update_default_gravity(JoltArea3D *this)
...
/* JoltArea3D::_events_changed() */

void __thiscall JoltArea3D::_events_changed(JoltArea3D *this)
...
/* JoltArea3D::_body_monitoring_changed() */

void __thiscall JoltArea3D::_body_monitoring_changed(JoltArea3D *this)
...
/* JoltArea3D::_area_monitoring_changed() */

void __thiscall JoltArea3D::_area_monitoring_changed(JoltArea3D *this)
...
/* JoltArea3D::_monitorable_changed() */

void JoltArea3D::_monitorable_changed(void)
...
/* JoltArea3D::_gravity_changed() */

void __thiscall JoltArea3D::_gravity_changed(JoltArea3D *this)
...
void __thiscall JoltArea3D::JoltArea3D(JoltArea3D *this)
...
/* JoltArea3D::is_default_area() const */

bool __thiscall JoltArea3D::is_default_area(JoltArea3D *this)
...
/* JoltArea3D::set_default_area(bool) */

void __thiscall JoltArea3D::set_default_area(JoltArea3D *this,bool param_1)
...
/* JoltArea3D::set_body_monitor_callback(Callable const&) */

void __thiscall JoltArea3D::set_body_monitor_callback(JoltArea3D *this,Callable *param_1)
...
/* JoltArea3D::set_area_monitor_callback(Callable const&) */

void __thiscall JoltArea3D::set_area_monitor_callback(JoltArea3D *this,Callable *param_1)
...
/* JoltArea3D::set_monitorable(bool) */

void __thiscall JoltArea3D::set_monitorable(JoltArea3D *this,bool param_1)
...
/* JoltArea3D::can_monitor(JoltArea3D const&) const */

uint __thiscall JoltArea3D::can_monitor(JoltArea3D *this,JoltArea3D *param_1)

{
  ...
  if (param_1[0x178] != (JoltArea3D)0x0) {
    uVar1 = CONCAT31((int3)((*(uint *)(this + 0x38) & *(uint *)(param_1 + 0x34)) >> 8),
                     (*(uint *)(this + 0x38) & *(uint *)(param_1 + 0x34)) != 0);
  }
  return uVar1;
}
...
/* JoltArea3D::set_point_gravity(bool) */

void __thiscall JoltArea3D::set_point_gravity(JoltArea3D *this,bool param_1)
...
/* JoltArea3D::set_gravity(float) */

void __thiscall JoltArea3D::set_gravity(JoltArea3D *this,float param_1)
...
/* JoltArea3D::set_point_gravity_distance(float) */

void __thiscall JoltArea3D::set_point_gravity_distance(JoltArea3D *this,float param_1)
...
/* JoltArea3D::set_gravity_mode(PhysicsServer3D::AreaSpaceOverrideMode) */

void __thiscall JoltArea3D::set_gravity_mode(JoltArea3D *this,int param_2)
...
/* JoltArea3D::set_gravity_vector(Vector3 const&) */

void __thiscall JoltArea3D::set_gravity_vector(JoltArea3D *this,Vector3 *param_1)

{
  ...
  if (((*(float *)(this + 0x128) != *(float *)param_1) ||
      (*(float *)(this + 300) != *(float *)(param_1 + 4))) ||
     (*(float *)(this + 0x130) != *(float *)(param_1 + 8))) {
...
/* JoltArea3D::compute_gravity(Vector3 const&) const */

void __thiscall JoltArea3D::compute_gravity(JoltArea3D *this,Vector3 *param_1)

{
  ...
  if (this[0x179] != (JoltArea3D)0x0) {
    ...
    fVar4 = (local_40 * fVar5 + local_3c * fVar6 + local_38 * fVar7 + local_2c) -
            *(float *)(param_1 + 8);
    auVar3._0_4_ = ((float)local_58 * fVar5 + fVar6 * fStack_54 + local_50 * fVar7 + (float)local_34
                   ) - (float)*(undefined8 *)param_1;
    auVar3._4_4_ = (fStack_4c * fVar5 + fVar6 * local_48 + fStack_44 * fVar7 +
                   (float)((ulong)local_34 >> 0x20)) -
...
ulong __thiscall
JoltArea3D::body_shape_exited
          (JoltArea3D *this,BodyID *param_1,SubShapeID *param_2,SubShapeID *param_3)
  ...
  if ((lVar2 != 0) && (*(int *)(this + 0xf4) != 0)) {
    ...
    if (uVar11 != 0) {
      ...
      while ((uVar16 != uVar11 || (uVar1 != *(uint *)(*(long *)(lVar2 + lVar15 * 8) + 0x10)))) {
        ...
        auVar9._0_8_ = uVar17;
        auVar6._8_8_ = 0;
        auVar6._0_8_ = (((&hash_table_size_primes)[*(uint *)(this + 0xf0)] + uVar13) -
                       SUB164(auVar5 * auVar9,8)) * uVar12;
        auVar10._8_8_ = 0;
    ...
    if (uVar12 != 0) {
      ...
      do {
        if ((uVar17 == uVar12) && (uVar1 == *(uint *)(*(long *)(lVar2 + lVar16 * 8) + 0x10))) {
          uVar13 = _remove_shape_pair(this,(Overlap *)(*(long *)(lVar2 + (ulong)uVar14 * 8) + 0x18),
                                      param_2,param_3);
          return uVar13;
        }
        uVar19 = uVar19 + 1;
        ...
        uVar14 = SUB164(auVar5 * auVar9,8);
              ...
              auVar7._0_8_ = (((&hash_table_size_primes)[*(uint *)(this + 0x120)] + uVar14) -
...
/* JoltArea3D::shape_exited(JPH::BodyID const&, JPH::SubShapeID const&, JPH::SubShapeID const&) */

void __thiscall
JoltArea3D::shape_exited(JoltArea3D *this,BodyID *param_1,SubShapeID *param_2,SubShapeID *param_3)
...
/* JoltArea3D::body_exited(JPH::BodyID const&, bool) */

void __thiscall JoltArea3D::body_exited(JoltArea3D *this,BodyID *param_1,bool param_2)
  ...
  if ((lVar2 != 0) && (*(int *)(this + 0xf4) != 0)) {
    ...
    if (uVar13 != 0) {
      ...
      while ((uVar20 != uVar13 || (uVar1 != *(uint *)(*(long *)(lVar2 + lVar18 * 8) + 0x10)))) {
        ...
        auVar7._8_8_ = 0;
        auVar7._0_8_ = (((&hash_table_size_primes)[*(uint *)(this + 0xf0)] + uVar16) -
                       SUB164(auVar6 * auVar10,8)) * uVar19;
        auVar11._8_8_ = 0;
      ...
      if (*(int *)(lVar2 + 0x44) != 0) {
        ...
        while (puVar3 != (undefined8 *)0x0) {
          ...
          if (uVar1 != 0) {
            uVar19 = 0;
            do {
              if ((*(int *)(lVar18 + uVar19 * 8) == (int)uVar23) &&
                 ((int)((ulong)uVar23 >> 0x20) == *(int *)(lVar18 + 4 + uVar19 * 8))) {
                uVar13 = (uint)uVar19;
                if (uVar13 < uVar1) {
                  *(uint *)(lVar2 + 0x48) = uVar1 - 1;
                  if (uVar13 < uVar1 - 1) {
                    memmove((void *)(lVar18 + uVar19 * 8),(void *)(lVar18 + (ulong)(uVar13 + 1) * 8)
                            ,(ulong)((uVar1 - 2) - uVar13) * 8 + 8);
                    uVar23 = puVar3[3];
                  }
                }
                else {
                  _err_print_index_error
                            ("remove_at","./core/templates/local_vector.h",0x4c,uVar19,(ulong)uVar1,
                             "p_index","count","",false,false);
                  uVar23 = puVar3[3];
                }
                break;
...
/* JoltArea3D::area_exited(JPH::BodyID const&) */

void __thiscall JoltArea3D::area_exited(JoltArea3D *this,BodyID *param_1)
  ...
  if ((lVar2 != 0) && (*(int *)(this + 0x124) != 0)) {
    ...
    if (uVar13 != 0) {
      ...
      while ((uVar13 != uVar20 || (uVar1 != *(uint *)(*(long *)(lVar2 + lVar18 * 8) + 0x10)))) {
        ...
        auVar10._0_8_ = uVar22;
        auVar7._8_8_ = 0;
        auVar7._0_8_ = (((&hash_table_size_primes)[*(uint *)(this + 0x120)] + uVar16) -
                       SUB164(auVar6 * auVar10,8)) * uVar19;
        auVar11._8_8_ = 0;
        auVar11._0_8_ = uVar22;
        if (SUB164(auVar7 * auVar11,8) < uVar21) {
      ...
      if (*(int *)(lVar2 + 0x44) != 0) {
        ...
        while (puVar3 != (undefined8 *)0x0) {
          ...
          if (uVar1 != 0) {
            ...
            do {
              if ((*(int *)(lVar18 + uVar19 * 8) == (int)uVar23) &&
                 (*(int *)(lVar18 + 4 + uVar19 * 8) == (int)((ulong)uVar23 >> 0x20))) {
                uVar13 = (uint)uVar19;
                if (uVar13 < uVar1) {
                  *(uint *)(lVar2 + 0x48) = uVar1 - 1;
                  if (uVar13 < uVar1 - 1) {
...
void __thiscall
JoltArea3D::_report_event
          (undefined8 param_1_00,Variant **param_1,int param_3,RID *param_4,undefined8 param_5,
...

{
  ...
  if (cVar4 == '\0') {
    _err_print_error("_report_event","modules/jolt_physics/objects/jolt_area_3d.cpp",0xab,
                     "Condition \"!p_callback.is_valid()\" is true.",0,0);
  }
  else {
    ...
    if ((local_148 != 0) &&
      ...
      Variant::get_callable_error_text
                ((Callable *)&local_158,param_1,(int)&local_68,(CallError *)0x5);
      JoltObject3D::to_string();
      local_138 = 
      "Failed to call area monitor callback for \'%s\'. It returned the following error: \'%s\'.";
      local_150 = 0;
      local_130 = 0x55;
      String::parse_latin1((StrRange *)&local_150);
      vformat<String,String>(&local_138,(StrRange *)&local_150,&local_160,(Callable *)&local_158);
      _err_print_error("_report_event","modules/jolt_physics/objects/jolt_area_3d.cpp",0xb9,
                       &local_138,0,0);
      pcVar3 = local_138;
...
/* JoltArea3D::_flush_events(HashMap<JPH::BodyID, JoltArea3D::Overlap, JoltArea3D::BodyIDHasher,
   ...
   JoltArea3D::Overlap> > >&, Callable const&) */

void __thiscall JoltArea3D::_flush_events(JoltArea3D *this,HashMap *param_1,Callable *param_2)
...
joined_r0x00102a06:
  do {
    do {
      ...
      } while (((*(int *)((long)puVar2 + 0x44) != 0) ||
               (lVar44 = *(long *)(param_1 + 8), lVar44 == 0)) || (*(int *)(param_1 + 0x2c) == 0));
    ...
    while( true ) {
      ...
      uVar42 = uVar42 + 1;
      if ((uVar33 == 0) ||
         (auVar14._8_8_ = 0, auVar14._0_8_ = uVar33 * uVar10, auVar23._8_8_ = 0,
         auVar23._0_8_ = uVar41, auVar15._8_8_ = 0,
         auVar15._0_8_ = ((uVar7 + uVar34) - SUB164(auVar14 * auVar23,8)) * uVar10,
         auVar24._8_8_ = 0, auVar24._0_8_ = uVar41, uVar35 = uVar36,
         SUB164(auVar15 * auVar24,8) < uVar42)) goto joined_r0x00102a06;
    }
    puVar46 = (uint *)(lVar11 + uVar36 * 4);
    uVar32 = *puVar46;
    if ((uVar32 != 0) &&
       (auVar17._8_8_ = 0, auVar17._0_8_ = uVar32 * uVar10, auVar26._8_8_ = 0,
       auVar26._0_8_ = uVar41, auVar18._8_8_ = 0,
       auVar18._0_8_ = ((uVar34 + uVar7) - SUB164(auVar17 * auVar26,8)) * uVar10, auVar27._8_8_ = 0,
       auVar27._0_8_ = uVar41, uVar35 = (ulong)uVar34, uVar39 = uVar38,
       SUB164(auVar18 * auVar27,8) != 0)) {
      while( true ) {
        uVar38 = uVar35;
        ...
        *puVar3 = uVar12;
        ...
        uVar32 = *puVar46;
        if ((uVar32 == 0) ||
           (auVar19._8_8_ = 0, auVar19._0_8_ = uVar32 * uVar10, auVar28._8_8_ = 0,
           auVar28._0_8_ = uVar41, auVar20._8_8_ = 0,
           auVar20._0_8_ =
                ((SUB164(auVar21 * auVar30,8) + uVar7) - SUB164(auVar19 * auVar28,8)) * uVar10,
           auVar29._8_8_ = 0, auVar29._0_8_ = uVar41, SUB164(auVar20 * auVar29,8) == 0)) break;
...
void __thiscall JoltArea3D::call_queries(JoltArea3D *this)
...
/* JoltArea3D::set_transform(Transform3D) */

void JoltArea3D::set_transform(long param_1)

{
  ...
  if ((((float)uStack0000000000000018 * fStack0000000000000028 -
    ...
    _err_print_error("set_transform","modules/jolt_physics/objects/jolt_area_3d.cpp",0x174,&local_78
                     ,0,1);
    pcVar4 = local_78;
    ...
    *puVar2 = CONCAT44(uStack0000000000000030,uStack000000000000002c);
    ...
    JPH::BodyInterface::SetPositionAndRotation
              (CONCAT44(uStack0000000000000030,uStack000000000000002c),
               CONCAT44(uStack0000000000000034,uStack0000000000000034),local_58,uStack_50,uVar6,
               param_1 + 0x30,1);
  }
...
/* JoltArea3D::get_param(PhysicsServer3D::AreaParameter) const */

Variant * JoltArea3D::get_param(Variant *param_1,long param_2,undefined4 param_3)
...
/* JoltArea3D::set_param(PhysicsServer3D::AreaParameter, Variant const&) */

void __thiscall JoltArea3D::set_param(JoltArea3D *this,undefined4 param_2,Variant *param_3)
...
void __thiscall
JoltArea3D::_add_shape_pair
          (JoltArea3D *this,Overlap *param_1,BodyID *param_2,SubShapeID *param_3,SubShapeID *param_4
          )

{
  ...
  if (((local_48 == 0) || (pSVar2 = *(SubShapeID **)(local_48 + 0x50), pSVar2 == (SubShapeID *)0x0))
     || (pSVar2[0x3c] == (SubShapeID)0x2)) {
    _err_print_error("_add_shape_pair","modules/jolt_physics/objects/jolt_area_3d.cpp",0x70,
                     "Parameter \"other_object\" is null.",0,0);
  }
  else {
    ...
    *(undefined8 *)(param_1 + 0x58) = uVar5;
    ...
    puVar8 = (undefined4 *)
             HashMap<JoltArea3D::ShapeIDPair,JoltArea3D::ShapeIndexPair,JoltArea3D::ShapeIDPair,HashMapComparatorDefault<JoltArea3D::ShapeIDPair>,DefaultTypedAllocator<HashMapElement<JoltArea3D::ShapeIDPair,JoltArea3D::ShapeIndexPair>>>
             ::operator[]((HashMap<JoltArea3D::ShapeIDPair,JoltArea3D::ShapeIndexPair,JoltArea3D::ShapeIDPair,HashMapComparatorDefault<JoltArea3D::ShapeIDPair>,DefaultTypedAllocator<HashMapElement<JoltArea3D::ShapeIDPair,JoltArea3D::ShapeIndexPair>>>
                           *)param_1,(ShapeIDPair *)&local_90);
...

{
  ...
  pOVar1 = (Overlap *)
           ...
           ::operator[]((HashMap<JPH::BodyID,JoltArea3D::Overlap,JoltArea3D::BodyIDHasher,HashMapComparatorDefault<JPH::BodyID>,DefaultTypedAllocator<HashMapElement<JPH::BodyID,JoltArea3D::Overlap>>>
                         *)(this + 200),param_1);
...
void __thiscall JoltArea3D::_space_changing(JoltArea3D *this)
...
/* JoltArea3D::_get_motion_type() const */

undefined8 JoltArea3D::_get_motion_type(void)
...
/* JoltArea3D::reports_contacts() const */

undefined8 JoltArea3D::reports_contacts(void)
...
/* JoltArea3D::has_custom_center_of_mass() const */

undefined8 JoltArea3D::has_custom_center_of_mass(void)
...
/* JoltArea3D::get_center_of_mass_custom() const */

undefined1  [16] JoltArea3D::get_center_of_mass_custom(void)
...
/* WARNING: Removing unreachable block (ram,0x00104c40) */
/* WARNING: Removing unreachable block (ram,0x00104d70) */
/* WARNING: Removing unreachable block (ram,0x00104ee9) */
/* WARNING: Removing unreachable block (ram,0x00104d7c) */
/* WARNING: Removing unreachable block (ram,0x00104d86) */
/* WARNING: Removing unreachable block (ram,0x00104ecb) */
/* WARNING: Removing unreachable block (ram,0x00104d92) */
/* WARNING: Removing unreachable block (ram,0x00104d9c) */
/* WARNING: Removing unreachable block (ram,0x00104ead) */
/* WARNING: Removing unreachable block (ram,0x00104da8) */
/* WARNING: Removing unreachable block (ram,0x00104db2) */
/* WARNING: Removing unreachable block (ram,0x00104e8f) */
/* WARNING: Removing unreachable block (ram,0x00104dbe) */
/* WARNING: Removing unreachable block (ram,0x00104dc8) */
/* WARNING: Removing unreachable block (ram,0x00104e71) */
/* WARNING: Removing unreachable block (ram,0x00104dd4) */
/* WARNING: Removing unreachable block (ram,0x00104dde) */
/* WARNING: Removing unreachable block (ram,0x00104e53) */
/* WARNING: Removing unreachable block (ram,0x00104de6) */
/* WARNING: Removing unreachable block (ram,0x00104df0) */
/* WARNING: Removing unreachable block (ram,0x00104e38) */
/* WARNING: Removing unreachable block (ram,0x00104df8) */
/* WARNING: Removing unreachable block (ram,0x00104e0e) */
/* WARNING: Removing unreachable block (ram,0x00104e1a) */
...
/* WARNING: Removing unreachable block (ram,0x00105028) */
/* WARNING: Removing unreachable block (ram,0x00105158) */
/* WARNING: Removing unreachable block (ram,0x00105320) */
/* WARNING: Removing unreachable block (ram,0x00105164) */
/* WARNING: Removing unreachable block (ram,0x0010516e) */
/* WARNING: Removing unreachable block (ram,0x00105300) */
/* WARNING: Removing unreachable block (ram,0x0010517a) */
/* WARNING: Removing unreachable block (ram,0x00105184) */
/* WARNING: Removing unreachable block (ram,0x001052e0) */
/* WARNING: Removing unreachable block (ram,0x00105190) */
/* WARNING: Removing unreachable block (ram,0x0010519a) */
/* WARNING: Removing unreachable block (ram,0x001052c0) */
/* WARNING: Removing unreachable block (ram,0x001051a6) */
...
/* WARNING: Removing unreachable block (ram,0x00105280) */
/* WARNING: Removing unreachable block (ram,0x001051d2) */
/* WARNING: Removing unreachable block (ram,0x001051dc) */
/* WARNING: Removing unreachable block (ram,0x00105260) */
/* WARNING: Removing unreachable block (ram,0x001051e4) */
/* WARNING: Removing unreachable block (ram,0x001051fa) */
...
/* WARNING: Removing unreachable block (ram,0x00105468) */
/* WARNING: Removing unreachable block (ram,0x00105598) */
/* WARNING: Removing unreachable block (ram,0x00105760) */
/* WARNING: Removing unreachable block (ram,0x001055a4) */
/* WARNING: Removing unreachable block (ram,0x001055ae) */
/* WARNING: Removing unreachable block (ram,0x00105740) */
/* WARNING: Removing unreachable block (ram,0x001055ba) */
/* WARNING: Removing unreachable block (ram,0x001055c4) */
/* WARNING: Removing unreachable block (ram,0x00105720) */
...
/* WARNING: Removing unreachable block (ram,0x001055f0) */
/* WARNING: Removing unreachable block (ram,0x001056e0) */
/* WARNING: Removing unreachable block (ram,0x001055fc) */
/* WARNING: Removing unreachable block (ram,0x00105606) */
/* WARNING: Removing unreachable block (ram,0x001056c0) */
/* WARNING: Removing unreachable block (ram,0x00105612) */
/* WARNING: Removing unreachable block (ram,0x0010561c) */
/* WARNING: Removing unreachable block (ram,0x001056a0) */
/* WARNING: Removing unreachable block (ram,0x00105624) */
/* WARNING: Removing unreachable block (ram,0x0010563a) */
/* WARNING: Removing unreachable block (ram,0x00105646) */
/* String vformat<PhysicsServer3D::AreaParameter>(String const&, PhysicsServer3D::AreaParameter
   const) */

undefined8 * vformat<PhysicsServer3D::AreaParameter>(undefined8 *param_1,bool *param_2,int param_3)
...
/* HashMap<JoltArea3D::ShapeIDPair, JoltArea3D::ShapeIndexPair, JoltArea3D::ShapeIDPair,
   HashMapComparatorDefault<JoltArea3D::ShapeIDPair>,
   DefaultTypedAllocator<HashMapElement<JoltArea3D::ShapeIDPair, JoltArea3D::ShapeIndexPair> >
   >::operator[](JoltArea3D::ShapeIDPair const&) */
...

{
  ...
  __s_00 = *(void **)(this + 8);
  uVar31 = (&hash_table_size_primes)[uVar39];
...
LAB_0010637c:
      if (local_60 == 0) goto LAB_001062d8;
      uVar39 = (ulong)*(uint *)(this + 0x28);
...
LAB_001062d8:
      ...
      if (uVar30 != 0) {
        ...
        do {
          if (((uVar43 == uVar30) &&
              (lVar36 = *(long *)((long)__s_00 + lVar36 * 8), *(int *)(lVar36 + 0x10) == iVar34)) &&
             (*(int *)(lVar36 + 0x14) == iVar2)) {
          ...
          uVar44 = SUB164(auVar6 * auVar18,8);
                ...
                auVar8._0_8_ = ((uVar44 + uVar31) - SUB164(auVar7 * auVar19,8)) * uVar3,
                auVar20._8_8_ = 0, auVar20._0_8_ = uVar41, lVar37 = SUB168(auVar8 * auVar20,8),
...
LAB_00105fc2:
      ...
      if (uVar31 != 0) {
        ...
        do {
          ...
          uVar43 = SUB164(auVar10 * auVar22,8);
                ...
                auVar12._0_8_ =
                     (((&hash_table_size_primes)[uVar39] + uVar43) - SUB164(auVar11 * auVar23,8)) *
                     uVar3, auVar24._8_8_ = 0, auVar24._0_8_ = uVar35,
                lVar37 = SUB168(auVar12 * auVar24,8), uVar44 <= SUB164(auVar12 * auVar24,8)));
      }
    }
  }
  ...
  *(undefined1 (**) [16])(this + 0x20) = pauVar32;
  uVar31 = (*(int *)param_1 * 0x16a88000 | (uint)(*(int *)param_1 * -0x3361d2af) >> 0x11) *
  ...
  auVar13._8_8_ = 0;
  auVar13._0_8_ = uVar39 * lVar36;
  auVar25._8_8_ = 0;
  auVar25._0_8_ = uVar41;
  lStack_90 = SUB168(auVar13 * auVar25,8);
  lVar37 = *(long *)(this + 8);
  ...
  *(undefined1 (**) [16])(lVar37 + lStack_90 * 8) = pauVar29;
  *puVar1 = uVar31;
  *(int *)(this + 0x2c) = *(int *)(this + 0x2c) + 1;
LAB_001060c7:
...
/* HashMap<JoltArea3D::ShapeIDPair, JoltArea3D::ShapeIndexPair, JoltArea3D::ShapeIDPair,
   HashMapComparatorDefault<JoltArea3D::ShapeIDPair>,
   DefaultTypedAllocator<HashMapElement<JoltArea3D::ShapeIDPair, JoltArea3D::ShapeIndexPair> >
   >::insert(JoltArea3D::ShapeIDPair const&, JoltArea3D::ShapeIndexPair const&, bool) */

void HashMap<JoltArea3D::ShapeIDPair,JoltArea3D::ShapeIndexPair,JoltArea3D::ShapeIDPair,HashMapComparatorDefault<JoltArea3D::ShapeIDPair>,DefaultTypedAllocator<HashMapElement<JoltArea3D::ShapeIDPair,JoltArea3D::ShapeIndexPair>>>
     ::insert(ShapeIDPair *param_1,ShapeIndexPair *param_2,bool param_3)
...
LAB_00106489:
    if (iVar29 != 0) {
      ...
      if (uVar25 != 0) {
        ...
        do {
          if (((uVar38 == uVar25) &&
              (lVar32 = *(long *)((long)__s_00 + lVar32 * 8), *(int *)(lVar32 + 0x10) == iVar2)) &&
             (*(int *)(lVar32 + 0x14) == iVar3)) {
          ...
          uVar35 = SUB164(auVar9 * auVar17,8);
                ...
                (auVar10._8_8_ = 0, auVar10._0_8_ = uVar25 * uVar34, auVar18._8_8_ = 0,
                auVar18._0_8_ = uVar36, auVar11._8_8_ = 0,
                auVar11._0_8_ =
                     (((&hash_table_size_primes)[*(uint *)(param_2 + 0x28)] + uVar35) -
                     SUB164(auVar10 * auVar18,8)) * uVar34, auVar19._8_8_ = 0,
                auVar19._0_8_ = uVar36, uVar37 <= SUB164(auVar11 * auVar19,8)));
      }
    }
  }
  if ((float)uVar26 * __LC50 < (float)(iVar29 + 1)) {
    ...
    _resize_and_rehash((HashMap<JoltArea3D::ShapeIDPair,JoltArea3D::ShapeIndexPair,JoltArea3D::ShapeIDPair,HashMapComparatorDefault<JoltArea3D::ShapeIDPair>,DefaultTypedAllocator<HashMapElement<JoltArea3D::ShapeIDPair,JoltArea3D::ShapeIndexPair>>>
  ...
  *(undefined8 *)(pauVar27[1] + 8) = uVar4;
  ...
  uVar26 = (uVar26 << 0xd | uVar26 >> 0x13) * 5 + 0xe6546b64 ^
           (piVar30[1] * 0x16a88000 | (uint)(piVar30[1] * -0x3361d2af) >> 0x11) * 0x1b873593;
  uVar26 = (uVar26 << 0xd | uVar26 >> 0x13) * 5 + 0xe6546b64;
...
LAB_001067b0:
  *(undefined1 (**) [16])param_1 = pauVar27;
  return;
}
...
/* HashMap<JPH::BodyID, JoltArea3D::Overlap, JoltArea3D::BodyIDHasher,
   HashMapComparatorDefault<JPH::BodyID>, DefaultTypedAllocator<HashMapElement<JPH::BodyID,
   JoltArea3D::Overlap> > >::operator[](JPH::BodyID const&) */
...

{
  ...
  uVar40 = *(uint *)param_1;
  uVar53 = (ulong)uVar40;
  uVar58 = (&hash_table_size_primes)[uVar41];
  uVar52 = CONCAT44(0,uVar58);
  if (local_f0 == (void *)0x0) {
    ...
    *(void **)(this + 8) = local_f0;
    if (uVar58 == 0) {
      ...
      if ((pvVar5 < (void *)((long)local_f0 + uVar53)) &&
    ...
    if (iVar47 != 0) {
      ...
      if (uVar39 != 0) {
        ...
        do {
          if ((uVar57 == uVar39) &&
             (uVar40 == *(uint *)(*(long *)((long)local_f0 + lVar49 * 8) + 0x10))) {
          ...
          uVar55 = SUB164(auVar7 * auVar23,8);
                ...
                (auVar8._8_8_ = 0, auVar8._0_8_ = uVar39 * uVar4, auVar24._8_8_ = 0,
                auVar24._0_8_ = uVar52, auVar9._8_8_ = 0,
                auVar9._0_8_ = ((uVar55 + uVar58) - SUB164(auVar8 * auVar24,8)) * uVar4,
                auVar25._8_8_ = 0, auVar25._0_8_ = uVar52, uVar56 <= SUB164(auVar9 * auVar25,8)));
      }
LAB_00106efb:
      uVar48 = CONCAT44(0,(&hash_table_size_primes)[uVar41]);
      uVar4 = *(ulong *)(hash_table_size_primes_inv + uVar41 * 8);
      ...
      if (uVar40 != 0) {
        ...
        do {
          ...
          uVar39 = SUB164(auVar19 * auVar35,8);
                ...
                (auVar20._8_8_ = 0, auVar20._0_8_ = uVar40 * uVar4, auVar36._8_8_ = 0,
                auVar36._0_8_ = uVar48, auVar21._8_8_ = 0,
                auVar21._0_8_ =
                     (((&hash_table_size_primes)[uVar41] + uVar39) - SUB164(auVar20 * auVar36,8)) *
                     uVar4, auVar37._8_8_ = 0, auVar37._0_8_ = uVar48,
                uVar57 <= SUB164(auVar21 * auVar37,8)));
      }
    }
  }
LAB_00106a93:
  if ((float)uVar52 * __LC50 < (float)(iVar47 + 1)) {
...
LAB_00106cfc:
  pauVar43 = (undefined1 (*) [16])operator_new(0x78,"");
  *pauVar43 = (undefined1  [16])0x0;
  *(undefined8 *)pauVar43[4] = 0;
  *(undefined4 *)pauVar43[1] = uVar3;
  uVar40 = (&hash_table_size_primes)[uVar41];
  pauVar43[2] = (undefined1  [16])0x0;
  lVar44 = 1;
  pauVar43[3] = (undefined1  [16])0x0;
  if (5 < uVar40) {
    do {
...
LAB_00106d8f:
  ...
  *(undefined8 *)(pauVar43[4] + 8) = 0;
  *(undefined8 *)pauVar43[5] = 0;
  *(undefined8 *)(pauVar43[5] + 8) = 0;
  *(undefined8 *)pauVar43[6] = 0;
  *(undefined1 (*) [16])(pauVar43[6] + 8) = (undefined1  [16])0x0;
  if (puVar2 == (undefined8 *)0x0) {
  ...
  *(undefined1 (**) [16])(this + 0x20) = pauVar43;
  uVar40 = (*(uint *)param_1 >> 0x10 ^ *(uint *)param_1) * -0x7a143595;
  uVar58 = (uVar40 ^ uVar40 >> 0xd) * -0x3d4d51cb;
  uVar40 = uVar58 ^ uVar58 >> 0x10;
  if (uVar58 == uVar58 >> 0x10) {
    uVar41 = 1;
    uVar40 = 1;
  }
  else {
  ...
  lVar44 = *(long *)(this + 0x10);
  lVar49 = *(long *)(hash_table_size_primes_inv + (ulong)*(uint *)(this + 0x28) * 8);
  uVar58 = (&hash_table_size_primes)[*(uint *)(this + 0x28)];
  uVar53 = CONCAT44(0,uVar58);
  auVar14._8_8_ = 0;
  auVar14._0_8_ = uVar41 * lVar49;
  auVar30._8_8_ = 0;
...
LAB_0010704a:
  ...
  lVar49 = *(long *)(this + 8);
  *(undefined1 (*) [16])(lVar44 + 0x68) = (undefined1  [16])0x0;
  pauVar43 = *(undefined1 (**) [16])(lVar49 + (ulong)uVar39 * 8);
  goto LAB_00106ee3;
}
...
void JoltArea3D::_GLOBAL__sub_I__get_broad_phase_layer(void)

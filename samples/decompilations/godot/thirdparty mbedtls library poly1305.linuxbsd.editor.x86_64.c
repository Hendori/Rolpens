...

{
  ...
  do {
    ...
    uVar11 = (uVar12 >> 0x20) + uVar4 * uVar6 + uVar9 * uVar13 + uVar19 * uVar16 + uVar10 * uVar15 +
             uVar18 * uVar14;
    uVar5 = (uVar11 >> 0x20) +
            uVar4 * uVar13 + uVar9 * uVar15 + uVar1 * uVar19 + uVar10 * uVar16 + uVar18 * uVar6;
    uVar19 = (uVar5 >> 0x20) +
             uVar4 * uVar15 + uVar9 * uVar16 + uVar1 * uVar10 + uVar2 * uVar19 + uVar18 * uVar13;
...
LAB_00100392:
  *(ulong *)(param_1 + 0x48) = param_3;
  ...
  if (uVar1 < 8) {
    if ((param_3 & 4) == 0) {
      if ((uVar1 != 0) &&
         (*(undefined1 *)(param_1 + 0x34) = *(undefined1 *)param_2, (param_3 & 2) != 0)) {
    ...
    *(undefined8 *)(param_1 + 0x2c + (param_3 & 0xffffffff)) =
...

{
  ...
  uVar5 = (ulong)((uint)uVar5 & uVar6 | *(uint *)(param_1 + 0x24) & uVar7) +
          (ulong)*(uint *)(param_1 + 0x14) +
          ((ulong)uVar8 + (ulong)*(uint *)(param_1 + 0x10) >> 0x20);
  lVar4 = (ulong)((uint)uVar3 & uVar6 | *(uint *)(param_1 + 0x28) & uVar7) +
          (ulong)*(uint *)(param_1 + 0x18) + (uVar5 >> 0x20);
  iVar2 = *(int *)(param_1 + 0x1c);
  *param_2 = CONCAT44((int)uVar5,uVar8 + *(uint *)(param_1 + 0x10));
  param_2[1] = CONCAT44((uVar6 & (uint)lVar9 | uVar1 & uVar7) + iVar2 + (int)((ulong)lVar4 >> 0x20),
                        (int)lVar4);
  return 0;
}
...
int mbedtls_poly1305_mac(ulong *param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

...
LAB_001057da:
          ...
          if (lVar30 <= (long)uVar31) goto LAB_00105709;
          uVar26 = uVar26 + 1;
          fVar43 = fVar43 + (pfVar18[uVar31 * 2] - pfVar18[lVar13]) *
                            (fVar2 + (pfVar18 + uVar31 * 2)[1]);
          fVar2 = fVar45;
        } while (uVar26 != uVar25);
        ...
        if ((long)uVar26 < 0) {
          ...
          if ((local_290 != (NodePath *)0x0) && (pNVar28[0x600] == (NodePath)0x0)) {
            if ((*(long *)(pNVar28 + 0x5c8) == 0) ||
               (*(long *)(*(long *)(pNVar28 + 0x5c8) + -8) == 0)) goto LAB_00106646;
...
LAB_00105709:
        _err_print_index_error
                  ("get","./core/templates/cowdata.h",0xdb,uVar31,lVar30,"p_index","size()","",false
                   ,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
...
LAB_00105cd4:
        if ((int)fVar24 < 1) goto LAB_0010662b;
        uVar29 = 0;
        do {

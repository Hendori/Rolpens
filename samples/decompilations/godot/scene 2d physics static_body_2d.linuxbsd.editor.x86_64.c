...
/* StaticBody2D::get_constant_linear_velocity() const */

undefined8 __thiscall StaticBody2D::get_constant_linear_velocity(StaticBody2D *this)
...
/* StaticBody2D::get_constant_angular_velocity() const */

undefined4 __thiscall StaticBody2D::get_constant_angular_velocity(StaticBody2D *this)
...
/* StaticBody2D::set_constant_linear_velocity(Vector2 const&) */

void __thiscall StaticBody2D::set_constant_linear_velocity(StaticBody2D *this,Vector2 *param_1)
...
/* StaticBody2D::set_constant_angular_velocity(float) */

void __thiscall StaticBody2D::set_constant_angular_velocity(StaticBody2D *this,float param_1)
...
void __thiscall StaticBody2D::_reload_physics_characteristics(StaticBody2D *this)
...
/* StaticBody2D::get_physics_material_override() const */

void StaticBody2D::get_physics_material_override(void)
...
void StaticBody2D::navmesh_parse_init(void)

{
  ...
  if (lVar1 == 0) {
    if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
      _err_print_error("navmesh_parse_init","scene/2d/physics/static_body_2d.cpp",0x5d,
...
/* StaticBody2D::StaticBody2D(PhysicsServer2D::BodyMode) */
...
/* StaticBody2D::set_physics_material_override(Ref<PhysicsMaterial> const&) */

void __thiscall StaticBody2D::set_physics_material_override(StaticBody2D *this,Ref *param_1)
...
LAB_00100750:
    ...
    create_custom_callable_function_pointer<StaticBody2D>
              (aSStack_48,(char *)this,
               (_func_void *)"&StaticBody2D::_reload_physics_characteristics");
...
LAB_0010073b:
        if (pOVar4 == (Object *)0x0) goto LAB_00100790;
      }
      else {
        cVar3 = RefCounted::reference();
...
void StaticBody2D::_bind_methods(void)

{
  ...
  local_50 = (undefined1  [16])0x0;
  local_58 = (char **)0x0;
  pMVar5 = create_method_bind<StaticBody2D,Ref<PhysicsMaterial>const&>
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* StaticBody2D::navmesh_parse_source_geometry(Ref<NavigationPolygon> const&,
   Ref<NavigationMeshSourceGeometryData2D>, Node*) */

void StaticBody2D::navmesh_parse_source_geometry(undefined8 param_1,long *param_2,long param_3)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (((param_3 != 0) &&
      (pLVar11 = (List *)__dynamic_cast(param_3,&Object::typeinfo,&typeinfo,0),
      pLVar11 != (List *)0x0)) &&
     (iVar8 = NavigationPolygon::get_parsed_geometry_type(), iVar8 - 1U < 2)) {
    ...
    if ((uVar10 & uVar9) != 0) {
      ...
      if (local_d8 != (long *)0x0) {
        for (lVar12 = *local_d8; lVar12 != 0; lVar12 = *(long *)(lVar12 + 8)) {
          ...
          if ((cVar7 == '\0') &&
             (iVar8 = CollisionObject2D::shape_owner_get_shape_count(uVar9), 0 < iVar8)) {
            local_150 = 0;
            do {
                    ...
                    if (local_c0 == (undefined8 *)0x0) {
                      ...
                      if (0 < lVar13) {
                        ...
                        *local_c0 = uVar23;
                        ...
                        CowData<Vector2>::_copy_on_write((CowData<Vector2> *)&local_c0);
                        lVar13 = local_c0[-1];
                        local_c0[2] = CONCAT44((fVar31 - fVar32 * fVar27) + fVar34,
...
LAB_00102074:
                    _err_print_index_error
                              ("operator[]","./core/templates/vector.h",0x38,lVar15,lVar13,"p_index"
...
LAB_00101c25:
                  lVar13 = __dynamic_cast(pOVar14,&Object::typeinfo,&CapsuleShape2D::typeinfo,0);
                  if (lVar13 != 0) {
                    uVar17 = 0;
                    ...
                    do {
                      ...
                      while( true ) {
                        ...
                        CowData<Vector2>::_copy_on_write((CowData<Vector2> *)&local_c0);
                        local_c0[lVar19] =
                             CONCAT44((fVar24 + 0.0) * fStack_134 + fVar28 * fVar22 + fVar30,
                                      (fVar24 + 0.0) * local_138 + fVar28 * fVar21 + fVar29);
                        iVar18 = iVar16 + 1;
                        if ((0x208UL >> (uVar17 & 0x3f) & 1) != 0) {
                          ...
                          iVar18 = iVar16 + 2;
                          CowData<Vector2>::_copy_on_write((CowData<Vector2> *)&local_c0);
                          *(float *)(local_c0 + lVar19 + 1) =
                               fVar24 * local_138 + fVar33 * fVar21 + fVar29;
                          *(float *)((long)(local_c0 + lVar19 + 1) + 4) =
                               fVar24 * fStack_134 + fVar33 * fVar22 + fVar30;
                        }
                        iVar16 = (int)uVar17;
                        uVar10 = iVar16 + 1;
                        uVar17 = (ulong)uVar10;
...
LAB_00101c45:
                  lVar13 = __dynamic_cast(pOVar14,&Object::typeinfo,&CircleShape2D::typeinfo,0);
                  if (lVar13 != 0) {
                    lVar15 = 0;
                    ...
                    while( true ) {
                      ...
                      iVar18 = (int)lVar15;
                      local_c0[lVar15] =
                           CONCAT44(fVar21 * fVar27 * (float)((ulong)uVar23 >> 0x20) +
                                    fVar33 * fVar27 * fVar24 + (float)((ulong)uVar6 >> 0x20),
                                    fVar21 * fVar27 * (float)uVar23 + fVar33 * fVar27 * fVar22 +
                                    (float)uVar6);
                      lVar15 = lVar15 + 1;
                      if (lVar15 == 0xc) break;
                  ...
                  lVar13 = __dynamic_cast(pOVar14,&Object::typeinfo,&ConcavePolygonShape2D::typeinfo
                                          ,0);
                  if (lVar13 != 0) {
                    ConcavePolygonShape2D::get_segments();
                    for (lVar13 = 0;
                        (local_c0 != (undefined8 *)0x0 && (lVar13 < (long)local_c0[-1]));
                        lVar13 = lVar13 + 1) {
                      ...
                      CowData<Vector2>::_copy_on_write((CowData<Vector2> *)&local_c0);
                      local_c0[lVar13] =
                           CONCAT44((float)uVar4 + fVar24 + fVar21 * (float)uVar17,
                                    fVar33 + fVar22 + fVar21 * fVar27);
                    }
                    NavigationMeshSourceGeometryData2D::add_obstruction_outline((Vector *)*param_2);
                    CowData<Vector2>::_unref((CowData<Vector2> *)&local_c0);
                    pOVar14 = local_d0[0];
                  ...
                  lVar13 = __dynamic_cast(pOVar14,&Object::typeinfo,&ConvexPolygonShape2D::typeinfo,
                                          0);
                  if (lVar13 != 0) {
...

{
  ...
  return (uint)CONCAT71(0x10d0,in_RSI == &CollisionObject2D::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x10d0,in_RSI == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x10d0,in_RSI == &Node2D::get_class_ptr_static()::ptr) |
...
{
  return (uint)CONCAT71(0x10d0,(undefined4 *)param_1 == &Resource::get_class_ptr_static()::ptr) |
...
/* CallableCustomMethodPointer<StaticBody2D, void>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<StaticBody2D,void>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<StaticBody2D,void> *this)
...
/* CallableCustomMethodPointer<StaticBody2D, void>::get_argument_count(bool&) const */

undefined8 __thiscall
CallableCustomMethodPointer<StaticBody2D,void>::get_argument_count
          (CallableCustomMethodPointer<StaticBody2D,void> *this,bool *param_1)
...
/* CallableCustomMethodPointer<StaticBody2D, void>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<StaticBody2D,void>::get_object
          (CallableCustomMethodPointer<StaticBody2D,void> *this)
...

{
  ...
  if (in_RSI != &get_class_ptr_static()::ptr) {
    uVar1 = (uint)CONCAT71(0x10d0,in_RSI == &CollisionObject2D::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10d0,in_RSI == &PhysicsBody2D::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10d0,in_RSI == &Node2D::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10d0,in_RSI == &CanvasItem::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x10d0,in_RSI == &Node::get_class_ptr_static()::ptr) |
            CONCAT31((int3)((uint)in_EDX >> 8),in_RSI == &Object::get_class_ptr_static()::ptr);
...
StaticBody2D *
create_custom_callable_function_pointer<StaticBody2D>
          (StaticBody2D *param_1,char *param_2,_func_void *param_3)
...
void __thiscall
CallableCustomMethodPointer<StaticBody2D,void>::call
          (CallableCustomMethodPointer<StaticBody2D,void> *this,Variant **param_1,int param_2,
    ...
    if (CollisionObject2D::initialize_class()::initialized == '\0') {
      if (Node2D::initialize_class()::initialized == '\0') {
        if (CanvasItem::initialize_class()::initialized == '\0') {
          ...
          if ((code *)PTR__bind_compatibility_methods_00111048 !=
              Object::_bind_compatibility_methods) {
...
MethodBind * create_method_bind<StaticBody2D,Vector2_const&>(_func_void_Vector2_ptr *param_1)
...
/* MethodBind* create_method_bind<StaticBody2D, float>(void (StaticBody2D::*)(float)) */

MethodBind * create_method_bind<StaticBody2D,float>(_func_void_float *param_1)
...
/* MethodBind* create_method_bind<StaticBody2D, Vector2>(Vector2 (StaticBody2D::*)() const) */

MethodBind * create_method_bind<StaticBody2D,Vector2>(_func_Vector2 *param_1)
...
/* MethodBind* create_method_bind<StaticBody2D, float>(float (StaticBody2D::*)() const) */

MethodBind * create_method_bind<StaticBody2D,float>(_func_float *param_1)
...
/* MethodBind* create_method_bind<StaticBody2D, Ref<PhysicsMaterial> const&>(void
   (StaticBody2D::*)(Ref<PhysicsMaterial> const&)) */

MethodBind *
create_method_bind<StaticBody2D,Ref<PhysicsMaterial>const&>(_func_void_Ref_ptr *param_1)
...
MethodBind * create_method_bind<StaticBody2D,Ref<PhysicsMaterial>>(_func_Ref *param_1)
...
/* StaticBody2D::_bind_methods() [clone .cold] */
...
LAB_00108af2:
    ...
    *(undefined8 *)(param_4 + 4) = uVar6;
    ...
    if (((pOVar10 == (Object *)0x0) ||
       ...
       (pOVar8 != (Object *)0x0)) goto LAB_00108af2;
  }
...
/* StaticBody2D::_navmesh_source_geometry_parsing_callback */

void StaticBody2D::_GLOBAL__sub_I__navmesh_source_geometry_parsing_callback(void)

...
LAB_00100160:
        ...
        param_5[1] = (uint)((uVar4 & 0xfffd) != 8) &
                     (uint)CONCAT71(uVar13,1 < (ushort)(uVar1 - 0x3d));
        goto LAB_00100301;
      }
      uVar4 = uVar1 - 0x48;
...
LAB_001000f8:
      param_5[1] = (uint)((uVar4 & 0xfffd) != 8) & (uint)CONCAT71(uVar13,1 < (ushort)(uVar4 - 2));
      if (uVar14 == 0x3b) {
LAB_00100301:
        *param_5 = 0x1f;
LAB_0010030b:
...
LAB_001001b4:
      uVar11 = (uint)*(byte *)(param_4 + (ulong)uVar4);
      goto LAB_001001b9;
    }
  }
...
ushort compare_opcodes(ushort *param_1,undefined4 param_2,undefined4 param_3,long param_4,
    ...
    do {
      ...
      if ((ushort)(uVar3 - 0x79) < 0x20) {
        ...
        if ((uVar10 & 0xc0000000) != 0) {
          puVar15 = param_1 + 1;
          if (((param_1[1] & 0xfffd) != 0x85) && (param_1[1] != 0x89))
      ...
      param_1 = (ushort *)
                get_chr_property_list(param_1,param_2,param_3,*(undefined8 *)(param_4 + 0x10));
...
switchD_001008d5_caseD_18:
      ...
      if (uVar9 != 0x6e) {
        ...
        if (1 < uVar9 - 0xf) {
          if (((uVar9 - 6 < 0x11) && (local_68 - 6 < 0x15)) &&
             (autoposstab[(ulong)(local_68 - 6) + (ulong)(uVar9 - 6) * 0x15] != '\0'))
          goto LAB_0010079a;
          goto switchD_001005ca_caseD_83;
        }

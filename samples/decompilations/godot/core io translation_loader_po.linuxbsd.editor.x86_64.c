...
/* TranslationLoaderPO::handles_type(String const&) const */

void __thiscall TranslationLoaderPO::handles_type(TranslationLoaderPO *this,String *param_1)
...
/* TranslationLoaderPO::get_recognized_extensions(List<String, DefaultAllocator>*) const */

void __thiscall
TranslationLoaderPO::get_recognized_extensions(TranslationLoaderPO *this,List *param_1)
...
/* TranslationLoaderPO::get_resource_type(String const&) const */

String * TranslationLoaderPO::get_resource_type(String *param_1)
...
/* TranslationLoaderPO::load_translation(Ref<FileAccess>, Error*) */

long * TranslationLoaderPO::load_translation
                 (long *param_1,undefined8 *param_2,undefined4 *param_3,undefined8 param_4,
                 undefined8 param_5,String *param_6)
      ...
      if (uVar12 == 2) {
        ...
        if ((StringName::configured != '\0') &&
          ...
          if (local_70 != 0) {
            StringName::unref();
joined_r0x00103aef:
            if (StringName::configured == '\0') goto LAB_00102682;
          }
LAB_00102645:
          if (local_58 != (char *)0x0) {
            StringName::unref();
      ...
      String::parse_latin1
                ((String *)&local_78,
                 "Number of \'msgstr[]\' doesn\'t match with number of plural forms: %s:%d.");
      param_6 = (String *)
                vformat<String,int>(local_130,(String *)&local_78,(CowData<char32_t> *)&local_70,
                                    local_114);
      uVar19 = 0xda;
      pcVar15 = "Condition \"plural_index != plural_forms - 1\" is true. Returning: Ref<Resource>()"
      ;
LAB_00102361:
      _err_print_error("load_translation","core/io/translation_loader_po.cpp",uVar19,pcVar15,
                       local_130,0,0,param_6);
...
LAB_0010120b:
    if (((local_88 != (char *)0x0) && (1 < *(uint *)(local_88 + -8))) &&
       (cVar6 = String::begins_with((char *)&local_88), cVar6 == '\0')) {
      cVar6 = String::begins_with((char *)&local_88);
...
LAB_001022c1:
        if (local_88 != (char *)0x0) {
          ...
          if ((int)uVar27 != 0) {
            ...
            uVar17 = 0;
LAB_001035a8:
            if ((int)uVar28 <= (int)uVar17) goto LAB_001022d3;
            if (uVar27 == uVar17) {
LAB_001035d7:
              bVar22 = false;
LAB_001035d9:
            ...
            if (uVar12 == 1) {
              ...
              if (local_f8 <= local_f4) {
                ...
                uVar19 = 0x12a;
                pcVar15 = 
                "Condition \"plural_index >= plural_forms\" is true. Returning: Ref<Resource>()";
                goto LAB_00102361;
              }
...
LAB_001022d3:
      ...
      local_78 = (char *)0x0;
      String::parse_latin1
                ((String *)&local_78,"Expected \'\"\' at end of message while parsing: %s:%d.");
    ...
    if (iVar9 != 0) {
      ...
      do {
        ...
        CowData<unsigned_char>::resize<false>
                  ((CowData<unsigned_char> *)local_50,(ulong)(uVar12 + 1));
...
LAB_00102b00:
        ...
        uVar13 = (**(code **)(*(long *)*param_2 + 0x1f0))();
        CowData<unsigned_char>::resize<false>
                  ((CowData<unsigned_char> *)&local_60,(ulong)(uVar12 + 1));
        (**(code **)(*(long *)*param_2 + 0x1b8))((long *)*param_2,uVar13);
        plVar30 = (long *)*param_2;
        pcVar2 = *(code **)(*plVar30 + 0x220);
...
LAB_001021bc:
              _err_print_index_error
                        ("get","./core/templates/cowdata.h",0xdb,uVar17,uVar27,"p_index","size()",""
                         ,false,true);
              _err_flush_stdout();
                    /* WARNING: Does not return */
              ...
              if (*(char *)(lVar21 + uVar17) == '\0') {
                ...
                if ((local_98 == (char *)0x0) || (*(uint *)(local_98 + -8) < 2)) {
                  ...
                  if (iVar29 == 0) {
                    ...
                    _err_print_index_error
                              ("set","./core/templates/cowdata.h",0xcf,lVar20,lVar14,"p_index",
                               "size()","",false,false);
                  }
                  else {
...
LAB_001039e8:
  ...
  vformat<String,unsigned_short,unsigned_short>
            (local_130,(StrRange *)&local_70,(CowData<char32_t> *)&local_68,uVar7,uVar8);
  pcVar15 = "Condition \"version_maj > 1\" is true. Returning: Ref<Resource>()";
  uVar19 = 0x33;
LAB_001018b3:
  _err_print_error("load_translation","core/io/translation_loader_po.cpp",uVar19,pcVar15,local_130,0
                   ,0);
  pcVar15 = local_58;
  if (local_58 != (char *)0x0) {
    LOCK();
...
LAB_00101e58:
  local_78 = (char *)0x0;
  local_58 = 
  "Unexpected \'msgctxt\', was expecting \'msgid_plural\' or \'msgstr\' before \'msgctxt\' while parsing: %s:%d."
  ;
  local_50[0] = 0x65;
  String::parse_latin1((StrRange *)&local_78);
  vformat<String,int>(local_130,(StrRange *)&local_78,&local_70,local_114);
  pcVar15 = 
  "Condition \"status != STATUS_READING_STRING && status != STATUS_READING_PLURAL\" is true. Returning: Ref<Resource>()"
  ;
  uVar19 = 0xb3;
  goto LAB_00100d82;
  while( true ) {
...
LAB_00102a73:
  local_78 = (char *)0x0;
  local_58 = 
  "Unexpected \'msgstr[]\', was expecting \'msgid_plural\' before \'msgstr[]\' while parsing: %s:%d."
  ;
  local_50[0] = 0x5b;
  String::parse_latin1((StrRange *)&local_78);
  vformat<String,int>(local_130,(StrRange *)&local_78,&local_70,local_114);
...
LAB_001032be:
  local_78 = (char *)0x0;
  local_58 = 
  "PO file uses \'msgid_plural\' but \'Plural-Forms\' is invalid or missing in header: %s:%d.";
  local_50[0] = 0x56;
  String::parse_latin1((StrRange *)&local_78);
  vformat<String,int>(local_130,(StrRange *)&local_78,&local_70,local_114);
  pcVar15 = "Method/function failed. Returning: Ref<Resource>()";
...
LAB_00101acd:
  local_58 = 
  "Unexpected \'msgstr\', was expecting \'msgid\' before \'msgstr\' while parsing: %s:%d.";
  local_78 = (char *)0x0;
  local_50[0] = 0x50;
  String::parse_latin1((StrRange *)&local_78);
  vformat<String,int>(local_130,(StrRange *)&local_78,&local_70,local_114);
  _err_print_error("load_translation","core/io/translation_loader_po.cpp",0xfb,
                   "Condition \"status != STATUS_READING_ID\" is true. Returning: Ref<Resource>()",
                   local_130,0,0);
  pcVar15 = local_58;
  if (local_58 != (char *)0x0) {
    LOCK();
...
LAB_00103498:
  ...
  _err_print_error("load_translation","core/io/translation_loader_po.cpp",0x108,
                   "Condition \"!l.begins_with(\"\\\"\") || status == STATUS_NONE\" is true. Returning: Ref<Resource>()"
                   ,local_130,0,0);
  pcVar15 = local_58;
  if (local_58 != (char *)0x0) {
    LOCK();
...
LAB_00102439:
    if (((bVar31) || (local_a0 == 0)) || (*(uint *)(local_a0 + -8) < 2)) goto LAB_00101764;
    if (local_f8 + -1 == local_f4) {
      pcVar2 = *(code **)(*(long *)this_00 + 0x1e8);
      StringName::StringName((StringName *)local_130,(String *)&local_90,false);
      StringName::StringName((StringName *)&local_70,(String *)&local_a0,false);
    ...
    pSVar26 = local_130;
    vformat<String,int>(local_130,(String *)&local_78,(CowData<char32_t> *)&local_70,local_114);
    _err_print_error("load_translation","core/io/translation_loader_po.cpp",0x13c,
                     "Condition \"plural_index != plural_forms - 1\" is true. Returning: Ref<Resource>()"
                     ,local_130,0,0,pSVar26);
    CowData<char32_t>::_unref((CowData<char32_t> *)local_130);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_78);
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_70);
    *param_1 = 0;
  ...
  if ((local_a0 == 0) || (*(uint *)(local_a0 + -8) < 2)) {
    ...
    if ((StringName::configured != '\0') &&
      ...
      if (local_70 != 0) {
        StringName::unref();
joined_r0x001024ea:
        if (StringName::configured == '\0') goto LAB_00101764;
      }
LAB_001024f0:
      if (local_58 != (char *)0x0) {
        StringName::unref();
...
LAB_0010180d:
  ...
  for (lVar21 = 0; (local_50[0] != 0 && (lVar21 < *(long *)(local_50[0] + -8))); lVar21 = lVar21 + 1
    ...
    if (iVar9 != -1) {
      ...
      if ((cVar4 != '\0') ||
         (cVar4 = String::operator==((String *)&local_78,"Language"), cVar4 != '\0')) {
...
LAB_00102e45:
  _err_print_index_error
            ("operator[]","./core/templates/vector.h",0x38,uVar16,lVar21,"p_index",
...
LAB_00103381:
  local_78 = (char *)0x0;
  local_58 = 
  "Unexpected \'msgid_plural\', was expecting \'msgid\' before \'msgid_plural\' while parsing: %s:%d."
  ;
  local_50[0] = 0x5c;
  String::parse_latin1((StrRange *)&local_78);
  vformat<String,int>(local_130,(StrRange *)&local_78,&local_70,local_114);
...
LAB_001040e8:
    ...
    _err_print_error(&_LC79,"core/io/translation_loader_po.cpp",0x160,
                     "Condition \"f.is_null()\" is true. Returning: Ref<Resource>()",&local_48,0,0);
    pOVar4 = local_48;
...
{
  return (uint)CONCAT71(0x107f,(undefined4 *)param_1 == &RefCounted::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x107f,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
...
/* TranslationLoaderPO::get_resource_uid(String const&) const */

undefined8 TranslationLoaderPO::get_resource_uid(String *param_1)
...
/* TranslationLoaderPO::has_custom_uid_support() const */

undefined8 TranslationLoaderPO::has_custom_uid_support(void)
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (initialize_class()::initialized != '\0') goto LAB_0010555b;
...
void __thiscall TranslationLoaderPO::~TranslationLoaderPO(TranslationLoaderPO *this)
...
/* WARNING: Removing unreachable block (ram,0x0010607e) */
/* WARNING: Removing unreachable block (ram,0x001061c2) */
/* WARNING: Removing unreachable block (ram,0x0010608a) */
/* WARNING: Removing unreachable block (ram,0x00106094) */
/* WARNING: Removing unreachable block (ram,0x001061a4) */
/* WARNING: Removing unreachable block (ram,0x001060a0) */
/* WARNING: Removing unreachable block (ram,0x001060aa) */
/* WARNING: Removing unreachable block (ram,0x00106186) */
/* WARNING: Removing unreachable block (ram,0x001060b6) */
/* WARNING: Removing unreachable block (ram,0x001060c0) */
/* WARNING: Removing unreachable block (ram,0x00106168) */
/* WARNING: Removing unreachable block (ram,0x001060cc) */
/* WARNING: Removing unreachable block (ram,0x001060d6) */
/* WARNING: Removing unreachable block (ram,0x0010614a) */
/* WARNING: Removing unreachable block (ram,0x001060de) */
/* WARNING: Removing unreachable block (ram,0x001060e8) */
/* WARNING: Removing unreachable block (ram,0x0010612f) */
/* WARNING: Removing unreachable block (ram,0x001060f0) */
/* WARNING: Removing unreachable block (ram,0x00106105) */
/* WARNING: Removing unreachable block (ram,0x00106111) */
/* String vformat<String, unsigned short, unsigned short>(String const&, String const, unsigned
   short const, unsigned short const) */

undefined8 *
vformat<String,unsigned_short,unsigned_short>
          (undefined8 *param_1,bool *param_2,String *param_3,ushort param_4,ushort param_5)

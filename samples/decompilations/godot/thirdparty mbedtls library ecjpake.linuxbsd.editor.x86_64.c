...
ecjpake_write_len_point
          (ulong *param_1,ulong param_2,undefined8 param_3,undefined4 param_4,undefined8 param_5)

{
  ...
  if ((param_2 < uVar1) || ((long)(param_2 - uVar1) < 5)) {
    ...
    uVar2 = mbedtls_ecp_point_write_binary
                      (param_3,param_5,param_4,&local_18,uVar1 + 4,param_2 - (uVar1 + 4));
    if ((int)uVar2 == 0) {
      uVar3 = (uint)local_18;
      *(uint *)*param_1 =
...
undefined8
ecjpake_hash(undefined4 param_1,long param_2,undefined4 param_3,undefined8 param_4,
    ...
    if ((int)uVar3 == 0) {
      ...
      if ((int)uVar3 == 0) {
        if (3 < (long)local_43 - (long)local_230) {
          __dest = local_230 + 1;
          uVar2 = (uint)__n;
          *local_230 = uVar2 >> 0x18 | (uVar2 & 0xff0000) >> 8 | (uVar2 & 0xff00) << 8 |
                       uVar2 << 0x18;
          local_230 = __dest;
          if ((__dest <= local_43) && (__n <= (ulong)((long)local_43 - (long)__dest))) {
            ...
            uVar3 = mbedtls_md(uVar3,local_1e8,(long)(__n + (long)pvVar4) - (long)local_1e8,
                               local_228);
            if ((int)uVar3 == 0) {
              uVar3 = mbedtls_md_info_from_type(param_1);
...
LAB_001001bf:
  if (local_43._3_8_ == *(long *)(in_FS_OFFSET + 0x28)) {
    return uVar3;
  }
                    /* WARNING: Subroutine does not return */
  __stack_chk_fail();
...
int ecjpake_zkp_write(undefined4 param_1,long param_2,undefined4 param_3,undefined8 param_4,
          ...
          if (iVar2 == 0) {
            ...
            if (iVar2 == 0) {
              iVar2 = mbedtls_ecp_tls_write_point
                                (param_2,local_78,param_3,&local_a0,*param_8,
                                 (long)param_9 - *param_8);
              if (iVar2 == 0) {
...
undefined8
ecjpake_kkp_write(undefined4 param_1,undefined8 param_2,undefined4 param_3,undefined8 param_4,
                 undefined8 param_5,undefined8 param_6,undefined8 param_7,ulong *param_8,
...

{
  ...
  if (param_9 < *param_8) {
    ...
    uVar1 = mbedtls_ecp_gen_keypair_base
                      (param_2,param_4,param_5,param_6,param_10,param_11,param_3,param_7);
    if ((int)uVar1 == 0) {
      uVar1 = mbedtls_ecp_tls_write_point
                        (param_2,param_6,param_3,&local_48,*param_8,param_9 - *param_8);
      if ((int)uVar1 == 0) {
        *param_8 = *param_8 + local_48;
        uVar1 = ecjpake_zkp_write(param_1,param_2,param_3,param_4,param_5,param_6,param_7,param_8,
...
int ecjpake_ecp_add3(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
                    undefined8 param_5)
...
int ecjpake_mul_secret(long param_1,short param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  iVar1 = mbedtls_mpi_lset(local_58,1);
  if (iVar1 == 0) {
    iVar1 = ecjpake_mul_secret(local_68,0xffffffff,param_1 + 0x1d0,param_1 + 0x1e0,param_1 + 0x70,
                               param_3);
    if (iVar1 == 0) {
...
ulong ecjpake_kkp_read(undefined4 param_1,undefined8 param_2,undefined4 param_3,undefined8 param_4,
                      undefined8 param_5,undefined8 param_6,ulong *param_7,byte *param_8)
...
LAB_00100a73:
  mbedtls_ecp_point_free(local_a8);
  mbedtls_ecp_point_free(local_78);
...

{
  *param_1 = 0;
  ...
  mbedtls_ecp_point_free(param_1 + 0x34);
  mbedtls_ecp_point_free(param_1 + 0x40);
  mbedtls_ecp_point_free(param_1 + 0x4c);
  mbedtls_ecp_point_free(param_1 + 0x58);
  mbedtls_ecp_point_free(param_1 + 100);
  mbedtls_mpi_free(param_1 + 0x70);
  mbedtls_mpi_free(param_1 + 0x74);
  mbedtls_mpi_free(param_1 + 0x78);
  return;
}
...

{
  *param_1 = 0;
  ...
  param_1[0x33] = 0;
  mbedtls_ecp_point_init(param_1 + 0x34);
  mbedtls_ecp_point_init(param_1 + 0x40);
  mbedtls_ecp_point_init(param_1 + 0x4c);
  mbedtls_ecp_point_init(param_1 + 0x58);
  mbedtls_ecp_point_init(param_1 + 100);
  mbedtls_mpi_init(param_1 + 0x70);
  mbedtls_mpi_init(param_1 + 0x74);
  mbedtls_mpi_init(param_1 + 0x78);
  return;
}
...

{
  ...
  local_48 = param_2;
  uVar4 = ecjpake_kkp_read(uVar2,param_1 + 2,uVar1,param_1 + 0x10,param_1 + 0x4c,uVar3,&local_48,
                           param_3);
  if ((((int)uVar4 == 0) &&
      (uVar4 = ecjpake_kkp_read(uVar2,param_1 + 2,uVar1,param_1 + 0x10,param_1 + 0x58,uVar3,
                                &local_48,param_3), (int)uVar4 == 0)) &&
     (uVar4 = uVar4 & 0xffffffff, param_3 != local_48)) {
    uVar4 = 0xffffb080;
  }
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
...
void mbedtls_ecjpake_write_round_one
...

{
  ...
  if (iVar4 == 0) {
    iVar4 = ecjpake_kkp_write(uVar2,param_1 + 2,uVar1,param_1 + 0x10,param_1 + 0x74,param_1 + 0x40,
                              uVar3,&local_48,param_3 + param_2,param_5,param_6);
    if (iVar4 == 0) {
...

{
  ...
  iVar1 = ecjpake_kkp_read(*param_1,param_1 + 2,param_1[0x33],local_138,param_1 + 100,
                           *(undefined8 *)(ecjpake_id + (ulong)(1 - iVar1) * 8),&local_140,
                           param_3 + param_2);
...
int mbedtls_ecjpake_write_round_two
              (undefined4 *param_1,ulong param_2,long param_3,long *param_4,undefined8 param_5,
              undefined8 param_6)
...
LAB_001012bb:
    if (uVar4 <= uVar2) {
      iVar3 = mbedtls_ecp_tls_write_point
                        (puVar1,local_78,param_1[0x33],&local_c0,uVar4,uVar2 - uVar4);
      if (iVar3 == 0) {
        local_c8 = uVar4 + local_c0;
        iVar3 = ecjpake_zkp_write(*param_1,puVar1,param_1[0x33],local_a8,local_b8,local_78,
                                  *(undefined8 *)(ecjpake_id + (ulong)(uint)param_1[0x32] * 8),
                                  &local_c8,uVar2,param_5,param_6);
        if (iVar3 == 0) {
...

{
  ...
  if (iVar1 == 0) {
    iVar1 = mbedtls_ecp_point_write_binary
                      (param_1 + 8,local_78,*(undefined4 *)(param_1 + 0xcc),param_4,param_2,param_3)
    ;
  }
  mbedtls_ecp_point_free(local_78);
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
...

{
  ...
  if ((iVar1 == 0) &&
     (iVar1 = mbedtls_mpi_read_binary(local_468,ecjpake_test_password,0xf), iVar1 == 0)) {
    local_390 = 1;
    lVar2 = mbedtls_md_info_from_type(9);
    if (lVar2 == 0) {
LAB_001016cc:
    ...
    if ((iVar1 != 0) ||
       (iVar1 = mbedtls_mpi_read_binary(local_278,ecjpake_test_password,0xf), iVar1 != 0)) {
      mbedtls_ecjpake_free_part_0(local_458);
      goto LAB_001016cc;
    }
    if (param_1 != 0) {
    ...
    if ((((iVar1 != 0) ||
         (iVar1 = mbedtls_ecjpake_read_round_one(local_458,local_248,local_658), iVar1 != 0)) ||
        (iVar1 = mbedtls_ecjpake_write_round_one(local_458,local_248,0x200,&local_658,ecjpake_lgc,0)
        , iVar1 != 0)) ||
       (((iVar1 = mbedtls_ecjpake_read_round_one(local_648,local_248,local_658), iVar1 != 0 ||
         (iVar1 = mbedtls_ecjpake_write_round_two
                            (local_458,local_248,0x200,&local_658,ecjpake_lgc,0), iVar1 != 0)) ||
        (iVar1 = mbedtls_ecjpake_read_round_two(local_648,local_248,local_658), iVar1 != 0))))
    goto LAB_001016cc;
    iVar1 = mbedtls_ecjpake_derive_secret(local_648,local_268,0x20,&local_650,ecjpake_lgc,0);
    if (((iVar1 != 0) ||
        (iVar1 = mbedtls_ecjpake_write_round_two(local_648,local_248,0x200,&local_658,ecjpake_lgc,0)
        , iVar1 != 0)) ||
       ((iVar1 = mbedtls_ecjpake_read_round_two(local_458,local_248,local_658), iVar1 != 0 ||
        (((iVar1 = mbedtls_ecjpake_derive_secret(local_458,local_248,0x200,&local_658,ecjpake_lgc,0)
          , iVar1 != 0 || (local_658 != local_650)) ||
         (iVar1 = memcmp(local_248,local_268,local_658), iVar1 != 0)))))) goto LAB_001016cc;
    if (param_1 != 0) {
      puts("passed");
    ...
    if ((((iVar1 != 0) ||
         (iVar1 = ecjpake_test_load_constprop_0(local_458,ecjpake_test_x3,ecjpake_test_x4),
         iVar1 != 0)) ||
        ((iVar1 = mbedtls_ecjpake_read_round_one(local_458,ecjpake_test_cli_one,0x14a), iVar1 != 0
         || ((iVar1 = mbedtls_ecjpake_read_round_one(local_648,ecjpake_test_srv_one,0x14a),
             iVar1 != 0 ||
             (iVar1 = mbedtls_ecjpake_read_round_two(local_648,ecjpake_test_srv_two,0xa8),
             iVar1 != 0)))))) ||
       ((iVar1 = mbedtls_ecjpake_read_round_two(local_458,ecjpake_test_cli_two,0xa5), iVar1 != 0 ||
        (((((iVar1 = mbedtls_ecjpake_derive_secret
                               (local_458,local_248,0x200,&local_658,ecjpake_lgc,0), iVar1 != 0 ||
            (local_658 != 0x20)) || (iVar1 = memcmp(local_248,ecjpake_test_pms,0x20), iVar1 != 0))
          || ((iVar1 = mbedtls_ecjpake_write_shared_key
                                 (local_458,local_248,0x200,&local_658,ecjpake_lgc,0), iVar1 != 0 ||
              (local_658 != 0x41)))) ||
         (iVar1 = memcmp(local_248,ecjpake_test_shared_key,0x41), iVar1 != 0))))))
    goto LAB_001016cc;
    puVar3 = local_248;
    ...
    if (((iVar1 != 0) || (local_658 != 0x20)) ||
       ((iVar1 = memcmp(local_248,ecjpake_test_pms,0x20), iVar1 != 0 ||
        (((iVar1 = mbedtls_ecjpake_write_shared_key
                             (local_648,local_248,0x200,&local_658,ecjpake_lgc,0), iVar1 != 0 ||
          (local_658 != 0x41)) ||
         (iVar1 = memcmp(local_248,ecjpake_test_shared_key,0x41), iVar1 != 0))))))
    goto LAB_001016cc;
    uVar4 = 0;

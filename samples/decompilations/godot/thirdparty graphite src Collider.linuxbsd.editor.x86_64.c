  ...
  if (param_5 == 2) {
    ...
    if (fVar4 - fVar2 < fVar5) {
      ...
      if (((fVar3 < fVar6 - fVar1) && (0.0 < fVar6 - fVar4)) && (0.0 < fVar2 - fVar1)) {
        ...
        fVar4 = (*(float *)param_4 + *(float *)(param_4 + 8)) * _LC2;
    ...
    if (param_5 == 0) {
      if ((*(float *)(param_2 + 4) <= *(float *)(param_3 + 0xc) + in_XMM1_Da &&
        ...
        if (0.0 < *(float *)(param_2 + 8) - *(float *)param_2) {
          fVar4 = (*(float *)param_3 + *(float *)(param_3 + 8)) * _LC2;
      ...
      if ((*(float *)param_2 <= *(float *)(param_3 + 8) + in_XMM0_Da &&
        ...
        if (0.0 < *(float *)(param_2 + 0xc) - *(float *)(param_2 + 4)) {
          fVar4 = (*(float *)(param_3 + 4) + *(float *)(param_3 + 0xc)) * _LC2;
    ...
    if (fVar4 + fVar2 < fVar5) {
      ...
      if (((fVar3 < fVar6 + fVar1) && (0.0 < fVar6 - fVar4)) && (0.0 < fVar1 - fVar2)) {
        ...
        fVar4 = (*(float *)(param_4 + 4) + *(float *)(param_4 + 0xc)) * _LC2;
        graphite2::Zones::remove(fVar2 - fVar4,fVar8 - fVar4);
        return;
      }
    }
...

{
  ...
  *(ulong *)(param_1 + 0x20) = CONCAT44(fVar16,fVar18);
  if (*(float **)(param_1 + 0x10) == pfVar11) {
    if (SUB168(ZEXT816(1) * ZEXT816(0x18),8) != 0) goto LAB_00104646;
    pfVar11 = (float *)realloc(pfVar11,SUB168(ZEXT816(1) * ZEXT816(0x18),0));
    *(float **)param_1 = pfVar11;
    if (pfVar11 == (float *)0x0) goto LAB_00104646;
    pfVar8 = pfVar11 + 6;
  ...
  *(undefined8 *)(param_1 + 0x70) = uVar14;
  ...
  if (*(undefined8 **)(param_1 + 0x60) == puVar10) {
    ...
    *(undefined8 **)(param_1 + 0x50) = puVar10;
    if (puVar10 == (undefined8 *)0x0) goto LAB_00104646;
    puVar9 = puVar10 + 3;
  ...
  if (in_stack_00000010 == 2) {
    ...
    if (fVar5 - fVar6 < fVar3 + *(float *)(param_5 + 0xc)) {
      ...
      if (fVar3 + *(float *)(param_5 + 4) < fVar4 - fVar1) {
        fVar3 = (*(float *)(param_5 + 0xc) + *(float *)(param_5 + 4)) * _LC2 + fVar3;
    ...
    if (fVar5 + fVar6 < fVar3 + *(float *)(param_5 + 8)) {
      ...
      if (fVar3 + *(float *)param_5 < fVar4 + fVar1) {
        fVar3 = (*(float *)(param_5 + 8) + *(float *)param_5) * _LC2 + fVar3;
        fVar4 = (fVar4 + fVar4) - fVar3;
...

{
  ...
  lVar19 = *(long *)(*(long *)(param_2 + 0x88) + 0x78);
  pRVar7 = param_3;
  do {
    pRVar10 = pRVar7;
  ...
  __ptr = *(undefined4 **)(param_1 + 0x38);
  uVar25 = *(undefined4 *)(param_5 + 4);
  ...
  lVar17 = (long)puVar13 - (long)__ptr;
  *(undefined4 *)(param_1 + 8) = *(undefined4 *)param_5;
  *(undefined4 *)(param_1 + 0xc) = uVar25;
  ...
  *(undefined8 *)(param_1 + 0x1c) = *(undefined8 *)CONCAT44(in_register_0000008c,param_7);
  ...
  fVar28 = _LC17;
  if (bVar3) {
    puVar13 = (undefined4 *)((long)puVar13 - lVar17);
    *(undefined4 **)(param_1 + 0x40) = puVar13;
    fVar24 = fVar4 / fVar28;
    *(float *)(param_1 + 0x30) = param_9 + fVar4;
    fVar27 = ((param_9 + fVar4) - (param_8 - fVar4)) + __LC18;
    *(float *)(param_1 + 0x2c) = param_8 - fVar4;
    *(float *)(param_1 + 0x50) = fVar24;
    uVar25 = _LC0;
    if (((ulong)param_10 & 1) != 0) {
      uVar25 = _LC1;
    }
    uVar11 = (ulong)(int)(fVar27 / (fVar24 / fVar28) + _LC19);
    uVar18 = uVar11 + 7 + ((long)puVar13 - (long)__ptr >> 2);
    uVar22 = uVar18 & 0xfffffffffffffff8;
    puVar14 = __ptr;
    if ((ulong)(*(long *)(param_1 + 0x48) - (long)__ptr >> 2) < uVar22) {
      if (uVar18 >> 0x3e != 0) goto graphite2_KernCollider_initSlot;
      puVar14 = (undefined4 *)realloc(__ptr,uVar22 * 4);
      *(undefined4 **)(param_1 + 0x38) = puVar14;
      if (puVar14 == (undefined4 *)0x0) goto graphite2_KernCollider_initSlot;
      puVar13 = (undefined4 *)((long)puVar14 + ((long)puVar13 - (long)__ptr));
      *(undefined4 **)(param_1 + 0x40) = puVar13;
      *(undefined4 **)(param_1 + 0x48) = puVar14 + uVar22;
    }
    __ptr = puVar14;
    if (puVar14 != puVar13) {
      memmove(puVar14 + uVar11,puVar14,(long)puVar13 - (long)puVar14);
      puVar13 = *(undefined4 **)(param_1 + 0x40);
      __ptr = *(undefined4 **)(param_1 + 0x38);
    }
    ...
    *(undefined4 **)(param_1 + 0x40) = puVar13;
    if (uVar11 != 0) {
      if ((uVar11 & 1) != 0) {
        *puVar14 = uVar25;
        uVar18 = 1;
        if (uVar11 == 1) goto LAB_00101e0e;
      }
      do {
        puVar14[uVar18] = uVar25;
        puVar14[uVar18 + 1] = uVar25;
        uVar18 = uVar18 + 2;
      } while (uVar11 != uVar18);
    }
LAB_00101e0e:
    *(undefined4 *)(param_1 + 0x58) = uVar25;
LAB_001018cb:
    do {
      lVar17 = *(long *)(param_2 + 0x80);
      if (lVar17 != 0) {
        lVar17 = lVar17 + (ulong)*(uint *)((Slot *)pRVar10 + 0x20) * 0x44;
      }
      if ((*(long *)(lVar19 + 0x20) == 0) ||
         (*(ushort *)(lVar19 + 0x28) <= *(ushort *)((Slot *)pRVar10 + 0x10))) {
        return 0;
      }
      pfVar9 = (float *)graphite2::GlyphCache::glyph((ushort)lVar19);
      fVar24 = _LC19;
      if (((ulong)param_10 & 1) == 0) {
        fVar28 = pfVar9[2];
      }
      ...
      fVar28 = *(float *)(lVar17 + 0x10) + *(float *)((Slot *)pRVar10 + 0x40) + fVar28;
      fVar1 = *(float *)(param_1 + 0x2c);
      fVar27 = *(float *)(param_1 + 0x50);
      fVar26 = (*(float *)(lVar17 + 0x14) - fVar1) + _LC19 + *(float *)((Slot *)pRVar10 + 0x44);
      iVar8 = (int)((pfVar9[1] + fVar26) / fVar27);
      if (iVar8 < 0) {
        iVar8 = 0;
      }
      iVar16 = (int)((long)puVar13 - (long)__ptr >> 2) + -1;
      iVar21 = (int)((fVar26 + pfVar9[3]) / fVar27 + _LC19);
      if (iVar16 < iVar21) {
        iVar21 = iVar16;
      }
      if (iVar8 <= iVar21) {
        ...
        fVar26 = _LC2;
        do {
          fVar27 = ((float)iVar8 + fVar26) * fVar27 + (fVar1 - fVar24);
          if (((ulong)param_10 & 1) == 0) {
            if (*(float *)(lVar20 + lVar23) < fVar28) {
              fVar27 = (float)get_edge(*(Segment **)(param_2 + 0x88),(Slot *)pRVar10,(Position *)0x1
                                       ,*(float *)(lVar17 + 0x10),*(float *)(lVar17 + 0x14),fVar27,
                                       SUB81(lVar15,0));
              fVar26 = _LC2;
              lVar20 = *(long *)(param_1 + 0x38);
              pfVar9 = (float *)(lVar20 + lVar23);
              if ((*pfVar9 <= fVar27 && fVar27 != *pfVar9) &&
                 (*pfVar9 = fVar27,
                 *(float *)(param_1 + 0x58) <= fVar27 && fVar27 != *(float *)(param_1 + 0x58)))
              goto LAB_00101ac1;
            }
          }
          else if (fVar28 < *(float *)(lVar20 + lVar23)) {
            fVar27 = (float)get_edge(*(Segment **)(param_2 + 0x88),(Slot *)pRVar10,(Position *)0x0,
                                     *(float *)(lVar17 + 0x10),*(float *)(lVar17 + 0x14),fVar27,
                                     SUB81(lVar15,0));
            fVar26 = _LC2;
            lVar20 = *(long *)(param_1 + 0x38);
            if ((fVar27 < *(float *)(lVar20 + lVar23)) &&
               (*(float *)(lVar20 + lVar23) = fVar27, fVar27 < *(float *)(param_1 + 0x58))) {
LAB_00101ac1:
              *(float *)(param_1 + 0x58) = fVar27;
            }
          }
          if (iVar21 < iVar8 + 1) break;
          iVar8 = iVar8 + 1;
          lVar23 = lVar23 + 4;
          fVar1 = *(float *)(param_1 + 0x2c);
          fVar27 = *(float *)(param_1 + 0x50);
  ...
  if (fVar24 == param_9) {
    if (param_8 == fVar28) goto LAB_001018cb;
LAB_00101e30:
    iVar8 = (int)(((param_8 - fVar4) - fVar28) / *(float *)(param_1 + 0x50) - _LC19);
    *(float *)(param_1 + 0x2c) = (float)iVar8 * *(float *)(param_1 + 0x50) + fVar28;
    if (iVar8 < 0) {
      uVar25 = _LC0;
      if (((ulong)param_10 & 1) != 0) {
        uVar25 = _LC1;
      ...
      uVar11 = (ulong)-iVar8;
      uVar18 = uVar11 + 7 + (lVar17 >> 2);
      uVar22 = uVar18 & 0xfffffffffffffff8;
      if ((ulong)(*(long *)(param_1 + 0x48) - (long)__ptr >> 2) < uVar22) {
        if (uVar18 >> 0x3e != 0) goto graphite2_KernCollider_initSlot;
        __ptr = (undefined4 *)realloc(__ptr,uVar22 * 4);
        *(undefined4 **)(param_1 + 0x38) = __ptr;
        if (__ptr == (undefined4 *)0x0) goto graphite2_KernCollider_initSlot;
        *(undefined4 **)(param_1 + 0x48) = __ptr + uVar22;
        puVar13 = (undefined4 *)((long)__ptr + lVar17);
        *(undefined4 **)(param_1 + 0x40) = puVar13;
      }
      puVar14 = __ptr;
      if (__ptr != puVar13) {
        memmove(__ptr + uVar11,__ptr,(long)puVar13 - (long)__ptr);
        puVar14 = *(undefined4 **)(param_1 + 0x40);
      }
      *(undefined4 **)(param_1 + 0x40) = puVar14 + uVar11;
      uVar18 = 0;
      if ((uVar11 & 1) == 0) {
LAB_001020e0:
        do {
          __ptr[uVar18] = uVar25;
          __ptr[uVar18 + 1] = uVar25;
          uVar18 = uVar18 + 2;
        } while (uVar11 != uVar18);
      }
      else {
        *__ptr = uVar25;
        uVar18 = 1;
        if (uVar11 != 1) goto LAB_001020e0;
      }
      fVar24 = *(float *)(param_1 + 0x30);
    }
    else {
      uVar18 = (ulong)iVar8;
      if (uVar18 < (ulong)(lVar17 >> 2)) {
        if (iVar8 == 0) {
          lVar19 = 0;
          puVar14 = __ptr;
        }
          ...
          lVar19 = uVar18 * -4;
          puVar14 = __ptr + uVar18;
        }
        if (puVar14 != puVar13) {
          memmove(__ptr,puVar14,(long)puVar13 - (long)puVar14);
          puVar13 = *(undefined4 **)(param_1 + 0x40);
          fVar24 = *(float *)(param_1 + 0x30);
        }
        *(long *)(param_1 + 0x40) = (long)puVar13 + lVar19;
      }
    }
    if (param_9 == fVar24) goto LAB_00101b03;
    fVar28 = *(float *)(param_1 + 0x2c);
    puVar13 = *(undefined4 **)(param_1 + 0x40);
    __ptr = *(undefined4 **)(param_1 + 0x38);
  }
  else if (param_8 != fVar28) goto LAB_00101e30;
  lVar19 = (long)puVar13 - (long)__ptr >> 2;
  iVar8 = (int)(((param_9 + fVar4) - fVar28) / *(float *)(param_1 + 0x50) + fVar27);
  *(float *)(param_1 + 0x30) = (float)iVar8 * *(float *)(param_1 + 0x50) + fVar28;
  iVar21 = (int)lVar19;
  if (iVar21 < iVar8) {
    uVar25 = _LC0;
    if (((ulong)param_10 & 1) != 0) {
    ...
    uVar18 = (long)iVar8 + 7;
    uVar11 = uVar18 & 0xfffffffffffffff8;
    uVar22 = iVar8 - lVar19;
...
graphite2_KernCollider_initSlot:
      ...
      pvVar12 = realloc(__ptr,__size);
      *(void **)(param_1 + 0x38) = pvVar12;
      if (pvVar12 == (void *)0x0) goto graphite2_KernCollider_initSlot;
      puVar13 = (undefined4 *)((long)pvVar12 + ((long)puVar13 - (long)__ptr));
      *(void **)(param_1 + 0x48) = (void *)((long)pvVar12 + __size);
    }
    *(undefined4 **)(param_1 + 0x40) = puVar13 + uVar22;
    if (uVar22 != 0) {
      uVar18 = 0;
      if ((uVar22 & 1) != 0) {
        *puVar13 = uVar25;
        uVar18 = 1;
        if (uVar22 == 1) goto LAB_00101b03;
      }
      do {
        puVar13[uVar18] = uVar25;
        puVar13[uVar18 + 1] = uVar25;
        uVar18 = uVar18 + 2;
      } while (uVar22 != uVar18);
    }
  }
  else if (iVar8 < iVar21) {
    do {
      puVar13 = puVar13 + -1;
    } while (iVar8 < (int)((long)puVar13 - (long)__ptr >> 2));
    *(undefined4 **)(param_1 + 0x40) = puVar13;
  }
LAB_00101b03:
...

{
  ...
  if ((*(long *)(lVar5 + 0x20) != 0) && (*(ushort *)(param_3 + 0x10) < *(ushort *)(lVar5 + 0x28))) {
    ...
    if ((param_1[0x5c] == (Segment)0x0) ||
      ...
      fVar9 = (_LC19 - *(float *)(param_1 + 0x2c)) + *(float *)(param_3 + 0x44) + pfVar2[1];
      iVar6 = (int)((pfVar4[1] + fVar9) / *(float *)(param_1 + 0x50) + _LC19);
      if (iVar6 < 1) {
        iVar6 = 1;
      }
      ...
      iVar7 = (int)((fVar9 + pfVar4[3]) / *(float *)(param_1 + 0x50) + _LC19);
      if (iVar3 < iVar7) {
        iVar7 = iVar3;
      }
      if (iVar6 <= iVar7 + 1) {
          ...
          if (fVar9 <= __LC21) {
            if ((param_1[0x5c] == (Segment)0x0) ||
              ...
              fVar10 = (float)get_edge(*(Segment **)(param_2 + 0x88),(Slot *)param_3,
                                       ...
                                       (*(float *)(param_1 + 0x2c) - _LC19) +
                                       ((float)iVar6 + _LC2) * *(float *)(param_1 + 0x50),
                                       SUB41(param_5,0));
...
LAB_00102373:
                  *(float *)(param_1 + 0x54) = fVar9;
                  ...
                  if (param_1[0x5c] != (Segment)0x0) goto LAB_00102268;
                  if (local_39 == 0) goto LAB_00102373;
                }
                local_3a = 0;
                local_39 = 1;
              }
...

{
  ...
  if ((*(long *)(lVar7 + 0x20) == 0) ||
     (uVar6 = *(ushort *)(param_2 + 0x10), *(ushort *)(lVar7 + 0x28) <= uVar6)) goto LAB_00102772;
  ...
  if (*(short *)(this + 0xea) == 0) {
    ...
    if (*(short *)(this + 0xe8) == *(short *)(param_3 + 0x30)) {
      if (param_6) {
        cVar17 = param_6;
        cVar8 = param_6;
        if (*(short *)(this + 0xe8) != 0) goto LAB_00102c2f;
      }
      else {
        cVar17 = '\x01';
      }
...
LAB_00102e8d:
      ...
      if ((uVar10 == 0) || (*(long *)(lVar7 + 0x20) == 0)) {
        ...
        if (!bVar21 && !param_8) {
          ...
          uVar10 = 1;
          if (pSVar14 == (Segment *)0x0) goto LAB_00102772;
...
LAB_00102772:
    ...
    if (((!param_6) || (cVar17 = '\0', *(short *)(this + 0xe8) == 0)) ||
       (cVar8 = '\0', *(short *)(this + 0xea) != *(short *)(param_3 + 0x30))) goto LAB_00102818;
LAB_00102c2f:
    cVar17 = cVar8;
    local_264 = (uint)*(ushort *)(this + 0xec);
    if (local_264 == 0) goto LAB_00102818;
  }
  lVar2 = (ulong)uVar6 * 8;
...
LAB_001029ea:
  ...
  if (local_264 == 0) goto switchD_00102bf0_caseD_3;
  ...
  switch(local_264) {
  case 1:
    fVar24 = (fVar4 + fVar24) * _LC2 + fVar23;
    fVar49 = ((fVar43 - (float)(int)*(short *)(param_3 + 0x3a)) + fVar22) - (fVar49 - fVar40) * _LC2
    ;
    uStack_80 = CONCAT44(fVar24,fVar45);
    local_1e8 = CONCAT44(fVar24,fVar49);
    local_88 = (undefined1  [8])
               CONCAT44(fVar46,(fVar43 + pfVar11[2]) * _LC2 + (float)(int)*(short *)(param_3 + 0x36)
                               + fVar22);
  ...
  case 2:
    fVar24 = (fVar4 + fVar24) * _LC2 + fVar23;
    fVar49 = (float)(int)*(short *)(param_3 + 0x3a) + pfVar11[2] + fVar22 + (fVar49 - fVar40) * _LC2
    ;
    local_1e8 = CONCAT44(fVar46,fVar47);
    local_88._4_4_ = fVar24;
    local_88._0_4_ = fVar47;
    uStack_80._0_4_ = (float)(int)*(short *)(param_3 + 0x36) + (pfVar11[2] + fVar43) * _LC2 + fVar22
    ;
...
LAB_00103e86:
        ...
        lVar19 = lVar19 + 0x20;
        if (lVar19 == (ulong)bVar9 << 5) goto LAB_00104180;
        pbVar16 = *(byte **)(*(long *)(lVar7 + 0x20) + lVar2);
      } while( true );
    }
    local_191 = true;

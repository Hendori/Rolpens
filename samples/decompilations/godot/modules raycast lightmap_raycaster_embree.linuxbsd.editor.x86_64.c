...
LAB_00100107:
  ...
  if ((*(long *)(param_2 + 8) != 0) && (lVar8 != *(long *)(*(long *)(param_2 + 8) + -8))) {
    uVar2 = 0x7f;
...
LAB_00100292:
  ...
  uVar9 = (ulong)iVar1;
  pvVar4 = (void *)rtcSetNewGeometryBuffer(uVar2,1,0,0x9003,0xc,uVar9);
  memcpy(pvVar4,*(void **)(param_1 + 8),uVar9 * 0xc);
  pvVar4 = (void *)rtcSetNewGeometryBuffer(uVar2,2,0,0x9002,8,uVar9);
  memcpy(pvVar4,*(void **)(param_3 + 8),uVar9 * 8);
  puVar5 = (undefined4 *)rtcSetNewGeometryBuffer(uVar2,0,0,0x5003,0xc,(long)(iVar1 / 3));
  if (0 < iVar1) {
    uVar7 = 0;
    if ((uVar9 & 1) != 0) {
      *puVar5 = 0;
      uVar7 = 1;
      if (uVar9 == 1) goto LAB_001001f3;
    }
    do {
      puVar5[uVar7] = (int)uVar7;
      lVar8 = uVar7 + 1;
      uVar7 = uVar7 + 2;
      puVar5[lVar8] = (int)lVar8;
    } while (uVar9 != uVar7);
  }
LAB_001001f3:
  if (*(long *)(param_2 + 8) != 0) {
    pvVar4 = (void *)rtcSetNewGeometryBuffer(uVar2,2,1,0x9003,0xc,uVar9);
    memcpy(pvVar4,*(void **)(param_2 + 8),uVar9 * 0xc);
  }
...

{
  ...
  if (*(long *)(param_1 + 8) == 0) goto LAB_001006e0;
  if (*(ulong *)(*(long *)(param_1 + 8) + -0x10) < 2) {
LAB_00100641:
    __dest = *(undefined8 **)(param_1 + 8);
    if (__dest == (undefined8 *)0x0) goto LAB_001006e0;
  }
  else {
    if (*(long *)(param_1 + 8) == 0) {
...

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_001041a8;
  ...
  if (pvVar5 != (void *)0x0) {
    if (*(int *)(this + 0x1bc) != 0) {
      ...
      if (uVar2 == 0) {
        ...
        *(undefined4 *)(this + 0x1bc) = 0;
        *(undefined1 (*) [16])(this + 0x1a8) = (undefined1  [16])0x0;
        if (pvVar5 == (void *)0x0) goto LAB_001009fb;
      }
    }
    Memory::free_static(pvVar5,false);
...
LAB_001009fb:
  *(undefined ***)this = &PTR__initialize_classv_00104048;
...
LAB_00100da5:
  ...
  if (-1 < iVar6) goto LAB_00100ca2;
LAB_00100cad:
  lVar7 = (long)iVar4;
  if (-1 < lVar7) goto joined_r0x00100d83;
  if (lVar9 != 0) goto LAB_00100da5;
LAB_00100d89:
  lVar9 = 0;
LAB_00100da9:
    ...
    if (uVar15 != 0) {
      ...
      while ((uVar20 != uVar15 ||
        ...
        if ((uVar15 == 0) ||
           ...
           auVar13._0_8_ = uVar21, SUB164(auVar9 * auVar13,8) < uVar22)) goto LAB_001010e0;
      }
...

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  if (initialize_class()::initialized != '\0') goto LAB_001026ba;
...
LAB_00103907:
    ...
    uVar32 = *param_1;
    iVar40 = *(int *)(this + 0x2c);
    if (__s_00 != (void *)0x0) goto LAB_00103907;
  }
  else {
    iVar40 = *(int *)(this + 0x2c);
    if (iVar40 == 0) {
...

{
  ...
  if (__s_00 == (void *)0x0) {
    ...
    *(void **)(param_2 + 8) = __s_00;
    ...
    iVar25 = *(int *)(param_2 + 0x2c);
    local_b8 = *puVar26;
    if (__s_00 != (void *)0x0) goto LAB_00103a58;
  }
  else {
LAB_00103a4a:
    iVar25 = *(int *)(param_2 + 0x2c);
...
LAB_00103c77:
    ...
    if (puVar23 != (undefined8 *)0x0) goto LAB_00103c84;
LAB_00103e15:
    ...
    *plVar1 = *plVar1 + -1;
    UNLOCK();
    if (*plVar1 != 0) goto LAB_00103c77;
    Memory::free_static((void *)(local_58 + -0x10),false);
    puVar23 = *(undefined8 **)(param_2 + 0x20);
    if (puVar23 == (undefined8 *)0x0) goto LAB_00103e15;
LAB_00103c84:
    if (in_R8B == '\0') {
      *puVar23 = pauStack_90;

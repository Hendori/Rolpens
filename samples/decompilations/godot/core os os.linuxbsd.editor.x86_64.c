...
/* OS::get_unix_time() const */

undefined8 OS::get_unix_time(void)
...
/* OS::set_low_processor_usage_mode(bool) */

void __thiscall OS::set_low_processor_usage_mode(OS *this,bool param_1)
...
/* OS::is_in_low_processor_usage_mode() const */

OS __thiscall OS::is_in_low_processor_usage_mode(OS *this)
...
/* OS::set_low_processor_usage_mode_sleep_usec(int) */

void __thiscall OS::set_low_processor_usage_mode_sleep_usec(OS *this,int param_1)
...
/* OS::get_low_processor_usage_mode_sleep_usec() const */

undefined4 __thiscall OS::get_low_processor_usage_mode_sleep_usec(OS *this)
...
/* OS::get_process_id() const */

undefined8 OS::get_process_id(void)
...
/* OS::get_exit_code() const */

undefined4 __thiscall OS::get_exit_code(OS *this)
...
/* OS::set_exit_code(int) */

void __thiscall OS::set_exit_code(OS *this,int param_1)
...
/* OS::get_embedded_pck_offset() const */

undefined8 OS::get_embedded_pck_offset(void)
...
/* OS::calculate_boot_screen_rect(Vector2 const&, Vector2 const&) const */

undefined1  [16] __thiscall
OS::calculate_boot_screen_rect(OS *this,Vector2 *param_1,Vector2 *param_2)
...
/* OS::get_bundle_icon_path() const */

OS * __thiscall OS::get_bundle_icon_path(OS *this)
...
/* OS::shell_open(String const&) */

undefined8 OS::shell_open(String *param_1)
...
/* OS::set_cwd(String const&) */

undefined8 OS::set_cwd(String *param_1)
...
/* OS::is_sandboxed() const */

undefined8 OS::is_sandboxed(void)
...
/* OS::get_preferred_texture_format() const */

undefined8 OS::get_preferred_texture_format(void)
...
/* OS::get_resource_dir() const */

OS * __thiscall OS::get_resource_dir(OS *this)
...
/* OS::get_static_memory_usage() const */

void OS::get_static_memory_usage(void)
...
/* OS::get_static_memory_peak_usage() const */

void OS::get_static_memory_peak_usage(void)
...
/* OS::get_processor_count() const */

void OS::get_processor_count(void)
...
/* OS::setup_remote_filesystem(String const&, int, String const&, String&) */

void OS::setup_remote_filesystem(String *param_1,int param_2,String *param_3,String *param_4)
...
/* CowData<Logger*>::_copy_on_write() [clone .isra.0] */

void __thiscall CowData<Logger*>::_copy_on_write(CowData<Logger*> *this)
...
/* OS::add_frame_delay(bool) */

void __thiscall OS::add_frame_delay(OS *this,bool param_1)

{
  ...
  if ((OVar1 == (OS)0x1) || (!param_1)) {
    ...
    if ((iVar2 < 1) || (lVar5 = Engine::get_singleton(), *(char *)(lVar5 + 0xc0) != '\0'))
    goto LAB_001003ae;
  }
  else {
    plVar3 = (long *)Engine::get_singleton();
...
/* OS::alert(String const&, String const&) */

void OS::alert(String *param_1,String *param_2)
...
/* OS::get_memory_info() const */

OS * __thiscall OS::get_memory_info(OS *this)
...
/* OS::get_system_dir(OS::SystemDir, bool) const */

StrRange * OS::get_system_dir(StrRange *param_1)
...
/* OS::get_unique_id() const */

OS * __thiscall OS::get_unique_id(OS *this)
...
/* OS::get_config_path() const */

OS * __thiscall OS::get_config_path(OS *this)
...
/* OS::get_processor_name() const */

OS * __thiscall OS::get_processor_name(OS *this)
...
OS * __thiscall OS::get_locale(OS *this)
...
/* OS::get_user_data_dir(String const&) const */

String * OS::get_user_data_dir(String *param_1)
...
/* OS::get_model_name() const */

OS * __thiscall OS::get_model_name(OS *this)
...
/* OS::get_identifier() const */

void OS::get_identifier(void)
...
/* OS::get_godot_dir_name() const */

OS * __thiscall OS::get_godot_dir_name(OS *this)
...
/* OS::get_executable_path() const */

void OS::get_executable_path(void)
...
/* OS::shell_show_in_file_manager(String, bool) */

undefined8 OS::shell_show_in_file_manager(long *param_1,String *param_2)
...
undefined8 OS::get_singleton(void)
...
ulong __thiscall OS::get_ticks_msec(OS *this)
...
/* OS::_set_logger(CompositeLogger*) */

void __thiscall OS::_set_logger(OS *this,CompositeLogger *param_1)
...
/* OS::print_rich(char const*, ...) */

void OS::print_rich(char *param_1,...)
...
/* OS::printerr(char const*, ...) */

void OS::printerr(char *param_1,...)
...
/* OS::set_delta_smoothing(bool) */

void __thiscall OS::set_delta_smoothing(OS *this,bool param_1)
...
/* OS::is_delta_smoothing_enabled() const */

OS __thiscall OS::is_delta_smoothing_enabled(OS *this)
...
/* OS::is_stdout_verbose() const */

OS __thiscall OS::is_stdout_verbose(OS *this)
...
/* OS::is_stdout_debug_enabled() const */

OS __thiscall OS::is_stdout_debug_enabled(OS *this)
...
/* OS::is_stdout_enabled() const */

OS __thiscall OS::is_stdout_enabled(OS *this)
...
/* OS::is_stderr_enabled() const */

OS __thiscall OS::is_stderr_enabled(OS *this)
...
/* OS::set_stdout_enabled(bool) */

void __thiscall OS::set_stdout_enabled(OS *this,bool param_1)
...
/* OS::set_stderr_enabled(bool) */

void __thiscall OS::set_stderr_enabled(OS *this,bool param_1)
...
/* OS::get_locale_language() const */

void OS::get_locale_language(void)
...
void __thiscall OS::create_lock_file(OS *this)
...
void __thiscall OS::remove_lock_file(OS *this)
...
/* OS::set_has_server_feature_callback(bool (*)(String const&)) */

void __thiscall OS::set_has_server_feature_callback(OS *this,_func_bool_String_ptr *param_1)
...
/* OS::has_feature(String const&) */

ulong __thiscall OS::has_feature(OS *this,String *param_1)
...
LAB_001018ee:
    cVar4 = String::operator==(param_1,"movie");
    if (cVar4 != '\0') {
...
/* OS::set_restart_on_exit(bool, List<String, DefaultAllocator> const&) */

void __thiscall OS::set_restart_on_exit(OS *this,bool param_1,List *param_2)
...
LAB_00101b60:
  if ((*(long **)param_2 != (long *)0x0) &&
     (pCVar6 = (CowData *)**(long **)param_2, pCVar6 != (CowData *)0x0)) {
    if (plVar7 == (long *)0x0) {
...
/* OS::is_restart_on_exit_set() const */

OS __thiscall OS::is_restart_on_exit_set(OS *this)
...
/* OS::get_restart_on_exit_arguments() const */

void OS::get_restart_on_exit_arguments(void)
...
/* OS::set_use_benchmark(bool) */

void __thiscall OS::set_use_benchmark(OS *this,bool param_1)
...
/* OS::is_use_benchmark_set() */

OS __thiscall OS::is_use_benchmark_set(OS *this)
...
/* OS::set_benchmark_file(String const&) */

void __thiscall OS::set_benchmark_file(OS *this,String *param_1)
...
/* OS::get_benchmark_file() */

void OS::get_benchmark_file(void)
...
void OS::close_midi_inputs(void)
...
OS * __thiscall OS::get_connected_midi_inputs(OS *this)

{
  ...
  if (lVar3 == 0) {
    ...
    _err_print_error("get_connected_midi_inputs","core/os/os.cpp",0x27a,
                     "Method/function failed. Returning: list",&local_48,0,0);
    pcVar2 = local_48;
...
void __thiscall OS::ensure_user_data_dir(OS *this)
...
LAB_00102950:
      ...
      _err_print_error("ensure_user_data_dir","core/os/os.cpp",0x19a,
                       "Condition \"err != OK\" is true.",&local_38,0,0);
      pcVar3 = local_38;
      if (local_38 != (char *)0x0) {
        LOCK();
        plVar1 = (long *)(local_38 + -0x10);
...
/* OS::set_cmdline(char const*, List<String, DefaultAllocator> const&, List<String,
   DefaultAllocator> const&) */

void __thiscall OS::set_cmdline(OS *this,char *param_1,List *param_2,List *param_3)
...
/* OS::benchmark_begin_measure(String const&, String const&) */

void __thiscall OS::benchmark_begin_measure(OS *this,String *param_1,String *param_2)
    ...
    if (uVar23 != 0) {
      ...
      do {
        if ((uint)uVar24 == uVar23) {
          ...
          if ((cVar14 != '\0') &&
             (cVar14 = String::operator==((String *)(lVar20 + 0x18),(String *)&local_60),
             cVar14 != '\0')) {
            local_70 = 0;
        ...
        iVar21 = SUB164(auVar5 * auVar9,8);
              ...
              (auVar6._8_8_ = 0, auVar6._0_8_ = (ulong)uVar23 * lVar3, auVar10._8_8_ = 0,
              auVar10._0_8_ = uVar12, auVar7._8_8_ = 0,
              auVar7._0_8_ = (ulong)((uVar2 + iVar21) - SUB164(auVar6 * auVar10,8)) * lVar3,
              auVar11._8_8_ = 0, auVar11._0_8_ = uVar12, uVar25 <= SUB164(auVar7 * auVar11,8)));
    }
  }
  uVar18 = (**(code **)(*singleton + 0x208))();
  puVar19 = (undefined8 *)
            HashMap<Pair<String,String>,unsigned_long,PairHash<String,String>,HashMapComparatorDefault<Pair<String,String>>,DefaultTypedAllocator<HashMapElement<Pair<String,String>,unsigned_long>>>
            ::operator[]((HashMap<Pair<String,String>,unsigned_long,PairHash<String,String>,HashMapComparatorDefault<Pair<String,String>>,DefaultTypedAllocator<HashMapElement<Pair<String,String>,unsigned_long>>>
                          *)(this + 0xc0),(Pair *)local_c0);
  *puVar19 = uVar18;
LAB_00102dc5:
  lVar3 = local_60;
  if (local_60 != 0) {
...
LAB_00102ee0:
  ...
  _err_print_error("benchmark_begin_measure","core/os/os.cpp",0x2d1,
                   "Condition \"benchmark_marks_from.has(mark_key)\" is true.",&local_58,0,0);
  pcVar13 = local_58;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* OS::benchmark_end_measure(String const&, String const&) */

void __thiscall OS::benchmark_end_measure(OS *this,String *param_1,String *param_2)
    ...
    if (uVar23 != 0) {
      ...
      do {
        if ((uint)uVar24 == uVar23) {
          ...
          if ((cVar12 != '\0') &&
             (cVar12 = String::operator==((String *)(lVar16 + 0x18),(String *)&local_60),
             cVar12 != '\0')) {
            lVar17 = (**(code **)(*singleton + 0x208))();
            plVar18 = (long *)HashMap<Pair<String,String>,unsigned_long,PairHash<String,String>,HashMapComparatorDefault<Pair<String,String>>,DefaultTypedAllocator<HashMapElement<Pair<String,String>,unsigned_long>>>
                              ::operator[]((HashMap<Pair<String,String>,unsigned_long,PairHash<String,String>,HashMapComparatorDefault<Pair<String,String>>,DefaultTypedAllocator<HashMapElement<Pair<String,String>,unsigned_long>>>
                                            *)(this + 0xc0),(Pair *)&local_68);
            dVar26 = (double)(ulong)(lVar17 - *plVar18) / __LC64;
            pdVar19 = (double *)
                      HashMap<Pair<String,String>,double,PairHash<String,String>,HashMapComparatorDefault<Pair<String,String>>,DefaultTypedAllocator<HashMapElement<Pair<String,String>,double>>>
                      ::operator[]((HashMap<Pair<String,String>,double,PairHash<String,String>,HashMapComparatorDefault<Pair<String,String>>,DefaultTypedAllocator<HashMapElement<Pair<String,String>,double>>>
                                    *)(this + 0xf0),(Pair *)&local_68);
            *pdVar19 = dVar26;
            lVar17 = local_60;
        ...
        iVar20 = SUB164(auVar3 * auVar7,8);
              ...
              (auVar4._8_8_ = 0, auVar4._0_8_ = (ulong)uVar23 * lVar17, auVar8._8_8_ = 0,
              auVar8._0_8_ = uVar10, auVar5._8_8_ = 0,
              auVar5._0_8_ = (ulong)((uVar1 + iVar20) - SUB164(auVar4 * auVar8,8)) * lVar17,
              auVar9._8_8_ = 0, auVar9._0_8_ = uVar10, uVar22 <= SUB164(auVar5 * auVar9,8)));
    }
  }
  local_70 = 0;
...
LAB_00103388:
  ...
  String::parse_latin1((StrRange *)&local_80);
  vformat<String,String>(&local_58,(StrRange *)&local_80,&local_78,&local_70);
  _err_print_error("benchmark_end_measure","core/os/os.cpp",0x2d9,
                   "Condition \"!benchmark_marks_from.has(mark_key)\" is true.",&local_58,0,0);
  pcVar11 = local_58;
  if (local_58 != (char *)0x0) {
    LOCK();
...
/* OS::get_safe_dir_name(String const&, bool) const */

String * OS::get_safe_dir_name(String *param_1,bool param_2)
...
/* OS::get_user_data_dir() const */

void OS::get_user_data_dir(void)
  ...
  if ((local_98 == 0) || (*(uint *)(local_98 + -8) < 2)) {
    ...
    if (bVar6) {
      ...
      StringName::StringName
                ((StringName *)&local_70,"application/config/custom_user_dir_name",false);
      ProjectSettings::get_setting_with_override((StringName *)local_58);
      Variant::operator_cast_to_String((Variant *)&local_68);
...
/* OS::benchmark_dump() [clone .part.0] */

void __thiscall OS::benchmark_dump(OS *this)
        ...
        if (cVar18 != '\0') {
          ...
          if ((local_a0._0_8_ != 0) && (local_80._4_4_ != 0)) {
            ...
            if (uVar19 != 0) {
              ...
              do {
                if ((uVar22 == uVar19) &&
                   (cVar18 = String::operator==((String *)(*(long *)(uVar16 + lVar24 * 8) + 0x10),
                                                pSVar20), cVar18 != '\0')) goto LAB_00104768;
                uVar27 = uVar27 + 1;
                auVar6._8_8_ = 0;
                ...
                iVar23 = SUB164(auVar6 * auVar10,8);
                      ...
                      (auVar7._8_8_ = 0, auVar7._0_8_ = (ulong)uVar19 * lVar26, auVar11._8_8_ = 0,
                      auVar11._0_8_ = uVar13, auVar8._8_8_ = 0,
                      auVar8._0_8_ = (ulong)((uVar3 + iVar23) - SUB164(auVar7 * auVar11,8)) * lVar26
                      , auVar12._8_8_ = 0, auVar12._0_8_ = uVar13,
          ...
          ::insert((String *)&local_b8,(String *)&local_a8,SUB81(pSVar20,0));
          lVar26 = local_c0;
          if (local_c0 != 0) {
            LOCK();
...
LAB_001047ad:
        ...
        vformat<String,double>
                  (dVar33,(String *)&local_b8,(StrRange *)&local_c8,(StrRange *)&local_c0);
        pSVar20 = (String *)
                  HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>
...
LAB_00104ba0:
    ...
    if ((void *)local_a0._0_8_ != (void *)0x0) {
      ...
      if ((local_80._4_4_ != 0) &&
         (uVar3 = *(uint *)(hash_table_size_primes + (local_80 & 0xffffffff) * 4), uVar3 != 0)) {
        lVar26 = 0;
        do {
...
LAB_00104f58:
      ...
      *(undefined1 (*) [16])(this_00 + 0x250) = (undefined1  [16])0x0;
      ...
      if (((pRVar28 != (Resource *)0x0) && (cVar18 = RefCounted::unreference(), cVar18 != '\0')) &&
         (cVar18 = predelete_handler((Object *)pRVar28), cVar18 != '\0')) {
        (**(code **)(*(long *)pRVar28 + 0x140))(pRVar28);
        Memory::free_static(pRVar28,false);
      }
      Dictionary::~Dictionary((Dictionary *)&local_d0);
      if (((local_d8 != (Object *)0x0) &&
          (cVar18 = RefCounted::unreference(), pOVar14 = local_d8, cVar18 != '\0')) &&
         (cVar18 = predelete_handler(local_d8), cVar18 != '\0')) {
...
/* Vector<Logger*>::push_back(Logger*) [clone .isra.0] */

void __thiscall Vector<Logger*>::push_back(Vector<Logger*> *this,Logger *param_1)
...
void __thiscall OS::add_logger(OS *this,Logger *param_1)
...
/* OS::get_user_prefers_integrated_gpu() const */

undefined8 OS::get_user_prefers_integrated_gpu(void)
...
/* OS::get_stdin_type() const */

undefined8 OS::get_stdin_type(void)
...
/* OS::get_stdout_type() const */

undefined8 OS::get_stdout_type(void)
...
/* OS::get_stderr_type() const */

undefined8 OS::get_stderr_type(void)
...
String * OS::get_system_font_path_for_text
                   (String *param_1,String *param_2,String *param_3,String *param_4,int param_5,
...
/* OS::vibrate_handheld(int, float) */

void OS::vibrate_handheld(int param_1,float param_2)
...
/* OS::get_version_alias() const */

void OS::get_version_alias(void)
...
/* OS::get_cmdline_platform_args() const */

OS * __thiscall OS::get_cmdline_platform_args(OS *this)
...
/* OS::is_userfs_persistent() const */

undefined8 OS::is_userfs_persistent(void)
...
/* OS::set_crash_handler_silent() */

void __thiscall OS::set_crash_handler_silent(OS *this)
...
/* OS::is_crash_handler_silent() */

OS __thiscall OS::is_crash_handler_silent(OS *this)
...
void OS::disable_crash_handler(void)
...
/* OS::is_disable_crash_handler() const */

undefined8 OS::is_disable_crash_handler(void)
...
/* OS::request_permission(String const&) */

undefined8 OS::request_permission(String *param_1)
...
undefined8 OS::request_permissions(void)
...
/* OS::get_granted_permissions() const */

OS * __thiscall OS::get_granted_permissions(OS *this)
...
void OS::revoke_granted_permissions(void)
...
/* OS::_test_create_rendering_device_and_gl(String const&) const */

undefined8 OS::_test_create_rendering_device_and_gl(String *param_1)
...
/* OS::_test_create_rendering_device(String const&) const */

undefined8 OS::_test_create_rendering_device(String *param_1)
...
{
  return (uint)CONCAT71(0x10bd,(undefined4 *)param_1 == &Resource::get_class_ptr_static()::ptr) |
...
/* OS::execute_with_pipe(String const&, List<String, DefaultAllocator> const&, bool) */

String * OS::execute_with_pipe(String *param_1,List *param_2,bool param_3)
...
/* CowData<Logger*>::_copy_on_write() [clone .isra.0] [clone .cold] */

void CowData<Logger*>::_copy_on_write(void)
...
/* OS::get_cmdline_user_args() const */

void OS::get_cmdline_user_args(void)
...
/* WARNING: Removing unreachable block (ram,0x00108068) */
/* WARNING: Removing unreachable block (ram,0x00108230) */
/* WARNING: Removing unreachable block (ram,0x00108074) */
/* WARNING: Removing unreachable block (ram,0x0010807e) */
/* WARNING: Removing unreachable block (ram,0x00108210) */
/* WARNING: Removing unreachable block (ram,0x0010808a) */
/* WARNING: Removing unreachable block (ram,0x00108094) */
/* WARNING: Removing unreachable block (ram,0x001081f0) */
/* WARNING: Removing unreachable block (ram,0x001080a0) */
/* WARNING: Removing unreachable block (ram,0x001080aa) */
/* WARNING: Removing unreachable block (ram,0x001081d0) */
/* WARNING: Removing unreachable block (ram,0x001080b6) */
/* WARNING: Removing unreachable block (ram,0x001080c0) */
/* WARNING: Removing unreachable block (ram,0x001081b0) */
/* WARNING: Removing unreachable block (ram,0x001080cc) */
/* WARNING: Removing unreachable block (ram,0x001080d6) */
/* WARNING: Removing unreachable block (ram,0x00108190) */
/* WARNING: Removing unreachable block (ram,0x001080e2) */
/* WARNING: Removing unreachable block (ram,0x001080ec) */
/* WARNING: Removing unreachable block (ram,0x00108170) */
/* WARNING: Removing unreachable block (ram,0x001080f4) */
/* WARNING: Removing unreachable block (ram,0x0010810a) */
/* WARNING: Removing unreachable block (ram,0x00108116) */
...
void __thiscall
List<String,DefaultAllocator>::operator=(List<String,DefaultAllocator> *this,List *param_1)
...
/* WARNING: Removing unreachable block (ram,0x001086bc) */
/* WARNING: Removing unreachable block (ram,0x001086c6) */
/* WARNING: Removing unreachable block (ram,0x0010880b) */
/* WARNING: Removing unreachable block (ram,0x001086d2) */
/* WARNING: Removing unreachable block (ram,0x001086dc) */
/* WARNING: Removing unreachable block (ram,0x001087ed) */
/* WARNING: Removing unreachable block (ram,0x001086e8) */
/* WARNING: Removing unreachable block (ram,0x001086f2) */
/* WARNING: Removing unreachable block (ram,0x001087cf) */
/* WARNING: Removing unreachable block (ram,0x001086fe) */
/* WARNING: Removing unreachable block (ram,0x00108708) */
/* WARNING: Removing unreachable block (ram,0x001087b1) */
/* WARNING: Removing unreachable block (ram,0x00108714) */
/* WARNING: Removing unreachable block (ram,0x0010871e) */
/* WARNING: Removing unreachable block (ram,0x00108793) */
/* WARNING: Removing unreachable block (ram,0x00108726) */
/* WARNING: Removing unreachable block (ram,0x00108730) */
/* WARNING: Removing unreachable block (ram,0x00108778) */
/* WARNING: Removing unreachable block (ram,0x00108738) */
/* WARNING: Removing unreachable block (ram,0x0010874e) */
/* WARNING: Removing unreachable block (ram,0x0010875a) */
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* HashMap<Pair<String, String>, unsigned long, PairHash<String, String>,
        ...
        if (uVar53 != 0) {
          do {
            ...
            uVar52 = SUB164(auVar17 * auVar33,8);
                  ...
                  (auVar18._8_8_ = 0, auVar18._0_8_ = (ulong)uVar53 * lVar48, auVar34._8_8_ = 0,
                  auVar34._0_8_ = uVar57, auVar19._8_8_ = 0,
                  auVar19._0_8_ = (ulong)((uVar50 + uVar52) - SUB164(auVar18 * auVar34,8)) * lVar48,
                  auVar35._8_8_ = 0, auVar35._0_8_ = uVar57, uVar51 <= SUB164(auVar19 * auVar35,8)))
          ;
        }
        iVar44 = *(int *)(this + 0x2c);
      }
      ...
      if (uVar53 != 0) {
        do {
          ...
          uVar52 = SUB164(auVar13 * auVar29,8);
                ...
                (auVar14._8_8_ = 0, auVar14._0_8_ = (ulong)uVar53 * lVar48, auVar30._8_8_ = 0,
                auVar30._0_8_ = uVar39, auVar15._8_8_ = 0,
                auVar15._0_8_ = (ulong)((uVar52 + uVar55) - SUB164(auVar14 * auVar30,8)) * lVar48,
...
LAB_00108968:
    if ((float)uVar39 * __LC55 < (float)(iVar44 + 1)) goto LAB_0010898e;
  }
  local_58 = 0;
  if (*(long *)param_1 != 0) {
  ...
  local_48 = 0;
  puVar41 = (undefined8 *)operator_new(0x28,"");
  lVar56 = local_58;
  puVar41[2] = 0;
  *puVar41 = 0;
  puVar41[1] = 0;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* HashMap<Pair<String, String>, double, PairHash<String, String>,
   HashMapComparatorDefault<Pair<String, String> >,
...
LAB_00109368:
    if ((float)uVar39 * __LC55 < (float)(iVar44 + 1)) goto LAB_0010938e;
  }
  local_58 = 0;
  if (*(long *)param_1 != 0) {
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)param_1);
...
/* WARNING: Removing unreachable block (ram,0x0010a111) */
/* WARNING: Removing unreachable block (ram,0x00109fa4) */
/* WARNING: Removing unreachable block (ram,0x00109fae) */
/* WARNING: Removing unreachable block (ram,0x0010a0f3) */
/* WARNING: Removing unreachable block (ram,0x00109fba) */
/* WARNING: Removing unreachable block (ram,0x00109fc4) */
/* WARNING: Removing unreachable block (ram,0x0010a0d5) */
/* WARNING: Removing unreachable block (ram,0x00109fd0) */
/* WARNING: Removing unreachable block (ram,0x00109fda) */
/* WARNING: Removing unreachable block (ram,0x0010a0b7) */
/* WARNING: Removing unreachable block (ram,0x00109fe6) */
/* WARNING: Removing unreachable block (ram,0x00109ff0) */
/* WARNING: Removing unreachable block (ram,0x0010a099) */
/* WARNING: Removing unreachable block (ram,0x00109ffc) */
/* WARNING: Removing unreachable block (ram,0x0010a006) */
/* WARNING: Removing unreachable block (ram,0x0010a07b) */
/* WARNING: Removing unreachable block (ram,0x0010a00e) */
/* WARNING: Removing unreachable block (ram,0x0010a018) */
/* WARNING: Removing unreachable block (ram,0x0010a060) */
/* WARNING: Removing unreachable block (ram,0x0010a020) */
/* WARNING: Removing unreachable block (ram,0x0010a036) */
/* WARNING: Removing unreachable block (ram,0x0010a042) */
/* String vformat<String, double>(String const&, String const, double const) */

undefined8 *
vformat<String,double>(double param_1_00,undefined8 *param_1,bool *param_3,String *param_4)
...
LAB_0010a88f:
    if ((float)uVar23 * __LC55 < (float)(iVar24 + 1)) goto LAB_0010a8b1;
  }
  local_58 = 0;
  if (*(long *)pSVar26 != 0) {
...
LAB_0010ae6a:
    ...
    iVar33 = 0;
LAB_0010ae48:
    if ((float)uVar36 * __LC55 < (float)(iVar33 + 1)) goto LAB_0010ae6a;
  }
  local_58[0] = 0;
...
/* CowData<Logger*>::_realloc(long) */

undefined8 __thiscall CowData<Logger*>::_realloc(CowData<Logger*> *this,long param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Error CowData<Logger*>::resize<false>(long) */

undefined8 __thiscall CowData<Logger*>::resize<false>(CowData<Logger*> *this,long param_1)

      ...
      do {
        ...
        if ((((uVar23 & 0xfffffffe) == 4) == (bool)((byte)~(byte)uVar15 >> 7)) &&
          ...
          if (puVar20[1] < 0x7000000) {
            ...
            (*(code *)(&DAT_00113980 + *(int *)(&DAT_00113980 + (ulong)(puVar20[1] >> 0x18) * 4)))
                      (&DAT_00113980,uVar25 & 0xffffffff,
                       &DAT_00113980 + *(int *)(&DAT_00113980 + (ulong)(puVar20[1] >> 0x18) * 4));
            return;
          }
...
LAB_0010343d:
        if (param_3 == uVar13) goto LAB_00102f70;
LAB_00103446:
...
LAB_001031dd:
        if (uVar13 == param_3) goto LAB_00102f70;
        uVar10 = (ulong)(param_3 - 1);
        uVar7 = (ulong)uVar13;
        uVar11 = *(uint *)(lVar4 + 8 + uVar7 * 0x14);
        uVar15 = *(uint *)(lVar4 + 8 + uVar10 * 0x14);
      ...
      if (pLVar9 + (6 - *(long *)(param_1 + 8)) <= (LigGlyph *)(ulong)*(uint *)(param_1 + 0x18)) {
        ...
        if ((ushort)((uVar5 << 8 | uVar5 >> 8) - 1) < 3) {
          ...
          if ((((LigGlyph *)(ulong)*(uint *)(param_1 + 0x18) < pLVar9 + -*(long *)(param_1 + 8)) ||
             ...
             (int)(iVar6 - uVar7) < 1)) goto LAB_00104620;
        }
        goto LAB_001044f0;
      }
LAB_00104620:
...
LAB_001049c2:
                if ((uVar4 * 2 <= (uint)((int)*(undefined8 *)(param_1 + 0x10) - ((int)pMVar5 + 4)))
                   && (iVar3 = *(int *)(param_1 + 0x1c) + uVar4 * -2,
                      *(int *)(param_1 + 0x1c) = iVar3, 0 < iVar3)) goto LAB_00104940;
              }
            }
            else {
...
LAB_001055f9:
      ...
      if ((((ulong)((long)pGVar8 - *(long *)(param_1 + 8)) <= (ulong)*(uint *)(param_1 + 0x18)) &&
         ...
         uVar3 <= (uint)((int)*(undefined8 *)(param_1 + 0x10) - (int)pGVar8))) goto LAB_001055f9;
    }
  }
  if (0x1f < *(uint *)(param_1 + 0x2c)) {
    return 0;
          ...
          if ((int)uVar11 <= (int)uVar16) {
            while( true ) {
              ...
              if (((uVar9 != 0) || (pSVar12 = pSVar21 + -lVar2, pSVar24 < pSVar12)) ||
                 ...
                 (uint)pSVar12 < (uint)uVar4)) goto LAB_00105698;
              ...
              *(uint *)(param_1 + 0x1c) = uVar9;
              ...
              do {
                ...
                if ((pSVar24 < pSVar15 + -lVar2) ||
                   ...
                   (uint)pSVar12 < (uint)(iVar6 * 4))) goto LAB_00105698;
                ...
                *(int *)(param_1 + 0x1c) = iVar6;
                ...
                if (((uVar10 != 0) ||
                   ...
                   || ((uint)((int)lVar3 - (int)pSVar12) < uVar9)) goto LAB_00105698;
...
LAB_00106abc:
  paVar18 = (accelerator_t *)&_hb_NullPool;
LAB_00106683:
  puVar15 = *(undefined **)paVar18;
...
LAB_00106ada:
  paVar18 = (accelerator_t *)&_hb_NullPool;
LAB_001066c1:
  psVar9 = *(short **)(this + 0xf0);
  *(accelerator_t **)(this + 0xf8) = paVar18;
  if (((*psVar9 == 0x100) && (0x10002 < (ushort)(psVar9[1] << 8 | (ushort)psVar9[1] >> 8) + 0x10000)
      ) && (uVar5 = *(uint *)(psVar9 + 7), uVar5 != 0)) {
    puVar15 = (undefined *)
              ((long)psVar9 +
  ...
  *(undefined **)(this + 0x100) = puVar15;
  if ((iVar6 == 1) && (*(int *)(*(long *)(this + 0x90) + 0x78) != 0)) {
    ...
    puVar19 = &_hb_NullPool;
    if (uVar5 != 0) {
      puVar19 = puVar15 + (uVar5 >> 0x18 | (uVar5 & 0xff0000) >> 8 | (uVar5 & 0xff00) << 8 |
                          uVar5 << 0x18);
    }
...
LAB_0010785b:
    ...
    if ((((uint)((int)local_58 - (int)psVar2) < uVar4) ||
        (local_4c = local_4c - uVar4, (int)local_4c < 1)) || (local_50 < 8)) goto LAB_001076f8;
    uVar1 = *(uint *)(psVar2 + 2);
    if ((uVar1 == 0) ||
       (cVar3 = AAT::
                Lookup<OT::OffsetTo<OT::ArrayOf<AAT::Anchor,OT::IntType<unsigned_int,4u>>,OT::IntType<unsigned_short,2u>,void,false>>
              ...
              *(uint *)(param_1 + 0x1c) = uVar9;
              ...
              do {
                ...
                *(int *)(param_1 + 0x1c) = iVar6;
                ...
                if (((uVar10 != 0) ||
                    (pSVar12 = pSVar21 + (uVar7 * uVar18 & 0xffffffff), pSVar24 < pSVar12 + -lVar2))
                   || ((uint)((int)lVar3 - (int)pSVar12) < uVar9)) goto LAB_00109488;
                iVar6 = *(int *)(param_1 + 0x1c) - uVar9;
                if (iVar6 < 1) {
                  *(int *)(param_1 + 0x1c) = iVar6;
                  goto LAB_00109488;
              ...
              *(uint *)(param_1 + 0x1c) = uVar9;
              ...
              do {
                ...
                *(int *)(param_1 + 0x1c) = iVar6;
                ...
                if (((uVar10 != 0) ||
                    (pSVar12 = pSVar21 + (uVar7 * uVar18 & 0xffffffff), pSVar24 < pSVar12 + -lVar2))
                   || ((uint)((int)lVar3 - (int)pSVar12) < uVar9)) goto LAB_001097c8;
                iVar6 = *(int *)(param_1 + 0x1c) - uVar9;
                if (iVar6 < 1) {
                  *(int *)(param_1 + 0x1c) = iVar6;
                  goto LAB_001097c8;
            ...
            if (uVar24 != 0) {
              ...
              if ((((int)uVar24 < 0) ||
                  ...
                  (ulong)*(uint *)(lVar7 + 0x40) < (ulong)((long)puVar25 - *(long *)(lVar7 + 0x30)))
                        ...
                        *(int *)(lVar7 + 0x44) = iVar16, iVar16 < 1)))) goto LAB_00109c4b;
                  ...
                  if (uVar8 != 0) {
                    ...
                    do {
                      ...
                      if ((uVar1 >> 0x18 | (uVar1 & 0xff0000) >> 8 | (uVar1 & 0xff00) << 8 |
                        ...
                        if ((ulong)*(uint *)(param_1 + 0x18) <
                            (ulong)((long)pCVar6 - *(long *)(param_1 + 8))) goto LAB_0010a6f8;
                        uVar1 = *(uint *)(pCVar6 + -4);
                        if ((((ulong)*(uint *)(param_1 + 0x18) <
                            ...
                            ((uint)((int)*(undefined8 *)(param_1 + 0x10) -
                                 ...
                                 *(int *)(param_1 + 0x1c) = iVar11, iVar11 < 1)) goto LAB_0010a6f8;
                      }
                      pCVar6 = pCVar6 + 4;
  ...
  *(undefined8 *)this = 0;
  ...
  do {
    ...
    if ((uVar4 != 0) &&
      ...
      if (uVar11 == 0) {
LAB_0010ac20:
        if (local_5c == 0) goto LAB_0010ac31;
        local_5c = 0;
...
/* WARNING: Removing unreachable block (ram,0x0010b014) */
/* WARNING: Removing unreachable block (ram,0x0010b01b) */
/* WARNING: Removing unreachable block (ram,0x0010b03a) */
/* WARNING: Removing unreachable block (ram,0x0010b0c0) */
/* WARNING: Removing unreachable block (ram,0x0010b0e2) */
/* WARNING: Removing unreachable block (ram,0x0010b10a) */
...
LAB_0010b1cc:
          if ((uVar20 != 3) || (uVar17 != 3)) goto LAB_0010b1f3;
          uVar18 = 1;
          uVar20 = 0x25;
        } while( true );
      }
...
LAB_0010caa0:
      ...
      if ((*(short *)((long)puVar10 + lVar16 + 4) != -1) ||
         (*(short *)((long)puVar10 + lVar16 + 6) != -1)) goto LAB_0010c6e1;
LAB_0010c6f9:
      ...
      if ((iVar26 != 0) && (((uVar4 & 0x4000) == 0 || (iVar9 != 0)))) {
        ...
        if (((uVar4 & 0x3fff) != 0 || uVar10 >> 8 != 0) ||
           ((uVar10 = *puVar1,
            ...
            || (((uVar4 ^ uVar18) & 0x4000) != 0)))) goto LAB_0010cf58;
      }
      uVar10 = *(ushort *)
                ((long)puVar15 +
...
LAB_0010d097:
          if ((int)uVar11 < 0) goto LAB_0010d0bb;
          puVar12 = puVar12 + 1;
        } while (uVar27 != 0);
...
LAB_0010d0d0:
    if ((uVar22 == uVar14) || (this_00[0x58] == (hb_buffer_t)0x0)) goto LAB_0010d2de;
    iVar26 = iVar9;
    if (((puVar16[1] & 0x40) == 0) ||
  ...
  if (((uVar18 & 0x3ff) == 0 && uVar1 >> 8 == 0) ||
    ...
    if ((iVar20 != 0) && (((uVar18 & 0x4000) == 0 || (iVar14 != 0)))) {
      ...
      if (((((uVar6 & 0x3ff) != 0 || puVar35[1] >> 8 != 0) &&
          ...
          (iVar14 != (int)((uint)(ushort)(*puVar35 << 8 | *puVar35 >> 8) - (uint)uVar31) /
                     (int)uVar24)) || (((uVar6 ^ uVar13) & 0x4000) != 0)) goto LAB_0010d844;
    }
    ...
    if (((uVar12 & 3) != 0 || uVar12 >> 8 != 0) &&
       ((*(short *)((long)puVar30 + lVar29 + 4) != -1 ||
        (*(short *)((long)puVar30 + lVar29 + 6) != -1)))) goto LAB_0010d844;
  }
  else {
LAB_0010d844:
    uVar24 = uVar15;
  ...
  if (((puVar21[1] & 0x40) == 0) ||
    ...
    if (this_00[0x5a] == (hb_buffer_t)0x0) {
      ...
      *(uint *)(this_00 + 0x5c) = uVar23 + 1;
      ...
      if ((*(long *)(this_00 + 0x78) != *(long *)(this_00 + 0x70)) ||
         (uVar23 != *(uint *)(this_00 + 100))) goto LAB_0010dd76;
      uVar23 = uVar23 + 1;
      uVar32 = (ulong)uVar23;
...
LAB_0010dc2c:
  if ((uint)uVar32 < uVar23) goto code_r0x0010dc35;
LAB_0010e000:
  uVar33 = 0;
  puVar30 = *(ushort **)this;
  goto LAB_0010d7b8;
...
joined_r0x0010de44:
  if (hVar11 == (hb_buffer_t)0x0) goto LAB_0010de50;
  uVar23 = *(uint *)(this_00 + 0x60);
    ...
    do {
      ...
      *(uint *)(param_1 + 0x18) = uVar5;
      ...
      if (((pKVar13 < this_01 + -lVar6) ||
         ...
         (int)(iVar9 - uVar5) < 1)) goto LAB_0010f940;
      switch(this_01[7]) {
  ...
  if (((puVar17[1] & 0x40) == 0) ||
    ...
    if (this_00[0x5a] == (hb_buffer_t)0x0) {
      ...
      *(uint *)(this_00 + 0x5c) = uVar14;
      ...
      if ((*(long *)(this_00 + 0x78) != *(long *)(this_00 + 0x70)) ||
         (uVar14 != *(uint *)(this_00 + 100))) goto LAB_001109f6;
      uVar14 = uVar14 + 1;
      *(uint *)(this_00 + 100) = uVar14;
      *(uint *)(this_00 + 0x5c) = uVar14;
    }
...
LAB_00110883:
  if (uVar14 < uVar28) goto code_r0x0011088b;
LAB_00110c88:
  uVar32 = 0;
  puVar15 = *(uint **)this;
  puVar22 = puVar21;
...
LAB_001122fa:
    if (uVar10 < uVar17) goto LAB_00112339;
LAB_001122fe:
    if ((uVar16 & *puVar14) != 0) {
      puVar15 = *(uint **)this;
      goto LAB_00112743;
...
LAB_001129d3:
    ...
    if ((uVar3 == 0xffff) || (iVar16 = *(int *)(param_1 + 0x38), iVar16 == 0)) goto LAB_001129d0;
LAB_00112b0d:
    lVar21 = *(long *)param_1;
  ...
  if (((puVar15[1] & 0x40) == 0) ||
    ...
    if (this_00[0x5a] == (hb_buffer_t)0x0) {
      ...
      *(uint *)(this_00 + 0x5c) = uVar11;
      ...
      if ((*(long *)(this_00 + 0x78) != *(long *)(this_00 + 0x70)) ||
         (uVar11 != *(uint *)(this_00 + 100))) goto LAB_00112cde;
      uVar11 = uVar11 + 1;
      *(uint *)(this_00 + 100) = uVar11;
      *(uint *)(this_00 + 0x5c) = uVar11;
    }
...
LAB_00112a1d:
  if (uVar11 < uVar12) goto code_r0x00112a25;
LAB_00112e10:
  puVar14 = *(uint **)this;
  uVar25 = 0;
  puVar20 = puVar19;
...
LAB_0011345e:
      if ((uint)uVar17 == uVar14) goto LAB_001135c0;
    }
    else {
      uVar16 = (uint)uVar17;
      uVar14 = uVar16;
...
LAB_001141cb:
          if ((int)uVar12 < 0) goto LAB_001141f3;
          puVar14 = puVar14 + 1;
        } while (uVar23 != 0);
        *(undefined4 *)(param_1 + 0x30) = 0;
LAB_001141f3:
...
LAB_00114210:
    if ((uVar20 == uVar9) || (this_00[0x58] == (hb_buffer_t)0x0)) goto LAB_00114436;
    uVar23 = uVar16;
    if (((puVar10[1] & 0x40) == 0) ||
  ...
  do {
    ...
    if (((uVar4 & 0xf00) == 0) || (*(uint *)(param_1 + 8) <= *(uint *)(param_1 + 4))) {
      if ((uVar23 != 0) && (((uVar4 & 0x40) == 0 || (uVar35 != 0)))) {
        ...
        if ((((uVar5 & 0xf00) != 0) && (*(uint *)(param_1 + 4) < *(uint *)(param_1 + 8))) ||
           ((uVar6 = *puVar1, uVar35 != (ushort)(uVar6 << 8 | uVar6 >> 8) ||
            (((uVar4 ^ uVar5) & 0x40) != 0)))) goto LAB_00114966;
      }
      ...
      if (((*(byte *)((long)puVar11 +
         ...
         && (*(uint *)(param_1 + 4) < *(uint *)(param_1 + 8))) goto LAB_00114966;
    }
    else {
LAB_00114966:
      uVar10 = uVar31;
  ...
  *(undefined8 *)this = 0;
  ...
  do {
    ...
    if ((uVar4 != 0) &&
      ...
      if (uVar11 == 0) {
LAB_00116e60:
        if (local_5c == 0) goto LAB_00116e71;
        local_5c = 0;
        if ((ulong)local_70 < (ulong)((long)puVar2 + (2 - local_80._0_8_))) {
          hb_blob_destroy(local_58);
          goto LAB_00116f48;

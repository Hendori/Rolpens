...
/* BoxContainer::get_alignment() const */

undefined4 __thiscall BoxContainer::get_alignment(BoxContainer *this)
...
/* BoxContainer::is_vertical() const */

BoxContainer __thiscall BoxContainer::is_vertical(BoxContainer *this)
...
/* BoxContainer::get_minimum_size() const */

void __thiscall BoxContainer::get_minimum_size(BoxContainer *this)
...
/* BoxContainer::add_spacer(bool) */

Control * __thiscall BoxContainer::add_spacer(BoxContainer *this,bool param_1)
...
undefined8
std::
_Function_handler<void(Node*,StringName_const&,StringName_const&),BoxContainer::_bind_methods()::{lambda(Node*,StringName_const&,StringName_const&)#1}>
::_M_manager(undefined8 *param_1,undefined8 param_2,int param_3)

{
  if (param_3 == 0) {
    *param_1 = &BoxContainer::_bind_methods()::{lambda(Node*,StringName_const&,StringName_const&)#1}
                ::typeinfo;
    return 0;
  }
  if (param_3 != 1) {
...
/* BoxContainer::_validate_property(PropertyInfo&) const */

void __thiscall BoxContainer::_validate_property(BoxContainer *this,PropertyInfo *param_1)
...
/* BoxContainer::BoxContainer(bool) */

void __thiscall BoxContainer::BoxContainer(BoxContainer *this,bool param_1)
...
void __thiscall BoxContainer::_resort(BoxContainer *this)

{
  ...
  int local_b8;
  Rect2 *local_90;
  HashMap<Control*,_MinSizeCache,HashMapHasherDefault,HashMapComparatorDefault<Control*>,DefaultTypedAllocator<HashMapElement<Control*,_MinSizeCache>>>
  local_88 [8];
  ...
  while( true ) {
    ...
    if (local_90 != (Rect2 *)0x0) {
      ...
      iVar33 = iVar33 + 1;
      piVar13 = (int *)HashMap<Control*,_MinSizeCache,HashMapHasherDefault,HashMapComparatorDefault<Control*>,DefaultTypedAllocator<HashMapElement<Control*,_MinSizeCache>>>
                       ::operator[](local_88,(Control **)&local_90);
      *piVar13 = iVar12;
...
LAB_001008b1:
      ...
      if ((undefined8 *)local_80._0_8_ == (undefined8 *)0x0) {
        if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
          _err_print_error("_resort","scene/gui/box_container.cpp",0x72,
                           "Condition \"!min_size_cache.has(c)\" is true.",0,0);
          return;
        }
        goto LAB_00100d8b;
      }
...
LAB_001008c0:
      ...
      while ((uVar27 != (uint)uVar31 ||
             (local_90 != *(Rect2 **)(*(long *)(local_80._0_8_ + lVar20 * 8) + 0x10)))) {
        uVar29 = uVar29 + 1;
        auVar3._8_8_ = 0;
        ...
        if ((uVar27 == 0) ||
           (auVar4._8_8_ = 0, auVar4._0_8_ = (ulong)uVar27 * lVar17, auVar8._8_8_ = 0,
           auVar8._0_8_ = uVar28, auVar5._8_8_ = 0,
           auVar5._0_8_ = (ulong)((*(uint *)(hash_table_size_primes + (local_60 & 0xffffffff) * 4) +
                                  iVar12) - SUB164(auVar4 * auVar8,8)) * lVar17, auVar9._8_8_ = 0,
           auVar9._0_8_ = uVar28, SUB164(auVar5 * auVar9,8) < uVar29)) goto LAB_001008c0;
      }
      piVar13 = (int *)HashMap<Control*,_MinSizeCache,HashMapHasherDefault,HashMapComparatorDefault<Control*>,DefaultTypedAllocator<HashMapElement<Control*,_MinSizeCache>>>
                       ::operator[](local_88,(Control **)&local_90);
    ...
    if (cVar32 == '\0') {
      ...
      iVar12 = iVar22 >> 1;
      if (this[0xa00] != (BoxContainer)0x0) {
        if ((iVar21 != 1) && (iVar12 = iVar22, iVar21 != 2)) {
          iVar12 = 0;
        }
        goto LAB_00100b10;
      }
...
LAB_00100c46:
      iVar22 = Node::get_child_count(bVar35);
      iVar18 = -1;
      iVar21 = -1;
      iVar22 = iVar22 + -1;
    }
...
LAB_00100b10:
    ...
    for (; local_60 = uVar15, iVar22 != iVar21; iVar22 = iVar22 + iVar18) {
      ...
      if (pRVar16 != (Rect2 *)0x0) {
        lVar17 = HashMap<Control*,_MinSizeCache,HashMapHasherDefault,HashMapComparatorDefault<Control*>,DefaultTypedAllocator<HashMapElement<Control*,_MinSizeCache>>>
                 ::operator[](local_88,(Control **)&local_90);
        if (!bVar35) {
...
LAB_00100ac1:
    ...
    if ((bVar35) && (*(uint *)(hash_table_size_primes + (uVar15 & 0xffffffff) * 4) != 0)) {
      piVar1 = (int *)(local_80._8_8_ +
                      (ulong)*(uint *)(hash_table_size_primes + (uVar15 & 0xffffffff) * 4) * 4);
      piVar23 = (int *)local_80._8_8_;
...
/* BoxContainer::_notification(int) */

void __thiscall BoxContainer::_notification(BoxContainer *this,int param_1)
...
/* BoxContainer::set_alignment(BoxContainer::AlignmentMode) */

void __thiscall BoxContainer::set_alignment(BoxContainer *this,int param_2)
...
/* VBoxContainer::add_margin_child(String const&, Control*, bool) */

MarginContainer * __thiscall
...
/* BoxContainer::set_vertical(bool) */

void __thiscall BoxContainer::set_vertical(BoxContainer *this,bool param_1)

{
  ...
  if (this[0xa0c] == (BoxContainer)0x0) {
    ...
    _err_print_error("set_vertical","scene/gui/box_container.cpp",0x138,
...
void BoxContainer::_bind_methods(void)

{
  ...
  GetTypeInfo<BoxContainer::AlignmentMode,void>::get_class_info
            ((GetTypeInfo<BoxContainer::AlignmentMode,void> *)&local_a8);
  local_c0 = local_98;
  local_98 = (long *)0x0;
...
/* BoxContainer::get_allowed_size_flags_vertical() const */

void BoxContainer::get_allowed_size_flags_vertical(void)
...
/* BoxContainer::get_allowed_size_flags_horizontal() const */

void BoxContainer::get_allowed_size_flags_horizontal(void)
...
/* BoxContainer::is_class_ptr(void*) const */

uint BoxContainer::is_class_ptr(void *param_1)

{
  undefined4 in_EDX;
  undefined4 *in_RSI;
  
  return (uint)CONCAT71(0x109a,in_RSI == &Container::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x109a,in_RSI == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x109a,in_RSI == &Control::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x109a,in_RSI == &CanvasItem::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x109a,in_RSI == &Node::get_class_ptr_static()::ptr) |
...
/* MethodBindTRC<BoxContainer::AlignmentMode>::_gen_argument_type(int) const */

undefined8 MethodBindTRC<BoxContainer::AlignmentMode>::_gen_argument_type(int param_1)
...
/* MethodBindTRC<BoxContainer::AlignmentMode>::get_argument_meta(int) const */

undefined8 MethodBindTRC<BoxContainer::AlignmentMode>::get_argument_meta(int param_1)
...
/* MethodBindT<BoxContainer::AlignmentMode>::_gen_argument_type(int) const */

char __thiscall
MethodBindT<BoxContainer::AlignmentMode>::_gen_argument_type
          (MethodBindT<BoxContainer::AlignmentMode> *this,int param_1)
...
/* MethodBindT<BoxContainer::AlignmentMode>::get_argument_meta(int) const */

undefined8 MethodBindT<BoxContainer::AlignmentMode>::get_argument_meta(int param_1)
...
/* MethodBindTR<Control*, bool>::_gen_argument_type(int) const */

int __thiscall
MethodBindTR<Control*,bool>::_gen_argument_type(MethodBindTR<Control*,bool> *this,int param_1)
...
/* MethodBindTR<Control*, bool>::get_argument_meta(int) const */

undefined8 MethodBindTR<Control*,bool>::get_argument_meta(int param_1)
...
/* MethodBindTR<Control*, bool>::~MethodBindTR() */

void __thiscall MethodBindTR<Control*,bool>::~MethodBindTR(MethodBindTR<Control*,bool> *this)
...
/* MethodBindT<BoxContainer::AlignmentMode>::~MethodBindT() */

void __thiscall
MethodBindT<BoxContainer::AlignmentMode>::~MethodBindT
          (MethodBindT<BoxContainer::AlignmentMode> *this)
...
/* MethodBindTRC<BoxContainer::AlignmentMode>::~MethodBindTRC() */

void __thiscall
MethodBindTRC<BoxContainer::AlignmentMode>::~MethodBindTRC
          (MethodBindTRC<BoxContainer::AlignmentMode> *this)
...
/* BoxContainer::_property_get_revertv(StringName const&, Variant&) const */

undefined8 BoxContainer::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* BoxContainer::_property_can_revertv(StringName const&) const */

undefined8 BoxContainer::_property_can_revertv(StringName *param_1)
...
/* BoxContainer::_bind_methods() [clone .cold] */
...
/* BoxContainer::_setv(StringName const&, Variant const&) */

undefined8 BoxContainer::_setv(StringName *param_1,Variant *param_2)
...
/* BoxContainer::_validate_propertyv(PropertyInfo&) const */

void __thiscall BoxContainer::_validate_propertyv(BoxContainer *this,PropertyInfo *param_1)
...
/* WARNING: Removing unreachable block (ram,0x00102a28) */
/* BoxContainer::_getv(StringName const&, Variant&) const */

undefined8 BoxContainer::_getv(StringName *param_1,Variant *param_2)
...
void __thiscall BoxContainer::~BoxContainer(BoxContainer *this)
...
/* BoxContainer::_get_class_namev() const */

undefined8 * BoxContainer::_get_class_namev(void)
...
LAB_00102b53:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"BoxContainer");
      goto LAB_00102bbe;
    }
  }
  StringName::assign_static_unique_class_name
...
/* BoxContainer::get_class() const */

void BoxContainer::get_class(void)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* HashMap<Control*, _MinSizeCache, HashMapHasherDefault, HashMapComparatorDefault<Control*>,
   DefaultTypedAllocator<HashMapElement<Control*, _MinSizeCache> > >::operator[](Control* const&) */

undefined1  [16] __thiscall
HashMap<Control*,_MinSizeCache,HashMapHasherDefault,HashMapComparatorDefault<Control*>,DefaultTypedAllocator<HashMapElement<Control*,_MinSizeCache>>>
::operator[](HashMap<Control*,_MinSizeCache,HashMapHasherDefault,HashMapComparatorDefault<Control*>,DefaultTypedAllocator<HashMapElement<Control*,_MinSizeCache>>>
...
LAB_00102f6b:
  if ((float)uVar55 * __LC8 < (float)(iVar43 + 1)) {
...
GetTypeInfo<BoxContainer::AlignmentMode,void> * __thiscall
GetTypeInfo<BoxContainer::AlignmentMode,void>::get_class_info
...
/* MethodBindTRC<BoxContainer::AlignmentMode>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTRC<BoxContainer::AlignmentMode>::_gen_argument_type_info(int param_1)
...
/* MethodBindTR<Control*, bool>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTR<Control*,bool>::_gen_argument_type_info(int param_1)
...
/* MethodBindT<BoxContainer::AlignmentMode>::_gen_argument_type_info(int) const */

undefined4 * MethodBindT<BoxContainer::AlignmentMode>::_gen_argument_type_info(int param_1)

{
  ...
  *(undefined1 (*) [16])(puVar2 + 2) = (undefined1  [16])0x0;
  if (in_EDX == 0) {
    GetTypeInfo<BoxContainer::AlignmentMode,void>::get_class_info
              ((GetTypeInfo<BoxContainer::AlignmentMode,void> *)local_48);
    *puVar2 = local_48[0];
...
/* MethodBind* create_method_bind<BoxContainer, Control*, bool>(Control* (BoxContainer::*)(bool)) */

MethodBind * create_method_bind<BoxContainer,Control*,bool>(_func_Control_ptr_bool *param_1)
...
/* MethodBind* create_method_bind<BoxContainer, BoxContainer::AlignmentMode>(void
   (BoxContainer::*)(BoxContainer::AlignmentMode)) */

MethodBind *
create_method_bind<BoxContainer,BoxContainer::AlignmentMode>(_func_void_AlignmentMode *param_1)
...
/* MethodBind* create_method_bind<BoxContainer,
   BoxContainer::AlignmentMode>(BoxContainer::AlignmentMode (BoxContainer::*)() const) */

MethodBind *
create_method_bind<BoxContainer,BoxContainer::AlignmentMode>(_func_AlignmentMode *param_1)
...
/* MethodBind* create_method_bind<BoxContainer, bool>(void (BoxContainer::*)(bool)) */

MethodBind * create_method_bind<BoxContainer,bool>(_func_void_bool *param_1)
...
/* MethodBind* create_method_bind<BoxContainer, bool>(bool (BoxContainer::*)() const) */

MethodBind * create_method_bind<BoxContainer,bool>(_func_bool *param_1)
...
/* BoxContainer::_initialize_classv() */

void BoxContainer::_initialize_classv(void)
...
/* WARNING: Removing unreachable block (ram,0x00106d88) */
...
Object * MethodBindTRC<BoxContainer::AlignmentMode>::call
...
void __thiscall
MethodBindTRC<BoxContainer::AlignmentMode>::validated_call
          (MethodBindTRC<BoxContainer::AlignmentMode> *this,Object *param_1,Variant **param_2,
          Variant *param_3)
...
/* MethodBindTRC<BoxContainer::AlignmentMode>::ptrcall(Object*, void const**, void*) const */

void __thiscall
MethodBindTRC<BoxContainer::AlignmentMode>::ptrcall
          (MethodBindTRC<BoxContainer::AlignmentMode> *this,Object *param_1,void **param_2,
          void *param_3)
...
void MethodBindT<BoxContainer::AlignmentMode>::validated_call
...
/* MethodBindT<BoxContainer::AlignmentMode>::ptrcall(Object*, void const**, void*) const */

void MethodBindT<BoxContainer::AlignmentMode>::ptrcall(Object *param_1,void **param_2,void *param_3)
...
/* MethodBindTR<Control*, bool>::validated_call(Object*, Variant const**, Variant*) const */

void __thiscall
MethodBindTR<Control*,bool>::validated_call
          (MethodBindTR<Control*,bool> *this,Object *param_1,Variant **param_2,Variant *param_3)
...
/* MethodBindTR<Control*, bool>::ptrcall(Object*, void const**, void*) const */

void __thiscall
MethodBindTR<Control*,bool>::ptrcall
          (MethodBindTR<Control*,bool> *this,Object *param_1,void **param_2,void *param_3)
...
/* MethodBindTR<Control*, bool>::call(Object*, Variant const**, int, Callable::CallError&) const */

Object * MethodBindTR<Control*,bool>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
void call_with_variant_args_dv<__UnexistingClass,BoxContainer::AlignmentMode>
...
Object * MethodBindT<BoxContainer::AlignmentMode>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)

{
  ...
  call_with_variant_args_dv<__UnexistingClass,BoxContainer::AlignmentMode>

...
/* Gizmo3DHelper::initialize_handle_action(Variant const&, Transform3D const&) */

void __thiscall
Gizmo3DHelper::initialize_handle_action(Gizmo3DHelper *this,Variant *param_1,Transform3D *param_2)
...
/* Gizmo3DHelper::get_segment(Camera3D*, Vector2 const&, Vector3*) */

void __thiscall
Gizmo3DHelper::get_segment(Gizmo3DHelper *this,Camera3D *param_1,Vector2 *param_2,Vector3 *param_3)

{
  ...
  *(float *)(param_3 + 4) =
       local_a0 * fStack_4c + fStack_9c * local_48 + fVar4 * fStack_44 + fStack_f4;
  *(float *)(param_3 + 8) =
       local_a0 * fStack_40 + fStack_9c * fStack_44 + fVar4 * local_38 + fStack_f0;
  *(float *)(param_3 + 0xc) = fVar2 * local_58 + fVar6 * fStack_54 + fVar5 * fStack_50 + fStack_34;
  *(ulong *)(param_3 + 0x10) =
       CONCAT44(fVar2 * fStack_40 + fVar6 * fStack_3c + fVar5 * local_38 + fStack_f0,
                fVar2 * fStack_4c + fVar6 * local_48 + fVar5 * fStack_44 + fStack_f4);
...
/* Gizmo3DHelper::box_get_handle_name(int) const */

StrRange * Gizmo3DHelper::box_get_handle_name(int param_1)
...
/* Gizmo3DHelper::box_set_handle(Vector3 const*, int, Vector3&, Vector3&) */

void __thiscall
Gizmo3DHelper::box_set_handle
          (Gizmo3DHelper *this,Vector3 *param_1,int param_2,Vector3 *param_3,Vector3 *param_4)

{
  ...
  *(undefined4 *)((long)&local_4c + lVar11 * 4) = 0xc5800000;
  ...
  Geometry3D::get_closest_points_between_segments
            ((Vector3 *)&local_58,(Vector3 *)&local_4c,param_1,param_1 + 0xc,(Vector3 *)&local_70,
             (Vector3 *)&local_64);
  ...
  *(float *)pVVar2 = fVar12;
  ...
  if (cVar9 == '\0') {
    ...
    *(float *)(param_4 + 8) =
         *(float *)(this + 0x1b4) * fVar15 + fVar12 * fVar14 +
         *(float *)(this + 0x1b8) * local_88[2] + *(float *)(this + 0x1c4);
    *(ulong *)param_4 =
         CONCAT44((float)((ulong)uVar10 >> 0x20) * fVar14 + fVar15 * fVar3 +
                  (float)((ulong)uVar6 >> 0x20) * local_88[2] + (float)((ulong)uVar7 >> 0x20),
                  (float)uVar5 * fVar14 + fVar15 * fVar4 + (float)uVar10 * local_88[2] +
                  (float)uVar7);
  }
  else {
...
Gizmo3DHelper::box_commit_handle
          (Gizmo3DHelper *this,String *param_1,bool param_2,Object *param_3,Object *param_4,
          StringName *param_5,StringName *param_6)
...
/* Gizmo3DHelper::cylinder_get_handle_name(int) const */

StrRange * Gizmo3DHelper::cylinder_get_handle_name(int param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Gizmo3DHelper::cylinder_set_handle(Vector3 const*, int, float&, float&, Vector3&) */

void __thiscall
Gizmo3DHelper::cylinder_set_handle
          (Gizmo3DHelper *this,Vector3 *param_1,int param_2,float *param_3,float *param_4,
          Vector3 *param_5)

{
  ...
  local_4c = 0;
  local_44 = 0;
  local_78 = CONCAT44((uint)(_UNK_00101c2c * local_88[1]) ^ _LC21._4_4_,
                      (uint)(_LC4 * local_88[0]) ^ (uint)_LC21);
  local_60 = 0;
  local_70 = 0x80000000;
  Geometry3D::get_closest_points_between_segments
            ((Vector3 *)&local_78,(Vector3 *)&local_68,param_1,param_1 + 0xc,(Vector3 *)local_58,
             (Vector3 *)&local_4c);
  ...
  if (param_2 == 0) {
    ...
    *param_3 = fVar10;
    ...
    if (cVar4 == '\0') {
      ...
      *(float *)(param_5 + 8) =
           *(float *)(this + 0x1b8) * 0.0 +
           *(float *)(this + 0x1b0) * 0.0 + *(float *)(this + 0x1b4) * fVar8 +
           *(float *)(this + 0x1c4);
      *(ulong *)param_5 =
           CONCAT44(fVar8 * fVar10 + (float)((ulong)uVar5 >> 0x20) * 0.0 +
                    (float)((ulong)uVar2 >> 0x20) * 0.0 + (float)((ulong)uVar3 >> 0x20),
                    fVar8 * fVar7 + (float)uVar1 * 0.0 + (float)uVar5 * 0.0 + (float)uVar3);
    }
    else {
      *(undefined8 *)param_5 = *(undefined8 *)(this + 0x1bc);
      *(undefined4 *)(param_5 + 8) = *(undefined4 *)(this + 0x1c4);
...
/* Gizmo3DHelper::cylinder_commit_handle(int, String const&, String const&, bool, Object*, Object*,
   Object*, StringName const&, StringName const&, StringName const&) */

void __thiscall
Gizmo3DHelper::cylinder_commit_handle
          (Gizmo3DHelper *this,int param_1,String *param_2,String *param_3,bool param_4,
          Object *param_5,Object *param_6,Object *param_7,StringName *param_8,StringName *param_9,
          StringName *param_10)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Gizmo3DHelper::cylinder_get_handles(float, float) */

Gizmo3DHelper * __thiscall
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Gizmo3DHelper::box_get_handles(Vector3 const&) */

Vector3 * Gizmo3DHelper::box_get_handles(Vector3 *param_1)
...
void Gizmo3DHelper::_GLOBAL__sub_I_initialize_handle_action(void)

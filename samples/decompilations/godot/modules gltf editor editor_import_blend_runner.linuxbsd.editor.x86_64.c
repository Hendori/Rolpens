...
/* EditorImportBlendRunner::_resources_reimported(Vector<String> const&) */

void EditorImportBlendRunner::_resources_reimported(Vector *param_1)
...
/* EditorImportBlendRunner::_kill_blender() */

void __thiscall EditorImportBlendRunner::_kill_blender(EditorImportBlendRunner *this)
...
/* EditorImportBlendRunner::connect_blender_rpc(Ref<HTTPClient> const&, int) */

void __thiscall
EditorImportBlendRunner::connect_blender_rpc(EditorImportBlendRunner *this,Ref *param_1,int param_2)
...
/* EditorImportBlendRunner::_extract_error_message_xml(Vector<unsigned char> const&, String&) */

ulong __thiscall
EditorImportBlendRunner::_extract_error_message_xml
          (EditorImportBlendRunner *this,Vector *param_1,String *param_2)
...
/* EditorImportBlendRunner::_notification(int) */

void __thiscall EditorImportBlendRunner::_notification(EditorImportBlendRunner *this,int param_1)
...
void __thiscall EditorImportBlendRunner::EditorImportBlendRunner(EditorImportBlendRunner *this)
  ...
  *(undefined8 *)(this + 0x418) = 0;
  if (bVar7) {
    ...
    *(char **)(pCVar6 + 0x20) = "EditorImportBlendRunner::_resources_reimported";
    ...
    _err_print_error("EditorImportBlendRunner","modules/gltf/editor/editor_import_blend_runner.cpp",
                     0x17e,"Condition \"singleton != nullptr\" is true.",
                     "EditorImportBlendRunner already created.",0,0);
  }
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
  }
...
/* EditorImportBlendRunner::start_blender(String const&, bool) */

undefined4 __thiscall
EditorImportBlendRunner::start_blender(EditorImportBlendRunner *this,String *param_1,bool param_2)
...
/* dict_to_python(Dictionary const&) */

Dictionary * dict_to_python(Dictionary *param_1)
...
LAB_001012b0:
        ...
        if (local_78[0] != 0x1b) {
LAB_001010cf:
          Variant::get_type_name((StrRange *)&local_98);
          local_88 = "Unhandled Variant type %s for python dictionary";
          local_90 = (char *)0x0;
          local_80 = 0x2f;
          String::parse_latin1((StrRange *)&local_90);
          vformat<String>((Variant *)&local_88,(StrRange *)&local_90,(StrRange *)&local_98);
          _err_print_error("dict_to_python","modules/gltf/editor/editor_import_blend_runner.cpp",
                           0x77,"Method/function failed. Returning: \"\"",(Variant *)&local_88,0,0);
          pcVar3 = local_88;
...
LAB_001013fa:
      ...
      vformat<String,String>
                ((Variant *)&local_88,(StrRange *)&local_a0,(StrRange *)&local_98,
                 (StrRange *)&local_90);
...
/* EditorImportBlendRunner::do_import_direct(Dictionary const&) */

ulong EditorImportBlendRunner::do_import_direct(Dictionary *param_1)
...
/* dict_to_xmlrpc(Dictionary const&) */

Dictionary * dict_to_xmlrpc(Dictionary *param_1)
...
LAB_00101aef:
          ...
          String::parse_latin1((StrRange *)&local_90);
          vformat<String>((Variant *)&local_88,(StrRange *)&local_90,(StrRange *)&local_98);
          _err_print_error("dict_to_xmlrpc","modules/gltf/editor/editor_import_blend_runner.cpp",
                           0x98,"Method/function failed. Returning: \"\"",(Variant *)&local_88,0,0);
          pcVar3 = local_88;
          if (local_88 != (char *)0x0) {
            LOCK();
            plVar1 = (long *)(local_88 + -0x10);
...
/* EditorImportBlendRunner::do_import_rpc(Dictionary const&) */

int EditorImportBlendRunner::do_import_rpc(Dictionary *param_1)
...
LAB_001024e1:
  local_78 = 0;
  local_58 = 
  "<?xml version=\"1.0\"?><methodCall><methodName>export_gltf</methodName><params><param><value>%s</value></param></params></methodCall>"
  ;
  local_50 = 0x83;
    ...
    if (iVar8 == 0) {
      ...
      if (iVar9 == 5) {
        ...
        if (iVar9 == 200) {
          ...
          if ((iVar9 < 0) && (iVar9 = String::find((char *)&local_98,0x1051a0), iVar9 < 0)) {
            local_90 = (char *)0x0;
            cVar7 = _extract_error_message_xml
                              ((EditorImportBlendRunner *)param_1,(Vector *)&local_68,
                               (String *)&local_90);
            local_80 = (char *)0x0;
            if (cVar7 == '\0') {
              plVar11 = (long *)(local_98 + -0x10);
...
LAB_00102e47:
            ...
            _err_print_error("do_import_rpc","modules/gltf/editor/editor_import_blend_runner.cpp",
                             uVar13,"Method/function failed. Returning: ERR_QUERY_FAILED",&local_58,
                             0,0);
            pcVar6 = local_58;
            if (local_58 != (char *)0x0) {
              LOCK();
...
LAB_00102a83:
          uVar10 = (**(code **)(*(long *)pOVar3 + 400))(pOVar3);
          local_88 = 0;
          local_50 = 0x38;
          ...
          _err_print_error("do_import_rpc","modules/gltf/editor/editor_import_blend_runner.cpp",299,
                           "Method/function failed. Returning: ERR_QUERY_FAILED",&local_58,0,0);
          pcVar6 = local_58;
          if (local_58 != (char *)0x0) {
            LOCK();
            plVar11 = (long *)(local_58 + -0x10);
...
LAB_00102b42:
        ...
        _err_print_error("do_import_rpc","modules/gltf/editor/editor_import_blend_runner.cpp",0x120,
                         "Method/function failed. Returning: ERR_CONNECTION_ERROR",&local_58,0,0);
        pcVar6 = local_58;
        if (local_58 != (char *)0x0) {
          LOCK();
          plVar11 = (long *)(local_58 + -0x10);
      ...
      _err_print_error("do_import_rpc","modules/gltf/editor/editor_import_blend_runner.cpp",0x109,
                       "Method/function failed. Returning: err",&local_58,0,0);
      pcVar6 = local_58;
      if (local_58 != (char *)0x0) {
        LOCK();
        plVar11 = (long *)(local_58 + -0x10);
    ...
    _err_print_error("do_import_rpc","modules/gltf/editor/editor_import_blend_runner.cpp",0x102,
                     "Method/function failed. Returning: ERR_CONNECTION_ERROR",&local_58,0,0);
    pcVar6 = local_58;
    if (local_58 != (char *)0x0) {
      LOCK();
  ...
  pOVar3 = local_a0;
  if (((local_a0 != (Object *)0x0) && (cVar7 = RefCounted::unreference(), cVar7 != '\0')) &&
...
/* EditorImportBlendRunner::do_import(Dictionary const&) */

void EditorImportBlendRunner::do_import(Dictionary *param_1)
...
/* EditorImportBlendRunner::is_class_ptr(void*) const */

uint __thiscall EditorImportBlendRunner::is_class_ptr(EditorImportBlendRunner *this,void *param_1)

{
  return (uint)CONCAT71(0x1080,(undefined4 *)param_1 == &Node::get_class_ptr_static()::ptr) |
...
/* EditorImportBlendRunner::_getv(StringName const&, Variant&) const */

undefined8 EditorImportBlendRunner::_getv(StringName *param_1,Variant *param_2)
...
/* EditorImportBlendRunner::_setv(StringName const&, Variant const&) */

undefined8 EditorImportBlendRunner::_setv(StringName *param_1,Variant *param_2)
...
/* EditorImportBlendRunner::_property_can_revertv(StringName const&) const */

undefined8 EditorImportBlendRunner::_property_can_revertv(StringName *param_1)
...
/* EditorImportBlendRunner::_property_get_revertv(StringName const&, Variant&) const */

undefined8 EditorImportBlendRunner::_property_get_revertv(StringName *param_1,Variant *param_2)
...
void __thiscall
CallableCustomMethodPointer<EditorImportBlendRunner,void,Vector<String>const&>::
~CallableCustomMethodPointer
          (CallableCustomMethodPointer<EditorImportBlendRunner,void,Vector<String>const&> *this)
...
void __thiscall
CallableCustomMethodPointer<EditorImportBlendRunner,void>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<EditorImportBlendRunner,void> *this)
...
CallableCustomMethodPointer<EditorImportBlendRunner,void,Vector<String>const&>::get_argument_count
          (CallableCustomMethodPointer<EditorImportBlendRunner,void,Vector<String>const&> *this,
          bool *param_1)
...
/* CallableCustomMethodPointer<EditorImportBlendRunner, void>::get_argument_count(bool&) const */

undefined8 __thiscall
CallableCustomMethodPointer<EditorImportBlendRunner,void>::get_argument_count
          (CallableCustomMethodPointer<EditorImportBlendRunner,void> *this,bool *param_1)
...
/* EditorImportBlendRunner::_validate_propertyv(PropertyInfo&) const */

void EditorImportBlendRunner::_validate_propertyv(PropertyInfo *param_1)
...
/* CallableCustomMethodPointer<EditorImportBlendRunner, void>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<EditorImportBlendRunner,void>::get_object
          (CallableCustomMethodPointer<EditorImportBlendRunner,void> *this)
...
/* EditorImportBlendRunner::_get_class_namev() const */

undefined8 * EditorImportBlendRunner::_get_class_namev(void)
...
LAB_001036a3:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"EditorImportBlendRunner");
      goto LAB_0010370e;
    }
  }
  StringName::assign_static_unique_class_name
...
/* EditorImportBlendRunner::_notificationv(int, bool) */

void __thiscall
EditorImportBlendRunner::_notificationv(EditorImportBlendRunner *this,int param_1,bool param_2)
...
/* EditorImportBlendRunner::get_class() const */

void EditorImportBlendRunner::get_class(void)
...
/* EditorImportBlendRunner::is_class(String const&) const */

undefined8 __thiscall
EditorImportBlendRunner::is_class(EditorImportBlendRunner *this,String *param_1)
...
/* EditorImportBlendRunner::_initialize_classv() */

void EditorImportBlendRunner::_initialize_classv(void)

{
  ...
  local_30 = *(long *)(in_FS_OFFSET + 0x28);
  if (initialize_class()::initialized != '\0') goto LAB_00103f64;
...
void __thiscall
CallableCustomMethodPointer<EditorImportBlendRunner,void>::call
          (CallableCustomMethodPointer<EditorImportBlendRunner,void> *this,Variant **param_1,
...
void __thiscall
EditorImportBlendRunner::_get_property_listv
          (EditorImportBlendRunner *this,List *param_1,bool param_2)
...
/* WARNING: Removing unreachable block (ram,0x00105bd0) */
/* WARNING: Removing unreachable block (ram,0x00105d49) */
/* WARNING: Removing unreachable block (ram,0x00105bdc) */
/* WARNING: Removing unreachable block (ram,0x00105be6) */
/* WARNING: Removing unreachable block (ram,0x00105d2b) */
/* WARNING: Removing unreachable block (ram,0x00105bf2) */
/* WARNING: Removing unreachable block (ram,0x00105bfc) */
/* WARNING: Removing unreachable block (ram,0x00105d0d) */
/* WARNING: Removing unreachable block (ram,0x00105c08) */
/* WARNING: Removing unreachable block (ram,0x00105c12) */
/* WARNING: Removing unreachable block (ram,0x00105cef) */
/* WARNING: Removing unreachable block (ram,0x00105c1e) */
/* WARNING: Removing unreachable block (ram,0x00105c28) */
/* WARNING: Removing unreachable block (ram,0x00105cd1) */
/* WARNING: Removing unreachable block (ram,0x00105c34) */
/* WARNING: Removing unreachable block (ram,0x00105c3e) */
/* WARNING: Removing unreachable block (ram,0x00105cb3) */
...
/* WARNING: Removing unreachable block (ram,0x00105c6e) */
/* WARNING: Removing unreachable block (ram,0x00105c7a) */
...
/* WARNING: Removing unreachable block (ram,0x00106160) */
/* WARNING: Removing unreachable block (ram,0x00105fda) */
/* WARNING: Removing unreachable block (ram,0x00105fe4) */
/* WARNING: Removing unreachable block (ram,0x00106140) */
/* WARNING: Removing unreachable block (ram,0x00105ff0) */
...
/* WARNING: Removing unreachable block (ram,0x00106010) */
/* WARNING: Removing unreachable block (ram,0x00106100) */
/* WARNING: Removing unreachable block (ram,0x0010601c) */
/* WARNING: Removing unreachable block (ram,0x00106026) */
/* WARNING: Removing unreachable block (ram,0x001060e0) */
/* WARNING: Removing unreachable block (ram,0x00106032) */
/* WARNING: Removing unreachable block (ram,0x0010603c) */
/* WARNING: Removing unreachable block (ram,0x001060c0) */
/* WARNING: Removing unreachable block (ram,0x00106044) */
/* WARNING: Removing unreachable block (ram,0x0010605a) */
/* WARNING: Removing unreachable block (ram,0x00106066) */
...
/* WARNING: Removing unreachable block (ram,0x001063f8) */
/* WARNING: Removing unreachable block (ram,0x001065c0) */
/* WARNING: Removing unreachable block (ram,0x00106404) */
/* WARNING: Removing unreachable block (ram,0x0010640e) */
/* WARNING: Removing unreachable block (ram,0x001065a0) */
/* WARNING: Removing unreachable block (ram,0x0010641a) */
/* WARNING: Removing unreachable block (ram,0x00106424) */
/* WARNING: Removing unreachable block (ram,0x00106580) */
/* WARNING: Removing unreachable block (ram,0x00106430) */
/* WARNING: Removing unreachable block (ram,0x0010643a) */
/* WARNING: Removing unreachable block (ram,0x00106560) */
/* WARNING: Removing unreachable block (ram,0x00106446) */
/* WARNING: Removing unreachable block (ram,0x00106450) */
/* WARNING: Removing unreachable block (ram,0x00106540) */
/* WARNING: Removing unreachable block (ram,0x0010645c) */
/* WARNING: Removing unreachable block (ram,0x00106466) */
/* WARNING: Removing unreachable block (ram,0x00106520) */
/* WARNING: Removing unreachable block (ram,0x00106472) */
/* WARNING: Removing unreachable block (ram,0x0010647c) */
/* WARNING: Removing unreachable block (ram,0x00106500) */
/* WARNING: Removing unreachable block (ram,0x00106484) */
/* WARNING: Removing unreachable block (ram,0x0010649a) */
/* WARNING: Removing unreachable block (ram,0x001064a6) */
/* String vformat<HTTPClient::Status>(String const&, HTTPClient::Status const) */
...
void __thiscall
CallableCustomMethodPointer<EditorImportBlendRunner,void,Vector<String>const&>::call
          (CallableCustomMethodPointer<EditorImportBlendRunner,void,Vector<String>const&> *this,
...
LAB_001073ba:
      local_50 = (CowData<unsigned_char> *)(this + 8);
      ...
      if (lVar7 <= lVar12) {
        if ((lVar11 == lVar9) ||
           (iVar5 = CowData<unsigned_char>::_realloc(local_50,lVar11), iVar5 == 0)) {
          if (*(long *)(this + 8) == 0) {
            _DAT_00000000 = 0;
                    /* WARNING: Does not return */
...
LAB_0010751c:
        _err_print_index_error
                  ("get","./core/templates/cowdata.h",0xdb,lVar9,lVar11,"p_index","size()","",false,
                   true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
        pcVar4 = (code *)invalidInstructionException();

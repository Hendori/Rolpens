...
/* RefCounted::get_reference_count() const */

undefined4 __thiscall RefCounted::get_reference_count(RefCounted *this)
...
uint __thiscall RefCounted::unreference(RefCounted *this)

{
  ...
  pRVar10 = this + 0x174;
  iVar3 = *(int *)pRVar10;
  *(int *)pRVar10 = *(int *)pRVar10 + -1;
  UNLOCK();
  uVar8 = 0;
  if (iVar3 - 1U < 2) {
    uVar8 = (iVar3 - 1U ^ 1) & 1;
    if ((*(long **)(this + 0x98) != (long *)0x0) &&
       (pcVar4 = *(code **)(**(long **)(this + 0x98) + 0x88),
       pcVar4 != ScriptInstance::refcount_decremented)) {
      uVar6 = (*pcVar4)();
      uVar8 = uVar8 & uVar6;
    }
    if ((*(long *)(this + 8) != 0) &&
       (pcVar4 = *(code **)(*(long *)(this + 8) + 0x90), pcVar4 != (code *)0x0)) {
      (*pcVar4)(*(undefined8 *)(this + 0x10));
    }
    if (*(long *)(this + 0x150) != 0) {
      uVar6 = pthread_mutex_lock((pthread_mutex_t *)(this + 0x128));
      if (uVar6 != 0) {
        uVar9 = (ulong)uVar6;
        std::__throw_system_error(uVar6);
        puVar1 = (uint *)(uVar9 + 0x174);
        do {
          uVar8 = *puVar1;
          if (uVar8 == 0) {
            return 0;
        ...
        if (uVar6 < 2) {
          if ((*(long **)(uVar9 + 0x98) != (long *)0x0) &&
             (pcVar4 = *(code **)(**(long **)(uVar9 + 0x98) + 0x80),
             pcVar4 != ScriptInstance::refcount_incremented)) {
            (*pcVar4)();
          }
          if ((*(long *)(uVar9 + 8) != 0) &&
             (pcVar4 = *(code **)(*(long *)(uVar9 + 8) + 0x88), pcVar4 != (code *)0x0)) {
            (*pcVar4)(*(undefined8 *)(uVar9 + 0x10));
          }
          if (*(long *)(uVar9 + 0x150) != 0) {
            uVar8 = pthread_mutex_lock((pthread_mutex_t *)(uVar9 + 0x128));
            if (uVar8 != 0) {
              pRVar10 = (RefCounted *)(ulong)uVar8;
              std::__throw_system_error(uVar8);
              uVar8 = reference(pRVar10);
              if (((char)uVar8 != '\0') &&
                 (pRVar2 = pRVar10 + 0x178, *(int *)(pRVar10 + 0x178) == 1)) {
                LOCK();
            ...
            lVar11 = 0;
            if (*(int *)(uVar9 + 0x158) != 0) {
              do {
                puVar7 = (undefined8 *)(lVar11 * 0x20 + *(long *)(uVar9 + 0x150));
                if ((code *)puVar7[3] != (code *)0x0) {
                  (*(code *)puVar7[3])(puVar7[1],*puVar7,1);
                }
                lVar11 = lVar11 + 1;
              } while ((uint)lVar11 < *(uint *)(uVar9 + 0x158));
            }
            pthread_mutex_unlock((pthread_mutex_t *)(uVar9 + 0x128));
          }
          return 1;
        }
        return CONCAT31((int3)(uVar6 >> 8),uVar6 != 0xffffffff);
      }
      lVar11 = 0;
      uVar6 = 1;
      if (*(int *)(this + 0x158) != 0) {
        do {
          puVar7 = (undefined8 *)(lVar11 * 0x20 + *(long *)(this + 0x150));
          if (((code *)puVar7[3] != (code *)0x0) &&
             (cVar5 = (*(code *)puVar7[3])(puVar7[1],*puVar7,0), cVar5 == '\0')) {
            uVar6 = 0;
          }
          lVar11 = lVar11 + 1;
        } while ((uint)lVar11 < *(uint *)(this + 0x158));
        uVar8 = uVar8 & uVar6;
      }
...
undefined4 __thiscall RefCounted::reference(RefCounted *this)

{
  ...
  if (uVar2 < 2) {
    if ((*(long **)(this + 0x98) != (long *)0x0) &&
       (pcVar3 = *(code **)(**(long **)(this + 0x98) + 0x80),
       pcVar3 != ScriptInstance::refcount_incremented)) {
      (*pcVar3)();
    }
    if ((*(long *)(this + 8) != 0) &&
       (pcVar3 = *(code **)(*(long *)(this + 8) + 0x88), pcVar3 != (code *)0x0)) {
      (*pcVar3)(*(undefined8 *)(this + 0x10));
    }
    if (*(long *)(this + 0x150) != 0) {
      uVar4 = pthread_mutex_lock((pthread_mutex_t *)(this + 0x128));
      if (uVar4 != 0) {
        pRVar8 = (RefCounted *)(ulong)uVar4;
        std::__throw_system_error(uVar4);
        uVar5 = reference(pRVar8);
        if (((char)uVar5 != '\0') && (pRVar1 = pRVar8 + 0x178, *(int *)(pRVar8 + 0x178) == 1)) {
          LOCK();
      ...
      if (*(int *)(this + 0x158) != 0) {
        do {
          puVar6 = (undefined8 *)(lVar7 * 0x20 + *(long *)(this + 0x150));
          if ((code *)puVar6[3] != (code *)0x0) {
            (*(code *)puVar6[3])(puVar6[1],*puVar6,1);
          }
          lVar7 = lVar7 + 1;
        } while ((uint)lVar7 < *(uint *)(this + 0x158));
      }
      pthread_mutex_unlock((pthread_mutex_t *)(this + 0x128));
    }
    return 1;
...
undefined4 __thiscall RefCounted::init_ref(RefCounted *this)

{
  RefCounted *pRVar1;
  undefined4 uVar2;
  
  uVar2 = reference(this);
  if (((char)uVar2 != '\0') && (pRVar1 = this + 0x178, *(int *)(this + 0x178) == 1)) {
    LOCK();
    *(int *)pRVar1 = *(int *)pRVar1 + -1;
    UNLOCK();
    if (*(int *)pRVar1 == 0) {
...
/* WeakRef::get_ref() const */

void WeakRef::get_ref(void)
  ...
  if (uVar1 != 0) {
    ...
    if (uVar5 < (uint)ObjectDB::slot_max) {
      ...
      if ((uVar1 >> 0x18 & 0x7fffffffff) == (*puVar6 & 0x7fffffffff)) {
        pOVar3 = (Object *)puVar6[1];
        ObjectDB::spin_lock._0_1_ = '\0';
        if (pOVar3 != (Object *)0x0) {
          this = (RefCounted *)__dynamic_cast(pOVar3,&Object::typeinfo,&RefCounted::typeinfo,0);
          if (this == (RefCounted *)0x0) {
            Variant::Variant(in_RDI,pOVar3);
          }
          else {
            cVar4 = RefCounted::init_ref(this);
            if (cVar4 == '\0') {
              Variant::Variant(in_RDI,(Object *)0x0);
            }
            else {
              Variant::Variant(in_RDI,(Object *)this);
              cVar4 = RefCounted::unreference(this);
...
{
  Object::Object((Object *)this,true);
  *(undefined ***)this = &PTR__initialize_classv_00103b88;
...
/* WeakRef::set_obj(Object*) */

void __thiscall WeakRef::set_obj(WeakRef *this,Object *param_1)
...
/* WeakRef::set_ref(Ref<RefCounted> const&) */

void __thiscall WeakRef::set_ref(WeakRef *this,Ref *param_1)
...
void RefCounted::_bind_methods(void)

{
  ...
  D_METHODP((char *)local_78,(char ***)"init_ref",0);
  local_50 = (undefined1  [16])0x0;
  local_58 = 0;
  pMVar4 = create_method_bind<RefCounted,bool>(init_ref);
  ClassDB::bind_methodfi(1,pMVar4,false,(MethodDefinition *)local_78,(Variant_conflict **)0x0,0);
  ...
  D_METHODP((char *)local_78,(char ***)"reference",0);
  local_50 = (undefined1  [16])0x0;
  local_58 = 0;
  pMVar4 = create_method_bind<RefCounted,bool>(reference);
  ClassDB::bind_methodfi(1,pMVar4,false,(MethodDefinition *)local_78,(Variant_conflict **)0x0,0);
  if (Variant::needs_deinit[(int)local_58] != '\0') {
    Variant::_clear_internal();
  }
  ...
  D_METHODP((char *)local_78,(char ***)"unreference",0);
  local_50 = (undefined1  [16])0x0;
  local_58 = 0;
  pMVar4 = create_method_bind<RefCounted,bool>(unreference);
  ClassDB::bind_methodfi(1,pMVar4,false,(MethodDefinition *)local_78,(Variant_conflict **)0x0,0);
  if (Variant::needs_deinit[(int)local_58] != '\0') {
    Variant::_clear_internal();
  }
  ...
  D_METHODP((char *)local_78,(char ***)"get_reference_count",0);
  local_50 = (undefined1  [16])0x0;
  local_58 = 0;
  pMVar4 = create_method_bind<RefCounted,int>(get_reference_count);
  ClassDB::bind_methodfi(1,pMVar4,false,(MethodDefinition *)local_78,(Variant_conflict **)0x0,0);
  if (Variant::needs_deinit[(int)local_58] != '\0') {
    Variant::_clear_internal();
  }
...
/* WeakRef::_bind_methods() */

void WeakRef::_bind_methods(void)

{
  ...
  D_METHODP((char *)local_68,(char ***)"get_ref",0);
  local_40 = (undefined1  [16])0x0;
  local_48 = 0;
  pMVar4 = create_method_bind<WeakRef,Variant>(get_ref);
  ClassDB::bind_methodfi(1,pMVar4,false,(MethodDefinition *)local_68,(Variant_conflict **)0x0,0);
...

{
  return (uint)CONCAT71(0x103e,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x103d,(undefined4 *)param_1 == &get_class_ptr_static()::ptr);
}
...
{
  *(undefined ***)this = &PTR__gen_argument_type_00103ce8;
...
{
  *(undefined ***)this = &PTR__gen_argument_type_00103d48;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...
{
  *(undefined ***)this = &PTR__gen_argument_type_00103da8;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...
/* MethodBind* create_method_bind<RefCounted, bool>(bool (RefCounted::*)()) */

MethodBind * create_method_bind<RefCounted,bool>(_func_bool *param_1)
...
/* MethodBind* create_method_bind<RefCounted, int>(int (RefCounted::*)() const) */

MethodBind * create_method_bind<RefCounted,int>(_func_int *param_1)
...
/* RefCounted::_bind_methods() [clone .cold] */
...
/* WeakRef::_bind_methods() [clone .cold] */
...
/* MethodBind* create_method_bind<WeakRef, Variant>(Variant (WeakRef::*)() const) */

MethodBind * create_method_bind<WeakRef,Variant>(_func_Variant_conflict *param_1)
...
/* WARNING: Removing unreachable block (ram,0x001022b8) */
/* WARNING: Removing unreachable block (ram,0x00102480) */
/* WARNING: Removing unreachable block (ram,0x001022c4) */
/* WARNING: Removing unreachable block (ram,0x001022ce) */
/* WARNING: Removing unreachable block (ram,0x00102460) */
/* WARNING: Removing unreachable block (ram,0x001022da) */
/* WARNING: Removing unreachable block (ram,0x001022e4) */
...
/* WARNING: Removing unreachable block (ram,0x00102420) */
/* WARNING: Removing unreachable block (ram,0x00102306) */
/* WARNING: Removing unreachable block (ram,0x00102310) */
/* WARNING: Removing unreachable block (ram,0x00102400) */
/* WARNING: Removing unreachable block (ram,0x0010231c) */
/* WARNING: Removing unreachable block (ram,0x00102326) */
/* WARNING: Removing unreachable block (ram,0x001023e0) */
/* WARNING: Removing unreachable block (ram,0x00102332) */
/* WARNING: Removing unreachable block (ram,0x0010233c) */
/* WARNING: Removing unreachable block (ram,0x001023c0) */
/* WARNING: Removing unreachable block (ram,0x00102344) */
/* WARNING: Removing unreachable block (ram,0x0010235a) */
/* WARNING: Removing unreachable block (ram,0x00102366) */
  ...
  *(undefined1 (*) [16])(param_1 + 8) = (undefined1  [16])0x0;
  if (((plVar7 != (long *)0x0) && (plVar7[1] != 0)) && (*(char *)(plVar7[1] + 0x2e) != '\0')) {
    ...
    if (local_58 == (char *)*plVar6) {
      ...
      String::parse_latin1((StrRange *)&local_60);
      vformat<StringName>((StringName *)&local_58,(StrRange *)&local_60,&local_68);
      _err_print_error(&_LC23,"./core/object/method_bind.h",0x207,
                       "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: ret"
                       ,(StringName *)&local_58,0,0);
      pcVar3 = local_58;
      if (local_58 != (char *)0x0) {
  ...
  if (in_R8D == 0) {
    if ((param_2[5] == (Variant_conflict *)0x0) || (-1 < *(int *)(param_2[5] + -8))) {
      *in_R9 = 0;
      ...
      Variant::Variant((Variant_conflict *)local_48,bVar4);
      if (Variant::needs_deinit[*(int *)param_1] != '\0') {
        Variant::_clear_internal();
      }
      *(undefined4 *)param_1 = local_48[0];
...
MethodBindTR<bool>::validated_call
          (MethodBindTR<bool> *this,Object *param_1,Variant_conflict **param_2,
          Variant_conflict *param_3)

{
  long lVar1;
  char *pcVar2;
  Variant_conflict VVar3;
  long *plVar5;
  long in_FS_OFFSET;
  long local_58;
  long local_50;
  ...
  VVar3 = (Variant_conflict)(*pcVar4)(param_1 + *(long *)(this + 0x60));
  param_3[8] = VVar3;
LAB_00103702:
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;

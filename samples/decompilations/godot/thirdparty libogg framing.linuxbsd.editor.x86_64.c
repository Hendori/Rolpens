  ...
  if (param_1 != (undefined8 *)0x0) {
    ...
    *param_1 = 0;
    ...
    for (uVar1 = (ulong)(((int)param_1 -
                         (int)(undefined8 *)((ulong)(param_1 + 1) & 0xfffffffffffffff8)) + 0x198U >>
...

{
  ...
  if (param_1 != (long *)0x0) {
    ...
    *(char *)(*param_1 + 0x17) = (char)((uint)uVar2 >> 8);
    *(char *)(*param_1 + 0x18) = (char)((uint)uVar2 >> 0x10);
    *(char *)(*param_1 + 0x19) = (char)((uint)uVar2 >> 0x18);
    return;
  }
  return;
}
...
LAB_00100723:
  if (((int)param_1[0x2e] != 0) && (lVar2 == lVar8)) {
...
undefined8
ogg_stream_iovecin(long *param_1,undefined8 *param_2,int param_3,long param_4,long param_5)

{
  ...
  if (param_2 != (undefined8 *)0x0) {
    if (param_3 < 1) {
      ...
      lVar10 = (SUB168(SEXT816(-0x7f7f7f7f7f7f7f7f) * SEXT816(lVar11),8) + lVar11 >> 7) -
               (lVar11 >> 0x3f);
      local_48 = lVar10 + 1;
    }
    lVar8 = param_1[3];
    ...
    lVar5 = param_1[7];
    *(int *)(lVar8 + (lVar10 + lVar5) * 4) =
         (int)lVar11 +
         ((int)(SUB168(SEXT816(-0x7f7f7f7f7f7f7f7f) * SEXT816(lVar11),8) + lVar11 >> 7) -
         (int)(lVar11 >> 0x3f)) * -0xff;
...
{
  if ((-1 < *(int *)(param_1 + 8)) &&
     (*(int *)(param_1 + 0xc) + param_2 <= (long)*(int *)(param_1 + 8))) {
...

{
  ...
  if (((bVar2 & 1) == 0) ||
     (((0 < param_1[7] &&
       (uVar6 = *(uint *)(param_1[4] + -4 + param_1[7] * 4), (uVar6 & 0xff) == 0xff)) &&
      (uVar6 != 0x400)))) {
    iVar10 = 0;
...
LAB_00101472:
    iVar11 = _os_body_expand(param_1,__n_00);
    if (iVar11 != 0) {
      return 0xffffffff;
    }

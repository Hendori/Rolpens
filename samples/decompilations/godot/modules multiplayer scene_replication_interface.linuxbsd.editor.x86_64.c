...
undefined8 __thiscall
HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
::_lookup_pos(HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
...
undefined8 __thiscall
HashMap<ObjectID,SceneReplicationInterface::TrackedNode,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,SceneReplicationInterface::TrackedNode>>>
::_lookup_pos(HashMap<ObjectID,SceneReplicationInterface::TrackedNode,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,SceneReplicationInterface::TrackedNode>>>
...
void __thiscall
HashMap<ObjectID,unsigned_long,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,unsigned_long>>>
::erase(HashMap<ObjectID,unsigned_long,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,unsigned_long>>>
...
void __thiscall
HashMap<unsigned_int,ObjectID,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,ObjectID>>>
::erase(HashMap<unsigned_int,ObjectID,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,ObjectID>>>
        *this,uint *param_1)
...
void __thiscall
HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>>::erase
          (HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>> *this,
          ObjectID *param_1)
...
/* SceneReplicationInterface::_free_remotes(SceneReplicationInterface::PeerInfo const&) */

void __thiscall
SceneReplicationInterface::_free_remotes(SceneReplicationInterface *this,PeerInfo *param_1)
...
joined_r0x00100d61:
  ...
  if ((*(long *)(this + 0x1c0) != 0) && (*(int *)(this + 0x1e4) != 0)) {
    ...
    if (uVar14 != 0) {
      uVar20 = 0;
      while (((uint)uVar18 != uVar14 ||
             (uVar3 != *(ulong *)(*(long *)(*(long *)(this + 0x1c0) + lVar17 * 8) + 0x10)))) {
        uVar20 = uVar20 + 1;
        auVar5._8_8_ = 0;
        ...
        if ((uVar14 == 0) ||
           (auVar6._8_8_ = 0, auVar6._0_8_ = (ulong)uVar14 * lVar13, auVar10._8_8_ = 0,
           auVar10._0_8_ = uVar19, auVar7._8_8_ = 0,
           auVar7._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                            (ulong)*(uint *)(this + 0x1e0) * 4) + iVar16) -
                                 SUB164(auVar6 * auVar10,8)) * lVar13, auVar11._8_8_ = 0,
           auVar11._0_8_ = uVar19, SUB164(auVar7 * auVar11,8) < uVar20)) goto LAB_00100fa0;
      }
      if (uVar3 != 0) {
...
LAB_00100eb0:
  ...
  if ((uVar3 >> 0x18 & 0x7fffffffff) == (*puVar15 & 0x7fffffffff)) {
    ...
    if ((uVar3 != 0) &&
       (lVar13 = __dynamic_cast(uVar3,&Object::typeinfo,&Node::typeinfo,0), lVar13 != 0)) {
      Node::queue_free();
      goto LAB_00100f27;
    }
  }
...
LAB_00100fa0:
  _err_print_error("_free_remotes","modules/multiplayer/scene_replication_interface.cpp",0x56,
...
/* SceneReplicationInterface::_has_authority(Node const*) */

bool SceneReplicationInterface::_has_authority(Node *param_1)
...
void __thiscall SceneReplicationInterface::on_reset(SceneReplicationInterface *this)

{
  ...
  for (puVar2 = *(undefined8 **)(this + 0x198); puVar2 != (undefined8 *)0x0;
...
LAB_001012b8:
  ...
  do {
    ...
    while( true ) {
      ...
      if (uVar11 != 0) break;
LAB_00101285:
      _err_print_error("on_reset","modules/multiplayer/scene_replication_interface.cpp",0x7c,
                       "Condition \"!sync\" is true. Continuing.",0,0);
      iVar6 = (int)lVar10;
    }
  } while( true );
}
...
/* SceneReplicationInterface::is_rpc_visible(ObjectID const&, int) const */

undefined8 __thiscall
SceneReplicationInterface::is_rpc_visible
          (SceneReplicationInterface *this,ObjectID *param_1,int param_2)
  ...
  if ((lVar40 != 0) && (*(int *)(this + 0x1e4) != 0)) {
    ...
    if (uVar44 != 0) {
      ...
      do {
        ...
        {
          if (param_2 < 0) {
            _err_print_error("is_rpc_visible","modules/multiplayer/scene_replication_interface.cpp",
                             0x135,"Condition \"p_peer < 0\" is true. Returning: false",0,0);
            uVar29 = 0;
            goto LAB_00101685;
          }
          uVar42 = 0;
        ...
        uVar31 = SUB164(auVar5 * auVar16,8);
              ...
              (auVar6._8_8_ = 0, auVar6._0_8_ = (ulong)uVar42 * lVar2, auVar17._8_8_ = 0,
              auVar17._0_8_ = uVar43, auVar7._8_8_ = 0,
              auVar7._0_8_ = (ulong)((uVar33 + uVar31) - SUB164(auVar6 * auVar17,8)) * lVar2,
              auVar18._8_8_ = 0, auVar18._0_8_ = uVar43, uVar45 <= SUB164(auVar7 * auVar18,8)));
    }
  }
  goto LAB_00101680;
LAB_00101519:
  if ((uVar38 != uVar44) || (pOVar1 != *(ObjectID **)(*(long *)(lVar40 + lVar34 * 8) + 0x10)))
  goto LAB_001014d0;
  lVar40 = *(long *)(lVar40 + (ulong)uVar30 * 8);
  iVar32 = *(int *)(lVar40 + 0x54);
  if ((iVar32 == 0) || ((*(int *)(lVar40 + 0x24) != 0 && (*(int *)(lVar40 + 0x24) == param_2))))
  goto LAB_00101680;
  cVar27 = HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>>::_lookup_pos
                     ((HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>> *)
                      (this + 0x1e8),pOVar1,&local_44);
  if (cVar27 == '\0') {
...
LAB_00101782:
        _err_print_error("is_rpc_visible","modules/multiplayer/scene_replication_interface.cpp",
                         0x14c,"Condition \"!sync\" is true. Continuing.",0,0);
      }
    }
    goto LAB_00101680;
  }
  ...
  cVar27 = HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
           ::_lookup_pos((HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
                          *)(this + 0x180),(int *)(ulong)(uint)param_2,&local_44);
  ...
  cVar27 = HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
           ::_lookup_pos((HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
                          *)(this + 0x180),(int *)(ulong)(uint)param_2,&local_44);
  if (cVar27 != '\0') {
    uVar29 = HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>>::_lookup_pos
                       ((HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>> *
                        )(*(long *)(*(long *)(this + 0x188) + (ulong)local_44 * 8) + 0x40),pOVar1,
                        &local_44);
    goto LAB_00101685;
  }
  goto LAB_00101829;
LAB_001014d0:
  ...
  if ((uVar44 == 0) ||
     (auVar9._8_8_ = 0, auVar9._0_8_ = (ulong)uVar44 * lVar2, auVar20._8_8_ = 0,
     auVar20._0_8_ = uVar43, auVar10._8_8_ = 0,
     auVar10._0_8_ = (ulong)((uVar33 + uVar30) - SUB164(auVar9 * auVar20,8)) * lVar2,
     auVar21._8_8_ = 0, auVar21._0_8_ = uVar43, SUB164(auVar10 * auVar21,8) < uVar42))
  goto LAB_00101829;
  goto LAB_00101519;
LAB_00101765:
  uVar29 = 0;
...
LAB_00101829:
  ...
  while( true ) {
    ...
    uVar44 = 0;
    while ((uVar38 != uVar33 ||
           (pOVar1 != *(ObjectID **)(plVar41[8] + (ulong)*(uint *)(plVar41[9] + lVar36 * 4) * 8))))
    {
      uVar44 = uVar44 + 1;
      auVar12._8_8_ = 0;
      ...
      if ((uVar33 == 0) ||
         (auVar13._8_8_ = 0, auVar13._0_8_ = (ulong)uVar33 * lVar40, auVar24._8_8_ = 0,
         auVar24._0_8_ = uVar28, auVar14._8_8_ = 0,
         auVar14._0_8_ =
              (ulong)((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(plVar41 + 0xc) * 4) +
                      iVar32) - SUB164(auVar13 * auVar24,8)) * lVar40, auVar25._8_8_ = 0,
         auVar25._0_8_ = uVar28, SUB164(auVar14 * auVar25,8) < uVar44)) goto LAB_00101765;
    }
    plVar41 = (long *)*plVar41;
    if (plVar41 == (long *)0x0) break;
LAB_001015a0:
    if ((plVar41[8] == 0) || (*(int *)((long)plVar41 + 100) == 0)) goto LAB_00101765;
  }
LAB_00101680:
  uVar29 = 1;
LAB_00101685:
...
/* SceneReplicationInterface::_send_raw(unsigned char const*, int, int, bool) */

undefined4 __thiscall
SceneReplicationInterface::_send_raw
          (SceneReplicationInterface *this,uchar *param_1,int param_2,int param_3,bool param_4)

{
  ...
  if ((param_1 == (uchar *)0x0) || (param_2 < 1)) {
    uVar2 = 0x1f;
    _err_print_error("_send_raw","modules/multiplayer/scene_replication_interface.cpp",0x1cb,
                     "Condition \"!p_buffer || p_size < 1\" is true. Returning: ERR_INVALID_PARAMETER"
                     ,0,0);
  }
  else {
    ...
    if (local_38 == (Object *)0x0) {
      uVar2 = 3;
      _err_print_error("_send_raw","modules/multiplayer/scene_replication_interface.cpp",0x1ce,
      ...
      uVar2 = SceneMultiplayer::send_command
                        ((int)*(undefined8 *)(this + 0x288),(uchar *)(ulong)(uint)param_3,
                         (int)param_1);
    }
    if (local_38 != (Object *)0x0) {
      cVar1 = RefCounted::unreference();
...
/* SceneReplicationInterface::_verify_synchronizer(int, MultiplayerSynchronizer*, unsigned int&) */

undefined4 __thiscall
SceneReplicationInterface::_verify_synchronizer
          (SceneReplicationInterface *this,int param_1,MultiplayerSynchronizer *param_2,
          uint *param_3)

{
  ...
  *param_3 = uVar2;
  if ((int)uVar2 < 1) {
    uVar3 = SceneCacheInterface::send_object_cache
                      (*(Object **)(this + 0x290),(uint)param_2,(int *)(ulong)(uint)param_1);
    if (*param_3 == 0) {
      *param_3 = 0x80000000;
...
/* SceneReplicationInterface::set_max_sync_packet_size(int) */

void __thiscall
SceneReplicationInterface::set_max_sync_packet_size(SceneReplicationInterface *this,int param_1)

{
  ...
  _err_print_error("set_max_sync_packet_size","modules/multiplayer/scene_replication_interface.cpp",
                   0x389,"Condition \"p_size < 128\" is true.",
                   "Sync maximum packet size must be at least 128 bytes.",0,0);
  return;
}



/* SceneReplicationInterface::get_max_sync_packet_size() const */

undefined4 __thiscall
SceneReplicationInterface::get_max_sync_packet_size(SceneReplicationInterface *this)
...
/* SceneReplicationInterface::set_max_delta_packet_size(int) */

void __thiscall
SceneReplicationInterface::set_max_delta_packet_size(SceneReplicationInterface *this,int param_1)

{
  ...
  _err_print_error("set_max_delta_packet_size","modules/multiplayer/scene_replication_interface.cpp"
                   ,0x392,"Condition \"p_size < 128\" is true.",
                   "Sync maximum packet size must be at least 128 bytes.",0,0);
  return;
}
...
/* SceneReplicationInterface::get_max_delta_packet_size() const */

undefined4 __thiscall
SceneReplicationInterface::get_max_delta_packet_size(SceneReplicationInterface *this)
...
/* SceneReplicationInterface::_track(ObjectID const&) */

void __thiscall SceneReplicationInterface::_track(SceneReplicationInterface *this,ObjectID *param_1)
    ...
    if (uVar15 != 0) {
      ...
      do {
        if ((uVar15 == (uint)uVar19) &&
           (lVar1 == *(long *)(*(long *)(*(long *)(this + 0x1c0) + lVar18 * 8) + 0x10)))
        goto LAB_00101d20;
        uVar21 = uVar21 + 1;
        auVar6._8_8_ = 0;
        ...
        iVar17 = SUB164(auVar6 * auVar10,8);
              ...
              (auVar7._8_8_ = 0, auVar7._0_8_ = (ulong)uVar15 * lVar2, auVar11._8_8_ = 0,
              auVar11._0_8_ = uVar20, auVar8._8_8_ = 0,
              auVar8._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                               (ulong)*(uint *)(this + 0x1e0) * 4) + iVar17) -
                                    SUB164(auVar7 * auVar11,8)) * lVar2, auVar12._8_8_ = 0,
              auVar12._0_8_ = uVar20, uVar21 <= SUB164(auVar8 * auVar12,8)));
    }
  }
  plVar14 = (long *)HashMap<ObjectID,SceneReplicationInterface::TrackedNode,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,SceneReplicationInterface::TrackedNode>>>
                    ::operator[]((HashMap<ObjectID,SceneReplicationInterface::TrackedNode,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,SceneReplicationInterface::TrackedNode>>>
                                  *)(this + 0x1b8),param_1);
  *plVar14 = lVar1;
  ...
  if (pvVar3 != (void *)0x0) {
    if (*(int *)((long)plVar14 + 0x3c) != 0) {
      if (*(uint *)(hash_table_size_primes + (ulong)*(uint *)(plVar14 + 7) * 4) != 0) {
        memset((void *)plVar14[6],0,
               (ulong)*(uint *)(hash_table_size_primes + (ulong)*(uint *)(plVar14 + 7) * 4) * 4);
      }
    ...
    if (uVar15 < (uint)ObjectDB::slot_max) {
      ...
      if ((uVar13 >> 0x18 & 0x7fffffffff) == (*puVar16 & 0x7fffffffff)) {
        ...
        if (uVar13 != 0) {
          ...
          create_custom_callable_function_pointer<SceneReplicationInterface,ObjectID_const&>
                    (local_68,(char *)this,
                     (_func_void_ObjectID_ptr *)"&SceneReplicationInterface::_untrack");
...
/* SceneReplicationInterface::on_spawn(Object*, Variant) */

undefined8 __thiscall
SceneReplicationInterface::on_spawn(SceneReplicationInterface *this,long param_1,int *param_3)

{
  ...
  if (param_1 == 0) {
LAB_00102080:
    _err_print_error("on_spawn","modules/multiplayer/scene_replication_interface.cpp",0x9f,
                     "Condition \"!node || p_config.get_type() != Variant::OBJECT\" is true. Returning: ERR_INVALID_PARAMETER"
                     ,0,0);
  }
  else {
      ...
      if (lVar3 != 0) {
        ...
        if (*(long *)(lVar4 + 0x10) == 0) {
          *(undefined8 *)(lVar4 + 0x10) = *(undefined8 *)(lVar3 + 0x60);
          ...
          create_custom_callable_function_pointer<SceneReplicationInterface,ObjectID_const&>
                    (local_58,(char *)this,
                     (_func_void_ObjectID_ptr *)"&SceneReplicationInterface::_node_ready");
          ...
          _err_print_error("on_spawn","modules/multiplayer/scene_replication_interface.cpp",0xa7,
                           "Condition \"tobj.spawner != ObjectID()\" is true. Returning: ERR_ALREADY_IN_USE"
                           ,0,0);
          uVar5 = 0x16;
        }
        goto LAB_0010205c;
    ...
    _err_print_error("on_spawn","modules/multiplayer/scene_replication_interface.cpp",0xa1,
                     "Parameter \"spawner\" is null.",0,0);
  }
  uVar5 = 0x1f;
LAB_0010205c:
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
...
/* SceneReplicationInterface::on_replication_stop(Object*, Variant) */

undefined8 __thiscall
SceneReplicationInterface::on_replication_stop
          (SceneReplicationInterface *this,long param_1,int *param_3)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (((param_1 == 0) ||
      (lVar11 = __dynamic_cast(param_1,&Object::typeinfo,&Node::typeinfo,0), lVar11 == 0)) ||
     (*param_3 != 0x18)) {
    _err_print_error("on_replication_stop","modules/multiplayer/scene_replication_interface.cpp",
                     0x110,
                     "Condition \"!node || p_config.get_type() != Variant::OBJECT\" is true. Returning: ERR_INVALID_PARAMETER"
                     ,0,0);
  }
    ...
    if ((lVar12 == 0) ||
       (plVar13 = (long *)__dynamic_cast(lVar12,&Object::typeinfo,&MultiplayerSynchronizer::typeinfo
                                         ,0), plVar13 == (long *)0x0)) {
      _err_print_error("on_replication_stop","modules/multiplayer/scene_replication_interface.cpp",
                       0x112,"Parameter \"sync\" is null.",0,0);
    }
    else {
      pcVar1 = *(code **)(*plVar13 + 0x110);
      create_custom_callable_function_pointer<SceneReplicationInterface,int,ObjectID>
                ((SceneReplicationInterface *)local_58,(char *)this,
                 (_func_void_int_ObjectID *)"&SceneReplicationInterface::_visibility_changed");
        ...
        if (uVar16 != 0) {
          ...
          do {
            if ((uVar16 == (uint)uVar19) &&
               (local_60 == *(long *)(*(long *)(*(long *)(this + 0x1c0) + lVar12 * 8) + 0x10))) {
              lVar11 = _track(this,(ObjectID *)&local_60);
              HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>>::erase
                        ((HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>>
                          *)(lVar11 + 0x18),(ObjectID *)local_58);
              HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>>::erase
                        ((HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>>
                          *)(this + 0x210),(ObjectID *)local_58);
              for (plVar13 = *(long **)(this + 0x198); plVar13 != (long *)0x0;
                  plVar13 = (long *)*plVar13) {
                while( true ) {
                  HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>>::erase
                            ((HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>>
                              *)(plVar13 + 3),(ObjectID *)local_58);
                  HashMap<ObjectID,unsigned_long,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,unsigned_long>>>
                  ::erase((HashMap<ObjectID,unsigned_long,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,unsigned_long>>>
                           *)(plVar13 + 0xd),(ObjectID *)local_58);
...
LAB_001023d4:
            ...
            iVar10 = SUB164(auVar3 * auVar7,8);
                  ...
                  (auVar4._8_8_ = 0, auVar4._0_8_ = (ulong)uVar16 * lVar11, auVar8._8_8_ = 0,
                  auVar8._0_8_ = uVar17, auVar5._8_8_ = 0,
                  auVar5._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                                   (ulong)*(uint *)(this + 0x1e0) * 4) + iVar10) -
                                        SUB164(auVar4 * auVar8,8)) * lVar11, auVar9._8_8_ = 0,
                  auVar9._0_8_ = uVar17, uVar18 <= SUB164(auVar5 * auVar9,8)));
        }
      }
      _err_print_error("on_replication_stop","modules/multiplayer/scene_replication_interface.cpp",
                       0x117,
                       "Condition \"!tracked_nodes.has(oid)\" is true. Returning: ERR_INVALID_PARAMETER"
                       ,0,0);
    }
  }
  uVar15 = 0x1f;
...
/* SceneReplicationInterface::_send_sync(int, HashSet<ObjectID, HashMapHasherDefault,
   HashMapComparatorDefault<ObjectID> > const&, unsigned short, unsigned long) */

void SceneReplicationInterface::_send_sync
               (int param_1,HashSet *param_2,ushort param_3,ulong param_4)

{
  ...
  if (lVar21 < *(int *)(this_00 + 0x2a8) + 0xb) {
    CowData<unsigned_char>::resize<false>
              ((CowData<unsigned_char> *)(this_00 + 0x2a0),(long)(*(int *)(this_00 + 0x2a8) + 0xb));
  }
...
LAB_0010339d:
  ...
  do {
    ...
    ObjectDB::spin_lock._0_1_ = '\0';
    if (uVar15 == 0) goto LAB_00102f72;
    pMVar11 = (MultiplayerSynchronizer *)
              __dynamic_cast(uVar15,&Object::typeinfo,&MultiplayerSynchronizer::typeinfo,0);
    ...
    if (cVar9 != '\0') {
      ...
      if (pOVar13 == (Object *)0x0) {
        _err_print_error("_send_sync","modules/multiplayer/scene_replication_interface.cpp",0x333,
                         "Condition \"!node\" is true. Continuing.");
      }
      else {
        ...
        if (cVar9 != '\0') {
          ...
          if (((long *)*plVar14 != (long *)0x0) &&
             (pNVar18 = *(NodePath **)*plVar14, pNVar18 != (NodePath *)0x0)) {
...
LAB_00102d68:
          iVar10 = MultiplayerSynchronizer::get_state((List *)&local_a8,pOVar13,local_88,local_78);
          if (iVar10 == 0) {
            ...
            iVar10 = MultiplayerAPI::encode_and_compress_variants
                               (local_70,iVar10,(uchar *)0x0,(int *)&local_ac,(bool *)0x0,false);
            if (iVar10 == 0) {
              if (*(int *)(this_00 + 0x2a8) < (int)local_ac) {
                ...
                vformat<int,int,NodePath>
                          ((StringName *)&local_68,(StrRange *)&local_90,uVar16,uVar4,
                           (NodePath *)&local_98);
                _err_print_error("_send_sync","modules/multiplayer/scene_replication_interface.cpp",
                                 0x342,"Condition \"size > sync_mtu\" is true. Continuing.",
                ...
                if (*(int *)(this_00 + 0x2a8) < (int)(local_e0 + 8 + local_ac)) {
                  _send_raw((SceneReplicationInterface *)this_00,*(uchar **)(this_00 + 0x2a0),
                            local_e0,iVar20,false);
                  local_e0 = 3;
                }
                if (local_ac != 0) {
                  ...
                  MultiplayerAPI::encode_and_compress_variants
                            (local_70,iVar10,puVar5 + (local_e0 + 8),(int *)&local_ac,(bool *)0x0,
                             false);
                ...
                if (cVar9 != '\0') {
                  ...
                  EngineDebugger::profiler_add_frame_data
                            ((StringName *)&local_68,(Array *)&local_90);
                  if ((StringName::configured != '\0') && (local_68 != (char *)0x0)) {
                    StringName::unref();
                  }
                  Array::~Array((Array *)&local_90);
              ...
              _err_print_error("_send_sync","modules/multiplayer/scene_replication_interface.cpp",
                               0x340,"Condition \"err != OK\" is true. Continuing.",
                               "Unable to encode sync state.",0,0);
            }
          }
          else {
            _err_print_error("_send_sync","modules/multiplayer/scene_replication_interface.cpp",
                             0x33e,"Condition \"err != OK\" is true. Continuing.",
                             "Unable to retrieve sync state.",0,0);
          }
    ...
    while( true ) {
      if (iVar3 <= (int)lVar21 + 1) {
        ...
        if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
          _send_raw((SceneReplicationInterface *)this_00,*(uchar **)(this_00 + 0x2a0),local_e0,
                    iVar20,false);
          return;
        }
        goto LAB_0010339d;
      ...
      if (uVar15 != 0) break;
LAB_00102f72:
      _err_print_error("_send_sync","modules/multiplayer/scene_replication_interface.cpp",0x32d,
                       "Condition \"!sync || !sync->get_replication_config_ptr() || !_has_authority(sync)\" is true. Continuing."
                      );
    }
  } while( true );
}
...
/* SceneReplicationInterface::_make_spawn_packet(Node*, MultiplayerSpawner*, int&) */

int __thiscall
SceneReplicationInterface::_make_spawn_packet
          (SceneReplicationInterface *this,Node *param_1,MultiplayerSpawner *param_2,int *param_3)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (((*(long *)(this + 0x288) == 0) || (param_1 == (Node *)0x0)) ||
     (param_2 == (MultiplayerSpawner *)0x0)) {
    iVar21 = 0x2f;
    _err_print_error("_make_spawn_packet","modules/multiplayer/scene_replication_interface.cpp",
                     0x1d5,
                     "Condition \"!multiplayer || !p_node || !p_spawner\" is true. Returning: ERR_BUG"
                     ,0,0);
    goto LAB_00103db3;
  }
  ...
  if ((lVar41 != 0) && (*(int *)(this + 0x1e4) != 0)) {
    ...
    if (uVar35 != 0) {
      uVar40 = 0;
LAB_00103512:
      if (((uint)uVar33 != uVar35) || (local_d8 != *(long *)(*(long *)(lVar41 + lVar32 * 8) + 0x10))
         ) goto LAB_001034c8;
      ...
      if (local_104 == 0) {
        ...
        *(uint *)(lVar41 + 0x20) = local_104;
        if (local_104 == 0) {
          iVar21 = 3;
          _err_print_error("_make_spawn_packet",
                           "modules/multiplayer/scene_replication_interface.cpp",0x1e0,
                           "Condition \"!nid\" is true. Returning: ERR_UNCONFIGURED",0,0);
          goto LAB_00103db3;
        }
      }
      ...
      local_e0 = 0;
      if ((cVar17 == -1) &&
         (iVar21 = MultiplayerAPI::encode_and_compress_variant
                             ((Variant *)local_58,(uchar *)0x0,(int *)&local_e0,false), iVar21 != 0)
         ) {
        _err_print_error("_make_spawn_packet","modules/multiplayer/scene_replication_interface.cpp",
                         0x1e9,"Condition \"err\" is true. Returning: err",0,0);
        goto LAB_00103d9a;
      }
      ...
      HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>>::_init_from
                ((HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>> *)
                 local_88,(HashSet *)(lVar41 + 0x30));
...
LAB_00103816:
      ...
      if ((local_d0 != (undefined1 (*) [16])0x0) && (*(int *)local_d0[1] != 0)) {
        iVar21 = MultiplayerSynchronizer::get_state
                           ((List *)&local_d0,(Object *)param_1,local_b8,local_a8);
        if (iVar21 == 0) {
          ...
          iVar21 = MultiplayerAPI::encode_and_compress_variants
                             (local_a0,iVar21,(uchar *)0x0,&local_dc,(bool *)0x0,false);
          if (iVar21 == 0) goto LAB_0010385b;
          _err_print_error("_make_spawn_packet",
                           "modules/multiplayer/scene_replication_interface.cpp",0x207,
                           "Condition \"err != OK\" is true. Returning: err",
                           "Unable to encode spawn state.",0,0);
        }
        else {
          _err_print_error("_make_spawn_packet",
                           "modules/multiplayer/scene_replication_interface.cpp",0x205,
                           "Condition \"err != OK\" is true. Returning: err",
                           "Unable to retrieve spawn state.",0,0);
        }
        goto LAB_00103b29;
      }
LAB_0010385b:
      uVar35 = SceneCacheInterface::make_object_cache(*(Object **)(this + 0x290));
      uVar22 = (ulong)uVar35;
      Node::get_name();
      if (local_c8 == 0) {
LAB_00103fa0:
...
LAB_001038d4:
      ...
      if (lVar41 < iVar21 + local_dc) {
        CowData<unsigned_char>::resize<false>
                  ((CowData<unsigned_char> *)(this + 0x2a0),(long)(iVar21 + local_dc));
      }
      ...
      *puVar4 = 4;
      ...
      if ((pauVar30 == (undefined1 (*) [16])0x0) ||
         (puVar38 = *(uint **)*pauVar30, puVar38 == (uint *)0x0)) {
        iVar21 = 0x12;
        iVar19 = 0x13;
...
LAB_00103a51:
      ...
      if (cVar17 == -1) {
        ...
        iVar21 = MultiplayerAPI::encode_and_compress_variant
                           ((Variant *)local_58,puVar4 + (iVar19 + 4),(int *)&local_e0,false);
        if (iVar21 == 0) {
          iVar19 = iVar19 + 4 + local_e0;
          goto LAB_00103a8e;
        }
        _err_print_error("_make_spawn_packet","modules/multiplayer/scene_replication_interface.cpp",
                         0x21f,"Condition \"err\" is true. Returning: err",0,0);
      }
      else {
LAB_00103a8e:
        if (local_dc != 0) {
          ...
          CowData<Variant_const*>::_copy_on_write((CowData<Variant_const*> *)&local_a0);
          iVar21 = MultiplayerAPI::encode_and_compress_variants
                             (local_a0,iVar21,puVar4 + iVar19,&local_dc,(bool *)0x0,false);
          if (iVar21 != 0) {
            _err_print_error("_make_spawn_packet",
                             "modules/multiplayer/scene_replication_interface.cpp",0x225,
...
LAB_00103e53:
  iVar21 = 0x1f;
  _err_print_error("_make_spawn_packet","modules/multiplayer/scene_replication_interface.cpp",0x1d9,
                   "Parameter \"tnode\" is null.",0,0);
LAB_00103db3:
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return iVar21;
  }
...
LAB_001034c8:
  ...
  if ((uVar35 == 0) ||
     (auVar8._8_8_ = 0, auVar8._0_8_ = (ulong)uVar35 * lVar23, auVar12._8_8_ = 0,
     auVar12._0_8_ = uVar39, auVar9._8_8_ = 0,
     auVar9._0_8_ = (ulong)((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x1e0) * 4)
                            + uVar36) - SUB164(auVar8 * auVar12,8)) * lVar23, auVar13._8_8_ = 0,
     auVar13._0_8_ = uVar39, SUB164(auVar9 * auVar13,8) < uVar40)) goto LAB_00103e53;
  goto LAB_00103512;
LAB_0010360e:
  uVar35 = (uint)uVar22 & 0xffffff;
  ...
  if (cVar18 != '\0') {
    ...
    if (lVar32 == 0) {
      iVar21 = 0x2f;
      _err_print_error("_make_spawn_packet","modules/multiplayer/scene_replication_interface.cpp",
                       0x1f6,"Parameter \"sync->get_replication_config_ptr()\" is null.",0,0);
LAB_00103cb8:
      local_130 = (List<NodePath,DefaultAllocator> *)&local_d0;
      uVar15 = local_88._0_8_;
...
LAB_00103d90:
      List<NodePath,DefaultAllocator>::~List(local_130);
LAB_00103d9a:
      if (Variant::needs_deinit[local_58[0]] != '\0') {
        Variant::_clear_internal();
      }
    ...
    if (((long *)*plVar24 != (long *)0x0) &&
       (pNVar34 = *(NodePath **)*plVar24, pNVar34 != (NodePath *)0x0)) {
...
LAB_001037a4:
    iVar19 = MultiplayerSynchronizer::get_net_id();
    if (iVar19 == 0) {
...
LAB_00103bb2:
      _err_print_error("_make_spawn_packet","modules/multiplayer/scene_replication_interface.cpp",
                       0x1f5,"Condition \"!sync\" is true. Continuing.");
    }
  }
  goto LAB_0010360e;
}
...
/* SceneReplicationInterface::_make_despawn_packet(Node*, int&) */

undefined8 __thiscall
SceneReplicationInterface::_make_despawn_packet
          (SceneReplicationInterface *this,Node *param_1,int *param_2)
    ...
    if (uVar15 != 0) {
      ...
      do {
        if (((uint)uVar17 == uVar15) &&
           (*(long *)(param_1 + 0x60) == *(long *)(*(long *)(lVar1 + lVar16 * 8) + 0x10))) {
        ...
        uVar14 = SUB164(auVar5 * auVar9,8);
              ...
              auVar7._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                               (ulong)*(uint *)(this + 0x1e0) * 4) + uVar14) -
                                    SUB164(auVar6 * auVar10,8)) * lVar2, auVar11._8_8_ = 0,
              auVar11._0_8_ = uVar18, uVar19 <= SUB164(auVar7 * auVar11,8)));
    }
  }
  _err_print_error("_make_despawn_packet","modules/multiplayer/scene_replication_interface.cpp",
                   0x22f,"Parameter \"tnode\" is null.",0,0);
  return 0x1f;
}



/* SceneReplicationInterface::on_despawn(Object*, Variant) */

undefined4 __thiscall
SceneReplicationInterface::on_despawn(SceneReplicationInterface *this,long param_1,int *param_3)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (((param_1 == 0) ||
      (pNVar20 = (Node *)__dynamic_cast(param_1,&Object::typeinfo,&Node::typeinfo,0),
      pNVar20 == (Node *)0x0)) || (*param_3 != 0x18)) {
    _err_print_error("on_despawn","modules/multiplayer/scene_replication_interface.cpp",199,
                     "Condition \"!node || p_config.get_type() != Variant::OBJECT\" is true. Returning: ERR_INVALID_PARAMETER"
                     ,0,0);
  }
  else {
    ...
    if ((lVar21 == 0) ||
       (lVar21 = __dynamic_cast(lVar21,&Object::typeinfo,&MultiplayerSpawner::typeinfo,0),
       lVar21 == 0)) {
      _err_print_error("on_despawn","modules/multiplayer/scene_replication_interface.cpp",0xc9,
                       "Condition \"!p_obj || !spawner\" is true. Returning: ERR_INVALID_PARAMETER",
                       0,0);
    }
    else {
      local_4c = 0;
      ...
      if (iVar19 != 0) {
        uVar30 = 0x2f;
        _err_print_error("on_despawn","modules/multiplayer/scene_replication_interface.cpp",0xcd,
                         "Condition \"err != OK\" is true. Returning: ERR_BUG",0,0);
        goto LAB_001046fc;
      }
      ...
      if (plVar25 != (long *)0x0) {
        ...
        do {
          if ((plVar25[8] != 0) && (*(int *)((long)plVar25 + 100) != 0)) {
            ...
            if (uVar27 != 0) {
              uVar29 = 0;
              while ((uVar27 != (uint)uVar26 ||
                     (lVar23 != *(long *)(plVar25[8] + (ulong)*(uint *)(plVar25[9] + lVar24 * 4) * 8
                                         )))) {
                uVar29 = uVar29 + 1;
                auVar4._8_8_ = 0;
                ...
                if ((uVar27 == 0) ||
                   (auVar5._8_8_ = 0, auVar5._0_8_ = (ulong)uVar27 * lVar1, auVar13._8_8_ = 0,
                   auVar13._0_8_ = uVar22, auVar6._8_8_ = 0,
                   auVar6._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                                    (ulong)*(uint *)(plVar25 + 0xc) * 4) + iVar19) -
                                         SUB164(auVar5 * auVar13,8)) * lVar1, auVar14._8_8_ = 0,
                   auVar14._0_8_ = uVar22, SUB164(auVar6 * auVar14,8) < uVar29)) goto LAB_00104576;
              }
        ...
        if (uVar27 != 0) {
          ...
          do {
            if (((uint)uVar26 == uVar27) &&
               (lVar23 == *(long *)(*(long *)(*(long *)(this + 0x1c0) + lVar24 * 8) + 0x10))) {
              lVar23 = _track(this,(ObjectID *)&local_48);
              if (*(long *)(lVar21 + 0x60) == *(long *)(lVar23 + 0x10)) {
                *(undefined8 *)(lVar23 + 0x10) = 0;
                HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>>::erase
                          ((HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>>
                            *)(this + 0x1e8),(ObjectID *)&local_48);
                for (puVar2 = *(undefined8 **)(this + 0x198); uVar30 = 0,
                    puVar2 != (undefined8 *)0x0; puVar2 = (undefined8 *)*puVar2) {
                  HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>>::erase
                            ((HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>>
                              *)(puVar2 + 8),(ObjectID *)&local_48);
                }
                goto LAB_001046fc;
              }
              _err_print_error("on_despawn","modules/multiplayer/scene_replication_interface.cpp",
                               0xd8,
                               "Condition \"tobj.spawner != spawner->get_instance_id()\" is true. Returning: ERR_INVALID_PARAMETER"
                               ,0,0);
              goto LAB_00104750;
            }
            uVar29 = uVar29 + 1;
            ...
            iVar19 = SUB164(auVar8 * auVar16,8);
                  ...
                  (auVar9._8_8_ = 0, auVar9._0_8_ = (ulong)uVar27 * lVar1, auVar17._8_8_ = 0,
                  auVar17._0_8_ = uVar28, auVar10._8_8_ = 0,
                  auVar10._0_8_ =
                       (ulong)((*(uint *)(hash_table_size_primes +
                                         (ulong)*(uint *)(this + 0x1e0) * 4) + iVar19) -
                              SUB164(auVar9 * auVar17,8)) * lVar1, auVar18._8_8_ = 0,
                  auVar18._0_8_ = uVar28, uVar29 <= SUB164(auVar10 * auVar18,8)));
        }
      }
      _err_print_error("on_despawn","modules/multiplayer/scene_replication_interface.cpp",0xd6,
                       "Condition \"!tracked_nodes.has(oid)\" is true. Returning: ERR_INVALID_PARAMETER"
                       ,0,0);
    }
  }
...
/* SceneReplicationInterface::_untrack(ObjectID const&) */

void __thiscall
SceneReplicationInterface::_untrack(SceneReplicationInterface *this,ObjectID *param_1)

{
  ...
  if ((*(long *)(this + 0x1c0) != 0) && (*(int *)(this + 0x1e4) != 0)) {
    ...
    if (uVar54 != 0) {
      uVar57 = 0;
      do {
        if (((uint)uVar52 == uVar54) &&
           (*(long *)param_1 == *(long *)(*(long *)(*(long *)(this + 0x1c0) + lVar48 * 8) + 0x10)))
        {
          lVar46 = HashMap<ObjectID,SceneReplicationInterface::TrackedNode,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,SceneReplicationInterface::TrackedNode>>>
                   ::operator[]((HashMap<ObjectID,SceneReplicationInterface::TrackedNode,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,SceneReplicationInterface::TrackedNode>>>
                                 *)(this + 0x1b8),param_1);
          uVar54 = *(uint *)(lVar46 + 8);
          local_48 = uVar54;
          lVar48 = HashMap<ObjectID,SceneReplicationInterface::TrackedNode,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,SceneReplicationInterface::TrackedNode>>>
                   ::operator[]((HashMap<ObjectID,SceneReplicationInterface::TrackedNode,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,SceneReplicationInterface::TrackedNode>>>
                                 *)(this + 0x1b8),param_1);
        ...
        iVar47 = SUB164(auVar9 * auVar27,8);
              ...
              (auVar10._8_8_ = 0, auVar10._0_8_ = (ulong)uVar54 * lVar46, auVar28._8_8_ = 0,
              auVar28._0_8_ = uVar58, auVar11._8_8_ = 0,
              auVar11._0_8_ =
                   (ulong)((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x1e0) * 4) +
                           iVar47) - SUB164(auVar10 * auVar28,8)) * lVar46, auVar29._8_8_ = 0,
              auVar29._0_8_ = uVar58, uVar57 <= SUB164(auVar11 * auVar29,8)));
    }
  }
LAB_00104c64:
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
...
LAB_00104a88:
  uVar45 = (ulong)uVar56;
  if (((uint)uVar58 != uVar51) ||
     (*(long *)param_1 != *(long *)(*(long *)(lVar46 + lVar49 * 8) + 0x10))) {
    uVar55 = uVar55 + 1;
    auVar13._8_8_ = 0;
    ...
    if ((uVar51 == 0) ||
       (auVar14._8_8_ = 0, auVar14._0_8_ = (ulong)uVar51 * lVar5, auVar32._8_8_ = 0,
       auVar32._0_8_ = uVar52, auVar15._8_8_ = 0,
       auVar15._0_8_ = (ulong)((uVar44 + uVar56) - SUB164(auVar14 * auVar32,8)) * lVar5,
       auVar33._8_8_ = 0, auVar33._0_8_ = uVar52, SUB164(auVar15 * auVar33,8) < uVar55))
    goto LAB_00104c31;
    goto LAB_00104a88;
  }
  auVar16._8_8_ = 0;
  ...
  uVar51 = *puVar59;
  if ((uVar51 != 0) &&
     (auVar17._8_8_ = 0, auVar17._0_8_ = (ulong)uVar51 * lVar5, auVar35._8_8_ = 0,
     auVar35._0_8_ = uVar52, auVar18._8_8_ = 0,
     auVar18._0_8_ = (ulong)((uVar56 + uVar44) - SUB164(auVar17 * auVar35,8)) * lVar5,
     auVar36._8_8_ = 0, auVar36._0_8_ = uVar52, SUB164(auVar18 * auVar36,8) != 0)) {
    while( true ) {
      ...
      *puVar2 = uVar6;
      ...
      uVar45 = uVar58;
      if ((uVar51 == 0) ||
         (auVar19._8_8_ = 0, auVar19._0_8_ = (ulong)uVar51 * lVar5, auVar37._8_8_ = 0,
         auVar37._0_8_ = uVar52, auVar20._8_8_ = 0,
         auVar20._0_8_ =
              (ulong)((SUB164(auVar21 * auVar39,8) + uVar44) - SUB164(auVar19 * auVar37,8)) * lVar5,
         auVar38._8_8_ = 0, auVar38._0_8_ = uVar52, SUB164(auVar20 * auVar38,8) == 0)) break;
  ...
  if (pvVar7 != (void *)0x0) {
    if (*(int *)((long)plVar53 + 0x54) != 0) {
      if (*(uint *)(hash_table_size_primes + (ulong)*(uint *)(plVar53 + 10) * 4) != 0) {
        memset((void *)plVar53[9],0,
               (ulong)*(uint *)(hash_table_size_primes + (ulong)*(uint *)(plVar53 + 10) * 4) * 4);
      }
  ...
  if (uVar57 != 0) {
    if ((*(long *)(this + 0x188) != 0) && (*(int *)(this + 0x1ac) != 0)) {
      ...
      if (uVar44 != 0) {
        uVar56 = 0;
        while ((uVar51 != uVar44 ||
               (uVar57 != *(uint *)(*(long *)(*(long *)(this + 0x188) + lVar46 * 8) + 0x10)))) {
          uVar56 = uVar56 + 1;
          auVar23._8_8_ = 0;
          ...
          if ((uVar44 == 0) ||
             (auVar24._8_8_ = 0, auVar24._0_8_ = uVar44 * uVar45, auVar42._8_8_ = 0,
             auVar42._0_8_ = uVar58, auVar25._8_8_ = 0,
             auVar25._0_8_ =
                  ((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x1a8) * 4) + iVar47)
                  - SUB164(auVar24 * auVar42,8)) * uVar45, auVar43._8_8_ = 0, auVar43._0_8_ = uVar58
             , SUB164(auVar25 * auVar43,8) < uVar56)) goto LAB_00104daa;
        }
        local_44 = uVar57;
        lVar46 = HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
                 ::operator[]((HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
                               *)(this + 0x180),(int *)&local_44);
        HashMap<unsigned_int,ObjectID,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,ObjectID>>>
        ::erase((HashMap<unsigned_int,ObjectID,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,ObjectID>>>
                 *)(lVar46 + 0xb0),&local_48);
      }
    }
LAB_00104daa:
    if (uVar54 == 0) goto LAB_00104c64;
  }
...
/* SceneReplicationInterface::_update_sync_visibility(int, MultiplayerSynchronizer*) */

undefined8 __thiscall
SceneReplicationInterface::_update_sync_visibility
          (SceneReplicationInterface *this,int param_1,MultiplayerSynchronizer *param_2)

{
  ...
  *this_00;
  ...
  if (param_2 == (MultiplayerSynchronizer *)0x0) {
    _err_print_error("_update_sync_visibility","modules/multiplayer/scene_replication_interface.cpp"
                     ,0x159,"Parameter \"p_sync\" is null.",0,0);
    uVar18 = 0x2f;
  }
  else {
    cVar12 = _has_authority((Node *)this);
    if ((cVar12 != '\0') &&
       (uVar14 = (**(code **)(**(long **)(this + 0x288) + 0x168))(), uVar24 = local_6c[0],
       uVar14 != local_6c[0])) {
...
LAB_00104f95:
              ...
              do {
                if (((uint)uVar20 == uVar14) &&
                   (pOVar1 == *(ObjectID **)
                               (local_b0 + (ulong)*(uint *)(plVar25[4] + uVar15 * 4) * 8))) {
                  if (cVar13 == '\0') {
                    HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>>::erase
                              ((HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>>
                                *)(plVar25 + 3),(ObjectID *)&local_60);
                    HashMap<ObjectID,unsigned_long,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,unsigned_long>>>
                    ::erase((HashMap<ObjectID,unsigned_long,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,unsigned_long>>>
                             *)(plVar25 + 0xd),(ObjectID *)&local_60);
                  }
                  goto LAB_0010506b;
                }
                uVar23 = uVar23 + 1;
                ...
                uVar21 = uVar15 & 0xffffffff;
                      ...
                      (auVar4._8_8_ = 0, auVar4._0_8_ = (ulong)uVar14 * lVar22, auVar9._8_8_ = 0,
                      auVar9._0_8_ = uVar19, auVar5._8_8_ = 0,
                      auVar5._0_8_ = (ulong)((SUB164(auVar3 * auVar8,8) + uVar24) -
                                            SUB164(auVar4 * auVar9,8)) * lVar22, auVar10._8_8_ = 0,
                      auVar10._0_8_ = uVar19, uVar23 <= SUB164(auVar5 * auVar10,8)));
...
LAB_0010506b:
        ...
        this_00 = (HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
                   *)(this + 0x180);
        cVar13 = HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
                 ::_lookup_pos(this_00,(int *)(ulong)uVar24,(uint *)local_58);
        if (cVar13 == '\0') {
          _err_print_error("_update_sync_visibility",
                           "modules/multiplayer/scene_replication_interface.cpp",0x170,
                           "Condition \"!peers_info.has(p_peer)\" is true. Returning: ERR_INVALID_PARAMETER"
                           ,0,0);
          uVar18 = 0x1f;
          goto LAB_00105082;
        }
        pHVar16 = (HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>> *)
                  HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
                  ::operator[](this_00,(int *)local_6c);
        cVar13 = HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>>::
                 _lookup_pos(pHVar16,pOVar1,(uint *)local_58);
        if (cVar12 != cVar13) {
          if (cVar12 == '\0') {
            pHVar16 = (HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>> *)
                      HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
                      ::operator[](this_00,(int *)local_6c);
            HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>>::erase
                      (pHVar16,(ObjectID *)&local_60);
            lVar17 = HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
                     ::operator[](this_00,(int *)local_6c);
            HashMap<ObjectID,unsigned_long,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,unsigned_long>>>
            ::erase((HashMap<ObjectID,unsigned_long,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,unsigned_long>>>
                     *)(lVar17 + 0x50),(ObjectID *)&local_60);
          }
          else {
            HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
            ::operator[](this_00,(int *)local_6c);
...
/* SceneReplicationInterface::on_spawn_receive(int, unsigned char const*, int) */

int __thiscall
SceneReplicationInterface::on_spawn_receive
          (SceneReplicationInterface *this,int param_1,uchar *param_2,int param_3)

{
  ...
  *this_00;
  ...
  local_bc[0] = param_1;
  if (param_3 < 0x12) {
    _err_print_error("on_spawn_receive","modules/multiplayer/scene_replication_interface.cpp",0x23b,
                     "Condition \"p_buffer_len < 18\" is true. Returning: ERR_INVALID_DATA",
                     "Invalid spawn packet received",0,0);
LAB_00105d8c:
    iVar16 = 0x1e;
    goto LAB_001058af;
  }
  ...
  if ((lVar18 == 0) ||
     (pNVar19 = (NodePath *)__dynamic_cast(lVar18,&Object::typeinfo,&MultiplayerSpawner::typeinfo,0)
     , pNVar19 == (NodePath *)0x0)) {
    iVar16 = 0x21;
    _err_print_error("on_spawn_receive","modules/multiplayer/scene_replication_interface.cpp",0x242,
                     "Parameter \"spawner\" is null.",0,0);
    goto LAB_001058af;
  }
  ...
  if (param_1 != iVar16) {
    iVar16 = 4;
    _err_print_error("on_spawn_receive","modules/multiplayer/scene_replication_interface.cpp",0x243,
                     "Condition \"p_from != spawner->get_multiplayer_authority()\" is true. Returning: ERR_UNAUTHORIZED"
                     ,0,0);
    goto LAB_001058af;
  }
  do {
  ...
  if (param_3 - 0x12U < uVar17 * 4 + uVar35) {
    ...
    _err_print_error("on_spawn_receive","modules/multiplayer/scene_replication_interface.cpp",0x24b,
                     "Condition \"name_len + (sync_len * 4) > uint32_t(p_buffer_len - ofs)\" is true. Returning: ERR_INVALID_DATA"
                     ,(String_conflict *)&local_98,0,0);
  ...
  if (uVar35 == 0) {
    iVar16 = 0x1e;
    _err_print_error("on_spawn_receive","modules/multiplayer/scene_replication_interface.cpp",0x251,
                     "Condition \"name_len < 1\" is true. Returning: ERR_INVALID_DATA",
                     "Zero spawn name size.",0,0);
  }
  else {
...
LAB_0010569f:
            if (local_108 == (String_conflict *)0x0) {
              iVar16 = 4;
              _err_print_error("on_spawn_receive",
                               "modules/multiplayer/scene_replication_interface.cpp",0x26d,
              ...
              this_00 = (HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
                         *)(this + 0x180);
              cVar15 = HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
                       ::_lookup_pos(this_00,(int *)(ulong)(uint)param_1,(uint *)&local_98);
              if (cVar15 == '\0') {
                iVar16 = 2;
                _err_print_error("on_spawn_receive",
                                 "modules/multiplayer/scene_replication_interface.cpp",0x271,
                                 "Condition \"!peers_info.has(p_from)\" is true. Returning: ERR_UNAVAILABLE"
                                 ,0,0);
              }
              else {
                lVar18 = HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
                         ::operator[](this_00,local_bc);
                if ((*(long *)(lVar18 + 0xb8) != 0) && (*(int *)(lVar18 + 0xdc) != 0)) {
                  uVar26 = *(ulong *)(hash_table_size_primes_inv +
                                     (ulong)*(uint *)(lVar18 + 0xd8) * 8);
                  ...
                  if (uVar17 != 0) {
                    ...
                    do {
                      if ((local_d8 == uVar17) &&
                         (uVar32 == *(uint *)(*(long *)(*(long *)(lVar18 + 0xb8) + lVar28 * 8) +
                                             0x10))) {
                        iVar16 = 0x16;
                        _err_print_error("on_spawn_receive",
                                         "modules/multiplayer/scene_replication_interface.cpp",0x272
                                         ,
                                         "Condition \"peers_info[p_from].recv_nodes.has(net_id)\" is true. Returning: ERR_ALREADY_IN_USE"
                                         ,0,0);
                        goto LAB_00105848;
                      }
                      uVar35 = uVar35 + 1;
                      ...
                      iVar16 = SUB164(auVar7 * auVar11,8);
                            ...
                            (auVar8._8_8_ = 0, auVar8._0_8_ = uVar17 * uVar26, auVar12._8_8_ = 0,
                            auVar12._0_8_ = uVar33, auVar9._8_8_ = 0,
                            auVar9._0_8_ = ((*(uint *)(hash_table_size_primes +
                                                      (ulong)*(uint *)(lVar18 + 0xd8) * 4) + iVar16)
                                           - SUB164(auVar8 * auVar12,8)) * uVar26, auVar13._8_8_ = 0
                            , auVar13._0_8_ = uVar33, uVar35 <= SUB164(auVar9 * auVar13,8)));
                  }
                }
                ...
                *(ulong *)(lVar18 + 8) = CONCAT44(param_1,uVar32);
                ...
                puVar23 = (undefined8 *)
                          HashMap<unsigned_int,ObjectID,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,ObjectID>>>
                          ::operator[]((HashMap<unsigned_int,ObjectID,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,ObjectID>>>
                                        *)(lVar18 + 0xb0),&local_b4);
...
LAB_00105a13:
                if ((pauVar22 != (undefined1 (*) [16])0x0) &&
                   (puVar30 = *(undefined4 **)*pauVar22, puVar30 != (undefined4 *)0x0)) {
                  if (plVar31 == (long *)0x0) {
...
LAB_00105abe:
                Node::add_child(pNVar21,local_108,0,0);
                if ((on_spawn_receive(int,unsigned_char_const*,int)::{lambda()#1}::operator()()::
                     sname == '\0') &&
                   (iVar16 = __cxa_guard_acquire(&on_spawn_receive(int,unsigned_char_const*,int)::
                                                  {lambda()#1}::operator()()::sname), iVar16 != 0))
                {
                  _scs_create((char *)&on_spawn_receive(int,unsigned_char_const*,int)::{lambda()#1}
                                       ::operator()()::sname,true);
                  __cxa_atexit(StringName::~StringName,
                               &on_spawn_receive(int,unsigned_char_const*,int)::{lambda()#1}::
                ...
                (**(code **)(*(long *)pNVar19 + 0xd0))
                          (pNVar19,&on_spawn_receive(int,unsigned_char_const*,int)::{lambda()#1}::
...
LAB_00105c27:
                  _err_print_error("on_spawn_receive",
                                   "modules/multiplayer/scene_replication_interface.cpp",0x28a,
          ...
          if (param_3 - iVar36 < 4) {
            _err_print_error("on_spawn_receive",
                             "modules/multiplayer/scene_replication_interface.cpp",0x260,
                             "Condition \"p_buffer_len - ofs < 4\" is true. Returning: ERR_INVALID_DATA"
                             ,0,0);
          }
          else {
            lVar18 = 0;
            ...
            if (uVar17 <= (uint)(param_3 - iVar36)) {
              ...
              iVar16 = MultiplayerAPI::decode_and_decompress_variant
                                 ((Variant *)local_78,param_2 + iVar36,uVar17,(int *)0x0,false);
              if (iVar16 != 0) {
                _err_print_error("on_spawn_receive",
                                 "modules/multiplayer/scene_replication_interface.cpp",0x266,
              ...
              local_108 = (String_conflict *)
                          MultiplayerSpawner::instantiate_custom((Variant *)pNVar19);
              if (Variant::needs_deinit[local_78[0]] != '\0') {
                Variant::_clear_internal();
              }
              goto LAB_0010569f;
            ...
            _err_print_error("on_spawn_receive",
                             "modules/multiplayer/scene_replication_interface.cpp",0x263,
                             "Condition \"arg_size > uint32_t(p_buffer_len - ofs)\" is true. Returning: ERR_INVALID_DATA"
                             ,0,0);
          }
        }
        else {
          _err_print_error("on_spawn_receive","modules/multiplayer/scene_replication_interface.cpp",
                           0x25b,
      ...
      iVar16 = 3;
      _err_print_error("on_spawn_receive","modules/multiplayer/scene_replication_interface.cpp",
                       0x25a,"Parameter \"parent\" is null.",0,0);
    }
    else {
      local_a0 = 0;
...
LAB_00105f1e:
      local_a8 = 0;
      local_98 = 
      "Invalid node name received: \'%s\'. Make sure to add nodes via \'add_child(node, true)\' remotely."
      ;
      local_90 = 0x5e;
      String::parse_latin1((StrRange *)&local_a8);
      vformat<String>((String_conflict *)&local_98,(StrRange *)&local_a8,
                      (CowData<char32_t> *)&local_a0);
      _err_print_error("on_spawn_receive","modules/multiplayer/scene_replication_interface.cpp",
                       0x255,
                       "Condition \"name.validate_node_name() != name\" is true. Returning: ERR_INVALID_DATA"
                       ,(String_conflict *)&local_98,0,0);
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_98);
...
/* SceneReplicationInterface::on_despawn_receive(int, unsigned char const*, int) */
...

{
  ...
  local_9c = param_1;
  if (param_3 < 5) {
    _err_print_error("on_despawn_receive","modules/multiplayer/scene_replication_interface.cpp",
                     0x290,"Condition \"p_buffer_len < 5\" is true. Returning: ERR_INVALID_DATA",
                     "Invalid spawn packet received",0,0);
    uVar34 = 0x1e;
    goto LAB_0010674a;
  }
  ...
  if ((*(long *)(this + 0x188) != 0) && (*(int *)(this + 0x1ac) != 0)) {
    ...
    if (uVar26 != 0) {
      ...
      do {
        if ((uVar26 == uVar38) &&
           (param_1 == *(int *)(*(long *)(*(long *)(this + 0x188) + lVar28 * 8) + 0x10))) {
          lVar28 = HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
                   ::operator[]((HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
                                 *)(this + 0x180),&local_9c);
        ...
        iVar27 = SUB164(auVar2 * auVar14,8);
              ...
              (auVar3._8_8_ = 0, auVar3._0_8_ = uVar26 * uVar31, auVar15._8_8_ = 0,
              auVar15._0_8_ = uVar35, auVar4._8_8_ = 0,
              auVar4._0_8_ = ((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x1a8) * 4
                                        ) + iVar27) - SUB164(auVar3 * auVar15,8)) * uVar31,
              auVar16._8_8_ = 0, auVar16._0_8_ = uVar35, uVar39 <= SUB164(auVar4 * auVar16,8)));
    }
  }
  _err_print_error("on_despawn_receive","modules/multiplayer/scene_replication_interface.cpp",0x296,
                   "Condition \"!peers_info.has(p_from)\" is true. Returning: ERR_UNAUTHORIZED",0,0)
  ;
  goto LAB_001067d5;
LAB_00106430:
  while( true ) {
  ...
  if ((uVar31 >> 0x18 & 0x7fffffffff) == (*puVar29 & 0x7fffffffff)) {
    ...
    ObjectDB::spin_lock._0_1_ = '\0';
    if ((uVar31 == 0) ||
       (pOVar30 = (Object *)__dynamic_cast(uVar31,&Object::typeinfo,&Node::typeinfo,0),
       pOVar30 == (Object *)0x0)) goto LAB_001068c7;
    HashMap<unsigned_int,ObjectID,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,ObjectID>>>
    ::erase((HashMap<unsigned_int,ObjectID,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,ObjectID>>>
             *)(lVar28 + 0xb0),&local_94);
    ...
    if ((*(long *)(this + 0x1c0) != 0) && (*(int *)(this + 0x1e4) != 0)) {
      ...
      if (uVar37 != 0) {
        uVar26 = 0;
        do {
          if (((uint)uVar40 == uVar37) &&
             (local_90 == *(ulong *)(*(long *)(*(long *)(this + 0x1c0) + lVar36 * 8) + 0x10))) {
            lVar28 = HashMap<ObjectID,SceneReplicationInterface::TrackedNode,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,SceneReplicationInterface::TrackedNode>>>
                     ::operator[]((HashMap<ObjectID,SceneReplicationInterface::TrackedNode,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,SceneReplicationInterface::TrackedNode>>>
                                   *)(this + 0x1b8),(ObjectID *)&local_90);
          ...
          iVar27 = SUB164(auVar10 * auVar22,8);
                ...
                (auVar11._8_8_ = 0, auVar11._0_8_ = (ulong)uVar37 * lVar28, auVar23._8_8_ = 0,
                auVar23._0_8_ = uVar35, auVar12._8_8_ = 0,
                auVar12._0_8_ =
                     (ulong)((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x1e0) * 4)
                             + iVar27) - SUB164(auVar11 * auVar23,8)) * lVar28, auVar24._8_8_ = 0,
                auVar24._0_8_ = uVar35, uVar26 <= SUB164(auVar12 * auVar24,8)));
      }
    }
    _err_print_error("on_despawn_receive","modules/multiplayer/scene_replication_interface.cpp",
                     0x29e,"Condition \"!tracked_nodes.has(oid)\" is true. Returning: ERR_BUG",0,0);
  }
  else {
    ObjectDB::spin_lock._0_1_ = '\0';
LAB_001068c7:
    _err_print_error("on_despawn_receive","modules/multiplayer/scene_replication_interface.cpp",
                     0x29a,"Parameter \"node\" is null.",0,0);
  }
  uVar34 = 0x2f;
  goto LAB_0010674a;
LAB_00106620:
  ...
  if ((uVar31 >> 0x18 & 0x7fffffffff) == (*puVar29 & 0x7fffffffff)) {
    ...
    ObjectDB::spin_lock._0_1_ = '\0';
    if ((uVar31 != 0) &&
       (plVar32 = (long *)__dynamic_cast(uVar31,&Object::typeinfo,&MultiplayerSpawner::typeinfo,0),
       plVar32 != (long *)0x0)) {
      ...
      if (iVar27 == local_9c) {
        ...
        Node::queue_free();
        if ((on_despawn_receive(int,unsigned_char_const*,int)::{lambda()#1}::operator()()::sname ==
             '\0') &&
          ...
          _scs_create((char *)&on_despawn_receive(int,unsigned_char_const*,int)::{lambda()#1}::
                               operator()()::sname,true);
          __cxa_atexit(StringName::~StringName,
                       &on_despawn_receive(int,unsigned_char_const*,int)::{lambda()#1}::operator()()
                        ::sname,&__dso_handle);
        ...
        local_88[0] = (Variant *)local_78;
        (**(code **)(*plVar32 + 0xd0))
                  (plVar32,&on_despawn_receive(int,unsigned_char_const*,int)::{lambda()#1}::
                            operator()()::sname,local_88,1);
        if (Variant::needs_deinit[(int)local_60] != '\0') {
          Variant::_clear_internal();
        }
...
LAB_0010694c:
  _err_print_error("on_despawn_receive","modules/multiplayer/scene_replication_interface.cpp",0x2a0,
                   "Parameter \"spawner\" is null.",0,0);
  uVar34 = 0x21;
  goto LAB_0010674a;
  while( true ) {
    ...
    if ((uVar26 == 0) ||
       (auVar7._8_8_ = 0, auVar7._0_8_ = uVar26 * uVar31, auVar19._8_8_ = 0, auVar19._0_8_ = uVar40,
       auVar8._8_8_ = 0,
       auVar8._0_8_ = ((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(lVar28 + 0xd8) * 4) +
                       iVar27) - SUB164(auVar7 * auVar19,8)) * uVar31, auVar20._8_8_ = 0,
       auVar20._0_8_ = uVar40, SUB164(auVar8 * auVar20,8) < uVar39)) break;
LAB_001063e1:
    if ((uVar38 == uVar26) &&
       (uVar37 == *(uint *)(*(long *)(*(long *)(lVar28 + 0xb8) + lVar36 * 8) + 0x10))) {
      puVar29 = (ulong *)HashMap<unsigned_int,ObjectID,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,ObjectID>>>
                         ::operator[]((HashMap<unsigned_int,ObjectID,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,ObjectID>>>
                                       *)(lVar28 + 0xb0),&local_94);
      uVar31 = *puVar29;
...
LAB_00106878:
  _err_print_error("on_despawn_receive","modules/multiplayer/scene_replication_interface.cpp",0x298,
...
/* SceneReplicationInterface::_find_synchronizer(int, unsigned int) */

undefined8 __thiscall
SceneReplicationInterface::_find_synchronizer
          (SceneReplicationInterface *this,int param_1,uint param_2)

{
  ...
  lVar10 = HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
           ::operator[]((HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
                         *)(this + 0x180),local_4c);
  if ((*(long *)(lVar10 + 0x88) != 0) && (*(int *)(lVar10 + 0xac) != 0)) {
    ...
    if (uVar9 != 0) {
      uVar19 = 0;
      while ((uVar17 != uVar9 ||
             (param_2 != *(uint *)(*(long *)(*(long *)(lVar10 + 0x88) + lVar16 * 8) + 0x10)))) {
        uVar19 = uVar19 + 1;
        auVar2._8_8_ = 0;
        ...
        if ((uVar9 == 0) ||
           (auVar3._8_8_ = 0, auVar3._0_8_ = uVar9 * uVar12, auVar7._8_8_ = 0, auVar7._0_8_ = uVar18
           , auVar4._8_8_ = 0,
           auVar4._0_8_ = ((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(lVar10 + 0xa8) * 4)
                           + iVar14) - SUB164(auVar3 * auVar7,8)) * uVar12, auVar8._8_8_ = 0,
           auVar8._0_8_ = uVar18, SUB164(auVar4 * auVar8,8) < uVar19)) goto LAB_00106bd1;
      }
      lVar10 = HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
               ::operator[]((HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
                             *)(this + 0x180),local_4c);
      puVar11 = (ulong *)HashMap<unsigned_int,ObjectID,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,ObjectID>>>
                         ::operator[]((HashMap<unsigned_int,ObjectID,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,ObjectID>>>
                                       *)(lVar10 + 0x80),&local_50);
      uVar12 = *puVar11;
      if (uVar12 != 0) {
...
/* SceneReplicationInterface::on_delta_receive(int, unsigned char const*, int) */

int __thiscall
SceneReplicationInterface::on_delta_receive
          (SceneReplicationInterface *this,int param_1,uchar *param_2,int param_3)
  ...
  if (0x11 < param_3) {
    ...
    do {
      ...
      if ((uint)(param_3 - iVar8) < uVar10) {
        _err_print_error("on_delta_receive","modules/multiplayer/scene_replication_interface.cpp",
                         0x309,
                         "Condition \"size > uint32_t(p_buffer_len - ofs)\" is true. Returning: ERR_INVALID_DATA"
                         ,0,0);
        iVar3 = 0x1e;
        goto LAB_00106ffb;
      }
...
LAB_00106f70:
        _err_print_error("on_delta_receive","modules/multiplayer/scene_replication_interface.cpp",
                         0x30e,"Condition \"true\" is true. Continuing.",
                         "Ignoring delta for non-authority or invalid synchronizer.",0,0);
      }
      else {
        ...
        if ((local_98 == 0) || (*(int *)(local_98 + 0x10) == 0)) {
          _err_print_error("on_delta_receive","modules/multiplayer/scene_replication_interface.cpp",
                           0x311,
                           "Condition \"props.is_empty()\" is true. Returning: ERR_INVALID_DATA",0,0
                          );
          iVar3 = 0x1e;
LAB_00107193:
        ...
        CowData<Variant>::resize<false>
                  ((CowData<Variant> *)&local_70,(long)*(int *)(local_98 + 0x10));
        local_9c = 0;
        iVar3 = MultiplayerAPI::decode_and_decompress_variants
                          (local_78,param_2 + iVar8,uVar10,(int *)&local_9c,false,false);
        if (iVar3 != 0) {
          _err_print_error("on_delta_receive","modules/multiplayer/scene_replication_interface.cpp",
                           0x316,"Condition \"err != OK\" is true. Returning: err",0,0);
LAB_001071d6:
        ...
        if (local_9c != uVar10) {
          _err_print_error("on_delta_receive","modules/multiplayer/scene_replication_interface.cpp",
                           0x317,
                           "Condition \"uint32_t(consumed) != size\" is true. Returning: ERR_INVALID_DATA"
                           ,0,0);
          iVar3 = 0x1e;
          goto LAB_001071d6;
        }
        ...
        if (iVar3 != 0) {
          _err_print_error("on_delta_receive","modules/multiplayer/scene_replication_interface.cpp",
                           0x319,"Condition \"err != OK\" is true. Returning: err",0,0);
          goto LAB_001071d6;
        }
        if (on_delta_receive(int,unsigned_char_const*,int)::{lambda()#1}::operator()()::sname ==
            '\0') {
          iVar3 = __cxa_guard_acquire(&on_delta_receive(int,unsigned_char_const*,int)::{lambda()#1}
                                       ::operator()()::sname);
          if (iVar3 != 0) {
            _scs_create((char *)&on_delta_receive(int,unsigned_char_const*,int)::{lambda()#1}::
                                 operator()()::sname,true);
            __cxa_atexit(StringName::~StringName,
                         &on_delta_receive(int,unsigned_char_const*,int)::{lambda()#1}::operator()()
                          ::sname,&__dso_handle);
        ...
        (**(code **)(*plVar5 + 0xd0))
                  (plVar5,&on_delta_receive(int,unsigned_char_const*,int)::{lambda()#1}::
                           operator()()::sname,0,0);
        if (Variant::needs_deinit[local_58[0]] != '\0') {
          Variant::_clear_internal();
        }
...
/* SceneReplicationInterface::on_sync_receive(int, unsigned char const*, int) */
...

{
  ...
  if (param_3 < 0xb) {
    uVar11 = 0x1e;
    _err_print_error("on_sync_receive","modules/multiplayer/scene_replication_interface.cpp",0x359,
                     "Condition \"p_buffer_len < 11\" is true. Returning: ERR_INVALID_DATA",
                     "Invalid sync packet received",0,0);
  }
  else {
    if ((*param_2 & 0x10) != 0) {
      if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    ...
    if (param_3 != 0xb) {
      ...
      do {
        ...
        if ((uint)(param_3 - iVar12) < uVar10) {
          uVar11 = 0x1e;
          _err_print_error("on_sync_receive","modules/multiplayer/scene_replication_interface.cpp",
                           0x365,
                           "Condition \"size > uint32_t(p_buffer_len - ofs)\" is true. Returning: ERR_INVALID_DATA"
                           ,0,0);
          goto LAB_0010769b;
        ...
        if (plVar5 != (long *)0x0) {
          ...
          if ((pOVar6 == (Object *)0x0) || (iVar3 != param_1)) {
            _err_print_error("on_sync_receive","modules/multiplayer/scene_replication_interface.cpp"
                             ,0x370,"Condition \"true\" is true. Continuing.",
                             "Ignoring sync data from non-authority or for missing node.",0,0);
          }
          else {
            ...
            if (cVar2 != '\0') {
              ...
              if (((long *)*plVar7 == (long *)0x0) ||
                 (pNVar8 = *(NodePath **)*plVar7, pNVar8 == (NodePath *)0x0)) {
                lVar4 = 0;
              }
              else {
              ...
              uVar9 = MultiplayerAPI::decode_and_decompress_variants
                                (local_78,param_2 + iVar12,uVar10,&local_9c,false,false);
              if (uVar9 == 0) {
                uVar9 = MultiplayerSynchronizer::set_state((List *)&local_98,pOVar6,local_78);
                if (uVar9 == 0) {
                  if ((on_sync_receive(int,unsigned_char_const*,int)::{lambda()#1}::operator()()::
                       sname == '\0') &&
                     (iVar3 = __cxa_guard_acquire(&on_sync_receive(int,unsigned_char_const*,int)::
                                                   {lambda()#1}::operator()()::sname), iVar3 != 0))
                  {
                    _scs_create((char *)&on_sync_receive(int,unsigned_char_const*,int)::{lambda()#1}
                                         ::operator()()::sname,true);
                    __cxa_atexit(StringName::~StringName,
                                 &on_sync_receive(int,unsigned_char_const*,int)::{lambda()#1}::
                                  operator()()::sname,&__dso_handle);
                  ...
                  local_50 = (undefined1  [16])0x0;
                  (**(code **)(*plVar5 + 0xd0))
                            (plVar5,&on_sync_receive(int,unsigned_char_const*,int)::{lambda()#1}::
                                     operator()()::sname,0,0);
                  if (Variant::needs_deinit[local_58[0]] != '\0') {
                    Variant::_clear_internal();
                  }
                  ...
                  List<NodePath,DefaultAllocator>::~List
                            ((List<NodePath,DefaultAllocator> *)&local_98);
                  goto LAB_0010749c;
                }
                _err_print_error("on_sync_receive",
                                 "modules/multiplayer/scene_replication_interface.cpp",0x37e,
                                 "Condition \"err\" is true. Returning: err",0,0);
              }
              else {
                _err_print_error("on_sync_receive",
                                 "modules/multiplayer/scene_replication_interface.cpp",0x37c,
                                 "Condition \"err\" is true. Returning: err",0,0);
              }
...
/* SceneReplicationInterface::on_replication_start(Object*, Variant) */

int __thiscall
SceneReplicationInterface::on_replication_start
          (SceneReplicationInterface *this,long param_1,int *param_3)

{
  ...
  if (param_1 == 0) {
LAB_00107b70:
    _err_print_error("on_replication_start","modules/multiplayer/scene_replication_interface.cpp",
                     0xe3,
                     "Condition \"!node || p_config.get_type() != Variant::OBJECT\" is true. Returning: ERR_INVALID_PARAMETER"
                     ,0,0);
  }
    ...
    if (lVar9 != 0) {
      pMVar10 = (MultiplayerSynchronizer *)
                __dynamic_cast(lVar9,&Object::typeinfo,&MultiplayerSynchronizer::typeinfo,0);
      if (pMVar10 != (MultiplayerSynchronizer *)0x0) {
        ...
        create_custom_callable_function_pointer<SceneReplicationInterface,int,ObjectID>
                  ((SceneReplicationInterface *)local_68,(char *)this,
                   (_func_void_int_ObjectID *)"&SceneReplicationInterface::_visibility_changed");
        Callable::bind<ObjectID>
                  ((ObjectID *)&local_58,(SceneReplicationInterface *)local_68,
                   *(undefined8 *)(pMVar10 + 0x60));
        ...
        if (*(long *)(param_1 + 0x60) == *(long *)(this + 0x260)) {
          ...
          if (uVar6 == *(uint *)(this + 0x268)) {
            ...
            if ((plVar12 == (long *)0x0) || ((int)plVar12[2] == 0)) {
              Node::get_path();
              local_58 = 
              "The MultiplayerSynchronizer at path \"%s\" is unable to process the pending spawn since it has no network ID. This might happen when changing the multiplayer authority during the \"_ready\" callback. Make sure to only change the authority of multiplayer synchronizers during \"_enter_tree\" or the \"_spawn_custom\" callback of their multiplayer spawner."
              ;
              local_68[0] = (undefined1 (*) [16])0x0;
              local_50[0] = 0x15a;
              String::parse_latin1((StrRange *)local_68);
              vformat<NodePath>((ObjectID *)&local_58,(SceneReplicationInterface *)local_68,
                                (NodePath *)local_70);
              _err_print_error("on_replication_start",
                               "modules/multiplayer/scene_replication_interface.cpp",0xf3,
                               "Condition \"pending_sync_net_ids.is_empty()\" is true. Returning: ERR_INVALID_DATA"
                               ,(ObjectID *)&local_58,0,0);
              CowData<char32_t>::_unref((CowData<char32_t> *)&local_58);
              CowData<char32_t>::_unref((CowData<char32_t> *)local_68);
              NodePath::~NodePath((NodePath *)local_70);
            }
            else {
              cVar5 = HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
                      ::_lookup_pos((HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
                                     *)(this + 0x180),(int *)(ulong)uVar6,(uint *)&local_58);
              if (cVar5 != '\0') {
                puVar2 = (uint *)*plVar12;
                local_7c = *puVar2;
                ...
                lVar9 = HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
                        ::operator[]((HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
                                      *)(this + 0x180),(int *)(this + 0x268));
                puVar11 = (undefined8 *)
                          HashMap<unsigned_int,ObjectID,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,ObjectID>>>
                          ::operator[]((HashMap<unsigned_int,ObjectID,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,ObjectID>>>
                                        *)(lVar9 + 0x80),&local_7c);
                *puVar11 = uVar4;
                ...
                if (lVar9 == 0) {
                  _err_print_error("on_replication_start",
                                   "modules/multiplayer/scene_replication_interface.cpp",0xfc,
                                   "Condition \"!node || !sync->get_replication_config_ptr()\" is true. Returning: ERR_UNCONFIGURED"
                                   ,0,0);
                  iVar7 = 3;
                  goto LAB_00107b9a;
                }
                ...
                if (((long *)*plVar12 == (long *)0x0) ||
                   (pNVar13 = *(NodePath **)*plVar12, pNVar13 == (NodePath *)0x0)) {
                  lVar9 = 0;
                }
                else {
                ...
                iVar7 = MultiplayerAPI::decode_and_decompress_variants
                                  ((Vector *)&local_58,*(uchar **)(this + 0x270),
                                   *(int *)(this + 0x278),local_70,false,false);
                if (iVar7 == 0) {
                  if (0 < local_70[0]) {
                    *(int *)(this + 0x278) = *(int *)(this + 0x278) - local_70[0];
                    *(long *)(this + 0x270) = *(long *)(this + 0x270) + (long)local_70[0];
                    iVar7 = MultiplayerSynchronizer::set_state
                                      ((List *)local_68,pOVar8,(Vector *)&local_58);
                    if (iVar7 != 0) {
                      _err_print_error("on_replication_start",
                                       "modules/multiplayer/scene_replication_interface.cpp",0x107,
                                       "Condition \"err\" is true. Returning: err",0,0);
                      goto LAB_00107edc;
                    }
                  }
                  ...
                  List<NodePath,DefaultAllocator>::~List
                            ((List<NodePath,DefaultAllocator> *)local_68);
                  iVar7 = 0;
                }
                else {
                  _err_print_error("on_replication_start",
                                   "modules/multiplayer/scene_replication_interface.cpp",0x102,
                                   "Condition \"err\" is true. Returning: err",0,0);
LAB_00107edc:
                  CowData<Variant>::_unref((CowData<Variant> *)local_50);
                  List<NodePath,DefaultAllocator>::~List
              ...
              _err_print_error("on_replication_start",
                               "modules/multiplayer/scene_replication_interface.cpp",0xf4,
                               "Condition \"!peers_info.has(pending_spawn_remote)\" is true. Returning: ERR_INVALID_DATA"
                               ,0,0);
            }
            iVar7 = 0x1e;
            goto LAB_00107b9a;
...
LAB_00107aa4:
    ...
    _err_print_error("on_replication_start","modules/multiplayer/scene_replication_interface.cpp",
                     0xe5,"Parameter \"sync\" is null.",0,0);
  }
  iVar7 = 0x1f;
LAB_00107b9a:
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
...
/* SceneReplicationInterface::_update_spawn_visibility(int, ObjectID const&) */

undefined8 __thiscall
SceneReplicationInterface::_update_spawn_visibility
          (SceneReplicationInterface *this,int param_1,ObjectID *param_2)

{
  ...
  *this_01;
  ...
  this_00 = (HashMap<ObjectID,SceneReplicationInterface::TrackedNode,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,SceneReplicationInterface::TrackedNode>>>
             *)(this + 0x1b8);
  ...
  local_ec[0] = param_1;
  cVar29 = HashMap<ObjectID,SceneReplicationInterface::TrackedNode,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,SceneReplicationInterface::TrackedNode>>>
           ::_lookup_pos(this_00,pOVar45,(uint *)local_68);
  if (cVar29 == '\0') {
    _err_print_error("_update_spawn_visibility",
                     "modules/multiplayer/scene_replication_interface.cpp",0x180,
                     "Parameter \"tnode\" is null.",0,0);
    goto LAB_0010854f;
  }
    ...
    if (uVar36 < (uint)ObjectDB::slot_max) {
      ...
      if ((uVar40 >> 0x18 & 0x7fffffffff) == (*puVar32 & 0x7fffffffff)) {
        ...
        if (local_128 != (MultiplayerSpawner *)0x0) {
          local_128 = (MultiplayerSpawner *)
                      __dynamic_cast(local_128,&Object::typeinfo,&MultiplayerSpawner::typeinfo,0);
        }
        pOVar45 = *(ObjectID **)param_2;
      }
      else {
...
LAB_00108b4f:
    _err_print_error("_update_spawn_visibility",
                     "modules/multiplayer/scene_replication_interface.cpp",0x183,
                     "Parameter \"node\" is null.",0,0);
  }
  else {
    ...
    ObjectDB::spin_lock._0_1_ = '\0';
    if ((uVar40 == 0) ||
       (pNVar33 = (Node *)__dynamic_cast(uVar40,&Object::typeinfo,&Node::typeinfo,0),
       pNVar33 == (Node *)0x0)) goto LAB_00108b4f;
    if (local_128 == (MultiplayerSpawner *)0x0) {
      _err_print_error("_update_spawn_visibility",
                       "modules/multiplayer/scene_replication_interface.cpp",0x184,
                       "Parameter \"spawner\" is null.",0,0);
    }
    else {
      ...
      if (cVar29 == '\0') {
        _err_print_error("_update_spawn_visibility",
                         "modules/multiplayer/scene_replication_interface.cpp",0x185,
                         "Condition \"!_has_authority(spawner)\" is true. Returning: ERR_BUG",0,0);
      }
      else {
        cVar29 = HashMap<ObjectID,SceneReplicationInterface::TrackedNode,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,SceneReplicationInterface::TrackedNode>>>
                 ::_lookup_pos(this_00,*(ObjectID **)param_2,(uint *)local_68);
        if (cVar29 != '\0') {
          lVar34 = HashMap<ObjectID,SceneReplicationInterface::TrackedNode,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,SceneReplicationInterface::TrackedNode>>>
          ...
          if (local_a8._4_4_ != 0) {
            ...
            while( true ) {
              ...
              uVar36 = local_ec[0];
              if ((cVar30 != '\0') &&
                 (cVar29 = MultiplayerSynchronizer::is_visible_to((int)lVar35), cVar29 != '\0'))
              break;
              iVar37 = (int)lVar34;
              uVar36 = local_ec[0];
              while( true ) {
...
LAB_001082f3:
                _err_print_error("_update_spawn_visibility",
                                 "modules/multiplayer/scene_replication_interface.cpp",0x18b,
                                 "Condition \"!sync\" is true. Continuing.",0,0);
                iVar37 = (int)lVar34;
                uVar36 = local_ec[0];
              }
...
LAB_0010832c:
          ...
          if (uVar36 == 0) {
            ...
            if (cVar29 == '\0') {
              ...
              do {
                cVar29 = HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>>::
                         _lookup_pos((HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>>
                                      *)(plVar46 + 8),*(ObjectID **)param_2,local_d8);
                if (cVar29 == '\0') {
...
LAB_001083a0:
            ...
            if (local_78._4_4_ != 0) {
              ...
              do {
                ...
                local_e0 = uVar36;
                if ((*(long *)(this + 0x188) != 0) && (*(int *)(this + 0x1ac) != 0)) {
                  uVar40 = *(ulong *)(hash_table_size_primes_inv +
                                     (ulong)*(uint *)(this + 0x1a8) * 8);
                  ...
                  if (uVar31 != 0) {
                    ...
                    do {
                      if ((uVar43 == uVar31) &&
                         (uVar36 == *(uint *)(*(long *)(*(long *)(this + 0x188) + lVar34 * 8) + 0x10
                                             ))) {
                        SceneCacheInterface::send_object_cache
                                  (*(Object **)(this + 0x290),(int)local_128,(int *)(ulong)uVar36);
                        _send_raw(this,*(uchar **)(this + 0x2a0),local_e4,uVar36,true);
                        HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
                        ::operator[]((HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
                                      *)(this + 0x180),(int *)&local_e0);
                        HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>>::
                        insert((ObjectID *)local_d8);
                        goto LAB_001089cd;
                      }
                      uVar42 = uVar42 + 1;
                      auVar6._8_8_ = 0;
                      ...
                      iVar37 = SUB164(auVar6 * auVar14,8);
                            ...
                            (auVar7._8_8_ = 0, auVar7._0_8_ = uVar31 * uVar40, auVar15._8_8_ = 0,
                            auVar15._0_8_ = uVar41, auVar8._8_8_ = 0,
                            auVar8._0_8_ = ((*(uint *)(hash_table_size_primes +
                                                      (ulong)*(uint *)(this + 0x1a8) * 4) + iVar37)
                                           - SUB164(auVar7 * auVar15,8)) * uVar40, auVar16._8_8_ = 0
                            , auVar16._0_8_ = uVar41, uVar42 <= SUB164(auVar8 * auVar16,8)));
                  }
                }
                _err_print_error("_update_spawn_visibility",
                                 "modules/multiplayer/scene_replication_interface.cpp",0x1b7,
                                 "Condition \"!peers_info.has(pid)\" is true. Continuing.",0,0);
LAB_001089cd:
                if (iVar26 <= (int)local_120 + 1) break;
                local_120 = local_120 + 1;
              } while( true );
            }
            goto LAB_001083b3;
          }
          this_01 = (HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
                     *)(this + 0x180);
          cVar30 = HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
                   ::_lookup_pos(this_01,(int *)(ulong)uVar36,local_d8);
          if (cVar30 == '\0') {
            uVar44 = 0x1f;
            _err_print_error("_update_spawn_visibility",
                             "modules/multiplayer/scene_replication_interface.cpp",0x19a,
                             "Condition \"!peers_info.has(p_peer)\" is true. Returning: ERR_INVALID_PARAMETER"
                             ,0,0);
          }
          else {
            uVar44 = 0;
            lVar34 = HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
                     ::operator[](this_01,(int *)local_ec);
            cVar30 = HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>>::
                     _lookup_pos((HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>>
                                  *)(lVar34 + 0x28),*(ObjectID **)param_2,local_d8);
            if (cVar29 != cVar30) {
              if (cVar29 != '\0') {
                HashSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>>::insert
                          ((int *)local_d8);
                ...
                do {
                  ...
                  if ((*(long *)(this + 0x188) != 0) && (*(int *)(this + 0x1ac) != 0)) {
                    ...
                    if (uVar31 != 0) {
                      ...
                      do {
                        if ((uVar43 == uVar31) &&
                           (uVar36 == *(uint *)(*(long *)(*(long *)(this + 0x188) + lVar34 * 8) +
                                               0x10))) {
                          lVar34 = HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
                                   ::operator[](this_01,(int *)local_d8);
                          HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>>
                          ::erase((HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>>
                                   *)(lVar34 + 0x28),param_2);
                        ...
                        iVar37 = SUB164(auVar2 * auVar10,8);
                              ...
                              (auVar3._8_8_ = 0, auVar3._0_8_ = uVar31 * uVar40, auVar11._8_8_ = 0,
                              auVar11._0_8_ = uVar41, auVar4._8_8_ = 0,
                              auVar4._0_8_ = ((*(uint *)(hash_table_size_primes +
                                                        (ulong)*(uint *)(this + 0x1a8) * 4) + iVar37
                                              ) - SUB164(auVar3 * auVar11,8)) * uVar40,
                              auVar12._8_8_ = 0, auVar12._0_8_ = uVar41,
                              uVar42 <= SUB164(auVar4 * auVar12,8)));
                    }
                  }
                  _err_print_error("_update_spawn_visibility",
                                   "modules/multiplayer/scene_replication_interface.cpp",0x1c2,
                                   "Condition \"!peers_info.has(pid)\" is true. Continuing.",0,0);
LAB_00108798:
                  if (iVar26 <= (int)local_128 + 1) goto code_r0x001087a8;
        ...
        _err_print_error("_update_spawn_visibility",
                         "modules/multiplayer/scene_replication_interface.cpp",0x186,
                         "Condition \"!tracked_nodes.has(p_oid)\" is true. Returning: ERR_BUG",0,0);
      }
    }
  }
LAB_0010854f:
...
LAB_001083bb:
  if (pvVar39 != (void *)0x0) {
    ...
    if ((local_78._4_4_ != 0) &&
       (*(uint *)(hash_table_size_primes + (local_78 & 0xffffffff) * 4) != 0)) {
...
/* SceneReplicationInterface::_node_ready(ObjectID const&) */

void __thiscall
SceneReplicationInterface::_node_ready(SceneReplicationInterface *this,ObjectID *param_1)

{
  ...
  lVar20 = *(long *)param_1;
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if ((pOVar30 != (ObjectID *)0x0) && (iVar1 = *(int *)(this + 0x25c), iVar1 != 0)) {
    ...
    if (uVar21 != 0) {
      ...
      do {
        if (((uint)uVar29 == uVar21) &&
           (lVar20 == *(long *)(pOVar30 + (ulong)*(uint *)(*(long *)(this + 0x240) + lVar25 * 4) * 8
                               ))) {
        ...
        iVar23 = SUB164(auVar3 * auVar11,8);
              ...
              (auVar4._8_8_ = 0, auVar4._0_8_ = (ulong)uVar21 * lVar26, auVar12._8_8_ = 0,
              auVar12._0_8_ = uVar27, auVar5._8_8_ = 0,
              auVar5._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                               (ulong)*(uint *)(this + 600) * 4) + iVar23) -
                                    SUB164(auVar4 * auVar12,8)) * lVar26, auVar13._8_8_ = 0,
              auVar13._0_8_ = uVar27, uVar28 <= SUB164(auVar5 * auVar13,8)));
    }
  }
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    _err_print_error("_node_ready","modules/multiplayer/scene_replication_interface.cpp",0xaf,
                     "Condition \"!spawn_queue.has(p_oid)\" is true.",0,0);
    return;
  }
  goto LAB_00109124;
LAB_00108f00:
  ...
  if ((uVar19 >> 0x18 & 0x7fffffffff) == (*puVar22 & 0x7fffffffff)) {
    ...
    ObjectDB::spin_lock._0_1_ = '\0';
    if ((uVar19 == 0) ||
       (lVar20 = __dynamic_cast(uVar19,&Object::typeinfo,&MultiplayerSpawner::typeinfo,0),
       lVar20 == 0)) goto LAB_001090ae;
    ...
    ObjectDB::spin_lock._0_1_ = '\0';
LAB_001090ae:
    _err_print_error("_node_ready","modules/multiplayer/scene_replication_interface.cpp",0xbb,
                     "Condition \"!spawner\" is true. Continuing.",0,0);
  }
  while( true ) {
    iVar23 = iVar23 + 1;
    pOVar30 = pOVar30 + 8;
      ...
      if (uVar21 != 0) {
        ...
        do {
          if (((uint)uVar27 == uVar21) &&
             (*(long *)pOVar30 == *(long *)(*(long *)(*(long *)(this + 0x1c0) + lVar26 * 8) + 0x10))
             ) {
            lVar20 = HashMap<ObjectID,SceneReplicationInterface::TrackedNode,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,SceneReplicationInterface::TrackedNode>>>
                     ::operator[]((HashMap<ObjectID,SceneReplicationInterface::TrackedNode,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,SceneReplicationInterface::TrackedNode>>>
                                   *)(this + 0x1b8),pOVar30);
          ...
          iVar24 = SUB164(auVar7 * auVar15,8);
                ...
                (auVar8._8_8_ = 0, auVar8._0_8_ = (ulong)uVar21 * lVar20, auVar16._8_8_ = 0,
                auVar16._0_8_ = uVar29, auVar9._8_8_ = 0,
                auVar9._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                                 (ulong)*(uint *)(this + 0x1e0) * 4) + iVar24) -
                                      SUB164(auVar8 * auVar16,8)) * lVar20, auVar17._8_8_ = 0,
                auVar17._0_8_ = uVar29, uVar28 <= SUB164(auVar9 * auVar17,8)));
      }
    }
    _err_print_error("_node_ready","modules/multiplayer/scene_replication_interface.cpp",0xb7,
                     "Condition \"!tracked_nodes.has(oid)\" is true. Continuing.",0,0);
  }
...
/* SceneReplicationInterface::_visibility_changed(int, ObjectID) */

void __thiscall
SceneReplicationInterface::_visibility_changed
          (SceneReplicationInterface *this,int param_1,ulong param_3)
  ...
  if (param_3 != 0) {
    ...
    if (uVar17 < (uint)ObjectDB::slot_max) {
      ...
      if ((param_3 >> 0x18 & 0x7fffffffff) == (*puVar18 & 0x7fffffffff)) {
        ...
        if ((uVar13 != 0) &&
           (pMVar11 = (MultiplayerSynchronizer *)
                      __dynamic_cast(uVar13,&Object::typeinfo,&MultiplayerSynchronizer::typeinfo,0),
           pMVar11 != (MultiplayerSynchronizer *)0x0)) {
          ...
          if ((*(long *)(this + 0x1e8) != 0) && (*(int *)(this + 0x20c) != 0)) {
            ...
            if (uVar17 != 0) {
              uVar17 = 0;
              while (((int)uVar13 != (int)uVar20 ||
                     (local_48 !=
                      *(ulong *)(*(long *)(this + 0x1e8) +
                                (ulong)*(uint *)(*(long *)(this + 0x1f0) + lVar15 * 4) * 8)))) {
                uVar17 = uVar17 + 1;
                auVar3._8_8_ = 0;
                ...
                iVar10 = SUB164(auVar3 * auVar7,8);
                if ((uVar1 == 0) ||
                   (auVar4._8_8_ = 0, auVar4._0_8_ = uVar13 * lVar12, auVar8._8_8_ = 0,
                   auVar8._0_8_ = uVar19, auVar5._8_8_ = 0,
                   auVar5._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                                    (ulong)*(uint *)(this + 0x208) * 4) + iVar10) -
                                         SUB164(auVar4 * auVar8,8)) * lVar12, auVar9._8_8_ = 0,
                   auVar9._0_8_ = uVar19, SUB164(auVar5 * auVar9,8) < uVar17)) goto LAB_00109350;
              }
...
LAB_00109350:
          _update_sync_visibility(this,param_1,pMVar11);
          if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
            return;
          }
          goto LAB_00109448;
...
LAB_001093fa:
    _err_print_error("_visibility_changed","modules/multiplayer/scene_replication_interface.cpp",
                     uVar16,pcVar14,0,0);
    return;
  }
LAB_00109448:
...
/* SceneReplicationInterface::on_peer_change(int, bool) */

void __thiscall
SceneReplicationInterface::on_peer_change(SceneReplicationInterface *this,int param_1,bool param_2)
  ...
  if (!param_2) {
    if ((*(long *)(this + 0x188) != 0) && (*(int *)(this + 0x1ac) != 0)) {
      ...
      if (uVar54 != 0) {
        ...
        do {
          if ((uVar54 == uVar49) &&
             (param_1 == *(int *)(*(long *)(*(long *)(this + 0x188) + lVar53 * 8) + 0x10))) {
            pPVar40 = (PeerInfo *)
                      HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
                      ::operator[]((HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
                                    *)(this + 0x180),&local_12c);
          ...
          iVar44 = SUB164(auVar9 * auVar22,8);
                ...
                (auVar10._8_8_ = 0, auVar10._0_8_ = uVar54 * uVar39, auVar23._8_8_ = 0,
                auVar23._0_8_ = uVar46, auVar11._8_8_ = 0,
                auVar11._0_8_ =
                     ((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x1a8) * 4) +
                      iVar44) - SUB164(auVar10 * auVar23,8)) * uVar39, auVar24._8_8_ = 0,
                auVar24._0_8_ = uVar46, uVar56 <= SUB164(auVar11 * auVar24,8)));
      }
    }
    _err_print_error("on_peer_change","modules/multiplayer/scene_replication_interface.cpp",0x69,
                     "Condition \"!peers_info.has(p_id)\" is true.",0,0);
    goto LAB_00109a18;
  }
  _local_128 = (undefined1  [16])0x0;
  local_118 = (undefined1  [16])0x0;
  local_100[0] = (HashSet)0x0;
  local_100[1] = (HashSet)0x0;
  local_100[2] = (HashSet)0x0;
  local_100[3] = (HashSet)0x0;
  local_100[4] = (HashSet)0x0;
  local_100[5] = (HashSet)0x0;
  local_100[6] = (HashSet)0x0;
  local_100[7] = (HashSet)0x0;
  local_100[8] = (HashSet)0x0;
  local_100[9] = (HashSet)0x0;
  local_100[10] = (HashSet)0x0;
  local_100[0xb] = (HashSet)0x0;
  local_100[0xc] = (HashSet)0x0;
  local_100[0xd] = (HashSet)0x0;
  local_100[0xe] = (HashSet)0x0;
  local_100[0xf] = (HashSet)0x0;
...
LAB_001095c6:
    if (uVar38 < 0x17) goto LAB_001095cb;
  }
  else {
    lVar53 = 0;
    if (uVar38 != 0) {
...
LAB_0010963a:
    if (uVar38 < 0x17) goto LAB_0010963f;
  }
  else {
    lVar53 = 0;
    if (uVar38 != 0) {
...
LAB_00109693:
  *(undefined2 *)(this_00 + 0xe0) = 0;
  PeerInfo::~PeerInfo(&local_128);
  iVar36 = local_12c;
  iVar44 = *(int *)(this + 0x20c);
  if (iVar44 != 0) {
    pOVar57 = *(ObjectID **)(this + 0x1e8);
    for (iVar51 = 1; _update_spawn_visibility(this,iVar36,pOVar57), iVar51 < iVar44;
        iVar51 = iVar51 + 1) {
      pOVar57 = pOVar57 + 8;
    }
  }
    ...
    do {
      ...
      if (uVar42 < (uint)ObjectDB::slot_max) {
        ...
        if ((uVar39 >> 0x18 & 0x7fffffffff) == (*puVar43 & 0x7fffffffff)) {
          ...
          ObjectDB::spin_lock._0_1_ = '\0';
          if (uVar39 == 0) goto LAB_00109b14;
          pMVar41 = (MultiplayerSynchronizer *)
                    __dynamic_cast(uVar39,&Object::typeinfo,&MultiplayerSynchronizer::typeinfo,0);
        }
        else {
...
LAB_00109a18:
  ...
  while( true ) {
    ...
    uVar38 = uVar38 + 1;
    if ((uVar42 == 0) ||
       (auVar13._8_8_ = 0, auVar13._0_8_ = uVar42 * uVar39, auVar26._8_8_ = 0,
       auVar26._0_8_ = uVar45, auVar14._8_8_ = 0,
       auVar14._0_8_ = ((uVar54 + uVar48) - SUB164(auVar13 * auVar26,8)) * uVar39, auVar27._8_8_ = 0
       , auVar27._0_8_ = uVar45, uVar46 = uVar47, SUB164(auVar14 * auVar27,8) < uVar38)) break;
LAB_001098cd:
    auVar15._8_8_ = 0;
    ...
    if ((uVar49 == uVar42) && (param_1 == *(int *)(*(long *)(lVar53 + uVar46 * 8) + 0x10))) {
      ...
      uVar42 = *puVar58;
      if ((uVar42 != 0) &&
         (auVar16._8_8_ = 0, auVar16._0_8_ = uVar42 * uVar39, auVar29._8_8_ = 0,
         auVar29._0_8_ = uVar45, auVar17._8_8_ = 0,
         auVar17._0_8_ = ((uVar48 + uVar54) - SUB164(auVar16 * auVar29,8)) * uVar39,
         auVar30._8_8_ = 0, auVar30._0_8_ = uVar45, uVar46 = (ulong)uVar48, uVar55 = uVar52,
        ...
        while( true ) {
          ...
          *puVar3 = uVar6;
          ...
          uVar42 = *puVar58;
          if ((uVar42 == 0) ||
             (auVar18._8_8_ = 0, auVar18._0_8_ = uVar42 * uVar39, auVar31._8_8_ = 0,
             auVar31._0_8_ = uVar45, auVar19._8_8_ = 0,
             auVar19._0_8_ =
                  ((SUB164(auVar20 * auVar33,8) + uVar54) - SUB164(auVar18 * auVar31,8)) * uVar39,
...
/* SceneReplicationInterface::_send_delta(int, HashSet<ObjectID, HashMapHasherDefault,
   ...
   DefaultTypedAllocator<HashMapElement<ObjectID, unsigned long> > > const&) */

void __thiscall
SceneReplicationInterface::_send_delta
          (SceneReplicationInterface *this,int param_1,HashSet *param_2,ulong param_3,
          HashMap *param_4)

{
  ...
  if (lVar28 < *(int *)(this + 0x2ac) + 0x11) {
    CowData<unsigned_char>::resize<false>
              ((CowData<unsigned_char> *)(this + 0x2a0),(long)(*(int *)(this + 0x2ac) + 0x11));
  }
  CowData<unsigned_char>::_copy_on_write((CowData<unsigned_char> *)(this + 0x2a0));
  ...
  *puVar5 = 0x16;
  ...
  if (iVar3 != 0) {
    ...
    do {
      ...
      ObjectDB::spin_lock._0_1_ = '\0';
      if (uVar29 == 0) goto LAB_0010a25e;
      pMVar27 = (MultiplayerSynchronizer *)
                __dynamic_cast(uVar29,&Object::typeinfo,&MultiplayerSynchronizer::typeinfo,0);
      ...
      if (cVar25 != '\0') {
        ...
        if ((lVar6 != 0) && (*(int *)(param_4 + 0x2c) != 0)) {
          ...
          if (uVar42 != 0) {
            ...
            iVar33 = iVar26;
LAB_0010a108:
            if ((uVar38 != (uint)uVar37) ||
               (lVar28 != *(long *)(*(long *)(lVar6 + lVar35 * 8) + 0x10))) goto LAB_0010a0c0;
            uVar38 = 0;
            while ((uVar42 != (uint)uVar37 ||
                   (lVar28 != *(long *)(*(long *)(lVar6 + lVar34 * 8) + 0x10)))) {
              uVar38 = uVar38 + 1;
              auVar14._8_8_ = 0;
              ...
              if ((uVar42 == 0) ||
                 (auVar15._8_8_ = 0, auVar15._0_8_ = (ulong)uVar42 * lVar8, auVar22._8_8_ = 0,
                 auVar22._0_8_ = uVar40, auVar16._8_8_ = 0,
                 auVar16._0_8_ = (ulong)((uVar31 + iVar26) - SUB164(auVar15 * auVar22,8)) * lVar8,
                 auVar23._8_8_ = 0, auVar23._0_8_ = uVar40, SUB164(auVar16 * auVar23,8) < uVar38)) {
                _err_print_error("operator[]","./core/templates/hash_map.h",0x245,
                                 "FATAL: Condition \"!exists\" is true.",0,0);
                _err_flush_stdout();
                    /* WARNING: Does not return */
...
LAB_0010a1bc:
        MultiplayerSynchronizer::get_delta_state((ulong)&local_98,(ulong)pMVar27,(ulong *)param_3);
        if (local_98 != (long *)0x0) {
          ...
          if (iVar26 != 0) {
            ...
            if (local_98 != (long *)0x0) {
              ppVVar36 = local_70;
              for (pVVar9 = (Variant *)*local_98; pVVar9 != (Variant *)0x0;
                  pVVar9 = *(Variant **)(pVVar9 + 0x18)) {
                *ppVVar36 = pVVar9;
                ppVVar36 = ppVVar36 + 1;
              }
            }
            ...
            iVar26 = MultiplayerAPI::encode_and_compress_variants
                               (local_70,iVar26,(uchar *)0x0,(int *)&local_a4,(bool *)0x0,false);
            if (iVar26 == 0) {
              if (*(int *)(this + 0x2ac) < (int)local_a4) {
                ...
                vformat<int,int,NodePath>
                          ((StringName *)&local_68,(StrRange *)local_80,uVar31,uVar4,
                           (NodePath *)&local_88);
                _err_print_error("_send_delta","modules/multiplayer/scene_replication_interface.cpp"
                                 ,0x2e7,"Condition \"size > delta_mtu\" is true. Continuing.",
                                 (StringName *)&local_68,0,0);
                CowData<char32_t>::_unref((CowData<char32_t> *)&local_68);
                ...
                if (local_a4 != 0) {
                  ...
                  MultiplayerAPI::encode_and_compress_variants
                            (ppVVar1,iVar39,puVar5 + (local_c0 + 0x10),(int *)&local_a4,(bool *)0x0,
                             false);
                ...
                lVar28 = HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
                         ::operator[]((HashMap<int,SceneReplicationInterface::PeerInfo,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,SceneReplicationInterface::PeerInfo>>>
                                       *)(this + 0x180),&local_ac);
                puVar32 = (ulong *)HashMap<ObjectID,unsigned_long,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,unsigned_long>>>
                                   ::operator[]((HashMap<ObjectID,unsigned_long,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,unsigned_long>>>
                                                 *)(lVar28 + 0x50),local_110);
                *puVar32 = param_3;
              }
            }
            else {
              _err_print_error("_send_delta","modules/multiplayer/scene_replication_interface.cpp",
                               0x2e5,"Condition \"err != OK\" is true. Continuing.",
                               "Unable to encode delta state.",0,0);
            }
            if (ppVVar1 != (Variant **)0x0) {
              LOCK();
              ppVVar1 = ppVVar1 + -2;
      ...
      while( true ) {
        ...
        if (uVar29 != 0) break;
LAB_0010a25e:
        _err_print_error("_send_delta","modules/multiplayer/scene_replication_interface.cpp",0x2ce,
                         "Condition \"!sync || !sync->get_replication_config_ptr() || !_has_authority(sync)\" is true. Continuing."
                         ,0);
      }
    } while( true );
...
LAB_0010a0c0:
  ...
  if ((uVar38 == 0) ||
     (auVar12._8_8_ = 0, auVar12._0_8_ = (ulong)uVar38 * lVar8, auVar19._8_8_ = 0,
     auVar19._0_8_ = uVar40, auVar13._8_8_ = 0,
     auVar13._0_8_ = (ulong)((uVar31 + iVar33) - SUB164(auVar12 * auVar19,8)) * lVar8,
     auVar20._8_8_ = 0, auVar20._0_8_ = uVar40, SUB164(auVar13 * auVar20,8) < uVar41))
  goto LAB_0010a1bc;
  goto LAB_0010a108;
}
...
void __thiscall SceneReplicationInterface::on_network_process(SceneReplicationInterface *this)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (*(int *)(this + 0x25c) != 0) {
    _err_print_error("on_network_process","modules/multiplayer/scene_replication_interface.cpp",0x85
                     ,
                     "An error happened during last spawn, this usually means the \'ready\' signal was not emitted by the spawned node."
                     ,0,0);
    ...
    if (iVar3 != 0) {
      ...
      do {
        ...
        create_custom_callable_function_pointer<SceneReplicationInterface,ObjectID_const&>
                  ((SceneReplicationInterface *)local_68,(char *)this,
                   (_func_void_ObjectID_ptr *)"&SceneReplicationInterface::_node_ready");
        cVar11 = (*pcVar7)(plVar12,SceneStringNames::singleton + 0x50,
                           (SceneReplicationInterface *)local_68);
        Callable::~Callable((Callable *)local_68);
        if (cVar11 != '\0') {
        ...
        while( true ) {
          if (iVar3 <= (int)lVar21 + 1) {
            if ((*(long *)(this + 0x238) != 0) && (*(int *)(this + 0x25c) != 0)) {
              if (*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 600) * 4) != 0) {
                memset(*(void **)(this + 0x250),0,
                       (ulong)*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 600) * 4) *
                       4);
              }
              *(undefined4 *)(this + 0x25c) = 0;
            }
          ...
          if (uVar13 != 0) break;
LAB_0010acee:
          _err_print_error("on_network_process",
                           "modules/multiplayer/scene_replication_interface.cpp",0x88,
                           "Condition \"!node\" is true. Continuing.",0,0);
        }
      } while( true );
    }
...
LAB_0010a8e3:
  ...
  for (puVar4 = *(undefined8 **)(this + 0x198); puVar4 != (undefined8 *)0x0;
    ...
    if (uVar18 != 0) {
      ...
      if (uVar2 == 0) {
        *(ushort *)(puVar4 + 0x1f) = uVar20;
        _send_sync((int)this,(HashSet *)(ulong)*(uint *)(puVar4 + 2),(ushort)(HashSet *)local_68,
                   (ulong)(uint)uVar20);
...
void __thiscall
CallableCustomMethodPointer<SceneReplicationInterface,void,int,ObjectID>::
~CallableCustomMethodPointer
          (CallableCustomMethodPointer<SceneReplicationInterface,void,int,ObjectID> *this)
...
void __thiscall
CallableCustomMethodPointer<SceneReplicationInterface,void,ObjectID_const&>::
~CallableCustomMethodPointer
          (CallableCustomMethodPointer<SceneReplicationInterface,void,ObjectID_const&> *this)
...
undefined8 __thiscall
CallableCustomMethodPointer<SceneReplicationInterface,void,int,ObjectID>::get_argument_count
          (CallableCustomMethodPointer<SceneReplicationInterface,void,int,ObjectID> *this,
          bool *param_1)
...
undefined8 __thiscall
CallableCustomMethodPointer<SceneReplicationInterface,void,ObjectID_const&>::get_argument_count
          (CallableCustomMethodPointer<SceneReplicationInterface,void,ObjectID_const&> *this,
          bool *param_1)
...
/* SceneReplicationInterface::_track(ObjectID const&) [clone .cold] */

void SceneReplicationInterface::_track(ObjectID *param_1)
...
undefined8 __thiscall
CallableCustomMethodPointer<SceneReplicationInterface,void,int,ObjectID>::get_object
          (CallableCustomMethodPointer<SceneReplicationInterface,void,int,ObjectID> *this)
...
undefined8 __thiscall
CallableCustomMethodPointer<SceneReplicationInterface,void,ObjectID_const&>::get_object
          (CallableCustomMethodPointer<SceneReplicationInterface,void,ObjectID_const&> *this)
...
/* SceneReplicationInterface::PeerInfo::~PeerInfo() */

void __thiscall SceneReplicationInterface::PeerInfo::~PeerInfo(PeerInfo *this)
...
/* HashMap<ObjectID, SceneReplicationInterface::TrackedNode, HashMapHasherDefault,
   HashMapComparatorDefault<ObjectID>, DefaultTypedAllocator<HashMapElement<ObjectID,
   SceneReplicationInterface::TrackedNode> > >::operator[](ObjectID const&) */
...

{
  ...
  if (lVar3 == 0) {
    uVar33 = uVar34 * 4;
    local_c0[0] = (HashSet)0x0;
    local_c0[1] = (HashSet)0x0;
    local_c0[2] = (HashSet)0x0;
    local_c0[3] = (HashSet)0x0;
    local_c0[4] = (HashSet)0x0;
    local_c0[5] = (HashSet)0x0;
    local_c0[6] = (HashSet)0x0;
    local_c0[7] = (HashSet)0x0;
    local_c0[8] = (HashSet)0x0;
    local_c0[9] = (HashSet)0x0;
    local_c0[10] = (HashSet)0x0;
    local_c0[0xb] = (HashSet)0x0;
    local_c0[0xc] = (HashSet)0x0;
    local_c0[0xd] = (HashSet)0x0;
    local_c0[0xe] = (HashSet)0x0;
    local_c0[0xf] = (HashSet)0x0;
    uVar43 = uVar34 * 8;
    ...
    *(void **)(this + 8) = pvVar37;
    ...
    if (*(int *)(this + 0x2c) != 0) {
      ...
      if (uVar45 != 0) {
        uVar47 = 0;
        do {
          if ((uVar45 == (uint)uVar43) &&
             (pOVar48 == *(ObjectID **)(*(long *)(lVar3 + lVar40 * 8) + 0x10))) {
          ...
          uVar38 = SUB164(auVar7 * auVar19,8);
                ...
                (auVar8._8_8_ = 0, auVar8._0_8_ = (ulong)uVar45 * lVar4, auVar20._8_8_ = 0,
                auVar20._0_8_ = uVar34, auVar9._8_8_ = 0,
                auVar9._0_8_ = (ulong)((uVar38 + uVar42) - SUB164(auVar8 * auVar20,8)) * lVar4,
  ...
  local_dc = 0;
  cVar32 = _lookup_pos(this,pOVar48,&local_dc);
  if (cVar32 == '\0') {
...
/* Callable create_custom_callable_function_pointer<SceneReplicationInterface, ObjectID
   const&>(SceneReplicationInterface*, char const*, void (SceneReplicationInterface::*)(ObjectID
   const&)) */

SceneReplicationInterface *
create_custom_callable_function_pointer<SceneReplicationInterface,ObjectID_const&>
          (SceneReplicationInterface *param_1,char *param_2,_func_void_ObjectID_ptr *param_3)
...
SceneReplicationInterface *
create_custom_callable_function_pointer<SceneReplicationInterface,int,ObjectID>
          (SceneReplicationInterface *param_1,char *param_2,_func_void_int_ObjectID *param_3)
...
/* WARNING: Removing unreachable block (ram,0x0010ea38) */
/* WARNING: Removing unreachable block (ram,0x0010ebcd) */
/* WARNING: Removing unreachable block (ram,0x0010ebd9) */
...
/* WARNING: Removing unreachable block (ram,0x0010ed70) */
/* WARNING: Removing unreachable block (ram,0x0010ef05) */
/* WARNING: Removing unreachable block (ram,0x0010ef11) */
...
/* WARNING: Removing unreachable block (ram,0x0010f068) */
/* WARNING: Removing unreachable block (ram,0x0010f1fd) */
/* WARNING: Removing unreachable block (ram,0x0010f209) */
...
/* WARNING: Removing unreachable block (ram,0x0010f3b0) */
/* WARNING: Removing unreachable block (ram,0x0010f545) */
/* WARNING: Removing unreachable block (ram,0x0010f551) */
/* String vformat<int, int, NodePath>(String const&, int const, int const, NodePath const) */

undefined8 *
vformat<int,int,NodePath>
          (undefined8 *param_1,bool *param_2,int param_3,int param_4,NodePath *param_5)
...
void __thiscall
CallableCustomMethodPointer<SceneReplicationInterface,void,ObjectID_const&>::call
          (CallableCustomMethodPointer<SceneReplicationInterface,void,ObjectID_const&> *this,
...
void __thiscall
CallableCustomMethodPointer<SceneReplicationInterface,void,int,ObjectID>::call
          (CallableCustomMethodPointer<SceneReplicationInterface,void,int,ObjectID> *this,
          Variant **param_1,int param_2,Variant *param_3,CallError *param_4)
...
void HashMap<ObjectID,unsigned_long,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,unsigned_long>>>
     ::insert(ObjectID *param_1,ulong *param_2,bool param_3)
...
LAB_0010fff1:
    if (iVar25 != 0) {
      ...
      if (uVar31 != 0) {
        uVar33 = 0;
        do {
          if (((uint)uVar29 == uVar31) &&
             (*(long *)(*(long *)((long)__s_00 + lVar27 * 8) + 0x10) == lVar34)) {
          ...
          uVar22 = SUB164(auVar6 * auVar14,8);
                ...
                (auVar7._8_8_ = 0, auVar7._0_8_ = (ulong)uVar31 * lVar28, auVar15._8_8_ = 0,
                auVar15._0_8_ = uVar30, auVar8._8_8_ = 0,
                auVar8._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                                 (ulong)(uint)param_2[5] * 4) + uVar22) -
                                      SUB164(auVar7 * auVar15,8)) * lVar28, auVar16._8_8_ = 0,
                auVar16._0_8_ = uVar30, uVar33 <= SUB164(auVar8 * auVar16,8)));
      }
    }
  }
  if ((float)uVar2 * __LC33 < (float)(iVar25 + 1)) {
    ...
    _resize_and_rehash((HashMap<ObjectID,unsigned_long,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,unsigned_long>>>
...
LAB_001102d0:
  *(undefined1 (**) [16])param_1 = pauVar24;
  return;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* HashMap<ObjectID, unsigned long, HashMapHasherDefault, HashMapComparatorDefault<ObjectID>,
   DefaultTypedAllocator<HashMapElement<ObjectID, unsigned long> > >::operator[](ObjectID const&) */
...
void HashMap<unsigned_int,ObjectID,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,ObjectID>>>
     ::insert(uint *param_1,ObjectID *param_2,bool param_3)
...
LAB_00110c21:
  ...
  if ((float)uVar22 * __LC33 < (float)(iVar27 + 1)) {
    ...
    _resize_and_rehash((HashMap<unsigned_int,ObjectID,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,ObjectID>>>
...
/* SceneReplicationInterface::PeerInfo::PeerInfo(SceneReplicationInterface::PeerInfo const&) */

void __thiscall SceneReplicationInterface::PeerInfo::PeerInfo(PeerInfo *this,PeerInfo *param_1)
...
LAB_0011179b:
  if ((*(int *)(param_1 + 0x7c) != 0) &&
     (plVar11 = *(long **)(param_1 + 0x68), plVar11 != (long *)0x0)) {
    do {
      HashMap<ObjectID,unsigned_long,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,unsigned_long>>>
      ::insert(aOStack_48,(ulong *)(this + 0x50),(bool)((char)plVar11 + '\x10'));
...
LAB_0011185a:
  if ((*(int *)(param_1 + 0xac) != 0) &&
     (plVar11 = *(long **)(param_1 + 0x98), plVar11 != (long *)0x0)) {
    do {
      HashMap<unsigned_int,ObjectID,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,ObjectID>>>
      ::insert((uint *)aOStack_48,(ObjectID *)(this + 0x80),(bool)((char)plVar11 + '\x10'));
      plVar11 = (long *)*plVar11;
    } while (plVar11 != (long *)0x0);
  }
...
LAB_00111919:
  if ((*(int *)(param_1 + 0xdc) != 0) &&
     (plVar11 = *(long **)(param_1 + 200), plVar11 != (long *)0x0)) {
    do {
      HashMap<unsigned_int,ObjectID,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,ObjectID>>>
      ::insert((uint *)aOStack_48,(ObjectID *)(this + 0xb0),(bool)((char)plVar11 + '\x10'));
      plVar11 = (long *)*plVar11;
    } while (plVar11 != (long *)0x0);
  }
...
/* HashMap<int, SceneReplicationInterface::PeerInfo, HashMapHasherDefault,
   HashMapComparatorDefault<int>, DefaultTypedAllocator<HashMapElement<int,
   SceneReplicationInterface::PeerInfo> > >::operator[](int const&) */
...

{
  ...
  PeerInfo *local_270;
  uint local_23c;
  PeerInfo local_238 [16];
  undefined1 local_228 [16];
  undefined8 local_218;
  HashSet local_210 [16];
  ...
  uVar33 = CONCAT44(0,uVar31);
  if ((lVar3 != 0) && (*(int *)(this + 0x2c) != 0)) {
    ...
    if (uVar30 != 0) {
      ...
      do {
        ...
        uVar46 = SUB164(auVar6 * auVar18,8);
              ...
              (auVar7._8_8_ = 0, auVar7._0_8_ = uVar30 * uVar38, auVar19._8_8_ = 0,
              auVar19._0_8_ = uVar33, auVar8._8_8_ = 0,
              auVar8._0_8_ = ((uVar46 + uVar31) - SUB164(auVar7 * auVar19,8)) * uVar38,
              auVar20._8_8_ = 0, auVar20._0_8_ = uVar33, uVar47 <= SUB164(auVar8 * auVar20,8)));
    }
  }
  local_158 = 0;
  local_238[0] = (PeerInfo)0x0;
  local_238[1] = (PeerInfo)0x0;
  local_238[2] = (PeerInfo)0x0;
  local_238[3] = (PeerInfo)0x0;
  local_238[4] = (PeerInfo)0x0;
  local_238[5] = (PeerInfo)0x0;
  local_238[6] = (PeerInfo)0x0;
  local_238[7] = (PeerInfo)0x0;
  local_238[8] = (PeerInfo)0x0;
  local_238[9] = (PeerInfo)0x0;
  local_238[10] = (PeerInfo)0x0;
  local_238[0xb] = (PeerInfo)0x0;
  local_238[0xc] = (PeerInfo)0x0;
  local_238[0xd] = (PeerInfo)0x0;
  local_238[0xe] = (PeerInfo)0x0;
  local_238[0xf] = (PeerInfo)0x0;
  local_218 = _LC38;
  local_1f0 = _LC38;
  local_1c0 = _LC38;
  local_190 = _LC38;
  ...
  local_210[0] = (HashSet)0x0;
  local_210[1] = (HashSet)0x0;
  local_210[2] = (HashSet)0x0;
  local_210[3] = (HashSet)0x0;
  local_210[4] = (HashSet)0x0;
  local_210[5] = (HashSet)0x0;
  local_210[6] = (HashSet)0x0;
  local_210[7] = (HashSet)0x0;
  local_210[8] = (HashSet)0x0;
  local_210[9] = (HashSet)0x0;
  local_210[10] = (HashSet)0x0;
  local_210[0xb] = (HashSet)0x0;
  local_210[0xc] = (HashSet)0x0;
  local_210[0xd] = (HashSet)0x0;
  local_210[0xe] = (HashSet)0x0;
  local_210[0xf] = (HashSet)0x0;
  ...
  local_23c = 0;
  cVar29 = _lookup_pos(this,(int *)(ulong)uVar32,&local_23c);
  if (cVar29 == '\0') {
  ...
  uVar33 = (ulong)local_23c;
  lVar3 = *(long *)(*(long *)(this + 8) + uVar33 * 8);
  HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>>::operator=
            ((HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>> *)
             (lVar3 + 0x18),(HashSet *)local_238);
  HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>>::operator=
            ((HashSet<ObjectID,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>> *)
             (lVar3 + 0x40),local_210);
  uVar31 = *(uint *)(lVar3 + 0x90);
  uVar32 = *(uint *)(hash_table_size_primes + (ulong)uVar31 * 4);
  if ((*(int *)(lVar3 + 0x94) == 0) || (*(long *)(lVar3 + 0x70) == 0)) {
LAB_001121c6:
    if (uVar32 < 0x17) goto LAB_001121cb;
  }
  else {
    lVar41 = 0;
    if (uVar32 != 0) {
...
LAB_00112221:
  ...
  uVar32 = *(uint *)(hash_table_size_primes + (ulong)uVar31 * 4);
  if ((*(int *)(lVar3 + 0xc4) == 0) || (*(long *)(lVar3 + 0xa0) == 0)) {
LAB_00112242:
    if (uVar32 < 0x17) goto LAB_00112247;
  }
  else {
    lVar41 = 0;
    if (uVar32 != 0) {
...
LAB_0011229b:
  ...
  uVar32 = *(uint *)(hash_table_size_primes + (ulong)uVar31 * 4);
  if ((*(int *)(lVar3 + 0xf4) == 0) || (*(long *)(lVar3 + 0xd0) == 0)) {
LAB_001122be:
    if (uVar32 < 0x17) goto LAB_001122c3;
  }
  else {
    lVar41 = 0;
    if (uVar32 != 0) {
...
LAB_00112319:
  lVar41 = *(long *)(this + 8);
  *(undefined2 *)(lVar3 + 0xf8) = 0;
  local_278 = (PeerInfo *)(*(long *)(lVar41 + uVar33 * 8) + 0x18);
LAB_00112113:
  local_270 = local_238;
  SceneReplicationInterface::PeerInfo::~PeerInfo(local_270);
LAB_00111c79:
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    __stack_chk_fail();

...
undefined8 * (anonymous_namespace)::GetSetCurrentLoaderInstance(void)

{
  ...
  if (GetSetCurrentLoaderInstance()::current_loader_instance == '\0') {
    ...
    if (iVar1 != 0) {
      __cxa_atexit(std::unique_ptr<LoaderInstance,std::default_delete<LoaderInstance>>::~unique_ptr,
                   &GetSetCurrentLoaderInstance()::current_loader_instance,&__dso_handle);
      __cxa_guard_release(&GetSetCurrentLoaderInstance()::current_loader_instance);
      return &GetSetCurrentLoaderInstance()::current_loader_instance;
    }
  }
  return &GetSetCurrentLoaderInstance()::current_loader_instance;
}
...

{
  ...
  *(undefined8 *)psVar12 = _locale;
  ...
  std::__ostream_insert<char,std::char_traits<char>>
            ((ostream *)local_1b8,"Destroying LoaderInstance = ",0x1c);
  ...
  *(undefined1 *)((long)local_1d8 + 1) = 0x78;
  ...
  LoaderLogger::LogMessage
            (0x1039e0,0x10,(string *)0x1,(string *)&local_1d8,(string *)local_218,
             (string *)&local_1f8);
  if (local_1d8 != local_1c8) {
    operator_delete(local_1d8,local_1c8[0] + 1);
  }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* ActiveLoaderInstance::Set(std::unique_ptr<LoaderInstance, std::default_delete<LoaderInstance> >,
   char const*) */

undefined1 ActiveLoaderInstance::Set(undefined8 *param_1,char *param_2)

{
  ...
  *(string *)((long)local_88 + (long)local_d0) = (string)0x0;
  ...
  if (param_2 == (char *)0x0) {
    ...
    if (((anonymous_namespace)::GetSetCurrentLoaderInstance()::current_loader_instance == '\0') &&
       (iVar3 = __cxa_guard_acquire(&(anonymous_namespace)::GetSetCurrentLoaderInstance()::
                                     current_loader_instance), iVar3 != 0)) {
      __cxa_atexit(std::unique_ptr<LoaderInstance,std::default_delete<LoaderInstance>>::~unique_ptr,
                   &(anonymous_namespace)::GetSetCurrentLoaderInstance()::current_loader_instance,
                   &__dso_handle);
    ...
    *(long *)pcVar11 = (anonymous_namespace)::GetSetCurrentLoaderInstance()::current_loader_instance
    ;
    if (lVar10 != 0) {
      uVar2 = 0;
      goto LAB_00100b0a;
    ...
    psStack_170 = (size_t *)
                  std::__cxx11::string::_M_create((ulong *)&psStack_170,(ulong)&sStack_1b8);
    sVar7 = _UNK_00103b08;
    ...
    *(undefined1 *)((long)psStack_170 + sStack_1b8) = 0;
    ...
    if (ppsVar8 == (string **)0x0) {
      std::__throw_logic_error("basic_string: construction from null is not valid");
      if ((anonymous_namespace)::GetSetCurrentLoaderInstance()::current_loader_instance != '\0') {
        return (anonymous_namespace)::GetSetCurrentLoaderInstance()::current_loader_instance != 0;
      }
      iVar3 = __cxa_guard_acquire(&(anonymous_namespace)::GetSetCurrentLoaderInstance()::
                                   current_loader_instance);
      if (iVar3 == 0) {
    ...
    if (sVar7 < 0x10) {
      ...
      psStack_190 = (size_t *)
                    std::__cxx11::string::_M_create((ulong *)&psStack_190,(ulong)&sStack_1b8);
      asStack_180[0] = sStack_1b8;
      __dest = psStack_190;
LAB_00100da9:
      memcpy(__dest,ppsVar8,sVar7);
    }
    ...
    *(undefined1 *)((long)psStack_190 + sStack_1b8) = 0;
    ...
    LoaderLogger::LogMessage
              (0x1039e0,0x1000,(string *)0x1,(string *)aplStack_150,(string *)&psStack_190,
               (vector *)&psStack_170);
    ...
    uVar2 = 0xf4;
LAB_00100b0a:
    if (lStack_128 == *(long *)(in_FS_OFFSET + 0x28)) {
      return uVar2;
    }
                    /* WARNING: Subroutine does not return */
    __stack_chk_fail();
...
LAB_00100a13:
  ...
  *(string *)((long)ppsVar8 + (long)local_d0) = (string)0x0;
  ...
  LoaderLogger::LogMessage
            (0x1039e0,0x1000,(string *)0x1,local_e0,(string *)&local_a8,(vector *)&local_88);
...
undefined1 ActiveLoaderInstance::Get(LoaderInstance **param_1,char *param_2)

{
  ...
  *param_1 = (anonymous_namespace)::GetSetCurrentLoaderInstance()::current_loader_instance;
  ...
  *(undefined1 *)((long)local_88 + local_d0) = 0;
  ...
  if (param_2 == (char *)0x0) {
    std::__throw_logic_error("basic_string: construction from null is not valid");
    if ((anonymous_namespace)::GetSetCurrentLoaderInstance()::current_loader_instance != '\0') {
      return (anonymous_namespace)::GetSetCurrentLoaderInstance()::current_loader_instance !=
             (LoaderInstance *)0x0;
    }
    iVar4 = __cxa_guard_acquire(&(anonymous_namespace)::GetSetCurrentLoaderInstance()::
                                 current_loader_instance);
...
LAB_00100da9:
  ...
  *(undefined1 *)((long)local_a8 + local_d0) = 0;
  ...
  LoaderLogger::LogMessage
            (0x1039e0,0x1000,(string *)0x1,(string *)local_68,(string *)&local_a8,
             (vector *)&local_88);
  if (local_68[0] != local_58) {
    operator_delete(local_68[0],local_58[0] + 1);
  }
...
bool ActiveLoaderInstance::IsAvailable(void)
...
undefined * LoaderInstance::LoaderSpecificExtensions(void)

{
  return &LoaderSpecificExtensions()::extensions;
}
...
void LoaderInstance::GetInstanceProcAddr(char *param_1,_func_void *param_2)
...
/* LoaderInstance::ExtensionIsEnabled(std::__cxx11::string const&) */

undefined8 __thiscall LoaderInstance::ExtensionIsEnabled(LoaderInstance *this,string *param_1)
...
/* LoaderInstance::LoaderInstance(XrInstance_T*, XrInstanceCreateInfo const*, XrResult
   ...
   std::default_delete<ApiLayerInterface> > > >) */

void __thiscall
LoaderInstance::LoaderInstance
          (LoaderInstance *this,undefined8 param_1,long param_2,undefined8 param_3,
            ...
            if ((uVar11 & 4) == 0) {
              if (uVar6 != 0) {
                *(undefined1 *)(plVar2 + 2) = (undefined1)local_58;
                if ((uVar11 & 2) != 0) {
                  *(undefined2 *)((long)plVar2 + (uVar11 & 0xffffffff) + 0xe) =
                       *(undefined2 *)((long)&local_60 + (uVar11 & 0xffffffff) + 6);
                }
              }
            }
            else {
              *(undefined4 *)(plVar2 + 2) = local_58;
              *(undefined4 *)((long)plVar2 + (uVar11 & 0xffffffff) + 0xc) =
                   *(undefined4 *)((long)&local_60 + (uVar11 & 0xffffffff) + 4);
            }
          }
          else {
            plVar2[2] = CONCAT44(uStack_54,local_58);
            *(undefined8 *)((long)plVar2 + (uVar11 & 0xffffffff) + 8) =
                 *(undefined8 *)((long)&local_60 + (uVar11 & 0xffffffff));
            ...
            if (7 < uVar6) {
              ...
              do {
                uVar11 = (ulong)uVar8;
                uVar8 = uVar8 + 8;
                *(undefined8 *)(((ulong)(plVar2 + 3) & 0xfffffffffffffff8) + uVar11) =
                     *(undefined8 *)((long)&local_58 + (uVar11 - lVar9));
              } while (uVar8 < uVar6);
            }
          }
        }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* LoaderInstance::CreateInstance(XrResult (*)(XrInstance_T*, char const*, void (**)()), XrResult
   ...
   std::unique_ptr<LoaderInstance, std::default_delete<LoaderInstance> >*) */

int LoaderInstance::CreateInstance
              (undefined8 param_1,code *param_2,code *param_3,undefined1 (*param_4) [16],
...

{
  ...
  *(code *)((long)local_3f8 + (long)local_440) = (code)0x0;
  ...
  LoaderLogger::LogMessage
            (0x1039e0,1,(string *)0x1,(string *)local_268,(string *)&local_3f8,(string *)&local_3d8)
  ;
  ...
  for (; pcVar5 = pcStack_430, (undefined1  [8])pcStack_430 != auVar21;
...
LAB_00101576:
    do {
      if ((RuntimeInterface::GetInstance()::instance == '\0') &&
         (iVar9 = __cxa_guard_acquire(&RuntimeInterface::GetInstance()::instance), iVar9 != 0)) {
...
LAB_00101c85:
        ...
        *(code *)((long)local_3d8 + (long)local_440) = (code)0x0;
        ...
        LoaderLogger::LogMessage
                  (0x1039e0,0x1000,(string *)0x1,(string *)local_268,(string *)&local_3d8,
                   (string *)&local_3f8);
        if (local_268[0] != (code *)local_258) {
          operator_delete(local_268[0],local_258._0_8_ + 1);
        }
      ...
      while( true ) {
        ...
        std::__cxx11::string::_M_construct<char_const*>
                  ((string *)local_268,pcVar26,pcVar26 + sVar11);
...
LAB_001029c2:
        operator_delete((void *)uVar4,uVar14);
      }
        ...
        do {
          while (lVar20 = lVar24 * 8, local_278 == puVar15) {
            ...
            _M_realloc_insert<char_const*const&>
                      ((vector<char_const*,std::allocator<char_const*>> *)local_288);
            ppcVar16 = local_3d8;
  ...
  local_3d8 = param_5;
LAB_0010170e:
  local_298 = (undefined4)((long)puVar15 - local_288._0_8_ >> 3);
  ...
  if (*(int *)(param_5 + 0x27) != 0) {
    ...
    *(undefined8 *)(local_268[0] + 8) = uVar6;
    ...
    if (cVar8 == '\0') {
      if (local_428 == pcStack_430) {
        std::vector<char_const*,std::allocator<char_const*>>::_M_realloc_insert<char_const(&)[128]>
                  (pvVar18,local_428,"XR_EXT_debug_utils");
      }
      else {
    ...
    if ((local_288._8_8_ != local_288._0_8_) &&
       (auVar21 = local_438, puVar15 = (undefined8 *)local_288._0_8_,
       puVar13 = (undefined8 *)local_288._8_8_, (undefined1  [8])pcStack_430 != local_438)) {
      do {
        ...
        if (puVar15 != puVar13) {
          ...
          if (0 < lVar20) {
            do {
              ...
              iVar9 = strcmp(pcVar26,(char *)puVar25[1]);
              if (iVar9 == 0) {
                puVar25 = puVar25 + 1;
                goto LAB_00101937;
              }
              iVar9 = strcmp(pcVar26,(char *)puVar25[2]);
              if (iVar9 == 0) {
                puVar25 = puVar25 + 2;
                goto LAB_00101937;
              }
              iVar9 = strcmp(pcVar26,(char *)puVar25[3]);
              if (iVar9 == 0) {
                puVar25 = puVar25 + 3;
                goto LAB_00101937;
              }
...
LAB_00101c5b:
          memcpy(local_268[0],__src_00,(size_t)pcVar19);
        }
        pcVar19 = local_268[0];
        puVar25 = puVar15 + -2;
  ...
  if (iVar9 < 0) {
    ...
    *(code *)((long)local_418 + (long)local_440) = (code)0x0;
    if ((LoaderLogger::GetInstance()::instance == '\0') &&
       (iVar10 = __cxa_guard_acquire(&LoaderLogger::GetInstance()::instance), iVar10 != 0)) {
      LoaderLogger::LoaderLogger((LoaderLogger *)LoaderLogger::GetInstance()::instance);
      __cxa_atexit(LoaderLogger::~LoaderLogger,LoaderLogger::GetInstance()::instance,&__dso_handle);
      __cxa_guard_release(&LoaderLogger::GetInstance()::instance);
    }
    ...
    LoaderLogger::LogMessage
              (0x1039e0,0x1000,(string *)0x1,(string *)local_4a8,(string *)&local_418,
               (string *)&local_3f8);
    if (local_268[0] != (code *)local_258) {
      operator_delete(local_268[0],local_258._0_8_ + 1);
    }
    ...
    *param_6 = (long)pLVar17;
    ...
    auVar7 = local_438;
    pcVar19 = pcStack_430;
    for (auVar21 = local_438; (undefined1  [8])pcVar19 != auVar21;
        auVar21 = (undefined1  [8])((long)auVar21 + 8)) {
    ...
    *(undefined8 *)(local_4a8 + lVar24) = _locale;
    ...
    std::__ostream_insert<char,std::char_traits<char>>
              (local_4a8,"LoaderInstance::CreateInstance succeeded with ",0x2e);
    std::ostream::_M_insert<unsigned_long>((ulong)local_4a8);
    std::__ostream_insert<char,std::char_traits<char>>
              (local_4a8," layers enabled and runtime interface - created instance = ",0x3b);
    ...
    *(undefined1 *)((long)local_3d8 + 1) = 0x78;
    ...
    do {
      vVar1 = *pvVar18;
      pvVar18 = pvVar18 + 1;
      pcVar19[-1] = (code)to_hex[abi:cxx11](unsigned_char_const*,unsigned_long)::hex
                          [(byte)vVar1 & 0xf];
      pcVar19[-2] = (code)to_hex[abi:cxx11](unsigned_char_const*,unsigned_long)::hex
                          [(byte)vVar1 >> 4];
      pcVar19 = pcVar19 + -2;
    ...
    *(code *)((long)local_3f8 + (long)local_440) = (code)0x0;
    ...
    local_3d8 = (code **)&local_3c8;
    LoaderLogger::LogMessage
              (0x1039e0,0x10,(string *)0x1,(string *)&local_3d8,(string *)&local_3f8,
               (string *)&local_418);
    if (local_3d8 != (code **)&local_3c8) {
      operator_delete(local_3d8,CONCAT35(local_3c8._5_3_,(undefined5)local_3c8) + 1);
    }
...
void __thiscall
std::unique_ptr<LoaderInstance,std::default_delete<LoaderInstance>>::~unique_ptr
          (unique_ptr<LoaderInstance,std::default_delete<LoaderInstance>> *this)
...
std::vector<char_const*,std::allocator<char_const*>>::_M_realloc_insert<char_const*const&>
          (vector<char_const*,std::allocator<char_const*>> *this,void *param_2,undefined8 *param_3)

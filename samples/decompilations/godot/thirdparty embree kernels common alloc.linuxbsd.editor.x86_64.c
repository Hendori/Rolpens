...
/* embree::FastAllocator::malloc(unsigned long&, unsigned long, bool) [clone .constprop.0] */

void embree::FastAllocator::malloc(ulong *param_1,ulong param_2,bool param_3)
          ...
          *(undefined8 *)(lVar4 + 8) = 0;
          ...
          if (_DAT_00000138 == _DAT_00000140) {
            ...
            if (_DAT_00000138 == _DAT_00000130) {
              ...
              uVar8 = uVar8 * 8;
LAB_00101d8f:
              __dest_00 = (long *)operator_new(uVar8);
        ...
        if (*(MutexSys **)(this + 0x58) < pMVar6) {
          *(long *)(this + 0x50) = lVar4;
          if (*(MutexSys **)(this + 0x60) < (MutexSys *)((long)local_1f98 * 4)) {
            ...
            *(long *)(this + 0x70) =
                 (*(long *)(this + 0x58) + *(long *)(this + 0x70)) - *(long *)(this + 0x50);
      ...
      do {
        while( true ) {
          ...
          if (lVar12 == *(long *)(lVar9 + 8)) {
            ...
            *plVar1 = *plVar1 + (((*(long *)(lVar9 + 0x98) + *(long *)(lVar9 + 0x58)) -
...
LAB_00102522:
      if (*(long *)(lVar12 + 0x130) != *(long *)(lVar12 + 0x138)) {

...
void JPH::HashTable<int,int,JPH::UnorderedSetDetail<int>,JPH::Hash<int>,std::equal_to<int>>::rehash
               (uint param_1)
...
/* JPH::ConvexHullBuilder::Face::~Face() */

void __thiscall JPH::ConvexHullBuilder::Face::~Face(Face *this)
...
/* JPH::ConvexHullBuilder::Face::CalculateNormalAndCentroid(JPH::Vec3 const*) */

void __thiscall JPH::ConvexHullBuilder::Face::CalculateNormalAndCentroid(Face *this,Vec3 *param_1)
  ...
  if (lVar3 != lVar10) {
    ...
    do {
      ...
      *(undefined1 (*) [16])(this + 0x10) = auVar26;
      ...
      fVar28 = fVar28 + (float)((uint)(fVar20 * fVar33 - fVar19 * fVar34) & uVar22 |
                               ~uVar22 & (uint)(fVar34 * fVar16 - fVar17 * fVar33));
      fVar29 = fVar29 + (float)((uint)(fVar18 * fVar34 - fVar20 * fVar32) & uVar23 |
                               ~uVar23 & (uint)(fVar32 * fVar17 - fVar15 * fVar34));
...
/* JPH::ConvexHullBuilder::Face::Initialize(int, int, int, JPH::Vec3 const*) */

void __thiscall
JPH::ConvexHullBuilder::Face::Initialize
          (Face *this,int param_1,int param_2,int param_3,Vec3 *param_4)
...
void __thiscall JPH::ConvexHullBuilder::ConvexHullBuilder(ConvexHullBuilder *this,Array *param_1)
...
void __thiscall JPH::ConvexHullBuilder::FreeFaces(ConvexHullBuilder *this)
...
void JPH::ConvexHullBuilder::GetFaceForPoint
...
LAB_001005c0:
    ...
    fVar2 = pfVar5[1];
    fVar3 = pfVar5[2];
    fVar7 = (param_2 - pfVar5[6]) * fVar3 +
            ((float)((ulong)param_1 >> 0x20) - pfVar5[5]) * fVar2 +
            ((float)param_1 - pfVar5[4]) * fVar8 + 0.0;
    if ((fVar7 <= 0.0) ||
       (fVar8 = (fVar7 * fVar7) / (fVar3 * fVar3 + fVar2 * fVar2 + fVar8 * fVar8 + 0.0),
       fVar8 < *param_6 || fVar8 == *param_6)) goto LAB_001005c0;
    puVar6 = puVar6 + 1;
    *param_5 = pfVar5;
    *param_6 = fVar8;
  } while( true );
...
undefined8
JPH::ConvexHullBuilder::GetDistanceToEdgeSq
...

{
  ...
  do {
    while( true ) {
      ...
      fVar6 = pfVar1[2];
      fVar7 = pfVar1[3];
      if (0.0 <= ((fVar12 - fVar23) * (fVar4 - fVar22) - (fVar5 - fVar23) * (fVar10 - fVar22)) *
                 *(float *)(param_4 + 1) +
                 ((fVar10 - fVar22) * (fVar6 - fVar24) - (fVar4 - fVar22) * (fVar15 - fVar24)) *
                 (float)((ulong)*param_4 >> 0x20) +
                 ((fVar15 - fVar24) * (fVar5 - fVar23) - (fVar6 - fVar24) * (fVar12 - fVar23)) *
                 (float)*param_4 + 0.0) break;
      fVar18 = fVar4 - fVar10;
      fVar19 = fVar5 - fVar12;
      fVar20 = fVar6 - fVar15;
      fVar21 = fVar7 - fVar16;
      ...
      if (fVar17 < _LC5) {
        if (fVar20 * fVar20 + fVar19 * fVar19 + fVar18 * fVar18 + 0.0 <=
            fVar24 * fVar24 + fVar22 * fVar22 + 0.0 + fVar23 * fVar23) {
LAB_001008e3:
          fVar22 = fVar18;
          fVar23 = fVar19;
          fVar24 = fVar20;
        ...
        fVar17 = (float)((uint)(fVar24 * fVar14 + fVar23 * fVar13 + fVar11 * fVar22 + 0.0) ^ _LC6) /
                 fVar17;
        if (0.0 < fVar17) {
          fVar11 = _LC7 - fVar17;
...
/* JPH::ConvexHullBuilder::AssignPointToFace(int, JPH::Array<JPH::ConvexHullBuilder::Face*,
   JPH::STLAllocator<JPH::ConvexHullBuilder::Face*> > const&, float) */

undefined8 __thiscall
JPH::ConvexHullBuilder::AssignPointToFace
          (ConvexHullBuilder *this,int param_1,Array *param_2,float param_3)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* JPH::ConvexHullBuilder::DetermineCoplanarDistance() const */

undefined8 __thiscall JPH::ConvexHullBuilder::DetermineCoplanarDistance(ConvexHullBuilder *this)
...
/* JPH::ConvexHullBuilder::ContainsFace(JPH::Array<int, JPH::STLAllocator<int> > const&) const */

undefined8 __thiscall JPH::ConvexHullBuilder::ContainsFace(ConvexHullBuilder *this,Array *param_1)
...
LAB_00100ccb:
      if (iVar9 != *piVar8) {
        piVar8 = piVar8 + 1;
LAB_00100cbf:
        if (*piVar8 != iVar9) goto LAB_00100c5a;
      }
LAB_00100c24:
      if (piVar2 != piVar8) {
        lVar11 = 0;
...
/* JPH::ConvexHullBuilder::GarbageCollectFaces() */

void __thiscall JPH::ConvexHullBuilder::GarbageCollectFaces(ConvexHullBuilder *this)

{
  ...
  do {
    ...
    uVar2 = *(ulong *)(this + 8);
    if ((lVar4 >> 3) + 1U < uVar2) {
      memmove((void *)(*(long *)(this + 0x18) + lVar4),(void *)(*(long *)(this + 0x18) + 8 + lVar4),
              ((uVar2 - 1) - (lVar4 >> 3)) * 8);
      uVar2 = *(ulong *)(this + 8);
    }
    lVar4 = lVar4 + -8;
...
/* JPH::ConvexHullBuilder::CreateFace() */

undefined1 (*) [16] __thiscall JPH::ConvexHullBuilder::CreateFace(ConvexHullBuilder *this)
...
/* JPH::ConvexHullBuilder::CreateTriangle(int, int, int) */
...
/* JPH::ConvexHullBuilder::FreeFace(JPH::ConvexHullBuilder::Face*) */

void __thiscall JPH::ConvexHullBuilder::FreeFace(ConvexHullBuilder *this,Face *param_1)
...
/* JPH::ConvexHullBuilder::sUnlinkFace(JPH::ConvexHullBuilder::Face*) */

void JPH::ConvexHullBuilder::sUnlinkFace(Face *param_1)
...
void JPH::ConvexHullBuilder::FindEdge
               (undefined8 param_1,float param_2,undefined8 param_3,long param_4,ulong *param_5)
  ...
  while( true ) {
    while( true ) {
      ...
      if ((puVar2 != (undefined8 *)0x0) &&
         (pfVar3 = (float *)*puVar2, *(char *)(pfVar3 + 0x11) == '\0')) {
        local_868 = (float)param_1;
        fStack_864 = (float)((ulong)param_1 >> 0x20);
        if ((param_2 - pfVar3[6]) * pfVar3[2] +
            (fStack_864 - pfVar3[5]) * pfVar3[1] + *pfVar3 * (local_868 - pfVar3[4]) + 0.0 <= 0.0) {
          lVar6 = plVar5[3];
          uVar8 = *param_5;
...
/* JPH::ConvexHullBuilder::MergeFaces(JPH::ConvexHullBuilder::Edge*) */

void __thiscall JPH::ConvexHullBuilder::MergeFaces(ConvexHullBuilder *this,Edge *param_1)
...
void JPH::ConvexHullBuilder::sMarkAffected(Face *param_1,Array *param_2)
...
LAB_0010151c:
    if ((Face *)*plVar4 != param_1) {
      plVar4 = plVar4 + 1;
LAB_001014bc:
      if ((Face *)*plVar4 != param_1) goto LAB_001014c1;
    }
  }
  else {
    if (lVar5 != 3) {
...
void __thiscall
JPH::ConvexHullBuilder::RemoveInvalidEdges(ConvexHullBuilder *this,Face *param_1,Array *param_2)

{
  ...
  lVar10 = *(long *)(lVar8 + 8);
LAB_00101570:
  pFVar11 = (Face *)**(undefined8 **)(lVar8 + 0x10);
  lVar12 = lVar8;
  do {
    lVar9 = lVar10;
...
void __thiscall
JPH::ConvexHullBuilder::MergeDegenerateFace(ConvexHullBuilder *this,Face *param_1,Array *param_2)

{
  ...
  if (*(float *)(param_1 + 8) * *(float *)(param_1 + 8) +
      *(float *)param_1 * *(float *)param_1 + 0.0 +
      *(float *)(param_1 + 4) * *(float *)(param_1 + 4) < _LC9) {
    fVar9 = 0.0;
    pEVar5 = (Edge *)0x0;
...
void __thiscall
JPH::ConvexHullBuilder::MergeCoplanarOrConcaveFaces
          (ConvexHullBuilder *this,Face *param_1,float param_2,Array *param_3)

{
  ...
  do {
    while( true ) {
      ...
      fVar15 = (pfVar8[6] - *(float *)(param_1 + 0x18)) * fVar5 +
               fVar2 * (pfVar8[5] - *(float *)(param_1 + 0x14)) +
               (pfVar8[4] - *(float *)(param_1 + 0x10)) * fVar1 + 0.0;
      fVar6 = pfVar8[2];
      if ((((fVar5 * fVar5 + fVar2 * fVar2 + fVar1 * fVar1 + 0.0) * fVar12 <
            (float)((uint)fVar15 & uVar13) * fVar15) ||
          (fVar15 = (pfVar8[6] - *(float *)(param_1 + 0x18)) * fVar6 +
                    (pfVar8[5] - *(float *)(param_1 + 0x14)) * fVar4 +
                    (pfVar8[4] - *(float *)(param_1 + 0x10)) * fVar3 + 0.0,
          (fVar6 * fVar6 + fVar4 * fVar4 + fVar3 * fVar3 + 0.0) * fVar12 <
          (float)((uint)fVar15 ^ uVar14) * (float)((uint)fVar15 & uVar13))) &&
         (0.0 < fVar6 * fVar5 + fVar2 * fVar4 + fVar1 * fVar3 + 0.0)) break;
      pEVar11 = pEVar7;
      bVar10 = bVar9;
...
void __thiscall
JPH::ConvexHullBuilder::AddPoint
          (ConvexHullBuilder *this,Face *param_1,int param_2,float param_3,Array *param_4)

{
  ...
  if (*(ulong *)(param_4 + 8) < (ulong)local_78._0_8_) {
    uVar8 = (*Reallocate)(*(undefined8 *)(param_4 + 0x10),*(ulong *)(param_4 + 8) << 3,
                          local_78._0_8_ * 8);
  ...
  if (uVar9 == 0) {
    ...
    do {
      ...
      *(long *)(lVar14 + 0x10) = lVar13;
      ...
      lVar13 = *(long *)(*(long *)(*(long *)(*(long *)(lVar10 + (uVar12 % uVar9) * 8) + 0x38) + 8) +
                        8);
      *(long *)(lVar14 + 0x10) = lVar13;
      *(long *)(lVar13 + 0x10) = lVar14;
      uVar11 = uVar12;
...
bool __thiscall
JPH::ConvexHullBuilder::RemoveTwoEdgeFace(ConvexHullBuilder *this,Face *param_1,Array *param_2)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* JPH::ConvexHullBuilder::GetCenterOfMassAndVolume(JPH::Vec3&, float&) const */

void __thiscall
JPH::ConvexHullBuilder::GetCenterOfMassAndVolume
          (ConvexHullBuilder *this,Vec3 *param_1,float *param_2)
    ...
    do {
      ...
      if (lVar4 != lVar10) {
        ...
        do {
          ...
          fVar23 = pfVar2[2];
          fVar24 = pfVar2[3];
          fVar30 = ((fVar22 - fVar28) * fVar30 - fVar31 * (fVar21 - fVar25)) * (fVar6 - fVar29) +
                   ((fVar21 - fVar25) * fVar32 - fVar30 * (fVar23 - fVar29)) * (fVar5 - fVar28) +
                   ((fVar23 - fVar29) * fVar31 - fVar32 * (fVar22 - fVar28)) * (fVar13 - fVar25) +
                   0.0;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* JPH::ConvexHullBuilder::DetermineMaxError(JPH::ConvexHullBuilder::Face*&, float&, int&, float&)
   const */

void __thiscall
JPH::ConvexHullBuilder::DetermineMaxError
          (ConvexHullBuilder *this,Face **param_1,float *param_2,int *param_3,float *param_4)
    ...
    do {
      ...
      if ((uVar3 & 0x1fffffffffffffff) != 0) {
        ...
        do {
          ...
          fVar18 = ((fStack_90 - *(float *)(pFVar8 + 0x18)) * fVar1 +
                   (fStack_94 - *(float *)(pFVar8 + 0x14)) * fVar17 +
                   (local_98 - *(float *)(pFVar8 + 0x10)) * fVar18 + 0.0) /
                   SQRT(fVar1 * fVar1 + fVar17 * fVar17 + fVar18 * fVar18 + 0.0);
          if (fVar16 < fVar18) {
...
/* JPH::ConvexHullBuilder::GetNumVerticesUsed() const */

undefined4 __thiscall JPH::ConvexHullBuilder::GetNumVerticesUsed(ConvexHullBuilder *this)

{
  ...
  if (plVar1 != plVar9) {
    do {
      ...
      do {
        bVar6 = HashTable<int,int,JPH::UnorderedSetDetail<int>,JPH::Hash<int>,std::equal_to<int>>::
                InsertKey<false>((HashTable<int,int,JPH::UnorderedSetDetail<int>,JPH::Hash<int>,std::equal_to<int>>
                                  *)local_68,(int *)(lVar8 + 0x18),&uStack_6c);
        if (bVar6) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* JPH::ConvexHullBuilder::Initialize(int, float, char const*&) */

undefined1 __thiscall
JPH::ConvexHullBuilder::Initialize(ConvexHullBuilder *this,int param_1,float param_2,char **param_3)

{
  ...
  if (0 < iVar15) {
    ...
    do {
      if ((iVar39 != iVar37) &&
         (fVar47 = (pfVar16[2] - pfVar31[2]) * (pfVar16[2] - pfVar31[2]) +
                   (pfVar16[1] - pfVar31[1]) * (pfVar16[1] - pfVar31[1]) +
                   (*pfVar16 - *pfVar31) * (*pfVar16 - *pfVar31) + 0.0, fVar48 < fVar47)) {
        fVar48 = fVar47;
        iVar42 = iVar39;
      }
      pfVar16 = pfVar16 + 4;
    ...
    if (_LC9 <= fVar48) {
      ...
      do {
        if ((iVar42 != iVar15 && iVar15 != iVar37) && (iVar39 != iVar15)) {
          fVar51 = (pfVar23[2] - auVar62._8_4_) * fVar53 +
                   (pfVar23[1] - auVar62._4_4_) * fVar47 + (*pfVar23 - auVar62._0_4_) * fVar48 + 0.0
          ;
...
LAB_00102c4d:
          ...
          if ((!bVar44) ||
             (local_c8._0_8_ = unaff_RBP, local_c8 = CONCAT88(uVar10,local_c8._0_8_), unaff_RBP == 0
             )) goto LAB_00102ac0;
          iVar39 = *(int *)(*(long *)(unaff_RBP + 0x30) + -4 + *(long *)(unaff_RBP + 0x20) * 4);
          *(long *)(unaff_RBP + 0x20) = *(long *)(unaff_RBP + 0x20) + -1;
LAB_001029c5:
          if ((param_1 <= iVar15) && (iVar15 = GetNumVerticesUsed(this), param_1 <= iVar15))
          goto LAB_00102ca4;
          iVar15 = iVar15 + 1;
...
joined_r0x00102a36:
      ...
      if (uVar28 != 0) {
        ...
        for (; local_c8._0_8_ = uVar38, puVar22 != puVar19; puVar19 = puVar19 + 2) {
          ...
          if (puVar24 != (undefined8 *)0x0) {
            *puVar24 = CONCAT44((fVar46 * fVar48 - fVar47 * fVar52) * fVar54 +
                                (fVar52 * fVar53 - fVar48 * fVar51) * fVar64 +
                                (fVar51 * fVar47 - fVar53 * fVar46) * fVar59 + 0.0,
                                fVar51 * fVar54 + fVar46 * fVar64 + fVar52 * fVar59 + 0.0);
            puVar24[1] = 0;
          }
      ...
      JPH::ConvexHullBuilder2D::ConvexHullBuilder2D
                ((ConvexHullBuilder2D *)local_88,(Array *)local_c8);
      iVar15 = JPH::ConvexHullBuilder2D::Initialize
                         ((int)(ConvexHullBuilder2D *)local_88,iVar37,iVar42,iVar39,param_2,
                          (Array *)(ulong)(uint)param_1);
      pFVar17 = (Face *)CreateFace(this);
...
LAB_00102e75:
        ...
        *(undefined8 *)(*plVar26 + 8) = *(undefined8 *)(pfVar23 + 0xe);
        ...
        uVar28 = 0;
        do {
          lVar34 = *(long *)(lVar25 + (((local_a8._0_8_ * 2 + -2) - uVar28) % (ulong)local_a8._0_8_)
                                      * 8);
...
void __thiscall
JPH::HashTable<int,int,JPH::UnorderedSetDetail<int>,JPH::Hash<int>,std::equal_to<int>>::GrowTable
          (HashTable<int,int,JPH::UnorderedSetDetail<int>,JPH::Hash<int>,std::equal_to<int>> *this)
...
LAB_0010366a:
                    /* WARNING: Could not recover jumptable at 0x0010367b. Too many branches */
                    /* WARNING: Treating indirect jump as call */
      (*Free)(lVar3);
      return;
    }
...
/* bool JPH::HashTable<int, int, JPH::UnorderedSetDetail<int>, JPH::Hash<int>, std::equal_to<int>
   >::InsertKey<false>(int const&, unsigned int&) */
...
void JPH::ConvexHullBuilder::Face::_GLOBAL__sub_I__Face(void)

...
undefined8
sdf_cubic_to(undefined8 *param_1,undefined8 *param_2,undefined8 *param_3,undefined8 *param_4)
...

{
  ...
  if ((ulong)(param_2[2] * -3 + *param_2 * 2 + 0xf + local_68) < 0x1f) {
    if (((0x1e < (ulong)(lStack_60 + 0xf + lStack_80 * -3 + lStack_90 * 2)) ||
        (0x1e < (ulong)(local_78 * -3 + *param_2 + 0xf + local_68 * 2))) ||
       (0x1e < (ulong)(lStack_70 * -3 + lStack_90 + 0xf + lStack_60 * 2))) goto LAB_00101070;
...
LAB_001013e0:
            ...
            *(long *)(local_90[1] + 8) = lVar4;
            lVar4 = plVar2[5];
            *(long *)local_90[2] = plVar2[4];
            *(long *)(local_90[2] + 8) = lVar4;
            lVar4 = plVar2[7];
            *(long *)local_90[3] = plVar2[6];
            *(long *)(local_90[3] + 8) = lVar4;
            lVar4 = plVar2[9];
            *(long *)local_90[4] = plVar2[8];
            *(long *)(local_90[4] + 8) = lVar4;
...
int sdf_generate_bounding_box_isra_0
              (int param_1,char param_2,char param_3,int param_4,long *param_5,uint param_6,
              int *param_7)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  local_6c = 0;
  if ((((param_5 == (long *)0x0) || (param_7 == (int *)0x0)) || (0x1e < param_6 - 2)) ||
     (lVar41 = *param_5, lVar41 == 0)) {
    local_6c = 6;
    lVar41 = 0;
    local_148 = 0;
  }
    ...
    if (local_6c == 0) {
      ...
      if ((iVar2 == 0) || (iVar3 == 0)) {
        ...
        if (lVar32 != 0) {
          ...
          do {
            for (plVar5 = *(long **)(lVar32 + 0x10); plVar5 != (long *)0x0;
...
LAB_001016de:
                ...
                do {
                  if ((long)(int)uVar9 < (long)uVar48) {
                    ...
                    uVar30 = uVar9;
                    do {
                      while ((((int)(local_1bc | uVar30) < 0 || (iVar2 <= (int)uVar30)) ||
                             (iVar3 <= (int)local_1bc))) {
LAB_001017f0:
                        lVar40 = lVar40 + 1;
                        uVar30 = uVar30 + 1;
                      ...
                      if (iVar11 == 2) {
                        ...
                        do {
                          ...
                          do {
                            ...
                            lVar36 = (((int)((ulong)(lVar36 + 0x8000 + (lVar36 >> 0x3f)) >> 0x10) +
                                      (int)((ulong)(lVar23 + 0x8000 + (lVar23 >> 0x3f)) >> 0x10)) +
                                     lVar21) * 0x400;
                            lVar16 = (((int)((ulong)(lVar16 + 0x8000 + (lVar16 >> 0x3f)) >> 0x10) +
                                      (int)((ulong)(lVar17 + 0x8000 + (lVar17 >> 0x3f)) >> 0x10)) +
                                     lVar43) * 0x400;
                            ...
                            lVar23 = (int)((ulong)(lVar36 + 0x8000 + (lVar36 >> 0x3f)) >> 0x10) +
                                     lVar19;
                            lVar36 = (int)((ulong)(lVar16 + 0x8000 + (lVar16 >> 0x3f)) >> 0x10) +
                                     lVar15;
                            ...
                            iVar12 = FT_DivFix((long)((int)(lVar16 >> 6) + (int)(lVar28 >> 6)),
                                               (long)((int)(lVar17 >> 6) + (int)(lVar24 >> 6) +
                                                      (int)(lVar23 * lVar23 >> 6) +
                                                     (int)(lVar36 * lVar36 >> 6)));
                            uVar31 = uVar31 - iVar12;
                          } while ((uVar31 < 0x10001) && (sVar26 = sVar26 + -1, sVar26 != 0));
                          uVar42 = uVar42 + 0x4000;
                        } while (uVar42 != 0x14000);
                        lVar45 = lVar45 * (int)uVar7;
                        lVar46 = (int)uVar7 * lVar46;
                        local_58 = (int)((ulong)(lVar45 + 0x8000 + (lVar45 >> 0x3f)) >> 0x10) * 2 +
                                   lVar19;
                        local_50 = (int)((ulong)(lVar46 + 0x8000 + (lVar46 >> 0x3f)) >> 0x10) * 2 +
                                   lVar15;
                        ...
                        bVar6 = (int)((ulong)(lVar21 + 0x8000 + (lVar21 >> 0x3f)) >> 0x10) <
                                (int)((ulong)(lVar43 + 0x8000 + (lVar43 >> 0x3f)) >> 0x10);
joined_r0x00102782:
                        cVar25 = bVar6 * '\x02' + -1;
                        iVar12 = 0x10000;
                        if ((uVar7 & 0xfffeffff) == 0) {
                          ...
                          iVar12 = (int)local_50;
LAB_00102341:
                          iVar12 = (int)((ulong)(lVar39 + 0x8000 + (lVar39 >> 0x3f)) >> 0x10) -
                                   (int)((ulong)((long)iVar10 * (long)iVar12 + 0x8000 +
                                                ((long)iVar10 * (long)iVar12 >> 0x3f)) >> 0x10);
                        }
                      }
                      else {
                        if (iVar11 == 3) {
                          ...
                          lVar19 = (long)((((int)lVar19 - (int)plVar5[7]) * 3 - (int)lVar15) +
                                         (int)plVar5[3]);
                          uVar42 = 0;
                          iVar11 = 0x7fffffff;
                          lVar21 = (long)((((int)lVar21 - (int)plVar5[6]) * 3 - (int)lVar43) +
                                         (int)plVar5[2]);
                          uVar7 = 0;
                          do {
                            sVar26 = 4;
                            ...
                            do {
                              ...
                              lVar23 = (((int)((ulong)(lVar23 + 0x8000 + (lVar23 >> 0x3f)) >> 0x10)
                                         + (int)((ulong)(lVar36 * lVar29 + 0x8000 +
                                                        (lVar36 * lVar29 >> 0x3f)) >> 0x10) +
                                        (int)((ulong)(lVar33 + 0x8000 + (lVar33 >> 0x3f)) >> 0x10))
                                       + lVar43) * 0x400;
                              lVar17 = (((int)((ulong)(lVar17 + 0x8000 + (lVar17 >> 0x3f)) >> 0x10)
                                         + (int)((ulong)(lVar16 * lVar29 + 0x8000 +
                                                        (lVar16 * lVar29 >> 0x3f)) >> 0x10) +
                                        (int)((ulong)(lVar24 + 0x8000 + (lVar24 >> 0x3f)) >> 0x10))
                                       + lVar15) * 0x400;
                              ...
                              lVar28 = ((int)((ulong)(lVar17 + 0x8000 + (lVar17 >> 0x3f)) >> 0x10) +
                                       (int)((ulong)(lVar28 + 0x8000 + (lVar28 >> 0x3f)) >> 0x10)) +
                                       lVar34;
                              lVar17 = (int)(uVar31 * 2) * lVar16;
                              lVar17 = ((int)((ulong)(lVar23 + 0x8000 + (lVar23 >> 0x3f)) >> 0x10) +
                                       (int)((ulong)(lVar17 + 0x8000 + (lVar17 >> 0x3f)) >> 0x10)) +
                                       lVar45;
                              ...
                              local_50 = lVar23 >> 10;
                              lVar29 = ((long)(int)((ulong)(lVar29 + 0x8000 + (lVar29 >> 0x3f)) >>
                                                   0x10) + lVar20 * 2) * local_58;
                              lVar23 = lVar29 + 0x3f;
                              if (-1 < lVar29) {
                                lVar23 = lVar29;
                              }
                              lVar24 = ((long)(int)((ulong)(lVar24 + 0x8000 + (lVar24 >> 0x3f)) >>
                                                   0x10) + lVar46 * 2) * local_50;
                              if (lVar24 < 0) {
                                lVar24 = lVar24 + 0x3f;
                              }
                              ...
                              iVar10 = FT_DivFix((long)((int)(lVar29 >> 6) + (int)(lVar33 >> 6)),
                                                 (long)((int)(lVar23 >> 6) + (int)(lVar24 >> 6) +
                                                        (int)(lVar28 * lVar28 >> 6) +
                                                       (int)(lVar17 * lVar17 >> 6)));
                          ...
                          local_58 = ((int)((ulong)(lVar36 + 0x8000 + (lVar36 >> 0x3f)) >> 0x10) +
                                     (int)((ulong)(lVar21 + 0x8000 + (lVar21 >> 0x3f)) >> 0x10)) +
                                     lVar34;
                          lVar19 = (iVar12 * 3) * lVar19;
                          lVar16 = (int)(uVar7 * 2) * lVar16;
                          local_50 = ((int)((ulong)(lVar19 + 0x8000 + (lVar19 >> 0x3f)) >> 0x10) +
                                     (int)((ulong)(lVar16 + 0x8000 + (lVar16 >> 0x3f)) >> 0x10)) +
                                     lVar45;
                          lVar21 = (long)(local_68._0_4_ + (int)lVar39 * -0x400) *
                                   (long)(int)local_50;
                          lVar43 = (long)(int)local_58 * (long)(local_68._8_4_ + local_120 * -0x400)
                          ;
                          bVar6 = (int)((ulong)(lVar21 + 0x8000 + (lVar21 >> 0x3f)) >> 0x10) <
                        ...
                        iVar10 = FT_DivFix((long)((int)(lVar15 >> 6) + (int)(lVar19 >> 6)),
                                           (long)((int)((long)(local_68._0_8_ * local_68._0_8_) >> 6
                                                       ) + (int)((long)(local_68._8_8_ *
                                                                       local_68._8_8_) >> 6)));
                        iVar11 = 0;
                        if (-1 < iVar10) {
                          iVar11 = iVar10;
                        ...
                        local_58 = lVar43 * 0x400 + (lVar19 + 0x8000 + (lVar19 >> 0x3f) >> 0x10) +
                                   lVar39 * -0x400;
                        local_50 = lVar21 * 0x400 + (lVar15 + 0x8000 + (lVar15 >> 0x3f) >> 0x10) +
                                   lVar14 * -0x400;
                        lVar43 = (long)(int)local_58 * (long)local_68._8_4_;
                        lVar39 = (long)local_68._0_4_ * (long)(int)local_50;
                        iVar11 = FT_Vector_Length(&local_58);
                        cVar25 = ((int)((ulong)(lVar43 + 0x8000 + (lVar43 >> 0x3f)) >> 0x10) <
                                 (int)((ulong)(lVar39 + 0x8000 + (lVar39 >> 0x3f)) >> 0x10)) *
                                 '\x02' + -1;
                        iVar12 = 0x10000;
                        if (0xfffe < iVar10 - 1U) {
                          FT_Vector_NormLen(local_68);
    ...
    if ((0 < psVar7[1]) && (0 < *psVar7)) {
      ...
      *puVar14 = uVar8;
      ...
      if (*(char *)((long)param_2 + 0x66) == '\0') {
        ...
        local_5c = 0;
        if ((piVar9 == (int *)0x0) || (uVar8 = *puVar14, uVar8 == 0)) goto LAB_00102e90;
        uVar15 = puVar14[1];
        uVar6 = piVar9[1];
        iVar13 = *piVar9;
        if (uVar15 == 0) {
...
LAB_00102e51:
                ...
                *(undefined8 *)(uVar15 + 0x18) = 0;
                ...
                if ((iVar20 != 0) ||
                   (local_5c = sdf_generate_bounding_box_isra_0
                                         (iVar12,0,uVar3,uVar26,&local_58,uVar5,puVar24),
                   plVar18 = extraout_RDX_02, iVar20 = local_5c, local_5c != 0))
                goto joined_r0x00102cab;
...
int bsdf_raster_render(long *param_1,undefined8 *param_2)
...
LAB_00103260:
  ...
  if (local_5c == 0) {
    ...
    if ((((int)uVar4 < iVar31) || (iVar36 = *piVar5, iVar37 < iVar36)) ||
       (cVar3 = *(char *)((long)piVar5 + 0x1a), cVar3 == '\0')) {
      local_5c = 6;
      goto LAB_00103214;
    }
    ...
    if (cVar3 == '\x01') {
      if (0 < iVar37) {
        ...
        iVar21 = 0;
LAB_00103b9f:
        if ((int)uVar4 < 1) goto LAB_00103c8f;
        do {
          ...
          do {
            ...
            *(undefined1 (*) [16])(puVar14 + 2) = (undefined1  [16])0x0;
            if (((-1 < (int)(uVar20 | uVar18)) && ((int)uVar18 < iVar31)) && ((int)uVar20 < iVar36))
            {
              ...
              *(char *)(puVar14 + 6) =
                   -((*(byte *)(lVar15 + (int)(((int)uVar18 >> 3) + piVar5[2] * uVar8)) &
      ...
      do {
        ...
        if (0 < (int)uVar4) {
          ...
          do {
            ...
            if (bVar28 == 0) {
LAB_001034d8:
              *(undefined4 *)(plVar22 + -1) = 0x1900000;
              *plVar22 = lVar15;
              plVar22[1] = lVar16;
            }
            else {
...
LAB_00103795:
                  if (((uVar4 != 1) && ((char)plVar22[6] != '\0')) && (iVar36 != 0))
                  goto LAB_00103513;
                  goto LAB_001037b0;
                }
...
LAB_00103a80:
                    if (((iVar31 < iVar37) && (pbVar35[-0x20] != 0)) && (iVar26 < (int)uVar4))
                    goto LAB_00103513;
                  }
                  else {
                    cVar17 = cVar17 + '\x01';
...
LAB_00103528:
                ...
                if ((((int)uVar24 < (int)(uVar4 - 1)) && (iVar36 != 0)) && (iVar36 < iVar37 + -1)) {
                  ...
                  local_58._8_8_ =
                       (long)(int)((iVar21 - (int)((ulong)((long)(int)((uint)*(byte *)(lVar33 + 0x18
                                                                                      ) << 8) *
                                                           0x16a09 + 0x8000) >> 0x10)) +
                                   (uint)*(byte *)(lVar33 + 0x38) * -0x100 +
                                   (uint)pbVar35[-0x20] * 0x100 +
                                   (int)((ulong)((long)(int)((uint)*pbVar35 << 8) * 0x16a09 + 0x8000
                                                ) >> 0x10) + (uint)pbVar35[0x20] * 0x100);
                  local_58._0_8_ =
                       (long)(int)((iVar21 - (int)((ulong)((long)(int)((uint)*(byte *)(plVar22 + -2)
                                                                      << 8) * 0x16a09 + 0x8000) >>
                                                  0x10)) + (uint)pbVar35[-0x20] * -0x100 +
                                   (uint)*(byte *)(lVar33 + 0x38) * 0x100 +
                                   (int)((ulong)((long)(int)((uint)*(byte *)(plVar22 + 6) << 8) *
                                                 0x16a09 + 0x8000) >> 0x10) +
                                  (uint)pbVar35[0x20] * 0x100);
                  FT_Vector_NormLen(local_58);
                  if ((local_58._0_8_ == 0) || (local_58._8_8_ == 0)) {
                    ...
                    if (iVar26 < iVar23) {
                      ...
                      lVar16 = 0;
                      uVar27 = 0x40000000;
                      uVar19 = (ulong)((int)((ulong)((iVar26 * lVar15 + 0x8000 >> 0x10) * lVar29 +
                                                    0x8000) >> 0x10) * 2);
                      do {
                        uVar1 = uVar27 + lVar16;
                        if (uVar1 <= uVar19) {
                      ...
                      iVar26 = 0x18;
                      uVar27 = 0x40000000;
                      uVar19 = (ulong)((int)((ulong)(((int)(uVar20 * -0x100 + 0x10000) * lVar15 +
                                                      0x8000 >> 0x10) * lVar29 + 0x8000) >> 0x10) *
                                      2);
                      do {
                        uVar1 = uVar27 + lVar16;
                        if (uVar1 <= uVar19) {
...
LAB_001037b0:
      ...
      if (iVar37 == 1) {
        ...
        do {
          ...
          do {
            ...
            lVar15 = lVar15 + -0x20;
          } while (((ulong)uVar4 + (long)(int)uVar18) * 0x20 +
                   lVar13 + (ulong)uVar20 * -0x20 + -0x60 != lVar15);
          iVar31 = iVar31 + 1;
          uVar18 = uVar18 + uVar4;
        } while (iVar37 != iVar31);
        iVar31 = iVar37 + -2;
        ...
        do {
          ...
          do {
            compare_neighbor(lVar15,1,0,uVar4);
            lVar15 = lVar15 + -0x20;
          } while (lVar15 != ((long)(int)uVar4 + (long)iVar36) * 0x20 +
                             lVar13 + (ulong)uVar20 * -0x20 + -0x60);
          iVar31 = iVar31 + -1;
          iVar36 = iVar36 - uVar4;
        } while (iVar31 != -1);
        uVar20 = piVar25[1];
      ...
      if (bVar9) {
        ...
        if (0 < iVar31) {
          ...
          iVar37 = 0;
LAB_00103d5e:
          if ((int)uVar20 < 1) goto LAB_00103e33;
          do {
            lVar33 = (long)iVar36;

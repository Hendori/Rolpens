...
void register_macos_exporter(void)

{
  ...
  char cVar4;
  PropertyInfo *pPVar5;
  EditorExportPlatformMacOS *this;
  Object *pOVar6;
  EditorExportPlatformMacOS *pEVar7;
  long in_FS_OFFSET;
  long local_c8;
  long local_c0;
  long local_b8;
  ...
  local_a8 = (Object *)0x1009ad;
  local_b0 = 0;
  local_a0 = 0x16;
  String::parse_latin1((StrRange *)&local_b0);
  _EDITOR_DEF((String *)local_58,(Variant *)&local_b0,SUB81((Variant *)local_78,0),false);
...
LAB_00100248:
  ...
  this = (EditorExportPlatformMacOS *)operator_new(0x1d0,"");
  EditorExportPlatformMacOS::EditorExportPlatformMacOS(this);
...
LAB_0010032b:
    ...
    if ((local_a8 != (Object *)0x0) &&
      ...
      this = (EditorExportPlatformMacOS *)0x0;
      cVar4 = predelete_handler(local_a8);
      if (cVar4 != '\0') {
LAB_001005a5:
        (**(code **)(*(long *)pOVar6 + 0x140))(pOVar6);
        Memory::free_static(pOVar6,false);
        if (this != (EditorExportPlatformMacOS *)0x0) goto LAB_0010040c;
      }
    }
  }
  else {
    ...
    if (cVar4 == '\0') {
      ...
      if (cVar4 != '\0') {
        ...
        pEVar7 = (EditorExportPlatformMacOS *)0x0;
        if (cVar4 != '\0') goto LAB_00100490;
      }
      goto LAB_0010032b;
    }
    cVar4 = RefCounted::unreference();
    if ((cVar4 != '\0') && (cVar4 = predelete_handler((Object *)this), pEVar7 = this, cVar4 != '\0')
       ) {
LAB_00100490:
      (**(code **)(*(long *)this + 0x140))(this);
      Memory::free_static(this,false);
      this = pEVar7;
      if (pEVar7 == (EditorExportPlatformMacOS *)0x0) goto LAB_0010032b;
    }
    ...
    if (((local_a8 != (Object *)0x0) &&
        (cVar4 = RefCounted::unreference(), pOVar6 = local_a8, cVar4 != '\0')) &&
       (cVar4 = predelete_handler(local_a8), cVar4 != '\0')) goto LAB_001005a5;
LAB_0010040c:
    cVar4 = RefCounted::unreference();
...
void register_macos_exporter_types(void)

{
  ClassDB::register_class<EditorExportPlatformMacOS>(true);
  return;
}
...
/* Object* ClassDB::creator<EditorExportPlatformMacOS>(bool) */

Object * ClassDB::creator<EditorExportPlatformMacOS>(bool param_1)
  ...
  if (pvVar5 != (void *)0x0) {
    if (*(int *)(this + 0x3c) != 0) {
      ...
      if (uVar2 == 0) {
        ...
        *(undefined4 *)(this + 0x3c) = 0;
        *(undefined1 (*) [16])(this + 0x28) = (undefined1  [16])0x0;
        if (pvVar5 == (void *)0x0) goto LAB_001008c4;
      }
    }
    Memory::free_static(pvVar5,false);
...
/* void ClassDB::register_class<EditorExportPlatformMacOS>(bool) */

void ClassDB::register_class<EditorExportPlatformMacOS>(bool param_1)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  _global_lock();
  if (EditorExportPlatformMacOS::initialize_class()::initialized == '\0') {
    ...
    StringName::StringName((StringName *)&local_60,(String *)&local_68,false);
    local_70 = 0;
    local_58 = "EditorExportPlatformMacOS";
    local_50 = 0x19;
    String::parse_latin1((StrRange *)&local_70);
    StringName::StringName((StringName *)&local_58,(String *)&local_70,false);
    ClassDB::_add_class2((StringName *)&local_58,(StringName *)&local_60);
    ...
    EditorExportPlatformMacOS::initialize_class()::initialized = '\x01';
  }
  local_58 = "EditorExportPlatformMacOS";
  local_60 = 0;
  local_50 = 0x19;
  ...
  if ((CONCAT44(current_api._4_4_,(undefined4)current_api) != 0) && (_DAT_0010211c != 0)) {
    ...
    if (uVar17 != 0) {
      ...
      do {
        if ((uVar17 == uVar13) &&
          ...
          if (local_60 == 0) goto LAB_00100e5f;
          goto LAB_00100e35;
        }
        uVar18 = uVar18 + 1;
        auVar5._8_8_ = 0;
...
LAB_00100e5f:
        ...
        *(code **)(puVar16 + 0xa4) = creator<EditorExportPlatformMacOS>;
        *(bool *)((long)puVar16 + 0x28b) = param_1;
        *(undefined4 **)(puVar16 + 4) = &EditorExportPlatformMacOS::get_class_ptr_static()::ptr;
        *puVar16 = (undefined4)current_api;
        if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) goto LAB_00101087;
        goto LAB_00100ea7;
      }
    }
  }

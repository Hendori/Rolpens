...
LAB_00100a88:
          _err_print_index_error
                    ("operator[]","./core/templates/local_vector.h",0xb2,uVar8,uVar13,"p_index",
                     "count","",false,true);
          _err_flush_stdout();
                    /* WARNING: Does not return */
...
/* WARNING: Removing unreachable block (ram,0x001030db) */
...
LAB_00103298:
    if (fVar7 == 0.0) goto LAB_00103260;
  }
  else {
...
/* WARNING: Removing unreachable block (ram,0x001037ef) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
...
LAB_0010392c:
  ...
  if (fVar24 <= fVar22) {
    ...
    if ((fVar24 < fVar31) ||
       ...
       fVar22 < fVar26)) goto LAB_0010397a;
    if (fVar26 <= fVar31) {
      fVar26 = fVar31;
    }
    if (fVar22 <= fVar24) {
...
LAB_00108280:
        if (lVar14 <= param_2) goto LAB_001082d0;
        lVar7 = param_2 * 0x10;

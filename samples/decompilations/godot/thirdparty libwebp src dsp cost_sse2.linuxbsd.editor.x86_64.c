...

{
  ...
  if (iVar2 < 0) {
    ...
    if (iVar57 < iVar2) {
      ...
      uVar54 = iVar2 - iVar57;
      do {
        uVar55 = uVar55 + (uint)*(ushort *)(lVar53 + (ulong)local_48[uVar51 + lVar56] * 2) +
                          (uint)*(ushort *)
                                 (&VP8LevelFixedCosts +
                                 (ulong)*(ushort *)(local_68 + uVar51 * 2 + lVar56 * 2) * 2);
    ...
    lVar56 = (long)iVar57;
    uVar55 = (uint)*(ushort *)(lVar53 + (ulong)local_48[lVar56] * 2) +
             (uint)*(ushort *)(&VP8LevelFixedCosts + (ulong)*(ushort *)(local_68 + lVar56 * 2) * 2)
             + uVar55;
    if (iVar57 < 0xf) {
      uVar55 = uVar55 + *(ushort *)
                         (&VP8EntropyCost +
                         (ulong)*(byte *)(*(long *)(param_2 + 6) +
                                          (ulong)(byte)(&VP8EncBands)[iVar57 + 1] * 0x21 +
                                         (ulong)local_38[lVar56] * 0xb) * 2);
    }
  }
...

{
  ...
  auVar4[8] = -(auVar3[8] == '\0');
  auVar4[9] = -(auVar3[9] == '\0');
  auVar4[10] = -(auVar3[10] == '\0');
  auVar4[0xb] = -(auVar3[0xb] == '\0');
  auVar4[0xc] = -(auVar3[0xc] == '\0');
  auVar4[0xd] = -(auVar3[0xd] == '\0');
  auVar4[0xe] = -(auVar3[0xe] == '\0');
  auVar4[0xf] = -(auVar3[0xf] == '\0');
  uVar1 = (uint)(ushort)((ushort)(SUB161(auVar4 >> 7,0) & 1) |

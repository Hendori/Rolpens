...
/* CowData<CVTTCompressionRowTask>::_copy_on_write() [clone .isra.0] */

void __thiscall
CowData<CVTTCompressionRowTask>::_copy_on_write(CowData<CVTTCompressionRowTask> *this)
...
/* image_decompress_cvtt(Image*) */

void image_decompress_cvtt(Image *param_1)
...
LAB_00100cc0:
                        if ((uVar25 & 4) == 0) {
                          if ((uVar25 != 0) && (*pPVar18 = *pPVar28, (uVar25 & 2) != 0)) {
                            *(undefined2 *)(pPVar18 + ((ulong)uVar25 - 2)) =
                                 *(undefined2 *)(pPVar28 + ((ulong)uVar25 - 2));
                          }
                        }
                        else {
                          *(undefined4 *)pPVar18 = *(undefined4 *)pPVar28;
                          *(undefined4 *)(pPVar18 + ((ulong)uVar25 - 4)) =
                               *(undefined4 *)(pPVar28 + ((ulong)uVar25 - 4));
                        }
                      }
                      else {
                        *(undefined8 *)pPVar18 = *(undefined8 *)pPVar28;
                        *(undefined8 *)(pPVar18 + (uVar21 - 8)) =
                             *(undefined8 *)((long)&uStack_4d0 + uVar21 + lVar17);
                        ...
                        if (7 < uVar12) {
                          ...
                          do {
                            uVar33 = (ulong)uVar26;
                            uVar26 = uVar26 + 8;
                            *(undefined8 *)(((ulong)(pPVar18 + 8) & 0xfffffffffffffff8) + uVar33) =
                                 *(undefined8 *)(pPVar28 + (uVar33 - lVar17));
                          } while (uVar26 < uVar12);
                        }
                      }
                    }
                      ...
                      *(undefined8 *)pPVar18 = *(undefined8 *)pPVar28;
                      *(undefined8 *)(pPVar18 + (uVar21 - 8)) =
                           *(undefined8 *)(local_6c8 + uVar21 + lVar17 + -8);
                      lVar17 = (long)pPVar18 - ((ulong)(pPVar18 + 8) & 0xfffffffffffffff8);
                      uVar12 = (int)lVar17 + uVar25 & 0xfffffff8;
                      if (7 < uVar12) {
                        uVar26 = 0;
...
/* image_compress_cvtt(Image*, Image::UsedChannels) */

void image_compress_cvtt(undefined8 param_1,int param_2)

{
  ...
  if ((iVar11 < 8) || (iVar11 = Image::get_format(), 0x10 < iVar11)) {
    ...
    do {
      ...
      if (0 < (int)uVar23) {
        ...
        do {
          ...
          iVar11 = CowData<CVTTCompressionRowTask>::resize<false>
                             ((CowData<CVTTCompressionRowTask> *)&local_3f0,lVar22);
          local_458 = local_3f0;
          if (iVar11 == 0) {
            if (local_3f0 == 0) {
              lVar19 = -1;
              ...
              lVar19 = lVar22 + -1;
              if (-1 < lVar19) {
                CowData<CVTTCompressionRowTask>::_copy_on_write
                          ((CowData<CVTTCompressionRowTask> *)&local_3f0);
...
LAB_0010131c:
  ...
  if ((image_compress_cvtt(Image*,Image::UsedChannels)::{lambda()#1}::operator()()::sname == '\0')
     && (iVar10 = __cxa_guard_acquire(&image_compress_cvtt(Image*,Image::UsedChannels)::{lambda()#1}
                                       ::operator()()::sname), iVar10 != 0)) {
    _scs_create((char *)&image_compress_cvtt(Image*,Image::UsedChannels)::{lambda()#1}::operator()()
                         ::sname,true);
  ...
  lVar15 = image_compress_cvtt(Image*,Image::UsedChannels)::{lambda()#1}::operator()()::sname;
  if (image_compress_cvtt(Image*,Image::UsedChannels)::{lambda()#1}::operator()()::sname == 0) {
LAB_0010164c:
    local_410 = 0;
  }
  else {
    pcVar1 = *(char **)(image_compress_cvtt(Image*,Image::UsedChannels)::{lambda()#1}::operator()()
                        ::sname + 8);
    local_410 = 0;
    if (pcVar1 == (char *)0x0) {
      plVar20 = (long *)(*(long *)(image_compress_cvtt(Image*,Image::UsedChannels)::{lambda()#1}::
                                   operator()()::sname + 0x10) + -0x10);
      if (*(long *)(image_compress_cvtt(Image*,Image::UsedChannels)::{lambda()#1}::operator()()::
                    sname + 0x10) == 0) goto LAB_0010164c;
      do {
        lVar16 = *plVar20;
  ...
  WorkerThreadPool::add_native_group_task
            (p_Var2,_digest_job_queue,(int)&local_3b8,*(int *)(WorkerThreadPool::singleton + 0x290),
             true,(String_conflict *)0x1);
  lVar15 = local_410;
  if (local_410 != 0) {
    LOCK();
  ...
  Image::set_data(param_1,uVar14,uVar13,uVar5,local_42c,local_408);
...
/* CowData<CVTTCompressionRowTask>::_copy_on_write() [clone .isra.0] [clone .cold] */

void CowData<CVTTCompressionRowTask>::_copy_on_write(void)
...
/* WARNING: Removing unreachable block (ram,0x00101b48) */
/* WARNING: Removing unreachable block (ram,0x00101c78) */
/* WARNING: Removing unreachable block (ram,0x00101e40) */
/* WARNING: Removing unreachable block (ram,0x00101c84) */
/* WARNING: Removing unreachable block (ram,0x00101c8e) */
/* WARNING: Removing unreachable block (ram,0x00101e20) */
/* WARNING: Removing unreachable block (ram,0x00101c9a) */
...
/* WARNING: Removing unreachable block (ram,0x00101cba) */
/* WARNING: Removing unreachable block (ram,0x00101de0) */
/* WARNING: Removing unreachable block (ram,0x00101cc6) */
/* WARNING: Removing unreachable block (ram,0x00101cd0) */
/* WARNING: Removing unreachable block (ram,0x00101dc0) */
/* WARNING: Removing unreachable block (ram,0x00101cdc) */
/* WARNING: Removing unreachable block (ram,0x00101ce6) */
/* WARNING: Removing unreachable block (ram,0x00101da0) */
/* WARNING: Removing unreachable block (ram,0x00101cf2) */
/* WARNING: Removing unreachable block (ram,0x00101cfc) */
/* WARNING: Removing unreachable block (ram,0x00101d80) */
/* WARNING: Removing unreachable block (ram,0x00101d04) */
...
/* CowData<CVTTCompressionRowTask>::_realloc(long) */

undefined8 __thiscall
CowData<CVTTCompressionRowTask>::_realloc(CowData<CVTTCompressionRowTask> *this,long param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Error CowData<CVTTCompressionRowTask>::resize<false>(long) */

undefined8 __thiscall
CowData<CVTTCompressionRowTask>::resize<false>(CowData<CVTTCompressionRowTask> *this,long param_1)

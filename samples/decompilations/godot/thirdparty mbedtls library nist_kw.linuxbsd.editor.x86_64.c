...
int unwrap_constprop_0(undefined8 param_1,undefined8 *param_2,ulong param_3,byte *param_4,
...
mbedtls_nist_kw_setkey
          (undefined8 param_1,int param_2,undefined8 param_3,undefined4 param_4,int param_5)
...
int mbedtls_nist_kw_wrap
              (undefined8 param_1,int param_2,void *param_3,ulong param_4,byte *param_5,
              size_t *param_6,ulong param_7)
...
int mbedtls_nist_kw_unwrap
              (undefined8 param_1,int param_2,undefined8 param_3,ulong param_4,undefined8 *param_5,
              size_t *param_6,ulong param_7)
...
LAB_00100659:
      ...
      if (param_2 == 1) {
        if ((param_4 - 0x10 < 0xfffffff1) && (uVar2 = (uint)param_4 & 7, (param_4 & 7) == 0)) {
          ...
          uVar5 = (ulong)(local_60._4_4_ >> 0x18 | (local_60._4_4_ & 0xff0000) >> 8 |
          ...
          uVar3 = (uint)uVar4 & 7;
          local_58 = 0;
          local_6c[0] = mbedtls_ct_memcmp_partial
                                  ((long)param_5 + (*param_6 - 8),local_80,8,8 - (ulong)uVar3,0);
...

{
  ...
  while( true ) {
    ...
    if (((iVar3 != 0) || (sVar2 = *(size_t *)((long)&kw_out_len + lVar4 * 2), sVar2 != local_e0)) ||
       (iVar3 = memcmp(local_78,kw_res + lVar4 * 0xc,sVar2), iVar3 != 0)) goto LAB_00100c40;
    ...
    if (((iVar3 != 0) || (sVar1 != local_e0)) ||
       (iVar3 = memcmp(local_78,kw_msg + lVar4 * 10,sVar1), iVar3 != 0)) {
...
LAB_00100a5b:
      __printf_chk(2,"  KW-AES-%u ",local_100);
      lVar4 = lVar5;
    }
  }
...
LAB_00100cc3:
  ...
  goto LAB_00100cdd;
LAB_00100a9c:
  iVar3 = mbedtls_nist_kw_setkey(local_d8,2,kwp_key + lVar4 * 0x20,local_100,1);
  if (iVar3 == 0) {
    sVar1 = (&kwp_msg_len)[lVar4];
    iVar3 = mbedtls_nist_kw_wrap(local_d8,1,kwp_msg + lVar4 * 0x1f,sVar1,local_78,&local_e0,0x30);
    if (((iVar3 != 0) || (sVar2 = (&kwp_out_len)[lVar4], sVar2 != local_e0)) ||
       (iVar3 = memcmp(local_78,kwp_res + lVar4 * 0x30,sVar2), iVar3 != 0)) goto LAB_00100c40;
    ...
    if (((iVar3 != 0) || (sVar1 != local_e0)) ||
       (iVar3 = memcmp(local_78,kwp_msg + lVar4 * 0x1f,sVar1), iVar3 != 0)) goto LAB_00100c40;
    if (param_1 == 0) {
      lVar4 = lVar4 + 1;
      if (lVar4 == 3) {
        mbedtls_cipher_free(local_d8);
      ...
      local_100 = *(int *)(key_len + lVar4 * 4) << 3;
LAB_00100c23:
      __printf_chk(2,"  KWP-AES-%u ",local_100);
    }
    goto LAB_00100a9c;
  }
LAB_00100d88:

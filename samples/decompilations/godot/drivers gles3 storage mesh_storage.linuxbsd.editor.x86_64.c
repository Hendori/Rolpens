              ...
              *(undefined4 **)(piVar9 + 0x24) = puVar11;
              if (local_b8[0] == 0) {
                ...
                for (lVar35 = 0; lVar35 < lVar13; lVar35 = lVar35 + 1) {
                  ...
                  (*_glad_glBindBuffer)
                            (0x8893,*(undefined4 *)(*(long *)(piVar9 + 0x24) + 0xc + lVar25));
...
LAB_001136de:
                    _err_print_index_error
                              ("get","./core/templates/cowdata.h",0xdb,lVar35,lVar13,"p_index",
                               "size()","",false,true);
                    _err_flush_stdout();
                    /* WARNING: Does not return */
                    pcVar5 = (code *)invalidInstructionException();
                  ...
                  local_180 = CONCAT44(local_180._4_4_,
                                       *(undefined4 *)(*(long *)(piVar9 + 0x24) + 0xc + lVar25));
            ...
            if ((uStack_130 & 0x1000) == 0) {
              ...
              *(int *)((long)puVar10 + 4) = iVar30 * 2;
              CowData<unsigned_int>::resize<false>
                        ((CowData<unsigned_int> *)&local_160,(ulong)(uint)(iVar30 * 2));
              ...
              *(undefined8 **)(piVar9 + 0x42) = puVar10;
              if (iVar19 != 0) {
                ...
                while( true ) {
                  ...
                  (*_glad_glBufferData)
                            (0x8892,uVar33 & 0xffffffff,uVar16 + local_68,
...
LAB_0011301e:
          ...
          *(int *)(pMVar2 + 0x10) = iVar30;
          ...
          vformat<unsigned_long,unsigned_long>
                    ((String *)&local_158,(ulong)&local_168,uVar33 >> 0x23);
...
LAB_0011438e:
        ...
        uVar23 = 0xb2;
LAB_00113bf3:
        _err_print_error("mesh_add_surface","drivers/gles3/storage/mesh_storage.cpp",uVar23,pcVar17,
                         &local_158,0,0);
        pcVar17 = local_158;
        if (local_158 != (char *)0x0) {
          LOCK();
...
LAB_00113a71:
    _err_print_error("mesh_add_surface","drivers/gles3/storage/mesh_storage.cpp",uVar23,pcVar17,0,0)
    ;
    return;
  }
LAB_001147ec:
...
switchD_00112208_caseD_6:
  ...
  iVar32 = iVar32 + *(int *)((long)&local_138 +
                            (ulong)((uint)(uVar33 >>
    ...
    if (puVar2[0x34] == (uint)(param_3 >> 0x20)) {
      ...
      if (puVar4[0x26] != 0) {
        do {
          ...
          if (local_150 == 0) {
LAB_00119348:
            if (local_b8[0] == 0) goto LAB_00119495;
LAB_00119359:
            lVar13 = local_148[0];
...
LAB_0011947f:
            if (local_b8[0] != 0) goto LAB_00119359;
LAB_00119495:
            lVar13 = local_148[0];
            iVar8 = CowData<RenderingServer::SurfaceData::LOD>::resize<false>
...

{
  ShaderGLES3::_setup((char *)this,
                      ...
                      ,"\nvoid main() {\n\n}\n/* clang-format on */\n",0x119c25,
                      (char **)&DAT_00000008,0x125560,(UBOPair *)0x0,(int)_init()::_ubo_pairs,
                      (Feedback *)0x3,0x125480,(TexUnitPair *)0x1,0x125540,(Specialization *)0x7,
                      0x1254c0,(char **)0x2);
  return;
}
...
/* WARNING: Removing unreachable block (ram,0x0011d410) */
/* WARNING: Removing unreachable block (ram,0x0011d540) */
/* WARNING: Removing unreachable block (ram,0x0011d6b9) */
/* WARNING: Removing unreachable block (ram,0x0011d54c) */
/* WARNING: Removing unreachable block (ram,0x0011d556) */
/* WARNING: Removing unreachable block (ram,0x0011d69b) */
/* WARNING: Removing unreachable block (ram,0x0011d562) */
/* WARNING: Removing unreachable block (ram,0x0011d56c) */
/* WARNING: Removing unreachable block (ram,0x0011d67d) */
/* WARNING: Removing unreachable block (ram,0x0011d578) */
/* WARNING: Removing unreachable block (ram,0x0011d582) */
/* WARNING: Removing unreachable block (ram,0x0011d65f) */
/* WARNING: Removing unreachable block (ram,0x0011d58e) */
/* WARNING: Removing unreachable block (ram,0x0011d598) */
/* WARNING: Removing unreachable block (ram,0x0011d641) */
/* WARNING: Removing unreachable block (ram,0x0011d5a4) */
/* WARNING: Removing unreachable block (ram,0x0011d5ae) */
/* WARNING: Removing unreachable block (ram,0x0011d623) */
/* WARNING: Removing unreachable block (ram,0x0011d5b6) */
/* WARNING: Removing unreachable block (ram,0x0011d5c0) */
/* WARNING: Removing unreachable block (ram,0x0011d608) */
/* WARNING: Removing unreachable block (ram,0x0011d5c8) */
/* WARNING: Removing unreachable block (ram,0x0011d5de) */
/* WARNING: Removing unreachable block (ram,0x0011d5ea) */
...
/* WARNING: Removing unreachable block (ram,0x0011de50) */
/* WARNING: Removing unreachable block (ram,0x0011df80) */
/* WARNING: Removing unreachable block (ram,0x0011e0f9) */
/* WARNING: Removing unreachable block (ram,0x0011df8c) */
/* WARNING: Removing unreachable block (ram,0x0011df96) */
/* WARNING: Removing unreachable block (ram,0x0011e0db) */
/* WARNING: Removing unreachable block (ram,0x0011dfa2) */
/* WARNING: Removing unreachable block (ram,0x0011dfac) */
/* WARNING: Removing unreachable block (ram,0x0011e0bd) */
/* WARNING: Removing unreachable block (ram,0x0011dfb8) */
/* WARNING: Removing unreachable block (ram,0x0011dfc2) */
/* WARNING: Removing unreachable block (ram,0x0011e09f) */
/* WARNING: Removing unreachable block (ram,0x0011dfce) */
/* WARNING: Removing unreachable block (ram,0x0011dfd8) */
/* WARNING: Removing unreachable block (ram,0x0011e081) */
/* WARNING: Removing unreachable block (ram,0x0011dfe4) */
/* WARNING: Removing unreachable block (ram,0x0011dfee) */
/* WARNING: Removing unreachable block (ram,0x0011e063) */
/* WARNING: Removing unreachable block (ram,0x0011dff6) */
/* WARNING: Removing unreachable block (ram,0x0011e000) */
/* WARNING: Removing unreachable block (ram,0x0011e048) */
/* WARNING: Removing unreachable block (ram,0x0011e008) */
/* WARNING: Removing unreachable block (ram,0x0011e01e) */
/* WARNING: Removing unreachable block (ram,0x0011e02a) */
...
LAB_0011e34a:
    if ((uint)uVar5 < (uint)uVar7) goto LAB_0011e38b;
    lVar6 = 0;
    while( true ) {
...

{
  ...
  *(undefined ***)this = &PTR__RID_Alloc_00122470;
  ...
  if (uVar3 == 0) {
    ...
    puVar8 = *(undefined8 **)(this + 8);
LAB_0011e5ca:
    if ((uint)uVar5 < (uint)uVar7) goto LAB_0011e60b;
    lVar6 = 0;
    while( true ) {
      Memory::free_static((void *)puVar8[lVar6],false);
      lVar2 = lVar6 * 8;
...
LAB_0011e82a:
    if ((uint)uVar5 < (uint)uVar8) goto LAB_0011e86b;
    lVar7 = 0;
    while( true ) {
      Memory::free_static((void *)puVar9[lVar7],false);
      lVar2 = lVar7 * 8;
...

{
  ...
  *(undefined ***)this = &PTR__RID_Alloc_00122410;
  ...
  if (uVar3 == 0) {
    ...
    puVar9 = *(undefined8 **)(this + 8);
LAB_0011ea6a:
    if ((uint)uVar5 < (uint)uVar8) goto LAB_0011eaab;
    lVar7 = 0;
    while( true ) {
      Memory::free_static((void *)puVar9[lVar7],false);
      lVar2 = lVar7 * 8;
...

{
  ...
  *(undefined ***)this = &PTR__RID_Alloc_00122430;
  if (uVar3 == 0) {
    ...
    puVar9 = *(undefined8 **)(this + 8);
LAB_0011ecaa:
    if ((uint)uVar5 < (uint)uVar8) goto LAB_0011eceb;
    lVar7 = 0;
    while( true ) {
      Memory::free_static((void *)puVar9[lVar7],false);
      lVar2 = lVar7 * 8;
...

{
  ...
  *(undefined ***)this = &PTR__RID_Alloc_00122410;
  ...
  if (uVar3 == 0) {
    ...
    puVar9 = *(undefined8 **)(this + 8);
LAB_0011eeca:
    if ((uint)uVar5 < (uint)uVar8) goto LAB_0011ef0b;
    lVar7 = 0;
    while( true ) {
      Memory::free_static((void *)puVar9[lVar7],false);
      lVar2 = lVar7 * 8;
...
/* WARNING: Removing unreachable block (ram,0x00120148) */
/* WARNING: Removing unreachable block (ram,0x00120278) */
/* WARNING: Removing unreachable block (ram,0x00120440) */
/* WARNING: Removing unreachable block (ram,0x00120284) */
/* WARNING: Removing unreachable block (ram,0x0012028e) */
/* WARNING: Removing unreachable block (ram,0x00120420) */
/* WARNING: Removing unreachable block (ram,0x0012029a) */
/* WARNING: Removing unreachable block (ram,0x001202a4) */
/* WARNING: Removing unreachable block (ram,0x00120400) */
/* WARNING: Removing unreachable block (ram,0x001202b0) */
/* WARNING: Removing unreachable block (ram,0x001202ba) */
/* WARNING: Removing unreachable block (ram,0x001203e0) */
/* WARNING: Removing unreachable block (ram,0x001202c6) */
/* WARNING: Removing unreachable block (ram,0x001202d0) */
/* WARNING: Removing unreachable block (ram,0x001203c0) */
/* WARNING: Removing unreachable block (ram,0x001202dc) */
/* WARNING: Removing unreachable block (ram,0x001202e6) */
/* WARNING: Removing unreachable block (ram,0x001203a0) */
/* WARNING: Removing unreachable block (ram,0x001202f2) */
/* WARNING: Removing unreachable block (ram,0x001202fc) */
/* WARNING: Removing unreachable block (ram,0x00120380) */
/* WARNING: Removing unreachable block (ram,0x00120304) */
/* WARNING: Removing unreachable block (ram,0x0012031a) */
/* WARNING: Removing unreachable block (ram,0x00120326) */

...
void __thiscall
OpenXRCompositionLayerDepthExtension::~OpenXRCompositionLayerDepthExtension
          (OpenXRCompositionLayerDepthExtension *this)
...
/* OpenXRCompositionLayerDepthExtension::get_composition_layer_count() */

undefined8 OpenXRCompositionLayerDepthExtension::get_composition_layer_count(void)
...
/* OpenXRCompositionLayerDepthExtension::get_composition_layer(int) */

undefined8 OpenXRCompositionLayerDepthExtension::get_composition_layer(int param_1)
...
/* OpenXRCompositionLayerDepthExtension::get_composition_layer_order(int) */

undefined8 OpenXRCompositionLayerDepthExtension::get_composition_layer_order(int param_1)
...
/* non-virtual thunk to OpenXRCompositionLayerDepthExtension::get_composition_layer_order(int) */

undefined8 __thiscall
OpenXRCompositionLayerDepthExtension::get_composition_layer_order
          (OpenXRCompositionLayerDepthExtension *this,int param_1)
...
/* non-virtual thunk to OpenXRCompositionLayerDepthExtension::get_composition_layer_count() */
...
/* non-virtual thunk to OpenXRCompositionLayerDepthExtension::get_composition_layer(int) */

undefined8 __thiscall
OpenXRCompositionLayerDepthExtension::get_composition_layer
          (OpenXRCompositionLayerDepthExtension *this,int param_1)
...
undefined8 OpenXRCompositionLayerDepthExtension::get_singleton(void)
...
{
  this[0x10] = (OpenXRCompositionLayerDepthExtension)0x0;
  singleton = this;
  *(undefined ***)this = &PTR_get_requested_extensions_00100e30;
  *(undefined ***)(this + 8) = &PTR_get_composition_layer_count_00100f70;
  return;
}



/* OpenXRCompositionLayerDepthExtension::is_available() */

OpenXRCompositionLayerDepthExtension __thiscall
OpenXRCompositionLayerDepthExtension::is_available(OpenXRCompositionLayerDepthExtension *this)
...
/* OpenXRCompositionLayerDepthExtension::get_requested_extensions() */

void OpenXRCompositionLayerDepthExtension::get_requested_extensions(void)

{
  ...
  *(undefined1 (*) [16])(in_RDI + 0x18) = (undefined1  [16])0x0;
  local_38 = "XR_KHR_composition_layer_depth";
  local_40 = 0;
  local_30 = 0x1e;
...
LAB_00100aa6:
    ...
    iVar45 = *(int *)(this + 0x2c);
    if (pvVar43 == (void *)0x0) goto LAB_00100584;
    if (iVar45 != 0) goto LAB_00100aa6;
LAB_001005aa:
    ...
    *(void **)(this + 8) = __s_00;
    ...
    if (iVar45 != 0) {
      ...
      uVar55 = *(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x28) * 4);
      if (*(long *)(this + 8) == 0) goto LAB_00100c08;
LAB_00100a9a:
      iVar45 = *(int *)(this + 0x2c);
      goto LAB_00100a9e;
    }
LAB_00100584:
    if ((float)uVar39 * __LC0 < (float)(iVar45 + 1)) goto LAB_001005aa;
  }
  local_58[0] = 0;
  if (*(long *)param_1 == 0) {
...
LAB_00100833:
    ...
    if (puVar42 != (undefined8 *)0x0) goto LAB_00100840;
LAB_00100a75:
    ...
    *plVar1 = *plVar1 + -1;
    UNLOCK();
    if (*plVar1 != 0) goto LAB_00100833;
    Memory::free_static((void *)(local_58[0] + -0x10),false);
    puVar42 = *(undefined8 **)(this + 0x20);
    if (puVar42 == (undefined8 *)0x0) goto LAB_00100a75;
LAB_00100840:
    *puVar42 = pauVar41;

...

{
  ...
  if (10 < uVar1) {
    ...
    bVar6 = (((((((*(long *)(param_1 + 4) != 0 && *(long *)(param_1 + 6) != 0) &&
                 *(long *)(param_1 + 8) != 0) && (int)uVar2 <= (int)uVar4) && iVar11 <= (int)uVar5)
              && iVar11 <= (int)uVar7) &&
             (ulong)((int)uVar4 * lVar9 + lVar10) <= *(ulong *)(param_1 + 0x10)) &&
            (ulong)((int)uVar5 * lVar8 + (long)iVar11) <= *(ulong *)(param_1 + 0x12)) &&
            (ulong)((int)uVar7 * lVar8 + (long)iVar11) <= *(ulong *)(param_1 + 0x14);
    if (uVar1 == 0xc) {
      uVar1 = param_1[0xf];
      uVar7 = -uVar1;
      if (0 < (int)uVar1) {
      ...
      bVar6 = bVar6 && ((*(long *)(param_1 + 10) != 0 && (int)uVar2 <= (int)uVar7) &&
                       (ulong)((int)uVar7 * lVar9 + lVar10) <= *(ulong *)(param_1 + 0x16));
    }
    return bVar6 * '\x02' ^ 2;
  }
  uVar7 = param_1[6];
  ...
  return ((int)uVar4 * lVar9 + (ulong)(byte)kModeBpp[uVar1] * lVar10 <= *(ulong *)(param_1 + 8) &&
         (*(long *)(param_1 + 4) != 0 && (int)((byte)kModeBpp[uVar1] * uVar2) <= (int)uVar4)) *
         '\x02' ^ 2;
}
...
LAB_001002c2:
        bVar3 = (int)param_2 < 1 || (int)uVar10 < 1;
        goto LAB_001002cf;
      }
LAB_00100370:
      local_48 = *(uint *)(param_3 + 0x20);
      ...
      iVar4 = WebPCheckCropDimensions
                        (param_1,param_2,*(uint *)(param_3 + 0xc) & 0xfffffffe,
                         *(uint *)(param_3 + 0x10) & 0xfffffffe,uVar10,uVar2);
      if (iVar4 != 0) {
        param_2 = (ulong)uVar2;
        uVar12 = (ulong)uVar10;
  ...
  if ((param_2 >> 8 == 2) && (param_1 != (undefined8 *)0x0)) {
    *param_1 = 0;
    ...
    for (uVar1 = (ulong)(((int)param_1 -
                         (int)(undefined8 *)((ulong)(param_1 + 1) & 0xfffffffffffffff8)) + 0x78U >>
...

{
  ...
  *(undefined8 *)(param_2 + 4) = uVar1;
  ...
  if (iVar2 == 0) {
    uVar3 = 0;
    if (*param_1 < 0xb) {
      WebPCopyPlane(*(undefined8 *)(param_1 + 4),param_1[6],*(undefined8 *)(param_2 + 0x10),
                    *(undefined4 *)(param_2 + 0x18),
                    (uint)(byte)kModeBpp[*param_1] * (int)extraout_XMM0_Qa,uVar4);
      return 0;
    }
    WebPCopyPlane(*(undefined8 *)(param_1 + 4),param_1[0xc],*(undefined8 *)(param_2 + 0x10),
                  *(undefined4 *)(param_2 + 0x30),extraout_XMM0_Qa & 0xffffffff,uVar4);
    WebPCopyPlane(*(undefined8 *)(param_1 + 6),param_1[0xd],*(undefined8 *)(param_2 + 0x18),
                  *(undefined4 *)(param_2 + 0x34),(int)(param_1[1] + 1) / 2,
                  (int)(param_1[2] + 1) / 2);
    WebPCopyPlane(*(undefined8 *)(param_1 + 8),param_1[0xe],*(undefined8 *)(param_2 + 0x20),
                  *(undefined4 *)(param_2 + 0x38),(int)(param_1[1] + 1) / 2,
                  (int)(param_1[2] + 1) / 2);
    if ((*param_1 < 0xd) && ((0x17baUL >> ((ulong)*param_1 & 0x3f) & 1) != 0)) {
      WebPCopyPlane(*(undefined8 *)(param_1 + 10),param_1[0xf],*(undefined8 *)(param_2 + 0x28),
                    *(undefined4 *)(param_2 + 0x3c),param_1[1],param_1[2]);
    }
  }
  return uVar3;
}

...
LAB_00102712:
  ...
  do {
    ...
    switch((long)&switchD_00102569::switchdataD_0010daac +
           (long)(int)(&switchD_00102569::switchdataD_0010daac)[param_2 - 8]) {
    case 0x102670:
      uVar20 = puVar26[1];
...
LAB_00104a58:
    if (uVar4 == 0x10) goto LAB_00104c10;
...
LAB_00104a85:
    if ((*(long *)(pTVar14 + 0x60) != 0) &&
       (lVar6 = *(long *)(*(long *)(pTVar14 + 0x60) + 8), lVar6 != 0)) {
LAB_00104a97:
      piVar5 = *(int **)(lVar6 + 8);
...
LAB_00104c10:
    ...
    if ((*(long *)(pTVar14 + 0x60) != 0) &&
       (lVar6 = *(long *)(*(long *)(pTVar14 + 0x60) + 8), lVar6 != 0)) goto LAB_00104a97;
LAB_00104b09:
    local_68 = &PTR__TConstUnionArray_0010ebd8;
    local_60 = (ulong *)0x0;
  }
  ...
  if (*(long *)(pTVar14 + 0x10) - *(long *)(pTVar14 + 8) == 8) {
    ...
    cVar2 = glslang::TIntermediate::parseConstTree
                      (this,param_1,&local_58,*(undefined4 *)(param_1 + 0xb8),pTVar14,1);
  }
  else {
    if (pcVar12 == TIntermTyped::getType) {
      pTVar14 = param_1 + 0x20;
    ...
    local_50 = local_60;
    cVar2 = glslang::TIntermediate::parseConstTree
                      (this,param_1,&local_58,*(undefined4 *)(param_1 + 0xb8),pTVar14,0);
  }
...
LAB_00104dc4:
    pTVar13 = (TSourceLoc *)(*pcVar12)(param_1);
  }
  else {
...
LAB_00104bb9:
  ...
  param_1 = (TIntermAggregate *)
            glslang::TIntermediate::addConstantUnion
                      ((TConstUnionArray *)this,(TType *)&local_68,pTVar13,(bool)cVar2);
LAB_00104bd1:
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return param_1;
  }
...

{
  ...
  if ((local_78 != 0) && (lVar7 = *(long *)(local_78 + 8), lVar7 != 0)) {
    piVar14 = *(int **)(lVar7 + 8);
...
LAB_001070a0:
        iVar16 = iVar16 * *piVar14 * piVar14[4];
      }
    }
...
LAB_001072f9:
      if (*(code **)(lVar7 + 0x150) == TIntermTyped::isArray) {
        if (*(long *)(param_1 + 0x80) == 0) {
LAB_0010731f:
          if (*(code **)(lVar7 + 0x168) == TIntermTyped::isStruct) {
...
LAB_001073c6:
                    if (uVar6 == 0x10) goto LAB_00107570;
                    if (*(byte *)((long)plVar3 + 9) < 0x10) {
                      uVar15 = *(byte *)((long)plVar3 + 9) & 0xf;
                    }
                    else {
                      uVar15 = (uint)(*(byte *)((long)plVar3 + 9) >> 4) *
                               (*(byte *)((long)plVar3 + 10) & 0xf);
                    }
                  }
                  else {
...
LAB_00107570:
                  ...
                  if ((plVar3[0xc] != 0) && (lVar7 = *(long *)(plVar3[0xc] + 8), lVar7 != 0)) {
                    piVar14 = *(int **)(lVar7 + 8);
                    ...
                    if (iVar16 < 1) {
                      ...
                      piVar1 = piVar14 + 4;
                      iVar17 = 1;
                      if (((int)(piVar1 + (ulong)(iVar16 - 1) * 4) - (int)piVar14 & 0x10U) == 0)
                      goto LAB_00107450;
                      iVar17 = *piVar14;
                      for (piVar14 = piVar1; piVar14 != piVar1 + (ulong)(iVar16 - 1) * 4;
                          piVar14 = piVar14 + 8) {
LAB_00107450:
                        iVar17 = iVar17 * *piVar14 * piVar14[4];
                      }
                    }
    ...
    lVar7 = *(long *)param_1;
    if (((*(byte *)(lVar19 + 10) & 0x20) == 0) && ((*(byte *)(lVar19 + 10) & 0x40) == 0))
    goto LAB_001072f9;
LAB_00107490:
    if (*(code **)(lVar7 + 0xf0) != TIntermTyped::getType) {
...
LAB_00109d93:
      ...
      if (*(code **)(lVar4 + 0xe8) == glslang::TType::isArray) {
        ...
        if (lVar3 != 0) {
LAB_00109de4:
          if (*(long *)(*(long *)(*(long *)(lVar3 + 8) + 8) + 8) != 0) goto LAB_00109df3;
          goto LAB_00109e00;
        }
      }
      else {
...
LAB_0010a4fd:
      ...
      if (*(code **)(lVar4 + 0x140) == glslang::TType::isOpaque) {
        if ((*(byte *)(plVar1 + 1) < 0x15) &&
           ((0x1a6000UL >> ((ulong)*(byte *)(plVar1 + 1) & 0x3f) & 1) != 0)) goto LAB_0010a320;
      }
      else {
        cVar2 = (**(code **)(lVar4 + 0x140))(plVar1);
...
LAB_0010a320:
      ...
      if (*(code **)(lVar4 + 0x140) == glslang::TType::isOpaque) {
        if ((*(byte *)(plVar1 + 1) < 0x15) &&
           ((0x1a6000UL >> ((ulong)*(byte *)(plVar1 + 1) & 0x3f) & 1) != 0)) goto LAB_0010a388;
      }
      else {
        cVar2 = (**(code **)(lVar4 + 0x140))(plVar1);
...
LAB_0010a388:
      ...
      if (*(code **)(lVar4 + 0x140) == glslang::TType::isOpaque) {
        if ((*(byte *)(plVar1 + 1) < 0x15) &&
           ((0x1a6000UL >> ((ulong)*(byte *)(plVar1 + 1) & 0x3f) & 1) != 0)) goto LAB_0010a3f0;
      }
      else {
        cVar2 = (**(code **)(lVar4 + 0x140))(plVar1);
...
LAB_0010aae5:
      ...
      if (*(code **)(lVar4 + 0xf8) == glslang::TType::isUnsizedArray) {
        ...
        if (lVar3 != 0) {
LAB_0010a8b8:
          if (**(int **)(*(long *)(lVar3 + 8) + 8) == 0) goto LAB_0010a8c8;
          goto LAB_0010a8e1;
        }
      }
      else {
...
LAB_0010a8c8:
      ...
      if (*(code **)(lVar4 + 0xf8) == glslang::TType::isUnsizedArray) {
        ...
        if (lVar3 != 0) {
LAB_0010a930:
          if (**(int **)(*(long *)(lVar3 + 8) + 8) == 0) goto LAB_0010a93e;
          goto LAB_0010a959;
        }
      }
      else {
...
LAB_0010a93e:
      ...
      if (*(code **)(lVar4 + 0xf8) == glslang::TType::isUnsizedArray) {
        ...
        if (lVar3 != 0) {
LAB_0010a9a8:
          if (**(int **)(*(long *)(lVar3 + 8) + 8) == 0) goto LAB_0010a9b6;
          goto LAB_0010a9c9;
        }
      }
      else {
...
LAB_0010b9eb:
        if (uVar16 == 0x10) goto LAB_0010ba9e;
        if (*(byte *)((long)plVar3 + 9) < 0x10) {
...
LAB_0010baef:
              if (uVar11 == 0x10) goto LAB_0010bbad;
...
LAB_0010bc04:
                    if (uVar19 == 0x10) goto LAB_0010bcca;
...
LAB_0010bd22:
                          if (uVar12 == 0x10) goto LAB_0010bdf8;
...
LAB_0010be51:
                                if (uVar15 == 0x10) goto LAB_0010bf20;
...
LAB_0010bf76:
                                      if (uVar24 == 0x10) goto LAB_0010c040;
...
LAB_0010c096:
                                            if (uVar14 == 0x10) goto LAB_0010c160;
                                          ...
                                          if ((plVar9[0xc] != 0) &&
                                            ...
                                            if (iVar13 < 1) {
                                              ...
                                              if (((int)(piVar1 + (ulong)(iVar13 - 1) * 4) -
                                                   (int)piVar17 & 0x10U) == 0) goto LAB_0010c112;
                                              iVar18 = *piVar17;
                                              for (piVar17 = piVar1;

...
LAB_00100870:
  uVar9 = (ulong)(param_3 & 0xffffffe0);
  iVar10 = (int)param_4;
    ...
    if (((param_1 == (UNewTrie *)0x0) || (param_3 < 0)) ||
      ...
      *param_6 = 1;
      ...
      if (iVar32 == **(int **)(param_1 + 0x22080)) {
        iVar23 = 0;
LAB_00100e92:
        if (((int)(param_1 + 0x1b80) - (int)pUVar25 & 0x10U) == 0) goto LAB_00100eb9;
        *(int *)pUVar25 = iVar23;
        *(int *)(param_1 + 0x1b04) = iVar23;
        *(int *)(param_1 + 0x1b08) = iVar23;
        *(int *)(param_1 + 0x1b0c) = iVar23;
...
LAB_00100eb9:
          ...
          *(int *)(pUVar25 + 0x10) = iVar23;
          *(int *)(pUVar25 + 0x14) = iVar23;
          *(int *)(pUVar25 + 0x18) = iVar23;
          *(int *)(pUVar25 + 0x1c) = iVar23;
        }
        uVar31 = 0x10000;
        iVar32 = 0x800;
        do {
...
LAB_00100f78:
            iVar33 = (*param_4)(param_1,uVar30,iVar23 + 0x20);
              ...
              if (iVar32 <= param_3) {
                ...
                *param_2 = __LC3;
                ...
                if (0 < (int)uVar31) {
                  ...
                  do {
                    *(short *)((long)param_2 + uVar21 * 2 + 0x10) =
                         (short)(*(int *)(param_1 + uVar21 * 4) + uVar31 >> 2);
                    uVar21 = uVar21 + 1;
                  } while (uVar21 != uVar31);
                ...
                if (0 < (int)uVar30) {
                  ...
                  do {
                    *(short *)((long)puVar26 + uVar21 * 2) =
                         (short)*(undefined4 *)(lVar29 + uVar21 * 4);
                    uVar21 = uVar21 + 1;
                  } while (uVar30 != uVar21);
                }
              }
...
LAB_0010148e:
      ...
      *param_2 = 0;
      ...
      for (uVar11 = (ulong)(((int)param_2 -
                            ...
                            0x1040U >> 3); uVar4 = _UNK_00101a28, uVar3 = __LC6, uVar11 != 0;
          uVar11 = uVar11 - 1) {
        *puVar10 = 0;
        puVar10 = puVar10 + 1;
      }
      ...
      *param_1 = param_2;
      ...
      if (param_5 != param_4) {
        ...
        *(undefined4 *)(param_2 + 0x248) = uVar13;
        *(undefined4 *)((long)param_2 + 0x1244) = uVar13;
        *(undefined4 *)(param_2 + 0x249) = uVar13;
        *(undefined4 *)((long)param_2 + 0x124c) = uVar13;
        *(undefined4 *)(param_2 + 0x24a) = uVar13;
        *(undefined4 *)((long)param_2 + 0x1254) = uVar13;
        *(undefined4 *)(param_2 + 0x24b) = uVar13;
        *(undefined4 *)((long)param_2 + 0x125c) = uVar13;
        *(undefined4 *)(param_2 + 0x24c) = uVar13;
        *(undefined4 *)((long)param_2 + 0x1264) = uVar13;
        *(undefined4 *)(param_2 + 0x24d) = uVar13;
        *(undefined4 *)((long)param_2 + 0x126c) = uVar13;
        *(undefined4 *)(param_2 + 0x24e) = uVar13;
        *(undefined4 *)((long)param_2 + 0x1274) = uVar13;
        *(undefined4 *)(param_2 + 0x24f) = uVar13;
        *(undefined4 *)((long)param_2 + 0x127c) = uVar13;
      }
    }
    param_1[2] = 0x100000;
  }

...
/* hb_shape_plan_key_t::init(bool, hb_face_t*, hb_segment_properties_t const*, hb_feature_t const*,
   unsigned int, int const*, unsigned int, char const* const*) */

undefined8 __thiscall
hb_shape_plan_key_t::init
          (hb_shape_plan_key_t *this,bool param_1,hb_face_t *param_2,
          hb_segment_properties_t *param_3,hb_feature_t *param_4,uint param_5,int *param_6,
...
LAB_001000f6:
  ...
  return 0;
LAB_001001b0:
  pcVar10 = _hb_graphite2_shape;
  pcVar8 = "graphite2";
  goto LAB_001001be;
LAB_001001e8:
  pcVar10 = _hb_ot_shape;
  pcVar8 = "ot";
  goto LAB_001001be;
LAB_00100210:
  pcVar10 = _hb_fallback_shape;
  pcVar8 = "fallback";
LAB_001001be:
  *(char **)(this + 0x40) = pcVar8;
...
undefined8 __thiscall
hb_shape_plan_key_t::user_features_match(hb_shape_plan_key_t *this,hb_shape_plan_key_t *param_1)
...
undefined8 __thiscall
hb_shape_plan_key_t::equal(hb_shape_plan_key_t *this,hb_shape_plan_key_t *param_1)

{
  ...
  if (iVar1 != 0) {
    ...
    if (((char)uVar2 != '\0') && (uVar2 = 0, *(long *)(this + 0x2c) == *(long *)(param_1 + 0x2c))) {
      uVar2 = CONCAT71((int7)((ulong)*(long *)(param_1 + 0x38) >> 8),
...
hb_shape_plan_create2
          (hb_face_t *param_1,hb_segment_properties_t *param_2,hb_feature_t *param_3,uint param_4,
...

{
  ...
  {
    *(undefined1 (*) [16])(__ptr + 0x2a) = (undefined1  [16])0x0;
    *(undefined1 (*) [16])(__ptr + 0x2e) = (undefined1  [16])0x0;
    *(undefined1 (*) [16])(__ptr + 0x32) = (undefined1  [16])0x0;
    *(undefined1 (*) [16])(__ptr + 0x36) = (undefined1  [16])0x0;
    *__ptr = 1;
    __ptr[1] = 1;
    ...
    *(hb_face_t **)(__ptr + 4) = param_1;
    cVar1 = hb_shape_plan_key_t::init
                      ((hb_shape_plan_key_t *)(__ptr + 6),true,param_1,param_2,param_3,param_4,
...
bool hb_shape_plan_set_user_data(int *param_1,long param_2,long param_3,long param_4,int param_5)
...
LAB_00100ed7:
      do {
        if (*plVar1 != 0) {
LAB_00100ee4:
          iVar4 = _hb_graphite2_shape(param_1,param_2,param_3);
...
LAB_00100f57:
      do {
        if (*plVar1 != 0) {
LAB_00100f64:
          iVar4 = _hb_ot_shape(param_1,param_2,param_3);
          goto joined_r0x00100f71;
        }
        if (*(long *)(param_2 + 0xa8) == 0) {
          return 0;
...
LAB_00100f27:
      do {
        if (*plVar1 != 0) {
LAB_00100f34:
          iVar4 = _hb_fallback_shape(param_1,param_2,param_3);
joined_r0x00100f71:
          if (iVar4 == 0) {
            return 0;
          }
...
int * hb_shape_plan_create_cached2
                (hb_face_t *param_1,hb_segment_properties_t *param_2,hb_feature_t *param_3,
                uint param_4,int *param_5,uint param_6,char **param_7)
...
LAB_00101306:
    ...
    cVar4 = hb_shape_plan_key_t::init
                      (local_88,false,param_1,param_2,param_3,param_4,param_5,param_6,param_7);
    plVar2 = plVar3;
    if (cVar4 == '\0') {

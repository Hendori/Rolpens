...
HashMap<unsigned_long,int,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>,DefaultTypedAllocator<HashMapElement<unsigned_long,int>>>
::_lookup_pos(HashMap<unsigned_long,int,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>,DefaultTypedAllocator<HashMapElement<unsigned_long,int>>>
              *this,ulong *param_1,uint *param_2)
    ...
    if (uVar14 != 0) {
      ...
      do {
        if (((uint)uVar13 == uVar14) &&
           (*(ulong **)(*(long *)(*(long *)(this + 8) + lVar12 * 8) + 0x10) == param_1)) {
          *param_2 = uVar11;
          return 1;
        }
        uVar16 = uVar16 + 1;
...
/* WorkerThreadPool::is_task_completed(long) const */

byte __thiscall WorkerThreadPool::is_task_completed(WorkerThreadPool *this,long param_1)
      ...
      do {
        ...
        uVar13 = SUB164(auVar4 * auVar8,8);
              ...
              auVar6._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                               (ulong)*(uint *)(this + 0x390) * 4) + uVar13) -
                                    SUB164(auVar5 * auVar9,8)) * lVar2, auVar10._8_8_ = 0,
              auVar10._0_8_ = uVar18, uVar19 <= SUB164(auVar6 * auVar10,8)));
    }
  }
  bVar15 = 0;
  _err_print_error("is_task_completed","core/object/worker_thread_pool.cpp",0x168,
                   "Method/function failed. Returning: false","Invalid Task ID",0,0);
LAB_0010027a:
  pthread_mutex_unlock((pthread_mutex_t *)(this + 0x268));
  return bVar15;
}



/* WorkerThreadPool::get_group_processed_element_count(long) const */

undefined4 __thiscall
WorkerThreadPool::get_group_processed_element_count(WorkerThreadPool *this,long param_1)
    ...
    if (uVar17 != 0) {
      ...
      do {
        ...
        uVar13 = SUB164(auVar4 * auVar8,8);
              ...
              auVar9._0_8_ = uVar18, auVar6._8_8_ = 0,
              auVar6._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                               (ulong)*(uint *)(this + 0x420) * 4) + uVar13) -
                                    SUB164(auVar5 * auVar9,8)) * lVar2, auVar10._8_8_ = 0,
              auVar10._0_8_ = uVar18, uVar19 <= SUB164(auVar6 * auVar10,8)));
    }
  }
  uVar15 = 0;
  _err_print_error("get_group_processed_element_count","core/object/worker_thread_pool.cpp",0x2a0,
                   "Method/function failed. Returning: 0","Invalid Group ID",0,0);
LAB_0010041b:
  pthread_mutex_unlock((pthread_mutex_t *)(this + 0x268));
  return uVar15;
}
...
/* WorkerThreadPool::is_group_task_completed(long) const */

undefined8 __thiscall WorkerThreadPool::is_group_task_completed(WorkerThreadPool *this,long param_1)

{
    ...
    if (uVar17 != 0) {
      ...
      do {
        if (((uint)uVar15 == uVar17) && (*(long *)(*(long *)(lVar1 + lVar14 * 8) + 0x10) == param_1)
          ...
          uVar16 = CONCAT71((int7)(uVar15 >> 8),
                            *(char *)(*(long *)(*(long *)(lVar1 + (ulong)uVar13 * 8) + 0x18) + 0x78)
                            != '\0');
          goto LAB_001005ca;
        }
        uVar19 = uVar19 + 1;
  ...
  uVar16 = 0;
  _err_print_error("is_group_task_completed","core/object/worker_thread_pool.cpp",0x2a8,
                   "Method/function failed. Returning: false","Invalid Group ID",0,0);
LAB_001005ca:
  pthread_mutex_unlock((pthread_mutex_t *)(this + 0x268));
  return uVar16;
}
...
void __thiscall
HashMap<long,WorkerThreadPool::Task*,HashMapHasherDefault,HashMapComparatorDefault<long>,PagedAllocator<HashMapElement<long,WorkerThreadPool::Task*>,false,1024u>>
::erase(HashMap<long,WorkerThreadPool::Task*,HashMapHasherDefault,HashMapComparatorDefault<long>,PagedAllocator<HashMapElement<long,WorkerThreadPool::Task*>,false,1024u>>
        *this,long *param_1)
  ...
  if ((lVar6 != 0) && (*(int *)(this + 0x8c) != 0)) {
    ...
    if (uVar37 != 0) {
      ...
      do {
        ...
        if (((uint)uVar33 == uVar37) &&
           (*param_1 == *(long *)(*(long *)(lVar6 + uVar29 * 8) + 0x10))) {
          ...
          if ((uVar37 != 0) &&
             ...
             auVar16._0_8_ = (ulong)((uVar31 + uVar5) - SUB164(auVar15 * auVar24,8)) * lVar8,
             auVar25._8_8_ = 0, auVar25._0_8_ = uVar35, uVar29 = (ulong)uVar31, uVar33 = uVar34,
...
joined_r0x00100823:
          ...
          *(long **)(*(long *)(*(long *)(this + 8) +
                              (ulong)(uVar5 >> ((byte)*(undefined4 *)(this + 0x18) & 0x1f)) * 8) +
                    (ulong)(uVar5 & *(uint *)(this + 0x1c)) * 8) = plVar30;
        ...
        uVar36 = uVar36 + 1;
              ...
              auVar13._0_8_ = (ulong)((uVar5 + uVar31) - SUB164(auVar12 * auVar21,8)) * lVar8,
              auVar22._8_8_ = 0, auVar22._0_8_ = uVar35, uVar29 = uVar32,
...
/* WorkerThreadPool::Task::free_template_userdata() */

void __thiscall WorkerThreadPool::Task::free_template_userdata(Task *this)

{
  long *plVar1;
  
  if (*(long *)(this + 0xd8) == 0) {
    _err_print_error("free_template_userdata","core/object/worker_thread_pool.cpp",0x2b,
                     "Parameter \"template_userdata\" is null.",0,0);
    return;
  }
  ...
  _err_print_error("free_template_userdata","core/object/worker_thread_pool.cpp",0x2c,
                   "Parameter \"native_func_userdata\" is null.",0,0);
  return;
}
...
ulong __thiscall
WorkerThreadPool::_notify_threads
          (WorkerThreadPool *this,ThreadData *param_1,uint param_2,uint param_3)
...
LAB_00100aed:
    _err_print_index_error
              ("operator[]","./core/templates/local_vector.h",0xb2,(ulong)uVar5,uVar7,"p_index",
               "count","",false,true);
    _err_flush_stdout();
  ...
  do {
    ...
    if (((byte)pTVar2[0x18] & 1) == 0) {
      if (*(long *)(pTVar2 + 0x20) == 0) {
        ...
        if ((*(long *)(pTVar2 + 0x28) == 0) || (*(char *)(*(long *)(pTVar2 + 0x20) + 0xd0) == '\0'))
        break;
        if (param_1 != pTVar2) {
          std::condition_variable::notify_one();
        }
...
LAB_00100b80:
    ...
    while( true ) {
      if (*(uint *)(this + 0x290) <= uVar5) {
        _err_print_index_error
                  ("operator[]","./core/templates/local_vector.h",0xb2,(ulong)uVar5,
                   (ulong)*(uint *)(this + 0x290),"p_index","count","",false,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
        pcVar4 = (code *)invalidInstructionException();
        (*pcVar4)();
...
/* WorkerThreadPool::_try_promote_low_priority_task() */

undefined8 __thiscall WorkerThreadPool::_try_promote_low_priority_task(WorkerThreadPool *this)
  ...
  if (plVar1 != (long *)0x0) {
    ...
    if (*(long *)(lVar2 + 0xa8) == 0) {
      ...
      *(long *)(this + 0x260) = lVar4;
      ...
      _err_print_error("add_last","./core/templates/self_list.h",0x3f,
...
/* WorkerThreadPool::_lock_unlockable_mutexes() */

void WorkerThreadPool::_lock_unlockable_mutexes(void)
...
/* WorkerThreadPool::_unlock_unlockable_mutexes() */

void WorkerThreadPool::_unlock_unlockable_mutexes(void)
...
/* WorkerThreadPool::wait_for_group_task_completion(long) */

void __thiscall
WorkerThreadPool::wait_for_group_task_completion(WorkerThreadPool *this,long param_1)
...
LAB_0010151b:
                    /* WARNING: Subroutine does not return */
    std::__throw_system_error(iVar36);
  }
  ...
  if ((lVar7 != 0) && (*(int *)(this + 0x424) != 0)) {
    ...
    if (uVar45 != 0) {
      ...
      while (((uint)uVar43 != uVar45 || (*(long *)(*(long *)(lVar7 + lVar41 * 8) + 0x10) != param_1)
        ...
        if ((uVar45 == 0) ||
           (auVar12._8_8_ = 0, auVar12._0_8_ = (ulong)uVar45 * lVar8, auVar25._8_8_ = 0,
           auVar25._0_8_ = uVar44, auVar13._8_8_ = 0,
           auVar13._0_8_ =
                (ulong)((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x420) * 4) +
                        uVar39) - SUB164(auVar12 * auVar25,8)) * lVar8, auVar26._8_8_ = 0,
           auVar26._0_8_ = uVar44, SUB164(auVar13 * auVar26,8) < uVar47)) goto LAB_00101318;
      }
      ...
      *piVar1 = *piVar1 + 1;
      ...
      if (*(int *)(lVar7 + 0x80) + 1 == iVar36 + 1) {
        iVar36 = pthread_mutex_lock(__mutex);
        if ((iVar36 != 0) || (iVar36 = pthread_mutex_lock(__mutex_00), iVar36 != 0))
        goto LAB_0010151b;
        if (*(int *)(lVar7 + 0x74) != 0) {
        ...
        *(long *)(*(long *)(*(long *)(this + 0x1e8) +
                           (ulong)(uVar45 >> ((byte)*(undefined4 *)(this + 0x1f8) & 0x1f)) * 8) +
                 (ulong)(uVar45 & *(uint *)(this + 0x1fc)) * 8) = lVar7;
      ...
      if ((lVar7 != 0) && (*(int *)(this + 0x424) != 0)) {
        ...
        if (uVar39 != 0) {
          ...
          do {
            ...
            if ((uVar39 == (uint)uVar43) &&
               (*(long *)(*(long *)(lVar7 + uVar37 * 8) + 0x10) == param_1)) {
              puVar48 = (uint *)(lVar8 + uVar42 * 4);
              uVar39 = *puVar48;
              if ((uVar39 != 0) &&
                 (auVar18._8_8_ = 0, auVar18._0_8_ = (ulong)uVar39 * lVar41, auVar31._8_8_ = 0,
                 auVar31._0_8_ = uVar46, auVar19._8_8_ = 0,
                 auVar19._0_8_ = (ulong)((uVar40 + uVar45) - SUB164(auVar18 * auVar31,8)) * lVar41,
                 auVar32._8_8_ = 0, auVar32._0_8_ = uVar46, uVar37 = (ulong)uVar40, uVar43 = uVar44,
                 SUB164(auVar19 * auVar32,8) != 0)) {
                while( true ) {
                  uVar44 = uVar37;
                  ...
                  *puVar4 = uVar9;
                  ...
                  uVar39 = *puVar48;
                  if ((uVar39 == 0) ||
                     (auVar20._8_8_ = 0, auVar20._0_8_ = (ulong)uVar39 * lVar41, auVar33._8_8_ = 0,
                     auVar33._0_8_ = uVar46, auVar21._8_8_ = 0,
                     auVar21._0_8_ =
                          (ulong)((SUB164(auVar22 * auVar35,8) + uVar45) -
                                 SUB164(auVar20 * auVar33,8)) * lVar41, auVar34._8_8_ = 0,
                     auVar34._0_8_ = uVar46, SUB164(auVar21 * auVar34,8) == 0)) break;
              ...
              *(long **)(*(long *)(*(long *)(this + 0x3a0) +
                                  (ulong)(uVar45 >> ((byte)*(undefined4 *)(this + 0x3b0) & 0x1f)) *
                                  8) + (ulong)(uVar45 & *(uint *)(this + 0x3b4)) * 8) = plVar38;
            ...
            uVar47 = uVar47 + 1;
                  ...
                  (auVar15._8_8_ = 0, auVar15._0_8_ = (ulong)uVar39 * lVar41, auVar28._8_8_ = 0,
                  auVar28._0_8_ = uVar46, auVar16._8_8_ = 0,
                  auVar16._0_8_ = (ulong)((uVar45 + uVar40) - SUB164(auVar15 * auVar28,8)) * lVar41,
                  auVar29._8_8_ = 0, auVar29._0_8_ = uVar46, uVar37 = uVar42,
...
LAB_00101318:
  pthread_mutex_unlock(__mutex);
  _err_print_error("wait_for_group_task_completion","core/object/worker_thread_pool.cpp",0x2b3,
                   "Method/function failed.","Invalid Group ID.",0,0);
  if (lVar6 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
  }
LAB_00101522:
...
/* WorkerThreadPool::_switch_runlevel(WorkerThreadPool::Runlevel) */

void __thiscall WorkerThreadPool::_switch_runlevel(WorkerThreadPool *this,undefined4 param_2)
...
/* WorkerThreadPool::finish() [clone .part.0] */

void __thiscall WorkerThreadPool::finish(WorkerThreadPool *this)

{
  ...
  if (iVar5 == 0) {
    for (lVar7 = *(long *)(this + 0x248); lVar7 != 0; lVar7 = *(long *)(lVar7 + 0x10)) {
      operator+((char *)&local_48,(String *)"Task waiting was never re-claimed: ");
    ...
    if (iVar5 == 0) {
      ...
      while( true ) {
        ...
        *(long *)(*(long *)(*(long *)(this + 0x180) +
                           (ulong)(uVar2 >> ((byte)*(undefined4 *)(this + 400) & 0x1f)) * 8) +
                 (ulong)(uVar2 & *(uint *)(this + 0x194)) * 8) = lVar7;
...
undefined8 __thiscall
WorkerThreadPool::_handle_runlevel(WorkerThreadPool *this,ThreadData *param_1,MutexLock *param_2)

{
  ...
  if (iVar1 == 2) {
    ...
    if ((((iVar1 == 1) && (((byte)param_1[0x18] & 4) == 0)) && (*(long *)(this + 600) == 0)) &&
       (*(long *)(this + 0x248) == 0)) {
...
/* WorkerThreadPool::notify_yield_over(long) */

void __thiscall WorkerThreadPool::notify_yield_over(WorkerThreadPool *this,long param_1)
      ...
      do {
        if (((uint)uVar17 == uVar18) && (*(long *)(*(long *)(lVar2 + lVar16 * 8) + 0x10) == param_1)
          ...
          if (uVar18 == 0xffffffff) {
            ...
            if (*(uint *)(this + 0x290) <= uVar18) {
              _err_print_index_error
                        ("operator[]","./core/templates/local_vector.h",0xb2,(ulong)uVar18,
                         (ulong)*(uint *)(this + 0x290),"p_index","count","",false,true);
              _err_flush_stdout();
                    /* WARNING: Does not return */
        ...
        uVar15 = SUB164(auVar5 * auVar9,8);
              ...
              auVar7._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                               (ulong)*(uint *)(this + 0x390) * 4) + uVar15) -
                                    SUB164(auVar6 * auVar10,8)) * lVar3, auVar11._8_8_ = 0,
              auVar11._0_8_ = uVar19, uVar20 <= SUB164(auVar7 * auVar11,8)));
    }
  }
  _err_print_error("notify_yield_over","core/object/worker_thread_pool.cpp",0x254,
                   "Method/function failed.","Invalid Task ID.",0,0);
LAB_00101b72:
  pthread_mutex_unlock((pthread_mutex_t *)(this + 0x268));
  return;
}
...
/* WorkerThreadPool::get_thread_index() const */

undefined4 __thiscall WorkerThreadPool::get_thread_index(WorkerThreadPool *this)
    ...
    if (uVar30 != 0) {
      ...
      do {
        if ((uVar28 == (uint)uVar24) && (lVar4 == *(long *)(*(long *)(lVar2 + lVar26 * 8) + 0x10)))
        {
          uVar28 = 0;
          do {
            if (((uint)uVar24 == uVar30) &&
               (lVar4 == *(long *)(*(long *)(lVar2 + lVar25 * 8) + 0x10))) {
            ...
            uVar22 = SUB164(auVar10 * auVar17,8);
                  ...
                  (auVar11._8_8_ = 0, auVar11._0_8_ = (ulong)uVar30 * lVar5, auVar18._8_8_ = 0,
                  auVar18._0_8_ = uVar29, auVar12._8_8_ = 0,
                  auVar12._0_8_ = (ulong)((uVar1 + uVar22) - SUB164(auVar11 * auVar18,8)) * lVar5,
                  auVar19._8_8_ = 0, auVar19._0_8_ = uVar29, uVar28 <= SUB164(auVar12 * auVar19,8)))
          ;
        ...
        uVar23 = SUB164(auVar7 * auVar14,8);
              ...
              auVar9._0_8_ = (ulong)((uVar1 + uVar23) - SUB164(auVar8 * auVar15,8)) * lVar5,
              auVar16._8_8_ = 0, auVar16._0_8_ = uVar29, uVar27 <= SUB164(auVar9 * auVar16,8)));
    }
  }
  return 0xffffffff;
}
...
/* WorkerThreadPool::get_caller_task_id() const */

undefined8 __thiscall WorkerThreadPool::get_caller_task_id(WorkerThreadPool *this)
...
/* WorkerThreadPool::_thread_enter_unlock_allowance_zone(std::unique_lock<std::mutex>&) */

long WorkerThreadPool::_thread_enter_unlock_allowance_zone(unique_lock *param_1)

{
  ...
  if (param_1 == (unique_lock *)*in_FS_OFFSET) {
    lVar1 = 0;
LAB_00101f82:
    *(int *)(in_FS_OFFSET + lVar1 * 2) = (int)in_FS_OFFSET[lVar1 * 2] + 1;
    return lVar1;
  }
  if ((unique_lock *)*in_FS_OFFSET == (unique_lock *)0x0) {
    ...
    if ((unique_lock *)*in_FS_OFFSET != (unique_lock *)0x0) {
      _err_print_error("_thread_enter_unlock_allowance_zone","core/object/worker_thread_pool.cpp",
                       0x2ec,"Method/function failed. Returning: (4294967295U)",
                       "No more unlockable lock slots available. Engine bug.",0,0);
      return 0xffffffff;
    }
    lVar1 = 1;
  }
...
/* WorkerThreadPool::thread_exit_unlock_allowance_zone(unsigned int) */

void WorkerThreadPool::thread_exit_unlock_allowance_zone(uint param_1)
...
/* WorkerThreadPool::exit_languages_threads() */

void __thiscall WorkerThreadPool::exit_languages_threads(WorkerThreadPool *this)
...
/* WorkerThreadPool::WorkerThreadPool(bool) */

void __thiscall WorkerThreadPool::WorkerThreadPool(WorkerThreadPool *this,bool param_1)
...
void __thiscall WorkerThreadPool::~WorkerThreadPool(WorkerThreadPool *this)

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_0010fc60;
  ...
  if (singleton == this) {
    ...
    for (puVar3 = (undefined8 *)named_pools._24_8_; puVar3 != (undefined8 *)0x0;
        puVar3 = (undefined8 *)*puVar3) {
          ...
          if (*(int *)(lVar6 + uVar5 * 4) != 0) {
            ...
            *(undefined8 *)
             (*(long *)(*(long *)(this + 0x3a0) +
                       (ulong)(uVar2 >> ((byte)*(undefined4 *)(this + 0x3b0) & 0x1f)) * 8) +
             (ulong)(uVar2 & *(uint *)(this + 0x3b4)) * 8) =
                 *(undefined8 *)((long)pvVar7 + uVar5 * 8);
      ...
      if (uVar8 != 0) {
        ...
        do {
          if (*(int *)(lVar6 + uVar5 * 4) != 0) {
            ...
            *(undefined8 *)
             (*(long *)(*(long *)(this + 0x310) +
                       (ulong)(uVar2 >> ((byte)*(undefined4 *)(this + 800) & 0x1f)) * 8) +
             (ulong)(uVar2 & *(uint *)(this + 0x324)) * 8) =
                 *(undefined8 *)((long)pvVar7 + uVar5 * 8);
    ...
    if (*(int *)(this + 0x290) != 0) {
      ...
      while( true ) {
        ...
        std::condition_variable::~condition_variable
                  ((condition_variable *)((long)pvVar7 + lVar6 + 0x30));
...
LAB_00102628:
  if (*(uint *)(this + 500) < (uint)(*(int *)(this + 0x200) * *(int *)(this + 0x1f0))) {
    if ((char)CoreGlobals::leak_reporting_enabled != '\0') {
      local_50 = 0;
...
/* WorkerThreadPool::_bind_methods() */

void WorkerThreadPool::_bind_methods(void)

{
  ...
  pMVar8 = create_method_bind<WorkerThreadPool,long,Callable_const&,int,int,bool,String_const&>
                     (add_group_task);
...
void __thiscall WorkerThreadPool::_process_task(WorkerThreadPool *this,Task *param_1)

{
  ...
  puVar15 = (uint *)HashMap<unsigned_long,int,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>,DefaultTypedAllocator<HashMapElement<unsigned_long,int>>>
                    ::operator[]((HashMap<unsigned_long,int,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>,DefaultTypedAllocator<HashMapElement<unsigned_long,int>>>
                                  *)(this + 0x2d8),(ulong *)&local_b8);
  uVar5 = *(uint *)(this + 0x290);
  uVar20 = *puVar15;
  if (uVar5 <= uVar20) {
LAB_00103e13:
    _err_print_index_error
              ("operator[]","./core/templates/local_vector.h",0xb2,(ulong)uVar20,(ulong)uVar5,
  ...
  if ((*(long *)(in_FS_OFFSET + lRam0000000000103878) == 0) ||
     (MessageQueue::thread_singleton(),
     MessageQueue::main_singleton == *(CallQueue **)(in_FS_OFFSET + lVar7))) {
  ...
  if (lVar19 != 0) {
      ...
      *puVar15 = *puVar15 + 1;
      ...
      if (*(code **)(param_1 + 0x20) == (code *)0x0) {
        if (*(long **)(param_1 + 0xd8) == (long *)0x0) {
          ...
          Callable::callp((Variant **)(param_1 + 8),(int)local_a8,(Variant *)0x1,
                          (CallError *)local_98);
    ...
    *piVar1 = *piVar1 + 1;
    ...
    if (*(int *)(lVar19 + 0x80) + 1 == iVar14 + 1) {
      ...
      *(long *)(*(long *)(*(long *)(this + 0x1e8) +
                         (ulong)(uVar20 >> ((byte)*(undefined4 *)(this + 0x1f8) & 0x1f)) * 8) +
               (ulong)(uVar20 & *(uint *)(this + 0x1fc)) * 8) = lVar19;
    ...
    if (iVar14 == 0) {
      ...
      if (iVar14 == 0) {
        ...
        *(Task **)(*(long *)(*(long *)(this + 0x180) +
                            (ulong)(uVar20 >> ((byte)*(undefined4 *)(this + 400) & 0x1f)) * 8) +
                  (ulong)(uVar20 & *(uint *)(this + 0x194)) * 8) = param_1;
...
void WorkerThreadPool::_thread_function(void *param_1)

{
  ...
  while( true ) {
    ...
    local_30 = '\x01';
    cVar5 = _handle_runlevel(*(WorkerThreadPool **)((long)param_1 + 0x60),(ThreadData *)param_1,
                             (MutexLock *)&local_38);
    if (cVar5 != '\0') break;
...
void __thiscall
WorkerThreadPool::_wait_collaboratively(WorkerThreadPool *this,ThreadData *param_1,Task *param_2)
...
LAB_001044b8:
      if (((byte)TVar1 & 1) != 0) {
        if (*(long *)(this + 600) == 0) {
          if ((*(char *)(*(long *)(param_1 + 0x20) + 0xd0) == '\0') ||
             (*(long *)(this + 0x248) == 0)) goto LAB_001044f8;
          uVar8 = 1;
          uVar9 = 0;
        }
...
LAB_001044f8:
    ...
    if (((*(char *)(*(long *)(param_1 + 0x20) + 0xd0) != '\0') && (*(long *)(this + 0x248) != 0)) &&
       (cVar6 = _try_promote_low_priority_task(this), cVar6 != '\0')) {
      _notify_threads(this,param_1,1,0);
    }
    if (*(long *)(*(long *)(param_1 + 0x60) + 600) == 0) {
LAB_001043c8:
      bVar12 = singleton == this;
...
void __thiscall WorkerThreadPool::yield(WorkerThreadPool *this)

{
  ...
  if (uVar2 == 0xffffffff) {
    _err_print_error("yield","core/object/worker_thread_pool.cpp",0x240,
                     "Condition \"th_index == -1\" is true.",
                     "This function can only be called from a worker thread.",0,0);
    return;
  }
  ...
  _wait_collaboratively
            (this,(ThreadData *)(*(long *)(this + 0x298) + (ulong)uVar2 * 0x68),(Task *)0x1);
...
/* WARNING: Removing unreachable block (ram,0x00104954) */
/* WorkerThreadPool::_post_tasks(WorkerThreadPool::Task**, unsigned int, bool,
   MutexLock<MutexImpl<std::mutex> >&) [clone .part.0] */

void WorkerThreadPool::_post_tasks(Task **param_1,uint param_2,bool param_3,MutexLock *param_4)
      ...
      if (uVar20 != 0) {
        ...
        do {
          if (((int)uVar24 == (int)uVar16) &&
             (uVar3 == *(ulong *)(*(long *)(local_78 + lVar19 * 8) + 0x10))) {
            local_48 = uVar3;
            puVar17 = (uint *)HashMap<unsigned_long,int,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>,DefaultTypedAllocator<HashMapElement<unsigned_long,int>>>
                              ::operator[]((HashMap<unsigned_long,int,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>,DefaultTypedAllocator<HashMapElement<unsigned_long,int>>>
                                            *)(param_1 + 0x5b),&local_48);
            uVar20 = *puVar17;
            if (*(uint *)(param_1 + 0x52) <= uVar20) {
              _err_print_index_error
                        ("operator[]","./core/templates/local_vector.h",0xb2,(ulong)uVar20,
                         (ulong)*(uint *)(param_1 + 0x52),"p_index","count","",false,true);
              _err_flush_stdout();
                    /* WARNING: Does not return */
          ...
          iVar18 = SUB164(auVar7 * auVar11,8);
                ...
                (auVar8._8_8_ = 0, auVar8._0_8_ = uVar16 * lVar4, auVar12._8_8_ = 0,
                auVar12._0_8_ = uVar22, auVar9._8_8_ = 0,
                auVar9._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                                 (ulong)*(uint *)(param_1 + 0x60) * 4) + iVar18) -
                                      SUB164(auVar8 * auVar12,8)) * lVar4, auVar13._8_8_ = 0,
                auVar13._0_8_ = uVar22, uVar20 <= SUB164(auVar9 * auVar13,8)));
      }
    }
...
/* WorkerThreadPool::_post_tasks(WorkerThreadPool::Task**, unsigned int, bool,
   MutexLock<MutexImpl<std::mutex> >&) */

void __thiscall
WorkerThreadPool::_post_tasks
          (WorkerThreadPool *this,Task **param_1,uint param_2,bool param_3,MutexLock *param_4)
...
/* WorkerThreadPool::_add_group_task(Callable const&, void (*)(void*, unsigned int), void*,
   WorkerThreadPool::BaseTemplateUserdata*, int, int, bool, String const&) */
...

{
  ...
  local_70 = param_1;
  if (param_5 < 0) {
    _err_print_error("_add_group_task","core/object/worker_thread_pool.cpp",0x266,
                     "Condition \"p_elements < 0\" is true. Returning: INVALID_TASK_ID",0,0);
...
LAB_00105040:
    ...
    local_50 = '\x01';
    pGVar3 = PagedAllocator<WorkerThreadPool::Group,false,256u>::alloc<>
                       ((PagedAllocator<WorkerThreadPool::Group,false,256u> *)(this + 0x1e0));
    ...
    *(undefined8 *)(puVar10 + -8) = 0x104edb;
    local_70 = pCVar12;
    puVar5 = (undefined8 *)
             HashMap<long,WorkerThreadPool::Group*,HashMapHasherDefault,HashMapComparatorDefault<long>,PagedAllocator<HashMapElement<long,WorkerThreadPool::Group*>,false,256u>>
             ::operator[]((HashMap<long,WorkerThreadPool::Group*,HashMapHasherDefault,HashMapComparatorDefault<long>,PagedAllocator<HashMapElement<long,WorkerThreadPool::Group*>,false,256u>>
                           *)(this + 0x398),(long *)&local_60);
    *puVar5 = pGVar3;
...
WorkerThreadPool::add_native_group_task
          (WorkerThreadPool *this,_func_void_void_ptr_uint *param_1,void *param_2,int param_3,
          int param_4,bool param_5,String *param_6)

{
  ...
  local_38 = 0;
  local_30 = 0;
  uVar1 = _add_group_task(this,(Callable *)&local_38,param_1,param_2,(BaseTemplateUserdata *)0x0,
...
/* WorkerThreadPool::add_group_task(Callable const&, int, int, bool, String const&) */

void __thiscall
WorkerThreadPool::add_group_task
          (WorkerThreadPool *this,Callable *param_1,int param_2,int param_3,bool param_4,
          String *param_5)

{
  _add_group_task(this,param_1,(_func_void_void_ptr_uint *)0x0,(void *)0x0,
                  (BaseTemplateUserdata *)0x0,param_2,param_3,param_4,param_5);
  return;
}
...
/* WorkerThreadPool::_add_task(Callable const&, void (*)(void*), void*,
   WorkerThreadPool::BaseTemplateUserdata*, bool, String const&) */

long __thiscall
WorkerThreadPool::_add_task
          (WorkerThreadPool *this,Callable *param_1,_func_void_void_ptr *param_2,void *param_3,
          BaseTemplateUserdata *param_4,bool param_5,String *param_6)
...
LAB_00105296:
  ...
  local_50 = '\x01';
  pTVar3 = PagedAllocator<WorkerThreadPool::Task,false,1024u>::alloc<>
                     ((PagedAllocator<WorkerThreadPool::Task,false,1024u> *)(this + 0x178));
  ...
  *(BaseTemplateUserdata **)(pTVar3 + 0xd8) = param_4;
  HashMap<long,WorkerThreadPool::Task*,HashMapHasherDefault,HashMapComparatorDefault<long>,PagedAllocator<HashMapElement<long,WorkerThreadPool::Task*>,false,1024u>>
  ::insert(&local_60,(Task **)(this + 0x308),SUB81(&local_68,0));
  if (*(int *)(this + 0x290) == 0) {
    if (local_50 == '\0') {
LAB_001052a2:
                    /* WARNING: Subroutine does not return */
...
/* WorkerThreadPool::add_native_task(void (*)(void*), void*, bool, String const&) */

undefined8 __thiscall
WorkerThreadPool::add_native_task
          (WorkerThreadPool *this,_func_void_void_ptr *param_1,void *param_2,bool param_3,
          String *param_4)

{
  ...
  local_38 = 0;
  local_30 = 0;
  uVar1 = _add_task(this,(Callable *)&local_38,param_1,param_2,(BaseTemplateUserdata *)0x0,param_3,
                    param_4);
  Callable::~Callable((Callable *)&local_38);
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
    return uVar1;
...
/* WorkerThreadPool::add_task(Callable const&, bool, String const&) */

void __thiscall
WorkerThreadPool::add_task(WorkerThreadPool *this,Callable *param_1,bool param_2,String *param_3)

{
  _add_task(this,param_1,(_func_void_void_ptr *)0x0,(void *)0x0,(BaseTemplateUserdata *)0x0,param_2,
            param_3);
  return;
}
...
/* WorkerThreadPool::wait_for_task_completion(long) */

undefined8 __thiscall
WorkerThreadPool::wait_for_task_completion(WorkerThreadPool *this,long param_1)
    ...
    if (uVar27 != 0) {
      ...
      do {
        if (((int)uVar20 == (int)uVar25) &&
           (local_60 == *(long *)(*(long *)(lVar3 + lVar24 * 8) + 0x10))) {
          ...
          if (((byte)pTVar5[0x98] & 1) == 0) {
            ...
            cVar18 = HashMap<unsigned_long,int,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>,DefaultTypedAllocator<HashMapElement<unsigned_long,int>>>
                     ::_lookup_pos((HashMap<unsigned_long,int,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>,DefaultTypedAllocator<HashMapElement<unsigned_long,int>>>
                                    *)(this + 0x2d8),(ulong *)&ppVar6->__align,(uint *)&local_58);
            if (cVar18 != '\0') {
              if (_GLOBAL_OFFSET_TABLE_ != (undefined *)0x0) {
                    /* WARNING: Subroutine does not return */
                Thread::caller_id();
              ...
              local_58 = ppVar6;
              puVar21 = (uint *)HashMap<unsigned_long,int,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>,DefaultTypedAllocator<HashMapElement<unsigned_long,int>>>
                                ::operator[]((HashMap<unsigned_long,int,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>,DefaultTypedAllocator<HashMapElement<unsigned_long,int>>>
                                              *)(this + 0x2d8),(ulong *)&local_58);
              uVar27 = *puVar21;
              if (*(uint *)(this + 0x290) <= uVar27) {
                _err_print_index_error
                          ("operator[]","./core/templates/local_vector.h",0xb2,(ulong)uVar27,
                           (ulong)*(uint *)(this + 0x290),"p_index","count","",false,true);
                _err_flush_stdout();
                    /* WARNING: Does not return */
...
LAB_001056c0:
          if (*(long *)(pTVar5 + 200) != 0) goto LAB_001055f0;
          HashMap<long,WorkerThreadPool::Task*,HashMapHasherDefault,HashMapComparatorDefault<long>,PagedAllocator<HashMapElement<long,WorkerThreadPool::Task*>,false,1024u>>
          ::erase((HashMap<long,WorkerThreadPool::Task*,HashMapHasherDefault,HashMapComparatorDefault<long>,PagedAllocator<HashMapElement<long,WorkerThreadPool::Task*>,false,1024u>>
                   *)(this + 0x308),&local_60);
          ...
          *(Task **)(*(long *)(*(long *)(this + 0x180) +
                              (ulong)(uVar27 >> ((byte)*(undefined4 *)(this + 400) & 0x1f)) * 8) +
                    (ulong)(uVar27 & *(uint *)(this + 0x194)) * 8) = pTVar5;
        ...
        auVar12._8_8_ = 0;
        auVar12._0_8_ =
             (ulong)((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x390) * 4) +
                     uVar23) - SUB164(auVar11 * auVar15,8)) * lVar4;
        auVar16._8_8_ = 0;
  ...
  pthread_mutex_unlock(__mutex);
  _err_print_error("wait_for_task_completion","core/object/worker_thread_pool.cpp",0x173,
                   "Method/function failed. Returning: ERR_INVALID_PARAMETER","Invalid Task ID",0,0)
  ;
  uVar22 = 0x1f;
  goto LAB_001055fc;
LAB_00105570:
...
LAB_001058c1:
  ...
  *(int *)(pTVar5 + 0xcc) = *(int *)(pTVar5 + 0xcc) + -1;
  if (*(long *)(pTVar5 + 200) == 0) {
    ...
    ::erase((HashMap<long,WorkerThreadPool::Task*,HashMapHasherDefault,HashMapComparatorDefault<long>,PagedAllocator<HashMapElement<long,WorkerThreadPool::Task*>,false,1024u>>
             *)(this + 0x308),&local_60);
    PagedAllocator<WorkerThreadPool::Task,false,1024u>::free
              ((PagedAllocator<WorkerThreadPool::Task,false,1024u> *)(this + 0x178),pTVar5);
  }
LAB_001055f0:
  pthread_mutex_unlock(__mutex);
  uVar22 = 0;
...
/* WorkerThreadPool::init(int, float) */

void __thiscall WorkerThreadPool::init(WorkerThreadPool *this,int param_1,float param_2)

{
  ...
  if (*(int *)(this + 0x290) != 0) {
    if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
      _err_print_error(&_LC79,"core/object/worker_thread_pool.cpp",0x2f9,
                       "Condition \"threads.size() > 0\" is true.",0,0);
      return;
    }
    goto LAB_00105d6d;
  }
...
LAB_00105be8:
        _err_print_index_error
                  ("operator[]","./core/templates/local_vector.h",0xb2,uVar9 & 0xffffffff,
                   (ulong)uVar11,"p_index","count","",false,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
        pcVar1 = (code *)invalidInstructionException();
        (*pcVar1)();
      ...
      *(WorkerThreadPool **)(pSVar5 + 0x60) = this;
      ...
      HashMap<unsigned_long,int,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>,DefaultTypedAllocator<HashMapElement<unsigned_long,int>>>
      ::insert((ulong *)&local_68,(int *)(this + 0x2d8),SUB81(&local_70,0));
...
/* WorkerThreadPool::get_named_pool(StringName const&) */

WorkerThreadPool * WorkerThreadPool::get_named_pool(StringName *param_1)

{
  ...
  if ((named_pools._8_8_ != 0) && (named_pools._44_4_ != 0)) {
    ...
    if (uVar15 != 0) {
      ...
      do {
        if ((uVar11 == uVar15) &&
           (*(long *)(*(long *)(named_pools._8_8_ + lVar14 * 8) + 0x10) == *(long *)param_1)) {
  ...
  init(this,-1,_LC85);
  puVar12 = (undefined8 *)
            HashMap<StringName,WorkerThreadPool*,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,WorkerThreadPool*>>>
            ::operator[]((HashMap<StringName,WorkerThreadPool*,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,WorkerThreadPool*>>>
                          *)named_pools,param_1);
  *puVar12 = this;
  return this;
}
...
/* OS::get_default_thread_pool_size() const */

void __thiscall OS::get_default_thread_pool_size(OS *this)
...
/* WorkerThreadPool::is_class_ptr(void*) const */

uint __thiscall WorkerThreadPool::is_class_ptr(WorkerThreadPool *this,void *param_1)
...
/* WorkerThreadPool::_getv(StringName const&, Variant&) const */

undefined8 WorkerThreadPool::_getv(StringName *param_1,Variant *param_2)
...
/* WorkerThreadPool::_setv(StringName const&, Variant const&) */

undefined8 WorkerThreadPool::_setv(StringName *param_1,Variant *param_2)
...
/* WorkerThreadPool::_validate_propertyv(PropertyInfo&) const */

void WorkerThreadPool::_validate_propertyv(PropertyInfo *param_1)
...
/* WorkerThreadPool::_property_can_revertv(StringName const&) const */

undefined8 WorkerThreadPool::_property_can_revertv(StringName *param_1)
...
/* WorkerThreadPool::_property_get_revertv(StringName const&, Variant&) const */

undefined8 WorkerThreadPool::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* WorkerThreadPool::_notificationv(int, bool) */

void WorkerThreadPool::_notificationv(int param_1,bool param_2)
...
/* WorkerThreadPool::BaseTemplateUserdata::~BaseTemplateUserdata() */

void __thiscall
WorkerThreadPool::BaseTemplateUserdata::~BaseTemplateUserdata(BaseTemplateUserdata *this)
...
/* MethodBindTRC<unsigned int, long>::_gen_argument_type(int) const */

undefined8 MethodBindTRC<unsigned_int,long>::_gen_argument_type(int param_1)
...
/* MethodBindTRC<unsigned int, long>::get_argument_meta(int) const */

long __thiscall
MethodBindTRC<unsigned_int,long>::get_argument_meta
          (MethodBindTRC<unsigned_int,long> *this,int param_1)
...
byte __thiscall
MethodBindTR<long,Callable_const&,int,int,bool,String_const&>::get_argument_meta
          (MethodBindTR<long,Callable_const&,int,int,bool,String_const&> *this,int param_1)
...
/* MethodBindTR<Error, long>::_gen_argument_type(int) const */

undefined8 MethodBindTR<Error,long>::_gen_argument_type(int param_1)
...
/* MethodBindTR<Error, long>::get_argument_meta(int) const */

long __thiscall
MethodBindTR<Error,long>::get_argument_meta(MethodBindTR<Error,long> *this,int param_1)
...
/* MethodBindTR<long, Callable const&, bool, String const&>::_gen_argument_type(int) const */

char __thiscall
MethodBindTR<long,Callable_const&,bool,String_const&>::_gen_argument_type
          (MethodBindTR<long,Callable_const&,bool,String_const&> *this,int param_1)

{
  char cVar1;
  
  cVar1 = '\x02';
  if (((uint)param_1 < 3) && (cVar1 = '\x19', param_1 != 0)) {
...
/* MethodBindTR<long, Callable const&, bool, String const&>::get_argument_meta(int) const */

int __thiscall
MethodBindTR<long,Callable_const&,bool,String_const&>::get_argument_meta
          (MethodBindTR<long,Callable_const&,bool,String_const&> *this,int param_1)
...
char __thiscall
MethodBindTR<long,Callable_const&,int,int,bool,String_const&>::_gen_argument_type
          (MethodBindTR<long,Callable_const&,int,int,bool,String_const&> *this,int param_1)

{
  ...
  cVar1 = '\x02';
  if ((((uint)param_1 < 5) && (cVar1 = '\x19', param_1 != 0)) && (cVar1 = '\x02', 1 < param_1 - 1U))
  {
...
/* MethodBindTR<long, Callable const&, bool, String const&>::~MethodBindTR() */

void __thiscall
MethodBindTR<long,Callable_const&,bool,String_const&>::~MethodBindTR
          (MethodBindTR<long,Callable_const&,bool,String_const&> *this)
...
/* MethodBindTR<Error, long>::~MethodBindTR() */

void __thiscall MethodBindTR<Error,long>::~MethodBindTR(MethodBindTR<Error,long> *this)
...
/* MethodBindTR<long, Callable const&, int, int, bool, String const&>::~MethodBindTR() */

void __thiscall
MethodBindTR<long,Callable_const&,int,int,bool,String_const&>::~MethodBindTR
          (MethodBindTR<long,Callable_const&,int,int,bool,String_const&> *this)
...
/* MethodBindTRC<unsigned int, long>::~MethodBindTRC() */

void __thiscall
MethodBindTRC<unsigned_int,long>::~MethodBindTRC(MethodBindTRC<unsigned_int,long> *this)
...
/* HashMap<StringName, WorkerThreadPool*, HashMapHasherDefault,
   ...
   WorkerThreadPool*> > >::~HashMap() */

void __thiscall
HashMap<StringName,WorkerThreadPool*,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,WorkerThreadPool*>>>
::~HashMap(HashMap<StringName,WorkerThreadPool*,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,WorkerThreadPool*>>>
           *this)
...
/* WorkerThreadPool::_get_class_namev() const */

undefined8 * WorkerThreadPool::_get_class_namev(void)
...
LAB_00106503:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"WorkerThreadPool");
      goto LAB_0010656e;
    }
  }
  StringName::assign_static_unique_class_name
...
/* WorkerThreadPool::get_class() const */

void WorkerThreadPool::get_class(void)
...
/* WorkerThreadPool::is_class(String const&) const */

undefined8 __thiscall WorkerThreadPool::is_class(WorkerThreadPool *this,String *param_1)
...
/* WorkerThreadPool::Task* PagedAllocator<WorkerThreadPool::Task, false, 1024u>::alloc<>() */
...

{
  ...
  *(uint *)(this + 0x14) = uVar4;
  pTVar1 = *(Task **)(plVar11[uVar4 >> ((byte)*(undefined4 *)(this + 0x18) & 0x1f)] +
  ...
  *(undefined1 (*) [16])(pTVar1 + 0x18) = (undefined1  [16])0x0;
  *(undefined1 (*) [16])(pTVar1 + 0x28) = (undefined1  [16])0x0;
  *(undefined1 (*) [16])(pTVar1 + 0x38) = (undefined1  [16])0x0;
  *(undefined1 (*) [16])(pTVar1 + 0x48) = (undefined1  [16])0x0;
...
/* HashMap<long, WorkerThreadPool::Task*, HashMapHasherDefault, HashMapComparatorDefault<long>,
   ...
   const&, WorkerThreadPool::Task* const&, bool) */

void HashMap<long,WorkerThreadPool::Task*,HashMapHasherDefault,HashMapComparatorDefault<long>,PagedAllocator<HashMapElement<long,WorkerThreadPool::Task*>,false,1024u>>
     ::insert(long *param_1,Task **param_2,bool param_3)
...
LAB_0010730d:
      ...
      if (uVar42 != 0) {
        do {
          if ((uVar42 == (uint)uVar45) &&
             (lVar40 == *(long *)(*(long *)(local_80 + lVar38 * 8) + 0x10))) {
          ...
          uVar31 = SUB164(auVar5 * auVar17,8);
                ...
                (auVar6._8_8_ = 0, auVar6._0_8_ = (ulong)uVar42 * lVar39, auVar18._8_8_ = 0,
                auVar18._0_8_ = uVar41, auVar7._8_8_ = 0,
                auVar7._0_8_ = (ulong)((*(uint *)(hash_table_size_primes +
                                                 (ulong)*(uint *)(param_2 + 0x11) * 4) + uVar31) -
                                      SUB164(auVar6 * auVar18,8)) * lVar39, auVar19._8_8_ = 0,
  ...
  *(uint *)((long)param_2 + 0x14) = uVar30;
  pTVar35 = *(Task **)(*(long *)(pTVar35 +
                                (ulong)(uVar30 >> ((byte)*(undefined4 *)(param_2 + 3) & 0x1f)) * 8)
                      + (ulong)(uVar30 & *(uint *)((long)param_2 + 0x1c)) * 8);
  ...
  *(int *)((long)param_2 + 0x8c) = *(int *)((long)param_2 + 0x8c) + 1;
LAB_001077ec:
  *param_1 = (long)pTVar35;
  return;
}



/* WorkerThreadPool::Group* PagedAllocator<WorkerThreadPool::Group, false, 256u>::alloc<>() */
...

{
  ...
  *(uint *)(this + 0x14) = uVar3;
  pGVar1 = *(Group **)
            (plVar11[uVar3 >> ((byte)*(undefined4 *)(this + 0x18) & 0x1f)] +
            (ulong)(uVar3 & *(uint *)(this + 0x1c)) * 8);
  pGVar12 = pGVar1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* HashMap<long, WorkerThreadPool::Group*, HashMapHasherDefault, HashMapComparatorDefault<long>,
  ...
  if (local_70 == (void *)0x0) {
    ...
    *(void **)(this + 0x68) = local_70;
    if (uVar38 == 0) {
      ...
      if ((pvVar3 < (void *)((long)local_70 + uVar40)) &&
         (local_70 < (void *)((long)pvVar3 + uVar41))) {
        uVar41 = 0;
        do {
    ...
    if (iVar39 != 0) {
      ...
      if (uVar43 != 0) {
        ...
        lVar45 = lVar44;
        do {
          if (((uint)uVar55 == uVar43) &&
             (lVar57 == *(long *)(*(long *)((long)local_70 + lVar44 * 8) + 0x10))) {
          ...
          uVar54 = SUB164(auVar5 * auVar21,8);
                ...
                auVar7._0_8_ = (ulong)((uVar54 + uVar38) - SUB164(auVar6 * auVar22,8)) * lVar46,
                auVar23._8_8_ = 0, auVar23._0_8_ = uVar56, lVar45 = SUB168(auVar7 * auVar23,8),
                uVar51 <= SUB164(auVar7 * auVar23,8)));
      }
LAB_001080d3:
      uVar52 = CONCAT44(0,*(uint *)(hash_table_size_primes + uVar41 * 4));
      lVar46 = *(long *)(hash_table_size_primes_inv + uVar41 * 8);
      uVar40 = lVar57 * 0x3ffff - 1;
      uVar40 = (uVar40 ^ uVar40 >> 0x1f) * 0x15;
      uVar40 = (uVar40 ^ uVar40 >> 0xb) * 0x41;
      ...
      if (uVar38 != 0) {
        ...
        lVar45 = lVar44;
        do {
          if (((uint)uVar55 == uVar38) &&
             (*(long *)(*(long *)((long)local_70 + lVar44 * 8) + 0x10) == lVar57)) {
          ...
          uVar43 = SUB164(auVar17 * auVar33,8);
                ...
                (auVar18._8_8_ = 0, auVar18._0_8_ = (ulong)uVar38 * lVar46, auVar34._8_8_ = 0,
                auVar34._0_8_ = uVar52, auVar19._8_8_ = 0,
                auVar19._0_8_ =
                     (ulong)((*(uint *)(hash_table_size_primes + uVar41 * 4) + uVar43) -
                            SUB164(auVar18 * auVar34,8)) * lVar46, auVar35._8_8_ = 0,
                auVar35._0_8_ = uVar52, lVar45 = SUB168(auVar19 * auVar35,8),
                uVar54 <= SUB164(auVar19 * auVar35,8)));
      }
    }
  }
LAB_00107cf3:
  if ((float)uVar56 * __LC43 < (float)(iVar39 + 1)) {
  ...
  uVar38 = iVar39 - 1;
  *(uint *)(this + 0x14) = uVar38;
  pauVar48 = *(undefined1 (**) [16])
              (plVar49[uVar38 >> ((byte)*(undefined4 *)(this + 0x18) & 0x1f)] +
              (ulong)(uVar38 & *(uint *)(this + 0x1c)) * 8);
  *pauVar48 = (undefined1  [16])0x0;
  puVar2 = *(undefined8 **)(this + 0x80);
  *(long *)pauVar48[1] = lVar57;
  *(undefined8 *)(pauVar48[1] + 8) = 0;
  if (puVar2 == (undefined8 *)0x0) {
  ...
  lVar57 = *(long *)(this + 0x70);
  *(undefined1 (**) [16])(this + 0x80) = pauVar48;
  ...
  lVar53 = *(long *)(hash_table_size_primes_inv + (ulong)*(uint *)(this + 0x88) * 8);
  uVar54 = (uint)uVar56;
  uVar38 = *(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0x88) * 4);
  uVar41 = CONCAT44(0,uVar38);
  auVar12._8_8_ = 0;
  auVar12._0_8_ = uVar56 * lVar53;
  auVar28._8_8_ = 0;
  auVar28._0_8_ = uVar41;
  lStack_90 = SUB168(auVar12 * auVar28,8);
  lVar46 = *(long *)(this + 0x68);
...
/* HashMap<StringName, WorkerThreadPool*, HashMapHasherDefault,
   HashMapComparatorDefault<StringName>, DefaultTypedAllocator<HashMapElement<StringName,
   WorkerThreadPool*> > >::operator[](StringName const&) */
...
LAB_00108553:
    if ((float)uVar40 * __LC43 < (float)(iVar46 + 1)) goto LAB_00108579;
  }
...
/* PagedAllocator<WorkerThreadPool::Task, false, 1024u>::free(WorkerThreadPool::Task*) */

void __thiscall
PagedAllocator<WorkerThreadPool::Task,false,1024u>::free
          (PagedAllocator<WorkerThreadPool::Task,false,1024u> *this,Task *param_1)
...
/* WARNING: Removing unreachable block (ram,0x00108ed0) */
/* String vformat<int, unsigned int>(String const&, int const, unsigned int const) */

String * vformat<int,unsigned_int>(String *param_1,int param_2,uint param_3)
...
/* WorkerThreadPool::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void WorkerThreadPool::_get_property_listv(List *param_1,bool param_2)
...
/* MethodBindTR<Error, long>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTR<Error,long>::_gen_argument_type_info(int param_1)
...
/* MethodBindTRC<unsigned int, long>::_gen_argument_type_info(int) const */

undefined4 * MethodBindTRC<unsigned_int,long>::_gen_argument_type_info(int param_1)
...
/* MethodBind* create_method_bind<WorkerThreadPool, long, Callable const&, bool, String const&>(long
   (WorkerThreadPool::*)(Callable const&, bool, String const&)) */

MethodBind *
create_method_bind<WorkerThreadPool,long,Callable_const&,bool,String_const&>
          (_func_long_Callable_ptr_bool_String_ptr *param_1)
...
MethodBind * create_method_bind<WorkerThreadPool,bool,long>(_func_bool_long *param_1)
...
/* MethodBind* create_method_bind<WorkerThreadPool, long, Callable const&, int, int, bool, String
   const&>(long (WorkerThreadPool::*)(Callable const&, int, int, bool, String const&)) */

MethodBind *
create_method_bind<WorkerThreadPool,long,Callable_const&,int,int,bool,String_const&>
          (_func_long_Callable_ptr_int_int_bool_String_ptr *param_1)
...
/* MethodBind* create_method_bind<WorkerThreadPool, unsigned int, long>(unsigned int
   (WorkerThreadPool::*)(long) const) */

MethodBind * create_method_bind<WorkerThreadPool,unsigned_int,long>(_func_uint_long *param_1)
...
/* MethodBind* create_method_bind<WorkerThreadPool, long>(void (WorkerThreadPool::*)(long)) */

MethodBind * create_method_bind<WorkerThreadPool,long>(_func_void_long *param_1)
...
/* WorkerThreadPool::_bind_methods() [clone .cold] */
...
/* WorkerThreadPool::_initialize_classv() */

void WorkerThreadPool::_initialize_classv(void)
...
/* HashMap<unsigned long, int, HashMapHasherDefault, HashMapComparatorDefault<unsigned long>,
   DefaultTypedAllocator<HashMapElement<unsigned long, int> > >::_resize_and_rehash(unsigned int) */
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* HashMap<unsigned long, int, HashMapHasherDefault, HashMapComparatorDefault<unsigned long>,
   DefaultTypedAllocator<HashMapElement<unsigned long, int> > >::operator[](unsigned long const&) */
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  local_48 = 0;
  cVar17 = _lookup_pos(this,puVar26,&local_48);
  if (cVar17 == '\0') {
...
void HashMap<unsigned_long,int,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>,DefaultTypedAllocator<HashMapElement<unsigned_long,int>>>
     ::insert(ulong *param_1,int *param_2,bool param_3)
...
LAB_0010b2e1:
  ...
  if ((float)uVar2 * __LC43 < (float)(iVar27 + 1)) {
    ...
    _resize_and_rehash((HashMap<unsigned_long,int,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>,DefaultTypedAllocator<HashMapElement<unsigned_long,int>>>
...
LAB_0010b5a8:
  *param_1 = (ulong)pauVar25;
  return;
}



/* WARNING: Removing unreachable block (ram,0x0010b7f8) */
...
/* MethodBindTRC<unsigned int, long>::validated_call(Object*, Variant const**, Variant*) const */

void __thiscall
MethodBindTRC<unsigned_int,long>::validated_call
          (MethodBindTRC<unsigned_int,long> *this,Object *param_1,Variant **param_2,Variant *param_3
          )
...
/* MethodBindTRC<unsigned int, long>::ptrcall(Object*, void const**, void*) const */

void __thiscall
MethodBindTRC<unsigned_int,long>::ptrcall
          (MethodBindTRC<unsigned_int,long> *this,Object *param_1,void **param_2,void *param_3)
...
void __thiscall
MethodBindTR<long,Callable_const&,int,int,bool,String_const&>::validated_call
          (MethodBindTR<long,Callable_const&,int,int,bool,String_const&> *this,Object *param_1,
...

{
  ...
  uVar2 = (*pcVar1)(param_1 + *(long *)(this + 0x60),*param_2 + 8,*(undefined4 *)(param_2[1] + 8),
                    *(undefined4 *)(param_2[2] + 8),param_2[3][8],param_2[4] + 8);
...
void __thiscall
MethodBindTR<long,Callable_const&,int,int,bool,String_const&>::ptrcall
          (MethodBindTR<long,Callable_const&,int,int,bool,String_const&> *this,Object *param_1,
...

{
  ...
  if (((ulong)pcVar1 & 1) != 0) {
    pcVar1 = *(code **)(pcVar1 + *(long *)(param_1 + *(long *)(this + 0x60)) + -1);
                    ...
                    /* WARNING: Load size is inaccurate */
                    /* WARNING: Load size is inaccurate */
  uVar2 = (*pcVar1)(param_1 + *(long *)(this + 0x60),*param_2,*param_2[1],*param_2[2],
                    *param_2[3] != '\0',param_2[4]);
...
/* MethodBindTR<Error, long>::validated_call(Object*, Variant const**, Variant*) const */

void __thiscall
MethodBindTR<Error,long>::validated_call
          (MethodBindTR<Error,long> *this,Object *param_1,Variant **param_2,Variant *param_3)
...
/* MethodBindTR<Error, long>::ptrcall(Object*, void const**, void*) const */

void __thiscall
MethodBindTR<Error,long>::ptrcall
          (MethodBindTR<Error,long> *this,Object *param_1,void **param_2,void *param_3)
...
void __thiscall
MethodBindTR<long,Callable_const&,bool,String_const&>::validated_call
          (MethodBindTR<long,Callable_const&,bool,String_const&> *this,Object *param_1,
          Variant **param_2,Variant *param_3)
...
void __thiscall
MethodBindTR<long,Callable_const&,bool,String_const&>::ptrcall
          (MethodBindTR<long,Callable_const&,bool,String_const&> *this,Object *param_1,
          void **param_2,void *param_3)
...
/* MethodBindTR<Error, long>::call(Object*, Variant const**, int, Callable::CallError&) const */

Object * MethodBindTR<Error,long>::call
...
Object * MethodBindTRC<unsigned_int,long>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
Object * MethodBindTR<long,Callable_const&,bool,String_const&>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
  ...
  if (in_R8D < 4) {
    ...
    if ((int)(3 - in_R8D) <= iVar12) {
      ...
      *in_R9 = 0;
      ...
      lVar9 = (*(code *)pVVar15)((Variant *)((long)plVar13 + (long)pVVar1),(Variant *)&local_88,
...
Object * MethodBindTR<long,Callable_const&,int,int,bool,String_const&>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
  ...
  if (in_R8D < 6) {
    ...
    if ((int)(5 - in_R8D) <= iVar7) {
      ...
      do {
        if ((int)lVar10 < (int)in_R8D) {
          ...
          if (lVar11 <= (int)uVar13) {
            _err_print_index_error
                      ("get","./core/templates/cowdata.h",0xdb,(long)(int)uVar13,lVar11,"p_index",
                       "size()","",false,true);
            _err_flush_stdout();
                    /* WARNING: Does not return */
            pcVar3 = (code *)invalidInstructionException();
      ...
      *in_R9 = 0;
      ...
      lVar11 = (*(code *)local_c0)((Variant *)((long)plVar14 + (long)pVVar1),(Variant *)&local_98,
                                   iVar8,iVar7,bVar6,(Variant *)&local_a0);
...
/* MethodBindTR<long, Callable const&, bool, String const&>::_gen_argument_type_info(int) const */

undefined4 *
MethodBindTR<long,Callable_const&,bool,String_const&>::_gen_argument_type_info(int param_1)
...
undefined4 *
MethodBindTR<long,Callable_const&,int,int,bool,String_const&>::_gen_argument_type_info(int param_1)
...
/* WorkerThreadPool::ThreadData::YIELDING */

void WorkerThreadPool::ThreadData::_GLOBAL__sub_I_YIELDING(void)

{
  named_pools._40_8_ = 2;
  named_pools._8_16_ = (undefined1  [16])0x0;
  named_pools._24_16_ = (undefined1  [16])0x0;
  __cxa_atexit(HashMap<StringName,WorkerThreadPool*,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,WorkerThreadPool*>>>
               ::~HashMap,named_pools,&__dso_handle);
  return;
}

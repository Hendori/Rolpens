...

{
  ...
  if (lVar19 < 1) {
    ...
    for (puVar14 = (undefined8 *)((long)local_1398 + 4);
        puVar14 != (undefined8 *)((long)local_1398 + lVar19 * 4); puVar14 = puVar14 + 1) {
LAB_001013e8:
    ...
    for (puVar14 = (undefined8 *)((long)local_1288 + 4);
        (undefined8 *)((long)local_1288 + lVar19 * 4) != puVar14; puVar14 = puVar14 + 1) {
LAB_00101430:
      *(undefined4 *)puVar14 = 0xffffff38;
      *(undefined4 *)((long)puVar14 + 4) = 0xffffff38;
    }
...
LAB_00101a40:
            ...
            if (fVar35 <= *pfVar23 + *(float *)(lVar8 + 0x458)) {
              if (((float)iVar21 <= fVar2 + (float)(int)uVar39) &&
                 ((float)(int)uVar39 - fVar3 <= (float)iVar21)) goto LAB_001017ae;
LAB_0010189b:
...
LAB_001017ae:
              ...
              do {
                ...
                if ((fVar35 <= pfVar23[(long)puVar20 + 1] + *(float *)(lVar8 + 0x458)) &&
                  ...
                  if ((fVar2 + (float)(int)uVar29 < (float)iVar22) ||
                     ((float)iVar22 < (float)(int)uVar29 - fVar3)) goto LAB_0010189b;
                }
            ...
            if ((((fVar2 * fVar2) / fVar35 <= fVar4) && ((fVar3 * fVar3) / fVar35 <= fVar4)) &&
               ...
               fVar4 < (float)(iVar21 / iVar18))) goto LAB_0010189b;
LAB_00101c09:

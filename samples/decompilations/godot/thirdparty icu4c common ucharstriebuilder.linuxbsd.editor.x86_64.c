...
/* icu_76_godot::UCharsTrieBuilder::getElementValue(int) const */

undefined4 __thiscall
icu_76_godot::UCharsTrieBuilder::getElementValue(UCharsTrieBuilder *this,int param_1)
...
/* icu_76_godot::UCharsTrieBuilder::~UCharsTrieBuilder() */

void __thiscall icu_76_godot::UCharsTrieBuilder::~UCharsTrieBuilder(UCharsTrieBuilder *this)
...
bool __thiscall
icu_76_godot::UCharsTrieBuilder::UCTLinearMatchNode::operator==
          (UCTLinearMatchNode *this,Node *param_1)

{
  ...
  cVar1 = icu_76_godot::StringTrieBuilder::LinearMatchNode::operator==
                    ((LinearMatchNode *)this,param_1);
  if (cVar1 == '\0') {
    return false;
  }
  iVar2 = u_memcmp_76_godot(*(undefined8 *)(this + 0x28),*(undefined8 *)(param_1 + 0x28),
...
/* icu_76_godot::UCharsTrieElement::setTo(icu_76_godot::UnicodeString const&, int,
   icu_76_godot::UnicodeString&, UErrorCode&) [clone .part.0] */

void __thiscall
icu_76_godot::UCharsTrieElement::setTo
          (UCharsTrieElement *this,UnicodeString *param_1,int param_2,UnicodeString *param_3,
          UErrorCode *param_4)
...
/* icu_76_godot::UCharsTrieBuilder::indexOfElementWithNextUnit(int, int, char16_t) const */

void __thiscall
icu_76_godot::UCharsTrieBuilder::indexOfElementWithNextUnit
          (UCharsTrieBuilder *this,int param_1,int param_2,wchar16 param_3)
...
/* icu_76_godot::UCharsTrieBuilder::skipElementsBySomeUnits(int, int, int) const */

ulong __thiscall
icu_76_godot::UCharsTrieBuilder::skipElementsBySomeUnits
          (UCharsTrieBuilder *this,int param_1,int param_2,int param_3)
...
/* icu_76_godot::UCharsTrieBuilder::countElementUnits(int, int, int) const */

int __thiscall
icu_76_godot::UCharsTrieBuilder::countElementUnits
          (UCharsTrieBuilder *this,int param_1,int param_2,int param_3)
...
/* icu_76_godot::UCharsTrieBuilder::getElementStringLength(int) const */

undefined2 __thiscall
icu_76_godot::UCharsTrieBuilder::getElementStringLength(UCharsTrieBuilder *this,int param_1)
...
/* icu_76_godot::UCharsTrieBuilder::getElementUnit(int, int) const */

ulong __thiscall
icu_76_godot::UCharsTrieBuilder::getElementUnit(UCharsTrieBuilder *this,int param_1,int param_2)
...
void __thiscall
icu_76_godot::UCharsTrieBuilder::buildUChars
          (UCharsTrieBuilder *this,undefined4 param_2,int *param_3)

{
  ...
  if (*(int *)(this + 0x6c) == 0) {
    ...
    uprv_sortArray_76_godot
              (*(undefined8 *)(this + 0x50),*(int *)(this + 0x5c),8,compareElementStrings,
               this + 0x10,0);
...
/* icu_76_godot::UCharsTrieBuilder::getLimitOfLinearMatch(int, int, int) const */

void __thiscall
icu_76_godot::UCharsTrieBuilder::getLimitOfLinearMatch
          (UCharsTrieBuilder *this,int param_1,int param_2,int param_3)
...
LAB_001008ba:
        sVar4 = *(short *)(pUVar3 + (long)(int)uVar5 * 2);
      }
      if (sVar4 != sVar9) {
        return;
      }
...
/* icu_76_godot::UCharsTrieElement::compareStringTo(icu_76_godot::UCharsTrieElement const&,
   icu_76_godot::UnicodeString const&) const */

int __thiscall
icu_76_godot::UCharsTrieElement::compareStringTo
          (UCharsTrieElement *this,UCharsTrieElement *param_1,UnicodeString *param_2)

{
  ...
  if ((local_60 & 1) == 0) {
    ...
    if ((local_60 & 2) == 0) {
      bVar1 = icu_76_godot::UnicodeString::doCompare
                        (iVar2,0,(wchar16 *)(ulong)local_9c,local_50,iVar3);
    }
    else {
      bVar1 = icu_76_godot::UnicodeString::doCompare
                        (iVar2,0,(wchar16 *)(ulong)local_9c,(int)local_5e,iVar3);
    }
  }
  else {
...
void compareElementStrings
               (UnicodeString *param_1,UCharsTrieElement *param_2,UCharsTrieElement *param_3)
...
/* icu_76_godot::UCharsTrieBuilder::UCharsTrieBuilder(UErrorCode&) */

void __thiscall
icu_76_godot::UCharsTrieBuilder::UCharsTrieBuilder(UCharsTrieBuilder *this,UErrorCode *param_1)
...
/* icu_76_godot::UCharsTrieBuilder::add(icu_76_godot::UnicodeString const&, int, UErrorCode&) */
...

{
  ...
  UCharsTrieElement::setTo
            ((UCharsTrieElement *)((long)__dest + (long)iVar1 * 8),param_1,param_2,
             (UnicodeString *)(this + 0x10),param_3);
  if (0 < *(int *)param_3) {
    return this;
  }
  if (((byte)this[0x18] & 1) == 0) {
...
/* icu_76_godot::UCharsTrieBuilder::build(UStringTrieBuildOption, UErrorCode&) */

long * __thiscall
icu_76_godot::UCharsTrieBuilder::build(UCharsTrieBuilder *this,ulong param_2,int *param_3)

{
  ...
  if (((*(long *)(this + 0x60) != 0) && (0 < *(int *)(this + 0x6c))) ||
     (buildUChars(this,param_2,param_3), *param_3 < 1)) {
...
undefined8 __thiscall
icu_76_godot::UCharsTrieBuilder::buildUnicodeString
          (UCharsTrieBuilder *this,undefined8 param_2,undefined8 param_3,int *param_4)

{
  ...
  if (*param_4 < 1) {
    ...
    if ((lVar2 == 0) || (iVar1 = *(int *)(this + 0x6c), iVar1 < 1)) {
...
/* icu_76_godot::UCharsTrieBuilder::buildUChars(UStringTrieBuildOption, UErrorCode&) */

void __thiscall
icu_76_godot::UCharsTrieBuilder::buildUChars
          (UCharsTrieBuilder *this,undefined8 param_2,int *param_3)
...
void __thiscall
icu_76_godot::UCharsTrieBuilder::UCTLinearMatchNode::UCTLinearMatchNode
          (UCTLinearMatchNode *this,wchar16 *param_1,int param_2,Node *param_3)
...
/* icu_76_godot::UCharsTrieBuilder::ensureCapacity(int) */

undefined8 __thiscall
icu_76_godot::UCharsTrieBuilder::ensureCapacity(UCharsTrieBuilder *this,int param_1)

{
  ...
  if (*(int *)(this + 0x68) < param_1) {
    ...
    u_memcpy_76_godot(lVar2 + (long)(iVar1 - *(int *)(this + 0x6c)) * 2,
                      *(long *)(this + 0x60) +
                      (long)(*(int *)(this + 0x68) - *(int *)(this + 0x6c)) * 2);
    uprv_free_76_godot(*(undefined8 *)(this + 0x60));
    *(long *)(this + 0x60) = lVar2;
    *(int *)(this + 0x68) = iVar1;
  }
...
/* icu_76_godot::UCharsTrieBuilder::write(int) */

int __thiscall icu_76_godot::UCharsTrieBuilder::write(UCharsTrieBuilder *this,int param_1)
...
/* icu_76_godot::UCharsTrieBuilder::writeElementUnits(int, int, int) */

undefined4 __thiscall
icu_76_godot::UCharsTrieBuilder::writeElementUnits
          (UCharsTrieBuilder *this,int param_1,int param_2,int param_3)

{
  ...
  if (cVar2 != '\0') {
    *(int *)(this + 0x6c) = iVar4;
    u_memcpy_76_godot(*(long *)(this + 0x60) + (long)(*(int *)(this + 0x68) - iVar4) * 2,
                      puVar3 + (long)param_2 * 2,param_3);
  }
...
/* icu_76_godot::UCharsTrieBuilder::UCTLinearMatchNode::write(icu_76_godot::StringTrieBuilder&) */

void __thiscall
icu_76_godot::UCharsTrieBuilder::UCTLinearMatchNode::write
          (UCTLinearMatchNode *this,StringTrieBuilder *param_1)

{
  ...
  if (cVar4 != '\0') {
    *(int *)(param_1 + 0x6c) = iVar7;
    u_memcpy_76_godot(*(long *)(param_1 + 0x60) + (long)(*(int *)(param_1 + 0x68) - iVar7) * 2,uVar1
                      ,iVar6);
  }
  iVar6 = 0x30;
  ...
  uVar5 = (*pcVar2)(param_1,(int)(char)this[0x10],*(undefined4 *)(this + 0x14),
...
/* icu_76_godot::UCharsTrieBuilder::writeDeltaTo(int) */

ulong __thiscall icu_76_godot::UCharsTrieBuilder::writeDeltaTo(UCharsTrieBuilder *this,int param_1)

{
  ...
  if (iVar7 < 0xfc00) {
    ...
    *(short *)(*(long *)(this + 0x60) + (long)(int)(*(int *)(this + 0x68) - uVar2) * 2) =
         (short)iVar7;
  }
  else {
    ...
    if (cVar3 != '\0') {
      *(int *)(this + 0x6c) = iVar1;
      u_memcpy_76_godot(*(long *)(this + 0x60) + (long)(*(int *)(this + 0x68) - iVar1) * 2,local_36,
                        iVar8);
    }
LAB_001013d1:
...
/* icu_76_godot::UCharsTrieBuilder::writeValueAndFinal(int, signed char) */

ulong __thiscall
icu_76_godot::UCharsTrieBuilder::writeValueAndFinal
          (UCharsTrieBuilder *this,uint param_1,int param_3)

{
  ...
  if (param_1 < 0x4000) {
    ...
    *(short *)(*(long *)(this + 0x60) + (long)(int)(*(int *)(this + 0x68) - uVar1) * 2) =
         (short)param_1;
  }
  else {
    ...
    if (cVar2 != '\0') {
      *(int *)(this + 0x6c) = iVar4;
      u_memcpy_76_godot(*(long *)(this + 0x60) + (long)(*(int *)(this + 0x68) - iVar4) * 2,&local_26
                        ,iVar5);
    }
LAB_00101514:
...
/* icu_76_godot::UCharsTrieBuilder::writeValueAndType(signed char, int, int) */

ulong __thiscall
icu_76_godot::UCharsTrieBuilder::writeValueAndType
          (UCharsTrieBuilder *this,char param_2,uint param_3,undefined4 param_4)

{
  ...
  if (param_2 == '\0') {
    ...
    *(uint *)(this + 0x6c) = uVar1;
    *(ushort *)(*(long *)(this + 0x60) + (long)(int)(*(int *)(this + 0x68) - uVar1) * 2) =
         (ushort)param_4;
  }
  else {
    sVar4 = (short)param_3;
    ...
    if (cVar2 != '\0') {
      *(int *)(this + 0x6c) = iVar5;
      u_memcpy_76_godot(*(long *)(this + 0x60) + (long)(*(int *)(this + 0x68) - iVar5) * 2,&local_36
                        ,iVar6);
    }
LAB_00101652:
    uVar1 = *(uint *)(this + 0x6c);
...
/* icu_76_godot::UCharsTrieBuilder::write(char16_t const*, int) */

undefined4 __thiscall
icu_76_godot::UCharsTrieBuilder::write(UCharsTrieBuilder *this,wchar16 *param_1,int param_2)

{
  ...
  *(int *)(this + 0x6c) = iVar2;
  u_memcpy_76_godot(*(long *)(this + 0x60) + (long)(*(int *)(this + 0x68) - iVar2) * 2,param_1,
                    param_2);
  return *(undefined4 *)(this + 0x6c);
}
...
/* icu_76_godot::UCharsTrieBuilder::matchNodesCanHaveValues() const */

undefined8 icu_76_godot::UCharsTrieBuilder::matchNodesCanHaveValues(void)
...
/* icu_76_godot::UCharsTrieBuilder::getMaxBranchLinearSubNodeLength() const */

undefined8 icu_76_godot::UCharsTrieBuilder::getMaxBranchLinearSubNodeLength(void)
...
/* icu_76_godot::UCharsTrieBuilder::getMinLinearMatch() const */

undefined8 icu_76_godot::UCharsTrieBuilder::getMinLinearMatch(void)
...
/* icu_76_godot::UCharsTrieBuilder::getMaxLinearMatchLength() const */

undefined8 icu_76_godot::UCharsTrieBuilder::getMaxLinearMatchLength(void)
...
void __thiscall
icu_76_godot::UCharsTrieBuilder::UCTLinearMatchNode::~UCTLinearMatchNode(UCTLinearMatchNode *this)

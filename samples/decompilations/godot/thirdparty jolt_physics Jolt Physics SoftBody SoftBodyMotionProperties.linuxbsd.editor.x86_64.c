...
DetermineCollidingShapes(JPH::SoftBodyUpdateContext_const&,JPH::PhysicsSystem_const&,JPH::BodyLockInterface_const&)
...
/* JPH::SoftBodyMotionProperties::ApplySkinConstraints(JPH::SoftBodyUpdateContext const&, unsigned
   int, unsigned int) [clone .part.0] */

void __thiscall
JPH::SoftBodyMotionProperties::ApplySkinConstraints
          (SoftBodyMotionProperties *this,SoftBodyUpdateContext *param_1,uint param_2,uint param_3)
...
/* JPH::SoftBodyMotionProperties::DetermineCollidingShapes(JPH::SoftBodyUpdateContext const&,
   ...
   const&)::LeafShapeCollector::AddHit(JPH::TransformedShape const&) */

void JPH::SoftBodyMotionProperties::DetermineCollidingShapes(JPH::SoftBodyUpdateContext_const&,JPH::
     PhysicsSystem_const&,JPH::BodyLockInterface_const&)::Collector::AddHit(JPH::BodyID_const&)::
     LeafShapeCollector::AddHit(JPH::TransformedShape_const__(long param_1,undefined8 *param_2)
...
JPH::SoftBodyMotionProperties::
DetermineCollidingShapes(JPH::SoftBodyUpdateContext_const&,JPH::PhysicsSystem_const&,JPH::BodyLockInterface_const&)
::Collector::AddHit(JPH::BodyID_const&)::LeafShapeCollector::~LeafShapeCollector
          (LeafShapeCollector *this)

{
  ...
  *(undefined ***)this = &PTR__LeafShapeCollector_00107770;
  ...
  if ((*(long *)(this + 0x18) != 0) &&
     (uVar4 = *(long *)(this + 0x18) * 0x60 + uVar3, uVar3 < uVar4)) {
    do {
...
/* JPH::SoftBodyMotionProperties::CalculateMassAndInertia() */

void __thiscall
JPH::SoftBodyMotionProperties::CalculateMassAndInertia(SoftBodyMotionProperties *this)
...
/* JPH::SoftBodyMotionProperties::GetVolumeTimesSix() const */

float __thiscall JPH::SoftBodyMotionProperties::GetVolumeTimesSix(SoftBodyMotionProperties *this)

{
  ...
  if (puVar3 + *(long *)(*(long *)(this + 0x100) + 0x20) * 4 != puVar3) {
    ...
    do {
      ...
      fVar8 = fVar8 + (pfVar2[1] * *pfVar1 - pfVar1[1] * *pfVar2) * *(float *)(lVar5 + 0x18) +
                      (*pfVar2 * pfVar1[2] - *pfVar1 * pfVar2[2]) * *(float *)(lVar5 + 0x14) +
                      (pfVar2[2] * pfVar1[1] - pfVar1[2] * pfVar2[1]) * *(float *)(lVar5 + 0x10) +
                      0.0;
      puVar6 = puVar7;
...
/* JPH::SoftBodyMotionProperties::DetermineCollidingShapes(JPH::SoftBodyUpdateContext const&,
   JPH::PhysicsSystem const&, JPH::BodyLockInterface const&) */

void __thiscall
JPH::SoftBodyMotionProperties::DetermineCollidingShapes
          (SoftBodyMotionProperties *this,SoftBodyUpdateContext *param_1,PhysicsSystem *param_2,
          BodyLockInterface *param_3)

{
  ...
  local_88._12_4_ = 0;
  local_78 = CONCAT44(0.0 - (fVar4 * *(float *)(param_1 + 0x30) + *(float *)(param_1 + 0x34) * fVar5
                            + fVar6 * *(float *)(param_1 + 0x38)),
                      0.0 - (fVar4 * *(float *)(param_1 + 0x20) + *(float *)(param_1 + 0x24) * fVar5
                            + fVar6 * *(float *)(param_1 + 0x28)));
  local_70 = 0.0 - (fVar4 * *(float *)(param_1 + 0x40) + *(float *)(param_1 + 0x44) * fVar5 +
                   fVar6 * *(float *)(param_1 + 0x48));
  local_148 = local_168;
  local_b0 = param_1;
  local_48 = param_3;
  (**(code **)(**(long **)(param_2 + 400) + 0x18))
            (*(long **)(param_2 + 400),&local_e8,&local_c8,&local_178,&local_158);
...
/* JPH::SoftBodyMotionProperties::DetermineCollisionPlanes(unsigned int, unsigned int) */

void __thiscall
JPH::SoftBodyMotionProperties::DetermineCollisionPlanes
          (SoftBodyMotionProperties *this,uint param_1,uint param_2)
    ...
    do {
      ...
      for (; lVar2 != lVar4; lVar4 = lVar4 + 0x60) {
        ...
        (**(code **)(**(long **)(lVar4 + 0x50) + 0xb0))
                   ...
                   *(long **)(lVar4 + 0x50),lVar4,&local_98,param_2,
                   lVar3 - *(long *)(this + 0x130) >> 8);
      }
      lVar3 = lVar3 + 0x100;
    } while (lVar1 != lVar3);
  }
...
/* JPH::SoftBodyMotionProperties::DetermineSensorCollisions(JPH::SoftBodyMotionProperties::CollidingSensor&)
    */

void __thiscall
JPH::SoftBodyMotionProperties::DetermineSensorCollisions
          (SoftBodyMotionProperties *this,CollidingSensor *param_1)

{
  ...
  if (lVar1 == lVar3) {
    ...
    do {
      lVar2 = lVar1 + 0x60;
      (**(code **)(**(long **)(lVar1 + 0x50) + 0xb0))
                (*(undefined8 *)(lVar1 + 0x40),*(undefined8 *)(lVar1 + 0x48),
                 *(long **)(lVar1 + 0x50),lVar1,&local_98,*(undefined4 *)(this + 0x108),0);
      lVar1 = lVar2;
    } while (lVar3 != lVar2);
...
/* JPH::SoftBodyMotionProperties::ApplyPressure(JPH::SoftBodyUpdateContext const&) */

void __thiscall
JPH::SoftBodyMotionProperties::ApplyPressure
          (SoftBodyMotionProperties *this,SoftBodyUpdateContext *param_1)
      ...
      if (puVar11 != puVar8) {
        ...
        do {
          ...
          do {
            ...
            *(float *)(lVar1 + 0x20) =
                 fVar4 * (fVar19 * fVar14 - fVar15 * fVar18) * fVar12 + *(float *)(lVar1 + 0x20);
            *(float *)(lVar1 + 0x24) =
                 fVar4 * (fVar17 * fVar15 - fVar13 * fVar19) * fVar12 + *(float *)(lVar1 + 0x24);
...
/* JPH::SoftBodyMotionProperties::IntegratePositions(JPH::SoftBodyUpdateContext const&) */

void __thiscall
JPH::SoftBodyMotionProperties::IntegratePositions
          (SoftBodyMotionProperties *this,SoftBodyUpdateContext *param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* JPH::SoftBodyMotionProperties::ApplyDihedralBendConstraints(JPH::SoftBodyUpdateContext const&,
   unsigned int, unsigned int) */

void __thiscall
JPH::SoftBodyMotionProperties::ApplyDihedralBendConstraints
          (SoftBodyMotionProperties *this,SoftBodyUpdateContext *param_1,uint param_2,uint param_3)
  ...
  if (puVar20 < puVar1) {
    ...
    do {
      while( true ) {
        ...
        fVar42 = (fVar36 * fVar36 + fVar35 * fVar35 + 0.0 + fVar37 * fVar37) *
                 *(float *)(lVar21 + 0x4c) +
                 (fVar45 * fVar45 + fVar44 * fVar44 + 0.0 + fVar47 * fVar47) *
                 *(float *)(lVar23 + 0x4c) +
                 (fVar31 * fVar31 + fVar26 * fVar26 + 0.0 + fVar32 * fVar32) *
                 *(float *)(lVar24 + 0x4c) +
                 (fVar40 * fVar40 + fVar39 * fVar39 + 0.0 + fVar41 * fVar41) *
                 *(float *)(lVar22 + 0x4c) + fVar46 * (float)puVar20[4];
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* JPH::SoftBodyMotionProperties::ApplyVolumeConstraints(JPH::SoftBodyUpdateContext const&, unsigned
   int, unsigned int) */

void __thiscall
JPH::SoftBodyMotionProperties::ApplyVolumeConstraints
          (SoftBodyMotionProperties *this,SoftBodyUpdateContext *param_1,uint param_2,uint param_3)

{
  ...
  if (puVar19 < puVar1) {
    ...
    do {
      ...
      fVar25 = (fVar31 * fVar31 + fVar30 * fVar30 + 0.0 + fVar29 * fVar29) * fVar28 +
               (fVar33 * fVar33 + fVar35 * fVar35 + fVar34 * fVar34 + 0.0) *
               *(float *)(lVar23 + 0x4c) +
               (fVar32 * fVar32 + fVar27 * fVar27 + fVar26 * fVar26 + 0.0) *
               *(float *)(lVar20 + 0x4c) +
               (fVar39 * fVar39 + fVar41 * fVar41 + fVar40 * fVar40 + 0.0) * fVar2 +
               fVar24 * (float)puVar19[5];
      if (_LC18 <= fVar25) {
        fVar25 = ((float)((uint)(fVar37 * fVar41 + fVar36 * fVar40 + 0.0 + fVar38 * fVar39) & __LC12
                         ) - (float)puVar19[4]) / fVar25;
...
{
  if ((*(long *)(*(long *)(this + 0x100) + 0x80) != 0) &&
     (this[0x1be] != (SoftBodyMotionProperties)0x0)) {
...
void __thiscall
JPH::SoftBodyMotionProperties::ApplyEdgeConstraints
          (SoftBodyMotionProperties *this,SoftBodyUpdateContext *param_1,uint param_2,uint param_3)
...
/* JPH::SoftBodyMotionProperties::ApplyLRAConstraints(unsigned int, unsigned int) */

void __thiscall
JPH::SoftBodyMotionProperties::ApplyLRAConstraints
          (SoftBodyMotionProperties *this,uint param_1,uint param_2)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* JPH::SoftBodyMotionProperties::ApplyCollisionConstraintsAndUpdateVelocities(JPH::SoftBodyUpdateContext
   const&) */

void __thiscall
JPH::SoftBodyMotionProperties::ApplyCollisionConstraintsAndUpdateVelocities
          (SoftBodyMotionProperties *this,SoftBodyUpdateContext *param_1)

{
  ...
  fVar21 = SQRT(*(float *)(param_1 + 0x68) * *(float *)(param_1 + 0x68) +
                *(float *)(param_1 + 0x60) * *(float *)(param_1 + 0x60) + 0.0 +
                *(float *)(param_1 + 100) * *(float *)(param_1 + 100)) * __LC19 * fVar1;
  if (pfVar18 == pfVar17) {
    return;
  }
  ...
  do {
    ...
    *(undefined1 (*) [16])(pfVar17 + 8) = auVar24;
    ...
    if (-1 < (int)pfVar17[0x10]) {
      ...
      fVar4 = pfVar17[0xe];
      fVar5 = pfVar17[0xf];
      fVar50 = fVar2 - (pfVar17[5] * fVar49 + pfVar17[4] * fVar48 + 0.0 + pfVar17[6] * fVar4 +
                       pfVar17[0xf]);
      if (0.0 < fVar50) {
        ...
        *(undefined1 *)(pfVar17 + 0x11) = 1;
        ...
        if (cVar3 == '\x02') {
          ...
          fVar29 = fVar33 * (fVar10 * fVar31 + fVar33 * fVar6 + fStack_84 * fVar29 + fStack_74) +
                   fVar31 * (fVar9 * fVar31 + fVar33 * fVar44 + local_88 * fVar29 + local_78) + 0.0
                   + fVar29 * (fVar11 * fVar31 + fVar33 * fVar7 + fStack_80 * fVar29 + fStack_70) +
                   fVar43 + fVar37;
          if (0.0 < fVar29) {
            ...
            fVar35 = ((float)uVar14 - fStack_10) * fVar4 +
                     (fVar35 - fStack_14) * fVar49 + fVar48 * (fVar20 - local_18) + 0.0;
            if (fVar35 < fVar21) {
            ...
            *(float *)(lVar19 + 0xd0) =
                 fVar37 * local_88 + fVar38 * fVar9 + fVar36 * fVar44 + local_78 +
                 *(float *)(lVar19 + 0xd0);
            *(float *)(lVar19 + 0xd4) =
                 fVar37 * fStack_84 + fVar38 * fVar10 + fVar36 * fVar6 + fStack_74 +
                 *(float *)(lVar19 + 0xd4);
            *(float *)(lVar19 + 0xd8) =
                 fVar37 * fStack_80 + fVar38 * fVar11 + fVar36 * fVar7 + fStack_70 +
                 *(float *)(lVar19 + 0xd8);
            *(float *)(lVar19 + 0xdc) =
                 fVar37 * fStack_7c + fVar38 * fVar12 + fVar36 * fVar8 + fStack_6c +
                 *(float *)(lVar19 + 0xdc);
          }
        }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* JPH::SoftBodyMotionProperties::UpdateSoftBodyState(JPH::SoftBodyUpdateContext&,
   JPH::PhysicsSettings const&) */

void __thiscall
JPH::SoftBodyMotionProperties::UpdateSoftBodyState
          (SoftBodyMotionProperties *this,SoftBodyUpdateContext *param_1,PhysicsSettings *param_2)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if ((this[0x1bd] != (SoftBodyMotionProperties)0x0) &&
     (plVar27 = *(long **)(param_1 + 0x10), plVar27 != (long *)0x0)) {
...
LAB_00102200:
        ...
        *puVar2 = *puVar3;
        ...
        if (puVar3 + 8 != puVar2 + 8) {
          uVar28 = puVar2[10];
          if (uVar28 != 0) {
            if ((puVar2[8] != 0) && (uVar25 = puVar2[8] * 0x60 + uVar28, uVar28 < uVar25)) {
LAB_00102819:
              do {
        ...
        *(long *)(this + 0x138) = lVar23 + -1;
        ...
        if ((*(long *)(lVar21 + 0x40) != 0) &&
           (uVar25 = *(long *)(lVar21 + 0x40) * 0x60 + uVar28, uVar28 < uVar25)) {
LAB_00102331:
          do {
            plVar27 = *(long **)(uVar28 + 0x50);
            if (plVar27 != (long *)0x0) {
...
LAB_00102386:
  ...
  *(undefined4 *)(this + 0x174) = uVar6;
  *(undefined4 *)(this + 0x178) = uVar6;
  *(undefined4 *)(this + 0x17c) = uVar6;
  uVar6 = _LC8;
  *(undefined4 *)(this + 0x180) = _LC8;
  *(undefined4 *)(this + 0x184) = uVar6;
  ...
  *(undefined8 *)(this + 0x1a8) = uVar19;
  ...
  if (lVar21 == lVar30) {
    ...
    do {
      ...
      fVar31 = *(float *)(lVar23 + 0x28) * *(float *)(lVar23 + 0x28) +
               *(float *)(lVar23 + 0x20) * *(float *)(lVar23 + 0x20) + 0.0 +
               *(float *)(lVar23 + 0x24) * *(float *)(lVar23 + 0x24);
      fVar45 = fVar31;
      if (fVar31 <= fVar33) {
        fVar45 = fVar33;
      }
      ...
      *(undefined1 (*) [16])(this + 0x180) = auVar32;
      auVar32._0_4_ =
           *(float *)(lVar23 + 0x20) * fVar4 + *(float *)(lVar23 + 0x10) +
           *(float *)(param_1 + 0x70);
      auVar32._4_4_ =
           *(float *)(lVar23 + 0x24) * fVar4 + *(float *)(lVar23 + 0x14) +
           *(float *)(param_1 + 0x74);
      auVar32._8_4_ =
           *(float *)(lVar23 + 0x28) * fVar4 + *(float *)(lVar23 + 0x18) +
           *(float *)(param_1 + 0x78);
      auVar32._12_4_ =
           *(float *)(lVar23 + 0x2c) * fVar4 + *(float *)(lVar23 + 0x1c) +
           *(float *)(param_1 + 0x7c);
  ...
  *(uint *)this =
       (uint)(fVar39 * fVar46 + fVar43 * fVar50 + fVar44 * fVar15) &
       -(uint)(auVar42._0_4_ == __LC23);
  ...
  *(uint *)(this + 0xc) =
       (uint)(fVar39 * fVar49 + fVar43 * fVar14 + fVar44 * fVar18) & -(uint)bVar12;
  *(uint *)(this + 0x10) =
       (uint)(fVar34 * fVar46 + fVar37 * fVar50 + fVar38 * fVar15) & -(uint)bVar7;
  *(uint *)(this + 0x14) =
       (uint)(fVar34 * fVar33 + fVar37 * fVar51 + fVar38 * fVar16) & -(uint)bVar9;
  *(uint *)(this + 0x18) =
       (uint)(fVar34 * fVar48 + fVar37 * fVar31 + fVar38 * fVar17) & -(uint)bVar11;
  *(uint *)(this + 0x1c) =
       (uint)(fVar34 * fVar49 + fVar37 * fVar14 + fVar38 * fVar18) & -(uint)bVar13;
  if (this[0x1bc] == (SoftBodyMotionProperties)0x0) {
    ...
    *(ulong *)(this + 0xf0) =
         CONCAT44(*(float *)(this + 0xf4) + fVar33,*(float *)(this + 0xf0) + fVar46);
    *(float *)(this + 0xf8) = *(float *)(this + 0xf8) + fVar48;
    fVar34 = 0.0 - fVar34;
    fVar37 = 0.0 - fVar37;
    fVar38 = 0.0 - fVar38;
    fVar39 = 0.0 - fVar39;
    *(float *)(this + 0x170) = *(float *)(this + 0x170) + fVar34;
    *(float *)(this + 0x174) = *(float *)(this + 0x174) + fVar37;
    *(float *)(this + 0x178) = *(float *)(this + 0x178) + fVar38;
    *(float *)(this + 0x17c) = *(float *)(this + 0x17c) + fVar39;
    *(float *)(this + 0x180) = *(float *)(this + 0x180) + fVar34;
    *(float *)(this + 0x184) = *(float *)(this + 0x184) + fVar37;
    *(float *)(this + 0x188) = *(float *)(this + 0x188) + fVar38;
    *(float *)(this + 0x18c) = *(float *)(this + 0x18c) + fVar39;
    *(float *)(this + 400) = *(float *)(this + 400) + fVar34;
    *(float *)(this + 0x194) = *(float *)(this + 0x194) + fVar37;
    *(float *)(this + 0x198) = *(float *)(this + 0x198) + fVar38;
    *(float *)(this + 0x19c) = *(float *)(this + 0x19c) + fVar39;
...
JPH::SoftBodyMotionProperties::UpdateRigidBodyVelocities
          (SoftBodyMotionProperties *this,SoftBodyUpdateContext *param_1,BodyInterface *param_2)
  ...
  if (lVar6 != lVar3) {
    do {
      while (*(char *)(lVar3 + 0x70) != '\0') {
        ...
        JPH::BodyInterface::AddLinearAndAngularVelocity
                  (CONCAT44(fVar11 * *(float *)(param_1 + 0x24) +
                            fVar13 * *(float *)(param_1 + 0x34) +
                            fVar15 * *(float *)(param_1 + 0x44),
                            fVar11 * *(float *)(param_1 + 0x20) +
                            fVar13 * *(float *)(param_1 + 0x30) +
                            fVar15 * *(float *)(param_1 + 0x40)),
                   CONCAT44(fVar11 * *(float *)(param_1 + 0x2c) +
                   ...
                   CONCAT44(fVar10 * *(float *)(param_1 + 0x24) +
    ...
    for (; uVar7 < uVar9; uVar7 = uVar7 + 0x100) {
      ...
      if (uVar5 != 0) {
        if ((*(long *)(uVar7 + 0x40) != 0) &&
           (uVar8 = *(long *)(uVar7 + 0x40) * 0x60 + uVar5, uVar5 < uVar8)) {
LAB_001029d9:
          do {
...
/* JPH::SoftBodyMotionProperties::InitializeUpdateContext(float, JPH::Body&, JPH::PhysicsSystem
   const&, JPH::SoftBodyUpdateContext&) */

void __thiscall
JPH::SoftBodyMotionProperties::InitializeUpdateContext
          (SoftBodyMotionProperties *this,float param_1,Body *param_2,PhysicsSystem *param_3,
          SoftBodyUpdateContext *param_4)
...
/* JPH::SoftBodyMotionProperties::StartNextIteration(JPH::SoftBodyUpdateContext const&) */

void __thiscall
JPH::SoftBodyMotionProperties::StartNextIteration
          (SoftBodyMotionProperties *this,SoftBodyUpdateContext *param_1)
...
/* JPH::SoftBodyMotionProperties::StartFirstIteration(JPH::SoftBodyUpdateContext&) */

void __thiscall
JPH::SoftBodyMotionProperties::StartFirstIteration
          (SoftBodyMotionProperties *this,SoftBodyUpdateContext *param_1)
...
/* JPH::SoftBodyMotionProperties::ParallelDetermineCollisionPlanes(JPH::SoftBodyUpdateContext&) */

undefined8 __thiscall
JPH::SoftBodyMotionProperties::ParallelDetermineCollisionPlanes
          (SoftBodyMotionProperties *this,SoftBodyUpdateContext *param_1)
...
/* JPH::SoftBodyMotionProperties::ParallelDetermineSensorCollisions(JPH::SoftBodyUpdateContext&) */

undefined8 __thiscall
JPH::SoftBodyMotionProperties::ParallelDetermineSensorCollisions
          (SoftBodyMotionProperties *this,SoftBodyUpdateContext *param_1)
    ...
    *(uint *)pSVar1 = *(uint *)pSVar1 + 1;
    ...
    if (uVar2 < uVar4) {
      DetermineSensorCollisions
                (this,(CollidingSensor *)((ulong)uVar2 * 0x60 + *(long *)(this + 0x148)));
      LOCK();
      pSVar1 = param_1 + 0x98;
      iVar3 = *(int *)pSVar1;
...
/* JPH::SoftBodyMotionProperties::ProcessGroup(JPH::SoftBodyUpdateContext const&, unsigned int) */

void __thiscall
JPH::SoftBodyMotionProperties::ProcessGroup
          (SoftBodyMotionProperties *this,SoftBodyUpdateContext *param_1,uint param_2)
...
undefined8 __thiscall
JPH::SoftBodyMotionProperties::ParallelApplyConstraints
          (SoftBodyMotionProperties *this,SoftBodyUpdateContext *param_1,PhysicsSettings *param_2)
...
long __thiscall
JPH::SoftBodyMotionProperties::ParallelUpdate
          (SoftBodyMotionProperties *this,SoftBodyUpdateContext *param_1,PhysicsSettings *param_2)
...
/* JPH::SoftBodyMotionProperties::SkinVertices(JPH::Mat44 const&, JPH::Mat44 const*, unsigned int,
   bool, JPH::TempAllocator&) */

void __thiscall
JPH::SoftBodyMotionProperties::SkinVertices
          (SoftBodyMotionProperties *this,Mat44 *param_1,Mat44 *param_2,uint param_3,bool param_4,
...

{
  ...
  puVar19 = (undefined8 *)
            (**(code **)(*(long *)param_5 + 0x10))
                      (param_5,iVar31,param_2,CONCAT44(in_register_0000000c,param_3));
  ...
  for (puVar23 = puVar19; puVar23 < puVar19 + (uVar3 & 0xffffffff) * 8; puVar23 = puVar23 + 8) {
    ...
    do {
      ...
      fVar16 = pfVar22[2];
      fVar17 = pfVar22[3];
      *(float *)((long)&local_88 + lVar21) =
           fVar17 * fVar10 + fVar14 * fVar5 + fVar15 * fVar39 + fVar16 * fVar6;
      *(float *)((long)&local_88 + lVar21 + 4) =
           fVar17 * fVar11 + fVar14 * fVar33 + fVar15 * fVar40 + fVar16 * fVar7;
      *(float *)((long)&uStack_80 + lVar21) =
           fVar17 * fVar12 + fVar14 * fVar38 + fVar15 * fVar41 + fVar16 * fVar8;
      *(float *)((long)&uStack_80 + lVar21 + 4) =
           fVar17 * fVar13 + fVar14 * fVar36 + fVar15 * fVar42 + fVar16 * fVar9;
      lVar21 = lVar21 + 0x10;
    } while (lVar21 != 0x40);
  ...
  if (puVar26 != puVar27) {
    ...
    do {
      ...
      do {
        ...
        auVar43._0_4_ =
             auVar34._0_4_ +
             (*pfVar22 * fVar5 + pfVar22[4] * fVar33 + pfVar22[8] * fVar38 + pfVar22[0xc]) * fVar36;
        auVar43._4_4_ =
             auVar34._4_4_ +
             (pfVar22[1] * fVar5 + pfVar22[5] * fVar33 + pfVar22[9] * fVar38 + pfVar22[0xd]) *
             fVar36;
        auVar43._8_4_ =
             auVar34._8_4_ +
             (pfVar22[2] * fVar5 + pfVar22[6] * fVar33 + pfVar22[10] * fVar38 + pfVar22[0xe]) *
             fVar36;
        auVar43._12_4_ =
             auVar34._12_4_ +
             (pfVar22[3] * fVar5 + pfVar22[7] * fVar33 + pfVar22[0xb] * fVar38 + pfVar22[0xf]) *
             fVar36;
        auVar34 = auVar43;
...
LAB_0010359c:
          fVar33 = auVar44._0_4_ * auVar44._0_4_ + 0.0 + auVar44._4_4_ * auVar44._4_4_ +
...
/* JPH::SoftBodyMotionProperties::CustomUpdate(float, JPH::Body&, JPH::PhysicsSystem&) */

void __thiscall
JPH::SoftBodyMotionProperties::CustomUpdate
          (SoftBodyMotionProperties *this,float param_1,Body *param_2,PhysicsSystem *param_3)

{
  ...
  if (this[0x1bc] != (SoftBodyMotionProperties)0x0) {
    ...
    JPH::BodyInterface::SetPosition
              (local_118,uStack_110,(BodyInterface *)(param_3 + 0x158),param_2 + 0x70,1);
  }
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
  }
...
/* JPH::SoftBodyMotionProperties::DrawVertices(JPH::DebugRenderer*, JPH::Mat44 const&) const */

void __thiscall
JPH::SoftBodyMotionProperties::DrawVertices
          (SoftBodyMotionProperties *this,DebugRenderer *param_1,Mat44 *param_2)
...
void __thiscall
JPH::SoftBodyMotionProperties::DrawVertexVelocities
          (SoftBodyMotionProperties *this,DebugRenderer *param_1,Mat44 *param_2)
              ...
              (CONCAT44(fVar3 * *(float *)(param_2 + 0x24) +
               ...
               CONCAT44(fVar3 * *(float *)(param_2 + 0x2c) +
                        ...
                        *(float *)(param_2 + 0x3c),
                        ...
                        fVar1 * *(float *)(param_2 + 8) + fVar2 * *(float *)(param_2 + 0x18) +
                        *(float *)(param_2 + 0x38)),
               CONCAT44(fVar8 * *(float *)(param_2 + 0x24) +
                        fVar6 * *(float *)(param_2 + 4) + fVar7 * *(float *)(param_2 + 0x14) +
                        *(float *)(param_2 + 0x34),
                        fVar8 * *(float *)(param_2 + 0x20) +
                        fVar6 * *(float *)param_2 + fVar7 * *(float *)(param_2 + 0x10) +
                        *(float *)(param_2 + 0x30)),
               CONCAT44(fVar8 * *(float *)(param_2 + 0x2c) +
                        fVar6 * *(float *)(param_2 + 0xc) + fVar7 * *(float *)(param_2 + 0x1c) +
                        *(float *)(param_2 + 0x3c),
                        fVar8 * *(float *)(param_2 + 0x28) +
                        fVar6 * *(float *)(param_2 + 8) + fVar7 * *(float *)(param_2 + 0x18) +
                        *(float *)(param_2 + 0x38)),_LC31,param_1,(undefined4)Color::sYellow);
  }
  return;
}
...
/* JPH::SoftBodyMotionProperties::DrawEdgeConstraints(JPH::DebugRenderer*, JPH::Mat44 const&,
   JPH::ESoftBodyConstraintColor) const */

void __thiscall
JPH::SoftBodyMotionProperties::DrawEdgeConstraints
          (SoftBodyMotionProperties *this,long *param_1,float *param_2,int param_4)
    ...
    do {
      ...
      if (uVar21 < uVar2) {
        ...
        while( true ) {
          ...
          fVar7 = pfVar1[1];
          fVar8 = pfVar1[2];
          local_88 = CONCAT44(fVar8 * param_2[9] + fVar24 * param_2[1] + fVar7 * param_2[5] +
                              param_2[0xd],
                              fVar8 * param_2[8] + fVar24 * *param_2 + fVar7 * param_2[4] +
                              param_2[0xc]);
          ...
          fVar11 = pfVar1[2];
          (**(code **)(*param_1 + 0x10))
                    (CONCAT44(fVar11 * param_2[9] + fVar9 * param_2[1] + fVar10 * param_2[5] +
                              param_2[0xd],
                              fVar11 * param_2[8] + fVar9 * *param_2 + fVar10 * param_2[4] +
                              param_2[0xc]),
                     CONCAT44(fVar11 * param_2[0xb] + fVar9 * param_2[3] + fVar10 * param_2[7] +
                              param_2[0xf],
                              fVar11 * param_2[10] + fVar9 * param_2[2] + fVar10 * param_2[6] +
                              param_2[0xe]),local_88,
                     CONCAT44(fVar8 * param_2[0xb] + fVar24 * param_2[3] + fVar7 * param_2[7] +
                              param_2[0xf],
                              fVar8 * param_2[10] + fVar24 * param_2[2] + fVar7 * param_2[6] +
                              param_2[0xe]),param_1,
                     (((uint)bVar14 | (uVar6 >> 0x18) << 8) << 8 | (uint)local_58) << 8 |
                     uVar18 & 0xff);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* JPH::SoftBodyMotionProperties::DrawBendConstraints(JPH::DebugRenderer*, JPH::Mat44 const&,
   JPH::ESoftBodyConstraintColor) const */

void __thiscall
JPH::SoftBodyMotionProperties::DrawBendConstraints
          (SoftBodyMotionProperties *this,long *param_1,float *param_2,int param_4)
    ...
    do {
      ...
      if (uVar33 < uVar2) {
        ...
        while( true ) {
          ...
          lVar35 = lVar35 + 0x18;
          uVar34 = (((uint)bVar29 | (uVar30 >> 0x18) << 8) << 8 | (uint)(byte)local_54) << 8 |
                   (uint)bVar38;
          ...
          local_a8 = CONCAT44(_UNK_00107844 * fVar48 + _UNK_00107854 * fVar44,
                              __LC34 * fVar47 + _LC37 * fVar42);
          local_98 = CONCAT44(fVar48 * _UNK_00107854 + fVar44 * _UNK_00107844,
                              fVar47 * _LC37 + fVar42 * __LC34);
          JPH::DebugRenderer::DrawArrow
                    (local_98,CONCAT44(fVar50 * _UNK_0010785c + fVar46 * _UNK_0010784c,
                                       fVar49 * _UNK_00107858 + fVar45 * _UNK_00107848),local_a8,
                     CONCAT44(_UNK_0010784c * fVar50 + _UNK_0010785c * fVar46,
                              _UNK_00107848 * fVar49 + _UNK_00107858 * fVar45),_LC31,param_1,uVar34)
          ;
          ...
          (**(code **)(*param_1 + 0x10))
                    (local_b8,uVar3,local_a8,
                     CONCAT44(fStack_7c * _UNK_0010784c + fVar55,fStack_80 * _UNK_00107848 + fVar43)
                     ,param_1,uVar34);
          ...
          (**(code **)(*param_1 + 0x10))
                    (uVar27,uVar3,local_b8,
                     CONCAT44(fStack_6c * _UNK_0010784c + fVar55,fStack_70 * _UNK_00107848 + fVar43)
                     ,param_1,uVar34);
...
void __thiscall
JPH::SoftBodyMotionProperties::DrawVolumeConstraints
          (SoftBodyMotionProperties *this,long *param_1,float *param_2,int param_4)
    ...
    do {
      ...
      if (uVar38 < uVar2) {
        ...
        while( true ) {
          ...
          fVar18 = param_2[0xf];
          lVar4 = *(long *)(this + 0x118);
          uVar39 = (((uint)bVar31 | (uVar32 >> 0x18) << 8) << 8 | (uint)local_58) << 8 |
                   (uint)bVar36;
          ...
          fVar20 = pfVar1[1];
          fVar21 = pfVar1[2];
          local_98 = CONCAT44(fVar21 * fVar14 + fVar19 * fVar6 + fVar20 * fVar10 + fVar46,
                              fVar21 * fVar13 + fVar19 * fVar45 + fVar20 * fVar9 + fVar44);
          pfVar1 = (float *)(lVar4 + 0x10 + (ulong)puVar37[1] * 0x50);
          fVar22 = *pfVar1;
          fVar23 = pfVar1[1];
          fVar24 = pfVar1[2];
          uVar26 = CONCAT44(fVar21 * fVar16 + fVar19 * fVar8 + fVar20 * fVar12 + fVar18,
                            fVar21 * fVar15 + fVar19 * fVar7 + fVar20 * fVar11 + fVar17);
          local_88 = CONCAT44(fVar24 * fVar14 + fVar22 * fVar6 + fVar23 * fVar10 + fVar46,
                              fVar24 * fVar13 + fVar22 * fVar45 + fVar23 * fVar9 + fVar44);
          pfVar1 = (float *)(lVar4 + 0x10 + (ulong)puVar37[2] * 0x50);
          fVar19 = *pfVar1;
          fVar20 = pfVar1[1];
          fVar21 = pfVar1[2];
          uVar27 = CONCAT44(fVar24 * fVar16 + fVar22 * fVar8 + fVar23 * fVar12 + fVar18,
                            fVar24 * fVar15 + fVar22 * fVar7 + fVar23 * fVar11 + fVar17);
          local_c8 = CONCAT44(fVar21 * fVar14 + fVar19 * fVar6 + fVar20 * fVar10 + fVar46,
                              fVar21 * fVar13 + fVar19 * fVar45 + fVar20 * fVar9 + fVar44);
          pfVar1 = (float *)(lVar4 + 0x10 + (ulong)puVar37[3] * 0x50);
          fVar22 = *pfVar1;
          fVar23 = pfVar1[1];
          fVar24 = pfVar1[2];
          uVar3 = CONCAT44(fVar21 * fVar16 + fVar19 * fVar8 + fVar20 * fVar12 + fVar18,
                           fVar21 * fVar15 + fVar19 * fVar7 + fVar20 * fVar11 + fVar17);
          fVar44 = fVar24 * fVar13 + fVar22 * fVar45 + fVar9 * fVar23 + fVar44;
          fVar46 = fVar24 * fVar14 + fVar22 * fVar6 + fVar10 * fVar23 + fVar46;
          (**(code **)(*param_1 + 0x18))
                    (local_98,uVar26,local_c8,uVar3,local_88,uVar27,param_1,uVar39,0);
          uVar25 = CONCAT44(fVar24 * fVar16 + fVar22 * fVar8 + fVar12 * fVar23 + fVar18,
                            fVar24 * fVar15 + fVar22 * fVar7 + fVar11 * fVar23 + fVar17);
          (**(code **)(*param_1 + 0x18))
                    (local_88,uVar27,local_c8,uVar3,CONCAT44(fVar46,fVar44),uVar25,param_1,uVar39,0)
          ;
          (**(code **)(*param_1 + 0x18))
                    (local_98,uVar26,CONCAT44(fVar46,fVar44),uVar25,local_c8,uVar3,param_1,uVar39,0)
          ;
          (**(code **)(*param_1 + 0x18))
                    (local_98,uVar26,local_88,uVar27,CONCAT44(fVar46,fVar44),uVar25,param_1,uVar39,0
                    );
...
void __thiscall
JPH::SoftBodyMotionProperties::DrawSkinConstraints
          (SoftBodyMotionProperties *this,long *param_1,float *param_2,int param_4)
    ...
    do {
      ...
      if (uVar12 < uVar1) {
        ...
        while( true ) {
          ...
          local_88 = CONCAT44(fVar25 * *(float *)(this + 0xe4) +
                              fVar22 * *(float *)(this + 0xc4) + fVar24 * *(float *)(this + 0xd4) +
                              *(float *)(this + 0xf4),
                              fVar25 * *(float *)(this + 0xe0) +
                              fVar22 * *(float *)(this + 0xc0) + fVar24 * *(float *)(this + 0xd0) +
                              *(float *)(this + 0xf0));
          JPH::DebugRenderer::DrawArrow
                    (CONCAT44(fVar23 * *(float *)(this + 0xc4) + fVar4 * *(float *)(this + 0xd4) +
                              fVar5 * *(float *)(this + 0xe4) + *(float *)(this + 0xf4),
                              fVar23 * *(float *)(this + 0xc0) + fVar4 * *(float *)(this + 0xd0) +
                              fVar5 * *(float *)(this + 0xe0) + *(float *)(this + 0xf0)),
                     CONCAT44(fVar23 * *(float *)(this + 0xcc) + fVar4 * *(float *)(this + 0xdc) +
                              fVar5 * *(float *)(this + 0xec) + *(float *)(this + 0xfc),
                              fVar23 * *(float *)(this + 200) + fVar4 * *(float *)(this + 0xd8) +
                              fVar5 * *(float *)(this + 0xe8) + *(float *)(this + 0xf8)),local_88,
                     CONCAT44(fVar25 * *(float *)(this + 0xec) +
                              fVar22 * *(float *)(this + 0xcc) + fVar24 * *(float *)(this + 0xdc) +
                              *(float *)(this + 0xfc),
                              fVar25 * *(float *)(this + 0xe8) +
                              fVar22 * *(float *)(this + 200) + fVar24 * *(float *)(this + 0xd8) +
                              *(float *)(this + 0xf8)),_LC31,param_1,
                     (((uVar9 >> 0x18) << 8 | (uint)bVar18) << 8 | (uint)(byte)local_54) << 8 |
                     (uint)bVar14);
          lVar13 = (ulong)*puVar17 * 0x50 + *(long *)(this + 0x118);
          fVar23 = *(float *)(lVar13 + 0x10);
          fVar4 = *(float *)(lVar13 + 0x14);
          fVar5 = *(float *)(lVar13 + 0x18);
          local_88 = CONCAT44(fVar5 * param_2[9] + fVar23 * param_2[1] + fVar4 * param_2[5] +
                              param_2[0xd],
                              fVar5 * param_2[8] + fVar23 * *param_2 + fVar4 * param_2[4] +
                              param_2[0xc]);
          fVar22 = *(float *)(lVar15 + 0x10);
          fVar24 = *(float *)(lVar15 + 0x14);
          fVar25 = *(float *)(lVar15 + 0x18);
          (**(code **)(*param_1 + 0x10))
                    (CONCAT44(fVar25 * *(float *)(this + 0xe4) +
                              fVar22 * *(float *)(this + 0xc4) + fVar24 * *(float *)(this + 0xd4) +
                              *(float *)(this + 0xf4),
                              fVar25 * *(float *)(this + 0xe0) +
                              fVar22 * *(float *)(this + 0xc0) + fVar24 * *(float *)(this + 0xd0) +
                     ...
                     CONCAT44(fVar25 * *(float *)(this + 0xec) +
                              ...
                              *(float *)(this + 0xfc),
                              fVar25 * *(float *)(this + 0xe8) +
                              fVar22 * *(float *)(this + 200) + fVar24 * *(float *)(this + 0xd8) +
                              *(float *)(this + 0xf8)),local_88,
                     CONCAT44(fVar5 * param_2[0xb] + fVar23 * param_2[3] + fVar4 * param_2[7] +
                              param_2[0xf],
                              fVar5 * param_2[10] + fVar23 * param_2[2] + fVar4 * param_2[6] +
                              param_2[0xe]),param_1,(undefined4)Color::sBlue);
...
void __thiscall
JPH::SoftBodyMotionProperties::DrawLRAConstraints
          (SoftBodyMotionProperties *this,long *param_1,float *param_2,int param_4)
...
void __thiscall
JPH::SoftBodyMotionProperties::DrawPredictedBounds
          (SoftBodyMotionProperties *this,DebugRenderer *param_1,Mat44 *param_2)
...
/* JPH::SoftBodyMotionProperties::SaveState(JPH::StateRecorder&) const */

void __thiscall
JPH::SoftBodyMotionProperties::SaveState(SoftBodyMotionProperties *this,StateRecorder *param_1)

{
  ...
  (**(code **)(*(long *)(param_1 + 8) + 0x10))(pSVar1,this + 0x170,0xc);
  (**(code **)(*(long *)(param_1 + 8) + 0x10))(pSVar1,this + 0x180,0xc);
...
/* JPH::SoftBodyMotionProperties::RestoreState(JPH::StateRecorder&) */

void __thiscall
JPH::SoftBodyMotionProperties::RestoreState(SoftBodyMotionProperties *this,StateRecorder *param_1)

{
  ...
  (**(code **)(*(long *)param_1 + 0x10))(param_1,this + 0x170,0xc);
  (**(code **)(*(long *)param_1 + 0x10))(param_1,this + 0x180,0xc);
  (**(code **)(*(long *)param_1 + 0x10))(param_1,this + 400,0xc);
  (**(code **)(*(long *)param_1 + 0x10))(param_1,this + 0x1a0,0xc);
  return;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* JPH::SoftBodyMotionProperties::Initialize(JPH::SoftBodyCreationSettings const&) */

void __thiscall
JPH::SoftBodyMotionProperties::Initialize
          (SoftBodyMotionProperties *this,SoftBodyCreationSettings *param_1)

{
  ...
  *(SoftBodyCreationSettings *)(this + 0x1bc) = SVar3;
  if (*(ulong *)(this + 0x110) < uVar4) {
    uVar13 = (*Reallocate)(*(undefined8 *)(this + 0x118),*(ulong *)(this + 0x110) * 0x50,
                           uVar4 * 0x50);
...
LAB_00104f93:
    ...
    do {
      ...
      fVar31 = pfVar11[2];
      auVar22._0_4_ =
           (float)*(undefined8 *)pfVar11 * fVar27 + fVar24 * fVar23 + fVar31 * fVar28 + fVar6;
      auVar22._4_4_ =
           (float)*(undefined8 *)pfVar11 * fVar21 + fVar24 * fVar32 + fVar31 * fVar29 + fVar7;
...
LAB_001050e6:
  ...
  uVar1 = _LC42;
  for (pauVar19 = (undefined1 (*) [16])(*(long *)(this + 0x150) * 0x30 + lVar14);
      pauVar19 < (undefined1 (*) [16])(lVar14 + lVar20); pauVar19 = pauVar19 + 3) {
    *pauVar19 = (undefined1  [16])0x0;
    *(undefined4 *)pauVar19[1] = uVar1;
    *(undefined4 *)(pauVar19[1] + 4) = uVar1;
    *(undefined4 *)(pauVar19[1] + 8) = uVar1;
    *(undefined4 *)(pauVar19[1] + 0xc) = uVar1;
    *(undefined4 *)pauVar19[2] = uVar1;
    *(undefined4 *)(pauVar19[2] + 4) = uVar1;
    *(undefined4 *)(pauVar19[2] + 8) = uVar1;
    *(undefined4 *)(pauVar19[2] + 0xc) = uVar1;
  }
  *(ulong *)(this + 0x150) = uVar4;
LAB_00105091:
  *(undefined8 *)(this + 400) = *(undefined8 *)(this + 0x170);
  *(undefined8 *)(this + 0x198) = *(undefined8 *)(this + 0x178);
  *(undefined8 *)(this + 0x1a0) = *(undefined8 *)(this + 0x180);
  *(undefined8 *)(this + 0x1a8) = *(undefined8 *)(this + 0x188);
...
void JPH::SoftBodyMotionProperties::DetermineCollidingShapes(JPH::SoftBodyUpdateContext_const&,JPH::
     PhysicsSystem_const&,JPH::BodyLockInterface_const&)::Collector::AddHit(JPH::BodyID_const__
...

{
  ...
  long *plVar2;
  code *pcVar3;
  Array<JPH::SoftBodyMotionProperties::CollidingShape,JPH::STLAllocator<JPH::SoftBodyMotionProperties::CollidingShape>>
  *this;
  float *pfVar4;
  undefined8 uVar5;
  float fVar6;
  ...
  if (*param_2 != 0xffffffff) {
    ...
    if (((uVar38 < *(ulong *)plVar1[1]) &&
        (puVar41 = *(undefined8 **)(((ulong *)plVar1[1])[2] + uVar38 * 8), ((ulong)puVar41 & 1) == 0
        )) && (*param_2 == *(uint *)(puVar41 + 0xe))) {
...
LAB_001052df:
        ...
        else if (((*(code **)(*plVar29 + 0x10) == SoftBodyContactListener::OnSoftBodyContactValidate
                  ) || (iVar27 = (**(code **)(*plVar29 + 0x10))(plVar29,lVar36,puVar41,&local_288),
                       iVar27 == 0)) &&
                (((local_27c != 0 || ((float)local_288 != 0.0)) ||
                 ((*(char *)(puVar41 + 0xf) == '\x02' && (local_288._4_4_ != 0.0)))))) {
LAB_00105370:
          fVar44 = _LC2;
          fStack_14c = _LC2;
          ...
          do {
            ...
            *(float *)((CollidingSensor *)&local_148 + lVar37) =
                 fVar54 * fVar33 + fVar25 * fVar45 + fVar26 * fVar8 + fVar53 * fVar11;
            *(float *)((long)&local_148 + lVar37 + 4) =
                 fVar54 * fVar34 + fVar25 * fVar52 + fVar26 * fVar9 + fVar53 * fVar12;
            *(float *)((long)&uStack_140 + lVar37) =
                 fVar54 * fVar50 + fVar25 * fVar6 + fVar26 * fVar51 + fVar53 * fVar13;
            *(float *)((long)&uStack_140 + lVar37 + 4) =
                 fVar54 * fVar55 + fVar25 * fVar7 + fVar26 * fVar10 + fVar53 * fVar14;
            uVar49 = uStack_110;
            uVar48 = local_118;
            lVar37 = lVar37 + 0x10;
          } while (lVar37 != 0x40);
          ...
          *(undefined8 **)(lVar37 + 0x20) = puVar41;
          ...
          if (0.0 <= fVar51) {
            ...
            local_318 = CONCAT44(((float)local_128 - (float)uStack_140) * fVar45,
                                 ((float)uStack_130 - local_128._4_4_) * fVar45);
          }
...
LAB_00105be8:
            fVar44 = ((float)uStack_120 - ((float)local_148 + local_138._4_4_)) + fVar44;
            if (fVar44 < 0.0) {
              fVar44 = sqrtf(fVar44);
            }
            else {
          ...
          (*pcVar3)(uVar48,uVar49,local_318,uStack_310,0x3f8000003f800000,0x3f8000003f800000,plVar29
                    ,param_1 + 0x60,&local_290,&local_278,lVar37);
            ...
            if (local_27c == 0) {
              ...
              if (cVar24 == '\x02') {
                ...
                do {
                  ...
                  *(float *)(local_188 + lVar36 + 4) =
                       *(float *)((long)afStack_1c4 + lVar36) * local_280;
                ...
                local_2e8 = fVar45 * *(float *)(param_1 + 0x20) +
                            fVar52 * *(float *)(param_1 + 0x30) + fVar6 * *(float *)(param_1 + 0x40)
                ;
                fStack_2e4 = fVar45 * *(float *)(param_1 + 0x24) +
                             fVar52 * *(float *)(param_1 + 0x34) +
                             fVar6 * *(float *)(param_1 + 0x44);
                fStack_2e0 = fVar45 * *(float *)(param_1 + 0x28) +
                             fVar52 * *(float *)(param_1 + 0x38) +
                             fVar6 * *(float *)(param_1 + 0x48);
                fStack_2dc = fVar45 * *(float *)(param_1 + 0x2c) +
                             fVar52 * *(float *)(param_1 + 0x3c) +
                             fVar6 * *(float *)(param_1 + 0x4c);
                fVar45 = pfVar4[4];
                fVar52 = pfVar4[5];
                fVar6 = pfVar4[6];
                local_2d8 = fVar45 * *(float *)(param_1 + 0x20) +
                            fVar52 * *(float *)(param_1 + 0x30) + fVar6 * *(float *)(param_1 + 0x40)
                ;
                fStack_2d4 = fVar45 * *(float *)(param_1 + 0x24) +
                             fVar52 * *(float *)(param_1 + 0x34) +
                             fVar6 * *(float *)(param_1 + 0x44);
                fStack_2d0 = fVar45 * *(float *)(param_1 + 0x28) +
                             fVar52 * *(float *)(param_1 + 0x38) +
                             fVar6 * *(float *)(param_1 + 0x48);
                fStack_2cc = fVar45 * *(float *)(param_1 + 0x2c) +
                             fVar52 * *(float *)(param_1 + 0x3c) +
                             fVar6 * *(float *)(param_1 + 0x4c);
              }
              this = *(Array<JPH::SoftBodyMotionProperties::CollidingShape,JPH::STLAllocator<JPH::SoftBodyMotionProperties::CollidingShape>>
                       **)(param_1 + 0xa0);
              ...
              *puVar42 = local_148;
              ...
              if (lVar37 * 0x60 == 0) {
                ...
                *(uint *)(puVar42 + 0xb) = local_f0;
                ...
                if (puVar35 != (undefined8 *)0x0) {
                  lVar36 = puVar42[8];
                  if (puVar30 < puVar35) {
                    for (puVar31 = puVar30; puVar31 < puVar30 + lVar36 * 0xc;
                        puVar31 = puVar31 + 0xc) {
                      uVar15 = puVar35[1];
                      uVar5 = puVar35[10];
                      uVar16 = puVar35[2];
              ...
              local_108 = lVar37;
              local_f8 = puVar39;
              Array<JPH::SoftBodyMotionProperties::CollidingSensor,JPH::STLAllocator<JPH::SoftBodyMotionProperties::CollidingSensor>>
              ::push_back(*(Array<JPH::SoftBodyMotionProperties::CollidingSensor,JPH::STLAllocator<JPH::SoftBodyMotionProperties::CollidingSensor>>
                            **)(param_1 + 0xa8),(CollidingSensor *)&local_148);
...
LAB_00105b1a:
            ...
            if (uVar38 != 0) {
              if ((CONCAT44(uStack_25c,uStack_260) != 0) &&
                 (uVar40 = CONCAT44(uStack_25c,uStack_260) * 0x60 + uVar38, uVar38 < uVar40)) {
                do {
...
undefined8
JPH::SoftBodyContactListener::OnSoftBodyContactValidate
          (Body *param_1,Body *param_2,SoftBodyContactSettings *param_3)
...
void JPH::SoftBodyContactListener::OnSoftBodyContactAdded(Body *param_1,SoftBodyManifold *param_2)
...
/* JPH::Array<JPH::SoftBodyMotionProperties::CollidingSensor,
   ...
   >::push_back(JPH::SoftBodyMotionProperties::CollidingSensor const&) */

void __thiscall
JPH::
Array<JPH::SoftBodyMotionProperties::CollidingSensor,JPH::STLAllocator<JPH::SoftBodyMotionProperties::CollidingSensor>>
::push_back(Array<JPH::SoftBodyMotionProperties::CollidingSensor,JPH::STLAllocator<JPH::SoftBodyMotionProperties::CollidingSensor>>
            *this,CollidingSensor *param_1)
...
/* JPH::Array<JPH::SoftBodyMotionProperties::CollidingShape,
   JPH::STLAllocator<JPH::SoftBodyMotionProperties::CollidingShape> >::reallocate(unsigned long) */

void __thiscall
JPH::
Array<JPH::SoftBodyMotionProperties::CollidingShape,JPH::STLAllocator<JPH::SoftBodyMotionProperties::CollidingShape>>
::reallocate(Array<JPH::SoftBodyMotionProperties::CollidingShape,JPH::STLAllocator<JPH::SoftBodyMotionProperties::CollidingShape>>
             *this,ulong param_1)
...
void JPH::SoftBodyMotionProperties::_GLOBAL__sub_I_CalculateMassAndInertia(void)

...
/* renormalizeValue(double, Triple const&, TripleDistances const&, bool) */

double renormalizeValue(double param_1,Triple *param_2,TripleDistances *param_3,bool param_4)
...
LAB_0010107d:
  ...
  if (dVar2 != local_50[0]) {
    if (dVar2 < 0.0) {
      ...
      uVar4 = renormalizeValue((double)((ulong)local_50[0] ^ _LC3),(Triple *)&local_28,
                               (TripleDistances *)&local_38,param_4);
...
/* rebase_tent(Triple, Triple, TripleDistances) */

uint * rebase_tent(undefined8 param_1,undefined8 param_2,uint *param_3)
  ...
  do {
    ...
    if (dVar11 != 0.0) {
      if (((pdVar7[1] != 0.0) || (pdVar7[2] != 0.0)) || (pdVar7[3] != 0.0)) {
        dVar9 = pdVar7[2];
        dVar10 = pdVar7[3];
        dVar8 = (double)renormalizeValue(pdVar7[1],(Triple *)&stack0x00000020,
                                         (TripleDistances *)&local_68,true);
        dVar9 = (double)renormalizeValue(dVar9,(Triple *)&stack0x00000020,
                                         (TripleDistances *)&local_68,true);
        dVar10 = (double)renormalizeValue(dVar10,(Triple *)&stack0x00000020,
                                          (TripleDistances *)&local_68,true);
        uVar5 = param_3[1];
        uVar1 = (ulong)uVar5;
        uVar6 = *param_3;

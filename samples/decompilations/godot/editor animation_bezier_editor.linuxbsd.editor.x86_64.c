...
/* AnimationBezierTrackEdit::get_minimum_size() const */

undefined8 AnimationBezierTrackEdit::get_minimum_size(void)
...
/* AnimationBezierTrackEdit::_zoom_changed() */

void AnimationBezierTrackEdit::_zoom_changed(void)
...
/* AnimationBezierTrackEdit::_bezier_track_insert_key_at_anim(Ref<Animation> const&, int, double,
   float, Vector2 const&, Vector2 const&, Animation::HandleMode) */

void __thiscall
AnimationBezierTrackEdit::_bezier_track_insert_key_at_anim
          (double param_3,float param_4,undefined8 param_3_00,undefined8 *param_1,uint param_2,
          Vector2 *param_5,undefined8 param_7,undefined4 param_8)

{
  undefined4 uVar1;
  
  uVar1 = Animation::bezier_track_insert_key
                    ((int)*param_1,param_3,param_4,(Vector2 *)(ulong)param_2,param_5);
...
/* CowData<AnimationBezierTrackEdit::EditPoint>::_copy_on_write() [clone .isra.0] */

void __thiscall
CowData<AnimationBezierTrackEdit::EditPoint>::_copy_on_write
          (CowData<AnimationBezierTrackEdit::EditPoint> *this)
...
/* void EditorUndoRedoManager::add_undo_method<Ref<Animation>, int, float, bool>(Object*, StringName
   const&, Ref<Animation>, int, float, bool) [clone .isra.0] */

void __thiscall
EditorUndoRedoManager::add_undo_method<Ref<Animation>,int,float,bool>
          (float param_1_00,EditorUndoRedoManager *this,StringName *param_1,Variant **param_2,
          Object *param_5,int param_6,bool param_7)
...
void __thiscall
EditorUndoRedoManager::add_do_method<Ref<Animation>,int,float,bool>
          (float param_1_00,EditorUndoRedoManager *this,StringName *param_1,Variant **param_2,
          Object *param_5,int param_6,bool param_7)
...
/* void EditorUndoRedoManager::add_undo_method<Ref<Animation> >(Object*, StringName const&,
   Ref<Animation>) [clone .isra.0] */

void __thiscall
EditorUndoRedoManager::add_undo_method<Ref<Animation>>
          (EditorUndoRedoManager *this,StringName *param_1,Variant **param_2,Object *param_4)
...
void __thiscall
EditorUndoRedoManager::add_do_method<Ref<Animation>>
          (EditorUndoRedoManager *this,StringName *param_1,Variant **param_2,Object *param_4)
...
/* AnimationBezierTrackEdit::_play_position_draw() */

void __thiscall AnimationBezierTrackEdit::_play_position_draw(AnimationBezierTrackEdit *this)

{
  ...
  if ((*(long *)(this + 0x9e8) != 0) &&
     (local_48 = auVar2, 0.0 < *(float *)(this + 0x9e0) || *(float *)(this + 0x9e0) == 0.0)) {
    ...
    if (iVar3 <= iVar4) {
      ...
      if (fVar5 < fVar6) {
        if (_play_position_draw()::{lambda()#1}::operator()()::sname == '\0') {
          iVar3 = __cxa_guard_acquire(&_play_position_draw()::{lambda()#1}::operator()()::sname);
          if (iVar3 != 0) {
            _scs_create((char *)&_play_position_draw()::{lambda()#1}::operator()()::sname,true);
            __cxa_atexit(StringName::~StringName,
                         &_play_position_draw()::{lambda()#1}::operator()()::sname,&__dso_handle);
        ...
        local_48 = Control::get_theme_color
                             ((StringName *)this,
                              (StringName *)
                              &_play_position_draw()::{lambda()#1}::operator()()::sname);
...
void __thiscall
AnimationBezierTrackEdit::_pan_callback
          (undefined8 param_1,AnimationBezierTrackEdit *this,long *param_3)

{
  ...
  if (((*param_3 != 0) &&
      (pOVar3 = (Object *)
                __dynamic_cast(*param_3,&Object::typeinfo,&InputEventMouseMotion::typeinfo,0),
    ...
    if (fVar4 <= (float)iVar2) {
      ...
      *(float *)(this + 0xaa8) = fVar5;
      if ((fVar5 < fVar4) || (fVar4 = 0.0, 0.0 < fVar5)) {
      ...
      fVar5 = _LC13;
      if ((_LC13 <= fVar4) && (fVar5 = fVar4, _LC14 < fVar4)) {
        fVar5 = _LC14;
      }
...
void __thiscall
AnimationBezierTrackEdit::_zoom_callback
          (float param_1,undefined8 param_2,AnimationBezierTrackEdit *this,long *param_4)
...
LAB_00100fdb:
    ...
    pOVar4 = (Object *)
             __dynamic_cast(local_38,&Object::typeinfo,&InputEventWithModifiers::typeinfo,0);
    if (pOVar4 == (Object *)0x0) {
      ...
      if (cVar3 == '\0') {
        ...
        if (cVar3 != '\0') {
          ...
          fVar7 = _LC16;
          if ((_LC20 <= (double)param_1) && (fVar7 = param_1, _LC14 < param_1)) {
            fVar7 = _LC14;
          }
...
LAB_00100e43:
  fVar7 = *(float *)(this + 0xab0);
  Control::get_size();
  *(float *)(this + 0xab0) =
       (float)(((double)(float)((ulong)param_2 >> 0x20) - (double)extraout_XMM0_Db * __LC21) *
               (double)(*(float *)(this + 0xab4) - fVar1) + (double)fVar7);
  CanvasItem::queue_redraw();
...
void __thiscall
RBSet<Pair<int,int>,AnimationBezierTrackEdit::PairCompare,DefaultAllocator>::_insert
          (RBSet<Pair<int,int>,AnimationBezierTrackEdit::PairCompare,DefaultAllocator> *this,
          Pair *param_1)
...
void __thiscall
AnimationBezierTrackEdit::_select_at_anim
          (AnimationBezierTrackEdit *this,Ref *param_1,int param_2,float param_3,bool param_4)
    ...
    if (cVar3 != '\0') {
      ...
      if (iVar4 < 0) {
        if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
          _err_print_error("_select_at_anim","editor/animation_bezier_editor.cpp",0x37f,
                           "Condition \"idx < 0\" is true.",0,0);
          return;
        }
      }
      else {
        ...
        RBSet<Pair<int,int>,AnimationBezierTrackEdit::PairCompare,DefaultAllocator>::_insert
                  ((RBSet<Pair<int,int>,AnimationBezierTrackEdit::PairCompare,DefaultAllocator> *)
                   (this + 0xba0),(Pair *)&local_d0);
        if (_select_at_anim(Ref<Animation>const&,int,float,bool)::{lambda()#1}::operator()()::sname
            == '\0') {
          iVar5 = __cxa_guard_acquire(&_select_at_anim(Ref<Animation>const&,int,float,bool)::
                                       {lambda()#1}::operator()()::sname);
          if (iVar5 != 0) {
            _scs_create((char *)&_select_at_anim(Ref<Animation>const&,int,float,bool)::{lambda()#1}
                                 ::operator()()::sname,true);
            __cxa_atexit(StringName::~StringName,
                         &_select_at_anim(Ref<Animation>const&,int,float,bool)::{lambda()#1}::
        ...
        local_b8 = local_78;
        (**(code **)(*(long *)this + 0xd0))
                  (this,&_select_at_anim(Ref<Animation>const&,int,float,bool)::{lambda()#1}::
...
undefined8 __thiscall
AnimationBezierTrackEdit::_bezier_h_to_pixel(AnimationBezierTrackEdit *this,float param_1)
...
void __thiscall
AnimationBezierTrackEdit::_draw_line_clipped
          (AnimationBezierTrackEdit *this,Vector2 *param_1,Vector2 *param_2,Color *param_3,
  ...
  if (bVar3) {
    ...
    if ((float)local_30 <= fVar7) {
      ...
      if (bVar3) {
        ...
        local_28 = CONCAT44((local_28._4_4_ - local_30._4_4_) * fVar7 + local_30._4_4_,
                            fVar5 * fVar7 + (float)local_30);
      }
      if ((float)local_30 < fVar6) {
        fVar6 = (fVar6 - (float)local_30) / ((float)local_28 - (float)local_30);
        local_30 = CONCAT44(((float)((ulong)local_28 >> 0x20) - local_30._4_4_) * fVar6 +
                            local_30._4_4_,
                            ((float)local_28 - (float)local_30) * fVar6 + (float)local_30);
      }
      fVar6 = (float)EditorScale::get_scale();
      fVar6 = roundf(fVar6);
      CanvasItem::draw_line
                ((Vector2 *)this,(Vector2 *)&local_30,(Color *)&local_28,fVar6,SUB81(param_3,0));
      uVar2 = local_30;
      uVar1 = local_28;
    }
  }
...
void __thiscall
AnimationBezierTrackEdit::set_animation_and_track
          (AnimationBezierTrackEdit *this,Ref *param_1,int param_2,bool param_3)
...
void __thiscall
AnimationBezierTrackEdit::set_editor(AnimationBezierTrackEdit *this,AnimationTrackEditor *param_1)
...
void __thiscall
AnimationBezierTrackEdit::set_play_position(AnimationBezierTrackEdit *this,float param_1)
...
void __thiscall AnimationBezierTrackEdit::set_root(AnimationBezierTrackEdit *this,Node *param_1)
...
void __thiscall
AnimationBezierTrackEdit::_zoom_vertically
          (AnimationBezierTrackEdit *this,float param_1,float param_2)

{
  ...
  *(float *)(this + 0xab0) = (param_2 + param_1) * _LC37;
  ...
  Control::get_size();
  *(float *)(this + 0xab4) =
       (float)((double)(param_2 - param_1) /
              ((double)(extraout_XMM0_Db - extraout_XMM0_Db_00) * __LC38));
  return;
}
...
void __thiscall
AnimationBezierTrackEdit::set_timeline
          (AnimationBezierTrackEdit *this,AnimationTimelineEdit *param_1)

{
  ...
  *(AnimationTimelineEdit **)(this + 0x9c8) = param_1;
  ...
  create_custom_callable_function_pointer<AnimationBezierTrackEdit>
            (local_58,(char *)this,(_func_void *)"&AnimationBezierTrackEdit::_zoom_changed");
...
void __thiscall AnimationBezierTrackEdit::_clear_selection(AnimationBezierTrackEdit *this)

{
  ...
  lVar1 = *(long *)(in_FS_OFFSET + 0x28);
  RBSet<Pair<int,int>,AnimationBezierTrackEdit::PairCompare,DefaultAllocator>::clear
            ((RBSet<Pair<int,int>,AnimationBezierTrackEdit::PairCompare,DefaultAllocator> *)
             (this + 0xba0));
  if (_clear_selection()::{lambda()#1}::operator()()::sname == '\0') {
    iVar2 = __cxa_guard_acquire(&_clear_selection()::{lambda()#1}::operator()()::sname);
    if (iVar2 != 0) {
      _scs_create((char *)&_clear_selection()::{lambda()#1}::operator()()::sname,true);
      __cxa_atexit(StringName::~StringName,&_clear_selection()::{lambda()#1}::operator()()::sname,
                   &__dso_handle);
      __cxa_guard_release(&_clear_selection()::{lambda()#1}::operator()()::sname);
    }
  }
  (**(code **)(*(long *)this + 0xd0))
            (this,&_clear_selection()::{lambda()#1}::operator()()::sname,0,0);
  if (Variant::needs_deinit[0] != '\0') {
    Variant::_clear_internal();
  }
  if (lVar1 == *(long *)(in_FS_OFFSET + 0x28)) {
...
/* AnimationBezierTrackEdit::_clear_selection_for_anim(Ref<Animation> const&) */

void __thiscall
AnimationBezierTrackEdit::_clear_selection_for_anim(AnimationBezierTrackEdit *this,Ref *param_1)
...
/* AnimationBezierTrackEdit::_is_track_displayed(int) */

undefined8 AnimationBezierTrackEdit::_is_track_displayed(int param_1)
...
uint __thiscall
AnimationBezierTrackEdit::_is_track_curves_displayed(AnimationBezierTrackEdit *this,int param_1)
  ...
  if ((((char)uVar10 != '\0') && (*(long *)(this + 0xa78) != 0)) && (*(int *)(this + 0xa9c) != 0)) {
    ...
    if (uVar11 != 0) {
      ...
      do {
        if ((uVar17 == uVar11) &&
           (*(int *)(*(long *)(this + 0xa78) +
                    (ulong)*(uint *)(*(long *)(this + 0xa80) + lVar14 * 4) * 4) == param_1)) {
          return 0;
        }
        uVar16 = uVar16 + 1;
        auVar3._8_8_ = 0;
        ...
        iVar12 = SUB164(auVar3 * auVar7,8);
              ...
              auVar8._0_8_ = uVar15, auVar5._8_8_ = 0,
              auVar5._0_8_ = ((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0xa98) * 4
...
void __thiscall AnimationBezierTrackEdit::auto_fit_vertically(AnimationBezierTrackEdit *this)
...
LAB_00102ae8:
      ...
      if ((*(long *)(this + 0xa78) != 0) && (*(int *)(this + 0xa9c) != 0)) {
        ...
        if (uVar20 != 0) {
          ...
          do {
            if ((uVar27 == uVar20) &&
               (*(uint *)(*(long *)(this + 0xa78) +
                         (ulong)*(uint *)(*(long *)(this + 0xa80) + lVar22 * 4) * 4) == uVar24))
            goto LAB_00102ae8;
            uVar26 = uVar26 + 1;
            auVar3._8_8_ = 0;
            ...
            iVar21 = SUB164(auVar3 * auVar11,8);
                  ...
                  (auVar4._8_8_ = 0, auVar4._0_8_ = uVar20 * uVar1, auVar12._8_8_ = 0,
                  auVar12._0_8_ = uVar25, auVar5._8_8_ = 0,
                  auVar5._0_8_ = ((*(uint *)(hash_table_size_primes +
                                            (ulong)*(uint *)(this + 0xa98) * 4) + iVar21) -
                                 SUB164(auVar4 * auVar12,8)) * uVar1, auVar13._8_8_ = 0,
                  auVar13._0_8_ = uVar25, uVar26 <= SUB164(auVar5 * auVar13,8)));
        }
      }
      if ((*(long *)(this + 0xa50) != 0) && (*(int *)(this + 0xa74) != 0)) {
        ...
        if (uVar20 != 0) {
          ...
          do {
            if ((uVar27 == uVar20) &&
               (*(uint *)(*(long *)(this + 0xa50) +
                         (ulong)*(uint *)(*(long *)(this + 0xa58) + lVar22 * 4) * 4) == uVar24))
            goto LAB_00102ae8;
            uVar26 = uVar26 + 1;
            auVar7._8_8_ = 0;
            ...
            iVar21 = SUB164(auVar7 * auVar15,8);
                  ...
                  (auVar8._8_8_ = 0, auVar8._0_8_ = uVar20 * uVar1, auVar16._8_8_ = 0,
                  auVar16._0_8_ = uVar25, auVar9._8_8_ = 0,
                  auVar9._0_8_ = ((*(uint *)(hash_table_size_primes +
                                            (ulong)*(uint *)(this + 0xa70) * 4) + iVar21) -
                                 SUB164(auVar8 * auVar16,8)) * uVar1, auVar17._8_8_ = 0,
                  auVar17._0_8_ = uVar25, uVar26 <= SUB164(auVar9 * auVar17,8)));
        }
      }
      ...
      if (0 < iVar21) {
        iVar28 = 0;
        do {
          fVar29 = (float)Animation::bezier_track_get_key_value
                                    ((int)*(undefined8 *)(this + 0x9e8),uVar24);
          fVar33 = fVar29;
          if (fVar29 <= local_4c) {
            fVar33 = local_4c;
          }
...
LAB_00102af7:
    if (((local_3c != 0) && ((float)((uint)fVar30 & _LC54) <= _LC55)) &&
       ((float)(_LC54 & (uint)local_4c) <= _LC55)) {
      if (_LC36 < (double)(local_4c - fVar30)) {
        *(float *)(this + 0xab0) = (fVar30 + local_4c) * _LC37;
        Control::get_size();
        Control::get_size();
        *(float *)(this + 0xab4) =
             (float)((double)(local_4c - fVar30) /
                    ((double)(extraout_XMM0_Db_01 - extraout_XMM0_Db_02) * __LC38));
      }
      else {
...
void AnimationBezierTrackEdit::_change_selected_keys_handle_mode
               (long param_1,int param_2,uint param_3,undefined8 param_4,undefined8 param_5,
               undefined8 param_6)
  ...
  if (*(long *)(param_1 + 0xba0) != 0) {
    ...
    if (lVar2 != *(long *)(param_1 + 0xba8)) {
      ...
      do {
        ...
        iVar6 = Animation::bezier_track_get_key_handle_mode
                          ((int)*(undefined8 *)(param_1 + 0x9e8),iVar5);
        ...
        EditorUndoRedoManager::add_undo_methodp
                  (pOVar7,pSVar4,(Variant **)this,(int)(Vector2 *)&local_258);
        pVVar9 = local_d8;
        do {
          pVVar1 = pVVar9 + -0x18;
          pVVar9 = pVVar9 + -0x18;
        ...
        uVar10 = Animation::bezier_track_get_key_in_handle
                           ((int)*(undefined8 *)(param_1 + 0x9e8),iVar5);
        ...
        uVar10 = Animation::bezier_track_get_key_out_handle
                           ((int)*(undefined8 *)(param_1 + 0x9e8),iVar5);
...
void __thiscall AnimationBezierTrackEdit::delete_selection(AnimationBezierTrackEdit *this)

{
  ...
  if (*(long *)(this + 0xba0) != 0) {
    ...
    if (lVar3 != *(long *)(this + 0xba8)) {
      ...
      do {
        ...
        dVar11 = (double)Animation::track_get_key_time
                                   ((int)*(undefined8 *)(this + 0x9e8),*(int *)(lVar10 + 0x30));
        ...
        EditorUndoRedoManager::add_undo_methodp
                  (pOVar7,pSVar4,(Variant **)&local_158,(int)(Variant *)&local_108);
  ...
  EditorUndoRedoManager::add_do_methodp
            (pOVar7,(StringName *)this,(Variant **)&local_160,(int)local_148);
...
/* AnimationBezierTrackEdit::delete_selection() */
...
void __thiscall AnimationBezierTrackEdit::AnimationBezierTrackEdit(AnimationBezierTrackEdit *this)
...
LAB_00104166:
  ...
  *(Control **)(this + 0x9d8) = this_01;
  ...
  create_custom_callable_function_pointer<AnimationBezierTrackEdit>
            ((AnimationBezierTrackEdit *)&local_58,(char *)this,
             (_func_void *)"&AnimationBezierTrackEdit::_play_position_draw");
...
void __thiscall
AnimationBezierTrackEdit::duplicate_selected_keys
          (AnimationBezierTrackEdit *this,float param_1,bool param_2)

{
  ...
  if (*(long *)(this + 0xba0) == 0) {
    ...
    if (lVar10 == *(long *)(this + 0xba8)) {
      ...
      local_430 = _LC84;
      do {
        dVar18 = (double)Animation::track_get_key_time
                                   ((int)*(undefined8 *)(this + 0x9e8),*(int *)(lVar11 + 0x30));
    ...
    if (*(long *)local_438[1] == *(long *)(this + 0xba8)) {
      ...
      do {
        ...
        if (param_2) {
          ...
          fVar16 = param_1;
          if ((cVar6 != '\0') && (dVar19 = (double)Range::get_value(), dVar19 != 0.0)) {
            fVar16 = (float)AnimationTrackEditor::snap_time
                                      (param_1,SUB81(*(undefined8 *)(this + 0xb88),0));
          }
        }
        else {
        ...
        iVar7 = Animation::track_find_key
                          ((double)fVar16,*(undefined8 *)(this + 0x9e8),
                           *(undefined4 *)(lVar11 + 0x30),1,0,0);
        fVar17 = (float)Animation::track_get_key_transition
                                  ((int)*(undefined8 *)(this + 0x9e8),*(int *)(lVar11 + 0x30));
        ...
        *(int *)local_438[1] = *(int *)local_438[1] + 1;
        if (iVar7 != -1) {
          ...
          Animation::track_get_key_value
                    ((int)(Variant *)local_288,(int)*(undefined8 *)(this + 0x9e8));
  ...
  EditorUndoRedoManager::add_do_methodp
            (pOVar8,(StringName *)this,(Variant **)&local_2f0,(int)local_448);
  ...
  Ref<Animation>::unref((Ref<Animation> *)&local_2e8);
  if ((local_438 != (undefined1 (*) [16])0x0) &&
     (piVar15 = *(int **)*local_438, piVar15 != (int *)0x0)) {
    iVar13 = 0;
    do {
      iVar7 = *piVar15;
      ...
      EditorUndoRedoManager::add_do_methodp
                (pOVar8,(StringName *)this,(Variant **)&local_2e8,(int)local_458);
      pVVar14 = local_c0;
      do {
        pVVar1 = pVVar14 + -0x18;
        pVVar14 = pVVar14 + -0x18;
...
LAB_00105722:
    Memory::free_static(local_438,false);
  }
LAB_0010572e:
  if (local_40[0] != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
...
void __thiscall
AnimationBezierTrackEdit::paste_keys(AnimationBezierTrackEdit *this,float param_1,bool param_2)
  ...
  if (lVar11 != 0) {
    ...
    do {
      ...
      if (local_138._4_4_ != 0) {
        ...
        _err_print_error("paste_keys","editor/animation_bezier_editor.cpp",0x75c,
                         "Pasted animation keys from multiple tracks into single Bezier track",0,1);
        lVar12 = *(long *)(*(long *)(this + 0xb88) + 0xcf0);
        goto LAB_00105db7;
      }
      cVar8 = AnimationTrackEditor::_is_track_compatible
                        (*(undefined8 *)(this + 0xb88),*(undefined4 *)(this + 0x9f4),(int)uStack_128
                         ,local_138._0_1_);
      if (cVar8 == '\0') {
        if (Variant::needs_deinit[(int)uStack_128] != '\0') {
          Variant::_clear_internal();
        }
        _err_print_error("paste_keys","editor/animation_bezier_editor.cpp",0x75a,
                         "Condition \"!all_compatible\" is true.",
                         "Paste failed: Not all animation keys were compatible with their target tracks"
                         ,0,0);
        goto LAB_00106aba;
      }
      if (Variant::needs_deinit[(int)uStack_128] != '\0') {
      ...
      do {
        ...
        if (param_2) {
          ...
          if (cVar8 != '\0') {
            ...
            if (dVar22 != 0.0) {
              fVar20 = (float)AnimationTrackEditor::snap_time
                                        (param_1,SUB81(*(undefined8 *)(this + 0xb88),0));
            }
          }
        }
        ...
        iVar9 = Animation::track_find_key
                          ((double)fVar20,*(undefined8 *)(this + 0x9e8),
                           *(undefined4 *)(this + 0x9f4),1,0,0);
        ...
        *(int *)local_378[1] = *(int *)local_378[1] + 1;
        if (iVar9 != -1) {
          fVar21 = (float)Animation::track_get_key_transition
                                    ((int)*(undefined8 *)(this + 0x9e8),*(int *)(this + 0x9f4));
...
LAB_00106345:
  ...
  Ref<Animation>::unref((Ref<Animation> *)&local_308);
  if ((local_378 != (undefined1 (*) [16])0x0) &&
     (piVar18 = *(int **)*local_378, piVar18 != (int *)0x0)) {
    iVar19 = 0;
    do {
      iVar14 = *piVar18;
  ...
  if (*(long *)(this + 0xba0) != 0) {
    ...
    if (lVar12 != *(long *)(this + 0xba8)) {
      ...
      iVar9 = 0;
      do {
        dVar22 = (double)Animation::track_get_key_time
                                   ((int)*(undefined8 *)(this + 0x9e8),*(int *)(lVar11 + 0x30));
        ...
        uStack_128 = local_88;
        EditorUndoRedoManager::add_undo_methodp
                  (pOVar10,(StringName *)this,(Variant **)&local_308,(int)(Variant *)&local_138);
...

{
  ...
  if (((cVar2 != '\0') && (*(long *)(this + 0x9e8) != 0)) &&
     (iVar1 = *(int *)(this + 0x9f4), -1 < iVar1)) {
...
void __thiscall AnimationBezierTrackEdit::set_filtered(AnimationBezierTrackEdit *this,bool param_1)

{
  ...
  if ((this[0xaa4] != (AnimationBezierTrackEdit)0x0) &&
     (pNVar2 = *(NodePath **)(this + 0x9d0), pNVar2 != (NodePath *)0x0)) {
          ...
          if (pNVar2 != (NodePath *)0x0) {
            ...
            if (cVar3 != '\0') {
              ...
              if (lVar5 != 0) {
                ...
                if (cVar3 != '\0') {
                  AVar1 = this[0x9f0];
                  Ref<Animation>::operator=
                            ((Ref<Animation> *)(this + 0x9e8),*(Ref **)(this + 0x9e8));
                  this[0x9f0] = AVar1;
...

{
  ...
  local_50 = (undefined1  [16])0x0;
  local_58 = 0;
  pMVar11 = create_method_bind<AnimationBezierTrackEdit,Ref<Animation>const&>
  ...
  local_50 = (undefined1  [16])0x0;
  local_58 = 0;
  pMVar11 = create_method_bind<AnimationBezierTrackEdit,Ref<Animation>const&,int,float,bool>
                      (_select_at_anim);
  ClassDB::bind_methodfi(1,pMVar11,false,(MethodDefinition *)&local_c8,(Variant **)0x0,0);
  if (Variant::needs_deinit[(int)local_58] != '\0') {
    Variant::_clear_internal();
  ...
  local_50 = (undefined1  [16])0x0;
  local_58 = 0;
  pMVar11 = create_method_bind<AnimationBezierTrackEdit,Ref<Animation>const&,int,double,float,Vector2_const&,Vector2_const&,Animation::HandleMode>
  ...
  PropertyInfo::PropertyInfo
            ((PropertyInfo *)&local_188,2,(StrRange *)&local_208,0,(StrRange *)&local_200,6,
             &local_1f8);
  local_210 = 0;
  local_218 = 0;
  local_c8 = "";
  ...
  PropertyInfo::PropertyInfo
            ((PropertyInfo *)&local_1b8,1,(StrRange *)&local_220,0,(StrRange *)&local_218,6,
             (StrRange *)&local_210);
  local_228 = 0;
  local_230 = 0;
  local_c8 = "";
  ...
  PropertyInfo::PropertyInfo
            ((PropertyInfo *)local_1e8,2,(StrRange *)&local_238,0,(StrRange *)&local_230,6,
             &local_228);
  local_1f0 = 0;
  local_c8 = "select_key";
  local_c0 = 10;
  ...
  String::parse_latin1((StrRange *)&local_1f0);
  PropertyInfo::PropertyInfo
            ((PropertyInfo *)&local_128,2,(StrRange *)&local_1f0,0,(PropertyInfo *)local_1e8,6,
  ...
  String::parse_latin1((StrRange *)&local_208);
  PropertyInfo::PropertyInfo
            ((PropertyInfo *)&local_158,2,(StrRange *)&local_208,0,(StrRange *)&local_200,6,
             &local_1f8);
...
void __thiscall
AnimationBezierTrackEdit::_update_hidden_tracks_after(AnimationBezierTrackEdit *this,int param_1)
...
LAB_00108a0b:
    ...
    if (uVar12 != 0) {
      ...
      do {
        if ((local_80 == uVar12) &&
           (param_1 == *(int *)(lVar18 + (ulong)*(uint *)(*(long *)(this + 0xa80) + lVar15 * 4) * 4)
           )) {
          HashSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>>::erase
        ...
        iVar13 = SUB164(auVar4 * auVar8,8);
              ...
              auVar6._0_8_ = ((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0xa98) * 4
                                        ) + iVar13) - SUB164(auVar5 * auVar9,8)) * uVar2,
              auVar10._8_8_ = 0, auVar10._0_8_ = uVar16, uVar17 <= SUB164(auVar6 * auVar10,8)));
    }
  }
  local_60 = 0;
  for (lVar15 = 0; Vector<int>::push_back(local_68,*(int *)(lVar18 + lVar15 * 4)), lVar11 = local_60
      , (int)lVar15 + 1 < iVar19; lVar15 = lVar15 + 1) {
  }
  if ((*(long *)(this + 0xa78) != 0) && (*(int *)(this + 0xa9c) != 0)) {
    if (*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0xa98) * 4) != 0) {
      memset(*(void **)(this + 0xa90),0,
             (ulong)*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0xa98) * 4) * 4);
    }
...
void __thiscall
AnimationBezierTrackEdit::_update_locked_tracks_after(AnimationBezierTrackEdit *this,int param_1)
...
LAB_00108ceb:
    ...
    if (uVar12 != 0) {
      ...
      do {
        if ((local_80 == uVar12) &&
           (param_1 == *(int *)(lVar18 + (ulong)*(uint *)(*(long *)(this + 0xa58) + lVar15 * 4) * 4)
           )) {
          HashSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>>::erase
                    ((HashSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>> *)
                     (this + 0xa50),local_7c);
        ...
        iVar13 = SUB164(auVar4 * auVar8,8);
              ...
              (auVar5._8_8_ = 0, auVar5._0_8_ = uVar12 * uVar2, auVar9._8_8_ = 0,
              auVar9._0_8_ = uVar16, auVar6._8_8_ = 0,
              auVar6._0_8_ = ((*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0xa70) * 4
                                        ) + iVar13) - SUB164(auVar5 * auVar9,8)) * uVar2,
              auVar10._8_8_ = 0, auVar10._0_8_ = uVar16, uVar17 <= SUB164(auVar6 * auVar10,8)));
    }
  }
  ...
  if ((*(long *)(this + 0xa50) != 0) && (*(int *)(this + 0xa74) != 0)) {
    if (*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0xa70) * 4) != 0) {
      memset(*(void **)(this + 0xa68),0,
             (ulong)*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0xa70) * 4) * 4);
    }
...
undefined8 __thiscall
AnimationBezierTrackEdit::_try_select_at_ui_pos
          (AnimationBezierTrackEdit *this,Vector2 *param_1,bool param_2,bool param_3)
...
LAB_00108ec0:
    if (lVar17 < *(long *)(lVar12 + -8)) {
      ...
      if (((*(float *)(param_1 + 4) < pfVar2[1]) || (*pfVar2 + pfVar2[2] <= fVar3)) ||
         (pfVar2[1] + pfVar2[3] <= *(float *)(param_1 + 4))) goto LAB_00109000;
      ...
      if (!param_2) {
        if (param_3) {
          ...
          *(float *)(this + 0xacc) = fVar3;
          uVar10 = Animation::bezier_track_get_key_in_handle
                             ((int)*(undefined8 *)(this + 0x9e8),iVar5);
...
LAB_001090d0:
        ...
        if (lVar16 <= lVar17) goto LAB_00109243;
        dVar18 = (double)Animation::track_get_key_time
                                   ((int)*(undefined8 *)(this + 0x9e8),
                                    *(int *)(lVar12 + lVar14 + 0x30));
        lVar12 = *(long *)(this + 0xb98);
        if (lVar12 == 0) goto LAB_00109240;
        lVar16 = *(long *)(lVar12 + -8);
        if (lVar16 <= lVar17) goto LAB_00109243;
        _select_at_anim(this,(Ref *)(this + 0x9e8),*(int *)(lVar12 + 0x30 + lVar14),(float)dVar18,
                        true);
        goto LAB_00108fef;
      }
...
LAB_00108f95:
  dVar18 = (double)Animation::track_get_key_time((int)*(undefined8 *)(this + 0x9e8),iVar5);
  lVar12 = *(long *)(this + 0xb98);
  if (lVar12 == 0) goto LAB_00109240;
  lVar16 = *(long *)(lVar12 + -8);
  if (lVar16 <= lVar17) goto LAB_00109243;
...
LAB_00109243:
  _err_print_index_error
            ("get","./core/templates/cowdata.h",0xdb,lVar17,lVar16,"p_index","size()","",false,true)
  ;
  _err_flush_stdout();
                    /* WARNING: Does not return */
  ...
  do {
    if (iVar5 == *(int *)(pEVar15 + 0x30)) {
      if (*(int *)(pEVar15 + 0x34) <= iVar6) {
        ...
        RBSet<Pair<int,int>,AnimationBezierTrackEdit::PairCompare,DefaultAllocator>::_erase
                  ((RBSet<Pair<int,int>,AnimationBezierTrackEdit::PairCompare,DefaultAllocator> *)
                   (this + 0xba0),pEVar15);
...
LAB_001092c8:
  ...
  iVar5 = *(int *)(lVar12 + 0x30);
  iVar6 = *(int *)(lVar12 + 0x34);
  if ((_try_select_at_ui_pos(Vector2_const&,bool,bool)::{lambda()#1}::operator()()::sname == '\0')
     && (iVar9 = __cxa_guard_acquire(&_try_select_at_ui_pos(Vector2_const&,bool,bool)::{lambda()#1}
                                      ::operator()()::sname), iVar9 != 0)) {
    _scs_create((char *)&_try_select_at_ui_pos(Vector2_const&,bool,bool)::{lambda()#1}::operator()()
                         ::sname,true);
    __cxa_atexit(StringName::~StringName,
                 &_try_select_at_ui_pos(Vector2_const&,bool,bool)::{lambda()#1}::operator()()::sname
                 ,&__dso_handle);
    __cxa_guard_release(&_try_select_at_ui_pos(Vector2_const&,bool,bool)::{lambda()#1}::operator()()
                         ::sname);
  }
  ...
  pVStack_a0 = local_70;
  (**(code **)(*(long *)this + 0xd0))
            (this,&_try_select_at_ui_pos(Vector2_const&,bool,bool)::{lambda()#1}::operator()()::
                   sname,&local_a8,2);
  do {
    pVVar1 = pVVar13 + -0x18;
...
/* AnimationBezierTrackEdit::copy_selected_keys(bool) [clone .part.0] */

void __thiscall
AnimationBezierTrackEdit::copy_selected_keys(AnimationBezierTrackEdit *this,bool param_1)

{
  ...
  float fVar20;
  double dVar21;
  RBMap<AnimationTrackEditor::SelectedKey,AnimationTrackEditor::KeyInfo,Comparator<AnimationTrackEditor::SelectedKey>,DefaultAllocator>
  *local_2d0;
  int local_284;
  undefined8 local_1e0;
  long local_1d8;
  ...
  if (*(long *)(this + 0xba0) != 0) {
    ...
    if (lVar3 != *(long *)(this + 0xba8)) {
      ...
      do {
        dVar21 = (double)Animation::track_get_key_time
                                   ((int)*(undefined8 *)(this + 0x9e8),*(int *)(lVar15 + 0x30));
        ...
        if (lVar3 != *(long *)(this + 0xba8)) {
          ...
          do {
            ...
            if (local_1c8 == (Element *)0x0) {
              ...
              *(Element **)(pEVar12 + 8) = pEStack_1c0;
              *(Element **)(pEVar12 + 0x10) = pEStack_1c0;
              *(Element **)(pEVar12 + 0x18) = pEStack_1c0;
              local_1c8 = pEVar12;
            }
            else {
...
LAB_00109694:
              *(Element **)(pEVar9 + 0x28) = pEVar12;
              if (pEVar11 != (Element *)0x0) {
LAB_0010969d:
                *(Element **)(pEVar11 + 0x28) = pEVar9;
...
LAB_001096ae:
            ...
            RBMap<AnimationTrackEditor::SelectedKey,AnimationTrackEditor::KeyInfo,Comparator<AnimationTrackEditor::SelectedKey>,DefaultAllocator>
            ::_insert_rb_fix((RBMap<AnimationTrackEditor::SelectedKey,AnimationTrackEditor::KeyInfo,Comparator<AnimationTrackEditor::SelectedKey>,DefaultAllocator>
                              *)&local_1c8,pEVar9);
LAB_001096c0:
            lVar15 = *(long *)(lVar15 + 0x28);
          } while (lVar15 != 0);
  ...
  fVar20 = _LC84;
LAB_001096d2:
  local_2d0 = (RBMap<AnimationTrackEditor::SelectedKey,AnimationTrackEditor::KeyInfo,Comparator<AnimationTrackEditor::SelectedKey>,DefaultAllocator>
               *)&local_1c8;
  AnimationTrackEditor::_set_key_clipboard
            ((int)*(undefined8 *)(this + 0xb88),fVar20,(RBMap *)(ulong)*(uint *)(this + 0x9f4));
  if (param_1) {
    ...
    Ref<Animation>::unref((Ref<Animation> *)&local_1d0);
    if ((local_1c8 != (Element *)0x0) &&
       (pEVar12 = *(Element **)(local_1c8 + 0x10), *(Element **)(local_1c8 + 0x10) != pEStack_1c0))
    {
      do {
        pEVar9 = pEVar12;
      ...
      do {
        ...
        fVar20 = (float)Animation::track_get_key_transition
                                  ((int)*(undefined8 *)(this + 0x9e8),iVar17);
        ...
        EditorUndoRedoManager::add_undo_methodp
                  (this_00,pSVar5,(Variant **)&local_1d0,(int)(Variant *)&local_188);
        pVVar18 = local_c0;
        do {
          pVVar1 = pVVar18 + -0x18;
          pVVar18 = pVVar18 + -0x18;
        ...
        if ((pOVar16 != (Object *)0x0) && (cVar7 = RefCounted::reference(), cVar7 == '\0')) {
          pOVar16 = (Object *)0x0;
        }
        ...
        EditorUndoRedoManager::add_undo_methodp
                  (this_00,(StringName *)this,(Variant **)&local_1d0,iVar8);
        ...
        if (((pOVar16 != (Object *)0x0) && (cVar7 = RefCounted::unreference(), cVar7 != '\0')) &&
           (cVar7 = predelete_handler(pOVar16), cVar7 != '\0')) {
          (**(code **)(*(long *)pOVar16 + 0x140))(pOVar16);
          Memory::free_static(pOVar16,false);
        }
        pEVar9 = *(Element **)(pEVar9 + 0x28);
    ...
    if (AnimationPlayerEditor::singleton != (Object *)0x0) {
      ...
      EditorUndoRedoManager::add_do_method<>
                ((EditorUndoRedoManager *)this_00,pOVar16,(StringName *)&local_1d0);
      if ((StringName::configured != '\0') && (local_1d0 != (Object *)0x0)) {
        StringName::unref();
      }
      StringName::StringName((StringName *)&local_1d0,"_animation_update_key_frame",false);
...
/* AnimationBezierTrackEdit::copy_selected_keys(bool) */
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* AnimationBezierTrackEdit::_menu_selected(int) */

void __thiscall AnimationBezierTrackEdit::_menu_selected(AnimationBezierTrackEdit *this,int param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* AnimationBezierTrackEdit::_draw_track(int, Color const&) */

void __thiscall
AnimationBezierTrackEdit::_draw_track(AnimationBezierTrackEdit *this,int param_1,Color *param_2)
...
LAB_0010ac58:
  iVar7 = Animation::track_get_key_count((int)*(undefined8 *)(this + 0x9e8));
  if (iVar17 < iVar7) {
...
LAB_0010aca8:
    ...
    if (local_58 == (Element *)0x0) {
      ...
      *(Element **)(local_58 + 8) = pEStack_50;
      *(Element **)(local_58 + 0x10) = pEStack_50;
      *(Element **)(local_58 + 0x18) = pEStack_50;
      pEVar15 = local_58;
    }
    else {
...
LAB_0010ae20:
    ...
    RBMap<float,int,Comparator<float>,DefaultAllocator>::_insert_rb_fix
              ((RBMap<float,int,Comparator<float>,DefaultAllocator> *)&local_58,pEVar9);
LAB_0010ae35:
    *(int *)(pEVar9 + 0x34) = iVar17;
    iVar17 = iVar17 + 1;
    goto LAB_0010ac58;
  }
  if ((local_58 != (Element *)0x0) &&
     (pEVar15 = *(Element **)(local_58 + 0x10), *(Element **)(local_58 + 0x10) != pEStack_50)) {
    do {
      pEVar13 = pEVar15;
    ...
    do {
      ...
      local_c4 = (float)Animation::bezier_track_get_key_value
                                  ((int)*(undefined8 *)(this + 0x9e8),param_1);
      uVar24 = Animation::bezier_track_get_key_out_handle
                         ((int)*(undefined8 *)(this + 0x9e8),param_1);
      fVar21 = (float)uVar24;
      local_a0 = (float)((ulong)uVar24 >> 0x20);
      if (((*(int *)(this + 0xb08) == param_1) && ((*(int *)(this + 0xb00) + 1U & 0xfffffffd) == 0))
         && (iVar17 == *(int *)(this + 0xb04))) {
...
LAB_0010afa8:
      ...
      local_c8 = (float)Animation::bezier_track_get_key_value
                                  ((int)*(undefined8 *)(this + 0x9e8),param_1);
      ...
      if ((iVar5 <= iVar17) && (iVar7 <= iVar6)) {
        ...
        if (iVar2 <= iVar3) {
          ...
          do {
            dVar23 = (double)Range::get_value();
            fVar26 = local_c8;
            if ((iVar17 != iVar16) && (fVar26 = local_c4, iVar7 != iVar16)) {
              fVar26 = 0.0;
              iVar12 = 10;
              ...
              fVar32 = fVar21 * fVar30 * fVar26 * _LC141 + local_c0 * fVar31 * fVar30 +
                       fVar28 * fVar31 * fVar29 * _LC141 + local_bc * fVar29 * fVar26;
              fVar26 = (local_a0 + local_c4) * fVar30 * fVar26 * _LC141 + fVar31 * fVar30 * local_c4
                       + fVar31 * (local_9c + local_c8) * fVar29 * _LC141 +
                       fVar29 * fVar26 * local_c8;
              fVar30 = _LC19 - fVar27;
              fVar31 = fVar30 * fVar30;
              fVar29 = fVar27 * fVar27;
              fVar26 = ((fVar22 - fVar32) /
                       ((fVar21 * fVar31 * fVar27 * _LC141 + local_c0 * fVar30 * fVar31 +
                         fVar28 * fVar30 * fVar29 * _LC141 + local_bc * fVar29 * fVar27) - fVar32))
                       * (((local_a0 + local_c4) * fVar31 * fVar27 * _LC141 +
                           fVar30 * fVar31 * local_c4 +
                           fVar30 * (local_9c + local_c8) * fVar29 * _LC141 +
                          fVar29 * fVar27 * local_c8) - fVar26) + fVar26;
            }
            fVar27 = *(float *)(this + 0xab0);
            fVar22 = *(float *)(this + 0xab4);
            Control::get_size();
            pVVar25 = (Vector<Vector2> *)
                      CONCAT44((float)((double)extraout_XMM0_Db * __LC21 -
                                      (double)((fVar26 - fVar27) / fVar22)),(float)iVar16);
            if (iVar2 < iVar16) {
...
LAB_0010b126:
  ...
  RBMap<float,int,Comparator<float>,DefaultAllocator>::clear
            ((RBMap<float,int,Comparator<float>,DefaultAllocator> *)&local_58);
  if (local_58 != (Element *)0x0) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* AnimationBezierTrackEdit::gui_input(Ref<InputEvent> const&) */

void __thiscall AnimationBezierTrackEdit::gui_input(AnimationBezierTrackEdit *this,Ref *param_1)

{
  ...
  if (*(long *)param_1 == 0) {
    if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
      _err_print_error("gui_input","editor/animation_bezier_editor.cpp",0x387,
    ...
    if (cVar15 == '\0') {
      ...
      if (cVar15 == '\0') {
        ...
        if ((gui_input(Ref<InputEvent>const&)::{lambda()#1}::operator()()::sname == '\0') &&
           (iVar19 = __cxa_guard_acquire(&gui_input(Ref<InputEvent>const&)::{lambda()#1}::
                                          operator()()::sname), iVar19 != 0)) {
        ...
        for (lVar31 = 0; (lVar36 != 0 && (lVar31 < *(long *)(lVar36 + -8))); lVar31 = lVar31 + 1) {
          dVar48 = (double)Animation::track_get_key_time
                                     ((int)*(undefined8 *)(this + 0x9e8),
                                      *(int *)(lVar36 + lVar33 + 0x30));
          lVar36 = *(long *)(this + 0xb98);
          if (lVar36 == 0) {
            lVar35 = 0;
            goto LAB_0010d5c5;
        ...
        if (lVar36 != 0) {
          do {
            ...
            if (local_198 == (Object *)0x0) {
              ...
              *(undefined8 **)(local_198 + 8) = local_190;
              *(undefined8 **)(local_198 + 0x10) = local_190;
              *(undefined8 **)(local_198 + 0x18) = local_190;
            }
            lVar31 = lVar31 + 1;
            lVar33 = lVar33 + 0x38;
            RBSet<Pair<int,int>,AnimationBezierTrackEdit::PairCompare,DefaultAllocator>::_insert
                      ((RBSet<Pair<int,int>,AnimationBezierTrackEdit::PairCompare,DefaultAllocator>
                        *)&local_198,(Pair *)&local_1a8);
            lVar36 = *(long *)(this + 0xb98);
          } while (lVar36 != 0);
LAB_0010d1b0:
          if (local_188 != 0) {
            ...
            if (local_198 == (Object *)0x0) {
              ...
              if (*(undefined8 **)(local_198 + 0x10) == local_190) {
                ...
                do {
                  ...
                  dVar48 = (double)Animation::track_get_key_time
                                             ((int)*(undefined8 *)(this + 0x9e8),iVar19);
                  fVar42 = (float)dVar48;
                  fVar47 = (float)Animation::bezier_track_get_key_value
                                            ((int)*(undefined8 *)(this + 0x9e8),iVar19);
                  fVar43 = fVar47;
                  if (fVar47 <= local_2c0) {
                    fVar43 = local_2c0;
...
LAB_0010db9b:
              fVar42 = _LC55;
              if (((float)((uint)local_2e8 & _LC54) <= _LC55) &&
                 (_LC36 < (double)(local_2e8 - local_2d0._0_4_))) {
...
LAB_0010e111:
        ...
        if (lVar36 != *(long *)(this + 0xba8)) {
          ...
          do {
            ...
            if (iVar19 < iVar21 + -1) {
              local_1a8 = (Object *)
                          CONCAT44(*(int *)(lVar31 + 0x34) + 1,*(undefined4 *)(lVar31 + 0x30));
              if (local_198 == (Object *)0x0) {
                local_198 = (Object *)operator_new(0x38,DefaultAllocator::alloc);
                *(undefined1 (*) [16])(local_198 + 0x20) = (undefined1  [16])0x0;
                *(undefined8 *)(local_198 + 0x30) = 0;
...
LAB_0010b861:
  ...
  if (local_2d0 != (Object *)0x0) {
    ...
    if ((iVar19 == 2) && (cVar15 = InputEvent::is_pressed(), cVar15 != '\0')) {
...
LAB_00110cbe:
              ...
              TTR((String *)&local_198,(String *)&local_1b0);
              if ((gui_input(Ref<InputEvent>const&)::{lambda()#5}::operator()()::sname == '\0') &&
                 (iVar21 = __cxa_guard_acquire(&gui_input(Ref<InputEvent>const&)::{lambda()#5}::
                                                operator()()::sname), iVar21 != 0)) {
                _scs_create((char *)&gui_input(Ref<InputEvent>const&)::{lambda()#5}::operator()()::
                                     sname,true);
                __cxa_atexit(StringName::~StringName,
                             &gui_input(Ref<InputEvent>const&)::{lambda()#5}::operator()()::sname,
                             &__dso_handle);
                __cxa_guard_release(&gui_input(Ref<InputEvent>const&)::{lambda()#5}::operator()()::
                                     sname);
              }
...
LAB_0010c532:
            if (*(int *)(this + 0xbb0) != 0) goto LAB_0010c54c;
          }
          else {
            local_198 = (Object *)0x0;
            ...
            if ((gui_input(Ref<InputEvent>const&)::{lambda()#2}::operator()()::sname == '\0') &&
               (iVar21 = __cxa_guard_acquire(&gui_input(Ref<InputEvent>const&)::{lambda()#2}::
                                              operator()()::sname), iVar21 != 0)) {
            ...
            if ((gui_input(Ref<InputEvent>const&)::{lambda()#3}::operator()()::sname == '\0') &&
               (iVar21 = __cxa_guard_acquire(&gui_input(Ref<InputEvent>const&)::{lambda()#3}::
                                              operator()()::sname), iVar21 != 0)) {
            ...
            if ((gui_input(Ref<InputEvent>const&)::{lambda()#4}::operator()()::sname == '\0') &&
               (iVar21 = __cxa_guard_acquire(&gui_input(Ref<InputEvent>const&)::{lambda()#4}::
                                              operator()()::sname), iVar21 != 0)) {
...
LAB_0010c54c:
            ...
            TTR((String *)&local_198,(String *)&local_1b0);
            if ((gui_input(Ref<InputEvent>const&)::{lambda()#6}::operator()()::sname == '\0') &&
               (iVar21 = __cxa_guard_acquire(&gui_input(Ref<InputEvent>const&)::{lambda()#6}::
                                              operator()()::sname), iVar21 != 0)) {
              _scs_create((char *)&gui_input(Ref<InputEvent>const&)::{lambda()#6}::operator()()::
                                   sname,true);
              __cxa_atexit(StringName::~StringName,
                           &gui_input(Ref<InputEvent>const&)::{lambda()#6}::operator()()::sname,
                           &__dso_handle);
              __cxa_guard_release(&gui_input(Ref<InputEvent>const&)::{lambda()#6}::operator()()::
                                   sname);
            }
            Control::get_editor_theme_icon(local_2a8);
            ...
            TTR((String *)&local_198,(String *)&local_1b0);
            if ((gui_input(Ref<InputEvent>const&)::{lambda()#7}::operator()()::sname == '\0') &&
               (iVar21 = __cxa_guard_acquire(&gui_input(Ref<InputEvent>const&)::{lambda()#7}::
                                              operator()()::sname), iVar21 != 0)) {
              _scs_create((char *)&gui_input(Ref<InputEvent>const&)::{lambda()#7}::operator()()::
                                   sname,true);
              __cxa_atexit(StringName::~StringName,
                           &gui_input(Ref<InputEvent>const&)::{lambda()#7}::operator()()::sname,
                           &__dso_handle);
              __cxa_guard_release(&gui_input(Ref<InputEvent>const&)::{lambda()#7}::operator()()::
                                   sname);
            }
            Control::get_editor_theme_icon(local_2a8);
            ...
            TTR((String *)&local_198,(String *)&local_1b0);
            if ((gui_input(Ref<InputEvent>const&)::{lambda()#8}::operator()()::sname == '\0') &&
               (iVar21 = __cxa_guard_acquire(&gui_input(Ref<InputEvent>const&)::{lambda()#8}::
                                              operator()()::sname), iVar21 != 0)) {
              _scs_create((char *)&gui_input(Ref<InputEvent>const&)::{lambda()#8}::operator()()::
                                   sname,true);
              __cxa_atexit(StringName::~StringName,
                           &gui_input(Ref<InputEvent>const&)::{lambda()#8}::operator()()::sname,
                           &__dso_handle);
              __cxa_guard_release(&gui_input(Ref<InputEvent>const&)::{lambda()#8}::operator()()::
                                   sname);
            }
            Control::get_editor_theme_icon(local_2a8);
            ...
            TTR((String *)&local_198,(String *)&local_1b0);
            if ((gui_input(Ref<InputEvent>const&)::{lambda()#9}::operator()()::sname == '\0') &&
               (iVar21 = __cxa_guard_acquire(&gui_input(Ref<InputEvent>const&)::{lambda()#9}::
                                              operator()()::sname), iVar21 != 0)) {
              _scs_create((char *)&gui_input(Ref<InputEvent>const&)::{lambda()#9}::operator()()::
                                   sname,true);
              __cxa_atexit(StringName::~StringName,
                           &gui_input(Ref<InputEvent>const&)::{lambda()#9}::operator()()::sname,
                           &__dso_handle);
              __cxa_guard_release(&gui_input(Ref<InputEvent>const&)::{lambda()#9}::operator()()::
                                   sname);
            }
            Control::get_editor_theme_icon(local_2a8);
            ...
            TTR((String *)&local_198,(String *)&local_1b0);
            if ((gui_input(Ref<InputEvent>const&)::{lambda()#10}::operator()()::sname == '\0') &&
               (iVar21 = __cxa_guard_acquire(&gui_input(Ref<InputEvent>const&)::{lambda()#10}::
                                              operator()()::sname), iVar21 != 0)) {
              _scs_create((char *)&gui_input(Ref<InputEvent>const&)::{lambda()#10}::operator()()::
                                   sname,true);
              __cxa_atexit(StringName::~StringName,
                           &gui_input(Ref<InputEvent>const&)::{lambda()#10}::operator()()::sname,
                           &__dso_handle);
              __cxa_guard_release(&gui_input(Ref<InputEvent>const&)::{lambda()#10}::operator()()::
                                   sname);
            }
            Control::get_editor_theme_icon(local_2a8);
            ...
            TTR((String *)&local_198,(String *)&local_1b0);
            if ((gui_input(Ref<InputEvent>const&)::{lambda()#11}::operator()()::sname == '\0') &&
               (iVar19 = __cxa_guard_acquire(&gui_input(Ref<InputEvent>const&)::{lambda()#11}::
                                              operator()()::sname), iVar19 != 0)) {
              _scs_create((char *)&gui_input(Ref<InputEvent>const&)::{lambda()#11}::operator()()::
                                   sname,true);
              __cxa_atexit(StringName::~StringName,
                           &gui_input(Ref<InputEvent>const&)::{lambda()#11}::operator()()::sname,
                           &__dso_handle);
              __cxa_guard_release(&gui_input(Ref<InputEvent>const&)::{lambda()#11}::operator()()::
                                   sname);
            }
            Control::get_editor_theme_icon(local_2a8);
            PopupMenu::add_icon_item(uVar50,local_2a8,(String *)&local_198);
            ...
            TTR((String *)&local_198,(String *)&local_1b0);
            if ((gui_input(Ref<InputEvent>const&)::{lambda()#12}::operator()()::sname == '\0') &&
               (iVar19 = __cxa_guard_acquire(&gui_input(Ref<InputEvent>const&)::{lambda()#12}::
                                              operator()()::sname), iVar19 != 0)) {
              _scs_create((char *)&gui_input(Ref<InputEvent>const&)::{lambda()#12}::operator()()::
                                   sname,true);
              __cxa_atexit(StringName::~StringName,
                           &gui_input(Ref<InputEvent>const&)::{lambda()#12}::operator()()::sname,
                           &__dso_handle);
              __cxa_guard_release(&gui_input(Ref<InputEvent>const&)::{lambda()#12}::operator()()::
                                   sname);
            }
            Control::get_editor_theme_icon(local_2a8);
...
LAB_0010b8f5:
      if (((this[0xaec] != (AnimationBezierTrackEdit)0x0) &&
          (cVar15 = InputEvent::is_pressed(), cVar15 == '\0')) &&
         (iVar19 = InputEventMouseButton::get_button_index(), iVar19 == 1)) {
        AVar17 = this[0xaed];
        if (AVar17 == (AnimationBezierTrackEdit)0x0) {
          ...
          if (0 < (int)uVar22) {
            do {
              ...
              if (((cVar15 == '\x06') &&
                  (cVar15 = HashSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>>::
                            _lookup_pos((HashSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>>
                                         *)(this + 0xa78),(int *)(ulong)uVar38,(uint *)&local_198),
                  cVar15 == '\0')) &&
                 (cVar15 = HashSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>>::
                           _lookup_pos((HashSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>>
                                        *)(this + 0xa50),(int *)(ulong)uVar38,(uint *)&local_198),
                 cVar15 == '\0')) {
                fVar43 = (float)Animation::bezier_track_interpolate
                                          ((int)*(undefined8 *)(this + 0x9e8),
                                           (double)(float)(dVar48 + (double)((fVar47 - (float)
                                                  local_2b8) / fVar42)));
          ...
          if (lVar36 != 0) {
            ...
            do {
              ...
              if (((pfVar5[2] <= 0.0 && pfVar5[2] != 0.0) || (pfVar5[3] <= 0.0 && pfVar5[3] != 0.0))
                 || ((fVar46 - fVar44 < 0.0 || (fVar42 - fVar47 < 0.0)))) {
                _err_print_error("intersects","./core/math/rect2.h",0x39,
                                 "Rect2 size is negative, this is not supported. Use Rect2.abs() to get a Rect2 with a positive size."
                                );
                lVar36 = *(long *)(this + 0xb98);
              }
              if ((((*pfVar5 < (fVar46 - fVar44) + fVar44) && (fVar44 < *pfVar5 + pfVar5[2])) &&
                  (pfVar5[1] < (fVar42 - fVar47) + fVar47)) && (fVar47 < pfVar5[1] + pfVar5[3])) {
                bVar37 = false;
                if (iVar19 == 0) {
...
LAB_0010d5c5:
                  _err_print_index_error
                            ("get","./core/templates/cowdata.h",0xdb,lVar31,lVar35,"p_index",
                             "size()","",false,true);
                  _err_flush_stdout();
                    /* WARNING: Does not return */
                ...
                lVar35 = *(long *)(lVar36 + -8);
                if (lVar35 <= lVar31) goto LAB_0010d5c5;
                _select_at_anim(this,(Ref *)(this + 0x9e8),*(int *)(lVar36 + 0x30 + lVar33),
                                (float)dVar48,(bool)bVar37);
      ...
      if (this[0xac8] != (AnimationBezierTrackEdit)0x0) {
        ...
        if (((cVar15 == '\0') && (iVar19 = InputEventMouseButton::get_button_index(), iVar19 == 1))
           && (this[0x9f0] == (AnimationBezierTrackEdit)0x0)) {
          if ((this[0xad8] == (AnimationBezierTrackEdit)0x0) ||
             (((double)(float)(*(uint *)(this + 0xae4) & _LC54) <= _LC36 &&
              ((double)(float)(*(uint *)(this + 0xae8) & _LC54) <= _LC36)))) {
            if ((*(int *)(this + 0xad0) != -1) || (*(int *)(this + 0xad4) != -1)) {
              ...
              *(undefined4 *)(this + 0x9f4) = uVar20;
              CanvasItem::queue_redraw();
              dVar48 = (double)Animation::track_get_key_time
                                         ((int)*(undefined8 *)(this + 0x9e8),*(int *)(this + 0xad0))
              ;
...
LAB_0010f007:
                ...
                if (*(long *)(lVar36 + 0x10) != lVar31) {
                  ...
                  do {
                    ...
                    iVar23 = Animation::bezier_track_get_key_handle_mode
                                       ((int)*(undefined8 *)(this + 0x9e8),*(int *)(lVar36 + 0x30));
                    pVVar29 = (Variant *)Array::operator[](iVar19);
                    fVar47 = Variant::operator_cast_to_float(pVVar29);
                    pVVar29 = (Variant *)Array::operator[](iVar19);
                    ...
                    StringName::StringName
                              ((StringName *)&local_1a8,"_bezier_track_insert_key_at_anim",false);
                    ...
                    local_118 = local_78;
                    EditorUndoRedoManager::add_do_methodp
                              ((Object *)pEVar28,(StringName *)this,(Variant **)&local_1a8,iVar21);
                ...
                if (*(long *)(lVar36 + 0x10) != lVar31) {
                  ...
                  do {
                    ...
                    fVar46 = *(float *)(this + 0xae4);
                    StringName::StringName
                              ((StringName *)&local_198,"track_remove_key_at_time",false);
                    EditorUndoRedoManager::add_undo_method<int,float>
                              (pEVar28,*(Object **)(this + 0x9e8),(StringName *)&local_198,iVar21,
                               (float)((double)fVar46 + dVar48));
                ...
                if (*(long *)(lVar36 + 0x10) != lVar31) {
                  ...
                  do {
                    dVar48 = (double)Animation::track_get_key_time
                                                ...
                                                *(int *)(lVar36 + 0x30));
                    Animation::track_get_key_value
                              ((int)local_148,(int)*(undefined8 *)(this + 0x9e8));
                    Variant::operator_cast_to_Array((Variant *)&local_1b0);
                    if (Variant::needs_deinit[(int)local_148._0_4_] != '\0') {
                      Variant::_clear_internal();
                    }
                    iVar24 = Animation::bezier_track_get_key_handle_mode
                                       ((int)*(undefined8 *)(this + 0x9e8),*(int *)(lVar36 + 0x30));
                    pVVar29 = (Variant *)Array::operator[](iVar19);
                    ...
                    local_118 = local_78;
                    EditorUndoRedoManager::add_undo_methodp
                              ((Object *)pEVar28,(StringName *)this,(Variant **)&local_1a8,
                               (int)local_148);
                    pVVar29 = (Variant *)local_48;
                    do {
                      pVVar2 = pVVar29 + -0x18;
                ...
                do {
                  ...
                  EditorUndoRedoManager::add_do_method<int,int>
                            (pEVar28,*(Object **)(this + 0x9e8),(StringName *)&local_198,iVar24,
                             iVar21);
                  if ((StringName::configured != '\0') && (local_198 != (Object *)0x0)) {
                    StringName::unref();
                  }
                ...
                do {
                  ...
                  iVar21 = Animation::track_find_key
                                     (dVar49,*(undefined8 *)(this + 0x9e8),
                                      *(undefined4 *)(lVar36 + 0x30),1,0,0);
                  if (iVar21 != -1) {
                    iVar21 = *(int *)(lVar36 + 0x30);
                    cVar15 = RBSet<Pair<int,int>,AnimationBezierTrackEdit::PairCompare,DefaultAllocator>
                             ::has(*(Pair **)(this + 0xba0));
                    if (cVar15 == '\0') {
                      StringName::StringName
                                ((StringName *)&local_198,"track_remove_key_at_time",false);
                      EditorUndoRedoManager::add_do_method<int,float>
                                (pEVar28,*(Object **)(this + 0x9e8),(StringName *)&local_198,iVar21,
                                 (float)((double)fVar46 + dVar48));
                      if ((StringName::configured != '\0') && (local_198 != (Object *)0x0)) {
                        StringName::unref();
                      ...
                      *(int *)pauVar3[1] = *(int *)pauVar3[1] + 1;
                      uVar20 = Animation::bezier_track_get_key_handle_mode
                                         ((int)*(undefined8 *)(this + 0x9e8),*(int *)(lVar36 + 0x30)
                                         );
...
LAB_0010f9a3:
              if (local_1b8 != (undefined1 (*) [16])0x0) {
                ...
                if ((local_228 != (int *)0x0) && (piVar34 != (int *)0x0)) {
                  do {
                    ...
                    EditorUndoRedoManager::add_undo_method<int,double,Variant,int>
                              (pEVar53,pEVar28,*(undefined8 *)(this + 0x9e8),(String *)&local_198,
                               iVar21,(Variant *)local_148,1);
                    if ((StringName::configured != '\0') && (local_198 != (Object *)0x0)) {
                      StringName::unref();
                    }
                    if (Variant::needs_deinit[(int)local_148._0_4_] != '\0') {
            ...
            EditorUndoRedoManager::add_do_method<Ref<Animation>>
                      (pEVar28,this,(String *)&local_1a8,local_198);
            if ((StringName::configured != '\0') && (local_1a8 != (Object *)0x0)) {
              StringName::unref();
            }
            Ref<Animation>::unref((Ref<Animation> *)&local_198);
              ...
              if (lVar36 != *(long *)(this + 0xba8)) {
                ...
                do {
                  Animation::track_get_key_time
                            ((int)*(undefined8 *)(this + 0x9e8),*(int *)(lVar31 + 0x30));
                  uVar20 = *(undefined4 *)(lVar31 + 0x30);
                  local_198 = (Object *)0x0;
                  Ref<Animation>::operator=((Ref<Animation> *)&local_198,*(Ref **)(this + 0x9e8));
                  StringName::StringName((StringName *)&local_1a8,"_select_at_anim",false);
                  EditorUndoRedoManager::add_do_method<Ref<Animation>,int,float,bool>
                            (pEVar28,this,(String *)&local_1a8,local_198,uVar20,iVar19 == 0);
                  if ((StringName::configured != '\0') && (local_1a8 != (Object *)0x0)) {
                    StringName::unref();
                  }
                  Ref<Animation>::unref((Ref<Animation> *)&local_198);
...
LAB_001101db:
              Memory::free_static(pauVar30,false);
            }
LAB_001101e5:
            List<AnimationBezierTrackEdit::AnimMoveRestore,DefaultAllocator>::~List
                      ((List<AnimationBezierTrackEdit::AnimMoveRestore,DefaultAllocator> *)
                       &local_1b8);
          }
          this[0xad8] = (AnimationBezierTrackEdit)0x0;
          this[0xac8] = (AnimationBezierTrackEdit)0x0;
      ...
      if (lVar36 != *(long *)(this + 0xa28)) {
        ...
        do {
          ...
          if (cVar15 != '\0') {
            ...
            cVar15 = HashSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>>::_lookup_pos
                               ((HashSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>> *)
                                (this + 0xa50),(int *)(ulong)uVar22,(uint *)&local_198);
            if ((cVar15 == '\0') &&
               (cVar15 = HashSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>>::
                         _lookup_pos((HashSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>>
                                      *)(this + 0xa78),(int *)(ulong)uVar22,(uint *)&local_198),
               cVar15 == '\0')) {
              AVar17 = this[0x9f0];
              Ref<Animation>::operator=((Ref<Animation> *)(this + 0x9e8),*(Ref **)(this + 0x9e8));
              this[0x9f0] = AVar17;
    ...
    if (*(long *)(this + 0xa38) != 0) {
      ...
      if (lVar36 != *(long *)(this + 0xa40)) {
        ...
        do {
          ...
          local_190 = &_GlobalNilClass::_nil;
          RBMap<int,Rect2,Comparator<int>,DefaultAllocator>::_copy_from
                    ((RBMap<int,Rect2,Comparator<int>,DefaultAllocator> *)&local_198,
                     (RBMap *)(lVar31 + 0x38));
          if ((local_198 != (Object *)0x0) &&
             (puVar14 = *(undefined8 **)(local_198 + 0x10),
             *(undefined8 **)(local_198 + 0x10) != local_190)) {
              ...
              if (cVar15 != '\0') {
                ...
                if (iVar19 == 0) {
                  if (this[0x9f0] == (AnimationBezierTrackEdit)0x0) {
                    ...
                    CowData<char32_t>::_unref((CowData<char32_t> *)&local_1a8);
                    StringName::StringName
                              ((StringName *)&local_1a8,"_update_locked_tracks_after",false);
                    EditorUndoRedoManager::add_do_method<int>
                              (pEVar28,(Object *)this,(StringName *)&local_1a8,uVar22);
                    if ((StringName::configured != '\0') && (local_1a8 != (Object *)0x0)) {
                      StringName::unref();
                    }
                    StringName::StringName
                              ((StringName *)&local_1a8,"_update_hidden_tracks_after",false);
                    EditorUndoRedoManager::add_do_method<int>
                              (pEVar28,(Object *)this,(StringName *)&local_1a8,uVar22);
                    if ((StringName::configured != '\0') && (local_1a8 != (Object *)0x0)) {
                      StringName::unref();
                    ...
                    EditorUndoRedoManager::add_do_method<int>
                              (pEVar28,*(Object **)(this + 0x9e8),(StringName *)&local_1a8,uVar22);
                    if ((StringName::configured != '\0') && (local_1a8 != (Object *)0x0)) {
                      StringName::unref();
                    }
                    ...
                    EditorUndoRedoManager::add_undo_methodp
                              ((Object *)pEVar28,pSVar8,(Variant **)&local_1a8,iVar19);
                    pVVar29 = local_c0;
                    do {
                    ...
                    for (iVar21 = 0;
                        ...
                        iVar21 < iVar24; iVar21 = iVar21 + 1) {
                      iVar24 = Animation::bezier_track_get_key_handle_mode
                                         ((int)*(undefined8 *)(this + 0x9e8),uVar22);
                      uVar50 = Animation::bezier_track_get_key_out_handle
                                         ((int)*(undefined8 *)(this + 0x9e8),uVar22);
                      uVar52 = Animation::bezier_track_get_key_in_handle
                                         ((int)*(undefined8 *)(this + 0x9e8),uVar22);
                      fVar46 = (float)Animation::bezier_track_get_key_value
                                                ((int)*(undefined8 *)(this + 0x9e8),uVar22);
                      dVar48 = (double)Animation::track_get_key_time
                                                 ((int)*(undefined8 *)(this + 0x9e8),uVar22);
                      local_1a8 = (Object *)0x0;
                      Ref<Animation>::operator=
                                ((Ref<Animation> *)&local_1a8,*(Ref **)(this + 0x9e8));
                      StringName::StringName
                                ((StringName *)&local_1b0,"_bezier_track_insert_key_at_anim",false);
                      local_170 = uVar52;
                      local_168[0] = uVar50;
                      ...
                      local_118 = local_78;
                      EditorUndoRedoManager::add_undo_methodp
                                ((Object *)pEVar28,(StringName *)this,(Variant **)&local_1b0,iVar19)
                      ;
                      do {
                        pVVar1 = pVVar41 + -0x18;
                ...
                if (iVar19 == 1) {
                  pHVar4 = (HashSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>> *)
                           (this + 0xa50);
                  cVar15 = HashSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>>::
                           _lookup_pos(pHVar4,(int *)(ulong)uVar22,(uint *)&local_1a8);
                  if (cVar15 != '\0') {
                    HashSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>>::erase
                              (pHVar4,(int *)&local_1b8);
                    goto LAB_001103d6;
                  }
                ...
                if (uVar22 == *(uint *)(this + 0xaa0)) {
                  *(undefined4 *)(this + 0xaa0) = 0xffffffff;
                  ...
                  while( true ) {
                    ...
                    cVar15 = Animation::track_get_type((int)*(undefined8 *)(this + 0x9e8));
                    if (((cVar15 == '\x06') && (uVar22 != uVar38)) &&
                       (cVar15 = HashSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>>::
                                 _lookup_pos(pHVar4,(int *)(ulong)uVar38,(uint *)&local_1a8),
                       cVar15 == '\0')) {
                      HashSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>>::insert
                                ((int *)&local_1a8);
                    }
          ...
          RBMap<int,Rect2,Comparator<int>,DefaultAllocator>::clear
                    ((RBMap<int,Rect2,Comparator<int>,DefaultAllocator> *)&local_198);
        ...
        do {
          ...
          if (this[0x9f0] == (AnimationBezierTrackEdit)0x0) {
            ...
            *(int *)(this + 0xb08) = iVar19;
            uVar50 = Animation::bezier_track_get_key_in_handle
                               ((int)*(undefined8 *)(this + 0x9e8),iVar19);
            lVar36 = *(long *)(this + 0xb98);
            *(undefined8 *)(this + 0xb0c) = uVar50;
            ...
            if (lVar35 <= lVar31) goto LAB_0010d5c5;
            uVar50 = Animation::bezier_track_get_key_out_handle
                               ((int)*(undefined8 *)(this + 0x9e8),*(int *)(lVar36 + lVar33 + 0x30))
            ;
...
LAB_0010e068:
      ...
      if (fVar47 <= fVar46) {
        ...
        if ((fVar46 < fVar42) &&
           (cVar15 = InputEventWithModifiers::is_command_or_control_pressed(), cVar15 != '\0')) {
          Control::get_size();
          dVar48 = (double)extraout_XMM0_Db_04 * __LC21;
          InputEventMouse::get_position();
          Animation::make_default_bezier_key
                    ((float)((dVar48 - (double)extraout_XMM0_Db_05) *
                             (double)*(float *)(this + 0xab4) + (double)*(float *)(this + 0xab0)));
          fVar46 = (float)InputEventMouse::get_position();
          fVar42 = (float)AnimationTimelineEdit::get_zoom_scale();
          dVar48 = (double)Range::get_value();
          ...
          while( true ) {
            ...
            iVar19 = Animation::track_find_key
                               (dVar48,*(undefined8 *)(this + 0x9e8),*(undefined4 *)(this + 0x9f4),1
                                ,0,0);
            if (iVar19 == -1) break;
          ...
          EditorUndoRedoManager::add_do_method<int,float,Variant,Vector2,Vector2>
                    (pEVar28,CONCAT44(fVar42,fVar43),CONCAT44(fVar46,fVar47),pEVar53,
                     *(undefined8 *)(this + 0x9e8),(String *)&local_198,uVar20,(Variant *)&local_108
                    );
          if ((StringName::configured != '\0') && (local_198 != (Object *)0x0)) {
            StringName::unref();
          }
          ...
          EditorUndoRedoManager::add_undo_method<int,float>
                    (pEVar53,*(Object **)(this + 0x9e8),(StringName *)&local_198,iVar19,
                     (float)pEVar28);
          if ((StringName::configured != '\0') && (local_198 != (Object *)0x0)) {
            StringName::unref();
          }
          ...
          iVar19 = Animation::track_find_key
                             (dVar48,*(undefined8 *)(this + 0x9e8),*(undefined4 *)(this + 0x9f4),1,0
                              ,0);
          if (iVar19 == -1) {
            _err_print_error("gui_input","editor/animation_bezier_editor.cpp",0x4df,
...
LAB_0010b92f:
  ...
  if (lVar36 == 0) {
LAB_0010bc40:
    if (((*(int *)(this + 0xb00) + 1U & 0xfffffffd) == 0) && (local_2d0 != (Object *)0x0)) {
      pOVar25 = (Object *)0x0;
      cVar15 = InputEvent::is_pressed();
...
LAB_0010b94b:
    pOVar25 = (Object *)__dynamic_cast(lVar36,&Object::typeinfo,&InputEventMouseMotion::typeinfo,0);
    if ((pOVar25 == (Object *)0x0) || (cVar15 = RefCounted::reference(), cVar15 == '\0'))
    goto LAB_0010bc40;
    if (this[0xac8] == (AnimationBezierTrackEdit)0x0) {
      if (this[0xaec] != (AnimationBezierTrackEdit)0x0) goto LAB_0010bf0a;
LAB_0010b994:
      if ((*(int *)(this + 0xb00) + 1U & 0xfffffffd) == 0) goto LAB_0010bf41;
    }
    else {
      if (this[0xad8] == (AnimationBezierTrackEdit)0x0) {
      ...
      if (this[0x9f0] == (AnimationBezierTrackEdit)0x0) {
        ...
        dVar51 = (double)Animation::track_get_key_time
                                   ((int)*(undefined8 *)(this + 0x9e8),*(int *)(this + 0xae0));
        fVar43 = (float)(dVar54 + (double)((fVar44 - (float)local_2b8) / fVar45)) -
                 (float)(dVar49 + (double)((fVar42 - (float)local_2b8) / fVar43));
        fVar44 = (float)dVar51;
        fVar42 = (float)AnimationTrackEditor::snap_time
                                  (fVar44 + fVar43,SUB81(*(undefined8 *)(this + 0xb88),0));
...
LAB_0010d130:
        ...
        fVar43 = (float)Animation::bezier_track_get_key_value
                                  ((int)*(undefined8 *)(this + 0x9e8),*(int *)(this + 0xae0));
        *(ulong *)(this + 0xae4) =
             CONCAT44((float)((dVar48 - (double)extraout_XMM0_Db_02) * (double)fVar46 +
                             (double)fVar47) - fVar43,fVar42);
      }
...
LAB_0010bf41:
      ...
      fVar43 = (float)AnimationTimelineEdit::get_zoom_scale();
      fVar42 = (float)AnimationTrackEditor::snap_time
                                ((fVar42 - (float)iVar19) / fVar43,SUB81(uVar50,0));
      dVar48 = (double)Range::get_value();
      fVar43 = (float)Animation::bezier_track_get_key_value
                                ((int)*(undefined8 *)(this + 0x9e8),*(int *)(this + 0x9f4));
      dVar49 = (double)Animation::track_get_key_time
                                 ((int)*(undefined8 *)(this + 0x9e8),*(int *)(this + 0x9f4));
      uVar52 = CONCAT44((float)((dVar54 - (double)extraout_XMM0_Db_00) * (double)fVar46 +
                               (double)fVar47) - fVar43,
                        (float)(dVar48 + (double)fVar42) - (float)dVar49);
      uVar50 = Animation::bezier_track_get_key_in_handle
                         ((int)*(undefined8 *)(this + 0x9e8),*(int *)(this + 0xb08));
      *(undefined8 *)(this + 0xb0c) = uVar50;
      uVar50 = Animation::bezier_track_get_key_out_handle
                         ((int)*(undefined8 *)(this + 0x9e8),*(int *)(this + 0xb08));
      *(undefined8 *)(this + 0xb14) = uVar50;
      if (*(int *)(this + 0xb00) == -1) {
        *(undefined8 *)(this + 0xb0c) = uVar52;
        iVar19 = Animation::bezier_track_get_key_handle_mode
                           ((int)*(undefined8 *)(this + 0x9e8),*(int *)(this + 0xb08));
        if (iVar19 == 2) {
          ...
          local_170 = CONCAT44(fVar47 * local_148._12_4_ + fVar46 * local_148._4_4_ +
                               auStack_138._4_4_,
                               fVar47 * local_148._8_4_ + fVar46 * local_148._0_4_ +
                               auStack_138._0_4_);
          fVar46 = (float)*(undefined8 *)(this + 0xb0c);
          fVar47 = (float)((ulong)*(undefined8 *)(this + 0xb0c) >> 0x20);
          local_168[0] = CONCAT44(fVar47 * local_148._12_4_ + fVar46 * local_148._4_4_ +
                                  auStack_138._4_4_,
                                  fVar47 * local_148._8_4_ + fVar46 * local_148._0_4_ +
                                  auStack_138._0_4_);
          ...
          *(ulong *)(this + 0xb14) =
               CONCAT44(fVar47 * (float)(local_108 >> 0x20) +
                        fVar46 * (float)((ulong)local_100 >> 0x20) + fStack_f4,
                        fVar47 * (float)local_108 + fVar46 * SUB84(local_100,0) + local_f8);
        }
        else if (iVar19 == 3) {
          *(ulong *)(this + 0xb14) =
               CONCAT44((uint)((ulong)*(undefined8 *)(this + 0xb0c) >> 0x20) ^ _LC188._4_4_,
                        (uint)*(undefined8 *)(this + 0xb0c) ^ (uint)_LC188);
        }
      }
        ...
        *(undefined8 *)(this + 0xb14) = uVar52;
        ...
        if (iVar19 == 2) {
          ...
          fVar46 = (float)*(undefined8 *)(this + 0xb0c);
          fVar47 = (float)((ulong)*(undefined8 *)(this + 0xb0c) >> 0x20);
          local_170 = CONCAT44(fVar46 * local_148._4_4_ + fVar47 * local_148._12_4_ +
                               auStack_138._4_4_,
                               fVar46 * local_148._0_4_ + fVar47 * local_148._8_4_ +
                               auStack_138._0_4_);
          fVar46 = (float)*(undefined8 *)(this + 0xb14);
          fVar47 = (float)((ulong)*(undefined8 *)(this + 0xb14) >> 0x20);
          local_168[0] = CONCAT44(fVar47 * local_148._12_4_ + fVar46 * local_148._4_4_ +
          ...
          *(ulong *)(this + 0xb0c) =
               CONCAT44((uint)((ulong)*(undefined8 *)(this + 0xb14) >> 0x20) ^ _LC188._4_4_,
                        (uint)*(undefined8 *)(this + 0xb14) ^ (uint)_LC188);
        }
      }
      CanvasItem::queue_redraw();
      if ((((*(int *)(this + 0xb00) + 1U & 0xfffffffd) != 0) || (local_2d0 == (Object *)0x0)) ||
         (cVar15 = InputEvent::is_pressed(), cVar15 != '\0')) goto LAB_0010b9a6;
LAB_0010bc72:
      iVar19 = InputEventMouseButton::get_button_index();
      if ((iVar19 == 1) && (this[0x9f0] == (AnimationBezierTrackEdit)0x0)) {
        ...
        if (*(int *)(this + 0xb00) == -1) {
          ...
          EditorUndoRedoManager::add_do_method<int,int,Vector2,float>
                    (*(EditorUndoRedoManager **)(this + 0xb0c),pEVar28,*(undefined8 *)(this + 0x9e8)
                     ,(String *)&local_198,uVar20,uVar6);
          if ((StringName::configured != '\0') && (local_198 != (Object *)0x0)) {
            StringName::unref();
          }
          pEVar53 = (EditorUndoRedoManager *)
...
LAB_0011069d:
          ...
          EditorUndoRedoManager::add_undo_method<int,int,Vector2,float>
                    (pEVar53,pEVar28,*(undefined8 *)(this + 0x9e8),(String *)&local_198,uVar20,uVar6
                    );
          if ((StringName::configured != '\0') && (local_198 != (Object *)0x0)) {
            StringName::unref();
          }
          ...
          EditorUndoRedoManager::add_do_method<int,int,Vector2,float>
                    (*(EditorUndoRedoManager **)(this + 0xb14),pEVar28,*(undefined8 *)(this + 0x9e8)
                     ,(String *)&local_198,uVar20,uVar6);
          if ((StringName::configured != '\0') && (local_198 != (Object *)0x0)) {
            StringName::unref();
          }
...
LAB_0010b9a6:
    ...
    if ((cVar15 != '\0') && (cVar15 = predelete_handler(pOVar25), cVar15 != '\0')) {
...
LAB_0010b9b6:
  pOVar25 = local_1c0;
  if (((local_1c0 != (Object *)0x0) && (cVar15 = RefCounted::unreference(), cVar15 != '\0')) &&
     (cVar15 = predelete_handler(pOVar25), cVar15 != '\0')) {
    (**(code **)(*(long *)pOVar25 + 0x140))(pOVar25);
    Memory::free_static(pOVar25,false);
  }
  if (((local_2c8 != (Object *)0x0) && (cVar15 = RefCounted::unreference(), cVar15 != '\0')) &&
     (cVar15 = predelete_handler(local_2c8), cVar15 != '\0')) {
...
LAB_00110aac:
  iVar19 = Animation::get_track_count();
  if (iVar19 <= (int)uVar22) goto LAB_001103d6;
  cVar15 = HashSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>>::_lookup_pos
                     (pHVar4,(int *)(ulong)uVar22,(uint *)&local_1a8);
  if ((cVar15 == '\0') &&
     (cVar15 = Animation::track_get_type((int)*(undefined8 *)(this + 0x9e8)), cVar15 == '\x06')) {
    AVar17 = this[0x9f0];
    Ref<Animation>::operator=((Ref<Animation> *)(this + 0x9e8),*(Ref **)(this + 0x9e8));
    this[0x9f0] = AVar17;
    *(uint *)(this + 0x9f4) = uVar22;
...
LAB_00110c43:
  iVar19 = Animation::get_track_count();
  iVar21 = (int)piVar34;
  if (iVar19 <= iVar21) goto LAB_0011055e;
  cVar15 = HashSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>>::_lookup_pos
                     (pHVar4,piVar34,(uint *)&local_1a8);
  if ((cVar15 == '\0') &&
     (cVar15 = Animation::track_get_type((int)*(undefined8 *)(this + 0x9e8)), cVar15 == '\x06')) {
    AVar17 = this[0x9f0];
    Ref<Animation>::operator=((Ref<Animation> *)(this + 0x9e8),*(Ref **)(this + 0x9e8));
  ...
  piVar34 = (int *)(ulong)(iVar21 + 1);
  goto LAB_00110c43;
LAB_0011055e:
  local_1a0 = (undefined4 *)0x0;
  for (uVar22 = 0; iVar19 = Animation::get_track_count(), (int)uVar22 < iVar19; uVar22 = uVar22 + 1)
  {
    cVar15 = HashSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>>::_lookup_pos
                       (pHVar4,(int *)(ulong)uVar22,(uint *)&local_1b0);
    if ((cVar15 == '\0') &&
       (cVar15 = Animation::track_get_type((int)*(undefined8 *)(this + 0x9e8)), cVar15 == '\x06')) {
  ...
  uVar20 = 0xffffffff;
  if ((local_1a0 != (undefined4 *)0x0) && (uVar20 = 0xffffffff, *(long *)(local_1a0 + -2) == 1)) {
    uVar20 = *local_1a0;
  }
  *(undefined4 *)(this + 0xaa0) = uVar20;
  CanvasItem::queue_redraw();
...
LAB_0010dfed:
  ...
  RBMap<int,Rect2,Comparator<int>,DefaultAllocator>::_Data::_free_root((_Data *)&local_198);
LAB_0010bd46:
  Ref<InputEventMouseButton>::unref((Ref<InputEventMouseButton> *)&local_1c0);
  if (local_2c8 != (Object *)0x0) {
LAB_0010bd60:
    cVar15 = RefCounted::unreference();
    if ((cVar15 != '\0') && (cVar15 = predelete_handler(local_2c8), cVar15 != '\0')) {
      (**(code **)(*(long *)local_2c8 + 0x140))(local_2c8);
      Memory::free_static(local_2c8,false);
    }
  }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* AnimationBezierTrackEdit::_notification(int) */

void __thiscall AnimationBezierTrackEdit::_notification(AnimationBezierTrackEdit *this,int param_1)

{
  ...
  if (param_1 == 0x2d) {
    if ((_notification(int)::{lambda()#1}::operator()()::sname == '\0') &&
       (iVar22 = __cxa_guard_acquire(&_notification(int)::{lambda()#1}::operator()()::sname),
       iVar22 != 0)) {
  ...
  if (param_1 < 0x2e) {
    if (param_1 != 10) {
      ...
      local_2b8 = auVar16;
      if ((param_1 == 0x1e) &&
         (local_308 = auVar65, local_2f8 = auVar11, local_2e8 = auVar13, local_2d8 = auVar15,
         local_2b8 = auVar17, *(long *)(this + 0x9e8) != 0)) {
        iVar22 = AnimationTimelineEdit::get_name_limit();
        if ((_notification(int)::{lambda()#4}::operator()()::sname == '\0') &&
           (iVar24 = __cxa_guard_acquire(&_notification(int)::{lambda()#4}::operator()()::sname),
           iVar24 != 0)) {
        ...
        if ((_notification(int)::{lambda()#5}::operator()()::sname == '\0') &&
           (iVar24 = __cxa_guard_acquire(&_notification(int)::{lambda()#5}::operator()()::sname),
           iVar24 != 0)) {
        ...
        if (_notification(int)::{lambda()#7}::operator()()::sname == '\0') {
          iVar24 = __cxa_guard_acquire(&_notification(int)::{lambda()#7}::operator()()::sname);
          if (iVar24 != 0) {
        ...
        if (_notification(int)::{lambda()#10}::operator()()::sname == '\0') {
          iVar24 = __cxa_guard_acquire(&_notification(int)::{lambda()#10}::operator()()::sname);
          if (iVar24 != 0) {
        ...
        if (_notification(int)::{lambda()#9}::operator()()::sname == '\0') {
          iVar24 = __cxa_guard_acquire(&_notification(int)::{lambda()#9}::operator()()::sname);
          if (iVar24 != 0) {
        ...
        if (_notification(int)::{lambda()#12}::operator()()::sname == '\0') {
          iVar24 = __cxa_guard_acquire(&_notification(int)::{lambda()#12}::operator()()::sname);
          if (iVar24 != 0) {
        ...
        if (_notification(int)::{lambda()#11}::operator()()::sname == '\0') {
          iVar24 = __cxa_guard_acquire(&_notification(int)::{lambda()#11}::operator()()::sname);
          if (iVar24 != 0) {
        ...
        if (_notification(int)::{lambda()#14}::operator()()::sname == '\0') {
          iVar24 = __cxa_guard_acquire(&_notification(int)::{lambda()#14}::operator()()::sname);
          if (iVar24 != 0) {
        ...
        if (_notification(int)::{lambda()#13}::operator()()::sname == '\0') {
          iVar24 = __cxa_guard_acquire(&_notification(int)::{lambda()#13}::operator()()::sname);
          if (iVar24 != 0) {
        ...
        if (_notification(int)::{lambda()#16}::operator()()::sname == '\0') {
          iVar24 = __cxa_guard_acquire(&_notification(int)::{lambda()#16}::operator()()::sname);
          if (iVar24 != 0) {
            _scs_create((char *)&_notification(int)::{lambda()#16}::operator()()::sname,true);
            __cxa_atexit(StringName::~StringName,
                         &_notification(int)::{lambda()#16}::operator()()::sname,&__dso_handle);
            __cxa_guard_release(&_notification(int)::{lambda()#16}::operator()()::sname);
          }
        }
        if (_notification(int)::{lambda()#15}::operator()()::sname == '\0') {
          iVar24 = __cxa_guard_acquire(&_notification(int)::{lambda()#15}::operator()()::sname);
          if (iVar24 != 0) {
        ...
        if (_notification(int)::{lambda()#18}::operator()()::sname == '\0') {
          iVar25 = __cxa_guard_acquire(&_notification(int)::{lambda()#18}::operator()()::sname);
          if (iVar25 != 0) {
            _scs_create((char *)&_notification(int)::{lambda()#18}::operator()()::sname,true);
            __cxa_atexit(StringName::~StringName,
                         &_notification(int)::{lambda()#18}::operator()()::sname,&__dso_handle);
            __cxa_guard_release(&_notification(int)::{lambda()#18}::operator()()::sname);
          }
        }
        if (_notification(int)::{lambda()#17}::operator()()::sname == '\0') {
          iVar25 = __cxa_guard_acquire(&_notification(int)::{lambda()#17}::operator()()::sname);
          if (iVar25 != 0) {
            _scs_create((char *)&_notification(int)::{lambda()#17}::operator()()::sname,true);
            __cxa_atexit(StringName::~StringName,
                         &_notification(int)::{lambda()#17}::operator()()::sname,&__dso_handle);
        ...
        fVar58 = (float)iVar22;
        auVar8._8_8_ = 0;
        auVar8._0_8_ = uStack_200;
        _local_208 = auVar8 << 0x40;
        local_208._0_4_ = fVar58;
        local_248 = fVar58;
        fStack_244 = extraout_XMM0_Db;
        CanvasItem::draw_line
                  ((Vector2 *)this,(Vector2 *)local_208,(Color *)&local_248,fVar46,
                   SUB81(local_2f8,0));
        fVar46 = (float)Control::get_size();
        local_2c8._8_4_ = _UNK_0012a538;
        local_2c8._0_8_ = __LC71;
        local_2c8._12_4_ = _LC19;
        local_3b8 = (undefined8 *)0x0;
        fVar60 = (float)iVar25;
        local_3b0 = &_GlobalNilClass::_nil;
        local_3a8 = 0;
        *(float *)(this + 0xaac) = fVar60;
        iVar26 = (int)(fVar60 + *(float *)(this + 0xaa8));
        RBMap<int,Rect2,Comparator<int>,DefaultAllocator>::clear
                  ((RBMap<int,Rect2,Comparator<int>,DefaultAllocator> *)(this + 0xa20));
        RBMap<int,RBMap<int,Rect2,Comparator<int>,DefaultAllocator>,Comparator<int>,DefaultAllocator>
        ::clear((RBMap<int,RBMap<int,Rect2,Comparator<int>,DefaultAllocator>,Comparator<int>,DefaultAllocator>
                 *)(this + 0xa38));
        local_398 = 0;
        local_388 = 0;
        local_390 = &_GlobalNilClass::_nil;
        uVar27 = Animation::get_track_count();
        if (0 < (int)uVar27) {
          do {
            ...
            if (cVar20 != '\0') {
              ...
              if (local_398 != 0) {
                for (puVar36 = *(undefined8 **)(local_398 + 0x10); local_390 != puVar36;
                  ...
                  if (cVar20 == '\0') {
                    if (puVar36 != (undefined8 *)0x0) {
                      lVar35 = RBMap<String,Vector<int>,Comparator<String>,DefaultAllocator>::
                               operator[]((RBMap<String,Vector<int>,Comparator<String>,DefaultAllocator>
                                           *)&local_398,(String *)&local_358);
...
LAB_00111be7:
              local_330 = (undefined8 *)0x0;
LAB_00111c03:
              Vector<int>::push_back((Vector<int> *)&local_338,uVar42);
              lVar35 = RBMap<String,Vector<int>,Comparator<String>,DefaultAllocator>::operator[]
                                 ((RBMap<String,Vector<int>,Comparator<String>,DefaultAllocator> *)
                                  &local_398,(String *)&local_358);
        ...
        auVar9._8_8_ = local_2b8._8_8_;
        auVar9._0_8_ = local_2b8._0_8_;
        if ((local_398 != 0) &&
           (puVar36 = *(undefined8 **)(local_398 + 0x10), local_2b8 = auVar9,
           *(undefined8 **)(local_398 + 0x10) != local_390)) {
          do {
            local_468 = puVar36;
...
LAB_00115f0d:
            ...
            if (_notification(int)::{lambda()#20}::operator()()::sname == '\0') {
              iVar28 = __cxa_guard_acquire(&_notification(int)::{lambda()#20}::operator()()::sname);
              if (iVar28 != 0) {
                _scs_create((char *)&_notification(int)::{lambda()#20}::operator()()::sname,true);
                __cxa_atexit(StringName::~StringName,
                             &_notification(int)::{lambda()#20}::operator()()::sname,&__dso_handle);
                __cxa_guard_release(&_notification(int)::{lambda()#20}::operator()()::sname);
              }
            }
            Control::get_editor_theme_icon((StringName *)&local_400);
            iVar28 = (**(code **)(*(long *)CONCAT44(uStack_3fc,local_400) + 0x1c8))();
            fVar59 = (float)((iVar22 - iVar24) - iVar28);
            if (_notification(int)::{lambda()#21}::operator()()::sname == '\0') {
              iVar28 = __cxa_guard_acquire(&_notification(int)::{lambda()#21}::operator()()::sname);
              if (iVar28 != 0) {
                _scs_create((char *)&_notification(int)::{lambda()#21}::operator()()::sname,true);
                __cxa_atexit(StringName::~StringName,
                             &_notification(int)::{lambda()#21}::operator()()::sname,&__dso_handle);
                __cxa_guard_release(&_notification(int)::{lambda()#21}::operator()()::sname);
              }
            }
            Control::get_editor_theme_icon((StringName *)&local_3f8);
            if (_notification(int)::{lambda()#22}::operator()()::sname == '\0') {
              iVar28 = __cxa_guard_acquire(&_notification(int)::{lambda()#22}::operator()()::sname);
              if (iVar28 != 0) {
                _scs_create((char *)&_notification(int)::{lambda()#22}::operator()()::sname,true);
                __cxa_atexit(StringName::~StringName,
                             &_notification(int)::{lambda()#22}::operator()()::sname,&__dso_handle);
                __cxa_guard_release(&_notification(int)::{lambda()#22}::operator()()::sname);
              }
            }
            Control::get_editor_theme_icon((StringName *)&local_3f0);
            iVar28 = (**(code **)(*local_3f8 + 0x1c8))();
            fVar47 = (fVar59 - local_57c) - (float)iVar28;
            if (_notification(int)::{lambda()#23}::operator()()::sname == '\0') {
              iVar28 = __cxa_guard_acquire(&_notification(int)::{lambda()#23}::operator()()::sname);
              if (iVar28 != 0) {
                _scs_create((char *)&_notification(int)::{lambda()#23}::operator()()::sname,true);
                __cxa_atexit(StringName::~StringName,
                             &_notification(int)::{lambda()#23}::operator()()::sname,&__dso_handle);
                __cxa_guard_release(&_notification(int)::{lambda()#23}::operator()()::sname);
              }
            }
            Control::get_editor_theme_icon((StringName *)&local_3e8);
            if (_notification(int)::{lambda()#24}::operator()()::sname == '\0') {
              iVar28 = __cxa_guard_acquire(&_notification(int)::{lambda()#24}::operator()()::sname);
              if (iVar28 != 0) {
                _scs_create((char *)&_notification(int)::{lambda()#24}::operator()()::sname,true);
                __cxa_atexit(StringName::~StringName,
                             &_notification(int)::{lambda()#24}::operator()()::sname,&__dso_handle);
                __cxa_guard_release(&_notification(int)::{lambda()#24}::operator()()::sname);
              }
            }
            Control::get_editor_theme_icon((StringName *)&local_3e0);
            iVar28 = (**(code **)(*local_3e8 + 0x1c8))();
            fVar48 = (fVar47 - local_57c) - (float)iVar28;
            if (_notification(int)::{lambda()#25}::operator()()::sname == '\0') {
              iVar28 = __cxa_guard_acquire(&_notification(int)::{lambda()#25}::operator()()::sname);
              if (iVar28 != 0) {
                _scs_create((char *)&_notification(int)::{lambda()#25}::operator()()::sname,true);
                __cxa_atexit(StringName::~StringName,
                             &_notification(int)::{lambda()#25}::operator()()::sname,&__dso_handle);
                __cxa_guard_release(&_notification(int)::{lambda()#25}::operator()()::sname);
              }
            }
            Control::get_editor_theme_icon((StringName *)&local_3d8);
            iVar28 = (**(code **)(*local_3d8 + 0x1c8))();
            fVar49 = (fVar48 - local_57c) - (float)iVar28;
            iVar28 = (**(code **)(*(long *)CONCAT44(uStack_3fc,local_400) + 0x1c8))();
            iVar29 = (**(code **)(*local_3f8 + 0x1c8))();
            iVar30 = (**(code **)(*local_3e8 + 0x1c8))();
            iVar31 = (**(code **)(*local_3d8 + 0x1c8))();
            lVar35 = local_3c0;
            fVar61 = _LC19;
            if ((local_3c0 != 0) && (0 < *(long *)(local_3c0 + -8))) {
              this_00 = (HashSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>> *)
                        (this + 0xa50);
              local_588 = 0;
              do {
                ...
                local_2a8 = local_308;
                String::parse_latin1((StrRange *)&local_358);
                TextLine::TextLine((TextLine *)local_208,local_590,(StringName *)&local_410,uVar23,
                                   (StrRange *)&local_358,0,0);
                CowData<char32_t>::_unref((CowData<char32_t> *)&local_358);
                TextLine::set_width(((float)(iVar22 - local_518) -
                                    (float)(iVar31 + iVar28 + iVar29 + iVar30 + iVar24 * 3)) -
                                    (float)(iVar24 * 2));
                TextLine::get_size();
                iVar32 = (**(code **)(*local_3d8 + 0x1c8))();
                fVar56 = (float)iVar26;
                uStack_290 = CONCAT44(extraout_XMM0_Db_00 + fVar60,
                                      (fVar49 - local_57c) - (float)iVar32);
                ...
                if (uVar42 == *(uint *)(this + 0x9f4)) {
                  CanvasItem::draw_rect
                            ((Rect2 *)this,(Color *)&local_298,SUB81(local_2d8,0),_LC145,true);
                  cVar20 = HashSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>>::
                           _lookup_pos(this_00,(int *)(ulong)*(uint *)(this + 0x9f4),
                                       (uint *)&local_338);
                  if (cVar20 == '\0') {
                  ...
                  fStack_24c = _LC19;
                  cVar20 = HashSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>>::
                           _lookup_pos(this_00,(int *)(ulong)uVar42,(uint *)&local_338);
                  if (cVar20 == '\0') {
                  ...
                  fStack_244 = fVar56;
                  CanvasItem::draw_rect
                            ((Rect2 *)this,(Color *)&local_248,SUB81((Color *)&local_258,0),_LC145,
                             true);
                  puVar36 = local_3b8;
                  if (local_3b8 == (undefined8 *)0x0) {
                    ...
                    *(undefined8 *)((long)local_3b8 + 0x3c) = uVar52;
                    local_3b8[1] = local_3b0;
                    local_3b8[2] = local_3b0;
                    local_3b8[3] = local_3b0;
                  }
                  else {
...
LAB_00112509:
                  local_248 = (float)__LC71;
                  fStack_244 = (float)((ulong)__LC71 >> 0x20);
                  fStack_240 = _UNK_0012a538;
                  fStack_23c = _LC19;
                  puVar36 = (undefined8 *)
                            RBMap<int,Color,Comparator<int>,DefaultAllocator>::_insert
                                      ((RBMap<int,Color,Comparator<int>,DefaultAllocator> *)
                                       &local_3b8,(int *)&local_414,(Color *)&local_248);
LAB_00112530:
                  *(undefined8 *)((long)puVar36 + 0x34) = local_258;
...
LAB_00112579:
                  ...
                  fStack_240 = 0.0;
                  fStack_23c = 0.0;
                  lVar37 = RBMap<int,Rect2,Comparator<int>,DefaultAllocator>::_insert
                                     ((RBMap<int,Rect2,Comparator<int>,DefaultAllocator> *)
                                      (this + 0xa20),(int *)&local_414,(Rect2 *)&local_248);
LAB_001125a9:
                  *(undefined8 *)(lVar37 + 0x34) = local_298;
                  *(undefined8 *)(lVar37 + 0x3c) = uStack_290;
                }
                local_310 = CONCAT44(fVar56,(float)(local_518 + iVar24));
                TextLine::draw((Vector2 *)local_208,*(undefined8 *)(this + 0x428),&local_310,
                               local_2a8);
                ...
                cVar20 = HashSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>>::
                         _lookup_pos((HashSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>>
                                      *)(this + 0xa78),(int *)(ulong)uVar42,(uint *)&local_338);
                if (cVar20 == '\0') {
                  fStack_240 = fVar61;
                  fStack_23c = fVar61;
                  local_248 = fVar61;
                ...
                *(undefined4 *)local_378 = 1;
                local_378[1] = (long)local_370;
                local_378[2] = (long)local_370;
                local_378[3] = (long)local_370;
                local_248 = 0.0;
                fStack_244 = 0.0;
                fStack_240 = 0.0;
                fStack_23c = 0.0;
                lVar37 = RBMap<int,Rect2,Comparator<int>,DefaultAllocator>::_insert
                                   ((RBMap<int,Rect2,Comparator<int>,DefaultAllocator> *)&local_378,
                                    (int *)&local_338,(Rect2 *)&local_248);
                ...
                *(undefined4 *)(lVar37 + 0x40) = uStack_280._4_4_;
                ...
                if (local_378 == (long *)0x0) {
                  ...
                  *(undefined4 *)local_378 = 1;
                  ...
                  for (puVar36 = (undefined8 *)local_378[2]; puVar36 != local_370;
                      puVar36 = (undefined8 *)puVar36[1]) {
...
LAB_00112b49:
                  for (puVar36 = (undefined8 *)local_378[2]; local_370 != puVar36;
                      puVar36 = (undefined8 *)puVar36[1]) {
...
LAB_00112b9a:
                ...
                *(undefined1 (*) [16])((long)puVar36 + 0x34) = auVar6;
                if (*(long *)(this + 0xa38) == 0) {
                  ...
                  local_320 = 0;
                  RBMap<int,Rect2,Comparator<int>,DefaultAllocator>::_copy_from
                            ((RBMap<int,Rect2,Comparator<int>,DefaultAllocator> *)&local_330,
                             (RBMap *)&local_358);
                  *puVar39 = 0;
                  ...
                  *(undefined1 (*) [16])(puVar39 + 6) = (undefined1  [16])0x0;
                  RBMap<int,Rect2,Comparator<int>,DefaultAllocator>::_copy_from
                            ((RBMap<int,Rect2,Comparator<int>,DefaultAllocator> *)(puVar39 + 0xe),
                             (RBMap *)&local_330);
                  *(undefined4 **)(this + 0xa38) = puVar39;
                  ...
                  RBMap<int,Rect2,Comparator<int>,DefaultAllocator>::clear
                            ((RBMap<int,Rect2,Comparator<int>,DefaultAllocator> *)&local_358);
                  if (local_358 != (Object *)0x0) {
...
LAB_00112bea:
                ...
                lVar37 = RBMap<int,RBMap<int,Rect2,Comparator<int>,DefaultAllocator>,Comparator<int>,DefaultAllocator>
                         ::_insert((RBMap<int,RBMap<int,Rect2,Comparator<int>,DefaultAllocator>,Comparator<int>,DefaultAllocator>
                                    *)(this + 0xa38),(int *)&local_414,(RBMap *)&local_338);
                RBMap<int,Rect2,Comparator<int>,DefaultAllocator>::clear
                          ((RBMap<int,Rect2,Comparator<int>,DefaultAllocator> *)&local_338);
                if (local_338 != (Object *)0x0) {
                  Memory::free_static(local_338,false);
                }
LAB_00112c47:
                RBMap<int,Rect2,Comparator<int>,DefaultAllocator>::_copy_from
                          ((RBMap<int,Rect2,Comparator<int>,DefaultAllocator> *)(lVar37 + 0x38),
                           (RBMap *)&local_378);
                TextLine::get_size();
            ...
            Ref<Texture2D>::unref((Ref<Texture2D> *)&local_3d8);
            Ref<Texture2D>::unref((Ref<Texture2D> *)&local_3e0);
            Ref<Texture2D>::unref((Ref<Texture2D> *)&local_3e8);
            Ref<Texture2D>::unref((Ref<Texture2D> *)&local_3f0);
            Ref<Texture2D>::unref((Ref<Texture2D> *)&local_3f8);
            Ref<Texture2D>::unref((Ref<Texture2D> *)&local_400);
            CowData<int>::_unref((CowData<int> *)&local_3c0);
            CowData<char32_t>::_unref((CowData<char32_t> *)&local_408);
            local_468 = (undefined8 *)local_468[4];
          } while (local_468 != (undefined8 *)0x0);
        }
        if (_notification(int)::{lambda()#26}::operator()()::sname == '\0') {
          iVar24 = __cxa_guard_acquire(&_notification(int)::{lambda()#26}::operator()()::sname);
          if (iVar24 != 0) {
            _scs_create((char *)&_notification(int)::{lambda()#26}::operator()()::sname,true);
            __cxa_atexit(StringName::~StringName,
                         &_notification(int)::{lambda()#26}::operator()()::sname,&__dso_handle);
            __cxa_guard_release(&_notification(int)::{lambda()#26}::operator()()::sname);
          }
        }
        auVar65 = Control::get_theme_color
                            ((StringName *)this,
                             (StringName *)&_notification(int)::{lambda()#26}::operator()()::sname);
        local_258 = auVar65._0_8_;
        fStack_250 = auVar65._8_4_;
        fStack_24c = auVar65._12_4_;
        fVar59 = (float)(**(code **)(*(long *)local_410 + 0x218))(local_410,uVar23);
        fVar59 = fVar60 + fVar59 + fVar60 + fVar59;
        dVar55 = (double)(fVar59 * *(float *)(this + 0xab4));
        dVar51 = log(dVar55 / __LC242);
        dVar51 = round(dVar51 / __LC243);
        dVar51 = pow(_LC244,dVar51);
        dVar51 = dVar51 * __LC242;
        dVar57 = (double)(float)dVar51;
        dVar55 = (double)Math::snapped(dVar55,dVar57);
        for (fVar60 = (float)dVar55; fVar60 / *(float *)(this + 0xab4) < fVar59;
            fVar60 = fVar60 + (float)dVar51) {
        }
        iVar25 = (int)fVar46;
        bVar21 = true;
        fVar46 = (float)(**(code **)(*(long *)local_410 + 0x218))(local_410,uVar23);
        iVar26 = (int)fVar46;
        iVar24 = 0;
        while( true ) {
          fVar46 = (float)iVar26;
          ...
          Control::get_size();
          fVar59 = (float)((double)extraout_XMM0_Db_04 * __LC21 - (double)iVar26) *
                   *(float *)(this + 0xab4) + *(float *)(this + 0xab0);
          ...
          if ((!bVar21) && (iVar24 != iVar28)) {
            ...
            CanvasItem::draw_line
                      ((Vector2 *)this,(Vector2 *)&local_268,(Color *)local_208,fVar59,
                       SUB81((Color *)&local_248,0));
            ...
            rtos(dVar51);
            (*pcVar3)((CowData<char32_t> *)&local_338,pOVar41,(CowData<char32_t> *)&local_378,
                      (String *)&local_358);
            local_268 = CONCAT44((float)iVar29,(float)iVar24);
            CanvasItem::draw_string
                      (this,(StringName *)&local_410,(Vector2 *)&local_268,
                       (CowData<char32_t> *)&local_338,0,uVar23,(Vector2 *)local_208,3,0,0);
            CowData<char32_t>::_unref((CowData<char32_t> *)&local_338);
        ...
        fVar46 = (float)AnimationTimelineEdit::get_zoom_scale();
        if (_notification(int)::{lambda()#27}::operator()()::sname == '\0') {
          iVar24 = __cxa_guard_acquire(&_notification(int)::{lambda()#27}::operator()()::sname);
          if (iVar24 != 0) {
            _scs_create((char *)&_notification(int)::{lambda()#27}::operator()()::sname,true);
            __cxa_atexit(StringName::~StringName,
                         &_notification(int)::{lambda()#27}::operator()()::sname,&__dso_handle);
            __cxa_guard_release(&_notification(int)::{lambda()#27}::operator()()::sname);
          }
        }
        Control::get_editor_theme_icon((StringName *)&local_338);
        if ((local_3b8 != (undefined8 *)0x0) &&
           (puVar36 = (undefined8 *)local_3b8[2], (undefined8 *)local_3b8[2] != local_3b0)) {
          do {
            puVar43 = puVar36;
          ...
          do {
            ...
            cVar20 = HashSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>>::_lookup_pos
                               ((HashSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>> *)
                                (this + 0xa78),(int *)(ulong)uVar42,(uint *)&local_358);
            if (cVar20 == '\0') {
              iVar24 = 0;
              ...
              while( true ) {
                ...
                dVar51 = (double)Animation::track_get_key_time
                                           ((int)*(undefined8 *)(this + 0x9e8),*(int *)(puVar43 + 6)
                                           );
                fVar47 = (float)Animation::bezier_track_get_key_value
                                          ((int)*(undefined8 *)(this + 0x9e8),*(int *)(puVar43 + 6))
                ;
                ...
                if ((fVar58 <= fVar48) && (fVar48 <= (float)iVar25)) {
                  ...
                  auVar64 = _local_208;
                  local_208._4_4_ =
                       (float)((double)extraout_XMM0_Db_06 * __LC21 -
                              (double)((fVar47 - fVar60) / fVar59)) -
                       (float)((ulong)uVar52 >> 0x20) * _UNK_0012a544;
        ...
        if ((int)uVar27 < 1) {
          Ref<Texture2D>::unref((Ref<Texture2D> *)&local_338);
          CowData<AnimationBezierTrackEdit::EditPoint>::resize<false>
                    ((CowData<AnimationBezierTrackEdit::EditPoint> *)(this + 0xb98),0);
          AnimationTimelineEdit::get_zoom_scale();
        }
        else {
          ...
          do {
            ...
            if (cVar20 != '\0') {
              cVar20 = HashSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>>::_lookup_pos
                                 ((HashSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>> *
                                  )(this + 0xa50),(int *)(ulong)uVar42,(uint *)&local_338);
              if (cVar20 == '\0') {
                iVar24 = Animation::track_get_key_count((int)*(undefined8 *)(this + 0x9e8));
                uVar34 = local_400;
                if (0 < iVar24) {
                  ...
                  do {
                    dVar57 = (double)Animation::track_get_key_time
                                               ((int)*(undefined8 *)(this + 0x9e8),uVar42);
                    fVar60 = (float)dVar57;
                    fVar59 = (float)Animation::bezier_track_get_key_value
                                              ((int)*(undefined8 *)(this + 0x9e8),uVar42);
                    if (this[0xad8] != (AnimationBezierTrackEdit)0x0) {
...
LAB_00114940:
                        ...
                        if (*(long *)(this + 0xba8) != lVar35) {
                          do {
                            ...
                            else if (uVar50 != uVar42 && (int)uVar42 <= (int)uVar50)
                            goto LAB_00114940;
                    ...
                    if ((((*(int *)(this + 0xb00) + 1U & 0xfffffffd) == 0) &&
                        (*(uint *)(this + 0xb08) == uVar42)) && (*(int *)(this + 0xb04) == iVar26))
                    {
                    ...
                    local_278 = fVar62;
                    fStack_274 = fVar63;
                    uVar52 = Animation::bezier_track_get_key_out_handle
                                       ((int)*(undefined8 *)(this + 0x9e8),uVar42);
                    fVar48 = (float)uVar52;
                    fVar47 = (float)((ulong)uVar52 >> 0x20);
                    if ((((*(int *)(this + 0xb00) + 1U & 0xfffffffd) == 0) &&
...
LAB_00114f3f:
                      _draw_line_clipped(this,(Vector2 *)&local_288,(Vector2 *)&local_278,
                                         (Color *)&local_258,iVar22,iVar25);
                      _draw_line_clipped(this,(Vector2 *)&local_288,(Vector2 *)&local_268,
                                         (Color *)&local_258,iVar22,iVar25);
                    }
                    else {
                      lVar35 = *(long *)(this + 0xba0);
...
LAB_00114cf2:
                            ...
                            if (uVar50 == uVar42) {
                              ...
                              if (iVar26 <= *(int *)(lVar35 + 0x34)) {
                                ...
                                CanvasItem::draw_texture
                                          ((Ref *)this,(Vector2 *)(this + 0xa18),(Color *)&local_248
                                          );
                                local_3d0 = (long *)0x0;
                                Ref<TextServer>::operator=
                                          ((Ref<TextServer> *)&local_3d0,
                                ...
                                rtos(dVar57);
                                (*pcVar3)((CowData<char32_t> *)&local_358,plVar19,local_3c8,
                                          (String *)&local_378);
                                local_3e0 = 0;
                                ...
                                local_208 = (undefined1  [8])
                                            CONCAT44(((float)(uVar50 ^ _LC15) - (float)_LC250) +
                                                     fStack_244,local_248 + (float)_LC250);
                                CanvasItem::draw_string
                                          (this,(StringName *)&local_410,(Vector2 *)local_208,
                                           (StringName *)&local_338,0,uVar23,&local_258,3,0,0);
                                CowData<char32_t>::_unref((CowData<char32_t> *)&local_338);
                      ...
                      if (*(uint *)(this + 0x9f4) != uVar42) {
                        pauVar40 = (undefined1 (*) [16])
                                   RBMap<int,Color,Comparator<int>,DefaultAllocator>::operator[]
                                             (local_500,(int *)&local_400);
                        _local_208 = *pauVar40;
                      }
                      CanvasItem::draw_texture
                                ((Ref *)this,(Vector2 *)(this + 0xa08),(Color *)&local_248);
LAB_00114d6a:
                      fVar60 = _LC37 * fStack_240;
                      fVar59 = fVar60 + fVar60 + fStack_240;
                      local_248 = (local_248 - fStack_240 * _LC37) - fVar59 * _LC37;
                      fStack_244 = (fStack_244 - fStack_240 * _UNK_0012a544) -
                                   fVar59 * _UNK_0012a544;
                      fStack_240 = _LC37 * fVar59 * _UNK_0012a548 +
                                   fVar60 * _UNK_0012a548 + fStack_240;
                      fStack_23c = _LC37 * fVar59 * _UNK_0012a54c +
                                   fVar60 * _UNK_0012a54c + fStack_23c;
                    }
                    if (*(uint *)(this + 0x9f4) == uVar42) {
LAB_00114faf:
                      iVar28 = Animation::bezier_track_get_key_handle_mode
                                         ((int)*(undefined8 *)(this + 0x9e8),uVar34);
                      if (iVar28 != 1) {
                        if ((fVar58 <= fVar62) && (fVar62 <= (float)iVar25)) {
                          ...
                          uStack_200._4_4_ = _LC19;
                          CanvasItem::draw_texture
                                    ((Ref *)this,(Vector2 *)(this + 0xa10),(Color *)&fStack_238);
                        ...
                        if ((fVar58 <= fVar48) && (fVar48 <= (float)iVar25)) {
                          ...
                          uStack_200._4_4_ = _LC19;
                          CanvasItem::draw_texture
                                    ((Ref *)this,(Vector2 *)(this + 0xa10),(Color *)local_228);
                          fVar60 = _LC37 * (float)uStack_220;
                          local_228._4_4_ =
                               (float)local_228._4_4_ - (float)uStack_220 * _UNK_0012a544;
...
LAB_00114e08:
                    ...
                    cVar20 = HashSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>>::
                             _lookup_pos((HashSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>>
                                          *)(this + 0xa50),(int *)(ulong)uVar34,(uint *)&local_338);
                    if (cVar20 == '\0') {
                      ...
                      iVar28 = CowData<AnimationBezierTrackEdit::EditPoint>::resize<false>
                                         (local_550,lVar35);
                      if (iVar28 == 0) {
                        if (*(long *)(this + 0xb98) == 0) {
                          lVar37 = -1;
...
LAB_00114e3f:
        ...
        local_500 = (RBMap<int,Color,Comparator<int>,DefaultAllocator> *)&local_3b8;
        this_01 = (CowData<AnimationBezierTrackEdit::EditPoint> *)(this + 0xb98);
        pauVar40 = *(undefined1 (**) [16])this_01;
        lVar37 = 0;
        lVar35 = 0;
joined_r0x001138a7:
        if (pauVar40 != (undefined1 (*) [16])0x0) {
          do {
            ...
            if (lVar4 == 0) {
              ...
              if (lVar35 < lVar45) {
                memmove((void *)(lVar4 + lVar37),(void *)(lVar4 + lVar37 + 0x38),
                        (*(long *)(lVar4 + -8) - lVar35) * 0x38 - 0x38);
              }
            }
            ...
            if (*(long *)(this + 0xb98) == 0) {
              ...
              if (lVar4 < 1) {
                _err_print_index_error
                          ("insert","./core/templates/cowdata.h",0xf0,0,lVar4,"p_pos","new_size","",
                           false,false);
                pauVar40 = *(undefined1 (**) [16])(this + 0xb98);
                goto LAB_001138ce;
              }
        ...
        if (this[0xaed] != (AnimationBezierTrackEdit)0x0) {
          ...
          if (_notification(int)::{lambda()#28}::operator()()::sname == '\0') {
            iVar22 = __cxa_guard_acquire(&_notification(int)::{lambda()#28}::operator()()::sname);
            if (iVar22 != 0) {
              _scs_create((char *)&_notification(int)::{lambda()#28}::operator()()::sname,true);
              __cxa_atexit(StringName::~StringName,
                           &_notification(int)::{lambda()#28}::operator()()::sname,&__dso_handle);
          ...
          _local_208 = Control::get_theme_color
                                 ((StringName *)this,
                                  (StringName *)
                                  &_notification(int)::{lambda()#28}::operator()()::sname);
          bVar21 = SUB81((Vector2 *)local_208,0);
          local_248 = fVar58;
          fStack_244 = fVar60;
          fStack_240 = fVar47 - fVar58;
          fStack_23c = fVar46 - fVar60;
          CanvasItem::draw_rect((Rect2 *)this,(Color *)&local_248,bVar21,_LC145,true);
          fVar59 = (float)EditorScale::get_scale();
          fVar59 = roundf(fVar59);
          if (_notification(int)::{lambda()#29}::operator()()::sname == '\0') {
            iVar22 = __cxa_guard_acquire(&_notification(int)::{lambda()#29}::operator()()::sname);
            if (iVar22 != 0) {
              _scs_create((char *)&_notification(int)::{lambda()#29}::operator()()::sname,true);
              __cxa_atexit(StringName::~StringName,
                           &_notification(int)::{lambda()#29}::operator()()::sname,&__dso_handle);
          ...
          _local_208 = Control::get_theme_color
                                 ((StringName *)this,
                                  (StringName *)
                                  &_notification(int)::{lambda()#29}::operator()()::sname);
          local_248 = fVar58;
          fStack_244 = fVar60;
          fStack_240 = fVar47 - fVar58;
          fStack_23c = fVar46 - fVar60;
          CanvasItem::draw_rect((Rect2 *)this,(Color *)&local_248,bVar21,fVar59,false);
        }
        RBMap<String,Vector<int>,Comparator<String>,DefaultAllocator>::~RBMap
                  ((RBMap<String,Vector<int>,Comparator<String>,DefaultAllocator> *)&local_398);
        RBMap<int,Color,Comparator<int>,DefaultAllocator>::clear(local_500);
        if (local_3b8 != (undefined8 *)0x0) {
  ...
  local_338 = (Object *)0x0;
  String::parse_latin1((String *)&local_338,"editors/panning/simple_panning");
  _EDITOR_GET((String *)local_208);
  bVar21 = Variant::operator_cast_to_bool((Variant *)local_208);
  local_378 = (long *)0x0;
  String::parse_latin1((String *)&local_378,"canvas_item_editor/pan_view");
  ED_GET_SHORTCUT((String *)&local_358);
  local_398 = 0;
  String::parse_latin1((String *)&local_398,"editors/panning/animation_editors_panning_scheme");
  _EDITOR_GET((String *)&local_248);
  iVar22 = Variant::operator_cast_to_int((Variant *)&local_248);
  ViewPanner::setup(local_590,iVar22,(String *)&local_358,bVar21);
  if (Variant::needs_deinit[(int)local_248] != '\0') {
    Variant::_clear_internal();
  }
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_398);
  Ref<Shortcut>::unref((Ref<Shortcut> *)&local_358);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_378);
  if (Variant::needs_deinit[(int)local_208._0_4_] != '\0') {
    Variant::_clear_internal();
  }
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_338);
  pVVar2 = *(Viewport **)(this + 3000);
  local_338 = (Object *)0x0;
  String::parse_latin1((String *)&local_338,"editors/panning/warped_mouse_panning");
  _EDITOR_GET((String *)local_208);
  Variant::operator_cast_to_bool((Variant *)local_208);
...
LAB_001138ce:
  lVar37 = lVar37 + 0x38;
  lVar35 = lVar35 + 1;
  goto joined_r0x001138a7;
}



/* AnimationBezierTrackEdit::get_tooltip(Vector2 const&) const */

Vector2 * AnimationBezierTrackEdit::get_tooltip(Vector2 *param_1)
...
/* AnimationBezierTrackEdit::is_class_ptr(void*) const */

uint __thiscall AnimationBezierTrackEdit::is_class_ptr(AnimationBezierTrackEdit *this,void *param_1)

{
  return (uint)CONCAT71(0x12a2,(undefined4 *)param_1 == &Control::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x12a1,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x12a2,(undefined4 *)param_1 == &CanvasItem::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x12a2,(undefined4 *)param_1 == &Node::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x12a2,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr);
}
...
void __thiscall
CallableCustomMethodPointer<AnimationBezierTrackEdit,void,int>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<AnimationBezierTrackEdit,void,int> *this)
...
CallableCustomMethodPointer<AnimationBezierTrackEdit,void,Vector2,Ref<InputEvent>>::
~CallableCustomMethodPointer
          (CallableCustomMethodPointer<AnimationBezierTrackEdit,void,Vector2,Ref<InputEvent>> *this)
...
/* CallableCustomMethodPointer<Range, void, double>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<Range,void,double>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<Range,void,double> *this)
...
void __thiscall
CallableCustomMethodPointer<AnimationTrackEditor,void,int,int>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<AnimationTrackEditor,void,int,int> *this)
...
void __thiscall
CallableCustomMethodPointer<AnimationTrackEditor,void,int,bool,int>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<AnimationTrackEditor,void,int,bool,int> *this)
...
/* CallableCustomMethodPointer<AnimationTrackEditor, void, bool>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<AnimationTrackEditor,void,bool>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<AnimationTrackEditor,void,bool> *this)
...
/* CallableCustomMethodPointer<AnimationBezierTrackEdit, void>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<AnimationBezierTrackEdit,void>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<AnimationBezierTrackEdit,void> *this)
...
/* MethodBindT<Ref<Animation> const&, int, float, bool>::get_argument_meta(int) const */

char __thiscall
MethodBindT<Ref<Animation>const&,int,float,bool>::get_argument_meta
          (MethodBindT<Ref<Animation>const&,int,float,bool> *this,int param_1)
...
/* MethodBindT<Ref<Animation> const&>::_gen_argument_type(int) const */

byte __thiscall
MethodBindT<Ref<Animation>const&>::_gen_argument_type
          (MethodBindT<Ref<Animation>const&> *this,int param_1)
...
/* MethodBindT<Ref<Animation> const&>::get_argument_meta(int) const */

undefined8 MethodBindT<Ref<Animation>const&>::get_argument_meta(int param_1)
...
undefined8 __thiscall
CallableCustomMethodPointer<AnimationBezierTrackEdit,void,int>::get_argument_count
          (CallableCustomMethodPointer<AnimationBezierTrackEdit,void,int> *this,bool *param_1)
...
undefined8 __thiscall
CallableCustomMethodPointer<AnimationBezierTrackEdit,void,float,Vector2,Ref<InputEvent>>::
get_argument_count(CallableCustomMethodPointer<AnimationBezierTrackEdit,void,float,Vector2,Ref<InputEvent>>
                   *this,bool *param_1)
...
undefined8 __thiscall
CallableCustomMethodPointer<AnimationBezierTrackEdit,void,Vector2,Ref<InputEvent>>::
get_argument_count(CallableCustomMethodPointer<AnimationBezierTrackEdit,void,Vector2,Ref<InputEvent>>
                   *this,bool *param_1)
...
/* CallableCustomMethodPointer<Range, void, double>::get_argument_count(bool&) const */

undefined8 __thiscall
CallableCustomMethodPointer<Range,void,double>::get_argument_count
          (CallableCustomMethodPointer<Range,void,double> *this,bool *param_1)
...
undefined8 __thiscall
CallableCustomMethodPointer<AnimationTrackEditor,void,int,int>::get_argument_count
          (CallableCustomMethodPointer<AnimationTrackEditor,void,int,int> *this,bool *param_1)
...
undefined8 __thiscall
CallableCustomMethodPointer<AnimationTrackEditor,void,int,bool,int>::get_argument_count
          (CallableCustomMethodPointer<AnimationTrackEditor,void,int,bool,int> *this,bool *param_1)
...
/* CallableCustomMethodPointer<AnimationTrackEditor, void, bool>::get_argument_count(bool&) const */

undefined8 __thiscall
CallableCustomMethodPointer<AnimationTrackEditor,void,bool>::get_argument_count
          (CallableCustomMethodPointer<AnimationTrackEditor,void,bool> *this,bool *param_1)
...
/* CallableCustomMethodPointer<AnimationBezierTrackEdit, void>::get_argument_count(bool&) const */

undefined8 __thiscall
CallableCustomMethodPointer<AnimationBezierTrackEdit,void>::get_argument_count
          (CallableCustomMethodPointer<AnimationBezierTrackEdit,void> *this,bool *param_1)
...
/* MethodBindT<Ref<Animation> const&, int, double, float, Vector2 const&, Vector2 const&,
   Animation::HandleMode>::_gen_argument_type(int) const */

char __thiscall
MethodBindT<Ref<Animation>const&,int,double,float,Vector2_const&,Vector2_const&,Animation::HandleMode>
::_gen_argument_type
          (MethodBindT<Ref<Animation>const&,int,double,float,Vector2_const&,Vector2_const&,Animation::HandleMode>
           *this,int param_1)

{
  ...
  cVar1 = '\0';
  if (((((uint)param_1 < 7) && (cVar1 = '\x18', param_1 != 0)) && (cVar1 = '\x02', param_1 != 1)) &&
     (cVar1 = '\x03', 1 < param_1 - 2U)) {
    if (param_1 == 4) {
      return '\x05';
    }
...
/* MethodBindT<Ref<Animation> const&, int, double, float, Vector2 const&, Vector2 const&,
   Animation::HandleMode>::get_argument_meta(int) const */

char __thiscall
MethodBindT<Ref<Animation>const&,int,double,float,Vector2_const&,Vector2_const&,Animation::HandleMode>
::get_argument_meta(MethodBindT<Ref<Animation>const&,int,double,float,Vector2_const&,Vector2_const&,Animation::HandleMode>
                    *this,int param_1)
...
/* MethodBindT<Ref<Animation> const&>::~MethodBindT() */

void __thiscall
MethodBindT<Ref<Animation>const&>::~MethodBindT(MethodBindT<Ref<Animation>const&> *this)
...
/* MethodBindT<Ref<Animation> const&, int, float, bool>::~MethodBindT() */

void __thiscall
MethodBindT<Ref<Animation>const&,int,float,bool>::~MethodBindT
          (MethodBindT<Ref<Animation>const&,int,float,bool> *this)
...
/* MethodBindT<Ref<Animation> const&, int, double, float, Vector2 const&, Vector2 const&,
   Animation::HandleMode>::~MethodBindT() */

void __thiscall
MethodBindT<Ref<Animation>const&,int,double,float,Vector2_const&,Vector2_const&,Animation::HandleMode>
::~MethodBindT(MethodBindT<Ref<Animation>const&,int,double,float,Vector2_const&,Vector2_const&,Animation::HandleMode>
               *this)
...
/* AnimationBezierTrackEdit::_property_get_revertv(StringName const&, Variant&) const */

undefined8 AnimationBezierTrackEdit::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* AnimationBezierTrackEdit::_property_can_revertv(StringName const&) const */

undefined8 AnimationBezierTrackEdit::_property_can_revertv(StringName *param_1)
...
void RBSet<Pair<int,int>,AnimationBezierTrackEdit::PairCompare,DefaultAllocator>::_set_color
...
/* MethodBindT<Ref<Animation> const&, int, float, bool>::_gen_argument_type(int) const */

char __thiscall
MethodBindT<Ref<Animation>const&,int,float,bool>::_gen_argument_type
          (MethodBindT<Ref<Animation>const&,int,float,bool> *this,int param_1)
...
/* CowData<AnimationBezierTrackEdit::EditPoint>::_copy_on_write() [clone .isra.0] [clone .cold] */

void CowData<AnimationBezierTrackEdit::EditPoint>::_copy_on_write(void)
...
/* AnimationBezierTrackEdit::_bind_methods() [clone .cold] */
...
/* AnimationBezierTrackEdit::_notification(int) [clone .cold] */

void AnimationBezierTrackEdit::_notification(int param_1)
...
/* CallableCustomMethodPointer<Range, void, double>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<Range,void,double>::get_object
          (CallableCustomMethodPointer<Range,void,double> *this)
...
undefined8 __thiscall
CallableCustomMethodPointer<AnimationBezierTrackEdit,void,Vector2,Ref<InputEvent>>::get_object
          (CallableCustomMethodPointer<AnimationBezierTrackEdit,void,Vector2,Ref<InputEvent>> *this)
...
/* CallableCustomMethodPointer<AnimationTrackEditor, void, bool>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<AnimationTrackEditor,void,bool>::get_object
          (CallableCustomMethodPointer<AnimationTrackEditor,void,bool> *this)
...
/* CallableCustomMethodPointer<AnimationBezierTrackEdit, void, int>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<AnimationBezierTrackEdit,void,int>::get_object
          (CallableCustomMethodPointer<AnimationBezierTrackEdit,void,int> *this)
...
/* CallableCustomMethodPointer<AnimationTrackEditor, void, int, int>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<AnimationTrackEditor,void,int,int>::get_object
          (CallableCustomMethodPointer<AnimationTrackEditor,void,int,int> *this)
...
/* CallableCustomMethodPointer<AnimationBezierTrackEdit, void>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<AnimationBezierTrackEdit,void>::get_object
          (CallableCustomMethodPointer<AnimationBezierTrackEdit,void> *this)
...
undefined8 __thiscall
CallableCustomMethodPointer<AnimationBezierTrackEdit,void,float,Vector2,Ref<InputEvent>>::get_object
          (CallableCustomMethodPointer<AnimationBezierTrackEdit,void,float,Vector2,Ref<InputEvent>>
           *this)
...
/* CallableCustomMethodPointer<AnimationTrackEditor, void, int, bool, int>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<AnimationTrackEditor,void,int,bool,int>::get_object
          (CallableCustomMethodPointer<AnimationTrackEditor,void,int,bool,int> *this)
...
/* AnimationBezierTrackEdit::_validate_propertyv(PropertyInfo&) const */

void AnimationBezierTrackEdit::_validate_propertyv(PropertyInfo *param_1)
...
/* AnimationBezierTrackEdit::_setv(StringName const&, Variant const&) */

undefined8 AnimationBezierTrackEdit::_setv(StringName *param_1,Variant *param_2)
...
/* WARNING: Removing unreachable block (ram,0x00117b88) */
/* AnimationBezierTrackEdit::_getv(StringName const&, Variant&) const */

undefined8 AnimationBezierTrackEdit::_getv(StringName *param_1,Variant *param_2)

{
  undefined8 uVar1;
  
  if (((code *)PTR__get_00130020 != CanvasItem::_get) &&
...
void __thiscall
RBMap<int,Color,Comparator<int>,DefaultAllocator>::_cleanup_tree
          (RBMap<int,Color,Comparator<int>,DefaultAllocator> *this,Element *param_1)
...
void __thiscall
RBMap<int,Rect2,Comparator<int>,DefaultAllocator>::_cleanup_tree
          (RBMap<int,Rect2,Comparator<int>,DefaultAllocator> *this,Element *param_1)
...
void __thiscall
RBMap<AnimationTrackEditor::SelectedKey,AnimationTrackEditor::KeyInfo,Comparator<AnimationTrackEditor::SelectedKey>,DefaultAllocator>
::_cleanup_tree(RBMap<AnimationTrackEditor::SelectedKey,AnimationTrackEditor::KeyInfo,Comparator<AnimationTrackEditor::SelectedKey>,DefaultAllocator>
...
void __thiscall
RBSet<Pair<int,int>,AnimationBezierTrackEdit::PairCompare,DefaultAllocator>::_cleanup_tree
          (RBSet<Pair<int,int>,AnimationBezierTrackEdit::PairCompare,DefaultAllocator> *this,
          Element *param_1)
...
/* AnimationBezierTrackEdit::_get_class_namev() const */

undefined8 * AnimationBezierTrackEdit::_get_class_namev(void)
...
LAB_00119c43:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"AnimationBezierTrackEdit");
      goto LAB_00119cae;
    }
  }
  StringName::assign_static_unique_class_name
...
/* AnimationBezierTrackEdit::get_class() const */

void AnimationBezierTrackEdit::get_class(void)
...
void __thiscall
RBMap<int,Rect2,Comparator<int>,DefaultAllocator>::clear
          (RBMap<int,Rect2,Comparator<int>,DefaultAllocator> *this)
...
void __thiscall
RBMap<int,RBMap<int,Rect2,Comparator<int>,DefaultAllocator>,Comparator<int>,DefaultAllocator>::
_cleanup_tree(RBMap<int,RBMap<int,Rect2,Comparator<int>,DefaultAllocator>,Comparator<int>,DefaultAllocator>
              *this,Element *param_1)

{
  ...
  if (pEVar1 != pEVar2) {
    ...
    if (pEVar2 != pEVar4) {
      ...
      if (pEVar2 != pEVar6) {
        ...
        if (pEVar2 != pEVar3) {
          ...
          RBMap<int,Rect2,Comparator<int>,DefaultAllocator>::clear
                    ((RBMap<int,Rect2,Comparator<int>,DefaultAllocator> *)(pEVar3 + 0x38));
        ...
        if (pEVar2 != pEVar3) {
          ...
          RBMap<int,Rect2,Comparator<int>,DefaultAllocator>::clear
                    ((RBMap<int,Rect2,Comparator<int>,DefaultAllocator> *)(pEVar2 + 0x38));
        ...
        RBMap<int,Rect2,Comparator<int>,DefaultAllocator>::clear
                  ((RBMap<int,Rect2,Comparator<int>,DefaultAllocator> *)(pEVar6 + 0x38));
      ...
      RBMap<int,Rect2,Comparator<int>,DefaultAllocator>::clear
                ((RBMap<int,Rect2,Comparator<int>,DefaultAllocator> *)(pEVar4 + 0x38));
    ...
    RBMap<int,Rect2,Comparator<int>,DefaultAllocator>::clear
              ((RBMap<int,Rect2,Comparator<int>,DefaultAllocator> *)(pEVar1 + 0x38));
  ...
  RBMap<int,Rect2,Comparator<int>,DefaultAllocator>::clear
            ((RBMap<int,Rect2,Comparator<int>,DefaultAllocator> *)(param_1 + 0x38));
...
void __thiscall
RBMap<int,RBMap<int,Rect2,Comparator<int>,DefaultAllocator>,Comparator<int>,DefaultAllocator>::clear
          (RBMap<int,RBMap<int,Rect2,Comparator<int>,DefaultAllocator>,Comparator<int>,DefaultAllocator>
           *this)

{
  ...
  if (pvVar4 != (void *)0x0) {
    ...
    if (pEVar1 != pEVar2) {
      ...
      if (pEVar2 != pEVar3) {
        ...
        if (pEVar2 != pEVar7) {
          ...
          RBMap<int,Rect2,Comparator<int>,DefaultAllocator>::clear
                    ((RBMap<int,Rect2,Comparator<int>,DefaultAllocator> *)(pEVar7 + 0x38));
      ...
      if (pEVar2 != pEVar3) {
        ...
        if (pEVar3 != pEVar7) {
          ...
          if (pEVar3 != pEVar5) {
            ...
            RBMap<int,Rect2,Comparator<int>,DefaultAllocator>::clear
                      ((RBMap<int,Rect2,Comparator<int>,DefaultAllocator> *)(pEVar5 + 0x38));
    ...
    *(undefined4 *)(this + 0x10) = 0;
    RBMap<int,Rect2,Comparator<int>,DefaultAllocator>::clear
              ((RBMap<int,Rect2,Comparator<int>,DefaultAllocator> *)((long)pvVar4 + 0x38));
...
/* Callable
   ...
   const*, void (AnimationBezierTrackEdit::*)()) */

AnimationBezierTrackEdit *
create_custom_callable_function_pointer<AnimationBezierTrackEdit>
          (AnimationBezierTrackEdit *param_1,char *param_2,_func_void *param_3)
...
LAB_0011c027:
  pvVar6 = *(void **)(this + 0xa78);
  if (pvVar6 != (void *)0x0) {
    if (*(int *)(this + 0xa9c) != 0) {
      if (*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0xa98) * 4) != 0) {
        memset(*(void **)(this + 0xa90),0,
               (ulong)*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0xa98) * 4) << 2);
      }
      *(undefined4 *)(this + 0xa9c) = 0;
    }
    Memory::free_static(pvVar6,false);
  ...
  if (pvVar6 != (void *)0x0) {
    if (*(int *)(this + 0xa74) != 0) {
      if (*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0xa70) * 4) != 0) {
        memset(*(void **)(this + 0xa68),0,
               (ulong)*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0xa70) * 4) << 2);
      }
      *(undefined4 *)(this + 0xa74) = 0;
    }
    Memory::free_static(pvVar6,false);
  ...
  if (pvVar6 != (void *)0x0) {
    RBMap<int,Rect2,Comparator<int>,DefaultAllocator>::clear
              ((RBMap<int,Rect2,Comparator<int>,DefaultAllocator> *)((long)pvVar6 + 0x38));
...
/* void EditorUndoRedoManager::add_do_method<int, float, Variant, Vector2, Vector2>(Object*,
   StringName const&, int, float, Variant, Vector2, Vector2) */

void __thiscall
EditorUndoRedoManager::add_do_method<int,float,Variant,Vector2,Vector2>
          (float param_4,undefined8 param_2_00,undefined8 param_3_00,EditorUndoRedoManager *this,
          StringName *param_1,Variant **param_2,int param_3,Variant *param_8)
...
void __thiscall
List<AnimationBezierTrackEdit::AnimMoveRestore,DefaultAllocator>::~List
          (List<AnimationBezierTrackEdit::AnimMoveRestore,DefaultAllocator> *this)
    ...
    if (*(undefined8 **)((long)pvVar1 + 0x40) == puVar2) {
      *puVar2 = *(undefined8 *)((long)pvVar1 + 0x30);
      ...
      if (*(long *)((long)pvVar1 + 0x38) != 0) {
        *(undefined8 *)(*(long *)((long)pvVar1 + 0x38) + 0x30) =
             *(undefined8 *)((long)pvVar1 + 0x30);
      }
      if (*(long *)((long)pvVar1 + 0x30) != 0) {
        *(undefined8 *)(*(long *)((long)pvVar1 + 0x30) + 0x38) =
...
/* void EditorUndoRedoManager::add_do_method<int, float>(Object*, StringName const&, int, float) */
...
/* void EditorUndoRedoManager::add_undo_method<int, double, Variant, int>(Object*, StringName
   const&, int, double, Variant, int) */

void __thiscall
EditorUndoRedoManager::add_undo_method<int,double,Variant,int>
          (double param_4,EditorUndoRedoManager *this,StringName *param_1,Variant **param_2,
          int param_3,Variant *param_6,int param_7)
...
/* void EditorUndoRedoManager::add_do_method<int, int, Vector2, float>(Object*, StringName const&,
   int, int, Vector2, float) */

void __thiscall
EditorUndoRedoManager::add_do_method<int,int,Vector2,float>
          (undefined8 param_1_00,float param_2_00,EditorUndoRedoManager *this,StringName *param_1,
          Variant **param_2,int param_3,int param_4)
...
void __thiscall
CallableCustomMethodPointer<AnimationBezierTrackEdit,void>::call
          (CallableCustomMethodPointer<AnimationBezierTrackEdit,void> *this,Variant **param_1,
...
void __thiscall
CallableCustomMethodPointer<AnimationTrackEditor,void,int,int>::call
          (CallableCustomMethodPointer<AnimationTrackEditor,void,int,int> *this,Variant **param_1,
          int param_2,Variant *param_3,CallError *param_4)
...
void __thiscall
CallableCustomMethodPointer<AnimationBezierTrackEdit,void,int>::call
          (CallableCustomMethodPointer<AnimationBezierTrackEdit,void,int> *this,Variant **param_1,
          int param_2,Variant *param_3,CallError *param_4)
...
void __thiscall
CallableCustomMethodPointer<Range,void,double>::call
          (CallableCustomMethodPointer<Range,void,double> *this,Variant **param_1,int param_2,
...
void __thiscall
CallableCustomMethodPointer<AnimationTrackEditor,void,bool>::call
          (CallableCustomMethodPointer<AnimationTrackEditor,void,bool> *this,Variant **param_1,
          int param_2,Variant *param_3,CallError *param_4)
...
void __thiscall
CallableCustomMethodPointer<AnimationTrackEditor,void,int,bool,int>::call
          (CallableCustomMethodPointer<AnimationTrackEditor,void,int,bool,int> *this,
...
void __thiscall
CallableCustomMethodPointer<AnimationBezierTrackEdit,void,float,Vector2,Ref<InputEvent>>::call
          (CallableCustomMethodPointer<AnimationBezierTrackEdit,void,float,Vector2,Ref<InputEvent>>
...
LAB_0011e5e0:
        ...
        if (((local_58 != (Object *)0x0) &&
            (cVar7 = RefCounted::unreference(), pOVar6 = local_58, cVar7 != '\0')) &&
           (cVar7 = predelete_handler(local_58), cVar7 != '\0')) {
          (**(code **)(*(long *)pOVar6 + 0x140))(pOVar6);
          Memory::free_static(pOVar6,false);
        }
        goto LAB_0011e4e5;
...
void __thiscall
CallableCustomMethodPointer<AnimationBezierTrackEdit,void,Vector2,Ref<InputEvent>>::call
          (CallableCustomMethodPointer<AnimationBezierTrackEdit,void,Vector2,Ref<InputEvent>> *this,
          Variant **param_1,int param_2,Variant *param_3,CallError *param_4)
...
/* AnimationBezierTrackEdit::is_class(String const&) const */

undefined8 __thiscall
AnimationBezierTrackEdit::is_class(AnimationBezierTrackEdit *this,String *param_1)
...
void __thiscall
AnimationBezierTrackEdit::_get_property_listv
          (AnimationBezierTrackEdit *this,List *param_1,bool param_2)
...
/* RBMap<int, Color, Comparator<int>, DefaultAllocator>::clear() */

void __thiscall
RBMap<int,Color,Comparator<int>,DefaultAllocator>::clear
          (RBMap<int,Color,Comparator<int>,DefaultAllocator> *this)
...
/* RBMap<int, Rect2, Comparator<int>, DefaultAllocator>::_Data::_free_root() */

void __thiscall RBMap<int,Rect2,Comparator<int>,DefaultAllocator>::_Data::_free_root(_Data *this)
...
/* RBMap<AnimationTrackEditor::SelectedKey, AnimationTrackEditor::KeyInfo,
   Comparator<AnimationTrackEditor::SelectedKey>, DefaultAllocator>::clear() */

void __thiscall
RBMap<AnimationTrackEditor::SelectedKey,AnimationTrackEditor::KeyInfo,Comparator<AnimationTrackEditor::SelectedKey>,DefaultAllocator>
::clear(RBMap<AnimationTrackEditor::SelectedKey,AnimationTrackEditor::KeyInfo,Comparator<AnimationTrackEditor::SelectedKey>,DefaultAllocator>
        *this)
...
/* MethodBind* create_method_bind<AnimationBezierTrackEdit>(void (AnimationBezierTrackEdit::*)()) */

MethodBind * create_method_bind<AnimationBezierTrackEdit>(_func_void *param_1)
...
/* MethodBind* create_method_bind<AnimationBezierTrackEdit, Ref<Animation> const&>(void
   (AnimationBezierTrackEdit::*)(Ref<Animation> const&)) */

MethodBind *
create_method_bind<AnimationBezierTrackEdit,Ref<Animation>const&>(_func_void_Ref_ptr *param_1)
...
/* MethodBind* create_method_bind<AnimationBezierTrackEdit, Ref<Animation> const&, int, float,
   bool>(void (AnimationBezierTrackEdit::*)(Ref<Animation> const&, int, float, bool)) */

MethodBind *
create_method_bind<AnimationBezierTrackEdit,Ref<Animation>const&,int,float,bool>
          (_func_void_Ref_ptr_int_float_bool *param_1)
...
/* MethodBind* create_method_bind<AnimationBezierTrackEdit, int>(void
   (AnimationBezierTrackEdit::*)(int)) */

MethodBind * create_method_bind<AnimationBezierTrackEdit,int>(_func_void_int *param_1)
...
/* MethodBind* create_method_bind<AnimationBezierTrackEdit, Ref<Animation> const&, int, double,
   ...
   const&, Animation::HandleMode)) */

MethodBind *
create_method_bind<AnimationBezierTrackEdit,Ref<Animation>const&,int,double,float,Vector2_const&,Vector2_const&,Animation::HandleMode>
          (_func_void_Ref_ptr_int_double_float_Vector2_ptr_Vector2_ptr_HandleMode *param_1)

{
  ...
  this = (MethodBind *)operator_new(0x68,"");
  MethodBind::MethodBind(this);
  *(_func_void_Ref_ptr_int_double_float_Vector2_ptr_Vector2_ptr_HandleMode **)(this + 0x58) =
       param_1;
  *(undefined ***)this = &PTR__gen_argument_type_0012a0d8;
  *(undefined8 *)(this + 0x60) = in_RSI;
  MethodBind::_generate_argument_types((int)this);
...
/* RBMap<String, Vector<int>, Comparator<String>, DefaultAllocator>::_cleanup_tree(RBMap<String,
   Vector<int>, Comparator<String>, DefaultAllocator>::Element*) [clone .part.0] */

void __thiscall
RBMap<String,Vector<int>,Comparator<String>,DefaultAllocator>::_cleanup_tree
          (RBMap<String,Vector<int>,Comparator<String>,DefaultAllocator> *this,Element *param_1)
...
void __thiscall
RBMap<String,Vector<int>,Comparator<String>,DefaultAllocator>::~RBMap
          (RBMap<String,Vector<int>,Comparator<String>,DefaultAllocator> *this)
...
/* AnimationBezierTrackEdit::_initialize_classv() */

void AnimationBezierTrackEdit::_initialize_classv(void)
...
void __thiscall
RBSet<Pair<int,int>,AnimationBezierTrackEdit::PairCompare,DefaultAllocator>::_erase_fix_rb
          (RBSet<Pair<int,int>,AnimationBezierTrackEdit::PairCompare,DefaultAllocator> *this,
          Element *param_1)
...
/* RBMap<String, Vector<int>, Comparator<String>, DefaultAllocator>::_insert_rb_fix(RBMap<String,
   Vector<int>, Comparator<String>, DefaultAllocator>::Element*) */

void __thiscall
RBMap<String,Vector<int>,Comparator<String>,DefaultAllocator>::_insert_rb_fix
          (RBMap<String,Vector<int>,Comparator<String>,DefaultAllocator> *this,Element *param_1)
...
LAB_001230cf:
  pEVar3 = (Element *)operator_new(0x48,DefaultAllocator::alloc);
  local_58[0] = 0;
  plVar1 = (long *)(*(long *)param_1 + -0x10);
  if (*(long *)param_1 != 0) {
    do {
...
LAB_00123159:
  ...
  *(undefined1 (*) [16])(pEVar3 + 0x28) = (undefined1  [16])0x0;
  if (local_58[0] != 0) {
...
/* RBMap<String, Vector<int>, Comparator<String>, DefaultAllocator>::operator[](String const&) */

long __thiscall
RBMap<String,Vector<int>,Comparator<String>,DefaultAllocator>::operator[]
          (RBMap<String,Vector<int>,Comparator<String>,DefaultAllocator> *this,String *param_1)
...
void __thiscall
RBMap<int,Color,Comparator<int>,DefaultAllocator>::_insert_rb_fix
          (RBMap<int,Color,Comparator<int>,DefaultAllocator> *this,Element *param_1)
...
/* RBMap<int, Color, Comparator<int>, DefaultAllocator>::_insert(int const&, Color const&) */
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* RBMap<int, Color, Comparator<int>, DefaultAllocator>::operator[](int const&) */

long __thiscall
RBMap<int,Color,Comparator<int>,DefaultAllocator>::operator[]
          (RBMap<int,Color,Comparator<int>,DefaultAllocator> *this,int *param_1)
...
void __thiscall
RBMap<int,Rect2,Comparator<int>,DefaultAllocator>::_insert_rb_fix
          (RBMap<int,Rect2,Comparator<int>,DefaultAllocator> *this,Element *param_1)
...
/* RBMap<int, Rect2, Comparator<int>, DefaultAllocator>::_insert(int const&, Rect2 const&) */
...
/* RBMap<int, Rect2, Comparator<int>, DefaultAllocator>::_copy_from(RBMap<int, Rect2,
   Comparator<int>, DefaultAllocator> const&) */

void __thiscall
RBMap<int,Rect2,Comparator<int>,DefaultAllocator>::_copy_from
          (RBMap<int,Rect2,Comparator<int>,DefaultAllocator> *this,RBMap *param_1)
...
/* RBMap<int, RBMap<int, Rect2, Comparator<int>, DefaultAllocator>, Comparator<int>,
   ...
   DefaultAllocator>, Comparator<int>, DefaultAllocator>::Element*) */

void __thiscall
RBMap<int,RBMap<int,Rect2,Comparator<int>,DefaultAllocator>,Comparator<int>,DefaultAllocator>::
_insert_rb_fix(RBMap<int,RBMap<int,Rect2,Comparator<int>,DefaultAllocator>,Comparator<int>,DefaultAllocator>
               *this,Element *param_1)
...

{
  ...
  if (*(Element **)(pEVar8 + 0x10) != *(Element **)(this + 8)) {
    ...
    do {
      ...
      if (*param_1 < *(int *)(pEVar8 + 0x30)) {
        ...
        if (*param_1 <= *(int *)(pEVar8 + 0x30)) {
          RBMap<int,Rect2,Comparator<int>,DefaultAllocator>::_copy_from
                    ((RBMap<int,Rect2,Comparator<int>,DefaultAllocator> *)(pEVar8 + 0x38),param_2);
          goto LAB_001248b7;
        }
  ...
  RBMap<int,Rect2,Comparator<int>,DefaultAllocator>::_copy_from
            ((RBMap<int,Rect2,Comparator<int>,DefaultAllocator> *)&local_60,param_2);
  ...
  *(undefined1 (*) [16])(pEVar2 + 0x18) = (undefined1  [16])0x0;
  RBMap<int,Rect2,Comparator<int>,DefaultAllocator>::_copy_from
            ((RBMap<int,Rect2,Comparator<int>,DefaultAllocator> *)(pEVar2 + 0x38),(RBMap *)&local_60
            );
  RBMap<int,Rect2,Comparator<int>,DefaultAllocator>::clear
            ((RBMap<int,Rect2,Comparator<int>,DefaultAllocator> *)&local_60);
...
/* CowData<AnimationBezierTrackEdit::EditPoint>::_realloc(long) */

undefined8 __thiscall
CowData<AnimationBezierTrackEdit::EditPoint>::_realloc
          (CowData<AnimationBezierTrackEdit::EditPoint> *this,long param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Error CowData<AnimationBezierTrackEdit::EditPoint>::resize<false>(long) */
...
/* WARNING: Removing unreachable block (ram,0x00124ed8) */
...
/* MethodBindT<Ref<Animation> const&>::validated_call(Object*, Variant const**, Variant*) const */

void MethodBindT<Ref<Animation>const&>::validated_call
...
void MethodBindT<Ref<Animation>const&,int,float,bool>::validated_call
               (Object *param_1,Variant **param_2,Variant *param_3)
...
/* MethodBindT<Ref<Animation> const&, int, double, float, Vector2 const&, Vector2 const&,
   Animation::HandleMode>::validated_call(Object*, Variant const**, Variant*) const */

void MethodBindT<Ref<Animation>const&,int,double,float,Vector2_const&,Vector2_const&,Animation::HandleMode>
...
LAB_00126372:
  ...
  (*pcVar11)(uVar1,(long *)((long)param_2 + lVar3),(StringName *)&local_68,uVar2,lVar6 + 8,lVar5 + 8
             ,uVar4 & 0xffffffff);
  if (local_68 != (Object *)0x0) {
    cVar8 = RefCounted::unreference();
    pOVar7 = local_68;
...
/* MethodBindT<Ref<Animation> const&>::ptrcall(Object*, void const**, void*) const */

void MethodBindT<Ref<Animation>const&>::ptrcall(Object *param_1,void **param_2,void *param_3)
...
void MethodBindT<Ref<Animation>const&,int,float,bool>::ptrcall
...
/* MethodBindT<Ref<Animation> const&, int, double, float, Vector2 const&, Vector2 const&,
   Animation::HandleMode>::ptrcall(Object*, void const**, void*) const */
...
Object * MethodBindT<Ref<Animation>const&>::call
...
/* MethodBindT<Ref<Animation> const&, int, double, float, Vector2 const&, Vector2 const&,
   Animation::HandleMode>::call(Object*, Variant const**, int, Callable::CallError&) const */

Object * MethodBindT<Ref<Animation>const&,int,double,float,Vector2_const&,Vector2_const&,Animation::HandleMode>
...
LAB_00127406:
      ...
      (*(code *)pVVar16)(dVar18,fVar17,(Variant *)((long)plVar14 + (long)pVVar1),&local_98,iVar7,
                         &local_80,&local_88,uVar10 & 0xffffffff);
      if (local_98 != (Object *)0x0) {
        cVar6 = RefCounted::unreference();
        pOVar5 = local_98;
        if (cVar6 != '\0') {
...
Object * MethodBindT<Ref<Animation>const&,int,float,bool>::call
                   (Object *param_1,Variant **param_2,int param_3,CallError *param_4)
...
/* void call_get_argument_type_info_helper<Ref<Animation> const&>(int, int&, PropertyInfo&) */

void call_get_argument_type_info_helper<Ref<Animation>const&>
...
/* MethodBindT<Ref<Animation> const&>::_gen_argument_type_info(int) const */

PropertyInfo * MethodBindT<Ref<Animation>const&>::_gen_argument_type_info(int param_1)
...
/* void call_get_argument_type_info<Ref<Animation> const&, int, float, bool>(int, PropertyInfo&) */

void call_get_argument_type_info<Ref<Animation>const&,int,float,bool>
...
/* MethodBindT<Ref<Animation> const&, int, float, bool>::_gen_argument_type_info(int) const */

PropertyInfo *
MethodBindT<Ref<Animation>const&,int,float,bool>::_gen_argument_type_info(int param_1)
...
/* void call_get_argument_type_info<Ref<Animation> const&, int, double, float, Vector2 const&,
   Vector2 const&, Animation::HandleMode>(int, PropertyInfo&) */

void call_get_argument_type_info<Ref<Animation>const&,int,double,float,Vector2_const&,Vector2_const&,Animation::HandleMode>
               (int param_1,PropertyInfo *param_2)
...
/* MethodBindT<Ref<Animation> const&, int, double, float, Vector2 const&, Vector2 const&,
   Animation::HandleMode>::_gen_argument_type_info(int) const */
...

{
  ...
  *(undefined4 *)(pPVar1 + 0x28) = 6;
  *(undefined1 (*) [16])(pPVar1 + 8) = (undefined1  [16])0x0;
  call_get_argument_type_info<Ref<Animation>const&,int,double,float,Vector2_const&,Vector2_const&,Animation::HandleMode>
            (in_EDX,pPVar1);
  return pPVar1;
}
...
void AnimationBezierTrackEdit::_GLOBAL__sub_I__bezier_h_to_pixel(void)
...
/* WARNING: Removing unreachable block (ram,0x001291e0) */
/* AnimationBezierTrackEdit::_notificationv(int, bool) */

void __thiscall
AnimationBezierTrackEdit::_notificationv(AnimationBezierTrackEdit *this,int param_1,bool param_2)

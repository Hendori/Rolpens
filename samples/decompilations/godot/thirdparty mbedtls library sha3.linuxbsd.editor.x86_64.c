...

{
  ...
  do {
    ...
    do {
      uVar15 = uVar12 + 4;
      uVar12 = uVar12 + 1;
      uVar14 = (local_68[(int)(uVar12 % 5)] << 1 | (ulong)((long)local_68[(int)(uVar12 % 5)] < 0)) ^
               local_68[(int)(uVar15 % 5)];
      *puVar10 = *puVar10 ^ uVar14;
      puVar10[5] = puVar10[5] ^ uVar14;
      puVar10[10] = puVar10[10] ^ uVar14;
      puVar10[0xf] = puVar10[0xf] ^ uVar14;
      puVar10[0x14] = puVar10[0x14] ^ uVar14;
      puVar10 = puVar10 + 1;
    } while (uVar12 != 5);
    uVar13 = 0x3f022425;
    puVar10 = param_1 + 1;
    ...
    *param_1 = ~uVar5 & uVar1 ^ *param_1 ^
               (((ulong)bVar9 & 0x40) << 0x39 | (ulong)((bVar9 & 0x20) << 0x1a) |
                (ulong)(bVar9 & 0x8f) | (ulong)((bVar9 & 0x10) << 0xb));
    puVar10 = param_1;
    puVar17 = local_68;
    local_a0 = pNVar18;
...

{
  ...
  *param_1 = 0;
  ...
  for (uVar1 = (ulong)(((int)param_1 -
                       (int)(undefined8 *)((ulong)(param_1 + 1) & 0xfffffffffffffff8)) + 0xd0U >> 3)
    ...
    *(undefined4 *)(param_1 + 200) = 0;
    ...
    if (param_3 != 0) {
      do {
        while( true ) {
          puVar7 = puVar6 + 1;
          *puVar6 = (char)(*(ulong *)(param_1 + (ulong)(uVar4 >> 3) * 8) >>
                          ((char)uVar4 * '\b' & 0x38U));
...
LAB_00100988:
  mbedtls_platform_zeroize(auStack_538,0xd0);
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    __stack_chk_fail();
  }
...
int mbedtls_sha3(undefined4 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
                undefined8 param_5)
...

{
  ...
  lVar2 = (long)param_4;
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  iVar1 = mbedtls_sha3(param_3,(long)&test_data + lVar2 * 4,
                       *(undefined8 *)(test_data_len + lVar2 * 8),local_88,0x40);
  if (iVar1 == 0) {
    if (param_3 == 3) {
...

{
  ...
  while( true ) {
    ...
    if (iVar2 != 0) {
      ...
      if ((((iVar2 == 0) && (iVar2 = mbedtls_sha3_long_kat_test(param_1,"SHA3-256",2), iVar2 == 0))
          && (iVar2 = mbedtls_sha3_long_kat_test(param_1,"SHA3-384",3), iVar2 == 0)) &&
         (iVar2 = mbedtls_sha3_long_kat_test(param_1,"SHA3-512",4), iVar2 == 0)) {
        if (param_1 != 0) {
          putchar(10);
          return 0;
        }

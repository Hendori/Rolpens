...
ktxTexture2_transcodeLzEtc1s
          (long param_1,int param_2,long param_3,undefined4 param_4,undefined4 param_5)

{
  ...
  if (((*(int *)(puVar6 + 2) == 0) || (*(int *)(puVar6 + 4) == 0)) || (*(int *)(puVar6 + 6) == 0)) {
    ...
    *puVar13 = 0;
    ...
    if ((ulong)*(uint *)(puVar6 + 2) + (ulong)*(uint *)(puVar6 + 4) + (ulong)*(uint *)(puVar6 + 6) +
        lVar22 <= (ulong)puVar5[2]) {
      ...
      if (*(char *)(param_1 + 0x8c) == '\0') {
        uVar25 = 1;
LAB_001006d4:
        std::vector<basist::basisu_transcoder_state,std::allocator<basist::basisu_transcoder_state>>
        ::_M_default_append((vector<basist::basisu_transcoder_state,std::allocator<basist::basisu_transcoder_state>>
                             *)local_378,uVar25);
      ...
      basist::basisu_lowlevel_etc1s_transcoder::decode_palettes
                ((uint)local_358,(uchar *)(ulong)*puVar6,iVar26 + iVar21,*(uint *)(puVar6 + 2),
                 (uchar *)(ulong)puVar6[1],iVar26 + *(uint *)(puVar6 + 2) + iVar21);
      basist::basisu_lowlevel_etc1s_transcoder::decode_tables
                ((uchar *)local_358,*(int *)(puVar6 + 2) + *(int *)(puVar6 + 4) + iVar21 + iVar26);
        ...
        do {
          ...
          if (uVar11 < iVar21 + uVar11) {
            ...
            do {
              ...
              else if ((*(int *)(puVar19 + 6) == 0) || (iVar4 = *(int *)(puVar19 + 8), iVar4 == 0))
              {
                uVar29 = 1;
                goto LAB_00100501;
              }
              ...
              cVar10 = basist::basisu_lowlevel_etc1s_transcoder::transcode_image
                                 (local_358,param_4,lVar22 + local_420 + lVar27,
                                  local_3d0 - local_400,*(undefined8 *)(param_1 + 0x70),
                                  *(undefined4 *)(param_1 + 0x68),uVar12 + 3 >> 2,uVar3 + 3 >> 2,
                                  uVar12,uVar3,local_3b8 & 0xffffffff,*(int *)(puVar19 + 2) + iVar26
                                  ,*(undefined4 *)(puVar19 + 4),*(int *)(puVar19 + 6) + iVar26,iVar4
                                  ,param_5,param_2 != 0,uVar2,0,
                                  (void *)(uVar15 * 0x220 + (long)local_428),0);
              if (cVar10 == '\0') {
                uVar29 = 0xe;
                goto LAB_0010072e;
              }
          ...
          *(long *)(local_388 + 0x30) = lVar27;
          ...
          if ((float)((uint)fVar30 & _LC6) < _LC2) {
            fVar30 = (float)((uint)((float)(int)fVar30 +
                                   (float)(-(uint)((float)(int)fVar30 < fVar30) & _LC4)) |
                            ~_LC6 & (uint)fVar30);
          }
...
LAB_00100501:
      pvVar23 = (void *)((long)local_428 + 0x20);
      pvVar1 = local_428;
    ...
    do {
      ...
      if (iVar13 == 0) {
        ...
        do {
          ...
          cVar6 = basist::basisu_lowlevel_uastc_transcoder::transcode_image
                            (&local_59,param_4,local_b0 + lVar2 + lVar22,
                             local_80 - (int)(local_b0 / uVar12),*(undefined8 *)(param_1 + 0x70),
                             *(undefined4 *)(param_1 + 0x68),uVar4 + 3 >> 2,uVar5 + 3 >> 2,uVar4,
                             uVar5,iVar17,lVar10,uVar8 & 0xffffffff,param_5,param_2 != 0,
                             *(undefined1 *)(param_1 + 0x8c),0,local_108 + uVar14 * 0x44,0,
...
LAB_00100d1c:
    if ((param_3 & 2) == 0) {
      if ((param_2 - 8 < 2) &&
         ((((uVar2 = *(uint *)(param_1 + 0x24), uVar2 == 0 || ((uVar2 - 1 & uVar2) != 0)) ||
           (uVar2 = *(uint *)(param_1 + 0x28), uVar2 == 0)) || ((uVar2 - 1 & uVar2) != 0)))) {
        basisu::debug_printf
...
LAB_00100fc1:
            ...
            cVar13 = '\0';
LAB_00100fcb:
            iVar17 = (uint)(uVar10 == 0x20000) * 4 + 0x3b9b9cf1;
            goto LAB_00100da2;
          }
          if (param_2 != 0x13) {
            cVar13 = (bVar12 == 5) * '\x02';
...
LAB_00100f62:
        ...
        param_2 = 0x13;
LAB_00100d8e:
        iVar17 = (uint)(uVar10 == 0x20000) * 4 + 0x3b9b9cf3;
      }
LAB_00100da2:
      cVar9 = basist::basis_is_format_supported(uVar14,uVar16 == 0xa6);
      if (cVar9 != '\0') {
    ...
    if (*(int *)(param_1 + 0x88) == 1) {
      plVar15 = *(long **)(param_1 + 0xa0);
LAB_00100cf2:
      if ((*plVar15 != 0) && (plVar15[2] != 0)) goto LAB_00100d1c;
    }
LAB_00100ebe:
    iVar11 = 10;
  }
...

{
  ...
  if ((ulong)((*(long *)(this + 0x10) - (long)pvVar4 >> 5) * -0xf0f0f0f0f0f0f0f) < param_1) {
    ...
    if ((param_1 <= (ulong)(lVar8 * -0xf0f0f0f0f0f0f0f)) &&
       (uVar6 = lVar8 * -0x1e1e1e1e1e1e1e1e, 0x3c3c3c3c3c3c3c < uVar6)) {
      uVar6 = 0x3c3c3c3c3c3c3c;
    }
        ...
        do {
          *puVar14 = 0;
          ...
          basisu::elemental_vector::increase_capacity
                    ((uint)puVar14,SUB41(*puVar19,0),0,(_func_void_void_ptr_void_ptr_uint *)0x4,
                     false);
          uVar3 = *puVar19;
        ...
        do {
          ...
          do {
            *puVar16 = 0;
            puVar16[1] = 0;
            basisu::elemental_vector::increase_capacity
                      ((uint)puVar16,SUB41(*puVar21,0),0,(_func_void_void_ptr_void_ptr_uint *)0x4,
                       false);
            uVar3 = *puVar21;

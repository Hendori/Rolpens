...

{
  ...
  if (*(int *)(this + 0x10) + -1 == param_2) {
    ...
    local_54 = CONCAT44((float)((ulong)*(undefined8 *)param_3 >> 0x20) +
                        (float)((ulong)*(undefined8 *)(param_3 + 0xc) >> 0x20) * _UNK_0010ef2c,
...
LAB_0010a18a:
  lVar2 = *(long *)(this + 8);
  iVar7 = iVar20 * uVar8;
  if ((lVar2 != 0) && (iVar14 = (int)*(undefined8 *)(lVar2 + -8), iVar14 != 0)) {
...
LAB_0010a221:
    ...
    do {
      iVar19 = (int)uVar16;
      if ((param_2 != (_func_bool_int_int *)0x0) && (bVar4 = (*param_2)(local_58,iVar14), bVar4))
      goto LAB_0010a440;
      iVar17 = 0;
      if (0 < iVar1) {
        do {
...

{
  ...
  return (uint)CONCAT71(0x10ed,in_RSI == &BaseMaterial3D::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x10ed,in_RSI == &get_class_ptr_static()::ptr) |

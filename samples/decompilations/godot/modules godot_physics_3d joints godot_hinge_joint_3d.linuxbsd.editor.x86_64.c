...
/* GodotHingeJoint3D::solve(float) */

void __thiscall GodotHingeJoint3D::solve(GodotHingeJoint3D *this,float param_1)

{
  ...
  if (this[0x259] == (GodotHingeJoint3D)0x0) {
    ...
    fVar30 = fVar38 * fVar19 + *(float *)(this + 0x1f0) * fVar41 + fVar13 * fVar16 +
             *(float *)(lVar3 + 0x74);
    fVar13 = *(float *)(this + 0x21c);
    fVar23 = fVar10 * *(float *)(this + 0x1f0) + fVar22 * fVar16 + fVar32 * fVar19 +
             *(float *)(lVar3 + 0x70);
    fVar27 = local_4c * *(float *)(this + 0x1f0) + fVar16 * fVar25 + fVar19 * local_48 +
             *(float *)(lVar3 + 0x6c);
    ...
    do {
      ...
      fVar11 = (((float)((uint)((fVar23 - fVar26) * fVar18 + (fVar27 - fVar33) * fVar12 +
                               (fVar30 - fVar24) * fVar28) ^ uVar6) * fVar16) / param_1) *
               (fVar20 / *(float *)(pGVar7 + 0x3c)) -
               ((((fVar19 * fVar39 - fVar25 * fVar34) + fVar32) -
                ((fVar17 * fVar14 - fVar13 * fVar36) + fVar41)) * fVar18 +
                (((fVar34 * fVar8 - fVar35 * fVar39) + fVar15) -
                ((fVar36 * fVar10 - fVar21 * fVar14) + fVar38)) * fVar12 +
               (((fVar35 * fVar25 - fVar19 * fVar8) + fVar29) -
               ((fVar21 * fVar13 - fVar9 * fVar17) + fVar22)) * fVar28) *
               (fVar20 / *(float *)(pGVar7 + 0x3c));
      ...
      *(float *)(this + 0x25c) = *(float *)(this + 0x25c) + fVar11;
      if (GVar1 != (GodotHingeJoint3D)0x0) {
        ...
        *(ulong *)(lVar3 + 0xd8) =
             CONCAT44(fVar18 * fVar11 + *(float *)(lVar3 + 0xdc),
                      fVar12 * fVar11 + *(float *)(lVar3 + 0xd8));
        *(ulong *)(lVar3 + 0xe0) =
             CONCAT44(fVar31 * *(float *)(lVar3 + 0x1b0) + fVar40 * *(float *)(lVar3 + 0x1b4) +
                      fVar42 * *(float *)(lVar3 + 0x1b8) + *(float *)(lVar3 + 0xe4),
                      fVar11 * fVar28 + *(float *)(lVar3 + 0xe0));
        *(ulong *)(lVar3 + 0xe8) =
             CONCAT44((float)((ulong)*(undefined8 *)(lVar3 + 0xe8) >> 0x20) +
                      (float)((ulong)*(undefined8 *)(lVar3 + 0x1c4) >> 0x20) * fVar31 +
                      fVar40 * *(float *)(lVar3 + 0x1cc) +
                      (float)((ulong)*(undefined8 *)(lVar3 + 0x1cc) >> 0x20) * fVar42,
                      (float)*(undefined8 *)(lVar3 + 0xe8) +
                      (float)*(undefined8 *)(lVar3 + 0x1bc) * fVar31 +
                      fVar40 * *(float *)(lVar3 + 0x1c0) +
                      (float)*(undefined8 *)(lVar3 + 0x1c4) * fVar42);
      }
      if (GVar2 != (GodotHingeJoint3D)0x0) {
        ...
        *(ulong *)(lVar5 + 0xd8) =
             CONCAT44(fVar18 * fVar11 + *(float *)(lVar5 + 0xdc),
                      fVar12 * fVar11 + *(float *)(lVar5 + 0xd8));
        *(ulong *)(lVar5 + 0xe0) =
             CONCAT44(*(float *)(lVar5 + 0x1b4) * fVar40 + fVar37 * *(float *)(lVar5 + 0x1b0) +
                      *(float *)(lVar5 + 0x1b8) * fVar31 + *(float *)(lVar5 + 0xe4),
                      fVar11 * fVar28 + *(float *)(lVar5 + 0xe0));
        *(ulong *)(lVar5 + 0xe8) =
             CONCAT44((float)((ulong)*(undefined8 *)(lVar5 + 0xe8) >> 0x20) +
                      (float)((ulong)*(undefined8 *)(lVar5 + 0x1cc) >> 0x20) * fVar31 +
                      fVar37 * (float)((ulong)*(undefined8 *)(lVar5 + 0x1c4) >> 0x20) +
                      fVar40 * *(float *)(lVar5 + 0x1cc),
                      (float)*(undefined8 *)(lVar5 + 0xe8) +
                      (float)*(undefined8 *)(lVar5 + 0x1c4) * fVar31 +
                      fVar37 * (float)*(undefined8 *)(lVar5 + 0x1bc) +
                      fVar40 * *(float *)(lVar5 + 0x1c0));
      }
      pGVar7 = pGVar7 + 0x40;
  ...
  if (_LC3 < fVar29) {
    ...
    fVar15 = *(float *)(this + 0x238) *
             (fVar20 / ((*(float *)(lVar5 + 0x1bc) * fVar16 + *(float *)(lVar5 + 0x1b0) * fVar15 +
                        *(float *)(lVar5 + 0x1c8) * fVar29) * fVar15 +
                        (*(float *)(lVar5 + 0x1c0) * fVar16 + *(float *)(lVar5 + 0x1b4) * fVar15 +
                        *(float *)(lVar5 + 0x1cc) * fVar29) * fVar16 +
                        (*(float *)(lVar5 + 0x1c4) * fVar16 + *(float *)(lVar5 + 0x1b8) * fVar15 +
                        *(float *)(lVar5 + 0x1d0) * fVar29) * fVar29 +
                       (*(float *)(lVar3 + 0x1c0) * fVar16 + *(float *)(lVar3 + 0x1b4) * fVar15 +
                       *(float *)(lVar3 + 0x1cc) * fVar29) * fVar16 +
                       (*(float *)(lVar3 + 0x1bc) * fVar16 + *(float *)(lVar3 + 0x1b0) * fVar15 +
                       *(float *)(lVar3 + 0x1c8) * fVar29) * fVar15 +
                       (fVar16 * *(float *)(lVar3 + 0x1c4) + fVar15 * *(float *)(lVar3 + 0x1b8) +
                       *(float *)(lVar3 + 0x1d0) * fVar29) * fVar29));
  ...
  if (_LC3 < fVar26) {
    ...
    fVar20 = fVar20 / ((*(float *)(lVar3 + 0x1c0) * fVar29 + *(float *)(lVar3 + 0x1b4) * fVar36 +
                       *(float *)(lVar3 + 0x1cc) * fVar26) * fVar29 +
                       (*(float *)(lVar3 + 0x1bc) * fVar29 + *(float *)(lVar3 + 0x1b0) * fVar36 +
                       *(float *)(lVar3 + 0x1c8) * fVar26) * fVar36 +
                       (fVar29 * *(float *)(lVar3 + 0x1c4) + fVar36 * *(float *)(lVar3 + 0x1b8) +
                       *(float *)(lVar3 + 0x1d0) * fVar26) * fVar26 +
                      (*(float *)(lVar5 + 0x1bc) * fVar29 + *(float *)(lVar5 + 0x1b0) * fVar36 +
                      *(float *)(lVar5 + 0x1c8) * fVar26) * fVar36 +
                      (*(float *)(lVar5 + 0x1c0) * fVar29 + *(float *)(lVar5 + 0x1b4) * fVar36 +
                      *(float *)(lVar5 + 0x1cc) * fVar26) * fVar29 +
                      (*(float *)(lVar5 + 0x1c4) * fVar29 + *(float *)(lVar5 + 0x1b8) * fVar36 +
                      *(float *)(lVar5 + 0x1d0) * fVar26) * fVar26);
  ...
  if (GVar1 != (GodotHingeJoint3D)0x0) {
    ...
    *(float *)(lVar3 + 0xec) =
         *(float *)(lVar3 + 0x1d0) * fVar26 +
         *(float *)(lVar3 + 0x1cc) * fVar29 + *(float *)(lVar3 + 0x1c8) * fVar20 +
         *(float *)(lVar3 + 0xec);
    *(ulong *)(lVar3 + 0xe4) =
         CONCAT44((float)((ulong)*(undefined8 *)(lVar3 + 0x1bc) >> 0x20) * fVar29 +
                  *(float *)(lVar3 + 0x1bc) * fVar20 + fVar26 * *(float *)(lVar3 + 0x1c4) +
                  (float)((ulong)*(undefined8 *)(lVar3 + 0xe4) >> 0x20),
                  (float)*(undefined8 *)(lVar3 + 0x1b4) * fVar29 +
                  *(float *)(lVar3 + 0x1b0) * fVar20 + fVar26 * *(float *)(lVar3 + 0x1b8) +
  ...
  if (GVar2 != (GodotHingeJoint3D)0x0) {
    ...
    fVar39 = fVar39 - fVar15;
    *(float *)(lVar5 + 0xec) =
         *(float *)(lVar5 + 0x1d0) * fVar41 +
         *(float *)(lVar5 + 0x1cc) * fVar32 + *(float *)(lVar5 + 0x1c8) * fVar39 +
         *(float *)(lVar5 + 0xec);
    *(ulong *)(lVar5 + 0xe4) =
         CONCAT44((float)((ulong)*(undefined8 *)(lVar5 + 0x1bc) >> 0x20) * fVar32 +
                  fVar39 * *(float *)(lVar5 + 0x1bc) + fVar41 * *(float *)(lVar5 + 0x1c4) +
                  (float)((ulong)*(undefined8 *)(lVar5 + 0xe4) >> 0x20),
                  (float)*(undefined8 *)(lVar5 + 0x1b4) * fVar32 +
                  fVar39 * *(float *)(lVar5 + 0x1b0) + fVar41 * *(float *)(lVar5 + 0x1b8) +
                  (float)*(undefined8 *)(lVar5 + 0xe4));
  }
  if (this[0x25b] != (GodotHingeJoint3D)0x0) {
    fVar15 = *(float *)(this + 0x248);
    fVar39 = *(float *)(this + 0x250);
    fVar29 = (((fStack_24 - fStack_18) * fVar22 + (local_28 - local_1c) * fVar10 +
              (fVar21 - fVar17) * fVar38) * *(float *)(this + 0x238) +
             fVar19 * *(float *)(this + 0x24c) * *(float *)(this + 0x234)) * fVar15 *
             *(float *)(this + 0x244) + fVar39;
    if (fVar29 <= 0.0) {
      fVar29 = 0.0;
    }
    *(float *)(this + 0x250) = fVar29;
    ...
    if (GVar1 != (GodotHingeJoint3D)0x0) {
      *(float *)(lVar3 + 0xec) =
           *(float *)(lVar3 + 0x1c8) * fVar15 + *(float *)(lVar3 + 0x1cc) * fVar39 +
           *(float *)(lVar3 + 0x1d0) * fVar32 + *(float *)(lVar3 + 0xec);
      *(ulong *)(lVar3 + 0xe4) =
           CONCAT44((float)((ulong)*(undefined8 *)(lVar3 + 0x1bc) >> 0x20) * fVar39 +
                    *(float *)(lVar3 + 0x1bc) * fVar15 + *(float *)(lVar3 + 0x1c4) * fVar32 +
                    (float)((ulong)*(undefined8 *)(lVar3 + 0xe4) >> 0x20),
                    (float)*(undefined8 *)(lVar3 + 0x1b4) * fVar39 +
                    *(float *)(lVar3 + 0x1b0) * fVar15 + *(float *)(lVar3 + 0x1b8) * fVar32 +
                    (float)*(undefined8 *)(lVar3 + 0xe4));
    }
    if (GVar2 != (GodotHingeJoint3D)0x0) {
      ...
      *(float *)(lVar5 + 0xec) =
           *(float *)(lVar5 + 0x1c8) * fVar15 + *(float *)(lVar5 + 0x1cc) * fVar39 +
           *(float *)(lVar5 + 0x1d0) * fVar32 + *(float *)(lVar5 + 0xec);
      *(ulong *)(lVar5 + 0xe4) =
           CONCAT44((float)((ulong)*(undefined8 *)(lVar5 + 0x1bc) >> 0x20) * fVar39 +
                    *(float *)(lVar5 + 0x1bc) * fVar15 + *(float *)(lVar5 + 0x1c4) * fVar32 +
                    (float)((ulong)*(undefined8 *)(lVar5 + 0xe4) >> 0x20),
                    (float)*(undefined8 *)(lVar5 + 0x1b4) * fVar39 +
                    *(float *)(lVar5 + 0x1b0) * fVar15 + *(float *)(lVar5 + 0x1b8) * fVar32 +
                    (float)*(undefined8 *)(lVar5 + 0xe4));
    }
  }
  if (this[0x25a] != (GodotHingeJoint3D)0x0) {
    fVar14 = (*(float *)(this + 0x228) -
             ((fVar13 * fVar10 - fVar14 * fVar25) * fVar10 +
              (fVar13 * fVar22 - fVar14 * fVar9) * fVar22 +
             (fVar38 * fVar13 - fVar14 * fVar8) * fVar38)) * *(float *)(this + 0x244);
    ...
    if (GVar1 != (GodotHingeJoint3D)0x0) {
      ...
      *(float *)(lVar3 + 0xec) =
           *(float *)(lVar3 + 0x1d0) * fVar9 +
           fVar13 * *(float *)(lVar3 + 0x1c8) + *(float *)(lVar3 + 0x1cc) * fVar15 +
           *(float *)(lVar3 + 0xec);
      *(ulong *)(lVar3 + 0xe4) =
           CONCAT44((float)((ulong)*(undefined8 *)(lVar3 + 0x1bc) >> 0x20) * fVar15 +
                    fVar13 * *(float *)(lVar3 + 0x1bc) + *(float *)(lVar3 + 0x1c4) * fVar9 +
                    (float)((ulong)*(undefined8 *)(lVar3 + 0xe4) >> 0x20),
                    (float)*(undefined8 *)(lVar3 + 0x1b4) * fVar15 +
                    fVar13 * *(float *)(lVar3 + 0x1b0) + *(float *)(lVar3 + 0x1b8) * fVar9 +
                    (float)*(undefined8 *)(lVar3 + 0xe4));
    }
    if (GVar2 != (GodotHingeJoint3D)0x0) {
      ...
      *(float *)(lVar5 + 0xec) =
           *(float *)(lVar5 + 0x1d0) * fVar9 +
           *(float *)(lVar5 + 0x1c8) * fVar13 + *(float *)(lVar5 + 0x1cc) * fVar15 +
           *(float *)(lVar5 + 0xec);
      *(ulong *)(lVar5 + 0xe4) =
           CONCAT44((float)((ulong)*(undefined8 *)(lVar5 + 0x1bc) >> 0x20) * fVar15 +
                    fVar13 * *(float *)(lVar5 + 0x1bc) + *(float *)(lVar5 + 0x1c4) * fVar9 +
                    (float)((ulong)*(undefined8 *)(lVar5 + 0xe4) >> 0x20),
                    (float)*(undefined8 *)(lVar5 + 0x1b4) * fVar15 +
                    fVar13 * *(float *)(lVar5 + 0x1b0) + *(float *)(lVar5 + 0x1b8) * fVar9 +
                    (float)*(undefined8 *)(lVar5 + 0xe4));
    }
  }
...
/* GodotHingeJoint3D::get_hinge_angle() */

ulong __thiscall GodotHingeJoint3D::get_hinge_angle(GodotHingeJoint3D *this)

{
  ...
  fVar12 = *(float *)(lVar8 + 100) * fVar11 + *(float *)(lVar8 + 0x60) * fVar1 +
           *(float *)(lVar8 + 0x68) * fVar9;
  fVar13 = *(float *)(lVar8 + 0x58) * fVar11 + *(float *)(lVar8 + 0x54) * fVar1 +
           *(float *)(lVar8 + 0x5c) * fVar9;
  fVar11 = fVar11 * *(float *)(lVar8 + 0x4c) + fVar1 * *(float *)(lVar8 + 0x48) +
           fVar9 * *(float *)(lVar8 + 0x50);
  fVar9 = (fVar5 * *(float *)(lVar7 + 100) + fVar6 * *(float *)(lVar7 + 0x60) +
          fVar4 * *(float *)(lVar7 + 0x68)) * fVar12 +
          (*(float *)(lVar7 + 0x58) * fVar5 + fVar6 * *(float *)(lVar7 + 0x54) +
          *(float *)(lVar7 + 0x5c) * fVar4) * fVar13 +
          (fVar5 * *(float *)(lVar7 + 0x4c) + fVar6 * *(float *)(lVar7 + 0x48) +
          fVar4 * *(float *)(lVar7 + 0x50)) * fVar11;
  fVar10 = (*(float *)(lVar7 + 0x48) * fVar3 + *(float *)(lVar7 + 0x4c) * fVar2 +
           *(float *)(lVar7 + 0x50) * fVar10) * fVar11 +
           (*(float *)(lVar7 + 0x54) * fVar3 + *(float *)(lVar7 + 0x58) * fVar2 +
           *(float *)(lVar7 + 0x5c) * fVar10) * fVar13 +
           (*(float *)(lVar7 + 0x60) * fVar3 + *(float *)(lVar7 + 100) * fVar2 +
           *(float *)(lVar7 + 0x68) * fVar10) * fVar12;
  fVar11 = ABS(fVar10);
  if (fVar9 < 0.0) {
...
/* GodotHingeJoint3D::setup(float) */

byte GodotHingeJoint3D::setup(float param_1)

{
  ...
  *(undefined4 *)(in_RDI + 0x25c) = 0;
  ...
  if (in_RDI[0x259] == (GodotHingeJoint3D)0x0) {
    ...
    fVar19 = *(float *)(lVar9 + 0x60) * fVar12 + *(float *)(lVar9 + 100) * fVar24 +
             *(float *)(lVar9 + 0x68) * fVar21 + fVar18;
    fVar13 = *(float *)(in_RDI + 0x224);
    fVar34 = *(float *)(in_RDI + 0x220);
    fVar23 = *(float *)(lVar9 + 0x54) * fVar12 + *(float *)(lVar9 + 0x58) * fVar24 +
             *(float *)(lVar9 + 0x5c) * fVar21 + fVar25;
    fVar11 = fVar12 * *(float *)(lVar9 + 0x48) + fVar24 * *(float *)(lVar9 + 0x4c) +
             fVar21 * *(float *)(lVar9 + 0x50) + fVar22;
    fVar12 = *(float *)(in_RDI + 0x21c);
    fVar24 = *(float *)(lVar8 + 0x70);
    fVar17 = *(float *)(lVar8 + 100) * fVar34 + *(float *)(lVar8 + 0x60) * fVar12 +
             *(float *)(lVar8 + 0x68) * fVar13 + fVar20;
    local_120 = fVar17 - fVar19;
    fVar21 = *(float *)(lVar8 + 0x6c);
    fVar33 = *(float *)(lVar8 + 0x58) * fVar34 + *(float *)(lVar8 + 0x54) * fVar12 +
             *(float *)(lVar8 + 0x5c) * fVar13 + fVar24;
    local_128._4_4_ = fVar33 - fVar23;
    local_114 = 0.0;
    local_11c = 0.0;
    fVar12 = fVar12 * *(float *)(lVar8 + 0x48) + fVar34 * *(float *)(lVar8 + 0x4c) +
             fVar13 * *(float *)(lVar8 + 0x50) + fVar21;
    local_128._0_4_ = fVar12 - fVar11;
    fVar13 = local_128._4_4_ * local_128._4_4_ + (float)local_128 * (float)local_128 +
             local_120 * local_120;
    if (_LC3 <= ABS(fVar13)) {
      if (fVar13 == 0.0) {
        local_128._0_4_ = 0.0;
...
LAB_00101c47:
    ...
    while( true ) {
      ...
      *(float *)(pGVar7 + 0xc) = fVar18;
      fVar32 = fVar30 * (float)((uint)fVar24 ^ (uint)fVar14) -
               fVar20 * (float)((uint)fVar21 ^ (uint)fVar14);
      fVar25 = (float)((uint)fVar21 ^ (uint)fVar14) * fVar29 -
               fVar30 * (float)((uint)fVar22 ^ (uint)fVar14);
      fVar21 = fVar20 * (float)((uint)fVar22 ^ (uint)fVar14) -
               fVar29 * (float)((uint)fVar24 ^ (uint)fVar14);
      ...
      *(float *)(pGVar7 + 0x30) = fVar24;
      fVar24 = fVar21 * fVar24 + fVar22 * fVar20 + fVar25 * fVar26 +
               fVar18 * fVar31 + fVar28 * fVar30 + fVar27 * fVar29 + fVar34 + fVar13;
      *(float *)(pGVar7 + 0x3c) = fVar24;
      if (fVar24 <= 0.0) {
        ...
        _err_print_error("GodotJacobianEntry3D",
                         ...
                         "Condition \"m_Adiag <= real_t(0.0)\" is true.",0,0,uVar35,uVar16);
        fVar14 = (float)uVar35;
  ...
  local_158 = fVar13 * *(float *)(lVar9 + 100) + fVar22 * *(float *)(lVar9 + 0x60) +
              fVar20 * *(float *)(lVar9 + 0x68);
  local_160 = CONCAT44(fVar13 * fVar11 + fVar22 * fVar33 + fVar20 * fVar17,
                       fVar13 * fVar14 + fVar22 * fVar19 + fVar20 * fVar23);
  local_150 = CONCAT44(fVar25 * fVar11 + fVar34 * fVar33 + fVar18 * fVar17,
                       fVar25 * fVar14 + fVar34 * fVar19 + fVar18 * fVar23);
  local_148 = fVar34 * *(float *)(lVar9 + 0x60) + fVar25 * *(float *)(lVar9 + 100) +
              fVar18 * *(float *)(lVar9 + 0x68);
  local_128 = CONCAT44(fVar24 * fVar11 + fVar21 * fVar33 + fVar12 * fVar17,
                       fVar24 * fVar14 + fVar21 * fVar19 + fVar12 * fVar23);
  local_120 = *(float *)(lVar9 + 0x60) * fVar21 + fVar24 * *(float *)(lVar9 + 100) +
              fVar12 * *(float *)(lVar9 + 0x68);
  local_98 = *(undefined8 *)(lVar8 + 0x1d4);
  uStack_90 = *(undefined8 *)(lVar8 + 0x1dc);
  local_88 = *(undefined8 *)(lVar8 + 0x1e4);
  uStack_80 = *(undefined8 *)(lVar8 + 0x1ec);
  ...
  local_d8 = *(undefined4 *)(lVar2 + 500);
  Basis::transposed();
  GodotJacobianEntry3D::GodotJacobianEntry3D
            (local_1e8,(Vector3 *)&local_160,(Basis *)&local_c8,(Basis *)&local_68,
             (Vector3 *)(lVar9 + 0x174),(Vector3 *)(lVar8 + 0x174));
  ...
  Basis::transposed();
  GodotJacobianEntry3D::GodotJacobianEntry3D
            ((GodotJacobianEntry3D *)(in_RDI + 0x148),(Vector3 *)&local_150,(Basis *)&local_c8,
             (Basis *)&local_68,(Vector3 *)(lVar8 + 0x174),(Vector3 *)(lVar9 + 0x174));
  lVar9 = *(long *)(in_RDI + 0x40);
  lVar8 = *(long *)(in_RDI + 0x38);
  local_98 = *(undefined8 *)(lVar9 + 0x1d4);
  uStack_90 = *(undefined8 *)(lVar9 + 0x1dc);
  ...
  Basis::transposed();
  GodotJacobianEntry3D::GodotJacobianEntry3D
            ((GodotJacobianEntry3D *)(in_RDI + 0x188),local_180,(Basis *)&local_c8,
             (Basis *)&local_68,(Vector3 *)(lVar8 + 0x174),(Vector3 *)(lVar9 + 0x174));
  ...
  *(undefined4 *)(in_RDI + 0x250) = 0;
  ...
  fVar22 = *(float *)(lVar9 + 0x60) * fVar12 + *(float *)(lVar9 + 100) * fVar14 +
           *(float *)(lVar9 + 0x68) * fVar24;
  fVar21 = *(float *)(lVar9 + 0x54) * fVar12 + *(float *)(lVar9 + 0x58) * fVar14 +
           *(float *)(lVar9 + 0x5c) * fVar24;
  fVar14 = fVar12 * *(float *)(lVar9 + 0x48) + fVar14 * *(float *)(lVar9 + 0x4c) +
           fVar24 * *(float *)(lVar9 + 0x50);
  *(float *)(in_RDI + 0x244) =
       fVar3 / ((*(float *)(lVar8 + 0x1b0) * fVar14 + *(float *)(lVar8 + 0x1bc) * fVar21 +
                *(float *)(lVar8 + 0x1c8) * fVar22) * fVar14 +
                (*(float *)(lVar8 + 0x1b4) * fVar14 + *(float *)(lVar8 + 0x1c0) * fVar21 +
                *(float *)(lVar8 + 0x1cc) * fVar22) * fVar21 +
                (*(float *)(lVar8 + 0x1b8) * fVar14 + *(float *)(lVar8 + 0x1c4) * fVar21 +
                *(float *)(lVar8 + 0x1d0) * fVar22) * fVar22 +
               (fVar14 * *(float *)(lVar9 + 0x1b8) + fVar21 * *(float *)(lVar9 + 0x1c4) +
               *(float *)(lVar9 + 0x1d0) * fVar22) * fVar22 +
               (*(float *)(lVar9 + 0x1b0) * fVar14 + *(float *)(lVar9 + 0x1bc) * fVar21 +
               *(float *)(lVar9 + 0x1c8) * fVar22) * fVar14 +
               (*(float *)(lVar9 + 0x1b4) * fVar14 + *(float *)(lVar9 + 0x1c0) * fVar21 +
               *(float *)(lVar9 + 0x1cc) * fVar22) * fVar21);
LAB_00102857:
...
/* GodotHingeJoint3D::set_param(PhysicsServer3D::HingeJointParam, float) */

void __thiscall
GodotHingeJoint3D::set_param(undefined4 param_1,GodotHingeJoint3D *this,undefined4 param_3)
...
/* GodotHingeJoint3D::get_param(PhysicsServer3D::HingeJointParam) const */

undefined4 __thiscall GodotHingeJoint3D::get_param(GodotHingeJoint3D *this,undefined4 param_2)
...
/* GodotHingeJoint3D::set_flag(PhysicsServer3D::HingeJointFlag, bool) */

void __thiscall
GodotHingeJoint3D::set_flag(GodotHingeJoint3D *this,int param_2,GodotHingeJoint3D param_3)
...
/* GodotHingeJoint3D::get_flag(PhysicsServer3D::HingeJointFlag) const */

GodotHingeJoint3D __thiscall GodotHingeJoint3D::get_flag(GodotHingeJoint3D *this,int param_2)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GodotHingeJoint3D::GodotHingeJoint3D(GodotBody3D*, GodotBody3D*, Transform3D const&, Transform3D
   const&) */

void __thiscall
GodotHingeJoint3D::GodotHingeJoint3D
          (GodotHingeJoint3D *this,GodotBody3D *param_1,GodotBody3D *param_2,Transform3D *param_3,
          Transform3D *param_4)

{
  ...
  *(undefined ***)this = &PTR_get_soft_body_ptr_00104a20;
  ...
  do {
    ...
    *(undefined8 *)(pGVar18 + 0xc) = 0;
    *(undefined4 *)(pGVar18 + 0x14) = 0;
    *(undefined8 *)(pGVar18 + 0x18) = 0;
    *(undefined4 *)(pGVar18 + 0x20) = 0;
    *(undefined8 *)(pGVar18 + 0x24) = 0;
    *(undefined4 *)(pGVar18 + 0x2c) = 0;
    *(undefined8 *)(pGVar18 + 0x30) = 0;
    *(undefined4 *)(pGVar18 + 0x38) = 0;
  ...
  do {
    ...
    *(undefined8 *)(pGVar17 + 0xc) = 0;
    *(undefined4 *)(pGVar17 + 0x14) = 0;
    *(undefined8 *)(pGVar17 + 0x18) = 0;
    *(undefined4 *)(pGVar17 + 0x20) = 0;
    *(undefined8 *)(pGVar17 + 0x24) = 0;
    *(undefined4 *)(pGVar17 + 0x2c) = 0;
    *(undefined8 *)(pGVar17 + 0x30) = 0;
    *(undefined4 *)(pGVar17 + 0x38) = 0;
  ...
  *(uint *)(this + 0x200) = *(uint *)(this + 0x200) ^ uVar12;
  *(uint *)(this + 0x20c) = *(uint *)(this + 0x20c) ^ uVar12;
  *(uint *)(this + 0x218) = *(uint *)(this + 0x218) ^ uVar12;
  local_28 = this;
  puVar19 = (undefined4 *)
            HashMap<GodotConstraint3D*,int,HashMapHasherDefault,HashMapComparatorDefault<GodotConstraint3D*>,DefaultTypedAllocator<HashMapElement<GodotConstraint3D*,int>>>
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GodotHingeJoint3D::GodotHingeJoint3D(GodotBody3D*, GodotBody3D*, Vector3 const&, Vector3 const&,
   Vector3 const&, Vector3 const&) */

void __thiscall
GodotHingeJoint3D::GodotHingeJoint3D
          (GodotHingeJoint3D *this,GodotBody3D *param_1,GodotBody3D *param_2,Vector3 *param_3,
...

{
  ...
  *(undefined ***)this = &PTR_get_soft_body_ptr_00104a20;
  ...
  do {
    ...
    *(undefined8 *)(pGVar10 + 0xc) = 0;
    *(undefined4 *)(pGVar10 + 0x14) = 0;
    *(undefined8 *)(pGVar10 + 0x18) = 0;
    *(undefined4 *)(pGVar10 + 0x20) = 0;
    *(undefined8 *)(pGVar10 + 0x24) = 0;
    *(undefined4 *)(pGVar10 + 0x2c) = 0;
    *(undefined8 *)(pGVar10 + 0x30) = 0;
    *(undefined4 *)(pGVar10 + 0x38) = 0;
  ...
  *(float *)(this + 0x1e4) = fVar22;
  ...
  if (cVar9 == '\0') {
    ...
    operator+((char *)&local_78,"The quaternion ");
    String::operator+((String *)&local_68,(String *)&local_78);
    _err_print_error("xform","./core/math/quaternion.h",0x5c,
                     "Condition \"!is_normalized()\" is true. Returning: p_v",(String *)&local_68,0,
                     0);
...
/* GodotHingeJoint3D::get_type() const */

undefined8 GodotHingeJoint3D::get_type(void)
...
void __thiscall GodotHingeJoint3D::~GodotHingeJoint3D(GodotHingeJoint3D *this)
...
void __thiscall
GodotJacobianEntry3D::GodotJacobianEntry3D
          (GodotJacobianEntry3D *this,Vector3 *param_1,Basis *param_2,Basis *param_3,
...

{
  ...
  *(float *)(this + 0xc) = fVar14;
  ...
  fVar3 = *(float *)param_4;
  fVar11 = fVar10 * *(float *)param_3 + fVar15 * *(float *)(param_3 + 4) +
           fVar9 * *(float *)(param_3 + 8);
  fVar7 = (float)uVar5 * fVar15 + *(float *)(param_3 + 0xc) * fVar10 +
          *(float *)(param_3 + 0x14) * fVar9;
  fVar8 = (float)((ulong)uVar4 >> 0x20) * fVar15 + fVar16 * fVar10 +
          *(float *)(param_3 + 0x20) * fVar9;
  ...
  *(ulong *)(this + 0x34) = CONCAT44(fVar9,fVar16);
  fVar10 = fVar8 * fVar9 + fVar10 * fVar11 * fVar11 + fVar7 * fVar16 +
           fVar3 * fVar14 * fVar14 + fVar1 * fVar13 * fVar13 + fVar2 * fVar12 * fVar12;
...
/* GodotHingeJoint3D::get_param(PhysicsServer3D::HingeJointParam) const [clone .cold] */

undefined8 GodotHingeJoint3D::get_param(void)
...
LAB_001042bb:
  if ((float)uVar55 * __LC26 < (float)(iVar43 + 1)) {

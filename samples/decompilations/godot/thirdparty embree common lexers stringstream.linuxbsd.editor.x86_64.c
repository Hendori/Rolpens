...

{
  ...
  *(StringStream **)(this + 0x248) = __dest;
  ...
  if (uVar6 < 0x10) {
    ...
    __dest = (StringStream *)
             std::__cxx11::string::_M_create((ulong *)(this + 0x248),(ulong)&local_48);
    *(StringStream **)(this + 0x248) = __dest;
...
LAB_00100420:
  if (*(int *)(plVar15[5] + (ulong)((int)plVar15[3] + (int)plVar15[2] & 0x3ff) * 0x28) != -1) {
    plVar15 = *(long **)(in_RSI + 0x40);
    lVar10 = plVar15[4];
    plVar14 = plVar15;
    if (*(long *)(in_RSI + 0x250) != 0) {
      if (lVar10 == 0) {
        ...
        plVar15[4] = lVar12 + 1;
        puVar4 = (undefined4 *)
                 (plVar15[5] + (ulong)(uVar13 + (int)lVar10 + (int)lVar12 & 0x3ff) * 0x28);
        *puVar4 = uVar8;
        p_Var16 = *(_Sp_counted_base<(__gnu_cxx::_Lock_policy)2> **)(puVar4 + 4);
        *(ulong *)(puVar4 + 2) = uVar5;
        if (p_Var17 == p_Var16) {
...
LAB_001005cb:
      if (*(int *)(plVar15[5] + (ulong)((int)plVar15[3] + (int)plVar15[2] & 0x3ff) * 0x28) == 10) {
        if (lVar10 == 0) {
...
LAB_00103b82:
          ...
          plVar14[4] = lVar12 + 1;
          puVar4 = (undefined4 *)
                   (plVar14[5] + (ulong)(uVar13 + (int)lVar10 + (int)lVar12 & 0x3ff) * 0x28);
          *puVar4 = uVar8;
...
LAB_00100788:
      if (lVar10 == 0) {
        ...
        plVar14[4] = lVar12 + 1;
        puVar4 = (undefined4 *)
                 (plVar14[5] + (ulong)((int)lVar10 + uVar13 + (int)lVar12 & 0x3ff) * 0x28);
        *puVar4 = uVar8;
        p_Var16 = *(_Sp_counted_base<(__gnu_cxx::_Lock_policy)2> **)(puVar4 + 4);
        *(ulong *)(puVar4 + 2) = uVar5;
        if (p_Var17 == p_Var16) {
...
LAB_001008f0:
      uVar13 = *(uint *)(plVar14[5] + (ulong)((int)plVar14[3] + (int)plVar14[2] & 0x3ff) * 0x28);
      ...
      if (lVar10 == 0) {
        ...
        plVar15[4] = lVar12 + 1;
        puVar4 = (undefined4 *)
                 (plVar15[5] + (ulong)((int)lVar10 + uVar13 + (int)lVar12 & 0x3ff) * 0x28);
        *puVar4 = uVar8;
        p_Var16 = *(_Sp_counted_base<(__gnu_cxx::_Lock_policy)2> **)(puVar4 + 4);
        *(ulong *)(puVar4 + 2) = uVar5;
        if (p_Var17 == p_Var16) {
...
LAB_00101316:
      ...
      if (lVar10 != 0) {
        lVar12 = plVar14[3];
        if (*(int *)(plVar14[5] + (ulong)((int)plVar14[2] + (int)lVar12 & 0x3ff) * 0x28) == 0x5c)
        goto LAB_00101666;
        goto LAB_001008f0;
      }
      (**(code **)(*plVar14 + 0x28))(&local_68,plVar14);
...
LAB_00101a97:
      ...
      plVar14 = *(long **)(in_RSI + 0x40);
      lVar10 = plVar14[4];
      if (*(int *)(*plVar3 + (ulong)((int)*plVar15 + (int)*plVar2 & 0x3ff) * 0x28) != 0x5c)
      goto LAB_00100788;
      if (lVar10 != 0) {
        lVar12 = plVar14[3];
        goto LAB_00101666;
...
LAB_00102c9a:
        ...
        lVar12 = plVar15[3];
        if (*(int *)(plVar15[5] + (ulong)((int)plVar15[2] + (int)lVar12 & 0x3ff) * 0x28) != 10)
        goto LAB_00102040;
      }
LAB_001026dd:
      plVar15[3] = lVar12 + 1;

...
/* EditorAbout::_item_list_resized(ItemList*) */

void __thiscall EditorAbout::_item_list_resized(EditorAbout *this,ItemList *param_1)
...
/* CowData<ItemList*>::_copy_on_write() [clone .isra.0] */

void __thiscall CowData<ItemList*>::_copy_on_write(CowData<ItemList*> *this)
...
/* EditorAbout::_notification(int) [clone .part.0] */

void EditorAbout::_notification(int param_1)

{
  ...
  Window::get_theme_font_size
            (pSVar9,(StringName *)&_notification(int)::{lambda()#2}::operator()()::sname);
...
void __thiscall EditorAbout::~EditorAbout(EditorAbout *this)
...
/* EditorAbout::_notification(int) */

void __thiscall EditorAbout::_notification(EditorAbout *this,int param_1)
...
void __thiscall EditorAbout::_license_tree_selected(EditorAbout *this)
...
/* EditorAbout::_item_with_website_selected(int, ItemList*) */

void EditorAbout::_item_with_website_selected(int param_1,ItemList *param_2)
...
/* EditorAbout::_populate_list(String const&, List<String, DefaultAllocator> const&, char const*
   const* const*, int, bool) */

ScrollContainer * __thiscall
...

{
  ...
  *(undefined ***)local_d0 = &PTR__initialize_classv_00124d38;
  ...
  plVar1 = *(long **)param_2;
  if (cVar4 == '\0') {
    if ((plVar1 == (long *)0x0) || (local_120 = *plVar1, local_120 == 0)) goto LAB_00101121;
    ...
    do {
      ...
      if (*ppcVar11 != (char *)0x0) {
        ...
        Control::add_theme_constant_override
                  ((StringName *)this_03,(int)(CowData<char32_t> *)local_68);
        if ((StringName::configured != '\0') && (local_68[0] != (Object *)0x0)) {
          StringName::unref();
        }
        ...
        if (param_5) {
          ...
          *(char **)(pCVar8 + 0x20) = "ItemList::deselect_all";
          ...
          Callable::~Callable((Callable *)local_68);
          local_68[0] = (Object *)0x0;
          if (((local_d0 != (StyleBox *)0x0) &&
              (pOVar9 = (Object *)__dynamic_cast(local_d0,&Object::typeinfo,&StyleBox::typeinfo,0),
              pOVar9 != (Object *)0x0)) &&
             (local_68[0] = pOVar9, cVar4 = RefCounted::reference(), cVar4 == '\0')) {
            local_68[0] = (Object *)0x0;
          }
          ...
          if (((local_68[0] != (Object *)0x0) &&
              (cVar4 = RefCounted::unreference(), pOVar9 = local_68[0], cVar4 != '\0')) &&
             (cVar4 = predelete_handler(local_68[0]), cVar4 != '\0')) {
          ...
          if (pcVar16 != (char *)0x0) {
            do {
              ppcVar11 = ppcVar11 + 1;
              String::utf8((char *)local_b0,(int)pcVar16);
              iVar14 = (int)local_b0;
              String::get_slice((char *)local_a8,iVar14);
              iVar7 = String::get_slice_count((char *)local_b0);
              if (iVar7 == 1) {
                local_a0 = 0;
                String::parse_latin1((String *)&local_a0,"");
              }
              else {
                String::get_slice((char *)local_68,iVar14);
                String::trim_suffix((char *)&local_a0);
                CowData<char32_t>::_unref((CowData<char32_t> *)local_68);
              }
              local_68[0] = (Object *)0x0;
              uVar6 = ItemList::add_item((String *)this_03,(Ref *)local_a8,bVar10);
              if (((local_68[0] != (Object *)0x0) &&
                  (cVar4 = RefCounted::unreference(), pOVar9 = local_68[0], cVar4 != '\0')) &&
                 (cVar4 = predelete_handler(local_68[0]), cVar4 != '\0')) {
              ...
              local_118 = (Variant *)local_58;
              bVar13 = SUB41(uVar6,0);
              ItemList::set_item_tooltip_enabled(iVar5,bVar13);
              if ((local_a0 == 0) || (*(uint *)(local_a0 + -8) < 2)) {
                pcVar16 = *ppcVar11;
              }
              else {
                ItemList::set_item_selectable(iVar5,bVar13);
                Variant::Variant(local_118,(String *)&local_a0);
                ItemList::set_item_metadata(iVar5,(Variant *)(ulong)uVar6);
                ...
                local_88 = 0;
                String::parse_latin1((String *)&local_88,"Double-click to open in browser.");
                ...
                ItemList::set_item_tooltip(iVar5,(String *)(ulong)uVar6);
                CowData<char32_t>::_unref((CowData<char32_t> *)local_68);
              ...
              if ((pcVar16 == (char *)0x0) &&
                 (iVar7 = String::find((char *)local_b0,0x103cf7), iVar7 != -1)) {
                ItemList::set_item_disabled(iVar5,bVar13);
              }
          ...
          while (pcVar16 != (char *)0x0) {
            while( true ) {
              ...
              if (((local_68[0] != (Object *)0x0) &&
                  (cVar4 = RefCounted::unreference(), pOVar9 = local_68[0], cVar4 != '\0')) &&
                 (cVar4 = predelete_handler(local_68[0]), cVar4 != '\0')) break;
              pcVar16 = *ppcVar11;
...
LAB_00100ff5:
        ItemList::set_max_columns(iVar5);
        if (*(long *)(this + 0xdd8) == 0) {
          lVar15 = 1;
        }
        else {
...
LAB_00101085:
    ...
    if (local_d0 == (StyleBox *)0x0) goto LAB_00101121;
  }
  else if ((plVar1 != (long *)0x0) && (local_120 = *plVar1, local_120 != 0)) goto LAB_00100daa;
  cVar4 = RefCounted::unreference();
  if ((cVar4 != '\0') && (cVar4 = predelete_handler((Object *)local_d0), cVar4 != '\0')) {
...

{
  ...
  *(undefined ***)this_02 = &PTR__initialize_classv_001252b0;
  ...
  List<String,DefaultAllocator>::push_back
            ((List<String,DefaultAllocator> *)&local_120,(String *)&local_e8);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_e8);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_e0);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_d8);
  local_d8 = (undefined *)0x0;
  ...
  TTR((String *)&local_e8,(String *)&local_e0);
  List<String,DefaultAllocator>::push_back
            ((List<String,DefaultAllocator> *)&local_118,(String *)&local_e8);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_e8);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_e0);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_d8);
  local_d8 = (undefined *)0x0;
  ...
  *(Tree **)(this + 0xdb0) = this_06;
  ...
  do {
    ...
    local_d0 = 1;
    String::parse_latin1((StrRange *)&local_e0);
    operator+((char *)&local_d8,(String *)&_LC111);
  ...
  do {
    ...
    operator+((char *)&local_e8,(String *)&_LC117);
    String::operator+((String *)&local_f0,(String *)&local_e8);
...
{
  return (uint)CONCAT71(0x1290,(undefined4 *)param_1 == &StyleBox::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1290,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1291,(undefined4 *)param_1 == &Resource::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1291,(undefined4 *)param_1 == &RefCounted::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1291,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr);
}
...
/* EditorAbout::is_class_ptr(void*) const */

uint EditorAbout::is_class_ptr(void *param_1)

{
  undefined4 in_EDX;
  undefined4 *in_RSI;
  
  return (uint)CONCAT71(0x1290,in_RSI == &AcceptDialog::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x128f,in_RSI == &get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1290,in_RSI == &Window::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1290,in_RSI == &Viewport::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1290,in_RSI == &Node::get_class_ptr_static()::ptr) |
         CONCAT31((int3)((uint)in_EDX >> 8),in_RSI == &Object::get_class_ptr_static()::ptr);
}



/* EditorAbout::_property_can_revertv(StringName const&) const */

undefined8 EditorAbout::_property_can_revertv(StringName *param_1)
...
/* EditorAbout::_property_get_revertv(StringName const&, Variant&) const */

undefined8 EditorAbout::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* CallableCustomMethodPointer<EditorAbout, void>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<EditorAbout,void>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<EditorAbout,void> *this)
...
/* CallableCustomMethodPointer<ItemList, void>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<ItemList,void>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<ItemList,void> *this)
...
/* CallableCustomMethodPointer<EditorAbout, void, ItemList*>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<EditorAbout,void,ItemList*>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<EditorAbout,void,ItemList*> *this)
...
/* CallableCustomMethodPointer<EditorAbout, void, int, ItemList*>::~CallableCustomMethodPointer() */

void __thiscall
CallableCustomMethodPointer<EditorAbout,void,int,ItemList*>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<EditorAbout,void,int,ItemList*> *this)
...
/* CallableCustomMethodPointer<EditorAbout, void>::get_argument_count(bool&) const */

undefined8 __thiscall
CallableCustomMethodPointer<EditorAbout,void>::get_argument_count
          (CallableCustomMethodPointer<EditorAbout,void> *this,bool *param_1)
...
/* CallableCustomMethodPointer<ItemList, void>::get_argument_count(bool&) const */

undefined8 __thiscall
CallableCustomMethodPointer<ItemList,void>::get_argument_count
          (CallableCustomMethodPointer<ItemList,void> *this,bool *param_1)
...
/* CallableCustomMethodPointer<EditorAbout, void, ItemList*>::get_argument_count(bool&) const */

undefined8 __thiscall
CallableCustomMethodPointer<EditorAbout,void,ItemList*>::get_argument_count
          (CallableCustomMethodPointer<EditorAbout,void,ItemList*> *this,bool *param_1)
...
undefined8 __thiscall
CallableCustomMethodPointer<EditorAbout,void,int,ItemList*>::get_argument_count
          (CallableCustomMethodPointer<EditorAbout,void,int,ItemList*> *this,bool *param_1)
...
/* EditorAbout::_getv(StringName const&, Variant&) const */

undefined8 EditorAbout::_getv(StringName *param_1,Variant *param_2)
...
/* EditorAbout::_setv(StringName const&, Variant const&) */

undefined8 EditorAbout::_setv(StringName *param_1,Variant *param_2)
...
/* CowData<ItemList*>::_copy_on_write() [clone .isra.0] [clone .cold] */

void CowData<ItemList*>::_copy_on_write(void)
...
/* CallableCustomMethodPointer<ItemList, void>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<ItemList,void>::get_object
          (CallableCustomMethodPointer<ItemList,void> *this)
...
/* CallableCustomMethodPointer<EditorAbout, void>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<EditorAbout,void>::get_object
          (CallableCustomMethodPointer<EditorAbout,void> *this)
...
/* CallableCustomMethodPointer<EditorAbout, void, ItemList*>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<EditorAbout,void,ItemList*>::get_object
          (CallableCustomMethodPointer<EditorAbout,void,ItemList*> *this)
...
/* CallableCustomMethodPointer<EditorAbout, void, int, ItemList*>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<EditorAbout,void,int,ItemList*>::get_object
          (CallableCustomMethodPointer<EditorAbout,void,int,ItemList*> *this)
...
/* EditorAbout::_validate_propertyv(PropertyInfo&) const */

void EditorAbout::_validate_propertyv(PropertyInfo *param_1)
...

{
  ...
  if (in_RSI != &get_class_ptr_static()::ptr) {
    uVar1 = (uint)CONCAT71(0x1290,in_RSI == &Container::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x125e,in_RSI == &SplitContainer::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x1290,in_RSI == &Control::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x1290,in_RSI == &CanvasItem::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x1290,in_RSI == &Node::get_class_ptr_static()::ptr) |
            CONCAT31((int3)((uint)in_EDX >> 8),in_RSI == &Object::get_class_ptr_static()::ptr);
  }
  return uVar1;
...

{
  ...
  if (in_RSI != &get_class_ptr_static()::ptr) {
    uVar1 = (uint)CONCAT71(0x1290,in_RSI == &Container::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x1290,in_RSI == &BoxContainer::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x1290,in_RSI == &Control::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x1290,in_RSI == &CanvasItem::get_class_ptr_static()::ptr) |
            (uint)CONCAT71(0x1290,in_RSI == &Node::get_class_ptr_static()::ptr) |
            CONCAT31((int3)((uint)in_EDX >> 8),in_RSI == &Object::get_class_ptr_static()::ptr);
...
/* WARNING: Removing unreachable block (ram,0x00108168) */
...
/* WARNING: Removing unreachable block (ram,0x001081d8) */
...
/* EditorAbout::_notificationv(int, bool) */

void __thiscall EditorAbout::_notificationv(EditorAbout *this,int param_1,bool param_2)
...
/* EditorAbout::_get_class_namev() const */

undefined8 * EditorAbout::_get_class_namev(void)
...
LAB_00108623:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      goto LAB_00108623;
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"EditorAbout");
      goto LAB_0010868e;
    }
  }
  StringName::assign_static_unique_class_name
...
void StyleBox::get_save_class(void)
...
/* EditorAbout::get_class() const */

void EditorAbout::get_class(void)
...
void __thiscall
CallableCustomMethodPointer<EditorAbout,void>::call
          (CallableCustomMethodPointer<EditorAbout,void> *this,Variant **param_1,int param_2,
...
void __thiscall
CallableCustomMethodPointer<ItemList,void>::call
          (CallableCustomMethodPointer<ItemList,void> *this,Variant **param_1,int param_2,
          Variant *param_3,CallError *param_4)
...
void __thiscall
CallableCustomMethodPointer<EditorAbout,void,ItemList*>::call
          (CallableCustomMethodPointer<EditorAbout,void,ItemList*> *this,Variant **param_1,
...
LAB_0010a3d0:
          ...
          *(undefined8 *)(param_4 + 4) = uVar3;
          ...
          if (((pOVar6 == (Object *)0x0) ||
              (lVar7 = __dynamic_cast(pOVar6,&Object::typeinfo,&ItemList::typeinfo,0), lVar7 == 0))
             && (pOVar5 != (Object *)0x0)) goto LAB_0010a3d0;
        }
...
void __thiscall
CallableCustomMethodPointer<EditorAbout,void,int,ItemList*>::call
          (CallableCustomMethodPointer<EditorAbout,void,int,ItemList*> *this,Variant **param_1,
          int param_2,Variant *param_3,CallError *param_4)
...
LAB_0010a6cf:
          ...
          *(undefined8 *)(param_4 + 4) = uVar3;
          ...
          if (((pOVar7 == (Object *)0x0) ||
              (lVar8 = __dynamic_cast(pOVar7,&Object::typeinfo,&ItemList::typeinfo,0), lVar8 == 0))
             && (pOVar6 != (Object *)0x0)) goto LAB_0010a6cf;
        }
      ...
      if (Container::initialize_class()::initialized == '\0') {
        if (Control::initialize_class()::initialized == '\0') {
          if (CanvasItem::initialize_class()::initialized == '\0') {
            ...
            if ((code *)PTR__bind_compatibility_methods_0012d070 !=
                Object::_bind_compatibility_methods) {
...
/* EditorAbout::_initialize_classv() */

void EditorAbout::_initialize_classv(void)
...
/* EditorAbout::is_class(String const&) const */

undefined8 __thiscall EditorAbout::is_class(EditorAbout *this,String *param_1)
...
/* EditorAbout::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */

void __thiscall EditorAbout::_get_property_listv(EditorAbout *this,List *param_1,bool param_2)
...
void Container::_get_property_listv(List *param_1,bool param_2)
...
/* CowData<ItemList*>::_realloc(long) */

undefined8 __thiscall CowData<ItemList*>::_realloc(CowData<ItemList*> *this,long param_1)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* Error CowData<ItemList*>::resize<false>(long) */

undefined8 __thiscall CowData<ItemList*>::resize<false>(CowData<ItemList*> *this,long param_1)
...
void EditorAbout::_GLOBAL__sub_I__notification(void)

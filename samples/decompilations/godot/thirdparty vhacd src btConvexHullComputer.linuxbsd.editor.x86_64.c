...
LAB_001074b1:
        ...
        if (iVar26 == iVar9) {
          ...
          if ((*(int *)*pauVar16 != iVar22) || (iVar4 <= *(int *)(*pauVar16 + 8)))
          goto LAB_00106e03;
          iVar20 = iVar20 + 1;
          pauVar16 = pauVar16 + 1;
          iVar19 = iVar19 + 1;
...
LAB_00106e03:
        for (pauVar25 = pauVar14 + iVar28;
            ...
            ((iVar31 == iVar9 &&
             ((iVar22 < *(int *)*pauVar25 ||
              ((*(int *)*pauVar25 == iVar22 && (iVar4 < *(int *)(*pauVar25 + 8)))))))));
            pauVar25 = pauVar25 + -1) {
          iVar28 = iVar28 + -1;
        }
        iVar31 = iVar20;
        ...
        if (0 < iVar28) {
          ...
          do {
            ...
            if ((iVar4 <= iVar30) &&
               ((iVar30 != iVar4 ||
                ((iVar9 <= *(int *)*pauVar16 &&
                 ((*(int *)*pauVar16 != iVar9 || (iVar22 <= *(int *)(*pauVar16 + 8))))))))) {
              for (pauVar25 = pauVar14 + iVar20;
                  (iVar27 = *(int *)(*pauVar25 + 4), iVar27 != iVar4 && iVar4 <= iVar27 ||
                  ((iVar27 == iVar4 &&
                   ((iVar9 < *(int *)*pauVar25 ||
                    ((*(int *)*pauVar25 == iVar9 && (iVar22 < *(int *)(*pauVar25 + 8)))))))));
                  pauVar25 = pauVar25 + -1) {
                iVar20 = iVar20 + -1;
              }
              iVar27 = iVar19;
  ...
  if (0 < iVar20) {
    ...
    do {
      ...
      if ((iVar4 <= iVar32) &&
         ((iVar32 != iVar4 ||
          ((iVar22 <= *(int *)*pauVar16 &&
           ((*(int *)*pauVar16 != iVar22 || (iVar9 <= *(int *)(*pauVar16 + 8))))))))) {
        for (pauVar25 = pauVar14 + iVar19;
            (iVar29 = *(int *)(*pauVar25 + 4), iVar29 != iVar4 && iVar4 <= iVar29 ||
            ((iVar29 == iVar4 &&
             ((iVar22 < *(int *)*pauVar25 ||
              ((*(int *)*pauVar25 == iVar22 && (iVar9 < *(int *)(*pauVar25 + 8)))))))));
            pauVar25 = pauVar25 + -1) {
          iVar19 = iVar19 + -1;
        }
        iVar29 = iVar26;
  ...
  if (iVar27 < iVar28) {
    ...
    do {
      ...
      if ((iVar4 == iVar30 || iVar4 < iVar30) &&
         ((iVar4 != iVar30 ||
          ((iVar9 <= *(int *)*pauVar14 &&
           ((*(int *)*pauVar14 != iVar9 || (iVar22 <= *(int *)(*pauVar14 + 8))))))))) {
  ...
  if (iVar31 < iVar10) {
    ...
    do {
      ...
      if ((iVar4 <= iVar30) &&
         ((iVar30 != iVar4 ||
          ((iVar9 <= *(int *)*pauVar14 &&
           ((iVar9 != *(int *)*pauVar14 || (iVar22 <= *(int *)(*pauVar14 + 8))))))))) {
        for (pauVar25 = local_88 + iVar19;
            (iVar27 = *(int *)(*pauVar25 + 4), iVar27 != iVar4 && iVar4 <= iVar27 ||
            ((iVar27 == iVar4 &&
             ((iVar9 < *(int *)*pauVar25 ||
              ((iVar9 == *(int *)*pauVar25 && (iVar22 < *(int *)(*pauVar25 + 8)))))))));
            pauVar25 = pauVar25 + -1) {
          iVar19 = iVar19 + -1;
        }
        iVar27 = iVar20;
  ...
  if (iVar27 < iVar10) {
    ...
    do {
      ...
      if ((iVar9 <= iVar26) &&
         ((iVar26 != iVar9 ||
          ((iVar22 <= *(int *)*pauVar16 &&
           ((*(int *)*pauVar16 != iVar22 || (iVar4 <= *(int *)(*pauVar16 + 8))))))))) {
        for (pauVar14 = local_88 + iVar19;
            (iVar31 = *(int *)(*pauVar14 + 4), iVar31 != iVar9 && iVar9 <= iVar31 ||
            ((iVar31 == iVar9 &&
             ((iVar22 < *(int *)*pauVar14 ||
              ((*(int *)*pauVar14 == iVar22 && (iVar4 < *(int *)(*pauVar14 + 8)))))))));
            pauVar14 = pauVar14 + -1) {
          iVar19 = iVar19 + -1;
        }
        iVar31 = iVar28;
...
LAB_00107342:
  ...
  memset((void *)(*(long *)(this + 0x90) + (long)iVar22 * 8),0,
         (ulong)((param_4 - iVar22) - 1) * 8 + 8);
LAB_00107075:
...
LAB_0010830e:
                ...
                if (iVar23 < 1) {
                  ...
                  do {
                    *(undefined8 *)(lVar19 + lVar15) = *(undefined8 *)((long)pvVar24 + lVar15);
                    *(undefined4 *)(lVar19 + 8 + lVar15) =
                         *(undefined4 *)((long)pvVar24 + lVar15 + 8);
                    lVar15 = lVar15 + 0xc;
...
LAB_001081bf:
            puVar1 = (undefined8 *)(lVar19 + (long)iVar23 * 0xc);
            *puVar1 = 0;
            *(undefined4 *)(puVar1 + 1) = 0;
...
LAB_00108656:
                  ...
                  if (SBORROW4(iVar6,iVar8) != 0 < iVar6) {
                    ...
                    lVar17 = 0;
                    do {
                      *(undefined8 *)((long)plVar16 + lVar17) =
                           *(undefined8 *)((long)local_158 + lVar17);
                      lVar17 = lVar17 + 8;

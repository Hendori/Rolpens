  ...
  if (param_1[0x44] == (SwFill)0x0) {
    ...
    if (iVar2 == 2) {
      ...
      if (cVar8 == '\v') {
        ...
        fVar25 = pfVar5[2] - *pfVar5;
        fVar27 = pfVar5[3] - pfVar5[1];
        if (fVar25 < 0.0) {
          fVar25 = (float)((uint)fVar25 ^ __LC4);
        }
        if (fVar27 < 0.0) {
          fVar27 = (float)((uint)fVar27 ^ __LC4);
        }
        if (fVar25 <= fVar27) {
          fVar27 = fVar25 * __LC16 + fVar27;
          fVar25 = (float)((uint)fVar27 & _LC2);
        }
        else {
          fVar25 = fVar25 + fVar27 * __LC16;
          fVar27 = fVar25;
        }
        if (fVar25 <= _LC1) goto LAB_00103d30;
        local_78 = (ulong)(_LC15 / fVar27);
      }
    }
    else {
LAB_00103d30:
    ...
    uVar12 = (uVar11 >> 8 & 0xff00ff | 0xff0000) * (iVar22 + 1) & 0xff00ff00 |
             (uVar11 & 0xff00ff) * (iVar22 + 1) >> 8 & 0xff00ff;
    bVar6 = fVar27 < _LC14;
    *puVar20 = uVar12;
    if (bVar6) {
      if (iVar10 != 1) {
...
LAB_00104440:
      local_54 = 0;
LAB_001040b7:
      puVar17 = puVar20 + uVar21;
      puVar20 = puVar20 + (ulong)(0x3ff - uVar21) + (ulong)uVar21 + 1;
      puVar16 = puVar17;
      if (((int)puVar20 - (int)puVar17 & 4U) != 0) {
        *puVar17 = uVar12;
        puVar16 = puVar17 + 1;
        if (puVar17 + 1 == puVar20) goto LAB_001040f6;
      }
      do {
        *puVar16 = uVar12;
        puVar17 = puVar16 + 2;
      ...
      if (bVar6) {
        do {
          ...
          uVar19 = (ulong)uVar21;
          uVar21 = uVar21 + 1;
          puVar20[uVar19] = puVar20[uVar18];
        } while (fVar25 <= fVar27);
        if (iVar10 != 1) goto LAB_00103dd4;
        local_54 = 0;
      }
      else {
        if (iVar10 == 1) goto LAB_00104440;
LAB_00103dd4:
        uVar19 = 0;
        local_54 = 0;
        do {
          if (((iVar2 == 2) && (local_54 == 0)) && (iVar10 + -2 == (int)uVar19)) {
            uVar12 = 0x28;
            if ((uint)local_78 < 0x29) {
              uVar12 = (uint)local_78;
            }
            local_54 = (uint)(long)((float)(0x400 - uVar21) * __LC17);
            if (uVar12 <= local_54) {
              local_54 = uVar12;
            }
          }
          pfVar5 = local_48 + uVar19 * 2;
          fVar27 = _LC6 / (pfVar5[2] - *pfVar5);
          iVar22 = (int)((uint)*(byte *)((long)pfVar5 + 0xf) * (uint)param_5 + 0xff) >> 8;
          if ((param_1[0x45] != (SwFill)0x1) && (iVar22 != 0xff)) {
            param_1[0x45] = (SwFill)0x1;
          }
          uVar12 = (**(code **)(param_4 + 0x40))
                             (*(undefined1 *)(pfVar5 + 3),*(undefined1 *)((long)pfVar5 + 0xd),
                              *(undefined1 *)((long)pfVar5 + 0xe),iVar22);
          fVar7 = _LC18;
          fVar24 = _LC12;
          fVar23 = pfVar5[2];
          if ((uVar21 < 0x400) && (fVar25 < fVar23)) {
            fVar1 = *pfVar5;
            puVar20 = (uint *)(*(long *)(param_1 + 0x38) + (ulong)uVar21 * 4);
            fVar26 = fVar25;
            do {
              fVar25 = fVar26 + fVar24;
              uVar21 = uVar21 + 1;
              uVar18 = 0xffU - (int)((fVar26 - fVar1) * fVar27 * fVar7) & 0xff;
              uVar13 = uVar18 * ((uVar11 >> 8 & 0xff00ff) - (uVar12 >> 8 & 0xff00ff)) +
                       (uVar12 & 0xff00ff00);
              iVar14 = (uVar13 >> 0x18) + 1;
              *puVar20 = ((uVar13 & 0xff00ff00) >> 8 | 0xff0000) * iVar14 & 0xff00ff00 |
                         iVar14 * ((uVar18 * ((uVar11 & 0xff00ff) - (uVar12 & 0xff00ff)) >> 8) +
                                   (uVar12 & 0xff00ff) & 0xff00ff) >> 8 & 0xff00ff;
              if (fVar23 <= fVar25) break;
              puVar20 = puVar20 + 1;
              fVar26 = fVar25;
            } while (uVar21 < 0x400);
          }
          if (((int)uVar19 == 0) && (iVar2 == 2)) {
            uVar11 = 0x28;
            if ((uint)local_78 < 0x29) {
              uVar11 = (uint)local_78;
            }
            uVar18 = (uint)(long)((float)(uVar21 - 1) * __LC17);
            if (uVar11 <= uVar18) {
              uVar18 = uVar11;
            }
          ...
          uVar19 = uVar19 + 1;
          uVar11 = uVar12;
        } while (uVar19 != iVar10 - 1);
        uVar12 = (uVar12 & 0xff00ff) * (iVar22 + 1) >> 8 & 0xff00ff |
                 (uVar12 >> 8 & 0xff00ff | 0xff0000) * (iVar22 + 1) & 0xff00ff00;
      }
      if (uVar21 < 0x400) {
        puVar20 = *(uint **)(param_1 + 0x38);
        goto LAB_001040b7;
...
LAB_001040f6:
    ...
    if (iVar2 == 2) {
      if (((uint)local_78 != 0) && (local_54 != 0)) {
        ...
        uVar12 = 0x400 - local_54;
        uVar11 = *(uint *)(lVar4 + (ulong)uVar12 * 4);
        if ((uVar11 >> 0x18 != 0xff) && (uVar11 >> 0x18 != 0)) {
          fVar25 = _LC18 / (float)(uVar11 >> 0x18);
          uVar11 = ((int)((float)(uVar11 >> 8 & 0xff) * fVar25) & 0xffU) << 8 |
                   (int)((float)(uVar11 & 0xff) * fVar25) & 0xffU | uVar11 & 0xff000000 |
                   ((int)((float)(uVar11 >> 0x10 & 0xff) * fVar25) & 0xffU) << 0x10;
        }
        uVar21 = *(uint *)(lVar4 + (local_78 & 0xffffffff) * 4);
        if ((uVar21 >> 0x18 != 0xff) && (uVar21 >> 0x18 != 0)) {
          fVar25 = _LC18 / (float)(uVar21 >> 0x18);
          uVar21 = ((int)((float)(uVar21 >> 8 & 0xff) * fVar25) & 0xffU) << 8 |
                   (int)((float)(uVar21 & 0xff) * fVar25) & 0xffU | uVar21 & 0xff000000 |
                   ((int)((float)(uVar21 >> 0x10 & 0xff) * fVar25) & 0xffU) << 0x10;
        }
        fVar25 = _LC6 / ((float)(local_54 + (uint)local_78) + _LC6);
        if (uVar12 != (uint)local_78) {
          ...
          do {
            while( true ) {
              ...
              uVar12 = 0xffU - (int)(fVar23 * fVar27) & 0xff;
              uVar18 = uVar12 * ((uVar11 >> 8 & 0xff00ff) - (uVar21 >> 8 & 0xff00ff)) +
                       (uVar21 & 0xff00ff00);
              iVar10 = (uVar18 >> 0x18) + 1;
              *(uint *)(lVar4 + uVar19 * 4) =
                   ((uVar18 & 0xff00ff00) >> 8 | 0xff0000) * iVar10 & 0xff00ff00 |
                   ((uVar12 * ((uVar11 & 0xff00ff) - (uVar21 & 0xff00ff)) >> 8) +
                    (uVar21 & 0xff00ff) & 0xff00ff) * iVar10 >> 8 & 0xff00ff;
              fVar23 = fVar24;
              if ((int)uVar19 != 0x3ff) break;
              uVar19 = 0;
            }
            uVar19 = (ulong)uVar13;
      ...
      *(uint *)(*(long *)(param_1 + 0x38) + 0xffc) = uVar12;
    }
  }
  uVar19 = CONCAT71(in_register_00000089,param_6) & 0xffffffff;
LAB_00103c42:

...

{
  ...
  if (param_1 + 0xc0000000 < 0x3fff0000) {
    ...
    if ((((uVar2 < 0x16) && ((ulong)(param_1 & 0x1ffffff) < (ulong)(uint)(0x10 << (sbyte)uVar2))) &&
        ((&global_data)[uVar2] != 0)) &&
       ((lVar1 = (&global_data)[uVar2] + (ulong)(param_1 & 0x1ffffff) * 0x38,
        *(int *)(lVar1 + 0x18) == 2 && (*(uint *)(lVar1 + 0x14) == param_1)))) {
LAB_00100058:
...

{
  ...
  while (lVar3 = lVar7, iVar2 != 0) {
    if (((iVar2 == 2) && (*(long *)(lVar7 + 0x20) == 0)) &&
       (lVar4 = lVar7, *(char *)(lVar7 + 4) != '\0')) goto LAB_001003f8;

...
/* GLES3::CubemapFilter::CubemapFilter() */

void __thiscall GLES3::CubemapFilter::CubemapFilter(CubemapFilter *this)

{
  ...
  *(undefined4 *)(this + 0x140) = 0x80;
  ...
  StringName::StringName
            ((StringName *)&local_68,"rendering/reflections/sky_reflections/ggx_samples",false);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* importance_sample_GGX(Vector2, float) */

void importance_sample_GGX(undefined8 param_1,float param_2)
...
/* distribution_GGX(float, float) */

void distribution_GGX(float param_1,float param_2)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* radical_inverse_vdC(unsigned int) */

undefined8 radical_inverse_vdC(uint param_1)
...
/* hammersley(unsigned int, unsigned int) */

void hammersley(uint param_1,uint param_2)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GLES3::CubemapFilter::filter_radiance(unsigned int, unsigned int, unsigned int, int, int, int) */

void __thiscall
GLES3::CubemapFilter::filter_radiance
          (CubemapFilter *this,uint param_1,uint param_2,uint param_3,int param_4,int param_5,
          int param_6)
  ...
  if ((int)local_11c < *(int *)(this + 0x120)) {
    if (uVar7 != 0) {
      if ((uint)uVar7 < *(uint *)(this + 0x54)) {
        uVar23 = ((uVar7 & 0xffffffff) % (ulong)*(uint *)(this + 0x50)) * 0x80 +
                 *(long *)(*(long *)(this + 0x40) +
        ...
        if (*(int *)(uVar23 + 0x78) == (int)(uVar7 >> 0x20)) {
          ...
          if (uVar17 != 0) {
            uVar3 = 0;
            while ((uVar18 = (ulong)uVar17, uVar17 != (uint)uVar22 ||
                   (local_b0 != *(ulong *)(plVar20[1] + uVar6 * 8)))) {
              uVar3 = uVar3 + 1;
              uVar6 = (ulong)((int)uVar6 + 1) % uVar9;
              uVar17 = *(uint *)(lVar11 + uVar6 * 4);
              if ((uVar17 == 0) || (((uVar15 + (int)uVar6) - uVar17 % uVar15) % uVar15 < uVar3))
              goto LAB_001018a8;
            }
...
LAB_001018a8:
          ...
          ShaderGLES3::_compile_specialization
                    ((Specialization *)this,(uint)(Specialization *)&local_a8,
                     (Version *)(ulong)local_124,uVar23);
          uVar15 = *(uint *)(uVar23 + 0x68);
          if (local_124 < uVar15) {
            ...
            ::insert((OAHashMap<unsigned_long,ShaderGLES3::Version::Specialization,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>
                      *)(lVar5 + *(long *)(uVar23 + 0x70)),&local_b0,(Specialization *)&local_a8);
            uVar15 = *(uint *)(uVar23 + 0x68);
            if (local_124 < uVar15) {
              ...
              if (uVar17 != 0) {
                uVar18 = 0;
LAB_001019c9:
                if ((uVar17 != (uint)uVar22) || (uVar7 != *(ulong *)(plVar20[1] + uVar23 * 8)))
                goto LAB_00101990;
...
LAB_0010092d:
                if (puVar24 == (undefined4 *)0x0) goto LAB_00100e88;
LAB_00100936:
                if (*(char *)((long)puVar24 + 0x31) == '\0') goto LAB_00100e88;
                ...
                *(undefined4 **)(this + 0x128) = puVar24;
                if (0 < param_6) {
                  ...
                  if (uVar17 == 0) {
                    ...
                    uVar3 = uVar3 | uVar3 >> 4;
                    uVar3 = uVar3 | uVar3 >> 8;
                    pvVar8 = (void *)Memory::realloc_static
                                               ((void *)0x0,
                                                (ulong)((uVar3 | uVar3 >> 0x10) + 1) << 2,false);
                    if (pvVar8 == (void *)0x0) {
                  ...
                  if (uVar15 != 0) {
                    ...
                    do {
                      ...
                      if (0.0 < fVar31) {
                        uVar13 = iVar2 * 4;
                        if (uVar13 < uVar17) {
                          *(float *)((long)pvVar8 + (ulong)uVar13 * 4) =
                               (float)local_64._0_4_ * fVar27;
                            ...
                            *(float *)((long)pvVar8 + uVar7 * 4) = fVar27 * (float)local_64._4_4_;
                            ...
                            if (uVar13 + 2 < uVar17) {
                              *(float *)((long)pvVar8 + uVar7 * 4) = fVar31;
                              dVar29 = (double)(float)((double)(fVar30 * fVar30) *
                                                       ((double)fVar26 - _LC11) + _LC11);
                              _local_64 = auVar32;
                              fVar27 = log2f((float)(_LC11 / ((double)((float)((double)((fVar26 / (
                                                  float)(_LC13 * dVar29 * dVar29)) * fVar30) /
                                                  ((double)fVar30 * __LC33) + __LC34) *
                                                  (float)uVar15) + __LC34)) / (float)dVar28);
                              iVar10 = param_6 + -3;
                              if (iVar10 < 1) {
                                iVar10 = 1;
                              }
...
LAB_00102226:
                    ...
                    lVar11 = ((uVar7 & 0xffffffff) % (ulong)*(uint *)(this + 0x50)) * 0x80 +
                             *(long *)(*(long *)(this + 0x40) +
                                      ((uVar7 & 0xffffffff) / (ulong)*(uint *)(this + 0x50)) * 8);
                    if (*(int *)(lVar11 + 0x78) != (int)(uVar7 >> 0x20)) {
                      if (*(int *)(lVar11 + 0x78) + 0x80000000U < 0x7fffffff) {
                        _err_print_error("get_or_null","./core/templates/rid_owner.h",0x103,
                                         ...
                                         "Attempting to use an uninitialized RID",0,0,uVar18);
                      }
                      goto LAB_00102226;
                    }
                    ...
                    if ((int)uVar13 <= (int)local_11c) {
                      _err_print_index_error
                                ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe7,uVar4,
                                 (long)(int)uVar13,"p_variant","int(version->variants.size())","",
                                 false,false);
                      goto LAB_00101faa;
                    }
                    if (local_124 < uVar13) {
...
LAB_0010203d:
                      ...
                      while ((uVar17 != 0x2aeaa2ab || (*(long *)(plVar20[1] + uVar7 * 8) != 0))) {
                        ...
                        uVar17 = *(uint *)((long)plVar21 + uVar7 * 4);
                        if ((uVar17 == 0) ||
                           (((uVar13 + (int)uVar7) - uVar17 % uVar13) % uVar13 < uVar3))
                        goto LAB_0010203d;
                      }
...
LAB_00101fd9:
                    _err_print_index_error
                              ("_version_get_uniform","./drivers/gles3/shader_gles3.h",iVar2,uVar7,
                               lVar11,pcVar19,pcVar33,"",false,false);
                    lVar11 = (long)*(int *)(this + 0xd0);
                  }
                  else {
                    if (uVar7 != 0) {
                      if ((uint)uVar7 < *(uint *)(this + 0x54)) {
                        lVar12 = ((uVar7 & 0xffffffff) % (ulong)*(uint *)(this + 0x50)) * 0x80 +
                                 *(long *)(*(long *)(this + 0x40) +
                                          ((uVar7 & 0xffffffff) / (ulong)*(uint *)(this + 0x50)) * 8
                                          );
                        ...
                        if (iVar2 == (int)(uVar7 >> 0x20)) {
                          ...
                          if (uVar15 != 0) {
                            ...
                            while ((uVar15 != 0x2aeaa2ab ||
                                   (*(long *)(plVar21[1] + uVar23 * 8) != 0))) {
                              uVar17 = uVar17 + 1;
                              uVar23 = (ulong)((int)uVar23 + 1) % (ulong)uVar13;
                              uVar15 = *(uint *)(plVar21[2] + uVar23 * 4);
                              if ((uVar15 == 0) ||
                                 (((uVar13 + (int)uVar23) - uVar15 % uVar13) % uVar13 < uVar17))
                              goto LAB_00101f2d;
                            }
                              ...
                              if (*(int *)(this + 0xd0) < 4) {
                                _err_print_index_error
                                          ("_version_get_uniform","./drivers/gles3/shader_gles3.h",
                                           0xe4,3,lVar11,"p_which","uniform_count","",false,false);
LAB_00102177:
                                uVar14 = 0xffffffff;
                              }
                              else {
...
LAB_00102152:
                                ...
                                lVar11 = ((uVar7 & 0xffffffff) % (ulong)*(uint *)(this + 0x50)) *
                                         0x80 + *(long *)(*(long *)(this + 0x40) +
                                                         ((uVar7 & 0xffffffff) /
                                ...
                                if ((int)uVar13 <= (int)local_11c) {
                                  _err_print_index_error
                                            ("_version_get_uniform","./drivers/gles3/shader_gles3.h"
                                             ,0xe7,uVar4,(long)(int)uVar13,"p_variant",
...
LAB_0010253c:
                                ...
                                uVar17 = 0;
                                while ((uVar15 != 0x2aeaa2ab ||
                                       (*(long *)(plVar21[1] + uVar7 * 8) != 0))) {
                                  uVar17 = uVar17 + 1;
                                  uVar7 = (ulong)((int)uVar7 + 1) % (ulong)uVar13;
                                  uVar15 = *(uint *)(plVar21[2] + uVar7 * 4);
                                  if ((uVar15 == 0) ||
                                     (((uVar13 + (int)uVar7) - uVar15 % uVar13) % uVar13 < uVar17))
                                  goto LAB_0010253c;
                                }
...
LAB_00101f2d:
                        ...
                        if (iVar2 + 0x80000000U < 0x7fffffff) {
                          _err_print_error("get_or_null","./core/templates/rid_owner.h",0x103,
                                           "Method/function failed. Returning: nullptr",
                                           "Attempting to use an uninitialized RID",0,0,uVar23);
                        }
                      }
                    }
                    _err_print_error("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe6,
...
LAB_001015a2:
                  pcVar1 = _glad_glUniform1ui;
                  uVar7 = *(ulong *)(this + 0x130);
                  if ((int)lVar11 < 2) {
                    _err_print_index_error
                              ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe4,1,lVar11
...
LAB_0010230f:
                    ...
                    if (iVar2 != (int)(uVar7 >> 0x20)) {
                      if (iVar2 + 0x80000000U < 0x7fffffff) {
                        _err_print_error("get_or_null","./core/templates/rid_owner.h",0x103,
                                         "Method/function failed. Returning: nullptr",
                                         "Attempting to use an uninitialized RID",0,0,plVar21);
                      }
                      goto LAB_0010230f;
                    }
                    uVar13 = *(uint *)(lVar11 + 0x68);
                        ...
                        if (iVar10 < 2) {
                          _err_print_index_error
                                    ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe4,1,
                                     (long)iVar10,"p_which","uniform_count","",false,false);
LAB_00102375:
                          uVar14 = 0xffffffff;
                        }
                        else {
...
LAB_001024de:
                          ...
                          lVar11 = ((uVar7 & 0xffffffff) % (ulong)*(uint *)(this + 0x50)) * 0x80 +
                                   *(long *)(*(long *)(this + 0x40) +
                                            ((uVar7 & 0xffffffff) / (ulong)*(uint *)(this + 0x50)) *
                                            8);
                          if (iVar2 != *(int *)(lVar11 + 0x78)) {
                            if (*(int *)(lVar11 + 0x78) + 0x80000000U < 0x7fffffff) {
                              _err_print_error("get_or_null","./core/templates/rid_owner.h",0x103,
                          ...
                          if ((int)uVar13 <= (int)local_11c) {
                            _err_print_index_error
                                      ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xe7,
                                       uVar4,(long)(int)uVar13,"p_variant",
                                       "int(version->variants.size())","",false,false);
                            goto LAB_00102375;
                          }
                          if (uVar13 <= local_124) goto LAB_00101a50;
                          ...
                          if (*(int *)(lVar11 + 0x10) < 2) {
                            _err_print_index_error
                                      ("_version_get_uniform","./drivers/gles3/shader_gles3.h",0xea,
                                       1,(long)*(int *)(lVar11 + 0x10),"p_which",
                                       "int(spec->uniform_location.size())","",false,false);
                            goto LAB_00102375;
                          }
...
LAB_00101808:
                ...
                uVar7 = 0;
LAB_00100960:
                (*_glad_glFramebufferTexture2D)(0x8d40,0x8ce0,(int)uVar7 + 0x8515,param_2,param_6);
...
LAB_00101878:
                  ...
                  itos((long)&local_d0);
                  operator+((char *)&local_c8,(String *)"Could not bind sky radiance face: ");
                  String::operator+((String *)&local_b8,(String *)&local_c8);
                  String::operator+((String *)&local_a8,(String *)&local_b8);
                  _err_print_error("filter_radiance","drivers/gles3/effects/cubemap_filter.cpp",0xca
                                   ,(String *)&local_a8,0);
                  pcVar19 = local_a8;
                ...
                if (*(int *)(this + 0xd0) < 1) {
                  ...
                  if (uVar23 != 0) {
                    if ((uint)uVar23 < *(uint *)(this + 0x54)) {
                      lVar11 = ((uVar23 & 0xffffffff) % (ulong)*(uint *)(this + 0x50)) * 0x80 +
                               *(long *)(*(long *)(this + 0x40) +
                                        ((uVar23 & 0xffffffff) / (ulong)*(uint *)(this + 0x50)) * 8)
                      ;
                      iVar2 = *(int *)(lVar11 + 0x78);
                        ...
                        if ((int)local_11c < (int)uVar13) {
                          ...
                          if (uVar15 != 0) {
                            ...
                            while ((uVar15 != 0x2aeaa2ab || (*(long *)(plVar21[1] + uVar6 * 8) != 0)
                              ...
                              uVar15 = *(uint *)(plVar21[2] + uVar6 * 4);
                              if ((uVar15 == 0) ||
                                 (((uVar13 + (int)uVar6) - uVar15 % uVar13) % uVar13 < uVar17))
                              goto LAB_00101c70;
                            }
                            ...
                            if (lVar11 != 0) {
                              if (*(int *)(lVar11 + 0x10) < 1) {
                                _err_print_index_error
                                          ("_version_get_uniform","./drivers/gles3/shader_gles3.h",
                                           0xea,0,(long)*(int *)(lVar11 + 0x10),"p_which",
                                           "int(spec->uniform_location.size())","",false,false);
                                goto LAB_00100df0;
                              }
                              ...
                              if (*(int *)(this + 0xd0) < 1) {
                                _err_print_index_error
                                          ("_version_get_uniform","./drivers/gles3/shader_gles3.h",
                                           0xe4,0,(long)*(int *)(this + 0xd0),"p_which",
                                           "uniform_count","",false,false);
                                goto LAB_00101d38;
                              }
                              if ((uint)uVar23 < *(uint *)(this + 0x54)) {
                                lVar11 = ((uVar23 & 0xffffffff) % (ulong)*(uint *)(this + 0x50)) *
                                         0x80 + *(long *)(*(long *)(this + 0x40) +
                                                         ((uVar23 & 0xffffffff) /
                                                         (ulong)*(uint *)(this + 0x50)) * 8);
                                if (iVar2 == *(int *)(lVar11 + 0x78)) {
                                  ...
                                  if ((int)uVar13 <= (int)local_11c) {
                                    _err_print_index_error
                                              ("_version_get_uniform",
                                               "./drivers/gles3/shader_gles3.h",0xe7,uVar4,
                                               (long)(int)uVar13,"p_variant",
                                               "int(version->variants.size())","",false,false);
                                    goto LAB_00101d38;
                                  }
                                  if (uVar13 <= local_124) goto LAB_00101a50;
...
LAB_00101a76:
          _local_64 = auVar32;
          _err_print_index_error
                    ("operator[]","./core/templates/local_vector.h",0xb2,uVar4,uVar6,"p_index",
                     "count","",false,true);
          _err_flush_stdout();
                    /* WARNING: Does not return */
          pcVar1 = (code *)invalidInstructionException();
  ...
  _err_print_index_error
            ("_version_bind_shader","./drivers/gles3/shader_gles3.h",0xbb,(ulong)local_124,
             (long)*(int *)(this + 0x120),"p_variant","variant_count","",false,false);
  goto LAB_00100e95;
LAB_00100da9:
  if ((uVar15 != 0x2aeaa2ab) || (*(long *)(plVar21[1] + uVar23 * 8) != 0)) {
    uVar17 = uVar17 + 1;
    uVar23 = (ulong)((int)uVar23 + 1) % (ulong)uVar13;
    uVar15 = *(uint *)(plVar21[2] + uVar23 * 4);
    if ((uVar15 == 0) || (((uVar13 + (int)uVar23) - uVar15 % uVar13) % uVar13 < uVar17))
    goto LAB_00101e70;
    goto LAB_00100da9;
  }
  lVar11 = *plVar21 + uVar23 * 0x38;
...
LAB_00101d38:
  uVar14 = 0xffffffff;
LAB_00100deb:
  (*pcVar1)(uVar14,uVar7 & 0xffffffff);
LAB_00100df0:
  uVar7 = uVar7 + 1;
...
LAB_00101990:
  ...
  uVar17 = *(uint *)(plVar20[2] + uVar23 * 4);
  if ((uVar17 == 0) || (((uVar15 + (int)uVar23) - uVar17 % uVar15) % uVar15 < uVar3))
  goto LAB_00100e6d;
  goto LAB_001019c9;
  while( true ) {
    uVar3 = uVar3 + 1;
    ...
    uVar17 = *(uint *)(lVar11 + uVar7 * 4);
    if ((uVar17 == 0) ||
       (uVar16 = uVar15 + (int)uVar7, uVar18 = (ulong)uVar16,
       (uVar16 - uVar17 % uVar15) % uVar15 < uVar3)) break;
LAB_00100913:
    if ((uVar17 == (uint)uVar23) && (*(long *)(this + 0x110) == *(long *)(plVar20[1] + uVar7 * 8)))
    {
...
/* CubemapFilterShaderGLES3::~CubemapFilterShaderGLES3() */

void __thiscall CubemapFilterShaderGLES3::~CubemapFilterShaderGLES3(CubemapFilterShaderGLES3 *this)
...
/* CubemapFilterShaderGLES3::_init() */

void __thiscall CubemapFilterShaderGLES3::_init(CubemapFilterShaderGLES3 *this)

{
  ShaderGLES3::_setup((char *)this,
                      ...
                      ,0x102675,(char **)0x4,0x103f20,(UBOPair *)0x0,(int)_init()::_ubo_pairs,
                      (Feedback *)0x0,(int)_init()::_feedbacks,(TexUnitPair *)0x1,0x103ef0,
                      (Specialization *)0x0,(int)_init()::_spec_pairs,(char **)0x2);
  return;
}

...
/* JPH::MotionProperties::SetMassProperties(JPH::EAllowedDOFs, JPH::MassProperties const&) */

void __thiscall
JPH::MotionProperties::SetMassProperties
          (MotionProperties *this,MotionProperties param_2,Mat44 *param_3)

{
  ...
  *(float *)(this + 0x58) = fVar2;
  ...
  uVar6 = __LC1;
  if ((cVar1 == '\0') ||
     (fStack_60 * fStack_60 + local_68 * local_68 + 0.0 + fStack_64 * fStack_64 <= _LC3)) {
...
LAB_00100218:
      fVar2 = (local_30 - (local_58 + local_44)) + _LC2;
      if (fVar2 < 0.0) {
        fVar2 = sqrtf(fVar2);
      }
      else {
...
/* JPH::MotionProperties::SaveState(JPH::StateRecorder&) const */

void __thiscall JPH::MotionProperties::SaveState(MotionProperties *this,StateRecorder *param_1)
...
/* JPH::MotionProperties::RestoreState(JPH::StateRecorder&) */

void __thiscall JPH::MotionProperties::RestoreState(MotionProperties *this,StateRecorder *param_1)
...
void JPH::MotionProperties::_GLOBAL__sub_I_SetMassProperties(void)

              ...
              if (bVar12 != 4) {
                if (bVar12 != 3) {
                  *(ushort *)puVar13 = uVar7 << 8 | uVar7 >> 8;
                  ...
                  goto joined_r0x001025b7;
                }
                *(char *)puVar13 = (char)(uVar9 >> 0x10);
                *(ushort *)((long)puVar13 + 1) = uVar7 << 8 | uVar7 >> 8;
                if (uVar9 < 0x1000000) goto joined_r0x001025c4;
                goto LAB_001025b9;
              }
...
LAB_00102791:
      ...
      *(undefined4 *)(puVar2 + 1) = *(undefined4 *)(puVar9 + 1);
      ...
      if (-1 < (int)uVar4) {
        uVar10 = uVar4;
        if (uVar7 <= uVar4) goto LAB_0010278d;
        do {
...
LAB_00102832:
        ...
        if (pvVar5 == (void *)0x0) {
          uVar4 = *(uint *)(lVar3 + 0x20);
          if (uVar4 < uVar10) goto LAB_00102832;
...
LAB_00102d17:
    ...
    if (param_1 == 0) {
      ...
      if ((param_1 >> 1) + param_1 < *(uint *)(this + 0x1c)) goto LAB_00102c8b;
    ...
    if (uVar12 == 0) {
      pvVar8 = malloc(0x10);
      if (pvVar8 == (void *)0x0) goto LAB_00102d12;
      iVar16 = 0;
      sVar20 = 0;
      iVar9 = 0x10;
      __size = 0x10;
...
LAB_00102d12:
      ...
      if (iVar9 != 0) goto LAB_00102906;
    }
    uStack_c0 = _UNK_001032a8;
    uStack_c8 = __LC0;
    iVar9 = *(int *)(this + 0x1c);
    ...
    *(int *)(this + 0x1c) = iVar16;
    ...
    uStack_b8 = __LC1;
    uStack_b0 = _UNK_001032b8;
    uStack_a8 = __LC2;
    uStack_a0 = _UNK_001032c8;
    uStack_98 = __LC3;
    uStack_90 = _UNK_001032d8;
    uStack_88 = __LC4;
    uStack_80 = _UNK_001032e8;
    uStack_78 = __LC5;
    uStack_70 = _UNK_001032f8;
    uStack_68 = __LC6;
    uStack_60 = _UNK_00103308;
    uStack_58 = __LC7;
    uStack_50 = _UNK_00103318;
    if ((int)uVar13 == 0x20) {
      uVar10 = 0x7fffffff;
    }
    else {
                ...
                if (uVar11 == puVar4[1] - (long)*puVar4) {
                  ...
                  if ((iVar16 == iVar2) &&
                    ...
                    if ((iVar2 * 0xc == iVar16 * 0xc) &&
                      ...
                      if ((int)uVar21 == -1) goto LAB_00102bb0;
                      goto LAB_00102ba6;
                    }
                  }
                }
...
LAB_00102bb0:
              if ((*(byte *)(plVar14 + 1) & 2) == 0) goto LAB_00102c68;
...
LAB_001030ce:
    ...
    if (param_1 == 0) {
      ...
      if ((param_1 >> 1) + param_1 < *(uint *)(this + 0x1c)) goto LAB_0010302d;
      if (param_1 < *(uint *)(this + 0x14)) {
        param_1 = *(uint *)(this + 0x14);
      }
    }
    ...
    if (uVar16 == 0) {
      pvVar6 = malloc(0x18);
      if (pvVar6 == (void *)0x0) goto LAB_001030ca;
      iVar19 = 0;
      sVar20 = 0;
      iVar9 = 0x18;
      __size = 0x18;
        ...
        if (((*(byte *)(piVar17 + 1) & 1) != 0) &&
          ...
          if ((bVar1 & 2) == 0) {
            ...
            *(int *)(this + 0x14) = iVar9 + 1;
            ...
            do {
              if (*piVar8 == iVar19) {
                if (uVar14 == 0xffffffff) goto LAB_00102f7f;
                goto LAB_00102f74;
              }
              if (((bVar1 & 1) == 0) && (uVar14 == 0xffffffff)) {
                uVar14 = (uint)uVar11;
...
LAB_00102f7f:
              ...
              if ((*(byte *)(piVar8 + 1) & 2) == 0) goto LAB_0010306d;

...
int hash_mprime(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
      ...
      if (param_2 != 0) {
        do {
          while( true ) {
            ...
            if ((((local_ac != 0) ||
                 (local_ac = mbedtls_md_update(local_a8,param_3,param_4), local_ac != 0)) ||
                (local_ac = mbedtls_md_update(local_a8,&local_8c,4), local_ac != 0)) ||
               (local_ac = mbedtls_md_finish(local_a8,local_88), local_ac != 0)) goto LAB_001001d9;
            uVar4 = 0;
            if (uVar5 != 0) break;
...

{
  ...
  if (param_2 == 0) {
    ...
    iVar3 = mbedtls_mpi_cmp_int(param_1 + 0x60,0);
    if (iVar3 < 1) {
      return 0xffffbf80;
    }
    iVar3 = mbedtls_mpi_cmp_int(param_1 + 0x70,0);
    if (iVar3 < 1) {
      return 0xffffbf80;
    }
    iVar3 = mbedtls_mpi_cmp_int(param_1 + 0x80,0);
  }
  if (iVar3 < 1) {
    return 0xffffbf80;
  }
...
rsa_rsassa_pkcs1_v15_encode
          (int param_1,uint param_2,undefined8 *param_3,ulong param_4,undefined2 *param_5)

{
  ...
  if (param_1 == 0) {
    ...
    if ((((bVar2 != 0) &&
         (iVar3 = mbedtls_oid_get_oid_by_md(param_1,&local_48,&local_50), iVar3 == 0)) &&
        (bVar2 == param_2)) && ((param_2 + 8) + local_50 < 0x80)) {
      uVar6 = local_50 + (param_2 + 10);
      if (((uVar6 <= param_4) && (!CARRY8(local_50,(ulong)(param_2 + 10)))) &&
         (uVar6 = param_4 - uVar6, 10 < uVar6)) {
        *param_5 = 0x100;
        ...
        *(char *)((long)puVar11 + 3) = (char)param_2;
        if (param_2 < 8) {
          if ((param_2 & 4) == 0) {
            if ((param_2 != 0) &&
               (*(undefined1 *)(puVar11 + 2) = *(undefined1 *)param_3, (param_2 & 2) != 0)) {
...
LAB_001006a9:
            mbedtls_platform_zeroize(param_5,param_4);
            goto LAB_0010051d;
          }
        }
        else {
          *(undefined8 *)(puVar11 + 2) = *param_3;
          *(undefined8 *)((long)puVar11 + (uVar6 - 4)) =
               *(undefined8 *)((long)param_3 + (uVar6 - 8));
...
joined_r0x00100a8b:
  ...
  if (((iVar11 != 0 && iVar12 != 0) && (iVar13 != 0)) ||
     (iVar6 = mbedtls_rsa_deduce_crt(lVar2,lVar3,lVar4,param_1 + 0x60,param_1 + 0x70,param_1 + 0x80)
     , iVar6 == 0)) {
    uVar15 = 1;
LAB_00100a38:
    uVar14 = rsa_check_context_isra_0(param_1,uVar15);
    return uVar14;
  }
LAB_00100a91:
...
mbedtls_rsa_export_raw
          ...
          ,undefined8 param_7,long param_8,undefined8 param_9,long param_10,undefined8 param_11)

{
  ...
  if (iVar2 == 0) {
LAB_00100bd6:
    if ((param_8 != 0 || param_6 != 0) || param_4 != 0) {
      return 0xffffbf80;
    }
    ...
    if ((iVar2 == 0) || (iVar2 = mbedtls_mpi_cmp_int(param_1 + 0x20,0), iVar2 == 0))
    goto LAB_00100bd6;
    ...
    if ((param_4 != 0) &&
       (uVar3 = mbedtls_mpi_write_binary(param_1 + 0x40,param_4,param_5), (int)uVar3 != 0)) {
      return uVar3;
    }
    if ((param_6 != 0) &&
       (uVar3 = mbedtls_mpi_write_binary(param_1 + 0x50,param_6,param_7), (int)uVar3 != 0)) {
      return uVar3;
    }
...
undefined8
mbedtls_rsa_export(long param_1,long param_2,long param_3,long param_4,long param_5,long param_6)
...
LAB_00100ef3:
  ...
  iVar1 = iVar2;
  if ((-1 < iVar2) && (iVar1 = mbedtls_asn1_write_tag(param_3,param_2,0x30), -1 < iVar1)) {
...

{
  ...
  if ((((iVar1 == 0) || (iVar1 = mbedtls_mpi_cmp_int(param_1 + 0x40,0), iVar1 == 0)) ||
      (iVar1 = mbedtls_mpi_cmp_int(param_1 + 0x50,0), iVar1 == 0)) ||
     ((iVar1 = mbedtls_mpi_cmp_int(param_1 + 0x30,0), iVar1 == 0 ||
      (iVar1 = mbedtls_mpi_cmp_int(param_1 + 0x20,0), iVar1 == 0)))) {
    return -0x4080;
  }
  if ((((param_2 == 0) || (iVar1 = mbedtls_mpi_copy(param_2,param_1 + 0x60), iVar1 == 0)) &&
      ((param_3 == 0 || (iVar1 = mbedtls_mpi_copy(param_3,param_1 + 0x70), iVar1 == 0)))) &&
     ((param_4 == 0 || (iVar1 = mbedtls_mpi_copy(param_4,param_1 + 0x80), iVar1 == 0)))) {
    return 0;
  }
  return iVar1 + -0x4080;
}
...

{
  ...
  *param_1 = 0;
  ...
  for (uVar1 = (ulong)(((int)param_1 -
                       (int)(undefined8 *)((ulong)(param_1 + 1) & 0xfffffffffffffff8)) + 0xe8U >> 3)
...

{
  ...
  if (((param_3 != 0) && ((param_2 & 1) != 0)) &&
     (lVar1 = mbedtls_md_info_from_type(param_3), lVar1 == 0)) {
    return 0xffffbf00;
  }
  ...
  if (iVar1 == 0) {
    ...
    if (0x7f < uVar2) {
      ...
      if (((iVar1 != 0) && (uVar2 = mbedtls_mpi_bitlen(lVar3), 1 < uVar2)) &&
         (iVar1 = mbedtls_mpi_cmp_mpi(lVar3,param_1 + 0x10), iVar1 < 0)) {
        return 0;
      }
    }
  }
...

{
  ...
  if (param_3 == local_38 + local_40) {
    ...
    if (((local_40 == 0) || (iVar1 = mbedtls_mpi_read_binary(param_1 + 0x20), iVar1 == 0)) ||
      ...
      if ((iVar1 == 0) && (iVar1 = mbedtls_rsa_check_pubkey(param_1), iVar1 == 0)) {
        uVar2 = 0;
        if (local_40 != param_3) {
          uVar2 = 0xffffff9a;
        }
...
LAB_001019e7:
          ...
          if (((iVar1 == 0) || (iVar1 = iVar1 + -0x4080, iVar1 == 0)) &&
             (iVar1 = mbedtls_asn1_get_mpi(&local_50,param_3,local_48), iVar1 == 0)) {
            iVar1 = mbedtls_mpi_cmp_int(local_48,0);
                  ...
                  if ((iVar1 == 0) &&
                    ...
                    if ((iVar1 == 0) &&
                      ...
                      if (((iVar1 == 0) && (iVar1 = mbedtls_rsa_complete(param_1), iVar1 == 0)) &&
                         (iVar1 = mbedtls_rsa_check_pubkey(param_1), iVar1 == 0)) {
                        if (local_50 == param_3) {
...

{
  ...
  if ((iVar1 == 0) && (iVar1 = rsa_check_context_isra_0(param_1,1), iVar1 == 0)) {
    iVar1 = mbedtls_rsa_validate_params
                      (param_1 + 0x10,param_1 + 0x40,param_1 + 0x50,param_1 + 0x30,param_1 + 0x20,0,
                       0);
    if ((iVar1 == 0) &&
       (uVar2 = mbedtls_rsa_validate_crt
                          (param_1 + 0x40,param_1 + 0x50,param_1 + 0x30,param_1 + 0x60,
                           param_1 + 0x70,param_1 + 0x80), (int)uVar2 == 0)) {
      return uVar2;
    }
  }
  return 0xffffbe00;
...

{
  ...
  if (((param_5 < 3) || ((param_4 & 1) != 0)) || (uVar10 = (uint)param_4, uVar10 < 0x400)) {
  ...
  if (iVar6 == 0) {
    ...
    do {
      do {
        do {
          ...
          if (((iVar6 != 0) ||
              (iVar6 = mbedtls_mpi_gen_prime(lVar2,uVar7,cVar5,param_2,param_3), iVar6 != 0)) ||
             (iVar6 = mbedtls_mpi_sub_mpi(local_78,lVar3,lVar2), iVar6 != 0)) goto LAB_00101d93;
        ...
        if (((iVar6 != 0) || (iVar6 = mbedtls_mpi_sub_int(lVar2,lVar2,1), iVar6 != 0)) ||
           ((iVar6 = mbedtls_mpi_mul_mpi(local_78,lVar3,lVar2), iVar6 != 0 ||
            (iVar6 = mbedtls_mpi_gcd(local_68,lVar1,local_78), iVar6 != 0)))) goto LAB_00101d93;
        iVar6 = mbedtls_mpi_cmp_int(local_68,1);
      } while (iVar6 != 0);
      iVar6 = mbedtls_mpi_gcd(local_68,lVar3,lVar2);
      if ((iVar6 != 0) || (iVar6 = mbedtls_mpi_div_mpi(local_58,0,local_78,local_68), iVar6 != 0))
      goto LAB_00101d93;
      lVar4 = param_1 + 0x30;
    ...
    if ((iVar6 != 0) || (iVar6 = mbedtls_mpi_add_int(lVar2,lVar2,1), iVar6 != 0)) goto LAB_00101d93;
...
LAB_00101d93:
    ...
    mbedtls_mpi_free(local_58);
LAB_00101dae:
    if (param_1 != 0) goto LAB_00101e12;
  }
  if ((uint)-iVar6 < 0x80) {
    iVar6 = iVar6 + -0x4180;
  }
...

{
  ...
  iVar1 = mbedtls_rsa_check_pubkey();
  if ((((iVar1 == 0) && (iVar1 = mbedtls_rsa_check_privkey(param_2), iVar1 == 0)) &&
      (iVar1 = mbedtls_mpi_cmp_mpi(param_1 + 0x10,param_2 + 0x10), iVar1 == 0)) &&
     (uVar2 = mbedtls_mpi_cmp_mpi(param_1 + 0x20,param_2 + 0x20), (int)uVar2 == 0)) {
    return uVar2;
  }
  return 0xffffbe00;
}
...

{
  ...
  if (iVar2 == 0) {
    ...
    iVar2 = mbedtls_mpi_exp_mod_unsafe
                      (local_48,local_48,param_1 + 0x20,param_1 + 0x10,param_1 + 0x90);
    if (iVar2 == 0) {
...
int mbedtls_rsa_private(long param_1,long param_2,undefined8 param_3,undefined8 param_4,
                       undefined8 param_5)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if ((param_2 == 0) || (iVar4 = rsa_check_context_isra_0(param_1,1), iVar4 != 0)) {
    iVar4 = -0x4080;
    goto LAB_00102192;
  }
  ...
  if (*(long *)(param_1 + 0xd0) == 0) {
    ...
    while( true ) {
      ...
      if ((iVar4 != 0) ||
         (iVar4 = mbedtls_mpi_fill_random(local_58,*(long *)(param_1 + 8) + -1,param_2,param_3),
         iVar4 != 0)) break;
      lVar3 = param_1 + 0xc0;
      iVar4 = mbedtls_mpi_mul_mpi(lVar3,param_1 + 0xd0,local_58);
      if ((iVar4 != 0) || (iVar4 = mbedtls_mpi_mod_mpi(lVar3,lVar3,lVar1), iVar4 != 0)) break;
      iVar4 = mbedtls_mpi_inv_mod(lVar3,lVar3,lVar1);
      if (iVar4 == 0) {
        iVar4 = mbedtls_mpi_mul_mpi(lVar3,lVar3,local_58);
        if ((iVar4 != 0) || (iVar4 = mbedtls_mpi_mod_mpi(lVar3,lVar3,lVar1), iVar4 != 0))
        goto LAB_00102774;
...
joined_r0x001023ce:
        ...
        if (((iVar4 == 0) && (iVar4 = mbedtls_mpi_mod_mpi(local_108,local_108,lVar1), iVar4 == 0))
           && (iVar4 = mbedtls_mpi_copy(local_88,local_108), iVar4 == 0)) {
          lVar3 = param_1 + 0x40;
          ...
          if (iVar4 == 0) {
            ...
            if (((((iVar4 == 0) &&
                  (iVar4 = mbedtls_mpi_fill_random(local_d8,0x1c,param_2,param_3), iVar4 == 0)) &&
                 ((iVar4 = mbedtls_mpi_mul_mpi(local_a8,local_f8,local_d8), iVar4 == 0 &&
                  ((iVar4 = mbedtls_mpi_add_mpi(local_a8,local_a8,param_1 + 0x60), iVar4 == 0 &&
                   (iVar4 = mbedtls_mpi_fill_random(local_d8,0x1c,param_2,param_3), iVar4 == 0))))))
                && ((iVar4 = mbedtls_mpi_mul_mpi(local_98,local_e8,local_d8), iVar4 == 0 &&
                    ((((iVar4 = mbedtls_mpi_add_mpi(local_98,local_98,param_1 + 0x70), iVar4 == 0 &&
                       (iVar4 = mbedtls_mpi_exp_mod(local_c8,local_108,local_a8,lVar3,param_1 + 0xa0
                                                   ), iVar4 == 0)) &&
                      (iVar4 = mbedtls_mpi_exp_mod(local_b8,local_108,local_98,lVar2,param_1 + 0xb0)
                      , iVar4 == 0)) &&
                     ((iVar4 = mbedtls_mpi_sub_mpi(local_108,local_c8,local_b8), iVar4 == 0 &&
                      (iVar4 = mbedtls_mpi_mul_mpi(local_c8,local_108,param_1 + 0x80), iVar4 == 0)))
                     ))))) &&
               (((iVar4 = mbedtls_mpi_mod_mpi(local_108,local_c8,lVar3), iVar4 == 0 &&
                 ((iVar4 = mbedtls_mpi_mul_mpi(local_c8,local_108,lVar2), iVar4 == 0 &&
                  (iVar4 = mbedtls_mpi_add_mpi(local_108,local_b8,local_c8), iVar4 == 0)))) &&
                (iVar4 = mbedtls_mpi_exp_mod(local_78,local_108,param_1 + 0x20,lVar1,param_1 + 0x90)
                , iVar4 == 0)))) {
              ...
              if (((((int)uVar6 == 0) &&
                   (uVar6 = mbedtls_mpi_grow(local_58,uVar8 * 2 + 1), (int)uVar6 == 0)) &&
                  (uVar6 = mbedtls_mpi_grow(local_108,uVar8), (int)uVar6 == 0)) &&
                 (uVar6 = mbedtls_mpi_grow(local_110,uVar8), (int)uVar6 == 0)) {
                mbedtls_mpi_core_to_mont_rep
                          (local_108[0],local_108[0],*(undefined8 *)(param_1 + 0x10),uVar8,uVar5,
                           local_68[0],local_58[0],uVar6);
                mbedtls_mpi_core_montmul
                          (local_108[0],local_108[0],*(undefined8 *)(param_1 + 0xd0),uVar8,
                           *(undefined8 *)(param_1 + 0x10),uVar8,uVar5,local_58[0]);
                mbedtls_mpi_free(local_68);
                mbedtls_mpi_free(local_58);
...
ulong rsa_rsassa_pss_sign_no_mode_check
                (long param_1,code *param_2,undefined8 param_3,int param_4,uint param_5,long param_6
...
ulong mbedtls_rsa_rsaes_oaep_encrypt
                (long param_1,code *param_2,undefined8 param_3,undefined8 param_4,undefined8 param_5
                ,ulong param_6,void *param_7,undefined1 *param_8)
      ...
      if ((param_6 <= uVar7) && (uVar7 <= __n)) {
        ...
        *param_8 = 0;
        ...
        if (lVar6 != 0) {
          ...
          if (param_6 != 0) {
            memcpy(puVar2 + (((uVar8 - 2) + (__n - param_6)) - (ulong)((uint)bVar3 + (uint)bVar3)) +
                   1,param_7,param_6);
          }
          lVar6 = (__n - 1) - uVar8;
...
ulong mbedtls_rsa_rsaes_pkcs1_v15_encrypt
                (long param_1,code *param_2,undefined8 param_3,ulong param_4,void *param_5,
                undefined1 *param_6)
...
LAB_00102d00:
  uVar4 = mbedtls_rsa_public(param_1,param_6,param_6);
  return uVar4;
}
...
int mbedtls_rsa_rsaes_oaep_decrypt
              ...
              undefined8 param_5,ulong *param_6,undefined8 param_7,void *param_8,ulong param_9)

{
  ...
  if (*(int *)(param_1 + 0xe0) == 1) {
    ...
    if (uVar12 - 0x10 < 0x3f1) {
      ...
      uVar11 = (ulong)bVar2;
      if ((bVar2 != 0) && (uVar3 = bVar2 + 2 + (uint)bVar2, uVar3 <= uVar12)) {
        ...
        if (iVar4 == 0) {
          ...
          iVar4 = mgf_mask(pbVar7,uVar11,abStack_449 + uVar11 + 2,lVar10,
                           *(undefined4 *)(param_1 + 0xe4));
          if (iVar4 == 0) {
            iVar4 = mgf_mask(abStack_449 + uVar11 + 2,lVar10,pbVar7,uVar11,
                             *(undefined4 *)(param_1 + 0xe4));
            if (iVar4 == 0) {
              ...
              if (lVar10 == 0) {
                ...
                if (iVar4 == 0) {
                  ...
                  if ((long)(-(long)iVar5 | (long)iVar5 |
                             -(ulong)abStack_449[1] | (ulong)abStack_449[1] |
                            -((ulong)*pbVar7 ^ 1) | (ulong)*pbVar7 ^ 1) < 0) {
                    iVar4 = -0x4100;
                  }
                  else {
...

{
  ...
  if ((*(int *)(param_1 + 0xe0) == 0) && (lVar12 - 0x10U < 0x3f1)) {
    ...
    if (iVar4 == 0) {
      ...
      uVar11 = (long)(-(ulong)local_448[0] | (ulong)local_448[0] |
                     -((ulong)local_448[1] ^ 2) | (ulong)local_448[1] ^ 2) >> 0x3f | ~uVar6 |
               (long)(uVar10 - 8 & ~(uVar10 ^ 8) | (uVar10 ^ 8) & 8) >> 0x3f;
      uVar2 = (uint)uVar7;
      uVar3 = (uint)uVar11;
        ...
        if (uVar2 < 8) {
          if ((uVar7 & 4) == 0) {
            if ((uVar2 != 0) && (*param_6 = *pbVar8, (uVar7 & 2) != 0)) {
              *(undefined2 *)(param_6 + ((uVar7 & 0xffffffff) - 2)) =
                   *(undefined2 *)(local_448 + (uVar7 & 0xffffffff) + lVar12 + -2);
            }
          }
          else {
            *(undefined4 *)param_6 = *(undefined4 *)pbVar8;
            *(undefined4 *)(param_6 + ((uVar7 & 0xffffffff) - 4)) =
                 *(undefined4 *)(local_448 + (uVar7 & 0xffffffff) + lVar12 + -4);
          }
        }
        else {
          *(undefined8 *)param_6 = *(undefined8 *)pbVar8;
          *(undefined8 *)(param_6 + ((uVar7 & 0xffffffff) - 8)) =
               *(undefined8 *)(local_448 + (uVar7 & 0xffffffff) + lVar12 + -8);
...
undefined8
mbedtls_rsa_rsassa_pss_sign_ext(long param_1,undefined8 param_2,undefined8 param_3,int param_4)
...
undefined8
mbedtls_rsa_rsassa_pss_sign(long param_1,undefined8 param_2,undefined8 param_3,int param_4)
...

{
  ...
  if (((param_4 == 0 && param_5 == 0) || (param_6 != 0)) && (*(int *)(param_1 + 0xe0) == 0)) {
    iVar1 = rsa_rsassa_pkcs1_v15_encode
                      (param_4,param_5,param_6,*(undefined8 *)(param_1 + 8),param_7);
    if (iVar1 == 0) {
      ...
      if (__ptr != (void *)0x0) {
        ...
        if (pvVar2 != (void *)0x0) {
          ...
          if ((iVar1 == 0) && (iVar1 = mbedtls_rsa_public(param_1,__ptr,pvVar2), iVar1 == 0)) {
...
mbedtls_rsa_pkcs1_sign
          (long param_1,undefined8 param_2,undefined8 param_3,int param_4,int param_5,long param_6)
...
int mbedtls_rsa_rsassa_pss_verify_ext
              (long param_1,int param_2,uint param_3,long param_4,undefined4 param_5,int param_6,
              undefined8 param_7)

{
  ...
  if (((param_2 == 0 && param_3 == 0) || (param_4 != 0)) &&
     (uVar9 = *(ulong *)(param_1 + 8), uVar9 - 0x10 < 0x3f1)) {
...
int mbedtls_rsa_rsassa_pkcs1_v15_verify
              (long param_1,int param_2,int param_3,long param_4,undefined8 param_5)

{
  ...
  if (pvVar2 != (void *)0x0) {
    ...
    if (pvVar3 != (void *)0x0) {
      ...
      if ((iVar1 == 0) && (iVar1 = mbedtls_rsa_public(param_1,param_5,pvVar2), iVar1 == 0)) {
...

{
  ...
  *(undefined8 *)(param_1 + 8) = *(undefined8 *)(param_2 + 8);
  ...
  if (((((iVar1 == 0) && (iVar1 = mbedtls_mpi_copy(param_1 + 0x20,param_2 + 0x20), iVar1 == 0)) &&
       (iVar1 = mbedtls_mpi_copy(param_1 + 0x30,param_2 + 0x30), iVar1 == 0)) &&
      (((iVar1 = mbedtls_mpi_copy(param_1 + 0x40,param_2 + 0x40), iVar1 == 0 &&
        (iVar1 = mbedtls_mpi_copy(param_1 + 0x50,param_2 + 0x50), iVar1 == 0)) &&
       ((iVar1 = mbedtls_mpi_copy(param_1 + 0x60,param_2 + 0x60), iVar1 == 0 &&
        ((iVar1 = mbedtls_mpi_copy(param_1 + 0x70,param_2 + 0x70), iVar1 == 0 &&
         (iVar1 = mbedtls_mpi_copy(param_1 + 0x80,param_2 + 0x80), iVar1 == 0)))))))) &&
     ((iVar1 = mbedtls_mpi_copy(param_1 + 0xa0,param_2 + 0xa0), iVar1 == 0 &&
      ((((iVar1 = mbedtls_mpi_copy(param_1 + 0xb0,param_2 + 0xb0), iVar1 == 0 &&
         (iVar1 = mbedtls_mpi_copy(param_1 + 0x90,param_2 + 0x90), iVar1 == 0)) &&
        (iVar1 = mbedtls_mpi_copy(param_1 + 0xc0,param_2 + 0xc0), iVar1 == 0)) &&
       (iVar1 = mbedtls_mpi_copy(param_1 + 0xd0,param_2 + 0xd0), iVar1 == 0)))))) {
...
void mbedtls_rsa_free(long param_1)
...
int mbedtls_rsa_self_test(int param_1)

{
  ...
  if (iVar1 == 0) {
    ...
    if ((((iVar1 == 0) &&
         ((((iVar1 = mbedtls_mpi_copy(local_1d8,local_228), iVar1 == 0 ||
          ...
          ((iVar1 = mbedtls_mpi_copy(local_1c8,local_228), iVar1 == 0 ||
           (iVar1 = iVar1 + -0x4080, iVar1 == 0)))))) &&
        (iVar1 = mbedtls_mpi_read_string
                           (local_228,0x10,
       ...
       (((iVar1 = mbedtls_mpi_copy(local_1e8,local_228), iVar1 == 0 ||
         (iVar1 = iVar1 + -0x4080, iVar1 == 0)) &&
        ((iVar1 = mbedtls_mpi_read_string(local_228,0x10,"10001"), iVar1 == 0 &&
         (((iVar1 = mbedtls_mpi_copy(local_1f8,local_228), iVar1 == 0 ||
           (iVar1 = iVar1 + -0x4080, iVar1 == 0)) &&
          (iVar1 = mbedtls_rsa_complete(&local_218), iVar1 == 0)))))))) {
      if (param_1 == 0) {
        iVar2 = mbedtls_rsa_check_pubkey(&local_218);
        if ((iVar2 == 0) && (iVar2 = mbedtls_rsa_check_privkey(&local_218), iVar2 == 0)) {
          ...
          if ((int)uVar3 == 0) {
            puVar7 = local_e8;
            iVar2 = mbedtls_rsa_pkcs1_decrypt
                              (&local_218,myrand,0,&local_230,local_c8,local_e8,0x18,uVar3);
            if ((iVar2 == 0) && (iVar2 = memcmp(local_e8,&local_108,local_230), iVar2 == 0)) {
...
LAB_00103f04:
              ...
              if ((iVar2 == 0) &&
                 (iVar2 = mbedtls_rsa_pkcs1_verify(&local_218,5,0x14,local_128,local_c8), iVar2 == 0
                 )) goto LAB_00103cb5;
            }
          }
        }
        ...
        if ((iVar2 == 0) && (iVar2 = mbedtls_rsa_check_privkey(&local_218), iVar2 == 0)) {
          ...
          if (iVar2 == 0) {
            ...
            __printf_chk(2);
            iVar2 = mbedtls_rsa_pkcs1_decrypt
                              (&local_218,myrand,0,&local_230,local_c8,local_e8,0x18,pcVar5);
            if ((iVar2 == 0) && (iVar2 = memcmp(local_e8,puVar6,local_230), iVar2 == 0)) {
              puts("passed");

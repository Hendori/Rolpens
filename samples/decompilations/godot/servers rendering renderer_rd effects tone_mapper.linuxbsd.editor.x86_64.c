...
void __thiscall RendererRD::ToneMapper::~ToneMapper(ToneMapper *this)
  ...
  do {
    ...
    if (cVar5 == '\0') {
      ...
      if (iVar6 == 0) {
        ...
        _err_print_index_error
                  ("set","./core/templates/cowdata.h",0xcf,lVar14,lVar16,"p_index","size()","",false
                   ,false);
      }
      else {
        _err_print_error("push_back","./core/templates/vector.h",0x142,
...
LAB_001014f0:
          ...
          lVar16 = ((uVar2 & 0xffffffff) % (ulong)*(uint *)(this + 0x130)) * 0xa0 +
                   *(long *)(*(long *)(this + 0x120) +
                            ((uVar2 & 0xffffffff) / (ulong)*(uint *)(this + 0x130)) * 8);
...
LAB_0010100c:
      PipelineCacheRD::setup(pPVar13,uVar7,5);
...
/* RendererRD::ToneMapper::tonemapper(RID, RID, RendererRD::ToneMapper::TonemapSettings const&) */

void __thiscall
RendererRD::ToneMapper::tonemapper
          (ToneMapper *this,undefined8 param_2,undefined8 param_3,byte *param_4)
...
LAB_001025a3:
      _err_print_error("tonemapper","servers/rendering/renderer_rd/effects/tone_mapper.cpp",uVar18,
                       pcVar25,0,0);
      return;
    }
    goto LAB_00102717;
  ...
  *(undefined8 *)(this + 0x58) = 0;
  ...
  for (uVar23 = (ulong)((uVar11 - (int)(undefined8 *)((ulong)(this + 8) & 0xfffffffffffffff8)) +
...
LAB_00101cbc:
        _err_print_index_error
                  ("set","./core/templates/cowdata.h",0xcf,lVar27,lVar17,"p_index","size()","",false
                   ,false);
      }
      else {
...
LAB_001025f5:
    _err_print_index_error
              ("version_get_shader","./servers/rendering/renderer_rd/shader_rd.h",0xa6,uVar29,lVar16
               ,"p_variant","variant_defines.size()","",false,false);
LAB_00101b3f:
    _err_print_error("tonemapper","servers/rendering/renderer_rd/effects/tone_mapper.cpp",0xa7,
...
LAB_00102018:
      _err_print_index_error
                ("get","./core/templates/cowdata.h",0xdb,uVar24,lVar21,"p_index","size()","",false,
                 true);
      _err_flush_stdout();
                    /* WARNING: Does not return */
...
LAB_00101fcd:
    ...
    if (*(long *)(pTVar3 + 0x40) == 0) {
      ...
      while( true ) {
        ...
        local_88 = uVar23 << 8;
        do {
        } while (*pTVar3 != (ToneMapper)0x0);
      }
      if (*(uint *)(this + uVar29 * 0x138 + 0x310) != 0) {
        plVar22 = *(long **)(this + uVar29 * 0x138 + 0x308);
        plVar1 = plVar22 + (ulong)*(uint *)(this + uVar29 * 0x138 + 0x310) * 5;
        do {
          if ((((*plVar22 == -1) && (lVar21 == plVar22[1])) &&
              (this[uVar29 * 0x138 + 0x22e] == *(ToneMapper *)((long)plVar22 + 0x14))) &&
             ((uVar14 == *(uint *)(plVar22 + 2) && ((int)plVar22[3] == 0)))) {
            lVar21 = plVar22[4];
      ...
      lVar21 = PipelineCacheRD::_generate_version
                         ((long)pTVar3,-1,SUB81(lVar21,0),(uint)(byte)this[uVar29 * 0x138 + 0x22e],
                          uVar14);
      *pTVar3 = (ToneMapper)0x0;
    }
LAB_00102079:
    RenderingDevice::draw_list_bind_render_pipeline(uVar18,pvVar19,lVar21);
    uVar18 = RenderingDevice::get_singleton();
    local_68[0] = 0;
    local_88 = uVar12;
    ...
    local_a8 = local_138;
    if (local_128[0] == 0) {
      uVar20 = UniformSetCacheRD::get_cache<RenderingDevice::Uniform,RenderingDevice::Uniform>
                         (pUVar13,lVar16,2,&local_b8,&local_88);
...
void __thiscall
RendererRD::ToneMapper::tonemapper
          (ToneMapper *this,void *param_1,undefined8 param_3,long param_4,char *param_5)
...
LAB_00103496:
      _err_print_error("tonemapper","servers/rendering/renderer_rd/effects/tone_mapper.cpp",uVar17,
                       pcVar22,0,0);
      return;
    }
    goto LAB_001035d5;
  ...
  *(undefined8 *)(this + 0x58) = 0;
  ...
  for (uVar20 = (ulong)((uVar13 - (int)(undefined8 *)((ulong)(this + 8) & 0xfffffffffffffff8)) +
                        0x60 >> 3); uVar20 != 0; uVar20 = uVar20 - 1) {
    *puVar23 = 0;
  ...
  *(undefined4 *)(this + 8) = *(undefined4 *)(param_5 + 0x78);
  ...
  if (cVar6 == '\0') {
    ...
    *(uint *)(this + 0xc) =
         (uint)bVar8 << 3 | (uint)bVar7 << 2 | (uint)bVar27 | (uint)bVar9 << 5 | (uint)bVar10 << 6;
...
LAB_00102c75:
      _err_print_index_error
                ("version_get_shader","./servers/rendering/renderer_rd/shader_rd.h",0xa6,uVar26,
                 lVar16,"p_variant","variant_defines.size()","",false,false);
LAB_00102cb0:
      _err_print_error("tonemapper","servers/rendering/renderer_rd/effects/tone_mapper.cpp",0xf9,
                       "Condition \"shader.is_null()\" is true.",0,0);
      if (local_a8[0] != 0) {
        LOCK();
...
LAB_00103436:
        _err_print_index_error
                  ("get","./core/templates/cowdata.h",0xdb,uVar21,lVar19,"p_index","size()","",false
                   ,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
...
LAB_0010354e:
      ...
      lVar16 = ((uVar11 & 0xffffffff) % (ulong)*(uint *)(this + 0x130)) * 0xa0 +
               *(long *)(*(long *)(this + 0x120) +
                        ((uVar11 & 0xffffffff) / (ulong)*(uint *)(this + 0x130)) * 8);
...
LAB_001033ec:
        ...
        uVar28 = UniformSetCacheRD::get_cache<RenderingDevice::Uniform>
                           (pUVar14,lVar16,0,&local_68,uVar28);
        ...
        if (*(uint *)(this + uVar26 * 0x138 + 0x310) != 0) {
          ...
          do {
            if ((((*plVar18 == -1) && (param_4 == plVar18[1])) &&
                (this[uVar26 * 0x138 + 0x22e] == *(ToneMapper *)((long)plVar18 + 0x14))) &&
               ((uVar15 == *(uint *)(plVar18 + 2) && ((int)plVar18[3] == 0)))) {
              lVar19 = plVar18[4];
              goto LAB_00102e58;
            }
            plVar18 = plVar18 + 5;
        ...
        lVar19 = PipelineCacheRD::_generate_version
                           ((long)pTVar3,-1,SUB81(param_4,0),
                            (uint)(byte)this[uVar26 * 0x138 + 0x22e],uVar15);
LAB_00102e58:
        lVar24 = local_168[0];
        *pTVar3 = (ToneMapper)0x0;
      ...
      local_88 = local_118;
      if (local_108[0] == 0) {
        uVar28 = UniformSetCacheRD::get_cache<RenderingDevice::Uniform,RenderingDevice::Uniform>
                           (pUVar14,lVar16,2,&local_98,&local_68);
...
LAB_00102cf0:
    ...
    _err_print_error("tonemapper","servers/rendering/renderer_rd/effects/tone_mapper.cpp",0xc2,
                     "Condition \"p_settings.use_glow\" is true.",
                     "Glow is not supported when using subpasses.",0,0);
  }
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
  }
...
/* TonemapShaderRD::~TonemapShaderRD() */

void __thiscall TonemapShaderRD::~TonemapShaderRD(TonemapShaderRD *this)
...
LAB_00105a11:
  ...
  if ((*(long *)(param_4 + 8) != 0) &&
     (uVar7 = (uint)*(undefined8 *)(*(long *)(param_4 + 8) + -8), uVar7 != 0)) goto LAB_001059fd;
LAB_001058a0:
  lVar19 = local_48;
  lVar13 = local_58;
...
joined_r0x00106453:
                  if (local_e8 != 0) goto LAB_00105c76;
                }
LAB_0010613a:
                lVar19 = local_58;

...
LAB_001009f0:
    ...
    do {
      if ((lVar16 + -1 <= lVar7) ||
         (fVar19 = *(float *)(uVar17 + 4 + lVar7 * 4), pfVar1 = (float *)(uVar17 + lVar7 * 4),
         fVar19 < *pfVar1 || fVar19 == *pfVar1)) {
...
LAB_0010094c:
      ...
      if ((fVar3 < fVar20) || (*(long *)((uVar18 - 0x10) + lVar7 * 2) + (long)param_2 <= lVar8))
      goto LAB_00100948;
      lVar7 = lVar7 + -4;
      lVar16 = lVar15 + -1;
      fVar20 = fVar3;
...
LAB_00100c21:
    if (param_8 <= iVar5) goto LAB_00100d54;
  }
  lVar8 = (long)iVar5;
  iVar9 = 0;
...
LAB_00101299:
          fVar57 = (float)(&ATH)[iVar52 + lVar50];
    ...
    *(undefined8 *)(pfVar38 + 0x36) = uVar23;
    ...
    do {
      ...
      do {
        ...
        *pfVar53 = (float)(~-(uint)(bVar32 != (fVar57 < 0.0 && 0.0 < param_2 != bVar32)) &
                          (uint)fVar57) + *pfVar53;
        pfVar53[1] = (float)(~-(uint)(bVar33 != (fVar63 < 0.0 && 0.0 < param_2 != bVar33)) &
                            (uint)fVar63) + pfVar53[1];
        pfVar53[2] = (float)(~-(uint)(bVar30 != (fVar65 < 0.0 && 0.0 < param_2 != bVar30)) &
                            (uint)fVar65) + pfVar53[2];
        pfVar53[3] = (float)(~-(uint)(bVar31 != (fVar67 < 0.0 && 0.0 < param_2 != bVar31)) &
                            (uint)fVar67) + pfVar53[3];
        pfVar51 = pfVar53 + 4;
    ...
    while( true ) {
      ...
      do {
        ...
        *pfVar43 = *pfVar43 + fVar63;
        pfVar43[1] = pfVar43[1] + fVar63;
        pfVar43[2] = pfVar43[2] + fVar63;
        pfVar43[3] = pfVar43[3] + fVar63;
        pfVar43 = pfVar42;
      ...
      *(undefined8 *)(pfVar51 + 0x1e) = uStack_7eb0;
      ...
      do {
        ...
        if (*(float *)((long)pfVar51 + lVar44) <= fVar63 &&
            fVar63 != *(float *)((long)pfVar51 + lVar44)) {
  ...
  do {
    ...
    *(undefined8 *)(puVar47 + lVar5 + -8) = 0x101913;
    ...
    if ((double)(_LC8 & (ulong)dVar59) < _LC4) {
      dVar59 = (double)((ulong)((double)(long)dVar59 -
                               (double)(-(ulong)(dVar59 < (double)(long)dVar59) & (ulong)_LC25)) |
                       ~_LC8 & (ulong)dVar59);
    }
    *(undefined8 *)(puVar47 + lVar5 + -8) = 0x10199b;
    ...
    if ((double)(_LC8 & (ulong)dVar60) < _LC4) {
      dVar60 = (double)((ulong)((double)(long)dVar60 +
                               (double)(-(ulong)((double)(long)dVar60 < dVar60) & (ulong)_LC25)) |
                       ~_LC8 & (ulong)dVar60);
    }

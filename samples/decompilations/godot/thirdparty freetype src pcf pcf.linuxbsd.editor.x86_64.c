...
LAB_0010011b:
  *param_2 = (uVar2 + uVar10) * 0x100 | uVar7;
  return sVar8;
}
...

{
  ...
  *(ulong *)(param_1 + 0x38) = (ulong)(uint)((sVar4 + iVar21) * 0x40);
  ...
  if ((param_4 & 0x400000) == 0) {
    ...
    if (((uVar14 >> 3 & 1) == 0) && (pbVar10 = *(byte **)(param_1 + 0xa8), uVar23 != 0)) {
      pbVar19 = pbVar10;
      do {
        bVar3 = *pbVar19;
        pbVar20 = pbVar19 + 1;
    ...
    if (((uVar18 ^ (uint)(uVar14 >> 2)) & 1) != 0) {
      ...
      else if ((uVar18 == 2) && (puVar9 = *(uint **)(param_1 + 0xa8), 3 < uVar23)) {
        puVar15 = puVar9;
        do {
          uVar18 = *puVar15;
          puVar16 = puVar15 + 1;
          *puVar15 = uVar18 >> 0x18 | (uVar18 & 0xff0000) >> 8 | (uVar18 & 0xff00) << 8 |
                     uVar18 << 0x18;
          puVar15 = puVar16;
...

{
  ...
  lVar1 = pcf_find_property_isra_0
                    (*(undefined4 *)(param_1 + 0x1f8),*(undefined8 *)(param_1 + 0x200),param_2);
  uVar2 = 6;
  if (lVar1 != 0) {
...
int pcf_load_font(long param_1,undefined8 *param_2,long param_3)

{
  ...
  if ((((local_90 == 0) &&
       (local_90 = FT_Stream_ReadFields(param_1,pcf_toc_header,param_2 + 0x2c), local_90 == 0)) &&
      (param_2[0x2c] == 0x70636601)) &&
     ((uVar34 = param_2[0x2d], uVar34 != 0 && (0xf < *(ulong *)(param_1 + 8))))) {
...
LAB_001010a8:
        ...
        } while ((bVar39) && (uVar34 = (ulong)((int)uVar34 + 1), uVar34 < uVar24));
        uVar34 = *(ulong *)(param_1 + 8);
        uVar30 = 0;
        do {
          if ((uVar34 < *(ulong *)(lVar13 + 0x10)) ||
             (uVar34 - *(ulong *)(lVar13 + 0x10) < *(ulong *)(lVar13 + 0x18))) goto LAB_0010116a;
          uVar30 = uVar30 + 1;
          lVar13 = lVar13 + 0x20;
        } while (uVar24 != uVar30);
      }
...
LAB_0010116a:
        local_90 = 8;
LAB_00100c2a:
        ft_mem_free(uVar23,param_2[0x2e]);
        local_98 = local_90;
        param_2[0x2e] = 0;
      ...
      *param_2 = __LC2;
      ...
      if (param_2[0x2d] != 0) {
        ...
        do {
          if (*plVar16 == 1) {
            if (((ulong)plVar16[3] < *(ulong *)(param_1 + 0x10)) ||
               (iVar10 = FT_Stream_Skip(param_1,plVar16[3] - *(ulong *)(param_1 + 0x10)),
               iVar10 != 0)) {
              local_90 = 0x53;
              goto LAB_00100cd8;
            }
...
LAB_00100cd8:
  ...
  goto LAB_00100af5;
LAB_001012f4:
  local_90 = FT_Stream_ReadFields(param_1,pcf_property_header,puVar28);
  if (local_90 != 0) goto LAB_001012d0;
  uVar35 = uVar35 + 1;
  ...
  goto LAB_001012f4;
LAB_001012b4:
  local_90 = FT_Stream_ReadFields(param_1,pcf_property_msb_header,puVar28);
  if (local_90 != 0) goto LAB_001012d0;
  uVar35 = uVar35 + 1;
  puVar28 = puVar28 + 3;
  if (uVar30 <= uVar35) goto LAB_00101dc3;
...
LAB_00101e01:
    ...
    if (local_90 == 0) {
      if (uVar35 <= uVar34 + uVar24 * -9) {
        ...
        if ((local_90 == 0) && (local_90 = FT_Stream_Read(param_1,lVar13,uVar34), local_90 == 0)) {
        ...
        do {
          if (*plVar16 == 4) {
            ...
            if (uVar11 < 0x100) {
              ...
              if ((local_94 != 0) || (uVar24 = (ulong)uVar12, uVar34 / 0xc < uVar24)) break;
            }
            else {
              if (uVar12 == 0) {
              ...
              if ((local_94 != 0) || (uVar24 = (ulong)uVar9, uVar34 / 5 < uVar24)) break;
            }
            if (uVar24 != 0) {
              if (0xfffe < uVar24) {
                uVar24 = 0xfffe;
...
LAB_00101368:
  ...
  while( true ) {
    if ((sVar8 < sVar38) ||
       (SBORROW4((int)psVar14[0xf],-(int)psVar14[0x10]) !=
        (int)psVar14[0xf] + (int)psVar14[0x10] < 0)) {
      psVar37[0] = 0;
      psVar37[1] = 0;
      psVar37[2] = 0;
      psVar37[3] = 0;
...
LAB_0010131e:
    ft_mem_free(local_b8,param_2[0x42]);
    param_2[0x42] = 0;
    local_98 = local_94;
  ...
  if (param_2[0x2d] != 0) {
    lVar13 = 0;
LAB_00101379:
    if (*plVar16 != 8) goto LAB_00101368;
    if (((ulong)plVar16[3] < *(ulong *)(param_1 + 0x10)) ||
       (iVar10 = FT_Stream_Skip(param_1,plVar16[3] - *(ulong *)(param_1 + 0x10)), iVar10 != 0))
    goto LAB_00100af5;
    uVar34 = plVar16[2];
    local_90 = 0;
...
LAB_00101533:
      ...
      do {
        if (*plVar16 == 0x20) {
          if ((*(ulong *)(param_1 + 0x10) <= (ulong)plVar16[3]) &&
             (iVar10 = FT_Stream_Skip(param_1,plVar16[3] - *(ulong *)(param_1 + 0x10)), iVar10 == 0)
             ) {
            local_90 = 0;
            uVar11 = FT_Stream_ReadULongLE(param_1,&local_90);
              ...
              if (local_90 == 0) {
                ...
                if ((uVar9 <= uVar33) && (uVar33 < 0x100)) {
                  ...
                  if ((uVar2 <= uVar3) && (uVar3 < 0x100)) {
                    ...
                    uVar25 = uVar4 >> 8;
                    if (((uVar25 < uVar2 || uVar3 < uVar25) || (uVar4 & 0xff) < uVar9) ||
                       (uVar26 = (uint)uVar25, uVar33 < (uVar4 & 0xff))) {
                      uVar12 = (uint)uVar9;
                      *(ushort *)(param_2 + 0x44) = uVar2 * 0x100 + uVar9;
                      uVar26 = (uint)uVar2;
                    }
                    lVar13 = (long)(int)(((uint)uVar33 - (uint)uVar9) + 1) *
                             (long)(int)(((uint)uVar3 - (uint)uVar2) + 1);
                    local_90 = FT_Stream_EnterFrame(param_1,lVar13 * 2);
                    if (local_90 == 0) {
                      uVar9 = *(ushort *)
                               (*(long *)(param_1 + 0x40) +
                               (long)(int)((((((uint)*(ushort *)((long)param_2 + 0x21a) -
                                              (uint)*(ushort *)(param_2 + 0x43)) + 1) *
                                             (uVar26 - *(ushort *)((long)param_2 + 0x21c)) + uVar12)
                                           - (uint)*(ushort *)(param_2 + 0x43)) * 2));
                      if (uVar11 != 0) {
                      ...
                      *puVar21 = *(undefined8 *)((long)puVar21 + lVar36);
                      ...
                      if (local_90 == 0) {
                        ...
                        if ((local_90 == 0) &&
                           ((!bVar39 ||
                            (local_98 = pcf_get_accel(param_1,param_2,0x100), local_98 == 0)))) {
                          uVar34 = param_2[2];
                          ...
                          if (local_90 == 0) {
                            do {
                              ...
                              if (__src != (void *)0x0) {
                                ...
                                if (((9UL >> (uVar34 & 0x3f) & 1) != 0) &&
                                   (pcVar17 = pcVar19, sVar18 != 0)) {
                                  pcVar17 = pcVar19 + sVar18;
                                  do {
                                    if (*pcVar19 == ' ') {
                                      *pcVar19 = '-';
                            ...
                            *pcVar17 = '\0';
                            local_98 = local_90;
                            if (local_90 == 0) {
                              lVar13 = pcf_find_property_isra_0
                                                 (*(undefined4 *)(param_2 + 0x3f),param_2[0x40],
                                                  "FAMILY_NAME");
                              if ((lVar13 == 0) || (*(char *)(lVar13 + 8) == '\0')) {
                                param_2[5] = 0;
                              }
                              else {
                                uVar22 = ft_mem_strdup(uVar23,*(undefined8 *)(lVar13 + 0x10),
                                                       &local_98);
                                param_2[5] = uVar22;
                                if (local_98 != 0) break;
                              }
...
LAB_00101ec9:
                                  *(ulong *)(psVar14 + 8) = uVar34;
                                  ...
                                  if ((long)uVar30 < 0x8000) {
                                    ...
                                    *(ulong *)(psVar14 + 0xc) = uVar34;
LAB_00101cc7:
                                    uVar34 = FT_MulDiv(uVar34,uVar30,0x48);
                                    *(ulong *)(psVar14 + 0xc) = uVar34;
                                    bVar39 = true;
                                  }
                                  else {
                                ...
                                if ((((lVar13 != 0) && (*(char *)(lVar13 + 8) != '\0')) &&
                                    (lVar36 != 0)) && (*(char *)(lVar36 + 8) != '\0')) {
                                  uVar22 = ft_mem_strdup(uVar23,*(undefined8 *)(lVar36 + 0x10),
                                                         &local_98);
                                  param_2[0x2a] = uVar22;
                                  if (local_98 != 0) break;
                                  uVar23 = ft_mem_strdup(uVar23,*(undefined8 *)(lVar13 + 0x10),
                                                         &local_98);
                                  param_2[0x2b] = uVar23;
                                }
                                iVar10 = local_98;
...
LAB_00102227:
        if ((iVar2 == 0) ||
           ((iVar2 = FT_Stream_OpenLZW(lVar4,param_1), (char)iVar2 != '\a' && (iVar2 == 0)))) {
...
LAB_00102279:
  pbVar1 = *(byte **)(param_2 + 0x158);
  __s1 = *(char **)(param_2 + 0x150);
  if ((((pbVar1 == (byte *)0x0) || (__s1 == (char *)0x0)) || ((*pbVar1 & 0xdf) != 0x49)) ||
     (((pbVar1[1] & 0xdf) != 0x53 || ((pbVar1[2] & 0xdf) != 0x4f)))) {
LAB_001022a0:
    local_40 = 0;
    local_3c = 0;
    local_3a = 0;
    ...
    if ((iVar2 == 0) ||
       (((iVar2 = strcmp((char *)pbVar1,"8859"), iVar2 == 0 && (*__s1 == '1')) && (__s1[1] == '\0'))
       )) {
      local_40 = 0x756e6963;
      local_3c = 3;
      local_3a = 1;

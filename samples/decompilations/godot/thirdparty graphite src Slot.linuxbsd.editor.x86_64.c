...
/* graphite2::Slot::Slot(short*) */

void __thiscall graphite2::Slot::Slot(Slot *this,short *param_1)
...
/* graphite2::Slot::set(graphite2::Slot const&, int, unsigned long, unsigned long, unsigned long) */

void __thiscall
graphite2::Slot::set(Slot *this,Slot *param_1,int param_2,ulong param_3,ulong param_4,ulong param_5)
...
void __thiscall graphite2::Slot::update(Slot *this,int param_1,int param_2,Position *param_3)

{
  ...
  *(ulong *)(this + 0x18) =
       CONCAT44((int)((ulong)*(undefined8 *)(this + 0x18) >> 0x20) + param_2,
                (int)*(undefined8 *)(this + 0x18) + param_2);
  *(ulong *)(this + 0x40) =
       CONCAT44((float)((ulong)*(undefined8 *)(this + 0x40) >> 0x20) + (float)((ulong)uVar1 >> 0x20)
                ,(float)*(undefined8 *)(this + 0x40) + (float)uVar1);
  return;
}



/* graphite2::Slot::getJustify(graphite2::Segment const*, unsigned char, unsigned char) const */

int __thiscall graphite2::Slot::getJustify(Slot *this,Segment *param_1,uchar param_2,uchar param_3)

{
  ...
  if (param_2 == '\0') {
    ...
    if (lVar2 == 0) {
LAB_001001d9:
      if ((((param_3 == '\x02') || (param_3 < 3)) || (param_3 == '\x03')) &&
         ((*(ushort *)(this + 0x10) <
           *(ushort *)(*(long *)(*(long *)(param_1 + 0x88) + 0x78) + 0x28) &&
          (lVar2 = graphite2::GlyphCache::glyph((ushort)*(long *)(*(long *)(param_1 + 0x88) + 0x78))
          , lVar2 != 0)))) {
  ...
  return (int)*(short *)(lVar2 + 8 +
                        (long)(int)((uint)param_2 + (uint)param_2 * 4 + (uint)param_3) * 2);
}



/* graphite2::Slot::getAttr(graphite2::Segment const*, gr_attrCode, unsigned char) const */

ulong __thiscall graphite2::Slot::getAttr(Slot *this,Segment *param_1,uint param_3,byte param_4)

{
  ...
  uVar4 = (undefined4)
          ((ulong)((long)&switchD_00100296::switchdataD_00101a44 +
                  (long)(int)(&switchD_00100296::switchdataD_00101a44)[param_3]) >> 0x20);
  switch(param_3) {
  case 0:
...
/* graphite2::Slot::child(graphite2::Slot*) */

undefined8 __thiscall graphite2::Slot::child(Slot *this,Slot *param_1)
...
/* graphite2::Slot::sibling(graphite2::Slot*) */

void graphite2::Slot::sibling(Slot *param_1)
...
/* graphite2::Slot::removeChild(graphite2::Slot*) */

bool __thiscall graphite2::Slot::removeChild(Slot *this,Slot *param_1)
...
/* graphite2::Slot::setGlyph(graphite2::Segment*, unsigned short, graphite2::GlyphFace const*) */

void __thiscall
graphite2::Slot::setGlyph(Slot *this,Segment *param_1,ushort param_2,GlyphFace *param_3)
...
LAB_00100875:
    ...
    param_3 = (GlyphFace *)
              graphite2::GlyphCache::glyph((ushort)*(long *)(*(long *)(param_1 + 0x88) + 0x78));
...
/* graphite2::Slot::floodShift(graphite2::Position, int) */

void __thiscall graphite2::Slot::floodShift(undefined8 param_1,Slot *this,int param_3)

{
  if (param_3 < 0x65) {
    ...
    do {
      *(ulong *)(this + 0x40) =
           CONCAT44((float)((ulong)*(undefined8 *)(this + 0x40) >> 0x20) +
                    (float)((ulong)param_1 >> 0x20),
                    (float)*(undefined8 *)(this + 0x40) + (float)param_1);
      if (*(long *)(this + 0x30) != 0) {
        floodShift(*(long *)(this + 0x30),param_3);
      }
      this = *(Slot **)(this + 0x38);
    } while ((this != (Slot *)0x0) && (param_3 = param_3 + 1, param_3 != 0x66));
    return;
  }
  return;
}
...
graphite2::Slot::finalise
          (Slot *this,Segment *param_1,Font *param_2,Position *param_3,Rect *param_4,uchar param_5,
          float *param_6,bool param_7,bool param_8,int param_9)

{
  ...
  if (((param_8) && (*(long *)(param_1 + 0x80) != 0)) &&
     ((lVar7 = *(long *)(param_1 + 0x80) + (ulong)*(uint *)(this + 0x20) * 0x44,
      (*(byte *)(lVar7 + 0x2c) & 0x10) == 0 || (param_7)))) {
  ...
  if (uVar9 < *(ushort *)(*(long *)(*(long *)(param_1 + 0x88) + 0x78) + 0x28)) {
    pfVar6 = (float *)graphite2::GlyphCache::glyph
                                ((ushort)*(long *)(*(long *)(param_1 + 0x88) + 0x78));
    if (param_2 != (Font *)0x0) {
      fVar12 = *(float *)(param_2 + 0x38);
  ...
  *(ulong *)(this + 0x40) = CONCAT44(fVar17,fVar16);
  if (lVar7 == 0) {
    ...
    *param_6 = fVar16;
    ...
    fVar16 = ((float)*(undefined8 *)(this + 0x58) - (float)*(undefined8 *)(this + 0x60)) * fVar12 +
             fVar16;
    *(ulong *)(this + 0x40) =
         CONCAT44(((float)((ulong)*(undefined8 *)(this + 0x58) >> 0x20) -
                  (float)((ulong)*(undefined8 *)(this + 0x60) >> 0x20)) * fVar12 + fVar17,fVar16);
...
LAB_00100b78:
  ...
  if (((this == pSVar5) || (pSVar5 == (Slot *)0x0)) || (this != *(Slot **)(pSVar5 + 0x28))) {
    ...
    if ((param_9 != 100) && ((param_5 == '\0' || ((byte)pSVar5[0x6d] <= param_5)))) {
      auVar18._0_8_ =
           finalise(pSVar5,param_1,param_2,(Position *)(this + 0x40),param_4,param_5,param_6,param_7
                    ,param_8,param_9 + 1);
  ...
  if ((param_9 != 100) && ((param_5 == '\0' || ((byte)pSVar5[0x6d] <= param_5)))) {
    auVar11._0_8_ =
         finalise(pSVar5,param_1,param_2,param_3,param_4,param_5,param_6,param_7,param_8,param_9 + 1
                 );
...
LAB_00100cd0:
  ...
  if (*param_6 < *(float *)param_3) {
    ...
    *(ulong *)(this + 0x40) =
         CONCAT44((float)((ulong)*(undefined8 *)(this + 0x40) >> 0x20) + 0.0,
                  (float)*(undefined8 *)(this + 0x40) + fVar12);
    if (lVar7 != 0) {
      iVar8 = 1;
      fVar17 = 0.0;
...
/* graphite2::Slot::finalise(graphite2::Segment const*, graphite2::Font const*,
   graphite2::Position&, graphite2::Rect&, unsigned char, float&, bool, bool, int) */
...
/* graphite2::Slot::clusterMetric(graphite2::Segment const*, unsigned char, unsigned char, bool) */

int __thiscall
graphite2::Slot::clusterMetric(Slot *this,Segment *param_1,uchar param_2,uchar param_3,bool param_4)

{
  ...
  if (uVar3 < *(ushort *)(*(long *)(*(long *)(param_1 + 0x88) + 0x78) + 0x28)) {
    ...
    if ((param_3 == '\0') || ((byte)this[0x6d] <= param_3)) {
      uVar4 = finalise(this,param_1,(Font *)0x0,(Position *)&local_50,(Rect *)&local_48,param_3,
                       &local_54,param_4,false,0);
    }
    else {
      uVar4 = 0;
    }
...
/* graphite2::SlotJustify::LoadSlot(graphite2::Slot const*, graphite2::Segment const*) */

void __thiscall graphite2::SlotJustify::LoadSlot(SlotJustify *this,Slot *param_1,Segment *param_2)
...
/* graphite2::Slot::setJustify(graphite2::Segment*, unsigned char, unsigned char, short) */

void __thiscall
graphite2::Slot::setJustify(Slot *this,Segment *param_1,uchar param_2,uchar param_3,short param_4)

{
  ...
  if ((param_2 == '\0') || (param_2 < *(byte *)(*(long *)(param_1 + 0x90) + 0x29))) {
    ...
    *(short *)(this_00 + (long)(int)((uint)param_2 + (uint)param_2 * 4 + (uint)param_3) * 2 + 8) =
         param_4;
  }
  return;
}
...
/* graphite2::Slot::setAttr(graphite2::Segment*, gr_attrCode, unsigned char, short,
   graphite2::SlotMap const&) */

void __thiscall
graphite2::Slot::setAttr
          (Slot *this,Segment *param_1,int param_3,byte param_4,ushort param_5,long param_6)
...
LAB_0010133f:
    *(ushort *)(*(long *)(this + 0x70) + lVar8) = param_5;
    return;
  }
  uVar11 = param_3 - 0x19;
  if ((uVar11 < 0x14) && (param_3 != 0x1d)) {
    setJustify(this,param_1,(uchar)((ulong)uVar11 / 5),(char)uVar11 + (char)(uVar11 / 5) * -5,
               param_5);
    return;
  }
...
/* graphite2::Slot::nextInCluster(graphite2::Slot const*) const */

long __thiscall graphite2::Slot::nextInCluster(Slot *this,Slot *param_1)
...
/* graphite2::Slot::isChildOf(graphite2::Slot const*) const */

Slot * __thiscall graphite2::Slot::isChildOf(Slot *this,Slot *param_1)
...
void graphite2::Slot::getAttr(void)
...
/* graphite2::Slot::setAttr(graphite2::Segment*, gr_attrCode, unsigned char, short,
   graphite2::SlotMap const&) [clone .cold] */

void graphite2::Slot::setAttr(void)

...
/* icu_76_godot::CStr::CStr(icu_76_godot::UnicodeString const&) */

void __thiscall icu_76_godot::CStr::CStr(CStr *this,UnicodeString *param_1)

{
  ...
  *(CStr **)(this + 8) = this + 0x15;
  ...
  uVar3 = icu_76_godot::UnicodeString::extract((int)param_1,0,(char *)(ulong)uVar3,0);
  local_34 = 0;
  uVar2 = icu_76_godot::CharString::getAppendBuffer
                    ((int)(this + 8),uVar3,(int *)(ulong)uVar3,(UErrorCode *)&local_34);
  ...
  icu_76_godot::UnicodeString::extract((int)param_1,0,(char *)(ulong)uVar4,uVar2);
  icu_76_godot::CharString::append((char *)(this + 8),uVar2,(UErrorCode *)(ulong)uVar3);
...
/* icu_76_godot::CStr::~CStr() */

void __thiscall icu_76_godot::CStr::~CStr(CStr *this)

{
  if (this[0x14] == (CStr)0x0) {
    return;
  }
...
/* icu_76_godot::CStr::TEMPNAMEPLACEHOLDERVALUE() const */

undefined8 __thiscall icu_76_godot::CStr::operator()(CStr *this)

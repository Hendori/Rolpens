...

{
  ...
  *(undefined ***)this = &PTR__initialize_classv_001030c0;
  return;
}
...

{
  ...
  cVar7 = String::operator!=((String *)&local_80,"#?RADIANCE");
  if ((cVar7 == '\0') || (cVar7 = String::operator!=((String *)&local_80,"#?RGBE"), cVar7 == '\0'))
  {
    while( true ) {
      (**(code **)(*(long *)*param_3 + 0x228))((String *)&local_78);
      cVar7 = (**(code **)(*(long *)*param_3 + 0x1d8))();
      lVar4 = local_78;
      if (cVar7 != '\0') break;
      if (local_78 == 0) {
LAB_00100604:
        (**(code **)(*(long *)*param_3 + 0x230))((String *)&local_70);
        cVar7 = String::operator!=((String *)&local_70,"-Y");
        if (cVar7 == '\0') {
          ...
          cVar7 = String::operator!=((String *)&local_70,"+X");
          if (cVar7 == '\0') {
            ...
            local_60 = (uint *)0x0;
            iVar17 = uVar13 * iVar12;
            CowData<unsigned_char>::resize<false>
                      ((CowData<unsigned_char> *)&local_60,(long)(iVar17 * 4));
            ...
            if (0x7ff7 < uVar13 - 8) {
              (**(code **)(*(long *)*param_3 + 0x220))
                        ((long *)*param_3,puVar21,(long)(int)uVar13 * (long)iVar12 * 4);
              goto LAB_00100acc;
            }
            if (iVar12 < 1) goto LAB_00100acc;
            local_c8 = 0;
            local_b8 = 0;
            iVar22 = 0;
            goto LAB_00100968;
      ...
      cVar7 = String::begins_with((char *)&local_78);
      if (cVar7 == '\0') {
        cVar7 = String::begins_with((char *)&local_78);
        if (cVar7 == '\0') {
          local_68 = 0;
          ...
          _err_print_error("load_image","modules/hdr/image_loader_hdr.cpp",0x2f,(String *)&local_58)
          ;
          puVar5 = local_58;
          if (local_58 != (undefined *)0x0) {
            LOCK();
        ...
        cVar7 = String::operator!=((String *)&local_78,"FORMAT=32-bit_rle_rgbe");
        if (cVar7 != '\0') {
...
LAB_00100968:
  do {
    ...
    bVar10 = (**(code **)(*(long *)*param_3 + 0x1e0))();
    if (((bVar8 == 2) && (bVar9 == 2)) && (-1 < (char)bVar10)) {
      uVar11 = (**(code **)(*(long *)*param_3 + 0x1e0))();
      if (uVar13 != CONCAT11(bVar10,uVar11)) {
      ...
      do {
        ...
        do {
          ...
          plVar1 = (long *)*param_3;
          if (bVar8 < 0x81) {
            (**(code **)(*plVar1 + 0x220))(plVar1,lVar4,bVar8);
            if (bVar8 != 0) {
              lVar15 = 0;
              do {
                *(byte *)((long)puVar21 + lVar15 * 4 + lVar20 + (long)(local_c8 + iVar18) * 4) =
                     *(byte *)(lVar4 + lVar15);
                lVar15 = lVar15 + 1;
              } while ((int)lVar15 < (int)(uint)bVar8);
              iVar18 = iVar18 + (uint)bVar8;
            }
          }
          else {
            bVar9 = (**(code **)(*plVar1 + 0x1e0))();
            pbVar2 = (byte *)((long)puVar21 +
                             ((ulong)(bVar8 - 0x81) + (long)(iVar18 + local_c8)) * 4 + lVar20 + 4);
            pbVar14 = (byte *)((iVar18 + local_c8) * 4 + lVar20 + (long)puVar21);
            if (((int)pbVar2 - (int)pbVar14 & 4U) == 0) goto LAB_00100a68;
            *pbVar14 = bVar9;
            for (pbVar14 = pbVar14 + 4; pbVar14 != pbVar2; pbVar14 = pbVar14 + 8) {
LAB_00100a68:
              *pbVar14 = bVar9;
              pbVar14[4] = bVar9;
            }
            iVar18 = iVar18 + -0x80 + (uint)bVar8;
          }
      ...
      lVar20 = (long)iVar22;
      *(byte *)((long)puVar21 + lVar20) = bVar8;
      *(byte *)((long)puVar21 + lVar20 + 1) = bVar9;
      *(byte *)((long)puVar21 + lVar20 + 2) = bVar10;
      bVar8 = (**(code **)(*(long *)*param_3 + 0x1e0))();
      *(byte *)((long)puVar21 + lVar20 + 3) = bVar8;
      (**(code **)(*(long *)*param_3 + 0x220))
                ((long *)*param_3,(byte *)((long)(iVar22 + 4) + (long)puVar21),uVar13 * 4 + -4);
    }
    local_b8 = local_b8 + 1;
    local_c8 = local_c8 + uVar13;
    iVar22 = iVar22 + uVar13 * 4;
  } while (iVar12 != local_b8);
LAB_00100acc:
  puVar3 = puVar21 + iVar17;
  if (0 < iVar17) {
    do {
      uVar16 = (uint)*(byte *)((long)puVar21 + 3);
      if ((param_4 & 1) == 0) {
        while (uVar16 - 0x71 < 0x1f) {
          *puVar21 = (uVar16 - 0x71) * 0x8000000 |
                     (uint)*(byte *)((long)puVar21 + 2) << 0x13 |
                     (uint)*(byte *)((long)puVar21 + 1) << 10 | (uint)(byte)*puVar21 * 2;
          if (puVar21 + 1 == puVar3) goto LAB_00100d8d;
          uVar16 = (uint)*(byte *)((long)puVar21 + 7);
          puVar21 = puVar21 + 1;
        }
      }
      while( true ) {
        dVar24 = pow(_LC35,(double)(int)(uVar16 - 0x80));
        fVar23 = (float)dVar24;
        fVar28 = ((float)*(byte *)((long)puVar21 + 2) * fVar23) / __LC36;
        fVar26 = ((float)*(byte *)((long)puVar21 + 1) * fVar23) / __LC36;
        fVar23 = ((float)(byte)*puVar21 * fVar23) / __LC36;
        if ((param_4 & 1) == 0) break;
        if (_LC37 <= fVar28) {
          fVar28 = powf((float)(((double)fVar28 + __LC39) * __LC40),_LC41);
        }
        else {
          fVar28 = fVar28 * __LC38;
        }
        if (_LC37 <= fVar26) {
          fVar26 = powf((float)(((double)fVar26 + __LC39) * __LC40),_LC41);
        }
        else {
          fVar26 = fVar26 * __LC38;
        }
        if (_LC37 <= fVar23) {
          fVar23 = powf((float)(((double)fVar23 + __LC39) * __LC40),_LC41);
          break;
        }
        fVar23 = fVar23 * __LC38;
        if (0.0 <= fVar23) goto LAB_00100f6a;
        if (0.0 <= fVar26) goto LAB_00100f1b;
        if (0.0 <= fVar28) {
          fVar27 = 0.0;
          fVar26 = 0.0;
          goto LAB_00100d47;
        ...
        *puVar21 = 0;
        if (puVar3 == puVar21 + 1) goto LAB_00100d8d;
        uVar16 = (uint)*(byte *)((long)puVar21 + 7);
        puVar21 = puVar21 + 1;
      }
      if (0.0 <= fVar23) {
...
LAB_00100f1f:
            if (_LC13 < fVar26) {
              fVar26 = _LC13;
              if (fVar28 < 0.0) {
                uVar16 = (uint)(fVar27 + __LC43) & 0x1ff | 0xf803fe00;
                goto LAB_00100d7c;
              }
LAB_00100d47:
              if (_LC13 < fVar28) {
LAB_00100d54:
                uVar16 = (int)(fVar26 + __LC43) << 9 | (uint)(fVar27 + __LC43) & 0x1ff | 0xfffc0000;
                goto LAB_00100d7c;
              }
              goto LAB_00100eab;
            }
            if (0.0 <= fVar28) goto LAB_00100d47;
            fVar28 = 0.0;
            fVar25 = _LC14;
            goto LAB_00100ebf;
          }
          ...
          if (fVar23 <= 0.0) {
            uVar16 = (uint)(fVar23 + __LC42) & 0x1ff;
            goto LAB_00100d7c;
          }
          fVar26 = 0.0;
          fVar29 = 0.0;
          fVar28 = 0.0;
          fVar25 = _LC14;
          if (fVar23 <= _LC14) goto LAB_00100fa0;
        }
        else {
          fVar27 = _LC13;
          if (0.0 <= fVar26) goto LAB_00100f1f;
          uVar16 = 0xf80001ff;
          if (fVar28 < 0.0) goto LAB_00100d7c;
          fVar26 = 0.0;
          if (_LC13 < fVar28) goto LAB_00100d54;
LAB_00100eab:
          fVar25 = fVar28;
          if (fVar28 <= _LC14) {
            fVar25 = _LC14;
...
LAB_00100ebf:
          ...
          if (fVar23 <= fVar25) {
LAB_00100fa0:
            fVar23 = (float)((int)fVar25 + 0x7804000U & 0x7f800000);
            uVar16 = (uint)(fVar27 + fVar23) & 0x1ff |
                     (int)(fVar28 + fVar23) << 0x12 | (int)(fVar26 + fVar23) << 9 |
                     (int)fVar23 * 0x10 + 0x10000000U;
            goto LAB_00100d7c;
          }
        }
        fVar23 = (float)((int)fVar23 + 0x7804000U & 0x7f800000);
        uVar16 = (int)(fVar29 + fVar23) << 0x12 | (int)(fVar26 + fVar23) << 9 |
                 (int)fVar23 * 0x10 + 0x10000000U | (uint)(fVar27 + fVar23) & 0x1ff;
      }
      else {
        if (0.0 <= fVar26) {
LAB_00100f1b:
...
LAB_00100d8d:
  ...
  uVar19 = 0;
  Image::set_data(*param_2,uVar13,iVar12,0,0x10,&local_68);
LAB_00100dc2:
  puVar21 = local_60;
  if (local_60 != (uint *)0x0) {
    ...
    *(long *)puVar3 = *(long *)puVar3 + -1;
    ...
    if (*(long *)puVar3 == 0) {
      local_60 = (uint *)0x0;
      Memory::free_static(puVar21 + -4,false);
    }
  }
LAB_00100ded:
  puVar5 = local_70;
...
{
  *(undefined ***)this = &PTR__initialize_classv_00102f60;
...
LAB_00102188:
    ...
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_00102188;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)pLVar6;
      local_68 = local_80;
      goto joined_r0x001021a6;
    }
...
LAB_00102588:
    ...
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)&local_90);
    local_50 = 0x80;
    if (local_60 != 0x11) goto LAB_00102588;
    StringName::StringName((StringName *)&local_80,(String *)&local_58,false);
    if (local_68 != local_80) {
      StringName::unref();
      lVar2 = *(long *)param_1;
      local_68 = local_80;
      goto joined_r0x001025a5;
    }
    if ((StringName::configured != '\0') && (local_80 != 0)) {
      StringName::unref();
    }
...

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if (initialize_class()::initialized != '\0') goto LAB_001029cb;
...
LAB_00102aea:
      ...
      *plVar1 = *plVar1 + -1;
      UNLOCK();
      if (*plVar1 != 0) goto LAB_00102ada;
      local_68 = 0;
      Memory::free_static((void *)(lVar2 + -0x10),false);
      if ((code *)PTR__bind_methods_00105010 != RefCounted::_bind_methods) goto LAB_00102aea;
    }

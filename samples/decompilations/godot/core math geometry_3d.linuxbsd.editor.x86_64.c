...

{
  ...
  if (ppuVar24 == (uchar **)0x0) {
    pppuVar9 = (uchar ***)0x0;
LAB_00104ffa:
    if (0 < local_148) goto LAB_001044f3;
    if (local_14c < 1) {
      *(undefined8 *)(this + 8) = 0;
...
LAB_001044e7:
    if (local_148 < 1) goto LAB_001045c2;
LAB_001044f3:
    iVar23 = 0;
    do {
      ...
      do {
        pFVar13 = pFVar12 + 0xc;
        *(ulong *)pFVar12 =
             CONCAT44((float)((ulong)*(undefined8 *)pFVar12 >> 0x20) -
                      (float)((ulong)local_c8 >> 0x20),
                      (float)*(undefined8 *)pFVar12 - (float)local_c8);
...
LAB_00104696:
      if (0 < local_14c) goto LAB_001046a2;
      goto LAB_00104810;
    }
    if (local_14c < 1) {
LAB_00105073:
      *(undefined8 *)(this + 8) = 0;
      CowData<Face3>::_copy_on_write((CowData<Face3> *)(this + 8));
LAB_00104f0b:
      Memory::free_static(pppuVar9,true);
...
LAB_00104802:
  if (local_150 < 1) goto LAB_00105073;
LAB_00104810:
  lVar35 = 0;
  do {
        ...
        do {
          ...
          *(ulong *)pfVar14 =
               CONCAT44((float)((ulong)*(undefined8 *)pfVar14 >> 0x20) *
                        ...
                        (float)*(undefined8 *)pfVar14 * (float)local_d8);
...
LAB_00104ac0:
                if ((0x55555554 < (iVar33 + -2) * -0x55555555 + 0x2aaaaaaaU) ||
                   (iVar16 = iVar7 + 1, uVar30 < 3)) goto LAB_00104ae8;
              }
              else {
                iVar28 = local_10c + -1;
                if ((iVar33 + -1) * -0x55555555 + 0x2aaaaaaaU < 0x55555555) {
LAB_00104daa:
                  iVar8 = (int)local_120 + -1;
...
LAB_00104ae8:
            if ((((iVar31 <= iVar8) ||
                 ((char)((byte)((uint)iVar28 >> 0x18) | (byte)((uint)iVar8 >> 0x18) |
                        (byte)((uint)iVar16 >> 0x18)) < '\0' || local_150 <= iVar28)) ||
                (local_14c <= iVar16)) || ((pppuVar9[iVar28][iVar8][iVar16] & 2) != 0)) {
              pbVar29 = &_build_faces(unsigned_char***,int,int,int,int,int,int,Vector<Face3>&)::
                         indices + uVar30 * 4;

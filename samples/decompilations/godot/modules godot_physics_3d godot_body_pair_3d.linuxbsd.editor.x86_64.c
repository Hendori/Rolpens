...
/* GodotBodyPair3D::solve(float) [clone .part.0] */

void __thiscall GodotBodyPair3D::solve(GodotBodyPair3D *this,float param_1)
  ...
  if (0 < iVar2) {
    ...
    do {
      if (pGVar6[0xdc] != (GodotBodyPair3D)0x0) {
        ...
        fVar14 = *(float *)(pGVar6 + 0xd0) -
                 (fVar18 * ((((*(float *)(lVar5 + 0x130) * local_160._4_4_ -
                              fVar19 * *(float *)(lVar5 + 0x134)) + *(float *)(lVar5 + 0x120)) -
                            *(float *)(lVar4 + 0x120)) -
                           (*(float *)(lVar4 + 0x130) * local_150 -
                           fVar13 * *(float *)(lVar4 + 0x134))) +
                  ((((*(float *)(lVar5 + 0x134) * fVar23 - local_160._4_4_ * *(float *)(lVar5 + 300)
                     ) + *(float *)(lVar5 + 0x124)) - *(float *)(lVar4 + 0x124)) -
                  (*(float *)(lVar4 + 0x134) * fVar15 - *(float *)(lVar4 + 300) * local_150)) *
                  fVar22 + ((((*(float *)(lVar5 + 300) * fVar19 - *(float *)(lVar5 + 0x130) * fVar23
                              ) + *(float *)(lVar5 + 0x128)) - *(float *)(lVar4 + 0x128)) -
                           (*(float *)(lVar4 + 300) * fVar13 - *(float *)(lVar4 + 0x130) * fVar15))
                           * local_164);
        if (__LC2 < (double)ABS(fVar14)) {
          ...
          *(float *)(pGVar6 + 0xc4) = fVar14;
          ...
          if (GVar1 != (GodotBodyPair3D)0x0) {
            ...
            *(ulong *)(lVar4 + 0x120) =
                 CONCAT44((float)((ulong)*(undefined8 *)(lVar4 + 0x120) >> 0x20) + fVar23 * fVar12,
                          (float)*(undefined8 *)(lVar4 + 0x120) + fVar23 * fVar19);
            if (fVar27 != 0.0) {
              ...
              fVar23 = *(float *)(lVar4 + 0x1c8) * fVar25 + fVar13 * *(float *)(lVar4 + 0x1cc) +
                       *(float *)(lVar4 + 0x1d0) * fVar12;
              fVar19 = 0.0;
              fVar15 = *(float *)(lVar4 + 0x1b4) * fVar13 +
                       fVar25 * (float)*(undefined8 *)(lVar4 + 0x1b0) +
                       (float)*(undefined8 *)(lVar4 + 0x1b8) * fVar12;
              fVar13 = *(float *)(lVar4 + 0x1c0) * fVar13 +
                       fVar25 * (float)((ulong)*(undefined8 *)(lVar4 + 0x1b8) >> 0x20) +
                       (float)((ulong)*(undefined8 *)(lVar4 + 0x1c0) >> 0x20) * fVar12;
              ...
              *(ulong *)(lVar4 + 300) =
                   CONCAT44((float)((ulong)*(undefined8 *)(lVar4 + 300) >> 0x20) +
                            (float)((ulong)uVar20 >> 0x20),
                            (float)*(undefined8 *)(lVar4 + 300) + (float)uVar20);
            }
            fVar19 = *(float *)(pGVar6 + 0xf0);
            fVar23 = *(float *)(pGVar6 + 0xec);
          }
          ...
          if (GVar7 == (GodotBodyPair3D)0x0) {
            ...
            *(float *)(lVar5 + 0x128) = fVar13;
            if (fVar27 == 0.0) {
              ...
              fVar18 = *(float *)(lVar5 + 0x1c8) * fVar19 + *(float *)(lVar5 + 0x1cc) * fVar15 +
                       *(float *)(lVar5 + 0x1d0) * fVar23;
              fVar33 = *(float *)(lVar5 + 0x1bc) * fVar19 + *(float *)(lVar5 + 0x1c0) * fVar15 +
                       *(float *)(lVar5 + 0x1c4) * fVar23;
              fVar22 = *(float *)(lVar5 + 0x1b0) * fVar19 + fVar15 * *(float *)(lVar5 + 0x1b4) +
                       fVar23 * *(float *)(lVar5 + 0x1b8);
              if (0.0 < fVar27) {
          ...
          fVar18 = *(float *)(pGVar6 + 0xd0) -
                   (((((fVar18 * fVar23 - fVar14 * fVar22) + fVar30) - *(float *)(lVar4 + 0x124)) -
                    (*(float *)(lVar4 + 0x134) * *(float *)(pGVar6 + 0xe0) -
                    *(float *)(pGVar6 + 0xe8) * *(float *)(lVar4 + 300))) * fVar29 +
                    ((((fVar14 * fVar33 - fVar19 * fVar18) + fVar15) - *(float *)(lVar4 + 0x120)) -
                    (*(float *)(lVar4 + 0x130) * *(float *)(pGVar6 + 0xe8) -
                    *(float *)(pGVar6 + 0xe4) * *(float *)(lVar4 + 0x134))) *
                    *(float *)(pGVar6 + 0x7c) +
                   ((((fVar19 * fVar22 - fVar33 * fVar23) + fVar13) - *(float *)(lVar4 + 0x128)) -
                   (*(float *)(lVar4 + 300) * *(float *)(pGVar6 + 0xe4) -
                   *(float *)(lVar4 + 0x130) * *(float *)(pGVar6 + 0xe0))) * local_164);
          if (__LC2 < (double)ABS(fVar18)) {
            ...
            *(float *)(pGVar6 + 200) = fVar18;
            ...
            if (GVar1 != (GodotBodyPair3D)0x0) {
              ...
              *(ulong *)(lVar4 + 0x120) =
                   CONCAT44((float)((ulong)*(undefined8 *)(lVar4 + 0x120) >> 0x20) - fVar15 * fVar29
                            ,(float)*(undefined8 *)(lVar4 + 0x120) - fVar15 * fVar13);
              *(float *)(lVar4 + 0x128) =
                   (float)((uint)(fVar18 * local_164) ^ __LC4) * fVar15 + *(float *)(lVar4 + 0x128);
            }
            if (GVar7 != (GodotBodyPair3D)0x0) {
              fVar15 = *(float *)(lVar5 + 0x170);
              *(float *)(lVar5 + 0x128) = fVar18 * local_164 * fVar15 + *(float *)(lVar5 + 0x128);
              *(ulong *)(lVar5 + 0x120) =
                   CONCAT44((float)((ulong)*(undefined8 *)(lVar5 + 0x120) >> 0x20) + fVar15 * fVar29
                            ,(float)*(undefined8 *)(lVar5 + 0x120) + fVar15 * fVar13);
            }
            fVar23 = *(float *)(pGVar6 + 0xec);
            local_164 = *(float *)(pGVar6 + 0x84);
            fVar14 = *(float *)(pGVar6 + 0xf4);
        ...
        fVar12 = ((((local_154 * local_a4 - fStack_a0 * fVar23) + fVar30) - fVar29) -
                 (local_b0 * fVar25 - fStack_ac * fStack_14c)) * local_164 +
                 ((((fVar19 * fVar23 - fVar14 * local_a4) + fVar33) - fStack_94) -
                 (fVar15 * fStack_14c - local_150 * local_b0)) * fVar22 +
                 ((((fStack_a0 * fVar14 - local_154 * fVar19) + fVar32) - local_98) -
                 (local_150 * fStack_ac - fVar15 * fVar25)) * (float)uVar26;
        if (__LC2 < (double)ABS(fVar12)) {
          ...
          *(float *)(pGVar6 + 0xb4) = fVar15;
          ...
          if (GVar1 != (GodotBodyPair3D)0x0) {
            ...
            *(ulong *)(lVar4 + 0xd8) =
                 CONCAT44(fVar14 * fVar18 + *(float *)(lVar4 + 0xdc),
                          fVar13 * fVar18 + *(float *)(lVar4 + 0xd8));
            *(ulong *)(lVar4 + 0xe0) =
                 CONCAT44(fVar29 * *(float *)(lVar4 + 0x1b0) + fVar33 * *(float *)(lVar4 + 0x1b4) +
                          fVar32 * *(float *)(lVar4 + 0x1b8) + *(float *)(lVar4 + 0xe4),
                          fVar23 * fVar18 + *(float *)(lVar4 + 0xe0));
            *(ulong *)(lVar4 + 0xe8) =
                 CONCAT44((float)((ulong)*(undefined8 *)(lVar4 + 0xe8) >> 0x20) +
                          (float)((ulong)*(undefined8 *)(lVar4 + 0x1c8) >> 0x20) * fVar33 +
                          *(float *)(lVar4 + 0x1c8) * fVar29 + *(float *)(lVar4 + 0x1d0) * fVar32,
                          (float)*(undefined8 *)(lVar4 + 0xe8) +
                          (float)*(undefined8 *)(lVar4 + 0x1c0) * fVar33 +
                          *(float *)(lVar4 + 0x1bc) * fVar29 + *(float *)(lVar4 + 0x1c4) * fVar32);
            fVar23 = *(float *)(pGVar6 + 0xec);
          }
          if (GVar7 != (GodotBodyPair3D)0x0) {
            ...
            fVar14 = (*(float *)(pGVar6 + 0xf4) + *(float *)(lVar5 + 0x200)) -
                     *(float *)(lVar5 + 0x200);
            fVar29 = fVar23 * fVar22 - fVar13 * fVar19;
            fVar23 = fVar14 * fVar19 - fVar23 * fVar15;
            fVar13 = fVar13 * fVar15 - fVar14 * fVar22;
            *(ulong *)(lVar5 + 0xd8) =
                 CONCAT44(fVar22 * fVar18 + *(float *)(lVar5 + 0xdc),
                          fVar19 * fVar18 + *(float *)(lVar5 + 0xd8));
            *(ulong *)(lVar5 + 0xe0) =
                 CONCAT44(fVar13 * *(float *)(lVar5 + 0x1b0) + fVar23 * *(float *)(lVar5 + 0x1b4) +
                          fVar29 * *(float *)(lVar5 + 0x1b8) + *(float *)(lVar5 + 0xe4),
                          *(float *)(lVar5 + 0xe0) + fVar18 * fVar15);
            *(ulong *)(lVar5 + 0xe8) =
                 CONCAT44((float)((ulong)*(undefined8 *)(lVar5 + 0xe8) >> 0x20) +
                          (float)((ulong)*(undefined8 *)(lVar5 + 0x1c8) >> 0x20) * fVar23 +
                          *(float *)(lVar5 + 0x1c8) * fVar13 + *(float *)(lVar5 + 0x1d0) * fVar29,
                          (float)*(undefined8 *)(lVar5 + 0xe8) +
                          (float)*(undefined8 *)(lVar5 + 0x1c0) * fVar23 +
                          *(float *)(lVar5 + 0x1bc) * fVar13 + *(float *)(lVar5 + 0x1c4) * fVar29);
            fVar23 = *(float *)(pGVar6 + 0xec);
          }
          pGVar6[0xdc] = (GodotBodyPair3D)0x1;
          uVar20 = *(undefined8 *)(pGVar6 + 0xe4);
          ...
          fVar13 = 0.0;
          *(ulong *)(pGVar6 + 0xa8) =
               CONCAT44((float)((ulong)*(undefined8 *)(pGVar6 + 0xa8) >> 0x20) - fVar22,
                        (float)*(undefined8 *)(pGVar6 + 0xa8) - fVar19);
        ...
        fVar29 = ((local_100 * local_154 - fStack_fc * fVar23) + fVar30) -
                 (fVar29 + (local_120 * fVar25 - fStack_11c * fStack_14c));
        fVar30 = ((fStack_fc * fVar14 - fVar19 * (float)local_160) + fVar32) -
                 ((local_150 * fStack_11c - fVar15 * (float)uVar20) + (float)uVar3);
        fVar15 = ((fVar19 * fVar23 - local_100 * (float)((ulong)local_160 >> 0x20)) + fVar33) -
                 ((fStack_14c * fVar15 - local_120 * (float)((ulong)uVar20 >> 0x20)) +
        ...
        fVar18 = SQRT(auVar16._0_4_ * auVar16._0_4_ + auVar16._4_4_ * auVar16._4_4_ +
                      fVar29 * fVar29);
        if (__LC2 < (double)fVar18) {
          ...
          fVar23 = (float)((uint)fVar18 ^ __LC4) /
                   (((fVar15 * fVar23 - fVar14 * fVar22) +
                    (fVar33 * fStack_14c - fVar32 * local_150)) * fVar30 +
                    ((fVar31 * fVar14 - local_154 * fVar15) + (fVar12 * local_150 - fVar33 * fVar25)
                    ) * fVar19 +
                    ((local_154 * fVar22 - fVar31 * fVar23) +
                    (fVar32 * fVar25 - fVar12 * fStack_14c)) * fVar29 + local_138 + local_134);
          ...
          *(ulong *)(pGVar6 + 0xb8) = CONCAT44(fVar14,fVar19);
          ...
          fVar18 = (float)((ulong)*(undefined8 *)(pGVar6 + 0xb8) >> 0x20) -
                   *(float *)(pGVar6 + 0xbc);
          if (GVar1 != (GodotBodyPair3D)0x0) {
            ...
            *(ulong *)(lVar4 + 0xd8) =
                 CONCAT44(fVar30 * fVar23 + *(float *)(lVar4 + 0xdc),
                          fVar14 * fVar23 + *(float *)(lVar4 + 0xd8));
            *(float *)(lVar4 + 0xe0) = fVar22 * fVar23 + *(float *)(lVar4 + 0xe0);
            *(float *)(lVar4 + 0xe4) =
                 fVar29 * *(float *)(lVar4 + 0x1b0) + fVar19 * *(float *)(lVar4 + 0x1b4) +
                 fVar32 * *(float *)(lVar4 + 0x1b8) + *(float *)(lVar4 + 0xe4);
            *(ulong *)(lVar4 + 0xe8) =
                 CONCAT44((float)((ulong)*(undefined8 *)(lVar4 + 0xe8) >> 0x20) +
                          (float)((ulong)*(undefined8 *)(lVar4 + 0x1c8) >> 0x20) * fVar19 +
                          *(float *)(lVar4 + 0x1c8) * fVar29 + *(float *)(lVar4 + 0x1d0) * fVar32,
                          (float)*(undefined8 *)(lVar4 + 0xe8) +
                          (float)*(undefined8 *)(lVar4 + 0x1c0) * fVar19 +
                          *(float *)(lVar4 + 0x1bc) * fVar29 + *(float *)(lVar4 + 0x1c4) * fVar32);
          }
          if (GVar7 != (GodotBodyPair3D)0x0) {
            ...
            fVar29 = (*(float *)(pGVar6 + 0xf4) + *(float *)(lVar5 + 0x200)) -
                     *(float *)(lVar5 + 0x200);
            ...
            auVar21._12_4_ =
                 fVar19 * *(float *)(lVar5 + 0x1b0) + fVar14 * *(float *)(lVar5 + 0x1b4) +
                 fVar22 * *(float *)(lVar5 + 0x1b8) + *(float *)(lVar5 + 0xe4);
            auVar21._8_4_ = fVar23 * fVar15 + *(float *)(lVar5 + 0xe0);
            *(undefined1 (*) [16])(lVar5 + 0xd8) = auVar21;
            *(ulong *)(lVar5 + 0xe8) =
                 CONCAT44((float)((ulong)*(undefined8 *)(lVar5 + 0xe8) >> 0x20) +
                          (float)((ulong)*(undefined8 *)(lVar5 + 0x1c8) >> 0x20) * fVar14 +
                          *(float *)(lVar5 + 0x1c8) * fVar19 + *(float *)(lVar5 + 0x1d0) * fVar22,
                          (float)*(undefined8 *)(lVar5 + 0xe8) +
                          (float)*(undefined8 *)(lVar5 + 0x1c0) * fVar14 +
                          *(float *)(lVar5 + 0x1bc) * fVar19 + *(float *)(lVar5 + 0x1c4) * fVar22);
          }
          pGVar6[0xdc] = (GodotBodyPair3D)0x1;
          *(ulong *)(pGVar6 + 0xa8) =
               CONCAT44((float)((ulong)*(undefined8 *)(pGVar6 + 0xa8) >> 0x20) - fVar18,
                        (float)*(undefined8 *)(pGVar6 + 0xa8) - fVar13);
          *(float *)(pGVar6 + 0xb0) = *(float *)(pGVar6 + 0xb0) - fVar15;
        }
      }
      pGVar6 = pGVar6 + 0x88;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GodotBodySoftBodyPair3D::solve(float) [clone .part.0] */

void __thiscall GodotBodySoftBodyPair3D::solve(GodotBodySoftBodyPair3D *this,float param_1)
    ...
    while( true ) {
      ...
      if (*(char *)(lVar5 + 0x6c) != '\0') {
        ...
        *(undefined1 *)(lVar5 + 0x6c) = 0;
        ...
        fVar13 = *(float *)(lVar5 + 0x60) -
                 (((local_78 - *(float *)(lVar3 + 0x120)) - (fVar14 * fVar20 - fVar13 * fVar10)) *
                  *(float *)(lVar5 + 0xc) +
                  fVar12 * ((fStack_74 - *(float *)(lVar3 + 0x124)) -
                           (fVar17 * fVar10 - fVar24 * fVar14)) +
                 ((auVar29._8_4_ - *(float *)(lVar3 + 0x128)) - (fVar24 * fVar13 - fVar20 * fVar17))
                 * *(float *)(lVar5 + 0x14));
        if (__LC2 < (double)ABS(fVar13)) {
          ...
          *(float *)(lVar5 + 0x54) = fVar13;
          ...
          if (this[0x5c] != (GodotBodySoftBodyPair3D)0x0) {
            ...
            *(ulong *)(lVar3 + 0x120) =
                 CONCAT44((float)((ulong)*(undefined8 *)(lVar3 + 0x120) >> 0x20) + fVar17 * fVar12,
                          (float)*(undefined8 *)(lVar3 + 0x120) + fVar17 * fVar9);
            if (fVar16 != 0.0) {
              ...
              fVar10 = *(float *)(lVar3 + 0x1c8) * fVar21 + *(float *)(lVar3 + 0x1cc) * fVar13 +
                       *(float *)(lVar3 + 0x1d0) * fVar12;
              fVar14 = 0.0;
              fVar17 = fVar13 * *(float *)(lVar3 + 0x1b4) +
                       fVar21 * (float)*(undefined8 *)(lVar3 + 0x1b0) +
                       (float)*(undefined8 *)(lVar3 + 0x1b8) * fVar12;
              fVar13 = fVar13 * *(float *)(lVar3 + 0x1c0) +
                       fVar21 * (float)((ulong)*(undefined8 *)(lVar3 + 0x1b8) >> 0x20) +
                       (float)((ulong)*(undefined8 *)(lVar3 + 0x1c0) >> 0x20) * fVar12;
              ...
              *(ulong *)(lVar3 + 300) =
                   CONCAT44((float)((ulong)*(undefined8 *)(lVar3 + 300) >> 0x20) +
                            (float)((ulong)uVar11 >> 0x20),
                            (float)*(undefined8 *)(lVar3 + 300) + (float)uVar11);
            }
          }
          if (this[0x5d] != (GodotBodySoftBodyPair3D)0x0) {
            GodotSoftBody3D::apply_node_bias_impulse
                      ((uint)*(undefined8 *)(this + 0x50),(Vector3 *)(ulong)*(uint *)(lVar5 + 0x1c))
            ;
          }
          lVar3 = *(long *)(this + 0x48);
          fVar13 = *(float *)(lVar5 + 0x74);
          ...
          fVar13 = *(float *)(lVar5 + 0x60) -
                    ...
                    *(float *)(lVar5 + 0xc) +
                    fVar12 * ((fStack_74 - *(float *)(lVar3 + 0x124)) -
                             (fVar17 * fVar10 - fVar24 * fVar14)) +
                   ((auVar29._8_4_ - *(float *)(lVar3 + 0x128)) -
                   (fVar24 * fVar13 - fVar20 * fVar17)) * *(float *)(lVar5 + 0x14));
          if (__LC2 < (double)ABS(fVar13)) {
            ...
            *(float *)(lVar5 + 0x58) = fVar13;
            ...
            if (this[0x5c] == (GodotBodySoftBodyPair3D)0x0) {
              ...
              fVar17 = *(float *)(lVar3 + 0x170);
              *(float *)(lVar3 + 0x128) =
                   (float)((uint)(*(float *)(lVar5 + 0x14) * fVar13) ^ __LC4) * fVar17 +
                   *(float *)(lVar3 + 0x128);
              *(ulong *)(lVar3 + 0x120) =
                   CONCAT44((float)((ulong)*(undefined8 *)(lVar3 + 0x120) >> 0x20) -
                            fVar13 * fVar12 * fVar17,
                            (float)*(undefined8 *)(lVar3 + 0x120) - fVar13 * (float)uVar11 * fVar17)
              ;
            }
            if (GVar1 != (GodotBodySoftBodyPair3D)0x0) {
              GodotSoftBody3D::apply_node_bias_impulse
                        ((uint)*(undefined8 *)(this + 0x50),
                         (Vector3 *)(ulong)*(uint *)(lVar5 + 0x1c));
            }
          }
        ...
        fVar13 = ((local_78 - local_90) - (fStack_98 * fVar20 - fVar13 * fVar24)) *
                 *(float *)(lVar5 + 0xc) +
                 fVar14 * ((fStack_74 - fStack_8c) - (fVar17 * fVar24 - local_9c * fVar20)) +
                 ((auVar29._8_4_ - fVar10) - (fVar13 * local_9c - fVar17 * fStack_98)) *
                 *(float *)(lVar5 + 0x14);
        if (__LC2 < (double)ABS(fVar13)) {
          ...
          *(float *)(lVar5 + 0x44) = fVar13;
          ...
          if (this[0x5c] != (GodotBodySoftBodyPair3D)0x0) {
            ...
            fVar25 = (*(float *)(lVar5 + 0x78) + *(float *)(lVar3 + 0x200)) -
                     *(float *)(lVar3 + 0x200);
            ...
            *(ulong *)(lVar3 + 0xd8) =
                 CONCAT44(fVar21 * fVar24 + *(float *)(lVar3 + 0xdc),
                          fVar9 * fVar24 + *(float *)(lVar3 + 0xd8));
            *(ulong *)(lVar3 + 0xe0) =
                 CONCAT44(fVar10 * *(float *)(lVar3 + 0x1b0) + fVar12 * *(float *)(lVar3 + 0x1b4) +
                          fVar26 * *(float *)(lVar3 + 0x1b8) + *(float *)(lVar3 + 0xe4),
                          fVar24 * fVar14 + *(float *)(lVar3 + 0xe0));
            *(ulong *)(lVar3 + 0xe8) =
                 CONCAT44((float)((ulong)*(undefined8 *)(lVar3 + 0xe8) >> 0x20) +
                          (float)((ulong)*(undefined8 *)(lVar3 + 0x1c8) >> 0x20) * fVar12 +
                          *(float *)(lVar3 + 0x1c8) * fVar10 + *(float *)(lVar3 + 0x1d0) * fVar26,
                          (float)*(undefined8 *)(lVar3 + 0xe8) +
                          (float)*(undefined8 *)(lVar3 + 0x1c0) * fVar12 +
                          *(float *)(lVar3 + 0x1bc) * fVar10 + *(float *)(lVar3 + 0x1c4) * fVar26);
          }
          if (this[0x5d] != (GodotBodySoftBodyPair3D)0x0) {
            GodotSoftBody3D::apply_node_impulse
                      ((uint)*(undefined8 *)(this + 0x50),(Vector3 *)(ulong)*(uint *)(lVar5 + 0x1c))
            ;
          }
          *(undefined1 *)(lVar5 + 0x6c) = 1;
          *(ulong *)(lVar5 + 0x38) =
               CONCAT44((float)((ulong)*(undefined8 *)(lVar5 + 0x38) >> 0x20) - fVar13,
                        (float)*(undefined8 *)(lVar5 + 0x38) - fVar17);
        ...
        fVar10 = auVar29._4_4_ -
                 ((fVar24 * fVar10 - (float)((ulong)uVar11 >> 0x20) * local_d0) +
                 (float)((ulong)uVar22 >> 0x20));
        fVar24 = auVar29._8_4_ - ((fVar13 * local_d0 - fStack_cc * fVar24) + fVar14);
        fVar13 = *(float *)(lVar5 + 0xc) * fVar17 + fVar10 * *(float *)(lVar5 + 0x10) +
        ...
        fVar13 = SQRT(auVar18._0_4_ * auVar18._0_4_ + auVar18._4_4_ * auVar18._4_4_ +
                      fVar24 * fVar24);
        if (__LC2 < (double)fVar13) {
          ...
          fVar21 = (float)((uint)fVar13 ^ __LC4) /
                   ((fVar21 * fVar17 - fVar14 * fVar12) * fVar26 +
                    (fVar14 * fVar9 - fVar10 * fVar21) * fVar25 +
                    (fVar12 * fVar10 - fVar9 * fVar17) * fVar24 + local_100 + local_f8);
          ...
          *(float *)(lVar5 + 0x50) = fVar21;
          ...
          if ((_LC6 < (double)fVar24) &&
             (fVar20 = fVar20 * *(float *)(lVar5 + 0x44), fVar20 < fVar24)) {
          ...
          if (this[0x5c] != (GodotBodySoftBodyPair3D)0x0) {
            ...
            *(ulong *)(lVar3 + 0xd8) =
                 CONCAT44(fVar9 * fVar13 + *(float *)(lVar3 + 0xdc),
                          fVar20 * fVar13 + *(float *)(lVar3 + 0xd8));
            *(ulong *)(lVar3 + 0xe0) =
                 CONCAT44(fVar17 * *(float *)(lVar3 + 0x1b0) + fVar27 * *(float *)(lVar3 + 0x1b4) +
                          fVar14 * *(float *)(lVar3 + 0x1b8) + *(float *)(lVar3 + 0xe4),
                          fVar24 * fVar13 + *(float *)(lVar3 + 0xe0));
            *(ulong *)(lVar3 + 0xe8) =
                 CONCAT44((float)((ulong)*(undefined8 *)(lVar3 + 0xe8) >> 0x20) +
                          (float)((ulong)*(undefined8 *)(lVar3 + 0x1c8) >> 0x20) * fVar27 +
                          *(float *)(lVar3 + 0x1c8) * fVar17 + *(float *)(lVar3 + 0x1d0) * fVar14,
                          (float)*(undefined8 *)(lVar3 + 0xe8) +
                          (float)*(undefined8 *)(lVar3 + 0x1c0) * fVar27 +
                          *(float *)(lVar3 + 0x1bc) * fVar17 + *(float *)(lVar3 + 0x1c4) * fVar14);
          }
          if (this[0x5d] != (GodotBodySoftBodyPair3D)0x0) {
            GodotSoftBody3D::apply_node_impulse
                      ((uint)*(undefined8 *)(this + 0x50),(Vector3 *)(ulong)*(uint *)(lVar5 + 0x1c))
...
/* GodotBodySoftBodyPair3D::solve(float) */
...
/* CowData<GodotBody3D::Contact>::_copy_on_write() [clone .isra.0] */

void __thiscall CowData<GodotBody3D::Contact>::_copy_on_write(CowData<GodotBody3D::Contact> *this)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GodotBodySoftBodyPair3D::pre_solve(float) [clone .part.0] */

undefined1 __thiscall
GodotBodySoftBodyPair3D::pre_solve(GodotBodySoftBodyPair3D *this,float param_1)
        ...
        do {
          ...
          *(undefined1 *)(lVar27 + 0x6c) = 0;
          if (((GVar14 != (GodotBodySoftBodyPair3D)0x0) &&
              (fVar36 = (float)GodotSoftBody3D::get_node_inv_mass
                                         ((uint)*(undefined8 *)(this + 0x50)), fVar36 != 0.0)) ||
             (local_188 != 0.0)) {
            ...
            fVar35 = *(float *)(lVar16 + 0x60) * fVar32 + *(float *)(lVar16 + 100) * fVar34 +
                     *(float *)(lVar16 + 0x68) * fVar4 + *(float *)(lVar16 + 0x74);
            fVar37 = (float)*(undefined8 *)(lVar16 + 0x48) * fVar32 + fVar34 * fVar10 +
                     (float)*(undefined8 *)(lVar16 + 0x50) * fVar4 +
                     (float)*(undefined8 *)(lVar16 + 0x6c);
            fVar38 = (float)((ulong)*(undefined8 *)(lVar16 + 0x50) >> 0x20) * fVar32 +
                     fVar34 * fVar11 +
                     (float)((ulong)*(undefined8 *)(lVar16 + 0x58) >> 0x20) * fVar4 +
                     (float)((ulong)*(undefined8 *)(lVar16 + 0x6c) >> 0x20);
            ...
            fVar43 = (fVar37 - local_78) * *(float *)(lVar27 + 0xc) + (fVar38 - fVar43) * fVar33 +
                     (fVar35 - fVar52) * fVar39;
            if (0.0 < fVar43) {
...
LAB_00103098:
              ...
              *(float *)(lVar27 + 0x5c) =
                   (float)_LC21 /
                   ((fVar46 * fVar53 - fStack_80 * fVar38) * fVar44 +
                    (fVar38 * local_84 - fVar46 * fVar37) * fVar33 +
                    (fVar37 * fStack_80 - fVar53 * local_84) * fVar39 + fVar36 + local_188);
              ...
              *(float *)(lVar27 + 0x60) = fVar36 * fVar41 * fVar50;
              ...
              if (GVar14 != (GodotBodySoftBodyPair3D)0x0) {
                ...
                *(float *)(lVar24 + 0xe4) =
                     fVar33 * *(float *)(lVar24 + 0x1b0) + fVar50 * *(float *)(lVar24 + 0x1b4) +
                     fVar44 * *(float *)(lVar24 + 0x1b8) + *(float *)(lVar24 + 0xe4);
                *(ulong *)(lVar24 + 0xe8) =
                     CONCAT44((float)((ulong)*(undefined8 *)(lVar24 + 0xe8) >> 0x20) +
                              (float)((ulong)*(undefined8 *)(lVar24 + 0x1c8) >> 0x20) * fVar50 +
                              *(float *)(lVar24 + 0x1c8) * fVar33 +
                              *(float *)(lVar24 + 0x1d0) * fVar44,
                              (float)*(undefined8 *)(lVar24 + 0xe8) +
                              (float)*(undefined8 *)(lVar24 + 0x1c0) * fVar50 +
                              *(float *)(lVar24 + 0x1bc) * fVar33 +
                              *(float *)(lVar24 + 0x1c4) * fVar44);
              }
              if (this[0x5d] != (GodotBodySoftBodyPair3D)0x0) {
                GodotSoftBody3D::apply_node_impulse
                          ((uint)*(undefined8 *)(this + 0x50),
                           (Vector3 *)(ulong)*(uint *)(lVar27 + 0x1c));
                lVar24 = *(long *)(this + 0x48);
              }
              lVar17 = *(long *)(lVar24 + 0x338);
              *(ulong *)(lVar27 + 0x38) =
                   CONCAT44((float)((ulong)*(undefined8 *)(lVar27 + 0x38) >> 0x20) - fVar39,
                            (float)*(undefined8 *)(lVar27 + 0x38) - fVar36);
              *(float *)(lVar27 + 0x40) = *(float *)(lVar27 + 0x40) - fVar38;
              if (lVar17 != 0) {
                ...
                if ((*(long *)(lVar24 + 0x338) != 0) &&
                   (iVar20 = (int)*(undefined8 *)(*(long *)(lVar24 + 0x338) + -8), iVar20 != 0)) {
                  CowData<GodotBody3D::Contact>::_copy_on_write
                            ((CowData<GodotBody3D::Contact> *)(lVar24 + 0x338));
                  iVar21 = *(int *)(lVar24 + 0x340);
                  lVar17 = *(long *)(lVar24 + 0x338);
                  if (iVar21 < iVar20) {
                    *(int *)(lVar24 + 0x340) = iVar21 + 1;
LAB_00103b11:
                    auVar45._8_8_ = auVar13._0_8_;
                    ...
                    *puVar1 = CONCAT44(fVar8 + fVar5 * fVar4 + fVar11 * fVar6 + fVar3 * fVar9,
                                       fVar7 * fVar3 + fVar10 * fVar6 + fVar32 * fVar4 + fVar34);
                    puVar1[1] = CONCAT44(uVar48,fVar35);
                    puVar1[2] = CONCAT44(uVar47,uVar40);
                    puVar1[3] = CONCAT44((fVar33 * fVar39 - fVar37 * local_9c) + fStack_a4,
                                         local_a8 + (fStack_98 * fVar37 - fVar33 * fVar36));
...
LAB_0010367e:
                    if (fVar44 < fVar43) goto LAB_00103b11;
                  }
                }
              }
              if (this[0x5e] == (GodotBodySoftBodyPair3D)0x0) {
                ...
                *(float *)(lVar27 + 100) = fVar36;
                if (fVar36 != 0.0) {
                  ...
                  fStack_74 = auVar55._4_4_;
                  *(float *)(lVar27 + 100) =
                       (((local_78 - local_b4) - (fStack_bc * fVar4 - fVar5 * fVar36)) *
                        *(float *)(lVar27 + 0xc) +
                        ((fStack_74 - fStack_b0) - (fVar3 * fVar5 - local_c0 * fVar4)) *
                        *(float *)(lVar27 + 0x10) +
                       ((auVar55._8_4_ - fVar6) - (local_c0 * fVar36 - fStack_bc * fVar3)) *
                       *(float *)(lVar27 + 0x14)) * *(float *)(lVar27 + 100);
                }
                local_139 = 1;
              }
              else {
...
LAB_00103717:
      _err_print_index_error
                ("operator[]",pcVar25,iVar20,lVar24,uVar26,"p_index",pcVar56,"",false,true);
      _err_flush_stdout();
                    /* WARNING: Does not return */
...
LAB_00103cc5:
  _err_print_index_error
            ("get_shape","modules/godot_physics_3d/godot_collision_object_3d.h",0x7c,lVar23,lVar27,
...
/* GodotBodySoftBodyPair3D::pre_solve(float) */
...
void __thiscall GodotBodySoftBodyPair3D::~GodotBodySoftBodyPair3D(GodotBodySoftBodyPair3D *this)

{
  ...
  *(undefined ***)this = &PTR_get_soft_body_ptr_00109e80;
  ...
  HashMap<GodotConstraint3D*,int,HashMapHasherDefault,HashMapComparatorDefault<GodotConstraint3D*>,DefaultTypedAllocator<HashMapElement<GodotConstraint3D*,int>>>
  ::erase((HashMap<GodotConstraint3D*,int,HashMapHasherDefault,HashMapComparatorDefault<GodotConstraint3D*>,DefaultTypedAllocator<HashMapElement<GodotConstraint3D*,int>>>
           *)(*(long *)(this + 0x48) + 0x2f0),(GodotConstraint3D **)&local_48);
  ...
  if ((lVar7 != 0) && (*(int *)(lVar6 + 0x2ac) != 0)) {
    ...
    if (uVar46 != 0) {
      uVar35 = 0;
LAB_0010419d:
      if (uVar46 != (uint)uVar42) goto LAB_00104150;
      ...
      if ((*puVar41 == 0) ||
         (auVar18._8_8_ = 0, auVar18._0_8_ = (ulong)*puVar41 * lVar9, auVar28._8_8_ = 0,
         auVar28._0_8_ = uVar44, auVar19._8_8_ = 0,
         auVar19._0_8_ = (ulong)((uVar38 + uVar33) - SUB164(auVar18 * auVar28,8)) * lVar9,
         auVar29._8_8_ = 0, auVar29._0_8_ = uVar44, SUB164(auVar19 * auVar29,8) == 0)) {
        uVar45 = (ulong)uVar35;
      }
      else {
        while( true ) {
          ...
          *puVar4 = uVar35;
          ...
          puVar41 = (uint *)(lVar8 + lVar39);
          if ((*puVar41 == 0) ||
             (auVar20._8_8_ = 0, auVar20._0_8_ = (ulong)*puVar41 * lVar9, auVar30._8_8_ = 0,
             auVar30._0_8_ = uVar44, auVar21._8_8_ = 0,
             auVar21._0_8_ =
                  (ulong)((SUB164(auVar22 * auVar32,8) + uVar33) - SUB164(auVar20 * auVar30,8)) *
                  lVar9, auVar31._8_8_ = 0, auVar31._0_8_ = uVar44, SUB164(auVar21 * auVar31,8) == 0
             )) break;
          uVar42 = uVar45;
      ...
      *(uint *)(lVar6 + 0x2ac) = uVar33;
      if (uVar46 < uVar33) {
        ...
        *puVar1 = uVar35;
        *(uint *)(lVar10 + (ulong)*(uint *)(lVar11 + (ulong)*(uint *)(lVar6 + 0x2ac) * 4) * 4) =
             uVar46;
...
LAB_00104150:
  ...
  if ((uVar46 == 0) ||
     (auVar15._8_8_ = 0, auVar15._0_8_ = (ulong)uVar46 * lVar9, auVar25._8_8_ = 0,
     auVar25._0_8_ = uVar44, auVar16._8_8_ = 0,
     auVar16._0_8_ = (ulong)((uVar33 + iVar37) - SUB164(auVar15 * auVar25,8)) * lVar9,
     auVar26._8_8_ = 0, auVar26._0_8_ = uVar44, SUB164(auVar16 * auVar26,8) < uVar35))
  goto LAB_001042d7;
  goto LAB_0010419d;
}
...
void __thiscall GodotBodyPair3D::~GodotBodyPair3D(GodotBodyPair3D *this)

{
  ...
  *(undefined ***)this = &PTR_get_soft_body_ptr_00109e38;
  ...
  HashMap<GodotConstraint3D*,int,HashMapHasherDefault,HashMapComparatorDefault<GodotConstraint3D*>,DefaultTypedAllocator<HashMapElement<GodotConstraint3D*,int>>>
  ::erase((HashMap<GodotConstraint3D*,int,HashMapHasherDefault,HashMapComparatorDefault<GodotConstraint3D*>,DefaultTypedAllocator<HashMapElement<GodotConstraint3D*,int>>>
           *)(*(long *)(this + 0x48) + 0x2f0),(GodotConstraint3D **)&local_28);
  local_28 = this;
  HashMap<GodotConstraint3D*,int,HashMapHasherDefault,HashMapComparatorDefault<GodotConstraint3D*>,DefaultTypedAllocator<HashMapElement<GodotConstraint3D*,int>>>
  ::erase((HashMap<GodotConstraint3D*,int,HashMapHasherDefault,HashMapComparatorDefault<GodotConstraint3D*>,DefaultTypedAllocator<HashMapElement<GodotConstraint3D*,int>>>
           *)(*(long *)(this + 0x50) + 0x2f0),(GodotConstraint3D **)&local_28);
...
void GodotBodyPair3D::contact_added_callback
...

{
  ...
  fVar18 = *(float *)(lVar7 + 0x90) * fVar15 + *(float *)(lVar7 + 0x94) * fVar23 +
           *(float *)(lVar7 + 0x98) * fVar24;
  fVar17 = *(float *)(lVar7 + 0x84) * fVar15 + *(float *)(lVar7 + 0x88) * fVar23 +
           *(float *)(lVar7 + 0x8c) * fVar24;
  fVar21 = (float)*puVar12;
  fVar16 = fVar15 * *(float *)(lVar7 + 0x78) + fVar23 * *(float *)(lVar7 + 0x7c) +
           *(float *)(lVar7 + 0x80) * fVar24;
  fVar19 = fVar21 - fVar2;
  iVar11 = *(int *)(param_1 + 0x290);
  fVar20 = fVar19 * *(float *)(lVar8 + 0x78) + fVar22 * *(float *)(lVar8 + 0x7c) +
           fVar25 * *(float *)(lVar8 + 0x80);
  fVar15 = (float)*(undefined8 *)(lVar8 + 0x88) * fVar22 + *(float *)(lVar8 + 0x84) * fVar19 +
           *(float *)(lVar8 + 0x8c) * fVar25;
  fVar19 = (float)((ulong)*(undefined8 *)(lVar8 + 0x90) >> 0x20) * fVar22 +
           *(float *)(lVar8 + 0x90) * fVar19 + *(float *)(lVar8 + 0x98) * fVar25;
  if (4 < iVar11) {
    if (lVar9 == *(long *)(in_FS_OFFSET + 0x28)) {
      _err_print_error("contact_added_callback","modules/godot_physics_3d/godot_body_pair_3d.cpp",
                       0x32,"Condition \"new_index >= (MAX_CONTACTS + 1)\" is true.",0,0);
      return;
    }
    goto LAB_00104e4e;
  }
  ...
  if (iVar11 < 1) {
LAB_001047e1:
    *(ulong *)(param_1 + (long)iVar11 * 0x88 + 0x90) = CONCAT44(fVar17,fVar16);
    ...
    *(undefined8 *)(param_1 + (long)iVar11 * 0x88 + 0xb0) = 0;
    *(undefined8 *)(param_1 + (long)iVar11 * 0x88 + 0xb8) = 0;
    *(undefined8 *)(param_1 + (long)iVar11 * 0x88 + 0xc0) = 0;
    *(undefined8 *)(param_1 + (long)iVar11 * 0x88 + 200) = 0;
    *(undefined8 *)(param_1 + (long)iVar11 * 0x88 + 0xd0) = 0;
    ...
    *(undefined8 *)(param_1 + (long)iVar11 * 0x88 + 0xe0) = 0;
    *(undefined8 *)(param_1 + (long)iVar11 * 0x88 + 0xe8) = 0;
    *(undefined8 *)(param_1 + (long)iVar11 * 0x88 + 0xf0) = 0;
    *(int *)(param_1 + 0x290) = iVar11 + 1;
  }
  else {
    fVar21 = *(float *)(*(long *)(param_1 + 0x40) + 0xd4) *
             *(float *)(*(long *)(param_1 + 0x40) + 0xd4);
    pVVar10 = param_1 + 0x90;
    iVar13 = 0;
    do {
      if (((fVar16 - *(float *)pVVar10) * (fVar16 - *(float *)pVVar10) +
           (fVar17 - *(float *)(pVVar10 + 4)) * (fVar17 - *(float *)(pVVar10 + 4)) +
           (fVar18 - *(float *)(pVVar10 + 8)) * (fVar18 - *(float *)(pVVar10 + 8)) < fVar21) &&
         ((fVar20 - *(float *)(pVVar10 + 0xc)) * (fVar20 - *(float *)(pVVar10 + 0xc)) +
          (fVar15 - *(float *)(pVVar10 + 0x10)) * (fVar15 - *(float *)(pVVar10 + 0x10)) +
          (fVar19 - *(float *)(pVVar10 + 0x14)) * (fVar19 - *(float *)(pVVar10 + 0x14)) < fVar21)) {
    ...
    iVar13 = 0;
    iVar11 = -1;
    fVar21 = ((*(float *)(lVar7 + 0x58) * fVar17 + *(float *)(lVar7 + 0x54) * fVar16 +
              *(float *)(lVar7 + 0x5c) * fVar18) -
             (*(float *)(lVar8 + 0x58) * fVar15 + *(float *)(lVar8 + 0x54) * fVar20 +
              *(float *)(lVar8 + 0x5c) * fVar19 + fVar1)) * fVar24 +
             ((*(float *)(lVar7 + 0x4c) * fVar17 + *(float *)(lVar7 + 0x48) * fVar16 +
              *(float *)(lVar7 + 0x50) * fVar18) -
             (*(float *)(lVar8 + 0x4c) * fVar15 + *(float *)(lVar8 + 0x48) * fVar20 +
              *(float *)(lVar8 + 0x50) * fVar19 + fVar2)) * (float)lVar26 +
             ((fVar17 * *(float *)(lVar7 + 100) + fVar16 * *(float *)(lVar7 + 0x60) +
              fVar18 * *(float *)(lVar7 + 0x68)) -
             (fVar15 * *(float *)(lVar8 + 100) + fVar20 * *(float *)(lVar8 + 0x60) +
              fVar19 * *(float *)(lVar8 + 0x68) + fVar3)) * local_ec;
    do {
      ...
      fVar22 = ((*(float *)(lVar7 + 0x48) * fVar22 + *(float *)(lVar7 + 0x4c) * fVar23 +
                *(float *)(lVar7 + 0x50) * fVar25) -
               (*(float *)(lVar8 + 0x48) * fVar4 + *(float *)(lVar8 + 0x4c) * fVar5 +
                *(float *)(lVar8 + 0x50) * fVar6 + fVar2)) * *(float *)pVVar10 +
               ((*(float *)(lVar7 + 0x54) * fVar22 + *(float *)(lVar7 + 0x58) * fVar23 +
                *(float *)(lVar7 + 0x5c) * fVar25) -
               (*(float *)(lVar8 + 0x54) * fVar4 + *(float *)(lVar8 + 0x58) * fVar5 +
                *(float *)(lVar8 + 0x5c) * fVar6 + fVar1)) * *(float *)(pVVar10 + 4) +
               ((fVar23 * *(float *)(lVar7 + 100) + fVar22 * *(float *)(lVar7 + 0x60) +
                fVar25 * *(float *)(lVar7 + 0x68)) -
               (*(float *)(lVar8 + 0x68) * fVar6 +
                fVar5 * *(float *)(lVar8 + 100) + fVar4 * *(float *)(lVar8 + 0x60) + fVar3)) *
               *(float *)(pVVar10 + 8);
      if (fVar22 < fVar21) {
        iVar11 = iVar13;
        fVar21 = fVar22;
...
LAB_001049af:
      ...
      *(undefined8 *)(pVVar10 + 0xe0) = 0;
      *(undefined8 *)(pVVar10 + 0xe8) = 0;
      *(undefined8 *)(pVVar10 + 0xf0) = 0;
    }
  }
  if (lVar9 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
...
void GodotBodyPair3D::_contact_added_callback
               (Vector3 *param_1,int param_2,Vector3 *param_3,int param_4,Vector3 *param_5,
               void *param_6)

{
  contact_added_callback
            ((Vector3 *)param_6,(int)param_1,(Vector3 *)(ulong)(uint)param_2,(int)param_3,
             (Vector3 *)(ulong)(uint)param_4);
  return;
}
...
void __thiscall GodotBodyPair3D::validate_contacts(GodotBodyPair3D *this)
...
LAB_001050b2:
        ...
        if (iVar1 < iVar18) {
          ...
          *(undefined8 *)(this + lVar20 * 0x88 + 0x70) =
               *(undefined8 *)(this + (long)iVar21 * 0x88 + 0x70);
          *(undefined8 *)(this + lVar20 * 0x88 + 0x78) = uVar17;
          uVar17 = *(undefined8 *)(this + (long)iVar21 * 0x88 + 0x88);
          *(undefined8 *)(this + lVar20 * 0x88 + 0x80) =
               *(undefined8 *)(this + (long)iVar21 * 0x88 + 0x80);
          *(undefined8 *)(this + lVar20 * 0x88 + 0x88) = uVar17;
          uVar17 = *(undefined8 *)(this + (long)iVar21 * 0x88 + 0x98);
          *(undefined8 *)(this + lVar20 * 0x88 + 0x90) =
               *(undefined8 *)(this + (long)iVar21 * 0x88 + 0x90);
          *(undefined8 *)(this + lVar20 * 0x88 + 0x98) = uVar17;
          uVar17 = *(undefined8 *)(this + (long)iVar21 * 0x88 + 0xa8);
          *(undefined8 *)(this + lVar20 * 0x88 + 0xa0) =
               *(undefined8 *)(this + (long)iVar21 * 0x88 + 0xa0);
          *(undefined8 *)(this + lVar20 * 0x88 + 0xa8) = uVar17;
          uVar17 = *(undefined8 *)(this + (long)iVar21 * 0x88 + 0xb8);
          *(undefined8 *)(this + lVar20 * 0x88 + 0xb0) =
               *(undefined8 *)(this + (long)iVar21 * 0x88 + 0xb0);
          *(undefined8 *)(this + lVar20 * 0x88 + 0xb8) = uVar17;
          uVar17 = *(undefined8 *)(this + (long)iVar21 * 0x88 + 200);
          *(undefined8 *)(this + lVar20 * 0x88 + 0xc0) =
               *(undefined8 *)(this + (long)iVar21 * 0x88 + 0xc0);
          *(undefined8 *)(this + lVar20 * 0x88 + 200) = uVar17;
          uVar17 = *(undefined8 *)(this + (long)iVar21 * 0x88 + 0xd8);
          *(undefined8 *)(this + lVar20 * 0x88 + 0xd0) =
               *(undefined8 *)(this + (long)iVar21 * 0x88 + 0xd0);
          *(undefined8 *)(this + lVar20 * 0x88 + 0xd8) = uVar17;
          uVar17 = *(undefined8 *)(this + (long)iVar21 * 0x88 + 0xe8);
          *(undefined8 *)(this + lVar20 * 0x88 + 0xe0) =
               *(undefined8 *)(this + (long)iVar21 * 0x88 + 0xe0);
          *(undefined8 *)(this + lVar20 * 0x88 + 0xe8) = uVar17;
          *(undefined8 *)(this + lVar20 * 0x88 + 0xf0) =
               *(undefined8 *)(this + (long)iVar21 * 0x88 + 0xf0);
      ...
      fVar26 = *(float *)(lVar15 + 0x60) * fVar22 + *(float *)(lVar15 + 100) * fVar24 +
               *(float *)(lVar15 + 0x68) * fVar23;
      fVar25 = *(float *)(lVar15 + 0x54) * fVar22 + *(float *)(lVar15 + 0x58) * fVar24 +
               *(float *)(lVar15 + 0x5c) * fVar23;
      fVar3 = *(float *)(this + lVar20 * 0x88 + 0x9c);
      fVar4 = *(float *)(this + lVar20 * 0x88 + 0xa0);
      fVar24 = fVar22 * *(float *)(lVar15 + 0x48) + fVar24 * *(float *)(lVar15 + 0x4c) +
               fVar23 * *(float *)(lVar15 + 0x50);
      fVar22 = *(float *)(this + lVar20 * 0x88 + 0xa4);
      fVar28 = *(float *)(lVar13 + 0x60) * fVar3 + *(float *)(lVar13 + 100) * fVar4 +
               *(float *)(lVar13 + 0x68) * fVar22 + *(float *)(this + 0x6c);
      fVar27 = *(float *)(lVar13 + 0x54) * fVar3 + *(float *)(lVar13 + 0x58) * fVar4 +
               *(float *)(lVar13 + 0x5c) * fVar22 + *(float *)(this + 0x68);
      fVar22 = fVar3 * *(float *)(lVar13 + 0x48) + fVar4 * *(float *)(lVar13 + 0x4c) +
               fVar22 * *(float *)(lVar13 + 0x50) + *(float *)(this + 100);
      fVar23 = (fVar24 - fVar22) * *(float *)(this + lVar20 * 0x88 + 0x7c) +
               (fVar25 - fVar27) * *(float *)(this + lVar20 * 0x88 + 0x80) +
               (fVar26 - fVar28) * *(float *)(this + lVar20 * 0x88 + 0x84);
...
/* GodotBodyPair3D::setup(float) */

undefined8 GodotBodyPair3D::setup(float param_1)

{
  ...
  if (((*(uint *)(lVar6 + 0x24) & *(uint *)(lVar9 + 0x20)) == 0) &&
     ((*(uint *)(lVar9 + 0x24) & *(uint *)(lVar6 + 0x20)) == 0)) {
LAB_001055f9:
...
LAB_0010537f:
  ...
  if (iVar7 < 2) {
    ...
    GVar13 = (GodotBodyPair3D)
             ((*(uint *)(*(long *)(in_RDI + 0x48) + 0x24) &
              *(uint *)(*(long *)(in_RDI + 0x50) + 0x20)) != 0);
  }
  in_RDI[0x60] = GVar13;
  iVar7 = GodotBody3D::get_mode();
  lVar9 = *(long *)(in_RDI + 0x48);
  ...
  if ((iVar7 < 2) || ((*(uint *)(lVar9 + 0x20) & *(uint *)(lVar6 + 0x24)) == 0)) {
    *(undefined2 *)(in_RDI + 0x61) = 0;
    if (in_RDI[0x60] == (GodotBodyPair3D)0x0) {
      if (((*(long *)(lVar9 + 0x338) == 0) || (*(int *)(*(long *)(lVar9 + 0x338) + -8) < 1)) &&
         ((*(long *)(lVar6 + 0x338) == 0 || (*(int *)(*(long *)(lVar6 + 0x338) + -8) < 1))))
      goto LAB_001055f9;
  ...
  *(ulong *)(in_RDI + 100) =
       CONCAT44((float)((ulong)uVar5 >> 0x20) - (float)((ulong)uVar1 >> 0x20),
                (float)uVar5 - (float)uVar1);
              ...
              if (lVar10 < *(long *)(lVar8 + -8)) {
                GVar13 = (GodotBodyPair3D)
                         GodotCollisionSolver3D::solve_static
                                   (*(GodotShape3D **)(lVar6 + 0x80 + lVar11),local_c8,
                                    *(GodotShape3D **)(lVar8 + 0x80 + lVar10 * 0x90),
                                    (Transform3D *)&local_68,_contact_added_callback,in_RDI,
                                    (Vector3 *)(in_RDI + 0x30),0.0,0.0);
                in_RDI[0x3c] = GVar13;
                if (GVar13 == (GodotBodyPair3D)0x0) {
                  if (((*(char *)(*(long *)(in_RDI + 0x48) + 0x2ba) == '\0') ||
                      (in_RDI[0x60] == (GodotBodyPair3D)0x0)) &&
                     ((*(char *)(*(long *)(in_RDI + 0x50) + 0x2ba) == '\0' ||
                      (in_RDI[0x61] == (GodotBodyPair3D)0x0)))) goto LAB_001055fd;
...
LAB_0010572b:
        _err_print_index_error
                  ("get_shape","modules/godot_physics_3d/godot_collision_object_3d.h",0x7c,lVar9,
...
LAB_001056c0:
  _err_print_index_error
            ("get_shape_transform","modules/godot_physics_3d/godot_collision_object_3d.h",0x80,lVar8
             ,lVar6,"p_index","shapes.size()","",false,true);
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar3 = (code *)invalidInstructionException();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GodotBodyPair3D::_test_ccd(float, GodotBody3D*, int, Transform3D const&, GodotBody3D*, int,
   Transform3D const&) */

undefined8
GodotBodyPair3D::_test_ccd
          (float param_1,GodotBody3D *param_2,int param_3,Transform3D *param_4,GodotBody3D *param_5,
          int param_6,Transform3D *param_7)
  ...
  if ((int)param_4 < 0) {
    ...
    if (_LC6 <= (double)fVar17) {
      ...
      if ((double)(local_1e0 - local_1e4) * __LC33 < (double)fVar17) {
        ...
        auVar21._0_4_ =
             (float)*(undefined8 *)(param_5 + 0xc) * fVar18 + (float)*(undefined8 *)param_5 * fVar27
             + (float)*(undefined8 *)(param_5 + 0x18) * local_1c8;
        auVar21._4_4_ =
             (float)((ulong)*(undefined8 *)(param_5 + 0xc) >> 0x20) * fVar18 +
             (float)((ulong)*(undefined8 *)param_5 >> 0x20) * fVar27 +
             (float)((ulong)*(undefined8 *)(param_5 + 0x18) >> 0x20) * local_1c8;
        auVar21._8_8_ = 0;
        ...
        if (0 < local_1dc) {
          ...
          do {
            ...
            fVar18 = *(float *)(param_5 + 0x18) * fVar30 + *(float *)(param_5 + 0x1c) * fVar25 +
                     *(float *)(param_5 + 0x20) * fVar17 + *(float *)(param_5 + 0x2c);
            uVar2 = *(undefined8 *)(param_5 + 0x10);
            fVar28 = fVar29 + fVar18;
            uVar3 = *(undefined8 *)(param_5 + 0x24);
            pfVar10[2] = fVar18;
            *(ulong *)pfVar10 =
                 CONCAT44(fVar24 * fVar25 + fVar30 * (float)((ulong)uVar7 >> 0x20) +
                          (float)((ulong)uVar2 >> 0x20) * fVar17 + (float)((ulong)uVar3 >> 0x20),
                          fVar27 * fVar25 + fVar30 * (float)uVar1 + (float)uVar7 * fVar17 +
                          (float)uVar3);
            fVar17 = *pfVar10;
            fVar24 = pfVar10[1];
            ...
            local_1b0 = CONCAT44(fStack_12c * fVar27 + local_128 * fVar30 + fStack_124 * fVar28 +
                                 fVar25,(float)local_138 * fVar27 + local_138._4_4_ * fVar30 +
                                        local_130 * fVar28 + (float)local_114);
            local_1c0 = CONCAT44(fVar17 * fStack_12c + fVar24 * local_128 + fVar18 * fStack_124 +
                                 fVar25,fVar17 * (float)local_138 + fVar24 * local_138._4_4_ +
                                        fVar18 * local_130 + (float)local_114);
...
LAB_00106051:
            ...
            plVar4 = *(long **)(lVar9 + 0x80 + lVar8 * 0x90);
            cVar6 = (**(code **)(*plVar4 + 0x38))
                              (plVar4,&local_1c0,&local_1b0,&local_180,&local_174,&local_1d4,1);
            if (cVar6 != '\0') {
              fVar17 = SQRT(((float)local_180 - (float)local_1c0) *
                            ((float)local_180 - (float)local_1c0) +
                            (local_180._4_4_ - local_1c0._4_4_) *
                            (local_180._4_4_ - local_1c0._4_4_) +
                            (local_178 - local_1b8) * (local_178 - local_1b8));
              if (fVar17 < local_208) {
                local_208 = fVar17;
                local_204 = iVar15;
                local_200 = local_178;
          ...
          if (local_204 != -1) {
            fVar29 = local_100[lVar9 * 3] -
                     (local_150 * local_1f8 + local_14c * local_1fc + local_148 * local_200 +
                     local_13c);
            uVar7 = 1;
            fVar24 = local_100[lVar9 * 3 + -1] -
                     (local_15c * local_1f8 + local_158 * local_1fc + local_154 * local_200 +
                     local_140);
            fVar17 = local_100[lVar9 * 3 + -2] -
                     (local_200 * local_160 + local_1f8 * local_168 + local_1fc * local_164 +
                     local_144);
            fVar17 = (float)((double)SQRT(fVar29 * fVar29 + fVar17 * fVar17 + fVar24 * fVar24) +
                            (double)(local_1e0 - local_1e4) * __LC35);
...
LAB_00106055:
  _err_print_index_error
            ("get_shape","modules/godot_physics_3d/godot_collision_object_3d.h",0x7c,lVar8,lVar14,
             "p_index","shapes.size()","",false,true);
  _err_flush_stdout();
                    /* WARNING: Does not return */
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GodotBodyPair3D::pre_solve(float) */

GodotBodyPair3D __thiscall GodotBodyPair3D::pre_solve(GodotBodyPair3D *this,float param_1)
  ...
  if (GVar7 == (GodotBodyPair3D)0x0) {
    if (this[0x3d] != (GodotBodyPair3D)0x0) {
      ...
      Transform3D::Transform3D
                ((Transform3D *)&local_108,(Basis *)(lVar12 + 0x48),(Vector3 *)local_78);
...
LAB_00107650:
        ...
        if (*(long *)(lVar15 + 0x38) != 0) {
          ...
          if ((*(char *)(*(long *)(this + 0x48) + 0x2ba) != '\0') &&
             (this[0x60] != (GodotBodyPair3D)0x0)) {
            _test_ccd(param_1,(GodotBody3D *)this,(int)*(long *)(this + 0x48),
                      (Transform3D *)(ulong)*(uint *)(this + 0x58),(GodotBody3D *)&local_d8,
                      (int)*(undefined8 *)(this + 0x50),(Transform3D *)(ulong)*(uint *)(this + 0x5c)
                     );
          }
          if ((*(char *)(*(long *)(this + 0x50) + 0x2ba) != '\0') &&
             (this[0x61] != (GodotBodyPair3D)0x0)) {
            _test_ccd(param_1,(GodotBody3D *)this,(int)*(long *)(this + 0x50),
                      (Transform3D *)(ulong)*(uint *)(this + 0x5c),(GodotBody3D *)local_78,
                      (int)*(undefined8 *)(this + 0x48),(Transform3D *)(ulong)*(uint *)(this + 0x58)
                     );
          }
          goto LAB_001061ca;
        }
...
LAB_00107661:
      _err_print_index_error
                ("get_shape_transform","modules/godot_physics_3d/godot_collision_object_3d.h",0x80,
                 lVar17,lVar15,"p_index","shapes.size()","",false,true);
      _err_flush_stdout();
                    /* WARNING: Does not return */
...
LAB_00107600:
    ...
    local_78[0] = (Transform3D)0x0;
    local_78[1] = (Transform3D)0x0;
    local_78[2] = (Transform3D)0x0;
    local_78[3] = (Transform3D)0x0;
    local_78[4] = (Transform3D)0x0;
    local_78[5] = (Transform3D)0x0;
    local_78[6] = (Transform3D)0x0;
    local_78[7] = (Transform3D)0x0;
    local_78[8] = (Transform3D)0x0;
    local_78[9] = (Transform3D)0x0;
    local_78[10] = (Transform3D)0x0;
    local_78[0xb] = (Transform3D)0x0;
    local_78[0xc] = (Transform3D)0x0;
    local_78[0xd] = (Transform3D)0x0;
    local_78[0xe] = (Transform3D)0x0;
    local_78[0xf] = (Transform3D)0x0;
    local_68 = (undefined1  [16])0x0;
...
LAB_0010631f:
    ...
    if (0 < *(int *)(this + 0x290)) {
      ...
      do {
        ...
        fVar46 = *(float *)(pGVar26 + 0x14) * *(float *)(lVar12 + 0x60) +
                 *(float *)(lVar12 + 100) * fVar29 + *(float *)(lVar12 + 0x68) * fVar27;
        fVar28 = (float)((ulong)*(undefined8 *)(pGVar26 + 0x10) >> 0x20);
        fVar34 = (float)*(undefined8 *)(lVar12 + 0x48) * fVar28 + *(float *)(lVar12 + 0x4c) * fVar29
                 + (float)*(undefined8 *)(lVar12 + 0x50) * fVar27;
        fVar36 = (float)((ulong)*(undefined8 *)(lVar12 + 0x50) >> 0x20) * fVar28 +
                 *(float *)(lVar12 + 0x58) * fVar29 +
                 (float)((ulong)*(undefined8 *)(lVar12 + 0x58) >> 0x20) * fVar27;
        fVar31 = (float)*(undefined8 *)(pGVar26 + 0x20);
        fVar44 = (float)((ulong)*(undefined8 *)(pGVar26 + 0x20) >> 0x20);
        fVar29 = *(float *)(pGVar26 + 0x28);
        fVar27 = *(float *)(lVar10 + 0x60) * fVar31 + fVar44 * *(float *)(lVar10 + 100) +
                 *(float *)(lVar10 + 0x68) * fVar29 + *(float *)(this + 0x6c);
        fVar28 = (float)*(undefined8 *)(lVar10 + 0x48) * fVar31 + fVar44 * *(float *)(lVar10 + 0x4c)
                 + (float)*(undefined8 *)(lVar10 + 0x50) * fVar29 +
                 (float)*(undefined8 *)(this + 100);
        fVar31 = (float)((ulong)*(undefined8 *)(lVar10 + 0x50) >> 0x20) * fVar31 +
                 fVar44 * *(float *)(lVar10 + 0x58) +
                 (float)((ulong)*(undefined8 *)(lVar10 + 0x58) >> 0x20) * fVar29 +
                 (float)((ulong)*(undefined8 *)(this + 100) >> 0x20);
        fVar29 = (fVar34 - fVar28) * *(float *)pGVar26 + (fVar36 - fVar31) * *(float *)(pGVar26 + 4)
                 + (fVar46 - fVar27) * *(float *)(pGVar26 + 8);
        if (0.0 < fVar29) {
...
LAB_001078c5:
          ...
          *(ulong *)(pGVar26 + 100) =
               CONCAT44(fVar36 - (float)((ulong)*(undefined8 *)(lVar15 + 0x1f8) >> 0x20),
                        fVar34 - (float)*(undefined8 *)(lVar15 + 0x1f8));
          ...
          *(ulong *)(pGVar26 + 0x70) =
               CONCAT44((fVar31 - (float)((ulong)uVar5 >> 0x20)) - (float)((ulong)uVar6 >> 0x20),
                        (fVar28 - (float)uVar5) - (float)uVar6);
          fVar30 = fVar52 * fVar44 - fVar4 * local_238;
          fVar33 = fVar51 * local_238 - fVar52 * fVar50;
          fVar37 = fVar4 * fVar50 - fVar44 * fVar51;
          fVar35 = *(float *)(pTVar22 + 0x1c) * fVar33 + *(float *)(pTVar22 + 0x18) * fVar37 +
                   *(float *)(pTVar22 + 0x20) * fVar30;
          fVar39 = *(float *)(pGVar26 + 0x74);
          fVar47 = *(float *)(pTVar22 + 0x10) * fVar33 + *(float *)(pTVar22 + 0xc) * fVar37 +
                   *(float *)(pTVar22 + 0x14) * fVar30;
          fVar54 = *(float *)(pGVar26 + 0x70);
          fVar33 = fVar33 * *(float *)(pTVar22 + 4) + fVar37 * *(float *)pTVar22 +
                   fVar30 * *(float *)(pTVar22 + 8);
          fVar53 = fVar54 * fVar44 - fVar39 * local_238;
          fVar30 = fVar43 * local_238 - fVar54 * fVar50;
          fVar37 = fVar39 * fVar50 - fVar44 * fVar43;
          fVar38 = *(float *)(pTVar25 + 0x1c) * fVar30 + *(float *)(pTVar25 + 0x18) * fVar37 +
                   *(float *)(pTVar25 + 0x20) * fVar53;
          fVar48 = *(float *)(pTVar25 + 0x10) * fVar30 + *(float *)(pTVar25 + 0xc) * fVar37 +
                   *(float *)(pTVar25 + 0x14) * fVar53;
          fVar30 = fVar30 * *(float *)(pTVar25 + 4) + *(float *)pTVar25 * fVar37 +
                   fVar53 * *(float *)(pTVar25 + 8);
          fVar37 = fVar3 - fVar29;
          *(float *)(pGVar26 + 0x50) =
               (float)_LC21 /
               ((fVar47 * fVar51 - fVar35 * fVar4) * local_238 +
                (fVar35 * fVar52 - fVar33 * fVar51) * fVar44 +
                (fVar33 * fVar4 - fVar47 * fVar52) * fVar50 +
                (fVar30 * fVar39 - fVar48 * fVar54) * fVar50 +
                (fVar48 * fVar43 - fVar38 * fVar39) * local_238 +
                (fVar38 * fVar54 - fVar30 * fVar43) * fVar44 + local_1f4 + local_1f0);
          if (0.0 < fVar37) {
            fVar37 = 0.0;
          }
          ...
          *(float *)(pGVar26 + 0x54) = fVar32 * fVar42 * fVar37;
          ...
          fVar33 = fVar33 * (float)((ulong)*(undefined8 *)pGVar26 >> 0x20) +
                   (float)((ulong)*(undefined8 *)(pGVar26 + 0x3c) >> 0x20);
          *(ulong *)(pGVar26 + 0x2c) =
               CONCAT44((float)((ulong)*(undefined8 *)(pGVar26 + 0x2c) >> 0x20) - fVar33,
                        (float)*(undefined8 *)(pGVar26 + 0x2c) - fVar30);
          *(float *)(pGVar26 + 0x34) = *(float *)(pGVar26 + 0x34) - fVar35;
          if ((lVar16 != 0) || (*(long *)(lVar17 + 0x338) != 0)) {
            ...
            if ((lVar16 != 0) && (iVar20 = (int)*(undefined8 *)(lVar16 + -8), iVar20 != 0)) {
              ...
              CowData<GodotBody3D::Contact>::_copy_on_write
                        ((CowData<GodotBody3D::Contact> *)(lVar15 + 0x338));
...
LAB_00106cf6:
                  if (fVar37 < fVar29) goto LAB_0010770a;
                }
              }
            }
...
LAB_00106eb0:
                  if (fVar39 < fVar29) goto LAB_001077fb;
                }
              }
            }
          }
          if (this[0x62] == (GodotBodyPair3D)0x0) {
            ...
            if (this[0x60] != (GodotBodyPair3D)0x0) {
              ...
              fVar31 = (*(float *)(pGVar26 + 0x6c) + *(float *)(lVar15 + 0x200)) -
                       *(float *)(lVar15 + 0x200);
              ...
              *(ulong *)(lVar15 + 0xd8) =
                   CONCAT44(fVar36 * fVar29 + *(float *)(lVar15 + 0xdc),
                            fVar27 * fVar29 + *(float *)(lVar15 + 0xd8));
              *(ulong *)(lVar15 + 0xe0) =
                   CONCAT44(fVar28 * *(float *)(lVar15 + 0x1b0) +
                            fVar44 * *(float *)(lVar15 + 0x1b4) +
                            fVar46 * *(float *)(lVar15 + 0x1b8) + *(float *)(lVar15 + 0xe4),
                            fVar29 * fVar34 + *(float *)(lVar15 + 0xe0));
              *(ulong *)(lVar15 + 0xe8) =
                   CONCAT44((float)((ulong)*(undefined8 *)(lVar15 + 0xe8) >> 0x20) +
                            (float)((ulong)*(undefined8 *)(lVar15 + 0x1c8) >> 0x20) * fVar44 +
                            *(float *)(lVar15 + 0x1c8) * fVar28 +
                            *(float *)(lVar15 + 0x1d0) * fVar46,
                            (float)*(undefined8 *)(lVar15 + 0xe8) +
                            (float)*(undefined8 *)(lVar15 + 0x1c0) * fVar44 +
                            *(float *)(lVar15 + 0x1bc) * fVar28 +
                            *(float *)(lVar15 + 0x1c4) * fVar46);
            }
            lVar17 = *(long *)(this + 0x50);
            if (this[0x61] != (GodotBodyPair3D)0x0) {
              ...
              fVar28 = (*(float *)(pGVar26 + 0x78) + *(float *)(lVar17 + 0x200)) -
                       *(float *)(lVar17 + 0x200);
              ...
              *(ulong *)(lVar17 + 0xd8) =
                   CONCAT44(fVar33 * fVar29 + *(float *)(lVar17 + 0xdc),
                            fVar30 * fVar29 + *(float *)(lVar17 + 0xd8));
              *(ulong *)(lVar17 + 0xe0) =
                   CONCAT44(fVar27 * *(float *)(lVar17 + 0x1b0) +
                            fVar31 * *(float *)(lVar17 + 0x1b4) +
                            fVar44 * *(float *)(lVar17 + 0x1b8) + *(float *)(lVar17 + 0xe4),
                            fVar35 * fVar29 + *(float *)(lVar17 + 0xe0));
              *(ulong *)(lVar17 + 0xe8) =
                   CONCAT44((float)((ulong)*(undefined8 *)(lVar17 + 0xe8) >> 0x20) +
                            (float)((ulong)*(undefined8 *)(lVar17 + 0x1c8) >> 0x20) * fVar31 +
                            *(float *)(lVar17 + 0x1c8) * fVar27 +
                            *(float *)(lVar17 + 0x1d0) * fVar44,
                            (float)*(undefined8 *)(lVar17 + 0xe8) +
                            (float)*(undefined8 *)(lVar17 + 0x1c0) * fVar31 +
                            *(float *)(lVar17 + 0x1bc) * fVar27 +
                            *(float *)(lVar17 + 0x1c4) * fVar44);
            }
            ...
            if (fVar29 < 0.0) {
              *(float *)(pGVar26 + 0x58) = 0.0;
              ...
              fVar27 = (float)_LC21;
              if (((float)_LC21 < fVar29) ||
                 (*(float *)(pGVar26 + 0x58) = fVar29, fVar27 = fVar29, fVar29 != 0.0)) {
                ...
                *(float *)(pGVar26 + 0x58) =
                     (((((local_d0 * *(float *)(pGVar26 + 0x70) -
                         *(float *)(pGVar26 + 0x78) * (float)local_d8) + fStack_110) -
                       local_108._4_4_) -
                      (fVar29 * *(float *)(pGVar26 + 100) -
                      *(float *)(pGVar26 + 0x6c) * (float)local_a8)) * *(float *)(pGVar26 + 4) +
                      ((((*(float *)(pGVar26 + 0x78) * local_d8._4_4_ -
                         *(float *)(pGVar26 + 0x74) * local_d0) + local_114) - (float)local_108) -
                      (local_a8._4_4_ * *(float *)(pGVar26 + 0x6c) -
                      *(float *)(pGVar26 + 0x68) * fVar29)) * *(float *)pGVar26 +
                     ((((*(float *)(pGVar26 + 0x74) * (float)local_d8 -
                        *(float *)(pGVar26 + 0x70) * local_d8._4_4_) + *(float *)(lVar17 + 0xf8)) -
                      local_100) -
                     ((float)local_a8 * *(float *)(pGVar26 + 0x68) -
                     local_a8._4_4_ * *(float *)(pGVar26 + 100))) * *(float *)(pGVar26 + 8)) *
                     fVar27;
                local_108 = uVar11;
                local_d8 = uVar6;
                local_a8 = uVar5;
...
LAB_0010760d:
  _err_print_index_error
            ("get_shape","modules/godot_physics_3d/godot_collision_object_3d.h",0x7c,lVar17,lVar23,
             "p_index","shapes.size()","",false,true);
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar13 = (code *)invalidInstructionException();
...
/* combine_bounce(GodotBody3D*, GodotBody3D*) */

float combine_bounce(GodotBody3D *param_1,GodotBody3D *param_2)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* combine_friction(GodotBody3D*, GodotBody3D*) */

ulong combine_friction(GodotBody3D *param_1,GodotBody3D *param_2)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GodotBodySoftBodyPair3D::contact_added_callback(Vector3 const&, int, Vector3 const&, int, Vector3
   const&) */

void __thiscall
GodotBodySoftBodyPair3D::contact_added_callback
          (GodotBodySoftBodyPair3D *this,Vector3 *param_1,int param_2,Vector3 *param_3,int param_4,
          Vector3 *param_5)

{
  ...
  fVar11 = *(float *)(lVar15 + 0x90) * fVar14 + *(float *)(lVar15 + 0x94) * fVar10 +
           *(float *)(lVar15 + 0x98) * fVar9 + *(float *)(lVar15 + 0xa4);
  fVar12 = *(float *)(lVar15 + 0x84) * fVar14 + *(float *)(lVar15 + 0x88) * fVar10 +
           *(float *)(lVar15 + 0x8c) * fVar9 + *(float *)(lVar15 + 0xa0);
  fVar9 = fVar9 * *(float *)(lVar15 + 0x80);
  fVar10 = *(float *)(lVar15 + 0x9c) +
           fVar14 * *(float *)(lVar15 + 0x78) + fVar10 * *(float *)(lVar15 + 0x7c) + fVar9;
  ...
  uStack_110 = 0;
  local_108 = 0;
  if ((*(float *)param_1 - *(float *)param_3) * *(float *)param_5 +
      (*(float *)(param_1 + 4) - fVar13) * fVar6 + (*(float *)(param_1 + 8) - fVar16) * fVar14 < 0.0
     ) {
  ...
  if (uVar7 != 0) {
    ...
    do {
      if (*(int *)((long)puVar3 + 0x1c) == param_4) {
        ...
        fVar6 = *(float *)(*(long *)(this + 0x40) + 0xd4) *
                *(float *)(*(long *)(this + 0x40) + 0xd4);
        if ((fVar6 <= (fVar10 - *(float *)(puVar3 + 4)) * (fVar10 - *(float *)(puVar3 + 4)) +
                      fVar13 * fVar13 +
                      (fVar11 - *(float *)(puVar3 + 5)) * (fVar11 - *(float *)(puVar3 + 5))) ||
           (fVar13 = local_c8 - *(float *)((long)puVar3 + 0x2c),
           fStack_c4 = fStack_c4 - *(float *)(puVar3 + 6),
           fVar9 = fVar9 - *(float *)((long)puVar3 + 0x34),
           fVar6 <= fVar13 * fVar13 + fStack_c4 * fStack_c4 + fVar9 * fVar9)) {
          uVar5 = 0;
          uVar7 = 0;
        }
        else {
...
void GodotBodySoftBodyPair3D::_contact_added_callback
               (Vector3 *param_1,int param_2,Vector3 *param_3,int param_4,Vector3 *param_5,
               void *param_6)
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* GodotBodySoftBodyPair3D::validate_contacts() */

void __thiscall GodotBodySoftBodyPair3D::validate_contacts(GodotBodySoftBodyPair3D *this)
...
LAB_00108050:
      ...
      if (uVar17 < uVar23) {
        ...
        *(undefined8 *)(*pauVar3 + 8) = uVar16;
        uVar16 = *(undefined8 *)(pauVar2[1] + 8);
        *(undefined8 *)pauVar3[1] = *(undefined8 *)pauVar2[1];
        *(undefined8 *)(pauVar3[1] + 8) = uVar16;
        uVar16 = *(undefined8 *)(pauVar2[2] + 8);
        *(undefined8 *)pauVar3[2] = *(undefined8 *)pauVar2[2];
        *(undefined8 *)(pauVar3[2] + 8) = uVar16;
        uVar16 = *(undefined8 *)(pauVar2[3] + 8);
        *(undefined8 *)pauVar3[3] = *(undefined8 *)pauVar2[3];
        *(undefined8 *)(pauVar3[3] + 8) = uVar16;
        uVar16 = *(undefined8 *)(pauVar2[4] + 8);
        *(undefined8 *)pauVar3[4] = *(undefined8 *)pauVar2[4];
        *(undefined8 *)(pauVar3[4] + 8) = uVar16;
        uVar16 = *(undefined8 *)(pauVar2[5] + 8);
        *(undefined8 *)pauVar3[5] = *(undefined8 *)pauVar2[5];
        *(undefined8 *)(pauVar3[5] + 8) = uVar16;
        uVar16 = *(undefined8 *)(pauVar2[6] + 8);
        *(undefined8 *)pauVar3[6] = *(undefined8 *)pauVar2[6];
        *(undefined8 *)(pauVar3[6] + 8) = uVar16;
        uVar16 = *(undefined8 *)(pauVar2[7] + 8);
        *(undefined8 *)pauVar3[7] = *(undefined8 *)pauVar2[7];
        *(undefined8 *)(pauVar3[7] + 8) = uVar16;
      ...
      if (uVar1 <= uVar21) {
LAB_00108370:
        if (uVar23 < (uint)uVar22) goto LAB_0010846f;
          ...
          *(long *)(this + 0x68) = lVar20;
          if (lVar20 == 0) {
            _err_print_error("resize","./core/templates/local_vector.h",0xa3,
                             "FATAL: Condition \"!data\" is true.","Out of memory",0,0,uVar22);
            _err_flush_stdout();
                    /* WARNING: Does not return */
...
LAB_0010846f:
      ...
      fVar27 = *(float *)(lVar20 + 0x60) * fVar24 + *(float *)(lVar20 + 100) * fVar25 +
               *(float *)(lVar20 + 0x68) * fVar28 + *(float *)(lVar20 + 0x74);
      fVar26 = *(float *)(lVar20 + 0x54) * fVar24 + *(float *)(lVar20 + 0x58) * fVar25 +
               *(float *)(lVar20 + 0x5c) * fVar28 + *(float *)(lVar20 + 0x70);
      fVar25 = *(float *)(lVar20 + 0x6c) +
               fVar24 * *(float *)(lVar20 + 0x48) + fVar25 * *(float *)(lVar20 + 0x4c) +
               fVar28 * *(float *)(lVar20 + 0x50);
      ...
      fVar24 = (fVar25 - local_c8) * *(float *)(*pauVar3 + 0xc) +
               (fVar26 - fStack_c4) * *(float *)pauVar3[1] +
               (fVar27 - fVar28) * *(float *)(pauVar3[1] + 4);
  ...
  _err_print_index_error
            ("operator[]","./core/templates/local_vector.h",0xb2,(ulong)uVar17,uVar22,"p_index",
             "count","",false,true);
  _err_flush_stdout();
                    /* WARNING: Does not return */
  pcVar15 = (code *)invalidInstructionException();
...
/* GodotBodySoftBodyPair3D::setup(float) */

void GodotBodySoftBodyPair3D::setup(float param_1)

{
  ...
  local_20 = *(long *)(in_FS_OFFSET + 0x28);
  if (((*(uint *)(lVar9 + 0x24) & *(uint *)(lVar4 + 0x20)) == 0) &&
     ((*(uint *)(lVar4 + 0x24) & *(uint *)(lVar9 + 0x20)) == 0)) {
LAB_001087e9:
...
LAB_0010867f:
  ...
  if (iVar5 < 2) {
    ...
    GVar10 = (GodotBodySoftBodyPair3D)
             ((*(uint *)(*(long *)(in_RDI + 0x50) + 0x20) & *(uint *)(lVar4 + 0x24)) != 0);
  }
  GVar11 = (GodotBodySoftBodyPair3D)
           ((*(uint *)(lVar4 + 0x20) & *(uint *)(*(long *)(in_RDI + 0x50) + 0x24)) != 0);
  in_RDI[0x5c] = GVar10;
  in_RDI[0x5d] = GVar11;
  if ((GVar10 == (GodotBodySoftBodyPair3D)0x0) && (!(bool)GVar11)) {
    param_1 = extraout_XMM0_Da;
    if ((*(long *)(lVar4 + 0x338) == 0) || (*(int *)(*(long *)(lVar4 + 0x338) + -8) < 1))
    goto LAB_001087e9;
          ...
          if ((long)iVar5 < *(long *)(lVar4 + -8)) {
            ...
            if (lVar9 == 0) {
              ...
              if (0 < lVar6) {
                GVar10 = (GodotBodySoftBodyPair3D)
                         GodotCollisionSolver3D::solve_static
                                   (*(GodotShape3D **)(lVar4 + 0x80 + (long)iVar5 * 0x90),aTStack_b8
                                    ,*(GodotShape3D **)(lVar9 + 0x80),local_58,
                                    _contact_added_callback,in_RDI,(Vector3 *)(in_RDI + 0x30),0.0,
                                    0.0);
...
LAB_00108910:
        _err_print_index_error
                  ("get_shape","modules/godot_physics_3d/godot_collision_object_3d.h",0x7c,lVar4,
                   lVar6,"p_index","shapes.size()","",false,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
        pcVar2 = (code *)invalidInstructionException();
...
LAB_001088bb:
  _err_print_index_error
            ("get_shape_transform","modules/godot_physics_3d/godot_collision_object_3d.h",0x80,lVar6
...
/* GodotBodyPair3D::GodotBodyPair3D(GodotBody3D*, int, GodotBody3D*, int) */

void __thiscall
GodotBodyPair3D::GodotBodyPair3D
          (GodotBodyPair3D *this,GodotBody3D *param_1,int param_2,GodotBody3D *param_3,int param_4)

{
  ...
  *(undefined ***)this = &PTR_get_soft_body_ptr_00109e38;
  ...
  do {
    ...
    *(undefined8 *)(pGVar3 + 0x20) = 0;
    *(undefined4 *)(pGVar3 + 0x28) = 0;
    *(undefined8 *)(pGVar3 + 0x2c) = 0;
    *(undefined4 *)(pGVar3 + 0x34) = 0;
    *(undefined8 *)(pGVar3 + 0x38) = 0;
    *(undefined4 *)(pGVar3 + 0x40) = 0;
  ...
  *puVar5 = 0;
  ...
  puVar5 = (undefined4 *)
           HashMap<GodotConstraint3D*,int,HashMapHasherDefault,HashMapComparatorDefault<GodotConstraint3D*>,DefaultTypedAllocator<HashMapElement<GodotConstraint3D*,int>>>
           ::operator[]((HashMap<GodotConstraint3D*,int,HashMapHasherDefault,HashMapComparatorDefault<GodotConstraint3D*>,DefaultTypedAllocator<HashMapElement<GodotConstraint3D*,int>>>
                         *)(lVar2 + 0x2f0),(GodotConstraint3D **)&local_28);
  *puVar5 = 1;
  if (local_20 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
  }
...
/* GodotBodySoftBodyPair3D::GodotBodySoftBodyPair3D(GodotBody3D*, int, GodotSoftBody3D*) */

void __thiscall
GodotBodySoftBodyPair3D::GodotBodySoftBodyPair3D
          (GodotBodySoftBodyPair3D *this,GodotBody3D *param_1,int param_2,GodotSoftBody3D *param_3)
...
/* GodotBodySoftBodyPair3D::get_soft_body_ptr(int) const */

undefined8 GodotBodySoftBodyPair3D::get_soft_body_ptr(int param_1)
...
/* GodotBodySoftBodyPair3D::get_soft_body_count() const */

undefined8 GodotBodySoftBodyPair3D::get_soft_body_count(void)
...
/* CowData<GodotBody3D::Contact>::_copy_on_write() [clone .isra.0] [clone .cold] */

void CowData<GodotBody3D::Contact>::_copy_on_write(void)
...
LAB_0010973b:
  if ((float)uVar55 * __LC42 < (float)(iVar43 + 1)) {

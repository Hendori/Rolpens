...
void __thiscall
ResourceFormatLoader::get_recognized_extensions_for_type
          (ResourceFormatLoader *this,String *param_1,List *param_2)
...
void ResourceLoader::get_recognized_extensions_for_type(String *param_1,List *param_2)
...
/* ResourceLoader::set_is_import_thread(bool) */

void ResourceLoader::set_is_import_thread(bool param_1)
...
bool ResourceLoader::_ensure_load_progress(void)
...
/* ResourceLoader::resource_changed_connect(Resource*, Callable const&, unsigned int) */

void ResourceLoader::resource_changed_connect(Resource *param_1,Callable *param_2,uint param_3)

{
  ...
  *(int *)in_FS_OFFSET = iVar4;
  ...
  for (; plVar8 != plVar7; plVar7 = plVar7 + 4) {
    if (((Resource *)*plVar7 == param_1) &&
       (cVar3 = Callable::operator==((Callable *)(plVar7 + 1),param_2), cVar3 != '\0')) {
...
/* ResourceLoader::resource_changed_disconnect(Resource*, Callable const&) */

void ResourceLoader::resource_changed_disconnect(Resource *param_1,Callable *param_2)
          ...
          if ((uint)uVar5 < uVar3) {
            ...
            *(uint *)(lVar4 + 0x98) = uVar3;
            ...
            _err_print_index_error
                      ("remove_at_unordered","./core/templates/local_vector.h",0x59,
                       uVar5 & 0xffffffff,(ulong)uVar3,"p_index","count","",false,false);
          }
          goto LAB_00100940;
        }
        lVar4 = *in_FS_OFFSET;
...
/* ResourceLoader::resource_changed_emit(Resource*) */

void ResourceLoader::resource_changed_emit(Resource *param_1)
...
/* ResourceLoader::add_resource_format_loader(Ref<ResourceFormatLoader>, bool) */

void ResourceLoader::add_resource_format_loader(long *param_1,char param_2)
...
LAB_00100f4a:
    _err_print_error("add_resource_format_loader","core/io/resource_loader.cpp",uVar6,pcVar4,0,0);
    return;
  }
...
LAB_00100da0:
      ...
      *plVar7 = (long)pOVar1;
      ...
      if (((pOVar8 == (Object *)0x0) || (cVar2 = RefCounted::unreference(), cVar2 == '\0')) ||
         (cVar2 = predelete_handler(pOVar8), cVar2 == '\0')) goto LAB_00100da0;
      plVar7 = plVar7 + -1;
      (**(code **)(*(long *)pOVar8 + 0x140))(pOVar8);
      Memory::free_static(pOVar8,false);
...
/* ResourceLoader::remove_resource_format_loader(Ref<ResourceFormatLoader>) */

void ResourceLoader::remove_resource_format_loader(long *param_1)

{
  ...
  if (*param_1 == 0) {
    _err_print_error("remove_resource_format_loader","core/io/resource_loader.cpp",0x41b,
                     "Condition \"p_format_loader.is_null()\" is true.",0,0);
    return;
  }
  plVar6 = &loader;
  iVar7 = 0;
            ...
            do {
              ...
              if (pOVar2 != pOVar1) {
                *plVar6 = (long)pOVar2;
                ...
                iVar4 = loader_count;
                if (((pOVar1 != (Object *)0x0) &&
                    (cVar3 = RefCounted::unreference(), iVar4 = loader_count, cVar3 != '\0')) &&
                   (cVar3 = predelete_handler(pOVar1), iVar4 = loader_count, cVar3 != '\0')) {
                  (**(code **)(*(long *)pOVar1 + 0x140))(pOVar1);
                  Memory::free_static(pOVar1,false);
                  iVar4 = loader_count;
                }
  ...
  _err_print_error("remove_resource_format_loader","core/io/resource_loader.cpp",0x425,
                   "Condition \"i >= loader_count\" is true.",0,0);
  return;
}



/* ResourceLoader::import_remap(String const&) */

ResourceLoader * __thiscall ResourceLoader::import_remap(ResourceLoader *this,String *param_1)

{
  ...
  local_28 = 0;
  cVar3 = (**(code **)(*ResourceFormatImporter::singleton + 0x170))
                    (ResourceFormatImporter::singleton,param_1,&local_28);
  lVar2 = local_28;
  if (local_28 != 0) {
    LOCK();
...
void ResourceLoader::reload_translation_remaps(void)
...
void ResourceLoader::clear_path_remaps(void)
...
/* ResourceLoader::set_load_callback(void (*)(Ref<Resource>, String const&)) */

void ResourceLoader::set_load_callback(_func_void_Ref_String_ptr *param_1)
...
/* ResourceLoader::_find_custom_resource_format_loader(String const&) */

ResourceLoader * __thiscall
    ...
    do {
      ...
      if (plVar1 != (long *)0x0) {
        ...
        if (((local_50 != (Object *)0x0) &&
            (cVar5 = RefCounted::unreference(), pOVar2 = local_50, cVar5 != '\0')) &&
           (cVar5 = predelete_handler(local_50), cVar5 != '\0')) {
...
/* ResourceLoader::set_create_missing_resources_if_class_unavailable(bool) */

void ResourceLoader::set_create_missing_resources_if_class_unavailable(bool param_1)
...
/* ResourceLoader::is_cleaning_tasks() */

undefined1 ResourceLoader::is_cleaning_tasks(void)
...
LAB_0010177e:
    ...
    *in_FS_OFFSET = iVar2 + 1;
    if (iVar2 + 1 == 1) {
LAB_001017d9:
      if (*(pthread_mutex_t **)in_FS_OFFSET == (pthread_mutex_t *)0x0) goto LAB_00101822;
      if ((char)*in_FS_OFFSET != '\0') {
                    /* WARNING: Subroutine does not return */
        std::__throw_system_error(0x23);
      }
...
void ResourceLoader::initialize(void)
...
/* ResourceLoader::_validate_local_path(String const&) */

String * ResourceLoader::_validate_local_path(String *param_1)

{
  ...
  if (lVar2 == -1) {
    ...
    if (cVar1 == '\0') {
      ...
      operator+((char *)aCStack_28,(String *)"res://");
...
/* ResourceLoader::get_resource_uid(String const&) */

long ResourceLoader::get_resource_uid(String *param_1)
...
/* ResourceLoader::has_custom_uid_support(String const&) */

ulong ResourceLoader::has_custom_uid_support(String *param_1)

{
  ...
  if (0 < loader_count) {
    ...
    do {
      local_38 = 0;
      cVar3 = (**(code **)(*(long *)(&loader)[lVar5] + 0x170))
                        ((long *)(&loader)[lVar5],(String *)&local_40,&local_38);
      lVar2 = local_38;
      if (local_38 != 0) {
        LOCK();
...
/* ResourceLoader::get_resource_type(String const&) */

String * ResourceLoader::get_resource_type(String *param_1)

{
  ...
  if (0 < loader_count) {
    lVar3 = 0;
    do {
      (**(code **)(*(long *)(&loader)[lVar3] + 0x188))
                (&local_48,(long *)(&loader)[lVar3],(String *)&local_50);
      puVar2 = local_48;
...
/* ResourceLoader::get_resource_script_class(String const&) */

String * ResourceLoader::get_resource_script_class(String *param_1)
...
void __thiscall
ResourceLoader::ThreadLoadTask::operator=(ThreadLoadTask *this,ThreadLoadTask *param_1)

{
  ...
  *(undefined4 *)(this + 0x58) = *(undefined4 *)(param_1 + 0x58);
  ...
  if (param_1 + 0x70 != this + 0x70) {
    pvVar18 = *(void **)(this + 0x70);
    if (pvVar18 != (void *)0x0) {
      if ((*(int *)(this + 0x94) != 0) &&
         (((&hash_table_size_primes)[*(uint *)(this + 0x90)] == 0 ||
          (memset(*(void **)(this + 0x88),0,
                  (ulong)(uint)(&hash_table_size_primes)[*(uint *)(this + 0x90)] * 4),
          *(int *)(this + 0x94) != 0)))) {
        lVar14 = 0;
        do {
          lVar17 = lVar14 * 8;
      ...
      *(undefined8 *)(this + 0x78) = uVar11;
      if (*(int *)(this + 0x94) != 0) {
        do {
          ...
          *(undefined4 *)(*(long *)(this + 0x80) + lVar14 * 4) =
               *(undefined4 *)(*(long *)(param_1 + 0x80) + lVar14 * 4);
          lVar14 = lVar14 + 1;
        } while ((uint)lVar14 < *(uint *)(this + 0x94));
      }
      if (uVar19 != 0) {
  ...
  if (uVar13 < uVar19) {
    ...
    do {
      ...
      *(undefined4 *)(pauVar9[1] + 8) = 0;
      pauVar9 = pauVar10;
    } while ((undefined1 (*) [16])(lVar14 + 0x20 + ((ulong)(uVar1 - uVar19) + (ulong)uVar19) * 0x20)
             != pauVar10);
  }
LAB_00101f84:
...
/* ResourceLoader::get_classes_used(String const&, HashSet<StringName, HashMapHasherDefault,
   HashMapComparatorDefault<StringName> >*) */

void ResourceLoader::get_classes_used(String *param_1,HashSet *param_2)

{
  ...
  if (0 < loader_count) {
    ...
    do {
      local_48 = 0;
      cVar3 = (**(code **)(*(long *)(&loader)[lVar4] + 0x170))
                        ((long *)(&loader)[lVar4],(String *)&local_50,&local_48);
      lVar2 = local_48;
      if (local_48 != 0) {
        LOCK();
        plVar1 = (long *)(local_48 + -0x10);
...
LAB_001022ec:
        (**(code **)(*(long *)(&loader)[(int)lVar4] + 0x180))
                  ((long *)(&loader)[(int)lVar4],param_1,param_2);
        lVar4 = local_50;
        if (local_50 != 0) {
          LOCK();
          plVar1 = (long *)(local_50 + -0x10);
...
/* ResourceLoader::should_create_uid_file(String const&) */

uint ResourceLoader::should_create_uid_file(String *param_1)

{
  ...
  if ((cVar3 == '\0') && (0 < loader_count)) {
    ...
    do {
      local_48 = (undefined *)0x0;
      cVar3 = (**(code **)(*(long *)(&loader)[lVar5] + 0x170))
                        ((long *)(&loader)[lVar5],aSStack_58,(String *)&local_48);
      puVar2 = local_48;
      if (local_48 != (undefined *)0x0) {
        LOCK();
        plVar1 = (long *)(local_48 + -0x10);
...
/* HashMap<String, ResourceLoader::LoadToken*, HashMapHasherDefault,
   ...
   ResourceLoader::LoadToken*> > >::erase(String const&) [clone .isra.0] */

ulong __thiscall
HashMap<String,ResourceLoader::LoadToken*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::LoadToken*>>>
::erase(HashMap<String,ResourceLoader::LoadToken*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::LoadToken*>>>
        *this,String *param_1)
        ...
        if (uVar31 == uVar29) {
          ...
          if (cVar28 != '\0') {
            ...
            if ((uVar31 == 0) ||
               ...
               SUB164(auVar14 * auVar24,8) == 0)) goto LAB_001026eb;
            goto LAB_001026a5;
          }
          lVar36 = *(long *)(this + 0x10);
        }
...
void ResourceLoader::_load_threaded_request_setup_user_token(LoadToken *param_1,String *param_2)

{
  ...
  *(undefined4 *)(param_1 + 400) = 1;
  puVar1 = (undefined8 *)
           HashMap<String,ResourceLoader::LoadToken*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::LoadToken*>>>
           ::operator[]((HashMap<String,ResourceLoader::LoadToken*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::LoadToken*>>>
                         *)user_load_tokens,param_2);
  *puVar1 = param_1;
  return;
}
...
/* ResourceLoader::_path_remap(String const&, bool*) */
    ...
    if (uVar29 != 0) {
      ...
      while ((uVar34 != uVar29 ||
             (cVar28 = String::operator==((String *)
                                          (*(long *)(translation_remaps._8_8_ + lVar35 * 8) + 0x10),
                                          param_1), lVar42 = translation_remaps._16_8_,
             cVar28 == '\0'))) {
        uVar40 = uVar40 + 1;
        auVar7._8_8_ = 0;
        ...
        if ((uVar29 == 0) ||
           (auVar8._8_8_ = 0, auVar8._0_8_ = (ulong)uVar29 * lVar36, auVar20._8_8_ = 0,
           auVar20._0_8_ = uVar37, auVar9._8_8_ = 0,
           auVar9._0_8_ = (ulong)((uVar1 + iVar32) - SUB164(auVar8 * auVar20,8)) * lVar36,
           auVar21._8_8_ = 0, auVar21._0_8_ = uVar37, SUB164(auVar9 * auVar21,8) < uVar40))
        goto joined_r0x00102cd9;
      }
...
LAB_00102bd2:
        ...
        vformat<String,String>
                  ((CowData<char32_t> *)local_20e8,(String *)&local_2100,
                   (CowData<char32_t> *)&local_20f8,local_2178);
        _err_print_error("_path_remap","core/io/resource_loader.cpp",0x4de,
                         "Condition \"locale.length() < 2\" is true. Returning: p_path",
                         (CowData<char32_t> *)local_20e8,0,0);
      ...
      while ((uVar29 != uVar34 ||
             (cVar28 = String::operator==((String *)
                                          (*(long *)(translation_remaps._8_8_ + lVar35 * 8) + 0x10),
                                          (String *)&local_2128), lVar42 = translation_remaps._16_8_
             , cVar28 == '\0'))) {
        uVar41 = uVar41 + 1;
        auVar11._8_8_ = 0;
        ...
        if ((uVar29 == 0) ||
           (auVar12._8_8_ = 0, auVar12._0_8_ = (ulong)uVar29 * lVar36, auVar24._8_8_ = 0,
           auVar24._0_8_ = uVar37, auVar13._8_8_ = 0,
           auVar13._0_8_ = (ulong)((uVar1 + uVar40) - SUB164(auVar12 * auVar24,8)) * lVar36,
           auVar25._8_8_ = 0, auVar25._0_8_ = uVar37, SUB164(auVar13 * auVar25,8) < uVar41)) {
LAB_00103847:
                    /* WARNING: Does not return */
...
LAB_00102fa3:
              _err_print_index_error
                        ("get","./core/templates/cowdata.h",0xdb,lVar42,lVar39,"p_index","size()",""
                         ,false,true);
              _err_flush_stdout();
                    /* WARNING: Does not return */
              pcVar26 = (code *)invalidInstructionException();
            ...
            String::strip_edges(SUB81((CowData<char32_t> *)&local_20f0,0),
                                SUB81((CowData<char32_t> *)local_20e8,0));
            CowData<char32_t>::_unref((CowData<char32_t> *)local_20e8);
            iVar31 = TranslationServer::compare_locales
                               (TranslationServer::singleton,(String *)&local_2108);
      ...
      if ((cVar28 == '\0') && (cVar28 = FileAccess::exists((String *)&local_2128), cVar28 == '\0'))
      {
        ...
        String::parse_latin1
                  ((String *)&local_2100,
                   "Translation remap \'%s\' does not exist. Falling back to \'%s\'.");
        vformat<String,String>
                  (local_2180,(String *)&local_2100,(CowData<char32_t> *)&local_20f8,local_2178);
...
joined_r0x00102cd9:
  if ((path_remaps._8_8_ != 0) && (local_2188 = (String *)&local_2128, path_remaps._44_4_ != 0)) {
    ...
    if (uVar29 != 0) {
      ...
      do {
        if ((uVar29 == uVar34) &&
           (cVar28 = String::operator==((String *)(*(long *)(path_remaps._8_8_ + lVar35 * 8) + 0x10)
                                        ,local_2188), lVar42 = path_remaps._16_8_, cVar28 != '\0'))
        {
          pCVar33 = (CowData *)
        ...
        iVar32 = SUB164(auVar3 * auVar15,8);
              ...
              (auVar4._8_8_ = 0, auVar4._0_8_ = (ulong)uVar29 * lVar36, auVar16._8_8_ = 0,
              auVar16._0_8_ = uVar37, auVar5._8_8_ = 0,
              auVar5._0_8_ = (ulong)((uVar1 + iVar32) - SUB164(auVar4 * auVar16,8)) * lVar36,
              auVar17._8_8_ = 0, auVar17._0_8_ = uVar37, uVar40 <= SUB164(auVar5 * auVar17,8)));
    }
  }
  ...
  do {
    ...
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_20f0);
    iVar32 = VariantParser::parse_tag_assign_eof
                       ((Stream *)local_2068,&local_212c,(String *)&local_2110,(Tag *)local_20e8,
                        (String *)&local_2118,(Variant *)&local_20a8,(ResourceParser *)0x0,true);
    ...
    if (iVar32 != 0) {
      ...
      vformat<String,int,String>
                ((String *)&local_20f0,(String *)&local_2108,(CowData<char32_t> *)&local_2100,iVar32
                 ,(CowData<char32_t> *)&local_20f8);
...
LAB_0010349d:
  ...
  local_2068[0] = VariantParser::parse_tag_assign_eof;
  if (((local_50 != (Object *)0x0) &&
      (cVar28 = RefCounted::unreference(), pOVar27 = local_50, cVar28 != '\0')) &&
     (cVar28 = predelete_handler(local_50), cVar28 != '\0')) {
    (**(code **)(*(long *)pOVar27 + 0x140))(pOVar27);
    Memory::free_static(pOVar27,false);
  }
  lVar36 = local_2128;
  if (((local_2120 != (Object *)0x0) &&
      (cVar28 = RefCounted::unreference(), lVar36 = local_2128, cVar28 != '\0')) &&
     (cVar28 = predelete_handler(local_2120), lVar36 = local_2128, cVar28 != '\0')) {
...
/* ResourceLoader::exists(String const&, String const&) */

undefined4 ResourceLoader::exists(String *param_1,String *param_2)

{
  ...
  if ((char)uVar3 == '\0') {
    ...
    if (0 < loader_count) {
      lVar5 = 0;
      do {
        cVar2 = (**(code **)(*(long *)(&loader)[lVar5] + 0x170))
                          ((long *)(&loader)[lVar5],local_38,param_2);
        if (cVar2 != '\0') {
...
/* ResourceLoader::get_import_order(String const&) */

undefined4 ResourceLoader::get_import_order(String *param_1)

{
  ...
  if (0 < loader_count) {
    do {
      local_48 = 0;
      cVar3 = (**(code **)(*(long *)(&loader)[lVar5] + 0x170))
                        ((long *)(&loader)[lVar5],(ResourceLoader *)&local_50,(String *)&local_48);
      lVar2 = local_48;
      if (local_48 != 0) {
        LOCK();
        plVar1 = (long *)(local_48 + -0x10);
...
LAB_00103a2e:
        uVar4 = (**(code **)(*(long *)(&loader)[(int)lVar5] + 0x1c8))();
        goto LAB_00103a43;
      }
LAB_00103a29:
      if (cVar3 != '\0') goto LAB_00103a2e;
LAB_00103a9e:
      lVar5 = lVar5 + 1;
    } while ((int)lVar5 < loader_count);
  }
...
/* ResourceLoader::get_import_group_file(String const&) */
...

{
  ...
  if (0 < loader_count) {
    ...
    do {
      local_48 = 0;
      cVar3 = (**(code **)(*(long *)(&loader)[lVar4] + 0x170))
                        ((long *)(&loader)[lVar4],(ResourceLoader *)&local_50,(String *)&local_48);
      lVar2 = local_48;
      if (local_48 != 0) {
        LOCK();
        plVar1 = (long *)(local_48 + -0x10);
...
LAB_00103b82:
        (**(code **)(*(long *)(&loader)[(int)lVar4] + 0x1d0))
                  (this,(long *)(&loader)[(int)lVar4],param_1);
        goto LAB_00103b9b;
      }
LAB_00103b7d:
      if (cVar3 != '\0') goto LAB_00103b82;
LAB_00103bee:
      lVar4 = lVar4 + 1;
    } while ((int)lVar4 < loader_count);
  }
...
/* ResourceLoader::is_import_valid(String const&) */

undefined4 ResourceLoader::is_import_valid(String *param_1)

{
  ...
  if (0 < loader_count) {
    do {
      local_48 = 0;
      cVar3 = (**(code **)(*(long *)(&loader)[lVar5] + 0x170))
                        ((long *)(&loader)[lVar5],local_50,(String *)&local_48);
      lVar2 = local_48;
      if (local_48 != 0) {
        LOCK();
        plVar1 = (long *)(local_48 + -0x10);
...
LAB_00103cec:
        uVar4 = (**(code **)(*(long *)(&loader)[(int)lVar5] + 0x1b8))
                          ((long *)(&loader)[(int)lVar5],param_1);
        goto LAB_00103d01;
      }
LAB_00103ce7:
      if (cVar3 != '\0') goto LAB_00103cec;
LAB_00103d4e:
      lVar5 = lVar5 + 1;
    } while ((int)lVar5 < loader_count);
  }
...
/* ResourceLoader::is_imported(String const&) */

undefined4 ResourceLoader::is_imported(String *param_1)
...
LAB_00103e3c:
        uVar4 = (**(code **)(*(long *)(&loader)[(int)lVar5] + 0x1c0))
                          ((long *)(&loader)[(int)lVar5],param_1);
        goto LAB_00103e51;
      }
LAB_00103e37:
      if (cVar3 != '\0') goto LAB_00103e3c;
LAB_00103e9e:
      lVar5 = lVar5 + 1;
    } while ((int)lVar5 < loader_count);
  }
...
/* ResourceLoader::get_dependencies(String const&, List<String, DefaultAllocator>*, bool) */

void ResourceLoader::get_dependencies(String *param_1,List *param_2,bool param_3)

{
  ...
  if (0 < loader_count) {
    ...
    do {
      ...
      if (cVar3 != '\0') {
        (**(code **)(*(long *)(&loader)[lVar4] + 0x1a8))
                  ((long *)(&loader)[lVar4],(ResourceLoader *)&local_50,param_2,param_3);
      }
      lVar4 = lVar4 + 1;
    } while ((int)lVar4 < loader_count);
  }
...
undefined4 ResourceLoader::rename_dependencies(String *param_1,HashMap *param_2)
...
LAB_001040be:
        uVar4 = (**(code **)(*(long *)(&loader)[(int)lVar5] + 0x1b0))
                          ((long *)(&loader)[(int)lVar5],(ResourceLoader *)&local_50,param_2);
        goto LAB_001040d6;
      }
LAB_001040b9:
      if (cVar3 != '\0') goto LAB_001040be;
LAB_0010412e:
      lVar5 = lVar5 + 1;
    } while ((int)lVar5 < loader_count);
  }
...
/* ResourceLoader::path_remap(String const&) */

ResourceLoader * __thiscall ResourceLoader::path_remap(ResourceLoader *this,String *param_1)
...
/* ResourceLoader::_load_threaded_request_reuse_user_token(String const&) */

long ResourceLoader::_load_threaded_request_reuse_user_token(String *param_1)
    ...
    if (uVar11 != 0) {
      ...
      while ((uVar13 != uVar11 ||
             (cVar10 = String::operator==((String *)
                                          (*(long *)(user_load_tokens._8_8_ + lVar15 * 8) + 0x10),
                                          param_1), lVar16 = user_load_tokens._16_8_, cVar10 == '\0'
             ))) {
        uVar18 = uVar18 + 1;
        auVar3._8_8_ = 0;
        ...
        if ((uVar11 == 0) ||
           (auVar4._8_8_ = 0, auVar4._0_8_ = (ulong)uVar11 * lVar12, auVar8._8_8_ = 0,
           auVar8._0_8_ = uVar17, auVar5._8_8_ = 0,
           auVar5._0_8_ = (ulong)((uVar1 + uVar14) - SUB164(auVar4 * auVar8,8)) * lVar12,
           auVar9._8_8_ = 0, auVar9._0_8_ = uVar17, SUB164(auVar5 * auVar9,8) < uVar18))
        goto LAB_001042bb;
      }
      ...
      if (lVar12 != 0) {
        ...
        if (cVar10 != '\0') {
          ...
          operator+((char *)local_80,
                    (String *)"load_threaded_request(): Another threaded load for resource path \'")
          ;
...
void ResourceLoader::clear_thread_load_tasks(void)
...
LAB_00104557:
  ...
  while (user_load_tokens._24_8_ != 0) {
    ...
    HashMap<String,ResourceLoader::LoadToken*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::LoadToken*>>>
    ::erase((HashMap<String,ResourceLoader::LoadToken*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::LoadToken*>>>
             *)user_load_tokens,(String *)(user_load_tokens._24_8_ + 0x10));
...
/* ResourceLoader::get_resource_ref_override(String const&) */
  ...
  if ((lVar2 != 0) && (*in_FS_OFFSET != 0)) {
    ...
    if (uVar20 != 0) {
      ...
      while ((uVar25 != uVar20 || (uVar1 != *(uint *)(*(long *)(lVar2 + lVar23 * 8) + 0x10)))) {
        ...
        if ((uVar20 == 0) ||
           (auVar5._8_8_ = 0, auVar5._0_8_ = uVar20 * uVar28, auVar13._8_8_ = 0,
           auVar13._0_8_ = uVar26, auVar6._8_8_ = 0,
           auVar6._0_8_ = (((&hash_table_size_primes)[*in_FS_OFFSET] + uVar21) -
                          SUB164(auVar5 * auVar13,8)) * uVar28, auVar14._8_8_ = 0,
           auVar14._0_8_ = uVar26, SUB164(auVar6 * auVar14,8) < uVar29)) goto LAB_00104ac8;
      }
...
LAB_00104a87:
  if (uVar20 == uVar25) {
    cVar19 = String::operator==((String *)(*(long *)(*(long *)(lVar2 + 0x20) + lVar24 * 8) + 0x10),
                                param_1);
    if (cVar19 != '\0') {
  ...
  if ((uVar25 == 0) ||
     (auVar9._8_8_ = 0, auVar9._0_8_ = (ulong)uVar25 * lVar23, auVar17._8_8_ = 0,
     auVar17._0_8_ = uVar28, auVar10._8_8_ = 0,
     auVar10._0_8_ = (ulong)((uVar1 + uVar21) - SUB164(auVar9 * auVar17,8)) * lVar23,
     auVar18._8_8_ = 0, auVar18._0_8_ = uVar28, SUB164(auVar10 * auVar18,8) < uVar29))
  goto LAB_00104ac8;
  goto LAB_00104a87;
}
...
void ResourceLoader::clear_translation_remaps(void)
...
void ResourceLoader::load_path_remaps(void)
  ...
  if (cVar2 != '\0') {
    ...
    if (local_50 != 0) {
      if ((*(ulong *)(local_50 + -8) & 1) == 0) {
        ...
        _err_print_error("load_path_remaps","core/io/resource_loader.cpp",0x598,
                         "Condition \"rc & 1\" is true.",0,0);
      }
    }
...
void ResourceLoader::load_translation_remaps(void)

{
  ...
  if (cVar4 != '\0') {
    ...
    if ((local_a0 != (long *)0x0) && (lVar8 = *local_a0, lVar8 != 0)) {
      do {
        ...
        lVar7 = HashMap<String,Vector<String>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Vector<String>>>>
                ::operator[]((HashMap<String,Vector<String>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Vector<String>>>>
                              *)translation_remaps,(String *)&local_68);
...
LAB_00105feb:
        if ((cVar31 == '\0') && (__tls_init_part_0(), (char)*in_FS_OFFSET == '\0')) {
          __tls_init_part_0();
        }
        lVar42 = *(long *)in_FS_OFFSET;
        goto LAB_00105aec;
      ...
      *in_FS_OFFSET = uVar47 + 1;
      if (uVar47 + 1 == 1) {
LAB_00105fab:
        if (*(pthread_mutex_t **)in_FS_OFFSET == (pthread_mutex_t *)0x0) goto LAB_00106362;
        if ((char)*in_FS_OFFSET != '\0') {
                    /* WARNING: Subroutine does not return */
          std::__throw_system_error(0x23);
        }
...
LAB_00105af5:
      lVar45 = *(long *)(lVar42 + -8);
      lVar38 = lVar45 + -1;
      if (lVar38 < 0) {
LAB_00106308:
        _err_print_index_error
                  ("get","./core/templates/cowdata.h",0xdb,lVar38,lVar45,"p_index","size()","",false
                   ,true);
        _err_flush_stdout();
                    /* WARNING: Does not return */
      ...
      cVar31 = HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>
               ::_lookup_pos((HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>
                              *)thread_load_tasks,(String *)&local_70,(uint *)&local_68);
      if (cVar31 == '\0') {
...
LAB_001054f9:
  local_c8 = (CowData<char32_t> *)&local_68;
  local_68 = (char *)0x0;
  if (*(long *)this_00 != 0) {
  ...
  if (cVar31 != '\0') {
    ...
    vformat<String>((CowData<char32_t> *)&local_70,(StrRange *)&local_80,
...
LAB_00105700:
    ...
    cVar31 = '\0';
    do {
      cVar32 = (**(code **)(*(long *)(&loader)[lVar42] + 0x170))
                         ((long *)(&loader)[lVar42],param_1,param_3);
      if ((cVar32 != '\0') &&
         ((**(code **)(*(long *)(&loader)[lVar42] + 0x150))
                    (local_c8,(long *)(&loader)[lVar42],param_1,this_00,param_6,param_7,param_8,
                     param_5), pOVar49 = (Object *)local_68, cVar31 = cVar32,
         (Object *)local_68 != (Object *)0x0)) {
        cVar31 = RefCounted::reference();
        if (cVar31 == '\0') {
          cVar31 = cVar32;
          if (((Object *)local_68 != (Object *)0x0) &&
             (cVar33 = RefCounted::unreference(), pOVar51 = (Object *)local_68, cVar33 != '\0')) {
            pOVar49 = (Object *)0x0;
          ...
          if ((((Object *)local_68 == (Object *)0x0) ||
              (cVar33 = RefCounted::unreference(), pOVar51 = (Object *)local_68, cVar33 == '\0')) ||
             (cVar33 = predelete_handler((Object *)local_68), cVar33 == '\0')) goto LAB_00105700;
LAB_00105c05:
...
LAB_00105848:
      uVar36 = (ulong)uVar37;
      if ((uVar34 != uVar41) || (uVar47 != *(uint *)(*(long *)(lVar42 + lVar38 * 8) + 0x10)))
      goto LAB_00105800;
      auVar12._8_8_ = 0;
      ...
      uVar47 = *puVar48;
      if ((uVar47 != 0) &&
         (auVar13._8_8_ = 0, auVar13._0_8_ = uVar47 * uVar7, auVar23._8_8_ = 0,
         auVar23._0_8_ = uVar29, auVar14._8_8_ = 0,
         auVar14._0_8_ = ((uVar34 + uVar6) - SUB164(auVar13 * auVar23,8)) * uVar7, auVar24._8_8_ = 0
         , auVar24._0_8_ = uVar29, uVar30 = (ulong)uVar34, uVar43 = uVar36,
         SUB164(auVar14 * auVar24,8) != 0)) {
        while( true ) {
          uVar36 = uVar30;
          ...
          *puVar3 = uVar40;
          ...
          uVar47 = *puVar48;
          if ((uVar47 == 0) ||
             (auVar15._8_8_ = 0, auVar15._0_8_ = uVar47 * uVar7, auVar25._8_8_ = 0,
             auVar25._0_8_ = uVar29, auVar16._8_8_ = 0,
             auVar16._0_8_ =
                  ((SUB164(auVar17 * auVar27,8) + uVar6) - SUB164(auVar15 * auVar25,8)) * uVar7,
             auVar26._8_8_ = 0, auVar26._0_8_ = uVar29, SUB164(auVar16 * auVar26,8) == 0)) break;
...
LAB_00105ce9:
    if (cVar31 == '\0') {
      ...
      if (cVar31 == '\0') {
        ...
        vformat<String,String>
                  (local_c8,(String *)&local_80,(CowData<char32_t> *)&local_78,
        ...
        local_80 = 0;
        String::parse_latin1
                  ((String *)&local_80,"No loader found for resource: %s (expected type: %s)");
        vformat<String,String>
                  (local_c8,(String *)&local_80,(CowData<char32_t> *)&local_78,
                   (CowData<char32_t> *)&local_70);
        uVar40 = 0x167;
      }
      _err_print_error("_load","core/io/resource_loader.cpp",uVar40,
                       "Method/function failed. Returning: Ref<Resource>()",local_c8,0,0);
      CowData<char32_t>::_unref(local_c8);
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_80);
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_78);
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_70);
      *(undefined8 *)this = 0;
      if (((local_88 != (Object *)0x0) && (cVar31 = RefCounted::unreference(), cVar31 != '\0')) &&
         (cVar31 = predelete_handler(local_88), cVar31 != '\0')) {
    ...
    ResourceFormatImporter::get_importer_by_extension((String *)local_c8);
    if ((Object *)local_68 == (Object *)0x0) {
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_70);
      goto LAB_00105ce9;
    }
    cVar31 = RefCounted::unreference();
    pOVar49 = (Object *)local_68;
    if ((cVar31 != '\0') && (cVar31 = predelete_handler((Object *)local_68), cVar31 != '\0')) {
      (**(code **)(*(long *)pOVar49 + 0x140))(pOVar49);
      Memory::free_static(pOVar49,false);
    }
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_70);
  ...
  String::parse_latin1
            ((String *)&local_78,
             "Failed loading resource: %s. Make sure resources have been imported by opening the project in the editor at least once."
            );
  vformat<String>(local_c8,(CowData<char32_t> *)&local_78,(CowData<char32_t> *)&local_70);
  _err_print_error("_load","core/io/resource_loader.cpp",0x157,
                   "Condition \"found\" is true. Returning: Ref<Resource>()",local_c8,0,0);
  CowData<char32_t>::_unref(local_c8);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_78);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_70);
  *(undefined8 *)this = 0;
...
LAB_00105800:
  uVar46 = uVar46 + 1;
  auVar9._8_8_ = 0;
  auVar9._0_8_ = (uVar37 + 1) * uVar7;
  auVar19._8_8_ = 0;
  auVar19._0_8_ = uVar29;
  lVar38 = SUB168(auVar9 * auVar19,8);
  uVar34 = *(uint *)(lVar45 + lVar38 * 4);
  uVar37 = SUB164(auVar9 * auVar19,8);
  if ((uVar34 == 0) ||
     (auVar10._8_8_ = 0, auVar10._0_8_ = uVar34 * uVar7, auVar20._8_8_ = 0, auVar20._0_8_ = uVar29,
     auVar11._8_8_ = 0, auVar11._0_8_ = ((uVar6 + uVar37) - SUB164(auVar10 * auVar20,8)) * uVar7,
     auVar21._8_8_ = 0, auVar21._0_8_ = uVar29, SUB164(auVar11 * auVar21,8) < uVar46))
  goto LAB_00105a5d;
  goto LAB_00105848;
}
...
/* WARNING: Removing unreachable block (ram,0x00106a10) */
/* WARNING: Removing unreachable block (ram,0x00106a1d) */
/* ResourceLoader::_run_load_task(void*) */

void ResourceLoader::_run_load_task(void *param_1)
...
joined_r0x001068ad:
      ...
      *(void **)in_FS_OFFSET = param_1;
      if (iVar7 == 0) {
        ...
        if ((*(long *)((long)in_FS_OFFSET + lRam0000000000106699) == 0) ||
           (MessageQueue::thread_singleton(),
           MessageQueue::main_singleton == *(long *)((long)in_FS_OFFSET + lVar8))) {
...
LAB_00106423:
      ...
      _load((ResourceLoader *)&local_58,local_60,(CowData<char32_t> *)&local_48,(long)param_1 + 0x38
            ,uVar2,&local_64);
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_48);
      MessageQueue::thread_singleton();
...
LAB_00106d60:
          ...
          if (local_48 == (Ref *)0x0) {
            (**(code **)(**(long **)((long)param_1 + 0x60) + 0x188))
                      (*(long **)((long)param_1 + 0x60),pSVar1,0);
LAB_00106c82:
            pthread_mutex_unlock((pthread_mutex_t *)&ResourceCache::lock);
          }
          else {
...
LAB_001067bb:
      ...
      *(undefined8 *)in_FS_OFFSET = uVar4;
      if (((local_58 != (Ref *)0x0) && (cVar6 = RefCounted::unreference(), cVar6 != '\0')) &&
...
/* ResourceFormatLoader::get_recognized_extensions(List<String, DefaultAllocator>*) const */

void __thiscall
ResourceFormatLoader::get_recognized_extensions(ResourceFormatLoader *this,List *param_1)

{
  ...
  if (plVar5 == (long *)0x0) {
LAB_00106e1b:
    if ((*(long *)(this + 8) != 0) && (this[0x188] == (ResourceFormatLoader)0x0)) {
      local_c8 = 0;
...
LAB_001072b6:
          ...
          if (((pcVar6 == (code *)0x0) || (*(long *)(lVar4 + 0xe0) == 0)) &&
             (pcVar6 = *(code **)(lVar4 + 0xc0), pcVar6 == (code *)0x0)) goto LAB_001071ae;
...
LAB_00106ffd:
    ...
    (**(code **)(*(long *)(this + 8) + 0xe0))
              (*(undefined8 *)(this + 0x10),this + 0x180,pcVar6,0,local_f8);
...
/* ResourceFormatLoader::recognize_path(String const&, String const&) const */

ulong __thiscall
ResourceFormatLoader::recognize_path(ResourceFormatLoader *this,String *param_1,String *param_2)
...
LAB_00107b44:
          ...
          if (((pcVar7 == (code *)0x0) || (*(long *)(lVar5 + 0xe0) == 0)) &&
             (pcVar7 = *(code **)(lVar5 + 0xc0), pcVar7 == (code *)0x0)) goto LAB_001079fc;
          ...
          *(undefined8 *)(this + 0x1a8) = uVar4;
          ...
          if (StringName::configured != '\0') {
LAB_00107b20:
            if (CONCAT71(uStack_14f,local_150) != 0) {
              StringName::unref();
            }
          }
          CowData<char32_t>::_unref((CowData<char32_t> *)&local_158);
...
LAB_001079fc:
    ...
    if (*(long *)(this + 0x1a8) == 0) {
      ...
      if ((undefined8 *)CONCAT44(uStack_114,local_118) != (undefined8 *)0x0) {
        for (pSVar1 = *(String **)CONCAT44(uStack_114,local_118); pSVar1 != (String *)0x0;
      ...
      uVar8 = 0;
LAB_00107691:
      List<String,DefaultAllocator>::~List((List<String,DefaultAllocator> *)local_190);
    ...
    if (*(code **)(*(long *)(this + 8) + 0xe0) == (code *)0x0) {
      ...
      (**(code **)(*(long *)(this + 8) + 0xe0))
                (*(undefined8 *)(this + 0x10),this + 0x198,*(undefined8 *)(this + 0x1a8),&local_78,
                 &local_150);
    }
...
void ResourceFormatLoader::_bind_methods(void)

{
  ...
  PropertyInfo::PropertyInfo
            ((PropertyInfo *)&local_b8,2,(CowData<char32_t> *)&local_110,0,
             (CowData<char32_t> *)&local_108,0x10006,(StringName *)&local_e8);
  ...
  StringName::StringName((StringName *)&local_b8,(String *)&local_f8,false);
  ClassDB::bind_integer_constant
            ((StringName *)&local_b8,(StringName *)&local_e8,(StringName *)&local_118,1,false);
  if ((StringName::configured != '\0') && (local_b8 != (char *)0x0)) {
    StringName::unref();
  }
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_f8);
  ...
  StringName::StringName((StringName *)&local_b8,(String *)&local_f8,false);
  ClassDB::bind_integer_constant
            ((StringName *)&local_b8,(StringName *)&local_e8,(StringName *)&local_118,2,false);
  if ((StringName::configured != '\0') && (local_b8 != (char *)0x0)) {
    StringName::unref();
  }
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_f8);
  ...
  StringName::StringName((StringName *)&local_b8,(String *)&local_f8,false);
  ClassDB::bind_integer_constant
            ((StringName *)&local_b8,(StringName *)&local_e8,(StringName *)&local_118,3,false);
  if ((StringName::configured != '\0') && (local_b8 != (char *)0x0)) {
    StringName::unref();
  }
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_f8);
  ...
  StringName::StringName((StringName *)&local_b8,(String *)&local_f8,false);
  ClassDB::bind_integer_constant
            ((StringName *)&local_b8,(StringName *)&local_e8,(StringName *)&local_118,4,false);
  if ((StringName::configured != '\0') && (local_b8 != (char *)0x0)) {
    StringName::unref();
  }
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_f8);
...
LAB_001091fd:
  ...
  local_100 = 0;
  PropertyInfo::PropertyInfo
            ((PropertyInfo *)&local_e8,0x1b,(StrRange *)&local_100,0,(CowData<char32_t> *)&local_108
             ,6,(CowData<char32_t> *)&local_110);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_100);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_108);
  ...
  local_100 = 0;
  PropertyInfo::PropertyInfo
            ((PropertyInfo *)&local_e8,0,(StrRange *)&local_100,0,(CowData<char32_t> *)&local_108,
             0x20006,(CowData<char32_t> *)&local_110);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_100);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_108);
  if ((StringName::configured != '\0') && (local_110 != 0)) {
    StringName::unref();
  ...
  local_100 = 0;
  PropertyInfo::PropertyInfo
            ((PropertyInfo *)&local_e8,2,(StrRange *)&local_100,0,(CowData<char32_t> *)&local_108,6,
...
long * ResourceFormatLoader::load
                 (long *param_1,long param_2,CowData *param_3,CowData *param_4,undefined4 *param_5,
                 bool param_6,undefined8 param_7,int param_8)
...
LAB_0010aa2d:
            ...
            if (((pcVar12 == (code *)0x0) || (*(long *)(lVar9 + 0xe0) == 0)) &&
               (pcVar12 = *(code **)(lVar9 + 0xc0), pcVar12 == (code *)0x0)) goto LAB_0010a862;
...
LAB_0010a862:
    ...
    if (*(long *)(param_2 + 0x280) != 0) {
      ...
      if (pcVar12 == (code *)0x0) {
        (**(code **)(param_2 + 0x280))
                  (*(undefined8 *)(param_2 + 0x10),&local_a8,(Variant *)&local_e8);
        ...
        (*pcVar12)(*(undefined8 *)(param_2 + 0x10),param_2 + 0x270,*(undefined8 *)(param_2 + 0x280),
    ...
    _err_print_error(&_LC122,"core/io/resource_loader.cpp",0xb2,
                     "Method/function failed. Returning: Ref<Resource>()",local_220,0,0);
    ...
    *param_1 = 0;
    ...
    pVStack_b0 = local_60;
    (**(code **)(*plVar11 + 0x60))
              ((Variant *)local_108,plVar11,param_2 + 0x270,&local_c8,4,&local_198);
    if (local_198 != 0) {
...
LAB_0010a506:
            Ref<Resource>::unref((Ref<Resource> *)local_220);
          }
        }
      }
...
void ResourceFormatLoader::get_classes_used(String *param_1,HashSet *param_2)

{
  ...
  if (plVar4 == (long *)0x0) {
LAB_0010abb8:
    if ((*(long *)(param_1 + 8) != 0) && (param_1[0x230] == (String)0x0)) {
      local_f8 = 0;
      ...
      GetTypeInfo<Vector<String>,void>::get_class_info
                ((GetTypeInfo<Vector<String>,void> *)&local_128);
...
LAB_0010b182:
            ...
            if (((pcVar5 == (code *)0x0) || (*(long *)(lVar3 + 0xe0) == 0)) &&
               (pcVar5 = *(code **)(lVar3 + 0xc0), pcVar5 == (code *)0x0)) goto LAB_0010b030;
...
LAB_0010aea6:
      ...
      (**(code **)(*(long *)(param_1 + 8) + 0xe0))
                (*(undefined8 *)(param_1 + 0x10),param_1 + 0x228,*(undefined8 *)(param_1 + 0x238),
                 local_58,&local_128);
...
/* ResourceFormatLoader::get_resource_uid(String const&) const */

long __thiscall ResourceFormatLoader::get_resource_uid(ResourceFormatLoader *this,String *param_1)

{
  ...
  if (cVar2 == '\0') {
    ...
    if (local_130 != (Object *)0x0) {
      ...
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_f8);
      if (((local_130 != (Object *)0x0) && (cVar2 = RefCounted::unreference(), cVar2 != '\0')) &&
...
LAB_0010b75e:
          ...
          if (((pcVar6 == (code *)0x0) || (*(long *)(lVar7 + 0xe0) == 0)) &&
             (pcVar6 = *(code **)(lVar7 + 0xc0), pcVar6 == (code *)0x0)) goto LAB_0010b6a6;
...
LAB_0010b6a6:
    ...
    if (*(long *)(this + 0x208) != 0) {
      ...
      if (*(code **)(*(long *)(this + 8) + 0xe0) == (code *)0x0) {
        ...
        (**(code **)(*(long *)(this + 8) + 0xe0))
                  (*(undefined8 *)(this + 0x10),this + 0x1f8,*(undefined8 *)(this + 0x208),local_58,
                   &local_f8);
        lVar7 = CONCAT44(uStack_f4,local_f8);
      }
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_128);
...
/* ResourceFormatLoader::rename_dependencies(String const&, HashMap<String, String,
...
ResourceFormatLoader::rename_dependencies
          (ResourceFormatLoader *this,String *param_1,HashMap *param_2)
...
LAB_0010bf7b:
      ...
      if (((pcVar9 != (code *)0x0) && (*(long *)(lVar7 + 0xe0) != 0)) ||
         (pcVar9 = *(code **)(lVar7 + 0xc0), pcVar9 != (code *)0x0)) {
...
LAB_0010be8a:
  ...
  if (*(long *)(this + 0x250) != 0) {
    ...
    if (*(code **)(*(long *)(this + 8) + 0xe0) == (code *)0x0) {
      ...
      (**(code **)(*(long *)(this + 8) + 0xe0))
                (*(undefined8 *)(this + 0x10),this + 0x240,*(undefined8 *)(this + 0x250),&local_78,
                 &local_118);
    }
...
/* ResourceFormatLoader::get_dependencies(String const&, List<String, DefaultAllocator>*, bool) */

void __thiscall
ResourceFormatLoader::get_dependencies
          (ResourceFormatLoader *this,String *param_1,List *param_2,bool param_3)

{
  ...
  if (plVar6 == (long *)0x0) {
LAB_0010c19c:
    if ((*(long *)(this + 8) != 0) && (this[0x218] == (ResourceFormatLoader)0x0)) {
      local_118 = 0;
      local_108 = (undefined1  [16])0x0;
      local_110 = 0;
      local_f8 = 0;
...
LAB_0010c788:
          ...
          pcVar7 = *(code **)(lVar5 + 200);
          if (((pcVar7 == (code *)0x0) || (*(long *)(lVar5 + 0xe0) == 0)) &&
             (pcVar7 = *(code **)(lVar5 + 0xc0), pcVar7 == (code *)0x0)) goto LAB_0010c651;
...
LAB_0010c488:
      ...
      (**(code **)(*(long *)(this + 8) + 0xe0))
                (*(undefined8 *)(this + 0x10),this + 0x210,*(undefined8 *)(this + 0x220),&local_78,
                 local_148);
...
/* ResourceFormatLoader::exists(String const&) const */

ulong __thiscall ResourceFormatLoader::exists(ResourceFormatLoader *this,String *param_1)

{
  ...
  if (plVar6 == (long *)0x0) {
LAB_0010c93e:
    if ((*(long *)(this + 8) != 0) && (this[0x260] == (ResourceFormatLoader)0x0)) {
      local_f8[0] = 0;
      local_f8[1] = 0;
      local_e8 = (undefined1  [16])0x0;
      uStack_f0 = 0;
...
LAB_0010ccd3:
          ...
          pcVar7 = *(code **)(lVar5 + 200);
          if (((pcVar7 == (code *)0x0) || (*(long *)(lVar5 + 0xe0) == 0)) &&
             (pcVar7 = *(code **)(lVar5 + 0xc0), pcVar7 == (code *)0x0)) goto LAB_0010cbe6;
...
LAB_0010cbe6:
    ...
    if (*(code **)(*(long *)(this + 8) + 0xe0) == (code *)0x0) {
      ...
      (**(code **)(*(long *)(this + 8) + 0xe0))
                (*(undefined8 *)(this + 0x10),this + 600,*(undefined8 *)(this + 0x268),local_58,
                 local_128);
    }
...
/* ResourceFormatLoader::has_custom_uid_support() const */

char __thiscall ResourceFormatLoader::has_custom_uid_support(ResourceFormatLoader *this)

{
  ...
  local_40 = *(long *)(in_FS_OFFSET + 0x28);
  if ((plVar5 != (long *)0x0) &&
     (cVar1 = (**(code **)(*plVar5 + 0x50))(plVar5,this + 0x1f8), cVar1 != '\0')) goto LAB_0010cdea;
  if ((*(long *)(this + 8) != 0) && (this[0x200] == (ResourceFormatLoader)0x0)) {
    local_b8 = 0;
    local_a8 = (undefined1  [16])0x0;
    local_b0 = 0;
    ...
    *(undefined8 *)(this + 0x208) = 0;
    ...
    if (((pcVar6 == (code *)0x0) || (*(long *)(lVar4 + 0xe0) == 0)) &&
      ...
      ClassDB::get_virtual_method_compatibility_hashes
                ((StringName *)local_e8,(StringName *)&local_f0);
      if (local_e0[0] == 0) {
        CowData<unsigned_int>::_unref((CowData<unsigned_int> *)local_e0);
        if ((StringName::configured != '\0') && (lVar4 = 0, local_f0 != 0)) goto LAB_0010cfe8;
        CowData<char32_t>::_unref((CowData<char32_t> *)&local_f8);
LAB_0010cffd:
        lVar4 = *(long *)(this + 8);
        pcVar6 = *(code **)(lVar4 + 200);
        if (((pcVar6 == (code *)0x0) || (*(long *)(lVar4 + 0xe0) == 0)) &&
           (pcVar6 = *(code **)(lVar4 + 0xc0), pcVar6 == (code *)0x0)) goto LAB_0010cf52;
...
/* ResourceFormatLoader::get_resource_script_class(String const&) const */

String * ResourceFormatLoader::get_resource_script_class(String *param_1)
...
LAB_0010d593:
        ...
        pcVar5 = *(code **)(lVar3 + 200);
        if (((pcVar5 == (code *)0x0) || (*(long *)(lVar3 + 0xe0) == 0)) &&
           (pcVar5 = *(code **)(lVar3 + 0xc0), pcVar5 == (code *)0x0)) goto LAB_0010d4a6;
...
LAB_0010d4a6:
  ...
  if (*(long *)(in_RSI + 0x1f0) != 0) {
    ...
    if (pcVar5 == (code *)0x0) {
      (**(code **)(in_RSI + 0x1f0))
                (*(undefined8 *)(in_RSI + 0x10),local_58,(CowData<char32_t> *)&local_128);
    }
    else {
      (*pcVar5)(*(undefined8 *)(in_RSI + 0x10),in_RSI + 0x1e0,*(undefined8 *)(in_RSI + 0x1f0),
                local_58,(CowData<char32_t> *)&local_128);
    }
    local_f8 = 0;
    uStack_f4 = 0;
...
/* ResourceFormatLoader::get_resource_type(String const&) const */

String * ResourceFormatLoader::get_resource_type(String *param_1)
...
LAB_0010db23:
        ...
        pcVar5 = *(code **)(lVar3 + 200);
        if (((pcVar5 == (code *)0x0) || (*(long *)(lVar3 + 0xe0) == 0)) &&
           (pcVar5 = *(code **)(lVar3 + 0xc0), pcVar5 == (code *)0x0)) goto LAB_0010da36;
...
LAB_0010da36:
  ...
  if (*(long *)(in_RSI + 0x1d8) != 0) {
    ...
    if (pcVar5 == (code *)0x0) {
      ...
      (*pcVar5)(*(undefined8 *)(in_RSI + 0x10),in_RSI + 0x1c8,*(undefined8 *)(in_RSI + 0x1d8),
                local_58,(CowData<char32_t> *)&local_128);
    }
    local_f8 = 0;
    uStack_f4 = 0;
...
/* ResourceFormatLoader::handles_type(String const&) const */

ulong __thiscall ResourceFormatLoader::handles_type(ResourceFormatLoader *this,String *param_1)

{
  ...
  if (plVar5 == (long *)0x0) {
LAB_0010dcbe:
    if ((*(long *)(this + 8) != 0) && (this[0x1b8] == (ResourceFormatLoader)0x0)) {
      unaff_R12 = local_128;
      local_f8 = 0;
      uStack_f4 = 0;
      local_e8 = (undefined1  [16])0x0;
      ...
      List<PropertyInfo,DefaultAllocator>::push_back
                ((List<PropertyInfo,DefaultAllocator> *)local_b8,(PropertyInfo *)unaff_R12);
      PropertyInfo::~PropertyInfo((PropertyInfo *)unaff_R12);
      Vector<int>::push_back(local_98,0);
      uVar2 = MethodInfo::get_compatibility_hash();
      lVar4 = *(long *)(this + 8);
      *(undefined8 *)(this + 0x1c0) = 0;
      ...
      if (((pcVar6 == (code *)0x0) || (*(long *)(lVar4 + 0xe0) == 0)) &&
        ...
        StringName::StringName((StringName *)&local_130,(String *)&local_138,false);
        ClassDB::get_virtual_method_compatibility_hashes
                  ((StringName *)unaff_R12,(StringName *)&local_130);
        if (local_120[0] == 0) {
...
LAB_0010e056:
          ...
          pcVar6 = *(code **)(lVar4 + 200);
          if (((pcVar6 == (code *)0x0) || (*(long *)(lVar4 + 0xe0) == 0)) &&
             (pcVar6 = *(code **)(lVar4 + 0xc0), pcVar6 == (code *)0x0)) goto LAB_0010df6e;
...
LAB_0010df6e:
    ...
    if (*(code **)(*(long *)(this + 8) + 0xe0) == (code *)0x0) {
      ...
      (**(code **)(*(long *)(this + 8) + 0xe0))
                (*(undefined8 *)(this + 0x10),this + 0x1b0,*(undefined8 *)(this + 0x1c0),local_58,
                 local_128);
    }
...
/* ResourceLoader::_dependency_get_progress(String const&) [clone .part.0] */

ulong ResourceLoader::_dependency_get_progress(String *param_1)

{
  ...
  lVar14 = HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>
           ::operator[]((HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>
                         *)thread_load_tasks,param_1);
  ...
  if (0 < (int)uVar1) {
    ...
    do {
      ...
      if ((thread_load_tasks._8_8_ != 0) &&
         (uVar15 = (ulong)(uint)thread_load_tasks._44_4_, thread_load_tasks._44_4_ != 0)) {
        uVar2 = (&hash_table_size_primes)[(uint)thread_load_tasks._40_4_];
        ...
        if (uVar13 != 0) {
          ...
          while ((uVar16 != uVar13 ||
                 (cVar12 = String::operator==((String *)
                                              (*(long *)(thread_load_tasks._8_8_ + lVar18 * 8) +
                                              0x10),pSVar20), lVar21 = thread_load_tasks._16_8_,
                 cVar12 == '\0'))) {
            uVar19 = uVar19 + 1;
            auVar5._8_8_ = 0;
            ...
            if ((uVar13 == 0) ||
               ...
               auVar11._8_8_ = 0, auVar11._0_8_ = uVar22, uVar15 = SUB168(auVar7 * auVar11,0),
               SUB164(auVar7 * auVar11,8) < uVar19)) goto LAB_0010e272;
          }
...
LAB_0010e2b8:
  ...
  *(float *)(lVar14 + 0x44) = fVar23;
  return uVar15;
code_r0x0010e280:
  fVar24 = (float)((double)*(float *)(lVar14 + 0x40) * __LC126 +
                  (double)((fVar24 / (float)(int)uVar1) * __LC127));
  goto LAB_0010e2b8;
}



/* ResourceLoader::_dependency_get_progress(String const&) */
      ...
      do {
        if ((uVar13 == uVar12) &&
           (cVar11 = String::operator==((String *)
                                        (*(long *)(thread_load_tasks._8_8_ + lVar15 * 8) + 0x10),
                                        param_1), lVar16 = thread_load_tasks._16_8_, cVar11 != '\0')
           ) {
...
/* ResourceLoader::load_threaded_get_status(String const&, float*) */

int ResourceLoader::load_threaded_get_status(String *param_1,float *param_2)
  ...
  if ((user_load_tokens._8_8_ != 0) && (user_load_tokens._44_4_ != 0)) {
    ...
    if (uVar12 != 0) {
      ...
      do {
        if ((uVar16 == uVar12) &&
           (cVar11 = String::operator==((String *)
                                        (*(long *)(user_load_tokens._8_8_ + lVar17 * 8) + 0x10),
                                        param_1), lVar18 = user_load_tokens._16_8_, cVar11 != '\0'))
        {
          _validate_local_path(local_60);
          local_68[0] = 0;
          cVar11 = HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>
                   ::_lookup_pos((HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>
                                  *)thread_load_tasks,local_60,local_68);
          if (cVar11 == '\0') {
            _err_print_error("load_threaded_get_status","core/io/resource_loader.cpp",700,
                             "Condition \"!thread_load_tasks.has(local_path)\" is true. Returning: THREAD_LOAD_INVALID_RESOURCE"
                             ,"Bug in ResourceLoader logic, please report.",0,0);
            CowData<char32_t>::_unref((CowData<char32_t> *)local_60);
            goto LAB_0010e4b5;
          }
          lVar14 = HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>
                   ::operator[]((HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>
                                 *)thread_load_tasks,local_60);
...
LAB_0010e68b:
        ...
        iVar13 = SUB164(auVar3 * auVar7,8);
              ...
              auVar5._0_8_ = (ulong)((uVar1 + iVar13) - SUB164(auVar4 * auVar8,8)) * lVar14,
  ...
  if (cVar11 == '\0') {
LAB_0010e4b5:
    if ((char)*in_FS_OFFSET != '\0') goto LAB_0010e4c4;
LAB_0010e7fc:
    __tls_init_part_0();
    *in_FS_OFFSET = *in_FS_OFFSET + -1;
    iVar13 = *in_FS_OFFSET;
    ...
    local_70 = 0;
    String::parse_latin1
              ((String *)&local_70,"\' has been initiated or its result has already been collected."
              );
    operator+((char *)local_78,
              (String *)"load_threaded_get_status(): No threaded load for resource path \'");
...
/* ResourceLoader::LoadToken::clear() */

void __thiscall ResourceLoader::LoadToken::clear(LoadToken *this)
  ...
  *(int *)in_FS_OFFSET = iVar29;
  ...
  if ((*(long *)(this + 0x180) != 0) && (1 < *(uint *)(*(long *)(this + 0x180) + -8))) {
    ...
    if (this_02 == (ThreadLoadTask *)0x0) {
      ...
      plVar31 = (long *)HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>
                        ::operator[]((HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>
                                      *)thread_load_tasks,this_00);
      lVar38 = *plVar31;
...
LAB_0010ed43:
        ...
        if (uVar30 != 0) {
          ...
          do {
            if ((uVar30 == uVar32) &&
               (cVar28 = String::operator==((String *)
                                            (*(long *)(thread_load_tasks._8_8_ + lVar34 * 8) + 0x10)
                                            ,this_00), uVar27 = thread_load_tasks._16_8_,
               uVar26 = thread_load_tasks._8_8_, lVar36 = thread_load_tasks._16_8_, cVar28 != '\0'))
            {
              uVar4 = (&hash_table_size_primes)[(uint)thread_load_tasks._40_4_];
              uVar37 = CONCAT44(0,uVar4);
              lVar40 = *(long *)(hash_table_size_primes_inv +
                                (ulong)(uint)thread_load_tasks._40_4_ * 8);
              auVar10._8_8_ = 0;
              ...
              uVar32 = *puVar41;
              if ((uVar32 == 0) ||
                 (auVar11._8_8_ = 0, auVar11._0_8_ = (ulong)uVar32 * lVar40, auVar21._8_8_ = 0,
                 auVar21._0_8_ = uVar37, auVar12._8_8_ = 0,
                 auVar12._0_8_ = (ulong)((uVar4 + uVar30) - SUB164(auVar11 * auVar21,8)) * lVar40,
                 auVar22._8_8_ = 0, auVar22._0_8_ = uVar37, uVar39 = uVar33,
                 SUB164(auVar12 * auVar22,8) == 0)) goto LAB_0010ef39;
              goto LAB_0010eeed;
            }
            uVar39 = uVar39 + 1;
            auVar7._8_8_ = 0;
            ...
            uVar33 = SUB164(auVar7 * auVar17,8);
                  ...
                  (auVar8._8_8_ = 0, auVar8._0_8_ = (ulong)uVar30 * lVar40, auVar18._8_8_ = 0,
                  auVar18._0_8_ = uVar37, auVar9._8_8_ = 0,
                  auVar9._0_8_ = (ulong)((uVar4 + uVar33) - SUB164(auVar8 * auVar18,8)) * lVar40,
                  auVar19._8_8_ = 0, auVar19._0_8_ = uVar37, uVar39 <= SUB164(auVar9 * auVar19,8)));
        }
        goto LAB_0010efc4;
      }
      if ((*(long *)(this + 0x180) != 0) && (*(long *)(*(long *)(this + 0x180) + -8) != 0)) {
...
LAB_0010e9d6:
  lVar38 = 0;
  goto LAB_0010e9d9;
  while (auVar13._8_8_ = 0, auVar13._0_8_ = (ulong)uVar32 * lVar40, auVar23._8_8_ = 0,
        auVar23._0_8_ = uVar37, auVar14._8_8_ = 0,
        auVar14._0_8_ = (ulong)((uVar30 + uVar4) - SUB164(auVar13 * auVar23,8)) * lVar40,
        auVar24._8_8_ = 0, auVar24._0_8_ = uVar37, uVar39 = uVar33, SUB164(auVar14 * auVar24,8) != 0
        ) {
LAB_0010eeed:
    uVar33 = uVar30;
...
void __thiscall ResourceLoader::LoadToken::~LoadToken(LoadToken *this)
...
/* ResourceLoader::_load_complete_inner(ResourceLoader::LoadToken&, Error*,
   MutexLock<SafeBinaryMutex<1> >&) */

LoadToken *
ResourceLoader::_load_complete_inner(LoadToken *param_1,Error *param_2,MutexLock *param_3)

{
  ...
  if (plVar14 == (long *)0x0) {
    ...
    cVar8 = HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>
            ::_lookup_pos((HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>
                           *)thread_load_tasks,(String *)(param_2 + 0x180),(uint *)&local_2d8);
    if (cVar8 == '\0') {
      if (param_3 != (MutexLock *)0x0) {
        *(undefined4 *)param_3 = 0x2f;
      }
      _err_print_error("_load_complete_inner","core/io/resource_loader.cpp",800,
                       "Method/function failed. Returning: Ref<Resource>()",
                       "Bug in ResourceLoader logic, please report.",0);
      *(undefined8 *)param_1 = 0;
      goto LAB_0010f3d4;
    }
    plVar14 = (long *)HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>
                      ::operator[]((HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>
                                    *)thread_load_tasks,(String *)(param_2 + 0x180));
    if ((int)plVar14[10] == 1) {
      lVar18 = *plVar14;
      if (lVar18 == 0) {
        lVar18 = plVar14[1];
...
LAB_0010feb9:
  ...
  *(undefined8 *)param_1 = 0;
  ...
  if (((pRVar7 != (Ref *)0x0) && (cVar8 = RefCounted::unreference(), cVar8 != '\0')) &&
     (cVar8 = predelete_handler((Object *)pRVar7), cVar8 != '\0')) {
...
/* ResourceLoader::_load_complete(ResourceLoader::LoadToken&, Error*) */
...
/* ResourceLoader::load_threaded_get(String const&, Error*) */
...
LAB_001100da:
    ...
    do {
      if ((uVar15 == uVar20) &&
         (cVar14 = String::operator==((String *)
                                      (*(long *)(user_load_tokens._8_8_ + lVar21 * 8) + 0x10),
                                      param_1), lVar24 = user_load_tokens._16_8_, cVar14 != '\0')) {
        puVar17 = (undefined8 *)
                  HashMap<String,ResourceLoader::LoadToken*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::LoadToken*>>>
                  ::operator[]((HashMap<String,ResourceLoader::LoadToken*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::LoadToken*>>>
                                *)user_load_tokens,param_1);
        pOVar4 = (Object *)*puVar17;
        if (_GLOBAL_OFFSET_TABLE_ != (undefined *)0x0) {
                    /* WARNING: Subroutine does not return */
          Thread::caller_id();
        }
        if (((*(long *)((long)in_FS_OFFSET + lRam0000000000110278) != 1) ||
            (*(long *)(pOVar4 + 0x180) == 0)) || (*(uint *)(*(long *)(pOVar4 + 0x180) + -8) < 2))
        goto LAB_00110283;
        lVar18 = HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>
                 ::operator[]((HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>
                               *)thread_load_tasks,(String *)(pOVar4 + 0x180));
        goto LAB_00110580;
      }
      uVar23 = uVar23 + 1;
      auVar6._8_8_ = 0;
      ...
      iVar16 = SUB164(auVar6 * auVar10,8);
            ...
            (auVar7._8_8_ = 0, auVar7._0_8_ = (ulong)uVar15 * lVar18, auVar11._8_8_ = 0,
            auVar11._0_8_ = uVar13, auVar8._8_8_ = 0,
            auVar8._0_8_ = (ulong)((uVar3 + iVar16) - SUB164(auVar7 * auVar11,8)) * lVar18,
  ...
  if (cVar14 != '\0') {
    ...
    operator+((char *)local_78,
              (String *)"load_threaded_get(): No threaded load for resource path \'");
...
LAB_00110119:
  ...
  while( true ) {
    ...
    if (cVar22 == '\0') break;
LAB_00110580:
    if (*(int *)(lVar18 + 0x50) != 1) break;
  }
LAB_00110283:
  _load_complete_inner((LoadToken *)&local_60,(Error *)pOVar4,(MutexLock *)param_2);
  Ref<Resource>::operator=((Ref<Resource> *)&local_88,local_60);
  if (((local_60 != (Ref *)0x0) && (cVar14 = RefCounted::unreference(), cVar14 != '\0')) &&
     (cVar14 = predelete_handler((Object *)local_60), cVar14 != '\0')) {
  ...
  *(int *)pOVar1 = *(int *)pOVar1 + -1;
  ...
  pOVar4 = local_88;
  *(undefined8 *)this = 0;
  Ref<Resource>::operator=((Ref<Resource> *)this,(Ref *)local_88);
  if (((pOVar4 != (Object *)0x0) && (cVar14 = RefCounted::unreference(), cVar14 != '\0')) &&
     (cVar14 = predelete_handler(pOVar4), cVar14 != '\0')) {
    (**(code **)(*(long *)pOVar4 + 0x140))(pOVar4);
    Memory::free_static(pOVar4,false);
  }
  goto LAB_00110119;
...
/* ResourceLoader::_load_start(String const&, String const&, ResourceLoader::LoadThreadMode,
   ResourceFormatLoader::CacheMode, bool) */
...
joined_r0x00110c49:
  ...
  if (param_5 != 0 && param_5 != 3) {
    ...
    cVar2 = HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>
            ::_lookup_pos((HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>
                           *)thread_load_tasks,(String *)&local_f8,(uint *)&local_e8);
    if (cVar2 != '\0') {
      lVar6 = HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>
              ::operator[]((HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>
                            *)thread_load_tasks,(String *)&local_f8);
  ...
  *(undefined1 (*) [16])(this_01 + 0x180) = (undefined1  [16])0x0;
  ...
  if (param_5 == 1) {
    ...
    if ((Ref *)CONCAT44(uStack_ec,local_f0) != (Ref *)0x0) {
      ...
      pTVar5 = (ThreadLoadTask *)
               HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>
               ::operator[]((HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>
                             *)thread_load_tasks,(String *)&local_f8);
...
LAB_00110aa2:
    HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>
    ::insert((String *)&local_f0,(ThreadLoadTask *)thread_load_tasks,SUB81((String *)&local_f8,0));
    ...
    cVar2 = HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>
            ::_lookup_pos((HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>
                           *)thread_load_tasks,(String *)&local_f8,&local_f0);
...
LAB_00110b08:
    *in_FS_OFFSET = *in_FS_OFFSET + -1;
    ...
    local_e8 = 0;
    lVar6 = WorkerThreadPool::add_native_task
                      (WorkerThreadPool::singleton,_run_load_task,SUB81(pTVar5,0),(String *)0x0);
    *(long *)pTVar5 = lVar6;
    CowData<char32_t>::_unref((CowData<char32_t> *)&local_e8);
...
LAB_00110b40:
  if (((pRVar7 != (RefCounted *)0x0) && (cVar2 = RefCounted::unreference(), cVar2 != '\0')) &&
     (cVar2 = predelete_handler((Object *)pRVar7), cVar2 != '\0')) {
...
/* ResourceLoader::load(String const&, String const&, ResourceFormatLoader::CacheMode, Error*) */
...
LAB_001113d9:
  if (local_30 == *(long *)(in_FS_OFFSET + 10)) {
    return this;
  }
                    /* WARNING: Subroutine does not return */
  __stack_chk_fail();
...
/* ResourceLoader::add_custom_resource_format_loader(String const&) [clone .part.0] */

uint ResourceLoader::add_custom_resource_format_loader(String *param_1)

{
  ...
  if (local_88 == (Object *)0x0) {
    uVar3 = 0;
    _err_print_error("add_custom_resource_format_loader","core/io/resource_loader.cpp",0x5b9,
                     "Condition \"res.is_null()\" is true. Returning: false",0,0);
    goto LAB_00111857;
  }
  ...
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_70);
  if ((char)uVar3 == '\0') {
    _err_print_error("add_custom_resource_format_loader","core/io/resource_loader.cpp",0x5ba,
                     "Condition \"!res->is_class(\"Script\")\" is true. Returning: false",0,0);
  }
  else {
    ...
    if ((char)uVar3 == '\0') {
      ...
      String::parse_latin1
                ((String *)&local_78,
                 "Failed to add a custom resource loader, script \'%s\' does not inherit \'ResourceFormatLoader\'."
                );
      vformat<String>((StringName *)&local_68,(String *)&local_78,(StrRange *)&local_70);
      _err_print_error("add_custom_resource_format_loader","core/io/resource_loader.cpp",0x5bf,
                       "Condition \"!valid_type\" is true. Returning: false",(StringName *)&local_68
                       ,0,0);
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_68);
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_78);
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_70);
...
LAB_00111827:
      ...
      String::parse_latin1
                ((String *)&local_78,
                 "Failed to add a custom resource loader, cannot instantiate \'%s\'.");
      vformat<StringName>((StringName *)&local_68,(String *)&local_78,(StrRange *)&local_70);
      _err_print_error("add_custom_resource_format_loader","core/io/resource_loader.cpp",0x5c2,
                       "Parameter \"obj\" is null.",(StringName *)&local_68,0,0);
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_68);
      CowData<char32_t>::_unref((CowData<char32_t> *)&local_78);
...
/* ResourceLoader::add_custom_resource_format_loader(String const&) */

undefined8 ResourceLoader::add_custom_resource_format_loader(String *param_1)
...
void ResourceLoader::add_custom_loaders(void)
...
/* CowData<Ref<ResourceFormatLoader> >::_copy_on_write() [clone .isra.0] */

void __thiscall
CowData<Ref<ResourceFormatLoader>>::_copy_on_write(CowData<Ref<ResourceFormatLoader>> *this)
...
/* ResourceLoader::list_directory(String const&) */

ResourceLoader * __thiscall ResourceLoader::list_directory(ResourceLoader *this,String *param_1)
      ...
      while ((local_78 != 0 && (1 < *(uint *)(local_78 + -8)))) {
        ...
        if (cVar3 == '\0') {
          ...
          if (((cVar3 != '\0') || (cVar3 = String::ends_with((char *)&local_78), cVar3 != '\0')) ||
             (cVar3 = String::ends_with((char *)&local_78), cVar3 != '\0')) {
          ...
          if (0 < loader_count) {
            ...
            do {
              local_68 = 0;
              cVar3 = (**(code **)(*(long *)(&loader)[lVar11] + 0x170))
                                ((long *)(&loader)[lVar11],(String *)&local_70,
          ...
          if ((cVar3 != '\0') &&
             (cVar3 = String::operator!=((String *)&local_78,".."), cVar3 != '\0')) {
...
joined_r0x001123a9:
            ...
            if (pEVar6 == (Element *)0x0) {
              ...
              *(undefined4 *)pEVar6 = 1;
              *(Element **)(pEVar6 + 8) = local_50;
              *(Element **)(pEVar6 + 0x10) = local_50;
              *(Element **)(pEVar6 + 0x18) = local_50;
              local_58 = pEVar6;
            }
            else {
...
LAB_00112406:
            local_98 = (RBSet<String,Comparator<String>,DefaultAllocator> *)&local_58;
...
LAB_0011220e:
        (**(code **)(*(long *)local_80 + 0x168))((CowData<char32_t> *)&local_68);
        if (local_78 != local_68) {
          CowData<char32_t>::_unref((CowData<char32_t> *)&local_78);
          local_78 = local_68;
          local_68 = 0;
  ...
  local_98 = (RBSet<String,Comparator<String>,DefaultAllocator> *)&local_58;
  RBSet<String,Comparator<String>,DefaultAllocator>::~RBSet(local_98);
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    __stack_chk_fail();
  }
...
/* ResourceLoader::ensure_resource_ref_override_for_outer_load(String const&, String const&) */
...

{
  ...
  *this_00;
  ...
  local_40 = *(long *)(in_FS_OFFSET + 10);
  if (*in_FS_OFFSET == 0) {
    _err_print_error("ensure_resource_ref_override_for_outer_load","core/io/resource_loader.cpp",
                     0x3d2,"Condition \"load_nesting == 0\" is true. Returning: Ref<Resource>()",0,0
                    );
    *(undefined8 *)this = 0;
    goto LAB_001129dd;
  }
  ...
  this_00 = (HashMap<String,Ref<Resource>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<Resource>>>>
             *)HashMap<int,HashMap<String,Ref<Resource>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<Resource>>>>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,HashMap<String,Ref<Resource>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<Resource>>>>>>>
               ::operator[](*(HashMap<int,HashMap<String,Ref<Resource>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<Resource>>>>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,HashMap<String,Ref<Resource>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<Resource>>>>>>>
  ...
  if ((*(long *)(this_00 + 8) != 0) && (*(int *)(this_00 + 0x2c) != 0)) {
    ...
    if (uVar12 != 0) {
      ...
      do {
        if (uVar17 == uVar12) {
          cVar11 = String::operator==((String *)
                                      (*(long *)(*(long *)(this_00 + 8) + lVar20 * 8) + 0x10),
                                      local_68);
          if (cVar11 != '\0') {
        ...
        if ((uVar12 == 0) ||
           ...
           auVar5._0_8_ = (ulong)((uVar1 + uVar18) - SUB164(auVar4 * auVar8,8)) * lVar14,
           auVar9._8_8_ = 0, auVar9._0_8_ = uVar10, SUB164(auVar5 * auVar9,8) < uVar22)) break;
      } while( true );
    }
  }
...
void ResourceLoader::remove_custom_loaders(void)
  ...
  if (0 < loader_count) {
    ...
    do {
      ...
      if (*(long *)(pOVar5 + 0x98) != 0) {
        ...
        iVar4 = CowData<Ref<ResourceFormatLoader>>::resize<false>
                          ((CowData<Ref<ResourceFormatLoader>> *)local_50,lVar6);
        if (iVar4 == 0) {
          if (local_50[0] == 0) {
            lVar8 = -1;
            lVar6 = 0;
LAB_00112e42:
          ...
          CowData<Ref<ResourceFormatLoader>>::_copy_on_write
                    ((CowData<Ref<ResourceFormatLoader>> *)local_50);
          lVar6 = local_50[0];
          ...
          *puVar1 = pOVar5;
          if (pOVar5 == (Object *)0x0) {
            if (((pOVar2 == (Object *)0x0) || (cVar3 = RefCounted::unreference(), cVar3 == '\0')) ||
               (cVar3 = predelete_handler(pOVar2), cVar3 == '\0')) goto LAB_00112c53;
LAB_00112dd9:
            (**(code **)(*(long *)pOVar2 + 0x140))(pOVar2);
            Memory::free_static(pOVar2,false);
            lVar6 = local_50[0];
...
joined_r0x00112d68:
        ...
        local_50[0] = lVar6;
        if ((cVar3 != '\0') &&
           (cVar3 = predelete_handler(pOVar5), lVar6 = local_50[0], cVar3 != '\0')) {
...
LAB_00112c53:
    ...
    if ((lVar6 != 0) && (0 < *(long *)(lVar6 + -8))) {
      lVar7 = 0;
      do {
        while ((pOVar5 = *(Object **)(lVar6 + lVar7 * 8), pOVar5 == (Object *)0x0 ||
               (local_60[0] = pOVar5, cVar3 = RefCounted::reference(), cVar3 == '\0'))) {
...
LAB_00112d10:
  CowData<Ref<ResourceFormatLoader>>::_unref((CowData<Ref<ResourceFormatLoader>> *)local_50);
  if (local_40 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    __stack_chk_fail();
  }
...
/* TLS init function for ResourceLoader::load_paths_stack */

void ResourceLoader::load_paths_stack(void)
...
{
  return (uint)CONCAT71(0x1209,(undefined4 *)param_1 == &Object::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1209,(undefined4 *)param_1 == &get_class_ptr_static()::ptr);
}
...
{
  return (uint)CONCAT71(0x1209,(undefined4 *)param_1 == &RefCounted::get_class_ptr_static()::ptr) |
         (uint)CONCAT71(0x1209,(undefined4 *)param_1 == &get_class_ptr_static()::ptr) |
...
/* core_bind::Semaphore::is_class_ptr(void*) const */

uint __thiscall core_bind::Semaphore::is_class_ptr(Semaphore *this,void *param_1)
...
/* core_bind::Semaphore::_getv(StringName const&, Variant&) const */

undefined8 core_bind::Semaphore::_getv(StringName *param_1,Variant *param_2)
...
/* core_bind::Semaphore::_setv(StringName const&, Variant const&) */

undefined8 core_bind::Semaphore::_setv(StringName *param_1,Variant *param_2)
...
/* core_bind::Semaphore::_validate_propertyv(PropertyInfo&) const */

void core_bind::Semaphore::_validate_propertyv(PropertyInfo *param_1)
...
/* core_bind::Semaphore::_property_can_revertv(StringName const&) const */

undefined8 core_bind::Semaphore::_property_can_revertv(StringName *param_1)
...
/* core_bind::Semaphore::_property_get_revertv(StringName const&, Variant&) const */

undefined8 core_bind::Semaphore::_property_get_revertv(StringName *param_1,Variant *param_2)
...
/* core_bind::Semaphore::_notificationv(int, bool) */

void core_bind::Semaphore::_notificationv(int param_1,bool param_2)
...
void __thiscall
CallableCustomMethodPointer<core_bind::Semaphore,void,int>::~CallableCustomMethodPointer
          (CallableCustomMethodPointer<core_bind::Semaphore,void,int> *this)
...
void __thiscall
CallableCustomMethodPointer<Resource,void,Callable_const&,unsigned_int>::
~CallableCustomMethodPointer
          (CallableCustomMethodPointer<Resource,void,Callable_const&,unsigned_int> *this)
...
/* CallableCustomMethodPointer<core_bind::Semaphore, void, int>::get_argument_count(bool&) const */

undefined8 __thiscall
CallableCustomMethodPointer<core_bind::Semaphore,void,int>::get_argument_count
          (CallableCustomMethodPointer<core_bind::Semaphore,void,int> *this,bool *param_1)
...
undefined8 __thiscall
CallableCustomMethodPointer<Resource,void,Callable_const&,unsigned_int>::get_argument_count
          (CallableCustomMethodPointer<Resource,void,Callable_const&,unsigned_int> *this,
          bool *param_1)
...
void __thiscall SafeBinaryMutex<1>::~SafeBinaryMutex(SafeBinaryMutex<1> *this)
...
void __thiscall SelfList<Resource>::List::~List(List *this)
...
void __thiscall core_bind::Semaphore::~Semaphore(Semaphore *this)
...
/* ResourceLoader::_load_start(String const&, String const&, ResourceLoader::LoadThreadMode,
   ResourceFormatLoader::CacheMode, bool) [clone .cold] */

void ResourceLoader::_load_start(void)
...
/* ResourceLoader::add_custom_resource_format_loader(String const&) [clone .part.0] [clone .cold] */

void ResourceLoader::add_custom_resource_format_loader(String *param_1)
...
/* CowData<Ref<ResourceFormatLoader> >::_copy_on_write() [clone .isra.0] [clone .cold] */

void CowData<Ref<ResourceFormatLoader>>::_copy_on_write(void)
...
/* CallableCustomMethodPointer<core_bind::Semaphore, void, int>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<core_bind::Semaphore,void,int>::get_object
          (CallableCustomMethodPointer<core_bind::Semaphore,void,int> *this)
...
/* CallableCustomMethodPointer<Resource, void, Callable const&, unsigned int>::get_object() const */

undefined8 __thiscall
CallableCustomMethodPointer<Resource,void,Callable_const&,unsigned_int>::get_object
          (CallableCustomMethodPointer<Resource,void,Callable_const&,unsigned_int> *this)
...
void __thiscall SafeBinaryMutex<1>::TLSData::~TLSData(TLSData *this)
...
/* core_bind::Semaphore::_get_class_namev() const */

undefined8 * core_bind::Semaphore::_get_class_namev(void)
...
LAB_001140f3:
    ...
    if (*(long *)(_get_class_namev()::_class_name_static + 0x10) != 0) {
      ...
      StringName::assign_static_unique_class_name
                ((StringName *)&_get_class_namev()::_class_name_static,"Semaphore");
      goto LAB_0011415e;
    }
  }
  StringName::assign_static_unique_class_name
...
void __thiscall
HashMap<int,HashMap<String,Ref<Resource>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<Resource>>>>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,HashMap<String,Ref<Resource>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<Resource>>>>>>>
::~HashMap(HashMap<int,HashMap<String,Ref<Resource>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<Resource>>>>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,HashMap<String,Ref<Resource>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<Resource>>>>>>>
           *this)
...
void __thiscall
HashMap<String,ResourceLoader::LoadToken*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::LoadToken*>>>
::~HashMap(HashMap<String,ResourceLoader::LoadToken*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::LoadToken*>>>
           *this)
...
/* core_bind::Semaphore::get_class() const */

void core_bind::Semaphore::get_class(void)
...
/* core_bind::Semaphore::is_class(String const&) const */

undefined8 __thiscall core_bind::Semaphore::is_class(Semaphore *this,String *param_1)
...
void __thiscall
ResourceLoader::ThreadLoadTask::ThreadLoadTask(ThreadLoadTask *this,ThreadLoadTask *param_1)
    ...
    *(undefined8 *)(this + 0x78) = uVar12;
    if (*(int *)(this + 0x94) != 0) {
      do {
        ...
        *(undefined4 *)(*(long *)(this + 0x80) + lVar11 * 4) =
             *(undefined4 *)(*(long *)(param_1 + 0x80) + lVar11 * 4);
        lVar11 = lVar11 + 1;
    ...
    if (uVar10 < uVar5) {
      ...
      do {
        ...
        *(undefined4 *)(pauVar14[1] + 8) = 0;
        pauVar14 = pauVar15;
      } while ((undefined1 (*) [16])(((ulong)uVar10 + 1 + (ulong)(uVar1 - uVar10)) * 0x20 + lVar11)
               != pauVar15);
    }
...
/* core_bind::Semaphore::_initialize_classv() */

void core_bind::Semaphore::_initialize_classv(void)
...
void __thiscall ResourceLoader::ThreadLoadTask::~ThreadLoadTask(ThreadLoadTask *this)
...
LAB_00118a4e:
  ...
  if (*(int *)(this + 0x94) != 0) {
    if ((&hash_table_size_primes)[*(uint *)(this + 0x90)] != 0) {
      memset(*(void **)(this + 0x88),0,
             (ulong)(uint)(&hash_table_size_primes)[*(uint *)(this + 0x90)] << 2);
...
void __thiscall
HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>
::~HashMap(HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>
           *this)
...
LAB_00118d64:
    if ((float)uVar39 * __LC36 < (float)(iVar44 + 1)) goto LAB_00118d8a;
  }
  local_58[0] = 0;
  if (*(long *)param_1 == 0) {
    local_58[1] = 0;
...
LAB_00119556:
    ...
    *(void **)(this + 8) = __s_00;
    ...
    iVar44 = 0;
LAB_00119530:
    if ((float)uVar47 * __LC36 < (float)(iVar44 + 1)) goto LAB_00119556;
  }
  local_58 = 0;
  local_68 = (undefined1  [16])0x0;
  if (*(long *)param_1 == 0) {
...
void __thiscall
CallableCustomMethodPointer<core_bind::Semaphore,void,int>::call
          (CallableCustomMethodPointer<core_bind::Semaphore,void,int> *this,Variant **param_1,
...
void __thiscall
CallableCustomMethodPointer<Resource,void,Callable_const&,unsigned_int>::call
          (CallableCustomMethodPointer<Resource,void,Callable_const&,unsigned_int> *this,
...
void __thiscall
core_bind::Semaphore::_get_property_listv(Semaphore *this,List *param_1,bool param_2)
...
LAB_0011be6d:
    ...
    *(void **)(this + 8) = __s_00;
    ...
    iVar45 = 0;
LAB_0011be47:
    if ((float)uVar48 * __LC36 < (float)(iVar45 + 1)) goto LAB_0011be6d;
  }
  local_58[0] = 0;
  local_68 = (undefined1  [16])0x0;
  if (*(long *)param_1 == 0) {
...
void __thiscall
HashMap<String,Vector<String>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Vector<String>>>>
::~HashMap(HashMap<String,Vector<String>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Vector<String>>>>
           *this)
...
LAB_0011d920:
      ...
      if (uVar21 == 0) {
        ...
        do {
          if (uVar21 == uVar27) {
            ...
            if (cVar19 != '\0') {
              local_1d0 = (ThreadLoadTask *)
                          (*(long *)(*(long *)(this + 8) + (ulong)uVar31 * 8) + 0x18);
              goto LAB_0011d7ff;
            }
            lVar24 = *(long *)(this + 8);
            lVar33 = *(long *)(this + 0x10);
          ...
          uVar31 = SUB164(auVar8 * auVar16,8);
                ...
                (auVar9._8_8_ = 0, auVar9._0_8_ = (ulong)uVar21 * lVar25, auVar17._8_8_ = 0,
                auVar17._0_8_ = uVar29, auVar10._8_8_ = 0,
                auVar10._0_8_ = (ulong)((uVar31 + uVar20) - SUB164(auVar9 * auVar17,8)) * lVar25,
                auVar18._8_8_ = 0, auVar18._0_8_ = uVar29, uVar36 <= SUB164(auVar10 * auVar18,8)));
      }
      goto LAB_0011d920;
    }
    pTVar30 = local_1b8;
  ...
  if (cVar19 == '\0') {
    ...
    *(int *)(this + 0x2c) = *(int *)(this + 0x2c) + 1;
    ...
    ResourceLoader::ThreadLoadTask::operator=
              ((ThreadLoadTask *)(*(long *)(*(long *)(this + 8) + uVar29 * 8) + 0x18),local_1d8);
    local_1d0 = (ThreadLoadTask *)(*(long *)(*(long *)(this + 8) + uVar29 * 8) + 0x18);
  }
LAB_0011d7f0:
  ResourceLoader::ThreadLoadTask::~ThreadLoadTask(local_1d8);
LAB_0011d7ff:
  if (local_40 == *(long *)(in_FS_OFFSET + 0x28)) {
    return local_1d0;
  }
...
String * HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>
         ::insert(String *param_1,ThreadLoadTask *param_2,bool param_3)
...
LAB_0011db55:
    ...
    _resize_and_rehash((HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>
...
LAB_0011db33:
    if ((float)uVar25 * __LC36 < (float)(iVar26 + 1)) goto LAB_0011db55;
  }
  local_f8 = 0;
  if (*(long *)pSVar29 != 0) {
          ...
          do {
            if (uVar31 == uVar40) {
              cVar29 = String::operator==((String *)
                                          (*(long *)(*(long *)(this + 8) + lVar38 * 8) + 0x10),
                                          param_1);
              if (cVar29 != '\0') {
                Ref<Resource>::operator=
                          ((Ref<Resource> *)
                           (*(long *)(*(long *)(this + 8) + (ulong)uVar43 * 8) + 0x18),(Ref *)0x0);
                local_70 = (Ref<Resource> *)
                           (*(long *)(*(long *)(this + 8) + (ulong)uVar43 * 8) + 0x18);
                goto LAB_0011e444;
              }
              lVar41 = *(long *)(this + 0x10);
            }
            ...
            uVar43 = SUB164(auVar13 * auVar25,8);
                  ...
                  (auVar14._8_8_ = 0, auVar14._0_8_ = (ulong)uVar40 * lVar3, auVar26._8_8_ = 0,
                  auVar26._0_8_ = uVar39, auVar15._8_8_ = 0,
                  auVar15._0_8_ = (ulong)((uVar36 + uVar43) - SUB164(auVar14 * auVar26,8)) * lVar3,
                  auVar27._8_8_ = 0, auVar27._0_8_ = uVar39, uVar44 <= SUB164(auVar15 * auVar27,8)))
          ;
        }
        uVar39 = (ulong)uVar30;
        iVar35 = *(int *)(this + 0x2c);
      ...
      if (uVar31 != 0) {
        do {
          ...
          uVar40 = SUB164(auVar9 * auVar21,8);
                ...
                (auVar10._8_8_ = 0, auVar10._0_8_ = (ulong)uVar31 * lVar3, auVar22._8_8_ = 0,
                auVar22._0_8_ = uVar39, auVar11._8_8_ = 0,
                auVar11._0_8_ = (ulong)((uVar40 + uVar30) - SUB164(auVar10 * auVar22,8)) * lVar3,
                auVar23._8_8_ = 0, auVar23._0_8_ = uVar39, uVar43 <= SUB164(auVar11 * auVar23,8)));
      }
...
LAB_0011e253:
    if ((float)uVar39 * __LC36 < (float)(iVar35 + 1)) goto LAB_0011e275;
  }
  local_58 = 0;
  if (*(long *)param_1 != 0) {
    CowData<char32_t>::_ref((CowData<char32_t> *)&local_58,(CowData *)param_1);
  ...
  *puVar32 = 0;
  ...
  if (((pRVar28 != (Ref *)0x0) && (cVar29 = RefCounted::unreference(), cVar29 != '\0')) &&
     (cVar29 = predelete_handler((Object *)pRVar28), cVar29 != '\0')) {
...
void __thiscall CowData<Ref<ResourceFormatLoader>>::_unref(CowData<Ref<ResourceFormatLoader>> *this)
...
String * HashMap<String,Ref<Resource>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<Resource>>>>
...
LAB_0011ec91:
    ...
    _resize_and_rehash((HashMap<String,Ref<Resource>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<Resource>>>>
                        *)param_2,*(int *)(param_2 + 0x28) + 1);
  }
  else {
LAB_0011ec5f:
        ...
        do {
          if (uVar32 == uVar33) {
            cVar20 = String::operator==((String *)
                                        (*(long *)(*(long *)(param_2 + 8) + lVar30 * 8) + 0x10),
                                        pSVar28);
            if (cVar20 != '\0') {
              Ref<Resource>::operator=
                        ((Ref<Resource> *)
                         (*(long *)(*(long *)(param_2 + 8) + (ulong)uVar27 * 8) + 0x18),
                         (Ref *)*in_RCX);
          ...
          uVar27 = SUB164(auVar8 * auVar16,8);
                ...
                (auVar9._8_8_ = 0, auVar9._0_8_ = (ulong)uVar33 * lVar2, auVar17._8_8_ = 0,
                auVar17._0_8_ = uVar24, auVar10._8_8_ = 0,
                auVar10._0_8_ = (ulong)((uVar21 + uVar27) - SUB164(auVar9 * auVar17,8)) * lVar2,
                auVar18._8_8_ = 0, auVar18._0_8_ = uVar24, uVar38 <= SUB164(auVar10 * auVar18,8)));
      }
      iVar26 = *(int *)(param_2 + 0x2c);
    }
LAB_0011ec6f:
    if ((float)uVar25 * __LC36 < (float)(iVar26 + 1)) goto LAB_0011ec91;
  }
  local_58 = 0;
  if (*(long *)pSVar28 != 0) {
  ...
  if (local_70 == (void *)0x0) {
    ...
    *(void **)(this + 8) = local_70;
    if (uVar39 == 0) {
      ...
      pvVar3 = *(void **)(this + 0x10);
      if ((pvVar3 < (void *)((long)local_70 + uVar50)) &&
    ...
    if (iVar46 != 0) {
      ...
      if (uVar37 != 0) {
        ...
        do {
          if ((uVar55 == uVar37) &&
             (uVar38 == *(uint *)(*(long *)((long)local_70 + lVar47 * 8) + 0x10))) {
          ...
          uVar56 = SUB164(auVar5 * auVar21,8);
                ...
                (auVar6._8_8_ = 0, auVar6._0_8_ = uVar37 * uVar50, auVar22._8_8_ = 0,
                auVar22._0_8_ = uVar53, auVar7._8_8_ = 0,
                auVar7._0_8_ = ((uVar56 + uVar39) - SUB164(auVar6 * auVar22,8)) * uVar50,
...
LAB_0011f73b:
      ...
      if (uVar39 != 0) {
        ...
        do {
          if ((uVar37 == uVar39) &&
             (*(uint *)(*(long *)((long)local_70 + lVar47 * 8) + 0x10) == uVar38)) {
          ...
          uVar55 = SUB164(auVar17 * auVar33,8);
                ...
                (auVar18._8_8_ = 0, auVar18._0_8_ = uVar39 * uVar50, auVar34._8_8_ = 0,
                auVar34._0_8_ = uVar54, auVar19._8_8_ = 0,
                auVar19._0_8_ =
                     (((&hash_table_size_primes)[uVar40] + uVar55) - SUB164(auVar18 * auVar34,8)) *
                     uVar50, auVar35._8_8_ = 0, auVar35._0_8_ = uVar54,
                uVar56 <= SUB164(auVar19 * auVar35,8)));
      }
    }
  }
LAB_0011f303:
  if ((float)uVar53 * __LC36 < (float)(iVar46 + 1)) {
...
LAB_0011f889:
  pauVar42 = *(undefined1 (**) [16])(*(long *)(this + 8) + (ulong)uVar55 * 8);
  goto LAB_0011f71f;
}
...
undefined8 __thiscall
CowData<Ref<ResourceFormatLoader>>::_realloc(CowData<Ref<ResourceFormatLoader>> *this,long param_1)
...
undefined8 __thiscall
CowData<Ref<ResourceFormatLoader>>::resize<false>
          (CowData<Ref<ResourceFormatLoader>> *this,long param_1)
...

{
  ...
  thread_load_tasks._24_16_ = (undefined1  [16])0x0;
  __cxa_atexit(HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>
               ::~HashMap,thread_load_tasks,&__dso_handle);
  user_load_tokens._40_8_ = uVar1;
  user_load_tokens._8_16_ = (undefined1  [16])0x0;
  user_load_tokens._24_16_ = (undefined1  [16])0x0;
  __cxa_atexit(HashMap<String,ResourceLoader::LoadToken*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::LoadToken*>>>
               ::~HashMap,user_load_tokens,&__dso_handle);
  ...
  translation_remaps._24_16_ = (undefined1  [16])0x0;
  __cxa_atexit(HashMap<String,Vector<String>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Vector<String>>>>
               ::~HashMap,translation_remaps,&__dso_handle);
  ...
  __cxa_atexit(HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>
               ::~HashMap,path_remaps,&__dso_handle);
  return;
}

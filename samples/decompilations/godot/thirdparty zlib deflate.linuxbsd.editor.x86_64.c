...

{
  ...
  do {
    ...
    if ((((pcVar8[(int)uVar6] == cVar13) && (pcVar8[(long)(int)uVar6 + -1] == cVar14)) &&
        (*pcVar8 == *pcVar1)) && (pcVar8[1] == pcVar1[1])) {
      pcVar11 = pcVar1 + 2;
      pcVar8 = pcVar8 + 2;
      while( true ) {
      ...
      pcVar11 = pcVar11 + 2;
LAB_001001e8:
      uVar7 = ((int)pcVar11 - (int)pcVar2) + 0x102;
...
LAB_00100118:
    ...
    param_2 = (uint)uVar3;
    uVar7 = uVar6;
    if ((param_2 <= uVar12) || (uVar9 = uVar9 - 1, uVar9 == 0)) goto LAB_00100227;
  } while( true );
}
...

{
  ...
  while( true ) {
    ...
    if (iVar4 == 0) break;
    iVar16 = read_buf(lVar6,(ulong)*(uint *)((long)param_1 + 0xac) +
    ...
    do {
      *(uint *)((long)param_1 + 0xac) = uVar9;
      if (uVar9 <= iVar3 + uVar15) {
        uVar8 = ((uint)*(byte *)(param_1[0xc] + (ulong)(uVar9 + 2)) ^
                (int)param_1[0x10] << ((byte)(int)param_1[0x12] & 0x1f)) &
                *(uint *)((long)param_1 + 0x8c);
        *(uint *)(param_1 + 0x10) = uVar8;
...
LAB_001013a0:
    ...
    uVar1 = (uint)uVar8;
    if ((uVar1 < (uint)uVar4) &&
       (((uVar1 == 0 && param_2 != 4 || (param_2 == 0)) || (uVar2 + uVar7 != uVar1))))
    goto LAB_001013a0;
    bVar13 = param_2 == 4;
...
LAB_001012e8:
      read_buf(plVar9,plVar9[3],uVar8);
      plVar9 = (long *)*param_1;
...
LAB_001017c3:
  ...
  *param_1 = param_2;
  ...
  while (2 < uVar13) {
    ...
    do {
      uVar16 = ((uint)*(byte *)(lVar6 + (ulong)(uVar12 + 2)) ^ uVar16 << ((byte)uVar2 & 0x1f)) &
               uVar3;
...

{
  ...
  if ((((param_1 == 0) || (*(long *)(param_1 + 0x40) == 0)) || (*(long *)(param_1 + 0x48) == 0)) ||
     (uVar1 = deflateStateCheck_part_0(), (int)uVar1 != 0)) {
    return 0xfffffffe;
  }
...

{
  ...
  if ((((param_1 != 0) && (*(long *)(param_1 + 0x40) != 0)) && (*(long *)(param_1 + 0x48) != 0)) &&
     (iVar3 = deflateStateCheck_part_0(), iVar3 == 0)) {
    lVar1 = *(long *)(param_1 + 0x38);
...
uint deflate(long *param_1,uint param_2)
...
LAB_001022f1:
      if (iVar11 == 0x39) {
        ...
        *(undefined1 *)(plVar5[2] + lVar19) = 8;
        ...
        lVar19 = plVar5[5];
        plVar5[5] = lVar19 + 1;
        *(char *)(plVar5[2] + lVar19) =
             (lVar8 != 0) * '\x10' +
             (((iVar11 != 0) * '\x02' + (lVar16 != 0) * '\x04' + '\x01') - (iVar13 == 0)) +
             (lVar21 != 0) * '\b';
...
LAB_00102b48:
    ...
    if ((int)plVar5[6] != 0) {
      ...
      uVar12 = uVar14;
      if (((int)plVar5[0x19] < 2) && (iVar11 = *(int *)((long)plVar5 + 0xc4), 1 < iVar11)) {
        if (iVar11 < 6) {
          uVar12 = uVar14 | 0x40;
        }
        else {
    ...
    *(undefined4 *)(plVar5 + 1) = 0x71;
    ...
    iVar11 = (int)plVar5[1];
LAB_001020c9:
    if (iVar11 != 0x29a) goto LAB_00101fd2;
    if ((int)param_1[1] != 0) {
LAB_00102dbd:
      param_1[6] = _DAT_00104088;
      return 0xfffffffb;
    }
LAB_001020e5:
    iVar11 = (int)param_1[1];
...
LAB_00102129:
    ...
    if ((int)plVar5[0x19] != 3) {
      iVar11 = (**(code **)(configuration_table + (long)*(int *)((long)plVar5 + 0xc4) * 0x10 + 8))
                         (plVar5);
      goto LAB_0010203f;
    }
LAB_00102ca4:
...
LAB_00102bf0:
        ...
        *(undefined4 *)(plVar5 + 0x14) = 0;
LAB_00102c09:
        if (uVar14 == 0) goto LAB_00102c1f;
        pcVar18 = (char *)(lVar19 + -1 + uVar23);
        cVar10 = *pcVar18;
        if (((cVar10 != pcVar18[1]) || (cVar10 != pcVar18[2])) || (cVar10 != pcVar18[3]))
        goto LAB_00102c1f;
        pcVar18 = pcVar18 + 3;
        ...
        pcVar18 = pcVar18 + 2;
LAB_00102e5c:
        uVar14 = ((int)pcVar18 - (int)pcVar2) + 0x102;
        ...
        *(char *)(plVar5[0x2e0] + (ulong)uVar12) = (char)(uVar14 - 3);
        psVar1 = (short *)((long)plVar5 +
                          (ulong)(byte)(&_length_code)[uVar14 - 3 & 0xff] * 4 + 0x4d8);
        *psVar1 = *psVar1 + 1;
...
LAB_00102080:
  *(undefined4 *)((long)plVar5 + 0x4c) = 0xffffffff;
  return 0;
LAB_001027f1:
  ...
  if (iVar3 == 0) {
    ...
    if ((param_3 < 5) && (param_2 == 0xffffffff || param_2 < 10)) {
      ...
      if (((*(uint *)(lVar2 + 200) != param_3) ||
          (*(long *)(configuration_table + (long)iVar5 * 0x10 + 8) !=
           *(long *)(configuration_table + (long)iVar3 * 0x10 + 8))) &&
         (*(int *)(lVar2 + 0x4c) != -2)) {
  ...
  if (param_1 != 0) {
    *(undefined8 *)(param_1 + 0x30) = 0;
    ...
    if ((((param_5 - 1U < 9) && (param_4 - 8U < 8)) &&
        ((param_3 == 8 && ((param_2 < 10 && (param_6 < 5)))))) && ((param_4 != 8 || (iVar2 == 1))))
    {
      if (param_4 == 8) {
        param_4 = 9;
      }

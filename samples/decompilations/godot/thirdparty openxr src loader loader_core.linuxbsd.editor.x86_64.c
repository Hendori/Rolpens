...
undefined8 LoaderXrTermGetInstanceProcAddr(XrInstance_T *param_1,char *param_2,_func_void *param_3)
...
void LoaderTrampolineSubmitDebugUtilsMessageEXT
               (XrInstance_T *param_1,ulong param_2,ulong param_3,
               XrDebugUtilsMessengerCallbackDataEXT *param_4)
...
void LoaderTrampolineSetDebugUtilsObjectNameEXT
               (XrInstance_T *param_1,XrDebugUtilsObjectNameInfoEXT *param_2)
...
void LoaderLogger::LogValidationErrorMessage
               (string *param_1,string *param_2,string *param_3,vector *param_4)
...
/* WARNING: Removing unreachable block (ram,0x00100660) */
/* WARNING: Removing unreachable block (ram,0x0010066d) */
/* WARNING: Removing unreachable block (ram,0x0010067a) */
/* WARNING: Removing unreachable block (ram,0x00100683) */
/* WARNING: Removing unreachable block (ram,0x001007d8) */
/* WARNING: Removing unreachable block (ram,0x001007e5) */
/* WARNING: Removing unreachable block (ram,0x001007f2) */
/* WARNING: Removing unreachable block (ram,0x001007fb) */
/* WARNING: Removing unreachable block (ram,0x0010068d) */
/* WARNING: Removing unreachable block (ram,0x00100805) */
  ...
  *(string **)this = __dest;
  if (param_1 == (char *)0x0) {
    ...
    if ((LoaderLogger::GetInstance()::instance == '\0') &&
       (iVar2 = __cxa_guard_acquire(&LoaderLogger::GetInstance()::instance), iVar2 != 0)) {
    ...
    LoaderLogger::LogMessage
              (0x10ad20,1,(string *)0x1,(string *)aplStack_a0,(string *)aplStack_e0,
               (vector *)aplStack_c0);
...
/* WARNING: Removing unreachable block (ram,0x0010068d) */
/* WARNING: Removing unreachable block (ram,0x00100805) */
/* LoaderXrTermSubmitDebugUtilsMessageEXT(XrInstance_T*, unsigned long, unsigned long,
   XrDebugUtilsMessengerCallbackDataEXT const*) */
...

{
  ...
  LoaderLogger::LogMessage
            (0x10ad20,1,(string *)0x1,(string *)local_68,(string *)local_a8,(vector *)local_88);
  ...
  if (*(code **)(lVar3 + 0x1d8) == (code *)0x0) {
    ...
    LoaderLogger::LogDebugUtilsMessage
              (0x10ad20,param_2,(XrDebugUtilsMessengerCallbackDataEXT *)param_3);
  }
  else {
...
/* WARNING: Removing unreachable block (ram,0x00100ae5) */
/* WARNING: Removing unreachable block (ram,0x00100af2) */
/* WARNING: Removing unreachable block (ram,0x00100afb) */
/* WARNING: Removing unreachable block (ram,0x00100c58) */
/* WARNING: Removing unreachable block (ram,0x00100c65) */
/* WARNING: Removing unreachable block (ram,0x00100c72) */
/* WARNING: Removing unreachable block (ram,0x00100c7b) */
/* WARNING: Removing unreachable block (ram,0x00100b05) */
/* WARNING: Removing unreachable block (ram,0x00100c85) */
/* LoaderXrTermDestroyInstance(XrInstance_T*) */

undefined4 LoaderXrTermDestroyInstance(XrInstance_T *param_1)

{
  ...
  LoaderLogger::RemoveLogRecordersForXrInstance
            ((XrInstance_T *)LoaderLogger::GetInstance()::instance);
  if ((RuntimeInterface::GetInstance()::instance == '\0') &&
     (iVar2 = __cxa_guard_acquire(&RuntimeInterface::GetInstance()::instance), iVar2 != 0)) {
    __cxa_atexit(std::unique_ptr<RuntimeInterface,std::default_delete<RuntimeInterface>>::
                 ~unique_ptr,&RuntimeInterface::GetInstance()::instance,&__dso_handle);
...
/* WARNING: Removing unreachable block (ram,0x0010110a) */
/* WARNING: Removing unreachable block (ram,0x00101110) */
/* WARNING: Removing unreachable block (ram,0x0010111d) */
/* WARNING: Removing unreachable block (ram,0x0010112a) */
/* WARNING: Removing unreachable block (ram,0x00101133) */
/* WARNING: Removing unreachable block (ram,0x00100f68) */
/* WARNING: Removing unreachable block (ram,0x00100f70) */
/* WARNING: Removing unreachable block (ram,0x00100f7d) */
/* WARNING: Removing unreachable block (ram,0x00100f8a) */
/* WARNING: Removing unreachable block (ram,0x00100f93) */
/* WARNING: Removing unreachable block (ram,0x00100f9d) */
/* WARNING: Removing unreachable block (ram,0x0010113d) */
/* LoaderXrTermDestroyDebugUtilsMessengerEXT(XrDebugUtilsMessengerEXT_T*) */

undefined4 LoaderXrTermDestroyDebugUtilsMessengerEXT(XrDebugUtilsMessengerEXT_T *param_1)

{
  ...
  std::__cxx11::string::_M_construct<char_const*>
            ((string *)local_a8,"xrDestroyDebugUtilsMessengerEXT");
  if ((LoaderLogger::GetInstance()::instance == '\0') &&
     (iVar2 = __cxa_guard_acquire(&LoaderLogger::GetInstance()::instance), iVar2 != 0)) {
    LoaderLogger::LoaderLogger((LoaderLogger *)LoaderLogger::GetInstance()::instance);
    __cxa_atexit(LoaderLogger::~LoaderLogger,LoaderLogger::GetInstance()::instance,&__dso_handle);
...
undefined4
LoaderXrTermSetDebugUtilsObjectNameEXT(XrInstance_T *param_1,XrDebugUtilsObjectNameInfoEXT *param_2)

{
  ...
  if (local_60 < 0x10) {
    ...
    plVar5 = local_68;
LAB_001017bc:
    memcpy(plVar5,__s,local_60);
    local_60 = local_c8._0_8_;
    plVar5 = local_68;
  }
  *(undefined1 *)((long)plVar5 + local_60) = 0;
  LoaderLogger::AddObjectName
            (LoaderLogger::GetInstance()::instance,*(undefined8 *)(param_2 + 0x18),
             *(undefined4 *)(param_2 + 0x10),(string *)&local_68);
  if (local_68 != local_58) {
    operator_delete(local_68,local_58[0] + 1);
  }
  local_b8 = 0;
...
int LoaderXrEnumerateApiLayerProperties(uint param_1,uint *param_2,XrApiLayerProperties *param_3)

{
  ...
  local_a8 = local_98;
  std::__cxx11::string::_M_construct<char_const*>
            ((string *)&local_a8,"xrEnumerateApiLayerProperties");
  if ((LoaderLogger::GetInstance()::instance == '\0') &&
  ...
  local_68[0] = local_58;
  std::__cxx11::string::_M_construct<char_const*>
            ((string *)local_68,"xrEnumerateApiLayerProperties");
  ...
  if (iVar4 < 0) {
    ...
    *(undefined1 *)((long)local_a8 + local_d0) = 0;
    ...
    std::__cxx11::string::_M_construct<char_const*>((string *)local_68,"OpenXR-Loader");
    LoaderLogger::LogMessage
              (0x10ad20,0x1000,(string *)0x1,(string *)local_68,(string *)&local_a8,
               (vector *)&local_88);
    if (local_68[0] != local_58) {
      operator_delete(local_68[0],local_58[0] + 1);
    }
...
undefined8 LoaderTrampolineSessionEndDebugUtilsLabelRegionEXT(XrSession_T *param_1)

{
  ...
  if (param_1 == (XrSession_T *)0x0) {
    ...
    *(undefined1 *)((long)local_a8 + local_d0) = 0;
    ...
    for (pLVar5 = (LoaderInstance *)local_c8._0_8_; (LoaderInstance *)uVar4 != pLVar5;
        pLVar5 = pLVar5 + 0x30) {
    ...
    uVar4 = ActiveLoaderInstance::Get
                      ((LoaderInstance **)local_c8,"xrSessionEndDebugUtilsLabelRegionEXT");
    if (-1 < (int)uVar4) {
      if ((LoaderLogger::GetInstance()::instance == '\0') &&
         (iVar3 = __cxa_guard_acquire(&LoaderLogger::GetInstance()::instance), iVar3 != 0)) {
        LoaderLogger::LoaderLogger((LoaderLogger *)LoaderLogger::GetInstance()::instance);
...
int LoaderTrampolineDestroyDebugUtilsMessengerEXT(XrDebugUtilsMessengerEXT_T *param_1)

{
  ...
  if (param_1 == (XrDebugUtilsMessengerEXT_T *)0x0) {
    ...
    local_88 = local_78;
    local_88 = (LoaderInstance **)
               std::__cxx11::string::_M_create((ulong *)&local_88,(ulong)&local_d0);
    ...
    *(LoaderInstance *)((long)local_88 + (long)local_d0) = (LoaderInstance)0x0;
    ...
    local_a8 = local_98;
    local_a8 = (LoaderInstance **)
               std::__cxx11::string::_M_create((ulong *)&local_a8,(ulong)&local_d0);
    ...
    *(LoaderInstance *)((long)local_a8 + (long)local_d0) = (LoaderInstance)0x0;
    ...
    if (-1 < iVar3) {
      ...
      local_88 = local_78;
      std::__cxx11::string::_M_construct<char_const*>
                ((vector *)&local_88,"Completed loader trampoline");
      local_a8 = local_98;
      std::__cxx11::string::_M_construct<char_const*>
                ((string *)&local_a8,"xrDestroyDebugUtilsMessengerEXT");
      if ((LoaderLogger::GetInstance()::instance == '\0') &&
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* LoaderTrampolineCreateDebugUtilsMessengerEXT(XrInstance_T*, XrDebugUtilsMessengerCreateInfoEXT
   const*, XrDebugUtilsMessengerEXT_T**) */

int LoaderTrampolineCreateDebugUtilsMessengerEXT
              (XrInstance_T *param_1,XrDebugUtilsMessengerCreateInfoEXT *param_2,
              XrDebugUtilsMessengerEXT_T **param_3)

{
  ...
  local_a8 = local_98;
  std::__cxx11::string::_M_construct<char_const*>
            ((string *)&local_a8,"xrCreateDebugUtilsMessengerEXT");
  if ((LoaderLogger::GetInstance()::instance == '\0') &&
     (iVar4 = __cxa_guard_acquire(&LoaderLogger::GetInstance()::instance), iVar4 != 0)) {
    LoaderLogger::LoaderLogger((LoaderLogger *)LoaderLogger::GetInstance()::instance);
    __cxa_atexit(LoaderLogger::~LoaderLogger,LoaderLogger::GetInstance()::instance,&__dso_handle);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */
/* LoaderXrTermCreateDebugUtilsMessengerEXT(XrInstance_T*, XrDebugUtilsMessengerCreateInfoEXT
   const*, XrDebugUtilsMessengerEXT_T**) */

int LoaderXrTermCreateDebugUtilsMessengerEXT
              (XrInstance_T *param_1,XrDebugUtilsMessengerCreateInfoEXT *param_2,
              XrDebugUtilsMessengerEXT_T **param_3)

{
  ...
  if (param_3 == (XrDebugUtilsMessengerEXT_T **)0x0) {
    ...
    *(undefined1 *)((long)local_a8 + local_d0) = 0;
    ...
    LoaderLogger::LogMessage
              (0x10ad20,0x1000,(string *)0x2,(string *)&local_a8,(string *)&local_88,
               (vector *)&local_68);
    if (local_a8 != local_98) {
      operator_delete(local_a8,local_98[0] + 1);
    }
...
joined_r0x00103229:
    ...
    MakeDebugUtilsLoaderLogRecorder
              ((XrDebugUtilsMessengerCreateInfoEXT *)local_c8,(XrDebugUtilsMessengerEXT_T *)param_2)
    ;
    LoaderLogger::AddLogRecorderForXrInstance
              ((XrInstance_T *)LoaderLogger::GetInstance()::instance,(unique_ptr *)param_1);
    if ((long *)local_c8._0_8_ != (long *)0x0) {
      (**(code **)(*(long *)local_c8._0_8_ + 8))();
    }
    if ((RuntimeInterface::GetInstance()::instance == '\0') &&
       (iVar3 = __cxa_guard_acquire(&RuntimeInterface::GetInstance()::instance), iVar3 != 0)) {
      __cxa_atexit(std::unique_ptr<RuntimeInterface,std::default_delete<RuntimeInterface>>::
                   ~unique_ptr,&RuntimeInterface::GetInstance()::instance,&__dso_handle);
      __cxa_guard_release(&RuntimeInterface::GetInstance()::instance);
    }
    RuntimeInterface::TrackDebugMessenger
              (RuntimeInterface::GetInstance()::instance,(XrDebugUtilsMessengerEXT_T *)param_1);
  }
  else {
...
int LoaderXrDestroyInstance(XrInstance_T *param_1)
    ...
    *(undefined1 *)((long)local_a8 + local_d0) = 0;
    ...
    if (-1 < local_ec) {
      if (*(XrDebugUtilsMessengerEXT_T **)(local_d8 + 0x50) != (XrDebugUtilsMessengerEXT_T *)0x0) {
        LoaderTrampolineDestroyDebugUtilsMessengerEXT
                  (*(XrDebugUtilsMessengerEXT_T **)(local_d8 + 0x50));
      }
...
undefined8
LoaderTrampolineSessionInsertDebugUtilsLabelEXT(XrSession_T *param_1,XrDebugUtilsLabelEXT *param_2)

{
  ...
  if (param_1 == (XrSession_T *)0x0) {
    ...
    *(undefined1 *)((long)local_b8 + local_100) = 0;
    ...
    LoaderLogger::LogMessage
              (0x10ad20,0x1000,(string *)0x1,(string *)&local_78,(string *)&local_b8,
               (vector *)&local_98);
  ...
  if (param_2 != (XrDebugUtilsLabelEXT *)0x0) {
    ...
    LoaderLogger::InsertLabel
              ((XrSession_T *)LoaderLogger::GetInstance()::instance,(XrDebugUtilsLabelEXT *)param_1)
    ;
    uVar6 = 0;
...
LAB_0010441d:
  ...
  *(undefined1 *)((long)local_d8 + local_100) = 0;
  ...
  LoaderLogger::LogMessage
            (0x10ad20,0x1000,(string *)0x2,(string *)&local_d8,(string *)&local_b8,
             (vector *)&local_98);
...
undefined8
LoaderTrampolineSessionBeginDebugUtilsLabelRegionEXT
          (XrSession_T *param_1,XrDebugUtilsLabelEXT *param_2)

{
  ...
  if (param_1 == (XrSession_T *)0x0) {
    ...
    *(undefined1 *)((long)local_b8 + local_100) = 0;
    ...
    for (pLVar7 = (LoaderInstance *)local_f8._0_8_; (LoaderInstance *)uVar5 != pLVar7;
        pLVar7 = pLVar7 + 0x30) {
  ...
  if (param_2 != (XrDebugUtilsLabelEXT *)0x0) {
    uVar5 = ActiveLoaderInstance::Get
                      ((LoaderInstance **)local_f8,"xrSessionBeginDebugUtilsLabelRegionEXT");
    if (-1 < (int)uVar5) {
      if ((LoaderLogger::GetInstance()::instance == '\0') &&
         (iVar4 = __cxa_guard_acquire(&LoaderLogger::GetInstance()::instance), iVar4 != 0)) {
        LoaderLogger::LoaderLogger((LoaderLogger *)LoaderLogger::GetInstance()::instance);
      ...
      LoaderLogger::BeginLabelRegion
                ((XrSession_T *)LoaderLogger::GetInstance()::instance,
                 (XrDebugUtilsLabelEXT *)param_1);
      uVar5 = 0;
  ...
  *(undefined4 *)(pLVar6 + 8) = local_70;
  ...
  if (local_60 < 0x10) {
    ...
    __dest = (LoaderInstance *)
             std::__cxx11::string::_M_create((ulong *)(pLVar6 + 0x10),(ulong)&local_100);
    *(LoaderInstance **)(pLVar6 + 0x10) = __dest;
...
int LoaderXrCreateInstance(XrInstanceCreateInfo *param_1,XrInstance_T **param_2)

{
  ...
  local_1d8 = local_1c8;
  local_1d8 = (XrDebugUtilsMessengerEXT_T **)
              std::__cxx11::string::_M_create((ulong *)&local_1d8,(ulong)local_258);
  ...
  *(XrDebugUtilsMessengerEXT_T *)((long)local_1d8 + local_258._0_8_) =
       (XrDebugUtilsMessengerEXT_T)0x0;
  local_258._0_8_ = 0x10;
  local_1f8 = local_1e8;
  local_1f8 = (XrDebugUtilsMessengerEXT_T **)
              std::__cxx11::string::_M_create((ulong *)&local_1f8,(ulong)local_258);
  ...
  *(XrDebugUtilsMessengerEXT_T *)((long)local_1f8 + local_258._0_8_) =
       (XrDebugUtilsMessengerEXT_T)0x0;
  if ((LoaderLogger::GetInstance()::instance == '\0') &&
     (iVar8 = __cxa_guard_acquire(&LoaderLogger::GetInstance()::instance), iVar8 != 0)) {
    LoaderLogger::LoaderLogger((LoaderLogger *)LoaderLogger::GetInstance()::instance);
    __cxa_atexit(LoaderLogger::~LoaderLogger,LoaderLogger::GetInstance()::instance,&__dso_handle);
    __cxa_guard_release(&LoaderLogger::GetInstance()::instance);
  }
  ...
  LoaderLogger::LogMessage
            (0x10ad20,1,(string *)0x1,(string *)local_1b8,(string *)&local_1f8,(vector *)&local_1d8)
  ;
  ...
  if ((undefined1  [8])pXStack_230 != local_238) {
    do {
      if (*(XrDebugUtilsMessengerEXT_T **)((long)auVar15 + 0x10) !=
          (XrDebugUtilsMessengerEXT_T *)((long)auVar15 + 0x20)) {
        operator_delete(*(XrDebugUtilsMessengerEXT_T **)((long)auVar15 + 0x10),
                        *(long *)((long)auVar15 + 0x20) + 1);
      }
  ...
  if (param_1 == (XrInstanceCreateInfo *)0x0) {
    ...
    local_1b8[0] = (XrDebugUtilsMessengerEXT_T *)local_1a8;
    local_1b8[0] = (XrDebugUtilsMessengerEXT_T *)
                   std::__cxx11::string::_M_create((ulong *)local_1b8,(ulong)local_258);
    uVar5 = _UNK_0010afb8;
    ...
    *(XrDebugUtilsMessengerEXT_T *)((long)local_1f8 + local_258._0_8_) =
    ...
    LoaderLogger::LogMessage
              (0x10ad20,0x1000,(string *)0x2,(string *)&local_1f8,(string *)&local_1d8,
               (vector *)local_1b8);
    if (local_1f8 != local_1e8) {
      operator_delete(local_1f8,(ulong)(local_1e8[0] + 1));
    }
    ...
    pXVar3 = pXStack_230;
    for (auVar15 = local_238; (undefined1  [8])pXVar3 != auVar15;
        auVar15 = (undefined1  [8])((long)auVar15 + 0x30)) {
      if (*(XrDebugUtilsMessengerEXT_T **)((long)auVar15 + 0x10) !=
          (XrDebugUtilsMessengerEXT_T *)((long)auVar15 + 0x20)) {
        operator_delete(*(XrDebugUtilsMessengerEXT_T **)((long)auVar15 + 0x10),
...
LAB_00106832:
  ...
  if ((1 < uVar13) || ((1 < (ushort)(*(ulong *)(param_1 + 0x120) >> 0x20) && ((uVar13 & 1) != 0))))
  {
    ...
    *(undefined8 *)psVar12 = _vtable;
    ...
    std::__ostream_insert<char,std::char_traits<char>>
              ((ostream *)local_1b8,"xrCreateInstance called with invalid API version ",0x31);
    ...
    *(XrDebugUtilsMessengerEXT_T *)((long)local_1f8 + local_258._0_8_) =
    ...
    LoaderLogger::LogMessage
              (0x10ad20,0x1000,(string *)0x1,(string *)&local_1d8,(string *)&local_1f8,
               (vector *)&local_218);
    if (local_1d8 != local_1c8) {
      operator_delete(local_1d8,(ulong)(local_1c8[0] + 1));
    }
  ...
  if (cVar7 == '\0') {
    ...
    local_1b8[0] = (XrDebugUtilsMessengerEXT_T *)local_1a8;
    local_1b8[0] = (XrDebugUtilsMessengerEXT_T *)
                   std::__cxx11::string::_M_create((ulong *)local_1b8,(ulong)local_238);
    pXVar3 = _UNK_0010b078;
    ...
    *(XrDebugUtilsMessengerEXT_T **)(local_1b8[0] + 8) = pXVar3;
    ...
    if (iVar8 < 0) {
      ...
      local_1d8 = local_1c8;
      local_1d8 = (XrDebugUtilsMessengerEXT_T **)
                  std::__cxx11::string::_M_create((ulong *)&local_1d8,(ulong)&local_260);
      ...
      *(undefined2 *)(local_1d8 + 4) = 0x6e6f;
      ...
      local_1d8[3] = pXVar6;
      local_1d0 = local_260;
      *(XrDebugUtilsMessengerEXT_T *)((long)local_1d8 + (long)local_260) =
           (XrDebugUtilsMessengerEXT_T)0x0;
      local_260 = (XrDebugUtilsMessengerEXT_T *)&DAT_00000010;
      local_1f8 = local_1e8;
      local_1f8 = (XrDebugUtilsMessengerEXT_T **)
                  std::__cxx11::string::_M_create((ulong *)&local_1f8,(ulong)&local_260);
      pXVar3 = _UNK_0010b078;
      local_1e8[0] = local_260;
      *local_1f8 = __LC62;
      local_1f8[1] = pXVar3;
      local_1f0 = local_260;
      *(XrDebugUtilsMessengerEXT_T *)((long)local_1f8 + (long)local_260) =
           (XrDebugUtilsMessengerEXT_T)0x0;
      if ((LoaderLogger::GetInstance()::instance == '\0') &&
         (iVar9 = __cxa_guard_acquire(&LoaderLogger::GetInstance()::instance), iVar9 != 0)) {
        LoaderLogger::LoaderLogger((LoaderLogger *)LoaderLogger::GetInstance()::instance);
        __cxa_atexit(LoaderLogger::~LoaderLogger,LoaderLogger::GetInstance()::instance,&__dso_handle
                    );
        __cxa_guard_release(&LoaderLogger::GetInstance()::instance);
      ...
      std::__cxx11::string::_M_construct<char_const*>((string *)local_1b8,"OpenXR-Loader");
      LoaderLogger::LogMessage
                (0x10ad20,0x1000,(string *)0x1,(string *)local_1b8,(string *)&local_1f8,
                 (vector *)&local_1d8);
      if (local_1b8[0] != (XrDebugUtilsMessengerEXT_T *)local_1a8) {
        operator_delete(local_1b8[0],local_1a8._0_8_ + 1);
      }
      ...
      for (; pXVar6 = pXStack_230, bVar4 = (undefined1  [8])pXStack_230 != auVar15,
          pXStack_230 = pXVar3, bVar4; auVar15 = (undefined1  [8])((long)auVar15 + 0x30)) {
        if (*(XrDebugUtilsMessengerEXT_T **)((long)auVar15 + 0x10) !=
            (XrDebugUtilsMessengerEXT_T *)((long)auVar15 + 0x20)) {
          operator_delete(*(XrDebugUtilsMessengerEXT_T **)((long)auVar15 + 0x10),
                          *(long *)((long)auVar15 + 0x20) + 1);
...
LAB_00105366:
      ...
      *(XrDebugUtilsMessengerEXT_T **)(local_1b8[0] + 8) = pXVar3;
      ...
      local_1d8 = local_1c8;
      local_1d8 = (XrDebugUtilsMessengerEXT_T **)
                  std::__cxx11::string::_M_create((ulong *)&local_1d8,(ulong)local_288);
      pXVar3 = _UNK_0010b078;
      local_1c8[0] = local_260;
      *local_1d8 = __LC62;
      local_1d8[1] = pXVar3;
...
LAB_001055c3:
      ...
      *(XrDebugUtilsMessengerEXT_T **)(local_1b8[0] + 8) = pXVar3;
      local_1b8[1] = (XrDebugUtilsMessengerEXT_T *)local_238;
      local_1b8[0][(long)local_238] = (XrDebugUtilsMessengerEXT_T)0x0;
      iVar8 = ApiLayerInterface::LoadApiLayers
                        ((string *)local_1b8,uVar1,ppcVar2,(vector *)local_258);
      if (local_1b8[0] != (XrDebugUtilsMessengerEXT_T *)local_1a8) {
        operator_delete(local_1b8[0],local_1a8._0_8_ + 1);
      }
      if (iVar8 < 0) {
      ...
      local_258 = (undefined1  [16])0x0;
      iVar8 = LoaderInstance::CreateInstance
                        (0x100000,LoaderXrTermCreateInstance,LoaderXrTermCreateApiLayerInstance,
                         local_238,param_1,&local_260);
      pXVar3 = pXStack_230;
      for (auVar15 = local_238; (undefined1  [8])pXVar3 != auVar15;
...
LAB_0010593d:
        if (*(int *)pXVar14 != 0x3b9b143a) goto LAB_00105930;
        _local_238 = (undefined1  [16])0x0;
        local_228 = 0;
        ...
        *(XrDebugUtilsMessengerEXT_T *)((long)local_1f8 + (long)local_260) =
        ...
        local_1b8[0] = (XrDebugUtilsMessengerEXT_T *)local_1a8;
        LoaderLogger::LogMessage
                  (0x10ad20,0x10,(string *)0x1,(string *)local_1b8,(string *)&local_1f8,
                   (vector *)&local_1d8);
        if (local_1b8[0] != (XrDebugUtilsMessengerEXT_T *)local_1a8) {
          operator_delete(local_1b8[0],local_1a8._0_8_ + 1);
        }
        ...
        iVar8 = LoaderTrampolineCreateDebugUtilsMessengerEXT
                          (*(XrInstance_T **)(pXVar3 + 8),pXVar14,
                           (XrDebugUtilsMessengerEXT_T **)local_238);
        if (-1 < iVar8) {
...
LAB_00105be5:
      ...
      *(XrDebugUtilsMessengerEXT_T *)((long)local_1f8 + (long)local_260) =
      ...
      std::__cxx11::string::_M_construct<char_const*>((string *)local_1b8,"OpenXR-Loader");
      LoaderLogger::LogMessage
                (0x10ad20,1,(string *)0x1,(string *)local_1b8,(string *)&local_1f8,
                 (vector *)&local_1d8);
      if (local_1b8[0] != (XrDebugUtilsMessengerEXT_T *)local_1a8) {
        operator_delete(local_1b8[0],local_1a8._0_8_ + 1);
      }
...
LAB_00105635:
  ...
  __stack_chk_fail();
LAB_00105930:
  pXVar14 = *(XrDebugUtilsMessengerCreateInfoEXT **)(pXVar14 + 8);
...
undefined4 LoaderXrTermCreateInstance(XrInstanceCreateInfo *param_1,XrInstance_T **param_2)
...
LAB_00106ed8:
  ...
  return uVar3;
LAB_00106d55:
  if (*paVar6 != (allocator)0x0) goto LAB_00106d48;
  ...
  if ((*(int *)(param_1 + 0x138) != 0) && (*(long *)(param_1 + 0x140) == 0)) {
    ...
    std::__cxx11::string::string<std::allocator<char>>
              ((string *)&local_68,"enabledExtensionCount is non-0 but array is NULL",
               (allocator *)(param_1 + 0x11c));
    std::__cxx11::string::string<std::allocator<char>>
              ((string *)&local_88,"xrCreateInstance",extraout_RDX);
    std::__cxx11::string::string<std::allocator<char>>
              ((string *)&local_a8,"VUID-XrInstanceCreateInfo-enabledExtensionNames-parameter",
               extraout_RDX_00);
    LoaderLogger::LogValidationErrorMessage
              ((string *)&local_a8,(string *)&local_88,(string *)&local_68,(vector *)local_c8);
  ...
  if ((RuntimeInterface::GetInstance()::instance == '\0') &&
     (iVar4 = __cxa_guard_acquire(&RuntimeInterface::GetInstance()::instance), iVar4 != 0)) {
    __cxa_atexit(std::unique_ptr<RuntimeInterface,std::default_delete<RuntimeInterface>>::
                 ~unique_ptr,&RuntimeInterface::GetInstance()::instance,&__dso_handle);
    __cxa_guard_release(&RuntimeInterface::GetInstance()::instance);
  }
  uVar3 = RuntimeInterface::CreateInstance
                    (RuntimeInterface::GetInstance()::instance,(XrInstance_T **)param_1);
  local_c8 = (undefined1  [16])0x0;
  local_b8 = 0;
  local_88 = local_78;
...
void LoaderXrTermCreateApiLayerInstance
               (XrInstanceCreateInfo *param_1,XrApiLayerCreateInfo *param_2,XrInstance_T **param_3)
...

{
  ...
  if (param_3 == (_func_void *)0x0) {
    ...
    *(string *)((long)local_a8 + (long)local_d0) = (string)0x0;
    if ((LoaderLogger::GetInstance()::instance == '\0') &&
       (iVar6 = __cxa_guard_acquire(&LoaderLogger::GetInstance()::instance), iVar6 != 0)) {
      LoaderLogger::LoaderLogger((LoaderLogger *)LoaderLogger::GetInstance()::instance);
      __cxa_atexit(LoaderLogger::~LoaderLogger,LoaderLogger::GetInstance()::instance,&__dso_handle);
      __cxa_guard_release(&LoaderLogger::GetInstance()::instance);
    }
    ...
    if (param_2 != (char *)0x0) {
      *(undefined8 *)param_3 = 0;
      ...
      if (param_1 == (XrInstance_T *)0x0) {
        ...
        if (((iVar6 == 0) || (iVar6 = strcmp(param_2,"xrEnumerateApiLayerProperties"), iVar6 == 0))
           || (iVar6 = strcmp(param_2,"xrEnumerateInstanceExtensionProperties"), iVar6 == 0))
        goto LAB_00108177;
        iVar6 = strcmp(param_2,"xrInitializeLoaderKHR");
        if (iVar6 != 0) {
          std::__cxx11::string::string<std::allocator<char>>
                    ((string *)&local_a8,"XR_NULL_HANDLE for instance but query for ",extraout_RDX);
          std::__cxx11::string::append((string *)&local_a8,param_2);
          std::__cxx11::string::append((string *)&local_a8," requires a valid instance");
          local_b8 = 0;
          local_c8 = (undefined1  [16])0x0;
          std::__cxx11::string::string<std::allocator<char>>
                    ((string *)&local_68,"xrGetInstanceProcAddr",extraout_RDX_00);
          std::__cxx11::string::string<std::allocator<char>>
                    ((string *)&local_88,"VUID-xrGetInstanceProcAddr-instance-parameter",
                     extraout_RDX_01);
          LoaderLogger::LogValidationErrorMessage
                    ((string *)&local_88,(string *)&local_68,(string *)&local_a8,(vector *)local_c8)
          ;
          std::__cxx11::string::_M_dispose();
          std::__cxx11::string::_M_dispose();
          std::vector<XrSdkLogObjectInfo,std::allocator<XrSdkLogObjectInfo>>::~vector
...
int LoaderXrEnumerateInstanceExtensionProperties
              (char *param_1,uint param_2,uint *param_3,XrExtensionProperties *param_4)

{
  ...
  *(undefined1 *)((long)local_68 + local_c8._0_8_) = 0;
  local_104 = ApiLayerInterface::GetInstanceExtensionProperties
                        ((string *)&local_68,param_1,(vector *)local_e8);
  if (local_68 != local_58) {
    operator_delete(local_68,local_58[0] + 1);
  }
...
LAB_00109c2b:
    ...
    *(undefined1 *)((long)local_68 + local_c8._0_8_) = 0;
    ...
    if ((RuntimeInterface::GetInstance()::instance == '\0') &&
       (iVar5 = __cxa_guard_acquire(&RuntimeInterface::GetInstance()::instance), iVar5 != 0)) {
      __cxa_atexit(std::unique_ptr<RuntimeInterface,std::default_delete<RuntimeInterface>>::
                   ~unique_ptr,&RuntimeInterface::GetInstance()::instance,&__dso_handle);
      __cxa_guard_release(&RuntimeInterface::GetInstance()::instance);
    }
    ...
    pthread_mutex_unlock((pthread_mutex_t *)GetGlobalLoaderMutex()::loader_mutex);
LAB_00109523:
    puVar8 = (undefined8 *)LoaderInstance::LoaderSpecificExtensions();
    puVar10 = (undefined8 *)local_e8._0_8_;
    uVar1 = local_e8._8_8_;
    for (puVar9 = (undefined8 *)local_e8._0_8_; (undefined8 *)uVar1 != puVar9;
        puVar9 = puVar9 + 0x13) {
    ...
    if (local_d8 == (undefined8 *)uVar1) {
      ...
      _M_realloc_insert<XrExtensionProperties_const&>
                ((vector<XrExtensionProperties,std::allocator<XrExtensionProperties>> *)local_e8,
                 uVar1,puVar8);
      goto LAB_00108ea2;
    }
    uVar2 = puVar8[1];
    ...
    *(undefined8 *)(uVar1 + 8) = uVar2;
    uVar2 = puVar8[3];
    *(undefined8 *)(uVar1 + 0x10) = puVar8[2];
    *(undefined8 *)(uVar1 + 0x18) = uVar2;
    uVar2 = puVar8[5];
    *(undefined8 *)(uVar1 + 0x20) = puVar8[4];
    *(undefined8 *)(uVar1 + 0x28) = uVar2;
    uVar2 = puVar8[7];
    *(undefined8 *)(uVar1 + 0x30) = puVar8[6];
    *(undefined8 *)(uVar1 + 0x38) = uVar2;
    uVar2 = puVar8[9];
    *(undefined8 *)(uVar1 + 0x40) = puVar8[8];
    *(undefined8 *)(uVar1 + 0x48) = uVar2;
    uVar2 = puVar8[0xb];
    *(undefined8 *)(uVar1 + 0x50) = puVar8[10];
    *(undefined8 *)(uVar1 + 0x58) = uVar2;
    uVar2 = puVar8[0xd];
    *(undefined8 *)(uVar1 + 0x60) = puVar8[0xc];
    *(undefined8 *)(uVar1 + 0x68) = uVar2;
    uVar2 = puVar8[0xf];
    *(undefined8 *)(uVar1 + 0x70) = puVar8[0xe];
    *(undefined8 *)(uVar1 + 0x78) = uVar2;
    uVar2 = puVar8[0x11];
    *(undefined8 *)(uVar1 + 0x80) = puVar8[0x10];
    *(undefined8 *)(uVar1 + 0x88) = uVar2;
    *(undefined8 *)(uVar1 + 0x90) = puVar8[0x12];
    local_e8._8_8_ = puVar7;
LAB_00108eac:
    uVar6 = (int)((long)puVar7 - (long)puVar10 >> 3) * 0x286bca1b;
    if (param_2 == 0) {
LAB_001091da:
      local_120 = &local_f0;
      local_c8 = (undefined1  [16])0x0;
      ...
      *(undefined1 *)((long)local_a8 + local_f0) = 0;
      ...
      std::__cxx11::string::_M_construct<char_const*>((string *)&local_68,"OpenXR-Loader");
      LoaderLogger::LogMessage
                (0x10ad20,1,(string *)0x1,(string *)&local_68,(string *)&local_a8,
                 (vector *)&local_88);
      if (local_68 != local_58) {
        operator_delete(local_68,local_58[0] + 1);
      }
      ...
      while (uVar11 < (ulong)(((long)puVar7 - (long)puVar10 >> 3) * -0x79435e50d79435e5)) {
        if (*(int *)(param_4 + lVar13) == 2) {
          ...
          *(undefined8 *)(param_4 + lVar13 + 8) = uVar1;
          ...
          uVar1 = puVar9[1];
          *(undefined8 *)(param_4 + lVar13 + 0x10) = *puVar9;
          *(undefined8 *)(param_4 + lVar13 + 0x10 + 8) = uVar1;
          puVar9 = (undefined8 *)((long)puVar10 + lVar13 + 0x20);
          uVar1 = puVar9[1];
          *(undefined8 *)(param_4 + lVar13 + 0x20) = *puVar9;
          *(undefined8 *)(param_4 + lVar13 + 0x20 + 8) = uVar1;
          puVar9 = (undefined8 *)((long)puVar10 + lVar13 + 0x30);
          uVar1 = puVar9[1];
          *(undefined8 *)(param_4 + lVar13 + 0x30) = *puVar9;
          *(undefined8 *)(param_4 + lVar13 + 0x30 + 8) = uVar1;
          puVar9 = (undefined8 *)((long)puVar10 + lVar13 + 0x40);
          uVar1 = puVar9[1];
          *(undefined8 *)(param_4 + lVar13 + 0x40) = *puVar9;
          *(undefined8 *)(param_4 + lVar13 + 0x40 + 8) = uVar1;
          puVar9 = (undefined8 *)((long)puVar10 + lVar13 + 0x50);
          uVar1 = puVar9[1];
          *(undefined8 *)(param_4 + lVar13 + 0x50) = *puVar9;
          *(undefined8 *)(param_4 + lVar13 + 0x50 + 8) = uVar1;
          puVar9 = (undefined8 *)((long)puVar10 + lVar13 + 0x60);
          uVar1 = puVar9[1];
          *(undefined8 *)(param_4 + lVar13 + 0x60) = *puVar9;
          *(undefined8 *)(param_4 + lVar13 + 0x60 + 8) = uVar1;
          puVar9 = (undefined8 *)((long)puVar10 + lVar13 + 0x70);
          uVar1 = puVar9[1];
          *(undefined8 *)(param_4 + lVar13 + 0x70) = *puVar9;
          *(undefined8 *)(param_4 + lVar13 + 0x70 + 8) = uVar1;
          puVar9 = (undefined8 *)((long)puVar10 + lVar13 + 0x80);
          uVar1 = puVar9[1];
          *(undefined8 *)(param_4 + lVar13 + 0x80) = *puVar9;
          *(undefined8 *)(param_4 + lVar13 + 0x80 + 8) = uVar1;
...
void __thiscall
std::unique_ptr<RuntimeInterface,std::default_delete<RuntimeInterface>>::~unique_ptr
          (unique_ptr<RuntimeInterface,std::default_delete<RuntimeInterface>> *this)

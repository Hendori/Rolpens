/* tvg::Paint::Impl::bounds(tvg::RenderMethod*) const */undefined1[16];tvg::Paint::Impl::bounds (Impl *this,RenderMethod *param_1) {
   byte bVar1;
...
/* tvg::Paint::Impl::iterator() */undefined8 * __thiscall tvg::Paint::Impl::iterator(Impl *this){
   long lVar1;
   undefined8 uVar2;
   char cVar3;
   undefined8 *puVar4;
...
/* tvg::Paint::Impl::rotate(float) */undefined8 tvg::Paint::Impl::rotate(Impl *this, float param_1) {
   undefined8 uVar1;
   uVar1 = 0;
...
/* tvg::Paint::Impl::scale(float) */undefined8 tvg::Paint::Impl::scale(Impl *this, float param_1) {
   undefined8 uVar1;
   uVar1 = 0;
   if (this[0x70] == (Impl)0x0) {
...
/* tvg::Paint::Impl::translate(float, float) */undefined8 tvg::Paint::Impl::translate(Impl *this, float param_1, float param_2) {
   undefined8 uVar1;
   uVar1 = 0;
   if (this[0x70] == (Impl)0x0) {
      if (( _LC4 < (float)( ( uint )(param_1 - *(float*)( this + 0x28 )) & _LC3 ) ) || ( _LC4 < (float)( ( uint )(param_2 - *(float*)( this + 0x34 )) & _LC3 ) )) {
         this[0x75] = ( Impl )((byte)this[0x75] | 0x10);
...
/* tvg::Paint::Impl::render(tvg::RenderMethod*) */ulong tvg::Paint::Impl::render(Impl *this, RenderMethod *param_1) {
   int iVar1;
   code *pcVar2;
   byte bVar3;
   undefined1 uVar4;
   ...
   if (this[0x77] == (Impl)0x0) {
      LAB_00100a10:uVar11 = 1;
   }
 else {
      plVar10 = *(long**)this;
      if (( *(long**)( this + 8 ) == (long*)0x0 ) || ( ( *(byte*)( *(long*)( **(long**)( this + 8 ) + 0x10 ) + 0x76 ) & 1 ) != 0 )) {
         LAB_001008e8:bVar3 = ( **(code**)( *plVar10 + 0x10 ) )();
         if (bVar3 == 3) {
         ...
         if (bVar3 < 4) {
            if (bVar3 == 1) {
               ...
               if (*(long*)( lVar9 + 0x38 ) != 0) {
                  lVar8 = 0;
                  LAB_00100955:( **(code**)( *(long*)param_1 + 0x60 ) )(param_1, *(undefined1*)( *(long*)( *(long*)( lVar9 + 0x40 ) + 0x10 ) + 0x74 ));
         ...
         if (bVar3 == 3) {
            ...
            if (bVar3 == 1) {
               lVar8 = *(long*)this;
               LAB_00100aeb:_local_68 = ZEXT816(0);
            ...
            LAB_00100c78:_local_68 = (undefined1[16])0x0;
         }
         ...
         ( **(code**)( *(long*)param_1 + 0x90 ) )(param_1, lVar8, (int)( *(long**)( this + 8 ) )[2], *(undefined1*)( *(long*)( **(long**)( this + 8 ) + 0x10 ) + 0x77 ));
         ...
         if (bVar3 == 3) {
            ...
            LAB_00100a54:( **(code**)( *(long*)param_1 + 0x60 ) )(param_1, *(undefined1*)( *(long*)( plVar10[1] + 0x10 ) + 0x74 ));
            uVar6 = render(*(Impl**)( plVar10[2] + 0x10 ), param_1);
            uVar11 = (ulong)uVar6;
            LAB_00100a7c:if (lVar8 == 0) goto LAB_00100a15;
         }

         LAB_00100a81:( **(code**)( *(long*)param_1 + 0x98 ) )(param_1, lVar8);
      }

   }

   LAB_00100a15:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar11;
   }

   LAB_00100d36:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* tvg::Paint::Impl::update(tvg::RenderMethod*, tvg::Matrix const&, tvg::Array<void*>&, unsigned
   char, tvg::RenderUpdateFlag, bool) */undefined8 tvg::Paint::Impl::update(Impl *this, RenderMethod *param_1, Matrix *param_2, long *param_3, uint param_5, byte param_6, undefined1 param_7) {
   byte *pbVar1;
   Impl IVar2;
   Paint *pPVar3;
   long *plVar4;
   ...
   if (puVar25 == (undefined8*)0x0) {
      ...
      *(byte*)( *(long*)( pPVar3 + 0x10 ) + 0x76 ) = *(byte*)( *(long*)( pPVar3 + 0x10 ) + 0x76 ) & 0xfe;
      ...
      if (cVar12 != '\x01') {
         LAB_00100de2:lVar14 = *(long*)( pPVar3 + 0x10 );
         LAB_00100de7:update((Impl*)lVar14, param_1, param_2, param_3, 0xff, param_6, 0);
         goto LAB_00100e09;
      }
      ...
      if (iVar23 == 2) {
         local_a8 = auVar9;
         if (( local_68._0_1_ == -1 ) && ( local_a8 = auVar10 * (char*)( lVar14 + 0x77 ) == -1 )) goto LAB_00101179;
         goto LAB_00100de7;
      }

      local_a8 = auVar7;
      if (( iVar23 != 3 ) || ( ( local_68._0_1_ != '\0' && ( local_a8 = auVar8 * (char*)( lVar14 + 0x77 ) != '\0' ) ) )) goto LAB_00100de7;
      LAB_00101179:local_a8 = ( **(code**)( *(long*)param_1 + 0x50 ) )(param_1);
   ...
   if (*(long*)( this + 0x10 ) != 0) {
      ...
      *pbVar1 = *pbVar1 & 0xfe;
      ...
      if (local_e0 == 2) {
         uVar15 = update((Impl*)*(undefined8*)( *(long*)( this + 0x10 ) + 0x10 ), param_1, param_2, param_3, 0xff, param_6, 1);
   ...
   if (bVar13 == 3) {
      ...
      if (plVar4[2] == 0) {
         if (plVar4[1] != 0) {
            ...
            auVar28 = update((Impl*)*(undefined8*)( plVar4[1] + 0x10 ), param_1, (Matrix*)( this + 0x44 ), param_3, uVar18, param_6 | bVar13, 0);
         ...
         auVar28 = ( **(code**)( *(long*)param_1 + 0x18 ) )(param_1, plVar4[2], plVar4[3], local_98, param_3, uVar18, param_6 | bVar13);
         plVar4[3] = auVar28._0_8_;
         goto joined_r0x0010109b;
      }
   ...
   if (bVar13 < 4) {
      ...
      if (bVar13 == 1) {
         ...
         if (param_6 == 0 && this_00[0x48] == (Impl)0x0) {
            ...
            auVar28 = ( **(code**)( *(long*)param_1 + 0x10 ) )(param_1, this_00, *(undefined8*)( this_00 + 0x38 ), this + 0x44, param_3, uVar18, param_6 | (byte)this_00[0x48], param_7);
      ...
      *(undefined1(*) [16])( plVar4 + 5 ) = auVar27;
      if (uVar24 == 0) {
         ...
         uVar18 = 0;
         uVar19 = uVar18;
         joined_r0x001011cc:for (; plVar21 != plVar4; plVar21 = (long*)*plVar21) {
            LAB_001011e0:update((Impl*)*(undefined8*)( plVar21[2] + 0x10 ), param_1, this + 0x44, param_3, uVar18 & 0xff, param_6, 0);
         ...
         if (plVar21 != plVar4) {
            ...
            *(byte*)( plVar4 + 8 ) = bVar13;
            ...
            LAB_00100f64:*(char*)( (long)plVar4 + 0x41 ) = (char)uVar18;
            uVar18 = 0xffffffff;
            uVar19 = uVar18;
      ...
      if (( puVar6 != (ulong*)0x0 ) && ( puVar25 = (undefined8*)*puVar6 ),puVar25 < puVar25 + (uint)puVar6[1]) {
         do {
            uVar15 = *puVar25;
            puVar25 = puVar25 + 1;
 ...
 while ( puVar25 < (undefined8*)( *(long*)plVar4[7] + uVar19 * 8 ) );
      ...
      if (plVar21 != (long*)0x0) {
         ...
         cVar12 = ( **(code**)( lVar14 + 0x48 ) )((int)plVar4[4], plVar21, plVar4[2], *(undefined1*)( (long)plVar4 + 0x24 ));
         ...
         if (cVar12 != '\0') {
            ...
            if (( plVar21 != (long*)0x0 ) && ( ( *(byte*)( *(long*)( lVar14 + 0x18 ) + 0x48 ) & 4 ) != 0 )) {
               ...
               if (cVar12 == '\n') {
                  *pfVar5 = *pfVar5 * fVar26;
                  for (int i = 0; i < 3; i++) {
                     pfVar5[( i + 1 )] = pfVar5[( i + 1 )] * fVar26;
                  }

                  lVar14 = plVar4[2];
               }
 else {
                  *(ulong*)( pfVar5 + 4 ) = CONCAT44((float)( ( ulong ) * (undefined8*)( pfVar5 + 4 ) >> 0x20 ) * fVar26, (float)*(undefined8*)( pfVar5 + 4 ) * fVar26);
                  *pfVar5 = *pfVar5 * fVar26;
                  for (int i = 0; i < 3; i++) {
                     pfVar5[( i + 1 )] = pfVar5[( i + 1 )] * fVar26;
                  }
            ...
            uVar29 = 0;
            uVar15 = update((Impl*)*(undefined8*)( lVar14 + 0x10 ), param_1, this + 0x44, param_3, uVar18, param_6);
   ...
   LAB_0010125a:auVar11._8_8_ = 0;
   auVar11._0_8_ = uVar19;
   auVar28 = auVar11 << 0x40;
   joined_r0x0010109b:if (local_e0 == 0) {
...
/* tvg::Paint::Impl::bounds(float*, float*, float*, float*, bool, bool, bool) */ulong tvg::Paint::Impl::bounds(Impl *this, float *param_1, float *param_2, float *param_3, float *param_4, bool param_5, bool param_6, bool param_7) {
   uint uVar1;
   long *plVar2;
   float *pfVar3;
   float *pfVar4;
...
;
            ...
            if (bVar5 == 2) {
               ...
               if (plVar11 != plVar2) {
                  ...
                  do {
                     ...
                     local_78 = fVar14;
                     local_74 = fVar14;
                     cVar6 = bounds(*(Impl**)( plVar11[2] + 0x10 ), &local_78, &local_74, &local_70, &local_6c, true, param_6, false);
                     fVar17 = local_d0;
                     if (cVar6 != '\0') {
                        fVar19 = local_78;
 ...
 while ( plVar2 != plVar11 );
            ...
            if (plVar11 != (long*)0x0) {
               ...
               cVar6 = ( **(code**)( lVar8 + 0x48 ) )((int)plVar2[4], plVar11, plVar2[2], *(undefined1*)( (long)plVar2 + 0x24 ));
               if (cVar6 != '\0') {
...
;
 ...
 while ( plVar2 != plVar11 );
         ...
         if (plVar11 != (long*)0x0) {
            ...
            param_5 = (bool)( **(code**)( lVar8 + 0x48 ) )((int)plVar2[4], plVar11, plVar2[2], *(undefined1*)( (long)plVar2 + 0x24 ));
            fVar14 = _LC1;
            fVar17 = _LC13;
            if (param_5 != false) {
               bounds(*(Impl**)( plVar2[2] + 0x10 ), &local_88, &local_84, &local_80, &local_7c, true, true, false);
               fVar14 = _LC1;
               fVar17 = _LC13;
            }
   ...
   LAB_00101b78:local_58 = local_80 + local_88;
 ...
 while ( local_48 != pPVar13 );
   ...
   uVar7 = (ulong)param_5;
   LAB_00101868:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar7;
   }
...
/* tvg::Paint::Impl::reset() */void tvg::Paint::Impl::reset(Impl *this) {
   char *pcVar1;
   long *plVar2;
   uint uVar3;
   undefined8 uVar4;
...
/* tvg::Paint::Paint() */void tvg::Paint::Paint(Paint *this) {
   uint uVar1;
   undefined8 uVar2;
   undefined8 *puVar3;
...
/* tvg::Paint::rotate(float) */undefined8 tvg::Paint::rotate(Paint *this, float param_1) {
   long lVar1;
   undefined8 uVar2;
...
/* tvg::Paint::scale(float) */undefined8 tvg::Paint::scale(Paint *this, float param_1) {
   long lVar1;
   undefined8 uVar2;
   lVar1 = *(long*)( this + 0x10 );
   uVar2 = 2;
...
/* tvg::Paint::translate(float, float) */undefined8 tvg::Paint::translate(Paint *this, float param_1, float param_2) {
   long lVar1;
   undefined8 uVar2;
   lVar1 = *(long*)( this + 0x10 );
   uVar2 = 2;
   if (*(char*)( lVar1 + 0x70 ) == '\0') {
      if (( _LC4 < (float)( ( uint )(param_1 - *(float*)( lVar1 + 0x28 )) & _LC3 ) ) || ( _LC4 < (float)( ( uint )(param_2 - *(float*)( lVar1 + 0x34 )) & _LC3 ) )) {
         *(byte*)( lVar1 + 0x75 ) = *(byte*)( lVar1 + 0x75 ) | 0x10;
...
/* tvg::Paint::transform(tvg::Matrix const&) */undefined8 tvg::Paint::transform(Paint *this, Matrix *param_1) {
   long lVar1;
   undefined8 uVar2;
   lVar1 = *(long*)( this + 0x10 );
...
/* tvg::Paint::transform() */void tvg::Paint::transform(void) {
   undefined4 uVar1;
   long lVar2;
   undefined8 uVar3;
   undefined8 uVar4;
...
/* tvg::Paint::bounds(float*, float*, float*, float*) const */int tvg::Paint::bounds(Paint *this, float *param_1, float *param_2, float *param_3, float *param_4) {
   uint uVar1;
   uVar1 = Impl::bounds(*(Impl**)( this + 0x10 ), param_1, param_2, param_3, param_4, false, true, false);
   return ( ( uVar1 ^ 1 ) & 0xff ) * 2;
}
/* tvg::Paint::bounds(float*, float*, float*, float*, bool) const */int tvg::Paint::bounds(Paint *this, float *param_1, float *param_2, float *param_3, float *param_4, bool param_5) {
   uint uVar1;
   uVar1 = Impl::bounds(*(Impl**)( this + 0x10 ), param_1, param_2, param_3, param_4, param_5, true, param_5);
   return ( ( uVar1 ^ 1 ) & 0xff ) * 2;
}
/* tvg::Paint::clip(std::unique_ptr<tvg::Paint, std::default_delete<tvg::Paint> >) */undefined8 tvg::Paint::clip(Paint *this, long *param_2) {
   char *pcVar1;
   long *plVar2;
   char cVar3;
   long lVar4;
...
/* tvg::Paint::composite(std::unique_ptr<tvg::Paint, std::default_delete<tvg::Paint> >,
   tvg::CompositeMethod) */ulong tvg::Paint::composite(Paint *this, long *param_2, int param_3) {
   long *plVar1;
   long lVar2;
   long *plVar3;
   char cVar4;
   ...
   *param_2 = 0;
   ...
   if (__ptr == (long*)0x0) {
      ...
      *(char*)( plVar3[2] + 0x78 ) = cVar4;
      ...
      LAB_00102621:*(char*)( plVar1[2] + 0x78 ) = *(char*)( plVar1[2] + 0x78 ) + '\x01';
      *(int*)( __ptr + 2 ) = param_3;
      *__ptr = (long)plVar1;
      __ptr[1] = (long)this;
   }
   ...
   uVar5 = 0;
   LAB_001025c2:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar5;
   }
...
/* tvg::Paint::Impl::duplicate(tvg::Paint*) */long *__thiscalltvg::Paint::Impl::duplicate(Impl *this, Paint *param_1) {
   undefined1 uVar1;
   undefined4 uVar2;
   long *plVar3;
   undefined8 *puVar4;
...
;
         ...
         if (plVar11 != (long*)0x0) {
            ...
            ( **(code**)( lVar15 + 0x48 ) )((int)plVar10[4], plVar11, plVar10[2], *(undefined1*)( (long)plVar10 + 0x24 ));
         }
   ...
   LAB_0010274a:uVar6 = *(undefined8*)( this + 0x28 );
   *(undefined8*)( lVar15 + 0x20 ) = *(undefined8*)( this + 0x20 );
   *(undefined8*)( lVar15 + 0x28 ) = uVar6;
   for (int i = 0; i < 4; i++) {
      uVar6 = *(undefined8*)( this + ( 16*i + 56 ) );
      *(undefined8*)( lVar15 + ( 16*i + 48 ) ) = *(undefined8*)( this + ( 16*i + 48 ) );
      *(undefined8*)( lVar15 + ( 16*i + 56 ) ) = uVar6;
   }
   ...
   *(Impl*)( lVar15 + 0x77 ) = this[0x77];
            ...
            *(char*)( plVar3[2] + 0x78 ) = cVar8;
            ...
            if (plVar10 == (long*)0x0) {
               ...
               *(undefined8*)( lVar15 + 8 ) = 0;
               ...
               LAB_001027f5:*(char*)( plVar10[2] + 0x78 ) = *(char*)( plVar10[2] + 0x78 ) + '\x01';
               *plVar11 = (long)plVar10;
   ...
   if (plVar10 == (long*)0x0) {
      LAB_0010284c:*(long**)( lVar15 + 0x10 ) = plVar11;
...
/* tvg::Paint::duplicate() const */void tvg::Paint::duplicate(Paint *this) {
   Impl::duplicate(*(Impl**)( this + 0x10 ), (Paint*)0x0);
   return;
}
/* tvg::Paint::composite(tvg::Paint const**) const */undefined4 tvg::Paint::composite(Paint *this, Paint **param_1) {
   undefined8 *puVar1;
   Paint *pPVar2;
...
/* tvg::Paint::opacity(unsigned char) */undefined8 tvg::Paint::opacity(Paint *this, uchar param_1) {
   long lVar1;
   lVar1 = *(long*)( this + 0x10 );
...
/* tvg::Paint::opacity() const */undefined1 tvg::Paint::opacity(Paint *this) {
   return *(undefined1*)( *(long*)( this + 0x10 ) + 0x77 );
}
/* tvg::Paint::identifier() const */undefined1 tvg::Paint::identifier(Paint *this) {
   undefined1 uVar1;
   uVar1 = ( **(code**)( *(long*)this + 0x10 ) )();
   return uVar1;
}
/* tvg::Paint::blend(tvg::BlendMethod) */undefined8 tvg::Paint::blend(Paint *this, char param_2) {
   long lVar1;
...
/* PictureIterator::next() */void PictureIterator::next(PictureIterator *this) {
   if (*(long*)( this + 0x10 ) != 0) {
      *(undefined8*)( this + 0x10 ) = 0;
      return;
   }
...
/* PictureIterator::count() */bool PictureIterator::count(PictureIterator *this) {
   return *(long*)( this + 8 ) != 0;
}
/* PictureIterator::begin() */void PictureIterator::begin(PictureIterator *this) {
   *(undefined8*)( this + 0x10 ) = 0;
   return;
}
/* SceneIterator::next() */undefined8 SceneIterator::next(SceneIterator *this) {
   undefined8 *puVar1;
   undefined8 uVar2;
...
/* SceneIterator::count() */undefined4 SceneIterator::count(SceneIterator *this) {
   return *(undefined4*)( *(long*)( this + 8 ) + 0x10 );
}
/* SceneIterator::begin() */void SceneIterator::begin(SceneIterator *this) {
   *(undefined8*)( this + 0x10 ) = **(undefined8**)( this + 8 );
   return;
}
/* SceneIterator::~SceneIterator() */void SceneIterator::~SceneIterator(SceneIterator *this) {
   return;
}
/* PictureIterator::~PictureIterator() */void PictureIterator::~PictureIterator(PictureIterator *this) {
   return;
}
/* SceneIterator::~SceneIterator() */void SceneIterator::~SceneIterator(SceneIterator *this) {
   operator_delete(this, 0x18);
...
/* tvg::Shape::Impl::needComposition(unsigned char) */undefined8 tvg::Shape::Impl::needComposition(Impl *this, uchar param_1) {
   int iVar1;
   float *pfVar2;
   undefined8 *puVar3;
   long *plVar4;
   ...
   this[0x49] = (Impl)0x0;
   if (( ( ( param_1 == '\0' ) || ( pfVar2 = *(float**)( this + 0x28 ) ),pfVar2 == (float*)0x0 ) ) || ( *pfVar2 <= _LC4 && _LC4 != *pfVar2 )) goto LAB_00102e22;
   ...
   if (param_1 == 0xff) {
      ...
      if (puVar3 != (undefined8*)0x0) {
         ...
         if (( plVar4 != (long*)0x0 ) && ( iVar1 != 1 )) {
            if (( ( byte )(*(char*)( plVar4[2] + 0x77 ) - 1U) < 0xfe ) || ( ( ( cVar5 = ( **(code**)( *plVar4 + 0x10 ) )(plVar4) ),cVar5 != '\x01' || ( lVar7 = tvg::Shape::fill() ),lVar7 != 0 ) ) || ( tvg::Shape::fillColor((uchar*)plVar4, &local_24, &local_23, &local_22),( byte )(local_21 - 1U) < 0xfe )) goto LAB_00102e08;
            if (iVar1 - 4U < 2) {
               if (local_24 == 0xff) {
                  if (( local_23 & local_22 ) != 0xff) goto LAB_00102e08;
               }
 else if (( local_24 != '\0' || local_23 != 0 ) || local_22 != 0) {
                  LAB_00102e08:this[0x49] = (Impl)0x4;
                  goto LAB_00102d3a;
               }
      ...
      LAB_00102e22:uVar6 = 0;
   }
 else {
      this[0x49] = (Impl)0x1;
      LAB_00102d3a:uVar6 = 1;
   }

   LAB_00102d3f:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* tvg::Shape::Impl::duplicate(tvg::Paint*) */Paint * __thiscall tvg::Shape::Impl::duplicate(Impl *this,Paint *param_1){
   size_t __size;
   undefined4 uVar1;
   uint uVar2;
   uint uVar3;
...
/* tvg::Scene::Impl::bounds(tvg::RenderMethod*) const */undefined8 tvg::Scene::Impl::bounds(Impl *this, RenderMethod *param_1) {
   long lVar1;
   int iVar2;
   int iVar3;
   int iVar4;
 ...
 while ( pIVar10 != this );
      ...
      if (( puVar7 == (ulong*)0x0 ) || ( plVar11 = (long*)*puVar7 ),plVar11 + (uint)puVar7[1] <= plVar11) {
         local_68 = 0;
         local_64 = 0;
         iVar6 = iVar14;
         iVar2 = iVar12;
...
/* tvg::Scene::Impl::render(tvg::RenderMethod*) */uint tvg::Scene::Impl::render(Impl *this, RenderMethod *param_1) {
   Impl IVar1;
   code *pcVar2;
   ulong uVar3;
   undefined1 uVar4;
   ...
   long local_40;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   ( **(code**)( *(long*)param_1 + 0x60 ) )(param_1, *(undefined1*)( *(long*)( *(long*)( this + 0x20 ) + 0x10 ) + 0x74 ));
   IVar1 = this[0x40];
   if (IVar1 == (Impl)0x0) {
      pIVar8 = *(Impl**)this;
      lVar7 = 0;
         ...
         if (plVar9 < plVar9 + (uint)uVar3) {
            do {
               if (*(char*)( *plVar9 + 0x21 ) != '\0') {
                  ( **(code**)( *(long*)param_1 + 0xb0 ) )(param_1, lVar7, *plVar9, IVar1 == (Impl)0x8 && (uint)uVar3 == 1);
                  puVar6 = *(ulong**)( this + 0x38 );
               }
 ...
 while ( plVar9 < (long*)( *puVar6 + (ulong)(uint)puVar6[1] * 8 ) );
   ...
   LAB_00103464:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* tvg::Paint::Impl::duplicate(tvg::Paint*) [clone .cold] */void tvg::Paint::Impl::duplicate(Paint *param_1) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* WARNING: Control flow encountered bad instruction data *//* PictureIterator::~PictureIterator() */void PictureIterator::~PictureIterator(PictureIterator *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* SceneIterator::~SceneIterator() */void SceneIterator::~SceneIterator(SceneIterator *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

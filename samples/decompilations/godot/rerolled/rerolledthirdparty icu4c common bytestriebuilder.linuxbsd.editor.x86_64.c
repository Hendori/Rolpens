/* icu_76_godot::BytesTrieBuilder::getElementUnit(int, int) const */undefined1 icu_76_godot::BytesTrieBuilder::getElementUnit(BytesTrieBuilder *this, int param_1, int param_2) {
   int iVar1;
   int iVar2;
...
/* icu_76_godot::BytesTrieBuilder::getElementValue(int) const */undefined4 icu_76_godot::BytesTrieBuilder::getElementValue(BytesTrieBuilder *this, int param_1) {
   return *(undefined4*)( *(long*)( this + 0x18 ) + 4 + (long)param_1 * 8 );
}
/* icu_76_godot::BytesTrieBuilder::countElementUnits(int, int, int) const */int icu_76_godot::BytesTrieBuilder::countElementUnits(BytesTrieBuilder *this, int param_1, int param_2, int param_3) {
   int iVar1;
   int iVar2;
   int iVar3;
   int iVar4;
   ...
   while (true) {
      ...
      while (true) {
         ...
         if (*(char*)( (long)param_3 + **(long**)( this + 0x10 ) + (long)( iVar1 + 1 ) ) != *(char*)( (long)param_3 + **(long**)( this + 0x10 ) + (long)( iVar4 + 1 ) )) break;
         uVar5 = uVar5 + 1;
...
;
   LAB_001000c0:return iVar3 + 1;
}
/* icu_76_godot::BytesTrieBuilder::skipElementsBySomeUnits(int, int, int) const */void icu_76_godot::BytesTrieBuilder::skipElementsBySomeUnits(BytesTrieBuilder *this, int param_1, int param_2, int param_3) {
   int iVar1;
   int iVar2;
   ulong uVar3;
   ulong uVar4;
 ...
 while ( *(char*)( (long)param_2 + **(long**)( this + 0x10 ) + (long)( iVar1 + 1 ) ) == *(char*)( (long)param_2 + **(long**)( this + 0x10 ) + (long)( iVar2 + 1 ) ) );
      param_3 = param_3 + -1;
   }
 while ( 0 < param_3 );
   return;
}
/* icu_76_godot::BytesTrieBuilder::indexOfElementWithNextUnit(int, int, char16_t) const */void icu_76_godot::BytesTrieBuilder::indexOfElementWithNextUnit(BytesTrieBuilder *this, int param_1, int param_2, wchar16 param_3) {
   int iVar1;
   int iVar2;
   long lVar3;
   lVar3 = (long)param_1;
...
/* icu_76_godot::BytesTrieBuilder::~BytesTrieBuilder() */void icu_76_godot::BytesTrieBuilder::~BytesTrieBuilder(BytesTrieBuilder *this) {
   UMemory *this_00;
   void *in_RSI;
...
/* icu_76_godot::BytesTrieBuilder::BTLinearMatchNode::TEMPNAMEPLACEHOLDERVALUE(icu_76_godot::StringTrieBuilder::Node
   const&) const */undefined8 icu_76_godot::BytesTrieBuilder::BTLinearMatchNode::operator ==(BTLinearMatchNode *this, Node *param_1) {
   int iVar1;
   undefined8 uVar2;
   undefined4 extraout_var;
   if (this != (BTLinearMatchNode*)param_1) {
      uVar2 = icu_76_godot::StringTrieBuilder::LinearMatchNode::operator ==((LinearMatchNode*)this, param_1);
      if ((char)uVar2 != '\0') {
...
/* icu_76_godot::BytesTrieBuilder::getLimitOfLinearMatch(int, int, int) const */void icu_76_godot::BytesTrieBuilder::getLimitOfLinearMatch(BytesTrieBuilder *this, int param_1, int param_2, int param_3) {
   char *pcVar1;
   long lVar2;
   uint uVar3;
   int iVar4;
...
/* icu_76_godot::BytesTrieBuilder::getElementStringLength(int) const */ushort icu_76_godot::BytesTrieBuilder::getElementStringLength(BytesTrieBuilder *this, int param_1) {
   uint uVar1;
   long lVar2;
...
/* icu_76_godot::BytesTrieElement::setTo(icu_76_godot::StringPiece, int, icu_76_godot::CharString&,
   UErrorCode&) */void icu_76_godot::BytesTrieElement::setTo(uint *param_1, int param_2, uint param_3, uint param_4, char *param_5, int *param_6) {
   uint uVar1;
   if (0 < *param_6) {
      return;
   }
   ...
   if ((int)param_3 < 0x10000) {
      ...
      if (0xff < (int)param_3) {
         icu_76_godot::CharString::append((char)param_5, (UErrorCode*)(ulong)(uint)(int)(char)( param_3 >> 8 ));
         uVar1 = ~uVar1;
      }
...
/* icu_76_godot::BytesTrieElement::compareStringTo(icu_76_godot::BytesTrieElement const&,
   icu_76_godot::CharString const&) const */int icu_76_godot::BytesTrieElement::compareStringTo(BytesTrieElement *this, BytesTrieElement *param_1, CharString *param_2) {
   uint uVar1;
   uint uVar2;
   long lVar3;
   int iVar4;
   ...
   iVar5 = memcmp((void*)( (int)( uVar1 + 1 ) + lVar3 ), (void*)( lVar3 + (int)( uVar2 + 1 ) ), (long)(int)uVar6);
   iVar4 = uVar8 - uVar7;
   if (iVar5 != 0) {
      iVar4 = iVar5;
   }
...
/* icu_76_godot::BytesTrieBuilder::BytesTrieBuilder(UErrorCode&) */void icu_76_godot::BytesTrieBuilder::BytesTrieBuilder(BytesTrieBuilder *this, UErrorCode *param_1) {
   uint uVar1;
   long *plVar2;
   icu_76_godot::StringTrieBuilder::StringTrieBuilder((StringTrieBuilder*)this);
   uVar1 = *(uint*)param_1;
...
/* icu_76_godot::BytesTrieBuilder::add(icu_76_godot::StringPiece, int, UErrorCode&) */long icu_76_godot::BytesTrieBuilder::add(long param_1, void *param_2, undefined8 param_3, undefined4 param_4, int *param_5) {
   int iVar1;
   void *__dest;
   void *__src;
   UMemory *this;
   ...
   if (*param_5 < 1) {
      if (*(int*)( param_1 + 0x34 ) < 1) {
         ...
         *(int*)( param_1 + 0x24 ) = iVar1 + 1;
         BytesTrieElement::setTo((void*)( (long)__dest + (long)iVar1 * 8 ), param_2, param_3, param_4, *(undefined8*)( param_1 + 0x10 ), param_5);
      }
 else {
         *param_5 = 0x1e;
      }
...
/* icu_76_godot::BytesTrieBuilder::buildBytes(UStringTrieBuildOption, UErrorCode&) */void icu_76_godot::BytesTrieBuilder::buildBytes(BytesTrieBuilder *this, undefined4 param_2, int *param_3) {
   uint uVar1;
   char cVar2;
   long lVar3;
   long *plVar4;
   ...
   if (*param_3 < 1) {
      if (( *(long*)( this + 0x28 ) == 0 ) || ( *(int*)( this + 0x34 ) < 1 )) {
         if (*(int*)( this + 0x34 ) == 0) {
            ...
            uprv_sortArray_76_godot(*(undefined8*)( this + 0x18 ), *(int*)( this + 0x24 ), 8, compareElementStrings, *(undefined8*)( this + 0x10 ), 0);
            ...
            local_68 = *plVar4;
            if ((int)uVar1 < 0) {
               local_60 = (uint)CONCAT11(*(undefined1*)( local_68 + (int)~uVar1 ), *(undefined1*)( local_68 + (int)-uVar1 ));
               uVar1 = -uVar1;
            }
 else {
            ...
            if (1 < *(int*)( this + 0x24 )) {
               ...
               while (true) {
                  ...
                  if ((int)uVar1 < 0) {
                     local_50 = (uint)CONCAT11(*(undefined1*)( local_58 + (int)~uVar1 ), *(undefined1*)( local_58 + (int)-uVar1 ));
                     uVar1 = -uVar1;
                  }
 else {
...
;
   ...
   LAB_00100820:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* icu_76_godot::BytesTrieBuilder::build(UStringTrieBuildOption, UErrorCode&) */long *__thiscallicu_76_godot::BytesTrieBuilder::build(BytesTrieBuilder *this, ulong param_2, int *param_3) {
   int iVar1;
   int iVar2;
   long lVar3;
   long *plVar4;
...
/* icu_76_godot::BytesTrieBuilder::buildStringPiece(UStringTrieBuildOption, UErrorCode&) */undefined1  [16] __thiscallicu_76_godot::BytesTrieBuilder::buildStringPiece(BytesTrieBuilder *this, undefined8 param_2, int *param_3) {
...
/* icu_76_godot::BytesTrieBuilder::clear() */BytesTrieBuilder * __thiscall icu_76_godot::BytesTrieBuilder::clear(BytesTrieBuilder *this){
   undefined8 *puVar1;
...
/* icu_76_godot::BytesTrieBuilder::BTLinearMatchNode::BTLinearMatchNode(char const*, int,
   icu_76_godot::StringTrieBuilder::Node*) */void icu_76_godot::BytesTrieBuilder::BTLinearMatchNode::BTLinearMatchNode(BTLinearMatchNode *this, char *param_1, int param_2, Node *param_3) {
   int iVar1;
   int iVar2;
   iVar1 = 0;
   if (param_3 != (Node*)0x0) {
...
/* icu_76_godot::BytesTrieBuilder::ensureCapacity(int) */undefined8 icu_76_godot::BytesTrieBuilder::ensureCapacity(BytesTrieBuilder *this, int param_1) {
   long lVar1;
   int iVar2;
   int iVar3;
   long lVar4;
...
/* icu_76_godot::BytesTrieBuilder::write(int) */undefined4 icu_76_godot::BytesTrieBuilder::write(BytesTrieBuilder *this, int param_1) {
   int iVar1;
   char cVar2;
...
/* icu_76_godot::BytesTrieBuilder::writeValueAndType(signed char, int, int) */ulong icu_76_godot::BytesTrieBuilder::writeValueAndType(BytesTrieBuilder *this, char param_2, undefined4 param_3, undefined4 param_4) {
   int iVar1;
   char cVar2;
   ulong uVar3;
...
/* icu_76_godot::BytesTrieBuilder::write(char const*, int) */undefined4 icu_76_godot::BytesTrieBuilder::write(BytesTrieBuilder *this, char *param_1, int param_2) {
   char cVar1;
   int iVar2;
   ...
   *(int*)( this + 0x34 ) = iVar2;
   memcpy((void*)( (long)( *(int*)( this + 0x30 ) - iVar2 ) + *(long*)( this + 0x28 ) ), param_1, (long)param_2);
   return *(undefined4*)( this + 0x34 );
}
/* icu_76_godot::BytesTrieBuilder::BTLinearMatchNode::write(icu_76_godot::StringTrieBuilder&) */void icu_76_godot::BytesTrieBuilder::BTLinearMatchNode::write(BTLinearMatchNode *this, StringTrieBuilder *param_1) {
   int iVar1;
   code *pcVar2;
   code *pcVar3;
   char cVar4;
...
/* icu_76_godot::BytesTrieBuilder::writeElementUnits(int, int, int) */void icu_76_godot::BytesTrieBuilder::writeElementUnits(BytesTrieBuilder *this, int param_1, int param_2, int param_3) {
   int iVar1;
   int iVar2;
   iVar1 = *(int*)( *(long*)( this + 0x18 ) + (long)param_1 * 8 );
   iVar2 = -iVar1;
...
/* icu_76_godot::BytesTrieBuilder::writeValueAndFinal(int, signed char) */ulong icu_76_godot::BytesTrieBuilder::writeValueAndFinal(BytesTrieBuilder *this, uint param_1, byte param_3) {
   char cVar1;
   ulong uVar2;
   long lVar3;
   int iVar4;
   ...
   if (param_1 < 0x41) {
      ...
      if (param_1 < 0x1000000) {
         ...
         local_27 = param_1 >> 0x18 | ( param_1 & 0xff0000 ) >> 8 | ( param_1 & 0xff00 ) << 8 | param_1 << 0x18;
         local_28 = 0xfe;
         iVar4 = 5;
      }
   ...
   LAB_00100fe3:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* icu_76_godot::BytesTrieBuilder::writeDeltaTo(int) */ulong icu_76_godot::BytesTrieBuilder::writeDeltaTo(BytesTrieBuilder *this, int param_1) {
   char cVar1;
   char cVar2;
   ulong uVar3;
   long lVar4;
   ...
   LAB_00101165:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* icu_76_godot::BytesTrieBuilder::internalEncodeDelta(int, char*) */undefined8 icu_76_godot::BytesTrieBuilder::internalEncodeDelta(int param_1, char *param_2) {
   char cVar1;
   undefined8 uVar2;
   long lVar3;
   char cVar4;
...
/* icu_76_godot::BytesTrieBuilder::matchNodesCanHaveValues() const */undefined8 icu_76_godot::BytesTrieBuilder::matchNodesCanHaveValues(void) {
   return 0;
}
/* icu_76_godot::BytesTrieBuilder::getMaxBranchLinearSubNodeLength() const */undefined8 icu_76_godot::BytesTrieBuilder::getMaxBranchLinearSubNodeLength(void) {
   return 5;
}
/* icu_76_godot::BytesTrieBuilder::getMinLinearMatch() const */undefined8 icu_76_godot::BytesTrieBuilder::getMinLinearMatch(void) {
   return 0x10;
}
/* icu_76_godot::BytesTrieBuilder::getMaxLinearMatchLength() const */undefined8 icu_76_godot::BytesTrieBuilder::getMaxLinearMatchLength(void) {
   return 0x10;
}
/* icu_76_godot::BytesTrieBuilder::BTLinearMatchNode::~BTLinearMatchNode() */void icu_76_godot::BytesTrieBuilder::BTLinearMatchNode::~BTLinearMatchNode(BTLinearMatchNode *this) {
...
/* WARNING: Control flow encountered bad instruction data *//* icu_76_godot::BytesTrieBuilder::BTLinearMatchNode::~BTLinearMatchNode() */void icu_76_godot::BytesTrieBuilder::BTLinearMatchNode::~BTLinearMatchNode(BTLinearMatchNode *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

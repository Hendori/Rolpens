/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* hb_serialize_cff_fdselect(hb_serialize_context_t*, unsigned int, CFF::FDSelect const&, unsigned
   int, unsigned int, unsigned int, hb_vector_t<CFF::code_pair_t, false> const&) */undefined8 hb_serialize_cff_fdselect(hb_serialize_context_t *param_1, uint param_2, FDSelect *param_3, uint param_4, uint param_5, uint param_6, hb_vector_t *param_7) {
   ushort uVar1;
   undefined1 *puVar2;
   ushort uVar3;
   uint uVar4;
               ...
               *__s = uVar13;
               if (*(int*)( param_7 + 4 ) != 0) {
                  ...
                  do {
                     ...
                     puVar10 = puVar12;
                     if (( uVar13 >> 0x18 | ( uVar13 & 0xff0000 ) >> 8 | ( uVar13 & 0xff00 ) << 8 | uVar13 << 0x18 ) <= uVar4) {
 ...
 while ( (uint)lVar5 < *(uint*)( param_7 + 4 ) );
               ...
               *(uint*)( puVar6 + 6 ) = param_2 >> 0x18 | ( param_2 & 0xff0000 ) >> 8 | ( param_2 & 0xff00 ) << 8 | param_2 << 0x18;
               return 1;
            }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* hb_inc_bimap_t::add(unsigned int) [clone .isra.0] */void hb_inc_bimap_t::add(hb_inc_bimap_t *this, uint param_1) {
 ...
 while ( ( bVar1 & 2 ) != 0 );
   ...
   if (this[0x10] != (hb_inc_bimap_t)0x0) {
      ...
      if (( uVar7 >> 1 ) + uVar7 < *(uint*)( this + 0x1c )) {
         LAB_0010048e:iVar13 = *(int*)( this + 0x14 );
         uVar10 = ( ulong )(param_1 * -0x61c8864f & 0x3fffffff) % (ulong)uVar12;
         lVar5 = uVar10 * 0xc;
 ...
 while ( ( bVar1 & 2 ) != 0 );
            if (uVar9 == 0xffffffff) {
               LAB_00100576:uVar7 = uVar7 + 1;
            }
 else {
               LAB_00100503:lVar5 = (ulong)uVar9 * 0xc;
               LAB_0010050e:puVar8 = (uint*)( lVar11 + lVar5 );
         ...
         cVar3 = hb_hashmap_t<unsigned_int,unsigned_int,true>::alloc((hb_hashmap_t<unsigned_int,unsigned_int,true>*)this, 0);
         if (cVar3 != '\0') {
            lVar11 = *(long*)( this + 0x28 );
            uVar12 = *(uint*)( this + 0x20 );
            uVar7 = *(uint*)( this + 0x18 );
 ...
 while ( uVar14 < uVar9 );
         if (0x3fffffff < uVar14) {
            LAB_0010063d:*(uint*)( this + 0x30 ) = ~uVar12;
            __hb_CrapPool = __hb_NullPool;
            return;
         }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* hb_plan_subset_cff_fdselect(hb_subset_plan_t const*, unsigned int, CFF::FDSelect const&, unsigned
   int&, unsigned int&, unsigned int&, hb_vector_t<CFF::code_pair_t, false>&, hb_inc_bimap_t&) */undefined8 hb_plan_subset_cff_fdselect(hb_subset_plan_t *param_1, uint param_2, FDSelect *param_3, uint *param_4, uint *param_5, uint *param_6, hb_vector_t *param_7, hb_inc_bimap_t *param_8) {
   undefined8 *puVar1;
   byte bVar2;
   uint uVar3;
   uint uVar4;
...
;
 ...
 while ( iVar10 <= iVar29 );
               ...
               LAB_00100970:uVar28 = *(ushort*)( param_3 + 1 );
               pFVar32 = (FDSelect*)&_hb_NullPool;
         ...
         LAB_001007d9:if (uVar21 != uVar23) {
            if ((char)local_48 == '\0') {
               if (local_78._0_1_ != (hb_bit_set_t)0x0) {
                  ...
                  if (puVar12 != (undefined4*)0x0) {
                     *(ulong*)( puVar12 + ( ulong )(uVar21 >> 6) * 2 + 2 ) = *(ulong*)( puVar12 + ( ulong )(uVar21 >> 6) * 2 + 2 ) | 1L << ( (byte)uVar21 & 0x3f );
                     *puVar12 = 0xffffffff;
                  }
 ...
 else if (( local_78._0_1_ != (hb_bit_set_t)0x0 ) && ( puVar12 = (undefined4*)hb_bit_set_t::page_for((hb_bit_set_t*)&local_78, uVar21, false) ),puVar12 != (undefined4*)0x0) {
               local_78 = CONCAT44(0xffffffff, (undefined4)local_78);
               bVar2 = (byte)uVar21 & 0x3f;
               *(ulong*)( puVar12 + ( ulong )(uVar21 >> 6) * 2 + 2 ) = *(ulong*)( puVar12 + ( ulong )(uVar21 >> 6) * 2 + 2 ) & ( -2L << bVar2 | 0xfffffffffffffffeU >> 0x40 - bVar2 );
               *puVar12 = 0xffffffff;
            }
            ...
            if ((int)uVar23 < (int)uVar4) {
               LAB_00100861:pvVar18 = *(void**)( param_7 + 8 );
               LAB_00100865:puVar14 = (uint*)( (long)pvVar18 + uVar13 * 8 );
 ...
 while ( uVar23 < uVar30 );
               ...
               LAB_00100ff8:__hb_CrapPool = __hb_NullPool;
            }
 ...
 while ( ( bVar2 & 2 ) != 0 );
         ...
         LAB_00100e60:piVar17 = piVar27 + 2;
         *piVar27 = *piVar20;
         piVar27 = piVar17;
      }
 while ( piVar17 != piVar6 + (ulong)uVar31 * 2 );
   ...
   LAB_001006c2:uVar11 = 1;
   LAB_001006c7:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
...
/* hb_bit_set_t::resize(unsigned int, bool, bool) */hb_bit_set_t hb_bit_set_t::resize(hb_bit_set_t *this, uint param_1, bool param_2, bool param_3) {
 ...
 while ( uVar8 < param_1 );
      ...
      LAB_00101177:*(uint*)( this + 0x20 ) = ~uVar5;
      goto LAB_0010117c;
   }
   ...
   if (uVar5 == 0) {
      param_1 = 1;
      uVar8 = 1;
      LAB_00101309:pvVar2 = *(void**)( this + 0x28 );
      param_3 = (bool)hVar1;
      LAB_00101310:pvVar2 = realloc(pvVar2, (ulong)uVar8 * 0x48);
      if (pvVar2 == (void*)0x0) {
         uVar5 = *(uint*)( this + 0x20 );
         if (uVar5 < uVar8) goto LAB_00101177;
      }
 else {
         LAB_0010132c:*(void**)( this + 0x28 ) = pvVar2;
   ...
   LAB_001010c3:if (( (uint)uVar7 < param_1 ) && ( param_2 )) {
 ...
 while ( uVar5 < param_1 );
      ...
      LAB_0010118f:if (( (uint)uVar6 < param_1 ) && ( param_2 )) {
 ...
 while ( uVar8 < uVar4 );
      ...
      LAB_00101234:uVar8 = *(uint*)( this + 0x24 );
   }
 else {
      LAB_00101276:uVar8 = *(uint*)( this + 0x24 );
      uVar4 = (uint)uVar6;
      if (uVar4 <= uVar8) {
         uVar6 = (ulong)uVar8;
      }
      ...
      uVar9 = (uint)uVar6;
      if (uVar5 < uVar9) {
         LAB_00101200:if (0x38e38e3 < (uint)uVar6) goto LAB_00101177;
         pvVar2 = *(void**)( this + 0x28 );
         LAB_00101211:uVar8 = (uint)uVar6;
         ...
         if (pvVar2 == (void*)0x0) {
            ...
            LAB_0010122d:*(void**)( this + 0x28 ) = pvVar2;
            *(uint*)( this + 0x20 ) = uVar8;
         }
   ...
   *(uint*)( this + 0x24 ) = uVar4;
   LAB_0010117c:*this = (hb_bit_set_t)0x0;
   return (hb_bit_set_t)0x0;
}
/* hb_bit_set_t::next(unsigned int*) const */undefined8 hb_bit_set_t::next(hb_bit_set_t *this, uint *param_1) {
 ...
 while ( uVar3 != uVar8 );
   ...
   if (uVar9 < uVar2) {
      ...
      LAB_001014da:uVar2 = uVar3 + 1 & 0x1ff;
      if (uVar2 != 0) {
         uVar4 = ( ulong )(uVar2 >> 6);
      ...
      if ((int)( uVar2 - 1 ) < 0) {
         ...
         do {
            while (true) {
               ...
               uVar9 = uVar10;
               if (( uVar16 == uVar3 ) || ( uVar9 = iVar12 < (int)uVar9 )) goto LAB_001016ab;
            }
;
            iVar12 = uVar10 - 1;
         }
 while ( (int)uVar9 <= iVar12 );
      ...
      LAB_001016ab:if (uVar2 <= uVar9) goto LAB_00101598;
      LAB_001016b4:*(uint*)( this + 8 ) = uVar9;
      puVar13 = (uint*)( lVar5 + (ulong)uVar9 * 8 );
      lVar14 = *(long*)( this + 0x28 );
      if (*puVar13 == uVar16) {
         uVar3 = *param_1;
 ...
 while ( uVar9 != *(uint*)( this + 0x14 ) );
   ...
   LAB_00101598:*param_1 = 0xffffffff;
   return 0;
   LAB_00101657:uVar4 = *(ulong*)( piVar11 + uVar8 * 2 + 2 );
   if (uVar4 != 0) {
      iVar12 = 0;
      ...
      uVar8 = (ulong)uVar3;
      iVar12 = uVar3 + iVar12;
      LAB_0010166f:uVar3 = iVar12 + *piVar15 * 0x200;
   ...
   LAB_0010178c:if (param_2) {
      ...
      if (cVar6 != '\0') {
         ...
         *(ulong*)( *(long*)( this + 0x18 ) + (ulong)uVar8 * 8 ) = CONCAT44(uVar4, uVar9);
         uVar7 = uVar8;
         LAB_00101825:*(uint*)( this + 8 ) = uVar7;
...
;
 ...
 while ( true );
      ...
      __mutex[1].__align = 0;
      *(undefined8*)( (long)__mutex + 0x30 ) = 0;
      LAB_0010195a:pthread_mutex_destroy(__mutex);
      free(__mutex);
      *(undefined8*)( this + 8 ) = 0;
      iVar2 = *(int*)( this + 0x20 );
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* hb_hashmap_t<unsigned int, unsigned int, true>::alloc(unsigned int) */hb_hashmap_t<unsigned_int,unsigned_int,true> hb_hashmap_t<unsigned_int,unsigned_int,true>::alloc(hb_hashmap_t<unsigned_int,unsigned_int,true> *this, uint param_1) {
   ...
   if (hVar10 == (hb_hashmap_t<unsigned_int,unsigned_int,true>)0x0) {
      LAB_00101d53:hVar10 = (hb_hashmap_t<unsigned_int,unsigned_int,true>)0x0;
   }
 else {
      if (param_1 == 0) {
      ...
      if (uVar14 == 0) {
         ...
         iVar7 = 0xc;
         __size = 0xc;
         LAB_00101a99:pvVar4 = (void*)__memset_chk(pvVar4, 0, iVar7, __size);
      }
 else {
         iVar7 = 0x1f;
         if (uVar14 != 0) {
         ...
         if (pvVar4 == (void*)0x0) {
            LAB_00101d4f:this[0x10] = (hb_hashmap_t<unsigned_int,unsigned_int,true>)0x0;
            goto LAB_00101d53;
         }
 ...
 while ( ( bVar1 & 2 ) != 0 );
                  if (uVar12 == 0xffffffff) {
                     LAB_00101cfa:uVar13 = uVar13 + 1;
                  }
 else {
                     LAB_00101c14:lVar5 = (ulong)uVar12 * 0xc;
                     LAB_00101c1f:piVar6 = (int*)( lVar2 + lVar5 );
            ...
            LAB_00101b60:piVar15 = piVar15 + 3;
         }
 while ( __ptr + (ulong)uVar14 * 3 != piVar15 );
   ...
   LAB_00101cbd:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }

/* PluginConfigDialog::~PluginConfigDialog() */void PluginConfigDialog::~PluginConfigDialog(PluginConfigDialog *this) {
...
/* PluginConfigDialog::_notification(int) */void PluginConfigDialog::_notification(PluginConfigDialog *this, int param_1) {
   code *pcVar1;
   char cVar2;
   long *plVar3;
   long in_FS_OFFSET;
   ...
   if (param_1 == 0xd) {
      ...
      create_custom_callable_function_pointer<PluginConfigDialog>(aPStack_48, (char*)this, (_func_void*)"&PluginConfigDialog::_on_confirmed");
      ...
      create_custom_callable_function_pointer<PluginConfigDialog>(aPStack_48, (char*)this, (_func_void*)"&PluginConfigDialog::_on_canceled");
   ...
   LAB_001001a9:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* PluginConfigDialog::_clear_fields() */void PluginConfigDialog::_clear_fields(PluginConfigDialog *this) {
   undefined8 uVar1;
   String *pSVar2;
   long in_FS_OFFSET;
   undefined8 local_50;
...
/* PluginConfigDialog::_on_canceled() */void PluginConfigDialog::_on_canceled(PluginConfigDialog *this) {
   _clear_fields(this);
   return;
}
/* PluginConfigDialog::_to_absolute_plugin_path(String const&) */String *PluginConfigDialog::_to_absolute_plugin_path(String *param_1) {
   long in_FS_OFFSET;
   undefined8 local_50;
   char *local_48;
   undefined8 local_40;
...
/* PluginConfigDialog::_get_subfolder() */PluginConfigDialog * __thiscall PluginConfigDialog::_get_subfolder(PluginConfigDialog *this){
   long in_FS_OFFSET;
   long local_48;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* PluginConfigDialog::PluginConfigDialog() */void PluginConfigDialog::PluginConfigDialog(PluginConfigDialog *this) {
   uint uVar1;
   undefined8 uVar2;
   String *pSVar3;
   Vector2 *pVVar4;
   ...
   *(LineEdit**)( this + 0xdb8 ) = pLVar8;
   ...
   String::parse_latin1((String*)local_58, "");
   local_68[0] = 0;
   String::parse_latin1((String*)local_68, "Required. This name will be displayed in the list of plugins.");
   TTR(local_70, (String*)local_68);
   ...
   *(LineEdit**)( this + 0xdc0 ) = pLVar8;
   ...
   String::parse_latin1((String*)local_58, "");
   local_68[0] = 0;
   String::parse_latin1((String*)local_68, "Optional. The folder name should generally use `snake_case` naming (avoid spaces and special characters).\nIf left empty, the folder will be named after the plugin name converted to `snake_case`.");
   TTR(local_70, (String*)local_68);
   Control::set_tooltip_text(pSVar3);
   CowData<char32_t>::_unref((CowData<char32_t>*)local_70);
   CowData<char32_t>::_unref((CowData<char32_t>*)local_68);
   ...
   *(TextEdit**)( this + 0xdc8 ) = this_02;
   ...
   String::parse_latin1((String*)local_58, "");
   local_68[0] = 0;
   String::parse_latin1((String*)local_68, "Optional. This description should be kept relatively short (up to 5 lines).\nIt will display when hovering the plugin in the list of plugins.");
   TTR(local_70, (String*)local_68);
   Control::set_tooltip_text(pSVar3);
   CowData<char32_t>::_unref((CowData<char32_t>*)local_70);
   CowData<char32_t>::_unref((CowData<char32_t>*)local_68);
   ...
   *(LineEdit**)( this + 0xdd0 ) = pLVar8;
   ...
   String::parse_latin1((String*)local_58, "");
   local_68[0] = 0;
   String::parse_latin1((String*)local_68, "Optional. The author\'s username, full name, or organization name.");
   TTR(local_70, (String*)local_68);
   Control::set_tooltip_text(pSVar3);
   CowData<char32_t>::_unref((CowData<char32_t>*)local_70);
   CowData<char32_t>::_unref((CowData<char32_t>*)local_68);
   ...
   *(LineEdit**)( this + 0xdd8 ) = pLVar8;
   ...
   String::parse_latin1((String*)local_58, "");
   local_68[0] = 0;
   String::parse_latin1((String*)local_68, "Optional. A human-readable version identifier used for informational purposes only.");
   TTR(local_70, (String*)local_68);
   Control::set_tooltip_text(pSVar3);
   CowData<char32_t>::_unref((CowData<char32_t>*)local_70);
   CowData<char32_t>::_unref((CowData<char32_t>*)local_68);
   ...
   *(OptionButton**)( this + 0xde0 ) = this_03;
   ...
   String::parse_latin1((String*)local_58, "");
   local_68[0] = 0;
   String::parse_latin1((String*)local_68, "Required. The scripting language to use for the script.\nNote that a plugin may use several languages at once by adding more scripts to the plugin.");
   TTR(local_70, (String*)local_68);
   Control::set_tooltip_text(pSVar3);
   CowData<char32_t>::_unref((CowData<char32_t>*)local_70);
   CowData<char32_t>::_unref((CowData<char32_t>*)local_68);
 ...
 while ( iVar12 < (int)ScriptServer::_language_count );
   ...
   *(LineEdit**)( this + 0xde8 ) = pLVar8;
   ...
   String::parse_latin1((String*)local_58, "");
   local_68[0] = 0;
   String::parse_latin1((String*)local_68, "Optional. The name of the script file. If left empty, will default to the subfolder name.");
   TTR(local_70, (String*)local_68);
   Control::set_tooltip_text(pSVar3);
   CowData<char32_t>::_unref((CowData<char32_t>*)local_70);
   CowData<char32_t>::_unref((CowData<char32_t>*)local_68);
   ...
   *(CheckBox**)( this + 0xdf0 ) = this_04;
   ...
   if (uVar1 == *(uint*)( this + 0xdfc )) {
      ...
      *(long*)( this + 0xe00 ) = lVar10;
      if (lVar10 == 0) {
         LAB_0010196e:_err_print_error("push_back", "./core/templates/local_vector.h", 0x41, "FATAL: Condition \"!data\" is true.", "Out of memory", 0, 0);
         _err_flush_stdout();
   ...
   *(EditorValidationPanel**)( this + 0xe08 ) = this_06;
   ...
   create_custom_callable_function_pointer<PluginConfigDialog>((PluginConfigDialog*)local_58, (char*)this, (_func_void*)"&PluginConfigDialog::_on_required_text_changed");
   ...
   create_custom_callable_function_pointer<EditorValidationPanel>((EditorValidationPanel*)local_58, *(char**)( this + 0xe08 ), (_func_void*)"&EditorValidationPanel::update");
...
/* PluginConfigDialog::config(String const&) */void PluginConfigDialog::config(PluginConfigDialog *this, String *param_1) {
   undefined8 *puVar1;
   undefined8 uVar2;
   String *pSVar3;
   char cVar4;
   ...
   if (( *(long*)param_1 == 0 ) || ( *(uint*)( *(long*)param_1 + -8 ) < 2 )) {
      ...
      LAB_00101a6e:puVar7 = *(undefined8**)( this + 0xe00 );
      ...
      *(undefined1(*) [16])( this_00 + 0x198 ) = (undefined1[16])0x0;
      ...
      String::parse_latin1((String*)&local_88, "\'.");
      operator+((char *)&
      local_90,(String*)"Cannot load config file from path \'";
      String::operator +(local_80, (String*)&local_90);
      _err_print_error("config", "editor/plugins/plugin_config_dialog.cpp", 0xad, "Condition \"err != OK\" is true.", local_80, 0);
      CowData<char32_t>::_unref((CowData<char32_t>*)local_80);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_90);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);
      cVar4 = RefCounted::unreference();
   ...
   LAB_0010221a:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* PluginConfigDialog::_on_required_text_changed() */void PluginConfigDialog::_on_required_text_changed(PluginConfigDialog *this) {
   undefined8 uVar1;
   char cVar2;
   int iVar3;
   long *plVar4;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   LineEdit::get_text();
   if (( local_48 == 0 ) || ( iVar3 = iVar3 == 0 )) {
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_48);
      LAB_001022c8:uVar1 = *(undefined8*)( this + 0xe08 );
      local_50 = 0;
   ...
   if (cVar2 == '\0') {
      ...
      operator+((char *)&
      local_60,(String*)"res://addons/";
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_48);
      if (( this[0xe10] == (PluginConfigDialog)0x0 ) && ( cVar2 = DirAccess::exists((String*)&local_60) ),cVar2 != '\0') {
         uVar1 = *(undefined8*)( this + 0xe08 );
         local_50 = 0;
         String::parse_latin1((String*)&local_50, "");
         local_58 = 0;
   ...
   LAB_001023ca:iVar3 = OptionButton::get_selected();
   ...
   if (plVar4 != (long*)0x0) {
      ...
      if (cVar2 != '\0') {
         ...
         local_68 = 0;
         String::parse_latin1((String*)&local_68, "Script extension must match chosen language extension (.%s).");
      ...
      if (cVar2 != '\0') {
         ...
         if (cVar2 == '\0') {
            ...
            String::parse_latin1((String*)&local_50, "");
            local_58 = 0;
            String::parse_latin1((String*)&local_58, "C# doesn\'t support activating the plugin on creation because the project must be built first.");
            TTR((String*)&local_48, (String*)&local_58);
...
/* PluginConfigDialog::_bind_methods() */void PluginConfigDialog::_bind_methods(void) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   int *piVar4;
   ...
   PropertyInfo::PropertyInfo((PropertyInfo*)local_118, 4, (StrRange*)&local_168, 0, (StrRange*)&local_160, 6, &local_158);
   local_b8 = "";
   local_170 = 0;
   local_178 = 0;
   local_b0 = 0;
   ...
   PropertyInfo::PropertyInfo(local_148, 4, (StrRange*)&local_180, 0, (StrRange*)&local_178, 6, &local_170);
   local_150 = 0;
...
/* PluginConfigDialog::_create_script_for_plugin(String const&, Ref<ConfigFile>, int) */void PluginConfigDialog::_create_script_for_plugin(PluginConfigDialog *this, undefined8 param_2, undefined8 *param_3, int param_4) {
   Variant *pVVar1;
   String *pSVar2;
   code *pcVar3;
   char cVar4;
   ...
   if (plVar6 == (long*)0x0) {
      if (local_40[0] == *(long*)( in_FS_OFFSET + 0x28 )) {
         _err_print_error("_create_script_for_plugin", "editor/plugins/plugin_config_dialog.cpp", 0x51, "Condition \"language == nullptr\" is true.", 0, 0);
         return;
      }
      ...
      if (this[0xe10] == (PluginConfigDialog)0x0) {
         ...
         if (cVar4 == '\0') {
            ...
            if (local_b0 != 0) {
               if (*(long*)( local_b0 + -8 ) < 1) {
                  _err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, 0, *(long*)( local_b0 + -8 ), "p_index", "size()", "", false, true);
                  _err_flush_stdout();
                  /* WARNING: Does not return */
                  pcVar3 = (code*)invalidInstructionException();
                  ( *pcVar3 )();
        ...
        if (local_d0 != (Object *)0x0) {
          cVar4 = RefCounted::unreference();
          pOVar7 = local_d0;
          if (cVar4 != '\0'){cVar4 = predelete_handler(local_d0);
            if (cVar4 != '\0') {
              (**(code **)(*(long *)pOVar7 + 0x140))(pOVar7);Memory::free_static(pOVar7, false);}}((CowData<ScriptLanguage::ScriptTemplate>*)&local_b0));CowData<char32_t>::_unref((CowData<char32_t>*)&local_d8) ;;
...
/* PluginConfigDialog::_on_confirmed() */void PluginConfigDialog::_on_confirmed(PluginConfigDialog *this) {
   String *pSVar1;
   char cVar2;
   int iVar3;
   undefined4 uVar4;
   ...
   *(undefined1(*) [16])( this_00 + 0x198 ) = (undefined1[16])0x0;
   ...
   LAB_00103720:CowData<char32_t>::_unref(local_78);
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* RefCounted::is_class_ptr(void*) const */uint RefCounted::is_class_ptr(RefCounted *this, void *param_1) {
   return (uint)CONCAT71(0x10c0, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10c0, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr);
}
...
/* ConfirmationDialog::is_class_ptr(void*) const */uint ConfirmationDialog::is_class_ptr(void *param_1) {
   undefined4 in_EDX;
   undefined4 *in_RSI;
   return (uint)CONCAT71(0x10c0, in_RSI == &AcceptDialog::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10bf, in_RSI == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10c0, in_RSI == &Window::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10c0, in_RSI == &Viewport::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10c0, in_RSI == &Node::get_class_ptr_static(), ::ptr) | CONCAT31(( int3 )((uint)in_EDX >> 8), in_RSI == &Object::get_class_ptr_static(), ::ptr);
}
...
/* PluginConfigDialog::_property_can_revertv(StringName const&) const */undefined8 PluginConfigDialog::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* PluginConfigDialog::_property_get_revertv(StringName const&, Variant&) const */undefined8 PluginConfigDialog::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* ConfigFile::is_class_ptr(void*) const */uint ConfigFile::is_class_ptr(ConfigFile *this, void *param_1) {
   return (uint)CONCAT71(0x10c0, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10bf, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10c0, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
...
/* CallableCustomMethodPointer<PluginConfigDialog, void>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<PluginConfigDialog,void>::~CallableCustomMethodPointer(CallableCustomMethodPointer<PluginConfigDialog,void> *this) {
   return;
}
...
/* CallableCustomMethodPointer<PluginConfigDialog, void>::get_argument_count(bool&) const */undefined8 CallableCustomMethodPointer<PluginConfigDialog,void>::get_argument_count(CallableCustomMethodPointer<PluginConfigDialog,void> *this, bool *param_1) {
   *param_1 = true;
   return 0;
}
/* CallableCustomMethodPointer<PluginConfigDialog, void>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<PluginConfigDialog,void>::~CallableCustomMethodPointer(CallableCustomMethodPointer<PluginConfigDialog,void> *this) {
...
/* PluginConfigDialog::_getv(StringName const&, Variant&) const */undefined8 PluginConfigDialog::_getv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
   if ((code*)PTR__get_0010f010 != Object::_get) {
      uVar1 = Window::_get(param_1, param_2);
      return uVar1;
...
/* PluginConfigDialog::_setv(StringName const&, Variant const&) */undefined8 PluginConfigDialog::_setv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
   if ((code*)PTR__set_0010f018 != Object::_set) {
      uVar1 = Window::_set(param_1, param_2);
      return uVar1;
...
;
   ...
   uVar2 = 0;
   LAB_001042cd:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* CallableCustomMethodPointer<PluginConfigDialog, void>::get_object() const */undefined8 CallableCustomMethodPointer<PluginConfigDialog,void>::get_object(CallableCustomMethodPointer<PluginConfigDialog,void> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   uVar2 = 0;
   LAB_001043cd:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* PluginConfigDialog::_validate_propertyv(PropertyInfo&) const */void PluginConfigDialog::_validate_propertyv(PropertyInfo *param_1) {
...
/* WARNING: Removing unreachable block (ram,0x00104698) *//* VBoxContainer::_getv(StringName const&, Variant&) const */undefined8 VBoxContainer::_getv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
   if (( (code*)PTR__get_0010f038 != CanvasItem::_get ) && ( uVar1 = Control::_get(param_1, param_2) ),(char)uVar1 != '\0') {
      return uVar1;
   }
...
/* VBoxContainer::is_class_ptr(void*) const */uint VBoxContainer::is_class_ptr(void *param_1) {
   ...
   if (in_RSI != &get_class_ptr_static()::ptr) {
      uVar1 = (uint)CONCAT71(0x10c0, in_RSI == &Container::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10c0, in_RSI == &BoxContainer::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10c0, in_RSI == &Control::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10c0, in_RSI == &CanvasItem::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10c0, in_RSI == &Node::get_class_ptr_static(), ::ptr) | CONCAT31(( int3 )((uint)in_EDX >> 8), in_RSI == &Object::get_class_ptr_static(), ::ptr);
   }
...
/* PluginConfigDialog::_notificationv(int, bool) */void PluginConfigDialog::_notificationv(PluginConfigDialog *this, int param_1, bool param_2) {
   if (param_2) {
...
/* PluginConfigDialog::is_class_ptr(void*) const */uint PluginConfigDialog::is_class_ptr(void *param_1) {
   uint uVar1;
   undefined4 in_EDX;
   undefined4 *in_RSI;
   uVar1 = 1;
   if (in_RSI != &get_class_ptr_static()::ptr) {
      uVar1 = (uint)CONCAT71(0x10c0, in_RSI == &AcceptDialog::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10bf, in_RSI == &ConfirmationDialog::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10c0, in_RSI == &Window::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10c0, in_RSI == &Viewport::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10c0, in_RSI == &Node::get_class_ptr_static(), ::ptr) | CONCAT31(( int3 )((uint)in_EDX >> 8), in_RSI == &Object::get_class_ptr_static(), ::ptr);
   }
...
/* VBoxContainer::~VBoxContainer() */void VBoxContainer::~VBoxContainer(VBoxContainer *this) {
   ...
   *(code**)this = __cxa_guard_acquire;
   ...
   LAB_00104a60:Control::~Control((Control*)this);
   return;
}
/* VBoxContainer::~VBoxContainer() */void VBoxContainer::~VBoxContainer(VBoxContainer *this) {
   bool bVar1;
   ...
   *(code**)this = __cxa_guard_acquire;
   ...
   LAB_00104ac0:Control::~Control((Control*)this);
...
/* VBoxContainer::_get_class_namev() const */undefined8 *VBoxContainer::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00104b23:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00104b23;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "VBoxContainer");
   LAB_00104b8e:return &_get_class_namev();
}
/* PluginConfigDialog::_get_class_namev() const */undefined8 *PluginConfigDialog::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00104c13:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00104c13;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "PluginConfigDialog");
         goto LAB_00104c7e;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "PluginConfigDialog");
   LAB_00104c7e:return &_get_class_namev();
}
...
/* ConfirmationDialog::_get_class_namev() const */undefined8 *ConfirmationDialog::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00104de3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00104de3;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "ConfirmationDialog");
   LAB_00104e4e:return &_get_class_namev();
}
/* RefCounted::_get_class_namev() const */undefined8 *RefCounted::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00104ec3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00104ec3;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "RefCounted");
   LAB_00104f2e:return &_get_class_namev();
}
...
/* Callable create_custom_callable_function_pointer<PluginConfigDialog>(PluginConfigDialog*, char
   const*, void (PluginConfigDialog::*)()) */PluginConfigDialog *create_custom_callable_function_pointer<PluginConfigDialog>(PluginConfigDialog *param_1, char *param_2, _func_void *param_3) {
   undefined8 uVar1;
   CallableCustom *this;
   undefined8 in_RCX;
   undefined8 in_R8;
...
/* WARNING: Removing unreachable block (ram,0x00105e38) *//* String vformat<String>(String const&, String const) */undefined8 *vformat<String>(undefined8 *param_1, bool *param_2, String *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* PluginConfigDialog::get_class() const */void PluginConfigDialog::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
;
      ...
      *(undefined4*)( param_4 + 8 ) = 0;
      ...
      _err_print_error("get_instance", "./core/object/object.h", 0x418, "Condition \"slot >= slot_max\" is true. Returning: nullptr", 0, 0);
      LAB_0010670f:local_40 = 0;
      String::parse_latin1((String*)&local_40, "\', can\'t call method.");
      uitos((ulong)local_50);
      operator+((char *)
      local_48,(String*)"Invalid Object id \'";
      String::operator +(local_38, (String*)local_48);
      _err_print_error(&_LC82, "./core/object/callable_method_pointer.h", 0x67, "Parameter \"ObjectDB::get_instance(ObjectID(data.object_id))\" is null.", local_38, 0, 0);
   ...
   LAB_001067c0:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* CallableCustomMethodPointer<PluginConfigDialog, void>::call(Variant const**, int, Variant&,
   Callable::CallError&) const */void CallableCustomMethodPointer<PluginConfigDialog,void>::call(CallableCustomMethodPointer<PluginConfigDialog,void> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long lVar1;
   long lVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   LAB_001069d0:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
         ...
         if (Container::initialize_class() == '\0') {
            if (Control::initialize_class() == '\0') {
               if (CanvasItem::initialize_class() == '\0') {
                  ...
                  if ((code*)PTR__bind_compatibility_methods_0010f078 != Object::_bind_compatibility_methods) {
...
/* Node::is_class(String const&) const */undefined8 Node::is_class(Node *this, String *param_1) {
   ...
   if (cVar5 == '\0') {
      ...
      LAB_0010773b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* Window::is_class(String const&) const */undefined8 Window::is_class(Window *this, String *param_1) {
   ...
   LAB_0010793b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_00107a3e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* ConfirmationDialog::is_class(String const&) const */undefined8 ConfirmationDialog::is_class(ConfirmationDialog *this, String *param_1) {
   ...
   LAB_00107b4b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_00107c4e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* PluginConfigDialog::is_class(String const&) const */undefined8 PluginConfigDialog::is_class(PluginConfigDialog *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *__s;
   long lVar3;
   ...
   if (cVar4 == '\0') {
      ...
      LAB_00107d5b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* Container::is_class(String const&) const */undefined8 Container::is_class(Container *this, String *param_1) {
   ...
   LAB_00107e83:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0010801e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* VBoxContainer::is_class(String const&) const */undefined8 VBoxContainer::is_class(VBoxContainer *this, String *param_1) {
   ...
   LAB_0010822e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* RefCounted::is_class(String const&) const */undefined8 RefCounted::is_class(RefCounted *this, String *param_1) {
   ...
   if (cVar5 == '\0') {
      ...
      LAB_0010833b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* ConfigFile::is_class(String const&) const */undefined8 ConfigFile::is_class(ConfigFile *this, String *param_1) {
   ...
   if (cVar4 == '\0') {
      ...
      LAB_0010853b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* PropertyListHelper::~PropertyListHelper() */void PropertyListHelper::~PropertyListHelper(PropertyListHelper *this) {
 ...
 while ( lVar2 != (ulong)uVar1 << 2 );
   ...
   LAB_0010867f:CowData<char32_t>::_unref((CowData<char32_t>*)this);
   return;
}
/* RefCounted::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void RefCounted::_get_property_listv(List *param_1, bool param_2) {
   ...
   LAB_0010883c:List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)CONCAT71(in_register_00000031, param_2), (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
   }
...
/* Node::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Node::_get_property_listv(List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00108a8c:List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)CONCAT71(in_register_00000031, param_2), (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
   }
...
/* ConfigFile::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void ConfigFile::_get_property_listv(ConfigFile *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00108ec1:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
...
/* PluginConfigDialog::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void PluginConfigDialog::_get_property_listv(PluginConfigDialog *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   CowData<char32_t> *local_b0;
   long local_98;
   long local_90;
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00109701:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* Container::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Container::_get_property_listv(Container *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00109d91:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* BoxContainer::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void BoxContainer::_get_property_listv(BoxContainer *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_0010a041:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* VBoxContainer::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void VBoxContainer::_get_property_listv(VBoxContainer *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_0010a2f1:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* PluginConfigDialog::_bind_methods() [clone .cold] */void PluginConfigDialog::_bind_methods(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* PluginConfigDialog::_initialize_classv() */void PluginConfigDialog::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_60;
   long local_58;
   undefined8 local_50;
...
/* void memdelete<HashMapElement<String, HashMap<String, Variant, HashMapHasherDefault,
 ...
 while ( lVar2 != (ulong)uVar1 << 2 );
   ...
   LAB_0010ad1f:CowData<char32_t>::_unref((CowData<char32_t>*)( param_1 + 0x10 ));
...
/* ConfigFile::~ConfigFile() */void ConfigFile::~ConfigFile(ConfigFile *this) {
 ...
 while ( lVar2 != (ulong)uVar1 << 2 );
   ...
   LAB_0010ae21:*(undefined***)this = &PTR__initialize_classv_0010b268;
   Object::~Object((Object*)this);
   return;
}
/* ConfigFile::~ConfigFile() */void ConfigFile::~ConfigFile(ConfigFile *this) {
 ...
 while ( lVar2 != (ulong)uVar1 << 2 );
   ...
   LAB_0010af11:*(undefined***)this = &PTR__initialize_classv_0010b268;
   Object::~Object((Object*)this);
   operator_delete(this, 0x1b0);
   return;
}
/* PluginConfigDialog::_clear_fields() */void PluginConfigDialog::_GLOBAL__sub_I__clear_fields(void) {
   undefined8 uStack_8;
...
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<PluginConfigDialog, void>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<PluginConfigDialog,void>::~CallableCustomMethodPointer(CallableCustomMethodPointer<PluginConfigDialog,void> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

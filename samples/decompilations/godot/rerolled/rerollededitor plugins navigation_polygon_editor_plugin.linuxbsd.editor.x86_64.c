/* NavigationPolygonEditor::_get_node() const */undefined8 NavigationPolygonEditor::_get_node(NavigationPolygonEditor *this) {
   return *(undefined8*)( this + 0xaa8 );
}
/* NavigationPolygonEditor::_get_polygon_count() const */undefined4 NavigationPolygonEditor::_get_polygon_count(void) {
   long lVar1;
   char cVar2;
   undefined4 uVar3;
   long in_FS_OFFSET;
...
/* NavigationPolygonEditor::NavigationPolygonEditor() */void NavigationPolygonEditor::NavigationPolygonEditor(NavigationPolygonEditor *this) {
   String *pSVar1;
   long *plVar2;
   code *pcVar3;
   ...
   *(undefined4*)( this + 0xae0 ) = 0x3fc00000;
   for (int i = 0; i < 3; i++) {
      *(undefined1(*) [16])( this + ( 16*i + 2728 ) ) = (undefined1[16])0;
   }
   ...
   *(Button**)( this + 0xac0 ) = pBVar4;
   ...
   String::parse_latin1((String*)local_68, "");
   local_70 = 0;
   String::parse_latin1((String*)&local_70, "Bakes the NavigationPolygon by first parsing the scene for source geometry and then creating the navigation polygon vertices and polygons.");
   TTR(local_78, (String*)&local_70);
   ...
   create_custom_callable_function_pointer<NavigationPolygonEditor>((NavigationPolygonEditor*)local_68, (char*)this, (_func_void*)"&NavigationPolygonEditor::_bake_pressed");
   ...
   *(Button**)( this + 0xac8 ) = pBVar4;
   ...
   String::parse_latin1((String*)local_68, "");
   local_70 = 0;
   String::parse_latin1((String*)&local_70, "Clears the internal NavigationPolygon outlines, vertices and polygons.");
   TTR(local_78, (String*)&local_70);
   Control::set_tooltip_text(pSVar1);
   CowData<char32_t>::_unref((CowData<char32_t>*)local_78);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_70);
   ...
   pcVar3 = *(code**)( *plVar2 + 0x108 );
   create_custom_callable_function_pointer<NavigationPolygonEditor>((NavigationPolygonEditor*)local_68, (char*)this, (_func_void*)"&NavigationPolygonEditor::_clear_pressed");
   ( *pcVar3 )(plVar2, SceneStringNames::singleton + 0x238, (CowData<char32_t>*)local_68, 0);
   Callable::~Callable((Callable*)local_68);
   ...
   *(float*)( this + 0xae0 ) = fVar5;
   ...
   pcVar3 = *(code**)( *plVar2 + 0x108 );
   create_custom_callable_function_pointer<NavigationPolygonEditor>((NavigationPolygonEditor*)local_68, (char*)this, (_func_void*)"&NavigationPolygonEditor::_rebake_timer_timeout");
...
/* NavigationPolygonEditorPlugin::NavigationPolygonEditorPlugin() */void NavigationPolygonEditorPlugin::NavigationPolygonEditorPlugin(NavigationPolygonEditorPlugin *this) {
   ...
   postinitialize_handler((Object*)this_00);
   AbstractPolygon2DEditorPlugin::AbstractPolygon2DEditorPlugin((AbstractPolygon2DEditorPlugin*)this, (AbstractPolygon2DEditor*)this_00, (String*)&local_40);
...
/* NavigationPolygonEditor::_notification(int) */void __thiscall NavigationPolygonEditor::_notification(NavigationPolygonEditor *this,int param_1)

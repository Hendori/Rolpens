/* is_valid_rename_target(lsp::DocumentSymbol const*) */undefined8 is_valid_rename_target(DocumentSymbol *param_1) {
   long lVar1;
   if (( param_1 != (DocumentSymbol*)0x0 ) && ( ( ( *(long*)( param_1 + 0x18 ) == 0 || ( *(uint*)( *(long*)( param_1 + 0x18 ) + -8 ) < 2 ) ) && ( lVar1 = *(long*)( param_1 + 0x50 ) ),lVar1 != 0 ) )) {
      return CONCAT71(( int7 )((ulong)lVar1 >> 8), 1 < *(uint*)( lVar1 + -8 ));
   }

   return 0;
}
/* GDScriptWorkspace::get_native_symbol(String const&, String const&) const */String * __thiscall
GDScriptWorkspace::get_native_symbol(GDScriptWorkspace *this,String *param_1,String *param_2){
   ...
   if (local_58 != (String*)0x0) {
      LAB_00100099:if (( *(long*)( this + 0x188 ) != 0 ) && ( *(int*)( this + 0x1ac ) != 0 )) {
         ...
         if (uVar16 != 0) {
            ...
            do {
               if (uVar12 == uVar16) {
                  if (*(String**)( *(long*)( *(long*)( this + 0x188 ) + lVar14 * 8 ) + 0x10 ) == local_58) {
                     ...
                     if (lVar2 != 0) {
                        ...
                        if (( *(long*)param_2 == 0 ) || ( *(uint*)( *(long*)param_2 + -8 ) < 2 )) goto LAB_00100230;
               ...
               if (( uVar16 == 0 ) || ( auVar5._8_8_ = 0 ),auVar5._0_8_ = (ulong)uVar16 * lVar2,auVar9._8_8_ = 0,auVar9._0_8_ = uVar18,auVar6._8_8_ = 0,auVar6._0_8_ = ( ulong )(( uVar1 + uVar13 ) - SUB164(auVar5 * auVar9, 8)) * lVar2,auVar10._8_8_ = 0,auVar10._0_8_ = uVar18,SUB164(auVar6 * auVar10, 8) < uVar17) break;
            }
 while ( true );
         }
   ...
   LAB_0010024b:if (StringName::configured == '\0') goto LAB_00100267;
   LAB_00100256:if (local_58 != (String*)0x0) {
      StringName::unref();
   }

   LAB_00100267:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return this_00;
   }
   ...
   while (true) {
      ...
      lVar15 = lVar15 + 0x68;
      if (lVar14 == 0) break;
      LAB_001001c0:if (*(long*)( lVar14 + -8 ) <= lVar19) break;
   }
;
   LAB_001001f0:ClassDB::get_parent_class((StringName*)&local_48);
   ...
   goto LAB_00100099;
   code_r0x0010022c:this_00 = (String*)0x0;
   LAB_00100230:if (StringName::configured == '\0') goto LAB_00100267;
...
/* GDScriptWorkspace::get_script_symbol(String const&) const */long GDScriptWorkspace::get_script_symbol(GDScriptWorkspace *this, String *param_1) {
   uint uVar1;
   long lVar2;
   undefined1 auVar3[16];
   undefined1 auVar4[16];
   ...
   if (( *(long*)( this + 0x1c8 ) != 0 ) && ( *(int*)( this + 0x1ec ) != 0 )) {
      ...
      if (uVar12 != 0) {
         ...
         while (true) {
            if (uVar13 == uVar12) {
               cVar11 = String::operator ==((String*)( *(long*)( *(long*)( this + 0x1c8 ) + lVar15 * 8 ) + 0x10 ), param_1);
               if (cVar11 != '\0') {
...
/* GDScriptWorkspace::get_parameter_symbol(lsp::DocumentSymbol const*, String const&) */String * __thiscall
...
GDScriptWorkspace::get_local_symbol_at
   ...
   while (true) {
      ...
      if (( ( ( ( ( cVar2 != '\0' ) && ( pSVar5 = this * (int*)( this + 0x38 ) <= iVar3 ) ) && ( iVar3 <= *(int*)( this + 0x40 ) ) ) && ( ( iVar3 != *(int*)( this + 0x38 ) || ( *(int*)( this + 0x3c ) <= iVar4 ) ) ) ) && ( ( iVar3 != *(int*)( this + 0x40 ) || ( iVar4 <= *(int*)( this + 0x44 ) ) ) ) ) || ( ( this = *(String**)( this + 0x60 ) ),this == (String*)0x0 || ( pSVar1 = this + *(long*)( this + -8 ) * 0x68 ),pSVar1 == this )) break;
      while (( ( iVar3 < *(int*)( this + 0x28 ) || ( ( *(int*)( this + 0x30 ) < iVar3 || ( ( iVar3 == *(int*)( this + 0x28 ) && ( iVar4 < *(int*)( this + 0x2c ) ) ) ) ) ) ) || ( ( iVar3 == *(int*)( this + 0x30 ) && ( *(int*)( this + 0x34 ) < iVar4 ) ) ) )) {
         this =
         this + 0x68;
         if (pSVar1 == this) {
            return pSVar5;
...
/* GDScriptWorkspace::resolve_native_symbol(lsp::NativeSymbolInspectParams const&) */String * __thiscall
GDScriptWorkspace::resolve_native_symbol(GDScriptWorkspace *this,NativeSymbolInspectParams *param_1){
         ...
         do {
            if (uVar12 == uVar17) {
               if (*(long*)( *(long*)( *(long*)( this + 0x188 ) + lVar14 * 8 ) + 0x10 ) == local_48) {
                  ...
                  if (( *(long*)( param_1 + 8 ) == 0 ) || ( *(uint*)( *(long*)( param_1 + 8 ) + -8 ) < 2 )) goto LAB_00100701;
 ...
 while ( ( uVar17 != 0 ) && ( auVar4._8_8_ = 0 ),auVar4._0_8_ = (ulong)uVar17 * lVar18,auVar8._8_8_ = 0,auVar8._0_8_ = uVar21,auVar5._8_8_ = 0,auVar5._0_8_ = ( ulong )(( uVar1 + uVar13 ) - SUB164(auVar4 * auVar8, 8)) * lVar18,auVar9._8_8_ = 0,auVar9._0_8_ = uVar21,uVar19 <= SUB164(auVar5 * auVar9, 8) );
      }
   ...
   LAB_0010074b:pSVar16 = (String*)0x0;
   goto LAB_00100701;
   while (true) {
      ...
      if (cVar11 != '\0') {
         ...
         _err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar20, lVar18, "p_index", "size()", "", false, true);
         _err_flush_stdout();
      ...
      lVar15 = lVar15 + 0x68;
      if (lVar14 == 0) break;
      LAB_00100788:if (*(long*)( lVar14 + -8 ) <= lVar20) goto LAB_0010074b;
   }
;
   pSVar16 = (String*)0x0;
   LAB_00100701:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return pSVar16;
   }
...
/* GDScriptWorkspace::GDScriptWorkspace() */void GDScriptWorkspace::GDScriptWorkspace(GDScriptWorkspace *this) {
   undefined8 uVar1;
   long in_FS_OFFSET;
...
/* GDScriptWorkspace::get_file_uri(String const&) const */String *GDScriptWorkspace::get_file_uri(String *param_1) {
   undefined *puVar1;
   CowData *in_RDX;
   long in_RSI;
   long in_FS_OFFSET;
...
/* GDScriptWorkspace::get_file_path(String const&) const */String *GDScriptWorkspace::get_file_path(String *param_1) {
   undefined *puVar1;
   long in_FS_OFFSET;
...
/* GDScriptWorkspace::list_script_files(String const&, List<String, DefaultAllocator>&) */void GDScriptWorkspace::list_script_files(GDScriptWorkspace *this, String *param_1, List *param_2) {
   code *pcVar1;
   long *plVar2;
   long lVar3;
   Object *pOVar4;
   ...
   if (local_6c == 0) {
      ...
      while (( local_60 != (char*)0x0 && ( 1 < *(uint*)( local_60 + -8 ) ) )) {
         ...
         if (( cVar5 == '\0' ) || ( ( ( cVar5 = String::operator !=((String*)&local_60, ".") ),cVar5 == '\0' || ( cVar5 = String::operator !=((String*)&local_60, "..") ),cVar5 == '\0' ) ) || ( cVar5 = String::operator !=((String*)&local_60, "./") ),cVar5 == '\0') {
...
;
      ...
      LAB_00100d02:if (local_68 == (Object*)0x0) goto LAB_00100d19;
      cVar5 = RefCounted::unreference();
      pOVar4 = local_68;
   }
   ...
   LAB_00100d19:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* GDScriptWorkspace::publish_diagnostics(String const&) */void GDScriptWorkspace::publish_diagnostics(GDScriptWorkspace *this, String *param_1) {
   long lVar1;
   String *pSVar2;
   char cVar3;
   Variant *pVVar4;
   ...
   cVar3 = HashMap<String,ExtendGDScriptParser*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ExtendGDScriptParser*>>>::_lookup_pos((HashMap<String,ExtendGDScriptParser*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ExtendGDScriptParser*>>>*)( this + 0x1f0 ), param_1, (uint*)&local_88);
   if (( cVar3 != '\0' ) && ( lVar1 = *(long*)( *(long*)( this + 0x1f8 ) + ( (ulong)local_88 & 0xffffffff ) * 8 ) ),lVar1 != 0) {
...
/* HashMap<String, ExtendGDScriptParser*, HashMapHasherDefault, HashMapComparatorDefault<String>,
   ...
   [clone .isra.0] */void HashMap<String,ExtendGDScriptParser*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ExtendGDScriptParser*>>>::erase(HashMap<String,ExtendGDScriptParser*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ExtendGDScriptParser*>>> *this, String *param_1) {
   uint *puVar1;
   uint *puVar2;
   undefined8 *puVar3;
   undefined8 *puVar4;
...
;
   ...
   *(undefined4*)( lVar8 + uVar30 * 4 ) = 0;
   ...
   if (*(long**)( this + 0x18 ) == plVar31) {
      *(long*)( this + 0x18 ) = *plVar31;
      ...
      LAB_00101600:*(long*)( this + 0x20 ) = plVar31[1];
      plVar31 = (long*)*plVar5;
      plVar12 = (long*)plVar31[1];
   }
 else {
      if (*(long**)( this + 0x20 ) == plVar31) goto LAB_00101600;
      LAB_0010158e:plVar12 = (long*)plVar31[1];
   }
   ...
   *(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + -1;
   LAB_001015d7:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* GDScriptWorkspace::_get_owners(EditorFileSystemDirectory*, String, List<String,
   DefaultAllocator>&) [clone .part.0] */void GDScriptWorkspace::_get_owners(GDScriptWorkspace *this, int param_2, CowData *param_3, long *param_4) {
   long *plVar1;
   long lVar2;
   char cVar3;
   int iVar4;
...
/* GDScriptWorkspace::_get_owners(EditorFileSystemDirectory*, String, List<String,
   DefaultAllocator>&) */void GDScriptWorkspace::_get_owners(undefined8 param_1, long param_2) {
   if (param_2 != 0) {
      _get_owners();
      return;
   }
...
/* GDScriptWorkspace::_get_owner_scene_node(String) */undefined8 GDScriptWorkspace::_get_owner_scene_node(GDScriptWorkspace *this, CowData *param_2) {
   long *plVar1;
   undefined *puVar2;
   char cVar3;
   long lVar4;
 ...
 while ( pSVar7 != (String*)0x0 );
   ...
   uVar6 = 0;
   LAB_00101a72:List<String,DefaultAllocator>::~List(local_80);
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* GDScriptWorkspace::_bind_methods() */void GDScriptWorkspace::_bind_methods(void) {
   MethodBind *pMVar1;
   uint uVar2;
   long in_FS_OFFSET;
   long local_98[2];
...
/* CowData<DocData::MethodDoc>::_ref(CowData<DocData::MethodDoc> const&) [clone .part.0] [clone
   .constprop.0] */void CowData<DocData::MethodDoc>::_ref(CowData<DocData::MethodDoc> *this, CowData *param_1) {
   long *plVar1;
   long lVar2;
   long lVar3;
   bool bVar4;
...
/* CowData<lsp::TextEdit>::_ref(CowData<lsp::TextEdit> const&) [clone .part.0] */void CowData<lsp::TextEdit>::_ref(CowData<lsp::TextEdit> *this, CowData *param_1) {
   long *plVar1;
   long lVar2;
   long lVar3;
   bool bVar4;
...
/* CowData<lsp::TextEdit>::_copy_on_write() [clone .isra.0] */void CowData<lsp::TextEdit>::_copy_on_write(CowData<lsp::TextEdit> *this) {
   long lVar1;
   long lVar2;
   code *pcVar3;
   undefined8 uVar4;
...
/* GDScriptWorkspace::remove_cache_parser(String const&) */void GDScriptWorkspace::remove_cache_parser(GDScriptWorkspace *this, String *param_1) {
   long lVar1;
   ExtendGDScriptParser *pEVar2;
   char cVar3;
   long lVar4;
   ulong uVar5;
   HashMap<String,ExtendGDScriptParser*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ExtendGDScriptParser*>>> *this_00;
   long in_FS_OFFSET;
   uint local_44;
   long local_40;
   this_00 = (HashMap<String,ExtendGDScriptParser*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ExtendGDScriptParser*>>>*)( this + 0x1f0 );
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   local_44 = 0;
   cVar3 = HashMap<String,ExtendGDScriptParser*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ExtendGDScriptParser*>>>::_lookup_pos(this_00, param_1, &local_44);
   if (cVar3 == '\0') {
      local_44 = 0;
      cVar3 = HashMap<String,ExtendGDScriptParser*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ExtendGDScriptParser*>>>::_lookup_pos((HashMap<String,ExtendGDScriptParser*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ExtendGDScriptParser*>>>*)( this + 0x1c0 ), param_1, &local_44);
      if (cVar3 != '\0') {
         lVar4 = *(long*)( *(long*)( this + 0x1c8 ) + (ulong)local_44 * 8 );
         LAB_00102454:if (lVar4 != 0) {
      ...
      if (cVar3 != '\0') {
         ...
         if (( pEVar2 == (ExtendGDScriptParser*)0x0 ) || ( pEVar2 != *(ExtendGDScriptParser**)( lVar1 + 0x18 ) )) {
         ...
         HashMap<String,ExtendGDScriptParser*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ExtendGDScriptParser*>>>::erase(this_00, param_1);
         if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) goto LAB_00102476;
         LAB_001024d5:this_00 = (HashMap<String,ExtendGDScriptParser*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ExtendGDScriptParser*>>>*)( this + 0x1c0 );
         LAB_00102407:HashMap<String,ExtendGDScriptParser*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ExtendGDScriptParser*>>>::erase(this_00, param_1);
         return;
      }

      if (lVar1 != 0) {
         LAB_001023e8:memdelete<ExtendGDScriptParser>(*(ExtendGDScriptParser**)( lVar1 + 0x18 ));
   ...
   LAB_00102476:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* GDScriptWorkspace::parse_script(String const&, String const&) */int GDScriptWorkspace::parse_script(GDScriptWorkspace *this, String *param_1, String *param_2) {
   HashMap<String,ExtendGDScriptParser*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ExtendGDScriptParser*>>> *this_00;
   long lVar1;
   undefined8 uVar2;
   char cVar3;
   ...
   *(undefined1(*) [16])( this_01 + 0xb08 ) = (undefined1[16])0x0;
   ...
   if (cVar3 == '\0') {
      if (iVar4 == 0) {
         LAB_001026e0:remove_cache_parser(this, param_1);
         puVar5 = (undefined8*)HashMap<String,ExtendGDScriptParser*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ExtendGDScriptParser*>>>::operator [](this_00, param_1);
         *puVar5 = this_01;
         puVar5 = (undefined8*)HashMap<String,ExtendGDScriptParser*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ExtendGDScriptParser*>>>::operator []((HashMap<String,ExtendGDScriptParser*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ExtendGDScriptParser*>>>*)( this + 0x1c0 ), param_1);
         *puVar5 = this_01;
         goto LAB_00102683;
      }
      ...
      if (( ( lVar1 != 0 ) && ( lVar6 != 0 ) ) && ( *(ExtendGDScriptParser**)( lVar6 + 0x18 ) != *(ExtendGDScriptParser**)( lVar1 + 0x18 ) )) {
   ...
   puVar5 = (undefined8*)HashMap<String,ExtendGDScriptParser*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ExtendGDScriptParser*>>>::operator [](this_00, param_1);
   *puVar5 = this_01;
   LAB_00102683:publish_diagnostics(this, param_1);
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar4;
   }
...
/* GDScriptWorkspace::did_delete_files(Dictionary const&) */void GDScriptWorkspace::did_delete_files(GDScriptWorkspace *this, Dictionary *param_1) {
   long *plVar1;
   long lVar2;
   int iVar3;
   int iVar4;
...
/* GDScriptWorkspace::reload_all_workspace_scripts() */void GDScriptWorkspace::reload_all_workspace_scripts(GDScriptWorkspace *this) {
   long *plVar1;
   uint uVar2;
   long lVar3;
   undefined1 auVar4[16];
            ...
            if (local_74 != 0) {
               if (( *(long*)( this + 0x1f8 ) != 0 ) && ( *(int*)( this + 0x21c ) != 0 )) {
                  ...
                  if (uVar14 != 0) {
                     ...
                     do {
                        if (uVar15 == uVar14) {
                           cVar13 = String::operator ==((String*)( *(long*)( *(long*)( this + 0x1f8 ) + lVar17 * 8 ) + 0x10 ), pSVar20);
                           if (cVar13 != '\0') {
                              lVar3 = *(long*)( *(long*)( this + 0x1f8 ) + (ulong)uVar16 * 8 );
                              operator+((char *)&
                              local_60,(String*)"Failed parse script ";
                              if (lVar3 != 0) {
                                 operator+((char *)&
                                 local_58,(String*)&_LC78;
 ...
 while ( ( uVar14 != 0 ) && ( auVar6._8_8_ = 0 ),auVar6._0_8_ = (ulong)uVar14 * lVar3,auVar10._8_8_ = 0,auVar10._0_8_ = uVar12,auVar7._8_8_ = 0,auVar7._0_8_ = ( ulong )(( uVar2 + uVar16 ) - SUB164(auVar6 * auVar10, 8)) * lVar3,auVar11._8_8_ = 0,auVar11._0_8_ = uVar12,uVar18 <= SUB164(auVar7 * auVar11, 8) );
                  }
               ...
               operator+((char *)&
               local_60,(String*)"Failed parse script ";
               joined_r0x00102c77:if (local_74 != 0) {
                  _err_print_error("reload_all_workspace_scripts", "modules/gdscript/language_server/gdscript_workspace.cpp", 0xe4, "Condition \"err != OK\" is true. Continuing.", (StrRange*)&local_60, 0, 0);
                  CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
                  goto LAB_00102ce5;
               }
            ...
            _err_print_error("reload_all_workspace_scripts", "modules/gdscript/language_server/gdscript_workspace.cpp", 0xdb, "Condition \"err != OK\" is true. Continuing.", 0, 0);
            LAB_00102ce5:CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
         }
...
/* GDScriptWorkspace::parse_local_script(String const&) */int GDScriptWorkspace::parse_local_script(GDScriptWorkspace *this, String *param_1) {
   long *plVar1;
   long lVar2;
   long in_FS_OFFSET;
   int local_3c;
...
/* GDScriptWorkspace::get_parse_successed_script(String const&) */undefined8 GDScriptWorkspace::get_parse_successed_script(GDScriptWorkspace *this, String *param_1) {
   uint uVar1;
   undefined1 auVar2[16];
   undefined1 auVar3[16];
   undefined1 auVar4[16];
   ...
   if (( *(long*)( this + 0x1c8 ) != 0 ) && ( *(int*)( this + 0x1ec ) != 0 )) {
      ...
      if (uVar11 != 0) {
         ...
         do {
            if (uVar14 == uVar11) {
               cVar10 = String::operator ==((String*)( *(long*)( *(long*)( this + 0x1c8 ) + lVar16 * 8 ) + 0x10 ), param_1);
               if (cVar10 != '\0') {
            ...
            if (( uVar11 == 0 ) || ( auVar4._8_8_ = 0 ),auVar4._0_8_ = (ulong)uVar11 * lVar13,auVar8._8_8_ = 0,auVar8._0_8_ = uVar18,auVar5._8_8_ = 0,auVar5._0_8_ = ( ulong )(( uVar1 + uVar15 ) - SUB164(auVar4 * auVar8, 8)) * lVar13,auVar9._8_8_ = 0,auVar9._0_8_ = uVar18,SUB164(auVar5 * auVar9, 8) < uVar19) break;
         }
 while ( true );
      }
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)local_48);
   local_48[0] = 0;
   cVar10 = HashMap<String,ExtendGDScriptParser*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ExtendGDScriptParser*>>>::_lookup_pos((HashMap<String,ExtendGDScriptParser*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ExtendGDScriptParser*>>>*)( this + 0x1c0 ), param_1, local_48);
   if (cVar10 == '\0') {
      uVar12 = 0;
   }
 else {
      ...
      if (lVar13 == 0) {
         ...
         LAB_00102f4b:uVar12 = *(undefined8*)( lVar13 + 0x18 );
      }
...
/* GDScriptWorkspace::resolve_document_links(String const&, List<lsp::DocumentLink,
   DefaultAllocator>&) */void GDScriptWorkspace::resolve_document_links(GDScriptWorkspace *this, String *param_1, List *param_2) {
   undefined8 uVar1;
   long lVar2;
   long *plVar3;
   undefined1(*pauVar4)[16];
   ...
   if (lVar2 != 0) {
      ...
      if (( (long*)*plVar3 != (long*)0x0 ) && ( puVar5 = *(undefined8**)*plVar3 ),puVar5 != (undefined8*)0x0) {
         if (*(long*)param_2 == 0) {
            pauVar4 = (undefined1(*) [16])operator_new(0x18, DefaultAllocator::alloc);
...
;
 ...
 while ( puVar5 != (undefined8*)0x0 );
   ...
   LAB_001030e0:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* GDScriptWorkspace::generate_script_api(String const&) */String *GDScriptWorkspace::generate_script_api(String *param_1) {
   long lVar1;
   String *in_RDX;
...
/* GDScriptWorkspace::get_parse_result(String const&) */undefined8 GDScriptWorkspace::get_parse_result(GDScriptWorkspace *this, String *param_1) {
   uint uVar1;
   undefined1 auVar2[16];
   undefined1 auVar3[16];
   undefined1 auVar4[16];
   ...
   if (( *(long*)( this + 0x1f8 ) != 0 ) && ( *(int*)( this + 0x21c ) != 0 )) {
      ...
      if (uVar11 != 0) {
         ...
         do {
            if (uVar14 == uVar11) {
               cVar10 = String::operator ==((String*)( *(long*)( *(long*)( this + 0x1f8 ) + lVar16 * 8 ) + 0x10 ), param_1);
               if (cVar10 != '\0') {
 ...
 while ( true );
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)local_48);
   local_48[0] = 0;
   cVar10 = HashMap<String,ExtendGDScriptParser*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ExtendGDScriptParser*>>>::_lookup_pos((HashMap<String,ExtendGDScriptParser*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ExtendGDScriptParser*>>>*)( this + 0x1f0 ), param_1, local_48);
   if (cVar10 == '\0') {
      uVar12 = 0;
   }
 else {
      ...
      if (lVar13 == 0) {
         ...
         LAB_0010331b:uVar12 = *(undefined8*)( lVar13 + 0x18 );
      }
...
/* GDScriptWorkspace::completion(lsp::CompletionParams const&,
   List<ScriptLanguage::CodeCompletionOption, DefaultAllocator>*) */void GDScriptWorkspace::completion(GDScriptWorkspace *this, CompletionParams *param_1, List *param_2) {
   char cVar1;
   int iVar2;
   long lVar3;
   Object *pOVar4;
   ...
   if (pOVar4 == (Object*)0x0) {
      ...
      ( **(code**)( *GDScriptLanguage::singleton + 0x220 ) )(GDScriptLanguage::singleton, (CowData<char32_t>*)&local_60, (String*)&local_88, 0, param_2, &local_89, &local_80);
   }
 else {
      ...
      pOVar5 = (Object*)0x0;
      LAB_001034a0:cVar1 = Array::is_empty();
      if (cVar1 == '\0') {
         do {
            Array::pop_back();
            ...
            if (lVar3 == 0) {
               LAB_00103800:cVar1 = Variant::needs_deinit[local_58[0]];
               joined_r0x0010382d:if (cVar1 != '\0') {
                  Variant::_clear_internal();
               }
            ...
            for (iVar8 = 0; iVar2 = Node::get_child_count(SUB81(pOVar5, 0)),iVar8 < iVar2; iVar8 = iVar8 + 1) {
            ...
            if (( ( pOVar6 == (Object*)0x0 ) || ( cVar1 = RefCounted::unreference() ),cVar1 == '\0' )) goto LAB_001034a0;
            ( **(code**)( *(long*)pOVar6 + 0x140 ) )(pOVar6);
            Memory::free_static(pOVar6, false);
 ...
 while ( true );
      ...
      lVar3 = Variant::get_validated_object();
      if (lVar3 == 0) {
         LAB_001036c1:cVar1 = Variant::needs_deinit[local_58[0]];
         joined_r0x0010394b:pOVar5 = pOVar4;
         if (cVar1 != '\0') {
            Variant::_clear_internal();
         }
      ...
      ExtendGDScriptParser::get_text_for_completion((CowData<char32_t>*)&local_60);
      puVar9 = &local_80;
      ( **(code**)( *GDScriptLanguage::singleton + 0x220 ) )(GDScriptLanguage::singleton, (CowData<char32_t>*)&local_60, (String*)&local_88, pOVar5, param_2, &local_89);
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
   Array::~Array(local_78);
   LAB_001037ab:CowData<char32_t>::_unref((CowData<char32_t>*)&local_80);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* GDScriptWorkspace::resolve_symbol(lsp::TextDocumentPositionParams const&, String const&, bool) */String *GDScriptWorkspace::resolve_symbol(TextDocumentPositionParams *param_1, String *param_2, bool param_3) {
   code *pcVar1;
   long *plVar2;
   Object *pOVar3;
   char cVar4;
   ...
   if (*(long*)CONCAT71(in_register_00000011, param_3) != 0) {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_e8, (CowData*)CONCAT71(in_register_00000011, param_3));
   }

   String::split(local_c8, SUB81((CowData<char32_t>*)&local_e8, 0), 0x10e80d);
   uVar7 = local_e8;
   if (( local_c0 != (CowData*)0x0 ) && ( lVar8 = lVar8 != 0 )) {
      if (lVar8 < 1) {
         lVar9 = 0;
         goto LAB_0010403d;
      }
   ...
   if (( uVar7 == 0 ) || ( *(uint*)( uVar7 - 8 ) < 2 )) {
      ...
      uStack_b0 = 0;
      uStack_ac = 0;
      ExtendGDScriptParser::get_identifier_under_position((CowData<char32_t>*)&local_d8, (Range*)pSVar6);
      ...
      LAB_00103b48:StringName::StringName((StringName*)&local_b8, (String*)&local_e8, false);
      ...
      if (cVar4 == '\0') {
         ...
         if (cVar4 != '\0') {
            ...
            if (lVar9 < 0) {
               if (lVar8 != 0) {
                  LAB_001040b0:lVar8 = *(long*)( lVar8 + -8 );
                  goto LAB_0010403d;
               }
            ...
            lVar8 = 0;
            LAB_0010403d:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar9, lVar8, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
         ...
         LAB_00103c69:plVar2 = GDScriptLanguage::singleton;
         ...
         iVar5 = ( *pcVar1 )(plVar2, local_118, (CowData<char32_t>*)&local_e8, (String*)&local_f0, 0, (StringName*)&local_b8);
         CowData<char32_t>::_unref(local_118);
         if (iVar5 == 0) {
            if (local_48 < 0) {
               local_d8 = 0;
               if (( ( ( local_a8 == 0 ) || ( CowData<char32_t>::_ref(local_118, (CowData*)&local_a8),local_d8 == 0 ) ) || ( *(uint*)( local_d8 - 8 ) < 2 ) ) && ( ( cVar4 = String::operator !=((String*)&local_e8, (String*)&uStack_b0) ),cVar4 != '\0' && ( local_d8 != local_e8 ) )) {
                  CowData<char32_t>::_ref(local_118, (CowData*)&local_e8);
               }

               this(String * get_native_symbol((GDScriptWorkspace*)param_1, (String*)&uStack_b0, (String*)local_118));
               CowData<char32_t>::_unref(local_118);
            }
 else {
               local_e0 = 0;
               ...
               if (( lVar8 == 0 ) || ( this = (String*)ExtendGDScriptParser::get_symbol_defined_at_line((int)lVar8, (String*)( ulong )(local_48 - 1)) ),this == (String*)0x0) {
                  this(String * 0x0);
               }
 else if (( *(int*)( this + 0x20 ) == 0xc ) && ( cVar4 = String::operator !=(this, (String*)&local_e8) ),cVar4 != '\0') {
                  this(String * get_parameter_symbol((GDScriptWorkspace*)param_1, (DocumentSymbol*)this, (String*)&local_e8));
               }
            ...
            this(String * get_local_symbol_at((GDScriptWorkspace*)param_1, pSVar6, (CowData<char32_t>*)&local_e8, *(undefined8*)( param_2 + 8 )));
            if (this == (String*)0x0) {
               local_d8 = 0;
         ...
         CowData<char32_t>::_unref(local_118);
         if (( pOStack_58 != (Object*)0x0 ) && ( cVar4 = cVar4 != '\0' )) {
            pOVar3 = pOStack_58;
         ...
         cVar4 = HashMap<String,ExtendGDScriptParser*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ExtendGDScriptParser*>>>::_lookup_pos((HashMap<String,ExtendGDScriptParser*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ExtendGDScriptParser*>>>*)( param_1 + 0x1c0 ), (String*)&local_b8, (uint*)&local_d8);
         if (( cVar4 == '\0' ) || ( lVar8 = *(long*)( *(long*)( param_1 + 0x1c8 ) + ( local_d8 & 0xffffffff ) * 8 ) ),lVar8 == 0) {
            this(String * 0x0);
         }
 else {
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_e8);
   LAB_00103ae8:CowData<char32_t>::_unref((CowData<char32_t>*)&local_f0);
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* GDScriptWorkspace::resolve_related_symbols(lsp::TextDocumentPositionParams const&,
   List<lsp::DocumentSymbol const*, DefaultAllocator>&) */void __thiscall

/* EditorPluginSettings::_create_clicked() */void EditorPluginSettings::_create_clicked(EditorPluginSettings *this) {
   long *plVar1;
...
/* EditorPluginSettings::_plugin_activity_changed() */void EditorPluginSettings::_plugin_activity_changed(void) {
   bool bVar1;
   char cVar2;
   int iVar3;
   long lVar4;
   ...
   if (in_RDI[0xa28] == (StringName)0x0) {
      ...
      if (lVar4 == 0) {
         if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            _err_print_error("_plugin_activity_changed", "editor/plugins/editor_plugin_settings.cpp", 0x8c, "Parameter \"ti\" is null.", 0, 0);
            return;
         }
      ...
      if (cVar2 == '\0') {
         if (_plugin_activity_changed()::{lambda()
         #1
         iVar3 = __cxa_guard_acquire(&_plugin_activity_changed()::, {
               lambda()
               #1
               if (iVar3 != 0) {
                  _scs_create((char *)&_plugin_activity_changed()::{lambda()
                  #1
                  __cxa_atexit(StringName::~StringName, &_plugin_activity_changed()::, {
                        lambda()
                        #1
                        ;;
      ...
      local_58[0] = Control::get_theme_color
                              (in_RDI,(StringName *)
                                      &_plugin_activity_changed()::{lambda()
                        #1
                     }
);
...
, if (local_40 == *(long *)(in_FS_OFFSET + 0x28);
      ...
      LAB_00100475:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }

   /* EditorPluginSettings::_cell_button_pressed(Object*, int, int, MouseButton) */
   void EditorPluginSettings::_cell_button_pressed(EditorPluginSettings *this, long param_1, int param_2, int param_3, int param_5) {
      long lVar1;
      long in_FS_OFFSET;
      Variant local_40[8];
      ...
      long local_20;
      local_20 = *(long*)( in_FS_OFFSET + 0x28 );
      if (( ( ( param_1 != 0 ) && ( param_5 == 1 ) ) && ( lVar1 = __dynamic_cast(param_1, &Object::typeinfo, &TreeItem::typeinfo, 0) ),param_2 == 5 && param_3 == 0 )) {
   ...
   void EditorPluginSettings::EditorPluginSettings(EditorPluginSettings *this) {
      code *pcVar1;
      undefined8 uVar2;
      long *plVar3;
      ...
      *(PluginConfigDialog**)( this + 0xa10 ) = this_00;
      ...
      if (*(char*)( lVar5 + 0xc4 ) != '\0') {
         ...
         *(TextureRect**)( this + 0xa18 ) = this_03;
         ...
         local_60 = 0;
         String::parse_latin1((String_conflict*)&local_60, "Recovery mode is enabled. Enabled plugins will not run while this mode is active.");
      ...
      *(undefined***)pBVar6 = &PTR__initialize_classv_0010b708;
      ...
      create_custom_callable_function_pointer<EditorPluginSettings>((EditorPluginSettings*)&local_58, (char*)this, (_func_void*)"&EditorPluginSettings::_create_clicked");
      ...
      *(Tree**)( this + 0xa20 ) = this_02;
      ...
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
      for (int i = 0; i < 5; i++) {
         Tree::set_column_title_alignment(*(undefined8*)( this + 2592 ), ( i + 1 ), 0);
      }

      Tree::set_column_expand((int)*(undefined8*)( this + 0xa20 ), false);
      for (int i = 0; i < 6; i++) {
         Tree::set_column_expand((int)*(undefined8*)( this + 2592 ), true);
      }

      for (int i = 0; i < 5; i++) {
         Tree::set_column_clip_content((int)*(undefined8*)( this + 2592 ), true);
      }
      ...
      create_custom_callable_function_pointer<EditorPluginSettings>((EditorPluginSettings*)&local_58, (char*)this, (_func_void*)"&EditorPluginSettings::_plugin_activity_changed");
   ...
   void SortArray<String,_DefaultComparator<String>,true>::introsort(long param_1, long param_2, String_conflict *param_3, long param_4) {
      ...
      if (0x10 < lVar12) {
         ...
         if (param_4 != 0) {
            ...
            local_68 = param_2;
            local_60 = param_4;
            LAB_0010132b:local_60 = local_60 + -1;
...
;
 ...
 while ( true );
         ...
         LAB_0010154a:lVar11 = lVar12 + -2 >> 1;
...
;
         ...
         do {
            ...
            if (*(long*)pSVar4 == 0) {
               LAB_001016f8:if (*(long*)pCVar10 != *(long*)pSVar4) {
                  CowData<char32_t>::_ref((CowData<char32_t>*)pSVar4, pCVar10);
               }

               LAB_00101718:local_48 = 0;
 ...
 while ( !bVar13 );
               if (lVar7 == -1) {
                  LAB_00101733:adjust_heap(param_1, 0, lVar12, (CowData<char32_t>*)&local_48, param_3);
               }
 else {
                  local_48 = lVar11;
                  adjust_heap(param_1, 0, lVar12, (CowData<char32_t>*)&local_48, param_3);
 ...
 while ( bVar13 );
      ...
      LAB_0010151f:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Subroutine does not return */
         __stack_chk_fail();
      }

      return;
      LAB_00101480:CowData<char32_t>::_unref((CowData<char32_t>*)&local_48);
 ...
 while ( lVar2 != lVar6 );
   ...
   EditorPluginSettings * EditorPluginSettings::_get_plugins(EditorPluginSettings * this, String_conflict * param_1);
   {
      code *pcVar1;
      long lVar2;
      Object *pOVar3;
      ...
      if (iVar5 == 0) {
         ...
         piVar6 = local_88;
         while (( local_88 != (int*)0x0 && ( lVar2 = *(long*)( local_88 + -2 ) ),piVar6 = local_60,1 < (uint)lVar2 )) {
            if (lVar2 < 1) {
            ...
            if (( *local_88 != 0x2e ) && ( cVar4 = ( **(code**)( *(long*)local_90 + 0x170 ) )(local_90) ),cVar4 != '\0') {
...
;
      ...
      if (( ( local_90 != (Object*)0x0 ) && ( cVar4 = RefCounted::unreference() ),cVar4 != '\0' )) &&( cVar4 = cVar4 != '\0' )(**(code**)( *(long*)local_90 + 0x140 ))(local_90);
...
/* EditorPluginSettings::update_plugins() */void EditorPluginSettings::update_plugins(EditorPluginSettings *this) {
   CowData *pCVar1;
   long *plVar2;
   long lVar3;
   char *__s;
...
;
                     ...
                     LAB_00102510:do {
                        if (*(long*)pCVar26 != *(long*)( (CowData<char32_t>*)pCVar26 + -8 )) {
                           CowData<char32_t>::_ref((CowData<char32_t>*)pCVar26, (CowData*)( (CowData<char32_t>*)pCVar26 + -8 ));
                        }
...
;
 ...
 while ( !bVar30 );
                  ...
                  LAB_00102084:pCVar20 = (CowData<char32_t>*)pCVar26;
                  lVar17 = lVar17 + -1;
                  ...
                  LAB_001020c1:if ((Object*)*(char**)pCVar20 != local_98) {
            ...
            do {
               ...
               *(undefined1(*) [16])( this_00 + 0x198 ) = (undefined1[16])0x0;
               ...
               if (lVar18 <= (long)local_1e0) {
                  LAB_0010285d:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, (long)pCVar20, lVar18, "p_index", "size()", "", false, true);
                  _err_flush_stdout();
                  /* WARNING: Does not return */
                  pcVar4 = (code*)invalidInstructionException();
                  ( *pcVar4 )();
               ...
               if (iVar12 == 0) {
                  ...
                  do {
                     ...
                     cVar9 = ConfigFile::has_section_key((String_conflict*)pRVar28, (String_conflict*)&local_a8);
                     CowData<char32_t>::_unref((CowData<char32_t>*)&local_a8);
                     if (cVar9 == '\0') {
                        local_d0 = 0;
                        ...
                        operator+((char *)&
                        local_d8,(String_conflict*)"\"plugin/";
 ...
 while ( pSVar22 != (String_conflict*)local_40 );
                  if (local_b0 == 0) {
                     ...
                     ConfigFile::get_value((String_conflict*)local_68, (String_conflict*)pRVar28, (Variant*)&local_a8);
                     ...
                     if ((update_plugins()::{lambda()
                     #1
                     ( iVar12 = __cxa_guard_acquire(&update_plugins()::{lambda()#1}::operator()()::sname)
                 , iVar12 != 0) );
                     {
                        _scs_create((char *)&update_plugins()::{lambda()
                        #1
                        __cxa_atexit(StringName::~StringName(( StringName::configured != '\0' ) && ( local_d0 != 0 )), {
                StringName::unref();
                     }
                 ...
                 , iVar13 != 0) );
                     {
                        _scs_create((char *)&update_plugins()::{lambda()
                        #2
                        __cxa_atexit(StringName::~StringName, &update_plugins()::, {
                              lambda()
                              #2
                              __cxa_guard_release(&update_plugins()::{lambda()#2}::operator()()::sname);
              }
              Control::get_editor_theme_icon((StringName *)&local_e0);, TreeItem::add_button(iVar24, (Ref*)0x5, iVar12, false, (String_conflict*)0x0));
                              if (( ( local_e0 != (Object*)0x0 ) && ( cVar9 = RefCounted::unreference() ),pOVar23 = local_e0,cVar9 != '\0' )) &&( cVar9 = cVar9 != '\0' )(**(code**)( *(long*)pOVar23 + 0x140 ))(pOVar23);
...
, CowData<char32_t>::_unref((CowData<char32_t> *) & local_98;
                     ...
                     local_90 = 0x37;
                     String::parse_latin1((StrRange*)&local_d0);
                     vformat<String,String>((String_conflict*)&local_98, (StrRange*)&local_d0, (StrRange*)&local_a8, (CowData<char32_t>*)&local_d8);
                     _err_print_error("update_plugins", "editor/plugins/editor_plugin_settings.cpp", 0x5a, (String_conflict*)&local_98, 0, 1);
                     CowData<char32_t>::_unref((CowData<char32_t>*)&local_98);
                     CowData<char32_t>::_unref((CowData<char32_t>*)&local_d0);
                     CowData<char32_t>::_unref((CowData<char32_t>*)&local_a8);
                     CowData<char32_t>::_unref((CowData<char32_t>*)&local_d8);
                  ...
                  operator+((char *)&
                  local_98,(String_conflict*)"Can\'t load plugin config at: ";
                  _err_print_error("update_plugins", "editor/plugins/editor_plugin_settings.cpp", 0x50, (String_conflict*)&local_98, 0, 1);
                  CowData<char32_t>::_unref((CowData<char32_t>*)&local_98);
                  cVar9 = RefCounted::unreference();
               }
...
/* EditorPluginSettings::_notification(int) */void EditorPluginSettings::_notification(EditorPluginSettings *this, int param_1) {
   long *plVar1;
   code *pcVar2;
   undefined8 uVar3;
   Ref *pRVar4;
   ...
   if (param_1 == 0x2d) {
    ...
    if (param_1 == 0xd){plVar1 = *(long **)(this + 0xa10);
      ...
      *(char **)(pCVar7 + 0x20) = "EditorPluginSettings::_cell_button_pressed";
      ...
      if ((StringName::configured != '\0') && (local_60 != 0)) {
        StringName::unref();
      }Callable::~Callable((Callable*)local_58);}};if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return;
}
LAB_001039a5:/* WARNING: Subroutine does not return */__stack_chk_fail();}/* DefaultAllocator::alloc(unsigned long) */void DefaultAllocator::alloc(ulong param_1) {
...
/* RefCounted::is_class_ptr(void*) const */uint RefCounted::is_class_ptr(RefCounted *this, void *param_1) {
   return (uint)CONCAT71(0x10c5, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10c5, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr);
}
...
/* ConfigFile::is_class_ptr(void*) const */uint ConfigFile::is_class_ptr(ConfigFile *this, void *param_1) {
   return (uint)CONCAT71(0x10c5, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10c4, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10c5, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
...
/* CallableCustomMethodPointer<EditorPluginSettings, void>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<EditorPluginSettings,void>::~CallableCustomMethodPointer(CallableCustomMethodPointer<EditorPluginSettings,void> *this) {
   return;
}
/* CallableCustomMethodPointer<EditorPluginSettings, void, Object*, int, int,
   MouseButton>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<EditorPluginSettings,void,Object*,int,int,MouseButton>::~CallableCustomMethodPointer(CallableCustomMethodPointer<EditorPluginSettings,void,Object*,int,int,MouseButton> *this) {
   return;
}
/* CallableCustomMethodPointer<EditorNode, void, Object*, String
   const&>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<EditorNode,void,Object*,String_const&>::~CallableCustomMethodPointer(CallableCustomMethodPointer<EditorNode,void,Object*,String_const&> *this) {
   return;
}
/* CallableCustomMethodPointer<EditorPluginSettings, void>::get_argument_count(bool&) const */undefined8 CallableCustomMethodPointer<EditorPluginSettings,void>::get_argument_count(CallableCustomMethodPointer<EditorPluginSettings,void> *this, bool *param_1) {
   *param_1 = true;
   return 0;
}
/* CallableCustomMethodPointer<EditorPluginSettings, void, Object*, int, int,
   MouseButton>::get_argument_count(bool&) const */undefined8 CallableCustomMethodPointer<EditorPluginSettings,void,Object*,int,int,MouseButton>::get_argument_count(CallableCustomMethodPointer<EditorPluginSettings,void,Object*,int,int,MouseButton> *this, bool *param_1) {
   *param_1 = true;
   return 4;
}
/* CallableCustomMethodPointer<EditorNode, void, Object*, String const&>::get_argument_count(bool&)
   const */undefined8 CallableCustomMethodPointer<EditorNode,void,Object*,String_const&>::get_argument_count(CallableCustomMethodPointer<EditorNode,void,Object*,String_const&> *this, bool *param_1) {
   *param_1 = true;
   return 2;
}
...
/* EditorPluginSettings::_property_get_revertv(StringName const&, Variant&) const */undefined8 EditorPluginSettings::_property_get_revertv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
   if ((code*)_GLOBAL_OFFSET_TABLE_ != Object::_property_get_revert) {
      uVar1 = Control::_property_get_revert(param_1, param_2);
      return uVar1;
...
/* EditorPluginSettings::_property_can_revertv(StringName const&) const */undefined8 EditorPluginSettings::_property_can_revertv(StringName *param_1) {
   undefined8 uVar1;
   if ((code*)PTR__property_can_revert_00110008 != Object::_property_can_revert) {
      uVar1 = Control::_property_can_revert(param_1);
      return uVar1;
...
/* CallableCustomMethodPointer<EditorPluginSettings, void>::get_object() const */undefined8 CallableCustomMethodPointer<EditorPluginSettings,void>::get_object(CallableCustomMethodPointer<EditorPluginSettings,void> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   uVar2 = 0;
   LAB_00103f2d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* CallableCustomMethodPointer<EditorNode, void, Object*, String const&>::get_object() const */undefined8 CallableCustomMethodPointer<EditorNode,void,Object*,String_const&>::get_object(CallableCustomMethodPointer<EditorNode,void,Object*,String_const&> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   uVar2 = 0;
   LAB_0010402d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* CallableCustomMethodPointer<EditorPluginSettings, void, Object*, int, int,
   MouseButton>::get_object() const */undefined8 CallableCustomMethodPointer<EditorPluginSettings,void,Object*,int,int,MouseButton>::get_object(CallableCustomMethodPointer<EditorPluginSettings,void,Object*,int,int,MouseButton> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   uVar2 = 0;
   LAB_0010412d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* EditorPluginSettings::_validate_propertyv(PropertyInfo&) const */void EditorPluginSettings::_validate_propertyv(PropertyInfo *param_1) {
   for (int i = 0; i < 3; i++) {
...
/* EditorPluginSettings::_setv(StringName const&, Variant const&) */undefined8 EditorPluginSettings::_setv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
   uVar1 = CanvasItem::_set(param_1, param_2);
   if ((char)uVar1 == '\0') {
      if ((code*)PTR__set_00110018 != CanvasItem::_set) {
...
/* WARNING: Removing unreachable block (ram,0x001044f8) *//* EditorPluginSettings::_getv(StringName const&, Variant&) const */undefined8 EditorPluginSettings::_getv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
...
/* WARNING: Removing unreachable block (ram,0x00104568) *//* HBoxContainer::_getv(StringName const&, Variant&) const */undefined8 HBoxContainer::_getv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
   if (( (code*)PTR__get_00110020 != CanvasItem::_get ) && ( uVar1 = Control::_get(param_1, param_2) ),(char)uVar1 != '\0') {
      return uVar1;
   }
...
/* WARNING: Removing unreachable block (ram,0x001045d8) *//* VBoxContainer::_getv(StringName const&, Variant&) const */undefined8 VBoxContainer::_getv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
   if (( (code*)PTR__get_00110020 != CanvasItem::_get ) && ( uVar1 = Control::_get(param_1, param_2) ),(char)uVar1 != '\0') {
      return uVar1;
   }
...
/* HBoxContainer::is_class_ptr(void*) const */uint HBoxContainer::is_class_ptr(void *param_1) {
   ...
   if (in_RSI != &get_class_ptr_static()::ptr) {
      uVar1 = (uint)CONCAT71(0x10c5, in_RSI == &Container::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10c5, in_RSI == &BoxContainer::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10c5, in_RSI == &Control::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10c5, in_RSI == &CanvasItem::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10c5, in_RSI == &Node::get_class_ptr_static(), ::ptr) | CONCAT31(( int3 )((uint)in_EDX >> 8), in_RSI == &Object::get_class_ptr_static(), ::ptr);
   }
...
/* EditorPluginSettings::is_class_ptr(void*) const */ulong EditorPluginSettings::is_class_ptr(void *param_1) {
   undefined4 in_EDX;
   undefined4 *in_RSI;
   if (in_RSI == &VBoxContainer::get_class_ptr_static() || in_RSI == &get_class_ptr_static()::ptr) {
      return CONCAT71(0x10c5, in_RSI == &VBoxContainer::get_class_ptr_static() || in_RSI == &get_class_ptr_static(), ::ptr);
   }

   return ( ulong )((uint)CONCAT71(0x10c5, in_RSI == &Container::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10c5, in_RSI == &BoxContainer::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10c5, in_RSI == &Control::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10c5, in_RSI == &CanvasItem::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10c5, in_RSI == &Node::get_class_ptr_static(), ::ptr) | CONCAT31(( int3 )((uint)in_EDX >> 8), in_RSI == &Object::get_class_ptr_static(), ::ptr));
}
/* RefCounted::_get_class_namev() const */undefined8 *RefCounted::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00104793:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00104793;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "RefCounted");
   LAB_001047fe:return &_get_class_namev();
}
/* VBoxContainer::_get_class_namev() const */undefined8 *VBoxContainer::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00104883:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00104883;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "VBoxContainer");
   LAB_001048ee:return &_get_class_namev();
}
/* HBoxContainer::_get_class_namev() const */undefined8 *HBoxContainer::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00104973:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00104973;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "HBoxContainer");
   LAB_001049de:return &_get_class_namev();
}
/* ConfigFile::_get_class_namev() const */undefined8 *ConfigFile::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00104a53:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00104a53;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "ConfigFile");
   LAB_00104abe:return &_get_class_namev();
}
/* EditorPluginSettings::_get_class_namev() const */undefined8 *EditorPluginSettings::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00104b43:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00104b43;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorPluginSettings");
         goto LAB_00104bae;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorPluginSettings");
   LAB_00104bae:return &_get_class_namev();
}
/* EditorPluginSettings::~EditorPluginSettings() */void EditorPluginSettings::~EditorPluginSettings(EditorPluginSettings *this) {
   bool bVar1;
   ...
   *(code**)this = strlen;
   ...
   LAB_00104c40:Control::~Control((Control*)this);
   return;
}
/* HBoxContainer::~HBoxContainer() */void HBoxContainer::~HBoxContainer(HBoxContainer *this) {
   ...
   *(code**)this = strlen;
   ...
   LAB_00104ca0:Control::~Control((Control*)this);
   return;
}
/* VBoxContainer::~VBoxContainer() */void VBoxContainer::~VBoxContainer(VBoxContainer *this) {
   ...
   *(code**)this = strlen;
   ...
   LAB_00104d00:Control::~Control((Control*)this);
   return;
}
/* EditorPluginSettings::~EditorPluginSettings() */void EditorPluginSettings::~EditorPluginSettings(EditorPluginSettings *this) {
   bool bVar1;
   ...
   *(code**)this = strlen;
   ...
   LAB_00104d60:Control::~Control((Control*)this);
...
/* HBoxContainer::~HBoxContainer() */void HBoxContainer::~HBoxContainer(HBoxContainer *this) {
   ...
   *(code**)this = strlen;
   ...
   LAB_00104dd0:Control::~Control((Control*)this);
...
/* VBoxContainer::~VBoxContainer() */void VBoxContainer::~VBoxContainer(VBoxContainer *this) {
   ...
   *(code**)this = strlen;
   ...
   LAB_00104e40:Control::~Control((Control*)this);
   operator_delete(this, 0xa10);
   return;
}
...
/* Object::is_class(String const&) const */ulong Object::is_class(Object *this, String_conflict *param_1) {
   long *plVar1;
   long lVar2;
   char *__s;
   long lVar3;
   ...
   do {
      if (lVar2 == 0) {
         ...
         LAB_001052b7:/* WARNING: Subroutine does not return */__stack_chk_fail();
      }
...
/* WARNING: Removing unreachable block (ram,0x001053a0) *//* BoxContainer::_notificationv(int, bool) */void BoxContainer::_notificationv(BoxContainer *this, int param_1, bool param_2) {
   int iVar1;
   iVar1 = (int)this;
   if (param_2) {
...
/* EditorPluginSettings::get_class() const */void EditorPluginSettings::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* Callable create_custom_callable_function_pointer<EditorPluginSettings>(EditorPluginSettings*,
   char const*, void (EditorPluginSettings::*)()) */EditorPluginSettings *create_custom_callable_function_pointer<EditorPluginSettings>(EditorPluginSettings *param_1, char *param_2, _func_void *param_3) {
   undefined8 uVar1;
   CallableCustom *this;
   undefined8 in_RCX;
   undefined8 in_R8;
...
/* EditorPluginSettings::_initialize_classv() */void EditorPluginSettings::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_70;
   long local_68;
   long local_60;
            ...
            if (Container::initialize_class() == '\0') {
               if (Control::initialize_class() == '\0') {
                  if (CanvasItem::initialize_class() == '\0') {
                     ...
                     if ((code*)PTR__bind_compatibility_methods_00110030 != Object::_bind_compatibility_methods) {
...
/* WARNING: Removing unreachable block (ram,0x001063e0) *//* String vformat<String, String>(String const&, String const, String const) */undefined8 *vformat<String,String>(undefined8 *param_1, bool *param_2, String_conflict *param_3, String_conflict *param_4) {
   Variant *pVVar1;
   Variant *pVVar2;
   int iVar3;
   long in_FS_OFFSET;
...
/* WARNING: Removing unreachable block (ram,0x001066b8) *//* String vformat<String, String, String, String>(String const&, String const, String const, String
...
/* CallableCustomMethodPointer<EditorPluginSettings, void>::call(Variant const**, int, Variant&,
   Callable::CallError&) const */void CallableCustomMethodPointer<EditorPluginSettings,void>::call(CallableCustomMethodPointer<EditorPluginSettings,void> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long lVar1;
   long lVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   LAB_00106aa0:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* CallableCustomMethodPointer<EditorPluginSettings, void, Object*, int, int,
   MouseButton>::call(Variant const**, int, Variant&, Callable::CallError&) const */void CallableCustomMethodPointer<EditorPluginSettings,void,Object*,int,int,MouseButton>::call(CallableCustomMethodPointer<EditorPluginSettings,void,Object*,int,int,MouseButton> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long lVar1;
   long lVar2;
   Variant *this_00;
   undefined8 uVar3;
...
;
      ...
      _err_print_error(&_LC48, "./core/object/callable_method_pointer.h", 0x67, "Parameter \"ObjectDB::get_instance(ObjectID(data.object_id))\" is null.", local_48, 0, 0);
      CowData<char32_t>::_unref((CowData<char32_t>*)local_48);
   ...
   LAB_00106dfa:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* CallableCustomMethodPointer<EditorNode, void, Object*, String const&>::call(Variant const**, int,
   Variant&, Callable::CallError&) const */void CallableCustomMethodPointer<EditorNode,void,Object*,String_const&>::call(CallableCustomMethodPointer<EditorNode,void,Object*,String_const&> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long lVar1;
   long lVar2;
   Variant *this_00;
   undefined8 uVar3;
...
;
   ...
   CowData<char32_t>::_unref(local_60);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_50);
   LAB_00106ec5:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* Control::is_class(String const&) const */undefined8 Control::is_class(Control *this, String_conflict *param_1) {
   ...
   LAB_0010756b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0010770e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* BoxContainer::is_class(String const&) const */undefined8 BoxContainer::is_class(BoxContainer *this, String_conflict *param_1) {
   ...
   LAB_0010781b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0010791e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* VBoxContainer::is_class(String const&) const */undefined8 VBoxContainer::is_class(VBoxContainer *this, String_conflict *param_1) {
   ...
   if (cVar4 == '\0') {
      ...
      LAB_00107a2b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* HBoxContainer::is_class(String const&) const */undefined8 HBoxContainer::is_class(HBoxContainer *this, String_conflict *param_1) {
   ...
   if (cVar4 == '\0') {
      ...
      LAB_00107b7b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* PropertyListHelper::~PropertyListHelper() */void PropertyListHelper::~PropertyListHelper(PropertyListHelper *this) {
 ...
 while ( lVar4 != (ulong)uVar2 << 2 );
   ...
   LAB_00108906:CowData<char32_t>::_unref((CowData<char32_t>*)this);
   return;
}
/* RefCounted::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void RefCounted::_get_property_listv(List *param_1, bool param_2) {
   ...
   LAB_00108abc:List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)CONCAT71(in_register_00000031, param_2), (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
   }
...
/* Node::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Node::_get_property_listv(List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00108d0c:List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)CONCAT71(in_register_00000031, param_2), (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
   }
...
/* ConfigFile::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void ConfigFile::_get_property_listv(ConfigFile *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00108f71:local_b0 = (CowData<char32_t>*)&local_58;
...
/* CanvasItem::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void CanvasItem::_get_property_listv(CanvasItem *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00109221:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* Control::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Control::_get_property_listv(Control *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_001094f1:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* Container::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Container::_get_property_listv(Container *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_001097c1:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* BoxContainer::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void BoxContainer::_get_property_listv(BoxContainer *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00109a71:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* VBoxContainer::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void VBoxContainer::_get_property_listv(VBoxContainer *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00109d21:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* EditorPluginSettings::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void EditorPluginSettings::_get_property_listv(EditorPluginSettings *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   CowData<char32_t> *local_b0;
   long local_98;
   long local_90;
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00109fd1:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* HBoxContainer::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void HBoxContainer::_get_property_listv(HBoxContainer *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_0010a281:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* RefCounted::is_class(String const&) const */undefined8 RefCounted::is_class(RefCounted *this, String_conflict *param_1) {
   ...
   if (cVar5 == '\0') {
      ...
      LAB_0010a4bb:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* ConfigFile::is_class(String const&) const */undefined8 ConfigFile::is_class(ConfigFile *this, String_conflict *param_1) {
   long *plVar1;
   long lVar2;
   char *__s;
   long lVar3;
   ...
   if (cVar4 == '\0') {
      ...
      LAB_0010a6bb:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* EditorPluginSettings::is_class(String const&) const */undefined8 EditorPluginSettings::is_class(EditorPluginSettings *this, String_conflict *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long lVar4;
   ...
   LAB_0010a80b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0010a90e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* EditorPluginSettings::update_plugins() [clone .cold] */void EditorPluginSettings::update_plugins(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<String>::resize<false>(long) */undefined8 CowData<String>::resize<false>(CowData<String> *this, long param_1) {
   ...
   if (param_1 * 8 == 0) {
      LAB_0010ad60:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (lVar9 == lVar5) {
      LAB_0010acdb:puVar7 = *(undefined8**)this;
      if (puVar7 == (undefined8*)0x0) {
         LAB_0010adb6:/* WARNING: Does not return */pcVar1 = (code*)invalidInstructionException();
         ( *pcVar1 )();
      }
   ...
   if (lVar2 != 0) {
      ...
      if (0 < lVar2) {
         ...
         do {
            ...
            if (lVar3 == 0) {
               lVar7 = 0;
               LAB_0010ae98:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar5, lVar7, "p_index", "size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
               pcVar4 = (code*)invalidInstructionException();
               ( *pcVar4 )();
...
/* EditorPluginSettings::_notificationv(int, bool) */void EditorPluginSettings::_notificationv(EditorPluginSettings *this, int param_1, bool param_2) {
   if (param_2) {
...
/* void memdelete<HashMapElement<String, HashMap<String, Variant, HashMapHasherDefault,
 ...
 while ( lVar4 != (ulong)uVar2 << 2 );
   ...
   LAB_0010b041:CowData<char32_t>::_unref((CowData<char32_t>*)( param_1 + 0x10 ));
...
/* ConfigFile::~ConfigFile() */void ConfigFile::~ConfigFile(ConfigFile *this) {
 ...
 while ( lVar2 != (ulong)uVar1 << 2 );
   ...
   LAB_0010b151:*(undefined***)this = &PTR__initialize_classv_0010b5a8;
   Object::~Object((Object*)this);
   return;
}
/* ConfigFile::~ConfigFile() */void ConfigFile::~ConfigFile(ConfigFile *this) {
 ...
 while ( lVar2 != (ulong)uVar1 << 2 );
   ...
   LAB_0010b241:*(undefined***)this = &PTR__initialize_classv_0010b5a8;
   Object::~Object((Object*)this);
   operator_delete(this, 0x1b0);
   return;
}
/* EditorPluginSettings::_notification(int) */void EditorPluginSettings::_GLOBAL__sub_I__notification(void) {
   undefined8 uStack_8;
...
/* WARNING: Control flow encountered bad instruction data *//* EditorPluginSettings::~EditorPluginSettings() */void EditorPluginSettings::~EditorPluginSettings(EditorPluginSettings *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<EditorNode, void, Object*, String
   const&>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<EditorNode,void,Object*,String_const&>::~CallableCustomMethodPointer(CallableCustomMethodPointer<EditorNode,void,Object*,String_const&> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<EditorPluginSettings, void, Object*, int, int,
   MouseButton>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<EditorPluginSettings,void,Object*,int,int,MouseButton>::~CallableCustomMethodPointer(CallableCustomMethodPointer<EditorPluginSettings,void,Object*,int,int,MouseButton> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<EditorPluginSettings, void>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<EditorPluginSettings,void>::~CallableCustomMethodPointer(CallableCustomMethodPointer<EditorPluginSettings,void> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

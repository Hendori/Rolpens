/* hb_ot_face_t::init0(hb_face_t*) */void hb_ot_face_t::init0(hb_ot_face_t *this, hb_face_t *param_1) {
   *(hb_face_t**)this = param_1;
   return;
}
/* hb_ot_face_t::fini() */void hb_ot_face_t::fini(hb_ot_face_t *this) {
   uint uVar1;
   undefined *puVar2;
   undefined8 *puVar3;
   int *__ptr;
...
;
 ...
 while ( lVar4 != lVar7 );
            LAB_00100bcf:pvVar5 = *(void**)( puVar2 + 0x110 );
         }
...
;
 ...
 while ( lVar4 != lVar7 );
            LAB_00100b5f:pvVar5 = *(void**)( puVar2 + 0x120 );
         }
...
;
 ...
 while ( lVar4 != lVar7 );
            LAB_00100af0:pvVar5 = *(void**)( puVar2 + 0x120 );
         }
...
;
 ...
 while ( lVar4 != lVar7 );
            LAB_00100a80:pvVar5 = *(void**)( puVar2 + 0x110 );
         }
...
;
 ...
 while ( lVar4 != lVar7 );
            LAB_00100def:pvVar5 = *(void**)( puVar2 + 0xa8 );
         }
...
;
 ...
 while ( lVar7 != lVar4 );
            LAB_00100d7f:pvVar5 = *(void**)( puVar2 + 0xb8 );
         }
...
;
 ...
 while ( lVar7 != lVar4 );
            LAB_00100cff:pvVar5 = *(void**)( puVar2 + 0xb8 );
         }
...
;
 ...
 while ( lVar7 != lVar4 );
            LAB_00100c87:pvVar5 = *(void**)( puVar2 + 0xa8 );
         }
   ...
   *(undefined8*)( this + 0x88 ) = 0;
   for (int i = 0; i < 3; i++) {
      lVar6 = *(long*)( this + ( 8*i + 144 ) );
      if (( lVar6 != 0 ) && ( lVar4 = lVar6 != lVar4 )) {
         hb_blob_destroy(lVar6);
      }

      *(undefined8*)( this + ( 8*i + 144 ) ) = 0;
   }

/* EditorDebuggerPlugin::get_sessions() */void EditorDebuggerPlugin::get_sessions(void) {
   undefined8 *puVar1;
   long in_RSI;
   Array *in_RDI;
   long in_FS_OFFSET;
   ...
   if (*(undefined8**)( in_RSI + 0x180 ) != (undefined8*)0x0) {
      for (puVar1 = (undefined8*)**(undefined8**)( in_RSI + 0x180 ); puVar1 != (undefined8*)0x0; puVar1 = (undefined8*)puVar1[1]) {
...
/* EditorDebuggerSession::send_message(String const&, Array const&) */void EditorDebuggerSession::send_message(String *param_1, Array *param_2) {
   if (*(String**)( param_1 + 0x1a8 ) != (String*)0x0) {
      ScriptEditorDebugger::send_message(*(String**)( param_1 + 0x1a8 ), param_2);
      return;
   }

   _err_print_error("send_message", "editor/plugins/editor_debugger_plugin.cpp", 0x50, "Parameter \"debugger\" is null.", "Plugin is not attached to debugger.", 0, 0);
   return;
}
/* EditorDebuggerSession::toggle_profiler(String const&, bool, Array const&) */void EditorDebuggerSession::toggle_profiler(String *param_1, bool param_2, Array *param_3) {
   if (*(String**)( param_1 + 0x1a8 ) != (String*)0x0) {
      ScriptEditorDebugger::toggle_profiler(*(String**)( param_1 + 0x1a8 ), param_2, (Array*)( (ulong)param_3 & 0xff ));
      return;
   }

   _err_print_error("toggle_profiler", "editor/plugins/editor_debugger_plugin.cpp", 0x55, "Parameter \"debugger\" is null.", "Plugin is not attached to debugger.", 0, 0);
   return;
}
/* EditorDebuggerSession::set_breakpoint(String const&, int, bool) */void EditorDebuggerSession::set_breakpoint(String *param_1, int param_2, bool param_3) {
   if (*(String**)( param_1 + 0x1a8 ) != (String*)0x0) {
      ScriptEditorDebugger::set_breakpoint(*(String**)( param_1 + 0x1a8 ), param_2, param_3);
      return;
   }

   _err_print_error("set_breakpoint", "editor/plugins/editor_debugger_plugin.cpp", 0x69, "Parameter \"debugger\" is null.", "Plugin is not attached to debugger.", 0, 0);
   return;
}
/* EditorDebuggerSession::is_breaked() */undefined4 EditorDebuggerSession::is_breaked(EditorDebuggerSession *this) {
   int iVar1;
   ...
   _err_print_error("is_breaked", "editor/plugins/editor_debugger_plugin.cpp", 0x5a, "Parameter \"debugger\" is null.", "Plugin is not attached to debugger.", 0, 0);
   return 0;
}
/* EditorDebuggerSession::is_active() */undefined8 EditorDebuggerSession::is_active(EditorDebuggerSession *this) {
   long *plVar1;
   undefined8 uVar2;
   if (*(long*)( this + 0x1a8 ) == 0) {
      _err_print_error("is_active", "editor/plugins/editor_debugger_plugin.cpp", 100, "Parameter \"debugger\" is null.", "Plugin is not attached to debugger.", 0, 0);
      return 0;
   }
...
/* EditorDebuggerSession::is_debuggable() */undefined1 EditorDebuggerSession::is_debuggable(void) {
   long lVar1;
   long lVar2;
   long lVar3;
   ...
   if (lVar1 == 0) {
      _err_print_error("is_debuggable", "editor/plugins/editor_debugger_plugin.cpp", 0x5f, "Parameter \"debugger\" is null.", "Plugin is not attached to debugger.", 0, 0);
   }
      ...
      if (lVar2 != 0) {
         ...
         if (uVar17 != 0) {
            uVar19 = 0;
            do {
               if (( (uint)uVar16 == uVar17 ) && ( *(long*)( lVar1 + 0xc08 ) == *(long*)( *(long*)( lVar2 + lVar15 * 8 ) + 0x10 ) )) {
 ...
 while ( ( uVar17 != 0 ) && ( auVar6._8_8_ = 0 ),auVar6._0_8_ = (ulong)uVar17 * lVar3,auVar10._8_8_ = 0,auVar10._0_8_ = uVar18,auVar7._8_8_ = 0,auVar7._0_8_ = ( ulong )(( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( lVar1 + 0xc38 ) * 4 ) + uVar14 ) - SUB164(auVar6 * auVar10, 8)) * lVar3,auVar11._8_8_ = 0,auVar11._0_8_ = uVar18,uVar19 <= SUB164(auVar7 * auVar11, 8) );
         }
...
/* EditorDebuggerSession::_breaked(bool, bool, String const&, bool) */void EditorDebuggerSession::_breaked(bool param_1, bool param_2, String *param_3, bool param_4) {
   int iVar1;
   ...
   local_30 = *(long*)( in_FS_OFFSET + 0x28 );
   if (param_2) {
      if (_breaked(bool,bool,String_const&,bool) ::{lambda();
      #1
      iVar1 = __cxa_guard_acquire(&_breaked, (bool,bool, String_const, &, bool)::{lambda()#1}::
                                   operator()()::sname);
      if (iVar1 != 0) {
         _scs_create((char*)&_breaked, (bool,bool, String_const, &, bool)::{lambda()#1}::operator()()::sname,true);
         __cxa_atexit(StringName::~StringName, &_breaked, (bool,bool, String_const, &, bool)::{lambda()#1}::operator()()::sname,&__dso_handle);
         __cxa_guard_release(&_breaked(bool,bool,String_const&,bool)::{lambda()
         #1
         sname;
      }
   ...
   ( **(code**)( *plVar2 + 0xd0 ) )(plVar2, &_breaked, (bool,bool, String_const, &, bool)::{lambda()#1}::operator()()::sname,local_78,1);
   ...
   if (Variant::needs_deinit[local_68[0]] != '\0') {
    ...
    if (_breaked(bool,bool,String_const&,bool)::{lambda()#2iVar1 = __cxa_guard_acquire(&_breaked, (bool,bool, String_const, &, bool)::{lambda()#2}::
                                   operator()()::sname);if (iVar1 != 0) {
   _scs_create((char*)&_breaked, (bool,bool, String_const, &, bool)::{lambda()#2}::operator()()::sname,true);
   __cxa_atexit(StringName::~StringName, &_breaked, (bool,bool, String_const, &, bool)::{lambda()#2}::operator()()::sname,&__dso_handle);
   __cxa_guard_release(&_breaked(bool,bool,String_const&,bool)::{lambda()
   #2
   sname;
}
}local_68[0] = 0;local_68[1] = 0;local_60 = (undefined1[16])0x0;(**(code **)(*plVar2 + 0xd0))
              (plVar2,&_breaked(bool,bool,String_const&,bool)::{lambda()#2);if (Variant::needs_deinit[local_68[0]] != '\0') {
   Variant::_clear_internal();
}
}if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* EditorDebuggerSession::_debugger_gone_away() */void EditorDebuggerSession::_debugger_gone_away(EditorDebuggerSession *this) {
...
/* EditorDebuggerSession::_stopped() */void __thiscall EditorDebuggerSession::_stopped(EditorDebuggerSession *this)

...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* EditorScriptPreviewPlugin::_generate_from_source_code(ScriptLanguage const*, String const&,
   Vector2 const&, Dictionary&) const */EditorScriptPreviewPlugin * __thiscall
...
/* EditorScriptPreviewPlugin::generate(Ref<Resource> const&, Vector2 const&, Dictionary&) const */EditorScriptPreviewPlugin * __thiscall
...
/* EditorMaterialPreviewPlugin::generate(Ref<Resource> const&, Vector2 const&, Dictionary&) const */EditorMaterialPreviewPlugin * __thiscall
...
/* EditorImagePreviewPlugin::generate(Ref<Resource> const&, Vector2 const&, Dictionary&) const */Ref *EditorImagePreviewPlugin::generate(Ref *param_1, Vector2 *param_2, Dictionary *param_3) {
   float fVar1;
   char cVar2;
   int iVar3;
   Image *pIVar4;
   ...
   long local_40;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (( ( ( *(long*)param_3 == 0 ) || ( pIVar4 = (Image*)__dynamic_cast(*(long*)param_3, &Object::typeinfo, &Image::typeinfo, 0, in_R8, in_R9, 0) ),pIVar4 == (Image*)0x0 ) ) || ( cVar2 = cVar2 == '\0' )) {
      *(undefined8*)param_1 = 0;
      goto LAB_0010358f;
   }
...
else{*(undefined8*)param_1 = 0;};LAB_001035d5:if (( pIVar4 != (Image*)0x0 ) && ( cVar2 = cVar2 != '\0' )) {
...
LAB_001046b9:iVar2 = Image::load(local_60);if (iVar2 == 0) goto LAB_00104736;LAB_001046c5:*(undefined8*)param_1 = 0;}if (( local_60 != (String*)0x0 ) && ( cVar1 = cVar1 != '\0' )) {
...
EditorFontPreviewPlugin::generate_from_path
   ...
   if (local_78 == (Ref*)0x0) {
      ...
      if (pOVar6 != (Object*)0x0) {
         ...
         if (( local_78 != (Ref*)0x0 ) && ( cVar4 = cVar4 != '\0' )) goto LAB_00104d88;
...
else{*(undefined8*)this = 0;};cVar5 = RefCounted::unreference();joined_r0x00105e84:if (( cVar5 != '\0' ) && ( cVar5 = cVar5 != '\0' )) {
...
CowData<unsigned_char>::_unref((CowData<unsigned_char>*)&local_80);cVar4 = RefCounted::unreference();if (( cVar4 != '\0' ) && ( cVar4 = cVar4 != '\0' )) {
   ( **(code**)( *(long*)pOVar5 + 0x140 ) )(pOVar5);
   Memory::free_static(pOVar5, false);
}

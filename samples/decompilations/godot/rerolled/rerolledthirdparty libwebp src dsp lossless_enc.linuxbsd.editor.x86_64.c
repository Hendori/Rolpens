void VP8LSubtractGreenFromBlueAndRed_C(uint *param_1, int param_2) {
   ...
   if (0 < param_2) {
      ...
      do {
         ...
         puVar4 = puVar3 + 1;
         uVar2 = uVar1 >> 8 & 0xff;
         *puVar3 = ( ( (int)uVar1 >> 0x10 ) - uVar2 & 0xff ) << 0x10 | uVar1 & 0xff00ff00 | uVar1 - uVar2 & 0xff;
         puVar3 = puVar4;
      }
...
void VP8LTransformColor_C(char *param_1, uint *param_2, int param_3) {
   ...
   if (0 < param_3) {
      ...
      do {
         ...
         *puVar7 = ( iVar5 - ( iVar6 * cVar1 >> 5 ) & 0xffU ) << 0x10 | ( ( uVar4 & 0xff ) - ( cVar2 * iVar6 >> 5 ) ) - ( iVar5 * cVar3 >> 5 ) & 0xff | uVar4 & 0xff00ff00;
         puVar7 = puVar8;
      }
...
void VP8LCollectColorRedTransforms_C(uint *param_1, int param_2, int param_3, int param_4, char param_5, long param_6) {
   int *piVar1;
   uint *puVar2;
   uint *puVar3;
   uint *puVar4;
   ...
   do {
      ...
      if (0 < param_3) {
         do {
            puVar3 = puVar2 + 1;
            piVar1 = (int*)( param_6 + ( ulong )(( *puVar2 >> 0x10 ) - ( (int)(char)( *puVar2 >> 8 ) * (int)param_5 >> 5 ) & 0xff) * 4 );
            *piVar1 = *piVar1 + 1;
            puVar2 = puVar3;
         }
 while ( puVar3 != puVar4 );
...
void VP8LCollectColorBlueTransforms_C(uint *param_1, int param_2, int param_3, int param_4, char param_5, char param_6, long param_7) {
   int *piVar1;
   uint uVar2;
   uint *puVar3;
   uint *puVar4;
      ...
      do {
         ...
         if (0 < param_3) {
            do {
               uVar2 = *puVar4;
               puVar4 = puVar4 + 1;
               piVar1 = (int*)( param_7 + ( ulong )(( ( uVar2 & 0xff ) - ( (int)(char)( uVar2 >> 8 ) * (int)param_5 >> 5 ) ) - ( (int)(char)( uVar2 >> 0x10 ) * (int)param_6 >> 5 ) & 0xff) * 4 );
               *piVar1 = *piVar1 + 1;
            }
 while ( puVar4 != puVar3 );
         }
...
int ExtraCostCombined_C(long param_1, long param_2, int param_3) {
   ...
   int iVar6;
   long lVar7;
   iVar5 = *(int*)( param_2 + 0x14 ) + *(int*)( param_2 + 0x10 ) + *(int*)( param_1 + 0x10 ) + *(int*)( param_1 + 0x14 );
   if (7 < param_3) {
      lVar7 = 2;
      do {
         lVar1 = lVar7 * 8;
         ...
         iVar6 = (int)lVar7;
         lVar7 = lVar7 + 1;
         iVar5 = iVar5 + ( *(int*)( param_2 + 8 + lVar1 ) + *(int*)( param_1 + 8 + lVar3 ) + *(int*)( param_2 + 0xc + lVar2 ) + *(int*)( param_1 + 0xc + lVar4 ) ) * iVar6;
      }
...
void PredictorSub0_C(long param_1, undefined8 param_2, int param_3, long param_4) {
   ...
   if (0 < param_3) {
      lVar1 = 0;
      do {
         *(uint*)( param_4 + lVar1 ) = ( *(uint*)( param_1 + lVar1 ) & 0xff00ff00 ) + 0x1ff00ff & 0xff00ff00 | *(uint*)( param_1 + lVar1 ) & 0xff00ff;
         lVar1 = lVar1 + 4;
      }
 while ( (long)param_3 * 4 - lVar1 != 0 );
   }
...
void PredictorSub13_C(long param_1, long param_2, int param_3, uint *param_4) {
   ...
   if (0 < param_3) {
      ...
      do {
         ...
         uVar1 = puVar5[1];
         *param_4 = ( 0xff00ff - ( uVar2 & 0xff00ff00 ) ) + ( uVar1 & 0xff00ff00 ) & 0xff00ff00 | ( -0xff0100 - ( uVar2 & 0xff00ff ) ) + ( uVar1 & 0xff00ff ) & 0xff00ff;
         lVar3 = lVar4;
         param_4 = param_4 + 1;
         puVar5 = puVar5 + 1;
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 FastSLog2Slow_C(uint param_1) {
   int iVar1;
   byte bVar2;
   double dVar3;
   ...
   if (param_1 < 0x10000) {
      ...
      auVar4._0_4_ = ( (float)( iVar1 + -7 ) + *(float*)( kLog2Table + ( ulong )(param_1 >> ( bVar2 & 0x1f )) * 4 ) ) * (float)(int)param_1 + (float)( ( ( 1 << ( bVar2 & 0x1f ) ) - 1U & param_1 ) * 0x17 >> 4 );
      return auVar4._0_8_;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 FastLog2Slow_C(uint param_1) {
   int iVar1;
   byte bVar2;
   double dVar3;
   undefined1 auVar4[16];
   ...
   bVar2 = ( byte )(iVar1 + -7);
   auVar4._4_12_ = SUB1612((undefined1[16])0x0, 4);
   auVar4._0_4_ = (float)( iVar1 + -7 ) + *(float*)( kLog2Table + ( ulong )(param_1 >> ( bVar2 & 0x1f )) * 4 );
   if (0xfff < param_1) {
      dVar3 = (double)auVar4._0_4_ + (double)( ( ( 1 << ( bVar2 & 0x1f ) ) - 1U & param_1 ) * 0x17 >> 4 ) / (double)(int)param_1;
...
void PredictorSub1_C(long param_1, undefined8 param_2, int param_3, long param_4) {
   ...
   if (0 < param_3) {
      ...
      do {
         ...
         *(uint*)( param_4 + lVar2 ) = ( *(uint*)( param_1 + lVar2 ) | 0xff00ff00 ) - ( uVar1 & 0xff00ff ) & 0xff00ff | ( *(uint*)( param_1 + lVar2 ) | 0xff00ff ) - ( uVar1 & 0xff00ff00 ) & 0xff00ff00;
         lVar2 = lVar2 + 4;
      }
...
;
 ...
 while ( lVar2 != 0x400 );
   LAB_00100ec1:if ((uint)uVar4 < 0x100) {
...
void GetCombinedEntropyUnrefined_C(int *param_1, int *param_2, uint param_3, float *param_4, undefined1 (*param_5)[16]) {
   ulong uVar1;
   ulong uVar2;
   float fVar3;
   float fVar4;
   ...
   if ((int)param_3 < 2) {
      ...
      do {
         ...
         if (fVar3 != fVar4) {
            ...
            *(uint*)( *param_5 + ( ulong )(fVar4 != 0.0) * 4 ) = *(int*)( *param_5 + ( ulong )(fVar4 != 0.0) * 4 ) + ( uint )(3 < iVar6);
            *(int*)( *param_5 + ( ( ulong )(3 < iVar6) + ( ulong )(fVar4 != 0.0) * 2 ) * 4 + 8 ) = *(int*)( *param_5 + ( ( ulong )(3 < iVar6) + ( ulong )(fVar4 != 0.0) * 2 ) * 4 + 8 ) + iVar6;
         }
 ...
 while ( param_3 != uVar2 );
   ...
   *(int*)( *param_5 + ( ulong )(fVar3 != 0.0) * 4 ) = *(int*)( *param_5 + ( ulong )(fVar3 != 0.0) * 4 ) + (int)uVar1;
   *(int*)( *param_5 + ( uVar1 + ( ulong )(fVar3 != 0.0) * 2 ) * 4 + 8 ) = *(int*)( *param_5 + ( uVar1 + ( ulong )(fVar3 != 0.0) * 2 ) * 4 + 8 ) + iVar6;
   if ((uint)uVar5 < 0x100) {
...
void GetEntropyUnrefined_C(float *param_1, uint param_2, float *param_3, undefined1 (*param_4)[16]) {
   ...
   if ((int)param_2 < 2) {
      ...
      do {
         ...
         if (fVar6 != fVar4) {
            ...
            uVar1 = uVar2 & 0xffffffff;
            *(uint*)( *param_4 + ( ulong )(fVar4 != 0.0) * 4 ) = *(int*)( *param_4 + ( ulong )(fVar4 != 0.0) * 4 ) + ( uint )(3 < iVar5);
            *(int*)( *param_4 + ( ( ulong )(3 < iVar5) + ( ulong )(fVar4 != 0.0) * 2 ) * 4 + 8 ) = *(int*)( *param_4 + ( ( ulong )(3 < iVar5) + ( ulong )(fVar4 != 0.0) * 2 ) * 4 + 8 ) + iVar5;
         }
 ...
 while ( param_2 != uVar2 );
   ...
   *(int*)( *param_4 + ( ulong )(fVar6 != 0.0) * 4 ) = *(int*)( *param_4 + ( ulong )(fVar6 != 0.0) * 4 ) + (int)uVar1;
   *(int*)( *param_4 + ( uVar1 + ( ulong )(fVar6 != 0.0) * 2 ) * 4 + 8 ) = *(int*)( *param_4 + ( uVar1 + ( ulong )(fVar6 != 0.0) * 2 ) * 4 + 8 ) + iVar5;
   if ((uint)uVar3 < 0x100) {
...
;
 ...
 while ( param_2 != lVar2 );
   LAB_00101514:if (0xff < (uint)uVar3) {
   ...
   if (param_2 == param_3) {
      ...
      if (*(char*)( (long)param_1 + 0xcc4 ) != '\0') {
         if (*(char*)( (long)param_3 + 0xcc4 ) == '\0') {
            for (int i = 0; i < 10; i++) {
               uVar4 = param_1[( 2*i + 386 )];
               param_3[( 2*i + 385 )] = param_1[( 2*i + 385 )];
               param_3[( 2*i + 386 )] = uVar4;
            }
      ...
      lVar1 = 0xcc0;
      do {
         *(byte*)( (long)param_3 + lVar1 ) = *(byte*)( (long)param_3 + lVar1 ) | *(byte*)( (long)param_1 + lVar1 );
         lVar1 = lVar1 + 1;
      }
 while ( lVar1 != 0xcc5 );
      return;
   ...
   if (*(char*)( (long)param_1 + 0xcc1 ) == '\0') {
      ...
      for (uVar2 = ( ulong )(( iVar3 - (int)(undefined8*)( ( ulong )(param_3 + 2) & 0xfffffffffffffff8 ) ) + 0x408U >> 3); uVar2 != 0; uVar2 = uVar2 - 1) {
         *puVar5 = 0;
         puVar5 = puVar5 + (ulong)bVar7 * -2 + 1;
      }
      ...
      param_3[1] = param_1[1];
      uVar4 = param_1[0x80];
      LAB_001018d2:param_3[0x80] = uVar4;
      lVar1 = (long)param_3 + ( 8 - (long)( ( ulong )(param_3 + 2) & 0xfffffffffffffff8 ) );
   ...
   if (*(char*)( (long)param_1 + 0xcc2 ) == '\0') {
      ...
      for (uVar2 = ( ulong )(( iVar3 - (int)(undefined8*)( ( ulong )(param_3 + 0x82) & 0xfffffffffffffff8 ) ) + 0x808U >> 3); uVar2 != 0; uVar2 = uVar2 - 1) {
         *puVar5 = 0;
         puVar5 = puVar5 + (ulong)bVar7 * -2 + 1;
      }
      ...
      param_3[0x81] = param_1[0x81];
      uVar4 = param_1[0x100];
      LAB_0010187e:param_3[0x100] = uVar4;
      lVar1 = (long)param_3 + ( 0x408 - (long)( ( ulong )(param_3 + 0x82) & 0xfffffffffffffff8 ) );
      puVar5 = (undefined8*)( (long)puVar5 - lVar1 );
      puVar6 = (undefined8*)( ( ulong )(param_3 + 0x82) & 0xfffffffffffffff8 );
      for (uVar2 = ( ulong )((int)lVar1 + 0x400U >> 3); uVar2 != 0; uVar2 = uVar2 - 1) {
   ...
   if (*(char*)( (long)param_1 + 0xcc3 ) == '\0') {
      if (*(char*)( (long)param_2 + 0xcc3 ) == '\0') {
         ...
         for (uVar2 = ( ulong )(( iVar3 - (int)(undefined8*)( ( ulong )(param_3 + 0x102) & 0xfffffffffffffff8 ) ) + 0xc08U >> 3); uVar2 != 0; uVar2 = uVar2 - 1) {
            *puVar5 = 0;
            puVar5 = puVar5 + (ulong)bVar7 * -2 + 1;
         }
   ...
   LAB_001016b3:if (*(char*)( (long)param_1 + 0xcc4 ) == '\0') {
      if (*(char*)( (long)param_2 + 0xcc4 ) == '\0') {
         param_3[0x181] = 0;
         param_3[0x194] = 0;
         puVar5 = (undefined8*)( ( ulong )(param_3 + 0x182) & 0xfffffffffffffff8 );
         for (uVar2 = ( ulong )(( iVar3 - (int)(undefined8*)( ( ulong )(param_3 + 0x182) & 0xfffffffffffffff8 ) ) + 0xca8U >> 3); uVar2 != 0; uVar2 = uVar2 - 1) {
            *puVar5 = 0;
            puVar5 = puVar5 + (ulong)bVar7 * -2 + 1;
         }
         ...
         for (int i = 0; i < 10; i++) {
            uVar4 = param_2[( 2*i + 386 )];
            param_3[( 2*i + 385 )] = param_2[( 2*i + 385 )];
            param_3[( 2*i + 386 )] = uVar4;
         }
   ...
   lVar1 = 0xcc0;
   do {
      *(byte*)( (long)param_3 + lVar1 ) = *(byte*)( (long)param_1 + lVar1 ) | *(byte*)( (long)param_2 + lVar1 );
      lVar1 = lVar1 + 1;
   }
 while ( lVar1 != 0xcc5 );
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void VP8LEncDspInit(void) {
   int iVar1;

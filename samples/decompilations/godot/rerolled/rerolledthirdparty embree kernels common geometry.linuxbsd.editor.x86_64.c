/* embree::Geometry::setNumPrimitives(unsigned int) */void embree::Geometry::setNumPrimitives(Geometry *this, uint param_1) {
...
/* embree::Geometry::setNumTimeSteps(unsigned int) */void embree::Geometry::setNumTimeSteps(Geometry *this, uint param_1) {
...
/* embree::Geometry::commit() */void embree::Geometry::commit(Geometry *this) {
   *(int*)( this + 0x38 ) = *(int*)( this + 0x38 ) + 1;
   this[0x3e] = ( Geometry )((byte)this[0x3e] & 0xe7 | 8);
   return;
}
/* embree::Geometry::postCommit() */void embree::Geometry::postCommit(void) {
   return;
}
/* embree::Geometry::setUserData(void*) */void embree::Geometry::setUserData(Geometry *this, void *param_1) {
   *(void**)( this + 0x18 ) = param_1;
   return;
}
/* embree::Geometry::preCommit() */void embree::Geometry::preCommit(Geometry *this) {
...
/* embree::Geometry::setIntersectionFilterFunctionN(void (*)(RTCFilterFunctionNArguments const*)) */void embree::Geometry::setIntersectionFilterFunctionN(Geometry *this, _func_void_RTCFilterFunctionNArguments_ptr *param_1) {
...
/* embree::Geometry::setOcclusionFilterFunctionN(void (*)(RTCFilterFunctionNArguments const*)) */void embree::Geometry::setOcclusionFilterFunctionN(Geometry *this, _func_void_RTCFilterFunctionNArguments_ptr *param_1) {
   if (( 1 << ( (byte)this[0x3c] & 0x1f ) & 0x2ef7777fU ) != 0) {
...
/* embree::Geometry::interpolateN(RTCInterpolateNArguments const*) */void embree::Geometry::interpolateN(Geometry *this, RTCInterpolateNArguments *param_1) {
   uint uVar1;
   uint uVar2;
   long lVar3;
   long lVar4;
...
;
 ...
 while ( uVar2 != uVar25 );
   ...
   LAB_00100462:if (local_48 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* embree::Geometry::enable() */void embree::Geometry::enable(Geometry *this) {
...
/* embree::Geometry::disable() */void embree::Geometry::disable(Geometry *this) {
   if (( (byte)this[0x3e] & 0x20 ) != 0) {
      *(int*)( this + 0x38 ) = *(int*)( this + 0x38 ) + 1;
...
/* embree::Geometry::~Geometry() */void embree::Geometry::~Geometry(Geometry *this) {
   long *plVar1;
   long *plVar2;
...
/* embree::Geometry::Geometry(embree::Device*, embree::Geometry::GType, unsigned int, unsigned int)
    */void embree::Geometry::Geometry(Geometry *this, long *param_1, Geometry param_3, undefined4 param_4, int param_5) {
   long lVar1;
...
/* embree::Geometry::setTimeRange(embree::BBox<float>) */void embree::Geometry::setTimeRange(undefined8 param_1, Geometry *this) {
   *(int*)( this + 0x38 ) = *(int*)( this + 0x38 ) + 1;
   this[0x3e] = ( Geometry )((byte)this[0x3e] & 0xe7);
   *(undefined8*)( this + 0x2c ) = param_1;
   return;
}
/* embree::Geometry::getTimeRange() const */undefined8 embree::Geometry::getTimeRange(Geometry *this) {
   return *(undefined8*)( this + 0x2c );
}
/* embree::Geometry::update() */void embree::Geometry::update(Geometry *this) {
   *(int*)( this + 0x38 ) = *(int*)( this + 0x38 ) + 1;
   this[0x3e] = ( Geometry )((byte)this[0x3e] & 0xe7);
   return;
}
/* embree::Geometry::setPointQueryFunction(bool (*)(RTCPointQueryFunctionArguments*)) */void embree::Geometry::setPointQueryFunction(Geometry *this, _func_bool_RTCPointQueryFunctionArguments_ptr *param_1) {
   *(_func_bool_RTCPointQueryFunctionArguments_ptr**)( this + 0x50 ) = param_1;
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* embree::Geometry::pointQuery(embree::PointQueryK<1>*, embree::PointQueryContext*) */uint embree::Geometry::pointQuery(Geometry *this, PointQueryK *param_1, PointQueryContext *param_2) {
   int iVar1;
   ...
   if (*(code**)( param_2 + 0x20 ) == (code*)0x0) {
      ...
      pcVar14 = *(code**)( this + 0x50 );
      if (pcVar14 != (code*)0x0) {
         LAB_00100761:uVar13 = ( *pcVar14 )(&local_68);
   ...
   uVar12 = 0;
   LAB_0010077b:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* embree::Geometry::updateBuffer(RTCBufferType, unsigned int) */void embree::Geometry::updateBuffer(long param_1) {
   *(int*)( param_1 + 0x38 ) = *(int*)( param_1 + 0x38 ) + 1;
   *(byte*)( param_1 + 0x3e ) = *(byte*)( param_1 + 0x3e ) & 0xe7;
   return;
}
/* embree::Geometry::verify() */undefined8 embree::Geometry::verify(void) {
   return 1;
}
/* embree::Geometry::getCompactVertexArray() const */undefined8 embree::Geometry::getCompactVertexArray(void) {
   return 0;
}
...
/* embree::Geometry::interpolate(RTCInterpolateArguments const*) */void embree::Geometry::interpolate(RTCInterpolateArguments *param_1) {
   /* WARNING: Subroutine does not return */
   abort();
}
...
/* embree::Geometry::setVertexAttributeCount(unsigned int) */void embree::Geometry::setVertexAttributeCount(uint param_1) {
   /* WARNING: Subroutine does not return */
   abort();
}
/* embree::Geometry::getBuffer(RTCBufferType, unsigned int) */void embree::Geometry::getBuffer(void) {
   /* WARNING: Subroutine does not return */
   abort();
}
/* embree::Geometry::setBuffer(RTCBufferType, unsigned int, RTCFormat, embree::Ref<embree::Buffer>
   const&, unsigned long, unsigned long, unsigned int) */void embree::Geometry::setBuffer(void) {
   /* WARNING: Subroutine does not return */
   abort();
}
/* embree::Geometry::setMask(unsigned int) */void embree::Geometry::setMask(uint param_1) {
   /* WARNING: Subroutine does not return */
   abort();
}
/* embree::Geometry::addElementsToCount(embree::GeometryCounts&) const */void embree::Geometry::addElementsToCount(GeometryCounts *param_1) {
   /* WARNING: Subroutine does not return */
   abort();
}
/* embree::Geometry::preCommit() [clone .cold] */void embree::Geometry::preCommit(void) {
   /* WARNING: Subroutine does not return */
   abort();
}
/* embree::Geometry::setIntersectionFilterFunctionN(void (*)(RTCFilterFunctionNArguments const*))
   [clone .cold] */void embree::Geometry::setIntersectionFilterFunctionN(_func_void_RTCFilterFunctionNArguments_ptr *param_1) {
   /* WARNING: Subroutine does not return */
   abort();
}
/* embree::Geometry::setOcclusionFilterFunctionN(void (*)(RTCFilterFunctionNArguments const*))
   [clone .cold] */void embree::Geometry::setOcclusionFilterFunctionN(_func_void_RTCFilterFunctionNArguments_ptr *param_1) {
   /* WARNING: Subroutine does not return */
   abort();
}
/* embree::Geometry::interpolateN(RTCInterpolateNArguments const*) [clone .cold] */void embree::Geometry::interpolateN(RTCInterpolateNArguments *param_1) {
   /* WARNING: Subroutine does not return */
   abort();
}

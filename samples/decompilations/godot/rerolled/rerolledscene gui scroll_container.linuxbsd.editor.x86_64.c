/* ScrollContainer::get_horizontal_scroll_mode() const */undefined4 ScrollContainer::get_horizontal_scroll_mode(ScrollContainer *this) {
   return *(undefined4*)( this + 0xa40 );
}
/* ScrollContainer::get_vertical_scroll_mode() const */undefined4 ScrollContainer::get_vertical_scroll_mode(ScrollContainer *this) {
   return *(undefined4*)( this + 0xa44 );
}
/* ScrollContainer::get_deadzone() const */undefined4 ScrollContainer::get_deadzone(ScrollContainer *this) {
   return *(undefined4*)( this + 0xa48 );
}
/* ScrollContainer::set_deadzone(int) */void ScrollContainer::set_deadzone(ScrollContainer *this, int param_1) {
   *(int*)( this + 0xa48 ) = param_1;
   return;
}
/* ScrollContainer::is_following_focus() const */ScrollContainer ScrollContainer::is_following_focus(ScrollContainer *this) {
   return this[0xa4c];
}
/* ScrollContainer::set_follow_focus(bool) */void ScrollContainer::set_follow_focus(ScrollContainer *this, bool param_1) {
   this[0xa4c] = (ScrollContainer)param_1;
   return;
}
/* ScrollContainer::get_h_scroll_bar() */undefined8 ScrollContainer::get_h_scroll_bar(ScrollContainer *this) {
   return *(undefined8*)( this + 0xa00 );
}
/* ScrollContainer::get_v_scroll_bar() */undefined8 ScrollContainer::get_v_scroll_bar(ScrollContainer *this) {
   return *(undefined8*)( this + 0xa08 );
}
/* ScrollContainer::get_draw_focus_border() */ScrollContainer ScrollContainer::get_draw_focus_border(ScrollContainer *this) {
   return this[0xa60];
}
/* ScrollContainer::get_minimum_size() const */void ScrollContainer::get_minimum_size(ScrollContainer *this) {
   float fVar1;
   int iVar2;
   long *plVar3;
   ...
   *(undefined8*)( this + 0xa10 ) = 0;
   for (iVar5 = 0; iVar2 = Node::get_child_count(SUB81(this, 0)),iVar5 < iVar2; iVar5 = iVar5 + 1) {
      ...
      if (( ( plVar3 != (long*)0x0 ) && ( *(long**)( this + 0xa00 ) != plVar3 ) ) && ( *(long**)( this + 0xa08 ) != plVar3 )) {
   ...
   if (*(int*)( this + 0xa40 ) == 0) {
      if (( ( *(int*)( this + 0xa44 ) - 2U & 0xfffffffd ) != 0 ) && ( ( *(int*)( this + 0xa44 ) != 1 || ( *(float*)( this + 0xa14 ) <= (float)( (ulong)uVar6 >> 0x20 ) ) ) )) goto LAB_001001c8;
   ...
   if (( iVar5 == 0 ) && ( ( ( ( *(int*)( this + 0xa40 ) - 2U & 0xfffffffd ) == 0 || ( ( *(int*)( this + 0xa40 ) == 1 && ( (float)uVar6 < *(float*)( this + 0xa10 ) ) ) ) ) && ( pSVar4 = (ScrollContainer*)Node::get_parent() ),this == pSVar4 ) )) {
      ( **(code**)( **(long**)( this + 0xa00 ) + 0x2f8 ) )();
   }

   LAB_001001c8:( **(code**)( **(long**)( this + 0xa50 ) + 0x1d0 ) )();
   return;
}
/* ScrollContainer::get_h_scroll() const */int ScrollContainer::get_h_scroll(void) {
   double dVar1;
   dVar1 = (double)Range::get_value();
   return (int)dVar1;
}
/* ScrollContainer::get_v_scroll() const */int ScrollContainer::get_v_scroll(void) {
   double dVar1;
   dVar1 = (double)Range::get_value();
   return (int)dVar1;
}
/* ScrollContainer::set_draw_focus_border(bool) */void ScrollContainer::set_draw_focus_border(ScrollContainer *this, bool param_1) {
...
/* ScrollContainer::_scroll_moved(float) */void ScrollContainer::_scroll_moved(float param_1) {
   Container::queue_sort();
   return;
}
/* ScrollContainer::set_horizontal_custom_step(float) */void ScrollContainer::set_horizontal_custom_step(float param_1) {
   ScrollBar::set_custom_step(param_1);
   return;
}
/* ScrollContainer::set_vertical_custom_step(float) */void ScrollContainer::set_vertical_custom_step(float param_1) {
   ScrollBar::set_custom_step(param_1);
   return;
}
/* ScrollContainer::get_horizontal_custom_step() const */void ScrollContainer::get_horizontal_custom_step(void) {
   ScrollBar::get_custom_step();
   return;
}
/* ScrollContainer::get_vertical_custom_step() const */void ScrollContainer::get_vertical_custom_step(void) {
   ScrollBar::get_custom_step();
   return;
}
/* ScrollContainer::set_horizontal_scroll_mode(ScrollContainer::ScrollMode) */void ScrollContainer::set_horizontal_scroll_mode(ScrollContainer *this, int param_2) {
...
/* ScrollContainer::set_vertical_scroll_mode(ScrollContainer::ScrollMode) */void ScrollContainer::set_vertical_scroll_mode(ScrollContainer *this, int param_2) {
...
/* ScrollContainer::_update_scrollbar_position() */void ScrollContainer::_update_scrollbar_position(ScrollContainer *this) {
   undefined8 uVar1;
   char cVar2;
   float fVar3;
...
/* std::_Function_handler<void (Node*, StringName const&, StringName const&),
   ...
   const&)#2}>::_M_manager(std::_Any_data&, std::_Any_data const&, std::_Manager_operation) */undefined8 std::_Function_handler<void(Node *, StringName_const &, StringName_const &),ScrollContainer::_bind_methods()::{lambda(Node*,StringName_const&,StringName_const&)#2}>::_M_manager(undefined8 *param_1, undefined8 param_2, int param_3) {
   if (param_3 == 0) {
...
/* std::_Function_handler<void (Node*, StringName const&, StringName const&),
   ScrollContainer::_bind_methods()::{lambda(Node*, StringName const&, StringName
   const&)#1}>::_M_manager(std::_Any_data&, std::_Any_data const&, std::_Manager_operation) */undefined8 std::_Function_handler<void(Node *, StringName_const &, StringName_const &),ScrollContainer::_bind_methods()::{lambda(Node*,StringName_const&,StringName_const&)#1}>::_M_manager(undefined8 *param_1, undefined8 param_2, int param_3) {
   if (param_3 == 0) {
      *param_1 = &ScrollContainer::_bind_methods()::
                {lambda(Node*,StringName_const&,StringName_const&)
      #1
...
/* ScrollContainer::_cancel_drag() */void __thiscall ScrollContainer::_cancel_drag(ScrollContainer *this)

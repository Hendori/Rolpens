/* AudioEffectEQ::get_band_count() const */undefined4 AudioEffectEQ::get_band_count(AudioEffectEQ *this) {
   if (*(long*)( this + 0x278 ) != 0) {
      return *(undefined4*)( *(long*)( this + 0x278 ) + -8 );
   }

   return 0;
}
/* AudioEffectEQ::get_band_gain_db(int) const */undefined4 AudioEffectEQ::get_band_gain_db(AudioEffectEQ *this, int param_1) {
   long lVar1;
   long lVar2;
   long lVar3;
   lVar1 = *(long*)( this + 0x278 );
   lVar2 = (long)param_1;
   if (param_1 < 0) {
      if (lVar1 != 0) {
         lVar3 = *(long*)( lVar1 + -8 );
      ...
      lVar3 = *(long*)( lVar1 + -8 );
      if (lVar2 < lVar3) {
         return *(undefined4*)( lVar1 + lVar2 * 4 );
      }
   ...
   lVar3 = 0;
   LAB_00100059:_err_print_index_error("get_band_gain_db", "servers/audio/effects/audio_effect_eq.cpp", 0x54, lVar2, lVar3, "p_band", "gain.size()", "", false, false);
   return 0;
}
...
/* AudioEffectEQ::set_band_gain_db(int, float) */void AudioEffectEQ::set_band_gain_db(AudioEffectEQ *this, int param_1, float param_2) {
   long lVar1;
   long lVar2;
   lVar1 = (long)param_1;
   lVar2 = *(long*)( this + 0x278 );
   if (param_1 < 0) {
      if (lVar2 != 0) {
         lVar2 = *(long*)( lVar2 + -8 );
         goto LAB_00100239;
      ...
      lVar2 = *(long*)( lVar2 + -8 );
      if (lVar1 < lVar2) {
         CowData<float>::_copy_on_write((CowData<float>*)( this + 0x278 ));
         *(float*)( *(long*)( this + 0x278 ) + lVar1 * 4 ) = param_2;
         return;
      }
   ...
   lVar2 = 0;
   LAB_00100239:_err_print_index_error("set_band_gain_db", "servers/audio/effects/audio_effect_eq.cpp", 0x4f, lVar1, lVar2, "p_band", "gain.size()", "", false, false);
   return;
}
/* CowData<EQ::BandProcess>::_copy_on_write() [clone .isra.0] */void CowData<EQ::BandProcess>::_copy_on_write(CowData<EQ::BandProcess> *this) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   undefined8 *puVar4;
...
/* AudioEffectEQInstance::process(AudioFrame const*, AudioFrame*, int) */void AudioEffectEQInstance::process(AudioEffectEQInstance *this, AudioFrame *param_1, AudioFrame *param_2, int param_3) {
   float fVar1;
   float fVar2;
   undefined8 uVar3;
   code *pcVar4;
   ...
   if (*(long*)( this + 0x1c0 ) == 0) {
      iVar15 = 0;
      CowData<EQ::BandProcess>::_copy_on_write((CowData<EQ::BandProcess>*)( this + 0x1c0 ));
      pfVar13 = *(float**)( this + 0x1c0 );
      CowData<EQ::BandProcess>::_copy_on_write((CowData<EQ::BandProcess>*)( this + 0x1d0 ));
      pfVar14 = *(float**)( this + 0x1d0 );
      CowData<float>::_copy_on_write((CowData<float>*)( this + 0x1e0 ));
      pfVar10 = *(float**)( this + 0x1e0 );
   }
 else {
      uVar3 = *(undefined8*)( *(long*)( this + 0x1c0 ) + -8 );
      CowData<EQ::BandProcess>::_copy_on_write((CowData<EQ::BandProcess>*)( this + 0x1c0 ));
      pfVar13 = *(float**)( this + 0x1c0 );
      iVar15 = (int)uVar3;
      CowData<EQ::BandProcess>::_copy_on_write((CowData<EQ::BandProcess>*)( this + 0x1d0 ));
      ...
      pfVar10 = *(float**)( this + 0x1e0 );
      if (0 < iVar15) {
         lVar11 = *(long*)( *(long*)( this + 0x1b0 ) + 0x278 );
         if (lVar11 == 0) {
            uVar8 = 0;
            lVar12 = 0;
            LAB_001005f3:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar8, lVar12, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
         ...
         do {
            ...
            if (lVar12 <= (long)uVar8) goto LAB_001005f3;
            fVar17 = expf(_LC15 * *(float*)( lVar11 + uVar8 * 4 ));
            pfVar10[uVar8] = fVar17;
 ...
 while ( bVar16 );
   ...
   if (0 < param_3) {
      ...
      do {
         while (true) {
            fVar17 = *(float*)( param_1 + lVar11 );
            fVar1 = *(float*)( param_1 + lVar11 + 4 );
            if (iVar15 < 1) break;
            fVar20 = 0.0;
            fVar21 = 0.0;
            pfVar5 = pfVar14;
            ...
            do {
               pfVar7 = pfVar6 + 1;
               fVar2 = pfVar9[4];
               fVar18 = ( ( fVar17 - pfVar9[5] ) * *pfVar9 + pfVar9[2] * pfVar9[7] ) - pfVar9[1] * pfVar9[8];
               pfVar9[3] = fVar17;
               pfVar9[4] = fVar17;
               pfVar9[5] = fVar2;
               pfVar9[6] = fVar18;
               *(ulong*)( pfVar9 + 7 ) = CONCAT44(pfVar9[7], fVar18);
               fVar2 = pfVar5[4];
               fVar19 = ( ( fVar1 - pfVar5[5] ) * *pfVar5 + pfVar5[2] * pfVar5[7] ) - pfVar5[1] * pfVar5[8];
               pfVar5[3] = fVar1;
               pfVar5[4] = fVar1;
               pfVar5[5] = fVar2;
               pfVar5[6] = fVar19;
               *(ulong*)( pfVar5 + 7 ) = CONCAT44(pfVar5[7], fVar19);
               fVar20 = fVar20 + fVar18 * *pfVar6;
               fVar21 = fVar21 + fVar19 * *pfVar6;
               pfVar5 = pfVar5 + 9;
               pfVar6 = pfVar7;
               pfVar9 = pfVar9 + 9;
            }
 while ( pfVar7 != pfVar10 + iVar15 );
            *(ulong*)( param_2 + lVar11 ) = CONCAT44(fVar21, fVar20);
            lVar11 = lVar11 + 8;
            if (lVar11 == (long)param_3 * 8) {
               return;
            }

         }
;
         *(undefined8*)( param_2 + lVar11 ) = 0;
         lVar11 = lVar11 + 8;
      }
 while ( lVar11 != (long)param_3 * 8 );
   }
...
/* AudioEffectEQ::_set(StringName const&, Variant const&) */undefined8 AudioEffectEQ::_set(AudioEffectEQ *this, StringName *param_1, Variant *param_2) {
   uint uVar1;
   long lVar2;
   ...
   if (*(int*)( this + 0x2ac ) != 0) {
      ...
      uVar14 = *(uint*)( *(long*)( this + 0x290 ) + lVar13 * 4 );
      uVar12 = SUB164(auVar3 * auVar7, 8);
      if (uVar14 != 0) {
         uVar15 = 0;
         while (( uVar11 != uVar14 || ( *(long*)( *(long*)( *(long*)( this + 0x288 ) + lVar13 * 8 ) + 0x10 ) != *(long*)param_1 ) )) {
            uVar15 = uVar15 + 1;
            auVar4._8_8_ = 0;
...
;
         lVar2 = *(long*)( *(long*)( this + 0x288 ) + (ulong)uVar12 * 8 );
         if (lVar2 != 0) {
            fVar17 = Variant::operator_cast_to_float(param_2);
            set_band_gain_db(this, *(int*)( lVar2 + 0x18 ), fVar17);
            return 1;
         }
...
/* AudioEffectEQ::_get(StringName const&, Variant&) const */undefined8 AudioEffectEQ::_get(AudioEffectEQ *this, StringName *param_1, Variant *param_2) {
   uint uVar1;
   long lVar2;
   undefined1 auVar3[16];
   undefined1 auVar4[16];
   ...
   if (( *(long*)( this + 0x288 ) != 0 ) && ( *(int*)( this + 0x2ac ) != 0 )) {
      ...
      uVar15 = *(uint*)( *(long*)( this + 0x290 ) + lVar14 * 4 );
      uVar13 = SUB164(auVar3 * auVar7, 8);
      if (uVar15 != 0) {
         uVar16 = 0;
         while (( uVar15 != uVar11 || ( *(long*)( *(long*)( *(long*)( this + 0x288 ) + lVar14 * 8 ) + 0x10 ) != *(long*)param_1 ) )) {
            uVar16 = uVar16 + 1;
            auVar4._8_8_ = 0;
            ...
            if (( uVar15 == 0 ) || ( auVar5._8_8_ = 0 ),auVar5._0_8_ = (ulong)uVar15 * lVar2,auVar9._8_8_ = 0,auVar9._0_8_ = uVar17,auVar6._8_8_ = 0,auVar6._0_8_ = ( ulong )(( uVar1 + uVar13 ) - SUB164(auVar5 * auVar9, 8)) * lVar2,auVar10._8_8_ = 0,auVar10._0_8_ = uVar17,SUB164(auVar6 * auVar10, 8) < uVar16) goto LAB_001009e8;
         }
;
         lVar2 = *(long*)( *(long*)( this + 0x288 ) + (ulong)uVar13 * 8 );
         if (lVar2 != 0) {
            fVar18 = (float)get_band_gain_db(this, *(int*)( lVar2 + 0x18 ));
   ...
   LAB_001009e8:uVar12 = 0;
   LAB_001009ea:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar12;
   }
...
/* AudioEffectEQ::_get_property_list(List<PropertyInfo, DefaultAllocator>*) const */void AudioEffectEQ::_get_property_list(AudioEffectEQ *this, List *param_1) {
   CowData *pCVar1;
   long *plVar2;
   code *pcVar3;
   undefined4 *puVar4;
   ...
   if (lVar5 != 0) {
      ...
      do {
         ...
         if (lVar5 == 0) {
            lVar8 = 0;
            LAB_00100d83:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar7, lVar8, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar3 = (code*)invalidInstructionException();
            ( *pcVar3 )();
         ...
         lVar8 = *(long*)( lVar5 + -8 );
         if (lVar8 <= lVar7) goto LAB_00100d83;
         pCVar1 = (CowData*)( lVar5 + lVar7 * 8 );
         ...
         if (local_90 == 0) {
            ...
            local_50 = 6;
            if (local_60 != 0x11) goto LAB_00100d29;
...
/* AudioEffectEQ::_bind_methods() */void AudioEffectEQ::_bind_methods(void) {
   long lVar1;
   code *pcVar2;
   long *plVar3;
   MethodBind *pMVar4;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   local_68 = 0;
   local_78 = PTR__LC31_0010a1e0;
   pcStack_70 = "volume_db";
   auStack_50._8_8_ = auStack_50._0_8_;
   auStack_50._0_8_ = &pcStack_70;
   local_58 = &local_78;
   D_METHODP((char*)local_98, (char***)"set_band_gain_db", ( uint ) & local_58);
   auStack_50 = (undefined1[16])0x0;
   local_58 = (char**)0x0;
   pMVar4 = create_method_bind<AudioEffectEQ,int,float>(set_band_gain_db);
 ...
 while ( lVar1 != lVar6 );
   ...
   pcStack_70 = (char*)0x0;
   local_58 = &local_78;
   D_METHODP((char*)local_98, (char***)"get_band_gain_db", ( uint ) & local_58);
   auStack_50 = (undefined1[16])0x0;
   local_58 = (char**)0x0;
   pMVar4 = create_method_bind<AudioEffectEQ,float,int>(get_band_gain_db);
   ClassDB::bind_methodfi(1, pMVar4, false, (MethodDefinition*)local_98, (Variant**)0x0, 0);
   if (Variant::needs_deinit[(int)local_58] != '\0') {
      Variant::_clear_internal();
   }
 ...
 while ( lVar1 != lVar6 );
   ...
   D_METHODP((char*)local_98, (char***)"get_band_count", 0);
   auStack_50 = (undefined1[16])0x0;
   local_58 = (char**)0x0;
   pMVar4 = create_method_bind<AudioEffectEQ,int>(get_band_count);
   ClassDB::bind_methodfi(1, pMVar4, false, (MethodDefinition*)local_98, (Variant**)0x0, 0);
   if (Variant::needs_deinit[(int)local_58] != '\0') {
      Variant::_clear_internal();
   }
...
/* Error CowData<float>::resize<false>(long) [clone .isra.0] */void CowData<float>::resize<false>(CowData<float> *this, long param_1) {
   ...
   LAB_00101512:_err_print_error("resize", "./core/templates/cowdata.h", uVar9, pcVar7, 0, 0);
   return;
}
/* AudioEffectEQ::AudioEffectEQ(EQ::Preset) */void AudioEffectEQ::AudioEffectEQ(AudioEffectEQ *this, undefined4 param_2) {
   EQ *this_00;
   ...
   *(undefined1(*) [16])( this + 0x298 ) = (undefined1[16])0x0;
   ...
   fVar9 = (float)( **(code**)( *plVar2 + 0x188 ) )(plVar2);
   EQ::set_mix_rate(fVar9);
   EQ::set_preset_band_mode(this_00, param_2);
   iVar1 = EQ::get_band_count();
   CowData<float>::resize<false>((CowData<float>*)( this + 0x278 ), (long)iVar1);
   lVar4 = *(long*)( this + 0x278 );
   do {
      ...
      CowData<float>::_copy_on_write((CowData<float>*)( this + 0x278 ));
      *(undefined4*)( *(long*)( this + 0x278 ) + lVar5 * 4 ) = 0;
      local_58 = &_LC43;
      local_60 = 0;
      local_50 = 3;
      String::parse_latin1((StrRange*)&local_60);
      EQ::get_band_frequency((int)this_00);
      itos((long)&local_58);
      operator+((char *)&
      local_68,(String*)"band_db/";
      ...
      puVar3 = (undefined4*)HashMap<StringName,int,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,int>>>::operator []((HashMap<StringName,int,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,int>>>*)( this + 0x280 ), (StringName*)&local_58);
      bVar8 = StringName::configured != '\0';
      *puVar3 = (int)lVar5;
      if (( bVar8 ) && ( local_58 != (undefined*)0x0 )) {
         StringName::unref();
      }

      local_58 = (undefined*)0x0;
      if (local_70 == 0) {
         LAB_00101642:lVar4 = *(long*)( this + 0x2b8 );
         puVar6 = (undefined*)local_70;
         lVar7 = local_70;
         if (lVar4 == 0) goto LAB_001018ab;
         LAB_00101652:lVar4 = *(long*)( lVar4 + -8 ) + 1;
      }
 else {
         plVar2 = (long*)( local_70 + -0x10 );
         do {
            lVar4 = *plVar2;
            if (lVar4 == 0) goto LAB_00101896;
            LOCK();
            lVar7 = *plVar2;
            bVar8 = lVar4 == lVar7;
            if (bVar8) {
 ...
 while ( !bVar8 );
         ...
         LAB_00101896:lVar4 = *(long*)( this + 0x2b8 );
         puVar6 = local_58;
         lVar7 = 0;
         if (lVar4 != 0) goto LAB_00101652;
         LAB_001018ab:lVar4 = 1;
         puVar6 = (undefined*)lVar7;
      }

      iVar1 = CowData<String>::resize<false>((CowData<String>*)( this + 0x2b8 ), lVar4);
      if (iVar1 == 0) {
         if (*(long*)( this + 0x2b8 ) == 0) {
            ...
            lVar4 = *(long*)( *(long*)( this + 0x2b8 ) + -8 );
            lVar7 = lVar4 + -1;
            if (-1 < lVar7) {
               CowData<String>::_copy_on_write((CowData<String>*)( this + 0x2b8 ));
               this_01 = (CowData<char32_t>*)( *(long*)( this + 0x2b8 ) + lVar7 * 8 );
               if (puVar6 != (undefined*)*(long*)this_01) {
      ...
      LAB_001016b2:if (puVar6 != (undefined*)0x0) {
         LOCK();
         plVar2 = (long*)( (long)puVar6 + -0x10 );
         *plVar2 = *plVar2 + -1;
         UNLOCK();
         if (*plVar2 == 0) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* AudioEffectEQ::instantiate() */long *AudioEffectEQ::instantiate(void) {
   Object *pOVar1;
   code *pcVar2;
   char cVar3;
   int iVar4;
   ...
   long lVar8;
   undefined8 *puVar9;
   CowData<EQ::BandProcess> *this_00;
   Object *pOVar10;
   Object *in_RSI;
   ulong uVar11;
   long *in_RDI;
   ...
   for (lVar8 = 0x3d; lVar8 != 0; lVar8 = lVar8 + -1) {
      *(undefined8*)pRVar12 = 0;
      pRVar12 = pRVar12 + (ulong)bVar16 * -0x10 + 8;
   }
   ...
   *(undefined***)this = &PTR__initialize_classv_00109b40;
   this[0x1a0] = (RefCounted)0x0;
   for (int i = 0; i < 3; i++) {
      *(undefined8*)( this + ( 16*i + 448 ) ) = 0;
   }
   ...
   *(undefined1(*) [16])( this + 0x1a8 ) = (undefined1[16])0x0;
   ...
   if (cVar3 == '\0') {
      if (pOVar1 == (Object*)0x0) goto LAB_00101aa4;
...
LAB_00101aa4:this_00 = (CowData<EQ::BandProcess>*)( (Object*)pRVar13 + 0x1c0 );iVar4 = EQ::get_band_count();CowData<float>::resize<false>((CowData<float>*)( (Object*)pRVar13 + 0x1e0 ), (long)iVar4);do {
   iVar4 = EQ::get_band_count();
   lVar8 = (long)iVar4;
   if (lVar8 < 0) {
      _err_print_error("resize", "./core/templates/cowdata.h", 0x157, "Condition \"p_size < 0\" is true. Returning: ERR_INVALID_PARAMETER", 0, 0);
   }
      ...
      if (lVar15 == 0) {
         if (lVar8 != 0) {
            lVar14 = 0;
            CowData<EQ::BandProcess>::_copy_on_write(this_00);
            LAB_00101ea4:uVar11 = lVar8 * 0x24 - 1;
            uVar11 = uVar11 | uVar11 >> 1;
            uVar11 = uVar11 | uVar11 >> 2;
            uVar11 = uVar11 >> 4 | uVar11;
            uVar11 = uVar11 >> 8 | uVar11;
            uVar11 = uVar11 >> 0x10 | uVar11;
            lVar15 = ( uVar11 | uVar11 >> 0x20 ) + 1;
            if (lVar14 < lVar8) {
               LAB_00101f10:if (lVar14 == 0) {
                  puVar6 = (undefined8*)Memory::alloc_static(lVar15 + 0x10, false);
                  if (puVar6 == (undefined8*)0x0) {
                     ...
                     *(undefined8**)this_00 = puVar9;
                     lVar15 = 0;
                     LAB_00101bc7:if (lVar15 < lVar8) {
                        do {
                           lVar14 = lVar15 + 1;
                           EQ::BandProcess::BandProcess((BandProcess*)( (long)puVar9 + lVar15 * 0x24 ));
 ...
 while ( lVar8 != lVar14 );
                  ...
                  iVar4 = CowData<EQ::BandProcess>::_realloc(this_00, lVar15);
                  if (iVar4 == 0) {
                     LAB_00101bb7:puVar9 = *(undefined8**)this_00;
                     if (puVar9 == (undefined8*)0x0) {
                        /* WARNING: Does not return */
                        pcVar2 = (code*)invalidInstructionException();
                        ( *pcVar2 )();
               ...
               LAB_00101ef4:iVar4 = CowData<EQ::BandProcess>::_realloc(this_00, lVar15);
         ...
         if (lVar8 != lVar14) {
            if (lVar8 == 0) {
               ...
               *plVar7 = *plVar7 + -1;
               ...
               lVar15 = uVar11 + 1;
               if (lVar14 * 0x24 == 0) goto LAB_00101ea4;
               uVar5 = lVar14 * 0x24 - 1;
               uVar5 = uVar5 | uVar5 >> 1;
               uVar5 = uVar5 | uVar5 >> 2;
               uVar5 = uVar5 | uVar5 >> 4;
               ...
               if (lVar14 < lVar8) {
                  if (uVar5 != uVar11) goto LAB_00101f10;
                  goto LAB_00101bb7;
               }

               if (uVar5 != uVar11) goto LAB_00101ef4;
               LAB_00101de9:if (*(long*)this_00 == 0) {
                  plVar7 = (long*)instantiate();
                  return plVar7;
               }

               *(long*)( *(long*)this_00 + -8 ) = lVar8;
            }
   ...
   lVar8 = *(long*)this_00;
   for (lVar15 = 0; ( lVar8 != 0 && ( lVar15 < *(long*)( lVar8 + -8 ) ) ); lVar15 = lVar15 + 1) {
      EQ::get_band_processor((int)&local_68);
      if (*(long*)this_00 == 0) {
         lVar8 = 0;
         LAB_00101c76:_err_print_index_error("operator[]", "./core/templates/vector.h", 0x38, lVar15, lVar8, "p_index", "((Vector<T> *)(this))->_cowdata.size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
      ...
      lVar8 = *(long*)( *(long*)this_00 + -8 );
      if (lVar8 <= lVar15) goto LAB_00101c76;
      CowData<EQ::BandProcess>::_copy_on_write(this_00);
      lVar8 = *(long*)this_00;
      puVar6 = (undefined8*)( lVar8 + lVar15 * 0x24 );
      *(undefined4*)( puVar6 + 4 ) = local_48;
      *puVar6 = local_68;
      puVar6[1] = uStack_60;
      puVar6[2] = local_58;
      puVar6[3] = uStack_50;
   ...
   if (this_00 == (CowData<EQ::BandProcess>*)( (Object*)pRVar13 + 0x1e0 )) {
      *in_RDI = 0;
      lVar8 = __dynamic_cast(pRVar13, &Object::typeinfo, &AudioEffectInstance::typeinfo, 0);
      if (lVar8 != 0) {
         *in_RDI = lVar8;
         cVar3 = RefCounted::reference();
         if (cVar3 == '\0') {
 ...
 while ( true );}/* DefaultAllocator::alloc(unsigned long) */void DefaultAllocator::alloc(ulong param_1) {
...
/* RefCounted::is_class_ptr(void*) const */uint RefCounted::is_class_ptr(RefCounted *this, void *param_1) {
   return (uint)CONCAT71(0x10a0, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x109f, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr);
}
...
/* AudioEffectEQInstance::is_class_ptr(void*) const */uint AudioEffectEQInstance::is_class_ptr(AudioEffectEQInstance *this, void *param_1) {
   return (uint)CONCAT71(0x109f, (undefined4*)param_1 == &AudioEffectInstance::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x109f, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x109f, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10a0, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* AudioEffectEQInstance::_getv(StringName const&, Variant&) const */undefined8 AudioEffectEQInstance::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* AudioEffectEQInstance::_setv(StringName const&, Variant const&) */undefined8 AudioEffectEQInstance::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* AudioEffectEQInstance::_validate_propertyv(PropertyInfo&) const */void AudioEffectEQInstance::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* AudioEffectEQInstance::_property_can_revertv(StringName const&) const */undefined8 AudioEffectEQInstance::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* AudioEffectEQInstance::_property_get_revertv(StringName const&, Variant&) const */undefined8 AudioEffectEQInstance::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* AudioEffectEQInstance::_notificationv(int, bool) */void AudioEffectEQInstance::_notificationv(int param_1, bool param_2) {
   return;
}
/* AudioEffectEQ::is_class_ptr(void*) const */uint AudioEffectEQ::is_class_ptr(AudioEffectEQ *this, void *param_1) {
   return (uint)CONCAT71(0x109f, (undefined4*)param_1 == &AudioEffect::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x109f, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x109f, (undefined4*)param_1 == &Resource::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x109f, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10a0, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* AudioEffectEQ::_validate_propertyv(PropertyInfo&) const */void AudioEffectEQ::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* AudioEffectEQ::_property_can_revertv(StringName const&) const */undefined8 AudioEffectEQ::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* AudioEffectEQ::_property_get_revertv(StringName const&, Variant&) const */undefined8 AudioEffectEQ::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* AudioEffectEQ::_notificationv(int, bool) */void AudioEffectEQ::_notificationv(int param_1, bool param_2) {
   return;
}
...
/* RefCounted::~RefCounted() */void RefCounted::~RefCounted(RefCounted *this) {
   *(undefined***)this = &PTR__initialize_classv_001099e0;
...
/* MethodBindT<int, float>::~MethodBindT() */void MethodBindT<int,float>::~MethodBindT(MethodBindT<int,float> *this) {
   *(undefined***)this = &PTR__gen_argument_type_00109e90;
...
/* MethodBindTRC<float, int>::~MethodBindTRC() */void MethodBindTRC<float,int>::~MethodBindTRC(MethodBindTRC<float,int> *this) {
   *(undefined***)this = &PTR__gen_argument_type_00109ef0;
   MethodBind::~MethodBind((MethodBind*)this);
   return;
}
/* MethodBindTRC<float, int>::~MethodBindTRC() */void MethodBindTRC<float,int>::~MethodBindTRC(MethodBindTRC<float,int> *this) {
...
/* MethodBindTRC<int>::~MethodBindTRC() */void MethodBindTRC<int>::~MethodBindTRC(MethodBindTRC<int> *this) {
   *(undefined***)this = &PTR__gen_argument_type_00109f50;
   MethodBind::~MethodBind((MethodBind*)this);
   return;
}
/* MethodBindTRC<int>::~MethodBindTRC() */void MethodBindTRC<int>::~MethodBindTRC(MethodBindTRC<int> *this) {
...
/* CowData<EQ::BandProcess>::_copy_on_write() [clone .isra.0] [clone .cold] */void CowData<EQ::BandProcess>::_copy_on_write(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* AudioEffectEQ::_bind_methods() [clone .cold] */void AudioEffectEQ::_bind_methods(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void FUN_00102630(void) {
   code *pcVar1;
   _DAT_00000000 = 0;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* AudioEffectEQ::instantiate() [clone .cold] */void AudioEffectEQ::instantiate(void) {
   code *pcVar1;
   _DAT_00000000 = 0;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
...
/* AudioEffectEQInstance::~AudioEffectEQInstance() */void AudioEffectEQInstance::~AudioEffectEQInstance(AudioEffectEQInstance *this) {
   long *plVar1;
   long lVar2;
   Object *pOVar3;
   char cVar4;
   AudioEffectEQInstance *pAVar5;
   bool bVar6;
   *(undefined***)this = &PTR__initialize_classv_00109b40;
   ...
   do {
      if (*(long*)( pAVar5 + 8 ) != 0) {
         LOCK();
         plVar1 = (long*)( *(long*)( pAVar5 + 8 ) + -0x10 );
         *plVar1 = *plVar1 + -1;
         UNLOCK();
         if (*plVar1 == 0) {
            lVar2 = *(long*)( pAVar5 + 8 );
   ...
   *(code**)this = __cxa_guard_acquire;
   if (bVar6) {
      if (*(long*)( this + 0x198 ) != 0) {
         StringName::unref();
         if (StringName::configured == '\0') goto LAB_0010277d;
      }
   ...
   LAB_0010277d:*(undefined***)this = &PTR__initialize_classv_001099e0;
   Object::~Object((Object*)this);
   return;
}
/* AudioEffectEQInstance::~AudioEffectEQInstance() */void AudioEffectEQInstance::~AudioEffectEQInstance(AudioEffectEQInstance *this) {
 ...
 while ( this + 0x1a8 != pAVar5 );
   ...
   *(code**)this = __cxa_guard_acquire;
   if (bVar6) {
      if (*(long*)( this + 0x198 ) != 0) {
         StringName::unref();
         if (StringName::configured == '\0') goto LAB_001028cd;
      }
   ...
   LAB_001028cd:*(undefined***)this = &PTR__initialize_classv_001099e0;
   Object::~Object((Object*)this);
   operator_delete(this, 0x1e8);
   return;
}
/* AudioEffectEQInstance::_get_class_namev() const */undefined8 *AudioEffectEQInstance::_get_class_namev(void) {
   int iVar1;
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001029a3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001029a3;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "AudioEffectEQInstance");
         goto LAB_00102a0e;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "AudioEffectEQInstance");
   LAB_00102a0e:return &_get_class_namev();
}
/* AudioEffectEQ::_get_class_namev() const */undefined8 *AudioEffectEQ::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00102a93:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00102a93;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "AudioEffectEQ");
         goto LAB_00102afe;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "AudioEffectEQ");
   LAB_00102afe:return &_get_class_namev();
}
/* RefCounted::_get_class_namev() const */undefined8 *RefCounted::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00102b73:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00102b73;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "RefCounted");
   LAB_00102bde:return &_get_class_namev();
}
/* AudioEffectEQ::_setv(StringName const&, Variant const&) */undefined8 AudioEffectEQ::_setv(AudioEffectEQ *this, StringName *param_1, Variant *param_2) {
   uint uVar1;
   long lVar2;
   undefined1 auVar3[16];
   undefined1 auVar4[16];
...
/* AudioEffectEQInstance::get_class() const */void AudioEffectEQInstance::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* AudioEffectEQ::get_class() const */void AudioEffectEQ::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* RefCounted::is_class(String const&) const */undefined8 RefCounted::is_class(RefCounted *this, String *param_1) {
 ...
 while ( !bVar9 );
      ...
      LAB_0010306f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
 ...
 while ( !bVar9 );
         ...
         LAB_001031d3:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
      ...
      LAB_00103123:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* AudioEffectEQInstance::is_class(String const&) const */undefined8 AudioEffectEQInstance::is_class(AudioEffectEQInstance *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long lVar4;
 ...
 while ( !bVar9 );
      ...
      LAB_0010330f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
      ...
      if (cVar6 != '\0') goto LAB_001033c3;
   }

   cVar6 = String::operator ==(param_1, "AudioEffectEQInstance");
   if (cVar6 == '\0') {
      for (lVar2 = *(long*)( this + 8 ); lVar2 != 0; lVar2 = *(long*)( lVar2 + 8 )) {
         lVar4 = *(long*)( lVar2 + 0x20 );
         if (lVar4 == 0) {
 ...
 while ( !bVar9 );
         ...
         LAB_00103483:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
   ...
   LAB_001033c3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0010352c:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindTRC<int>::_gen_argument_type_info(int) const */undefined4 *MethodBindTRC<int>::_gen_argument_type_info(int param_1) {
   ...
   *(undefined1(*) [16])( puVar3 + 2 ) = (undefined1[16])0x0;
   ...
   lVar2 = local_58;
   joined_r0x0010367c:local_58 = lVar2;
   if (lVar2 != 0) {
      LOCK();
      plVar1 = (long*)( lVar2 + -0x10 );
      *plVar1 = *plVar1 + -1;
...
/* RefCounted::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void RefCounted::_get_property_listv(List *param_1, bool param_2) {
   ...
   local_58 = 0;
   if (local_90 == 0) {
      LAB_001039c8:local_50 = 0x80;
      StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_58, (CowData*)&local_90);
      local_50 = 0x80;
      if (local_60 != 0x11) goto LAB_001039c8;
      StringName::StringName((StringName*)&local_80, (String*)&local_58, false);
      if (local_68 != local_80) {
         StringName::unref();
         lVar2 = *(long*)pLVar6;
         local_68 = local_80;
         goto joined_r0x001039e6;
      }
...
/* AudioEffectEQ::is_class(String const&) const */undefined8 AudioEffectEQ::is_class(AudioEffectEQ *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long lVar4;
 ...
 while ( !bVar9 );
      ...
      LAB_00103ccf:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
      ...
      if (cVar6 != '\0') goto LAB_00103d83;
   }

   cVar6 = String::operator ==(param_1, "AudioEffectEQ");
   if (cVar6 == '\0') {
      for (lVar2 = *(long*)( this + 8 ); lVar2 != 0; lVar2 = *(long*)( lVar2 + 8 )) {
         lVar4 = *(long*)( lVar2 + 0x20 );
         if (lVar4 == 0) {
 ...
 while ( !bVar9 );
         ...
         LAB_00103e6b:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
 ...
 while ( !bVar9 );
            ...
            LAB_00103f4b:cVar6 = String::operator ==(param_1, (String*)&local_60);
            lVar4 = local_60;
            if (local_60 != 0) {
               LOCK();
               plVar1 = (long*)( local_60 + -0x10 );
   ...
   LAB_00103d83:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_00103ff4:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* AudioEffectEQInstance::_initialize_classv() */void AudioEffectEQInstance::_initialize_classv(void) {
   long *plVar1;
   long lVar2;
   long in_FS_OFFSET;
   long local_70;
   ...
   if (initialize_class() == '\0') {
      ...
      String::parse_latin1((StrRange*)&local_68);
      StringName::StringName((StringName*)&local_60, (String*)&local_68, false);
      local_58 = "AudioEffectEQInstance";
      local_70 = 0;
      local_50 = 0x15;
      String::parse_latin1((StrRange*)&local_70);
      StringName::StringName((StringName*)&local_58, (String*)&local_70, false);
...
/* MethodBindT<int, float>::_gen_argument_type_info(int) const */undefined4 *MethodBindT<int,float>::_gen_argument_type_info(int param_1) {
   ...
   *(undefined1(*) [16])( puVar9 + 2 ) = (undefined1[16])0x0;
   ...
   if (local_70 == 0) {
      ...
      local_30 = 6;
      if (local_40 != 0x11) goto LAB_00104558;
   ...
   *puVar9 = local_58._0_4_;
   ...
   LAB_00104470:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* MethodBindTRC<float, int>::_gen_argument_type_info(int) const */undefined4 *MethodBindTRC<float,int>::_gen_argument_type_info(int param_1) {
   ...
   if (in_EDX != 0) {
      ...
      *(undefined1(*) [16])( puVar8 + 2 ) = (undefined1[16])0x0;
      if (local_a0 == 0) {
         puVar8[10] = 6;
         LAB_001049b7:StringName::operator =((StringName*)( puVar8 + 4 ), (StringName*)&local_98);
         uVar4 = local_a0;
      }
 else {
         CowData<char32_t>::_ref((CowData<char32_t>*)( puVar8 + 8 ), (CowData*)&local_a0);
         puVar8[10] = 6;
         if (puVar8[6] != 0x11) goto LAB_001049b7;
   ...
   if (local_b0 == 0) {
      ...
      local_40 = 6;
      if (local_50 != 0x11) goto LAB_00104a00;
   ...
   *(long*)( puVar8 + 8 ) = local_78;
   puVar8[10] = local_70;
   LAB_00104983:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return puVar8;
   }
...
/* Resource::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Resource::_get_property_listv(Resource *this, List *param_1, bool param_2) {
   ...
   local_58 = 0;
   if (local_90 == 0) {
      LAB_00104db8:local_50 = 0x80;
      StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_58, (CowData*)&local_90);
      local_50 = 0x80;
      if (local_60 != 0x11) goto LAB_00104db8;
      StringName::StringName((StringName*)&local_80, (String*)&local_58, false);
      if (local_68 != local_80) {
         StringName::unref();
         lVar2 = *(long*)param_1;
         local_68 = local_80;
         goto joined_r0x00104dd5;
      }
...
/* AudioEffectInstance::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void AudioEffectInstance::_get_property_listv(AudioEffectInstance *this, List *param_1, bool param_2) {
   ...
   local_58 = 0;
   if (local_90 == 0) {
      LAB_00105208:local_50 = 0x80;
      StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_58, (CowData*)&local_90);
      local_50 = 0x80;
      if (local_60 != 0x11) goto LAB_00105208;
      StringName::StringName((StringName*)&local_80, (String*)&local_58, false);
      if (local_68 != local_80) {
         StringName::unref();
         lVar2 = *(long*)param_1;
         local_68 = local_80;
         goto joined_r0x00105225;
      }
...
/* AudioEffectEQInstance::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void AudioEffectEQInstance::_get_property_listv(AudioEffectEQInstance *this, List *param_1, bool param_2) {
   long *plVar1;
   long lVar2;
   long lVar3;
   undefined1(*pauVar4)[16];
   ...
   local_88 = 0;
   local_90 = 0;
   local_78 = "AudioEffectEQInstance";
   local_70 = 0x15;
   String::parse_latin1((StrRange*)&local_90);
   local_78 = "AudioEffectEQInstance";
   local_98 = 0;
   ...
   local_58 = 0;
   if (local_90 == 0) {
      LAB_00105658:local_50 = 0x80;
      StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_58, (CowData*)&local_90);
      local_50 = 0x80;
      if (local_60 != 0x11) goto LAB_00105658;
      StringName::StringName((StringName*)&local_80, (String*)&local_58, false);
      if (local_68 != local_80) {
         StringName::unref();
         lVar2 = *(long*)param_1;
         local_68 = local_80;
         goto joined_r0x00105675;
      }
   ...
   *(int*)( plVar1 + 2 ) = (int)plVar1[2] + 1;
   ...
   StringName::StringName((StringName*)&local_78, "AudioEffectEQInstance", false);
   ClassDB::get_property_list((StringName*)&local_78, param_1, true, (Object*)this);
   if (( StringName::configured != '\0' ) && ( local_78 != (char*)0x0 )) {
      StringName::unref();
   }
...
/* AudioEffect::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void AudioEffect::_get_property_listv(AudioEffect *this, List *param_1, bool param_2) {
   ...
   local_58 = 0;
   if (local_90 == 0) {
      LAB_00105aa8:local_50 = 0x80;
      StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_58, (CowData*)&local_90);
      local_50 = 0x80;
      if (local_60 != 0x11) goto LAB_00105aa8;
      StringName::StringName((StringName*)&local_80, (String*)&local_58, false);
      if (local_68 != local_80) {
         StringName::unref();
         lVar2 = *(long*)param_1;
         local_68 = local_80;
         goto joined_r0x00105ac5;
      }
...
/* AudioEffectEQ::_getv(StringName const&, Variant&) const */void AudioEffectEQ::_getv(AudioEffectEQ *this, StringName *param_1, Variant *param_2) {
   _get(this, param_1, param_2);
   return;
}
/* AudioEffectEQ::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void AudioEffectEQ::_get_property_listv(AudioEffectEQ *this, List *param_1, bool param_2) {
   long *plVar1;
   long lVar2;
   long lVar3;
   undefined1(*pauVar4)[16];
   ...
   local_58 = 0;
   if (local_90 == 0) {
      LAB_00105f18:local_50 = 0x80;
      StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_58, (CowData*)&local_90);
      local_50 = 0x80;
      if (local_60 != 0x11) goto LAB_00105f18;
      StringName::StringName((StringName*)&local_80, (String*)&local_58, false);
      if (local_68 != local_80) {
         StringName::unref();
         lVar2 = *(long*)param_1;
   ...
   *(int*)( plVar1 + 2 ) = (int)plVar1[2] + 1;
   ...
   StringName::StringName((StringName*)&local_78, "AudioEffectEQ", false);
   ClassDB::get_property_list((StringName*)&local_78, param_1, true, (Object*)this);
   if (( StringName::configured != '\0' ) && ( local_78 != (char*)0x0 )) {
      StringName::unref();
   }
...
::operator[](HashMap<StringName,int,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,int>>>
 ...
 while ( uVar40 != uVar45 );
         ...
         LAB_001067cc:if (iVar46 != 0) {
            LAB_001067d4:uVar38 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
 ...
 while ( ( uVar52 != 0 ) && ( auVar19._8_8_ = 0 ),auVar19._0_8_ = (ulong)uVar52 * lVar43,auVar35._8_8_ = 0,auVar35._0_8_ = uVar45,auVar20._8_8_ = 0,auVar20._0_8_ = ( ulong )(( uVar38 + uVar53 ) - SUB164(auVar19 * auVar35, 8)) * lVar43,auVar36._8_8_ = 0,auVar36._0_8_ = uVar45,uVar54 <= SUB164(auVar20 * auVar36, 8) );
      ...
      iVar46 = *(int*)( this + 0x2c );
      if (pvVar44 == (void*)0x0) goto LAB_00106403;
      if (iVar46 != 0) goto LAB_001067d4;
      LAB_00106429:uVar38 = *(uint*)( this + 0x28 );
      if (uVar38 == 0x1c) {
...
;
 ...
 while ( ( uVar52 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = (ulong)uVar52 * lVar49,auVar23._8_8_ = 0,auVar23._0_8_ = uVar40,auVar8._8_8_ = 0,auVar8._0_8_ = ( ulong )(( uVar53 + uVar38 ) - SUB164(auVar7 * auVar23, 8)) * lVar49,auVar24._8_8_ = 0,auVar24._0_8_ = uVar40,uVar54 <= SUB164(auVar8 * auVar24, 8) );
         ...
         if (lVar43 == 0) goto LAB_00106918;
         LAB_001067c8:iVar46 = *(int*)( this + 0x2c );
         goto LAB_001067cc;
      }

      LAB_00106403:if ((float)uVar40 * __LC25 < (float)( iVar46 + 1 )) goto LAB_00106429;
   }
   ...
   *(undefined4*)( puVar42 + 3 ) = local_50;
   ...
   if (puVar4 == (undefined8*)0x0) {
      ...
      *(undefined8**)( this + 0x20 ) = puVar42;
      if (lVar43 == 0) goto LAB_001068dd;
      LAB_001066b4:uVar38 = *(uint*)( lVar43 + 0x20 );
   }
 else {
      *puVar4 = puVar42;
      puVar42[1] = puVar4;
      lVar43 = *(long*)param_1;
      *(undefined8**)( this + 0x20 ) = puVar42;
      if (lVar43 != 0) goto LAB_001066b4;
      LAB_001068dd:uVar38 = StringName::get_empty_hash();
   }
...
;
   ...
   *puVar1 = uVar38;
   *(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;
   LAB_001063cc:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return puVar42 + 3;
   }
...
/* MethodBind* create_method_bind<AudioEffectEQ, int, float>(void (AudioEffectEQ::*)(int, float)) */MethodBind *create_method_bind<AudioEffectEQ,int,float>(_func_void_int_float *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<AudioEffectEQ, float, int>(float (AudioEffectEQ::*)(int) const) */MethodBind *create_method_bind<AudioEffectEQ,float,int>(_func_float_int *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<AudioEffectEQ, int>(int (AudioEffectEQ::*)() const) */MethodBind *create_method_bind<AudioEffectEQ,int>(_func_int *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* AudioEffectEQ::_initialize_classv() */void AudioEffectEQ::_initialize_classv(void) {
   long *plVar1;
   long lVar2;
   long in_FS_OFFSET;
   long local_70;
   ...
   if (initialize_class() == '\0') {
      if (AudioEffect::initialize_class() == '\0') {
         ...
         if ((code*)PTR__bind_methods_0010d018 != Resource::_bind_methods) {
...
/* AudioEffectEQ::~AudioEffectEQ() */void AudioEffectEQ::~AudioEffectEQ(AudioEffectEQ *this) {
   long *plVar1;
   uint uVar2;
   long lVar3;
   void *pvVar4;
   bool bVar5;
   *(undefined***)this = &PTR__initialize_classv_00109cb0;
   CowData<String>::_unref((CowData<String>*)( this + 0x2b8 ));
   pvVar4 = *(void**)( this + 0x288 );
   if (pvVar4 != (void*)0x0) {
      if (*(int*)( this + 0x2ac ) != 0) {
         uVar2 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x2a8 ) * 4 );
         if (uVar2 == 0) {
            ...
            *(undefined1(*) [16])( this + 0x298 ) = (undefined1[16])0x0;
            ...
            lVar3 = 0;
            do {
               if (*(int*)( *(long*)( this + 0x290 ) + lVar3 ) != 0) {
                  bVar5 = StringName::configured != '\0';
                  *(int*)( *(long*)( this + 0x290 ) + lVar3 ) = 0;
 ...
 while ( lVar3 != (ulong)uVar2 << 2 );
            *(undefined4*)( this + 0x2ac ) = 0;
            *(undefined1(*) [16])( this + 0x298 ) = (undefined1[16])0x0;
            if (pvVar4 == (void*)0x0) goto LAB_001074d5;
         }
   ...
   LAB_001074d5:if (*(long*)( this + 0x278 ) != 0) {
      LOCK();
      plVar1 = (long*)( *(long*)( this + 0x278 ) + -0x10 );
      *plVar1 = *plVar1 + -1;
      UNLOCK();
      if (*plVar1 == 0) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<String>::resize<false>(long) */undefined8 CowData<String>::resize<false>(CowData<String> *this, long param_1) {
   ...
   if (param_1 * 8 == 0) {
      LAB_00107950:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   lVar10 = uVar8 + 1;
   if (lVar10 == 0) goto LAB_00107950;
   if (param_1 <= lVar6) {
      lVar6 = *(long*)this;
      uVar8 = param_1;
      while (lVar6 != 0) {
         if (*(ulong*)( lVar6 + -8 ) <= uVar8) {
            LAB_00107829:if (lVar10 != lVar7) {
         ...
         while (true) {
            ...
            if (*plVar2 != 0) break;
            uVar8 = uVar8 + 1;
            if (*(ulong*)( lVar6 + -8 ) <= uVar8) goto LAB_00107829;
         }
;
         LOCK();
...
;
   ...
   if (lVar10 == lVar7) {
      LAB_001078cf:puVar9 = *(undefined8**)this;
      if (puVar9 == (undefined8*)0x0) {
         LAB_001079a6:/* WARNING: Does not return */pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
      }

      lVar6 = puVar9[-1];
      if (param_1 <= lVar6) goto LAB_001078ba;
   }
 else {
      if (lVar6 != 0) {
         uVar4 = _realloc(this, lVar10);
...
/* CowData<EQ::BandProcess>::_realloc(long) */undefined8 CowData<EQ::BandProcess>::_realloc(CowData<EQ::BandProcess> *this, long param_1) {
   undefined8 *puVar1;
   puVar1 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), param_1 + 0x10, false);
   if (puVar1 != (undefined8*)0x0) {
      *puVar1 = 1;
...
/* WARNING: Removing unreachable block (ram,0x00107c18) *//* WARNING: Removing unreachable block (ram,0x00107d48) *//* WARNING: Removing unreachable block (ram,0x00107f10) *//* WARNING: Removing unreachable block (ram,0x00107d54) *//* WARNING: Removing unreachable block (ram,0x00107d5e) *//* WARNING: Removing unreachable block (ram,0x00107ef0) *//* WARNING: Removing unreachable block (ram,0x00107d6a) *//* WARNING: Removing unreachable block (ram,0x00107d74) *//* WARNING: Removing unreachable block (ram,0x00107ed0) *//* WARNING: Removing unreachable block (ram,0x00107d80) *//* WARNING: Removing unreachable block (ram,0x00107d8a) *//* WARNING: Removing unreachable block (ram,0x00107eb0) *//* WARNING: Removing unreachable block (ram,0x00107d96) *//* WARNING: Removing unreachable block (ram,0x00107da0) *//* WARNING: Removing unreachable block (ram,0x00107e90) *//* WARNING: Removing unreachable block (ram,0x00107dac) *//* WARNING: Removing unreachable block (ram,0x00107db6) *//* WARNING: Removing unreachable block (ram,0x00107e70) *//* WARNING: Removing unreachable block (ram,0x00107dc2) *//* WARNING: Removing unreachable block (ram,0x00107dcc) *//* WARNING: Removing unreachable block (ram,0x00107e50) *//* WARNING: Removing unreachable block (ram,0x00107dd4) *//* WARNING: Removing unreachable block (ram,0x00107dea) *//* WARNING: Removing unreachable block (ram,0x00107df6) *//* String vformat<StringName>(String const&, StringName const) */undefined8 *vformat<StringName>(undefined8 *param_1, bool *param_2, StringName *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* MethodBindTRC<int>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindTRC<int>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   ...
   LAB_001080e0:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTRC<int>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTRC<int>::validated_call(MethodBindTRC<int> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   *(long*)( param_3 + 8 ) = (long)iVar3;
   LAB_001083d4:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<int>::ptrcall(Object*, void const**, void*) const */void MethodBindTRC<int>::ptrcall(MethodBindTRC<int> *this, Object *param_1, void **param_2, void *param_3) {
   ...
   *(long*)param_3 = (long)iVar3;
   LAB_001085d3:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<float, int>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTRC<float,int>::validated_call(MethodBindTRC<float,int> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   *(double*)( param_3 + 8 ) = (double)fVar5;
   LAB_001087de:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<float, int>::ptrcall(Object*, void const**, void*) const */void MethodBindTRC<float,int>::ptrcall(MethodBindTRC<float,int> *this, Object *param_1, void **param_2, void *param_3) {
   ...
   *(double*)param_3 = (double)fVar5;
   LAB_001089fc:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindT<int, float>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<int,float>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      ...
      /* WARNING: Could not recover jumptable at 0x00108c35. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *UNRECOVERED_JUMPTABLE )(auVar5._0_8_, (long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), *(undefined4*)( *(long*)param_3 + 8 ));
      return;
   }

   LAB_00108df5:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<int, float>::ptrcall(Object*, void const**, void*) const */void MethodBindT<int,float>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   ...
   if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      ...
      /* WARNING: Could not recover jumptable at 0x00108e63. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *UNRECOVERED_JUMPTABLE )(auVar4._0_8_, (long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), **param_3);
      return;
   }

   LAB_0010901d:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (( ( plVar11 != (long*)0x0 ) && ( plVar11[1] != 0 ) ) && ( *(char*)( plVar11[1] + 0x2e ) != '\0' )) {
      ...
      if (local_58 == (char*)*plVar9) {
         ...
         String::parse_latin1((StrRange*)&local_60);
         vformat<StringName>((StringName*)&local_58, (StrRange*)&local_60, &local_68);
         _err_print_error(&_LC63, "./core/object/method_bind.h", 0x267, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: ret", (StringName*)&local_58, 0);
         pcVar5 = local_58;
         if (local_58 != (char*)0x0) {
            LOCK();
   ...
   if (in_R8D < 2) {
      ...
      if (pVVar12 == (Variant*)0x0) {
         if (in_R8D != 1) goto LAB_001091a0;
         LAB_00109190:pVVar12 = *(Variant**)param_4;
      }
 else {
         lVar2 = *(long*)( pVVar12 + -8 );
         if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
            LAB_001091a0:uVar8 = 4;
            goto LAB_0010914d;
         }

         if (in_R8D == 1) goto LAB_00109190;
      ...
      *(undefined8*)( param_1 + 0x10 ) = uStack_38;
      ...
      uVar8 = 3;
      LAB_0010914d:*in_R9 = uVar8;
      in_R9[2] = 1;
   }

   LAB_00109158:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* void call_with_variant_args_dv<__UnexistingClass, int, float>(__UnexistingClass*, void
   ...
   if (lVar1 == 0) {
      if (iVar6 == 0) {
         this(Variant * ) * plVar8;
         LAB_0010954d:this_00 = (Variant*)plVar8[1];
         goto LAB_00109475;
      }
      ...
      if (iVar6 <= iVar11) {
         if (uVar10 == 0) {
            lVar9 = (long)( iVar11 + -2 );
            if (lVar2 <= lVar9) goto LAB_00109568;
            this(Variant * )(lVar1 + lVar9 * 0x18);
         }
 else {
            this(Variant * ) * plVar8;
            if (uVar10 == 2) goto LAB_0010954d;
         }

         lVar9 = (long)(int)( ( uVar10 ^ 1 ) + ( iVar11 - iVar6 ) );
         if (lVar2 <= lVar9) {
            LAB_00109568:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar9, lVar2, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar3 = (code*)invalidInstructionException();
            ( *pcVar3 )();
         ...
         LAB_00109475:*(undefined4*)param_6 = 0;
         ...
         /* WARNING: Could not recover jumptable at 0x001094ff. Too many branches */
         /* WARNING: Treating indirect jump as call */
   ...
   uVar7 = 4;
   LAB_00109515:*(undefined4*)param_6 = uVar7;
...
/* MethodBindT<int, float>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindT<int,float>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   call_with_variant_args_dv<__UnexistingClass,int,float>(p_Var4, (_func_void_int_float*)param_2[0xb], (Variant**)param_2[0xc], (int)param_4, in_R8, in_R9);
   *(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
...
/* WARNING: Control flow encountered bad instruction data *//* AudioEffectEQ::~AudioEffectEQ() */void AudioEffectEQ::~AudioEffectEQ(AudioEffectEQ *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* AudioEffectEQInstance::~AudioEffectEQInstance() */void AudioEffectEQInstance::~AudioEffectEQInstance(AudioEffectEQInstance *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

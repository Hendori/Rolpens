/* RenderingContextDriverVulkan::get_tracked_object_name(unsigned int) const */undefined8 RenderingContextDriverVulkan::get_tracked_object_name(RenderingContextDriverVulkan *this, uint param_1) {
   return *(undefined8*)( get_tracked_object_name(unsigned_int) );
}
/* RenderingContextDriverVulkan::get_tracked_object_type_count() const */undefined8 RenderingContextDriverVulkan::get_tracked_object_type_count(void) {
   return 0x21;
}
/* _FUN(void*, unsigned long, VkInternalAllocationType, VkSystemAllocationScope) */void RenderingContextDriverVulkan::get_allocation_callbacks(VkObjectType)::

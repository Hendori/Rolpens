...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<Label3D::SurfaceKey, Label3D::SurfaceData, Label3D::SurfaceKeyHasher,
   ...
   >::operator[](Label3D::SurfaceKey const&) */undefined1(*)[16];HashMap<Label3D::SurfaceKey,Label3D::SurfaceData,Label3D::SurfaceKeyHasher,HashMapComparatorDefault<Label3D::SurfaceKey>,DefaultTypedAllocator<HashMapElement<Label3D::SurfaceKey,Label3D::SurfaceData>>>::operator [](HashMap<Label3D::SurfaceKey,Label3D::SurfaceData,Label3D::SurfaceKeyHasher,HashMapComparatorDefault<Label3D::SurfaceKey>,DefaultTypedAllocator<HashMapElement<Label3D::SurfaceKey,Label3D::SurfaceData>>> *this, SurfaceKey *param_1) {
   uint *puVar1;
   undefined8 *puVar2;
   int iVar3;
   void *pvVar4;
   ...
   undefined1 auVar37[16] = ( *,pauVar38 );
   [16](*, pauVar42)[16](*, pauVar56)[16]
   ;;
   ;;
   long in_FS_OFFSET;
   void *local_178;
   ...
   SurfaceData local_b8[8](ulong) = ( local_178 != (void*)0x0 );
   ( *(int*)( this,+ 0x2c ) = 0 );
   {
...
;
   ...
   *puVar1 = uVar47;
   *(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;
   LAB_001139e7:Label3D::SurfaceData::~SurfaceData(local_148);
   LAB_001132ef:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return pauVar42 + 2;
   }
...
/* Ref<Font>::unref() */void Ref<Font>::unref(Ref<Font> *this) {
   Object *pOVar1;
   char cVar2;
   if (*(long*)this != 0) {
      cVar2 = RefCounted::unreference();

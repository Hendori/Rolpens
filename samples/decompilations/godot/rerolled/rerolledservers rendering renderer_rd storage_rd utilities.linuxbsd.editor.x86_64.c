/* RendererRD::Utilities::get_rendering_info(RenderingServer::RenderingInfo) */undefined8 RendererRD::Utilities::get_rendering_info(Utilities *this, int param_2) {
   if (param_2 == 3) {
...
/* RendererRD::Utilities::visibility_notifier_get_aabb(RID) const */undefined8 *RendererRD::Utilities::visibility_notifier_get_aabb(undefined8 *param_1, long param_2, ulong param_3) {
   undefined8 uVar1;
   undefined8 uVar2;
   undefined8 *puVar3;
   ...
   _err_print_error("visibility_notifier_get_aabb", "servers/rendering/renderer_rd/storage_rd/utilities.cpp", 0xc0, "Parameter \"vn\" is null.", 0, 0);
   *param_1 = 0;
...
/* RendererRD::Utilities::visibility_notifier_free(RID) */long RendererRD::Utilities::visibility_notifier_free(Utilities *this, ulong param_2) {
   ulong uVar1;
   uint uVar2;
   int iVar3;
   uint uVar4;
   ...
   lVar5 = 0;
   LAB_0010018c:Dependency::deleted_notify((RID*)( lVar5 + 0x38 ));
...
/* RendererRD::Utilities::visibility_notifier_set_aabb(RID, AABB const&) */void RendererRD::Utilities::visibility_notifier_set_aabb(Utilities *this, ulong param_2, undefined8 *param_3) {
   undefined8 uVar1;
   undefined8 *puVar2;
   ...
   _err_print_error("visibility_notifier_set_aabb", "servers/rendering/renderer_rd/storage_rd/utilities.cpp", 0xb2, "Parameter \"vn\" is null.", 0, 0);
   return;
}
/* RendererRD::Utilities::visibility_notifier_set_callbacks(RID, Callable const&, Callable const&)
    */void RendererRD::Utilities::visibility_notifier_set_callbacks(Utilities *this, ulong param_2, Callable *param_3, Callable *param_4) {
   long lVar1;
   if (( param_2 != 0 ) && ( (uint)param_2 < *(uint*)( this + 0x2c ) )) {
   ...
   _err_print_error("visibility_notifier_set_callbacks", "servers/rendering/renderer_rd/storage_rd/utilities.cpp", 0xb9, "Parameter \"vn\" is null.", 0, 0);
   return;
}
/* RendererRD::Utilities::capture_timestamp(String const&) */void RendererRD::Utilities::capture_timestamp(String *param_1) {
   String *pSVar1;
   pSVar1 = (String*)RenderingDevice::get_singleton();
   RenderingDevice::capture_timestamp(pSVar1);
   return;
}
/* RendererRD::Utilities::get_captured_timestamps_count() const */void RendererRD::Utilities::get_captured_timestamps_count(void) {
   RenderingDevice::get_singleton();
   RenderingDevice::get_captured_timestamps_count();
   return;
}
/* RendererRD::Utilities::get_captured_timestamps_frame() const */void RendererRD::Utilities::get_captured_timestamps_frame(void) {
   RenderingDevice::get_singleton();
   RenderingDevice::get_captured_timestamps_frame();
   return;
}
/* RendererRD::Utilities::get_captured_timestamp_gpu_time(unsigned int) const */void RendererRD::Utilities::get_captured_timestamp_gpu_time(uint param_1) {
   uint uVar1;
   uVar1 = RenderingDevice::get_singleton();
   RenderingDevice::get_captured_timestamp_gpu_time(uVar1);
   return;
}
/* RendererRD::Utilities::get_captured_timestamp_cpu_time(unsigned int) const */void RendererRD::Utilities::get_captured_timestamp_cpu_time(uint param_1) {
   uint uVar1;
   uVar1 = RenderingDevice::get_singleton();
   RenderingDevice::get_captured_timestamp_cpu_time(uVar1);
   return;
}
/* RendererRD::Utilities::get_captured_timestamp_name(unsigned int) const */undefined8 RendererRD::Utilities::get_captured_timestamp_name(uint param_1) {
   long lVar1;
...
/* RendererRD::Utilities::update_dirty_resources() */void RendererRD::Utilities::update_dirty_resources(void) {
...
/* RendererRD::Utilities::has_os_feature(String const&) const */undefined8 RendererRD::Utilities::has_os_feature(Utilities *this, String *param_1) {
   char cVar1;
   long lVar2;
   undefined8 uVar3;
...
/* RendererRD::Utilities::update_memory_info() */void RendererRD::Utilities::update_memory_info(Utilities *this) {
   undefined8 uVar1;
   for (int i = 0; i < 3; i++) {
      uVar1 = RenderingDevice::get_singleton();
      uVar1 = RenderingDevice::get_memory_usage(uVar1, i);
      *(undefined8*)( this + ( 8*i + 104 ) ) = uVar1;
   }

   return;
}
/* RendererRD::Utilities::get_video_adapter_name() const */Utilities * __thiscall RendererRD::Utilities::get_video_adapter_name(Utilities *this){
   long lVar1;
   long in_FS_OFFSET;
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
   RenderingDevice::get_singleton();
...
/* RendererRD::Utilities::get_video_adapter_vendor() const */Utilities * __thiscall RendererRD::Utilities::get_video_adapter_vendor(Utilities *this){
   long lVar1;
   long in_FS_OFFSET;
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
   RenderingDevice::get_singleton();
...
/* RendererRD::Utilities::get_video_adapter_type() const */void RendererRD::Utilities::get_video_adapter_type(void) {
   RenderingDevice::get_singleton();
   RenderingDevice::get_device_type();
   return;
}
/* RendererRD::Utilities::get_video_adapter_api_version() const */Utilities * __thiscall RendererRD::Utilities::get_video_adapter_api_version(Utilities *this){
   long lVar1;
   long in_FS_OFFSET;
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
   RenderingDevice::get_singleton();
...
/* RendererRD::Utilities::get_maximum_shader_varyings() const */void RendererRD::Utilities::get_maximum_shader_varyings(void) {
   undefined8 uVar1;
   uVar1 = RenderingDevice::get_singleton();
   RenderingDevice::limit_get(uVar1, 0x30);
   return;
}
/* RendererRD::Utilities::get_maximum_uniform_buffer_size() const */void RendererRD::Utilities::get_maximum_uniform_buffer_size(void) {
   undefined8 uVar1;
   uVar1 = RenderingDevice::get_singleton();
   RenderingDevice::limit_get(uVar1, 0x15);
   return;
}
/* RendererRD::Utilities::get_maximum_viewport_size() const */ulong RendererRD::Utilities::get_maximum_viewport_size(void) {
   undefined8 uVar1;
   ulong uVar2;
   long lVar3;
   uVar1 = RenderingDevice::get_singleton();
...
/* RendererRD::Utilities::capture_timestamps_begin() */void RendererRD::Utilities::capture_timestamps_begin(void) {
   long *plVar1;
   long lVar2;
   String *pSVar3;
   long in_FS_OFFSET;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RendererRD::Utilities::free(RID) */undefined4 RendererRD::Utilities::free(Utilities *this, ulong param_2) {
   ...
   if (cVar4 == '\0') {
      ...
      if (uVar6 == 0) {
         ...
         if (( ( uVar9 < *(uint*)( (long)plVar3 + 0x24 ) ) && ( uVar11 = ( ulong ) * (uint*)( plVar3 + 4 ) ),param_2 >> 0x20 != 0x7fffffff )) {
         ...
         if (uVar6 == 0) {
            if (uVar9 < *(uint*)( (long)plVar3 + 0x24 )) {
               ...
               if (( *(uint*)( ( uVar12 % ( ulong ) * (uint*)( plVar3 + 4 ) ) * 0x50 + *(long*)( plVar3[2] + ( uVar12 / *(uint*)( plVar3 + 4 ) ) * 8 ) + 0x48 ) & 0x7fffffff ) == uVar10) {
                  pthread_mutex_unlock(ppVar1);
            ...
            if (( *(uint*)( ( uVar12 % ( ulong ) * (uint*)( this + 0x28 ) ) * 0x70 + *(long*)( *(long*)( this + 0x18 ) + ( uVar12 / *(uint*)( this + 0x28 ) ) * 8 ) + 0x68 ) & 0x7fffffff ) == uVar10) {
      ...
      if (uVar6 == 0) {
         ...
         if (( ( uVar10 < *(uint*)( lVar8 + 0xcc ) ) && ( uVar11 >> 0x20 != 0x7fffffff ) ) && ( ( *(uint*)( ( ( uVar11 & 0xffffffff ) % ( ulong ) * (uint*)( lVar8 + 200 ) ) * 0xe0 + *(long*)( *(long*)( lVar8 + 0xb8 ) + ( ( uVar11 & 0xffffffff ) / ( ulong ) * (uint*)( lVar8 + 200 ) ) * 8 ) + 0xd8 ) & 0x7fffffff ) == uVar9 )) {
            pthread_mutex_unlock(ppVar1);
            return 1;
         }
         ...
         uVar6 = pthread_mutex_lock(ppVar1);
         if (uVar6 == 0) {
            if (( ( uVar10 < *(uint*)( lVar8 + 0x19c ) ) && ( uVar11 >> 0x20 != 0x7fffffff ) ) && ( ( *(uint*)( ( uVar14 % ( ulong ) * (uint*)( lVar8 + 0x198 ) ) * 0x160 + *(long*)( *(long*)( lVar8 + 0x188 ) + ( uVar14 / *(uint*)( lVar8 + 0x198 ) ) * 8 ) + 0x158 ) & 0x7fffffff ) == uVar9 )) {
               pthread_mutex_unlock(ppVar1);
               return 2;
            }
            ...
            uVar6 = pthread_mutex_lock(ppVar1);
            if (uVar6 == 0) {
               if (( ( uVar10 < *(uint*)( lVar8 + 0x134 ) ) && ( uVar11 >> 0x20 != 0x7fffffff ) ) && ( ( *(uint*)( ( uVar14 % ( ulong ) * (uint*)( lVar8 + 0x130 ) ) * 0x90 + *(long*)( *(long*)( lVar8 + 0x120 ) + ( uVar14 / *(uint*)( lVar8 + 0x130 ) ) * 8 ) + 0x88 ) & 0x7fffffff ) == uVar9 )) {
                  pthread_mutex_unlock(ppVar1);
                  return 6;
               }
               ...
               uVar6 = pthread_mutex_lock(ppVar1);
               if (uVar6 == 0) {
                  if (( ( uVar10 < *(uint*)( lVar8 + 0x1dc ) ) && ( uVar11 >> 0x20 != 0x7fffffff ) ) && ( ( *(uint*)( ( uVar14 % ( ulong ) * (uint*)( lVar8 + 0x1d8 ) ) * 0xa0 + *(long*)( *(long*)( lVar8 + 0x1c8 ) + ( uVar14 / *(uint*)( lVar8 + 0x1d8 ) ) * 8 ) + 0x98 ) & 0x7fffffff ) == uVar9 )) {
                     pthread_mutex_unlock(ppVar1);
                     return 7;
                  }
                  ...
                  uVar6 = pthread_mutex_lock(ppVar1);
                  if (uVar6 == 0) {
                     if (( ( uVar10 < *(uint*)( (long)plVar3 + 0x24 ) ) && ( uVar11 >> 0x20 != 0x7fffffff ) ) && ( ( *(uint*)( ( uVar14 % ( ulong ) * (uint*)( plVar3 + 4 ) ) * 0xe8 + *(long*)( plVar3[2] + ( uVar14 / *(uint*)( plVar3 + 4 ) ) * 8 ) + 0xe0 ) & 0x7fffffff ) == uVar9 )) {
                        pthread_mutex_unlock(ppVar1);
                        return 8;
                     }
                     ...
                     uVar6 = pthread_mutex_lock(ppVar1);
                     if (uVar6 == 0) {
                        if (( ( uVar10 < *(uint*)( lVar8 + 0x2c ) ) && ( uVar11 >> 0x20 != 0x7fffffff ) ) && ( ( *(uint*)( ( uVar14 % ( ulong ) * (uint*)( lVar8 + 0x28 ) ) * 0xe8 + *(long*)( *(long*)( lVar8 + 0x18 ) + ( uVar14 / *(uint*)( lVar8 + 0x28 ) ) * 8 ) + 0xe0 ) & 0x7fffffff ) == uVar9 )) {
                           pthread_mutex_unlock(ppVar1);
                           return 5;
                        }
                        ...
                        uVar6 = pthread_mutex_lock(ppVar1);
                        if (uVar6 == 0) {
                           if (( ( uVar10 < *(uint*)( lVar8 + 0x284 ) ) && ( uVar11 >> 0x20 != 0x7fffffff ) ) && ( ( *(uint*)( ( uVar14 % ( ulong ) * (uint*)( lVar8 + 0x280 ) ) * 0xb8 + *(long*)( *(long*)( lVar8 + 0x270 ) + ( uVar14 / *(uint*)( lVar8 + 0x280 ) ) * 8 ) + 0xb0 ) & 0x7fffffff ) == uVar9 )) {
                              pthread_mutex_unlock(ppVar1);
                              return 9;
                           }
                           ...
                           uVar6 = pthread_mutex_lock(ppVar1);
                           if (uVar6 == 0) {
                              if (( ( uVar10 < *(uint*)( lVar8 + 0x91c ) ) && ( uVar11 >> 0x20 != 0x7fffffff ) ) && ( ( *(uint*)( ( uVar14 % ( ulong ) * (uint*)( lVar8 + 0x918 ) ) * 0x2f8 + *(long*)( *(long*)( lVar8 + 0x908 ) + ( uVar14 / *(uint*)( lVar8 + 0x918 ) ) * 8 ) + 0x2f0 ) & 0x7fffffff ) == uVar9 )) {
                                 pthread_mutex_unlock(ppVar1);
                                 return 3;
                              }
                              ...
                              uVar6 = pthread_mutex_lock(ppVar1);
                              if (uVar6 == 0) {
                                 if (( ( uVar10 < *(uint*)( lVar8 + 0x974 ) ) && ( uVar11 >> 0x20 != 0x7fffffff ) ) && ( ( *(uint*)( *(long*)( *(long*)( lVar8 + 0x960 ) + ( uVar14 / *(uint*)( lVar8 + 0x970 ) ) * 8 ) + ( uVar14 % ( ulong ) * (uint*)( lVar8 + 0x970 ) ) * 0x88 + 0x80 ) & 0x7fffffff ) == uVar9 )) {
                                    pthread_mutex_unlock(ppVar1);
                                    return 4;
                                 }
                                 ...
                                 if (uVar6 == 0) {
                                    if (uVar10 < *(uint*)( (long)plVar3 + 0x24 )) {
                                       ...
                                       if (( *(uint*)( ( uVar14 % ( ulong ) * (uint*)( plVar3 + 4 ) ) * 0x50 + *(long*)( plVar3[2] + ( uVar14 / *(uint*)( plVar3 + 4 ) ) * 8 ) + 0x48 ) & 0x7fffffff ) == uVar9) {
                                          pthread_mutex_unlock(ppVar1);
                                          return 0xc;
                                       }
                                    ...
                                    if (( *(uint*)( ( uVar14 % ( ulong ) * (uint*)( uVar12 + 0x28 ) ) * 0x70 + *(long*)( *(long*)( uVar12 + 0x18 ) + ( uVar14 / *(uint*)( uVar12 + 0x28 ) ) * 8 ) + 0x68 ) & 0x7fffffff ) != uVar9) {
                                       return 0;
                                    }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RendererRD::Utilities::get_base_type(RID) const */undefined ** __thiscall RendererRD::Utilities::get_base_type(Utilities *this,ulong param_2){
   pthread_mutex_t *ppVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   uint uVar4;
   ...
   if (uVar4 == 0) {
      ...
      if (( ( uVar6 < *(uint*)( lVar5 + 0xcc ) ) && ( param_2 >> 0x20 != 0x7fffffff ) ) && ( ( *(uint*)( ( ( param_2 & 0xffffffff ) % ( ulong ) * (uint*)( lVar5 + 200 ) ) * 0xe0 + *(long*)( *(long*)( lVar5 + 0xb8 ) + ( ( param_2 & 0xffffffff ) / ( ulong ) * (uint*)( lVar5 + 200 ) ) * 8 ) + 0xd8 ) & 0x7fffffff ) == uVar7 )) {
         pthread_mutex_unlock(ppVar1);
      ...
      uVar4 = pthread_mutex_lock(ppVar1);
      if (uVar4 == 0) {
         if (( ( uVar6 < *(uint*)( lVar5 + 0x19c ) ) && ( param_2 >> 0x20 != 0x7fffffff ) ) && ( ( *(uint*)( ( uVar9 % ( ulong ) * (uint*)( lVar5 + 0x198 ) ) * 0x160 + *(long*)( *(long*)( lVar5 + 0x188 ) + ( uVar9 / *(uint*)( lVar5 + 0x198 ) ) * 8 ) + 0x158 ) & 0x7fffffff ) == uVar7 )) {
            pthread_mutex_unlock(ppVar1);
         ...
         uVar4 = pthread_mutex_lock(ppVar1);
         if (uVar4 == 0) {
            if (( ( uVar6 < *(uint*)( lVar5 + 0x134 ) ) && ( param_2 >> 0x20 != 0x7fffffff ) ) && ( ( *(uint*)( ( uVar9 % ( ulong ) * (uint*)( lVar5 + 0x130 ) ) * 0x90 + *(long*)( *(long*)( lVar5 + 0x120 ) + ( uVar9 / *(uint*)( lVar5 + 0x130 ) ) * 8 ) + 0x88 ) & 0x7fffffff ) == uVar7 )) {
               pthread_mutex_unlock(ppVar1);
            ...
            uVar4 = pthread_mutex_lock(ppVar1);
            if (uVar4 == 0) {
               if (( ( uVar6 < *(uint*)( lVar5 + 0x1dc ) ) && ( param_2 >> 0x20 != 0x7fffffff ) ) && ( ( *(uint*)( ( uVar9 % ( ulong ) * (uint*)( lVar5 + 0x1d8 ) ) * 0xa0 + *(long*)( *(long*)( lVar5 + 0x1c8 ) + ( uVar9 / *(uint*)( lVar5 + 0x1d8 ) ) * 8 ) + 0x98 ) & 0x7fffffff ) == uVar7 )) {
                  pthread_mutex_unlock(ppVar1);
               ...
               uVar4 = pthread_mutex_lock(ppVar1);
               if (uVar4 == 0) {
                  if (( ( uVar6 < *(uint*)( lVar5 + 0x24 ) ) && ( param_2 >> 0x20 != 0x7fffffff ) ) && ( ( *(uint*)( ( uVar9 % ( ulong ) * (uint*)( lVar5 + 0x20 ) ) * 0xe8 + *(long*)( *(long*)( lVar5 + 0x10 ) + ( uVar9 / *(uint*)( lVar5 + 0x20 ) ) * 8 ) + 0xe0 ) & 0x7fffffff ) == uVar7 )) {
                     pthread_mutex_unlock(ppVar1);
                  ...
                  uVar4 = pthread_mutex_lock(ppVar1);
                  if (uVar4 == 0) {
                     if (( ( uVar6 < *(uint*)( lVar5 + 0x2c ) ) && ( param_2 >> 0x20 != 0x7fffffff ) ) && ( ( *(uint*)( ( uVar9 % ( ulong ) * (uint*)( lVar5 + 0x28 ) ) * 0xe8 + *(long*)( *(long*)( lVar5 + 0x18 ) + ( uVar9 / *(uint*)( lVar5 + 0x28 ) ) * 8 ) + 0xe0 ) & 0x7fffffff ) == uVar7 )) {
                        pthread_mutex_unlock(ppVar1);
                     ...
                     uVar4 = pthread_mutex_lock(ppVar1);
                     if (uVar4 == 0) {
                        if (( ( uVar6 < *(uint*)( lVar5 + 0x284 ) ) && ( param_2 >> 0x20 != 0x7fffffff ) ) && ( ( *(uint*)( ( uVar9 % ( ulong ) * (uint*)( lVar5 + 0x280 ) ) * 0xb8 + *(long*)( *(long*)( lVar5 + 0x270 ) + ( uVar9 / *(uint*)( lVar5 + 0x280 ) ) * 8 ) + 0xb0 ) & 0x7fffffff ) == uVar7 )) {
                           pthread_mutex_unlock(ppVar1);
                        ...
                        uVar4 = pthread_mutex_lock(ppVar1);
                        if (uVar4 == 0) {
                           if (( ( uVar6 < *(uint*)( lVar5 + 0x91c ) ) && ( param_2 >> 0x20 != 0x7fffffff ) ) && ( ( *(uint*)( ( uVar9 % ( ulong ) * (uint*)( lVar5 + 0x918 ) ) * 0x2f8 + *(long*)( *(long*)( lVar5 + 0x908 ) + ( uVar9 / *(uint*)( lVar5 + 0x918 ) ) * 8 ) + 0x2f0 ) & 0x7fffffff ) == uVar7 )) {
                              pthread_mutex_unlock(ppVar1);
                           ...
                           uVar4 = pthread_mutex_lock(ppVar1);
                           if (uVar4 == 0) {
                              if (( ( uVar6 < *(uint*)( lVar5 + 0x974 ) ) && ( param_2 >> 0x20 != 0x7fffffff ) ) && ( ( *(uint*)( *(long*)( *(long*)( lVar5 + 0x960 ) + ( uVar9 / *(uint*)( lVar5 + 0x970 ) ) * 8 ) + ( uVar9 % ( ulong ) * (uint*)( lVar5 + 0x970 ) ) * 0x88 + 0x80 ) & 0x7fffffff ) == uVar7 )) {
                                 pthread_mutex_unlock(ppVar1);
                              ...
                              if (uVar4 == 0) {
                                 if (uVar6 < *(uint*)( lVar5 + 0x24 )) {
                                    ...
                                    if (( *(uint*)( ( uVar9 % ( ulong ) * (uint*)( lVar5 + 0x20 ) ) * 0x50 + *(long*)( *(long*)( lVar5 + 0x10 ) + ( uVar9 / *(uint*)( lVar5 + 0x20 ) ) * 8 ) + 0x48 ) & 0x7fffffff ) == uVar7) {
                                       pthread_mutex_unlock(ppVar1);
                                 ...
                                 if (( *(uint*)( ( uVar9 % ( ulong ) * (uint*)( this + 0x28 ) ) * 0x70 + *(long*)( *(long*)( this + 0x18 ) + ( uVar9 / *(uint*)( this + 0x28 ) ) * 8 ) + 0x68 ) & 0x7fffffff ) != uVar7) {
                                    return (undefined**)0x0;
                                 }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RendererRD::Utilities::Utilities() */void RendererRD::Utilities::Utilities(Utilities *this) {
   undefined8 uVar1;
   undefined8 uVar2;
...
/* RendererRD::Utilities::visibility_notifier_call(RID, bool, bool) */void RendererRD::Utilities::visibility_notifier_call(Utilities *this, ulong param_2, char param_3, char param_4) {
   char cVar1;
   long lVar2;
   Variant **ppVVar3;
   long in_FS_OFFSET;
      ...
      if (*(int*)( lVar2 + 0x68 ) == (int)( param_2 >> 0x20 )) {
         if (param_3 == '\0') {
            ...
            if (cVar1 != '\0') {
               ...
               LAB_00101370:Variant::Variant((Variant*)local_38, 0);
               Callable::call_deferredp(ppVVar3, 0);
               cVar1 = Variant::needs_deinit[local_38[0]];
               joined_r0x001013ea:if (cVar1 != '\0') {
   ...
   if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      _err_print_error("visibility_notifier_call", "servers/rendering/renderer_rd/storage_rd/utilities.cpp", 0xc6, "Parameter \"vn\" is null.", 0, 0);
      return;
   }

   LAB_00101483:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* RendererRD::Utilities::~Utilities() */void RendererRD::Utilities::~Utilities(Utilities *this) {
   *(undefined***)this = &PTR__Utilities_00104158;
   singleton = 0;
   RID_Alloc<RendererRD::VisibilityNotifier,false>::~RID_Alloc((RID_Alloc<RendererRD::VisibilityNotifier,false>*)( this + 0x10 ));
   return;
}
/* RendererRD::Utilities::~Utilities() */void RendererRD::Utilities::~Utilities(Utilities *this) {
   *(undefined***)this = &PTR__Utilities_00104158;
...
/* RendererRD::Utilities::visibility_notifier_allocate() */void RendererRD::Utilities::visibility_notifier_allocate(Utilities *this) {
   RID_Alloc<RendererRD::VisibilityNotifier,false>::allocate_rid((RID_Alloc<RendererRD::VisibilityNotifier,false>*)( this + 0x10 ));
   return;
}
/* RendererRD::Utilities::base_update_dependency(RID, DependencyTracker*) */void RendererRD::Utilities::base_update_dependency(Utilities *this, ulong param_2, DependencyTracker *param_3) {
   undefined4 uVar1;
   uint uVar2;
   long lVar3;
   undefined4 *puVar4;
   long *plVar5;
   undefined8 uVar6;
   HashMap<DependencyTracker*,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<DependencyTracker*>,DefaultTypedAllocator<HashMapElement<DependencyTracker*,unsigned_int>>> *pHVar7;
   Dependency *pDVar8;
   uint uVar9;
   uint uVar10;
   ...
   if (uVar2 != 0) {
      LAB_00101c20:ppVar11 = (pthread_mutex_t*)(ulong)uVar2;
      std::__throw_system_error(uVar2);
      LAB_00101c27:pthread_mutex_unlock(ppVar11);
   ...
   uVar12 = param_2 & 0xffffffff;
   uVar10 = ( uint )(param_2 >> 0x20);
   if (( ( uVar9 < *(uint*)( lVar3 + 0xcc ) ) && ( param_2 >> 0x20 != 0x7fffffff ) ) && ( ( *(uint*)( ( ( param_2 & 0xffffffff ) % ( ulong ) * (uint*)( lVar3 + 200 ) ) * 0xe0 + *(long*)( *(long*)( lVar3 + 0xb8 ) + ( ( param_2 & 0xffffffff ) / ( ulong ) * (uint*)( lVar3 + 200 ) ) * 8 ) + 0xd8 ) & 0x7fffffff ) == uVar10 )) {
      pthread_mutex_unlock(ppVar11);
      uVar6 = RendererRD::MeshStorage::get_singleton();
      pHVar7 = (HashMap<DependencyTracker*,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<DependencyTracker*>,DefaultTypedAllocator<HashMapElement<DependencyTracker*,unsigned_int>>>*)RendererRD::MeshStorage::mesh_get_dependency(uVar6, param_2);
      goto LAB_00101a48;
   }
   ...
   if (( ( uVar9 < *(uint*)( lVar3 + 0x19c ) ) && ( param_2 >> 0x20 != 0x7fffffff ) ) && ( ( *(uint*)( ( uVar12 % ( ulong ) * (uint*)( lVar3 + 0x198 ) ) * 0x160 + *(long*)( *(long*)( lVar3 + 0x188 ) + ( uVar12 / *(uint*)( lVar3 + 0x198 ) ) * 8 ) + 0x158 ) & 0x7fffffff ) == uVar10 )) {
      pthread_mutex_unlock(ppVar11);
      uVar6 = RendererRD::MeshStorage::get_singleton();
      pHVar7 = (HashMap<DependencyTracker*,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<DependencyTracker*>,DefaultTypedAllocator<HashMapElement<DependencyTracker*,unsigned_int>>>*)RendererRD::MeshStorage::multimesh_get_dependency(uVar6, param_2);
      HashSet<Dependency*,HashMapHasherDefault,HashMapComparatorDefault<Dependency*>>::insert((Dependency**)local_58);
      uVar1 = *(undefined4*)( param_3 + 0x18 );
      local_58[0] = param_3;
      puVar4 = (undefined4*)HashMap<DependencyTracker*,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<DependencyTracker*>,DefaultTypedAllocator<HashMapElement<DependencyTracker*,unsigned_int>>>::operator [](pHVar7, local_58);
      *puVar4 = uVar1;
   ...
   uVar2 = pthread_mutex_lock(ppVar11);
   if (uVar2 != 0) goto LAB_00101c20;
   if (( ( uVar9 < *(uint*)( lVar3 + 0x134 ) ) && ( param_2 >> 0x20 != 0x7fffffff ) ) && ( ( *(uint*)( ( uVar12 % ( ulong ) * (uint*)( lVar3 + 0x130 ) ) * 0x90 + *(long*)( *(long*)( lVar3 + 0x120 ) + ( uVar12 / *(uint*)( lVar3 + 0x130 ) ) * 8 ) + 0x88 ) & 0x7fffffff ) == uVar10 )) {
      pthread_mutex_unlock(ppVar11);
      uVar6 = RendererRD::LightStorage::get_singleton();
      pHVar7 = (HashMap<DependencyTracker*,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<DependencyTracker*>,DefaultTypedAllocator<HashMapElement<DependencyTracker*,unsigned_int>>>*)RendererRD::LightStorage::reflection_probe_get_dependency(uVar6, param_2);
      LAB_00101a48:HashSet<Dependency*,HashMapHasherDefault,HashMapComparatorDefault<Dependency*>>::insert((Dependency**)local_58);
      uVar1 = *(undefined4*)( param_3 + 0x18 );
      local_58[0] = param_3;
      puVar4 = (undefined4*)HashMap<DependencyTracker*,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<DependencyTracker*>,DefaultTypedAllocator<HashMapElement<DependencyTracker*,unsigned_int>>>::operator [](pHVar7, local_58);
      *puVar4 = uVar1;
   ...
   uVar2 = pthread_mutex_lock(ppVar11);
   if (uVar2 != 0) goto LAB_00101c20;
   if (( ( uVar9 < *(uint*)( lVar3 + 0x1dc ) ) && ( param_2 >> 0x20 != 0x7fffffff ) ) && ( ( *(uint*)( ( uVar12 % ( ulong ) * (uint*)( lVar3 + 0x1d8 ) ) * 0xa0 + *(long*)( *(long*)( lVar3 + 0x1c8 ) + ( uVar12 / *(uint*)( lVar3 + 0x1d8 ) ) * 8 ) + 0x98 ) & 0x7fffffff ) == uVar10 )) {
      pthread_mutex_unlock(ppVar11);
      uVar6 = RendererRD::TextureStorage::get_singleton();
      pHVar7 = (HashMap<DependencyTracker*,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<DependencyTracker*>,DefaultTypedAllocator<HashMapElement<DependencyTracker*,unsigned_int>>>*)RendererRD::TextureStorage::decal_get_dependency(uVar6, param_2);
      goto LAB_00101a48;
   }
   ...
   uVar2 = pthread_mutex_lock(ppVar11);
   if (uVar2 != 0) goto LAB_00101c20;
   if (( ( uVar9 < *(uint*)( lVar3 + 0x24 ) ) && ( param_2 >> 0x20 != 0x7fffffff ) ) && ( ( *(uint*)( ( uVar12 % ( ulong ) * (uint*)( lVar3 + 0x20 ) ) * 0xe8 + *(long*)( *(long*)( lVar3 + 0x10 ) + ( uVar12 / *(uint*)( lVar3 + 0x20 ) ) * 8 ) + 0xe0 ) & 0x7fffffff ) == uVar10 )) {
      pthread_mutex_unlock(ppVar11);
      pHVar7 = (HashMap<DependencyTracker*,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<DependencyTracker*>,DefaultTypedAllocator<HashMapElement<DependencyTracker*,unsigned_int>>>*)RendererRD::GI::voxel_gi_get_dependency(GI::singleton, param_2);
      goto LAB_00101a48;
   }
   ...
   uVar2 = pthread_mutex_lock(ppVar11);
   if (uVar2 != 0) goto LAB_00101c20;
   if (( ( uVar9 < *(uint*)( lVar3 + 0x284 ) ) && ( param_2 >> 0x20 != 0x7fffffff ) ) && ( ( *(uint*)( ( uVar12 % ( ulong ) * (uint*)( lVar3 + 0x280 ) ) * 0xb8 + *(long*)( *(long*)( lVar3 + 0x270 ) + ( uVar12 / *(uint*)( lVar3 + 0x280 ) ) * 8 ) + 0xb0 ) & 0x7fffffff ) == uVar10 )) {
      pthread_mutex_unlock(ppVar11);
      uVar6 = RendererRD::LightStorage::get_singleton();
      pHVar7 = (HashMap<DependencyTracker*,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<DependencyTracker*>,DefaultTypedAllocator<HashMapElement<DependencyTracker*,unsigned_int>>>*)RendererRD::LightStorage::lightmap_get_dependency(uVar6, param_2);
      goto LAB_00101a48;
   }
   ...
   uVar2 = pthread_mutex_lock(ppVar11);
   if (uVar2 != 0) goto LAB_00101c20;
   if (( ( uVar9 < *(uint*)( lVar3 + 0x2c ) ) && ( param_2 >> 0x20 != 0x7fffffff ) ) && ( ( *(uint*)( ( uVar12 % ( ulong ) * (uint*)( lVar3 + 0x28 ) ) * 0xe8 + *(long*)( *(long*)( lVar3 + 0x18 ) + ( uVar12 / *(uint*)( lVar3 + 0x28 ) ) * 8 ) + 0xe0 ) & 0x7fffffff ) == uVar10 )) {
      pthread_mutex_unlock(ppVar11);
      uVar6 = RendererRD::LightStorage::get_singleton();
      pHVar7 = (HashMap<DependencyTracker*,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<DependencyTracker*>,DefaultTypedAllocator<HashMapElement<DependencyTracker*,unsigned_int>>>*)RendererRD::LightStorage::light_get_dependency(uVar6, param_2);
      goto LAB_00101a48;
   }
   ...
   uVar2 = pthread_mutex_lock(ppVar11);
   if (uVar2 != 0) goto LAB_00101c20;
   if (( ( uVar9 < *(uint*)( lVar3 + 0x91c ) ) && ( param_2 >> 0x20 != 0x7fffffff ) ) && ( ( *(uint*)( ( uVar12 % ( ulong ) * (uint*)( lVar3 + 0x918 ) ) * 0x2f8 + *(long*)( *(long*)( lVar3 + 0x908 ) + ( uVar12 / *(uint*)( lVar3 + 0x918 ) ) * 8 ) + 0x2f0 ) & 0x7fffffff ) == uVar10 )) {
      pthread_mutex_unlock(ppVar11);
      uVar6 = RendererRD::ParticlesStorage::get_singleton();
      pHVar7 = (HashMap<DependencyTracker*,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<DependencyTracker*>,DefaultTypedAllocator<HashMapElement<DependencyTracker*,unsigned_int>>>*)RendererRD::ParticlesStorage::particles_get_dependency(uVar6, param_2);
      goto LAB_00101a48;
   }
   ...
   uVar2 = pthread_mutex_lock(ppVar11);
   if (uVar2 != 0) goto LAB_00101c20;
   if (( ( uVar9 < *(uint*)( lVar3 + 0x974 ) ) && ( param_2 >> 0x20 != 0x7fffffff ) ) && ( ( *(uint*)( *(long*)( *(long*)( lVar3 + 0x960 ) + ( uVar12 / *(uint*)( lVar3 + 0x970 ) ) * 8 ) + ( uVar12 % ( ulong ) * (uint*)( lVar3 + 0x970 ) ) * 0x88 + 0x80 ) & 0x7fffffff ) == uVar10 )) {
      pthread_mutex_unlock(ppVar11);
      uVar6 = RendererRD::ParticlesStorage::get_singleton();
      pHVar7 = (HashMap<DependencyTracker*,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<DependencyTracker*>,DefaultTypedAllocator<HashMapElement<DependencyTracker*,unsigned_int>>>*)RendererRD::ParticlesStorage::particles_collision_get_dependency(uVar6, param_2);
      goto LAB_00101a48;
   }
   ...
   if (uVar9 < *(uint*)( lVar3 + 0x24 )) {
      ...
      if (( *(uint*)( ( uVar12 % ( ulong ) * (uint*)( lVar3 + 0x20 ) ) * 0x50 + *(long*)( *(long*)( lVar3 + 0x10 ) + ( uVar12 / *(uint*)( lVar3 + 0x20 ) ) * 8 ) + 0x48 ) & 0x7fffffff ) != uVar10) {
         pthread_mutex_unlock(ppVar11);
   ...
   if (( uVar9 < *(uint*)( this + 0x2c ) ) && ( param_2 >> 0x20 != 0x7fffffff )) {
      LAB_001019c1:lVar3 = ( uVar12 % ( ulong ) * (uint*)( this + 0x28 ) ) * 0x70 + *(long*)( *(long*)( this + 0x18 ) + ( uVar12 / *(uint*)( this + 0x28 ) ) * 8 );
      if (( *(uint*)( lVar3 + 0x68 ) & 0x7fffffff ) == uVar10) {
         if (param_2 == 0) {
            LAB_00101cd0:lVar3 = 0;
         }
         ...
         if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            LAB_00101a17:DependencyTracker::update_dependency(param_3, pDVar8);
            return;
         }
   ...
   LAB_00101c52:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* RendererRD::Utilities::visibility_notifier_initialize(RID) */void RendererRD::Utilities::visibility_notifier_initialize(Utilities *this, ulong param_2) {
   long lVar1;
   undefined8 uVar2;
   long *plVar3;
   undefined8 *puVar4;
 ...
 while ( lVar1 != 0x1d );
            ...
            LAB_00101e58:if (( local_38._4_4_ != 0 ) && ( (long*)local_48._0_8_ != (long*)0x0 )) {
 ...
 while ( plVar3 != (long*)0x0 );
   ...
   LAB_00101e96:Dependency::~Dependency(local_60);
...
/* RendererRD::Utilities::set_debug_generate_wireframes(bool) */void RendererRD::Utilities::set_debug_generate_wireframes(bool param_1) {
   return;
}
...
;
   ...
   *(uint*)( (long)in_RSI + 0x24 ) = uVar44;
   LAB_001027d1:*(uint*)( (long)param_1 + 0xc ) = uVar37;
   *param_1 = local_88;
...
/* WARNING: Removing unreachable block (ram,0x00102b70) *//* WARNING: Removing unreachable block (ram,0x00102ca0) *//* WARNING: Removing unreachable block (ram,0x00102e19) *//* WARNING: Removing unreachable block (ram,0x00102cac) *//* WARNING: Removing unreachable block (ram,0x00102cb6) *//* WARNING: Removing unreachable block (ram,0x00102dfb) *//* WARNING: Removing unreachable block (ram,0x00102cc2) *//* WARNING: Removing unreachable block (ram,0x00102ccc) *//* WARNING: Removing unreachable block (ram,0x00102ddd) *//* WARNING: Removing unreachable block (ram,0x00102cd8) *//* WARNING: Removing unreachable block (ram,0x00102ce2) *//* WARNING: Removing unreachable block (ram,0x00102dbf) *//* WARNING: Removing unreachable block (ram,0x00102cee) *//* WARNING: Removing unreachable block (ram,0x00102cf8) *//* WARNING: Removing unreachable block (ram,0x00102da1) *//* WARNING: Removing unreachable block (ram,0x00102d04) *//* WARNING: Removing unreachable block (ram,0x00102d0e) *//* WARNING: Removing unreachable block (ram,0x00102d83) *//* WARNING: Removing unreachable block (ram,0x00102d16) *//* WARNING: Removing unreachable block (ram,0x00102d20) *//* WARNING: Removing unreachable block (ram,0x00102d68) *//* WARNING: Removing unreachable block (ram,0x00102d28) *//* WARNING: Removing unreachable block (ram,0x00102d3e) *//* WARNING: Removing unreachable block (ram,0x00102d4a) *//* String vformat<unsigned int, char const*>(String const&, unsigned int const, char const* const)
...
/* RID_Alloc<RendererRD::VisibilityNotifier, false>::~RID_Alloc() */void RID_Alloc<RendererRD::VisibilityNotifier,false>::~RID_Alloc(RID_Alloc<RendererRD::VisibilityNotifier,false> *this) {
   long *plVar1;
   long lVar2;
   uint uVar3;
   char *pcVar4;
   ...
   *(undefined***)this = &PTR__RID_Alloc_00104138;
   if (uVar3 == 0) {
      ...
      LAB_00102fba:if ((uint)uVar5 < (uint)uVar7) goto LAB_00102ffb;
      lVar6 = 0;
      while (true) {
...
;
 ...
 while ( uVar9 < uVar5 );
   ...
   puVar8 = *(undefined8**)( this + 8 );
   LAB_00102ffb:if (puVar8 == (undefined8*)0x0) {
      if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
...
/* RID_Alloc<RendererRD::VisibilityNotifier, false>::allocate_rid() */ulong RID_Alloc<RendererRD::VisibilityNotifier,false>::allocate_rid(RID_Alloc<RendererRD::VisibilityNotifier,false> *this) {
   void *pvVar1;
   code *pcVar2;
   uint uVar3;
   long lVar4;
...

{
 ...
 while ( uVar43 != uVar31 );
      ...
      LAB_00103a69:if (iVar36 == 0) goto LAB_00103b00;
 ...
 while ( ( uVar33 != 0 ) && ( auVar6._8_8_ = 0 ),auVar6._0_8_ = (ulong)uVar33 * lVar2,auVar18._8_8_ = 0,auVar18._0_8_ = uVar43,auVar7._8_8_ = 0,auVar7._0_8_ = ( ulong )(( uVar40 + uVar37 ) - SUB164(auVar6 * auVar18, 8)) * lVar2,auVar19._8_8_ = 0,auVar19._0_8_ = uVar43,lVar35 = SUB168(auVar7 * auVar19, 8),uVar38 <= SUB164(auVar7 * auVar19, 8) );
   ...
   LAB_00103714:uVar41 = CONCAT44(0, *(uint*)( hash_table_size_primes + uVar31 * 4 ));
   lVar2 = *(long*)( hash_table_size_primes_inv + uVar31 * 8 );
   uVar29 = (long)pDVar45 * 0x3ffff - 1;
   uVar29 = ( uVar29 ^ uVar29 >> 0x1f ) * 0x15;
   uVar29 = ( uVar29 ^ uVar29 >> 0xb ) * 0x41;
...
;*(undefined1(**) [16])( lVar34 + lStack_70 * 8 ) = pauVar28;*puVar1 = uVar40;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_001037fe:auVar47._8_8_ = lStack_70;auVar47._0_8_ = pauVar30[1] + 8;return auVar47;}/* DependencyTracker::update_dependency(Dependency*) */void DependencyTracker::update_dependency(DependencyTracker *this, Dependency *param_1) {
   undefined4 uVar1;
   undefined4 *puVar2;
   long in_FS_OFFSET;
   ...
   long local_20;
   local_20 = *(long*)( in_FS_OFFSET + 0x28 );
   HashSet<Dependency*,HashMapHasherDefault,HashMapComparatorDefault<Dependency*>>::insert((Dependency**)local_38);
   uVar1 = *(undefined4*)( this + 0x18 );
   local_38[0] = this;
   puVar2 = (undefined4*)HashMap<DependencyTracker*,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<DependencyTracker*>,DefaultTypedAllocator<HashMapElement<DependencyTracker*,unsigned_int>>>::operator []((HashMap<DependencyTracker*,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<DependencyTracker*>,DefaultTypedAllocator<HashMapElement<DependencyTracker*,unsigned_int>>>*)param_1, local_38);
   *puVar2 = uVar1;
   if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<DependencyTracker*, unsigned int, HashMapHasherDefault,
 ...
 while ( uVar34 != uVar24 );
      ...
      LAB_00103c06:uVar32 = param_2[0xb];
      lVar36 = *plVar28;
      LAB_00103c11:if (uVar32 != 0) {
...
;
   ...
   *puVar1 = uVar23;
   ...
   LAB_00103ed8:*param_1 = pDVar25;
   return;
}
/* WARNING: Control flow encountered bad instruction data *//* RID_Alloc<RendererRD::VisibilityNotifier, false>::~RID_Alloc() */void RID_Alloc<RendererRD::VisibilityNotifier,false>::~RID_Alloc(RID_Alloc<RendererRD::VisibilityNotifier,false> *this) {

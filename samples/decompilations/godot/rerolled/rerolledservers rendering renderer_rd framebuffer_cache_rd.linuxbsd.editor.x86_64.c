...
/* FramebufferCacheRD::_initialize_classv() */void FramebufferCacheRD::_initialize_classv(void) {
   ...
   LAB_00102735:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* void call_get_argument_type_info<TypedArray<RID> const&, TypedArray<RDFramebufferPass> const&,
   unsigned int>(int, PropertyInfo&) */void call_get_argument_type_info<TypedArray<RID>const&,TypedArray<RDFramebufferPass>const&,unsigned_int>(int param_1, PropertyInfo *param_2) {
   long *plVar1;
   long lVar2;
...
/* MethodBindTRS<RID, TypedArray<RID> const&, TypedArray<RDFramebufferPass> const&, unsigned
   int>::_gen_argument_type_info(int) const */undefined4 *MethodBindTRS<RID,TypedArray<RID>const&,TypedArray<RDFramebufferPass>const&,unsigned_int>::_gen_argument_type_info(int param_1) {
   long *plVar1;
...
/* WARNING: Control flow encountered bad instruction data *//* MethodBindTRS<RID, TypedArray<RID> const&, TypedArray<RDFramebufferPass> const&, unsigned
   int>::~MethodBindTRS() */void MethodBindTRS<RID,TypedArray<RID>const&,TypedArray<RDFramebufferPass>const&,unsigned_int>::~MethodBindTRS(MethodBindTRS<RID,TypedArray<RID>const&,TypedArray<RDFramebufferPass>const&,unsigned_int> *this) {

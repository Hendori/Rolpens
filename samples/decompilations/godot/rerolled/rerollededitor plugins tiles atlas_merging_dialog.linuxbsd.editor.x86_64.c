/* AtlasMergingDialog::ok_pressed() */void AtlasMergingDialog::ok_pressed(AtlasMergingDialog *this) {
   this[0xdbc] = (AtlasMergingDialog)0x0;
   EditorFileDialog::popup_file_dialog();
   return;
}
/* AtlasMergingDialog::cancel_pressed() */void AtlasMergingDialog::cancel_pressed(AtlasMergingDialog *this) {
   int iVar1;
...
/* AtlasMergingDialog::custom_action(String const&) */void AtlasMergingDialog::custom_action(AtlasMergingDialog *this, String *param_1) {
   char cVar1;
...
/* AtlasMergingDialog::_get(StringName const&, Variant&) const */ulong AtlasMergingDialog::_get(AtlasMergingDialog *this, StringName *param_1, Variant *param_2) {
   ulong uVar1;
   long in_FS_OFFSET;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* AtlasMergingDialog::AtlasMergingDialog() */void AtlasMergingDialog::AtlasMergingDialog(AtlasMergingDialog *this) {
   Vector2i *pVVar1;
   StringName *pSVar2;
   long *plVar3;
   code *pcVar4;
...
/* AtlasMergingDialog::update_tile_set(Ref<TileSet>) */void AtlasMergingDialog::update_tile_set(AtlasMergingDialog *this, long *param_2) {
   undefined8 uVar1;
   char cVar2;
   int iVar3;
   Object *pOVar4;
   ...
   if (pOVar4 == (Object*)0x0) {
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         _err_print_error("update_tile_set", "editor/plugins/tiles/atlas_merging_dialog.cpp", 0x110, "Condition \"p_tile_set.is_null()\" is true.", 0, 0);
         return;
      }
   ...
   for (iVar6 = 0; iVar3 = TileSet::get_source_count(),iVar6 < iVar3; iVar6 = iVar6 + 1) {
      ...
      if (local_68 != (Object*)0x0) {
         pOVar4 = (Object*)__dynamic_cast(local_68, &Object::typeinfo, &TileSetAtlasSource::typeinfo, 0);
         if (pOVar4 == (Object*)0x0) {
            cVar2 = RefCounted::unreference();
            pOVar5 = local_68;
            if (cVar2 != '\0') {
               cVar2 = predelete_handler(local_68);
               joined_r0x00101158:if (cVar2 != '\0') goto LAB_00101035;
            }
            ...
            cVar2 = RefCounted::reference();
            if (cVar2 == '\0') {
               if (( local_68 != (Object*)0x0 ) && ( cVar2 = RefCounted::unreference() ),pOVar5 = local_68,cVar2 != '\0') {
                  pOVar4 = (Object*)0x0;
                  cVar2 = predelete_handler(local_68);
               ...
               if (( ( local_68 != (Object*)0x0 ) && ( cVar2 = RefCounted::unreference() ),pOVar5 = local_68,cVar2 != '\0' )) {
                  LAB_00101035:( **(code**)( *(long*)pOVar5 + 0x140 ) )(pOVar5);
                  Memory::free_static(pOVar5, false);
               ...
               if (local_98 != (Object*)0x0) {
                  ...
                  if (( ( local_98 != (Object*)0x0 ) && ( cVar2 = RefCounted::unreference() ),pOVar5 = local_98,cVar2 != '\0' )) &&( cVar2 = cVar2 != '\0' )(**(code**)( *(long*)pOVar5 + 0x140 ))(pOVar5);
                  Memory::free_static(pOVar5, false);
               }
   ...
   LAB_00100d70:}BaseButton::set_disabled(SUB81(*(undefined8*)( this + 0xd88 ), 0));
   BaseButton::set_disabled(SUB81(*(undefined8*)( this + 0xe18 ), 0));
   *(undefined4*)( this + 0xdb8 ) = 0;
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
...
/* AtlasMergingDialog::_merge_confirmed(String const&) */void AtlasMergingDialog::_merge_confirmed(AtlasMergingDialog *this, String *param_1) {
   Variant *pVVar1;
   long *plVar2;
   StringName *pSVar3;
   code *pcVar4;
   ...
   if (*(long*)( this + 0xdc0 ) == 0) {
      _err_print_error("_merge_confirmed", "editor/plugins/tiles/atlas_merging_dialog.cpp", 0xb4, "Condition \"merged.is_null()\" is true.", 0, 0);
      goto LAB_00101e9c;
   }

   TileSetAtlasSource::get_texture();
   if (( local_228 == (String*)0x0 ) || ( pOVar9 = (Object*)__dynamic_cast(local_228, &Object::typeinfo, &ImageTexture::typeinfo, 0) ),pOVar9 == (Object*)0x0) {
   ...
   if (( local_228 != (String*)0x0 ) && ( cVar5 = cVar5 != '\0' )) {
   ...
   if (local_230 == (Object*)0x0) {
      ...
      if (lVar10 == 0) {
         LAB_001014a8:cVar5 = RefCounted::unreference();
   ...
   if (( pOVar12 == (Object*)0x0 ) || ( local_228 = (String*)pOVar12 ),cVar5 = RefCounted::reference(),cVar5 == '\0') {
      local_228 = (String*)0x0;
      pOVar12 = (Object*)0x0;
   }
 ...
 while ( pVVar16 != (Variant*)&local_1f8 );
   ...
   EditorUndoRedoManager::add_undo_methodp(pOVar11, pSVar3, (Variant**)&local_228, (int)(Variant*)local_108);
   ...
   if (( this[0xdbc] != (AtlasMergingDialog)0x0 ) && ( ItemList::get_selected_items(),local_220 != 0 )) {
      ...
      do {
         ...
         pOVar12 = local_230;
         if (local_230 != (Object*)0x0) {
            pOVar12 = (Object*)__dynamic_cast(local_230, &Object::typeinfo, &TileSetAtlasSource::typeinfo, 0);
            ...
            pOVar18 = local_230;
            pOVar12 = local_240;
            if (( cVar5 != '\0' ) && ( cVar5 = predelete_handler(local_230) ),pOVar12 = local_240,cVar5 != '\0') {
         ...
         LAB_0010195f:StringName::StringName((StringName*)&local_230, "remove_source", false);
         pSVar3 = *(StringName**)( this + 0xdd8 );
         ...
         EditorUndoRedoManager::add_do_methodp(pOVar11, pSVar3, (Variant**)&local_230, (int)(Vector2i*)local_208);
         ...
         if (( pOVar12 == (Object*)0x0 ) || ( local_230 = pOVar12 ),cVar5 = RefCounted::reference(),pOVar18 = pOVar12,cVar5 == '\0') {
            local_230 = (Object*)0x0;
            pOVar18 = (Object*)0x0;
         }
         ...
         if (0 < iVar8) {
            do {
               ...
               if (*(uint*)( this + 0xdc8 ) <= (uint)local_310) {
                  _err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, local_310, ( ulong ) * (uint*)( this + 0xdc8 ), "p_index", "count", "", false, true);
                  _err_flush_stdout();
                  /* WARNING: Does not return */
                  pcVar4 = (code*)invalidInstructionException();
                  ( *pcVar4 )();
               ...
               puVar13 = (undefined8*)HashMap<Vector2i,Vector2i,HashMapHasherDefault,HashMapComparatorDefault<Vector2i>,DefaultTypedAllocator<HashMapElement<Vector2i,Vector2i>>>::operator []((HashMap<Vector2i,Vector2i,HashMapHasherDefault,HashMapComparatorDefault<Vector2i>,DefaultTypedAllocator<HashMapElement<Vector2i,Vector2i>>>*)( local_310 * 0x30 + *(long*)( this + 0xdd0 ) ), (Vector2i*)&local_210);
               ...
               EditorUndoRedoManager::add_do_methodp(pOVar11, pSVar3, (Variant**)&local_230, (int)(Variant*)&local_1a8);
               do {
                  pVVar1 = pVVar16 + -0x18;
                  pVVar16 = pVVar16 + -0x18;
                  if (Variant::needs_deinit[*(int*)pVVar1] != '\0') {
 ...
 while ( pVVar16 != (Variant*)&local_b8 );
               ...
               cVar5 = TileSet::has_coords_level_tile_proxy(*(undefined8*)( this + 0xdd8 ), iVar7, local_210);
               if (cVar5 == '\0') {
 ...
 while ( pVVar16 != (Variant*)local_108 );
                  ...
                  TileSet::get_coords_level_tile_proxy((String*)&local_238, *(undefined8*)( this + 0xdd8 ), iVar7, local_210);
 ...
 while ( local_220 != 0 );
   ...
   *(int*)( this + 0xdb8 ) = *(int*)( this + 0xdb8 ) + 1;
   ...
   LAB_00101e9c:if (local_40[0] != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* AtlasMergingDialog::_generate_merged(Vector<Ref<TileSetAtlasSource> > const&, int) [clone
   .part.0] */void AtlasMergingDialog::_generate_merged(AtlasMergingDialog *this, Vector *param_1, int param_2) {
   long *plVar1;
   undefined8 *puVar2;
   String *pSVar3;
   code *pcVar4;
...
;
   ...
   LAB_00102a90:do {
      ...
      if (uVar21 <= (uint)local_160) {
         LAB_0010283a:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, local_160, (ulong)uVar21, "p_index", "count", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar4 = (code*)invalidInstructionException();
         ( *pcVar4 )();
         ...
         do {
            ...
            while (true) {
               ...
               if (iVar9 == 0) {
                  ...
                  TileSetAtlasSource::set_tile_animation_frames_count(*(undefined8*)( this + 0xdc0 ), local_a0, iVar9);
                  if (0 < iVar9) {
                     iVar26 = 0;
                     do {
                        uVar12 = *(undefined8*)( this + 0xdc0 );
 ...
 while ( iVar9 != iVar10 );
                  ...
                  iVar26 = TileSetAtlasSource::create_alternative_tile(*(undefined8*)( this + 0xdc0 ), local_a0, iVar22);
               ...
               if (( local_120 != (undefined8*)0x0 ) && ( puVar23 = (undefined4*)*local_120 ),puVar23 != (undefined4*)0x0) {
                  do {
                     while (true) {
                        local_100 = 0;
                        ...
                        ClassDB::class_get_default_property_value((StringName*)local_78, &local_118, (bool*)&local_110);
                        ...
                        LAB_00102cf4:if (local_78[0]._0_4_ != 0) {
                           local_50 = (undefined1[16])0x0;
                           local_110 = (Image*)( (ulong)local_110 & 0xffffffff00000000 );
                           local_118 = (StringName)0x1;
                           local_58 = local_58 & 0xffffffff00000000;
                           Variant::evaluate((Operator*)&local_110, (Variant*)&local_98, (Variant*)local_78, (Variant*)&local_58, (bool*)&local_118);
                        ...
                        LAB_00102d94:puVar23 = *(undefined4**)( puVar23 + 0xc );
...
;
 ...
 while ( puVar23 != (undefined4*)0x0 );
               ...
               LAB_00102eb5:List<PropertyInfo,DefaultAllocator>::~List((List<PropertyInfo,DefaultAllocator>*)&local_120);
               iVar22 = iVar22 + 1;
            }
;
 ...
 while ( lVar13 != 0 );
   LAB_00103141:if (local_128 != (Image*)0x0) {
   ...
   LAB_00102378:do {
      ...
      if (lVar20 <= local_160) {
         ...
         local_110 = (Image*)0x0;
         if (CONCAT71(uStack_117, local_118) != 0) {
            pIVar17 = (Image*)__dynamic_cast(CONCAT71(uStack_117, local_118), &Object::typeinfo, &Texture2D::typeinfo, 0);
      ...
      while (true) {
         ...
         while (true) {
            ...
            if ((float)iVar9 < fVar27) {
               LAB_00102634:pIVar17 = local_128;
               Image::get_height();
               iVar9 = Image::get_width();
            ...
            local_d0 = CONCAT44(( fVar28 + auVar29._4_4_ ) - (float)( (ulong)uVar12 >> 0x20 ), ( fVar27 + auVar29._0_4_ ) - (float)uVar12);
...
;
         ...
         iVar26 = iVar26 + 1;
         puVar14 = (undefined8*)HashMap<Vector2i,Vector2i,HashMapHasherDefault,HashMapComparatorDefault<Vector2i>,DefaultTypedAllocator<HashMapElement<Vector2i,Vector2i>>>::operator []((HashMap<Vector2i,Vector2i,HashMapHasherDefault,HashMapComparatorDefault<Vector2i>,DefaultTypedAllocator<HashMapElement<Vector2i,Vector2i>>>*)( local_160 * 0x30 + *(long*)( this + 0xdd0 ) ), (Vector2i*)&local_b8);
         *puVar14 = local_98;
         iVar9 = iVar10;
      }
;
 ...
 while ( lVar13 != 0 );
   LAB_00102309:lVar20 = 0;
   LAB_0010230c:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, 0, lVar20, "p_index", "size()", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar4 = (code*)invalidInstructionException();
   ( *pcVar4 )();
}
/* AtlasMergingDialog::_generate_merged(Vector<Ref<TileSetAtlasSource> > const&, int) */void AtlasMergingDialog::_generate_merged(AtlasMergingDialog *this, Vector *param_1, int param_2) {
   undefined8 uVar1;
   char cVar2;
   Resource *this_00;
   long lVar3;
   ...
   *(undefined1(*) [16])( this_00 + 0x2c8 ) = (undefined1[16])0x0;
   ...
   if (cVar2 == '\0') {
      ...
      *(undefined8*)( this + 0xdc0 ) = 0;
      ...
      if (cVar2 == '\0') goto LAB_00103313;
      LAB_001033fb:( **(code**)( *(long*)pOVar6 + 0x140 ) )(pOVar6);
      ...
      if (this_00 != (Resource*)pOVar6) {
         *(Resource**)( this + 0xdc0 ) = this_00;
         ...
         pOVar5 = (Object*)this_00;
         if (( ( pOVar6 != (Object*)0x0 ) && ( cVar2 = RefCounted::unreference() ),cVar2 != '\0' )) goto LAB_001033fb;
      }
   ...
   LAB_00103313:LocalVector<HashMap<Vector2i,Vector2i,HashMapHasherDefault,HashMapComparatorDefault<Vector2i>,DefaultTypedAllocator<HashMapElement<Vector2i,Vector2i>>>,unsigned_int,false,false>::resize((LocalVector<HashMap<Vector2i,Vector2i,HashMapHasherDefault,HashMapComparatorDefault<Vector2i>,DefaultTypedAllocator<HashMapElement<Vector2i,Vector2i>>>,unsigned_int,false,false>*)( this + 0xdc8 ), 0);
...
/* CowData<Ref<TileSetAtlasSource> >::_copy_on_write() [clone .isra.0] */void CowData<Ref<TileSetAtlasSource>>::_copy_on_write(CowData<Ref<TileSetAtlasSource>> *this) {
   long lVar1;
   long lVar2;
   code *pcVar3;
   char cVar4;
...
/* AtlasMergingDialog::_update_texture() */void AtlasMergingDialog::_update_texture(AtlasMergingDialog *this) {
   long *plVar1;
   undefined8 *puVar2;
   Object *pOVar3;
   Ref *pRVar4;
   ...
   if (( local_70 == 0 ) || ( lVar9 = lVar9 < 2 )) {
      ...
      for (lVar8 = 0; lVar8 < lVar9; lVar8 = lVar8 + 1) {
         ...
         pOVar7 = local_80[0];
         if (( ( local_80[0] != (Object*)0x0 ) && ( pOVar7 = (Object*)__dynamic_cast(local_80[0], &Object::typeinfo, &TileSetAtlasSource::typeinfo, 0) ),pOVar7 != (Object*)0x0 )) {
            pOVar7 = (Object*)0x0;
         }
         ...
         iVar6 = CowData<Ref<TileSetAtlasSource>>::resize<false>((CowData<Ref<TileSetAtlasSource>>*)&local_60, lVar9);
         if (iVar6 == 0) {
            if (local_60 == 0) {
               lVar10 = -1;
               lVar9 = 0;
               LAB_001039f2:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar10, lVar9, "p_index", "size()", "", false, false);
            ...
            CowData<Ref<TileSetAtlasSource>>::_copy_on_write((CowData<Ref<TileSetAtlasSource>>*)&local_60);
            ...
            *puVar2 = pOVar7;
            if (pOVar7 != (Object*)0x0) {
               ...
               if (cVar5 == '\0') {
                  *puVar2 = 0;
                  ...
                  cVar5 = RefCounted::unreference();
                  joined_r0x00103812:if (( cVar5 != '\0' ) && ( cVar5 = cVar5 != '\0' )) goto LAB_001037d1;
               }
            ...
            if (( ( pOVar3 != (Object*)0x0 ) && ( cVar5 = RefCounted::unreference() ),cVar5 != '\0' )) {
               LAB_001037d1:( **(code**)( *(long*)pOVar3 + 0x140 ) )(pOVar3);
            ...
            joined_r0x00103770:if (pOVar7 != (Object*)0x0) {
               cVar5 = RefCounted::unreference();
               joined_r0x0010370f:if (( cVar5 != '\0' ) && ( cVar5 = cVar5 != '\0' )) {
         ...
         if (( ( local_80[0] != (Object*)0x0 ) && ( cVar5 = RefCounted::unreference() ),pOVar7 = local_80[0],cVar5 != '\0' )) &&( cVar5 = cVar5 != '\0' )(**(code**)( *(long*)pOVar7 + 0x140 ))(pOVar7);
         Memory::free_static(pOVar7, false);
      }
...
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* AtlasMergingDialog::_set(StringName const&, Variant const&) */undefined4 AtlasMergingDialog::_set(AtlasMergingDialog *this, StringName *param_1, Variant *param_2) {
   undefined4 uVar1;
   int iVar2;
   uVar1 = StringName::operator ==(param_1, "next_line_after_column");
   if ((char)uVar1 != '\0') {
...
/* AtlasMergingDialog::_notification(int) */void AtlasMergingDialog::_notification(AtlasMergingDialog *this, int param_1) {
   char cVar1;
   if (param_1 != 0x1e) {
      return;
   }
...
/* AtlasMergingDialog::_property_changed(StringName const&, Variant const&, String const&, bool) */void AtlasMergingDialog::_property_changed(StringName *param_1, Variant *param_2, String *param_3, bool param_4) {
   char cVar1;
   int iVar2;
...
/* ConfirmationDialog::is_class_ptr(void*) const */uint ConfirmationDialog::is_class_ptr(void *param_1) {
   undefined4 in_EDX;
   undefined4 *in_RSI;
   return (uint)CONCAT71(0x10d4, in_RSI == &AcceptDialog::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10d4, in_RSI == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10d4, in_RSI == &Window::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10d4, in_RSI == &Viewport::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10d5, in_RSI == &Node::get_class_ptr_static(), ::ptr) | CONCAT31(( int3 )((uint)in_EDX >> 8), in_RSI == &Object::get_class_ptr_static(), ::ptr);
}
...
/* AtlasMergingDialog::_property_can_revertv(StringName const&) const */undefined8 AtlasMergingDialog::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* AtlasMergingDialog::_property_get_revertv(StringName const&, Variant&) const */undefined8 AtlasMergingDialog::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* CallableCustomMethodPointer<AtlasMergingDialog, void, String
   const&>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<AtlasMergingDialog,void,String_const&>::~CallableCustomMethodPointer(CallableCustomMethodPointer<AtlasMergingDialog,void,String_const&> *this) {
   return;
}
/* CallableCustomMethodPointer<AtlasMergingDialog, void, StringName const&, Variant const&, String
   const&, bool>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<AtlasMergingDialog,void,StringName_const&,Variant_const&,String_const&,bool>::~CallableCustomMethodPointer(CallableCustomMethodPointer<AtlasMergingDialog,void,StringName_const&,Variant_const&,String_const&,bool> *this) {
   return;
}
/* CallableCustomMethodPointer<AtlasMergingDialog, void>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<AtlasMergingDialog,void>::~CallableCustomMethodPointer(CallableCustomMethodPointer<AtlasMergingDialog,void> *this) {
   return;
}
/* CallableCustomMethodPointer<AtlasMergingDialog, void, String const&>::get_argument_count(bool&)
   const */undefined8 CallableCustomMethodPointer<AtlasMergingDialog,void,String_const&>::get_argument_count(CallableCustomMethodPointer<AtlasMergingDialog,void,String_const&> *this, bool *param_1) {
   *param_1 = true;
   return 1;
}
/* CallableCustomMethodPointer<AtlasMergingDialog, void, StringName const&, Variant const&, String
   const&, bool>::get_argument_count(bool&) const */undefined8 CallableCustomMethodPointer<AtlasMergingDialog,void,StringName_const&,Variant_const&,String_const&,bool>::get_argument_count(CallableCustomMethodPointer<AtlasMergingDialog,void,StringName_const&,Variant_const&,String_const&,bool> *this, bool *param_1) {
   *param_1 = true;
   return 4;
}
/* CallableCustomMethodPointer<AtlasMergingDialog, void>::get_argument_count(bool&) const */undefined8 CallableCustomMethodPointer<AtlasMergingDialog,void>::get_argument_count(CallableCustomMethodPointer<AtlasMergingDialog,void> *this, bool *param_1) {
   *param_1 = true;
   return 0;
}
...
/* VBoxContainer::_get_class_namev() const */undefined8 *VBoxContainer::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001041c3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001041c3;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "VBoxContainer");
   LAB_0010422e:return &_get_class_namev();
}
/* CallableCustomMethodPointer<AtlasMergingDialog, void>::get_object() const */undefined8 CallableCustomMethodPointer<AtlasMergingDialog,void>::get_object(CallableCustomMethodPointer<AtlasMergingDialog,void> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   uVar2 = 0;
   LAB_0010435d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* CallableCustomMethodPointer<AtlasMergingDialog, void, StringName const&, Variant const&, String
   const&, bool>::get_object() const */undefined8 CallableCustomMethodPointer<AtlasMergingDialog,void,StringName_const&,Variant_const&,String_const&,bool>::get_object(CallableCustomMethodPointer<AtlasMergingDialog,void,StringName_const&,Variant_const&,String_const&,bool> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   uVar2 = 0;
   LAB_0010445d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* CallableCustomMethodPointer<AtlasMergingDialog, void, String const&>::get_object() const */undefined8 CallableCustomMethodPointer<AtlasMergingDialog,void,String_const&>::get_object(CallableCustomMethodPointer<AtlasMergingDialog,void,String_const&> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   uVar2 = 0;
   LAB_0010455d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* AtlasMergingDialog::_validate_propertyv(PropertyInfo&) const */void AtlasMergingDialog::_validate_propertyv(PropertyInfo *param_1) {
...
/* VBoxContainer::is_class_ptr(void*) const */uint VBoxContainer::is_class_ptr(void *param_1) {
   ...
   if (in_RSI != &get_class_ptr_static()::ptr) {
      uVar1 = (uint)CONCAT71(0x10d5, in_RSI == &Container::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10d5, in_RSI == &BoxContainer::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10d5, in_RSI == &Control::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10d5, in_RSI == &CanvasItem::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10d5, in_RSI == &Node::get_class_ptr_static(), ::ptr) | CONCAT31(( int3 )((uint)in_EDX >> 8), in_RSI == &Object::get_class_ptr_static(), ::ptr);
   }
...
/* HSplitContainer::is_class_ptr(void*) const */uint HSplitContainer::is_class_ptr(void *param_1) {
   ...
   uVar1 = 1;
   if (in_RSI != &get_class_ptr_static()::ptr) {
      uVar1 = (uint)CONCAT71(0x10d5, in_RSI == &Container::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10d3, in_RSI == &SplitContainer::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10d5, in_RSI == &Control::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10d5, in_RSI == &CanvasItem::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10d5, in_RSI == &Node::get_class_ptr_static(), ::ptr) | CONCAT31(( int3 )((uint)in_EDX >> 8), in_RSI == &Object::get_class_ptr_static(), ::ptr);
   }
...
/* WARNING: Removing unreachable block (ram,0x00104b08) *//* HSplitContainer::_getv(StringName const&, Variant&) const */undefined8 HSplitContainer::_getv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
   if (( (code*)PTR__get_00111048 != CanvasItem::_get ) && ( uVar1 = Control::_get(param_1, param_2) ),(char)uVar1 != '\0') {
      return uVar1;
   }
...
/* WARNING: Removing unreachable block (ram,0x00104b78) *//* VBoxContainer::_getv(StringName const&, Variant&) const */undefined8 VBoxContainer::_getv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
   if (( (code*)PTR__get_00111048 != CanvasItem::_get ) && ( uVar1 = Control::_get(param_1, param_2) ),(char)uVar1 != '\0') {
      return uVar1;
   }
...
/* AtlasMergingDialog::is_class_ptr(void*) const */uint AtlasMergingDialog::is_class_ptr(void *param_1) {
   uint uVar1;
   undefined4 in_EDX;
   undefined4 *in_RSI;
   uVar1 = 1;
   if (in_RSI != &get_class_ptr_static()::ptr) {
      uVar1 = (uint)CONCAT71(0x10d4, in_RSI == &AcceptDialog::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10d4, in_RSI == &ConfirmationDialog::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10d4, in_RSI == &Window::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10d4, in_RSI == &Viewport::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10d5, in_RSI == &Node::get_class_ptr_static(), ::ptr) | CONCAT31(( int3 )((uint)in_EDX >> 8), in_RSI == &Object::get_class_ptr_static(), ::ptr);
   }

   return uVar1;
}
/* AtlasMergingDialog::_getv(StringName const&, Variant&) const */ulong AtlasMergingDialog::_getv(AtlasMergingDialog *this, StringName *param_1, Variant *param_2) {
   uint uVar1;
   ulong uVar2;
   long in_FS_OFFSET;
   ...
   LAB_00104cfa:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* VBoxContainer::~VBoxContainer() */void VBoxContainer::~VBoxContainer(VBoxContainer *this) {
   ...
   *(code**)this = Container::_notification;
   ...
   LAB_00104d50:Control::~Control((Control*)this);
   return;
}
/* VBoxContainer::~VBoxContainer() */void VBoxContainer::~VBoxContainer(VBoxContainer *this) {
   bool bVar1;
   ...
   *(code**)this = Container::_notification;
   ...
   LAB_00104db0:Control::~Control((Control*)this);
...
/* AtlasMergingDialog::_get_class_namev() const */undefined8 *AtlasMergingDialog::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001050c3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001050c3;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "AtlasMergingDialog");
         goto LAB_0010512e;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "AtlasMergingDialog");
   LAB_0010512e:return &_get_class_namev();
}
/* ConfirmationDialog::_get_class_namev() const */undefined8 *ConfirmationDialog::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001051b3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001051b3;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "ConfirmationDialog");
   LAB_0010521e:return &_get_class_namev();
}
/* HSplitContainer::_get_class_namev() const */undefined8 *HSplitContainer::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001052a3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001052a3;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "HSplitContainer");
   LAB_0010530e:return &_get_class_namev();
}
/* HSplitContainer::~HSplitContainer() */void HSplitContainer::~HSplitContainer(HSplitContainer *this) {
   ...
   *(code**)this = Container::_notification;
   ...
   LAB_0010540f:Control::~Control((Control*)this);
   return;
}
/* HSplitContainer::~HSplitContainer() */void HSplitContainer::~HSplitContainer(HSplitContainer *this) {
   Object *pOVar1;
   ...
   *(code**)this = Container::_notification;
   ...
   LAB_001055bf:Control::~Control((Control*)this);
...
/* WARNING: Removing unreachable block (ram,0x00105b50) *//* String vformat<String, int>(String const&, String const, int const) */undefined8 *vformat<String,int>(undefined8 *param_1, bool *param_2, String *param_3, int param_4) {
   Variant *pVVar1;
   Variant *pVVar2;
   int iVar3;
   long in_FS_OFFSET;
...
/* AtlasMergingDialog::get_class() const */void AtlasMergingDialog::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* CallableCustomMethodPointer<AtlasMergingDialog, void>::call(Variant const**, int, Variant&,
   Callable::CallError&) const */void CallableCustomMethodPointer<AtlasMergingDialog,void>::call(CallableCustomMethodPointer<AtlasMergingDialog,void> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long lVar1;
   long lVar2;
   uint uVar3;
   ulong *puVar4;
...
;
      ...
      *(undefined4*)( param_4 + 8 ) = 0;
      ...
      _err_print_error("get_instance", "./core/object/object.h", 0x418, "Condition \"slot >= slot_max\" is true. Returning: nullptr", 0, 0);
      LAB_001064df:local_40 = 0;
      String::parse_latin1((String*)&local_40, "\', can\'t call method.");
      uitos((ulong)local_50);
      operator+((char *)
      local_48,(String*)"Invalid Object id \'";
      String::operator +(local_38, (String*)local_48);
      _err_print_error(&_LC48, "./core/object/callable_method_pointer.h", 0x67, "Parameter \"ObjectDB::get_instance(ObjectID(data.object_id))\" is null.", local_38, 0, 0);
   ...
   LAB_00106590:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* CallableCustomMethodPointer<AtlasMergingDialog, void, StringName const&, Variant const&, String
   const&, bool>::call(Variant const**, int, Variant&, Callable::CallError&) const */void CallableCustomMethodPointer<AtlasMergingDialog,void,StringName_const&,Variant_const&,String_const&,bool>::call(CallableCustomMethodPointer<AtlasMergingDialog,void,StringName_const&,Variant_const&,String_const&,bool> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long lVar1;
   long lVar2;
   undefined8 uVar3;
   char cVar4;
...
;
            ...
            if ((uint)param_2 < 5) {
               if (param_2 == 4) {
                  *(undefined4*)param_4 = 0;
                  ...
                  ( *pcVar7 )((long*)( lVar1 + lVar2 ), &local_60, (Variant*)local_58, (Variant*)&local_68, bVar8);
   ...
   _err_print_error(&_LC48, "./core/object/callable_method_pointer.h", 0x67, "Parameter \"ObjectDB::get_instance(ObjectID(data.object_id))\" is null.", &local_60, 0, 0);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
   CowData<char32_t>::_unref(local_70);
   CowData<char32_t>::_unref(local_78);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
   LAB_0010666c:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* CallableCustomMethodPointer<AtlasMergingDialog, void, String const&>::call(Variant const**, int,
   Variant&, Callable::CallError&) const */void CallableCustomMethodPointer<AtlasMergingDialog,void,String_const&>::call(CallableCustomMethodPointer<AtlasMergingDialog,void,String_const&> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long lVar1;
   long lVar2;
   undefined8 uVar3;
   char cVar4;
...
;
   ...
   CowData<char32_t>::_unref(local_50);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_40);
   LAB_001069ae:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* AtlasMergingDialog::_initialize_classv() */void AtlasMergingDialog::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_60;
   long local_58;
   undefined8 local_50;
...
/* Node::is_class(String const&) const */undefined8 Node::is_class(Node *this, String *param_1) {
   ...
   if (cVar5 == '\0') {
      ...
      LAB_0010831b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* AcceptDialog::is_class(String const&) const */undefined8 AcceptDialog::is_class(AcceptDialog *this, String *param_1) {
   ...
   LAB_001084f3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0010868e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* ConfirmationDialog::is_class(String const&) const */undefined8 ConfirmationDialog::is_class(ConfirmationDialog *this, String *param_1) {
   ...
   if (cVar4 == '\0') {
      ...
      LAB_0010879b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* Container::is_class(String const&) const */undefined8 Container::is_class(Container *this, String *param_1) {
   ...
   LAB_00108a5e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* VBoxContainer::is_class(String const&) const */undefined8 VBoxContainer::is_class(VBoxContainer *this, String *param_1) {
   ...
   LAB_00108b6b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_00108c6e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* HSplitContainer::is_class(String const&) const */undefined8 HSplitContainer::is_class(HSplitContainer *this, String *param_1) {
   ...
   LAB_00108d7b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_00108e7e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* PropertyListHelper::~PropertyListHelper() */void PropertyListHelper::~PropertyListHelper(PropertyListHelper *this) {
 ...
 while ( lVar2 != (ulong)uVar1 << 2 );
   ...
   LAB_00108f7f:CowData<char32_t>::_unref((CowData<char32_t>*)this);
   return;
}
/* AtlasMergingDialog::is_class(String const&) const */undefined8 AtlasMergingDialog::is_class(AtlasMergingDialog *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long lVar4;
   ...
   LAB_001090db:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_001091de:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* AtlasMergingDialog::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void AtlasMergingDialog::_get_property_listv(AtlasMergingDialog *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   undefined8 local_90;
   undefined8 local_88;
   long local_80;
...
/* LocalVector<HashMap<Vector2i, Vector2i, HashMapHasherDefault, HashMapComparatorDefault<Vector2i>,
   ...
   false>::resize(unsigned int) */void LocalVector<HashMap<Vector2i,Vector2i,HashMapHasherDefault,HashMapComparatorDefault<Vector2i>,DefaultTypedAllocator<HashMapElement<Vector2i,Vector2i>>>,unsigned_int,false,false>::resize(LocalVector<HashMap<Vector2i,Vector2i,HashMapHasherDefault,HashMapComparatorDefault<Vector2i>,DefaultTypedAllocator<HashMapElement<Vector2i,Vector2i>>>,unsigned_int,false,false> *this, uint param_1) {
   uint uVar1;
   code *pcVar2;
   undefined8 uVar3;
   int *piVar4;
 ...
 while ( lVar6 + 0x30 + ( ( ulong )(uVar1 - uVar8) + (ulong)uVar8 ) * 0x30 != lVar5 );
   ...
   LAB_0010ab2b:*(uint*)this = param_1;
   return;
}
/* AtlasMergingDialog::~AtlasMergingDialog() */void AtlasMergingDialog::~AtlasMergingDialog(AtlasMergingDialog *this) {
   Object *pOVar1;
   char cVar2;
   *(undefined***)this = &PTR__initialize_classv_0010cf10;
   ...
   if (*(long*)( this + 0xdd0 ) != 0) {
      LocalVector<HashMap<Vector2i,Vector2i,HashMapHasherDefault,HashMapComparatorDefault<Vector2i>,DefaultTypedAllocator<HashMapElement<Vector2i,Vector2i>>>,unsigned_int,false,false>::resize((LocalVector<HashMap<Vector2i,Vector2i,HashMapHasherDefault,HashMapComparatorDefault<Vector2i>,DefaultTypedAllocator<HashMapElement<Vector2i,Vector2i>>>,unsigned_int,false,false>*)( this + 0xdc8 ), 0);
...
/* HashMap<Vector2i, Vector2i, HashMapHasherDefault, HashMapComparatorDefault<Vector2i>,
   ...
   unsigned int&) const */undefined8 HashMap<Vector2i,Vector2i,HashMapHasherDefault,HashMapComparatorDefault<Vector2i>,DefaultTypedAllocator<HashMapElement<Vector2i,Vector2i>>>::_lookup_pos(HashMap<Vector2i,Vector2i,HashMapHasherDefault,HashMapComparatorDefault<Vector2i>,DefaultTypedAllocator<HashMapElement<Vector2i,Vector2i>>> *this, Vector2i *param_1, uint *param_2) {
   uint uVar1;
   ulong uVar2;
...
/* Ref<TileSetAtlasSource>::unref() */void Ref<TileSetAtlasSource>::unref(Ref<TileSetAtlasSource> *this) {
   Object *pOVar1;
   char cVar2;
   if (*(long*)this != 0) {
      cVar2 = RefCounted::unreference();
...
/* HashMap<Vector2i, Vector2i, HashMapHasherDefault, HashMapComparatorDefault<Vector2i>,
   DefaultTypedAllocator<HashMapElement<Vector2i, Vector2i> > >::_resize_and_rehash(unsigned int) */void HashMap<Vector2i,Vector2i,HashMapHasherDefault,HashMapComparatorDefault<Vector2i>,DefaultTypedAllocator<HashMapElement<Vector2i,Vector2i>>>::_resize_and_rehash(HashMap<Vector2i,Vector2i,HashMapHasherDefault,HashMapComparatorDefault<Vector2i>,DefaultTypedAllocator<HashMapElement<Vector2i,Vector2i>>> *this, uint param_1) {
   uint *puVar1;
   undefined8 *puVar2;
   uint uVar3;
   uint uVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<Vector2i, Vector2i, HashMapHasherDefault, HashMapComparatorDefault<Vector2i>,
...
::insert(Vector2i *param_1,Vector2i *param_2,bool param_3){
 ...
 while ( uVar28 != uVar24 );
   ...
   local_6c[0] = 0;
   cVar16 = _lookup_pos((HashMap<Vector2i,Vector2i,HashMapHasherDefault,HashMapComparatorDefault<Vector2i>,DefaultTypedAllocator<HashMapElement<Vector2i,Vector2i>>>*)param_2, pVVar22, local_6c);
   if (cVar16 == '\0') {
      if ((float)uVar17 * __LC69 < (float)( *(int*)( param_2 + 0x2c ) + 1 )) {
         ...
         _resize_and_rehash((HashMap<Vector2i,Vector2i,HashMapHasherDefault,HashMapComparatorDefault<Vector2i>,DefaultTypedAllocator<HashMapElement<Vector2i,Vector2i>>>*)param_2, *(int*)( param_2 + 0x28 ) + 1);
      }
      ...
      *(undefined8*)( pauVar19[1] + 8 ) = local_50;
      ...
      uVar17 = ( *(int*)pVVar22 * 0x16a88000 | ( uint )(*(int*)pVVar22 * -0x3361d2af) >> 0x11 ) * 0x1b873593 ^ 0x7f07c65;
      uVar17 = ( uVar17 << 0xd | uVar17 >> 0x13 ) * 5 + 0xe6546b64 ^ ( *(int*)( pVVar22 + 4 ) * 0x16a88000 | ( uint )(*(int*)( pVVar22 + 4 ) * -0x3361d2af) >> 0x11 ) * 0x1b873593;
...
;
   ...
   LAB_0010b665:*(undefined1(**) [16])param_1 = pauVar19;
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<Vector2i, Vector2i, HashMapHasherDefault, HashMapComparatorDefault<Vector2i>,
   DefaultTypedAllocator<HashMapElement<Vector2i, Vector2i> > >::operator[](Vector2i const&) */undefined1 * __thiscallHashMap<Vector2i,Vector2i,HashMapHasherDefault,HashMapComparatorDefault<Vector2i>,DefaultTypedAllocator<HashMapElement<Vector2i,Vector2i>>>::operator [](HashMap<Vector2i,Vector2i,HashMapHasherDefault,HashMapComparatorDefault<Vector2i>,DefaultTypedAllocator<HashMapElement<Vector2i,Vector2i>>> * this, Vector2i * param_1) * puVar1 ;uint uVar2undefined8 *puVar3long lVar4long lVar5long lVar6void *__sundefined1 auVar7[16]undefined1 auVar8[16]undefined1 auVar9[16]undefined1 auVar10[16]undefined1 auVar11[16]undefined1 auVar12[16]undefined1 auVar13[16]undefined1 auVar14[16]undefined1(*pauVar15)[16];char cVar16uint uVar17uint uVar18undefined1(*pauVar19)[16];undefined8 uVar20void *__s_00int iVar21long lVar22ulong uVar23uint uVar24ulong uVar25ulong uVar26undefined1(*pauVar27)[16];long in_FS_OFFSETuint local_98uint local_70uint local_6c[5]undefined8 local_58undefined8 local_50long local_40local_40 = *(long*)( in_FS_OFFSET + 0x28 );local_70 = 0;cVar16 = _lookup_pos(this, param_1, &local_70);if (cVar16 == '\0') {
 ...
 while ( uVar26 != uVar23 );
   ...
   if (cVar16 == '\0') {
      ...
      *(undefined1(**) [16])( this + 0x20 ) = pauVar19;
      ...
      uVar17 = ( uVar17 << 0xd | uVar17 >> 0x13 ) * 5 + 0xe6546b64 ^ ( *(int*)( param_1 + 4 ) * 0x16a88000 | ( uint )(*(int*)( param_1 + 4 ) * -0x3361d2af) >> 0x11 ) * 0x1b873593;
      uVar17 = ( uVar17 << 0xd | uVar17 >> 0x13 ) * 5 + 0xe6546b64;
      uVar17 = ( uVar17 >> 0x10 ^ uVar17 ) * -0x7a143595;
      uVar18 = ( uVar17 ^ uVar17 >> 0xd ) * -0x3d4d51cb;
      uVar17 = uVar18 ^ uVar18 >> 0x10;
...
LAB_0010ba5b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return pauVar19[1] + 8;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* AtlasMergingDialog::_merge_confirmed(String const&) [clone .cold] */void AtlasMergingDialog::_merge_confirmed(String *param_1) {
   code *pcVar1;
...
/* CowData<Ref<TileSetAtlasSource> >::_copy_on_write() [clone .isra.0] [clone .cold] */void CowData<Ref<TileSetAtlasSource>>::_copy_on_write(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* CowData<Ref<TileSetAtlasSource> >::_unref() */void CowData<Ref<TileSetAtlasSource>>::_unref(CowData<Ref<TileSetAtlasSource>> *this) {
   long *plVar1;
   long lVar2;
   Object *pOVar3;
   code *pcVar4;
...
/* CowData<Ref<TileSetAtlasSource> >::_realloc(long) */undefined8 CowData<Ref<TileSetAtlasSource>>::_realloc(CowData<Ref<TileSetAtlasSource>> *this, long param_1) {
   undefined8 *puVar1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Ref<TileSetAtlasSource> >::resize<false>(long) */undefined8 CowData<Ref<TileSetAtlasSource>>::resize<false>(CowData<Ref<TileSetAtlasSource>> *this, long param_1) {
   long *plVar1;
   Object *pOVar2;
   code *pcVar3;
   char cVar4;
   ...
   if (param_1 * 8 == 0) {
      LAB_0010c090:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (lVar11 == lVar8) {
      LAB_0010c00b:puVar10 = *(undefined8**)this;
      if (puVar10 == (undefined8*)0x0) {
         LAB_0010bf00:/* WARNING: Does not return */pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
      }
   ...
   LAB_0010bfeb:puVar10[-1] = param_1;
   return 0;
}
/* AtlasMergingDialog::_notificationv(int, bool) */void AtlasMergingDialog::_notificationv(AtlasMergingDialog *this, int param_1, bool param_2) {
   char cVar1;
   if (param_2) {
      if (param_1 == 0x1e) {
         cVar1 = Window::is_visible();
...
/* AtlasMergingDialog::_setv(StringName const&, Variant const&) */undefined8 AtlasMergingDialog::_setv(AtlasMergingDialog *this, StringName *param_1, Variant *param_2) {
   char cVar1;
   int iVar2;
   undefined8 uVar3;
   if (( (code*)PTR__set_00111018 != Object::_set ) && ( cVar1 = Window::_set((StringName*)this, (Variant*)param_1) ),cVar1 != '\0') {
      return 1;
   }
...
/* AtlasMergingDialog::_property_changed(StringName const&, Variant const&, String const&, bool) */void AtlasMergingDialog::_GLOBAL__sub_I__property_changed(void) {
   undefined8 uStack_8;
...
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<AtlasMergingDialog, void>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<AtlasMergingDialog,void>::~CallableCustomMethodPointer(CallableCustomMethodPointer<AtlasMergingDialog,void> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<AtlasMergingDialog, void, StringName const&, Variant const&, String
   const&, bool>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<AtlasMergingDialog,void,StringName_const&,Variant_const&,String_const&,bool>::~CallableCustomMethodPointer(CallableCustomMethodPointer<AtlasMergingDialog,void,StringName_const&,Variant_const&,String_const&,bool> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<AtlasMergingDialog, void, String
   const&>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<AtlasMergingDialog,void,String_const&>::~CallableCustomMethodPointer(CallableCustomMethodPointer<AtlasMergingDialog,void,String_const&> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* AtlasMergingDialog::~AtlasMergingDialog() */void AtlasMergingDialog::~AtlasMergingDialog(AtlasMergingDialog *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

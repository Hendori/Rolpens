/* scheduleDispatch(FfxFsr2Context_Private*, FfxFsr2DispatchDescription const*, FfxPipelineState
   const*, unsigned int, unsigned int) [clone .isra.0] */void scheduleDispatch(FfxFsr2Context_Private *param_1, FfxFsr2DispatchDescription *param_2, FfxPipelineState *param_3, uint param_4, uint param_5) {
   undefined8 *__s;
   code *pcVar1;
   uint uVar2;
   undefined4 uVar3;
   ...
   if (*(int*)( param_2 + 0x14 ) != 0) {
      ...
      *(undefined1**)( puVar5 + -0x1f50 ) = puVar5 + 0xc04;
      ...
      do {
         ...
         uVar13 = uVar13 - 0x100;
         *(undefined4*)( puVar5 + lVar12 * 4 + -0x43c ) = *(undefined4*)( param_1 + ( ulong ) * (uint*)( pFVar11 + -4 ) * 4 + 0xf3e0 );
         lVar12 = lVar12 + 1;
   ...
   *(undefined4*)( puVar5 + -0x444 ) = *(undefined4*)( puVar5 + -0x1f3c );
   if (*(int*)( param_2 + 0x18 ) != 0) {
      ...
      do {
         ...
         *(undefined8*)( (long)puVar8 + 0x337c ) = *(undefined8*)( &globalFsr2ConstantBuffers + (ulong)uVar2 * 0x41 );
...
/* patchResourceBindings(FfxPipelineState*) [clone .isra.0] */void patchResourceBindings(FfxPipelineState *param_1) {
   uint uVar1;
   int iVar2;
   int iVar3;
...
/* createPipelineStates(FfxFsr2Context_Private*) */ulong createPipelineStates(FfxFsr2Context_Private *param_1) {
   ...
   if ((int)uVar2 == 0) {
      ...
      if ((int)uVar2 == 0) {
         uVar2 = ( **(code**)( param_1 + 0x58 ) )(pFVar1, 7, local_78, (FfxPipelineState*)( param_1 + 0xbe00 ));
         if ((int)uVar2 == 0) {
            uVar2 = ( **(code**)( param_1 + 0x58 ) )(pFVar1, 8, local_78, (FfxPipelineState*)( param_1 + 0xd8f0 ));
            if ((int)uVar2 == 0) {
               local_58 = 1;
               uVar2 = ( **(code**)( param_1 + 0x58 ) )(pFVar1, 0, local_78, (FfxPipelineState*)( param_1 + 0x170 ));
               if ((int)uVar2 == 0) {
                  uVar2 = ( **(code**)( param_1 + 0x58 ) )(pFVar1, 1, local_78, (FfxPipelineState*)( param_1 + 0x1c60 ));
                  if ((int)uVar2 == 0) {
                     uVar2 = ( **(code**)( param_1 + 0x58 ) )(pFVar1, 2, local_78, (FfxPipelineState*)( param_1 + 0x3750 ));
                     if ((int)uVar2 == 0) {
                        uVar2 = ( **(code**)( param_1 + 0x58 ) )(pFVar1, 3, local_78, (FfxPipelineState*)( param_1 + 0x5240 ));
                        if ((int)uVar2 == 0) {
                           uVar2 = ( **(code**)( param_1 + 0x58 ) )(pFVar1, 4, local_78, (FfxPipelineState*)( param_1 + 0x6d30 ));
                           if ((int)uVar2 == 0) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* fsr2Create(FfxFsr2Context_Private*, FfxFsr2ContextDescription const*) */void fsr2Create(FfxFsr2Context_Private *param_1, FfxFsr2ContextDescription *param_2) {
   FfxFsr2Context_Private *pFVar1;
   ...
   *(undefined8*)( param_1 + 8 ) = uVar3;
   for (int i = 0; i < 8; i++) {
      uVar3 = *(undefined8*)( param_2 + ( 16*i + 24 ) );
      *(undefined8*)( param_1 + ( 16*i + 16 ) ) = *(undefined8*)( param_2 + ( 16*i + 16 ) );
      *(undefined8*)( param_1 + ( 16*i + 24 ) ) = uVar3;
   }
 ...
 while ( lVar6 != 0x100 );
         ...
         *(undefined8*)( param_1 + 0xf4c0 ) = 0;
         ...
         for (uVar7 = ( ulong )(( (int)param_1 - (int)(undefined8*)( ( ulong )(param_1 + 0xf3e8) & 0xfffffffffffffff8 ) ) + 0xf4c8U >> 3); uVar7 != 0; uVar7 = uVar7 - 1) {
            *puVar10 = 0;
            puVar10 = puVar10 + (ulong)bVar11 * -2 + 1;
         }
         ...
         do {
            ...
            iVar5 = ( **(code**)( param_1 + 0x30 ) )(pFVar1, &local_978, param_1 + ( ulong ) * puVar9 * 4 + 0xf3e0);
            if (iVar5 != 0) goto LAB_001010a7;
            puVar9 = puVar9 + 0xe;
         }
 while ( (uint*)local_40 != puVar9 );
         for (int i = 0; i < 28; i++) {
            *(undefined8*)( param_1 + ( 8*i + 62664 ) ) = *(undefined8*)( param_1 + ( 8*i + 62432 ) );
         }
   ...
   LAB_001010a7:if (local_40[0] == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* fsr2Dispatch(FfxFsr2Context_Private*, FfxFsr2DispatchDescription const*) */undefined8 fsr2Dispatch(FfxFsr2Context_Private *param_1, FfxFsr2DispatchDescription *param_2) {
   undefined8 *__s;
   float fVar1;
   float fVar2;
   float fVar3;
 ...
 while ( puVar22 + -0x1000 != local_7030 );
   ...
   *(long*)( puVar22 + -0x1038 ) = lVar16;
   if (( *(uint*)param_1 & 0x100 ) != 0) {
      ...
      if (( _LC53 < (float)( *(uint*)( param_2 + 0x890 ) & _LC3 ) ) || ( fVar37 = _LC53 ),_LC53 < (float)( *(uint*)( param_2 + 0x894 ) & _LC3 )) {
      ...
      if (( (float)*(uint*)( param_1 + 4 ) < fVar1 ) || ( (float)*(uint*)( param_1 + 8 ) < *(float*)( param_2 + 0x89c ) )) {
   ...
   *(undefined4*)( param_1 + 0xf40c ) = *(undefined4*)( param_1 + ( ulong ) * (uint*)( puVar22 + -0x102c ) * 4 + 0xf3e0 );
   *(undefined4*)( param_1 + 0xf4f8 ) = *(undefined4*)( param_1 + ( ulong ) * (uint*)( puVar22 + -0x1030 ) * 4 + 0xf4c8 );
   uVar13 = *(undefined4*)( param_1 + ( ( ulong ) * (uint*)( puVar22 + -0x1020 ) + 0x3d30 ) * 4 + 8 );
   *(undefined4*)( param_1 + 0xf430 ) = *(undefined4*)( param_1 + ( ( ulong ) * (uint*)( puVar22 + -0x1020 ) + 0x3d30 ) * 4 + 8 );
   ...
   *(undefined4*)( param_1 + 0xf504 ) = *(undefined4*)( param_1 + ( ulong ) * (uint*)( puVar22 + -0x1014 ) * 4 + 0xf4c8 );
   *(undefined4*)( param_1 + 0xf41c ) = *(undefined4*)( param_1 + ( ulong ) * (uint*)( puVar22 + -0x1018 ) * 4 + 0xf3e0 );
   *(undefined4*)( param_1 + 0xf498 ) = *(undefined4*)( param_1 + ( ulong )(( -(uint)(uVar12 == 0) & 0xfffffffe ) + 0x32) * 4 + 0xf3e0 );
   *(undefined4*)( param_1 + 0xf580 ) = *(undefined4*)( param_1 + ( ulong )(( -(uint)(uVar12 == 0) & 2 ) + 0x30) * 4 + 0xf4c8 );
   uVar13 = *(undefined4*)( param_1 + 0xf3e8 );
   *(undefined4*)( param_1 + 0xf49c ) = *(undefined4*)( param_1 + ( ulong ) * (uint*)( puVar22 + -0x1010 ) * 4 + 0xf3e0 );
   uVar15 = *(undefined8*)( puVar22 + -0x1048 );
   *(undefined4*)( param_1 + 0xf584 ) = *(undefined4*)( param_1 + ( ulong )(( -(uint)(uVar12 == 0) & 2 ) + 0x31) * 4 + 0xf4c8 );
   ...
   *(uint*)( param_1 + 0x110 ) = ( uint ) * (float*)( param_2 + 0x8c8 ) & uVar29 | ~uVar29 & (uint)fVar2;
   fVar38 = fVar37;
   if (( fVar31 <= fVar37 ) && ( fVar38 = fVar31 < fVar37 )) {
      fVar31 = fVar37;
   }
   ...
   *(float*)( puVar22 + -0xf2c ) = _LC80;
   uVar27 = CONCAT44((float)(int)( ( ulong ) * (undefined8*)( puVar22 + -0x1028 ) >> 0x20 ), (float)(int)*(undefined8*)( puVar22 + -0x1028 ));
   ...
   *(ulong*)( param_1 + 200 ) = CONCAT44(*(undefined4*)( puVar22 + lVar16 * 4 + 0x2858 ), *(uint*)( puVar22 + lVar16 * 4 + -0xf38 ) ^ _LC81);
   *(ulong*)( param_1 + 0xd0 ) = CONCAT44(fVar31 / ( fVar2 / fVar38 ), fVar31 / ( ( fVar2 / fVar38 ) / fVar3 ));
   ...
   *(float*)( param_1 + 0xf8 ) = fVar37;
   if (( uVar7 & 2 ) != 0) {
      uVar27 = CONCAT44((float)(int)( ( ulong ) * (undefined8*)( param_1 + 0xa8 ) >> 0x20 ), (float)(int)*(undefined8*)( param_1 + 0xa8 ));
   }
   ...
   *(long*)( param_1 + 0xe0 ) = auVar36._0_8_;
   if (( uVar7 & 4 ) != 0) {
      ...
      auVar34._4_4_ = (float)( ( ulong ) * (undefined8*)( param_1 + 0xf5b8 ) >> 0x20 ) - (float)( (ulong)uVar15 >> 0x20 );
      auVar34._8_8_ = 0;
   ...
   fVar37 = (float)(int)( (double)( (float)(int)uVar6 / (float)*(int*)( puVar22 + -0x100c ) ) * (double)( (float)(int)uVar6 / (float)*(int*)( puVar22 + -0x100c ) ) * __LC83 );
   if (puVar22[-0x103c] == '\0') {
      ...
      if (( fVar37 <= fVar31 ) && ( fVar31 = fVar37 < 0.0 )) {
         fVar31 = 0.0;
      }
   ...
   *(int*)( param_1 + 0xbc ) = (int)(long)( (float)iVar9 * fVar37 );
   for (int i = 0; i < 4; i++) {
      uVar15 = *(undefined8*)( param_2 + ( 16*i + 2592 ) );
      *(undefined8*)( param_1 + ( 16*i + 280 ) ) = *(undefined8*)( param_2 + ( 16*i + 2584 ) );
      *(undefined8*)( param_1 + ( 16*i + 288 ) ) = uVar15;
   }
   ...
   if (cVar5 != '\0') {
      ...
      *(undefined8*)( puVar22 + -0x1050 ) = 0x1019ed;
      memset(puVar23, 0, 0x3798);
      uVar15 = *(undefined8*)( puVar22 + -0x1048 );
      *(undefined4*)( puVar22 + 0x2870 ) = *(undefined4*)( param_1 + *(long*)( puVar22 + -0x1000 ) * 4 + 0xf3e0 );
      pcVar14 = *(code**)( param_1 + 0x68 );
      *(undefined8*)( puVar22 + -0x1050 ) = 0x101a0f;
      ( *pcVar14 )(uVar15, puVar23);
      *(undefined1(*) [16])( puVar22 + 0x2860 ) = (undefined1[16])0x0;
      *(undefined4*)( puVar22 + 0x2870 ) = *(undefined4*)( param_1 + *(long*)( puVar22 + -0xff8 ) * 4 + 0xf3e0 );
      pcVar14 = *(code**)( param_1 + 0x68 );
   ...
   *(undefined8*)( puVar22 + -0x1050 ) = 0x101ae4;
   ...
   if ((double)( (ulong)dVar32 & _LC94 ) < _LC86) {
      dVar32 = (double)( ( ulong )((double)(long)dVar32 - (double)( -(ulong)(dVar32 < (double)(long)dVar32) & _LC88 )) | ~_LC94 & (ulong)dVar32 );
   }
   ...
   *(uint*)( puVar22 + -0xf64 ) = ( ( ( (uint)fVar37 & 0x7fffff ) >> ( f32tof16(float):: ) ) + ( uint ) * (ushort*)( f32tof16(float):: ) ) * 0x10001;
   ...
   *(undefined8*)( puVar22 + -0x1050 ) = 0x101c8d;
   ...
   if (param_2[0x8cc] != (FfxFsr2DispatchDescription)0x0) {
      ...
      *(ulong*)( puVar22 + -0x1028 ) = CONCAT44(( uint )((int)( ( ulong ) * (undefined8*)( param_2 + 0x8a0 ) >> 0x20 ) + _LC92._4_4_) >> 3, ( uint )((int)*(undefined8*)( param_2 + 0x8a0 ) + (int)_LC92) >> 3);
      ...
      *(undefined8*)( puVar22 + -0x1050 ) = 0x1023de;
      ...
      for (int i = 0; i < 4; i++) {
         *(undefined4*)( puVar22 + ( 4*i + 7172 ) ) = *(undefined4*)( param_1 + ( 4*i + 62840 ) );
      }

      for (int i = 0; i < 4; i++) {
         *(undefined8*)( puVar22 + -4176 ) = ( 25*i + 1057846 );
         __wcscpy_chk(puVar22 + ( 256*i + 7236 ), param_1 + ( 264*i + 55572 ), ( -64*i + 512 ));
      }
      ...
      if (iVar25 != 0) {
         *(FfxFsr2DispatchDescription**)( puVar22 + -0x1028 ) = param_2;
         ...
         do {
            ...
            uVar18 = uVar27 >> 2;
            uVar27 = uVar27 - 0x100;
            *(undefined4*)( puVar22 + lVar16 * 4 + 0xbc4 ) = *(undefined4*)( param_1 + ( ulong ) * (uint*)( pFVar20 + -4 ) * 4 + 0xf3e0 );
            lVar16 = lVar16 + 1;
      ...
      if (*(int*)( param_1 + 0xd908 ) != 0) {
         ...
         *(FfxFsr2DispatchDescription**)( puVar22 + -0x1028 ) = param_2;
         ...
         do {
            ...
            *(undefined8*)( (long)puVar21 + 0x337c ) = *(undefined8*)( &globalFsr2ConstantBuffers + (ulong)uVar12 * 0x41 );
 ...
 while ( (uint)lVar16 < *(uint*)( param_1 + 0xd908 ) );
   ...
   *(undefined8*)( puVar22 + -0x1050 ) = 0x101cb1;
   scheduleDispatch(param_1, (FfxFsr2DispatchDescription*)( param_1 + 0xa310 ), (FfxPipelineState*)( ulong ) * (uint*)( puVar22 + -0x103c ), *(uint*)( puVar22 + -0x1030 ), in_R8D);
   uVar12 = *(uint*)( puVar22 + -0x1020 );
   uVar6 = *(uint*)( puVar22 + -0x102c );
   *(undefined8*)( puVar22 + -0x1050 ) = 0x101cd0;
   scheduleDispatch(param_1, (FfxFsr2DispatchDescription*)( param_1 + 0x1c60 ), (FfxPipelineState*)(ulong)uVar6, uVar12, in_R8D);
   *(undefined8*)( puVar22 + -0x1050 ) = 0x101ce5;
   scheduleDispatch(param_1, (FfxFsr2DispatchDescription*)( param_1 + 0x170 ), (FfxPipelineState*)(ulong)uVar6, uVar12, in_R8D);
   FVar4 = param_2[0x8a8];
   *(undefined8*)( puVar22 + -0x1050 ) = 0x101d01;
   scheduleDispatch(param_1, (FfxFsr2DispatchDescription*)( param_1 + 0x3750 ), (FfxPipelineState*)(ulong)uVar6, uVar12, in_R8D);
   if (FVar4 == (FfxFsr2DispatchDescription)0x0) {
      *(undefined8*)( puVar22 + -0x1050 ) = 0x102367;
      scheduleDispatch(param_1, (FfxFsr2DispatchDescription*)( param_1 + 0x5240 ), (FfxPipelineState*)( ulong ) * (uint*)( puVar22 + -0x101c ), *(uint*)( puVar22 + -0x1018 ), in_R8D);
   }
 else {
      *(undefined8*)( puVar22 + -0x1050 ) = 0x101d20;
      scheduleDispatch(param_1, (FfxFsr2DispatchDescription*)( param_1 + 0x6d30 ), (FfxPipelineState*)( ulong ) * (uint*)( puVar22 + -0x101c ), *(uint*)( puVar22 + -0x1018 ), in_R8D);
      iVar25 = *(int*)( param_1 + 0x10 );
      iVar19 = *(int*)( param_1 + 0xc );
      *(undefined8*)( puVar22 + -0x1050 ) = 0x101d43;
      scheduleDispatch(param_1, (FfxFsr2DispatchDescription*)( param_1 + 0x8820 ), (FfxPipelineState*)( ulong )(iVar19 + 0xfU >> 4), iVar25 + 0xfU >> 4, in_R8D);
   }
   ...
   *(undefined8*)( puVar22 + -0x1050 ) = 0x101d6e;
   ( *pcVar14 )(uVar15);
   uVar15 = 0;
   LAB_00101d70:if (*(long*)( puVar22 + 0x5ff0 ) == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar15;
   }
...
undefined8 ffxFsr2ContextCreate(void *param_1, FfxFsr2ContextDescription *param_2) {
   ...
   if (( ( ( *(long*)( param_2 + 0x20 ) != 0 ) && ( *(long*)( param_2 + 0x18 ) != 0 ) ) && ( *(long*)( param_2 + 0x28 ) != 0 ) ) && ( ( *(long*)( param_2 + 0x78 ) == 0 || ( *(long*)( param_2 + 0x80 ) != 0 ) ) )) {
...
undefined8 ffxFsr2ContextDestroy(long param_1) {
   ...
   if (param_1 != 0) {
      ...
      for (int i = 0; i < 9; i++) {
         ( **(code**)( param_1 + 96 ) )(lVar1, param_1 + ( 6896*i + 368 ));
      }
...
undefined8 ffxFsr2ContextDispatch(FfxFsr2Context_Private *param_1, FfxFsr2DispatchDescription *param_2) {
   undefined8 uVar1;
   if (( param_2 == (FfxFsr2DispatchDescription*)0x0 ) || ( param_1 == (FfxFsr2Context_Private*)0x0 )) {
      return 0x80000000;
   }

   if (( *(uint*)( param_2 + 0x8a0 ) <= *(uint*)( param_1 + 4 ) ) && ( *(uint*)( param_2 + 0x8a4 ) <= *(uint*)( param_1 + 8 ) )) {
      if (*(long*)( param_1 + 0x158 ) != 0) {
...
undefined8 ffxFsr2GetRenderResolutionFromQualityMode(undefined4 *param_1, undefined4 *param_2, uint param_3, uint param_4, int param_5) {
   float fVar1;
...
/* ffxFsr2ContextEnqueueRefreshPipelineRequest(FfxFsr2Context*) */undefined8 ffxFsr2ContextEnqueueRefreshPipelineRequest(FfxFsr2Context *param_1) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int ffxFsr2GetJitterPhaseCount(int param_1, int param_2) {
   return (int)( (double)( (float)param_2 / (float)param_1 ) * (double)( (float)param_2 / (float)param_1 ) * __LC83 );
}
   ...
   if (0 < (int)uVar2) {
      ...
      do {
         ...
         if ((float)( (uint)fVar3 & _LC3 ) < _LC96) {
            fVar3 = (float)( ( uint )((float)(int)fVar3 - (float)( -(uint)(fVar3 < (float)(int)fVar3) & (uint)_LC53 )) | ~_LC3 & (uint)fVar3 );
         }
 ...
 while ( 0 < (int)uVar1 );
      ...
      do {
         ...
         if ((float)( (uint)fVar4 & _LC3 ) < _LC96) {
            fVar4 = (float)( ( uint )((float)(int)fVar4 - (float)( -(uint)(fVar4 < (float)(int)fVar4) & (uint)_LC53 )) | ~_LC3 & (uint)fVar4 );
         }
...
undefined8 ffxFsr2ContextGenerateReactiveMask(FfxFsr2Context_Private *param_1, long *param_2) {
 ...
 while ( puVar7 + -0x1000 != local_6030 );
   *(undefined8*)( puVar7 + 0x4ff0 ) = *(undefined8*)( in_FS_OFFSET + 0x28 );
   if (( ( param_2 == (long*)0x0 ) || ( param_1 == (FfxFsr2Context_Private*)0x0 ) ) || ( lVar5 = *param_2 ),*(long*)( puVar7 + -0x1f50 ) = lVar5,lVar5 == 0) {
      uVar4 = 0x80000000;
   }
      ...
      *(ulong*)( puVar7 + -0x1f58 ) = CONCAT44(( uint )((int)( (ulong)lVar5 >> 0x20 ) + _LC92._4_4_) >> 3, ( uint )((int)lVar5 + (int)_LC92) >> 3);
      ...
      if (iVar1 != 0) {
         ...
         *(undefined1**)( puVar7 + -0x1f58 ) = puVar7 + 0xc04;
         ...
         do {
            ...
            uVar11 = uVar11 - 0x100;
            *(undefined4*)( puVar7 + lVar5 * 4 + -0x43c ) = *(undefined4*)( param_1 + ( ulong ) * (uint*)( pFVar8 + -4 ) * 4 + 0xf3e0 );
            lVar5 = lVar5 + 1;

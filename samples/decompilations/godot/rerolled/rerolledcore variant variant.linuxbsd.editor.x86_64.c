...
/* Variant::get_type_by_name(String const&) */undefined4 Variant::get_type_by_name(String *param_1) {
   ...
   long local_40;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (( get_type_by_name(String_const&):: ) && ( iVar19 = __cxa_guard_acquire(&get_type_by_name(String_const & ::type_names), iVar19 != 0) ) {
      get_type_by_name(String_const &) {
         uVar16 = uVar14;
      }
 ...
 while ( ( uVar14 != 0 ) && ( auVar6._8_8_ = 0 ),auVar6._0_8_ = (ulong)uVar14 * lVar3,auVar10._8_8_ = 0,auVar10._0_8_ = uVar21,auVar7._8_8_ = 0,auVar7._0_8_ = ( ulong )(( uVar2 + uVar17 ) - SUB164(auVar6 * auVar10, 8)) * lVar3,auVar11._8_8_ = 0,auVar11._0_8_ = uVar21,uVar22 <= SUB164(auVar7 * auVar11, 8) );
   ...
   const&) */
   Variant * __thiscallVariant::get_callable_error_text(Variant * this, Callable * param_1, Variant * *param_2, int, param_3, CallError * param_4);
   {
      long *plVar1;
      Variant *pVVar2;
      code *pcVar3;
 ...
 while ( local_60 != 0 );
   ...
   void CowData<Variant>::_copy_on_write(CowData<Variant> *this) {
      long lVar1;
      long lVar2;
      code *pcVar3;
      undefined8 *puVar4;
 ...
 while ( !bVar4 );
   ...
   void Variant::Variant(Variant *this, Vector *param_1) {
      undefined8 *puVar1;
 ...
 while ( lVar2 != lVar6 );
   ...
   void CowData<String>::resize<false>(CowData<String> *this, long param_1) {
      long *plVar1;
      long *plVar2;
      code *pcVar3;
      undefined8 *puVar4;
...
;
 ...
 while ( bVar8 );
   ...
   void CowData<StringName>::_copy_on_write(CowData<StringName> *this) {
      long lVar1;
      long lVar2;
      code *pcVar3;
      undefined8 *puVar4;
 ...
 while ( lVar2 != lVar5 );
   ...
   void CowData<_VariantStrPair>::_copy_on_write(CowData<_VariantStrPair> *this) {
      long lVar1;
      code *pcVar2;
      undefined8 *puVar3;
      CowData *pCVar4;
...
LAB_0010b406:
   ...
   Variant * __thiscallVariant::operator_cast_to_String(Variant * this);
   {
      long lVar1;
      long in_FS_OFFSET;
      lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
   ...
   Variant::operator_cast_to_Color(Variant *this) {
      long *plVar1;
      int iVar2;
      long lVar3;
      char cVar4;
   ...
   Variant * __thiscallVariant::operator_cast_to_NodePath(Variant * this);
   {
      long *plVar1;
      long lVar2;
      int *in_RSI;
   ...
   Variant * __thiscallVariant::operator_cast_to_Vector(Variant * this);
   {
      long lVar1;
      long lVar2;
      int *in_RSI;
 ...
 while ( puVar10 != (undefined8*)( (long)puVar4 + lVar5 + 0x10 ) );
   ...
   Variant * __thiscallVariant::operator_cast_to_Array(Variant * this);
   {
      long lVar1;
      int *in_RSI;
      long in_FS_OFFSET;
...
;
 ...
 while ( puVar10 != (undefined8*)0x0 );
   ...
   Variant * __thiscallVariant::operator_cast_to_IPAddress(Variant * this);
   {
      long *plVar1;
      uint *puVar2;
      uint uVar3;
   ...
   void Variant::operator_cast_to_Vector(Variant *this) {
      code *pcVar1;
      _DAT_00000000 = 0;
      /* WARNING: Does not return */
      pcVar1 = (code*)invalidInstructionException();
   ...
   void HashMap<String,Variant::Type,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Variant::Type>>>::~HashMap(HashMap<String,Variant::Type,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Variant::Type>>> *this) {
      long *plVar1;
      uint uVar2;
      long lVar3;
      long lVar4;
 ...
 while ( lVar4 != (ulong)uVar2 << 2 );
   ...
   void PagedAllocator<Variant::Pools::BucketSmall,true,4096u>::~PagedAllocator(PagedAllocator<Variant::Pools::BucketSmall,true,4096u> *this) {
...
;
 ...
 while ( (uint)lVar7 < *(uint*)( this + 0x10 ) );
   ...
   void PagedAllocator<Variant::Pools::BucketLarge,true,4096u>::~PagedAllocator(PagedAllocator<Variant::Pools::BucketLarge,true,4096u> *this) {
...
;
 ...
 while ( (uint)lVar7 < *(uint*)( this + 0x10 ) );
   ...
   void PagedAllocator<Variant::Pools::BucketMedium,true,4096u>::~PagedAllocator(PagedAllocator<Variant::Pools::BucketMedium,true,4096u> *this) {
...
;
 ...
 while ( (uint)lVar7 < *(uint*)( this + 0x10 ) );
   ...
   void CowData<double>::_copy_on_write(CowData<double> *this) {
      long *plVar1;
      long lVar2;
      code *pcVar3;
      undefined8 *puVar4;
   ...
   void CowData<long>::_copy_on_write(CowData<long> *this) {
      long *plVar1;
      long lVar2;
      code *pcVar3;
      undefined8 *puVar4;
   ...
   void CowData<Vector4>::_copy_on_write(CowData<Vector4> *this) {
      long *plVar1;
      long lVar2;
      code *pcVar3;
      undefined8 *puVar4;
   ...
   void CowData<int>::resize<false>(CowData<int> *this, long param_1) {
      long *plVar1;
      code *pcVar2;
      long lVar3;
      ulong uVar4;
   ...
   void CowData<long>::resize<false>(CowData<long> *this, long param_1) {
      long *plVar1;
      code *pcVar2;
      long lVar3;
      ulong uVar4;
   ...
   void CowData<double>::resize<false>(CowData<double> *this, long param_1) {
      long *plVar1;
      code *pcVar2;
      long lVar3;
      ulong uVar4;
   ...
   void CowData<float>::resize<false>(CowData<float> *this, long param_1) {
      long *plVar1;
      code *pcVar2;
      long lVar3;
      ulong uVar4;
   ...
   void CowData<Vector2>::resize<false>(CowData<Vector2> *this, long param_1) {
      long *plVar1;
      code *pcVar2;
      long lVar3;
      ulong uVar4;
   ...
   void CowData<Color>::resize<false>(CowData<Color> *this, long param_1) {
      long *plVar1;
      code *pcVar2;
      undefined8 uVar3;
      long lVar4;
 ...
 while ( puVar7 + ( param_1 - lVar4 ) * 2 != puVar8 );
   ...
   void CowData<Vector4>::resize<false>(CowData<Vector4> *this, long param_1) {
      long *plVar1;
      code *pcVar2;
      long lVar3;
      ulong uVar4;

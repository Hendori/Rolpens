/* ScreenSelect::_emit_screen_signal(int) */void ScreenSelect::_emit_screen_signal(ScreenSelect *this, int param_1) {
   char cVar1;
   long in_FS_OFFSET;
   long local_80;
   Variant *local_78[2];
...
/* ScreenSelect::_handle_mouse_shortcut(Ref<InputEvent> const&) */void ScreenSelect::_handle_mouse_shortcut(ScreenSelect *this, Ref *param_1) {
   char cVar1;
   int iVar2;
   Object *pOVar3;
   if (*(long*)param_1 != 0) {
      pOVar3 = (Object*)__dynamic_cast(*(long*)param_1, &Object::typeinfo, &InputEventMouseButton::typeinfo, 0);
...
/* WindowWrapper::_window_size_changed() */void __thiscall WindowWrapper::_window_size_changed(WindowWrapper *this)

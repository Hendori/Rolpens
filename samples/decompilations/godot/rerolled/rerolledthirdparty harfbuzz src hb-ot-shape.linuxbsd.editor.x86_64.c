/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* hb_ot_shape_planner_t::hb_ot_shape_planner_t(hb_face_t*, hb_segment_properties_t const&) */void hb_ot_shape_planner_t::hb_ot_shape_planner_t(hb_ot_shape_planner_t *this, hb_face_t *param_1, hb_segment_properties_t *param_2) {
   ...
   *(undefined8*)( this + 0x20 ) = uVar5;
   ...
   if (iVar8 == 0) {
      ...
      if (uVar9 == 0x4c616f6f) {
         *(undefined**)( this + 0xb0 ) = &_hb_ot_shaper_thai;
         this[0xa8] = ( hb_ot_shape_planner_t )(( _hb_ot_layout_has_glyph_classes != 0 ) * '\x02' | cVar7 * '\x04' & 6U | (byte)hVar1 & 0xf8);
         return;
      }
   ...
   if (uVar9 < 0x4c616f70) {
      ...
      if (uVar9 < 0x48656273) {
 ...
 else if (( ( uVar9 != 0x43687273 ) && ( uVar9 != 0x43706d6e ) ) && ( uVar9 != 0x4368616d )) goto LAB_0010039c;
                     }
         ...
         if (uVar9 < 0x4b686d73) {
            if (uVar9 != 0x4b616c69) {
               if (uVar9 < 0x4b616c6a) {
                  if (( uVar9 != 0x486d6e70 ) && ( ( uVar9 != 0x4a617661 && ( uVar9 != 0x486d6e67 ) ) )) goto LAB_0010039c;
               }
 ...
 else if (( uVar9 != 0x4b746869 ) && ( ( uVar9 != 0x4c616e61 && ( uVar9 != 0x4b726169 ) ) )) goto LAB_0010039c;
         }
   ...
   if (0x51616167 < uVar9) {
      ...
      if (uVar9 < 0x54616d6d) {
         if (uVar9 == 0x53797263) {
            ...
            LAB_00100390:if (( uVar10 & 0xfffffffe ) != 4) goto LAB_0010039c;
         ...
         if (uVar9 < 0x53797264) {
            if (uVar9 != 0x53696e68) {
               if (uVar9 < 0x53696e69) {
                  if (uVar9 != 0x53687264) {
                     if (uVar9 < 0x53687265) {
                        if (( uVar9 != 0x526f6867 ) && ( ( uVar9 != 0x53617572 && ( uVar9 != 0x526a6e67 ) ) )) goto LAB_0010039c;
                     }
                  ...
                  if (uVar9 < 0x53756e65) {
                     if (( uVar9 != 0x536f676f ) && ( ( uVar9 != 0x536f796f && ( uVar9 != 0x536f6764 ) ) )) goto LAB_0010039c;
                  }
 ...
 else if (( ( uVar9 != 0x54616b72 ) && ( uVar9 != 0x54616c65 ) ) && ( uVar9 != 0x54616762 )) goto LAB_0010039c;
      }
 else {
         puVar11 = &_hb_ot_shaper_thai;
   ...
   if (uVar9 == 0x4d796d72) {
      if (( iVar8 == 0x44464c54 || iVar8 == 0x6c61746e ) || ( puVar11 = iVar8 == 0x6d796d72 )) goto LAB_0010039c;
      goto LAB_001004d8;
   }

   if (uVar9 < 0x4d796d73) {
      if (uVar9 == 0x4d6c796d) {
         LAB_001005c8:if (( iVar8 == 0x44464c54 ) || ( iVar8 == 0x6c61746e )) goto LAB_0010039c;
 ...
 else if (( ( uVar9 != 0x4d617263 ) && ( uVar9 != 0x4d656466 ) ) && ( uVar9 != 0x4d616e69 )) goto LAB_0010039c;
         }
   ...
   LAB_00100570:if (( iVar8 == 0x44464c54 ) || ( puVar11 = iVar8 == 0x6c61746e )) {
      LAB_0010039c:*(undefined**)( this + 0xb0 ) = &_hb_ot_shaper_default;
      this[0xa8] = ( hb_ot_shape_planner_t )(( iVar6 != 0 ) * '\x02' | cVar7 * '\x04' & 6U | (byte)this[0xa8] & 0xf9);
      return;
   }

   LAB_001004d8:iVar8 = *(int*)( puVar11 + 0x58 );
   *(undefined**)( this + 0xb0 ) = puVar11;
   this[0xa8] = ( hb_ot_shape_planner_t )(( iVar8 != 0 ) * '\x02' | ( puVar11[0x5c] & 1 ) << 2 | (byte)this[0xa8] & 0xf9);
...
/* hb_ot_shape_planner_t::compile(hb_ot_shape_plan_t&, hb_ot_shape_plan_key_t const&) */void hb_ot_shape_planner_t::compile(hb_ot_shape_plan_t *param_1, hb_ot_shape_plan_key_t *param_2) {
   uint *puVar1;
...
;
 ...
 while ( iVar16 <= iVar18 );
      LAB_001010d4:uVar11 = 0;
      LAB_00100c0f:*(uint*)( param_2 + 0x90 ) = uVar11;
      iVar16 = 0;
      iVar18 = iVar12;
      do {
         while (true) {
...
;
 ...
 while ( iVar16 <= iVar18 );
      LAB_001010bc:uVar13 = 0;
      LAB_00100c4f:*(uint*)( param_2 + 0x94 ) = uVar13;
      iVar16 = 0;
      iVar18 = iVar12;
      do {
         while (true) {
...
;
 ...
 while ( iVar16 <= iVar18 );
      LAB_0010109c:bVar19 = uVar11 != 0;
      uVar14 = 0;
      LAB_00100c9c:*(uint*)( param_2 + 0x98 ) = uVar14;
      iVar16 = 0;
...
;
 ...
 while ( iVar16 <= iVar18 );
      LAB_00101084:uVar11 = 0;
      LAB_00100cf6:*(uint*)( param_2 + 0x9c ) = uVar11;
      iVar16 = 0;
      iVar18 = iVar12;
      do {
         while (true) {
...
;
 ...
 while ( iVar16 <= iVar18 );
      LAB_0010106c:bVar19 = false;
      LAB_00100d3b:param_2[0xa8] = ( hb_ot_shape_plan_key_t )((byte)param_2[0xa8] & 0xf7 | bVar19 * '\b');
      uVar11 = 0x6b65726e;
...
;
 ...
 while ( iVar16 <= iVar18 );
      LAB_0010104d:bVar19 = false;
      uVar13 = 0;
      LAB_00100dae:*(uint*)( param_2 + 0xa0 ) = uVar13;
      iVar16 = 0;
...
;
 ...
 while ( iVar16 <= iVar18 );
      LAB_0010102d:bVar19 = false;
      uVar13 = 0;
      LAB_00100e03:*(uint*)( param_2 + 0xa4 ) = uVar13;
      iVar16 = 0;
 ...
 while ( iVar16 <= iVar12 );
   ...
   bVar20 = false;
   param_2[0xa9] = ( hb_ot_shape_plan_key_t )((byte)param_2[0xa9] & 0xdf | ( byte )(( (byte)param_1[0xa8] & 1 ) << 5));
   ...
   if (( bVar19 ) || ( iVar16 = iVar16 == 0 )) {
      if (iVar12 == 0) {
         ...
         LAB_00100eca:hVar2 = param_2[0xa9];
      ...
      if (bVar17 == 0) {
         LAB_00100ee9:param_2[0xa9] = ( hb_ot_shape_plan_key_t )((byte)hVar10 & 0xf7);
         LAB_00100ef2:bVar17 = 0;
         uVar11 = 0;
         goto LAB_00100f00;
      }

      LAB_00101110:param_2[0xa9] = ( hb_ot_shape_plan_key_t )((byte)hVar10 & 0xf7);
      ...
      LAB_00101269:cVar9 = hb_ot_layout_has_kerning(*(hb_face_t**)param_1);
      hVar10 = param_2[0xa9];
      if (cVar9 != '\0') {
   ...
   LAB_00100f00:param_2[0xa8] = ( hb_ot_shape_plan_key_t )((byte)param_2[0xa8] & 0xdf | ( byte )(( uVar11 & 1 ) << 5));
   iVar12 = *(int*)( param_2 + 0x3c ) + -1;
   if (-1 < iVar12) {
      iVar16 = 0;
      do {
...
;
 ...
 while ( iVar16 <= iVar12 );
   ...
   LAB_00101173:uVar11 = 0;
   LAB_00100f60:param_2[0xa8] = ( hb_ot_shape_plan_key_t )((byte)param_2[0xa8] & 0xef | ( byte )(uVar11 << 4));
   if (( ( bVar17 == 0 ) && ( ( (byte)param_2[0xa9] & 0x10 ) == 0 ) ) && ( ( ( (byte)param_2[0xa9] & 4 ) == 0 || ( cVar9 = hb_ot_layout_has_cross_kerning(*(hb_face_t**)param_1) ),cVar9 == '\0' ) )) {
...
/* hb_ot_shape_plan_t::init0(hb_face_t*, hb_shape_plan_key_t const*) */undefined8 hb_ot_shape_plan_t::init0(hb_ot_shape_plan_t *this, hb_face_t *param_1, hb_shape_plan_key_t *param_2) {
   undefined4 *puVar1;
   uint uVar2;
   undefined4 uVar3;
   long lVar4;
   ...
   *(undefined8*)( this + 0x80 ) = 0;
   ...
   for (uVar5 = ( ulong )(( (int)this - (int)(undefined8*)( ( ulong )(this + 0x30) & 0xfffffffffffffff8 ) ) + 0x88U >> 3); uVar5 != 0; uVar5 = uVar5 - 1) {
      *puVar10 = 0;
      puVar10 = puVar10 + 1;
   }
   ...
   hb_ot_map_builder_t::add_pause((uint)local_d0, (_func_bool_hb_ot_shape_plan_t_ptr_hb_font_t_ptr_hb_buffer_t_ptr*)0x0);
   if (local_f0 == 4) {
 ...
 while ( phVar9 != this + 0x68 );
   ...
   uVar7 = 1;
   LAB_001015fa:hb_ot_map_builder_t::~hb_ot_map_builder_t(local_d0);
...
/* hb_ot_shape_plan_t::fini() */void hb_ot_shape_plan_t::fini(hb_ot_shape_plan_t *this) {
...
/* hb_ot_shape_plan_t::substitute(hb_font_t*, hb_buffer_t*) const */void hb_ot_shape_plan_t::substitute(hb_font_t *param_1, hb_buffer_t *param_2) {
   hb_ot_map_t::substitute((hb_ot_shape_plan_t*)( param_1 + 0x28 ), param_1, param_2);
   return;
}
/* hb_ot_shape_plan_t::position(hb_font_t*, hb_buffer_t*) const */void hb_ot_shape_plan_t::position(hb_ot_shape_plan_t *this, hb_font_t *param_1, hb_buffer_t *param_2) {
...
void hb_ot_shape_glyphs_closure(long param_1, long param_2, undefined8 param_3, undefined8 param_4, long param_5) {
   int *piVar1;
   uint uVar2;
   int iVar3;
   int iVar4;
   ...
   if (*(uint*)( param_2 + 0x60 ) != 0) {
      ...
      do {
         ...
         iVar5 = ( **(code**)( *(long*)( param_1 + 0x90 ) + 0x30 ) )(param_1, *(undefined8*)( param_1 + 0x98 ), iVar4, &local_5c, lVar12);
         uVar2 = local_5c;
         if (iVar5 != 0) {
            bVar9 = (byte)local_5c;
            if (*(char*)( param_5 + 0x40 ) == '\0') {
               if (( local_5c != 0xffffffff ) && ( *(char*)( param_5 + 0x10 ) == '\x01' )) {
                  *(undefined4*)( param_5 + 0x14 ) = 0xffffffff;
                  puVar7 = (undefined4*)hb_bit_set_t::page_for((hb_bit_set_t*)( param_5 + 0x10 ), local_5c, true);
                  if (puVar7 != (undefined4*)0x0) {
                     *(ulong*)( puVar7 + ( ulong )(uVar2 >> 6 & 7) * 2 + 2 ) = *(ulong*)( puVar7 + ( ulong )(uVar2 >> 6 & 7) * 2 + 2 ) | 1L << ( bVar9 & 0x3f );
                     *puVar7 = 0xffffffff;
                  }
 ...
 else if (( *(char*)( param_5 + 0x10 ) != '\0' ) && ( puVar7 = (undefined4*)hb_bit_set_t::page_for((hb_bit_set_t*)( param_5 + 0x10 ), local_5c, false) ),puVar7 != (undefined4*)0x0) {
               *(undefined4*)( param_5 + 0x14 ) = 0xffffffff;
               bVar9 = bVar9 & 0x3f;
               *(ulong*)( puVar7 + ( ulong )(uVar2 >> 6 & 7) * 2 + 2 ) = *(ulong*)( puVar7 + ( ulong )(uVar2 >> 6 & 7) * 2 + 2 ) & ( -2L << bVar9 | 0xfffffffffffffffeU >> 0x40 - bVar9 );
               *puVar7 = 0xffffffff;
            }

         }

         if (( iVar3 == 5 ) && ( iVar5 = ( **(code**)( lVar11 + 0x30 ) )(lVar11, iVar4, *(undefined8*)( lVar11 + 0x70 )) ),iVar4 != iVar5) {
            local_5c = 0;
            ...
            iVar4 = ( **(code**)( *(long*)( param_1 + 0x90 ) + 0x30 ) )(param_1, *(undefined8*)( param_1 + 0x98 ), iVar5, &local_5c, lVar11);
            uVar2 = local_5c;
            if (iVar4 != 0) {
               bVar9 = (byte)local_5c;
               if (*(char*)( param_5 + 0x40 ) == '\0') {
...
/* hb_buffer_t::_set_glyph_flags(unsigned int, unsigned int, unsigned int, bool, bool) */void hb_buffer_t::_set_glyph_flags(hb_buffer_t *this, uint param_1, uint param_2, uint param_3, bool param_4, bool param_5) {
 ...
 while ( puVar1 != puVar5 );
         ...
         if (uVar13 == param_3) {
            ...
            LAB_0010445f:uVar7 = (ulong)param_2;
            uVar8 = local_44;
            if (param_2 < uVar11) {
               ...
               LAB_001044cc:local_50 = uVar7 * 0x14;
               LAB_001044dd:if (param_2 < uVar11) {
 ...
 while ( puVar5 != (uint*)( lVar9 + 0x18 + ( ( ulong )(( uVar11 - param_2 ) - 1) + (ulong)param_2 ) * 0x14 ) );
            ...
            LAB_0010451d:if (param_3 == uVar13) goto LAB_00104050;
            LAB_00104526:uVar10 = ( ulong )(param_3 - 1);
            uVar7 = (ulong)uVar13;
            LAB_0010452d:uVar11 = *(uint*)( lVar4 + 8 + uVar7 * 0x14 );
            uVar15 = *(uint*)( lVar4 + 8 + uVar10 * 0x14 );
            if (iVar2 != 2) goto LAB_001042e3;
            LAB_0010454e:if (uVar13 < param_3) {
 ...
 while ( puVar5 != puVar1 );
            ...
            LAB_001041f5:lVar12 = lVar9 + ( ulong )(uVar11 - 1) * 0x14;
            uVar7 = (ulong)param_2;
            uVar8 = *(uint*)( lVar12 + 8 );
 ...
 while ( puVar5 != (uint*)( lVar9 + 0x18 + ( ( ( uVar11 - param_2 ) - 1 ) + uVar7 ) * 0x14 ) );
            ...
            LAB_0010439d:if (param_2 < uVar11) {
               do {
 ...
 while ( lVar12 != lVar9 + -0x14 + lVar14 + ( ulong )(( uVar11 - param_2 ) - 1) * -0x14 );
               LAB_001042b9:uVar13 = *(uint*)( this + 0x5c );
            }

            LAB_001042bd:if (uVar13 == param_3) goto LAB_00104050;
            uVar10 = ( ulong )(param_3 - 1);
            uVar7 = (ulong)uVar13;
            uVar11 = *(uint*)( lVar4 + 8 + uVar7 * 0x14 );
            uVar15 = *(uint*)( lVar4 + 8 + uVar10 * 0x14 );
            LAB_001042e3:if (uVar11 != uVar8) {
 ...
 while ( lVar4 + -0x14 + lVar14 + ( ulong )(( param_3 - param_2 ) - 1) * -0x14 != lVar9 );
   ...
   LAB_00104050:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* hb_bit_set_t::resize(unsigned int, bool, bool) */hb_bit_set_t hb_bit_set_t::resize(hb_bit_set_t *this, uint param_1, bool param_2, bool param_3) {
 ...
 while ( uVar8 < param_1 );
      ...
      LAB_001048c7:*(uint*)( this + 0x20 ) = ~uVar5;
      goto LAB_001048cc;
   }
   ...
   if (uVar5 == 0) {
      param_1 = 1;
      uVar8 = 1;
      LAB_00104a59:pvVar2 = *(void**)( this + 0x28 );
      param_3 = (bool)hVar1;
      LAB_00104a60:pvVar2 = realloc(pvVar2, (ulong)uVar8 * 0x48);
      if (pvVar2 == (void*)0x0) {
         uVar5 = *(uint*)( this + 0x20 );
         if (uVar5 < uVar8) goto LAB_001048c7;
      }
 else {
         LAB_00104a7c:*(void**)( this + 0x28 ) = pvVar2;
   ...
   LAB_00104813:if (( (uint)uVar7 < param_1 ) && ( param_2 )) {
 ...
 while ( uVar5 < param_1 );
      ...
      LAB_001048df:if (( (uint)uVar6 < param_1 ) && ( param_2 )) {
 ...
 while ( uVar8 < uVar4 );
      ...
      LAB_00104984:uVar8 = *(uint*)( this + 0x24 );
   }
 else {
      LAB_001049c6:uVar8 = *(uint*)( this + 0x24 );
      uVar4 = (uint)uVar6;
      if (uVar4 <= uVar8) {
         uVar6 = (ulong)uVar8;
      }
      ...
      uVar9 = (uint)uVar6;
      if (uVar5 < uVar9) {
         LAB_00104950:if (0x38e38e3 < (uint)uVar6) goto LAB_001048c7;
         pvVar2 = *(void**)( this + 0x28 );
         LAB_00104961:uVar8 = (uint)uVar6;
         ...
         if (pvVar2 == (void*)0x0) {
            ...
            LAB_0010497d:*(void**)( this + 0x28 ) = pvVar2;
            *(uint*)( this + 0x20 ) = uVar8;
         }
   ...
   *(uint*)( this + 0x24 ) = uVar4;
   LAB_001048cc:*this = (hb_bit_set_t)0x0;
   return (hb_bit_set_t)0x0;
}
   ...
   LAB_00104c5c:if (param_2) {
      ...
      if (cVar6 != '\0') {
         ...
         *(ulong*)( *(long*)( this + 0x18 ) + (ulong)uVar8 * 8 ) = CONCAT44(uVar4, uVar9);
         uVar7 = uVar8;
         LAB_00104cf5:*(uint*)( this + 8 ) = uVar7;

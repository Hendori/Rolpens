...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Vector3>::resize<false>(long) [clone .isra.0] */void CowData<Vector3>::resize<false>(CowData<Vector3> *this, long param_1) {
   ...
   if (param_1 * 0xc != 0) {
      ...
      if (uVar6 != 0xffffffffffffffff) {
         if (param_1 <= lVar10) {
            ...
            LAB_00100d70:pcVar4 = "Parameter \"mem_new\" is null.";
            uVar7 = 0x1a9;
            pcVar9 = "_realloc";
            goto LAB_00100d58;
         }
         ...
         if (uVar6 + 1 == lVar5) {
            ...
            lVar5 = puVar8[-1];
            LAB_00100c81:if (param_1 <= lVar5) goto LAB_00100be7;
         }
 else {
            if (lVar10 != 0) {
   ...
   uVar7 = 0x16a;
   pcVar9 = "resize";
   LAB_00100d58:_err_print_error(pcVar9, "./core/templates/cowdata.h", uVar7, pcVar4, 0, 0);
   return;
}
/* Variant::get_type_name(Variant::Type) */Variant * __thiscall Variant::get_type_name(Variant *this,uint param_2){
   long lVar1;
   long in_FS_OFFSET;
...
LAB_00100e47:
   ...
   String::parse_latin1((StrRange*)this);
   LAB_00100e20:if (lVar1 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return this;
   }
...
/* Variant::can_convert(Variant::Type, Variant::Type) */bool Variant::can_convert(int param_1, int param_2) {
   bool bVar1;
   int iVar2;
   undefined1 *puVar3;
...
;
   ...
   switchD_0010120b_caseD_0:return bVar1;
}
/* Variant::can_convert_strict(Variant::Type, Variant::Type) */bool Variant::can_convert_strict(int param_1, int param_2) {
   bool bVar1;
   int iVar2;
   undefined1 *puVar3;
   bVar1 = param_2 == 0 || param_1 == param_2;
...
;
   ...
   switchD_0010148b_caseD_0:return bVar1;
}
/* Variant::is_null() const */bool Variant::is_null(Variant *this) {
   bool bVar1;
   bVar1 = true;
   if (*(int*)this == 0x18) {
...
/* Variant::ObjData::ref(Variant::ObjData const&) */void Variant::ObjData::ref(ObjData *this, ObjData *param_1) {
   long lVar1;
   long lVar2;
   Object *pOVar3;
   undefined8 uVar4;
   ...
   if (lVar2 != lVar1) {
      ...
      *(undefined8*)( this + 8 ) = uVar4;
      if (( lVar1 < 0 ) && ( cVar5 = cVar5 == '\0' )) {
         *(undefined8*)this = 0;
         *(undefined8*)( this + 8 ) = 0;
      }

      if (( ( lVar2 < 0 ) && ( cVar5 = RefCounted::unreference() ),cVar5 != '\0' )) &&( cVar5 = cVar5 != '\0' )(**(code**)( *(long*)pOVar3 + 0x140 ))(pOVar3);
      Memory::free_static(pOVar3, false);
      return;
   }

}
return;}/* Variant::ObjData::ref_pointer(Object*) */void Variant::ObjData::ref_pointer(ObjData *this, Object *param_1) {
   Object OVar1;
   Object *pOVar2;
   long lVar3;
   undefined8 uVar4;
   ...
   if (param_1 != (Object*)0x0) {
      ...
      *(undefined8*)this = uVar4;
      if (( OVar1 == (Object)0x0 ) || ( cVar5 = cVar5 != '\0' )) goto joined_r0x001017fe;
   }

   *(undefined8*)this = 0;
   *(undefined8*)( this + 8 ) = 0;
   joined_r0x001017fe:if (( ( lVar3 < 0 ) && ( cVar5 = RefCounted::unreference() ),cVar5 != '\0' )) &&( cVar5 = cVar5 != '\0' )(**(code**)( *(long*)pOVar2 + 0x140 ))(pOVar2);
   Memory::free_static(pOVar2, false);
   return;
}
return;}/* Variant::ObjData::unref() */void Variant::ObjData::unref(ObjData *this) {
   Object *pOVar1;
   char cVar2;
   if (*(long*)this < 0) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Variant::_clear_internal() */void Variant::_clear_internal(Variant *this) {
   int *piVar1;
   long *plVar2;
   long lVar3;
   undefined8 *puVar4;
...
LAB_00101a86:
   ...
   LAB_00101d0a:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* Variant::TEMPNAMEPLACEHOLDERVALUE(Variant const&) const */bool Variant::operator !=(Variant *this, Variant *param_1) {
   bool bVar1;
   long in_FS_OFFSET;
   bool local_2d;
   undefined4 local_2c;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Variant::zero() */void Variant::zero(Variant *this) {
   int iVar1;
   undefined8 uVar2;
   long in_FS_OFFSET;
   undefined4 local_38;
...
/* Variant::operator long() const */long Variant::operator_cast_to_long(Variant *this) {
   uint uVar1;
   long lVar2;
   uVar1 = *(uint*)this;
   if (uVar1 == 3) {
...
/* Variant::operator int() const */int Variant::operator_cast_to_int(Variant *this) {
   uint uVar1;
   int iVar2;
   uVar1 = *(uint*)this;
   if (uVar1 == 3) {
...
/* Variant::operator short() const */short Variant::operator_cast_to_short(Variant *this) {
   uint uVar1;
   short sVar2;
   uVar1 = *(uint*)this;
   if (uVar1 == 3) {
...
/* Variant::operator signed char() const */ulong Variant::operator_cast_to_signed_char(Variant *this) {
   uint uVar1;
   ulong uVar2;
   uVar1 = *(uint*)this;
   if (uVar1 == 3) {
...
/* Variant::operator unsigned long() const */ulong Variant::operator_cast_to_unsigned_long(Variant *this) {
   double dVar1;
   uint uVar2;
   ulong uVar3;
   uVar2 = *(uint*)this;
...
/* Variant::operator unsigned int() const */uint Variant::operator_cast_to_unsigned_int(Variant *this) {
   uint uVar1;
   uVar1 = *(uint*)this;
   if (uVar1 == 3) {
...
/* Variant::operator unsigned short() const */ushort Variant::operator_cast_to_unsigned_short(Variant *this) {
   uint uVar1;
   ushort uVar2;
   uVar1 = *(uint*)this;
   if (uVar1 == 3) {
...
/* Variant::operator unsigned char() const */uchar Variant::operator_cast_to_unsigned_char(Variant *this) {
   uint uVar1;
   uchar uVar2;
   uVar1 = *(uint*)this;
   if (uVar1 == 3) {
...
/* Variant::operator ObjectID() const */undefined8 Variant::operator_cast_to_ObjectID(Variant *this) {
...
/* Variant::operator char32_t() const */wchar32 Variant::operator_cast_to_char32_t(Variant *this) {
   uint uVar1;
   wchar32 wVar2;
   uVar1 = *(uint*)this;
   if (uVar1 == 3) {
...
/* Variant::operator float() const */float Variant::operator_cast_to_float(Variant *this) {
   uint uVar1;
   double dVar2;
   uVar1 = *(uint*)this;
   if (uVar1 == 3) {
...
/* Variant::operator double() const */double Variant::operator_cast_to_double(Variant *this) {
   uint uVar1;
   double dVar2;
   uVar1 = *(uint*)this;
   if (uVar1 == 3) {
...
/* Variant::operator StringName() const */Variant * __thiscall Variant::operator_cast_to_StringName(Variant *this){
   int *in_RSI;
   if (*in_RSI == 0x15) {
...
/* Variant::to_json_string() const */void Variant::to_json_string(void) {
   long *plVar1;
   long lVar2;
   String *in_RSI;
   Variant *in_RDI;
...
/* Variant::operator Vector2() const */undefined8 Variant::operator_cast_to_Vector2(Variant *this) {
   undefined8 uVar1;
   switch (*(undefined4*)this) {
      case 5:
      case 9:
...
/* Variant::operator Vector2i() const */undefined8 Variant::operator_cast_to_Vector2i(Variant *this) {
   undefined8 uVar1;
   long in_FS_OFFSET;
   undefined8 local_18;
   long local_10;
   ...
   LAB_0010264e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* Variant::operator Rect2() const */undefined1[16];__thiscallVariant::operator_cast_to_Rect2(Variant *this) {
...
/* Variant::operator Rect2i() const */undefined1[16];__thiscallVariant::operator_cast_to_Rect2i(Variant *this) {
   undefined1 auVar1[16];
   if (*(int*)this == 8) {
      return *(undefined1(*) [16])( this + 8 );
   }
...
/* Variant::operator Vector3() const */undefined1[16];__thiscallVariant::operator_cast_to_Vector3(Variant *this) {
   long in_FS_OFFSET;
   undefined1 auVar1[16];
   undefined8 local_20;
   float local_18;
   ...
   LAB_00102809:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* Variant::operator Vector3i() const */undefined8 Variant::operator_cast_to_Vector3i(Variant *this) {
   undefined8 uVar1;
   undefined8 in_RSI;
   long in_FS_OFFSET;
   undefined8 local_20;
   ...
   LAB_0010292d:/* WARNING: Subroutine does not return */__stack_chk_fail(this, in_RSI, local_18);
}
/* Variant::operator Vector4() const */undefined1[16];__thiscallVariant::operator_cast_to_Vector4(Variant *this) {
   undefined1 auVar1[16];
...
/* Variant::operator Vector4i() const */undefined1[16];__thiscallVariant::operator_cast_to_Vector4i(Variant *this) {
   undefined1 auVar1[16];
   undefined1 auVar2[16];
   undefined1 auVar3[16];
   undefined1 auVar4[16];
...
/* Variant::operator Plane() const */undefined1[16];__thiscallVariant::operator_cast_to_Plane(Variant *this) {
   undefined1 auVar1[16];
   long in_FS_OFFSET;
   undefined8 local_28;
   undefined4 uStack_20;
...
/* Variant::operator AABB() const */Variant * __thiscall Variant::operator_cast_to_AABB(Variant *this){
   undefined8 *puVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   int *in_RSI;
...
/* Variant::operator Basis() const */Variant * __thiscall Variant::operator_cast_to_Basis(Variant *this){
   int iVar1;
   undefined8 *puVar2;
   undefined8 uVar3;
   undefined8 uVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Variant::operator Quaternion() const */Variant * __thiscall Variant::operator_cast_to_Quaternion(Variant *this){
   int iVar1;
   long lVar2;
   undefined8 uVar3;
   int *in_RSI;
...
/* Variant::operator Transform3D() const */Variant * __thiscall Variant::operator_cast_to_Transform3D(Variant *this){
   undefined8 *puVar1;
   undefined4 *in_RSI;
   long in_FS_OFFSET;
   undefined8 uVar2;
...
/* Variant::operator Projection() const */Variant * __thiscall Variant::operator_cast_to_Projection(Variant *this){
   uint *puVar1;
   undefined8 uVar2;
   undefined8 *puVar3;
   undefined4 *in_RSI;
...
/* Variant::operator Transform2D() const */Variant * __thiscall Variant::operator_cast_to_Transform2D(Variant *this){
   undefined4 *puVar1;
   undefined8 *puVar2;
   undefined8 uVar3;
   undefined4 uVar4;
...
/* Variant::operator RID() const */undefined8 Variant::operator_cast_to_RID(Variant *this) {
   uint uVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
   ...
   if (( *(int*)this == 0x18 ) && ( plVar5 = *(long**)( this + 0x10 ) ),plVar5 != (long*)0x0) {
      if (( EngineDebugger::singleton == 0 ) || ( EngineDebugger::script_debugger == 0 )) {
         LAB_00103197:local_38[0] = 0;
         local_38[1] = 0;
         local_38[2] = 0;
         ( **(code**)( *plVar5 + 0x68 ) )((Variant*)local_28, plVar5, CoreStringNames::singleton + 0x38, 0, 0, local_38);
...
;
      ...
      _err_print_error(_LC71, "core/variant/variant.cpp", 0x7df, "Parameter \"ObjectDB::get_instance(_get_obj().id)\" is null.", "Invalid pointer (object was freed).", 0, 0);
   }

   uVar2 = 0;
   LAB_001030cc:if (local_10 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* Variant::operator Object*() const */Object * __thiscall Variant::operator_cast_to_Object_(Variant *this){
   Object *pOVar1;
   pOVar1 = (Object*)0x0;
   if (*(int*)this == 0x18) {
...
/* Variant::get_validated_object_with_check(bool&) const */ulong Variant::get_validated_object_with_check(Variant *this, bool *param_1) {
   long lVar1;
   ulong uVar2;
   uint uVar3;
   ulong *puVar4;
...
/* Variant::get_validated_object() const */ulong Variant::get_validated_object(Variant *this) {
   long lVar1;
   ulong uVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   uVar2 = 0;
   LAB_00103470:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* Variant::is_zero() const */undefined8 Variant::is_zero(void) {
   long *plVar1;
   float fVar2;
   long lVar3;
   undefined8 uVar4;
...
LAB_00103930:
   ...
   LAB_00103994:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Variant::is_one() const */ulong Variant::is_one(Variant *this) {
   uint uVar1;
   undefined7 uVar3;
   ulong uVar2;
   long in_FS_OFFSET;
   ...
   long local_10;
   local_10 = *(long*)( in_FS_OFFSET + 0x28 );
   uVar3 = ( undefined7 )(( ulong )((long)&switchD_001039d5::switchdataD_001116f0 + (long)(int)( &switchD_001039d5::switchdataD_001116f0 )[*(uint*)this]) >> 8);
   switch (*(uint*)this) {
      case 0:
    uVar2 = 1;
    break;
...
/* Variant::operator Dictionary() const */Variant * __thiscall Variant::operator_cast_to_Dictionary(Variant *this){
   int *in_RSI;
   if (*in_RSI != 0x1b) {
...
/* Variant::operator Callable() const */Variant * __thiscall Variant::operator_cast_to_Callable(Variant *this){
   int *in_RSI;
   if (*in_RSI != 0x19) {
      *(undefined8*)this = 0;
      *(undefined8*)( this + 8 ) = 0;
...
/* Variant::operator Signal() const */Variant * __thiscall Variant::operator_cast_to_Signal(Variant *this){
   int *in_RSI;
   if (*in_RSI != 0x1a) {
      *(undefined8*)this = 0;
      *(undefined8*)( this + 8 ) = 0;
...
/* Variant::operator Side() const */ulong Variant::operator_cast_to_Side(Variant *this) {
   uint uVar1;
   ulong uVar2;
   uVar1 = *(uint*)this;
   if (uVar1 == 3) {
...
/* Variant::operator Orientation() const */ulong Variant::operator_cast_to_Orientation(Variant *this) {
   uint uVar1;
   ulong uVar2;
   uVar1 = *(uint*)this;
   if (uVar1 == 3) {
...
/* Variant::Variant(bool) */void Variant::Variant(Variant *this, bool param_1) {
   *(undefined4*)this = 1;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   this[8] = (Variant)param_1;
   return;
}
/* Variant::Variant(long) */void Variant::Variant(Variant *this, long param_1) {
   *(undefined4*)this = 2;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   *(long*)( this + 8 ) = param_1;
   return;
}
/* Variant::Variant(int) */void Variant::Variant(Variant *this, int param_1) {
   *(undefined4*)this = 2;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   *(long*)( this + 8 ) = (long)param_1;
   return;
}
/* Variant::Variant(short) */void Variant::Variant(Variant *this, short param_1) {
   *(undefined4*)this = 2;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   *(long*)( this + 8 ) = (long)param_1;
   return;
}
/* Variant::Variant(signed char) */void Variant::Variant(Variant *this, char param_2) {
   *(undefined4*)this = 2;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   *(long*)( this + 8 ) = (long)param_2;
   return;
}
/* Variant::Variant(unsigned long) */void Variant::Variant(Variant *this, ulong param_1) {
   *(undefined4*)this = 2;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   *(ulong*)( this + 8 ) = param_1;
   return;
}
/* Variant::Variant(unsigned int) */void Variant::Variant(Variant *this, uint param_1) {
   *(undefined4*)this = 2;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   *(ulong*)( this + 8 ) = (ulong)param_1;
   return;
}
/* Variant::Variant(unsigned short) */void Variant::Variant(Variant *this, ushort param_1) {
   *(undefined4*)this = 2;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   *(ulong*)( this + 8 ) = (ulong)param_1;
   return;
}
/* Variant::Variant(unsigned char) */void Variant::Variant(Variant *this, uchar param_1) {
   *(undefined4*)this = 2;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   *(ulong*)( this + 8 ) = (ulong)param_1;
   return;
}
/* Variant::Variant(float) */void Variant::Variant(Variant *this, float param_1) {
   *(undefined4*)this = 3;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   *(double*)( this + 8 ) = (double)param_1;
   return;
}
/* Variant::Variant(double) */void Variant::Variant(Variant *this, double param_1) {
   *(undefined4*)this = 3;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   *(double*)( this + 8 ) = param_1;
   return;
}
/* Variant::Variant(ObjectID const&) */void Variant::Variant(Variant *this, ObjectID *param_1) {
   *(undefined4*)this = 2;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   *(undefined8*)( this + 8 ) = *(undefined8*)param_1;
   return;
}
/* Variant::Variant(StringName const&) */void Variant::Variant(Variant *this, StringName *param_1) {
   *(undefined4*)this = 0x15;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   StringName::StringName((StringName*)( this + 8 ), param_1);
   return;
}
/* Variant::Variant(String const&) */void Variant::Variant(Variant *this, String *param_1) {
   *(undefined4*)this = 4;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   if (*(long*)param_1 != 0) {
...
/* Variant::Variant(char const*) */void Variant::Variant(Variant *this, char *param_1) {
   long lVar1;
   long in_FS_OFFSET;
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
   *(undefined4*)this = 4;
...
/* Variant::Variant(char32_t const*) */void Variant::Variant(Variant *this, wchar32 *param_1) {
   wchar32 *pwVar1;
   wchar32 wVar2;
   long lVar3;
   long in_FS_OFFSET;
...
/* Variant::Variant(Vector3 const&) */void Variant::Variant(Variant *this, Vector3 *param_1) {
   *(undefined4*)this = 9;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   *(undefined8*)( this + 8 ) = *(undefined8*)param_1;
...
/* Variant::Variant(Vector3i const&) */void Variant::Variant(Variant *this, Vector3i *param_1) {
   *(undefined4*)this = 10;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   *(undefined8*)( this + 8 ) = *(undefined8*)param_1;
   *(undefined4*)( this + 0x10 ) = *(undefined4*)( param_1 + 8 );
...
/* Variant::Variant(Vector4 const&) */void Variant::Variant(Variant *this, Vector4 *param_1) {
   undefined8 uVar1;
   *(undefined4*)this = 0xc;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
...
/* Variant::Variant(Vector4i const&) */void Variant::Variant(Variant *this, Vector4i *param_1) {
   undefined8 uVar1;
   *(undefined4*)this = 0xd;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   uVar1 = *(undefined8*)( param_1 + 8 );
...
/* Variant::Variant(Vector2 const&) */void Variant::Variant(Variant *this, Vector2 *param_1) {
   *(undefined4*)this = 5;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   *(undefined8*)( this + 8 ) = *(undefined8*)param_1;
   return;
}
/* Variant::Variant(Vector2i const&) */void Variant::Variant(Variant *this, Vector2i *param_1) {
   *(undefined4*)this = 6;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   *(undefined8*)( this + 8 ) = *(undefined8*)param_1;
   return;
}
/* Variant::Variant(Rect2 const&) */void Variant::Variant(Variant *this, Rect2 *param_1) {
   undefined8 uVar1;
   *(undefined4*)this = 7;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   uVar1 = *(undefined8*)( param_1 + 8 );
...
/* Variant::Variant(Rect2i const&) */void Variant::Variant(Variant *this, Rect2i *param_1) {
   undefined8 uVar1;
   *(undefined4*)this = 8;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   uVar1 = *(undefined8*)( param_1 + 8 );
...
/* Variant::Variant(Plane const&) */void Variant::Variant(Variant *this, Plane *param_1) {
   undefined8 uVar1;
   *(undefined4*)this = 0xe;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   uVar1 = *(undefined8*)( param_1 + 8 );
...
/* Variant::Variant(Quaternion const&) */void Variant::Variant(Variant *this, Quaternion *param_1) {
   undefined8 uVar1;
   undefined8 uVar2;
...
/* Variant::Variant(Color const&) */void Variant::Variant(Variant *this, Color *param_1) {
   undefined8 uVar1;
...
/* Variant::Variant(NodePath const&) */void Variant::Variant(Variant *this, NodePath *param_1) {
   *(undefined4*)this = 0x16;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   NodePath::NodePath((NodePath*)( this + 8 ), param_1);
   return;
}
/* Variant::Variant(RID const&) */void Variant::Variant(Variant *this, RID *param_1) {
   *(undefined4*)this = 0x17;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   *(undefined8*)( this + 8 ) = *(undefined8*)param_1;
   return;
}
/* Variant::Variant(Object const*) */void Variant::Variant(Variant *this, Object *param_1) {
   Object OVar1;
   undefined8 uVar2;
   char cVar3;
...
/* Variant::Variant(Callable const&) */void Variant::Variant(Variant *this, Callable *param_1) {
   *(undefined4*)this = 0x19;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   Callable::Callable((Callable*)( this + 8 ), param_1);
   return;
}
/* Variant::Variant(Signal const&) */void Variant::Variant(Variant *this, Signal *param_1) {
   *(undefined4*)this = 0x1a;
   StringName::StringName((StringName*)( this + 8 ), param_1);
   *(undefined8*)( this + 0x10 ) = *(undefined8*)( param_1 + 8 );
   return;
}
/* Variant::Variant(Dictionary const&) */void Variant::Variant(Variant *this, Dictionary *param_1) {
   *(undefined4*)this = 0x1b;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   Dictionary::Dictionary((Dictionary*)( this + 8 ), (Dictionary*)param_1);
   return;
}
/* Variant::Variant(Array const&) */void Variant::Variant(Variant *this, Array *param_1) {
   *(undefined4*)this = 0x1c;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   Array::Array((Array*)( this + 8 ), param_1);
   return;
}
/* Variant::Variant(Vector<unsigned char> const&) */void Variant::Variant(Variant *this, Vector *param_1) {
   undefined8 *puVar1;
...
/* Variant::Variant(Vector<int> const&) */void Variant::Variant(Variant *this, Vector *param_1) {
   undefined8 *puVar1;
...
/* Variant::Variant(Vector<long> const&) */void Variant::Variant(Variant *this, Vector *param_1) {
   undefined8 *puVar1;
...
/* Variant::Variant(Vector<float> const&) */void Variant::Variant(Variant *this, Vector *param_1) {
   undefined8 *puVar1;
...
/* Variant::Variant(Vector<double> const&) */void Variant::Variant(Variant *this, Vector *param_1) {
   undefined8 *puVar1;
...
/* Variant::Variant(Vector<Vector2> const&) */void Variant::Variant(Variant *this, Vector *param_1) {
   undefined8 *puVar1;
...
/* Variant::Variant(Vector<Vector3> const&) */void Variant::Variant(Variant *this, Vector *param_1) {
   undefined8 *puVar1;
...
/* Variant::Variant(Vector<Color> const&) */void Variant::Variant(Variant *this, Vector *param_1) {
   undefined8 *puVar1;
...
/* Variant::Variant(Vector<Vector4> const&) */void Variant::Variant(Variant *this, Vector *param_1) {
   undefined8 *puVar1;
...
/* Variant::Variant(Vector<RID> const&) */void Variant::Variant(Variant *this, Vector *param_1) {
   long lVar1;
   ulong uVar2;
   int iVar3;
   long in_FS_OFFSET;
...
;
   ...
   LAB_001047e0:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* Variant::Variant(Vector<Plane> const&) */void Variant::Variant(Variant *this, Vector *param_1) {
   char cVar1;
   long lVar2;
   Variant *this_00;
   long lVar3;
...
/* Variant::Variant(Vector<Face3> const&) */void Variant::Variant(Variant *this, Vector *param_1) {
   long *plVar1;
   int iVar2;
   long lVar3;
   long lVar4;
 ...
 while ( iVar6 != iVar2 * 3 );
   ...
   *(undefined8*)( this + 0x10 ) = uStack_48;
   ...
   LAB_00104b24:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* Variant::Variant(IPAddress const&) */void Variant::Variant(Variant *this, IPAddress *param_1) {
   long lVar1;
   long in_FS_OFFSET;
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
   *(undefined4*)this = 4;
...
/* WARNING: Removing unreachable block (ram,0x00106354) *//* Variant::recursive_hash(int) const */ulong Variant::recursive_hash(int param_1) {
   float *pfVar1;
   double *pdVar2;
   float fVar3;
   double dVar4;
...
LAB_0010559c:
   ...
   LAB_0010675b:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* Variant::hash() const */void Variant::hash(Variant *this) {
   recursive_hash((int)this);
   return;
}
/* Variant::hash_compare(Variant const&, int, bool) const */bool Variant::hash_compare(Variant *this, Variant *param_1, int param_2, bool param_3) {
   double dVar1;
   double dVar2;
   bool bVar3;
   char cVar4;
...
LAB_001067d8:
   ...
   LAB_00107387:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* Variant::TEMPNAMEPLACEHOLDERVALUE(Variant const&) const */void Variant::operator ==(Variant *this, Variant *param_1) {
   hash_compare(this, param_1, 0, true);
   return;
}
/* Variant::identity_compare(Variant const&) const */bool Variant::identity_compare(Variant *this, Variant *param_1) {
   uint uVar1;
   undefined1 uVar2;
   long lVar3;
   long lVar4;
...
/* StringLikeVariantComparator::compare(Variant const&, Variant const&) */void StringLikeVariantComparator::compare(Variant *param_1, Variant *param_2) {
   char cVar1;
   cVar1 = ::Variant::hash_compare(param_1, param_2, 0, true);
   if (cVar1 == '\0') {
      if (*(int*)param_1 == 4) {
         if (*(int*)param_2 == 0x15) {
            operator==((String *)(param_1 + 8),(
            StringName * param_2 + 8;
            return;
         }
...
/* Variant::is_ref_counted() const */ulong Variant::is_ref_counted(Variant *this) {
   if (*(int*)this != 0x18) {
      return 0;
   }
...
/* Variant::is_type_shared(Variant::Type) */bool Variant::is_type_shared(int param_1) {
   return param_1 == 0x18 || param_1 - 0x1bU < 2;
}
/* Variant::is_shared() const */bool Variant::is_shared(Variant *this) {
   return *(int*)this == 0x18 || *(int*)this - 0x1bU < 2;
}
/* Variant::is_read_only() const */undefined8 Variant::is_read_only(Variant *this) {
   undefined8 uVar1;
   if (*(int*)this == 0x1b) {
...
/* Variant::_variant_call_error(String const&, Callable::CallError&) */void Variant::_variant_call_error(Variant *this, String *param_1, CallError *param_2) {
   long *plVar1;
   int iVar2;
   long lVar3;
   char *pcVar4;
   ...
   if (iVar2 == 2) {
      ...
      itos((long)&local_88);
      operator+((char *)&
      local_80,(String*)"Invalid type for argument #";
      ...
      String::parse_latin1((StrRange*)&local_60);
      operator+((char *)&
      local_58,(String*)"Too many arguments for method \'";
      ...
      String::parse_latin1((StrRange*)&local_78);
      operator+((char *)&
      local_80,(String*)"Invalid method \'";
      String::operator +((String*)&local_70, (String*)&local_80);
      String::operator +((String*)&local_58, (String*)&local_70);
...
/* Variant::construct_from_string(String const&, Variant&, void (*)(String const&, void*, Variant&),
   void*) */void Variant::construct_from_string(String *param_1, Variant *param_2, _func_void_String_ptr_void_ptr_Variant_ptr *param_3, void *param_4) {
   long lVar1;
   long in_FS_OFFSET;
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
...
/* Variant::get_construct_string() const */void Variant::get_construct_string(void) {
   Variant *in_RSI;
   String *in_RDI;
   *(undefined8*)in_RDI = 0;
   VariantWriter::write_to_string(in_RSI, in_RDI, (_func_String_void_ptr_Ref_ptr*)0x0, (void*)0x0, true);
   return;
}
/* Variant::get_call_error_text(Object*, StringName const&, Variant const**, int,
   Callable::CallError const&) */Variant * __thiscall
Variant::get_call_error_text
    ...
    *(undefined8 *)this = 0;
    ...
    itos((long)&local_b0);
      operator+((char *)&
      local_a8,(String*)"Cannot convert argument ";
...
LAB_00107e93:
   ...
   switchD_00107d4a_default:local_d8 = (String*)&local_90;
   ...
   if (param_1 != (Object*)0x0) {
      ...
      if (lVar7 == 0) {
         LAB_00108790:cVar6 = ( &needs_deinit )[local_58[0]];
      }
 else {
 ...
 while ( !bVar11 );
   ...
   LAB_0010825b:operator + ( (char*)&local_88,(String*)&_LC81 );
   String::operator +((String*)&local_78, (String*)&local_88);
   String::operator +((String*)&local_68, (String*)&local_78);
...
/* Variant::register_types() */void Variant::register_types(void) {
...
/* Variant::unregister_types() */void Variant::unregister_types(void) {
...
/* Variant::Variant(AABB const&) */void Variant::Variant(Variant *this, AABB *param_1) {
   undefined8 uVar1;
   undefined8 uVar2;
   BucketSmall *pBVar3;
   *(undefined4*)this = 0x10;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   pBVar3 = PagedAllocator<Variant::Pools::BucketSmall,true,4096u>::alloc<>((PagedAllocator<Variant::Pools::BucketSmall,true,4096u>*)&Pools::_bucket_small);
   uVar1 = *(undefined8*)param_1;
   uVar2 = *(undefined8*)( param_1 + 8 );
...
/* Variant::Variant(Transform2D const&) */void Variant::Variant(Variant *this, Transform2D *param_1) {
   undefined8 uVar1;
   undefined8 uVar2;
   BucketSmall *pBVar3;
   *(undefined4*)this = 0xb;
...
/* Variant::Variant(Basis const&) */void Variant::Variant(Variant *this, Basis *param_1) {
   undefined8 uVar1;
   undefined8 uVar2;
   BucketMedium *pBVar3;
   *(undefined4*)this = 0x11;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   pBVar3 = PagedAllocator<Variant::Pools::BucketMedium,true,4096u>::alloc<>((PagedAllocator<Variant::Pools::BucketMedium,true,4096u>*)&Pools::_bucket_medium);
   uVar1 = *(undefined8*)param_1;
   uVar2 = *(undefined8*)( param_1 + 8 );
...
/* Variant::Variant(Transform3D const&) */void Variant::Variant(Variant *this, Transform3D *param_1) {
   undefined8 uVar1;
   undefined8 uVar2;
   BucketMedium *pBVar3;
...
/* Variant::Variant(Projection const&) */void Variant::Variant(Variant *this, Projection *param_1) {
   undefined8 uVar1;
   undefined8 uVar2;
   BucketLarge *pBVar3;
   *(undefined4*)this = 0x13;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   pBVar3 = PagedAllocator<Variant::Pools::BucketLarge,true,4096u>::alloc<>((PagedAllocator<Variant::Pools::BucketLarge,true,4096u>*)&Pools::_bucket_large);
   uVar1 = *(undefined8*)param_1;
   uVar2 = *(undefined8*)( param_1 + 8 );
   ...
   *(undefined8*)( pBVar3 + 8 ) = uVar2;
   for (int i = 0; i < 3; i++) {
      uVar1 = *(undefined8*)( param_1 + ( 16 * i + 24 ) );
      *(undefined8*)( pBVar3 + ( 16 * i + 16 ) ) = *(undefined8*)( param_1 + ( 16 * i + 16 ) );
      *(undefined8*)( pBVar3 + ( 16 * i + 24 ) ) = uVar1;
   }

   return;
}
/* Variant::reference(Variant const&) */void Variant::reference(Variant *this, Variant *param_1) {
   int *piVar1;
   undefined4 uVar2;
   int iVar3;
   long lVar4;
   ...
   if (*(int*)this == 0x18) {
      ...
      LAB_00108cd5:_clear_internal(this);
   }
...
/* Variant::Variant(Variant const&) */void Variant::Variant(Variant *this, Variant *param_1) {
   *(undefined4*)this = 0;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   reference(this, param_1);
   return;
}
/* Variant::TEMPNAMEPLACEHOLDERVALUE(Variant const&) */void Variant::operator =(Variant *this, Variant *param_1) {
   int *piVar1;
   int iVar2;
   undefined8 uVar3;
   int iVar4;
...
/* Variant::Variant(Vector<Variant> const&) */void Variant::Variant(Variant *this, Vector *param_1) {
   long lVar1;
   Variant *this_00;
   long lVar2;
   int iVar3;
   ...
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   ...
   for (lVar2 = 0; ( lVar1 != 0 && ( lVar2 < *(long*)( lVar1 + -8 ) ) ); lVar2 = lVar2 + 1) {
      ...
      operator=(this_00,(Variant *)(lVar1
      + lVar2 * 0x18;
      lVar1 = *(long*)( param_1 + 8 );
   }
...
/* Variant::get_type_by_name(String const&) */undefined4 Variant::get_type_by_name(String *param_1) {
   long *plVar1;
   uint uVar2;
   long lVar3;
   undefined1 auVar4[16];
   ...
   long local_40;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if ((get_type_by_name(String_const &)::)&& ( iVar19 = __cxa_guard_acquire(&get_type_by_name(String_const & ::type_names), iVar19 != 0) ){get_type_by_name(String_const &) {
         uVar16 = uVar14;
      }
      ...
      auVar8._8_8_ = 0;
      auVar8._0_8_ = uVar21;
      lVar18 = SUB168(auVar4 * auVar8, 8);, uVar14 = *(uint*)(get_type_by_name(String_const &))uVar17 = SUB164(auVar4 * auVar8, 8)(uVar14 != 0), {
         uVar22 = 0;
         lVar20 = get_type_by_name(String_const & ::type_names._16_8_);
         do {
            if (uVar16 == uVar14) {
               cVar12 = String::operator ==((String*)( *(long*)(get_type_by_name(String_const &))+ 0x10 ), param_1);
               if (cVar12 != '\0') {
                  uVar13 = *(undefined4*)( *(long*)(get_type_by_name(String_const &))+ 0x18 );
                  goto LAB_00109a53;
               }
 ...
 while ( ( uVar14 != 0 ) && ( auVar6._8_8_ = 0 ),auVar6._0_8_ = (ulong)uVar14 * lVar3,auVar10._8_8_ = 0,auVar10._0_8_ = uVar21,auVar7._8_8_ = 0,auVar7._0_8_ = ( ulong )(( uVar2 + uVar17 ) - SUB164(auVar6 * auVar10, 8)) * lVar3,auVar11._8_8_ = 0,auVar11._0_8_ = uVar21,uVar22 <= SUB164(auVar7 * auVar11, 8) );
      }
, LAB_00109a4e:uVar13 = 0x27;
      LAB_00109a53:if (local_40 != *(long*)(in_FS_OFFSET + 0x28)), {
         /* WARNING: Subroutine does not return */
         __stack_chk_fail();
      }
, return uVar13;
...
/* Variant::get_callable_error_text(Callable const&, Variant const**, int, Callable::CallError
   const&) */Variant *__thiscallVariant::get_callable_error_text(Variant *this, Callable * param_1, Variant * *param_2, int,, param_3, CallError * param_4) * plVar1;Variant * pVVar2 ;;
   code *pcVar3;
   int iVar4;
   ulong uVar5;
   long lVar6;
   ...
   if (iVar11 < 0) {
      ...
      itos((long)&local_88);
      operator+((char *)&
      local_80,(String*)"Callable unbinds ";
   ...
   if (local_60 == 0) {
      if (lVar14 != 0) {
         ...
         lVar15 = lVar14;
         LAB_00109d53:puVar7 = (undefined8*)Memory::alloc_static(lVar6 + 0x10, false);
         if (puVar7 == (undefined8*)0x0) {
            uVar10 = 0x171;
            pcVar9 = "Parameter \"mem_new\" is null.";
            LAB_0010a197:_err_print_error("resize", "./core/templates/cowdata.h", uVar10, pcVar9, 0, 0);
            ppVVar13 = local_50[0];
         }
 else {
      ...
      if (lVar15 < 0) {
         ...
         CowData<Variant_const*>::_copy_on_write((CowData<Variant_const*>*)local_50);
         if (( lVar15 * 8 != 0 ) && ( uVar5 = lVar15 * 8 - 1 ),uVar5 = uVar5 | uVar5 >> 1,uVar5 = uVar5 | uVar5 >> 2,uVar5 = uVar5 | uVar5 >> 4,uVar5 = uVar5 | uVar5 >> 8,uVar5 = uVar5 | uVar5 >> 0x10,lVar6 = ( uVar5 | uVar5 >> 0x20 ) + 1,lVar6 != 0) goto LAB_00109d53;
         uVar10 = 0x16a;
         ...
         do {
            ...
            if (lVar15 < 0) {
               if (ppVVar13 == (Variant**)0x0) {
                  LAB_00109fad:pVVar12 = (Variant*)0x0;
               }
 else {
                  LAB_0010a101:pVVar12 = ppVVar13[-1];
               }

               LAB_00109fb0:_err_print_index_error("operator[]", "./core/templates/vector.h", 0x38, lVar15, (long)pVVar12, "p_index", "((Vector<T> *)(this))->_cowdata.size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
               pcVar3 = (code*)invalidInstructionException();
               ( *pcVar3 )();
 ...
 while ( local_60 != 0 );
   ...
   LAB_00109ef3:CowData<Variant>::_unref((CowData<Variant>*)&local_60);
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* Variant::Variant(Vector<String> const&) */void Variant::Variant(Variant *this, Vector *param_1) {
   undefined8 *puVar1;
...
/* Error CowData<String>::resize<false>(long) [clone .isra.0] */void CowData<String>::resize<false>(CowData<String> *this, long param_1) {
   long *plVar1;
   long *plVar2;
   code *pcVar3;
   undefined8 *puVar4;
...
;
            ...
            LAB_0010a6b9:if (uVar10 + 1 == lVar9) {
               LAB_0010a6c2:puVar7[-1] = param_1;
               return;
            }
            ...
            LAB_0010a85b:pcVar5 = "Parameter \"mem_new\" is null.";
            uVar6 = 0x1a9;
            pcVar8 = "_realloc";
            goto LAB_0010a848;
         }
         ...
         if (uVar10 + 1 == lVar9) {
            ...
            lVar12 = puVar7[-1];
            LAB_0010a7a0:if (param_1 <= lVar12) goto LAB_0010a744;
         }
 else {
            if (lVar12 != 0) {
   ...
   uVar6 = 0x16a;
   pcVar8 = "resize";
   LAB_0010a848:_err_print_error(pcVar8, "./core/templates/cowdata.h", uVar6, pcVar5, 0, 0);
   return;
}
/* Variant::Variant(Vector<StringName> const&) */void Variant::Variant(Variant *this, Vector *param_1) {
   long *plVar1;
   char *__s;
   code *pcVar2;
   long lVar3;
   ...
   if (lVar5 == 0) {
      ...
      if (0 < iVar4) {
         ...
         do {
            ...
            if (lVar5 == 0) {
               lVar6 = 0;
               LAB_0010aaa3:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar7, lVar6, "p_index", "size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
               pcVar2 = (code*)invalidInstructionException();
               ( *pcVar2 )();
            ...
            if (lVar5 == 0) {
               ...
               LAB_0010aa16:lVar5 = 0;
               LAB_0010aa19:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, uVar7, lVar5, "p_index", "size()", "", false, false);
            }
 else {
               __s = *(char**)( lVar5 + 8 );
               local_80 = 0;
 ...
 while ( !bVar8 );
               ...
               LAB_0010a956:if (local_70 == 0) goto LAB_0010aa16;
               LAB_0010a964:lVar5 = *(long*)( local_70 + -8 );
...
/* CowData<_VariantStrPair>::_copy_on_write() [clone .isra.0] */void CowData<_VariantStrPair>::_copy_on_write(CowData<_VariantStrPair> *this) {
   long lVar1;
   code *pcVar2;
   undefined8 *puVar3;
   CowData *pCVar4;
...
/* Variant::stringify(int) const */Vector *Variant::stringify(int param_1) {
   Variant VVar1;
   char *pcVar2;
   ulong uVar3;
   undefined8 *puVar4;
...
/* Variant::operator String() const */Variant *__thiscallVariant::operator_cast_to_String(Variant *this) {
   long lVar1;
   long in_FS_OFFSET;
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
   stringify((int)this);
...
/* Variant::operator Color() const */undefined1[16];__thiscallVariant::operator_cast_to_Color(Variant *this) {
   long *plVar1;
   int iVar2;
   long lVar3;
   char cVar4;
   ...
   LAB_0010c131:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* Variant::operator NodePath() const */Variant *__thiscallVariant::operator_cast_to_NodePath(Variant *this) {
   long *plVar1;
   long lVar2;
   int *in_RSI;
   long in_FS_OFFSET;
...
/* Variant::operator Vector<String>() const */Variant *__thiscallVariant::operator_cast_to_Vector(Variant *this) {
   long lVar1;
   long lVar2;
   int *in_RSI;
   long in_FS_OFFSET;
...
/* Variant::operator Vector<StringName>() const */Variant *__thiscallVariant::operator_cast_to_Vector(Variant *this) {
   code *pcVar1;
   undefined8 *puVar2;
   int iVar3;
   long *plVar4;
   ...
   if (local_50[0] != 0) {
      ...
      if (lVar5 < 0) {
         ...
         if (lVar5 == 0) {
            uVar6 = 0;
            lVar7 = 0;
            LAB_0010c469:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar6, lVar7, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
         ...
         do {
            ...
            if (*(long*)( this + 8 ) == 0) {
               lVar7 = 0;
               LAB_0010c4cb:_err_print_index_error("operator[]", "./core/templates/vector.h", 0x38, uVar6, lVar7, "p_index", "((Vector<T> *)(this))->_cowdata.size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
               pcVar1 = (code*)invalidInstructionException();
               ( *pcVar1 )();
 ...
 while ( bVar8 );
   ...
   LAB_0010c518:CowData<String>::_unref((CowData<String>*)local_50);
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return this;
   }
...
/* Variant::operator Vector<Vector4>() const */Variant *__thiscallVariant::operator_cast_to_Vector(Variant *this) {
   long lVar1;
   long lVar2;
   int *in_RSI;
   long in_FS_OFFSET;
...
/* Variant::operator Vector<Vector2>() const */Variant *__thiscallVariant::operator_cast_to_Vector(Variant *this) {
   long lVar1;
   long lVar2;
   int *in_RSI;
   long in_FS_OFFSET;
...
/* Variant::operator Vector<Vector3>() const */Variant *__thiscallVariant::operator_cast_to_Vector(Variant *this) {
   long lVar1;
   long lVar2;
   int *in_RSI;
   long in_FS_OFFSET;
...
/* Variant::operator Vector<Face3>() const */Variant *__thiscallVariant::operator_cast_to_Vector(Variant *this) {
   long *plVar1;
   ...
   *(undefined8*)( this + 8 ) = 0;
   ...
   if (uVar12 != 0) {
      ...
      if ((int)uVar12 < -2) {
         ...
         if (iVar7 == 0) {
            LAB_0010c932:CowData<Face3>::_copy_on_write(this_00);
            lVar5 = *(long*)( this + 8 );
            if ((int)uVar12 < 1) goto LAB_0010c742;
            LAB_0010c89f:uVar11 = 0;
            puVar6 = puVar9;
            do {
               iVar7 = (int)uVar11;
               uVar2 = uVar11 / 3;
               ...
               uVar8 = iVar7 + 1;
               uVar11 = (ulong)uVar8;
               puVar4 = (undefined8*)( lVar5 + (long)(int)uVar2 * 0x24 + (long)( iVar7 + (int)uVar3 * -3 ) * 0xc );
               *puVar4 = *puVar6;
 ...
 while ( puVar10 != (undefined8*)( (long)puVar4 + lVar5 + 0x10 ) );
   ...
   *plVar1 = *plVar1 + -1;
   ...
   LAB_0010c75a:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* Variant::operator Vector<Color>() const */Variant *__thiscallVariant::operator_cast_to_Vector(Variant *this) {
   long lVar1;
   long lVar2;
   int *in_RSI;
   long in_FS_OFFSET;
...
/* Variant::operator Vector<long>() const */Variant *__thiscallVariant::operator_cast_to_Vector(Variant *this) {
   long lVar1;
   long lVar2;
   int *in_RSI;
   long in_FS_OFFSET;
...
/* Variant::operator Vector<double>() const */Variant *__thiscallVariant::operator_cast_to_Vector(Variant *this) {
   long lVar1;
   long lVar2;
   int *in_RSI;
   long in_FS_OFFSET;
...
/* Variant::operator Vector<float>() const */Variant *__thiscallVariant::operator_cast_to_Vector(Variant *this) {
   long lVar1;
   long lVar2;
   int *in_RSI;
   long in_FS_OFFSET;
...
/* Variant::operator Vector<int>() const */Variant *__thiscallVariant::operator_cast_to_Vector(Variant *this) {
   long lVar1;
   long lVar2;
   int *in_RSI;
   long in_FS_OFFSET;
...
/* Variant::operator Vector<unsigned char>() const */Variant *__thiscallVariant::operator_cast_to_Vector(Variant *this) {
   long lVar1;
   long lVar2;
   int *in_RSI;
   long in_FS_OFFSET;
...
/* Variant::operator Array() const */Variant *__thiscallVariant::operator_cast_to_Array(Variant *this) {
   long lVar1;
   int *in_RSI;
   long in_FS_OFFSET;
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Variant::operator Vector<Variant>() const */Variant *__thiscallVariant::operator_cast_to_Vector(Variant *this) {
   ...
   *(undefined8*)( this + 8 ) = 0;
   ...
   if (*(long*)( this + 8 ) == 0) {
      uVar12 = 0;
      CowData<Variant>::_copy_on_write(this_00);
      LAB_0010ce17:uVar8 = uVar11 * 0x18 - 1;
      uVar8 = uVar8 >> 1 | uVar8;
      uVar8 = uVar8 >> 2 | uVar8;
      uVar8 = uVar8 >> 4 | uVar8;
      uVar8 = uVar8 >> 8 | uVar8;
 ...
 while ( uVar11 != uVar12 );
            ...
            puVar4 = (undefined8*)Memory::realloc_static((void*)( *(long*)( this + 8 ) + -0x10 ), lVar5 + 0x10U, false);
            if (puVar4 == (undefined8*)0x0) goto LAB_0010d054;
            puVar7 = puVar4 + 2;
            *puVar4 = 1;
            *(undefined8**)( this + 8 ) = puVar7;
            lVar5 = puVar4[1];
            LAB_0010cdfe:if (lVar5 < (long)uVar11) goto LAB_0010cea0;
         }
         ...
         lVar13 = 0;
         LAB_0010cf44:puVar4 = *(undefined8**)( this + 8 );
         uVar12 = uVar11;
         while (true) {
            if (puVar4 == (undefined8*)0x0) {
               /* WARNING: Does not return */
...
;
         ...
         if (lVar5 != lVar13) {
            ...
            if (puVar7 == (undefined8*)0x0) {
               LAB_0010d054:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
               goto LAB_0010cf03;
            }
 ...
 while ( iVar2 != iVar10 );
   LAB_0010ccce:Array::~Array((Array*)local_48);
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Variant::operator Vector<Plane>() const */Variant *__thiscallVariant::operator_cast_to_Vector(Variant *this) {
   ...
   *(undefined8*)( this + 8 ) = 0;
   ...
   if (*(long*)( this + 8 ) == 0) {
      lVar11 = 0;
      CowData<Plane>::_copy_on_write(this_00);
      LAB_0010d2e4:uVar8 = lVar12 * 0x10 - 1;
      uVar8 = uVar8 >> 1 | uVar8;
      uVar8 = uVar8 | uVar8 >> 2;
      uVar8 = uVar8 | uVar8 >> 4;
      uVar8 = uVar8 >> 8 | uVar8;
      ...
      if (lVar11 < lVar12) {
         LAB_0010d380:if (lVar11 == 0) {
            ...
            *(undefined8**)( this + 8 ) = puVar5;
            lVar11 = 0;
            LAB_0010d3b4:puVar6 = puVar5 + lVar11 * 2;
            do {
               *puVar6 = 0;
               puVar7 = puVar6 + 2;
 ...
 while ( puVar5 + lVar12 * 2 != puVar7 );
            ...
            puVar6 = (undefined8*)Memory::realloc_static((void*)( *(long*)( this + 8 ) + -0x10 ), lVar9 + 0x10U, false);
            if (puVar6 == (undefined8*)0x0) goto LAB_0010d45c;
            puVar5 = puVar6 + 2;
            *puVar6 = 1;
            *(undefined8**)( this + 8 ) = puVar5;
            lVar11 = puVar6[1];
            LAB_0010d243:if (lVar11 < lVar12) goto LAB_0010d3b4;
         }
         ...
         puVar6 = *(undefined8**)( this + 8 );
         LAB_0010d337:puVar5 = (undefined8*)Memory::realloc_static(puVar6 + -2, lVar9 + 0x10, false);
         if (puVar5 != (undefined8*)0x0) {
            puVar6 = puVar5 + 2;
            *puVar5 = 1;
            *(undefined8**)( this + 8 ) = puVar6;
         ...
         LAB_0010d45c:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
      }
      ...
      if (lVar12 != lVar11) {
         ...
         LAB_0010d372:puVar6[-1] = lVar12;
      }

   }

   LAB_0010d254:iVar10 = 0;
   CowData<Plane>::_copy_on_write(this_00);
   puVar6 = *(undefined8**)( this + 8 );
   do {
 ...
 while ( iVar2 != iVar10 );
   LAB_0010d10d:Array::~Array((Array*)local_80);
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Variant::operator Vector<RID>() const */Variant *__thiscallVariant::operator_cast_to_Vector(Variant *this) {
   long *plVar1;
   CowData<RID> *this_00;
   code *pcVar2;
   int iVar3;
   ...
   *(undefined8*)( this + 8 ) = 0;
   ...
   if (lVar9 < 0) {
      ...
      LAB_0010d84a:if (puVar10 == (undefined8*)0x0) goto LAB_0010d6d8;
   }
 else {
      puVar10 = *(undefined8**)( this + 8 );
         ...
         if (lVar11 < lVar9) {
            LAB_0010d7e0:if (lVar11 == 0) {
               ...
               *(undefined8**)( this + 8 ) = puVar10;
               ...
               puVar7 = (undefined8*)Memory::realloc_static((void*)( *(long*)( this + 8 ) + -0x10 ), lVar8 + 0x10U, false);
            ...
            puVar10 = *(undefined8**)( this + 8 );
            LAB_0010d7a9:puVar7 = (undefined8*)Memory::realloc_static(puVar10 + -2, lVar8 + 0x10, false);
            if (puVar7 == (undefined8*)0x0) {
               LAB_0010d8b1:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
               puVar10 = *(undefined8**)( this + 8 );
               goto LAB_0010d84a;
            }
   ...
   do {
      ...
      if (*(long*)( this + 8 ) == 0) {
         lVar11 = 0;
         LAB_0010d67c:_err_print_index_error("operator[]", "./core/templates/vector.h", 0x38, lVar9, lVar11, "p_index", "((Vector<T> *)(this))->_cowdata.size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
 ...
 while ( puVar10 != (undefined8*)0x0 );
   LAB_0010d6d8:Array::~Array((Array*)aVStack_48);
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* Variant::operator IPAddress() const */Variant *__thiscallVariant::operator_cast_to_IPAddress(Variant *this) {
   long *plVar1;
   uint *puVar2;
   uint uVar3;
   long lVar4;
   ...
   if (( uVar3 - 0x1e & 0xfffffffd ) == 0) {
      ...
      LAB_0010d968:puVar2 = local_30[0];
      if (local_30[0] != (uint*)0x0) {
         if (*(long*)( local_30[0] + -2 ) == 4) {
            IPAddress::IPAddress((IPAddress*)this, *local_30[0], local_30[0][1], local_30[0][2], local_30[0][3], false);
            LOCK();
            puVar2 = puVar2 + -4;
      ...
      LAB_0010d95d:_convert_array_from_variant<Vector<int>>((Variant*)&local_38);
      goto LAB_0010d968;
   }

   LAB_0010d997:stringify((int)&local_38);
   ...
   LAB_0010d9da:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return this;
   }
...
/* stringify_variant_clean(Variant const&, int) */Variant *stringify_variant_clean(Variant *param_1, int param_2) {
   long *plVar1;
   int iVar2;
   undefined *puVar3;
   long lVar4;
   ...
   LAB_0010dbb0:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* Variant::is_zero() const [clone .cold] */void Variant::is_zero(void) {
   FUN_00103539();
   return;
}
...
/* Error CowData<String>::resize<false>(long) [clone .isra.0] [clone .cold] */void CowData<String>::resize<false>(long param_1) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
...
/* CowData<_VariantStrPair>::_copy_on_write() [clone .isra.0] [clone .cold] */void CowData<_VariantStrPair>::_copy_on_write(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Variant::operator Vector<Variant>() const [clone .cold] */void Variant::operator_cast_to_Vector(Variant *this) {
   code *pcVar1;
   _DAT_00000000 = 0;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
...
/* Variant::operator Vector<Plane>() const [clone .cold] */void Variant::operator_cast_to_Vector(Variant *this) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* Variant::operator Vector<RID>() const [clone .cold] */void Variant::operator_cast_to_Vector(Variant *this) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
...
/* PagedAllocator<Variant::Pools::BucketSmall, true, 4096u>::~PagedAllocator() */void PagedAllocator<Variant::Pools::BucketSmall,true,4096u>::~PagedAllocator(PagedAllocator<Variant::Pools::BucketSmall,true,4096u> *this) {
...
/* PagedAllocator<Variant::Pools::BucketLarge, true, 4096u>::~PagedAllocator() */void PagedAllocator<Variant::Pools::BucketLarge,true,4096u>::~PagedAllocator(PagedAllocator<Variant::Pools::BucketLarge,true,4096u> *this) {
...
/* PagedAllocator<Variant::Pools::BucketMedium, true, 4096u>::~PagedAllocator() */void PagedAllocator<Variant::Pools::BucketMedium,true,4096u>::~PagedAllocator(PagedAllocator<Variant::Pools::BucketMedium,true,4096u> *this) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<unsigned char>::resize<false>(long) [clone .isra.0] */void CowData<unsigned_char>::resize<false>(CowData<unsigned_char> *this, long param_1) {
   ...
   if (param_1 <= lVar7) {
      ...
      if (uVar3 + 1 == lVar4) {
         ...
         if (puVar6 == (undefined8*)0x0) {
            LAB_0010fc30:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
            return;
         }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<int>::resize<false>(long) [clone .isra.0] */void CowData<int>::resize<false>(CowData<int> *this, long param_1) {
      ...
      if (uVar4 != 0xffffffffffffffff) {
         if (param_1 <= lVar9) {
            ...
            if (uVar4 + 1 == lVar3) {
               ...
               if (puVar6 == (undefined8*)0x0) {
                  LAB_00110080:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
                  return;
               }
   ...
   LAB_00110062:_err_print_error("resize", "./core/templates/cowdata.h", uVar8, pcVar7, 0, 0);
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<long>::resize<false>(long) [clone .isra.0] */void CowData<long>::resize<false>(CowData<long> *this, long param_1) {
      ...
      if (uVar4 != 0xffffffffffffffff) {
         if (param_1 <= lVar9) {
            ...
            if (uVar4 + 1 == lVar3) {
               ...
               puVar6 = (undefined8*)Memory::realloc_static(puVar5 + -2, uVar4 + 0x11, false);
               if (puVar6 == (undefined8*)0x0) {
                  LAB_00110340:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
                  return;
               }
   ...
   uVar8 = 0x16a;
   pcVar7 = "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY";
   LAB_00110322:_err_print_error("resize", "./core/templates/cowdata.h", uVar8, pcVar7, 0, 0);
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<double>::resize<false>(long) [clone .isra.0] */void CowData<double>::resize<false>(CowData<double> *this, long param_1) {
      ...
      if (uVar4 != 0xffffffffffffffff) {
         if (param_1 <= lVar9) {
            ...
            if (uVar4 + 1 == lVar3) {
               ...
               puVar6 = (undefined8*)Memory::realloc_static(puVar5 + -2, uVar4 + 0x11, false);
               if (puVar6 == (undefined8*)0x0) {
                  LAB_00110600:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
                  return;
               }
   ...
   uVar8 = 0x16a;
   pcVar7 = "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY";
   LAB_001105e2:_err_print_error("resize", "./core/templates/cowdata.h", uVar8, pcVar7, 0, 0);
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<float>::resize<false>(long) [clone .isra.0] */void CowData<float>::resize<false>(CowData<float> *this, long param_1) {
      ...
      if (uVar4 != 0xffffffffffffffff) {
         if (param_1 <= lVar9) {
            ...
            if (uVar4 + 1 == lVar3) {
               ...
               puVar6 = (undefined8*)Memory::realloc_static(puVar5 + -2, uVar4 + 0x11, false);
               if (puVar6 == (undefined8*)0x0) {
                  LAB_001108c0:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
                  return;
               }
   ...
   uVar8 = 0x16a;
   pcVar7 = "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY";
   LAB_001108a2:_err_print_error("resize", "./core/templates/cowdata.h", uVar8, pcVar7, 0, 0);
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Vector2>::resize<false>(long) [clone .isra.0] */void CowData<Vector2>::resize<false>(CowData<Vector2> *this, long param_1) {
   ...
   if (param_1 * 8 != 0) {
      ...
      if (uVar4 != 0xffffffffffffffff) {
         if (param_1 <= lVar10) {
            ...
            LAB_00110bd0:pcVar6 = "Parameter \"mem_new\" is null.";
            uVar7 = 0x1a9;
            pcVar9 = "_realloc";
            goto LAB_00110bb8;
         }
         ...
         if (uVar4 + 1 == lVar3) {
            ...
            lVar3 = puVar8[-1];
            LAB_00110ae1:if (param_1 <= lVar3) goto LAB_00110a4d;
         }
 else {
            if (lVar10 != 0) {
               puVar5 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), uVar4 + 0x11, false);
   ...
   uVar7 = 0x16a;
   pcVar9 = "resize";
   LAB_00110bb8:_err_print_error(pcVar9, "./core/templates/cowdata.h", uVar7, pcVar6, 0, 0);
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Color>::resize<false>(long) [clone .isra.0] */void CowData<Color>::resize<false>(CowData<Color> *this, long param_1) {
      ...
      if (uVar5 != 0xffffffffffffffff) {
         if (param_1 <= lVar12) {
            ...
            if (uVar5 + 1 == lVar4) {
               ...
               if (puVar6 == (undefined8*)0x0) {
                  LAB_00110ef8:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
                  return;
               }
         ...
         if (uVar5 + 1 == lVar4) {
            ...
            lVar4 = puVar9[-1];
            LAB_00110e21:if (param_1 <= lVar4) goto LAB_00110d98;
         }
 else {
            if (lVar12 != 0) {
 ...
 while ( puVar7 + ( param_1 - lVar4 ) * 2 != puVar8 );
   ...
   LAB_00110eda:_err_print_error("resize", "./core/templates/cowdata.h", uVar11, pcVar10, 0, 0);
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Vector4>::resize<false>(long) [clone .isra.0] */void CowData<Vector4>::resize<false>(CowData<Vector4> *this, long param_1) {
      ...
      if (uVar4 != 0xffffffffffffffff) {
         if (param_1 <= lVar12) {
            ...
            if (uVar4 + 1 == lVar3) {
               ...
               if (puVar5 == (undefined8*)0x0) {
                  LAB_00111218:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
                  return;
               }
         ...
         if (uVar4 + 1 == lVar3) {
            ...
            lVar3 = puVar9[-1];
            LAB_00111141:if (param_1 <= lVar3) goto LAB_001110b8;
         }
 else {
            if (lVar12 != 0) {
               puVar5 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), uVar4 + 0x11, false);
 ...
 while ( pauVar6 + ( param_1 - lVar3 ) != pauVar8 );
   ...
   uVar11 = 0x16a;
   pcVar10 = "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY";
   LAB_001111fa:_err_print_error("resize", "./core/templates/cowdata.h", uVar11, pcVar10, 0, 0);
   return;
}
/* Variant::Pools::BucketSmall* PagedAllocator<Variant::Pools::BucketSmall, true, 4096u>::alloc<>()
    */BucketSmall * PagedAllocator<Variant::Pools::BucketSmall,true,4096u>::alloc<>(PagedAllocator<Variant::Pools::BucketSmall,true,4096u> * this) < Variant::Pools::BucketSmall * pPVar1 ;PagedAllocator<Variant::Pools::BucketSmall,true,4096u> *pBVar4long lVar5long *plVar6uint uVar7int iVar8undefined8 uVar9long lVar10long *plVar11long *plVar12long lVar13long *plVar14long lVar15longin_FS_OFFSETpPVar1 = this + 0x24lVar3 = *(long*)( in_FS_OFFSET + 0x28 );while (true) {
   LOCK();
   PVar2 = *pPVar1;
...
;;;iVar8 = *(int*)( this + 0x14 );if (iVar8 == 0) {
...
uVar7 = iVar8 - 1;*(uint*)( this + 0x14 ) = uVar7;pBVar4 = *(BucketSmall**)( plVar14[uVar7 >> ( ( byte ) * (undefined4*)( this + 0x18 ) & 0x1f )] + ( ulong )(uVar7 & *(uint*)( this + 0x1c )) * 8 );this[0x24] = (PagedAllocator<Variant::Pools::BucketSmall,true,4096u>)0x0;if (lVar3 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return pBVar4;}/* Variant::Pools::BucketMedium* PagedAllocator<Variant::Pools::BucketMedium, true,
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<String, Variant::Type, HashMapHasherDefault, HashMapComparatorDefault<String>,
   DefaultTypedAllocator<HashMapElement<String, Variant::Type> > >::operator[](String const&) */undefined1 * __thiscallHashMap<String,Variant::Type,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Variant::Type>>>::operator [](HashMap<String,Variant::Type,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Variant::Type>>> * this, String * param_1) * plVar1 ;void *pvVar2void*__slonglVar3undefined1auVar4[16]undefined1 auVar5[16]undefined1 auVar6[16]undefined1 auVar7[16]undefined1 auVar8[16]undefined1 auVar9[16]undefined1 auVar10[16]undefined1 auVar11[16]undefined1 auVar12[16]undefined1 auVar13[16]undefined1 auVar14[16]undefined1 auVar15[16]undefined1 auVar16[16]undefined1 auVar17[16]undefined1 auVar18[16]undefined1 auVar19[16]undefined1 auVar20[16]undefined1 auVar21[16]undefined1 auVar22[16]undefined1 auVar23[16]undefined1 auVar24[16]undefined1 auVar25[16]undefined1 auVar26[16]undefined1 auVar27[16]undefined1 auVar28[16]undefined1 auVar29[16]undefined1 auVar30[16]undefined1 auVar31[16]undefined1 auVar32[16]undefined1 auVar33[16]undefined1 auVar34[16]undefined1 auVar35[16]char __s_00undefined1 = ( *pauVar41 )[16]undefined8 * puVar42void * pvVar43ulong * puVar50uint * pauVar56)[16];undefined1(*pauVar57)[16];long in_FS_OFFSETlong local_58undefined4 = *(long*)( in_FS_OFFSET + 0x28 ) = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 )if (*(long*)( this + 8 ) == 0) {
   LAB_00112b38:uVar39 = (ulong)uVar55;
   uVar44 = uVar39 * 4;
   uVar48 = uVar39 * 8;
 ...
 while ( uVar39 != uVar44 );
      ...
      LAB_001129ce:if (iVar45 != 0) {
         LAB_001129d6:uVar37 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
 ...
 while ( ( uVar52 != 0 ) && ( auVar18._8_8_ = 0 ),auVar18._0_8_ = (ulong)uVar52 * lVar3,auVar34._8_8_ = 0,auVar34._0_8_ = uVar39,auVar19._8_8_ = 0,auVar19._0_8_ = ( ulong )(( uVar37 + uVar51 ) - SUB164(auVar18 * auVar34, 8)) * lVar3,auVar35._8_8_ = 0,auVar35._0_8_ = uVar39,uVar54 <= SUB164(auVar19 * auVar35, 8) );
   ...
   LAB_001124ea:uVar55 = *(uint*)( this + 0x28 );
   if (uVar55 == 0x1c) {
...
;
 ...
 while ( ( uVar38 != 0 ) && ( auVar14._8_8_ = 0 ),auVar14._0_8_ = (ulong)uVar38 * lVar3,auVar30._8_8_ = 0,auVar30._0_8_ = uVar39,auVar15._8_8_ = 0,auVar15._0_8_ = ( ulong )(( uVar52 + uVar55 ) - SUB164(auVar14 * auVar30, 8)) * lVar3,auVar31._8_8_ = 0,auVar31._0_8_ = uVar39,uVar51 <= SUB164(auVar15 * auVar31, 8) );
      ...
      LAB_001129ca:iVar45 = *(int*)( this + 0x2c );
      goto LAB_001129ce;
   }

   LAB_001124c4:if ((float)uVar39 * __LC97 < (float)( iVar45 + 1 )) goto LAB_001124ea;
}
local_58 = 0;if (*(long*)param_1 == 0) {
   pauVar41 = (undefined1(*) [16])operator_new(0x20, "");
   *(undefined8*)pauVar41[1] = 0;
   *pauVar41 = (undefined1[16])0x0;
   LAB_00112b0b:*(undefined4*)( pauVar41[1] + 8 ) = 0;
   LAB_00112771:puVar42 = *(undefined8**)( this + 0x20 );
   if (puVar42 != (undefined8*)0x0) goto LAB_0011277e;
   LAB_001129a5:*(undefined1(**) [16])( this + 0x18 ) = pauVar41;
}
 else {
...
*(undefined1(**) [16])( lVar46 + lVar47 * 8 ) = pauVar57;*puVar50 = uVar55;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_00112883:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return pauVar41[1] + 8;
}
...
/* CowData<_VariantStrPair>::_unref() */void CowData<_VariantStrPair>::_unref(CowData<_VariantStrPair> *this) {
   long *plVar1;
   long *plVar2;
   long lVar3;
   long lVar4;
...
/* Error CowData<_VariantStrPair>::resize<false>(long) */undefined8 CowData<_VariantStrPair>::resize<false>(CowData<_VariantStrPair> *this, long param_1) {
   long *plVar1;
   long *plVar2;
   code *pcVar3;
   undefined8 *puVar4;
   ...
   if (param_1 * 0x10 == 0) {
      LAB_00113450:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
      ...
      LAB_001134cd:/* WARNING: Does not return */pcVar3 = (code*)invalidInstructionException();
      ( *pcVar3 )();
   }
   ...
   if (uVar10 + 1 == lVar9) {
      ...
      lVar8 = puVar7[-1];
      LAB_001133b1:if (param_1 <= lVar8) goto LAB_001132b8;
   }
 else {
      if (lVar8 != 0) {
         puVar4 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), uVar10 + 0x11, false);
         if (puVar4 == (undefined8*)0x0) {
            LAB_0011347f:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
            return 6;
         }
 ...
 while ( pauVar11 != pauVar6 );
   LAB_001132b8:puVar7[-1] = param_1;
   return 0;
}
/* String stringify_vector<Vector<Vector2> >(Vector<Vector2> const&, int) */Vector *stringify_vector<Vector<Vector2>>(Vector *param_1, int param_2) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   undefined *puVar4;
...
;
   ...
   lVar6 = 0;
   LAB_0011dc93:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar7, lVar6, "p_index", "size()", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar3 = (code*)invalidInstructionException();
   ( *pcVar3 )();
}
/* String stringify_vector<Vector<Vector3> >(Vector<Vector3> const&, int) */Vector *stringify_vector<Vector<Vector3>>(Vector *param_1, int param_2) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   undefined *puVar4;
...
;
   ...
   lVar6 = 0;
   LAB_0011de82:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar7, lVar6, "p_index", "size()", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar3 = (code*)invalidInstructionException();
   ( *pcVar3 )();
}
/* String stringify_vector<Vector<Color> >(Vector<Color> const&, int) */Vector *stringify_vector<Vector<Color>>(Vector *param_1, int param_2) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   undefined *puVar4;
...
;
   ...
   lVar6 = 0;
   LAB_0011e06b:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar7, lVar6, "p_index", "size()", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar3 = (code*)invalidInstructionException();
   ( *pcVar3 )();
}
/* String stringify_vector<Vector<Vector4> >(Vector<Vector4> const&, int) */Vector *stringify_vector<Vector<Vector4>>(Vector *param_1, int param_2) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   undefined *puVar4;
...
;
   ...
   lVar6 = 0;
   LAB_0011e24b:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar7, lVar6, "p_index", "size()", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar3 = (code*)invalidInstructionException();
   ( *pcVar3 )();
}
/* String stringify_vector<Vector<String> >(Vector<String> const&, int) */Vector *stringify_vector<Vector<String>>(Vector *param_1, int param_2) {
   long *plVar1;
   long *plVar2;
   long lVar3;
   code *pcVar4;
 ...
 while ( !bVar9 );
      ...
      LAB_0011e3c2:stringify_variant_clean((Variant*)&local_68, (int)(Variant*)&local_58);
      String::operator +=((String*)param_1, (String*)&local_68);
      puVar5 = local_68;
      if (local_68 != (undefined*)0x0) {
         LOCK();
...
;
   ...
   lVar6 = 0;
   LAB_0011e454:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar8, lVar6, "p_index", "size()", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar4 = (code*)invalidInstructionException();
   ( *pcVar4 )();
}
/* String stringify_vector<Vector<unsigned char> >(Vector<unsigned char> const&, int) */Vector *stringify_vector<Vector<unsigned_char>>(Vector *param_1, int param_2) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   undefined *puVar4;
...
;
   ...
   lVar6 = 0;
   LAB_0011e633:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar7, lVar6, "p_index", "size()", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar3 = (code*)invalidInstructionException();
   ( *pcVar3 )();
}
/* String stringify_vector<Vector<int> >(Vector<int> const&, int) */Vector *stringify_vector<Vector<int>>(Vector *param_1, int param_2) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   undefined *puVar4;
...
;
   ...
   lVar6 = 0;
   LAB_0011e812:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar7, lVar6, "p_index", "size()", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar3 = (code*)invalidInstructionException();
   ( *pcVar3 )();
}
/* String stringify_vector<Vector<long> >(Vector<long> const&, int) */Vector *stringify_vector<Vector<long>>(Vector *param_1, int param_2) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   undefined *puVar4;
...
;
   ...
   lVar6 = 0;
   LAB_0011e9f2:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar7, lVar6, "p_index", "size()", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar3 = (code*)invalidInstructionException();
   ( *pcVar3 )();
}
/* String stringify_vector<Vector<float> >(Vector<float> const&, int) */Vector *stringify_vector<Vector<float>>(Vector *param_1, int param_2) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   undefined *puVar4;
...
;
   ...
   lVar6 = 0;
   LAB_0011ebd9:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar7, lVar6, "p_index", "size()", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar3 = (code*)invalidInstructionException();
   ( *pcVar3 )();
}
/* String stringify_vector<Vector<double> >(Vector<double> const&, int) */Vector *stringify_vector<Vector<double>>(Vector *param_1, int param_2) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   undefined *puVar4;
...
;
   ...
   lVar6 = 0;
   LAB_0011edb5:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar7, lVar6, "p_index", "size()", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar3 = (code*)invalidInstructionException();
   ( *pcVar3 )();
}
/* String stringify_vector<Array>(Array const&, int) */Array *stringify_vector<Array>(Array *param_1, int param_2) {
   long *plVar1;
   undefined *puVar2;
   int iVar3;
   int iVar4;
...
/* WARNING: Removing unreachable block (ram,0x0011f1a4) *//* WARNING: Removing unreachable block (ram,0x0011f17a) *//* WARNING: Removing unreachable block (ram,0x0011f1ce) *//* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Variant::Pools::_bucket_small */void Variant::Pools::_GLOBAL__sub_I__bucket_small(void) {
   long lVar1;
   bool bVar2;
   bool bVar3;
   long in_FS_OFFSET;
...
;
   ...
   __cxa_atexit(PagedAllocator<Variant::Pools::BucketSmall,true,4096u>::~PagedAllocator, &_bucket_small, &__dso_handle);
   bVar3 = false;
   while (true) {
      LOCK();
      bVar2 = !bVar3;
...
;
   ...
   __cxa_atexit(PagedAllocator<Variant::Pools::BucketMedium,true,4096u>::~PagedAllocator, &_bucket_medium, &__dso_handle);
   bVar3 = false;
   while (true) {
      LOCK();
      bVar2 = !bVar3;
...
;
   ...
   if (lVar1 == *(long*)( in_FS_OFFSET + 0x28 )) {
      __cxa_atexit(PagedAllocator<Variant::Pools::BucketLarge,true,4096u>::~PagedAllocator, &_bucket_large, &__dso_handle);
      return;
   }
...
/* WARNING: Control flow encountered bad instruction data *//* PagedAllocator<Variant::Pools::BucketMedium, true, 4096u>::~PagedAllocator() */void PagedAllocator<Variant::Pools::BucketMedium,true,4096u>::~PagedAllocator(PagedAllocator<Variant::Pools::BucketMedium,true,4096u> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* PagedAllocator<Variant::Pools::BucketLarge, true, 4096u>::~PagedAllocator() */void PagedAllocator<Variant::Pools::BucketLarge,true,4096u>::~PagedAllocator(PagedAllocator<Variant::Pools::BucketLarge,true,4096u> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* PagedAllocator<Variant::Pools::BucketSmall, true, 4096u>::~PagedAllocator() */void PagedAllocator<Variant::Pools::BucketSmall,true,4096u>::~PagedAllocator(PagedAllocator<Variant::Pools::BucketSmall,true,4096u> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

/* ures_loc_countLocales(UEnumeration*, UErrorCode*) */undefined4 ures_loc_countLocales(UEnumeration *param_1, UErrorCode *param_2) {
   if (*(long*)( param_1 + 8 ) != 0) {
...
/* ures_appendResPath(UResourceBundle*, char const*, int, UErrorCode*) */void ures_appendResPath(UResourceBundle *param_1, char *param_2, int param_3, UErrorCode *param_4) {
   int iVar1;
   ...
   *(long*)( param_1 + 0x20 ) = lVar3;
   if (lVar3 == 0) {
      LAB_001000f8:*(undefined4*)param_4 = 7;
      return;
   }

   pUVar2 = (UResourceBundle*)__strcpy_chk(lVar3, param_1 + 0x28, lVar5);
   LAB_00100093:strcpy((char*)( pUVar2 + iVar1 ), param_2);
   return;
}
/* ures_toUTF8String(char16_t const*, int, char*, int*, signed char, UErrorCode*) */undefined *ures_toUTF8String(undefined8 param_1, ulong param_2, undefined *param_3, uint *param_4, char param_5, int *param_6) {
   undefined *puVar1;
   uint uVar2;
   int iVar3;
   uint uVar4;
   ...
   if (param_4 == (uint*)0x0) {
      ...
      if (iVar3 != 0) {
         LAB_0010017e:if ((int)uVar4 < iVar3) {
            puVar1 = (undefined*)u_strToUTF8_76_godot(0, 0, param_4, param_1, param_2 & 0xffffffff);
            return puVar1;
         }

         if (( ( param_5 == '\0' ) && ( iVar3 < 0x2aaaaaab ) ) && ( uVar2 = iVar3 * 3 + 1 ),(int)uVar2 < (int)uVar4) {
...
/* getFallbackData(UResourceBundle const*, char const**, unsigned int*, UErrorCode*) */undefined8 *getFallbackData(UResourceBundle *param_1, char **param_2, uint *param_3, UErrorCode *param_4) {
   char *__s1;
   undefined8 *puVar1;
   int iVar2;
   uint uVar3;
   ...
   *param_3 = 0xffffffff;
   if (puVar4 != (undefined8*)0x0) {
      if (*(int*)( puVar4 + 0xe ) == 0) {
         uVar3 = res_getTableItemByKey_76_godot(puVar4 + 5, *(undefined4*)( puVar4 + 9 ), &local_44, param_2);
         *param_3 = uVar3;
         ...
         iVar2 = 0;
         if (param_1[0x70] != (UResourceBundle)0x0) {
            LAB_0010023d:for (puVar1 = (undefined8*)puVar4[2]; puVar1 != (undefined8*)0x0; puVar1 = (undefined8*)puVar1[2]) {
               if (*(int*)( puVar1 + 0xe ) == 0) {
                  iVar2 = iVar2 + 1;
                  uVar3 = res_getTableItemByKey_76_godot(puVar1 + 5, *(undefined4*)( puVar1 + 9 ), &local_44, param_2);
                  *param_3 = uVar3;
               }
 else {
                  uVar3 = *param_3;
   ...
   *(undefined4*)param_4 = 2;
   ...
   LAB_00100286:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return puVar4;
   }
...
/* (anonymous namespace)::GetAllChildrenSink::~GetAllChildrenSink() */void GetAllChildrenSink::~GetAllChildrenSink(GetAllChildrenSink *this) {
...
/* free_entry(UResourceDataEntry*) */void free_entry(UResourceDataEntry *param_1) {
   int *piVar1;
   long lVar2;
   long lVar3;
   res_unload_76_godot(param_1 + 0x28);
   if (( *(UResourceDataEntry**)param_1 != (UResourceDataEntry*)0x0 ) && ( *(UResourceDataEntry**)param_1 != param_1 + 0x68 )) {
      uprv_free_76_godot();
   }
...
/* compareEntries(UElement, UElement) */bool compareEntries(undefined8 *param_1, undefined8 *param_2) {
   undefined8 uVar1;
   undefined8 uVar2;
   char cVar3;
   uVar1 = param_1[1];
...
/* hashEntry(UElement) */int hashEntry(undefined8 *param_1) {
   undefined8 uVar1;
   int iVar2;
   int iVar3;
   uVar1 = param_1[1];
...
/* init_entry(char const*, char const*, UErrorCode*) */UResourceDataEntry *init_entry(char *param_1, char *param_2, UErrorCode *param_3) {
   long lVar1;
   int iVar2;
 ...
 while ( *(UResourceDataEntry**)( pUVar6 + 0x18 ) != (UResourceDataEntry*)0x0 );
      ...
      *(undefined8*)( pUVar3 + 0x70 ) = 0;
      ...
      for (uVar8 = ( ulong )(( (int)pUVar3 - (int)(undefined8*)( ( ulong )(pUVar3 + 8) & 0xfffffffffffffff8 ) ) + 0x78U >> 3); uVar8 != 0; uVar8 = uVar8 - 1) {
         *puVar9 = 0;
      ...
      if ((int)sVar4 < 3) {
         ...
         *(UResourceDataEntry**)pUVar3 = pUVar6;
         LAB_00100627:strcpy((char*)pUVar6, param_1);
         if (*(int*)param_3 < 1) {
            if (param_2 == (char*)0x0) {
               lVar5 = *(long*)( pUVar3 + 8 );
            }
            ...
            if (*(int*)param_3 < 1) {
               if (pUVar3[0x62] == (UResourceDataEntry)0x0) {
                  LAB_001006f3:iVar2 = res_getResource_76_godot(pUVar6, "%%ALIAS");
                  if (( ( iVar2 != -1 ) && ( lVar5 = res_getStringNoTrace_76_godot(pUVar6, iVar2, &local_120) ),lVar5 != 0 )) {
                  ...
                  iVar2 = *(int*)param_3;
                  if (iVar2 < 1) {
                     if (( ( lVar5 != 0 ) && ( *(int*)( lVar5 + 0x70 ) == 0 ) ) && ( *(char*)( lVar5 + 0x61 ) != '\0' )) {
            ...
            LAB_0010068b:pUVar6 = (UResourceDataEntry*)uhash_get_76_godot(cache, pUVar3);
      ...
      LAB_001006d5:uprv_free_76_godot(pUVar3);
   }

   pUVar6 = (UResourceDataEntry*)0x0;
   LAB_00100587:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* createPath(char const*, int, char const*, int, char const*, icu_76_godot::CharString&,
   UErrorCode*) */void createPath(char *param_1, int param_2, char *param_3, int param_4, char *param_5, CharString *param_6, UErrorCode *param_7) {
   char cVar1;
   char *pcVar2;
   char *pcVar3;
   long in_FS_OFFSET;
   ...
   **(undefined1**)param_6 = 0;
   if (( param_4 < 1 ) || ( icu_76_godot::CharString::append((char*)param_6, (int)param_3, (UErrorCode*)(ulong)(uint)param_4),0 < *(int*)param_7 )) {
      LAB_001008d8:icu_76_godot::StringPiece::StringPiece((StringPiece*)local_58, param_5);
...
;
   goto LAB_001008d8;
   LAB_001009ea:param_5 = param_5 + 1;
   goto LAB_00100998;
}
/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* ures_cleanup() */undefined8 ures_cleanup(void) {
...
/* loadParentsExceptRoot(UResourceDataEntry*&, char*, int, signed char, char*, UErrorCode*) [clone
   .part.0] [clone .constprop.0] */undefined1 loadParentsExceptRoot(long *param_1, char *param_2, undefined8 param_3, int *param_4) {
   long lVar1;
   int iVar2;
   long lVar3;
   char *pcVar4;
   ...
   do {
      ...
      while (true) {
         if (( ( lVar1 != 0 ) || ( *(char*)( lVar3 + 0x60 ) != '\0' ) ) || ( iVar2 = iVar2 != -1 )) goto LAB_00100c08;
...
;
      if (( *param_2 == '\0' ) || ( pcVar4 = strstr("nb nn", param_2) ),pcVar4 == (char*)0x0) {
         LAB_00100c08:uVar5 = 1;
         LAB_00100c0e:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            return uVar5;
         }
...
/* ures_closeBundle(UResourceBundle*, signed char) */void ures_closeBundle(long param_1, uint param_2) {
   long *plVar1;
   long lVar2;
   if (param_1 == 0) {
      return;
 ...
 while ( *plVar1 != 0 );
   ...
   *(undefined4*)( param_1 + 0x68 ) = 0;
   if (( ( *(int*)( param_1 + 0x74 ) == 0x12c9b17 ) && ( *(int*)( param_1 + 0x78 ) == 0x12bb38b ) ) && ( ( param_2 & 1 ) != 0 )) {
      uprv_free_76_godot(param_1);
      return;
   }
...
/* ures_loc_closeLocales(UEnumeration*) */void ures_loc_closeLocales(UEnumeration *param_1) {
   long lVar1;
...
/* WARNING: Removing unreachable block (ram,0x00100eb7) *//* WARNING: Removing unreachable block (ram,0x00100ff0) *//* getDefaultScript(icu_76_godot::CharString const&, icu_76_godot::CharString const&) */CharString *getDefaultScript(CharString *param_1, CharString *param_2) {
   int *piVar1;
   int iVar2;
   char *pcVar3;
   undefined8 *in_RDX;
   ...
   *(undefined4*)( param_1 + 0x38 ) = 0;
   ...
   if (*(int*)( in_RDX + 7 ) != 0) {
      ...
      local_50 = 0;
      local_7c = 0;
      pcVar3 = (char*)icu_76_godot::CharString::append((char*)&local_88, (int)*(undefined8*)param_2, (UErrorCode*)( ulong ) * (uint*)( param_2 + 0x38 ));
      icu_76_godot::StringPiece::StringPiece((StringPiece*)local_98, "_");
      pcVar3 = (char*)icu_76_godot::CharString::append(pcVar3, local_98[0], (UErrorCode*)(ulong)local_90);
...
;
   ...
   if (puVar5 < piVar4) {
      ...
      iVar2 = piVar1[1];
      LAB_00100fae:*(undefined4*)( param_1 + 0x38 ) = 0;
...
void ures_initStackObject_76_godot(undefined8 *param_1) {
   ...
   *param_1 = 0;
   ...
   for (uVar1 = ( ulong )(( (int)param_1 - (int)(undefined8*)( ( ulong )(param_1 + 1) & 0xfffffffffffffff8 ) ) + 0x88U >> 3); uVar1 != 0; uVar1 = uVar1 - 1) {
      *puVar2 = 0;
      puVar2 = puVar2 + 1;
   }
...
/* icu_76_godot::StackUResourceBundle::StackUResourceBundle() */void icu_76_godot::StackUResourceBundle::StackUResourceBundle(StackUResourceBundle *this) {
   ulong uVar1;
   undefined8 *puVar2;
   *(undefined8*)this = 0;
   *(undefined8*)( this + 0x80 ) = 0;
   puVar2 = (undefined8*)( ( ulong )(this + 8) & 0xfffffffffffffff8 );
   for (uVar1 = ( ulong )(( (int)this - (int)(undefined8*)( ( ulong )(this + 8) & 0xfffffffffffffff8 ) ) + 0x88U >> 3); uVar1 != 0; uVar1 = uVar1 - 1) {
      *puVar2 = 0;
      puVar2 = puVar2 + 1;
   }
...
UResourceBundle *ures_copyResb_76_godot(UResourceBundle *param_1, UResourceBundle *param_2, UErrorCode *param_3) {
   undefined8 uVar1;
   long lVar2;
   long lVar3;
   undefined8 uVar4;
   ...
   if (*(int*)( param_1 + 0x74 ) == 0x12c9b17) {
      ...
      *(undefined8*)( param_1 + 8 ) = uVar1;
      for (int i = 0; i < 7; i++) {
         uVar1 = *(undefined8*)( param_2 + ( 16*i + 24 ) );
         *(undefined8*)( param_1 + ( 16*i + 16 ) ) = *(undefined8*)( param_2 + ( 16*i + 16 ) );
      ...
      *(undefined4*)( param_1 + 0x68 ) = 0;
      if (pcVar19 != (char*)0x0) {
         LAB_00101194:ures_appendResPath(param_1, pcVar19, *(int*)( param_2 + 0x68 ), param_3);
         goto LAB_001011a2;
      }
   ...
   uVar18 = 0;
   uVar17 = 0;
   LAB_001011b5:lVar2 = *(long*)( param_1 + 8 );
...
long ures_getString_76_godot(long param_1, undefined8 param_2, int *param_3) {
   ...
   if (*param_3 < 1) {
      if (param_1 != 0) {
         lVar1 = res_getStringNoTrace_76_godot(*(long*)( param_1 + 8 ) + 0x28, *(undefined4*)( param_1 + 0x6c ), param_2);
         if (lVar1 != 0) {
            return lVar1;
         }
...
void ures_getUTF8String_76_godot(long param_1, undefined8 param_2, undefined8 param_3, char param_4, int *param_5) {
   long lVar1;
   long in_FS_OFFSET;
   undefined4 local_34;
   long local_30;
   ...
   if (( param_5 != (int*)0x0 ) && ( *param_5 < 1 )) {
      if (param_1 != 0) {
         lVar1 = res_getStringNoTrace_76_godot(*(long*)( param_1 + 8 ) + 0x28, *(undefined4*)( param_1 + 0x6c ), &local_34);
         if (lVar1 == 0) {
            *param_5 = 0x11;
         }
   ...
   lVar1 = 0;
   LAB_00101418:ures_toUTF8String(lVar1, local_34, param_2, param_3, (int)param_4, param_5);
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
long ures_getBinary_76_godot(long param_1, undefined8 param_2, int *param_3) {
   ...
   if (*param_3 < 1) {
      if (param_1 != 0) {
         lVar1 = res_getBinaryNoTrace_76_godot(*(long*)( param_1 + 8 ) + 0x28, *(undefined4*)( param_1 + 0x6c ), param_2);
         if (lVar1 != 0) {
            return lVar1;
         }
...
long ures_getIntVector_76_godot(long param_1, undefined8 param_2, int *param_3) {
   ...
   if (*param_3 < 1) {
      if (param_1 != 0) {
         lVar1 = res_getIntVectorNoTrace_76_godot(*(long*)( param_1 + 8 ) + 0x28, *(undefined4*)( param_1 + 0x6c ), param_2);
         if (lVar1 != 0) {
            return lVar1;
         }
...
/* findFirstExisting(char const*, char*, char const*, UResOpenType, signed char*, signed char*,
   signed char*, UErrorCode*) */undefined8 *findFirstExisting(char *param_1, char *param_2, char *param_3, int param_4, undefined8 param_5, char *param_6, undefined8 param_7, UErrorCode *param_8) {
   void *pvVar1;
   int *piVar2;
   int iVar3;
   int iVar4;
   ...
   *param_6 = '\x01';
   ...
   LAB_001017b0:do {
      ...
      if (0 < *(int*)param_8) {
         LAB_00101954:puVar5 = (undefined8*)0x0;
         LAB_00101924:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            return puVar5;
         }
      ...
      if (iVar3 == 0) {
         ...
         *(bool*)param_5 = iVar4 == 0;
         ...
         if (( sVar6 == 0 ) || ( param_2[sVar6 - 1] == '_' )) {
            LAB_0010188e:pcVar7 = strrchr(param_2, 0x5f);
            if (pcVar7 == (char*)0x0) {
               *param_6 = '\0';
               goto LAB_00101954;
            }
            ...
            *param_6 = '\x01';
            ...
            local_2cc = 0;
            icu_76_godot::CheckedArrayByteSink::CheckedArrayByteSink((CheckedArrayByteSink*)&local_2c8, (char*)0x0, 0);
            ulocimp_getSubtags_76_godot(param_2, (ByteSink*)0x0, (ByteSink*)0x0, (ByteSink*)0x0, (ByteSink*)&local_2c8, (char**)0x0, (UErrorCode*)&local_2cc);
            iVar4 = local_2b0;
            icu_76_godot::CheckedArrayByteSink::~CheckedArrayByteSink((CheckedArrayByteSink*)&local_2c8);
            ...
            local_220 = 0x28;
            local_1f0 = 0;
            ulocimp_getSubtags_76_godot(param_2, (CharString*)&local_2a8, (CharString*)&local_268, (CharString*)&local_228, (CharString*)0x0, (char**)0x0, (UErrorCode*)&local_2d0);
            if (local_2d0 < 1) {
               if (param_4 == 0) {
...
;
               ...
               if (local_230 == 0) {
                  ...
                  local_160 = 0x28;
                  local_130 = 0;
                  ulocimp_getSubtags_76_godot(local_e8, (CharString*)&local_1a8, (CharString*)&local_168, (CharString*)0x0, (CharString*)0x0, (char**)0x0, (UErrorCode*)&local_2cc);
                  if (local_130 == 0) {
                     pcVar7 = (char*)icu_76_godot::CharString::append((char*)&local_1e8, (int)local_2a8, (UErrorCode*)(ulong)local_270);
                     icu_76_godot::StringPiece::StringPiece((StringPiece*)&local_2c8, "_");
                     pcVar7 = (char*)icu_76_godot::CharString::append(pcVar7, (int)local_2c8, (UErrorCode*)(ulong)local_2c0);
                  ...
                  LAB_00101b20:if (( 0 < local_2d0 ) || ( local_1b0 == 0 )) goto LAB_00101b37;
                  cVar9 = '\x01';
                  ...
                  if (local_1f0 != 0) {
                     ...
                     cVar9 = local_11c;
                     pvVar1 = local_128;
                     if (( local_f0 == local_230 ) && ( ( local_f0 == 0 || ( iVar4 = memcmp(local_128, local_268, (long)(int)local_f0) ),iVar4 == 0 ) )) {
                        if (cVar9 != '\0') {
                           uprv_free_76_godot(local_128);
                        }
                        ...
                        icu_76_godot::StringPiece::StringPiece((StringPiece*)&local_2c8, "_");
                        pcVar7 = (char*)icu_76_godot::CharString::append(pcVar7, (int)local_2c8, (UErrorCode*)(ulong)local_2c0);
                        icu_76_godot::CharString::append(pcVar7, (int)local_228, (UErrorCode*)(ulong)local_1f0);
                     }
 else {
                        if (cVar9 != '\0') {
                        ...
                        icu_76_godot::StringPiece::StringPiece((StringPiece*)&local_2c8, "_");
                        pcVar7 = (char*)icu_76_godot::CharString::append(pcVar7, (int)local_2c8, (UErrorCode*)(ulong)local_2c0);
                        icu_76_godot::CharString::append(pcVar7, (int)local_268, (UErrorCode*)(ulong)local_230);
                     }
                  ...
                  if (param_4 != 0) {
                     LAB_00101b04:icu_76_godot::CharString::append((char*)&local_1e8, (int)local_2a8, (UErrorCode*)(ulong)local_270);
                     goto LAB_00101b20;
                  }
               ...
               LAB_00101aab:if ((char)local_21c == '\0') goto LAB_00101ab9;
               LAB_00101bf6:uprv_free_76_godot(local_228);
               ...
               *pcVar7 = '\0';
               ...
               LAB_00101ab9:if ((char)local_25c == '\0') goto LAB_00101ac7;
               LAB_00101c11:uprv_free_76_godot(local_268);
            }
...
/* ures_openWithType(UResourceBundle*, char const*, char const*, UResOpenType, UErrorCode*) */undefined8 *ures_openWithType(undefined8 *param_1, char *param_2, UErrorCode *param_3, int param_4, UErrorCode *param_5) {
   char cVar1;
   undefined4 uVar2;
   int iVar3;
   undefined8 uVar4;
   ...
   if (*(int*)param_5 < 1) {
      if (param_4 == 2) {
         if (( gCacheInitOnce == 2 ) || ( cVar1 = icu_76_godot::umtx_initImplPreInit((UInitOnce*)&gCacheInitOnce) ),cVar1 == '\0') {
            if (0 < DAT_00106cdc) {
         ...
         if (0 < *(int*)param_5) {
            LAB_0010253a:umtx_unlock_76_godot(resbMutex);
            iVar3 = *(int*)param_5;
            joined_r0x001027f1:if (0 < iVar3) goto LAB_00102200;
            goto LAB_0010254d;
         }
         ...
         lVar11 = puVar5[2];
         if (iVar3 == 0) {
            joined_r0x00102993:for (; lVar11 != 0; lVar11 = *(long*)( lVar11 + 0x10 )) {
               LAB_00102760:*(int*)( lVar11 + 0x6c ) = *(int*)( lVar11 + 0x6c ) + 1;
            }

            LAB_0010276d:umtx_unlock_76_godot(resbMutex);
            goto LAB_001023cc;
         }
         ...
         if (*(char*)( puVar5 + 0xc ) == '\0') {
            ...
            if (sVar7 < 0x9d) {
               ...
               if (pcVar6 == (char*)0x0) {
                  LAB_00102a12:iVar3 = strcmp((char*)*puVar5, "root");
                  if (iVar3 != 0) {
                     puVar12 = puVar5;
                  ...
                  *pcVar6 = '\0';
                  ...
                  puVar12 = local_190;
                  if (( ( ( cVar1 != '\0' ) && ( iVar3 = strcmp((char*)*local_190, "root") ),iVar3 != 0 ) ) && ( puVar12[2] == 0 )) {
                     LAB_00102a33:local_194 = 0;
                  ...
                  LAB_0010297b:if (0 < *(int*)param_5) goto LAB_0010253a;
               }
         ...
         umtx_unlock_76_godot(resbMutex);
         if (0 < *(int*)param_5) goto LAB_00102200;
         LAB_001023df:if (param_1 == (undefined8*)0x0) {
 ...
 while ( (undefined8*)*puVar12 != (undefined8*)0x0 );
            ...
            *param_1 = 0;
            ...
            for (uVar9 = ( ulong )(( (int)param_1 - (int)(undefined8*)( ( ulong )(param_1 + 1) & 0xfffffffffffffff8 ) ) + 0x88U >> 3); uVar9 != 0; uVar9 = uVar9 - 1) {
               *puVar12 = 0;
               puVar12 = puVar12 + (ulong)bVar14 * -2 + 1;
            }

            LAB_0010270b:*(undefined8*)( (long)param_1 + 0x74 ) = _LC9;
         }
      ...
      if (( gCacheInitOnce == 2 ) || ( cVar1 = icu_76_godot::umtx_initImplPreInit((UInitOnce*)&gCacheInitOnce) ),cVar1 == '\0') {
         ...
         *(int*)param_5 = DAT_00106cdc;
         ...
         DAT_00106cdc = *(int*)param_5;
         icu_76_godot::umtx_initImplPostInit((UInitOnce*)&gCacheInitOnce);
         LAB_001022a7:if (*(int*)param_5 < 1) {
            strncpy((char*)&local_e8, pcVar6, 0x9c);
            local_4c = 0;
            uVar4 = uloc_getDefault_76_godot();
            umtx_lock_76_godot(resbMutex);
            puVar5 = (undefined8*)findFirstExisting(param_2, &local_e8, uVar4, param_4, &local_19a, &local_199, &local_19b, &local_198);
            if (local_198 == 7) {
               LAB_001026b0:*(undefined4*)param_5 = 7;
               goto LAB_001026b6;
            }
            ...
            if (puVar5 == (undefined8*)0x0) {
               if (( param_4 != 1 ) && ( local_19b == '\0' && local_19a == '\0' )) {
                  ...
                  puVar5 = (undefined8*)findFirstExisting(param_2, &local_e8, uVar4, 0, &local_19a, &local_199, &local_19b, &local_198);
            ...
            joined_r0x00102607:local_190 = puVar5;
            if (( local_199 == '\0' ) && ( ( puVar12 = puVar5 ),cVar1 = local_19a,(char)local_e8 == '\0' || ( pcVar6 = strstr("nb nn", (char*)&local_e8) ),puVar12 = local_190,cVar1 = local_19a,pcVar6 == (char*)0x0 )) {
               joined_r0x00102391:local_190 = puVar12;
               if (cVar1 != '\0') goto LAB_001023a0;
               iVar3 = strcmp((char*)*puVar12, "root");
               if (( ( iVar3 == 0 ) || ( puVar12[2] != 0 ) ) || ( *(char*)( puVar5 + 0xc ) != '\0' )) {
                  LAB_0010266f:if (local_19a == '\0') {
...
;
               ...
               LAB_001026b6:puVar5 = (undefined8*)0x0;
            }
 else {
               if (local_19a == '\0') {
               ...
               LAB_001023a0:if (0 < *(int*)param_5) goto LAB_001026b6;
               if (local_198 != 0) {
      ...
      if (( local_17c != '\0' ) && ( uprv_free_76_godot(local_188),*(int*)param_5 < 1 )) {
         LAB_0010254d:*(undefined4*)param_5 = 2;
      }

   }

   LAB_00102200:param_1 = (undefined8*)0x0;
...
/* (anonymous namespace)::getAliasTargetAsResourceBundle(ResourceData const&, unsigned int, char
   const*, int, UResourceDataEntry*, char const*, int, UResourceBundle*, UErrorCode*) */UResourceBundle * (anonymous_namespace)::getAliasTargetAsResourceBundle(ResourceData * param_1, uint, param_2, char, *param_3, int, param_4, UResourceDataEntry * param_5, char, *param_6, int, param_7, UResourceBundle * param_8, UErrorCode * param_9) * pcVar4 ;size_t sVar5char *pcVar6char *pcVar7undefined4 in_register_00000034UResourceBundle *pUVar8UResourceDataEntry *pUVar9long in_FS_OFFSETbool bVar10StringPiece *local_108UResourceBundle *local_f8uint local_e4char *local_e0undefined8 local_d8uint local_d0char *local_c8undefined4 local_c0undefined2 local_bcundefined4 local_90char *local_88undefined4 local_80undefined2 local_7cundefined4 local_50long local_40local_40 = *(long*)( in_FS_OFFSET + 0x28 );if (0 < *(int*)param_9) goto LAB_00102b4c;local_e4 = 0;iVar1 = res_getAlias_76_godot(param_1, CONCAT44(in_register_00000034, param_2), &local_e4);if ((int)local_e4 < 1) {
   *(undefined4*)param_9 = 1;
   goto LAB_00102b4c;
}
local_c0 = 0x28;local_c8 = (char*)( (long)&local_bc + 1 );local_bc = 0;local_90 = 0;icu_76_godot::CharString::appendInvariantChars((wchar16*)&local_c8, iVar1, (UErrorCode*)(ulong)local_e4);pcVar6 = local_c8;pUVar8 = (UResourceBundle*)0x0;if (*(int*)param_9 < 1) {
   if (*local_c8 == '/') {
      ...
      *pcVar6 = '\0';
      ...
      local_f8 = (UResourceBundle*)0x0;
      pUVar9 = param_5;
      LAB_00102d1c:local_108 = (StringPiece*)&local_d8;
      local_e0 = (char*)0x0;
      ...
      local_50 = 0;
      local_7c = 0;
      icu_76_godot::CharString::append((char*)&local_88, (int)local_d8, (UErrorCode*)(ulong)local_d0);
      iVar1 = *(int*)param_9;
      if (iVar1 < 1) {
         pcVar4 = (char*)0x0;
         local_d8 = local_88;
         do {
            ...
            if (*local_d8 != '\0') {
               ...
               do {
                  ...
                  param_8 = (UResourceBundle*)init_resb_result(pUVar9, uVar3, local_e0, -1, param_5, pcVar4, param_7 + 1, param_8, param_9);
                  iVar1 = *(int*)param_9;
                  if (0 < iVar1) goto LAB_001030d8;
                  if (( local_e0 == (char*)0x0 ) || ( iVar2 = iVar2 != 0 )) {
                     if (( *(UResourceBundle**)( param_8 + 0x20 ) != (UResourceBundle*)0x0 ) && ( *(UResourceBundle**)( param_8 + 0x20 ) != param_8 + 0x28 )) {
                        uprv_free_76_godot();
                     }
 ...
 while ( *local_d8 != '\0' );
            ...
            bVar10 = iVar2 != -1;
            LAB_00102ec4:if (( 0 < iVar1 ) || ( bVar10 )) goto LAB_001030d8;
 ...
 while ( true );
      ...
      LAB_00102cc2:param_8 = (UResourceBundle*)0x0;
   }
 else {
      ...
      LAB_00102c1f:local_d8 = (char*)( (ulong)local_d8._4_4_ << 0x20 );
      ...
      if ((int)local_d8 < 1) {
         ...
         LAB_00102c72:local_e0 = (char*)0x0;
         uVar3 = *(uint*)( pUVar9 + 0x48 );
         if (param_6 != (char*)0x0) {
            local_90 = 0;
            *local_c8 = '\0';
            icu_76_godot::StringPiece::StringPiece((StringPiece*)&local_d8, param_6);
            icu_76_godot::CharString::append((char*)&local_c8, (int)local_d8, (UErrorCode*)(ulong)local_d0);
         ...
         if (uVar3 == 0xffffffff) {
            *(undefined4*)param_9 = 2;
            ...
            param_8 = (UResourceBundle*)init_resb_result(pUVar9, uVar3, local_e0, -1, param_5, (char*)0x0, param_7 + 1, param_8, param_9);
         }
...
goto LAB_00102cdf;LAB_001030cb:*(undefined4*)param_9 = 2;LAB_001030d8:if ((char)local_7c != '\0') {
   uprv_free_76_godot(local_88);
}
LAB_001030a9:pUVar8 = param_8;if (param_8 != local_f8) {
   LAB_00102cc8:pUVar8 = param_8;
   if (local_f8 != (UResourceBundle*)0x0) {
      ures_closeBundle(local_f8, 1);
   }

}
LAB_00102cdf:param_8 = pUVar8;if ((char)local_bc != '\0') {
   uprv_free_76_godot(local_c8);
}
LAB_00102b4c:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return param_8;}/* (anonymous namespace)::init_resb_result(UResourceDataEntry*, unsigned int, char const*, int,
   UResourceDataEntry*, char const*, int, UResourceBundle*, UErrorCode*) */UResourceBundle * (anonymous_namespace)::init_resb_result(UResourceDataEntry * param_1, uint, param_2, char, *param_3, int, param_4, UResourceDataEntry * param_5, char, *param_6, int, param_7, UResourceBundle * param_8, UErrorCode * param_9) * plVar1 ;undefined8 uVar2undefined4 uVar3int iVar4long lVar5size_t sVar6UResourceBundle *pUVar7UResourceBundle *__slong in_FS_OFFSETchar local_148[264]long local_40local_40 = *(long*)( in_FS_OFFSET + 0x28 );if (( param_9 != (UErrorCode*)0x0 ) && ( *(int*)param_9 < 1 )) {
   if (param_5 == (UResourceDataEntry*)0x0) {
      uVar3 = 1;
      LAB_00103505:*(undefined4*)param_9 = uVar3;
      param_8 = (UResourceBundle*)0x0;
   }
 else if (param_2 >> 0x1c == 3) {
      if (param_7 < 0x100) {
         if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            pUVar7 = (UResourceBundle*)getAliasTargetAsResourceBundle((ResourceData*)( param_1 + 0x28 ), param_2, param_3, param_4, param_5, param_6, param_7, param_8, param_9);
            return pUVar7;
         }
 ...
 while ( *plVar1 != 0 );
      ...
      *(UResourceDataEntry**)( param_8 + 0x18 ) = param_5;
      ...
      if (param_3 == (char*)0x0) {
         ...
         LAB_001033a2:pUVar7 = *(UResourceBundle**)( param_8 + 0x20 );
      }
 else {
         sVar6 = strlen(param_3);
         iVar4 = (int)sVar6;
         LAB_00103371:ures_appendResPath(param_8, param_3, iVar4, param_9);
         pUVar7 = *(UResourceBundle**)( param_8 + 0x20 );
...
LAB_00103510:/* WARNING: Subroutine does not return */__stack_chk_fail();}UResourceBundle *ures_getNextResource_76_godot(long param_1, UResourceBundle *param_2, UErrorCode *param_3) {
   uint uVar1;
   ulong uVar2;
   int iVar3;
   long in_FS_OFFSET;
         ...
         *(int*)( param_1 + 0x7c ) = iVar3;
         ...
         if (( uVar2 & 0x40c3 ) == 0) {
            if (( uVar2 & 0x34 ) == 0) {
               ...
               uVar1 = res_getTableItemByIndex_76_godot(*(long*)( param_1 + 8 ) + 0x28, *(undefined4*)( param_1 + 0x6c ), iVar3, &local_28);
            }

            param_2 = (UResourceBundle*)(anonymous_namespace)::init_resb_result(*(UResourceDataEntry**)( param_1 + 8 ), uVar1, local_28, *(int*)( param_1 + 0x7c ), *(UResourceDataEntry**)( param_1 + 0x18 ), *(char**)( param_1 + 0x20 ), 0, param_2, param_3);
         }
 else {
   ...
   LAB_001035f3:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
char *ures_loc_nextLocale(long param_1, undefined4 *param_2) {
   ...
   uVar2 = 0;
   __s = (char*)0x0;
   LAB_0010369c:if (param_2 != (undefined4*)0x0) {
      *param_2 = uVar2;
   }

   return __s;
}
UResourceBundle *ures_getByIndex_76_godot(long param_1, int param_2, UResourceBundle *param_3, UErrorCode *param_4) {
   undefined4 uVar1;
   uint uVar2;
   ulong uVar3;
   long in_FS_OFFSET;
         ...
         *(undefined4*)param_4 = 2;
         ...
         if (( uVar3 & 0x40c3 ) == 0) {
            if (( uVar3 & 0x34 ) == 0) {
               ...
               uVar2 = res_getTableItemByIndex_76_godot(*(long*)( param_1 + 8 ) + 0x28, uVar1, param_2, &local_38);
            }

            param_3 = (UResourceBundle*)(anonymous_namespace)::init_resb_result(*(UResourceDataEntry**)( param_1 + 8 ), uVar2, local_38, param_2, *(UResourceDataEntry**)( param_1 + 0x18 ), *(char**)( param_1 + 0x20 ), 0, param_3, param_4);
         }
 else {
   ...
   LAB_00103770:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* ures_getStringWithAlias(UResourceBundle const*, unsigned int, int, int*, UErrorCode*) */long ures_getStringWithAlias(UResourceBundle *param_1, uint param_2, int param_3, int *param_4, UErrorCode *param_5) {
   long lVar1;
   long lVar2;
   undefined4 in_register_00000034;
   if (param_2 >> 0x1c != 3) {
      lVar1 = res_getStringNoTrace_76_godot(*(long*)( param_1 + 8 ) + 0x28, CONCAT44(in_register_00000034, param_2), param_4);
      return lVar1;
   }
   ...
   if (( param_5 != (UErrorCode*)0x0 ) && ( *(int*)param_5 < 1 )) {
      if (lVar1 != 0) {
         lVar2 = res_getStringNoTrace_76_godot(*(long*)( lVar1 + 8 ) + 0x28, *(undefined4*)( lVar1 + 0x6c ), param_4);
         if (lVar2 == 0) {
   ...
   lVar2 = 0;
   LAB_00103860:ures_closeBundle(lVar1, 1);
   return lVar2;
}
undefined8 ures_getNextString_76_godot(long param_1, undefined8 param_2, undefined8 param_3, int *param_4) {
   undefined8 uVar1;
   int iVar2;
   if (param_4 == (int*)0x0) {
      return 0;
      ...
      if (param_1 == 0) {
         ...
         *(int*)( param_1 + 0x7c ) = iVar2;
         if (*(uint*)( param_1 + 0x6c ) < 0xf0000000) {
            ...
            uVar1 = ( *(code*)( &DAT_001071c0 + *(int*)( &DAT_001071c0 + ( ulong )(*(uint*)( param_1 + 0x6c ) >> 0x1c) * 4 ) ) )(&DAT_001071c0, param_3, iVar2, &DAT_001071c0 + *(int*)( &DAT_001071c0 + ( ulong )(*(uint*)( param_1 + 0x6c ) >> 0x1c) * 4 ));
            return uVar1;
         }
      ...
      if (param_1 == 0) {
         ...
         *param_4 = 2;
         ...
         if (*(uint*)( param_1 + 0x6c ) < 0xf0000000) {
            ...
            /* WARNING: Treating indirect jump as call */
            uVar2 = ( *(code*)( &DAT_001071fc + *(int*)( &DAT_001071fc + ( ulong )(*(uint*)( param_1 + 0x6c ) >> 0x1c) * 4 ) ) )();
            return uVar2;
         }
...
void ures_getUTF8StringByIndex_76_godot(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, char param_5, undefined8 param_6) {
   undefined8 uVar1;
   long in_FS_OFFSET;
   undefined4 local_34;
   long local_30;
...
UResourceBundle *ures_findSubResource_76_godot(UResourceBundle *param_1, char *param_2, UResourceBundle *param_3, UErrorCode *param_4) {
   uint uVar1;
   UResourceBundle *pUVar2;
   long in_FS_OFFSET;
   char *local_50;
   ...
   if (( param_4 != (UErrorCode*)0x0 ) && ( *(int*)param_4 < 1 )) {
      do {
         uVar1 = res_findResource_76_godot(*(long*)( param_1 + 8 ) + 0x28, *(undefined4*)( param_1 + 0x6c ), &local_50, &local_48);
         if (uVar1 == 0xffffffff) {
            *(undefined4*)param_4 = 2;
            break;
         }

         param_1 = (UResourceBundle*)(anonymous_namespace)::init_resb_result(*(UResourceDataEntry**)( param_1 + 8 ), uVar1, local_48, -1, *(UResourceDataEntry**)( param_1 + 0x18 ), *(char**)( param_1 + 0x20 ), 0, param_3, param_4);
         pUVar2 = param_1;
      }
 while ( *local_50 != '\0' );
   }
...
UResourceBundle *ures_getByKeyWithFallback_76_godot(long param_1, char *param_2, UResourceBundle *param_3, UErrorCode *param_4) {
   int iVar1;
   char *pcVar2;
   long lVar3;
   ...
   if (( 0x34UL >> uVar14 & 1 ) == 0) {
      *(undefined4*)param_4 = 0x11;
      ...
      LAB_0010417c:ures_closeBundle(local_f0, 1);
      LAB_00103e18:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return param_3;
      }
   ...
   if ((int)local_a8 < 1) {
      if (*local_88 == '\0') {
         if ((char)local_7c != '\0') {
            LAB_0010423b:uprv_free_76_godot(local_88);
            LAB_001041be:if (uVar6 == 0xffffffff) goto LAB_00103e70;
         }

         local_a8 = param_2;
         param_3 = (UResourceBundle*)(anonymous_namespace)::init_resb_result(*(UResourceDataEntry**)( param_1 + 8 ), uVar6, param_2, -1, *(UResourceDataEntry**)( param_1 + 0x18 ), *(char**)( param_1 + 0x20 ), 0, param_3, param_4);
         local_f0 = (UResourceBundle*)0x0;
         goto LAB_0010417c;
      }
 ...
 while ( uVar6 != 0xffffffff );
   ...
   LAB_00103e70:local_d8 = *(char**)( param_1 + 0x20 );
   ...
   LAB_00103ee0:do {
      ...
      if (iVar7 == 0) {
         ...
         if (*(int*)param_4 < 1) {
            local_a0 = local_88;
            local_a8 = param_2;
            LAB_00103f83:uVar6 = res_findResource_76_godot(pUVar12 + 0x28, uVar15, &local_a0, &local_a8);
            if (uVar6 >> 0x1c == 3) {
               if (( *local_a0 != '\0' ) && ( local_f0 = (UResourceBundle*)(anonymous_namespace)::init_resb_result(pUVar12, uVar6, (char*)0x0, -1, *(UResourceDataEntry**)( param_1 + 0x18 ), *(char**)( param_1 + 0x20 ), 0, local_f0, param_4) ),local_f0 != (UResourceBundle*)0x0) {
 ...
 while ( true );
   *(undefined4*)param_4 = 2;
   LAB_0010421c:if ((char)local_7c != '\0') {
      uprv_free_76_godot(local_88);
   }

   goto LAB_0010417c;
   LAB_00103f79:if (*local_a0 != '\0') goto LAB_00103f83;
   LAB_00103fad:pcVar10 = (char*)uloc_getDefault_76_godot();
   ...
   *(int*)param_4 = iVar8;
   param_3 = (UResourceBundle*)(anonymous_namespace)::init_resb_result(pUVar12, uVar6, local_a8, -1, *(UResourceDataEntry**)( param_1 + 0x18 ), *(char**)( param_1 + 0x20 ), 0, param_3, param_4);
   ...
   createPath(pcVar2, iVar1, local_d8, iVar9, param_2, (CharString*)&local_88, param_4);
   LAB_00104088:if (( *(UResourceBundle**)( param_3 + 0x20 ) != (UResourceBundle*)0x0 ) && ( *(UResourceBundle**)( param_3 + 0x20 ) != param_3 + 0x28 )) {
      uprv_free_76_godot();
   }
...
short *ures_getStringByKeyWithFallback_76_godot(undefined8 param_1, undefined8 param_2, int *param_3, int *param_4) {
   short *psVar1;
   long lVar2;
   long *plVar3;
   long in_FS_OFFSET;
...
void ures_getValueWithFallback_76_godot(long param_1, char *param_2, undefined8 param_3, long param_4, int *param_5) {
   undefined8 uVar1;
   if (0 < *param_5) {
      return;
   }
...
/* (anonymous namespace)::getAllItemsWithFallback(UResourceBundle const*,
   icu_76_godot::ResourceDataValue&, icu_76_godot::ResourceSink&, UErrorCode&) */void (anonymous_namespace)::getAllItemsWithFallback(UResourceBundle *param_1, ResourceDataValue *param_2, ResourceSink *param_3, UErrorCode *param_4) {
   undefined8 uVar1;
   int iVar2;
      ...
      *(undefined4*)( param_2 + 0x18 ) = *(undefined4*)( param_1 + 0x6c );
      ...
      if (iVar2 < 1) {
         ...
         *(int*)( lVar6 + 0x6c ) = *(int*)( lVar6 + 0x6c ) + 1;
         ...
         pUVar4 = local_158;
         if (( ( pcVar3 == (char*)0x0 ) || ( *pcVar3 == '\0' ) ) || ( pUVar4 = (UResourceBundle*)ures_getByKeyWithFallback_76_godot(local_158, pcVar3, local_c8, &local_15c) ),local_15c < 1) {
   ...
   LAB_00104718:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
void ures_getAllItemsWithFallback_76_godot(UResourceBundle *param_1, char *param_2, ResourceSink *param_3, UErrorCode *param_4) {
   char cVar1;
   long lVar2;
   undefined8 *puVar3;
   long in_FS_OFFSET;
   ...
   if (*(int*)param_4 < 1) {
      if (param_2 == (char*)0x0) {
         *(undefined4*)param_4 = 1;
         ...
         if (( cVar1 == '\0' ) || ( param_1 = (UResourceBundle*)ures_getByKeyWithFallback_76_godot(param_1, param_2, local_b8, param_4) * (int*)param_4 < 1 )) {
            local_d8 = u_versionFromString_76_godot;
            local_d0 = 0;
            local_c8 = 0;
            local_c0 = 0xffffffff;
            (anonymous_namespace)::getAllItemsWithFallback(param_1, (ResourceDataValue*)&local_d8, param_3, param_4);
...
void ures_getAllChildrenWithFallback_76_godot(undefined8 param_1, undefined8 param_2, undefined8 param_3) {
   long in_FS_OFFSET;
   undefined **local_38;
   undefined8 local_30;
   long local_20;
...
UResourceBundle *ures_getByKey_76_godot(UResourceBundle *param_1, char *param_2, UResourceBundle *param_3, UErrorCode *param_4) {
   UResourceDataEntry *pUVar1;
   long in_FS_OFFSET;
   uint local_40;
   ...
   if (( param_4 != (UErrorCode*)0x0 ) && ( *(int*)param_4 < 1 )) {
      if (param_1 == (UResourceBundle*)0x0) {
         ...
         *(undefined4*)param_4 = 0x11;
         ...
         local_40 = res_getTableItemByKey_76_godot(*(long*)( param_1 + 8 ) + 0x28, *(uint*)( param_1 + 0x6c ), local_3c, &local_38);
         if (local_40 == 0xffffffff) {
            local_38 = param_2;
            if (( param_1[0x70] == (UResourceBundle)0x0 ) || ( pUVar1 = (UResourceDataEntry*)getFallbackData(param_1, &local_38, &local_40, param_4) ),0 < *(int*)param_4) {
               *(undefined4*)param_4 = 2;
            }
 else {
               param_3 = (UResourceBundle*)(anonymous_namespace)::init_resb_result(pUVar1, local_40, local_38, -1, *(UResourceDataEntry**)( param_1 + 0x18 ), *(char**)( param_1 + 0x20 ), 0, param_3, param_4);
            }

         }
 else {
            param_3 = (UResourceBundle*)(anonymous_namespace)::init_resb_result(*(UResourceDataEntry**)( param_1 + 8 ), local_40, local_38, -1, *(UResourceDataEntry**)( param_1 + 0x18 ), *(char**)( param_1 + 0x20 ), 0, param_3, param_4);
         }
...
/* WARNING: Type propagation algorithm not settling */long ures_getStringByKey_76_godot(UResourceBundle *param_1, char *param_2, undefined8 param_3, UErrorCode *param_4) {
   long lVar1;
   long lVar2;
   long in_FS_OFFSET;
   uint local_40[2];
   ...
   if (( param_4 != (UErrorCode*)0x0 ) && ( *(int*)param_4 < 1 )) {
      if (param_1 == (UResourceBundle*)0x0) {
         ...
         *(undefined4*)param_4 = 0x11;
         ...
         local_40[1] = 0;
         local_40[0] = res_getTableItemByKey_76_godot(*(long*)( param_1 + 8 ) + 0x28, *(uint*)( param_1 + 0x6c ), local_40 + 1, &local_38);
         if (local_40[0] == 0xffffffff) {
            local_38 = param_2;
            if (( param_1[0x70] != (UResourceBundle)0x0 ) && ( lVar2 = getFallbackData(param_1, &local_38, local_40, param_4) * (int*)param_4 < 1 )) {
            ...
            *(undefined4*)param_4 = 2;
            ...
            if (local_40[0] >> 0x1c == 3) {
               LAB_00104b40:lVar1 = ures_getByKey_76_godot(param_1, param_2, 0, param_4);
               if (*(int*)param_4 < 1) {
                  if (lVar1 == 0) {
                     *(undefined4*)param_4 = 1;
                     goto LAB_00104c16;
                  ...
                  lVar2 = res_getStringNoTrace_76_godot(*(long*)( lVar1 + 8 ) + 0x28, *(undefined4*)( lVar1 + 0x6c ), param_3);
                  if (lVar2 == 0) {
                     *(undefined4*)param_4 = 0x11;
                  }
            ...
            LAB_00104ab6:*(undefined4*)param_4 = 0x11;
         }
   ...
   lVar2 = 0;
   LAB_00104ac8:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
void ures_getUTF8StringByKey_76_godot(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, char param_5, undefined8 param_6) {
   undefined8 uVar1;
   long in_FS_OFFSET;
   undefined4 local_34;
   long local_30;
...
undefined2 *ures_getVersionNumberInternal_76_godot(long param_1) {
   ...
   LAB_00104cd1:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return puVar2;
   }
...
void ures_getVersionByKey_76_godot(undefined8 param_1, undefined8 param_2, undefined8 param_3, int *param_4) {
   undefined8 uVar1;
   long in_FS_OFFSET;
...
undefined4 ures_countArrayItems_76_godot(long param_1, undefined8 param_2, int *param_3) {
   ...
   uVar1 = 0;
   LAB_00104eb2:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar1;
   }
...
/* getParentForFunctionalEquivalent(char const*, UResourceBundle*, UResourceBundle*,
   icu_76_godot::CharString&) */void getParentForFunctionalEquivalent(char *param_1, UResourceBundle *param_2, UResourceBundle *param_3, CharString *param_4) {
   long lVar1;
   long in_FS_OFFSET;
   int local_80;
   uint local_7c;
   ...
   **(undefined1**)param_4 = 0;
   if (param_2 == (UResourceBundle*)0x0) {
      LAB_00104fdc:if (( local_80 < 1 ) && ( *(int*)( param_4 + 0x38 ) != 0 )) goto LAB_00104f8d;
   }
 else {
      ures_getByKey_76_godot(param_2, "%%Parent", param_3, &local_80);
      if (local_80 < 1) {
         lVar1 = res_getStringNoTrace_76_godot(*(long*)( param_3 + 8 ) + 0x28, *(undefined4*)( param_3 + 0x6c ), &local_7c);
         if (lVar1 == 0) {
            local_80 = 0x11;
         }

         icu_76_godot::CharString::appendInvariantChars((wchar16*)param_4, (int)lVar1, (UErrorCode*)(ulong)local_7c);
         goto LAB_00104fdc;
      }
   ...
   LAB_00104f8d:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* (anonymous namespace)::GetAllChildrenSink::put(char const*, icu_76_godot::ResourceValue&, signed
   char, UErrorCode&) */void GetAllChildrenSink::put(GetAllChildrenSink *this, undefined8 param_1, long *param_2, char param_4, UErrorCode *param_5) {
   UResourceDataEntry *pUVar1;
   undefined8 uVar2;
   char cVar3;
   int iVar4;
   ...
   if (*(int*)param_5 < 1) {
      uVar10 = 0;
      while (cVar3 = icu_76_godot::ResourceTable::getKeyAndValue((int)local_178, (char**)(ulong)uVar10, (ResourceValue*)&local_1c0),cVar3 != '\0') {
         ...
         if (iVar4 == 3) {
            ...
            lVar7 = getAliasTargetAsResourceBundle((ResourceData*)param_2[1], uVar5, (char*)0x0, -1, pUVar1, (char*)0x0, 0, local_c8, param_5);
            if (*(int*)param_5 < 1) {
               ...
               if (iVar4 == 2) {
                  ...
                  local_140 = 0x28;
                  local_110 = 0;
                  icu_76_godot::StringPiece::StringPiece((StringPiece*)&local_1a8, *(char**)( lVar7 + 0x20 ));
                  icu_76_godot::CharString::append((char*)&local_148, (int)local_1a8, (UErrorCode*)(ulong)local_1a0);
                  uVar2 = local_1c0;
                  ( **(code**)( **(long**)( this + 8 ) + 0x18 ) )(*(long**)( this + 8 ), local_1c0, (ResourceDataValue*)&local_198, iVar9, param_5);
                  lVar7 = *(long*)( lVar7 + 8 );
                  if (*(long*)( lVar7 + 0x10 ) != 0) {
                     do {
                        ...
                        icu_76_godot::CharString::copyFrom((CharString*)&local_108, (UErrorCode*)&local_148);
                        lVar7 = *(long*)( lVar7 + 0x10 );
                        local_1b8 = local_108;
                        uVar5 = res_findResource_76_godot((ResourceData*)( lVar7 + 0x28 ), *(undefined4*)( lVar7 + 0x48 ), &local_1b8, local_1b0);
                        if (uVar5 != 0xffffffff) {
                           local_190 = (ResourceData*)( lVar7 + 0x28 );
                           local_180 = uVar5;
                           iVar4 = icu_76_godot::ResourceDataValue::getType();
                           if (iVar4 == 3) {
                              lVar6 = getAliasTargetAsResourceBundle(local_190, local_180, (char*)0x0, -1, local_188, (char*)0x0, 0, local_c8, param_5);
                              local_110 = 0;
                              *local_148 = 0;
                              icu_76_godot::StringPiece::StringPiece((StringPiece*)&local_1a8, *(char**)( lVar6 + 0x20 ));
                              icu_76_godot::CharString::append((char*)&local_148, (int)local_1a8, (UErrorCode*)(ulong)local_1a0);
                              lVar7 = *(long*)( lVar6 + 8 );
                           ...
                           ( **(code**)( **(long**)( this + 8 ) + 0x18 ) )(*(long**)( this + 8 ), uVar2, (ResourceDataValue*)&local_198, iVar9, param_5);
                        }
 ...
 while ( *(long*)( lVar7 + 0x10 ) != 0 );
            ...
            ( **(code**)( **(long**)( this + 8 ) + 0x18 ) )(*(long**)( this + 8 ), local_1c0, param_2, (int)param_4, param_5);
            iVar4 = *(int*)param_5;
         }
...
;
   ...
   LAB_00105140:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
   ...
   if (pcVar3 == (char*)0x0) {
      ...
      *pcVar3 = '\0';
      ...
      if (*param_3 < 1) {
         ...
         LAB_00105606:ures_closeBundle(uVar4, 1);
   ...
   if (*param_2 < 1) {
      ...
      if (( puVar6 != (undefined8*)0x0 ) && ( puVar5 != (undefined8*)0x0 )) {
         ...
         *puVar5 = 0;
         ...
         for (uVar8 = ( ulong )(( (int)puVar5 - (int)(undefined8*)( ( ulong )(puVar5 + 1) & 0xfffffffffffffff8 ) ) + 0x88U >> 3); uVar8 != 0; uVar8 = uVar8 - 1) {
            *puVar9 = 0;
            puVar9 = puVar9 + (ulong)bVar10 * -2 + 1;
         }
         ...
         for (uVar8 = ( ulong )(( (int)puVar5 - (int)(undefined8*)( ( ulong )(puVar5 + 0x12) & 0xfffffffffffffff8 ) ) + 0x110U >> 3); uVar8 != 0; uVar8 = uVar8 - 1) {
            *puVar9 = 0;
            puVar9 = puVar9 + (ulong)bVar10 * -2 + 1;
         }
...
undefined4 ures_getFunctionalEquivalent_76_godot(undefined1 *param_1, undefined4 param_2, undefined8 param_3, char *param_4, char *param_5, UErrorCode *param_6, undefined1 *param_7, char param_8, int *param_9) {
   UErrorCode *pUVar1;
   undefined1 *puVar2;
   undefined1 uVar3;
   int iVar4;
   ...
   if (( param_5 != (char*)0x0 ) && ( *param_5 != '\0' )) {
      ...
      puVar2 = local_258;
      if (( local_3a0 == local_220 ) && ( ( local_220 == 0 || ( iVar4 = memcmp(local_258, (void*)CONCAT44(uStack_3a4, local_3a8), (long)(int)local_220) ),iVar4 == 0 ) )) {
         local_220 = 0;
         *puVar2 = 0;
      }
   ...
   if (local_3cc < 1) {
      while (true) {
         ...
         if (local_3cc + 0x80U < 2) {
            ...
            if (( ( ( local_3cc == 0 ) && ( ures_getByKey_76_godot(pUVar8, param_4, local_158),local_3cc == 0 ) ) && ( iVar4 = ures_getStringByKey_76_godot(local_158, "default", &local_3a8) ),local_3cc < 1 )) {
               local_360 = 0;
               *local_398 = 0;
               icu_76_godot::CharString::appendInvariantChars((wchar16*)&local_398, iVar4, (UErrorCode*)(ulong)local_3a8);
               icu_76_godot::CharString::copyFrom((CharString*)&local_358, (UErrorCode*)&local_2d8);
               if (local_220 == 0) {
                  icu_76_godot::CharString::append((char*)&local_258, (int)local_398, (UErrorCode*)(ulong)local_360);
               }
         ...
         if (pUVar8 != (UResourceBundle*)0x0) {
            local_2e0 = 0;
            *local_318 = '\0';
            icu_76_godot::StringPiece::StringPiece((StringPiece*)&local_3a8, (char*)**(undefined8**)( pUVar8 + 0x18 ));
            icu_76_godot::CharString::append((char*)&local_318, local_3a8, (UErrorCode*)(ulong)local_3a0);
         }

         pcVar10 = local_318;
         if (( local_2e0 == local_2a0 ) && ( ( local_2e0 == 0 || ( iVar4 = memcmp(local_318, local_2d8, (long)(int)local_2e0) ),iVar4 == 0 ) )) {
         ...
         if (local_2e0 == local_3a0) {
            if (( local_2e0 == 0 ) || ( iVar4 = memcmp(local_318, (void*)CONCAT44(uStack_3a4, local_3a8), (long)(int)local_2e0) ),iVar4 == 0) break;
            iVar4 = *param_9;
         }
 else {
            iVar4 = *param_9;
...
;
      ...
      do {
         pUVar8 = (UResourceBundle*)ures_openWithType(0, param_3, local_2d8, 0, &local_3cc);
         if (local_3cc < 1) {
            if (( ( local_3cc == 0 ) && ( ures_getByKey_76_godot(pUVar8, param_4, local_158, &local_3cc),local_3cc == 0 ) ) && ( ures_getByKey_76_godot(local_158, local_258, (CharString*)&local_c8, &local_3cc),local_3cc == 0 )) {
               if (local_2a0 == 0) {
                  local_260 = 0;
                  *local_298 = 0;
                  icu_76_godot::StringPiece::StringPiece((StringPiece*)&local_3a8, "root");
                  icu_76_godot::CharString::append((char*)&local_298, local_3a8, (UErrorCode*)(ulong)local_3a0);
               }
 else {
               ...
               if (( ( local_260 < local_320 ) && ( iVar4 = ures_getStringByKey_76_godot(local_158, "default", &local_3a8, &local_3cc) ),local_3cc < 1 )) {
                  local_360 = 0;
                  *local_398 = 0;
                  icu_76_godot::CharString::appendInvariantChars((wchar16*)&local_398, iVar4, (UErrorCode*)(ulong)local_3a8);
         ...
         local_3cc = 0;
         if (( ( pUVar8 == (UResourceBundle*)0x0 ) || ( iVar4 = iVar4 != 0 ) ) || ( ( pUVar1 = (UErrorCode*)**(undefined8**)( pUVar8 + 0x18 ) ),pUVar1 == (UErrorCode*)0x0 || ( ( *pUVar1 == (UErrorCode)0x0 || ( iVar4 = strcmp((char*)pUVar1, "root") ),iVar4 == 0 ) ) )) {
            LAB_00105c48:icu_76_godot::CharString::copyFrom((CharString*)&local_318, (UErrorCode*)&local_2d8);
         }
 else {
            ulocimp_getLanguage_76_godot((char*)&local_1d8, pUVar1);
            ulocimp_getLanguage_76_godot((char*)&local_198, local_2d8);
            if (( 0 < local_3cc ) || ( ( local_1a0 == local_160 && ( ( local_1a0 == 0 || ( iVar4 = memcmp(local_1d8, local_198, (long)local_1a0) ),iVar4 == 0 ) ) ) )) {
               if (local_18c != '\0') {
 ...
 while ( ( local_2e0 != 0 ) && ( *param_9 < 1 ) );
      if (local_220 == local_360) {
         ...
         LAB_00105e40:if (*param_9 < 1) {
            if (local_260 == 0) {
               LAB_001064c0:*param_9 = 2;
               icu_76_godot::CharString::copyFrom((CharString*)&local_318, (UErrorCode*)&local_298);
               if (local_220 == 0) {
                  if (param_8 == '\0') {
                     LAB_001064f5:icu_76_godot::StringPiece::StringPiece((StringPiece*)&local_3c8, "@");
                     pcVar10 = (char*)icu_76_godot::CharString::append((char*)&local_318, (int)local_3c8, (UErrorCode*)(ulong)local_3c0);
                     icu_76_godot::StringPiece::StringPiece((StringPiece*)&local_3b8, param_5);
                     pcVar10 = (char*)icu_76_godot::CharString::append(pcVar10, (int)local_3b8, (UErrorCode*)(ulong)local_3b0);
                     icu_76_godot::StringPiece::StringPiece((StringPiece*)&local_3a8, "=");
                     pcVar10 = (char*)icu_76_godot::CharString::append(pcVar10, local_3a8, (UErrorCode*)(ulong)local_3a0);
                     icu_76_godot::CharString::append(pcVar10, (int)local_398, (UErrorCode*)(ulong)local_360);
                  }
               ...
               LAB_00105e60:puVar2 = local_258;
               if (param_8 == '\0') {
                  icu_76_godot::CharString::copyFrom((CharString*)&local_318, (UErrorCode*)&local_298);
                  if (local_220 == 0) goto LAB_001064f5;
               }
 else {
                  if (( ( local_320 <= local_260 ) && ( local_220 == local_360 ) ) && ( ( local_220 == 0 || ( iVar4 = memcmp(local_258, local_398, (long)(int)local_220) ),iVar4 == 0 ) )) {
                     local_220 = 0;
                     *puVar2 = 0;
                  }
 ...
 while ( *param_9 < 1 );
      ...
      LAB_00105da0:ures_closeBundle(local_158, 1);
      ures_closeBundle((CharString*)&local_c8, 1);
      uVar12 = local_2e0;
      if (*param_9 < 1) {
         uVar6 = uprv_min_76_godot(local_2e0, param_2);
         if (0 < (int)uVar6) {
            icu_76_godot::CharString::extract((char*)&local_318, (int)param_1, (UErrorCode*)(ulong)uVar6);
         }
   ...
   LAB_0010608a:if ((char)local_30c != '\0') {
      uprv_free_76_godot(local_318);
   }

   if ((char)local_34c == '\0') {} else {
...
undefined8 ures_getKeywordValues_76_godot(undefined8 param_1, undefined8 param_2, int *param_3) {
 ...
 while ( ( ( ( __s1 == (char*)0x0 ) || ( *__s1 == '\0' ) ) || ( iVar1 = iVar1 == 0 ) ) || ( iVar1 = iVar1 == 0 ) );
            if (local_1988 < 1) {
               LAB_00106b28:sVar4 = strlen(__s1);
 ...
 while ( puVar9 != puVar3 );
         ...
         LAB_001069f8:ures_closeBundle(lVar7, 1);
      }
;

bool IsValidSimpleFormat(long param_1) {
   ...
   bool bVar2;
   bVar2 = true;
   if (( ( ( *(int*)( param_1 + 0x28 ) != 0 ) && ( bVar2 = false ),0 < *(int*)( param_1 + 0x34 ) ) ) && ( 0 < *(int*)( param_1 + 0x38 ) )) {
...
undefined8 IsValidExtendedFormat(long param_1) {
   ...
   if (( ( ( 0 < iVar2 ) && ( iVar3 = *(int*)( param_1 + 0x38 ) ),0 < iVar3 ) ) && ( -1 < *(int*)( param_1 + 0x3c ) )) {
      if (plVar4 == (long*)0x0) {
         return 1;
      }
      ...
      if (( iVar8 < 2 ) || ( uVar5 != 0 )) {
         LAB_001000b5:if (*(int*)( (long)plVar4 + 0x24 ) == 0) goto LAB_00100152;
         do {
            if (plVar4[8] == 0) {
               if (plVar4[6] == 0) {
                  return 0;
...
bool SetFrame(int param_1, undefined8 *param_2) {
   ...
   long lVar10;
   lVar4 = param_2[9];
   if (( ( lVar4 != 0 ) && ( -1 < param_1 ) ) && ( iVar1 = param_1 <= iVar1 )) {
   ...
   do {
      ...
      *param_2 = lVar1;
      ...
      if (iVar8 != 0x48504c41) {
         ...
         LAB_00100580:uVar14 = 1;
         break;
      }

      if (bVar7) {
         LAB_00100570:*param_2 = lVar13;
         bVar6 = true;
      }
 else {
      ...
      LAB_0010051a:if (lVar13 == lVar9) break;
...
int ParseSingleImage(long *param_1) {
   ...
   if (( param_1[9] == 0 ) && ( 7 < ( ulong )(param_1[2] - *param_1) )) {
      ...
      if (lVar5 != 0) {
         if (( ( ulong )(param_1[1] - *param_1) < 8 ) || ( iVar4 = iVar4 != 2 )) {
            ...
            if (( ( *(int*)( (long)param_1 + 0x2c ) == 0 ) && ( 0 < *(int*)( lVar5 + 8 ) ) ) && ( 0 < *(int*)( lVar5 + 0xc ) )) {
                  ...
                  while (true) {
                     ...
                     *param_1 = lVar9;
                     ...
                     if (uVar13 == 0x48504c41) {
                        LAB_00100c30:if (( !bVar8 ) && ( ( bVar1 >> 1 & 1 ) == 0 )) {
                           *param_1 = lVar21;
                     ...
                     if (uVar13 < 0x48504c42) {
                                    ...
                                    if (piVar10 != (int*)0x0) {
                                       ...
                                       *param_1 = lVar12;
                                       ...
                                       if (( ulong )((long)iVar19 * (long)iVar16) >> 0x20 == 0) {
                                          if (( ( ( ulong )(param_1[1] - lVar12) < 8 ) || ( ( ulong )(param_1[1] - lVar12) < ( ulong )(uVar22 - 0x10) ) ) || ( ( iVar15 = StoreFrame_part_0(*(int*)( (long)param_1 + 0x44 ) + 1, param_1) ),iVar15 != 2 && ( ( ulong )(*param_1 - lVar12) <= ( ulong )(uVar22 - 0x10) ) )) {
                        ...
                        LAB_001008ff:if (( ulong )(lVar12 - lVar9) < uVar20) {
                           LAB_001009e0:iVar15 = 1;
                        }
 else {
                           if (uVar13 != 0) {
                              LAB_00100bc8:plVar11 = (long*)WebPSafeCalloc(1, 0x18);
                           ...
                           LAB_00100913:lVar9 = lVar9 + uVar20;
                           iVar15 = 0;
                           *param_1 = lVar9;
                        }
                        ...
                        if (0x50434349 < uVar13) {
                           if (uVar13 != 0x58385056) {
                              LAB_00100bbc:if (uVar20 <= ( ulong )(lVar12 - lVar9)) goto LAB_00100bc8;
                              goto LAB_001009e0;
                           }
...
undefined8 *WebPDemuxInternal(undefined8 *param_1, int param_2, undefined4 *param_3, int param_4) {
   ...
   if (( ( ( param_4 >> 8 == 1 ) && ( param_1 != (undefined8*)0x0 ) ) && ( piVar1 = (int*)*param_1 ),piVar1 != (int*)0x0 )) {
      if (uStack_80 < 0x14) {
         LAB_00100f08:if (param_3 != (undefined4*)0x0) {
            *param_3 = 0;
         }
               ...
               if (*piVar8 == piVar1[3]) {
                  ...
                  if (iVar4 == 0) {
                     *(undefined4*)( puVar5 + 5 ) = 2;
                     LAB_00100ede:iVar4 = ( **(code**)( piVar8 + 4 ) )(puVar5);
                     if (iVar4 != 0) {
                        if (param_3 != (undefined4*)0x0) {
...
;
   ...
   LAB_00100db8:puVar5 = (undefined8*)0x0;
   LAB_00100dba:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return puVar5;
   }
...
undefined8 WebPDemuxGetChunk(undefined8 param_1, undefined8 param_2, undefined4 param_3, undefined1 (*param_4)[16]) {
   undefined8 uVar1;

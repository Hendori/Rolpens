...
undefined8 ecp_mod_koblitz(long *param_1, undefined8 param_2, ulong param_3, long param_4, long param_5, ulong param_6) {
   long lVar1;
   ulong *puVar2;
   ulong uVar3;
   long lVar4;
 ...
 while ( uVar11 < uVar6 );
      ...
      if (( (int)uVar7 == 0 ) && ( uVar7 = mbedtls_mpi_add_abs(param_1, param_1, &local_98) ),(int)uVar7 == 0) {
 ...
 while ( uVar6 < uVar5 );
   ...
   LAB_001001f1:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar7;
   }
...
undefined8 ecp_mod_p448(long *param_1) {
 ...
 while ( uVar6 < uVar3 );
         ...
         if ((int)uVar4 == 0) {
            ...
            if (( (int)uVar4 == 0 ) && ( uVar4 = mbedtls_mpi_add_mpi(param_1, param_1, &local_b8) ),(int)uVar4 == 0) {
...
undefined8 ecp_mod_p255(long *param_1) {
 ...
 while ( uVar5 < uVar2 );
   ...
   uVar3 = 0;
   LAB_001006f9:if (local_10 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar3;
   }
...
int ecp_mod_p384(undefined8 *param_1) {
   ...
   if (iVar4 == 0) {
      ...
      bVar7 = ( CARRY4((uint)uVar3, uVar22) + CARRY4(uVar19, uVar5) + CARRY4(uVar20, uVar11) ) - ( uVar21 < uVar23 );
      ...
      bVar7 = ( ( cVar31 + CARRY4(uVar19, uVar16) + CARRY4(uVar19 + uVar16, uVar30) + CARRY4(uVar20, uVar23) ) - ( uVar12 < uVar22 ) ) - ( uVar26 < uVar11 );
      ...
      *puVar2 = CONCAT44(uVar26 - uVar11, uVar21 - uVar23);
      ...
      bVar7 = ( ( cVar31 + CARRY4(uVar19 + uVar20, uVar17) + CARRY4(uVar21, uVar23) ) - ( uVar12 < uVar16 ) ) - ( uVar26 < uVar5 );
      ...
      bVar7 = ( ( ( cVar31 + CARRY4(uVar20 + uVar19, uVar21) + CARRY4(uVar12, uVar22) + CARRY4(uVar13, uVar11) + CARRY4(uVar14, uVar5) ) - ( uVar15 < uVar17 ) ) - ( uVar28 < uVar30 ) ) - ( uVar24 < uVar23 );
      ...
      bVar7 = ( ( ( cVar31 + CARRY4(uVar19 + uVar20, uVar5) + CARRY4(uVar14, uVar5) + CARRY4(uVar15, uVar27) + CARRY4(uVar24, uVar16) + CARRY4(uVar22, uVar28) + CARRY4(uVar12, uVar11) + CARRY4(uVar26, uVar30) ) - ( uVar13 < uVar21 ) ) - ( uVar29 < uVar23 ) ) - ( uVar25 < uVar23 );
      ...
      bVar7 = ( cVar31 + CARRY4(uVar22 + uVar19, uVar30) + CARRY4(uVar20, uVar30) + CARRY4(uVar12, uVar24) + CARRY4(uVar26, uVar17) + CARRY4(uVar16, uVar13) + CARRY4(uVar28, uVar5) + CARRY4(uVar14, uVar23) ) - ( uVar15 < uVar27 );
      ...
      bVar7 = ( cVar31 + CARRY4(uVar19 + uVar22, uVar23) + CARRY4(uVar12, uVar23) + CARRY4(uVar16, uVar20) + CARRY4(uVar26, uVar21) + CARRY4(uVar17, uVar13) + CARRY4(uVar15, uVar30) ) - ( uVar14 < uVar24 );
      ...
      bVar7 = ( cVar31 + CARRY4(uVar19 + uVar22, uVar13) + CARRY4(uVar16, uVar27) + CARRY4(uVar21, uVar26) + CARRY4(uVar12, uVar23) ) - ( uVar17 < uVar20 );
      ...
      bVar7 = ( cVar31 + CARRY4(uVar19 + uVar22, uVar11) + CARRY4(uVar21, uVar24) + CARRY4(uVar12, uVar27) ) - ( uVar16 < uVar13 );
      ...
      uVar26 = uVar12 + uVar24;
      bVar7 = ( cVar31 + CARRY4(uVar19 + uVar22, uVar5) + CARRY4(uVar21, uVar20) + CARRY4(uVar12, uVar24) ) - ( uVar26 < uVar11 );
      ...
      bVar7 = ( cVar31 + CARRY4(uVar30, uVar19 + uVar22) + CARRY4(uVar21, uVar13) + CARRY4(uVar12, uVar20) ) - ( uVar16 < uVar5 );
      ...
      cVar18 = ( cVar31 + CARRY4(uVar23, uVar19 + uVar22) + CARRY4(uVar11, uVar20) + CARRY4(uVar13, uVar21) ) - ( uVar12 < uVar30 );
 ...
 while ( (ulong)uVar2 * 2 != uVar11 );
      ...
      if (cVar22 < '\0') {
         ...
         *puVar3 = *puVar3 ^ 0xffffffff;
         for (int i = 0; i < 7; i++) {
            puVar3[( i + 1 )] = puVar3[( i + 1 )] ^ 4294967295;
         }
...
int ecp_mod_p192(long *param_1) {
   ...
   if (iVar6 == 0) {
      ...
      *puVar2 = uVar3 + *puVar2 + uVar4;
      ...
      uVar11 = (ulong)CARRY8(uVar9, uVar5) + (ulong)CARRY8(uVar7, uVar11) + (ulong)CARRY8(uVar8, uVar3) + (ulong)CARRY8(uVar10, uVar4);
      uVar3 = puVar2[2];
      uVar7 = uVar11 + puVar2[2];
      uVar8 = uVar7 + uVar5;
      puVar2[2] = uVar8 + uVar4;
      puVar2[3] = (ulong)CARRY8(uVar11, uVar3) + (ulong)CARRY8(uVar7, uVar5) + (ulong)CARRY8(uVar8, uVar4);
      if (puVar2 + 4 < puVar2 + uVar1) {
         memset(puVar2 + 4, 0, ( (long)( puVar2 + uVar1 ) + ( -0x21 - (long)puVar2 ) & 0xfffffffffffffff8U ) + 8);
         return 0;
      }
...
int ecp_mod_p256(undefined8 *param_1) {
   ...
   if (iVar4 == 0) {
      ...
      bVar8 = ( ( ( ( CARRY4(uVar5, uVar26) + CARRY4(uVar28, ( uint ) * puVar2) ) - ( uVar6 < uVar12 ) ) - ( uVar25 < uVar27 ) ) - ( uVar13 < uVar18 ) ) - ( uVar22 < uVar14 );
      ...
      bVar8 = ( ( ( ( cVar29 + CARRY4(uVar5 + uVar6, uVar26) + CARRY4(uVar16, uVar19) ) - ( uVar17 < uVar27 ) ) - ( uVar13 < uVar18 ) ) - ( uVar23 < uVar14 ) ) - ( uVar21 < uVar25 );
      *puVar2 = CONCAT44(uVar21 - uVar25, uVar22 - uVar14);
      ...
      bVar8 = ( ( ( cVar29 + CARRY4(uVar5 + uVar6, uVar19) + CARRY4(uVar13, uVar12) ) - ( uVar22 < uVar18 ) ) - ( uVar17 < uVar14 ) ) - ( uVar16 < uVar25 );
      ...
      bVar8 = ( ( ( cVar29 + CARRY4(uVar6 + uVar5, uVar12) + CARRY4(uVar13, uVar12) + CARRY4(uVar22, uVar27) + CARRY4(uVar17, uVar27) + CARRY4(uVar21, uVar18) ) - ( uVar23 < uVar25 ) ) - ( uVar24 < uVar28 ) ) - ( uVar20 < uVar26 );
      ...
      bVar8 = ( ( cVar29 + CARRY4(uVar5 + uVar6, uVar27) + CARRY4(uVar13, uVar27) + CARRY4(uVar22, uVar18) + CARRY4(uVar16, uVar18) + CARRY4(uVar17, uVar14) ) - ( uVar21 < uVar26 ) ) - ( uVar23 < uVar19 );
      ...
      bVar8 = ( ( cVar29 + CARRY4(uVar5 + uVar6, uVar18) + CARRY4(uVar13, uVar18) + CARRY4(uVar22, uVar14) + CARRY4(uVar16, uVar14) + CARRY4(uVar17, uVar25) ) - ( uVar21 < uVar19 ) ) - ( uVar20 < uVar12 );
      ...
      bVar8 = ( ( cVar29 + CARRY4(uVar5 + uVar6, uVar14) + CARRY4(uVar13, uVar14) + CARRY4(uVar22, uVar25) + CARRY4(uVar16, uVar25) + CARRY4(uVar17, uVar14) + CARRY4(uVar18, uVar21) ) - ( uVar23 < uVar28 ) ) - ( uVar20 < uVar26 );
      ...
      cVar15 = ( ( ( ( CARRY4(uVar28, uVar13) + cVar29 + CARRY4(uVar5 + uVar6, uVar25) + CARRY4(uVar22, uVar25) + CARRY4(uVar25, uVar16) ) - ( uVar17 < uVar19 ) ) - ( uVar14 < uVar12 ) ) - ( uVar23 < uVar27 ) ) - ( uVar21 < uVar18 );
      cVar29 = '\0';
      if (-1 < cVar15) {
         cVar29 = cVar15;
      }
...
int mbedtls_ecp_group_load(undefined4 *param_1, undefined4 param_2) {
   ...
   *param_1 = param_2;
   ...
   mbedtls_mpi_free(local_38);
   LAB_00101871:mbedtls_ecp_group_free(param_1);
   goto LAB_00101952;
}
local_3c = 0;LAB_00101952:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return local_3c;
}

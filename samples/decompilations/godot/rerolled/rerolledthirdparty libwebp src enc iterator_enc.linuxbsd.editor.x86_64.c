/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void InitLeft(long param_1) {
   undefined8 *puVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   undefined1 uVar4;
   ...
   for (int i = 0; i < 3; i++) {
      *(undefined1*)( *(long*)( param_1 + ( -8*i + 376 ) ) + -1 ) = uVar4;
   }
...
void ImportBlock(undefined8 *param_1, int param_2, undefined8 *param_3, uint param_4, ulong param_5, uint param_6) {
   uint uVar1;
   ulong uVar2;
   uint uVar3;
   long lVar4;
         ...
         if (uVar8 < 8) {
            if (( param_4 & 4 ) == 0) {
               if (( uVar8 != 0 ) && ( *(undefined1*)puVar6 = *(undefined1*)param_1(param_4 & 2) != 0 )) {
                  *(undefined2*)( (long)puVar6 + ( uVar8 - 2 ) ) = *(undefined2*)( (long)param_1 + ( uVar8 - 2 ) );
               }
            ...
            *(undefined8*)( (long)puVar6 + ( uVar8 - 8 ) ) = *(undefined8*)( (long)param_1 + ( uVar8 - 8 ) );
            if (7 < uVar5) {
               uVar2 = 0;
               do {
                  *(undefined8*)( ( ( ulong )(puVar6 + 1) & 0xfffffffffffffff8 ) + uVar2 ) = *(undefined8*)( (long)param_1 + ( uVar2 - lVar4 ) );
                  uVar2 = uVar2 + 8;
               }
 while ( uVar2 < uVar5 );
            }
         ...
         if ((int)param_4 < (int)param_6) {
            memset((undefined1*)( (long)puVar6 + uVar8 ), ( uint ) * (byte*)( (long)puVar6 + ( uVar8 - 1 ) ), (long)(int)( param_6 - param_4 ));
         }
 ...
 while ( puVar6 != param_3 + (long)iVar7 * 4 );
   ...
   do {
      ...
      *param_3 = param_3[-4];
      *(undefined8*)( (long)param_3 + ( (ulong)param_6 - 8 ) ) = *(undefined8*)( (long)param_3 + ( (ulong)param_6 - 0x28 ) );
...
void VP8IteratorSetRow(undefined4 *param_1, uint param_2) {
   ...
   param_1[1] = param_2;
   *param_1 = 0;
   *(long*)( param_1 + 0xe ) = lVar2 + 0x70 + (long)(int)( *(int*)( lVar2 + 0x3c ) - 1U & param_2 ) * 0x30;
   iVar1 = *(int*)( lVar2 + 0x30 );
   *(long*)( param_1 + 0x10 ) = (long)(int)( *(int*)( lVar2 + 0x38 ) * param_2 * 4 ) + *(long*)( lVar2 + 0x5c68 );
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void VP8IteratorImport(int *param_1, undefined8 *param_2) {
   undefined1 uVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   int iVar4;
   ...
   if (iVar17 == 0) {
      ...
      if (iVar19 == 0) {
         for (int i = 0; i < 3; i++) {
            *(undefined1*)( *(long*)( param_1 + ( -2*i + 94 ) ) + -1 ) = 127;
         }

      }
 else {
         *(undefined1*)( *(long*)( param_1 + 0x5a ) + -1 ) = *(undefined1*)( lVar5 + (int)~*(uint *)(lVar10 + 0x28) );
         *(undefined1*)( *(long*)( param_1 + 0x5c ) + -1 ) = *(undefined1*)( lVar18 + (int)~*(uint *)(lVar10 + 0x2c) );
         *(undefined1*)( *(long*)( param_1 + 0x5e ) + -1 ) = *(undefined1*)( lVar6 + (int)~*(uint *)(lVar10 + 0x2c) );
      }
      ...
      if (iVar4 < 1) {
         iVar17 = 0;
         LAB_001006bf:puVar11 = (undefined1*)( lVar9 + iVar17 );
         do {
            puVar7 = puVar11 + 1;
 ...
 while ( (int)lVar13 < iVar20 );
         ...
         puVar11 = *(undefined1**)( param_1 + 0x5c );
         iVar17 = *(int*)( lVar10 + 0x2c );
         LAB_0010070d:puVar14 = (undefined1*)( lVar18 + -1 );
         puVar7 = puVar11;
         do {
            uVar1 = *puVar14;
            puVar8 = puVar7 + 1;
 ...
 while ( puVar11 + iVar16 != puVar8 );
         ...
         puVar11 = *(undefined1**)( param_1 + 0x5e );
         iVar17 = *(int*)( lVar10 + 0x2c );
         LAB_00100774:puVar14 = (undefined1*)( lVar6 + -1 );
         puVar7 = puVar11;
         do {
            uVar1 = *puVar14;
            puVar8 = puVar7 + 1;
 ...
 while ( (int)lVar9 != 8 );
   ...
   LAB_001007b7:*(undefined8**)( param_1 + 0x60 ) = param_2;
   *(undefined8**)( param_1 + 0x62 ) = param_2 + 2;
   ...
   if (iVar15 < 1) {
      iVar19 = 0;
      LAB_0010085f:puVar11 = (undefined1*)( (long)param_2 + (long)iVar19 );
      do {
         puVar7 = puVar11 + 1;
 ...
 while ( puVar7 != (undefined1*)( (long)param_2 + ( ulong )(0xf - iVar19) + (long)iVar19 + 1 ) );
      ...
      lVar5 = 0;
      LAB_001008d2:do {
         *(undefined1*)( (long)param_2 + lVar5 + 0x10 ) = *(undefined1*)( (long)param_2 + (long)iVar12 + 0xf );
         lVar5 = lVar5 + 1;
      }
 while ( (int)lVar5 != 8 );
      iVar19 = *(int*)( lVar10 + 0x2c );
 ...
 while ( lVar10 != iVar12 );
   ...
   LAB_0010092f:do {
      *(undefined1*)( (long)param_2 + lVar10 + 0x18 ) = *(undefined1*)( (long)param_2 + (long)iVar12 + 0x17 );
      lVar10 = lVar10 + 1;
   }
 while ( (int)lVar10 != 8 );
   return;
...
void VP8IteratorExport(int *param_1) {
   ...
   if (*(int*)( **(long**)( param_1 + 10 ) + 0x40 ) != 0) {
      ...
      if (0 < (int)uVar17) {
         ...
         do {
            if (uVar19 < 8) {
               if (( uVar12 & 4 ) == 0) {
                  if (( uVar19 != 0 ) && ( *(undefined1*)puVar13 = *(undefined1*)puVar18(uVar12 & 2) != 0 )) {
                     *(undefined2*)( (long)puVar13 + ( uVar19 - 2 ) ) = *(undefined2*)( (long)puVar18 + ( uVar19 - 2 ) );
                  }

               }
 else {
                  *(undefined4*)puVar13 = *(undefined4*)puVar18;
                  *(undefined4*)( (long)puVar13 + ( uVar19 - 4 ) ) = *(undefined4*)( (long)puVar18 + ( uVar19 - 4 ) );
               }
               ...
               *(undefined8*)( (long)puVar13 + ( uVar19 - 8 ) ) = *(undefined8*)( (long)puVar18 + ( uVar19 - 8 ) );
               if (7 < uVar11) {
                  uVar9 = 0;
                  do {
                     *(undefined8*)( ( ( ulong )(puVar13 + 1) & 0xfffffffffffffff8 ) + uVar9 ) = *(undefined8*)( (long)puVar18 + ( uVar9 - lVar6 ) );
                     uVar9 = uVar9 + 8;
                  }
 while ( uVar9 < uVar11 );
               }
 ...
 while ( uVar17 != 0 );
         ...
         do {
            if (uVar19 < 8) {
               if (( uVar12 & 4 ) == 0) {
                  if (( uVar19 != 0 ) && ( *(undefined1*)puVar16 = *(undefined1*)puVar15(uVar12 & 2) != 0 )) {
                     *(undefined2*)( (long)puVar16 + ( uVar19 - 2 ) ) = *(undefined2*)( (long)puVar15 + ( uVar19 - 2 ) );
                  }

               }
 else {
                  *(undefined4*)puVar16 = *(undefined4*)puVar15;
                  *(undefined4*)( (long)puVar16 + ( uVar19 - 4 ) ) = *(undefined4*)( (long)puVar15 + ( uVar19 - 4 ) );
               }
               ...
               *(undefined8*)( (long)puVar16 + ( uVar19 - 8 ) ) = *(undefined8*)( (long)puVar15 + ( uVar19 - 8 ) );
               if (7 < uVar9) {
                  uVar10 = 0;
                  do {
                     *(undefined8*)( ( ( ulong )(puVar16 + 1) & 0xfffffffffffffff8 ) + uVar10 ) = *(undefined8*)( (long)puVar15 + ( uVar10 - lVar6 ) );
                     uVar10 = uVar10 + 8;
                  }
 while ( uVar10 < uVar9 );
               }
            ...
            if (uVar19 < 8) {
               if (( uVar19 & 4 ) == 0) {
                  if (( uVar19 != 0 ) && ( *(undefined1*)puVar7 = *(undefined1*)puVar14(uVar19 & 2) != 0 )) {
                     *(undefined2*)( (long)puVar7 + ( uVar19 - 2 ) ) = *(undefined2*)( (long)puVar14 + ( uVar19 - 2 ) );
                  }

               }
 else {
                  *(undefined4*)puVar7 = *(undefined4*)puVar14;
                  *(undefined4*)( (long)puVar7 + ( uVar19 - 4 ) ) = *(undefined4*)( (long)puVar14 + ( uVar19 - 4 ) );
               }

            }
 else {
               *puVar7 = *puVar14;
               *(undefined8*)( (long)puVar7 + ( uVar19 - 8 ) ) = *(undefined8*)( (long)puVar14 + ( uVar19 - 8 ) );
               lVar8 = (long)puVar7 - ( ( ulong )(puVar7 + 1) & 0xfffffffffffffff8 );
               uVar9 = lVar8 + uVar19 & 0xfffffffffffffff8;
               if (7 < uVar9) {
                  uVar10 = 0;
                  do {
                     *(undefined8*)( ( ( ulong )(puVar7 + 1) & 0xfffffffffffffff8 ) + uVar10 ) = *(undefined8*)( (long)puVar14 + ( uVar10 - lVar8 ) );
                     uVar10 = uVar10 + 8;
                  }
 while ( uVar10 < uVar9 );
               }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void VP8IteratorNzToBytes(long param_1) {
   uint uVar1;
   uint uVar2;
   uint uVar3;
   uint uVar4;
...
void VP8IteratorBytesToNz(long param_1) {
   **(uint**)( param_1 + 0x48 ) = *(int*)( param_1 + 0x84 ) << 0xc | *(int*)( param_1 + 0x88 ) << 0xd | *(int*)( param_1 + 0x8c ) << 0xe | *(int*)( param_1 + 0x90 ) << 0xf | *(int*)( param_1 + 0x94 ) << 0x12 | *(int*)( param_1 + 0x98 ) << 0x13 | *(int*)( param_1 + 0x9c ) << 0x16 | *(int*)( param_1 + 0xa0 ) << 0x17 | *(int*)( param_1 + 0xc0 ) << 0x15 | *(int*)( param_1 + 0xb8 ) << 0x11 | *(int*)( param_1 + 0xa8 ) * 8 | *(int*)( param_1 + 0xac ) << 7 | *(int*)( param_1 + 0xa4 ) << 0x18 | *(int*)( param_1 + 0xb0 ) << 0xb;
   return;
}
void VP8IteratorSaveBoundary(int *param_1) {
   ...
   if (*param_1 < *(int*)( lVar2 + 0x30 ) + -1) {
      lVar6 = 0;
      do {
         *(undefined1*)( *(long*)( param_1 + 0x5a ) + lVar6 ) = *(undefined1*)( lVar3 + 0xf + lVar6 * 0x20 );
         lVar6 = lVar6 + 1;
      }
 while ( lVar6 != 0x10 );
      lVar6 = 0;
 ...
 while ( lVar6 != 8 );
      *(undefined1*)( *(long*)( param_1 + 0x5a ) + -1 ) = *(undefined1*)( *(long*)( param_1 + 0x60 ) + 0xf );
      *(undefined1*)( *(long*)( param_1 + 0x5c ) + -1 ) = *(undefined1*)( *(long*)( param_1 + 0x62 ) + 7 );
      *(undefined1*)( *(long*)( param_1 + 0x5e ) + -1 ) = *(undefined1*)( *(long*)( param_1 + 0x62 ) + 0xf );
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */bool VP8IteratorNext(int *param_1) {
   int iVar1;
   long lVar2;
   long lVar3;
   iVar1 = *param_1;
...
void VP8IteratorStartI4(int *param_1) {
 ...
 while ( lVar5 != 0x10 );
   ...
   for (int i = 0; i < 3; i++) {
      *(undefined1*)( (long)param_1 + ( i + 113 ) ) = *(undefined1*)( lVar2 + ( i + 16 ) );
   }
...
bool VP8IteratorRotateI4(long param_1, long param_2) {
   ...
   *(undefined1*)( puVar2 + -1 ) = *(undefined1*)( param_2 + 0x60 );
   for (int i = 0; i < 3; i++) {
      *(undefined1*)( (long)puVar2 + ( i + -3 ) ) = *(undefined1*)( param_2 + ( i + 97 ) );
   }

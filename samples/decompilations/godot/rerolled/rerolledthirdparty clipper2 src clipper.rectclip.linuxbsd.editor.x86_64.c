/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Clipper2Lib::GetSegmentIntersection(Clipper2Lib::Point<long> const&, Clipper2Lib::Point<long>
   const&, Clipper2Lib::Point<long> const&, Clipper2Lib::Point<long> const&,
   Clipper2Lib::Point<long>&) */bool Clipper2Lib::GetSegmentIntersection(Point *param_1, Point *param_2, Point *param_3, Point *param_4, Point *param_5) {
   long lVar1;
   undefined8 uVar2;
   long lVar3;
   long lVar4;
   ...
   dVar6 = (double)( lVar5 - *(long*)param_2 ) * dVar9 - (double)( lVar4 - *(long*)( param_2 + 8 ) ) * dVar10;
   if (dVar7 == 0.0) {
      ...
      *(undefined8*)( param_5 + 8 ) = uVar2;
      ...
      if (( *(long*)param_3 != lVar4 ) || ( *(long*)( param_1 + 8 ) != *(long*)( param_3 + 8 ) )) {
         ...
         if (( *(long*)param_4 != lVar4 ) || ( *(long*)( param_1 + 8 ) != lVar5 )) {
            ...
            LAB_001000f2:return lVar3 < lVar4 == lVar4 < lVar5;
         }
         ...
         *(undefined8*)( param_5 + 8 ) = uVar2;
         ...
         if (( lVar4 != *(long*)param_1 ) || ( *(long*)( param_3 + 8 ) != *(long*)( param_1 + 8 ) )) {
            ...
            if (( lVar4 != *(long*)param_2 ) || ( *(long*)( param_3 + 8 ) != lVar5 )) {
               ...
               lVar4 = *(long*)( param_3 + 8 );
               LAB_00100224:return lVar3 < lVar4 == lVar4 < lVar5;
            }
         ...
         dVar8 = (double)( lVar3 - *(long*)param_4 ) * dVar7 - (double)( lVar1 - *(long*)( param_4 + 8 ) ) * dVar11;
         if (dVar8 == 0.0) {
...
/* Clipper2Lib::GetIntersection(std::vector<Clipper2Lib::Point<long>,
   ...
   .isra.0] */undefined8 Clipper2Lib::GetIntersection(vector *param_1, Point *param_2, Point *param_3, Location *param_4, Point *param_5) {
   int iVar1;
   char cVar2;
   iVar1 = *(int*)param_4;
   if (iVar1 == 2) {
      cVar2 = GetSegmentIntersection(param_2, param_3, (Point*)( param_1 + 0x10 ), (Point*)( param_1 + 0x20 ), param_5);
      if (cVar2 != '\0') {
         return 1;
      }

      if (*(long*)( param_1 + 0x18 ) <= *(long*)( param_2 + 8 )) goto LAB_0010069a;
      cVar2 = GetSegmentIntersection(param_2, param_3, (Point*)param_1, (Point*)( param_1 + 0x10 ), param_5);
      joined_r0x00100634:if (cVar2 == '\0') {
         LAB_0010069a:cVar2 = GetSegmentIntersection(param_2, param_3, (Point*)( param_1 + 0x20 ), (Point*)( param_1 + 0x30 ), param_5);
         if (cVar2 != '\0') {
      ...
      LAB_001006e1:*(undefined4*)param_4 = 1;
      return 1;
   }

   if (iVar1 < 3) {
      if (iVar1 == 0) {
         cVar2 = GetSegmentIntersection(param_2, param_3, (Point*)param_1, (Point*)( param_1 + 0x30 ), param_5);
         if (cVar2 != '\0') {
            return 1;
         }
      ...
      if (( *(long*)param_2 < *(long*)param_1 ) && ( cVar2 = GetSegmentIntersection(param_2, param_3, (Point*)param_1, (Point*)( param_1 + 0x30 ), param_5) ),cVar2 != '\0') goto LAB_001005d0;
      cVar2 = GetSegmentIntersection(param_2, param_3, (Point*)( param_1 + 0x10 ), (Point*)( param_1 + 0x20 ), param_5);
   }
 else {
      if (iVar1 != 3) {
         LAB_001005b0:cVar2 = GetSegmentIntersection(param_2, param_3, (Point*)param_1, (Point*)( param_1 + 0x30 ), param_5);
         if (cVar2 != '\0') {
            LAB_001005d0:*(undefined4*)param_4 = 0;
            return 1;
         }
      ...
      cVar2 = GetSegmentIntersection(param_2, param_3, (Point*)( param_1 + 0x20 ), (Point*)( param_1 + 0x30 ), param_5);
      if (cVar2 != '\0') {
         return 1;
      }

      if (( *(long*)param_2 < *(long*)( param_1 + 0x30 ) ) && ( cVar2 = GetSegmentIntersection(param_2, param_3, (Point*)param_1, (Point*)( param_1 + 0x30 ), param_5) ),cVar2 != '\0') goto LAB_001005d0;
      cVar2 = GetSegmentIntersection(param_2, param_3, (Point*)( param_1 + 0x10 ), (Point*)( param_1 + 0x20 ), param_5);
   }
   ...
   LAB_00100526:*(undefined4*)param_4 = 2;
   return 1;
}
/* Clipper2Lib::StartLocsAreClockwise(std::vector<Clipper2Lib::Location,
   std::allocator<Clipper2Lib::Location> > const&) */undefined8 Clipper2Lib::StartLocsAreClockwise(vector *param_1) {
   int *piVar1;
   ulong uVar2;
   ulong uVar3;
   int iVar4;
...
/* Clipper2Lib::RectClip64::GetPath(Clipper2Lib::OutPt2*&) */OutPt2 **Clipper2Lib::RectClip64::GetPath(OutPt2 **param_1) {
   long lVar1;
   long *plVar2;
   undefined8 uVar3;
   undefined8 uVar4;
      ...
      if (plVar24 != (long*)0x0) {
         while (plVar23 = plVar24,(long*)*in_RDX != plVar24) {
            while (true) {
               ...
               if (( ( uVar9 >> 0x20 ) + ( uVar17 >> 0x20 ) * ( uVar10 >> 0x20 ) + ( uVar14 >> 0x20 ) != ( uVar5 >> 0x20 ) * ( uVar21 >> 0x20 ) + ( uVar8 >> 0x20 ) + ( uVar7 >> 0x20 ) || ( uVar14 << 0x20 | uVar22 & 0xffffffff ) != ( uVar7 << 0x20 | uVar13 & 0xffffffff ) ) || ( ( ( uint )(0 < (long)uVar12) + (int)( (long)uVar12 >> 0x3f ) ) * ( ( uint )(0 < (long)uVar20) + (int)( (long)uVar20 >> 0x3f ) ) != ( ( uint )(0 < (long)uVar18) + (int)( (long)uVar18 >> 0x3f ) ) * ( ( uint )(0 < (long)uVar19) + (int)( (long)uVar19 >> 0x3f ) ) )) break;
               *in_RDX = (long)plVar2;
               plVar24 = (long*)plVar23[4];
...
;
         LAB_00100998:local_58 = (undefined1[16])0x0;
         local_48 = (OutPt2*)0x0;
         std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>::_M_realloc_insert<Clipper2Lib::Point<long>const&>((vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>*)local_58, 0, plVar24);
...
;
               std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>::_M_realloc_insert<Clipper2Lib::Point<long>const&>((vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>*)local_58, pOVar16, puVar11);
               puVar11 = (undefined8*)puVar11[4];
               pOVar6 = local_48;
               pOVar16 = (OutPt2*)local_58._8_8_;
               pOVar15 = (OutPt2*)local_58._8_8_;
 ...
 while ( (undefined8*)*in_RDX != puVar11 );
         ...
         LAB_00100a20:param_1[2] = pOVar6;
         *param_1 = (OutPt2*)local_58._0_8_;
         param_1[1] = pOVar15;
         goto LAB_00100a5c;
      }

      LAB_00100a40:*in_RDX = 0;
   }

   param_1[2] = (OutPt2*)0x0;
   param_1[0] = (OutPt2*)0x0;
   param_1[1] = (OutPt2*)0x0;
   LAB_00100a5c:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
...
/* Clipper2Lib::RectClipLines64::GetPath(Clipper2Lib::OutPt2*&) */OutPt2 **Clipper2Lib::RectClipLines64::GetPath(OutPt2 **param_1) {
   long lVar1;
   OutPt2 *pOVar2;
   undefined8 uVar3;
   undefined8 uVar4;
   ...
   if (( lVar1 != 0 ) && ( lVar1 != *(long*)( lVar1 + 0x20 ) )) {
      *in_RDX = *(long*)( lVar1 + 0x20 );
      std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>::_M_realloc_insert<Clipper2Lib::Point<long>const&>((vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>*)param_1, 0);
...
;
            std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>::_M_realloc_insert<Clipper2Lib::Point<long>const&>((vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>*)param_1, pOVar2, puVar5);
            puVar5 = (undefined8*)puVar5[4];
         }
...
/* Clipper2Lib::RectClip64::CheckEdges() */void Clipper2Lib::RectClip64::CheckEdges(RectClip64 *this) {
   long *plVar1;
   long lVar2;
   undefined8 *puVar3;
   bool bVar4;
   ...
   if (lVar18 == *(long*)( this + 0xc0 )) {
      LAB_00100d66:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Subroutine does not return */
         __stack_chk_fail();
      }
   ...
   uVar24 = 0;
   LAB_00100b70:plVar11 = (long*)( lVar18 + uVar24 * 8 );
   ...
   if (local_80 != (long*)0x0) {
      do {
         while (true) {
            ...
            if (( ( uVar9 >> 0x20 ) + ( uVar19 >> 0x20 ) * ( uVar22 >> 0x20 ) + ( uVar15 >> 0x20 ) == ( uVar5 >> 0x20 ) + ( uVar17 >> 0x20 ) * ( uVar20 >> 0x20 ) + ( uVar8 >> 0x20 ) && ( uVar28 & 0xffffffff | uVar15 << 0x20 ) == ( uVar8 << 0x20 | uVar14 & 0xffffffff ) ) && ( ( ( uint )(0 < (long)uVar23) + (int)( (long)uVar23 >> 0x3f ) ) * ( ( uint )(0 < (long)uVar10) + (int)( (long)uVar10 >> 0x3f ) ) == ( ( uint )(0 < (long)uVar21) + (int)( (long)uVar21 >> 0x3f ) ) * ( ( uint )(0 < (long)uVar13) + (int)( (long)uVar13 >> 0x3f ) ) )) break;
            LAB_00100ba0:plVar26 = plVar12;
...
;
      ...
      *plVar11 = (long)plVar12;
      ...
      do {
         ...
         if (*plVar11 == *(long*)( this + 0x10 )) {
            ...
            joined_r0x00100ebb:if (lVar18 == 0) {
               pvVar27 = (vector<Clipper2Lib::OutPt2*,std::allocator<Clipper2Lib::OutPt2*>>*)( this + 0xd0 );
               iVar7 = 0;
               LAB_00100ec9:bVar6 = (byte)iVar7;
               do {
                  ...
                  if (iVar7 == 1) {
                     ...
                     LAB_00100fb6:if (bVar4) {
                        if (plVar11[3] != 0) goto LAB_00100fc6;
                        LAB_00100ff0:plVar11[3] = (long)pvVar27;
                        puVar3 = *(undefined8**)( pvVar27 + 8 );
                        if (puVar3 == *(undefined8**)( pvVar27 + 0x10 )) {
                           std::vector<Clipper2Lib::OutPt2*,std::allocator<Clipper2Lib::OutPt2*>>::_M_realloc_insert<Clipper2Lib::OutPt2*const&>(pvVar27, puVar3, &local_48);
                        }
 else {
                           *puVar3 = plVar11;
                        ...
                        if (plVar11[3] != 0) goto LAB_00100fc6;
                        LAB_00100f67:puVar3 = *(undefined8**)( pvVar27 + 0x20 );
                        plVar11[3] = (long)( pvVar27 + 0x18 );
                        if (puVar3 == *(undefined8**)( pvVar27 + 0x28 )) {
                           std::vector<Clipper2Lib::OutPt2*,std::allocator<Clipper2Lib::OutPt2*>>::_M_realloc_insert<Clipper2Lib::OutPt2*const&>(pvVar27 + 0x18, puVar3, &local_48);
                        }
 else {
                           *puVar3 = plVar11;
 ...
 while ( true );
   ...
   goto LAB_00100d4b;
   LAB_00100fc6:iVar7 = iVar7 + 1;
   pvVar27 = pvVar27 + 0x30;
   goto LAB_00100ec9;
   LAB_00100e89:lVar18 = *(long*)( this + 0xb8 );
   LAB_00100d4b:uVar24 = uVar24 + 1;
...
/* Clipper2Lib::RectClip64::TidyEdges(unsigned long, std::vector<Clipper2Lib::OutPt2*,
   ...
   std::allocator<Clipper2Lib::OutPt2*> >&) */void Clipper2Lib::RectClip64::TidyEdges(RectClip64 *this, ulong param_1, vector *param_2, vector *param_3) {
   ulong uVar1;
   long *plVar2;
   long lVar3;
   long *plVar4;
...
LAB_00101130:
   ...
   OutPt2 *Clipper2Lib::RectClip64::Add(long param_1, long param_2, long param_3, char param_4) {
      ...
      if (( lVar6 == 0 ) || ( param_4 != '\0' )) {
         ...
         local_50 = 0;
         pOVar4 = std::deque<Clipper2Lib::OutPt2,std::allocator<Clipper2Lib::OutPt2>>::emplace_back<Clipper2Lib::OutPt2>((deque<Clipper2Lib::OutPt2,std::allocator<Clipper2Lib::OutPt2>>*)( param_1 + 0x68 ), local_78);
         ...
         *(OutPt2**)( pOVar4 + 0x28 ) = pOVar4;
         ...
         if (puVar2 == *(undefined8**)( param_1 + 200 )) {
            std::vector<Clipper2Lib::OutPt2*,std::allocator<Clipper2Lib::OutPt2*>>::_M_realloc_insert<Clipper2Lib::OutPt2*const&>((vector<Clipper2Lib::OutPt2*,std::allocator<Clipper2Lib::OutPt2*>>*)( param_1 + 0xb8 ), puVar2, &local_80);
         }
 else {
            *puVar2 = pOVar4;
         ...
         if (( *(long*)pOVar4 != param_2 ) || ( *(long*)( pOVar4 + 8 ) != param_3 )) {
            ...
            pOVar3 = std::deque<Clipper2Lib::OutPt2,std::allocator<Clipper2Lib::OutPt2>>::emplace_back<Clipper2Lib::OutPt2>((deque<Clipper2Lib::OutPt2,std::allocator<Clipper2Lib::OutPt2>>*)( param_1 + 0x68 ), local_78);
   ...
   void Clipper2Lib::RectClip64::AddCorner(RectClip64 *this, int param_2, int param_3) {
      undefined8 *puVar1;
   ...
   void Clipper2Lib::RectClip64::AddCorner(RectClip64 *this, Location *param_1, bool param_2) {
      long lVar1;
      int iVar2;
      undefined8 *puVar3;
   ...
   unsigned long) */
   void Clipper2Lib::RectClip64::GetNextLocation(RectClip64 *this, vector *param_1, Location *param_2, ulong *param_3, ulong param_4) {
      long lVar1;
      long *plVar2;
      ulong uVar3;
...
LAB_0010194b:
   ...
   void Clipper2Lib::RectClipLines64::ExecuteInternal(RectClipLines64 *this, vector *param_1) {
      ulong uVar1;
      undefined8 uVar2;
      undefined8 uVar3;
      long *plVar4;
      ...
      long local_40;
      local_40 = *(long*)( in_FS_OFFSET + 0x28 );
      if (( ( *(long*)( this + 0x18 ) <= *(long*)( this + 8 ) ) || ( *(long*)( this + 0x10 ) <= *(long*)this ) ) || ( ( ulong )(*(long*)( param_1 + 8 ) - *(long*)param_1) < 0x11 )) goto LAB_00101b4c;
      ...
      *(undefined8**)( this + 0xb0 ) = puVar26;
      ...
      local_58 = uVar11;
      lStack_50 = lVar5;
      std::_Deque_base<Clipper2Lib::OutPt2,std::allocator<Clipper2Lib::OutPt2>>::~_Deque_base((_Deque_base<Clipper2Lib::OutPt2,std::allocator<Clipper2Lib::OutPt2>>*)&local_98);
      ...
      if (lVar7 == lVar5) {
         if (lVar6 <= lVar8) {
            ...
            if (lVar25 < lVar8) {
               ...
               LAB_00102110:if (lVar23 < lVar7) goto LAB_00101f18;
               local_c8 = 1;
            }
 else {
               local_c8 = 0;
                  ...
                  if (lVar7 == lVar5) {
                     if (lVar8 < lVar6) {
                        ...
                        if (lVar25 == lVar5) {
                           ...
                           LAB_001020a0:lVar23 = *(long*)( this + 0x18 );
                           lVar15 = lVar23;
                           joined_r0x001020c9:if (lVar8 == lVar15) goto LAB_00101fa6;
                        }
                     ...
                     if (lVar23 < lVar8) {
                        lVar25 = *(long*)( this + 0x10 );
                        lVar15 = lVar6;
                        if (( lVar5 == lVar25 ) || ( lVar15 = lVar8 != lVar6 )) goto joined_r0x001020c9;
                        goto LAB_00101fab;
                     }
                     ...
                     if (lVar7 != lVar25) {
                        ...
                        LAB_00101fa6:if (lVar5 <= lVar7) {
                           LAB_00101fab:if (lVar7 <= lVar25) goto LAB_00101ff0;
                        }
                     ...
                     lVar23 = *(long*)( this + 0x18 );
                     lVar15 = lVar23;
                     if (( lVar8 < lVar6 ) || ( lVar15 = lVar23 < lVar8 )) goto joined_r0x001020c9;
                  }

                  LAB_00101ff0:uVar22 = uVar22 + 1;
                  bVar14 = true;
                  unaff_RBP = uVar22;
                  plVar10 = plVar10 + 2;
                  uVar17 = uVar22;
 ...
 while ( uVar22 <= uVar1 );
         ...
         lVar23 = *(long*)( this + 0x10 );
         LAB_00101f0c:lVar25 = *(long*)( this + 0x18 );
         LAB_00101eb0:if (lVar8 != lVar25) goto LAB_00101eb9;
         if (lVar5 <= lVar7) {
         ...
         if (lVar7 == lVar23) {
            ...
            LAB_00101f3e:if (lVar8 == lVar6) goto LAB_00101d31;
            LAB_00101eb9:if (lVar7 < lVar5) goto LAB_00102123;
            if (lVar23 < lVar7) {
               LAB_00101f18:local_c8 = 2;
            }
 else if (lVar8 < lVar6) {
               local_c8 = 1;
            }
      ...
      if (uVar1 != 0) {
         LAB_00101d49:local_f8 = local_c8;
         while (RectClip64::GetNextLocation((RectClip64*)this, param_1, (Location*)&local_c8, &local_c0, uVar1),uVar17 = local_c0,iVar16 = local_c8,local_c0 <= uVar1) {
            ...
            cVar18 = GetIntersection(pvVar9, pPVar21, (Point*)&local_98, (Location*)&local_c4, (Point*)local_b8);
            if (cVar18 == '\0') {
               local_c0 = uVar17 + 1;
...
;
      ...
      LAB_00101b4c:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   ...
   std::allocator<Clipper2Lib::Point<long> > > const&) */
   void Clipper2Lib::RectClip64::ExecuteInternal(RectClip64 *this, vector *param_1) {
      long *plVar1;
      undefined8 *puVar2;
      long lVar3;
      long lVar4;
      ...
      if (lVar3 == lVar19) {
         if (lVar25 <= lVar4) {
            ...
            if (lVar32 < lVar4) {
               ...
               LAB_001030a4:local_88 = 1;
            }
 else {
               local_88 = 0;
            }

            joined_r0x0010260b:while (uVar13 != 0) {
               lVar3 = puVar2[-4];
               lVar4 = puVar2[-3];
               if (lVar3 == lVar19) {
                  if (lVar4 < lVar25) {
                     ...
                     LAB_00102695:if (( ( ( lVar3 < lVar19 ) || ( lVar32 < lVar3 ) ) || ( lVar4 < lVar25 ) ) || ( lVar34 < lVar4 )) goto LAB_00102228;
                     goto LAB_001026b9;
                  }
                  ...
                  if (lVar34 < lVar4) {
                     lVar32 = *(long*)( this + 0x10 );
                     lVar14 = lVar25;
                     if (( lVar19 == lVar32 ) || ( lVar14 = lVar4 != lVar25 )) goto joined_r0x00102c49;
                     goto LAB_0010263f;
                  }
                  ...
                  if (lVar3 == lVar32) {
                     lVar34 = *(long*)( this + 0x18 );
                     lVar14 = lVar34;
                     if (( lVar25 <= lVar4 ) && ( lVar14 = lVar4 <= lVar34 )) goto LAB_00102648;
                     joined_r0x00102c49:if (lVar4 != lVar14) goto LAB_00102695;
                  }
 else if (lVar4 != lVar25) {
                     LAB_00102c20:lVar34 = *(long*)( this + 0x18 );
                     lVar14 = lVar34;
                     goto joined_r0x00102c49;
                  }

                  if (lVar3 < lVar19) goto LAB_00102228;
                  LAB_0010263f:if (lVar32 < lVar3) goto LAB_00102228;
               }

               LAB_00102648:puVar2 = puVar2 + -2;
               uVar13 = uVar13 - 1;
            }
;
            do {
 ...
 while ( puVar20 != puVar28 );
         ...
         LAB_001025b3:if (lVar3 < lVar19) goto LAB_0010221a;
         ...
         if (lVar3 == lVar34) {
            ...
            if (lVar4 != lVar25) goto LAB_001025b3;
            LAB_00102211:if (lVar3 < lVar19) {
               LAB_0010221a:local_88 = 0;
               goto LAB_00102228;
            }

            LAB_00102589:if (lVar3 <= lVar34) goto LAB_001030a4;
         }
 else {
            if (lVar4 == lVar25) goto LAB_00102211;
            LAB_001025aa:lVar32 = *(long*)( this + 0x18 );
            LAB_001025ae:if (lVar4 != lVar32) goto LAB_001025b3;
            LAB_001025ef:if (lVar3 < lVar19) goto LAB_0010221a;
            if (lVar3 <= lVar34) {
               local_88 = 3;
         ...
         LAB_00102592:local_88 = 2;
      }

      LAB_00102228:iVar17 = local_88;
      local_80 = 0;
      local_ac = 4;
      LAB_0010237d:do {
         iVar22 = local_84;
         ...
         local_84 = local_88;
         cVar15 = GetIntersection(pvVar5, pPVar27, (Point*)&local_58, (Location*)&local_84, (Point*)local_78);
         iVar23 = local_84;
         if (cVar15 != '\0') {
            if (iVar16 == 4) {
               if (local_ac == 4) {
                  ...
                  if (piVar6 == *(int**)( this + 0x1a0 )) {
                     std::vector<Clipper2Lib::Location,std::allocator<Clipper2Lib::Location>>::_M_realloc_insert<Clipper2Lib::Location_const&>((vector<Clipper2Lib::Location,std::allocator<Clipper2Lib::Location>>*)( this + 400 ), piVar6, &local_8c);
                  }
 else {
                     *piVar6 = iVar26;
                  ...
                  if (iVar16 == 2) {
                     bVar37 = (double)( *(long*)( this + 0x38 ) - local_58 ) * (double)( *(long*)( pPVar27 + 8 ) - *(long*)( this + 0x40 ) ) - (double)( *(long*)( this + 0x40 ) - lStack_50 ) * (double)( *(long*)pPVar27 - *(long*)( this + 0x38 ) ) < 0.0;
                  }
 else {
 ...
 while ( local_8c != iVar23 );
               ...
               if (( iVar22 != 4 ) && ( local_88 != iVar22 )) {
                  if (local_88 == ( iVar22 + 1 ) % 4) {
                     Add(this, *(undefined8*)( pvVar5 + (long)iVar22 * 0x10 ), *(undefined8*)( pvVar5 + (long)iVar22 * 0x10 + 8 ), 0);
                  }
 else {
                     Add(this, *(undefined8*)( pvVar5 + (long)local_88 * 0x10 ), *(undefined8*)( pvVar5 + (long)local_88 * 0x10 + 8 ), 0);
                  }
                  ...
                  if (local_78._8_8_ == local_68._8_8_) {
                     ...
                     if (lVar19 == lVar25) {
                        ...
                        if (lVar34 < lVar4) {
                           ...
                           LAB_00103182:iVar26 = 1;
                        }
 else {
                           LAB_0010318c:iVar26 = 0;
                        }

                        LAB_00102827:lVar19 = *(long*)( this + 0x20 );
                        ...
                        if (lVar19 == lVar32) {
                           ...
                           lVar34 = *(long*)( this + 0x18 );
                           if (lVar34 < lVar4) {
                              LAB_001030d2:if (lVar4 == lVar3) goto LAB_00102814;
                              goto LAB_00102877;
                           }

                           LAB_0010316f:iVar26 = 2;
                           goto LAB_00102827;
                        }

                        if (lVar4 == lVar3) {
                           LAB_00102814:iVar26 = 0;
                           if (lVar25 <= lVar19) {
                        ...
                        LAB_0010286a:lVar34 = *(long*)( this + 0x18 );
                        if (lVar4 == lVar34) {
                           iVar26 = 0;
                           if (lVar25 <= lVar19) {
                        ...
                        LAB_00102877:if (lVar19 < lVar25) goto LAB_0010318c;
 ...
 while ( local_80 <= uVar24 );
      if (local_ac == 4) {
         if (( ( ( iVar17 != 4 ) && ( *(long*)( this + 0x48 ) <= *(long*)this ) ) && ( *(long*)( this + 0x10 ) <= *(long*)( this + 0x58 ) ) ) && ( ( *(long*)( this + 0x50 ) <= *(long*)( this + 8 ) && ( *(long*)( this + 0x18 ) <= *(long*)( this + 0x60 ) ) ) )) {
...
;
                        ...
                        LAB_00102ab8:do {
                           ...
                           LAB_00102ad6:if (plVar21[1] < lVar19) goto LAB_00102ac8;
                           bVar11 = true;
                           if (plVar30 == plVar21) goto LAB_00102af0;
                           LAB_00102b38:lVar3 = plVar21[1];
                           lVar25 = *plVar36;
                           plVar33 = plVar21 + -2;
                           if (plVar9 == plVar21) {
                              plVar33 = plVar1;
                           ...
                           if (lVar19 != lVar3) {
                              ...
                              if (lVar25 < lVar4) {
                                 if (lVar29 <= lVar25) {
                                    LAB_00102b73:dVar38 = (double)( lVar4 - lVar29 ) * (double)( lVar19 - lVar3 ) - (double)( lVar3 - plVar33[1] ) * (double)( lVar25 - lVar4 );
                           ...
                           if (( lVar25 == lVar4 ) || ( ( lVar19 == plVar33[1] && ( lVar25 < *plVar33 != lVar25 < lVar4 ) ) )) goto joined_r0x00103056;
                           plVar21 = plVar21 + 2;
                        }
 while ( plVar21 != plVar31 );
                        plVar30 = plVar31;
                        if (bVar11 == bVar37) {
                           LAB_00102f1b:if (bVar12) {
                              iVar17 = iVar17 + -1;
                              goto LAB_00102f27;
                           }
                        ...
                        LAB_00102e9f:plVar31 = plVar30 + -2;
                        if (plVar30 == plVar9) {
                           plVar31 = plVar1;
                        }

                        LAB_00102eac:dVar38 = (double)( *plVar30 - *plVar31 ) * (double)( lVar19 - plVar30[1] ) - (double)( plVar30[1] - plVar31[1] ) * (double)( lVar25 - *plVar30 );
                        if (dVar38 != 0.0) {
                        ...
                        joined_r0x00103056:plVar36 = plVar36 + 2;
                        if (plVar7 == plVar36) goto LAB_00102f40;
                     }
;
                  }

                  LAB_00103077:iVar17 = iVar17 + 1;
                  LAB_00102f27:iVar26 = -iVar17;
                  if (0 < iVar17) {
                     iVar26 = iVar17;
                  }

               }
 while ( ( iVar26 < 2 ) && ( plVar36 = plVar7 != plVar36 ) );
               LAB_00102f40:if (0 < iVar17) goto LAB_00102530;
            }
            ...
            while (true) {
               ...
               if (*(long*)( local_58 + 0x18 ) == 0) {
                  *(vector<Clipper2Lib::OutPt2*,std::allocator<Clipper2Lib::OutPt2*>>**)( local_58 + 0x18 ) = (vector<Clipper2Lib::OutPt2*,std::allocator<Clipper2Lib::OutPt2*>>*)( this + lVar25 * 0x30 + 0xd0 );
                  plVar18 = *(long**)( this + lVar25 * 0x30 + 0xd8 );
                  if (plVar18 == *(long**)( this + lVar25 * 0x30 + 0xe0 )) {
                     std::vector<Clipper2Lib::OutPt2*,std::allocator<Clipper2Lib::OutPt2*>>::_M_realloc_insert<Clipper2Lib::OutPt2*const&>((vector<Clipper2Lib::OutPt2*,std::allocator<Clipper2Lib::OutPt2*>>*)( this + lVar25 * 0x30 + 0xd0 ), plVar18, &local_58);
                  }
 else {
                     *plVar18 = local_58;
...
;
      ...
      if (local_88 == local_ac) {
         ...
         LAB_001024aa:local_8c = local_88;
         iVar17 = local_88;
         do {
            iVar26 = *piVar35;
            if (iVar26 != iVar17) {
 ...
 while ( piVar6 != piVar35 );
      ...
      LAB_00102530:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }

      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
      LAB_00102ac8:plVar21 = plVar21 + 2;
      bVar11 = true;
      if (plVar30 == plVar21) {
         LAB_00102af0:if (( plVar30 == plVar31 ) || ( plVar9 == plVar31 )) {
...
;
   ...
   vector *Clipper2Lib::RectClip64::Execute(vector *param_1) {
      ...
      *(undefined1(*) [16])param_1 = (undefined1[16])0x0;
      if (( lVar14 < *(long*)( in_RSI + 0x18 ) ) && ( *(long*)in_RSI < *(long*)( in_RSI + 0x10 ) )) {
         ...
         joined_r0x00103227:if (pvVar16 != pvVar1) {
            do {
 ...
 while ( plVar10 != plVar2 );
                     ...
                     *(long*)( in_RSI + 0x60 ) = lVar20;
                     if (lVar22 <= lVar21) {
                        ...
                        if (lVar28 <= lVar26) {
                           if (( ( ( lVar4 < lVar14 ) || ( lVar17 < lVar3 ) ) || ( lVar19 < lVar22 ) ) || ( lVar21 < lVar20 )) {
                              pRVar27 = in_RSI + 0xd0;
                              uVar23 = 0;
                                 ...
                                 if (pvStack_90 == local_98) {
                                    ...
                                    *(ulong*)pauVar6[1] = (long)pvVar11 + uVar18;
                                    ...
                                    do {
                                       ...
                                       *(undefined8*)( (long)pvVar11 + uVar15 ) = *(undefined8*)( (long)pvVar12 + uVar15 );
 ...
 while ( uVar15 != uVar18 );
                                    ...
                                    *(long*)( param_1 + 8 ) = *(long*)( param_1 + 8 ) + 0x18;
                                    LAB_0010340e:operator_delete(pvVar12, local_88 - (long)pvVar12);
                                 }
...
;
 ...
 while ( true );
      ...
      LAB_00103707:/* WARNING: Subroutine does not return */__stack_chk_fail();
      code_r0x00103600:*(undefined8*)pauVar6[1] = 0;
      *pauVar6 = (undefined1[16])0x0;
      uVar18 = uVar23;
 ...
 while ( lVar17 != lVar19 );
      ...
      *(long*)( param_1 + 8 ) = *(long*)( param_1 + 8 ) + 0x18;
      ...
      joined_r0x00103700:while ((long)uVar18 < 0) {
...
;
                        ...
                        if (lVar13 != lVar15) {
                           do {
                              ...
                              if (pOStack_90 == local_98) {
                                 LAB_00103ab6:if (pOVar4 != (OutPt2*)0x0) goto LAB_001038ec;
                              }
 else {
                                 pauVar3 = *(undefined1(**) [16])( param_1 + 8 );
                                 if (pauVar3 == *(undefined1(**) [16])( param_1 + 0x10 )) {
                                    std::vector<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>,std::allocator<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point < long>>>> > ::_M_realloc_insert<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>&>(( vector<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>,std::allocator<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point < long>>>> > *)param_1,pauVar3,&local_98 ));
                                    goto LAB_00103ab6;
                                 }
 ...
 while ( uVar14 != uVar11 );
                                 ...
                                 *(long*)( param_1 + 8 ) = *(long*)( param_1 + 8 ) + 0x18;
                                 LAB_001038ec:operator_delete(pOVar4, local_88 - (long)pOVar4);
                              }
 ...
 while ( lVar13 != lVar15 );
                        ...
                        LAB_00103920:local_a0 = (_Deque_base<Clipper2Lib::OutPt2,std::allocator<Clipper2Lib::OutPt2>>*)&local_98;
                        ...
                        *(OutPt2**)( in_RSI + 0xb0 ) = pOVar10;
                        ...
                        local_58 = uVar6;
                        lStack_50 = lVar13;
                        std::_Deque_base<Clipper2Lib::OutPt2,std::allocator<Clipper2Lib::OutPt2>>::~_Deque_base(local_a0);
                        if (*(long*)( in_RSI + 400 ) != *(long*)( in_RSI + 0x198 )) {
                           *(long*)( in_RSI + 0x198 ) = *(long*)( in_RSI + 400 );
                        }
 ...
 while ( pvVar1 != pvVar18 );
      ...
      LAB_00103ae2:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }

   /* std::_Deque_base<Clipper2Lib::OutPt2, std::allocator<Clipper2Lib::OutPt2> >::~_Deque_base() */
   void std::_Deque_base<Clipper2Lib::OutPt2,std::allocator<Clipper2Lib::OutPt2>>::~_Deque_base(_Deque_base<Clipper2Lib::OutPt2,std::allocator<Clipper2Lib::OutPt2>> *this) {
      long lVar1;
      undefined8 *puVar2;
      void *pvVar3;
      pvVar3 = *(void**)this;
 ...
 while ( puVar2 < (undefined8*)( lVar1 + 8U ) );
   ...
   void std::vector<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>,std::allocator<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>>>::_M_realloc_insert<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>const&>(vector<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>,std::allocator<std::vector<Clipper2Lib::Point<long>,std::allocator < Clipper2Lib::Point<long>>>> > *this, undefined8 *param_2, long *param_3) {
      ...
      uVar16 = 0x555555555555555;
      LAB_00103d55:while (true) {
         puVar11 = (undefined8*)operator_new(uVar6);
         LAB_00103be2:lVar5 = param_3[1];
         lVar14 = *param_3;
         ...
         *pauVar15 = (undefined1[16])0x0;
         ...
         if (uVar6 < 0x7ffffffffffffff1) {
            ...
            lVar5 = param_3[1];
            lVar14 = *param_3;
            LAB_00103c45:*(void**)*pauVar15 = pvVar7;
 ...
 while ( puVar1 != puVar10 );
         ...
         LAB_00103dc5:if (0x555555555555555 < uVar16) {
            uVar16 = 0x555555555555555;
         }
...
;
   ...
   void std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>::_M_realloc_insert<Clipper2Lib::Point<long>const&>(vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>> *this, undefined8 *param_2, undefined8 *param_3) {
      undefined8 *puVar1;
      undefined8 *puVar2;
      undefined8 uVar3;
      undefined8 uVar4;
      ...
      if (puVar2 == puVar1) {
         ...
         uVar7 = uVar7 << 4;
         LAB_00103f02:puVar6 = (undefined8*)operator_new(uVar7);
         uVar3 = param_3[1];
 ...
 while ( puVar10 + 2 != (undefined8*)( ( (long)param_2 - (long)puVar2 ) + (long)puVar6 ) );
         ...
         uVar7 = uVar5 * 2;
         if (uVar7 < uVar5) {
            LAB_00103ef8:uVar7 = 0x7ffffffffffffff0;
            goto LAB_00103f02;
         }
      ...
      LAB_00103ebc:if (puVar2 != (undefined8*)0x0) {
         operator_delete(puVar2, *(long*)( this + 0x10 ) - (long)puVar2);
      }
   ...
   void std::vector<Clipper2Lib::OutPt2*,std::allocator<Clipper2Lib::OutPt2*>>::_M_realloc_insert<Clipper2Lib::OutPt2*const&>(vector<Clipper2Lib::OutPt2*,std::allocator<Clipper2Lib::OutPt2*>> *this, void *param_2, undefined8 *param_3) {
      void *__dest;
      void *pvVar1;
      void *__src;
      ulong uVar2;
      ...
      if (__src == pvVar1) {
         ...
         uVar3 = uVar3 << 3;
         LAB_0010404a:__dest_00 = operator_new(uVar3);
         lVar4 = uVar3 + (long)__dest_00;
      }
 else {
         uVar3 = uVar2 * 2;
         if (uVar3 < uVar2) {
            LAB_00104040:uVar3 = 0x7ffffffffffffff8;
            goto LAB_0010404a;
         }
      ...
      *(undefined8*)( (long)__dest_00 + __n ) = *param_3;
      ...
      LAB_0010401c:*(void**)this = __dest_00;
   ...
   void std::deque<Clipper2Lib::OutPt2,std::allocator<Clipper2Lib::OutPt2>>::_M_push_back_aux<Clipper2Lib::OutPt2>(deque<Clipper2Lib::OutPt2,std::allocator<Clipper2Lib::OutPt2>> *this, OutPt2 *param_1) {
      undefined8 *puVar1;
      undefined8 uVar2;
      void *pvVar3;
      long lVar4;
      ...
      if (( *(long*)( this + 0x20 ) - *(long*)( this + 0x10 ) >> 4 ) * -0x5555555555555555 + ( *(long*)( this + 0x30 ) - *(long*)( this + 0x38 ) >> 4 ) * -0x5555555555555555 + ( ( lVar7 >> 3 ) + -1 + ( ulong )(plVar8 == (long*)0x0) ) * 10 == 0x2aaaaaaaaaaaaaa) {
         LAB_001043cc:/* WARNING: Subroutine does not return */std::__throw_length_error("cannot create std::deque larger than max_size()");
      }
      ...
      if (( ulong )((long)__dest * 2) < uVar6) {
         ...
         if (uVar6 == 0) {
            uVar6 = 0x18;
            uVar9 = 3;
            LAB_00104283:unaff_R15 = operator_new(uVar6);
            __src = *(long**)( this + 0x28 );
         ...
         *(void**)this = unaff_R15;
         *(ulong*)( this + 8 ) = uVar9;
         LAB_001042d4:lVar4 = *__dest;
      }

      LAB_001042d7:*(long*)( this + 0x18 ) = lVar4;
      ...
      *(long*)( this + 0x40 ) = lVar7 + 0x1e0;
      LAB_001041dd:pvVar3 = operator_new(0x1e0);
   ...
   OutPt2 * __thiscallstd::deque<Clipper2Lib::OutPt2,std::allocator<Clipper2Lib::OutPt2>>::emplace_back<Clipper2Lib::OutPt2>(deque<Clipper2Lib::OutPt2,std::allocator<Clipper2Lib::OutPt2>> * this, OutPt2 * param_1) * puVar1;
   undefined8 uVar2;
   undefined8 *puVar3;
   puVar1 = *(undefined8**)( this + 0x30 );
...
/* void std::vector<Clipper2Lib::Location, std::allocator<Clipper2Lib::Location>
   ...
   std::allocator<Clipper2Lib::Location> > >, Clipper2Lib::Location const&) */void std::vector<Clipper2Lib::Location,std::allocator<Clipper2Lib::Location>>::_M_realloc_insert<Clipper2Lib::Location_const&>(vector<Clipper2Lib::Location,std::allocator<Clipper2Lib::Location>> *this, void *param_2, undefined4 *param_3) {
   void *__dest;
   void *pvVar1;
   void *__src;
   ulong uVar2;
   ...
   if (__src == pvVar1) {
      ...
      uVar3 = uVar3 << 2;
      LAB_0010452a:__dest_00 = operator_new(uVar3);
      lVar4 = uVar3 + (long)__dest_00;
   }
 else {
      uVar3 = uVar2 * 2;
      if (uVar3 < uVar2) {
         LAB_00104520:uVar3 = 0x7ffffffffffffffc;
         goto LAB_0010452a;
      }
   ...
   *(undefined4*)( (long)__dest_00 + __n ) = *param_3;
   ...
   operator_delete(__src, *(long*)( this + 0x10 ) - (long)__src);
   LAB_001044fb:*(void**)this = __dest_00;
   *(size_t*)( this + 8 ) = (long)__dest + __n_00;
   *(long*)( this + 0x10 ) = lVar4;
   return;
}
/* void std::vector<std::vector<Clipper2Lib::Point<long>, std::allocator<Clipper2Lib::Point<long> >
   ...
   std::allocator<Clipper2Lib::Point<long> > >, std::allocator<std::vector<Clipper2Lib::Point<long>,
   std::allocator<Clipper2Lib::Point<long> > > > > >, std::vector<Clipper2Lib::Point<long>,
   std::allocator<Clipper2Lib::Point<long> > >&) */void std::vector<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>,std::allocator<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>>>::_M_realloc_insert<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>&>(vector<std::vector<Clipper2Lib::Point<long>,std::allocator<Clipper2Lib::Point<long>>>,std::allocator<std::vector<Clipper2Lib::Point<long>,std::allocator < Clipper2Lib::Point<long>>>> > *this, undefined8 *param_2, long *param_3) {
   undefined8 *puVar1;
   undefined8 *puVar2;
   undefined8 uVar3;
   undefined8 uVar4;
   ...
   uVar6 = 0x7ffffffffffffff8;
   uVar16 = 0x555555555555555;
   LAB_001047d5:while (true) {
      puVar11 = (undefined8*)operator_new(uVar6);
      LAB_00104662:lVar5 = param_3[1];
      lVar14 = *param_3;
      pauVar15 = (undefined1(*) [16])( *pauVar15 + (long)puVar11 );
      *(undefined8*)pauVar15[1] = 0;
      *pauVar15 = (undefined1[16])0x0;
      ...
      if (uVar6 < 0x7ffffffffffffff1) {
         ...
         lVar5 = param_3[1];
         lVar14 = *param_3;
         LAB_001046c5:*(void**)*pauVar15 = pvVar7;
         *(ulong*)pauVar15[1] = uVar6 + (long)pvVar7;
         if (lVar5 != lVar14) {
            lVar12 = 0;
            do {
 ...
 while ( puVar1 != puVar10 );
      ...
      std::__throw_bad_array_new_length();
      param_3 = extraout_RDX;
      LAB_00104845:if (0x555555555555555 < uVar16) {
         uVar16 = 0x555555555555555;
      }
...
/* Clipper2Lib::GetSegmentIntersection(Clipper2Lib::Point<long> const&, Clipper2Lib::Point<long>
   const&, Clipper2Lib::Point<long> const&, Clipper2Lib::Point<long> const&,
   Clipper2Lib::Point<long>&) */void Clipper2Lib::_GLOBAL__sub_I_GetSegmentIntersection(void) {
   return;
}
/* WARNING: Control flow encountered bad instruction data *//* std::_Deque_base<Clipper2Lib::OutPt2, std::allocator<Clipper2Lib::OutPt2> >::~_Deque_base() */void std::_Deque_base<Clipper2Lib::OutPt2,std::allocator<Clipper2Lib::OutPt2>>::~_Deque_base(_Deque_base<Clipper2Lib::OutPt2,std::allocator<Clipper2Lib::OutPt2>> *this) {

/* bracketProcessBoundary(BracketData*, int, unsigned char, unsigned char) */void bracketProcessBoundary(BracketData *param_1, int param_2, uchar param_3, uchar param_4) {
   undefined2 uVar1;
   int iVar2;
   BracketData BVar3;
   uint uVar4;
   if (( 0x780000UL >> ( ( ulong ) * (byte*)( *(long*)( *(long*)param_1 + 0x70 ) + (long)param_2 ) & 0x3f ) & 1 ) == 0) {
...
/* fixN0c(BracketData*, int, int, unsigned char) */void fixN0c(BracketData *param_1, int param_2, int param_3, uchar param_4) {
   int iVar1;
   int iVar2;
   int iVar3;
   long lVar4;
...
/* addPoint(UBiDi*, int, int) */void addPoint(UBiDi *param_1, int param_2, int param_3) {
   int *piVar1;
   long lVar2;
   int iVar3;
   long lVar4;
   ...
   *(long*)( param_1 + 0x1b0 ) = lVar2;
   if (lVar2 == 0) {
      *(long*)( param_1 + 0x1b0 ) = lVar4;
      LAB_00100247:*(undefined4*)( param_1 + 0x1ac ) = 7;
      return;
   }

   iVar3 = *(int*)( param_1 + 0x1a4 );
   *(int*)( param_1 + 0x1a0 ) = *(int*)( param_1 + 0x1a0 ) << 1;
   LAB_001001ae:piVar1 = (int*)( lVar2 + (long)iVar3 * 8 );
   *piVar1 = param_2;
   piVar1[1] = param_3;
   *(int*)( param_1 + 0x1a4 ) = iVar3 + 1;
   return;
}
/* processPropertySeq(UBiDi*, LevState*, unsigned char, int, int) */void processPropertySeq(UBiDi *param_1, LevState *param_2, uchar param_3, int param_4, int param_5) {
   LevState *pLVar1;
   LevState LVar2;
   char cVar3;
   LevState LVar4;
...
LAB_0010076b:
   ...
   LAB_001002b4:lVar8 = (long)param_4;
   bVar7 = false;
   LAB_001002b9:if (( cVar3 != '\0' ) || ( bVar7 )) {
...
/* bracketAddOpening(BracketData*, char16_t, int) */undefined8 bracketAddOpening(BracketData *param_1, wchar16 param_2, int param_3) {
   int *piVar1;
   ushort uVar2;
   int iVar3;
   long lVar4;
   ...
   if (puVar5 == (undefined8*)0x0) {
      ...
      *(undefined8**)( lVar4 + 0x48 ) = puVar5;
      ...
      LAB_00100995:*(int*)( lVar4 + 0x24 ) = iVar9;
   }
   ...
   *(int*)( param_1 + 0x1f0 ) = (int)( (ulong)(long)iVar9 / 0x18 );
   uVar2 = *(ushort*)( param_1 + (long)iVar3 * 0x10 + 0x1fe );
   LAB_0010090d:piVar1 = (int*)( puVar5 + (ulong)uVar2 * 3 );
...
/* bracketProcessChar(BracketData*, int) */undefined8 bracketProcessChar(BracketData *param_1, int param_2) {
   byte bVar1;
   ushort uVar2;
   wchar16 wVar3;
   char cVar4;
         ...
         do {
            ...
            if (*(uint*)( *(long*)( param_1 + 0x1e8 ) + 4 + lVar24 ) == (uint)(ushort)wVar3) {
               ...
               if (( (byte)pBVar20[0x200] & 1 ) == 0) {
                  ...
                  uVar15 = '\0';
                  LAB_00100c39:*(char*)( lVar11 + *piVar17 ) = (char)uVar16;
 ...
 while ( uVar18 != uVar13 - 1 );
 ...
 else if (( wVar6 == L'〉' ) && ( cVar4 = bracketAddOpening(param_1, L'〉', param_2) ),cVar4 == '\0') {
               return 0;
            }
   ...
   while (true) {
      piVar17[1] = 0;
      piVar17 = piVar17 + -6;
      if ((int*)( lVar14 + -0x30 + (long)(int)uVar18 * 0x18 + ( ulong )(( uVar18 - uVar13 ) - 1) * -0x18 ) == piVar17) break;
      LAB_00100ed0:if (*piVar17 != iVar8) break;
   }
;
   LAB_00100ed4:uVar13 = *(ushort*)( pBVar20 + 0x1fe );
 ...
 while ( (int*)( lVar14 + 0x34 + ( ( ulong )(( uVar13 - 2 ) - uVar18) + (long)(int)uVar18 ) * 0x18 ) != piVar17 );
   }
   ...
   while (true) {
      ...
      *(ushort*)( pBVar20 + 0x1fe ) = uVar7;
      ...
      LAB_00100cbc:if (*(int*)( lVar14 + -0x18 ) != iVar8) break;
   }
;
   LAB_00100cc1:lVar14 = *(long*)param_1;
   lVar11 = *(long*)( lVar14 + 0x78 );
   if ((char)uVar16 == '\n') {
      LAB_00100bf6:bVar1 = *(byte*)( *(long*)( lVar14 + 0x78 ) + lVar22 );
      if (-1 < (char)bVar1) {
         switchD_00100ab0_caseD_3:param_1[lVar21 * 0x10 + 0x202] = BVar12;
         return 1;
      }

      BVar25 = ( BracketData )(bVar1 & 1);
      LAB_00100ac7:uVar5 = CONCAT11(BVar25, BVar25);
      LAB_00100acc:lVar14 = lVar21 * 0x10;
      ...
      *(int*)( param_1 + lVar14 + 0x1f8 ) = param_2;
      ...
      LAB_00100af9:uVar7 = *(ushort*)( param_1 + lVar21 * 0x10 + 0x1fc );
 ...
 while ( piVar17 != (int*)( lVar14 + 0x18 + ( ( ulong )(( uVar2 - 1 ) - (uint)uVar7) + (ulong)uVar7 ) * 0x18 ) );
      return 1;
   }

   LAB_00100cd3:pbVar23 = (byte*)( lVar22 + lVar11 );
   pBVar20[0x202] = (BracketData)0xa;
   *(uint*)( pBVar20 + 0x204 ) = uVar16;
   *(int*)( pBVar20 + 0x1f8 ) = param_2;
   if (-1 < (char)*pbVar23) goto LAB_00100cf9;
   uVar13 = *(ushort*)( pBVar20 + 0x1fc );
   BVar12 = ( BracketData )(*pbVar23 & 1);
   pBVar20[0x201] = BVar12;
   if ((int)(uint)uVar13 < (int)uVar18) {
      lVar14 = *(long*)( param_1 + 0x1e8 ) + (ulong)uVar13 * 0x18;
      lVar11 = *(long*)( param_1 + 0x1e8 ) + ( (ulong)uVar13 + ( ulong )(uVar18 - uVar13) ) * 0x18;
      uVar13 = ( ushort )(1 << (sbyte)BVar12);
      if (( (int)lVar11 - (int)lVar14 & 8U ) != 0) {
         *(ushort*)( lVar14 + 0xc ) = *(ushort*)( lVar14 + 0xc ) | uVar13;
         lVar14 = lVar14 + 0x18;
         if (lVar11 == lVar14) goto LAB_00100fa1;
      }

      do {
         *(ushort*)( lVar14 + 0xc ) = *(ushort*)( lVar14 + 0xc ) | uVar13;
         *(ushort*)( lVar14 + 0x24 ) = *(ushort*)( lVar14 + 0x24 ) | uVar13;
         lVar14 = lVar14 + 0x30;
      }
 while ( lVar11 != lVar14 );
   }

   LAB_00100fa1:*pbVar23 = *pbVar23 & 0x7f;
   lVar11 = *(long*)( *(long*)param_1 + 0x78 );
   LAB_00100cf9:pbVar23 = (byte*)( lVar11 + *(int*)( *(long*)( param_1 + 0x1e8 ) + lVar24 ) );
   *pbVar23 = *pbVar23 & 0x7f;
   return 1;
}
/* bracketInit(UBiDi*, BracketData*) [clone .constprop.0] */void bracketInit(UBiDi *param_1, BracketData *param_2) {
   BracketData BVar1;
   int iVar2;
   int *piVar3;
   uint uVar4;
   ...
   *(undefined4*)( param_2 + 0x1fc ) = 0;
   if (( param_1[0x8e] == (UBiDi)0x0 ) || ( piVar3= *(int **)(param_1 + 0xd0),0 < *piVar3 )) {
      ...
      if (iVar2 < 1) {
         ...
         do {
            if (0 < *piVar7) {
               if (iVar5 < iVar2) goto LAB_00101189;
               break;
            }
 ...
 while ( iVar2 != iVar5 );
         iVar5 = iVar2 + -1;
         LAB_00101189:param_2[0x200] = *(BracketData*)( piVar3 + (long)iVar5 * 2 + 1 );
         iVar5 = 0;
         piVar7 = piVar3;
         do {
            if (0 < *piVar7) {
               if (iVar5 < iVar2) goto LAB_001011b7;
               break;
            }
 ...
 while ( iVar2 != iVar5 );
      ...
      LAB_001011b7:uVar4 = piVar3[(long)iVar5 * 2 + 1];
   }
...
/* getDirProps(UBiDi*) */undefined8 getDirProps(UBiDi *param_1) {
   uint *puVar1;
   UBiDi UVar2;
   ushort uVar3;
   ushort uVar4;
      ...
      *(uint*)( *(long*)( param_1 + 0xd0 ) + 4 ) = (uint)bVar11;
      if (0 < iVar15) {
         ...
         do {
            ...
            uVar29 = (uint)uVar3;
            if (( ( ( uVar29 & 0xfffffc00 ) == 0xd800 ) && ( iVar15 != iVar28 ) ) && ( uVar4 = *(ushort*)( lVar25 + 2 + (long)iVar16 * 2 )(uVar4 & 0xfc00) == 0xdc00 )) {
               iVar28 = iVar16 + 2;
               uVar29 = uVar4 + 0xfca02400 + (uint)uVar3 * 0x400;
            }

            if (( *(code**)( param_1 + 0x1c0 ) == (code*)0x0 ) || ( iVar16 = ( **(code**)( param_1 + 0x1c0 ) )(*(undefined8*)( param_1 + 0x1c8 ), uVar29) ),iVar16 == 0x17) {
 ...
 while ( iVar28 < iVar15 );
   ...
   LAB_001012e1:if (iVar6 < 1) {
      ...
      do {
         ...
         lVar17 = (long)iVar27;
         local_468 = lVar17;
         if (( ( ( uVar26 & 0xfffffc00 ) == 0xd800 ) && ( iVar6 != iVar27 ) ) && ( uVar4 = *(ushort*)( lVar23 + 2 + lVar25 * 2 )(uVar4 & 0xfc00) == 0xdc00 )) {
            iVar27 = iVar15 + 2;
         ...
         if (( *(code**)( param_1 + 0x1c0 ) == (code*)0x0 ) || ( uVar13 = ( **(code**)( param_1 + 0x1c0 ) )(*(undefined8*)( param_1 + 0x1c8 ), uVar26) ),uVar13 == 0x17) {
            uVar13 = ubidi_getClass_76_godot(uVar26);
            if (0x16 < (int)uVar13) goto LAB_00101683;
            LAB_00101384:uVar14 = ( uint )(1L << ( (byte)uVar13 & 0x3f ));
         }
 else {
            if ((int)uVar13 < 0x17) goto LAB_00101384;
            LAB_00101683:uVar13 = 10;
            uVar14 = 0x400;
         }
         ...
         *(char*)( lVar19 + lVar25 ) = cVar22;
         if ((int)uVar26 < 0x10000) {
            if (( ( uVar5 & 2 ) != 0 ) && ( ( ( ( uVar26 & 0xfffffffc ) == 0x200c || ( uVar26 - 0x202a < 5 ) ) || ( uVar26 - 0x2066 < 4 ) ) )) {
            ...
            switch (uVar13 & 0xff) {
               case 0:
          goto switchD_001013d8_caseD_0;
               case 1:
               case 0xd:
          goto switchD_001013d8_caseD_1;
               case 7:
          bVar9 = iVar27 < iVar6;
          if ((uVar26 != 0xd || !bVar9) ||
          ...
          break;
               ...
               case 0x14:
               case 0x15:
          goto switchD_001013d8_caseD_13;
               case 0x16:
          goto switchD_001013d8_caseD_16;
            }
            ...
            *(undefined1*)( lVar19 + -2 + local_468 ) = 0x12;
            if (( uVar5 & 2 ) == 0) {
               LAB_00101503:switch (uVar13 & 0xff) {
                  case 0:
            goto switchD_001013d8_caseD_0;
                  case 1:
                  case 0xd:
            goto switchD_001013d8_caseD_1;
                  default:
            goto switchD_001013d8_caseD_2;
                  case 7:
            goto switchD_001013d8_caseD_7;
                  case 0x13:
                  case 0x14:
                  case 0x15:
            goto switchD_001013d8_caseD_13;
...
LAB_001018a1:
                *(undefined4 *)(param_1 + 0x28) = 0xa0;
                ...
                if (puVar21 == (undefined8 *)0x0) goto LAB_00101b38;
                *(undefined8 **)(param_1 + 0x50) = puVar21;
                goto LAB_001018a1;
              }
...
LAB_001015c5:
              *(int *)(param_1 + 0x28) = iVar16;
              ...
              if (pUVar18 == (UBiDi *)0x0) goto LAB_00101b38;
              *(UBiDi **)(param_1 + 0x50) = pUVar18;
              goto LAB_001015c5;
            }
...
switchD_001013d8_caseD_13:
          ...
          break;
               case 0x16:
switchD_001013d8_caseD_16:
          if (local_450 == 2) {
            if (0x7d < local_44c) goto LAB_001014cc;
            uVar29 = uVar29 | 0x100000;
            if (-1 < local_44c) goto LAB_001014bc;
          }
          else if (-1 < local_44c) {
            if (local_44c < 0x7e) {
LAB_001014bc:
...
LAB_001014cc:
         ...
         switchD_001013d8_caseD_2:iVar15 = iVar27;
      }
 while ( iVar27 < iVar6 );
      uVar26 = *(uint*)( param_1 + 0x88 ) & 4;
      bVar10 = (bool)( local_43c == 1 & bVar8 );
      LAB_00101711:if (local_44c < 0x7e) {
         if (local_44c < 0) goto LAB_00101721;
         if (local_450 != 2) {
            piVar24 = local_238 + local_44c;
            do {
               iVar15 = *piVar24;
               if (piVar24 == local_238) goto LAB_00101721;
               piVar24 = piVar24 + -1;
            }
 while ( iVar15 != 2 );
         }
 ...
 while ( lVar19 != lVar23 );
   ...
   *(int*)( param_1 + 0xc0 ) = local_440;
   uVar20 = 1;
   LAB_001017bf:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* resolveImplicitLevels(UBiDi*, int, int, unsigned char, unsigned char) */void resolveImplicitLevels(UBiDi *param_1, int param_2, int param_3, uchar param_4, uchar param_5) {
   ushort uVar1;
   long lVar2;
   int *piVar3;
   bool bVar4;
   ...
   if (param_2 < *(int*)( param_1 + 0xc0 )) {
      if (( param_1[0x8e] == (UBiDi)0x0 ) || ( piVar3 = param_2 < *piVar3 )) {
         ...
         if (0 < iVar28) {
            do {
               if (param_2 < *piVar17) {
                  if (iVar7 < iVar28) goto LAB_001020a3;
                  break;
               }
 ...
 while ( iVar28 != iVar7 );
         ...
         iVar7 = iVar28 + -1;
         LAB_001020a3:uVar9 = piVar3[(long)iVar7 * 2 + 1];
      }
   ...
   if (( param_2 == 0 ) && ( 0 < *(int*)( param_1 + 0x98 ) )) {
      ...
      do {
         ...
         if (( ( ( uVar9 & 0xfffffc00 ) == 0xdc00 ) && ( iVar28 != 0 ) ) && ( uVar8 = ( uint ) * (ushort*)( lVar13 + -2 + (long)iVar28 * 2 )(uVar8 & 0xfffffc00) == 0xd800 )) {
            iVar28 = iVar7 + -2;
            uVar9 = uVar9 + 0xfca02400 + uVar8 * 0x400;
            pcVar12 = *(code**)( param_1 + 0x1c0 );
            if (pcVar12 == (code*)0x0) goto LAB_00102188;
            LAB_001020e0:uVar8 = ( *pcVar12 )(*(undefined8*)( param_1 + 0x1c8 ), uVar9);
            if (uVar8 == 0x17) goto LAB_00102188;
         }
 else {
            pcVar12 = *(code**)( param_1 + 0x1c0 );
            if (pcVar12 != (code*)0x0) goto LAB_001020e0;
            LAB_00102188:uVar8 = ubidi_getClass_76_godot(uVar9);
         }

         if ((int)uVar8 < 0x17) {
            cVar6 = (char)uVar8;
            if (cVar6 == '\0') goto LAB_00101c8e;
 ...
 while ( iVar28 != 0 );
   ...
   LAB_00101c8e:if (*(char*)( lVar2 + uVar18 ) == '\x16') {
   ...
   uVar8 = param_2;
   LAB_00101cdd:uVar25 = (undefined2)uVar26;
         ...
         while (true) {
            ...
            if (bVar5 == 7) {
               *(undefined4*)( param_1 + 0x144 ) = 0xffffffff;
               ...
               uVar9 = 1;
               if (bVar5 != 0xd) {
                  if (bVar5 != 2) goto LAB_00101df0;
                  if ((int)uVar8 < local_70) {
                     LAB_00101d48:uVar9 = ( local_69 == 0xd ) + 2;
                  }
 else {
 ...
 while ( (int)lVar13 < param_3 );
               ...
               LAB_00101df0:uVar9 = (uint)(byte)groupProp[bVar5];
            }
            ...
            uVar9 = (uint)bVar5;
            LAB_00101d79:uVar25 = (undefined2)uVar27;
            if (bVar5 != 0) {
            ...
            pUVar22 = pUVar21;
            uVar26 = uVar27;
            if (param_3 < (int)uVar18) goto LAB_00101ed0;
         }
;
         ...
         if (param_2 < param_3 + -1) {
            ...
            do {
               ...
               if (( 0x5d800UL >> ( (ulong)(byte)UVar16 & 0x3f ) & 1 ) == 0) goto LAB_00101e5b;
               lVar13 = lVar10 + -1;
            }
 while ( ( (long)param_3 + -3 ) - ( ulong )(uint)(( param_3 + -2 ) - param_2) != lVar10 + -1 );
         ...
         LAB_00101e5b:if (( byte )((char)UVar16 - 0x14U) < 2) goto LAB_00101ed8;
         puVar15 = impTabProps + uVar26 * 0x10;
         bVar5 = (byte)puVar15[param_5] >> 5;
         uVar27 = ( ulong )((byte)puVar15[param_5] & 0x1f);
         uVar9 = (uint)bVar5;
         pUVar23 = pUVar20;
         if (( param_3 != uVar8 ) || ( bVar5 != 0 )) goto LAB_00101d79;
         bVar5 = impTabProps[uVar26 * 0x10 + 0xf];
         LAB_00101e9d:uVar25 = (undefined2)uVar27;
         pUVar23 = pUVar22;
 ...
 while ( (int)uVar18 <= param_3 );
      LAB_00101ed0:pUVar20 = (UBiDi*)(long)( param_3 + -1 );
      pUVar21 = pUVar22;
   }

   LAB_00101ed8:local_7d = param_5;
   if (( *(int*)( param_1 + 0x14 ) == param_3 ) && ( iVar7= *(int *)(param_1 + 0xa8),0 < iVar7 )) {
      ...
      do {
         ...
         uVar8 = (uint)uVar19;
         if (( ( ( uVar8 & 0xfffffc00 ) == 0xd800 ) && ( iVar7 != iVar24 ) ) && ( uVar1 = *(ushort*)( lVar13 + 2 + (long)iVar28 * 2 )(uVar1 & 0xfc00) == 0xdc00 )) {
            iVar24 = iVar28 + 2;
            uVar8 = uVar1 + 0xfca02400 + (uint)uVar19 * 0x400;
         }

         if (( *(code**)( param_1 + 0x1c0 ) == (code*)0x0 ) || ( uVar9 = ( **(code**)( param_1 + 0x1c0 ) )(*(undefined8*)( param_1 + 0x1c8 ), uVar8) ),uVar9 == 0x17) {
 ...
 while ( iVar24 < iVar7 );
   ...
   LAB_00101ee2:UVar16 = pUVar20[lVar2];
   if (param_2 < param_3 + -1) {
      pUVar23 = (UBiDi*)(long)( param_3 + -2 );
      do {
         pUVar22 = pUVar23;
         UVar16 = pUVar22[lVar2 + 1];
         if (( 0x5d800UL >> ( (ulong)(byte)UVar16 & 0x3f ) & 1 ) == 0) goto LAB_00101f2b;
         pUVar23 = pUVar22 + -1;
      }
 while ( pUVar22 + -1 != pUVar20 + ( -2 - ( ulong )(( ( param_3 + -1 ) - param_2 ) - 1) ) );
   ...
   LAB_00101f2b:if (( ( byte )((char)UVar16 - 0x14U) < 2 ) && ( param_3 < *(int*)( param_1 + 0x14 ) )) {
      iVar7 = *(int*)( param_1 + 0x144 );
      *(int*)( param_1 + 0x144 ) = iVar7 + 1;
...
/* resolveExplicitLevels(UBiDi*, UErrorCode*) */uint resolveExplicitLevels(UBiDi *param_1, UErrorCode *param_2) {
   byte *pbVar1;
   uint uVar2;
   ushort uVar3;
   int iVar4;
   ...
   if (( param_1[0x8e] == (UBiDi)0x0 ) || ( piVar14= *(int **)(param_1 + 0xd0),0 < *piVar14 )) {
      ...
      if (0 < iVar6) {
         do {
            if (0 < *piVar20) {
               if (iVar11 < iVar6) goto LAB_0010252f;
               break;
            }
 ...
 while ( iVar11 != iVar6 );
      ...
      iVar11 = iVar6 + -1;
      LAB_0010252f:UVar19 = *(UBiDi*)( piVar14 + (long)iVar11 * 2 + 1 );
   }

   uVar17 = (uint)(byte)UVar19;
   *(undefined4*)( param_1 + 0x144 ) = 0;
   uVar10 = 0;
   if (( *(int*)param_2 < 1 ) && ( ( ( ( uVar25 & 0x20e002 ) != 0 || ( ( uVar10 = uVar25 & 0x20 ),uVar10 != 0 && ( uVar10 = uVar25 & 0x7ddfd8 ),uVar10 != 0 ) ) ) ) && ( uVar10 = 1(uVar25 & 0x1901825) != 0 )) {
            ...
            if (iVar4 < 1) {
              ...
              if ((param_1[0x8e] == (UBiDi)0x0) ||
                ...
                if (0 < iVar5) {
                  do {
                    if (iVar21 < *piVar20) {
                      if (iVar13 < iVar5) goto LAB_001028c3;
                      break;
                    }
                    iVar13 = iVar13 + 1;
                    piVar20 = piVar20 + 2;
...
LAB_001028c3:
              ...
              *pUVar27 = UVar19;
              iVar21 = iVar21 + 1;
              if (iVar4 <= iVar21) goto LAB_00102698;
              if ((*(short *)(lVar24 + lVar18 * 2) != 0xd) ||
                ...
                if ((param_1[0x8e] == (UBiDi)0x0) ||
                  ...
                  if (0 < iVar6) {
                    do {
                      if (iVar21 < *piVar20) {
                        if (iVar11 < iVar6) goto LAB_001029b3;
                        break;
                      }
                      iVar11 = iVar11 + 1;
                      piVar20 = piVar20 + 2;
...
LAB_00102a5e:
              ...
              else if (local_b48 == 0) goto LAB_00102a5e;
              break;
                     case 0x10:
              *pUVar27 = UVar19;
              uVar25 = uVar25 | 0x40000;
 ...
 while ( iVar21 < iVar4 );
               LAB_00102698:if (( ( ( uVar25 & 0x7fdfd8 ) != 0 ) && ( uVar25 = uVar25 | *(uint*)( (long)&flagLR + ( ulong )((byte)param_1[0x8d] & 1) * 4 ) ),param_1[0x8c] != (UBiDi)0x0 )) {
                  uVar25 = uVar25 | 1;
               }

               if (( ( uVar25 & 0x20e002 ) != 0 ) || ( ( uVar10 = uVar25 & 0x20(uVar25 & 0x20) != 0 && ( uVar10 = uVar25 & 0x7ddfd8(uVar25 & 0x7ddfd8) != 0 ) ) )) {
 ...
 while ( (int)lVar18 < *(int*)( param_1 + 200 ) );
         ...
         if (0 < *(int*)( param_1 + 200 )) {
            do {
               ...
               iVar4 = *piVar14;
               if ((int)lVar24 < iVar4) {
                  memset((void*)( lVar24 + lVar7 ), piVar14[1] & 0xff, ( ulong )(uint)(( iVar4 + -1 ) - (int)lVar24) + 1);
               }
 ...
 while ( (int)lVar22 < *(int*)( param_1 + 200 ) );
   ...
   LAB_001024d6:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar10;
   }
...
undefined8 *ubidi_openSized_76_godot(uint param_1, uint param_2, int *param_3) {
   ...
   *puVar1 = 0;
   ...
   for (uVar3 = ( ulong )(( (int)puVar1 - (int)(undefined8*)( ( ulong )(puVar1 + 1) & 0xfffffffffffffff8 ) ) + 0x1d0U >> 3); uVar3 != 0; uVar3 = uVar3 - 1) {
      *puVar5 = 0;
      ...
      if (lVar2 == 0) {
         ...
         *(uint*)( (long)puVar1 + 0x1c ) = param_1;
         if (puVar1[8] == 0) {
            lVar2 = uprv_malloc_76_godot(lVar6);
            puVar1[8] = lVar2;
            if (lVar2 == 0) goto LAB_00103111;
         }
 else {
            if ((int)param_1 <= *(int*)( puVar1 + 4 )) goto LAB_0010300a;
      ...
      *(undefined1*)( (long)puVar1 + 0x69 ) = 1;
      ...
      if (param_2 != 1) {
         ...
         if (puVar1[0xb] == 0) {
            ...
            puVar1[0xb] = lVar2;
            if (lVar2 != 0) {
               LAB_00103086:*(int*)( (long)puVar1 + 0x2c ) = iVar4;
               goto LAB_00103044;
            }

         }
 else {
            if (iVar4 <= *(int*)( (long)puVar1 + 0x2c )) goto LAB_00103044;
   ...
   LAB_00103044:if (*param_3 < 1) {
      return puVar1;
   }

   LAB_0010304c:ubidi_close_76_godot(puVar1);
   return (undefined8*)0x0;
}
undefined8 *ubidi_open_76_godot(void) {
   ...
   if (puVar1 != (undefined8*)0x0) {
      *puVar1 = 0;
      ...
      for (uVar2 = ( ulong )(( (int)puVar1 - (int)(undefined8*)( ( ulong )(puVar1 + 1) & 0xfffffffffffffff8 ) ) + 0x1d0U >> 3); uVar2 != 0; uVar2 = uVar2 - 1) {
         *puVar3 = 0;
...
undefined8 ubidi_getBaseDirection_76_godot(long param_1, int param_2) {
   ...
   if (-2 < param_2) {
      ...
      while (iVar5 < param_2) {
         ...
         uVar6 = (uint)uVar1;
         if (( ( ( uVar1 & 0xfc00 ) == 0xd800 ) && ( param_2 != iVar3 ) ) && ( uVar2 = *(ushort*)( param_1 + 2 + (long)iVar5 * 2 )(uVar2 & 0xfc00) == 0xdc00 )) {
...
void ubidi_setContext_76_godot(long param_1, long param_2, int param_3, long param_4, int param_5, int *param_6) {
   if (( param_6 != (int*)0x0 ) && ( *param_6 < 1 )) {
      if (( ( ( param_1 == 0 || param_3 < -1 ) || ( param_5 < -1 ) ) || ( ( param_2 == 0 && ( param_3 != 0 ) ) ) ) || ( ( param_4 == 0 && ( param_5 != 0 ) ) )) {
         *param_6 = 1;
      }
 else {
         if (param_3 == -1) {
...
void ubidi_setPara_76_godot(long param_1, long param_2, int param_3, char param_4, undefined8 param_5, int *param_6) {
...
void ubidi_setPara_76_godot_part_0(UBiDi *param_1, long param_2, int param_3, uint param_4, long param_5, UErrorCode *param_6) {
   uint *puVar1;
   void *__src;
   undefined4 uVar2;
   undefined4 uVar3;
         ...
         *(undefined8*)( param_1 + 0x70 ) = *(undefined8*)( param_1 + 0x38 );
         ...
         if (cVar5 != '\0') {
            ...
            *(int*)( param_1 + 0xc4 ) = iVar11;
            if (param_5 == 0) {
               cVar5 = ubidi_getMemory_76_godot(param_1 + 0x40, param_1 + 0x20, (int)(char)param_1[0x68], iVar11);
               if (cVar5 == '\0') goto LAB_001035a5;
               ...
               *(undefined4*)( param_1 + 0x144 ) = 0;
               ...
               if (iVar11 < 1) {
                  ...
                  do {
                     ...
                     if (( ( param_1[0x8e] != (UBiDi)0x0 ) && ( iVar9 == (int)lVar12 ) ) && ( iVar24 = iVar26 + 1 ),iVar24 < *(int*)( param_1 + 200 )) {
                     ...
                     if ((int)( bVar37 & 0x7f ) < (int)uVar38) {
                        if (( bVar37 & 0x7f ) != 0) {
                           LAB_00103890:*(undefined4*)param_6 = 1;
                           return;
                        }

                        uVar27 = 0;
                        if (bVar31 == 7) goto LAB_00103647;
                        *(byte*)( param_5 + lVar12 ) = bVar37 & 0x80 | (byte)uVar38;
                        uVar27 = ( ulong )(uVar38 & 1);
                        if (-1 < (char)bVar37) goto LAB_0010364f;
                        LAB_001036f3:uVar28 = uVar28 | ( &flagO )[uVar27];
                     }
 else {
                        if (0x7d < ( bVar37 & 0x7f )) goto LAB_00103890;
                        uVar27 = ( ulong )(bVar37 & 1);
                        LAB_00103647:if ((char)bVar37 < '\0') goto LAB_001036f3;
                        LAB_0010364f:uVar28 = ( uint )(1L << ( bVar31 & 0x3f )) | uVar28 | ( &flagE )[uVar27];
                     }
 ...
 while ( iVar11 != lVar12 );
                  ...
                  if (( ( uVar28 & 0x20e002 ) != 0 ) || ( ( uVar38 = uVar28 & 0x20(uVar28 & 0x20) != 0 && ( uVar38 = uVar28 & 0x7ddfd8(uVar28 & 0x7ddfd8) != 0 ) ) )) {
               ...
               if (*(int*)( param_1 + 0x30 ) < iVar9) {
                  if (*(long*)( param_1 + 0x60 ) == 0) {
                     ...
                     *(UBiDi**)( param_1 + 0x60 ) = pUVar17;
                     if (pUVar17 == (UBiDi*)0x0) goto LAB_001035a5;
                  }
 else {
               ...
               if (( ( param_5 == 0 ) && ( *(int*)( param_1 + 200 ) < 2 ) ) && ( -1 < *(int*)( param_1 + 0xbc ) )) {
                  ...
                  if (( param_1[0x8e] == (UBiDi)0x0 ) || ( piVar35= *(int **)(param_1 + 0xd0),0 < *piVar35 )) {
                     ...
                     if (0 < iVar9) {
                        do {
                           if (0 < *piVar22) {
                              if (iVar26 < iVar9) goto LAB_0010460d;
                              break;
                           }
 ...
 while ( iVar26 != iVar9 );
                     ...
                     iVar26 = iVar9 + -1;
                     LAB_0010460d:UVar7 = *(UBiDi*)( piVar35 + (long)iVar26 * 2 + 1 );
                  }
                  ...
                  do {
                     ...
                     if (( iVar9 < 1 ) || ( *(char*)( lVar13 + -1 + (long)iVar9 ) != '\a' )) {
                        LAB_00103ce3:iVar32 = iVar9 + 1;
                        if (iVar11 <= iVar32) {
                           LAB_00103df2:if (param_1[0x8e] != (UBiDi)0x0) {
                        ...
                        LAB_00103cee:uVar27 = ( ulong )(iVar9 + 1);
                        do {
                           iVar26 = (int)uVar27;
                           if (( pUVar17[uVar27] != UVar6 ) && ( ( 0x5d800UL >> ( ( ulong ) * (byte*)( lVar13 + uVar27 ) & 0x3f ) & 1 ) == 0 )) {
                              iVar26 = iVar26 + -1;
                              goto LAB_00103d1d;
                           }
 ...
 while ( (int)uVar27 < iVar11 );
                        ...
                        LAB_00103d1d:iVar32 = (int)uVar27;
                        if (iVar11 <= iVar32) goto LAB_00103df2;
                        UVar7 = pUVar17[iVar32];
                     }
 else {
                        if (( param_1[0x8e] == (UBiDi)0x0 ) || ( piVar35 = iVar9 < *piVar35 )) {
                           bVar37 = (byte)param_1[0x8d] & 1;
                           goto LAB_00103ce3;
                        }
                        ...
                        if (0 < iVar32) {
                           do {
                              if (iVar9 < *piVar22) {
                                 if (iVar24 < iVar32) goto LAB_00103eed;
                                 break;
                              }
 ...
 while ( iVar24 != iVar32 );
                        ...
                        iVar24 = iVar32 + -1;
                        LAB_00103eed:iVar32 = iVar9 + 1;
                        bVar37 = (byte)piVar35[(long)iVar24 * 2 + 1] & 1;
                        if (iVar32 < iVar11) goto LAB_00103cee;
                        LAB_00103e02:if (*piVar35 < iVar11) {
                           ...
                           if (0 < iVar24) {
                              ...
                              do {
                                 if (iVar11 + -1 < *piVar22) {
                                    if (iVar33 < iVar24) goto LAB_00103e46;
                                    break;
                                 }
 ...
 while ( iVar24 != iVar33 );
                           ...
                           iVar33 = iVar24 + -1;
                           LAB_00103e46:UVar7 = *(UBiDi*)( piVar35 + (long)iVar33 * 2 + 1 );
                        }
 else {
                           LAB_00103e60:UVar7 = param_1[0x8d];
                        }
                  ...
                  LAB_00104320:if (0 < (int)lVar36) {
                     ...
                     while (true) {
                        ...
                        if (( UVar7 == (UBiDi)0x0 ) || ( UVar6 = (UBiDi)0x0(uVar27 & 0x80) == 0 )) {
                           if (( param_1[0x8e] == (UBiDi)0x0 ) || ( piVar35 = iVar11 < *piVar35 )) {
                              UVar6 = param_1[0x8d];
                           }
 else {
                              ...
                              if (0 < iVar26) {
                                 do {
                                    if (iVar11 < *piVar22) {
                                       if (iVar9 < iVar26) goto LAB_00104473;
                                       break;
                                    }
 ...
 while ( iVar26 != iVar9 );
                              ...
                              iVar9 = iVar26 + -1;
                              LAB_00104473:UVar6 = *(UBiDi*)( piVar35 + (long)iVar9 * 2 + 1 );
                           }
                        ...
                        *(UBiDi*)( lVar19 + lVar18 ) = UVar6;
                        lVar18 = lVar18 + -1;
                        if (( lVar36 + -2 ) - (ulong)uVar38 == lVar18) goto LAB_00103950;
                     }
;
                     if (iVar11 != 0) {
                        ...
                        do {
                           ...
                           if (( uVar27 & 0x5d800 ) == 0) {
                              ...
                              if (( uVar27 & 0x180 ) != 0) goto code_r0x001043b9;
                           }
 else {
 ...
 while ( true );
            ...
            LAB_00103950:uVar38 = *(uint*)( param_1 + 0x88 );
            if (( ( ( param_1[0x8e] != (UBiDi)0x0 ) && ( ( uVar38 & 1 ) != 0 ) ) && ( *(int*)( param_1 + 0x84 ) - 5U < 2 ) ) && ( 0 < *(int*)( param_1 + 200 ) )) {
               lVar12 = 0;
               do {
                  ...
                  if ((char)piVar35[1] != '\0') {
                     ...
                     if (iVar11 <= iVar9) {
                        lVar19 = (long)iVar9;
                        LAB_001045a6:if (*(byte*)( lVar13 + lVar19 ) != 0) goto LAB_00104598;
 ...
 while ( (int)lVar12 < *(int*)( param_1 + 200 ) );
      ...
      LAB_001035a5:*(undefined4*)param_6 = 7;
      return;
   }
   ...
   *(undefined4*)( param_1 + 0x84 ) = 0;
   if (param_3 == 0) {
      ...
      if (lVar13 != 0) {
         ...
         if (0 < *(int*)param_6) goto LAB_00103865;
         uVar15 = lVar12 * 4;
                  ...
                  do {
                     ...
                     if (1 < iVar32) {
                        ...
                        do {
                           ...
                           if (( iVar23 != 1 ) || ( *(char*)( (long)__src + (long)iVar33 ) != *(char*)( (long)__src + (long)iVar24 ) )) {
                              iVar26 = iVar26 + 1;
                           }
 ...
 while ( puVar21 != puVar40 + (long)iVar9 * 3 );
                  local_70 = puVar40;
                  if (iVar26 != 0) {
                     cVar5 = ubidi_getMemory_76_godot(param_1 + 0x58, param_1 + 0x2c, (int)(char)param_1[0x69], ( iVar9 + iVar26 ) * 0xc);
                     if (cVar5 == '\0') goto LAB_001042cf;
                        ...
                        *puVar21 = ( *(byte*)( (long)__src + (long)(int)uVar38 ) ^ uVar29 ) << 0x1f | uVar38;
                        ...
                        if (uVar38 == (uint)uVar27) {
                           ...
                           do {
                              ...
                              if (( iVar9 != 1 ) || ( *(char*)( (long)__src + (long)(int)uVar28 ) != *(char*)( (long)__src + (long)(int)*puVar21 ) )) {
                                 uVar30 = *local_68;
                                 ...
                                 *(ulong*)( local_70 + (long)iVar9 * 3 ) = CONCAT44(puVar40[1], ( *(byte*)( (long)__src + (long)(int)uVar30 ) ^ uVar29 ) << 0x1f | uVar30);
                                 uVar28 = puVar40[2];
                                 iVar26 = iVar26 + -1;
 ...
 while ( iVar32 != -1 );
            ...
            LAB_001042cf:param_1[0x8d] = ( UBiDi )((byte)param_1[0x8d] ^ 1);
         }
   ...
   lVar13 = 0;
   LAB_00103865:uprv_free_76_godot(lVar13);
   *(undefined4*)( param_1 + 0x84 ) = 3;
   return;
   code_r0x001043b9:if (( param_1[0x8e] == (UBiDi)0x0 ) || ( piVar35 = iVar9 < *piVar35 )) {
      UVar6 = param_1[0x8d];
   }
 else {
      iVar26 = *(int*)( param_1 + 200 );
      ...
      if (0 < iVar26) {
         do {
            if (iVar9 < *piVar22) {
               if (iVar11 < iVar26) goto LAB_0010440c;
               break;
            }
 ...
 while ( iVar26 != iVar11 );
      ...
      iVar11 = iVar26 + -1;
      LAB_0010440c:UVar6 = *(UBiDi*)( piVar35 + (long)iVar11 * 2 + 1 );
   }

   *(UBiDi*)( lVar19 + lVar18 ) = UVar6;
   goto LAB_00104320;
   LAB_00104598:if (( ( 0x2002UL >> ( ( ulong ) * (byte*)( lVar13 + lVar19 ) & 0x3f ) & 1 ) != 0 ) || ( lVar19= lVar19 + -1,(int)lVar19 < iVar11 )) goto LAB_00104550;
   goto LAB_001045a6;
}
...
void ubidi_getParagraphByIndex_76_godot(long *param_1, int param_2, int *param_3, undefined4 *param_4, undefined1 *param_5, int *param_6) {
   int iVar1;
   long *plVar2;
   int *piVar3;
   undefined1 uVar4;
   ...
   int iVar7;
   if (( param_6 != (int*)0x0 ) && ( *param_6 < 1 )) {
      if (( param_1 == (long*)0x0 ) || ( ( plVar2 = (long*)*param_1 ),param_1 != plVar2 && ( ( plVar2 == (long*)0x0 || ( plVar2 != (long*)*plVar2 ) ) ) )) {
         *param_6 = 0x1b;
         return;
      }
      ...
      if (param_5 != (undefined1*)0x0) {
         if (( *(char*)( (long)plVar2 + 0x8e ) == '\0' ) || ( piVar3 = iVar7 < *piVar3 )) {
            ...
            if (0 < iVar1) {
               do {
                  if (iVar7 < *piVar6) {
                     if (iVar5 < iVar1) goto LAB_00104a24;
                     break;
                  }
 ...
 while ( iVar1 != iVar5 );
            ...
            iVar5 = iVar1 + -1;
            LAB_00104a24:uVar4 = (undefined1)piVar3[(long)iVar5 * 2 + 1];
         }
...
ulong ubidi_getParagraph_76_godot(long *param_1, int param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5, int *param_6) {
   long *plVar1;
   ulong uVar2;
   ulong uVar3;
   if (( param_6 == (int*)0x0 ) || ( 0 < *param_6 )) {
 ...
 while ( ( (int*)plVar1[0x1a] )[uVar2 * 2 + -2] <= param_2 );
   ...
   uVar3 = 0xffffffff;
   LAB_00104aae:return uVar3 & 0xffffffff;
}
void ubidi_setClassCallback_76_godot(long param_1, undefined8 param_2, undefined8 param_3, undefined8 *param_4, undefined8 *param_5, int *param_6) {
   if (( param_6 != (int*)0x0 ) && ( *param_6 < 1 )) {
      if (param_1 == 0) {
         *param_6 = 1;
         return;
...
/* processPropertySeq(UBiDi*, LevState*, unsigned char, int, int) [clone .cold] */void processPropertySeq(UBiDi *param_1, LevState *param_2, uchar param_3, int param_4, int param_5) {
   /* WARNING: Subroutine does not return */
   abort();
}
/* resolveImplicitLevels(UBiDi*, int, int, unsigned char, unsigned char) [clone .cold] */void resolveImplicitLevels(UBiDi *param_1, int param_2, int param_3, uchar param_4, uchar param_5) {
   /* WARNING: Subroutine does not return */
   abort();
}
/* WARNING: Unknown calling convention -- yet parameter storage is locked */void ubidi_setPara_76_godot_part_0_cold(void) {
   /* WARNING: Subroutine does not return */
   abort();
}

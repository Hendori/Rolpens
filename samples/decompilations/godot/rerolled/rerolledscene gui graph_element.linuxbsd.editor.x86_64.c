/* GraphElement::get_position_offset() const */undefined8 GraphElement::get_position_offset(GraphElement *this) {
   return *(undefined8*)( this + 0xa20 );
}
/* GraphElement::is_selected() */GraphElement GraphElement::is_selected(GraphElement *this) {
   return this[0xa00];
}
/* GraphElement::is_resizable() const */GraphElement GraphElement::is_resizable(GraphElement *this) {
   return this[0xa01];
}
/* GraphElement::set_draggable(bool) */void GraphElement::set_draggable(GraphElement *this, bool param_1) {
   this[0xa03] = (GraphElement)param_1;
   return;
}
/* GraphElement::is_draggable() */GraphElement GraphElement::is_draggable(GraphElement *this) {
   return this[0xa03];
}
/* GraphElement::is_selectable() */GraphElement GraphElement::is_selectable(GraphElement *this) {
   return this[0xa04];
}
/* GraphElement::_resort() */void GraphElement::_resort(GraphElement *this) {
   long lVar1;
   int iVar2;
   undefined8 uVar3;
   Rect2 *pRVar4;
...
/* GraphElement::get_minimum_size() const */undefined8 GraphElement::get_minimum_size(GraphElement *this) {
   int iVar1;
   undefined8 uVar2;
   long *plVar3;
   int iVar4;
...
/* GraphElement::set_resizable(bool) */void GraphElement::set_resizable(GraphElement *this, bool param_1) {
...
/* std::_Function_handler<void (Node*, StringName const&, StringName const&),
   ...
   const&)#1}>::_M_manager(std::_Any_data&, std::_Any_data const&, std::_Manager_operation) */undefined8 std::_Function_handler<void(Node *, StringName_const &, StringName_const &),GraphElement::_bind_methods()::{lambda(Node*,StringName_const&,StringName_const&)#1}>::_M_manager(undefined8 *param_1, undefined8 param_2, int param_3) {
   if (param_3 == 0) {
      *param_1;
      return 0;
   }
...
/* std::_Function_handler<void (Node*, StringName const&, StringName const&),
   ...
   LAB_00100330:if (Variant::needs_deinit[local_48[0]] != '\0') {
...
/* GraphElement::set_position_offset(Vector2 const&) */void GraphElement::set_position_offset(GraphElement *this, Vector2 *param_1) {
   long lVar1;
   int iVar2;
   long in_FS_OFFSET;
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
   if (( *(float*)( this + 0xa20 ) == *(float*)param_1 ) && ( *(float*)( this + 0xa24 ) == *(float*)( param_1 + 4 ) )) {
      if (lVar1 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
      ...
      *(undefined8*)( this + 0xa20 ) = *(undefined8*)param_1;
      if ((set_position_offset(Vector2_const&)::{lambda()
      #1
      ( iVar2 = __cxa_guard_acquire(&set_position_offset(Vector2_const & ::sname), iVar2 != 0) );
      {
         _scs_create((char*)&set_position_offset(Vector2_const & ::sname, true));
         __cxa_atexit(StringName::~StringName, &set_position_offset(Vector2_const & ::sname, &__dso_handle));
         __cxa_guard_release(&set_position_offset(Vector2_const&)::{lambda()
         #1
      }

      (**(code **)(*(long *)this + 0xd0))
              (this,&set_position_offset(Vector2_const&)::{lambda()
      #1
...
/* GraphElement::_edit_set_position(Vector2 const&) */void GraphElement::_edit_set_position(GraphElement *this, Vector2 *param_1) {
   long lVar1;
   long in_FS_OFFSET;
   float fVar2;
   undefined8 uVar3;
   ...
   if (lVar1 != 0) {
      ...
      if (lVar1 != 0) {
         ...
         local_28 = CONCAT44(( (float)( ( ulong ) * (undefined8*)param_1 >> 0x20 ) + (float)( (ulong)uVar3 >> 0x20 ) ) * fVar2, ( (float)*(undefined8*)param_1 + (float)uVar3 ) * fVar2);
...
/* GraphElement::set_selected(bool) */void GraphElement::set_selected(GraphElement *this, bool param_1) {
   long lVar1;
   int iVar2;
   undefined8 *puVar3;
   long in_FS_OFFSET;
   ...
   if (( this[0xa04] == (GraphElement)0x0 ) || ( this[0xa00] == (GraphElement)param_1 )) {
      ...
      if (param_1) {
         if (set_selected(bool)::{lambda()
         #1
         iVar2 = __cxa_guard_acquire(&set_selected(bool)::{lambda()
         #1
         if (iVar2 != 0) {
            _scs_create((char *)&set_selected(bool)::{lambda()
            #1
            __cxa_atexit(StringName::~StringName,
                       &set_selected(bool)::{lambda()
            #1
            __cxa_guard_release(&set_selected(bool)::{lambda()
            #1
         }

      }

      puVar3 = &set_selected(bool)::{lambda()
      #1
   }
...
puVar3 = &set_selected(bool)::{lambda()#2}( **(code**)( *(long*)this + 0xd0 ) )(this, puVar3, 0, 0);if (Variant::needs_deinit[0] != '\0') {
   Variant::_clear_internal();
}
if (lVar1 == *(long*)( in_FS_OFFSET + 0x28 )) {
   CanvasItem::queue_redraw();
...
}/* WARNING: Subroutine does not return */__stack_chk_fail();}/* GraphElement::set_selectable(bool) */void GraphElement::set_selectable(GraphElement *this, bool param_1) {
   if (param_1) {
...
/* GraphElement::gui_input(Ref<InputEvent> const&) */void GraphElement::gui_input(GraphElement *this, Ref *param_1) {
   undefined8 uVar1;
   char cVar2;
   int iVar3;
   Object *pOVar4;
   ...
   if (lVar6 == 0) {
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         _err_print_error("gui_input", "scene/gui/graph_element.cpp", 0x8c, "Condition \"p_ev.is_null()\" is true.", 0, 0);
         return;
      }
   ...
   if (pOVar4 == (Object*)0x0) {
      LAB_0010082e:pOVar5 = (Object*)__dynamic_cast(lVar6, &Object::typeinfo, &InputEventMouseMotion::typeinfo, 0);
      if (pOVar5 != (Object*)0x0) {
         LAB_0010084a:cVar2 = RefCounted::reference();
         if (cVar2 != '\0') {
            if (this[0xa02] != (GraphElement)0x0) {
               ...
               #3
               ( iVar3 = __cxa_guard_acquire(&gui_input(Ref < InputEvent > const & sname), iVar3 != 0) );
               {
               ...
               local_90 = CONCAT44(( (float)( (ulong)uVar8 >> 0x20 ) - (float)( (ulong)uVar9 >> 0x20 ) ) + (float)( (ulong)uVar1 >> 0x20 ), ( (float)uVar8 - (float)uVar9 ) + (float)uVar1);
      ...
      if (pOVar4 != (Object*)0x0) {
         LAB_0010085f:cVar2 = RefCounted::unreference();
         if (( cVar2 != '\0' ) && ( cVar2 = cVar2 != '\0' )) {
      ...
      if (cVar2 != '\0') {
         ...
         if (lVar6 == 0) {
            _err_print_error("gui_input", "scene/gui/graph_element.cpp", 0x90, "Parameter \"get_parent_control()\" is null.", "GraphElement must be the child of a GraphEdit node.", 0, 0);
         }
 else {
            cVar2 = InputEvent::is_pressed();
            if (( cVar2 != '\0' ) && ( iVar3 = iVar3 == 1 )) {
               ...
               (**(code **)(*(long *)this + 0xd0))
                    (this,&gui_input(Ref<InputEvent>const&)::{lambda()
               #1
               if (Variant::needs_deinit[local_78[0]] != '\0') {
                  Variant::_clear_internal();
               }
            ...
            if (( cVar2 == '\0' ) && ( iVar3 = iVar3 == 1 )) {
               if (this[0xa02] == (GraphElement)0x0) {
                  if (( *(long*)param_1 != 0 ) && ( pOVar5 = (Object*)__dynamic_cast(*(long*)param_1, &Object::typeinfo, &InputEventMouseMotion::typeinfo, 0) ),pOVar5 != (Object*)0x0) goto LAB_0010084a;
               }
 else {
   ...
   LAB_00100e39:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* GraphElement::_notification(int) */void GraphElement::_notification(GraphElement *this, int param_1) {
   if (param_1 == 0x33) {
   ...
   if (param_1 < 0x34) {
      if (( param_1 - 0x2dU & 0xfffffffb ) == 0) {
         LAB_00100ff0:Control::update_minimum_size();
         CanvasItem::queue_redraw();
         return;
      }
...
/* GraphElement::_validate_property(PropertyInfo&) const */void GraphElement::_validate_property(GraphElement *this, PropertyInfo *param_1) {
   char cVar1;
   long lVar2;
...
/* GraphElement::set_drag(bool) */void GraphElement::set_drag(GraphElement *this, bool param_1) {
   Variant *pVVar1;
   undefined8 uVar2;
   int iVar3;
   Variant *pVVar4;
   ...
   if (param_1) {
      *(undefined8*)( this + 0xa08 ) = *(undefined8*)( this + 0xa20 );
      ...
      if ((set_drag(bool)::{lambda()
      #1
      (iVar3 = __cxa_guard_acquire(&set_drag(bool)::{lambda()
      #1
      )
      {
         _scs_create((char *)&set_drag(bool)::{lambda()
         #1
  ...
  return;
}, /* GraphElement::get_drag_from() */, undefined8 __thiscall GraphElement::get_drag_from(GraphElement *this)
...
void, GraphElement::_bind_methods(void){long lVar1;
  code *pcVar2;
  ...
  piVar5 = local_98;
  if (local_98 != (int *)0x0){LOCK();
    plVar11 = (long *)(local_98 + -4);
    *plVar11 = *plVar11 + -1;
    UNLOCK();
    if (*plVar11 == 0){if (local_98 == (int *)0x0) {
                    /* WARNING: Does not return */
        pcVar2 = (code *)invalidInstructionException();
        (*pcVar2)();
      }
      ...
      }Memory::free_static(piVar5 + -4, false);}}List<PropertyInfo,DefaultAllocator>::~List((List<PropertyInfo,DefaultAllocator> *)local_a8);
  CowData<char32_t>::_unref((CowData<char32_t> *)&local_c0);
  if ((StringName::configured != '\0') && (local_d8._8_8_ != 0)){StringName::unref();}CowData<char32_t>::_unref((CowData<char32_t> *)local_d8);
  ...
  StringName::StringName((StringName *)&local_118,(String *)local_178,false);
  ClassDB::add_signal((StringName *)&local_118,(MethodInfo *)local_e8);
  if ((StringName::configured != '\0') && (CONCAT44(uStack_114,local_118) != 0)){StringName::unref();}CowData<char32_t>::_unref((CowData<char32_t> *)local_178);
  lVar1 = local_80;
  if (local_80 != 0) {
    LOCK();
    plVar11 = (long *)(local_80 + -0x10);
    *plVar11 = *plVar11 + -1;
    ...
    if (*plVar11 == 0) {
      local_80 = 0;
      Memory::free_static((void *)(lVar1 + -0x10),false);}(local_98 != (int*)0x0), {
    LOCK()(long * )(local_98 + -4) * plVar11 = *plVar11 + -1, ;
    UNLOCK());
         if (*plVar11 == 0) {
            if (local_98 == (int*)0x0) {
               /* WARNING: Does not return */
 ...
 while ( lVar1 != lVar9 );
      ...
      PropertyInfo::PropertyInfo((PropertyInfo*)&local_118, 5, (String*)&local_190, 0, (String*)&local_188, 6, (String*)&local_180);
      local_178[0] = 0;
 ...
 while ( lVar1 != lVar9 );
      ...
      PropertyInfo::PropertyInfo((PropertyInfo*)&local_148, 5, (String*)&local_198, 0, (String*)&local_190, 6, (String*)&local_188);
      local_1a0 = 0;
      local_1a8 = 0;
      String::parse_latin1((String*)&local_1a8, "");
      local_1b0 = 0;
      String::parse_latin1((String*)&local_1b0, "from");
      PropertyInfo::PropertyInfo((PropertyInfo*)local_178, 5, (String*)&local_1b0, 0, (String*)&local_1a8, 6, &local_1a0);
      local_180 = 0;
      ...
      local_f0 = local_120;
      List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)local_a8, (PropertyInfo*)local_178);
      List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)local_a8, (PropertyInfo*)&local_118);
      PropertyInfo::~PropertyInfo((PropertyInfo*)&local_118);
      local_1b8 = 0;
 ...
 while ( lVar1 != lVar9 );
      ...
      local_68._4_4_ = 0;
      uStack_60 = 0;
      pcStack_58 = std::_Function_handler<void(Node *, StringName_const &, StringName_const &),GraphElement::_bind_methods()::{lambda(Node *, StringName_const &, StringName_const &)#1}>::_M_manager;
      pcStack_50 = std::_Function_handler<void(Node *, StringName_const &, StringName_const &),GraphElement::_bind_methods()::{lambda(Node *, StringName_const &, StringName_const &)#1}>::_M_invoke;
      ...
      ThemeDB::bind_class_item(uVar7, 4, (String*)&local_148, (StringName*)&local_118, (MethodDefinition*)local_e8, &local_68);
      if (( StringName::configured != '\0' ) && ( local_148 != 0 )) {
         StringName::unref();
      }

      CowData<char32_t>::_unref((CowData<char32_t>*)local_178);
      if (( StringName::configured != '\0' ) && ( ( ( CONCAT44(uStack_114, local_118) == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) && ( local_e8[0] != 0 ) ) )) {
         StringName::unref();
      }
   ...
   uint GraphElement::is_class_ptr(void *param_1) {
      undefined4 in_EDX;
      undefined4 *in_RSI;
      return (uint)CONCAT71(0x109d, in_RSI == &Container::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x109d, in_RSI == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x109d, in_RSI == &Control::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x109d, in_RSI == &CanvasItem::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x109d, in_RSI == &Node::get_class_ptr_static(), ::ptr) | CONCAT31(( int3 )((uint)in_EDX >> 8), in_RSI == &Object::get_class_ptr_static(), ::ptr);
   }
   ...
   byte MethodBindT<Vector2_const&>::_gen_argument_type(MethodBindT<Vector2_const&> *this, int param_1) {
      return -(param_1 == 0) & 5;
   }
   ...
   [clone .cold] */
   void std::_Function_handler<void(Node *, StringName_const &, StringName_const &),GraphElement::_bind_methods()::{lambda(Node*,StringName_const&,StringName_const&)#1}>::_M_invoke(_Any_data *param_1, Node **param_2, StringName *param_3, StringName *param_4) {
      code *pcVar1;
   ...
   void GraphElement::~GraphElement(GraphElement *this) {
      Object *pOVar1;
      char cVar2;
      bool bVar3;
      ...
      *(code**)this = __cxa_guard_acquire;
      ...
      LAB_00103e44:Control::~Control((Control*)this);
      return;
   }
   ...
   void GraphElement::~GraphElement(GraphElement *this) {
      ...
      *(code**)this = __cxa_guard_acquire;
      ...
      LAB_00103f04:Control::~Control((Control*)this);
   ...
   undefined8 *GraphElement::_get_class_namev(void) {
      ...
      if (_get_class_namev()::_class_name_static != 0) {
         if (*(long*)( _get_class_namev() ) != 0) {
            LAB_001041b3:return &_get_class_namev();
         }

         if (*(long*)( _get_class_namev() ) != 0) {
            if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001041b3;
            StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "GraphElement");
            goto LAB_0010421e;
         }
      ...
      StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "GraphElement");
      LAB_0010421e:return &_get_class_namev();
   }
   ...
   ulong Object::is_class(Object *this, String *param_1) {
      ...
      do {
         if (lVar2 == 0) {
            ...
            LAB_001045cf:/* WARNING: Subroutine does not return */__stack_chk_fail();
         }
 ...
 while ( !bVar8 );
         ...
         LAB_001044e3:uVar5 = String::operator ==(param_1, (String*)&local_50);
         lVar3 = local_50;
         if (local_50 != 0) {
            LOCK();
 ...
 while ( true );
   ...
   void GraphElement::_notificationv(GraphElement *this, int param_1, bool param_2) {
      int iVar1;
      iVar1 = (int)this;
      if (param_2) {
   ...
   void GraphElement::_validate_propertyv(GraphElement *this, PropertyInfo *param_1) {
 ...
 while ( lVar2 != lVar5 );
   ...
   undefined4 *MethodBindTRC<Vector2>::_gen_argument_type_info(int param_1) {
      ...
      *(undefined1(*) [16])( puVar1 + 2 ) = (undefined1[16])0x0;
      ...
      LAB_00104a35:CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
 ...
 while ( !bVar9 );
         ...
         LAB_00104b2f:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar5 = local_60;
         if (local_60 != 0) {
            LOCK();
      ...
      LAB_00104be3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }

      LAB_00104d7e:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }

   /* GraphElement::is_class(String const&) const */
   undefined8 GraphElement::is_class(GraphElement *this, String *param_1) {
      long *plVar1;
      long lVar2;
      long lVar3;
      char *pcVar4;
 ...
 while ( !bVar9 );
         ...
         LAB_00104dff:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar5 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
      ...
      LAB_00104eb3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }

      LAB_00104fbe:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }
   ...
   undefined4 *MethodBindTRC<bool>::_gen_argument_type_info(int param_1) {
      ...
      *(undefined1(*) [16])( puVar1 + 2 ) = (undefined1[16])0x0;
      ...
      StringName::operator =((StringName*)( puVar1 + 4 ), (StringName*)&local_50);
      LAB_001050c5:CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
      if (( StringName::configured != '\0' ) && ( local_50 != 0 )) {
         StringName::unref();
      }
   ...
   undefined4 *MethodBindTR<bool>::_gen_argument_type_info(int param_1) {
      ...
      *(undefined1(*) [16])( puVar1 + 2 ) = (undefined1[16])0x0;
      ...
      StringName::operator =((StringName*)( puVar1 + 4 ), (StringName*)&local_50);
      LAB_00105225:CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
      if (( StringName::configured != '\0' ) && ( local_50 != 0 )) {
         StringName::unref();
      }
   ...
   void Node::_get_property_listv(List *param_1, bool param_2) {
      ...
      LAB_001053ec:List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)CONCAT71(in_register_00000031, param_2), (PropertyInfo*)&local_78);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
   ...
   void CanvasItem::_get_property_listv(CanvasItem *this, List *param_1, bool param_2) {
      ...
      local_50 = 0x80;
      StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
      LAB_00105651:local_b0 = (CowData<char32_t>*)&local_58;
   ...
   void Control::_get_property_listv(Control *this, List *param_1, bool param_2) {
      ...
      local_50 = 0x80;
      StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
      LAB_00105921:local_b0 = (CowData<char32_t>*)&local_58;
      List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
      CowData<char32_t>::_unref(local_b0);
      if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
         StringName::unref();
   ...
   void Container::_get_property_listv(Container *this, List *param_1, bool param_2) {
      ...
      local_50 = 0x80;
      StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
      LAB_00105bf1:local_b0 = (CowData<char32_t>*)&local_58;
      List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
      CowData<char32_t>::_unref(local_b0);
      if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
         StringName::unref();
   ...
   void GraphElement::_get_property_listv(GraphElement *this, List *param_1, bool param_2) {
      long in_FS_OFFSET;
      CowData<char32_t> *local_b0;
      long local_98;
      long local_90;
 ...
 while ( (int)plVar4[2] != 0 );
   ...
   undefined4 *MethodBindT<Vector2_const&>::_gen_argument_type_info(int param_1) {
      ...
      *puVar5 = local_68._0_4_;
      ...
      CowData<char32_t>::_unref((CowData<char32_t>*)local_60);
      LAB_001061d9:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Subroutine does not return */
         __stack_chk_fail();
      }
   ...
   undefined4 *MethodBindT<bool>::_gen_argument_type_info(int param_1) {
      ...
      *puVar5 = local_68._0_4_;
      ...
      CowData<char32_t>::_unref((CowData<char32_t>*)local_60);
      LAB_00106449:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Subroutine does not return */
         __stack_chk_fail();
      }
   ...
   Object *MethodBindTRC<Vector2>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
      ...
      *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
      ...
      LAB_001075d0:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return param_1;
      }
   ...
   void MethodBindTRC<Vector2>::validated_call(MethodBindTRC<Vector2> *this, Object *param_1, Variant **param_2, Variant *param_3) {
      ...
      *(undefined8*)( param_3 + 8 ) = uVar3;
      LAB_00107874:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   ...
   void MethodBindTRC<Vector2>::ptrcall(MethodBindTRC<Vector2> *this, Object *param_1, void **param_2, void *param_3) {
      ...
      *(undefined8*)param_3 = uVar3;
      LAB_00107a33:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   ...
   void MethodBindT<Vector2_const&>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
      ...
      LAB_00107d71:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }
   ...
   void MethodBindT<Vector2_const&>::ptrcall(Object *param_1, void **param_2, void *param_3) {
      ...
      LAB_00107f51:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }
   ...
   void MethodBindTR<bool>::validated_call(MethodBindTR<bool> *this, Object *param_1, Variant **param_2, Variant *param_3) {
      ...
      param_3[8] = VVar1;
      LAB_00108232:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   ...
   void MethodBindTR<bool>::ptrcall(MethodBindTR<bool> *this, Object *param_1, void **param_2, void *param_3) {
      ...
      *(undefined1*)param_3 = uVar1;
      LAB_001083e1:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   ...
   Object *MethodBindTRC<bool>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
      ...
      *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
      ...
      LAB_00108610:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return param_1;
      }
   ...
   void MethodBindTRC<bool>::validated_call(MethodBindTRC<bool> *this, Object *param_1, Variant **param_2, Variant *param_3) {
      ...
      VVar1 = ( Variant )(*pcVar2)(param_1 + *(long*)( this + 0x60 ));
      param_3[8] = VVar1;
      LAB_00108822:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   ...
   void MethodBindTRC<bool>::ptrcall(MethodBindTRC<bool> *this, Object *param_1, void **param_2, void *param_3) {
      ...
      uVar1 = ( *pcVar2 )(param_1 + *(long*)( this + 0x60 ));
      *(undefined1*)param_3 = uVar1;
      LAB_001089d1:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   ...
   void MethodBindT<bool>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
      ...
      LAB_00108d11:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }
   ...
   void MethodBindT<bool>::ptrcall(Object *param_1, void **param_2, void *param_3) {
      ...
      LAB_00108ef9:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }
   ...
   Object *MethodBindT<Vector2_const&>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
      ...
      if (in_R8D < 2) {
         ...
         if (pVVar10 == (Variant*)0x0) {
            ...
            LAB_00109100:pVVar10 = *(Variant**)param_4;
         }
 else {
            lVar2 = *(long*)( pVVar10 + -8 );
            if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
               LAB_00109110:uVar6 = 4;
               goto LAB_001090b5;
            }
         ...
         *in_R9 = 0;
         ...
         uVar6 = 3;
         LAB_001090b5:*in_R9 = uVar6;
         in_R9[2] = 1;
      }

      LAB_001090c0:*(undefined4*)param_1 = 0;
      *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
      if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return param_1;
      }
   ...
   void call_with_variant_args_dv<__UnexistingClass,bool>(__UnexistingClass *param_1, _func_void_bool *param_2, Variant **param_3, int param_4, CallError *param_5, Vector *param_6) {
      ...
      if (lVar1 == 0) {
         ...
         if ((int)lVar2 < (int)( uVar8 ^ 1 )) {
            LAB_00109430:uVar6 = 4;
            LAB_001093cd:*(undefined4*)param_6 = uVar6;
      ...
      LAB_0010934b:*(undefined4*)param_6 = 0;
   ...
   Object *MethodBindT<bool>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
      ...
      *(undefined4*)param_1 = 0;
      *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
      LAB_00109496:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return param_1;
      }

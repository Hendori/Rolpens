         ...
         if (( *(long*)( param_2 + 8 ) != 0 ) && ( lVar10 < *(long*)( *(long*)( param_2 + 8 ) + -8 ) )) {
            ...
            if (lVar7 != 0) {
               ...
               if (lVar7 != 0) {
                  ...
                  if (lVar6 <= lVar10) goto LAB_00104b73;
                  pOVar8 = *(Object**)( lVar7 + lVar10 * 8 );
                  if (( pOVar8 != (Object*)0x0 ) && ( cVar4 = cVar4 == '\0' )) {
                     pOVar8 = (Object*)0x0;
                  }
...
/* SkinTool::_determine_skeleton_roots(Vector<Ref<GLTFNode> >&, Vector<Ref<GLTFSkeleton> >&, int) */undefined8 SkinTool::_determine_skeleton_roots(Vector *param_1, Vector *param_2, int param_3) {
   ...
   if (lVar19 != 0) {
      ...
      do {
         ...
         if (( pOVar20 != (Object*)0x0 ) && ( cVar12 = cVar12 == '\0' )) {
            pOVar20 = (Object*)0x0;
         }
      ...
      if (iVar14 == 0) {
         if (*(long*)( param_3 + 8 ) == 0) {
            ...
            if (-1 < lVar23) {
               ...
               if (local_e8 != pOVar5) {
                  *puVar2 = local_e8;
                  if (( local_e8 != (Object*)0x0 ) && ( cVar13 = cVar13 == '\0' )) {
                     *puVar2 = 0;
                  }
...
/* Resource::is_class(String const&) const */undefined8 Resource::is_class(Resource *this, String *param_1) {
   ...
   LAB_0010b69b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0010b82e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* GLTFSkin::is_class(String const&) const */undefined8 GLTFSkin::is_class(GLTFSkin *this, String *param_1) {
   ...
   if (cVar4 == '\0') {
      ...
      LAB_0010b93b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* GLTFSkeleton::is_class(String const&) const */undefined8 GLTFSkeleton::is_class(GLTFSkeleton *this, String *param_1) {
   ...
   if (cVar4 == '\0') {
      ...
      LAB_0010ba8b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* RBSet<int, Comparator<int>, DefaultAllocator>::clear() */void RBSet<int,Comparator<int>,DefaultAllocator>::clear(RBSet<int,Comparator<int>,DefaultAllocator> *this) {
   Element *pEVar1;
   Element *pEVar2;
   Element *pEVar3;
   Element *pEVar4;
...
/* Ref<GLTFSkeleton>::unref() */void Ref<GLTFSkeleton>::unref(Ref<GLTFSkeleton> *this) {
   Object *pOVar1;
   char cVar2;
   if (*(long*)this != 0) {
      cVar2 = RefCounted::unreference();
...
/* void List<int, DefaultAllocator>::sort_custom<Comparator<int> >() */void List<int,DefaultAllocator>::sort_custom<Comparator<int>>(List<int,DefaultAllocator> *this) {
   size_t __n;
   int iVar1;
   int iVar2;
   undefined8 *puVar3;
 ...
 while ( pEVar13 != (Element*)0x1 );
   SortArray<List<int,DefaultAllocator>::Element*,List<int,DefaultAllocator>::AuxiliaryComparator<Comparator<int>>,true>::introsort(0, (long)pEVar4, __src, lVar9 * 2);
   if ((long)pEVar4 < 0x11) {
      pEVar13 = (Element*)0x1;
      pEVar8 = *__src;
      do {
 ...
 while ( iVar2 < *(int*)pEVar8 );
            ...
            LAB_0010d433:pEVar13 = pEVar13 + 1;
            *ppEVar7 = pEVar6;
            pEVar6 = *__src;
            pEVar8 = pEVar6;
...
;
 ...
 while ( lVar14 + 1 != 0x10 );
      LAB_0010d240:pEVar13 = (Element*)( lVar14 + 1 );
      ppEVar7 = __src + 0x10;
      do {
         pEVar6 = *ppEVar7;
         pEVar10 = ppEVar7[-1];
 ...
 while ( pEVar11 != (Element*)0x0 );
         ...
         LAB_0010d2c3:pEVar13 = pEVar13 + 1;
         *ppEVar12 = pEVar6;
         ppEVar7 = ppEVar7 + 1;
      }
 while ( pEVar4 != pEVar13 );
   ...
   LAB_0010d2e0:puVar3 = *(undefined8**)this;
   *puVar3 = pEVar6;
...
/* GLTFSkeleton::~GLTFSkeleton() */void GLTFSkeleton::~GLTFSkeleton(GLTFSkeleton *this) {
 ...
 while ( lVar5 != (ulong)uVar3 << 2 );
   ...
   LAB_0010d627:pvVar6 = *(void**)( this + 0x268 );
...
/* GLTFSkin::~GLTFSkin() */void GLTFSkin::~GLTFSkin(GLTFSkin *this) {
 ...
 while ( (ulong)uVar2 << 2 != lVar5 );
   ...
   LAB_0010d8a2:pvVar6 = *(void**)( this + 0x2a8 );
   if (pvVar6 != (void*)0x0) {
      if (*(int*)( this + 0x2cc ) != 0) {
 ...
 while ( lVar5 != (ulong)uVar2 << 2 );
   ...
   LAB_0010d937:CowData<int>::_unref((CowData<int>*)( this + 0x290 ));
...
/* SkinTool::_reparent_non_joint_skeleton_subtrees(Vector<Ref<GLTFNode> >&, Ref<GLTFSkeleton>,
   Vector<int> const&) [clone .cold] */void SkinTool::_reparent_non_joint_skeleton_subtrees(void) {
   code *pcVar1;
   DAT_00000290 = 0;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
...
/* SkinTool::_recurse_children(Vector<Ref<GLTFNode> >&, int, RBSet<int, Comparator<int>,
   ...
   .cold] */void SkinTool::_recurse_children(Vector *param_1, int param_2, RBSet *param_3, HashSet *param_4) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
...
/* CowData<Ref<GLTFSkin> >::_copy_on_write() [clone .isra.0] [clone .cold] */void CowData<Ref<GLTFSkin>>::_copy_on_write(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* CowData<Ref<GLTFSkeleton> >::_copy_on_write() [clone .isra.0] [clone .cold] */void CowData<Ref<GLTFSkeleton>>::_copy_on_write(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<int>::resize<false>(long) */undefined8 CowData<int>::resize<false>(CowData<int> *this, long param_1) {
   ...
   if (param_1 * 4 == 0) {
      LAB_0010dde0:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
/* Vector<int>::append_array(Vector<int>) */void Vector<int>::append_array(Vector<int> *this, long param_2) {
   undefined4 uVar1;
   long lVar2;
   long lVar3;
   code *pcVar4;
   ...
   if (lVar2 != 0) {
      ...
      if (0 < lVar2) {
         ...
         do {
            ...
            if (lVar3 == 0) {
               lVar7 = 0;
               LAB_0010dee9:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar5, lVar7, "p_index", "size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
               pcVar4 = (code*)invalidInstructionException();
               ( *pcVar4 )();
...
/* DisjointSet<int, HashMapHasherDefault, HashMapComparatorDefault<int>,
   DefaultAllocator>::get_members(Vector<int>&, int) */void DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::get_members(DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator> *this, Vector *param_1, int param_2) {
   long lVar1;
   ulong uVar2;
   Element *pEVar3;
   undefined8 *puVar4;
   ...
   if (( lVar1 != 0 ) && ( *(int*)( this + 0x2c ) != 0 )) {
      ...
      if (uVar13 != 0) {
         ...
         while (( uVar21 != uVar13 || ( *(int*)( *(long*)( lVar1 + lVar18 * 8 ) + 0x10 ) != param_2 ) )) {
            ...
            if (( uVar13 == 0 ) || ( auVar7._8_8_ = 0 ),auVar7._0_8_ = uVar13 * uVar2,auVar11._8_8_ = 0,auVar11._0_8_ = uVar25,auVar8._8_8_ = 0,auVar8._0_8_ = ( ( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 ) + uVar16 ) - SUB164(auVar7 * auVar11, 8) ) * uVar2,auVar12._8_8_ = 0,auVar12._0_8_ = uVar25,SUB164(auVar8 * auVar12, 8) < uVar27) goto LAB_0010e1a0;
         }
;
         ...
         if (lVar1 != 0) {
            ...
            if (*(Element**)( pEVar3 + 8 ) == pEVar3) {
               for (puVar4 = *(undefined8**)( this + 0x18 ); puVar4 != (undefined8*)0x0; puVar4 = (undefined8*)*puVar4) {
   ...
   LAB_0010e1a0:uVar20 = 0x89;
   pcVar15 = "Parameter \"rep_itr\" is null.";
   LAB_0010e1b2:_err_print_error("get_members", "./core/math/disjoint_set.h", uVar20, pcVar15, 0, 0);
   return;
}
/* DisjointSet<int, HashMapHasherDefault, HashMapComparatorDefault<int>,
   DefaultAllocator>::get_representatives(Vector<int>&) */void DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::get_representatives(DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator> *this, Vector *param_1) {
   int *piVar1;
   long *plVar2;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<int, DisjointSet<int, HashMapHasherDefault, HashMapComparatorDefault<int>,
   DefaultAllocator>::Element*, HashMapHasherDefault, HashMapComparatorDefault<int>,
   DefaultTypedAllocator<HashMapElement<int, DisjointSet<int, HashMapHasherDefault,
   ...
   const&, bool) */int *HashMap<int,DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::Element*,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::Element*>>>::insert(int *param_1, Element **param_2, bool param_3) {
   uint uVar1;
   Element *pEVar2;
   Element *pEVar3;
   Element *pEVar4;
 ...
 while ( uVar33 != uVar27 );
   ...
   uVar26 = *puVar31;
   local_44 = 0;
   cVar23 = _lookup_pos((HashMap<int,DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::Element*,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::Element*>>>*)param_2, (int*)(ulong)uVar26, &local_44);
   if (cVar23 == '\0') {
...
;
   ...
   LAB_0010e651:*(Element**)param_1 = pEVar29;
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* DisjointSet<int, HashMapHasherDefault, HashMapComparatorDefault<int>,
   DefaultAllocator>::create_union(int, int) */void DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::create_union(DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator> *this, int param_1, int param_2) {
   int iVar1;
   Element *pEVar2;
   char cVar3;
   Element *pEVar4;
   ...
   local_38[0] = 0;
   local_44 = param_1;
   cVar3 = HashMap<int,DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::Element*,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::Element*>>>::_lookup_pos((HashMap<int,DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::Element*,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::Element*>>>*)this, (int*)CONCAT44(in_register_00000034, param_1), local_38);
   if (( cVar3 == '\0' ) || ( lVar7 = lVar7 == 0 )) {
      pEVar4 = (Element*)operator_new(0x18, DefaultAllocator::alloc);
      *(int*)pEVar4 = param_1;
      *(undefined4*)( pEVar4 + 0x10 ) = 0;
      *(Element**)( pEVar4 + 8 ) = pEVar4;
      local_40 = pEVar4;
      HashMap<int,DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::Element*,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::Element*>>>::insert((int*)local_38, (Element**)this, SUB81(&local_44, 0));
   }
 else {
   ...
   local_38[0] = 0;
   local_44 = param_2;
   cVar3 = HashMap<int,DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::Element*,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::Element*>>>::_lookup_pos((HashMap<int,DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::Element*,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::Element*>>>*)this, (int*)(ulong)(uint)param_2, local_38);
   if (( cVar3 == '\0' ) || ( lVar7 = lVar7 == 0 )) {
...
/* RBSet<int, Comparator<int>, DefaultAllocator>::_insert_rb_fix(RBSet<int, Comparator<int>,
   DefaultAllocator>::Element*) */void RBSet<int,Comparator<int>,DefaultAllocator>::_insert_rb_fix(RBSet<int,Comparator<int>,DefaultAllocator> *this, Element *param_1) {
   int iVar1;
   long lVar2;
   long lVar3;
   long lVar4;
      ...
      while (true) {
         ...
         if (*(Element**)( pEVar8 + 0x10 ) == param_1) {
            ...
            *(int*)pEVar8 = 1;
            ...
            LAB_0010ec50:_err_print_error("_set_color", "./core/templates/rb_set.h", 0xd0, "Condition \"p_node == _data._nil && p_color == RED\" is true.", 0, 0);
         }
...
;
      ...
      if (*(int*)pEVar6 != 0) {
         if (*(Element**)( pEVar8 + 8 ) == param_1) {
            ...
            *(long*)( pEVar8 + 8 ) = lVar3;
            if (lVar2 == lVar3) {
               *(Element**)( param_1 + 0x18 ) = pEVar5;
               pEVar7 = pEVar5;
               LAB_0010ed42:*(Element**)( pEVar7 + 0x10 ) = param_1;
            }
 else {
               *(Element**)( lVar3 + 0x18 ) = pEVar8;
               pEVar7 = *(Element**)( pEVar8 + 0x18 );
            ...
            *(int*)pEVar8 = 1;
            ...
            LAB_0010ed10:_err_print_error("_set_color", "./core/templates/rb_set.h", 0xd0, "Condition \"p_node == _data._nil && p_color == RED\" is true.", 0, 0);
         }
      ...
      LAB_0010eb2d:pEVar7 = *(Element**)( this + 8 );
      *(int*)pEVar8 = 1;
      *(int*)pEVar6 = 1;
      if (pEVar5 == pEVar7) {
...
/* HashMap<int, int, HashMapHasherDefault, HashMapComparatorDefault<int>,
   DefaultTypedAllocator<HashMapElement<int, int> > >::_resize_and_rehash(unsigned int) */void HashMap<int,int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,int>>>::_resize_and_rehash(HashMap<int,int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,int>>> *this, uint param_1) {
   uint *puVar1;
   undefined8 *puVar2;
   uint uVar3;
   uint uVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<int, int, HashMapHasherDefault, HashMapComparatorDefault<int>,
   DefaultTypedAllocator<HashMapElement<int, int> > >::insert(int const&, int const&, bool) */void HashMap<int,int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,int>>>::insert(int *param_1, int *param_2, bool param_3) {
   undefined4 uVar1;
   undefined8 *puVar2;
   long lVar3;
   long lVar4;
 ...
 while ( uVar30 != uVar33 );
      ...
      LAB_0010f0a6:iVar28 = param_2[0xb];
      uVar24 = *puVar29;
      LAB_0010f0b1:if (iVar28 != 0) {
 ...
 while ( ( uVar22 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = uVar22 * uVar33,auVar15._8_8_ = 0,auVar15._0_8_ = uVar35,auVar8._8_8_ = 0,auVar8._0_8_ = ( ( *(uint*)( hash_table_size_primes + (ulong)(uint)param_2[10] * 4 ) + uVar25 ) - SUB164(auVar7 * auVar15, 8) ) * uVar33,auVar16._8_8_ = 0,auVar16._0_8_ = uVar35,uVar36 <= SUB164(auVar8 * auVar16, 8) );
   ...
   if ((float)uVar23 * __LC19 < (float)( iVar28 + 1 )) {
      ...
      _resize_and_rehash((HashMap<int,int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,int>>>*)param_2, param_2[10] + 1);
   }
...
;
   ...
   *puVar29 = uVar23;
   ...
   LAB_0010f340:*(undefined1(**) [16])param_1 = pauVar26;
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<int, int, HashMapHasherDefault, HashMapComparatorDefault<int>,
...

{
 ...
 while ( uVar41 != uVar38 );
      ...
      LAB_0010f8f9:if (iVar39 == 0) goto LAB_0010f9b0;
 ...
 while ( ( uVar29 != 0 ) && ( auVar6._8_8_ = 0 ),auVar6._0_8_ = uVar29 * uVar2,auVar18._8_8_ = 0,auVar18._0_8_ = uVar41,auVar7._8_8_ = 0,auVar7._0_8_ = ( ( uVar44 + uVar30 ) - SUB164(auVar6 * auVar18, 8) ) * uVar2,auVar19._8_8_ = 0,auVar19._0_8_ = uVar41,lVar37 = SUB168(auVar7 * auVar19, 8),uVar40 <= SUB164(auVar7 * auVar19, 8) );
   ...
   LAB_0010f5c4:uVar35 = CONCAT44(0, *(uint*)( hash_table_size_primes + uVar38 * 4 ));
   uVar2 = *(ulong*)( hash_table_size_primes_inv + uVar38 * 8 );
   uVar30 = ( uVar31 >> 0x10 ^ uVar31 ) * -0x7a143595;
...
iVar39 = *param_1;pauVar32 = (undefined1(*) [16])operator_new(0x18, "");*(int*)pauVar32[1] = iVar39;*(undefined4*)( pauVar32[1] + 4 ) = 0;*pauVar32 = (undefined1[16])0x0;puVar3 = *(undefined8**)( this + 0x20 );if (puVar3 == (undefined8*)0x0) {
...
;*(undefined1(**) [16])( lVar37 + lStack_70 * 8 ) = pauVar28;*puVar1 = uVar31;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_0010f696:auVar47._8_8_ = lStack_70;auVar47._0_8_ = pauVar32[1] + 4;return auVar47;}/* CowData<Ref<GLTFSkin> >::_unref() */void CowData<Ref<GLTFSkin>>::_unref(CowData<Ref<GLTFSkin>> *this) {
   long *plVar1;
   long lVar2;
   Object *pOVar3;
   code *pcVar4;
...
/* CowData<Ref<GLTFSkin> >::_realloc(long) */undefined8 CowData<Ref<GLTFSkin>>::_realloc(CowData<Ref<GLTFSkin>> *this, long param_1) {
   undefined8 *puVar1;
   puVar1 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), param_1 + 0x10, false);
   if (puVar1 != (undefined8*)0x0) {
      *puVar1 = 1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Ref<GLTFSkin> >::resize<false>(long) */undefined8 CowData<Ref<GLTFSkin>>::resize<false>(CowData<Ref<GLTFSkin>> *this, long param_1) {
   ...
   if (param_1 * 8 == 0) {
      LAB_0010fe00:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (lVar11 == lVar8) {
      LAB_0010fd7b:puVar10 = *(undefined8**)this;
      if (puVar10 == (undefined8*)0x0) {
         LAB_0010fc70:/* WARNING: Does not return */pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
      }
   ...
   LAB_0010fd5b:puVar10[-1] = param_1;
   return 0;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Vector<int> >::resize<false>(long) */undefined8 CowData<Vector<int>>::resize<false>(CowData<Vector<int>> *this, long param_1) {
   ...
   if (param_1 * 0x10 == 0) {
      LAB_00110170:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (lVar10 == lVar7) {
      LAB_001100e3:puVar6 = *(undefined8**)this;
      if (puVar6 == (undefined8*)0x0) {
         LAB_001101c6:/* WARNING: Does not return */pcVar1 = (code*)invalidInstructionException();
         ( *pcVar1 )();
      }
...
/* CowData<Ref<GLTFSkeleton> >::_realloc(long) */undefined8 CowData<Ref<GLTFSkeleton>>::_realloc(CowData<Ref<GLTFSkeleton>> *this, long param_1) {
   undefined8 *puVar1;
   puVar1 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), param_1 + 0x10, false);
   if (puVar1 != (undefined8*)0x0) {
      *puVar1 = 1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Ref<GLTFSkeleton> >::resize<false>(long) */undefined8 CowData<Ref<GLTFSkeleton>>::resize<false>(CowData<Ref<GLTFSkeleton>> *this, long param_1) {
   long *plVar1;
   Object *pOVar2;
   code *pcVar3;
   char cVar4;
   ...
   if (param_1 * 8 == 0) {
      LAB_001105e0:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (lVar11 == lVar8) {
      LAB_0011055b:puVar10 = *(undefined8**)this;
      if (puVar10 == (undefined8*)0x0) {
         LAB_00110450:/* WARNING: Does not return */pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
      }
   ...
   memset(puVar10 + lVar7, 0, ( param_1 - lVar7 ) * 8);
   LAB_0011053b:puVar10[-1] = param_1;
   return 0;
}
...
/* WARNING: Control flow encountered bad instruction data *//* DisjointSet<int, HashMapHasherDefault, HashMapComparatorDefault<int>,
   DefaultAllocator>::~DisjointSet() */void DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator>::~DisjointSet(DisjointSet<int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultAllocator> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

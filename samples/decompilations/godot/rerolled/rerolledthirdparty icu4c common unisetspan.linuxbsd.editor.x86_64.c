/* icu_76_godot::UnicodeSetStringSpan::UnicodeSetStringSpan(icu_76_godot::UnicodeSetStringSpan
   const&, icu_76_godot::UVector const&) */void icu_76_godot::UnicodeSetStringSpan::UnicodeSetStringSpan(UnicodeSetStringSpan *this, UnicodeSetStringSpan *param_1, UVector *param_2) {
   undefined4 uVar1;
   int iVar2;
   UnicodeSet *pUVar3;
   void *__src;
...
/* icu_76_godot::UnicodeSetStringSpan::~UnicodeSetStringSpan() */void icu_76_godot::UnicodeSetStringSpan::~UnicodeSetStringSpan(UnicodeSetStringSpan *this) {
   UnicodeSet *this_00;
   ...
   if (( *(UnicodeSetStringSpan**)( this + 0xe0 ) != (UnicodeSetStringSpan*)0x0 ) && ( *(UnicodeSetStringSpan**)( this + 0xe0 ) != this + 0x108 )) {
      uprv_free_76_godot();
   }
...
/* icu_76_godot::UnicodeSetStringSpan::addToSpanNotSet(int) */void icu_76_godot::UnicodeSetStringSpan::addToSpanNotSet(int param_1) {
   char cVar1;
   long lVar2;
...
/* icu_76_godot::UnicodeSetStringSpan::UnicodeSetStringSpan(icu_76_godot::UnicodeSet const&,
   icu_76_godot::UVector const&, unsigned int) */void icu_76_godot::UnicodeSetStringSpan::UnicodeSetStringSpan(UnicodeSetStringSpan *this, UnicodeSet *param_1, UVector *param_2, uint param_3) {
   UnicodeSet *this_00;
   ushort uVar1;
   bool bVar2;
   undefined1 uVar3;
         ...
         if (iVar7 != 0) {
            ...
            if (iVar5 < iVar7) {
               ...
               if (( param_3 & 4 ) == 0) {
                  ...
                  bVar2 = true;
                  LAB_001003ae:local_48 = 0;
                  local_44 = 0;
                  u_strToUTF8_76_godot(0, 0, &local_44, lVar15, iVar7, &local_48);
                  if (( local_48 == 0xf ) || ( iVar7 = local_48 < 1 )) {
                     iVar7 = local_44;
                  }
 ...
 while ( true );
   ...
   LAB_00100480:*(undefined8*)( this + 0xfc ) = 0;
   LAB_00100708:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }

   LAB_00100a49:/* WARNING: Subroutine does not return */__stack_chk_fail();
   LAB_00100418:if (!bVar2) goto LAB_00100480;
   if (( this[0x104] == (UnicodeSetStringSpan)0x0 ) || ( icu_76_godot::UnicodeSet::freeze(),this[0x104] == (UnicodeSetStringSpan)0x0 )) {
      iVar12 = iVar11;
      if (( param_3 & 4 ) == 0) goto LAB_001004e5;
      iVar12 = *(int*)( this + 0xf8 ) + iVar11 * 5;
      if (iVar12 < 0x81) goto LAB_001004f1;
      LAB_00100458:pUVar9 = (UnicodeSetStringSpan*)uprv_malloc_76_godot((long)iVar12);
      *(UnicodeSetStringSpan**)( this + 0xe0 ) = pUVar9;
      if (pUVar9 == (UnicodeSetStringSpan*)0x0) goto LAB_00100480;
   }
 else {
      iVar12 = *(int*)( this + 0xf8 ) + iVar11 * 8;
      LAB_001004e5:if (0x80 < iVar12) goto LAB_00100458;
      LAB_001004f1:pUVar9 = this + 0x108;
      *(UnicodeSetStringSpan**)( this + 0xe0 ) = pUVar9;
   }
         ...
         if (uVar6 != 0) {
            if (( param_3 & 2 ) == 0) {
               *(undefined4*)( *(long*)( this + 0xe0 ) + lVar15 * 4 ) = 0;
               ...
               local_48 = 0;
               local_44 = 0;
               u_strToUTF8_76_godot((long)local_74 + *(long*)( this + 0xf0 ), *(int*)( this + 0xf8 ) - local_74, &local_44, lVar14, iVar11, &local_48);
               iVar11 = 0;
               if (local_48 < 1) {
...
;
      ...
      if (uVar6 == 0) {
         LAB_001005ae:if (( param_3 & 1 ) != 0) {
            if (( param_3 & 0x20 ) != 0) {
               LAB_001005c3:addToSpanNotSet((int)this);
            }
         ...
         local_44 = 0;
         u_strToUTF8_76_godot(lVar10, *(int*)( this + 0xf8 ) - local_74, &local_44, lVar14, iVar11, &local_48);
         iVar11 = local_44;
         if (0 < local_48) {
            *(undefined4*)( *(long*)( this + 0xe0 ) + lVar15 * 4 ) = 0;
            LAB_001007c0:pUVar9[lVar15] = (UnicodeSetStringSpan)0xff;
            local_68[lVar15] = (UnicodeSetStringSpan)0xff;
            goto LAB_001005ae;
         }
         ...
         *(int*)( *(long*)( this + 0xe0 ) + lVar15 * 4 ) = local_44;
         ...
         if (( param_3 & 0x10 ) != 0) {
            LAB_001008af:iVar12 = icu_76_godot::UnicodeSet::spanBackUTF8(this_00, lVar10, iVar11, 1);
      ...
      LAB_00100628:lVar15 = lVar15 + 1;
   }
 while ( lVar15 != lVar8 );
   LAB_001006fa:if (this[0x104] != (UnicodeSetStringSpan)0x0) {
...
/* icu_76_godot::UnicodeSetStringSpan::spanNot(char16_t const*, int) const */int icu_76_godot::UnicodeSetStringSpan::spanNot(UnicodeSetStringSpan *this, wchar16 *param_1, int param_2) {
   wchar16 *pwVar1;
   ushort uVar2;
   int iVar3;
   char cVar4;
...
;
 ...
 while ( iVar3 != lVar12 );
      ...
      LAB_00100bd3:iVar11 = iVar11 - local_3c;
...
/* icu_76_godot::UnicodeSetStringSpan::span(char16_t const*, int, USetSpanCondition) const */ulong icu_76_godot::UnicodeSetStringSpan::span(UnicodeSetStringSpan *this, wchar16 *param_1, uint param_2, int param_4) {
...
;
                  ...
                  if (bVar3 == 0xfe) {
                     uVar10 = uVar7 - 1;
                     if (( ( ( *(ushort*)( lVar17 + (long)(int)uVar10 * 2 ) & 0xfc00 ) == 0xdc00 ) && ( 0 < (int)uVar10 ) ) && ( ( *(ushort*)( lVar17 + -2 + (long)(int)uVar10 * 2 ) & 0xfc00 ) == 0xd800 )) {
                        uVar10 = uVar7 - 2;
                     }
 ...
 while ( 0 < (int)( uVar7 - (int)lVar9 ) );
                        if (( ( ( iVar13 < 1 ) || ( ( pwVar2[-1] & 0xfc00U ) != 0xd800 ) ) || ( ( *pwVar2 & 0xfc00U ) != 0xdc00 ) ) && ( ( ( (int)( param_2 - iVar13 ) <= (int)uVar7 || ( ( pwVar2[(long)(int)uVar7 + -1] & 0xfc00U ) != 0xd800 ) ) || ( ( pwVar2[(int)uVar7] & 0xfc00U ) != 0xdc00 ) ) )) {
                     ...
                     LAB_001010dc:if (uVar16 == uVar7) goto LAB_00100fe8;
                     uVar16 = uVar16 + 1;
                     iVar13 = iVar13 + 1;
                  }
 ...
 while ( iVar5 != lVar21 );
            ...
            LAB_00101108:if (local_98 == 0) goto LAB_00101118;
            LAB_00101266:if (iStack_5c != 0) {
               LAB_0010126e:uVar8 = (ulong)(int)local_58;
               pcVar15 = local_68 + uVar8 + 1;
               LAB_001012a0:pcVar12 = pcVar15;
               uVar7 = (int)uVar8 + 1;
               uVar8 = (ulong)uVar7;
 ...
 while ( 0 < (int)( uVar10 - (int)lVar9 ) );
                           if (( ( ( iVar19 < 1 ) || ( ( pwVar2[-1] & 0xfc00U ) != 0xd800 ) ) || ( ( *pwVar2 & 0xfc00U ) != 0xdc00 ) ) && ( ( ( uVar16 = uVar14 ),iVar11 = iVar18,(int)( ( param_2 - local_94 ) + uVar14 ) <= (int)uVar10 || ( ( pwVar2[(long)(int)uVar10 + -1] & 0xfc00U ) != 0xd800 ) ) || ( ( pwVar2[(int)uVar10] & 0xfc00U ) != 0xdc00 ) )) break;
                        }

                        LAB_00100e70:iVar18 = iVar18 + 1;
                        uVar14 = uVar14 - 1;
                        iVar19 = iVar19 + 1;
                        uVar16 = uVar7;
                        iVar11 = iVar13;
...
;
         ...
         LAB_00101118:if (local_94 == 0) goto LAB_00101266;
         ...
         if (iStack_5c != 0) {
            ...
            if (( ( ushort )(*pwVar2 + L'⠀') < 0x400 ) && ( 1 < (int)uVar20 )) {
               ...
               if (cVar6 == '\0') goto LAB_0010126e;
               uVar7 = 1;
               LAB_001013aa:if (uVar7 == uVar20) goto LAB_00100f29;
            }
 ...
 while ( true );
   ...
   goto LAB_00100f3e;
   LAB_00101290:pcVar15 = pcVar12 + 1;
   if (*pcVar12 != '\0') goto LAB_001013b8;
   goto LAB_001012a0;
   LAB_001013b8:*pcVar12 = '\0';
   iVar13 = uVar7 - local_58;
   LAB_001012e1:iStack_5c = iStack_5c + -1;
   local_94 = local_94 + iVar13;
   uVar20 = uVar20 - iVar13;
   local_98 = 0;
   local_58 = uVar7;
   goto LAB_00100d82;
   LAB_001013f8:local_a4 = local_98 + local_94;
   LAB_00100f29:if (local_68 != local_54) {
      uprv_free_76_godot(local_68);
   }

   local_98 = local_a4;
   LAB_00100f3e:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return (ulong)local_98;
   }

   LAB_00101470:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* icu_76_godot::UnicodeSetStringSpan::spanNotBackUTF8(unsigned char const*, int) const */int icu_76_godot::UnicodeSetStringSpan::spanNotBackUTF8(uchar *param_1, int param_2) {
   int iVar1;
   int iVar2;
   char cVar3;
   int iVar4;
...
/* icu_76_godot::UnicodeSetStringSpan::spanBackUTF8(unsigned char const*, int, USetSpanCondition)
   const */ulong icu_76_godot::UnicodeSetStringSpan::spanBackUTF8(UnicodeSetStringSpan *this, long param_1, int param_2, int param_4) {
   UnicodeSetStringSpan *pUVar1;
   byte bVar2;
   byte bVar3;
   int iVar4;
                        ...
                        if (bVar2 == 0xfe) {
                           ...
                           if (( ( byte )(bVar2 + 0x3e) < 0x33 ) && ( iVar18 != 1 )) {
                              ...
                              if (( byte )(bVar2 + 0x20) < 0x10) {
                                 iVar17 = 1;
                                 if (( ( (uint)(int)(char)( &_LC0 )[bVar2 & 0xf] >> ( bVar3 >> 5 ) & 1 ) != 0 ) && ( iVar17 = iVar18 != 2 )) {
                                 ...
                                 iVar17 = 1;
                                 if (( ( ( ( (uint)(int)(char)( &DAT_001031bb )[bVar3 >> 4] >> ( bVar2 & 7 ) & 1 ) != 0 ) && ( iVar17 = 2 ),iVar18 != 2 ) ) && ( (char)pbVar20[2] < -0x40 )) {
 ...
 while ( 0 < iVar18 - (int)lVar11 );
                           ...
                           joined_r0x00101933:if (iVar18 == iVar17) break;
                           pcVar13 = pcVar13 + -1;
                        }
...
;
 ...
 while ( iVar4 != lVar22 );
               LAB_0010184d:if (uVar9 == 0 && iVar18 == 0) break;
...
;
         ...
         if (( uVar8 != 0 ) || ( param_2 == iVar15 )) {
            if (local_60._4_4_ != 0) {
               LAB_00101a74:uVar10 = (ulong)(int)local_58;
               pcVar13 = local_68 + uVar10 + 1;
               LAB_00101aa0:pcVar14 = pcVar13;
               uVar9 = (int)uVar10 + 1;
               uVar10 = (ulong)uVar9;
 ...
 while ( true );
   ...
   goto LAB_00101879;
   LAB_00101a90:pcVar13 = pcVar14 + 1;
   if (*pcVar14 != '\0') goto LAB_00101b90;
   goto LAB_00101aa0;
   LAB_00101b90:*pcVar14 = '\0';
   iVar18 = uVar9 - local_58;
   LAB_00101ae1:local_60 = CONCAT44(local_60._4_4_ + -1, (int)local_60);
   uVar10 = ( ulong )(uint)(iVar15 - iVar18);
   uVar8 = 0;
   local_58 = uVar9;
   goto LAB_0010173d;
   LAB_00101c10:uVar10 = (ulong)uVar9;
   LAB_0010186c:if (local_68 != local_54) {
      uprv_free_76_godot(local_68);
   }

   LAB_00101879:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar10;
   }

   LAB_00101d35:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* icu_76_godot::UnicodeSetStringSpan::spanNotBack(char16_t const*, int) const */int icu_76_godot::UnicodeSetStringSpan::spanNotBack(UnicodeSetStringSpan *this, wchar16 *param_1, int param_2) {
   wchar16 *pwVar1;
   ushort uVar2;
   int iVar3;
   char cVar4;
   ...
   do {
      ...
      if (( ( ( ushort )(param_1[(long)iVar5 + -1] + L'␀') < 0x400 ) && ( 1 < iVar5 ) ) && ( ( param_1[(long)iVar5 + -2] & 0xfc00U ) == 0xd800 )) {
 ...
 while ( 0 < iVar8 - (int)lVar7 );
                  if (( ( iVar12 != 0 ) && ( ( pwVar1[-1] & 0xfc00U ) == 0xd800 ) ) && ( ( *pwVar1 & 0xfc00U ) == 0xdc00 )) {
                     lVar13 = lVar13 + 1;
...
/* icu_76_godot::UnicodeSetStringSpan::spanBack(char16_t const*, int, USetSpanCondition) const */ulong icu_76_godot::UnicodeSetStringSpan::spanBack(UnicodeSetStringSpan *this, wchar16 *param_1, uint param_2, int param_4) {
   wchar16 *pwVar1;
   byte bVar2;
   ushort uVar3;
   int iVar4;
...
;
 ...
 while ( 0 < (int)( uVar10 - (int)lVar9 ) );
                        if (uVar20 == 0) {
                           ...
                           LAB_00102429:if (( ( pwVar1[(long)(int)uVar10 + -1] & 0xfc00U ) != 0xd800 ) || ( ( pwVar1[(int)uVar10] & 0xfc00U ) != 0xdc00 )) {
                              LAB_00102403:if (uVar13 == uVar6) {
                                 uVar7 = 0;
                                 goto LAB_00102205;
                              }
                     ...
                     LAB_001023b0:if (uVar10 == uVar6) goto LAB_001022b0;
                     uVar6 = uVar6 + 1;
                     uVar20 = uVar20 - 1;
                     iVar14 = iVar14 + 1;
                  }
 ...
 while ( 0 < (int)( uVar10 - (int)lVar9 ) );
                              if (( ( ( uVar13 - iVar19 == 0 ) || ( ( pwVar1[-1] & 0xfc00U ) != 0xd800 ) ) || ( ( *pwVar1 & 0xfc00U ) != 0xdc00 ) ) && ( ( ( iVar11 = iVar19 ),uVar20 = uVar15,(int)( ( param_2 - uVar13 ) + iVar19 ) <= (int)uVar10 || ( ( pwVar1[(long)(int)uVar10 + -1] & 0xfc00U ) != 0xd800 ) ) || ( ( pwVar1[(int)uVar10] & 0xfc00U ) != 0xdc00 ) )) break;
                           }

                           LAB_00102140:iVar19 = iVar19 + 1;
                           uVar15 = uVar15 - 1;
                           iVar11 = iVar14;
                           uVar20 = uVar6;
...
;
         ...
         LAB_001024a8:uVar7 = (ulong)uVar13;
         ...
         if (local_60._4_4_ != 0) {
            ...
            if (( ( ushort )(param_1[(long)(int)uVar13 + -1] + L'␀') < 0x400 ) && ( 1 < (int)uVar13 )) {
               ...
               uVar6 = 1;
               if (cVar5 == '\0') {
                  LAB_00102514:uVar7 = (ulong)(int)local_58;
                  pcVar16 = local_68 + uVar7 + 1;
                  LAB_00102540:pcVar12 = pcVar16;
                  uVar6 = (int)uVar7 + 1;
                  uVar7 = (ulong)uVar6;
 ...
 while ( *pcVar16 == '\0' );
               ...
               if (cVar5 == '\0') goto LAB_00102514;
               uVar6 = 1;
               LAB_00102669:if (uVar13 == uVar6) {
                  LAB_001021fd:uVar7 = 0;
                  goto LAB_00102205;
               }
 ...
 while ( true );
   ...
   goto LAB_0010221a;
   LAB_00102530:pcVar16 = pcVar12 + 1;
   if (*pcVar12 != '\0') goto LAB_001025b9;
   goto LAB_00102540;
   LAB_001025b9:*pcVar12 = '\0';
   iVar14 = uVar6 - local_58;
   LAB_00102581:local_60 = CONCAT44(local_60._4_4_ + -1, (int)local_60);
   uVar7 = ( ulong )(uVar13 - iVar14);
   local_94 = 0;
   local_58 = uVar6;
   goto LAB_0010206c;
   LAB_001024f2:uVar7 = (ulong)uVar6;
   LAB_00102205:if (local_68 != local_54) {
      uprv_free_76_godot(local_68);
   }

   LAB_0010221a:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar7;
   }

   LAB_001026f8:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* icu_76_godot::UnicodeSetStringSpan::spanNotUTF8(unsigned char const*, int) const */int icu_76_godot::UnicodeSetStringSpan::spanNotUTF8(UnicodeSetStringSpan *this, uchar *param_1, int param_2) {
   byte bVar1;
   int iVar2;
   int iVar3;
   char cVar4;
   ...
   do {
      ...
      if ((char)bVar1 < '\0') {
         if (iVar14 == 1) {
            ...
            if (bVar1 < 0xe0) {
               if (0xc1 < uVar9) {
                  lVar11 = 1;
                  iVar5 = 1;
                  LAB_0010290a:if (( byte )(pbVar8[lVar11] + 0x80) < 0x40) {
                     iVar5 = iVar5 + 1;
                  }
            ...
            if (uVar9 < 0xf0) {
               if (( (uint)(int)(char)( &_LC0 )[bVar1 & 0xf] >> ( pbVar8[1] >> 5 ) & 1 ) == 0) goto LAB_00102810;
               iVar5 = 2;
               LAB_0010298c:if (iVar5 != iVar14) {
                  lVar11 = (long)iVar5;
                  goto LAB_0010290a;
               }
               ...
               if (( 4 < (int)( uVar9 - 0xf0 ) ) || ( ( (uint)(int)(char)( &DAT_001031bb )[pbVar8[1] >> 4] >> ( uVar9 - 0xf0 & 0x1f ) & 1 ) == 0 )) goto LAB_00102810;
         ...
         LAB_0010281b:cVar4 = icu_76_godot::UnicodeSet::contains(iVar10);
         if (cVar4 != '\0') {
            return iVar12;
         }
...
/* icu_76_godot::UnicodeSetStringSpan::spanUTF8(unsigned char const*, int, USetSpanCondition) const
    */ulong icu_76_godot::UnicodeSetStringSpan::spanUTF8(UnicodeSetStringSpan *this, uchar *param_1, uint param_2, int param_4) {
   UnicodeSetStringSpan *pUVar1;
   uint *puVar2;
   byte bVar3;
   int iVar4;
            ...
            if (0 < iVar4) {
               do {
                  ...
                  if (uVar24 != 0) {
                     ...
                     uVar19 = (uint)bVar3;
                     if (bVar3 != 0xff) {
                        if (( bVar3 == 0xfe ) && ( uVar19 = uVar24 - 1 * (char*)( lVar15 + (int)uVar19 ) < -0x40 )) {
 ...
 while ( 0 < (int)( uVar24 - (int)lVar11 ) );
                           ...
                           joined_r0x00102d03:if (uVar24 == uVar19) break;
                           puVar13 = puVar13 + 1;
                        }
 ...
 while ( iVar4 != lVar16 );
            ...
            LAB_00102e57:uVar8 = local_a0;
            if (iStack_5c != 0) {
               LAB_00102e5f:uVar10 = (ulong)(int)local_58;
               pcVar22 = local_68 + uVar10 + 1;
               LAB_00102e90:pcVar14 = pcVar22;
               uVar8 = (int)uVar10 + 1;
               uVar10 = (ulong)uVar8;
...
;
 ...
 while ( puVar2 != puVar21 );
            LAB_00102bfa:if (uVar24 == 0 && iVar20 == 0) break;
...
;
         ...
         LAB_00102d99:if (local_a0 == 0) goto LAB_00102e57;
         ...
         if ((char)bVar3 < '\0') {
            if (uVar17 == 1) {
               LAB_001030d5:cVar7 = icu_76_godot::UnicodeSet::contains(iVar20);
            ...
            if (bVar3 < 0xe0) {
               if (0xc1 < uVar9) {
                  lVar15 = 1;
                  uVar9 = 1;
                  LAB_00103038:if (( byte )(pbVar25[lVar15] + 0x80) < 0x40) {
                     uVar9 = uVar9 + 1;
                  }
               ...
               LAB_00103072:uVar9 = 1;
            }
 else {
               if (uVar9 < 0xf0) {
                  if (( (uint)(int)(char)( &_LC0 )[bVar3 & 0xf] >> ( pbVar25[1] >> 5 ) & 1 ) != 0) {
                     uVar9 = 2;
                     LAB_00102f59:if (uVar17 == uVar9) goto LAB_001030d5;
               ...
               if (( 4 < (int)( uVar9 - 0xf0 ) ) || ( ( (uint)(int)(char)( &DAT_001031bb )[pbVar25[1] >> 4] >> ( uVar9 - 0xf0 & 0x1f ) & 1 ) == 0 )) goto LAB_00103072;
            ...
            if (cVar7 == '\0') goto LAB_00102e5f;
            uVar9 = 1;
            LAB_00103009:if (uVar9 == uVar17) goto LAB_00102c26;
         }
 ...
 while ( true );
   ...
   goto LAB_00102c36;
   LAB_00102e80:pcVar22 = pcVar14 + 1;
   if (*pcVar14 != '\0') goto LAB_00102f78;
   goto LAB_00102e90;
   LAB_00102f78:*pcVar14 = '\0';
   iVar20 = uVar8 - local_58;
   LAB_00102ece:iStack_5c = iStack_5c + -1;
   local_a0 = local_a0 + iVar20;
   uVar17 = uVar17 - iVar20;
   uVar9 = 0;
   local_58 = uVar8;
   goto LAB_00102ace;
   LAB_00102f8b:uVar8 = local_a0 + uVar9;
   LAB_00102c26:if (local_68 != local_54) {
      uprv_free_76_godot(local_68);
   }

   LAB_00102c36:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return (ulong)uVar8;
   }

   LAB_0010318a:/* WARNING: Subroutine does not return */__stack_chk_fail();
}

/* OpenXRHand::get_hand() const */undefined4 OpenXRHand::get_hand(OpenXRHand *this) {
   return *(undefined4*)( this + 0x538 );
}
/* OpenXRHand::get_motion_range() const */undefined4 OpenXRHand::get_motion_range(OpenXRHand *this) {
   return *(undefined4*)( this + 0x53c );
}
/* OpenXRHand::get_skeleton_rig() const */undefined4 OpenXRHand::get_skeleton_rig(OpenXRHand *this) {
   return *(undefined4*)( this + 0x548 );
}
/* OpenXRHand::get_bone_update() const */undefined4 OpenXRHand::get_bone_update(OpenXRHand *this) {
   return *(undefined4*)( this + 0x54c );
}
/* OpenXRHand::set_hand_skeleton(NodePath const&) */void OpenXRHand::set_hand_skeleton(OpenXRHand *this, NodePath *param_1) {
   NodePath::operator =((NodePath*)( this + 0x540 ), param_1);
   return;
}
/* OpenXRHand::get_hand_skeleton() const */void OpenXRHand::get_hand_skeleton(void) {
   long in_RSI;
   NodePath *in_RDI;
   NodePath::NodePath(in_RDI, (NodePath*)( in_RSI + 0x540 ));
   return;
}
/* OpenXRHand::set_hand(OpenXRHand::Hands) */void OpenXRHand::set_hand(OpenXRHand *this, uint param_2) {
   if (param_2 < 2) {
      *(uint*)( this + 0x538 ) = param_2;
      return;
   }

   _err_print_index_error("set_hand", "modules/openxr/scene/openxr_hand.cpp", 0x54, (ulong)param_2, 2, "p_hand", "HAND_MAX", "", false, false);
   return;
}
/* OpenXRHand::set_skeleton_rig(OpenXRHand::SkeletonRig) */void OpenXRHand::set_skeleton_rig(OpenXRHand *this, uint param_2) {
   if (param_2 < 2) {
      *(uint*)( this + 0x548 ) = param_2;
      return;
   }

   _err_print_index_error("set_skeleton_rig", "modules/openxr/scene/openxr_hand.cpp", 0x88, (ulong)param_2, 2, "p_skeleton_rig", "SKELETON_RIG_MAX", "", false, false);
   return;
}
/* OpenXRHand::set_bone_update(OpenXRHand::BoneUpdate) */void OpenXRHand::set_bone_update(OpenXRHand *this, uint param_2) {
   if (param_2 < 2) {
      *(uint*)( this + 0x54c ) = param_2;
      return;
   }

   _err_print_index_error("set_bone_update", "modules/openxr/scene/openxr_hand.cpp", 0x92, (ulong)param_2, 2, "p_bone_update", "BONE_UPDATE_MAX", "", false, false);
   return;
}
/* OpenXRHand::set_motion_range(OpenXRHand::MotionRange) */void OpenXRHand::set_motion_range(OpenXRHand *this, uint param_2) {
   if (1 < param_2) {
      _err_print_index_error("set_motion_range", "modules/openxr/scene/openxr_hand.cpp", 100, (ulong)param_2, 2, "p_motion_range", "MOTION_RANGE_MAX", "", false, false);
      return;
   }

   *(uint*)( this + 0x53c ) = param_2;
   if (*(long*)( this + 0x530 ) != 0) {
      OpenXRHandTrackingExtension::set_motion_range(*(long*)( this + 0x530 ), *(undefined4*)( this + 0x538 ), 2 - ( uint )(param_2 == 0));
      return;
   }
...
/* OpenXRHand::OpenXRHand() */void OpenXRHand::OpenXRHand(OpenXRHand *this) {
   OpenXRHand *pOVar1;
   OpenXRHand *pOVar2;
   undefined8 uVar3;
   ...
   *(undefined***)this = &PTR__initialize_classv_0010cad8;
   for (int i = 0; i < 3; i++) {
      *(undefined8*)( this + ( 8*i + 1336 ) ) = 0;
   }

   *(undefined8*)( this + 0x550 ) = uVar3;
   *(undefined8*)( this + 0x558 ) = uVar3;
   pOVar1 = this + 0x560;
   do {
      *(undefined8*)pOVar1 = uVar3;
      pOVar2 = pOVar1 + 0x10;
      *(undefined8*)( pOVar1 + 8 ) = uVar3;
      pOVar1 = pOVar2;
   }
 while ( this + 0x620 != pOVar2 );
   *(undefined8*)( this + 0x528 ) = OpenXRAPI::singleton;
   uVar3 = OpenXRHandTrackingExtension::get_singleton();
   *(undefined8*)( this + 0x530 ) = uVar3;
   return;
}
/* OpenXRHand::_set_motion_range() */void OpenXRHand::_set_motion_range(OpenXRHand *this) {
   if (*(long*)( this + 0x530 ) != 0) {
      OpenXRHandTrackingExtension::set_motion_range(*(long*)( this + 0x530 ), *(undefined4*)( this + 0x538 ), 2 - ( uint )(*(int*)( this + 0x53c ) == 0));
      return;
   }

   return;
}
/* OpenXRHand::get_skeleton() */undefined8 OpenXRHand::get_skeleton(OpenXRHand *this) {
   char cVar1;
   long lVar2;
   undefined8 uVar3;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* OpenXRHand::_update_skeleton() */void OpenXRHand::_update_skeleton(OpenXRHand *this) {
   float fVar1;
   float fVar2;
   undefined8 uVar3;
   ...
   if (( ( ( *(long*)( this + 0x528 ) != 0 ) && ( cVar6 = OpenXRAPI::is_initialized() ),cVar6 != '\0' ) ) && ( *(long*)( this + 0x530 ) != 0 )) &&( ( cVar6 = OpenXRHandTrackingExtension::get_active() ),cVar6 != '\0' && ( lVar8 = lVar8 != 0 ) )(_update_skeleton() == '\0');
   {
      iVar7 = __cxa_guard_acquire(&_update_skeleton(), ::bone_adjustments);
      uVar22 = __LC16;
      uVar30._4_4_ = _LC25;
      uVar30._0_4_ = _UNK_0010d0e8;
      if (iVar7 != 0) {
         _update_skeleton() {
            uVar30._4_4_ = _LC25;
            uVar30._0_4_ = _UNK_0010d0e8;
         ...
         pQVar10 = pQVar15;
         do {
            *(undefined8*)pQVar10 = uVar22;
            *(undefined8*)( pQVar10 + 8 ) = uVar30;
            pQVar9 = pQVar10 + 0x20;
            *(undefined8*)( pQVar10 + 0x10 ) = uVar22;
            *(undefined8*)( pQVar10 + 0x18 ) = uVar30;
            pQVar10 = pQVar9;
         }
 ...
 while ( pQVar9 != (Quaternion*)( auStack_1e0 + 0x33 ) );
         ...
         pfVar14 = (float*)&local_4c8;
         for (lVar12 = 0x27; lVar12 != 0; lVar12 = lVar12 + -1) {
            pfVar14[0] = 0.0;
            pfVar14[1] = 0.0;
            pfVar14 = pfVar14 + (ulong)bVar18 * -4 + 2;
         }

         pcVar11 = (char*)OpenXRHandTrackingExtension::get_hand_tracker(*(undefined8*)( this + 0x530 ), uVar5);
         XRServer::get_singleton();
         dVar20 = (double)XRServer::get_world_scale();
         if (( *pcVar11 != '\0' ) && ( *(int*)( pcVar11 + 0x7a0 ) != 0 )) {
            fVar28 = (float)dVar20;
            pbVar16 = (byte*)( pcVar11 + 0x20 );
            piVar17 = local_538;
            pQVar10 = local_1e8;
            pfVar14 = (float*)&local_4c8;
            do {
               *piVar17 = 0;
               *(undefined8*)pQVar15 = uVar22;
               *(undefined8*)( pQVar15 + 8 ) = uVar30;
               for (int i = 0; i < 3; i++) {
                  pfVar14[i] = 0;
               }

               if (( *pbVar16 & 1 ) != 0) {
                  auVar4 = *(undefined1(*) [16])( pbVar16 + 8 );
                  if (( ( ( auVar4._0_4_ != 0.0 ) || ( auVar4._4_4_ != 0.0 ) ) || ( auVar4._8_4_ != 0.0 ) ) || ( auVar4._12_4_ != 0.0 )) {
                     local_598 = auVar4;
                     Quaternion::operator *((Quaternion*)local_568, (Quaternion*)local_598);
                     *(undefined8*)pQVar15 = local_568._0_8_;
                     *(undefined8*)( pQVar15 + 8 ) = local_568._8_8_;
                     Quaternion::inverse();
                     bVar18 = *pbVar16;
                     *(undefined8*)pQVar10 = local_568._0_8_;
                     *(undefined8*)( pQVar10 + 8 ) = local_568._8_8_;
                     if (( bVar18 & 2 ) == 0) {
                        *piVar17 = 1;
                     }
 else {
                        uVar3 = *(undefined8*)( pbVar16 + 0x18 );
                        *piVar17 = 2;
                        pfVar14[2] = fVar28 * *(float*)( pbVar16 + 0x20 );
                        *(ulong*)pfVar14 = CONCAT44((float)( (ulong)uVar3 >> 0x20 ) * fVar28, (float)uVar3 * fVar28);
                     }
               ...
               piVar17 = piVar17 + 1;
               pQVar15 = pQVar15 + 0x10;
               pfVar14 = pfVar14 + 3;
               pbVar16 = pbVar16 + 0x28;
               pQVar10 = pQVar10 + 0x10;
            }
 while ( piVar17 != local_4d0 );
            if (local_538[0] != 0) {
               pOVar13 = this + 0x550;
               pfVar14 = (float*)&local_4c8;
               do {
                  if (*(uint*)pOVar13 != 0xffffffff) {
                     lVar12 = (long)(int)*(uint*)( pOVar13 + 4 );
                     pQVar15 = local_1e8 + lVar12 * 0x10;
                     Quaternion::operator *((Quaternion*)local_568, pQVar15);
                     fVar28 = *pfVar14;
                     fVar1 = local_4c0[lVar12 * 3 + -2];
                     fVar32 = (float)*(undefined8*)( pfVar14 + 1 ) - (float)*(undefined8*)( local_4c0 + lVar12 * 3 + -1 );
                     fVar34 = (float)( ( ulong ) * (undefined8*)( pfVar14 + 1 ) >> 0x20 ) - (float)( ( ulong ) * (undefined8*)( local_4c0 + lVar12 * 3 + -1 ) >> 0x20 );
                     uVar30 = *(undefined8*)( (long)&local_4c8 + lVar12 * 3 * 4 );
                     fVar29 = (float)*(undefined8*)pfVar14 - (float)uVar30;
                     fVar31 = (float)( ( ulong ) * (undefined8*)pfVar14 >> 0x20 ) - (float)( (ulong)uVar30 >> 0x20 );
                     uVar30 = CONCAT44(fVar31, fVar29);
                     fVar33 = local_4c0[lVar12 * 3];
                     fVar2 = pfVar14[2];
                     ...
                     if (cVar6 == '\0') {
                        ...
                        operator+((char *)
                        local_5b0,(String*)"The quaternion ";
                        String::operator +(local_5a0, (String*)local_5b0);
                        _err_print_error("xform", "./core/math/quaternion.h", 0x5c, "Condition \"!is_normalized()\" is true. Returning: p_v", local_5a0, 0, 0);
                        ...
                        uVar30 = *(undefined8*)( (long)auStack_1e0 + lVar12 * 0x10 + -4 );
                        uVar22 = *(undefined8*)( local_1e8 + lVar12 * 0x10 );
                        fVar19 = (float)*(undefined8*)pQVar15;
                        fVar37 = (float)auStack_1e0[lVar12 * 2];
                        fVar26 = (float)uVar30;
                        fVar27 = (float)( (ulong)uVar30 >> 0x20 );
                        fVar21 = (float)uVar22;
                        fVar23 = (float)( (ulong)uVar22 >> 0x20 );
                        fVar36 = fVar29 * fVar37 - fVar21 * ( fVar2 - fVar33 );
                        fVar24 = fVar21 * fVar32 - fVar26 * fVar29;
                        fVar25 = fVar23 * fVar34 - fVar27 * fVar31;
                        fVar35 = (float)( (ulong)auStack_1e0[lVar12 * 2] >> 0x20 );
                        fVar33 = ( ( fVar2 - fVar33 ) * fVar26 - fVar32 * fVar37 ) * fVar35 + ( fVar26 * fVar24 - fVar37 * fVar36 );
                        fVar28 = ( ( fVar28 - fVar1 ) * fVar27 - fVar34 * fVar19 ) * fVar35 + ( fVar27 * fVar25 - fVar19 * ( fVar31 * fVar19 - fVar23 * ( fVar28 - fVar1 ) ) );
                        uVar30 = CONCAT44(fVar31 + fVar28 + fVar28, fVar29 + fVar33 + fVar33);
                        fVar28 = ( fVar21 * fVar36 - fVar26 * fVar25 ) + fVar24 * fVar35;
                        fVar34 = fVar34 + fVar28 + fVar28;
                     }

                     local_598._8_4_ = fVar34;
                     local_598._0_8_ = uVar30;
                     if (*(int*)( this + 0x54c ) == 0) {
                        Skeleton3D::set_bone_pose_position((int)lVar8, (Vector3*)( ulong ) * (uint*)pOVar13);
                     }

                     Skeleton3D::set_bone_pose_rotation((int)lVar8, (Quaternion*)( ulong ) * (uint*)pOVar13);
                  }

                  pOVar13 = pOVar13 + 8;
                  pfVar14 = pfVar14 + 3;
               }
 while ( pOVar13 != this + 0x620 );
      ...
      LAB_001004e8:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
 ...
 while ( lVar1 != lVar7 );
      ...
      if (local_c8 == 0) {
         ...
         local_70 = 6;
         if (local_80 != 0x11) goto LAB_0010181b;
      ...
      local_78 = 0;
      if (local_c8 == 0) {
         LAB_00101a2b:local_70 = 6;
         StringName::operator =((StringName*)&local_88, (StringName*)&local_c0);
      }
 else {
         CowData<char32_t>::_ref((CowData<char32_t>*)&local_78, (CowData*)&local_c8);
         local_70 = 6;
         if (local_80 != 0x11) goto LAB_00101a2b;
         StringName::StringName((StringName*)&local_a8, (String*)&local_78, false);
         if (local_88 == (long*)local_a8) {
            if (( StringName::configured != '\0' ) && ( local_a8 != (char*)0x0 )) {
               StringName::unref();
      ...
      local_78 = 0;
      if (local_c8 == 0) {
         LAB_00101c1b:local_70 = 6;
         StringName::operator =((StringName*)&local_88, (StringName*)&local_c0);
      }
 else {
         CowData<char32_t>::_ref((CowData<char32_t>*)&local_78, (CowData*)&local_c8);
         local_70 = 6;
         if (local_80 != 0x11) goto LAB_00101c1b;
         StringName::StringName((StringName*)&local_a8, (String*)&local_78, false);
         if (local_88 == (long*)local_a8) {
            if (( StringName::configured != '\0' ) && ( local_a8 != (char*)0x0 )) {
               StringName::unref();
      ...
      local_78 = 0;
      if (local_c8 == 0) {
         LAB_00101e2b:local_70 = 6;
         StringName::operator =((StringName*)&local_88, (StringName*)&local_c0);
      }
 else {
         CowData<char32_t>::_ref((CowData<char32_t>*)&local_78, (CowData*)&local_c8);
         local_70 = 6;
         if (local_80 != 0x11) goto LAB_00101e2b;
         StringName::StringName((StringName*)&local_a8, (String*)&local_78, false);
         if (local_88 == (long*)local_a8) {
            if (( StringName::configured != '\0' ) && ( local_a8 != (char*)0x0 )) {
               StringName::unref();
      ...
      GetTypeInfo<OpenXRHand::Hands,void>::get_class_info((GetTypeInfo<OpenXRHand::Hands,void>*)&local_98);
      ...
      GetTypeInfo<OpenXRHand::MotionRange,void>::get_class_info((GetTypeInfo<OpenXRHand::MotionRange,void>*)&local_98);
      local_b0 = (char*)local_88;
      local_88 = (long*)0x0;
      PropertyInfo::~PropertyInfo((PropertyInfo*)&local_98);
      local_c0 = 0;
      ...
      GetTypeInfo<OpenXRHand::SkeletonRig,void>::get_class_info((GetTypeInfo<OpenXRHand::SkeletonRig,void>*)&local_98);
      local_b0 = (char*)local_88;
      local_88 = (long*)0x0;
      PropertyInfo::~PropertyInfo((PropertyInfo*)&local_98);
      local_98 = "OpenXRHand";
      ...
      local_90 = 0x10;
      String::parse_latin1((StrRange*)&local_b8);
      GetTypeInfo<OpenXRHand::BoneUpdate,void>::get_class_info((GetTypeInfo<OpenXRHand::BoneUpdate,void>*)&local_98);
      local_b0 = (char*)local_88;
      local_88 = (long*)0x0;
      PropertyInfo::~PropertyInfo((PropertyInfo*)&local_98);
      local_c0 = 0;
   ...
   void OpenXRHand::_get_joint_data(OpenXRHand *this) {
      long lVar1;
      int iVar2;
      int iVar3;
      OpenXRHand *pOVar4;
      ...
      if (( _get_joint_data() ) && ( iVar2 = iVar2 != 0 )) {
         _get_joint_data()
         String::parse_latin1((String*)_get_joint_data(), ::bone_names, "Palm");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "Wrist");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "Thumb_Metacarpal");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "Thumb_Proximal");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "Thumb_Distal");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "Thumb_Tip");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "Index_Metacarpal");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "Index_Proximal");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "Index_Intermediate");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "Index_Distal");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "Index_Tip");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "Middle_Metacarpal");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "Middle_Proximal");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "Middle_Intermediate");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "Middle_Distal");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "Middle_Tip");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "Ring_Metacarpal");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "Ring_Proximal");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "Ring_Intermediate");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "Ring_Distal");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "Ring_Tip");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "Little_Metacarpal");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "Little_Proximal");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "Little_Intermediate");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "Little_Distal");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "Little_Tip");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "Palm");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "Hand");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "ThumbMetacarpal");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "ThumbProximal");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "ThumbDistal");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "ThumbTip");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "IndexMetacarpal");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "IndexProximal");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "IndexIntermediate");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "IndexDistal");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "IndexTip");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "MiddleMetacarpal");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "MiddleProximal");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "MiddleIntermediate");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "MiddleDistal");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "MiddleTip");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "RingMetacarpal");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "RingProximal");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "RingIntermediate");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "RingDistal");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "RingTip");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "LittleMetacarpal");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "LittleProximal");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "LittleIntermediate");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "LittleDistal");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "LittleTip");
      ...
      if (( _get_joint_data() ) && ( iVar2 = iVar2 != 0 )) {
         ...
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "<bone>_R");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "Left<bone>");
         _get_joint_data()
         String::parse_latin1((String*)( _get_joint_data() ), "Right<bone>");
      ...
      *(int*)pOVar10 = -1;
      for (int i = 0; i < 3; i++) {
         *(undefined4*)( this + ( 4*i + 1364 ) ) = 4294967295;
      }

      pOVar4 = this + 0x560;
      do {
         *(undefined4*)pOVar4 = 0xffffffff;
         for (int i = 0; i < 3; i++) {
            *(undefined4*)( pOVar4 + ( 4*i + 4 ) ) = 4294967295;
         }

         pOVar5 = pOVar4 + 0x20;
         for (int i = 0; i < 4; i++) {
            *(undefined4*)( pOVar4 + ( 4*i + 16 ) ) = 4294967295;
         }

         pOVar4 = pOVar5;
      }
 while ( pOVar5 != this + 0x620 );
      pSVar6 = (String*)get_skeleton(this);
      if (pSVar6 != (String*)0x0) {
         ...
         do {
            ...
            String::replace((String*)&local_f0, (String*)( _get_joint_data() ));
            lVar1 = local_e0;
            if (local_e0 != 0) {
               LOCK();
            ...
            *(int*)( (long)local_a8 + lVar8 * 4 ) = iVar2;
            if (iVar2 == -1) {
               local_e8 = 0;
 ...
 while ( !bVar11 );
               ...
               LAB_00103036:stringify_variants<String>((String*)&local_d8, (Variant*)local_c8, (StrRange*)&local_e0);
            ...
            if (iVar2 != -1) {
               ...
               if (iVar3 == -1) {
                  ...
                  *(int*)( pOVar10 + 4 ) = 0;
                  ...
                  do {
                     if (*(int*)( (long)local_a8 + lVar8 * 4 ) == iVar3) {
                        *(ulong*)pOVar10 = CONCAT44((int)lVar8, iVar2);
                        break;
                     }
 ...
 while ( plVar9 != local_40 );
   ...
   void OpenXRHand::_notification(OpenXRHand *this, int param_1) {
      OpenXRHand *pOVar1;
      OpenXRHand *pOVar2;
      if (param_1 == 0xb) {
         Node::set_process_internal(SUB81(this, 0));
         for (int i = 0; i < 4; i++) {
            *(undefined4*)( this + ( 4*i + 1360 ) ) = 4294967295;
         }
         ...
         do {
            *(undefined4*)pOVar1 = 0xffffffff;
            for (int i = 0; i < 3; i++) {
               *(undefined4*)( pOVar1 + ( 4*i + 4 ) ) = 4294967295;
            }

            pOVar2 = pOVar1 + 0x20;
            for (int i = 0; i < 4; i++) {
               *(undefined4*)( pOVar1 + ( 4*i + 16 ) ) = 4294967295;
            }

            pOVar1 = pOVar2;
         }
 while ( pOVar2 != this + 0x620 );
         return;
      }
   ...
   uint OpenXRHand::is_class_ptr(OpenXRHand *this, void *param_1) {
      return (uint)CONCAT71(0x10d0, (undefined4*)param_1 == &Node3D::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10d0, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10d0, (undefined4*)param_1 == &Node::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10d0, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
   }
   ...
   char MethodBindT<OpenXRHand::BoneUpdate>::_gen_argument_type(MethodBindT<OpenXRHand::BoneUpdate> *this, int param_1) {
   ...
   char MethodBindT<OpenXRHand::SkeletonRig>::_gen_argument_type(MethodBindT<OpenXRHand::SkeletonRig> *this, int param_1) {
      return ( param_1 == 0 ) * '\x02';
   }
   ...
   char MethodBindT<OpenXRHand::MotionRange>::_gen_argument_type(MethodBindT<OpenXRHand::MotionRange> *this, int param_1) {
      return ( param_1 == 0 ) * '\x02';
   }
   ...
   char MethodBindT<OpenXRHand::Hands>::_gen_argument_type(MethodBindT<OpenXRHand::Hands> *this, int param_1) {
      return ( param_1 == 0 ) * '\x02';
   }
   ...
   void MethodBindT<OpenXRHand::Hands>::~MethodBindT(MethodBindT<OpenXRHand::Hands> *this) {
      *(undefined***)this = &PTR__gen_argument_type_0010ccc0;
   ...
   void MethodBindTRC<OpenXRHand::Hands>::~MethodBindTRC(MethodBindTRC<OpenXRHand::Hands> *this) {
      *(undefined***)this = &PTR__gen_argument_type_0010cd20;
      MethodBind::~MethodBind((MethodBind*)this);
      return;
   }
   ...
   void MethodBindT<NodePath_const&>::~MethodBindT(MethodBindT<NodePath_const&> *this) {
      *(undefined***)this = &PTR__gen_argument_type_0010cd80;
      MethodBind::~MethodBind((MethodBind*)this);
      return;
   }
   ...
   void MethodBindT<OpenXRHand::MotionRange>::~MethodBindT(MethodBindT<OpenXRHand::MotionRange> *this) {
   ...
   void MethodBindTRC<OpenXRHand::MotionRange>::~MethodBindTRC(MethodBindTRC<OpenXRHand::MotionRange> *this) {
   ...
   void MethodBindT<OpenXRHand::SkeletonRig>::~MethodBindT(MethodBindT<OpenXRHand::SkeletonRig> *this) {
   ...
   void MethodBindTRC<OpenXRHand::SkeletonRig>::~MethodBindTRC(MethodBindTRC<OpenXRHand::SkeletonRig> *this) {
   ...
   void MethodBindT<OpenXRHand::BoneUpdate>::~MethodBindT(MethodBindT<OpenXRHand::BoneUpdate> *this) {
   ...
   void MethodBindTRC<OpenXRHand::BoneUpdate>::~MethodBindTRC(MethodBindTRC<OpenXRHand::BoneUpdate> *this) {
      *(undefined***)this = &PTR__gen_argument_type_0010d020;
      MethodBind::~MethodBind((MethodBind*)this);
      return;
   }
   ...
   void OpenXRHand::~OpenXRHand(OpenXRHand *this) {
      *(undefined***)this = &PTR__initialize_classv_0010cad8;
   ...
   undefined8 *OpenXRHand::_get_class_namev(void) {
      ...
      if (_get_class_namev()::_class_name_static != 0) {
         if (*(long*)( _get_class_namev() ) != 0) {
            LAB_001048a3:return &_get_class_namev();
         }

         if (*(long*)( _get_class_namev() ) != 0) {
            if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001048a3;
            StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "OpenXRHand");
            goto LAB_0010490e;
         }
      ...
      StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "OpenXRHand");
      LAB_0010490e:return &_get_class_namev();
   }
   ...
   undefined4 *MethodBindTRC<NodePath>::_gen_argument_type_info(int param_1) {
      ...
      *(undefined1(*) [16])( puVar3 + 2 ) = (undefined1[16])0x0;
      ...
      lVar2 = local_58;
      joined_r0x00104b5c:local_58 = lVar2;
      if (lVar2 != 0) {
         LOCK();
   ...
   details * __thiscallgodot::details::enum_qualified_name_to_class_info_name(details * this, String * param_1);
   {
      ...
      long local_30;
      local_30 = *(long*)( in_FS_OFFSET + 0x28 );
      String::split(local_58, SUB81(param_1, 0), 0x104cdd);
 ...
 while ( lVar7 != lVar6 );
   ...
   GetTypeInfo<OpenXRHand::Hands,void> * GetTypeInfo<OpenXRHand::Hands,void>::get_class_info(GetTypeInfo<OpenXRHand::Hands,void> * this);
   {
      long in_FS_OFFSET;
      undefined8 local_60;
      undefined8 local_58;
   ...
   GetTypeInfo<OpenXRHand::MotionRange,void> * GetTypeInfo<OpenXRHand::MotionRange,void>::get_class_info(GetTypeInfo<OpenXRHand::MotionRange,void> * this);
   {
      long *plVar1;
      long lVar2;
      long in_FS_OFFSET;
   ...
   GetTypeInfo<OpenXRHand::SkeletonRig,void> * GetTypeInfo<OpenXRHand::SkeletonRig,void>::get_class_info(GetTypeInfo<OpenXRHand::SkeletonRig,void> * this);
   {
      long in_FS_OFFSET;
      undefined8 local_60;
      undefined8 local_58;
   ...
   GetTypeInfo<OpenXRHand::BoneUpdate,void> * GetTypeInfo<OpenXRHand::BoneUpdate,void>::get_class_info(GetTypeInfo<OpenXRHand::BoneUpdate,void> * this);
   {
      long in_FS_OFFSET;
      undefined8 local_60;
      undefined8 local_58;
   ...
   undefined8 OpenXRHand::is_class(OpenXRHand *this, String *param_1) {
      long *plVar1;
      long lVar2;
      long lVar3;
      long lVar4;
 ...
 while ( !bVar9 );
         ...
         LAB_0010545f:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
      ...
      LAB_00105513:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }

      LAB_0010574c:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }
   ...
   void Node::_get_property_listv(List *param_1, bool param_2) {
      ...
      local_58 = 0;
      if (local_90 == 0) {
         LAB_00105d5d:local_50 = 0x80;
         StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
      }
 else {
         CowData<char32_t>::_ref((CowData<char32_t>*)&local_58, (CowData*)&local_90);
         local_50 = 0x80;
         if (local_60 != 0x11) goto LAB_00105d5d;
         StringName::StringName((StringName*)&local_80, (String*)&local_58, false);
         if (local_68 != local_80) {
            StringName::unref();
            lVar2 = *(long*)pLVar5;
            local_68 = local_80;
            goto joined_r0x00105d7f;
         }
   ...
   void Node3D::_get_property_listv(Node3D *this, List *param_1, bool param_2) {
      ...
      local_58 = 0;
      if (local_90 == 0) {
         LAB_001060dd:local_50 = 0x80;
         StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
      }
 else {
         CowData<char32_t>::_ref((CowData<char32_t>*)&local_58, (CowData*)&local_90);
         local_50 = 0x80;
         if (local_60 != 0x11) goto LAB_001060dd;
         StringName::StringName((StringName*)&local_80, (String*)&local_58, false);
         if (local_68 != local_80) {
            StringName::unref();
            lVar2 = *(long*)param_1;
            local_68 = local_80;
            goto joined_r0x001060ff;
         }
   ...
   void OpenXRHand::_get_property_listv(OpenXRHand *this, List *param_1, bool param_2) {
      long *plVar1;
      long lVar2;
      undefined1(*pauVar3)[16];
      undefined4 *puVar4;
      ...
      local_58 = 0;
      if (local_90 == 0) {
         LAB_001064bd:local_50 = 0x80;
         StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
      }
 else {
         CowData<char32_t>::_ref((CowData<char32_t>*)&local_58, (CowData*)&local_90);
         local_50 = 0x80;
         if (local_60 != 0x11) goto LAB_001064bd;
         StringName::StringName((StringName*)&local_80, (String*)&local_58, false);
         if (local_68 != local_80) {
            StringName::unref();
            lVar2 = *(long*)param_1;
            local_68 = local_80;
            goto joined_r0x001064df;
         }
   ...
   undefined4 *MethodBindT<OpenXRHand::Hands>::_gen_argument_type_info(int param_1) {
      ...
      *(undefined1(*) [16])( puVar2 + 2 ) = (undefined1[16])0x0;
      if (in_EDX == 0) {
         GetTypeInfo<OpenXRHand::Hands,void>::get_class_info((GetTypeInfo<OpenXRHand::Hands,void>*)local_48);
         *puVar2 = local_48[0];
   ...
   undefined4 *MethodBindT<OpenXRHand::SkeletonRig>::_gen_argument_type_info(int param_1) {
      ...
      *(undefined1(*) [16])( puVar2 + 2 ) = (undefined1[16])0x0;
      if (in_EDX == 0) {
         GetTypeInfo<OpenXRHand::SkeletonRig,void>::get_class_info((GetTypeInfo<OpenXRHand::SkeletonRig,void>*)local_48);
         *puVar2 = local_48[0];
         if (*(long*)( puVar2 + 2 ) != local_40) {
            CowData<char32_t>::_unref((CowData<char32_t>*)( puVar2 + 2 ));
            lVar1 = local_40;
   ...
   undefined4 *MethodBindT<OpenXRHand::MotionRange>::_gen_argument_type_info(int param_1) {
      ...
      *(undefined1(*) [16])( puVar2 + 2 ) = (undefined1[16])0x0;
      if (in_EDX == 0) {
         GetTypeInfo<OpenXRHand::MotionRange,void>::get_class_info((GetTypeInfo<OpenXRHand::MotionRange,void>*)local_48);
         *puVar2 = local_48[0];
         if (*(long*)( puVar2 + 2 ) != local_40) {
            CowData<char32_t>::_unref((CowData<char32_t>*)( puVar2 + 2 ));
            lVar1 = local_40;
   ...
   undefined4 *MethodBindT<OpenXRHand::BoneUpdate>::_gen_argument_type_info(int param_1) {
      ...
      *(undefined1(*) [16])( puVar2 + 2 ) = (undefined1[16])0x0;
      if (in_EDX == 0) {
         GetTypeInfo<OpenXRHand::BoneUpdate,void>::get_class_info((GetTypeInfo<OpenXRHand::BoneUpdate,void>*)local_48);
         *puVar2 = local_48[0];
         if (*(long*)( puVar2 + 2 ) != local_40) {
            CowData<char32_t>::_unref((CowData<char32_t>*)( puVar2 + 2 ));
            lVar1 = local_40;
   ...
   undefined4 *MethodBindT<NodePath_const&>::_gen_argument_type_info(int param_1) {
      ...
      *(undefined1(*) [16])( puVar5 + 2 ) = (undefined1[16])0x0;
      ...
      if (local_80 == 0) {
         LAB_00106d05:local_40 = 6;
         StringName::operator =((StringName*)( local_60 + 8 ), (StringName*)&local_78);
      }
 else {
         CowData<char32_t>::_ref((CowData<char32_t>*)&local_48, (CowData*)&local_80);
         local_40 = 6;
         if (local_50 != 0x11) goto LAB_00106d05;
      ...
      *puVar5 = local_68._0_4_;
      ...
      CowData<char32_t>::_unref((CowData<char32_t>*)local_60);
      LAB_00106c09:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Subroutine does not return */
         __stack_chk_fail();
      }
   ...
   /* WARNING: Removing unreachable block (ram,0x00107f70) */
   /* OpenXRHand::_notificationv(int, bool) */
   void OpenXRHand::_notificationv(OpenXRHand *this, int param_1, bool param_2) {
      int iVar1;
      iVar1 = (int)this;
      if (param_2) {
   ...
   const */
   Object *MethodBindTRC<OpenXRHand::BoneUpdate>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
      Variant *pVVar1;
      int iVar2;
      long *plVar4;
      ...
      *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
      if (( ( plVar5 != (long*)0x0 ) && ( plVar5[1] != 0 ) ) && ( *(char*)( plVar5[1] + 0x2e ) != '\0' )) {
         ...
         if (local_58 == (char*)*plVar4) {
            ...
            _err_print_error(&_LC130, "./core/object/method_bind.h", 0x267, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: ret", (StringName*)&local_58, 0, 0);
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
            if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
               StringName::unref();
      ...
      LAB_001084d0:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return param_1;
      }
    ...
    */
   void MethodBindTRC<OpenXRHand::BoneUpdate>::validated_call(MethodBindTRC<OpenXRHand::BoneUpdate> *this, Object *param_1, Variant **param_2, Variant *param_3) {
      uint uVar1;
      long *plVar3;
      long in_FS_OFFSET;
      long local_58;
      ...
      *(ulong*)( param_3 + 8 ) = (ulong)uVar1;
      LAB_00108774:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   ...
   void MethodBindTRC<OpenXRHand::BoneUpdate>::ptrcall(MethodBindTRC<OpenXRHand::BoneUpdate> *this, Object *param_1, void **param_2, void *param_3) {
      uint uVar1;
      long *plVar3;
      long in_FS_OFFSET;
      long local_58;
      ...
      *(ulong*)param_3 = (ulong)uVar1;
      LAB_00108933:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   ...
   void MethodBindT<OpenXRHand::BoneUpdate>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
      ...
      if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Could not recover jumptable at 0x00108afc. Too many branches */
         /* WARNING: Treating indirect jump as call */
         ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), *(undefined4*)( *(long*)param_3 + 8 ));
         return;
      }

      LAB_00108c71:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }
   ...
   void MethodBindT<OpenXRHand::BoneUpdate>::ptrcall(Object *param_1, void **param_2, void *param_3) {
      ...
      if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Could not recover jumptable at 0x00108cdb. Too many branches */
         /* WARNING: Treating indirect jump as call */
         ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), **param_3);
         return;
      }

      LAB_00108e51:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }

   /* MethodBindTRC<OpenXRHand::SkeletonRig>::call(Object*, Variant const**, int, Callable::CallError&)
   const */
   Object *MethodBindTRC<OpenXRHand::SkeletonRig>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
      Variant *pVVar1;
      int iVar2;
      long *plVar4;
      undefined4 in_register_00000014;
      ...
      *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
      ...
      LAB_00108f20:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return param_1;
      }
    ...
    */
   void MethodBindTRC<OpenXRHand::SkeletonRig>::validated_call(MethodBindTRC<OpenXRHand::SkeletonRig> *this, Object *param_1, Variant **param_2, Variant *param_3) {
      uint uVar1;
      long *plVar3;
      long in_FS_OFFSET;
      long local_58;
      ...
      uVar1 = ( *pcVar2 )(param_1 + *(long*)( this + 0x60 ));
      *(ulong*)( param_3 + 8 ) = (ulong)uVar1;
      LAB_00109134:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   ...
   void MethodBindTRC<OpenXRHand::SkeletonRig>::ptrcall(MethodBindTRC<OpenXRHand::SkeletonRig> *this, Object *param_1, void **param_2, void *param_3) {
      uint uVar1;
      long *plVar3;
      long in_FS_OFFSET;
      long local_58;
      ...
      uVar1 = ( *pcVar2 )(param_1 + *(long*)( this + 0x60 ));
      *(ulong*)param_3 = (ulong)uVar1;
      LAB_001092e3:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   ...
   void MethodBindT<OpenXRHand::SkeletonRig>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
      code *UNRECOVERED_JUMPTABLE;
      Variant *pVVar1;
      long in_FS_OFFSET;
      long local_58;
      ...
      if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Could not recover jumptable at 0x001094ac. Too many branches */
         /* WARNING: Treating indirect jump as call */
         ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), *(undefined4*)( *(long*)param_3 + 8 ));
         return;
      }

      LAB_00109621:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }
   ...
   void MethodBindT<OpenXRHand::SkeletonRig>::ptrcall(Object *param_1, void **param_2, void *param_3) {
      ...
      if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Could not recover jumptable at 0x0010968b. Too many branches */
         /* WARNING: Treating indirect jump as call */
         ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), **param_3);
         return;
      }

      LAB_00109801:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }

   /* MethodBindTRC<OpenXRHand::MotionRange>::call(Object*, Variant const**, int, Callable::CallError&)
   const */
   Object *MethodBindTRC<OpenXRHand::MotionRange>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
      Variant *pVVar1;
      int iVar2;
      long *plVar4;
      undefined4 in_register_00000014;
    ...
    */
   void MethodBindTRC<OpenXRHand::MotionRange>::validated_call(MethodBindTRC<OpenXRHand::MotionRange> *this, Object *param_1, Variant **param_2, Variant *param_3) {
      uint uVar1;
      long *plVar3;
      long in_FS_OFFSET;
      long local_58;
      ...
      uVar1 = ( *pcVar2 )(param_1 + *(long*)( this + 0x60 ));
      *(ulong*)( param_3 + 8 ) = (ulong)uVar1;
      LAB_00109ae4:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   ...
   void MethodBindTRC<OpenXRHand::MotionRange>::ptrcall(MethodBindTRC<OpenXRHand::MotionRange> *this, Object *param_1, void **param_2, void *param_3) {
      uint uVar1;
      long *plVar3;
      long in_FS_OFFSET;
      long local_58;
      ...
      uVar1 = ( *pcVar2 )(param_1 + *(long*)( this + 0x60 ));
      *(ulong*)param_3 = (ulong)uVar1;
      LAB_00109c93:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   ...
   void MethodBindT<OpenXRHand::MotionRange>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
      code *UNRECOVERED_JUMPTABLE;
      Variant *pVVar1;
      long in_FS_OFFSET;
      long local_58;
      ...
      if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Could not recover jumptable at 0x00109e5c. Too many branches */
         /* WARNING: Treating indirect jump as call */
         ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), *(undefined4*)( *(long*)param_3 + 8 ));
         return;
      }
   ...
   void MethodBindT<OpenXRHand::MotionRange>::ptrcall(Object *param_1, void **param_2, void *param_3) {
      ...
      if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Could not recover jumptable at 0x0010a03b. Too many branches */
         /* WARNING: Treating indirect jump as call */
         ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), **param_3);
         return;
      }
   ...
   Object *MethodBindTRC<NodePath>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
      ...
      *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
      ...
      LAB_0010a290:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return param_1;
      }
   ...
   void MethodBindTRC<NodePath>::validated_call(MethodBindTRC<NodePath> *this, Object *param_1, Variant **param_2, Variant *param_3) {
      ...
      LAB_0010a4b9:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   ...
   void MethodBindTRC<NodePath>::ptrcall(MethodBindTRC<NodePath> *this, Object *param_1, void **param_2, void *param_3) {
      ...
      NodePath::~NodePath((NodePath*)&local_48);
      LAB_0010a68a:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   ...
   void MethodBindT<NodePath_const&>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
      ...
      if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Could not recover jumptable at 0x0010a85d. Too many branches */
         /* WARNING: Treating indirect jump as call */
         ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), *(long*)param_3 + 8);
         return;
      }

      LAB_0010a9d1:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }
   ...
   void MethodBindT<NodePath_const&>::ptrcall(Object *param_1, void **param_2, void *param_3) {
      ...
      if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Could not recover jumptable at 0x0010aa39. Too many branches */
         /* WARNING: Treating indirect jump as call */
         ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), *param_3);
         return;
      }

      LAB_0010abb1:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }

   /* MethodBindTRC<OpenXRHand::Hands>::call(Object*, Variant const**, int, Callable::CallError&) const
    */
   Object *MethodBindTRC<OpenXRHand::Hands>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
      Variant *pVVar1;
      int iVar2;
      long *plVar4;
      undefined4 in_register_00000014;
      ...
      *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
      ...
      LAB_0010ac80:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return param_1;
      }
   ...
   void MethodBindTRC<OpenXRHand::Hands>::validated_call(MethodBindTRC<OpenXRHand::Hands> *this, Object *param_1, Variant **param_2, Variant *param_3) {
      uint uVar1;
      long *plVar3;
      long in_FS_OFFSET;
      long local_58;
      ...
      uVar1 = ( *pcVar2 )(param_1 + *(long*)( this + 0x60 ));
      *(ulong*)( param_3 + 8 ) = (ulong)uVar1;
      LAB_0010ae94:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   ...
   void MethodBindTRC<OpenXRHand::Hands>::ptrcall(MethodBindTRC<OpenXRHand::Hands> *this, Object *param_1, void **param_2, void *param_3) {
      uint uVar1;
      long *plVar3;
      long in_FS_OFFSET;
      long local_58;
      ...
      uVar1 = ( *pcVar2 )(param_1 + *(long*)( this + 0x60 ));
      *(ulong*)param_3 = (ulong)uVar1;
      LAB_0010b043:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   ...
   void MethodBindT<OpenXRHand::Hands>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
      code *UNRECOVERED_JUMPTABLE;
      Variant *pVVar1;
      long in_FS_OFFSET;
      long local_58;
      ...
      if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Could not recover jumptable at 0x0010b20c. Too many branches */
         /* WARNING: Treating indirect jump as call */
         ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), *(undefined4*)( *(long*)param_3 + 8 ));
         return;
      }

      LAB_0010b381:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }
   ...
   void MethodBindT<OpenXRHand::Hands>::ptrcall(Object *param_1, void **param_2, void *param_3) {
      ...
      if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Could not recover jumptable at 0x0010b3eb. Too many branches */
         /* WARNING: Treating indirect jump as call */
         ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), **param_3);
         return;
      }

      LAB_0010b561:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }
   ...
   Object *MethodBindT<NodePath_const&>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
      ...
      if (( ( plVar9 != (long*)0x0 ) && ( plVar9[1] != 0 ) ) && ( *(char*)( plVar9[1] + 0x2e ) != '\0' )) {
         ...
         if (local_48 == (char*)*plVar7) {
            ...
            String::parse_latin1((StrRange*)&local_50);
            vformat<StringName>((StringName*)&local_48, (StrRange*)&local_50, &local_58);
            _err_print_error(&_LC130, "./core/object/method_bind.h", 0x154, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: Variant()", (StringName*)&local_48, 0, 0);
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_48);
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_50);
            if (( StringName::configured != '\0' ) && ( local_58 != 0 )) {
               StringName::unref();
      ...
      if (in_R8D < 2) {
         ...
         if (pVVar10 == (Variant*)0x0) {
            if (in_R8D != 1) goto LAB_0010b760;
            LAB_0010b750:pVVar10 = *(Variant**)param_4;
         }
 else {
            lVar2 = *(long*)( pVVar10 + -8 );
            if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
               LAB_0010b760:uVar6 = 4;
               goto LAB_0010b705;
            }

            if (in_R8D == 1) goto LAB_0010b750;
         ...
         *in_R9 = 0;
         ...
         uVar6 = 3;
         LAB_0010b705:*in_R9 = uVar6;
         in_R9[2] = 1;
      }

      LAB_0010b710:*(undefined4*)param_1 = 0;
      *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
      if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return param_1;
      }
   ...
   void call_with_variant_args_dv<__UnexistingClass,OpenXRHand::BoneUpdate>(__UnexistingClass *param_1, _func_void_BoneUpdate *param_2, Variant **param_3, int param_4, CallError *param_5, Vector *param_6) {
      long lVar1;
      long lVar2;
      code *pcVar3;
      undefined8 uVar4;
      ...
      if (lVar1 == 0) {
         if (uVar8 != 1) goto LAB_0010ba80;
      }
 else {
         lVar2 = *(long*)( lVar1 + -8 );
         if ((int)lVar2 < (int)( uVar8 ^ 1 )) {
            LAB_0010ba80:uVar6 = 4;
            LAB_0010ba1d:*(undefined4*)param_6 = uVar6;
      ...
      LAB_0010b99b:*(undefined4*)param_6 = 0;
      ...
      /* WARNING: Could not recover jumptable at 0x0010b9f6. Too many branches */
      /* WARNING: Treating indirect jump as call */
   ...
   const */
   Object *MethodBindT<OpenXRHand::BoneUpdate>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
      long *plVar1;
      undefined4 in_register_00000014;
      ...
      call_with_variant_args_dv<__UnexistingClass,OpenXRHand::BoneUpdate>(p_Var2, (_func_void_BoneUpdate*)param_2[0xb], (Variant**)param_2[0xc], (int)param_4, in_R8, in_R9);
      *(undefined4*)param_1 = 0;
      *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
      LAB_0010bae6:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return param_1;
      }
   ...
   Vector<Variant> const&) */
   void call_with_variant_args_dv<__UnexistingClass,OpenXRHand::SkeletonRig>(__UnexistingClass *param_1, _func_void_SkeletonRig *param_2, Variant **param_3, int param_4, CallError *param_5, Vector *param_6) {
      long lVar1;
      long lVar2;
      code *pcVar3;
      undefined8 uVar4;
      ...
      lVar1 = *(long*)( in_stack_00000008 + 8 );
      if (lVar1 == 0) {
         if (uVar8 != 1) goto LAB_0010be10;
      }
 else {
         lVar2 = *(long*)( lVar1 + -8 );
         if ((int)lVar2 < (int)( uVar8 ^ 1 )) {
            LAB_0010be10:uVar6 = 4;
            LAB_0010bdad:*(undefined4*)param_6 = uVar6;
            *(undefined4*)( param_6 + 8 ) = 1;
            return;
         }
      ...
      this * (Variant**)CONCAT44(in_register_0000000c, param_4);
      LAB_0010bd2b:*(undefined4*)param_6 = 0;
      if (( (ulong)param_2 & 1 ) != 0) {
      ...
      Variant::operator_cast_to_long(this);
      /* WARNING: Could not recover jumptable at 0x0010bd86. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *param_2 )((char)( param_1 + (long)param_3 ));
      return;
   }
   ...
   const */
   Object *MethodBindT<OpenXRHand::SkeletonRig>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
      long *plVar1;
      undefined4 in_register_00000014;
      __UnexistingClass *p_Var2;
      CallError *in_R8;
      ...
      call_with_variant_args_dv<__UnexistingClass,OpenXRHand::SkeletonRig>(p_Var2, (_func_void_SkeletonRig*)param_2[0xb], (Variant**)param_2[0xc], (int)param_4, in_R8, in_R9);
      *(undefined4*)param_1 = 0;
      *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
      LAB_0010be76:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return param_1;
      }
   ...
   Vector<Variant> const&) */
   void call_with_variant_args_dv<__UnexistingClass,OpenXRHand::MotionRange>(__UnexistingClass *param_1, _func_void_MotionRange *param_2, Variant **param_3, int param_4, CallError *param_5, Vector *param_6) {
      long lVar1;
      long lVar2;
      code *pcVar3;
      undefined8 uVar4;
      ...
      lVar1 = *(long*)( in_stack_00000008 + 8 );
      if (lVar1 == 0) {
         if (uVar8 != 1) goto LAB_0010c1a0;
      }
 else {
         lVar2 = *(long*)( lVar1 + -8 );
         if ((int)lVar2 < (int)( uVar8 ^ 1 )) {
            LAB_0010c1a0:uVar6 = 4;
            LAB_0010c13d:*(undefined4*)param_6 = uVar6;
            *(undefined4*)( param_6 + 8 ) = 1;
            return;
         }
      ...
      this * (Variant**)CONCAT44(in_register_0000000c, param_4);
      LAB_0010c0bb:*(undefined4*)param_6 = 0;
      if (( (ulong)param_2 & 1 ) != 0) {
      ...
      Variant::operator_cast_to_long(this);
      /* WARNING: Could not recover jumptable at 0x0010c116. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *param_2 )((char)( param_1 + (long)param_3 ));
      return;
   }
   ...
   const */
   Object *MethodBindT<OpenXRHand::MotionRange>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
      long *plVar1;
      undefined4 in_register_00000014;
      __UnexistingClass *p_Var2;
      CallError *in_R8;
      ...
      call_with_variant_args_dv<__UnexistingClass,OpenXRHand::MotionRange>(p_Var2, (_func_void_MotionRange*)param_2[0xb], (Variant**)param_2[0xc], (int)param_4, in_R8, in_R9);
      *(undefined4*)param_1 = 0;
      *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
      LAB_0010c206:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return param_1;
      }
   ...
   Vector<Variant> const&) */
   void call_with_variant_args_dv<__UnexistingClass,OpenXRHand::Hands>(__UnexistingClass *param_1, _func_void_Hands *param_2, Variant **param_3, int param_4, CallError *param_5, Vector *param_6) {
      long lVar1;
      long lVar2;
      code *pcVar3;
      undefined8 uVar4;
      ...
      lVar1 = *(long*)( in_stack_00000008 + 8 );
      if (lVar1 == 0) {
         if (uVar8 != 1) goto LAB_0010c530;
      }
 else {
         lVar2 = *(long*)( lVar1 + -8 );
         if ((int)lVar2 < (int)( uVar8 ^ 1 )) {
            LAB_0010c530:uVar6 = 4;
            LAB_0010c4cd:*(undefined4*)param_6 = uVar6;
            *(undefined4*)( param_6 + 8 ) = 1;
            return;
         }
      ...
      this * (Variant**)CONCAT44(in_register_0000000c, param_4);
      LAB_0010c44b:*(undefined4*)param_6 = 0;
      if (( (ulong)param_2 & 1 ) != 0) {
      ...
      Variant::operator_cast_to_long(this);
      /* WARNING: Could not recover jumptable at 0x0010c4a6. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *param_2 )((char)( param_1 + (long)param_3 ));
      return;
   }
    ...
    */
   Object *MethodBindT<OpenXRHand::Hands>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
      long *plVar1;
      undefined4 in_register_00000014;
      __UnexistingClass *p_Var2;
      CallError *in_R8;
      ...
      call_with_variant_args_dv<__UnexistingClass,OpenXRHand::Hands>(p_Var2, (_func_void_Hands*)param_2[0xb], (Variant**)param_2[0xc], (int)param_4, in_R8, in_R9);
      *(undefined4*)param_1 = 0;
      *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
      LAB_0010c596:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return param_1;
      }

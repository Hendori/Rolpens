/* embree::BarrierSys::BarrierSys(unsigned long) */void embree::BarrierSys::BarrierSys(BarrierSys *this, ulong param_1) {
   MutexSys *this_00;
...
/* embree::BarrierSys::~BarrierSys() */void embree::BarrierSys::~BarrierSys(BarrierSys *this) {
   MutexSys *this_00;
...
/* embree::BarrierSys::init(unsigned long) */void embree::BarrierSys::init(BarrierSys *this, ulong param_1) {
   long lVar1;
   lVar1 = *(long*)this;
...
/* embree::BarrierSys::wait() */void embree::BarrierSys::wait(BarrierSys *this) {
   long lVar1;
   lVar1 = *(long*)this;
...
/* embree::LinearBarrierActive::LinearBarrierActive(unsigned long) */void embree::LinearBarrierActive::LinearBarrierActive(LinearBarrierActive *this, ulong param_1) {
   uint uVar1;
   void *pvVar2;
   undefined1 *puVar3;
   undefined1 *puVar4;
   ...
   *(undefined8*)( this + 0x20 ) = 0;
   if (param_1 == 0) {
      ...
      *(ulong*)( this + 0x20 ) = param_1;
      LAB_00100174:pvVar2 = operator_new__(param_1);
      *(void**)this = pvVar2;
...
/* embree::LinearBarrierActive::~LinearBarrierActive() */void embree::LinearBarrierActive::~LinearBarrierActive(LinearBarrierActive *this) {
   if (*(void**)this != (void*)0x0) {
      operator_delete__(*(void**)this);
   }
...
/* embree::LinearBarrierActive::init(unsigned long) */void embree::LinearBarrierActive::init(LinearBarrierActive *this, ulong param_1) {
   void *pvVar1;
   ulong uVar2;
   ulong uVar3;
   bool bVar4;
...
/* embree::LinearBarrierActive::wait(unsigned long) */void embree::LinearBarrierActive::wait(LinearBarrierActive *this, ulong param_1) {
   int iVar1;
   undefined1 *puVar2;
   long lVar3;
   ulong uVar4;
...
/* embree::barrier_sys_regression_test::~barrier_sys_regression_test() */void embree::barrier_sys_regression_test::~barrier_sys_regression_test(barrier_sys_regression_test *this) {
   void *pvVar1;
   MutexSys *this_00;
...
/* embree::barrier_sys_regression_test::thread_alloc(embree::barrier_sys_regression_test*) */void embree::barrier_sys_regression_test::thread_alloc(barrier_sys_regression_test *param_1) {
...
/* WARNING: Control flow encountered bad instruction data *//* WARNING: Instruction at (ram,0x00100902) overlaps instruction at (ram,0x00100901)
    *//* std::vector<unsigned long, std::allocator<unsigned long> >::_M_default_append(unsigned long) */void std::vector<unsigned_long,std::allocator<unsigned_long>>::_M_default_append(ulong param_1) {
   ulong uVar1;
   void *pvVar2;
   void *pvVar3;
   byte *pbVar4;
   ...
   if (bVar9) {
      ...
      if ((int)unaff_RBP == (int)&local_48) {
         ...
         uVar6 = uVar1 * 2;
         if (uVar6 < uVar1) {
            LAB_00100990:uVar6 = 0x7ffffffffffffff8;
         }
 else {
            if (uVar6 == 0) {
               lVar5 = 0;
      ...
      in_RCX = local_40;
      pbVar4 = local_48;
      LAB_00100919:*(undefined8*)( (long)pvVar2 + (long)pbVar4 ) = *in_RCX;
      if (0 < (long)pbVar4) {
         local_48 = pbVar4;
   ...
   if (uVar1 < in_RSI) {
      ...
      *puVar7 = 0;
      ...
      LAB_00100799:if (__src == (void*)0x0) goto LAB_001007a2;
   }
 else {
      uVar1 = uVar1 * 2;
      ...
      *puVar7 = 0;
      if (in_RSI != 1) {
         LAB_00100785:memset(puVar7 + 1, 0, (long)local_40 << 3);
         goto LAB_00100799;
      }
   ...
   LAB_001007a2:if (pvVar3 != (void*)0x0) {
...
/* WARNING: Control flow encountered bad instruction data *//* void std::vector<embree::opaque_thread_t*, std::allocator<embree::opaque_thread_t*>
   ...
   if (__src == pvVar2) {
      ...
      uVar4 = uVar1 * 2;
      if (uVar4 < uVar1) {
         LAB_00100990:uVar4 = 0x7ffffffffffffff8;
      }
 else {
         if (uVar4 == 0) {
            lVar3 = 0;
   ...
   LAB_00100919:*(undefined8*)( (long)__dest + __n ) = *param_3;
   if (0 < (long)__n) {
...
/* embree::barrier_sys_regression_test::run() */ulong embree::barrier_sys_regression_test::run(barrier_sys_regression_test *this) {
   barrier_sys_regression_test *pbVar1;
   long lVar2;
   void *pvVar3;
   undefined8 *puVar4;
   ...
   *(long*)pbVar1 = 0;
   ...
   if (uVar7 < uVar8) {
      std::vector<unsigned_long,std::allocator<unsigned_long>>::_M_default_append(( ulong )(this + 0x40));
      lVar9 = *(long*)( this + 0x28 );
      *(undefined8*)( lVar9 + 0x10 ) = 0;
      *(ulong*)( lVar9 + 0x18 ) = uVar8 + 1;
   }
 else {
      if (( uVar8 < uVar7 ) && ( lVar9 = *(long*)( this + 0x40 ) + uVar8 * 8 * (long*)( this + 0x48 ) != lVar9 )) {
   ...
   while (true) {
      ...
      if (puVar4 == puVar5) {
         std::vector<embree::opaque_thread_t*,std::allocator<embree::opaque_thread_t*>>::_M_realloc_insert<embree::opaque_thread_t*>((vector<embree::opaque_thread_t*,std::allocator<embree::opaque_thread_t*>>*)&local_58, puVar4, &local_60);
      }
 else {
         *puVar4 = local_60;
         local_50 = puVar4 + 1;
...
;
      ...
      do {
         LOCK();
         *(ulong*)pbVar1 = *(long*)pbVar1 + ( ulong )(*(ulong*)( *(long*)( this + 0x40 ) + uVar7 * 8 ) != uVar7);
         UNLOCK();
         uVar7 = uVar7 + 1;
      }
 while ( uVar8 != uVar7 );
 ...
 while ( uVar8 != uVar7 );
   LAB_00100c05:lVar9 = *(long*)( this + 0x38 );
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* embree::BarrierSys::BarrierSys(unsigned long) */void embree::BarrierSys::_GLOBAL__sub_I_BarrierSys(void) {
   ulong uVar1;
   undefined8 uVar2;
   ulong __n;
   ulong *__src;
   ...
   *(undefined1*)( (long)__src + local_60 ) = 0;
   ...
   if (local_60 < 0x10) {
      ...
      barrier_sys_regression_test._8_8_ = std::__cxx11::string::_M_create((ulong*)( barrier_sys_regression_test + 8 ), ( ulong ) & local_60);
      barrier_sys_regression_test._24_8_ = local_60;
   }

   memcpy((void*)barrier_sys_regression_test._8_8_, __src, __n);
   LAB_00100dd8:barrier_sys_regression_test._16_8_ = local_60;
   ...
   *(undefined8*)( this + 0x18 ) = 0;
   ...
   __cxa_atexit(barrier_sys_regression_test::~barrier_sys_regression_test, barrier_sys_regression_test, &__dso_handle);
   return;
}
/* WARNING: Control flow encountered bad instruction data *//* embree::barrier_sys_regression_test::~barrier_sys_regression_test() */void embree::barrier_sys_regression_test::~barrier_sys_regression_test(barrier_sys_regression_test *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

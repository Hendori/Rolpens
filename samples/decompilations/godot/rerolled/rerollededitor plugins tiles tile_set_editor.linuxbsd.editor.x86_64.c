/* TileSetEditor::_tile_set_changed() */void TileSetEditor::_tile_set_changed(TileSetEditor *this) {
   this[0x9d8] = (TileSetEditor)0x1;
   return;
}
/* TileSetEditor::_pattern_preview_done(Ref<TileMapPattern>, Ref<Texture2D>) */void TileSetEditor::_pattern_preview_done(long param_1, undefined8 *param_2) {
   char cVar1;
   int iVar2;
   uint uVar3;
   long in_FS_OFFSET;
   ...
   do {
      ...
      if (iVar2 <= (int)uVar3) {
         ...
         LAB_0010014f:/* WARNING: Subroutine does not return */__stack_chk_fail();
      }
      ...
      if (Variant::needs_deinit[local_78[0]] != '\0') {
         ...
         LAB_0010005c:if (cVar1 == '\0') goto LAB_00100064;
         LAB_001000f8:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      ...
      LAB_001000d8:Variant::_clear_internal();
      if (cVar1 != '\0') goto LAB_001000f8;
      LAB_00100064:uVar3 = uVar3 + 1;
   }
 while ( true );
}
/* TileSetEditor::_tab_changed(int) */void TileSetEditor::_tab_changed(int param_1) {
...
/* TileSetEditor::_sources_advanced_menu_id_pressed(int) */void TileSetEditor::_sources_advanced_menu_id_pressed(TileSetEditor *this, int param_1) {
   long lVar1;
   undefined8 uVar2;
   long lVar3;
   char cVar4;
   ...
   if (local_28 == (Object*)0x0) {
      if (lVar1 == *(long*)( in_FS_OFFSET + 0x28 )) {
         _err_print_error("_sources_advanced_menu_id_pressed", "editor/plugins/tiles/tile_set_editor.cpp", 0x14b, "Condition \"tile_set.is_null()\" is true.", 0, 0);
         return;
      }
      ...
      if (param_1 == 0) {
         ...
         if (( ( local_28 != (Object*)0x0 ) && ( cVar4 = RefCounted::unreference() ),cVar4 != '\0' )) &&( cVar4 = cVar4 != '\0' )(**(code**)( *(long*)local_28 + 0x140 ))(local_28);
      ...
      uVar2 = *(undefined8 *)(this + 0xa50);cVar4 = RefCounted::reference();
   if (cVar4 == '\0') {
      local_28 = (Object*)0x0;
   }
...
lVar3 = *(long*)( in_FS_OFFSET + 0x28 );}if (lVar1 == lVar3) {
   Window::popup_centered_ratio(_LC12);
   return;
}
}LAB_0010034b:/* WARNING: Subroutine does not return */__stack_chk_fail();}/* TileSetEditor::add_expanded_editor(Control*) */void TileSetEditor::add_expanded_editor(Control *param_1) {
   undefined8 *puVar1;
   long *plVar2;
   code *pcVar3;
   Vector2 *pVVar4;
   ...
   *(undefined8*)( param_1 + 0xa88 ) = *(undefined8*)( lVar5 + 0x60 );
   ...
   do {
      if (lVar5 == 0) {
         if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            _err_print_error("add_expanded_editor", "editor/plugins/tiles/tile_set_editor.cpp", 0x302, "Parameter \"parent_container\" is null.", 0, 0);
            return;
         }

         LAB_001005a8:/* WARNING: Subroutine does not return */__stack_chk_fail();
      }

      lVar6 = __dynamic_cast(lVar5, &Object::typeinfo, &EditorInspector::typeinfo, 0);
      if (( lVar6 != 0 ) || ( lVar5 = __dynamic_cast(lVar5, &Object::typeinfo, &ScrollContainer::typeinfo, 0) ),lVar5 != 0) {
         ...
         ( **(code**)( **(long**)( param_1 + 0xa80 ) + 0x198 ) )(*(long**)( param_1 + 0xa80 ), *(undefined8*)( param_1 + 0xa78 ), 1);
         CanvasItem::show();
...
/* TileSetEditor::remove_expanded_editor() */void TileSetEditor::remove_expanded_editor(TileSetEditor *this) {
   undefined8 *puVar1;
   ulong uVar2;
   long *plVar3;
   code *pcVar4;
...
;
   ...
   *(undefined8*)( this + 0xa88 ) = 0;
   ...
   LAB_00100723:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* TileSetEditor::register_split(SplitContainer*) */void TileSetEditor::register_split(TileSetEditor *this, SplitContainer *param_1) {
   uint uVar1;
   code *pcVar2;
   void *pvVar3;
   ulong uVar4;
...
/* TileSourceInspectorPlugin::_confirm_change_id() */void TileSourceInspectorPlugin::_confirm_change_id(TileSourceInspectorPlugin *this) {
   StringName *pSVar1;
   String *pSVar2;
   bool *pbVar3;
   long in_FS_OFFSET;
...
/* TileSourceInspectorPlugin::can_handle(Object*) */undefined4 TileSourceInspectorPlugin::can_handle(TileSourceInspectorPlugin *this, Object *param_1) {
   code *pcVar1;
   undefined4 uVar2;
   long in_FS_OFFSET;
   undefined8 local_58;
...
/* TileSourceInspectorPlugin::_show_id_edit_dialog(Object*) */void TileSourceInspectorPlugin::_show_id_edit_dialog(TileSourceInspectorPlugin *this, Object *param_1) {
   Vector2i *pVVar1;
   undefined8 uVar2;
   long *plVar3;
   code *pcVar4;
   ...
   if (*(long*)( this + 0x218 ) == 0) {
      ...
      *(undefined***)this_01 = &PTR__initialize_classv_00117708;
      ...
      local_88 = 0;
      String::parse_latin1((String*)&local_88, "Warning: Modifying a source ID will result in all TileMaps using that source to reference an invalid source instead. This may result in unexpected data loss. Change this ID carefully.");
...
/* TileSourceInspectorPlugin::parse_property(Object*, Variant::Type, String const&, PropertyHint,
   String const&, BitField<PropertyUsageFlags>, bool) */undefined4 TileSourceInspectorPlugin::parse_property(String *param_1, Object *param_2, undefined8 param_3, String *param_4) {
   code *pcVar1;
   undefined8 uVar2;
   undefined4 uVar3;
   EditorProperty *this;
...
/* TileSetEditor::_update_patterns_list() [clone .part.0] */void TileSetEditor::_update_patterns_list(TileSetEditor *this) {
   undefined8 uVar1;
   String *pSVar2;
   undefined8 uVar3;
   Object *pOVar4;
   ...
   while (true) {
      ...
      *(char**)( this_00 + 0x20 ) = "TileSetEditor::_pattern_preview_done";
      ...
      TilesEditorUtils::queue_pattern_preview(uVar3, (StrRange*)&local_78, (String*)&local_70, (String*)&local_68);
...
/* TileSetEditor::_update_patterns_list() */void TileSetEditor::_update_patterns_list(TileSetEditor *this) {
   ...
   _err_print_error("_update_patterns_list", "editor/plugins/tiles/tile_set_editor.cpp", 0x1b7, "Condition \"tile_set.is_null()\" is true.", 0, 0);
   return;
}
...
/* TileSetEditor::_source_selected(int) */void TileSetEditor::_source_selected(TileSetEditor *this, int param_1) {
   undefined8 uVar1;
   Object *pOVar2;
   char cVar3;
   int iVar4;
   ...
   if (*(long*)( this + 0x9d0 ) == 0) {
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         _err_print_error("_source_selected", "editor/plugins/tiles/tile_set_editor.cpp", 0xf3, "Condition \"tile_set.is_null()\" is true.", 0, 0);
         return;
      }
   ...
   TileSet::get_source(iVar7);
   if (local_60 != (Object*)0x0) {
      LAB_00101a47:lVar6 = __dynamic_cast(local_60, &Object::typeinfo, &TileSetScenesCollectionSource::typeinfo, 0);
      cVar3 = RefCounted::unreference();
      pOVar2 = local_60;
      if (( cVar3 != '\0' ) && ( cVar3 = cVar3 != '\0' )) {
         ( **(code**)( *(long*)pOVar2 + 0x140 ) )(pOVar2);
...
LAB_00101b61:CanvasItem::show();CanvasItem::hide();if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   LAB_00101b82:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
LAB_00101b2c:CanvasItem::hide();return;}/* TileSetEditor::_update_sources_list(int) [clone .part.0] */void TileSetEditor::_update_sources_list(TileSetEditor *this, int param_1) {
   undefined8 uVar1;
   void *pvVar2;
   long lVar3;
   Object *pOVar4;
   ...
   LAB_00101d98:if (( param_1 < 0 ) && ( param_1 = local_d0 < 0 )) {
   ...
   local_98 = (Object*)0x0;
   if (( *(Object**)( this + 0x9d0 ) != (Object*)0x0 ) && ( local_98 = *(Object**)( this + 0x9d0 ) ),cVar5 = RefCounted::reference(),cVar5 == '\0') {
      local_98 = (Object*)0x0;
   }
...
joined_r0x00101e81:
        ...
        if ((_update_sources_list(int)::{lambda()#1}::operator()()::sname == '\0') &&
           (iVar6 = __cxa_guard_acquire(&_update_sources_list(int)::{lambda()#1}::operator()()::
                                         sname), iVar6 != 0))
      {
         _scs_create((char *)&_update_sources_list(int)::{lambda()
         #1
         __cxa_atexit(StringName::~StringName,
                       &_update_sources_list(int)::{lambda()
         #1
         __cxa_guard_release(&_update_sources_list(int)::{lambda()
         #1
      }
      ...
      pOVar11 = local_c0;
      if (local_98 == local_c0) {
         LAB_00101fa1:if (( ( pOVar11 != (Object*)0x0 ) && ( cVar5 = RefCounted::unreference() ),pOVar11 = local_98,cVar5 != '\0' )) &&( cVar5 = cVar5 != '\0' )(**(code**)( *(long*)pOVar11 + 0x140 ))(pOVar11);
      ...
      if (pOVar10 != (Object*)0x0) {
         cVar5 = RefCounted::unreference();
         pOVar11 = local_98;
         joined_r0x00101f96:local_98 = pOVar11;
         if (( cVar5 != '\0' ) && ( cVar5 = predelete_handler(pOVar10) ),pOVar11 = local_98,cVar5 != '\0') {
            ( **(code**)( *(long*)pOVar10 + 0x140 ) )(pOVar10);
            Memory::free_static(pOVar10, false);
            pOVar11 = local_98;
         }
...
ItemList::add_item(*(String**)( this + 0xa30 ), (CowData<char32_t>*)&local_b8, SUB81(&local_c0, 0));uVar1 = *(undefined8*)( this + 0xa30 );Variant::Variant((Variant*)local_78, *piVar13);ItemList::set_item_metadata((int)uVar1, (Variant*)0xffffffff);if (Variant::needs_deinit[local_78[0]] != '\0') {
   Variant::_clear_internal();
}
CowData<char32_t>::_unref((CowData<char32_t>*)&local_b8);if (( ( local_c0 == (Object*)0x0 ) || ( cVar5 = RefCounted::unreference() ),pOVar11 = local_c0,cVar5 == '\0' )) {
   piVar13 = *(int**)( piVar13 + 2 );
   if (piVar13 == (int*)0x0) break;
   goto LAB_00102200;
}
( **(code**)( *(long*)pOVar11 + 0x140 ) )(pOVar11);Memory::free_static(pOVar11, false);piVar13 = *(int**)( piVar13 + 2 );}while (piVar13 != (int*)0x0) ;;;}iVar6 = 0;if (-1 < param_1) {
...
iVar6 = ItemList::get_current();if (( iVar6 < 0 ) && ( iVar6= ItemList::get_item_count(),0 < iVar6 )) {
   ItemList::set_current((int)*(undefined8*)( this + 0xa30 ));
   ItemList::get_item_metadata((int)(Variant*)local_78);
...
iVar6 = ItemList::get_current();_source_selected(this, iVar6);uVar1 = TilesEditorUtils::singleton;ItemList::get_current();TilesEditorUtils::set_sources_lists_current((int)uVar1);if (local_c8 != (long*)0x0) {
   do {
      plVar8 = local_c8;
...
LAB_00102526:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* TileSetEditor::_update_sources_list(int) */void TileSetEditor::_update_sources_list(TileSetEditor *this, int param_1) {
   if (*(long*)( this + 0x9d0 ) != 0) {
...
/* TileSetEditor::_source_delete_pressed() */void TileSetEditor::_source_delete_pressed(TileSetEditor *this) {
   Variant *pVVar1;
   StringName *pSVar2;
   char cVar3;
   int iVar4;
   ...
   if (*(long*)( this + 0x9d0 ) == 0) {
      _err_print_error("_source_delete_pressed", "editor/plugins/tiles/tile_set_editor.cpp", 0x113, "Condition \"tile_set.is_null()\" is true.", 0, 0);
   }
 else {
      ItemList::get_current();
      ...
      EditorUndoRedoManager::add_do_method<int>(this_00, *(Object**)( this + 0x9d0 ), (StringName*)&local_b0, iVar4);
...
/* TileSetEditor::_source_add_id_pressed(int) */void TileSetEditor::_source_add_id_pressed(TileSetEditor *this, int param_1) {
   Variant *pVVar1;
   StringName *pSVar2;
   long *plVar3;
   code *pcVar4;
   ...
   if (*(long*)( this + 0x9d0 ) == 0) {
      if (local_40[0] == *(long*)( in_FS_OFFSET + 0x28 )) {
         ...
         LAB_001031b1:_err_print_error("_source_add_id_pressed", "editor/plugins/tiles/tile_set_editor.cpp", uVar10, pcVar9, 0, 0);
         return;
      }
 ...
 while ( pVVar11 != local_88 );
      ...
      if (( ( local_d8 != (Object*)0x0 ) && ( cVar7 = RefCounted::unreference() ),cVar7 != '\0' )) &&( cVar7 = cVar7 != '\0' )(**(code**)( *(long*)local_d8 + 0x140 ))(local_d8);
      Memory::free_static(local_d8, false);
   }

   StringName::StringName((StringName*)local_b8, "remove_source", false);
   EditorUndoRedoManager::add_undo_method<int>((EditorUndoRedoManager*)this_01, *(Object**)( this + 0x9d0 ), (StringName*)local_b8, iVar8);
   if (( StringName::configured != '\0' ) && ( local_b8[0] != 0 )) {
      StringName::unref();
   }
...
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* TileSetEditor::_set_source_sort(int) */void TileSetEditor::_set_source_sort(TileSetEditor *this, int param_1) {
   char cVar1;
   int iVar2;
   int iVar3;
   String *pSVar4;
 ...
 while ( iVar5 != 4 );
   ...
   LAB_00103510:if (*(long*)( this + 0x9d0 ) != 0) {
...
/* TileSetEditor::_notification(int) */void TileSetEditor::_notification(TileSetEditor *this, int param_1) {
   Ref *pRVar1;
   StringName *pSVar2;
   undefined8 uVar3;
   char cVar4;
    ...
    if (*(long *)(this + 0x9d0) != 0) {
      ...
      goto LAB_00103c8c;
                              ...
                              if (*(long*)( this + 0x9d0 ) == 0) {
                                 ...
                                 if (*(long*)( this + 0x9d0 ) != 0) {
                                    local_38 = (Object*)0x0;
                                    pOVar7 = (Object*)__dynamic_cast(*(long*)( this + 0x9d0 ), &Object::typeinfo, &Resource::typeinfo, 0);
...
, if (local_30 == *(long *)(in_FS_OFFSET + 0x28));
                     ...
                     LAB_00103c8c:/* WARNING: Subroutine does not return */__stack_chk_fail();
                  }

                  /* TileSetEditor::edit(Ref<TileSet>) */
                  void TileSetEditor::edit(TileSetEditor *this, long *param_2) {
                     undefined8 uVar1;
                     char cVar2;
                     TileSetEditor TVar3;
                     int iVar4;
                     ...
                     if (*param_2 == 0) {
                        ...
                        LAB_00103e9f:create_custom_callable_function_pointer<TileSetEditor>((TileSetEditor*)local_88, (char*)this, (_func_void*)"&TileSetEditor::_tile_set_changed");
                        ...
                        if (pOVar7 != pOVar5) {
                           *(Object**)( this + 0x9d0 ) = pOVar5;
                           ...
                           LAB_00103d82:if (( ( pOVar7 != (Object*)0x0 ) && ( cVar2 = RefCounted::unreference() ),cVar2 != '\0' )) &&( cVar2 = cVar2 != '\0' )(**(code**)( *(long*)pOVar7 + 0x140 ))(pOVar7);
                           Memory::free_static(pOVar7, false);
                        }
                     ...
                     if (pOVar5 != (Object*)0x0) {
                        ...
                        BaseButton::set_disabled(SUB81(*(undefined8*)( this + 0xa20 ), 0));
                        pCVar8 = *(Callable**)( this + 0x9d0 );
                        create_custom_callable_function_pointer<TileSetEditor>((TileSetEditor*)local_88, (char*)this, (_func_void*)"&TileSetEditor::_tile_set_changed");
                        ...
                        if (this[0xa58] == (TileSetEditor)0x0) {
                           ...
                           LAB_00103e49:if (*(long*)( this + 0x9d0 ) != 0) {
                              ItemList::clear();
                              if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
                                 _update_patterns_list(this);
                                 return;
                  ...
                  else{local_88[0] = (Object*)0x0;
                  pOVar5 = (Object*)__dynamic_cast(*param_2, &Object::typeinfo, &Resource::typeinfo, 0);
                  uVar1 = EditorNode::singleton;
                  if (( pOVar5 != (Object*)0x0 ) && ( local_88[0] = pOVar5 ),cVar2 = RefCounted::reference(),cVar2 == '\0') {
                     local_88[0] = (Object*)0x0;
                  }

                  TVar3 = (TileSetEditor)EditorNode::is_resource_read_only(uVar1, local_88, 0);
                  if (( ( local_88[0] != (Object*)0x0 ) && ( cVar2 = RefCounted::unreference() ),pOVar5 = local_88[0],cVar2 != '\0' )) &&( cVar2 = cVar2 != '\0' )(**(code**)( *(long*)pOVar5 + 0x140 ))(pOVar5);
               ...
               pCVar8 = *(Callable**)( this + 0x9d0 );
               if (pCVar8 != pCVar9) {
                  LAB_00103d55:if (pCVar8 != (Callable*)0x0) goto LAB_00103e9f;
                  ...
                  *(Callable**)( this + 0x9d0 ) = pCVar9;
                  pOVar7 = (Object*)0x0;
                  LAB_00103d6e:cVar2 = RefCounted::reference();
                  if (cVar2 == '\0') {
               ...
               LAB_00103f05:if (this[0x9c8] != TVar3) goto LAB_00103d55;
            }

            LAB_00103f18:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
               return;
            }

            LAB_001040dd:/* WARNING: Subroutine does not return */__stack_chk_fail();
         }

         /* TileSetEditor::_patterns_item_list_gui_input(Ref<InputEvent> const&) */
         void TileSetEditor::_patterns_item_list_gui_input(TileSetEditor *this, Ref *param_1) {
            Variant *pVVar1;
            int iVar2;
            StringName *pSVar3;
            undefined8 uVar4;
            ...
            if (*(long*)( this + 0x9d0 ) == 0) {
               if (local_40[0] == *(long*)( in_FS_OFFSET + 0x28 )) {
                  _err_print_error("_patterns_item_list_gui_input", "editor/plugins/tiles/tile_set_editor.cpp", 0x198, "Condition \"tile_set.is_null()\" is true.", 0, 0);
                  return;
               }
               ...
               local_b8 = (Object*)0x0;
               pOVar7 = (Object*)__dynamic_cast(*(long*)( this + 0x9d0 ), &Object::typeinfo, &Resource::typeinfo, 0);
               if (( pOVar7 != (Object*)0x0 ) && ( local_b8 = pOVar7 ),cVar5 = RefCounted::reference(),cVar5 == '\0') {
                  local_b8 = (Object*)0x0;
               }

               cVar5 = EditorNode::is_resource_read_only(uVar4, (String*)&local_b8, 0);
               if (( ( local_b8 != (Object*)0x0 ) && ( cVar6 = RefCounted::unreference() ),pOVar7 = local_b8,cVar6 != '\0' )) &&( cVar6 = cVar6 != '\0' )(**(code**)( *(long*)pOVar7 + 0x140 ))(pOVar7);
               Memory::free_static(pOVar7, false);
            }
               ...
               if (( ( cVar5 == '\0' ) || ( cVar5 = InputEvent::is_pressed() ),cVar5 == '\0' )) {
                  ...
                  if (local_b0 != 0) {
                     ...
                     do {
                        ...
                        EditorUndoRedoManager::add_do_method<int>(this_00, *(Object**)( this + 0x9d0 ), (StringName*)&local_c0, iVar2);
                        if (( StringName::configured != '\0' ) && ( local_c0 != 0 )) {
                           StringName::unref();
                        }
                        ...
                        local_a8 = local_88;
                        pVStack_a0 = local_70;
                        EditorUndoRedoManager::add_undo_methodp((Object*)this_00, pSVar3, (Variant**)&local_c0, (int)&local_a8);
                        do {
                           pVVar1 = pVVar9 + -0x18;
                           pVVar9 = pVVar9 + -0x18;
                           if (Variant::needs_deinit[*(int*)pVVar1] != '\0') {
 ...
 while ( pVVar9 != local_88 );
                        ...
                        if (( ( local_c8 != (Object*)0x0 ) && ( cVar5 = RefCounted::unreference() ),pOVar7 = local_c8,cVar5 != '\0' )) &&( cVar5 = cVar5 != '\0' )(**(code**)( *(long*)pOVar7 + 0x140 ))(pOVar7);
                        Memory::free_static(pOVar7, false);
                     }
 while ( local_b0 != 0 );
                  }
      ...
      void TileSetEditor::TileSetEditor(TileSetEditor *this) {
         Variant *pVVar1;
         long lVar2;
         String *pSVar3;
         code *pcVar4;
         ...
         *(TabBar**)( this + 0x9f0 ) = this_01;
         ...
         create_custom_callable_function_pointer<TileSetEditor,int>((TileSetEditor*)&local_128, (char*)this, (_func_void_int*)"&TileSetEditor::_tab_changed");
         ...
         *(MenuButton**)( this + 0xa20 ) = pMVar11;
         ...
         pcVar4 = *(code**)( *plVar12 + 0x108 );
         create_custom_callable_function_pointer<TileSetEditor,int>((TileSetEditor*)&local_128, (char*)this, (_func_void_int*)"&TileSetEditor::_set_source_sort");
         ...
         *(ItemList**)( this + 0xa30 ) = pIVar13;
         ...
         pcVar4 = *(code**)( *plVar12 + 0x108 );
         create_custom_callable_function_pointer<TileSetEditor,int>((TileSetEditor*)&local_128, (char*)this, (_func_void_int*)"&TileSetEditor::_source_selected");
 ...
 while ( pVVar17 != (Variant*)local_88 );
         ...
         plVar12 = *(long**)( this + 0xa30 );
         pcVar4 = *(code**)( *plVar12 + 0x108 );
         create_custom_callable_function_pointer<TileSetEditor,int>((TileSetEditor*)&local_128, (char*)this, (_func_void_int*)"&TileSetEditor::_update_sources_list");
         ...
         *(Button**)( this + 0xa10 ) = this_04;
         ...
         pcVar4 = *(code**)( *plVar12 + 0x108 );
         create_custom_callable_function_pointer<TileSetEditor>((TileSetEditor*)&local_128, (char*)this, (_func_void*)"&TileSetEditor::_source_delete_pressed");
         ...
         *(MenuButton**)( this + 0xa18 ) = pMVar11;
         ...
         String::parse_latin1((String*)&local_128, "");
         local_138[0] = 0;
         String::parse_latin1((String*)local_138, "A collection of scenes that can be instantiated and placed as tiles.");
         TTR((String*)local_148, (String*)local_138);
         PopupMenu::set_item_tooltip(iVar9, (String*)0xffffffff);
         CowData<char32_t>::_unref((CowData<char32_t>*)local_148);
         CowData<char32_t>::_unref((CowData<char32_t>*)local_138);
         ...
         plVar12 = (long*)MenuButton::get_popup();
         pcVar4 = *(code**)( *plVar12 + 0x108 );
         create_custom_callable_function_pointer<TileSetEditor,int>((TileSetEditor*)&local_128, (char*)this, (_func_void_int*)"&TileSetEditor::_source_add_id_pressed");
         ...
         *(MenuButton**)( this + 0xa28 ) = pMVar11;
         ...
         plVar12 = (long*)MenuButton::get_popup();
         pcVar4 = *(code**)( *plVar12 + 0x108 );
         create_custom_callable_function_pointer<TileSetEditor,int>((TileSetEditor*)&local_128, (char*)this, (_func_void_int*)"&TileSetEditor::_sources_advanced_menu_id_pressed");
         ( *pcVar4 )(plVar12, SceneStringNames::singleton + 0x240, (Ref<Texture2D>*)&local_128, 0);
         Callable::~Callable((Callable*)&local_128);
         ...
         *(char**)( pCVar14 + 0x20 ) = "TileSetEditor::_move_tile_set_array_element";
         Callable::Callable((Callable*)&local_128, pCVar14);
         if (TileSetEditor()::{lambda()
         #1
         iVar9 = __cxa_guard_acquire(&TileSetEditor()::, {
               lambda()
               #1
               if (iVar9 != 0) {
                  _scs_create((char *)&TileSetEditor()::{lambda()
                  #1
                  __cxa_atexit(StringName::~StringName, &TileSetEditor()::, {
                        lambda()
                        #1
                        &__dso_handle;
...
TileSetEditor::_can_drop_data_fw
          (TileSetEditor *this,Vector2 *param_1,Variant *param_2,Control *param_3), {
                              ...
                              local_40 = *(long*)( in_FS_OFFSET + 0x28 );
                              if (*(long*)( this + 0x9d0 ) == 0) {
                                 _err_print_error("_can_drop_data_fw", "editor/plugins/tiles/tile_set_editor.cpp", 0x42, "Condition \"tile_set.is_null()\" is true. Returning: false", 0, 0);
                              }
...
;
                              ...
                              LAB_001063a2:uVar2 = 0;
                              LAB_001063a5:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
                                 /* WARNING: Subroutine does not return */
                                 __stack_chk_fail();
                              }
...
, /* TileSetEditor::_undo_redo_inspector_callback(Object*, Object*, String const&, Variant const&) */, void TileSetEditor::_undo_redo_inspector_callback
               (Object *param_1, Object * param_2, String * param_3, Variant * param_4);
                        {
                           ...
                           long local_40;
                           local_40 = *(long*)( in_FS_OFFSET + 0x28 );
                           if (( param_2 == (Object*)0x0 ) || ( pOVar7 = (Object*)__dynamic_cast(param_2, &Object::typeinfo, &EditorUndoRedoManager::typeinfo, 0) ),pOVar7 == (Object*)0x0) {
                              if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
                                 _err_print_error("_undo_redo_inspector_callback", "editor/plugins/tiles/tile_set_editor.cpp", 0x2a3, "Parameter \"undo_redo_man\" is null.", 0, 0);
                                 return;
                              }

                           }
 else {
                              if (( param_3 != (String*)0x0 ) && ( lVar8 = __dynamic_cast(param_3, &Object::typeinfo, &TileSet::typeinfo, 0) ),lVar8 != 0) {
                                 ...
                                 for (iVar14 = 0; iVar4 = TileSet::get_source_count(),iVar14 < iVar4; iVar14 = iVar14 + 1) {
                                    ...
                                    if (local_78 != (Object*)0x0) {
                                       ...
                                       if (plVar9 == (long*)0x0) {
                                          cVar3 = RefCounted::unreference();
                                          joined_r0x00106ec7:if (cVar3 != '\0') {
                                             plVar9 = (long*)0x0;
                                             LAB_00106ed0:pOVar2 = local_78;
                                          ...
                                          Ref<TileSetAtlasSource>::unref((Ref<TileSetAtlasSource>*)&local_70);
                                          if (( local_78 != (Object*)0x0 ) && ( cVar3 = cVar3 != '\0' )) goto LAB_00106ed0;
                                          LAB_00106857:for (iVar4 = 0; iVar5 = ( **(code**)( *plVar9 + 0x268 ) )(plVar9),iVar4 < iVar5; iVar4 = iVar4 + 1) {
                                             uVar10 = ( **(code**)( *plVar9 + 0x270 ) )(plVar9, iVar4);
                                             for (local_104 = 0; iVar5 = ( **(code**)( *plVar9 + 0x280 ) )(plVar9, uVar10),local_104 < iVar5; local_104 = local_104 + 1) {
                                                ...
                                                if (pSVar11 == (StringName*)0x0) {
                                                   _err_print_error("_undo_redo_inspector_callback", "editor/plugins/tiles/tile_set_editor.cpp", 0x2b3, "Parameter \"tile_data\" is null.", 0, 0);
                                                   ...
                                                   if (cVar3 != '\0') {
                                                      if (local_60 == (char*)0x0) {
                                                         ...
                                                         if (0 < lVar13) {
                                                            ...
                                                            if (cVar3 == '\0') {
                                                               LAB_00106eb0:CowData<char32_t>::_unref((CowData<char32_t>*)&local_70);
                                                               goto LAB_00106935;
                                                            }

                                                            if (local_60 == (char*)0x0) {
                                                               LAB_00107006:lVar13 = 0;
                                                            }
 else {
                                                               lVar13 = *(long*)( local_60 + -8 );
                                                               if (1 < lVar13) {
                                                                  ...
                                                                  if (cVar3 != '\0') {
                                                                     ...
                                                                     EditorUndoRedoManager::add_undo_property(pOVar7, pSVar11, (Variant*)&local_70);
                                                                     ...
                                                                     uVar12 = 0;
                                                                     do {
                                                                        while (cVar3 = TileData::is_valid_terrain_peering_bit(pSVar11, uVar12 & 0xffffffff),cVar3 == '\0') {
                                                                           uVar12 = uVar12 + 1;
                                                                           if (uVar12 == 0x10) goto LAB_001068b8;
                                                                        }
;
                                                                        local_88 = 0;
                                                                        String::parse_latin1((String*)&local_88, (char*)( &TileSet::CELL_NEIGHBOR_ENUM_TO_TEXT )[uVar12]);
                                                                        operator+((char *)
                                                                        local_80,(String*)"terrains_peering_bit/";
                                                                        StringName::StringName((StringName*)&local_78, local_80, false);
                                                                        Object::get((StringName*)local_58, (bool*)pSVar11);
                                                                        local_98 = 0;
                                                                        String::parse_latin1((String*)&local_98, (char*)( &TileSet::CELL_NEIGHBOR_ENUM_TO_TEXT )[uVar12]);
                                                                        operator+((char *)
                                                                        local_90,(String*)"terrains_peering_bit/";
 ...
 while ( uVar12 != 0x10 );
                                                            ...
                                                            LAB_00107009:lVar8 = 1;
                                                            goto LAB_00106f50;
                                                         }

                                                      }

                                                      LAB_00106f33:lVar8 = 0;
                                                      LAB_00106f50:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar8, lVar13, "p_index", "size()", "", false, true);
                                                      _err_flush_stdout();
                                                      /* WARNING: Does not return */
                                                   ...
                                                   LAB_00106935:if (( ( local_60 != (char*)0x0 ) && ( *(long*)( local_60 + -8 ) == 2 ) ) && ( cVar3 = cVar3 != '\0' )) {
                                    ...
                                    LAB_001067b2:Ref<TileSetAtlasSource>::unref((Ref<TileSetAtlasSource>*)&local_a0);
                                 }

                                 CowData<String>::_unref((CowData<String>*)&local_60);
                              }

                              LAB_00106804:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
                                 return;
                              }
                        ...
                        void TileSetEditor::_move_tile_set_array_element(TileSetEditor *this, Object *param_1, Object *param_2, String *param_3, int param_4, int param_5) {
                           long lVar1;
                           Variant *pVVar2;
                           code *pcVar3;
                           Object *pOVar4;
                           ...
                           long local_40;
                           local_40 = *(long*)( in_FS_OFFSET + 0x28 );
                           if (( param_1 == (Object*)0x0 ) || ( this_00 = (EditorUndoRedoManager*)__dynamic_cast(param_1, &Object::typeinfo, &EditorUndoRedoManager::typeinfo, 0) ),this_00 == (EditorUndoRedoManager*)0x0) {
                              if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
                                 _err_print_error("_move_tile_set_array_element", "editor/plugins/tiles/tile_set_editor.cpp", 0x1d1, "Parameter \"undo_redo_man\" is null.", 0, 0);
                                 return;
                              }
                           ...
                           if (( param_2 != (Object*)0x0 ) && ( pLVar11 = (List*)__dynamic_cast(param_2, &Object::typeinfo, &TileSet::typeinfo, 0) ),pLVar11 != (List*)0x0) {
                              local_f8 = (Object*)0x0;
                              if (*(long*)param_3 != 0) {
                              ...
                              if (cVar5 == '\0') {
                                 ...
                                 if (( ( local_100 == (char*)0x0 ) || ( *(long*)( local_100 + -8 ) < 2 ) ) || ( cVar5 = String::begins_with(local_100) ),cVar5 == '\0') {
                                    LAB_0010734d:cVar5 = String::operator ==(param_3, "navigation_layer_");
                                    if (cVar5 == '\0') {
                                       cVar5 = String::operator ==(param_3, "custom_data_layer_");
                                       if (cVar5 == '\0') {
                                          _err_print_error("_move_tile_set_array_element", "editor/plugins/tiles/tile_set_editor.cpp", 0x1eb, "Method/function failed.", "Invalid array prefix for TileSet.", 0, 0);
                                          LAB_001073d4:CowData<String>::_unref((CowData<String>*)&local_100);
                                          goto LAB_001073e1;
                                       }
                                 ...
                                 if (cVar5 == '\0') {
                                    LAB_00108a1c:CowData<char32_t>::_unref((CowData<char32_t>*)&local_f8);
                                    goto LAB_0010734d;
                                 }

                                 if (local_100 == (char*)0x0) {
                                    LAB_00108d74:uVar17 = 0;
                                 }
 else {
                                    uVar17 = *(ulong*)( local_100 + -8 );
                                    if (1 < (long)uVar17) {
                                 ...
                                 LAB_00108d77:uVar15 = 1;
                                 goto LAB_001081fb;
                              }

                              local_1a4 = TileSet::get_occlusion_layers_count();
                              LAB_00107171:local_16c = param_5;
                              iVar16 = param_5;
                              if (param_4 < 0) {
                                 if (param_5 < 0) {
                                    cVar5 = String::operator ==(param_3, "occlusion_layer_");
                                    if (cVar5 == '\0') {
                                       ...
                                       local_16c = 0;
                                       local_1a4 = 0;
                                       LAB_00108aa5:pcVar21 = "remove_physics_layer";
                                       goto LAB_00107443;
                                    }
                              ...
                              if (( cVar5 == '\0' ) && ( cVar5 = String::operator ==(param_3, "physics_layer_") ),cVar5 == '\0') {
                                 LAB_00107e85:cVar5 = String::operator ==(param_3, "terrain_set_");
                                 if (cVar5 != '\0') {
                                    if (param_4 < 0) {
                                       if (param_5 < 0) {
                                 ...
                                 if (( ( local_100 == (char*)0x0 ) || ( *(long*)( local_100 + -8 ) < 2 ) ) || ( cVar5 = String::begins_with(local_100) ),cVar5 == '\0') {
                                    LAB_00107eb9:cVar5 = String::operator ==(param_3, "navigation_layer_");
                                    if (cVar5 == '\0') {
                                       cVar5 = String::operator ==(param_3, "custom_data_layer_");
                                       ...
                                       LAB_00107443:StringName::StringName((StringName*)&local_f8, pcVar21, false);
                                       EditorUndoRedoManager::add_undo_method<int>(this_00, (Object*)pLVar11, (StringName*)&local_f8, iVar16);
                                       LAB_0010745f:if (( StringName::configured != '\0' ) && ( local_f8 != (Object*)0x0 )) {
                                          StringName::unref();
                                       }
                                 ...
                                 if (local_100 != (char*)0x0) {
                                    ...
                                    if (0 < (long)uVar17) {
                                       ...
                                       cVar5 = String::is_valid_int();
                                       if (cVar5 == '\0') {
                                          LAB_00108b66:CowData<char32_t>::_unref((CowData<char32_t>*)&local_f8);
                                          goto LAB_00107eb9;
                                       }
                                       ...
                                       pVStack_c0 = local_90;
                                       EditorUndoRedoManager::add_undo_methodp((Object*)this_00, (StringName*)pLVar11, (Variant**)&local_f8, (int)&local_c8);
                                       do {
                                          pVVar2 = pVVar22 + -0x18;
 ...
 while ( pVVar22 != (Variant*)local_a8 );
                                 ...
                                 LAB_00108ab3:uVar17 = 0;
                                 LAB_00108ab6:uVar15 = 0;
                                 LAB_001081fb:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar15, uVar17, "p_index", "size()", "", false, true);
                                 _err_flush_stdout();
                                 /* WARNING: Does not return */
                              ...
                              LAB_001071c6:local_140 = (undefined8*)0x0;
                              Object::get_property_list(pLVar11, SUB81((List<PropertyInfo,DefaultAllocator>*)&local_140, 0));
                              if (( local_140 != (undefined8*)0x0 ) && ( puVar23 = (undefined4*)*local_140 ),puVar23 != (undefined4*)0x0) {
                                 do {
                                    local_f0 = 0;
...
;
                                             if ((int)uVar20 != 0) {
                                                ...
                                                if (( local_16c <= iVar16 ) && ( iVar16 < local_1a4 )) {
                                                   ...
                                                   EditorUndoRedoManager::add_undo_property((Object*)this_00, (StringName*)pLVar11, (Variant*)&local_110);
 ...
 while ( puVar23 != (undefined4*)0x0 );
                              ...
                              for (iVar16 = 0; iVar6 = TileSet::get_source_count(),iVar16 < iVar6; iVar16 = iVar16 + 1) {
                                 ...
                                 if (local_f8 != (Object*)0x0) {
                                    ...
                                    if (plVar12 == (long*)0x0) {
                                       LAB_00107525:cVar5 = RefCounted::unreference();
                                       pOVar4 = local_f8;
                                       plVar12 = local_138;
                                       if (( cVar5 != '\0' ) && ( cVar5 = predelete_handler(local_f8) ),plVar12 = local_138,cVar5 != '\0') {
                                          ( **(code**)( *(long*)pOVar4 + 0x140 ) )(pOVar4);
                                          Memory::free_static(pOVar4, false);
                                       }
                                    ...
                                    iVar6 = 0;
                                    if (plVar12 != (long*)0x0) {
                                       LAB_0010759e:iVar7 = ( **(code**)( *plVar12 + 0x268 ) )(plVar12);
                                       if (iVar6 < iVar7) {
                                          uVar13 = ( **(code**)( *plVar12 + 0x270 ) )(plVar12, iVar6);
                                          local_170 = 0;
                                          LAB_001075f0:iVar7 = ( **(code**)( *plVar12 + 0x280 ) )(plVar12, uVar13);
                                          ...
                                          if (pSVar14 == (StringName*)0x0) {
                                             _err_print_error("_move_tile_set_array_element", "editor/plugins/tiles/tile_set_editor.cpp", 0x23c, "Parameter \"tile_data\" is null.", 0, 0);
                                          ...
                                          if (cVar5 == '\0') {
                                             ...
                                             if (cVar5 != '\0') {
                                                ...
                                                do {
                                                   ...
                                                   EditorUndoRedoManager::add_undo_property((Object*)this_00, pSVar14, (Variant*)&local_f8);
                                                   ...
                                                   CowData<char32_t>::_unref((CowData<char32_t>*)&local_120);
                                                   for (iVar24 = 0; iVar9 = TileData::get_collision_polygons_count((int)pSVar14),iVar24 < iVar9; iVar24 = iVar24 + 1) {
                                                      local_120 = 0;
 ...
 while ( iVar7 != local_1a4 );
                                             ...
                                             cVar5 = String::operator ==(param_3, "terrain_set_");
                                             if (cVar5 == '\0') {
                                                if (( ( local_100 != (char*)0x0 ) && ( 1 < *(long*)( local_100 + -8 ) ) ) && ( cVar5 = String::begins_with(local_100) ),cVar5 != '\0') {
                                                   if (local_100 == (char*)0x0) goto LAB_00108ab3;
                                                   uVar17 = *(ulong*)( local_100 + -8 );
                                                   if ((long)uVar17 < 1) goto LAB_00108ab6;
                                                   String::trim_prefix((char*)&local_f8);
                                                   ...
                                                   if (cVar5 != '\0') {
                                                      ...
                                                      if (cVar5 != '\0') {
                                                         ...
                                                         CowData<char32_t>::_unref((CowData<char32_t>*)&local_f8);
                                                         do {
                                                            while (cVar5 = TileData::is_valid_terrain_peering_bit(pSVar14, uVar17 & 0xffffffff),cVar5 != '\0') {
                                                               local_120 = 0;
                                                               String::parse_latin1((String*)&local_120, (char*)( &TileSet::CELL_NEIGHBOR_ENUM_TO_TEXT )[uVar17]);
                                                               operator+((char *)&
                                                               local_118,(String*)"terrains_peering_bit/";
                                                               StringName::StringName((StringName*)&local_110, (String*)&local_118, false);
                                                               Object::get((StringName*)local_a8, (bool*)pSVar14);
                                                               local_130 = 0;
                                                               String::parse_latin1((String*)&local_130, (char*)( &TileSet::CELL_NEIGHBOR_ENUM_TO_TEXT )[uVar17]);
                                                               operator+((char *)
                                                               local_128,(String*)"terrains_peering_bit/";
                                                               StringName::StringName((StringName*)&local_f8, local_128, false);
                                                               EditorUndoRedoManager::add_undo_property((Object*)this_00, pSVar14, (Variant*)&local_f8);
                                                               if (( StringName::configured != '\0' ) && ( local_f8 != (Object*)0x0 )) {
                                                                  StringName::unref();
...
;
 ...
 while ( uVar17 != 0x10 );
                                                         LAB_00108441:local_170 = local_170 + 1;
                                                         goto LAB_001075f0;
                                                      }
 ...
 while ( iVar7 != local_1a4 );
                                                   LAB_0010807d:local_170 = local_170 + 1;
                                                   goto LAB_001075f0;
                                                }
...
;
 ...
 while ( iVar7 != local_1a4 );
                                          ...
                                          LAB_001076dc:local_170 = local_170 + 1;
                                          goto LAB_001075f0;
                                       }
                              ...
                              if (cVar5 == '\0') {
                                 ...
                                 if (( ( local_100 != (char*)0x0 ) && ( 1 < *(long*)( local_100 + -8 ) ) ) && ( cVar5 = String::begins_with(local_100) ),cVar5 != '\0') {
                                    ...
                                    EditorUndoRedoManager::add_do_methodp((Object*)this_00, (StringName*)pLVar11, (Variant**)&local_f8, (int)&local_c8);
                                    do {
                                       pVVar2 = pVVar22 + -0x18;
                                       pVVar22 = pVVar22 + -0x18;
                                       if (Variant::needs_deinit[*(int*)pVVar2] != '\0') {
 ...
 while ( pVVar22 != (Variant*)local_a8 );
                                 ...
                                 LAB_00108f6b:cVar5 = String::operator ==(param_3, "navigation_layer_");
                                 if (cVar5 != '\0') {
                                    if (param_4 < 0) {
                                       ...
                                       LAB_00108dea:StringName::StringName((StringName*)&local_f8, pcVar21, false);
                                    }

                                    LAB_00108df6:EditorUndoRedoManager::add_do_method<int>(this_00, (Object*)pLVar11, (StringName*)&local_f8, param_4);
                                 ...
                                 LAB_00108cd6:StringName::StringName((StringName*)&local_f8, pcVar21, false);
                                 iVar10 = param_4;
                                 LAB_00108ce5:EditorUndoRedoManager::add_do_method<int,int>(this_00, (Object*)pLVar11, (StringName*)&local_f8, iVar10, param_5);
                                 LAB_00108cf7:if (StringName::configured != '\0') {
                                    LAB_00108d00:if (local_f8 != (Object*)0x0) {
                                       StringName::unref();
                                    }
                              ...
                              LAB_00108d13:List<PropertyInfo,DefaultAllocator>::~List((List<PropertyInfo,DefaultAllocator>*)&local_140);
                              CowData<String>::_unref((CowData<String>*)&local_100);
                           }

                           LAB_001073e1:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
                              return;
                           }

                           LAB_00108ec5:/* WARNING: Subroutine does not return */__stack_chk_fail();
                           LAB_001087c0:iVar6 = iVar6 + 1;
                           goto LAB_0010759e;
                        }

                        /* CowData<Ref<TileSetAtlasSource> >::_copy_on_write() [clone .isra.0] */
                        void CowData<Ref<TileSetAtlasSource>>::_copy_on_write(CowData<Ref<TileSetAtlasSource>> *this) {
                           long lVar1;
                           long lVar2;
                           code *pcVar3;
                           char cVar4;
 ...
 while ( lVar1 != lVar8 );
                        ...
                        void TileSetEditor::_load_texture_files(TileSetEditor *this, Vector *param_1) {
                           Variant *pVVar1;
                           long lVar2;
                           undefined8 *puVar3;
                           StringName *pSVar4;
                           ...
                           if (( local_168 != 0 ) && ( lVar2 = local_168 != lVar2 )) {
                              do if (Variant::needs_deinit[(int)local_70] != '\0') if (( cVar6 != '\0' ) && ( cVar6 = cVar6 != '\0' )) {
 ...
 while ( lVar2 != local_168 );
                        ...
                        void TileSetEditor::_drop_data_fw(TileSetEditor *this, Vector2 *param_1, Variant *param_2, Control *param_3) {
                           char cVar1;
                           long in_FS_OFFSET;
                           Variant local_60[8];
                           Variant local_58[8];
                           ...
                           if (*(long*)( this + 0x9d0 ) == 0) {
                              if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
                                 _err_print_error("_drop_data_fw", "editor/plugins/tiles/tile_set_editor.cpp", 0x33, "Condition \"tile_set.is_null()\" is true.", 0, 0);
                                 return;
                              }
                        ...
                        uint RefCounted::is_class_ptr(RefCounted *this, void *param_1) {
                           return (uint)CONCAT71(0x118e, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x118d, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr);
                        }
                        ...
                        uint TileSetEditor::is_class_ptr(TileSetEditor *this, void *param_1) {
                           return (uint)CONCAT71(0x118d, (undefined4*)param_1 == &Control::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x118b, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x118d, (undefined4*)param_1 == &CanvasItem::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x118d, (undefined4*)param_1 == &Node::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x118e, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
                        }

                        /* TileSourceInspectorPlugin::is_class_ptr(void*) const */
                        uint TileSourceInspectorPlugin::is_class_ptr(TileSourceInspectorPlugin *this, void *param_1) {
                           return (uint)CONCAT71(0x118c, (undefined4*)param_1 == &EditorInspectorPlugin::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x118b, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x118d, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x118e, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
                        }
   ...
   Object*>::~CallableCustomMethodPointer() */
                        void CallableCustomMethodPointer<TileSourceInspectorPlugin,void,Object*>::~CallableCustomMethodPointer(CallableCustomMethodPointer<TileSourceInspectorPlugin,void,Object*> *this) {
                           return;
                        }
                        ...
                        void CallableCustomMethodPointer<TileSourceInspectorPlugin,void>::~CallableCustomMethodPointer(CallableCustomMethodPointer<TileSourceInspectorPlugin,void> *this) {
                           return;
                        }

                        /* CallableCustomMethodPointer<TileSetEditor, void, Object*, Object*, String const&, Variant
   const&>::~CallableCustomMethodPointer() */
                        void CallableCustomMethodPointer<TileSetEditor,void,Object*,Object*,String_const&,Variant_const&>::~CallableCustomMethodPointer(CallableCustomMethodPointer<TileSetEditor,void,Object*,Object*,String_const&,Variant_const&> *this) {
                           return;
                        }

                        /* CallableCustomMethodPointer<TileSetEditor, void, Object*, Object*, String const&, int,
   int>::~CallableCustomMethodPointer() */
                        void CallableCustomMethodPointer<TileSetEditor,void,Object*,Object*,String_const&,int,int>::~CallableCustomMethodPointer(CallableCustomMethodPointer<TileSetEditor,void,Object*,Object*,String_const&,int,int> *this) {
                           return;
                        }

                        /* CallableCustomMethodPointer<TileSetEditor, void, Ref<InputEvent>
   const&>::~CallableCustomMethodPointer() */
                        void CallableCustomMethodPointer<TileSetEditor,void,Ref<InputEvent>const&>::~CallableCustomMethodPointer(CallableCustomMethodPointer<TileSetEditor,void,Ref<InputEvent>const&> *this) {
                           return;
                        }

                        /* CallableCustomMethodPointer<TileSetEditor, void, Vector2 const&, Variant const&,
   Control*>::~CallableCustomMethodPointer() */
                        void CallableCustomMethodPointer<TileSetEditor,void,Vector2_const&,Variant_const&,Control*>::~CallableCustomMethodPointer(CallableCustomMethodPointer<TileSetEditor,void,Vector2_const&,Variant_const&,Control*> *this) {
                           return;
                        }

                        /* CallableCustomMethodPointerC<TileSetEditor, bool, Vector2 const&, Variant const&,
   Control*>::~CallableCustomMethodPointerC() */
                        void CallableCustomMethodPointerC<TileSetEditor,bool,Vector2_const&,Variant_const&,Control*>::~CallableCustomMethodPointerC(CallableCustomMethodPointerC<TileSetEditor,bool,Vector2_const&,Variant_const&,Control*> *this) {
                           return;
                        }

                        /* CallableCustomMethodPointer<TilesEditorUtils, void, Object*,
   Object*>::~CallableCustomMethodPointer() */
                        void CallableCustomMethodPointer<TilesEditorUtils,void,Object*,Object*>::~CallableCustomMethodPointer(CallableCustomMethodPointer<TilesEditorUtils,void,Object*,Object*> *this) {
                           return;
                        }

                        /* CallableCustomMethodPointer<TilesEditorUtils, void, int>::~CallableCustomMethodPointer() */
                        void CallableCustomMethodPointer<TilesEditorUtils,void,int>::~CallableCustomMethodPointer(CallableCustomMethodPointer<TilesEditorUtils,void,int> *this) {
                           return;
                        }

                        /* CallableCustomMethodPointer<TileSetEditor, void, int>::~CallableCustomMethodPointer() */
                        void CallableCustomMethodPointer<TileSetEditor,void,int>::~CallableCustomMethodPointer(CallableCustomMethodPointer<TileSetEditor,void,int> *this) {
                           return;
                        }

                        /* CallableCustomMethodPointer<TileSetEditor, void>::~CallableCustomMethodPointer() */
                        void CallableCustomMethodPointer<TileSetEditor,void>::~CallableCustomMethodPointer(CallableCustomMethodPointer<TileSetEditor,void> *this) {
                           return;
                        }

                        /* CallableCustomMethodPointer<TileSetEditor, void, Ref<TileMapPattern>, Ref<Texture2D>
   >::~CallableCustomMethodPointer() */
                        void CallableCustomMethodPointer<TileSetEditor,void,Ref<TileMapPattern>,Ref<Texture2D>>::~CallableCustomMethodPointer(CallableCustomMethodPointer<TileSetEditor,void,Ref<TileMapPattern>,Ref<Texture2D>> *this) {
                           return;
                        }

                        /* CallableCustomMethodPointer<TileSetEditor, void, Vector<String>
   const&>::~CallableCustomMethodPointer() */
                        void CallableCustomMethodPointer<TileSetEditor,void,Vector<String>const&>::~CallableCustomMethodPointer(CallableCustomMethodPointer<TileSetEditor,void,Vector<String>const&> *this) {
                           return;
                        }

                        /* CallableCustomMethodPointer<TileSourceInspectorPlugin, void, Object*>::get_argument_count(bool&)
   const */
                        undefined8 CallableCustomMethodPointer<TileSourceInspectorPlugin,void,Object*>::get_argument_count(CallableCustomMethodPointer<TileSourceInspectorPlugin,void,Object*> *this, bool *param_1) {
                           *param_1 = true;
                           return 1;
                        }
                        ...
                        undefined8 CallableCustomMethodPointer<TileSourceInspectorPlugin,void>::get_argument_count(CallableCustomMethodPointer<TileSourceInspectorPlugin,void> *this, bool *param_1) {
                           *param_1 = true;
                           return 0;
                        }
   ...
   const&>::get_argument_count(bool&) const */
                        undefined8 CallableCustomMethodPointer<TileSetEditor,void,Object*,Object*,String_const&,Variant_const&>::get_argument_count(CallableCustomMethodPointer<TileSetEditor,void,Object*,Object*,String_const&,Variant_const&> *this, bool *param_1) {
                           *param_1 = true;
                           return 4;
                        }
   ...
   int>::get_argument_count(bool&) const */
                        undefined8 CallableCustomMethodPointer<TileSetEditor,void,Object*,Object*,String_const&,int,int>::get_argument_count(CallableCustomMethodPointer<TileSetEditor,void,Object*,Object*,String_const&,int,int> *this, bool *param_1) {
                           *param_1 = true;
                           return 5;
                        }
                        ...
                        /* CallableCustomMethodPointer<TileSetEditor, void, Ref<InputEvent>
   const&>::get_argument_count(bool&) const */
                        undefined8 CallableCustomMethodPointer<TileSetEditor,void,Ref<InputEvent>const&>::get_argument_count(CallableCustomMethodPointer<TileSetEditor,void,Ref<InputEvent>const&> *this, bool *param_1) {
                           *param_1 = true;
                           return 1;
                        }
   ...
   Control*>::get_argument_count(bool&) const */
                        undefined8 CallableCustomMethodPointer<TileSetEditor,void,Vector2_const&,Variant_const&,Control*>::get_argument_count(CallableCustomMethodPointer<TileSetEditor,void,Vector2_const&,Variant_const&,Control*> *this, bool *param_1) {
                           *param_1 = true;
                           return 3;
                        }
                        ...
                        /* CallableCustomMethodPointerC<TileSetEditor, bool, Vector2 const&, Variant const&,
   Control*>::get_argument_count(bool&) const */
                        undefined8 CallableCustomMethodPointerC<TileSetEditor,bool,Vector2_const&,Variant_const&,Control*>::get_argument_count(CallableCustomMethodPointerC<TileSetEditor,bool,Vector2_const&,Variant_const&,Control*> *this, bool *param_1) {
                           *param_1 = true;
                           return 3;
                        }
   ...
   const */
                        undefined8 CallableCustomMethodPointer<TilesEditorUtils,void,Object*,Object*>::get_argument_count(CallableCustomMethodPointer<TilesEditorUtils,void,Object*,Object*> *this, bool *param_1) {
                           *param_1 = true;
                           return 2;
                        }

                        /* CallableCustomMethodPointer<TilesEditorUtils, void, int>::get_argument_count(bool&) const */
                        undefined8 CallableCustomMethodPointer<TilesEditorUtils,void,int>::get_argument_count(CallableCustomMethodPointer<TilesEditorUtils,void,int> *this, bool *param_1) {
                           *param_1 = true;
                           return 1;
                        }

                        /* CallableCustomMethodPointer<TileSetEditor, void, int>::get_argument_count(bool&) const */
                        undefined8 CallableCustomMethodPointer<TileSetEditor,void,int>::get_argument_count(CallableCustomMethodPointer<TileSetEditor,void,int> *this, bool *param_1) {
                           *param_1 = true;
                           return 1;
                        }

                        /* CallableCustomMethodPointer<TileSetEditor, void>::get_argument_count(bool&) const */
                        undefined8 CallableCustomMethodPointer<TileSetEditor,void>::get_argument_count(CallableCustomMethodPointer<TileSetEditor,void> *this, bool *param_1) {
                           *param_1 = true;
                           return 0;
                        }
   ...
   >::get_argument_count(bool&) const */
                        undefined8 CallableCustomMethodPointer<TileSetEditor,void,Ref<TileMapPattern>,Ref<Texture2D>>::get_argument_count(CallableCustomMethodPointer<TileSetEditor,void,Ref<TileMapPattern>,Ref<Texture2D>> *this, bool *param_1) {
                           *param_1 = true;
                           return 2;
                        }
                        ...
                        /* CallableCustomMethodPointer<TileSetEditor, void, Vector<String>
   const&>::get_argument_count(bool&) const */
                        undefined8 CallableCustomMethodPointer<TileSetEditor,void,Vector<String>const&>::get_argument_count(CallableCustomMethodPointer<TileSetEditor,void,Vector<String>const&> *this, bool *param_1) {
                           *param_1 = true;
                           return 1;
                        }
   ...
   Object*>::~CallableCustomMethodPointer() */
                        ...
                        uint HSplitContainer::is_class_ptr(void *param_1) {
                           ...
                           if (in_RSI != &get_class_ptr_static()::ptr) {
                              uVar1 = (uint)CONCAT71(0x118d, in_RSI == &Container::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x118b, in_RSI == &SplitContainer::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x118d, in_RSI == &Control::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x118d, in_RSI == &CanvasItem::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x118d, in_RSI == &Node::get_class_ptr_static(), ::ptr) | CONCAT31(( int3 )((uint)in_EDX >> 8), in_RSI == &Object::get_class_ptr_static(), ::ptr);
                           }
                        ...
                        undefined8 CallableCustomMethodPointer<TilesEditorUtils,void,Object*,Object*>::get_object(CallableCustomMethodPointer<TilesEditorUtils,void,Object*,Object*> *this) {
                           long lVar1;
                           undefined8 uVar2;
                           uint uVar3;
                           ulong *puVar4;
...
;
                           ...
                           uVar2 = 0;
                           LAB_0010a80d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
                              /* WARNING: Subroutine does not return */
                              __stack_chk_fail();
                           }
                        ...
                        undefined8 CallableCustomMethodPointer<TileSourceInspectorPlugin,void,Object*>::get_object(CallableCustomMethodPointer<TileSourceInspectorPlugin,void,Object*> *this) {
                           long lVar1;
                           undefined8 uVar2;
                           uint uVar3;
                           ulong *puVar4;
...
;
                           ...
                           uVar2 = 0;
                           LAB_0010a90d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
                              /* WARNING: Subroutine does not return */
                              __stack_chk_fail();
                           }
                        ...
                        undefined8 CallableCustomMethodPointer<TileSetEditor,void,Vector<String>const&>::get_object(CallableCustomMethodPointer<TileSetEditor,void,Vector<String>const&> *this) {
                           long lVar1;
                           undefined8 uVar2;
                           uint uVar3;
                           ulong *puVar4;
...
;
                           ...
                           uVar2 = 0;
                           LAB_0010aa0d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
                              /* WARNING: Subroutine does not return */
                              __stack_chk_fail();
                           }
   ...
   const&>::get_object() const */
                        undefined8 CallableCustomMethodPointer<TileSetEditor,void,Object*,Object*,String_const&,Variant_const&>::get_object(CallableCustomMethodPointer<TileSetEditor,void,Object*,Object*,String_const&,Variant_const&> *this) {
                           long lVar1;
                           undefined8 uVar2;
                           uint uVar3;
                           ulong *puVar4;
...
;
                           ...
                           uVar2 = 0;
                           LAB_0010ab0d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
                              /* WARNING: Subroutine does not return */
                              __stack_chk_fail();
                           }
...
;
                           ...
                           uVar2 = 0;
                           LAB_0010ac0d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
                              /* WARNING: Subroutine does not return */
                              __stack_chk_fail();
                           }
   ...
   int>::get_object() const */
                        undefined8 CallableCustomMethodPointer<TileSetEditor,void,Object*,Object*,String_const&,int,int>::get_object(CallableCustomMethodPointer<TileSetEditor,void,Object*,Object*,String_const&,int,int> *this) {
                           long lVar1;
                           undefined8 uVar2;
                           uint uVar3;
                           ulong *puVar4;
...
;
                           ...
                           uVar2 = 0;
                           LAB_0010ad0d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
                              /* WARNING: Subroutine does not return */
                              __stack_chk_fail();
                           }
                        ...
                        undefined8 CallableCustomMethodPointer<TileSetEditor,void,Ref<InputEvent>const&>::get_object(CallableCustomMethodPointer<TileSetEditor,void,Ref<InputEvent>const&> *this) {
                           long lVar1;
                           undefined8 uVar2;
                           uint uVar3;
                           ulong *puVar4;
...
;
                           ...
                           uVar2 = 0;
                           LAB_0010ae0d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
                              /* WARNING: Subroutine does not return */
                              __stack_chk_fail();
                           }
                        ...
                        undefined8 CallableCustomMethodPointer<TileSourceInspectorPlugin,void>::get_object(CallableCustomMethodPointer<TileSourceInspectorPlugin,void> *this) {
                           long lVar1;
                           undefined8 uVar2;
                           uint uVar3;
                           ulong *puVar4;
...
;
                           ...
                           uVar2 = 0;
                           LAB_0010af0d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
                              /* WARNING: Subroutine does not return */
                              __stack_chk_fail();
                           }
   ...
   Control*>::get_object() const */
                        undefined8 CallableCustomMethodPointer<TileSetEditor,void,Vector2_const&,Variant_const&,Control*>::get_object(CallableCustomMethodPointer<TileSetEditor,void,Vector2_const&,Variant_const&,Control*> *this) {
                           long lVar1;
                           undefined8 uVar2;
                           uint uVar3;
                           ulong *puVar4;
...
;
                           ...
                           uVar2 = 0;
                           LAB_0010b00d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
                              /* WARNING: Subroutine does not return */
                              __stack_chk_fail();
                           }
                        ...
                        undefined8 CallableCustomMethodPointer<TileSetEditor,void,int>::get_object(CallableCustomMethodPointer<TileSetEditor,void,int> *this) {
                           long lVar1;
                           undefined8 uVar2;
                           uint uVar3;
                           ulong *puVar4;
...
;
                           ...
                           uVar2 = 0;
                           LAB_0010b10d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
                              /* WARNING: Subroutine does not return */
                              __stack_chk_fail();
                           }
                        ...
                        /* CallableCustomMethodPointerC<TileSetEditor, bool, Vector2 const&, Variant const&,
   Control*>::get_object() const */
                        undefined8 CallableCustomMethodPointerC<TileSetEditor,bool,Vector2_const&,Variant_const&,Control*>::get_object(CallableCustomMethodPointerC<TileSetEditor,bool,Vector2_const&,Variant_const&,Control*> *this) {
                           long lVar1;
                           undefined8 uVar2;
                           uint uVar3;
                           ulong *puVar4;
...
;
                           ...
                           uVar2 = 0;
                           LAB_0010b20d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
                              /* WARNING: Subroutine does not return */
                              __stack_chk_fail();
                           }
                        ...
                        undefined8 CallableCustomMethodPointer<TileSetEditor,void>::get_object(CallableCustomMethodPointer<TileSetEditor,void> *this) {
                           long lVar1;
                           undefined8 uVar2;
                           uint uVar3;
                           ulong *puVar4;
...
;
                           ...
                           uVar2 = 0;
                           LAB_0010b30d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
                              /* WARNING: Subroutine does not return */
                              __stack_chk_fail();
                           }
                        ...
                        /* CallableCustomMethodPointer<TileSetEditor, void, Ref<TileMapPattern>, Ref<Texture2D>
   >::get_object() const */
                        undefined8 CallableCustomMethodPointer<TileSetEditor,void,Ref<TileMapPattern>,Ref<Texture2D>>::get_object(CallableCustomMethodPointer<TileSetEditor,void,Ref<TileMapPattern>,Ref<Texture2D>> *this) {
                           long lVar1;
                           undefined8 uVar2;
                           uint uVar3;
                           ulong *puVar4;
...
;
                        ...
                        undefined8 CallableCustomMethodPointer<TilesEditorUtils,void,int>::get_object(CallableCustomMethodPointer<TilesEditorUtils,void,int> *this) {
                           long lVar1;
                           undefined8 uVar2;
                           uint uVar3;
                           ulong *puVar4;
...
;
                        ...
                        uint VBoxContainer::is_class_ptr(void *param_1) {
                           ...
                           uVar1 = 1;
                           if (in_RSI != &get_class_ptr_static()::ptr) {
                              uVar1 = (uint)CONCAT71(0x118d, in_RSI == &Container::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x118d, in_RSI == &BoxContainer::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x118d, in_RSI == &Control::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x118d, in_RSI == &CanvasItem::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x118d, in_RSI == &Node::get_class_ptr_static(), ::ptr) | CONCAT31(( int3 )((uint)in_EDX >> 8), in_RSI == &Object::get_class_ptr_static(), ::ptr);
                           }
                        ...
                        undefined8 TileSetEditor::_getv(StringName *param_1, Variant *param_2) {
                           undefined8 uVar1;
                           if (( (code*)PTR__get_0011e030 != CanvasItem::_get ) && ( uVar1 = Control::_get(param_1, param_2) ),(char)uVar1 != '\0') {
                              return uVar1;
                           }
                        ...
                        void VBoxContainer::~VBoxContainer(VBoxContainer *this) {
                           ...
                           *(code**)this = Container::_notification;
                           ...
                           LAB_0010bc60:Control::~Control((Control*)this);
                           return;
                        }
                        ...
                        void HBoxContainer::~HBoxContainer(HBoxContainer *this) {
                           ...
                           *(code**)this = Container::_notification;
                           ...
                           LAB_0010bcc0:Control::~Control((Control*)this);
                           return;
                        }
                        ...
                        void VBoxContainer::~VBoxContainer(VBoxContainer *this) {
                           ...
                           *(code**)this = Container::_notification;
                           ...
                           LAB_0010bd20:Control::~Control((Control*)this);
                        ...
                        void HBoxContainer::~HBoxContainer(HBoxContainer *this) {
                           ...
                           *(code**)this = Container::_notification;
                           ...
                           LAB_0010bd90:Control::~Control((Control*)this);
                           operator_delete(this, 0xa10);
                           return;
                        }
                        ...
                        undefined8 *HSplitContainer::_get_class_namev(void) {
                           ...
                           if (_get_class_namev()::_class_name_static != 0) {
                              if (*(long*)( _get_class_namev() ) != 0) {
                                 LAB_0010c1c3:return &_get_class_namev();
                              }

                              if (*(long*)( _get_class_namev() ) != 0) {
                                 if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_0010c1c3;
                           ...
                           StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "HSplitContainer");
                           LAB_0010c22e:return &_get_class_namev();
                        }
                        ...
                        undefined8 *TileSetEditor::_get_class_namev(void) {
                           ...
                           if (_get_class_namev()::_class_name_static != 0) {
                              if (*(long*)( _get_class_namev() ) != 0) {
                                 LAB_0010c2b3:return &_get_class_namev();
                              }

                              if (*(long*)( _get_class_namev() ) != 0) {
                                 if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_0010c2b3;
                                 StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "TileSetEditor");
                                 goto LAB_0010c31e;
                              }
                           ...
                           StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "TileSetEditor");
                           LAB_0010c31e:return &_get_class_namev();
                        }
                        ...
                        undefined8 *TileSourceInspectorPlugin::_get_class_namev(void) {
                           ...
                           if (_get_class_namev()::_class_name_static != 0) {
                              if (*(long*)( _get_class_namev() ) != 0) {
                                 LAB_0010c3a3:return &_get_class_namev();
                              }

                              if (*(long*)( _get_class_namev() ) != 0) {
                                 if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_0010c3a3;
                                 StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "TileSourceInspectorPlugin");
                                 goto LAB_0010c40e;
                              }
                           ...
                           StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "TileSourceInspectorPlugin");
                           LAB_0010c40e:return &_get_class_namev();
                        }
                        ...
                        void HSplitContainer::~HSplitContainer(HSplitContainer *this) {
                           ...
                           *(code**)this = Container::_notification;
                           ...
                           LAB_0010d1df:Control::~Control((Control*)this);
                           return;
                        }
                        ...
                        void HSplitContainer::~HSplitContainer(HSplitContainer *this) {
                           ...
                           *(code**)this = Container::_notification;
                           ...
                           LAB_0010d38f:Control::~Control((Control*)this);
                        ...
                        void EditorUndoRedoManager::add_do_method<int,int>(EditorUndoRedoManager *this, Object *param_1, StringName *param_2, int param_3, int param_4) {
                           Variant *pVVar1;
                           Variant *pVVar2;
                           long in_FS_OFFSET;
                           Variant *local_a8;
 ...
 while ( pVVar2 != local_88 );
   ...
   (TileSetEditor::*)()) */
                        TileSetEditor *create_custom_callable_function_pointer<TileSetEditor>(TileSetEditor *param_1, char *param_2, _func_void *param_3) {
                           undefined8 uVar1;
                           CallableCustom *this;
                           undefined8 in_RCX;
                           undefined8 in_R8;
   ...
   void (TileSetEditor::*)(int)) */
                        TileSetEditor *create_custom_callable_function_pointer<TileSetEditor,int>(TileSetEditor *param_1, char *param_2, _func_void_int *param_3) {
                           undefined8 uVar1;
                           CallableCustom *this;
                           undefined8 in_RCX;
                           undefined8 in_R8;
                        ...
                        ulong Object::is_class(Object *this, String *param_1) {
                           ...
                           do {
                              if (lVar2 == 0) {
                                 ...
                                 LAB_0010f157:/* WARNING: Subroutine does not return */__stack_chk_fail();
                              }
 ...
 while ( true );
                        ...
                        undefined8 Node::is_class(Node *this, String *param_1) {
                           ...
                           if (cVar4 == '\0') {
                              ...
                              LAB_0010f26b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
                                 return 1;
                              }
                        ...
                        undefined8 RefCounted::is_class(RefCounted *this, String *param_1) {
                           ...
                           if (cVar4 == '\0') {
                              ...
                              LAB_0010f3bb:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
                                 return 1;
                              }
                        ...
                        undefined8 EditorInspectorPlugin::is_class(EditorInspectorPlugin *this, String *param_1) {
                           long *plVar1;
                           long lVar2;
                           char *__s;
                           long lVar3;
                           ...
                           if (cVar4 == '\0') {
                              ...
                              LAB_0010f50b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
                                 return 1;
                              }
                        ...
                        undefined8 TileSourceInspectorPlugin::is_class(TileSourceInspectorPlugin *this, String *param_1) {
                           long *plVar1;
                           long lVar2;
                           char *__s;
                           long lVar3;
                           ...
                           if (cVar4 == '\0') {
                              ...
                              LAB_0010f65b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
                                 return 1;
                              }
   ...
   int, StringName const&) */
                        void PropertyInfo::PropertyInfo(PropertyInfo *this, undefined4 param_2, CowData *param_3, undefined4 param_4, CowData *param_5, undefined4 param_6, StringName *param_7) {
                           long lVar1;
                           long in_FS_OFFSET;
                           long local_38;
                           long local_30;
...
;
                           ...
                           LAB_0010fb50:/* WARNING: Subroutine does not return */__stack_chk_fail();
                        }

                        /* CallableCustomMethodPointer<TileSourceInspectorPlugin, void>::call(Variant const**, int,
   Variant&, Callable::CallError&) const */
                        void CallableCustomMethodPointer<TileSourceInspectorPlugin,void>::call(CallableCustomMethodPointer<TileSourceInspectorPlugin,void> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
                           long lVar1;
                           long lVar2;
                           uint uVar3;
                           ulong *puVar4;
...
;
                           ...
                           LAB_0010fd60:/* WARNING: Subroutine does not return */__stack_chk_fail();
                        }

                        /* CallableCustomMethodPointer<TileSetEditor, void>::call(Variant const**, int, Variant&,
   Callable::CallError&) const */
                        void CallableCustomMethodPointer<TileSetEditor,void>::call(CallableCustomMethodPointer<TileSetEditor,void> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
                           long lVar1;
                           long lVar2;
                           uint uVar3;
                           ulong *puVar4;
...
;
                           ...
                           LAB_0010ff70:/* WARNING: Subroutine does not return */__stack_chk_fail();
                        }

                        /* CallableCustomMethodPointer<TilesEditorUtils, void, Object*, Object*>::call(Variant const**, int,
   Variant&, Callable::CallError&) const */
                        void CallableCustomMethodPointer<TilesEditorUtils,void,Object*,Object*>::call(CallableCustomMethodPointer<TilesEditorUtils,void,Object*,Object*> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
                           long lVar1;
                           long lVar2;
                           Variant *pVVar3;
                           undefined8 uVar4;
...
;
                              ...
                              _err_print_error(&_LC53, "./core/object/callable_method_pointer.h", 0x67, "Parameter \"ObjectDB::get_instance(ObjectID(data.object_id))\" is null.", local_48, 0, 0);
                           ...
                           LAB_0011028a:/* WARNING: Subroutine does not return */__stack_chk_fail();
                        }

                        /* CallableCustomMethodPointer<TileSourceInspectorPlugin, void, Object*>::call(Variant const**, int,
   Variant&, Callable::CallError&) const */
                        void CallableCustomMethodPointer<TileSourceInspectorPlugin,void,Object*>::call(CallableCustomMethodPointer<TileSourceInspectorPlugin,void,Object*> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
                           long lVar1;
                           long lVar2;
                           Variant *this_00;
                           undefined8 uVar3;
...
;
                           ...
                           LAB_0011052a:/* WARNING: Subroutine does not return */__stack_chk_fail();
                        }

                        /* CallableCustomMethodPointer<TilesEditorUtils, void, int>::call(Variant const**, int, Variant&,
   Callable::CallError&) const */
                        void CallableCustomMethodPointer<TilesEditorUtils,void,int>::call(CallableCustomMethodPointer<TilesEditorUtils,void,int> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
                           long lVar1;
                           long lVar2;
                           undefined8 uVar3;
                           char cVar4;
...
;
                           ...
                           LAB_00110799:/* WARNING: Subroutine does not return */__stack_chk_fail();
                        }

                        /* CallableCustomMethodPointer<TileSetEditor, void, int>::call(Variant const**, int, Variant&,
   Callable::CallError&) const */
                        void CallableCustomMethodPointer<TileSetEditor,void,int>::call(CallableCustomMethodPointer<TileSetEditor,void,int> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
                           long lVar1;
                           long lVar2;
                           undefined8 uVar3;
                           char cVar4;
...
;
                           ...
                           LAB_00110a09:/* WARNING: Subroutine does not return */__stack_chk_fail();
                        }
   ...
   int, Variant&, Callable::CallError&) const */
                        void CallableCustomMethodPointer<TileSetEditor,void,Ref<InputEvent>const&>::call(CallableCustomMethodPointer<TileSetEditor,void,Ref<InputEvent>const&> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
                           long lVar1;
                           long lVar2;
                           ulong uVar3;
                           undefined8 uVar4;
...
;
                                    ...
                                    *(undefined4*)param_4 = 0;
                                    ...
                                    if (pOVar7 != local_38) {
                                       if (pOVar7 == (Object*)0x0) {
                                          if (local_38 != (Object*)0x0) {
                                             local_38 = (Object*)0x0;
                                             LAB_00110bad:cVar6 = RefCounted::unreference();
                        ...
                        _err_print_error(&_LC53, "./core/object/callable_method_pointer.h", 0x67, "Parameter \"ObjectDB::get_instance(ObjectID(data.object_id))\" is null.", (String*)&local_38, 0, 0);
                        CowData<char32_t>::_unref((CowData<char32_t>*)&local_38);
                        CowData<char32_t>::_unref(local_48);
                        CowData<char32_t>::_unref(local_50);
                        CowData<char32_t>::_unref((CowData<char32_t>*)&local_40);
                        LAB_00110ade:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
                           /* WARNING: Subroutine does not return */
                           __stack_chk_fail();
                        }
...
, /* CallableCustomMethodPointer<TileSetEditor, void, Vector2 const&, Variant const&,
   Control*>::call(Variant const**, int, Variant&, Callable::CallError&) const */, void __thiscall
...
;
                                 ...
                                 *(undefined4*)param_4 = 0;
                                 ...
                                 if (cVar4 == '\0') {
                                    ...
                                    *(undefined8*)( param_4 + 4 ) = uVar3;
                                    ...
                                    pOVar5 = Variant::operator_cast_to_Object_(this_00);
                                    pOVar6 = Variant::operator_cast_to_Object_(this_00);
                                    if (( ( pOVar6 == (Object*)0x0 ) || ( lVar7 = __dynamic_cast(pOVar6, &Object::typeinfo, &Control::typeinfo, 0) ),lVar7 == 0 )) goto LAB_00110ecf;
                                 }
                        ...
                        _err_print_error(&_LC53, "./core/object/callable_method_pointer.h", 0x67, "Parameter \"ObjectDB::get_instance(ObjectID(data.object_id))\" is null.", local_68, 0, 0);
                        CowData<char32_t>::_unref((CowData<char32_t>*)local_68);
                        CowData<char32_t>::_unref(local_78);
                        CowData<char32_t>::_unref(local_80);
                        CowData<char32_t>::_unref((CowData<char32_t>*)&local_70);
                        LAB_00110e45:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
                           /* WARNING: Subroutine does not return */
                           __stack_chk_fail();
                        }
...
;
                                 ...
                                 *(undefined4*)param_4 = 0;
                                 ...
                                 if (cVar4 == '\0') {
                                    ...
                                    *(undefined8*)( param_4 + 4 ) = uVar3;
                                    ...
                                    pOVar5 = Variant::operator_cast_to_Object_(this_00);
                                    pOVar6 = Variant::operator_cast_to_Object_(this_00);
                                    if (( ( pOVar6 == (Object*)0x0 ) || ( lVar7 = __dynamic_cast(pOVar6, &Object::typeinfo, &Control::typeinfo, 0) ),lVar7 == 0 )) goto LAB_0011123c;
                                 }
                        ...
                        _err_print_error(&_LC53, "./core/object/callable_method_pointer.h", 0xad, "Parameter \"ObjectDB::get_instance(ObjectID(data.object_id))\" is null.", local_88, 0, 0);
                        CowData<char32_t>::_unref((CowData<char32_t>*)local_88);
                        CowData<char32_t>::_unref(local_98);
                        CowData<char32_t>::_unref(local_a0);
                        CowData<char32_t>::_unref((CowData<char32_t>*)&local_90);
                        LAB_001111b4:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
                           /* WARNING: Subroutine does not return */
                           __stack_chk_fail();
                        }
...
, /* CallableCustomMethodPointer<TileSetEditor, void, Object*, Object*, String const&, int,
   int>::call(Variant const**, int, Variant&, Callable::CallError&) const */, void __thiscall
...
;
                        ...
                        CowData<char32_t>::_unref(local_60);
                        CowData<char32_t>::_unref((CowData<char32_t>*)&local_50);
                        LAB_0011154c:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
                           /* WARNING: Subroutine does not return */
                           __stack_chk_fail();
                        }
...
, /* CallableCustomMethodPointer<TileSetEditor, void, Object*, Object*, String const&, Variant
   const&>::call(Variant const**, int, Variant&, Callable::CallError&) const */, void __thiscall
...
;
                        ...
                        _err_print_error(&_LC53, "./core/object/callable_method_pointer.h", 0x67, "Parameter \"ObjectDB::get_instance(ObjectID(data.object_id))\" is null.", local_60, 0, 0);
                        CowData<char32_t>::_unref((CowData<char32_t>*)local_60);
                        CowData<char32_t>::_unref(local_70);
                        CowData<char32_t>::_unref(local_78);
                        CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
                        LAB_001118e4:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
                           /* WARNING: Subroutine does not return */
                           __stack_chk_fail();
                        }
...
, /* RefCounted::_initialize_classv() */, void RefCounted::_initialize_classv(void);
 ...
 while ( lVar2 != (ulong)uVar1 << 2 );
                     ...
                     LAB_0011335f:CowData<char32_t>::_unref((CowData<char32_t>*)this);
                     return;
                  }
                  ...
                  undefined8 Control::is_class(Control *this, String *param_1) {
                     ...
                     LAB_00113493:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
                        return 1;
                     }

                     LAB_0011359e:/* WARNING: Subroutine does not return */__stack_chk_fail();
                  }

                  /* TileSetEditor::is_class(String const&) const */
                  undefined8 TileSetEditor::is_class(TileSetEditor *this, String *param_1) {
                     long *plVar1;
                     long lVar2;
                     char *__s;
                     long lVar3;
                     ...
                     if (cVar4 == '\0') {
                        ...
                        LAB_001136ab:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
                           return 1;
                        }
                  ...
                  undefined8 Container::is_class(Container *this, String *param_1) {
                     ...
                     if (cVar4 == '\0') {
                        ...
                        LAB_001137fb:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
                           return 1;
                        }
                  ...
                  undefined8 VBoxContainer::is_class(VBoxContainer *this, String *param_1) {
                     long lVar1;
                     char *pcVar2;
                     long lVar3;
                     char cVar4;
                     ...
                     LAB_00113923:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
                        return 1;
                     }

                     LAB_00113a2e:/* WARNING: Subroutine does not return */__stack_chk_fail();
                  }

                  /* HSplitContainer::is_class(String const&) const */
                  undefined8 HSplitContainer::is_class(HSplitContainer *this, String *param_1) {
                     long lVar1;
                     char *pcVar2;
                     long lVar3;
                     char cVar4;
                     ...
                     LAB_00113b13:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
                        return 1;
                     }

                     LAB_00113c1e:/* WARNING: Subroutine does not return */__stack_chk_fail();
                  }
                  ...
                  undefined8 HBoxContainer::is_class(HBoxContainer *this, String *param_1) {
                     ...
                     LAB_00113d03:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
                        return 1;
                     }

                     LAB_00113e0e:/* WARNING: Subroutine does not return */__stack_chk_fail();
                  }
    ...
    */
                  void TileSourceInspectorPlugin::_get_property_listv(TileSourceInspectorPlugin *this, List *param_1, bool param_2) {
                     long in_FS_OFFSET;
                     undefined8 local_90;
                     undefined8 local_88;
                     long local_80;
                  ...
                  void TileSetEditor::_get_property_listv(TileSetEditor *this, List *param_1, bool param_2) {
                     long in_FS_OFFSET;
                     undefined8 local_90;
                     undefined8 local_88;
                     long local_80;
                  ...
                  void SplitContainer::_get_property_listv(SplitContainer *this, List *param_1, bool param_2) {
                     long in_FS_OFFSET;
                     undefined8 local_90;
                     undefined8 local_88;
                     long local_80;
                  ...
                  void HSplitContainer::_get_property_listv(HSplitContainer *this, List *param_1, bool param_2) {
                     long in_FS_OFFSET;
                     undefined8 local_90;
                     undefined8 local_88;
                     long local_80;
                  ...
                  /* Ref<Texture2D>::unref() */
                  void Ref<Texture2D>::unref(Ref<Texture2D> *this) {
                     Object *pOVar1;
                     char cVar2;
                     if (*(long*)this != 0) {
                        cVar2 = RefCounted::unreference();
   ...
   >::call(Variant const**, int, Variant&, Callable::CallError&) const */
                  void CallableCustomMethodPointer<TileSetEditor,void,Ref<TileMapPattern>,Ref<Texture2D>>::call(CallableCustomMethodPointer<TileSetEditor,void,Ref<TileMapPattern>,Ref<Texture2D>> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
                     long lVar1;
                     long lVar2;
                     Object *pOVar3;
                     ulong uVar4;
                        ...
                        if (( *(ulong*)( this + 0x30 ) >> 0x18 & 0x7fffffffff ) == ( *puVar9 & 0x7fffffffff )) {
                           ...
                           if (puVar9[1] != 0) {
                              ...
                              *(undefined4*)param_4 = 0;
                              ...
                              if (pOVar7 != local_50) {
                                 if (pOVar7 == (Object*)0x0) {
                                    ...
                                    if (pOVar3 != pOVar7) {
                                       ...
                                       LAB_00115780:Ref<Texture2D>::unref((Ref<Texture2D>*)&local_48);
                                    }
                              ...
                              if (pOVar7 != local_48) {
                                 if (pOVar7 == (Object*)0x0) {
                                    if (local_48 != (Object*)0x0) {
                                       local_48 = (Object*)0x0;
                                       LAB_00115810:cVar6 = RefCounted::unreference();
                                       if (( cVar6 != '\0' ) && ( cVar6 = cVar6 != '\0' )) {
                              ...
                              if (( ( local_48 != (Object*)0x0 ) && ( cVar6 = RefCounted::unreference() ),pOVar3 = local_48,cVar6 != '\0' )) &&( cVar6 = cVar6 != '\0' )(**(code**)( *(long*)pOVar3 + 0x140 ))(pOVar3);
                              Memory::free_static(pOVar3, false);
                           }
...
, else {
    _err_print_error("get_instance", "./core/object/object.h", 0x418, "Condition \"slot >= slot_max\" is true. Returning: nullptr", 0, 0);
      ...
      local_58,(String*)"Invalid Object id \'";
      String::operator +((String*)&local_48, (String*)local_58);
      _err_print_error(&_LC53, "./core/object/callable_method_pointer.h", 0x67, "Parameter \"ObjectDB::get_instance(ObjectID(data.object_id))\" is null.", (Ref<Texture2D>*)&local_48, 0, 0);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_48);
      CowData<char32_t>::_unref(local_58);
      CowData<char32_t>::_unref(local_60);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_50);
      LAB_00115685:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Subroutine does not return */
         __stack_chk_fail();
      }
   ...
   /* Ref<TileSet>::unref() */
   void Ref<TileSet>::unref(Ref<TileSet> *this) {
      Object *pOVar1;
      char cVar2;
      if (*(long*)this != 0) {
         cVar2 = RefCounted::unreference();
   ...
   void TileSetEditor::_notificationv(TileSetEditor *this, int param_1, bool param_2) {
      int iVar1;
      iVar1 = (int)this;
      if (param_2) {
   ...
   void Ref<TileSetAtlasSource>::unref(Ref<TileSetAtlasSource> *this) {
      Object *pOVar1;
      char cVar2;
      if (*(long*)this != 0) {
         cVar2 = RefCounted::unreference();
 ...
 while ( lVar3 != lVar5 );
   ...
   int, Variant&, Callable::CallError&) const */
   void CallableCustomMethodPointer<TileSetEditor,void,Vector<String>const&>::call(CallableCustomMethodPointer<TileSetEditor,void,Vector<String>const&> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
      long lVar1;
      long lVar2;
      undefined8 uVar3;
      char cVar4;
...
;
      ...
      CowData<char32_t>::_unref(local_60);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_50);
      LAB_00115e1e:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Subroutine does not return */
         __stack_chk_fail();
      }
   ...
   void CowData<Ref<TileSetAtlasSource>>::_unref(CowData<Ref<TileSetAtlasSource>> *this) {
      long *plVar1;
      long lVar2;
      Object *pOVar3;
      code *pcVar4;
 ...
 while ( lVar2 != lVar7 );
   ...
   undefined8 CowData<Ref<TileSetAtlasSource>>::_realloc(CowData<Ref<TileSetAtlasSource>> *this, long param_1) {
      undefined8 *puVar1;
   ...
   undefined8 CowData<Ref<TileSetAtlasSource>>::resize<false>(CowData<Ref<TileSetAtlasSource>> *this, long param_1) {
      long *plVar1;
      Object *pOVar2;
      code *pcVar3;
      char cVar4;
      ...
      if (param_1 * 8 == 0) {
         LAB_00116480:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
         return 6;
      }
...
;
      ...
      if (lVar11 == lVar8) {
         LAB_001163fb:puVar10 = *(undefined8**)this;
         if (puVar10 == (undefined8*)0x0) {
            LAB_001162f0:/* WARNING: Does not return */pcVar3 = (code*)invalidInstructionException();
            ( *pcVar3 )();
         }
      ...
      LAB_001163db:puVar10[-1] = param_1;
      return 0;
   }

   /* List<EditorInspectorPlugin::AddedEditor, DefaultAllocator>::~List() */
   void List<EditorInspectorPlugin::AddedEditor,DefaultAllocator>::~List(List<EditorInspectorPlugin::AddedEditor,DefaultAllocator> *this) {
      void *pvVar1;
      long lVar2;
      long lVar3;
      long *plVar4;
 ...
 while ( (int)plVar4[2] != 0 );
   ...
   void TileSourceInspectorPlugin::~TileSourceInspectorPlugin(TileSourceInspectorPlugin *this) {
      bool bVar1;
      bVar1 = StringName::configured != '\0';
      *(undefined**)this = &BoxContainer::typeinfo;
      ...
      LAB_001166b4:List<EditorInspectorPlugin::AddedEditor,DefaultAllocator>::~List((List<EditorInspectorPlugin::AddedEditor,DefaultAllocator>*)( this + 0x180 ));
      *(undefined***)this = &PTR__initialize_classv_00117230;
      Object::~Object((Object*)this);
      return;
   }
   ...
   void TileSourceInspectorPlugin::~TileSourceInspectorPlugin(TileSourceInspectorPlugin *this) {
      ...
      *(undefined**)this = &BoxContainer::typeinfo;
      ...
      LAB_001167b4:List<EditorInspectorPlugin::AddedEditor,DefaultAllocator>::~List((List<EditorInspectorPlugin::AddedEditor,DefaultAllocator>*)( this + 0x180 ));
      *(undefined***)this = &PTR__initialize_classv_00117230;
      Object::~Object((Object*)this);
   ...
   void TileSetEditor::_GLOBAL__sub_I_singleton(void) {
      ...
      for (int i = 0; i < 3; i++) {
         if (PopupMenu::base_property_helper == '\0') {
            ...
            PopupMenu::base_property_helper._0_16_ = (undefined1[16])0;
            PopupMenu::base_property_helper._24_16_ = (undefined1[16])0;
            PopupMenu::base_property_helper._40_16_ = (undefined1[16])0;
         ...
         if (OptionButton::base_property_helper == '\0') {
            ...
            OptionButton::base_property_helper._0_16_ = (undefined1[16])0;
            OptionButton::base_property_helper._24_16_ = (undefined1[16])0;
            OptionButton::base_property_helper._40_16_ = (undefined1[16])0;

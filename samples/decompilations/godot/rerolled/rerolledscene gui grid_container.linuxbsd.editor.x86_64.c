/* GridContainer::get_columns() const */undefined4 GridContainer::get_columns(GridContainer *this) {
   return *(undefined4*)( this + 0xa00 );
}
/* GridContainer::set_columns(int) */void GridContainer::set_columns(GridContainer *this, int param_1) {
   if (param_1 < 1) {
      _err_print_error("set_columns", "scene/gui/grid_container.cpp", 0xf4, "Condition \"p_columns < 1\" is true.", 0, 0);
      return;
   }
...
/* std::_Function_handler<void (Node*, StringName const&, StringName const&),
   ...
   const&)#2}>::_M_manager(std::_Any_data&, std::_Any_data const&, std::_Manager_operation) */undefined8 std::_Function_handler<void(Node *, StringName_const &, StringName_const &),GridContainer::_bind_methods()::{lambda(Node*,StringName_const&,StringName_const&)#2}>::_M_manager(undefined8 *param_1, undefined8 param_2, int param_3) {
   if (param_3 == 0) {
...
/* std::_Function_handler<void (Node*, StringName const&, StringName const&),
   GridContainer::_bind_methods()::{lambda(Node*, StringName const&, StringName
   const&)#1}>::_M_manager(std::_Any_data&, std::_Any_data const&, std::_Manager_operation) */undefined8 std::_Function_handler<void(Node *, StringName_const &, StringName_const &),GridContainer::_bind_methods()::{lambda(Node*,StringName_const&,StringName_const&)#1}>::_M_manager(undefined8 *param_1, undefined8 param_2, int param_3) {
   if (param_3 == 0) {
      *param_1 = &GridContainer::_bind_methods()::
                {lambda(Node*,StringName_const&,StringName_const&)
      #1
...
/* RBSet<int, Comparator<int>, DefaultAllocator>::insert(int const&) [clone .isra.0] */void RBSet<int,Comparator<int>,DefaultAllocator>::insert(RBSet<int,Comparator<int>,DefaultAllocator> *this, int *param_1) {
 ...
 while ( bVar14 );
         LAB_00100485:if (piVar12 == piVar8) {
            piVar8 = (int*)0x0;
         }
 ...
 while ( bVar14 );
      ...
      LAB_00100345:*(int**)( piVar8 + 10 ) = piVar6;
 ...
 while ( *(int**)( this + 8 ) != *(int**)( piVar10 + 2 ) );
      LAB_0010033c:*(int**)( piVar6 + 10 ) = piVar10;
      if (piVar8 != (int*)0x0) goto LAB_00100345;
   }

   *(int**)( piVar10 + 8 ) = piVar6;
   LAB_00100356:iVar2 = *piVar9;
               ...
               *(long*)( piVar9 + 2 ) = lVar4;
               if (lVar3 == lVar4) {
                  *(int**)( piVar6 + 6 ) = piVar13;
                  piVar10 = piVar13;
                  LAB_001006f0:*(int**)( piVar10 + 4 ) = piVar6;
               }
 else {
...
;
         if (*piVar10 != 0) {
            ...
            if (piVar6 == piVar10) {
               ...
               *piVar10 = 1;
               ...
               LAB_00100578:_err_print_error("_set_color", "./core/templates/rb_set.h", 0xd0, "Condition \"p_node == _data._nil && p_color == RED\" is true.", 0, 0);
               piVar6 = piVar9;
            }
 else {
               piVar11 = *(int**)( this + 8 );
         ...
         LAB_001003ed:piVar6 = *(int**)( this + 8 );
         *piVar9 = 1;
         *piVar10 = 1;
         if (piVar13 == piVar6) {
            _err_print_error("_set_color", "./core/templates/rb_set.h", 0xd0, "Condition \"p_node == _data._nil && p_color == RED\" is true.", 0, 0);
...
/* GridContainer::get_h_separation() const */undefined4 GridContainer::get_h_separation(GridContainer *this) {
   return *(undefined4*)( this + 0xa04 );
}
/* GridContainer::GridContainer() */void GridContainer::GridContainer(GridContainer *this) {
...
/* GridContainer::_bind_methods() */void GridContainer::_bind_methods(void) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   MethodBind *pMVar4;
 ...
 while ( lVar2 != lVar7 );
   ...
   local_68._4_4_ = 0;
   uStack_60 = 0;
   pcStack_58 = std::_Function_handler<void(Node *, StringName_const &, StringName_const &),GridContainer::_bind_methods()::{lambda(Node *, StringName_const &, StringName_const &)#1}>::_M_manager;
   pcStack_50 = std::_Function_handler<void(Node *, StringName_const &, StringName_const &),GridContainer::_bind_methods()::{lambda(Node *, StringName_const &, StringName_const &)#1}>::_M_invoke;
   ...
   ThemeDB::bind_class_item(uVar5, 1, (StringName*)&local_a8, (StringName*)&local_c0, (StringName*)&local_b8, &local_68);
   if (( StringName::configured != '\0' ) && ( local_a8 != (char*)0x0 )) {
      StringName::unref();
   }
   ...
   if (( StringName::configured != '\0' ) && ( ( ( local_c0 == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) && ( local_b8 != (char*)0x0 ) ) )) {
      StringName::unref();
   }
   ...
   local_68._4_4_ = 0;
   uStack_60 = 0;
   pcStack_58 = std::_Function_handler<void(Node *, StringName_const &, StringName_const &),GridContainer::_bind_methods()::{lambda(Node *, StringName_const &, StringName_const &)#2}>::_M_manager;
   pcStack_50 = std::_Function_handler<void(Node *, StringName_const &, StringName_const &),GridContainer::_bind_methods()::{lambda(Node *, StringName_const &, StringName_const &)#2}>::_M_invoke;
...
/* GridContainer::_notification(int) [clone .part.0] */void GridContainer::_notification(int param_1) {
   bool bVar1;
   char cVar2;
   bool bVar3;
   int iVar4;
            ...
            while (puVar11 = (undefined8*)puVar11[2],local_d0 != puVar11) {
               while (*(int*)( puVar11 + 6 ) <= iVar17) {
                  if (iVar17 <= *(int*)( puVar11 + 6 )) {
                     piVar10 = (int*)RBMap<int,int,Comparator<int>,DefaultAllocator>::operator []((RBMap<int,int,Comparator<int>,DefaultAllocator>*)&local_d8, &local_dc);
                     if (iVar16 < *piVar10) {
                        iVar16 = *piVar10;
                     }
...
;
         ...
         LAB_001011ce:piVar10 = (int*)RBMap<int,int,Comparator<int>,DefaultAllocator>::operator []((RBMap<int,int,Comparator<int>,DefaultAllocator>*)&local_d8, &local_dc);
         *piVar10 = iVar16;
         LAB_001011ec:puVar11 = local_b8;
            ...
            while (puVar11 = (undefined8*)puVar11[2],local_b0 != puVar11) {
               while (*(int*)( puVar11 + 6 ) <= iVar5) {
                  if (iVar5 <= *(int*)( puVar11 + 6 )) {
                     piVar10 = (int*)RBMap<int,int,Comparator<int>,DefaultAllocator>::operator []((RBMap<int,int,Comparator<int>,DefaultAllocator>*)&local_b8, &local_e0);
                     if (iVar6 < *piVar10) {
                        iVar6 = *piVar10;
                     }
...
;
         ...
         LAB_00101222:piVar10 = (int*)RBMap<int,int,Comparator<int>,DefaultAllocator>::operator []((RBMap<int,int,Comparator<int>,DefaultAllocator>*)&local_b8, &local_e0);
         *piVar10 = iVar6;
         uVar12 = Control::get_h_size_flags();
         joined_r0x001012a6:if (( uVar12 & 2 ) == 0) {
            uVar12 = Control::get_v_size_flags();
         }
 else {
            RBSet<int,Comparator<int>,DefaultAllocator>::insert((RBSet<int,Comparator<int>,DefaultAllocator>*)&local_98, &local_dc);
            uVar12 = Control::get_v_size_flags();
         }

         if (( uVar12 & 2 ) != 0) {
            RBSet<int,Comparator<int>,DefaultAllocator>::insert((RBSet<int,Comparator<int>,DefaultAllocator>*)&local_78, &local_e0);
         }
...
;
   ...
   if ((float)( (uint)fVar25 & _LC31 ) < _LC28) {
      fVar25 = (float)( ( uint )((float)(int)fVar25 + (float)( -(uint)((float)(int)fVar25 < fVar25) & (uint)_LC30 )) | ~_LC31 & (uint)fVar25 );
   }
 ...
 while ( iVar17 < *(int*)( pCVar23 + 0xa00 ) );
   ...
   if (( local_d8 != (undefined8*)0x0 ) && ( puVar11 = (undefined8*)local_d8[2] ),(undefined8*)local_d8[2] != local_d0) {
      do {
         puVar21 = puVar11;
 ...
 while ( local_d0 != (undefined8*)puVar21[2] );
      do {
         if (local_98 != (void*)0x0) {
            ...
            LAB_0010144c:pEVar15 = *(Element**)( (long)local_98 + 0x10 );
 ...
 while ( puVar21 != (undefined8*)0x0 );
   ...
   LAB_00101493:if (( local_b8 != (undefined8*)0x0 ) && ( puVar11 = (undefined8*)local_b8[2] ),(undefined8*)local_b8[2] != local_b0) {
      do {
         puVar21 = puVar11;
         puVar11 = (undefined8*)puVar21[2];
      }
 while ( local_b0 != (undefined8*)puVar21[2] );
      do {
         if (local_78 != (Element*)0x0) {
            iVar17 = *(int*)( puVar21 + 6 );
            LAB_001014e4:pEVar15 = *(Element**)( local_78 + 0x10 );
 ...
 while ( puVar21 != (undefined8*)0x0 );
   ...
   while (0 < local_88) {
      if (( local_98 == (void*)0x0 ) || ( pEVar15 = *(Element**)( (long)local_98 + 0x10 ) ),pEVar14 = pEVar15,pEVar15 == local_90) goto LAB_00101eb0;
      do {
         pEVar22 = pEVar14;
 ...
 while ( local_90 != *(Element**)( pEVar14 + 0x10 ) );
      ...
      do {
         while (true) {
            piVar10 = (int*)RBMap<int,int,Comparator<int>,DefaultAllocator>::operator []((RBMap<int,int,Comparator<int>,DefaultAllocator>*)&local_d8, (int*)( pEVar14 + 0x30 ));
            iVar17 = *piVar10;
            piVar10 = (int*)RBMap<int,int,Comparator<int>,DefaultAllocator>::operator []((RBMap<int,int,Comparator<int>,DefaultAllocator>*)&local_d8, &local_dc);
            if (*piVar10 < iVar17) {
...
;
 ...
 while ( pEVar14 != (Element*)0x0 );
      LAB_00101666:if (bVar1) break;
      if (local_98 != (void*)0x0) {
         for (pEVar15 = *(Element**)( (long)local_98 + 0x10 ); local_90 != pEVar15; pEVar15 = *(Element**)( pEVar15 + 0x10 )) {
            while (*(int*)( pEVar15 + 0x30 ) <= local_dc) {
               if (local_dc <= *(int*)( pEVar15 + 0x30 )) {
                  RBSet<int,Comparator<int>,DefaultAllocator>::_erase((RBSet<int,Comparator<int>,DefaultAllocator>*)&local_98, pEVar15);
...
;
      ...
      LAB_00101be8:piVar10 = (int*)RBMap<int,int,Comparator<int>,DefaultAllocator>::operator []((RBMap<int,int,Comparator<int>,DefaultAllocator>*)&local_d8, &local_dc);
      local_138 = local_138 - (float)*piVar10;
   }
;
   do {
      if (local_68 < 1) goto LAB_00101e4a;
      if (( local_78 == (Element*)0x0 ) || ( pEVar15 = *(Element**)( local_78 + 0x10 ) ),pEVar14 = pEVar15,pEVar15 == local_70) {
         LAB_00101eb0:/* WARNING: Does not return */pcVar18 = (code*)invalidInstructionException();
         ( *pcVar18 )();
      }
 ...
 while ( local_70 != *(Element**)( pEVar14 + 0x10 ) );
      ...
      do {
         while (true) {
            piVar10 = (int*)RBMap<int,int,Comparator<int>,DefaultAllocator>::operator []((RBMap<int,int,Comparator<int>,DefaultAllocator>*)&local_b8, (int*)( pEVar14 + 0x30 ));
            iVar17 = *piVar10;
            piVar10 = (int*)RBMap<int,int,Comparator<int>,DefaultAllocator>::operator []((RBMap<int,int,Comparator<int>,DefaultAllocator>*)&local_b8, &local_dc);
            if (*piVar10 < iVar17) {
               local_dc = *(int*)( pEVar14 + 0x30 );
            }
...
;
 ...
 while ( pEVar14 != (Element*)0x0 );
      ...
      if (local_78 != (Element*)0x0) {
         for (pEVar15 = *(Element**)( local_78 + 0x10 ); local_70 != pEVar15; pEVar15 = *(Element**)( pEVar15 + 0x10 )) {
            while (*(int*)( pEVar15 + 0x30 ) <= local_dc) {
               if (local_dc <= *(int*)( pEVar15 + 0x30 )) {
                  RBSet<int,Comparator<int>,DefaultAllocator>::_erase((RBSet<int,Comparator<int>,DefaultAllocator>*)&local_78, pEVar15);
...
;
      ...
      LAB_00101e18:piVar10 = (int*)RBMap<int,int,Comparator<int>,DefaultAllocator>::operator []((RBMap<int,int,Comparator<int>,DefaultAllocator>*)&local_b8, &local_dc);
      fVar25 = fVar25 - (float)*piVar10;
   }
 while ( true );
   LAB_00101b50:puVar21 = (undefined8*)puVar21[4];
   if (puVar21 == (undefined8*)0x0) goto LAB_00101493;
   iVar17 = *(int*)( puVar21 + 6 );
   goto LAB_0010144c;
   LAB_00101b68:puVar21 = (undefined8*)puVar21[4];
   if (puVar21 == (undefined8*)0x0) goto LAB_00101523;
   iVar17 = *(int*)( puVar21 + 6 );
   goto LAB_001014e4;
   LAB_00101e4a:if (local_88 < 1) {
      iVar17 = 0;
      iVar19 = 0;
      bVar1 = true;
      pcVar18 = *(code**)( *(long*)pCVar23 + 0x340 );
      LAB_00101e80:cVar2 = ( *pcVar18 )(pCVar23);
      if (!bVar1) {
         iVar16 = 0;
         bVar3 = true;
         iVar5 = 0;
         LAB_00101836:iVar24 = 0;
         iVar7 = 0;
         do {
        iVar20 = iVar7 + 1;
        if (local_98 != (void *)0x0) {
...
LAB_00101878:
    ...
    iVar24 = 0;
         ...
         LAB_00101791:iVar19 = (int)( local_138 / (float)local_88 );
         iVar17 = (int)( local_138 - (float)( local_88 * iVar19 ) );
         bVar1 = iVar17 == 0 || iVar4 < 1;
         LAB_001017ce:pcVar18 = *(code**)( *(long*)pCVar23 + 0x340 );
         ...
         LAB_00101881:if (!bVar3) {
            ...
            do {
               iVar4 = iVar4 + 1;
               if (local_78 != (Element*)0x0) {
                  for (pEVar15 = *(Element**)( local_78 + 0x10 ); local_70 != pEVar15; pEVar15 = *(Element**)( pEVar15 + 8 )) {
 ...
 while ( ( iVar5 != 0 ) && ( iVar4 < iVar6 ) );
      ...
      do {
         while (true) {
            ...
            if (iVar5 <= iVar4) {
               RBSet<int,Comparator<int>,DefaultAllocator>::clear((RBSet<int,Comparator<int>,DefaultAllocator>*)&local_78);
               if (local_78 != (Element*)0x0) {
                  Memory::free_static(local_78, false);
               }

               RBSet<int,Comparator<int>,DefaultAllocator>::clear((RBSet<int,Comparator<int>,DefaultAllocator>*)&local_98);
               if (local_98 != (void*)0x0) {
                  Memory::free_static(local_98, false);
               }

               RBMap<int,int,Comparator<int>,DefaultAllocator>::clear((RBMap<int,int,Comparator<int>,DefaultAllocator>*)&local_b8);
               if (local_b8 != (undefined8*)0x0) {
                  Memory::free_static(local_b8, false);
               }

               RBMap<int,int,Comparator<int>,DefaultAllocator>::clear((RBMap<int,int,Comparator<int>,DefaultAllocator>*)&local_d8);
               if (local_d8 != (undefined8*)0x0) {
...
;
         ...
         if (iVar17 == 0) {
            ...
            iVar20 = iVar7 + -1;
            if (local_78 != (Element*)0x0) {
               for (pEVar15 = *(Element**)( local_78 + 0x10 ); pEVar15 != local_70; pEVar15 = *(Element**)( pEVar15 + 8 )) {
...
;
            ...
            LAB_00101ce0:local_dc = iVar20;
            piVar10 = (int*)RBMap<int,int,Comparator<int>,DefaultAllocator>::operator []((RBMap<int,int,Comparator<int>,DefaultAllocator>*)&local_b8, &local_dc);
            local_138 = (float)( (int)local_138 + *(int*)( pCVar23 + 0xa08 ) + *piVar10 );
            if (local_78 != (Element*)0x0) {
               LAB_00101d2a:pEVar15 = *(Element**)( local_78 + 0x10 );
               pEVar14 = pEVar15;
               if (local_70 != pEVar15) {
                  do {
                     pEVar22 = local_70;
 ...
 while ( true );
            ...
            LAB_00101999:pEVar15 = local_78;
            pEVar22 = local_70;
            if (local_78 != (Element*)0x0) {
               while (pEVar15 = *(Element**)( pEVar15 + 0x10 ),pEVar22 != pEVar15) {
                  LAB_001019b1:while (*(int*)( pEVar15 + 0x30 ) <= iVar7) {
                     iVar20 = iVar16;
...
;
         ...
         LAB_001019c6:piVar10 = (int*)RBMap<int,int,Comparator<int>,DefaultAllocator>::operator []((RBMap<int,int,Comparator<int>,DefaultAllocator>*)&local_b8, &local_e4);
         iVar20 = *piVar10;
         LAB_001019e5:fVar25 = (float)iVar20;
         if (local_98 != (void*)0x0) {
...
;
         ...
         LAB_00101a2d:piVar10 = (int*)RBMap<int,int,Comparator<int>,DefaultAllocator>::operator []((RBMap<int,int,Comparator<int>,DefaultAllocator>*)&local_d8, &local_e0);
         fVar26 = (float)*piVar10;
         if (( local_98 != (void*)0x0 ) && ( pEVar14 = local_90 != pEVar14 )) {
            ...
            do {
               ...
               LAB_00101c3d:iVar20 = *(int*)( pEVar14 + 0x30 );
            }
 while ( true );
         }
...
;
         ...
         LAB_00101ace:fVar27 = (float)iVar6;
         if (cVar2 != '\0') {
 ...
 while ( true );
   ...
   void GridContainer::_notification(GridContainer *this, int param_1) {
      if (param_1 == 0x33) {
   ...
   undefined8 GridContainer::get_minimum_size(GridContainer *this) {
      int iVar1;
      ulong uVar2;
      int iVar3;
      undefined8 uVar4;
      ...
      do {
         ...
         if (iVar3 <= iVar10) {
            if (( local_88 == (undefined8*)0x0 ) || ( puVar7 = (undefined8*)local_88[2] ),(undefined8*)local_88[2] == local_80) {
               fVar14 = 0.0;
            }
 else {
               do {
 ...
 while ( puVar9 != (undefined8*)0x0 );
            ...
            if (( local_68 == (undefined8*)0x0 ) || ( puVar7 = (undefined8*)local_68[2] ),(undefined8*)local_68[2] == local_60) {
               fVar15 = 0.0;
            }
 else {
               do {
 ...
 while ( puVar9 != (undefined8*)0x0 );
            ...
            RBMap<int,int,Comparator<int>,DefaultAllocator>::clear((RBMap<int,int,Comparator<int>,DefaultAllocator>*)&local_68);
            if (local_68 != (undefined8*)0x0) {
               Memory::free_static(local_68, false);
            }

            RBMap<int,int,Comparator<int>,DefaultAllocator>::clear((RBMap<int,int,Comparator<int>,DefaultAllocator>*)&local_88);
               ...
               while (puVar7 = (undefined8*)puVar7[2],local_80 != puVar7) {
                  while (*(int*)( puVar7 + 6 ) <= iVar8) {
                     if (iVar8 <= *(int*)( puVar7 + 6 )) {
                        piVar6 = (int*)RBMap<int,int,Comparator<int>,DefaultAllocator>::operator []((RBMap<int,int,Comparator<int>,DefaultAllocator>*)&local_88, &local_8c);
                        if (iVar11 < *piVar6) {
                           iVar11 = *piVar6;
                        }
...
;
            ...
            LAB_0010221e:piVar6 = (int*)RBMap<int,int,Comparator<int>,DefaultAllocator>::operator []((RBMap<int,int,Comparator<int>,DefaultAllocator>*)&local_88, &local_8c);
            *piVar6 = iVar11;
            LAB_0010223a:puVar7 = local_68;
            if (local_68 != (undefined8*)0x0) {
               while (puVar7 = (undefined8*)puVar7[2],local_60 != puVar7) {
                  while (*(int*)( puVar7 + 6 ) <= iVar3) {
                     if (iVar3 <= *(int*)( puVar7 + 6 )) {
                        piVar6 = (int*)RBMap<int,int,Comparator<int>,DefaultAllocator>::operator []((RBMap<int,int,Comparator<int>,DefaultAllocator>*)&local_68, &local_90);
                        if (iVar12 < *piVar6) {
                           iVar12 = *piVar6;
                        }
...
;
            ...
            LAB_00102269:piVar6 = (int*)RBMap<int,int,Comparator<int>,DefaultAllocator>::operator []((RBMap<int,int,Comparator<int>,DefaultAllocator>*)&local_68, &local_90);
            *piVar6 = iVar12;
            LAB_0010227b:if ((int)uVar13 < iVar8) {
 ...
 while ( true );
   ...
   uint GridContainer::is_class_ptr(void *param_1) {
      undefined4 in_EDX;
      undefined4 *in_RSI;
      return (uint)CONCAT71(0x108e, in_RSI == &Container::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x108e, in_RSI == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x108e, in_RSI == &Control::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x108e, in_RSI == &CanvasItem::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x108e, in_RSI == &Node::get_class_ptr_static(), ::ptr) | CONCAT31(( int3 )((uint)in_EDX >> 8), in_RSI == &Object::get_class_ptr_static(), ::ptr);
   }
   ...
   [clone .cold] */
   void std::_Function_handler<void(Node *, StringName_const &, StringName_const &),GridContainer::_bind_methods()::{lambda(Node*,StringName_const&,StringName_const&)#2}>::_M_invoke(_Any_data *param_1, Node **param_2, StringName *param_3, StringName *param_4) {
      code *pcVar1;
   ...
   [clone .cold] */
   void std::_Function_handler<void(Node *, StringName_const &, StringName_const &),GridContainer::_bind_methods()::{lambda(Node*,StringName_const&,StringName_const&)#1}>::_M_invoke(_Any_data *param_1, Node **param_2, StringName *param_3, StringName *param_4) {
      code *pcVar1;
      Control::get_theme_item();
      Variant::operator_cast_to_int((Variant*)&stack0x00000000);
      _DAT_00000a04 = 0;
   ...
   void RBSet<int,Comparator<int>,DefaultAllocator>::_cleanup_tree(RBSet<int,Comparator<int>,DefaultAllocator> *this, Element *param_1) {
      Element *pEVar1;
      Element *pEVar2;
      Element *pEVar3;
      Element *pEVar4;
   ...
   void RBMap<int,int,Comparator<int>,DefaultAllocator>::_cleanup_tree(RBMap<int,int,Comparator<int>,DefaultAllocator> *this, Element *param_1) {
      Element *pEVar1;
      Element *pEVar2;
      Element *pEVar3;
      Element *pEVar4;
   ...
   void GridContainer::~GridContainer(GridContainer *this) {
      bool bVar1;
      ...
      *(code**)this = __cxa_guard_acquire;
      ...
      LAB_00103710:Control::~Control((Control*)this);
      return;
   }
   ...
   void GridContainer::~GridContainer(GridContainer *this) {
      ...
      *(code**)this = __cxa_guard_acquire;
      ...
      LAB_00103770:Control::~Control((Control*)this);
   ...
   undefined8 *GridContainer::_get_class_namev(void) {
      ...
      if (_get_class_namev()::_class_name_static != 0) {
         if (*(long*)( _get_class_namev() ) != 0) {
            LAB_001037d3:return &_get_class_namev();
         }

         if (*(long*)( _get_class_namev() ) != 0) {
            if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001037d3;
            StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "GridContainer");
            goto LAB_0010383e;
         }
      ...
      StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "GridContainer");
      LAB_0010383e:return &_get_class_namev();
   }
   ...
   undefined4 *MethodBindTRC<int>::_gen_argument_type_info(int param_1) {
      ...
      *(undefined1(*) [16])( puVar3 + 2 ) = (undefined1[16])0x0;
      ...
      lVar2 = local_58;
      joined_r0x00103a8c:local_58 = lVar2;
      if (lVar2 != 0) {
         LOCK();
   ...
   void GridContainer::_get_property_listv(GridContainer *this, List *param_1, bool param_2) {
      long *plVar1;
      long lVar2;
      long lVar3;
      undefined1(*pauVar4)[16];
   ...
   undefined4 *MethodBindT<int>::_gen_argument_type_info(int param_1) {
      ...
      *puVar7 = local_58._0_4_;
      ...
      LAB_001050f7:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Subroutine does not return */
         __stack_chk_fail();
      }
 ...
 while ( !bVar9 );
         ...
         LAB_001053ef:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
 ...
 while ( !bVar9 );
            ...
            LAB_001055eb:cVar6 = String::operator ==(param_1, (String*)&local_60);
            lVar4 = local_60;
            if (local_60 != 0) {
               LOCK();
               plVar1 = (long*)( local_60 + -0x10 );
 ...
 while ( !bVar9 );
               ...
               LAB_001056cb:cVar6 = String::operator ==(param_1, (String*)&local_60);
               lVar4 = local_60;
               if (local_60 != 0) {
                  LOCK();
                  plVar1 = (long*)( local_60 + -0x10 );
 ...
 while ( !bVar9 );
                  ...
                  LAB_00105573:cVar6 = String::operator ==(param_1, (String*)&local_60);
      ...
      LAB_001054a3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }

      LAB_001057e1:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }

   /* GridContainer::is_class(String const&) const */
   undefined8 GridContainer::is_class(GridContainer *this, String *param_1) {
      long *plVar1;
      long lVar2;
      char *pcVar3;
      long lVar4;
 ...
 while ( !bVar9 );
   ...
   void RBMap<int,int,Comparator<int>,DefaultAllocator>::clear(RBMap<int,int,Comparator<int>,DefaultAllocator> *this) {
      Element *pEVar1;
      Element *pEVar2;
      Element *pEVar3;
      Element *pEVar4;
   ...
   void RBSet<int,Comparator<int>,DefaultAllocator>::clear(RBSet<int,Comparator<int>,DefaultAllocator> *this) {
      Element *pEVar1;
      Element *pEVar2;
      Element *pEVar3;
      Element *pEVar4;
   ...
   void RBSet<int,Comparator<int>,DefaultAllocator>::_erase_fix_rb(RBSet<int,Comparator<int>,DefaultAllocator> *this, Element *param_1) {
      int iVar1;
      Element *pEVar2;
      long lVar3;
      long lVar4;
      ...
      do {
         pEVar6 = pEVar9;
         if (pEVar2 == pEVar7) {
            LAB_001067f0:iVar1 = *(int*)pEVar8;
            joined_r0x001068b3:if (iVar1 != 1) {
         ...
         pEVar9 = param_1;
         if (*(int*)param_1 != 0) {
            LAB_00106799:pEVar7 = *(Element**)( pEVar9 + 0x10 );
            if (*(int*)pEVar7 == 1) goto LAB_001067a6;
            LAB_00106850:if (pEVar9 != *(Element**)( pEVar6 + 8 )) {
               iVar1 = *(int*)pEVar6;
               pEVar7 = pEVar9;
            ...
            LAB_00106a41:if (( pEVar9 == pEVar8 ) && ( *(int*)pEVar6 == 0 )) {
               _err_print_error("_set_color", "./core/templates/rb_set.h", 0xd0, "Condition \"p_node == _data._nil && p_color == RED\" is true.", 0, 0);
               pEVar8 = *(Element**)( this + 8 );
            }
 else {
         ...
         *(Element**)( pEVar6 + 0x18 ) = param_1;
         ...
         LAB_001067a6:pEVar7 = *(Element**)( pEVar9 + 8 );
         if (*(int*)pEVar7 != 1) {
            ...
            *(Element**)( pEVar9 + 0x18 ) = pEVar7;
            iVar1 = *(int*)pEVar6;
            joined_r0x0010685f:if (( iVar1 == 0 ) && ( pEVar7 == pEVar8 )) {
               _err_print_error("_set_color", "./core/templates/rb_set.h", 0xd0, "Condition \"p_node == _data._nil && p_color == RED\" is true.", 0, 0);
               pEVar8 = *(Element**)( this + 8 );
            }
 else {
 ...
 while ( true );
   ...
   DefaultAllocator>::Element*) */
   void RBSet<int,Comparator<int>,DefaultAllocator>::_erase(RBSet<int,Comparator<int>,DefaultAllocator> *this, Element *param_1) {
      int *piVar1;
      Element *pEVar2;
      Element *pEVar3;
      int *piVar4;
      ...
      pEVar8 = param_1;
      if (piVar4 == piVar1) {
         LAB_00106d18:lVar6 = *(long*)( pEVar8 + 0x18 );
         piVar4 = *(int**)( pEVar8 + 8 );
         pEVar9 = *(Element**)( lVar6 + 0x10 );
         if (pEVar9 == pEVar8) goto LAB_00106d2d;
         LAB_00106c3d:*(int**)( lVar6 + 8 ) = piVar4;
      }
 else {
         ...
         LAB_00106d2d:*(int**)( lVar6 + 0x10 ) = piVar4;
      ...
      *(int*)( this + 0x10 ) = *(int*)( this + 0x10 ) + -1;
      ...
      LAB_00106d62:_err_print_error("_erase", "./core/templates/rb_set.h", uVar7, pcVar5, 0, 0);
      return;
   }

   /* RBMap<int, int, Comparator<int>, DefaultAllocator>::_insert_rb_fix(RBMap<int, int,
   Comparator<int>, DefaultAllocator>::Element*) */
   void RBMap<int,int,Comparator<int>,DefaultAllocator>::_insert_rb_fix(RBMap<int,int,Comparator<int>,DefaultAllocator> *this, Element *param_1) {
      int iVar1;
      long lVar2;
      long lVar3;
      long lVar4;
         ...
         while (true) {
            ...
            if (*(Element**)( pEVar8 + 0x10 ) == param_1) {
               ...
               *(int*)pEVar8 = 1;
               ...
               LAB_00106f70:_err_print_error("_set_color", "./core/templates/rb_map.h", 0xed, "Condition \"p_node == _data._nil && p_color == RED\" is true.", 0, 0);
            }
...
;
         ...
         if (*(int*)pEVar6 != 0) {
            if (*(Element**)( pEVar8 + 8 ) == param_1) {
               ...
               *(long*)( pEVar8 + 8 ) = lVar3;
               if (lVar2 == lVar3) {
                  *(Element**)( param_1 + 0x18 ) = pEVar5;
                  pEVar7 = pEVar5;
                  LAB_00107062:*(Element**)( pEVar7 + 0x10 ) = param_1;
               }
 else {
                  *(Element**)( lVar3 + 0x18 ) = pEVar8;
                  pEVar7 = *(Element**)( pEVar8 + 0x18 );
               ...
               *(int*)pEVar8 = 1;
               ...
               LAB_00107030:_err_print_error("_set_color", "./core/templates/rb_map.h", 0xed, "Condition \"p_node == _data._nil && p_color == RED\" is true.", 0, 0);
            }
         ...
         LAB_00106e4d:pEVar7 = *(Element**)( this + 8 );
         *(int*)pEVar8 = 1;
         *(int*)pEVar6 = 1;
         if (pEVar5 == pEVar7) {
 ...
 while ( true );
   ...
   Element * __thiscallRBMap<int,int,Comparator<int>,DefaultAllocator>::operator [](RBMap<int,int,Comparator<int>,DefaultAllocator> * this, int, *param_1);
   {
      int iVar1;
      Element *pEVar2;
      Element *pEVar3;
 ...
 while ( bVar10 );
         ...
         *(undefined8*)( pEVar2 + 0x28 ) = 0;
         ...
         LAB_001071dd:*(Element**)( pEVar4 + 0x28 ) = pEVar2;
 ...
 while ( *(Element**)( this + 8 ) != *(Element**)( pEVar5 + 8 ) );
         LAB_001071d4:*(Element**)( pEVar2 + 0x28 ) = pEVar5;
         if (pEVar4 != (Element*)0x0) goto LAB_001071dd;
      }

      *(Element**)( pEVar5 + 0x20 ) = pEVar2;
      LAB_001071ee:*(int*)( this + 0x10 ) = *(int*)( this + 0x10 ) + 1;
      _insert_rb_fix(this, pEVar2);
      LAB_001071ff:return pEVar2 + 0x34;
   }

   /* GridContainer::_notificationv(int, bool) */
   void GridContainer::_notificationv(GridContainer *this, int param_1, bool param_2) {
      int iVar1;
      iVar1 = (int)this;
      if (!param_2) {
         for (int i = 0; i < 3; i++) {
         ...
         if (param_1 < 0x34) {
            ...
            if (param_1 == 0x31) {
               LAB_0010745c:Container::queue_sort();
               return;
            }
      ...
      Container::queue_sort();
      LAB_001073d8:if ((code*)PTR__notification_0010b050 != Control::_notification) {
         Container::_notification(iVar1);
      }
      ...
      *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
      if (( ( plVar7 != (long*)0x0 ) && ( plVar7[1] != 0 ) ) && ( *(char*)( plVar7[1] + 0x2e ) != '\0' )) {
         ...
         if (local_58 == (char*)*plVar6) {
            ...
            _err_print_error(&_LC42, "./core/object/method_bind.h", 0x267, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: ret", (StringName*)&local_58, 0, 0);
            pcVar3 = local_58;
      ...
      LAB_001079d0:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return param_1;
      }
   ...
   void MethodBindTRC<int>::validated_call(MethodBindTRC<int> *this, Object *param_1, Variant **param_2, Variant *param_3) {
      ...
      *(long*)( param_3 + 8 ) = (long)iVar3;
      LAB_00107cc4:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   ...
   void MethodBindTRC<int>::ptrcall(MethodBindTRC<int> *this, Object *param_1, void **param_2, void *param_3) {
      ...
      *(long*)param_3 = (long)iVar3;
      LAB_00107ec3:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   ...
   void MethodBindT<int>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
      ...
      LAB_00108295:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }
   ...
   void MethodBindT<int>::ptrcall(Object *param_1, void **param_2, void *param_3) {
      ...
      LAB_001084b5:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }
   ...
   void call_with_variant_args_dv<__UnexistingClass,int>(__UnexistingClass *param_1, _func_void_int *param_2, Variant **param_3, int param_4, CallError *param_5, Vector *param_6) {
      ...
      if (lVar1 == 0) {
         ...
         if ((int)lVar2 < (int)( uVar8 ^ 1 )) {
            LAB_00108640:uVar6 = 4;
            LAB_001085dd:*(undefined4*)param_6 = uVar6;
      ...
      LAB_0010855b:*(undefined4*)param_6 = 0;
   ...
   Object *MethodBindT<int>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
      ...
      if (( ( p_Var4 != (__UnexistingClass*)0x0 ) && ( *(long*)( p_Var4 + 8 ) != 0 ) ) && ( *(char*)( *(long*)( p_Var4 + 8 ) + 0x2e ) != '\0' )) {
         ...
         if (local_48 == (char*)*plVar3) {
            ...
            String::parse_latin1((StrRange*)&local_50);
            vformat<StringName>((StringName*)&local_48, (StrRange*)&local_50, &local_58);
            _err_print_error(&_LC42, "./core/object/method_bind.h", 0x154, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: Variant()", (StringName*)&local_48, 0, 0);
            pcVar2 = local_48;
            if (local_48 != (char*)0x0) {
               LOCK();
      ...
      *(undefined4*)param_1 = 0;
      *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
      LAB_00108736:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return param_1;
      }

...
/* CowData<Button*>::_copy_on_write() [clone .isra.0] */void CowData<Button*>::_copy_on_write(CowData<Button*> *this) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   undefined8 *puVar4;
...
/* EditorMainScreen::set_button_container(HBoxContainer*) */void EditorMainScreen::set_button_container(EditorMainScreen *this, HBoxContainer *param_1) {
   *(HBoxContainer**)( this + 0xa18 ) = param_1;
   return;
}
/* EditorMainScreen::is_button_enabled(int) const */undefined8 EditorMainScreen::is_button_enabled(EditorMainScreen *this, int param_1) {
   undefined8 uVar1;
   long lVar2;
   ...
   lVar2 = 0;
   LAB_00100419:_err_print_index_error("is_button_enabled", "editor/editor_main_screen.cpp", 0x71, (long)param_1, lVar2, "p_index", "buttons.size()", "", false, false);
   return 0;
}
/* EditorMainScreen::_get_current_main_editor() const */long EditorMainScreen::_get_current_main_editor(EditorMainScreen *this) {
   long lVar1;
   long lVar2;
   long lVar3;
...
/* EditorMainScreen::get_selected_index() const */long EditorMainScreen::get_selected_index(EditorMainScreen *this) {
   long lVar1;
   long lVar2;
   long lVar3;
   lVar1 = *(long*)( this + 0xa38 );
...
/* EditorMainScreen::get_plugin_index(EditorPlugin*) const */long EditorMainScreen::get_plugin_index(EditorMainScreen *this, EditorPlugin *param_1) {
   long lVar1;
   long lVar2;
   long lVar3;
   lVar1 = *(long*)( this + 0xa38 );
...
/* EditorMainScreen::get_selected_plugin() const */undefined8 EditorMainScreen::get_selected_plugin(EditorMainScreen *this) {
   return *(undefined8*)( this + 0xa10 );
}
/* EditorMainScreen::get_plugin_by_name(String const&) const */undefined8 EditorMainScreen::get_plugin_by_name(EditorMainScreen *this, String *param_1) {
   uint uVar1;
   long lVar2;
   ...
   if (( *(long*)( this + 0xa48 ) != 0 ) && ( *(int*)( this + 0xa6c ) != 0 )) {
      ...
      if (uVar21 != 0) {
         ...
         do {
            if (uVar22 == uVar21) {
               cVar20 = String::operator ==((String*)( *(long*)( *(long*)( this + 0xa48 ) + lVar24 * 8 ) + 0x10 ), param_1);
               if (cVar20 != '\0') {
                  if (( *(long*)( this + 0xa48 ) != 0 ) && ( *(int*)( this + 0xa6c ) != 0 )) {
                     uVar1 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0xa68 ) * 4 );
                     uVar25 = CONCAT44(0, uVar1);
                     ...
                     if (uVar21 != 0) {
                        ...
                        do {
                           if (uVar22 == uVar21) {
                              cVar20 = String::operator ==((String*)( *(long*)( *(long*)( this + 0xa48 ) + lVar24 * 8 ) + 0x10 ), param_1);
                              if (cVar20 != '\0') {
                                 return *(undefined8*)( *(long*)( *(long*)( this + 0xa48 ) + (ulong)uVar28 * 8 ) + 0x18 );
                              }
 ...
 while ( ( uVar21 != 0 ) && ( auVar9._8_8_ = 0 ),auVar9._0_8_ = (ulong)uVar21 * lVar2,auVar17._8_8_ = 0,auVar17._0_8_ = uVar25,auVar10._8_8_ = 0,auVar10._0_8_ = ( ulong )(( uVar1 + uVar28 ) - SUB164(auVar9 * auVar17, 8)) * lVar2,auVar18._8_8_ = 0,auVar18._0_8_ = uVar25,uVar27 <= SUB164(auVar10 * auVar18, 8) );
                     }
 ...
 while ( ( uVar21 != 0 ) && ( auVar5._8_8_ = 0 ),auVar5._0_8_ = (ulong)uVar21 * lVar2,auVar13._8_8_ = 0,auVar13._0_8_ = uVar25,auVar6._8_8_ = 0,auVar6._0_8_ = ( ulong )(( uVar1 + iVar23 ) - SUB164(auVar5 * auVar13, 8)) * lVar2,auVar14._8_8_ = 0,auVar14._0_8_ = uVar25,uVar28 <= SUB164(auVar6 * auVar14, 8) );
      }

   }

   _err_print_error("get_plugin_by_name", "editor/editor_main_screen.cpp", 0xe8, "Condition \"!main_editor_plugins.has(p_plugin_name)\" is true. Returning: nullptr", 0, 0);
   return 0;
}
/* EditorMainScreen::get_control() const */undefined8 EditorMainScreen::get_control(EditorMainScreen *this) {
   return *(undefined8*)( this + 0xa08 );
}
/* EditorMainScreen::EditorMainScreen() */void EditorMainScreen::EditorMainScreen(EditorMainScreen *this) {
   StringName *pSVar1;
...
/* EditorMainScreen::save_layout_to_config(Ref<ConfigFile>, String const&) const */void EditorMainScreen::save_layout_to_config(EditorMainScreen *this, undefined8 *param_2, String *param_3) {
   char cVar1;
   long lVar2;
   long lVar3;
   String *pSVar4;
 ...
 while ( lVar2 != 0 );
   ...
   String::parse_latin1((StrRange*)&local_60);
   LAB_00100aa3:ConfigFile::set_value(pSVar4, param_3, (Variant*)&local_60);
...
/* EditorMainScreen::load_layout_from_config(Ref<ConfigFile>, String const&) */void EditorMainScreen::load_layout_from_config(EditorMainScreen *this, undefined8 *param_2, Variant *param_3) {
   String *pSVar1;
   int iVar2;
   long in_FS_OFFSET;
   undefined8 local_b0;
   ...
   if (-1 < iVar2) {
      if (( *(long*)( this + 0xa28 ) != 0 ) && ( (long)iVar2 < *(long*)( *(long*)( this + 0xa28 ) + -8 ) )) {
         create_custom_callable_function_pointer<EditorMainScreen,int>((EditorMainScreen*)&local_a8, (char*)this, (_func_void_int*)"&EditorMainScreen::select");
...
/* EditorMainScreen::select(int) [clone .part.0] */void EditorMainScreen::select(EditorMainScreen *this, int param_1) {
   long *plVar1;
   long *plVar2;
   code *pcVar3;
   int iVar4;
   ...
   if (param_1 < 0) {
      ...
      LAB_00100ead:_err_print_index_error("select", "editor/editor_main_screen.cpp", 0xad, lVar11, lVar10, "p_index", "editor_table.size()", "", false, false);
   }
 else {
      if (lVar10 == 0) {
         LAB_00100f58:lVar10 = 0;
         goto LAB_00100ead;
      }
      ...
      if (*(long*)( this + 0xa28 ) == 0) {
         LAB_00100f10:lVar10 = 0;
         LAB_00100f13:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar11, lVar10, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
      ...
      if (cVar5 != '\0') {
         ...
         if (plVar1 == (long*)0x0) {
            if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
               _err_print_error("select", "editor/editor_main_screen.cpp", 0xb8, "Parameter \"new_editor\" is null.", 0, 0);
               return;
            }
 ...
 while ( iVar6 != iVar8 );
   ...
   LAB_00100faa:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* EditorMainScreen::select(int) */void EditorMainScreen::select(EditorMainScreen *this, int param_1) {
   char cVar1;
...
/* EditorMainScreen::select_prev() */void EditorMainScreen::select_prev(EditorMainScreen *this) {
   code *pcVar1;
   ulong uVar2;
   char cVar3;
   long lVar4;
 ...
 while ( *(long*)( lVar4 + uVar7 * 8 ) != *(long*)( this + 0xa10 ) );
   ...
   while ((int)uVar7 != 0) {
      ...
      joined_r0x001010c3:if (lVar4 == 0) goto LAB_001010c5;
      uVar7 = (ulong)uVar6;
...
;
   ...
   if (lVar4 != 0) {
      LAB_001010dc:lVar4 = *(long*)( lVar4 + -8 );
      goto LAB_001010e0;
   }

   LAB_001010c5:lVar4 = 0;
   LAB_001010e0:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar5, lVar4, "p_index", "size()", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* EditorMainScreen::select_next() */void EditorMainScreen::select_next(EditorMainScreen *this) {
   code *pcVar1;
   ulong uVar2;
   char cVar3;
   long lVar4;
 ...
 while ( *(long*)( lVar7 + uVar6 * 8 ) != *(long*)( this + 0xa10 ) );
   ...
   LAB_001011b0:lVar7 = *(long*)( this + 0xa28 );
   uVar5 = (int)uVar6 + 1;
   uVar6 = (ulong)uVar5;
   ...
   do {
      if (lVar7 == 0) {
         lVar7 = 0;
         LAB_00101207:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar4, lVar7, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar1 = (code*)invalidInstructionException();
         ( *pcVar1 )();
      ...
      if (( *(long*)( this + 0xa38 ) == 0 ) || ( (long)(int)uVar6 != *(long*)( *(long*)( this + 0xa38 ) + -8 ) + -1 )) goto LAB_001011b0;
      LAB_001011f4:lVar7 = *(long*)( this + 0xa28 );
      uVar6 = 0;
      lVar4 = 0;
   }
 while ( true );
}
/* EditorMainScreen::set_button_enabled(int, bool) */void EditorMainScreen::set_button_enabled(EditorMainScreen *this, int param_1, bool param_2) {
   code *pcVar1;
   char cVar2;
   long lVar3;
   long lVar4;
   ...
   lVar3 = 0;
   LAB_00101319:_err_print_index_error("set_button_enabled", "editor/editor_main_screen.cpp", 0x69, lVar5, lVar3, "p_index", "buttons.size()", "", false, false);
   return;
}
/* EditorMainScreen::_notification(int) */void EditorMainScreen::_notification(EditorMainScreen *this, int param_1) {
   Ref *pRVar1;
   long *plVar2;
   code *pcVar3;
   Object *pOVar4;
 ...
 while ( lVar6 != 0 );
      ...
      LAB_001015ef:cVar5 = EditorNode::is_changing_scene();
      if (cVar5 == '\0') {
         if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            iVar8 = -1;
            LAB_001016c9:select(this, iVar8);
            return;
         }
      ...
      for (lVar7 = 0; ( lVar6 != 0 && ( lVar7 < *(long*)( lVar6 + -8 ) ) ); lVar7 = lVar7 + 1) {
         ...
         if (lVar6 == 0) {
            lVar9 = 0;
            LAB_0010166b:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar7, lVar9, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar3 = (code*)invalidInstructionException();
            ( *pcVar3 )();
         ...
         if (local_60 == (Object*)0x0) {
            ...
            if (cVar5 != '\0') {
               ...
               if (( ( local_48 != (Object*)0x0 ) && ( cVar5 = RefCounted::unreference() ),pOVar4 = local_48,cVar5 != '\0' )) &&( cVar5 = cVar5 != '\0' )(**(code**)( *(long*)pOVar4 + 0x140 ))(pOVar4);
      ...
      else{Button::set_button_icon(pRVar1);
   }

   if (( ( local_60 != (Object*)0x0 ) && ( cVar5 = RefCounted::unreference() ),pOVar4 = local_60,cVar5 != '\0' )) &&( cVar5 = cVar5 != '\0' )(**(code**)( *(long*)pOVar4 + 0x140 ))(pOVar4);
   Memory::free_static(pOVar4, false);
}
lVar6 = *(long*)( this + 0xa28 );}
  }LAB_00101608:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return;
}
LAB_00101796:/* WARNING: Subroutine does not return */__stack_chk_fail();}/* EditorMainScreen::select_by_name(String const&) */void EditorMainScreen::select_by_name(EditorMainScreen *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   char cVar4;
   ...
   if (( *(long*)param_1 == 0 ) || ( *(uint*)( *(long*)param_1 + -8 ) < 2 )) {
      if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         _err_print_error("select_by_name", "editor/editor_main_screen.cpp", 0x9c, "Condition \"p_name.is_empty()\" is true.", 0, 0);
         return;
      }
      ...
      String::parse_latin1((StrRange*)&local_50);
      operator+((char *)
      aCStack_58,(String*)"The editor name \'";
      String::operator +((String*)&local_48, (String*)aCStack_58);
      _err_print_error("select_by_name", "editor/editor_main_screen.cpp", 0xa5, "Method/function failed.", (String*)&local_48, 0, 0);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_48);
      CowData<char32_t>::_unref(aCStack_58);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_50);
      LAB_001018ec:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }

   }

   LAB_00101991:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* EditorMainScreen::remove_main_plugin(EditorPlugin*) */void EditorMainScreen::remove_main_plugin(EditorMainScreen *this, EditorPlugin *param_1) {
   uint *puVar1;
   undefined8 *puVar2;
   undefined8 *puVar3;
   long *plVar4;
   ...
   if (( lVar36 != 0 ) && ( uVar37 = *(int*)( lVar36 + -8 ) - 1 ),-1 < (int)uVar37) {
      ...
      do {
         if (lVar36 == 0) {
            LAB_00101bee:lVar36 = 0;
            LAB_00101bf1:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar34, lVar36, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
         ...
         if (cVar28 != '\0') {
            if (*(long*)( this + 0xa28 ) != 0) {
               ...
               if (lVar32 != 0) {
                     ...
                     if ((long)uVar34 < lVar36) {
                        ...
                        if (lVar36 == 0) {
                           ...
                           if ((long)uVar34 < lVar32) {
                              memmove((void*)( lVar36 + lVar38 ), (void*)( lVar36 + 8 + lVar38 ), ( lVar32 - uVar34 ) * 8);
                           }
                  ...
                  _err_print_index_error("remove_at", "./core/templates/cowdata.h", 0xe4, uVar34, lVar36, "p_index", "size()", "", false, false);
                  break;
               }
         ...
         create_custom_callable_function_pointer<EditorMainScreen,int>((EditorMainScreen*)local_98, (char*)this, (_func_void_int*)"&EditorMainScreen::select");
         ...
         if (*(EditorPlugin**)( lVar36 + lVar32 * 8 ) == param_1) {
            if (lVar32 < lVar38) {
               ...
               if (lVar36 == 0) {
                  ...
                  if (lVar32 < lVar38) {
                     memmove((void*)( lVar36 + lVar32 * 8 ), (void*)( lVar36 + 8 + lVar32 * 8 ), ( lVar38 - lVar32 ) * 8);
                  }
               ...
               _err_print_index_error("remove_at", "./core/templates/cowdata.h", 0xe4, lVar32, lVar38, "p_index", "size()", "", false, false);
            }
 ...
 while ( lVar38 != lVar32 );
   ...
   if (( *(long*)( this + 0xa48 ) != 0 ) && ( *(int*)( this + 0xa6c ) != 0 )) {
      ...
      if (uVar29 != 0) {
         ...
         do {
            if (uVar29 == uVar30) {
               cVar28 = String::operator ==((String*)( *(long*)( *(long*)( this + 0xa48 ) + lVar32 * 8 ) + 0x10 ), (String*)local_b0);
               if (cVar28 != '\0') {
                  ...
                  uVar30 = *puVar39;
                  if (( uVar30 == 0 ) || ( auVar13._8_8_ = 0 ),auVar13._0_8_ = (ulong)uVar30 * lVar32,auVar23._8_8_ = 0,auVar23._0_8_ = uVar34,auVar14._8_8_ = 0,auVar14._0_8_ = ( ulong )(( uVar37 + uVar29 ) - SUB164(auVar13 * auVar23, 8)) * lVar32,auVar24._8_8_ = 0,auVar24._0_8_ = uVar34,uVar40 = uVar31,SUB164(auVar14 * auVar24, 8) == 0) goto LAB_001020d9;
                  goto LAB_00102095;
               }
 ...
 while ( ( uVar29 != 0 ) && ( auVar10._8_8_ = 0 ),auVar10._0_8_ = (ulong)uVar29 * lVar36,auVar20._8_8_ = 0,auVar20._0_8_ = uVar34,auVar11._8_8_ = 0,auVar11._0_8_ = ( ulong )(( uVar37 + uVar31 ) - SUB164(auVar10 * auVar20, 8)) * lVar36,auVar21._8_8_ = 0,auVar21._0_8_ = uVar34,uVar40 <= SUB164(auVar11 * auVar21, 8) );
      }

   }

   goto LAB_00101d60;
   while (auVar15._8_8_ = 0,auVar15._0_8_ = (ulong)uVar30 * lVar32,auVar25._8_8_ = 0,auVar25._0_8_ = uVar34,auVar16._8_8_ = 0,auVar16._0_8_ = ( ulong )(( uVar29 + uVar37 ) - SUB164(auVar15 * auVar25, 8)) * lVar32,auVar26._8_8_ = 0,auVar26._0_8_ = uVar34,uVar40 = uVar31,SUB164(auVar16 * auVar26, 8) != 0) {
      LAB_00102095:uVar31 = uVar29;
...
;
   LAB_001020d9:uVar34 = (ulong)uVar31;
   ...
   *(int*)( this + 0xa6c ) = *(int*)( this + 0xa6c ) + -1;
   LAB_00101d60:CowData<char32_t>::_unref(local_b0);
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* EditorMainScreen::add_main_plugin(EditorPlugin*) */void EditorMainScreen::add_main_plugin(EditorMainScreen *this, EditorPlugin *param_1) {
   undefined8 uVar1;
   code *pcVar2;
   Callable *pCVar3;
   char cVar4;
   ...
   if (local_b8 == (Callable*)0x0) {
      ...
      if (cVar4 != '\0') {
         ...
         if (local_98[0] == local_b8) {
            LAB_00102704:if (( ( pCVar7 != (Callable*)0x0 ) && ( cVar4 = RefCounted::unreference() ),pCVar3 = local_98[0],cVar4 != '\0' )) &&( cVar4 = cVar4 != '\0' )(**(code**)( *(long*)pCVar3 + 0x140 ))();
         ...
         if (pCVar3 != (Callable*)0x0) {
            LAB_001026e5:cVar4 = RefCounted::unreference();
            pCVar7 = local_98[0];
            if (( cVar4 != '\0' ) && ( cVar4 = predelete_handler((Object*)pCVar3) ),pCVar7 = local_98[0],cVar4 != '\0') {
...
else{LAB_00102317:Button::set_button_icon(this_00);pCVar3 = local_b8;this_01 = (CallableCustom*)operator_new(0x48, "");CallableCustom::CallableCustom(this_01);*(undefined1(*) [16])( this_01 + 0x30 ) = (undefined1[16])0x0;*(undefined8*)( this_01 + 0x40 ) = 0;uVar1 = *(undefined8*)( this_00 + 0x60 );*(undefined***)this_01 = &PTR_hash_001089b8;*(undefined8*)( this_01 + 0x30 ) = uVar1;*(undefined8*)( this_01 + 0x10 ) = 0;*(code**)( this_01 + 0x38 ) = Control::update_minimum_size;*(undefined**)( this_01 + 0x20 ) = &_LC13;*(Button**)( this_01 + 0x28 ) = this_00;CallableCustomMethodPointerBase::_setup((uint*)this_01, (int)this_01 + 0x28);*(char**)( this_01 + 0x20 ) = "Control::update_minimum_size";Callable::Callable((Callable*)local_98, this_01);Resource::connect_changed(pCVar3, (uint)(CowData<char32_t>*)local_98);Callable::~Callable((Callable*)local_98);}pcVar2 = *(code**)( *(long*)this_00 + 0x108 );create_custom_callable_function_pointer<EditorMainScreen,int>((EditorMainScreen*)local_a8, (char*)this, (_func_void_int*)"&EditorMainScreen::select");if (*(long*)( this + 0xa28 ) == 0) {
   lVar8 = 0;
}
 else {
   lVar8 = *(long*)( *(long*)( this + 0xa28 ) + -8 );
}
Variant::Variant((Variant*)local_78, lVar8);local_60 = 0;local_58 = (undefined1[16])0x0;local_88 = (Variant*)local_78;Callable::bindp((Variant**)local_98, (int)(EditorMainScreen*)local_a8);if (Variant::needs_deinit[(int)local_60] == '\0') {
...
( *pcVar2 )(this_00, SceneStringNames::singleton + 0x238, (CowData<char32_t>*)local_98, 0);Callable::~Callable((Callable*)local_98);Callable::~Callable((Callable*)local_a8);if (*(long*)( this + 0xa28 ) == 0) {
   lVar8 = 1;
}
 else {
   lVar8 = *(long*)( *(long*)( this + 0xa28 ) + -8 ) + 1;
}
iVar5 = CowData<Button*>::resize<false>((CowData<Button*>*)( this + 0xa28 ), lVar8);if (iVar5 == 0) {
   if (*(long*)( this + 0xa28 ) == 0) {
      lVar6 = -1;
      lVar8 = 0;
   }
   ...
   _err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar6, lVar8, "p_index", "size()", "", false, false);
}
 else {
   _err_print_error("push_back", "./core/templates/vector.h", 0x142, "Condition \"err\" is true. Returning: true", 0, 0);
}
LAB_0010250e:Node::add_child(*(undefined8*)( this + 0xa18 ), this_00, 0, 0);if (*(long*)( this + 0xa38 ) == 0) {
   lVar8 = 1;
}
 else {
   lVar8 = *(long*)( *(long*)( this + 0xa38 ) + -8 ) + 1;
}
iVar5 = CowData<EditorPlugin*>::resize<false>((CowData<EditorPlugin*>*)( this + 0xa38 ), lVar8);if (iVar5 == 0) {
   if (*(long*)( this + 0xa38 ) == 0) {
      lVar6 = -1;
      lVar8 = 0;
   }
...
LAB_0010258c:( **(code**)( *(long*)param_1 + 0x1e8 ) )((EditorMainScreen*)local_a8, param_1);HashMap<String,EditorPlugin*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,EditorPlugin*>>>::insert((String*)local_98, (EditorPlugin**)( this + 0xa40 ), SUB81((EditorMainScreen*)local_a8, 0));CowData<char32_t>::_unref((CowData<char32_t>*)local_a8);if (( ( local_b8 != (Callable*)0x0 ) && ( cVar4 = RefCounted::unreference() ),pCVar3 = local_b8,cVar4 != '\0' )) &&( cVar4 = cVar4 != '\0' )(**(code**)( *(long*)pCVar3 + 0x140 ))(pCVar3);Memory::free_static(pCVar3, false);}if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return;
}
...
/* CallableCustomMethodPointer<EditorMainScreen, void, int>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<EditorMainScreen,void,int>::~CallableCustomMethodPointer(CallableCustomMethodPointer<EditorMainScreen,void,int> *this) {
   return;
}
...
/* CallableCustomMethodPointer<EditorMainScreen, void, int>::get_argument_count(bool&) const */undefined8 CallableCustomMethodPointer<EditorMainScreen,void,int>::get_argument_count(CallableCustomMethodPointer<EditorMainScreen,void,int> *this, bool *param_1) {
   *param_1 = true;
   return 1;
}
...
/* EditorMainScreen::_property_get_revertv(StringName const&, Variant&) const */undefined8 EditorMainScreen::_property_get_revertv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
...
/* EditorMainScreen::_property_can_revertv(StringName const&) const */undefined8 EditorMainScreen::_property_can_revertv(StringName *param_1) {
   undefined8 uVar1;
...
/* CowData<Button*>::_copy_on_write() [clone .isra.0] [clone .cold] */void CowData<Button*>::_copy_on_write(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* CallableCustomMethodPointer<EditorMainScreen, void, int>::get_object() const */undefined8 CallableCustomMethodPointer<EditorMainScreen,void,int>::get_object(CallableCustomMethodPointer<EditorMainScreen,void,int> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   uVar2 = 0;
   LAB_00102e9d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
;
   ...
   uVar2 = 0;
   LAB_00102f9d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* EditorMainScreen::_validate_propertyv(PropertyInfo&) const */void EditorMainScreen::_validate_propertyv(PropertyInfo *param_1) {
...
/* VBoxContainer::is_class_ptr(void*) const */uint VBoxContainer::is_class_ptr(void *param_1) {
   ...
   if (in_RSI != &get_class_ptr_static()::ptr) {
      uVar1 = (uint)CONCAT71(0x108a, in_RSI == &Container::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x108a, in_RSI == &BoxContainer::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x108a, in_RSI == &Control::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x108a, in_RSI == &CanvasItem::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x108a, in_RSI == &Node::get_class_ptr_static(), ::ptr) | CONCAT31(( int3 )((uint)in_EDX >> 8), in_RSI == &Object::get_class_ptr_static(), ::ptr);
   }

   return uVar1;
}
/* EditorMainScreen::is_class_ptr(void*) const */uint EditorMainScreen::is_class_ptr(void *param_1) {
   uint uVar1;
   undefined4 in_EDX;
   undefined4 *in_RSI;
   uVar1 = 1;
   if (in_RSI != &get_class_ptr_static()::ptr) {
      uVar1 = (uint)CONCAT71(0x108a, in_RSI == &Container::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x108a, in_RSI == &PanelContainer::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x108a, in_RSI == &Control::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x108a, in_RSI == &CanvasItem::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x108a, in_RSI == &Node::get_class_ptr_static(), ::ptr) | CONCAT31(( int3 )((uint)in_EDX >> 8), in_RSI == &Object::get_class_ptr_static(), ::ptr);
   }
...
/* EditorMainScreen::_setv(StringName const&, Variant const&) */undefined8 EditorMainScreen::_setv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
   uVar1 = CanvasItem::_set(param_1, param_2);
   if ((char)uVar1 == '\0') {
      if ((code*)PTR__set_0010c020 != CanvasItem::_set) {
...
/* WARNING: Removing unreachable block (ram,0x00103338) *//* EditorMainScreen::_getv(StringName const&, Variant&) const */undefined8 EditorMainScreen::_getv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
...
/* WARNING: Removing unreachable block (ram,0x001033a8) *//* VBoxContainer::_getv(StringName const&, Variant&) const */undefined8 VBoxContainer::_getv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
   if (( (code*)PTR__get_0010c028 != CanvasItem::_get ) && ( uVar1 = Control::_get(param_1, param_2) ),(char)uVar1 != '\0') {
      return uVar1;
   }
...
/* VBoxContainer::_get_class_namev() const */undefined8 *VBoxContainer::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00103403:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00103403;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "VBoxContainer");
   LAB_0010346e:return &_get_class_namev();
}
/* EditorMainScreen::_get_class_namev() const */undefined8 *EditorMainScreen::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001034f3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001034f3;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorMainScreen");
         goto LAB_0010355e;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorMainScreen");
   LAB_0010355e:return &_get_class_namev();
}
/* VBoxContainer::~VBoxContainer() */void VBoxContainer::~VBoxContainer(VBoxContainer *this) {
   ...
   *(code**)this = Container::_notification;
   ...
   LAB_001035f0:Control::~Control((Control*)this);
   return;
}
/* VBoxContainer::~VBoxContainer() */void VBoxContainer::~VBoxContainer(VBoxContainer *this) {
   bool bVar1;
   ...
   *(code**)this = Container::_notification;
   ...
   LAB_00103650:Control::~Control((Control*)this);
...
/* EditorMainScreen::get_class() const */void EditorMainScreen::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* Callable create_custom_callable_function_pointer<EditorMainScreen, int>(EditorMainScreen*, char
   const*, void (EditorMainScreen::*)(int)) */EditorMainScreen *create_custom_callable_function_pointer<EditorMainScreen,int>(EditorMainScreen *param_1, char *param_2, _func_void_int *param_3) {
   undefined8 uVar1;
   CallableCustom *this;
   undefined8 in_RCX;
   undefined8 in_R8;
...
/* WARNING: Removing unreachable block (ram,0x00103cb0) *//* EditorMainScreen::_notificationv(int, bool) */void EditorMainScreen::_notificationv(EditorMainScreen *this, int param_1, bool param_2) {
   int iVar1;
   iVar1 = (int)this;
   if (param_2) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<String, EditorPlugin*, HashMapHasherDefault, HashMapComparatorDefault<String>,
   DefaultTypedAllocator<HashMapElement<String, EditorPlugin*> > >::insert(String const&,
   EditorPlugin* const&, bool) */String * HashMap<String,EditorPlugin*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,EditorPlugin*>>>
 ...
 while ( uVar35 != uVar28 );
      ...
      LAB_00103e6d:uVar34 = *(uint*)( param_2 + 5 );
      if (uVar34 == 0x1c) {
...
;
 ...
 while ( uVar27 != uVar28 );
      ...
      LAB_00103e38:iVar31 = *(int*)( (long)param_2 + 0x2c );
      if (iVar31 != 0) {
         LAB_00104278:uVar27 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( param_2 + 5 ) * 4 );
         ...
         if (uVar40 != 0) {
            do {
               if (uVar38 == uVar40) {
                  cVar26 = String::operator ==((String*)( *(long*)( param_2[1] + lVar33 * 8 ) + 0x10 ), pSVar32);
                  if (cVar26 != '\0') {
 ...
 while ( ( uVar40 != 0 ) && ( auVar12._8_8_ = 0 ),auVar12._0_8_ = (ulong)uVar40 * lVar1,auVar24._8_8_ = 0,auVar24._0_8_ = uVar28,auVar13._8_8_ = 0,auVar13._0_8_ = ( ulong )(( uVar27 + uVar39 ) - SUB164(auVar12 * auVar24, 8)) * lVar1,auVar25._8_8_ = 0,auVar25._0_8_ = uVar28,uVar43 <= SUB164(auVar13 * auVar25, 8) );
         }

         iVar31 = *(int*)( (long)param_2 + 0x2c );
      }

      LAB_00103e47:if ((float)uVar34 * __LC37 < (float)( iVar31 + 1 )) goto LAB_00103e6d;
   }
 ...
 while ( uVar38 != 0 );
   ...
   *(uint*)pEVar37 = uVar34;
   *(int*)( (long)param_2 + 0x2c ) = *(int*)( (long)param_2 + 0x2c ) + 1;
   LAB_00104227:*(EditorPlugin**)param_1 = pEStack_c0;
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
;
      ...
      *(undefined4*)( param_4 + 8 ) = 0;
      ...
      _err_print_error(&_LC45, "./core/object/callable_method_pointer.h", 0x67, "Parameter \"ObjectDB::get_instance(ObjectID(data.object_id))\" is null.", (String*)&local_48, 0, 0);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_48);
   ...
   LAB_001047c1:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* CallableCustomMethodPointer<EditorMainScreen, void, int>::call(Variant const**, int, Variant&,
   Callable::CallError&) const */void CallableCustomMethodPointer<EditorMainScreen,void,int>::call(CallableCustomMethodPointer<EditorMainScreen,void,int> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long lVar1;
   long lVar2;
   undefined8 uVar3;
   char cVar4;
...
;
      ...
      _err_print_error("get_instance", "./core/object/object.h", 0x418, "Condition \"slot >= slot_max\" is true. Returning: nullptr", 0, 0);
      LAB_00104988:local_40 = 0;
      String::parse_latin1((String*)&local_40, "\', can\'t call method.");
      uitos((ulong)local_50);
      operator+((char *)
      local_48,(String*)"Invalid Object id \'";
      String::operator +(local_38, (String*)local_48);
      _err_print_error(&_LC45, "./core/object/callable_method_pointer.h", 0x67, "Parameter \"ObjectDB::get_instance(ObjectID(data.object_id))\" is null.", local_38, 0, 0);
   ...
   LAB_00104a39:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* EditorMainScreen::~EditorMainScreen() */void EditorMainScreen::~EditorMainScreen(EditorMainScreen *this) {
   long *plVar1;
   uint uVar2;
 ...
 while ( lVar5 != (ulong)uVar2 << 2 );
   ...
   LAB_00104b03:if (*(long*)( this + 0xa38 ) != 0) {
      LOCK();
   ...
   *(code**)this = Container::_notification;
   ...
   LAB_00104b9e:Control::~Control((Control*)this);
   return;
}
/* CanvasItem::is_class(String const&) const */undefined8 CanvasItem::is_class(CanvasItem *this, String *param_1) {
 ...
 while ( !bVar9 );
      ...
      LAB_00104cff:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
 ...
 while ( !bVar9 );
            ...
            LAB_00104f13:cVar6 = String::operator ==(param_1, (String*)&local_60);
            lVar4 = local_60;
            if (local_60 != 0) {
               LOCK();
               plVar1 = (long*)( local_60 + -0x10 );
   ...
   LAB_00104fbc:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* Container::is_class(String const&) const */undefined8 Container::is_class(Container *this, String *param_1) {
 ...
 while ( !bVar9 );
      ...
      LAB_0010504f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar5 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   LAB_00105103:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0010520e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* VBoxContainer::is_class(String const&) const */undefined8 VBoxContainer::is_class(VBoxContainer *this, String *param_1) {
 ...
 while ( !bVar9 );
      ...
      LAB_0010528f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar5 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   LAB_00105343:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0010544e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* EditorMainScreen::is_class(String const&) const */undefined8 EditorMainScreen::is_class(EditorMainScreen *this, String *param_1) {
   long *plVar1;
   long lVar2;
   long lVar3;
   char *pcVar4;
 ...
 while ( !bVar9 );
      ...
      LAB_001054df:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar5 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   LAB_00105593:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0010569e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* EditorMainScreen::~EditorMainScreen() */void EditorMainScreen::~EditorMainScreen(EditorMainScreen *this) {
   long *plVar1;
   uint uVar2;
 ...
 while ( lVar5 != (ulong)uVar2 << 2 );
   ...
   LAB_00105773:if (*(long*)( this + 0xa38 ) != 0) {
      LOCK();
      plVar1 = (long*)( *(long*)( this + 0xa38 ) + -0x10 );
      *plVar1 = *plVar1 + -1;
      UNLOCK();
   ...
   *(code**)this = Container::_notification;
   ...
   LAB_0010580e:Control::~Control((Control*)this);
...
/* EditorMainScreen::_initialize_classv() */void EditorMainScreen::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_70;
   long local_68;
   long local_60;
...
/* Node::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Node::_get_property_listv(List *param_1, bool param_2) {
   ...
   LAB_0010668c:List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)CONCAT71(in_register_00000031, param_2), (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
   }
...
/* CanvasItem::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void CanvasItem::_get_property_listv(CanvasItem *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_001068f1:local_b0 = (CowData<char32_t>*)&local_58;
...
/* Control::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Control::_get_property_listv(Control *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00106bc1:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* Container::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Container::_get_property_listv(Container *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00106e91:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* PanelContainer::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void PanelContainer::_get_property_listv(PanelContainer *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00107141:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* EditorMainScreen::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void EditorMainScreen::_get_property_listv(EditorMainScreen *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   CowData<char32_t> *local_b0;
   long local_98;
   long local_90;
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_001073f1:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* BoxContainer::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void BoxContainer::_get_property_listv(BoxContainer *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_001076a1:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* VBoxContainer::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void VBoxContainer::_get_property_listv(VBoxContainer *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00107951:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* CowData<Button*>::_realloc(long) */undefined8 CowData<Button*>::_realloc(CowData<Button*> *this, long param_1) {
   undefined8 *puVar1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Button*>::resize<false>(long) */undefined8 CowData<Button*>::resize<false>(CowData<Button*> *this, long param_1) {
   long *plVar1;
   code *pcVar2;
   long lVar3;
   ulong uVar4;
   ...
   if (param_1 * 8 == 0) {
      LAB_00107dd0:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<EditorPlugin*>::resize<false>(long) */undefined8 CowData<EditorPlugin*>::resize<false>(CowData<EditorPlugin*> *this, long param_1) {
   ...
   if (param_1 * 8 == 0) {
      LAB_001080b0:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
/* WARNING: Control flow encountered bad instruction data *//* EditorMainScreen::~EditorMainScreen() */void EditorMainScreen::~EditorMainScreen(EditorMainScreen *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<EditorMainScreen, void, int>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<EditorMainScreen,void,int>::~CallableCustomMethodPointer(CallableCustomMethodPointer<EditorMainScreen,void,int> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

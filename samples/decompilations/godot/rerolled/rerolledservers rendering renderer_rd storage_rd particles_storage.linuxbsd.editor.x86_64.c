...
/* RendererRD::ParticlesStorage::particles_collision_get_extents(RID) const */undefined1  [16] __thiscallRendererRD::ParticlesStorage::particles_collision_get_extents(ParticlesStorage *this, ulong param_2) {
   long lVar1;
   long lVar2;
   long in_FS_OFFSET;
...
/* RendererRD::ParticlesStorage::_particles_allocate_emission_buffer(RendererRD::ParticlesStorage::Particles*)
   ...
   if ((long)sVar11 < 0) {
      ...
      if ((long)__n < (long)sVar11) {
         ...
         if (( pPVar1 != pPVar5 ) && ( iVar3 = iVar3 != 0 )) {

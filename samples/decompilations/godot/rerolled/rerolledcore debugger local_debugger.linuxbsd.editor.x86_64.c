/* LocalDebugger::send_message(String const&, Array const&) */void LocalDebugger::send_message(String *param_1, Array *param_2) {
   return;
}
...
/* LocalDebugger::send_error(String const&, String const&, int, String const&, String const&, bool,
   ErrorHandlerType) */void LocalDebugger::send_error(void) {
   long *plVar1;
   long lVar2;
   undefined *puVar3;
   long in_FS_OFFSET;
...
/* LocalDebugger::to_breakpoint(String const&) */String *LocalDebugger::to_breakpoint(String *param_1) {
   long *plVar1;
   long lVar2;
   long lVar3;
   int iVar4;
...
/* LocalDebugger::LocalDebugger() */void __thiscall LocalDebugger::LocalDebugger(LocalDebugger *this)
  ...
  if ((*(long **)param_1 != (long *)0x0) &&
    ...
    do {
      ...
      if ((*(long *)param_3 == 0) || (*(uint *)(*(long *)param_3 + -8) < 2)) {
        ...
        String::split((char *)&local_68,SUB81(&local_a0,0),0x1059de);
        lVar4 = local_60;
...
LAB_00104197:
    ...
    String::split((char *)&local_68,bVar26,0x1059e2);
    if (local_60 == 0) {
      lVar22 = 0;
LAB_00103e74:
...
LAB_001050c2:
      ...
      if (((int)(puVar7 + 0x28000) - (int)puVar5 & 8U) == 0) goto LAB_001050f0;
      *puVar5 = 0;
      for (puVar5 = puVar5 + 5; puVar5 != puVar7 + 0x28000; puVar5 = puVar5 + 10) {
LAB_001050f0:
        *puVar5 = 0;
        puVar5[5] = 0;
      }
...
LAB_00105125:
          ...
          if (lVar6 < 0x8000) {
            if (lVar9 != 0x200000) goto LAB_00105125;
LAB_001050a9:
...
code_r0x00106ef0:
        ...
        for (; uVar4 < *(ulong *)(lVar6 + -8); uVar4 = uVar4 + 1) {
          while ((StringName::configured != '\0' && (*(long *)(lVar6 + uVar4 * 0x28) != 0))) {
            ...
            lVar6 = *(long *)((long)param_1 + 0x18);
            uVar4 = uVar4 + 1;
            if (lVar6 == 0) goto code_r0x00106ef0;
...
LAB_001055e3:
          ...
          if (*(ulong *)(pPVar14 + 0x10) < uVar9) {
            ...
            while (param_1 != lVar13) {
              lVar13 = lVar13 + -1;
              pPVar14 = pPVar11;
              if (uVar9 <= *(ulong *)(pPVar11 + 0x10)) goto LAB_0010564d;
...
LAB_0010564d:
          if (lVar13 <= param_2) goto LAB_00105720;
...
LAB_00105720:
  ...
  if (lVar13 < 0x11) goto LAB_0010595e;
  local_d0 = param_2;
  if (param_4 == 0) goto LAB_001057ce;
  goto LAB_0010552d;
}
...
LAB_00106860:
    ...
    iVar42 = *(int *)(this + 0x2c);
    if (pvVar41 == (void *)0x0) goto LAB_00106320;
    if (*(int *)(this + 0x2c) != 0) goto LAB_00106860;
LAB_00106346:
    ...
    *(void **)(this + 8) = __s_00;
    ...
    iVar42 = 0;
LAB_00106320:
    if ((float)uVar45 * __LC11 < (float)(iVar42 + 1)) goto LAB_00106346;
  }
  local_58[0] = 0;
...
LAB_00106a25:
    ...
    *(undefined8 *)(local_a0[1] + 8) = 0;
    ...
    if (puVar40 != (undefined8 *)0x0) goto LAB_001065ea;
LAB_00106a41:
    ...
    *plVar1 = *plVar1 + -1;
    ...
    puVar40 = *(undefined8 **)(this + 0x20);
    lVar48 = local_70;
    if (puVar40 == (undefined8 *)0x0) goto LAB_00106a41;
LAB_001065ea:
    *puVar40 = local_a0;
...

{
  ...
  if (((ulong)(lVar10 - *(long *)(this + 8)) < 1000000) && (!param_1)) goto LAB_00107011;
  plVar9 = (long *)OS::get_singleton();
  ...
  if (0 < (int)ScriptServer::_language_count) {
    ...
    if (param_1) {
      while( true ) {
        ...
        if ((lVar20 <= lVar10) || (lVar10 < 0)) goto LAB_00107183;
        iVar16 = iVar16 + 1;
        ...
        iVar15 = iVar15 + iVar8;
        if ((int)ScriptServer::_language_count <= iVar16) goto LAB_001071c8;
        lVar10 = (long)iVar15;
      }
    }
    else {
      while( true ) {
        ...
        if (*(long *)(this + 0x18) == 0) break;
        lVar20 = *(long *)(*(long *)(this + 0x18) + -8);
        if ((lVar10 < 0) || (lVar20 <= lVar10)) goto LAB_00107183;
        iVar16 = iVar16 + 1;
        CowData<ScriptLanguage::ProfilingInfo>::_copy_on_write(this_00);
        iVar8 = (*pcVar2)(plVar9,*(long *)(this + 0x18) + (long)iVar15 * 0x28,(int)lVar20 - iVar15);
        iVar15 = iVar15 + iVar8;
...
LAB_00108582:
      ...
      if (lVar10 <= lVar20) goto LAB_001084be;

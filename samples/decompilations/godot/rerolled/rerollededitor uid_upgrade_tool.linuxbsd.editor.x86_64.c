...
void, UIDUpgradeTool::begin_upgrade(void){String *pSVar1;
  long in_FS_OFFSET;
  undefined8 local_68;
  undefined8 local_60;
  char *local_58;
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
    return;
  }/* WARNING: Subroutine does not return */__stack_chk_fail();} * this, String * param_1) * pcVar1 * plVar3 * local_38 * (long*)( in_FS_OFFSET + 0x28 ) == ( param_1,"uid_upgrade_learn_more" )(cVar2 != '\0') = (long*)OS::get_singleton() * (code**)( *plVar3 + 0x150 ) * ) & local_40);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* UIDUpgradeDialog::UIDUpgradeDialog() */void UIDUpgradeDialog::UIDUpgradeDialog(UIDUpgradeDialog *this) {
   Vector2 *pVVar1;
   undefined8 uVar2;
   long in_FS_OFFSET;
   undefined8 local_70;

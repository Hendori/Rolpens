/* PhysicsBody2D::get_gravity() const */undefined8 PhysicsBody2D::get_gravity(PhysicsBody2D *this) {
   long *plVar1;
   undefined8 uVar2;
   ...
   _err_print_error("get_gravity", "scene/2d/physics/physics_body_2d.cpp", 0x8e, "Parameter \"state\" is null.", 0, 0);
   return 0;
}
/* PhysicsBody2D::remove_collision_exception_with(Node*) */void PhysicsBody2D::remove_collision_exception_with(PhysicsBody2D *this, Node *param_1) {
   long lVar1;
   long *plVar2;
   if (param_1 == (Node*)0x0) {
      _err_print_error("remove_collision_exception_with", "scene/2d/physics/physics_body_2d.cpp", 0xa7, "Parameter \"p_node\" is null.", 0, 0);
      return;
   }
   ...
   if (lVar1 != 0) {
      ...
      /* WARNING: Treating indirect jump as call */
      ( **(code**)( *plVar2 + 0x468 ) )(plVar2, *(undefined8*)( this + 0x590 ), *(undefined8*)( lVar1 + 0x590 ));
      return;
   }

   _err_print_error("remove_collision_exception_with", "scene/2d/physics/physics_body_2d.cpp", 0xa9, "Parameter \"physics_body\" is null.", "Collision exception only works between two nodes that inherit from PhysicsBody2D.", 0, 0);
   return;
}
/* PhysicsBody2D::add_collision_exception_with(Node*) */void PhysicsBody2D::add_collision_exception_with(PhysicsBody2D *this, Node *param_1) {
   long lVar1;
   long *plVar2;
   if (param_1 == (Node*)0x0) {
      _err_print_error("add_collision_exception_with", "scene/2d/physics/physics_body_2d.cpp", 0xa0, "Parameter \"p_node\" is null.", 0, 0);
      return;
   }
   ...
   if (lVar1 != 0) {
      ...
      /* WARNING: Treating indirect jump as call */
      ( **(code**)( *plVar2 + 0x460 ) )(plVar2, *(undefined8*)( this + 0x590 ), *(undefined8*)( lVar1 + 0x590 ));
      return;
   }

   _err_print_error("add_collision_exception_with", "scene/2d/physics/physics_body_2d.cpp", 0xa2, "Parameter \"physics_body\" is null.", "Collision exception only works between two nodes that inherit from PhysicsBody2D.", 0, 0);
   return;
}
/* PhysicsBody2D::test_move(Transform2D const&, Vector2 const&, Ref<KinematicCollision2D> const&,
   float, bool) */uint PhysicsBody2D::test_move(PhysicsBody2D *this, Transform2D *param_1, Vector2 *param_2, Ref *param_3, float param_4, bool param_5) {
   undefined8 uVar1;
   long *plVar2;
   uint uVar3;
   undefined8 *puVar4;
   ...
   if (( (byte)this[0x2fa] >> 6 & 1 ) == 0) {
      _err_print_error("test_move", "scene/2d/physics/physics_body_2d.cpp", 0x7c, "Condition \"!is_inside_tree()\" is true. Returning: false", 0, 0);
   }
 else {
...
/* PhysicsBody2D::PhysicsBody2D(PhysicsServer2D::BodyMode) */void PhysicsBody2D::PhysicsBody2D(PhysicsBody2D *this, undefined4 param_2) {
   long *plVar1;
   undefined8 uVar2;
   plVar1 = (long*)PhysicsServer2D::get_singleton();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* PhysicsBody2D::move_and_collide(PhysicsServer2D::MotionParameters const&,
   PhysicsServer2D::MotionResult&, bool, bool) */undefined4 PhysicsBody2D::move_and_collide(PhysicsBody2D *this, MotionParameters *param_1, MotionResult *param_2, bool param_3, bool param_4) {
   long lVar1;
   char cVar2;
   undefined4 uVar3;
   long *plVar4;
   ...
   if (cVar2 != '\0') {
      _err_print_error("move_and_collide", "scene/2d/physics/physics_body_2d.cpp", 0x47, "Move functions do not work together with \'sync to physics\' option. See the documentation for details.", 0, 0);
   }

   plVar4 = (long*)PhysicsServer2D::get_singleton();
   uVar3 = ( **(code**)( *plVar4 + 0x4d0 ) )(plVar4, *(undefined8*)( this + 0x590 ), param_1, param_2);
   if (( param_4 ) && ( ( auVar9._0_4_ = (float)Vector2::length() ),fVar7 = _LC15,(char)uVar3 == '\0' || ( fVar7 = ( *(float*)( param_2 + 0x30 ) - *(float*)( param_2 + 0x2c ) ) * auVar9._0_4_ + _LC15 * (float*)( param_2 + 0x28 ) <= *(float*)( param_1 + 0x20 ) + fVar7 ) )) {
      local_60 = 0;
...
/* PhysicsBody2D::_move(Vector2 const&, bool, float, bool) */Vector2 *PhysicsBody2D::_move(Vector2 *param_1, bool param_2, float param_3, bool param_4) {
   undefined8 uVar1;
   char cVar2;
   int iVar3;
   RefCounted *this;
   ...
   uStack_d4 = 0;
   local_a8 = param_3;
   cVar2 = move_and_collide(this_00, (MotionParameters*)&local_c8, (MotionResult*)&local_118, in_CL, true);
   if (cVar2 != '\0') {
      if (( *(long*)( this_00 + 0x648 ) == 0 ) || ( iVar3 = 1 < iVar3 )) {
         ...
         *(undefined1(*) [16])( this + 0x1c0 ) = (undefined1[16])0x0;
         ...
         if (cVar2 == '\0') {
            ...
            if (this != (RefCounted*)pOVar6) {
               *(RefCounted**)( this_00 + 0x648 ) = this;
               ...
               if (( ( pOVar6 != (Object*)0x0 ) && ( cVar2 = RefCounted::unreference() ),cVar2 != '\0' )) {
                  LAB_00100b6a:( **(code**)( *(long*)pOVar6 + 0x140 ) )(pOVar6);
            ...
            LAB_0010090c:pOVar6 = *(Object**)( this_00 + 0x648 );
         }
   ...
   *(undefined8*)param_1 = 0;
   LAB_0010098d:uVar1 = local_78._0_8_;
...
/* PhysicsBody2D::get_collision_exceptions() */Array *PhysicsBody2D::get_collision_exceptions(void) {
   void *pvVar1;
   long lVar2;
   ulong uVar3;
   char cVar4;
...
;
            ...
            LAB_0010102d:pOVar6 = (Object*)0x0;
         }
 ...
 while ( (int)local_80[2] != 0 );
   ...
   LAB_00100fe0:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* PhysicsBody2D::_bind_methods() */void PhysicsBody2D::_bind_methods(void) {
   Variant *pVVar1;
   long lVar2;
   code *pcVar3;
   long *plVar4;
   ...
   pMVar5 = create_method_bind<PhysicsBody2D,Ref<KinematicCollision2D>,Vector2_const&,bool,float,bool>(_move);
 ...
 while ( lVar2 != lVar8 );
   ...
   pMVar5 = create_method_bind<PhysicsBody2D,bool,Transform2D_const&,Vector2_const&,Ref<KinematicCollision2D>const&,float,bool>(test_move);
...
/* RefCounted::is_class_ptr(void*) const */uint RefCounted::is_class_ptr(RefCounted *this, void *param_1) {
   return (uint)CONCAT71(0x10a1, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10a1, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr);
}
...
/* KinematicCollision2D::is_class_ptr(void*) const */uint KinematicCollision2D::is_class_ptr(KinematicCollision2D *this, void *param_1) {
   return (uint)CONCAT71(0x10a1, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10a1, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10a1, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
...
/* PhysicsBody2D::is_class_ptr(void*) const */uint PhysicsBody2D::is_class_ptr(void *param_1) {
   undefined4 in_EDX;
   undefined4 *in_RSI;
   return (uint)CONCAT71(0x10a1, in_RSI == &CollisionObject2D::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10a1, in_RSI == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10a1, in_RSI == &Node2D::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10a1, in_RSI == &CanvasItem::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10a1, in_RSI == &Node::get_class_ptr_static(), ::ptr) | CONCAT31(( int3 )((uint)in_EDX >> 8), in_RSI == &Object::get_class_ptr_static(), ::ptr);
}
...
/* MethodBindTR<TypedArray<PhysicsBody2D>>::_gen_argument_type(int) const */undefined8 MethodBindTR<TypedArray<PhysicsBody2D>>::_gen_argument_type(int param_1) {
   return 0x1c;
}
/* MethodBindTR<TypedArray<PhysicsBody2D>>::get_argument_meta(int) const */undefined8 MethodBindTR<TypedArray<PhysicsBody2D>>::get_argument_meta(int param_1) {
   return 0;
}
...
/* MethodBindTR<bool, Transform2D const&, Vector2 const&, Ref<KinematicCollision2D> const&, float,
   bool>::get_argument_meta(int) const */char MethodBindTR<bool,Transform2D_const&,Vector2_const&,Ref<KinematicCollision2D>const&,float,bool>::get_argument_meta(MethodBindTR<bool,Transform2D_const&,Vector2_const&,Ref<KinematicCollision2D>const&,float,bool> *this, int param_1) {
   return ( param_1 == 3 ) * '\t';
}
/* MethodBindTR<Ref<KinematicCollision2D>, Vector2 const&, bool, float,
   bool>::_gen_argument_type(int) const */char MethodBindTR<Ref<KinematicCollision2D>,Vector2_const&,bool,float,bool>::_gen_argument_type(MethodBindTR<Ref<KinematicCollision2D>,Vector2_const&,bool,float,bool> *this, int param_1) {
   char cVar1;
   cVar1 = '\x18';
...
/* MethodBindTR<Ref<KinematicCollision2D>, Vector2 const&, bool, float,
   bool>::get_argument_meta(int) const */char MethodBindTR<Ref<KinematicCollision2D>,Vector2_const&,bool,float,bool>::get_argument_meta(MethodBindTR<Ref<KinematicCollision2D>,Vector2_const&,bool,float,bool> *this, int param_1) {
   return ( param_1 == 2 ) * '\t';
}
/* MethodBindTR<bool, Transform2D const&, Vector2 const&, Ref<KinematicCollision2D> const&, float,
   bool>::_gen_argument_type(int) const */char MethodBindTR<bool,Transform2D_const&,Vector2_const&,Ref<KinematicCollision2D>const&,float,bool>::_gen_argument_type(MethodBindTR<bool,Transform2D_const&,Vector2_const&,Ref<KinematicCollision2D>const&,float,bool> *this, int param_1) {
   char cVar1;
   cVar1 = '\x01';
   if (( ( ( (uint)param_1 < 5 ) && ( cVar1 = '\v' ),param_1 != 0 ) ) && ( cVar1 = param_1 != 1 )) {
      return ( param_1 == 3 ) * '\x02' + '\x01';
   }

   return cVar1;
}
/* MethodBindTR<Ref<KinematicCollision2D>, Vector2 const&, bool, float, bool>::~MethodBindTR() */void MethodBindTR<Ref<KinematicCollision2D>,Vector2_const&,bool,float,bool>::~MethodBindTR(MethodBindTR<Ref<KinematicCollision2D>,Vector2_const&,bool,float,bool> *this) {
...
/* MethodBindTR<bool, Transform2D const&, Vector2 const&, Ref<KinematicCollision2D> const&, float,
   bool>::~MethodBindTR() */void MethodBindTR<bool,Transform2D_const&,Vector2_const&,Ref<KinematicCollision2D>const&,float,bool>::~MethodBindTR(MethodBindTR<bool,Transform2D_const&,Vector2_const&,Ref<KinematicCollision2D>const&,float,bool> *this) {
...
/* MethodBindTR<TypedArray<PhysicsBody2D>>::~MethodBindTR() */void MethodBindTR<TypedArray<PhysicsBody2D>>::~MethodBindTR(MethodBindTR<TypedArray<PhysicsBody2D>> *this) {
...
/* RefCounted::_get_class_namev() const */undefined8 *RefCounted::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00102733:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00102733;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "RefCounted");
   LAB_0010279e:return &_get_class_namev();
}
/* KinematicCollision2D::_get_class_namev() const */undefined8 *KinematicCollision2D::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00102823:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00102823;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "KinematicCollision2D");
   LAB_0010288e:return &_get_class_namev();
}
...
/* MethodBindTRC<Vector2>::_gen_argument_type_info(int) const */undefined4 *MethodBindTRC<Vector2>::_gen_argument_type_info(int param_1) {
   ...
   *(undefined1(*) [16])( puVar1 + 2 ) = (undefined1[16])0x0;
   ...
   LAB_00102f55:CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
...
/* MethodBindTR<TypedArray<PhysicsBody2D>>::_gen_argument_type_info(int) const */undefined4 *MethodBindTR<TypedArray<PhysicsBody2D>>::_gen_argument_type_info(int param_1) {
   undefined4 in_register_0000003c;
   undefined4 *puVar1;
   long in_FS_OFFSET;
   undefined8 local_60;
   ...
   *(undefined1(*) [16])( puVar1 + 2 ) = (undefined1[16])0x0;
   ...
   StringName::operator =((StringName*)( puVar1 + 4 ), (StringName*)&local_50);
   LAB_001030b5:CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
   if (( StringName::configured != '\0' ) && ( local_50 != 0 )) {
      StringName::unref();
   }
...
/* CanvasItem::is_class(String const&) const */undefined8 CanvasItem::is_class(CanvasItem *this, String *param_1) {
   ...
   LAB_0010323b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_00103418:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* PhysicsBody2D::is_class(String const&) const */undefined8 PhysicsBody2D::is_class(PhysicsBody2D *this, String *param_1) {
   ...
   LAB_001038db:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_00103a7e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* KinematicCollision2D::is_class(String const&) const */undefined8 KinematicCollision2D::is_class(KinematicCollision2D *this, String *param_1) {
   ...
   if (cVar4 == '\0') {
      ...
      LAB_00103f3b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* RefCounted::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void RefCounted::_get_property_listv(List *param_1, bool param_2) {
   ...
   LAB_001040ec:List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)CONCAT71(in_register_00000031, param_2), (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
...
/* Node::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Node::_get_property_listv(List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_0010433c:List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)CONCAT71(in_register_00000031, param_2), (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
   }
...
/* KinematicCollision2D::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void KinematicCollision2D::_get_property_listv(KinematicCollision2D *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_001045a1:local_b0 = (CowData<char32_t>*)&local_58;
...
/* CanvasItem::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void CanvasItem::_get_property_listv(CanvasItem *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00104851:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* Node2D::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Node2D::_get_property_listv(Node2D *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00104b21:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* CollisionObject2D::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void CollisionObject2D::_get_property_listv(CollisionObject2D *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00104dd1:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* PhysicsBody2D::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void PhysicsBody2D::_get_property_listv(PhysicsBody2D *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00105081:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* MethodBind* create_method_bind<PhysicsBody2D, Ref<KinematicCollision2D>, Vector2 const&, bool,
   float, bool>(Ref<KinematicCollision2D> (PhysicsBody2D::*)(Vector2 const&, bool, float, bool)) */MethodBind *create_method_bind<PhysicsBody2D,Ref<KinematicCollision2D>,Vector2_const&,bool,float,bool>(_func_Ref_Vector2_ptr_bool_float_bool *param_1) {
   MethodBind *this;
   undefined8 in_RSI;
   long in_FS_OFFSET;
   undefined8 local_40;
...
/* MethodBind* create_method_bind<PhysicsBody2D, bool, Transform2D const&, Vector2 const&,
   ...
   Vector2 const&, Ref<KinematicCollision2D> const&, float, bool)) */MethodBind *create_method_bind<PhysicsBody2D,bool,Transform2D_const&,Vector2_const&,Ref<KinematicCollision2D>const&,float,bool>(_func_bool_Transform2D_ptr_Vector2_ptr_Ref_ptr_float_bool *param_1) {
   MethodBind *this;
   undefined8 in_RSI;
   long in_FS_OFFSET;
   undefined8 local_40;
...
/* MethodBind* create_method_bind<PhysicsBody2D, Vector2>(Vector2 (PhysicsBody2D::*)() const) */MethodBind *create_method_bind<PhysicsBody2D,Vector2>(_func_Vector2 *param_1) {
   MethodBind *this;
   undefined8 in_RSI;
   long in_FS_OFFSET;
   undefined8 local_40;
...
/* MethodBind* create_method_bind<PhysicsBody2D,
   TypedArray<PhysicsBody2D>>(TypedArray<PhysicsBody2D> (PhysicsBody2D::*)()) */MethodBind *create_method_bind<PhysicsBody2D,TypedArray<PhysicsBody2D>>(_func_TypedArray *param_1) {
   MethodBind *this;
   undefined8 in_RSI;
   long in_FS_OFFSET;
   undefined8 local_40;
...
/* MethodBind* create_method_bind<PhysicsBody2D, Node*>(void (PhysicsBody2D::*)(Node*)) */MethodBind *create_method_bind<PhysicsBody2D,Node*>(_func_void_Node_ptr *param_1) {
   MethodBind *this;
   undefined8 in_RSI;
   long in_FS_OFFSET;
   undefined8 local_40;
...
/* PhysicsBody2D::_bind_methods() [clone .cold] */void PhysicsBody2D::_bind_methods(void) {
   code *pcVar1;
   /* WARNING: Does not return */
...
/* WARNING: Removing unreachable block (ram,0x00105d98) *//* String vformat<StringName>(String const&, StringName const) */undefined8 *vformat<StringName>(undefined8 *param_1, bool *param_2, StringName *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* MethodBindTR<TypedArray<PhysicsBody2D>>::call(Object*, Variant const**, int,
   Callable::CallError&) const */Object *MethodBindTR<TypedArray<PhysicsBody2D>>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   Variant *pVVar1;
   Variant *pVVar2;
   long *plVar3;
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (( ( plVar4 != (long*)0x0 ) && ( plVar4[1] != 0 ) ) && ( *(char*)( plVar4[1] + 0x2e ) != '\0' )) {
      ...
      if (local_58 == (char*)*plVar3) {
         ...
         _err_print_error(&_LC55, "./core/object/method_bind.h", 0x207, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: ret", (StringName*)&local_58, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
         if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
            StringName::unref();
   ...
   LAB_001060d0:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (( ( plVar4 != (long*)0x0 ) && ( plVar4[1] != 0 ) ) && ( *(char*)( plVar4[1] + 0x2e ) != '\0' )) {
      ...
      if (local_68 == (char*)*plVar3) {
         ...
         _err_print_error(&_LC55, "./core/object/method_bind.h", 0x267, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: ret", (StringName*)&local_68, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_70);
   ...
   LAB_00106370:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTRC<Vector2>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTRC<Vector2>::validated_call(MethodBindTRC<Vector2> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   *(undefined8*)( param_3 + 8 ) = uVar3;
   LAB_00106614:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<Vector2>::ptrcall(Object*, void const**, void*) const */void MethodBindTRC<Vector2>::ptrcall(MethodBindTRC<Vector2> *this, Object *param_1, void **param_2, void *param_3) {
   ...
   *(undefined8*)param_3 = uVar3;
   LAB_001067d3:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindT<Node*>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<Node*>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   LAB_00106b11:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<Node*>::ptrcall(Object*, void const**, void*) const */void MethodBindT<Node*>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   ...
   LAB_00106cf9:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindTR<TypedArray<PhysicsBody2D>>::validated_call(Object*, Variant const**, Variant*) const
    */void MethodBindTR<TypedArray<PhysicsBody2D>>::validated_call(MethodBindTR<TypedArray<PhysicsBody2D>> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   code *pcVar1;
   long *plVar2;
   ...
   LAB_00106d59:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTR<TypedArray<PhysicsBody2D>>::ptrcall(Object*, void const**, void*) const */void MethodBindTR<TypedArray<PhysicsBody2D>>::ptrcall(MethodBindTR<TypedArray<PhysicsBody2D>> *this, Object *param_1, void **param_2, void *param_3) {
   code *pcVar1;
   long *plVar2;
   void **extraout_RDX;
   long in_FS_OFFSET;
   ...
   Array::~Array((Array*)&local_48);
   LAB_00106f2a:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTR<bool, Transform2D const&, Vector2 const&, Ref<KinematicCollision2D> const&, float,
   bool>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTR<bool,Transform2D_const&,Vector2_const&,Ref<KinematicCollision2D>const&,float,bool>::validated_call(MethodBindTR<bool,Transform2D_const&,Vector2_const&,Ref<KinematicCollision2D>const&,float,bool> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   double dVar1;
   long lVar2;
   Object *pOVar3;
   char cVar4;
   ...
   if (pOVar6 != local_68) {
      if (pOVar6 == (Object*)0x0) {
         if (local_68 != (Object*)0x0) {
            local_68 = (Object*)0x0;
            LAB_00107189:cVar4 = RefCounted::unreference();
            if (cVar4 != '\0') {
   ...
   VVar5 = ( Variant )(*pcVar8)((float)dVar1, param_1 + lVar2, *(undefined8*)( *param_2 + 8 ), param_2[1] + 8, (StringName*)&local_68, VVar5);
   param_3[8] = VVar5;
   if (local_68 != (Object*)0x0) {
   ...
   LAB_001071e7:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTR<bool, Transform2D const&, Vector2 const&, Ref<KinematicCollision2D> const&, float,
   bool>::ptrcall(Object*, void const**, void*) const */void MethodBindTR<bool,Transform2D_const&,Vector2_const&,Ref<KinematicCollision2D>const&,float,bool>::ptrcall(MethodBindTR<bool,Transform2D_const&,Vector2_const&,Ref<KinematicCollision2D>const&,float,bool> *this, Object *param_1, void **param_2, void *param_3) {
   long lVar1;
   Object *pOVar2;
   char cVar3;
   undefined1 uVar4;
   ...
   if (( (long*)param_2[2] == (long*)0x0 ) || ( local_58 = *param_2[2] ),local_58 == (Object*)0x0) {
      LAB_00107499:local_58 = (Object*)0x0;
   }
 else {
   ...
   *(undefined1*)param_3 = uVar4;
   ...
   LAB_001074cd:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTR<Ref<KinematicCollision2D>, Vector2 const&, bool, float, bool>::ptrcall(Object*, void
   const**, void*) const */void MethodBindTR<Ref<KinematicCollision2D>,Vector2_const&,bool,float,bool>::ptrcall(MethodBindTR<Ref<KinematicCollision2D>,Vector2_const&,bool,float,bool> *this, Object *param_1, void **param_2, void *param_3) {
   char cVar1;
   code *pcVar2;
   Object *pOVar3;
   long *plVar4;
   ...
   /* WARNING: Load size is inaccurate */
   ( *pcVar2 )(auVar6._0_8_, (StringName*)&local_48, param_1 + *(long*)( this + 0x60 ), *param_2, *param_2[1] != '\0', *param_2[3] != '\0');
      ...
      *(Object**)param_3 = pOVar3;
      if (pOVar3 == (Object*)0x0) {
         ...
         if (pOVar5 != (Object*)0x0) {
            LAB_00107781:cVar1 = RefCounted::unreference();
            if (cVar1 != '\0') {
   ...
   LAB_0010773e:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindT<Node*>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindT<Node*>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   if (( ( plVar11 != (long*)0x0 ) && ( plVar11[1] != 0 ) ) && ( *(char*)( plVar11[1] + 0x2e ) != '\0' )) {
      ...
      if (local_58 == (char*)*plVar7) {
         ...
         String::parse_latin1((StrRange*)&local_60);
         vformat<StringName>((StringName*)&local_58, (StrRange*)&local_60, &local_68);
         _err_print_error(&_LC55, "./core/object/method_bind.h", 0x154, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: Variant()", (StringName*)&local_58, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
         if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
            StringName::unref();
   ...
   if (pVVar12 == (Variant*)0x0) {
      ...
      LAB_00107b80:pVVar12 = *(Variant**)param_4;
   }
 else {
      lVar9 = *(long*)( pVVar12 + -8 );
      if ((int)lVar9 < (int)( in_R8D ^ 1 )) {
         LAB_00107b90:uVar5 = 4;
         goto LAB_00107b35;
      }
   ...
   *in_R9 = 0;
   ...
   if (cVar4 == '\0') {
      ...
      *(undefined8*)( in_R9 + 1 ) = uVar3;
      ...
      if (( ( pOVar8 == (Object*)0x0 ) || ( lVar9 = __dynamic_cast(pOVar8, &Object::typeinfo, &Node::typeinfo, 0) ),lVar9 == 0 )) goto LAB_00107ae6;
   }
   ...
   LAB_00107b40:*(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
...
/* MethodBindTR<Ref<KinematicCollision2D>, Vector2 const&, bool, float, bool>::call(Object*, Variant
   const**, int, Callable::CallError&) const */Object *MethodBindTR<Ref<KinematicCollision2D>,Vector2_const&,bool,float,bool>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   Variant *pVVar1;
   Variant *pVVar2;
   code *pcVar3;
   undefined8 uVar4;
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (( ( plVar14 != (long*)0x0 ) && ( plVar14[1] != 0 ) ) && ( *(char*)( plVar14[1] + 0x2e ) != '\0' )) {
      ...
      if (local_a8 == (Object*)*plVar11) {
         ...
         _err_print_error(&_LC55, "./core/object/method_bind.h", 0x207, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: ret", (StringName*)&local_a8, 0, 0);
 ...
 while ( lVar10 != 4 );
   ...
   *in_R9 = uVar9;
   in_R9[2] = 4;
   LAB_00108030:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTR<bool, Transform2D const&, Vector2 const&, Ref<KinematicCollision2D> const&, float,
   bool>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindTR<bool,Transform2D_const&,Vector2_const&,Ref<KinematicCollision2D>const&,float,bool>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   Variant *pVVar1;
   Variant *pVVar2;
   code *pcVar3;
   undefined8 uVar4;
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (( ( plVar14 != (long*)0x0 ) && ( plVar14[1] != 0 ) ) && ( *(char*)( plVar14[1] + 0x2e ) != '\0' )) {
      ...
      if (local_c8 == (Object*)*plVar11) {
         ...
         _err_print_error(&_LC55, "./core/object/method_bind.h", 0x207, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: ret", (StringName*)&local_c8, 0, 0);
 ...
 while ( lVar9 != 5 );
         *in_R9 = 0;
         ...
         if (pOVar10 != local_c8) {
            if (pOVar10 == (Object*)0x0) {
               if (local_c8 != (Object*)0x0) {
                  local_c8 = (Object*)0x0;
                  LAB_00108416:cVar6 = RefCounted::unreference();
                  if (cVar6 != '\0') {
               ...
               pOVar10 = (Object*)__dynamic_cast(pOVar10, &Object::typeinfo, &KinematicCollision2D::typeinfo, 0);
               if (pOVar5 != pOVar10) {
                  local_c8 = pOVar10;
                  if (pOVar10 != (Object*)0x0) {
         ...
         bVar7 = (bool)( *(code*)pVVar17 )((Variant*)( (long)plVar14 + (long)pVVar1 ), local_88, &local_b0, &local_c8, bVar7);
   ...
   *in_R9 = uVar8;
   in_R9[2] = 5;
   LAB_00108562:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTR<Ref<KinematicCollision2D>, Vector2 const&, bool, float,
   bool>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTR<Ref<KinematicCollision2D>,Vector2_const&,bool,float,bool>::validated_call(MethodBindTR<Ref<KinematicCollision2D>,Vector2_const&,bool,float,bool> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   Object *pOVar1;
   char cVar2;
   code *pcVar3;
   long *plVar4;
   ...
   ( *pcVar3 )(auVar5._0_8_, &local_50, param_1 + *(long*)( this + 0x60 ), *param_2 + 8, param_2[1][8], param_2[3][8]);
   ...
   LAB_0010886b:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* void call_get_argument_type_info<Transform2D const&, Vector2 const&, Ref<KinematicCollision2D>
   const&, float, bool>(int, PropertyInfo&) */void call_get_argument_type_info<Transform2D_const&,Vector2_const&,Ref<KinematicCollision2D>const&,float,bool>(int param_1, PropertyInfo *param_2) {
   int iVar1;
   long lVar2;
   long in_FS_OFFSET;
   int local_94;
   ...
   if (param_1 == 0) {
      ...
      local_90 = 0;
      PropertyInfo::PropertyInfo((PropertyInfo*)local_78, 0xb, (CowData<char32_t>*)&local_90, 0, (String*)&local_88, 6, &local_80);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_90);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);
      if (( StringName::configured != '\0' ) && ( local_80 != 0 )) {
         StringName::unref();
   ...
   if (param_1 == local_94) {
      ...
      String::parse_latin1((String*)&local_88, "");
      local_90 = 0;
      PropertyInfo::PropertyInfo((PropertyInfo*)local_78, 1, (CowData<char32_t>*)&local_90, 0, (String*)&local_88, 6, &local_80);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_90);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);
      if (( StringName::configured != '\0' ) && ( local_80 != 0 )) {
         StringName::unref();
...
/* MethodBindTR<bool, Transform2D const&, Vector2 const&, Ref<KinematicCollision2D> const&, float,
   bool>::_gen_argument_type_info(int) const */undefined4 *MethodBindTR<bool,Transform2D_const&,Vector2_const&,Ref<KinematicCollision2D>const&,float,bool>::_gen_argument_type_info(int param_1) {
   ...
   if (in_EDX < 5) {
      ...
      call_get_argument_type_info<Transform2D_const&,Vector2_const&,Ref<KinematicCollision2D>const&,float,bool>(in_EDX, (PropertyInfo*)&local_68);
   ...
   *(undefined1(*) [16])( puVar5 + 2 ) = (undefined1[16])0x0;
   if (local_78 == 0) {
      puVar5[10] = 6;
      LAB_0010931f:StringName::operator =((StringName*)( puVar5 + 4 ), (StringName*)&local_70);
   }
 else {
   ...
   LAB_0010923c:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return puVar5;
   }
...
/* MethodBindTR<Ref<KinematicCollision2D>, Vector2 const&, bool, float,
   bool>::_gen_argument_type_info(int) const */undefined4 *MethodBindTR<Ref<KinematicCollision2D>,Vector2_const&,bool,float,bool>::_gen_argument_type_info(int param_1) {
   undefined1 auVar1[16];
   undefined8 uVar2;
   undefined8 uVar3;
   uint in_EDX;
   ...
   *(undefined1(*) [16])( puVar4 + 2 ) = (undefined1[16])0x0;
   if (local_78 == 0) {
      puVar4[10] = 6;
      LAB_00109707:StringName::StringName((StringName*)&local_68, (String*)( puVar4 + 8 ), false);
   ...
   LAB_00109608:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return puVar4;
   }
...
/* WARNING: Control flow encountered bad instruction data *//* MethodBindTR<TypedArray<PhysicsBody2D>>::~MethodBindTR() */void MethodBindTR<TypedArray<PhysicsBody2D>>::~MethodBindTR(MethodBindTR<TypedArray<PhysicsBody2D>> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* MethodBindTR<bool, Transform2D const&, Vector2 const&, Ref<KinematicCollision2D> const&, float,
   bool>::~MethodBindTR() */void MethodBindTR<bool,Transform2D_const&,Vector2_const&,Ref<KinematicCollision2D>const&,float,bool>::~MethodBindTR(MethodBindTR<bool,Transform2D_const&,Vector2_const&,Ref<KinematicCollision2D>const&,float,bool> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* MethodBindTR<Ref<KinematicCollision2D>, Vector2 const&, bool, float, bool>::~MethodBindTR() */void MethodBindTR<Ref<KinematicCollision2D>,Vector2_const&,bool,float,bool>::~MethodBindTR(MethodBindTR<Ref<KinematicCollision2D>,Vector2_const&,bool,float,bool> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

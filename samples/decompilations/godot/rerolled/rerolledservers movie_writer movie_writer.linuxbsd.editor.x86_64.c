...
/* MovieWriter::add_frame() */void MovieWriter::add_frame(MovieWriter *this) {
 ...
 while ( !bVar13 );
   ...
   *(float*)( this + 400 ) = (float)( (double)*(float*)( this + 400 ) + dVar14 );
   ...
   if (( local_58 != (Image*)0x0 ) && ( cVar6 = cVar6 != '\0' )) {
...
/* MovieWriter::write_frame(Ref<Image> const&, int const*) */ulong MovieWriter::write_frame(MovieWriter *this, Ref *param_1, int *param_2) {
   ...
   if (pcVar3 == (code*)0x0) {
      ...
      if (( local_150 != (Image*)0x0 ) && ( cVar1 = cVar1 != '\0' )) {
...
/* MovieWriter::_initialize_classv() */void MovieWriter::_initialize_classv(void) {
   ...
   LAB_0010ed15:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* WARNING: Control flow encountered bad instruction data *//* MethodBindTS<MovieWriter*>::~MethodBindTS() */void MethodBindTS<MovieWriter*>::~MethodBindTS(MethodBindTS<MovieWriter*> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

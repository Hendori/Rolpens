/* icu_76_godot::LocaleDistanceData::LocaleDistanceData(icu_76_godot::LocaleDistanceData&&) */void icu_76_godot::LocaleDistanceData::LocaleDistanceData(LocaleDistanceData *this, LocaleDistanceData *param_1) {
   undefined8 uVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   undefined8 uVar4;
...
/* icu_76_godot::LocaleDistanceData::~LocaleDistanceData() */void icu_76_godot::LocaleDistanceData::~LocaleDistanceData(LocaleDistanceData *this) {
   long lVar1;
   long lVar2;
   long lVar3;
   void *in_RSI;
...
/* icu_76_godot::LikelySubtags::LikelySubtags(icu_76_godot::LikelySubtagsData&) */void icu_76_godot::LikelySubtags::LikelySubtags(LikelySubtags *this, LikelySubtagsData *param_1) {
   undefined8 uVar1;
   long lVar2;
   undefined8 uVar3;
   undefined8 uVar4;
   ...
   *(ulong*)( this + 0x40 ) = ( ulong )(*(int*)( this + 0x38 ) + 2) << 0x3b | *(long*)( this + 0x30 ) - *(long*)( this + 0x28 );
   icu_76_godot::BytesTrie::next(iVar8);
   *(ulong*)( this + 0x48 ) = ( ulong )(*(int*)( this + 0x38 ) + 2) << 0x3b | *(long*)( this + 0x30 ) - *(long*)( this + 0x28 );
   icu_76_godot::BytesTrie::next(iVar8);
   uVar5 = icu_76_godot::BytesTrie::readValue(*(byte**)( this + 0x30 ) + 1, (int)( uint ) * *(byte**)( this + 0x30 ) >> 1);
   *(undefined4*)( this + 0x38 ) = 0xffffffff;
   ...
   *(undefined8*)( this + 0x30 ) = *(undefined8*)( this + 0x28 );
   do {
      ...
      if (iVar6 == 1) {
         *(ulong*)( this + lVar7 * 8 + -0x2b0 ) = ( ulong )(*(int*)( this + 0x38 ) + 2) << 0x3b | *(long*)( this + 0x30 ) - lVar2;
      }
...
/* icu_76_godot::LikelySubtags::~LikelySubtags() */void icu_76_godot::LikelySubtags::~LikelySubtags(LikelySubtags *this) {
   UMemory *this_00;
   long lVar1;
   long lVar2;
   long lVar3;
...
/* icu_76_godot::(anonymous namespace)::cleanup() */undefined8 icu_76_godot:: = (anonymous_namespace)::cleanup(void) {
   LikelySubtags *this;
   void *in_RSI;
   this =
   gLikelySubtags;
...
/* icu_76_godot::LikelySubtags::initLikelySubtags(UErrorCode&) */void icu_76_godot::LikelySubtags::initLikelySubtags(UErrorCode *param_1) {
   short sVar1;
   ushort uVar2;
   short *psVar3;
   UMemory *pUVar4;
   ...
   local_e4 = '\0';
   local_a0 = 0;
   uhash_init_76_godot(local_150, &uhash_hashUChars_76_godot, &uhash_compareUChars_76_godot, &uhash_compareLong_76_godot, param_1);
   if (*(int*)param_1 < 1) {
   ...
   for (int i = 0; i < 16; i++) {
      local_70[i] = (LocaleDistanceData)0;
   }
   ...
   if (*(int*)param_1 < 1) {
      ...
      if (pLVar6 == (LikelySubtags*)0x0) {
         ...
         if (*(int*)param_1 < 1) {
            LAB_001005e2 = (UVector*)icu_76_godot::UMemory::operator_new((UMemory*)0x28, (ulong)this_00);
            if (this == (UVector*)0x0) {
               if (*(int*)param_1 < 1) {
                  *(undefined4*)param_1 = 7;
               }

               LAB_00100695:(anonymous_namespace)::gMacroregions = (UVector*)0x0;
            ...
            icu_76_godot::UVector::UVector(this, (_func_void_void_ptr*)&uprv_deleteUObject_76_godot, (_func_signed_UElement_UElement*)&uhash_compareUnicodeString_76_godot, param_1);
            if (0 < *(int*)param_1) {
               LAB_0010068b:( **(code**)( *(long*)this + 8 ) )();
               goto LAB_00100695;
            }
...
;
               ...
               if (0 < *(int*)param_1) {
                  LAB_00100681:icu_76_godot::UnicodeString::~UnicodeString(&local_198);
                  goto LAB_0010068b;
               }
               ...
               if (iVar5 < 1) {
                  this_00 = (LikelySubtagsData*)icu_76_godot::UMemory::operator_new((UMemory*)0x40, (ulong)ppuVar14);
                  ...
                  LAB_0010085a:iVar5 = *(int*)param_1;
               }
 else {
                  uVar7 = local_18c;
                  ...
                  if (uVar7 <= iVar5 + 1U) {
                     ...
                     LAB_001007d9:do {
                        ...
                        this_00 = (LikelySubtagsData*)icu_76_godot::UMemory::operator_new((UMemory*)0x40, (ulong)this_00);
                        if (this_00 == (LikelySubtagsData*)0x0) {
                           if (*(int*)param_1 < 1) {
                              *(undefined4*)param_1 = 7;
                           }
...
;
 ...
 while ( (int)lVar10 < local_f8 );
      ...
      LAB_001006ce:*(undefined4*)param_1 = 7;
   }
...
/* icu_76_godot::LikelySubtags::getSingleton(UErrorCode&) */undefined8 icu_76_godot::LikelySubtags::getSingleton(UErrorCode *param_1) {
   char cVar1;
   if (0 < *(int*)param_1) {
      return 0;
   }

   if (( (anonymous_namespace)::gInitOnce != 2 ) && ( cVar1 = icu_76_godot::umtx_initImplPreInit((UInitOnce*)&(anonymous_namespace)::gInitOnce) ),cVar1 != '\0') {
...
/* icu_76_godot::LikelySubtags::isMacroregion(icu_76_godot::StringPiece&, UErrorCode&) const */byte icu_76_godot::LikelySubtags::isMacroregion(LikelySubtags *this, StringPiece *param_1, UErrorCode *param_2) {
   char cVar1;
   byte bVar2;
   byte extraout_var;
   long in_FS_OFFSET;
   ...
   if (*(int*)param_2 < 1) {
      if ((anonymous_namespace)::gInitOnce == 2) {
         LAB_00100ba0:if (0 < DAT_0010266c) {
      ...
      if (*(int*)param_2 < 1) {
         icu_76_godot::UnicodeString::fromUTF8(local_68, *(undefined8*)param_1, *(undefined8*)( param_1 + 8 ));
   ...
   LAB_00100b50:bVar2 = 0;
   LAB_00100b52:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return bVar2;
   }
...
/* icu_76_godot::LikelySubtags::trieNext(icu_76_godot::BytesTrie&, char const*, int) */undefined8 icu_76_godot::LikelySubtags::trieNext(BytesTrie *param_1, char *param_2, int param_3) {
   int iVar1;
   ulong uVar2;
   undefined8 uVar3;
   char *pcVar4;
   ...
   if (param_2[param_3] == '\0') {
      ...
      joined_r0x00100c7e:if (iVar1 == 2) {
         uVar3 = icu_76_godot::BytesTrie::readValue(*(byte**)( param_1 + 0x10 ) + 1, (int)( uint ) * *(byte**)( param_1 + 0x10 ) >> 1);
         return uVar3;
      }
...
/* icu_76_godot::LikelySubtags::getLikelyIndex(char const*, char const*) const */int icu_76_godot::LikelySubtags::getLikelyIndex(LikelySubtags *this, char *param_1, char *param_2) {
   long lVar1;
   long lVar2;
   int iVar3;
   int iVar4;
   ...
   if (iVar3 == 0) {
      ...
      if (( ( 0x19 < (int)*param_1 - 0x61U ) || ( param_1[1] == '\0' ) ) || ( uVar5 = *(ulong*)( this + (long)(int)( (int)*param_1 - 0x61U ) * 8 + 0x58 ) ),uVar5 == 0) goto LAB_00100d6b;
   ...
   if (iVar3 < 0) {
      ...
      LAB_00100dd5:local_50 = ( uint )(*(ulong*)( this + 0x48 ) >> 0x3b) - 2;
      ...
      LAB_00100e8f:if (0 < iVar3) goto LAB_00100da1;
   }
 else if (iVar3 != 1) goto LAB_00100da1;
   iVar3 = trieNext((BytesTrie*)&local_68, "", 0);
   LAB_00100da1:icu_76_godot::BytesTrie::~BytesTrie((BytesTrie*)&local_68);
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* icu_76_godot::LikelySubtags::compareLikely(icu_76_godot::LSR const&, icu_76_godot::LSR const&,
   int) const */uint icu_76_godot::LikelySubtags::compareLikely(LikelySubtags *this, LSR *param_1, LSR *param_2, int param_3) {
   char *__s1;
   int iVar1;
   int iVar2;
   uint uVar3;
...
/* icu_76_godot::LikelySubtags::trieNext(icu_76_godot::BytesTrie&, icu_76_godot::StringPiece, int)
    */undefined8 icu_76_godot::LikelySubtags::trieNext(LikelySubtags *this, long param_1, int param_3, int param_4) {
   int iVar1;
   ulong uVar2;
   undefined8 uVar3;
   long lVar4;
 ...
 while ( lVar4 != (long)param_4 + 2 + param_1 + ( ulong )(uint)(( param_3 + -2 ) - param_4) );
   ...
   uVar3 = icu_76_godot::BytesTrie::readValue(*(byte**)( this + 0x10 ) + 1, (int)( uint ) * *(byte**)( this + 0x10 ) >> 1);
   return uVar3;
}
/* icu_76_godot::LikelySubtags::maximize(icu_76_godot::StringPiece, icu_76_godot::StringPiece,
   icu_76_godot::StringPiece, bool, UErrorCode&) const */LSR *icu_76_godot::LikelySubtags::maximize(LSR *param_1, LikelySubtags *param_2, char *param_3, undefined8 param_4, char *param_5, undefined8 param_6, char *param_7, undefined8 param_8, undefined4 param_9, UErrorCode *param_10) {
   undefined8 uVar1;
   undefined4 uVar2;
   char *pcVar3;
   char *pcVar4;
   ...
   if (( (int)local_b0 == 0 ) || ( (int)param_8 == 0 )) {
      ...
      if (( 0x19 < (int)*local_a8 - 0x61U ) || ( ( (int)local_a0 < 2 || ( uVar12 = uVar12 == 0 ) ) )) goto LAB_00101331;
      ...
      if ((int)local_a0 != 0) {
         icu_76_godot::LSR::LSR(param_1, local_a8, local_a0, local_b8, local_b0, 7, param_7, CONCAT44(param_8._4_4_, (int)param_8), pUVar6);
         goto LAB_00101231;
      }
      ...
      local_58 = *(long*)( param_2 + 0x30 );
      local_50 = *(int*)( param_2 + 0x38 );
      LAB_00101331:local_68 = (char*)0x0;
   ...
   if (iVar9 < 0) {
      ...
      bVar5 = false;
      if (-1 < iVar10) {
         LAB_0010164b:uVar12 = ( ulong )(local_50 + 2) << 0x3b | local_58 - local_60;
         bVar7 = (int)local_b0 != 0;
         bVar5 = bVar17;
         goto LAB_00101672;
      }

      LAB_00101950:local_50 = ( uint )(*(ulong*)( param_2 + 0x48 ) >> 0x3b) - 2;
      ...
      bVar17 = true;
      if (iVar10 < 0) {
         LAB_00101939:lVar14 = (long)*(int*)( param_2 + 0x50 );
         bVar7 = false;
         bVar18 = true;
      }
 else {
         LAB_001016cd:if ((int)param_8 != 0) {
      ...
      if (iVar9 == 0) {
         ...
         bVar7 = true;
         LAB_00101672:bVar17 = bVar7;
         if (iVar10 < 1) goto LAB_00101680;
      }
 else {
         iVar10 = iVar9;
         if (iVar9 == 1) {
            LAB_00101680:iVar10 = trieNext((LikelySubtags*)&local_68, param_7, CONCAT44(param_8._4_4_, (int)param_8), 0);
   ...
   LAB_001013af:puVar15 = (undefined8*)( lVar14 * 0x30 + *(long*)( param_2 + 0x128 ) );
   if (( ( (char)uVar2 == '\0' ) || ( -1 < iVar9 ) ) || ( bVar5 )) {
      if ((int)local_a0 == 0) goto LAB_00101788;
      LAB_0010153c:if (bVar16) {
         if (bVar17 == false) {
      ...
      LAB_001015a9:icu_76_godot::LSR::LSR(param_1, local_a8, local_a0, local_b8, local_b0, cVar8, param_7, CONCAT44(param_8._4_4_, (int)param_8), pUVar6);
   }
 else {
      if (( bVar7 ) && ( (int)local_a0 == 0 )) {
         LAB_00101788:icu_76_godot::StringPiece::StringPiece((StringPiece*)&local_78, "und");
         local_a8 = local_78;
         local_a0 = CONCAT44(local_a0._4_4_, local_70);
         goto LAB_0010153c;
      }
      ...
      icu_76_godot::LSR::LSR(param_1, local_98, local_90, local_88, local_80, 7, local_78, CONCAT44(uStack_6c, local_70), pUVar6);
   }

   LAB_001015dd:icu_76_godot::BytesTrie::~BytesTrie((BytesTrie*)&local_68);
...
/* icu_76_godot::LikelySubtags::maximize(char const*, char const*, char const*, bool, UErrorCode&)
   const */char *icu_76_godot::LikelySubtags::maximize(char *param_1, char *param_2, char *param_3, bool param_4, UErrorCode *param_5) {
   long lVar1;
   size_t sVar2;
   size_t sVar3;
   size_t sVar4;
   ...
   if (*in_stack_00000008 < 1) {
      ...
      maximize(param_1, param_2, param_3, sVar4 & 0xffffffff, (char*)CONCAT71(in_register_00000009, param_4), sVar3 & 0xffffffff, param_5, sVar2 & 0xffffffff, in_R9B, in_stack_00000008);
   }
 else {
      for (int i = 0; i < 8; i++) {
         param_1[( i + 24 )] = '\0';
...
/* icu_76_godot::LikelySubtags::makeMaximizedLsr(char const*, char const*, char const*, char const*,
   bool, UErrorCode&) const */char *icu_76_godot::LikelySubtags::makeMaximizedLsr(char *param_1, char *param_2, char *param_3, char *param_4, bool param_5, UErrorCode *param_6) {
   UErrorCode UVar1;
   long lVar2;
   int iVar3;
   char *pcVar4;
      ...
      if (*pUVar6 == (UErrorCode)0x58) {
         ...
         if (( UVar1 != (UErrorCode)0x0 ) && ( pUVar6[2] == (UErrorCode)0x0 )) {
            if (UVar1 != (UErrorCode)0x42) {
               ...
               iVar3 = 7;
               LAB_00101f2b:icu_76_godot::LSR::LSR((LSR*)param_1, ',', param_3, param_4, (char*)pUVar6, iVar3, in_stack_00000010);
               goto LAB_00101ce6;
            }

            iVar3 = 7;
            LAB_00101eb3:icu_76_godot::LSR::LSR((LSR*)param_1, '+', param_3, param_4, (char*)pUVar6, iVar3, in_stack_00000010);
            goto LAB_00101ce6;
         }

         LAB_00101df0:if (( *param_6 == (UErrorCode)0x50 ) && ( param_6[1] == (UErrorCode)0x53 )) goto LAB_00101e05;
      }
         ...
         if (*pUVar6 == (UErrorCode)0x0) {
            ...
            if (iVar3 == 0) {
               ...
               LAB_00101dcf:icu_76_godot::LSR::LSR((LSR*)param_1, '\'', param_3, param_4, (char*)pUVar6, iVar3, in_stack_00000010);
               goto LAB_00101ce6;
            }
            ...
            LAB_00101e05:iVar3 = strcmp((char*)param_6, "PSACCENT");
            if (iVar3 == 0) {
               iVar3 = 7;
               goto LAB_00101dcf;
            }
   ...
   LAB_00101ce6:if (lVar2 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* icu_76_godot::LikelySubtags::makeMaximizedLsrFrom(icu_76_godot::Locale const&, bool, UErrorCode&)
   const */Locale *icu_76_godot::LikelySubtags::makeMaximizedLsrFrom(Locale *param_1, bool param_2, UErrorCode *param_3) {
   char *pcVar1;
   undefined4 uVar2;
      ...
      if (param_3[0xd8] == (UErrorCode)0x0) {
         ...
         if (( ( *pcVar1 == '@' ) && ( pcVar1[1] == 'x' ) ) && ( pcVar1[2] == '=' )) {
            ...
            *(undefined4*)( param_1 + 0x20 ) = uVar2;
            ...
            makeMaximizedLsr((char*)&local_78, (char*)CONCAT71(in_register_00000031, param_2), (char*)( param_3 + 8 ), (char*)( param_3 + 0x14 ), SUB81(param_3 + 0x1a, 0), (UErrorCode*)( (long)*(int*)( param_3 + 0x20 ) + *(long*)( param_3 + 0xd0 ) ));
            if (( ( *local_78 == '\0' ) && ( *local_70 == '\0' ) ) && ( *local_68 == '\0' )) {
               ...
               icu_76_godot::LSR::LSR((LSR*)param_1, local_a8, local_a0, local_98, local_90, 7, local_88, local_80);
            }
 else {
   ...
   *(undefined**)param_1 = &_LC15;
   *(undefined**)( param_1 + 8 ) = &_LC16;
   LAB_0010202a:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* icu_76_godot::LikelySubtags::minimizeSubtags(icu_76_godot::StringPiece,
   icu_76_godot::StringPiece, icu_76_godot::StringPiece, bool, UErrorCode&) const */LSR *icu_76_godot::LikelySubtags::minimizeSubtags(LSR *param_1, char *param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6, undefined8 param_7, undefined8 param_8, char param_9, int *param_10) {
   char cVar1;
   UErrorCode *pUVar2;
   long in_FS_OFFSET;
   int *piVar3;
   ...
   if (*param_10 < 1) {
      if (( ( *local_d8 == '\0' ) && ( *local_d0 == '\0' ) ) && ( *local_c8 == (UErrorCode)0x0 )) {
         icu_76_godot::LSR::LSR(param_1, param_3, param_4, param_5, param_6, 7, param_7, param_8, param_10, piVar3);
      }
 else {
         ...
         if (cVar1 == '\0') {
            if (param_9 == '\0') {
               ...
               LAB_00102642:icu_76_godot::StringPiece::StringPiece((StringPiece*)&local_78, (char*)local_c8);
               local_d0 = "";
               goto LAB_001025d8;
            }

            LAB_001024b1:maximize((char*)&local_78, param_2, local_d8, SUB81(local_d0, 0), (UErrorCode*)&_LC16);
            icu_76_godot::LSR::operator =(local_a8, (LSR*)&local_78);
            if (local_60 != 0) {
               icu_76_godot::LSR::deleteOwned();
            }
            ...
            LAB_00102343:*(undefined**)( param_1 + 0x10 ) = &_LC16;
            *(undefined8*)( param_1 + 0x18 ) = 0;
            *(undefined8*)( param_1 + 0x20 ) = 0;
            *(undefined4*)( param_1 + 0x28 ) = 0;
            *(undefined**)param_1 = &_LC15;
            *(undefined**)( param_1 + 8 ) = &_LC16;
            ...
            icu_76_godot::StringPiece::StringPiece((StringPiece*)&local_78, "");
            local_d0 = "";
            LAB_001025d8:icu_76_godot::StringPiece::StringPiece((StringPiece*)&local_e8, local_d0);
            icu_76_godot::StringPiece::StringPiece((StringPiece*)&local_f8, local_d8);
            icu_76_godot::LSR::LSR(param_1, local_f8, local_f0, local_e8, local_e0, 0, local_78, local_70, param_10);
         }
   ...
   LAB_00102210:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* icu_76_godot::UniqueCharStrings::addByValue(icu_76_godot::UnicodeString, UErrorCode&) */int icu_76_godot::UniqueCharStrings::addByValue(UniqueCharStrings *this, UnicodeString *param_2, int *param_3) {
   wchar16 *pwVar1;
   int iVar2;
   uint uVar3;
   ulong uVar4;
   ...
   if (this[0xb0] == (UniqueCharStrings)0x0) {
      ...
      if (iVar2 == *(int*)( this + 0x58 )) {
         if (iVar2 == 8) {
            ...
            if (lVar6 != 0) {
               iVar7 = 0x20;
               LAB_00102b5d:uVar4 = *(ulong*)( this + 0x60 );
            ...
            iVar7 = iVar2 * 2;
            if (( 0 < iVar7 ) && ( lVar6 = lVar6 != 0 )) {
               if (iVar2 != 0) goto LAB_00102b5d;
               LAB_00102b81:if (this[0x6c] != (UniqueCharStrings)0x0) {
         ...
         LAB_00102b97:this_00 = icu_76_godot::UMemory::operator_new((UMemory*)0x40, uVar4);
         if (this_00 != (void*)0x0) {
            ...
            *(void**)( *(long*)( this + 0x60 ) + (long)iVar2 * 8 ) = this_00;
            ...
            if (this[0xb0] == (UniqueCharStrings)0x0) {
               ...
               if (iVar2 == 0) {
                  ...
                  icu_76_godot::CharString::appendInvariantChars(pwVar1, (int)uVar5, (UErrorCode*)(ulong)uVar3);
      ...
      *param_3 = 7;
      ...
      LAB_00102ca0:*param_3 = 0x1e;
   }

   return -1;
}
/* icu_76_godot::LikelySubtagsData::readStrings(icu_76_godot::ResourceTable const&, char const*,
   icu_76_godot::ResourceValue&, icu_76_godot::LocalMemory<int>&, int&, UErrorCode&) */undefined8 icu_76_godot::LikelySubtagsData::readStrings(LikelySubtagsData *this, ResourceTable *param_1, char *param_2, ResourceValue *param_3, LocalMemory *param_4, int *param_5, UErrorCode *param_6) {
   wchar16 *pwVar1;
   char cVar2;
   int iVar3;
   int iVar4;
         ...
         *param_5 = local_48;
         ...
         if (( 0 < local_48 ) && ( lVar7 = lVar7 != 0 )) {
            ...
            *(long*)param_4 = lVar7;
            ...
            if (0 < iVar4) {
               do {
                  cVar2 = icu_76_godot::ResourceArray::getValue((int)local_58, (ResourceValue*)( uVar8 & 0xffffffff ));
                  if (cVar2 != '\0') {
                     local_5c = 0;
                     ...
                     if (*(int*)param_6 < 1) {
                        if (this[0xb8] == (LikelySubtagsData)0x0) {
                           ...
                           if (iVar4 == 0) {
                              icu_76_godot::CharString::append((char)*(undefined8*)( this + 0x58 ), (UErrorCode*)0x0);
                              pwVar1 = *(wchar16**)( this + 0x58 );
                              iVar4 = *(int*)( pwVar1 + 0x1c );
                              uVar5 = u_strlen_76_godot(uVar6);
                              icu_76_godot::CharString::appendInvariantChars(pwVar1, (int)uVar6, (UErrorCode*)(ulong)uVar5);
 ...
 while ( (int)uVar8 < *param_5 );
      ...
      LAB_00102ee0:uVar6 = 0;
   }

   LAB_00102d03:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* icu_76_godot::LikelySubtagsData::readLSREncodedStrings(icu_76_godot::ResourceTable const&, char
   ...
   icu_76_godot::LocalMemory<int>&, int&, UErrorCode&) */undefined8 icu_76_godot::LikelySubtagsData::readLSREncodedStrings(LikelySubtagsData *this, ResourceTable *param_1, char *param_2, ResourceValue *param_3, ResourceArray *param_4, LocalMemory *param_5, int *param_6, UErrorCode *param_7) {
   ...
   if (*(int*)param_7 < 1) {
      ...
      if (cVar2 != '\0') {
         ...
         if (*param_6 != 0) {
            iVar9 = *param_6 * 3;
            if (( iVar9 < 1 ) || ( puVar5 = (undefined4*)uprv_malloc_76_godot((long)iVar9 * 4) ),puVar5 == (undefined4*)0x0) {
            ...
            *(undefined4**)param_5 = puVar5;
            if (0 < iVar9) {
               ...
               do {
                  ...
                  if (uVar8 == 0) {
                     local_90 = L"";
                     LAB_001032d7:icu_76_godot::UnicodeString::UnicodeString(local_88, 1, &local_90, 0xffffffff);
                  }
 else {
                     if (uVar8 == 1) {
                        local_90 = L"skip";
                  ...
                  *puVar5 = uVar3;
                  ...
                  uVar8 = *(uint*)( lVar4 + lVar10 * 4 );
                  if (uVar8 == 0) {
                     LAB_001032a0:local_90 = L"";
                     LAB_001032a7:icu_76_godot::UnicodeString::UnicodeString(local_88, 1, &local_90, 0xffffffff);
                  }
 else {
                     if (uVar8 == 1) {
                        local_90 = L"script";
                  ...
                  if (( *(int*)param_7 < 1 ) && ( 1 < uVar8 )) {
                     ...
                     if (uVar8 < 0x1b) {
                        cVar2 = icu_76_godot::ResourceArray::getValue((int)param_4, (ResourceValue*)(ulong)uVar8);
                        if (cVar2 == '\0') {
                        ...
                        local_94 = 0;
                        local_90 = (wchar16*)( **(code**)( *(long*)param_3 + 0x20 ) )(param_3, &local_94, param_7);
...
/* icu_76_godot::LikelySubtagsData::load(UErrorCode&) */void icu_76_godot::LikelySubtagsData::load(LikelySubtagsData *this, UErrorCode *param_1) {
   ...
   *(undefined8*)this = uVar8;
   ...
   ures_getValueWithFallback_76_godot(*(undefined8*)this, "likely", local_c8, (ResourceValue*)&local_148, param_1);
   ...
   if (*(int*)param_1 < 1) {
      ...
      if (cVar7 == '\0') {
         *(undefined4*)param_1 = 2;
         ...
         cVar7 = readStrings(this, (ResourceTable*)local_128, "languageAliases", (ResourceValue*)&local_148, (LocalMemory*)&local_190, (int*)&local_1ac, param_1);
         if (cVar7 == '\0') {
            local_1f8 = 0;
            lVar18 = 0;
            lVar22 = local_190;
            ...
            cVar7 = readStrings(this, (ResourceTable*)local_128, "regionAliases", (ResourceValue*)&local_148, (LocalMemory*)&local_188, (int*)&local_1a8, param_1);
            lVar22 = local_190;
            if (cVar7 == '\0') {
               local_1f8 = local_188;
               lVar18 = 0;
               ...
               cVar7 = readLSREncodedStrings(this, (ResourceTable*)local_128, "lsrnum", (ResourceValue*)&local_148, (ResourceArray*)&local_168, (LocalMemory*)&local_180, &local_1a4, param_1);
               lVar18 = local_180;
               lVar21 = local_188;
               uVar6 = local_1a8;
               uVar5 = local_1ac;
               ...
               if (cVar7 != '\0') {
                  if (( ( ( local_1ac & 1 ) == 0 ) && ( ( local_1a8 & 1 ) == 0 ) ) && ( local_1a4 % 3 == 0 )) {
                     if (( local_1a4 == 0 ) || ( cVar7 = icu_76_godot::ResourceTable::findValue((char*)local_128, (ResourceValue*)&_LC9) ),cVar7 == '\0') {
                        *(undefined4*)param_1 = 2;
                     }
 else {
                        uVar8 = icu_76_godot::ResourceDataValue::getBinary((int*)&local_148, (UErrorCode*)&local_1a0);
                        iVar2 = *(int*)param_1;
                        *(undefined8*)( this + 0xd0 ) = uVar8;
                        if (iVar2 < 1) {
                           local_19c = 0;
                           ures_getValueWithFallback_76_godot(*(undefined8*)this, "match", local_c8, (ResourceValue*)&local_148, &local_19c);
                           local_178 = 0;
                           local_170 = 0;
                           local_198 = 0;
                           local_194 = 0;
                           if (local_19c < 1) {
                              ...
                              cVar7 = icu_76_godot::ResourceTable::findValue((char*)&local_f8, (ResourceValue*)&_LC9);
                              if (cVar7 != '\0') {
                                 uVar8 = icu_76_godot::ResourceDataValue::getBinary((int*)&local_148, (UErrorCode*)&local_1a0);
                                 iVar2 = *(int*)param_1;
                              ...
                              cVar7 = icu_76_godot::ResourceTable::findValue((char*)&local_f8, (ResourceValue*)"regionToPartitions");
                              if (cVar7 != '\0') {
                                 uVar8 = icu_76_godot::ResourceDataValue::getBinary((int*)&local_148, (UErrorCode*)&local_1a0);
                                 iVar2 = *(int*)param_1;
                                 *(undefined8*)( this + 0xf0 ) = uVar8;
                                 if (iVar2 < 1) {
                                    ...
                                    LAB_00103cd8:*(undefined4*)param_1 = 3;
                                 }

                                 goto LAB_001037f8;
                              }

                              LAB_00103bfc:cVar7 = readStrings(this, (ResourceTable*)&local_f8, "partitions", (ResourceValue*)&local_148, (LocalMemory*)&local_178, &local_198, param_1);
                              if (( cVar7 == '\0' ) || ( cVar7 = readLSREncodedStrings(this, (ResourceTable*)&local_f8, "paradigmnum", (ResourceValue*)&local_148, (ResourceArray*)&local_168, (LocalMemory*)&local_170, &local_194, param_1) ),cVar7 == '\0') goto LAB_001037f8;
                              if (local_194 % 3 != 0) goto LAB_00103cd8;
                              cVar7 = icu_76_godot::ResourceTable::findValue((char*)&local_f8, (ResourceValue*)"distances");
                              if (cVar7 != '\0') {
                                 uVar8 = icu_76_godot::ResourceDataValue::getIntVector((int*)&local_148, (UErrorCode*)&local_1a0);
                                 iVar2 = *(int*)param_1;
                              ...
                              LAB_00103843:this[0xb8] = (LikelySubtagsData)0x1;
                              uVar8 = uhash_openSize_76_godot(&uhash_hashChars_76_godot, &uhash_compareChars_76_godot, &uhash_compareChars_76_godot, (long)(int)uVar5 / 2 & 0xffffffff, param_1);
...
;
                              *(ulong**)( this + 0xd8 ) = puVar11 + 1;
                              for (lVar21 = 0; lVar19 = local_178,iVar2 = local_198,(int)lVar21 < local_1a4; lVar21 = lVar21 + 3) {
                                 ...
                                 icu_76_godot::LSR::operator =((LSR*)( lVar21 * 0x10 + *(long*)( this + 0xd8 ) ), (LSR*)&local_f8);
                                 if (local_e0 != 0) {
                                    icu_76_godot::LSR::deleteOwned();
                                 }
 ...
 while ( (int)lVar9 < iVar2 );
                                 ...
                                 LAB_00103ee5:*(undefined4*)param_1 = 7;
                                 goto LAB_001037f8;
                              }

                              LAB_00103d14:if (0 < local_194) {
                                 lVar21 = (long)( local_194 / 3 );
                                 *(int*)( this + 0x108 ) = local_194 / 3;
                                 plVar13 = (long*)icu_76_godot::UMemory::operator_new__((UMemory*)( lVar21 * 0x30 + 8 ), (ulong)pUVar17);
...
;
                              ...
                              *(int*)param_1 = local_19c;
                              LAB_001037f8:uprv_free_76_godot(local_170);
                              lVar19 = local_178;
                           }
   ...
   icu_76_godot::StackUResourceBundle::~StackUResourceBundle(local_c8);
   LAB_0010345e:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }

/* GodotSoftBody3D::_shapes_changed() */void GodotSoftBody3D::_shapes_changed(void) {
   return;
}
/* GodotSoftBodyShape3D::intersect_point(Vector3 const&) const */undefined8 GodotSoftBodyShape3D::intersect_point(Vector3 *param_1) {
   return 0;
}
/* GodotSoftBodyShape3D::get_closest_point_to(Vector3 const&) const */undefined1[16];GodotSoftBodyShape3D::get_closest_point_to(Vector3 *param_1) {
   long lVar1;
   long in_FS_OFFSET;
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
   _err_print_error("get_closest_point_to", "modules/godot_physics_3d/godot_soft_body_3d.cpp", 0x50d, "Method/function failed. Returning: Vector3()", "Get closest point is not supported for soft bodies.", 0, 0);
...
/* LocalVector<DynamicBVH::Node const*, unsigned int, false, false>::resize(unsigned int) [clone
   .part.0] */void LocalVector<DynamicBVH::Node_const*,unsigned_int,false,false>::resize(uint param_1) {
   code *pcVar1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotSoftBody3D::GodotSoftBody3D() */void GodotSoftBody3D::GodotSoftBody3D(GodotSoftBody3D *this) {
   undefined8 uVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   ...
   *(undefined***)this = &PTR__shape_changed_00109f50;
   uVar3 = _LC13;
...
/* GodotSoftBody3D::get_state(PhysicsServer3D::BodyState) const */Variant *GodotSoftBody3D::get_state(Variant *param_1, long param_2, undefined4 param_3) {
   undefined8 uVar1;
   char *pcVar2;
   long in_FS_OFFSET;
   undefined8 local_1c;
...
LAB_0010031c:
   ...
   _err_print_error("get_state", "modules/godot_physics_3d/godot_soft_body_3d.cpp", uVar1, "Method/function failed. Returning: Vector3()", pcVar2, 0, 0);
   local_1c = 0;
   local_14 = 0;
   Variant::Variant(param_1, (Vector3*)&local_1c);
   LAB_0010033b:if (local_10 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* GodotSoftBody3D::update_rendering_server(PhysicsServer3DRenderingServerHandler*) */void GodotSoftBody3D::update_rendering_server(GodotSoftBody3D *this, PhysicsServer3DRenderingServerHandler *param_1) {
   uint uVar1;
   uint uVar2;
   code *pcVar3;
   long lVar4;
      ...
      if (uVar1 != 0) {
         do {
            ...
            if (*(uint*)( this + 0xe0 ) <= uVar2) {
               _err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, (ulong)uVar2, ( ulong ) * (uint*)( this + 0xe0 ), "p_index", "count", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
 ...
 while ( (uint)uVar6 < *(uint*)( this + 0x210 ) );
      ...
      _err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, uVar6, uVar5, "p_index", "count", "", false, true);
      _err_flush_stdout();
      /* WARNING: Does not return */
      pcVar3 = (code*)invalidInstructionException();
      ( *pcVar3 )();
   ...
   LAB_00100560:/* WARNING: Could not recover jumptable at 0x00100582. Too many branches *//* WARNING: Treating indirect jump as call */( **(code**)( *(long*)param_1 + 0x160 ) )(param_1, this + 0x220);
   return;
}
/* GodotSoftBody3D::update_normals_and_centroids() */void GodotSoftBody3D::update_normals_and_centroids(GodotSoftBody3D *this) {
   float fVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   undefined8 uVar4;
   ...
   if (lVar15 == lVar14) {
      ...
      LAB_00100680:do {
         ...
         fVar24 = ( fVar24 - (float)*(undefined8*)( lVar10 + 0x14 ) ) * fVar26 - fVar16 * ( fVar24 - (float)*(undefined8*)( lVar6 + 0x14 ) );
         fVar25 = fVar28 * ( fVar25 - (float)( ( ulong ) * (undefined8*)( lVar6 + 0x10 ) >> 0x20 ) ) - ( fVar25 - (float)( ( ulong ) * (undefined8*)( lVar10 + 0x10 ) >> 0x20 ) ) * fVar22;
         fVar22 = fVar16 * fVar22 - fVar28 * fVar26;
         auVar27._8_4_ = ( fVar21 - (float)( ( ulong ) * (undefined8*)( lVar10 + 0x14 ) >> 0x20 ) ) * 0.0 - ( fVar21 - (float)( ( ulong ) * (undefined8*)( lVar6 + 0x14 ) >> 0x20 ) ) * 0.0;
         auVar27._0_8_ = CONCAT44(fVar25, fVar24);
         auVar27._12_4_ = ( fVar18 - (float)( ( ulong ) * (undefined8*)( lVar10 + 0xc ) >> 0x20 ) ) * 0.0 - ( fVar18 - (float)( ( ulong ) * (undefined8*)( lVar6 + 0xc ) >> 0x20 ) ) * 0.0;
         *(ulong*)( lVar9 + 0x48 ) = CONCAT44((float)( ( ulong ) * (undefined8*)( lVar9 + 0x48 ) >> 0x20 ) + fVar25, (float)*(undefined8*)( lVar9 + 0x48 ) + fVar24);
         *(float*)( lVar9 + 0x50 ) = *(float*)( lVar9 + 0x50 ) + fVar22;
         *(ulong*)( lVar10 + 0x48 ) = CONCAT44((float)( ( ulong ) * (undefined8*)( lVar10 + 0x48 ) >> 0x20 ) + fVar25, (float)*(undefined8*)( lVar10 + 0x48 ) + fVar24);
         *(float*)( lVar10 + 0x50 ) = *(float*)( lVar10 + 0x50 ) + fVar22;
         *(float*)( lVar6 + 0x50 ) = fVar22 + *(float*)( lVar6 + 0x50 );
         *(ulong*)( lVar6 + 0x48 ) = CONCAT44((float)( ( ulong ) * (undefined8*)( lVar6 + 0x48 ) >> 0x20 ) + fVar25, (float)*(undefined8*)( lVar6 + 0x48 ) + fVar24);
         ...
         *(float*)( puVar12 + 1 ) = ( *(float*)( lVar9 + 0x14 ) + *(float*)( lVar10 + 0x14 ) + *(float*)( lVar6 + 0x14 ) ) * fVar17;
         *puVar12 = CONCAT44(( (float)( (ulong)uVar3 >> 0x20 ) + (float)( (ulong)uVar2 >> 0x20 ) + (float)( (ulong)uVar4 >> 0x20 ) ) * fVar1, ( (float)uVar3 + (float)uVar2 + (float)uVar4 ) * fVar17);
         puVar12 = puVar11;
      }
 ...
 while ( lVar15 != lVar10 );
   ...
   do {
      ...
      fVar17 = SQRT(*(float*)( lVar14 + 0x48 ) * *(float*)( lVar14 + 0x48 ) + fVar17 * fVar17 + fVar1 * fVar1);
 ...
 while ( lVar15 != lVar14 );
   LAB_00100842:if (lVar5 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* GodotSoftBody3D::update_area() */void GodotSoftBody3D::update_area(void) {
   float fVar1;
   long lVar2;
   long lVar3;
   code *pcVar4;
   ...
   lVar11 = lVar14 + ( ulong ) * (uint*)( in_RDI + 0x100 ) * 0x48;
   lVar6 = lVar14;
   if (lVar14 == lVar11) {
      ...
      LAB_00100b50:uVar16 = 0;
      uVar5 = uVar12 - 1 | uVar12 - 1 >> 1;
      uVar5 = uVar5 | uVar5 >> 2;
      uVar5 = uVar5 >> 4 | uVar5;
      uVar5 = uVar5 >> 8 | uVar5;
      __s = (void*)Memory::realloc_static((void*)0x0, ( ulong )(( uVar5 | uVar5 >> 0x10 ) + 1) << 2, false);
      if (__s == (void*)0x0) {
         LocalVector<DynamicBVH::Node_const*,unsigned_int,false,false>::resize(uVar16);
         LAB_00100c3a:lVar14 = *(long*)( in_RDI + 0x108 );
         lVar11 = ( ulong ) * (uint*)( in_RDI + 0x100 ) * 0x48 + lVar14;
      }
 else {
         in_RCX = (int*)memset(__s, 0, (ulong)uVar12 << 2);
         in_R10 = *(long*)( in_RDI + 0xe8 );
         unaff_R12 = ( ulong ) * (uint*)( in_RDI + 0xe0 );
         lVar11 = unaff_R12 * 0x70 + in_R10;
         if (lVar11 == in_R10) goto LAB_00100c3a;
         lVar14 = in_R10;
         if (( (int)lVar11 - (int)in_R10 & 0x10U ) == 0) goto LAB_00100bf0;
         *(undefined4*)( in_R10 + 0x54 ) = 0;
         for (lVar14 = in_R10 + 0x70; lVar11 != lVar14; lVar14 = lVar14 + 0xe0) {
            LAB_00100bf0:*(undefined4*)( lVar14 + 0x54 ) = 0;
            *(undefined4*)( lVar14 + 0xc4 ) = 0;
         }
      ...
      if (lVar14 != lVar11) goto LAB_0010099a;
      if ((int)unaff_R12 < 1) goto LAB_00100a54;
      LAB_00100a01:pfVar15 = (float*)( in_R10 + 0x54 );
      uVar5 = 0;
      piVar10 = in_RCX;
      do {
         if (uVar5 == uVar12) {
         ...
         if (*piVar10 < 1) {
            ...
            *pfVar15 = 0.0;
            ...
            if (uVar16 <= uVar5) {
               LAB_00100b24:uVar8 = (ulong)uVar5;
               uVar13 = unaff_R12 & 0xffffffff;
               LAB_00100a88:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, uVar8, uVar13, "p_index", "count", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
 ...
 while ( lVar11 != lVar14 );
   ...
   LAB_00100a54:Memory::free_static(in_RCX, false);
   return;
}
/* GodotSoftBody3D::reset_link_rest_lengths() */void GodotSoftBody3D::reset_link_rest_lengths(GodotSoftBody3D *this) {
   long lVar1;
   long lVar2;
   long lVar3;
   long lVar4;
...
/* GodotSoftBody3D::update_link_constants() */void GodotSoftBody3D::update_link_constants(GodotSoftBody3D *this) {
   long lVar1;
   long lVar2;
   float fVar3;
   ...
   for (; lVar2 != lVar1; lVar1 = lVar1 + 0x30) {
      *(float*)( lVar1 + 0x24 ) = ( *(float*)( *(long*)( lVar1 + 0x10 ) + 0x58 ) + *(float*)( *(long*)( lVar1 + 0x18 ) + 0x58 ) ) * fVar3;
   }

   return;
}
/* GodotSoftBody3D::update_constants() */void GodotSoftBody3D::update_constants(GodotSoftBody3D *this) {
   reset_link_rest_lengths(this);
   update_link_constants(this);
   update_area();
   return;
}
/* GodotSoftBody3D::get_vertex_position(int) const */undefined1  [16] __thiscallGodotSoftBody3D::get_vertex_position(GodotSoftBody3D *this, int param_1) {
   uint uVar1;
   long lVar2;
   code *pcVar3;
   long lVar4;
   ...
   if (param_1 < 0) {
      ...
      LAB_00100df2:_err_print_error("get_vertex_position", "modules/godot_physics_3d/godot_soft_body_3d.cpp", uVar6, pcVar5, 0, 0);
   }
      ...
      if (param_1 < (int)uVar1) {
         ...
         uVar6 = 0x141;
         pcVar5 = "Condition \"p_index >= (int)map_visual_to_physics.size()\" is true. Returning: Vector3()";
      }
   ...
   local_1c = 0;
   local_14 = 0;
   LAB_00100e16:auVar7._8_4_ = local_14;
...
/* GodotSoftBody3D::set_vertex_position(int, Vector3 const&) */void GodotSoftBody3D::set_vertex_position(GodotSoftBody3D *this, int param_1, Vector3 *param_2) {
   uint uVar1;
   code *pcVar2;
   long lVar3;
   if (param_1 < 0) {
      _err_print_error("set_vertex_position", "modules/godot_physics_3d/godot_soft_body_3d.cpp", 0x149, "Condition \"p_index < 0\" is true.", 0, 0);
      return;
   }
   ...
   if (*(long*)( this + 0xd8 ) != 0) {
      ...
      if ((int)uVar1 <= param_1) {
         _err_print_error("set_vertex_position", "modules/godot_physics_3d/godot_soft_body_3d.cpp", 0x14f, "Condition \"p_index >= (int)map_visual_to_physics.size()\" is true.", 0, 0);
         return;
      }
      ...
      if (*(uint*)( this + 0xe0 ) <= uVar1) {
         _err_print_error("set_vertex_position", "modules/godot_physics_3d/godot_soft_body_3d.cpp", 0x152, "Condition \"node_index >= nodes.size()\" is true.", 0, 0);
         return;
      }
...
/* GodotSoftBody3D::pin_vertex(int) */void GodotSoftBody3D::pin_vertex(GodotSoftBody3D *this, int param_1) {
   uint uVar1;
   long lVar2;
   code *pcVar3;
   int *piVar4;
...
/* GodotSoftBody3D::unpin_vertex(int) */void GodotSoftBody3D::unpin_vertex(GodotSoftBody3D *this, int param_1) {
   long lVar1;
   code *pcVar2;
   ulong uVar3;
   undefined4 *puVar4;
   ...
   uint uVar6;
   if (param_1 < 0) {
      _err_print_error("unpin_vertex", "modules/godot_physics_3d/godot_soft_body_3d.cpp", 0x16c, "Condition \"p_index < 0\" is true.", 0, 0);
      return;
   }
 ...
 while ( uVar6 < *(uint*)( this + 600 ) );
            ...
            if ((int)uVar6 <= param_1) {
               _err_print_error("unpin_vertex", "modules/godot_physics_3d/godot_soft_body_3d.cpp", 0x174, "Condition \"p_index >= (int)map_visual_to_physics.size()\" is true.", 0, 0);
               return;
            }

            if (uVar6 <= (uint)param_1) {
               _err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, (long)param_1, (ulong)uVar6, "p_index", "count", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
               pcVar2 = (code*)invalidInstructionException();
               ( *pcVar2 )();
            ...
            if (*(uint*)( this + 0xe0 ) <= uVar6) {
               _err_print_error("unpin_vertex", "modules/godot_physics_3d/godot_soft_body_3d.cpp", 0x177, "Condition \"node_index >= nodes.size()\" is true.", 0, 0);
               return;
            }

            *(float*)( (ulong)uVar6 * 0x70 + *(long*)( this + 0xe8 ) + 0x58 ) = (float)*(uint*)( this + 0xe0 ) * *(float*)( this + 0x240 );
            return;
         }
...
/* GodotSoftBody3D::unpin_all_vertices() */void GodotSoftBody3D::unpin_all_vertices(GodotSoftBody3D *this) {
   float fVar1;
   uint uVar2;
   uint uVar3;
   uint uVar4;
   ...
   if (*(long*)( this + 0xd8 ) != 0) {
      ...
      do {
         if ((uint)uVar10 <= (uint)uVar9) {
            LAB_0010146e:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, uVar9, uVar10, "p_index", "count", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
         ...
         if ((int)uVar4 < (int)uVar5) {
            ...
            *(float*)( (ulong)uVar4 * 0x70 + *(long*)( this + 0xe8 ) + 0x58 ) = (float)uVar3 * fVar1;
            ...
            pcVar7 = "Condition \"pinned_vertex >= (int)map_visual_to_physics.size()\" is true. Continuing.";
            uVar8 = 0x18a;
            LAB_001014b0:_err_print_error("unpin_all_vertices", "modules/godot_physics_3d/godot_soft_body_3d.cpp", uVar8, pcVar7, 0, 0);
...
/* GodotSoftBody3D::is_vertex_pinned(int) const */undefined8 GodotSoftBody3D::is_vertex_pinned(GodotSoftBody3D *this, int param_1) {
   int *piVar1;
   int *piVar2;
   if (param_1 < 0) {
      _err_print_error("is_vertex_pinned", "modules/godot_physics_3d/godot_soft_body_3d.cpp", 0x197, "Condition \"p_index < 0\" is true. Returning: false", 0, 0);
      return 0;
   }
...
/* GodotSoftBody3D::get_node_count() const */undefined4 GodotSoftBody3D::get_node_count(GodotSoftBody3D *this) {
   return *(undefined4*)( this + 0xe0 );
}
/* GodotSoftBody3D::get_node_inv_mass(unsigned int) const */undefined4 GodotSoftBody3D::get_node_inv_mass(GodotSoftBody3D *this, uint param_1) {
   if (param_1 < *(uint*)( this + 0xe0 )) {
      return *(undefined4*)( (ulong)param_1 * 0x70 + *(long*)( this + 0xe8 ) + 0x58 );
   }

   _err_print_index_error("get_node_inv_mass", "modules/godot_physics_3d/godot_soft_body_3d.cpp", 0x1a8, (ulong)param_1, ( ulong ) * (uint*)( this + 0xe0 ), "p_node_index", "nodes.size()", "", false, false);
   return 0;
}
/* GodotSoftBody3D::get_node_position(unsigned int) const */undefined1  [16] __thiscallGodotSoftBody3D::get_node_position(GodotSoftBody3D *this, uint param_1) {
   long lVar1;
   long lVar2;
   long in_FS_OFFSET;
   ...
   if (param_1 < *(uint*)( this + 0xe0 )) {
      ...
      _err_print_index_error("get_node_position", "modules/godot_physics_3d/godot_soft_body_3d.cpp", 0x1ad, (ulong)param_1, ( ulong ) * (uint*)( this + 0xe0 ), "p_node_index", "nodes.size()", "", false, false);
      local_14 = 0;
      local_1c = 0;
   }
...
/* GodotSoftBody3D::get_node_velocity(unsigned int) const */undefined1  [16] __thiscallGodotSoftBody3D::get_node_velocity(GodotSoftBody3D *this, uint param_1) {
   long lVar1;
   long lVar2;
   long in_FS_OFFSET;
   undefined1 auVar3[16];
   ...
   if (param_1 < *(uint*)( this + 0xe0 )) {
      ...
      _err_print_index_error("get_node_velocity", "modules/godot_physics_3d/godot_soft_body_3d.cpp", 0x1b2, (ulong)param_1, ( ulong ) * (uint*)( this + 0xe0 ), "p_node_index", "nodes.size()", "", false, false);
      local_14 = 0;
      local_1c = 0;
   }
...
/* GodotSoftBody3D::get_node_biased_velocity(unsigned int) const */undefined1  [16] __thiscallGodotSoftBody3D::get_node_biased_velocity(GodotSoftBody3D *this, uint param_1) {
   long lVar1;
   long lVar2;
   long in_FS_OFFSET;
   undefined1 auVar3[16];
   ...
   if (param_1 < *(uint*)( this + 0xe0 )) {
      ...
      _err_print_index_error("get_node_biased_velocity", "modules/godot_physics_3d/godot_soft_body_3d.cpp", 0x1b7, (ulong)param_1, ( ulong ) * (uint*)( this + 0xe0 ), "p_node_index", "nodes.size()", "", false, false);
      local_14 = 0;
      local_1c = 0;
   }
...
/* GodotSoftBody3D::apply_node_impulse(unsigned int, Vector3 const&) */void GodotSoftBody3D::apply_node_impulse(GodotSoftBody3D *this, uint param_1, Vector3 *param_2) {
   float fVar1;
   undefined8 uVar2;
   long lVar3;
   if (param_1 < *(uint*)( this + 0xe0 )) {
      ...
      *(ulong*)( lVar3 + 0x30 ) = CONCAT44((float)( ( ulong ) * (undefined8*)( lVar3 + 0x30 ) >> 0x20 ) + (float)( (ulong)uVar2 >> 0x20 ) * fVar1, (float)*(undefined8*)( lVar3 + 0x30 ) + (float)uVar2 * fVar1);
      return;
   }

   _err_print_index_error("apply_node_impulse", "modules/godot_physics_3d/godot_soft_body_3d.cpp", 0x1bc, (ulong)param_1, ( ulong ) * (uint*)( this + 0xe0 ), "p_node_index", "nodes.size()", "", false, false);
   return;
}
/* GodotSoftBody3D::apply_node_bias_impulse(unsigned int, Vector3 const&) */void GodotSoftBody3D::apply_node_bias_impulse(GodotSoftBody3D *this, uint param_1, Vector3 *param_2) {
   undefined8 uVar1;
   long lVar2;
   float fVar3;
   if (param_1 < *(uint*)( this + 0xe0 )) {
      ...
      *(float*)( lVar2 + 0x44 ) = *(float*)( lVar2 + 0x58 ) * *(float*)( param_2 + 8 ) + *(float*)( lVar2 + 0x44 );
      *(ulong*)( lVar2 + 0x3c ) = CONCAT44(fVar3 * (float)( (ulong)uVar1 >> 0x20 ) + (float)( ( ulong ) * (undefined8*)( lVar2 + 0x3c ) >> 0x20 ), fVar3 * (float)uVar1 + (float)*(undefined8*)( lVar2 + 0x3c ));
      return;
   }

   _err_print_index_error("apply_node_bias_impulse", "modules/godot_physics_3d/godot_soft_body_3d.cpp", 0x1c2, (ulong)param_1, ( ulong ) * (uint*)( this + 0xe0 ), "p_node_index", "nodes.size()", "", false, false);
   return;
}
/* GodotSoftBody3D::get_face_count() const */undefined4 GodotSoftBody3D::get_face_count(GodotSoftBody3D *this) {
   return *(undefined4*)( this + 0x100 );
}
/* GodotSoftBody3D::get_face_points(unsigned int, Vector3&, Vector3&, Vector3&) const */void GodotSoftBody3D::get_face_points(GodotSoftBody3D *this, uint param_1, Vector3 *param_2, Vector3 *param_3, Vector3 *param_4) {
   long lVar1;
   long lVar2;
   ...
   _err_print_index_error("get_face_points", "modules/godot_physics_3d/godot_soft_body_3d.cpp", 0x1cc, (ulong)param_1, ( ulong ) * (uint*)( this + 0x100 ), "p_face_index", "faces.size()", "", false, false);
   return;
}
/* GodotSoftBody3D::get_face_normal(unsigned int) const */undefined1  [16] __thiscallGodotSoftBody3D::get_face_normal(GodotSoftBody3D *this, uint param_1) {
   long lVar1;
   long lVar2;
   long in_FS_OFFSET;
   undefined1 auVar3[16];
   ...
   if (param_1 < *(uint*)( this + 0x100 )) {
      ...
      _err_print_index_error("get_face_normal", "modules/godot_physics_3d/godot_soft_body_3d.cpp", 0x1d4, (ulong)param_1, ( ulong ) * (uint*)( this + 0x100 ), "p_face_index", "faces.size()", "", false, false);
      local_14 = 0;
      local_1c = 0;
   }
...
/* GodotSoftBody3D::reoptimize_link_order() */void GodotSoftBody3D::reoptimize_link_order(GodotSoftBody3D *this) {
   long *plVar1;
   code *pcVar2;
   undefined8 uVar3;
   ulong uVar4;
   ...
   if (uVar17 == 0) {
      LAB_001021f8:local_68 = (void*)0x0;
   }
 else {
 ...
 while ( uVar17 < uVar4 );
   ...
   if (*(int*)( this + 0xf0 ) != 0) {
      ...
      do {
         ...
         uVar13 = (uint)lVar14;
         if (uVar15 <= uVar13) goto LAB_00101f38;
         puVar9 = *(undefined8**)( this + 0xf8 );
         iVar5 = (int)( puVar9[lVar14 * 6 + 3] - lVar18 >> 4 ) * -0x49249249;
         puVar23 = (uint*)( (long)__s + (long)( (int)( puVar9[lVar14 * 6 + 2] - lVar18 >> 4 ) * -0x49249249 ) * 4 );
         if ((int)*puVar23 < 0) {
            *(undefined4*)( (long)pvVar6 + lVar14 * 4 ) = 0xffffffff;
            puVar10 = (uint*)( (long)__s + (long)iVar5 * 4 );
            uVar15 = *puVar10;
            iVar20 = iVar16;
            if ((int)uVar15 < 0) goto LAB_00101ec4;
            LAB_00101dfd:*(uint*)( (long)pvVar7 + lVar14 * 4 ) = uVar15;
            iVar16 = iVar20 + 1;
            ...
            *puVar11 = puVar22;
            uVar15 = *puVar10;
            if (-1 < (int)uVar15) goto LAB_00101dfd;
            LAB_00101ec4:*(undefined4*)( (long)pvVar7 + lVar14 * 4 ) = 0xffffffff;
            iVar5 = *(int*)( (long)pvVar6 + lVar14 * 4 );
            iVar16 = iVar20;
            joined_r0x00101ed6:if (iVar5 == -1) {
 ...
 while ( (uint)lVar14 < uVar24 );
      if (iVar21 != 0) {
         ...
         do {
            ...
            if (uVar15 <= (uint)lVar14) goto LAB_00101f38;
            uVar3 = puVar11[1];
            ...
            *puVar9 = *puVar11;
            ...
            for (; puVar23 != (uint*)0x0; puVar23 = *(uint**)( puVar23 + 2 )) {
               while (true) {
                  ...
                  *piVar12 = -2;
                  *piVar19 = -2;
                  if (puVar23 == (uint*)0x0) goto LAB_00102060;
               }
;
            }

            LAB_00102060:lVar14 = lVar14 + 1;
            puVar9 = puVar9 + 6;
         }
 while ( iVar21 != (int)lVar14 );
   ...
   uVar17 = 0;
   lVar14 = 0;
   LAB_00101f53:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, lVar14, uVar17, "p_index", "count", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar2 = (code*)invalidInstructionException();
   ( *pcVar2 )();
   LAB_00101f38:uVar17 = (ulong)uVar15;
   goto LAB_00101f53;
}
/* GodotSoftBody3D::append_link(unsigned int, unsigned int) */void GodotSoftBody3D::append_link(GodotSoftBody3D *this, uint param_1, uint param_2) {
   uint uVar1;
   long lVar2;
   code *pcVar3;
   long lVar4;
   ...
   lVar2 = *(long*)( in_FS_OFFSET + 0x28 );
   if (param_1 == param_2) {
      LAB_001023c2:if (lVar2 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
...
/* GodotSoftBody3D::append_face(unsigned int, unsigned int, unsigned int) */void GodotSoftBody3D::append_face(GodotSoftBody3D *this, uint param_1, uint param_2, uint param_3) {
   undefined8 *puVar1;
   uint uVar2;
   long lVar3;
   long lVar4;
   ...
   if (( param_1 != param_3 && param_1 != param_2 ) && ( param_2 != param_3 )) {
      ...
      _err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, uVar8, (ulong)uVar2, "p_index", "count", "", false, true);
      _err_flush_stdout();
      /* WARNING: Does not return */
      pcVar5 = (code*)invalidInstructionException();
      ( *pcVar5 )();
   ...
   LAB_00102628:if (lVar3 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* GodotSoftBody3D::set_iteration_count(int) */void GodotSoftBody3D::set_iteration_count(GodotSoftBody3D *this, int param_1) {
   *(int*)( this + 0x244 ) = param_1;
   return;
}
/* GodotSoftBody3D::set_total_mass(float) */void GodotSoftBody3D::set_total_mass(GodotSoftBody3D *this, float param_1) {
   float fVar1;
   uint uVar2;
   long lVar3;
   long lVar4;
 ...
 while ( lVar5 != (ulong)uVar2 * 0x70 + lVar3 );
   ...
   _err_print_error("set_total_mass", "modules/godot_physics_3d/godot_soft_body_3d.cpp", 0x36a, "Condition \"p_val < 0.0\" is true.", 0, 0);
   return;
}
/* GodotSoftBody3D::set_collision_margin(float) */void GodotSoftBody3D::set_collision_margin(GodotSoftBody3D *this, float param_1) {
   *(float*)( this + 0x238 ) = param_1;
   return;
}
/* GodotSoftBody3D::set_linear_stiffness(float) */void GodotSoftBody3D::set_linear_stiffness(GodotSoftBody3D *this, float param_1) {
   *(float*)( this + 0x248 ) = param_1;
   return;
}
/* GodotSoftBody3D::set_pressure_coefficient(float) */void GodotSoftBody3D::set_pressure_coefficient(GodotSoftBody3D *this, float param_1) {
   *(float*)( this + 0x24c ) = param_1;
   return;
}
/* GodotSoftBody3D::set_damping_coefficient(float) */void GodotSoftBody3D::set_damping_coefficient(GodotSoftBody3D *this, float param_1) {
   *(float*)( this + 0x250 ) = param_1;
   return;
}
/* GodotSoftBody3D::set_drag_coefficient(float) */void GodotSoftBody3D::set_drag_coefficient(GodotSoftBody3D *this, float param_1) {
   *(float*)( this + 0x254 ) = param_1;
   return;
}
/* GodotSoftBody3D::add_velocity(Vector3 const&) */void GodotSoftBody3D::add_velocity(GodotSoftBody3D *this, Vector3 *param_1) {
   long lVar1;
   long lVar2;
   ...
   for (; lVar2 != lVar1; lVar1 = lVar1 + 0x70) {
      if (0.0 < *(float*)( lVar1 + 0x58 )) {
         *(ulong*)( lVar1 + 0x30 ) = CONCAT44((float)( ( ulong ) * (undefined8*)( lVar1 + 0x30 ) >> 0x20 ) + (float)( ( ulong ) * (undefined8*)param_1 >> 0x20 ), (float)*(undefined8*)( lVar1 + 0x30 ) + (float)*(undefined8*)param_1);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotSoftBody3D::apply_forces(LocalVector<GodotArea3D*, unsigned int, false, false> const&) */void GodotSoftBody3D::apply_forces(GodotSoftBody3D *this, LocalVector *param_1) {
   long *plVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   if (lVar9 == lVar10) {
      ...
      do {
         while (true) {
            ...
            fVar19 = fVar19 + ( fVar15 * fVar24 - fVar20 * fVar23 ) * ( *(float*)( lVar10 + 0x14 ) - fVar2 ) + ( fVar18 * fVar23 - fVar21 * fVar15 ) * ( *(float*)( lVar10 + 0x10 ) - fVar3 ) + ( fVar20 * fVar21 - fVar18 * fVar24 ) * ( *(float*)( lVar10 + 0xc ) - fVar4 );
            if (uVar8 == 0) break;
            auVar22 = ZEXT416(0);
            ...
            do {
               ...
               fVar16 = powf(( fVar15 - *(float*)( lVar10 + 0x108 ) ) * fVar23 + ( fVar2 - *(float*)( lVar10 + 0x10c ) ) * fVar6 + ( fVar4 - *(float*)( lVar10 + 0x110 ) ) * fVar24, (float)( *(uint*)( lVar10 + 0x104 ) ^ __LC68 ));
               fVar24 = (float)( (double)( fVar24 * fVar3 + fVar23 * fVar20 + fVar21 * fVar6 ) * (double)fVar5 * __LC69 * (double)*(float*)( (long)plVar13 + 0xc ) * (double)fVar16 );
 ...
 while ( plVar11 != plVar12 );
            ...
            do {
               lVar10 = *plVar11;
               plVar11 = plVar11 + 1;
               *(ulong*)( lVar10 + 0x24 ) = CONCAT44((float)( ( ulong ) * (undefined8*)( lVar10 + 0x24 ) >> 0x20 ) + auVar22._4_4_, (float)*(undefined8*)( lVar10 + 0x24 ) + auVar22._0_4_);
               *(float*)( lVar10 + 0x2c ) = *(float*)( lVar10 + 0x2c ) + fVar18;
            }
 while ( plVar13 != plVar11 );
            plVar13 = plVar13 + 9;
            if (plVar1 == plVar13) goto LAB_00102bfa;
         }
;
         plVar13 = plVar13 + 9;
      }
 while ( plVar1 != plVar13 );
      LAB_00102bfa:fVar19 = fVar19 / __LC70;
   }
   ...
   if (_LC31 < (double)fVar2) {
      ...
      do {
         if (0.0 < *(float*)( lVar14 + 0x58 )) {
            ...
            *(ulong*)( lVar14 + 0x24 ) = CONCAT44((float)( ( ulong ) * (undefined8*)( lVar14 + 0x24 ) >> 0x20 ) + fVar19 * (float)( ( ulong ) * (undefined8*)( lVar14 + 0x48 ) >> 0x20 ), (float)*(undefined8*)( lVar14 + 0x24 ) + fVar19 * (float)*(undefined8*)( lVar14 + 0x48 ));
         }
...
/* GodotSoftBody3D::solve_links(float, float) */void GodotSoftBody3D::solve_links(float param_1, float param_2) {
   undefined8 uVar1;
   long lVar2;
   long lVar3;
   double dVar4;
   ...
   for (; lVar6 != lVar5; lVar5 = lVar5 + 0x30) {
      if (0.0 < *(float*)( lVar5 + 0x24 )) {
         ...
         if (dVar4 < (double)fVar13) {
            fVar13 = ( ( *(float*)( lVar5 + 0x28 ) - fVar7 ) / ( *(float*)( lVar5 + 0x24 ) * fVar13 ) ) * param_1;
...
/* GodotSoftBody3D::solve_constraints(float) */void GodotSoftBody3D::solve_constraints(GodotSoftBody3D *this, float param_1) {
   float fVar1;
   undefined8 uVar2;
   undefined8 *puVar3;
   long lVar4;
   ...
   for (; puVar6 != puVar3; puVar3 = puVar3 + 6) {
      ...
      *(float*)( (long)puVar3 + 0x2c ) = fVar20 / ( ( fVar18 * fVar18 + fVar19 * fVar19 + fVar14 * fVar14 ) * *(float*)( (long)puVar3 + 0x24 ) );
   }
   ...
   if (lVar9 == lVar7) {
      ...
      if (iVar5 < 1) goto LAB_0010301a;
      LAB_00102f30:uVar12 = 0;
      fVar21 = (float)iVar5;
      do {
         iVar11 = (int)uVar12;
 ...
 while ( (int)uVar12 != iVar5 );
      ...
      fVar20 = fVar19;
      fVar21 = fVar19;
      if (lVar9 == lVar7) goto LAB_0010301a;
   }
 else {
      do {
         lVar4 = lVar8 + 0x70;
         *(float*)( lVar8 + 0x14 ) = *(float*)( lVar8 + 0x38 ) * param_1 + *(float*)( lVar8 + 0x20 );
         *(ulong*)( lVar8 + 0xc ) = CONCAT44((float)( ( ulong ) * (undefined8*)( lVar8 + 0x30 ) >> 0x20 ) * param_1 + (float)( ( ulong ) * (undefined8*)( lVar8 + 0x18 ) >> 0x20 ), (float)*(undefined8*)( lVar8 + 0x30 ) * param_1 + (float)*(undefined8*)( lVar8 + 0x18 ));
         lVar8 = lVar4;
      }
 while ( lVar9 != lVar4 );
      iVar5 = *(int*)( this + 0x244 );
      if (0 < iVar5) goto LAB_00102f30;
   ...
   do {
      ...
      *(undefined4*)( lVar7 + 0x44 ) = 0;
      ...
      fVar17 = (float)( (ulong)uVar16 >> 0x20 ) * fVar18 + (float)( ( ulong ) * (undefined8*)( lVar7 + 0xc ) >> 0x20 );
      ...
      *(ulong*)( lVar7 + 0x30 ) = CONCAT44(( fVar17 - (float)( (ulong)uVar2 >> 0x20 ) ) * fVar20, ( fVar15 - (float)uVar2 ) * fVar19);
      lVar7 = lVar8;
   }
 while ( lVar9 != lVar8 );
   LAB_0010301a:update_normals_and_centroids(this);
   return;
}
/* WARNING: Removing unreachable block (ram,0x001030db) *//* GodotSoftBody3D::query_aabb(AABB const&, bool (*)(unsigned int, void*), void*) */void GodotSoftBody3D::query_aabb(GodotSoftBody3D *this, AABB *param_1, _func_bool_uint_void_ptr *param_2, void *param_3) {
   code *pcVar1;
   bool bVar2;
   uint uVar3;
   long lVar4;
   ...
   if (pfVar14 == (float*)0x0) {
      LAB_0010326f:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }

      /* WARNING: Subroutine does not return */
      *(undefined**)( puVar11 + -8 ) = &UNK_0010345b;
      __stack_chk_fail();
   }
   ...
   LAB_00103130:fVar6 = (float)( (int)fVar16 + -1 );
   fVar7 = fVar6;
   if (( ( ( fVar21 < *pfVar14 ) || ( pfVar14[3] < fVar22 ) ) || ( fVar23 < pfVar14[1] ) ) || ( ( ( pfVar14[4] < fVar24 || ( fVar26 < pfVar14[2] ) ) || ( pfVar14[5] < fVar25 ) ) )) {
      LAB_00103298:if (fVar7 == 0.0) goto LAB_00103260;
   }
 else {
      if (*(long*)( pfVar14 + 10 ) == 0) {
         ...
         iVar10 = (int)local_88;
         fVar15 = local_68;
         if (!bVar2) goto LAB_00103298;
         LAB_00103260:puVar11 = auStack_4a8;
      ...
      if (iVar10 < (int)fVar6) {
         if (fVar15 == 0.0) {
            if ((uint)local_4c < 0x100) {
               ...
               fVar25 = local_4c;
               if (ppfVar5 == (float**)0x0) {
                  LAB_001033b0:_err_print_error("resize", "./core/templates/local_vector.h", 0xa3, "FATAL: Condition \"!data\" is true.", "Out of memory", 0);
                  _err_flush_stdout();
                  /* WARNING: Does not return */
                  pcVar1 = (code*)invalidInstructionException();
                  ( *pcVar1 )();
            ...
            *ppfVar5 = *ppfVar18;
            ...
            for (uVar9 = ( ulong )((int)lVar4 + 0x400U >> 3); ppfVar17 = ppfVar5,uVar9 != 0; uVar9 = uVar9 - 1) {
               *puVar13 = *puVar12;
            ...
            if ((uint)fVar15 <= (uint)fVar8) {
               ...
               if ((uint)local_4c < (uint)fVar8) {
                  ...
                  if (ppfVar5 == (float**)0x0) goto LAB_001033b0;
               }
      ...
      LAB_001031c7:ppfVar17[(int)fVar6] = *(float**)( pfVar14 + 8 );
...
/* GodotSoftBody3D::initialize_face_tree() */void GodotSoftBody3D::initialize_face_tree(GodotSoftBody3D *this) {
   float fVar1;
   float fVar2;
   uint uVar3;
   float fVar4;
...
/* WARNING: Removing unreachable block (ram,0x001037ef) *//* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* WARNING: Restarted to delay deadcode elimination for space: stack *//* GodotSoftBody3D::query_ray(Vector3 const&, Vector3 const&, bool (*)(unsigned int, void*), void*)
    */bool GodotSoftBody3D::query_ray(GodotSoftBody3D *this, Vector3 *param_1, Vector3 *param_2, _func_bool_uint_void_ptr *param_3, void *param_4) {
   ...
   if (puVar10 == (undefined8*)0x0) {
      ...
      puVar10 = *(undefined8**)( this + 0x1f8 );
      if (puVar10 == (undefined8*)0x0) goto LAB_00103a60;
   }
   ...
   if (fVar24 == 0.0) {
      ...
      if (fVar32 == 0.0) {
         ...
         fVar29 = _LC33 / fVar32;
         pauVar15 = (undefined1(*) [12])( (long)local_58 + ( ulong )(( uint )((long)( ( ulong )(fVar29 < 0.0) << 0x3f ) >> 0x3f) & 0xc) );
      ...
      if (fVar26 == 0.0) {
         ...
         fVar28 = _LC33 / fVar26;
         pauVar17 = (undefined1(*) [12])( (long)*pauVar4 + ( ulong )(( uint )((long)( ( ulong )(fVar28 < 0.0) << 0x3f ) >> 0x3f) & 0xc) );
      ...
      if (fVar24 == 0.0) {
         ...
         fVar30 = _LC33 / fVar24;
         pauVar4 = (undefined1(*) [12])( (long)*pauVar4 + ( ulong )(( uint )((long)( ( ulong )(fVar30 < 0.0) << 0x3f ) >> 0x3f) & 0xc) );
   ...
   if (fVar24 <= fVar22) {
      ...
      if (fVar26 < fVar31) goto LAB_0010397a;
      if (fVar31 <= fVar24) {
         fVar31 = fVar24;
      }
      ...
      if (( fVar24 < fVar31 ) || ( fVar26 = ( *(float*)( (long)*pauVar4 + 8 ) - *(float*)( param_1 + 8 ) ) * fVar30 ),fVar22 < fVar26) goto LAB_0010397a;
      if (fVar26 <= fVar31) {
         fVar26 = fVar31;
      }
      ...
      if (( fVar20 <= fVar26 ) || ( fVar24 <= 0.0 )) goto LAB_0010397a;
      if (puVar10[5] == 0) {
         ...
         if (!bVar1) goto LAB_0010397a;
         LAB_00103a50:puVar11 = auStack_4e8;
         if (local_60 != (undefined1(*) [12])0x0) {
            pVStack_4f0 = (Vector3*)0x103a60;
            Memory::free_static(local_60, false);
            puVar11 = auStack_4e8;
         }

         LAB_00103a60:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            return false;
         }

         /* WARNING: Subroutine does not return */
         *(undefined8*)( puVar11 + -8 ) = 0x103e2d;
         __stack_chk_fail();
      }
      ...
      if ((int)local_7c < (int)uVar2) {
         if (local_80 == 0.0) {
            if ((uint)local_cc < 0x100) {
               ...
               if (pauVar4 == (undefined1(*) [12])0x0) {
                  LAB_00103e2d:pVStack_4f0 = (Vector3*)0x103e32;
                  ...
                  auVar23._4_4_ = (float)( ( ulong ) * (undefined8*)extraout_RDX >> 0x20 ) - (float)( ( ulong ) * (undefined8*)pVVar12 >> 0x20 );
                  auVar23._8_8_ = 0;
                  ...
                  pVStack_4f0 = param_1;
                  query_ray(pGStack_540, pVVar12, extraout_RDX, _SoftBodyIntersectSegmentInfo::process_hit, &pGStack_540);
            ...
            *(undefined8**)( (long)local_60[0x54] + 8 ) = *(undefined8**)( (long)local_88[0x54] + 8 );
            ...
            if ((uint)local_80 <= (uint)local_7c) {
               ...
               if ((uint)local_cc < (uint)local_7c) {
                  ...
                  pauVar9 = local_60;
                  local_60 = pauVar4;
                  if (pauVar4 == (undefined1(*) [12])0x0) goto LAB_00103e2d;
                  fVar21 = *(float*)( param_1 + 4 );
                  fVar25 = *(float*)param_1;
                  pauVar15 = local_b0;
                  pauVar16 = local_a0;
         ...
         LAB_00103d1e:ppuVar7 = (undefined8**)( (long)*local_60 + local_68 );
         pauVar9 = local_60;
      }
 else {
      ...
      *(undefined8*)( (long)*pauVar9 + local_68 + 8 ) = puVar10[5];
      ...
      LAB_0010397a:uVar5 = uVar2;
      if (uVar5 == 0) goto LAB_00103a50;
      fVar21 = *(float*)( param_1 + 4 );
      fVar25 = *(float*)param_1;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotSoftBodyShape3D::intersect_segment(Vector3 const&, Vector3 const&, Vector3&, Vector3&, int&,
   bool) const */bool GodotSoftBodyShape3D::intersect_segment(Vector3 *param_1, Vector3 *param_2, Vector3 *param_3, Vector3 *param_4, int *param_5, bool param_6) {
   ...
   auVar3._4_4_ = (float)( ( ulong ) * (undefined8*)param_3 >> 0x20 ) - (float)( ( ulong ) * (undefined8*)param_2 >> 0x20 );
   auVar3._8_8_ = 0;
   ...
   GodotSoftBody3D::query_ray(local_58, param_2, param_3, _SoftBodyIntersectSegmentInfo::process_hit, &local_58);
...
/* GodotSoftBody3D::update_face_tree(float) */void GodotSoftBody3D::update_face_tree(GodotSoftBody3D *this, float param_1) {
   AABB *pAVar1;
   long lVar2;
   long lVar3;
   long lVar4;
...
/* GodotSoftBody3D::deinitialize_shape() */void GodotSoftBody3D::deinitialize_shape(GodotSoftBody3D *this) {
   long lVar1;
   long lVar2;
   long *plVar3;
   code *pcVar4;
   ...
   if (( lVar1 != 0 ) && ( lVar2 = *(long*)( lVar1 + -8 ) ),0 < (int)lVar2) {
      ...
      _err_print_index_error("get_shape", "modules/godot_physics_3d/godot_collision_object_3d.h", 0x7c, 0, lVar2, "p_index", "shapes.size()", "", false, true);
      _err_flush_stdout();
      /* WARNING: Does not return */
      pcVar4 = (code*)invalidInstructionException();
      ( *pcVar4 )();
...
/* GodotSoftBody3D::destroy() */void GodotSoftBody3D::destroy(GodotSoftBody3D *this) {
   long lVar1;
   long in_FS_OFFSET;
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
   *(undefined8*)( this + 0xd8 ) = 0;
   ...
   DynamicBVH::clear();
   for (int i = 0; i < 3; i++) {
      if (*(int*)( this + ( 16*i + 224 ) ) != 0) {
         *(undefined4*)( this + ( 16*i + 224 ) ) = 0;
      }
...
/* GodotSoftBodyShape3D::update_bounds() */void GodotSoftBodyShape3D::update_bounds(GodotSoftBodyShape3D *this) {
   long lVar1;
   long in_FS_OFFSET;
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
   if (*(long*)( this + 0x60 ) == 0) {
      if (lVar1 == *(long*)( in_FS_OFFSET + 0x28 )) {
         _err_print_error("update_bounds", "modules/godot_physics_3d/godot_soft_body_3d.cpp", 0x4ce, "Parameter \"soft_body\" is null.", 0, 0);
         return;
      }
...
/* GodotSoftBody3D::initialize_shape(bool) */void GodotSoftBody3D::initialize_shape(GodotSoftBody3D *this, bool param_1) {
   long lVar1;
   long lVar2;
   long lVar3;
   code *pcVar4;
   ...
   if (( lVar2 == 0 ) || ( lVar3 = *(long*)( lVar2 + -8 ) ),(int)lVar3 == 0) {
      ...
      *(undefined***)this_00 = &PTR_get_volume_00109f90;
      *(GodotSoftBody3D**)( this_00 + 0x60 ) = this;
      ...
      if (lVar3 < 1) {
         _err_print_index_error("get_shape", "modules/godot_physics_3d/godot_collision_object_3d.h", 0x7c, 0, lVar3, "p_index", "shapes.size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar4 = (code*)invalidInstructionException();
         ( *pcVar4 )();
   ...
   LAB_001049b0:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* GodotSoftBody3D::set_space(GodotSpace3D*) */void GodotSoftBody3D::set_space(GodotSpace3D *param_1) {
   char cVar1;
   long in_FS_OFFSET;
   undefined8 local_38;
   undefined4 local_30;
   ...
   LAB_00104a93:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* GodotSoftBody3D::update_bounds() */void GodotSoftBody3D::update_bounds(GodotSoftBody3D *this) {
   float fVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   if (uVar10 == 0) {
      ...
      while (true) {
         if (uVar10 <= (uint)lVar15) {
            _err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, lVar15, (ulong)uVar10, "p_index", "count", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
         ...
         if (( ( fVar18 < fVar2 - fVar1 ) || ( *(float*)( lVar14 + 0x10 ) < fVar3 - fVar1 ) ) || ( ( *(float*)( lVar14 + 0x14 ) < fVar4 - fVar1 || ( ( ( fVar2 - fVar1 ) + fVar5 + fVar22 < fVar18 || ( ( fVar3 - fVar1 ) + fVar6 + fVar22 < *(float*)( lVar14 + 0x10 ) ) ) ) ) )) {
            bVar16 = true;
         }
         ...
         if (bVar13) {
            ...
            *(undefined4*)( this + 0x228 ) = *(undefined4*)( lVar14 + 0x14 );
            ...
            if (( ( fVar19 < 0.0 ) || ( fVar23 = fVar23 < 0.0 ) ) || ( fVar25 = fVar25 < 0.0 )) {
               _err_print_error("expand_to", "./core/math/aabb.h", 0x158, "AABB size is negative, this is not supported. Use AABB.abs() to get an AABB with a positive size.", 0, 0);
               fVar18 = *(float*)( lVar14 + 0xc );
...
/* GodotSoftBody3D::apply_nodes_transform(Transform3D const&) [clone .part.0] */void GodotSoftBody3D::apply_nodes_transform(GodotSoftBody3D *this, Transform3D *param_1) {
   float fVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   undefined8 uVar4;
   ...
   if (uVar6 != 0) {
      ...
      while (true) {
         ...
         *(float*)( lVar10 + 0x14 ) = *(float*)( param_1 + 0x20 ) * fVar1 + *(float*)( param_1 + 0x18 ) * fVar14 + *(float*)( param_1 + 0x1c ) * fVar15 + *(float*)( param_1 + 0x2c );
         ...
         *(undefined4*)( lVar10 + 0x20 ) = *(undefined4*)( lVar10 + 0x14 );
         ...
         fVar13 = (float)( (ulong)uVar2 >> 0x20 ) * fVar14 + fVar15 * fVar13 + (float)( (ulong)uVar4 >> 0x20 ) * fVar1 + (float)( (ulong)uVar5 >> 0x20 );
         ...
         *(ulong*)( lVar10 + 0x18 ) = CONCAT44(fVar13, fVar12);
         ...
         if (*(uint*)( this + 0xe0 ) <= uVar11) {
            _err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, (ulong)uVar11, ( ulong ) * (uint*)( this + 0xe0 ), "p_index", "count", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
...
/* GodotSoftBody3D::apply_nodes_transform(Transform3D const&) */void GodotSoftBody3D::apply_nodes_transform(GodotSoftBody3D *this, Transform3D *param_1) {
   if (*(long*)( this + 0xd8 ) != 0) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotSoftBody3D::set_state(PhysicsServer3D::BodyState, Variant const&) */void GodotSoftBody3D::set_state(GodotSoftBody3D *param_1, undefined4 param_2) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long in_FS_OFFSET;
   ...
   LAB_00105507:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* GodotSoftBodyShape3D::GodotSoftBodyShape3D(GodotSoftBody3D*) */void GodotSoftBodyShape3D::GodotSoftBodyShape3D(GodotSoftBodyShape3D *this, GodotSoftBody3D *param_1) {
   *(undefined8*)( this + 8 ) = 0;
   ...
   *(undefined***)this = &PTR_get_volume_00109f90;
...
/* GodotSoftBody3D::generate_bending_constraints(int) [clone .part.0] */void GodotSoftBody3D::generate_bending_constraints(GodotSoftBody3D *this, int param_1) {
   uint uVar1;
   code *pcVar2;
   uint uVar3;
   uint *puVar4;
 ...
 while ( uVar1 != uVar17 );
   ...
   for (; lVar15 != lVar16; lVar15 = lVar15 + 0x30) {
      if (*(int*)( this + 0xe0 ) == 0) goto LAB_001056a5;
   ...
   if (param_1 == 2) {
      local_58 = 0;
      local_50 = (uint*)0x0;
      LocalVector<LocalVector<int,unsigned_int,false,false>,unsigned_int,false,false>::resize((LocalVector<LocalVector<int,unsigned_int,false,false>,unsigned_int,false,false>*)&local_58, *(uint*)( this + 0xe0 ));
      lVar16 = *(long*)( this + 0xf8 );
      lVar15 = lVar16 + ( ulong ) * (uint*)( this + 0xf0 ) * 0x30;
      if (lVar16 == lVar15) {
         local_88 = local_50;
         uVar17 = (uint)local_58;
         if ((uint)local_58 != 0) goto LAB_00105a63;
      }
 else {
         do {
            puVar14 = local_50;
            uVar10 = local_58;
            if (*(int*)( this + 0xe0 ) == 0) {
               LAB_001056a5:uVar10 = 0;
               uVar11 = 0;
               LAB_001056c5:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, uVar11, uVar10, "p_index", "count", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
               pcVar2 = (code*)invalidInstructionException();
               ( *pcVar2 )();
            ...
            if ((uint)local_58 <= uVar8) {
               LAB_001059b4:uVar10 = uVar10 & 0xffffffff;
               goto LAB_001056c5;
            }
            ...
            if (uVar13 != 0) {
               puVar5 = puVar7;
               do {
                  if (uVar3 == *puVar5) goto LAB_001058f6;
                  puVar5 = puVar5 + 1;
               }
 while ( puVar7 + uVar13 != puVar5 );
            ...
            if (puVar6[1] == uVar13) {
               ...
               *(uint**)( puVar6 + 2 ) = puVar7;
               if (puVar7 == (uint*)0x0) goto LAB_00105bdb;
               uVar13 = *puVar6;
            }

            *puVar6 = uVar13 + 1;
            puVar7[uVar13] = uVar3;
            LAB_001058f6:uVar11 = uVar19 & 0xffffffff;
            if (uVar17 <= uVar3) goto LAB_001059b4;
            ...
            if (uVar3 != 0) {
               puVar7 = puVar6;
               do {
                  if (uVar8 == *puVar7) goto LAB_00105931;
                  puVar7 = puVar7 + 1;
               }
 while ( puVar7 != puVar6 + uVar3 );
            ...
            if (puVar14[1] == uVar3) {
               ...
               *(uint**)( puVar14 + 2 ) = puVar6;
               if (puVar6 == (uint*)0x0) {
                  LAB_00105bdb:_err_print_error("push_back", "./core/templates/local_vector.h", 0x41, "FATAL: Condition \"!data\" is true.", "Out of memory", 0, 0);
                  _err_flush_stdout();
                  /* WARNING: Does not return */
                  pcVar2 = (code*)invalidInstructionException();
                  ( *pcVar2 )();
            ...
            *puVar14 = uVar3 + 1;
            puVar6[uVar3] = uVar8;
            LAB_00105931:lVar16 = lVar16 + 0x30;
         }
 while ( lVar15 != lVar16 );
         LAB_00105a63:uVar8 = 0;
         puVar14 = local_88;
         do {
            if (*puVar14 != 0) {
                     ...
                     do {
                        if (*puVar7 != uVar8) {
                           ...
                           if (puVar4[(int)( uVar3 + iVar18 )] + puVar4[(int)( uVar1 * uVar3 + uVar8 )] != 2) {
                              _err_print_error("generate_bending_constraints", "modules/godot_physics_3d/godot_soft_body_3d.cpp", 0x289, "Condition \"sum != 2\" is true.", 0, 0);
                              if (( local_88 == (uint*)0x0 ) || ( LocalVector<LocalVector<int,unsigned_int,false,false>,unsigned_int,false,false>::resize((LocalVector<LocalVector<int,unsigned_int,false,false>,unsigned_int,false,false>*)&local_58, 0),local_50 == (uint*)0x0 )) {
                                 if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
                                    return;
                                 }
                              ...
                              if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) goto LAB_00105c11;
                              bVar12 = false;
                              puVar4 = local_50;
                              goto LAB_001057f1;
                           }
 ...
 while ( uVar8 != uVar17 );
      ...
      if (( uVar1 == 0 ) || ( uVar1 == 1 )) goto LAB_001057d5;
   }
 else {
      if (( uVar1 == 0 ) || ( uVar1 == 1 )) goto LAB_001057d5;
      iVar18 = 0;
      ...
      do {
         ...
         do {
            uVar3 = uVar8;
            do {
               if (puVar4[(int)( iVar9 + uVar17 )] + puVar4[(int)( uVar3 + iVar18 )] < puVar4[(int)( uVar3 + iVar9 )]) {
                  puVar4[(int)( uVar3 + iVar9 )] = puVar4[(int)( iVar9 + uVar17 )] + puVar4[(int)( uVar3 + iVar18 )];
               }
   ...
   do {
      ...
      do {
         while (puVar4[(int)( uVar8 + iVar18 )] == param_1) {
            ...
            uVar8 = uVar3;
            if (uVar1 <= uVar3) goto LAB_001057c6;
         }
;
         uVar8 = uVar8 + 1;
      }
 while ( uVar8 < uVar1 );
      LAB_001057c6:uVar17 = uVar17 + 1;
      iVar18 = iVar18 + uVar1;
   }
 while ( uVar1 != uVar17 );
   LAB_001057d5:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      LAB_00105c11:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }

   bVar12 = true;
   LAB_001057f1:Memory::free_static(puVar4, bVar12);
   return;
}
/* GodotSoftBody3D::generate_bending_constraints(int) */void GodotSoftBody3D::generate_bending_constraints(GodotSoftBody3D *this, int param_1) {
   if (param_1 < 2) {
      return;
   }
...
/* GodotSoftBody3D::create_from_trimesh(Vector<int> const&, Vector<Vector3> const&) */undefined8 GodotSoftBody3D::create_from_trimesh(GodotSoftBody3D *this, Vector *param_1, Vector *param_2) {
   Vector3 *pVVar1;
   int *piVar2;
   uint uVar3;
   undefined4 uVar4;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (*(long*)( param_1 + 8 ) == 0) {
      _err_print_error("create_from_trimesh", "modules/godot_physics_3d/godot_soft_body_3d.cpp", 0x1d9, "Condition \"p_indices.is_empty()\" is true. Returning: false", 0, 0);
   }
 else {
      if (*(long*)( param_2 + 8 ) != 0) {
         ...
         if (iVar25 == 0) {
            ...
            local_a8 = (void*)Memory::realloc_static((void*)0x0, ( ulong )(( uVar10 | uVar10 >> 0x10 ) + 1) << 2, false);
            local_a0 = uVar6;
            if (local_a8 == (void*)0x0) goto LAB_0010626d;
         }
         ...
         if (uVar18 == 0) {
            ...
            LAB_00105f67:if (iVar25 == 0) goto LAB_00106756;
            ...
            do {
               ...
               if ((long)uVar28 < 0) {
                  if (lVar21 == 0) {
                     LAB_00106688:lVar14 = 0;
                  }
 else {
                     LAB_00105ff8:lVar14 = *(long*)( lVar21 + -8 );
                  }

                  LAB_001060dc:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar28, lVar14, "p_index", "size()", "", false, true);
                  _err_flush_stdout();
                  /* WARNING: Does not return */
               ...
               if (lVar21 == 0) goto LAB_00106688;
               lVar14 = (ulong)uVar24 << 2;
               uVar19 = uVar24;
               while (true) {
                  uVar16 = (ulong)uVar19;
                  if (*(long*)( lVar21 + -8 ) <= (long)uVar28) goto LAB_00105ff8;
                  ...
                  if (local_a0 <= uVar19) goto LAB_001066bc;
...
;
 ...
 while ( uVar6 != uVar24 );
            ...
            if (puVar12 == (undefined8*)0x0) goto LAB_0010626d;
            uVar23 = uVar23 & 0xffffffff;
            memset(puVar12, 0, uVar23 * 0xc);
            if (uVar18 < *(uint*)( this + 0x210 )) {
               LAB_00105d90:*(uint*)( this + 0x210 ) = uVar18;
            }
            ...
            do {
               ...
               if (lVar14 <= (long)uVar28) goto LAB_001060dc;
               local_8c = 0;
               pVVar1 = (Vector3*)( lVar21 + uVar28 * 0xc );
               cVar9 = HashMap<Vector3,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<Vector3>,DefaultTypedAllocator<HashMapElement<Vector3,unsigned_int>>>::_lookup_pos((HashMap<Vector3,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<Vector3>,DefaultTypedAllocator<HashMapElement<Vector3,unsigned_int>>>*)&local_88, pVVar1, &local_8c);
               if (cVar9 == '\0') {
                  LAB_00105e16:puVar13 = (uint*)HashMap<Vector3,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<Vector3>,DefaultTypedAllocator<HashMapElement<Vector3,unsigned_int>>>::operator []((HashMap<Vector3,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<Vector3>,DefaultTypedAllocator<HashMapElement<Vector3,unsigned_int>>>*)&local_88, pVVar1);
                  uVar16 = (ulong)uVar10;
                  *puVar13 = uVar10;
                  if (uVar18 <= uVar10) goto LAB_0010606a;
                  ...
                  *(undefined4*)( puVar26 + 1 ) = *(undefined4*)( pVVar1 + 8 );
                  ...
                  if (lVar21 == 0) goto LAB_00105e16;
                  uVar24 = *(uint*)( this + 0x210 );
                  uVar19 = *(uint*)( lVar21 + 0x1c );
               }

               if (uVar24 <= (uint)uVar28) goto LAB_0010604c;
 ...
 while ( (int)uVar28 < (int)uVar18 );
            ...
            uVar24 = uVar10;
            if (( uVar10 < uVar18 ) || ( uVar24 = uVar10 <= uVar18 )) {
               LAB_00105ec0:uVar10 = uVar24;
 ...
 while ( piVar2 != piVar22 );
            ...
            if (( uVar10 <= uVar27 ) || ( uVar27 = uVar10 - 1 | uVar10 - 1 >> 1 ),uVar27 = uVar27 | uVar27 >> 2,uVar27 = uVar27 >> 4 | uVar27,uVar27 = uVar27 >> 8 | uVar27,local_b0 = (undefined8*)Memory::realloc_static(puVar12, ( ulong )(( uVar27 | uVar27 >> 0x10 ) + 1) * 0xc, false),local_b0 != (undefined8*)0x0) {
               memset((void*)( (long)local_b0 + uVar23 * 0xc ), 0, ( ( ulong )(( uVar10 - uVar18 ) - 1) * 3 + 3 ) * 4);
               puVar26 = (undefined8*)local_80._0_8_;
               uVar24 = uVar10;
               goto LAB_00105ec0;
            }
         ...
         if (uVar19 < uVar24) {
            *(uint*)( this + 0xe0 ) = uVar19;
            LAB_00106328:fVar30 = (float)uVar19 * *(float*)( this + 0x240 );
            fVar29 = *(float*)( this + 0x238 ) + *(float*)( this + 0x238 );
            if (uVar19 != 0) goto LAB_0010635a;
         }
 else {
            if (uVar19 <= uVar24) goto LAB_00106328;
            if (*(uint*)( this + 0xe4 ) < uVar19) {
               ...
               *(long*)( this + 0xe8 ) = lVar21;
               if (lVar21 == 0) {
                  LAB_0010626d:_err_print_error("resize", "./core/templates/local_vector.h", 0xa3, "FATAL: Condition \"!data\" is true.", "Out of memory", 0, 0);
                  _err_flush_stdout();
                  /* WARNING: Does not return */
                  pcVar7 = (code*)invalidInstructionException();
                  ( *pcVar7 )();
               ...
               uVar24 = *(uint*)( this + 0xe0 );
               if (uVar24 < uVar19) goto LAB_0010677a;
            }
 else {
               LAB_0010677a:lVar21 = *(long*)( this + 0xe8 );
               ...
               do {
                  ...
                  *(undefined8*)( (long)puVar12 + 0xc ) = 0;
                  for (int i = 0; i < 3; i++) {
                     *(undefined4*)( (long)puVar12 + ( 24*i + 20 ) ) = 0;
                     puVar12[( 3*i + 3 )] = 0;
                     *(undefined4*)( puVar12 + ( 3*i + 4 ) ) = 0;
                     *(undefined8*)( (long)puVar12 + ( 24*i + 36 ) ) = 0;
                  }
 ...
 while ( (undefined8*)( lVar21 + 0x70 + ( ( ulong )(( uVar19 - uVar24 ) - 1) + (ulong)uVar24 ) * 0x70 ) != puVar26 );
            }

            *(uint*)( this + 0xe0 ) = uVar19;
            fVar30 = (float)uVar19 * *(float*)( this + 0x240 );
            fVar29 = *(float*)( this + 0x238 ) + *(float*)( this + 0x238 );
            LAB_0010635a:lVar21 = 0;
            uVar27 = 0;
            puVar12 = local_b0;
            do {
 ...
 while ( uVar27 != uVar19 );
         ...
         LocalVector<bool,unsigned_int,false,false>::resize((LocalVector<bool,unsigned_int,false,false>*)&local_88, uVar19 * uVar19);
         ...
         if (iVar25 != 0) {
            while (true) {
               ...
               if (local_a0 <= uVar27 + 1) goto LAB_001066bc;
               uVar27 = uVar27 + 2;
               ...
               do {
                  ...
                  uVar16 = (ulong)uVar11;
                  if (uVar10 <= uVar11) goto LAB_0010606a;
 ...
 while ( (uint*)&local_4c != puVar13 );
               ...
               uVar28 = uVar28 + 3;
               if (uVar6 <= (uint)uVar28) goto LAB_001065f1;
            }
;
            uVar16 = (ulong)uVar27;
            LAB_001066bc:uVar23 = (ulong)local_a0;
            LAB_0010606a:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, uVar16, uVar23, "p_index", "count", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar7 = (code*)invalidInstructionException();
            ( *pcVar7 )();
         ...
         LAB_001065f1:uVar6 = *(uint*)( this + 600 );
         for (uVar28 = 0; (uint)uVar28 < uVar6; uVar28 = uVar28 + 1) {
            ...
            if ((int)uVar10 < (int)uVar18) {
               ...
               if (uVar27 <= uVar10) {
                  LAB_00106994:uVar23 = (ulong)uVar27;
                  goto LAB_0010606a;
               }
               ...
               if (uVar10 < uVar19) {
                  ...
                  if (uVar27 <= uVar10) goto LAB_00106994;
                  *(undefined4*)( uVar16 * 0x70 + *(long*)( this + 0xe8 ) + 0x58 ) = 0;
               }
 else {
                  _err_print_error("create_from_trimesh", "modules/godot_physics_3d/godot_soft_body_3d.cpp", 0x241, "Condition \"node_index >= node_count\" is true. Continuing.", 0, 0);
               }

            }
 else {
               _err_print_error("create_from_trimesh", "modules/godot_physics_3d/godot_soft_body_3d.cpp", 0x23e, "Condition \"pinned_vertex >= visual_vertex_count\" is true. Continuing.", 0, 0);
            }
         ...
         update_normals_and_centroids(this);
         update_bounds(this);
         LocalVector<bool,unsigned_int,false,false>::resize((LocalVector<bool,unsigned_int,false,false>*)&local_88, 0);
      ...
      _err_print_error("create_from_trimesh", "modules/godot_physics_3d/godot_soft_body_3d.cpp", 0x1da, "Condition \"p_vertices.is_empty()\" is true. Returning: false", 0, 0);
   }

   uVar15 = 0;
   LAB_0010617f:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar15;
   }

   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   LAB_0010604c:uVar16 = uVar28;
   uVar23 = (ulong)uVar24;
   goto LAB_0010606a;
}
/* GodotSoftBody3D::set_mesh(RID) */void GodotSoftBody3D::set_mesh(GodotSoftBody3D *this, long param_2) {
   long *plVar1;
   long lVar2;
   char cVar3;
   undefined8 uVar4;
   ...
   *(long*)( this + 0xd8 ) = param_2;
   if (param_2 != 0) {
      ...
      if (cVar3 == '\0') {
         ...
         if (local_50 == 0) {
            _err_print_error("set_mesh", "modules/godot_physics_3d/godot_soft_body_3d.cpp", 0x90, "Condition \"indices.is_empty()\" is true.", "Soft body\'s mesh needs to have indices", 0, 0);
         }
 else if (local_40 == 0) {
            _err_print_error("set_mesh", "modules/godot_physics_3d/godot_soft_body_3d.cpp", 0x91, "Condition \"vertices.is_empty()\" is true.", "Soft body\'s mesh needs to have vertices", 0, 0);
         }
 else {
         ...
         _err_print_error("set_mesh", "modules/godot_physics_3d/godot_soft_body_3d.cpp", 0x8c, "Condition \"arrays.is_empty()\" is true.", 0, 0);
      }

      Array::~Array(local_60);
   }

   LAB_00106a75:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotSoftBody3D::predict_motion(float) */void GodotSoftBody3D::predict_motion(GodotSoftBody3D *this, float param_1) {
   float fVar1;
   uint uVar2;
   long lVar3;
   code *pcVar4;
   ...
   local_68 = 0;
   local_60 = (void*)0x0;
   if (( *(long*)( this + 0x2b8 ) == 0 ) || ( iVar15 = iVar15 == 0 )) {
      LAB_00106ce8:pVVar13 = *(Vector3**)( lVar9 + 200 );
      if (pVVar13 == (Vector3*)0x0) {
         if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            uVar14 = 0x3f9;
            pcVar12 = "Parameter \"default_area\" is null.";
            LAB_0010741f:_err_print_error("predict_motion", "modules/godot_physics_3d/godot_soft_body_3d.cpp", uVar14, pcVar12, 0, 0);
            return;
         }
      ...
      local_88 = 0;
      local_98 = _LC31;
      LAB_00106d18:local_58 = 0;
      fStack_50 = 0.0;
      GodotArea3D::compute_gravity(pVVar13, (Vector3*)( this + 0x6c ));
      local_8c = local_8c + fStack_50;
      local_88 = CONCAT44((float)( (ulong)local_88 >> 0x20 ) + (float)( (ulong)local_58 >> 0x20 ), (float)local_88 + (float)local_58);
      LAB_00106d77:local_58 = CONCAT44((float)( (ulong)local_88 >> 0x20 ) * param_1, (float)local_88 * param_1);
      ...
      for (; lVar17 != lVar9; lVar9 = lVar9 + 0x70) {
         ...
         *(undefined4*)( lVar9 + 0x20 ) = *(undefined4*)( lVar9 + 0x14 );
         ...
         local_58 = CONCAT44((float)( ( ulong ) * (undefined8*)( lVar9 + 0x24 ) >> 0x20 ) * fVar20 * param_1, (float)*(undefined8*)( lVar9 + 0x24 ) * fVar20 * param_1);
         pVVar13 = (Vector3*)&local_58;
         do {
            fVar20 = *(float*)pVVar13;
            fVar21 = fVar24;
            if (( fVar24 <= fVar20 ) && ( fVar21 = fVar20 <= fVar19 )) {
               fVar21 = fVar20;
            }
 ...
 while ( (Vector3*)&fStack_4c != pVVar13 );
         ...
         fVar22 = (float)( (ulong)local_58 >> 0x20 ) + (float)( ( ulong ) * (undefined8*)( lVar9 + 0x30 ) >> 0x20 );
         ...
         *(ulong*)( lVar9 + 0xc ) = CONCAT44(fVar22 * param_1 + (float)( ( ulong ) * (undefined8*)( lVar9 + 0xc ) >> 0x20 ), fVar21 * param_1 + (float)*(undefined8*)( lVar9 + 0xc ));
      }
...
;
      ...
      Vector<AreaCMP>::sort_custom<_DefaultComparator<AreaCMP>,true>((Vector<AreaCMP>*)( this + 0x2b0 ));
      dVar7 = _LC31;
      lVar9 = *(long*)( this + 0x2b8 );
      if (lVar9 == 0) {
         lVar17 = 0;
         LAB_00107467:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, 0, lVar17, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar4 = (code*)invalidInstructionException();
         ( *pcVar4 )();
 ...
 while ( lVar17 != lVar9 + -0x10 + (long)iVar15 * 0x10 + ( ulong )(iVar15 - 1) * -0x10 );
      if (bVar18) goto LAB_00106d77;
      pVVar13 = *(Vector3**)( *(long*)( this + 0x40 ) + 200 );
      if (pVVar13 != (Vector3*)0x0) goto LAB_00106d18;
      _err_print_error("predict_motion", "modules/godot_physics_3d/godot_soft_body_3d.cpp", 0x3f9, "Parameter \"default_area\" is null.", 0, 0);
   }
   ...
   LAB_001074b0:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* GodotShape3D::is_concave() const */undefined8 GodotShape3D::is_concave(void) {
   return 0;
}
/* GodotSoftBodyShape3D::get_type() const */undefined8 GodotSoftBodyShape3D::get_type(void) {
   return 9;
}
/* GodotSoftBodyShape3D::project_range(Vector3 const&, Transform3D const&, float&, float&) const */void GodotSoftBodyShape3D::project_range(Vector3 *param_1, Transform3D *param_2, float *param_3, float *param_4) {
   undefined4 *in_R8;
   *in_R8 = 0;
   *param_4 = 0.0;
   return;
}
/* GodotSoftBodyShape3D::get_support(Vector3 const&) const */undefined1[16];GodotSoftBodyShape3D::get_support(Vector3 *param_1) {
   long in_FS_OFFSET;
...
/* GodotSoftBodyShape3D::get_supports(Vector3 const&, int, Vector3*, int&,
   GodotShape3D::FeatureType&) const */void GodotSoftBodyShape3D::get_supports(Vector3 *param_1, int param_2, Vector3 *param_3, int *param_4, FeatureType *param_5) {
   *(undefined4*)param_5 = 0;
   return;
}
/* GodotSoftBodyShape3D::get_moment_of_inertia(float) const */undefined1[16];GodotSoftBodyShape3D::get_moment_of_inertia(float param_1) {
   long in_FS_OFFSET;
   if (*(long*)( in_FS_OFFSET + 0x28 ) == *(long*)( in_FS_OFFSET + 0x28 )) {
      return ZEXT816(0);
   }
...
/* GodotSoftBodyShape3D::set_data(Variant const&) */void GodotSoftBodyShape3D::set_data(Variant *param_1) {
   return;
}
/* GodotSoftBodyShape3D::get_data() const */GodotSoftBodyShape3D * __thiscall GodotSoftBodyShape3D::get_data(GodotSoftBodyShape3D *this){
   *(undefined4*)this = 0;
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   return this;
}
/* GodotSoftBodyShape3D::~GodotSoftBodyShape3D() */void GodotSoftBodyShape3D::~GodotSoftBodyShape3D(GodotSoftBodyShape3D *this) {
   *(undefined***)this = &PTR_get_volume_00109f90;
...
/* SortArray<AreaCMP, _DefaultComparator<AreaCMP>, true>::introsort(long, long, AreaCMP*, long)
   ...
   if (param_4 != 0) {
      lVar18 = param_2;
      local_b0 = param_4;
      LAB_00108173:local_b0 = local_b0 + -1;
      ...
      if (iVar6 < iVar1) {
         if (iVar1 < iVar13) {
            LAB_0010835d:lVar16 = *(long*)( param_3 + ( ( lVar14 >> 1 ) + param_1 ) * 0x10 );
            iVar13 = iVar1;
            goto LAB_001081c8;
         }

         if (iVar6 < iVar13) goto LAB_001081c8;
      }
 else if (iVar13 <= iVar6) {
         if (iVar1 < iVar13) goto LAB_001081c8;
         goto LAB_0010835d;
      }

      lVar16 = *(long*)( param_3 + param_1 * 0x10 );
      iVar13 = iVar6;
      LAB_001081c8:lVar14 = lVar18;
      param_2 = param_1;
      do {
         if (iVar6 < iVar13) {
            if (lVar18 + -1 == param_2) {
            ...
            if (iVar13 < *(int*)( *(long*)pAVar17 + 0x120 )) {
               ...
               while (param_1 != lVar14) {
                  lVar14 = lVar14 + -1;
                  pAVar17 = pAVar5;
                  if (*(int*)( *(long*)pAVar5 + 0x120 ) <= iVar13) goto LAB_00108280;
                  pAVar5 = pAVar5 + -0x10;
               }
;
            ...
            LAB_00108280:if (lVar14 <= param_2) goto LAB_001082d0;
            lVar7 = param_2 * 0x10;
 ...
 while ( true );
   ...
   LAB_001084db:lVar16 = lVar14 + -2 >> 1;
   lVar18 = lVar16 * 2 + 2;
 ...
 while ( lVar14 != lVar7 && SBORROW8(lVar14, lVar7) == lVar14 + lVar11 * -2 < 0 );
         ...
         lVar7 = lVar4 + -1;
         if (lVar4 <= lVar16) goto LAB_0010867c;
 ...
 while ( lVar16 < lVar12 );
         ...
         *(int*)( pAVar5 + 8 ) = (int)lVar3;
         if (lVar16 == 0) goto LAB_00108367;
      }
 else {
         pAVar9 = pAVar17;
         pAVar5 = pAVar17;
         if (lVar18 == lVar14) goto LAB_00108620;
         LAB_0010867c:*(long*)pAVar5 = lVar8;
         *(int*)( pAVar5 + 8 ) = (int)lVar3;
      }
 ...
 while ( true );
   LAB_001082d0:introsort(param_2, lVar18, param_3, local_b0);
   lVar14 = param_2 - param_1;
   if (lVar14 < 0x11) {
      return;
   }
   ...
   lVar18 = param_2;
   if (local_b0 == 0) goto LAB_001084db;
   goto LAB_00108173;
   LAB_00108367:pAVar5 = param_3 + param_1 * 0x10;
 ...
 while ( lVar14 != lVar16 && SBORROW8(lVar14, lVar16) == lVar14 + lVar7 * -2 < 0 );
         if (lVar14 == lVar16) goto LAB_00108650;
...
/* GodotSoftBody3D::~GodotSoftBody3D() */void GodotSoftBody3D::~GodotSoftBody3D(GodotSoftBody3D *this) {
   long *plVar1;
   void *pvVar2;
   long lVar3;
   long lVar4;
   *(undefined***)this = &PTR__shape_changed_00109f50;
   ...
   if (pvVar2 != (void*)0x0) {
      if (*(int*)( this + 0x2ac ) != 0) {
         if (*(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x2a8 ) * 4 ) != 0) {
            memset(*(void**)( this + 0x2a0 ), 0, ( ulong ) * (uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x2a8 ) * 4 ) << 2);
         }
   ...
   for (int i = 0; i < 3; i++) {
      if (*(void**)( this + ( -16*i + 264 ) ) != (void*)0) {
         if (*(int*)( this + ( -16*i + 256 ) ) != 0) {
            *(undefined4*)( this + ( -16*i + 256 ) ) = 0;
         }

         Memory::free_static(*(void**)( this + ( -16*i + 264 ) ), false);
      }
...
/* LocalVector<bool, unsigned int, false, false>::resize(unsigned int) */void LocalVector<bool,unsigned_int,false,false>::resize(LocalVector<bool,unsigned_int,false,false> *this, uint param_1) {
   code *pcVar1;
   long lVar2;
   uint uVar3;
...
/* LocalVector<LocalVector<int, unsigned int, false, false>, unsigned int, false,
 ...
 while ( uVar7 < *(uint*)this );
      ...
      if (*(uint*)( this + 4 ) < param_1) {
         ...
         *(long*)( this + 8 ) = lVar6;
         ...
         uVar7 = *(uint*)this;
         if (param_1 <= uVar7) goto LAB_00108eb9;
      }
 ...
 while ( puVar4 != (undefined8*)( lVar6 + 0x10 + ( ( ulong )(uVar5 - uVar7) + (ulong)uVar7 ) * 0x10 ) );
   ...
   LAB_00108eb9:*(uint*)this = param_1;
   return;
}
/* HashMap<Vector3, unsigned int, HashMapHasherDefault, HashMapComparatorDefault<Vector3>,
   ...
   unsigned int&) const */undefined8 HashMap<Vector3,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<Vector3>,DefaultTypedAllocator<HashMapElement<Vector3,unsigned_int>>>::_lookup_pos(HashMap<Vector3,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<Vector3>,DefaultTypedAllocator<HashMapElement<Vector3,unsigned_int>>> *this, Vector3 *param_1, uint *param_2) {
   float fVar1;
   float fVar2;
   float fVar3;
   ulong uVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<Vector3, unsigned int, HashMapHasherDefault, HashMapComparatorDefault<Vector3>,
   DefaultTypedAllocator<HashMapElement<Vector3, unsigned int> > >::operator[](Vector3 const&) */undefined1 * __thiscallHashMap<Vector3,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<Vector3>,DefaultTypedAllocator<HashMapElement<Vector3,unsigned_int>>>::operator [](HashMap<Vector3,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<Vector3>,DefaultTypedAllocator<HashMapElement<Vector3,unsigned_int>>> * this, Vector3 * param_1) * puVar1 ;undefined8 *puVar2float fVar3uint uVar4void *pvVar5void *__slong lVar6long lVar7undefined1 auVar8[16]undefined1 auVar9[16]undefined1 auVar10[16]undefined1 auVar11[16]undefined1 auVar12[16]undefined1 auVar13[16]undefined1 auVar14[16]undefined1 auVar15[16]undefined1 auVar16[16]undefined1 auVar17[16]undefined1 auVar18[16]undefined1 auVar19[16]undefined1 auVar20[16]undefined1 auVar21[16]undefined1 auVar22[16]undefined1 auVar23[16]undefined1(*pauVar24)[16];char cVar25uint uVar26uint uVar27ulong uVar28undefined8 uVar29void *__s_00undefined1(*pauVar30)[16];void *pvVar31int iVar32long lVar33long lVar34ulong uVar35undefined8 uVar36uint uVar37uint uVar38ulong uVar39undefined1(*pauVar40)[16];long in_FS_OFFSETuint local_c8uint local_70uint local_6c[5]undefined8 local_58undefined4 local_50long local_40local_40 = *(long*)( in_FS_OFFSET + 0x28 );local_70 = 0;cVar25 = _lookup_pos(this, param_1, &local_70);if (cVar25 == '\0') {
...
LAB_001097b7:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return pauVar30[1] + 0xc;}/* void Vector<AreaCMP>::sort_custom<_DefaultComparator<AreaCMP>, true>() */void Vector<AreaCMP>::sort_custom<_DefaultComparator<AreaCMP>,true>(Vector<AreaCMP> *this) {
   AreaCMP *pAVar1;
   long *plVar2;
   int iVar3;
   long lVar4;
 ...
 while ( lVar9 != 0 );
            ...
            LAB_00109cd9:*(long*)pAVar15 = lVar17;
 ...
 while ( lVar9 != 0 );
         ...
         LAB_00109d7d:*(long*)pAVar15 = lVar7;
...
/* WARNING: Control flow encountered bad instruction data *//* GodotSoftBody3D::~GodotSoftBody3D() */void GodotSoftBody3D::~GodotSoftBody3D(GodotSoftBody3D *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* GodotSoftBodyShape3D::~GodotSoftBodyShape3D() */void GodotSoftBodyShape3D::~GodotSoftBodyShape3D(GodotSoftBodyShape3D *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

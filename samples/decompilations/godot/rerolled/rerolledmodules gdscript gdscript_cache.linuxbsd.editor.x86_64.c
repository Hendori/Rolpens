...
;
   ...
   *(long*)( this + 0x20 ) = plVar36[1];
   ...
   if (( plVar36[3] != 0 ) && ( cVar29 = cVar29 != '\0' )) {
...
/* WARNING: Removing unreachable block (ram,0x00102060) *//* GDScriptCache::get_binary_tokens(String const&) */GDScriptCache * __thiscall GDScriptCache::get_binary_tokens(GDScriptCache *this,String *param_1){
   ...
   if (lVar7 == lVar8) {
      *(long*)( this + 8 ) = lVar4;
      local_60 = 0;
      if (( local_80 == (Object*)0x0 ) || ( cVar6 = cVar6 == '\0' )) goto LAB_00101fe5;
      lVar7 = 0;
      ...
      lVar7 = local_60;
      *(undefined8*)( this + 8 ) = 0;
      if (( local_80 != (Object*)0x0 ) && ( cVar6 = cVar6 != '\0' )) goto LAB_00102012;
   }
...
/* GDScriptCache::get_source_code(String const&) */GDScriptCache * __thiscall GDScriptCache::get_source_code(GDScriptCache *this,String *param_1){
   ...
   if (local_8c == 0) {
      ...
      *(undefined8*)this = 0;
      ...
      local_58 = "";
      String::parse_latin1((StrRange*)this);
      LAB_00102325:if (( local_88 != (Object*)0x0 ) && ( cVar5 = cVar5 != '\0' )) goto LAB_001025b0;
   }
 else {
      ...
      *(undefined8*)this = 0;
      ...
      local_50 = 0;
      String::parse_latin1((StrRange*)this);
      if (( local_88 == (Object*)0x0 ) || ( cVar5 = cVar5 == '\0' )) goto LAB_00102359;
      lVar9 = 0;
         ...
         do {
            if (uVar20 == uVar15) {
               ...
               if (cVar14 != '\0') {
                  ...
                  cVar14 = RefCounted::unreference();
                  joined_r0x0010301f:if (( cVar14 != '\0' ) && ( cVar14 = cVar14 != '\0' )) {
      ...
      *(undefined1(*) [16])( this_00 + 0x180 ) = (undefined1[16])0x0;
      ...
      if (cVar14 == '\0') {
         ...
         if (pOVar22 != (Object*)0x0) {
            *(undefined8*)this = 0;
            cVar14 = RefCounted::unreference();
            if (( cVar14 == '\0' ) || ( cVar14 = cVar14 == '\0' )) goto LAB_00102dd3;
            ( **(code**)( *(long*)pOVar22 + 0x140 ) )(pOVar22);
            Memory::free_static(pOVar22, false);
            pOVar22 = *(Object**)this;
         }
         ...
         do {
            if (uVar16 == uVar22) {
               ...
               if (cVar15 != '\0') {
                  ...
                  if (pOVar4 != pOVar1) {
                     *(Object**)this = pOVar4;
                     if (( pOVar4 != (Object*)0x0 ) && ( cVar15 = cVar15 == '\0' )) {
                        *(undefined8*)this = 0;
                     }
      ...
      if (param_4) {
         ...
         *(undefined4*)param_2 = uVar18;
         ...
         if (*(int*)param_2 == 0) {
            ...
            if (pOVar1 != pOVar4) {
               *plVar21 = (long)pOVar1;
               if (( pOVar1 != (Object*)0x0 ) && ( cVar15 = cVar15 == '\0' )) {
                  *plVar21 = 0;
               }
...
return this;}/* GDScriptCache::finish_compiling(String const&) */int GDScriptCache::finish_compiling(String *param_1) {
   ...
   *in_FS_OFFSET = iVar15 + 1;
   ...
   if (local_58 != pOVar5) {
      *puVar9 = local_58;
      if (( local_58 != (Object*)0x0 ) && ( cVar8 = cVar8 == '\0' )) {
         *puVar9 = 0;
      }
 ...
 while ( lVar22 != (ulong)uVar18 * 4 );
      ...
      if (plVar24 == (long*)0x0) {
         ...
         do {
            ...
            if (( pOVar13 != (Object*)0x0 ) && ( cVar9 = cVar9 == '\0' )) {
               pOVar13 = (Object*)0x0;
            }
...
;
            ...
            do {
               ...
               if (*piVar11 != 0) {
                  *piVar11 = 0;
                  ...
                  if (( *(long*)( (long)pvVar3 + 0x18 ) != 0 ) && ( cVar9 = cVar9 != '\0' )) {
 ...
 while ( lVar23 != (ulong)uVar18 << 2 );
      ...
      pEVar16 = local_78;
      if (local_78 != (Element*)0x0) {
         if (( *(long*)( local_78 + 0x30 ) != 0 ) && ( cVar9 = cVar9 != '\0' )) {

/* EditorPropertyBindingPath::_set_read_only(bool) */void EditorPropertyBindingPath::_set_read_only(bool param_1) {
   undefined7 in_register_00000039;
   BaseButton::set_disabled(SUB81(*(undefined8*)( CONCAT71(in_register_00000039, param_1) + 0xb58 ), 0));
   return;
}
/* OpenXRBindingModifierEditor::_on_remove_binding_modifier() */void OpenXRBindingModifierEditor::_on_remove_binding_modifier(OpenXRBindingModifierEditor *this) {
   long in_FS_OFFSET;
   long local_70;
   Variant *local_68[2];
   int local_58[6];
...
/* EditorInspectorPluginBindingModifier::can_handle(Object*) */undefined4 EditorInspectorPluginBindingModifier::can_handle(EditorInspectorPluginBindingModifier *this, Object *param_1) {
   char cVar1;
   undefined4 uVar2;
   Object *pOVar3;
   if (( ( param_1 == (Object*)0x0 ) || ( pOVar3 = (Object*)__dynamic_cast(param_1, &Object::typeinfo, &OpenXRBindingModifier::typeinfo, 0) ),pOVar3 == (Object*)0x0 )) {
      return 0;
   }
...
/* EditorPropertyActionSet::update_property() */void EditorPropertyActionSet::update_property(EditorPropertyActionSet *this) {
   char cVar1;
   int iVar2;
   Object *pOVar3;
   long lVar4;
   ...
   if (*(bool**)( this + 0xa10 ) == (bool*)0x0) {
      _err_print_error("get_edited_property_value", "./editor/editor_inspector.h", 0xb8, "Parameter \"object\" is null.", 0, 0);
      local_78[0] = 0;
      ...
      if (local_78[0] != 0) {
         ...
         if (( ( pOVar3 != (Object*)0x0 ) && ( pOVar3 = (Object*)__dynamic_cast(pOVar3, &Object::typeinfo, &OpenXRActionSet::typeinfo, 0) ),pOVar3 != (Object*)0x0 )) {
            pOVar3 = (Object*)0x0;
         }
         ...
         for (iVar6 = 0; iVar2 = OptionButton::get_item_count(),iVar6 < iVar2; iVar6 = iVar6 + 1) {
            ...
            if (( ( lVar4 == 0 ) || ( pOVar5 = (Object*)__dynamic_cast(lVar4, &Object::typeinfo, &OpenXRActionSet::typeinfo, 0) ),pOVar5 == (Object*)0x0 )) {
               pOVar5 = (Object*)0x0;
...
}OptionButton::select((int)*(undefined8*)( this + 0xb58 ));LAB_001003ce:cVar1 = Variant::needs_deinit[local_78[0]];joined_r0x0010045a:if (cVar1 != '\0') {
   Variant::_clear_internal();
}
...
return;}/* EditorPropertyActionSet::_option_selected(int) */void EditorPropertyActionSet::_option_selected(int param_1) {
   char cVar1;
   Object *pOVar2;
   ...
   EditorProperty::emit_changed((StringName*)CONCAT44(in_register_0000003c, param_1), (Variant*)&local_68, (StringName*)local_58, SUB81(&local_60, 0));
   ...
   LAB_0010063d:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* EditorPropertyActionSet::set_option_button_clip(bool) */void EditorPropertyActionSet::set_option_button_clip(bool param_1) {
   undefined7 in_register_00000039;
   Button::set_clip_text(SUB81(*(undefined8*)( CONCAT71(in_register_00000039, param_1) + 0xb58 ), 0));
   return;
}
/* EditorPropertyBindingPath::set_option_button_clip(bool) */void EditorPropertyBindingPath::set_option_button_clip(bool param_1) {
   undefined7 in_register_00000039;
   Button::set_clip_text(SUB81(*(undefined8*)( CONCAT71(in_register_00000039, param_1) + 0xb58 ), 0));
   return;
}
/* OpenXRBindingModifierEditor::_notification(int) */void __thiscall

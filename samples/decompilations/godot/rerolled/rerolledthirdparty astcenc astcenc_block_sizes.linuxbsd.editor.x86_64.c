/* assign_kmeans_texels(block_size_descriptor&) */void assign_kmeans_texels(block_size_descriptor *param_1) {
   byte bVar1;
...
/* WARNING: Type propagation algorithm not settling *//* construct_block_size_descriptor_3d(unsigned int, unsigned int, unsigned int,
   block_size_descriptor&) */void construct_block_size_descriptor_3d(uint param_1, uint param_2, uint param_3, block_size_descriptor *param_4) {
   float fVar1;
   ...
   *(uint*)param_4 = ( ( ( param_3 * param_2 * param_1 & 0xff ) << 8 | param_3 & 0xff ) << 8 | param_2 & 0xff ) << 8 | param_1 & 0xff;
   puVar29 = local_718;
 ...
 while ( uVar7 != 0x57 );
      ...
      *(uint*)( param_4 + 0xc ) = local_78c;
      ...
      for (uVar17 = ( ulong )(( (int)param_4 - (int)(undefined8*)( ( ulong )(param_4 + 0xac7568) & 0xfffffffffffffff8 ) ) + 0xac8560U >> 3); uVar17 != 0; uVar17 = uVar17 - 1) {
...
;
            ...
            if (( ( 0x48 < iVar35 - 0x18U || 0x40 < uVar27 ) || ( ( param_2 < uVar43 || param_1 < uVar24 ) || param_3 < uVar6 ) ) || ( uVar19 != 0 )) goto LAB_00100eb6;
            ...
            *(short*)( param_4 + uVar21 * 6 + 0xac8560 ) = (short)uVar17;
            ...
            param_4[uVar21 * 6 + 0xac8565] = ( block_size_descriptor )((byte)param_4[uVar21 * 6 + 0xac8565] & 0xfe);
            *(short*)( param_4 + uVar17 * 2 + 0xac7560 ) = (short)uVar21;
            uVar17 = uVar17 + 1;
            uVar21 = ( ulong )((int)uVar21 + 1);
         }
 while ( uVar17 != 0x800 );
         LAB_00101056:if (lVar15 != 0) {
 ...
 while ( true );
   ...
   uVar17 = (ulong)uVar6;
   local_7fc = 2;
   LAB_0010026f:if (param_2 < 2) goto LAB_0010109d;
   local_78c = 0;
   do {
      local_7b8 = 2;
                  ...
                  do {
                     ...
                     do {
                        ...
                        do {
                           ...
                           switch (( uVar45 < uVar44 ) * '\x02' + ( uVar44 < local_728[3] ) * '\x04' + ( uVar45 < local_728[3] )) {
                              default:
                    uVar40 = local_7f0;
 ...
 while ( param_4 + ( ( ulong )(( uVar23 - 1 ) - (uint)(byte)bVar33) + (ulong)(byte)bVar33 ) * 0x40 + uVar46 + lVar41 + 0x40 != pbVar32 );
                     }
 ...
 while ( uVar46 + 0x361 + uVar17 + lVar41 != lVar15 );
                  ...
                  bVar33 = param_4[( ulong )(uVar43 - 1) + 0x17c0 + (long)(int)( *(byte*)( (long)__s + ( ulong )(uVar43 - 1) + 0x798 ) - 1 ) * 0x40 + uVar21 * 0x1fb70];
 ...
 while ( uVar27 != uVar19 );
                  ...
                  *(uint*)( param_4 + uVar21 * 0x1fb70 + 0x252 ) = (uint)CONCAT21(CONCAT11((undefined1)local_79c, (undefined1)local_7b8), (undefined1)local_7fc) << 8 | uVar43 & 0xff;
                  do {
 ...
 while ( local_7fc <= param_1 );
   ...
   goto LAB_00100e30;
   LAB_0010109d:local_7fc = local_7fc + 1;
   if (param_1 < local_7fc) goto LAB_001010ad;
   goto LAB_0010026f;
}
/* construct_block_size_descriptor_2d(unsigned int, unsigned int, bool, float,
   block_size_descriptor&) */void construct_block_size_descriptor_2d(uint param_1, uint param_2, bool param_3, float param_4, block_size_descriptor *param_5) {
   float fVar1;
   block_size_descriptor bVar2;
   block_size_descriptor bVar3;
   block_size_descriptor bVar4;
   ...
   *(undefined8*)( param_5 + 0xac8558 ) = 0xffffffffffffffff;
   ...
   for (uVar19 = ( ulong )(( (int)param_5 - (int)(undefined8*)( ( ulong )(param_5 + 0xac7568) & 0xfffffffffffffff8 ) ) + 0xac8560U >> 3); uVar19 != 0; uVar19 = uVar19 - 1) {
         ...
         if (*(short*)( param_5 + uVar19 * 2 + 0xac7560 ) == -1) {
            ...
            if (( iVar26 - 0x18U < 0x49 && uVar25 < 0x41 ) && ( uVar45 <= param_1 && uVar41 <= param_2 )) {
               if (local_468 < 2) {
                  ...
                  LAB_001014df:bVar5 = *(float*)( (long)pvVar12 + uVar19 * 4 ) <= param_4;
                  LAB_001014f5:if (( (int)local_468 == 3 ) || ( bVar5 )) {
                     uVar9 = uVar41 * 0x10 + uVar45;
                     uVar25 = local_378[uVar9];
                     if ((int)local_378[uVar9] < 0) {
                        if (local_470 < 8) {
                           if (( local_470 & 4 ) == 0) {
                              if (( local_470 != 0 ) && ( *(undefined1*)( (long)__s + 0x798 ) = 0(local_470 & 2) != 0 )) {
                           ...
                           do {
                              ...
                              do {
                                 ...
                                 if (iVar10 != 0) {
                                    ...
                                    *(char*)( (long)__s + lVar40 + 0xd8 ) = (char)*(uint*)( (long)&local_398 + lVar18 );
 ...
 while ( uVar47 < param_2 );
                        ...
                        do {
                           ...
                           if (bVar2 == (block_size_descriptor)0x0) {
                              LAB_00101c57:pbVar42 = param_5 + lVar40 + lVar46 + uVar22 * 0xd8;
                              do {
                                 uVar25 = (int)uVar22 + 1;
                                 uVar22 = (ulong)uVar25;
 ...
 while ( pbVar13 != param_5 + ( ( ulong )(( uVar25 - 1 ) - (uint)(byte)bVar28) + (ulong)(byte)bVar28 ) * 0x40 + uVar22 + lVar46 + 0x40 );
                           }
 ...
 while ( lVar40 != uVar33 + 0x361 + uVar22 + lVar46 );
                        ...
                        bVar28 = param_5[( ulong )(local_470 - 1) + 0x17c0 + ( ulong )(*(byte*)( (long)__s + ( ulong )(local_470 - 1) + 0x798 ) - 1) * 0x40 + uVar23 * 0x1fb70];
                        uVar43 = local_470 + 3 & 0xfffffffc;
                        if (local_470 < uVar43) {
                           uVar47 = local_470 + 3 & 0xfffffffc;
                           memset(param_5 + lVar46 + 0x1780 + local_440, 0, ( ulong )(( uVar43 - local_470 ) - 1) + 1);
...
;
 ...
 while ( iVar49 != 0xc );
                     ...
                     *(short*)( param_5 + (ulong)local_418 * 6 + 0xac8560 ) = (short)uVar19;
                     param_5[(ulong)local_418 * 6 + 0xac8565] = ( block_size_descriptor )((byte)bVar28 & 0xfe | local_3d3);
                     uVar24 = ( ushort )(1 << ( (byte)bVar35 & 0x1f ));
                     if (local_3d3 == 0) {
                        *(ushort*)( param_5 + (long)(int)uVar25 * 6 + 0x42 ) = *(ushort*)( param_5 + (long)(int)uVar25 * 6 + 0x42 ) | uVar24;
                     }
 else {
                        *(ushort*)( param_5 + (long)(int)uVar25 * 6 + 0x44 ) = *(ushort*)( param_5 + (long)(int)uVar25 * 6 + 0x44 ) | uVar24;
                     }
...
/* init_block_size_descriptor(unsigned int, unsigned int, unsigned int, bool, unsigned int, float,
   block_size_descriptor&) */void init_block_size_descriptor(uint param_1, uint param_2, uint param_3, bool param_4, uint param_5, float param_6, block_size_descriptor *param_7) {
   if (param_3 < 2) {

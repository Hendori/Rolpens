/* RendererCompositorRD::begin_frame(double) */void RendererCompositorRD::begin_frame(RendererCompositorRD *this, double param_1) {
   double dVar1;
   long in_FS_OFFSET;
...
/* RendererCompositorRD::end_frame(bool) */void RendererCompositorRD::end_frame(bool param_1) {
   bool bVar1;
   bVar1 = (bool)RenderingDevice::get_singleton();
   RenderingDevice::swap_buffers(bVar1);
   return;
}
/* RendererCompositorRD::finalize() */void RendererCompositorRD::finalize(RendererCompositorRD *this) {
   long *plVar1;
   undefined8 *puVar2;
   undefined8 uVar3;
...
/* RendererCompositorRD::~RendererCompositorRD() */void RendererCompositorRD::~RendererCompositorRD(RendererCompositorRD *this) {
   long *plVar1;
   uint uVar2;
   Object *pOVar3;
   char cVar4;
 ...
 while ( lVar5 != (ulong)uVar2 << 2 );
   ...
   LAB_0010073b:*(undefined***)( this + 0xb8 ) = &PTR__BlitShaderRD_00105fe0;
...
/* RendererCompositorRD::RendererCompositorRD() */void RendererCompositorRD::RendererCompositorRD(RendererCompositorRD *this) {
   ...
   *(FramebufferCacheRD**)( this + 0x18 ) = this_01;
   ...
   if (local_78 == (Object*)0x0) {
      operator+((char *)&
      local_68,(String*)"Can\'t create shader cache folder, no shader caching will happen: ";
      uVar14 = 0x117;
      LAB_00100e20:_err_print_error("RendererCompositorRD", "servers/rendering/renderer_rd/renderer_compositor_rd.cpp", uVar14, (StringName*)&local_68, 0, 0);
      pcVar4 = local_68;
      ...
      ProjectSettings::get_singleton();
      StringName::StringName((StringName*)&local_68, "rendering/shader_compiler/shader_cache/enabled", false);
      ...
      if (( *(char*)( lVar12 + 0xc0 ) != '\0' ) || ( bVar7 )) {
         if (( local_80 != (char*)0x0 ) && ( 1 < *(uint*)( local_80 + -8 ) )) {
            ProjectSettings::get_singleton();
            StringName::StringName((StringName*)&local_68, "rendering/shader_compiler/shader_cache/compress", false);
            ProjectSettings::get_setting_with_override((StringName*)local_58);
            bVar7 = Variant::operator_cast_to_bool((Variant*)local_58);
            if (Variant::needs_deinit[local_58[0]] != '\0') {
               Variant::_clear_internal();
            ...
            ProjectSettings::get_singleton();
            StringName::StringName((StringName*)&local_68, "rendering/shader_compiler/shader_cache/use_zstd_compression", false);
            ProjectSettings::get_setting_with_override((StringName*)local_58);
            ...
            ProjectSettings::get_singleton();
            StringName::StringName((StringName*)&local_68, "rendering/shader_compiler/shader_cache/strip_debug", false);
            ProjectSettings::get_setting_with_override((StringName*)local_58);
   ...
   if (( ( local_78 != (Object*)0x0 ) && ( cVar8 = RefCounted::unreference() ),pOVar5 = local_78,cVar8 != '\0' )) &&( cVar8 = cVar8 != '\0' )(**(code**)( *(long*)pOVar5 + 0x140 ))(pOVar5);
   Memory::free_static(pOVar5, false);
}
pcVar4 = local_80;if (local_80 != (char*)0x0) {
   LOCK();
   plVar1 = (long*)( local_80 + -0x10 );
   *plVar1 = *plVar1 + -1;
   UNLOCK();
...
if (singleton == (RendererCompositorRD*)0x0) {
 ...
 while ( !bVar7 );
   ...
   LAB_00100d3b:uVar14 = RenderingDevice::get_singleton();
   ...
   if (( uVar15 < 0x30 ) || ( cVar8 != '\0' )) {
      ...
      if (( cVar8 != '\0' ) && ( RendererCompositorRD() )) {
         _err_print_error("RendererCompositorRD", "servers/rendering/renderer_rd/renderer_compositor_rd.cpp", 0x146, "Platform supports less than 48 textures per stage which is less than required by the Clustered renderer. Defaulting to Mobile renderer.", 0, 1);
         RendererCompositorRD()::first_print =
         '\0';
      }
 ...
 while ( !bVar7 );
         ...
         LAB_00100f27:local_78 = (Object*)0x0;
         local_68 = "Cannot instantiate RenderingDevice-based renderer with renderer type \'%s\'. Defaulting to Forward+ renderer.";
         local_60 = 0x6b;
         String::parse_latin1((StrRange*)&local_78);
         vformat<String>((StringName*)&local_68, (StrRange*)&local_78, &local_70);
         _err_print_error("RendererCompositorRD", "servers/rendering/renderer_rd/renderer_compositor_rd.cpp", 0x14d, (StringName*)&local_68, 0, 0);
         pcVar4 = local_68;
         if (local_68 != (char*)0x0) {
            LOCK();
            plVar1 = (long*)( local_68 + -0x10 );
      ...
      RendererSceneRenderImplementation::RenderForwardClustered::RenderForwardClustered((RenderForwardClustered*)this_10);
   }
   ...
   *(RenderForwardMobile**)( this + 0x60 ) = this_10;
   ...
   _err_print_error("RendererCompositorRD", "servers/rendering/renderer_rd/renderer_compositor_rd.cpp", 0x135, "Condition \"singleton != nullptr\" is true.", "A RendererCompositorRD singleton already exists.", 0, 0);
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RendererCompositorRD::initialize() */void RendererCompositorRD::initialize(RendererCompositorRD *this) {
   long *plVar1;
   undefined8 *__dest;
   Vector *pVVar2;
   char cVar3;
      ...
      if (*(long*)( this + 0xd0 ) != 0) {
         ...
         if (lVar13 != 0) {
            ...
            if (( uVar11 == 0 ) || ( *(uint*)( this + 0x18c ) <= (uint)uVar11 )) {
               LAB_001024a8:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
               uVar14 = 0;
               goto LAB_00101d26;
            }

            lVar13 = ( ( uVar11 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x188 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x178 ) + ( ( uVar11 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x188 ) ) * 8 );
 ...
 while ( lVar15 != 0 );
            ...
            LAB_001023b0:lVar15 = 0;
            uVar12 = uVar11;
            goto LAB_00102191;
         }

         LAB_00102170:lVar15 = 0;
         uVar12 = uVar16;
         LAB_00102191:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar12, lVar15, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar4 = (code*)invalidInstructionException();
         ( *pcVar4 )();
      ...
      lVar13 = 0;
      LAB_001023db:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, uVar16, lVar13, "p_variant", "variant_defines.size()", "", false, false);
      uVar14 = 0;
      LAB_00101d26:uVar6 = RenderingDevice::render_pipeline_create(uVar6, uVar14, uVar7, 0xffffffffffffffff, 5, (StrRange*)&local_118, (StrRange*)&local_e8, &local_b8, local_68, 0, 0, local_128);
      lVar13 = local_d0;
      *(undefined8*)( this + ( (long)(int)uVar16 + 0x46 ) * 8 + 8 ) = uVar6;
      ...
      if (*(long*)( this + 0xd0 ) == 0) {
         lVar13 = 0;
         LAB_0010232f:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, uVar16, lVar13, "p_variant", "variant_defines.size()", "", false, false);
         uVar11 = extraout_RDX;
         LAB_00102369:uVar7 = 0;
      }
 else {
         lVar13 = *(long*)( *(long*)( this + 0xd0 ) + -8 );
         ...
         if (*(char*)( lVar13 + uVar16 ) != '\0') {
            if (( uVar11 == 0 ) || ( *(uint*)( this + 0x18c ) <= (uint)uVar11 )) {
               LAB_00102510:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.");
               uVar7 = 0;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RendererCompositorRD::set_boot_image(Ref<Image> const&, Color const&, bool, bool) */void RendererCompositorRD::set_boot_image(RendererCompositorRD *this, Ref *param_1, Color *param_2, bool param_3, bool param_4) {
   Version *pVVar1;
   char *pcVar2;
   uint *puVar3;
   undefined8 *puVar4;
   ...
   long local_40;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (( *(long*)param_1 == 0 ) || ( cVar7 = cVar7 != '\0' )) goto LAB_00102818;
   ...
   if (*(long*)( this + 0xd0 ) == 0) {
      lVar18 = 0;
      LAB_00102e73:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 0, lVar18, "p_variant", "variant_defines.size()", "", false, false);
      LAB_00102eac:uVar17 = 0;
   }
 else {
      ...
      if (pcVar2 == (char*)0x0) {
         LAB_00102f48:lVar18 = 0;
         LAB_00102f4b:uVar19 = 0;
         LAB_00102f68:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar19, lVar18, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
      ...
      if (*pcVar2 != '\0') {
         if (( uVar19 == 0 ) || ( *(uint*)( this + 0x18c ) <= (uint)uVar19 )) {
            LAB_00103020:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
            uVar17 = 0;
            goto LAB_00102ab7;
         }

         lVar21 = ( ( uVar19 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x188 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x178 ) + ( ( uVar19 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x188 ) ) * 8 );
 ...
 while ( lVar18 != 0 );
   ...
   LAB_00102ab7:uVar12 = RenderingDevice::uniform_set_create<Vector<RenderingDevice::Uniform>>(uVar12, local_138, uVar17, 0, 0);
   if (local_e8[0] != 0) {
      LOCK();
   ...
   if (param_3) {
      ...
      local_60 = CONCAT44(( (float)( (ulong)local_68 >> 0x20 ) - (float)iVar9 ) * _LC83._4_4_, ( (float)local_68 - (float)iVar10 ) * (float)_LC83);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RendererCompositorRD::blit_render_targets_to_screen(int, BlitToScreen const*, int) */void RendererCompositorRD::blit_render_targets_to_screen(RendererCompositorRD *this, int param_1, BlitToScreen *param_2, int param_3) {
   long *plVar1;
   HashMap<RID,RID,HashMapHasherDefault,HashMapComparatorDefault<RID>,DefaultTypedAllocator<HashMapElement<RID,RID>>> *this_00;
   Version *pVVar2;
   undefined4 uVar3;
   undefined4 uVar4;
   char *pcVar5;
   ...
   if (iVar17 == 0) {
      ...
      pvVar20 = (void*)RenderingDevice::draw_list_begin_for_screen(iVar17, (Color*)(ulong)(uint)param_1);
      if (pvVar20 == (void*)0xffffffffffffffff) {
         if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            _err_print_error("blit_render_targets_to_screen", "servers/rendering/renderer_rd/renderer_compositor_rd.cpp", 0x2f, "Condition \"draw_list == RD::INVALID_ID\" is true.", 0, 0);
            return;
         }
         ...
         if (0 < param_3) {
            ...
            do {
               local_d0 = RendererRD::TextureStorage::render_target_get_rd_texture(*(undefined8*)( this + 0x50 ), *(undefined8*)param_2);
               if (local_d0 == 0) {
                  _err_print_error("blit_render_targets_to_screen", "servers/rendering/renderer_rd/renderer_compositor_rd.cpp", 0x33, "Condition \"rd_texture.is_null()\" is true. Continuing.", 0, 0);
               }
 else {
                  this_00 = (HashMap<RID,RID,HashMapHasherDefault,HashMapComparatorDefault<RID>,DefaultTypedAllocator<HashMapElement<RID,RID>>>*)( this + 0x270 );
                  if (( *(long*)( this + 0x278 ) != 0 ) && ( *(int*)( this + 0x29c ) != 0 )) {
                     uVar30 = CONCAT44(0, *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x298 ) * 4 ));
                     ...
                     if (uVar29 != 0) {
                        uVar31 = 0;
                        while (( uVar29 != (uint)uVar28 || ( local_d0 != *(long*)( *(long*)( *(long*)( this + 0x278 ) + lVar26 * 8 ) + 0x10 ) ) )) {
                           uVar31 = uVar31 + 1;
                           auVar7._8_8_ = 0;
                           ...
                           if (( uVar29 == 0 ) || ( auVar8._8_8_ = 0 ),auVar8._0_8_ = (ulong)uVar29 * lVar25,auVar12._8_8_ = 0,auVar12._0_8_ = uVar30,auVar9._8_8_ = 0,auVar9._0_8_ = ( ulong )(( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x298 ) * 4 ) + iVar17 ) - SUB164(auVar8 * auVar12, 8)) * lVar25,auVar13._8_8_ = 0,auVar13._0_8_ = uVar30,SUB164(auVar9 * auVar13, 8) < uVar31) goto LAB_001032c0;
                        }
;
                        uVar23 = RenderingDevice::get_singleton();
                        puVar24 = (undefined8*)HashMap<RID,RID,HashMapHasherDefault,HashMapComparatorDefault<RID>,DefaultTypedAllocator<HashMapElement<RID,RID>>>::operator [](this_00, (RID*)&local_d0);
                  ...
                  if (*(long*)( this + 0xd0 ) == 0) {
                     lVar25 = 0;
                     LAB_00103913:_err_print_index_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xa6, 0, lVar25, "p_variant", "variant_defines.size()", "", false, false);
                     uVar27 = 0;
                  }
 else {
                     ...
                     if (pcVar5 == (char*)0x0) {
                        LAB_00103870:lVar25 = 0;
                        LAB_00103873:uVar22 = 0;
                        LAB_00103890:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar22, lVar25, "p_index", "size()", "", false, true);
                        _err_flush_stdout();
                        /* WARNING: Does not return */
                     ...
                     if (( uVar22 == 0 ) || ( *(uint*)( this + 0x18c ) <= (uint)uVar22 )) {
                        LAB_00103990:_err_print_error("version_get_shader", "./servers/rendering/renderer_rd/shader_rd.h", 0xaa, "Parameter \"version\" is null.", 0, 0);
                        uVar27 = 0;
                     }
 else {
                        lVar26 = ( ( uVar22 & 0xffffffff ) % ( ulong ) * (uint*)( this + 0x188 ) ) * 0xa0 + *(long*)( *(long*)( this + 0x178 ) + ( ( uVar22 & 0xffffffff ) / ( ulong ) * (uint*)( this + 0x188 ) ) * 8 );
 ...
 while ( lVar25 != 0 );
                  ...
                  LAB_0010346e:uVar23 = RenderingDevice::uniform_set_create<Vector<RenderingDevice::Uniform>>(uVar23, local_c8, uVar27, 0);
                  puVar24 = (undefined8*)HashMap<RID,RID,HashMapHasherDefault,HashMapComparatorDefault<RID>,DefaultTypedAllocator<HashMapElement<RID,RID>>>::operator [](this_00, (RID*)&local_d0);
                  *puVar24 = uVar23;
                  if (local_98[0] != 0) {
                     LOCK();
                  ...
                  LAB_001034c4:iVar17 = RenderingDevice::get_singleton();
                  uVar22 = 2;
                  ...
                  uVar23 = RenderingDevice::get_singleton();
                  RenderingDevice::draw_list_bind_render_pipeline(uVar23, pvVar20, *(undefined8*)( this + uVar22 * 8 + 0x238 ));
                  uVar23 = RenderingDevice::get_singleton();
                  RenderingDevice::draw_list_bind_index_array(uVar23, pvVar20, *(undefined8*)( this + 0x260 ));
                  uVar23 = RenderingDevice::get_singleton();
                  puVar24 = (undefined8*)HashMap<RID,RID,HashMapHasherDefault,HashMapComparatorDefault<RID>,DefaultTypedAllocator<HashMapElement<RID,RID>>>::operator [](this_00, (RID*)&local_d0);
                  ...
                  *(undefined1(*) [16])( this + 0x78 ) = auVar35;
                  for (int i = 0; i < 6; i++) {
                     *(undefined4*)( this + ( 4*i + 152 ) ) = *(undefined4*)( param_2 + ( 4*i + 52 ) );
                  }
...
/* RendererCompositorRD::get_utilities() */undefined8 RendererCompositorRD::get_utilities(RendererCompositorRD *this) {
   return *(undefined8*)( this + 0x28 );
}
/* RendererCompositorRD::get_light_storage() */undefined8 RendererCompositorRD::get_light_storage(RendererCompositorRD *this) {
   return *(undefined8*)( this + 0x30 );
}
/* RendererCompositorRD::get_material_storage() */undefined8 RendererCompositorRD::get_material_storage(RendererCompositorRD *this) {
   return *(undefined8*)( this + 0x38 );
}
/* RendererCompositorRD::get_mesh_storage() */undefined8 RendererCompositorRD::get_mesh_storage(RendererCompositorRD *this) {
   return *(undefined8*)( this + 0x40 );
}
/* RendererCompositorRD::get_particles_storage() */undefined8 RendererCompositorRD::get_particles_storage(RendererCompositorRD *this) {
   return *(undefined8*)( this + 0x48 );
}
/* RendererCompositorRD::get_texture_storage() */undefined8 RendererCompositorRD::get_texture_storage(RendererCompositorRD *this) {
   return *(undefined8*)( this + 0x50 );
}
/* RendererCompositorRD::get_fog() */undefined8 RendererCompositorRD::get_fog(RendererCompositorRD *this) {
   return *(undefined8*)( this + 0x58 );
}
/* RendererCompositorRD::get_canvas() */undefined8 RendererCompositorRD::get_canvas(RendererCompositorRD *this) {
   return *(undefined8*)( this + 0x20 );
}
/* RendererCompositorRD::get_scene() */undefined8 RendererCompositorRD::get_scene(RendererCompositorRD *this) {
   return *(undefined8*)( this + 0x60 );
}
/* RendererCompositorRD::gl_end_frame(bool) */void RendererCompositorRD::gl_end_frame(bool param_1) {
   return;
}
...
/* RendererCompositorRD::can_create_resources_async() const */undefined8 RendererCompositorRD::can_create_resources_async(void) {
   return 1;
}
/* BlitShaderRD::~BlitShaderRD() */void BlitShaderRD::~BlitShaderRD(BlitShaderRD *this) {
...
/* RendererCompositorRD::get_gi() */long RendererCompositorRD::get_gi(RendererCompositorRD *this) {
   if (*(long*)( this + 0x60 ) != 0) {
      return *(long*)( this + 0x60 ) + 0xb50;
   }

   _err_print_error("get_gi", "servers/rendering/renderer_rd/renderer_compositor_rd.h", 0x73, "Parameter \"scene\" is null.", 0, 0);
   return 0;
}
/* CowData<RenderingDeviceCommons::PipelineColorBlendState::Attachment>::_copy_on_write() [clone
...
/* RendererCompositorRD::initialize() [clone .cold] */void RendererCompositorRD::initialize(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* WARNING: Removing unreachable block (ram,0x00104438) *//* WARNING: Removing unreachable block (ram,0x00104568) *//* WARNING: Removing unreachable block (ram,0x00104730) *//* WARNING: Removing unreachable block (ram,0x00104574) *//* WARNING: Removing unreachable block (ram,0x0010457e) *//* WARNING: Removing unreachable block (ram,0x00104710) *//* WARNING: Removing unreachable block (ram,0x0010458a) *//* WARNING: Removing unreachable block (ram,0x00104594) *//* WARNING: Removing unreachable block (ram,0x001046f0) *//* WARNING: Removing unreachable block (ram,0x001045a0) *//* WARNING: Removing unreachable block (ram,0x001045aa) *//* WARNING: Removing unreachable block (ram,0x001046d0) *//* WARNING: Removing unreachable block (ram,0x001045b6) *//* WARNING: Removing unreachable block (ram,0x001045c0) *//* WARNING: Removing unreachable block (ram,0x001046b0) *//* WARNING: Removing unreachable block (ram,0x001045cc) *//* WARNING: Removing unreachable block (ram,0x001045d6) *//* WARNING: Removing unreachable block (ram,0x00104690) *//* WARNING: Removing unreachable block (ram,0x001045e2) *//* WARNING: Removing unreachable block (ram,0x001045ec) *//* WARNING: Removing unreachable block (ram,0x00104670) *//* WARNING: Removing unreachable block (ram,0x001045f4) *//* WARNING: Removing unreachable block (ram,0x0010460a) *//* WARNING: Removing unreachable block (ram,0x00104616) *//* String vformat<String>(String const&, String const) */undefined8 *vformat<String>(undefined8 *param_1, bool *param_2, String *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<RID, RID, HashMapHasherDefault, HashMapComparatorDefault<RID>,
   DefaultTypedAllocator<HashMapElement<RID, RID> > >::operator[](RID const&) */undefined1[16];HashMap<RID,RID,HashMapHasherDefault,HashMapComparatorDefault<RID>,DefaultTypedAllocator<HashMapElement<RID,RID>>>::operator [](HashMap<RID,RID,HashMapHasherDefault,HashMapComparatorDefault<RID>,DefaultTypedAllocator<HashMapElement<RID,RID>>>
             *this,RID*param_1)

{
 ...
 while ( ( uVar43 != 0 ) && ( auVar6._8_8_ = 0 ),auVar6._0_8_ = (ulong)uVar43 * lVar46,auVar22._8_8_ = 0,auVar22._0_8_ = uVar55,auVar7._8_8_ = 0,auVar7._0_8_ = ( ulong )(( uVar53 + uVar47 ) - SUB164(auVar6 * auVar22, 8)) * lVar46,auVar23._8_8_ = 0,auVar23._0_8_ = uVar55,lVar45 = SUB168(auVar7 * auVar23, 8),uVar50 <= SUB164(auVar7 * auVar23, 8) );
   ...
   LAB_00104d23:uVar51 = CONCAT44(0, *(uint*)( hash_table_size_primes + uVar39 * 4 ));
   lVar46 = *(long*)( hash_table_size_primes_inv + uVar39 * 8 );
   uVar38 = lVar56 * 0x3ffff - 1;
   uVar38 = ( uVar38 ^ uVar38 >> 0x1f ) * 0x15;
   uVar38 = ( uVar38 ^ uVar38 >> 0xb ) * 0x41;
...
}LAB_0010496b:if ((float)uVar55 * __LC36 < (float)( iVar42 + 1 )) {
...
uVar40 = *(undefined8*)param_1;pauVar41 = (undefined1(*) [16])operator_new(0x20, "");*pauVar41 = (undefined1[16])0x0;*(undefined8*)( pauVar41[1] + 8 ) = 0;*(undefined8*)pauVar41[1] = uVar40;puVar2 = *(undefined8**)( this + 0x20 );if (puVar2 == (undefined8*)0x0) {
...
;*(undefined1(**) [16])( lVar46 + lStack_b0 * 8 ) = pauVar36;*puVar1 = uVar53;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_00104d04:auVar59._8_8_ = lStack_b0;auVar59._0_8_ = pauVar41[1] + 8;return auVar59;}/* CowData<String>::_unref() */void CowData<String>::_unref(CowData<String> *this) {
   long *plVar1;
   long *plVar2;
   long lVar3;
   long lVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<String>::resize<false>(long) */undefined8 CowData<String>::resize<false>(CowData<String> *this, long param_1) {
   ...
   if (param_1 * 8 == 0) {
      LAB_001053f0:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (lVar10 == lVar7) {
      LAB_0010536f:puVar9 = *(undefined8**)this;
      if (puVar9 == (undefined8*)0x0) {
         LAB_00105446:/* WARNING: Does not return */pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<RID>::resize<false>(long) */undefined8 CowData<RID>::resize<false>(CowData<RID> *this, long param_1) {
   ...
   if (param_1 * 8 == 0) {
      LAB_00105700:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (lVar7 == lVar3) {
      LAB_0010566c:puVar9 = *(undefined8**)this;
      if (puVar9 == (undefined8*)0x0) {
         /* WARNING: Does not return */
         pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<RenderingDeviceCommons::PipelineColorBlendState::Attachment>::resize<false>(long)
   ...
   if (param_1 * 0x20 == 0) {
      LAB_00105b70:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (lVar11 == lVar4) {
      LAB_00105adc:puVar9 = *(undefined8**)this;
      if (puVar9 == (undefined8*)0x0) {
         /* WARNING: Does not return */
         pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<RenderingDevice::Uniform>::resize<false>(long) */undefined8 CowData<RenderingDevice::Uniform>::resize<false>(CowData<RenderingDevice::Uniform> *this, long param_1) {
   ...
   if (param_1 * 0x28 == 0) {
      LAB_00105f10:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (lVar11 == lVar9) {
      LAB_00105e83:puVar7 = *(undefined8**)this;
      if (puVar7 == (undefined8*)0x0) {
         LAB_00105f66:/* WARNING: Does not return */pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
      }
 ...
 while ( puVar6 != puVar7 + param_1 * 5 );
   LAB_00105e60:puVar7[-1] = param_1;
   return 0;
}
/* WARNING: Control flow encountered bad instruction data *//* BlitShaderRD::~BlitShaderRD() */void BlitShaderRD::~BlitShaderRD(BlitShaderRD *this) {

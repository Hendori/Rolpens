...
;
 ...
 while ( true );
   ...
   __mutex[1].__align = 0;
   *(undefined8*)( (long)__mutex + 0x30 ) = 0;
   LAB_00100293:pthread_mutex_destroy(__mutex);
   free(__mutex);
...
/* bool OT::CFFIndex<OT::IntType<unsigned int, 4u>
   ...
   int, unsigned int) [clone .isra.0] */bool OT::CFFIndex<OT::IntType<unsigned_int,4u>>::serialize_header<hb_array_t<hb_vector_t<unsigned_char,false>const>,(void*)0>(uint *param_1, long param_2, long param_3, uint param_4, int param_5, uint param_6) {
   uint *puVar1;
   long lVar2;
   undefined1 *puVar3;
   long lVar4;
   ...
   if (( uVar12 < 0x80000000 ) && ( puVar1 <= *(uint**)( param_2 + 0x10 ) )) {
      ...
      *param_1 = param_4 >> 0x18 | ( param_4 & 0xff0000 ) >> 8 | ( param_4 & 0xff00 ) << 8 | param_4 << 0x18;
      if (param_4 == 0) {
         return true;
      }
      ...
      if (( __n < 0x80000000 ) && ( puVar3 <= *(undefined1**)( param_2 + 0x10 ) )) {
         ...
         *(char*)( param_1 + 1 ) = (char)param_6;
         uVar12 = ( ulong )(( ( uVar9 >> 0x18 | ( uVar9 & 0xff0000 ) >> 8 | ( uVar9 & 0xff00 ) << 8 | uVar9 << 0x18 ) + 1 ) * param_6);
         if (*(int*)( param_2 + 0x2c ) != 0) {
            return false;
         }
 ...
 while ( lVar2 != param_3 + uVar10 * 0x10 );
               ...
               *(ushort*)( puVar3 + ( ( lVar2 - param_3 ) - 0x10U >> 4 ) * 3 + 3 + 1 ) = (ushort)iVar6 << 8 | (ushort)iVar6 >> 8;
               return true;
            }
            ...
            if (3 < param_6) {
               ...
               *(undefined4*)( (long)param_1 + 5 ) = 0x1000000;
               ...
               if (lVar4 != param_3 + 0x10) {
                  lVar2 = 0;
                  do {
                     *(uint*)( (long)param_1 + lVar2 + 9 ) = uVar9 >> 0x18 | ( uVar9 & 0xff0000 ) >> 8 | ( uVar9 & 0xff00 ) << 8 | uVar9 << 0x18;
 ...
 while ( ( ( lVar4 - param_3 ) - 0x20U >> 4 ) * 4 + 4 != lVar2 );
               ...
               *(uint*)( (long)param_1 + ( ( lVar4 - param_3 ) - 0x10U >> 4 ) * 4 + 9 ) = uVar9 >> 0x18 | ( uVar9 & 0xff0000 ) >> 8 | ( uVar9 & 0xff00 ) << 8 | uVar9 << 0x18;
               return true;
            }
 ...
 while ( lVar2 != ( ( lVar4 - param_3 ) - 0x20U >> 4 ) * 2 + 2 );
            ...
            *(ushort*)( (long)param_1 + ( ( lVar4 - param_3 ) - 0x10U >> 4 ) * 2 + 7 ) = uVar5 << 8 | uVar5 >> 8;
            return true;
         }
...
/* bool OT::CFFIndex<OT::IntType<unsigned int, 4u> >::serialize<hb_vector_t<hb_vector_t<unsigned
   ...
   false>, false> const&, unsigned int const*, unsigned int) [clone .isra.0] */bool OT::CFFIndex<OT::IntType<unsigned_int,4u>>::serialize<hb_vector_t<hb_vector_t<unsigned_char,false>,false>,(void*)0>(CFFIndex<OT::IntType<unsigned_int,4u>> *this, hb_serialize_context_t *param_1, hb_vector_t *param_2, uint *param_3, uint param_4) {
   uint *puVar1;
   uint uVar2;
   bool bVar3;
   void *pvVar4;
            ...
            if (puVar5 != param_3) {
               do {
                  while (true) {
                     uVar2 = param_3[1];
                     if (uVar2 != 0) break;
                     LAB_001006cb:param_3 = param_3 + 4;
                     if (puVar5 == param_3) {
                        return bVar3;
                     }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* hb_inc_bimap_t::add(unsigned int) [clone .isra.0] */void hb_inc_bimap_t::add(hb_inc_bimap_t *this, uint param_1) {
   byte bVar1;
   ushort uVar2;
   uint uVar3;
   char cVar4;
 ...
 while ( ( bVar1 & 2 ) != 0 );
   ...
   if (( uVar7 >> 1 ) + uVar7 < *(uint*)( this + 0x1c )) {
      LAB_0010081e:iVar12 = *(int*)( this + 0x14 );
      uVar9 = ( ulong )(param_1 * -0x61c8864f & 0x3fffffff) % (ulong)uVar11;
      lVar6 = uVar9 * 0xc;
 ...
 while ( ( bVar1 & 2 ) != 0 );
         if (uVar13 == 0xffffffff) {
            LAB_00100906:uVar7 = uVar7 + 1;
         }
 else {
            LAB_00100893:lVar6 = (ulong)uVar13 * 0xc;
            LAB_0010089e:puVar8 = (uint*)( lVar10 + lVar6 );
      ...
      cVar4 = hb_hashmap_t<unsigned_int,unsigned_int,true>::alloc((hb_hashmap_t<unsigned_int,unsigned_int,true>*)this, 0);
      if (cVar4 != '\0') {
         lVar10 = *(long*)( this + 0x28 );
         uVar11 = *(uint*)( this + 0x20 );
         uVar7 = *(uint*)( this + 0x18 );
   ...
   uVar3 = *(uint*)( this + 0x34 );
   LAB_001008da:if (*(int*)( this + 0x30 ) <= (int)uVar3) {
      cVar4 = hb_vector_t<unsigned_int,false>::alloc((hb_vector_t<unsigned_int,false>*)( this + 0x30 ), uVar3 + 1, false);
      if (cVar4 == '\0') {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* OT::cff2::accelerator_subset_t::serialize(hb_serialize_context_t*, OT::cff2_subset_plan&,
   hb_array_t<int>) const */bool OT::cff2::accelerator_subset_t::serialize(long param_1, hb_serialize_context_t *param_2, long param_3, undefined8 param_4, undefined8 param_5) {
   byte bVar1;
   undefined8 uVar2;
   undefined2 *puVar3;
   ushort *puVar4;
   ...
   if (*(int*)( param_2 + 0x2c ) == 0) {
      plVar13 = (long*)hb_pool_t<hb_serialize_context_t::object_t,32u>::alloc((hb_pool_t<hb_serialize_context_t::object_t,32u>*)( param_2 + 0x30 ));
      if (plVar13 == (long*)0x0) {
         if (*(int*)( param_2 + 0x2c ) == 0) {
      ...
      *(long**)( param_2 + 0x48 ) = plVar13;
      ...
      uVar38 = 4;
      LAB_00100b0b:if ((long)uVar38 <= lVar37 - lVar27) {
         ...
         *plVar13 = lVar37;
         plVar13[1] = lVar37;
         bVar6 = CFFIndex<OT::IntType<unsigned_int,4u>>::serialize_header<hb_array_t<hb_vector_t<unsigned_char,false>const>,(void*)0>(lVar37, param_2, lVar41, uVar21, uVar22);
         if (( bVar6 ) && ( *(int*)( param_2 + 0x2c ) == 0 )) {
            if (( uVar22 < 0x80000000 ) && ( puVar28 = *(undefined1**)( param_2 + 8 ) ),(long)uVar22 <= *(long*)( param_2 + 0x10 ) - (long)puVar28) {
               *(undefined1**)( param_2 + 8 ) = puVar28 + uVar22;
               if (puVar28 != (undefined1*)0x0) {
                  lVar14 = uVar21 * 0x10 + lVar41;
                  joined_r0x00100b97:if (lVar14 != lVar41) {
                     do {
 ...
 while ( uStack_6c < uVar29 );
                     if (( uStack_6c < 0x15555556 ) && ( pvStack_80 = malloc(uVar21 * 0xc) ),pvStack_80 != (void*)0x0) {
                  ...
                  LAB_00100c18:uVar33 = *(int*)( param_1 + 0xb4 ) - 1;
                  lStack_b8 = (long)(int)uVar33 << 4;
                  if ((int)uVar33 < 0) goto LAB_00100f63;
                  LAB_00100c50:lVar41 = *(long*)( param_3 + 0x68 );
                  if (lVar41 != 0) {
                        ...
                        do {
                           if (*puVar16 == uVar33) {
                              if (( bVar1 & 1 ) != 0) {
                                 ...
                                 if (uVar9 != 0) {
                                    if (*(int*)( param_2 + 0x2c ) == 0) {
                                       puVar17 = (undefined8*)hb_pool_t<hb_serialize_context_t::object_t,32u>::alloc((hb_pool_t<hb_serialize_context_t::object_t,32u>*)( param_2 + 0x30 ));
                                    ...
                                    bVar6 = CFFIndex<OT::IntType<unsigned_int,4u>>::serialize<hb_vector_t<hb_vector_t<unsigned_char,false>,false>,(void*)0>(this, param_2, (hb_vector_t*)( ulong ) * (uint*)( puVar30 + 4 ), *(uint**)( puVar30 + 8 ), 0);
                                 ...
                                 uStack_68 = CONCAT62(CONCAT51(uStack_68._3_5_, *(undefined1*)( param_3 + 0x2c )), CONCAT11(*(undefined1*)( param_3 + 0xb0 ), *(undefined1*)( param_3 + 0xb1 )));
 ...
 while ( ( bVar1 & 2 ) != 0 );
      ...
      LAB_00101630:*(undefined4*)( param_2 + 0x2c ) = 4;
      bVar6 = false;
   }
 else {
      LAB_001015ff:uVar21 = ( ulong ) * (uint*)( param_3 + 0x84 );
      uVar33 = *(uint*)( param_3 + 0xb4 );
      lVar41 = *(long*)( param_3 + 0x88 );
      if (*(uint*)( param_3 + 0x84 ) != 0) {
         LAB_00100a97:uVar22 = 0;
         lVar14 = lVar41;
         do {
 ...
 while ( uVar21 * 0x10 + lVar41 != lVar14 );
      ...
      LAB_00101620:bVar6 = false;
   }

   goto LAB_00100e65;
   code_r0x00100bcd:lVar41 = lVar41 + 0x10;
   *puVar28 = *(undefined1*)*puVar17;
   puVar28 = puVar28 + 1;
   goto joined_r0x00100b97;
   while (lVar41 = lVar41 + 1,(uint)lVar41 < *(uint*)( puVar30 + 0xc )) {
      LAB_00100e32:cVar7 = cff2_private_dict_op_serializer_t::serialize((cff2_private_dict_op_serializer_t*)&uStack_68, param_2, (op_str_t*)( lVar41 * 0x10 + *(long*)( puVar30 + 0x10 ) ), uVar9);
      if (cVar7 == '\0') goto LAB_00100e4f;
   }
;
   LAB_00100e94:lVar41 = *(long*)( param_3 + 0x68 );
 ...
 while ( ( bVar1 & 2 ) != 0 );
   ...
   LAB_00100f0f:piVar20 = *(int**)( param_2 + 0x48 );
   uVar10 = *puVar16;
   joined_r0x00100f18:if (piVar20 == (int*)0x0) {
      iVar24 = 0;
   }
 else {
   ...
   *(undefined4*)( puVar30 + 8 ) = uVar12;
   LAB_00100f52:uVar33 = uVar33 - 1;
   lStack_b8 = lStack_b8 + -0x10;
   if (uVar33 == 0xffffffff) goto LAB_00100f63;
   goto LAB_00100c50;
   LAB_00100f63:pFVar31 = *(FDSelect**)( param_1 + 0x90 );
   ...
   if (pFVar31 != (FDSelect*)&_hb_NullPool) {
      ...
      cVar7 = hb_serialize_cff_fdselect(param_2, *(uint*)( param_3 + 0x18 ), pFVar31, *(uint*)( param_3 + 0x1c ), *(uint*)( param_3 + 0x28 ), *(uint*)( param_3 + 0x24 ), (hb_vector_t*)( param_3 + 0x30 ));
      if (cVar7 != '\0') {
   ...
   LAB_00100ffa:if (iVar24 == 0) {
      ...
      lVar14 = lVar41;
      if (iVar34 != 0) {
         LAB_0010104b:lVar37 = *(long*)( param_3 + 0x68 );
         lVar41 = lVar14;
         do {
 ...
 while ( iVar34 != 0 );
      ...
      LAB_00101b95:piStack_60 = (int*)0x0;
      uStack_68 = 0;
   }
         ...
         if (*(int*)( lVar41 + 0xc ) == 0) {
            ...
            do {
               ...
               if ((int)plVar13[1] == 0x12) {
                  if (*(int*)( param_2 + 0x2c ) == 0) {
                     uVar33 = *puVar40;
                     if (*(uint**)( param_2 + 0x10 ) != puVar32 && -1 < (long)*(uint**)( param_2 + 0x10 ) - (long)puVar32) {
                        ...
                        if (1 < *(long*)( param_2 + 0x10 ) - (long)puVar32) {
                           ...
                           *puVar4 = uVar8 << 8 | uVar8 >> 8;
                           if ((long)(short)( ( uVar8 >> 8 ) << 8 | uVar8 & 0xff ) == (ulong)uVar33) {
                              bVar6 = CFF::Dict::serialize_link_op<OT::IntType<int,4u>,29>(param_2, (int)plVar13[1], puVar40[1], 2);
                     ...
                     LAB_00101848:*(undefined4*)( param_2 + 0x2c ) = 4;
                  }
               ...
               if (bVar1 != 0) {
                  if (bVar1 < 8) {
                     ...
                     *(undefined8*)( (long)puVar32 + ( uVar21 - 8 ) ) = 0;
                     ...
                     for (uVar22 = ( ulong )((uint)bVar1 + ( (int)puVar32 - (int)(undefined8*)( ( ulong )(puVar32 + 2) & 0xfffffffffffffff8 ) ) >> 3); uVar22 != 0; uVar22 = uVar22 - 1) {
                        *puVar17 = 0;
 ...
 while ( (uint)lVar14 < *(uint*)( lVar41 + 0xc ) );
         ...
         LAB_00101236:if (iVar24 <= (int)uStack_68._4_4_) {
            cVar7 = hb_vector_t<unsigned_int,false>::alloc((hb_vector_t<unsigned_int,false>*)&uStack_68, uStack_68._4_4_ + 1, false);
 ...
 while ( true );
   ...
   *(uint**)( param_2 + 8 ) = puVar18;
   if (( pvVar15 == (void*)0x0 ) || ( puVar16 == (uint*)0x0 )) {
      LAB_00101b48:if (iVar24 != 0) goto LAB_00101b50;
      LAB_00100e4f:hb_serialize_context_t::pop_discard(param_2);
      LAB_00100e57:bVar6 = false;
   }
 else {
               ...
               *(long*)( param_2 + 8 ) = lVar14;
               if (lVar41 != 0) {
                  ...
                  *(char*)( puVar16 + 1 ) = (char)uVar29;
                  uVar22 = ( ulong )(( ( uVar33 >> 0x18 | ( uVar33 & 0xff0000 ) >> 8 | ( uVar33 & 0xff00 ) << 8 | uVar33 << 0x18 ) + 1 ) * uVar29);
                  if (*(int*)( param_2 + 0x2c ) == 0) {
 ...
 while ( piVar36 != piVar20 + uVar21 );
                           *(ushort*)( puVar28 + ( ( ulong )((long)piVar36 + ( -4 - (long)piVar20 )) >> 2 ) * 3 + 3 + 1 ) = (ushort)iVar34 << 8 | (ushort)iVar34 >> 8;
                           puVar28[( ( ulong )((long)piVar36 + ( -4 - (long)piVar20 )) >> 2 ) * 3 + 3] = (char)( (uint)iVar34 >> 0x10 );
                        }
 else if (uVar29 == 4) {
                           *(undefined4*)( (long)puVar16 + 5 ) = 0x1000000;
                           ...
                           if (piVar20 + uVar21 != piVar20 + 1) {
                              lVar41 = 0;
                              do {
                                 *(uint*)( (long)puVar16 + lVar41 + 9 ) = uVar33 >> 0x18 | ( uVar33 & 0xff0000 ) >> 8 | ( uVar33 & 0xff00 ) << 8 | uVar33 << 0x18;
 ...
 while ( lVar41 != (long)( piVar20 + uVar21 ) + ( -4 - (long)piVar20 ) );
                           ...
                           *(uint*)( puVar28 + uVar21 * 4 ) = uVar33 >> 0x18 | ( uVar33 & 0xff0000 ) >> 8 | ( uVar33 & 0xff00 ) << 8 | uVar33 << 0x18;
                        }
 else if (uVar29 == 1) {
                           uVar22 = uVar21 * 4 - 4 >> 2;
                           iVar34 = 1;
 ...
 while ( bVar6 );
                           ...
                           *(undefined2*)( (long)puVar16 + 5 ) = 0x100;
                           ...
                           if (piVar35 != piVar20 + 1) {
                              lVar41 = 0;
                              do {
                                 *(ushort*)( (long)puVar16 + lVar41 + 7 ) = (ushort)iVar34 << 8 | (ushort)iVar34 >> 8;
 ...
 while ( lVar41 != ( ( ulong )((long)piVar35 + ( -8 - (long)piVar20 )) >> 2 ) * 2 + 2 );
                           ...
                           *(ushort*)( (long)puVar16 + ( ( ulong )((long)piVar35 + ( -4 - (long)piVar20 )) >> 2 ) * 2 + 7 ) = uVar8 << 8 | uVar8 >> 8;
                        }
               ...
               LAB_00101b41:*(undefined4*)( param_2 + 0x2c ) = 4;
            }
      ...
      joined_r0x00101c6f:if (iVar24 != 0) {
         free(piVar20);
      }
      ...
      *(undefined4*)( param_3 + 0xc ) = uVar11;
      ...
      LAB_001014cc:if (*(int*)( param_2 + 0x2c ) != 0) goto LAB_00100e57;
      if (*(long*)( param_2 + 0x10 ) - (long)*(void**)( param_2 + 8 ) < 5) {
         LAB_00101882:*(undefined4*)( param_2 + 0x2c ) = 4;
         goto LAB_00100e57;
      }
         ...
         do {
            ...
            if (iVar24 == 0x18) {
               if (*(int*)( param_3 + 0x14 ) != 0) {
                  bVar6 = CFF::Dict::serialize_link_op<OT::IntType<int,4u>,29>(param_2, 0x18, *(int*)( param_3 + 0x14 ), 0);
                  goto LAB_001015a1;
               }
               ...
               if (iVar24 == 0x124) {
                  bVar6 = CFF::Dict::serialize_link_op<OT::IntType<int,4u>,29>(param_2, 0x124, *(undefined4*)( param_3 + 0xc ), 2);
               }
 else if (iVar24 == 0x125) {
                  bVar6 = CFF::Dict::serialize_link_op<OT::IntType<int,4u>,29>(param_2, 0x125, *(undefined4*)( param_3 + 8 ), 2);
               }
 else {
                  if (iVar24 != 0x11) {
 ...
 while ( (uint)lVar37 < ( uint ) * (byte*)( (long)plVar13 + 0xc ) );
                  ...
                  bVar6 = CFF::Dict::serialize_link_op<OT::IntType<int,4u>,29>(param_2, 0x11, *(undefined4*)( param_3 + 0x10 ), 2);
               }

               LAB_001015a1:if (bVar6 == false) goto LAB_00100e57;
            }

            LAB_0010154b:lVar41 = lVar41 + 1;
         }
 while ( (uint)lVar41 < *(uint*)( param_1 + 0x54 ) );
      ...
      *(ushort*)( (long)puVar3 + 3 ) = uVar8;
      bVar6 = CFFIndex<OT::IntType<unsigned_int,4u>>::serialize<hb_vector_t<hb_vector_t<unsigned_char,false>,false>,(void*)0>(*(CFFIndex<OT::IntType<unsigned_int,4u>>**)( param_2 + 8 ), param_2, (hb_vector_t*)( ulong ) * (uint*)( param_3 + 0x94 ), *(uint**)( param_3 + 0x98 ), 0);
   }

   if (uStack_6c != 0) {
      LAB_001013c8:free(pvStack_80);
   }

   LAB_00100e65:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return bVar6;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* OT::cff2::accelerator_subset_t::subset(hb_subset_context_t*) const */undefined4 OT::cff2::accelerator_subset_t::subset(accelerator_subset_t *this, hb_subset_context_t *param_1) {
   int *piVar1;
   int *piVar2;
   undefined8 uVar3;
   undefined4 uVar4;
   ...
   if ((char)uVar4 != '\0') {
      uVar4 = serialize(this, *(undefined8*)( param_1 + 0x18 ), local_f8, *(undefined8*)( *(long*)( param_1 + 0x10 ) + 0x890 ), *(undefined4*)( *(long*)( param_1 + 0x10 ) + 0x88c ));
   }
...
;
 ...
 while ( piVar8 != piVar6 );
                  LAB_0010201b:__ptr = *(void**)( piVar7 + 2 );
               }
...
;
 ...
 while ( piVar1 != piVar7 );
      ...
      LAB_001020a9:free(local_60);
      uVar3 = local_78;
   }

   local_78 = uVar3;
   if ((int)local_78 == 0) {} else {
...
/* char* hb_vector_t<char, false>::push<int>(int&&) [clone .isra.0] */char *__thiscallhb_vector_t<char,false>::push<int>(hb_vector_t<char,false> *this, int *param_1) {
   uint uVar1;
   uint uVar2;
   void *__ptr;
   uint uVar3;
   ...
   if ((int)uVar1 < (int)uVar2) {
      ...
      if ((int)uVar2 < 0) {
         LAB_001021f8:uVar2 = (uint)_hb_NullPool;
         _hb_CrapPool = _hb_NullPool;
         goto LAB_001021a3;
      }
 ...
 while ( uVar2 < uVar3 );
   ...
   *(char*)( (long)__ptr + uVar4 ) = (char)uVar2;
   LAB_001021a3:return (char*)(ulong)uVar2;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* CFF::subr_subsetter_t<cff2_subr_subsetter_t, CFF::Subrs<OT::IntType<unsigned int, 4u> >,
   ...
   65535u>::drop_hints_param_t&) [clone .isra.0] */undefined8 CFF::subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>::drop_hints_in_str(parsed_cs_str_t *param_1, subr_subset_param_t *param_2, drop_hints_param_t *param_3) {
   ushort uVar1;
   long lVar2;
   char cVar3;
   long lVar4;
   ...
   if (*(uint*)( param_1 + 0xc ) == 0) {
      ...
      do {
         while (uVar8 = *(uint*)( lVar4 + -8 + lVar12 ),0x1d < uVar8) {
            ...
            LAB_0010240a:*(undefined1*)( lVar4 + -3 + lVar12 ) = 1;
            joined_r0x0010241b:lVar12 = lVar12 + 0x10;
            uVar7 = uVar7 + 1;
...
switchD_0010228d_caseD_2:
         ...
         joined_r0x001023d0:lVar12 = lVar12 + 0x10;
         uVar7 = uVar7 + 1;
      }
 while ( uVar13 != uVar7 );
      LAB_0010231c:param_3[2] = (drop_hints_param_t)0x1;
...
/* hb_bit_set_t::resize(unsigned int, bool, bool) */hb_bit_set_t hb_bit_set_t::resize(hb_bit_set_t *this, uint param_1, bool param_2, bool param_3) {
 ...
 while ( uVar8 < param_1 );
      ...
      LAB_001027b7:*(uint*)( this + 0x20 ) = ~uVar2;
      goto LAB_001027bc;
   }
   ...
   if (uVar2 == 0) {
      param_1 = 1;
      uVar8 = 1;
      LAB_00102949:pvVar3 = *(void**)( this + 0x28 );
      param_3 = (bool)hVar1;
      LAB_00102950:pvVar3 = realloc(pvVar3, (ulong)uVar8 * 0x48);
      if (pvVar3 == (void*)0x0) {
         uVar2 = *(uint*)( this + 0x20 );
         if (uVar2 < uVar8) goto LAB_001027b7;
      }
 else {
         LAB_0010296c:*(void**)( this + 0x28 ) = pvVar3;
   ...
   LAB_00102703:if (( (uint)uVar7 < param_1 ) && ( param_2 )) {
 ...
 while ( uVar2 < param_1 );
      ...
      LAB_001027cf:if (( (uint)uVar6 < param_1 ) && ( param_2 )) {
 ...
 while ( uVar8 < uVar5 );
      ...
      LAB_00102874:uVar8 = *(uint*)( this + 0x24 );
   }
 else {
      LAB_001028b6:uVar8 = *(uint*)( this + 0x24 );
      uVar5 = (uint)uVar6;
      if (uVar5 <= uVar8) {
         uVar6 = (ulong)uVar8;
      }
      ...
      uVar9 = (uint)uVar6;
      if (uVar2 < uVar9) {
         LAB_00102840:if (0x38e38e3 < (uint)uVar6) goto LAB_001027b7;
         pvVar3 = *(void**)( this + 0x28 );
         LAB_00102851:uVar8 = (uint)uVar6;
         ...
         if (pvVar3 == (void*)0x0) {
            ...
            LAB_0010286d:*(void**)( this + 0x28 ) = pvVar3;
            *(uint*)( this + 0x20 ) = uVar8;
         }
   ...
   if (( uVar8 < uVar5 ) && ( param_2 )) {
      hb_memset((void*)( *(long*)( this + 0x28 ) + (ulong)uVar8 * 0x48 ), ( uVar5 - uVar8 ) * 0x48, uVar8 * 9);
   }

   *(uint*)( this + 0x24 ) = uVar5;
   LAB_001027bc:*this = (hb_bit_set_t)0x0;
   return (hb_bit_set_t)0x0;
}
/* hb_bit_set_t::next(unsigned int*) const */undefined8 hb_bit_set_t::next(hb_bit_set_t *this, uint *param_1) {
 ...
 while ( uVar3 != uVar8 );
   ...
   if (uVar9 < uVar2) {
      ...
      LAB_00102b0a:uVar2 = uVar3 + 1 & 0x1ff;
      if (uVar2 != 0) {
         uVar4 = ( ulong )(uVar2 >> 6);
      ...
      if ((int)( uVar2 - 1 ) < 0) {
         ...
         do {
            while (true) {
               ...
               uVar9 = uVar10;
               if (( uVar16 == uVar3 ) || ( uVar9 = iVar12 < (int)uVar9 )) goto LAB_00102cdb;
            }
;
            iVar12 = uVar10 - 1;
         }
 while ( (int)uVar9 <= iVar12 );
      ...
      LAB_00102cdb:if (uVar2 <= uVar9) goto LAB_00102bc8;
      LAB_00102ce4:*(uint*)( this + 8 ) = uVar9;
      puVar13 = (uint*)( lVar5 + (ulong)uVar9 * 8 );
      lVar14 = *(long*)( this + 0x28 );
      if (*puVar13 == uVar16) {
         uVar3 = *param_1;
 ...
 while ( uVar9 != *(uint*)( this + 0x14 ) );
   ...
   LAB_00102bc8:*param_1 = 0xffffffff;
   return 0;
   LAB_00102c87:uVar4 = *(ulong*)( piVar11 + uVar8 * 2 + 2 );
   if (uVar4 != 0) {
      iVar12 = 0;
      ...
      uVar8 = (ulong)uVar3;
      iVar12 = uVar3 + iVar12;
      LAB_00102c9f:uVar3 = iVar12 + *piVar15 * 0x200;
   ...
   LAB_00102dbc:if (param_2) {
      ...
      if (cVar6 != '\0') {
         ...
         *(ulong*)( *(long*)( this + 0x18 ) + (ulong)uVar8 * 8 ) = CONCAT44(uVar4, uVar9);
         uVar7 = uVar8;
         LAB_00102e55:*(uint*)( this + 8 ) = uVar7;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* CFF::subr_subsetter_t<cff2_subr_subsetter_t, CFF::Subrs<OT::IntType<unsigned int, 4u> >,
   ...
   CFF::parsed_cs_str_vec_t&, hb_set_t*, CFF::subr_subset_param_t const&) [clone .isra.0] */void CFF::subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>::collect_subr_refs_in_subr(uint param_1, parsed_cs_str_vec_t *param_2, hb_set_t *param_3, subr_subset_param_t *param_4) {
   uint *puVar1;
   uint uVar2;
   uint uVar3;
   uint uVar4;
   ...
   if (( *(uint*)( param_3 + 0x18 ) < *(uint*)( param_3 + 0x24 ) ) && ( puVar1 = (uint*)( *(long*)( param_3 + 0x28 ) + ( ulong ) * (uint*)( param_3 + 0x18 ) * 8 ) ),uVar3 == *puVar1) {
      ...
      LAB_00102fe5:if (lVar7 == 0) goto LAB_00102f31;
      ...
      LAB_00102f83:if (param_1 < *(uint*)( param_2 + 4 )) {
...
;
 ...
 while ( iVar10 <= iVar9 );
      ...
      LAB_00102f31:if (param_3[0x40] != (hb_set_t)0x0) {
         return;
      }

      LAB_00102f3b:if (param_3[0x10] == (hb_set_t)0x0) goto LAB_00102f83;
   ...
   LAB_00102f9a:if (( puVar6[0x18] & 0x10 ) != 0) {
      ...
      if (uVar10 == 0) {
         ...
         *(long*)( this + 0x10 ) = lVar2;
         while (1 < uVar10) {
            ...
            if (lVar2 == 0) {
               LAB_0010339a:iVar4 = *(int*)( puVar19 + 2 );
            }
 else {
...
/* OT::ItemVariationStore::get_region_scalars(unsigned int, int const*, unsigned int, float*,
   unsigned int) const */void OT::ItemVariationStore::get_region_scalars(ItemVariationStore *this, uint param_1, int *param_2, uint param_3, float *param_4, uint param_5) {
   ushort uVar1;
   int iVar2;
   uint uVar3;
   uint uVar4;
   ...
   if (uVar3 != 0) {
      pIVar11 = this + ( uVar3 >> 0x18 | ( uVar3 & 0xff0000 ) >> 8 | ( uVar3 & 0xff00 ) << 8 | uVar3 << 0x18 );
   }
   ...
   if (uVar3 != 0) {
      ...
      lVar14 = 0;
      do {
         uVar4 = ( uint )(ushort)(*(ushort*)( pIVar8 + lVar14 + 6 ) << 8 | *(ushort*)( pIVar8 + lVar14 + 6 ) >> 8);
               ...
               do {
                  ...
                  if ((uint)lVar5 < param_3) {
                     ...
                     if (( uVar6 != 0 ) && ( iVar2 != iVar10 )) {
                        ...
                        if (( ( iVar7 <= iVar10 ) && ( iVar10 <= iVar13 ) ) && ( ( -1 < (short)uVar6 || ( (short)uVar12 < 1 ) ) )) {
...
/* CFF::CFF2FDSelect::get_fd(unsigned int) const */ushort CFF::CFF2FDSelect::get_fd(CFF2FDSelect *this, uint param_1) {
   CFF2FDSelect CVar1;
   uint uVar2;
   uint uVar3;
   CFF2FDSelect *pCVar4;
...
;
               if (param_1 < ( ushort )(*(ushort*)( pCVar5 + 3 ) << 8 | *(ushort*)( pCVar5 + 3 ) >> 8)) goto LAB_0010387a;
               iVar7 = uVar3 + 1;
            }
 while ( iVar7 <= iVar6 );
         }

         LAB_0010384e:pCVar5 = (CFF2FDSelect*)&_hb_NullPool;
         uVar3 = ( ushort )(*(ushort*)( this + 1 ) << 8 | *(ushort*)( this + 1 ) >> 8) - 1;
         if (uVar3 < ( ushort )(*(ushort*)( this + 1 ) << 8 | *(ushort*)( this + 1 ) >> 8)) {
            pCVar5 = this + (ulong)uVar3 * 3 + 3;
         }

         LAB_0010387a:return (ushort)(byte)pCVar5[2];
      }
         ...
         if (-1 < iVar6) {
            ...
            do {
               while (true) {
                  ...
                  uVar3 = *(uint*)pCVar5;
                  if (( uVar3 >> 0x18 | ( uVar3 & 0xff0000 ) >> 8 | ( uVar3 & 0xff00 ) << 8 | uVar3 << 0x18 ) <= param_1) break;
                  iVar6 = uVar2 - 1;
                  if (iVar6 < iVar7) goto LAB_001037a5;
               }
;
               uVar3 = *(uint*)( pCVar5 + 6 );
               if (param_1 < ( uVar3 >> 0x18 | ( uVar3 & 0xff0000 ) >> 8 | ( uVar3 & 0xff00 ) << 8 | uVar3 << 0x18 )) goto LAB_001037c1;
               iVar7 = uVar2 + 1;
            }
 while ( iVar7 <= iVar6 );
         }

         LAB_001037a5:uVar3 = *(uint*)( this + 1 );
         ...
         LAB_001037c1:return *(ushort*)( pCVar5 + 4 ) << 8 | *(ushort*)( pCVar5 + 4 ) >> 8;
      }
...
/* CFF::subr_subsetter_t<cff2_subr_subsetter_t, CFF::Subrs<OT::IntType<unsigned int, 4u> >,
   OT::cff2::accelerator_subset_t const, CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,
   cff2_cs_opset_subr_subset_t, 65535u>::~subr_subsetter_t() */void CFF::subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>::~subr_subsetter_t(subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u> *this) {
   int *piVar1;
   hb_hashmap_t *phVar2;
   hb_hashmap_t *phVar3;
   int iVar4;
...
;
 ...
 while ( lVar7 != lVar11 );
               LAB_001039fe:pvVar9 = *(void**)( piVar10 + 2 );
            }
 ...
 while ( piVar1 != piVar10 );
         LAB_00103a11:pvVar9 = *(void**)( this + 0x108 );
      }
...
;
 ...
 while ( lVar7 != lVar11 );
         LAB_00103a7e:pvVar9 = *(void**)( this + 0xf8 );
      }
...
;
 ...
 while ( lVar7 != lVar11 );
         LAB_00103aee:pvVar9 = *(void**)( this + 0xe8 );
      }
...
;
 ...
 while ( phVar2 != phVar8 );
         LAB_00103c52:pvVar9 = *(void**)( this + 0x60 );
      }
...
/* WARNING: Type propagation algorithm not settling *//* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* cff2_private_dict_blend_opset_t::process_blend(CFF::cff2_priv_dict_interp_env_t&,
   cff2_private_blend_encoder_param_t&) */void cff2_private_dict_blend_opset_t::process_blend(cff2_priv_dict_interp_env_t *param_1, cff2_private_blend_encoder_param_t *param_2) {
   long lVar1;
   uint uVar2;
   long lVar3;
   uint uVar4;
   ...
   if (*(uint*)( param_2 + 0xc ) < ( uint )(ushort)(*(ushort*)( lVar5 + 8 ) << 8 | *(ushort*)( lVar5 + 8 ) >> 8)) {
   ...
   if (uVar10 != 0) {
      puVar11 = (undefined*)( lVar5 + 2 + ( ulong )(uVar10 >> 0x18 | ( uVar10 & 0xff0000 ) >> 8 | ( uVar10 & 0xff00 ) << 8 | uVar10 << 0x18) );
   }
   ...
   *(uint*)( param_2 + 0x10 ) = uVar13;
   if ((int)uVar10 < 0) {
      LAB_00103f90 = (ItemVariationStore*)( *(long*)( param_2 + 0x28 ) + 2 );
      if (uVar14 != 0) goto LAB_00103f1c;
      LAB_00103ff3:pfVar16 = (float*)&_hb_CrapPool;
      ...
      if (uVar13 < uVar14) {
         if (uVar14 <= uVar10) {
            ...
            LAB_00103f89:*(uint*)( param_2 + 0x1c ) = uVar18;
            uVar13 = *(uint*)( param_2 + 0x10 );
            uVar14 = (uint)uVar12;
            goto LAB_00103f90;
         }
         ...
         if (uVar14 < 0x40000000) {
            LAB_00104034:pvVar9 = *(void**)( param_2 + 0x20 );
            goto LAB_00103ece;
         }
         ...
         *(uint*)( param_2 + 0x18 ) = ~uVar10;
         ...
         pvVar9 = *(void**)( param_2 + 0x20 );
         uVar8 = (ulong)uVar18;
         LAB_00103ece:pvVar9 = realloc(pvVar9, uVar8 << 2);
         if (pvVar9 == (void*)0x0) {
         ...
         LAB_00103eef:if (uVar18 <= (uint)uVar8) goto LAB_00103f89;
         hb_memset((void*)( *(long*)( param_2 + 0x20 ) + uVar8 * 4 ), ( uVar18 - (uint)uVar8 ) * 4, (uint)puVar11);
         uVar13 = *(uint*)( param_2 + 0x10 );
         *(uint*)( param_2 + 0x1c ) = uVar18;
         this(ItemVariationStore * )(*(long*)( param_2 + 0x28 ) + 2);
      }

      LAB_00103f1c:pfVar16 = *(float**)( param_2 + 0x20 );
   }

   OT::ItemVariationStore::get_region_scalars(this, *(uint*)( param_2 + 0xc ), *(int**)( param_2 + 0x30 ), *(uint*)( param_2 + 0x38 ), pfVar16, uVar13);
   uVar10 = *(uint*)( param_1 + 0x14 );
   uVar13 = *(uint*)( param_2 + 0x10 );
   param_2[8] = (cff2_private_blend_encoder_param_t)0x1;
   joined_r0x00103f3c:if (uVar10 == 0) {
         ...
         do {
            ...
            if (( uVar4 == uVar7 ) && ( uVar4 != 0 )) {
               ...
               do {
                  ...
                  lVar3 = uVar8 * 8;
                  uVar8 = uVar8 + 1;
                  dVar21 = dVar21 + (double)*(float*)( lVar5 + lVar1 ) * *(double*)( param_1 + lVar3 + (ulong)uVar20 * 8 + 0x18 );
               }
 while ( uVar8 != uVar4 );
            }
 else {
...
hb_vector_t<hb_serialize_context_t::object_t::link_t,false>::push
   ...
   uVar6 = uVar4;
   if (uVar5 <= uVar4) {
      LAB_00104099:pvVar3 = *(void**)( this + 8 );
      LAB_0010409d:if (uVar1 < uVar5) {
 ...
 while ( uVar6 < uVar5 );
   ...
   *(uint*)this = ~uVar4;
   LAB_0010411c:__hb_CrapPool = __hb_NullPool;
   uVar2 = __hb_CrapPool;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* hb_hashmap_t<unsigned int, unsigned int, true>::alloc(unsigned int) */hb_hashmap_t<unsigned_int,unsigned_int,true> hb_hashmap_t<unsigned_int,unsigned_int,true>::alloc(hb_hashmap_t<unsigned_int,unsigned_int,true> *this, uint param_1) {
   ...
   if (hVar10 == (hb_hashmap_t<unsigned_int,unsigned_int,true>)0x0) {
      LAB_001044b3:hVar10 = (hb_hashmap_t<unsigned_int,unsigned_int,true>)0x0;
   }
 else {
      if (param_1 == 0) {
      ...
      if (uVar14 == 0) {
         ...
         iVar7 = 0xc;
         __size = 0xc;
         LAB_001041f9:pvVar4 = (void*)__memset_chk(pvVar4, 0, iVar7, __size);
      }
 else {
         iVar7 = 0x1f;
         if (uVar14 != 0) {
         ...
         if (pvVar4 == (void*)0x0) {
            LAB_001044af:this[0x10] = (hb_hashmap_t<unsigned_int,unsigned_int,true>)0x0;
            goto LAB_001044b3;
         }
 ...
 while ( ( bVar1 & 2 ) != 0 );
                  if (uVar12 == 0xffffffff) {
                     LAB_0010445a:uVar13 = uVar13 + 1;
                  }
 else {
                     LAB_00104374:lVar5 = (ulong)uVar12 * 0xc;
                     LAB_0010437f:piVar6 = (int*)( lVar2 + lVar5 );
            ...
            LAB_001042c0:piVar15 = piVar15 + 3;
         }
 while ( __ptr + (ulong)uVar14 * 3 != piVar15 );
   ...
   LAB_0010441d:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* hb_vector_t<unsigned int, false>::alloc(unsigned int, bool) */undefined8 hb_vector_t<unsigned_int,false>::alloc(hb_vector_t<unsigned_int,false> *this, uint param_1, bool param_2) {
 ...
 while ( uVar3 < param_1 );
   ...
   if (pvVar2 != (void*)0x0) {
      LAB_00104599:*(void**)( this + 8 ) = pvVar2;
      *(uint*)this = uVar3;
      return 1;
   }
   ...
   LAB_00104546:*(uint*)this = ~uVar1;
   return 0;
}
/* CFF::subr_remap_t::create(hb_set_t const*) */void CFF::subr_remap_t::create(subr_remap_t *this, hb_set_t *param_1) {
   undefined8 uVar1;
   char cVar2;
   int iVar3;
   int iVar4;
      ...
      if (uVar11 == 0xffffffff) {
         if (*(uint*)( param_1 + 0x34 ) == 0) {
            *(undefined4*)( param_1 + 0x14 ) = 0;
            hb_hashmap_t<unsigned_int,unsigned_int,true>::alloc((hb_hashmap_t<unsigned_int,unsigned_int,true>*)this, 0);
            goto LAB_001046b6;
         }
 ...
 while ( puVar13 != puVar8 );
      ...
      LAB_00104696:hb_hashmap_t<unsigned_int,unsigned_int,true>::alloc((hb_hashmap_t<unsigned_int,unsigned_int,true>*)this, uVar11);
      uVar7 = *(uint*)( this + 0x30 );
      if (( (int)uVar7 < 0 ) || ( uVar6 = uVar11 <= uVar7 )) goto LAB_001046b6;
   }
 else {
      if (uVar11 != 0xffffffff) {
         uVar11 = ~uVar11;
 ...
 while ( puVar13 != puVar8 );
      ...
      *(undefined4*)( param_1 + 0x14 ) = 0;
      hb_hashmap_t<unsigned_int,unsigned_int,true>::alloc((hb_hashmap_t<unsigned_int,unsigned_int,true>*)this, 0xffffffff);
      uVar7 = *(uint*)( this + 0x30 );
      uVar6 = uVar7;
 ...
 while ( uVar6 < uVar11 );
   ...
   LAB_001046b6:local_98 = (hb_bit_set_t*)( param_1 + 0x10 );
 ...
 while ( uVar7 == local_6c );
   ...
   LAB_00104959:if (uVar11 != 0xffffffff) goto LAB_00104920;
   do {
      if (phVar10 == local_98) {
         iVar14 = 0x6b;
      ...
      if (phVar10[0x30] == (hb_bit_set_t)0x0) {
         LAB_00104936:hb_bit_set_t::next(phVar10, &local_60);
         phVar10 = local_68;
         uVar7 = local_60;
         goto LAB_0010494a;
      }
...
;
         local_60 = uVar11;
         if (local_5c != 0) goto LAB_00104952;
         LAB_00104920:hb_inc_bimap_t::add((hb_inc_bimap_t*)this, uVar11);
         if (phVar10[0x30] == (hb_bit_set_t)0x0) goto LAB_00104936;
      }
 ...
 while ( local_5c == 0 );
   ...
   while (uVar11 = uVar7,uVar7 == (uint)local_58) {
      LAB_00104c5e:uVar7 = uVar11 + 1;
      local_6c = uVar11;
      cVar2 = hb_bit_set_t::next(phVar10, (uint*)&local_58);
      if (cVar2 == '\0') break;
   }
;
   LAB_0010494a:local_60 = uVar7;
   uVar11 = local_60;
   if (local_5c != 0) {
      LAB_00104952:local_5c = local_5c + -1;
      uVar11 = local_60;
   }

   goto LAB_00104959;
}
/* OT::CFFIndex<OT::IntType<unsigned int, 4u> >::operator[](unsigned int) const */undefined1[16];OT::CFFIndex<OT::IntType<unsigned_int,4u>>::operator (CFFIndex<OT::IntType<unsigned_int,4u>> *this,uint param_1) {
   ...
   if (param_1 < ( uVar3 >> 0x18 | ( uVar3 & 0xff0000 ) >> 8 | ( uVar3 & 0xff00 ) << 8 | uVar3 << 0x18 )) {
      ...
      if (CVar1 == (CFFIndex<OT::IntType<unsigned_int,4u>>)0x3) {
         ...
         if (CVar1 == (CFFIndex<OT::IntType<unsigned_int,4u>>)0x1) {
            ...
            uVar6 = *(ushort*)( this + (ulong)param_1 * 2 + 5 ) << 8 | *(ushort*)( this + (ulong)param_1 * 2 + 5 ) >> 8;
            uVar7 = (uint)uVar6;
            uVar3 = ( uint )(ushort)(*(ushort*)( this + ( ulong )(param_1 + 1) * 2 + 5 ) << 8 | *(ushort*)( this + ( ulong )(param_1 + 1) * 2 + 5 ) >> 8);
            if (uVar3 < uVar6) goto LAB_00104ec0;
            uVar2 = *(uint*)this;
            uVar2 = uVar2 >> 0x18 | ( uVar2 & 0xff0000 ) >> 8 | ( uVar2 & 0xff00 ) << 8 | uVar2 << 0x18;
            uVar5 = ( uint )(ushort)(*(ushort*)( this + (ulong)uVar2 * 2 + 5 ) << 8 | *(ushort*)( this + (ulong)uVar2 * 2 + 5 ) >> 8);
         }

      }
 else {
         if (CVar1 != (CFFIndex<OT::IntType<unsigned_int,4u>>)0x4) {
            LAB_00104ec8:uVar3 = *(uint*)this;
            auVar10._0_8_ = this + ( ulong )(( ( uVar3 >> 0x18 | ( uVar3 & 0xff0000 ) >> 8 | ( uVar3 & 0xff00 ) << 8 | uVar3 << 0x18 ) + 1 ) * (uint)(byte)CVar1) + 4;
            auVar10._8_8_ = 0;
            return auVar10;
         }
...
/* hb_vector_t<unsigned char, false>::alloc(unsigned int, bool) */undefined8 hb_vector_t<unsigned_char,false>::alloc(hb_vector_t<unsigned_char,false> *this, uint param_1, bool param_2) {
 ...
 while ( uVar2 < param_1 );
   ...
   LAB_00104fbd:*(void**)( this + 8 ) = pvVar1;
   *(uint*)this = uVar2;
   return 1;
}
/* CFF::str_encoder_t::encode_int(int) */void CFF::str_encoder_t::encode_int(str_encoder_t *this, int param_1) {
   uint uVar1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* cff2_cs_opset_flatten_t::flush_args(CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>&,
   CFF::flatten_param_t&) */void cff2_cs_opset_flatten_t::flush_args(cff2_cs_interp_env_t *param_1, flatten_param_t *param_2) {
   double dVar1;
         ...
         if (*(int*)( param_1 + uVar14 * 0x20 + 0x2c ) == 0) {
            ...
            if (dVar16 == (double)(int)(short)(int)dVar16) {
               ...
               for (int i = 0; i < 3; i++) {
                  ...
                  uVar15 = ( undefined1 )((uint)iVar5 >> ( -8*i + 24 ));
                  if ((int)uVar7 < *(int*)this_00) {
                     *(uint*)( this_00 + 4 ) = uVar7 + 1;
                     *(undefined1*)( *(long*)( this_00 + 8 ) + (ulong)uVar7 ) = uVar15;
                  }
 else {
                     cVar4 = hb_vector_t<unsigned_char,false>::alloc((hb_vector_t<unsigned_char,false>*)this_00, uVar7 + 1, false);
                     if (cVar4 == '\0') {
            ...
            do {
               ...
               if (( ( ( *(int*)( pcVar10 + 0x14 ) == 0 ) || ( *(uint*)( pcVar10 + 8 ) != uVar11 ) ) || ( *(uint*)( pcVar10 + 0xc ) != uVar7 ) ) || ( *(int*)( pcVar10 + 0x14 ) != *(int*)( param_1 + 0x41a0 ) )) {
                  *(int*)( param_1 + 0xc ) = *(int*)( param_1 + 8 ) + 1;
                  goto LAB_0010557b;
               }
                     ...
                     do {
                        while (true) {
                           ...
                           if (0xd6 < iVar5 + 0x6bU) {
                              ...
                              CFF::str_encoder_t::encode_byte((str_encoder_t*)this, (char)( ( uint )(-0x6c - iVar5) >> 8 ) + 0xfb);
...
;
                        ...
                        if ((int)uVar7 < *(int*)this) {
                           ...
                           *(undefined1*)( *(long*)( this + 8 ) + (ulong)uVar7 ) = uVar15;
                           ...
                           dVar16 = _LC12;
                           if (cVar4 == '\0') {
                              LAB_00105b81:__hb_CrapPool = CONCAT71(_hb_CrapPool_1, _hb_NullPool);
                              dVar16 = _LC12;
                           }
 else {
                              uVar7 = *(uint*)( this + 4 );
                        ...
                        LAB_00105468:uVar7 = *(uint*)( this + 4 );
                        cVar4 = (char)( (uint)local_50 >> 8 );
                        uVar9 = uVar7 + 1;
                        if ((int)uVar7 < *(int*)this) {
                           LAB_001053b0:cVar12 = (char)local_50;
                           *(uint*)( this + 4 ) = uVar9;
                           *(char*)( *(long*)( this + 8 ) + (ulong)uVar7 ) = cVar4;
                           LAB_001053bb:uVar7 = *(uint*)( this + 4 );
                           uVar6 = (ulong)uVar7;
                           uVar9 = uVar7 + 1;
                           if (*(int*)this <= (int)uVar7) goto LAB_001054e0;
                           LAB_001053c9:*(uint*)( this + 4 ) = uVar9;
                           *(char*)( *(long*)( this + 8 ) + uVar6 ) = cVar12;
                        }
 else {
                           cVar3 = hb_vector_t<unsigned_char,false>::alloc(this, uVar9, false);
                           dVar16 = _LC12;
                           joined_r0x001054b9:cVar12 = (char)local_50;
                           _LC12 = dVar16;
                           if (cVar3 == '\0') {
                           ...
                           *(char*)( *(long*)( this + 8 ) + (ulong)uVar7 ) = cVar4;
                           ...
                           uVar9 = uVar7 + 1;
                           if ((int)uVar7 < *(int*)this) goto LAB_001053c9;
                           LAB_001054e0:cVar4 = hb_vector_t<unsigned_char,false>::alloc(this, uVar9, false);
                           if (cVar4 != '\0') goto LAB_00105518;
                           LAB_001057fb:__hb_CrapPool = CONCAT71(_hb_CrapPool_1, _hb_NullPool);
                           dVar16 = _LC12;
                        }

                        LAB_001053d4:lVar8 = lVar8 + 1;
                     }
 while ( (uint)lVar8 < *(uint*)( pcVar10 + 0x14 ) );
                  }

                  LAB_00105540:uVar7 = *(uint*)( param_1 + uVar14 * 0x20 + 0x20 );
                  uVar11 = uVar11 + 1;
               }
 while ( uVar11 < uVar7 );
            }
            ...
            LAB_0010557b:uVar11 = iVar13 + *(int*)( param_1 + uVar14 * 0x20 + 0x20 );
         }
...
/* cff2_cs_opset_flatten_t::flush_args_and_op(unsigned int,
   CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>&, CFF::flatten_param_t&) */void cff2_cs_opset_flatten_t::flush_args_and_op(uint param_1, cff2_cs_interp_env_t *param_2, flatten_param_t *param_3) {
   ulong uVar1;
   str_encoder_t *this;
   if (param_1 < 0x18) {
   ...
   LAB_00105d1c:CFF::str_encoder_t::encode_byte(this, (byte)param_1);
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* bool CFF::Dict::serialize_link_op<OT::IntType<int, 4u>, 29>(hb_serialize_context_t*, unsigned
   ...
   if (*(undefined1**)( param_1 + 0x10 ) == puVar3 || (long)*(undefined1**)( param_1 + 0x10 ) - (long)puVar3 < 0) {
      LAB_00105f38:*(undefined4*)( param_1 + 0x2c ) = 4;
      return false;
   }
   ...
   *puVar5 = 0;
   ...
   puVar4 = *(undefined1**)( param_1 + 8 );
   if (*(long*)( param_1 + 0x10 ) - (long)puVar4 < (long)( ulong )(2 - ( param_2 < 0x100 ))) goto LAB_00105f38;
   *(undefined1**)( param_1 + 8 ) = puVar4 + ( 2 - ( ulong )(param_2 < 0x100) );
   ...
   if (-1 < (int)uVar1) {
      ...
      uVar9 = uVar1;
      if (uVar11 <= uVar1) {
         LAB_00105ecf:pvVar7 = (void*)puVar10[3];
         LAB_00105ed3:if (uVar2 < uVar11) {
 ...
 while ( uVar9 < uVar11 );
   ...
   __hb_CrapPool = __hb_NullPool;
   LAB_00105f08:if (*(int*)( puVar10 + 2 ) < 0) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* CFF::cs_opset_t<CFF::blend_arg_t, cff2_cs_opset_flatten_t,
   ...
   CFF::flatten_param_t&) */void CFF::cs_opset_t<CFF::blend_arg_t,cff2_cs_opset_flatten_t,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,CFF::flatten_param_t,CFF::path_procs_null_t<CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,CFF::flatten_param_t>>::flush_args_and_op(uint param_1, cff2_cs_interp_env_t *param_2, flatten_param_t *param_3) {
   double dVar1;
   hb_vector_t<unsigned_char,false> *this;
      ...
      do {
         ...
         if (*(int*)( param_2 + uVar15 * 0x20 + 0x2c ) == 0) {
            ...
            if (dVar16 == (double)(int)(short)(int)dVar16) {
               ...
               if ((int)uVar7 < *(int*)psVar2) {
                  ...
                  *(undefined1*)( *(long*)( psVar2 + 8 ) + (ulong)uVar7 ) = uVar12;
                  ...
                  cVar5 = hb_vector_t<unsigned_char,false>::alloc((hb_vector_t<unsigned_char,false>*)psVar2, uVar7 + 1, false);
                  if (cVar5 == '\0') {
                     __hb_CrapPool = CONCAT71(_hb_CrapPool_1, _hb_NullPool);
                  }
 else {
            ...
            do {
               ...
               if (( ( ( *(int*)( pcVar10 + 0x14 ) == 0 ) || ( *(uint*)( pcVar10 + 8 ) != uVar11 ) ) || ( *(uint*)( pcVar10 + 0xc ) != uVar7 ) ) || ( *(int*)( pcVar10 + 0x14 ) != *(int*)( param_2 + 0x41a0 ) )) {
                  *(int*)( param_2 + 0xc ) = *(int*)( param_2 + 8 ) + 1;
                  goto LAB_001062a3;
               }
               ...
               if (dVar16 == (double)(int)(short)(int)dVar16) {
                  ...
                  uVar11 = *(uint*)( this + 4 );
                  for (int i = 0; i < 3; i++) {
                     uVar12 = ( undefined1 )((uint)iVar8 >> ( -8*i + 24 ));
                     if ((int)uVar11 < *(int*)this) {
                        *(uint*)( this + 4 ) = uVar11 + 1;
                  ...
                  if (*(int*)( pcVar10 + 0x14 ) != 0) {
                     do {
                        ...
                        if (dVar1 == (double)(int)(short)iVar8) {
                           ...
                           str_encoder_t::encode_byte((str_encoder_t*)this, (char)( ( uint )(-0x6c - iVar8) >> 8 ) + 0xfb);
                           ...
                           if ((int)uVar7 < *(int*)this) {
                              ...
                              *(undefined1*)( *(long*)( this + 8 ) + (ulong)uVar7 ) = uVar12;
                              ...
                              dVar16 = _LC12;
                              if (cVar5 == '\0') {
                                 LAB_001068ff:__hb_CrapPool = CONCAT71(_hb_CrapPool_1, _hb_NullPool);
                                 dVar16 = _LC12;
                              }
 else {
                                 uVar7 = *(uint*)( this + 4 );
                           ...
                           LAB_00106230:uVar7 = *(uint*)( this + 4 );
                           cVar5 = (char)( (uint)iVar8 >> 8 );
                           uVar9 = uVar7 + 1;
                           if ((int)uVar7 < *(int*)this) {
                              LAB_00106178:cVar6 = (char)iVar8;
                              *(uint*)( this + 4 ) = uVar9;
                              *(char*)( *(long*)( this + 8 ) + (ulong)uVar7 ) = cVar5;
                              ...
                              cVar4 = hb_vector_t<unsigned_char,false>::alloc(this, uVar9, false);
                              dVar16 = _LC12;
                              joined_r0x00106277:cVar6 = (char)iVar8;
                              _LC12 = dVar16;
                              if (cVar4 == '\0') {
                                 _hb_CrapPool_1 = ( undefined7 )((ulong)__hb_CrapPool >> 8);
                                 __hb_CrapPool = CONCAT71(_hb_CrapPool_1, _hb_NullPool);
                           ...
                           uVar9 = uVar7 + 1;
                           if ((int)uVar7 < *(int*)this) {
                              LAB_00106191:*(uint*)( this + 4 ) = uVar9;
                              *(char*)( *(long*)( this + 8 ) + (ulong)uVar7 ) = cVar6;
                           }
 else {
                              LAB_001065a0:cVar5 = hb_vector_t<unsigned_char,false>::alloc(this, uVar9, false);
                              dVar16 = _LC12;
                              if (cVar5 == '\0') {
                                 __hb_CrapPool = CONCAT71(_hb_CrapPool_1, _hb_NullPool);
                              }
 ...
 while ( uVar11 < uVar7 );
            ...
            LAB_001062a3:uVar11 = iVar14 + *(int*)( param_2 + uVar15 * 0x20 + 0x20 );
         }
 ...
 while ( uVar11 < uVar7 );
   ...
   *(undefined4*)( param_2 + 0x14 ) = 0;
   joined_r0x001064a2:if (( param_1 == 0xb ) || ( param_1 == 0xe )) {
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
      ...
      if (param_1 < 0x100) {
         ...
         if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            LAB_001064e6:str_encoder_t::encode_byte(psVar2, local_50);
            return;
         }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* CFF::cs_interp_env_t<CFF::blend_arg_t, CFF::Subrs<OT::IntType<unsigned int, 4u> >
   >::call_subr(CFF::biased_subrs_t<CFF::Subrs<OT::IntType<unsigned int, 4u> > > const&,
   CFF::cs_type_t) */void CFF::cs_interp_env_t<CFF::blend_arg_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>>::call_subr(cs_interp_env_t<CFF::blend_arg_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>> *this, int *param_1, undefined4 param_3) {
   long lVar1;
   uint uVar2;
   ...
   if (*(int*)( this + 0x14 ) == 0) {
      ...
      pcVar4 = (cs_interp_env_t<CFF::blend_arg_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>>*)&_hb_CrapPool;
      __hb_CrapPool = uVar5;
   ...
   if (( ( -1 < (int)uVar3 ) && ( this_00 = *(CFFIndex<OT::IntType<unsigned_int,4u>>**)( param_1 + 2 ) ),this_00 != (CFFIndex<OT::IntType<unsigned_int,4u>>*)0x0 )) &&( uVar2 = *(uint*)this_00 ),uVar3<( uVar2 >> 0x18 | ( uVar2 & 0xff0000 ) >> 8 | ( uVar2 & 0xff00 ) << 8 | uVar2 << 0x18 ) = *(uint*)( this + 0x4064 );
   if (uVar2 < 10) {
...
*(int*)( this + 0xc ) = *(int*)( this + 8 ) + 1;return;}/* CFF::subr_subsetter_t<cff2_subr_subsetter_t, CFF::Subrs<OT::IntType<unsigned int, 4u> >,
   OT::cff2::accelerator_subset_t const, CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,
   cff2_cs_opset_subr_subset_t, 65535u>::subr_subsetter_t(OT::cff2::accelerator_subset_t const&,
   hb_subset_plan_t const*) */void CFF::subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>::subr_subsetter_t(subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u> *this, accelerator_subset_t *param_1, hb_subset_plan_t *param_2) {
   undefined4 *puVar1;
   uint uVar2;
   ulong uVar3;
   void *pvVar4;
   ...
   *(undefined8*)( this + 0x18 ) = 0;
   this[0x20] = (subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>)0x1;
   ...
   *(undefined4*)( this + 0x28 ) = 0;
   ...
   this[0x50] = (subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>)0x0;
   *(undefined8*)( this + 0x58 ) = 0;
   *(undefined8*)( this + 0x60 ) = 0;
   if ((int)uVar2 < 1) {
      LAB_00106c44:*(uint*)( this + 0x5c ) = uVar5;
   }
 else {
 ...
 while ( uVar2 < uVar5 );
   ...
   *(undefined8*)( this + 0x90 ) = 0;
   ...
   this[0x98] = (subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>)0x1;
...
;
   ...
   *(uint*)( this + 0xd4 ) = uVar5;
   LAB_00106cdd:*(undefined8*)( this + 0xe0 ) = 0;
   for (int i = 0; i < 5; i++) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* CFF::dict_interpreter_t<cff2_private_dict_blend_opset_t, cff2_private_blend_encoder_param_t,
   CFF::cff2_priv_dict_interp_env_t>::interpret(cff2_private_blend_encoder_param_t&) */undefined8 CFF::dict_interpreter_t<cff2_private_dict_blend_opset_t,cff2_private_blend_encoder_param_t,CFF::cff2_priv_dict_interp_env_t>::interpret(dict_interpreter_t<cff2_private_dict_blend_opset_t,cff2_private_blend_encoder_param_t,CFF::cff2_priv_dict_interp_env_t> *this, cff2_private_blend_encoder_param_t *param_1) {
   long lVar1;
   byte bVar2;
   byte bVar3;
   byte bVar4;
   ...
   if (uVar20 <= uVar29) {
      ...
      *(uint*)( pcVar34 + 0xc ) = uVar20;
      ...
      if (bVar19 == 0xc) {
         if (uVar29 < uVar21 + 2) {
            uVar26 = 0xffff;
            LAB_001073f0:*(undefined4*)( pcVar34 + 0x14 ) = 0;
         ...
         LAB_00106f92:if (pcVar34[0x10] != (cff2_priv_dict_interp_env_t)0x0) {
            LAB_00107404:uVar29 = *(uint*)( pcVar35 + 8 );
            pcVar34 = pcVar35;
            goto LAB_00106f12;
         }
 ...
 while ( uVar33 < uVar15 );
                                 ...
                                 if (pvVar13 == (void*)0x0) {
                                    LAB_00107b0f:local_78 = (double)CONCAT44(local_78._4_4_, ~uVar29);
                                    goto LAB_00107b15;
                                 }
...
;
 ...
 while ( uVar27 < uVar33 );
                        ...
                        if (pcVar9[1] == '-') {
                           ...
                           if ((int)(uint)local_78 <= (int)local_78._4_4_) {
                              if ((int)(uint)local_78 < 0) {
                                 LAB_00107e4e:__hb_CrapPool = (double)CONCAT71(_hb_CrapPool_1, _hb_NullPool);
                                 goto LAB_00107255;
                              }
 ...
 while ( uVar33 < uVar15 );
                        ...
                        LAB_00107255:cVar7 = *pcVar28;
                        if (cVar7 != '0') goto LAB_00107206;
                        cVar7 = pcVar28[1];
                        pcVar9 = pcVar28 + 1;
                     }
 while ( cVar7 != '\0' );
                     LAB_00107270:uVar11 = (ulong)local_78._4_4_;
                     ...
                     *(undefined1*)( (long)local_70 + uVar11 ) = 0xf;
                     LAB_00107294:if (( uVar29 & 1 ) != 0) {
                        LAB_001075c0:local_94 = 0xf;
                        hb_vector_t<char,false>::push<int>((hb_vector_t<char,false>*)&local_78, &local_94);
                     ...
                     if (( ( local_68[0] == '-' ) && ( local_68[1] == '0' ) ) && ( local_68[2] == '.' )) {
                        ...
                        LAB_00107491:uVar11 = ( ulong )(cVar24 == '-');
...
;
                        ...
                        __snprintf_chk(pcVar9 + uVar11 + sVar10, local_58 + -(long)(pcVar9 + uVar11 + sVar10), 2, uVar17 + ( lVar32 - lVar1 ), &_LC19, (int)sVar12 + -1);
                        cVar7 = *pcVar9;
                     }
 else {
                        LAB_001070a7:sVar10 = strlen(local_68);
                        pcVar9 = local_68;
                        if (( sVar10 < 4 ) || ( iVar8 = iVar8 != 0 )) {
                           ...
                           if (iVar8 - (int)sVar10 != 1) {
                              __snprintf_chk(pcVar31 + -1, local_58 + -(long)(pcVar31 + -1), 2, 0xffffffffffffffff, &_LC18);
                              cVar7 = local_68[0];
                              goto LAB_00107188;
                           }
 ...
 while ( ( pcVar31[-1] == '0' ) && ( pcVar28 = 1 < uVar29 ) );
                        }
 else {
                        ...
                        __snprintf_chk(pcVar31, local_58 + -(long)pcVar31, 2, uVar22 + ( ( uVar11 - 1 ) - uVar17 ), &_LC16);
                        cVar7 = local_68[0];
                        LAB_00107188:if (cVar7 == '.') goto LAB_00107678;
                        LAB_00107191:if (cVar7 == '-') {
                           lVar32 = 0x10;
                           goto LAB_001071a3;
                        }
                     ...
                     do {
                        ...
                        if ((int)local_88._4_4_ < (int)local_88) {
                           ...
                           *(byte*)( (long)local_80 + uVar11 ) = bVar19;
                           ...
                           cVar7 = hb_vector_t<unsigned_char,false>::alloc((hb_vector_t<unsigned_char,false>*)&local_88, local_88._4_4_ + 1, false);
                           if (cVar7 == '\0') {
                              __hb_CrapPool = (double)CONCAT71(_hb_CrapPool_1, _hb_NullPool);
                           }
 else {
      ...
      if (bVar19 != 0x17) {
         if (bVar19 < 0x18) {
            if (bVar19 < 0xc) {
               ...
               LAB_00107acc:if (0xd6 < uVar15 - 0x20) goto LAB_001073f0;
               uVar21 = *(uint*)( pcVar34 + 0x14 );
               if (uVar21 < 0x201) {
               ...
               LAB_00107cda:if (uVar15 < 0xf7) {
                  ...
                  *(double*)pcVar18 = (double)(int)(short)( ( bVar19 - 0xf7 ) * 0x100 + 0x6c + (ushort)bVar4 );
            ...
            *(double*)pcVar18 = (double)(int)( (uint)bVar3 | (uint)bVar2 << 8 | (uint)bVar4 << 0x10 | (uint)bVar19 << 0x18 );
 ...
 while ( uVar20 != 0x20 );
            *(int*)( pcVar34 + 0xc ) = *(int*)( pcVar34 + 8 ) + 1;
            dVar36 = 0.0;
            LAB_00107bd2:uVar21 = *(uint*)( pcVar34 + 0x14 );
            if (uVar21 < 0x201) {
               *(uint*)( pcVar34 + 0x14 ) = uVar21 + 1;
            ...
            *(double*)pcVar18 = (double)(int)( ( ( uint )(ushort)(bVar19 - 0xfb) * -0x100 - (uint)bVar4 ) + -0x6c );
   ...
   uVar14 = 1;
   goto LAB_00106f32;
   LAB_00107320:local_88._4_4_ = ( uint )((ulong)pcVar9 >> 0x20);
   uVar11 = (ulong)local_88._4_4_;
   ...
   if (uVar26 < 0x100) {
      ...
      if (bVar6) {
         LAB_00107366:local_88 = (char*)CONCAT44(uVar21, (int)local_88);
         *(undefined1*)( (long)local_80 + uVar11 ) = uVar25;
         goto LAB_00107373;
      }

      LAB_0010791a:cVar7 = hb_vector_t<unsigned_char,false>::alloc((hb_vector_t<unsigned_char,false>*)&local_88, uVar21, false);
      if (cVar7 != '\0') {
         uVar11 = (ulong)local_88._4_4_;
         local_88 = (char*)CONCAT44(local_88._4_4_ + 1, (int)local_88);
         *(undefined1*)( (long)local_80 + uVar11 ) = uVar25;
      ...
      if ((int)local_88._4_4_ < (int)local_88) {
         ...
         *(undefined1*)( (long)local_80 + uVar11 ) = 0xc;
         LAB_00107355:uVar11 = (ulong)local_88._4_4_;
         uVar21 = local_88._4_4_ + 1;
         bVar6 = (int)local_88._4_4_ < (int)local_88;
         if (bVar6) goto LAB_00107366;
      }
 else {
         LAB_00107c63:local_88 = pcVar9;
         cVar7 = hb_vector_t<unsigned_char,false>::alloc((hb_vector_t<unsigned_char,false>*)&local_88, uVar21, false);
         if (cVar7 == '\0') {
            __hb_CrapPool = (double)CONCAT71(_hb_CrapPool_1, _hb_NullPool);
            goto LAB_00107355;
         }
   ...
   __hb_CrapPool = (double)CONCAT71(_hb_CrapPool_1, _hb_NullPool);
   LAB_00107373:uVar11 = (ulong)local_88 >> 0x20;
   lVar32 = *(long*)param_1;
   if (*(int*)( lVar32 + 0x2c ) == 0) {
      if (( uVar11 < 0x80000000 ) && ( pvVar13 = *(void**)( lVar32 + 8 ) ),(long)uVar11 <= *(long*)( lVar32 + 0x10 ) - (long)pvVar13) {
   ...
   *(undefined4*)( pcVar34 + 0x14 ) = 0;
   ...
   uVar29 = *(uint*)( pcVar35 + 8 );
   pcVar34 = pcVar35;
   LAB_00106f12:uVar21 = *(uint*)( pcVar34 + 0xc );
   if (( uVar29 < uVar21 ) || ( pcVar34[0x10] != (cff2_priv_dict_interp_env_t)0x0 )) {
      uVar14 = 0;
      LAB_00106f32:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Subroutine does not return */
         __stack_chk_fail();
      }
...
/* cff2_private_dict_op_serializer_t::serialize(hb_serialize_context_t*, CFF::op_str_t const&,
   unsigned int) const */ulong cff2_private_dict_op_serializer_t::serialize(cff2_private_dict_op_serializer_t *this, hb_serialize_context_t *param_1, op_str_t *param_2, uint param_3) {
   undefined1 *puVar1;
   undefined1 *puVar2;
   undefined1 *puVar3;
   undefined2 *puVar4;
   ...
   if (this[1] == (cff2_private_dict_op_serializer_t)0x0) {
      LAB_00108150:if (uVar12 == 0x13) {
         if (( *this != (cff2_private_dict_op_serializer_t)0x0 ) || ( param_3 == 0 )) goto LAB_0010823e;
         puVar2 = *(undefined1**)( param_1 + 8 );
         if (*(int*)( param_1 + 0x2c ) == 0) {
            if (*(undefined1**)( param_1 + 0x10 ) == puVar2 || (long)*(undefined1**)( param_1 + 0x10 ) - (long)puVar2 < 0) {
               LAB_001082e0:*(undefined4*)( param_1 + 0x2c ) = 4;
            }
 else {
               *puVar2 = 0;
               puVar3 = *(undefined1**)( param_1 + 8 );
               ...
               if (( puVar3 != (undefined1*)0x0 ) && ( *puVar3 = 0x1c * (int*)( param_1 + 0x2c ) == 0 )) {
                  ...
                  *(undefined2**)( param_1 + 8 ) = puVar4 + 1;
                  if (( puVar4 != (undefined2*)0x0 ) && ( *puVar4 = 0 * (int*)( param_1 + 0x2c ) == 0 )) {
                     ...
                     if (*(undefined1**)( param_1 + 0x10 ) == puVar1 || (long)*(undefined1**)( param_1 + 0x10 ) - (long)puVar1 < 0) goto LAB_001082e0;
                     *(undefined1**)( param_1 + 8 ) = puVar1 + 1;
                     if (puVar1 != (undefined1*)0x0) {
                        *puVar1 = 0x13;
                        puVar8 = (undefined4*)hb_vector_t<hb_serialize_context_t::object_t::link_t,false>::push((hb_vector_t<hb_serialize_context_t::object_t::link_t,false>*)( *(long*)( param_1 + 0x48 ) + 0x10 ));
         ...
         if (this[2] != (cff2_private_dict_op_serializer_t)0x0) {
            LAB_00108168:local_1048 = *(undefined8*)param_2;
            puVar13 = local_1030;
            ...
            local_1068 = (void*)0x0;
            local_1088 = param_1;
            uVar6 = CFF::dict_interpreter_t<cff2_private_dict_blend_opset_t,cff2_private_blend_encoder_param_t,CFF::cff2_priv_dict_interp_env_t>::interpret((dict_interpreter_t<cff2_private_dict_blend_opset_t,cff2_private_blend_encoder_param_t,CFF::cff2_priv_dict_interp_env_t>*)&local_1090, (cff2_private_blend_encoder_param_t*)&local_1088);
            if ((int)local_1070 != 0) {
               free(local_1068);
               uVar6 = uVar6 & 0xff;
            }
         ...
         LAB_00108261:if (*(int*)( param_1 + 0x2c ) == 0) {
            if (*(long*)( param_1 + 0x10 ) - (long)*(void**)( param_1 + 8 ) < (long)(ulong)(byte)uVar12) goto LAB_001082e0;
 ...
 while ( (uint)lVar7 < (uint)(byte)param_2[0xc] );
      ...
      if (uVar12 < 0x10f) {
         if (( uVar12 < 0x109 ) && ( poVar10 = (op_str_t*)( ulong )(uVar12 - 6) ),5 < uVar12 - 6) goto LAB_00108150;
      }
      ...
      LAB_0010823e:uVar6 = 1;
   }

   LAB_0010820d:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar6;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* hb_hashmap_t<hb_serialize_context_t::object_t const*, unsigned int, false>::alloc(unsigned int)
   ...
   if (hVar18 == (hb_hashmap_t<hb_serialize_context_t::object_t_const*,unsigned_int,false>)0x0) {
      LAB_00108877:hVar18 = (hb_hashmap_t<hb_serialize_context_t::object_t_const*,unsigned_int,false>)0x0;
   }
 else {
      if (param_1 == 0) {
         param_1 = *(uint*)( this + 0x14 );
      ...
      if (uVar12 == 0) {
         ...
         iVar9 = 0x10;
         __size = 0x10;
         LAB_00108466:pvVar8 = (void*)__memset_chk(pvVar8, 0, iVar9, __size);
      }
 else {
         iVar9 = 0x1f;
         if (uVar12 != 0) {
         ...
         if (pvVar8 == (void*)0x0) {
            LAB_00108872:this[0x10] = (hb_hashmap_t<hb_serialize_context_t::object_t_const*,unsigned_int,false>)0x0;
            goto LAB_00108877;
         }
 ...
 while ( ( bVar1 & 2 ) != 0 );
                  if ((int)uVar21 == -1) {
                     LAB_001087c8:uVar17 = uVar17 + 1;
                  }
 else {
                     LAB_00108706:plVar14 = (long*)( uVar21 * 0x10 + lVar3 );
                     LAB_00108710:if (( *(byte*)( plVar14 + 1 ) & 2 ) == 0) goto LAB_001087c8;
            ...
            LAB_00108550:local_118 = local_118 + 2;
         }
 while ( __ptr + (ulong)uVar12 * 2 != local_118 );
   ...
   LAB_001087eb:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* hb_serialize_context_t::pop_pack(bool) */uint hb_serialize_context_t::pop_pack(hb_serialize_context_t *this, bool param_1) {
      ...
      if (uVar13 != 0) {
         ...
         do {
            ...
            if ((int)uVar16 < (int)uVar23) {
               LAB_00108c41:pvVar12 = *(void**)( lVar10 + 0x28 );
               LAB_00108c45:*(uint*)( lVar10 + 0x24 ) = uVar15;
 ...
 while ( uVar16 < uVar15 );
               ...
               LAB_001091c5:__hb_CrapPool = CONCAT44(_DAT_00110014, __hb_NullPool);
 ...
 while ( uVar16 < uVar13 );
         if (0x1fffffff < uVar16) {
            LAB_001091e4:__hb_CrapPool = CONCAT44(_DAT_00110014, __hb_NullPool);
      ...
      __hb_CrapPool = CONCAT44(_DAT_00110014, __hb_NullPool);
      iVar18 = *(int*)( this + 0x2c );
      joined_r0x00109200:if (iVar18 != 0) goto LAB_001089b8;
      LAB_00108d20:*(undefined4*)( this + 0x2c ) = 1;
      LAB_001089b8:if ((int)plVar3[2] != 0) {
         free((void*)plVar3[3]);
      }
   ...
   LAB_00108996:pvVar12 = *(void**)( this + 0x58 );
   LAB_0010899f:iVar18 = *(int*)( this + 0x2c );
   ...
   *(long**)( (long)pvVar12 + uVar20 * 8 ) = plVar3;
   ...
   if (param_1) {
      ...
      if (( uVar23 >> 1 ) + uVar23 < *(uint*)( this + 0x7c )) {
         LAB_00108d64:lVar10 = *(long*)( this + 0x88 );
 ...
 while ( ( bVar2 & 2 ) != 0 );
            if ((int)uVar25 == -1) {
               LAB_00108fd8:uVar23 = uVar23 + 1;
            }
 else {
               LAB_00108f36:plVar19 = (long*)( lVar10 + uVar25 * 0x10 );
               LAB_00108f41:if (( *(byte*)( plVar19 + 1 ) & 2 ) == 0) goto LAB_00108fd8;
   ...
   LAB_00108cc5:if (this[0x70] != (hb_serialize_context_t)0x0) {
      return uVar16;
   }
   ...
   LAB_00108cdd:*(undefined4*)( this + 0x2c ) = 1;
   return uVar16;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* hb_pool_t<hb_serialize_context_t::object_t, 32u>::alloc() */undefined1(*)[16];hb_pool_t<hb_serialize_context_t::object_t,32u>::alloc (hb_pool_t<hb_serialize_context_t::object_t,32u> *this) {
 ...
 while ( uVar8 < *(int*)( this + 0xc ) + 1U );
   ...
   if ((int)uVar7 < (int)uVar8) {
      LAB_001092b7:*(uint*)( this + 0xc ) = uVar6;
 ...
 while ( uVar7 < uVar6 );
      ...
      LAB_001093a7:__hb_CrapPool = __hb_NullPool;
   }
 ...
 while ( pauVar1 + 0x70 != pauVar4 );
   ...
   *(undefined1(**) [16])this = pauVar1;
   LAB_00109253:*(undefined8*)this = *(undefined8*)*pauVar1;
...
/* hb_vector_t<CFF::parsed_cs_op_t, false>::alloc(unsigned int, bool) */undefined8 hb_vector_t<CFF::parsed_cs_op_t,false>::alloc(hb_vector_t<CFF::parsed_cs_op_t,false> *this, uint param_1, bool param_2) {
 ...
 while ( uVar3 < param_1 );
   ...
   if (pvVar2 != (void*)0x0) {
      LAB_00109496:*(void**)( this + 8 ) = pvVar2;
      *(uint*)this = uVar3;
      return 1;
   }
   ...
   LAB_00109426:*(uint*)this = ~uVar1;
   return 0;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* cff2_cs_opset_subr_subset_t::process_call_subr(unsigned int, CFF::cs_type_t,
   CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>&, CFF::subr_subset_param_t&,
   CFF::biased_subrs_t<CFF::Subrs<OT::IntType<unsigned int, 4u> > >&, hb_set_t*) */void cff2_cs_opset_subr_subset_t::process_call_subr(undefined4 param_1, undefined4 param_2, long *param_3, long *param_4, int *param_5, long param_6) {
   uint uVar1;
   int iVar2;
   CFFIndex<OT::IntType<unsigned_int,4u>> *this;
   uint *puVar3;
   ...
   if (( ( (int)uVar7 < 0 ) || ( this = *(CFFIndex<OT::IntType<unsigned_int,4u>>**)( param_5 + 2 ) ),this == (CFFIndex<OT::IntType<unsigned_int,4u>>*)0x0 )) {
      LAB_00109760:uVar7 = *(uint*)( (long)param_3 + 0x404c );
   ...
   if (( (byte)puVar3[6] & 1 ) == 0) {
      *(byte*)( puVar3 + 6 ) = (byte)puVar3[6] | 0x10;
      ...
      if ((int)uVar14 < (int)puVar3[2]) {
         LAB_001096b5:plVar10 = (long*)( (ulong)uVar14 * 0x10 + *(long*)( puVar3 + 4 ) );
         puVar3[3] = uVar15;
         *plVar10 = 0;
         ...
         *(short*)( (long)plVar10 + 0xe ) = (short)uVar7;
         ...
         cVar6 = hb_vector_t<CFF::parsed_cs_op_t,false>::alloc((hb_vector_t<CFF::parsed_cs_op_t,false>*)( puVar3 + 2 ), uVar15, false);
         if (cVar6 != '\0') {
            uVar14 = puVar3[3];
      ...
      if (( uVar7 != 0xffffffff ) && ( *(char*)( param_6 + 0x10 ) == '\x01' )) {
         *(undefined4*)( param_6 + 0x14 ) = 0xffffffff;
         ...
         if (puVar9 != (undefined4*)0x0) {
            *(ulong*)( puVar9 + ( ulong )(uVar7 >> 6 & 7) * 2 + 2 ) = *(ulong*)( puVar9 + ( ulong )(uVar7 >> 6 & 7) * 2 + 2 ) | 1L << ( (byte)uVar7 & 0x3f );
            *puVar9 = 0xffffffff;
         }
 ...
 else if (( *(char*)( param_6 + 0x10 ) != '\0' ) && ( puVar9 = (undefined4*)hb_bit_set_t::page_for((hb_bit_set_t*)( param_6 + 0x10 ), uVar7, false) ),puVar9 != (undefined4*)0x0) {
      *(undefined4*)( param_6 + 0x14 ) = 0xffffffff;
      bVar4 = (byte)uVar7 & 0x3f;
      *(ulong*)( puVar9 + ( ulong )(uVar7 >> 6 & 7) * 2 + 2 ) = *(ulong*)( puVar9 + ( ulong )(uVar7 >> 6 & 7) * 2 + 2 ) & ( -2L << bVar4 | 0xfffffffffffffffeU >> 0x40 - bVar4 );
      *puVar9 = 0xffffffff;
   }
   ...
   if (iVar2 == 1) {
      ...
      LAB_0010965f:lVar12 = *(long*)( lVar12 + 8 ) + (ulong)uVar17 * 0x28;
   }
 else {
      if (iVar2 == 2) {
         lVar12 = param_4[3];
   ...
   if (lVar12 != 0) {
      ...
      hb_vector_t<CFF::parsed_cs_op_t,false>::alloc((hb_vector_t<CFF::parsed_cs_op_t,false>*)( lVar12 + 8 ), *(uint*)( param_3 + 1 ), true);
      *param_4 = lVar12;
      return;
   }

   LAB_00109636:*(int*)( (long)param_3 + 0xc ) = (int)param_3[1] + 1;
   return;
}
/* hb_vector_t<CFF::parsed_cs_str_t, false>::alloc(unsigned int, bool) */undefined8 hb_vector_t<CFF::parsed_cs_str_t,false>::alloc(hb_vector_t<CFF::parsed_cs_str_t,false> *this, uint param_1, bool param_2) {
   ...
   if (param_2) {
      ...
      if (( 0x6666666 < uVar11 ) || ( puVar6 = (undefined4*)malloc(uVar12 * 0x28) ),puVar6 == (undefined4*)0x0) goto LAB_001098f9;
   }
 else {
      if (param_1 <= uVar13) {
         return 1;
 ...
 while ( uVar11 < param_1 );
      if (0x6666666 < uVar11) goto LAB_001098f9;
      LAB_00109aa4:uVar11 = (uint)uVar12;
 ...
 while ( uVar13 < *(uint*)( this + 4 ) );
   ...
   free(__ptr);
   LAB_00109a6d:*(undefined4**)( this + 8 ) = puVar6;
   *(uint*)this = uVar11;
   return 1;
}
/* hb_vector_t<CFF::parsed_cs_str_vec_t, false>::resize(int, bool, bool) */undefined8 hb_vector_t<CFF::parsed_cs_str_vec_t,false>::resize(hb_vector_t<CFF::parsed_cs_str_vec_t,false> *this, int param_1, bool param_2, bool param_3) {
   ...
   if (param_3) {
      ...
      if (uVar4 < uVar2) {
         ...
         pvVar7 = *(void**)( this + 8 );
         LAB_00109ca4:uVar8 = (uint)uVar9;
         pvVar7 = realloc(pvVar7, uVar9 << 4);
         if (pvVar7 == (void*)0x0) {
            uVar4 = *(uint*)this;
            if (uVar4 < uVar8) {
               LAB_00109b9a:*(uint*)this = ~uVar4;
               return 0;
            }
 ...
 while ( uVar8 < uVar3 );
   ...
   LAB_00109b09:uVar8 = *(uint*)( this + 4 );
   LAB_00109b0c:if (uVar8 < uVar3) {
      if (param_2) {
         lVar10 = *(long*)( this + 8 );
...
;
 ...
 while ( lVar12 != lVar11 );
               LAB_00109c61:pvVar7 = *(void**)( piVar13 + 2 );
            }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* CFF::subr_subsetter_t<cff2_subr_subsetter_t, CFF::Subrs<OT::IntType<unsigned int, 4u> >,
   ...
   hb_vector_t<CFF::parsed_cs_str_vec_t, false> const&) */undefined8 CFF::subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>::closure_subroutines(subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u> *this, parsed_cs_str_vec_t *param_1, hb_vector_t *param_2) {
   ushort *puVar1;
   uint *puVar2;
   uint uVar3;
   uint uVar4;
   ...
   subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u> *local_58;
   hb_set_t *local_50;
   byte local_48;
   long local_40;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   hb_bit_set_t::resize((hb_bit_set_t*)( this + 0x20 ), 0, true, false);
   if (this[0x20] != (subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>)0x0) {
      *(undefined4*)( this + 0x24 ) = 0;
      this[0x50] = (subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>)0x0;
   }
 ...
 while ( (uint)lVar7 < *(uint*)( this + 0x5c ) );
   ...
   do {
      if (puVar2 == puVar8) {
         uVar5 = 1;
         LAB_00109f6a:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
            /* WARNING: Subroutine does not return */
            __stack_chk_fail();
         }
...
;
            if (*(int*)( lVar10 + 8 ) == 0x1d) {
               collect_subr_refs_in_subr(( uint ) * (ushort*)( lVar10 + 0xe ), local_68, (hb_set_t*)local_58, (subr_subset_param_t*)&local_78);
            }
...
/* CFF::subr_subsetter_t<cff2_subr_subsetter_t, CFF::Subrs<OT::IntType<unsigned int, 4u> >,
   ...
   hb_vector_t<unsigned char, false>&, bool) const */uint CFF::subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>::encode_str(subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u> *this, parsed_cs_str_t *param_1, uint param_2, hb_vector_t *param_3, bool param_4) {
   double dVar1;
   byte bVar2;
   uint uVar3;
   uint uVar4;
   ...
   *(undefined4*)( param_3 + 4 ) = 0;
   ...
   if (param_4) {
      uVar16 = 0;
      if (( ( ( (byte)param_1[0x18] & 8 ) != 0 ) && ( uVar16 = 0(uVar3 & 1) != 0 ) ) && ( ( (byte)param_1[0x18] & 2 ) != 0 )) {
         ...
         if (dVar1 == (double)(int)(short)(int)dVar1) {
            ...
            if (uVar6 == 0) {
               cVar5 = hb_vector_t<unsigned_char,false>::alloc((hb_vector_t<unsigned_char,false>*)param_3, 1, false);
               if (cVar5 == '\0') {
                  _hb_CrapPool = _hb_NullPool;
               }
 else {
            ...
            uVar6 = *(uint*)( param_3 + 4 );
            for (int i = 0; i < 3; i++) {
               uVar19 = ( undefined1 )((uint)iVar13 >> ( -8*i + 24 ));
               if ((int)uVar6 < *(int*)param_3) {
                  *(uint*)( param_3 + 4 ) = uVar6 + 1;
                  *(undefined1*)( *(long*)( param_3 + 8 ) + (ulong)uVar6 ) = uVar19;
               }
 else {
                  cVar5 = hb_vector_t<unsigned_char,false>::alloc((hb_vector_t<unsigned_char,false>*)param_3, uVar6 + 1, false);
                  if (cVar5 == '\0') {
                     _hb_CrapPool = _hb_NullPool;
                  }
 else {
...
;
 ...
 while ( puVar18 != puVar7 );
      LAB_0010a098:uVar4 = iVar13 + uVar16;
   }
   ...
   if (uVar6 < uVar16) {
      ...
      LAB_0010a0ba:pvVar8 = realloc(pvVar8, (ulong)uVar16);
      if (pvVar8 == (void*)0x0) {
         ...
         LAB_0010a0d5:*(void**)( param_3 + 8 ) = pvVar8;
         *(uint*)param_3 = uVar16;
      }
...
;
         ...
         if (*(int*)( puVar14 + 1 ) == 10) {
            ...
            if (lVar11 != 0) {
               uVar12 = ( ulong )(( uint ) * (ushort*)( (long)puVar14 + 0xe ) * -0x61c8864f & 0x3fffffff) % ( ulong ) * (uint*)( puVar15 + 0x20 );
 ...
 while ( ( bVar2 & 2 ) != 0 );
            ...
            LAB_0010a406:str_encoder_t::encode_int((str_encoder_t*)&local_48, *puVar17 - *(int*)( puVar15 + 0x40 ));
         }
 else if (*(int*)( puVar14 + 1 ) == 0x1d) {
            lVar11 = *(long*)( this + 0xb0 );
            puVar17 = (uint*)&minus_1;
            if (lVar11 != 0) {
               uVar12 = ( ulong )(( uint ) * (ushort*)( (long)puVar14 + 0xe ) * -0x61c8864f & 0x3fffffff) % ( ulong ) * (uint*)( this + 0xa8 );
               puVar9 = (uint*)( lVar11 + uVar12 * 0xc );
               bVar2 = (byte)puVar9[1];
               if (( bVar2 & 2 ) != 0) {
                  iVar13 = 0;
 ...
 while ( ( bVar2 & 2 ) != 0 );
            ...
            LAB_0010a1c9:str_encoder_t::encode_int((str_encoder_t*)&local_48, *puVar17 - *(int*)( this + 200 ));
         }
            ...
            if (bVar2 < 8) {
               if (( bVar2 & 4 ) == 0) {
                  if (bVar2 != 0) {
                     ...
                     *(undefined2*)( (long)puVar10 + ( uVar12 - 2 ) ) = *(undefined2*)( (long)puVar7 + ( uVar12 - 2 ) );
                     uVar6 = *(uint*)( param_3 + 4 );
                  }
                  ...
                  *(undefined4*)( (long)puVar10 + ( uVar12 - 4 ) ) = *(undefined4*)( (long)puVar7 + ( uVar12 - 4 ) );
                  uVar6 = *(uint*)( param_3 + 4 );
               }
               ...
               *puVar10 = *puVar7;
               *(undefined8*)( (long)puVar10 + ( uVar12 - 8 ) ) = *(undefined8*)( (long)puVar7 + ( uVar12 - 8 ) );
               ...
               LAB_0010a21a:uVar6 = *(uint*)( param_3 + 4 );
            }
 ...
 while ( puVar18 != puVar14 );
   ...
   LAB_0010a230:uVar6 = ~*(uint *)param_3 >> 0x1f;
   LAB_0010a238:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* CFF::opset_t<CFF::blend_arg_t>::process_op(unsigned int, CFF::interp_env_t<CFF::blend_arg_t>&) */void CFF::opset_t<CFF::blend_arg_t>::process_op(uint param_1, interp_env_t *param_2) {
   undefined1 uVar1;
   undefined1 uVar2;
   undefined8 uVar3;
   uint uVar4;
   ...
   if (param_1 < 0xfb) {
      if (param_1 < 0xf7) {
         ...
         LAB_0010a9c0:*(undefined4*)( param_2 + 0x14 ) = 0;
         return;
      }
   ...
   *(uint*)( param_2 + 0x14 ) = uVar4 + 1;
   piVar8 = param_2 + (ulong)uVar4 * 0x20 + 0x18;
   LAB_0010a7f3:*(undefined8*)( piVar8 + 8 ) = 0;
   if (*(int*)( piVar8 + 0x14 ) != 0) {
      *(undefined4*)( piVar8 + 0x14 ) = 0;
      if (( -1 < (int)*(uint*)( piVar8 + 0x10 ) ) && ( *(uint*)( piVar8 + 0x10 ) >> 2 != 0 )) {
         free(*(void**)( piVar8 + 0x18 ));
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* CFF::cs_opset_t<CFF::blend_arg_t, cff2_cs_opset_subr_subset_t,
   CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>, CFF::subr_subset_param_t,
   ...
   CFF::subr_subset_param_t&) [clone .isra.0] */void CFF::cs_opset_t<CFF::blend_arg_t,cff2_cs_opset_subr_subset_t,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,CFF::subr_subset_param_t,CFF::path_procs_null_t<CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,CFF::subr_subset_param_t>>::process_op(uint param_1, cff2_cs_interp_env_t *param_2, subr_subset_param_t *param_3) {
   uint uVar1;
   int iVar2;
   uint uVar3;
   uint *puVar4;
   ...
   if (0x1f < param_1) {
      if (param_1 == 0xff) {
         ...
         *(double*)pcVar6 = (double)(int)( uVar3 >> 0x18 | ( uVar3 & 0xff0000 ) >> 8 | ( uVar3 & 0xff00 ) << 8 | uVar3 << 0x18 ) * __LC22;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>::process_blend() */void CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>::process_blend(cff2_cs_interp_env_t<CFF::blend_arg_t> *this) {
   uint uVar1;
   long lVar2;
   uint uVar3;
   void *pvVar4;
   ...
   if (*(uint*)( this + 0x41a4 ) < ( uint )(ushort)(*(ushort*)( lVar2 + 8 ) << 8 | *(ushort*)( lVar2 + 8 ) >> 8)) {
   ...
   puVar5 = &_hb_NullPool;
   if (uVar3 != 0) {
      puVar5 = (undefined*)( lVar2 + 2 + ( ulong )(uVar3 >> 0x18 | ( uVar3 & 0xff0000 ) >> 8 | ( uVar3 & 0xff00 ) << 8 | uVar3 << 0x18) );
   }
   ...
   *(uint*)( this + 0x41a0 ) = (uint)uVar6;
   ...
   if ((int)uVar3 < 0) {
      LAB_0010afa1:*(int*)( this + 0xc ) = *(int*)( this + 8 ) + 1;
      goto LAB_0010ae32;
   }
   ...
   if (uVar6 < uVar1) {
      if (uVar3 < uVar1) {
         ...
         LAB_0010af99:*(uint*)( this + 0x41a8 ) = ~uVar3;
         goto LAB_0010afa1;
      }

      if (uVar1<uVar3> > 2) {
         LAB_0010afaf:pvVar4 = *(void**)( this + 0x41b0 );
         goto LAB_0010af22;
      }

      LAB_0010aed5:*(uint*)( this + 0x41ac ) = uVar7;
      uVar3 = *(uint*)( this + 0x41a0 );
      this_00 = (ItemVariationStore*)( *(long*)( this + 0x4198 ) + 2 );
      if (uVar7 == 0) goto LAB_0010aea3;
      LAB_0010aef1:pfVar10 = *(float**)( this + 0x41b0 );
   }
 else {
      if (uVar3 < uVar8) {
         pvVar4 = *(void**)( this + 0x41b0 );
         uVar11 = (ulong)uVar8;
         LAB_0010af22:pvVar4 = realloc(pvVar4, uVar11 << 2);
         if (pvVar4 == (void*)0x0) {
            uVar3 = *(uint*)( this + 0x41a8 );
         ...
         puVar5 = extraout_RDX;
         LAB_0010af4c:if (uVar8 <= (uint)uVar11) goto LAB_0010aed5;
         hb_memset((void*)( *(long*)( this + 0x41b0 ) + uVar11 * 4 ), ( uVar8 - (uint)uVar11 ) * 4, (uint)puVar5);
      ...
      *(undefined8*)( this + 0x41b0 ) = 0;
      this_00 = (ItemVariationStore*)( *(long*)( this + 0x4198 ) + 2 );
      LAB_0010aea3:pfVar10 = (float*)&_hb_CrapPool;
      __hb_CrapPool = __hb_NullPool;
   }

   OT::ItemVariationStore::get_region_scalars(this_00, *(uint*)( this + 0x41a4 ), *(int**)( this + 0x4188 ), *(uint*)( this + 0x4190 ), pfVar10, uVar3);
   LAB_0010ae32:this[0x41ba] = (cff2_cs_interp_env_t<CFF::blend_arg_t>)0x1;
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* CFF::cs_interpreter_t<CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>, cff2_cs_opset_subr_subset_t,
   CFF::subr_subset_param_t>::interpret(CFF::subr_subset_param_t&) */cff2_cs_interp_env_t CFF::cs_interpreter_t<CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,CFF::subr_subset_param_t>::interpret(cs_interpreter_t<CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,CFF::subr_subset_param_t> *this, subr_subset_param_t *param_1) {
   ...
   LAB_0010b018:iVar8 = *(int*)( this_00 + 0x4064 );
   lVar21 = *(long*)param_1;
   if (iVar8 != 0) {
   ...
   LAB_0010b02a:*(byte*)( lVar21 + 0x18 ) = *(byte*)( lVar21 + 0x18 ) | 1;
   this_00[0x4050] = (cff2_cs_interp_env_t)0x1;
   *(undefined4*)( this_00 + 0x14 ) = 0;
   LAB_0010b03e:do {
      cVar1 = this_00[0x4060];
      joined_r0x0010b046:if (cVar1 != (cff2_cs_interp_env_t)0x0) {
         LAB_0010b100:*(uint*)( this_00 + 0xc ) = uVar7 + 1;
         return (cff2_cs_interp_env_t)0x0;
      }

      uVar17 = *(uint*)( this_00 + 0xc );
      psVar20 = (subr_subset_param_t*)(ulong)uVar17;
      if (( ( uVar7 < uVar17 ) || ( this_00[0x10] != (cff2_cs_interp_env_t)0x0 ) ) || ( iVar30 = iVar30 == 0 )) goto LAB_0010b100;
      ...
      LAB_0010b084:sVar2 = psVar20[*(long*)this_00];
      ...
      *(uint*)( this_00 + 0xc ) = uVar17;
      ...
      if (sVar2 != (subr_subset_param_t)0xb) {
         if ((byte)sVar2 < 0xc) {
            ...
            cff2_cs_opset_subr_subset_t::process_call_subr(10, 2, this_00, param_1, this_00 + 0x4168, *(undefined8*)( param_1 + 0x28 ));
            this_00 = *(cff2_cs_interp_env_t**)this;
            uVar7 = *(uint*)( this_00 + 8 );
            goto LAB_0010b03e;
         }
         ...
         cff2_cs_opset_subr_subset_t::process_call_subr(0x1d, 1, this_00, param_1, this_00 + 0x4158, *(undefined8*)( param_1 + 0x20 ));
         this_00 = *(cff2_cs_interp_env_t**)this;
         cVar1 = this_00[0x4060];
         uVar7 = *(uint*)( this_00 + 8 );
      ...
      *(byte*)( *(long*)param_1 + 0x18 ) = *(byte*)( *(long*)param_1 + 0x18 ) | 1;
      ...
      if (iVar8 == 0) {
         ...
         LAB_0010b12c:*(uint*)( this_00 + 0x4064 ) = iVar8 - 1U;
      ...
      *(undefined8*)( this_00 + 0x4048 ) = uVar33;
      ...
      if (iVar8 == 1) {
         ...
         if (uVar7 < *(uint*)( lVar21 + 4 )) {
            LAB_0010b21c:lVar21 = *(long*)( lVar21 + 8 ) + (ulong)uVar7 * 0x28;
            LAB_0010b228:if (lVar21 != 0) {
               if (( *(byte*)( lVar21 + 0x18 ) & 1 ) == 0) {
                  hb_vector_t<CFF::parsed_cs_op_t,false>::alloc((hb_vector_t<CFF::parsed_cs_op_t,false>*)( lVar21 + 8 ), *(uint*)( this_00 + 8 ), true);
               }
 ...
 while ( true );
   if (sVar2 == (subr_subset_param_t)0x10) {
      cff2_cs_interp_env_t<CFF::blend_arg_t>::process_blend((cff2_cs_interp_env_t<CFF::blend_arg_t>*)this_00);
                  ...
                  if (-1 < (int)uVar9) {
                     ...
                     if (uVar9 < uVar19) {
                        if (uVar19 < 0x20000000) {
                           ...
                           LAB_0010b5dc:pvVar14 = realloc(pvVar14, (ulong)uVar19 << 3);
                        ...
                        *(uint*)( pcVar16 + 0x10 ) = ~uVar9;
                        ...
                        if (uVar19<uVar9> > 2) {
                           ...
                           free(pvVar14);
                           pvVar14 = (void*)0x0;
                           LAB_0010b614:*(void**)( pcVar16 + 0x18 ) = pvVar14;
                           *(uint*)( pcVar16 + 0x10 ) = uVar19;
                           LAB_0010b61c:uVar4 = *(uint*)( pcVar16 + 0x14 );
                        }

                        if (uVar4 < uVar17) {
                           memset((void*)( (long)*(double*)( pcVar16 + 0x18 ) + (ulong)uVar4 * 8 ), 0, ( ulong )(( uVar17 - 1 ) - uVar4) * 8 + 8);
                        }
 ...
 while ( pcVar29 != pcVar22 );
                  ...
                  dVar32 = 0.0;
                  if (( ( this_00[0x41b8] != (cff2_cs_interp_env_t)0x0 ) && ( *(uint*)( this_00 + 0x41ac ) == uVar17 ) ) && ( uVar17 != 0 )) {
 ...
 while ( iVar31 != iVar8 );
      ...
      *(uint*)( this_00 + 0x14 ) = uVar17;
      ...
      if ((byte)sVar2 < 0x11) {
         if (sVar2 == (subr_subset_param_t)0xf) {
            ...
            if (( this_00[0x41b9] == (cff2_cs_interp_env_t)0x0 ) && ( this_00[0x41ba] == (cff2_cs_interp_env_t)0x0 )) {
      ...
      LAB_0010b1aa:cs_opset_t<CFF::blend_arg_t,cff2_cs_opset_subr_subset_t,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,CFF::subr_subset_param_t,CFF::path_procs_null_t<CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,CFF::subr_subset_param_t>>::process_op(uVar25, this_00, psVar20);
   }

   LAB_0010b1b5:puVar5 = *(uint**)param_1;
   if (( puVar5[6] & 1 ) != 0) goto LAB_0010b1c2;
   uVar7 = puVar5[3];
   if ((int)uVar7 < (int)puVar5[2]) {
      LAB_0010b25c:plVar10 = (long*)( (ulong)uVar7 * 0x10 + *(long*)( puVar5 + 4 ) );
      puVar5[3] = uVar7 + 1;
      *plVar10 = 0;
      plVar10[1] = 0xffff;
   }
 else {
      cVar6 = hb_vector_t<CFF::parsed_cs_op_t,false>::alloc((hb_vector_t<CFF::parsed_cs_op_t,false>*)( puVar5 + 2 ), uVar7 + 1, false);
      if (cVar6 != '\0') {
         uVar7 = puVar5[3];
         goto LAB_0010b25c;
      }
   ...
   *puVar5 = uVar17;
   LAB_0010b1c2:this_00 = *(cff2_cs_interp_env_t**)this;
   uVar7 = *(uint*)( this_00 + 8 );
   goto LAB_0010b03e;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* CFF::subr_subsetter_t<cff2_subr_subsetter_t, CFF::Subrs<OT::IntType<unsigned int, 4u> >,
   OT::cff2::accelerator_subset_t const, CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,
   cff2_cs_opset_subr_subset_t, 65535u>::subset() */undefined8 CFF::subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>::subset(subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u> *this) {
   byte bVar1;
   byte bVar2;
   undefined4 uVar3;
   CFFIndex<OT::IntType<unsigned_int,4u>> *this_00;
   ...
   *(undefined8*)( puVar33 + 0x2ff0 ) = *(undefined8*)( in_FS_OFFSET + 0x28 );
   ...
   if (lVar35 == 0) {
      *(undefined8*)( puVar33 + -0x12a0 ) = 0x10c17c;
      cVar8 = hb_vector_t<CFF::parsed_cs_str_t,false>::alloc((hb_vector_t<CFF::parsed_cs_str_t,false>*)( this + 0xe0 ), uVar42, true);
      if (cVar8 != '\0') {
 ...
 while ( puVar37 != (undefined4*)( lVar36 + 0x28 + ( ( ulong )(( uVar42 - uVar38 ) - 1) + (ulong)uVar38 ) * 0x28 ) );
         }
 ...
 while ( puVar37 != (undefined4*)( lVar36 + 0x28 + ( ( ulong )(( uVar42 - uVar38 ) - 1) + (ulong)uVar38 ) * 0x28 ) );
            ...
            *(subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>**)( puVar33 + -0x1298 ) = this;
 ...
 while ( lVar11 != ( ulong )(uVar38 - uVar42) * -0x28 + lVar36 );
            this * (subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>**)( puVar33 + -0x1298 );
         }
         ...
         if (*(int*)( lVar36 + 0x98 ) != 0) {
            ...
            *(hb_vector_t<CFF::parsed_cs_str_t,false>**)( puVar33 + -0x1288 ) = phVar20;
            do {
               ...
               if (uVar38 < uVar42) {
                  phVar20 = (hb_vector_t<CFF::parsed_cs_str_t,false>*)( lVar35 * 0x10 + *(long*)( this + 0x108 ) );
               }
 else {
                  _pthread_mutex_lock = __hb_CrapPool;
 ...
 while ( puVar37 != (undefined4*)( lVar36 + 0x28 + ( ( ulong )(( uVar9 - 1 ) - uVar42) + (ulong)uVar42 ) * 0x28 ) );
                  }
 ...
 while ( (uint)lVar35 < *(uint*)( lVar36 + 0x98 ) );
      ...
      if (-1 < (int)uVar38) {
         ...
         if (uVar38 < uVar44) {
            if (uVar44 < 0x20000000) {
               ...
               LAB_0010b90b:*(undefined8*)( puVar33 + -0x12a0 ) = 0x10b917;
            ...
            *(uint*)( this + 0x68 ) = ~uVar38;
            ...
            if (uVar44<uVar38> > 2) {
               ...
               *(undefined8*)( puVar33 + -0x12a0 ) = 0x10d2c5;
               free(pvVar10);
               pvVar10 = (void*)0x0;
               LAB_0010b920:*(void**)( this + 0x70 ) = pvVar10;
               *(uint*)( this + 0x68 ) = uVar44;
               LAB_0010b928:uVar9 = *(uint*)( this + 0x6c );
            }
      ...
      LAB_0010b94e:*(hb_vector_t<CFF::parsed_cs_str_t,false>**)( this + 0x78 ) = phVar20;
      *(hb_vector_t<CFF::parsed_cs_str_vec_t,false>**)( this + 0x80 ) = this_02;
      if (( ( ( -1 < *(int*)( this + 0xd0 ) ) && ( -1 < *(int*)( this + 0x68 ) ) ) && ( -1 < *(int*)( this + 0xe0 ) ) ) && ( ( -1 < *(int*)phVar20 && ( -1 < *(int*)( this + 0x58 ) ) ) )) {
 ...
 while ( pauVar41 != pauVar15 );
                     ...
                     *(undefined1(*) [16])( puVar33 + 0x2e90 ) = (undefined1[16])0x0;
                     ...
                     if (*(undefined1(**) [16])( puVar33 + -0x1280 ) != (undefined1(*) [16])( puVar33 + 0x2ea8 )) goto LAB_0010bcb0;
                  }
                  ...
                  *(undefined8*)( puVar33 + -0x12a0 ) = 0x10be3a;
                  hb_vector_t<CFF::parsed_cs_op_t,false>::alloc((hb_vector_t<CFF::parsed_cs_op_t,false>*)( puVar25 + 8 ), auVar54._8_4_, true);
                  ...
                  *(subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>**)( puVar33 + -0x1248 ) = this + 0xf0;
                  *(subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>**)( puVar33 + -0x1298 ) = this + 0xf0;
                  *(undefined**)( puVar33 + -0x1240 ) = puVar16;
                  *(subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>**)( puVar33 + -0x1238 ) = this + 0x10;
                  *(undefined**)( puVar33 + -0x1258 ) = puVar31;
                  *(undefined**)( puVar33 + -0x1250 ) = puVar31;
                  *(undefined8*)( puVar33 + -0x12a0 ) = 0x10bedf;
                  cVar8 = cs_interpreter_t<CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,CFF::subr_subset_param_t>::interpret((cs_interpreter_t<CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,CFF::subr_subset_param_t>*)( puVar33 + -0x1260 ), (subr_subset_param_t*)( puVar33 + -0x1258 ));
                  ...
                  if (cVar8 != '\0') {
                     ...
                     if (( ( uVar44 & 1 ) == 0 ) && ( *(long*)( *(long*)( this + 8 ) + 0xad8 ) == 0 )) {
                        ...
                        *(subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>**)( puVar33 + -0x11f8 ) = this + 0x10;
                        ...
                        *(undefined8*)( puVar33 + -0x12a0 ) = 0x10bfdd;
                        cVar8 = drop_hints_in_str(ppVar40, (subr_subset_param_t*)( puVar33 + -0x1218 ), (drop_hints_param_t*)( puVar33 + -0x1264 ));
                        uVar9 = *(uint*)( this + 0xe4 );
                        ...
                        if (cVar8 != '\0') {
                           LAB_0010c010:_pthread_mutex_unlock = uVar24;
                           puVar25[0x18] = puVar25[0x18] | 4;
                           goto LAB_0010c014;
                        }

                        LAB_0010c027:puVar25 = (undefined*)( lVar36 + (ulong)uVar38 * 0x28 );
                     }
                     ...
                     if (1 < uVar42) {
                        ...
                        do {
                           ...
                           if (( ( ( (int)plVar30[1] == 10 ) || ( (int)plVar30[1] == 0x1d ) ) || ( (int)plVar17[1] == 10 ) ) || ( ( ( (int)plVar17[1] == 0x1d || ( *(char*)( (long)plVar30 + 0xd ) != *(char*)( (long)plVar17 + 0xd ) ) ) || ( ( bVar1 = *(byte*)( (long)plVar30 + 0xc ) * plVar17 != (ulong)bVar1 + *plVar30 || ( bVar2 = *(byte*)( (long)plVar17 + 0xc ) < (uint)bVar1 + (uint)bVar2 ) ) ) ) )) {
 ...
 while ( (long*)( lVar36 + 0x20 + ( ulong )(uVar42 - 2) * 0x10 ) != plVar17 );
                        ...
                        if (uVar38 < uVar42) {
                           ...
                           *(undefined8*)( puVar33 + -0x12a0 ) = 0x10c0df;
                           hb_vector_t<CFF::parsed_cs_op_t,false>::alloc((hb_vector_t<CFF::parsed_cs_op_t,false>*)( puVar25 + 8 ), uVar38, true);
                        }
 ...
 while ( puVar13 != puVar12 );
               ...
               if (*(uint*)( this + 0x6c ) == 0) {
                  ...
                  *(undefined8*)( puVar33 + -0x12a0 ) = 0x10bad0;
                  cVar8 = hb_vector_t<CFF::parsed_cs_op_t,false>::alloc((hb_vector_t<CFF::parsed_cs_op_t,false>*)( puVar37 + 2 ), 0, false);
                  if (cVar8 != '\0') {
                     puVar37[3] = 0;
                  }
                  ...
                  *(undefined8*)( puVar33 + -0x12a0 ) = 0x10baed;
                  hb_vector_t<CFF::parsed_cs_op_t,false>::alloc((hb_vector_t<CFF::parsed_cs_op_t,false>*)( puVar37 + 2 ), uVar42, true);
                  if (-1 < (int)puVar37[2]) {
                     uVar42 = puVar46[3];
 ...
 while ( lVar11 != (ulong)uVar42 << 4 );
                  ...
                  *(byte*)( puVar37 + 6 ) = bVar1 & 0xe0 | bVar27 | bVar28 | bVar29 | bVar2 & 8 | *(byte*)( puVar46 + 6 ) & 0x10;
               ...
               LAB_0010ba0f:puVar47 = puVar47 + 2;
            }
 ...
 while ( plVar17 != (long*)( lVar19 + 0x20 + ( ulong )(uVar42 - 2) * 0x10 ) );
                  ...
                  if (uVar38 < uVar42) {
                     ...
                     *(undefined8*)( puVar33 + -0x12a0 ) = 0x10c5f0;
                     hb_vector_t<CFF::parsed_cs_op_t,false>::alloc((hb_vector_t<CFF::parsed_cs_op_t,false>*)( lVar36 + 8 ), uVar38, true);
                  }
               ...
               for (; lVar11 != lVar19; lVar11 = lVar11 + 0x28) {
                  ...
                  if (1 < uVar42) {
                     ...
                     do {
                        ...
                        if (( ( (int)plVar30[1] == 10 ) || ( (int)plVar30[1] == 0x1d ) ) || ( ( (int)plVar17[1] == 10 || ( ( ( (int)plVar17[1] == 0x1d || ( *(char*)( (long)plVar30 + 0xd ) != *(char*)( (long)plVar17 + 0xd ) ) ) || ( bVar1 = *(byte*)( (long)plVar30 + 0xc ) * plVar17 != (ulong)bVar1 + *plVar30 ) ) ) ) )) {
                           LAB_0010c6b0:uVar26 = ( ulong )((int)uVar26 + 1);
                           lVar48 = plVar17[1];
                        ...
                        if (-1 < (int)uVar42) {
                           if (uVar42 < uVar38) {
                              if ((int)uVar9 < 0x10000000) {
                                 LAB_0010c700:*(undefined8*)( puVar33 + -0x12a0 ) = 0x10c70c;
                                 pvVar10 = realloc(pvVar10, (long)(int)uVar38 << 4);
                                 if (pvVar10 != (void*)0x0) {
                                    LAB_0010c715:*(void**)( lVar11 + 0x10 ) = pvVar10;
               ...
               *(undefined8*)( puVar33 + -0x12a0 ) = 0x10cca1;
               ...
               if (-1 < *piVar18) {
                  ...
                  if (iVar43 != 0) {
                     ...
                     *(subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>**)( puVar33 + -0x1290 ) = this;
                     iVar45 = 1;
                     do {
                        piVar18[1] = iVar45;
                        uVar3 = *puVar46;
 ...
 while ( (ulong)uVar42 << 4 != sVar23 );
                        ...
                        LAB_0010cd6a:bVar1 = *(byte*)( puVar46 + 6 );
 ...
 while ( bVar49 );
                     ...
                     this * (subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>**)( puVar33 + -0x1290 );
                  }
               ...
               *(undefined8*)( puVar33 + -0x12a0 ) = 0x10cde3;
               cVar8 = hb_vector_t<CFF::parsed_cs_str_t,false>::alloc((hb_vector_t<CFF::parsed_cs_str_t,false>*)( piVar18 + 4 ), 0, false);
 ...
 while ( lVar48 != lVar19 + (ulong)uVar42 * -0x28 );
               ...
               *(undefined8*)( puVar33 + -0x12a0 ) = 0x10ce49;
               hb_vector_t<CFF::parsed_cs_str_t,false>::alloc((hb_vector_t<CFF::parsed_cs_str_t,false>*)( piVar18 + 4 ), uVar42, true);
               lVar36 = *(long*)( puVar33 + -0x1298 );
 ...
 while ( sVar23 != (ulong)uVar42 << 4 );
                        ...
                        LAB_0010cf12:bVar1 = *(byte*)( puVar46 + 6 );
                        *(undefined8*)( puVar37 + 8 ) = *(undefined8*)( puVar46 + 8 );
                        *(byte*)( puVar37 + 6 ) = *(byte*)( puVar37 + 6 ) & 0xe0 | bVar1 & 0x1f;
                        puVar37[7] = puVar46[7];
                        puVar37 = puVar37 + 10;
               ...
               if (-1 < (int)uVar42) {
                  if (uVar42 < uVar38) {
                     if (uVar38 < 0x10000000) {
                        ...
                        LAB_0010d041:*(long*)( puVar33 + -0x1290 ) = lVar36;
                        ...
                        *(undefined8*)( puVar33 + -0x12a0 ) = 0x10d056;
                        ...
                        if (pvVar10 != (void*)0x0) {
                           LAB_0010d068:*(void**)( lVar36 + 0x28 ) = pvVar10;
                     ...
                     if (uVar42 >> 2 <= uVar38) {
                        LAB_0010d077:uVar21 = *(undefined8*)( this + 0x108 );
                        *(undefined4*)( lVar36 + 0x24 ) = 0;
                        ...
                        *(undefined8*)( puVar33 + -0x1280 ) = uVar21;
                        ...
                        while ((uint)uVar24 < *(uint*)( puVar33 + -0x1288 )) {
                           ...
                           *(uint*)( lVar36 + 0x24 ) = (uint)uVar24 + 1;
                           phVar20 = (hb_vector_t<CFF::parsed_cs_str_t,false>*)( *(long*)( lVar36 + 0x28 ) + uVar24 * 0x10 );
 ...
 while ( sVar23 != (ulong)uVar42 << 4 );
                                    ...
                                    LAB_0010d192:bVar1 = *(byte*)( puVar46 + 6 );
                                    *(undefined8*)( puVar37 + 8 ) = *(undefined8*)( puVar46 + 8 );
                                    *(byte*)( puVar37 + 6 ) = *(byte*)( puVar37 + 6 ) & 0xe0 | bVar1 & 0x1f;
                                    puVar37[7] = puVar46[7];
                                    puVar37 = puVar37 + 10;
...
;
               ...
               LAB_0010c7f8:*(long*)( puVar33 + -0x1298 ) = lVar36;
   ...
   LAB_0010bba0:uVar21 = 0;
   LAB_0010bba2:if (*(long*)( puVar33 + 0x2ff0 ) != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
...
/* hb_vector_t<hb_vector_t<unsigned char, false>, false>::resize(int, bool, bool) */undefined8 hb_vector_t<hb_vector_t<unsigned_char,false>,false>::resize(hb_vector_t<hb_vector_t<unsigned_char,false>,false> *this, int param_1, bool param_2, bool param_3) {
   ...
   if (param_3) {
      ...
      if (uVar5 < uVar2) {
         ...
         pvVar4 = *(void**)( this + 8 );
         LAB_0010d45c:uVar6 = (uint)uVar7;
         pvVar4 = realloc(pvVar4, uVar7 << 4);
         if (pvVar4 == (void*)0x0) {
            uVar5 = *(uint*)this;
            if (uVar5 < uVar6) {
               LAB_0010d392:*(uint*)this = ~uVar5;
               return 0;
            }
 ...
 while ( uVar6 < uVar3 );
   ...
   LAB_0010d34d:uVar6 = *(uint*)( this + 4 );
   LAB_0010d350:if (uVar6 < uVar3) {
      if (param_2) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* CFF::cs_opset_t<CFF::blend_arg_t, cff2_cs_opset_flatten_t,
    ...
    */void CFF::cs_opset_t<CFF::blend_arg_t,cff2_cs_opset_flatten_t,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,CFF::flatten_param_t,CFF::path_procs_null_t<CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,CFF::flatten_param_t>>::process_op(uint param_1, cff2_cs_interp_env_t *param_2, flatten_param_t *param_3) {
   str_encoder_t *this;
   int iVar1;
   uint uVar2;
   uint *puVar3;
   ...
   if (0x1f < param_1) {
      ...
      *(int *)(param_2 + 0xc) = *(int *)(param_2 + 0xc) + 4;
      ...
      switchD_0010d4fc_caseD_2:opset_t<CFF::blend_arg_t>::process_op(param_1, (interp_env_t*)param_2);
      return;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* CFF::subr_flattener_t<OT::cff2::accelerator_subset_t const,
   CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>, cff2_cs_opset_flatten_t,
   65535u>::flatten(hb_vector_t<hb_vector_t<unsigned char, false>, false>&) */uint CFF::subr_flattener_t<OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_flatten_t,65535u>::flatten(subr_flattener_t<OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_flatten_t,65535u> *this, hb_vector_t *param_1) {
   double *pdVar1;
   byte bVar2;
   undefined4 uVar3;
   long lVar4;
 ...
 while ( puVar31 + -0x1000 != local_4030 );
   ...
   *(undefined8*)( puVar31 + -0x1260 ) = 0x10dbb2;
   uVar11 = hb_vector_t<hb_vector_t<unsigned_char,false>,false>::resize((hb_vector_t<hb_vector_t<unsigned_char,false>,false>*)param_1, uVar12, true, true);
   if ((char)uVar11 == '\0') {
      LAB_0010e077:uVar11 = 0;
   }
 else {
      ...
      *(ulong*)( puVar31 + -0x1238 ) = (ulong)uVar12;
      if (uVar12 != 0) {
         ...
         do {
            ...
            if (lVar5 != 0) {
               uVar28 = ( ulong )(*(uint*)( puVar31 + -0x124c ) & 0x3fffffff) % ( ulong ) * (uint*)( lVar4 + 0x20 );
               ...
               *(undefined4*)( puVar31 + -0x122c ) = 200000;
               do {
                  ...
                  if (uVar12 < uVar26) {
                     ...
                     LAB_0010df33:*(undefined8*)( puVar31 + -0x1260 ) = 0x10df41;
                     cs_opset_t<CFF::blend_arg_t,cff2_cs_opset_flatten_t,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,CFF::flatten_param_t,CFF::path_procs_null_t<CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,CFF::flatten_param_t>>::process_op(uVar37, *(cff2_cs_interp_env_t**)( puVar31 + -0x1258 ), (flatten_param_t*)( puVar31 + -0x11f8 ));
                     uVar12 = *(uint*)( puVar31 + -0x11d0 );
                  }
 else {
                     ...
                     *(undefined8*)( puVar31 + -0x1260 ) = 0x10e144;
                     ...
                     if (iVar14 < 0) {
                        puVar31[-0x11c8] = 1;
                        LAB_0010e34e:*(uint*)( puVar31 + -0x11c4 ) = uVar26;
                     }
 else {
                        ...
                        if (uVar35 <= uVar26) {
                           if (iVar14 != 0) {
                              ...
                              *(subr_flattener_t<OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_flatten_t,65535u>**)( puVar31 + -0x1210 ) = this;
                              ...
                              *(undefined8**)( puVar31 + -0x1248 ) = puVar38;
                              do {
                                 ...
                                 pdVar24 = (double*)( *(long*)( puVar31 + -0x1258 ) + 0x18 + (ulong)uVar37 * 0x20 );
                                    ...
                                    if (-1 < (int)uVar15) {
                                       ...
                                       if (uVar15 < uVar27) {
                                          if (uVar27 < 0x20000000) {
                                             ...
                                             LAB_0010e39c:*(uint*)( puVar31 + -0x11fc ) = uVar12;
                                          ...
                                          *(uint*)( pdVar24 + 2 ) = ~uVar15;
                                          ...
                                          if (uVar27<uVar15> > 2) {
                                             ...
                                             *(undefined8*)( puVar31 + -0x1260 ) = 0x10e512;
                                             ...
                                             pvVar23 = (void*)0x0;
                                             uVar12 = *(uint*)( puVar31 + -0x11fc );
                                             LAB_0010e3cc:pdVar24[3] = (double)pvVar23;
                                             *(uint*)( pdVar24 + 2 ) = uVar36;
                                             LAB_0010e3d4:uVar36 = *(uint*)( (long)pdVar24 + 0x14 );
                                          }
                                          ...
                                          if (uVar36 < uVar26) {
                                             ...
                                             *(undefined8*)( puVar31 + -0x1260 ) = 0x10e406;
                                             memset((void*)( (long)dVar40 + (ulong)uVar36 * 8 ), 0, ( ulong )(( uVar26 - 1 ) - uVar36) * 8 + 8);
 ...
 while ( pdVar34 != pdVar1 );
                                    ...
                                    dVar40 = *pdVar24;
                                    dVar41 = 0.0;
                                    if (( ( puVar31[0x2fe0] != '\0' ) && ( *(uint*)( puVar31 + 0x2fd4 ) == uVar26 ) ) && ( uVar26 != 0 )) {
                                    ...
                                    *(undefined8*)( puVar31 + -0x1260 ) = 0x10e29e;
                                    ...
                                    if (*(int*)( (long)pdVar24 + 0x14 ) != 0) {
                                       *(undefined4*)( (long)pdVar24 + 0x14 ) = 0;
                                       if (( -1 < (int)*(uint*)( pdVar24 + 2 ) ) && ( *(uint*)( pdVar24 + 2 ) >> 2 != 0 )) {
                                          pvVar23 = (void*)pdVar24[3];
 ...
 while ( iVar13 != *(int*)( puVar31 + -0x1250 ) );
                              ...
                              this * (subr_flattener_t<OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_flatten_t,65535u>**)( puVar31 + -0x1210 );
                  ...
                  LAB_0010df49:if (( ( puVar31[0x2e88] != '\0' ) || ( uVar11 = uVar12 < uVar11 ) ) || ( puVar31[-0x11c8] != '\0' )) {
                     LAB_0010e030:if (*(int*)( puVar31 + 0x2fd0 ) != 0) {
...
;
 ...
 while ( puVar17 != puVar38 );
            ...
            LAB_0010dfdf:*(int*)( puVar31 + -0x124c ) = *(int*)( puVar31 + -0x124c ) + -0x61c8864f;
            lVar33 = lVar33 + 1;
         }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* OT::cff2_subset_plan::create(OT::cff2::accelerator_subset_t const&, hb_subset_plan_t*) */undefined8 OT::cff2_subset_plan::create(cff2_subset_plan *this, accelerator_subset_t *param_1, hb_subset_plan_t *param_2) {
   undefined4 *puVar1;
   int *piVar2;
   byte bVar3;
 ...
 while ( ( bVar3 & 2 ) != 0 );
   ...
   LAB_0010e66a:if (*piVar14 == 0) {
      uVar6 = **(uint**)( param_1 + 0x88 );
      *(ulong*)( this + 0x18 ) = CONCAT44(uVar6 >> 0x18 | ( uVar6 & 0xff0000 ) >> 8 | ( uVar6 & 0xff00 ) << 8 | uVar6 << 0x18, *(undefined4*)( param_2 + 0x58 ));
      ...
      if (( uVar6 & 4 ) == 0 && iVar11 == 0) {
         ...
         *(undefined4*)( this + 0xb4 ) = 0;
         CFF::subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>::subr_subsetter_t((subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>*)&local_158, param_1, param_2);
         cVar5 = CFF::subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>::subset((subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>*)&local_158);
         if (cVar5 != '\0') {
            cVar4 = this[0x2c];
            cVar5 = hb_vector_t<hb_vector_t<unsigned_char,false>,false>::resize((hb_vector_t<hb_vector_t<unsigned_char,false>,false>*)( this + 0x80 ), *(int*)( local_150 + 0x58 ), true, true);
            if (cVar5 != '\0') {
               ...
               for (; puVar18 != puVar8; puVar18 = puVar18 + 2) {
                  ...
                  cVar5 = CFF::subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>::encode_str((subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>*)&local_158, ppVar20, uVar6, (hb_vector_t*)( uVar23 * 0x10 + *(long*)( this + 0x88 ) ), (bool)( (byte)cVar4 ^ 1 ));
                  if (cVar5 == '\0') goto LAB_0010e758;
                  lVar19 = local_e0;
                  uVar6 = local_bc;
               }

               cVar5 = hb_vector_t<hb_vector_t<unsigned_char,false>,false>::resize((hb_vector_t<hb_vector_t<unsigned_char,false>,false>*)( this + 0x90 ), uVar6, true, true);
               if (cVar5 != '\0') {
                  uVar23 = 0;
                  if (uVar6 != 0) {
                     do {
                        ...
                        cVar5 = CFF::subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>::encode_str((subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>*)&local_158, ppVar20, 0, phVar12, true);
                        if (cVar5 == '\0') goto LAB_0010e758;
                        uVar23 = uVar23 + 1;
                     }
 while ( uVar6 != uVar23 );
 ...
 while ( uVar22 < uVar13 );
                        if (0xfffffff < uVar22) {
                           LAB_0010ed7e:*(uint*)( this + 0xa0 ) = ~uVar6;
                           goto LAB_0010e758;
                        }
                     ...
                     if (uVar6 < uVar13) {
                        hb_memset((void*)( (ulong)uVar6 * 0x10 + *(long*)( this + 0xa8 ) ), ( uVar13 - uVar6 ) * 0x10, uVar13);
                     }
                     ...
                     *(uint*)( this + 0xa4 ) = uVar13;
                     if (*(int*)( this + 0x1c ) != 0) {
                        ...
                        while (true) {
                           uVar6 = (uint)lVar19;
                           if (uVar6 < uVar13) {
                              this_00 = (hb_vector_t<hb_vector_t<unsigned_char,false>,false>*)( lVar19 * 0x10 + *(long*)( this + 0xa8 ) );
                           ...
                           cVar5 = hb_vector_t<hb_vector_t<unsigned_char,false>,false>::resize(this_00, uVar13, true, true);
                           if (cVar5 == '\0') goto LAB_0010e758;
                           uVar23 = 0;
                           if (uVar13 != 0) {
                              do {
                                 ...
                                 if (*puVar8 < *(uint*)( puVar15 + 4 )) {
                                    ppVar20 = (parsed_cs_str_t*)( *(long*)( puVar15 + 8 ) + ( ulong ) * puVar8 * 0x28 );
                                 }

                                 cVar5 = CFF::subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>::encode_str((subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>*)&local_158, ppVar20, uVar6, phVar12, true);
                                 if (cVar5 == '\0') goto LAB_0010e758;
                                 uVar23 = uVar23 + 1;
                              }
 while ( uVar23 != uVar13 );
...
;
                     ...
                     CFF::subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>::~subr_subsetter_t((subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>*)&local_158);
                     goto LAB_0010e6e6;
                  }
         ...
         *(undefined4*)( this + 0xb4 ) = 0;
         local_158 = param_1;
         local_150 = param_2;
         cVar5 = CFF::subr_flattener_t<OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_flatten_t,65535u>::flatten((subr_flattener_t<OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_flatten_t,65535u>*)&local_158, (hb_vector_t*)( this + 0x80 ));
         if (cVar5 != '\0') {
            LAB_0010e6e6:if (*(FDSelect**)( param_1 + 0x90 ) == (FDSelect*)&_hb_NullPool) {
               ...
               cVar5 = hb_vector_t<unsigned_int,false>::alloc((hb_vector_t<unsigned_int,false>*)( this + 0x70 ), 0, false);
               if (cVar5 != '\0') {
               ...
               uVar7 = hb_plan_subset_cff_fdselect(param_2, *(uint*)( this + 0x1c ), *(FDSelect**)( param_1 + 0x90 ), (uint*)( this + 0x20 ), (uint*)( this + 0x24 ), (uint*)( this + 0x28 ), (hb_vector_t*)( this + 0x30 ), (hb_inc_bimap_t*)( this + 0x40 ));
            }
   ...
   uVar7 = 0;
   LAB_0010e768:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Control flow encountered bad instruction data *//* CFF::subr_subsetter_t<cff2_subr_subsetter_t, CFF::Subrs<OT::IntType<unsigned int, 4u> >,
   OT::cff2::accelerator_subset_t const, CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,
   cff2_cs_opset_subr_subset_t, 65535u>::subr_subsetter_t(OT::cff2::accelerator_subset_t const&,
   hb_subset_plan_t const*) */void CFF::subr_subsetter_t<cff2_subr_subsetter_t,CFF::Subrs<OT::IntType<unsigned_int,4u>>,OT::cff2::accelerator_subset_t_const,CFF::cff2_cs_interp_env_t<CFF::blend_arg_t>,cff2_cs_opset_subr_subset_t,65535u>::subr_subsetter_t(accelerator_subset_t *param_1, hb_subset_plan_t *param_2) {

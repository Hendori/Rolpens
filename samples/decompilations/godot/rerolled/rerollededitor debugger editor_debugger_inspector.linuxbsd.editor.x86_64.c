/* HashMap<ObjectID, EditorDebuggerRemoteObject*, HashMapHasherDefault,
   ...
   .isra.0] */undefined8 HashMap<ObjectID,EditorDebuggerRemoteObject*,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,EditorDebuggerRemoteObject*>>>::_lookup_pos(HashMap<ObjectID,EditorDebuggerRemoteObject*,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,EditorDebuggerRemoteObject*>>> *this, ObjectID *param_1, uint *param_2) {
   long lVar1;
...
/* EditorDebuggerInspector::_object_selected(ObjectID) */void __thiscall
...
LAB_001023b0:
  ...
  if ((int)local_48 == 2) {
    ...
    if ((int)local_48 == 0) {
      ...
      if ((int)local_48 != 1) goto LAB_001026a0;
  ...
  if (((param_2 != -1) && (plVar2 = *(long **)(lVar1 + 0x188), plVar2 != (long *)0x0)) &&
    ...
    if (0 < param_2) {
      ...
      if ((param_2 & 1U) != 0) {
        ...
        iVar7 = 1;
        if (param_2 == 1) goto LAB_0010250f;
      }
      do {
        iVar7 = iVar7 + 2;
        lVar10 = *(long *)(*(long *)(lVar10 + 0x30) + 0x30);
      } while (param_2 != iVar7);
    }
LAB_0010250f:
    if (lVar10 != 0) {
...
LAB_00102ca0:
      ...
      do {
        ...
        if ((*(int *)pPVar25 == 0x18) &&
          ...
          iVar16 = String::find((char *)local_120,0x104c6b);
          if (iVar16 != -1) {
...
LAB_0010302d:
          ...
          if (uVar27 == 0) goto joined_r0x00103017;
          uVar28 = 0;
          do {
            if ((uVar15 == uVar27) &&
  ...
  if (pvVar6 != (void *)0x0) {
    if (*(int *)(this + 0xd0c) != 0) {
      if (*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0xd08) * 4) != 0) {
        ...
        if (*(int *)(this + 0xd0c) == 0) goto LAB_00104547;
      }
      lVar5 = 0;
      do {
      ...
      *(undefined4 *)(this + 0xd0c) = 0;
      if (pvVar6 == (void *)0x0) goto LAB_0010457b;
    }
LAB_00104547:
  ...
  if (pvVar6 != (void *)0x0) {
    if (*(int *)(this + 0xce4) != 0) {
      ...
      if (uVar2 == 0) {
        ...
        *(undefined4 *)(this + 0xce4) = 0;
        *(undefined1 (*) [16])(this + 0xcd0) = (undefined1  [16])0x0;
        if (pvVar6 == (void *)0x0) goto LAB_0010460b;
      }
    }
    Memory::free_static(pvVar6,false);
...
/* WARNING: Removing unreachable block (ram,0x001051c8) */
      ...
      if (uVar42 != 0) {
        ...
        do {
          if ((int)uVar34 == (int)uVar44) {
            ...
            if (*(long *)(lVar35 + uStack_98 * 8) == lVar36) goto LAB_001064ea;
          }
          uVar42 = uVar42 + 1;
          auVar9._8_8_ = 0;
...
/* WARNING: Removing unreachable block (ram,0x00106c18) */
...

{
  ...
  if (uVar5 < (uint)ObjectDB::slot_max) {
    ...
    ObjectDB::spin_lock._0_1_ = '\0';
    if (puVar6[1] == 0) goto LAB_00108029;
    ...
    if ((uint)param_2 < 2) {
      if (param_2 != 0) {
        *(undefined4 *)param_4 = 0;
        ...
        if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00107fd8. Too many branches */
  ...
  if (pvVar3 != (void *)0x0) {
    if (*(int *)(this + 0x3c) != 0) {
      ...
      if (uVar1 == 0) {
        ...
        *(undefined4 *)(this + 0x3c) = 0;
        *(undefined1 (*) [16])(this + 0x28) = (undefined1  [16])0x0;
        if (pvVar3 == (void *)0x0) goto LAB_0010927f;
      }
    }
    Memory::free_static(pvVar3,false);
...

{
  ...
  if (plVar5 != (long *)0x0) {
    do {
      pvVar2 = (void *)*plVar5;
      if (pvVar2 == (void *)0x0) goto LAB_0010976d;
  ...
  if (pvVar4 != (void *)0x0) {
    if (*(int *)(this + 0x1bc) != 0) {
      ...
      if (uVar1 == 0) {
        ...
        *(undefined4 *)(this + 0x1bc) = 0;
        *(undefined1 (*) [16])(this + 0x1a8) = (undefined1  [16])0x0;
        if (pvVar4 == (void *)0x0) goto LAB_0010ab51;
      }
    }
    Memory::free_static(pvVar4,false);
  ...
  if (pvVar3 != (void *)0x0) {
    if (*(int *)(param_1 + 0x44) != 0) {
      ...
      if (uVar1 == 0) {
        ...
        *(undefined4 *)(param_1 + 0x44) = 0;
        *(undefined1 (*) [16])(param_1 + 0x30) = (undefined1  [16])0x0;
        if (pvVar3 == (void *)0x0) goto LAB_0010c5f5;
      }
    }
    Memory::free_static(pvVar3,false);
  ...
  if (pvVar9 != (void *)0x0) {
    if (*(int *)(this + 0xc8c) != 0) {
      ...
      if (uVar1 == 0) {
        ...
        *(undefined4 *)(this + 0xc8c) = 0;
        *(undefined1 (*) [16])(this + 0xc78) = (undefined1  [16])0x0;
        if (pvVar9 == (void *)0x0) goto LAB_0010c72a;
      }
    }
    Memory::free_static(pvVar9,false);
  ...
  if (pvVar9 != (void *)0x0) {
    if (*(int *)(this + 0xc2c) != 0) {
      ...
      if (uVar1 == 0) {
        ...
        *(undefined4 *)(this + 0xc2c) = 0;
        *(undefined1 (*) [16])(this + 0xc18) = (undefined1  [16])0x0;
        if (pvVar9 == (void *)0x0) goto LAB_0010c7f9;
      }
    }
    Memory::free_static(pvVar9,false);
  ...
  if (pvVar9 != (void *)0x0) {
    if (*(int *)(this + 0xbfc) != 0) {
      ...
      if (uVar1 == 0) {
        ...
        *(undefined4 *)(this + 0xbfc) = 0;
        *(undefined1 (*) [16])(this + 0xbe8) = (undefined1  [16])0x0;
        if (pvVar9 == (void *)0x0) goto LAB_0010c8b0;
      }
    }
    Memory::free_static(pvVar9,false);
  ...
  if (pvVar9 != (void *)0x0) {
    if (*(int *)(this + 0xbcc) != 0) {
      if (*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0xbc8) * 4) != 0) {
        ...
        if (*(int *)(this + 0xbcc) == 0) goto LAB_0010cd90;
      }
      lVar6 = 0;
      do {
      ...
      *(undefined4 *)(this + 0xbcc) = 0;
      if (pvVar9 == (void *)0x0) goto LAB_0010c94e;
    }
LAB_0010cd90:
    Memory::free_static(pvVar9,false);
  ...
  if (pvVar9 != (void *)0x0) {
    if (*(int *)(this + 0xba4) != 0) {
      ...
      if (uVar1 == 0) {
        ...
        *(undefined4 *)(this + 0xba4) = 0;
        *(undefined1 (*) [16])(this + 0xb90) = (undefined1  [16])0x0;
        if (pvVar9 == (void *)0x0) goto LAB_0010c9e7;
      }
    }
    Memory::free_static(pvVar9,false);
...
LAB_0010c9e7:
  if (StringName::configured != '\0') {
    if (*(long *)(this + 0xb68) != 0) {
      StringName::unref();
      if (StringName::configured == '\0') goto LAB_0010ca25;
    }
  ...
  if (pvVar9 != (void *)0x0) {
    if (*(int *)(this + 0xb1c) != 0) {
      if (*(uint *)(hash_table_size_primes + (ulong)*(uint *)(this + 0xb18) * 4) != 0) {
        ...
        if (*(int *)(this + 0xb1c) == 0) goto LAB_0010cca8;
      }
      lVar6 = 0;
      do {
        if ((StringName::configured != '\0') && (*(long *)((long)pvVar9 + lVar6 * 8) != 0)) {
      ...
      *(undefined4 *)(this + 0xb1c) = 0;
      if (pvVar9 == (void *)0x0) goto LAB_0010cabe;
    }
LAB_0010cca8:
    Memory::free_static(pvVar9,false);
  ...
  *(code **)this = MethodBind::get_name;
  if (bVar10) {
    if (*(long *)(this + 0x9e8) != 0) {
      StringName::unref();
      if (StringName::configured == '\0') goto LAB_0010cc24;
    }
...
/* WARNING: Removing unreachable block (ram,0x0010cfe8) */
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010dc26. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0010dde6. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)((long *)((long)param_2 + *(long *)(param_1 + 0x60)));
    return;
  }

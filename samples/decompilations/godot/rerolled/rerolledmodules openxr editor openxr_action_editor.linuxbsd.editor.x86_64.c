/* OpenXRActionEditor::_do_set_action_type(OpenXRAction::ActionType) */void OpenXRActionEditor::_do_set_action_type(long param_1) {
   undefined8 uVar1;
...
/* OpenXRActionEditor::_on_remove_action() */void OpenXRActionEditor::_on_remove_action(OpenXRActionEditor *this) {
   long in_FS_OFFSET;
   long local_70;
   Variant *local_68[2];
   int local_58[6];
...
/* OpenXRActionEditor::_do_set_name(String) */void OpenXRActionEditor::_do_set_name(OpenXRActionEditor *this, CowData *param_2) {
   long *plVar1;
   undefined8 uVar2;
   long lVar3;
   long in_FS_OFFSET;
...
/* OpenXRActionEditor::_theme_changed() */void __thiscall OpenXRActionEditor::_theme_changed(OpenXRActionEditor *this)

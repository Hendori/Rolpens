/* NavigationRegion3DGizmoPlugin::get_priority() const */undefined8 NavigationRegion3DGizmoPlugin::get_priority(void) {
   return 0xffffffff;
}
/* NavigationRegion3DGizmoPlugin::has_gizmo(Node3D*) */bool NavigationRegion3DGizmoPlugin::has_gizmo(NavigationRegion3DGizmoPlugin *this, Node3D *param_1) {
   long lVar1;
...
/* NavigationRegion3DGizmoPlugin::get_gizmo_name() const */NavigationRegion3DGizmoPlugin * __thiscall
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* NavigationRegion3DGizmoPlugin::NavigationRegion3DGizmoPlugin() */void NavigationRegion3DGizmoPlugin::NavigationRegion3DGizmoPlugin(NavigationRegion3DGizmoPlugin *this) {
   long *plVar1;
   long lVar2;
   bool bVar3;
   long in_FS_OFFSET;
   ...
   *(undefined***)this = &PTR__initialize_classv_00105d28;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* NavigationRegion3DGizmoPlugin::redraw(EditorNode3DGizmo*) */void NavigationRegion3DGizmoPlugin::redraw(NavigationRegion3DGizmoPlugin *this, EditorNode3DGizmo *param_1) {
   long *plVar1;
   ...
   if (( ( 0.0 < local_8c ) && ( 0.0 < fStack_88 ) ) && ( 0.0 < local_84 )) {
      ...
      if (param_1[0x17c] != (EditorNode3DGizmo)0x0) {
         ...
         LAB_001011b5:pOVar21 = local_128;
         ...
         if (( ( local_118 != (EditorNode3DGizmo*)0x0 ) && ( cVar14 = RefCounted::unreference() ),pEVar13 = local_118,cVar14 != '\0' )) &&( cVar14 = cVar14 != '\0' )(**(code**)( *(long*)pEVar13 + 0x140 ))(pEVar13);
      ...
      local_4c = 0;
      local_c8 = CONCAT44(fVar32 * _LC44._4_4_ + (float)( (ulong)local_98 >> 0x20 ) + local_a8._4_4_, fVar31 * (float)_LC44 + (float)local_98 + local_a8._0_4_);
      EditorNode3DGizmo::add_solid_box(CONCAT44(fStack_88, local_8c), local_84, local_c8, local_c0, param_1, &local_138, &local_78);
      if (( ( local_138 != (Object*)0x0 ) && ( cVar14 = RefCounted::unreference() ),pOVar21 = local_138,cVar14 != '\0' )) &&( cVar14 = cVar14 != '\0' )(**(code**)( *(long*)pOVar21 + 0x140 ))(pOVar21);
      Memory::free_static(pOVar21, false);
   }

}
}iVar28 = 0;NavigationMesh::get_vertices();lVar18 = local_170;local_1c0 = (undefined1(*) [16])0x0;LAB_00100a8d:iVar16 = NavigationMesh::get_polygon_count();pauVar10 = local_1c0;if (iVar28 < iVar16) {
...
;
 ...
 while ( *(int*)pauVar10[1] != 0 );
      LAB_00100cf7:Memory::free_static(pauVar10, false);
      goto LAB_00100d01;
   }
      ...
      do {
         ...
         do {
            ...
            *(undefined4*)( puVar27 + 1 ) = *(undefined4*)( puVar30 + 1 );
            ...
            fVar33 = local_78;
            fVar37 = fStack_6c;
            if (( local_78 == fStack_6c ) && ( fVar33 = fStack_74 ),fVar37 = fStack_68,fStack_74 == fStack_68) {
            ...
            cVar14 = HashMap<NavigationRegion3DGizmoPlugin::_EdgeKey,bool,NavigationRegion3DGizmoPlugin::_EdgeKey,HashMapComparatorDefault<NavigationRegion3DGizmoPlugin::_EdgeKey>,DefaultTypedAllocator<HashMapElement<NavigationRegion3DGizmoPlugin::_EdgeKey,bool>>>::_lookup_pos((HashMap<NavigationRegion3DGizmoPlugin::_EdgeKey,bool,NavigationRegion3DGizmoPlugin::_EdgeKey,HashMapComparatorDefault<NavigationRegion3DGizmoPlugin::_EdgeKey>,DefaultTypedAllocator<HashMapElement<NavigationRegion3DGizmoPlugin::_EdgeKey,bool>>>*)&local_f8, (_EdgeKey*)&local_78, (uint*)&local_118);
            if (cVar14 == '\0') {
               LAB_00100fbf:puVar19 = (undefined1*)HashMap<NavigationRegion3DGizmoPlugin::_EdgeKey,bool,NavigationRegion3DGizmoPlugin::_EdgeKey,HashMapComparatorDefault<NavigationRegion3DGizmoPlugin::_EdgeKey>,DefaultTypedAllocator<HashMapElement<NavigationRegion3DGizmoPlugin::_EdgeKey,bool>>>::operator []((HashMap<NavigationRegion3DGizmoPlugin::_EdgeKey,bool,NavigationRegion3DGizmoPlugin::_EdgeKey,HashMapComparatorDefault<NavigationRegion3DGizmoPlugin::_EdgeKey>,DefaultTypedAllocator<HashMapElement<NavigationRegion3DGizmoPlugin::_EdgeKey,bool>>>*)&local_f8, (_EdgeKey*)&local_78);
               *puVar19 = 1;
            }
 else {
 ...
 while ( puVar17 != (undefined8*)0x0 );
      local_150 = 0;
      for (puVar17 = (undefined8*)local_e0._0_8_; puVar17 != (undefined8*)0x0; puVar17 = (undefined8*)*puVar17) {
         if (*(char*)( puVar17 + 5 ) != '\0') {
            Vector<Vector3>::push_back(puVar17[2], *(undefined4*)( puVar17 + 3 ), local_158);
            Vector<Vector3>::push_back(*(undefined8*)( (long)puVar17 + 0x1c ), *(undefined4*)( (long)puVar17 + 0x24 ), local_158);
         }
   ...
   if (cVar14 != '\0') {
      ...
      if (0 < iVar28) {
         ...
         do {
            ...
            Color::set_hsv((float)( dVar35 * __LC52 + (double)fVar33 ), fVar32, (float)( dVar34 + (double)fVar31 ), _LC43);
 ...
 while ( iVar28 != iVar29 );
   ...
   ArrayMesh::add_surface_from_arrays(pOVar21, 3, local_1b0, (Array*)local_180, (Dictionary*)&local_138);
   Array::~Array((Array*)local_180);
   Dictionary::~Dictionary((Dictionary*)&local_138);
   local_4c = 0;
   local_128 = (Object*)0x0;
   ...
   EditorNode3DGizmo::add_mesh((Ref*)param_1, (Ref*)local_180, (Transform3D*)&local_138, (Ref*)&local_78);
   ...
   if (cVar14 != '\0') {
      ...
      EditorNode3DGizmo::add_lines((Vector*)param_1, (Ref*)&local_138, SUB81(local_228, 0), (Color*)0x0);
   ...
   HashMap<NavigationRegion3DGizmoPlugin::_EdgeKey,bool,NavigationRegion3DGizmoPlugin::_EdgeKey,HashMapComparatorDefault<NavigationRegion3DGizmoPlugin::_EdgeKey>,DefaultTypedAllocator<HashMapElement<NavigationRegion3DGizmoPlugin::_EdgeKey,bool>>>::~HashMap((HashMap<NavigationRegion3DGizmoPlugin::_EdgeKey,bool,NavigationRegion3DGizmoPlugin::_EdgeKey,HashMapComparatorDefault<NavigationRegion3DGizmoPlugin::_EdgeKey>,DefaultTypedAllocator<HashMapElement<NavigationRegion3DGizmoPlugin::_EdgeKey,bool>>>*)&local_f8);
...
LAB_00100d70:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();LAB_00101d7f:lVar26 = 0;LAB_00101d82:lVar24 = 1;goto LAB_00100c3b;LAB_00101d5d:lVar26 = 0;LAB_00101d60:lVar24 = 2;goto LAB_00100c3b;LAB_00101d2d:if (local_170 == 0) {
   LAB_00101d36:lVar26 = 0;
}
 else {
   LAB_00101c60:lVar26 = *(long*)( local_170 + -8 );
}
goto LAB_00100c3b;LAB_00101d3e:lVar26 = 0;LAB_00101d41:lVar24 = 0;LAB_00100c3b:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar24, lVar26, "p_index", "size()", "", false, true);_err_flush_stdout();/* WARNING: Does not return */pcVar5 = (code*)invalidInstructionException();( *pcVar5 )();}/* DefaultAllocator::alloc(unsigned long) */void DefaultAllocator::alloc(ulong param_1) {
...
/* NavigationRegion3DGizmoPlugin::is_class_ptr(void*) const */uint NavigationRegion3DGizmoPlugin::is_class_ptr(NavigationRegion3DGizmoPlugin *this, void *param_1) {
   return (uint)CONCAT71(0x105f, (undefined4*)param_1 == &EditorNode3DGizmoPlugin::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x105f, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x105f, (undefined4*)param_1 == &Resource::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x105f, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x105f, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* NavigationRegion3DGizmoPlugin::_getv(StringName const&, Variant&) const */undefined8 NavigationRegion3DGizmoPlugin::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* NavigationRegion3DGizmoPlugin::_setv(StringName const&, Variant const&) */undefined8 NavigationRegion3DGizmoPlugin::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* NavigationRegion3DGizmoPlugin::_validate_propertyv(PropertyInfo&) const */void NavigationRegion3DGizmoPlugin::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* NavigationRegion3DGizmoPlugin::_property_can_revertv(StringName const&) const */undefined8 NavigationRegion3DGizmoPlugin::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* NavigationRegion3DGizmoPlugin::_property_get_revertv(StringName const&, Variant&) const */undefined8 NavigationRegion3DGizmoPlugin::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* NavigationRegion3DGizmoPlugin::_notificationv(int, bool) */void NavigationRegion3DGizmoPlugin::_notificationv(int param_1, bool param_2) {
   return;
}
/* NavigationRegion3DGizmoPlugin::~NavigationRegion3DGizmoPlugin() */void NavigationRegion3DGizmoPlugin::~NavigationRegion3DGizmoPlugin(NavigationRegion3DGizmoPlugin *this) {
   *(undefined***)this = &PTR__initialize_classv_00105d28;
   EditorNode3DGizmoPlugin::~EditorNode3DGizmoPlugin((EditorNode3DGizmoPlugin*)this);
   return;
}
...
/* NavigationRegion3DGizmoPlugin::_get_class_namev() const */undefined8 *NavigationRegion3DGizmoPlugin::_get_class_namev(void) {
   int iVar1;
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00102553:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00102553;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "NavigationRegion3DGizmoPlugin");
         goto LAB_001025be;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "NavigationRegion3DGizmoPlugin");
   LAB_001025be:return &_get_class_namev();
}
...
/* NavigationRegion3DGizmoPlugin::get_class() const */void NavigationRegion3DGizmoPlugin::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* NavigationRegion3DGizmoPlugin::_initialize_classv() */void NavigationRegion3DGizmoPlugin::_initialize_classv(void) {
   long *plVar1;
   long lVar2;
   long in_FS_OFFSET;
   long local_70;
...
/* RefCounted::is_class(String const&) const */undefined8 RefCounted::is_class(RefCounted *this, String *param_1) {
 ...
 while ( !bVar9 );
      ...
      LAB_00102f2f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
 ...
 while ( !bVar9 );
         ...
         LAB_00103093:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
      ...
      LAB_00102fe3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* Resource::is_class(String const&) const */undefined8 Resource::is_class(Resource *this, String *param_1) {
 ...
 while ( !bVar8 );
      ...
      LAB_001035af:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_00103663:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* NavigationRegion3DGizmoPlugin::is_class(String const&) const */undefined8 NavigationRegion3DGizmoPlugin::is_class(NavigationRegion3DGizmoPlugin *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long lVar4;
 ...
 while ( !bVar9 );
      ...
      LAB_0010372f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
 ...
 while ( !bVar9 );
         ...
         LAB_001038a3:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
   ...
   LAB_001037e3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0010394c:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* NavigationRegion3DGizmoPlugin::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool)
   const */void NavigationRegion3DGizmoPlugin::_get_property_listv(NavigationRegion3DGizmoPlugin *this, List *param_1, bool param_2) {
   long *plVar1;
   long lVar2;
   long lVar3;
   undefined1(*pauVar4)[16];
...
/* NavigationRegion3DGizmoPlugin::_EdgeKey::hash(NavigationRegion3DGizmoPlugin::_EdgeKey const&) */uint NavigationRegion3DGizmoPlugin::_EdgeKey::hash(_EdgeKey *param_1) {
   float fVar1;
   uint uVar2;
   uint uVar3;
   fVar1 = *(float*)param_1;
   uVar2 = 0x3413905a;
   if (( fVar1 != 0.0 ) && ( uVar2 = !NAN(fVar1) )) {
      uVar2 = ( (int)fVar1 * 0x16a88000 | ( uint )((int)fVar1 * -0x3361d2af) >> 0x11 ) * 0x1b873593 ^ 0x7f07c65;
...
/* List<Face3, DefaultAllocator>::~List() */undefined8 List<Face3,DefaultAllocator>::~List(List<Face3,DefaultAllocator> *this) {
   void *pvVar1;
   long lVar2;
   long lVar3;
   undefined8 uVar4;
...
/* HashMap<NavigationRegion3DGizmoPlugin::_EdgeKey, bool, NavigationRegion3DGizmoPlugin::_EdgeKey,
   ...
   >::~HashMap() */void HashMap<NavigationRegion3DGizmoPlugin::_EdgeKey,bool,NavigationRegion3DGizmoPlugin::_EdgeKey,HashMapComparatorDefault<NavigationRegion3DGizmoPlugin::_EdgeKey>,DefaultTypedAllocator<HashMapElement<NavigationRegion3DGizmoPlugin::_EdgeKey,bool>>>::~HashMap(HashMap<NavigationRegion3DGizmoPlugin::_EdgeKey,bool,NavigationRegion3DGizmoPlugin::_EdgeKey,HashMapComparatorDefault<NavigationRegion3DGizmoPlugin::_EdgeKey>,DefaultTypedAllocator<HashMapElement<NavigationRegion3DGizmoPlugin::_EdgeKey,bool>>> *this) {
   uint uVar1;
   long lVar2;
   void *pvVar3;
   pvVar3 = *(void**)( this + 8 );
...
/* Ref<EditorNode3DGizmo>::unref() */void Ref<EditorNode3DGizmo>::unref(Ref<EditorNode3DGizmo> *this) {
   Object *pOVar1;
   char cVar2;
   if (*(long*)this != 0) {
      cVar2 = RefCounted::unreference();
...
/* Ref<EditorNode3DGizmo>::TEMPNAMEPLACEHOLDERVALUE(EditorNode3DGizmo*) */void Ref<EditorNode3DGizmo>::operator =(Ref<EditorNode3DGizmo> *this, EditorNode3DGizmo *param_1) {
   Object *pOVar1;
   char cVar2;
   pOVar1 = *(Object**)this;
...
/* HashMap<NavigationRegion3DGizmoPlugin::_EdgeKey, bool, NavigationRegion3DGizmoPlugin::_EdgeKey,
   HashMapComparatorDefault<NavigationRegion3DGizmoPlugin::_EdgeKey>,
   DefaultTypedAllocator<HashMapElement<NavigationRegion3DGizmoPlugin::_EdgeKey, bool> >
   >::_lookup_pos(NavigationRegion3DGizmoPlugin::_EdgeKey const&, unsigned int&) const */undefined8 HashMap<NavigationRegion3DGizmoPlugin::_EdgeKey,bool,NavigationRegion3DGizmoPlugin::_EdgeKey,HashMapComparatorDefault<NavigationRegion3DGizmoPlugin::_EdgeKey>,DefaultTypedAllocator<HashMapElement<NavigationRegion3DGizmoPlugin::_EdgeKey,bool>>>::_lookup_pos(HashMap<NavigationRegion3DGizmoPlugin::_EdgeKey,bool,NavigationRegion3DGizmoPlugin::_EdgeKey,HashMapComparatorDefault<NavigationRegion3DGizmoPlugin::_EdgeKey>,DefaultTypedAllocator<HashMapElement<NavigationRegion3DGizmoPlugin::_EdgeKey,bool>>> *this, _EdgeKey *param_1, uint *param_2) {
   uint uVar1;
   long lVar2;
   long lVar3;
   ...
   if (lVar2 != 0) {
      ...
      do {
         if (uVar13 == uVar12) {
            ...
            if (( *(float*)( lVar15 + 0x10 ) == *(float*)param_1 ) || ( ( NAN(*(float*)param_1) && ( NAN(*(float*)( lVar15 + 0x10 )) ) ) )) {
               if (( *(float*)( lVar15 + 0x14 ) == *(float*)( param_1 + 4 ) ) || ( ( NAN(*(float*)( lVar15 + 0x14 )) && ( NAN(*(float*)( param_1 + 4 )) ) ) )) {
                  if (( *(float*)( lVar15 + 0x18 ) == *(float*)( param_1 + 8 ) ) || ( ( NAN(*(float*)( param_1 + 8 )) && ( NAN(*(float*)( lVar15 + 0x18 )) ) ) )) {
                     if (( *(float*)( lVar15 + 0x1c ) == *(float*)( param_1 + 0xc ) ) || ( ( NAN(*(float*)( lVar15 + 0x1c )) && ( NAN(*(float*)( param_1 + 0xc )) ) ) )) {
                        if (( *(float*)( lVar15 + 0x20 ) == *(float*)( param_1 + 0x10 ) ) || ( ( NAN(*(float*)( param_1 + 0x10 )) && ( NAN(*(float*)( lVar15 + 0x20 )) ) ) )) {
                           if (( *(float*)( lVar15 + 0x24 ) == *(float*)( param_1 + 0x14 ) ) || ( ( NAN(*(float*)( param_1 + 0x14 )) && ( NAN(*(float*)( lVar15 + 0x24 )) ) ) )) {
                              *param_2 = uVar14;
                              return 1;
                           }
 ...
 while ( ( uVar12 != 0 ) && ( auVar6._8_8_ = 0 ),auVar6._0_8_ = (ulong)uVar12 * lVar3,auVar10._8_8_ = 0,auVar10._0_8_ = uVar16,auVar7._8_8_ = 0,auVar7._0_8_ = ( ulong )(( uVar1 + uVar14 ) - SUB164(auVar6 * auVar10, 8)) * lVar3,auVar11._8_8_ = 0,auVar11._0_8_ = uVar16,uVar17 <= SUB164(auVar7 * auVar11, 8) );
   }

   return 0;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<NavigationRegion3DGizmoPlugin::_EdgeKey, bool, NavigationRegion3DGizmoPlugin::_EdgeKey,
   HashMapComparatorDefault<NavigationRegion3DGizmoPlugin::_EdgeKey>,
   DefaultTypedAllocator<HashMapElement<NavigationRegion3DGizmoPlugin::_EdgeKey, bool> >
   >::operator[](NavigationRegion3DGizmoPlugin::_EdgeKey const&) */undefined1 * __thiscallHashMap<NavigationRegion3DGizmoPlugin::_EdgeKey,bool,NavigationRegion3DGizmoPlugin::_EdgeKey,HashMapComparatorDefault<NavigationRegion3DGizmoPlugin::_EdgeKey>,DefaultTypedAllocator<HashMapElement<NavigationRegion3DGizmoPlugin::_EdgeKey,bool>>>::operator [](HashMap<NavigationRegion3DGizmoPlugin::_EdgeKey,bool,NavigationRegion3DGizmoPlugin::_EdgeKey,HashMapComparatorDefault<NavigationRegion3DGizmoPlugin::_EdgeKey>,DefaultTypedAllocator<HashMapElement<NavigationRegion3DGizmoPlugin::_EdgeKey,bool>>> * this, _EdgeKey * param_1) * puVar1 ;undefined8 *puVar2uint uVar3void *pvVar4void *__slong lVar5long lVar6undefined1 auVar7[16]undefined1 auVar8[16]undefined1 auVar9[16]undefined1 auVar10[16]undefined1 auVar11[16]undefined1 auVar12[16]undefined1 auVar13[16]undefined1 auVar14[16]undefined1 auVar15[16]undefined1 auVar16[16]undefined1 auVar17[16]undefined1 auVar18[16]undefined1 auVar19[16]undefined1 auVar20[16]undefined1 auVar21[16]undefined1 auVar22[16]undefined1(*pauVar23)[16];char cVar24uint uVar25uint uVar26ulong uVar27undefined8 uVar28void *__s_00undefined1(*pauVar29)[16];void *pvVar30int iVar31long lVar32long lVar33uint uVar34ulong uVar35undefined8 uVar36uint uVar37uint uVar38ulong uVar39undefined1(*pauVar40)[16];long in_FS_OFFSETuint local_80uint local_7c[5]undefined8 local_68undefined8 uStack_60undefined8 local_58long local_40local_40 = *(long*)( in_FS_OFFSET + 0x28 );local_80 = 0;cVar24 = _lookup_pos(this, param_1, &local_80);if (cVar24 == '\0') {
   ...
   if (*(long*)( this + 8 ) == 0) {
      ...
      *(void**)( this + 8 ) = pvVar30;
      if (uVar34 != 0) {
         ...
         if (( pvVar4 < (void*)( (long)pvVar30 + uVar39 ) ) && ( pvVar30 < (void*)( (long)pvVar4 + uVar27 ) )) {
            uVar27 = 0;
            do {
...
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* CowData<Vector3>::_unref() */void CowData<Vector3>::_unref(CowData<Vector3> *this) {
   long *plVar1;
   long lVar2;
   if (*(long*)this == 0) {
      return;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Vector3>::resize<false>(long) */undefined8 CowData<Vector3>::resize<false>(CowData<Vector3> *this, long param_1) {
   ...
   if (param_1 * 0xc == 0) {
      LAB_001058f0:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (lVar7 == lVar3) {
      LAB_0010585c:puVar9 = *(undefined8**)this;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Color>::resize<false>(long) */undefined8 CowData<Color>::resize<false>(CowData<Color> *this, long param_1) {
   ...
   if (param_1 * 0x10 == 0) {
      LAB_00105c70:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (lVar11 == lVar4) {
      LAB_00105bdc:puVar10 = *(undefined8**)this;
      ...
      lVar4 = puVar10[-1];
      if (param_1 <= lVar4) goto LAB_00105b70;
   }
 else {
      if (lVar12 != 0) {
   ...
   if (( ( param_1 - lVar4 ) * 0x10 & 0x10U ) != 0) {
      *puVar7 = __LC41;
      puVar7[1] = uVar3;
      puVar6 = puVar7 + 2;
      if (puVar7 + ( param_1 - lVar4 ) * 2 == puVar7 + 2) goto LAB_00105b70;
   }
 ...
 while ( puVar7 + ( param_1 - lVar4 ) * 2 != puVar8 );
   LAB_00105b70:puVar10[-1] = param_1;
   return 0;
}
/* WARNING: Control flow encountered bad instruction data *//* HashMap<NavigationRegion3DGizmoPlugin::_EdgeKey, bool, NavigationRegion3DGizmoPlugin::_EdgeKey,
   HashMapComparatorDefault<NavigationRegion3DGizmoPlugin::_EdgeKey>,
   DefaultTypedAllocator<HashMapElement<NavigationRegion3DGizmoPlugin::_EdgeKey, bool> >
   >::~HashMap() */void HashMap<NavigationRegion3DGizmoPlugin::_EdgeKey,bool,NavigationRegion3DGizmoPlugin::_EdgeKey,HashMapComparatorDefault<NavigationRegion3DGizmoPlugin::_EdgeKey>,DefaultTypedAllocator<HashMapElement<NavigationRegion3DGizmoPlugin::_EdgeKey,bool>>>::~HashMap(HashMap<NavigationRegion3DGizmoPlugin::_EdgeKey,bool,NavigationRegion3DGizmoPlugin::_EdgeKey,HashMapComparatorDefault<NavigationRegion3DGizmoPlugin::_EdgeKey>,DefaultTypedAllocator<HashMapElement<NavigationRegion3DGizmoPlugin::_EdgeKey,bool>>> *this) {
...
/* WARNING: Control flow encountered bad instruction data *//* List<Face3, DefaultAllocator>::~List() */void List<Face3,DefaultAllocator>::~List(List<Face3,DefaultAllocator> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* NavigationRegion3DGizmoPlugin::~NavigationRegion3DGizmoPlugin() */void NavigationRegion3DGizmoPlugin::~NavigationRegion3DGizmoPlugin(NavigationRegion3DGizmoPlugin *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

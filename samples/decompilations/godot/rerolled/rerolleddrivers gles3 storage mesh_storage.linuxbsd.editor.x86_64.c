...
/* GLES3::MeshStorage::mesh_instance_check_for_update(RID) */undefined1  [16] __thiscallGLES3::MeshStorage::mesh_instance_check_for_update(MeshStorage *this, ulong param_2) {
   long lVar1;
   long lVar2;
   ulong uVar3;
   long lVar4;
...
/* GLES3::MeshStorage::_multimesh_instance_get_custom_data(RID, int) const */undefined1  [16] __thiscallGLES3::MeshStorage::_multimesh_instance_get_custom_data(MeshStorage *this, ulong param_2, int param_3) {
   long *plVar1;
   ushort uVar2;
   undefined1 auVar3[16];
   int iVar4;
...
/* GLES3::MeshStorage::_multimesh_instance_get_color(RID, int) const */undefined1  [16] __thiscallGLES3::MeshStorage::_multimesh_instance_get_color(MeshStorage *this, ulong param_2, int param_3) {
   long *plVar1;
   ushort uVar2;
   undefined1 auVar3[16];
   int iVar4;

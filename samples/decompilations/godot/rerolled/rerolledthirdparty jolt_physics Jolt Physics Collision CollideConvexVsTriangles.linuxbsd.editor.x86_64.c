...
/* JPH::CollideConvexVsTriangles::CollideConvexVsTriangles(JPH::ConvexShape const*, JPH::Vec3,
   ...
   JPH::CollisionCollectorTraitsCollideShape>&) */void JPH::CollideConvexVsTriangles::CollideConvexVsTriangles(undefined8 param_1_00, undefined8 param_2, undefined8 param_3, undefined8 param_4, CollideConvexVsTriangles *this, long *param_1, undefined8 *param_7, float *param_8, undefined4 *param_9, long param_10, undefined8 param_11) {
   float *pfVar1;
   float fVar2;
   float fVar3;
   undefined8 uVar4;
   ...
   *(undefined4*)( this + 0xc0 ) = _LC10;
   for (int i = 0; i < 3; i++) {
      *(undefined4*)( this + ( 4*i + 196 ) ) = uVar22;
   }
   ...
   *(undefined1(*) [16])( this + 0x2190 ) = (undefined1[16])0x0;
   ...
   for (int i = 0; i < 4; i++) {
      *(undefined4*)( this + ( 4*i + 224 ) ) = uVar22;
   }
   ...
   *(undefined4*)( this + 0x100 ) = uVar23;
   ...
   do {
      ...
      fVar14 = pfVar1[2];
      fVar15 = pfVar1[3];
      *(float*)( (long)local_68 + lVar24 ) = fVar15 * ( 0.0 - ( fVar3 * fVar34 + fVar10 * fVar35 + fVar11 * fVar36 ) ) + fVar12 * fVar34 + fVar13 * fVar35 + fVar14 * fVar36;
      *(float*)( (long)local_68 + lVar24 + 4 ) = fVar15 * ( 0.0 - ( fVar3 * fVar37 + fVar10 * fVar38 + fVar11 * fVar31 ) ) + fVar12 * fVar37 + fVar13 * fVar38 + fVar14 * fVar31;
      *(float*)( (long)local_68 + lVar24 + 8 ) = fVar15 * ( 0.0 - ( fVar3 * fVar25 + fVar10 * fVar30 + fVar11 * fVar2 ) ) + fVar12 * fVar25 + fVar13 * fVar30 + fVar14 * fVar2;
      *(float*)( (long)local_68 + lVar24 + 0xc ) = fVar15 * 1.0 + fVar12 * 0.0 + fVar13 * 0.0 + fVar14 * 0.0;
      lVar24 = lVar24 + 0x10;
   }
 while ( lVar24 != 0x40 );
   lVar24 = *param_1;
   ...
   *(ulong*)( this + 0xb0 ) = CONCAT44(0.0 - ( local_68[0xc] * (float)local_68._16_8_ + local_68[0xd] * SUB84(local_68._16_8_, 4) + local_68[0xe] * local_68[6] ), 0.0 - ( local_68[0xc] * local_68[0] + local_68[0xd] * local_68[1] + local_68[0xe] * local_68[2] ));
   *(float*)( this + 0xb8 ) = 0.0 - ( local_68[0xc] * (float)local_68._32_8_ + local_68[0xd] * SUB84(local_68._32_8_, 4) + local_68[0xe] * local_68[10] );
 ...
 while ( lVar24 != 0xc );
   ...
   for (int i = 0; i < 4; i++) {
      *(float*)( this + ( 4*i + 224 ) ) = local_68[( i + 12 )];
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JPH::CollideConvexVsTriangles::Collide(JPH::Vec3, JPH::Vec3, JPH::Vec3, unsigned char,
   JPH::SubShapeID const&) */void JPH::CollideConvexVsTriangles::Collide(undefined8 param_1, float param_2, undefined8 param_3, float param_4, undefined8 param_5, float param_6, long *param_7, byte param_8, undefined4 *param_9) {
   char *pcVar1;
   code *pcVar2;
   float fVar3;
   float fVar4;
   ...
   fStack_57c = fVar39;
   if (plVar8 == (long*)0x0) {
      plVar8 = (long*)( **(code**)( *(long*)param_7[2] + 0x130 ) )(param_7[4], param_7[5], (long*)param_7[2], 0, param_7 + 0x22);
   ...
   fVar13 = GJKClosestPoint::GetClosestPoints<JPH::ConvexShape::Support,JPH::TriangleConvexSupport>(local_578, (Support*)param_7[0x432], (TriangleConvexSupport*)&local_5a8, fVar13, fVar23, (Vec3*)&local_5d8, (Vec3*)&local_5c8, (Vec3*)&local_5b8);
   ...
   if (0.0 < fVar13) {
      ...
      if (local_5e8 == 0) {
         local_5e8 = ( **(code**)( *(long*)param_7[2] + 0x130 ) )(param_7[4], param_7[5], (long*)param_7[2], 1, param_7 + 0x22a);
         param_7[0x433] = local_5e8;
      }

      local_5e0 = *(undefined4*)( *param_7 + 0x20 );
      bVar5 = EPAPenetrationDepth::GetPenetrationDepthStepEPA<JPH::AddConvexRadius<JPH::ConvexShape::Support>,JPH::TriangleConvexSupport>((EPAPenetrationDepth*)local_578, (AddConvexRadius*)&local_5e8, (TriangleConvexSupport*)&local_5a8, *(float*)( *param_7 + 8 ), (Vec3*)&local_5d8, (Vec3*)&local_5c8, (Vec3*)&local_5b8);
      if (!bVar5) goto LAB_001012db;
   }

   pcVar1 = (char*)*param_7;
   plVar8 = (long*)param_7[1];
   fVar13 = SQRT(( fStack_5b0 - fStack_5c0 ) * ( fStack_5b0 - fStack_5c0 ) + ( local_5b8 - local_5c8 ) * ( local_5b8 - local_5c8 ) + 0.0 + ( fStack_5b4 - fStack_5c4 ) * ( fStack_5b4 - fStack_5c4 )) - *(float*)( pcVar1 + 0x20 );
   ...
   if (( *pcVar1 == '\0' ) && ( param_8 != 7 )) {
      ...
      if (( fVar31 * local_6a8 + fVar30 * fVar20 + fVar29 * fVar18 + 0.0 ) * fVar12 <= ( fStack_5d0 * fVar31 + fStack_5d4 * fVar30 + fVar29 * local_5d8 + 0.0 ) * fVar10) {
         if (param_8 == 0) {
            LAB_001010bd:local_5d8 = fVar18;
            fStack_5d4 = fVar20;
            fStack_5d0 = local_6a8;
            fStack_5cc = fVar25;
         }
 else if (local_6a8 * fStack_5d0 + fVar20 * fStack_5d4 + local_5d8 * fVar18 + 0.0 <= fVar12 * __LC76 * fVar10) {
            ...
            ClosestPoint::GetBaryCentricCoordinates(CONCAT44(fVar33 - fStack_5b4, fVar32 - local_5b8), CONCAT44(fVar35 - fStack_5ac, fVar34 - fStack_5b0), local_6b8, uStack_6b0, local_6d8, uStack_6d0, &local_5f0, &local_5ec, &local_5e8);
            if (__LC77 < local_5f0) {
               bVar6 = 5;
            }
   ...
   if (pcVar1[1] == '\0') {
      ...
      if (pcVar2 != Shape::GetSupportingFace) {
         ( *pcVar2 )(local_6d8, uStack_6d0, param_7[4], param_7[5], (long*)param_7[2], &local_5e8, param_7 + 8, local_468);
         fVar51 = *(float*)( param_7 + 8 );
         fVar52 = *(float*)( (long)param_7 + 0x44 );
         fVar53 = *(float*)( param_7 + 9 );
         fVar54 = *(float*)( (long)param_7 + 0x4c );
   ...
   LAB_001012db:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* JPH::Vec3
   ...
   JPH::TriangleConvexSupport const&, JPH::Vec3, int&) [clone .isra.0] */undefined1[16];JPH::EPAPenetrationDepth::SupportPoints::Add<JPH::AddConvexRadius<JPH::ConvexShape::Support>,JPH::TriangleConvexSupport>(float param_1_00, undefined8 param_2_00, undefined8 param_3, uint *param_1, long *param_2, float *param_6, uint *param_7) {
   float *pfVar1;
   uint uVar2;
   float fVar3;
   float fVar4;
...
/* JPH::EPAConvexHullBuilder::FindEdge(JPH::EPAConvexHullBuilder::Triangle*, JPH::Vec3,
 ...
 while ( plVar10 + 6 != plVar7 );
         ...
         if (iVar8 < 0) {
            ...
            LAB_00101bf8:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
...
;
      while (true) {
         ...
         lVar4 = *plVar10;
         if (( lVar4 == 0 ) || ( unaff_RBP = ( ulong ) * (byte*)( lVar4 + 0x5e ) * (byte*)( lVar4 + 0x5e ) != 0 )) goto LAB_00101a70;
         ...
         *(float*)( this + 0x50 ) = ( (float)( (uint)fVar21 & _LC14 ) * fVar21 ) / fVar24;
         ...
         if (0.0 < fVar23) {
            ...
            *(long*)( this + 0x54 ) = auVar15._0_8_;
            if (( ( fVar24 < auVar15._0_4_ ) && ( __LC16 < auVar15._4_4_ ) ) && ( auVar15._0_4_ + auVar15._4_4_ < _LC17 )) goto LAB_0010213c;
         }
         ...
         if (0.0 < fVar13) {
            ...
            *(long*)( this + 0x54 ) = auVar15._0_8_;
            if (( ( fVar20 < auVar15._0_4_ ) && ( __LC16 < auVar15._4_4_ ) ) && ( auVar15._4_4_ + auVar15._0_4_ < _LC17 )) {
               LAB_0010213c:this[0x5d] = (Triangle)0x1;
               return;
            }
...
;
 ...
 while ( uVar20 != uVar22 );
      LAB_00102313:uVar14 = uVar14 & 0xff;
      uVar22 = 1;
      piVar21 = local_838;
      do {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* bool 
   ...
   JPH::TriangleConvexSupport>(JPH::AddConvexRadius<JPH::ConvexShape::Support> const&,
   JPH::TriangleConvexSupport const&, float, JPH::Vec3&, JPH::Vec3&, JPH::Vec3&) */bool JPH::EPAPenetrationDepth::GetPenetrationDepthStepEPA<JPH::AddConvexRadius<JPH::ConvexShape::Support>,JPH::TriangleConvexSupport>(EPAPenetrationDepth *this, AddConvexRadius *param_1, TriangleConvexSupport *param_2, float param_3, Vec3 *param_4, Vec3 *param_5, Vec3 *param_6) {
   ulong uVar1;
   undefined1 *puVar2;
   long *plVar3;
   float *pfVar4;
 ...
 while ( puVar22 + -0x1000 != local_8030 );
   ...
   *(uint*)( puVar22 + -0x1058 ) = uVar30;
   if (uVar30 == 1) {
      ...
      *(undefined8*)( puVar22 + -0x1520 ) = 0x102e9f;
      SupportPoints::Add<JPH::AddConvexRadius<JPH::ConvexShape::Support>,JPH::TriangleConvexSupport>(uVar7, uVar8, param_2, puVar22 + -0x1478);
      uVar47 = *(undefined8*)param_1;
      *(undefined8*)( puVar22 + -0x1520 ) = 0x102ec5;
      SupportPoints::Add<JPH::AddConvexRadius<JPH::ConvexShape::Support>,JPH::TriangleConvexSupport>(uVar7, uVar47, param_2, puVar22 + -0x1474);
      uVar47 = *(undefined8*)param_1;
      *(undefined8*)( puVar22 + -0x1520 ) = 0x102ef5;
      SupportPoints::Add<JPH::AddConvexRadius<JPH::ConvexShape::Support>,JPH::TriangleConvexSupport>(uVar7, uVar47, param_2, puVar22 + -0x1470);
      uVar47 = *(undefined8*)param_1;
      *(undefined8*)( puVar22 + -0x1520 ) = 0x102f2f;
      SupportPoints::Add<JPH::AddConvexRadius<JPH::ConvexShape::Support>,JPH::TriangleConvexSupport>(uVar7, uVar47, param_2, puVar22 + -0x146c);
      ...
      auVar38._0_4_ = SQRT(auVar56._8_4_ * auVar56._8_4_ + auVar56._4_4_ * auVar56._4_4_ + auVar56._0_4_ * auVar56._0_4_ + 0.0);
      ...
      *(ulong*)( puVar22 + -0x1510 ) = *(ulong*)( puVar22 + -0x1510 ) & 0xffffffff00000000 | (ulong)(uint)fVar31;
      fVar46 = (float)( __LC50 & ( ( __LC74 & uVar30 | ~uVar30 & ( uint )((float)__LC54 + __LC66) ) ^ __LC49 & __LC54 << 0x1e ^ __LC54 << 0x1f ) | ~__LC50 & ( uint )((float)( ( ( uint )((float)__LC54 + __LC66) & uVar30 | ~uVar30 & __LC74 ) ^ ( __LC48 ^ __LC54 << 0x1e ) & __LC49 ) * *(float*)( puVar22 + -0x1518 )) );
      fVar37 = (float)( _UNK_00104bc4 & ( ( _UNK_00104c04 & uVar41 | ~uVar41 & ( uint )((float)_UNK_00104be4 + _UNK_00104bf4) ) ^ _UNK_00104bb4 & _UNK_00104be4 << 0x1e ^ _UNK_00104be4 << 0x1f ) | ~_UNK_00104bc4 & ( uint )((float)( ( ( uint )((float)_UNK_00104be4 + _UNK_00104bf4) & uVar41 | ~uVar41 & _UNK_00104c04 ) ^ ( _UNK_00104ba4 ^ _UNK_00104be4 << 0x1e ) & _UNK_00104bb4 ) * *(float*)( puVar22 + -0x1514 )) );
      fVar42 = (float)( (uint)_LC9 & ( ( _UNK_00104c08 & uVar43 | ~uVar43 & ( uint )((float)_UNK_00104be8 + _UNK_00104bf8) ) ^ _UNK_00104bb8 & _UNK_00104be8 << 0x1e ^ _UNK_00104be8 << 0x1f ) | ~(uint)_LC9 & ( uint )((float)( ( ( uint )((float)_UNK_00104be8 + _UNK_00104bf8) & uVar43 | ~uVar43 & _UNK_00104c08 ) ^ ( _UNK_00104ba8 ^ _UNK_00104be8 << 0x1e ) & _UNK_00104bb8 ) * *(float*)( puVar22 + -0x1510 )) );
      fVar44 = (float)( _LC9._4_4_ & ( ( _UNK_00104c0c & uVar45 | ~uVar45 & ( uint )((float)_UNK_00104bec + _UNK_00104bfc) ) ^ _UNK_00104bbc & _UNK_00104bec << 0x1e ^ _UNK_00104bec << 0x1f ) | ~_LC9._4_4_ & ( uint )((float)( ( ( uint )((float)_UNK_00104bec + _UNK_00104bfc) & uVar45 | ~uVar45 & _UNK_00104c0c ) ^ ( _UNK_00104bac ^ _UNK_00104bec << 0x1e ) & _UNK_00104bbc ) * *(float*)( puVar22 + -0x150c )) );
      ...
      *(float*)( puVar22 + -0x1510 ) = fVar36 * fVar32 + fVar35 * fVar53 + fVar31 * fVar52 + _UNK_00104bd8;
      ...
      *(float*)( puVar22 + -0x1494 ) = fVar42 * fVar36 + fVar37 * fVar46 + fVar35 * fVar44 + _UNK_00104bd4;
      *(float*)( puVar22 + -0x1490 ) = fVar53 * fVar36 + fVar37 * fVar32 + fVar35 * fVar52 + _UNK_00104bd8;
   ...
   *(undefined8*)( puVar22 + -0x1520 ) = 0x1025bb;
   ...
   for (int i = 0; i < 3; i++) {
      *(Triangle**)( puVar22 + ( 16*i + 1992 ) ) = pTVar25;
      *(undefined4*)( puVar22 + ( 16*i + 2000 ) ) = ( 2 - i );
      *(undefined8*)( puVar22 + ( -16*i + 2120 ) ) = uVar47;
      *(undefined4*)( puVar22 + ( -16*i + 2128 ) ) = i;
   }
   ...
   *(undefined8*)( puVar22 + 0x67f0 ) = *(undefined8*)( puVar22 + -0x14d0 );
   if (*(float*)( puVar22 + 0x818 ) < *(float*)( puVar22 + 0x878 ) || *(float*)( puVar22 + 0x818 ) == *(float*)( puVar22 + 0x878 )) {
         ...
         if (uVar27 != 0) {
            ...
            LAB_001026fd:do {
               ...
               if (pTVar6[0x5e] == (Triangle)0x0) {
                  ...
                  fVar31 = ( pfVar28[2] - *(float*)( pTVar6 + 0x48 ) ) * fVar35 + ( pfVar28[1] - *(float*)( pTVar6 + 0x44 ) ) * fVar33 + ( *pfVar28 - *(float*)( pTVar6 + 0x40 ) ) * fVar32 + 0.0;
                  if (0.0 < fVar31) {
                     fVar32 = ( fVar31 * fVar31 ) / ( fVar35 * fVar35 + fVar33 * fVar33 + fVar32 * fVar32 + 0.0 );
                     if (fVar36 < fVar32) {
                        pTVar23 = pTVar6;
                        fVar36 = fVar32;
                     }
 ...
 while ( plVar3 + uVar27 != plVar16 );
            if (pTVar23 != (Triangle*)0x0) {
               ...
               *(undefined8*)( puVar22 + -0x1520 ) = 0x1027b3;
               cVar14 = EPAConvexHullBuilder::AddPoint((EPAConvexHullBuilder*)( puVar22 + 0x7b8 ), pTVar23, uVar30, _LC10, (StaticArray*)( puVar22 + -0x1468 ));
         ...
         *(long*)( puVar22 + 0x67e8 ) = lVar21;
         if (0x10 < uVar1) {
            ...
            do {
               ...
               lVar19 = lVar19 + 2;
               if (fVar36 <= fVar32) {
                  if (( lVar18 <= lVar19 ) || ( lVar17 = lVar19 ),fVar36 < *(float*)( *(long*)( puVar22 + lVar19 * 8 + 0x67e8 ) + 0x50 ) || fVar36 == *(float*)( *(long*)( puVar22 + lVar19 * 8 + 0x67e8 ) + 0x50 )) break;
               }
 else {
                  lVar17 = lVar20;
                  if (( lVar19 < lVar18 ) && ( lVar17 = lVar19 ),fVar32 < *(float*)( *(long*)( puVar22 + lVar19 * 8 + 0x67e8 ) + 0x50 ) || fVar32 == *(float*)( *(long*)( puVar22 + lVar19 * 8 + 0x67e8 ) + 0x50 )) {
                     lVar17 = lVar20;
                  }
 ...
 while ( lVar20 < lVar18 );
         ...
         *(undefined8*)( puVar22 + -0x1520 ) = 0x1028fa;
         auVar56 = SupportPoints::Add<JPH::AddConvexRadius<JPH::ConvexShape::Support>,JPH::TriangleConvexSupport>(uVar47, uVar48, param_2, puVar22 + -0x146c);
         fVar36 = *(float*)( pTVar25 + 0x30 );
         *(undefined4*)( puVar22 + -0x1468 ) = 0;
         *(long*)( puVar22 + -0x1518 ) = auVar56._0_8_;
         *(undefined8*)( puVar22 + -0x1510 ) = extraout_XMM0_Qb;
         *(long*)( puVar22 + -0x1510 ) = auVar56._8_8_;
         if (( *(float*)( puVar22 + -0x1510 ) - *(float*)( pTVar25 + 0x48 ) ) * *(float*)( pTVar25 + 0x38 ) + ( *(float*)( puVar22 + -0x1514 ) - *(float*)( pTVar25 + 0x44 ) ) * *(float*)( pTVar25 + 0x34 ) + fVar36 * ( *(float*)( puVar22 + -0x1518 ) - *(float*)( pTVar25 + 0x40 ) ) + 0.0 <= 0.0) goto LAB_00102aa0;
         *(undefined8*)( puVar22 + -0x1520 ) = 0x102978;
         cVar14 = EPAConvexHullBuilder::AddPoint((EPAConvexHullBuilder*)( puVar22 + 0x7b8 ), pTVar25, *(int*)( puVar22 + -0x146c ), _LC10, (StaticArray*)( puVar22 + -0x1468 ));
         if (cVar14 == '\0') goto LAB_00102aa0;
   ...
   *(long*)( puVar22 + 0x67e8 ) = lVar18;
   if (1 < lVar20) {
      ...
      do {
         ...
         lVar19 = lVar19 + 2;
         if (fVar32 <= fVar33) {
            if (( lVar20 <= lVar19 ) || ( lVar17 = lVar19 ),fVar32 < *(float*)( *(long*)( puVar22 + lVar19 * 8 + 0x67e8 ) + 0x50 ) || fVar32 == *(float*)( *(long*)( puVar22 + lVar19 * 8 + 0x67e8 ) + 0x50 )) break;
         }
 else {
            lVar17 = lVar21;
            if (( lVar19 < lVar20 ) && ( lVar17 = lVar19 ),fVar33 < *(float*)( *(long*)( puVar22 + lVar19 * 8 + 0x67e8 ) + 0x50 ) || fVar33 == *(float*)( *(long*)( puVar22 + lVar19 * 8 + 0x67e8 ) + 0x50 )) {
               lVar17 = lVar21;
            }
   ...
   *(uint*)( puVar22 + 0x67e0 ) = uVar30;
   if (pTVar25[0x5e] == (Triangle)0x0) {
      ...
      *(undefined8*)( puVar22 + -0x1520 ) = 0x1032b5;
      auVar56 = SupportPoints::Add<JPH::AddConvexRadius<JPH::ConvexShape::Support>,JPH::TriangleConvexSupport>(*(undefined8*)( puVar22 + -0x1508 ), uVar47, param_2, puVar22 + -0x146c);
      fVar36 = *(float*)( pTVar25 + 0x30 );
      ...
      *(long*)( puVar22 + -0x1510 ) = auVar56._8_8_;
      fVar35 = auVar56._8_4_ * fVar33 + (float)( ( ulong ) * (undefined8*)( puVar22 + -0x1518 ) >> 0x20 ) * fVar32 + (float)*(undefined8*)( puVar22 + -0x1518 ) * fVar36 + 0.0;
      if (fVar35 < 0.0) goto LAB_00102aa0;
      fVar31 = ( fVar35 * fVar35 ) / ( fVar33 * fVar33 + fVar32 * fVar32 + fVar36 * fVar36 + 0.0 );
      pTVar23 = pTVar25;
      if (fVar31 - *(float*)( pTVar25 + 0x50 ) < *(float*)( pTVar25 + 0x50 ) * *(float*)( puVar22 + -0x14b4 )) goto LAB_0010309f;
      if (*(float*)( puVar22 + -0x14f8 ) <= fVar31) {
         fVar31 = *(float*)( puVar22 + -0x14f8 );
      }

      if (( *(float*)( puVar22 + -0x1510 ) - *(float*)( pTVar25 + 0x48 ) ) * fVar33 + ( *(float*)( puVar22 + -0x1514 ) - *(float*)( pTVar25 + 0x44 ) ) * fVar32 + ( *(float*)( puVar22 + -0x1518 ) - *(float*)( pTVar25 + 0x40 ) ) * fVar36 + 0.0 <= 0.0) goto LAB_0010309f;
      *(float*)( puVar22 + -0x14f8 ) = fVar35;
      *(float*)( puVar22 + -0x1518 ) = fVar31;
      *(undefined4*)( puVar22 + -0x1468 ) = 0;
      *(undefined8*)( puVar22 + -0x1520 ) = 0x1033dc;
      cVar14 = EPAConvexHullBuilder::AddPoint((EPAConvexHullBuilder*)( puVar22 + 0x7b8 ), pTVar25, *(int*)( puVar22 + -0x146c ), fVar31, (StaticArray*)( puVar22 + -0x1468 ));
      ...
      if (( ulong ) * (uint*)( puVar22 + -0x1468 ) != 0) {
         do {
            lVar21 = *plVar16;
            if ((float)( ( ulong ) * (undefined8*)( lVar21 + 0x40 ) >> 0x20 ) * *(float*)( lVar21 + 0x34 ) + (float)*(undefined8*)( lVar21 + 0x40 ) * *(float*)( lVar21 + 0x30 ) + 0.0 + *(float*)( lVar21 + 0x38 ) * *(float*)( lVar21 + 0x48 ) < 0.0) {
               fVar32 = (float)*(undefined8*)( pTVar25 + 0x30 );
               fVar33 = (float)( ( ulong ) * (undefined8*)( pTVar25 + 0x30 ) >> 0x20 );
               fVar36 = *(float*)( pTVar25 + 0x38 );
               fVar31 = *(float*)( param_2 + 8 ) * fVar36 + *(float*)( param_2 + 4 ) * fVar33 + *(float*)param_2 * fVar32 + 0.0;
               fVar35 = *(float*)( param_2 + 0x18 ) * fVar36 + *(float*)( param_2 + 0x14 ) * fVar33 + *(float*)( param_2 + 0x10 ) * fVar32 + 0.0;
               fVar36 = fVar33 * *(float*)( param_2 + 0x24 ) + fVar32 * *(float*)( param_2 + 0x20 ) + 0.0 + fVar36 * *(float*)( param_2 + 0x28 );
               if (fVar31 <= fVar35) {
                  ...
                  LAB_00103664:uVar47 = *(undefined8*)( param_2 + 0x20 );
               ...
               *(float*)( puVar22 + -0x150c ) = 0.0 - fVar33;
               ...
               fVar36 = SQRT(*(float*)( puVar22 + -0x1514 ) * *(float*)( puVar22 + -0x1514 ) + *(float*)( puVar22 + -0x1518 ) * *(float*)( puVar22 + -0x1518 ) + 0.0 + *(float*)( puVar22 + -0x1510 ) * *(float*)( puVar22 + -0x1510 ));
               if (fVar36 <= 0.0) {
                  *(undefined4*)( puVar22 + -0x14f8 ) = *(undefined4*)( puVar22 + -0x14f8 );
                  *(undefined8*)( puVar22 + -0x1520 ) = 0x10364b;
                  auVar56 = ( *pcVar9 )(*(undefined8*)( puVar22 + -0x1518 ), *(undefined8*)( puVar22 + -0x1510 ));
                  ...
                  *(undefined4*)( puVar22 + -0x14e8 ) = *(undefined4*)( puVar22 + -0x14f8 );
                  for (int i = 0; i < 4; i++) {
                     *(float*)( puVar22 + ( 4*i + -5368 ) ) = *(float*)( puVar22 + ( 4*i + -5400 ) ) * fVar36;
                  }
               ...
               bVar15 = (float)( ( uint )(( auVar34._8_4_ - *(float*)( puVar22 + -0x1500 ) ) * *(float*)( pTVar25 + 0x38 ) + ( auVar34._4_4_ - *(float*)( puVar22 + -0x1504 ) ) * *(float*)( pTVar25 + 0x34 ) + *(float*)( pTVar25 + 0x30 ) * ( auVar34._0_4_ - *(float*)( puVar22 + -0x1508 ) ) + 0.0) ^ __LC4 ) < fVar36;
               goto LAB_001030a8;
            }
 ...
 while ( plVar3 != plVar16 );
   ...
   uVar27 = (ulong)uVar30;
   goto LAB_00102fa7;
   LAB_0010309f:pTVar25 = pTVar23;
   bVar15 = false;
   if (pTVar25 != (Triangle*)0x0) {
      LAB_001030a8:pfVar28 = *(float**)( puVar22 + -0x14b0 );
      fVar32 = ( *(float*)( pTVar25 + 0x48 ) * *(float*)( pTVar25 + 0x38 ) + (float)( ( ulong ) * (undefined8*)( pTVar25 + 0x30 ) >> 0x20 ) * *(float*)( pTVar25 + 0x44 ) + (float)*(undefined8*)( pTVar25 + 0x30 ) * *(float*)( pTVar25 + 0x40 ) + 0.0 ) / ( *(float*)( pTVar25 + 0x38 ) * *(float*)( pTVar25 + 0x38 ) + *(float*)( pTVar25 + 0x30 ) * *(float*)( pTVar25 + 0x30 ) + 0.0 + *(float*)( pTVar25 + 0x34 ) * *(float*)( pTVar25 + 0x34 ) );
   ...
   LAB_00102aa0:bVar15 = false;
   LAB_00102aa2:if (*(long*)( puVar22 + 0x6ff0 ) == *(long*)( in_FS_OFFSET + 0x28 )) {
      return bVar15;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JPH::Vec3 JPH::ClosestPoint::GetClosestPointOnTriangle<true>(JPH::Vec3, JPH::Vec3, JPH::Vec3,
   ...
   if (fVar31 < _LC13) {
      ...
      fVar9 = fVar31;
      if (_LC2 < fVar15) {
         fVar15 = (float)( ( uint )(fVar24 * fVar13 + fVar12 * fVar22 + fVar20 * fVar4 + 0.0) ^ __LC4 ) / fVar15;
         if (fVar15 < 0.0) {
            fVar16 = 0.0;
         }
 else {
      ...
      if (_LC2 < fVar30) {
         fVar30 = (float)( ( uint )(fVar28 * fStack_60 + fVar27 * fStack_64 + fVar26 * local_68 + 0.0) ^ __LC4 ) / fVar30;
         if (fVar30 < 0.0) {
            fVar4 = 0.0;
         }
 else {
   ...
   if (fVar26 < 0.0) {
      ...
      if (( ( fVar29 * fVar18 <= fVar30 * fVar26 ) && ( 0.0 <= fVar29 ) ) && ( fVar26 == 0.0 )) {
         LAB_00103c8e:*param_7 = ( -(uint)(iVar1 == 0) & 0xfffffffd ) + 6;
...
/* JPH::Vec3 JPH::ClosestPoint::GetClosestPointOnTetrahedron<true>(JPH::Vec3, JPH::Vec3, JPH::Vec3,
   ...
   fVar2 = fVar3;
   joined_r0x00103f5d:if (local_90 != 0) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* float JPH::GJKClosestPoint::GetClosestPoints<JPH::ConvexShape::Support,
   JPH::TriangleConvexSupport>(JPH::ConvexShape::Support const&, JPH::TriangleConvexSupport const&,
   float, float, JPH::Vec3&, JPH::Vec3&, JPH::Vec3&) */float JPH::GJKClosestPoint::GetClosestPoints<JPH::ConvexShape::Support,JPH::TriangleConvexSupport>(GJKClosestPoint *this, Support *param_1, TriangleConvexSupport *param_2, float param_3, float param_4, Vec3 *param_5, Vec3 *param_6, Vec3 *param_7) {
   int iVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   *(undefined4*)( this + 0xc0 ) = 0;
   local_84 = *(float*)( param_5 + 8 ) * *(float*)( param_5 + 8 ) + *(float*)( param_5 + 4 ) * *(float*)( param_5 + 4 ) + fVar12 * fVar12 + 0.0;
   do {
      auVar19 = ( **(code**)( *(long*)param_1 + 0x10 ) )(*(undefined8*)param_5, *(undefined8*)( param_5 + 8 ), param_1);
      fVar12 = 0.0 - *(float*)param_5;
      fVar14 = 0.0 - *(float*)( param_5 + 4 );
      fVar15 = 0.0 - *(float*)( param_5 + 8 );
      fVar17 = *(float*)( param_2 + 8 ) * fVar15 + *(float*)( param_2 + 4 ) * fVar14 + *(float*)param_2 * fVar12 + 0.0;
      fVar16 = *(float*)( param_2 + 0x18 ) * fVar15 + *(float*)( param_2 + 0x14 ) * fVar14 + *(float*)( param_2 + 0x10 ) * fVar12 + 0.0;
      fVar12 = fVar15 * *(float*)( param_2 + 0x28 ) + fVar14 * *(float*)( param_2 + 0x24 ) + fVar12 * *(float*)( param_2 + 0x20 ) + 0.0;
      if (fVar17 <= fVar16) {
         ...
         LAB_001046f0:fVar12 = *(float*)( param_2 + 0x20 );
      ...
      fVar17 = ( fStack_a0 - fVar15 ) * *(float*)( param_5 + 8 ) + ( (float)local_a8._4_4_ - fVar14 ) * *(float*)( param_5 + 4 ) + *(float*)param_5 * ( (float)local_a8._0_4_ - fVar12 ) + 0.0;
      if (( fVar17 < 0.0 ) && ( fVar18 = param_4 * local_84 < fVar17 * fVar17 )) goto LAB_00104541;
      iVar1 = *(int*)( this + 0xc0 );
      iVar8 = iVar1 + 1;
      ...
      *(int*)( this + 0xc0 ) = iVar8;
      if (iVar8 == 3) {
         auVar19 = ClosestPoint::GetClosestPointOnTriangle<true>(*(undefined8*)this, *(undefined8*)( this + 8 ), *(undefined8*)( this + 0x10 ), *(undefined8*)( this + 0x18 ), *(undefined8*)( this + 0x20 ), *(undefined8*)( this + 0x28 ), &local_44);
         fStack_a0 = auVar19._8_4_;
      }
 else if (iVar8 < 4) {
         if (iVar8 == 1) {
            ...
            if (fVar14 < _LC2) {
               if (fStack_90 * fStack_90 + fStack_94 * fStack_94 + local_98 * local_98 + 0.0 < fStack_70 * fStack_70 + fStack_74 * fStack_74 + local_78 * local_78 + 0.0) goto LAB_0010485a;
               LAB_00104864:local_44 = 2.8026e-45;
               _local_a8 = *(undefined1(*) [16])( this + 0x10 );
            }
 else {
               fVar14 = (float)( ( uint )(fVar16 * fStack_90 + fVar15 * fStack_94 + fVar12 * local_98 + 0.0) ^ __LC4 ) / fVar14;
               if (fVar14 <= 0.0) {
                  LAB_0010485a:local_44 = 1.4013e-45;
               }
 else {
                  fVar12 = _LC3 - fVar14;
         ...
         if (iVar8 != 4) {
            LAB_00104a98:*(int*)( this + 0xc0 ) = iVar1;
            fVar18 = local_84;
            goto LAB_00104541;
         }

         auVar19 = ClosestPoint::GetClosestPointOnTetrahedron<true>(*(undefined8*)this, *(undefined8*)( this + 8 ), *(undefined8*)( this + 0x10 ), *(undefined8*)( this + 0x18 ), *(undefined8*)( this + 0x20 ), *(undefined8*)( this + 0x28 ), *(undefined8*)( this + 0x30 ), *(undefined8*)( this + 0x38 ), &local_44);
         fStack_a0 = auVar19._8_4_;
      }

      fVar18 = fStack_a0 * fStack_a0 + auVar19._4_4_ * auVar19._4_4_ + auVar19._0_4_ * auVar19._0_4_ + 0.0;
      if (fVar13 <= fVar18) {
         *(int*)( this + 0xc0 ) = iVar1;
         iVar8 = iVar1;
         fVar18 = local_84;
         LAB_00104505:if (iVar8 == 2) {
            ...
            if (fVar12 < _LC2) {
               if (fStack_90 * fStack_90 + fStack_94 * fStack_94 + local_98 * local_98 + 0.0 <= (float)local_a8._4_4_ * (float)local_a8._4_4_ + (float)local_a8._0_4_ * (float)local_a8._0_4_ + 0.0 + fStack_a0 * fStack_a0) {
                  fVar13 = 0.0;
                  fVar12 = _LC3;
               }
 else {
               ...
               fVar12 = (float)( ( uint )(fVar15 * fStack_a0 + fVar14 * (float)local_a8._4_4_ + fVar13 * (float)local_a8._0_4_ + 0.0) ^ __LC4 ) / fVar12;
               fVar13 = _LC3 - fVar12;
            }
            ...
            *(float*)( param_7 + 0xc ) = fVar12 * fVar16 + fVar13 * fVar3;
            ...
            ClosestPoint::GetBaryCentricCoordinates(*(undefined8*)this, *(undefined8*)( this + 8 ), *(undefined8*)( this + 0x10 ), *(undefined8*)( this + 0x18 ), *(undefined8*)( this + 0x20 ), *(undefined8*)( this + 0x28 ), &local_4c, &local_48, &local_44);
            ...
            *(float*)param_6 = *(float*)( this + 0x50 ) * local_48 + *(float*)( this + 0x40 ) * local_4c + *(float*)( this + 0x60 ) * local_44;
            ...
            *(float*)param_7 = local_48 * *(float*)( this + 0x90 ) + local_4c * *(float*)( this + 0x80 ) + local_44 * *(float*)( this + 0xa0 );
         ...
         LAB_00104541:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            return fVar18;
         }
      ...
      *(ulong*)( param_5 + 8 ) = auVar19._8_8_ & 0xffffffff00000000 | (ulong)(uint)fStack_a0;
      ...
      LAB_001045b3:lVar10 = (long)iVar8;
      ...
      *(undefined1(*) [16])( pGVar11 + 0x80 ) = *(undefined1(*) [16])( pGVar7 + 0x80 );
      joined_r0x001045ec:if (iVar9 < iVar1) break;
      *(int*)( this + 0xc0 ) = iVar8;
      ...
      fVar12 = *(float*)( this + 8 ) * *(float*)( this + 8 ) + *(float*)( this + 4 ) * *(float*)( this + 4 ) + *(float*)this * *(float*)this + 0.0;
      if (1 < iVar8) {
         pGVar7 = this + 0x10;
         fVar14 = fVar12;
         do {
            pGVar11 = pGVar7 + 0x10;
            fVar12 = *(float*)( pGVar7 + 8 ) * *(float*)( pGVar7 + 8 ) + *(float*)pGVar7 * *(float*)pGVar7 + 0.0 + *(float*)( pGVar7 + 4 ) * *(float*)( pGVar7 + 4 );
            if (fVar12 <= fVar14) {
               fVar12 = fVar14;
            }
...
/* JPH::CollideConvexVsTriangles::CollideConvexVsTriangles(JPH::ConvexShape const*, JPH::Vec3,
   JPH::Vec3, JPH::Mat44 const&, JPH::Mat44 const&, JPH::SubShapeID const&,
   JPH::CollideShapeSettings const&, JPH::CollisionCollector<JPH::CollideShapeResult,
   JPH::CollisionCollectorTraitsCollideShape>&) */void JPH::CollideConvexVsTriangles::_GLOBAL__sub_I_CollideConvexVsTriangles(void) {
   if (DVec3::cTrue == '\0') {
      DVec3::cTrue = '\x01';
      DVec3::cTrue = _LC79;
   }

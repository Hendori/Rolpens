/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void PredictorAdd0_SSE2(long param_1, undefined8 param_2, int param_3, long param_4) {
   uint uVar1;
   char *pcVar2;
   char *pcVar3;
   char cVar4;
 ...
 while ( lVar36 != (ulong)uVar1 << 4 );
   ...
   if (param_3 != iVar35) {
      ...
      ( *_VP8LPredictorsAdd_C )(param_1 + (long)iVar35 * 4, 0, param_3 - iVar35, param_4 + (long)iVar35 * 4);
      return;
   }

   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void PredictorAdd2_SSE2(long param_1, long param_2, int param_3, long param_4) {
   uint uVar1;
   char *pcVar2;
   char *pcVar3;
   char *pcVar4;
 ...
 while ( lVar36 != (ulong)uVar1 << 4 );
   ...
   if (param_3 != iVar35) {
      ...
      /* WARNING: Treating indirect jump as call */
      ( *_VP8LConvertBGRAToRGB565_C )(param_1 + lVar36, param_2 + lVar36, param_3 - iVar35, param_4 + lVar36);
      return;
   }

   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void PredictorAdd3_SSE2(long param_1, long param_2, int param_3, long param_4) {
   uint uVar1;
   char *pcVar2;
   char *pcVar3;
   char *pcVar4;
 ...
 while ( (ulong)uVar1 << 4 != lVar36 );
   ...
   if (param_3 != iVar35) {
      ...
      /* WARNING: Treating indirect jump as call */
      ( *_VP8LConvertBGRAToRGBA4444_C )(param_1 + lVar36, param_2 + lVar36, param_3 - iVar35, param_4 + lVar36);
      return;
   }

   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void PredictorAdd4_SSE2(long param_1, long param_2, int param_3, long param_4) {
   uint uVar1;
   char *pcVar2;
   char *pcVar3;
   char *pcVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void ConvertBGRAToBGR_SSE2(ulong *param_1, int param_2, ulong *param_3) {
   ulong uVar1;
   int iVar2;
   ulong uVar3;
   ulong uVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void ConvertBGRAToRGB565_SSE2(long param_1, ulong param_2, long param_3) {
   undefined1 *puVar1;
   undefined1 uVar2;
   ...
   if (7 < (int)param_2) {
      ...
      do {
         ...
         auVar33._0_8_ = CONCAT17(puVar1[0xe], CONCAT16(puVar1[10], CONCAT15(puVar1[6], CONCAT14(puVar1[2], CONCAT13(auVar50[0xe], CONCAT12(auVar50[10], CONCAT11(auVar50[6], auVar50[2])))))));
         ...
         for (int i = 0; i < 3; i++) {
            auVar52[( 7 - i )] = puVar1[( -4*i + 12 )];
         }

         auVar52[4] = *puVar1;
         for (int i = 0; i < 4; i++) {
            auVar52[( 3 - i )] = auVar50[( -4*i + 12 )];
         }
         ...
         for (int i = 0; i < 3; i++) {
            auVar34[( -2*i + 7 )] = auVar51[( 3 - i )];
            auVar34[( -2*i + 6 )] = auVar23[( 3 - i )];
         }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void ConvertBGRAToRGBA4444_SSE2(long param_1, ulong param_2, long param_3) {
   undefined1 *puVar1;
   undefined1 uVar2;
   undefined1 auVar3[16];
   undefined1 auVar4[16];
   ...
   if (7 < (int)param_2) {
      ...
      do {
         ...
         auVar48._0_8_ = CONCAT17(puVar1[0xe], CONCAT16(puVar1[10], CONCAT15(puVar1[6], CONCAT14(puVar1[2], CONCAT13(auVar28[0xe], CONCAT12(auVar28[10], CONCAT11(auVar28[6], auVar28[2])))))));
         ...
         for (int i = 0; i < 3; i++) {
            auVar49[( 7 - i )] = puVar1[( -4*i + 12 )];
         }

         auVar49[4] = *puVar1;
         for (int i = 0; i < 4; i++) {
            auVar49[( 3 - i )] = auVar28[( -4*i + 12 )];
         }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void ConvertBGRAToRGBA_SSE2(undefined1 (*param_1)[16], ulong param_2, undefined1 (*param_3)[16]) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void TransformColorInverse_SSE2(char *param_1, long param_2, int param_3, long param_4) {
   uint uVar1;
   char *pcVar2;
   ...
   if (param_3 < 4) {
      ...
      do {
         ...
         for (int i = 0; i < 15; i++) {
            auVar10[( i + 1 )] = auVar8[( i + 1 )] + pcVar2[( i + 1 )];
         }
         ...
         in_XMM0._0_8_ = CONCAT26(( ushort )(( (ulong)auVar8[7] << 0x38 ) >> 0x38), CONCAT24(( ushort )(( ( uint6 )(byte)(auVar8[5] + auVar9[6]) << 0x28 ) >> 0x28), CONCAT22(( ushort )(( (uint)auVar8[3] << 0x18 ) >> 0x18), auVar3._0_2_))) & 0xffffffffffff00ff;
 ...
 while ( lVar7 != (ulong)uVar1 << 4 );
   ...
   VP8LTransformColorInverse_C(param_1, param_2 + (long)iVar6 * 4, param_3 - iVar6, param_4 + (long)iVar6 * 4);
   return;
}
...
undefined4 Predictor5_SSE2(undefined4 *param_1, undefined4 *param_2) {
   ...
   uVar2 = param_2[1];
   uVar3 = *param_2;
   uVar4 = ( ushort )(( ( ushort )(( (ushort)uVar2 & 0xff ) + (ushort)(byte)uVar1) >> 1 ) + (ushort)(byte)uVar3) >> 1;
   uVar5 = ( ushort )(( ( ushort )(( ushort )(byte)((uint)uVar2 >> 8) + ( ushort )(byte)((uint)uVar1 >> 8)) >> 1 ) + ( ushort )(byte)((uint)uVar3 >> 8)) >> 1;
   uVar6 = ( ushort )(( ( ushort )(( ushort )(byte)((uint)uVar2 >> 0x10) + ( ushort )(byte)((uint)uVar1 >> 0x10)) >> 1 ) + ( ushort )(byte)((uint)uVar3 >> 0x10)) >> 1;
   uVar7 = ( ushort )(( ( ushort )(( ushort )(byte)((uint)uVar2 >> 0x18) + ( ushort )(byte)((uint)uVar1 >> 0x18)) >> 1 ) + ( ushort )(byte)((uint)uVar3 >> 0x18)) >> 1;
   return CONCAT13(( uVar7 != 0 ) * ( uVar7 < 0x100 ) * (char)uVar7 - ( 0xff < uVar7 ), CONCAT12(( uVar6 != 0 ) * ( uVar6 < 0x100 ) * (char)uVar6 - ( 0xff < uVar6 ), CONCAT11(( uVar5 != 0 ) * ( uVar5 < 0x100 ) * (char)uVar5 - ( 0xff < uVar5 ), ( uVar4 != 0 ) * ( uVar4 < 0x100 ) * (char)uVar4 - ( 0xff < uVar4 ))));
}
undefined4 Predictor10_SSE2(undefined4 *param_1, undefined4 *param_2) {
   ...
   uVar3 = *param_2;
   uVar4 = param_2[1];
   uVar5 = ( ushort )(( ( ushort )(( (ushort)uVar4 & 0xff ) + ( (ushort)uVar3 & 0xff )) >> 1 ) + ( ( ushort )(( (ushort)uVar2 & 0xff ) + (ushort)(byte)uVar1) >> 1 )) >> 1;
   uVar6 = ( ushort )(( ( ushort )(( ushort )(byte)((uint)uVar4 >> 8) + ( ushort )(byte)((uint)uVar3 >> 8)) >> 1 ) + ( ( ushort )(( ushort )(byte)((uint)uVar2 >> 8) + ( ushort )(byte)((uint)uVar1 >> 8)) >> 1 )) >> 1;
   uVar7 = ( ushort )(( ( ushort )(( ushort )(byte)((uint)uVar4 >> 0x10) + ( ushort )(byte)((uint)uVar3 >> 0x10)) >> 1 ) + ( ( ushort )(( ushort )(byte)((uint)uVar2 >> 0x10) + ( ushort )(byte)((uint)uVar1 >> 0x10)) >> 1 )) >> 1;
   uVar8 = ( ushort )(( ( ushort )(( ushort )(byte)((uint)uVar4 >> 0x18) + ( ushort )(byte)((uint)uVar3 >> 0x18)) >> 1 ) + ( ( ushort )(( ushort )(byte)((uint)uVar2 >> 0x18) + ( ushort )(byte)((uint)uVar1 >> 0x18)) >> 1 )) >> 1;
   return CONCAT13(( uVar8 != 0 ) * ( uVar8 < 0x100 ) * (char)uVar8 - ( 0xff < uVar8 ), CONCAT12(( uVar7 != 0 ) * ( uVar7 < 0x100 ) * (char)uVar7 - ( 0xff < uVar7 ), CONCAT11(( uVar6 != 0 ) * ( uVar6 < 0x100 ) * (char)uVar6 - ( 0xff < uVar6 ), ( uVar5 != 0 ) * ( uVar5 < 0x100 ) * (char)uVar5 - ( 0xff < uVar5 ))));
}
undefined4 Predictor12_SSE2(undefined4 *param_1, undefined4 *param_2) {
   ...
   sVar5 = ( ( ushort )(byte)((uint)uVar1 >> 8) + ( ushort )(byte)((uint)uVar2 >> 8) ) - ( ushort )(byte)((uint)uVar3 >> 8);
   sVar6 = ( ( ushort )(byte)((uint)uVar1 >> 0x10) + ( ushort )(byte)((uint)uVar2 >> 0x10) ) - ( ushort )(byte)((uint)uVar3 >> 0x10);
   sVar7 = ( ( ushort )(byte)((uint)uVar1 >> 0x18) + ( ushort )(byte)((uint)uVar2 >> 0x18) ) - ( ushort )(byte)((uint)uVar3 >> 0x18);
   return CONCAT13(( 0 < sVar7 ) * ( sVar7 < 0x100 ) * (char)sVar7 - ( 0xff < sVar7 ), CONCAT12(( 0 < sVar6 ) * ( sVar6 < 0x100 ) * (char)sVar6 - ( 0xff < sVar6 ), CONCAT11(( 0 < sVar5 ) * ( sVar5 < 0x100 ) * (char)sVar5 - ( 0xff < sVar5 ), ( 0 < sVar4 ) * ( sVar4 < 0x100 ) * (char)sVar4 - ( 0xff < sVar4 ))));
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void PredictorAdd12_SSE2(long param_1, long param_2, int param_3, long param_4) {
   uint uVar1;
   char *pcVar2;
   long lVar3;
   undefined1 auVar4[16];
   ...
   auVar87 = ZEXT716(CONCAT52(CONCAT41((int)( CONCAT34(( int3 )(CONCAT25((short)( ( ( uint7 )(byte)((uint)uVar83 >> 0x18) << 0x30 ) >> 0x28 ), CONCAT14((char)( (uint)uVar83 >> 0x10 ), uVar83)) >> 0x20), uVar83) >> 0x18 ), (char)( (uint)uVar83 >> 8 )), (ushort)(byte)uVar83) & 0xffffff00ffffff);
   if (param_3 < 4) {
      iVar78 = 0;
   }
 else {
      ...
      do {
         ...
         uVar47 = CONCAT11(( ( 0 < sVar81 ) * ( sVar81 < 0x100 ) * (char)sVar81 - ( 0xff < sVar81 ) ) + pcVar2[8], bVar100);
         uVar60 = CONCAT12(( ( 0 < sVar92 ) * ( sVar92 < 0x100 ) * (char)sVar92 - ( 0xff < sVar92 ) ) + pcVar2[9], uVar47);
         uVar66 = CONCAT13(( ( 0 < sVar96 ) * ( sVar96 < 0x100 ) * (char)sVar96 - ( 0xff < sVar96 ) ) + pcVar2[10], uVar60);
         uVar67 = CONCAT14(( ( 0 < sVar99 ) * ( sVar99 < 0x100 ) * (char)sVar99 - ( 0xff < sVar99 ) ) + pcVar2[0xb], uVar66);
         auVar73[5] = ( ( 0 < sVar102 ) * ( sVar102 < 0x100 ) * (char)sVar102 - ( 0xff < sVar102 ) ) + pcVar2[0xc];
         ...
         bVar80 = ( ( 0 < sVar110 ) * ( sVar110 < 0x100 ) * (char)sVar110 - ( 0xff < sVar110 ) ) + *(char*)( lVar3 + 4 );
         cVar88 = ( ( 0 < sVar111 ) * ( sVar111 < 0x100 ) * (char)sVar111 - ( 0xff < sVar111 ) ) + *(char*)( lVar3 + 5 );
         uVar82 = CONCAT11(cVar88, bVar80);
         cVar90 = ( ( 0 < sVar112 ) * ( sVar112 < 0x100 ) * (char)sVar112 - ( 0xff < sVar112 ) ) + *(char*)( lVar3 + 6 );
         cVar93 = ( ( 0 < sVar113 ) * ( sVar113 < 0x100 ) * (char)sVar113 - ( 0xff < sVar113 ) ) + *(char*)( lVar3 + 7 );
         uVar84 = CONCAT13(cVar93, CONCAT12(cVar90, uVar82));
         cVar101 = ( ( bVar100 != 0 ) * ( bVar100 < 0x100 ) * bVar100 - ( 0xff < bVar100 ) ) + *(char*)( lVar3 + 0xb );
         uVar47 = CONCAT11(( ( 0 < sVar110 ) * ( sVar110 < 0x100 ) * (char)sVar110 - ( 0xff < sVar110 ) ) + cVar40, cVar101);
         uVar60 = CONCAT12(( ( 0 < sVar111 ) * ( sVar111 < 0x100 ) * (char)sVar111 - ( 0xff < sVar111 ) ) + cVar89, uVar47);
         uVar66 = CONCAT13(( ( 0 < sVar112 ) * ( sVar112 < 0x100 ) * (char)sVar112 - ( 0xff < sVar112 ) ) + cVar91, uVar60);
         uVar67 = CONCAT14(( ( 0 < sVar113 ) * ( sVar113 < 0x100 ) * (char)sVar113 - ( 0xff < sVar113 ) ) + cVar94, uVar66);
         auVar75[5] = ( 0 < sVar81 ) * ( sVar81 < 0x100 ) * cVar95 - ( 0xff < sVar81 );
         auVar75._0_5_ = uVar67;
         auVar75._6_8_ = 0;
         auVar9[0xe] = cVar101;
         auVar9._0_14_ = auVar75 << 0x38;
         uVar74 = CONCAT26(auVar9._13_2_, CONCAT15(( ( 0 < sVar96 ) * ( sVar96 < 0x100 ) * cVar98 - ( 0xff < sVar96 ) ) + *(char*)( lVar3 + 10 ), uVar67));
         auVar70._4_8_ = 0;
         auVar70._0_4_ = uVar66;
         auVar17._12_3_ = ( int3 )((ulong)uVar74 >> 0x28);
         auVar17._0_12_ = auVar70 << 0x38;
         uVar69 = CONCAT44(auVar17._11_4_, CONCAT13(( ( 0 < sVar92 ) * ( sVar92 < 0x100 ) * cVar97 - ( 0xff < sVar92 ) ) + *(char*)( lVar3 + 9 ), uVar60));
         auVar25._10_5_ = ( int5 )((ulong)uVar69 >> 0x18);
         auVar25._0_10_ = (unkuint10)uVar47 << 0x38;
         uVar61 = CONCAT62(auVar25._9_6_, CONCAT11(( ( 0 < sVar81 ) * ( sVar81 < 0x100 ) * cVar95 - ( 0xff < sVar81 ) ) + *(char*)( lVar3 + 8 ), cVar101));
         auVar50._7_8_ = 0;
         ...
         bVar80 = ( ( 0 < sVar81 ) * ( sVar81 < 0x100 ) * (char)sVar81 - ( 0xff < sVar81 ) ) + *(char*)( lVar3 + 8 );
         cVar88 = ( ( 0 < sVar110 ) * ( sVar110 < 0x100 ) * (char)sVar110 - ( 0xff < sVar110 ) ) + *(char*)( lVar3 + 9 );
         uVar82 = CONCAT11(cVar88, bVar80);
         cVar90 = ( ( 0 < sVar92 ) * ( sVar92 < 0x100 ) * (char)sVar92 - ( 0xff < sVar92 ) ) + *(char*)( lVar3 + 10 );
         cVar93 = ( ( 0 < sVar111 ) * ( sVar111 < 0x100 ) * (char)sVar111 - ( 0xff < sVar111 ) ) + *(char*)( lVar3 + 0xb );
         ...
         auVar19._12_3_ = ( int3 )(CONCAT26(auVar11._13_2_, CONCAT15(( 0 < sVar92 ) * ( sVar92 < 0x100 ) * cVar98 - ( 0xff < sVar92 ), uVar67)) >> 0x28);
         auVar19._0_12_ = auVar72 << 0x38;
         auVar27._10_5_ = ( int5 )(CONCAT44(auVar19._11_4_, CONCAT13(( 0 < sVar110 ) * ( sVar110 < 0x100 ) * cVar97 - ( 0xff < sVar110 ), uVar60)) >> 0x18);
         auVar27._0_10_ = (unkuint10)uVar47 << 0x38;
         auVar54._7_8_ = 0;
         auVar54._0_7_ = ( uint7 )(CONCAT62(auVar27._9_6_, CONCAT11(( 0 < sVar81 ) * ( sVar81 < 0x100 ) * cVar95 - ( 0xff < sVar81 ), cVar88)) >> 8);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void PredictorAdd11_SSE2(long param_1, long param_2, int param_3, long param_4) {
   uint uVar1;
   char *pcVar2;
   long lVar3;
   char cVar4;
   ...
   if (param_3 < 4) {
      ...
      do {
         ...
         uVar10 = CONCAT13(auVar43[3] + pcVar2[3], CONCAT12(auVar43[2] + pcVar2[2], CONCAT11(auVar43[1] + pcVar2[1], auVar43[0] + *pcVar2)));
         auVar30._0_8_ = CONCAT17(auVar43[7] + pcVar2[7], CONCAT16(auVar43[6] + pcVar2[6], CONCAT15(auVar43[5] + pcVar2[5], CONCAT14(auVar43[4] + pcVar2[4], uVar10))));
         for (int i = 0; i < 8; i++) {
            auVar30[( i + 8 )] = auVar43[( i + 8 )] + pcVar2[( i + 8 )];
         }
         ...
         uVar17 = CONCAT13(auVar43[3] + *(char*)( lVar3 + 7 ), CONCAT12(auVar43[2] + *(char*)( lVar3 + 6 ), CONCAT11(auVar43[1] + *(char*)( lVar3 + 5 ), auVar43[0] + *(char*)( lVar3 + 4 ))));
         auVar24._0_8_ = CONCAT17(auVar43[7] + *(char*)( lVar3 + 0xb ), CONCAT16(auVar43[6] + *(char*)( lVar3 + 10 ), CONCAT15(auVar43[5] + *(char*)( lVar3 + 9 ), CONCAT14(auVar43[4] + *(char*)( lVar3 + 8 ), uVar17))));
         auVar24[8] = auVar43[8] + cVar4;
         auVar24[9] = auVar43[9] + cVar5;
         auVar24[10] = auVar43[10] + cVar6;
         auVar24[0xb] = auVar43[0xb] + cVar7;
         for (int i = 0; i < 4; i++) {
            auVar24[( i + 12 )] = auVar43[( i + 12 )];
         }
         ...
         uVar11 = CONCAT13(auVar43[3] + *(char*)( lVar3 + 0xb ), CONCAT12(auVar43[2] + *(char*)( lVar3 + 10 ), CONCAT11(auVar43[1] + *(char*)( lVar3 + 9 ), auVar43[0] + *(char*)( lVar3 + 8 ))));
         auVar15._0_8_ = CONCAT17(auVar43[7] + cVar7, CONCAT16(auVar43[6] + cVar6, CONCAT15(auVar43[5] + cVar5, CONCAT14(auVar43[4] + cVar4, uVar11))));
         for (int i = 0; i < 8; i++) {
            auVar15[( i + 8 )] = auVar43[( i + 8 )];
         }
         ...
         auVar43._0_4_ = CONCAT13(auVar16[3] + cVar7, CONCAT12(auVar16[2] + cVar6, CONCAT11(auVar16[1] + cVar5, auVar16[0] + cVar4)));
         for (int i = 0; i < 12; i++) {
            auVar43[( i + 4 )] = auVar16[( i + 4 )];
         }
...
undefined4 Predictor6_SSE2(byte *param_1, long param_2) {
   ...
   return CONCAT13(cVar4 - ( ( param_1[3] ^ *(byte*)( param_2 + -1 ) ) & UNK_00101843 ), CONCAT12(cVar3 - ( ( param_1[2] ^ *(byte*)( param_2 + -2 ) ) & UNK_00101842 ), CONCAT11(cVar2 - ( ( param_1[1] ^ *(byte*)( param_2 + -3 ) ) & UNK_00101841 ), cVar1 - ( ( *param_1 ^ *(byte*)( param_2 + -4 ) ) & _LC10 ))));
}
undefined4 Predictor7_SSE2(byte *param_1, byte *param_2) {
   ...
   return CONCAT13(cVar4 - ( ( param_1[3] ^ param_2[3] ) & UNK_00101843 ), CONCAT12(cVar3 - ( ( param_1[2] ^ param_2[2] ) & UNK_00101842 ), CONCAT11(cVar2 - ( ( param_1[1] ^ param_2[1] ) & UNK_00101841 ), cVar1 - ( ( *param_1 ^ *param_2 ) & _LC10 ))));
}
undefined4 Predictor8_SSE2(undefined8 param_1, byte *param_2) {
   ...
   return CONCAT13(cVar4 - ( ( param_2[-1] ^ param_2[3] ) & UNK_00101843 ), CONCAT12(cVar3 - ( ( param_2[-2] ^ param_2[2] ) & UNK_00101842 ), CONCAT11(cVar2 - ( ( param_2[-3] ^ param_2[1] ) & UNK_00101841 ), cVar1 - ( ( param_2[-4] ^ *param_2 ) & _LC10 ))));
}
undefined4 Predictor9_SSE2(undefined8 param_1, byte *param_2) {
   ...
   return CONCAT13(cVar4 - ( ( param_2[3] ^ param_2[7] ) & UNK_00101843 ), CONCAT12(cVar3 - ( ( param_2[2] ^ param_2[6] ) & UNK_00101842 ), CONCAT11(cVar2 - ( ( param_2[1] ^ param_2[5] ) & UNK_00101841 ), cVar1 - ( ( *param_2 ^ param_2[4] ) & _LC10 ))));
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void PredictorAdd6_SSE2(long param_1, long param_2, int param_3, long param_4) {
   uint uVar1;
   undefined1 auVar2[16];
   uint uVar3;
   long lVar4;
   ...
   if (0 < param_3) {
      ...
      do {
         ...
         uVar3 = ( CONCAT13(cVar10 - auVar5[3], uVar7) & 0xff00ff00 ) + ( *(uint*)( param_1 + lVar4 ) & 0xff00ff00 ) & 0xff00ff00 | ( *(uint*)( param_1 + lVar4 ) & 0xff00ff ) + ( uVar7 & 0xff00ff ) & 0xff00ff;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void PredictorAdd7_SSE2(long param_1, long param_2, int param_3, long param_4) {
   uint uVar1;
   undefined1 auVar2[16];
   uint uVar3;
   long lVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void PredictorAdd8_SSE2(long param_1, long param_2, int param_3, long param_4) {
   uint uVar1;
   undefined1 *puVar2;
   byte *pbVar3;
   char *pcVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void PredictorAdd9_SSE2(long param_1, long param_2, int param_3, long param_4) {
   uint uVar1;
   undefined1 *puVar2;
   byte *pbVar3;
   char *pcVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void PredictorAdd10_SSE2(long param_1, long param_2, int param_3, long param_4) {
   uint uVar1;
   undefined1 *puVar2;
   long lVar3;
   char *pcVar4;
   ...
   if (param_3 < 4) {
      ...
      do {
         ...
         auVar61 = ( *(undefined1(*) [16])( param_2 + lVar12 ) ^ *(undefined1(*) [16])( param_2 + 4 + lVar12 ) ) & auVar10;
         ...
         auVar61._0_4_ = CONCAT13(( cVar18 + cVar9 ) - auVar15[3], CONCAT12(( cVar17 + cVar8 ) - auVar15[2], CONCAT11(( cVar16 + cVar7 ) - auVar15[1], ( cVar13 + cVar6 ) - auVar15[0])));
 ...
 while ( (ulong)uVar1 << 4 != lVar12 );
   ...
   if (param_3 != iVar11) {
      ...
      /* WARNING: Treating indirect jump as call */
      ( *_VP8LAddGreenToBlueAndRed )(param_1 + lVar12, param_2 + lVar12, param_3 - iVar11, param_4 + lVar12);
      return;
   }

   return;
}
/* WARNING: Removing unreachable block (ram,0x00100f47) *//* WARNING: Removing unreachable block (ram,0x00100f3a) *//* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void PredictorAdd1_SSE2(long param_1, long param_2, int param_3, long param_4) {
   uint uVar1;
   char *pcVar2;
   char *pcVar3;
   undefined4 uVar4;
...
undefined4 Predictor13_SSE2(undefined4 *param_1, undefined4 *param_2) {
   ...
   return CONCAT13(( 0 < sVar9 ) * ( sVar9 < 0x100 ) * (char)sVar9 - ( 0xff < sVar9 ), CONCAT12(( 0 < sVar8 ) * ( sVar8 < 0x100 ) * (char)sVar8 - ( 0xff < sVar8 ), CONCAT11(( 0 < sVar7 ) * ( sVar7 < 0x100 ) * (char)sVar7 - ( 0xff < sVar7 ), ( 0 < sVar5 ) * ( sVar5 < 0x100 ) * (char)sVar5 - ( 0xff < sVar5 ))));
}
uint Predictor11_SSE2(uint *param_1, uint *param_2) {
   ...
   if ((int)(short)( ( auVar27._0_2_ & 0xff ) - (ushort)auVar30[0] ) + (int)(short)( auVar15._2_2_ - auVar19._0_2_ ) + (int)(short)( auVar22._0_2_ - auVar18._0_2_ ) + (int)(short)( (short)Var21 - (short)Var17 ) < 1) {
      uVar1 = uVar2;
   }
...
void PredictorAdd13_SSE2(long param_1, long param_2, int param_3, long param_4) {
   ...
   if (0 < param_3) {
      ...
      do {
         ...
         uVar7 = CONCAT12(( 0 < sVar10 ) * ( sVar10 < 0x100 ) * (char)sVar10 - ( 0xff < sVar10 ), CONCAT11(( 0 < sVar9 ) * ( sVar9 < 0x100 ) * (char)sVar9 - ( 0xff < sVar9 ), ( 0 < sVar6 ) * ( sVar6 < 0x100 ) * (char)sVar6 - ( 0xff < sVar6 )));
         uVar4 = ( CONCAT13(( 0 < sVar11 ) * ( sVar11 < 0x100 ) * (char)sVar11 - ( 0xff < sVar11 ), uVar7) & 0xff00ff00 ) + ( *(uint*)( param_1 + lVar5 ) & 0xff00ff00 ) & 0xff00ff00 | ( *(uint*)( param_1 + lVar5 ) & 0xff00ff ) + ( uVar7 & 0xff00ff ) & 0xff00ff;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void ConvertBGRAToRGB_SSE2(undefined1 (*param_1)[16], ulong param_2, char *param_3) {
   byte bVar1;
   byte bVar9;
   byte bVar17;
   byte bVar25;
   ...
   if (0x1f < (int)param_2) {
      ...
      do {
         ...
         uVar365 = CONCAT13(cVar2, CONCAT12(( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar371[4] - ( 0xff < sVar66 ), CONCAT11(bVar1, ( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar371[0] - ( 0xff < sVar65 ))));
         sVar65 = auVar371._8_2_;
         sVar66 = auVar371._10_2_;
         cVar3 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar371[10] - ( 0xff < sVar66 );
         uVar366 = CONCAT15(cVar3, CONCAT14(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar371[8] - ( 0xff < sVar65 ), uVar365));
         sVar65 = auVar371._12_2_;
         sVar66 = auVar371._14_2_;
         cVar4 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar371[0xe] - ( 0xff < sVar66 );
         uVar332 = CONCAT17(cVar4, CONCAT16(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar371[0xc] - ( 0xff < sVar65 ), uVar366));
         sVar65 = auVar199._0_2_;
         sVar66 = auVar199._2_2_;
         cVar5 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar199[2] - ( 0xff < sVar66 );
         auVar367._0_10_ = CONCAT19(cVar5, CONCAT18(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar199[0] - ( 0xff < sVar65 ), uVar332));
         ...
         uVar330 = CONCAT13(cVar10, CONCAT12(( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar360[4] - ( 0xff < sVar66 ), CONCAT11(bVar9, ( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar360[0] - ( 0xff < sVar65 ))));
         sVar65 = auVar360._8_2_;
         sVar66 = auVar360._10_2_;
         cVar11 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar360[10] - ( 0xff < sVar66 );
         uVar331 = CONCAT15(cVar11, CONCAT14(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar360[8] - ( 0xff < sVar65 ), uVar330));
         sVar65 = auVar360._12_2_;
         sVar66 = auVar360._14_2_;
         cVar12 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar360[0xe] - ( 0xff < sVar66 );
         uVar291 = CONCAT17(cVar12, CONCAT16(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar360[0xc] - ( 0xff < sVar65 ), uVar331));
         sVar65 = auVar200._0_2_;
         sVar66 = auVar200._2_2_;
         cVar13 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar200[2] - ( 0xff < sVar66 );
         auVar348._0_10_ = CONCAT19(cVar13, CONCAT18(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar200[0] - ( 0xff < sVar65 ), uVar291));
         ...
         uVar167 = CONCAT13(cVar18, CONCAT12(( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar201[4] - ( 0xff < sVar66 ), CONCAT11(bVar17, ( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar201[0] - ( 0xff < sVar65 ))));
         sVar65 = auVar201._8_2_;
         sVar66 = auVar201._10_2_;
         cVar19 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar201[10] - ( 0xff < sVar66 );
         uVar168 = CONCAT15(cVar19, CONCAT14(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar201[8] - ( 0xff < sVar65 ), uVar167));
         sVar65 = auVar201._12_2_;
         sVar66 = auVar201._14_2_;
         cVar20 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar201[0xe] - ( 0xff < sVar66 );
         uVar138 = CONCAT17(cVar20, CONCAT16(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar201[0xc] - ( 0xff < sVar65 ), uVar168));
         sVar65 = auVar312._0_2_;
         sVar66 = auVar312._2_2_;
         cVar21 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar312[2] - ( 0xff < sVar66 );
         auVar170._0_10_ = CONCAT19(cVar21, CONCAT18(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar312[0] - ( 0xff < sVar65 ), uVar138));
         ...
         uVar212 = CONCAT13(cVar26, CONCAT12(( uVar225 != 0 ) * ( uVar225 < 0x100 ) * cVar27 - ( 0xff < uVar225 ), CONCAT11(bVar25, ( uVar211 != 0 ) * ( uVar211 < 0x100 ) * cVar207 - ( 0xff < uVar211 ))));
         cVar27 = ( uVar228 != 0 ) * ( uVar228 < 0x100 ) * auVar276[0xd] - ( 0xff < uVar228 );
         uVar213 = CONCAT15(cVar27, CONCAT14(( uVar227 != 0 ) * ( uVar227 < 0x100 ) * cVar165 - ( 0xff < uVar227 ), uVar212));
         cVar207 = ( uVar230 != 0 ) * ( uVar230 < 0x100 ) * pauVar130[3][0xd] - ( 0xff < uVar230 );
         uVar169 = CONCAT17(cVar207, CONCAT16(( uVar229 != 0 ) * ( uVar229 < 0x100 ) * cVar30 - ( 0xff < uVar229 ), uVar213));
         cVar28 = ( uVar279 != 0 ) * ( uVar279 < 0x100 ) * auVar313[0xd] - ( 0xff < uVar279 );
         auVar215._0_10_ = CONCAT19(cVar28, CONCAT18(( uVar257 != 0 ) * ( uVar257 < 0x100 ) * cVar282 - ( 0xff < uVar257 ), uVar169));
         ...
         uVar258 = CONCAT13(cVar32, CONCAT12(( uVar230 != 0 ) * ( uVar230 < 0x100 ) * cVar33 - ( 0xff < uVar230 ), CONCAT11(bVar31, ( bVar205 != 0 ) * ( bVar205 < 0x100 ) * bVar205 - ( 0xff < bVar205 ))));
         cVar33 = ( uVar279 != 0 ) * ( uVar279 < 0x100 ) * auVar276[0xc] - ( 0xff < uVar279 );
         uVar259 = CONCAT15(cVar33, CONCAT14(( bVar164 != 0 ) * ( bVar164 < 0x100 ) * bVar164 - ( 0xff < bVar164 ), uVar258));
         cVar208 = ( uVar284 != 0 ) * ( uVar284 < 0x100 ) * pauVar130[3][0xc] - ( 0xff < uVar284 );
         uVar234 = CONCAT17(cVar208, CONCAT16(( uVar281 != 0 ) * ( uVar281 < 0x100 ) * cVar34 - ( 0xff < uVar281 ), uVar259));
         cVar34 = ( uVar211 != 0 ) * ( uVar211 < 0x100 ) * auVar313[0xc] - ( 0xff < uVar211 );
         auVar261._0_10_ = CONCAT19(cVar34, CONCAT18(( bVar280 != 0 ) * ( bVar280 < 0x100 ) * bVar280 - ( 0xff < bVar280 ), uVar234));
         ...
         uVar232 = CONCAT13(cVar37, CONCAT12(( uVar251 != 0 ) * ( uVar251 < 0x100 ) * cVar43 - ( 0xff < uVar251 ), CONCAT11(bVar164, ( uVar231 != 0 ) * ( uVar231 < 0x100 ) * bVar209 - ( 0xff < uVar231 ))));
         cVar38 = ( uVar254 != 0 ) * ( uVar254 < 0x100 ) * auVar276[0xe] - ( 0xff < uVar254 );
         uVar233 = CONCAT15(cVar38, CONCAT14(( uVar253 != 0 ) * ( uVar253 < 0x100 ) * bVar166 - ( 0xff < uVar253 ), uVar232));
         cVar39 = ( uVar256 != 0 ) * ( uVar256 < 0x100 ) * pauVar130[3][0xe] - ( 0xff < uVar256 );
         uVar214 = CONCAT17(cVar39, CONCAT16(( uVar255 != 0 ) * ( uVar255 < 0x100 ) * cVar42 - ( 0xff < uVar255 ), uVar233));
         cVar40 = ( uVar224 != 0 ) * ( uVar224 < 0x100 ) * auVar313[0xe] - ( 0xff < uVar224 );
         auVar235._0_10_ = CONCAT19(cVar40, CONCAT18(( uVar211 != 0 ) * ( uVar211 < 0x100 ) * bVar283 - ( 0xff < uVar211 ), uVar214));
         ...
         uVar289 = CONCAT13(cVar44, CONCAT12(( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar371[4] - ( 0xff < sVar66 ), CONCAT11(bVar166, ( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar371[0] - ( 0xff < sVar65 ))));
         sVar65 = auVar371._8_2_;
         sVar66 = auVar371._10_2_;
         cVar45 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar371[10] - ( 0xff < sVar66 );
         uVar290 = CONCAT15(cVar45, CONCAT14(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar371[8] - ( 0xff < sVar65 ), uVar289));
         sVar65 = auVar371._12_2_;
         sVar66 = auVar371._14_2_;
         cVar46 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar371[0xe] - ( 0xff < sVar66 );
         uVar260 = CONCAT17(cVar46, CONCAT16(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar371[0xc] - ( 0xff < sVar65 ), uVar290));
         sVar65 = auVar199._0_2_;
         sVar66 = auVar199._2_2_;
         cVar47 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar199[2] - ( 0xff < sVar66 );
         auVar316._0_10_ = CONCAT19(cVar47, CONCAT18(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar199[0] - ( 0xff < sVar65 ), uVar260));
         sVar65 = auVar199._4_2_;
         ...
         uVar258 = CONCAT13(cVar51, CONCAT12(( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar313[4] - ( 0xff < sVar66 ), CONCAT11(bVar205, ( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar313[0] - ( 0xff < sVar65 ))));
         sVar65 = auVar313._8_2_;
         sVar66 = auVar313._10_2_;
         cVar52 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar313[10] - ( 0xff < sVar66 );
         uVar259 = CONCAT15(cVar52, CONCAT14(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar313[8] - ( 0xff < sVar65 ), uVar258));
         sVar65 = auVar313._12_2_;
         sVar66 = auVar313._14_2_;
         cVar53 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar313[0xe] - ( 0xff < sVar66 );
         uVar234 = CONCAT17(cVar53, CONCAT16(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar313[0xc] - ( 0xff < sVar65 ), uVar259));
         sVar65 = auVar162._0_2_;
         sVar66 = auVar162._2_2_;
         cVar54 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar162[2] - ( 0xff < sVar66 );
         auVar292._0_10_ = CONCAT19(cVar54, CONCAT18(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar162[0] - ( 0xff < sVar65 ), uVar234));
         ...
         uVar136 = CONCAT13(cVar58, CONCAT12(( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar162[4] - ( 0xff < sVar66 ), CONCAT11(bVar206, ( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar162[0] - ( 0xff < sVar65 ))));
         sVar65 = auVar162._8_2_;
         sVar66 = auVar162._10_2_;
         cVar59 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar162[10] - ( 0xff < sVar66 );
         uVar137 = CONCAT15(cVar59, CONCAT14(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar162[8] - ( 0xff < sVar65 ), uVar136));
         sVar65 = auVar162._12_2_;
         sVar66 = auVar162._14_2_;
         cVar60 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar162[0xe] - ( 0xff < sVar66 );
         uVar138 = CONCAT17(cVar60, CONCAT16(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar162[0xc] - ( 0xff < sVar65 ), uVar137));
         sVar65 = auVar345._0_2_;
         sVar66 = auVar345._2_2_;
         cVar61 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar345[2] - ( 0xff < sVar66 );
         auVar139._0_10_ = CONCAT19(cVar61, CONCAT18(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar345[0] - ( 0xff < sVar65 ), uVar138));
         ...
         uVar167 = CONCAT13(cVar207, CONCAT12(( uVar225 != 0 ) * ( uVar225 < 0x100 ) * cVar27 - ( 0xff < uVar225 ), CONCAT11(bVar209, ( uVar211 != 0 ) * ( uVar211 < 0x100 ) * bVar25 - ( 0xff < uVar211 ))));
         cVar27 = ( uVar228 != 0 ) * ( uVar228 < 0x100 ) * cVar165 - ( 0xff < uVar228 );
         uVar168 = CONCAT15(cVar27, CONCAT14(( uVar227 != 0 ) * ( uVar227 < 0x100 ) * cVar28 - ( 0xff < uVar227 ), uVar167));
         cVar30 = ( uVar230 != 0 ) * ( uVar230 < 0x100 ) * cVar30 - ( 0xff < uVar230 );
         uVar169 = CONCAT17(cVar30, CONCAT16(( uVar229 != 0 ) * ( uVar229 < 0x100 ) * cVar29 - ( 0xff < uVar229 ), uVar168));
         cVar29 = ( uVar279 != 0 ) * ( uVar279 < 0x100 ) * cVar32 - ( 0xff < uVar279 );
         auVar216._0_10_ = CONCAT19(cVar29, CONCAT18(( uVar257 != 0 ) * ( uVar257 < 0x100 ) * bVar31 - ( 0xff < uVar257 ), uVar169));
         ...
         uVar330 = CONCAT13(cVar4, CONCAT12(( uVar375 != 0 ) * ( uVar375 < 0x100 ) * cVar3 - ( 0xff < uVar375 ), CONCAT11(bVar25, ( uVar364 != 0 ) * ( uVar364 < 0x100 ) * bVar1 - ( 0xff < uVar364 ))));
         cVar2 = ( uVar378 != 0 ) * ( uVar378 < 0x100 ) * cVar6 - ( 0xff < uVar378 );
         uVar331 = CONCAT15(cVar2, CONCAT14(( uVar377 != 0 ) * ( uVar377 < 0x100 ) * cVar5 - ( 0xff < uVar377 ), uVar330));
         cVar8 = ( uVar380 != 0 ) * ( uVar380 < 0x100 ) * cVar8 - ( 0xff < uVar380 );
         uVar332 = CONCAT17(cVar8, CONCAT16(( uVar379 != 0 ) * ( uVar379 < 0x100 ) * cVar7 - ( 0xff < uVar379 ), uVar331));
         cVar7 = ( uVar224 != 0 ) * ( uVar224 < 0x100 ) * cVar10 - ( 0xff < uVar224 );
         auVar368._0_10_ = CONCAT19(cVar7, CONCAT18(( uVar211 != 0 ) * ( uVar211 < 0x100 ) * bVar9 - ( 0xff < uVar211 ), uVar332));
         ...
         uVar212 = CONCAT13(cVar15, CONCAT12(( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar276[4] - ( 0xff < sVar66 ), CONCAT11(bVar1, ( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar276[0] - ( 0xff < sVar65 ))));
         sVar65 = auVar276._8_2_;
         sVar66 = auVar276._10_2_;
         cVar16 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar276[10] - ( 0xff < sVar66 );
         uVar213 = CONCAT15(cVar16, CONCAT14(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar276[8] - ( 0xff < sVar65 ), uVar212));
         sVar65 = auVar276._12_2_;
         sVar66 = auVar276._14_2_;
         cVar14 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar276[0xe] - ( 0xff < sVar66 );
         uVar214 = CONCAT17(cVar14, CONCAT16(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar276[0xc] - ( 0xff < sVar65 ), uVar213));
         sVar65 = auVar313._0_2_;
         sVar66 = auVar313._2_2_;
         cVar13 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar313[2] - ( 0xff < sVar66 );
         auVar262._0_10_ = CONCAT19(cVar13, CONCAT18(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar313[0] - ( 0xff < sVar65 ), uVar214));
         ...
         uVar136 = CONCAT13(cVar18, CONCAT12(( uVar251 != 0 ) * ( uVar251 < 0x100 ) * cVar19 - ( 0xff < uVar251 ), CONCAT11(bVar9, ( uVar231 != 0 ) * ( uVar231 < 0x100 ) * bVar17 - ( 0xff < uVar231 ))));
         cVar32 = ( uVar254 != 0 ) * ( uVar254 < 0x100 ) * cVar22 - ( 0xff < uVar254 );
         uVar137 = CONCAT15(cVar32, CONCAT14(( uVar253 != 0 ) * ( uVar253 < 0x100 ) * cVar21 - ( 0xff < uVar253 ), uVar136));
         cVar24 = ( uVar256 != 0 ) * ( uVar256 < 0x100 ) * cVar24 - ( 0xff < uVar256 );
         uVar138 = CONCAT17(cVar24, CONCAT16(( uVar255 != 0 ) * ( uVar255 < 0x100 ) * cVar23 - ( 0xff < uVar255 ), uVar137));
         cVar22 = ( uVar374 != 0 ) * ( uVar374 < 0x100 ) * cVar37 - ( 0xff < uVar374 );
         auVar171._0_10_ = CONCAT19(cVar22, CONCAT18(( uVar364 != 0 ) * ( uVar364 < 0x100 ) * bVar164 - ( 0xff < uVar364 ), uVar138));
         ...
         uVar258 = CONCAT13(cVar282, CONCAT12(( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar362[4] - ( 0xff < sVar66 ), CONCAT11(bVar17, ( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar362[0] - ( 0xff < sVar65 ))));
         sVar65 = auVar362._8_2_;
         sVar66 = auVar362._10_2_;
         cVar33 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar362[10] - ( 0xff < sVar66 );
         uVar259 = CONCAT15(cVar33, CONCAT14(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar362[8] - ( 0xff < sVar65 ), uVar258));
         sVar65 = auVar362._12_2_;
         sVar66 = auVar362._14_2_;
         cVar35 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar362[0xe] - ( 0xff < sVar66 );
         uVar260 = CONCAT17(cVar35, CONCAT16(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar362[0xc] - ( 0xff < sVar65 ), uVar259));
         sVar65 = auVar162._0_2_;
         sVar66 = auVar162._2_2_;
         cVar36 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar162[2] - ( 0xff < sVar66 );
         auVar349._0_10_ = CONCAT19(cVar36, CONCAT18(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar162[0] - ( 0xff < sVar65 ), uVar260));
         sVar65 = auVar162._4_2_;
         ...
         uVar289 = CONCAT13(cVar37, CONCAT12(( uVar375 != 0 ) * ( uVar375 < 0x100 ) * cVar45 - ( 0xff < uVar375 ), CONCAT11(bVar31, ( uVar364 != 0 ) * ( uVar364 < 0x100 ) * bVar166 - ( 0xff < uVar364 ))));
         cVar43 = ( uVar378 != 0 ) * ( uVar378 < 0x100 ) * cVar48 - ( 0xff < uVar378 );
         uVar290 = CONCAT15(cVar43, CONCAT14(( uVar377 != 0 ) * ( uVar377 < 0x100 ) * cVar47 - ( 0xff < uVar377 ), uVar289));
         cVar42 = ( uVar380 != 0 ) * ( uVar380 < 0x100 ) * cVar50 - ( 0xff < uVar380 );
         uVar291 = CONCAT17(cVar42, CONCAT16(( uVar379 != 0 ) * ( uVar379 < 0x100 ) * cVar49 - ( 0xff < uVar379 ), uVar290));
         cVar41 = ( uVar279 != 0 ) * ( uVar279 < 0x100 ) * cVar51 - ( 0xff < uVar279 );
         auVar317._0_10_ = CONCAT19(cVar41, CONCAT18(( uVar257 != 0 ) * ( uVar257 < 0x100 ) * bVar205 - ( 0xff < uVar257 ), uVar291));
         ...
         uVar232 = CONCAT13(cVar49, CONCAT12(( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar313[4] - ( 0xff < sVar66 ), CONCAT11(bVar164, ( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar313[0] - ( 0xff < sVar65 ))));
         sVar65 = auVar313._8_2_;
         sVar66 = auVar313._10_2_;
         cVar47 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar313[10] - ( 0xff < sVar66 );
         uVar233 = CONCAT15(cVar47, CONCAT14(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar313[8] - ( 0xff < sVar65 ), uVar232));
         sVar65 = auVar313._12_2_;
         sVar66 = auVar313._14_2_;
         cVar45 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar313[0xe] - ( 0xff < sVar66 );
         uVar234 = CONCAT17(cVar45, CONCAT16(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar313[0xc] - ( 0xff < sVar65 ), uVar233));
         sVar65 = auVar162._0_2_;
         sVar66 = auVar162._2_2_;
         cVar44 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar162[2] - ( 0xff < sVar66 );
         auVar333._0_10_ = CONCAT19(cVar44, CONCAT18(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar162[0] - ( 0xff < sVar65 ), uVar234));
         sVar65 = auVar162._4_2_;
         ...
         uVar167 = CONCAT13(cVar51, CONCAT12(( uVar251 != 0 ) * ( uVar251 < 0x100 ) * cVar32 - ( 0xff < uVar251 ), CONCAT11(bVar166, ( uVar231 != 0 ) * ( uVar231 < 0x100 ) * bVar9 - ( 0xff < uVar231 ))));
         cVar24 = ( uVar254 != 0 ) * ( uVar254 < 0x100 ) * cVar21 - ( 0xff < uVar254 );
         uVar168 = CONCAT15(cVar24, CONCAT14(( uVar253 != 0 ) * ( uVar253 < 0x100 ) * cVar22 - ( 0xff < uVar253 ), uVar167));
         cVar22 = ( uVar256 != 0 ) * ( uVar256 < 0x100 ) * cVar19 - ( 0xff < uVar256 );
         uVar169 = CONCAT17(cVar22, CONCAT16(( uVar255 != 0 ) * ( uVar255 < 0x100 ) * cVar20 - ( 0xff < uVar255 ), uVar168));
         cVar18 = ( uVar279 != 0 ) * ( uVar279 < 0x100 ) * cVar207 - ( 0xff < uVar279 );
         auVar172._0_10_ = CONCAT19(cVar18, CONCAT18(( uVar257 != 0 ) * ( uVar257 < 0x100 ) * bVar209 - ( 0xff < uVar257 ), uVar169));
         ...
         uVar136 = CONCAT13(cVar27, CONCAT12(( uVar225 != 0 ) * ( uVar225 < 0x100 ) * cVar59 - ( 0xff < uVar225 ), CONCAT11(bVar9, ( uVar211 != 0 ) * ( uVar211 < 0x100 ) * bVar206 - ( 0xff < uVar211 ))));
         cVar30 = ( uVar228 != 0 ) * ( uVar228 < 0x100 ) * cVar62 - ( 0xff < uVar228 );
         uVar137 = CONCAT15(cVar30, CONCAT14(( uVar227 != 0 ) * ( uVar227 < 0x100 ) * cVar61 - ( 0xff < uVar227 ), uVar136));
         cVar29 = ( uVar230 != 0 ) * ( uVar230 < 0x100 ) * cVar64 - ( 0xff < uVar230 );
         uVar138 = CONCAT17(cVar29, CONCAT16(( uVar229 != 0 ) * ( uVar229 < 0x100 ) * cVar63 - ( 0xff < uVar229 ), uVar137));
         cVar4 = ( uVar374 != 0 ) * ( uVar374 < 0x100 ) * cVar4 - ( 0xff < uVar374 );
         auVar140._0_10_ = CONCAT19(cVar4, CONCAT18(( uVar364 != 0 ) * ( uVar364 < 0x100 ) * bVar25 - ( 0xff < uVar364 ), uVar138));
         ...
         uVar232 = CONCAT13(cVar5, CONCAT12(( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar276[4] - ( 0xff < sVar66 ), CONCAT11(bVar25, ( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar276[0] - ( 0xff < sVar65 ))));
         sVar65 = auVar276._8_2_;
         sVar66 = auVar276._10_2_;
         cVar28 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar276[10] - ( 0xff < sVar66 );
         uVar233 = CONCAT15(cVar28, CONCAT14(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar276[8] - ( 0xff < sVar65 ), uVar232));
         sVar65 = auVar276._12_2_;
         sVar66 = auVar276._14_2_;
         cVar26 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar276[0xe] - ( 0xff < sVar66 );
         uVar234 = CONCAT17(cVar26, CONCAT16(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar276[0xc] - ( 0xff < sVar65 ), uVar233));
         sVar65 = auVar162._0_2_;
         sVar66 = auVar162._2_2_;
         cVar207 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar162[2] - ( 0xff < sVar66 );
         auVar236._0_10_ = CONCAT19(cVar207, CONCAT18(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar162[0] - ( 0xff < sVar65 ), uVar234));
         sVar65 = auVar162._4_2_;
         ...
         uVar258 = CONCAT13(cVar32, CONCAT12(( uVar225 != 0 ) * ( uVar225 < 0x100 ) * cVar16 - ( 0xff < uVar225 ), CONCAT11(bVar205, ( uVar211 != 0 ) * ( uVar211 < 0x100 ) * bVar1 - ( 0xff < uVar211 ))));
         cVar12 = ( uVar228 != 0 ) * ( uVar228 < 0x100 ) * cVar12 - ( 0xff < uVar228 );
         uVar259 = CONCAT15(cVar12, CONCAT14(( uVar227 != 0 ) * ( uVar227 < 0x100 ) * cVar13 - ( 0xff < uVar227 ), uVar258));
         cVar13 = ( uVar230 != 0 ) * ( uVar230 < 0x100 ) * cVar10 - ( 0xff < uVar230 );
         uVar260 = CONCAT17(cVar13, CONCAT16(( uVar229 != 0 ) * ( uVar229 < 0x100 ) * cVar11 - ( 0xff < uVar229 ), uVar259));
         cVar11 = ( uVar279 != 0 ) * ( uVar279 < 0x100 ) * cVar282 - ( 0xff < uVar279 );
         auVar263._0_10_ = CONCAT19(cVar11, CONCAT18(( uVar257 != 0 ) * ( uVar257 < 0x100 ) * bVar17 - ( 0xff < uVar257 ), uVar260));
         ...
         sVar67 = auVar362._6_2_;
         cVar282 = ( 0 < sVar67 ) * ( sVar67 < 0x100 ) * auVar362[6] - ( 0xff < sVar67 );
         uVar289 = CONCAT13(cVar282, CONCAT12(( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar362[4] - ( 0xff < sVar66 ), CONCAT11(bVar1, ( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar362[0] - ( 0xff < sVar65 ))));
         sVar65 = auVar362._8_2_;
         sVar66 = auVar362._10_2_;
         cVar35 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar362[10] - ( 0xff < sVar66 );
         uVar290 = CONCAT15(cVar35, CONCAT14(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar362[8] - ( 0xff < sVar65 ), uVar289));
         sVar65 = auVar362._12_2_;
         sVar66 = auVar362._14_2_;
         cVar34 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar362[0xe] - ( 0xff < sVar66 );
         uVar291 = CONCAT17(cVar34, CONCAT16(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar362[0xc] - ( 0xff < sVar65 ), uVar290));
         sVar65 = auVar162._0_2_;
         sVar66 = auVar162._2_2_;
         cVar208 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar162[2] - ( 0xff < sVar66 );
         auVar293._0_10_ = CONCAT19(cVar208, CONCAT18(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar162[0] - ( 0xff < sVar65 ), uVar291));
         sVar65 = auVar162._4_2_;
         ...
         uVar330 = CONCAT13(cVar36, CONCAT12(( uVar251 != 0 ) * ( uVar251 < 0x100 ) * cVar47 - ( 0xff < uVar251 ), CONCAT11(bVar17, ( uVar231 != 0 ) * ( uVar231 < 0x100 ) * bVar164 - ( 0xff < uVar231 ))));
         cVar49 = ( uVar254 != 0 ) * ( uVar254 < 0x100 ) * cVar46 - ( 0xff < uVar254 );
         uVar331 = CONCAT15(cVar49, CONCAT14(( uVar253 != 0 ) * ( uVar253 < 0x100 ) * cVar44 - ( 0xff < uVar253 ), uVar330));
         cVar50 = ( uVar256 != 0 ) * ( uVar256 < 0x100 ) * cVar50 - ( 0xff < uVar256 );
         uVar332 = CONCAT17(cVar50, CONCAT16(( uVar255 != 0 ) * ( uVar255 < 0x100 ) * cVar48 - ( 0xff < uVar255 ), uVar331));
         cVar37 = ( uVar224 != 0 ) * ( uVar224 < 0x100 ) * cVar37 - ( 0xff < uVar224 );
         auVar334._0_10_ = CONCAT19(cVar37, CONCAT18(( uVar211 != 0 ) * ( uVar211 < 0x100 ) * bVar31 - ( 0xff < uVar211 ), uVar332));
         ...
         uVar212 = CONCAT13(cVar44, CONCAT12(( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar162[4] - ( 0xff < sVar66 ), CONCAT11(bVar31, ( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar162[0] - ( 0xff < sVar65 ))));
         sVar65 = auVar162._8_2_;
         sVar66 = auVar162._10_2_;
         cVar46 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar162[10] - ( 0xff < sVar66 );
         uVar213 = CONCAT15(cVar46, CONCAT14(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar162[8] - ( 0xff < sVar65 ), uVar212));
         sVar65 = auVar162._12_2_;
         sVar66 = auVar162._14_2_;
         cVar48 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar162[0xe] - ( 0xff < sVar66 );
         uVar214 = CONCAT17(cVar48, CONCAT16(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar162[0xc] - ( 0xff < sVar65 ), uVar213));
         sVar65 = auVar199._0_2_;
         sVar66 = auVar199._2_2_;
         cVar45 = ( 0 < sVar66 ) * ( sVar66 < 0x100 ) * auVar199[2] - ( 0xff < sVar66 );
         auVar217._0_10_ = CONCAT19(cVar45, CONCAT18(( 0 < sVar65 ) * ( sVar65 < 0x100 ) * auVar199[0] - ( 0xff < sVar65 ), uVar214));
         sVar65 = auVar199._4_2_;
         ...
         uVar136 = CONCAT13(cVar27, CONCAT12(( uVar225 != 0 ) * ( uVar225 < 0x100 ) * cVar30 - ( 0xff < uVar225 ), CONCAT11(bVar164, ( uVar211 != 0 ) * ( uVar211 < 0x100 ) * bVar9 - ( 0xff < uVar211 ))));
         cVar8 = ( uVar228 != 0 ) * ( uVar228 < 0x100 ) * cVar8 - ( 0xff < uVar228 );
         uVar137 = CONCAT15(cVar8, CONCAT14(( uVar227 != 0 ) * ( uVar227 < 0x100 ) * cVar4 - ( 0xff < uVar227 ), uVar136));
         cVar3 = ( uVar230 != 0 ) * ( uVar230 < 0x100 ) * cVar3 - ( 0xff < uVar230 );
         uVar138 = CONCAT17(cVar3, CONCAT16(( uVar229 != 0 ) * ( uVar229 < 0x100 ) * cVar6 - ( 0xff < uVar229 ), uVar137));
         cVar4 = ( uVar279 != 0 ) * ( uVar279 < 0x100 ) * cVar51 - ( 0xff < uVar279 );
         auVar141._0_10_ = CONCAT19(cVar4, CONCAT18(( uVar257 != 0 ) * ( uVar257 < 0x100 ) * bVar166 - ( 0xff < uVar257 ), uVar138));
...
void PredictorAdd5_SSE2(long param_1, long param_2, int param_3, long param_4) {
   ...
   if (0 < param_3) {
      ...
      do {
         ...
         uVar5 = ( ushort )(( ( ushort )(( (ushort)uVar1 & 0xff ) + (ushort)(byte)uVar3) >> 1 ) + (ushort)(byte)uVar2) >> 1;
         uVar7 = ( ushort )(( ( ushort )(( ushort )(byte)((uint)uVar1 >> 8) + ( ushort )(byte)(uVar3 >> 8)) >> 1 ) + ( ushort )(byte)((uint)uVar2 >> 8)) >> 1;
         uVar8 = ( ushort )(( ( ushort )(( ushort )(byte)((uint)uVar1 >> 0x10) + ( ushort )(byte)(uVar3 >> 0x10)) >> 1 ) + ( ushort )(byte)((uint)uVar2 >> 0x10)) >> 1;
         uVar9 = ( ushort )(( ( ushort )(( ushort )(byte)((uint)uVar1 >> 0x18) + ( ushort )(byte)(uVar3 >> 0x18)) >> 1 ) + ( ushort )(byte)((uint)uVar2 >> 0x18)) >> 1;
         uVar6 = CONCAT12(( uVar8 != 0 ) * ( uVar8 < 0x100 ) * (char)uVar8 - ( 0xff < uVar8 ), CONCAT11(( uVar7 != 0 ) * ( uVar7 < 0x100 ) * (char)uVar7 - ( 0xff < uVar7 ), ( uVar5 != 0 ) * ( uVar5 < 0x100 ) * (char)uVar5 - ( 0xff < uVar5 )));
         uVar3 = ( CONCAT13(( uVar9 != 0 ) * ( uVar9 < 0x100 ) * (char)uVar9 - ( 0xff < uVar9 ), uVar6) & 0xff00ff00 ) + ( *(uint*)( param_1 + lVar4 ) & 0xff00ff00 ) & 0xff00ff00 | ( *(uint*)( param_1 + lVar4 ) & 0xff00ff ) + ( uVar6 & 0xff00ff ) & 0xff00ff;
         *(uint*)( param_4 + lVar4 ) = uVar3;
         lVar4 = lVar4 + 4;
      }
 while ( (long)param_3 * 4 - lVar4 != 0 );
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void VP8LDspInitSSE2(void) {

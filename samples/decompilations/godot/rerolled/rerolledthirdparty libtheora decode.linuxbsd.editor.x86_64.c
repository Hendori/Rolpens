void oc_filter_hedge(undefined1 *param_1, int param_2, byte *param_3, int param_4, int param_5, int param_6, int *param_7, int *param_8) {
   undefined1 *puVar1;
   byte bVar2;
   long lVar3;
   undefined1 *puVar4;
 ...
 while ( (uint*)local_40 != puVar5 );
      ...
      iVar11 = ( ( local_68[5] - local_68[6] ^ uVar15 ) - uVar15 ) + ( ( local_68[7] - local_68[8] ^ uVar17 ) - uVar17 ) + ( ( local_68[6] - local_68[7] ^ uVar16 ) - uVar16 ) + ( ( local_68[8] - local_68[9] ^ uVar18 ) - uVar18 );
      iVar9 = ( ( local_68[1] - local_68[0] ^ uVar10 ) - uVar10 ) + ( ( local_68[3] - local_68[2] ^ uVar13 ) - uVar13 ) + ( ( local_68[2] - local_68[1] ^ uVar12 ) - uVar12 ) + ( ( local_68[4] - local_68[3] ^ uVar14 ) - uVar14 );
      iVar7 = 0xff;
      if (iVar9 < 0x100) {
         iVar7 = iVar9;
      }
      ...
      *param_8 = *param_8 + iVar7;
      ...
      if (( ( iVar9 < param_6 ) && ( (int)( local_68[5] - local_68[4] ) < param_5 ) ) && ( (int)( local_68[4] - local_68[5] ) < param_5 )) {
         *param_1 = (char)( (int)( local_68[4] + 4 + local_68[0] * 3 + local_68[1] * 2 + local_68[2] + local_68[3] ) >> 3 );
         param_1[lVar3] = (char)( (int)( local_68[5] + 4 + local_68[0] * 2 + local_68[1] + local_68[2] * 2 + local_68[3] + local_68[4] ) >> 3 );
         ...
         do {
            ...
            uVar10 = puVar6[6];
            puVar6 = puVar6 + 1;
            *puVar4 = (char)( (int)( uVar10 + 4 + uVar12 + uVar13 + uVar16 + uVar14 * 2 + uVar15 + uVar17 ) >> 3 );
            puVar4 = puVar4 + lVar3;
            uVar12 = uVar13;
            uVar13 = uVar16;
            uVar14 = uVar15;
 ...
 while ( puVar6 != local_68 + 4 );
         *local_b0 = (char)( (int)( local_68[4] + local_68[5] + local_68[6] + local_68[7] * 2 + local_68[8] + 4 + local_68[9] * 2 ) >> 3 );
         local_b0[lVar3] = (char)( (int)( local_68[5] + local_68[6] + local_68[7] + local_68[8] * 2 + 4 + local_68[9] * 3 ) >> 3 );
      }
 else {
         puVar6 = local_68 + 1;
         puVar4 = param_1;
...
void oc_filter_vedge(undefined1 *param_1, int param_2, int param_3, int param_4, undefined8 *param_5) {
 ...
 while ( lVar3 != 10 );
      ...
      iVar8 = ( ( local_68[5] - local_68[6] ^ uVar12 ) - uVar12 ) + ( ( local_68[7] - local_68[8] ^ uVar14 ) - uVar14 ) + ( ( local_68[6] - local_68[7] ^ uVar13 ) - uVar13 ) + ( ( local_68[8] - local_68[9] ^ uVar15 ) - uVar15 );
      iVar6 = ( ( local_68[1] - local_68[0] ^ uVar7 ) - uVar7 ) + ( ( local_68[3] - local_68[2] ^ uVar10 ) - uVar10 ) + ( ( local_68[2] - local_68[1] ^ uVar9 ) - uVar9 ) + ( ( local_68[4] - local_68[3] ^ uVar11 ) - uVar11 );
      iVar4 = 0xff;
      if (iVar6 < 0x100) {
         iVar4 = iVar6;
      }
      ...
      *param_5 = CONCAT44(iVar5 + -0xff + (int)( (ulong)uVar1 >> 0x20 ) + (int)( ( ulong ) * param_5 >> 0x20 ), iVar4 + -0xff + (int)uVar1 + (int)*param_5);
      if (( ( iVar6 < param_4 ) && ( (int)( local_68[5] - local_68[4] ) < param_3 ) ) && ( (int)( local_68[4] - local_68[5] ) < param_3 )) {
         *param_1 = (char)( (int)( local_68[4] + 4 + local_68[0] * 3 + local_68[1] * 2 + local_68[2] + local_68[3] ) >> 3 );
         param_1[1] = (char)( (int)( local_68[5] + 4 + local_68[0] * 2 + local_68[1] + local_68[2] * 2 + local_68[3] + local_68[4] ) >> 3 );
         lVar3 = 0;
         uVar7 = local_68[1];
         uVar9 = local_68[5];
         uVar10 = local_68[4];
         ...
         do {
            ...
            param_1[lVar3 + 2] = (char)( (int)( uVar11 + uVar14 + uVar7 + uVar12 * 2 + uVar13 + uVar10 + 4 + uVar9 ) >> 3 );
            lVar3 = lVar3 + 1;
            uVar11 = uVar14;
            uVar12 = uVar13;
         }
 while ( lVar3 != 4 );
         param_1[6] = (char)( (int)( local_68[5] + local_68[4] + local_68[6] + local_68[7] * 2 + local_68[8] + 4 + local_68[9] * 2 ) >> 3 );
         param_1[7] = (char)( (int)( local_68[5] + local_68[6] + local_68[7] + local_68[8] * 2 + 4 + local_68[9] * 3 ) >> 3 );
      }
...
void oc_dering_block(byte *param_1, uint param_2, uint param_3, int param_4, uint param_5, int param_6) {
 ...
 while ( iVar23 != 9 );
   ...
   while (true) {
      ...
      param_1 = pbVar13;
      uVar3 = puVar6[8];
      iVar9 = pbVar19[1] * uVar3 + ( uint ) * param_1 * piVar17[8] + (uint)pbVar19[lVar5] * *puVar6 + 0x40 + ( uint ) * pbVar21 * *piVar17 + ( uint ) * pbVar19 * ( ( ( ( 0x80 - *puVar6 ) - *piVar17 ) - piVar17[8] ) - uVar3 );
      iVar24 = iVar9 >> 7;
      ...
      *pbVar28 = bVar7;
      ...
      do {
         ...
         uVar3 = puVar15[0x10];
         iVar9 = pbVar19[lVar11 + 1] * uVar3 + (uint)param_1[lVar11] * *(int*)( puVar27 + lVar11 * 4 ) + iVar24 + 0x40 + (uint)pbVar21[lVar11] * piVar17[lVar11] + (uint)pbVar19[lVar11] * ( ( ( iVar9 - piVar17[lVar11] ) - *(int*)( puVar27 + lVar11 * 4 ) ) - uVar3 );
         iVar24 = iVar9 >> 7;
         bVar7 = -(0x7fff < iVar9) | (byte)iVar24;
         if (iVar24 < 0) {
            bVar7 = bVar22;
 ...
 while ( lVar11 != 7 );
      iVar9 = (uint)pbVar19[7] * ( ( ( ( 0x80 - puVar6[0x38] ) - piVar17[7] ) - piVar17[0xf] ) - puVar6[0x40] ) + (uint)pbVar19[8 - ( ulong )((char)uVar25 == '\0')] * puVar6[0x40] + (uint)param_1[7] * piVar17[0xf] + (uint)pbVar19[6] * puVar6[0x38] + 0x40 + (uint)pbVar21[7] * piVar17[7];
      iVar24 = iVar9 >> 7;
      bVar7 = -(0x7fff < iVar9) | (byte)iVar24;
      if (iVar24 < 0) {
         bVar7 = bVar22;
...
void oc_dec_residual_tokens_unpack(long param_1) {
 ...
 while ( (long*)( lVar19 + ( local_8e0 + lVar34 ) * 8 ) != plVar13 );
      ...
      if (lVar34 < lVar23) {
         ...
         do {
            while (true) {
               iVar7 = oc_huff_token_decode_c(lVar1, *(undefined8*)( param_1 + 8 + ( (long)iVar16 + 0x1a26 ) * 8 ));
               lVar33 = lVar18 + 1;
               ...
               *(char*)( lVar27 + lVar33 ) = (char)( (uint)iVar8 >> 8 );
               ...
               LAB_00100cd3:lVar18 = 0x7fffffffffffffff;
               LAB_00100cdd:plVar13 = (long*)( lVar19 + lVar34 * 8 );
...
;
            iVar8 = 0;
            LAB_00100be6:uVar9 = iVar8 + *(int*)( OC_DCT_CODE_WORD + (long)iVar7 * 4 );
            if (uVar9 == 0) goto LAB_00100cd3;
            LAB_00100bf7:uVar20 = (int)uVar9 >> 8 & 0xfff;
 ...
 while ( lVar34 < lVar23 );
         LAB_00100d34:local_8e0 = local_8e0 + local_658[1];
      }
 ...
 while ( bVar35 );
      ...
      do {
         ...
         *(long*)( puVar30 + lVar18 ) = *(long*)( puVar30 + lVar18 ) - *(long*)( (long)local_658 + lVar18 );
                     ...
                     if (uVar26 < uVar5) {
                        ...
                        do {
                           while (true) {
                              ...
                              iVar10 = oc_huff_token_decode_c(lVar1, *(undefined8*)( param_1 + 8 + ( (long)iVar3 + 0x1a26 ) * 8 ));
                              lVar34 = lVar19 + 1;
...
;
 ...
 while ( bVar35 );
                     ...
                     if (0 < (int)( 0x40 - uVar9 )) {
                        do {
                           *(long*)( puVar30 + lVar19 ) = *(long*)( puVar30 + lVar19 ) - *(long*)( (long)local_898 + lVar19 );
                           lVar19 = lVar19 + -8;
                        }
...
void oc_dec_dc_unpredict_mcu_plane_c(long param_1, long param_2, int param_3) {
 ...
 while ( (byte*)( lVar6 + ( lVar16 + lVar10 ) * 4 ) != pbVar14 );
            ...
            do {
               ...
               if (( *pbVar1 & 1 ) != 0) {
                  ...
                  ( *(code*)( &DAT_001041c0 + *(int*)( &DAT_001041c0 + ( ulong )(( uint )(bVar18 == 0xffffffff) | ( uint )(bVar18 == uVar15) << 2 | ( uint )(uVar7 == bVar18) << 3 | ( uint )(bVar18 == uVar19) * 2) * 4 ) ) )();
                  return;
               }
 ...
 while ( iVar9 != iVar5 );
            LAB_0010152f:lVar10 = lVar10 + 1 + ( ulong )(iVar5 - 1);
         }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */long th_decode_alloc(long param_1, long param_2) {
   undefined8 uVar1;
   undefined8 uVar2;
   int iVar3;
   long lVar4;
                  ...
                  do {
                     ...
                     while (true) {
                        ...
                        do {
                           ...
                           iVar7 = iVar7 + 1;
                           lVar15 = lVar15 + 0x10;
                           iVar3 = iVar3 + ( ( uint ) * (ushort*)( lVar16 + 0x18 ) + ( uint ) * (ushort*)( lVar16 + 0x22 ) + ( uint ) * (ushort*)( lVar16 + 0x24 ) + ( uint ) * (ushort*)( lVar16 + 0x30 ) << bVar12 );
                        }
 while ( iVar7 != 3 );
                        lVar14 = lVar14 + 8;
                        if (iVar9 == 1) break;
...
;
 ...
 while ( lVar13 != 0x180 );
                  for (int i = 0; i < 3; i++) {
                     uVar1 = *(undefined8*)( param_2 + ( 16*i + 904 ) );
                     *(undefined8*)( lVar4 + ( 16*i + 53456 ) ) = *(undefined8*)( param_2 + ( 16*i + 896 ) );
                     *(undefined8*)( lVar4 + ( 16*i + 53464 ) ) = uVar1;
                  }
...
undefined8 th_decode_ctl(long param_1, int param_2, ulong *param_3, long param_4) {
   ...
   if (param_2 == 5) {
      ...
      if (( param_4 == 8 ) && ( uVar1 = -1 < (long)uVar1 )) {
...
undefined8 th_decode_packetin(long param_1, undefined8 *param_2, long *param_3) {
   ...
   *(undefined1*)( param_1 + 0x4c2 ) = uVar11;
   if (*(char*)( param_1 + 0x4c0 ) != '\0') {
      LAB_0010243a:in_stack_fffffffffffffdf8 = puVar26;
         ...
         do {
            ...
            do {
               ...
               if (( ( bVar45 >> 2 & 0xf ) >> ( uVar30 & 0x1f ) & 1 ) != 0) {
                  puVar26 = (undefined1*)( CONCAT44((int)( (ulong)puVar26 >> 0x20 ), ( uint )(bVar45 >> 2)) & 0xffffffff0000000f );
                  do {
                     lVar39 = *plVar27;
                     if (-1 < lVar39) {
 ...
 while ( lVar35 != 0x18 );
   *(long*)( param_1 + 400 ) = lVar67;
   ...
   code_r0x0010333a:uVar17 = *(uint*)( param_1 + 0x148 );
   if (uVar30 < uVar17) {
      uVar32 = 0;
...
;
      ...
      LAB_00104067:uVar29 = oc_huff_token_decode_c(in_stack_fffffffffffffdf8, OC_SB_RUN_TREE_4);
      if (0xf < (int)uVar29) {
 ...
 while ( lVar39 != 3 );
   *(long*)( param_1 + 400 ) = lVar67;
   ...
   if (*(char*)( param_1 + 0x4c0 ) != '\0') {
      LAB_00101a75:if (( *(int*)( param_1 + 0x348 ) < 0 ) || ( *(int*)( param_1 + 0x34c ) < 0 )) {
         ...
         *(undefined8*)( param_1 + 0xe230 ) = *(undefined8*)( param_1 + 0x1d8 );
         ...
         puVar26 = (undefined1*)CONCAT44((int)( ( ulong ) * (undefined8*)( param_1 + 0x198 ) >> 0x20 ), *(uint*)( param_1 + 0x30 ));
         ...
         *(long*)( param_1 + 0x368 ) = lVar19;
         ...
         for (int i = 0; i < 8; i++) {
            *(undefined8*)( param_1 + ( 8*i + 57840 ) ) = *(undefined8*)( param_1 + ( 8*i + 408 ) );
         }
         ...
         memset((void*)( lVar19 - ( (long)( *(int*)( param_1 + 8 ) + 0xf ) * (long)iVar18 + 0x10 ) ), 0x80, (long)iVar49 * (long)iVar18 + 0x10 + (long)( iVar49 >> ( ( ( byte )(*(uint*)( param_1 + 0x30 ) >> 1) ^ 1 ) & 1 ) ) * (long)iVar4 * 2);
   ...
   joined_r0x00101aa0:if (lVar67 < 1) {
      lVar19 = *(long*)( param_1 + 0x4b0 );
      *(long*)( param_1 + 0x4b0 ) = lVar19 + 1;
      lVar19 = ( ( ulong ) * (byte*)( param_1 + 0x4c1 ) + *(long*)( param_1 + 0x4a8 ) << ( ( byte ) * (undefined4*)( param_1 + 0x3c ) & 0x3f ) ) + ( lVar19 - *(long*)( param_1 + 0x4a8 ) );
      *(long*)( param_1 + 0x4b8 ) = lVar19;
      ...
      uVar20 = 1;
      LAB_00101af6:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return uVar20;
      }
   ...
   for (iVar28 = 0; ( *(int*)( param_1 + 0x348 ) == iVar28 || ( iVar28 == *(int*)( param_1 + 0x34c ) ) ); iVar28 = iVar28 + 1) {}
   ...
   *(undefined8*)( param_1 + 0x370 ) = uVar20;
   if (*(char*)( param_1 + 0x4c0 ) == '\0') {
      *(undefined8*)( param_1 + 0x4a8 ) = *(undefined8*)( param_1 + 0x4b0 );
      LAB_00101c9a:lVar19 = *(long*)( param_1 + 0x118 );
 ...
 while ( lVar21 < lVar67 );
         ...
         LAB_001039ec:do {
            ...
            do {
               ...
               *(byte*)( lVar19 + plVar37[lVar36] * 4 ) = *(byte*)( lVar19 + plVar37[lVar36] * 4 ) & 0xc3 | ( byte )(( uVar17 & 0xf ) << 2);
...
;
            uVar17 = oc_pack_read1_c(puVar26);
            LAB_00103ad8:uVar15 = oc_huff_token_decode_c(puVar26, OC_SB_RUN_TREE_4);
            if (0xf < (int)uVar15) {
                  ...
                  if (4 < uVar17) {
                     do {
                        ...
                        if (( *puVar65 & 1 ) != 0) {
                           ...
                           *(undefined2*)( lVar66 + lVar34 * 2 ) = *(undefined2*)( (long)local_a0 + ( ulong )(bVar45 & 3) * 2 );
                        }
 ...
 while ( &DAT_001050a5 + ( ulong )(uVar17 - 5) + lVar21 != pbVar62 );
                  ...
                  do {
                     ...
                     if (( *puVar65 & 1 ) != 0) {
                        *puVar65 = *puVar65 & 0xf83f | ( ushort )(( uVar15 & 7 ) << 8) | ( ushort )(( 0x10011121 >> ( ( byte )(uVar15 << 2) & 0x1f ) & 0xfU ) << 6);
 ...
 while ( pcVar25 != local_1e8 );
   ...
   LAB_00101ccf:uVar47 = ( undefined4 )((ulong)puVar26 >> 0x20);
   local_108 = local_98;
 ...
 while ( iVar49 != 3 );
   ...
   for (int i = 0; i < 3; i++) {
      *(undefined1(*) [16])( param_1 + ( 16*i + 63320 ) ) = (undefined1[16])0;
   }
   ...
   *(uint*)( param_1 + 0xf78c ) = (uint)bVar68;
   ...
   if (iVar49 < 1) {
      if (*(void**)( param_1 + 0xe1d0 ) != (void*)0x0) {
         for (int i = 0; i < 3; i++) {
            free(*(void**)( param_1 + ( 8*i + 57808 ) ));
            *(undefined8*)( param_1 + ( 8*i + 57808 ) ) = 0;
         }
 ...
 while ( plVar27 != plVar37 );
         ...
         LAB_00101f12:pvVar23 = *(void**)( param_1 + 0xe1d8 );
         if (1 < iVar49) {
            if (pvVar23 == (void*)0x0) {
               ...
               *(undefined4*)( param_1 + 0xe1e8 ) = 0;
               if (iVar49 < 5) {
                  LAB_00101f50:uVar20 = *(undefined8*)( param_1 + 4 );
                  *(undefined4*)( param_1 + 0xe1e8 ) = 1;
                  *(undefined8*)( param_1 + 0xe1f0 ) = uVar20;
                  *(int*)( param_1 + 0xe1f8 ) = -(int)uVar20;
                  *(long*)( param_1 + 0xe200 ) = (long)( 1 - (int)( (ulong)uVar20 >> 0x20 ) ) * (long)-(int)uVar20 + *(long*)( param_1 + 0xe1e0 );
                  if (iVar49 < 5) goto LAB_00101fab;
               }
 else {
                  LAB_00102557:*(void**)( param_1 + 0xe200 ) = pvVar23;
               ...
               LAB_00101fab:puVar52 = (undefined8*)( param_1 + 0x1b0 + (long)*(int*)( param_1 + 0x350 ) * 0x48 );
               uVar20 = puVar52[1];
   ...
   LAB_00103de3:*(undefined4*)( param_1 + 0xf790 ) = 0;
   ...
   *(undefined8*)( param_1 + 0xe1f8 ) = uVar20;
   for (int i = 0; i < 3; i++) {
      uVar20 = puVar52[( 2*i + 3 )];
      *(undefined8*)( param_1 + ( 16*i + 57856 ) ) = puVar52[( 2*i + 2 )];
      *(undefined8*)( param_1 + ( 16*i + 57864 ) ) = uVar20;
   }

   *(undefined8*)( param_1 + 0xe230 ) = puVar52[8];
   LAB_00101ff1:*(undefined8*)( param_1 + 0xe250 ) = 0;
   *(undefined8*)( param_1 + 0xe2c8 ) = 0;
   ...
   local_134 = 0;
   LAB_00102091:iVar4 = *(int*)( param_1 + 0xa4 );
   local_1c8 = 0;
      ...
      *(int*)( param_1 + 0xf74c + local_1c8 * 4 ) = iVar46;
      ...
      if (0 < (long)pvVar23) {
         ...
         do {
            ...
            iVar49 = 0;
            lVar39 = *(long*)( param_1 + 0xe250 + ( ( ulong )(( pbVar62[1] & 7 ) != 1) + 0x28c + ( ( ulong )(*pbVar62 >> 2 & 0xf) + (long)iVar61 * 3 ) * 2 ) * 8 );
            do {
               ...
               *(short*)( param_1 + 0xe250 + ( ulong ) * (byte*)( lVar66 + iVar46 ) * 2 ) = ( (short)( ( ushort )(uVar15 >> 0x10) ^ ( ushort )(-(uVar15 & 0x100000) >> 0x10) ) >> 5 ) * *(short*)( lVar39 + (long)iVar46 * 2 );
            }
 while ( iVar49 < 0x40 );
 ...
 while ( pvVar23 != pvVar70 );
      ...
      *(long*)( param_1 + 0xf650 + local_1c8 * 8 ) = lVar21 + (long)pvVar23 * 8;
      ...
      if (*(int*)( param_1 + 0xf78c ) == 0) {
         ...
         ( **(code**)( param_1 + 0x80 ) )(param_1, param_1 + 0xe350, 2, iVar61, *(int*)( param_1 + 0xf740 + local_1c8 * 4 ) - local_138, iVar49 - uVar17, uVar20);
      ...
      if ((int)( ( -(uint)(local_1c8 == 0) & 0xfffffffd ) + 4 ) < *(int*)( param_1 + 0xf790 )) {
         ...
         memset((void*)( (long)pvVar70 + lVar36 * 4 ), 0, (int)( ( ( ( uint )(iVar16 < iVar61) + iVar16 ) - iVar46 ) - ( uint )(0 < iVar46) ) * lVar21);
         uVar15 = local_130[2];
 ...
 while ( iVar59 != 4 );
         ...
         if (iVar43 < iVar59) {
            ...
            do {
               ...
               oc_filter_hedge(local_1a8, uVar32 & 0xffffffff, local_1b0 + -8, iVar46, iVar6, iVar6 * 3 >> 2, pvVar70, (void*)( (long)pvVar70 + lVar21 ));
               ...
               if (8 < iVar5) {
                  ...
                  do {
                     ...
                     uVar15 = iVar6 * 3 >> 2;
                     uVar72 = (ulong)uVar15;
                     oc_filter_hedge(pvVar23, uVar32 & 0xffffffff, lVar66, iVar46, iVar6, uVar15, pvVar42, (void*)( (long)pvVar42 + lVar21 ));
                     lVar34 = (long)pvVar42 + -4;
                     pvVar42 = (void*)( (long)pvVar42 + 4 );
                     oc_filter_vedge(( -4 - (long)( iVar31 * 4 ) ) + (long)pvVar23, uVar32 & 0xffffffff, iVar6, uVar72 & 0xffffffff, lVar34);
                     lVar66 = lVar66 + 8;
                  }
               ...
               do {
                  ...
                  if (0 < iVar5) {
                     ...
                     do {
                        ...
                        bVar9 = iVar41 < 1;
                        iVar41 = iVar41 + 8;
                        uVar15 = ( uint )(iVar5 <= iVar41) * 2 | (uint)bVar9 | ( uint )(iVar31 < 1) << 2 | ( uint )(iVar59 <= iVar46) << 3;
                        if (( iVar61 < iVar6 ) && ( bVar68 )) {
                           lVar34 = param_1 + (ulong)bVar69 * 4;
                           oc_dering_block(lVar66, uVar53 & 0xffffffff, uVar15, *(undefined4*)( lVar34 + 0xdfd0 ), *(undefined4*)( lVar34 + 0xe0d0 ), 1);
                           if (( ( ( local_1c8 != 0 ) || ( ( bVar9 == 0 && ( 0xf00 < piVar44[-1] ) ) ) ) || ( ( iVar5 <= iVar41 == 0 && ( 0xf00 < piVar44[1] ) ) ) ) || ( ( ( iVar31 < 1 == 0 && ( 0xf00 < piVar44[-lVar36] ) ) || ( ( iVar59 <= iVar46 == 0 && ( 0xf00 < piVar44[lVar36] ) ) ) ) )) {
                              oc_dering_block(lVar66, uVar53 & 0xffffffff, uVar15, *(undefined4*)( lVar34 + 0xdfd0 ), *(undefined4*)( lVar34 + 0xe0d0 ), 1);
                              oc_dering_block(lVar66, uVar53 & 0xffffffff, uVar15, *(undefined4*)( lVar34 + 0xdfd0 ), *(undefined4*)( lVar34 + 0xe0d0 ), 1);
                           }
                           ...
                           oc_dering_block(lVar66, uVar53 & 0xffffffff, uVar15, uVar47, *(undefined4*)( param_1 + 0xe0d0 + (long)(int)uVar30 * 4 ), uVar20);
                        }

                        LAB_001031f8:pbVar64 = pbVar64 + 4;
                        piVar44 = piVar44 + 1;
                        lVar66 = lVar66 + 8;
                     }
 while ( iVar41 < iVar5 );
 ...
 while ( iVar46 < iVar16 * 8 );
      ...
      if (local_1c8 == 3) {
         if (*(long*)( param_1 + 0xe240 ) != 0) {
            ( **(code**)( param_1 + 0x88 ) )();
            ( **(code**)( param_1 + 0xe240 ) )(*(undefined8*)( param_1 + 0xe238 ), local_108, *(int*)( param_1 + 0xa4 ) - iVar16, *(int*)( param_1 + 0xa4 ) - iVar46);
         }
         ...
         for (int i = 0; i < 3; i++) {
            oc_state_borders_fill_caps(param_1, iVar28, i);
         }
 ...
 while ( true );
   code_r0x001040c5:uVar15 = ( uint )(uVar15 == 0);
   if (0x1020 < uVar29) {
      uVar15 = oc_pack_read1_c();
   }
   ...
   goto LAB_00104067;
   LAB_00104118:uVar17 = ( uint )(uVar17 == 0);

   ...
   if (0 < lVar7) {
      ...
      *(long*)param_2[3] = lVar3 / lVar4;
      if ((double)( (ulong)dVar8 & uVar6 ) < dVar1) {
         dVar8 = (double)( ( ulong )(( (double)( (ulong)dVar8 & uVar6 ) + dVar1 ) - dVar1) | ~uVar6 & (ulong)dVar8 );
      }
      ...
      *(long*)param_2[2] = (long)dVar8;
      ...
      if ((double)( (ulong)dVar9 & uVar6 ) < dVar1) {
         dVar9 = (double)( ( ulong )(( (double)( (ulong)dVar9 & uVar6 ) + dVar1 ) - dVar1) | ~uVar6 & (ulong)dVar9 );
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 vorbis_bitrate_addblock(long param_1) {
   long lVar1;
   long lVar2;
   double dVar3;
   ulong uVar4;
   ...
   if ((double)( (ulong)dVar19 & _LC1 ) < _LC0) {
      dVar19 = (double)( ( ulong )(( (double)( (ulong)dVar19 & _LC1 ) + _LC0 ) - _LC0) | ~_LC1 & (ulong)dVar19 );
   }
 ...
 else if (( ( lVar7 < lVar6 ) && ( iVar16 < 0xe ) ) && ( lVar12 != lVar8 && SBORROW8(lVar12, lVar8) == lVar12 + lVar5 * -8 < 0 )) {
         lVar7 = (long)( iVar16 + 1 );
         do {
            iVar16 = (int)lVar7;
            lVar5 = oggpack_bytes(*(undefined8*)( lVar9 + 0x10 + lVar7 * 8 ));
 ...
 while ( ( lVar5 * 8 - lVar12 ) + *(long*)( lVar1 + 0x98 ) < lVar6 );
      ...
      if ((double)( (ulong)dVar17 & _LC1 ) < _LC0) {
         dVar17 = (double)( ( ulong )(( (double)( (ulong)dVar17 & _LC1 ) + _LC0 ) - _LC0) | ~_LC1 & (ulong)dVar17 );
      }
   ...
   if (( ( 0 < *(long*)( lVar1 + 0xb0 ) ) && ( lVar8 < local_70 ) ) && ( ( lVar10 < local_70 - lVar8 && ( iVar16 = iVar16 < 0xf ) ) )) {
 ...
 while ( iVar16 != 0xf );
   ...
   if (( ( *(long*)( lVar1 + 0xb8 ) < 1 ) || ( lVar8 <= lVar15 ) ) || ( lVar7 = *(long*)( lVar11 + 0x1558 )(lVar8 - lVar15) + lVar10 <= lVar7 )) {
      if (iVar16 < 0) goto LAB_001007a7;
      LAB_001004f3:lVar11 = ( local_70 - lVar10 ) + 7;
 ...
 while ( iVar16 != -1 );
         LAB_001007a7:lVar7 = *(long*)( lVar11 + 0x1558 );
      }
   ...
   LAB_001005ac:lVar9 = *(long*)( lVar1 + 0xa8 );
   if (0 < lVar9) {

...
/* FLOAT_MATH::fm_intersectPointPlane(double const*, double const*, double*, double const*) */undefined8 FLOAT_MATH::fm_intersectPointPlane(double *param_1, double *param_2, double *param_3, double *param_4) {
   double dVar1;
   double dVar2;
   double dVar3;
   double dVar4;

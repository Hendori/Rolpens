...
void gxv_LookupTable_fmt2_skip_endmarkers(char *param_1, ushort param_2, long *param_3) {
   ...
   if (param_1 + 4 < *(char**)( *param_3 + 0xd0 )) {
      ...
      while (( ( *pcVar1 == -1 && ( pcVar1[1] == -1 ) ) && ( pcVar1[2] == -1 ) )) {
         if (( pcVar1[3] != -1 ) || ( pcVar1 = pcVar1 + param_2 * (char**)( *param_3 + 0xd0 ) <= pcVar1 + 4 )) break;
      }
;
   ...
   do {
      ...
      do {
         ...
         if (uVar4 == uVar5) {
            ...
            LAB_00100288:ft_validator_error(*param_2, 9);
         }
...
void gxv_LookupTable_fmt0_validate(long param_1, ulong param_2, long *param_3) {
   ...
   if (param_2 == 0) {
      ...
      if (param_2 < uVar3) {
         lVar2 = *param_3;
         LAB_001005e3:ft_validator_error(lVar2, 8);
...
;
   ...
   LAB_0010059b:if (1 < *(uint*)( lVar2 + 0xd8 )) {
      ft_validator_error(lVar2, 0x10);
   }

   LAB_001005b0:param_3[3] = lVar1;
...
void gxv_mort_subtable_type2_entry_validate(undefined8 param_1, ushort param_2, undefined8 param_3, long param_4, undefined8 param_5, long *param_6) {
   uint *puVar1;
   uint *puVar2;
   ushort uVar3;
   uint uVar4;
   ...
   if (( puVar2 <= puVar1 ) && ( puVar1 <= (uint*)( (long)puVar2 + (ulong)uVar3 ) )) {
      uVar4 = *puVar1;
      uVar4 = ( uVar4 >> 0x18 | ( uVar4 & 0xff0000 ) >> 8 | ( uVar4 & 0xff00 ) << 8 | ( uVar4 & 0x3f ) << 0x18 ) * 2;
...
void gxv_morx_subtable_type2_entry_validate(undefined8 param_1, undefined8 param_2, ushort *param_3, long param_4, undefined8 param_5, long *param_6) {
   uint uVar1;
   uint uVar2;
   ulong uVar4;
   uint *puVar5;
   ...
   lVar8 = *param_6;
   LAB_00100a53:if (*(uint*)( lVar8 + 0xd8 ) < 2) {
      return;
   }
...
void gxv_morx_subtable_type2_opttable_load(uint *param_1, uint *param_2, long *param_3) {
   ...
   *puVar2 = ( ulong )(uVar1 >> 0x18 | ( uVar1 & 0xff0000 ) >> 8 | ( uVar1 & 0xff00 ) << 8 | uVar1 << 0x18);
   uVar1 = param_1[1];
   puVar2[1] = ( ulong )(uVar1 >> 0x18 | ( uVar1 & 0xff0000 ) >> 8 | ( uVar1 & 0xff00 ) << 8 | uVar1 << 0x18);
   uVar1 = param_1[2];
   puVar2[2] = ( ulong )(uVar1 >> 0x18 | ( uVar1 & 0xff0000 ) >> 8 | ( uVar1 & 0xff00 ) << 8 | uVar1 << 0x18);
   return;
}
void gxv_morx_subtable_type1_entry_validate(undefined8 param_1, uint param_2, undefined8 *param_3, undefined8 param_4, undefined8 param_5, long *param_6) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   lVar1 = param_6[0xf];
...
void gxv_set_length_by_ushort_offset(long param_1, undefined8 *param_2, short *param_3, uint param_4, ushort param_5, undefined8 *param_6) {
   short sVar1;
   short sVar2;
   undefined2 *puVar3;
   uint uVar4;
 ...
 while ( param_4 != uVar8 );
      ...
      LAB_00100d60:uVar4 = uVar8;
      ft_validator_error(*param_6, 9);
      LAB_00100d1c:sVar2 = param_3[uVar4 + 1];
      sVar1 = *psVar7;
...
void gxv_kern_subtable_fmt1_subtable_setup(undefined2 param_1, undefined2 param_2, undefined2 param_3, undefined2 param_4, undefined8 param_5, undefined8 param_6, undefined8 param_7, long param_8) {
   long in_FS_OFFSET;
   undefined8 local_50;
...
void gxv_StateTable_subtable_setup(undefined2 param_1, undefined2 param_2, undefined2 param_3, undefined2 param_4, undefined8 param_5, undefined8 param_6, undefined8 param_7, undefined8 param_8) {
   long in_FS_OFFSET;
   undefined2 local_36;
   undefined2 local_34;
   undefined2 local_32;
...
void gxv_mort_subtable_type2_subtable_setup(undefined2 param_1, undefined2 param_2, undefined2 param_3, undefined2 param_4, undefined8 param_5, undefined8 param_6, undefined8 param_7, long param_8) {
   long in_FS_OFFSET;
   undefined8 local_68;
   undefined4 local_60;
...
void gxv_mort_subtable_type1_subtable_setup(undefined2 param_1, undefined2 param_2, undefined2 param_3, undefined2 param_4, undefined8 param_5, undefined8 param_6, undefined8 param_7, long param_8) {
   long in_FS_OFFSET;
   undefined8 local_50;
   undefined1 local_42[10];
   undefined8 local_38;
...
void gxv_set_length_by_ulong_offset(long param_1, undefined8 *param_2, long *param_3, uint param_4, ulong param_5, undefined8 *param_6) {
   undefined8 *puVar1;
   long lVar2;
   long lVar3;
   ulong uVar4;
 ...
 while ( param_4 != uVar9 );
      ...
      LAB_001011a0:uVar5 = uVar9;
      ft_validator_error(*param_6, 9);
      LAB_0010115c:lVar2 = param_3[uVar5 + 1];
      lVar3 = *plVar8;
...
void gxv_morx_subtable_type5_subtable_setup(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6, undefined8 param_7, long param_8) {
   long in_FS_OFFSET;
   undefined8 local_78;
   undefined8 local_70;
   undefined8 local_68;
...
void gxv_XStateTable_subtable_setup(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6, undefined8 param_7, undefined8 param_8) {
   long in_FS_OFFSET;
   undefined8 local_78;
   undefined8 local_70;
   undefined8 local_68;
...
void gxv_morx_subtable_type2_subtable_setup(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6, undefined8 param_7, long param_8) {
   long in_FS_OFFSET;
   undefined8 local_a8;
   undefined8 local_a0;
   undefined8 local_98;
...
void gxv_morx_subtable_type1_subtable_setup(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6, undefined8 param_7, long param_8) {
   long in_FS_OFFSET;
   undefined8 local_78;
   undefined8 local_70;
   undefined8 local_68;
...
void gxv_sfntName_validate(ushort param_1, ushort param_2, ushort param_3, undefined8 *param_4) {
 ...
 while ( iVar1 != iVar3 );
   ...
   ft_validator_error(*param_4, 8);
   LAB_00101528:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
void gxv_trak_trackData_validate(ushort *param_1, ushort *param_2, long *param_3) {
 ...
 while ( uVar11 < uVar10 );
   ...
   lVar12 = *(long*)( lVar8 + 200 ) + ( ulong )(uVar2 >> 0x18 | ( uVar2 & 0xff0000 ) >> 8 | ( uVar2 & 0xff00 ) << 8 | uVar2 << 0x18);
   puVar5 = param_2;
   if (param_2 == (ushort*)0x0) {
...
void gxv_mort_subtable_type1_entry_validate(undefined8 param_1, uint param_2, undefined8 *param_3, undefined8 param_4, undefined8 param_5, long *param_6) {
   ushort uVar1;
   undefined8 uVar2;
   undefined2 uVar3;
   uint uVar4;
...
void gxv_BinSrchHeader_validate_constprop_0(ushort *param_1, ushort *param_2, ushort *param_3, ushort *param_4, long *param_5) {
   ushort uVar1;
   ushort *puVar2;
   ushort *puVar3;
   ushort uVar4;
   ...
   if (uVar10 == 0) {
      ...
      if (param_2 == (ushort*)0x0) {
         ...
         LAB_00101b33:ft_validator_error(*param_5, 8);
      }
   ...
   if (uVar9 == 0) {
      ...
      if (param_2 == (ushort*)0x0) {
         ...
         LAB_00101b73:ft_validator_error(*param_5, 8);
      }
 ...
 while ( (uint)uVar5 * 2 <= (uint)uVar9 );
   ...
   if (( ( uVar7 != uVar4 || uVar6 != uVar5 ) || ( ( ushort )(uVar9 * uVar10 - uVar5) != uVar8 ) ) && ( 1 < *(uint*)( *param_5 + 0xd8 ) )) {
      ft_validator_error(*param_5, 8);
   }

   LAB_00101a73:if (*param_3 == 0) {
      *param_3 = uVar10;
   }
   ...
   if (uVar3 != 0) {
      do {
         while (puVar5 = puVar1 + 1,*(short*)param_3[2] == 1) {
            gxv_ctlPoint_validate(param_1, CONCAT11((char)*puVar1, *(undefined1*)( (long)puVar1 + 1 )), param_3);
            puVar1 = puVar5;
...
void gxv_morx_subtable_type1_LookupValue_validate(undefined8 param_1, ushort *param_2, undefined8 *param_3) {
   ...
   if (param_3 != 0) {
      ...
      do {
         while (true) {
            ...
            LAB_00101f20:if (puVar9 == param_1 + param_3 * 6) goto LAB_00101f29;
         }
;
 ...
 while ( puVar9 != param_1 + param_3 * 6 );
      LAB_00101f29:if (( ( ( uVar1 != 0 ) && ( uVar2 != 0x100 ) ) && ( iVar3 != 0 ) ) && ( iVar4 != 0 )) {
         ft_validator_error(*param_4, 8);
      }
...
void gxv_XStateTable_validate(uint *param_1, uint *param_2, long *param_3) {
   ...
   uVar11 = *param_1;
   uVar9 = ( ulong )(uVar11 >> 0x18 | ( uVar11 & 0xff0000 ) >> 8 | ( uVar11 & 0xff00 ) << 8 | uVar11 << 0x18);
   param_3[0x13] = uVar9;
   uVar11 = param_1[1];
   uVar5 = param_1[2];
   uVar6 = param_1[3];
   uVar14 = ( ulong )(uVar11 >> 0x18 | ( uVar11 & 0xff0000 ) >> 8 | ( uVar11 & 0xff00 ) << 8 | uVar11 << 0x18);
   ...
   ( *pcVar10 )((long)param_2 - (long)param_1, uVar14, uVar19, uVar16, &local_60, &local_58, &local_50, param_3);
   if (uVar14 == 0) {
   ...
   if (uVar19 == 0) {
      LAB_001020e3:if (uVar16 == 0) goto LAB_0010220b;
      iVar13 = 1;
      uVar11 = 0;
   }
 else {
 ...
 while ( puVar15 + iVar13 <= puVar22 );
   ...
   uVar3 = *(ushort*)( param_3 + 0x14 );
   if ((ushort*)( local_50 + (long)puVar17 ) < (ushort*)( (long)( ( (int)param_3[0xe] / 2 + 4 ) * iVar13 ) + (long)puVar17 )) {
      ft_validator_error(*param_3, 8);
   }
   ...
   do {
      ...
      if (( uVar9 < (ulong)(long)(int)( (uint)uVar12 + (uint)uVar12 ) ) && ( 1 < *(uint*)( *param_3 + 0xd8 ) )) {
         ft_validator_error(*param_3, 9);
      }

      if (( (int)( (ulong)uVar12 % (ulong)(long)(int)( uVar3 + 1 ) ) != 0 ) && ( 1 < *(uint*)( *param_3 + 0xd8 ) )) {
         ft_validator_error(*param_3, 9);
      }
      ...
      if ((code*)param_3[0x11] != (code*)0x0) {
         ( *(code*)param_3[0x11] )((ulong)uVar12 / (ulong)(long)(int)( uVar3 + 1 ), uVar4 << 8 | uVar4 >> 8, &local_48, param_1, param_2, param_3);
      }
 ...
 while ( uVar18 <= (ushort)uVar11 );
   LAB_0010220b:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
void gxv_morx_subtable_type2_validate(long param_1, ulong param_2, long *param_3) {
   ...
   *(undefined4*)( param_3 + 0xe ) = 4;
   ...
   if (lVar3 == 0) {
      LAB_001026d0:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
   ...
   goto LAB_001026d0;
   code_r0x0010266e:uVar2 = *puVar5;
   puVar1 = puVar5 + 1;
   puVar5 = puVar6;
   if ((long)(ulong)CONCAT11(uVar2, *puVar1) < *(long*)( param_3[1] + 0x20 )) {
      LAB_00102688:puVar5 = puVar6;
      if (1 < *(uint*)( *param_3 + 0xd8 )) {
         ft_validator_error(*param_3, 0x10);
      }
   ...
   *(undefined4*)( param_3 + 4 ) = 0;
   ...
   if (*(short*)( lVar1 + 0x10 ) != 0) {
      ...
      do {
         ...
         uVar6 = uVar6 + 1;
         gxv_LookupTable_validate((byte*)( param_1 + local_58 ) + ( ( uint ) * pbVar5 << 0x18 | (uint)pbVar5[1] << 0x10 | (uint)pbVar5[3] | (uint)pbVar5[2] << 8 ), pbVar4, param_3);
         pbVar5 = pbVar5 + 4;
      }
...
void gxv_prop_property_validate(ushort param_1, ushort param_2, long *param_3) {
   ...
   if (( param_1 & 0x1000 ) != 0) {
      ...
      if (( ( param_2 != 0xffff ) && ( *(long*)( param_3[1] + 0x20 ) < (long)(ulong)param_2 ) ) && ( 1 < *(uint*)( *param_3 + 0xd8 ) )) {
         ft_validator_error(*param_3, 0x10);
      }

   }

   LAB_001029b5:if (( ( param_1 & 0x80 ) != 0 ) && ( *(long*)param_3[2] == 0x10000 )) {
      ft_validator_error(*param_3, 8);
   }
...
void gxv_mort_subtable_type5_subtable_setup(undefined2 param_1, undefined2 param_2, undefined2 param_3, undefined2 param_4, undefined8 param_5, undefined8 param_6, undefined8 param_7, long param_8) {
   undefined2 *puVar1;
   long in_FS_OFFSET;
   undefined2 local_66;
   undefined2 local_64;
...
void gxv_kern_subtable_fmt1_entry_validate(undefined8 param_1, ushort param_2, undefined8 param_3, long param_4, undefined8 param_5, long *param_6) {
   ushort uVar1;
   ushort *puVar2;
   ulong uVar3;
...
void gxv_mort_subtable_type5_entry_validate(undefined8 param_1, uint param_2, ulong *param_3, long param_4, ulong param_5, long *param_6) {
   ulong uVar1;
   uint uVar2;
   ulong uVar3;
...
void gxv_morx_subtable_type5_entry_validate(undefined8 param_1, uint param_2, ulong *param_3, long param_4, ulong param_5, long *param_6) {
   ulong uVar1;
   uint uVar2;
   ulong uVar3;
   uVar2 = param_2 >> 5 & 0x1f;
...
ushort gxv_XClassTable_lookupfmt4_transit(short param_1, short *param_2, ushort *param_3, long *param_4) {
   ushort *puVar1;
   puVar1 = (ushort*)( ( ulong )(ushort)(*param_2 + param_1 * 2) + param_4[7] );
   if (param_3 == (ushort*)0x0) {
      param_3 = *(ushort**)( *param_4 + 0xd0 );
...
ushort gxv_morx_subtable_type1_LookupFmt4_transit(short param_1, short *param_2, ushort *param_3, long *param_4) {
   ushort *puVar1;
   puVar1 = (ushort*)( ( ulong )(ushort)(*param_2 + param_1 * 2) + param_4[7] );
   if (param_3 == (ushort*)0x0) {
      param_3 = *(ushort**)( *param_4 + 0xd0 );
...
ushort gxv_mort_subtable_type4_lookupfmt4_transit(short param_1, short *param_2, ushort *param_3, long *param_4) {
   ushort *puVar1;
   puVar1 = (ushort*)( ( ulong )(ushort)(*param_2 + param_1 * 2) + param_4[7] );
   if (param_3 == (ushort*)0x0) {
      param_3 = *(ushort**)( *param_4 + 0xd0 );
...
void gxv_LookupTable_fmt6_validate(long param_1, ushort *param_2, long *param_3) {
 ...
 while ( puVar7 != puVar9 + (ulong)uVar3 * 2 );
   ...
   LAB_001032e1:if (puVar9 < *(ushort**)( *param_3 + 0xd0 )) {
      do {
...
void gxv_LookupTable_fmt2_validate(long param_1, ushort *param_2, long *param_3) {
   ...
   do {
      ...
      if (( ( uVar1 != 0xffff ) && ( *(long*)( param_3[1] + 0x20 ) < (long)(ulong)uVar4 ) ) && ( 1 < *(uint*)( *param_3 + 0xd8 ) )) {
         ft_validator_error(*param_3, 0x10);
      }
 ...
 while ( puVar8 != local_68 + (ulong)uVar3 * 3 );
   ...
   LAB_0010356d:gxv_LookupTable_fmt2_skip_endmarkers(local_68, sVar2, param_3);
...
void gxv_LookupTable_fmt4_validate(long param_1, ushort *param_2, long *param_3) {
   ...
   do {
      ...
      if (( ( uVar2 != 0xffff ) && ( *(long*)( param_3[1] + 0x20 ) < (long)(ulong)uVar6 ) ) && ( 1 < *(uint*)( *param_3 + 0xd8 ) )) {
         ft_validator_error(*param_3, 0x10);
      }
      ...
      if (uVar1 == 0xffff) {
         uVar13 = 0xffff;
         LAB_00103800:puVar14 = puVar12 + 3;
         puVar5 = param_2;
         if (param_2 == (ushort*)0x0) {
            puVar5 = *(ushort**)( *param_3 + 0xd0 );
         }
 ...
 while ( local_56 != sVar4 );
   LAB_001038aa:gxv_LookupTable_fmt2_skip_endmarkers(puVar14, sVar3, param_3);
...
void gxv_bsln_parts_fmt2_validate(ushort *param_1, ushort *param_2, long *param_3) {
   ...
   if (( ( uVar3 != 0xffff ) && ( *(long*)( param_3[1] + 0x20 ) < (long)(ulong)uVar5 ) ) && ( 1 < *(uint*)( *param_3 + 0xd8 ) )) {
      ft_validator_error(*param_3, 0x10);
   }
...
void gxv_LookupTable_fmt8_validate(ushort *param_1, ushort *param_2, long *param_3) {
   ...
   if (( ( uVar10 != 0xffff ) && ( *(long*)( param_3[1] + 0x20 ) < (long)(ulong)uVar9 ) ) && ( 1 < *(uint*)( *param_3 + 0xd8 ) )) {
      ft_validator_error(*param_3, 0x10);
   }

   if (( ( ( ushort )(uVar9 + uVar7) != 0xffff ) && ( *(long*)( param_3[1] + 0x20 ) < (long)( ulong )(ushort)(uVar9 + uVar7) ) ) && ( 1 < *(uint*)( *param_3 + 0xd8 ) )) {
      ft_validator_error(*param_3, 0x10);
   }
...
void gxv_kern_subtable_fmt2_clstbl_validate(ushort *param_1, ushort *param_2, ulong param_3, long *param_4) {
   undefined8 *puVar1;
   byte bVar2;
   ushort uVar3;
   undefined8 uVar4;
...
void gxv_ClassTable_validate(ushort *param_1, ushort *param_2, ushort param_3, undefined1 *param_4, long *param_5) {
   ushort *puVar1;
   ushort uVar2;
   ushort uVar3;
   ulong uVar4;
   ...
   *param_4 = 3;
   ...
   if (uVar3 != 0) {
      ...
      if (( ( uVar6 != 0xffff ) && ( *(long*)( param_5[1] + 0x20 ) < (long)(ulong)uVar6 ) ) && ( 1 < *(uint*)( *param_5 + 0xd8 ) )) {
      ...
      puVar10 = puVar1;
      do {
         while (puVar9 = (ushort*)( (long)puVar10 + 1 ),(ushort*)( (ulong)uVar2 + (long)param_1 ) < puVar9) {
            ft_validator_error(*param_5, 8);
            bVar11 = ( byte ) * puVar10;
            if (bVar11 != 0) goto LAB_00104039;
            LAB_00104080:uVar6 = uVar6 + 1;
            ft_validator_error(*param_5, 8);
            puVar10 = puVar9;
...
;
         ...
         LAB_00104039:if (( byte )(bVar11 - 2) < 2) goto LAB_00104080;
         if (param_3 <= bVar11) {
            ft_validator_error(*param_5, 8);
         }
...
void gxv_StateTable_validate(ushort *param_1, ushort *param_2, long *param_3) {
   ...
   bVar3 = local_4f;
   if (uVar10 == 0) {
      LAB_001042ca:if (uVar1 == 0) goto LAB_00104418;
 ...
 while ( pbVar9 + iVar15 <= pbVar26 );
   ...
   do {
      ...
      if (( uVar7 < uVar5 ) || ( ( uVar17 & 0xffff ) + uVar18 < (uint)uVar7 )) {
         LAB_00104490:if (1 < *(uint*)( *param_3 + 0xd8 )) {
         ...
         uVar12 = (long)&switchD_001043c9::switchdataD_00107fcc + (long)(int)( &switchD_001043c9::switchdataD_00107fcc )[uVar11];
         switch (uVar11) {
            case 0:
        local_48 = (ulong)local_48._1_7_ << 8;
            default:
switchD_001043c9_caseD_1:
        ...
        local_48 = uVar12;
         ...
         if ((code*)param_3[0xc] != (code*)0x0) {
            ( *(code*)param_3[0xc] )((long)(int)( uVar7 - uVar18 ) / (long)(int)( bVar3 + 1 ) & 0xff, puVar24[1] << 8 | puVar24[1] >> 8, &local_48, param_1, param_2, param_3);
            uVar12 = extraout_RDX;
         }
      ...
      if (puVar6 < puVar20) {
         ...
         do {
            ...
            if (puVar8 < puVar13) {
               ...
               LAB_00104dc5:lVar14 = 4;
            }
 else {
               uVar3 = *puVar7;
               uVar10 = ( ulong )(uVar3 >> 0x18 | ( uVar3 & 0xff0000 ) >> 8 | ( uVar3 & 0xff00 ) << 8 | uVar3 << 0x18);
               if (uVar10 == 0) goto LAB_00104dc5;
               LAB_00104c91:uVar18 = 0;
               puVar8 = puVar13;
               do {
                  puVar9 = param_2;
                  if (param_2 == (uint*)0x0) {
                  ...
                  uVar3 = *puVar8;
                  if (( 0x7f < ( uVar3 >> 0x18 | ( uVar3 & 0xff0000 ) >> 8 | ( uVar3 & 0xff00 ) << 8 | uVar3 << 0x18 ) ) && ( 1 < *(uint*)( lVar16 + 0xd8 ) )) {
                     ft_validator_error(lVar16, 8);
                     lVar16 = *param_3;
                  }
      ...
      *(undefined4*)( param_3 + 4 ) = 0;
      ...
      if (uVar10 != 0) {
         ...
         do {
            ...
            uVar3 = puVar20[1];
            uVar19 = ( ulong )(uVar3 >> 0x18 | ( uVar3 & 0xff0000 ) >> 8 | ( uVar3 & 0xff00 ) << 8 | uVar3 << 0x18);
            if (( 0x7f < ( ushort )(( ushort ) * puVar20 << 8 | ( ushort ) * puVar20 >> 8) ) && ( 1 < *(uint*)( lVar15 + 0xd8 ) )) {
               ft_validator_error(lVar15, 8);
               lVar15 = *param_3;
            }
 ...
 while ( uVar10 != uVar18 );
   ...
   if (uVar1 != 0) {
      ...
      *(undefined4*)( param_3 + 9 ) = 0xffffffff;
      gxv_StateTable_validate(puVar17 + 4, (long)puVar17 + ( ulong )(ushort)(uVar1 << 8 | uVar1 >> 8), param_3);
      uVar10 = (ulong)local_b8[0];
      lVar16 = *(long*)( *param_3 + 200 );
      local_b8[0] = local_b8[0] + 1;
...
void gxv_mort_subtable_type2_validate(long param_1, ulong param_2, long *param_3) {
   ...
   *(undefined4*)( param_3 + 9 ) = 0xffffffff;
   ...
   goto LAB_00105129;
   code_r0x001050c6:uVar2 = *puVar6;
   puVar1 = puVar6 + 1;
   puVar6 = puVar7;
   if (*(long*)( param_3[1] + 0x20 ) < (long)(ulong)CONCAT11(uVar2, *puVar1)) {
      LAB_001050e1:puVar6 = puVar7;
      if (1 < *(uint*)( *param_3 + 0xd8 )) {
         ft_validator_error(*param_3, 0x10);
      }
   ...
   *(undefined4*)( param_3 + 9 ) = 8;
   ...
   if (uVar1 != 0) {
      ...
      do {
         ...
         if (( uVar2 != 0xffff ) && ( ( ( uVar2 < *(ushort*)( param_3 + 8 ) || ( *(ushort*)( (long)param_3 + 0x42 ) < uVar2 ) ) && ( 1 < *(uint*)( *param_3 + 0xd8 ) ) ) )) {
            ft_validator_error(*param_3, 0x10);
         }
...
void gxv_kern_validate_generic(ushort *param_1, long param_2, char param_3, undefined4 param_4, long param_5) {
   undefined8 *puVar1;
   byte bVar2;
   byte bVar3;
   byte bVar4;
   ...
   if (uVar7 < 2) {
      ...
      if (uVar10 != 0) {
         ...
         do {
            ...
            uVar13 = ( ulong )(ushort)(*(ushort*)( (long)puVar24 + 2 ) << 8 | *(ushort*)( (long)puVar24 + 2 ) >> 8);
            if (*local_158 == 1) {
               ...
               if (( uVar14 & 3 ) == 0) {
                  ...
                  puVar24 = puVar24 + 4;
                  LAB_00105aa3:local_19a = 0;
                  local_198[0] = CONCAT22(local_198[0]._2_2_, 6);
                  if (puVar22 < puVar24) {
                     ft_validator_error(local_168, 8);
                  }

                  gxv_BinSrchHeader_validate_constprop_0(puVar23, puVar22, local_198, &local_19a, &local_168, uVar13, uVar10, uVar13);
                  if (local_19a != 0) {
                     ...
                     do {
                        while (true) {
                           ...
                           if (( ( uVar8 != 0xffff ) && ( *(long*)( local_160 + 0x20 ) < (long)(ulong)uVar16 ) ) && ( 1 < *(uint*)( local_168 + 0xd8 ) )) {
                              ft_validator_error(local_168, 0x10);
                           }

                           uVar8 = *(ushort*)( (long)puVar24 + 2 );
                           uVar20 = uVar8 << 8 | uVar8 >> 8;
                           if (( ( uVar8 != 0xffff ) && ( *(long*)( local_160 + 0x20 ) < (long)(ulong)uVar20 ) ) && ( 1 < *(uint*)( local_168 + 0xd8 ) )) {
                              ft_validator_error(local_168, 0x10);
                           }

                           if (uVar14 == uVar16) break;
                           if (uVar16 <= uVar14) {
                              LAB_00105be0:ft_validator_error(local_168, 8);
                              uVar20 = uVar7;
                              uVar16 = uVar14;
                           }
...
;
 ...
 while ( puVar18 != puVar21 );
                     ...
                     puVar24 = puVar18;
                     if (puVar22 < puVar21) {
                        LAB_00105d29:ft_validator_error(local_168, 8);
                     }
...
;
 ...
 while ( (short)uVar12 != sVar15 );
               ...
               if (( uVar5 & 0x8000 ) == 0) {
                  if (( uVar5 & 0x4000 ) != 0) {
                     LAB_0010550e:if (( uVar8 & 0xfdf0 ) == 0) {
                  ...
                  LAB_00105a40:puVar22 = (uint*)( (long)puVar24 + uVar13 );
                  goto LAB_001056c0;
               }
               ...
               if (( uVar7 << 8 & 0xfd00 ) == 0) {
                  ...
                  LAB_00105a80:uVar13 = ( ulong )(uVar9 >> 0x18 | ( uVar9 & 0xff0000 ) >> 8 | ( uVar9 & 0xff00 ) << 8 | uVar9 << 0x18);
                  puVar22 = (uint*)( (long)puVar24 + uVar13 );
                  if (( uVar14 & 3 ) != 0) goto LAB_0010578f;
                  LAB_00105a98:puVar22 = (uint*)( (long)puVar24 + uVar13 );
                  LAB_00105a9c:puVar24 = (uint*)( (long)puVar24 + 0xe );
                  puVar23 = puVar21;
                  goto LAB_00105aa3;
               }
               ...
               LAB_00105522:uVar9 = *local_158;
               puVar22 = (uint*)( (long)puVar24 + uVar13 );
               LAB_0010552b:puVar23 = (uint*)( (long)puVar24 + 0xe );
               if (uVar9 == 1) {
                  puVar21 = puVar24 + 2;
                  puVar23 = puVar24 + 4;
               }
               ...
               *puVar6 = ( ushort ) * puVar21 << 8 | ( ushort ) * puVar21 >> 8;
               uVar9 = puVar21[1];
               uVar17 = ( ulong )(ushort)(*(ushort*)( (long)puVar21 + 2 ) << 8 | *(ushort*)( (long)puVar21 + 2 ) >> 8);
               ...
               if (puVar22 < (uint*)( (long)puVar23 + uVar17 )) {
                  ...
                  LAB_001055e5:uVar7 = *(ushort*)( *(long*)( local_158 + 2 ) + 2 );
               }
 else {
                  if (puVar21 <= puVar22) goto LAB_001055e5;
                  LAB_00105e34:ft_validator_error(local_168, 8);
               ...
               gxv_kern_subtable_fmt2_clstbl_validate((byte*)( (long)puVar24 + uVar17 ), puVar22, 0, &local_168);
               gxv_kern_subtable_fmt2_clstbl_validate((byte*)( (long)puVar24 + uVar12 ), puVar22, 1, &local_168);
            ...
            LAB_001056c0:local_1b8 = local_1b8 + 1;
            puVar24 = puVar22;
            local_150 = uVar13;
         }
...
int gxv_validate(long param_1, ulong param_2, undefined8 *param_3, uint param_4) {
   ...
   if (( ( param_2 & 0x4000 ) == 0 ) || ( iVar5 = iVar5 == 0 )) {
      if (param_4 < 4) {
         if (param_4 != 1) {
            if (( param_2 & 0x8000 ) == 0) {
               if (param_4 != 2) {
                  LAB_001061be:if (( param_2 & 0x10000 ) != 0) goto LAB_00107120;
               }

            }
 else {
               LAB_00106ad0:iVar5 = gxv_load_table(param_1, 0x6d6f7274, &local_920, &local_918);
         ...
         LAB_001061d0:if (local_960 != (int*)0x0) {
               ...
               if (uVar4 != 0) {
                  ...
                  do {
                     ...
                     if (( uVar22 < 0x68 ) && ( gxv_feat_registry[(ulong)uVar22 * 4] != '\0' )) {
                        ...
                        if (( (byte)gxv_feat_registry[(long)(int)(uint)uVar22 * 4 + 3] != uVar10 ) && ( local_50 != 0 )) {
                           ft_validator_error(&local_128, 8);
                        }

                        if (( gxv_feat_registry[(long)(int)(uint)uVar22 * 4 + 2] != (char)-((char)uVar11 >> 7) ) && ( local_50 != 0 )) {
                           LAB_00106f20:ft_validator_error(&local_128, 8);
                        }
                     ...
                     uVar20 = 0;
                     uVar23 = 0xffffffff;
                     gxv_sfntName_validate(*(ushort*)( (long)puVar24 + 10 ) << 8 | *(ushort*)( (long)puVar24 + 10 ) >> 8, 0xff, 0x8000, &local_878);
                     ...
                     if (uVar12 != 0) {
                        do {
                           while (true) {
                              ...
                              gxv_sfntName_validate(*(ushort*)( (long)puVar24 + 2 ) << 8 | *(ushort*)( (long)puVar24 + 2 ) >> 8, 0xff, 0x8000, &local_878);
                              puVar24 = puVar13;
                              local_8b2 = uVar11;
...
;
 ...
 while ( uVar20 < uVar10 );
                     ...
                     LAB_00106e70:uVar23 = (uint)local_8b4;
 ...
 while ( puVar15 != (uint*)( piVar14 + ( ulong )(uVar4 - 1) * 3 + 6 ) );
               ...
               if (( uVar4 >> 8 & 3 ) == 0) {
                  if (( uVar2 & 3 ) == 0) {
                     if (sVar19 != 0 || uVar11 != 0) {
                        LAB_00107c73:ft_validator_error(&local_128, 8);
                     }
                  ...
                  LAB_001076a0:ft_validator_error(&local_128, 9);
                  if (sVar19 != 0 || uVar11 != 0) {
                     ft_validator_error(&local_128, 8);
                  }

                  if (uVar4 != 0) goto LAB_00107bfd;
                  LAB_001076db:lVar18 = ( ulong )(ushort)(uVar12 << 8 | uVar2) + (long)piVar14;
                  ...
                  LAB_00107bfd:lVar18 = ( ulong )(ushort)(uVar4 << 8 | uVar4 >> 8) + (long)piVar14;
                  gxv_trak_trackData_validate(lVar18, puVar24, &local_718);
                  local_1b8[0] = "horizJustData";
                  local_898[0] = 1;
                  local_1c8[0] = lVar18;
                  LAB_0010694c:if (uVar12 != 0) goto LAB_001076db;
               }
         ...
         if (local_920 != (int*)0x0) {
            ...
            if (iVar5 == 0) {
               ...
               uVar23 = piVar14[1];
               uVar8 = ( ulong )(uVar23 >> 0x18 | ( uVar23 & 0xff0000 ) >> 8 | ( uVar23 & 0xff00 ) << 8 | uVar23 << 0x18);
               if (*piVar14 != 0x100) {
               ...
               if (uVar8 != 0) {
                  ...
                  while (true) {
                     ...
                     uVar12 = 0;
                     puVar9 = puVar15 + 2;
                     uVar6 = ( ulong )(uVar23 >> 0x18 | ( uVar23 & 0xff0000 ) >> 8 | ( uVar23 & 0xff00 ) << 8 | uVar23 << 0x18);
                     puVar15 = (uint*)( (long)puVar15 + uVar6 );
                     gxv_mort_featurearray_validate(puVar13, puVar15, ( ushort ) * puVar9 << 8 | ( ushort ) * puVar9 >> 8, &local_5b8);
                     ...
                     if (uVar4 != 0) {
                        do {
                           ...
                           puVar13 = (uint*)( (long)puVar9 + ( ulong )(( ushort )(( ushort ) * puVar13 << 8 | ( ushort ) * puVar13 >> 8) - 8) );
                           if (puVar15 < puVar13) {
                              ft_validator_error(local_5b8, 8);
                           }
...
;
            ...
            if (iVar5 == 0) {
               ...
               if (uVar8 != 0) {
                  do {
                     ...
                     gxv_mort_featurearray_validate(puVar15, 0, uVar7 >> 0x18 | ( uVar7 & 0xff0000 ) >> 8 | ( uVar7 & 0xff00 ) << 8 | uVar7 << 0x18, &local_508);
                     ...
                     if (sVar19 != 0) {
                        do {
                           ...
                           puVar15 = (uint*)( (long)puVar15 + ( ulong )(uVar23 >> 0x18 | ( uVar23 & 0xff0000 ) >> 8 | ( uVar23 & 0xff00 ) << 8 | uVar23 << 0x18) );
                           if (puVar24 < puVar15) {
                              ft_validator_error(local_508, 8);
                           }
 ...
 while ( uVar8 != uVar16 );
         ...
         if (( ( ( ( ( ( param_4 != 0 ) && ( *param_3 = local_960 ),param_4 != 1 ) ) && ( param_3[1] = local_920 ),param_4 != 2 ) ) && ( ( param_3[2] = local_910 ),param_4 != 3 && ( param_3[3] = param_4 != 4 ) ) )) &&( ( param_3[4] = local_930 ),param_4 != 5 && ( ( param_3[5] = local_900 ),param_4 != 6 && ( param_3[6] = param_4 != 7 ) ) ) && ( param_3[7] = param_4 != 8 ) && ( param_3[8] = param_4 != 9 )) {
        param_3[9] = local_8d0;
      }
   ...
   if (( ( param_2 & 0x20000 ) == 0 ) || ( iVar5 = iVar5 == 0 )) {
      if (param_4 < 8) {
         if (param_4 == 4) {
 ...
 else if (( ( param_2 & 0x200000 ) != 0 ) && ( iVar5 = iVar5 != 0 )) goto LAB_001066f0;
      if (( ( param_2 & 0x40000 ) == 0 ) || ( iVar5 = iVar5 == 0 )) {
         if (( param_2 & 0x8000 ) != 0) goto LAB_00106ad0;
         LAB_0010665b:if (( param_2 & 0x10000 ) != 0) {
            LAB_00107120:iVar5 = gxv_load_table(param_1, 0x6d6f7278, &local_910, &local_908);
            if (iVar5 != 0) goto LAB_001066f0;
         }

         if (( param_4 < 6 ) || ( ( ( ( param_2 & 0x80000 ) == 0 || ( iVar5 = gxv_load_table(param_1, 0x6b65726e, &local_900, &local_8f8) ),iVar5 == 0 ) ) && ( ( param_4 == 6 || ( ( ( ( param_2 & 0x100000 ) == 0 || ( iVar5 = gxv_load_table(param_1, 0x6f706264, &local_8f0, &local_8e8) ),iVar5 == 0 ) ) && ( ( param_4 < 9 || ( ( ( ( param_2 & 0x400000 ) == 0 || ( iVar5 = gxv_load_table(param_1, 0x70726f70, &local_8e0, &local_8d8) ),iVar5 == 0 ) ) && ( ( param_4 == 9 || ( ( ( param_2 & 0x800000 ) == 0 || ( iVar5 = gxv_load_table(param_1, 0x6c636172, &local_8d0, &local_8c8) ),iVar5 == 0 ) ) ) ) ) ) ) ) ) ) )) goto LAB_001061d0;
      }

   }

}
LAB_001066f0:ft_mem_free(local_968, local_960);local_960 = (int*)0x0;ft_mem_free(local_968, local_950);local_950 = (int*)0x0;ft_mem_free(local_968, local_940);local_940 = (int*)0x0;ft_mem_free(local_968, local_930);local_930 = (int*)0x0;ft_mem_free(local_968, local_920);local_920 = (int*)0x0;ft_mem_free(local_968, local_910);local_910 = (int*)0x0;ft_mem_free(local_968, local_900);local_900 = 0;ft_mem_free(local_968, local_8f0);local_8f0 = (int*)0x0;ft_mem_free(local_968, local_8e0);local_8e0 = (uint*)0x0;ft_mem_free(local_968, local_8d0);local_8d0 = (int*)0x0;LAB_0010683a:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return iVar5;
}

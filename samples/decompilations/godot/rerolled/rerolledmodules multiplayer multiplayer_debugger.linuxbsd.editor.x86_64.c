...
/* MultiplayerDebugger::initialize() */void MultiplayerDebugger::initialize(void) {
   ...
   *(undefined8*)( pRVar5 + 0x200 ) = 0;
   ...
   if (local_60 == 0) {
      ...
      if (( pOVar6 == (Object*)0x0 ) || ( cVar4 = cVar4 == '\0' )) goto joined_r0x00100fe8;
...
/* MultiplayerDebugger::BandwidthProfiler::bandwidth_usage(Vector<MultiplayerDebugger::BandwidthProfiler::BandwidthFrame>
   const&, int) */undefined1  [16] __thiscallMultiplayerDebugger::BandwidthProfiler::bandwidth_usage(BandwidthProfiler *this, Vector *param_1, int param_2) {
   uint *puVar1;
   uint uVar2;
   long lVar3;
   long lVar4;
...
/* EngineProfiler::_initialize_classv() */void EngineProfiler::_initialize_classv(void) {
   ...
   '\x01';
   LAB_00104e5b:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<ObjectID, MultiplayerDebugger::SyncInfo, HashMapHasherDefault,
   HashMapComparatorDefault<ObjectID>, DefaultTypedAllocator<HashMapElement<ObjectID,
   MultiplayerDebugger::SyncInfo> > >::operator[](ObjectID const&) */undefined1[16];HashMap<ObjectID,MultiplayerDebugger::SyncInfo,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,MultiplayerDebugger::SyncInfo>>>::operator [](HashMap<ObjectID,MultiplayerDebugger::SyncInfo,HashMapHasherDefault,HashMapComparatorDefault<ObjectID>,DefaultTypedAllocator<HashMapElement<ObjectID,MultiplayerDebugger::SyncInfo>>>
...

{
  ...
  undefined1 auVar58[16](ulong)(local_b0 = = (void*)0x0) {
   uVar39 = uVar55 * 4;
   uVar38 = uVar55 * 8;
...
uVar40 = *(undefined8*)param_1;pauVar41 = (undefined1(*) [16])operator_new(0x40, "");*pauVar41 = (undefined1[16])0x0;*(undefined1(*) [16])( pauVar41[1] + 8 ) = (undefined1[16])0x0;*(undefined8*)pauVar41[1] = uVar40;puVar2 = *(undefined8**)( this + 0x20 );*(undefined8*)( pauVar41[2] + 8 ) = 0;pauVar41[3] = (undefined1[16])0x0;if (puVar2 == (undefined8*)0x0) {
...
uVar50 = 0;lVar52 = *(long*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( this + 0x28 ) * 8 );uVar53 = (uint)uVar55;uVar47 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );uVar39 = CONCAT44(0, uVar47);auVar12._8_8_ = 0;auVar12._0_8_ = uVar55 * lVar52;auVar28._8_8_ = 0;auVar28._0_8_ = uVar39;lStack_d0 = SUB168(auVar12 * auVar28, 8);lVar46 = *(long*)( this + 8 );puVar1 = (uint*)( lVar56 + lStack_d0 * 4 );iVar42 = SUB164(auVar12 * auVar28, 8);uVar43 = *puVar1;pauVar36 = pauVar41;while (uVar43 != 0) {
   auVar13._8_8_ = 0;
...
;*(undefined1(**) [16])( lVar46 + lStack_d0 * 8 ) = pauVar36;*puVar1 = uVar53;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_00105dbb:auVar58._0_8_ = pauVar41[1] + 8;auVar58._8_8_ = lStack_d0;return auVar58;}/* CowData<MultiplayerDebugger::BandwidthProfiler::BandwidthFrame>::_realloc(long) */undefined8 CowData<MultiplayerDebugger::BandwidthProfiler::BandwidthFrame>::_realloc(CowData<MultiplayerDebugger::BandwidthProfiler::BandwidthFrame> *this, long param_1) {
   undefined8 *puVar1;

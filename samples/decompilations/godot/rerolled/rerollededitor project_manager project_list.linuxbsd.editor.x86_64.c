...
local_58 = Control::get_theme_color
                           (pSVar7,(StringName *)
                                   &_notification(int)::{lambda()#14Control::get_size();fVar11 = _LC13 + extraout_XMM0_Db;uVar10 = Control::get_size();local_68 = CONCAT44(fVar11, uVar10);Control::get_size();local_5c = extraout_XMM0_Db_00 + _LC13;local_60 = 0;CanvasItem::draw_line((Vector2*)pSVar7, (Vector2*)&local_60, (Color*)&local_68, _LC101, (bool)uVar6);}
    elseif (in_ESI == 0x29) {
...
Control::begin_bulk_theme_override();pSVar1 = *(StringName**)( pSVar7 + 0xa30 );if (_notification(int)::{lambda()#2iVar5 = __cxa_guard_acquire(&_notification(int)::{lambda()#2if (iVar5 != 0) {
   _scs_create((char *)&_notification(int)::{lambda()
   #2
   ...
   if (iVar5 != 0) {
      _scs_create((char *)&_notification(int)::{lambda()
      #3
      __cxa_atexit(StringName::~StringName, &_notification(int)::{lambda()#3}::operator()()::sname,&__dso_handle);__cxa_guard_release(&_notification(int)::{lambda()#3}, ::operator()(), ::sname);}(pSVar7, (StringName*)&_notification(int)::{lambda()#3}, ::operator()(), ::sname), ;
...
;
         ...
         if (iVar4 == 0) {
            ...
            local_150 = uVar7;
            if (( cVar2 != '\0' ) && ( local_150 = local_150 <= uVar7 )) {
               local_150 = uVar7;
            }
      ...
      void CowData<ProjectList::Item>::_copy_on_write(CowData<ProjectList::Item> *this) {
         Item *this_00;
         long lVar1;
         code *pcVar2;
         undefined8 *puVar3;
 ...
 while ( lVar1 != lVar7 );
      ...
      void ProjectList::_load_project_icon(ProjectList *this, int param_1) {
         code *pcVar1;
         String *pSVar2;
         char cVar3;
         int iVar4;
         ...
         if (lVar9 < 0) {
            ...
            if ((_load_project_icon(int)::{lambda()
            #1
            (iVar4 = __cxa_guard_acquire(&_load_project_icon(int)::{lambda()
            #1
            iVar4 != 0))
            {
               _scs_create((char *)&_load_project_icon(int)::{lambda()
               #1
               __cxa_atexit(StringName::~StringName,
                   &_load_project_icon(int)::{lambda()
               #1
               __cxa_guard_release(&_load_project_icon(int)::{lambda()
               #1
            }
            ...
            if (( *(long*)( lVar8 + 0x38 ) != 0 ) && ( 1 < *(uint*)( *(long*)( lVar8 + 0x38 ) + -8 ) )) {
               ...
               if (iVar4 == 0) {
                  ...
                  if (local_50 == (Object*)0x0) {
                     ...
                     if (local_70 != pOVar7) {
                        local_48 = local_70;
                        local_70 = pOVar7;
                        if (( pOVar7 != (Object*)0x0 ) && ( cVar3 = cVar3 == '\0' )) {
                           local_70 = (Object*)0x0;
                        }

                        LAB_00106d42:Ref<Texture2D>::unref((Ref<Texture2D>*)&local_48);
               ...
               LAB_00106d68:if (( local_68 != (String*)0x0 ) && ( cVar3 = cVar3 != '\0' )) {
            ...
            LAB_00106b90:ProjectListItemControl::set_project_icon(*(Ref**)( lVar8 + 0x68 ));
            if (( ( local_70 != (Object*)0x0 ) && ( cVar3 = RefCounted::unreference() ),pOVar7 = local_70,cVar3 != '\0' )) &&( cVar3 = cVar3 != '\0' )(**(code**)( *(long*)pOVar7 + 0x140 ))(pOVar7);
            Memory::free_static(pOVar7, false);
         }
   ...
   lVar8 = 0;
   LAB_00106e59:_err_print_index_error("operator[]", "./core/templates/vector.h", 0x38, lVar9, lVar8, "p_index", "((Vector<T> *)(this))->_cowdata.size()", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
...
/* ProjectList::_select_project_nocheck(int) */void ProjectList::_select_project_nocheck(ProjectList *this, int param_1) {
   code *pcVar1;
   long lVar2;
   long lVar3;
   long in_FS_OFFSET;
...
/* ProjectList::_toggle_project(int) */void ProjectList::_toggle_project(ProjectList *this, int param_1) {
   code *pcVar1;
   char cVar2;
   long lVar3;
   long lVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ProjectList::_create_project_item_control(int) */void ProjectList::_create_project_item_control(ProjectList *this, int param_1) {
   code *pcVar1;
   bool bVar2;
   int iVar3;
   ...
   if (lVar7 < 0) {
      ...
      if (pCVar8[0x62] == (CowData)0x0) {
         ...
         LAB_00107859:local_58 = CONCAT44(_UNK_0011b574, _LC13);
      ...
      *(ProjectListItemControl**)( pCVar8 + 0x68 ) = this_00;
      ...
      LAB_00107948:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }
...
/* ProjectList::set_project_version(String const&, int) */void ProjectList::set_project_version(ProjectList *this, String *param_1, int param_2) {
   char cVar1;
   long lVar2;
   long lVar3;
   CowData<ProjectList::Item>::_copy_on_write((CowData<ProjectList::Item>*)( this + 0xc28 ));
...
/* ProjectList::erase_selected_projects(bool) */void ProjectList::erase_selected_projects(bool param_1) {
   uint uVar1;
   long lVar2;
   Object *pOVar3;
      ...
      do {
         ...
         if (( *(long*)( this + 0xc48 ) == 0 ) || ( *(int*)( this + 0xc6c ) == 0 )) {
            ...
            if (uVar14 != 0) {
               do {
                  if (uVar16 == uVar14) {
                     cVar13 = String::operator ==((String*)( *(long*)( this + 0xc48 ) + ( ulong ) * (uint*)( *(long*)( this + 0xc50 ) + lVar18 * 4 ) * 8 ), (String*)( lVar15 + 0x30 ));
                     if (cVar13 != '\0') {
                  ...
                  if (( uVar14 == 0 ) || ( auVar6._8_8_ = 0 ),auVar6._0_8_ = (ulong)uVar14 * lVar2,auVar10._8_8_ = 0,auVar10._0_8_ = uVar12,auVar7._8_8_ = 0,auVar7._0_8_ = ( ulong )(( uVar1 + iVar17 ) - SUB164(auVar6 * auVar10, 8)) * lVar2,auVar11._8_8_ = 0,auVar11._0_8_ = uVar12,SUB164(auVar7 * auVar11, 8) < uVar21) break;
               }
 while ( true );
            }
...
/* ProjectList::get_selected_projects() const */long ProjectList::get_selected_projects(void) {
   uint uVar1;
               ...
               do {
                  if (uVar17 == uVar13) {
                     ...
                     if (cVar12 != '\0') {
                        ...
                        LAB_00108027:_err_print_index_error("operator[]", "./core/templates/vector.h", 0x38, lVar20, lVar15, "p_index", "((Vector<T> *)(this))->_cowdata.size()", "", false, true);
                        _err_flush_stdout();
                        /* WARNING: Does not return */
 ...
 while ( ( uVar13 != 0 ) && ( auVar4._8_8_ = 0 ),auVar4._0_8_ = (ulong)uVar13 * lVar15,auVar8._8_8_ = 0,auVar8._0_8_ = uVar11,auVar5._8_8_ = 0,auVar5._0_8_ = ( ulong )(( uVar1 + iVar18 ) - SUB164(auVar4 * auVar8, 8)) * lVar15,auVar9._8_8_ = 0,auVar9._0_8_ = uVar11,uVar21 <= SUB164(auVar5 * auVar9, 8) );
            }
...
;
         LAB_00107fa0:lVar16 = lVar16 + 1;
      }
 while ( lVar15 != 0 );
      LAB_00107fad:lVar16 = (long)local_4c;
      lVar15 = *(long*)( in_RDI + 8 );
      if (lVar15 == 0) {
         lVar15 = 0;
         goto LAB_00107fc8;
   ...
   lVar15 = *(long*)( lVar15 + -8 );
   LAB_00107fc8:if (lVar16 != lVar15) {
      _err_print_error("get_selected_projects", "editor/project_manager/project_list.cpp", 0x424, "Condition \"j != items.size()\" is true. Returning: items", 0, 0);
   }

   return in_RDI;
}
/* ProjectList::_clear_project_selection() */void ProjectList::_clear_project_selection(ProjectList *this) {
   long *plVar1;
   long *plVar2;
   long lVar3;
   long lVar4;
...
;
      ...
      memset(*(void**)( this + 0xc60 ), 0, ( ulong ) * (uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0xc68 ) * 4 ) * 4);
      if (*(int*)( this + 0xc6c ) != 0) goto LAB_0010810c;
   }

   *(undefined4*)( this + 0xc6c ) = 0;
   LAB_00108156:if (( local_30[0] != 0 ) && ( lVar4 = 0 ),0 < *(long*)( local_30[0] + -8 )) {
      do {
         lVar3 = lVar4 + 1;
...
/* ProjectList::_select_project_range(int, int) */void ProjectList::_select_project_range(ProjectList *this, int param_1, int param_2) {
   int iVar1;
   int iVar2;
...
/* ProjectList::select_project(int) */void ProjectList::select_project(ProjectList *this, int param_1) {
   _clear_project_selection(this);
   _select_project_nocheck(this, param_1);
   return;
}
/* ProjectList::_list_item_input(Ref<InputEvent> const&, Node*) */void ProjectList::_list_item_input(ProjectList *this, Ref *param_1, Node *param_2) {
   long lVar1;
   code *pcVar2;
   char cVar3;
   int iVar4;
   ...
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
   if (( ( pOVar5 != (Object*)0x0 ) && ( pOVar5 = (Object*)__dynamic_cast(pOVar5, &Object::typeinfo, &InputEventMouseButton::typeinfo, 0) ),pOVar5 != (Object*)0x0 )) {
      pOVar5 = (Object*)0x0;
   }

   if (*(long*)( param_2 + 400 ) == 0) {
      LAB_00108398:iVar8 = *(int*)( param_2 + 0x22c );
      LAB_001082f5:lVar7 = (long)iVar8;
      ...
      if (lVar6 != 0) {
         ...
         if (lVar7 < lVar9) {
            if (pOVar5 != (Object*)0x0) {
               ...
               if (( cVar3 != '\0' ) && ( iVar4 = iVar4 == 1 )) {
                  lVar6 = lVar6 + lVar7 * 0x70;
                  cVar3 = InputEventWithModifiers::is_shift_pressed();
                  if (( ( cVar3 != '\0' ) && ( ( *(int*)( this + 0xc6c ) != 0 && ( *(long*)( this + 0xc70 ) != 0 ) ) ) ) && ( 1 < *(uint*)( *(long*)( this + 0xc70 ) + -8 ) )) {
                     ...
                     if (cVar3 != '\0') {
                        ...
                        while (true) {
                           ...
                           cVar3 = String::operator ==((String*)( lVar6 + lVar7 + 0x30 ), (String*)( this + 0xc70 ));
                           if (cVar3 != '\0') break;
                           lVar6 = *(long*)( this + 0xc28 );
                           lVar9 = lVar9 + 1;
                           lVar7 = lVar7 + 0x70;
...
;
                        ...
                        if (*(long*)( lVar6 + 400 ) == 0) {
                           LAB_0010873b:iVar4 = *(int*)( lVar6 + 0x22c );
                        }
 else {
                           ...
                           if (iVar4 == 2) {
                              iVar4 = *(int*)( *(long*)( lVar6 + 400 ) + 0x228 ) + *(int*)( *(long*)( lVar6 + 400 ) + 0x220 ) + *(int*)( lVar6 + 0x22c );
                           }
 else {
                        ...
                        LAB_00108651:_err_print_error("_list_item_input", "editor/project_manager/project_list.cpp", 0x3a8, "FATAL: Condition \"anchor_index == -1\" is true.", 0, 0);
                        _err_flush_stdout();
                        /* WARNING: Does not return */
                        pcVar2 = (code*)invalidInstructionException();
                        ( *pcVar2 )();
            ...
            if ((_list_item_input(Ref<InputEvent>const&,Node*)::{lambda()#1}::operator()()::sname ==
               ...
               (iVar8 = __cxa_guard_acquire(&_list_item_input(Ref<InputEvent>const&,Node*)::
                  ...
                  __cxa_atexit(StringName::~StringName, &_list_item_input(Ref < InputEvent > const & Node * ::operator ()(), ::sname, &__dso_handle));
               ...
               if (( ( cVar3 == '\0' ) && ( cVar3 = InputEventMouseButton::is_double_click() ),cVar3 != '\0' )) {
                  if ((_list_item_input(Ref<InputEvent>const&,Node*)::{lambda()
                  #2
                  == '\0') &&
                 (iVar8 = __cxa_guard_acquire(&_list_item_input(Ref<InputEvent>const&,Node*)::
                                               {lambda()
...
lVar9 = 0;LAB_001083c4:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar7, lVar9, "p_index", "size()", "", false, true);_err_flush_stdout();/* WARNING: Does not return */pcVar2 = (code*)invalidInstructionException();( *pcVar2 )();}/* ProjectList::select_first_visible_project() */void ProjectList::select_first_visible_project(ProjectList *this) {
   long lVar1;
   char cVar2;
   long lVar3;
   _clear_project_selection(this);
...
;
   ...
   *(undefined4*)( this + 0xc30 ) = 0;
   ...
   ( iVar5 = __cxa_guard_acquire(&update_project_list()::{lambda()#1}::operator()()::sname),
     iVar5 != 0) );
   {
      _scs_create((char *)&update_project_list()::{lambda()
      #1
      SUB81(SIGNAL_LIST_CHANGED, 0);
      __cxa_atexit(StringName::~StringName, &update_project_list()::, {
            lambda()
            #1
            &__dso_handle;
            __cxa_guard_release(&update_project_list()::{lambda()#1}::operator()()::sname);
  }, ( **(code**)( *(long*)this + 0xd0 ) )(this, &update_project_list()::, {
                     lambda()
                     #1
                     if (Variant::needs_deinit[0] != '\0') {
                        Variant::_clear_internal();
...
, /* ProjectList::_scan_finished() */, void __thiscall ProjectList::_scan_finished(ProjectList *this) * this_00);
            String *pSVar1;
            void *pvVar2;
            ...
            if (( *(long**)( (long)pvVar2 + 0x18 ) != (long*)0x0 ) && ( pSVar1 = (String*)**(long**)( (long)pvVar2 + 0x18 ) ),pSVar1 != (String*)0x0) {
               do {
...
, /* ProjectList::_notification(int) [clone .part.0] */, void ProjectList::_notification(int param_1);
      {
         code *pcVar1;
         long lVar2;
         undefined4 in_register_0000003c;
         ...
         if (*(long*)( this + 0xc28 ) == 0) {
            ...
            if (lVar2 < lVar3) {
               ...
               LAB_0010ab13:_err_print_index_error("operator[]", "./core/templates/vector.h", 0x38, lVar2, lVar3, "p_index", "((Vector<T> *)(this))->_cowdata.size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
               pcVar1 = (code*)invalidInstructionException();
               ( *pcVar1 )();
         ...
         if (( ( *(long*)( this + 0xc80 ) == 0 ) || ( *(char*)( *(long*)( this + 0xc80 ) + 0x20 ) == '\0' ) ) && ( Node::set_process(SUB41(param_1, 0)),*(long*)( this + 0xc80 ) != 0 )) {
            _scan_finished(this);
            return;
         }
      ...
      void ProjectList::_notification(ProjectList *this, int param_1) {
         if (param_1 != 0x11) {
            return;
         }
      ...
      ulong ProjectList::refresh_project(ProjectList *this, String *param_1) {
         long lVar1;
         char cVar2;
         bool bVar3;
         char cVar4;
...
;
      ...
      uint ConfigFile::is_class_ptr(ConfigFile *this, void *param_1) {
      ...
      void CallableCustomMethodPointer<ProjectList,void,Variant_const&>::~CallableCustomMethodPointer(CallableCustomMethodPointer<ProjectList,void,Variant_const&> *this) {
         return;
      }

      /* CallableCustomMethodPointer<ProjectList, void, Node*>::~CallableCustomMethodPointer() */
      void CallableCustomMethodPointer<ProjectList,void,Node*>::~CallableCustomMethodPointer(CallableCustomMethodPointer<ProjectList,void,Node*> *this) {
         return;
      }

      /* CallableCustomMethodPointer<ProjectList, void, Ref<InputEvent> const&,
   Node*>::~CallableCustomMethodPointer() */
      void CallableCustomMethodPointer<ProjectList,void,Ref<InputEvent>const&,Node*>::~CallableCustomMethodPointer(CallableCustomMethodPointer<ProjectList,void,Ref<InputEvent>const&,Node*> *this) {
         return;
      }

      /* CallableCustomMethodPointer<ProjectList, void>::~CallableCustomMethodPointer() */
      void CallableCustomMethodPointer<ProjectList,void>::~CallableCustomMethodPointer(CallableCustomMethodPointer<ProjectList,void> *this) {
         return;
      }

      /* CallableCustomMethodPointer<ProjectListItemControl, void>::~CallableCustomMethodPointer() */
      void CallableCustomMethodPointer<ProjectListItemControl,void>::~CallableCustomMethodPointer(CallableCustomMethodPointer<ProjectListItemControl,void> *this) {
         return;
      }

      /* CallableCustomMethodPointer<ProjectList, void, String const&>::~CallableCustomMethodPointer() */
      void CallableCustomMethodPointer<ProjectList,void,String_const&>::~CallableCustomMethodPointer(CallableCustomMethodPointer<ProjectList,void,String_const&> *this) {
         return;
      }
    ...
    */
      ...
      undefined8 CallableCustomMethodPointer<ProjectList,void,Node*>::get_argument_count(CallableCustomMethodPointer<ProjectList,void,Node*> *this, bool *param_1) {
         *param_1 = true;
         return 1;
      }
   ...
   Node*>::get_argument_count(bool&) const */
      undefined8 CallableCustomMethodPointer<ProjectList,void,Ref<InputEvent>const&,Node*>::get_argument_count(CallableCustomMethodPointer<ProjectList,void,Ref<InputEvent>const&,Node*> *this, bool *param_1) {
         *param_1 = true;
         return 2;
      }

      /* CallableCustomMethodPointer<ProjectList, void>::get_argument_count(bool&) const */
      undefined8 CallableCustomMethodPointer<ProjectList,void>::get_argument_count(CallableCustomMethodPointer<ProjectList,void> *this, bool *param_1) {
         *param_1 = true;
         return 0;
      }

      /* CallableCustomMethodPointer<ProjectListItemControl, void>::get_argument_count(bool&) const */
      undefined8 CallableCustomMethodPointer<ProjectListItemControl,void>::get_argument_count(CallableCustomMethodPointer<ProjectListItemControl,void> *this, bool *param_1) {
         *param_1 = true;
         return 0;
      }

      /* CallableCustomMethodPointer<ProjectList, void, String const&>::get_argument_count(bool&) const */
      undefined8 CallableCustomMethodPointer<ProjectList,void,String_const&>::get_argument_count(CallableCustomMethodPointer<ProjectList,void,String_const&> *this, bool *param_1) {
         *param_1 = true;
         return 1;
      }
   ...
   Node*>::~CallableCustomMethodPointer() */
      ...
      undefined8 CallableCustomMethodPointer<ProjectList,void>::get_object(CallableCustomMethodPointer<ProjectList,void> *this) {
         long lVar1;
         undefined8 uVar2;
         uint uVar3;
         ulong *puVar4;
...
;
      ...
      undefined8 CallableCustomMethodPointer<ProjectList,void,Variant_const&>::get_object(CallableCustomMethodPointer<ProjectList,void,Variant_const&> *this) {
         long lVar1;
         undefined8 uVar2;
         uint uVar3;
         ulong *puVar4;
...
;
      ...
      undefined8 CallableCustomMethodPointer<ProjectList,void,String_const&>::get_object(CallableCustomMethodPointer<ProjectList,void,String_const&> *this) {
         long lVar1;
         undefined8 uVar2;
         uint uVar3;
         ulong *puVar4;
...
;
      ...
      undefined8 CallableCustomMethodPointer<ProjectList,void,Node*>::get_object(CallableCustomMethodPointer<ProjectList,void,Node*> *this) {
         long lVar1;
         undefined8 uVar2;
         uint uVar3;
         ulong *puVar4;
...
;
      ...
      undefined8 CallableCustomMethodPointer<ProjectListItemControl,void>::get_object(CallableCustomMethodPointer<ProjectListItemControl,void> *this) {
         long lVar1;
         undefined8 uVar2;
         uint uVar3;
         ulong *puVar4;
...
;
   ...
   const*, void (ProjectList::*)(String const&)) */
      ProjectList *create_custom_callable_function_pointer<ProjectList,String_const&>(ProjectList *param_1, char *param_2, _func_void_String_ptr *param_3) {
         undefined8 uVar1;
         CallableCustom *this;
         undefined8 in_RCX;
         undefined8 in_R8;
   ...
   char const*, void (ProjectListItemControl::*)()) */
      ProjectListItemControl *create_custom_callable_function_pointer<ProjectListItemControl>(ProjectListItemControl *param_1, char *param_2, _func_void *param_3) {
         undefined8 uVar1;
         CallableCustom *this;
         undefined8 in_RCX;
         undefined8 in_R8;
   ...
   (ProjectList::*)()) */
      ProjectList *create_custom_callable_function_pointer<ProjectList>(ProjectList *param_1, char *param_2, _func_void *param_3) {
         undefined8 uVar1;
         CallableCustom *this;
         undefined8 in_RCX;
         undefined8 in_R8;
   ...
   const*, void (ProjectList::*)(Variant const&)) */
      ProjectList *create_custom_callable_function_pointer<ProjectList,Variant_const&>(ProjectList *param_1, char *param_2, _func_void_Variant_ptr *param_3) {
         undefined8 uVar1;
         CallableCustom *this;
         undefined8 in_RCX;
         undefined8 in_R8;
      ...
      undefined4 OS::create_instance(OS *this, List *param_1, long *param_2) {
         code *pcVar1;
         undefined4 uVar2;
         long in_FS_OFFSET;
 ...
 while ( (int)plVar3[2] != 0 );
   ...
   Callable::CallError&) const */
      void CallableCustomMethodPointer<ProjectList,void>::call(CallableCustomMethodPointer<ProjectList,void> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
         long lVar1;
         long lVar2;
         uint uVar3;
         ulong *puVar4;
...
;
   ...
   Callable::CallError&) const */
      void CallableCustomMethodPointer<ProjectListItemControl,void>::call(CallableCustomMethodPointer<ProjectListItemControl,void> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
         long lVar1;
         long lVar2;
         uint uVar3;
         ulong *puVar4;
...
;
   ...
   Variant&, Callable::CallError&) const */
      void CallableCustomMethodPointer<ProjectList,void,Variant_const&>::call(CallableCustomMethodPointer<ProjectList,void,Variant_const&> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
         long lVar1;
         long lVar2;
         char cVar3;
         uint uVar4;
...
;
   ...
   Callable::CallError&) const */
      void CallableCustomMethodPointer<ProjectList,void,Node*>::call(CallableCustomMethodPointer<ProjectList,void,Node*> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
         long lVar1;
         long lVar2;
         Variant *this_00;
         undefined8 uVar3;
...
;
   ...
   const**, int, Variant&, Callable::CallError&) const */
      void CallableCustomMethodPointer<ProjectList,void,Ref<InputEvent>const&,Node*>::call(CallableCustomMethodPointer<ProjectList,void,Ref<InputEvent>const&,Node*> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
         long lVar1;
         long lVar2;
         Variant *this_00;
         ulong uVar3;
...
;
   ...
   CowData<char32_t>::_unref(local_60);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_50);
   LAB_0010f905:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }

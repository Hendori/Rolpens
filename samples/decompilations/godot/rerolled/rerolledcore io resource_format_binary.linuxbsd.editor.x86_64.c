/* ResourceFormatSaverBinary::recognize(Ref<Resource> const&) const */undefined8 ResourceFormatSaverBinary::recognize(Ref *param_1) {
   return 1;
}
/* ResourceFormatLoaderBinary::has_custom_uid_support() const */undefined8 ResourceFormatLoaderBinary::has_custom_uid_support(void) {
   return 1;
}
/* read_reals(float*, Ref<FileAccess>&, unsigned long) */undefined8 read_reals(float *param_1, Ref *param_2, ulong param_3) {
   double dVar1;
   float *pfVar2;
   long *plVar3;
   plVar3 = *(long**)param_2;
...
/* save_ustring(Ref<FileAccess>, String const&) */void save_ustring(undefined8 *param_1) {
   long lVar1;
   long *plVar2;
   code *pcVar3;
   int iVar4;
...
/* void Ref<FileAccess>::TEMPNAMEPLACEHOLDERVALUE(Ref<FileAccessCompressed> const&) [clone .isra.0]
    */void Ref<FileAccess>::operator =(Ref<FileAccess> *this, Ref *param_1) {
   Object *pOVar1;
   char cVar2;
   Object *pOVar3;
   pOVar1 = *(Object**)this;
...
/* ResourceLoaderBinary::get_dependencies(Ref<FileAccess>, List<String, DefaultAllocator>*, bool)
   [clone .part.0] */void ResourceLoaderBinary::get_dependencies(long param_1, long *param_2, char param_3) {
   long *plVar1;
   code *pcVar2;
 ...
 while ( !bVar10 );
               ...
               joined_r0x00101093:if (param_3 != '\0') {
                  lVar3 = *(long*)( param_1 + 0x98 );
                  goto LAB_0010120e;
               }

               LAB_0010109e:if (( local_50 == 0 ) || ( *(uint*)( local_50 + -8 ) < 2 )) goto LAB_001010ad;
               String::operator +=((String*)&local_58, "::");
               goto LAB_00101258;
            }

            if (param_3 != '\0') {
               LAB_0010120e:if (lVar3 == 0) goto LAB_00101320;
               lVar4 = *(long*)( lVar3 + -8 );
            ...
            if (local_58 == local_48) {
               ...
               *plVar1 = *plVar1 + -1;
               ...
               local_58 = local_48;
               LAB_00101055:lVar3 = *(long*)( param_1 + 0x98 );
            }

            if (lVar3 == 0) {
               LAB_00101320:lVar4 = 0;
               LAB_00101323:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar6, lVar4, "p_index", "size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
            ...
            LAB_00101228:if (( *(long*)( pCVar7 + 8 ) != 0 ) && ( 1 < *(uint*)( *(long*)( pCVar7 + 8 ) + -8 ) )) {
               operator+((char *)&
               local_48,(String*)&_LC24;
            ...
            LAB_00101258:operator + ( (char*)&local_48,(String*)&_LC24 );
            String::operator +=((String*)&local_58, (String*)&local_48);
            lVar3 = local_48;
...
/* ResourceFormatSaverBinary::get_recognized_extensions(Ref<Resource> const&, List<String,
   DefaultAllocator>*) const */void ResourceFormatSaverBinary::get_recognized_extensions(ResourceFormatSaverBinary *this, Ref *param_1, List *param_2) {
   long *plVar1;
   long lVar2;
   long lVar3;
   char cVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Vector4>::resize<false>(long) [clone .isra.0] */void CowData<Vector4>::resize<false>(CowData<Vector4> *this, long param_1) {
   ...
   if (param_1 * 0x10 != 0) {
      ...
      if (uVar4 != 0xffffffffffffffff) {
         if (param_1 <= lVar12) {
            ...
            if (uVar4 + 1 == lVar3) {
               ...
               if (puVar5 == (undefined8*)0x0) {
                  LAB_00101a08:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
                  return;
               }
         ...
         if (uVar4 + 1 == lVar3) {
            ...
            lVar3 = puVar9[-1];
            LAB_00101931:if (param_1 <= lVar3) goto LAB_001018a8;
         }
 else {
            if (lVar12 != 0) {
 ...
 while ( pauVar6 + ( param_1 - lVar3 ) != pauVar8 );
   ...
   LAB_001019ea:_err_print_error("resize", "./core/templates/cowdata.h", uVar11, pcVar10, 0, 0);
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<char>::resize<false>(long) [clone .isra.0] */void CowData<char>::resize<false>(CowData<char> *this, long param_1) {
   long *plVar1;
   size_t __n;
   code *pcVar2;
   ulong uVar3;
   ...
   if (param_1 <= lVar9) {
      ...
      LAB_00101d70:uVar7 = 0x1a9;
      pcVar8 = "_realloc";
      LAB_00101d90:_err_print_error(pcVar8, "./core/templates/cowdata.h", uVar7, "Parameter \"mem_new\" is null.", 0, 0);
      return;
   }
   ...
   puVar5 = puVar5 + 2;
   *(undefined8**)this = puVar5;
   LAB_00101b71:puVar5[-1] = param_1;
   return;
}
/* get_ustring(Ref<FileAccess>) */char *get_ustring(char *param_1, undefined8 *param_2) {
   long *plVar1;
   code *pcVar2;
   long lVar3;
   int iVar4;
...
/* ResourceLoaderBinary::_advance_padding(unsigned int) */void ResourceLoaderBinary::_advance_padding(ResourceLoaderBinary *this, uint param_1) {
   int iVar1;
   int iVar2;
   iVar2 = 4 - ( param_1 & 3 );
   if (iVar2 != 4) {
...
/* ResourceLoaderBinary::_get_string() */void ResourceLoaderBinary::_get_string(void) {
   uint uVar1;
   code *pcVar2;
   ulong uVar3;
   long in_RSI;
   ...
   if (lVar4 == 0) {
      if (uVar1 != 0) {
         ...
         LAB_001020b1:plVar5 = *(long**)( in_RSI + 0x30 );
         lVar4 = *(long*)( in_RSI + 0x50 );
         ...
         LAB_00102120:lVar6 = 0;
         LAB_00102123:uVar3 = 0;
         LAB_001020f6:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar3, lVar6, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
   ...
   *(undefined8*)in_RDI = 0;
   LAB_00101fad:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* ResourceLoaderBinary::get_resource() */void ResourceLoaderBinary::get_resource(void) {
   char cVar1;
   long in_RSI;
   long *in_RDI;
   *in_RDI = 0;
...
/* ResourceLoaderBinary::set_translation_remapped(bool) */void ResourceLoaderBinary::set_translation_remapped(ResourceLoaderBinary *this, bool param_1) {
   *this = (ResourceLoaderBinary)param_1;
   return;
}
/* ResourceLoaderBinary::get_unicode_string() */void ResourceLoaderBinary::get_unicode_string(void) {
   int iVar1;
   code *pcVar2;
   long in_RSI;
   long lVar3;
   ...
   if (lVar3 == 0) {
      if (lVar6 < 1) {
         ...
         LAB_00102295:plVar4 = *(long**)( in_RSI + 0x30 );
         lVar3 = *(long*)( in_RSI + 0x50 );
      ...
      LAB_001022c6:lVar5 = 0;
      LAB_001022c9:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, 0, lVar5, "p_index", "size()", "", false, true);
      _err_flush_stdout();
      /* WARNING: Does not return */
      pcVar2 = (code*)invalidInstructionException();
      ( *pcVar2 )();
   ...
   if (lVar5 < lVar6) {
      ...
      pcVar2 = *(code**)( *plVar4 + 0x220 );
      LAB_0010223e:if (lVar5 < 1) goto LAB_001022c9;
   ...
   LAB_00102206:*in_RDI = 0;
   LAB_0010220e:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* ResourceFormatSaverBinaryInstance::_pad_buffer(Ref<FileAccess>, int) */void ResourceFormatSaverBinaryInstance::_pad_buffer(undefined8 *param_1, int param_2) {
   int iVar1;
   uint uVar2;
   int iVar3;
...
/* ResourceFormatSaverBinaryInstance::save_unicode_string(Ref<FileAccess>, String const&, bool) */void ResourceFormatSaverBinaryInstance::save_unicode_string(undefined8 *param_1, undefined8 param_2, char param_3) {
   long lVar1;
   long *plVar2;
   code *pcVar3;
   uint uVar4;
...
/* ResourceFormatSaverBinary::ResourceFormatSaverBinary() */void ResourceFormatSaverBinary::ResourceFormatSaverBinary(ResourceFormatSaverBinary *this) {
...
/* ResourceLoaderBinary::recognize(Ref<FileAccess>) */StrRange *ResourceLoaderBinary::recognize(StrRange *param_1, long param_2, long *param_3) {
   Ref<FileAccess> *this;
   Object *pOVar1;
   long *plVar2;
   Ref *pRVar3;
   ...
   *(undefined4*)( param_2 + 0x110 ) = 0;
   ...
   if (( local_44 == 'R' ) && ( local_43 == 'S' )) {
      ...
      LAB_001026df:iVar5 = ( **(code**)( **(long**)( param_2 + 0x30 ) + 0x1f0 ) )();
      ...
      LAB_00102633:*(undefined4*)( param_2 + 0x110 ) = 0xf;
   ...
   *(undefined8*)param_1 = 0;
   ...
   local_50 = 0;
   String::parse_latin1(param_1);
   LAB_00102685:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* ResourceLoaderBinary::recognize_script_class(Ref<FileAccess>) */StrRange *ResourceLoaderBinary::recognize_script_class(StrRange *param_1, long param_2, long *param_3) {
   Ref<FileAccess> *this;
   Object *pOVar1;
   long *plVar2;
   Ref *pRVar3;
   ...
   *(undefined4*)( param_2 + 0x110 ) = 0;
   ...
   if (( local_44 == 'R' ) && ( local_43 == 'S' )) {
      ...
      if (local_42 == 'C') {
         ...
         LAB_001029f4:iVar5 = ( **(code**)( **(long**)( param_2 + 0x30 ) + 0x1f0 ) )();
         ( **(code**)( **(long**)( param_2 + 0x30 ) + 0x1f0 ) )();
         plVar2 = *(long**)( param_2 + 0x30 );
         lVar9 = *plVar2;
         if (*(code**)( lVar9 + 0x248 ) == FileAccess::set_big_endian) {
   ...
   *(undefined8*)param_1 = 0;
   ...
   local_50 = 0;
   String::parse_latin1(param_1);
   LAB_00102995:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* ResourceFormatSaverBinaryInstance::set_uid(String const&, long) */int ResourceFormatSaverBinaryInstance::set_uid(String *param_1, long param_2) {
   Ref *pRVar1;
   code *pcVar2;
   Ref *pRVar3;
   char cVar4;
   ...
   if (local_88 == (Object*)0x0) {
      ...
      _err_print_error("set_uid", "core/io/resource_format_binary.cpp", 0x955, "Condition \"f.is_null()\" is true. Returning: ERR_CANT_OPEN", (CowData<char32_t>*)&local_58, 0, 0);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
   ...
   if (( local_48 == 'R' ) && ( local_47 == 'S' )) {
      if (local_46 == 'C') {
         if (local_45 == 'C') {
            ...
            if (iVar5 == 0) {
               ...
               _err_print_error("set_uid", "core/io/resource_format_binary.cpp", 0x969, "Condition \"err\" is true. Returning: ERR_FILE_CORRUPT", (String*)&local_58, 0, 0, in_R8);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
               Ref<FileAccessCompressed>::unref((Ref<FileAccessCompressed>*)&local_70);
               ...
               _err_print_error("set_uid", "core/io/resource_format_binary.cpp", 0x962, "Condition \"err != OK\" is true. Returning: err", (String*)&local_58, 0, 0, param_2);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
            }
      ...
      if (local_80 == (Object*)0x0) {
         ...
         _err_print_error("set_uid", "core/io/resource_format_binary.cpp", 0x972, "Condition \"fw.is_null()\" is true. Returning: ERR_CANT_CREATE", (String*)&local_58, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
         goto LAB_00102d13;
      ...
      LAB_00102e90:local_98 = (Ref<FileAccess>*)&local_80;
      ...
      if (uVar8 == 0) {
         ...
         local_68 = (Object*)0x0;
         iVar5 = 2;
         String::parse_latin1((String*)local_b0, "This file is old, so it does not support UIDs, opening and resaving \'%s\'.");
      ...
      if (( 6 < uVar8 ) || ( 4 < uVar6 )) {
         ...
         local_68 = (Object*)0x0;
         String::parse_latin1((String*)local_b0, "File \'%s\' can\'t be loaded, as it uses a format version (%d) or engine version (%d.%d) which are not supported by your engine version (%s).");
         iVar5 = 0xf;
         uVar12 = 0;
         vformat<String,unsigned_int,unsigned_int,unsigned_int,char_const*>((String*)&local_58, local_b0, local_b8, uVar8, uVar6, uVar7, &_LC72);
         _err_print_error("set_uid", "core/io/resource_format_binary.cpp", 0x996, "Method/function failed. Returning: ERR_FILE_UNRECOGNIZED", (String*)&local_58, 0, uVar12 & 0xffffffff00000000);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
         CowData<char32_t>::_unref((CowData<char32_t>*)local_b0);
         CowData<char32_t>::_unref(local_b8);
         goto LAB_00102cfe;
...
;
      ...
      LAB_00102cf3:iVar5 = 0xf;
      pOVar11 = local_80;
      LAB_00102cfe:if (pOVar11 == (Object*)0x0) goto LAB_00102d13;
   }
   ...
   LAB_00102d13:if (local_88 != (Object*)0x0) {
      cVar4 = RefCounted::unreference();
      if (cVar4 != '\0') {
...
/* ResourceFormatLoaderBinary::get_recognized_extensions_for_type(String const&, List<String,
   DefaultAllocator>*) const */void ResourceFormatLoaderBinary::get_recognized_extensions_for_type(ResourceFormatLoaderBinary *this, String *param_1, List *param_2) {
   long lVar1;
   long *plVar2;
   long lVar3;
   long lVar4;
   ...
   if (( *(long*)param_1 == 0 ) || ( *(uint*)( *(long*)param_1 + -8 ) < 2 )) {
      ...
      if (cVar5 == '\0') {
         ...
         List<String,DefaultAllocator>::sort_custom<Comparator<String>>((List<String,DefaultAllocator>*)&local_50);
...
/* ResourceFormatLoaderBinary::get_recognized_extensions(List<String, DefaultAllocator>*) const */void ResourceFormatLoaderBinary::get_recognized_extensions(ResourceFormatLoaderBinary *this, List *param_1) {
   long *plVar1;
   long lVar2;
   long lVar3;
   CowData<char32_t> *this_00;
   ...
   List<String,DefaultAllocator>::sort_custom<Comparator<String>>((List<String,DefaultAllocator>*)&local_50);
   if (( local_50 != (long*)0x0 ) && ( lVar5 = lVar5 != 0 )) {
      do {
         String::to_lower();
         if (*(long*)param_1 == 0) {
            pauVar4 = (undefined1(*) [16])operator_new(0x18, DefaultAllocator::alloc);
...
/* ResourceFormatSaverBinaryInstance::write_variant(Ref<FileAccess>, Variant const&,
   ...
   DefaultTypedAllocator<HashMapElement<StringName, int> > >&, PropertyInfo const&) */void ResourceFormatSaverBinaryInstance::write_variant(undefined8 *param_1, Variant *param_2, HashMap<Ref<Resource>,int,HashMapHasherDefault,HashMapComparatorDefault<Ref<Resource>>,DefaultTypedAllocator<HashMapElement<Ref<Resource>,int>>> *param_3, HashMap<Ref<Resource>,int,HashMapHasherDefault,HashMapComparatorDefault<Ref<Resource>>,DefaultTypedAllocator<HashMapElement<Ref<Resource>,int>>> *param_4, HashMap<StringName,int,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,int>>> *param_5) {
   undefined8 *puVar1;
...
LAB_00105bf0:
      ...
      if (( plVar29[0x31] == 0 ) || ( *(uint*)( plVar29[0x31] + -8 ) < 2 )) {
         LAB_001048f2:if (( *(long*)( param_3 + 8 ) != 0 ) && ( *(int*)( param_3 + 0x2c ) != 0 )) {
            uVar30 = CONCAT44(0, *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( param_3 + 0x28 ) * 4 ));
            ...
            if (uVar17 != 0) {
               uVar31 = 0;
               do {
                  if (( (uint)uVar32 == uVar17 ) && ( local_d8 == *(long**)( *(long*)( *(long*)( param_3 + 8 ) + lVar28 * 8 ) + 0x10 ) )) {
                     ( **(code**)( *(long*)*param_1 + 0x278 ) )((long*)*param_1, 2);
                     plVar29 = (long*)*param_1;
                     UNRECOVERED_JUMPTABLE_00 = *(code**)( *plVar29 + 0x278 );
                     puVar21 = (undefined4*)HashMap<Ref<Resource>,int,HashMapHasherDefault,HashMapComparatorDefault<Ref<Resource>>,DefaultTypedAllocator<HashMapElement<Ref<Resource>,int>>>::operator [](param_3, (Ref*)&local_d8);
                     ( *UNRECOVERED_JUMPTABLE_00 )(plVar29, *puVar21);
                     goto LAB_00104a3d;
                  }
 ...
 while ( ( uVar17 != 0 ) && ( auVar4._8_8_ = 0 ),auVar4._0_8_ = (ulong)uVar17 * lVar23,auVar8._8_8_ = 0,auVar8._0_8_ = uVar30,auVar5._8_8_ = 0,auVar5._0_8_ = ( ulong )(( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( param_3 + 0x28 ) * 4 ) + iVar19 ) - SUB164(auVar4 * auVar8, 8)) * lVar23,auVar9._8_8_ = 0,auVar9._0_8_ = uVar30,uVar31 <= SUB164(auVar5 * auVar9, 8) );
            }

         }

         ( **(code**)( *(long*)*param_1 + 0x278 ) )((long*)*param_1, 0);
         _err_print_error("write_variant", "core/io/resource_format_binary.cpp", 0x740, "Method/function failed.", "Resource was not pre cached for the resource section, most likely due to circular reference.", 0, 0);
      }
 else {
         iVar19 = String::find((char*)( plVar29 + 0x31 ), 0x113b5b);
         if (( iVar19 != -1 ) || ( cVar14 = String::begins_with((char*)( plVar29 + 0x31 )) ),cVar14 != '\0') goto LAB_001048f2;
         ( **(code**)( *(long*)*param_1 + 0x278 ) )((long*)*param_1, 3);
         plVar29 = (long*)*param_1;
         UNRECOVERED_JUMPTABLE_00 = *(code**)( *plVar29 + 0x278 );
         puVar21 = (undefined4*)HashMap<Ref<Resource>,int,HashMapHasherDefault,HashMapComparatorDefault<Ref<Resource>>,DefaultTypedAllocator<HashMapElement<Ref<Resource>,int>>>::operator [](param_4, (Ref*)&local_d8);
         ( *UNRECOVERED_JUMPTABLE_00 )(plVar29, *puVar21);
      }

   }

   LAB_00104a3d:Ref<Resource>::unref((Ref<Resource>*)&local_d8);
   break;
   case 0x19:
...
LAB_00105e28:/* WARNING: Subroutine does not return */__stack_chk_fail();}/* CowData<StringName>::_copy_on_write() [clone .isra.0] */void CowData<StringName>::_copy_on_write(CowData<StringName> *this) {
   long lVar1;
   long lVar2;
   code *pcVar3;
   undefined8 *puVar4;
...
/* ResourceFormatSaverBinaryInstance::get_string_index(String const&) */int ResourceFormatSaverBinaryInstance::get_string_index(ResourceFormatSaverBinaryInstance *this, String *param_1) {
   uint uVar1;
   long lVar2;
   undefined1 auVar3[16];
   undefined1 auVar4[16];
   ...
   if (( *(long*)( this + 0x68 ) != 0 ) && ( *(int*)( this + 0x8c ) != 0 )) {
      ...
      if (uVar17 != 0) {
         uVar19 = 0;
         do {
            if (( uVar11 == uVar17 ) && ( *(long*)( *(long*)( *(long*)( this + 0x68 ) + lVar14 * 8 ) + 0x10 ) == local_50 )) {
               piVar12 = (int*)HashMap<StringName,int,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,int>>>::operator []((HashMap<StringName,int,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,int>>>*)( this + 0x60 ), (StringName*)&local_50);
               iVar16 = *piVar12;
               goto LAB_00106207;
            }
 ...
 while ( ( uVar17 != 0 ) && ( auVar5._8_8_ = 0 ),auVar5._0_8_ = (ulong)uVar17 * lVar2,auVar9._8_8_ = 0,auVar9._0_8_ = uVar18,auVar6._8_8_ = 0,auVar6._0_8_ = ( ulong )(( uVar1 + iVar16 ) - SUB164(auVar5 * auVar9, 8)) * lVar2,auVar10._8_8_ = 0,auVar10._0_8_ = uVar18,uVar19 <= SUB164(auVar6 * auVar10, 8) );
      }
   ...
   puVar13 = (undefined4*)HashMap<StringName,int,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,int>>>::operator []((HashMap<StringName,int,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,int>>>*)( this + 0x60 ), (StringName*)&local_50);
   *puVar13 = uVar15;
   ...
   if (StringName::configured == '\0') {
      ...
      if (local_48 == 0) {
         ...
         LAB_00106207:if (StringName::configured == '\0') goto LAB_0010621b;
      }
   ...
   LAB_0010621b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return iVar16;
   }
...
/* CowData<ResourceLoaderBinary::ExtResource>::_copy_on_write() [clone .isra.0] */void CowData<ResourceLoaderBinary::ExtResource>::_copy_on_write(CowData<ResourceLoaderBinary::ExtResource> *this) {
   long lVar1;
   undefined8 uVar2;
   long lVar3;
   code *pcVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ResourceLoaderBinary::parse_variant(Variant&) */int ResourceLoaderBinary::parse_variant(ResourceLoaderBinary *this, Variant *param_1) {
   Error *pEVar1;
   undefined1 auVar2[16];
   undefined1 auVar3[16];
   undefined1 auVar4[16];
   ...
   itos((long)&local_c8);
   operator+((char *)&
   local_b8,(String*)"find property of type: ";
...
LAB_00107ef0:
   ...
   joined_r0x0010670b:if (cVar16 == '\0') {
      LAB_001065e6:iVar20 = 0;
   }
 else {
      ::Variant::_clear_internal();
      iVar20 = 0;
   ...
   LAB_00106510:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ResourceFormatLoaderBinary::get_resource_type(String const&) const */String *ResourceFormatLoaderBinary::get_resource_type(String *param_1) {
   long *plVar1;
   Object *pOVar2;
   undefined1 auVar3[16];
   long lVar4;
   ...
   pOVar2 = local_1c8;
   if (local_1c8 == (Object*)0x0) {
      LAB_001091f9:local_1a8 = (Object*)0x0;
   ...
   if (local_1b0 == 0) {
      *(undefined8*)param_1 = 0;
      LAB_00109133:if (StringName::configured != '\0') {
         LAB_00109137:if (local_1b8 != 0) {
            StringName::unref();
         }
      ...
      *(undefined8*)param_1 = 0;
      if (pOVar2 == (Object*)0x0) {
         ...
         local_1a8 = pOVar2;
         String::parse_latin1((StrRange*)param_1);
         LAB_00109113:if (StringName::configured != '\0') {
            if (local_1b0 != 0) {
               LAB_00109124:StringName::unref();
               goto LAB_00109133;
            }
   ...
   LAB_0010917a:if (( ( local_1c8 != (Object*)0x0 ) && ( cVar5 = RefCounted::unreference() ),cVar5 != '\0' )) &&( cVar5 = cVar5 != '\0' )(**(code**)( *(long*)local_1c8 + 0x140 ))(local_1c8);
...
return param_1;}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ResourceFormatLoaderBinary::get_resource_script_class(String const&) const */String *ResourceFormatLoaderBinary::get_resource_script_class(String *param_1) {
   ...
   pOVar2 = local_198;
   if (local_198 == (Object*)0x0) {
      LAB_00109519:local_190 = (Object*)0x0;
   ...
   LAB_0010949b:if (( ( local_198 != (Object*)0x0 ) && ( cVar3 = RefCounted::unreference() ),cVar3 != '\0' )) &&( cVar3 = cVar3 != '\0' )(**(code**)( *(long*)local_198 + 0x140 ))(local_198);
...
return param_1;}/* CowData<ResourceLoaderBinary::IntResource>::_copy_on_write() [clone .isra.0] */void CowData<ResourceLoaderBinary::IntResource>::_copy_on_write(CowData<ResourceLoaderBinary::IntResource> *this) {
   long lVar1;
   code *pcVar2;
   undefined8 *puVar3;
   CowData *pCVar4;
...
/* WARNING: Removing unreachable block (ram,0x00109e80) *//* WARNING: Removing unreachable block (ram,0x0010a82e) *//* WARNING: Removing unreachable block (ram,0x0010aa5e) *//* WARNING: Removing unreachable block (ram,0x0010b035) *//* WARNING: Removing unreachable block (ram,0x0010ab5f) *//* WARNING: Removing unreachable block (ram,0x0010ab75) *//* WARNING: Removing unreachable block (ram,0x0010ab80) *//* WARNING: Removing unreachable block (ram,0x0010ab8a) *//* WARNING: Removing unreachable block (ram,0x0010b026) *//* WARNING: Removing unreachable block (ram,0x0010ab9c) *//* WARNING: Removing unreachable block (ram,0x0010aba5) *//* WARNING: Removing unreachable block (ram,0x0010abb0) *//* WARNING: Removing unreachable block (ram,0x0010abba) *//* WARNING: Removing unreachable block (ram,0x0010abcc) *//* WARNING: Removing unreachable block (ram,0x0010a85d) *//* ResourceLoaderBinary::load() [clone .part.0] */int ResourceLoaderBinary::load(ResourceLoaderBinary *this) {
   long *plVar1;
   code *pcVar2;
   undefined1 auVar3[16];
   undefined1 auVar4[16];
...
while (lVar20 != 0) ;;;}lVar18 = *(long*)( this + 0xa8 );if (lVar18 != 0) {
   local_1c8 = 0;
   ...
   do {
      ...
      if (lVar24 == local_1c8) {
         ...
         LAB_00109b32:if (lVar18 == 0) {
            lVar20 = 0;
            LAB_0010a0fb:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, local_1c8, lVar20, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar2 = (code*)invalidInstructionException();
            ( *pcVar2 )();
         ...
         lVar20 = *(long*)( lVar18 + -8 );
         if (lVar20 <= local_1c8) goto LAB_0010a0fb;
         ( **(code**)( **(long**)( this + 0x30 ) + 0x1b8 ) )(*(long**)( this + 0x30 ), *(undefined8*)( lVar18 + 8 + local_1c8 * 0x10 ));
         get_unicode_string();
         ...
         if (lVar24 == local_1c8) {
            ...
            LAB_0010a662:local_1a8 = (String*)&local_130;
            ...
            LAB_00109bf5:local_1a8 = (String*)&local_130;
            local_170 = (CowData<char32_t>*)&local_128;
            if (lVar24 != local_1c8) {
               pRVar19 = (Ref<Resource>*)HashMap<String,Ref<Resource>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<Resource>>>>::operator []((HashMap<String,Ref<Resource>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<Resource>>>>*)( this + 0xb0 ), local_1a8);
               ...
               do {
                  ...
                  if (local_108 == 0) {
                     *(undefined4*)( this + 0x110 ) = 0x10;
                     _err_print_error(&_LC121, "core/io/resource_format_binary.cpp", 0x337, "Method/function failed. Returning: ERR_FILE_CORRUPT", 0, 0);
                     iVar15 = 0x10;
                     LAB_0010a533:if (( StringName::configured != '\0' ) && ( local_108 != 0 )) {
                        StringName::unref();
                     }
                  ...
                  *(int*)( this + 0x110 ) = iVar15;
                  ...
                  if ((int)local_d8 == 0x18) {
                     if (( local_1a0 != (MissingResource*)0x0 ) || ( (char)ResourceLoader::create_missing_resources_if_class_unavailable == '\0' )) {
                        LAB_00109c79:Object::set((StringName*)local_118, (Variant*)&local_108, (bool*)&local_d8);
                        goto LAB_00109c8e;
                     }

                     lVar20 = ::Variant::get_validated_object();
                     if (( lVar20 == 0 ) || ( ( this_02 = (char*)__dynamic_cast(lVar20, &Object::typeinfo, &MissingResource::typeinfo, 0) ),(Object*)this_02 == (Object*)0x0 || ( cVar13 = RefCounted::reference() ),cVar13 == '\0' )) {
                     ...
                     cVar13 = RefCounted::unreference();
                     if (( cVar13 == '\0' ) || ( cVar13 = predelete_handler((Object*)this_02) ),cVar13 == '\0') {} else {
                     ...
                     if ((int)local_d8 == 0x1c) {
                        LAB_0010a2c4:bVar32 = true;
                        LAB_0010a2d0:::Variant::operator_cast_to_Array((Variant*)&local_f8);
                        ...
                        if (( local_100 != (Variant)0x0 ) && ( local_98[0] == 0x1c )) {
                           ...
                           if (cVar13 == '\0') {
                              ...
                              Array::Array((Array*)&local_e0, (Array*)&local_f8, uVar17, (StringName*)&local_e8, (Variant*)local_78);
                        ...
                        LAB_0010a37d:bVar32 = true;
                        LAB_00109e33:::Variant::operator_cast_to_Dictionary(&local_100);
                     ...
                     LAB_00109c8e:iVar15 = (int)local_d8;
                  }
 ...
 while ( iVar16 != iVar31 );
            ...
            List<Ref<Resource>,DefaultAllocator>::push_back((List<Ref<Resource>,DefaultAllocator>*)( this + 0x58 ), (Ref*)&local_118);
            if (lVar24 != local_1c8) {
               Dictionary::~Dictionary(local_110);
            ...
            *(undefined4*)( this + 0x110 ) = 0;
            LAB_0010a555:Dictionary::~Dictionary(local_110);
         }
 else {
            LAB_00109ba5:if (*(int*)( this + 0x114 ) == 2) {
            ...
            LAB_0010a598:StringName::StringName((StringName*)&local_e0, (String*)&local_120, false);
            ...
            if (pOVar22 == (Object*)0x0) {
               ...
               *(undefined4*)( this + 0x110 ) = 0x10;
               ...
               local_f8 = (Object*)0x0;
               String::parse_latin1((String*)&local_f8, "\'%s\': Resource of unrecognized type in file: \'%s\'.");
               vformat<String,String>((StringName*)&local_e0, (String*)&local_f8, (CowData<char32_t>*)&local_f0, (CowData<char32_t>*)&local_e8);
               _err_print_error(&_LC121, "core/io/resource_format_binary.cpp", 0x30d, "Method/function failed. Returning: ERR_FILE_CORRUPT", (StringName*)&local_e0, 0, 0, this_02);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_e0);
               ...
               LAB_0010a5e8:pRVar23 = (Ref*)__dynamic_cast(pOVar22, &Object::typeinfo, &Resource::typeinfo, 0);
               if (pRVar23 != (Ref*)0x0) {
                  local_e0 = (Object*)0x0;
                  local_e8 = pRVar23;
               ...
               *(undefined4*)( this + 0x110 ) = 0x10;
               ...
               local_f8 = (Object*)0x0;
               String::parse_latin1((String*)&local_f8, "\'%s\': Resource type in resource field not a resource, type is: %s.");
               pSVar28 = (StringName*)&local_e0;
               vformat<String,String>((StringName*)&local_e0, (String*)&local_f8, (CowData<char32_t>*)&local_f0, (CowData<char32_t>*)&local_e8);
               _err_print_error(&_LC121, "core/io/resource_format_binary.cpp", 0x316, "Method/function failed. Returning: ERR_FILE_CORRUPT", (StringName*)&local_e0, 0, 0, pSVar28);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_e0);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_f8);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_f0);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_e8);
      ...
      if (cVar13 != '\0') {
         ...
         if (*(long*)( this + 0xa8 ) == 0) {
            lVar20 = 0;
            LAB_0010a061:_err_print_index_error("operator[]", "./core/templates/vector.h", 0x38, local_1c8, lVar20, "p_index", "((Vector<T> *)(this))->_cowdata.size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar2 = (code*)invalidInstructionException();
            ( *pcVar2 )();
         ...
         if (lVar20 <= local_1c8) goto LAB_0010a061;
         CowData<ResourceLoaderBinary::IntResource>::_copy_on_write((CowData<ResourceLoaderBinary::IntResource>*)( this + 0xa8 ));
      ...
      local_1a8 = (String*)&local_130;
      if (( *(int*)( this + 0x114 ) != 1 ) || ( cVar13 = cVar13 == '\0' )) {
         LAB_00109b2b:lVar18 = *(long*)( this + 0xa8 );
         goto LAB_00109b32;
      }
      ...
      *(undefined4*)( this + 0x110 ) = 0;
      ...
      CowData<char32_t>::_unref((CowData<char32_t>*)local_1a8);
      LAB_0010a4b3:lVar18 = *(long*)( this + 0xa8 );
      local_1c8 = local_1c8 + 1;
   }
 while ( lVar18 != 0 );
}
iVar15 = 0x12;LAB_0010a4cd:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return iVar15;}/* ResourceLoaderBinary::load() */void ResourceLoaderBinary::load(ResourceLoaderBinary *this) {
   if (*(int*)( this + 0x110 ) == 0) {
      load(this);
      return;
   }
...
/* ResourceLoaderBinary::open(Ref<FileAccess>, bool, bool) */void ResourceLoaderBinary::open(ResourceLoaderBinary *this, undefined8 *param_2, char param_3, char param_4) {
   long *plVar1;
   ...
   *(undefined4*)( this + 0x110 ) = 0;
   ...
   if (pOVar25 != pOVar19) {
      *(Object**)( this + 0x30 ) = pOVar25;
      if (( pOVar25 != (Object*)0x0 ) && ( cVar10 = cVar10 == '\0' )) {
         *(undefined8*)( this + 0x30 ) = 0;
      }

      if (( ( pOVar19 != (Object*)0x0 ) && ( cVar10 = RefCounted::unreference() ),cVar10 != '\0' )) &&( cVar10 = cVar10 != '\0' )(**(code**)( *(long*)pOVar19 + 0x140 ))(pOVar19);
      Memory::free_static(pOVar19, false);
   }

   pOVar19 = *(Object**)( this + 0x30 );
}
( **(code**)( *(long*)pOVar19 + 0x220 ) )(pOVar19, &local_44, 4);if (( local_44 == 'R' ) && ( local_43 == 'S' )) {
   ...
   if (local_42 == 'C') {
      if (local_41 == 'C') {
         ...
         *(undefined4*)( this + 0x110 ) = uVar13;
         ...
         if (*(int*)( this + 0x110 ) != 0) {
            ...
            vformat<String>((Ref<FileAccess>*)&local_68, (String*)&local_90, (CowData<char32_t>*)local_88);
            _err_print_error(&_LC126, "core/io/resource_format_binary.cpp", 1000, "Method/function failed.", (Ref<FileAccess>*)&local_68, 0, 0);
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
      ...
      LAB_0010b32d:iVar11 = ( **(code**)( **(long**)( this + 0x30 ) + 0x1f0 ) )();
      ...
      *(undefined4*)( this + 0x28 ) = uVar14;
      itos((long)local_88);
      operator+((char *)&
      local_68,(String*)"big endian: ";
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
      CowData<char32_t>::_unref((CowData<char32_t>*)local_88);
      itos((long)local_88);
      operator+((char *)&
      local_68,(String*)"endian swap: ";
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
      CowData<char32_t>::_unref((CowData<char32_t>*)local_88);
      itos((long)local_88);
      operator+((char *)&
      local_68,(String*)"real64: ";
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
      CowData<char32_t>::_unref((CowData<char32_t>*)local_88);
      itos((long)local_88);
      operator+((char *)&
      local_68,(String*)"major: ";
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
      CowData<char32_t>::_unref((CowData<char32_t>*)local_88);
      itos((long)local_88);
      operator+((char *)&
      local_68,(String*)"minor: ";
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
      CowData<char32_t>::_unref((CowData<char32_t>*)local_88);
      itos((long)local_88);
      operator+((char *)&
      local_68,(String*)"format: ";
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
      CowData<char32_t>::_unref((CowData<char32_t>*)local_88);
         ...
         if (param_3 == '\0') {
            ...
            if (uVar12 != 0) {
               do {
                  ...
                  if (*(long*)( this + 0x68 ) == 0) {
                     lVar18 = 0;
                     LAB_0010b673:_err_print_index_error("operator[]", "./core/templates/vector.h", 0x38, uVar26, lVar18, "p_index", "((Vector<T> *)(this))->_cowdata.size()", "", false, true);
                     _err_flush_stdout();
                     /* WARNING: Does not return */
                     pcVar2 = (code*)invalidInstructionException();
                     ( *pcVar2 )();
                  ...
                  StringName::operator =((StringName*)( *(long*)( this + 0x68 ) + uVar26 * 8 ), (StringName*)local_88);
 ...
 while ( uVar26 != uVar12 );
            ...
            if (iVar11 != 0) {
               ...
               do {
                  ...
                  CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
                  lVar18 = local_78;
                  if (( ( this[0x71] != (ResourceLoaderBinary)0x0 ) && ( lVar18 = ( **(code**)( **(long**)( this + 0x30 ) + 0x1f8 ) )() ),local_78 = lVar18,param_4 != '\x01' )) {
                     ...
                     if (cVar10 == '\0') {
                        ...
                        if (lVar18 != lVar24) {
                           ...
                           local_98 = (Ref*)0x0;
                           if (*(long*)( this + 0x10 ) != 0) {
                              CowData<char32_t>::_ref((CowData<char32_t>*)&local_98, (CowData*)( this + 0x10 ));
                           }

                           local_a0 = 0;
                           String::parse_latin1((String*)&local_a0, "\'%s\': In external resource #%d, invalid UID: \'%s\' - using text path instead: \'%s\'.");
                           vformat<String,unsigned_int,String,String>((CowData<char32_t>*)&local_68, (String*)&local_a0, (CowData<char32_t>*)&local_98, local_ec, local_a8, (CowData<char32_t>*)&local_90);
                           _err_print_error(&_LC126, "core/io/resource_format_binary.cpp", 0x446, (CowData<char32_t>*)&local_68, 0, 1);
                           CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
                  ...
                  if (local_70 == (Object*)0x0) {
                     LAB_0010ba0d:local_50 = (Object*)0x0;
                     pOVar25 = (Object*)0x0;
                  }
 else {
                     local_50 = local_70;
                  ...
                  iVar15 = CowData<ResourceLoaderBinary::ExtResource>::resize<false>((CowData<ResourceLoaderBinary::ExtResource>*)( this + 0x98 ), lVar24);
                  if (iVar15 == 0) {
                     if (*(long*)( this + 0x98 ) == 0) {
                        lVar20 = -1;
                        lVar24 = 0;
                        LAB_0010c076:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar20, lVar24, "p_index", "size()", "", false, false);
                        goto LAB_0010bcac;
                     }
                     ...
                     CowData<ResourceLoaderBinary::ExtResource>::_copy_on_write((CowData<ResourceLoaderBinary::ExtResource>*)( this + 0x98 ));
                     ...
                     *(Object**)( this_01 + 0x18 ) = pOVar25;
                     if (pOVar25 != (Object*)0x0) {
                        ...
                        if (( ( pOVar3 != (Object*)0x0 ) && ( cVar10 = RefCounted::unreference() ),cVar10 != '\0' )) goto LAB_0010bce9;
                        goto LAB_0010baeb;
                     }

                     if (( ( pOVar3 != (Object*)0x0 ) && ( cVar10 = RefCounted::unreference() ),cVar10 != '\0' )) {
                        LAB_0010bce9:( **(code**)( *(long*)pOVar3 + 0x140 ) )(pOVar3);
                     ...
                     _err_print_error("push_back", "./core/templates/vector.h", 0x142, "Condition \"err\" is true. Returning: true", 0, 0);
                     LAB_0010bcac:if (pOVar25 != (Object*)0x0) {
                        LAB_0010baeb:cVar10 = RefCounted::unreference();
                        if (( cVar10 != '\0' ) && ( cVar10 = cVar10 != '\0' )) {
 ...
 while ( iVar11 != local_ec );
            ...
            if (iVar11 != 0) {
               ...
               do {
                  ...
                  local_60 = lVar18;
                  iVar16 = CowData<ResourceLoaderBinary::IntResource>::resize<false>((CowData<ResourceLoaderBinary::IntResource>*)( this + 0xa8 ), lVar24);
                  if (iVar16 == 0) {
                     if (*(long*)( this + 0xa8 ) == 0) {
                        lVar20 = -1;
                        lVar24 = 0;
                     ...
                     _err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar20, lVar24, "p_index", "size()", "", false, false);
                  }
 else {
                     _err_print_error("push_back", "./core/templates/vector.h", 0x142, "Condition \"err\" is true. Returning: true", 0, 0);
                  }

                  LAB_0010bea0:iVar15 = iVar15 + 1;
                  CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
                  CowData<char32_t>::_unref((CowData<char32_t>*)local_88);
               }
 while ( iVar11 != iVar15 );
            ...
            if (cVar10 != '\0') {
               *(undefined4*)( this + 0x110 ) = 0x10;
               ...
               _err_print_error(&_LC126, "core/io/resource_format_binary.cpp", 0x461, "Method/function failed.", (CowData<char32_t>*)&local_68, 0, 0);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_90);
               CowData<char32_t>::_unref((CowData<char32_t>*)local_88);
            }
         ...
         local_90 = 0;
         local_68 = "File \'%s\' can\'t be loaded, as it uses a format version (%d) or engine version (%d.%d) which are not supported by your engine version (%s).";
         local_60 = 0x8a;
         String::parse_latin1((StrRange*)&local_90);
         uVar26 = 0;
         vformat<String,unsigned_int,unsigned_int,unsigned_int,char_const*>((CowData<char32_t>*)&local_68, (StrRange*)&local_90, (CowData<char32_t>*)local_88, uVar14, uVar12, uVar13, &_LC72);
         _err_print_error(&_LC126, "core/io/resource_format_binary.cpp", 0x409, "Method/function failed.", (CowData<char32_t>*)&local_68, 0, uVar26 & 0xffffffff00000000);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_90);
         CowData<char32_t>::_unref((CowData<char32_t>*)local_88);
      }
...
*(undefined4*)( this + 0x110 ) = 0xf;if (( *(long*)( this + 0x30 ) != 0 ) && ( cVar10 = cVar10 != '\0' )) {
   pOVar19 = *(Object**)( this + 0x30 );
...
*(undefined8*)( this + 0x30 ) = 0;auVar6._8_8_ = 0;auVar6._0_8_ = local_88._8_8_;local_88 = auVar6 << 0x40;if (*(long*)( this + 8 ) != 0) {
   CowData<char32_t>::_ref((CowData<char32_t>*)local_88, (CowData*)( this + 8 ));
}
local_90 = 0;local_60 = 0x28;local_68 = "Unrecognized binary resource file: \'%s\'.";String::parse_latin1((StrRange*)&local_90);vformat<String>(&local_68, (StrRange*)&local_90, (CowData<char32_t>*)local_88);_err_print_error(&_LC126, "core/io/resource_format_binary.cpp", 0x3f0, "Method/function failed.", &local_68, 0, 0);pcVar22 = local_68;if (local_68 != (char*)0x0) {
   LOCK();
   plVar1 = (long*)( local_68 + -0x10 );
   *plVar1 = *plVar1 + -1;
   UNLOCK();
...
uVar17 = local_88._0_8_;if (local_88._0_8_ != 0) {
   LOCK();
...
LAB_0010b24f:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return;}/* ResourceLoaderBinary::get_classes_used(Ref<FileAccess>, HashSet<StringName, HashMapHasherDefault,
   HashMapComparatorDefault<StringName> >*) */void ResourceLoaderBinary::get_classes_used(ResourceLoaderBinary *param_1, undefined8 *param_2) {
   long *plVar1;
   Object *pOVar2;
   Object *pOVar3;
   char cVar4;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (( pOVar3 == (Object*)0x0 ) || ( local_58[0] = pOVar3 ),cVar4 = RefCounted::reference(),cVar4 == '\0') {
   ...
   if (( *(int*)( param_1 + 0x110 ) == 0 ) && ( lVar6 = lVar6 != 0 )) {
      lVar7 = 0;
      while (lVar7 < *(long*)( lVar6 + -8 )) {
         ( **(code**)( *(long*)*param_2 + 0x1b8 ) )((long*)*param_2, *(undefined8*)( lVar6 + 8 + lVar7 * 0x10 ));
         get_unicode_string();
         iVar5 = ( **(code**)( *(long*)*param_2 + 0x250 ) )();
         if (iVar5 != 0) {
            _err_print_error("get_classes_used", "core/io/resource_format_binary.cpp", 0x3b5, "Condition \"p_f->get_error() != OK\" is true.", 0, 0);
            lVar6 = local_68;
            if (local_68 != 0) {
               LOCK();
               plVar1 = (long*)( local_68 + -0x10 );
         ...
         if (cVar4 != '\0') {
            ...
            HashSet<StringName,HashMapHasherDefault,HashMapComparatorDefault<StringName>>::insert((String*)local_58);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ResourceFormatLoaderBinary::get_classes_used(String const&, HashSet<StringName,
   HashMapHasherDefault, HashMapComparatorDefault<StringName> >*) */void ResourceFormatLoaderBinary::get_classes_used(ResourceFormatLoaderBinary *this, String *param_1, HashSet *param_2) {
   long *plVar1;
   Object *pOVar2;
   long lVar3;
   char cVar4;
   ...
   if (local_1a0 == (Object*)0x0) {
      ...
      _err_print_error("get_classes_used", "core/io/resource_format_binary.cpp", 0x5f4, "Condition \"f.is_null()\" is true.", (CowData<char32_t>*)&local_188, 0);
   ...
   pOVar2 = local_1a0;
   if (local_1a0 == (Object*)0x0) {
      LAB_0010c710:local_190 = (Object*)0x0;
   ...
   ResourceLoaderBinary::~ResourceLoaderBinary((ResourceLoaderBinary*)&local_188);
   joined_r0x0010c8ed:if (( ( local_1a0 != (Object*)0x0 ) && ( cVar4 = RefCounted::unreference() ),cVar4 != '\0' )) &&( cVar4 = cVar4 != '\0' )(**(code**)( *(long*)local_1a0 + 0x140 ))(local_1a0);
   Memory::free_static(local_1a0, false);
}
if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* ResourceLoaderBinary::get_dependencies(Ref<FileAccess>, List<String, DefaultAllocator>*, bool) */void ResourceLoaderBinary::get_dependencies(ResourceLoaderBinary *this, undefined8 *param_2, undefined8 param_3, undefined1 param_4) {
   int iVar1;
   Object *pOVar2;
   char cVar3;
   long in_FS_OFFSET;
   ...
   local_30 = *(long*)( in_FS_OFFSET + 0x28 );
   if (( pOVar2 == (Object*)0x0 ) || ( local_38 = pOVar2 ),cVar3 = RefCounted::reference(),cVar3 == '\0') {
      local_38 = (Object*)0x0;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ResourceFormatLoaderBinary::load(String const&, String const&, Error*, bool, float*,
   ResourceFormatLoader::CacheMode) */long *ResourceFormatLoaderBinary::load(long *param_1, undefined8 param_2, CowData *param_3, CowData *param_4, int *param_5, undefined1 param_6, undefined8 param_7, uint param_8) {
   long *plVar1;
   Object *pOVar2;
   char cVar3;
   int iVar4;
   ...
   if (local_1b4 != 0) {
      ...
      vformat<String>((CowData<char32_t>*)&local_198, (StrRange*)&local_1a8, (CowData<char32_t>*)&local_1a0);
      _err_print_error(&_LC121, "core/io/resource_format_binary.cpp", 0x4c9, "Condition \"err != OK\" is true. Returning: Ref<Resource>()", (CowData<char32_t>*)&local_198, 0);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_198);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_1a8);
 ...
 while ( !bVar8 );
   ...
   LAB_0010cbe6:local_118 = param_6;
   ProjectSettings::get_singleton();
   ...
   if (local_1b0 == (Object*)0x0) {
      ...
      *param_1 = 0;
      ...
      LAB_0010ccb0:if (param_5 != (int*)0x0) {
         *param_5 = iStack_88;
      }

      LAB_0010ccbb:*param_1 = 0;
   }
   ...
   ResourceLoaderBinary::~ResourceLoaderBinary((ResourceLoaderBinary*)&local_198);
   LAB_0010ccf6:if (( ( local_1b0 != (Object*)0x0 ) && ( cVar3 = RefCounted::unreference() ),cVar3 != '\0' )) &&( cVar3 = cVar3 != '\0' )(**(code**)( *(long*)local_1b0 + 0x140 ))(local_1b0);
...
return param_1;}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ResourceFormatLoaderBinary::rename_dependencies(String const&, HashMap<String, String,
   HashMapHasherDefault, HashMapComparatorDefault<String>,
   DefaultTypedAllocator<HashMapElement<String, String> > > const&) */int ResourceFormatLoaderBinary::rename_dependencies(ResourceFormatLoaderBinary *this, String *param_1, HashMap *param_2) {
   code *pcVar1;
   bool bVar2;
   Object *pOVar3;
   char cVar4;
   ...
   undefined1 local_d0[16];
   undefined8 local_c0;
   HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>> local_b8[8];
   undefined1 local_b0[16];
   undefined1 local_a0[16];
   undefined8 local_90;
   undefined8 uStack_88;
   ...
   if (local_1d0 == (Object*)0x0) {
      ...
      String::parse_latin1((StrRange*)&local_1a8);
      vformat<String>((CowData<char32_t>*)&local_198, (StrRange*)&local_1a8, (CowData<char32_t>*)&local_1a0);
      _err_print_error("rename_dependencies", "core/io/resource_format_binary.cpp", 0x520, "Condition \"f.is_null()\" is true. Returning: ERR_CANT_OPEN", (CowData<char32_t>*)&local_198, 0, 0);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_198);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_1a8);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_1a0);
      goto LAB_0010d0e9;
      ...
      if (local_46 == 'C') {
         if (local_45 == 'C') {
            ...
            if (iVar6 == 0) {
               ...
               _err_print_error("rename_dependencies", "core/io/resource_format_binary.cpp", 0x534, "Condition \"err\" is true. Returning: ERR_FILE_CORRUPT", (Ref<FileAccess>*)&local_198, 0, 0, param_1);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_198);
               iVar6 = 0x10;
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_1a8);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_1a0);
               ...
               vformat<String>((Ref<FileAccess>*)&local_198, (String*)&local_1a8, (CowData<char32_t>*)&local_1a0);
               _err_print_error("rename_dependencies", "core/io/resource_format_binary.cpp", 0x52d, "Condition \"err != OK\" is true. Returning: err", (Ref<FileAccess>*)&local_198, 0, 0, pRVar16);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_198);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_1a8);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_1a0);
            }
         ...
         if (local_1c8 == (Ref*)0x0) {
            ...
            _err_print_error("rename_dependencies", "core/io/resource_format_binary.cpp", 0x53d, "Condition \"fw.is_null()\" is true. Returning: ERR_CANT_CREATE", (String*)&local_198, 0, 0);
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_198);
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_1a8);
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_1a0);
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_1c0);
         ...
         LAB_0010d23d:local_200 = (Ref<FileAccess>*)&local_1c8;
         ...
         if (uVar9 == 0) {
            ...
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_198);
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_1a0);
            if (( ( local_1a8 != (Object*)0x0 ) && ( cVar4 = RefCounted::unreference() ),pOVar3 = local_1a8,cVar4 != '\0' )) &&( cVar4 = cVar4 != '\0' )(**(code**)( *(long*)pOVar3 + 0x140 ))(pOVar3);
            Memory::free_static(pOVar3, false);
         }
         ...
         local_1a8 = (Object*)0x0;
         String::parse_latin1((String*)local_210, "This file is old, so it can\'t refactor dependencies, opening and resaving \'%s\'.");
         vformat<String>((Ref<FileAccess>*)&local_198, local_210, (CowData<char32_t>*)&local_1a0);
         _err_print_error("rename_dependencies", "core/io/resource_format_binary.cpp", 0x55d, (Ref<FileAccess>*)&local_198, 0, 1);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_198);
         ...
         if ((int)local_1b0 == 0) {
            ...
            HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>::operator =(local_b8, param_2);
            local_1a0 = 0;
            Ref<FileAccess>::operator =((Ref<FileAccess>*)&local_1a0, (Ref*)local_1d0);
            ResourceLoaderBinary::open((ResourceLoaderBinary*)&local_198, (CowData<char32_t>*)&local_1a0, 0, 0);
            ...
            if (iVar6 == 0x12) {
               ...
               if (local_1a0 == 0) {
                  iVar6 = 0x10;
                  _err_print_error("rename_dependencies", "core/io/resource_format_binary.cpp", 0x56e, "Condition \"res.is_null()\" is true. Returning: ERR_FILE_CORRUPT", 0, 0);
               }
 else {
                  iVar6 = ( **(code**)( *ResourceFormatSaverBinary::singleton + 0x150 ) )(ResourceFormatSaverBinary::singleton, (CowData<char32_t>*)&local_1a0, param_1, 0);
               }
               ...
               iVar6 = 0x10;
               _err_print_error("rename_dependencies", "core/io/resource_format_binary.cpp", 0x56c, "Condition \"err != ERR_FILE_EOF\" is true. Returning: ERR_FILE_CORRUPT", 0, 0);
            }
            ...
            vformat<String>((Ref<FileAccess>*)&local_198, local_210, (CowData<char32_t>*)&local_1a0);
            iVar6 = 0xc;
            _err_print_error("rename_dependencies", "core/io/resource_format_binary.cpp", 0x562, "Condition \"err != OK\" is true. Returning: ERR_FILE_CANT_OPEN", (Ref<FileAccess>*)&local_198, 0, 0);
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_198);
            CowData<char32_t>::_unref((CowData<char32_t>*)local_210);
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_1a0);
            pRVar17 = local_1c8;
         ...
         LAB_0010e066:CowData<char32_t>::_unref((CowData<char32_t>*)&local_1c0);
         ...
         if (6 < uVar9 || 4 < uVar7) {
            ...
            local_1a8 = (Object*)0x0;
            String::parse_latin1((String*)local_210, "File \'%s\' can\'t be loaded, as it uses a format version (%d) or engine version (%d.%d) which are not supported by your engine version (%s).");
            uVar20 = 0;
            iVar6 = 0xf;
            vformat<String,unsigned_int,unsigned_int,unsigned_int,char_const*>((Ref<FileAccess>*)&local_198, local_210, (CowData<char32_t>*)&local_1a0, uVar9, uVar7, uVar8, &_LC72);
            _err_print_error("rename_dependencies", "core/io/resource_format_binary.cpp", 0x574, "Method/function failed. Returning: ERR_FILE_UNRECOGNIZED", (Ref<FileAccess>*)&local_198, 0, uVar20 & 0xffffffff00000000);
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_198);
            CowData<char32_t>::_unref((CowData<char32_t>*)local_210);
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_1a0);
            goto LAB_0010e066;
 ...
 while ( iVar6 != iVar18 );
         ...
         if (iVar6 != 0) {
            do {
               ...
               Ref<FileAccess>::unref((Ref<FileAccess>*)&local_198);
               if (( ( ( uVar7 & 2 ) != 0 ) && ( lVar12 = ( **(code**)( *(long*)local_1d0 + 0x1f8 ) )() ),lVar12 != -1 )) {
               ...
               cVar4 = HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>::_lookup_pos((HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>*)param_2, (String*)local_210, (uint*)&local_198);
               if (cVar4 != '\0') {
                  local_198 = (Ref*)( (ulong)local_198 & 0xffffffff00000000 );
                  cVar4 = HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>::_lookup_pos((HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>*)param_2, (String*)local_210, (uint*)&local_198);
                  if (cVar4 == '\0') {
...
;
         ...
         if (iVar6 == 0) {
            ...
            iVar6 = 0;
            pRVar17 = local_1c8;
            if (( ( local_1b0 != (Ref*)0x0 ) && ( cVar4 = RefCounted::unreference() ),pRVar13 = local_1b0,pRVar17 = local_1c8,cVar4 != '\0' )) {
...
local_1a0 = 0;if (local_1c0 != 0) {
   CowData<char32_t>::_ref((CowData<char32_t>*)&local_1a0, (CowData*)&local_1c0);
}
local_1a8 = (Object*)0x0;iVar6 = 0xf;local_190._0_8_ = 0x27;local_198 = (Ref*)0x116410;String::parse_latin1((StrRange*)&local_1a8);vformat<String>((CowData<char32_t>*)&local_198, (StrRange*)&local_1a8, (CowData<char32_t>*)&local_1a0);_err_print_error("rename_dependencies", "core/io/resource_format_binary.cpp", 0x53a, "Method/function failed. Returning: ERR_FILE_UNRECOGNIZED", (CowData<char32_t>*)&local_198, 0, 0);CowData<char32_t>::_unref((CowData<char32_t>*)&local_198);CowData<char32_t>::_unref((CowData<char32_t>*)&local_1a8);CowData<char32_t>::_unref((CowData<char32_t>*)&local_1a0);CowData<char32_t>::_unref((CowData<char32_t>*)&local_1c0);LAB_0010d0e9:if (( ( local_1d0 != (Object*)0x0 ) && ( cVar4 = RefCounted::unreference() ),cVar4 != '\0' )) &&( cVar4 = cVar4 != '\0' )(**(code**)( *(long*)local_1d0 + 0x140 ))(local_1d0);Memory::free_static(local_1d0, false);}if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return iVar6;}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ResourceFormatLoaderBinary::get_resource_uid(String const&) const */undefined8 ResourceFormatLoaderBinary::get_resource_uid(ResourceFormatLoaderBinary *this, String *param_1) {
   long *plVar1;
   Object *pOVar2;
   undefined1 auVar3[16];
   long lVar4;
   ...
   if (local_188 == (Object*)0x0) {
      LAB_0010e932:local_180 = (Object*)0x0;
   ...
   if (( ( local_188 != (Object*)0x0 ) && ( cVar6 = RefCounted::unreference() ),cVar6 != '\0' )) &&( cVar6 = cVar6 != '\0' )(**(code**)( *(long*)local_188 + 0x140 ))(local_188);
   Memory::free_static(local_188, false);
}
LAB_0010e97a:lVar4 = local_190;if (local_190 != 0) {
   LOCK();
   plVar1 = (long*)( local_190 + -0x10 );
   *plVar1 = *plVar1 + -1;
   UNLOCK();
...
return uVar8;}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ResourceFormatLoaderBinary::get_dependencies(String const&, List<String, DefaultAllocator>*,
   bool) */void ResourceFormatLoaderBinary::get_dependencies(ResourceFormatLoaderBinary *this, String *param_1, List *param_2, bool param_3) {
   long *plVar1;
   long lVar2;
   char cVar3;
   Object *pOVar4;
   ...
   if (local_1a0 == (Object*)0x0) {
      ...
      String::parse_latin1((StrRange*)&local_198);
      vformat<String>((CowData<char32_t>*)&local_188, (StrRange*)&local_198, (CowData<char32_t>*)&local_190);
      _err_print_error("get_dependencies", "core/io/resource_format_binary.cpp", 0x516, "Condition \"f.is_null()\" is true.", (CowData<char32_t>*)&local_188, 0, 0);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_188);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_198);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_190);
   ...
   pOVar5 = local_1a0;
   if (( local_1a0 == (Object*)0x0 ) || ( cVar3 = cVar3 == '\0' )) {
      local_190 = (Object*)0x0;
      pOVar5 = (Object*)0x0;
      ResourceLoaderBinary::open((ResourceLoaderBinary*)&local_188, (String*)&local_190, 0, 1);
      if ((int)uStack_78 == 0) {
         LAB_0010ecae:ResourceLoaderBinary::get_dependencies(&local_188, param_2, param_3);
      ...
      if (cVar3 == '\0') {
         local_190 = (Object*)0x0;
         ResourceLoaderBinary::open((ResourceLoaderBinary*)&local_188, (String*)&local_190, 0, 1);
         joined_r0x0010ed65:if ((int)uStack_78 == 0) goto LAB_0010ecae;
      }
 else {
         ResourceLoaderBinary::open((ResourceLoaderBinary*)&local_188, (String*)&local_190, 0, 1);
         cVar3 = RefCounted::unreference();
      ...
      LAB_0010ecc2:cVar3 = RefCounted::unreference();
      if (( cVar3 != '\0' ) && ( cVar3 = cVar3 != '\0' )) {
         ( **(code**)( *(long*)pOVar5 + 0x140 ) )(pOVar5);
         Memory::free_static(pOVar5, false);
      }
   ...
   ResourceLoaderBinary::~ResourceLoaderBinary((ResourceLoaderBinary*)&local_188);
   joined_r0x0010ef4f:if (( ( local_1a0 != (Object*)0x0 ) && ( cVar3 = RefCounted::unreference() ),cVar3 != '\0' )) &&( cVar3 = cVar3 != '\0' )(**(code**)( *(long*)local_1a0 + 0x140 ))(local_1a0);
   Memory::free_static(local_1a0, false);
}
if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
...
return;}/* CowData<Ref<Resource> >::_copy_on_write() [clone .isra.0] */void CowData<Ref<Resource>>::_copy_on_write(CowData<Ref<Resource>> *this) {
   long lVar1;
   long lVar2;
   code *pcVar3;
   char cVar4;
...
/* ResourceFormatSaverBinaryInstance::_find_resources(Variant const&, bool) */void ResourceFormatSaverBinaryInstance::_find_resources(ResourceFormatSaverBinaryInstance *this, Variant *param_1, bool param_2) {
   _Data *this_00;
   undefined4 uVar1;
   code *pcVar2;
   long *plVar3;
   ...
   if (uVar41 == 0x1b) {
      ...
      if (local_88 != (Variant*)0x0) {
         for (pVVar39 = *(Variant**)local_88; pVVar39 != (Variant*)0x0; pVVar39 = *(Variant**)( pVVar39 + 0x18 )) {
      ...
      if (uVar41 == 0x16) {
 ...
 else if (( ( ( uVar41 == 0x18 ) && ( lVar33 = ::Variant::get_validated_object() ),lVar33 != 0 ) ) && ( local_f8 = (Object*)__dynamic_cast(lVar33, &Object::typeinfo, &Resource::typeinfo, 0) ),local_f8 != (Object*)0x0) {
         if (( *(long*)( this + 0xa8 ) != 0 ) && ( *(int*)( this + 0xcc ) != 0 )) {
            ...
            if (uVar41 != 0) {
               uVar42 = 0;
               do {
                  if (( (uint)uVar43 == uVar41 ) && ( local_f8 == (Object*)*(List**)( *(long*)( *(long*)( this + 0xa8 ) + lVar38 * 8 ) + 0x10 ) )) goto LAB_0010f33d;
                  uVar42 = uVar42 + 1;
                  auVar5._8_8_ = 0;
 ...
 while ( ( uVar41 != 0 ) && ( auVar6._8_8_ = 0 ),auVar6._0_8_ = (ulong)uVar41 * lVar33,auVar14._8_8_ = 0,auVar14._0_8_ = uVar40,auVar7._8_8_ = 0,auVar7._0_8_ = ( ulong )(( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 200 ) * 4 ) + iVar32 ) - SUB164(auVar6 * auVar14, 8)) * lVar33,auVar15._8_8_ = 0,auVar15._0_8_ = uVar40,uVar42 <= SUB164(auVar7 * auVar15, 8) );
            }
         ...
         if ((_find_resources(Variant_const&,bool)::{lambda()
         #1
         ( iVar32 = __cxa_guard_acquire(&_find_resources(Variant_const & sname), iVar32 != 0) );
         {
            _scs_create((char*)&_find_resources(Variant_const & ::sname, true));
            __cxa_atexit(StringName::~StringName, &_find_resources(Variant_const & ::sname, &__dso_handle));
            __cxa_guard_release(&_find_resources(Variant_const&,bool)::{lambda()
            #1
            )
            ;;
         }

         ( *pcVar2 )((Variant*)&local_58, local_f8, &_find_resources(Variant_const & ::sname, (Variant*)local_78));
         ...
         pLVar27 = local_b0;
         if (bVar30) {
            LAB_0010f9fd:if (pLVar27 != (List*)0x0) {
               local_f8 = (Object*)pLVar27;
               LAB_0010f33d:cVar29 = RefCounted::unreference();
            ...
            if (( ( ( !param_2 ) && ( this[0x11] == (ResourceFormatSaverBinaryInstance)0x0 ) ) && ( *(long*)( (List*)local_f8 + 0x188 ) != 0 ) ) && ( 1 < *(uint*)( *(long*)( (List*)local_f8 + 0x188 ) + -8 ) )) {
               iVar32 = String::find((char*)( (List*)local_f8 + 0x188 ), 0x113b5b);
               if (( iVar32 == -1 ) && ( cVar29 = String::begins_with((char*)( (List*)local_f8 + 0x188 )) ),cVar29 == '\0') {
                  Resource::get_path();
                  cVar29 = String::operator ==((String*)&local_88, (String*)( this + 8 ));
                  CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);
                  if (cVar29 == '\0') {
                     uVar1 = *(undefined4*)( this + 0xcc );
                     puVar37 = (undefined4*)HashMap<Ref<Resource>,int,HashMapHasherDefault,HashMapComparatorDefault<Ref<Resource>>,DefaultTypedAllocator<HashMapElement<Ref<Resource>,int>>>::operator []((HashMap<Ref<Resource>,int,HashMapHasherDefault,HashMapComparatorDefault<Ref<Resource>>,DefaultTypedAllocator<HashMapElement<Ref<Resource>,int>>>*)( this + 0xa0 ), (Ref*)&local_b0);
                     *puVar37 = uVar1;
                  }
 else {
                     auVar26._8_8_ = 0;
                     ...
                     local_a0 = 0;
                     String::parse_latin1((String*)&local_a0, "Circular reference to resource being saved found: \'%s\' will be null next time it\'s loaded.");
                     vformat<String>((String*)&local_88, (String*)&local_a0, (CowData<char32_t>*)local_98);
                     _err_print_error("_find_resources", "core/io/resource_format_binary.cpp", 0x7f0, (String*)&local_88, 0, 0);
                     CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);
                     CowData<char32_t>::_unref((CowData<char32_t>*)&local_a0);
                     CowData<char32_t>::_unref((CowData<char32_t>*)local_98);
                  }
            ...
            if (( *(long*)( this + 0x20 ) != 0 ) && ( *(int*)( this + 0x44 ) != 0 )) {
               ...
               if (uVar41 != 0) {
                  uVar41 = 0;
                  do {
                     if (( (int)uVar43 == (int)uVar34 ) && ( *(Ref**)( *(long*)( this + 0x20 ) + ( ulong ) * (uint*)( *(long*)( this + 0x28 ) + lVar38 * 4 ) * 8 ) == (Ref*)pLVar27 )) goto LAB_0010f9fd;
                     uVar41 = uVar41 + 1;
                     auVar9._8_8_ = 0;
 ...
 while ( ( uVar42 != 0 ) && ( auVar10._8_8_ = 0 ),auVar10._0_8_ = uVar34 * lVar33,auVar18._8_8_ = 0,auVar18._0_8_ = uVar40,auVar11._8_8_ = 0,auVar11._0_8_ = ( ulong )(( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x40 ) * 4 ) + iVar32 ) - SUB164(auVar10 * auVar18, 8)) * lVar33,auVar19._8_8_ = 0,auVar19._0_8_ = uVar40,uVar41 <= SUB164(auVar11 * auVar19, 8) );
               }

            }

            HashSet<Ref<Resource>,HashMapHasherDefault,HashMapComparatorDefault<Ref<Resource>>>::insert((Ref*)&local_88);
            local_a8 = (long*)0x0;
            Object::get_property_list((List*)local_f8, SUB81((List<PropertyInfo,DefaultAllocator>*)&local_a8, 0));
               ...
               for (lVar33 = *local_a8; lVar33 != 0; lVar33 = *(long*)( lVar33 + 0x30 )) {
                  if (( *(byte*)( lVar33 + 0x28 ) & 2 ) != 0) {
                     ...
                     if (( *(byte*)( lVar33 + 0x2a ) & 0x80 ) == 0) {
                        ...
                        if (lVar38 == 0) {
                           RBMap<ResourceFormatSaverBinaryInstance::NonPersistentKey,Variant,Comparator<ResourceFormatSaverBinaryInstance::NonPersistentKey>,DefaultAllocator>::_Data::_create_root(this_00);
                           lVar38 = *(long*)( this + 0x48 );
                           ...
                           LAB_0010fbda:lVar38 = *(long*)( lVar38 + 0x10 );
                           if (*(long*)( this + 0x50 ) != lVar38) {
                              do {
                                 if (local_98._0_8_ == *(ulong*)( lVar38 + 0x30 )) {
                                    ...
                                    LAB_0010fc00:lVar38 = *(long*)( lVar38 + 0x10 );
                                 }
 else {
                                    if ((ulong)local_98._0_8_ < *(ulong*)( lVar38 + 0x30 )) goto LAB_0010fc00;
                                    LAB_0010fc17:lVar38 = *(long*)( lVar38 + 8 );
                                 }
 ...
 while ( lVar38 != *(long*)( this + 0x50 ) );
                        ...
                        lVar38 = RBMap<ResourceFormatSaverBinaryInstance::NonPersistentKey,Variant,Comparator<ResourceFormatSaverBinaryInstance::NonPersistentKey>,DefaultAllocator>::_insert((RBMap<ResourceFormatSaverBinaryInstance::NonPersistentKey,Variant,Comparator<ResourceFormatSaverBinaryInstance::NonPersistentKey>,DefaultAllocator>*)this_00, (NonPersistentKey*)local_98, (Variant*)&local_58);
                        if (::Variant::needs_deinit[(int)local_58] != '\0') {
                           ::Variant::_clear_internal();
                        }

                        LAB_0010fc2f:::Variant::operator =((Variant*)( lVar38 + 0x40 ), (Variant*)local_78);
                        local_a0 = 0;
                        lVar38 = ::Variant::get_validated_object();
                        if (( lVar38 == 0 ) || ( lVar38 = __dynamic_cast(lVar38, &Object::typeinfo, &Resource::typeinfo, 0) ),lVar38 == 0) {
                           LAB_0010fc92:_find_resources(this, (Variant*)local_78, false);
                        }
 else {
                           local_a0 = lVar38;
                           ...
                           HashSet<Ref<Resource>,HashMapHasherDefault,HashMapComparatorDefault<Ref<Resource>>>::insert((Ref*)&local_88);
                           List<Ref<Resource>,DefaultAllocator>::push_back((List<Ref<Resource>,DefaultAllocator>*)( this + 0xd0 ), (Ref*)&local_a0);
                        }
                        ...
                        if (( local_98._0_8_ != 0 ) && ( cVar29 = cVar29 != '\0' )) {
                           uVar28 = local_98._0_8_;
 ...
 while ( pVVar39 != local_88 );
   ...
   LAB_0010ffd1:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* ResourceFormatSaverBinaryInstance::save(String const&, Ref<Resource> const&, unsigned int) */int ResourceFormatSaverBinaryInstance::save(ResourceFormatSaverBinaryInstance *this, String *param_1, Ref *param_2, uint param_3) {
   Object *pOVar1;
   size_t __n;
   code *pcVar2;
   bool *pbVar3;
   ...
   if (( param_3 & 0x20 ) == 0) {
      ...
      if (( CONCAT44(uStack_104, local_108) != 0 ) && ( cVar24 = cVar24 != '\0' )) {
         pOVar51 = (Object*)CONCAT44(uStack_104, local_108);
         goto LAB_00111920;
      }

      LAB_0011014c:local_1e0 = local_1b4;
   }
 else {
      ...
      if (( pOVar29 != (Object*)0x0 ) && ( local_1b0 = pOVar29 ),cVar24 = RefCounted::reference(),cVar24 == '\0') {
         local_1b0 = (Object*)0x0;
      }
      ...
      LAB_00111920:cVar24 = predelete_handler(pOVar51);
      if (cVar24 == '\0') goto LAB_0011014c;
   ...
   if (local_1e0 != 0) {
      ...
      _err_print_error(&_LC163, "core/io/resource_format_binary.cpp", 0x86e, "Condition \"err != OK\" is true. Returning: err", local_250, 0, 0);
   ...
   pOVar51 = local_1b0;
   if (( param_3 & 0x20 ) == 0) {
      ( **(code**)( *(long*)local_1b0 + 0x2d0 ) )(local_1b0, &save(String_const & Ref < Resource > const & unsigned_int), ::header, 4);
   }
   ...
   if (( iVar27 != 0 ) && ( iVar27 = iVar27 != 0x12 )) {
      local_1e0 = 0x14;
      goto LAB_00111b43;
   }
   ...
   if (( pOVar29 != (Object*)0x0 ) && ( local_148 = pOVar29 ),cVar24 = RefCounted::reference(),cVar24 == '\0') {
      local_148 = (Object*)0x0;
      pOVar29 = (Object*)0x0;
   }
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)local_138);
   if (( ( pOVar29 != (Object*)0x0 ) && ( cVar24 = RefCounted::unreference() ),cVar24 != '\0' )) &&( cVar24 = cVar24 != '\0' )(**(code**)( *(long*)pOVar29 + 0x140 ))(pOVar29);
   Memory::free_static(pOVar29, false);
}
( **(code**)( *(long*)pOVar51 + 0x280 ) )(pOVar51, 0);plVar38 = *(long**)param_2;local_1a8 = 0;pcVar2 = *(code**)( *plVar38 + 0x58 );auVar14._8_8_ = 0;auVar14._0_8_ = local_138._8_8_;local_138 = auVar14 << 0x40;local_108 = 0x113e2f;uStack_104 = 0;pvStack_100 = (void*)0xb;String::parse_latin1((StrRange*)local_138);cVar24 = ( *pcVar2 )(plVar38, (CowData<char32_t>*)local_138);iVar27 = 3;CowData<char32_t>::_unref((CowData<char32_t>*)local_138);if (cVar24 == '\0') {
   ( **(code**)( **(long**)param_2 + 0x98 ) )((Variant*)local_98);
   lVar30 = ::Variant::get_validated_object();
   if (lVar30 == 0) {
      LAB_00111b7d:cVar24 = ::Variant::needs_deinit[local_98[0]];
   }
 else {
...
LAB_001105f0:( **(code**)( *(long*)pOVar51 + 0x278 ) )(pOVar51, iVar27);uVar31 = ResourceSaver::get_resource_id_for_path(param_1, true);( **(code**)( *(long*)pOVar51 + 0x280 ) )(pOVar51, uVar31);if (( local_1a8 != 0 ) && ( 1 < *(uint*)( local_1a8 + -8 ) )) {
   local_108 = 0;
   uStack_104 = 0;
...
iVar27 = 0xb;do {
 ...
 while ( iVar27 != 0 );local_1a0 = (undefined1(*) [16])0x0;if (( *(long**)( this + 0xd0 ) != (long*)0x0 ) && ( plVar38 = (long*)**(long**)( this + 0xd0 ) ),plVar38 != (long*)0x0) {
   do if (( *(byte*)( piVar39 + 10 ) & 2 ) != 0) plVar38 = (long*)plVar38[1]; while ( plVar38 != (long*)0x0 );
}
if (*(long*)( this + 0x98 ) == 0) {
   uVar44 = 0;
}
...
( **(code**)( *(long*)pOVar51 + 0x278 ) )(pOVar51, uVar44);lVar30 = *(long*)( this + 0x98 );for (lVar47 = 0; ( lVar30 != 0 && ( lVar47 < *(long*)( lVar30 + -8 ) ) ); lVar47 = lVar47 + 1) {
...
( **(code**)( *(long*)pOVar51 + 0x278 ) )(pOVar51);uVar26 = *(uint*)( this + 0xcc );local_160 = (undefined8*)0x0;if (uVar26 == 0) {
   ...
   if (puVar37 == (undefined8*)0x0) {
      ...
      __s = local_160;
      if (plVar38 != (long*)0x0) goto LAB_00111608;
      LAB_00111691:if (__s == (undefined8*)0x0) goto LAB_00111bca;
   }
 else {
      __s = puVar37 + 2;
      *puVar37 = 1;
         ...
         LAB_00111608:do {
            ...
            if (lVar30 < 0) {
               if (__s != (undefined8*)0x0) {
                  LAB_00111878:lVar47 = __s[-1];
                  goto LAB_0011187d;
               }

               LAB_00111b24:lVar47 = 0;
               LAB_0011187d:_err_print_index_error("operator[]", "./core/templates/vector.h", 0x38, lVar30, lVar47, "p_index", "((Vector<T> *)(this))->_cowdata.size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
               pcVar2 = (code*)invalidInstructionException();
               ( *pcVar2 )();
            ...
            if (pOVar29 != pOVar1) {
               *plVar48 = (long)pOVar29;
               if (( pOVar29 != (Object*)0x0 ) && ( cVar24 = cVar24 == '\0' )) {
                  *plVar48 = 0;
               }

               if (( ( pOVar1 != (Object*)0x0 ) && ( cVar24 = RefCounted::unreference() ),cVar24 != '\0' )) &&( cVar24 = cVar24 != '\0' )(**(code**)( *(long*)pOVar1 + 0x140 ))(pOVar1);
               Memory::free_static(pOVar1, false);
            }
 ...
 while ( plVar38 != (long*)0x0 );
   ...
   for (lVar30 = 0; lVar30 < (long)__s[-1]; lVar30 = lVar30 + 1) {
      ...
      if (( ( pOVar29 != (Object*)0x0 ) && ( cVar24 = RefCounted::unreference() ),cVar24 != '\0' )) &&( cVar24 = cVar24 != '\0' )(**(code**)( *(long*)pOVar29 + 0x140 ))();
      Memory::free_static(pOVar29, false);
   }
   ...
   if (this[0x10] == (ResourceFormatSaverBinaryInstance)0x0) {
      ...
      LAB_001116d3:if (local_138._0_8_ != CONCAT44(uStack_104, local_108)) {
         CowData<char32_t>::_unref((CowData<char32_t>*)local_138);
         auVar21 = local_138;
...
lVar47 = __s[-1];if (lVar47 <= lVar30) goto LAB_00111d5b;Resource::get_path();ResourceSaver::get_resource_id_for_path((String*)local_250, false);CowData<char32_t>::_unref(local_250);( **(code**)( *(long*)pOVar51 + 0x280 ) )(pOVar51);CowData<char32_t>::_unref((CowData<char32_t>*)local_138);}
  }LAB_00111bca:uVar44 = 0;if (*(long*)( this + 0xd0 ) != 0) {
   uVar44 = *(undefined4*)( *(long*)( this + 0xd0 ) + 0x10 );
}
( **(code**)( *(long*)pOVar51 + 0x278 ) )(pOVar51, uVar44);uVar36 = _LC116;local_e0 = _LC116;plVar38 = *(long**)( this + 0xd0 );local_150 = 0;local_118 = _LC116;local_138 = (undefined1[16])0x0;local_128 = (undefined1[16])0x0;if (plVar38 == (long*)0x0) {
   ...
   if (plVar48 != (long*)0x0) {
      do {
         ...
         if (( lVar30 == 0 ) || ( *(uint*)( lVar30 + -8 ) < 2 )) {
            LAB_00111ce6:Resource::get_scene_unique_id();
            pCVar45 = local_250;
            if (( CONCAT44(uStack_104, local_108) == 0 ) || ( iVar27 = iVar27 == 0 )) {
               LAB_00111d0a:CowData<char32_t>::_unref(pCVar45);
            }
 else {
               CowData<char32_t>::_unref(local_250);
               if (iVar27 != 1) {
                  ...
                  cVar24 = HashSet<String,HashMapHasherDefault,HashMapComparatorDefault<String>>::_lookup_pos((HashSet<String,HashMapHasherDefault,HashMapComparatorDefault<String>>*)local_138, (String*)local_250, (uint*)&local_148);
                  CowData<char32_t>::_unref(local_250);
                  if (cVar24 == '\0') {
                     Resource::get_scene_unique_id();
                     HashSet<String,HashMapHasherDefault,HashMapComparatorDefault<String>>::insert((String*)local_250);
            ...
            if (( iVar27 != -1 ) || ( cVar24 = cVar24 != '\0' )) goto LAB_00111ce6;
         }
 ...
 while ( plVar48 != (long*)0x0 );
   ...
   if (pRVar52 != (Ref*)0x0) {
      ...
      do {
         ...
         if (( lVar30 == 0 ) || ( *(uint*)( lVar30 + -8 ) < 2 )) {
            LAB_0011204e:Resource::get_scene_unique_id();
            if (( local_148 == (Object*)0x0 ) || ( lVar30 = *(long*)( local_148 + -8 ) ),(int)lVar30 == 0) {
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_148);
               LAB_00112077:uVar31 = local_138._0_8_;
               local_198 = (Object*)0x0;
               LAB_001120d1:local_238 = local_178;
               ...
               if (( uVar31 != 0 ) && ( local_118._4_4_ != 0 )) {
                  ...
                  if (uVar28 != 0) {
                     ...
                     do {
                        if (uVar28 == uVar41) {
                           cVar24 = String::operator ==((String*)( uVar31 + ( ulong ) * (uint*)( local_138._8_8_ + lVar47 * 4 ) * 8 ), (String*)&local_198);
                        ...
                        if (( uVar28 == 0 ) || ( auVar8._8_8_ = 0 ),auVar8._0_8_ = (ulong)uVar28 * lVar30,auVar12._8_8_ = 0,auVar12._0_8_ = uVar36,auVar9._8_8_ = 0,auVar9._0_8_ = ( ulong )(( uVar26 + iVar27 ) - SUB164(auVar8 * auVar12, 8)) * lVar30,auVar13._8_8_ = 0,auVar13._0_8_ = uVar36,SUB164(auVar9 * auVar13, 8) < uVar43) break;
                     }
 while ( true );
                  }
               ...
               HashSet<String,HashMapHasherDefault,HashMapComparatorDefault<String>>::insert((String*)&local_148);
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_198);
            }
 else {
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_148);
            ...
            iVar27 = String::find(pcVar4, 0x113b5b);
            if (( iVar27 != -1 ) || ( cVar24 = cVar24 != '\0' )) goto LAB_0011204e;
            Resource::get_path();
            local_148 = (Object*)0x0;
            Ref<FileAccess>::operator =((Ref<FileAccess>*)&local_148, (Ref*)local_1b0);
            save_unicode_string((String*)&local_148, (CowData<char32_t>*)&local_170, 0);
         ...
         piVar39 = (int*)HashMap<Ref<Resource>,int,HashMapHasherDefault,HashMapComparatorDefault<Ref<Resource>>,DefaultTypedAllocator<HashMapElement<Ref<Resource>,int>>>::operator []((HashMap<Ref<Resource>,int,HashMapHasherDefault,HashMapComparatorDefault<Ref<Resource>>,DefaultTypedAllocator<HashMapElement<Ref<Resource>,int>>>*)local_250, pRVar52);
...
LAB_0011243b:pOVar29 = local_1b0;local_140 = 0;if (( local_1a0 == (undefined1(*) [16])0x0 ) || ( lVar30 = lVar30 == 0 )) {
   LAB_001126ee:lVar40 = *(long*)pOVar51;
}
 else {
   do {
      uVar36 = ( **(code**)( *(long*)pOVar51 + 0x1c8 ) )(pOVar51);
      ...
      if (( *(undefined8**)( lVar30 + 8 ) != (undefined8*)0x0 ) && ( puVar49 = (undefined4*)**(undefined8**)( lVar30 + 8 ) ),puVar49 != (undefined4*)0x0) {
         do {
            while (true) {
               ( **(code**)( *(long*)pOVar51 + 0x278 ) )(pOVar51, *puVar49);
               if (pOVar29 != (Object*)0x0) break;
               LAB_00112520:local_170 = (Ref*)0x0;
               write_variant((Ref<FileAccess>*)&local_170, puVar49 + 2, local_250, this + 0xa0, this + 0x60, puVar49 + 8);
               LAB_00112549:puVar49 = *(undefined4**)( puVar49 + 0x14 );
...
;
            ...
            write_variant((Ref<FileAccess>*)&local_170, puVar49 + 2, local_250, this + 0xa0, this + 0x60, puVar49 + 8);
            cVar24 = RefCounted::unreference();
            if (( cVar24 == '\0' ) || ( cVar24 = cVar24 == '\0' )) goto LAB_00112549;
            ( **(code**)( *(long*)pOVar29 + 0x140 ) )(pOVar29);
            Memory::free_static(pOVar29, false);
 ...
 while ( lVar30 != 0 );
   ...
   for (lVar30 = 0; lVar40 = *(long*)pOVar51,lVar30 < *(long*)( lVar42 + -8 ); lVar30 = lVar30 + 1) {
      if (local_150 == 0) {
         lVar47 = 0;
         LAB_00111d5b:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar30, lVar47, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
...
( **(code**)( lVar40 + 0x1c0 ) )(pOVar51, 0);( **(code**)( *(long*)pOVar51 + 0x2d0 ) )(pOVar51, &_LC168, 4);iVar27 = ( **(code**)( *(long*)pOVar51 + 0x250 ) )(pOVar51);local_1e0 = 0;if (iVar27 != 0) {
   iVar27 = ( **(code**)( *(long*)pOVar51 + 0x250 ) )(pOVar51);
   local_1e0 = 0x14;
   if (iVar27 == 0x12) {
      local_1e0 = 0;
...
CowData<unsigned_long>::_unref((CowData<unsigned_long>*)&local_140);if (pvStack_100 != (void*)0x0) {
   pvVar46 = pvStack_100;
   if (local_e0._4_4_ != 0) {
         ...
         do {
            if (*(int*)( (long)local_f8 + lVar30 ) != 0) {
               ...
               *(int*)( (long)local_f8 + lVar30 ) = 0;
               if (( *(long*)( (long)pvVar46 + 0x10 ) != 0 ) && ( cVar24 = cVar24 != '\0' )) {
...
LAB_00112809:uVar31 = local_138._0_8_;if ((CowData<char32_t>*)local_138._0_8_ != (CowData<char32_t>*)0x0) {
...
CowData<unsigned_long>::_unref((CowData<unsigned_long>*)&local_150);CowData<Ref<Resource>>::_unref((CowData<Ref<Resource>>*)&local_160);List<ResourceFormatSaverBinaryInstance::ResourceData,DefaultAllocator>::~List((List<ResourceFormatSaverBinaryInstance::ResourceData,DefaultAllocator>*)&local_1a0);CowData<char32_t>::_unref((CowData<char32_t>*)&local_1a8);LAB_00111b43:Ref<FileAccess>::unref((Ref<FileAccess>*)&local_1b0);if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return local_1e0;LAB_00110e9d:do {
   if (uVar36 == *(ulong*)( lVar47 + 0x30 )) {
      ...
      LAB_00110e90:lVar47 = *(long*)( lVar47 + 0x10 );
   }
 else {
      lVar47 = *(long*)( lVar47 + 8 );
   }
 ...
 while ( lVar30 != lVar47 );local_b8 = 0;local_b0 = (undefined1[16])0x0;lVar47 = RBMap<ResourceFormatSaverBinaryInstance::NonPersistentKey,Variant,Comparator<ResourceFormatSaverBinaryInstance::NonPersistentKey>,DefaultAllocator>::_insert((RBMap<ResourceFormatSaverBinaryInstance::NonPersistentKey,Variant,Comparator<ResourceFormatSaverBinaryInstance::NonPersistentKey>,DefaultAllocator>*)( this + 0x48 ), (NonPersistentKey*)local_250, (Variant*)&local_b8);if (::Variant::needs_deinit[(int)local_b8] != '\0') {
   ::Variant::_clear_internal();
}
LAB_00110ac7:::Variant::operator =((Variant*)local_90, (Variant*)( lVar47 + 0x40 ));LAB_00110ae0:if (( StringName::configured != '\0' ) && ( pvStack_100 != (void*)0x0 )) {
   StringName::unref();
}
if (( CONCAT44(uStack_104, local_108) != 0 ) && ( cVar24 = cVar24 != '\0' )) {
   pOVar29 = (Object*)CONCAT44(uStack_104, local_108);
...
LAB_00110b18:iVar27 = *piVar39;joined_r0x00110b1d:if (iVar27 == 0x18) {
   ...
   if (cVar24 != '\0') {
      lVar30 = ::Variant::get_validated_object();
      if (( ( lVar30 == 0 ) || ( pOVar29 = (Object*)__dynamic_cast(lVar30, &Object::typeinfo, &Resource::typeinfo, 0) ),pOVar29 == (Object*)0x0 )) {
         ::Variant::Variant((Variant*)&local_b8, pSVar5);
...
local_230 = (Variant*)local_90;StringName::StringName((StringName*)local_250, pSVar5, false);( **(code**)( *(long*)*plVar38 + 0x48 ) )((String*)&local_148);StringName::StringName((StringName*)local_138, (String*)&local_148, false);ClassDB::class_get_default_property_value((StringName*)local_d8, (StringName*)local_138, (bool*)local_250);if (( StringName::configured != '\0' ) && ( local_138._0_8_ != 0 )) {
   StringName::unref();
}
pOVar29 = local_148;if (local_148 != (Object*)0x0) {
   LOCK();
...
if (local_d8[0] != 0) {
   ...
   local_138[0] = 1;
   local_b8 = local_b8 & 0xffffffff00000000;
   ::Variant::evaluate((Operator*)local_250, local_230, (Variant*)local_d8, (Variant*)&local_b8, (bool*)local_138);
...
local_78 = *piVar39;if (local_70._0_8_ != *(long*)( piVar39 + 2 )) {
   CowData<char32_t>::_ref((CowData<char32_t>*)local_70, (CowData*)pSVar5);
}
StringName::operator =((StringName*)( local_70 + 8 ), (StringName*)( piVar39 + 4 ));local_60 = piVar39[6];if (local_58 != *(long*)( piVar39 + 8 )) {
   CowData<char32_t>::_ref((CowData<char32_t>*)&local_58, (CowData*)( piVar39 + 8 ));
}
local_50 = piVar39[10];if (*(long*)( *pauVar32 + 8 ) == 0) {
...
piVar33 = (int*)operator_new(0x68, DefaultAllocator::alloc);piVar33[2] = 0;piVar33[8] = 0;piVar33[0xe] = 0;piVar33[0x10] = 0;piVar33[0x11] = 0;piVar33[0x12] = 6;piVar33[0x18] = 0;piVar33[0x19] = 0;*(undefined1(*) [16])( piVar33 + 4 ) = (undefined1[16])0x0;*(undefined1(*) [16])( piVar33 + 10 ) = (undefined1[16])0x0;*(undefined1(*) [16])( piVar33 + 0x14 ) = (undefined1[16])0x0;*piVar33 = local_98[0];::Variant::operator =((Variant*)( piVar33 + 2 ), local_230);piVar33[8] = local_78;if (*(long*)( piVar33 + 10 ) != local_70._0_8_) {
   CowData<char32_t>::_ref((CowData<char32_t>*)( piVar33 + 10 ), (CowData*)local_70);
}
StringName::operator =((StringName*)( piVar33 + 0xc ), (StringName*)( local_70 + 8 ));piVar33[0xe] = local_60;if (*(long*)( piVar33 + 0x10 ) != local_58) {
   CowData<char32_t>::_ref((CowData<char32_t>*)( piVar33 + 0x10 ), (CowData*)&local_58);
}
piVar33[0x12] = local_50;uVar31 = *(undefined8*)( *(long*)( *pauVar32 + 8 ) + 8 );*(long*)( piVar33 + 0x18 ) = *(long*)( *pauVar32 + 8 );plVar48 = *(long**)( *pauVar32 + 8 );piVar33[0x14] = 0;piVar33[0x15] = 0;*(undefined8*)( piVar33 + 0x16 ) = uVar31;if (plVar48[1] != 0) {
   *(int**)( plVar48[1] + 0x50 ) = piVar33;
}
plVar48[1] = (long)piVar33;if (*plVar48 == 0) {
   *plVar48 = (long)piVar33;
}
*(int*)( plVar48 + 2 ) = (int)plVar48[2] + 1;if (::Variant::needs_deinit[local_d8[0]] != '\0') {
   ::Variant::_clear_internal();
}
lVar30 = local_58;if (local_58 != 0) {
   LOCK();
   plVar48 = (long*)( local_58 + -0x10 );
   *plVar48 = *plVar48 + -1;
   UNLOCK();
...
LAB_00110de1:uVar31 = local_70._0_8_;if (local_70._0_8_ != 0) {
   LOCK();
...
if (::Variant::needs_deinit[local_90[0]] == '\0') {
   LAB_00110e2e:piVar39 = *(int**)( piVar39 + 0xc );
}
 else {
   ::Variant::_clear_internal();
   piVar39 = *(int**)( piVar39 + 0xc );
}
joined_r0x00110e35:if (piVar39 == (int*)0x0) goto LAB_00110e3b;goto LAB_00110900;}/* ResourceFormatSaverBinary::set_uid(String const&, long) */undefined4 ResourceFormatSaverBinary::set_uid(String *param_1, long param_2) {
   long *plVar1;
   long lVar2;
   undefined4 uVar3;
   long in_FS_OFFSET;
   ...
   ResourceFormatSaverBinaryInstance::~ResourceFormatSaverBinaryInstance((ResourceFormatSaverBinaryInstance*)local_f8);
   lVar2 = local_100;
   if (local_100 != 0) {
      LOCK();
...
/* ResourceFormatSaverBinary::save(Ref<Resource> const&, String const&, unsigned int) */undefined4 ResourceFormatSaverBinary::save(ResourceFormatSaverBinary *this, Ref *param_1, String *param_2, uint param_3) {
   long *plVar1;
   long lVar2;
   undefined4 uVar3;
   long in_FS_OFFSET;
   ...
   for (int i = 0; i < 16; i++) {
      local_108[i] = (ResourceFormatSaverBinaryInstance)0;
   }
...
/* RefCounted::is_class_ptr(void*) const */uint RefCounted::is_class_ptr(RefCounted *this, void *param_1) {
   return (uint)CONCAT71(0x1217, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1217, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr);
}
...
/* ResourceFormatLoader::is_class_ptr(void*) const */uint ResourceFormatLoader::is_class_ptr(ResourceFormatLoader *this, void *param_1) {
   return (uint)CONCAT71(0x1217, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1216, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1217, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
...
/* ResourceFormatLoader::_get_class_namev() const */undefined8 *ResourceFormatLoader::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00112fd3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00112fd3;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "ResourceFormatLoader");
   LAB_0011303e:return &_get_class_namev();
}
/* RefCounted::_get_class_namev() const */undefined8 *RefCounted::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001130b3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001130b3;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "RefCounted");
   LAB_0011311e:return &_get_class_namev();
}
/* ResourceFormatSaver::_get_class_namev() const */undefined8 *ResourceFormatSaver::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001131a3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001131a3;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "ResourceFormatSaver");
   LAB_0011320e:return &_get_class_namev();
}
...
/* SortArray<List<String, DefaultAllocator>::Element*, List<String,
   ...
   List<String, DefaultAllocator>::Element**, long) const [clone .isra.0] */void SortArray<List<String,DefaultAllocator>::Element*,List<String,DefaultAllocator>::AuxiliaryComparator<Comparator<String>>,true>::introsort(long param_1, long param_2, Element **param_3, long param_4) {
   Element **ppEVar1;
   String *pSVar2;
   Element *pEVar3;
   char cVar4;
   ...
   if (param_4 != 0) {
      ...
      local_68 = param_2;
      local_60 = param_4;
      LAB_001133c1:local_60 = local_60 + -1;
      ...
      LAB_0011341d:pSVar2 = (String*)*ppEVar10;
      lVar9 = local_68;
      local_78 = param_1;
      do {
         cVar4 = String::operator <((String*)param_3[local_78], pSVar2);
         if (cVar4 == '\0') {
            LAB_00113464:lVar9 = lVar9 + -1;
...
;
 ...
 while ( true );
   ...
   do {
      ...
      if (local_58 < lVar9) {
         do {
            cVar4 = String::operator <((String*)param_3[param_1 + lVar6], (String*)param_3[param_1 + lVar6 + -1]);
            lVar8 = lVar6 + -1;
 ...
 while ( lVar7 < lVar12 );
         *ppEVar11 = (Element*)pSVar2;
         joined_r0x0011371d:if (lVar7 == 0) goto LAB_0011371f;
      }
 else {
         ppEVar5 = local_50;
         ppEVar11 = local_50;
         if (local_58 == lVar9) goto LAB_0011385d;
         LAB_001138ae:*ppEVar11 = (Element*)pSVar2;
      }
 ...
 while ( true );
   LAB_001134d0:introsort(local_78, local_68, param_3, local_60);
   ...
   goto LAB_001133c1;
   LAB_0011371f:ppEVar11 = param_3 + param_1;
...
;
         ...
         lVar9 = 2;
         do {
            cVar4 = String::operator <((String*)param_3[param_1 + lVar9], (String*)param_3[param_1 + lVar9 + -1]);
            lVar6 = lVar9 + -1;
            lVar7 = lVar9;
...
/* ResourceFormatSaverBinary::~ResourceFormatSaverBinary() */void ResourceFormatSaverBinary::~ResourceFormatSaverBinary(ResourceFormatSaverBinary *this) {
   ...
   *(code**)this = CharString::get_data;
   ...
   LAB_00113a11:*(undefined***)this = &PTR__initialize_classv_00121180;
   Object::~Object((Object*)this);
   return;
}
/* ResourceFormatSaverBinary::~ResourceFormatSaverBinary() */void ResourceFormatSaverBinary::~ResourceFormatSaverBinary(ResourceFormatSaverBinary *this) {
   ...
   *(code**)this = CharString::get_data;
   ...
   LAB_00113ae1:*(undefined***)this = &PTR__initialize_classv_00121180;
   Object::~Object((Object*)this);
...
/* Error CowData<char>::resize<false>(long) [clone .isra.0] [clone .cold] */void CowData<char>::resize<false>(long param_1) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void FUN_00113ee2(void) {
   code *pcVar1;
   _DAT_00000000 = 0;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
...
/* CowData<ResourceLoaderBinary::ExtResource>::_copy_on_write() [clone .isra.0] [clone .cold] */void CowData<ResourceLoaderBinary::ExtResource>::_copy_on_write(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* ResourceLoaderBinary::parse_variant(Variant&) [clone .cold] */void ResourceLoaderBinary::parse_variant(Variant *param_1) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* CowData<ResourceLoaderBinary::IntResource>::_copy_on_write() [clone .isra.0] [clone .cold] */void CowData<ResourceLoaderBinary::IntResource>::_copy_on_write(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* CowData<Ref<Resource> >::_copy_on_write() [clone .isra.0] [clone .cold] */void CowData<Ref<Resource>>::_copy_on_write(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
...
/* ResourceFormatSaver::_initialize_classv() */void ResourceFormatSaver::_initialize_classv(void) {
   ...
   long local_40;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (initialize_class() != '\0') goto LAB_0011533b;
   if (RefCounted::initialize_class() == '\0') {
      ...
      lVar2 = local_68;
      if (local_68 == 0) {
         LAB_0011544a:if ((code*)PTR__bind_methods_00126010 != RefCounted::_bind_methods) {
            LAB_0011545a:RefCounted::_bind_methods();
         }
   ...
   initialize_class()::initialized =
   '\x01';
   LAB_0011533b:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* ResourceFormatLoader::_initialize_classv() */void ResourceFormatLoader::_initialize_classv(void) {
   ...
   long local_40;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (initialize_class() != '\0') goto LAB_0011563b;
   if (RefCounted::initialize_class() == '\0') {
      Object::initialize_class();
      local_68 = 0;
      local_50 = 6;
      ...
      lVar2 = local_68;
      if (local_68 == 0) {
         LAB_0011574a:if ((code*)PTR__bind_methods_00126010 != RefCounted::_bind_methods) {
            LAB_0011575a:RefCounted::_bind_methods();
         }
   ...
   initialize_class()::initialized =
   '\x01';
   LAB_0011563b:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* RefCounted::is_class(String const&) const */undefined8 RefCounted::is_class(RefCounted *this, String *param_1) {
 ...
 while ( !bVar9 );
      ...
      LAB_0011583f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
 ...
 while ( !bVar9 );
         ...
         LAB_001159a3:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
      ...
      LAB_001158f3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* ResourceFormatSaver::is_class(String const&) const */undefined8 ResourceFormatSaver::is_class(ResourceFormatSaver *this, String *param_1) {
 ...
 while ( !bVar8 );
      ...
      LAB_00115acf:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_00115b83:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* ResourceFormatLoader::is_class(String const&) const */undefined8 ResourceFormatLoader::is_class(ResourceFormatLoader *this, String *param_1) {
 ...
 while ( !bVar8 );
      ...
      LAB_00115c4f:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_00115d03:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* ResourceFormatLoader::~ResourceFormatLoader() */void ResourceFormatLoader::~ResourceFormatLoader(ResourceFormatLoader *this) {
   ...
   *(code**)this = Thread::caller_id;
   ...
   LAB_00116833:*(undefined***)this = &PTR__initialize_classv_00121180;
   Object::~Object((Object*)this);
   return;
}
/* ResourceFormatLoaderBinary::~ResourceFormatLoaderBinary() */void ResourceFormatLoaderBinary::~ResourceFormatLoaderBinary(ResourceFormatLoaderBinary *this) {
...
/* ResourceLoader::notify_dependency_error(String const&, String const&, String const&) */void ResourceLoader::notify_dependency_error(String *param_1, String *param_2, String *param_3) {
 ...
 while ( !bVar8 );
      ...
      LAB_00116a85:::Variant::Variant((Variant*)local_a8, (String*)&local_100);
 ...
 while ( pVVar7 != (Variant*)local_a8 );
   ...
   LAB_00116bb2:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }

   LAB_00116c6d:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<String, Ref<Resource>, HashMapHasherDefault, HashMapComparatorDefault<String>,
 ...
 while ( uVar40 != uVar45 );
      ...
      LAB_00117746:if (iVar46 != 0) {
         LAB_0011774e:uVar38 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
 ...
 while ( ( uVar53 != 0 ) && ( auVar19._8_8_ = 0 ),auVar19._0_8_ = (ulong)uVar53 * lVar3,auVar35._8_8_ = 0,auVar35._0_8_ = uVar40,auVar20._8_8_ = 0,auVar20._0_8_ = ( ulong )(( uVar38 + uVar52 ) - SUB164(auVar19 * auVar35, 8)) * lVar3,auVar36._8_8_ = 0,auVar36._0_8_ = uVar40,uVar55 <= SUB164(auVar20 * auVar36, 8) );
   ...
   LAB_0011722a:uVar56 = *(uint*)( this + 0x28 );
   if (uVar56 == 0x1c) {
...
;
 ...
 while ( ( uVar39 != 0 ) && ( auVar15._8_8_ = 0 ),auVar15._0_8_ = (ulong)uVar39 * lVar3,auVar31._8_8_ = 0,auVar31._0_8_ = uVar40,auVar16._8_8_ = 0,auVar16._0_8_ = ( ulong )(( uVar53 + uVar56 ) - SUB164(auVar15 * auVar31, 8)) * lVar3,auVar32._8_8_ = 0,auVar32._0_8_ = uVar40,uVar52 <= SUB164(auVar16 * auVar32, 8) );
      ...
      LAB_00117742:iVar46 = *(int*)( this + 0x2c );
      goto LAB_00117746;
   }

   LAB_00117204:if ((float)uVar40 * __LC45 < (float)( iVar46 + 1 )) goto LAB_0011722a;
}
local_58[0] = 0;if (*(long*)param_1 == 0) {
   pauVar42 = (undefined1(*) [16])operator_new(0x20, "");
   *(undefined8*)pauVar42[1] = 0;
   *pauVar42 = (undefined1[16])0x0;
   LAB_0011786b:*(undefined8*)( pauVar42[1] + 8 ) = 0;
   LAB_001174b3:puVar43 = *(undefined8**)( this + 0x20 );
   if (puVar43 != (undefined8*)0x0) goto LAB_001174c0;
   LAB_001176fd:*(undefined1(**) [16])( this + 0x18 ) = pauVar42;
}
 else {
...
*(undefined1(**) [16])( lVar47 + lVar48 * 8 ) = pauVar58;*puVar51 = uVar56;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_001175cb:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return pauVar42[1] + 8;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* Ref<FileAccess>::unref() */void Ref<FileAccess>::unref(Ref<FileAccess> *this) {
   Object *pOVar1;
   char cVar2;
   if (*(long*)this != 0) {
      cVar2 = RefCounted::unreference();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashSet<StringName, HashMapHasherDefault, HashMapComparatorDefault<StringName>
 ...
 while ( ( uVar42 != 0 ) && ( auVar5._8_8_ = 0 ),auVar5._0_8_ = (ulong)uVar42 * lVar30,auVar17._8_8_ = 0,auVar17._0_8_ = uVar29,auVar6._8_8_ = 0,auVar6._0_8_ = ( ulong )(( uVar40 + iVar33 ) - SUB164(auVar5 * auVar17, 8)) * lVar30,auVar18._8_8_ = 0,auVar18._0_8_ = uVar29,uVar37 <= SUB164(auVar6 * auVar18, 8) );
   ...
   if ((float)( iVar44 + 1 ) <= (float)uVar27 * __LC45) {
      ...
      LAB_00117fb6:uVar27 = StringName::get_empty_hash();
   }
 else {
 ...
 while ( (uint)uVar29 < *(uint*)( (long)in_RSI + 0x24 ) );
      ...
      LAB_00117e55:uVar27 = *(uint*)( lVar30 + 0x20 );
   }
 ...
 while ( uVar42 != 0 );
   ...
   *(int*)( (long)in_RSI + 0x24 ) = iVar44;
   LAB_00117f78:*(uint*)( param_1 + 0xc ) = uVar42;
   *(long*)param_1 = lVar36;
   *(int*)( param_1 + 8 ) = iVar44;
   return param_1;
}
/* void Ref<FileAccessCompressed>::instantiate<>() */void Ref<FileAccessCompressed>::instantiate<>(Ref<FileAccessCompressed> *this) {
   long lVar1;
   char cVar2;
   RefCounted *this_00;
   Object *pOVar3;
   ...
   *(undefined1(*) [16])( this_00 + 0x218 ) = (undefined1[16])0x0;
      ...
      if (this_00 != (RefCounted*)pOVar4) {
         *(RefCounted**)this = this_00;
         ...
         if (( ( pOVar4 != (Object*)0x0 ) && ( cVar2 = RefCounted::unreference() ),cVar2 != '\0' )) {
            LAB_0011831b:( **(code**)( *(long*)pOVar4 + 0x140 ) )(pOVar4);
            Memory::free_static(pOVar4, false);
            pOVar3 = (Object*)this_00;
   ...
   LAB_0011825c:if (lVar1 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }

   LAB_00118358:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
::operator[](HashMap<StringName,int,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,int>>>
 ...
 while ( uVar40 != uVar45 );
         ...
         iVar46 = *(int*)( this + 0x2c );
         LAB_0011886c:if (iVar46 != 0) {
            LAB_00118874:uVar38 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
 ...
 while ( ( uVar52 != 0 ) && ( auVar19._8_8_ = 0 ),auVar19._0_8_ = (ulong)uVar52 * lVar43,auVar35._8_8_ = 0,auVar35._0_8_ = uVar45,auVar20._8_8_ = 0,auVar20._0_8_ = ( ulong )(( uVar38 + uVar53 ) - SUB164(auVar19 * auVar35, 8)) * lVar43,auVar36._8_8_ = 0,auVar36._0_8_ = uVar45,uVar54 <= SUB164(auVar20 * auVar36, 8) );
      ...
      LAB_001184c9:uVar38 = *(uint*)( this + 0x28 );
      if (uVar38 == 0x1c) {
...
;
 ...
 while ( ( uVar52 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = (ulong)uVar52 * lVar49,auVar23._8_8_ = 0,auVar23._0_8_ = uVar40,auVar8._8_8_ = 0,auVar8._0_8_ = ( ulong )(( uVar53 + uVar38 ) - SUB164(auVar7 * auVar23, 8)) * lVar49,auVar24._8_8_ = 0,auVar24._0_8_ = uVar40,uVar54 <= SUB164(auVar8 * auVar24, 8) );
         ...
         LAB_00118868:iVar46 = *(int*)( this + 0x2c );
         goto LAB_0011886c;
      }

      LAB_001184a3:if ((float)uVar40 * __LC45 < (float)( iVar46 + 1 )) goto LAB_001184c9;
   }
   ...
   *(undefined4*)( puVar42 + 3 ) = local_50;
   ...
   if (puVar4 == (undefined8*)0x0) {
      ...
      *(undefined8**)( this + 0x20 ) = puVar42;
      ...
      LAB_00118754:uVar38 = *(uint*)( lVar43 + 0x20 );
   }
 else {
      *puVar4 = puVar42;
      puVar42[1] = puVar4;
      ...
      *(undefined8**)( this + 0x20 ) = puVar42;
      ...
      LAB_0011897d:uVar38 = StringName::get_empty_hash();
   }
...
;
   ...
   *puVar1 = uVar38;
   *(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;
   LAB_0011846c:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return puVar42 + 3;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<Ref<Resource>, int, HashMapHasherDefault, HashMapComparatorDefault<Ref<Resource> >,
   DefaultTypedAllocator<HashMapElement<Ref<Resource>, int> > >::operator[](Ref<Resource> const&) */undefined1[16];HashMap<Ref<Resource>,int,HashMapHasherDefault,HashMapComparatorDefault<Ref<Resource>>,DefaultTypedAllocator<HashMapElement<Ref<Resource>,int>>>::operator [](HashMap<Ref<Resource>,int,HashMapHasherDefault,HashMapComparatorDefault<Ref<Resource>>,DefaultTypedAllocator<HashMapElement<Ref<Resource>,int>>>
             *this,Ref*param_1)

{
 ...
 while ( ( uVar45 != 0 ) && ( auVar6._8_8_ = 0 ),auVar6._0_8_ = (ulong)uVar45 * lVar2,auVar22._8_8_ = 0,auVar22._0_8_ = uVar56,auVar7._8_8_ = 0,auVar7._0_8_ = ( ulong )(( uVar54 + uVar48 ) - SUB164(auVar6 * auVar22, 8)) * lVar2,auVar23._8_8_ = 0,auVar23._0_8_ = uVar56,lVar47 = SUB168(auVar7 * auVar23, 8),uVar52 <= SUB164(auVar7 * auVar23, 8) );
   ...
   LAB_00119043:uVar55 = CONCAT44(0, *(uint*)( hash_table_size_primes + uVar40 * 4 ));
   lVar2 = *(long*)( hash_table_size_primes_inv + uVar40 * 8 );
   uVar39 = (long)pOVar50 * 0x3ffff - 1;
   uVar39 = ( uVar39 ^ uVar39 >> 0x1f ) * 0x15;
   uVar39 = ( uVar39 ^ uVar39 >> 0xb ) * 0x41;
...
}LAB_00118c33:if ((float)uVar56 * __LC45 < (float)( iVar44 + 1 )) {
...
if (( pOVar50 == (Object*)0x0 ) || ( cVar37 = cVar37 == '\0' )) {
   ...
   *(undefined4*)( pauVar42[1] + 8 ) = 0;
   ...
   LAB_00118e93:*(undefined1(**) [16])( this + 0x18 ) = pauVar42;
}
...
;*(undefined1(**) [16])( lVar46 + lStack_90 * 8 ) = pauVar36;*puVar1 = uVar54;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_00119027:auVar60._8_8_ = lStack_90;auVar60._0_8_ = pauVar42[1] + 8;return auVar60;}/* List<Variant, DefaultAllocator>::~List() */void List<Variant,DefaultAllocator>::~List(List<Variant,DefaultAllocator> *this) {
   int *piVar1;
   undefined8 *puVar2;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashSet<Ref<Resource>, HashMapHasherDefault, HashMapComparatorDefault<Ref<Resource> >
   ...
   if (lVar35 == 0) {
      ...
      *in_RSI = lVar35;
      ...
      lVar36 = *in_RDX;
      uVar3 = *(uint*)( (long)in_RSI + 0x24 );
      LAB_00119498:local_88 = (ulong)uVar3;
      if (uVar3 != 0) {
...
;
   ...
   *(uint*)( (long)in_RSI + 0x24 ) = uVar45 + 1;
   uVar3 = uVar45 + 1;
   LAB_001195aa:local_88._0_4_ = uVar3;
...
/* List<ResourceFormatSaverBinaryInstance::Property, DefaultAllocator>::~List() */void List<ResourceFormatSaverBinaryInstance::Property,DefaultAllocator>::~List(List<ResourceFormatSaverBinaryInstance::Property,DefaultAllocator> *this) {
   long *plVar1;
   void *pvVar2;
   long lVar3;
   undefined8 *puVar4;
...
/* List<ResourceFormatSaverBinaryInstance::ResourceData, DefaultAllocator>::~List() */void List<ResourceFormatSaverBinaryInstance::ResourceData,DefaultAllocator>::~List(List<ResourceFormatSaverBinaryInstance::ResourceData,DefaultAllocator> *this) {
   long *plVar1;
   long *plVar2;
   long lVar3;
   long lVar4;
   ...
   do {
      ...
      if ((long*)plVar2[4] == plVar5) {
         ...
         *plVar5 = lVar4;
         ...
         List<ResourceFormatSaverBinaryInstance::Property,DefaultAllocator>::~List((List<ResourceFormatSaverBinaryInstance::Property,DefaultAllocator>*)( plVar2 + 1 ));
         if (*plVar2 != 0) {
            LOCK();
            plVar1 = (long*)( *plVar2 + -0x10 );
            *plVar1 = *plVar1 + -1;
...
;
   ...
   *(int*)( (long)in_RSI + 0x24 ) = iVar37;
   LAB_0011a149:*(int*)( param_1 + 0xc ) = iVar31;
   *(long*)param_1 = lVar33;
...
/* WARNING: Removing unreachable block (ram,0x0011a5c8) *//* WARNING: Removing unreachable block (ram,0x0011a75d) *//* WARNING: Removing unreachable block (ram,0x0011a769) *//* String vformat<String>(String const&, String const) */undefined8 *vformat<String>(undefined8 *param_1, bool *param_2, String *param_3) {
   Variant *this;
   int iVar1;
   long in_FS_OFFSET;
   Array local_c8[8];
...
/* WARNING: Removing unreachable block (ram,0x0011a900) *//* WARNING: Removing unreachable block (ram,0x0011aa95) *//* WARNING: Removing unreachable block (ram,0x0011aaa1) *//* String vformat<String, String>(String const&, String const, String const) */undefined8 *vformat<String,String>(undefined8 *param_1, bool *param_2, String *param_3, String *param_4) {
   Variant *pVVar1;
   Variant *pVVar2;
   int iVar3;
   long in_FS_OFFSET;
...
/* WARNING: Removing unreachable block (ram,0x0011ac70) *//* WARNING: Removing unreachable block (ram,0x0011adfe) *//* WARNING: Removing unreachable block (ram,0x0011ae0a) *//* String vformat<String, unsigned int, unsigned int, unsigned int, char const*>(String const&,
   String const, unsigned int const, unsigned int const, unsigned int const, char const* const) */undefined8 *vformat<String,unsigned_int,unsigned_int,unsigned_int,char_const*>(undefined8 *param_1, bool *param_2, String *param_3, uint param_4, uint param_5, uint param_6, char *param_7) {
   Variant *pVVar1;
   Variant *pVVar2;
   int iVar3;
   int iVar4;
...
/* WARNING: Removing unreachable block (ram,0x0011afb8) *//* WARNING: Removing unreachable block (ram,0x0011b14d) *//* WARNING: Removing unreachable block (ram,0x0011b159) *//* String vformat<String, unsigned int, String, String>(String const&, String const, unsigned int
...
/* RBMap<ResourceFormatSaverBinaryInstance::NonPersistentKey, Variant,
   ...
   DefaultAllocator>::Element*) [clone .part.0] */void RBMap<ResourceFormatSaverBinaryInstance::NonPersistentKey,Variant,Comparator<ResourceFormatSaverBinaryInstance::NonPersistentKey>,DefaultAllocator>::_cleanup_tree(RBMap<ResourceFormatSaverBinaryInstance::NonPersistentKey,Variant,Comparator<ResourceFormatSaverBinaryInstance::NonPersistentKey>,DefaultAllocator> *this, Element *param_1) {
   Element *pEVar1;
   Object *pOVar2;
   char cVar3;
   Element *pEVar4;
...
/* Ref<FileAccessCompressed>::unref() */void Ref<FileAccessCompressed>::unref(Ref<FileAccessCompressed> *this) {
   Object *pOVar1;
   char cVar2;
   if (*(long*)this != 0) {
      cVar2 = RefCounted::unreference();
...
/* void List<String, DefaultAllocator>::sort_custom<Comparator<String> >() */void List<String,DefaultAllocator>::sort_custom<Comparator<String>>(List<String,DefaultAllocator> *this) {
   size_t __n;
   int iVar1;
   undefined8 *puVar2;
   char cVar3;
   ...
   if (*(long**)this != (long*)0x0) {
      ppEVar5 = __src;
      for (pEVar10 = (Element*)**(long**)this; pEVar10 != (Element*)0x0; pEVar10 = *(Element**)( pEVar10 + 8 )) {
         *ppEVar5 = pEVar10;
         ppEVar5 = ppEVar5 + 1;
      }
 ...
 while ( pEVar10 != (Element*)0x1 );
   SortArray<List<String,DefaultAllocator>::Element*,List<String,DefaultAllocator>::AuxiliaryComparator<Comparator<String>>,true>::introsort(0, (long)pEVar4, __src, lVar7 * 2);
   if ((long)pEVar4 < 0x11) {
      pEVar10 = (Element*)0x1;
      pEVar11 = *__src;
      do {
...
;
 ...
 while ( lVar9 + 1 != 0x10 );
      LAB_0011cdb6:pEVar10 = (Element*)( lVar9 + 1 );
      do {
         pSVar8 = (String*)__src[(long)pEVar10];
         ppEVar5 = __src + (long)pEVar10;
         pEVar11 = pEVar10;
...
;
 ...
 while ( pEVar4 != pEVar10 );
   ...
   LAB_0011cf35:puVar2 = *(undefined8**)this;
   *puVar2 = pSVar8;
...
/* RBMap<ResourceFormatSaverBinaryInstance::NonPersistentKey, Variant,
   Comparator<ResourceFormatSaverBinaryInstance::NonPersistentKey>,
   DefaultAllocator>::_Data::_create_root() */void RBMap<ResourceFormatSaverBinaryInstance::NonPersistentKey,Variant,Comparator<ResourceFormatSaverBinaryInstance::NonPersistentKey>,DefaultAllocator>::_Data::_create_root(_Data *this) {
   undefined8 uVar1;
   Object *pOVar2;
   char cVar3;
   undefined4 *puVar4;
...
cVar3 = ::Variant::needs_deinit[(int)local_88];joined_r0x0011d331:if (cVar3 != '\0') {
   ::Variant::_clear_internal();
}
...
/* Error CowData<StringName>::resize<false>(long) */undefined8 CowData<StringName>::resize<false>(CowData<StringName> *this, long param_1) {
   ...
   if (param_1 * 8 == 0) {
      LAB_0011dd50:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
      LAB_0011dbca:/* WARNING: Does not return */pcVar1 = (code*)invalidInstructionException();
      ( *pcVar1 )();
   }
   ...
   if (uVar4 + 1 == lVar3) {
      ...
      lVar7 = puVar5[-1];
      LAB_0011dcb0:if (param_1 <= lVar7) goto LAB_0011dc5d;
   }
 else {
      if (lVar7 != 0) {
         puVar2 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), uVar4 + 0x11, false);
         if (puVar2 == (undefined8*)0x0) {
            LAB_0011dd7f:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
            return 6;
         }
...
::operator[](HashMap<String,String,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,String>>>
 ...
 while ( uVar36 != uVar32 );
         ...
         LAB_0011e3ca:uVar28 = (uint)uVar36;
         iVar33 = *(int*)( this + 0x2c );
         if (iVar33 != 0) {
            LAB_0011e3d7:uVar39 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
 ...
 while ( ( uVar40 != 0 ) && ( auVar12._8_8_ = 0 ),auVar12._0_8_ = (ulong)uVar40 * lVar38,auVar24._8_8_ = 0,auVar24._0_8_ = uVar36,auVar13._8_8_ = 0,auVar13._0_8_ = ( ulong )(( uVar39 + uVar45 ) - SUB164(auVar12 * auVar24, 8)) * lVar38,auVar25._8_8_ = 0,auVar25._0_8_ = uVar36,uVar46 <= SUB164(auVar13 * auVar25, 8) );
      ...
      LAB_0011e08a:if (*(int*)( this + 0x28 ) == 0x1c) {
         _err_print_error("_insert", "./core/templates/hash_map.h", 0xdd, "Condition \"capacity_index + 1 == HASH_TABLE_SIZE_MAX\" is true. Returning: nullptr", "Hash table maximum capacity reached, aborting insertion.", 0, 0);
         local_88 = (undefined1(*) [16])0x0;
         goto LAB_0011e288;
      }
 ...
 while ( ( uVar29 != 0 ) && ( auVar8._8_8_ = 0 ),auVar8._0_8_ = (ulong)uVar29 * lVar38,auVar20._8_8_ = 0,auVar20._0_8_ = uVar36,auVar9._8_8_ = 0,auVar9._0_8_ = ( ulong )(( uVar40 + uVar28 ) - SUB164(auVar8 * auVar20, 8)) * lVar38,auVar21._8_8_ = 0,auVar21._0_8_ = uVar36,uVar45 <= SUB164(auVar9 * auVar21, 8) );
      ...
      local_70 = 0;
      iVar33 = 0;
      LAB_0011e068:if ((float)uVar36 * __LC45 < (float)( iVar33 + 1 )) goto LAB_0011e08a;
   }
 ...
 while ( uVar39 != 0 );
   ...
   *(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;
   ...
   LAB_0011e288:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<String, String, HashMapHasherDefault, HashMapComparatorDefault<String>,
 ...
 while ( uVar34 != uVar22 );
      ...
      LAB_0011e731:if (*(int*)( param_2 + 0x28 ) == 0x1c) {
         plVar19 = (long*)0x0;
         _err_print_error("_insert", "./core/templates/hash_map.h", 0xdd, "Condition \"capacity_index + 1 == HASH_TABLE_SIZE_MAX\" is true. Returning: nullptr", "Hash table maximum capacity reached, aborting insertion.", 0, 0);
         goto LAB_0011e939;
      }
      ...
      LAB_0011e6ff:iVar24 = *(int*)( param_2 + 0x2c );
      if (iVar24 != 0) {
         LAB_0011e988:uVar18 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( param_2 + 0x28 ) * 4 );
 ...
 while ( ( uVar31 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = (ulong)uVar31 * lVar33,auVar15._8_8_ = 0,auVar15._0_8_ = uVar22,auVar8._8_8_ = 0,auVar8._0_8_ = ( ulong )(( uVar18 + uVar25 ) - SUB164(auVar7 * auVar15, 8)) * lVar33,auVar16._8_8_ = 0,auVar16._0_8_ = uVar22,uVar37 <= SUB164(auVar8 * auVar16, 8) );
      ...
      LAB_0011e70f:if ((float)uVar23 * __LC45 < (float)( iVar24 + 1 )) goto LAB_0011e731;
   }
   ...
   *plVar19 = 0;
   ...
   if (local_58 == 0) {
      ...
      LAB_0011e812:puVar20 = *(undefined8**)( param_2 + 0x20 );
      if (puVar20 != (undefined8*)0x0) goto LAB_0011e820;
      LAB_0011eace:*(long**)( param_2 + 0x18 ) = plVar19;
      *(long**)( param_2 + 0x20 ) = plVar19;
      ...
      plVar19[3] = 0;
      if (lVar33 != 0) {
         LAB_0011e7e2:CowData<char32_t>::_ref((CowData<char32_t>*)( plVar19 + 3 ), (CowData*)local_50);
         LOCK();
 ...
 while ( uVar30 != 0 );
   ...
   *(int*)( param_2 + 0x2c ) = *(int*)( param_2 + 0x2c ) + 1;
   LAB_0011e939:*(long**)param_1 = plVar19;
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* HashMap<String, String, HashMapHasherDefault, HashMapComparatorDefault<String>,
 ...
 while ( uVar3 != 0x1c );
      ...
      LAB_0011ed69:if (( *(long*)( param_1 + 8 ) != 0 ) && ( plVar6 = *(long**)( param_1 + 0x18 ) ),plVar6 != (long*)0x0) {
         do {
...
/* CowData<ResourceLoaderBinary::ExtResource>::_unref() */void CowData<ResourceLoaderBinary::ExtResource>::_unref(CowData<ResourceLoaderBinary::ExtResource> *this) {
   long *plVar1;
   long *plVar2;
   long lVar3;
   long lVar4;
...
/* CowData<ResourceLoaderBinary::IntResource>::_unref() */void CowData<ResourceLoaderBinary::IntResource>::_unref(CowData<ResourceLoaderBinary::IntResource> *this) {
   long *plVar1;
   long *plVar2;
   long lVar3;
   long lVar4;
...
/* ResourceLoaderBinary::~ResourceLoaderBinary() */void ResourceLoaderBinary::~ResourceLoaderBinary(ResourceLoaderBinary *this) {
   long *plVar1;
   uint uVar2;
   long lVar3;
   Object *pOVar4;
 ...
 while ( (ulong)uVar2 << 2 != lVar6 );
   ...
   LAB_0011f1bf:pvVar7 = *(void**)( this + 0xe8 );
   if (pvVar7 != (void*)0x0) {
      if (*(int*)( this + 0x10c ) != 0) {
 ...
 while ( (ulong)uVar2 << 2 != lVar6 );
   ...
   LAB_0011f2b9:pvVar7 = *(void**)( this + 0xb8 );
   if (pvVar7 != (void*)0x0) {
      if (*(int*)( this + 0xdc ) != 0) {
 ...
 while ( lVar6 != (ulong)uVar2 << 2 );
   ...
   LAB_0011f3a5:CowData<ResourceLoaderBinary::IntResource>::_unref((CowData<ResourceLoaderBinary::IntResource>*)( this + 0xa8 ));
   CowData<ResourceLoaderBinary::ExtResource>::_unref((CowData<ResourceLoaderBinary::ExtResource>*)( this + 0x98 ));
   if (*(long*)( this + 0x78 ) != 0) {
      LOCK();
...
/* Error CowData<ResourceLoaderBinary::ExtResource>::resize<false>(long) */undefined8 CowData<ResourceLoaderBinary::ExtResource>::resize<false>(CowData<ResourceLoaderBinary::ExtResource> *this, long param_1) {
   long *plVar1;
   Object *pOVar2;
   code *pcVar3;
   char cVar4;
   ...
   if (param_1 * 0x20 == 0) {
      LAB_0011f9e0:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
      LAB_0011fa5d:/* WARNING: Does not return */pcVar3 = (code*)invalidInstructionException();
      ( *pcVar3 )();
   }
   ...
   if (uVar12 + 1 == lVar11) {
      ...
      lVar10 = puVar8[-1];
      LAB_0011f940:if (param_1 <= lVar10) goto LAB_0011f805;
   }
 else {
      if (lVar10 != 0) {
         puVar5 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), uVar12 + 0x11, false);
         if (puVar5 == (undefined8*)0x0) {
            LAB_0011fa0f:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
            return 6;
         }
 ...
 while ( (undefined1(*) [16])( puVar8 + param_1 * 4 ) != pauVar7 );
   LAB_0011f805:puVar8[-1] = param_1;
   return 0;
}
/* Error CowData<ResourceLoaderBinary::IntResource>::resize<false>(long) */undefined8 CowData<ResourceLoaderBinary::IntResource>::resize<false>(CowData<ResourceLoaderBinary::IntResource> *this, long param_1) {
   long *plVar1;
   code *pcVar2;
   long *plVar3;
   undefined8 *puVar4;
   ...
   if (param_1 * 0x10 == 0) {
      LAB_0011fd78:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
      LAB_0011fdf5:/* WARNING: Does not return */pcVar2 = (code*)invalidInstructionException();
      ( *pcVar2 )();
   }
   ...
   if (uVar9 + 1 == lVar8) {
      ...
      lVar11 = puVar7[-1];
      LAB_0011fcd0:if (param_1 <= lVar11) goto LAB_0011fc80;
   }
 else {
      if (lVar11 != 0) {
         puVar5 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), uVar9 + 0x11, false);
         if (puVar5 == (undefined8*)0x0) {
            LAB_0011fda7:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
            return 6;
         }
 ...
 while ( puVar4 != puVar6 );
   LAB_0011fc80:puVar7[-1] = param_1;
   return 0;
}
/* CowData<Ref<Resource> >::_unref() */void CowData<Ref<Resource>>::_unref(CowData<Ref<Resource>> *this) {
   long *plVar1;
   long lVar2;
   Object *pOVar3;
   code *pcVar4;
...
/* CowData<unsigned long>::_unref() */void CowData<unsigned_long>::_unref(CowData<unsigned_long> *this) {
   long *plVar1;
   long lVar2;
   if (*(long*)this == 0) {
      return;
      ...
      if (uVar4 != 0xffffffffffffffff) {
         if (lVar7 < param_1) {
            ...
            if (uVar4 + 1 == lVar3) {
               ...
               if (puVar6 == (undefined8*)0x0) {
                  LAB_001201a0:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
                  return 6;
               }
...
/* RBMap<ResourceFormatSaverBinaryInstance::NonPersistentKey, Variant,
   ...
   Variant, Comparator<ResourceFormatSaverBinaryInstance::NonPersistentKey>,
   DefaultAllocator>::Element*) */void RBMap<ResourceFormatSaverBinaryInstance::NonPersistentKey,Variant,Comparator<ResourceFormatSaverBinaryInstance::NonPersistentKey>,DefaultAllocator>::_insert_rb_fix(RBMap<ResourceFormatSaverBinaryInstance::NonPersistentKey,Variant,Comparator<ResourceFormatSaverBinaryInstance::NonPersistentKey>,DefaultAllocator> *this, Element *param_1) {
   int iVar1;
   long lVar2;
   long lVar3;
   Element *pEVar4;
      ...
      while (true) {
         ...
         if (*(Element**)( pEVar7 + 0x10 ) == param_1) {
            ...
            *(int*)pEVar7 = 1;
            ...
            LAB_00120418:_err_print_error("_set_color", "./core/templates/rb_map.h", 0xed, "Condition \"p_node == _data._nil && p_color == RED\" is true.", 0, 0);
         }
...
;
      ...
      if (*(int*)pEVar5 != 0) {
         if (*(Element**)( pEVar7 + 8 ) == param_1) {
            ...
            *(int*)pEVar7 = 1;
            ...
            LAB_001204e0:_err_print_error("_set_color", "./core/templates/rb_map.h", 0xed, "Condition \"p_node == _data._nil && p_color == RED\" is true.", 0, 0);
         }
      ...
      LAB_001202fa:pEVar6 = *(Element**)( this + 8 );
      *(int*)pEVar7 = 1;
      *(int*)pEVar5 = 1;
      if (pEVar4 == pEVar6) {
...
/* RBMap<ResourceFormatSaverBinaryInstance::NonPersistentKey, Variant,
   ...
   const&) */Element * __thiscallRBMap<ResourceFormatSaverBinaryInstance::NonPersistentKey,Variant,Comparator<ResourceFormatSaverBinaryInstance::NonPersistentKey>,DefaultAllocator>::_insert(RBMap<ResourceFormatSaverBinaryInstance::NonPersistentKey,Variant,Comparator<ResourceFormatSaverBinaryInstance::NonPersistentKey>,DefaultAllocator> * this, NonPersistentKey * param_1, Variant * param_2) * pOVar1 ;undefined8 uVar2char cVar3Element *pEVar4Element *pEVar5Element *pEVar6Element *pEVar7Element *pEVar8Element *pEVar9long in_FS_OFFSETbool bVar10Object *local_68long local_60int local_58[6]long local_40local_40 = *(long*)( in_FS_OFFSET + 0x28 );pEVar7 = *(Element**)this;if (*(Element**)( pEVar7 + 0x10 ) != *(Element**)( this + 8 )) {
   ...
   do {
      ...
      if (*(ulong*)param_1 == *(ulong*)( pEVar7 + 0x30 )) {
         ...
         LAB_00120580:pEVar4 = *(Element**)( pEVar7 + 8 );
      }
 else {
         if (*(ulong*)( pEVar7 + 0x30 ) <= *(ulong*)param_1) goto LAB_00120580;
         LAB_00120568:pEVar4 = *(Element**)( pEVar7 + 0x10 );
      }

   }
 while ( *(Element**)( this + 8 ) != pEVar4 );
}
pEVar4 = (Element*)operator_new(0x58, DefaultAllocator::alloc);pOVar1 = *(Object**)param_1;local_68 = (Object*)0x0;if (( pOVar1 != (Object*)0x0 ) && ( cVar3 = RefCounted::reference() ),local_68 = pOVar1,cVar3 == '\0') {
   local_68 = (Object*)0x0;
}
StringName::StringName((StringName*)&local_60, (StringName*)( param_1 + 8 ));::Variant::Variant((Variant*)local_58, param_2);*(undefined4*)pEVar4 = 0;*(undefined1(*) [16])( pEVar4 + 8 ) = (undefined1[16])0x0;*(undefined1(*) [16])( pEVar4 + 0x18 ) = (undefined1[16])0x0;*(undefined1(*) [16])( pEVar4 + 0x28 ) = (undefined1[16])0x0;if (local_68 != (Object*)0x0) {
...
StringName::StringName((StringName*)( pEVar4 + 0x38 ), (StringName*)&local_60);::Variant::Variant((Variant*)( pEVar4 + 0x40 ), (Variant*)local_58);if (::Variant::needs_deinit[local_58[0]] != '\0') {
   ::Variant::_clear_internal();
}
if (( StringName::configured != '\0' ) && ( local_60 != 0 )) {
   StringName::unref();
}
if (( ( local_68 != (Object*)0x0 ) && ( cVar3 = RefCounted::unreference() ),cVar3 != '\0' )) &&( cVar3 = cVar3 != '\0' )(**(code**)( *(long*)local_68 + 0x140 ))(local_68);Memory::free_static(local_68, false);}*(Element**)( pEVar4 + 0x18 ) = pEVar7;uVar2 = *(undefined8*)( this + 8 );*(undefined8*)( pEVar4 + 8 ) = uVar2;*(undefined8*)( pEVar4 + 0x10 ) = uVar2;if (*(Element**)this == pEVar7) {
   LAB_001206a4:*(Element**)( pEVar7 + 0x10 ) = pEVar4;
   pEVar7 = *(Element**)( this + 8 );
   pEVar9 = *(Element**)this;
   pEVar6 = pEVar4;
...
*(Element**)( pEVar4 + 0x20 ) = pEVar5;pEVar9 = *(Element**)( pEVar4 + 0x10 );pEVar7 = pEVar4;if (*(Element**)( this + 8 ) == *(Element**)( pEVar4 + 0x10 )) {
   do {
      pEVar9 = pEVar7;
 ...
 while ( pEVar9 == *(Element**)( pEVar7 + 0x10 ) );
   ...
   *(undefined8*)( pEVar4 + 0x28 ) = 0;
   ...
   LAB_001206fd:*(Element**)( pEVar5 + 0x28 ) = pEVar4;
 ...
 while ( *(Element**)( this + 8 ) != *(Element**)( pEVar7 + 8 ) );
   LAB_001206f4:*(Element**)( pEVar4 + 0x28 ) = pEVar7;
   if (pEVar5 != (Element*)0x0) goto LAB_001206fd;
}
*(Element**)( pEVar7 + 0x20 ) = pEVar4;LAB_0012070e:*(int*)( this + 0x10 ) = *(int*)( this + 0x10 ) + 1;_insert_rb_fix(this, pEVar4);pEVar7 = pEVar4;LAB_0012074a:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return pEVar7;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* void memdelete_allocator<RBMap<ResourceFormatSaverBinaryInstance::NonPersistentKey, Variant,
   ...
   Comparator<ResourceFormatSaverBinaryInstance::NonPersistentKey>, DefaultAllocator>::Element*) */void memdelete_allocator<RBMap<ResourceFormatSaverBinaryInstance::NonPersistentKey,Variant,Comparator<ResourceFormatSaverBinaryInstance::NonPersistentKey>,DefaultAllocator>::Element,DefaultAllocator>(Element *param_1) {
   Object *pOVar1;
   char cVar2;
   if (Variant::needs_deinit[*(int*)( param_1 + 0x40 )] != '\0') {
      Variant::_clear_internal();
...
/* ResourceFormatSaverBinaryInstance::~ResourceFormatSaverBinaryInstance() */void ResourceFormatSaverBinaryInstance::~ResourceFormatSaverBinaryInstance(ResourceFormatSaverBinaryInstance *this) {
   RBMap<ResourceFormatSaverBinaryInstance::NonPersistentKey,Variant,Comparator<ResourceFormatSaverBinaryInstance::NonPersistentKey>,DefaultAllocator> *this_00;
   long *plVar1;
   uint uVar2;
   Element *pEVar3;
   Object *pOVar4;
 ...
 while ( (ulong)uVar2 << 2 != lVar7 );
   ...
   LAB_001209ff:CowData<StringName>::_unref((CowData<StringName>*)( this + 0x98 ));
 ...
 while ( (ulong)uVar2 << 2 != lVar7 );
   ...
   LAB_00120ac1:lVar7 = *(long*)( this + 0x48 );
   if (lVar7 != 0) {
      pEVar3 = *(Element**)( lVar7 + 0x10 );
      pEVar6 = *(Element**)( this + 0x50 );
      if (pEVar3 != pEVar6) {
         pEVar11 = *(Element**)( pEVar3 + 0x10 );
         this_00 = (RBMap<ResourceFormatSaverBinaryInstance::NonPersistentKey,Variant,Comparator<ResourceFormatSaverBinaryInstance::NonPersistentKey>,DefaultAllocator>*)( this + 0x48 );
         if (pEVar6 != pEVar11) {
            pEVar8 = *(Element**)( pEVar11 + 0x10 );
            if (pEVar6 != pEVar8) {
               pEVar9 = *(Element**)( pEVar8 + 0x10 );
               if (pEVar6 != pEVar9) {
                  RBMap<ResourceFormatSaverBinaryInstance::NonPersistentKey,Variant,Comparator<ResourceFormatSaverBinaryInstance::NonPersistentKey>,DefaultAllocator>::_cleanup_tree(this_00, pEVar9);
                  pEVar9 = *(Element**)( this + 0x50 );
               }

               if (pEVar9 != *(Element**)( pEVar8 + 8 )) {
                  RBMap<ResourceFormatSaverBinaryInstance::NonPersistentKey,Variant,Comparator<ResourceFormatSaverBinaryInstance::NonPersistentKey>,DefaultAllocator>::_cleanup_tree(this_00, *(Element**)( pEVar8 + 8 ));
               }
            ...
            if (pEVar6 != pEVar8) {
               if (*(Element**)( pEVar6 + 0x10 ) != pEVar8) {
                  RBMap<ResourceFormatSaverBinaryInstance::NonPersistentKey,Variant,Comparator<ResourceFormatSaverBinaryInstance::NonPersistentKey>,DefaultAllocator>::_cleanup_tree(this_00, *(Element**)( pEVar6 + 0x10 ));
                  pEVar8 = *(Element**)( this + 0x50 );
               }

               if (pEVar8 != *(Element**)( pEVar6 + 8 )) {
                  RBMap<ResourceFormatSaverBinaryInstance::NonPersistentKey,Variant,Comparator<ResourceFormatSaverBinaryInstance::NonPersistentKey>,DefaultAllocator>::_cleanup_tree(this_00, *(Element**)( pEVar6 + 8 ));
               }
            ...
            memdelete_allocator<RBMap<ResourceFormatSaverBinaryInstance::NonPersistentKey,Variant,Comparator<ResourceFormatSaverBinaryInstance::NonPersistentKey>,DefaultAllocator>::Element,DefaultAllocator>(pEVar11);
         ...
         if (pEVar6 != pEVar11) {
            ...
            if (pEVar11 != pEVar8) {
               if (*(Element**)( pEVar11 + 0x10 ) != pEVar8) {
                  RBMap<ResourceFormatSaverBinaryInstance::NonPersistentKey,Variant,Comparator<ResourceFormatSaverBinaryInstance::NonPersistentKey>,DefaultAllocator>::_cleanup_tree(this_00, *(Element**)( pEVar11 + 0x10 ));
                  pEVar8 = *(Element**)( this + 0x50 );
               }

               if (pEVar8 != *(Element**)( pEVar11 + 8 )) {
                  RBMap<ResourceFormatSaverBinaryInstance::NonPersistentKey,Variant,Comparator<ResourceFormatSaverBinaryInstance::NonPersistentKey>,DefaultAllocator>::_cleanup_tree(this_00, *(Element**)( pEVar11 + 8 ));
               }
            ...
            memdelete_allocator<RBMap<ResourceFormatSaverBinaryInstance::NonPersistentKey,Variant,Comparator<ResourceFormatSaverBinaryInstance::NonPersistentKey>,DefaultAllocator>::Element,DefaultAllocator>(pEVar6);
         }

         memdelete_allocator<RBMap<ResourceFormatSaverBinaryInstance::NonPersistentKey,Variant,Comparator<ResourceFormatSaverBinaryInstance::NonPersistentKey>,DefaultAllocator>::Element,DefaultAllocator>(pEVar3);
      ...
      *(undefined4*)( this + 0x58 ) = 0;
      if (*(Element**)( this + 0x48 ) != (Element*)0x0) {
         memdelete_allocator<RBMap<ResourceFormatSaverBinaryInstance::NonPersistentKey,Variant,Comparator<ResourceFormatSaverBinaryInstance::NonPersistentKey>,DefaultAllocator>::Element,DefaultAllocator>(*(Element**)( this + 0x48 ));
      }
   ...
   if (*(int*)( this + 0x44 ) != 0) {
      if (*(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x40 ) * 4 ) != 0) {
         memset(*(void**)( this + 0x38 ), 0, ( ulong ) * (uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x40 ) * 4 ) << 2);
...
/* WARNING: Control flow encountered bad instruction data *//* ResourceFormatSaverBinary::~ResourceFormatSaverBinary() */void ResourceFormatSaverBinary::~ResourceFormatSaverBinary(ResourceFormatSaverBinary *this) {
...
/* WARNING: Control flow encountered bad instruction data *//* ResourceLoaderBinary::~ResourceLoaderBinary() */void ResourceLoaderBinary::~ResourceLoaderBinary(ResourceLoaderBinary *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* ResourceFormatSaverBinaryInstance::~ResourceFormatSaverBinaryInstance() */void ResourceFormatSaverBinaryInstance::~ResourceFormatSaverBinaryInstance(ResourceFormatSaverBinaryInstance *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* List<ResourceFormatSaverBinaryInstance::ResourceData, DefaultAllocator>::~List() */void List<ResourceFormatSaverBinaryInstance::ResourceData,DefaultAllocator>::~List(List<ResourceFormatSaverBinaryInstance::ResourceData,DefaultAllocator> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* List<ResourceFormatSaverBinaryInstance::Property, DefaultAllocator>::~List() */void List<ResourceFormatSaverBinaryInstance::Property,DefaultAllocator>::~List(List<ResourceFormatSaverBinaryInstance::Property,DefaultAllocator> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* ResourceFormatLoaderBinary::~ResourceFormatLoaderBinary() */void ResourceFormatLoaderBinary::~ResourceFormatLoaderBinary(ResourceFormatLoaderBinary *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

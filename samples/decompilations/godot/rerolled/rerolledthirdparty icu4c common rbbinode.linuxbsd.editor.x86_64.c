/* icu_76_godot::RBBINode::RBBINode(icu_76_godot::RBBINode::NodeType) */void icu_76_godot::RBBINode::RBBINode(RBBINode *this, UErrorCode *param_2) {
   UVector *pUVar1;
   int iVar2;
   long in_FS_OFFSET;
   undefined4 local_24;
...
/* icu_76_godot::RBBINode::RBBINode(icu_76_godot::RBBINode const&) */void icu_76_godot::RBBINode::RBBINode(RBBINode *this, RBBINode *param_1) {
   undefined8 uVar1;
   UVector *pUVar2;
   UErrorCode *pUVar3;
   long in_FS_OFFSET;
...
/* icu_76_godot::RBBINode::cloneTree() */RBBINode *icu_76_godot::RBBINode::cloneTree(void) {
   int iVar1;
   RBBINode *this;
   long lVar2;
   ulong in_RSI;
...
/* icu_76_godot::RBBINode::findNodes(icu_76_godot::UVector*, icu_76_godot::RBBINode::NodeType,
   UErrorCode&) */void icu_76_godot::RBBINode::findNodes(RBBINode *this, void *param_1, int param_3, int *param_4) {
   do {
      if (0 < *param_4) {
         return;
      }
...
/* icu_76_godot::RBBINode::~RBBINode() */void icu_76_godot::RBBINode::~RBBINode(RBBINode *this) {
   RBBINode *in_RSI;
   ...
   *(undefined8*)( this + 0x20 ) = 0;
   ...
   for (int i = 0; i < 3; i++) {
      if (*(long**)( this + ( 8*i + 136 ) ) != (long*)0) {
         ( **(code**)( **(long**)( this + ( 8*i + 136 ) ) + 8 ) )();
      }
...
/* icu_76_godot::RBBINode::NRDeleteNode(icu_76_godot::RBBINode*) */void icu_76_godot::RBBINode::NRDeleteNode(RBBINode *this, RBBINode *param_1) {
   RBBINode *pRVar1;
   RBBINode *pRVar2;
   if (this != (RBBINode*)0x0) {
      ...
      if (this != pRVar1) {
         do {
            ...
            if (( ( pRVar2 == (RBBINode*)0x0 ) && ( pRVar2 = *(RBBINode**)( this + 0x18 ) ),pRVar2 == (RBBINode*)0x0 )) {
...
/* icu_76_godot::RBBINode::flattenVariables(UErrorCode&, int) */RBBINode * __thiscall
...
/* icu_76_godot::RBBINode::flattenSets() */void icu_76_godot::RBBINode::flattenSets(void) {
   long lVar1;
   RBBINode *pRVar2;
   RBBINode *pRVar3;
   void *in_RSI;

/* EditorFileSystemImportFormatSupportQueryBlend::_path_confirmed() */void EditorFileSystemImportFormatSupportQueryBlend::_path_confirmed(EditorFileSystemImportFormatSupportQueryBlend *this) {
   this[0x1f0] = (EditorFileSystemImportFormatSupportQueryBlend)0x1;
   return;
}
/* EditorFileSystemImportFormatSupportQueryBlend::_update_icons() */void EditorFileSystemImportFormatSupportQueryBlend::_update_icons(EditorFileSystemImportFormatSupportQueryBlend *this) {
   Ref *pRVar1;
   char cVar2;
   int iVar3;
   long in_FS_OFFSET;
   ...
   if (_update_icons()::{lambda()
   #1
   iVar3 = __cxa_guard_acquire(&_update_icons()::, {
         lambda()
         #1
         if (iVar3 != 0) {
            _scs_create((char *)&_update_icons()::{lambda()
            #1
            __cxa_atexit(StringName::~StringName, &_update_icons()::, {
                  lambda()
                  #1
                  &__dso_handle;
  ...
  Control::get_editor_theme_icon((StringName *)&local_28);, Button::set_button_icon(pRVar1));
...
, /* CowData<char32_t>::_ref(CowData<char32_t> const&) [clone .part.0] */, void __thiscall CowData<char32_t>::_ref(CowData<char32_t> *this, CowData * param_1);
            {
               long *plVar1;
               long lVar2;
               long lVar3;
 ...
 while ( !bVar4 );
   ...
   const&) [clone .isra.0] */
            void List<ResourceImporter::ImportOption,DefaultAllocator>::push_back(List<ResourceImporter::ImportOption,DefaultAllocator> *this, ImportOption *param_1) {
               undefined8 uVar1;
               long *plVar2;
               long lVar3;
               undefined4 *puVar4;
            ...
            void EditorSceneFormatImporterBlend::get_extensions(EditorSceneFormatImporterBlend *this, List *param_1) {
               long *plVar1;
               long lVar2;
               long lVar3;
            ...
            void EditorFileSystemImportFormatSupportQueryBlend::EditorFileSystemImportFormatSupportQueryBlend(EditorFileSystemImportFormatSupportQueryBlend *this) {
               ...
               *(undefined8*)( this + 0x1f8 ) = 0;
               for (int i = 0; i < 3; i++) {
                  *(undefined1(*) [16])( this + ( 16*i + 448 ) ) = (undefined1[16])0;
               }
            ...
            void EditorFileSystemImportFormatSupportQueryBlend::_browse_install(EditorFileSystemImportFormatSupportQueryBlend *this) {
               long *plVar1;
               String *pSVar2;
               long lVar3;
               char cVar4;
   ...
   List<ResourceImporter::ImportOption, DefaultAllocator>*) */
            void EditorSceneFormatImporterBlend::get_import_options(EditorSceneFormatImporterBlend *this, String *param_1, List *param_2) {
               char cVar1;
               int iVar2;
               long in_FS_OFFSET;
               undefined8 local_f0;
...
, }
  PropertyInfo::PropertyInfo
            ((PropertyInfo *)local_d8,2,(CowData<char32_t>*)&local_f0,2,(String*)&local_e8,6,(CowData<char32_t>*)&local_e0;
...
if (get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
   ...
   #2
      ...
      String::parse_latin1
                 ...
                 *(char **)(get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                            ::{lambda()#2}
  }PropertyInfo::PropertyInfo((PropertyInfo*)local_d8, 1, (CowData<char32_t>*)&local_f0, 0, (String*)&local_e8, 6, (CowData<char32_t>*)&local_e0);PropertyInfo::PropertyInfo(local_88, (PropertyInfo*)local_d8);Variant::Variant(local_58, (Variant*)local_a8);List<ResourceImporter::ImportOption,DefaultAllocator>::push_back((List<ResourceImporter::ImportOption,DefaultAllocator>*)param_2, (ImportOption*)local_88);ResourceImporter::ImportOption::~ImportOption((ImportOption*)local_88);PropertyInfo::~PropertyInfo((PropertyInfo*)local_d8);CowData<char32_t>::_unref((CowData<char32_t>*)&local_f0);CowData<char32_t>::_unref((CowData<char32_t>*)&local_e8);if (( StringName::configured != '\0' ) && ( local_e0 != 0 )) {
   StringName::unref();
}
if (Variant::needs_deinit[local_a8[0]] != '\0') {
   Variant::_clear_internal();
}
Variant::Variant((Variant*)local_a8, true);local_e0 = 0;local_e8 = 0;String::parse_latin1((String*)&local_e8, "");if ((get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
       {lambda()#3(iVar2 = __cxa_guard_acquire(&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                                   ::{lambda()#3_scs_create((char *)&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#3__cxa_atexit(StringName::~StringName,
                 &get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                  ::{lambda()#3__cxa_guard_release (&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#3}
  if (get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
      {lambda()#3local_f0 = 0;}
  else{
...
Variant::Variant((Variant*)local_a8, true);local_e0 = 0;local_e8 = 0;String::parse_latin1((String*)&local_e8, "");if ((get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
       {lambda()#4(iVar2 = __cxa_guard_acquire(&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                                   ::{lambda()#4_scs_create((char *)&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#4__cxa_atexit(StringName::~StringName,
                 &get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                  ::{lambda()#4__cxa_guard_release (&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#4}
  if (get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
      {lambda()#4local_f0 = 0;}
  else{
...
Variant::Variant((Variant*)local_a8, true);local_e0 = 0;local_e8 = 0;String::parse_latin1((String*)&local_e8, "");if ((get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
       {lambda()#5(iVar2 = __cxa_guard_acquire(&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                                   ::{lambda()#5_scs_create((char *)&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#5__cxa_atexit(StringName::~StringName,
                 &get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                  ::{lambda()#5__cxa_guard_release (&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#5}
  if (get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
      {lambda()#5local_f0 = 0;}
  else{
...
Variant::Variant((Variant*)local_a8, 1);local_e0 = 0;local_e8 = 0;String::parse_latin1((String*)&local_e8, "No Modifiers,All Modifiers");if ((get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
       {lambda()#6(iVar2 = __cxa_guard_acquire(&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                                   ::{lambda()#6_scs_create((char *)&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#6__cxa_atexit(StringName::~StringName,
                 &get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                  ::{lambda()#6__cxa_guard_release (&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#6}
  if (get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
      {lambda()#6local_f0 = 0;}
  else{
   ...
   #6
      ...
      String::parse_latin1
                 ...
                 *(char **)(get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                            ::{lambda()#6}
  }PropertyInfo::PropertyInfo((PropertyInfo*)local_d8, 2, (CowData<char32_t>*)&local_f0, 2, (String*)&local_e8, 6, (CowData<char32_t>*)&local_e0);PropertyInfo::PropertyInfo(local_88, (PropertyInfo*)local_d8);Variant::Variant(local_58, (Variant*)local_a8);List<ResourceImporter::ImportOption,DefaultAllocator>::push_back((List<ResourceImporter::ImportOption,DefaultAllocator>*)param_2, (ImportOption*)local_88);ResourceImporter::ImportOption::~ImportOption((ImportOption*)local_88);PropertyInfo::~PropertyInfo((PropertyInfo*)local_d8);CowData<char32_t>::_unref((CowData<char32_t>*)&local_f0);CowData<char32_t>::_unref((CowData<char32_t>*)&local_e8);if (( StringName::configured != '\0' ) && ( local_e0 != 0 )) {
   StringName::unref();
}
if (Variant::needs_deinit[local_a8[0]] != '\0') {
   Variant::_clear_internal();
}
Variant::Variant((Variant*)local_a8, false);local_e0 = 0;local_e8 = 0;String::parse_latin1((String*)&local_e8, "");if ((get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
       {lambda()#7(iVar2 = __cxa_guard_acquire(&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                                   ::{lambda()#7_scs_create((char *)&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#7__cxa_atexit(StringName::~StringName,
                 &get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                  ::{lambda()#7__cxa_guard_release (&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#7}
  if (get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
      {lambda()#7local_f0 = 0;}
  else{
...
Variant::Variant((Variant*)local_a8, true);local_e0 = 0;local_e8 = 0;String::parse_latin1((String*)&local_e8, "");if ((get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
       {lambda()#8(iVar2 = __cxa_guard_acquire(&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                                   ::{lambda()#8_scs_create((char *)&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#8__cxa_atexit(StringName::~StringName,
                 &get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                  ::{lambda()#8__cxa_guard_release (&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#8}
  if (get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
      {lambda()#8local_f0 = 0;}
  else{
...
Variant::Variant((Variant*)local_a8, true);local_e0 = 0;local_e8 = 0;String::parse_latin1((String*)&local_e8, "");if ((get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
       {lambda()#9(iVar2 = __cxa_guard_acquire(&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                                   ::{lambda()#9_scs_create((char *)&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#9__cxa_atexit(StringName::~StringName,
                 &get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                  ::{lambda()#9__cxa_guard_release (&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#9}
  if (get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
      {lambda()#9local_f0 = 0;}
  else{
...
Variant::Variant((Variant*)local_a8, false);local_e0 = 0;local_e8 = 0;String::parse_latin1((String*)&local_e8, "");if ((get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
       {lambda()#10(iVar2 = __cxa_guard_acquire(&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                                   ::{lambda()#10_scs_create((char *)&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#10__cxa_atexit(StringName::~StringName,
                 &get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                  ::{lambda()#10__cxa_guard_release (&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#10}
  if (get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
      {lambda()#10local_f0 = 0;}
  else{
...
Variant::Variant((Variant*)local_a8, true);local_e0 = 0;local_e8 = 0;String::parse_latin1((String*)&local_e8, "");if ((get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
       {lambda()#11(iVar2 = __cxa_guard_acquire(&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                                   ::{lambda()#11_scs_create((char *)&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#11__cxa_atexit(StringName::~StringName,
                 &get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                  ::{lambda()#11__cxa_guard_release (&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#11}
  if (get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
      {lambda()#11local_f0 = 0;}
  else{
...
Variant::Variant((Variant*)local_a8, 2);local_e0 = 0;local_e8 = 0;String::parse_latin1((String*)&local_e8, "None,4 Influences (Compatible),All Influences");if ((get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
       {lambda()#12(iVar2 = __cxa_guard_acquire(&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                                   ::{lambda()#12_scs_create((char *)&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#12__cxa_atexit(StringName::~StringName,
                 &get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                  ::{lambda()#12__cxa_guard_release (&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#12}
  if (get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
      {lambda()#12local_f0 = 0;}
  else{
...
Variant::Variant((Variant*)local_a8, false);local_e0 = 0;local_e8 = 0;String::parse_latin1((String*)&local_e8, "");if ((get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
       {lambda()#13(iVar2 = __cxa_guard_acquire(&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                                   ::{lambda()#13_scs_create((char *)&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#13__cxa_atexit(StringName::~StringName,
                 &get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                  ::{lambda()#13__cxa_guard_release (&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#13}
  if (get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
      {lambda()#13local_f0 = 0;}
  else{
...
Variant::Variant((Variant*)local_a8, true);local_e0 = 0;local_e8 = 0;String::parse_latin1((String*)&local_e8, "");if ((get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
       {lambda()#14(iVar2 = __cxa_guard_acquire(&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                                   ::{lambda()#14_scs_create((char *)&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#14__cxa_atexit(StringName::~StringName,
                 &get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                  ::{lambda()#14__cxa_guard_release (&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#14}
  if (get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
      {lambda()#14local_f0 = 0;}
  else{
...
Variant::Variant((Variant*)local_a8, 1);local_e0 = 0;local_e8 = 0;String::parse_latin1((String*)&local_e8, "Placeholder,Export");if ((get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
       {lambda()#15(iVar2 = __cxa_guard_acquire(&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                                   ::{lambda()#15_scs_create((char *)&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#15__cxa_atexit(StringName::~StringName,
                 &get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                  ::{lambda()#15__cxa_guard_release (&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#15}
  if (get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
      {lambda()#15local_f0 = 0;}
  else{
...
Variant::Variant((Variant*)local_a8, true);local_e0 = 0;local_e8 = 0;String::parse_latin1((String*)&local_e8, "");if ((get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
       {lambda()#16(iVar2 = __cxa_guard_acquire(&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                                   ::{lambda()#16_scs_create((char *)&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#16__cxa_atexit(StringName::~StringName,
                 &get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                  ::{lambda()#16__cxa_guard_release (&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#16}
  if (get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
      {lambda()#16local_f0 = 0;}
  else{
...
Variant::Variant((Variant*)local_a8, true);local_e0 = 0;local_e8 = 0;String::parse_latin1((String*)&local_e8, "");if ((get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
       {lambda()#17(iVar2 = __cxa_guard_acquire(&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                                   ::{lambda()#17_scs_create((char *)&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#17__cxa_atexit(StringName::~StringName,
                 &get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                  ::{lambda()#17__cxa_guard_release (&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#17}
  if (get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
      {lambda()#17local_f0 = 0;}
  else{
...
Variant::Variant((Variant*)local_a8, true);local_e0 = 0;local_e8 = 0;String::parse_latin1((String*)&local_e8, "");if ((get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
       {lambda()#18(iVar2 = __cxa_guard_acquire(&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                                   ::{lambda()#18_scs_create((char *)&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#18__cxa_atexit(StringName::~StringName,
                 &get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                  ::{lambda()#18__cxa_guard_release (&get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)
                         ::{lambda()#18}
  if (get_import_options(String_const&,List<ResourceImporter::ImportOption,DefaultAllocator>*)::
      {lambda()#18local_f0 = 0;}
  else{
...
LAB_001007ab:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return;}/* EditorSceneFormatImporterBlend::get_option_visibility(String const&, String const&, String
   const&, HashMap<StringName, Variant, HashMapHasherDefault, HashMapComparatorDefault<StringName>,
   DefaultTypedAllocator<HashMapElement<StringName, Variant> > > const&) */String *EditorSceneFormatImporterBlend::get_option_visibility(String *param_1, String *param_2, String *param_3, HashMap *param_4) {
   char cVar1;
   bool bVar2;
   Variant *this;
   String *in_R8;
   HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>> *in_R9;
   long in_FS_OFFSET;
   ...
   if (cVar1 == '\0') {
      ...
      if (cVar1 != '\0') {
         ...
         if (cVar1 != '\0') {
            ...
            this(Variant * HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>::operator [](in_R9, (StringName*)&local_48));
   ...
   LAB_001025c2:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* EditorFileSystemImportFormatSupportQueryBlend::is_active() const */ulong EditorFileSystemImportFormatSupportQueryBlend::is_active(void) {
   bool bVar1;
   uint uVar2;
...
/* EditorFileSystemImportFormatSupportQueryBlend::_validate_path(String) */void EditorFileSystemImportFormatSupportQueryBlend::_validate_path(undefined8 param_1, undefined8 param_2, long param_3, String *param_4) {
   StringName *pSVar1;
   char cVar2;
   int iVar3;
   char *pcVar4;
   ...
   if (cVar2 == '\0') {
      ...
      if (cVar2 != '\0') {
         ...
         if (_validate_path(String)::{lambda()
         #1
         iVar3 = __cxa_guard_acquire(&_validate_path(String)::, {
               lambda()
               #1
               if (iVar3 != 0) {
                  _scs_create((char *)&_validate_path(String)::{lambda()
                  #1
                  __cxa_atexit(StringName::~StringName, &_validate_path(String)::, {
                        lambda()
                        #1
...
, Label::set_text(*(String **)(param_3 + 0x1e8);
  ...
  local_58 = Control::get_theme_color
                       (pSVar1,(StringName *)
                              ...
                              Control::add_theme_color_override(pSVar1, (Color*)( SceneStringNames::singleton + 0xb0 ));
                              BaseButton::set_disabled(SUB81(*(undefined8*)( *(long*)( param_3 + 0x1c8 ) + 0xd88 ), 0));
                              LAB_00103057:CowData<char32_t>::_unref((CowData<char32_t>*)&local_80);
...
, /* EditorFileSystemImportFormatSupportQueryBlend::_select_install(String) */, void __thiscall
EditorFileSystemImportFormatSupportQueryBlend::_select_install
   ...
   DefaultAllocator>*, Error*) */
                        undefined8 EditorSceneFormatImporterBlend::import_scene(EditorSceneFormatImporterBlend *this, String *param_1, uint param_2, HashMap *param_3, List *param_4, Error *param_5) {
                           code *pcVar1;
                           Object *pOVar2;
                           String *pSVar3;
                           char cVar4;
                           ...
                           if (( local_e8 == 0 ) || ( *(uint*)( local_e8 + -8 ) < 2 )) {
                              _err_print_error("import_scene", "modules/gltf/editor/editor_scene_importer_blend.cpp", 0x72, "Condition \"blender_path.is_empty()\" is true. Returning: nullptr", "Blender path is empty, check your Editor Settings.", 0, 0);
                           }
 else {
                              cVar4 = FileAccess::exists((String*)&local_e8);
                              if (cVar4 != '\0') {
                                 if (( ( *(int*)( this + 0x1e8 ) == -1 ) || ( *(int*)( this + 0x1ec ) == -1 ) ) || ( cVar4 = String::operator !=((String*)( this + 0x1f0 ), (String*)&local_e8) ),cVar4 != '\0') {
                                    local_80 = (String*)0x0;
                                    cVar4 = _get_blender_version((String*)&local_e8, (int*)( this + 0x1e8 ), (int*)( this + 0x1ec ), (String*)&local_80);
                                    if (cVar4 == '\0') {
                                       _err_print_error("import_scene", "modules/gltf/editor/editor_scene_importer_blend.cpp", 0x78, "Method/function failed. Returning: nullptr", (String*)&local_80, 0, 0);
                                       CowData<char32_t>::_unref((CowData<char32_t>*)&local_80);
                                       goto LAB_00105373;
                                    }
                                 ...
                                 vformat<String,String>((String*)&local_80, (String*)&local_90, (CowData<char32_t>*)&local_88, (CowData<char32_t>*)&local_98);
...
, local_80 = (String *)((ulong)local_80 & 0xffffffff00000000);
              ...
              ::_lookup_pos((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
               ...
               #5
               if (cVar4 == '\0') {
                  LAB_00103917:Variant::Variant((Variant*)local_58, false);
                  pcVar10 = "export_skins";
                  LAB_00103928:Variant::Variant((Variant*)local_78, pcVar10);
                  pVVar7 = (Variant*)Dictionary::operator []((Variant*)local_b8);
                  Variant::operator =(pVVar7, (Variant*)local_58);
                  if (Variant::needs_deinit[local_78[0]] != '\0') {
                     Variant::_clear_internal();
                  ...
                  pVVar7 = (Variant*)HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>::operator []((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>*)param_3, (StringName*)&local_80);
...
, local_80 = (String *)((ulong)local_80 & 0xffffffff00000000);
         ...
         #6
         if (cVar4 == '\0') {
            LAB_00104750:pcVar10 = "PLACEHOLDER";
            LAB_00104757:Variant::Variant((Variant*)local_58, pcVar10);
...
local_80 = (String*)( (ulong)local_80 & 0xffffffff00000000 );cVar4 = HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
              ::_lookup_pos((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
                             *)param_3,
                            (StringName *)
                            &import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                             ::{lambda()#9if (cVar4 == '\0') {
   LAB_00103b21:bVar5 = false;
}
 else {
   if ((import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
             ::{lambda()
...
pVVar7 = (Variant*)HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>::operator []((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>*)param_3, (StringName*)&import_scene(String_const & unsigned_int, HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement < StringName,Variant>> > const, &, List<String,DefaultAllocator>, *, Error * ::operator ()(), ::sname));bVar5 = Variant::operator_cast_to_bool(pVVar7);if (!bVar5) goto LAB_00103b21;bVar5 = true;}Variant::Variant((Variant*)local_58, bVar5);local_f8 = "export_lights";Variant::Variant((Variant*)local_78, "export_lights");pVVar7 = (Variant*)Dictionary::operator []((Variant*)local_b8);Variant::operator =(pVVar7, (Variant*)local_58);if (Variant::needs_deinit[local_78[0]] != '\0') {
   Variant::_clear_internal();
}
if (Variant::needs_deinit[local_58[0]] != '\0') {
   Variant::_clear_internal();
}
if (( *(int*)( this + 0x1e8 ) < 5 ) && ( ( *(int*)( this + 0x1e8 ) != 4 || ( *(int*)( this + 0x1ec ) < 2 ) ) )) {
   if ((import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
             ::{lambda()
   #13
   (iVar6 = __cxa_guard_acquire(&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
...
pVVar7 = (Variant*)HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>::operator []((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>*)param_3, (StringName*)&import_scene(String_const & unsigned_int, HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement < StringName,Variant>> > const, &, List<String,DefaultAllocator>, *, Error * ::operator ()(), ::sname));bVar5 = Variant::operator_cast_to_bool(pVVar7);if (!bVar5) goto LAB_00104670;bVar5 = true;}Variant::Variant((Variant*)local_58, bVar5);pcVar10 = "export_colors";}
      else{
   if ((import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
             ::{lambda()
   #11
...
local_80 = (String*)( (ulong)local_80 & 0xffffffff00000000 );cVar4 = HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
                ::_lookup_pos((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
                              ...
                              &import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                               ::{lambda()#11if (cVar4 == '\0') {
   LAB_00103bdb:Variant::Variant((Variant*)local_58, "NONE");
...
pVVar7 = (Variant*)HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>::operator []((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>*)param_3, (StringName*)&import_scene(String_const & unsigned_int, HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement < StringName,Variant>> > const, &, List<String,DefaultAllocator>, *, Error * ::operator ()(), ::sname));bVar5 = Variant::operator_cast_to_bool(pVVar7);if (!bVar5) goto LAB_00103bdb;Variant::Variant((Variant*)local_58, "MATERIAL");pcVar10 = "export_vertex_color";}
      }Variant::Variant((Variant*)local_78, pcVar10);pVVar7 = (Variant*)Dictionary::operator []((Variant*)local_b8);Variant::operator =(pVVar7, (Variant*)local_58);if (Variant::needs_deinit[local_78[0]] != '\0') {
   Variant::_clear_internal();
}
if (Variant::needs_deinit[local_58[0]] != '\0') {
   Variant::_clear_internal();
...
if ((import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
           ::{lambda()#15(iVar6 = __cxa_guard_acquire(&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                                       ::{lambda()#15_scs_create((char *)&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                             ::{lambda()#15__cxa_atexit(StringName::~StringName,
                     &import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                      ::{lambda()#15__cxa_guard_release (&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                             ::{lambda()#15}local_80 = (String*)( (ulong)local_80 & 0xffffffff00000000 );cVar4 = HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
              ::_lookup_pos((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
                             *)param_3,
                            (StringName *)
                            &import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                             ::{lambda()#15if (cVar4 == '\0') {
   LAB_00104690:Variant::Variant((Variant*)local_58, false);
   ...
   bVar5 = false;
   LAB_001046e9:Variant::Variant((Variant*)local_58, bVar5);
   pcVar10 = "use_visible";
   LAB_001046f8:Variant::Variant((Variant*)local_78, pcVar10);
   pVVar7 = (Variant*)Dictionary::operator []((Variant*)local_b8);
   Variant::operator =(pVVar7, (Variant*)local_58);
   if (Variant::needs_deinit[local_78[0]] != '\0') {
      Variant::_clear_internal();
...
if ((import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
           ::{lambda()#16(iVar6 = __cxa_guard_acquire(&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                                       ::{lambda()#16_scs_create((char *)&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                             ::{lambda()#16__cxa_atexit(StringName::~StringName,
                     &import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                      ::{lambda()#16__cxa_guard_release (&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                             ::{lambda()#16}local_80 = (String*)( (ulong)local_80 & 0xffffffff00000000 );cVar4 = HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
              ::_lookup_pos((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
                             *)param_3,
                            (StringName *)
                            &import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
...
pVVar7 = (Variant*)HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>::operator []((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>*)param_3, (StringName*)&import_scene(String_const & unsigned_int, HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement < StringName,Variant>> > const, &, List<String,DefaultAllocator>, *, Error * ::operator ()(), ::sname));bVar5 = Variant::operator_cast_to_bool(pVVar7);if (bVar5) {
   ...
   if (Variant::needs_deinit[local_58[0]] != '\0') {
      ...
      if ((import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
           ::{lambda()#18(iVar6 = __cxa_guard_acquire(&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                                       ::{lambda()#18_scs_create((char *)&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                             ::{lambda()#18__cxa_atexit(StringName::~StringName,
                     &import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                      ::{lambda()#18__cxa_guard_release (&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                             ::{lambda()#18}local_80 = (String*)( (ulong)local_80 & 0xffffffff00000000 );cVar4 = HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
              ::_lookup_pos((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
                             *)param_3,
                            (StringName *)
                            &import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                             ::{lambda()#18if (cVar4 == '\0') {
   LAB_00103d6e:bVar5 = false;
}
 else {
   if ((import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
             ::{lambda()
...
pVVar7 = (Variant*)HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>::operator []((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>*)param_3, (StringName*)&import_scene(String_const & unsigned_int, HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement < StringName,Variant>> > const, &, List<String,DefaultAllocator>, *, Error * ::operator ()(), ::sname));bVar5 = Variant::operator_cast_to_bool(pVVar7);if (!bVar5) goto LAB_00103d6e;bVar5 = true;}Variant::Variant((Variant*)local_58, bVar5);Variant::Variant((Variant*)local_78, "export_texcoords");pVVar7 = (Variant*)Dictionary::operator []((Variant*)local_b8);Variant::operator =(pVVar7, (Variant*)local_58);if (Variant::needs_deinit[local_78[0]] != '\0') {
   Variant::_clear_internal();
}
if (Variant::needs_deinit[local_58[0]] != '\0') {
   Variant::_clear_internal();
...
if ((import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
           ::{lambda()#20(iVar6 = __cxa_guard_acquire(&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                                       ::{lambda()#20_scs_create((char *)&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                             ::{lambda()#20__cxa_atexit(StringName::~StringName,
                     &import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                      ::{lambda()#20__cxa_guard_release (&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                             ::{lambda()#20}local_80 = (String*)( (ulong)local_80 & 0xffffffff00000000 );cVar4 = HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
              ::_lookup_pos((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
                             *)param_3,
                            (StringName *)
                            &import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                             ::{lambda()#20if (cVar4 == '\0') {
   LAB_00103e29:bVar5 = false;
}
 else {
   if ((import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
             ::{lambda()
...
pVVar7 = (Variant*)HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>::operator []((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>*)param_3, (StringName*)&import_scene(String_const & unsigned_int, HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement < StringName,Variant>> > const, &, List<String,DefaultAllocator>, *, Error * ::operator ()(), ::sname));bVar5 = Variant::operator_cast_to_bool(pVVar7);if (!bVar5) goto LAB_00103e29;bVar5 = true;}Variant::Variant((Variant*)local_58, bVar5);Variant::Variant((Variant*)local_78, "export_normals");pVVar7 = (Variant*)Dictionary::operator []((Variant*)local_b8);Variant::operator =(pVVar7, (Variant*)local_58);if (Variant::needs_deinit[local_78[0]] != '\0') {
   Variant::_clear_internal();
}
if (Variant::needs_deinit[local_58[0]] != '\0') {
   Variant::_clear_internal();
}
if (( 4 < *(int*)( this + 0x1e8 ) ) || ( ( *(int*)( this + 0x1e8 ) == 4 && ( 0 < *(int*)( this + 0x1ec ) ) ) )) {
   if ((import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
             ::{lambda()
   #22
   (iVar6 = __cxa_guard_acquire(&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
...
local_80 = (String*)( (ulong)local_80 & 0xffffffff00000000 );cVar4 = HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
                ::_lookup_pos((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
                              ...
                              &import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                               ::{lambda()#22if (cVar4 == '\0') {
   LAB_00104ad0:Variant::Variant((Variant*)local_58, false);
...
pVVar7 = (Variant*)HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>::operator []((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>*)param_3, (StringName*)&import_scene(String_const & unsigned_int, HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement < StringName,Variant>> > const, &, List<String,DefaultAllocator>, *, Error * ::operator ()(), ::sname));bVar5 = Variant::operator_cast_to_bool(pVVar7);if (!bVar5) goto LAB_00104ad0;Variant::Variant((Variant*)local_58, true);Variant::Variant((Variant*)local_78, "export_gn_mesh");pVVar7 = (Variant*)Dictionary::operator []((Variant*)local_b8);Variant::operator =(pVVar7, (Variant*)local_58);if (Variant::needs_deinit[local_78[0]] != '\0') {
   Variant::_clear_internal();
}
if (Variant::needs_deinit[local_58[0]] != '\0') {
   Variant::_clear_internal();
}
if (*(long*)( this + 0x1e8 ) != 0x100000004) goto LAB_00103e98;Variant::Variant((Variant*)local_58, false);}Variant::Variant((Variant*)local_78, local_f8);pVVar7 = (Variant*)Dictionary::operator []((Variant*)local_b8);Variant::operator =(pVVar7, (Variant*)local_58);if (Variant::needs_deinit[local_78[0]] != '\0') {
   Variant::_clear_internal();
}
if (Variant::needs_deinit[local_58[0]] != '\0') {
   Variant::_clear_internal();
...
LAB_00103e98:
      if ((import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
           ::{lambda()#24(iVar6 = __cxa_guard_acquire(&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                                       ::{lambda()#24_scs_create((char *)&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                             ::{lambda()#24__cxa_atexit(StringName::~StringName,
                     &import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                      ::{lambda()#24__cxa_guard_release (&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                             ::{lambda()#24}local_80 = (String*)( (ulong)local_80 & 0xffffffff00000000 );cVar4 = HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
              ::_lookup_pos((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
                             *)param_3,
                            (StringName *)
                            &import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                             ::{lambda()#24if (cVar4 == '\0') {
   LAB_00103efc:bVar5 = false;
}
 else {
   if ((import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
             ::{lambda()
...
pVVar7 = (Variant*)HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>::operator []((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>*)param_3, (StringName*)&import_scene(String_const & unsigned_int, HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement < StringName,Variant>> > const, &, List<String,DefaultAllocator>, *, Error * ::operator ()(), ::sname));bVar5 = Variant::operator_cast_to_bool(pVVar7);if (!bVar5) goto LAB_00103efc;bVar5 = true;}Variant::Variant((Variant*)local_58, bVar5);Variant::Variant((Variant*)local_78, "export_tangents");pVVar7 = (Variant*)Dictionary::operator []((Variant*)local_b8);Variant::operator =(pVVar7, (Variant*)local_58);if (Variant::needs_deinit[local_78[0]] != '\0') {
   Variant::_clear_internal();
}
if (Variant::needs_deinit[local_58[0]] != '\0') {
   Variant::_clear_internal();
...
if ((import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
           ::{lambda()#26(iVar6 = __cxa_guard_acquire(&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                                       ::{lambda()#26_scs_create((char *)&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                             ::{lambda()#26__cxa_atexit(StringName::~StringName,
                     &import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                      ::{lambda()#26__cxa_guard_release (&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                             ::{lambda()#26}local_80 = (String*)( (ulong)local_80 & 0xffffffff00000000 );cVar4 = HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
              ::_lookup_pos((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
                             *)param_3,
                            (StringName *)
                            &import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                             ::{lambda()#26if (cVar4 == '\0') {
   LAB_00103f8a:if (( *(int*)( this + 0x1e8 ) < 4 ) && ( ( *(int*)( this + 0x1e8 ) != 3 || ( *(int*)( this + 0x1ec ) < 6 ) ) )) {
      bVar5 = false;
      LAB_001045e2:Variant::Variant((Variant*)local_58, bVar5);
...
pVVar7 = (Variant*)HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>::operator []((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>*)param_3, (StringName*)&import_scene(String_const & unsigned_int, HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement < StringName,Variant>> > const, &, List<String,DefaultAllocator>, *, Error * ::operator ()(), ::sname));bVar5 = Variant::operator_cast_to_bool(pVVar7);if (!bVar5) goto LAB_00103f8a;if (( *(int*)( this + 0x1e8 ) < 4 ) && ( ( *(int*)( this + 0x1e8 ) != 3 || ( *(int*)( this + 0x1ec ) < 6 ) ) )) {
   bVar5 = true;
   goto LAB_001045e2;
}
Variant::Variant((Variant*)local_58, "ACTIONS");pcVar10 = "export_animation_mode";}Variant::Variant((Variant*)local_78, pcVar10);pVVar7 = (Variant*)Dictionary::operator []((Variant*)local_b8);Variant::operator =(pVVar7, (Variant*)local_58);if (Variant::needs_deinit[local_78[0]] != '\0') {
   Variant::_clear_internal();
}
if (Variant::needs_deinit[local_58[0]] != '\0') {
   Variant::_clear_internal();
...
if ((import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
           ::{lambda()#28(iVar6 = __cxa_guard_acquire(&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                                       ::{lambda()#28_scs_create((char *)&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                             ::{lambda()#28__cxa_atexit(StringName::~StringName,
                     &import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                      ::{lambda()#28__cxa_guard_release (&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                             ::{lambda()#28}local_80 = (String*)( (ulong)local_80 & 0xffffffff00000000 );cVar4 = HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
              ::_lookup_pos((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
                             *)param_3,
                            (StringName *)
                            &import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                             ::{lambda()#28if (cVar4 == '\0') {
   LAB_00104070:bVar5 = false;
}
 else {
   if ((import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
             ::{lambda()
...
pVVar7 = (Variant*)HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>::operator []((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>*)param_3, (StringName*)&import_scene(String_const & unsigned_int, HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement < StringName,Variant>> > const, &, List<String,DefaultAllocator>, *, Error * ::operator ()(), ::sname));bVar5 = Variant::operator_cast_to_bool(pVVar7);if (!bVar5) goto LAB_00104070;bVar5 = true;}Variant::Variant((Variant*)local_58, bVar5);Variant::Variant((Variant*)local_78, "export_frame_range");pVVar7 = (Variant*)Dictionary::operator []((Variant*)local_b8);Variant::operator =(pVVar7, (Variant*)local_58);if (Variant::needs_deinit[local_78[0]] != '\0') {
   Variant::_clear_internal();
}
if (Variant::needs_deinit[local_58[0]] != '\0') {
   Variant::_clear_internal();
...
if ((import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
           ::{lambda()#30(iVar6 = __cxa_guard_acquire(&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                                       ::{lambda()#30_scs_create((char *)&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                             ::{lambda()#30__cxa_atexit(StringName::~StringName,
                     &import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                      ::{lambda()#30__cxa_guard_release (&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                             ::{lambda()#30}local_80 = (String*)( (ulong)local_80 & 0xffffffff00000000 );cVar4 = HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
              ::_lookup_pos((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
                             *)param_3,
                            (StringName *)
                            &import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                             ::{lambda()#30if (cVar4 == '\0') {
   LAB_0010412b:bVar5 = false;
}
 else {
   if ((import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
             ::{lambda()
...
pVVar7 = (Variant*)HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>::operator []((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>*)param_3, (StringName*)&import_scene(String_const & unsigned_int, HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement < StringName,Variant>> > const, &, List<String,DefaultAllocator>, *, Error * ::operator ()(), ::sname));bVar5 = Variant::operator_cast_to_bool(pVVar7);if (!bVar5) goto LAB_0010412b;bVar5 = true;}Variant::Variant((Variant*)local_58, bVar5);Variant::Variant((Variant*)local_78, "export_force_sampling");pVVar7 = (Variant*)Dictionary::operator []((Variant*)local_b8);Variant::operator =(pVVar7, (Variant*)local_58);if (Variant::needs_deinit[local_78[0]] != '\0') {
   Variant::_clear_internal();
}
if (Variant::needs_deinit[local_58[0]] != '\0') {
   Variant::_clear_internal();
...
if ((import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
           ::{lambda()#32(iVar6 = __cxa_guard_acquire(&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                                       ::{lambda()#32_scs_create((char *)&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                             ::{lambda()#32__cxa_atexit(StringName::~StringName,
                     &import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                      ::{lambda()#32__cxa_guard_release (&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                             ::{lambda()#32}local_80 = (String*)( (ulong)local_80 & 0xffffffff00000000 );cVar4 = HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
              ::_lookup_pos((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
                             *)param_3,
                            (StringName *)
                            &import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                             ::{lambda()#32if (cVar4 == '\0') {
   LAB_001041e6:bVar5 = false;
}
 else {
   if ((import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
             ::{lambda()
...
pVVar7 = (Variant*)HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>::operator []((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>*)param_3, (StringName*)&import_scene(String_const & unsigned_int, HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement < StringName,Variant>> > const, &, List<String,DefaultAllocator>, *, Error * ::operator ()(), ::sname));bVar5 = Variant::operator_cast_to_bool(pVVar7);if (!bVar5) goto LAB_001041e6;bVar5 = true;}Variant::Variant((Variant*)local_58, bVar5);Variant::Variant((Variant*)local_78, "export_def_bones");pVVar7 = (Variant*)Dictionary::operator []((Variant*)local_b8);Variant::operator =(pVVar7, (Variant*)local_58);if (Variant::needs_deinit[local_78[0]] != '\0') {
   Variant::_clear_internal();
}
if (Variant::needs_deinit[local_58[0]] != '\0') {
   Variant::_clear_internal();
...
if ((import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
           ::{lambda()#34(iVar6 = __cxa_guard_acquire(&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                                       ::{lambda()#34_scs_create((char *)&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                             ::{lambda()#34__cxa_atexit(StringName::~StringName,
                     &import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                      ::{lambda()#34__cxa_guard_release (&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                             ::{lambda()#34}local_80 = (String*)( (ulong)local_80 & 0xffffffff00000000 );cVar4 = HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
              ::_lookup_pos((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
                             *)param_3,
                            (StringName *)
                            &import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                             ::{lambda()#34if (cVar4 == '\0') {
   LAB_001042a1:bVar5 = false;
}
 else {
   if ((import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
             ::{lambda()
...
pVVar7 = (Variant*)HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>::operator []((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>*)param_3, (StringName*)&import_scene(String_const & unsigned_int, HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement < StringName,Variant>> > const, &, List<String,DefaultAllocator>, *, Error * ::operator ()(), ::sname));bVar5 = Variant::operator_cast_to_bool(pVVar7);if (!bVar5) goto LAB_001042a1;bVar5 = true;}Variant::Variant((Variant*)local_58, bVar5);Variant::Variant((Variant*)local_78, "export_apply");pVVar7 = (Variant*)Dictionary::operator []((Variant*)local_b8);Variant::operator =(pVVar7, (Variant*)local_58);if (Variant::needs_deinit[local_78[0]] != '\0') {
   Variant::_clear_internal();
}
if (Variant::needs_deinit[local_58[0]] != '\0') {
   Variant::_clear_internal();
}
Variant::Variant((Variant*)local_58, local_108);Variant::Variant((Variant*)local_78, "unpack_all");pVVar7 = (Variant*)Dictionary::operator []((Variant*)local_c0);Variant::operator =(pVVar7, (Variant*)local_58);if (Variant::needs_deinit[local_78[0]] != '\0') {
   Variant::_clear_internal();
}
if (Variant::needs_deinit[local_58[0]] != '\0') {
   Variant::_clear_internal();
}
Variant::Variant((Variant*)local_58, local_e0);Variant::Variant((Variant*)local_78, "path");pVVar7 = (Variant*)Dictionary::operator []((Variant*)local_c0);Variant::operator =(pVVar7, (Variant*)local_58);if (Variant::needs_deinit[local_78[0]] != '\0') {
   Variant::_clear_internal();
}
if (Variant::needs_deinit[local_58[0]] != '\0') {
   Variant::_clear_internal();
}
Variant::Variant((Variant*)local_58, local_b8);Variant::Variant((Variant*)local_78, "gltf_options");pVVar7 = (Variant*)Dictionary::operator []((Variant*)local_c0);Variant::operator =(pVVar7, (Variant*)local_58);if (Variant::needs_deinit[local_78[0]] != '\0') {
   Variant::_clear_internal();
}
if (Variant::needs_deinit[local_58[0]] != '\0') {
   Variant::_clear_internal();
}
iVar6 = EditorImportBlendRunner::do_import(EditorImportBlendRunner::singleton);if (iVar6 == 0) {
   local_b0 = (Object*)0x0;
...
local_80 = (String*)( (ulong)local_80 & 0xffffffff00000000 );cVar4 = HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
                ::_lookup_pos((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>
                              ...
                              (StringName *)
                              &import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
                               ::{lambda()#36pSVar9 = local_a8;if (cVar4 != '\0') {
   if ((import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
               ::{lambda()
   #37
   (iVar6 = __cxa_guard_acquire(&import_scene(String_const&,unsigned_int,HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>const&,List<String,DefaultAllocator>*,Error*)
...
pVVar7 = (Variant*)HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>::operator []((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>*)param_3, (StringName*)&import_scene(String_const & unsigned_int, HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement < StringName,Variant>> > const, &, List<String,DefaultAllocator>, *, Error * ::operator ()(), ::sname));bVar5 = Variant::operator_cast_to_bool(pVVar7);pSVar9 = local_a8;if (bVar5) {
   GLTFState::set_import_as_skeleton_bones(SUB81(local_a8, 0));
}
}local_80 = (String*)0x0;if (local_d8 != 0) {
   CowData<char32_t>::_ref((CowData<char32_t>*)&local_80, (CowData*)&local_d8);
}
GLTFState::set_scene_name(pSVar9, (String*)&local_80);CowData<char32_t>::_unref((CowData<char32_t>*)&local_80);String::get_base_dir();GLTFState::set_extract_path(pSVar9);CowData<char32_t>::_unref((CowData<char32_t>*)&local_80);GLTFState::set_extract_prefix(pSVar9);pOVar2 = local_b0;pcVar1 = *(code**)( *(long*)local_b0 + 0x1c8 );String::get_base_dir();local_80 = pSVar9;cVar4 = RefCounted::reference();if (cVar4 == '\0') {
   local_80 = (String*)0x0;
}
local_98 = 0;String::parse_latin1((String*)&local_98, ".gltf");String::get_basename();String::operator +((String*)&local_90, (String*)local_a0);iVar6 = ( *pcVar1 )(pOVar2, (String*)&local_90, (String*)&local_80, param_2, (CowData<char32_t>*)&local_88);CowData<char32_t>::_unref((CowData<char32_t>*)&local_90);CowData<char32_t>::_unref(local_a0);CowData<char32_t>::_unref((CowData<char32_t>*)&local_98);if (( ( local_80 != (String*)0x0 ) && ( cVar4 = RefCounted::unreference() ),pSVar3 = local_80,cVar4 != '\0' )) &&( cVar4 = cVar4 != '\0' )(**(code**)( *(long*)pSVar3 + 0x140 ))(pSVar3);Memory::free_static(pSVar3, false);}CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);if (iVar6 == 0) {
   StringName::StringName((StringName*)&local_80, "animation/fps", false);
   local_88 = local_88 & 0xffffffff00000000;
   cVar4 = HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>::_lookup_pos((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>*)param_3, (StringName*)&local_80, (uint*)&local_88);
   if (( StringName::configured != '\0' ) && ( local_80 != (String*)0x0 )) {
      StringName::unref();
   }

   if (cVar4 == '\0') {
      _err_print_error("import_scene", "modules/gltf/editor/editor_scene_importer_blend.cpp", 0x142, "Condition \"!p_options.has(\"animation/fps\")\" is true. Returning: nullptr", 0, 0);
      goto LAB_001049bb;
   }

   StringName::StringName((StringName*)&local_88, "animation/trimming", false);
   local_80 = (String*)( (ulong)local_80 & 0xffffffff00000000 );
   cVar4 = HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>::_lookup_pos((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>*)param_3, (StringName*)&local_88, (uint*)&local_80);
   if (cVar4 == '\0') {
      bVar5 = false;
      LAB_0010546f:if (StringName::configured != '\0') {
         LAB_00105473:if (local_88 != 0) {
            StringName::unref();
         }
   ...
   pVVar7 = (Variant*)HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>::operator []((HashMap<StringName,Variant,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,Variant>>>*)param_3, (StringName*)&local_88);
   ...
   if (( ( local_80 != (String*)0x0 ) && ( cVar4 = RefCounted::unreference() ),pSVar3 = local_80,cVar4 != '\0' )) &&( cVar4 = cVar4 != '\0' )(**(code**)( *(long*)pSVar3 + 0x140 ))(pSVar3);
...
if (( StringName::configured != '\0' ) && ( local_88 != 0 )) {
   ...
   LAB_001049bb:uVar8 = 0;
}
cVar4 = RefCounted::unreference();if (( cVar4 != '\0' ) && ( cVar4 = predelete_handler((Object*)pSVar9) ),cVar4 != '\0') {
...
Dictionary::~Dictionary(local_b8);Dictionary::~Dictionary(local_c0);CowData<char32_t>::_unref((CowData<char32_t>*)local_c8);CowData<char32_t>::_unref((CowData<char32_t>*)local_d0);CowData<char32_t>::_unref((CowData<char32_t>*)&local_d8);CowData<char32_t>::_unref((CowData<char32_t>*)local_e0);goto LAB_0010446d;}local_88 = 0;if (local_e8 != 0) {
   CowData<char32_t>::_ref((CowData<char32_t>*)&local_88, (CowData*)&local_e8);
}
local_90 = 0;String::parse_latin1((String*)&local_90, "Invalid Blender path: %s, check your Editor Settings.");vformat<String>((String*)&local_80, (String*)&local_90, (CowData<char32_t>*)&local_88);_err_print_error("import_scene", "modules/gltf/editor/editor_scene_importer_blend.cpp", 0x73, "Condition \"!FileAccess::exists(blender_path)\" is true. Returning: nullptr", (String*)&local_80, 0, 0);CowData<char32_t>::_unref((CowData<char32_t>*)&local_80);CowData<char32_t>::_unref((CowData<char32_t>*)&local_90);CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);}LAB_00105373:uVar8 = 0;LAB_0010446d:CowData<char32_t>::_unref((CowData<char32_t>*)&local_e8);if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return uVar8;}/* CowData<String>::_copy_on_write() [clone .isra.0] */void CowData<String>::_copy_on_write(CowData<String> *this) {
   CowData *pCVar1;
   long lVar2;
   long lVar3;
   code *pcVar4;
...
/* EditorFileSystemImportFormatSupportQueryBlend::_autodetect_path() */char EditorFileSystemImportFormatSupportQueryBlend::_autodetect_path(EditorFileSystemImportFormatSupportQueryBlend *this) {
   StrRange *pSVar1;
   long *plVar2;
   char cVar3;
   int iVar4;
   ...
   if (iVar4 == 0) {
      ...
      do {
         if (local_60 == (String*)0x0) {
            lVar7 = 0;
            LAB_00106859:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar9, lVar7, "p_index", "size()", "", false, false);
         }
 else {
 ...
 while ( pSVar5 != (StrRange*)&local_58 );
   ...
   do {
      if (pSVar6 == pSVar8) {
         cVar3 = '\0';
         LAB_001067d2:CowData<String>::_unref((CowData<String>*)&local_60);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* EditorFileSystemImportFormatSupportQueryBlend::query() */undefined8 EditorFileSystemImportFormatSupportQueryBlend::query(EditorFileSystemImportFormatSupportQueryBlend *this) {
   long *plVar1;
   code *pcVar2;
   char cVar3;
   long lVar4;
   ...
   if (*(long*)( this + 0x1c8 ) == 0) {
      ...
      *(ConfirmationDialog**)( this + 0x1c8 ) = this_00;
      ...
      local_70 = 0;
      String::parse_latin1((String*)&local_70, "Blender 3.0+ is required to import \'.blend\' files.\nPlease provide a valid path to a Blender executable.");
      ...
      *(Button**)( this + 0x1d8 ) = this_04;
      ...
      create_custom_callable_function_pointer<EditorFileSystemImportFormatSupportQueryBlend>((EditorFileSystemImportFormatSupportQueryBlend*)&local_68, (char*)this, (_func_void*)"&EditorFileSystemImportFormatSupportQueryBlend::_browse_install");
      ...
      *(Label**)( this + 0x1e8 ) = pLVar6;
      ...
      pcVar2 = *(code**)( *plVar1 + 0x108 );
      create_custom_callable_function_pointer<EditorFileSystemImportFormatSupportQueryBlend,String>((EditorFileSystemImportFormatSupportQueryBlend*)&local_68, (char*)this, (_func_void_String*)"&EditorFileSystemImportFormatSupportQueryBlend::_validate_path");
      ...
      String::parse_latin1((String*)&local_70, "");
      local_78 = 0;
      String::parse_latin1((String*)&local_78, "Disables Blender \'.blend\' files import for this project. Can be re-enabled in Project Settings.");
      TTR((String*)&local_68, (String*)&local_78);
      ...
      pcVar2 = *(code**)( *plVar1 + 0x108 );
      create_custom_callable_function_pointer<EditorFileSystemImportFormatSupportQueryBlend>((EditorFileSystemImportFormatSupportQueryBlend*)&local_68, (char*)this, (_func_void*)"&EditorFileSystemImportFormatSupportQueryBlend::_path_confirmed");
      ...
      *(EditorFileDialog**)( this + 0x1e0 ) = this_05;
      ...
      pcVar2 = *(code**)( *plVar1 + 0x108 );
      create_custom_callable_function_pointer<EditorFileSystemImportFormatSupportQueryBlend,String>((EditorFileSystemImportFormatSupportQueryBlend*)&local_68, (char*)this, (_func_void_String*)"&EditorFileSystemImportFormatSupportQueryBlend::_select_install");
      ...
      create_custom_callable_function_pointer<EditorFileSystemImportFormatSupportQueryBlend>((EditorFileSystemImportFormatSupportQueryBlend*)&local_68, (char*)this, (_func_void*)"&EditorFileSystemImportFormatSupportQueryBlend::_update_icons");
   ...
   LAB_001069c9:LineEdit::set_text(uVar8, (CowData<char32_t>*)&local_68);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
   local_68 = (char*)0x0;
   if (local_b0 != 0) {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_68, (CowData*)&local_b0);
   ...
   do {
      ...
      if (cVar3 == '\0') {
         if (this[0x1f0] == (EditorFileSystemImportFormatSupportQueryBlend)0x0) {
            ...
            local_a8 = 0;
            String::parse_latin1((String*)&local_a8, "Disabling \'.blend\' file import requires restarting the editor.");
 ...
 while ( this[0x1f0] == (EditorFileSystemImportFormatSupportQueryBlend)0x0 );
   ...
   EditorSettings::save();
   LAB_00106af2:CowData<char32_t>::_unref((CowData<char32_t>*)&local_b0);
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* EditorFileSystemImportFormatSupportQueryBlend::get_file_extensions() const */EditorFileSystemImportFormatSupportQueryBlend * __thiscall
EditorFileSystemImportFormatSupportQueryBlend::get_file_extensions
   ...
   *(undefined8*)( this + 8 ) = 0;
   ...
   LAB_0010759e:CowData<char32_t>::_unref((CowData<char32_t>*)&local_50);
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return this;
   }
...
/* RefCounted::is_class_ptr(void*) const */uint RefCounted::is_class_ptr(RefCounted *this, void *param_1) {
   return (uint)CONCAT71(0x116c, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x116c, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr);
}
...
/* EditorFileSystemImportFormatSupportQuery::is_class_ptr(void*) const */uint EditorFileSystemImportFormatSupportQuery::is_class_ptr(EditorFileSystemImportFormatSupportQuery *this, void *param_1) {
   return (uint)CONCAT71(0x116c, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x116c, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x116c, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* EditorFileSystemImportFormatSupportQuery::_getv(StringName const&, Variant&) const */undefined8 EditorFileSystemImportFormatSupportQuery::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorFileSystemImportFormatSupportQuery::_setv(StringName const&, Variant const&) */undefined8 EditorFileSystemImportFormatSupportQuery::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorFileSystemImportFormatSupportQuery::_validate_propertyv(PropertyInfo&) const */void EditorFileSystemImportFormatSupportQuery::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* EditorFileSystemImportFormatSupportQuery::_property_can_revertv(StringName const&) const */undefined8 EditorFileSystemImportFormatSupportQuery::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* EditorFileSystemImportFormatSupportQuery::_property_get_revertv(StringName const&, Variant&)
   const */undefined8 EditorFileSystemImportFormatSupportQuery::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorFileSystemImportFormatSupportQuery::_notificationv(int, bool) */void EditorFileSystemImportFormatSupportQuery::_notificationv(int param_1, bool param_2) {
   return;
}
/* EditorSceneFormatImporter::handle_compatibility_options(HashMap<StringName, Variant,
   ...
   DefaultTypedAllocator<HashMapElement<StringName, Variant> > >&) const */void EditorSceneFormatImporter::handle_compatibility_options(HashMap *param_1) {
   return;
}
/* EditorSceneFormatImporterBlend::is_class_ptr(void*) const */uint EditorSceneFormatImporterBlend::is_class_ptr(EditorSceneFormatImporterBlend *this, void *param_1) {
   return (uint)CONCAT71(0x116c, (undefined4*)param_1 == &EditorSceneFormatImporter::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x116c, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x116c, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x116c, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* EditorSceneFormatImporterBlend::_getv(StringName const&, Variant&) const */undefined8 EditorSceneFormatImporterBlend::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorSceneFormatImporterBlend::_setv(StringName const&, Variant const&) */undefined8 EditorSceneFormatImporterBlend::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorSceneFormatImporterBlend::_validate_propertyv(PropertyInfo&) const */void EditorSceneFormatImporterBlend::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* EditorSceneFormatImporterBlend::_property_can_revertv(StringName const&) const */undefined8 EditorSceneFormatImporterBlend::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* EditorSceneFormatImporterBlend::_property_get_revertv(StringName const&, Variant&) const */undefined8 EditorSceneFormatImporterBlend::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorSceneFormatImporterBlend::_notificationv(int, bool) */void EditorSceneFormatImporterBlend::_notificationv(int param_1, bool param_2) {
   return;
}
/* EditorFileSystemImportFormatSupportQueryBlend::is_class_ptr(void*) const */uint EditorFileSystemImportFormatSupportQueryBlend::is_class_ptr(EditorFileSystemImportFormatSupportQueryBlend *this, void *param_1) {
   return (uint)CONCAT71(0x116c, (undefined4*)param_1 == &EditorFileSystemImportFormatSupportQuery::get_class_ptr_static(), ::
                                ptr) | (uint)CONCAT71(0x116c, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x116c, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x116c, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* EditorFileSystemImportFormatSupportQueryBlend::_getv(StringName const&, Variant&) const */undefined8 EditorFileSystemImportFormatSupportQueryBlend::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorFileSystemImportFormatSupportQueryBlend::_setv(StringName const&, Variant const&) */undefined8 EditorFileSystemImportFormatSupportQueryBlend::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorFileSystemImportFormatSupportQueryBlend::_validate_propertyv(PropertyInfo&) const */void EditorFileSystemImportFormatSupportQueryBlend::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* EditorFileSystemImportFormatSupportQueryBlend::_property_can_revertv(StringName const&) const */undefined8 EditorFileSystemImportFormatSupportQueryBlend::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* EditorFileSystemImportFormatSupportQueryBlend::_property_get_revertv(StringName const&, Variant&)
   const */undefined8 EditorFileSystemImportFormatSupportQueryBlend::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* EditorFileSystemImportFormatSupportQueryBlend::_notificationv(int, bool) */void EditorFileSystemImportFormatSupportQueryBlend::_notificationv(int param_1, bool param_2) {
   return;
}
/* GLTFState::is_class_ptr(void*) const */uint GLTFState::is_class_ptr(GLTFState *this, void *param_1) {
   return (uint)CONCAT71(0x116c, (undefined4*)param_1 == &Resource::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x116b, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x116c, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x116c, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
...
/* CallableCustomMethodPointer<EditorFileSystemImportFormatSupportQueryBlend, void,
   String>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<EditorFileSystemImportFormatSupportQueryBlend,void,String>::~CallableCustomMethodPointer(CallableCustomMethodPointer<EditorFileSystemImportFormatSupportQueryBlend,void,String> *this) {
   return;
}
/* CallableCustomMethodPointer<EditorFileSystemImportFormatSupportQueryBlend,
   void>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<EditorFileSystemImportFormatSupportQueryBlend,void>::~CallableCustomMethodPointer(CallableCustomMethodPointer<EditorFileSystemImportFormatSupportQueryBlend,void> *this) {
   return;
}
/* CallableCustomMethodPointer<EditorFileSystemImportFormatSupportQueryBlend, void,
   String>::get_argument_count(bool&) const */undefined8 CallableCustomMethodPointer<EditorFileSystemImportFormatSupportQueryBlend,void,String>::get_argument_count(CallableCustomMethodPointer<EditorFileSystemImportFormatSupportQueryBlend,void,String> *this, bool *param_1) {
   *param_1 = true;
   return 1;
}
/* CallableCustomMethodPointer<EditorFileSystemImportFormatSupportQueryBlend,
   void>::get_argument_count(bool&) const */undefined8 CallableCustomMethodPointer<EditorFileSystemImportFormatSupportQueryBlend,void>::get_argument_count(CallableCustomMethodPointer<EditorFileSystemImportFormatSupportQueryBlend,void> *this, bool *param_1) {
   *param_1 = true;
   return 0;
}
...
/* EditorFileSystemImportFormatSupportQuery::~EditorFileSystemImportFormatSupportQuery() */void EditorFileSystemImportFormatSupportQuery::~EditorFileSystemImportFormatSupportQuery(EditorFileSystemImportFormatSupportQuery *this) {
   bool bVar1;
   ...
   *(undefined***)this = &PTR__initialize_classv_00115c48;
   ...
   LAB_00107f7f:*(undefined***)this = &PTR__initialize_classv_00115ae8;
   Object::~Object((Object*)this);
   return;
}
...
/* CallableCustomMethodPointer<EditorFileSystemImportFormatSupportQueryBlend, void>::get_object()
   const */undefined8 CallableCustomMethodPointer<EditorFileSystemImportFormatSupportQueryBlend,void>::get_object(CallableCustomMethodPointer<EditorFileSystemImportFormatSupportQueryBlend,void> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   uVar2 = 0;
   LAB_0010865d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* CallableCustomMethodPointer<EditorFileSystemImportFormatSupportQueryBlend, void,
   String>::get_object() const */undefined8 CallableCustomMethodPointer<EditorFileSystemImportFormatSupportQueryBlend,void,String>::get_object(CallableCustomMethodPointer<EditorFileSystemImportFormatSupportQueryBlend,void,String> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   uVar2 = 0;
   LAB_0010875d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Removing unreachable block (ram,0x00108a28) *//* HBoxContainer::_getv(StringName const&, Variant&) const */undefined8 HBoxContainer::_getv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
   if (( (code*)PTR__get_0011b020 != CanvasItem::_get ) && ( uVar1 = Control::_get(param_1, param_2) ),(char)uVar1 != '\0') {
      return uVar1;
   }
...
/* WARNING: Removing unreachable block (ram,0x00108a98) *//* VBoxContainer::_getv(StringName const&, Variant&) const */undefined8 VBoxContainer::_getv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
   if (( (code*)PTR__get_0011b020 != CanvasItem::_get ) && ( uVar1 = Control::_get(param_1, param_2) ),(char)uVar1 != '\0') {
      return uVar1;
   }
...
/* VBoxContainer::~VBoxContainer() */void VBoxContainer::~VBoxContainer(VBoxContainer *this) {
   ...
   *(code**)this = String::parse_latin1;
   ...
   LAB_00108c40:Control::~Control((Control*)this);
   return;
}
/* HBoxContainer::~HBoxContainer() */void HBoxContainer::~HBoxContainer(HBoxContainer *this) {
   ...
   *(code**)this = String::parse_latin1;
   ...
   LAB_00108ca0:Control::~Control((Control*)this);
   return;
}
/* VBoxContainer::~VBoxContainer() */void VBoxContainer::~VBoxContainer(VBoxContainer *this) {
   bool bVar1;
   ...
   *(code**)this = String::parse_latin1;
   ...
   LAB_00108d00:Control::~Control((Control*)this);
...
/* HBoxContainer::~HBoxContainer() */void HBoxContainer::~HBoxContainer(HBoxContainer *this) {
   ...
   *(code**)this = String::parse_latin1;
   ...
   LAB_00108d70:Control::~Control((Control*)this);
   operator_delete(this, 0xa10);
   return;
}
/* EditorFileSystemImportFormatSupportQuery::~EditorFileSystemImportFormatSupportQuery() */void EditorFileSystemImportFormatSupportQuery::~EditorFileSystemImportFormatSupportQuery(EditorFileSystemImportFormatSupportQuery *this) {
   ...
   *(undefined***)this = &PTR__initialize_classv_00115c48;
   ...
   LAB_00108dff:*(undefined***)this = &PTR__initialize_classv_00115ae8;
   Object::~Object((Object*)this);
...
/* RefCounted::_get_class_namev() const */undefined8 *RefCounted::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00108f43:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00108f43;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "RefCounted");
   LAB_00108fae:return &_get_class_namev();
}
/* GLTFState::_get_class_namev() const */undefined8 *GLTFState::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00109023:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00109023;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "GLTFState");
   LAB_0010908e:return &_get_class_namev();
}
/* VBoxContainer::_get_class_namev() const */undefined8 *VBoxContainer::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00109113:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00109113;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "VBoxContainer");
   LAB_0010917e:return &_get_class_namev();
}
...
/* EditorFileSystemImportFormatSupportQueryBlend::_get_class_namev() const */undefined8 *EditorFileSystemImportFormatSupportQueryBlend::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00109313:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00109313;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorFileSystemImportFormatSupportQueryBlend");
         goto LAB_0010937e;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorFileSystemImportFormatSupportQueryBlend");
   LAB_0010937e:return &_get_class_namev();
}
/* EditorSceneFormatImporterBlend::_get_class_namev() const */undefined8 *EditorSceneFormatImporterBlend::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00109413:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00109413;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorSceneFormatImporterBlend");
         goto LAB_0010947e;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorSceneFormatImporterBlend");
   LAB_0010947e:return &_get_class_namev();
}
/* EditorFileSystemImportFormatSupportQuery::_get_class_namev() const */undefined8 *EditorFileSystemImportFormatSupportQuery::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00109523:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00109523;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorFileSystemImportFormatSupportQuery");
         goto LAB_0010958e;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorFileSystemImportFormatSupportQuery");
   LAB_0010958e:return &_get_class_namev();
}
...
/* EditorSceneFormatImporterBlend::get_class() const */void EditorSceneFormatImporterBlend::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* EditorFileSystemImportFormatSupportQuery::get_class() const */void EditorFileSystemImportFormatSupportQuery::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* EditorFileSystemImportFormatSupportQueryBlend::get_class() const */void EditorFileSystemImportFormatSupportQueryBlend::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* EditorFileSystemImportFormatSupportQueryBlend::~EditorFileSystemImportFormatSupportQueryBlend()
   ...
   *(undefined***)this = &PTR__initialize_classv_00115c48;
   ...
   LAB_00109c3d:*(undefined***)this = &PTR__initialize_classv_00115ae8;
   Object::~Object((Object*)this);
   return;
}
/* EditorFileSystemImportFormatSupportQueryBlend::~EditorFileSystemImportFormatSupportQueryBlend()
   ...
   *(undefined***)this = &PTR__initialize_classv_00115c48;
   ...
   LAB_00109d11:*(undefined***)this = &PTR__initialize_classv_00115ae8;
   Object::~Object((Object*)this);
   operator_delete(this, 0x200);
   return;
}
/* EditorSceneFormatImporterBlend::~EditorSceneFormatImporterBlend() */void EditorSceneFormatImporterBlend::~EditorSceneFormatImporterBlend(EditorSceneFormatImporterBlend *this) {
   long *plVar1;
   long lVar2;
   bool bVar3;
   ...
   *(code**)this = String::operator ==;
   ...
   LAB_00109e10:*(undefined***)this = &PTR__initialize_classv_00115ae8;
   Object::~Object((Object*)this);
   return;
}
/* EditorSceneFormatImporterBlend::~EditorSceneFormatImporterBlend() */void EditorSceneFormatImporterBlend::~EditorSceneFormatImporterBlend(EditorSceneFormatImporterBlend *this) {
   ...
   *(code**)this = String::operator ==;
   ...
   LAB_00109f00:*(undefined***)this = &PTR__initialize_classv_00115ae8;
   Object::~Object((Object*)this);
...
/* RefCounted::is_class(String const&) const */undefined8 RefCounted::is_class(RefCounted *this, String *param_1) {
   ...
   if (cVar5 == '\0') {
      ...
      LAB_0010a04b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* EditorFileSystemImportFormatSupportQuery::is_class(String const&) const */undefined8 EditorFileSystemImportFormatSupportQuery::is_class(EditorFileSystemImportFormatSupportQuery *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *__s;
   long lVar3;
 ...
 while ( !bVar8 );
      ...
      LAB_0010a1ef:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_0010a2a3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* EditorSceneFormatImporterBlend::is_class(String const&) const */undefined8 EditorSceneFormatImporterBlend::is_class(EditorSceneFormatImporterBlend *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long lVar4;
   ...
   LAB_0010a41b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0010a558:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* EditorFileSystemImportFormatSupportQueryBlend::is_class(String const&) const */undefined8 EditorFileSystemImportFormatSupportQueryBlend::is_class(EditorFileSystemImportFormatSupportQueryBlend *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long lVar4;
   ...
   LAB_0010a65b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0010a798:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* Resource::is_class(String const&) const */undefined8 Resource::is_class(Resource *this, String *param_1) {
 ...
 while ( !bVar8 );
      ...
      LAB_0010aaff:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_0010abb3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* GLTFState::is_class(String const&) const */undefined8 GLTFState::is_class(GLTFState *this, String *param_1) {
 ...
 while ( !bVar8 );
      ...
      LAB_0010ac7f:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
...
/* WARNING: Removing unreachable block (ram,0x0010aed0) *//* BoxContainer::_notificationv(int, bool) */void BoxContainer::_notificationv(BoxContainer *this, int param_1, bool param_2) {
   int iVar1;
   iVar1 = (int)this;
   if (param_2) {
...
/* ResourceImporter::ImportOption::~ImportOption() */void ResourceImporter::ImportOption::~ImportOption(ImportOption *this) {
   long *plVar1;
   long lVar2;
...
/* void Ref<GLTFDocument>::instantiate<>() */void Ref<GLTFDocument>::instantiate<>(Ref<GLTFDocument> *this) {
   long lVar1;
   char cVar2;
   Resource *this_00;
   long lVar3;
   ...
   *(undefined8*)( this_00 + 0x270 ) = 0;
      ...
      if (this_00 != (Resource*)pOVar6) {
         *(Resource**)this = this_00;
         ...
         if (( ( pOVar6 != (Object*)0x0 ) && ( cVar2 = RefCounted::unreference() ),cVar2 != '\0' )) {
            LAB_0010b35a:( **(code**)( *(long*)pOVar6 + 0x140 ) )(pOVar6);
   ...
   LAB_0010b29f:if (lVar1 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }

   LAB_0010b398:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
   ...
   *(undefined1(*) [16])( this_00 + 0x538 ) = (undefined1[16])0x0;
   ...
   if (cVar2 == '\0') {
      ...
      *(Resource**)this = this_00;
      ...
      pOVar4 = (Object*)this_00;
      if (( ( pOVar6 == (Object*)0x0 ) || ( cVar2 = RefCounted::unreference() ),cVar2 == '\0' )) goto LAB_0010b655;
   }
   ...
   LAB_0010b655:cVar2 = RefCounted::unreference();
   if (( cVar2 != '\0' ) && ( cVar2 = cVar2 != '\0' )) {
      ( **(code**)( *(long*)pOVar4 + 0x140 ) )(pOVar4);
      Memory::free_static(pOVar4, false);
      return;
...
/* Callable
   ...
   char const*, void (EditorFileSystemImportFormatSupportQueryBlend::*)()) */EditorFileSystemImportFormatSupportQueryBlend *create_custom_callable_function_pointer<EditorFileSystemImportFormatSupportQueryBlend>(EditorFileSystemImportFormatSupportQueryBlend *param_1, char *param_2, _func_void *param_3) {
   undefined8 uVar1;
   CallableCustom *this;
   undefined8 in_RCX;
   undefined8 in_R8;
...
/* Callable create_custom_callable_function_pointer<EditorFileSystemImportFormatSupportQueryBlend,
   ...
   (EditorFileSystemImportFormatSupportQueryBlend::*)(String)) */EditorFileSystemImportFormatSupportQueryBlend *create_custom_callable_function_pointer<EditorFileSystemImportFormatSupportQueryBlend,String>(EditorFileSystemImportFormatSupportQueryBlend *param_1, char *param_2, _func_void_String *param_3) {
   undefined8 uVar1;
   CallableCustom *this;
   undefined8 in_RCX;
   undefined8 in_R8;
...
GetTypeInfo<bool,void>::get_class_info(GetTypeInfo<bool,void> *this){
   ...
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   ...
   LAB_0010b995:CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
...
GetTypeInfo<Vector<String>,void>::get_class_info(GetTypeInfo<Vector<String>,void> *this){
   ...
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   ...
   StringName::operator =((StringName*)( this + 0x10 ), (StringName*)&local_50);
   LAB_0010baf5:CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
   if (( StringName::configured != '\0' ) && ( local_50 != 0 )) {
      StringName::unref();
   }
...
/* EditorSceneFormatImporterBlend::_initialize_classv() */void EditorSceneFormatImporterBlend::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_70;
   undefined8 local_68;
   long local_60;
...
/* WARNING: Removing unreachable block (ram,0x0010c338) *//* String vformat<int>(String const&, int const) */String *vformat<int>(String *param_1, int param_2) {
   char cVar1;
   Variant *this;
   int in_EDX;
...
/* WARNING: Removing unreachable block (ram,0x0010c670) *//* String vformat<String, String>(String const&, String const, String const) */undefined8 *vformat<String,String>(undefined8 *param_1, bool *param_2, String *param_3, String *param_4) {
   Variant *pVVar1;
   Variant *pVVar2;
   int iVar3;
   long in_FS_OFFSET;
...
/* PropertyListHelper::~PropertyListHelper() */void PropertyListHelper::~PropertyListHelper(PropertyListHelper *this) {
 ...
 while ( lVar4 != (ulong)uVar2 << 2 );
   ...
   LAB_0010d114:CowData<char32_t>::_unref((CowData<char32_t>*)this);
   return;
}
...
/* CallableCustomMethodPointer<EditorFileSystemImportFormatSupportQueryBlend, void>::call(Variant
   const**, int, Variant&, Callable::CallError&) const */void CallableCustomMethodPointer<EditorFileSystemImportFormatSupportQueryBlend,void>::call(CallableCustomMethodPointer<EditorFileSystemImportFormatSupportQueryBlend,void> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long lVar1;
   long lVar2;
   uint uVar3;
   ulong *puVar4;
...
;
      ...
      *(undefined4*)( param_4 + 8 ) = 0;
      ...
      _err_print_error(&_LC70, "./core/object/callable_method_pointer.h", 0x67, "Parameter \"ObjectDB::get_instance(ObjectID(data.object_id))\" is null.", (String*)&local_48, 0, 0);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_48);
   ...
   LAB_0010d5a1:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* CallableCustomMethodPointer<EditorFileSystemImportFormatSupportQueryBlend, void,
   String>::call(Variant const**, int, Variant&, Callable::CallError&) const */void CallableCustomMethodPointer<EditorFileSystemImportFormatSupportQueryBlend,void,String>::call(CallableCustomMethodPointer<EditorFileSystemImportFormatSupportQueryBlend,void,String> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long lVar1;
   long lVar2;
   ulong uVar3;
   undefined8 uVar4;
...
;
   ...
   local_58,(String*)"Invalid Object id \'";
   String::operator +((String*)&local_48, (String*)local_58);
   _err_print_error(&_LC70, "./core/object/callable_method_pointer.h", 0x67, "Parameter \"ObjectDB::get_instance(ObjectID(data.object_id))\" is null.", (Variant*)&local_48, 0, 0);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_48);
   CowData<char32_t>::_unref(local_58);
   CowData<char32_t>::_unref(local_60);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_50);
   LAB_0010d67e:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* CanvasItem::is_class(String const&) const */undefined8 CanvasItem::is_class(CanvasItem *this, String *param_1) {
   ...
   LAB_0010d92b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0010db08:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* BoxContainer::is_class(String const&) const */undefined8 BoxContainer::is_class(BoxContainer *this, String *param_1) {
   ...
   LAB_0010e0db:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0010e29e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* VBoxContainer::is_class(String const&) const */undefined8 VBoxContainer::is_class(VBoxContainer *this, String *param_1) {
 ...
 while ( !bVar8 );
      ...
      LAB_0010e31f:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_0010e3d3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* HBoxContainer::is_class(String const&) const */undefined8 HBoxContainer::is_class(HBoxContainer *this, String *param_1) {
 ...
 while ( !bVar8 );
      ...
      LAB_0010e49f:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_0010e553:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* RefCounted::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void RefCounted::_get_property_listv(List *param_1, bool param_2) {
   ...
   LAB_0010f37c:List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)CONCAT71(in_register_00000031, param_2), (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
   }
...
/* Resource::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Resource::_get_property_listv(Resource *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_0010f5e1:local_b0 = (CowData<char32_t>*)&local_58;
...
/* GLTFState::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void GLTFState::_get_property_listv(GLTFState *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_0010f891:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* EditorSceneFormatImporter::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_0010fb41:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* EditorFileSystemImportFormatSupportQuery::_get_property_listv(List<PropertyInfo,
   DefaultAllocator>*, bool) const */void EditorFileSystemImportFormatSupportQuery::_get_property_listv(EditorFileSystemImportFormatSupportQuery *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   CowData<char32_t> *local_b0;
   long local_98;
   long local_90;
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_0010fdf1:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* EditorSceneFormatImporterBlend::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool)
   const */void EditorSceneFormatImporterBlend::_get_property_listv(EditorSceneFormatImporterBlend *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   CowData<char32_t> *local_b0;
   long local_98;
   long local_90;
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_001100a1:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* EditorFileSystemImportFormatSupportQueryBlend::_get_property_listv(List<PropertyInfo,
   DefaultAllocator>*, bool) const */void EditorFileSystemImportFormatSupportQueryBlend::_get_property_listv(EditorFileSystemImportFormatSupportQueryBlend *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   CowData<char32_t> *local_b0;
   long local_98;
   long local_90;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (!param_2) {
      EditorFileSystemImportFormatSupportQuery::_get_property_listv((EditorFileSystemImportFormatSupportQuery*)this, param_1, false);
   }
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00110351:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
   ...
   StringName::StringName((StringName*)&local_78, "EditorFileSystemImportFormatSupportQueryBlend", false);
   ClassDB::get_property_list((StringName*)&local_78, param_1, true, (Object*)this);
   if (( StringName::configured != '\0' ) && ( local_78 != (char*)0x0 )) {
      StringName::unref();
   }
   ...
   if (param_2) {
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         EditorFileSystemImportFormatSupportQuery::_get_property_listv((EditorFileSystemImportFormatSupportQuery*)this, param_1, true);
         return;
      }
...
/* CanvasItem::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void CanvasItem::_get_property_listv(CanvasItem *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_0011071f:List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
...
/* Control::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Control::_get_property_listv(Control *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00110c31:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* Container::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Container::_get_property_listv(Container *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00110f01:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* BoxContainer::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void BoxContainer::_get_property_listv(BoxContainer *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_001111b1:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* VBoxContainer::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void VBoxContainer::_get_property_listv(VBoxContainer *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00111461:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* HBoxContainer::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void HBoxContainer::_get_property_listv(HBoxContainer *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00111711:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* EditorFileSystemImportFormatSupportQuery::_bind_methods() */void EditorFileSystemImportFormatSupportQuery::_bind_methods(void) {
   long *plVar1;
   long lVar2;
   long in_FS_OFFSET;
   long local_110;
   ...
   local_100 = 0;
   PropertyInfo::PropertyInfo((PropertyInfo*)&local_e8, 1, (CowData<char32_t>*)&local_100, 0, (StrRange*)&local_108, 6, &local_110);
   ...
   String::parse_latin1((StrRange*)&local_108);
   local_100 = 0;
   PropertyInfo::PropertyInfo((PropertyInfo*)&local_e8, 0x22, (CowData<char32_t>*)&local_100, 0, (StrRange*)&local_108, 6, &local_110);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_100);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_108);
   if (( StringName::configured != '\0' ) && ( local_110 != 0 )) {
      StringName::unref();
...
/* EditorFileSystemImportFormatSupportQueryBlend::_initialize_classv() */void EditorFileSystemImportFormatSupportQueryBlend::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_70;
   undefined8 local_68;
   long local_60;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (initialize_class() == '\0') {
      if (EditorFileSystemImportFormatSupportQuery::initialize_class() == '\0') {
         if (RefCounted::initialize_class() == '\0') {
            Object::initialize_class();
            local_68 = 0;
            local_50 = 6;
         ...
         EditorFileSystemImportFormatSupportQuery::initialize_class()::initialized =
         '\x01';
      }
...
/* EditorFileSystemImportFormatSupportQuery::_initialize_classv() */void EditorFileSystemImportFormatSupportQuery::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_70;
   undefined8 local_68;
   long local_60;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<String>::resize<false>(long) */undefined8 CowData<String>::resize<false>(CowData<String> *this, long param_1) {
   ...
   if (param_1 * 8 == 0) {
      LAB_00112e70:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (lVar9 == lVar5) {
      LAB_00112deb:puVar7 = *(undefined8**)this;
      if (puVar7 == (undefined8*)0x0) {
         LAB_00112ec6:/* WARNING: Does not return */pcVar1 = (code*)invalidInstructionException();
         ( *pcVar1 )();
      }
...
/* EditorFileSystemImportFormatSupportQuery::query() */bool EditorFileSystemImportFormatSupportQuery::query(EditorFileSystemImportFormatSupportQuery *this) {
   undefined4 uVar1;
   undefined8 uVar2;
   long lVar3;
   long *plVar4;
      ...
      *(undefined8*)( this + 0x1c0 ) = 0;
      ...
      if (( ( pcVar5 == (code*)0x0 ) || ( *(long*)( lVar3 + 0xe0 ) == 0 ) ) && ( pcVar5 = *(code**)( lVar3 + 0xd0 ) ),pcVar5 == (code*)0x0) {
         ...
         if (local_f0[0] == 0) {
            ...
            if (( StringName::configured != '\0' ) && ( lVar3 = local_100 != 0 )) goto LAB_00113419;
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_108);
            LAB_0011342e:lVar3 = *(long*)( this + 8 );
            pcVar5 = *(code**)( lVar3 + 200 );
            if (( ( pcVar5 == (code*)0x0 ) || ( *(long*)( lVar3 + 0xe0 ) == 0 ) ) && ( pcVar5 = *(code**)( lVar3 + 0xc0 ) ),pcVar5 == (code*)0x0) goto LAB_00113368;
      ...
      LAB_00113368:if (*(char*)( lVar3 + 0x29 ) != '\0') {
   ...
   if (pcVar5 == (code*)0x0) {
      if (_gdvirtual__query_call(bool&), ::first_print == '\0') {
         ...
         _err_print_error("_gdvirtual__query_call", "./editor/editor_file_system.h", 0x7b, (String*)local_c8, 0, 0);
         ...
         _gdvirtual__query_call(bool&)::first_print =
         '\0';
         bVar6 = false;
      }
   ...
   LAB_0011306f:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* EditorFileSystemImportFormatSupportQuery::get_file_extensions() const */void EditorFileSystemImportFormatSupportQuery::get_file_extensions(void) {
   undefined4 uVar1;
   long lVar2;
   long *plVar3;
   code *pcVar4;
   ...
   *(undefined8*)( in_RDI + 8 ) = 0;
   ...
   if (( in_RSI[1] != 0 ) && ( (char)in_RSI[0x34] == '\0' )) {
      ...
      if (( ( pcVar4 == (code*)0x0 ) || ( *(long*)( lVar2 + 0xe0 ) == 0 ) ) && ( pcVar4 = *(code**)( lVar2 + 0xd0 ) ),pcVar4 == (code*)0x0) {
         ...
         if (CONCAT44(uStack_ec, uStack_f0) == 0) {
            ...
            if (( StringName::configured != '\0' ) && ( lVar2 = local_100 != 0 )) goto LAB_00113a4f;
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_108);
            LAB_00113a64:lVar2 = in_RSI[1];
            pcVar4 = *(code**)( lVar2 + 200 );
            if (( ( pcVar4 == (code*)0x0 ) || ( *(long*)( lVar2 + 0xe0 ) == 0 ) ) && ( pcVar4 = *(code**)( lVar2 + 0xc0 ) ),pcVar4 == (code*)0x0) goto LAB_0011399e;
      ...
      LAB_0011399e:if (*(char*)( lVar2 + 0x29 ) != '\0') {
   ...
   if (pcVar4 == (code*)0x0) {
      if (_gdvirtual__get_file_extensions_call(Vector<String> & ::first_print != '\0') {
         ...
         String::operator +((String*)&local_100, local_110);
         String::operator +((String*)&local_c8, (String*)&local_100);
         _err_print_error("_gdvirtual__get_file_extensions_call", "./editor/editor_file_system.h", 0x7a, (String*)&local_c8, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_c8);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_100);
         CowData<char32_t>::_unref((CowData<char32_t>*)local_110);
         CowData<char32_t>::_unref(local_120);
         ...
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_108);
         CowData<char32_t>::_unref((CowData<char32_t>*)local_f8);
         _gdvirtual__get_file_extensions_call(Vector<String>&)::first_print =
         '\0';
      }
   ...
   LAB_00113665:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* EditorFileSystemImportFormatSupportQuery::is_active() const */bool EditorFileSystemImportFormatSupportQuery::is_active(EditorFileSystemImportFormatSupportQuery *this) {
   undefined4 uVar1;
   undefined8 uVar2;
   long lVar3;
   long *plVar4;
   ...
   if (( *(long*)( this + 8 ) != 0 ) && ( this[0x188] == (EditorFileSystemImportFormatSupportQuery)0x0 )) {
      ...
      *(undefined8*)( this + 400 ) = 0;
      ...
      if (( ( pcVar5 == (code*)0x0 ) || ( *(long*)( lVar3 + 0xe0 ) == 0 ) ) && ( pcVar5 = *(code**)( lVar3 + 0xd0 ) ),pcVar5 == (code*)0x0) {
         ...
         if (local_f0[0] == 0) {
            CowData<unsigned_int>::_unref((CowData<unsigned_int>*)local_f0);
            if (( StringName::configured != '\0' ) && ( lVar3 = local_100 != 0 )) goto LAB_00113fc9;
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_108);
            LAB_00113fde:lVar3 = *(long*)( this + 8 );
            pcVar5 = *(code**)( lVar3 + 200 );
            if (( ( pcVar5 == (code*)0x0 ) || ( *(long*)( lVar3 + 0xe0 ) == 0 ) ) && ( pcVar5 = *(code**)( lVar3 + 0xc0 ) ),pcVar5 == (code*)0x0) goto LAB_00113f18;
      ...
      LAB_00113f18:if (*(char*)( lVar3 + 0x29 ) != '\0') {
         plVar4 = (long*)operator_new(0x18, "");
   ...
   if (pcVar5 == (code*)0x0) {
      if (_gdvirtual__is_active_call(bool&), ::first_print == '\0') {
         ...
         String::operator +((String*)&local_100, local_110);
         String::operator +((String*)local_c8, (String*)&local_100);
         _err_print_error("_gdvirtual__is_active_call", "./editor/editor_file_system.h", 0x79, (String*)local_c8, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)local_c8);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_100);
         CowData<char32_t>::_unref((CowData<char32_t>*)local_110);
         CowData<char32_t>::_unref(local_120);
         ...
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_108);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_f8);
         _gdvirtual__is_active_call(bool&)::first_print =
         '\0';
         bVar6 = false;
      }
      ...
      ( **(code**)( *(long*)( this + 8 ) + 0xe0 ) )(*(undefined8*)( this + 0x10 ), this + 0x180, pcVar5, 0, local_c8);
      bVar6 = local_c8[0]._0_1_ != (String)0x0;
   }

   LAB_00113c1f:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* GLTFState::~GLTFState() */void GLTFState::~GLTFState(GLTFState *this) {
 ...
 while ( (ulong)uVar4 << 2 != lVar10 );
                  ...
                  LAB_001147dd:Memory::free_static(pvVar14, false);
                  pvVar14 = *(void**)( this + 0x528 );
 ...
 while ( lVar16 != (ulong)uVar3 << 2 );
   ...
   LAB_00114826:pvVar14 = *(void**)( this + 0x4f8 );
   if (pvVar14 != (void*)0x0) {
      if (*(int*)( this + 0x51c ) != 0) {
 ...
 while ( (ulong)uVar3 << 2 != lVar16 );
   ...
   LAB_001148bf:pvVar14 = *(void**)( this + 0x4c8 );
   if (pvVar14 != (void*)0x0) {
      if (*(int*)( this + 0x4ec ) != 0) {
 ...
 while ( (ulong)uVar3 << 2 != lVar16 );
   ...
   LAB_00114982:pvVar14 = *(void**)( this + 0x498 );
   if (pvVar14 != (void*)0x0) {
      if (*(int*)( this + 0x4bc ) != 0) {
 ...
 while ( lVar16 != (ulong)uVar3 << 2 );
   ...
   LAB_00114a21:pvVar14 = *(void**)( this + 0x468 );
   if (pvVar14 != (void*)0x0) {
      if (*(int*)( this + 0x48c ) != 0) {
 ...
 while ( lVar16 != (ulong)uVar3 << 2 );
   ...
   LAB_00114ac1:CowData<Ref<GLTFAnimation>>::_unref((CowData<Ref<GLTFAnimation>>*)( this + 0x458 ));
...
;
 ...
 while ( lVar16 != lVar10 );
         ...
         LAB_00114b70:Memory::free_static(plVar1 + -2, false);
      }
 ...
 while ( (uint)lVar16 < *(uint*)( this + 0x43c ) );
   ...
   LAB_00114c0f:pvVar14 = *(void**)( this + 0x3f0 );
   if (pvVar14 != (void*)0x0) {
 ...
 while ( (uint)lVar16 < *(uint*)( this + 0x414 ) );
   ...
   LAB_00114c97:if (*(long*)( this + 1000 ) != 0) {
      LOCK();
...
;
 ...
 while ( lVar16 != lVar10 );
         ...
         LAB_00114d38:Memory::free_static(plVar1 + -2, false);
      }
...
;
 ...
 while ( lVar16 != lVar10 );
         ...
         LAB_00114e40:Memory::free_static(plVar1 + -2, false);
      }
...
;
 ...
 while ( lVar16 != lVar10 );
         ...
         LAB_00114f08:Memory::free_static(plVar1 + -2, false);
      }
...
;
 ...
 while ( lVar16 != lVar10 );
         ...
         LAB_00114fd0:Memory::free_static(plVar1 + -2, false);
      }
...
;
 ...
 while ( lVar16 != lVar10 );
         ...
         LAB_001150b0:Memory::free_static(plVar1 + -2, false);
      }
 ...
 while ( lVar16 != (ulong)uVar3 << 2 );
   ...
   LAB_00115175:if (*(long*)( this + 0x2f8 ) != 0) {
      LOCK();
...
;
 ...
 while ( lVar16 != lVar10 );
         ...
         LAB_00115230:Memory::free_static(plVar1 + -2, false);
      }
   ...
   if (*(long*)( this + 0x2b8 ) != 0) {
      ...
      *plVar1 = *plVar1 + -1;
      ...
      if (*plVar1 == 0) {
         ...
         if (lVar16 == 0) {
            LAB_00115674:/* WARNING: Does not return */pcVar7 = (code*)invalidInstructionException();
            ( *pcVar7 )();
         }
...
/* EditorSceneFormatImporterBlend::get_extensions(List<String, DefaultAllocator>*) const */void EditorSceneFormatImporterBlend::_GLOBAL__sub_I_get_extensions(void) {
...
/* WARNING: Control flow encountered bad instruction data *//* ResourceImporter::ImportOption::~ImportOption() */void ResourceImporter::ImportOption::~ImportOption(ImportOption *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* PropertyInfo::PropertyInfo(PropertyInfo const&) */void PropertyInfo::PropertyInfo(PropertyInfo *this, PropertyInfo *param_1) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* EditorSceneFormatImporterBlend::~EditorSceneFormatImporterBlend() */void EditorSceneFormatImporterBlend::~EditorSceneFormatImporterBlend(EditorSceneFormatImporterBlend *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* EditorFileSystemImportFormatSupportQueryBlend::~EditorFileSystemImportFormatSupportQueryBlend()
    */void EditorFileSystemImportFormatSupportQueryBlend::~EditorFileSystemImportFormatSupportQueryBlend(EditorFileSystemImportFormatSupportQueryBlend *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* EditorFileSystemImportFormatSupportQuery::~EditorFileSystemImportFormatSupportQuery() */void EditorFileSystemImportFormatSupportQuery::~EditorFileSystemImportFormatSupportQuery(EditorFileSystemImportFormatSupportQuery *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<EditorFileSystemImportFormatSupportQueryBlend,
   void>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<EditorFileSystemImportFormatSupportQueryBlend,void>::~CallableCustomMethodPointer(CallableCustomMethodPointer<EditorFileSystemImportFormatSupportQueryBlend,void> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<EditorFileSystemImportFormatSupportQueryBlend, void,
   String>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<EditorFileSystemImportFormatSupportQueryBlend,void,String>::~CallableCustomMethodPointer(CallableCustomMethodPointer<EditorFileSystemImportFormatSupportQueryBlend,void,String> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

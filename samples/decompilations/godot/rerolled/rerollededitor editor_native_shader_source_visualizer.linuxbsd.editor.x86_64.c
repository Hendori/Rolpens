...
/* EditorNativeShaderSourceVisualizer::EditorNativeShaderSourceVisualizer() */void EditorNativeShaderSourceVisualizer::EditorNativeShaderSourceVisualizer(EditorNativeShaderSourceVisualizer *this) {
   long in_FS_OFFSET;
   undefined8 local_58;
   undefined8 local_50;
   char *local_48;
...
/* EditorNativeShaderSourceVisualizer::_load_theme_settings() */void EditorNativeShaderSourceVisualizer::_load_theme_settings(void) {
   undefined8 uVar1;
   String *pSVar2;
   char cVar3;
   CowData *pCVar4;
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_a0);
   local_a0 = 0;
   String::parse_latin1((String*)&local_a0, "text_editor/theme/highlighting/control_flow_keyword_color");
   _EDITOR_GET((String*)local_58);
...
;
   ...
   CodeHighlighter::add_color_region(pSVar2, (String*)&local_a8, (String*)&local_a0, SUB81(local_78, 0));
   ...
   local_a8 = 0;
   String::parse_latin1((String*)&local_a8, "#");
   CodeHighlighter::add_color_region(pSVar2, (String*)&local_a8, (String*)&local_a0, SUB81(local_68, 0));
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_a8);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_a0);
...
/* EditorNativeShaderSourceVisualizer::_bind_methods() */void EditorNativeShaderSourceVisualizer::_bind_methods(void) {
   long lVar1;
   code *pcVar2;
   long *plVar3;
   MethodBind *pMVar4;
...
/* EditorNativeShaderSourceVisualizer::_inspect_shader(RID) */void EditorNativeShaderSourceVisualizer::_inspect_shader(EditorNativeShaderSourceVisualizer *this, undefined8 param_2) {
   code *pcVar1;
   char cVar2;
   int iVar3;
   long *plVar4;
   ...
   *(TabContainer**)( this + 0xdb0 ) = pTVar5;
   ...
   while (true) {
      if (( local_60 == 0 ) || ( *(long*)( local_60 + -8 ) <= local_a0 )) {
         ...
         CowData<RenderingServer::ShaderNativeSourceCode::Version>::_unref((CowData<RenderingServer::ShaderNativeSourceCode::Version>*)&local_60);
         if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            return;
         }
      ...
      while (true) {
         ...
         local_70 = (Object*)0x0;
         if (( ( *(long*)( this + 0xdb8 ) != 0 ) && ( pOVar6 = (Object*)__dynamic_cast(*(long*)( this + 0xdb8 ), &Object::typeinfo, &SyntaxHighlighter::typeinfo, 0) ),pOVar6 != (Object*)0x0 )) {
            local_70 = (Object*)0x0;
         }

         TextEdit::set_syntax_highlighter(this_00);
         if (( ( local_70 != (Object*)0x0 ) && ( cVar2 = RefCounted::unreference() ),pOVar6 = local_70,cVar2 != '\0' )) &&( cVar2 = cVar2 != '\0' )(**(code**)( *(long*)pOVar6 + 0x140 ))(pOVar6);
         Memory::free_static(pOVar6, false);
      }
;
      StringName::StringName((StringName*)&local_78, "source", false);
      Window::get_theme_font((StringName*)&local_70, (StringName*)this);
      Control::add_theme_font_override((StringName*)this_00, (Ref*)( SceneStringNames::singleton + 0xa0 ));
      if (( ( local_70 != (Object*)0x0 ) && ( cVar2 = RefCounted::unreference() ),pOVar6 = local_70,cVar2 != '\0' )) &&( cVar2 = cVar2 != '\0' )(**(code**)( *(long*)pOVar6 + 0x140 ))(pOVar6);
      Memory::free_static(pOVar6, false);
   }
;
   ...
   Control::add_theme_font_size_override((StringName*)this_00, (int)SceneStringNames::singleton + 0xa8);
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_70);
   local_70 = (Object*)0x0;
   String::parse_latin1((String*)&local_70, "text_editor/appearance/caret/highlight_current_line");
   _EDITOR_GET((String*)local_58);
   Variant::operator_cast_to_bool((Variant*)local_58);
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_70);
   local_70 = (Object*)0x0;
   String::parse_latin1((String*)&local_70, "text_editor/appearance/caret/highlight_all_occurrences");
   _EDITOR_GET((String*)local_58);
   Variant::operator_cast_to_bool((Variant*)local_58);
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_70);
   local_70 = (Object*)0x0;
   String::parse_latin1((String*)&local_70, "text_editor/appearance/gutters/line_numbers_zero_padded");
   _EDITOR_GET((String*)local_58);
   Variant::operator_cast_to_bool((Variant*)local_58);
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_78);
   local_70 = (Object*)0x0;
   String::parse_latin1((String*)&local_70, "text_editor/behavior/navigation/scroll_past_end_of_file");
   _EDITOR_GET((String*)local_58);
   Variant::operator_cast_to_bool((Variant*)local_58);
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_70);
   local_70 = (Object*)0x0;
   String::parse_latin1((String*)&local_70, "text_editor/behavior/navigation/drag_and_drop_selection");
   _EDITOR_GET((String*)local_58);
   Variant::operator_cast_to_bool((Variant*)local_58);
...
local_a0 = local_a0 + 1;}LAB_001015a9:lVar11 = 0;lVar8 = local_a0;LAB_001015cc:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar8, lVar11, "p_index", "size()", "", false, true);_err_flush_stdout();/* WARNING: Does not return */pcVar1 = (code*)invalidInstructionException();( *pcVar1 )();}/* DefaultAllocator::alloc(unsigned long) */void DefaultAllocator::alloc(ulong param_1) {
...
/* SyntaxHighlighter::is_class_ptr(void*) const */uint SyntaxHighlighter::is_class_ptr(SyntaxHighlighter *this, void *param_1) {
   return (uint)CONCAT71(0x1076, (undefined4*)param_1 == &Resource::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1076, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1076, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1076, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
...
/* EditorNativeShaderSourceVisualizer::is_class_ptr(void*) const */uint EditorNativeShaderSourceVisualizer::is_class_ptr(void *param_1) {
   undefined4 in_EDX;
   undefined4 *in_RSI;
   return (uint)CONCAT71(0x1076, in_RSI == &AcceptDialog::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1076, in_RSI == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1076, in_RSI == &Window::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1076, in_RSI == &Viewport::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1076, in_RSI == &Node::get_class_ptr_static(), ::ptr) | CONCAT31(( int3 )((uint)in_EDX >> 8), in_RSI == &Object::get_class_ptr_static(), ::ptr);
}
/* EditorNativeShaderSourceVisualizer::_property_can_revertv(StringName const&) const */undefined8 EditorNativeShaderSourceVisualizer::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* EditorNativeShaderSourceVisualizer::_property_get_revertv(StringName const&, Variant&) const */undefined8 EditorNativeShaderSourceVisualizer::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
...
/* EditorNativeShaderSourceVisualizer::_getv(StringName const&, Variant&) const */undefined8 EditorNativeShaderSourceVisualizer::_getv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
...
/* EditorNativeShaderSourceVisualizer::_setv(StringName const&, Variant const&) */undefined8 EditorNativeShaderSourceVisualizer::_setv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
...
/* EditorNativeShaderSourceVisualizer::_validate_propertyv(PropertyInfo&) const */void EditorNativeShaderSourceVisualizer::_validate_propertyv(PropertyInfo *param_1) {
...
/* EditorNativeShaderSourceVisualizer::_notificationv(int, bool) */void EditorNativeShaderSourceVisualizer::_notificationv(EditorNativeShaderSourceVisualizer *this, int param_1, bool param_2) {
   int iVar1;
   iVar1 = (int)this;
   if (param_2) {
...
/* SyntaxHighlighter::~SyntaxHighlighter() */void SyntaxHighlighter::~SyntaxHighlighter(SyntaxHighlighter *this) {
   ...
   *(undefined***)this = &PTR__initialize_classv_00107100;
   ...
   LAB_0010271c:pvVar4 = *(void**)( this + 0x240 );
   if (pvVar4 != (void*)0x0) {
...
/* EditorNativeShaderSourceVisualizer::_get_class_namev() const */undefined8 *EditorNativeShaderSourceVisualizer::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00102b33:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00102b33;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorNativeShaderSourceVisualizer");
         goto LAB_00102b9e;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EditorNativeShaderSourceVisualizer");
   LAB_00102b9e:return &_get_class_namev();
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* void Ref<CodeHighlighter>::instantiate<>() */void Ref<CodeHighlighter>::instantiate<>(Ref<CodeHighlighter> *this) {
   undefined8 uVar1;
   undefined8 uVar2;
   char cVar3;
   Resource *this_00;
   ...
   *(undefined1(*) [16])( this_00 + 0x2d8 ) = (undefined1[16])0x0;
   ...
   for (int i = 0; i < 5; i++) {
      *(undefined8*)( this_00 + ( 16*i + 768 ) ) = uVar1;
      *(undefined8*)( this_00 + ( 16*i + 776 ) ) = uVar2;
   }
   ...
   if (cVar3 == '\0') {
      ...
      *(Resource**)this = this_00;
      ...
      if (( ( pOVar7 == (Object*)0x0 ) || ( cVar3 = RefCounted::unreference() ),cVar3 == '\0' )) goto LAB_00102e75;
   }
   ...
   LAB_00102e75:cVar3 = RefCounted::unreference();
...
/* EditorNativeShaderSourceVisualizer::get_class() const */void EditorNativeShaderSourceVisualizer::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* Object::is_class(String const&) const */ulong Object::is_class(Object *this, String *param_1) {
   ...
   do {
      if (lVar1 == 0) {
         ...
         LAB_00103d57:/* WARNING: Subroutine does not return */__stack_chk_fail();
      }
...
/* Resource::is_class(String const&) const */undefined8 Resource::is_class(Resource *this, String *param_1) {
   ...
   LAB_00104073:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_00104166:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* SyntaxHighlighter::is_class(String const&) const */undefined8 SyntaxHighlighter::is_class(SyntaxHighlighter *this, String *param_1) {
   ...
   if (cVar3 == '\0') {
      ...
      LAB_0010424b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* Viewport::is_class(String const&) const */undefined8 Viewport::is_class(Viewport *this, String *param_1) {
   long lVar1;
   char *pcVar2;
   long lVar3;
   char cVar4;
   ...
   LAB_00104383:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0010448e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* AcceptDialog::is_class(String const&) const */undefined8 AcceptDialog::is_class(AcceptDialog *this, String *param_1) {
   ...
   LAB_00104583:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_00104676:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* EditorNativeShaderSourceVisualizer::is_class(String const&) const */undefined8 EditorNativeShaderSourceVisualizer::is_class(EditorNativeShaderSourceVisualizer *this, String *param_1) {
   long lVar1;
   char *__s;
   long lVar2;
   char cVar3;
   ...
   if (cVar3 == '\0') {
      ...
      LAB_0010475b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* PropertyListHelper::~PropertyListHelper() */void PropertyListHelper::~PropertyListHelper(PropertyListHelper *this) {
 ...
 while ( lVar2 != (ulong)uVar1 << 2 );
   ...
   LAB_0010489f:CowData<char32_t>::_unref((CowData<char32_t>*)this);
   return;
}
...
/* EditorNativeShaderSourceVisualizer::_get_property_listv(List<PropertyInfo, DefaultAllocator>*,
   bool) const */void EditorNativeShaderSourceVisualizer::_get_property_listv(EditorNativeShaderSourceVisualizer *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   undefined8 local_98;
   undefined8 local_90;
   long local_88;
...
/* MethodBind* create_method_bind<EditorNativeShaderSourceVisualizer, RID>(void
   (EditorNativeShaderSourceVisualizer::*)(RID)) */MethodBind *create_method_bind<EditorNativeShaderSourceVisualizer,RID>(_func_void_RID *param_1) {
   MethodBind *this;
   undefined8 in_RSI;
   long in_FS_OFFSET;
   undefined8 local_40;
...
/* EditorNativeShaderSourceVisualizer::_bind_methods() [clone .cold] */void EditorNativeShaderSourceVisualizer::_bind_methods(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* EditorNativeShaderSourceVisualizer::_initialize_classv() */void EditorNativeShaderSourceVisualizer::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_60;
   long local_58;
   undefined8 local_50;
...
/* WARNING: Removing unreachable block (ram,0x001065c8) *//* String vformat<StringName>(String const&, StringName const) */undefined8 *vformat<StringName>(undefined8 *param_1, bool *param_2, StringName *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* MethodBindT<RID>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<RID>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   LAB_001069f0:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<RID>::ptrcall(Object*, void const**, void*) const */void MethodBindT<RID>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   ...
   LAB_00106bc0:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<RID>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindT<RID>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   if (( ( plVar9 != (long*)0x0 ) && ( plVar9[1] != 0 ) ) && ( *(char*)( plVar9[1] + 0x2e ) != '\0' )) {
      ...
      if (local_38 == *plVar7) {
         ...
         String::parse_latin1((String*)&local_40, "Cannot call method bind \'%s\' on placeholder instance.");
         vformat<StringName>((StringName*)&local_38, (String*)&local_40, &local_48);
         _err_print_error(&_LC82, "./core/object/method_bind.h", 0x154, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: Variant()", (StringName*)&local_38, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_38);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_40);
         if (( StringName::configured != '\0' ) && ( local_48 != 0 )) {
            StringName::unref();
   ...
   if (in_R8D < 2) {
      ...
      if (pVVar10 == (Variant*)0x0) {
         ...
         LAB_00106da0:pVVar10 = *(Variant**)param_4;
      }
 else {
         lVar2 = *(long*)( pVVar10 + -8 );
         if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
            LAB_00106db0:uVar5 = 4;
            goto LAB_00106d55;
         }
      ...
      *in_R9 = 0;
      ...
      uVar5 = 3;
      LAB_00106d55:*in_R9 = uVar5;
      in_R9[2] = 1;
   }

   LAB_00106d60:*(undefined4*)param_1 = 0;
...
/* EditorNativeShaderSourceVisualizer::_load_theme_settings() */void EditorNativeShaderSourceVisualizer::_GLOBAL__sub_I__load_theme_settings(void) {
   undefined8 uStack_8;
...
/* WARNING: Control flow encountered bad instruction data *//* EditorNativeShaderSourceVisualizer::~EditorNativeShaderSourceVisualizer() */void EditorNativeShaderSourceVisualizer::~EditorNativeShaderSourceVisualizer(EditorNativeShaderSourceVisualizer *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

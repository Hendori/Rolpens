...
;
   ...
   *puVar1 = uVar38;
   *(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;
   LAB_0010a15c:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return puVar42 + 3;
   }

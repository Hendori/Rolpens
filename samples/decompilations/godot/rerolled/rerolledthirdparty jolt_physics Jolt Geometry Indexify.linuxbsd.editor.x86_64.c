/* JPH::sIndexifyVerticesBruteForce(JPH::Array<JPH::Triangle, JPH::STLAllocator<JPH::Triangle> >
   ...
   JPH::STLAllocator<unsigned int> >&, float) [clone .isra.0] */void JPH::sIndexifyVerticesBruteForce(Array *param_1, uint *param_2, uint *param_3, Array *param_4, float param_5) {
   Array *pAVar1;
   float fVar2;
   float fVar3;
   float fVar4;
   ...
   do {
      ...
      while (true) {
         ...
         uVar9 = (ulong)uVar5;
         pAVar1 = param_1 + ( ulong )(uVar5 / 3) * 0x2c + ( ulong )(uVar5 % 3) * 0xc;
         if (( *(float*)( pAVar1 + 8 ) - fVar4 ) * ( *(float*)( pAVar1 + 8 ) - fVar4 ) + ( *(float*)( pAVar1 + 4 ) - fVar3 ) * ( *(float*)( pAVar1 + 4 ) - fVar3 ) + ( *(float*)pAVar1 - fVar2 ) * ( *(float*)pAVar1 - fVar2 ) + 0.0 <= param_5 * param_5) break;
         puVar6 = puVar6 + 1;
 ...
 while ( bVar11 );
      ...
      if (uVar10 < uVar5) {
         do {
            uVar9 = (ulong)uVar10;
            uVar5 = uVar10;
            LAB_00100114:uVar10 = *(uint*)( param_4 + uVar9 * 4 );
         }
 while ( uVar10 < uVar5 );
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JPH::sIndexifyVerticesRecursively(JPH::Array<JPH::Triangle, JPH::STLAllocator<JPH::Triangle> >
   const&, unsigned int*, unsigned int, unsigned int*, JPH::Array<unsigned int,
   JPH::STLAllocator<unsigned int> >&, float, unsigned int) */void JPH::sIndexifyVerticesRecursively(Array *param_1, uint *param_2, uint param_3, uint *param_4, Array *param_5, float param_6, uint param_7) {
   uint *puVar1;
      ...
      do {
         ...
         if (puVar11 < puVar8) {
            ...
            do {
               uVar9 = *puVar5;
               puVar5 = puVar5 + 1;
               auVar2 = *(undefined1(*) [16])( *(long*)( param_1 + 0x10 ) + ( ulong )(uVar9 / 3) * 0x2c + ( ulong )(uVar9 % 3) * 0xc );
 ...
 while ( puVar5 < puVar8 );
         ...
         do {
            while (true) {
               uVar3 = *puVar5;
               if (fVar24 <= *(float*)( pAVar12 + (long)(int)uVar9 * 4 + ( ulong )(uVar3 / 3) * 0x2c + ( ulong )(uVar3 % 3) * 0xc ) - fVar20) break;
               *__dest = uVar3;
               __dest = __dest + 1;
               LAB_001002d3:puVar5 = puVar5 + 1;
               if (puVar13 <= puVar5) goto LAB_0010032f;
            }
;
            if (*(float*)( pAVar12 + (long)(int)uVar9 * 4 + ( ulong )(uVar3 / 3) * 0x2c + ( ulong )(uVar3 % 3) * 0xc ) - fVar20 <= param_6) {
               *puVar15 = uVar3;
               puVar15 = puVar15 + 1;
               goto LAB_001002d3;
            }
 ...
 while ( puVar5 < puVar13 );
         LAB_0010032f:uVar6 = (long)puVar15 - (long)param_4 >> 2;
         iVar4 = (int)uVar6;
         if (iVar4 == (int)uVar10) {
         ...
         sIndexifyVerticesRecursively(param_1, puVar11, iVar4 + (int)uVar14, param_4, param_5, param_6, local_84);
         local_84 = local_84 - 1;
         puVar11 = param_2;
         fVar20 = _UNK_00100c94;
         fVar21 = _UNK_00100c98;
         fVar17 = _UNK_00100c9c;
      }
 while ( 8 < uVar9 && bVar16 );
   ...
   puVar11 = param_2;
   LAB_00100478:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      LAB_001004f8:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }

   pAVar12 = *(Array**)( param_1 + 0x10 );
   pAVar7 = *(Array**)( param_5 + 0x10 );
   LAB_001004e5:sIndexifyVerticesBruteForce(pAVar12, puVar11, puVar8, pAVar7, param_6);
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* JPH::Indexify(JPH::Array<JPH::Triangle, JPH::STLAllocator<JPH::Triangle> > const&,
   JPH::Array<JPH::Float3, JPH::STLAllocator<JPH::Float3> >&, JPH::Array<JPH::IndexedTriangle,
   JPH::STLAllocator<JPH::IndexedTriangle> >&, float) */void JPH::Indexify(Array *param_1, Array *param_2, Array *param_3, float param_4) {
   undefined8 *puVar1;
   undefined8 *puVar2;
   int iVar3;
   ulong uVar4;
      ...
      *puVar15 = 0;
      ...
      if (1 < uVar8) {
         if (( uVar8 - 1 & 1 ) != 0) {
            puVar15[1] = 1;
            lVar10 = 2;
            if (uVar8 < 3) goto LAB_001009b6;
         }

         do {
            puVar15[lVar10] = (uint)lVar10;
            lVar20 = lVar10 + 1;
            lVar10 = lVar10 + 2;
            puVar15[lVar20] = (uint)lVar20;
         }
 while ( (uint)lVar10 < uVar8 );
      }

      LAB_001009b6:_local_78 = (undefined1[16])0x0;
      local_68 = (undefined4*)0x0;
      local_68 = (undefined4*)( *Reallocate )(0, 0);
      uStack_70._0_4_ = uVar8;
      local_78 = (Array[8])uVar17;
      uStack_70._4_4_ = 0;
      if (iVar5 != 0) {
         *local_68 = 0;
         lVar10 = 1;
         if (1 < uVar8) {
            if (( uVar8 - 1 & 1 ) != 0) {
               local_68[1] = 1;
               lVar10 = 2;
               if (uVar8 < 3) goto LAB_00100a42;
            }

            do {
               local_68[lVar10] = (int)lVar10;
               lVar20 = lVar10 + 1;
               lVar10 = lVar10 + 2;
               local_68[lVar20] = (int)lVar20;
            }
 while ( (uint)lVar10 < uVar8 );
         }
      ...
      LAB_00100a42:puVar16 = (uint*)( *Reallocate )(0, 0, uVar17 * 4);
      sIndexifyVerticesRecursively(param_1, puVar15, uVar8, puVar16, local_78, param_4, 0x20);
      if (puVar16 != (uint*)0x0) {
         ( *_Free )(puVar16);
      }
   ...
   if (iVar5 == 0) {
      ...
      *(undefined8*)param_3 = 0;
      ...
      uVar21 = 0;
      do {
         iVar3 = local_68[(uint)local_68[lVar10]];
         iVar9 = (int)lVar10;
         local_68[lVar10] = iVar3;
         lVar10 = lVar10 + 1;
 ...
 while ( (uint)lVar10 < uVar8 );
      uVar17 = (ulong)uVar21;
      *(undefined8*)param_2 = 0;
      if (*(ulong*)( param_2 + 8 ) < uVar17) {
         uVar11 = ( *Reallocate )(*(undefined8*)( param_2 + 0x10 ), *(ulong*)( param_2 + 8 ) * 0xc, uVar17 * 0xc);
      ...
      uVar17 = 0;
      while (true) {
         puVar16 = local_68 + uVar17;
         if (*puVar16 == (uint)uVar17) {
            lVar10 = *(long*)param_2;
            ...
            *(ulong*)param_2 = uVar13;
            ...
            if (puVar1 != (undefined8*)0x0) {
               puVar2 = (undefined8*)( lVar20 + ( ( uVar6 & 0xffffffff ) / 3 ) * 0x2c + ( ulong )(uint)((int)uVar6 + (int)( ( uVar6 & 0xffffffff ) / 3 ) * -3) * 0xc );
               *puVar1 = *puVar2;
            ...
            *puVar16 = local_68[*puVar16];
         }

         if (uVar8 <= (uint)uVar17 + 1) break;
         uVar17 = uVar17 + 1;
      }
;
      uVar18 = uVar18 & 0xffffffff;
      *(undefined8*)param_3 = 0;
      if (*(ulong*)( param_3 + 8 ) < uVar18) {
         uVar11 = ( *Reallocate )(*(undefined8*)( param_3 + 0x10 ), *(ulong*)( param_3 + 8 ) * 0x14, uVar18 * 0x14);
         *(undefined8*)( param_3 + 0x10 ) = uVar11;
         *(ulong*)( param_3 + 8 ) = uVar18;
         puVar22 = local_68;
      ...
      fVar30 = _LC8;
      do {
         uVar11 = *(undefined8*)( *(long*)( param_1 + 0x10 ) + 0x24 + lVar10 );
         puVar16 = &local_58;
         uVar19 = uVar21;
         do {
            uVar18 = (ulong)uVar19;
            puVar14 = puVar16 + 1;
            uVar19 = uVar19 + 1;
            *puVar16 = puVar22[uVar18];
            puVar16 = puVar14;
         }
 while ( &uStack_4c != puVar14 );
         uVar18 = (ulong)local_58;
         lVar20 = *(long*)( param_2 + 0x10 );
         fVar28 = *(float*)( lVar20 + 4 + uVar18 * 0xc );
         fVar27 = *(float*)( lVar20 + uVar18 * 0xc );
         fVar29 = *(float*)( lVar20 + 8 + uVar18 * 0xc );
         uVar18 = (ulong)uStack_54;
         uVar17 = (ulong)uStack_50;
         fVar24 = *(float*)( lVar20 + uVar18 * 0xc ) - fVar27;
         fVar25 = *(float*)( lVar20 + 4 + uVar18 * 0xc ) - fVar28;
         fVar26 = *(float*)( lVar20 + 8 + uVar18 * 0xc ) - fVar29;
         fVar27 = *(float*)( lVar20 + uVar17 * 0xc ) - fVar27;
         fVar28 = *(float*)( lVar20 + 4 + uVar17 * 0xc ) - fVar28;
         fVar29 = *(float*)( lVar20 + 8 + uVar17 * 0xc ) - fVar29;
         ...
         if (fVar30 < fVar23 * fVar23 + fVar27 * fVar27 + fVar28 * fVar28 + 0.0) {
            ...
            if (uVar17 < uVar18) {
               ...
               lVar12 = ( *Reallocate )(lVar12, uVar17 * 0x14, uVar18 * 0x14);
               lVar20 = *(long*)param_3;
               *(long*)( param_3 + 0x10 ) = lVar12;
               *(ulong*)( param_3 + 8 ) = uVar18;
               uVar18 = lVar20 + 1;
               puVar22 = local_68;
               fVar30 = _LC8;
            ...
            *(ulong*)param_3 = uVar18;
            puVar1 = (undefined8*)( lVar12 + lVar20 * 0x14 );
            if (puVar1 != (undefined8*)0x0) {
 ...
 while ( uVar21 != uVar8 );
   ...
   LAB_0010082f:if (puVar22 != (undefined4*)0x0) {
      auVar7._8_8_ = 0;
...
/* JPH::Deindexify(JPH::Array<JPH::Float3, JPH::STLAllocator<JPH::Float3> > const&,
   ...
   JPH::Array<JPH::Triangle, JPH::STLAllocator<JPH::Triangle> >&) */void JPH::Deindexify(Array *param_1, Array *param_2, Array *param_3) {
   ulong uVar1;
   uint *puVar2;
   undefined8 *puVar3;
   uint uVar4;
   ...
   if (uVar7 < uVar1) {
      if (uVar7 == 0) goto LAB_00100b88;
      do {
         *(undefined8*)( uVar7 + 0x24 ) = 0;
         LAB_00100b88:uVar7 = uVar7 + 0x2c;
      }
 while ( uVar7 < uVar1 );
   }
...
/* JPH::Indexify(JPH::Array<JPH::Triangle, JPH::STLAllocator<JPH::Triangle> > const&,
   JPH::Array<JPH::Float3, JPH::STLAllocator<JPH::Float3> >&, JPH::Array<JPH::IndexedTriangle,
   JPH::STLAllocator<JPH::IndexedTriangle> >&, float) */void JPH::_GLOBAL__sub_I_Indexify(void) {
   if (DVec3::cTrue == '\0') {
      DVec3::cTrue = '\x01';
      DVec3::cTrue = _LC10;
   }

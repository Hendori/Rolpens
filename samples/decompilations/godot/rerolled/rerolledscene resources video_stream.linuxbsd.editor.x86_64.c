/* VideoStreamPlayback::set_mix_callback(int (*)(void*, float const*, int), void*) */void VideoStreamPlayback::set_mix_callback(VideoStreamPlayback *this, _func_int_void_ptr_float_ptr_int *param_1, void *param_2) {
   *(_func_int_void_ptr_float_ptr_int**)( this + 0x240 ) = param_1;
   *(void**)( this + 0x248 ) = param_2;
   return;
}
/* VideoStream::set_audio_track(int) */void VideoStream::set_audio_track(VideoStream *this, int param_1) {
   *(int*)( this + 0x260 ) = param_1;
   return;
}
/* VideoStreamPlayback::mix_audio(int, Vector<float>, int) */undefined8 VideoStreamPlayback::mix_audio(VideoStreamPlayback *this, int param_1, long param_3, int param_4) {
   long lVar1;
   undefined8 uVar2;
   int iVar3;
   long lVar4;
   ...
   if (param_4 < 0) {
      ...
      if (lVar6 < lVar5) {
         ...
         if (lVar5 - lVar6 <= lVar4) {
            _err_print_index_error("mix_audio", "scene/resources/video_stream.cpp", 0x98, lVar4, lVar5 - lVar6, "(_channel_count < 1 ? 1 : _channel_count) * num_frames - 1", "buffer.size() - offset", "", false, false);
            return 0xffffffff;
         }
   ...
   lVar5 = 0;
   LAB_001000bd:_err_print_index_error("mix_audio", "scene/resources/video_stream.cpp", 0x97, lVar6, lVar5, "offset", "buffer.size()", "", false, false);
   return 0xffffffff;
}
/* VideoStreamPlayback::~VideoStreamPlayback() */void VideoStreamPlayback::~VideoStreamPlayback(VideoStreamPlayback *this) {
   bool bVar1;
   ...
   *(undefined***)this = &PTR__initialize_classv_0010d028;
   ...
   LAB_00100329:Resource::~Resource((Resource*)this);
   return;
}
/* VideoStreamPlayback::~VideoStreamPlayback() */void VideoStreamPlayback::~VideoStreamPlayback(VideoStreamPlayback *this) {
...
/* VideoStream::~VideoStream() */void VideoStream::~VideoStream(VideoStream *this) {
   long *plVar1;
   long lVar2;
...
/* VideoStream::get_file() */void VideoStream::get_file(void) {
   long in_RSI;
...
/* VideoStream::set_file(String const&) */void VideoStream::set_file(VideoStream *this, String *param_1) {
...
/* VideoStream::_bind_methods() */void VideoStream::_bind_methods(void) {
   long lVar1;
   code *pcVar2;
 ...
 while ( lVar1 != lVar9 );
   ...
   if (local_130 == 0) {
      ...
      LAB_00100ec3:StringName::operator =((StringName*)local_c8, (StringName*)&local_128);
   }
 else {
   ...
   ClassDB::add_property((StringName*)&local_108, (PropertyInfo*)&local_d8, (StringName*)&local_120, (StringName*)&local_118, -1);
   if (( StringName::configured != '\0' ) && ( local_108 != (char*)0x0 )) {
      StringName::unref();
   }
   ...
   LAB_00101119:CowData<char32_t>::_unref(local_150);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_130);
   ...
   ClassDB::add_virtual_method((StringName*)&local_108, (MethodInfo*)&local_d8, true, (StringName*)&local_118, false);
   if (( StringName::configured != '\0' ) && ( local_108 != (char*)0x0 )) {
      StringName::unref();
   }
...
/* VideoStreamPlayback::stop() */void VideoStreamPlayback::stop(VideoStreamPlayback *this) {
   undefined4 uVar1;
   undefined8 uVar2;
   long lVar3;
   long *plVar4;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (plVar4 == (long*)0x0) {
      LAB_0010163b:if (( *(long*)( this + 8 ) != 0 ) && ( this[0x260] == (VideoStreamPlayback)0x0 )) {
         local_c8[0] = 0;
         local_c8[1] = 0;
         ...
         *(undefined8*)( this + 0x268 ) = 0;
         ...
         if (( ( UNRECOVERED_JUMPTABLE == (code*)0x0 ) || ( *(long*)( lVar3 + 0xe0 ) == 0 ) ) && ( UNRECOVERED_JUMPTABLE = *(code**)( lVar3 + 0xd0 ) ),UNRECOVERED_JUMPTABLE == (code*)0x0) {
            ...
            if (local_d0 == 0) {
               ...
               if (( StringName::configured != '\0' ) && ( lVar3 = local_e0 != 0 )) goto LAB_00101887;
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_e8);
               LAB_0010189c:lVar3 = *(long*)( this + 8 );
               UNRECOVERED_JUMPTABLE = *(code**)( lVar3 + 200 );
               if (( ( UNRECOVERED_JUMPTABLE == (code*)0x0 ) || ( *(long*)( lVar3 + 0xe0 ) == 0 ) ) && ( UNRECOVERED_JUMPTABLE = *(code**)( lVar3 + 0xc0 ) ),UNRECOVERED_JUMPTABLE == (code*)0x0) goto LAB_001017d9;
         ...
         LAB_001017d9:if (*(char*)( lVar3 + 0x29 ) != '\0') {
      ...
      if (UNRECOVERED_JUMPTABLE != (code*)0x0) {
         if (*(code**)( *(long*)( this + 8 ) + 0xe0 ) == (code*)0x0) {
            ...
            /* WARNING: Treating indirect jump as call */
            ( **(code**)( *(long*)( this + 8 ) + 0xe0 ) )(*(undefined8*)( this + 0x10 ), this + 600, UNRECOVERED_JUMPTABLE, 0, 0);
            return;
         }
   ...
   LAB_0010190f:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* VideoStreamPlayback::play() */void VideoStreamPlayback::play(VideoStreamPlayback *this) {
   undefined4 uVar1;
   undefined8 uVar2;
   long lVar3;
   long *plVar4;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (plVar4 == (long*)0x0) {
      LAB_001019eb:if (( *(long*)( this + 8 ) != 0 ) && ( this[0x278] == (VideoStreamPlayback)0x0 )) {
         local_c8[0] = 0;
         local_c8[1] = 0;
         local_b8 = (undefined1[16])0x0;
         local_c8[2] = 0;
         ...
         *(undefined8*)( this + 0x280 ) = 0;
         ...
         if (( ( UNRECOVERED_JUMPTABLE == (code*)0x0 ) || ( *(long*)( lVar3 + 0xe0 ) == 0 ) ) && ( UNRECOVERED_JUMPTABLE = *(code**)( lVar3 + 0xd0 ) ),UNRECOVERED_JUMPTABLE == (code*)0x0) {
            ...
            if (local_d0 == 0) {
               CowData<unsigned_int>::_unref((CowData<unsigned_int>*)&local_d0);
               if (( StringName::configured != '\0' ) && ( lVar3 = local_e0 != 0 )) goto LAB_00101c37;
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_e8);
               LAB_00101c4c:lVar3 = *(long*)( this + 8 );
               UNRECOVERED_JUMPTABLE = *(code**)( lVar3 + 200 );
               if (( ( UNRECOVERED_JUMPTABLE == (code*)0x0 ) || ( *(long*)( lVar3 + 0xe0 ) == 0 ) ) && ( UNRECOVERED_JUMPTABLE = *(code**)( lVar3 + 0xc0 ) ),UNRECOVERED_JUMPTABLE == (code*)0x0) goto LAB_00101b89;
         ...
         LAB_00101b89:if (*(char*)( lVar3 + 0x29 ) != '\0') {
            plVar4 = (long*)operator_new(0x18, "");
   ...
   LAB_00101cbf:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* VideoStreamPlayback::is_playing() const */bool VideoStreamPlayback::is_playing(VideoStreamPlayback *this) {
   undefined4 uVar1;
   undefined8 uVar2;
   long lVar3;
   long *plVar4;
      ...
      *(undefined8*)( this + 0x298 ) = 0;
      ...
      if (( ( pcVar5 == (code*)0x0 ) || ( *(long*)( lVar3 + 0xe0 ) == 0 ) ) && ( pcVar5 = *(code**)( lVar3 + 0xd0 ) ),pcVar5 == (code*)0x0) {
         ...
         if (local_f0[0] == 0) {
            ...
            if (( StringName::configured != '\0' ) && ( lVar3 = local_100 != 0 )) goto LAB_00102018;
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_108);
            LAB_0010202d:lVar3 = *(long*)( this + 8 );
            pcVar5 = *(code**)( lVar3 + 200 );
            if (( ( pcVar5 == (code*)0x0 ) || ( *(long*)( lVar3 + 0xe0 ) == 0 ) ) && ( pcVar5 = *(code**)( lVar3 + 0xc0 ) ),pcVar5 == (code*)0x0) goto LAB_00101f70;
      ...
      LAB_00101f70:if (*(char*)( lVar3 + 0x29 ) != '\0') {
         plVar4 = (long*)operator_new(0x18, "");
...
/* VideoStreamPlayback::is_paused() const */bool VideoStreamPlayback::is_paused(VideoStreamPlayback *this) {
   undefined4 uVar1;
   undefined8 uVar2;
   long lVar3;
   long *plVar4;
   ...
   if (( *(long*)( this + 8 ) != 0 ) && ( this[0x2c0] == (VideoStreamPlayback)0x0 )) {
      ...
      *(undefined8*)( this + 0x2c8 ) = 0;
      ...
      if (( ( pcVar5 == (code*)0x0 ) || ( *(long*)( lVar3 + 0xe0 ) == 0 ) ) && ( pcVar5 = *(code**)( lVar3 + 0xd0 ) ),pcVar5 == (code*)0x0) {
         ...
         if (local_f0[0] == 0) {
            CowData<unsigned_int>::_unref((CowData<unsigned_int>*)local_f0);
            if (( StringName::configured != '\0' ) && ( lVar3 = local_100 != 0 )) goto LAB_001023f8;
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_108);
            LAB_0010240d:lVar3 = *(long*)( this + 8 );
            pcVar5 = *(code**)( lVar3 + 200 );
            if (( ( pcVar5 == (code*)0x0 ) || ( *(long*)( lVar3 + 0xe0 ) == 0 ) ) && ( pcVar5 = *(code**)( lVar3 + 0xc0 ) ),pcVar5 == (code*)0x0) goto LAB_00102350;
      ...
      LAB_00102350:if (*(char*)( lVar3 + 0x29 ) != '\0') {
         plVar4 = (long*)operator_new(0x18, "");
...
/* VideoStreamPlayback::get_length() const */double VideoStreamPlayback::get_length(VideoStreamPlayback *this) {
   undefined4 uVar1;
   undefined8 uVar2;
   long lVar3;
   long *plVar4;
   ...
   if (( *(long*)( this + 8 ) != 0 ) && ( this[0x2d8] == (VideoStreamPlayback)0x0 )) {
      ...
      *(undefined8*)( this + 0x2e0 ) = 0;
      ...
      if (( ( pcVar5 == (code*)0x0 ) || ( *(long*)( lVar3 + 0xe0 ) == 0 ) ) && ( pcVar5 = *(code**)( lVar3 + 0xd0 ) ),pcVar5 == (code*)0x0) {
         ...
         if (local_f0[0] == 0) {
            CowData<unsigned_int>::_unref((CowData<unsigned_int>*)local_f0);
            if (( StringName::configured != '\0' ) && ( lVar3 = local_100 != 0 )) goto LAB_001027e8;
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_108);
            LAB_001027fd:lVar3 = *(long*)( this + 8 );
            pcVar5 = *(code**)( lVar3 + 200 );
            if (( ( pcVar5 == (code*)0x0 ) || ( *(long*)( lVar3 + 0xe0 ) == 0 ) ) && ( pcVar5 = *(code**)( lVar3 + 0xc0 ) ),pcVar5 == (code*)0x0) goto LAB_00102740;
      ...
      LAB_00102740:if (*(char*)( lVar3 + 0x29 ) != '\0') {
         plVar4 = (long*)operator_new(0x18, "");
   ...
   LAB_001025ac:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* VideoStreamPlayback::get_playback_position() const */double VideoStreamPlayback::get_playback_position(VideoStreamPlayback *this) {
   undefined4 uVar1;
   undefined8 uVar2;
   long lVar3;
   long *plVar4;
   ...
   if (( *(long*)( this + 8 ) != 0 ) && ( this[0x2f0] == (VideoStreamPlayback)0x0 )) {
      ...
      *(undefined8*)( this + 0x2f8 ) = 0;
      ...
      if (( ( pcVar5 == (code*)0x0 ) || ( *(long*)( lVar3 + 0xe0 ) == 0 ) ) && ( pcVar5 = *(code**)( lVar3 + 0xd0 ) ),pcVar5 == (code*)0x0) {
         ...
         if (local_f0[0] == 0) {
            CowData<unsigned_int>::_unref((CowData<unsigned_int>*)local_f0);
            if (( StringName::configured != '\0' ) && ( lVar3 = local_100 != 0 )) goto LAB_00102bd8;
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_108);
            LAB_00102bed:lVar3 = *(long*)( this + 8 );
            pcVar5 = *(code**)( lVar3 + 200 );
            if (( ( pcVar5 == (code*)0x0 ) || ( *(long*)( lVar3 + 0xe0 ) == 0 ) ) && ( pcVar5 = *(code**)( lVar3 + 0xc0 ) ),pcVar5 == (code*)0x0) goto LAB_00102b30;
      ...
      LAB_00102b30:if (*(char*)( lVar3 + 0x29 ) != '\0') {
         plVar4 = (long*)operator_new(0x18, "");
   ...
   LAB_0010299c:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* VideoStreamPlayback::get_channels() const */int VideoStreamPlayback::get_channels(VideoStreamPlayback *this) {
   int iVar1;
   undefined4 uVar2;
   undefined8 uVar3;
   long lVar4;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (plVar5 == (long*)0x0) {
      LAB_00102d3f:if (( *(long*)( this + 8 ) != 0 ) && ( this[0x368] == (VideoStreamPlayback)0x0 )) {
         local_c8[0] = 0;
         local_c8[1] = 0;
         local_b8 = (undefined1[16])0x0;
         uStack_c0 = 0;
         ...
         *(undefined8*)( this + 0x370 ) = 0;
         ...
         if (( ( pcVar6 == (code*)0x0 ) || ( *(long*)( lVar4 + 0xe0 ) == 0 ) ) && ( pcVar6 = *(code**)( lVar4 + 0xd0 ) ),pcVar6 == (code*)0x0) {
            ...
            if (local_f0[0] == 0) {
               CowData<unsigned_int>::_unref((CowData<unsigned_int>*)local_f0);
               if (( StringName::configured != '\0' ) && ( lVar4 = local_100 != 0 )) goto LAB_00102fc8;
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_108);
               LAB_00102fdd:lVar4 = *(long*)( this + 8 );
               pcVar6 = *(code**)( lVar4 + 200 );
               if (( ( pcVar6 == (code*)0x0 ) || ( *(long*)( lVar4 + 0xe0 ) == 0 ) ) && ( pcVar6 = *(code**)( lVar4 + 0xc0 ) ),pcVar6 == (code*)0x0) goto LAB_00102f18;
         ...
         LAB_00102f18:if (*(char*)( lVar4 + 0x29 ) != '\0') {
      ...
      if (*(code**)( *(long*)( this + 8 ) + 0xe0 ) == (code*)0x0) {
         ...
         ( **(code**)( *(long*)( this + 8 ) + 0xe0 ) )(*(undefined8*)( this + 0x10 ), this + 0x360, pcVar6, 0, local_c8);
         iVar1 = local_c8[0];
      }
   ...
   *(int*)( this + 0x250 ) = iVar1;
   LAB_00102d8d:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* VideoStreamPlayback::get_mix_rate() const */int VideoStreamPlayback::get_mix_rate(VideoStreamPlayback *this) {
   int iVar1;
   undefined4 uVar2;
   undefined8 uVar3;
   long lVar4;
   ...
   if (( *(long*)( this + 8 ) != 0 ) && ( this[0x380] == (VideoStreamPlayback)0x0 )) {
      ...
      *(undefined8*)( this + 0x388 ) = 0;
      ...
      if (( ( pcVar6 == (code*)0x0 ) || ( *(long*)( lVar4 + 0xe0 ) == 0 ) ) && ( pcVar6 = *(code**)( lVar4 + 0xd0 ) ),pcVar6 == (code*)0x0) {
         ...
         if (local_f0[0] == 0) {
            CowData<unsigned_int>::_unref((CowData<unsigned_int>*)local_f0);
            if (( StringName::configured != '\0' ) && ( lVar4 = local_100 != 0 )) goto LAB_001033a8;
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_108);
            LAB_001033bd:lVar4 = *(long*)( this + 8 );
            pcVar6 = *(code**)( lVar4 + 200 );
            if (( ( pcVar6 == (code*)0x0 ) || ( *(long*)( lVar4 + 0xe0 ) == 0 ) ) && ( pcVar6 = *(code**)( lVar4 + 0xc0 ) ),pcVar6 == (code*)0x0) goto LAB_001032f8;
      ...
      LAB_001032f8:if (*(char*)( lVar4 + 0x29 ) != '\0') {
         plVar5 = (long*)operator_new(0x18, "");
   ...
   if (pcVar6 != (code*)0x0) {
      if (*(code**)( *(long*)( this + 8 ) + 0xe0 ) == (code*)0x0) {
         ...
         ( **(code**)( *(long*)( this + 8 ) + 0xe0 ) )(*(undefined8*)( this + 0x10 ), this + 0x378, pcVar6, 0, local_c8);
         iVar1 = local_c8[0];
      }

   }

   LAB_00103173:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* VideoStreamPlayback::get_texture() const */void VideoStreamPlayback::get_texture(void) {
   code *pcVar1;
   char cVar2;
   undefined4 uVar3;
   long lVar4;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (plVar7 == (long*)0x0) {
      LAB_00103512:if (( *(long*)( in_RSI + 8 ) != 0 ) && ( *(char*)( in_RSI + 0x338 ) == '\0' )) {
         local_c8 = 0;
         uStack_c4 = 0;
         local_b8 = (undefined1[16])0x0;
         uStack_c0 = 0;
         ...
         *(undefined8*)( in_RSI + 0x340 ) = 0;
         ...
         if (( ( pcVar8 == (code*)0x0 ) || ( *(long*)( lVar4 + 0xe0 ) == 0 ) ) && ( pcVar8 = *(code**)( lVar4 + 0xd0 ) ),pcVar8 == (code*)0x0) {
            ...
            if (local_f0[0] == 0) {
               CowData<unsigned_int>::_unref((CowData<unsigned_int>*)local_f0);
               if (( StringName::configured != '\0' ) && ( lVar4 = local_100 != 0 )) goto LAB_001039d2;
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_108);
               LAB_001039e7:lVar4 = *(long*)( in_RSI + 8 );
               pcVar8 = *(code**)( lVar4 + 200 );
               if (( ( pcVar8 == (code*)0x0 ) || ( *(long*)( lVar4 + 0xe0 ) == 0 ) ) && ( pcVar8 = *(code**)( lVar4 + 0xc0 ) ),pcVar8 == (code*)0x0) goto LAB_001038d9;
      ...
      if (pcVar8 != (code*)0x0) {
         ...
         if (pcVar1 == (code*)0x0) {
            ...
            if (pOVar5 != (Object*)0x0) {
               ...
               LAB_001036a8:pOVar9 = (Object*)0x0;
            ...
            if (pOVar5 != (Object*)0x0) {
               ...
               cVar2 = RefCounted::unreference();
               joined_r0x0010377f:if (( cVar2 != '\0' ) && ( cVar2 = cVar2 != '\0' )) {
      ...
      if (( ( lVar4 == 0 ) || ( pOVar5 = (Object*)__dynamic_cast(lVar4, &Object::typeinfo, &Texture2D::typeinfo, 0) ),pOVar5 == (Object*)0x0 )) {
         if (Variant::needs_deinit[local_58[0]] != '\0') {
            Variant::_clear_internal();
         }
         ...
         LAB_001035b6:if (pOVar9 != (Object*)0x0) {
            *in_RDI = pOVar9;
            cVar2 = RefCounted::reference();
            if (cVar2 == '\0') {
               *in_RDI = 0;
   ...
   *in_RDI = 0;
   LAB_00103677:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* VideoStream::instantiate_playback() */void VideoStream::instantiate_playback(void) {
   code *pcVar1;
   char cVar2;
   undefined4 uVar3;
   long lVar4;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (plVar7 == (long*)0x0) {
      LAB_00103b32:if (( *(long*)( in_RSI + 8 ) != 0 ) && ( *(char*)( in_RSI + 0x248 ) == '\0' )) {
         local_c8 = 0;
         uStack_c4 = 0;
         local_b8 = (undefined1[16])0x0;
         uStack_c0 = 0;
         ...
         *(undefined8*)( in_RSI + 0x250 ) = 0;
         ...
         if (( ( pcVar8 == (code*)0x0 ) || ( *(long*)( lVar4 + 0xe0 ) == 0 ) ) && ( pcVar8 = *(code**)( lVar4 + 0xd0 ) ),pcVar8 == (code*)0x0) {
            ...
            if (local_f0[0] == 0) {
               CowData<unsigned_int>::_unref((CowData<unsigned_int>*)local_f0);
               if (( StringName::configured != '\0' ) && ( lVar4 = local_100 != 0 )) goto LAB_0010402a;
               CowData<char32_t>::_unref((CowData<char32_t>*)&local_108);
               LAB_0010403f:lVar4 = *(long*)( in_RSI + 8 );
               pcVar8 = *(code**)( lVar4 + 200 );
               if (( ( pcVar8 == (code*)0x0 ) || ( *(long*)( lVar4 + 0xe0 ) == 0 ) ) && ( pcVar8 = *(code**)( lVar4 + 0xc0 ) ),pcVar8 == (code*)0x0) goto LAB_00103f45;
               uVar6 = ( *pcVar8 )(*(undefined8*)( lVar4 + 0xa0 ));
         ...
         LAB_00103f45:if (*(char*)( lVar4 + 0x29 ) != '\0') {
            plVar7 = (long*)operator_new(0x18, "");
            *plVar7 = in_RSI + 0x250;
      ...
      if (pcVar1 == (code*)0x0) {
         ...
         if (pOVar5 != (Object*)0x0) {
            ...
            cVar2 = RefCounted::unreference();
            joined_r0x00103def:if (( cVar2 != '\0' ) && ( cVar2 = cVar2 != '\0' )) {
               ( **(code**)( *(long*)pOVar5 + 0x140 ) )(pOVar5);
               Memory::free_static(pOVar5, false);
            }

            if (CONCAT44(uStack_c4, local_c8) != 0) {
               LAB_00103bc9:cVar2 = RefCounted::unreference();
               if (cVar2 != '\0') {
                  pOVar5 = (Object*)CONCAT44(uStack_c4, local_c8);
                  cVar2 = predelete_handler(pOVar5);
                  if (cVar2 != '\0') {
         ...
         if (pOVar5 != (Object*)0x0) {
            ...
            LAB_00103c78:pOVar9 = (Object*)0x0;
      ...
      lVar4 = Variant::get_validated_object();
      if (( ( lVar4 == 0 ) || ( pOVar5 = (Object*)__dynamic_cast(lVar4, &Object::typeinfo, &VideoStreamPlayback::typeinfo, 0) ),pOVar5 == (Object*)0x0 )) {
         if (Variant::needs_deinit[local_58[0]] != '\0') {
            Variant::_clear_internal();
         }
      ...
      LAB_00103bd6:if (pOVar9 != (Object*)0x0) {
   ...
   LAB_00103c88:_err_print_error("instantiate_playback", "scene/resources/video_stream.cpp", 0xa1, "Condition \"ret.is_null()\" is true. Returning: nullptr", "Plugin returned null playback", 0, 0);
   *in_RDI = 0;
   LAB_00103c47:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* VideoStreamPlayback::_bind_methods() */void VideoStreamPlayback::_bind_methods(void) {
   Variant *pVVar1;
   long lVar2;
   code *pcVar3;
   undefined1 auVar4[16];
 ...
 while ( lVar2 != lVar11 );
   ...
   ClassDB::add_virtual_method((StringName*)&local_168, (MethodInfo*)&local_138, true, local_178, false);
   ...
   LAB_001052c1:CowData<char32_t>::_unref((CowData<char32_t>*)&local_188);
...
/* VideoStreamPlayback::update(double) */void VideoStreamPlayback::update(VideoStreamPlayback *this, double param_1) {
   undefined4 uVar1;
   undefined8 uVar2;
   long lVar3;
   long *plVar4;
   ...
   if (( *(long*)( this + 8 ) != 0 ) && ( this[0x350] == (VideoStreamPlayback)0x0 )) {
      ...
      *(undefined8*)( this + 0x358 ) = 0;
      ...
      LAB_00105d68:if (*(char*)( lVar3 + 0x29 ) != '\0') {
         plVar4 = (long*)operator_new(0x18, "");
   ...
   if (pcVar5 != (code*)0x0) {
      ...
      if (*(code**)( *(long*)( this + 8 ) + 0xe0 ) == (code*)0x0) {
         ...
         ( **(code**)( *(long*)( this + 8 ) + 0xe0 ) )(*(undefined8*)( this + 0x10 ), this + 0x348, pcVar5, local_58, 0);
      }

      goto LAB_001059ef;
   }

   if (_gdvirtual__update_call first_print) goto LAB_001059ef;
   local_128 = 0;
   ...
   _err_print_error("_gdvirtual__update_call", "scene/resources/video_stream.h", 0x3a, (String*)&local_f8, 0, 0);
   ...
   _gdvirtual__update_call(double)::first_print =
   '\0';
   LAB_001059ef:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* VideoStreamPlayback::set_audio_track(int) */void VideoStreamPlayback::set_audio_track(VideoStreamPlayback *this, int param_1) {
   undefined4 uVar1;
   undefined8 uVar2;
   long lVar3;
   long *plVar4;
      ...
      *(undefined8*)( this + 0x328 ) = 0;
      ...
      if (( ( pcVar5 == (code*)0x0 ) || ( *(long*)( lVar3 + 0xe0 ) == 0 ) ) && ( pcVar5 = *(code**)( lVar3 + 0xd0 ) ),pcVar5 == (code*)0x0) {
         ...
         if (local_120[0] == 0) {
            ...
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_138);
            LAB_00106334:lVar3 = *(long*)( this + 8 );
            pcVar5 = *(code**)( lVar3 + 200 );
            if (( ( pcVar5 == (code*)0x0 ) || ( *(long*)( lVar3 + 0xe0 ) == 0 ) ) && ( pcVar5 = *(code**)( lVar3 + 0xc0 ) ),pcVar5 == (code*)0x0) goto LAB_00106272;
      ...
      LAB_00106272:if (*(char*)( lVar3 + 0x29 ) != '\0') {
         plVar4 = (long*)operator_new(0x18, "");
   ...
   if (pcVar5 != (code*)0x0) {
      ...
      if (*(code**)( *(long*)( this + 8 ) + 0xe0 ) == (code*)0x0) {
         ...
         ( **(code**)( *(long*)( this + 8 ) + 0xe0 ) )(*(undefined8*)( this + 0x10 ), this + 0x318, pcVar5, local_58, 0);
      }

   }

   LAB_001060e9:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* VideoStreamPlayback::seek(double) */void VideoStreamPlayback::seek(VideoStreamPlayback *this, double param_1) {
   undefined4 uVar1;
   undefined8 uVar2;
   long lVar3;
   long *plVar4;
   ...
   if (( *(long*)( this + 8 ) != 0 ) && ( this[0x308] == (VideoStreamPlayback)0x0 )) {
      ...
      *(undefined8*)( this + 0x310 ) = 0;
      ...
      LAB_001066ca:if (*(char*)( lVar3 + 0x29 ) != '\0') {
         plVar4 = (long*)operator_new(0x18, "");
   ...
   if (pcVar5 != (code*)0x0) {
      ...
      if (*(code**)( *(long*)( this + 8 ) + 0xe0 ) == (code*)0x0) {
         ...
         ( **(code**)( *(long*)( this + 8 ) + 0xe0 ) )(*(undefined8*)( this + 0x10 ), this + 0x300, pcVar5, local_58, 0);
      }

   }

   LAB_00106520:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* VideoStreamPlayback::set_paused(bool) */void VideoStreamPlayback::set_paused(VideoStreamPlayback *this, bool param_1) {
   undefined4 uVar1;
   undefined8 uVar2;
   long lVar3;
   long *plVar4;
      ...
      *(undefined8*)( this + 0x2b0 ) = 0;
      ...
      if (( ( pcVar5 == (code*)0x0 ) || ( *(long*)( lVar3 + 0xe0 ) == 0 ) ) && ( pcVar5 = *(code**)( lVar3 + 0xd0 ) ),pcVar5 == (code*)0x0) {
         ...
         if (local_120[0] == 0) {
            ...
            CowData<char32_t>::_unref((CowData<char32_t>*)&local_138);
            LAB_00106c34:lVar3 = *(long*)( this + 8 );
            pcVar5 = *(code**)( lVar3 + 200 );
            if (( ( pcVar5 == (code*)0x0 ) || ( *(long*)( lVar3 + 0xe0 ) == 0 ) ) && ( pcVar5 = *(code**)( lVar3 + 0xc0 ) ),pcVar5 == (code*)0x0) goto LAB_00106b6f;
      ...
      LAB_00106b6f:if (*(char*)( lVar3 + 0x29 ) != '\0') {
         plVar4 = (long*)operator_new(0x18, "");
   ...
   if (pcVar5 != (code*)0x0) {
      ...
      if (*(code**)( *(long*)( this + 8 ) + 0xe0 ) == (code*)0x0) {
         ...
         ( **(code**)( *(long*)( this + 8 ) + 0xe0 ) )(*(undefined8*)( this + 0x10 ), this + 0x2a0, pcVar5, local_58, 0);
      }

   }

   LAB_001069ea:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* VideoStreamPlayback::is_class_ptr(void*) const */uint VideoStreamPlayback::is_class_ptr(VideoStreamPlayback *this, void *param_1) {
...
/* VideoStreamPlayback::_getv(StringName const&, Variant&) const */undefined8 VideoStreamPlayback::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* VideoStreamPlayback::_setv(StringName const&, Variant const&) */undefined8 VideoStreamPlayback::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* VideoStreamPlayback::_validate_propertyv(PropertyInfo&) const */void VideoStreamPlayback::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* VideoStreamPlayback::_property_can_revertv(StringName const&) const */undefined8 VideoStreamPlayback::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* VideoStreamPlayback::_property_get_revertv(StringName const&, Variant&) const */undefined8 VideoStreamPlayback::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* VideoStreamPlayback::_notificationv(int, bool) */void VideoStreamPlayback::_notificationv(int param_1, bool param_2) {
   return;
}
/* VideoStream::is_class_ptr(void*) const */uint VideoStream::is_class_ptr(VideoStream *this, void *param_1) {
   return (uint)CONCAT71(0x10d5, (undefined4*)param_1 == &Resource::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10d5, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10d5, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10d5, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* VideoStream::_getv(StringName const&, Variant&) const */undefined8 VideoStream::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* VideoStream::_setv(StringName const&, Variant const&) */undefined8 VideoStream::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* VideoStream::_validate_propertyv(PropertyInfo&) const */void VideoStream::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* VideoStream::_property_can_revertv(StringName const&) const */undefined8 VideoStream::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* VideoStream::_property_get_revertv(StringName const&, Variant&) const */undefined8 VideoStream::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* VideoStream::_notificationv(int, bool) */void VideoStream::_notificationv(int param_1, bool param_2) {
   return;
}
...
/* MethodBindTR<int, int, Vector<float>, int>::_gen_argument_type(int) const */undefined8 MethodBindTR<int,int,Vector<float>,int>::_gen_argument_type(MethodBindTR<int,int,Vector<float>,int> *this, int param_1) {
   undefined8 uVar1;
   uVar1 = 2;
   if (param_1 == 1) {
      uVar1 = 0x20;
...
/* MethodBindTR<int, int, Vector<float>, int>::get_argument_meta(int) const */char MethodBindTR<int,int,Vector<float>,int>::get_argument_meta(MethodBindTR<int,int,Vector<float>,int> *this, int param_1) {
   if (0 < param_1) {
...
/* MethodBindTR<int, int, Vector<float>, int>::~MethodBindTR() */void MethodBindTR<int,int,Vector<float>,int>::~MethodBindTR(MethodBindTR<int,int,Vector<float>,int> *this) {
...
/* VideoStream::_bind_methods() [clone .cold] */void VideoStream::_bind_methods(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
...
/* VideoStreamPlayback::_bind_methods() [clone .cold] */void VideoStreamPlayback::_bind_methods(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
...
/* VideoStreamPlayback::_get_class_namev() const */undefined8 *VideoStreamPlayback::_get_class_namev(void) {
   int iVar1;
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001074d3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001074d3;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "VideoStreamPlayback");
         goto LAB_0010753e;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "VideoStreamPlayback");
   LAB_0010753e:return &_get_class_namev();
}
/* VideoStream::_get_class_namev() const */undefined8 *VideoStream::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001075b3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001075b3;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "VideoStream");
         goto LAB_0010761e;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "VideoStream");
   LAB_0010761e:return &_get_class_namev();
}
/* VideoStream::get_class() const */void VideoStream::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* VideoStreamPlayback::get_class() const */void VideoStreamPlayback::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
GetTypeInfo<bool,void>::get_class_info(GetTypeInfo<bool,void> *this){
   ...
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   ...
   lVar2 = local_58;
   joined_r0x00107b9c:local_58 = lVar2;
   if (lVar2 != 0) {
      LOCK();
      plVar1 = (long*)( lVar2 + -0x10 );
      *plVar1 = *plVar1 + -1;
...
GetTypeInfo<int,void>::get_class_info(GetTypeInfo<int,void> *this){
   ...
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   ...
   StringName::operator =((StringName*)( this + 0x10 ), (StringName*)&local_50);
   lVar2 = local_58;
   joined_r0x00107d1c:local_58 = lVar2;
   if (lVar2 != 0) {
      LOCK();
      plVar1 = (long*)( lVar2 + -0x10 );
      *plVar1 = *plVar1 + -1;
...
GetTypeInfo<double,void>::get_class_info(GetTypeInfo<double,void> *this){
   ...
   *(undefined1(*) [16])( this + 8 ) = (undefined1[16])0x0;
   ...
   StringName::operator =((StringName*)( this + 0x10 ), (StringName*)&local_50);
   lVar2 = local_58;
   joined_r0x00107e9c:local_58 = lVar2;
   if (lVar2 != 0) {
      LOCK();
      plVar1 = (long*)( lVar2 + -0x10 );
      *plVar1 = *plVar1 + -1;
...
/* GetTypeInfo<Ref<VideoStreamPlayback>, void>::get_class_info() */GetTypeInfo<Ref<VideoStreamPlayback>,void> * __thiscall
...
/* Resource::is_class(String const&) const */undefined8 Resource::is_class(Resource *this, String *param_1) {
 ...
 while ( !bVar9 );
      ...
      LAB_001082df:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar5 = local_60;
      if (local_60 != 0) {
         LOCK();
   ...
   LAB_00108393:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_00108575:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* VideoStream::is_class(String const&) const */undefined8 VideoStream::is_class(VideoStream *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *__s;
   long lVar3;
 ...
 while ( !bVar8 );
      ...
      LAB_001085ef:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_001086a3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* VideoStreamPlayback::is_class(String const&) const */undefined8 VideoStreamPlayback::is_class(VideoStreamPlayback *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *__s;
   long lVar3;
 ...
 while ( !bVar8 );
      ...
      LAB_0010876f:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   if (cVar5 == '\0') {
      ...
      LAB_00108823:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* MethodBindT<String const&>::_gen_argument_type_info(int) const */undefined4 *MethodBindT<String_const&>::_gen_argument_type_info(int param_1) {
   ...
   *puVar5 = local_68._0_4_;
   ...
   LAB_00109b2b:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* MethodBind* create_method_bind<VideoStreamPlayback, int, int, Vector<float>, int>(int
   (VideoStreamPlayback::*)(int, Vector<float>, int)) */MethodBind *create_method_bind<VideoStreamPlayback,int,int,Vector<float>,int>(_func_int_int_Vector_int *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<VideoStream, String>(String (VideoStream::*)()) */MethodBind *create_method_bind<VideoStream,String>(_func_String *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* VideoStream::_initialize_classv() */void VideoStream::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_70;
   undefined8 local_68;
   long local_60;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<String>::resize<false>(long) */undefined8 CowData<String>::resize<false>(CowData<String> *this, long param_1) {
   ...
   if (param_1 * 8 == 0) {
      LAB_0010a830:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (lVar10 == lVar7) {
      LAB_0010a7af:puVar9 = *(undefined8**)this;
      if (puVar9 == (undefined8*)0x0) {
         LAB_0010a886:/* WARNING: Does not return */pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<int>::resize<false>(long) */undefined8 CowData<int>::resize<false>(CowData<int> *this, long param_1) {
   ...
   if (param_1 * 4 == 0) {
      LAB_0010ab50:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
/* VideoStreamPlayback::_initialize_classv() */void VideoStreamPlayback::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_70;
   undefined8 local_68;
   long local_60;
...
/* WARNING: Removing unreachable block (ram,0x0010b078) *//* WARNING: Removing unreachable block (ram,0x0010b20d) *//* WARNING: Removing unreachable block (ram,0x0010b219) *//* String vformat<StringName>(String const&, StringName const) */undefined8 *vformat<StringName>(undefined8 *param_1, bool *param_2, StringName *param_3) {
   Variant *this;
   int iVar1;
   long in_FS_OFFSET;
   Array local_c8[8];
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (( ( plVar4 != (long*)0x0 ) && ( plVar4[1] != 0 ) ) && ( *(char*)( plVar4[1] + 0x2e ) != '\0' )) {
      ...
      if (local_58 == (char*)*plVar3) {
         ...
         _err_print_error(&_LC78, "./core/object/method_bind.h", 0x207, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: ret", (StringName*)&local_58, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
         if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
            StringName::unref();
   ...
   LAB_0010b420:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTR<String>::ptrcall(Object*, void const**, void*) const */void MethodBindTR<String>::ptrcall(MethodBindTR<String> *this, Object *param_1, void **param_2, void *param_3) {
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_48);
   LAB_0010b8bd:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindT<String const&>::ptrcall(Object*, void const**, void*) const */void MethodBindT<String_const&>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   ...
   LAB_0010bdd1:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindTR<int, int, Vector<float>, int>::ptrcall(Object*, void const**, void*) const */void MethodBindTR<int,int,Vector<float>,int>::ptrcall(MethodBindTR<int,int,Vector<float>,int> *this, Object *param_1, void **param_2, void *param_3) {
   undefined4 uVar1;
   long lVar2;
   void *pvVar3;
   long lVar4;
 ...
 while ( !bVar9 );
   ...
   LAB_0010be73:/* WARNING: Load size is inaccurate */iVar5 = ( *pcVar8 )(param_1 + lVar2, **param_2, (StringName*)&local_48, uVar1);
   lVar2 = local_40;
   *(long*)param_3 = (long)iVar5;
   ...
   LAB_0010beb2:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* MethodBindTR<int, int, Vector<float>, int>::validated_call(Object*, Variant const**, Variant*)
   const */void MethodBindTR<int,int,Vector<float>,int>::validated_call(MethodBindTR<int,int,Vector<float>,int> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   undefined4 uVar1;
   long lVar2;
   long lVar3;
   long lVar4;
 ...
 while ( !bVar9 );
   ...
   LAB_0010c0d8:iVar5 = ( *pcVar8 )(param_1 + lVar2, *(undefined4*)( *param_2 + 8 ), (StringName*)&local_48, uVar1);
   lVar2 = local_40;
   *(long*)( param_3 + 8 ) = (long)iVar5;
   ...
   LAB_0010c118:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* MethodBindT<String const&>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindT<String_const&>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   if (in_R8D < 2) {
      ...
      if (pVVar10 == (Variant*)0x0) {
         ...
         LAB_0010c490:pVVar10 = *(Variant**)param_4;
      }
 else {
         lVar2 = *(long*)( pVVar10 + -8 );
         if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
            LAB_0010c4a0:uVar6 = 4;
            goto LAB_0010c445;
         }
      ...
      *in_R9 = 0;
      ...
      uVar6 = 3;
      LAB_0010c445:*in_R9 = uVar6;
      in_R9[2] = 1;
   }

   LAB_0010c450:*(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTR<int, int, Vector<float>, int>::call(Object*, Variant const**, int,
   Callable::CallError&) const */Object *MethodBindTR<int,int,Vector<float>,int>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   Variant *pVVar1;
   Variant *pVVar2;
   code *pcVar3;
   undefined8 uVar4;
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (( ( plVar13 != (long*)0x0 ) && ( plVar13[1] != 0 ) ) && ( *(char*)( plVar13[1] + 0x2e ) != '\0' )) {
      ...
      if (local_88 == (char*)*plVar10) {
         ...
         _err_print_error(&_LC78, "./core/object/method_bind.h", 0x207, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: ret", (StringName*)&local_88, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_90);
 ...
 while ( lVar9 != 3 );
         *in_R9 = 0;
         ...
         iVar7 = ( *(code*)pVVar15 )((Variant*)( (long)plVar13 + (long)pVVar1 ), iVar8, (Variant*)&local_88, iVar7);
   ...
   *in_R9 = uVar6;
   in_R9[2] = 3;
   LAB_0010c852:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* void call_get_argument_type_info<int, Vector<float>, int>(int, PropertyInfo&) */void call_get_argument_type_info<int,Vector<float>,int>(int param_1, PropertyInfo *param_2) {
   undefined1 auVar1[16];
   undefined1 auVar2[16];
   undefined8 uVar3;
   long lVar4;
   ...
   *(undefined4*)( param_2 + 0x28 ) = local_40;
   PropertyInfo::~PropertyInfo((PropertyInfo*)&local_68);
   LAB_0010cad9:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* MethodBindTR<int, int, Vector<float>, int>::_gen_argument_type_info(int) const */undefined4 *MethodBindTR<int,int,Vector<float>,int>::_gen_argument_type_info(int param_1) {
   undefined1 auVar1[16];
   undefined1 auVar2[16];
   undefined8 uVar3;
   undefined8 uVar4;
   ...
   *(undefined1(*) [16])( puVar5 + 2 ) = (undefined1[16])0x0;
   if (local_78 == 0) {
      puVar5[10] = 6;
      LAB_0010ce8f:StringName::operator =((StringName*)( puVar5 + 4 ), (StringName*)&local_80);
   }
 else {
   ...
   LAB_0010cdac:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return puVar5;
   }
...
/* WARNING: Control flow encountered bad instruction data *//* MethodBindTR<int, int, Vector<float>, int>::~MethodBindTR() */void MethodBindTR<int,int,Vector<float>,int>::~MethodBindTR(MethodBindTR<int,int,Vector<float>,int> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

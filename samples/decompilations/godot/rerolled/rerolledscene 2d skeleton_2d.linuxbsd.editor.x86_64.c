/* Bone2D::get_rest() const */void Bone2D::get_rest(void) {
   undefined8 uVar1;
   undefined8 uVar2;
   long in_RSI;
   undefined8 *in_RDI;
...
/* Bone2D::get_autocalculate_length_and_angle() const */Bone2D Bone2D::get_autocalculate_length_and_angle(Bone2D *this) {
   return this[0x5a8];
}
/* Bone2D::get_length() const */undefined4 Bone2D::get_length(Bone2D *this) {
   return *(undefined4*)( this + 0x5ac );
}
/* Bone2D::get_bone_angle() const */undefined4 Bone2D::get_bone_angle(Bone2D *this) {
   return *(undefined4*)( this + 0x5b0 );
}
/* Skeleton2D::get_skeleton() const */undefined8 Skeleton2D::get_skeleton(Skeleton2D *this) {
   return *(undefined8*)( this + 0x598 );
}
/* Bone2D::set_length(float) */void Bone2D::set_length(Bone2D *this, float param_1) {
   *(float*)( this + 0x5ac ) = param_1;
   CanvasItem::queue_redraw();
   return;
}
/* Bone2D::set_bone_angle(float) */void Bone2D::set_bone_angle(Bone2D *this, float param_1) {
   *(float*)( this + 0x5b0 ) = param_1;
   CanvasItem::queue_redraw();
   return;
}
/* Bone2D::apply_rest() */void Bone2D::apply_rest(Bone2D *this) {
   Node2D::set_transform(this);
   return;
}
/* Skeleton2D::set_bone_local_pose_override(int, Transform2D, float, bool) */void Skeleton2D::set_bone_local_pose_override(undefined4 param_1, long param_2, uint param_3, undefined1 param_4) {
   uint uVar1;
   code *pcVar2;
   long lVar3;
   ...
   _err_print_index_error("set_bone_local_pose_override", "scene/2d/skeleton_2d.cpp", 0x2e1, (long)(int)param_3, (long)(int)uVar1, "p_bone_idx", "(int)bones.size()", "Bone index is out of range!", false, false);
   return;
}
/* Skeleton2D::get_bone_local_pose_override(int) */void Skeleton2D::get_bone_local_pose_override(int param_1) {
   uint uVar1;
   undefined8 uVar2;
   code *pcVar3;
   undefined8 uVar4;
   ...
   if (( -1 < (int)in_EDX ) && ( (int)in_EDX < (int)uVar1 )) {
      ...
      _err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, (long)(int)in_EDX, (ulong)uVar1, "p_index", "count", "", false, true);
      _err_flush_stdout();
      /* WARNING: Does not return */
   ...
   _err_print_index_error("get_bone_local_pose_override", "scene/2d/skeleton_2d.cpp", 0x2e8, (long)(int)in_EDX, (long)(int)uVar1, "p_bone_idx", "(int)bones.size()", "Bone index is out of range!", false, false);
   *puVar6 = 0x3f800000;
   puVar6[1] = 0x3f80000000000000;
   puVar6[2] = 0;
   return;
}
/* Skeleton2D::get_bone(int) */undefined8 Skeleton2D::get_bone(Skeleton2D *this, int param_1) {
   uint uVar1;
   code *pcVar2;
   if (( (byte)this[0x2fa] & 0x40 ) == 0) {
      _err_print_error("get_bone", "scene/2d/skeleton_2d.cpp", 0x270, "Condition \"!is_inside_tree()\" is true. Returning: nullptr", 0, 0);
   }
 else {
      ...
      _err_print_index_error("get_bone", "scene/2d/skeleton_2d.cpp", 0x271, (long)param_1, (long)(int)uVar1, "p_idx", "(int)bones.size()", "", false, false);
   }

   return 0;
}
/* Skeleton2D::execute_modifications(float, int) */void Skeleton2D::execute_modifications(Skeleton2D *this, float param_1, int param_2) {
   code *pcVar1;
   long lVar2;
   StringName *pSVar3;
   long *plVar4;
         ...
         do {
            ...
            if (*(float*)( *(long*)( this + 0x588 ) + lVar6 + 0x54 ) <= 0.0) {
               ...
               if (*(uint*)( this + 0x580 ) <= uVar7) {
                  LAB_00100718:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, uVar8 & 0xffffffff, uVar10, "p_index", "count", "", false, true);
                  _err_flush_stdout();
                  /* WARNING: Does not return */
               ...
               Transform2D::interpolate_with((Transform2D*)&local_88, *(float*)( *(long*)( this + 0x588 ) + lVar6 + 0x54 ));
               uVar10 = ( ulong ) * (uint*)( this + 0x580 );
               local_48 = local_78;
               local_58 = local_88;
               uStack_50 = uStack_80;
 ...
 while ( plVar4 != plVar5 );
   ...
   LAB_0010078e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* Bone2D::~Bone2D() */void Bone2D::~Bone2D(Bone2D *this) {
   long lVar1;
   long *plVar2;
   *(undefined***)this = &PTR__initialize_classv_00116fb0;
   if (*(long*)( this + 0x5b8 ) != 0) {
      lVar1 = RenderingServer::get_singleton();
      if (lVar1 == 0) {
         _err_print_error("~Bone2D", "scene/2d/skeleton_2d.cpp", 0x1fa, "Parameter \"RenderingServer::get_singleton()\" is null.", 0, 0);
      }
 else {
...
/* Skeleton2D::_update_transform() [clone .part.0] */void Skeleton2D::_update_transform(Skeleton2D *this) {
   undefined8 *puVar1;
   uint uVar2;
   int iVar3;
   code *pcVar4;
   ...
   if (*(int*)( this + 0x580 ) != 0) {
      ...
      do {
         ...
         if (iVar3 < (int)uVar9) {
            ...
            if (iVar3 < 0) {
               ...
               if (uVar9 < uVar12) {
                  ...
                  Transform2D::operator *((Transform2D*)&local_78, (Transform2D*)( *(long*)( this + 0x588 ) + 0xc + uVar7 * 0x60 ));
                  uVar12 = *(uint*)( this + 0x580 );
                  uVar8 = (ulong)uVar12;
                  if (uVar9 < uVar12) {
                     lVar5 = *(long*)( this + 0x588 );
            ...
            LAB_00100972:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, uVar7, uVar8, "p_index", "count", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
         ...
         _err_print_error("_update_transform", "scene/2d/skeleton_2d.cpp", 0x256, "Condition \"bones[i].parent_index >= (int)i\" is true. Continuing.", 0, 0);
         uVar12 = *(uint*)( this + 0x580 );
         LAB_001008f8:uVar10 = uVar10 + 1;
      }
 while ( (uint)uVar10 < uVar12 );
      if (uVar12 != 0) {
         uVar10 = 0;
         do {
            Transform2D::operator *(local_58, (Transform2D*)( uVar10 * 0x60 + *(long*)( this + 0x588 ) + 0xc ));
...
/* SortArray<Skeleton2D::Bone, _DefaultComparator<Skeleton2D::Bone>, true>::adjust_heap(long, long,
   long, Skeleton2D::Bone, Skeleton2D::Bone*) const [clone .isra.0] */void SortArray<Skeleton2D::Bone,_DefaultComparator<Skeleton2D::Bone>,true>::adjust_heap(long param_1, long param_2, long param_3, long param_4, undefined8 param_5, undefined8 param_6, Node *param_7, undefined8 param_8, undefined8 param_9, undefined8 param_10, undefined8 param_11, undefined8 param_12, undefined8 param_13, undefined8 param_14, undefined8 param_15, undefined8 param_16, undefined8 param_17, undefined1 param_18) {
   long lVar1;
   undefined8 uVar2;
   char cVar3;
   undefined8 *puVar4;
...
/* SortArray<Skeleton2D::Bone, _DefaultComparator<Skeleton2D::Bone>, true>::introsort(long, long,
   Skeleton2D::Bone*, long) const [clone .isra.0] */void SortArray<Skeleton2D::Bone,_DefaultComparator<Skeleton2D::Bone>,true>::introsort(long param_1, long param_2, Bone_conflict *param_3, long param_4) {
   long lVar1;
   Node *pNVar2;
   bool bVar3;
   undefined8 uVar4;
   ...
   if (0x10 < lVar19) {
      ...
      if (param_4 != 0) {
         ...
         local_c8 = param_2;
         local_c0 = param_4;
         LAB_00100e41:local_c0 = local_c0 + -1;
         ...
         LAB_00100eb0:pNVar2 = *(Node**)pBVar18;
         local_e0 = param_1;
         lVar19 = local_c8;
         pBVar20 = pBVar16;
         do {
...
;
 ...
 while ( true );
      ...
      LAB_001010c3:for (lVar21 = lVar19 + -2 >> 1; adjust_heap(param_1, lVar21, lVar19, param_3),lVar21 != 0; lVar21 = lVar21 + -1) {}
 ...
 while ( bVar3 );
   ...
   LAB_00101262:if (lVar1 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }

   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   LAB_00101020:lVar19 = local_e0 - param_1;
...
/* Skeleton2D::get_modification_stack() const */void Skeleton2D::get_modification_stack(void) {
   char cVar1;
   long in_RSI;
   long *in_RDI;
   *in_RDI = 0;
...
/* Bone2D::get_skeleton_rest() const */void Bone2D::get_skeleton_rest(void) {
   long lVar1;
   long lVar2;
   undefined8 uVar3;
   undefined8 uVar4;
...
/* Skeleton2D::_update_bone_setup() [clone .part.0] */void Skeleton2D::_update_bone_setup(Skeleton2D *this) {
   ...
   plVar6 = (long*)RenderingServer::get_singleton();
   ( **(code**)( *plVar6 + 0x488 ) )(plVar6, *(undefined8*)( this + 0x598 ), *(undefined4*)( this + 0x580 ), 1);
 ...
 while ( uVar14 != 1 );
         pBVar16 = pBVar1 + 0x60;
         SortArray<Skeleton2D::Bone,_DefaultComparator<Skeleton2D::Bone>,true>::introsort(0, uVar12, pBVar1, lVar10 * 2);
         uVar14 = 1;
         lVar10 = 1;
         if (uVar12 < 0x11) {
            do {
...
;
      ...
      if (*(int*)( this + 0x580 ) != 0) {
         ...
         do {
            ...
            *(uint*)( *plVar6 + 0x5b4 ) = uVar11;
            ...
            if (lVar10 == 0) {
               uVar14 = ( ulong ) * (uint*)( this + 0x580 );
               LAB_00101c77:if ((uint)uVar14 <= uVar11) goto LAB_00101bd0;
               lVar10 = *(long*)( this + 0x588 );
            ...
            if (lVar2 == 0) {
               ...
               uVar14 = (ulong)uVar13;
               if (uVar13 <= uVar11) {
                  LAB_00101bd0:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, uVar12 & 0xffffffff, uVar14, "p_index", "count", "", false, true);
                  _err_flush_stdout();
                  /* WARNING: Does not return */
                  pcVar3 = (code*)invalidInstructionException();
                  ( *pcVar3 )();
 ...
 while ( (uint)uVar12 < uVar13 );
   ...
   if ((_update_bone_setup()::{lambda()
   #1
   ( iVar5 = __cxa_guard_acquire(&_update_bone_setup()::{lambda()#1}::operator()()::sname),
     iVar5 != 0) );
   {
      _scs_create((char *)&_update_bone_setup()::{lambda()
      #1
      __cxa_atexit(StringName::~StringName, &_update_bone_setup()::, {
            lambda()
            #1
            &__dso_handle;
            ...
            local_a8 = 0;
            ( **(code**)( *(long*)this + 0xd0 ) )(this, &_update_bone_setup()::, {
                  lambda()
                  #1
...
, /* Skeleton2D::_update_bone_setup() */, void __thiscall Skeleton2D::_update_bone_setup(Skeleton2D *this);
            {
               if (this[0x590] == (Skeleton2D)0x0) {
                  return;
               }
            ...
            undefined4 Bone2D::get_index_in_skeleton(Bone2D *this) {
               undefined4 uVar1;
               Skeleton2D *this_00;
               ...
               _err_print_error("get_index_in_skeleton", "scene/2d/skeleton_2d.cpp", 0x199, "Parameter \"skeleton\" is null.", 0, 0);
               return 0xffffffff;
            }

            /* Skeleton2D::_update_transform() */
            void Skeleton2D::_update_transform(Skeleton2D *this) {
               if (this[0x590] != (Skeleton2D)0x0) {
                  _update_bone_setup(this);
                  return;
               }
            ...
            undefined4 Skeleton2D::get_bone_count(Skeleton2D *this) {
               if (( (byte)this[0x2fa] & 0x40 ) != 0) {
                  if (this[0x590] != (Skeleton2D)0x0) {
                     _update_bone_setup(this);
                  }
               ...
               _err_print_error("get_bone_count", "scene/2d/skeleton_2d.cpp", 0x265, "Condition \"!is_inside_tree()\" is true. Returning: 0", 0, 0);
               return 0;
            }
 ...
 while ( !bVar4 );
            ...
            void Skeleton2D::~Skeleton2D(Skeleton2D *this) {
               Object *pOVar1;
               char cVar2;
               long lVar3;
               long *plVar4;
               *(undefined***)this = &PTR__initialize_classv_001172a0;
               lVar3 = RenderingServer::get_singleton();
               if (lVar3 == 0) {
                  _err_print_error("~Skeleton2D", "scene/2d/skeleton_2d.cpp", 0x348, "Parameter \"RenderingServer::get_singleton()\" is null.", 0, 0);
            ...
            undefined8 Bone2D::_get(Bone2D *this, StringName *param_1, Variant *param_2) {
               int iVar1;
               undefined8 uVar2;
               long in_FS_OFFSET;
               ...
               if (const::{lambda()
               #1
               iVar1 = __cxa_guard_acquire(&const::{lambda()
               #1
...
, else {
   ...
   *(undefined8*)( param_2 + 0x10 ) = uStack_38;
        ...
        if (const::{lambda()#4iVar1 = __cxa_guard_acquire(&const::{lambda()#4if (iVar1 != 0) {
   _scs_create((char *)&const::{lambda()
   #4
   __cxa_atexit(StringName::~StringName,&const::{lambda()
   #4
   ...
   #4
        ...
        if (*(long *)param_1 == const::{lambda()#4Variant::Variant((Variant*)local_48, *(float*)( this + 0x5ac ));if (Variant::needs_deinit[*(int*)param_2] != '\0') {
   Variant::_clear_internal();
}
*(undefined4*)param_2 = local_48[0];*(undefined8*)( param_2 + 8 ) = local_40;*(undefined8*)( param_2 + 0x10 ) = uStack_38;}
        else{
   if (const::{lambda()
   #5
   iVar1 = __cxa_guard_acquire(&const::{lambda()
...
uVar2 = 0;if (*(long *)param_1 != const::{lambda()#5Variant::Variant((Variant*)local_48, (bool)this[0x5c0]);if (Variant::needs_deinit[*(int*)param_2] != '\0') {
   Variant::_clear_internal();
}
*(undefined4*)param_2 = local_48[0];*(undefined8*)( param_2 + 8 ) = local_40;*(undefined8*)( param_2 + 0x10 ) = uStack_38;}
      }
   ...
   LAB_001025c8:
    if (const::{lambda()
   #1
   LAB_001027b0:Variant::Variant((Variant*)local_48, (bool)this[0x5a8]);
   if (Variant::needs_deinit[*(int*)param_2] != '\0') {
      Variant::_clear_internal();
   }
...
uVar2 = 1;LAB_0010272c:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return uVar2;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* Bone2D::_editor_set_show_bone_gizmo(bool) */void Bone2D::_editor_set_show_bone_gizmo(Bone2D *this, bool param_1) {
   this[0x5c0] = (Bone2D)param_1;
   CanvasItem::queue_redraw();
   return;
}
/* Bone2D::_editor_get_show_bone_gizmo() const */Bone2D Bone2D::_editor_get_show_bone_gizmo(Bone2D *this) {
   return this[0x5c0];
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Bone2D::Bone2D() */void Bone2D::Bone2D(Bone2D *this) {
   undefined8 uVar1;
   undefined8 uVar2;
   CanvasItem::CanvasItem((CanvasItem*)this);
   *(code**)this = Transform2D::operator *;
...
/* Skeleton2D::_get(StringName const&, Variant&) const */undefined8 Skeleton2D::_get(Skeleton2D *this, StringName *param_1, Variant *param_2) {
   Object *pOVar1;
   char cVar2;
   int iVar3;
   undefined8 uVar4;
...
uVar4 = 0;if (*(long *)param_1 == const::{lambda()#1pOVar1 = *(Object**)( this + 0x5a0 );if (pOVar1 == (Object*)0x0) {
...
uVar4 = 1;}if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return uVar4;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* Skeleton2D::_update_process_mode() */void Skeleton2D::_update_process_mode(Skeleton2D *this) {
   char cVar1;
...
/* Skeleton2D::_physics_interpolated_changed() */void Skeleton2D::_physics_interpolated_changed(Skeleton2D *this) {
   _update_process_mode(this);
   return;
}
/* Skeleton2D::set_modification_stack(Ref<SkeletonModificationStack2D>) */void Skeleton2D::set_modification_stack(Skeleton2D *this, long *param_2) {
   Skeleton2D *pSVar1;
   Object *pOVar2;
   char cVar3;
   Object *pOVar4;
   ...
   if (pSVar1 == (Skeleton2D*)0x0) {
      ...
      *(long*)( this + 0x5a0 ) = *param_2;
      ...
      pOVar4 = (Object*)0x0;
      if (cVar3 == '\0') {
         LAB_00102e48:*(undefined8*)( this + 0x5a0 ) = 0;
         goto LAB_00102e53;
      }

      LAB_00102e64:pOVar4 = *(Object**)( this + 0x5a0 );
   }
 else {
      ...
      if (pOVar2 != pOVar4) {
         *(Object**)( this + 0x5a0 ) = pOVar2;
         if (pOVar2 == (Object*)0x0) {
            LAB_00102e53:if (pOVar4 == (Object*)0x0) goto LAB_00102e79;
         }
 else {
            cVar3 = RefCounted::reference();
   ...
   LAB_00102e79:_update_process_mode(this);
   return;
}
/* Skeleton2D::_set(StringName const&, Variant const&) */undefined8 Skeleton2D::_set(StringName *param_1, Variant *param_2) {
   char cVar1;
   int iVar2;
   long lVar3;
   Object *pOVar4;
...
uVar5 = 0;if (*(long *)param_2 != _set(StringName_const&,Variant_const&)::{lambda()#1goto LAB_00102f32;local_38 = (Object*)0x0;lVar3 = Variant::get_validated_object();if (lVar3 == 0) {
   LAB_00102ffd:set_modification_stack((Skeleton2D*)param_1, &local_38);
}
 else {
   pOVar4 = (Object*)__dynamic_cast(lVar3, &Object::typeinfo, &SkeletonModificationStack2D::typeinfo, 0);
...
uVar5 = 1;LAB_00102f32:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return uVar5;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* Skeleton2D::_ensure_update_interpolation_data() */void Skeleton2D::_ensure_update_interpolation_data(Skeleton2D *this) {
   long lVar1;
...
/* Skeleton2D::_notification(int) */void Skeleton2D::_notification(Skeleton2D *this, int param_1) {
   Object *pOVar1;
   code *pcVar2;
   char cVar3;
   long lVar4;
...
LAB_001034e1:
      ...
      LAB_00103108:( **(code**)( *(long*)this + 0x298 ) )(&local_78, this);
      *(undefined8*)( this + 0x5a8 ) = local_78;
      *(undefined8*)( this + 0x5b0 ) = uStack_70;
   ...
   switchD_001030f1_caseD_b:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }

   LAB_00103694:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Skeleton2D::Skeleton2D() */void Skeleton2D::Skeleton2D(Skeleton2D *this) {
   undefined8 uVar1;
   long *plVar2;
   undefined8 uVar3;
   CanvasItem::CanvasItem((CanvasItem*)this);
...
/* Skeleton2D::_make_transform_dirty() */void Skeleton2D::_make_transform_dirty(Skeleton2D *this) {
   long in_FS_OFFSET;
   Skeleton2D aSStack_48[16];
   int local_38[6];
   long local_20;
   local_20 = *(long*)( in_FS_OFFSET + 0x28 );
   if (( this[0x591] == (Skeleton2D)0x0 ) && ( this[0x591] = (Skeleton2D)0x1((byte)this[0x2fa] & 0x40) != 0 )) {
      create_custom_callable_function_pointer<Skeleton2D>(aSStack_48, (char*)this, (_func_void*)"&Skeleton2D::_update_transform");
...
/* Skeleton2D::_make_bone_setup_dirty() [clone .part.0] [clone .constprop.0] */void Skeleton2D::_make_bone_setup_dirty(Skeleton2D *this) {
   long in_FS_OFFSET;
   Skeleton2D aSStack_48[16];
   int local_38[6];
   long local_20;
   local_20 = *(long*)( in_FS_OFFSET + 0x28 );
   create_custom_callable_function_pointer<Skeleton2D>(aSStack_48, (char*)this, (_func_void*)"&Skeleton2D::_update_bone_setup");
   Variant::Variant((Variant*)local_38, 0);
   Callable::call_deferredp((Variant**)aSStack_48, 0);
   if (Variant::needs_deinit[local_38[0]] != '\0') {
      Variant::_clear_internal();
...
/* Skeleton2D::_make_bone_setup_dirty() */void Skeleton2D::_make_bone_setup_dirty(Skeleton2D *this) {
   if (( this[0x590] == (Skeleton2D)0x0 ) && ( this[0x590] = (Skeleton2D)0x1((byte)this[0x2fa] & 0x40) != 0 )) {
...
/* Bone2D::set_rest(Transform2D const&) */void Bone2D::set_rest(Bone2D *this, Transform2D *param_1) {
   Skeleton2D *this_00;
   undefined8 uVar1;
   ...
   *(undefined8*)( this + 0x5a0 ) = *(undefined8*)( param_1 + 0x10 );
   this_00 = *(Skeleton2D**)( this + 0x588 );
   if (( ( this_00 != (Skeleton2D*)0x0 ) && ( this_00[0x590] == (Skeleton2D)0x0 ) ) && ( this_00[0x590] = (Skeleton2D)0x1((byte)this_00[0x2fa] & 0x40) != 0 )) {
...
/* Bone2D::calculate_length_and_rotation() */void Bone2D::calculate_length_and_rotation(Bone2D *this) {
   char *__s;
   int iVar1;
   long lVar2;
   int iVar3;
      ...
      do {
         ...
         if (lVar2 != 0) {
            ...
            if (lVar2 != 0) {
               ...
               local_58[0] = CONCAT44(fVar6 * (float)( (ulong)local_70 >> 0x20 ) + (float)uVar5 * (float)( (ulong)local_78 >> 0x20 ) + (float)( (ulong)local_68 >> 0x20 ), fVar6 * (float)local_70 + (float)uVar5 * (float)local_78 + (float)local_68);
 ...
 while ( iVar1 != iVar3 );
   ...
   local_90 = 0;
   local_80 = 0x5a;
   local_88 = ". Cannot calculate bone length or angle reliably.\nUsing transform rotation for bone angle.";
   ...
   operator+((char *)
   local_98,(String*)"No Bone2D children of node ";
   String::operator +((String*)&local_88, (String*)local_98);
   _err_print_error("calculate_length_and_rotation", "scene/2d/skeleton_2d.cpp", 0x1bf, (String*)&local_88, 0, 1);
   ...
   *(undefined4*)( this + 0x5b0 ) = uVar4;
   LAB_00103ab5:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* Bone2D::set_autocalculate_length_and_angle(bool) */void Bone2D::set_autocalculate_length_and_angle(Bone2D *this, bool param_1) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Bone2D::_set(StringName const&, Variant const&) */undefined8 Bone2D::_set(Bone2D *this, StringName *param_1, Variant *param_2) {
   long lVar1;
   Bone2D BVar2;
   int iVar3;
   undefined8 uVar4;
...
if (_set(StringName_const&,Variant_const&)::{lambda()#2*(long *)param_1){
   LAB_00103dc8:fVar5 = Variant::operator_cast_to_float(param_2);
   *(float*)( this + 0x5ac ) = fVar5;
   CanvasItem::queue_redraw();
}
else {
      if (_set(StringName_const&,Variant_const&)::{lambda()#3iVar3 = __cxa_guard_acquire(&_set(StringName_const & Variant_const & sname));if (iVar3 != 0) {
   _scs_create((char*)&_set(StringName_const & Variant_const & ::sname, true));
   __cxa_atexit(StringName::~StringName, &_set(StringName_const & Variant_const & ::sname, &__dso_handle));
   __cxa_guard_release(&_set(StringName_const&,Variant_const&)::{lambda()
   #3
   sname;
      ...
      if (*(long *)param_1 ==
          _set(StringName_const&,Variant_const&)::{lambda()#3fVar5 = Variant::operator_cast_to_float(param_2);*(float*)( this + 0x5b0 ) = fVar5 * __LC61;CanvasItem::queue_redraw();}
      else{
   if (_set(StringName_const&,Variant_const&)::{lambda()
   #4
   iVar3 = __cxa_guard_acquire(&_set(StringName_const & Variant_const & sname));
...
if (*(long *)param_1 ==
            _set(StringName_const&,Variant_const&)::{lambda()#4goto LAB_00103dc8;if (_set(StringName_const&,Variant_const&)::{lambda()#5iVar3 = __cxa_guard_acquire(&_set(StringName_const & Variant_const & sname));if (iVar3 != 0) {
   _scs_create((char*)&_set(StringName_const & Variant_const & ::sname, false));
   __cxa_atexit(StringName::~StringName, &_set(StringName_const & Variant_const & ::sname, &__dso_handle));
   __cxa_guard_release(&_set(StringName_const&,Variant_const&)::{lambda()
   #5
   ::sname
...
}uVar4 = 0;if (*(long *)param_1 !=
            _set(StringName_const&,Variant_const&)::{lambda()#5goto LAB_00103de5;BVar2 = (Bone2D)Variant::operator_cast_to_bool(param_2);this[0x5c0] = BVar2;CanvasItem::queue_redraw();}
    }
  }
  else{
   LAB_00103cc8:if (_set(StringName_const & Variant_const & ::sname != *(long*)param_1) goto LAB_00103cd8;
   LAB_00103e70:BVar2 = (Bone2D)Variant::operator_cast_to_bool(param_2);
   this[0x5a8] = BVar2;
   if ((bool)BVar2) {
      calculate_length_and_rotation(this);
   }
...
uVar4 = 1;LAB_00103de5:if (lVar1 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return uVar4;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* Skeleton2D::_get_property_list(List<PropertyInfo, DefaultAllocator>*) const */void Skeleton2D::_get_property_list(Skeleton2D *this, List *param_1) {
   long *plVar1;
   long lVar2;
   undefined4 *puVar3;
   undefined1(*pauVar4)[16];
...
/* Bone2D::_get_property_list(List<PropertyInfo, DefaultAllocator>*) const */void Bone2D::_get_property_list(Bone2D *this, List *param_1) {
   long in_FS_OFFSET;
   long local_98;
   long local_90;
   long local_88;
   ...
   local_50 = 6;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_001045d7:List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
   }
...
/* Bone2D::_bind_methods() */void Bone2D::_bind_methods(void) {
   long lVar1;
   code *pcVar2;
   long *plVar3;
   MethodBind *pMVar4;
 ...
 while ( lVar1 != lVar7 );
   ...
   PropertyInfo::PropertyInfo((PropertyInfo*)&local_98, 0xb, (StrRange*)&local_d0, 0, (StrRange*)&local_c8, 6, &local_c0);
   local_d8 = 0;
   local_a0 = 6;
   local_a8 = "Bone2D";
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Bone2D::_editor_get_bone_shape(Vector<Vector2>*, Vector<Vector2>*, Bone2D*) */byte Bone2D::_editor_get_bone_shape(Bone2D *this, Vector *param_1, Vector *param_2, Bone2D *param_3) {
   byte bVar1;
   long in_FS_OFFSET;
   float fVar2;
   float fVar3;
   ...
   if (( (byte)this[0x2fa] >> 6 & 1 ) != 0) {
      if (param_3 == (Bone2D*)0x0) {
         ...
         local_68 = (Vector<Vector2>*)CONCAT44((float)uVar5 * local_8c[0] * (float)( (ulong)uVar6 >> 0x20 ), (float)uVar5 * local_90 * (float)uVar6);
      }
 else {
         local_68 = (Vector<Vector2>*)0x0;
         uVar5 = Node2D::get_global_position();
         uVar6 = Node2D::get_global_position();
         local_68 = (Vector<Vector2>*)CONCAT44((float)( (ulong)uVar6 >> 0x20 ) - (float)( (ulong)uVar5 >> 0x20 ), (float)uVar6 - (float)uVar5);
      ...
      if (param_2 != (Vector*)0x0) {
         ...
         Vector<Vector2>::push_back((Vector<Vector2>*)CONCAT44(( (float)( (ulong)uVar6 >> 0x20 ) - (float)( (ulong)uVar5 >> 0x20 ) ) * fVar3, ( (float)uVar6 - (float)uVar5 ) * fVar3), param_2);
         for (int i = 0; i < 4; i++) {
            Vector<Vector2>::push_back((Vector<Vector2>*)param_2);
         }
   ...
   LAB_00105b32:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return bVar1;
   }
...
/* Skeleton2D::_bind_methods() */void Skeleton2D::_bind_methods(void) {
   long lVar1;
   code *pcVar2;
...
/* Bone2D::get_configuration_warnings() const */void Bone2D::get_configuration_warnings(void) {
   char cVar1;
   long in_RSI;
   long in_FS_OFFSET;
   undefined8 local_68;
...
/* Bone2D::_notification(int) */void __thiscall Bone2D::_notification(Bone2D *this,int param_1)
...
{
  *(undefined ***)this = &PTR__gen_argument_type_00117620;
...
{
  *(undefined ***)this = &PTR__gen_argument_type_001176e0;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...
{
  *(undefined ***)this = &PTR__gen_argument_type_00117680;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...
{
  *(undefined ***)this = &PTR__gen_argument_type_00117740;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...
{
  *(undefined ***)this = &PTR__gen_argument_type_001177a0;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...
{
  *(undefined ***)this = &PTR__gen_argument_type_00117800;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...
{
  *(undefined ***)this = &PTR__gen_argument_type_00117860;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...
{
  *(undefined ***)this = &PTR__gen_argument_type_001178c0;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...
{
  *(undefined ***)this = &PTR__gen_argument_type_00117920;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...
{
  *(undefined ***)this = &PTR__gen_argument_type_00117980;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...
{
  *(undefined ***)this = &PTR__gen_argument_type_001179e0;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...
{
  *(undefined ***)this = &PTR__gen_argument_type_00117a40;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...
{
  *(undefined ***)this = &PTR__gen_argument_type_00117aa0;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...
{
  *(undefined ***)this = &PTR__gen_argument_type_00117b00;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...
{
  *(undefined ***)this = &PTR__gen_argument_type_00117b60;
  MethodBind::~MethodBind((MethodBind *)this);
  return;
}
...

{
  ...
  *(undefined ***)this = &PTR_hash_00117590;
...
LAB_0010f99c:
    ...
    lVar4 = puVar10[-1];
    if (param_1 <= lVar4) goto LAB_0010f930;
  }
  else {
    if (lVar12 != 0) {
  ...
  if (((param_1 - lVar4) * 0x10 & 0x10U) != 0) {
    *puVar7 = __LC126;
    puVar7[1] = uVar3;
    puVar6 = puVar7 + 2;
    if (puVar7 + (param_1 - lVar4) * 2 == puVar7 + 2) goto LAB_0010f930;
  }
  do {
    *puVar6 = uVar9;
    puVar6[1] = uVar3;
...
/* WARNING: Removing unreachable block (ram,0x0010fb10) */
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
    ...
    auVar2._0_4_ = (float)*(double *)(*(long *)param_3 + 8);
                    /* WARNING: Could not recover jumptable at 0x00110839. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
    ...
    auVar2._0_4_ = (float)**param_3;
                    /* WARNING: Could not recover jumptable at 0x00110a27. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)
              (auVar2._0_8_,(long *)((long)param_2 + *(long *)(param_1 + 0x60)),
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
    auVar2._4_12_ = SUB1612((undefined1  [16])0x0,4);
    auVar2._0_4_ = (float)*(double *)(*(long *)param_3 + 8);
                    /* WARNING: Could not recover jumptable at 0x00111b92. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
    auVar2._4_12_ = SUB1612((undefined1  [16])0x0,4);
    auVar2._0_4_ = (float)**param_3;
                    /* WARNING: Could not recover jumptable at 0x00111d71. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)(auVar2._0_8_,(long *)((long)param_2 + *(long *)(param_1 + 0x60)));
    return;
  }
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x0011253d. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x001131d6. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00113396. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)((long *)((long)param_2 + *(long *)(param_1 + 0x60)));
    return;
  }
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00113b9d. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*UNRECOVERED_JUMPTABLE)
              ((long *)((long)param_2 + *(long *)(param_1 + 0x60)),
...

{
  ...
  if (local_30 == *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Could not recover jumptable at 0x00113d79. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...

{
  ...
  if (local_48 == (Object *)0x0) {
                    /* WARNING: Load size is inaccurate */
    pOVar5 = *param_3;
    if (pOVar5 == (Object *)0x0) goto LAB_00113fb6;
  ...
  if (pOVar5 != pOVar3) {
    *(Object **)param_3 = pOVar3;
    if (pOVar3 == (Object *)0x0) {
      if (pOVar5 != (Object *)0x0) goto LAB_00113ff9;
    }
    else {
      cVar1 = RefCounted::reference();
      if (cVar1 == '\0') {
...
LAB_00113ff9:
      ...
      if (local_48 == (Object *)0x0) goto LAB_00113fb6;
    }
  }
  cVar1 = RefCounted::unreference();
  pOVar5 = local_48;
...
LAB_00114276:
      ...
      if (pOVar2 != pOVar4) {
        ...
        if (pOVar2 != (Object *)0x0) goto LAB_00114276;
      }
    }
  }
...
LAB_001158fd:
      ...
      if (pOVar5 != pOVar8) {
        ...
        if (pOVar5 != (Object *)0x0) goto LAB_001158fd;
      }
    }
  }
...
LAB_00115dad:
    ...
    if (iVar6 <= iVar11) {
      if (uVar10 == 0) {
        lVar9 = (long)(iVar11 + -2);
        if (lVar2 <= lVar9) goto LAB_00115dc8;
        this = (Variant *)(lVar1 + lVar9 * 0x18);
      }
      else {
        this = (Variant *)*plVar8;
        if (uVar10 == 2) goto LAB_00115dad;
      }
...
LAB_00115ce5:
      *(undefined4 *)param_6 = 0;
      ...
      fVar12 = Variant::operator_cast_to_float(this);
                    /* WARNING: Could not recover jumptable at 0x00115d69. Too many branches */
                    /* WARNING: Treating indirect jump as call */
...
LAB_001160ab:
  *(undefined4 *)param_6 = 0;
  ...
  fVar9 = Variant::operator_cast_to_float(this);
                    /* WARNING: Could not recover jumptable at 0x00116104. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*param_2)(fVar9);
  return;
}
...
LAB_0011643b:
  *(undefined4 *)param_6 = 0;
  ...
  Variant::operator_cast_to_bool(this);
                    /* WARNING: Could not recover jumptable at 0x00116497. Too many branches */
                    /* WARNING: Treating indirect jump as call */

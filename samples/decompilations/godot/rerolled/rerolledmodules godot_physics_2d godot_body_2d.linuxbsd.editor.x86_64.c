/* GodotBody2D::~GodotBody2D() */void GodotBody2D::~GodotBody2D(GodotBody2D *this) {
   Callable *this_00;
   Object *pOVar1;
   void *pvVar2;
   long lVar3;
 ...
 while ( (int)plVar6[2] != 0 );
   ...
   LAB_00100127:if (*(long*)( this + 0x1b0 ) != 0) {
      LOCK();
   ...
   for (int i = 0; i < 3; i++) {
      plVar6 = *(long**)( this + ( -32*i + 392 ) );
      if (plVar6 != (long*)0) {
         lVar5 = *(long*)( this + ( -32*i + 408 ) );
         if (lVar5 != 0) {
            *(undefined8*)( lVar5 + 24 ) = *(undefined8*)( this + ( -32*i + 416 ) );
         }

         lVar3 = *(long*)( this + ( -32*i + 416 ) );
         if (lVar3 != 0) {
            *(long*)( lVar3 + 16 ) = lVar5;
         }

         if (this + ( -32*i + 392 ) == (GodotBody2D*)*plVar6) {
            *plVar6 = *(long*)( this + ( -32*i + 408 ) );
         }

         if (this + ( -32*i + 392 ) == (GodotBody2D*)plVar6[1]) {
            plVar6[1] = lVar3;
         }
...
/* GodotBody2D::_mass_properties_changed() */void GodotBody2D::_mass_properties_changed(GodotBody2D *this) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotBody2D::update_mass_properties() */void GodotBody2D::update_mass_properties(GodotBody2D *this) {
   long lVar1;
   undefined8 *puVar2;
   float *pfVar3;
   float *pfVar4;
   ...
   if (uVar6 == 2) {
      ...
      if (lVar9 == 0) {
         ...
         LAB_00100586:lVar11 = *(long*)( lVar9 + -8 );
         if ((int)lVar10 < (int)lVar11) {
            do {
               if (lVar10 < lVar11) {
                  ...
                  _err_print_index_error("is_shape_disabled", "modules/godot_physics_2d/godot_collision_object_2d.h", 0x8b, lVar10, lVar11, "p_idx", "shapes.size()", "", false, false);
                  lVar9 = *(long*)( this + 0x38 );
               }
 ...
 while ( true );
         ...
         LAB_001005e0:if (( this[0x121] != (GodotBody2D)0x0 ) && ( *(undefined8*)( this + 0x110 ) = fVar17 != 0.0 )) {
            lVar12 = 0;
            lVar10 = 0;
            if (lVar9 != 0) {
               LAB_00100611:lVar11 = *(long*)( lVar9 + -8 );
               if ((int)lVar10 < (int)lVar11) {
                  do {
                     if (lVar10 < lVar11) {
                     ...
                     if (lVar9 == 0) {
                        LAB_001008c8:lVar11 = 0;
                        LAB_001008cb:_err_print_index_error("get_shape_aabb", "modules/godot_physics_2d/godot_collision_object_2d.h", 0x81, lVar10, lVar11, "p_index", "shapes.size()", "", false, true);
                        _err_flush_stdout();
                     ...
                     lVar10 = lVar10 + 1;
                     lVar12 = lVar12 + 0x58;
                     fVar13 = ( *(float*)( lVar1 + 0x3c ) * *(float*)( lVar1 + 0x40 ) * *(float*)( this + 0x100 ) ) / fVar17;
                     *(ulong*)( this + 0x110 ) = CONCAT44((float)( ( ulong ) * (undefined8*)( this + 0x110 ) >> 0x20 ) + (float)( ( ulong ) * (undefined8*)( lVar1 + 0x10 ) >> 0x20 ) * fVar13, (float)*(undefined8*)( this + 0x110 ) + (float)*(undefined8*)( lVar1 + 0x10 ) * fVar13);
                     if ((int)lVar11 <= (int)lVar10) break;
                  }
 while ( true );
               }
      ...
      if (this[0x120] == (GodotBody2D)0x0) {
         LAB_001007fc:if (*(float*)( this + 0x108 ) <= 0.0) goto LAB_00100990;
         ...
         if (lVar9 != 0) {
            LAB_001006e8:do {
               ...
               if (lVar10 < lVar11) {
                  ...
                  _err_print_index_error("is_shape_disabled", "modules/godot_physics_2d/godot_collision_object_2d.h", 0x8b, lVar10, lVar11, "p_idx", "shapes.size()", "", false, false);
                  lVar9 = *(long*)( this + 0x38 );
                  LAB_0010070a:if (lVar9 == 0) {
                     lVar11 = 0;
                     LAB_001009a3:_err_print_index_error("get_shape", "modules/godot_physics_2d/godot_collision_object_2d.h", 0x75, lVar10, lVar11, "p_index", "shapes.size()", "", false, true);
                     _err_flush_stdout();
                     /* WARNING: Does not return */
                     pcVar8 = (code*)invalidInstructionException();
                     ( *pcVar8 )();
                  ...
                  lVar9 = *(long*)( this + 0x38 );
                  *(float*)( this + 0x108 ) = fVar14 * ( ( fVar13 * fVar5 ) / fVar17 ) + fVar15 + *(float*)( this + 0x108 );
               }
 ...
 while ( lVar9 != 0 );
   ...
   *(undefined4*)( this + 0x104 ) = 0;
   LAB_001004ed:fVar13 = (float)*(undefined8*)( this + 0x110 );
   fVar17 = (float)( ( ulong ) * (undefined8*)( this + 0x110 ) >> 0x20 );
   *(ulong*)( this + 0x118 ) = CONCAT44(fVar17 * (float)( ( ulong ) * (undefined8*)( this + 0x50 ) >> 0x20 ) + (float)( ( ulong ) * (undefined8*)( this + 0x48 ) >> 0x20 ) * fVar13, (float)*(undefined8*)( this + 0x50 ) * fVar17 + fVar13 * (float)*(undefined8*)( this + 0x48 ));
   ...
   __stack_chk_fail();
   LAB_00100858:if (lVar9 == 0) goto LAB_001005e0;
   lVar10 = lVar10 + 1;
   lVar12 = lVar12 + 0x58;
   goto LAB_00100586;
   LAB_00100920:if (lVar9 == 0) goto LAB_00100690;
   lVar10 = lVar10 + 1;
   lVar12 = lVar12 + 0x58;
   goto LAB_00100611;
}
/* GodotBody2D::reset_mass_properties() */void GodotBody2D::reset_mass_properties(GodotBody2D *this) {
...
/* GodotBody2D::set_active(bool) */void GodotBody2D::set_active(GodotBody2D *this, bool param_1) {
...
/* GodotBody2D::set_param(PhysicsServer2D::BodyParameter, Variant const&) */void GodotBody2D::set_param(GodotBody2D *this, undefined4 param_2, Variant *param_3) {
   int iVar1;
   float fVar2;
   undefined8 uVar3;
   switch (param_2) {
...
/* GodotBody2D::get_param(PhysicsServer2D::BodyParameter) const */Variant *GodotBody2D::get_param(Variant *param_1, long param_2, undefined4 param_3) {
   switch (param_3) {
      case 0:
...
/* GodotBody2D::set_mode(PhysicsServer2D::BodyMode) */void GodotBody2D::set_mode(GodotBody2D *this, uint param_2) {
   int iVar1;
   long lVar2;
   long in_FS_OFFSET;
   bool bVar3;
   ...
   *(uint*)( this + 0xa8 ) = param_2;
   if (param_2 == 2) {
      ...
      *(float*)( this + 0x104 ) = fVar4;
      ...
      LAB_00100f2f:GodotCollisionObject2D::_set_static(SUB81(this, 0));
   ...
   LAB_001010f1:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* GodotBody2D::get_mode() const */undefined4 GodotBody2D::get_mode(GodotBody2D *this) {
   return *(undefined4*)( this + 0xa8 );
}
/* GodotBody2D::get_state(PhysicsServer2D::BodyState) const */Variant *GodotBody2D::get_state(Variant *param_1, long param_2, undefined4 param_3) {
   switch (param_3) {
      case 0:
...
/* GodotBody2D::_update_transform_dependent() */void GodotBody2D::_update_transform_dependent(GodotBody2D *this) {
   float fVar1;
   float fVar2;
   fVar2 = (float)*(undefined8*)( this + 0x110 );
   fVar1 = (float)( ( ulong ) * (undefined8*)( this + 0x110 ) >> 0x20 );
   *(ulong*)( this + 0x118 ) = CONCAT44(fVar1 * (float)( ( ulong ) * (undefined8*)( this + 0x50 ) >> 0x20 ) + (float)( ( ulong ) * (undefined8*)( this + 0x48 ) >> 0x20 ) * fVar2, (float)*(undefined8*)( this + 0x50 ) * fVar1 + fVar2 * (float)*(undefined8*)( this + 0x48 ));
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotBody2D::integrate_velocities(float) */void GodotBody2D::integrate_velocities(GodotBody2D *this, float param_1) {
   undefined8 uVar1;
   int iVar2;
   char cVar3;
   SelfList *pSVar4;
   ...
   if (*(int*)( this + 0xa8 ) != 0) {
      ...
      if (pSVar4 == (SelfList*)0x0) {
         if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
            _err_print_error("integrate_velocities", "modules/godot_physics_2d/godot_body_2d.cpp", 0x26c, "Parameter \"get_space()\" is null.", 0, 0);
            return;
         }
      ...
      if (*(long*)( this + 0x218 ) == 0) {
         ...
         LAB_0010124c:GodotSpace2D::body_add_to_state_query_list(pSVar4);
      }
      ...
      if (*(int*)( this + 0xa8 ) == 1) {
         ...
         *(undefined8*)( this + 0x68 ) = uStack_40;
         if (( ( ( *(long*)( this + 0x1f8 ) == 0 ) || ( *(long*)( *(long*)( this + 0x1f8 ) + -8 ) == 0 ) ) && ( *(float*)( this + 0xb8 ) == 0.0 ) ) && ( ( ( *(float*)( this + 0xbc ) == 0.0 && ( *(float*)( this + 0xc0 ) == 0.0 ) ) && ( this[0x1bd] != (GodotBody2D)0x0 ) ) )) {
            this[0x1bd] = (GodotBody2D)0x0;
            if (*(SelfList**)( this + 0x40 ) != (SelfList*)0x0) {
               if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
                  GodotSpace2D::body_remove_from_active_list(*(SelfList**)( this + 0x40 ));
         ...
         local_50 = CONCAT44((float)( ( ulong ) * (undefined8*)( this + 0x58 ) >> 0x20 ) + ( (float)( (ulong)uVar1 >> 0x20 ) + (float)( (ulong)uVar7 >> 0x20 ) ) * param_1, (float)*(undefined8*)( this + 0x58 ) + ( (float)uVar1 + (float)uVar7 ) * param_1);
         fVar6 = (float)Vector2::length_squared();
         if (__LC26 < (double)fVar6) {
            uVar7 = Vector2::rotated(fVar8);
            local_50 = CONCAT44(( (float)( ( ulong ) * (undefined8*)( this + 0x118 ) >> 0x20 ) - (float)( (ulong)uVar7 >> 0x20 ) ) + (float)( (ulong)local_50 >> 0x20 ), ( (float)*(undefined8*)( this + 0x118 ) - (float)uVar7 ) + (float)local_50);
         }
         ...
         *(ulong*)( this + 0x118 ) = CONCAT44(fVar5 * (float)( ( ulong ) * (undefined8*)( this + 0x50 ) >> 0x20 ) + (float)( ( ulong ) * (undefined8*)( this + 0x48 ) >> 0x20 ) * fVar6, (float)*(undefined8*)( this + 0x50 ) * fVar5 + fVar6 * (float)*(undefined8*)( this + 0x48 ));
      }
   ...
   LAB_00101561:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* GodotBody2D::wakeup_neighbours() */void GodotBody2D::wakeup_neighbours(GodotBody2D *this) {
   int iVar1;
   long *plVar2;
   long lVar3;
   long lVar4;
   ...
   do {
      ...
      if (0 < iVar1) {
         lVar5 = 0;
         LAB_001015c1:do {
            if (( ( (int)plVar2[1] != (int)lVar5 ) && ( lVar4 = *(long*)( lVar3 + lVar5 * 8 ) ),1 < *(int*)( lVar4 + 0xa8 ) )) &&( *(char*)( lVar4 + 0x1bd ) == '\0' ) * (undefined1*)( lVar4 + 0x1bd ) = 1;
...
/* GodotBody2D::_shapes_changed() */void GodotBody2D::_shapes_changed(GodotBody2D *this) {
   SelfList *pSVar1;
   ...
   LAB_00101644:wakeup_neighbours(this);
   return;
}
/* GodotBody2D::set_state(PhysicsServer2D::BodyState, Variant const&) */void GodotBody2D::set_state(GodotBody2D *this, undefined4 param_2, Variant *param_3) {
   char cVar1;
   bool bVar2;
   GodotBody2D GVar3;
   SelfList *pSVar4;
...
LAB_0010176c:
   ...
   LAB_00101790:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* GodotBody2D::set_space(GodotSpace2D*) */void GodotBody2D::set_space(GodotSpace2D *param_1) {
...
/* GodotBody2D::sleep_test(float) */undefined8 GodotBody2D::sleep_test(GodotBody2D *this, float param_1) {
   float fVar1;
   long lVar2;
   float fVar3;
   float fVar4;
   ...
   if (this[0x1be] != (GodotBody2D)0x0) {
      if (*(long*)( this + 0x40 ) == 0) {
         _err_print_error("sleep_test", "modules/godot_physics_2d/godot_body_2d.cpp", 0x2c7, "Parameter \"get_space()\" is null.", 0, 0);
         return 1;
      }
...
/* GodotBody2D::set_state_sync_callback(Callable const&) */void GodotBody2D::set_state_sync_callback(GodotBody2D *this, Callable *param_1) {
   Callable::operator =((Callable*)( this + 0x208 ), param_1);
   return;
}
/* GodotBody2D::set_force_integration_callback(Callable const&, Variant const&) */void GodotBody2D::set_force_integration_callback(GodotBody2D *this, Callable *param_1, Variant *param_2) {
   char cVar1;
   Callable *pCVar2;
...
/* GodotBody2D::call_queries() */void GodotBody2D::call_queries(GodotBody2D *this) {
   Variant **ppVVar1;
   char cVar2;
   Object *this_00;
   long in_FS_OFFSET;
...
/* GodotBody2D::get_direct_state() */PhysicsDirectBodyState2D * __thiscall GodotBody2D::get_direct_state(GodotBody2D *this){
...
/* GodotBody2D::GodotBody2D() */void GodotBody2D::GodotBody2D(GodotBody2D *this) {
   ...
   *(undefined4*)( this + 300 ) = 0;
   for (int i = 0; i < 3; i++) {
      *(undefined8*)( this + ( 8*i + 304 ) ) = 0;
   }

   for (int i = 0; i < 3; i++) {
      *(undefined8*)( this + ( 32*i + 328 ) ) = 0;
      *(undefined8*)( this + ( 32*i + 344 ) ) = 0;
      *(undefined8*)( this + ( 32*i + 352 ) ) = 0;
      *(GodotBody2D**)( this + ( 32*i + 336 ) ) = this;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* GodotBody2D::integrate_forces(float) */void GodotBody2D::integrate_forces(GodotBody2D *this, float param_1) {
   code *pcVar1;
   double dVar2;
   bool bVar3;
   bool bVar4;
   ...
   if (*(int*)( this + 0xa8 ) != 0) {
      ...
      if (*(long*)( this + 0x1e8 ) == 0) {
         ...
         *(undefined8*)( this + 0xec ) = 0;
         LAB_00102bc6:pVVar11 = *(Vector2**)( lVar7 + 0xb8 );
         if (pVVar11 == (Vector2*)0x0) {
            LAB_00102c30:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
               uVar8 = 0x203;
               pcVar6 = "Parameter \"default_area\" is null.";
               LAB_00102b86:_err_print_error("integrate_forces", "modules/godot_physics_2d/godot_body_2d.cpp", uVar8, pcVar6, 0, 0);
               return;
            }
         ...
         bVar15 = false;
         bVar14 = false;
         LAB_001023f3:local_58[0] = 0;
         GodotArea2D::compute_gravity(pVVar11, (Vector2*)( this + 0x58 ));
         uVar8 = CONCAT44((float)( ( ulong ) * (undefined8*)( this + 0x124 ) >> 0x20 ) + (float)( local_58[0] >> 0x20 ), (float)*(undefined8*)( this + 0x124 ) + (float)local_58[0]);
         LAB_0010241c:if (!bVar14) {
         ...
         LAB_001026d8:iVar5 = *(int*)( this + 0xe0 );
         *(float*)( this + 0xec ) = *(float*)( this + 0xec ) + *(float*)( this + 0xe4 );
         if (iVar5 != 0) goto LAB_00102469;
         LAB_001026fe:*(float*)( this + 0xf0 ) = *(float*)( this + 0xf0 ) + *(float*)( this + 0xe8 );
      }
 else {
         ...
         *(undefined8*)( this + 0xec ) = 0;
         ...
         Vector<GodotBody2D::AreaCMP>::sort_custom<_DefaultComparator<GodotBody2D::AreaCMP>,true>((Vector<GodotBody2D::AreaCMP>*)( this + 0x1e0 ));
         lVar7 = *(long*)( this + 0x1e8 );
         if (lVar7 == 0) {
            lVar9 = 0;
            LAB_00102c63:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, 0, lVar9, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
         ...
         do {
            if (bVar13) {
               if (bVar14) {
                  ...
                  LAB_00102953:lVar7 = *plVar12;
                  LAB_0010295e:GodotArea2D::get_param((Variant*)local_58, lVar7, 7);
                  ...
                  LAB_001027f0:GodotArea2D::get_param((Variant*)local_58, *plVar12, 5);
                  iVar5 = Variant::operator_cast_to_int((Variant*)local_58);
                  if (Variant::needs_deinit[(int)local_58[0]] != '\0') {
                     Variant::_clear_internal();
                  }
                  ...
                  if (iVar5 != 0) {
                     ...
                     LAB_00102933:if (!bVar15) goto LAB_00102953;
                     if (!bVar4) goto LAB_001028e6;
                     goto LAB_001026c2;
                  }
               ...
               if (iVar5 != 0) {
                  ...
                  bVar13 = iVar5 == 2;
                  *(ulong*)( this + 0x124 ) = CONCAT44((float)( ( ulong ) * (undefined8*)( this + 0x124 ) >> 0x20 ) + (float)( local_58[0] >> 0x20 ), (float)*(undefined8*)( this + 0x124 ) + (float)local_58[0]);
                  LAB_001027df:bVar4 = bVar13;
                  if (!bVar14) goto LAB_001027f0;
                  goto LAB_00102933;
               }

               LAB_001028c8:if (!bVar14) goto LAB_001027f0;
               if (!bVar15) {
                  bVar14 = true;
                  bVar4 = false;
                  bVar13 = false;
 ...
 while ( ( -1 < iVar10 ) && ( bVar3 ) );
      ...
      *(ulong*)( this + 0x124 ) = CONCAT44(fVar19, fVar16);
      if (*(int*)( this + 0xa8 ) == 1) {
         auVar17._0_8_ = CONCAT44((float)( ( ulong ) * (undefined8*)( this + 0x1d0 ) >> 0x20 ) - (float)( ( ulong ) * (undefined8*)( this + 0x58 ) >> 0x20 ), (float)*(undefined8*)( this + 0x1d0 ) - (float)*(undefined8*)( this + 0x58 ));
         auVar17._8_8_ = 0;
         ...
         *(ulong*)( this + 0xb8 ) = CONCAT44((float)( ( ulong ) * (undefined8*)( this + 0xd0 ) >> 0x20 ) + auVar18._4_4_, (float)*(undefined8*)( this + 0xd0 ) + auVar18._0_4_);
 ...
 while ( ( in_FPUStatusWord & 0x400 ) != 0 );
         ...
         *(float*)( this + 0xc0 ) = (float)( dVar2 / (double)param_1 + (double)fVar16 );
         LAB_001025ba:*(undefined8*)( this + 0x130 ) = 0;
         ...
         *(undefined8*)( this + 0xac ) = 0;
         ...
         if (this[0x1bc] == (GodotBody2D)0x0) {
            ...
            *(float*)( this + 0xc0 ) = ( *(float*)( this + 0x138 ) + *(float*)( this + 0x144 ) ) * *(float*)( this + 0x10c ) * param_1 + *(float*)( this + 0xc0 ) * fVar23;
            *(ulong*)( this + 0xb8 ) = CONCAT44(fVar21 * ( fVar22 * fVar19 + (float)( ( ulong ) * (undefined8*)( this + 0x130 ) >> 0x20 ) + (float)( ( ulong ) * (undefined8*)( this + 0x13c ) >> 0x20 ) ) * param_1 + (float)( ( ulong ) * (undefined8*)( this + 0xb8 ) >> 0x20 ) * fVar20, fVar21 * ( fVar22 * fVar16 + (float)*(undefined8*)( this + 0x130 ) + (float)*(undefined8*)( this + 0x13c ) ) * param_1 + (float)*(undefined8*)( this + 0xb8 ) * fVar20);
         }

         if (*(int*)( this + 0x1b8 ) != 0) {
            local_58[0] = CONCAT44((float)( ( ulong ) * (undefined8*)( this + 0xb8 ) >> 0x20 ) * param_1, (float)*(undefined8*)( this + 0xb8 ) * param_1);
            goto LAB_001025ba;
         }
   ...
   LAB_00102cb1:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* SortArray<GodotBody2D::AreaCMP, _DefaultComparator<GodotBody2D::AreaCMP>, true>::introsort(long,
   long, GodotBody2D::AreaCMP*, long) const [clone .isra.0] */void SortArray<GodotBody2D::AreaCMP,_DefaultComparator<GodotBody2D::AreaCMP>,true>::introsort(long param_1, long param_2, AreaCMP *param_3, long param_4) {
   int iVar1;
   bool bVar2;
   long lVar3;
   long lVar4;
   ...
   if (param_4 != 0) {
      lVar18 = param_2;
      local_b0 = param_4;
      LAB_00102db3:local_b0 = local_b0 + -1;
      ...
      if (iVar6 < iVar1) {
         if (iVar1 < iVar13) {
            LAB_00102f9d:lVar16 = *(long*)( param_3 + ( ( lVar14 >> 1 ) + param_1 ) * 0x10 );
            iVar13 = iVar1;
            goto LAB_00102e08;
         }
...
;
            ...
            LAB_00102ec0:if (lVar14 <= param_2) goto LAB_00102f10;
            lVar7 = param_2 * 0x10;
 ...
 while ( true );
   ...
   LAB_0010311b:lVar16 = lVar14 + -2 >> 1;
   lVar18 = lVar16 * 2 + 2;
   ...
   do {
      ...
      if (lVar18 < lVar14) {
         do {
            ...
            lVar11 = lVar7;
            if (*(int*)( *(long*)( param_3 + ( param_1 + lVar7 + -1 ) * 0x10 ) + 0xd0 ) <= *(int*)( *(long*)( param_3 + ( param_1 + lVar7 ) * 0x10 ) + 0xd0 )) {
               lVar11 = lVar7 + 1;
               lVar4 = lVar7;
 ...
 while ( lVar16 < lVar12 );
         ...
         *(int*)( pAVar5 + 8 ) = (int)lVar3;
         ...
         LAB_001032bc:*(long*)pAVar5 = lVar8;
         *(int*)( pAVar5 + 8 ) = (int)lVar3;
      }
 ...
 while ( true );
   LAB_00102f10:introsort(param_2, lVar18, param_3, local_b0);
   lVar14 = param_2 - param_1;
   if (lVar14 < 0x11) {
      return;
   }
   ...
   goto LAB_00102db3;
   LAB_00102fa7:pAVar5 = param_3 + param_1 * 0x10;
      ...
      if (lVar14 < 3) {
         ...
         *(undefined4*)( pAVar9 + 8 ) = *(undefined4*)( pAVar17 + 8 );
         ...
         do {
            ...
            lVar7 = lVar16;
            if (*(int*)( *(long*)( param_3 + ( param_1 + lVar16 + -1 ) * 0x10 ) + 0xd0 ) <= *(int*)( *(long*)( param_3 + ( param_1 + lVar16 ) * 0x10 ) + 0xd0 )) {
               lVar7 = lVar16 + 1;
               lVar3 = lVar16;
...
/* void Vector<GodotBody2D::AreaCMP>::sort_custom<_DefaultComparator<GodotBody2D::AreaCMP>, true>()
    */void Vector<GodotBody2D::AreaCMP>::sort_custom<_DefaultComparator<GodotBody2D::AreaCMP>,true>(Vector<GodotBody2D::AreaCMP> *this) {
   AreaCMP *pAVar1;
   long *plVar2;
   int iVar3;
   long lVar4;
   ...
   LAB_00103616:if (lVar4 == 1) {
      SortArray<GodotBody2D::AreaCMP,_DefaultComparator<GodotBody2D::AreaCMP>,true>::introsort(0, 1, __dest, 0);
      return;
   }
 ...
 while ( lVar17 != 1 );
   SortArray<GodotBody2D::AreaCMP,_DefaultComparator<GodotBody2D::AreaCMP>,true>::introsort(0, lVar4, __dest, lVar7 * 2);
   pAVar1 = __dest + 0x10;
   lVar17 = 1;
   lVar7 = 1;
   pAVar16 = pAVar1;
 ...
 while ( lVar9 != 0 );
            ...
            LAB_00103899:*(long*)pAVar15 = lVar17;
 ...
 while ( lVar9 != 0 );
         ...
         LAB_0010393d:*(long*)pAVar15 = lVar7;

...
/* IP::get_singleton() */undefined8 IP::get_singleton(void) {
   return singleton;
}
/* IP::create() */undefined8 IP::create(void) {
   undefined8 uVar1;
   if (singleton == 0) {
      if (_create != (code*)0x0) {
      ...
      _err_print_error("create", "core/io/ip.cpp", 0x150, "Condition \"singleton\" is true. Returning: nullptr", "IP singleton already exist.", 0, 0);
   }

   return 0;
}
/* IP::IP() */void IP::IP(IP *this) {
   StrRange *pSVar1;
   long lVar2;
   void *pvVar3;
   undefined4 *puVar4;
            ...
            if (*(undefined8**)( (long)pvVar3 + 0x28 ) == puVar6) {
               *puVar6 = *(undefined8*)( (long)pvVar3 + 0x18 );
               ...
               if (*(long*)( (long)pvVar3 + 0x20 ) != 0) {
                  *(undefined8*)( *(long*)( (long)pvVar3 + 0x20 ) + 0x18 ) = *(undefined8*)( (long)pvVar3 + 0x18 );
               }

               if (*(long*)( (long)pvVar3 + 0x18 ) != 0) {
                  *(undefined8*)( *(long*)( (long)pvVar3 + 0x18 ) + 0x20 ) = *(undefined8*)( (long)pvVar3 + 0x20 );
               }
 ...
 while ( *(int*)( puVar6 + 2 ) != 0 );
      ...
      if (puVar4 + 0x800 == puVar5) {
         ...
         *(undefined1*)( puVar4 + 0x826 ) = 0;
         Thread::start((_func_void_void_ptr*)( *(Settings**)( this + 0x178 ) + 0x2088 ), _IP_ResolverPrivate::_thread_function, *(Settings**)( this + 0x178 ));
...
/* IP::get_resolve_item_status(int) const */int IP::get_resolve_item_status(IP *this, int param_1) {
   int iVar1;
   long in_FS_OFFSET;
   undefined8 local_40;
   char *local_38;
   ...
   if ((uint)param_1 < 0x100) {
      ...
      if (iVar1 == 0) {
         _err_print_error("get_resolve_item_status", "core/io/ip.cpp", 0xc0, "Condition status == IP::RESOLVER_STATUS_NONE", 0, 0);
      }
      ...
      local_40 = 0;
      local_30 = 0x76;
      local_38 = "Too many concurrent DNS resolver queries (%d, but should be %d at most). Try performing less network requests at once.";
      String::parse_latin1((StrRange*)&local_40);
      vformat<int,IP::_unnamed_type_1_>((CowData<char32_t>*)&local_38, (StrRange*)&local_40, param_1, 0x100);
      _err_print_index_error("get_resolve_item_status", "core/io/ip.cpp", 0xbc, (long)param_1, 0x100, "p_id", "IP::RESOLVER_MAX_QUERIES", (String*)&local_38, false, false);
...
/* IP::erase_resolve_item(int) */void IP::erase_resolve_item(IP *this, int param_1) {
   long in_FS_OFFSET;
   undefined8 local_40;
   char *local_38;
   undefined8 local_30;
   ...
   if ((uint)param_1 < 0x100) {
      *(undefined4*)( (long)param_1 * 0x20 + *(long*)( this + 0x178 ) ) = 0;
      ...
      String::parse_latin1((StrRange*)&local_40);
      vformat<int,IP::_unnamed_type_1_>((CowData<char32_t>*)&local_38, (StrRange*)&local_40, param_1, 0x100);
      _err_print_index_error("erase_resolve_item", "core/io/ip.cpp", 0xef, (long)param_1, 0x100, "p_id", "IP::RESOLVER_MAX_QUERIES", (String*)&local_38, false, false);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_38);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_40);
   }
...
/* HashMap<String, List<IPAddress, DefaultAllocator>, HashMapHasherDefault,
   ...
   DefaultAllocator> > > >::erase(String const&) [clone .isra.0] */void HashMap<String,List<IPAddress,DefaultAllocator>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,List<IPAddress,DefaultAllocator>>>>::erase(HashMap<String,List<IPAddress,DefaultAllocator>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,List<IPAddress,DefaultAllocator>>>> *this, String *param_1) {
   uint *puVar1;
   undefined8 *puVar2;
   long *plVar3;
   uint uVar4;
   ...
   if (*(int*)( this + 0x2c ) != 0) {
      ...
      if (uVar29 != 0) {
         uVar41 = 0;
         LAB_00100687:uVar34 = (ulong)uVar31;
         if (uVar30 == uVar29) {
            ...
            if (cVar28 != '\0') {
               ...
               uVar36 = (ulong)uVar29;
               uVar30 = *puVar39;
               if (( uVar30 != 0 ) && ( auVar13._8_8_ = 0 ),auVar13._0_8_ = (ulong)uVar30 * lVar32,auVar23._8_8_ = 0,auVar23._0_8_ = uVar37,auVar14._8_8_ = 0,auVar14._0_8_ = ( ulong )(( uVar4 + uVar29 ) - SUB164(auVar13 * auVar23, 8)) * lVar32,auVar24._8_8_ = 0,auVar24._0_8_ = uVar37,SUB164(auVar14 * auVar24, 8) != 0) {
                  while (true) {
                     ...
                     *puVar2 = uVar6;
                     ...
                     uVar30 = *puVar39;
                     uVar34 = uVar36;
                     if (( uVar30 == 0 ) || ( auVar15._8_8_ = 0 ),auVar15._0_8_ = (ulong)uVar30 * lVar32,auVar25._8_8_ = 0,auVar25._0_8_ = uVar37,auVar16._8_8_ = 0,auVar16._0_8_ = ( ulong )(( SUB164(auVar17 * auVar27, 8) + uVar4 ) - SUB164(auVar15 * auVar25, 8)) * lVar32,auVar26._8_8_ = 0,auVar26._0_8_ = uVar37,SUB164(auVar16 * auVar26, 8) == 0) break;
...
;
                     ...
                     if (*(undefined8**)( (long)pvVar7 + 0x28 ) == puVar35) {
                        *puVar35 = *(undefined8*)( (long)pvVar7 + 0x18 );
                        ...
                        if (*(long*)( (long)pvVar7 + 0x20 ) != 0) {
                           *(undefined8*)( *(long*)( (long)pvVar7 + 0x20 ) + 0x18 ) = *(undefined8*)( (long)pvVar7 + 0x18 );
                        }

                        if (*(long*)( (long)pvVar7 + 0x18 ) != 0) {
                           *(undefined8*)( *(long*)( (long)pvVar7 + 0x18 ) + 0x20 ) = *(undefined8*)( (long)pvVar7 + 0x20 );
                        }
 ...
 while ( *(int*)( puVar35 + 2 ) != 0 );
               ...
               LAB_00100859:CowData<char32_t>::_unref((CowData<char32_t>*)( plVar40 + 2 ));
...
/* IP::get_resolve_item_address(int) const */undefined8 *IP::get_resolve_item_address(int param_1) {
...
;
 ...
 while ( puVar8 != (undefined8*)0x0 );
            LAB_00100b51:for (puVar8 = *(undefined8**)*pauVar4; puVar8 != (undefined8*)0x0; puVar8 = (undefined8*)puVar8[3]) {
               if (*(char*)( puVar8 + 2 ) != '\0') {
                  uVar2 = puVar8[1];
                  *puVar7 = *puVar8;
                  puVar7[1] = uVar2;
         ...
         IPAddress::clear();
         LAB_00100b80:List<IPAddress,DefaultAllocator>::~List((List<IPAddress,DefaultAllocator>*)&local_58);
      }
 else {
         local_60 = 0;
         if (*(long*)( *(long*)( in_RSI + 0x178 ) + 0x10 + lVar6 ) != 0) {
            CowData<char32_t>::_ref((CowData<char32_t>*)&local_60, (CowData*)( *(long*)( in_RSI + 0x178 ) + 0x10 + lVar6 ));
         }
         ...
         _err_print_error("get_resolve_item_address", "core/io/ip.cpp", 0xcc, (CowData<char32_t>*)&local_58, 0, 0);
      ...
      local_60 = 0;
      String::parse_latin1((String*)&local_60, "Too many concurrent DNS resolver queries (%d, but should be %d at most). Try performing less network requests at once.");
      vformat<int,IP::_unnamed_type_1_>((CowData<char32_t>*)&local_58, (String*)&local_60, in_EDX, 0x100);
      _err_print_index_error("get_resolve_item_address", "core/io/ip.cpp", 199, (long)(int)in_EDX, 0x100, "p_id", "IP::RESOLVER_MAX_QUERIES", (String*)&local_58, false, false);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
      IPAddress::clear();
   }
...
/* IP::get_resolve_item_addresses(int) const */Array *IP::get_resolve_item_addresses(int param_1) {
   pthread_mutex_t *__mutex;
   long *plVar1;
   undefined8 uVar2;
   int iVar3;
...
;
 ...
 while ( puVar7 != (undefined8*)0x0 );
            LAB_00100e61:Array::Array((Array*)&local_70);
...
;
         ...
         LAB_00100ee2:Array::Array(this, (Array*)&local_70);
         Array::~Array((Array*)&local_70);
         ...
         local_70 = 0;
         if (*(long*)( *(long*)( in_RSI + 0x178 ) + 0x10 + lVar6 ) != 0) {
            CowData<char32_t>::_ref((CowData<char32_t>*)&local_70, (CowData*)( *(long*)( in_RSI + 0x178 ) + 0x10 + lVar6 ));
         }
         ...
         _err_print_error("get_resolve_item_addresses", "core/io/ip.cpp", 0xdf, (CowData<char32_t>*)&local_68, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
      ...
      local_70 = 0;
      String::parse_latin1((String*)&local_70, "Too many concurrent DNS resolver queries (%d, but should be %d at most). Try performing less network requests at once.");
      vformat<int,IP::_unnamed_type_1_>((CowData<char32_t>*)&local_68, (String*)&local_70, in_EDX, 0x100);
      _err_print_index_error("get_resolve_item_addresses", "core/io/ip.cpp", 0xdb, (long)(int)in_EDX, 0x100, "p_id", "IP::RESOLVER_MAX_QUERIES", (String*)&local_68, false, false);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_70);
      Array::Array(this);
   }
...
/* IP::_get_local_interfaces() const */Array *IP::_get_local_interfaces(void) {
   char cVar1;
   uint uVar2;
   IPAddress *pIVar3;
   void *pvVar4;
   ...
   if ((long*)local_90._0_8_ != (long*)0x0) {
      ...
      do {
         ...
         if ((undefined8*)plVar8[6] != (undefined8*)0x0) {
            for (pIVar3 = *(IPAddress**)plVar8[6]; pIVar3 != (IPAddress*)0x0; pIVar3 = *(IPAddress**)( pIVar3 + 0x18 )) {
                        ...
                        if (puVar6 == *(undefined8**)( (long)pvVar4 + 0x28 )) {
                           *puVar6 = *(undefined8*)( (long)pvVar4 + 0x18 );
                           ...
                           if (*(long*)( (long)pvVar4 + 0x20 ) != 0) {
                              *(undefined8*)( *(long*)( (long)pvVar4 + 0x20 ) + 0x18 ) = *(undefined8*)( (long)pvVar4 + 0x18 );
                           }

                           if (*(long*)( (long)pvVar4 + 0x18 ) != 0) {
                              *(undefined8*)( *(long*)( (long)pvVar4 + 0x18 ) + 0x20 ) = *(undefined8*)( (long)pvVar4 + 0x20 );
                           }
 ...
 while ( *(int*)( puVar6 + 2 ) != 0 );
                  ...
                  LAB_00101452:CowData<char32_t>::_unref((CowData<char32_t>*)( (long)pvVar7 + 0x28 ));
                  for (int i = 0; i < 3; i++) {
                     CowData<char32_t>::_unref((CowData<char32_t>*)( (long)pvVar7 + ( -8*i + 32 ) ));
                  }
...
/* IP::~IP() */void IP::~IP(IP *this) {
 ...
 while ( *(int*)( puVar9 + 2 ) != 0 );
                  ...
                  LAB_0010180c:CowData<char32_t>::_unref((CowData<char32_t>*)( (long)pvVar6 + 0x10 ));
 ...
 while ( (ulong)uVar2 << 2 != lVar8 );
   ...
   LAB_0010185b:Thread::~Thread((Thread*)( (long)pvVar3 + 0x2088 ));
   ...
   if (iVar5 == 0) {
      ...
      std::condition_variable::~condition_variable((condition_variable*)( (long)pvVar3 + 0x2050 ));
      LAB_001018c0:if (*(long*)( (long)pvVar6 + 0x10 ) != 0) {
         LOCK();
      ...
      do {
         ...
         do {
            if (puVar9 == (undefined8*)0x0) {
               joined_r0x001019e8:if (pvVar6 == pvVar3) {
                  Memory::free_static(pvVar6, false);
                  Object::~Object((Object*)this);
                  return;
               }
 ...
 while ( true );
   ...
   LAB_00101adb:/* WARNING: Subroutine does not return */std::__throw_system_error(iVar5);
}
/* IP::~IP() */void IP::~IP(IP *this) {
   ~IP(this)
   ;;
...
/* IP::get_local_addresses(List<IPAddress, DefaultAllocator>*) const */void IP::get_local_addresses(IP *this, List *param_1) {
   uint uVar1;
   undefined8 uVar2;
   long *plVar3;
   void *pvVar4;
   ...
   uVar5 = local_40;
   for (puVar8 = (undefined8*)local_50._0_8_; local_40 = uVar5,puVar8 != (undefined8*)0x0; puVar8 = (undefined8*)*puVar8) {
      if (( (long*)puVar8[6] != (long*)0x0 ) && ( puVar11 = *(undefined8**)puVar8[6] ),puVar11 != (undefined8*)0x0) {
         if (*(long*)param_1 == 0) {
...
;
 ...
 while ( *(int*)( puVar8 + 2 ) != 0 );
                  ...
                  LAB_00101d15:CowData<char32_t>::_unref((CowData<char32_t>*)( (long)pvVar10 + 0x28 ));
                  for (int i = 0; i < 3; i++) {
                     CowData<char32_t>::_unref((CowData<char32_t>*)( (long)pvVar10 + ( -8*i + 32 ) ));
                  }
 ...
 while ( lVar9 != (ulong)uVar1 * 4 );
   ...
   LAB_00101d77:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* IP::resolve_hostname_queue_item(String const&, IP::Type) */int IP::resolve_hostname_queue_item(IP *this, CowData *param_1, undefined4 param_3) {
   pthread_mutex_t *__mutex;
   uint uVar1;
   long lVar2;
   void *pvVar3;
 ...
 while ( iVar14 != 0x100 );
   ...
   while (true) {
      ...
      if (( uVar16 == 0 ) || ( auVar7._8_8_ = 0 ),auVar7._0_8_ = (ulong)uVar16 * lVar4,auVar11._8_8_ = 0,auVar11._0_8_ = uVar26,auVar8._8_8_ = 0,auVar8._0_8_ = ( ulong )(( uVar1 + iVar15 ) - SUB164(auVar7 * auVar11, 8)) * lVar4,auVar12._8_8_ = 0,auVar12._0_8_ = uVar26,SUB164(auVar8 * auVar12, 8) < uVar22) break;
      LAB_00102107:if (uVar16 == uVar20) {
         cVar13 = String::operator ==((String*)( *(long*)( *(long*)( lVar24 + 0x20a8 ) + lVar21 * 8 ) + 0x10 ), local_50);
         if (cVar13 != '\0') {
            pLVar19 = (List*)HashMap<String,List<IPAddress,DefaultAllocator>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,List<IPAddress,DefaultAllocator>>>>::operator []((HashMap<String,List<IPAddress,DefaultAllocator>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,List<IPAddress,DefaultAllocator>>>>*)( *(long*)( this + 0x178 ) + 0x20a0 ), local_50);
            List<IPAddress,DefaultAllocator>::operator =((List<IPAddress,DefaultAllocator>*)( *(long*)( this + 0x178 ) + 8 + lVar18 ), pLVar19);
...
;
   LAB_00102209:lVar24 = *(long*)( this + 0x178 );
   LAB_00101f39:local_48 = 0;
 ...
 while ( *(int*)( puVar23 + 2 ) != 0 );
   ...
   LAB_00101fbb:*(undefined8*)( lVar24 + 8 ) = 0;
   ...
   *(undefined4*)( *(long*)( this + 0x178 ) + lVar18 ) = 1;
   ...
   LAB_00102188:CowData<char32_t>::_unref((CowData<char32_t>*)local_50);
   LAB_00102192:pthread_mutex_unlock((pthread_mutex_t*)( lVar2 + 0x2000 ));
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* IP::clear_cache(String const&) */void IP::clear_cache(IP *this, String *param_1) {
   uint uVar1;
   long lVar2;
   long lVar3;
   void *pvVar4;
                        ...
                        if (puVar8 == *(undefined8**)( (long)pvVar5 + 0x28 )) {
                           *puVar8 = *(undefined8*)( (long)pvVar5 + 0x18 );
                           ...
                           if (*(long*)( (long)pvVar5 + 0x20 ) != 0) {
                              *(undefined8*)( *(long*)( (long)pvVar5 + 0x20 ) + 0x18 ) = *(undefined8*)( (long)pvVar5 + 0x18 );
                           }

                           if (*(long*)( (long)pvVar5 + 0x18 ) != 0) {
                              *(undefined8*)( *(long*)( (long)pvVar5 + 0x18 ) + 0x20 ) = *(undefined8*)( (long)pvVar5 + 0x20 );
                           }
 ...
 while ( *(int*)( puVar8 + 2 ) != 0 );
                  ...
                  LAB_001023a3:CowData<char32_t>::_unref((CowData<char32_t>*)( (long)pvVar4 + 0x10 ));
                  Memory::free_static(pvVar4, false);
 ...
 while ( lVar9 != (ulong)uVar1 << 2 );
      ...
      HashMap<String,List<IPAddress,DefaultAllocator>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,List<IPAddress,DefaultAllocator>>>>::erase((HashMap<String,List<IPAddress,DefaultAllocator>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,List<IPAddress,DefaultAllocator>>>>*)( lVar3 + 0x20a0 ), local_50);
...
/* IP::_bind_methods() */void IP::_bind_methods(void) {
   char cVar1;
   long lVar2;
   code *pcVar3;
   long *plVar4;
 ...
 while ( lVar2 != lVar6 );
   ...
   GetTypeInfo<IP::ResolverStatus,void>::get_class_info((GetTypeInfo<IP::ResolverStatus,void>*)&local_108);
   local_118 = local_f8;
   local_f8 = (long*)0x0;
   ...
   ClassDB::bind_integer_constant((StringName*)&local_110, (StringName*)&local_118, (StringName*)&local_108, 0x100, false);
   if (( StringName::configured != '\0' ) && ( local_110 != 0 )) {
      StringName::unref();
   }

   CowData<char32_t>::_unref((CowData<char32_t>*)&local_120);
   if (( StringName::configured != '\0' ) && ( ( ( local_118 == (long*)0x0 || ( StringName::unref(),StringName::configured != '\0' ) ) && ( local_108 != 0 ) ) )) {
      StringName::unref();
   }
   ...
   String::parse_latin1((String*)&local_120, "IP");
   StringName::StringName((StringName*)&local_110, (String*)&local_120, false);
   ClassDB::bind_integer_constant((StringName*)&local_110, (StringName*)&local_118, (StringName*)&local_108, -1, false);
   if (( StringName::configured != '\0' ) && ( local_110 != 0 )) {
      StringName::unref();
   }
...
/* IP::resolve_hostname_addresses(String const&, IP::Type) */Vector<String> *IP::resolve_hostname_addresses(Vector<String> *param_1, long *param_2, undefined8 param_3, undefined4 param_4) {
   long *plVar1;
   uint uVar2;
   long lVar3;
   void *pvVar4;
   ...
   if (iVar15 == 0) {
      ...
      if (( *(long*)( lVar3 + 0x20a8 ) != 0 ) && ( *(int*)( lVar3 + 0x20cc ) != 0 )) {
         ...
         if (uVar16 != 0) {
            ...
            do {
               if (uVar16 == uVar18) {
                  cVar14 = String::operator ==((String*)( *(long*)( *(long*)( lVar3 + 0x20a8 ) + lVar19 * 8 ) + 0x10 ), local_50);
                  if (cVar14 != '\0') {
                     pLVar17 = (List*)HashMap<String,List<IPAddress,DefaultAllocator>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,List<IPAddress,DefaultAllocator>>>>::operator []((HashMap<String,List<IPAddress,DefaultAllocator>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,List<IPAddress,DefaultAllocator>>>>*)( param_2[0x2f] + 0x20a0 ), local_50);
                     List<IPAddress,DefaultAllocator>::operator =((List<IPAddress,DefaultAllocator>*)&local_58, pLVar17);
                     goto LAB_0010407f;
                  }
 ...
 while ( ( uVar16 != 0 ) && ( auVar8._8_8_ = 0 ),auVar8._0_8_ = (ulong)uVar16 * lVar5,auVar12._8_8_ = 0,auVar12._0_8_ = uVar22,auVar9._8_8_ = 0,auVar9._0_8_ = ( ulong )(( uVar2 + iVar15 ) - SUB164(auVar8 * auVar12, 8)) * lVar5,auVar13._8_8_ = 0,auVar13._0_8_ = uVar22,uVar20 <= SUB164(auVar9 * auVar13, 8) );
         }
      ...
      if (iVar15 == 0) {
         ...
         LAB_0010407f:pthread_mutex_unlock(__mutex);
 ...
 while ( (int)local_58[2] != 0 );
         ...
         LAB_00104170:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            return param_1;
         }
...
/* IP::resolve_hostname(String const&, IP::Type) */IPAddress *IP::resolve_hostname(IPAddress *param_1) {
   long lVar1;
   code *pcVar2;
   long in_FS_OFFSET;
   ...
   if (( local_20[0] == (String*)0x0 ) || ( lVar1 = lVar1 == 0 )) {
      IPAddress::clear();
   }
 else {
      if (lVar1 < 1) {
...
/* WARNING: Removing unreachable block (ram,0x00104514) *//* WARNING: Removing unreachable block (ram,0x001045a0) *//* WARNING: Removing unreachable block (ram,0x001045a7) *//* WARNING: Removing unreachable block (ram,0x00104521) *//* WARNING: Removing unreachable block (ram,0x001045e0) *//* WARNING: Removing unreachable block (ram,0x0010452b) *//* WARNING: Removing unreachable block (ram,0x001045d0) *//* WARNING: Removing unreachable block (ram,0x0010453d) *//* WARNING: Removing unreachable block (ram,0x00104546) *//* WARNING: Removing unreachable block (ram,0x0010454e) *//* WARNING: Removing unreachable block (ram,0x00104557) *//* WARNING: Removing unreachable block (ram,0x0010455f) *//* WARNING: Removing unreachable block (ram,0x0010456a) *//* WARNING: Removing unreachable block (ram,0x00104576) *//* WARNING: Removing unreachable block (ram,0x001044b0) *//* WARNING: Removing unreachable block (ram,0x001044b9) *//* WARNING: Removing unreachable block (ram,0x001044c0) *//* WARNING: Removing unreachable block (ram,0x001044e0) *//* WARNING: Removing unreachable block (ram,0x001044e8) *//* WARNING: Removing unreachable block (ram,0x00104501) *//* WARNING: Removing unreachable block (ram,0x0010450a) *//* WARNING: Removing unreachable block (ram,0x0010450f) *//* IP::_get_local_addresses() const */void IP::_get_local_addresses(void) {
   long lVar1;
   long lVar2;
   long *in_RSI;
   long in_RDI;
...
/* IP::is_class_ptr(void*) const */uint IP::is_class_ptr(IP *this, void *param_1) {
   return (uint)CONCAT71(0x10f8, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10f8, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr);
}
/* IP::_getv(StringName const&, Variant&) const */undefined8 IP::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* IP::_setv(StringName const&, Variant const&) */undefined8 IP::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* IP::_validate_propertyv(PropertyInfo&) const */void IP::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* IP::_property_can_revertv(StringName const&) const */undefined8 IP::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* IP::_property_get_revertv(StringName const&, Variant&) const */undefined8 IP::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* IP::_notificationv(int, bool) */void IP::_notificationv(int param_1, bool param_2) {
   return;
}
...
/* MethodBindTRC<TypedArray<Dictionary>>::_gen_argument_type(int) const */undefined8 MethodBindTRC<TypedArray<Dictionary>>::_gen_argument_type(int param_1) {
   return 0x1c;
}
/* MethodBindTRC<TypedArray<Dictionary>>::get_argument_meta(int) const */undefined8 MethodBindTRC<TypedArray<Dictionary>>::get_argument_meta(int param_1) {
   return 0;
}
...
/* MethodBindTRC<IP::ResolverStatus, int>::_gen_argument_type(int) const */undefined8 MethodBindTRC<IP::ResolverStatus,int>::_gen_argument_type(int param_1) {
   return 2;
}
/* MethodBindTRC<IP::ResolverStatus, int>::get_argument_meta(int) const */byte MethodBindTRC<IP::ResolverStatus,int>::get_argument_meta(MethodBindTRC<IP::ResolverStatus,int> *this, int param_1) {
   return -(param_1 == 0) & 3;
}
/* MethodBindTR<int, String const&, IP::Type>::_gen_argument_type(int) const */char MethodBindTR<int,String_const&,IP::Type>::_gen_argument_type(MethodBindTR<int,String_const&,IP::Type> *this, int param_1) {
   return ( -(param_1 == 0) & 2U ) + 2;
}
/* MethodBindTR<int, String const&, IP::Type>::get_argument_meta(int) const */uint MethodBindTR<int,String_const&,IP::Type>::get_argument_meta(MethodBindTR<int,String_const&,IP::Type> *this, int param_1) {
   return param_1 >> 0x1f & 3;
}
/* MethodBindTR<Vector<String>, String const&, IP::Type>::_gen_argument_type(int) const */char MethodBindTR<Vector<String>,String_const&,IP::Type>::_gen_argument_type(MethodBindTR<Vector<String>,String_const&,IP::Type> *this, int param_1) {
   char cVar1;
   cVar1 = '\"';
   if ((uint)param_1 < 2) {
...
/* MethodBindTR<Vector<String>, String const&, IP::Type>::get_argument_meta(int) const */undefined8 MethodBindTR<Vector<String>,String_const&,IP::Type>::get_argument_meta(int param_1) {
   return 0;
}
/* MethodBindTR<IPAddress, String const&, IP::Type>::_gen_argument_type(int) const */char MethodBindTR<IPAddress,String_const&,IP::Type>::_gen_argument_type(MethodBindTR<IPAddress,String_const&,IP::Type> *this, int param_1) {
   return ( param_1 != 1 ) * '\x02' + '\x02';
}
/* MethodBindTR<IPAddress, String const&, IP::Type>::get_argument_meta(int) const */undefined8 MethodBindTR<IPAddress,String_const&,IP::Type>::get_argument_meta(int param_1) {
   return 0;
}
/* MethodBindTR<IPAddress, String const&, IP::Type>::~MethodBindTR() */void MethodBindTR<IPAddress,String_const&,IP::Type>::~MethodBindTR(MethodBindTR<IPAddress,String_const&,IP::Type> *this) {
...
/* MethodBindTR<Vector<String>, String const&, IP::Type>::~MethodBindTR() */void MethodBindTR<Vector<String>,String_const&,IP::Type>::~MethodBindTR(MethodBindTR<Vector<String>,String_const&,IP::Type> *this) {
...
/* MethodBindTR<int, String const&, IP::Type>::~MethodBindTR() */void MethodBindTR<int,String_const&,IP::Type>::~MethodBindTR(MethodBindTR<int,String_const&,IP::Type> *this) {
...
/* MethodBindTRC<IP::ResolverStatus, int>::~MethodBindTRC() */void MethodBindTRC<IP::ResolverStatus,int>::~MethodBindTRC(MethodBindTRC<IP::ResolverStatus,int> *this) {
...
/* MethodBindTRC<TypedArray<Dictionary>>::~MethodBindTRC() */void MethodBindTRC<TypedArray<Dictionary>>::~MethodBindTRC(MethodBindTRC<TypedArray<Dictionary>> *this) {
...
/* IP::_get_class_namev() const */undefined8 *IP::_get_class_namev(void) {
   int iVar1;
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00104c03:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00104c03;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "IP");
         goto LAB_00104c6e;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "IP");
   LAB_00104c6e:return &_get_class_namev();
}
/* IP::get_class() const */void IP::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* List<IPAddress, DefaultAllocator>::~List() */undefined8 List<IPAddress,DefaultAllocator>::~List(List<IPAddress,DefaultAllocator> *this) {
   void *pvVar1;
   undefined8 uVar2;
   undefined8 *puVar3;
   ...
   do {
      ...
      if (pvVar1 == (void*)0x0) {
         if (*(int*)( puVar3 + 2 ) != 0) {
            uVar2 = _err_print_error("~List", "./core/templates/list.h", 0x316, "Condition \"_data->size_cache\" is true.", 0, 0);
            return uVar2;
         }
      ...
      if (*(undefined8**)( (long)pvVar1 + 0x28 ) == puVar3) {
         *puVar3 = *(undefined8*)( (long)pvVar1 + 0x18 );
         ...
         if (*(long*)( (long)pvVar1 + 0x20 ) != 0) {
            *(undefined8*)( *(long*)( (long)pvVar1 + 0x20 ) + 0x18 ) = *(undefined8*)( (long)pvVar1 + 0x18 );
         }

         if (*(long*)( (long)pvVar1 + 0x18 ) != 0) {
            *(undefined8*)( *(long*)( (long)pvVar1 + 0x18 ) + 0x20 ) = *(undefined8*)( (long)pvVar1 + 0x20 );
         }
...
/* List<IPAddress, DefaultAllocator>::TEMPNAMEPLACEHOLDERVALUE(List<IPAddress, DefaultAllocator>
   const&) */void List<IPAddress,DefaultAllocator>::operator =(List<IPAddress,DefaultAllocator> *this, List *param_1) {
   void *pvVar1;
   long lVar2;
   long *plVar3;
   undefined8 uVar4;
 ...
 while ( *(int*)( puVar6 + 2 ) != 0 );
   ...
   LAB_001054b0:if (( *(long**)param_1 != (long*)0x0 ) && ( puVar7 = (undefined8*)**(long**)param_1 ),puVar7 != (undefined8*)0x0) {
      if (puVar6 == (undefined8*)0x0) {
...
/* MethodBindTRC<TypedArray<Dictionary>>::_gen_argument_type_info(int) const */undefined4 *MethodBindTRC<TypedArray<Dictionary>>::_gen_argument_type_info(int param_1) {
   undefined4 in_register_0000003c;
   undefined4 *puVar1;
   long in_FS_OFFSET;
   undefined8 local_50;
   ...
   *(undefined1(*) [16])( puVar1 + 2 ) = (undefined1[16])0x0;
   ...
   LAB_001056f5:CowData<char32_t>::_unref((CowData<char32_t>*)&local_50);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_48);
...
/* WARNING: Removing unreachable block (ram,0x00105940) *//* String vformat<int, IP::{unnamed type#1}>(IP::{unnamed type#1} const&, int const, IP::{unnamed
   type#1} const) */undefined8 *vformat<int,IP::_unnamed_type_1_>(undefined8 *param_1, bool *param_2, int param_3, int param_4) {
   Variant *pVVar1;
   Variant *pVVar2;
   int iVar3;
   long in_FS_OFFSET;
...
/* WARNING: Removing unreachable block (ram,0x00105bf8) *//* String vformat<String>(String const&, String const) */undefined8 *vformat<String>(undefined8 *param_1, bool *param_2, String *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<String, List<IPAddress, DefaultAllocator>, HashMapHasherDefault,
 ...
 while ( uVar48 != uVar41 );
      ...
      LAB_00106405:iVar45 = *(int*)( this + 0x2c );
      if (iVar45 != 0) {
         LAB_00106415:uVar39 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
         ...
         if (uVar51 != 0) {
            do {
               if (uVar51 == uVar40) {
                  ...
                  if (cVar38 != '\0') {
                     List<IPAddress,DefaultAllocator>::operator =((List<IPAddress,DefaultAllocator>*)( *(long*)( *(long*)( this + 8 ) + (ulong)uVar50 * 8 ) + 0x18 ), (List*)&local_70);
 ...
 while ( ( uVar51 != 0 ) && ( auVar19._8_8_ = 0 ),auVar19._0_8_ = (ulong)uVar51 * lVar4,auVar35._8_8_ = 0,auVar35._0_8_ = uVar41,auVar20._8_8_ = 0,auVar20._0_8_ = ( ulong )(( uVar39 + uVar50 ) - SUB164(auVar19 * auVar35, 8)) * lVar4,auVar36._8_8_ = 0,auVar36._0_8_ = uVar41,uVar54 <= SUB164(auVar20 * auVar36, 8) );
   ...
   LAB_00105f0d:uVar55 = *(uint*)( this + 0x28 );
   if (uVar55 == 0x1c) {
...
;
 ...
 while ( ( uVar40 != 0 ) && ( auVar15._8_8_ = 0 ),auVar15._0_8_ = (ulong)uVar40 * lVar4,auVar31._8_8_ = 0,auVar31._0_8_ = uVar41,auVar16._8_8_ = 0,auVar16._0_8_ = ( ulong )(( uVar51 + uVar55 ) - SUB164(auVar15 * auVar31, 8)) * lVar4,auVar32._8_8_ = 0,auVar32._0_8_ = uVar41,uVar50 <= SUB164(auVar16 * auVar32, 8) );
   ...
   uVar48 = (ulong)uVar55;
   iVar45 = 0;
   LAB_00105ee7:if ((float)uVar48 * __LC30 < (float)( iVar45 + 1 )) goto LAB_00105f0d;
}
...
*(undefined8*)( pauVar43[1] + 8 ) = 0;List<IPAddress,DefaultAllocator>::~List((List<IPAddress,DefaultAllocator>*)local_50);CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);puVar2 = *(undefined8**)( this + 0x20 );if (puVar2 == (undefined8*)0x0) {
...
;*(undefined1(**) [16])( lVar46 + lVar47 * 8 ) = pauVar37;*puVar1 = uVar55;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_001062b5:List<IPAddress,DefaultAllocator>::~List((List<IPAddress,DefaultAllocator>*)&local_70);LAB_001062c1:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return pauVar43[1] + 8;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* IP::is_class(String const&) const */undefined8 IP::is_class(IP *this, String *param_1) {
   long *plVar1;
   long lVar2;
   long lVar3;
   char *pcVar4;
 ...
 while ( !bVar9 );
      ...
      LAB_0010674f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar5 = local_60;
      if (local_60 != 0) {
         LOCK();
   ...
   if (cVar6 == '\0') {
      ...
      LAB_00106803:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* MethodBindTRC<Vector<String>>::_gen_argument_type_info(int) const */undefined4 *MethodBindTRC<Vector<String>>::_gen_argument_type_info(int param_1) {
   ...
   *(undefined1(*) [16])( puVar1 + 2 ) = (undefined1[16])0x0;
   ...
   LAB_001070b5:CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
...
/* IP::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void IP::_get_property_listv(List *param_1, bool param_2) {
   long *plVar1;
   long lVar2;
...
/* MethodBindT<int>::_gen_argument_type_info(int) const */undefined4 *MethodBindT<int>::_gen_argument_type_info(int param_1) {
   ...
   *puVar5 = local_68._0_4_;
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)local_60);
   LAB_001074d9:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* MethodBind* create_method_bind<IP, IPAddress, String const&, IP::Type>(IPAddress (IP::*)(String
   const&, IP::Type)) */MethodBind *create_method_bind<IP,IPAddress,String_const&,IP::Type>(_func_IPAddress_String_ptr_Type *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<IP, Vector<String>, String const&, IP::Type>(Vector<String>
   (IP::*)(String const&, IP::Type)) */MethodBind *create_method_bind<IP,Vector<String>,String_const&,IP::Type>(_func_Vector_String_ptr_Type *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<IP, int, String const&, IP::Type>(int (IP::*)(String const&,
   IP::Type)) */MethodBind *create_method_bind<IP,int,String_const&,IP::Type>(_func_int_String_ptr_Type *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<IP, IP::ResolverStatus, int>(IP::ResolverStatus (IP::*)(int)
   const) */MethodBind *create_method_bind<IP,IP::ResolverStatus,int>(_func_ResolverStatus_int *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<IP, IPAddress, int>(IPAddress (IP::*)(int) const) */MethodBind *create_method_bind<IP,IPAddress,int>(_func_IPAddress_int *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<IP, Array, int>(Array (IP::*)(int) const) */MethodBind *create_method_bind<IP,Array,int>(_func_Array_int *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<IP, int>(void (IP::*)(int)) */MethodBind *create_method_bind<IP,int>(_func_void_int *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<IP, Vector<String>>(Vector<String> (IP::*)() const) */MethodBind *create_method_bind<IP,Vector<String>>(_func_Vector *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<IP, TypedArray<Dictionary>>(TypedArray<Dictionary> (IP::*)()
   const) */MethodBind *create_method_bind<IP,TypedArray<Dictionary>>(_func_TypedArray *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<IP, String const&>(void (IP::*)(String const&)) */MethodBind *create_method_bind<IP,String_const&>(_func_void_String_ptr *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
godot::details::enum_qualified_name_to_class_info_name(details *this,String *param_1){
   ...
   String::join(this);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
   LAB_00108464:CowData<String>::_unref((CowData<String>*)&local_50);
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return this;
   }
...
/* IP::_bind_methods() [clone .cold] */void IP::_bind_methods(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* GetTypeInfo<IP::Type, void>::get_class_info() */GetTypeInfo<IP::Type,void> * __thiscall
GetTypeInfo<IP::Type,void>::get_class_info(GetTypeInfo<IP::Type,void> *this){
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_70);
   LAB_001086b5:CowData<String>::_unref((CowData<String>*)&local_60);
...
/* GetTypeInfo<IP::ResolverStatus, void>::get_class_info() */GetTypeInfo<IP::ResolverStatus,void> * __thiscall
GetTypeInfo<IP::ResolverStatus,void>::get_class_info(GetTypeInfo<IP::ResolverStatus,void> *this){
   ...
   String::join(local_78);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_70);
   LAB_00108935:CowData<String>::_unref((CowData<String>*)&local_60);
   StringName::StringName((StringName*)&local_58, (String*)local_78, false);
   *(undefined4*)this = 2;
   *(undefined4*)( this + 0x18 ) = 0;
   *(undefined8*)( this + 0x20 ) = 0;
...
/* IP::_initialize_classv() */void IP::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_60;
   undefined8 local_58;
   long local_50;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<String>::resize<false>(long) */undefined8 CowData<String>::resize<false>(CowData<String> *this, long param_1) {
   ...
   if (param_1 * 8 == 0) {
      LAB_00108f90:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (lVar9 == lVar5) {
      LAB_00108f0b:puVar7 = *(undefined8**)this;
      if (puVar7 == (undefined8*)0x0) {
         LAB_00108fe6:/* WARNING: Does not return */pcVar1 = (code*)invalidInstructionException();
         ( *pcVar1 )();
      }
   ...
   LAB_00108e7f:puVar7[-1] = param_1;
   return 0;
}
/* WARNING: Removing unreachable block (ram,0x00109118) *//* String vformat<StringName>(String const&, StringName const) */undefined8 *vformat<StringName>(undefined8 *param_1, bool *param_2, StringName *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* MethodBindT<String const&>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<String_const&>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   LAB_001095a1:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<String const&>::ptrcall(Object*, void const**, void*) const */void MethodBindT<String_const&>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   ...
   LAB_00109781:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindTRC<TypedArray<Dictionary>>::call(Object*, Variant const**, int, Callable::CallError&)
   const */Object *MethodBindTRC<TypedArray<Dictionary>>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   Variant *pVVar1;
   Variant *pVVar2;
   long *plVar3;
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (( ( plVar4 != (long*)0x0 ) && ( plVar4[1] != 0 ) ) && ( *(char*)( plVar4[1] + 0x2e ) != '\0' )) {
      ...
      if (local_58 == (char*)*plVar3) {
         ...
         _err_print_error(&_LC90, "./core/object/method_bind.h", 0x267, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: ret", (StringName*)&local_58, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
         if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
            StringName::unref();
   ...
   LAB_001098f0:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTRC<Vector<String>>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindTRC<Vector<String>>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   ...
   LAB_00109b90:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTRC<Vector<String>>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTRC<Vector<String>>::validated_call(MethodBindTRC<Vector<String>> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   LAB_00109dd7:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<Vector<String>>::ptrcall(Object*, void const**, void*) const */void MethodBindTRC<Vector<String>>::ptrcall(MethodBindTRC<Vector<String>> *this, Object *param_1, void **param_2, void *param_3) {
   ...
   CowData<String>::_unref((CowData<String>*)local_40);
   LAB_00109fb3:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindT<int>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<int>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   LAB_0010a2e1:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<int>::ptrcall(Object*, void const**, void*) const */void MethodBindT<int>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   ...
   LAB_0010a4c1:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindTRC<Array, int>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTRC<Array,int>::validated_call(MethodBindTRC<Array,int> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   LAB_0010a52f:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<Array, int>::ptrcall(Object*, void const**, void*) const */void MethodBindTRC<Array,int>::ptrcall(MethodBindTRC<Array,int> *this, Object *param_1, void **param_2, void *param_3) {
   ...
   Array::~Array((Array*)&local_48);
   LAB_0010a71d:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<IPAddress, int>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTRC<IPAddress,int>::validated_call(MethodBindTRC<IPAddress,int> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   char *pcVar1;
   code *pcVar2;
   long *plVar3;
   long in_FS_OFFSET;
   ...
   if (( ( param_1 != (Object*)0x0 ) && ( *(long*)( param_1 + 8 ) != 0 ) ) && ( *(char*)( *(long*)( param_1 + 8 ) + 0x2e ) != '\0' )) {
      ...
      if (local_78 == (char*)*plVar3) {
         ...
         _err_print_error("validated_call", "./core/object/method_bind.h", 0x273, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true.", (IPAddress*)&local_78, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_78);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_80);
         if (( StringName::configured != '\0' ) && ( local_88 != 0 )) {
            StringName::unref();
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_78);
   LAB_0010a957:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<IPAddress, int>::ptrcall(Object*, void const**, void*) const */void MethodBindTRC<IPAddress,int>::ptrcall(MethodBindTRC<IPAddress,int> *this, Object *param_1, void **param_2, void *param_3) {
   char *pcVar1;
   code *pcVar2;
   long *plVar3;
   long in_FS_OFFSET;
   ...
   if (( ( param_1 != (Object*)0x0 ) && ( *(long*)( param_1 + 8 ) != 0 ) ) && ( *(char*)( *(long*)( param_1 + 8 ) + 0x2e ) != '\0' )) {
      ...
      if (local_58 == (char*)*plVar3) {
         ...
         _err_print_error("ptrcall", "./core/object/method_bind.h", 0x27e, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true.", (IPAddress*)&local_58, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
         if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
            StringName::unref();
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
   LAB_0010ab6f:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<IP::ResolverStatus, int>::validated_call(Object*, Variant const**, Variant*) const
    */void MethodBindTRC<IP::ResolverStatus,int>::validated_call(MethodBindTRC<IP::ResolverStatus,int> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   uint uVar1;
   code *pcVar2;
   long *plVar3;
   long in_FS_OFFSET;
   ...
   *(ulong*)( param_3 + 8 ) = (ulong)uVar1;
   LAB_0010ad3b:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<IP::ResolverStatus, int>::ptrcall(Object*, void const**, void*) const */void MethodBindTRC<IP::ResolverStatus,int>::ptrcall(MethodBindTRC<IP::ResolverStatus,int> *this, Object *param_1, void **param_2, void *param_3) {
   uint uVar1;
   code *pcVar2;
   long *plVar3;
   long in_FS_OFFSET;
   ...
   *(ulong*)param_3 = (ulong)uVar1;
   LAB_0010af1a:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTR<int, String const&, IP::Type>::validated_call(Object*, Variant const**, Variant*)
   const */void MethodBindTR<int,String_const&,IP::Type>::validated_call(MethodBindTR<int,String_const&,IP::Type> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   int iVar1;
   code *pcVar2;
   long *plVar3;
   long in_FS_OFFSET;
   ...
   *(long*)( param_3 + 8 ) = (long)iVar1;
   LAB_0010b102:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTR<int, String const&, IP::Type>::ptrcall(Object*, void const**, void*) const */void MethodBindTR<int,String_const&,IP::Type>::ptrcall(MethodBindTR<int,String_const&,IP::Type> *this, Object *param_1, void **param_2, void *param_3) {
   int iVar1;
   code *pcVar2;
   long *plVar3;
   long in_FS_OFFSET;
   ...
   *(long*)param_3 = (long)iVar1;
   LAB_0010b2dc:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTR<Vector<String>, String const&, IP::Type>::validated_call(Object*, Variant const**,
   Variant*) const */void MethodBindTR<Vector<String>,String_const&,IP::Type>::validated_call(MethodBindTR<Vector<String>,String_const&,IP::Type> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   code *pcVar1;
   long *plVar2;
   long in_FS_OFFSET;
   long local_58;
   ...
   ( *pcVar1 )((StringName*)&local_48, param_1 + *(long*)( this + 0x60 ), *param_2 + 8, *(undefined4*)( param_2[1] + 8 ));
   if (*(long*)( *(long*)( param_3 + 8 ) + 0x18 ) != local_40[0]) {
      CowData<String>::_ref((CowData<String>*)( *(long*)( param_3 + 8 ) + 0x18 ), (CowData*)local_40);
   }

   CowData<String>::_unref((CowData<String>*)local_40);
   LAB_0010b4f3:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTR<Vector<String>, String const&, IP::Type>::ptrcall(Object*, void const**, void*)
   const */void MethodBindTR<Vector<String>,String_const&,IP::Type>::ptrcall(MethodBindTR<Vector<String>,String_const&,IP::Type> *this, Object *param_1, void **param_2, void *param_3) {
   code *pcVar1;
   long *plVar2;
   long in_FS_OFFSET;
   long local_58;
   ...
   CowData<String>::_unref((CowData<String>*)local_40);
   LAB_0010b6ec:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTR<IPAddress, String const&, IP::Type>::validated_call(Object*, Variant const**,
   Variant*) const */void MethodBindTR<IPAddress,String_const&,IP::Type>::validated_call(MethodBindTR<IPAddress,String_const&,IP::Type> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   char *pcVar1;
   code *pcVar2;
   long *plVar3;
   long in_FS_OFFSET;
   ...
   if (( ( param_1 != (Object*)0x0 ) && ( *(long*)( param_1 + 8 ) != 0 ) ) && ( *(char*)( *(long*)( param_1 + 8 ) + 0x2e ) != '\0' )) {
      ...
      if (local_78 == (char*)*plVar3) {
         ...
         String::parse_latin1((StrRange*)&local_80);
         vformat<StringName>((IPAddress*)&local_78, (StrRange*)&local_80, &local_88);
         _err_print_error("validated_call", "./core/object/method_bind.h", 0x213, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true.", (IPAddress*)&local_78, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_78);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_80);
         if (( StringName::configured != '\0' ) && ( local_88 != 0 )) {
            StringName::unref();
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_78);
   LAB_0010b91f:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTR<IPAddress, String const&, IP::Type>::ptrcall(Object*, void const**, void*) const */void MethodBindTR<IPAddress,String_const&,IP::Type>::ptrcall(MethodBindTR<IPAddress,String_const&,IP::Type> *this, Object *param_1, void **param_2, void *param_3) {
   char *pcVar1;
   code *pcVar2;
   long *plVar3;
   long in_FS_OFFSET;
   ...
   if (( ( param_1 != (Object*)0x0 ) && ( *(long*)( param_1 + 8 ) != 0 ) ) && ( *(char*)( *(long*)( param_1 + 8 ) + 0x2e ) != '\0' )) {
      ...
      if (local_58 == (char*)*plVar3) {
         ...
         String::parse_latin1((StrRange*)&local_60);
         vformat<StringName>((IPAddress*)&local_58, (StrRange*)&local_60, &local_68);
         _err_print_error("ptrcall", "./core/object/method_bind.h", 0x21e, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true.", (IPAddress*)&local_58, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_60);
         if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
            StringName::unref();
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
   LAB_0010bb37:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<TypedArray<Dictionary>>::validated_call(Object*, Variant const**, Variant*) const
    */void MethodBindTRC<TypedArray<Dictionary>>::validated_call(MethodBindTRC<TypedArray<Dictionary>> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   code *pcVar1;
   long *plVar2;
   Variant **extraout_RDX;
   long in_FS_OFFSET;
   ...
   Array::operator =((Array*)( param_3 + 8 ), (Array*)&local_48);
   Array::~Array((Array*)&local_48);
   LAB_0010bd19:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<TypedArray<Dictionary>>::ptrcall(Object*, void const**, void*) const */void MethodBindTRC<TypedArray<Dictionary>>::ptrcall(MethodBindTRC<TypedArray<Dictionary>> *this, Object *param_1, void **param_2, void *param_3) {
   code *pcVar1;
   long *plVar2;
   void **extraout_RDX;
   long in_FS_OFFSET;
   ...
   Array::operator =((Array*)param_3, (Array*)&local_48);
   Array::~Array((Array*)&local_48);
   LAB_0010beea:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindT<String const&>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindT<String_const&>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   if (( ( plVar9 != (long*)0x0 ) && ( plVar9[1] != 0 ) ) && ( *(char*)( plVar9[1] + 0x2e ) != '\0' )) {
      ...
      if (local_48 == (char*)*plVar7) {
         ...
         String::parse_latin1((StrRange*)&local_50);
         vformat<StringName>((StringName*)&local_48, (StrRange*)&local_50, &local_58);
         _err_print_error(&_LC90, "./core/object/method_bind.h", 0x154, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: Variant()", (StringName*)&local_48, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_48);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_50);
         if (( StringName::configured != '\0' ) && ( local_58 != 0 )) {
            StringName::unref();
   ...
   if (in_R8D < 2) {
      ...
      if (pVVar10 == (Variant*)0x0) {
         ...
         LAB_0010c240:pVVar10 = *(Variant**)param_4;
      }
 else {
         lVar2 = *(long*)( pVVar10 + -8 );
         if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
            LAB_0010c250:uVar6 = 4;
            goto LAB_0010c1f5;
         }
      ...
      *in_R9 = 0;
      ...
      uVar6 = 3;
      LAB_0010c1f5:*in_R9 = uVar6;
      in_R9[2] = 1;
   }

   LAB_0010c200:*(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTRC<IP::ResolverStatus, int>::call(Object*, Variant const**, int, Callable::CallError&)
   const */Object *MethodBindTRC<IP::ResolverStatus,int>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   Variant *pVVar1;
   long lVar2;
   code *pcVar3;
   undefined8 uVar4;
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   ...
   if (in_R8D < 2) {
      ...
      if (pVVar11 == (Variant*)0x0) {
         ...
         LAB_0010c580:pVVar11 = *(Variant**)param_4;
      }
 else {
         lVar2 = *(long*)( pVVar11 + -8 );
         if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
            LAB_0010c590:uVar7 = 4;
            goto LAB_0010c545;
         }
      ...
      *(undefined8*)( param_1 + 0x10 ) = uStack_38;
      ...
      uVar7 = 3;
      LAB_0010c545:*in_R9 = uVar7;
      in_R9[2] = 1;
   }

   LAB_0010c550:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTRC<IPAddress, int>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindTRC<IPAddress,int>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   Variant *pVVar1;
   long lVar2;
   code *pcVar3;
   undefined8 uVar4;
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (( ( plVar10 != (long*)0x0 ) && ( plVar10[1] != 0 ) ) && ( *(char*)( plVar10[1] + 0x2e ) != '\0' )) {
      ...
      if (local_78 == (char*)*plVar8) {
         ...
         _err_print_error(&_LC90, "./core/object/method_bind.h", 0x267, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: ret", (StringName*)&local_78, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_78);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_80);
         if (( StringName::configured != '\0' ) && ( local_88 != 0 )) {
            StringName::unref();
   ...
   if (in_R8D < 2) {
      ...
      if (pVVar11 == (Variant*)0x0) {
         ...
         LAB_0010c900:pVVar11 = *(Variant**)param_4;
      }
 else {
         lVar2 = *(long*)( pVVar11 + -8 );
         if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
            LAB_0010c910:uVar7 = 4;
            goto LAB_0010c8c5;
         }
      ...
      *(undefined8*)( param_1 + 0x10 ) = uStack_38;
      ...
      uVar7 = 3;
      LAB_0010c8c5:*in_R9 = uVar7;
      in_R9[2] = 1;
   }

   LAB_0010c8d0:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (( ( plVar10 != (long*)0x0 ) && ( plVar10[1] != 0 ) ) && ( *(char*)( plVar10[1] + 0x2e ) != '\0' )) {
      ...
      if (local_68 == (char*)*plVar8) {
         ...
         _err_print_error(&_LC90, "./core/object/method_bind.h", 0x267, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: ret", (StringName*)&local_68, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_70);
         if (( StringName::configured != '\0' ) && ( local_78 != 0 )) {
            StringName::unref();
   ...
   if (in_R8D < 2) {
      ...
      if (pVVar11 == (Variant*)0x0) {
         ...
         LAB_0010cca0:pVVar11 = *(Variant**)param_4;
      }
 else {
         lVar2 = *(long*)( pVVar11 + -8 );
         if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
            LAB_0010ccb0:uVar7 = 4;
            goto LAB_0010cc55;
         }
      ...
      *(undefined8*)( param_1 + 0x10 ) = uStack_48;
      ...
      uVar7 = 3;
      LAB_0010cc55:*in_R9 = uVar7;
      in_R9[2] = 1;
   }

   LAB_0010cc60:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* MethodBindTR<IPAddress, String const&, IP::Type>::call(Object*, Variant const**, int,
   Callable::CallError&) const */Object *MethodBindTR<IPAddress,String_const&,IP::Type>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   Variant *pVVar1;
   long lVar2;
   code *pcVar3;
   undefined8 uVar4;
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (( ( plVar11 != (long*)0x0 ) && ( plVar11[1] != 0 ) ) && ( *(char*)( plVar11[1] + 0x2e ) != '\0' )) {
      ...
      if (local_88 == (char*)*plVar9) {
         ...
         _err_print_error(&_LC90, "./core/object/method_bind.h", 0x207, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: ret", (StringName*)&local_88, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_88);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_90);
   ...
   if (in_R8D < 3) {
      ...
      if (pVVar15 == (Variant*)0x0) {
         ...
         LAB_0010d0ad:pVVar15 = *(Variant**)( param_4 + 8 );
      }
 else {
         lVar2 = *(long*)( pVVar15 + -8 );
         iVar13 = (int)lVar2;
         if (iVar13 < iVar6) {
            LAB_0010d098:uVar7 = 4;
            goto LAB_0010d085;
         }
         ...
         if (lVar2 <= lVar10) {
            LAB_0010d180:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar10, lVar2, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar3 = (code*)invalidInstructionException();
            ( *pcVar3 )();
      ...
      *in_R9 = 0;
      ...
      ( *(code*)pVVar14 )(local_78, (Variant*)( (long)plVar11 + (long)pVVar1 ), (Variant*)&local_88, uVar8 & 0xffffffff);
      ...
      *(undefined8*)( param_1 + 0x10 ) = uStack_48;
      ...
      uVar7 = 3;
      LAB_0010d085:*in_R9 = uVar7;
      in_R9[2] = 2;
   }

   LAB_0010d056:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTR<Vector<String>, String const&, IP::Type>::call(Object*, Variant const**, int,
   Callable::CallError&) const */Object *MethodBindTR<Vector<String>,String_const&,IP::Type>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   Variant *pVVar1;
   long lVar2;
   code *pcVar3;
   undefined8 uVar4;
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (( ( plVar12 != (long*)0x0 ) && ( plVar12[1] != 0 ) ) && ( *(char*)( plVar12[1] + 0x2e ) != '\0' )) {
      ...
      if (local_68 == (char*)*plVar9) {
         ...
         String::parse_latin1((StrRange*)&local_70);
         vformat<StringName>((StringName*)&local_68, (StrRange*)&local_70, &local_78);
         _err_print_error(&_LC90, "./core/object/method_bind.h", 0x207, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: ret", (StringName*)&local_68, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_70);
         if (( StringName::configured != '\0' ) && ( local_78 != 0 )) {
            StringName::unref();
   ...
   if (in_R8D < 3) {
      ...
      if (pVVar11 == (Variant*)0x0) {
         ...
         LAB_0010d4cd:pVVar11 = *(Variant**)( param_4 + 8 );
      }
 else {
         lVar2 = *(long*)( pVVar11 + -8 );
         iVar14 = (int)lVar2;
         if (iVar14 < iVar6) {
            LAB_0010d4b8:uVar7 = 4;
            goto LAB_0010d4a5;
         }
         ...
         if (lVar2 <= lVar10) {
            LAB_0010d590:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar10, lVar2, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar3 = (code*)invalidInstructionException();
            ( *pcVar3 )();
      ...
      *in_R9 = 0;
      ...
      ( *(code*)pVVar15 )(&local_68, (Variant*)( (long)plVar12 + (long)pVVar1 ), (Variant*)&local_70, uVar8 & 0xffffffff);
      ...
      *(undefined8*)( param_1 + 0x10 ) = uStack_48;
      ...
      uVar7 = 3;
      LAB_0010d4a5:*in_R9 = uVar7;
      in_R9[2] = 2;
   }

   LAB_0010d478:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTR<int, String const&, IP::Type>::call(Object*, Variant const**, int,
   Callable::CallError&) const */Object *MethodBindTR<int,String_const&,IP::Type>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   Variant *pVVar1;
   long lVar2;
   code *pcVar3;
   undefined8 uVar4;
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   ...
   if (in_R8D < 3) {
      ...
      if (pVVar15 == (Variant*)0x0) {
         ...
         pVVar12 = *(Variant**)param_4;
         LAB_0010d8bd:pVVar15 = *(Variant**)( param_4 + 8 );
      }
 else {
         lVar2 = *(long*)( pVVar15 + -8 );
         iVar13 = (int)lVar2;
         if (iVar13 < iVar6) {
            LAB_0010d8a8:uVar7 = 4;
            goto LAB_0010d895;
         }
         ...
         lVar10 = (long)(int)( ( in_R8D ^ 1 ) + ( iVar13 - iVar6 ) );
         if (lVar2 <= lVar10) {
            LAB_0010d990:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar10, lVar2, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar3 = (code*)invalidInstructionException();
            ( *pcVar3 )();
      ...
      *(undefined8*)( param_1 + 0x10 ) = uStack_48;
      ...
      uVar7 = 3;
      LAB_0010d895:*in_R9 = uVar7;
      in_R9[2] = 2;
   }

   LAB_0010d86a:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* void call_with_variant_args_dv<__UnexistingClass, int>(__UnexistingClass*, void
   ...
   if (lVar1 == 0) {
      ...
      if ((int)lVar2 < (int)( uVar8 ^ 1 )) {
         LAB_0010dc40:uVar6 = 4;
         LAB_0010dbdd:*(undefined4*)param_6 = uVar6;
   ...
   LAB_0010db5b:*(undefined4*)param_6 = 0;
...
/* MethodBindT<int>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindT<int>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   *(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   LAB_0010dca6:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* void call_get_argument_type_info<String const&, IP::Type>(int, PropertyInfo&) */void call_get_argument_type_info<String_const&,IP::Type>(int param_1, PropertyInfo *param_2) {
   long lVar1;
   long in_FS_OFFSET;
   int local_5c;
   undefined4 local_58[2];
...
/* MethodBindTR<IPAddress, String const&, IP::Type>::_gen_argument_type_info(int) const */undefined4 *MethodBindTR<IPAddress,String_const&,IP::Type>::_gen_argument_type_info(int param_1) {
   undefined1 auVar1[16];
   undefined1 auVar2[16];
   undefined8 uVar3;
   undefined8 uVar4;
   ...
   *(undefined1(*) [16])( puVar5 + 2 ) = (undefined1[16])0x0;
   if (local_78 == 0) {
      puVar5[10] = 6;
      LAB_0010e407:StringName::operator =((StringName*)( puVar5 + 4 ), (StringName*)&local_70);
   }
 else {
   ...
   LAB_0010e3e2:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return puVar5;
   }
...
/* MethodBindTR<Vector<String>, String const&, IP::Type>::_gen_argument_type_info(int) const */undefined4 *MethodBindTR<Vector<String>,String_const&,IP::Type>::_gen_argument_type_info(int param_1) {
   undefined1 auVar1[16];
   undefined1 auVar2[16];
   undefined8 uVar3;
   undefined8 uVar4;
   ...
   *(undefined1(*) [16])( puVar5 + 2 ) = (undefined1[16])0x0;
   if (local_78 == 0) {
      puVar5[10] = 6;
      LAB_0010e5f7:StringName::operator =((StringName*)( puVar5 + 4 ), (StringName*)&local_70);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)( puVar5 + 8 ), (CowData*)&local_78);
      puVar5[10] = 6;
   ...
   LAB_0010e5d2:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return puVar5;
   }
...
/* MethodBindTR<int, String const&, IP::Type>::_gen_argument_type_info(int) const */undefined4 *MethodBindTR<int,String_const&,IP::Type>::_gen_argument_type_info(int param_1) {
   undefined1 auVar1[16];
   undefined1 auVar2[16];
   undefined8 uVar3;
   undefined8 uVar4;
   ...
   *(undefined1(*) [16])( puVar5 + 2 ) = (undefined1[16])0x0;
   if (local_78 == 0) {
      puVar5[10] = 6;
      LAB_0010e7e7:StringName::operator =((StringName*)( puVar5 + 4 ), (StringName*)&local_70);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)( puVar5 + 8 ), (CowData*)&local_78);
      puVar5[10] = 6;
   ...
   LAB_0010e7c2:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return puVar5;
   }
...
/* MethodBindTRC<IP::ResolverStatus, int>::_gen_argument_type_info(int) const */undefined4 *MethodBindTRC<IP::ResolverStatus,int>::_gen_argument_type_info(int param_1) {
   undefined1 auVar1[16];
   undefined8 uVar2;
   undefined8 uVar3;
   int in_EDX;
...
/* MethodBindTRC<IPAddress, int>::_gen_argument_type_info(int) const */undefined4 *MethodBindTRC<IPAddress,int>::_gen_argument_type_info(int param_1) {
   ...
   *(undefined1(*) [16])( puVar5 + 2 ) = (undefined1[16])0x0;
   if (local_78 == 0) {
      puVar5[10] = 6;
      LAB_0010eddf:StringName::operator =((StringName*)( puVar5 + 4 ), (StringName*)&local_70);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)( puVar5 + 8 ), (CowData*)&local_78);
      puVar5[10] = 6;
   ...
   LAB_0010ecf8:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return puVar5;
   }
...
/* MethodBindTRC<Array, int>::_gen_argument_type_info(int) const */undefined4 *MethodBindTRC<Array,int>::_gen_argument_type_info(int param_1) {
   ...
   *(undefined1(*) [16])( puVar5 + 2 ) = (undefined1[16])0x0;
   if (local_78 == 0) {
      puVar5[10] = 6;
      LAB_0010efdf:StringName::operator =((StringName*)( puVar5 + 4 ), (StringName*)&local_70);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)( puVar5 + 8 ), (CowData*)&local_78);
      puVar5[10] = 6;
   ...
   LAB_0010eef8:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return puVar5;
   }
...
/* WARNING: Control flow encountered bad instruction data *//* List<IPAddress, DefaultAllocator>::~List() */void List<IPAddress,DefaultAllocator>::~List(List<IPAddress,DefaultAllocator> *this) {
...
/* WARNING: Control flow encountered bad instruction data *//* MethodBindTRC<TypedArray<Dictionary>>::~MethodBindTRC() */void MethodBindTRC<TypedArray<Dictionary>>::~MethodBindTRC(MethodBindTRC<TypedArray<Dictionary>> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* MethodBindTRC<IPAddress, int>::~MethodBindTRC() */void MethodBindTRC<IPAddress,int>::~MethodBindTRC(MethodBindTRC<IPAddress,int> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* MethodBindTRC<IP::ResolverStatus, int>::~MethodBindTRC() */void MethodBindTRC<IP::ResolverStatus,int>::~MethodBindTRC(MethodBindTRC<IP::ResolverStatus,int> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* MethodBindTR<int, String const&, IP::Type>::~MethodBindTR() */void MethodBindTR<int,String_const&,IP::Type>::~MethodBindTR(MethodBindTR<int,String_const&,IP::Type> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* MethodBindTR<Vector<String>, String const&, IP::Type>::~MethodBindTR() */void MethodBindTR<Vector<String>,String_const&,IP::Type>::~MethodBindTR(MethodBindTR<Vector<String>,String_const&,IP::Type> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* MethodBindTR<IPAddress, String const&, IP::Type>::~MethodBindTR() */void MethodBindTR<IPAddress,String_const&,IP::Type>::~MethodBindTR(MethodBindTR<IPAddress,String_const&,IP::Type> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

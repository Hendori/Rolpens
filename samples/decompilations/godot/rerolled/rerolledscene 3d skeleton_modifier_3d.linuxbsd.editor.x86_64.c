/* SkeletonModifier3D::_skeleton_changed(Skeleton3D*, Skeleton3D*) */void SkeletonModifier3D::_skeleton_changed(Skeleton3D *param_1, Skeleton3D *param_2) {
   return;
}
/* SkeletonModifier3D::is_active() const */SkeletonModifier3D SkeletonModifier3D::is_active(SkeletonModifier3D *this) {
   return this[0x528];
}
/* SkeletonModifier3D::_set_active(bool) */void SkeletonModifier3D::_set_active(bool param_1) {
   return;
}
/* SkeletonModifier3D::set_influence(float) */void SkeletonModifier3D::set_influence(SkeletonModifier3D *this, float param_1) {
   *(float*)( this + 0x52c ) = param_1;
   return;
}
/* SkeletonModifier3D::get_influence() const */undefined4 SkeletonModifier3D::get_influence(SkeletonModifier3D *this) {
   return *(undefined4*)( this + 0x52c );
}
/* SkeletonModifier3D::get_skeleton() const */undefined8 SkeletonModifier3D::get_skeleton(SkeletonModifier3D *this) {
   long lVar1;
   ulong uVar2;
   undefined8 uVar3;
   uint uVar4;
...
;
   ...
   LAB_00100167:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* SkeletonModifier3D::set_active(bool) */void SkeletonModifier3D::set_active(SkeletonModifier3D *this, bool param_1) {
   long lVar1;
...
/* SkeletonModifier3D::_update_skeleton() [clone .part.0] */void SkeletonModifier3D::_update_skeleton(SkeletonModifier3D *this) {
   long lVar1;
   long lVar2;
   lVar1 = get_skeleton(this);
...
/* SkeletonModifier3D::_validate_property(PropertyInfo&) const */void SkeletonModifier3D::_validate_property(PropertyInfo *param_1) {
   return;
}
/* SkeletonModifier3D::_update_skeleton_path() */void SkeletonModifier3D::_update_skeleton_path(SkeletonModifier3D *this) {
   long lVar1;
   *(undefined8*)( this + 0x530 ) = 0;
...
/* SkeletonModifier3D::_update_skeleton() */void SkeletonModifier3D::_update_skeleton(SkeletonModifier3D *this) {
   if (( (byte)this[0x2fa] & 0x40 ) == 0) {
      return;
   }
...
/* SkeletonModifier3D::_force_update_skeleton_skin() */void SkeletonModifier3D::_force_update_skeleton_skin(SkeletonModifier3D *this) {
   long lVar1;
   if (( (byte)this[0x2fa] & 0x40 ) == 0) {
      return;
   }
...
/* SkeletonModifier3D::process_modification() */void __thiscall SkeletonModifier3D::process_modification(SkeletonModifier3D *this)

/* GDScriptEditorTranslationParserPlugin::get_recognized_extensions(List<String, DefaultAllocator>*)
   const */void GDScriptEditorTranslationParserPlugin::get_recognized_extensions(List *param_1) {
...
/* GDScriptEditorTranslationParserPlugin::_is_constant_string(GDScriptParser::ExpressionNode const*)
   ...
   if (param_1 == (ExpressionNode*)0x0) {
      _err_print_error("_is_constant_string", "modules/gdscript/editor/gdscript_translation_parser_plugin.cpp", 0x4d, "Parameter \"p_expression\" is null.", 0, 0);
      return 0;
   }

   if (param_1[0x129] != (ExpressionNode)0x0) {
      iVar1 = *(int*)( param_1 + 0x130 );
      return (uint)CONCAT71(( int7 )((ulong)in_RAX >> 8), iVar1 == 4) | CONCAT31(( int3 )((uint)iVar1 >> 8), iVar1 == 0x15);
   }

   return 0;
}
/* GDScriptEditorTranslationParserPlugin::_parse_comment(int, bool&) const */undefined8 *GDScriptEditorTranslationParserPlugin::_parse_comment(int param_1, bool *param_2) {
   long *plVar1;
   uint uVar2;
   ulong uVar3;
   long lVar4;
   ...
   if (local_b0 == 0) {
      ...
      if (*(int*)( lVar53 + 0x2c ) != 0) {
         ...
         if (uVar43 != 0) {
            ...
            uVar52 = uVar43;
            iVar45 = iVar44;
            LAB_0010036a:if (( uVar55 != uVar52 ) || ( *(uint*)( *(long*)( local_b0 + lVar47 * 8 ) + 0x10 ) != in_EDX )) goto LAB_00100320;
            uVar52 = 0;
            while (( uVar43 != uVar55 || ( *(uint*)( *(long*)( local_b0 + lVar46 * 8 ) + 0x10 ) != in_EDX ) )) {
               ...
               if (( uVar43 == 0 ) || ( auVar10._8_8_ = 0 ),auVar10._0_8_ = uVar43 * uVar3,auVar27._8_8_ = 0,auVar27._0_8_ = uVar56,auVar11._8_8_ = 0,auVar11._0_8_ = ( ( uVar2 + iVar44 ) - SUB164(auVar10 * auVar27, 8) ) * uVar3,auVar28._8_8_ = 0,auVar28._0_8_ = uVar56,SUB164(auVar11 * auVar28, 8) < uVar52) {
                  LAB_00100588:_err_print_error(&_LC14, "./core/templates/hash_map.h", 0x147, "FATAL: Condition \"!exists\" is true.", "HashMap key not found.", 0, 0);
                  _err_flush_stdout();
                  /* WARNING: Does not return */
...
;
            ...
            if (( cVar42 != '\0' ) || ( cVar42 = String::begins_with((char*)&local_60) ),lVar53 = local_60,cVar42 != '\0') {
               *in_RCX = 1;
               *puVar51 = 0;
               goto LAB_001004d0;
            }
         ...
         LAB_00100b90:local_78 = (undefined*)0x0;
         local_a0 = in_EDX - 1;
         LAB_00100670:do {
            ...
            while (( uVar55 != uVar54 || ( local_a0 != *(uint*)( *(long*)( local_b0 + uVar49 * 8 ) + 0x10 ) ) )) {
               ...
               uVar58 = (ulong)uVar57;
               if (( uVar54 == 0 ) || ( auVar14._8_8_ = 0 ),auVar14._0_8_ = uVar54 * uVar3,auVar31._8_8_ = 0,auVar31._0_8_ = uVar56,auVar15._8_8_ = 0,auVar15._0_8_ = ( ( uVar2 + uVar57 ) - SUB164(auVar14 * auVar31, 8) ) * uVar3,auVar32._8_8_ = 0,auVar32._0_8_ = uVar56,SUB164(auVar15 * auVar32, 8) < uVar59) goto LAB_00100540;
            }
;
            uVar57 = 0;
            uVar49 = uVar48;
            ...
            while (( uVar55 != uVar54 || ( local_a0 != *(uint*)( *(long*)( local_b0 + uVar49 * 8 ) + 0x10 ) ) )) {
               ...
               if (( uVar54 == 0 ) || ( auVar17._8_8_ = 0 ),auVar17._0_8_ = uVar54 * uVar3,auVar34._8_8_ = 0,auVar34._0_8_ = uVar56,auVar18._8_8_ = 0,auVar18._0_8_ = ( ( uVar2 + uVar59 ) - SUB164(auVar17 * auVar34, 8) ) * uVar3,auVar35._8_8_ = 0,auVar35._0_8_ = uVar56,SUB164(auVar18 * auVar35, 8) < uVar57) goto LAB_00100588;
            }
;
            ...
            while (( uVar43 != uVar55 || ( local_a0 != *(uint*)( *(long*)( local_b0 + uVar48 * 8 ) + 0x10 ) ) )) {
               ...
               if (( uVar43 == 0 ) || ( auVar20._8_8_ = 0 ),auVar20._0_8_ = uVar43 * uVar3,auVar37._8_8_ = 0,auVar37._0_8_ = uVar56,auVar21._8_8_ = 0,auVar21._0_8_ = ( ( uVar2 + uVar52 ) - SUB164(auVar20 * auVar37, 8) ) * uVar3,auVar38._8_8_ = 0,auVar38._0_8_ = uVar56,SUB164(auVar21 * auVar38, 8) < uVar54) goto LAB_00100588;
            }
;
            String::trim_prefix((char*)&local_58);
            ...
            if (local_70 != (undefined*)0x0) {
               if (1 < *(uint*)( local_70 + -8 )) {
                  if (local_78 == (undefined*)0x0) {
                     LAB_00100955:CowData<char32_t>::_ref((CowData<char32_t>*)&local_78, (CowData*)&local_70);
                  }
                  ...
                  if (cVar42 == '\0') {
                     ...
                     if (( cVar42 == '\0' ) && ( cVar42 = String::begins_with((char*)&local_70) ),cVar42 == '\0') {
            ...
            LAB_0010090f:local_a0 = local_a0 - 1;
            lVar53 = *(long*)( param_2 + 0x1c8 );
            local_b0 = *(long*)( lVar53 + 8 );
 ...
 while ( true );
      ...
      local_78 = (undefined*)0x0;
      LAB_00100540:*puVar51 = 0;
      LAB_0010054f:puVar40 = local_78;
      if (local_78 != (undefined*)0x0) {
         LOCK();
         plVar1 = (long*)( local_78 + -0x10 );
         *plVar1 = *plVar1 + -1;
   ...
   LAB_00100500:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }

   return puVar51;
   LAB_00100320:uVar54 = uVar54 + 1;
   auVar6._8_8_ = 0;
   ...
   if (( uVar52 == 0 ) || ( auVar7._8_8_ = 0 ),auVar7._0_8_ = uVar52 * uVar3,auVar24._8_8_ = 0,auVar24._0_8_ = uVar56,auVar8._8_8_ = 0,auVar8._0_8_ = ( ( uVar2 + iVar45 ) - SUB164(auVar7 * auVar24, 8) ) * uVar3,auVar25._8_8_ = 0,auVar25._0_8_ = uVar56,SUB164(auVar8 * auVar25, 8) < uVar54) goto LAB_00100b90;
   goto LAB_0010036a;
}
/* GDScriptEditorTranslationParserPlugin::GDScriptEditorTranslationParserPlugin() */void GDScriptEditorTranslationParserPlugin::GDScriptEditorTranslationParserPlugin(GDScriptEditorTranslationParserPlugin *this) {
   undefined8 uVar1;
   long in_FS_OFFSET;
   long local_50;
   ...
   *(undefined1(*) [16])( this + 0x1f8 ) = (undefined1[16])0x0;
   for (int i = 0; i < 3; i++) {
      *(undefined8*)( this + ( 40*i + 536 ) ) = uVar1;
   }
...
/* GDScriptEditorTranslationParserPlugin::_add_id_ctx_plural(Vector<String> const&, int) */void GDScriptEditorTranslationParserPlugin::_add_id_ctx_plural(Vector *param_1, int param_2) {
   long *plVar1;
   ...
   if (plVar7 == (long*)0x0) {
      ...
      if (0 < lVar6) {
         ...
         if (*plVar7 == 0) {
            LAB_001016f0:if (1 < lVar6) {
               local_58[1] = 0;
               plVar1 = (long*)( plVar7[1] + -0x10 );
               if (plVar7[1] == 0) {
                  LAB_0010173f:lVar6 = plVar7[-1];
                  if (2 < lVar6) {
                     local_58[2] = 0;
 ...
 while ( !bVar10 );
                     ...
                     if (iVar4 == 0) {
                        ...
                        do {
                           if (local_60 == 0) {
                              lVar6 = 0;
                              LAB_001018ba:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar8, lVar6, "p_index", "size()", "", false, false);
                           }
 else {
 ...
 while ( !bVar10 );
                  ...
                  LAB_00101732:plVar7 = *(long**)( lVar8 + 8 );
 ...
 while ( !bVar10 );
            ...
            LAB_001016df:plVar7 = *(long**)( lVar8 + 8 );
            if (plVar7 != (long*)0x0) {
               lVar6 = plVar7[-1];
               goto LAB_001016f0;
            }
   ...
   lVar8 = 0;
   LAB_00101943:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar8, lVar6, "p_index", "size()", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar3 = (code*)invalidInstructionException();
   ( *pcVar3 )();
}
/* GDScriptEditorTranslationParserPlugin::_add_id(String const&, int) */void GDScriptEditorTranslationParserPlugin::_add_id(String *param_1, int param_2) {
   long *plVar1;
   CowData *pCVar2;
   CowData<char32_t> *this;
   ...
   if (iVar4 == 0) {
      ...
      do {
         ...
         while (true) {
            ...
            if (local_60 != 0) break;
            LAB_00101b97:lVar5 = 0;
            LAB_00101b9a:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar7, lVar5, "p_index", "size()", "", false, false);
         }
;
      }
 while ( true );
...
/* GDScriptEditorTranslationParserPlugin::_extract_fd_filter_string(GDScriptParser::ExpressionNode
   const*, int) [clone .part.0] */void GDScriptEditorTranslationParserPlugin::_extract_fd_filter_string(ExpressionNode *param_1, int param_2) {
   long *plVar1;
   long lVar2;
   bool bVar3;
   long in_FS_OFFSET;
   ...
   if (( local_30[0] == 0 ) || ( *(long*)( local_30[0] + -8 ) != 2 )) {
      _err_print_error("_extract_fd_filter_string", "modules/gdscript/editor/gdscript_translation_parser_plugin.cpp", 0x192, "Condition \"arr.size() != 2\" is true.", "Argument for setting FileDialog has bad format.", 0, 0);
...
/* GDScriptEditorTranslationParserPlugin::_extract_fd_filter_string(GDScriptParser::ExpressionNode
   const*, int) */void GDScriptEditorTranslationParserPlugin::_extract_fd_filter_string(ExpressionNode *param_1, int param_2) {
   undefined4 in_register_00000034;
   long lVar1;
   ...
   if (( *(char*)( lVar1 + 0x129 ) != '\0' ) && ( ( *(int*)( lVar1 + 0x130 ) == 4 || ( *(int*)( lVar1 + 0x130 ) == 0x15 ) ) )) {
...
/* GDScriptEditorTranslationParserPlugin::_extract_fd_filter_array(GDScriptParser::ExpressionNode
   const*) */void GDScriptEditorTranslationParserPlugin::_extract_fd_filter_array(GDScriptEditorTranslationParserPlugin *this, ExpressionNode *param_1) {
   long lVar1;
   long *plVar2;
   long lVar3;
   code *pcVar4;
   ...
   if (*(int*)( param_1 + 8 ) != 2) {
      if (( ( *(int*)( param_1 + 8 ) != 9 ) || ( *(long*)( param_1 + 0x148 ) == 0 ) ) || ( *(int*)( *(long*)( param_1 + 0x148 ) + 8 ) != 0x13 )) goto LAB_00101e0f;
      if ((_extract_fd_filter_array(GDScriptParser::ExpressionNode_const*)::{lambda()
      #1
      ::sname == '\0') &&
      ...
      _scs_create((char *)&_extract_fd_filter_array(GDScriptParser::ExpressionNode_const*)::
                           {lambda()
      #1
      __cxa_atexit(StringName::~StringName, &_extract_fd_filter_array(GDScriptParser::ExpressionNode_const * ::operator ()(), ::sname, &__dso_handle));
   ...
   if ((_extract_fd_filter_array(GDScriptParser::ExpressionNode_const*)::{lambda()
   #1
   ::sname != *(long*)( param_1 + 0x160 ) || ( plVar2 = *(long**)( param_1 + 0x158 ) ),plVar2 == (long*)0x0;
   if (plVar2[-1] < 1) {
      _err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, 0, plVar2[-1], "p_index", "size()", "", false, true);
      _err_flush_stdout();
      /* WARNING: Does not return */
      pcVar4 = (code*)invalidInstructionException();
      ( *pcVar4 )();
...
lVar6 = *(long*)( param_1 + 0x150 );if (lVar6 != 0) {
   lVar7 = 0;
   do {
      if (*(long*)( lVar6 + -8 ) <= lVar7) break;
      lVar3 = *(long*)( lVar6 + lVar7 * 8 );
      if (( *(char*)( lVar3 + 0x129 ) != '\0' ) && ( ( *(int*)( lVar3 + 0x130 ) == 4 || ( *(int*)( lVar3 + 0x130 ) == 0x15 ) ) )) {
...
LAB_00101e0f:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return;}/* GDScriptEditorTranslationParserPlugin::_assess_assignment(GDScriptParser::AssignmentNode const*)
    */void GDScriptEditorTranslationParserPlugin::_assess_assignment(GDScriptEditorTranslationParserPlugin *this, AssignmentNode *param_1) {
   long *plVar1;
   long lVar2;
   ...
   if (*(int*)( lVar18 + 8 ) == 0x20) {
      ...
      if (*(char*)( lVar18 + 0x158 ) == '\0') {
         if (( ( lVar2 != 0 ) && ( *(char*)( lVar2 + 0x129 ) != '\0' ) ) && ( ( *(int*)( lVar2 + 0x130 ) == 4 || ( *(int*)( lVar2 + 0x130 ) == 0x15 ) ) )) {
      ...
      if (( *(long*)( this + 0x1f8 ) != 0 ) && ( *(int*)( this + 0x21c ) != 0 )) {
         ...
         if (uVar14 != 0) {
            do {
               if (( uVar14 == uVar11 ) && ( *(long*)( *(long*)( this + 0x1f8 ) + ( ulong ) * (uint*)( *(long*)( this + 0x200 ) + lVar13 * 4 ) * 8 ) == local_50 )) {
                  ...
                  if (( pEVar15[0x129] != (ExpressionNode)0x0 ) && ( ( *(int*)( pEVar15 + 0x130 ) == 4 || ( *(int*)( pEVar15 + 0x130 ) == 0x15 ) ) )) {
 ...
 while ( ( uVar14 != 0 ) && ( auVar5._8_8_ = 0 ),auVar5._0_8_ = (ulong)uVar14 * lVar2,auVar9._8_8_ = 0,auVar9._0_8_ = uVar16,auVar6._8_8_ = 0,auVar6._0_8_ = ( ulong )(( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x218 ) * 4 ) + iVar12 ) - SUB164(auVar5 * auVar9, 8)) * lVar2,auVar10._8_8_ = 0,auVar10._0_8_ = uVar16,uVar17 <= SUB164(auVar6 * auVar10, 8) );
            goto LAB_001021fd;
         }
      ...
      LAB_001021fd:if (StringName::configured == '\0') goto LAB_001021cb;
      lVar18 = *(long*)( this + 0x280 );
      joined_r0x0010220d:if (lVar18 != local_50) {
         LAB_0010220f:StringName::unref();
         goto LAB_0010200b;
      }

   }
 else {
      LAB_00101ff0:if (StringName::configured == '\0') {
         lVar18 = 0;
         LAB_001021cb:if (lVar18 != *(long*)( this + 0x280 )) goto LAB_0010200b;
      }
 else if (*(long*)( this + 0x280 ) != 0) goto LAB_0010200b;
   }

   LAB_001021e0:pEVar15 = *(ExpressionNode**)( param_1 + 0x158 );
   LAB_001021e7:_extract_fd_filter_array(this, pEVar15);
   LAB_001022e8:if (StringName::configured != '\0') {
      LAB_001022fa:if (local_50 != 0) {
         StringName::unref();
      }

   }

   LAB_0010200b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* GDScriptEditorTranslationParserPlugin::_traverse_block(GDScriptParser::SuiteNode const*) [clone
   .part.0] */void GDScriptEditorTranslationParserPlugin::_traverse_block(GDScriptEditorTranslationParserPlugin *this, SuiteNode *param_1) {
...
/* GDScriptEditorTranslationParserPlugin::_traverse_block(GDScriptParser::SuiteNode const*) */void GDScriptEditorTranslationParserPlugin::_traverse_block(GDScriptEditorTranslationParserPlugin *this, SuiteNode *param_1) {
...
/* GDScriptEditorTranslationParserPlugin::_traverse_function(GDScriptParser::FunctionNode const*)
   [clone .part.0] */void GDScriptEditorTranslationParserPlugin::_traverse_function(GDScriptEditorTranslationParserPlugin *this, FunctionNode *param_1) {
   long lVar1;
   long lVar2;
...
/* GDScriptEditorTranslationParserPlugin::_traverse_function(GDScriptParser::FunctionNode const*) */void GDScriptEditorTranslationParserPlugin::_traverse_function(GDScriptEditorTranslationParserPlugin *this, FunctionNode *param_1) {
...
/* GDScriptEditorTranslationParserPlugin::_assess_expression(GDScriptParser::ExpressionNode const*)
    */void GDScriptEditorTranslationParserPlugin::_assess_expression(GDScriptEditorTranslationParserPlugin *this, ExpressionNode *param_1) {
   code *pcVar1;
   long lVar2;
   long lVar3;
   long lVar4;
 ...
 while ( true );
   LAB_0010287a:if (*(long*)( lVar2 + -8 ) <= lVar4) {
      return;
   }
   ...
   if (lVar2 == 0) {
      lVar3 = 0;
      LAB_001028a6:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar4, lVar3, "p_index", "size()", "", false, true);
      _err_flush_stdout();
      /* WARNING: Does not return */
...
/* GDScriptEditorTranslationParserPlugin::_assess_call(GDScriptParser::CallNode const*) */void GDScriptEditorTranslationParserPlugin::_assess_call(GDScriptEditorTranslationParserPlugin *this, CallNode *param_1) {
   long *plVar1;
   uint uVar2;
   long lVar3;
   undefined8 *puVar4;
      ...
      if (lVar24 != 0) {
         do {
            while (true) {
               ...
               if (lVar30 != 0) break;
               _err_print_error("_is_constant_string", "modules/gdscript/editor/gdscript_translation_parser_plugin.cpp", 0x4d, "Parameter \"p_expression\" is null.", 0, 0, this_00);
               lVar24 = *(long*)( param_1 + 0x158 );
               LAB_00102c40:bVar22 = false;
               LAB_00102c43:lVar29 = lVar29 + 1;
               if (lVar24 == 0) goto LAB_00102d10;
            }
;
            if (( *(char*)( lVar30 + 0x129 ) == '\0' ) || ( ( *(int*)( lVar30 + 0x130 ) != 4 && ( *(int*)( lVar30 + 0x130 ) != 0x15 ) ) )) goto LAB_00102c40;
            if (lVar24 == 0) {
               lVar24 = 0;
               goto LAB_00103149;
            }
 ...
 while ( lVar24 != 0 );
         LAB_00102d10:if (!bVar22) goto LAB_00102be8;
      }
      ...
      if (( local_78 != *(long*)( this + 0x1e0 ) ) && ( local_78 != *(long*)( this + 0x1f0 ) )) {
         if (( *(long*)( this + 0x220 ) != 0 ) && ( *(int*)( this + 0x244 ) != 0 )) {
            ...
            if (uVar26 != 0) {
               uVar28 = 0;
               do {
                  if (( uVar26 == uVar23 ) && ( local_78 == *(long*)( *(long*)( this + 0x220 ) + ( ulong ) * (uint*)( *(long*)( this + 0x228 ) + lVar29 * 4 ) * 8 ) )) {
 ...
 while ( ( uVar26 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = (ulong)uVar26 * lVar24,auVar15._8_8_ = 0,auVar15._0_8_ = uVar27,auVar8._8_8_ = 0,auVar8._0_8_ = ( ulong )(( uVar2 + iVar25 ) - SUB164(auVar7 * auVar15, 8)) * lVar24,auVar16._8_8_ = 0,auVar16._0_8_ = uVar27,uVar28 <= SUB164(auVar8 * auVar16, 8) );
            }
         ...
         if (( *(long*)( this + 0x248 ) != 0 ) && ( *(int*)( this + 0x26c ) != 0 )) {
            ...
            if (uVar26 != 0) {
               uVar28 = 0;
               do {
                  if (( uVar26 == uVar23 ) && ( local_78 == *(long*)( *(long*)( this + 0x248 ) + ( ulong ) * (uint*)( *(long*)( this + 0x250 ) + lVar29 * 4 ) * 8 ) )) {
                     lVar24 = *(long*)( param_1 + 0x158 );
                     if (( lVar24 != 0 ) && ( 1 < *(long*)( lVar24 + -8 ) )) {
                        lVar24 = *(long*)( lVar24 + 8 );
                        joined_r0x001030f4:if (lVar24 == 0) {
                           _err_print_error("_is_constant_string", "modules/gdscript/editor/gdscript_translation_parser_plugin.cpp", 0x4d, "Parameter \"p_expression\" is null.", 0, 0, this_00);
                        }
 else if (( *(char*)( lVar24 + 0x129 ) != '\0' ) && ( ( *(int*)( lVar24 + 0x130 ) == 4 || ( *(int*)( lVar24 + 0x130 ) == 0x15 ) ) )) {
                           Variant::operator_cast_to_String((Variant*)&local_58);
 ...
 while ( ( uVar26 != 0 ) && ( auVar11._8_8_ = 0 ),auVar11._0_8_ = (ulong)uVar26 * lVar24,auVar19._8_8_ = 0,auVar19._0_8_ = uVar27,auVar12._8_8_ = 0,auVar12._0_8_ = ( ulong )(( uVar2 + iVar25 ) - SUB164(auVar11 * auVar19, 8)) * lVar24,auVar20._8_8_ = 0,auVar20._0_8_ = uVar27,uVar28 <= SUB164(auVar12 * auVar20, 8) );
            }
 ...
 else if (( *(long*)( this + 0x278 ) == local_78 ) && ( puVar4 = *(undefined8**)( param_1 + 0x158 ) ),puVar4 != (undefined8*)0x0) {
            lVar24 = puVar4[-1];
            if (lVar24 < 1) {
               LAB_0010323d:lVar29 = 0;
               LAB_00103149:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar29, lVar24, "p_index", "size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
      ...
      if (local_50 != 0) {
         do {
            while (true) {
               ...
               joined_r0x00102fb6:lVar30 = lVar30 + 1;
...
;
            ...
            if (lVar24 == 0) {
               _err_print_error("_is_constant_string", "modules/gdscript/editor/gdscript_translation_parser_plugin.cpp", 0x4d, "Parameter \"p_expression\" is null.", 0, 0);
               lVar32 = local_50;
               LAB_00102e56:bVar22 = false;
               goto joined_r0x00102fb6;
            }

            if (( *(char*)( lVar24 + 0x129 ) == '\0' ) || ( ( *(int*)( lVar24 + 0x130 ) != 4 && ( *(int*)( lVar24 + 0x130 ) != 0x15 ) ) )) goto LAB_00102e56;
            Variant::operator_cast_to_String((Variant*)&local_70);
            lVar29 = lVar30;
            if (local_60 == 0) {
               LAB_00102f40:lVar24 = 0;
               LAB_00102f43:_err_print_index_error("operator[]", "./core/templates/vector.h", 0x38, lVar29, lVar24, "p_index", "((Vector<T> *)(this))->_cowdata.size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
               pcVar21 = (code*)invalidInstructionException();
               ( *pcVar21 )();
 ...
 while ( local_50 != 0 );
         LAB_00102e64:if (bVar22) {
            LAB_00102e6f:_add_id_ctx_plural(this, (int)local_68);
            if (lVar32 != 0) {
               LAB_00102e88:LOCK();
   ...
   LAB_00102be8:CowData<String>::_unref((CowData<String>*)&local_60);
...
/* GDScriptEditorTranslationParserPlugin::_traverse_class(GDScriptParser::ClassNode const*) */void GDScriptEditorTranslationParserPlugin::_traverse_class(GDScriptEditorTranslationParserPlugin *this, ClassNode *param_1) {
   int *piVar1;
   int iVar2;
   long lVar3;
   long lVar4;
   ...
   do {
      ...
      if (iVar2 == 3) {
         ...
         if (pFVar6 != (FunctionNode*)0x0) {
            LAB_00103369:_traverse_function(this, pFVar6);
            goto LAB_00103350;
         }
         ...
         LAB_00103350:lVar3 = *(long*)( param_1 + 0x148 );
      }
 else if (iVar2 == 1) {
...
/* GDScriptEditorTranslationParserPlugin::parse_file(String const&, Vector<Vector<String> >*) */int GDScriptEditorTranslationParserPlugin::parse_file(GDScriptEditorTranslationParserPlugin *this, String *param_1, Vector *param_2) {
   long *plVar1;
   uint uVar2;
   long lVar3;
   Object *pOVar4;
   ...
   if (local_adc != 0) {
      operator+((char *)&
      local_ac8,(String*)"Failed to load ";
      _err_print_error("parse_file", "modules/gdscript/editor/gdscript_translation_parser_plugin.cpp", 0x32, "Condition \"err\" is true. Returning: err", (GDScriptAnalyzer*)&local_ac8, 0, 0);
      puVar6 = local_ac8;
      iVar8 = local_adc;
   ...
   *(Vector**)( this + 0x1d0 ) = param_2;
   if (( local_ad8 == (Object*)0x0 ) || ( pOVar9 = (Object*)__dynamic_cast(local_ad8, &Object::typeinfo, &GDScript::typeinfo) ),pOVar9 == (Object*)0x0) {
      /* WARNING: Does not return */
   ...
   if (local_adc == 0) {
      ...
      if (iVar8 == 0) {
         ...
         *(undefined8*)( this + 0x1c8 ) = 0;
         ...
         _err_print_error("parse_file", "modules/gdscript/editor/gdscript_translation_parser_plugin.cpp", 0x3f, "Condition \"err\" is true. Returning: err", "Failed to analyze GDScript with GDScriptAnalyzer.", 0, 0);
         iVar8 = local_adc;
      }
 ...
 while ( lVar10 != (ulong)uVar2 << 2 );
      ...
      LAB_001035dc:if (local_ab0 != (long*)0x0) {
         do {
            plVar1 = local_ab0;
 ...
 while ( (int)local_ab0[2] != 0 );
      ...
      _err_print_error("parse_file", "modules/gdscript/editor/gdscript_translation_parser_plugin.cpp", 0x3b, "Condition \"err\" is true. Returning: err", "Failed to parse GDScript with GDScriptParser.", 0, 0);
      iVar8 = local_adc;
   }

   LAB_00103648:GDScriptParser::~GDScriptParser(local_a68);
   lVar10 = local_ad0;
   if (local_ad0 == 0) {
      LAB_00103667:cVar7 = RefCounted::unreference();
   }
 else {
      LOCK();
      plVar1 = (long*)( local_ad0 + -0x10 );
   ...
   LAB_00103677:if (( ( local_ad8 != (Object*)0x0 ) && ( cVar7 = RefCounted::unreference() ),cVar7 != '\0' )) &&( cVar7 = cVar7 != '\0' )(**(code**)( *(long*)local_ad8 + 0x140 ))(local_ad8);
...
/* RefCounted::is_class_ptr(void*) const */uint RefCounted::is_class_ptr(RefCounted *this, void *param_1) {
   return (uint)CONCAT71(0x1076, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1076, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr);
}
...
/* GDScriptEditorTranslationParserPlugin::is_class_ptr(void*) const */uint GDScriptEditorTranslationParserPlugin::is_class_ptr(GDScriptEditorTranslationParserPlugin *this, void *param_1) {
   return (uint)CONCAT71(0x1076, (undefined4*)param_1 == &EditorTranslationParserPlugin::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1076, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1076, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1076, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* GDScriptEditorTranslationParserPlugin::_getv(StringName const&, Variant&) const */undefined8 GDScriptEditorTranslationParserPlugin::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* GDScriptEditorTranslationParserPlugin::_setv(StringName const&, Variant const&) */undefined8 GDScriptEditorTranslationParserPlugin::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* GDScriptEditorTranslationParserPlugin::_validate_propertyv(PropertyInfo&) const */void GDScriptEditorTranslationParserPlugin::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* GDScriptEditorTranslationParserPlugin::_property_can_revertv(StringName const&) const */undefined8 GDScriptEditorTranslationParserPlugin::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* GDScriptEditorTranslationParserPlugin::_property_get_revertv(StringName const&, Variant&) const
    */undefined8 GDScriptEditorTranslationParserPlugin::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* GDScriptEditorTranslationParserPlugin::_notificationv(int, bool) */void GDScriptEditorTranslationParserPlugin::_notificationv(int param_1, bool param_2) {
   return;
}
...
/* GDScriptEditorTranslationParserPlugin::_get_class_namev() const */undefined8 *GDScriptEditorTranslationParserPlugin::_get_class_namev(void) {
   int iVar1;
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00103bc3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00103bc3;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "GDScriptEditorTranslationParserPlugin");
         goto LAB_00103c2e;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "GDScriptEditorTranslationParserPlugin");
   LAB_00103c2e:return &_get_class_namev();
}
...
/* GDScriptEditorTranslationParserPlugin::~GDScriptEditorTranslationParserPlugin() */void GDScriptEditorTranslationParserPlugin::~GDScriptEditorTranslationParserPlugin(GDScriptEditorTranslationParserPlugin *this) {
   ...
   *(undefined***)this = &PTR__initialize_classv_00107550;
   ...
   LAB_00103dc2:pvVar2 = *(void**)( this + 0x248 );
   if (pvVar2 != (void*)0x0) {
      if (*(int*)( this + 0x26c ) != 0) {
         if (*(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x268 ) * 4 ) != 0) {
            memset(*(void**)( this + 0x260 ), 0, ( ulong ) * (uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x268 ) * 4 ) << 2);
 ...
 while ( (uint)lVar1 < *(uint*)( this + 0x21c ) );
   ...
   LAB_00104085:*(undefined***)this = &PTR__initialize_classv_001073f0;
   Object::~Object((Object*)this);
   return;
}
/* GDScriptEditorTranslationParserPlugin::~GDScriptEditorTranslationParserPlugin() */void GDScriptEditorTranslationParserPlugin::~GDScriptEditorTranslationParserPlugin(GDScriptEditorTranslationParserPlugin *this) {
...
/* GDScriptEditorTranslationParserPlugin::parse_file(String const&, Vector<Vector<String> >*) [clone
   .cold] */void GDScriptEditorTranslationParserPlugin::parse_file(String *param_1, Vector *param_2) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* GDScriptEditorTranslationParserPlugin::get_class() const */void GDScriptEditorTranslationParserPlugin::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* RefCounted::is_class(String const&) const */undefined8 RefCounted::is_class(RefCounted *this, String *param_1) {
 ...
 while ( !bVar9 );
      ...
      LAB_001046af:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
 ...
 while ( !bVar9 );
         ...
         LAB_00104813:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
      ...
      LAB_00104763:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* GDScriptEditorTranslationParserPlugin::is_class(String const&) const */undefined8 GDScriptEditorTranslationParserPlugin::is_class(GDScriptEditorTranslationParserPlugin *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long lVar4;
 ...
 while ( !bVar9 );
      ...
      LAB_0010494f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
 ...
 while ( !bVar9 );
         ...
         LAB_00104ac3:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
   ...
   LAB_00104a03:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_00104b6c:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* GDScriptEditorTranslationParserPlugin::_initialize_classv() */void GDScriptEditorTranslationParserPlugin::_initialize_classv(void) {
   long *plVar1;
   long lVar2;
   long in_FS_OFFSET;
   long local_70;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (initialize_class() == '\0') {
      if (EditorTranslationParserPlugin::initialize_class() == '\0') {
         ...
         EditorTranslationParserPlugin::initialize_class()::initialized =
         '\x01';
      }
...
/* GDScriptEditorTranslationParserPlugin::_get_property_listv(List<PropertyInfo, DefaultAllocator>*,
   bool) const */void GDScriptEditorTranslationParserPlugin::_get_property_listv(GDScriptEditorTranslationParserPlugin *this, List *param_1, bool param_2) {
   long *plVar1;
   long lVar2;
   long lVar3;
   undefined1(*pauVar4)[16];
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (!param_2) {
      EditorTranslationParserPlugin::_get_property_listv((EditorTranslationParserPlugin*)this, param_1, false);
   }
   ...
   *(int*)( plVar1 + 2 ) = (int)plVar1[2] + 1;
   ...
   if (param_2) {
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         EditorTranslationParserPlugin::_get_property_listv((EditorTranslationParserPlugin*)this, param_1, true);
         return;
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashSet<StringName, HashMapHasherDefault, HashMapComparatorDefault<StringName>
 ...
 while ( ( uVar42 != 0 ) && ( auVar5._8_8_ = 0 ),auVar5._0_8_ = (ulong)uVar42 * lVar30,auVar17._8_8_ = 0,auVar17._0_8_ = uVar29,auVar6._8_8_ = 0,auVar6._0_8_ = ( ulong )(( uVar40 + iVar33 ) - SUB164(auVar5 * auVar17, 8)) * lVar30,auVar18._8_8_ = 0,auVar18._0_8_ = uVar29,uVar37 <= SUB164(auVar6 * auVar18, 8) );
   ...
   if ((float)( iVar44 + 1 ) <= (float)uVar27 * __LC20) {
      ...
      LAB_00106576:uVar27 = StringName::get_empty_hash();
   }
 else {
 ...
 while ( (uint)uVar29 < *(uint*)( (long)in_RSI + 0x24 ) );
      ...
      LAB_00106415:uVar27 = *(uint*)( lVar30 + 0x20 );
   }
 ...
 while ( uVar42 != 0 );
   ...
   *(int*)( (long)in_RSI + 0x24 ) = iVar44;
   LAB_00106538:*(uint*)( param_1 + 0xc ) = uVar42;
   *(long*)param_1 = lVar36;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<String>::resize<false>(long) */undefined8 CowData<String>::resize<false>(CowData<String> *this, long param_1) {
   ...
   if (param_1 * 8 == 0) {
      LAB_00106af0:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (lVar10 == lVar7) {
      LAB_00106a6f:puVar9 = *(undefined8**)this;
      if (puVar9 == (undefined8*)0x0) {
         LAB_00106b46:/* WARNING: Does not return */pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
      }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<int>::resize<false>(long) */undefined8 CowData<int>::resize<false>(CowData<int> *this, long param_1) {
   ...
   if (param_1 * 4 == 0) {
      LAB_00106dd0:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Vector<String> >::resize<false>(long) */undefined8 CowData<Vector<String>>::resize<false>(CowData<Vector<String>> *this, long param_1) {
   ...
   if (param_1 * 0x10 == 0) {
      LAB_001071d0:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (lVar10 == lVar7) {
      LAB_00107143:puVar6 = *(undefined8**)this;
      if (puVar6 == (undefined8*)0x0) {
         LAB_00107226:/* WARNING: Does not return */pcVar1 = (code*)invalidInstructionException();
         ( *pcVar1 )();
      }
 ...
 while ( puVar3 != puVar11 );
   LAB_001070a9:puVar6[-1] = param_1;
   return 0;
}
/* WARNING: Control flow encountered bad instruction data *//* GDScriptEditorTranslationParserPlugin::~GDScriptEditorTranslationParserPlugin() */void GDScriptEditorTranslationParserPlugin::~GDScriptEditorTranslationParserPlugin(GDScriptEditorTranslationParserPlugin *this) {

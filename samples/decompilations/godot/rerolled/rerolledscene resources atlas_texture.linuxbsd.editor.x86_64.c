/* AtlasTexture::get_rid() const */undefined8 AtlasTexture::get_rid(AtlasTexture *this) {
   undefined8 uVar1;
   if (*(long**)( this + 0x2e8 ) != (long*)0x0) {
      /* WARNING: Could not recover jumptable at 0x00100013. Too many branches */
      /* WARNING: Treating indirect jump as call */
      uVar1 = ( **(code**)( **(long**)( this + 0x2e8 ) + 0x1c0 ) )();
      return uVar1;
   }

   return 0;
}
/* AtlasTexture::has_alpha() const */undefined8 AtlasTexture::has_alpha(AtlasTexture *this) {
   undefined8 uVar1;
   if (*(long**)( this + 0x2e8 ) != (long*)0x0) {
      /* WARNING: Could not recover jumptable at 0x00100043. Too many branches */
      /* WARNING: Treating indirect jump as call */
      uVar1 = ( **(code**)( **(long**)( this + 0x2e8 ) + 0x1e8 ) )();
      return uVar1;
   }

   return 0;
}
/* AtlasTexture::get_region() const */undefined1  [16] __thiscallAtlasTexture::get_region(AtlasTexture *this) {
   return *(undefined1(*) [16])( this + 0x2f0 );
}
/* AtlasTexture::get_margin() const */undefined1  [16] __thiscallAtlasTexture::get_margin(AtlasTexture *this) {
   return *(undefined1(*) [16])( this + 0x300 );
}
/* AtlasTexture::has_filter_clip() const */AtlasTexture AtlasTexture::has_filter_clip(AtlasTexture *this) {
   return this[0x310];
}
/* AtlasTexture::draw_rect_region(RID, Rect2 const&, Rect2 const&, Color const&, bool, bool) const
    */void AtlasTexture::draw_rect_region(long *param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5, undefined1 param_6) {
   char cVar1;
   long in_FS_OFFSET;
   undefined8 local_68;
   undefined8 local_60;
   ...
   if (param_1[0x5d] != 0) {
      ...
      local_58 = 0;
      local_50 = 0;
      cVar1 = ( **(code**)( *param_1 + 0x208 ) )(param_1, param_3, param_4, &local_68, &local_58);
      if (cVar1 != '\0') {
         ( **(code**)( *(long*)param_1[0x5d] + 0x200 ) )((long*)param_1[0x5d], param_2, &local_68, &local_58, param_5, param_6, (char)param_1[0x62]);
      }
...
/* AtlasTexture::is_pixel_opaque(int, int) const */undefined8 AtlasTexture::is_pixel_opaque(AtlasTexture *this, int param_1, int param_2) {
   int iVar1;
   undefined8 uVar2;
   int iVar3;
   int iVar4;
   ...
   iVar3 = (int)( ( (float)param_1 + *(float*)( this + 0x2f0 ) ) - *(float*)( this + 0x300 ) );
   if (-1 < iVar3) {
      iVar4 = (int)( ( (float)param_2 + *(float*)( this + 0x2f4 ) ) - *(float*)( this + 0x304 ) );
      iVar1 = ( **(code**)( **(long**)( this + 0x2e8 ) + 0x1c8 ) )();
      if (( -1 < iVar4 ) && ( iVar3 < iVar1 )) {
         iVar1 = ( **(code**)( **(long**)( this + 0x2e8 ) + 0x1d0 ) )();
         if (iVar4 < iVar1) {
            /* WARNING: Could not recover jumptable at 0x00100231. Too many branches */
            /* WARNING: Treating indirect jump as call */
            uVar2 = ( **(code**)( **(long**)( this + 0x2e8 ) + 0x1e0 ) )(*(long**)( this + 0x2e8 ), iVar3, iVar4);
            return uVar2;
         }
...
/* AtlasTexture::set_filter_clip(bool) */void AtlasTexture::set_filter_clip(AtlasTexture *this, bool param_1) {
   this[0x310] = (AtlasTexture)param_1;
   Resource::emit_changed();
   return;
}
/* AtlasTexture::get_width() const */int AtlasTexture::get_width(AtlasTexture *this) {
   int iVar1;
   if (*(float*)( this + 0x2f8 ) != 0.0) {
      return (int)( *(float*)( this + 0x2f8 ) + *(float*)( this + 0x308 ) );
   }
   ...
   /* WARNING: Could not recover jumptable at 0x00100286. Too many branches */
   /* WARNING: Treating indirect jump as call */
   iVar1 = ( **(code**)( **(long**)( this + 0x2e8 ) + 0x1c8 ) )();
   return iVar1;
}
/* AtlasTexture::get_height() const */int AtlasTexture::get_height(AtlasTexture *this) {
   int iVar1;
   if (*(float*)( this + 0x2fc ) != 0.0) {
      return (int)( *(float*)( this + 0x2fc ) + *(float*)( this + 0x30c ) );
   }
...
/* AtlasTexture::set_margin(Rect2 const&) */void AtlasTexture::set_margin(AtlasTexture *this, Rect2 *param_1) {
   undefined8 uVar1;
   if (( ( ( *(float*)( this + 0x300 ) == *(float*)param_1 ) && ( *(float*)( this + 0x304 ) == *(float*)( param_1 + 4 ) ) ) && ( *(float*)( this + 0x308 ) == *(float*)( param_1 + 8 ) ) ) && ( *(float*)( this + 0x30c ) == *(float*)( param_1 + 0xc ) )) {
      return;
   }

   uVar1 = *(undefined8*)( param_1 + 8 );
   *(undefined8*)( this + 0x300 ) = *(undefined8*)param_1;
   *(undefined8*)( this + 0x308 ) = uVar1;
   Resource::emit_changed();
   return;
}
/* AtlasTexture::set_region(Rect2 const&) */void AtlasTexture::set_region(AtlasTexture *this, Rect2 *param_1) {
   undefined8 uVar1;
   if (( ( ( *(float*)( this + 0x2f0 ) == *(float*)param_1 ) && ( *(float*)( this + 0x2f4 ) == *(float*)( param_1 + 4 ) ) ) && ( *(float*)( this + 0x2f8 ) == *(float*)( param_1 + 8 ) ) ) && ( *(float*)( this + 0x2fc ) == *(float*)( param_1 + 0xc ) )) {
      return;
   }

   uVar1 = *(undefined8*)( param_1 + 8 );
   *(undefined8*)( this + 0x2f0 ) = *(undefined8*)param_1;
   *(undefined8*)( this + 0x2f8 ) = uVar1;
   Resource::emit_changed();
   return;
}
/* AtlasTexture::draw_rect(RID, Rect2 const&, bool, Color const&, bool) const */void AtlasTexture::draw_rect(AtlasTexture *this, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5, undefined1 param_6) {
   char cVar1;
   int iVar2;
   int iVar3;
   long lVar4;
   ...
   if (*(long**)( this + 0x2e8 ) != (long*)0x0) {
      lVar4 = *(long*)this;
      if (*(code**)( lVar4 + 0x1d0 ) == get_height) {
         if (*(float*)( this + 0x2fc ) == 0.0) {
            iVar2 = ( **(code**)( **(long**)( this + 0x2e8 ) + 0x1d0 ) )();
            lVar4 = *(long*)this;
         }
 else {
            iVar2 = (int)( *(float*)( this + 0x2fc ) + *(float*)( this + 0x30c ) );
         }

      }
 else {
         iVar2 = ( **(code**)( lVar4 + 0x1d0 ) )(this);
         lVar4 = *(long*)this;
      }

      if (*(code**)( lVar4 + 0x1c8 ) == get_width) {
         if (*(float*)( this + 0x2f8 ) == 0.0) {
            fVar5 = _LC4;
            if (*(long**)( this + 0x2e8 ) != (long*)0x0) {
               iVar3 = ( **(code**)( **(long**)( this + 0x2e8 ) + 0x1c8 ) )();
               lVar4 = *(long*)this;
               fVar5 = (float)iVar3;
            }
            ...
            fVar5 = (float)(int)( *(float*)( this + 0x2f8 ) + *(float*)( this + 0x308 ) );
         }

      }
 else {
         iVar3 = ( **(code**)( lVar4 + 0x1c8 ) )(this);
         lVar4 = *(long*)this;
         fVar5 = (float)iVar3;
      }

      local_70 = CONCAT44((float)iVar2, fVar5);
      local_78 = 0;
      local_68 = 0;
      local_60 = 0;
      local_58 = 0;
      local_50 = 0;
      cVar1 = ( **(code**)( lVar4 + 0x208 ) )(this, param_3, &local_78, &local_68, &local_58);
      if (cVar1 != '\0') {
         ( **(code**)( **(long**)( this + 0x2e8 ) + 0x200 ) )(*(long**)( this + 0x2e8 ), param_2, &local_68, &local_58, param_5, param_6, this[0x310]);
      }
...
/* AtlasTexture::get_atlas() const */void AtlasTexture::get_atlas(void) {
   char cVar1;
   long in_RSI;
   long *in_RDI;
   *in_RDI = 0;
...
/* AtlasTexture::_get_region_rect() const */undefined8 AtlasTexture::_get_region_rect(AtlasTexture *this) {
   float fVar1;
   undefined8 uVar2;
   uVar2 = *(undefined8*)( this + 0x2f0 );
   fVar1 = *(float*)( this + 0x2fc );
   if (*(long**)( this + 0x2e8 ) != (long*)0x0) {
      if (*(float*)( this + 0x2f8 ) == 0.0) {
         ( **(code**)( **(long**)( this + 0x2e8 ) + 0x1c8 ) )();
      }

      if (fVar1 == 0.0) {
         ( **(code**)( **(long**)( this + 0x2e8 ) + 0x1d0 ) )();
      }
...
/* AtlasTexture::draw(RID, Vector2 const&, Color const&, bool) const */void AtlasTexture::draw(AtlasTexture *this, undefined8 param_2, undefined8 *param_3, undefined8 param_4, undefined1 param_5) {
   long in_FS_OFFSET;
   ...
   if (*(long*)( this + 0x2e8 ) != 0) {
      local_58 = _get_region_rect(this);
      local_40 = local_58._8_8_;
      local_48 = CONCAT44((float)( ( ulong ) * param_3 >> 0x20 ) + (float)( ( ulong ) * (undefined8*)( this + 0x300 ) >> 0x20 ), (float)*param_3 + (float)*(undefined8*)( this + 0x300 ));
      ( **(code**)( **(long**)( this + 0x2e8 ) + 0x200 ) )(*(long**)( this + 0x2e8 ), param_2, &local_48, local_58, param_4, param_5, this[0x310]);
   }
...
/* AtlasTexture::get_rect_region(Rect2 const&, Rect2 const&, Rect2&, Rect2&) const */undefined8 AtlasTexture::get_rect_region(AtlasTexture *this, Rect2 *param_1, Rect2 *param_2, Rect2 *param_3, Rect2 *param_4) {
   long in_FS_OFFSET;
   float fVar1;
   undefined8 uVar2;
   float fVar3;
   ...
   if (*(long**)( this + 0x2e8 ) != (long*)0x0) {
      ...
      fVar9 = uStack_50._4_4_;
      fVar8 = (float)uStack_50;
      if (( (float)uStack_50 == 0.0 ) && ( uStack_50._4_4_ == 0.0 )) {
         uVar2 = *(undefined8*)( this + 0x2f8 );
         uStack_50._0_4_ = (float)uVar2;
         uStack_50._4_4_ = (float)( (ulong)uVar2 >> 0x20 );
         fVar9 = uStack_50._4_4_;
         fVar8 = (float)uStack_50;
         if (( (float)uStack_50 == 0.0 ) && ( uStack_50._4_4_ == 0.0 )) {
            uStack_50 = uVar2;
            uVar2 = ( **(code**)( **(long**)( this + 0x2e8 ) + 0x1d8 ) )();
            uStack_50._4_4_ = (float)( (ulong)uVar2 >> 0x20 );
            uStack_50._0_4_ = (float)uVar2;
            fVar9 = uStack_50._4_4_;
            fVar8 = (float)uStack_50;
      ...
      uStack_50 = uVar2;
      fVar6 = *(float*)( param_1 + 0xc ) / fVar9;
      fVar1 = ( (float)*(undefined8*)( this + 0x2f0 ) - (float)*(undefined8*)( this + 0x300 ) ) + (float)local_58;
      fVar3 = ( (float)( ( ulong ) * (undefined8*)( this + 0x2f0 ) >> 0x20 ) - (float)( ( ulong ) * (undefined8*)( this + 0x300 ) >> 0x20 ) ) + (float)( (ulong)local_58 >> 0x20 );
      local_58 = CONCAT44(fVar3, fVar1);
      fVar7 = *(float*)( param_1 + 8 ) / fVar8;
      local_48 = _get_region_rect(this);
      auVar10 = Rect2::intersection((Rect2*)local_48, (Rect2*)&local_58);
      fVar4 = auVar10._8_4_;
      fVar5 = auVar10._12_4_;
      if (( fVar5 != 0.0 ) || ( fVar4 != 0.0 )) {
         fVar1 = auVar10._0_4_ - fVar1;
         fVar3 = auVar10._4_4_ - fVar3;
         if (fVar7 < 0.0) {
            fVar1 = fVar1 + ( fVar4 - fVar8 );
         }

         if (fVar6 < 0.0) {
            fVar3 = fVar3 + ( fVar5 - fVar9 );
         }

         *(ulong*)param_3 = CONCAT44(fVar3 * fVar6 + *(float*)( param_1 + 4 ), fVar1 * fVar7 + *(float*)param_1);
         *(ulong*)( param_3 + 8 ) = CONCAT44(fVar5 * fVar6, fVar4 * fVar7);
   ...
   uVar2 = 0;
   LAB_00100a16:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* AtlasTexture::get_image() const */void AtlasTexture::get_image(void) {
   long *plVar1;
   long lVar2;
   char cVar3;
   AtlasTexture *in_RSI;
   ...
   if (*(long**)( in_RSI + 0x2e8 ) != (long*)0x0) {
      ( **(code**)( **(long**)( in_RSI + 0x2e8 ) + 0x210 ) )(&local_50);
      if (local_50 != (Object*)0x0) {
         local_48[0] = _get_region_rect(in_RSI);
         local_38 = Rect2::operator_cast_to_Rect2i((Rect2*)local_48);
         Image::get_region((Rect2i*)in_RDI);
         if (local_50 != (Object*)0x0) {
            cVar3 = RefCounted::unreference();
            if (cVar3 != '\0') {
               cVar3 = predelete_handler(local_50);
               if (cVar3 != '\0') {
                  if (*(code**)( *(long*)local_50 + 0x140 ) == Image::~Image) {
                     *(undefined8**)local_50 = &ObjectDB::slot_max;
                     if (*(long*)( local_50 + 0x250 ) != 0) {
                        LOCK();
                        plVar1 = (long*)( *(long*)( local_50 + 0x250 ) + -0x10 );
                        *plVar1 = *plVar1 + -1;
                        UNLOCK();
                        if (*plVar1 == 0) {
                           lVar2 = *(long*)( local_50 + 0x250 );
                           *(undefined8*)( local_50 + 0x250 ) = 0;
                           Memory::free_static((void*)( lVar2 + -0x10 ), false);
                        }

                     }

                     Resource::~Resource((Resource*)local_50);
                  }
 else {
   ...
   *in_RDI = 0;
   LAB_00100ba7:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* AtlasTexture::AtlasTexture() */void AtlasTexture::AtlasTexture(AtlasTexture *this) {
   Texture2D::Texture2D((Texture2D*)this);
   *(undefined8*)( this + 0x2e8 ) = 0;
   *(undefined***)this = &PTR__initialize_classv_0010b5e8;
   for (int i = 0; i < 4; i++) {
      *(undefined8*)( this + ( 8*i + 752 ) ) = 0;
   }

   this[0x310] = (AtlasTexture)0x0;
   return;
}
/* AtlasTexture::set_atlas(Ref<Texture2D> const&) */void AtlasTexture::set_atlas(AtlasTexture *this, Ref *param_1) {
   Callable *pCVar1;
   Callable *pCVar2;
   char cVar3;
   Object *pOVar4;
   ...
   Object *pOVar6;
   long in_FS_OFFSET;
   Resource aRStack_48[24];
   long local_30;
   pOVar5 = *(Object**)param_1;
   local_30 = *(long*)( in_FS_OFFSET + 0x28 );
   if (this == (AtlasTexture*)pOVar5) {
      if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         _err_print_error("set_atlas", "scene/resources/atlas_texture.cpp", 0x48, "Condition \"p_atlas == this\" is true.", 0, 0);
         return;
      }
   ...
   if (pOVar6 == (Object*)0x0) {
      if (pOVar5 != (Object*)0x0) {
         *(Object**)( this + 0x2e8 ) = pOVar5;
         cVar3 = RefCounted::reference();
         if (cVar3 == '\0') {
            LAB_00100d30:*(undefined8*)( this + 0x2e8 ) = 0;
            goto LAB_00100d3b;
         }
      ...
      pOVar4 = (Object*)__dynamic_cast(pOVar6, &Object::typeinfo, &typeinfo, 0);
      if (pOVar4 == (Object*)0x0) {
         *(Object**)( this + 0x2e8 ) = pOVar5;
         if (pOVar5 != (Object*)0x0) {
            LAB_00100d20:cVar3 = RefCounted::reference();
            if (cVar3 == '\0') goto LAB_00100d30;
            if (pOVar6 == (Object*)0x0) goto LAB_00100d50;
         }

         LAB_00100d40:cVar3 = RefCounted::unreference();
         if (( cVar3 != '\0' ) && ( cVar3 = cVar3 != '\0' )) {
            ( **(code**)( *(long*)pOVar6 + 0x140 ) )(pOVar6);
            Memory::free_static(pOVar6, false);
         }

         LAB_00100d50:pOVar6 = *(Object**)( this + 0x2e8 );
      }
 else {
         cVar3 = RefCounted::reference();
         if (cVar3 != '\0') {
            ...
            create_custom_callable_function_pointer<Resource>(aRStack_48, (char*)this, (_func_void*)"&AtlasTexture::emit_changed");
         ...
         if (pOVar5 != pOVar6) {
            *(Object**)( this + 0x2e8 ) = pOVar5;
            if (pOVar5 != (Object*)0x0) goto LAB_00100d20;
            LAB_00100d3b:if (pOVar6 == (Object*)0x0) goto LAB_00100d88;
            goto LAB_00100d40;
         }

      }

      if (( ( pOVar6 != (Object*)0x0 ) && ( pOVar5 = (Object*)__dynamic_cast(pOVar6, &Object::typeinfo, &typeinfo, 0) ),pOVar5 != (Object*)0x0 )) {
         cVar3 = RefCounted::unreference();
         if (( cVar3 != '\0' ) && ( cVar3 = cVar3 != '\0' )) {
         ...
         create_custom_callable_function_pointer<Resource>(aRStack_48, (char*)this, (_func_void*)"&AtlasTexture::emit_changed");
         Resource::connect_changed(pCVar2, (uint)aRStack_48);
         Callable::~Callable((Callable*)aRStack_48);
      }

   }

   LAB_00100d88:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      Resource::emit_changed();
      return;
   }

   LAB_00100f52:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* AtlasTexture::_bind_methods() */void AtlasTexture::_bind_methods(void) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   MethodBind *pMVar4;
   ...
   uVar5 = ( uint ) & local_58;
   local_58 = &local_68;
   D_METHODP((char*)&local_98, (char***)"set_atlas", uVar5);
   local_50 = (undefined1[16])0x0;
   local_58 = (char**)0x0;
   pMVar4 = create_method_bind<AtlasTexture,Ref<Texture2D>const&>(set_atlas);
 ...
 while ( lVar2 != lVar6 );
   ...
   D_METHODP((char*)&local_98, (char***)"get_atlas", 0);
   local_50 = (undefined1[16])0x0;
   local_58 = (char**)0x0;
   pMVar4 = create_method_bind<AtlasTexture,Ref<Texture2D>>(get_atlas);
   ClassDB::bind_methodfi(1, pMVar4, false, (MethodDefinition*)&local_98, (Variant**)0x0, 0);
   if (Variant::needs_deinit[(int)local_58] != '\0') {
      Variant::_clear_internal();
   }
 ...
 while ( lVar2 != lVar6 );
   ...
   local_60 = 0;
   local_58 = &local_68;
   D_METHODP((char*)&local_98, (char***)"set_region", uVar5);
   local_50 = (undefined1[16])0x0;
   local_58 = (char**)0x0;
   pMVar4 = create_method_bind<AtlasTexture,Rect2_const&>(set_region);
   ClassDB::bind_methodfi(1, pMVar4, false, (MethodDefinition*)&local_98, (Variant**)0x0, 0);
   if (Variant::needs_deinit[(int)local_58] != '\0') {
      Variant::_clear_internal();
   }
 ...
 while ( lVar2 != lVar6 );
   ...
   D_METHODP((char*)&local_98, (char***)"get_region", 0);
   local_50 = (undefined1[16])0x0;
   local_58 = (char**)0x0;
   pMVar4 = create_method_bind<AtlasTexture,Rect2>(get_region);
   ClassDB::bind_methodfi(1, pMVar4, false, (MethodDefinition*)&local_98, (Variant**)0x0, 0);
   if (Variant::needs_deinit[(int)local_58] != '\0') {
      Variant::_clear_internal();
   }
 ...
 while ( lVar2 != lVar6 );
   ...
   local_50 = (undefined1[16])0x0;
   local_58 = (char**)0x0;
   pMVar4 = create_method_bind<AtlasTexture,Rect2_const&>(set_margin);
   ClassDB::bind_methodfi(1, pMVar4, false, (MethodDefinition*)&local_98, (Variant**)0x0, 0);
   if (Variant::needs_deinit[(int)local_58] != '\0') {
      Variant::_clear_internal();
   }
 ...
 while ( lVar2 != lVar6 );
   ...
   local_50 = (undefined1[16])0x0;
   local_58 = (char**)0x0;
   pMVar4 = create_method_bind<AtlasTexture,Rect2>(get_margin);
   ClassDB::bind_methodfi(1, pMVar4, false, (MethodDefinition*)&local_98, (Variant**)0x0, 0);
   if (Variant::needs_deinit[(int)local_58] != '\0') {
      Variant::_clear_internal();
   }
 ...
 while ( lVar2 != lVar6 );
   ...
   local_60 = 0;
   local_58 = &local_68;
   D_METHODP((char*)&local_98, (char***)"set_filter_clip", uVar5);
   local_50 = (undefined1[16])0x0;
   local_58 = (char**)0x0;
   pMVar4 = create_method_bind<AtlasTexture,bool>(set_filter_clip);
   ClassDB::bind_methodfi(1, pMVar4, false, (MethodDefinition*)&local_98, (Variant**)0x0, 0);
   if (Variant::needs_deinit[(int)local_58] != '\0') {
      Variant::_clear_internal();
   }
 ...
 while ( lVar2 != lVar6 );
   ...
   D_METHODP((char*)&local_98, (char***)"has_filter_clip", 0);
   local_50 = (undefined1[16])0x0;
   local_58 = (char**)0x0;
   pMVar4 = create_method_bind<AtlasTexture,bool>(has_filter_clip);
   ClassDB::bind_methodfi(1, pMVar4, false, (MethodDefinition*)&local_98, (Variant**)0x0, 0);
   if (Variant::needs_deinit[(int)local_58] != '\0') {
      Variant::_clear_internal();
   }
 ...
 while ( lVar2 != lVar6 );
   ...
   local_78 = 0;
   if (local_c8 == 0) {
      LAB_001024c2:local_e0 = (CowData<char32_t>*)&local_78;
      local_70 = 6;
   ...
   local_78 = 0;
   if (local_c8 == 0) {
      LAB_00101bd0:local_70 = 6;
      StringName::operator =((StringName*)&local_88, (StringName*)&local_c0);
   }
 else {
      CowData<char32_t>::_ref(local_e0, (CowData*)&local_c8);
      local_70 = 6;
      if (local_80 != 0x11) goto LAB_00101bd0;
      StringName::StringName((StringName*)&local_a8, (String*)local_e0, false);
      if (local_88 == (long*)local_a8) {
         if (( StringName::configured != '\0' ) && ( local_a8 != (char*)0x0 )) {
            StringName::unref();
   ...
   local_78 = 0;
   if (local_c8 == 0) {
      LAB_00101e40:local_70 = 6;
      StringName::operator =((StringName*)&local_88, (StringName*)&local_c0);
   }
 else {
      CowData<char32_t>::_ref(local_e0, (CowData*)&local_c8);
      local_70 = 6;
      if (local_80 != 0x11) goto LAB_00101e40;
      StringName::StringName((StringName*)&local_a8, (String*)local_e0, false);
      if (local_88 == (long*)local_a8) {
         if (( StringName::configured != '\0' ) && ( local_a8 != (char*)0x0 )) {
            StringName::unref();
...
/* Texture::is_class_ptr(void*) const */uint Texture::is_class_ptr(Texture *this, void *param_1) {
   return (uint)CONCAT71(0x10bb, (undefined4*)param_1 == &Resource::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10ba, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10bb, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10bb, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
...
/* AtlasTexture::is_class_ptr(void*) const */uint AtlasTexture::is_class_ptr(void *param_1) {
   undefined4 in_EDX;
   undefined4 *in_RSI;
   return (uint)CONCAT71(0x10ba, in_RSI == &Texture2D::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10ba, in_RSI == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10ba, in_RSI == &Texture::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10bb, in_RSI == &Resource::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10bb, in_RSI == &RefCounted::get_class_ptr_static(), ::ptr) | CONCAT31(( int3 )((uint)in_EDX >> 8), in_RSI == &Object::get_class_ptr_static(), ::ptr);
}
/* AtlasTexture::_getv(StringName const&, Variant&) const */undefined8 AtlasTexture::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* AtlasTexture::_setv(StringName const&, Variant const&) */undefined8 AtlasTexture::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* AtlasTexture::_validate_propertyv(PropertyInfo&) const */void AtlasTexture::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* AtlasTexture::_property_can_revertv(StringName const&) const */undefined8 AtlasTexture::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* AtlasTexture::_property_get_revertv(StringName const&, Variant&) const */undefined8 AtlasTexture::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* AtlasTexture::_notificationv(int, bool) */void AtlasTexture::_notificationv(int param_1, bool param_2) {
   return;
}
/* CallableCustomMethodPointer<Resource, void>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<Resource,void>::~CallableCustomMethodPointer(CallableCustomMethodPointer<Resource,void> *this) {
   return;
}
...
/* CallableCustomMethodPointer<Resource, void>::get_argument_count(bool&) const */undefined8 CallableCustomMethodPointer<Resource,void>::get_argument_count(CallableCustomMethodPointer<Resource,void> *this, bool *param_1) {
   *param_1 = true;
   return 0;
}
/* CallableCustomMethodPointer<Resource, void>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<Resource,void>::~CallableCustomMethodPointer(CallableCustomMethodPointer<Resource,void> *this) {
...
/* Texture::~Texture() */void Texture::~Texture(Texture *this) {
   *(undefined***)this = &PTR__initialize_classv_0010b410;
...
/* MethodBindT<Ref<Texture2D> const&>::~MethodBindT() */void MethodBindT<Ref<Texture2D>const&>::~MethodBindT(MethodBindT<Ref<Texture2D>const&> *this) {
   *(undefined***)this = &PTR__gen_argument_type_0010b8a8;
...
/* MethodBindTRC<Ref<Texture2D>>::~MethodBindTRC() */void MethodBindTRC<Ref<Texture2D>>::~MethodBindTRC(MethodBindTRC<Ref<Texture2D>> *this) {
   *(undefined***)this = &PTR__gen_argument_type_0010b908;
   MethodBind::~MethodBind((MethodBind*)this);
   return;
}
/* MethodBindTRC<Ref<Texture2D>>::~MethodBindTRC() */void MethodBindTRC<Ref<Texture2D>>::~MethodBindTRC(MethodBindTRC<Ref<Texture2D>> *this) {
...
/* CallableCustomMethodPointer<Resource, void>::get_object() const */undefined8 CallableCustomMethodPointer<Resource,void>::get_object(CallableCustomMethodPointer<Resource,void> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   uVar2 = 0;
   LAB_00102cdd:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* AtlasTexture::get_base_extension() const */AtlasTexture * __thiscall AtlasTexture::get_base_extension(AtlasTexture *this){
   long lVar1;
   long in_FS_OFFSET;
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
   *(undefined8*)this = 0;
   ...
   *(code**)this = __cxa_guard_acquire;
   if (bVar3) {
      if (*(long*)( this + 0x2d0 ) != 0) {
         StringName::unref();
         if (StringName::configured == '\0') goto LAB_0010302f;
      }
   ...
   LAB_0010302f:*(undefined***)this = &PTR__initialize_classv_0010b410;
   Resource::~Resource((Resource*)this);
   return;
}
/* AtlasTexture::~AtlasTexture() */void AtlasTexture::~AtlasTexture(AtlasTexture *this) {
   ...
   *(code**)this = __cxa_guard_acquire;
   if (bVar3) {
      if (*(long*)( this + 0x2d0 ) != 0) {
         StringName::unref();
         if (StringName::configured == '\0') goto LAB_001031af;
      }
   ...
   LAB_001031af:*(undefined***)this = &PTR__initialize_classv_0010b410;
   Resource::~Resource((Resource*)this);
...
/* Texture::_get_class_namev() const */undefined8 *Texture::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00103253:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00103253;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "Texture");
   LAB_001032be:return &_get_class_namev();
}
/* AtlasTexture::_get_class_namev() const */undefined8 *AtlasTexture::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00103343:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00103343;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "AtlasTexture");
         goto LAB_001033ae;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "AtlasTexture");
   LAB_001033ae:return &_get_class_namev();
}
/* AtlasTexture::get_class() const */void AtlasTexture::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* MethodBindTRC<bool>::_gen_argument_type_info(int) const */undefined4 *MethodBindTRC<bool>::_gen_argument_type_info(int param_1) {
   ...
   *(undefined1(*) [16])( puVar3 + 2 ) = (undefined1[16])0x0;
   ...
   lVar2 = local_58;
   joined_r0x001036cc:local_58 = lVar2;
   if (lVar2 != 0) {
      LOCK();
...
/* MethodBindTRC<Rect2>::_gen_argument_type_info(int) const */undefined4 *MethodBindTRC<Rect2>::_gen_argument_type_info(int param_1) {
   ...
   *(undefined1(*) [16])( puVar3 + 2 ) = (undefined1[16])0x0;
   ...
   StringName::operator =((StringName*)( puVar3 + 4 ), (StringName*)&local_50);
   lVar2 = local_58;
   joined_r0x001039dc:local_58 = lVar2;
   if (lVar2 != 0) {
      LOCK();
      plVar1 = (long*)( lVar2 + -0x10 );
      *plVar1 = *plVar1 + -1;
...
/* CallableCustomMethodPointer<Resource, void>::call(Variant const**, int, Variant&,
   Callable::CallError&) const */void CallableCustomMethodPointer<Resource,void>::call(CallableCustomMethodPointer<Resource,void> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long *plVar1;
   long lVar2;
   long lVar3;
   char *pcVar4;
...
;
      ...
      ObjectDB::spin_lock._0_1_ = '\0';
      if (puVar6[1] == 0) goto LAB_0010404f;
      ...
      if (param_2 == 0) {
         *(undefined4*)param_4 = 0;
         ...
         if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
            /* WARNING: Could not recover jumptable at 0x00104028. Too many branches */
            /* WARNING: Treating indirect jump as call */
   ...
   LAB_001041b5:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<bool>::_gen_argument_type_info(int) const */undefined4 *MethodBindT<bool>::_gen_argument_type_info(int param_1) {
   ...
   *(undefined1(*) [16])( puVar8 + 2 ) = (undefined1[16])0x0;
   ...
   if (local_70 == 0) {
      ...
      local_30 = 6;
      if (local_40 != 0x11) goto LAB_001042f8;
   ...
   *puVar8 = local_58._0_4_;
   ...
   LAB_00104207:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* MethodBindT<Ref<Texture2D> const&>::_gen_argument_type_info(int) const */undefined4 *MethodBindT<Ref<Texture2D>const&>::_gen_argument_type_info(int param_1) {
   ...
   *(undefined1(*) [16])( puVar7 + 2 ) = (undefined1[16])0x0;
   ...
   if (local_70 == 0) {
      ...
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_38, (CowData*)&local_70);
      local_30 = 6;
      if (local_40 == 0x11) goto LAB_0010472d;
      StringName::operator =((StringName*)( local_50 + 8 ), (StringName*)&local_68);
   }
   ...
   *puVar7 = local_58._0_4_;
   ...
   LAB_00104527:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* MethodBindT<Rect2 const&>::_gen_argument_type_info(int) const */undefined4 *MethodBindT<Rect2_const&>::_gen_argument_type_info(int param_1) {
   ...
   *(undefined1(*) [16])( puVar8 + 2 ) = (undefined1[16])0x0;
   ...
   local_50 = auVar3 << 0x40;
   String::parse_latin1((StrRange*)&local_70);
   local_58 = (undefined*)CONCAT44(local_58._4_4_, 7);
   local_40 = 0;
   local_38 = 0;
   local_50 = (undefined1[16])0x0;
   if (local_70 == 0) {
      LAB_00104958:local_30 = 6;
      StringName::operator =((StringName*)( local_50 + 8 ), (StringName*)&local_68);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_38, (CowData*)&local_70);
      local_30 = 6;
      if (local_40 != 0x11) goto LAB_00104958;
      StringName::StringName((StringName*)&local_60, (String*)&local_38, false);
      if (local_50._8_8_ == local_60) {
         if (( StringName::configured != '\0' ) && ( local_60 != 0 )) {
            StringName::unref();
   ...
   *puVar8 = local_58._0_4_;
   ...
   LAB_00104867:if (local_20 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* RefCounted::is_class(String const&) const */undefined8 RefCounted::is_class(RefCounted *this, String *param_1) {
 ...
 while ( !bVar9 );
      ...
      LAB_00104d8f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
 ...
 while ( !bVar9 );
         ...
         LAB_00104ef3:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
      ...
      LAB_00104e43:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* Texture::is_class(String const&) const */undefined8 Texture::is_class(Texture *this, String *param_1) {
 ...
 while ( !bVar9 );
         ...
         LAB_00105193:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
   ...
   LAB_0010523c:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* AtlasTexture::is_class(String const&) const */undefined8 AtlasTexture::is_class(AtlasTexture *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long lVar4;
 ...
 while ( !bVar9 );
      ...
      LAB_001052bf:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   cVar6 = String::operator ==(param_1, "AtlasTexture");
   if (cVar6 == '\0') {
      for (lVar2 = *(long*)( this + 8 ); lVar2 != 0; lVar2 = *(long*)( lVar2 + 8 )) {
         lVar4 = *(long*)( lVar2 + 0x20 );
         if (lVar4 == 0) {
 ...
 while ( !bVar9 );
         ...
         LAB_00105433:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
   ...
   LAB_00105373:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_001054dc:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* Resource::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Resource::_get_property_listv(Resource *this, List *param_1, bool param_2) {
   ...
   local_58 = 0;
   if (local_90 == 0) {
      LAB_00105a58:local_50 = 0x80;
      StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_58, (CowData*)&local_90);
      local_50 = 0x80;
      if (local_60 != 0x11) goto LAB_00105a58;
      StringName::StringName((StringName*)&local_80, (String*)&local_58, false);
      if (local_68 != local_80) {
         StringName::unref();
         lVar2 = *(long*)param_1;
         local_68 = local_80;
         goto joined_r0x00105a75;
      }
...
/* Texture::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Texture::_get_property_listv(Texture *this, List *param_1, bool param_2) {
   ...
   local_58 = 0;
   if (local_90 == 0) {
      LAB_00105ea8:local_50 = 0x80;
      StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_58, (CowData*)&local_90);
      local_50 = 0x80;
      if (local_60 != 0x11) goto LAB_00105ea8;
      StringName::StringName((StringName*)&local_80, (String*)&local_58, false);
      if (local_68 != local_80) {
         StringName::unref();
         lVar2 = *(long*)param_1;
         local_68 = local_80;
         goto joined_r0x00105ec5;
      }
...
/* Texture2D::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Texture2D::_get_property_listv(Texture2D *this, List *param_1, bool param_2) {
   ...
   local_58 = 0;
   if (local_90 == 0) {
      LAB_00106358:local_50 = 0x80;
      StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   }
 else {
      CowData<char32_t>::_ref((CowData<char32_t>*)&local_58, (CowData*)&local_90);
      local_50 = 0x80;
      if (local_60 != 0x11) goto LAB_00106358;
      StringName::StringName((StringName*)&local_80, (String*)&local_58, false);
      if (local_68 != local_80) {
         StringName::unref();
         lVar2 = *(long*)param_1;
         local_68 = local_80;
         goto joined_r0x00106375;
      }
...
/* AtlasTexture::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void AtlasTexture::_get_property_listv(AtlasTexture *this, List *param_1, bool param_2) {
   long *plVar1;
   long lVar2;
   long lVar3;
   undefined1(*pauVar4)[16];
   ...
   *(int*)( plVar1 + 2 ) = (int)plVar1[2] + 1;
   ...
   StringName::StringName((StringName*)&local_78, "AtlasTexture", false);
   ClassDB::get_property_list((StringName*)&local_78, param_1, true, (Object*)this);
   if (( StringName::configured != '\0' ) && ( local_78 != (char*)0x0 )) {
      StringName::unref();
   }
...
/* Callable create_custom_callable_function_pointer<Resource>(Resource*, char const*, void
   (Resource::*)()) */Resource *create_custom_callable_function_pointer<Resource>(Resource *param_1, char *param_2, _func_void *param_3) {
   undefined8 uVar1;
   CallableCustom *this;
   undefined8 in_RCX;
   undefined8 in_R8;
   ...
   *(undefined***)this = &PTR_hash_0010b818;
...
/* MethodBind* create_method_bind<AtlasTexture, Ref<Texture2D> const&>(void
   (AtlasTexture::*)(Ref<Texture2D> const&)) */MethodBind *create_method_bind<AtlasTexture,Ref<Texture2D>const&>(_func_void_Ref_ptr *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<AtlasTexture, Ref<Texture2D>>(Ref<Texture2D> (AtlasTexture::*)()
   const) */MethodBind *create_method_bind<AtlasTexture,Ref<Texture2D>>(_func_Ref *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<AtlasTexture, Rect2 const&>(void (AtlasTexture::*)(Rect2 const&))
    */MethodBind *create_method_bind<AtlasTexture,Rect2_const&>(_func_void_Rect2_ptr *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<AtlasTexture, Rect2>(Rect2 (AtlasTexture::*)() const) */MethodBind *create_method_bind<AtlasTexture,Rect2>(_func_Rect2 *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<AtlasTexture, bool>(void (AtlasTexture::*)(bool)) */MethodBind *create_method_bind<AtlasTexture,bool>(_func_void_bool *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<AtlasTexture, bool>(bool (AtlasTexture::*)() const) */MethodBind *create_method_bind<AtlasTexture,bool>(_func_bool *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* AtlasTexture::_bind_methods() [clone .cold] */void AtlasTexture::_bind_methods(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* AtlasTexture::_initialize_classv() */void AtlasTexture::_initialize_classv(void) {
   long *plVar1;
   long lVar2;
   long in_FS_OFFSET;
   long local_70;
...
/* WARNING: Removing unreachable block (ram,0x00107ba8) *//* WARNING: Removing unreachable block (ram,0x00107cd8) *//* WARNING: Removing unreachable block (ram,0x00107ea0) *//* WARNING: Removing unreachable block (ram,0x00107ce4) *//* WARNING: Removing unreachable block (ram,0x00107cee) *//* WARNING: Removing unreachable block (ram,0x00107e80) *//* WARNING: Removing unreachable block (ram,0x00107cfa) *//* WARNING: Removing unreachable block (ram,0x00107d04) *//* WARNING: Removing unreachable block (ram,0x00107e60) *//* WARNING: Removing unreachable block (ram,0x00107d10) *//* WARNING: Removing unreachable block (ram,0x00107d1a) *//* WARNING: Removing unreachable block (ram,0x00107e40) *//* WARNING: Removing unreachable block (ram,0x00107d26) *//* WARNING: Removing unreachable block (ram,0x00107d30) *//* WARNING: Removing unreachable block (ram,0x00107e20) *//* WARNING: Removing unreachable block (ram,0x00107d3c) *//* WARNING: Removing unreachable block (ram,0x00107d46) *//* WARNING: Removing unreachable block (ram,0x00107e00) *//* WARNING: Removing unreachable block (ram,0x00107d52) *//* WARNING: Removing unreachable block (ram,0x00107d5c) *//* WARNING: Removing unreachable block (ram,0x00107de0) *//* WARNING: Removing unreachable block (ram,0x00107d64) *//* WARNING: Removing unreachable block (ram,0x00107d7a) *//* WARNING: Removing unreachable block (ram,0x00107d86) *//* String vformat<StringName>(String const&, StringName const) */undefined8 *vformat<StringName>(undefined8 *param_1, bool *param_2, StringName *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (( ( plVar7 != (long*)0x0 ) && ( plVar7[1] != 0 ) ) && ( *(char*)( plVar7[1] + 0x2e ) != '\0' )) {
      ...
      if (local_58 == (char*)*plVar6) {
         ...
         _err_print_error(&_LC18, "./core/object/method_bind.h", 0x267, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: ret", (StringName*)&local_58, 0, 0);
         pcVar3 = local_58;
   ...
   LAB_00108070:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTRC<bool>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTRC<bool>::validated_call(MethodBindTRC<bool> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   param_3[8] = VVar3;
   LAB_00108362:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<bool>::ptrcall(Object*, void const**, void*) const */void MethodBindTRC<bool>::ptrcall(MethodBindTRC<bool> *this, Object *param_1, void **param_2, void *param_3) {
   ...
   *(undefined1*)param_3 = uVar3;
   LAB_00108561:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindT<bool>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<bool>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Could not recover jumptable at 0x00108769. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), *(undefined1*)( *(long*)param_3 + 8 ));
      return;
   }

   LAB_00108925:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<bool>::ptrcall(Object*, void const**, void*) const */void MethodBindT<bool>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   ...
   if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Could not recover jumptable at 0x0010898e. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), **param_3 != '\0');
      return;
   }

   LAB_00108b45:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (( ( plVar6 != (long*)0x0 ) && ( plVar6[1] != 0 ) ) && ( *(char*)( plVar6[1] + 0x2e ) != '\0' )) {
      ...
      if (local_68 == (char*)*plVar5) {
         ...
         _err_print_error(&_LC18, "./core/object/method_bind.h", 0x267, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: ret", (StringName*)&local_68, 0, 0);
         pcVar3 = local_68;
   ...
   LAB_00108c20:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTRC<Rect2>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTRC<Rect2>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   *(undefined8*)( in_RCX + 0x10 ) = in_XMM1_Qa;
   LAB_00108e8b:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindTRC<Rect2>::ptrcall(Object*, void const**, void*) const */void MethodBindTRC<Rect2>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   ...
   *in_RCX = uVar5;
   in_RCX[1] = in_XMM1_Qa;
   LAB_0010908a:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindT<Rect2 const&>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<Rect2_const&>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   LAB_00109455:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<Rect2 const&>::ptrcall(Object*, void const**, void*) const */void MethodBindT<Rect2_const&>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   ...
   if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Could not recover jumptable at 0x001094b5. Too many branches */
      /* WARNING: Treating indirect jump as call */
      ( *UNRECOVERED_JUMPTABLE )((long*)( (long)param_2 + *(long*)( param_1 + 0x60 ) ), *param_3);
      return;
   }

   LAB_00109675:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindTRC<Ref<Texture2D>>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindTRC<Ref<Texture2D>>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   ...
   LAB_00109790:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTRC<Ref<Texture2D>>::ptrcall(Object*, void const**, void*) const */void MethodBindTRC<Ref<Texture2D>>::ptrcall(MethodBindTRC<Ref<Texture2D>> *this, Object *param_1, void **param_2, void *param_3) {
   ...
   if (local_48 == (Object*)0x0) {
      /* WARNING: Load size is inaccurate */
      pOVar6 = *param_3;
      if (pOVar6 == (Object*)0x0) goto LAB_00109a66;
   ...
   if (pOVar6 != pOVar4) {
      *(Object**)param_3 = pOVar4;
      if (pOVar4 == (Object*)0x0) {
         if (pOVar6 != (Object*)0x0) goto LAB_00109aa9;
      }
 else {
         ...
         if (pOVar6 != (Object*)0x0) {
            LAB_00109aa9:cVar2 = RefCounted::unreference();
            if (cVar2 != '\0') {
         ...
         if (local_48 == (Object*)0x0) goto LAB_00109a66;
      }
   ...
   LAB_00109a66:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindT<Ref<Texture2D> const&>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<Ref<Texture2D>const&>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   if (pOVar5 != local_58) {
      if (pOVar5 == (Object*)0x0) {
         if (local_58 != (Object*)0x0) {
            local_58 = (Object*)0x0;
            LAB_00109d66:cVar4 = RefCounted::unreference();
            if (cVar4 != '\0') {
         ...
         if (pOVar3 != pOVar5) {
            ...
            if (pOVar3 != (Object*)0x0) goto LAB_00109d66;
         }
   ...
   LAB_00109da8:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindT<Ref<Texture2D> const&>::ptrcall(Object*, void const**, void*) const */void MethodBindT<Ref<Texture2D>const&>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   ...
   if (( *param_3 == (long*)0x0 ) || ( local_48 = (Object*)**param_3 ),local_48 == (Object*)0x0) {
      LAB_0010a098:local_48 = (Object*)0x0;
   }
 else {
      cVar4 = RefCounted::init_ref();
      if (cVar4 == '\0') goto LAB_0010a098;
   }
   ...
   LAB_0010a0bc:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* MethodBindT<Rect2 const&>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindT<Rect2_const&>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   if (( ( plVar10 != (long*)0x0 ) && ( plVar10[1] != 0 ) ) && ( *(char*)( plVar10[1] + 0x2e ) != '\0' )) {
      ...
      if (local_58 == (char*)*plVar8) {
         ...
         String::parse_latin1((StrRange*)&local_60);
         vformat<StringName>((StringName*)&local_58, (StrRange*)&local_60, &local_68);
         _err_print_error(&_LC18, "./core/object/method_bind.h", 0x154, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: Variant()", (StringName*)&local_58, 0);
         pcVar5 = local_58;
         if (local_58 != (char*)0x0) {
            LOCK();
   ...
   if (in_R8D < 2) {
      ...
      if (pVVar11 == (Variant*)0x0) {
         ...
         LAB_0010a4d0:pVVar11 = *(Variant**)param_4;
      }
 else {
         lVar2 = *(long*)( pVVar11 + -8 );
         if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
            LAB_0010a4e0:uVar7 = 4;
            goto LAB_0010a47d;
         }
      ...
      *in_R9 = 0;
      ...
      cVar6 = Variant::can_convert_strict(*(undefined4*)pVVar11, 7);
      uVar4 = _LC57;
      if (cVar6 == '\0') {
         *in_R9 = 2;
      ...
      local_48[0] = Variant::operator_cast_to_Rect2(pVVar11);
      ( *(code*)pVVar12 )((Variant*)( (long)plVar10 + (long)pVVar1 ), local_48);
   }
 else {
      uVar7 = 3;
      LAB_0010a47d:*in_R9 = uVar7;
      in_R9[2] = 1;
   }

   LAB_0010a488:*(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
...
/* MethodBindT<Ref<Texture2D> const&>::call(Object*, Variant const**, int, Callable::CallError&)
   ...
   if (( ( plVar11 != (long*)0x0 ) && ( plVar11[1] != 0 ) ) && ( *(char*)( plVar11[1] + 0x2e ) != '\0' )) {
      ...
      if (local_48 == (Object*)*plVar9) {
         ...
         String::parse_latin1((StrRange*)&local_50);
         vformat<StringName>((StringName*)&local_48, (StrRange*)&local_50, &local_58);
         _err_print_error(&_LC18, "./core/object/method_bind.h", 0x154, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: Variant()", (StringName*)&local_48, 0);
         pOVar5 = local_48;
         if (local_48 != (Object*)0x0) {
            LOCK();
   ...
   if (pVVar12 == (Variant*)0x0) {
      if (in_R8D != 1) goto LAB_0010a8e0;
      LAB_0010a8d0:pVVar12 = *(Variant**)param_4;
   }
 else {
      lVar2 = *(long*)( pVVar12 + -8 );
      if ((int)lVar2 < (int)( in_R8D ^ 1 )) {
         LAB_0010a8e0:uVar7 = 4;
         goto LAB_0010a885;
      }

      if (in_R8D == 1) goto LAB_0010a8d0;
   ...
   *in_R9 = 0;
   ...
   if (pOVar8 != local_48) {
      if (pOVar8 == (Object*)0x0) {
         if (local_48 != (Object*)0x0) {
            local_48 = (Object*)0x0;
            LAB_0010a9fd:cVar6 = RefCounted::unreference();
            if (cVar6 != '\0') {
         ...
         if (pOVar5 != pOVar8) {
            ...
            if (pOVar5 != (Object*)0x0) goto LAB_0010a9fd;
         }
   ...
   LAB_0010a890:*(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindTRC<Ref<Texture2D>>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindTRC<Ref<Texture2D>>::validated_call(MethodBindTRC<Ref<Texture2D>> *this, Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   LAB_0010abf6:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* void call_with_variant_args_dv<__UnexistingClass, bool>(__UnexistingClass*, void
   ...
   if (lVar1 == 0) {
      if (uVar8 != 1) goto LAB_0010af40;
   }
 else {
      lVar2 = *(long*)( lVar1 + -8 );
      if ((int)lVar2 < (int)( uVar8 ^ 1 )) {
         LAB_0010af40:uVar6 = 4;
   ...
   LAB_0010ae5b:*(undefined4*)param_6 = 0;
   ...
   /* WARNING: Could not recover jumptable at 0x0010aeb7. Too many branches */
   /* WARNING: Treating indirect jump as call */
...
/* MethodBindT<bool>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindT<bool>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   *(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   LAB_0010afa6:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<Resource, void>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<Resource,void>::~CallableCustomMethodPointer(CallableCustomMethodPointer<Resource,void> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* AtlasTexture::~AtlasTexture() */void AtlasTexture::~AtlasTexture(AtlasTexture *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

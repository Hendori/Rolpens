...
/* icu_76_godot::DictionaryBreakEngine::findBreaks(UText*, int, int, icu_76_godot::UVector32&,
   signed char, UErrorCode&) const */undefined1  [16] __thiscallicu_76_godot::DictionaryBreakEngine::findBreaks(DictionaryBreakEngine *this, undefined8 param_1, undefined8 param_3_00, int param_3, undefined8 param_4, char param_6, int *param_7) {
   char cVar1;
   undefined4 uVar2;
   int iVar3;
   uint uVar4;

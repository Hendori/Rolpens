/* CollisionShape3DGizmoPlugin::get_priority() const */undefined8 CollisionShape3DGizmoPlugin::get_priority(void) {
   return 0xffffffff;
}
/* CollisionShape3DGizmoPlugin::begin_handle_action(EditorNode3DGizmo const*, int, bool) */void CollisionShape3DGizmoPlugin::begin_handle_action(CollisionShape3DGizmoPlugin *this, EditorNode3DGizmo *param_1, int param_2, bool param_3) {
   Variant *pVVar1;
   long in_FS_OFFSET;
   int local_98[22];
   long local_40;
...
/* LocalVector<Geometry3D::MeshData::Face, unsigned int, false, false>::resize(unsigned int) [clone
   .part.0] */void LocalVector<Geometry3D::MeshData::Face,unsigned_int,false,false>::resize(uint param_1) {
   code *pcVar1;
...
/* CollisionShape3DGizmoPlugin::has_gizmo(Node3D*) */bool CollisionShape3DGizmoPlugin::has_gizmo(CollisionShape3DGizmoPlugin *this, Node3D *param_1) {
   long lVar1;
...
/* CollisionShape3DGizmoPlugin::~CollisionShape3DGizmoPlugin() */void CollisionShape3DGizmoPlugin::~CollisionShape3DGizmoPlugin(CollisionShape3DGizmoPlugin *this) {
   Object *pOVar1;
   char cVar2;
...
/* void Ref<CylinderShape3D>::TEMPNAMEPLACEHOLDERVALUE(Ref<Shape3D> const&) [clone .isra.0] */void Ref<CylinderShape3D>::operator =(Ref<CylinderShape3D> *this, Ref *param_1) {
   Object *pOVar1;
   char cVar2;
   Object *pOVar3;
   pOVar1 = *(Object**)this;
...
/* void Ref<CapsuleShape3D>::TEMPNAMEPLACEHOLDERVALUE(Ref<Shape3D> const&) [clone .isra.0] */void Ref<CapsuleShape3D>::operator =(Ref<CapsuleShape3D> *this, Ref *param_1) {
   Object *pOVar1;
   char cVar2;
   Object *pOVar3;
   pOVar1 = *(Object**)this;
...
/* void Ref<SeparationRayShape3D>::TEMPNAMEPLACEHOLDERVALUE(Ref<Shape3D> const&) [clone .isra.0] */void Ref<SeparationRayShape3D>::operator =(Ref<SeparationRayShape3D> *this, Ref *param_1) {
   Object *pOVar1;
   char cVar2;
   Object *pOVar3;
   pOVar1 = *(Object**)this;
...
/* void Ref<Material>::TEMPNAMEPLACEHOLDERVALUE(Ref<StandardMaterial3D> const&) [clone .isra.0] */void Ref<Material>::operator =(Ref<Material> *this, Ref *param_1) {
   Object *pOVar1;
   char cVar2;
   Object *pOVar3;
   pOVar1 = *(Object**)this;
...
/* CollisionShape3DGizmoPlugin::get_gizmo_name() const */CollisionShape3DGizmoPlugin * __thiscall
...
/* CollisionShape3DGizmoPlugin::get_handle_name(EditorNode3DGizmo const*, int, bool) const */CollisionShape3DGizmoPlugin * __thiscall
...
/* CollisionShape3DGizmoPlugin::set_handle(EditorNode3DGizmo const*, int, bool, Camera3D*, Vector2
   const&) */void CollisionShape3DGizmoPlugin::set_handle(CollisionShape3DGizmoPlugin *this, EditorNode3DGizmo *param_1, int param_2, bool param_3, Camera3D *param_4, Vector2 *param_5) {
   char cVar1;
   Vector3 *pVVar2;
   Object *pOVar3;
   long lVar4;
   ...
   if (pOVar3 != (Object*)0x0) {
      ...
      local_64 = 0;
      local_5c = 0;
      Geometry3D::get_closest_points_between_segments((Vector3*)&local_64, (Vector3*)&local_88, (Vector3*)&local_58, (Vector3*)&local_4c, (Vector3*)&local_7c, local_70);
   ...
   if (pOVar3 != (Object*)0x0) {
      ...
      local_64 = 0;
      local_5c = 0;
      Gizmo3DHelper::box_set_handle(*(Vector3**)( this + 0x450 ), iVar6, (Vector3*)(ulong)(uint)param_2, local_70);
   ...
   if (lVar4 != 0) {
      ...
      *(undefined4*)( (long)&local_98 + ( ulong )(param_2 != 0) * 4 ) = 0x3f800000;
      ...
      if (param_2 == 0) {
         ...
         LAB_001011c3:cVar1 = RefCounted::unreference();
         if (( cVar1 != '\0' ) && ( cVar1 = cVar1 != '\0' )) {
   ...
   if (pOVar5 != (Object*)0x0) {
      ...
      local_64 = 0;
      local_5c = 0;
      Gizmo3DHelper::cylinder_set_handle(*(Vector3**)( this + 0x450 ), iVar6, (float*)(ulong)(uint)param_2, &local_a8, (Vector3*)&local_a4);
   ...
   LAB_00101156:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* CollisionShape3DGizmoPlugin::get_handle_value(EditorNode3DGizmo const*, int, bool) const */CollisionShape3DGizmoPlugin * __thiscall
CollisionShape3DGizmoPlugin::get_handle_value
   ...
   LAB_001013ca:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return this;
   }
...
/* CollisionShape3DGizmoPlugin::commit_handle(EditorNode3DGizmo const*, int, bool, Variant const&,
   bool) */void CollisionShape3DGizmoPlugin::commit_handle(CollisionShape3DGizmoPlugin *this, EditorNode3DGizmo *param_1, int param_2, bool param_3, Variant *param_4, bool param_5) {
   String *pSVar1;
   char cVar2;
   Object *pOVar3;
   Object *pOVar4;
   ...
   if (pOVar4 == (Object*)0x0) {
      LAB_00101996:lVar6 = __dynamic_cast(local_f8, &Object::typeinfo, &BoxShape3D::typeinfo, 0);
      if (lVar6 != 0) {
         ...
         Gizmo3DHelper::box_commit_handle(pSVar1, SUB81((String*)&local_c0, 0), (Object*)(ulong)param_5, pOVar3, local_f8, (StringName*)&local_b8);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_c0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_d0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_c8);
         if (( StringName::configured != '\0' ) && ( ( ( local_b8 == 0 || ( StringName::unref(),StringName::configured != '\0' ) ) && ( local_b0 != 0 ) ) )) {
            StringName::unref();
         }
      ...
      if (pOVar4 != (Object*)0x0) {
         ...
         EditorUndoRedoManager::add_undo_methodp((Object*)pEVar7, (StringName*)pOVar4, (Variant**)&local_b0, (int)local_98);
   ...
   if (pOVar4 != (Object*)0x0) {
      ...
      Gizmo3DHelper::cylinder_commit_handle((int)uVar10, (String*)(ulong)(uint)param_2, local_e0, SUB81((String*)&local_c8, 0), (Object*)(ulong)param_5, pOVar3, pOVar4, (StringName*)pOVar4, (StringName*)&local_c0, (StringName*)&local_b8);
...
lVar6 = __dynamic_cast(local_f8, &Object::typeinfo, &SeparationRayShape3D::typeinfo, 0);if (lVar6 != 0) {
   local_c8 = (Object*)0x0;
   pOVar4 = (Object*)__dynamic_cast(local_f8, &Object::typeinfo, &SeparationRayShape3D::typeinfo, 0);
   if (pOVar4 == (Object*)0x0) {
      LAB_00102299:pOVar4 = (Object*)0x0;
   }
 else {
      local_c8 = pOVar4;
      cVar2 = RefCounted::reference();
   ...
   if (!param_5) {
      ...
      EditorUndoRedoManager::add_undo_methodp((Object*)pEVar7, (StringName*)pOVar4, (Variant**)&local_b0, (int)local_a8);
      if (Variant::needs_deinit[(int)local_60] != '\0') {
         Variant::_clear_internal();
      }
   ...
   if (!param_5) {
      ...
      local_58 = (undefined1[16])0x0;
      local_98[0] = (Variant*)local_78;
      EditorUndoRedoManager::add_do_methodp(pOVar5, (StringName*)pOVar4, (Variant**)&local_b0, (int)(Variant*)local_98);
      if (Variant::needs_deinit[(int)local_60] != '\0') {
         Variant::_clear_internal();
      }
      ...
      local_58 = (undefined1[16])0x0;
      local_a8[0] = (Variant*)local_78;
      EditorUndoRedoManager::add_undo_methodp(pOVar5, (StringName*)pOVar4, (Variant**)&local_b0, (int)local_a8);
      if (Variant::needs_deinit[(int)local_60] != '\0') {
         Variant::_clear_internal();
      }
   ...
   cVar2 = RefCounted::unreference();
   joined_r0x00102218:if (( cVar2 != '\0' ) && ( cVar2 = cVar2 != '\0' )) {
      ( **(code**)( *(long*)pOVar4 + 0x140 ) )(pOVar4);
      Memory::free_static(pOVar4, false);
   }

   LAB_00102220:if (local_f8 == (StringName*)0x0) goto LAB_00102233;
}
cVar2 = RefCounted::unreference();if (( cVar2 != '\0' ) && ( cVar2 = predelete_handler((Object*)local_f8) ),cVar2 != '\0') {
   ( **(code**)( *(long*)local_f8 + 0x140 ) )(local_f8);
   Memory::free_static(local_f8, false);
}
LAB_00102233:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* CowData<Vector3>::_copy_on_write() [clone .isra.0] */void CowData<Vector3>::_copy_on_write(CowData<Vector3> *this) {
   long lVar1;
   code *pcVar2;
   undefined8 *puVar3;
   size_t __n;
...
/* CowData<Ref<StandardMaterial3D> >::_ref(CowData<Ref<StandardMaterial3D> > const&) [clone .part.0]
    */void CowData<Ref<StandardMaterial3D>>::_ref(CowData<Ref<StandardMaterial3D>> *this, CowData *param_1) {
   long *plVar1;
   long lVar2;
   long lVar3;
   bool bVar4;
...
/* CowData<Ref<StandardMaterial3D> >::_copy_on_write() [clone .isra.0] */void CowData<Ref<StandardMaterial3D>>::_copy_on_write(CowData<Ref<StandardMaterial3D>> *this) {
   long lVar1;
   long lVar2;
   code *pcVar3;
   char cVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* CollisionShape3DGizmoPlugin::create_collision_material(String const&, float) */void CollisionShape3DGizmoPlugin::create_collision_material(CollisionShape3DGizmoPlugin *this, String *param_1, float param_2) {
   undefined8 *puVar1;
   Object *pOVar2;
   undefined8 uVar3;
   char cVar4;
   ...
   local_60 = 0;
   do if (iVar8 == 4) {
      lVar6 = HashMap<String,Vector<Ref<StandardMaterial3D>>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Vector<Ref<StandardMaterial3D>>>>>::operator []((HashMap<String,Vector<Ref<StandardMaterial3D>>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Vector<Ref<StandardMaterial3D>>>>>*)( this + 0x270 ), param_1);
      if (*(long*)( lVar6 + 8 ) != lVar7) {
         CowData<Ref<StandardMaterial3D>>::_ref((CowData<Ref<StandardMaterial3D>>*)( lVar6 + 8 ), (CowData*)&local_60);
      }
   ...
   *(undefined1(*) [16])( this_00 + 0x1a8 ) = auVar7;
   ...
   if (cVar1 == '\0') {
      ...
      *(undefined8*)( this + 0x450 ) = 0;
      ...
      cVar1 = predelete_handler(pOVar5);
      if (cVar1 == '\0') goto LAB_00102e38;
      LAB_001030a3:( **(code**)( *(long*)pOVar5 + 0x140 ) )(pOVar5);
      Memory::free_static(pOVar5, false);
      ...
      if (this_00 != (RefCounted*)pOVar5) {
         *(RefCounted**)( this + 0x450 ) = this_00;
         ...
         pOVar4 = (Object*)this_00;
         if (( ( pOVar5 != (Object*)0x0 ) && ( cVar1 = RefCounted::unreference() ),cVar1 != '\0' )) goto LAB_001030a3;
      }
   ...
   LAB_00102e38:local_50 = (Object*)0x0;
   local_40 = 0xe;
   ...
   if (( ( local_50 != (Object*)0x0 ) && ( cVar1 = RefCounted::unreference() ),pOVar5 = local_50,cVar1 != '\0' )) &&( cVar1 = cVar1 != '\0' )(**(code**)( *(long*)pOVar5 + 0x140 ))(pOVar5);
   Memory::free_static(pOVar5, false);
}
...
return;}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* CollisionShape3DGizmoPlugin::redraw(EditorNode3DGizmo*) */void CollisionShape3DGizmoPlugin::redraw(CollisionShape3DGizmoPlugin *this, EditorNode3DGizmo *param_1) {
   undefined8 *puVar1;
   undefined8 *puVar2;
   uint uVar3;
   uint uVar4;
   ...
   if (( ( local_2f8 != (EditorNode3DGizmo*)0x0 ) && ( cVar7 = RefCounted::unreference() ),pEVar6 = local_2f8,cVar7 != '\0' )) &&( cVar7 = cVar7 != '\0' )(**(code**)( *(long*)pEVar6 + 0x140 ))(pEVar6);
   Memory::free_static(pEVar6, false);
}
local_2f8 = param_1;cVar7 = RefCounted::init_ref();if (cVar7 == '\0') {
   local_2f8 = (EditorNode3DGizmo*)0x0;
}
cVar7 = CollisionShape3D::is_disabled();pcVar16 = "shape_material_arraymesh_disabled";local_308 = (Object*)0x0;if (cVar7 == '\0') {
   pcVar16 = "shape_material_arraymesh";
}
String::parse_latin1((String*)&local_308, pcVar16);EditorNode3DGizmoPlugin::get_material((String*)&local_340, (Ref*)this);CowData<char32_t>::_unref((CowData<char32_t>*)&local_308);if (( ( local_2f8 != (EditorNode3DGizmo*)0x0 ) && ( cVar7 = RefCounted::unreference() ),pEVar6 = local_2f8,cVar7 != '\0' )) &&( cVar7 = cVar7 != '\0' )(**(code**)( *(long*)pEVar6 + 0x140 ))(pEVar6);Memory::free_static(pEVar6, false);}local_308 = (Object*)0x0;local_318 = (Object*)0x0;String::parse_latin1((String*)&local_318, "handles");EditorNode3DGizmoPlugin::get_material((String*)&local_2f8, (Ref*)this);local_338 = 0;Ref<Material>::operator =((Ref<Material>*)&local_338, (Ref*)local_2f8);Ref<StandardMaterial3D>::unref((Ref<StandardMaterial3D>*)&local_2f8);CowData<char32_t>::_unref((CowData<char32_t>*)&local_318);if (( ( local_308 != (Object*)0x0 ) && ( cVar7 = RefCounted::unreference() ),pOVar9 = local_308,cVar7 != '\0' )) &&( cVar7 = cVar7 != '\0' )(**(code**)( *(long*)pOVar9 + 0x140 ))(pOVar9);Memory::free_static(pOVar9, false);}cVar7 = CollisionShape3D::is_disabled();if (cVar7 == '\0') {
...
cVar7 = CollisionShape3D::get_debug_fill_enabled();if (cVar7 != '\0') {
   ...
   if (local_328 != (Object*)0x0) {
      ...
      if (0 < iVar8) {
         ...
         EditorNode3DGizmo::add_mesh((Ref*)param_1, (Ref*)&local_318, (Transform3D*)&local_308, (Ref*)&local_b8);
...
pRVar17 = local_350;if (local_350 != (Ref*)0x0) {
...
;
      ...
      local_2f0 = 0;
      EditorNode3DGizmo::add_handles((Vector*)param_1, (Ref*)&local_308, (Vector*)&local_338, bVar14, false);
 ...
 while ( uVar21 != 0xc );
   ...
   if (lVar11 != 0) {
      ...
      while (true) {
         ...
         if (( ( uint )(iVar8 * -0x5b05b05b) >> 1 | ( uint )(( iVar8 * -0x5b05b05b & 1U ) != 0) << 0x1f ) < 0x2d82d83) {
            local_288 = uVar31;
            local_280 = fVar35;
            Vector<Vector3>::push_back(uVar31, fVar35, (Ref*)&local_328);
            local_278 = uVar37;
...
;
      ...
      if (iVar8 == 0) {
         ...
         do {
            if (local_300 == 0) {
               lVar18 = 0;
               LAB_00105884:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar23, lVar18, "p_index", "size()", "", false, false);
            }
 else {
...
;
   ...
   if (pOVar9 != (Object*)0x0) {
      ...
      if (iVar8 == 0) {
         ...
         do {
            if (local_2f0 == 0) {
               lVar18 = 0;
               LAB_001058c6:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar23, lVar18, "p_index", "size()", "", false, false);
            }
 else {
 ...
 while ( lVar11 != 0x78 );
   ...
   if (lVar11 != 0) {
      ...
      if (( local_320 != 0 ) && ( 1 < *(long*)( local_320 + -8 ) )) {
         ...
         if (iVar8 == 0) {
            local_300 = 0;
            CowData<Vector3>::resize<false>((CowData<Vector3>*)&local_300, ( ulong )((uint)local_2e8 * 2));
            if ((uint)local_2e8 != 0) {
               uVar21 = 1;
               uVar20 = 0;
               do {
                  ...
                  if (local_300 == 0) {
                     LAB_00105d3a:uVar19 = 0;
                     uVar13 = uVar24;
                     LAB_00105d3d:iVar8 = 0x38;
                     pcVar16 = "./core/templates/vector.h";
                     pcVar43 = "((Vector<T> *)(this))->_cowdata.size()";
                     LAB_00105d23:_err_print_index_error("operator[]", pcVar16, iVar8, uVar13, uVar19, "p_index", pcVar43, "", false, true);
                     _err_flush_stdout();
                     /* WARNING: Does not return */
                  ...
                  *(undefined4*)( puVar2 + 1 ) = *(undefined4*)( puVar1 + 1 );
                  if ((uint)local_2e8 <= (uint)uVar20) {
                     ...
                     LAB_00105cfc:uVar19 = (ulong)uVar4;
                     iVar8 = 0xb2;
 ...
 while ( (uint)uVar20 < (uint)local_2e8 );
            ...
            EditorNode3DGizmo::add_lines((Vector*)param_1, (Ref*)&local_308, SUB81((Ref<Material>*)&local_330, 0), (Color*)0x0);
   ...
   if (lVar11 != 0) {
      ...
      if (iVar8 == 0) {
         ...
         do {
            if (local_310 == 0) {
               lVar18 = 0;
               LAB_00105845:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar23, lVar18, "p_index", "size()", "", false, false);
            }
 else {
...
LAB_00105051:Ref<Material>::unref((Ref<Material>*)&local_338);Ref<StandardMaterial3D>::unref((Ref<StandardMaterial3D>*)&local_340);Ref<StandardMaterial3D>::unref((Ref<StandardMaterial3D>*)&local_348);LAB_00105078:Ref<Shape3D>::unref((Ref<Shape3D>*)&local_350);if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
...
/* RefCounted::is_class_ptr(void*) const */uint RefCounted::is_class_ptr(RefCounted *this, void *param_1) {
   return (uint)CONCAT71(0x10b7, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10b7, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr);
}
...
/* StandardMaterial3D::is_class_ptr(void*) const */uint StandardMaterial3D::is_class_ptr(void *param_1) {
   undefined4 in_EDX;
   undefined4 *in_RSI;
   return (uint)CONCAT71(0x10b7, in_RSI == &BaseMaterial3D::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10b7, in_RSI == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10b7, in_RSI == &Material::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10b7, in_RSI == &Resource::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10b7, in_RSI == &RefCounted::get_class_ptr_static(), ::ptr) | CONCAT31(( int3 )((uint)in_EDX >> 8), in_RSI == &Object::get_class_ptr_static(), ::ptr);
}
...
/* CollisionShape3DGizmoPlugin::is_class_ptr(void*) const */uint CollisionShape3DGizmoPlugin::is_class_ptr(CollisionShape3DGizmoPlugin *this, void *param_1) {
   return (uint)CONCAT71(0x10b7, (undefined4*)param_1 == &EditorNode3DGizmoPlugin::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10b7, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10b7, (undefined4*)param_1 == &Resource::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10b7, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10b7, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* CollisionShape3DGizmoPlugin::_getv(StringName const&, Variant&) const */undefined8 CollisionShape3DGizmoPlugin::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* CollisionShape3DGizmoPlugin::_setv(StringName const&, Variant const&) */undefined8 CollisionShape3DGizmoPlugin::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* CollisionShape3DGizmoPlugin::_validate_propertyv(PropertyInfo&) const */void CollisionShape3DGizmoPlugin::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* CollisionShape3DGizmoPlugin::_property_can_revertv(StringName const&) const */undefined8 CollisionShape3DGizmoPlugin::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* CollisionShape3DGizmoPlugin::_property_get_revertv(StringName const&, Variant&) const */undefined8 CollisionShape3DGizmoPlugin::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* CollisionShape3DGizmoPlugin::_notificationv(int, bool) */void CollisionShape3DGizmoPlugin::_notificationv(int param_1, bool param_2) {
   return;
}
/* Gizmo3DHelper::is_class_ptr(void*) const */uint Gizmo3DHelper::is_class_ptr(Gizmo3DHelper *this, void *param_1) {
   return (uint)CONCAT71(0x10b7, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10b7, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10b7, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* Gizmo3DHelper::_getv(StringName const&, Variant&) const */undefined8 Gizmo3DHelper::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* Gizmo3DHelper::_setv(StringName const&, Variant const&) */undefined8 Gizmo3DHelper::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* Gizmo3DHelper::_validate_propertyv(PropertyInfo&) const */void Gizmo3DHelper::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* Gizmo3DHelper::_property_can_revertv(StringName const&) const */undefined8 Gizmo3DHelper::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* Gizmo3DHelper::_property_get_revertv(StringName const&, Variant&) const */undefined8 Gizmo3DHelper::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* Gizmo3DHelper::_notificationv(int, bool) */void Gizmo3DHelper::_notificationv(int param_1, bool param_2) {
   return;
}
...
/* Gizmo3DHelper::~Gizmo3DHelper() */void Gizmo3DHelper::~Gizmo3DHelper(Gizmo3DHelper *this) {
...
/* StandardMaterial3D::_get_class_namev() const */undefined8 *StandardMaterial3D::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00106523:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00106523;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "StandardMaterial3D");
   LAB_0010658e:return &_get_class_namev();
}
...
/* RefCounted::_get_class_namev() const */undefined8 *RefCounted::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001066c3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001066c3;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "RefCounted");
   LAB_0010672e:return &_get_class_namev();
}
/* CollisionShape3DGizmoPlugin::_get_class_namev() const */undefined8 *CollisionShape3DGizmoPlugin::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001067b3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001067b3;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "CollisionShape3DGizmoPlugin");
         goto LAB_0010681e;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "CollisionShape3DGizmoPlugin");
   LAB_0010681e:return &_get_class_namev();
}
/* Gizmo3DHelper::_get_class_namev() const */undefined8 *Gizmo3DHelper::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_001068a3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_001068a3;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "Gizmo3DHelper");
         goto LAB_0010690e;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "Gizmo3DHelper");
   LAB_0010690e:return &_get_class_namev();
}
...
/* void EditorUndoRedoManager::add_do_method<float>(Object*, StringName const&, float) */void EditorUndoRedoManager::add_do_method<float>(EditorUndoRedoManager *this, Object *param_1, StringName *param_2, float param_3) {
   char cVar1;
   long in_FS_OFFSET;
   Variant *local_78[2];
   int local_68[6];
...
/* CollisionShape3DGizmoPlugin::get_class() const */void CollisionShape3DGizmoPlugin::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* Gizmo3DHelper::get_class() const */void Gizmo3DHelper::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* RefCounted::is_class(String const&) const */undefined8 RefCounted::is_class(RefCounted *this, String *param_1) {
   ...
   if (cVar5 == '\0') {
      ...
      LAB_0010705b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* Gizmo3DHelper::is_class(String const&) const */undefined8 Gizmo3DHelper::is_class(Gizmo3DHelper *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *__s;
   long lVar3;
   ...
   if (cVar4 == '\0') {
      ...
      LAB_0010725b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* Resource::is_class(String const&) const */undefined8 Resource::is_class(Resource *this, String *param_1) {
   ...
   if (cVar4 == '\0') {
      ...
      LAB_001073bb:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* BaseMaterial3D::is_class(String const&) const */undefined8 BaseMaterial3D::is_class(BaseMaterial3D *this, String *param_1) {
   ...
   LAB_0010751b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0010761e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* StandardMaterial3D::is_class(String const&) const */undefined8 StandardMaterial3D::is_class(StandardMaterial3D *this, String *param_1) {
   ...
   if (cVar4 == '\0') {
      ...
      LAB_0010772b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* CollisionShape3DGizmoPlugin::is_class(String const&) const */undefined8 CollisionShape3DGizmoPlugin::is_class(CollisionShape3DGizmoPlugin *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long lVar4;
   ...
   LAB_0010789b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0010799e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* CollisionShape3DGizmoPlugin::_initialize_classv() */void CollisionShape3DGizmoPlugin::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_60;
   undefined8 local_58;
   long local_50;
   ...
   local_30 = *(long*)( in_FS_OFFSET + 0x28 );
   if (initialize_class() == '\0') {
      if (EditorNode3DGizmoPlugin::initialize_class() == '\0') {
         ...
         EditorNode3DGizmoPlugin::initialize_class()::initialized =
         '\x01';
      }
...
/* Gizmo3DHelper::_initialize_classv() */void Gizmo3DHelper::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_60;
   undefined8 local_58;
   long local_50;
...
/* PropertyListHelper::~PropertyListHelper() */void PropertyListHelper::~PropertyListHelper(PropertyListHelper *this) {
 ...
 while ( lVar2 != (ulong)uVar1 << 2 );
   ...
   LAB_0010839f:CowData<char32_t>::_unref((CowData<char32_t>*)this);
   return;
}
/* RefCounted::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void RefCounted::_get_property_listv(List *param_1, bool param_2) {
   ...
   LAB_0010855c:List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)CONCAT71(in_register_00000031, param_2), (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
...
/* Gizmo3DHelper::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Gizmo3DHelper::_get_property_listv(Gizmo3DHelper *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_001087c1:local_b0 = (CowData<char32_t>*)&local_58;
...
/* Resource::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Resource::_get_property_listv(Resource *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00108a71:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* Material::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Material::_get_property_listv(Material *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00108d21:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* EditorNode3DGizmoPlugin::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00108fd1:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* CollisionShape3DGizmoPlugin::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool)
   const */void CollisionShape3DGizmoPlugin::_get_property_listv(CollisionShape3DGizmoPlugin *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   CowData<char32_t> *local_b0;
   long local_98;
   long local_90;
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00109281:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* BaseMaterial3D::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void BaseMaterial3D::_get_property_listv(BaseMaterial3D *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_00109531:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* StandardMaterial3D::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void StandardMaterial3D::_get_property_listv(StandardMaterial3D *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_001097e1:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* Ref<StandardMaterial3D>::unref() */void Ref<StandardMaterial3D>::unref(Ref<StandardMaterial3D> *this) {
   Object *pOVar1;
   char cVar2;
   if (*(long*)this != 0) {
      cVar2 = RefCounted::unreference();
...
/* Ref<SeparationRayShape3D>::unref() */void Ref<SeparationRayShape3D>::unref(Ref<SeparationRayShape3D> *this) {
   Object *pOVar1;
   char cVar2;
   if (*(long*)this != 0) {
      cVar2 = RefCounted::unreference();
...
/* CowData<Ref<StandardMaterial3D> >::_copy_on_write() [clone .isra.0] [clone .cold] */void CowData<Ref<StandardMaterial3D>>::_copy_on_write(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* CollisionShape3DGizmoPlugin::redraw(EditorNode3DGizmo*) [clone .cold] */void CollisionShape3DGizmoPlugin::redraw(EditorNode3DGizmo *param_1) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Vector3>::resize<false>(long) */undefined8 CowData<Vector3>::resize<false>(CowData<Vector3> *this, long param_1) {
   ...
   if (param_1 * 0xc == 0) {
      LAB_00109eb0:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (lVar6 == lVar2) {
      LAB_00109e3c:puVar8 = *(undefined8**)this;
...
/* CowData<Ref<StandardMaterial3D> >::_unref() */void CowData<Ref<StandardMaterial3D>>::_unref(CowData<Ref<StandardMaterial3D>> *this) {
   long *plVar1;
   long lVar2;
   Object *pOVar3;
   code *pcVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<String, Vector<Ref<StandardMaterial3D> >, HashMapHasherDefault,
 ...
 while ( uVar48 != uVar41 );
      ...
      LAB_0010a685:iVar45 = *(int*)( this + 0x2c );
      if (iVar45 != 0) {
         LAB_0010a695:uVar39 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
               ...
               if (uVar40 == uVar51) {
                  ...
                  if (cVar38 != '\0') {
                     ...
                     if (*(long*)pauVar43[2] != 0) {
                        CowData<Ref<StandardMaterial3D>>::_ref((CowData<Ref<StandardMaterial3D>>*)( pauVar43 + 2 ), (CowData*)&local_70);
                        pauVar43 = *(undefined1(**) [16])( *(long*)( this + 8 ) + (ulong)uVar50 * 8 );
                     }
 ...
 while ( ( uVar51 != 0 ) && ( auVar19._8_8_ = 0 ),auVar19._0_8_ = (ulong)uVar51 * lVar4,auVar35._8_8_ = 0,auVar35._0_8_ = uVar41,auVar20._8_8_ = 0,auVar20._0_8_ = ( ulong )(( uVar39 + uVar50 ) - SUB164(auVar19 * auVar35, 8)) * lVar4,auVar36._8_8_ = 0,auVar36._0_8_ = uVar41,uVar54 <= SUB164(auVar20 * auVar36, 8) );
   ...
   LAB_0010a17d:uVar55 = *(uint*)( this + 0x28 );
   if (uVar55 == 0x1c) {
...
;
 ...
 while ( ( uVar40 != 0 ) && ( auVar15._8_8_ = 0 ),auVar15._0_8_ = (ulong)uVar40 * lVar4,auVar31._8_8_ = 0,auVar31._0_8_ = uVar41,auVar16._8_8_ = 0,auVar16._0_8_ = ( ulong )(( uVar51 + uVar55 ) - SUB164(auVar15 * auVar31, 8)) * lVar4,auVar32._8_8_ = 0,auVar32._0_8_ = uVar41,uVar50 <= SUB164(auVar16 * auVar32, 8) );
   ...
   uVar48 = (ulong)uVar55;
   iVar45 = 0;
   LAB_0010a157:if ((float)uVar48 * __LC54 < (float)( iVar45 + 1 )) goto LAB_0010a17d;
}
...
*(undefined8*)pauVar43[2] = 0;CowData<Ref<StandardMaterial3D>>::_unref((CowData<Ref<StandardMaterial3D>>*)&local_48);CowData<char32_t>::_unref((CowData<char32_t>*)local_58);puVar2 = *(undefined8**)( this + 0x20 );if (puVar2 == (undefined8*)0x0) {
...
;*(undefined1(**) [16])( lVar46 + lVar47 * 8 ) = pauVar37;*puVar1 = uVar55;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_0010a53b:CowData<Ref<StandardMaterial3D>>::_unref((CowData<Ref<StandardMaterial3D>>*)&local_70);LAB_0010a547:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return pauVar43[1] + 8;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* CowData<Ref<StandardMaterial3D> >::_realloc(long) */undefined8 CowData<Ref<StandardMaterial3D>>::_realloc(CowData<Ref<StandardMaterial3D>> *this, long param_1) {
   undefined8 *puVar1;
   puVar1 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), param_1 + 0x10, false);
   if (puVar1 != (undefined8*)0x0) {
      *puVar1 = 1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Ref<StandardMaterial3D> >::resize<false>(long) */undefined8 CowData<Ref<StandardMaterial3D>>::resize<false>(CowData<Ref<StandardMaterial3D>> *this, long param_1) {
   long *plVar1;
   Object *pOVar2;
   code *pcVar3;
   char cVar4;
...
;
   ...
   if (lVar11 == lVar8) {
      LAB_0010ac0b:puVar10 = *(undefined8**)this;
      if (puVar10 == (undefined8*)0x0) {
         LAB_0010ab00:/* WARNING: Does not return */pcVar3 = (code*)invalidInstructionException();
         ( *pcVar3 )();
      }
   ...
   LAB_0010abeb:puVar10[-1] = param_1;
   return 0;
}
/* WARNING: Control flow encountered bad instruction data *//* LocalVector<Geometry3D::MeshData::Face, unsigned int, false, false>::resize(unsigned int) */void LocalVector<Geometry3D::MeshData::Face,unsigned_int,false,false>::resize(LocalVector<Geometry3D::MeshData::Face,unsigned_int,false,false> *this, uint param_1) {
   long lVar1;
   undefined8 *puVar2;
   undefined8 *puVar3;
   uint uVar4;
 ...
 while ( puVar3 != (undefined8*)( lVar5 + 0x20 + ( ( ulong )(uVar4 - uVar7) + (ulong)uVar7 ) * 0x20 ) );
   ...
   LAB_0010ad4b:*(uint*)this = param_1;
   return;
}
...
/* CollisionShape3DGizmoPlugin::CollisionShape3DGizmoPlugin() */void CollisionShape3DGizmoPlugin::_GLOBAL__sub_I_CollisionShape3DGizmoPlugin(void) {
...
/* WARNING: Control flow encountered bad instruction data *//* Gizmo3DHelper::~Gizmo3DHelper() */void Gizmo3DHelper::~Gizmo3DHelper(Gizmo3DHelper *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

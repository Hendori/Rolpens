/* NodeDock::show_groups() */void NodeDock::show_groups(NodeDock *this) {
...
/* NodeDock::show_connections() */void NodeDock::show_connections(NodeDock *this) {
   BaseButton::set_pressed(SUB81(*(undefined8*)( this + 0xa18 ), 0));
   BaseButton::set_pressed(SUB81(*(undefined8*)( this + 0xa10 ), 0));
   CanvasItem::hide();
   CanvasItem::show();
...
/* NodeDock::_notification(int) [clone .part.0] */void NodeDock::_notification(int param_1)

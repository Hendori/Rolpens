void wslay_event_frame_recv_callback(undefined8 param_1, undefined8 param_2, undefined4 param_3, long *param_4) {
...
void wslay_event_frame_send_callback(undefined8 param_1, undefined8 param_2, undefined4 param_3, long *param_4) {
   code *UNRECOVERED_JUMPTABLE;
...
undefined4 wslay_event_queue_msg_ex(long param_1, byte *param_2, byte param_3) {
   ...
   if (( *(char*)( param_1 + 0x21 ) != '\0' ) && ( ( *(byte*)( param_1 + 0x11 ) & 2 ) == 0 )) {
      bVar1 = *param_2;
      bVar5 = bVar1 >> 3;
      if (( ( ( bVar5 & 1 ) == 0 ) || ( ( *(ulong*)( param_2 + 0x10 ) < 0x7e && ( ( param_3 & 4 ) == 0 ) ) ) ) && ( ( ~*(byte *)(param_1 + 0x1130) & param_3 ) == 0 )) {
...
undefined8 wslay_event_queue_close_wrapper(long param_1, ushort param_2, void *param_3, ulong param_4) {
   ...
   *(undefined1*)( param_1 + 0x20 ) = 0;
   ...
   uVar1 = 0;
   LAB_001006ca:if (local_10 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
ulong wslay_event_recv(byte *param_1) {
   ...
   LAB_00100ab2:bVar9 = param_1[0x20];
   do {
      if (bVar9 == 0) {
         LAB_00100cfd:uVar7 = 0;
      ...
      if (lVar6 < 0) {
         if (( lVar6 != -100 ) || ( ( *(int*)( param_1 + 0x80 ) != -0x191 && ( *(int*)( param_1 + 0x80 ) != 0 ) ) )) {
      ...
      if (( ( ~param_1[0x1130] & local_68[1] ) != 0 ) || ( ( ( ( local_68 & (undefined1[16])0x400 ) != (undefined1[16])0x0 && ( ( ( local_68 & (undefined1[16])0x80000 ) != (undefined1[16])0x0 || ( local_68[2] == 0 ) ) ) ) || ( local_58[0] == '\0' ) ) )) {
         LAB_00100b30:uVar7 = wslay_event_queue_close_wrapper(param_1, 0x3ea, 0, 0);
         goto LAB_00100b41;
      }
      ...
      if (bVar9 == 0xff) {
         ...
         *(undefined2*)pbVar12 = local_68._0_2_;
         ...
         LAB_00100980:if (*(ulong*)( param_1 + 8 ) < ( ulong )(lVar6 + local_68._8_8_)) {
         ...
         *(undefined8*)( param_1 + 0x70 ) = local_68._8_8_;
         ...
         if (( ( ( *param_1 & 1 ) != 0 ) && ( ( local_68 & (undefined1[16])0x80000 ) == (undefined1[16])0x0 ) ) || ( uVar15 = local_68._8_8_ == 0 )) {
            LAB_00100a35:bVar9 = pbVar12[2];
            goto LAB_00100a3b;
         }
      ...
      LAB_00100a3b:uVar4 = *(uint*)( pbVar12 + 4 );
      if (( ( ( ( pbVar12[1] & 4 ) == 0 ) && ( bVar9 == 1 ) ) || ( bVar9 == 8 ) ) && ( puVar10 = puVar10 < local_48 )) {
         do {
            uVar4 = (uint)(byte)utf8d[uVar4 + 0x100 + (uint)(byte)utf8d[*(byte*)( local_58._8_8_ + (long)puVar10 )]];
 ...
 while ( puVar10 < local_48 );
         ...
         LAB_00100a5c:if (uVar4 == 0xc) goto LAB_00100cfd;
      }
      ...
      if (local_48 == (ushort*)0x0) {
         ...
         if (( ( *param_1 & 1 ) == 0 ) || ( ( local_68 & (undefined1[16])0x80000 ) != (undefined1[16])0x0 )) {
            ...
            memcpy((void*)( *(long*)( param_1 + 0x78 ) + *(long*)( lVar6 + 8 ) ), (void*)local_58._8_8_, (size_t)local_48);
         }
      ...
      if (*pcVar14 == '\0') {
         ...
         if (pcVar8 != (code*)0x0) {
            LAB_00100be1:( *pcVar8 )(param_1, *(undefined8*)( param_1 + 0x1128 ));
            pcVar14 = *(char**)( param_1 + 0x68 );
         ...
         LAB_00100bfc:if (( *(long*)( param_1 + 0x1110 ) != 0 ) || ( ( byte )(pcVar14[2] - 8U) < 2 )) {
            if (( ( ( *param_1 & 1 ) == 0 ) || ( ( local_68 & (undefined1[16])0x80000 ) != (undefined1[16])0x0 ) ) && ( *(size_t*)( pcVar14 + 0x18 ) != 0 )) {
               ...
               while (iVar3 = wslay_queue_empty(pcVar14),iVar3 == 0) {
                  ...
                  __memcpy_chk((long)local_98 + lVar6, *(undefined8*)( (long)pvVar5 + 8 ), *(undefined8*)( (long)pvVar5 + 0x10 ));
...
undefined8 wslay_event_send(long param_1) {
      ...
      do {
         ...
         if (( iVar8 == 0 ) || ( iVar8 = iVar8 == 0 )) {
            ...
            *(undefined8*)( param_1 + 0x10d0 ) = uVar10;
            LAB_001012b5:lVar11 = *(long*)( param_1 + 0x10d8 );
            ...
            if (lVar9 < 0) {
               ...
               LAB_001014b2:*(undefined1*)( param_1 + 0x21 ) = 0;
               uVar10 = 0xfffffe70;
               goto LAB_0010123e;
            }
            ...
            *(ulong*)( param_1 + 0xb8 ) = *(long*)( param_1 + 0xb8 ) - uVar4;
            ...
            LAB_00101398:free(__ptr);
            *(undefined8*)( param_1 + 0x88 ) = 0;
         }
 else {
            lVar9 = *(long*)( param_1 + 0x88 );
            if (lVar9 == 0) break;
            LAB_00101120:if (( ( *(byte*)( lVar9 + 9 ) & 8 ) == 0 ) && ( *(int*)( *(long*)( param_1 + 0x18 ) + 0x1078 ) == 0 )) {
               iVar8 = wslay_queue_empty(lVar3);
               if (iVar8 == 0) {
            ...
            LAB_00101143:lVar11 = *(long*)( param_1 + 0x10c0 );
            if (( *(char*)( lVar9 + 8 ) == '\0' ) && ( lVar11 == *(long*)( param_1 + 0x10c8 ) )) {
               local_5c = 0;
               lVar9 = ( **(code**)( lVar9 + 0x28 ) )(param_1, lVar1, 0x1000, lVar9 + 0x20, &local_5c, *(undefined8*)( param_1 + 0x1128 ));
               if (lVar9 != 0) {
                  if (-1 < lVar9) {
               ...
               if (local_5c != 0) {
                  *(long*)( param_1 + 0x10c0 ) = lVar1;
                  lVar9 = 0;
                  LAB_00101424:*(undefined1*)( *(long*)( param_1 + 0x88 ) + 8 ) = 1;
                  LAB_0010142f:*(long*)( param_1 + 0x10d0 ) = lVar9;
            ...
            LAB_0010115d:lVar9 = *(long*)( param_1 + 0x88 );
            stack0xffffffffffffffab = SUB1613((undefined1[16])0x0, 3);
 ...
 while ( *(char*)( param_1 + 0x21 ) != '\0' );
   ...
   uVar10 = 0;
   LAB_0010123e:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
long wslay_event_write(long param_1, long param_2, long param_3) {
      ...
      do {
         ...
         if (( iVar9 == 0 ) || ( iVar9 = iVar9 == 0 )) {
            ...
            *(undefined8*)( param_1 + 0x10d0 ) = uVar12;
            LAB_001017a5:lVar13 = *(long*)( param_1 + 0x10d8 );
            ...
            if (lVar10 < 1) {
               LAB_00101a70:if (lVar10 != 0) {
                  LAB_001019e7:lVar11 = -400;
                  goto LAB_00101723;
               }
            ...
            *(undefined8*)( param_1 + 0x88 ) = 0;
            ...
            lVar10 = *(long*)( param_1 + 0x88 );
            if (lVar10 == 0) break;
            LAB_001015e0:if (( ( *(byte*)( lVar10 + 9 ) & 8 ) == 0 ) && ( *(int*)( *(long*)( param_1 + 0x18 ) + 0x1078 ) == 0 )) {
               iVar9 = wslay_queue_empty(lVar3);
               if (iVar9 == 0) {
                  wslay_queue_push_front(lVar2, *(undefined8*)( param_1 + 0x88 ));
                  lVar10 = wslay_event_send_ctrl_queue_pop(param_1);
            ...
            LAB_00101603:lVar13 = *(long*)( param_1 + 0x10c0 );
            if (( *(char*)( lVar10 + 8 ) == '\0' ) && ( lVar13 == *(long*)( param_1 + 0x10c8 ) )) {
               local_74 = 0;
               lVar10 = ( **(code**)( lVar10 + 0x28 ) )(param_1, lVar1, 0x1000, lVar10 + 0x20, &local_74, *(undefined8*)( param_1 + 0x1128 ));
               if (lVar10 != 0) {
                  if (-1 < lVar10) {
               ...
               if (local_74 != 0) {
                  *(long*)( param_1 + 0x10c0 ) = lVar1;
                  lVar10 = 0;
                  LAB_0010195b:*(undefined1*)( *(long*)( param_1 + 0x88 ) + 8 ) = 1;
                  LAB_00101966:*(long*)( param_1 + 0x10d0 ) = lVar10;
            ...
            LAB_0010161d:lVar10 = *(long*)( param_1 + 0x88 );
            stack0xffffffffffffff9b = SUB1613((undefined1[16])0x0, 3);
 ...
 while ( *(char*)( param_1 + 0x21 ) != '\0' );
   ...
   LAB_00101723:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }

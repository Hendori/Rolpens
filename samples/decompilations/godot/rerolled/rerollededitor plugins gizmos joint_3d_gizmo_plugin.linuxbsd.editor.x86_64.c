...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Vector3>::resize<false>(long) */undefined8 CowData<Vector3>::resize<false>(CowData<Vector3> *this, long param_1) {
   ...
   if (param_1 * 0xc == 0) {
      LAB_00108b90:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (lVar7 == lVar3) {
      LAB_00108afc:puVar9 = *(undefined8**)this;
   ...
   LAB_00108a8b:puVar9[-1] = param_1;
   return 0;
}
/* WARNING: Control flow encountered bad instruction data *//* Joint3DGizmoPlugin::~Joint3DGizmoPlugin() */void Joint3DGizmoPlugin::~Joint3DGizmoPlugin(Joint3DGizmoPlugin *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<Joint3DGizmoPlugin, void>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<Joint3DGizmoPlugin,void>::~CallableCustomMethodPointer(CallableCustomMethodPointer<Joint3DGizmoPlugin,void> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<Node, void, Node*, bool,
   Node::InternalMode>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<Node,void,Node*,bool,Node::InternalMode>::~CallableCustomMethodPointer(CallableCustomMethodPointer<Node,void,Node*,bool,Node::InternalMode> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

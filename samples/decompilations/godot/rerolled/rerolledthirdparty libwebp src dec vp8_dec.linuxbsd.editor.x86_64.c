...
int GetLargeValue(ulong *param_1, long param_2) {
   ...
   if (iVar3 < 0) {
      ...
      if (puVar2 < (ulong*)param_1[4]) {
         ...
         uVar4 = ( ( uVar4 & 0xff000000000000 ) >> 0x28 | ( uVar4 & 0xff0000000000 ) >> 0x18 | ( uVar4 & 0xff00000000 ) >> 8 | ( uVar4 & 0xff000000 ) << 8 | ( uVar4 & 0xff0000 ) << 0x18 | ( uVar4 & 0xff00 ) << 0x28 | uVar4 << 0x38 ) >> 8 | *param_1 << 0x38;
         *param_1 = uVar4;
         goto LAB_0010008b;
      }
   ...
   uVar4 = *param_1;
   LAB_0010008b:uVar5 = (uint)bVar1 * (int)uVar7 >> 8;
   uVar6 = uVar5 + 1;
      ...
      *(int*)( param_1 + 1 ) = iVar8;
      ...
      if (iVar3 < 0) {
         ...
         if (puVar2 < (ulong*)param_1[4]) {
            ...
            iVar3 = iVar3 + 0x38;
            param_1[2] = (long)puVar2 + 7;
            uVar4 = uVar4 << 0x38 | ( ( uVar7 & 0xff000000000000 ) >> 0x28 | ( uVar7 & 0xff0000000000 ) >> 0x18 | ( uVar7 & 0xff00000000 ) >> 8 | ( uVar7 & 0xff000000 ) << 8 | ( uVar7 & 0xff0000 ) << 0x18 | ( uVar7 & 0xff00 ) << 0x28 | uVar7 << 0x38 ) >> 8;
            *param_1 = uVar4;
         }
 else {
      ...
      *(int*)( param_1 + 1 ) = iVar8;
      ...
      if (iVar3 < 0) {
         ...
         if (puVar2 < (ulong*)param_1[4]) {
            ...
            iVar3 = iVar3 + 0x38;
            param_1[2] = (long)puVar2 + 7;
            uVar7 = ( ( uVar7 & 0xff000000000000 ) >> 0x28 | ( uVar7 & 0xff0000000000 ) >> 0x18 | ( uVar7 & 0xff00000000 ) >> 8 | ( uVar7 & 0xff000000 ) << 8 | ( uVar7 & 0xff0000 ) << 0x18 | ( uVar7 & 0xff00 ) << 0x28 | uVar7 << 0x38 ) >> 8 | *param_1 << 0x38;
            *param_1 = uVar7;
         }
 else {
            VP8LoadFinalBytes(param_1);
...
int GetCoeffsAlt(ulong *param_1, long param_2, int param_3, long param_4, int param_5, long param_6) {
   ...
   if (iVar6 < 0) {
      ...
      if (puVar2 < (ulong*)param_1[4]) {
         ...
         *(int*)( (long)param_1 + 0xc ) = iVar6;
         uVar13 = ( ( uVar13 & 0xff000000000000 ) >> 0x28 | ( uVar13 & 0xff0000000000 ) >> 0x18 | ( uVar13 & 0xff00000000 ) >> 8 | ( uVar13 & 0xff000000 ) << 8 | ( uVar13 & 0xff0000 ) << 0x18 | ( uVar13 & 0xff00 ) << 0x28 | uVar13 << 0x38 ) >> 8 | *param_1 << 0x38;
         *param_1 = uVar13;
      }
 else {
         VP8LoadFinalBytes(param_1);
   ...
   *(int*)( param_1 + 1 ) = (int)uVar16;
   ...
   do {
      uVar13 = *param_1;
      LAB_00100904:uVar15 = (uint)bVar7 * (int)uVar16 >> 8;
      if (uVar15 < ( uint )(uVar13 >> ( (byte)iVar6 & 0x3f ))) {
         ...
         *(uint*)( param_1 + 1 ) = uVar8;
         ...
         if (iVar6 < 0) {
            ...
            if (puVar2 < (ulong*)param_1[4]) {
               ...
               iVar6 = iVar6 + 0x38;
               param_1[2] = (long)puVar2 + 7;
               uVar13 = uVar13 << 0x38 | ( ( uVar16 & 0xff000000000000 ) >> 0x28 | ( uVar16 & 0xff0000000000 ) >> 0x18 | ( uVar16 & 0xff00000000 ) >> 8 | ( uVar16 & 0xff000000 ) << 8 | ( uVar16 & 0xff0000 ) << 0x18 | ( uVar16 & 0xff00 ) << 0x28 | uVar16 << 0x38 ) >> 8;
               *(int*)( (long)param_1 + 0xc ) = iVar6;
               *param_1 = uVar13;
            }
 else {
         ...
         if (uVar15 < ( uint )(uVar13 >> ( (byte)iVar6 & 0x3f ))) {
            ...
            *param_1 = uVar13 - ( ( ulong )(uVar15 + 1) << ( (byte)iVar6 & 0x3f ) );
            ...
            LAB_00100b56:puVar2 = (ulong*)param_1[2];
            if (puVar2 < (ulong*)param_1[4]) {
               uVar13 = *puVar2;
               iVar6 = iVar6 + 0x38;
               param_1[2] = (long)puVar2 + 7;
         ...
         *param_1 = uVar13 - ( ( ulong )(uVar12 + 1 & uVar8) << ( bVar5 & 0x3f ) );
         ...
         param_5 = iVar9 + 1;
         *(ushort*)( param_6 + (ulong)bVar7 * 2 ) = ( ( uVar4 ^ uVar3 ) - uVar3 ) * *(short*)( param_4 + ( ulong )(0 < iVar9) * 4 );
         if (0xf < param_5) {
            return 0x10;
         }
 ...
 while ( -1 < iVar6 );
   LAB_00100a5d:puVar2 = (ulong*)param_1[2];
   if (puVar2 < (ulong*)param_1[4]) {
      uVar13 = *puVar2;
      iVar6 = iVar6 + 0x38;
      param_1[2] = (long)puVar2 + 7;
   ...
   do {
      ...
      if (iVar8 < 0) {
         ...
         if (puVar1 < (ulong*)param_1[4]) {
            ...
            uVar9 = ( ( uVar9 & 0xff000000000000 ) >> 0x28 | ( uVar9 & 0xff0000000000 ) >> 0x18 | ( uVar9 & 0xff00000000 ) >> 8 | ( uVar9 & 0xff000000 ) << 8 | ( uVar9 & 0xff0000 ) << 0x18 | ( uVar9 & 0xff00 ) << 0x28 | uVar9 << 0x38 ) >> 8 | *param_1 << 0x38;
            *param_1 = uVar9;
         }
 else {
            VP8LoadFinalBytes(param_1);
      ...
      *(int*)( param_1 + 1 ) = iVar14;
      ...
      while (true) {
         ...
         *(int*)( param_1 + 1 ) = iVar14;
         ...
         LAB_00100f09:puVar1 = (ulong*)param_1[2];
...
;
      ...
      *(int*)( param_1 + 1 ) = iVar15;
      ...
      if (iVar8 < 0) {
         ...
         if (puVar1 < (ulong*)param_1[4]) {
            ...
            iVar8 = iVar8 + 0x38;
            param_1[2] = (long)puVar1 + 7;
            uVar9 = uVar9 << 0x38 | ( ( uVar2 & 0xff000000000000 ) >> 0x28 | ( uVar2 & 0xff0000000000 ) >> 0x18 | ( uVar2 & 0xff00000000 ) >> 8 | ( uVar2 & 0xff000000 ) << 8 | ( uVar2 & 0xff0000 ) << 0x18 | ( uVar2 & 0xff00 ) << 0x28 | uVar2 << 0x38 ) >> 8;
            *param_1 = uVar9;
         }
 else {
            VP8LoadFinalBytes(param_1);
      ...
      if (uVar5 < ( uint )(uVar9 >> ( (byte)iVar8 & 0x3f ))) {
         ...
         *(uint*)( param_1 + 1 ) = ( uVar5 << ( ( byte )(uVar6 ^ 7) & 0x1f ) ) + -1;
         ...
         LAB_00100f9b:puVar1 = (ulong*)param_1[2];
         if (puVar1 < (ulong*)param_1[4]) {
            uVar9 = *puVar1;
            iVar15 = iVar15 + 0x38;
            param_1[2] = (long)puVar1 + 7;
      ...
      *(ushort*)( param_6 + (ulong)bVar7 * 2 ) = ( ( uVar4 ^ uVar3 ) - uVar3 ) * *(short*)( param_4 + ( ulong )(0 < iVar14) * 4 );
      if (0xf < param_5) {
         return 0x10;
      }
 ...
 while ( true );
   LAB_00100f38:VP8LoadFinalBytes(param_1);
   iVar8 = *(int*)( (long)param_1 + 0xc );
   goto LAB_00100da8;
}
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined4 *VP8New(void) {
   undefined *puVar1;
   int iVar2;
   undefined4 *puVar3;
   undefined8 *puVar4;
...
uint VP8GetInfo(byte *param_1, ulong param_2, ulong param_3, uint *param_4, uint *param_5) {
   ...
   if (( ( param_1[3] == 0x9d ) && ( param_1[4] == 1 ) ) && ( param_1[5] == 0x2a )) {
      ...
      if (( ( bVar1 & 0x10 ) != 0 ) && ( ( (uint)param_1[1] << 8 | (uint)param_1[2] << 0x10 | (uint)bVar1 ) >> 5 < param_3 )) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */bool VP8DecodeMB(long param_1, long param_2) {
   byte *pbVar1;
   undefined4 *puVar2;
   byte bVar3;
   long lVar4;
   ...
   if (( *(int*)( param_1 + 0xaf0 ) == 0 ) || ( cVar29 = *(char*)( (long)puVar8 + 0x31d ) ),cVar29 == '\0') {
      ...
      *puVar8 = 0;
      ...
      for (uVar14 = ( ulong )(( (int)puVar8 - (int)(undefined8*)( ( ulong )(puVar8 + 1) & 0xfffffffffffffff8 ) ) + 0x300U >> 3); uVar14 != 0; uVar14 = uVar14 - 1) {
         *puVar10 = 0;
         puVar10 = puVar10 + 1;
      }
      ...
      if (*(char*)( puVar8 + 0x60 ) == '\0') {
         ...
         iVar7 = ( *GetCoeffs )(param_2, param_1 + 0x958, (uint)pbVar1[1] + ( uint ) * (byte*)( lVar4 + -1 ), param_1 + 0x42c + lVar9, 0, local_68);
 ...
 while ( puVar11 != puVar8 + 0x40 );
      ...
      do {
         ...
         do {
            psVar26 = psVar28;
            iVar6 = ( *GetCoeffs )(param_2, local_c8, ( (uint)uVar14 & 1 ) + uVar5, param_1 + 0x424 + lVar9, iVar7, psVar26);
            uVar19 = 3;
            uVar12 = ( uint )(iVar7 < iVar6) << 7;
            uVar5 = ( uint )(iVar7 < iVar6);
            uVar18 = ( uint )(uVar14 >> 1) | uVar12;
            uVar14 = (ulong)uVar18;
            if (( iVar6 < 4 ) && ( uVar19 = iVar6 < 2 )) {
 ...
 while ( psVar21 != (short*)( puVar8 + 0x50 ) );
      ...
      while (true) {
         ...
         do {
            ...
            do {
               psVar22 = psVar26;
               iVar7 = ( *GetCoeffs )(param_2, param_1 + 0x9e0, uVar18 + ( (uint)uVar20 & 1 ), param_1 + 0x434 + lVar9, 0, psVar22);
               uVar18 = ( uint )(0 < iVar7);
               uVar19 = ( uint )(uVar20 >> 1) & 0x7f | ( uint )(0 < iVar7) * 8;
               uVar20 = (ulong)uVar19;
               uVar13 = 3;
               if (( iVar7 < 4 ) && ( uVar13 = iVar7 < 2 )) {
...
;
   ...
   *(undefined1*)( (long)puVar8 + 0x31c ) = uVar15;
   if (0 < *(int*)( param_1 + 0xb68 )) {
      ...
      *puVar2 = *(undefined4*)( param_1 + 0xc + ( ( ulong ) * (byte*)( puVar8 + 0x60 ) + 0x2d8 + ( ulong ) * (byte*)( (long)puVar8 + 0x31e ) * 2 ) * 4 );
...
uint VP8Decode(int *param_1, long param_2) {
   ...
   if (iVar2 == 0) {
      ...
      if (iVar2 == 0) {
         LAB_001020cf:VP8ExitCritical(param_1, param_2);
      ...
      if (0 < param_1[0x6b]) {
         ...
         do {
            ...
            if (iVar2 == 0) {
               ...
               LAB_0010219f:*(char**)( param_1 + 2 ) = pcVar4;
               param_1[0] = 7;
               param_1[1] = 0;
 ...
 while ( (int)uVar3 < param_1[0x6b] );
   ...
   LAB_001020a3:VP8Clear_part_0(param_1);
   return 0;
}

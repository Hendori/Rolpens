/* CowData<ScriptLanguage::ProfilingInfo*>::_copy_on_write() [clone .isra.0] */void CowData<ScriptLanguage::ProfilingInfo*>::_copy_on_write(CowData<ScriptLanguage::ProfilingInfo*> *this) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   undefined8 *puVar4;
...
/* List<ServersDebugger::ServerInfo, DefaultAllocator>::push_back(ServersDebugger::ServerInfo
   const&) [clone .isra.0] */void List<ServersDebugger::ServerInfo,DefaultAllocator>::push_back(List<ServersDebugger::ServerInfo,DefaultAllocator> *this, ServerInfo *param_1) {
   long *plVar1;
   long lVar2;
   StringName *this_00;
   long lVar3;
 ...
 while ( (int)plVar6[2] != 0 );
   ...
   plVar6 = (long*)0x0;
   LAB_00100210:if (( *(long**)( param_1 + 8 ) != (long*)0x0 ) && ( pSVar5 = (StringName*)**(long**)( param_1 + 8 ) ),pSVar5 != (StringName*)0x0) {
      if (plVar6 == (long*)0x0) {
         pauVar4 = (undefined1(*) [16])operator_new(0x18, DefaultAllocator::alloc);
...
/* ServersDebugger::ScriptFunctionSignature::serialize() */void ServersDebugger::ScriptFunctionSignature::serialize(void) {
   StringName *in_RSI;
   Array *in_RDI;
   long in_FS_OFFSET;
   int local_48[6];
...
/* ServersDebugger::ScriptFunctionSignature::deserialize(Array const&) */undefined8 ServersDebugger::ScriptFunctionSignature::deserialize(ScriptFunctionSignature *this, Array *param_1) {
   long *plVar1;
   long lVar2;
   uint uVar3;
   int iVar4;
   ...
   uVar5 = 0;
   LAB_00100572:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar5;
   }
...
/* ServersDebugger::ServersProfilerFrame::serialize() */void ServersDebugger::ServersProfilerFrame::serialize(void) {
   StringName *pSVar1;
   StringName *pSVar2;
   code *pcVar3;
   long lVar4;
   ...
   for (int i = 0; i < 5; i++) {
      Variant::Variant((Variant*)local_58, *(double*)( in_RSI + ( 2*i + 2 ) ));
      Array::push_back((Variant*)in_RDI);
      if (Variant::needs_deinit[local_58[0]] != '\0') {
         Variant::_clear_internal();
      }
   ...
   if (*(undefined8**)( in_RSI + 0xc ) != (undefined8*)0x0) {
      for (pSVar1 = (StringName*)**(undefined8**)( in_RSI + 0xc ); pSVar1 != (StringName*)0x0; pSVar1 = *(StringName**)( pSVar1 + 0x10 )) {
         ...
         if (*(undefined8**)( pSVar1 + 8 ) != (undefined8*)0x0) {
            for (pSVar2 = (StringName*)**(undefined8**)( pSVar1 + 8 ); pSVar2 != (StringName*)0x0; pSVar2 = *(StringName**)( pSVar2 + 0x10 )) {
...
;
   lVar7 = 0;
   LAB_00100ecb:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar4, lVar7, "p_index", "size()", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar3 = (code*)invalidInstructionException();
   ( *pcVar3 )();
}
/* ServersDebugger::VisualProfilerFrame::serialize() */void ServersDebugger::VisualProfilerFrame::serialize(void) {
   ulong uVar1;
   code *pcVar2;
   long lVar3;
   ulong *in_RSI;
...
;
   lVar4 = 0;
   LAB_00101183:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar3, lVar4, "p_index", "size()", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar2 = (code*)invalidInstructionException();
   ( *pcVar2 )();
}
/* ServersDebugger::~ServersDebugger() */void ServersDebugger::~ServersDebugger(ServersDebugger *this) {
   Object *pOVar1;
   char cVar2;
   long in_FS_OFFSET;
   long local_28;
   ...
   LAB_00101340:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* ServersDebugger::deinitialize() */void ServersDebugger::deinitialize(void) {
...
/* ServersDebugger::ResourceUsage::deserialize(Array const&) */undefined8 ServersDebugger::ResourceUsage::deserialize(ResourceUsage *this, Array *param_1) {
   long *plVar1;
   ...
   if (iVar4 == 0) {
      ...
      if (( uVar5 & 3 ) != 0) {
         _err_print_error("deserialize", "servers/debugger/servers_debugger.cpp", 0x3b, "Condition \"size % 4\" is true. Returning: false", 0, 0);
         uVar10 = 0;
         goto LAB_00101667;
      }
 ...
 while ( uVar6 < uVar5 );
         ...
         if (uVar6 < uVar5) {
            ...
            String::operator +((String*)&local_78, (String*)&local_88);
            String::operator +((String*)local_68, (String*)&local_78);
            _err_print_error("deserialize", "servers/debugger/servers_debugger.cpp", 0x47, "Condition \"(uint32_t)p_arr.size() > (uint32_t)idx\" is true. Returning: false", (String*)local_68, 0, 0);
      ...
      String::operator +((String*)&local_78, (String*)&local_88);
      String::operator +((String*)local_68, (String*)&local_78);
      pcVar11 = "Condition \"(uint32_t)p_arr.size() < (uint32_t)(1 + size)\" is true. Returning: false";
      uVar10 = 0x3c;
   }
   ...
   uVar10 = 0;
   LAB_00101667:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* ServersDebugger::ResourceUsage::serialize() */void ServersDebugger::ResourceUsage::serialize(void) {
   String *pSVar1;
   int iVar2;
   ...
   long local_30;
   local_30 = *(long*)( in_FS_OFFSET + 0x28 );
   List<ServersDebugger::ResourceInfo,DefaultAllocator>::sort_custom<Comparator<ServersDebugger::ResourceInfo>>(in_RSI);
   Array::Array(in_RDI);
   iVar2 = 0;
   if (*(long*)in_RSI != 0) {
   ...
   if (*(undefined8**)in_RSI != (undefined8*)0x0) {
      for (pSVar1 = (String*)**(undefined8**)in_RSI; pSVar1 != (String*)0x0; pSVar1 = *(String**)( pSVar1 + 0x28 )) {
...
/* ServersDebugger::_send_resource_usage() */void ServersDebugger::_send_resource_usage(void) {
   code *pcVar1;
   undefined1 auVar2[16];
   ...
   ( **(code**)( *plVar6 + 0x218 ) )(plVar6, (List<RenderingServer::TextureInfo,DefaultAllocator>*)&local_e0);
 ...
 while ( !bVar10 );
         ...
         LAB_00102636:local_48 = (undefined4)puVar9[3];
         local_50 = *puVar9;
         local_70 = 7;
         local_78 = "Texture";
 ...
 while ( puVar9 != (undefined8*)0x0 );
   ...
   List<RenderingServer::TextureInfo,DefaultAllocator>::~List((List<RenderingServer::TextureInfo,DefaultAllocator>*)&local_e0);
   List<ServersDebugger::ResourceInfo,DefaultAllocator>::~List((List<ServersDebugger::ResourceInfo,DefaultAllocator>*)&local_e8);
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ServersDebugger::_capture(void*, String const&, Array const&, bool&) */undefined8 ServersDebugger::_capture(void *param_1, String *param_2, Array *param_3, bool *param_4) {
   code *pcVar1;
   long lVar2;
   char cVar3;
   long *plVar4;
   ...
   if (singleton == (double*)0x0) {
      _err_print_error("_capture", "servers/debugger/servers_debugger.cpp", 0x19b, "Parameter \"singleton\" is null.", 0, 0);
      uVar6 = 0x2f;
   }
 else {
      *param_4 = true;
...
/* CowData<RenderingServer::FrameProfileArea>::_copy_on_write() [clone .isra.0] */void CowData<RenderingServer::FrameProfileArea>::_copy_on_write(CowData<RenderingServer::FrameProfileArea> *this) {
   long lVar1;
   code *pcVar2;
   undefined8 uVar3;
   undefined8 *puVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<RenderingServer::FrameProfileArea>::resize<false>(long) [clone .isra.0] */void CowData<RenderingServer::FrameProfileArea>::resize<false>(CowData<RenderingServer::FrameProfileArea> *this, long param_1) {
   long *plVar1;
   long *plVar2;
   code *pcVar3;
   int iVar4;
...
;
         ...
         if (lVar13 == lVar10) {
            LAB_001031fb:puVar8 = *(undefined8**)this;
            if (puVar8 == (undefined8*)0x0) {
               FUN_00105c4c();
               return;
            }
 ...
 while ( puVar5 != puVar14 );
   ...
   LAB_00103272:_err_print_error("resize", "./core/templates/cowdata.h", uVar9, pcVar7, 0, 0);
   return;
}
/* ServersDebugger::VisualProfilerFrame::deserialize(Array const&) */undefined8 ServersDebugger::VisualProfilerFrame::deserialize(VisualProfilerFrame *this, Array *param_1) {
   long *plVar1;
   long lVar2;
   int iVar3;
   char *pcVar4;
   ...
   if (uVar5 < 2) {
      ...
      *(ulong*)this = uVar8;
      ...
      if (uVar6 < uVar5) {
         ...
         iVar3 = (int)uVar5 / 3;
         CowData<RenderingServer::FrameProfileArea>::resize<false>((CowData<RenderingServer::FrameProfileArea>*)( this + 0x10 ), (long)iVar3);
         CowData<RenderingServer::FrameProfileArea>::_copy_on_write((CowData<RenderingServer::FrameProfileArea>*)( this + 0x10 ));
         if ((int)uVar5 < 3) {
            uVar5 = 2;
         }
 else {
 ...
 while ( iVar13 < iVar3 );
   ...
   uVar9 = 0;
   LAB_0010346e:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar9;
   }
...
/* CowData<ServersDebugger::ScriptFunctionInfo>::_copy_on_write() [clone .isra.0] */void CowData<ServersDebugger::ScriptFunctionInfo>::_copy_on_write(CowData<ServersDebugger::ScriptFunctionInfo> *this) {
   undefined8 uVar1;
   long lVar2;
   code *pcVar3;
   undefined8 uVar4;
...
/* ServersDebugger::ServersProfilerFrame::deserialize(Array const&) */undefined8 ServersDebugger::ServersProfilerFrame::deserialize(ServersProfilerFrame *this, Array *param_1) {
   long *plVar1;
   undefined1 auVar2[16];
   ...
   if (uVar4 < 7) {
      ...
      _err_print_error("deserialize", "servers/debugger/servers_debugger.cpp", 0x79, "Condition \"(uint32_t)p_arr.size() < (uint32_t)(7)\" is true. Returning: false", (String*)&local_68, 0, 0);
      pcVar12 = local_68;
      ...
      if ((int)local_f8 == 0) {
         ...
         do {
            ...
            if (uVar6 < uVar4) {
               ...
               String::operator +((String*)&local_a0, (String*)&local_b0);
               String::operator +((String*)&local_68, (String*)&local_a0);
               _err_print_error("deserialize", "servers/debugger/servers_debugger.cpp", 0x83, "Condition \"(uint32_t)p_arr.size() < (uint32_t)(idx + 2)\" is true. Returning: false", (Variant*)&local_68, 0, 0);
               pcVar12 = local_68;
               if (local_68 != (char*)0x0) {
                  LOCK();
                  plVar1 = (long*)( local_68 + -0x10 );
            ...
            if (uVar6 < uVar4 + iVar5) {
               ...
               _err_print_error("deserialize", "servers/debugger/servers_debugger.cpp", 0x89, "Condition \"(uint32_t)p_arr.size() < (uint32_t)(idx + sub_data_size)\" is true. Returning: false", (Variant*)&local_68, 0, 0);
               pcVar12 = local_68;
               if (local_68 != (char*)0x0) {
                  LOCK();
                  plVar1 = (long*)( local_68 + -0x10 );
 ...
 while ( iVar13 < iVar5 / 2 );
            ...
            List<ServersDebugger::ServerInfo,DefaultAllocator>::push_back((List<ServersDebugger::ServerInfo,DefaultAllocator>*)( this + 0x30 ), (ServerInfo*)local_98);
            ServerInfo::~ServerInfo((ServerInfo*)local_98);
 ...
 while ( (int)local_f8 != 0 );
      ...
      if (uVar6 < uVar4) {
         ...
         String::operator +((String*)&local_a0, (String*)&local_b0);
         String::operator +((String*)&local_68, (String*)&local_a0);
         pcVar12 = "Condition \"(uint32_t)p_arr.size() < (uint32_t)(idx + 1)\" is true. Returning: false";
         uVar11 = 0x93;
      }
 else {
         pVVar8 = (Variant*)Array::operator [](iVar15);
         ...
         if (uVar6 < iVar5 + uVar4) {
            ...
            String::operator +((String*)&local_a0, (String*)&local_b0);
            String::operator +((String*)&local_68, (String*)&local_a0);
            pcVar12 = "Condition \"(uint32_t)p_arr.size() < (uint32_t)(idx + func_size)\" is true. Returning: false";
            uVar11 = 0x96;
         }
 else {
            if (4 < iVar5) {
               ...
               do {
                  ...
                  iVar7 = CowData<ServersDebugger::ScriptFunctionInfo>::resize<false>((CowData<ServersDebugger::ScriptFunctionInfo>*)( this + 0x40 ), lVar14);
                  if (iVar7 == 0) {
                     if (*(long*)( this + 0x40 ) == 0) {
                        lVar16 = -1;
                        lVar14 = 0;
                        ...
                        lVar16 = lVar14 + -1;
                        if (-1 < lVar16) {
                           CowData<ServersDebugger::ScriptFunctionInfo>::_copy_on_write((CowData<ServersDebugger::ScriptFunctionInfo>*)( this + 0x40 ));
                     ...
                     _err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar16, lVar14, "p_index", "size()", "", false, false);
                  }
 else {
                     _err_print_error("push_back", "./core/templates/vector.h", 0x142, "Condition \"err\" is true. Returning: true", 0, 0);
                  }

                  LAB_0010427a:if (( StringName::configured != '\0' ) && ( ( ( local_68 == (char*)0x0 || ( StringName::unref(),StringName::configured != '\0' ) ) && ( local_98._0_8_ != 0 ) ) )) {
                     StringName::unref();
                  }
 ...
 while ( iVar13 < iVar5 / 5 );
      ...
      _err_print_error("deserialize", "servers/debugger/servers_debugger.cpp", uVar11, pcVar12, (CowData<char32_t>*)&local_68, 0, 0);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
   ...
   LAB_00104550:uVar11 = 0;
   LAB_00104552:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* ServersDebugger::ServersDebugger() */void ServersDebugger::ServersDebugger(ServersDebugger *this) {
   ...
   *(undefined8*)this = 0;
   singleton = this;
   Ref<ServersDebugger::ServersProfiler>::instantiate<>((Ref<ServersDebugger::ServersProfiler>*)( this + 8 ));
   ...
   if (cVar3 == '\0') {
      ...
      *(undefined8*)( this + 0x10 ) = 0;
      ...
      if (cVar3 != '\0') {
         ...
         if (cVar3 != '\0') {
            LAB_001058f3:( **(code**)( *(long*)pOVar6 + 0x140 ) )(pOVar6);
         ...
         if (cVar3 == '\0') {
            *(undefined8*)( this + 0x10 ) = 0;
            if (pOVar6 != (Object*)0x0) {
               cVar3 = RefCounted::unreference();
               joined_r0x001058d3:if (( cVar3 != '\0' ) && ( cVar3 = cVar3 != '\0' )) goto LAB_001058f3;
            }
      ...
      LAB_0010583d:cVar3 = RefCounted::unreference();
...
/* ServersDebugger::initialize() */void ServersDebugger::initialize(void) {
...
/* EngineProfiler::is_class_ptr(void*) const */uint EngineProfiler::is_class_ptr(EngineProfiler *this, void *param_1) {
   return (uint)CONCAT71(0x10da, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10da, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x10da, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
...
/* ServersDebugger::VisualProfiler::add(Array const&) */void ServersDebugger::VisualProfiler::add(Array *param_1) {
   return;
}
/* CowData<ScriptLanguage::ProfilingInfo*>::_copy_on_write() [clone .isra.0] [clone .cold] */void CowData<ScriptLanguage::ProfilingInfo*>::_copy_on_write(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* CowData<RenderingServer::FrameProfileArea>::_copy_on_write() [clone .isra.0] [clone .cold] */void CowData<RenderingServer::FrameProfileArea>::_copy_on_write(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
...
/* Error CowData<RenderingServer::FrameProfileArea>::resize<false>(long) [clone .isra.0] [clone
   .cold] */void CowData<RenderingServer::FrameProfileArea>::resize<false>(long param_1) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
...
/* CowData<ServersDebugger::ScriptFunctionInfo>::_copy_on_write() [clone .isra.0] [clone .cold] */void CowData<ServersDebugger::ScriptFunctionInfo>::_copy_on_write(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
...
/* EngineProfiler::_get_class_namev() const */undefined8 *EngineProfiler::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00105cb3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00105cb3;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EngineProfiler");
   LAB_00105d1e:return &_get_class_namev();
}
/* ServersDebugger::ScriptsProfiler::toggle(bool, Array const&) */void ServersDebugger::ScriptsProfiler::toggle(ScriptsProfiler *this, bool param_1, Array *param_2) {
   uint uVar1;
   void *pvVar2;
   code *pcVar3;
   bool bVar4;
...
;
 ...
 while ( iVar5 < (int)ScriptServer::_language_count );
      ...
      LAB_00105f10:iVar10 = Array::size();
...
/* SortArray<ScriptLanguage::ProfilingInfo*, ServersDebugger::ScriptsProfiler::ProfileInfoSort,
   true>::introsort(long, long, ScriptLanguage::ProfilingInfo**, long) const [clone .isra.0] */void SortArray<ScriptLanguage::ProfilingInfo*,ServersDebugger::ScriptsProfiler::ProfileInfoSort,true>::introsort(long param_1, long param_2, ProfilingInfo **param_3, long param_4) {
   ulong uVar1;
   ...
   if (param_4 == 0) {
      LAB_001061d2:lVar10 = lVar16 + -2 >> 1;
      lVar11 = lVar10 * 2 + 2;
 ...
 while ( lVar10 < lVar5 );
         ...
         joined_r0x001062be:if (lVar10 == 0) {
         ...
         while (true) {
            ...
            LAB_001062de:lVar9 = lVar11;
            ppPVar15 = ppPVar8;
            ppPVar6 = ppPVar8;
            if (lVar11 == lVar16) break;
            LAB_00106422:*ppPVar6 = pPVar12;
         }
;
         LAB_001062e4:lVar3 = lVar11 + -1;
 ...
 while ( true );
   ...
   lVar11 = param_2;
   local_58 = param_4;
   LAB_00106011:pPVar12 = param_3[lVar11 + -1];
   local_58 = local_58 + -1;
   ...
   if (uVar1 < uVar7) {
      if (uVar13 < uVar1) {
         LAB_001061a4:pPVar12 = param_3[( lVar16 >> 1 ) + param_1];
         uVar13 = uVar1;
         goto LAB_00106057;
      }
...
;
         ...
         LAB_001060fe:if (lVar9 <= param_2) break;
 ...
 while ( true );
   ...
   goto LAB_00106011;
   LAB_00106320:pPVar12 = ppPVar8[lVar16];
   ...
   if (lVar16 < 3) {
      ...
      *ppPVar8 = param_3[lVar11];
      LAB_001063a6:uVar7 = *(ulong*)( pPVar12 + 0x10 );
      while (true) {
...
/* SortArray<List<ServersDebugger::ResourceInfo, DefaultAllocator>::Element*,
   ...
   long) const [clone .isra.0] */void SortArray<List<ServersDebugger::ResourceInfo,DefaultAllocator>::Element*,List<ServersDebugger::ResourceInfo,DefaultAllocator>::AuxiliaryComparator<Comparator<ServersDebugger::ResourceInfo>>,true>::introsort(long param_1, long param_2, Element **param_3, long param_4) {
   int iVar1;
   int iVar2;
   Element *pEVar3;
   Element *pEVar4;
   ...
   if (param_4 == 0) {
      LAB_00106ccb:lVar12 = lVar16 + -2 >> 1;
      lVar15 = lVar12 * 2 + 2;
 ...
 while ( lVar12 < lVar7 );
         ...
         joined_r0x00106dff:if (lVar12 == 0) {
         ...
         while (true) {
            ...
            LAB_00106e1f:ppEVar11 = ppEVar9;
            lVar7 = lVar15;
            if (lVar15 == lVar16) break;
            LAB_00106f95:*ppEVar9 = pEVar13;
         }
;
         LAB_00106e25:lVar6 = lVar15 + -1;
 ...
 while ( true );
   ...
   lVar6 = param_2;
   local_58 = param_4;
   LAB_00106a74:local_58 = local_58 + -1;
   ...
   do {
      if (iVar8 == iVar5) {
         ...
         LAB_00106b02:if (lVar6 + -1 == param_2) {
            _err_print_error("partitioner", "./core/templates/sort_array.h", 0xb2, "bad comparison function; sorting will be broken", 0, 0);
...
;
         _err_print_error("partitioner", "./core/templates/sort_array.h", 0xb9, "bad comparison function; sorting will be broken", 0, 0);
         joined_r0x00106b6b:if (lVar16 <= param_2) break;
 ...
 while ( true );
   ...
   goto LAB_00106a74;
   LAB_00106e60:pEVar13 = ppEVar9[lVar16];
   ...
   if (lVar16 < 3) {
      ...
      *ppEVar9 = param_3[lVar15];
      LAB_00106f0c:iVar1 = *(int*)( pEVar13 + 0x20 );
      while (true) {
         pEVar3 = param_3[param_1 + lVar7];
         bVar18 = iVar1 < *(int*)( pEVar3 + 0x20 );
         if (*(int*)( pEVar3 + 0x20 ) == iVar1) {
...
/* ServersDebugger::VisualProfiler::toggle(bool, Array const&) */void ServersDebugger::VisualProfiler::toggle(bool param_1, Array *param_2) {
   code *pcVar1;
   long lVar2;
   char *pcVar3;
   long *plVar4;
...
/* EngineProfiler::_initialize_classv() */void EngineProfiler::_initialize_classv(void) {
   ...
   long local_40;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (initialize_class() != '\0') goto LAB_0010742b;
   if (RefCounted::initialize_class() == '\0') {
      ...
      lVar2 = local_68;
      if (local_68 == 0) {
         LAB_0010753a:if ((code*)PTR__bind_methods_00111008 != RefCounted::_bind_methods) {
            LAB_0010754a:RefCounted::_bind_methods();
         }
   ...
   '\x01';
   LAB_0010742b:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* EngineProfiler::is_class(String const&) const */undefined8 EngineProfiler::is_class(EngineProfiler *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long lVar4;
 ...
 while ( !bVar9 );
      ...
      LAB_0010762f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
 ...
 while ( !bVar9 );
         ...
         LAB_001077bb:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
 ...
 while ( !bVar9 );
            ...
            LAB_0010789b:cVar6 = String::operator ==(param_1, (String*)&local_60);
            lVar4 = local_60;
            if (local_60 != 0) {
               LOCK();
               plVar1 = (long*)( local_60 + -0x10 );
   ...
   LAB_001076e3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_00107944:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* EngineProfiler::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void EngineProfiler::_get_property_listv(EngineProfiler *this, List *param_1, bool param_2) {
   long *plVar1;
   long lVar2;
   long lVar3;
   undefined1(*pauVar4)[16];
...
/* ServersDebugger::ServerInfo::~ServerInfo() */void ServersDebugger::ServerInfo::~ServerInfo(ServerInfo *this) {
   long *plVar1;
   long lVar2;
   long lVar3;
   long *plVar4;
 ...
 while ( (int)plVar4[2] != 0 );
   ...
   LAB_00108252:if (( StringName::configured != '\0' ) && ( *(long*)this != 0 )) {
      StringName::unref();
      return;
   }
...
/* ServersDebugger::VisualProfiler::~VisualProfiler() */void ServersDebugger::VisualProfiler::~VisualProfiler(VisualProfiler *this) {
   uint uVar1;
   long lVar2;
   void *pvVar3;
 ...
 while ( lVar2 != (ulong)uVar1 << 2 );
   ...
   LAB_001083d2:EngineProfiler::~EngineProfiler((EngineProfiler*)this);
   return;
}
/* ServersDebugger::VisualProfiler::~VisualProfiler() */void ServersDebugger::VisualProfiler::~VisualProfiler(VisualProfiler *this) {
   uint uVar1;
 ...
 while ( lVar2 != (ulong)uVar1 << 2 );
   ...
   LAB_00108502:EngineProfiler::~EngineProfiler((EngineProfiler*)this);
...
::operator[](HashMap<StringName,int,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,int>>>
 ...
 while ( uVar40 != uVar45 );
         ...
         LAB_00108b1c:if (iVar46 != 0) {
            LAB_00108b24:uVar38 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
 ...
 while ( ( uVar52 != 0 ) && ( auVar19._8_8_ = 0 ),auVar19._0_8_ = (ulong)uVar52 * lVar43,auVar35._8_8_ = 0,auVar35._0_8_ = uVar45,auVar20._8_8_ = 0,auVar20._0_8_ = ( ulong )(( uVar38 + uVar53 ) - SUB164(auVar19 * auVar35, 8)) * lVar43,auVar36._8_8_ = 0,auVar36._0_8_ = uVar45,uVar54 <= SUB164(auVar20 * auVar36, 8) );
      ...
      LAB_00108779:uVar38 = *(uint*)( this + 0x28 );
      if (uVar38 == 0x1c) {
...
;
 ...
 while ( ( uVar52 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = (ulong)uVar52 * lVar49,auVar23._8_8_ = 0,auVar23._0_8_ = uVar40,auVar8._8_8_ = 0,auVar8._0_8_ = ( ulong )(( uVar53 + uVar38 ) - SUB164(auVar7 * auVar23, 8)) * lVar49,auVar24._8_8_ = 0,auVar24._0_8_ = uVar40,uVar54 <= SUB164(auVar8 * auVar24, 8) );
         ...
         LAB_00108b18:iVar46 = *(int*)( this + 0x2c );
         goto LAB_00108b1c;
      }

      LAB_00108753:if ((float)uVar40 * __LC32 < (float)( iVar46 + 1 )) goto LAB_00108779;
   }
   ...
   *(undefined4*)( puVar42 + 3 ) = local_50;
   ...
   if (puVar4 == (undefined8*)0x0) {
      ...
      *(undefined8**)( this + 0x20 ) = puVar42;
      ...
      LAB_00108a04:uVar38 = *(uint*)( lVar43 + 0x20 );
   }
 else {
      *puVar4 = puVar42;
      puVar42[1] = puVar4;
      ...
      *(undefined8**)( this + 0x20 ) = puVar42;
      ...
      LAB_00108c2d:uVar38 = StringName::get_empty_hash();
   }
...
;
   ...
   *puVar1 = uVar38;
   *(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;
   LAB_0010871c:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return puVar42 + 3;
   }
...
/* List<ServersDebugger::ServerInfo, DefaultAllocator>::~List() */void List<ServersDebugger::ServerInfo,DefaultAllocator>::~List(List<ServersDebugger::ServerInfo,DefaultAllocator> *this) {
   ServerInfo *this_00;
   long lVar1;
   long lVar2;
   long *plVar3;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<StringName, ServersDebugger::ServerInfo, HashMapHasherDefault,
   HashMapComparatorDefault<StringName>, DefaultTypedAllocator<HashMapElement<StringName,
   ServersDebugger::ServerInfo> > >::operator[](StringName const&) */StringName * __thiscallHashMap<StringName,ServersDebugger::ServerInfo,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ServersDebugger::ServerInfo>>>::operator [](HashMap<StringName,ServersDebugger::ServerInfo,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ServersDebugger::ServerInfo>>> * this, StringName * param_1) * puVar1 ;undefined8 *puVar2long *plVar3void *pvVar4void *__sundefined1 auVar5[16]undefined1 auVar6[16]undefined1 auVar7[16]undefined1 auVar8[16]undefined1 auVar9[16]undefined1 auVar10[16]undefined1 auVar11[16]undefined1 auVar12[16]undefined1 auVar13[16]undefined1 auVar14[16]undefined1 auVar15[16]undefined1 auVar16[16]undefined1 auVar17[16]undefined1 auVar18[16]undefined1 auVar19[16]undefined1 auVar20[16]undefined1 auVar21[16]undefined1 auVar22[16]undefined1 auVar23[16]undefined1 auVar24[16]undefined1 auVar25[16]undefined1 auVar26[16]undefined1 auVar27[16]undefined1 auVar28[16]undefined1 auVar29[16]undefined1 auVar30[16]undefined1 auVar31[16]undefined1 auVar32[16]undefined1 auVar33[16]undefined1 auVar34[16]undefined1 auVar35[16]undefined1 auVar36[16]uint uVar37uint uVar38uint uVar39long *plVar40ulong uVar41undefined8 uVar42void *__s_00StringName *pSVar43undefined8 *puVar44undefined1(*pauVar45)[16];long lVar46void *pvVar47ulong uVar48int iVar49long lVar50long lVar51long lVar52ulong uVar53undefined8 *puVar54undefined8 uVar55StringName *pSVar56uint uVar57uint uVar58uint uVar59long in_FS_OFFSETStringName *local_a8ServerInfo *local_a0StringName local_78[8]long *plStack_70undefined1 local_68[16]long local_58StringName local_50[8]undefined1(*local_48)[16];long local_40lVar46 = *(long*)( this + 8 );local_40 = *(long*)( in_FS_OFFSET + 0x28 );uVar38 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );uVar41 = CONCAT44(0, uVar38);if (lVar46 == 0) {
   LAB_001098b0:_local_78 = (undefined1[16])0x0;
   uVar48 = uVar41 * 4;
   uVar53 = uVar41 * 8;
 ...
 while ( uVar41 != uVar48 );
      ...
      LAB_00108fd1:iVar49 = *(int*)( this + 0x2c );
      if (iVar49 != 0) {
         LAB_00108fdd:uVar38 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
         ...
         if (uVar57 != 0) {
            do {
               if (( uVar39 == uVar57 ) && ( *(long*)( *(long*)( *(long*)( this + 8 ) + lVar51 * 8 ) + 0x10 ) == *(long*)param_1 )) {
 ...
 while ( ( uVar57 != 0 ) && ( auVar11._8_8_ = 0 ),auVar11._0_8_ = (ulong)uVar57 * lVar46,auVar27._8_8_ = 0,auVar27._0_8_ = uVar48,auVar12._8_8_ = 0,auVar12._0_8_ = ( ulong )(( uVar38 + uVar58 ) - SUB164(auVar11 * auVar27, 8)) * lVar46,auVar28._8_8_ = 0,auVar28._0_8_ = uVar48,uVar59 <= SUB164(auVar12 * auVar28, 8) );
         }
   ...
   LAB_00109282:uVar38 = *(uint*)( this + 0x28 );
   if (uVar38 == 0x1c) {
      _err_print_error("_insert", "./core/templates/hash_map.h", 0xdd, "Condition \"capacity_index + 1 == HASH_TABLE_SIZE_MAX\" is true. Returning: nullptr", "Hash table maximum capacity reached, aborting insertion.", 0, 0);
...
;
 ...
 while ( uVar39 != uVar41 );
   ...
   if (*(int*)( this + 0x2c ) != 0) {
      ...
      if (uVar57 != 0) {
         uVar59 = 0;
         do {
            if (( uVar57 == uVar39 ) && ( *(long*)( *(long*)( lVar46 + lVar50 * 8 ) + 0x10 ) == *(long*)param_1 )) {
 ...
 while ( ( uVar57 != 0 ) && ( auVar7._8_8_ = 0 ),auVar7._0_8_ = (ulong)uVar57 * lVar51,auVar23._8_8_ = 0,auVar23._0_8_ = uVar41,auVar8._8_8_ = 0,auVar8._0_8_ = ( ulong )(( uVar58 + uVar38 ) - SUB164(auVar7 * auVar23, 8)) * lVar51,auVar24._8_8_ = 0,auVar24._0_8_ = uVar41,uVar59 <= SUB164(auVar8 * auVar24, 8) );
      }
   ...
   _local_78 = (undefined1[16])0x0;
   iVar49 = 0;
   LAB_0010925c:if ((float)uVar41 * __LC32 < (float)( iVar49 + 1 )) goto LAB_00109282;
}
local_68 = (undefined1[16])0x0;StringName::StringName((StringName*)&local_58, param_1);StringName::StringName(local_50, local_78);local_48 = (undefined1(*) [16])0x0;if (( plStack_70 != (long*)0x0 ) && ( pSVar56 = (StringName*)*plStack_70 ),pSVar56 != (StringName*)0x0) {
...
LAB_001095ad:puVar44 = (undefined8*)operator_new(0x28, "");*puVar44 = local_68._0_8_;puVar44[1] = local_68._8_8_;StringName::StringName((StringName*)( puVar44 + 2 ), (StringName*)&local_58);local_a8 = (StringName*)( puVar44 + 3 );StringName::StringName(local_a8, local_50);puVar44[4] = 0;if (( local_48 != (undefined1(*) [16])0x0 ) && ( pSVar56 = *(StringName**)*local_48 ),pSVar56 != (StringName*)0x0) {
...
LAB_001096e9:ServersDebugger::ServerInfo::~ServerInfo((ServerInfo*)local_50);if (( StringName::configured != '\0' ) && ( local_58 != 0 )) {
   StringName::unref();
}
puVar54 = *(undefined8**)( this + 0x20 );if (puVar54 == (undefined8*)0x0) {
   ...
   *(undefined8**)( this + 0x20 ) = puVar44;
   ...
   LAB_00109731:uVar38 = *(uint*)( lVar46 + 0x20 );
}
 else {
   *puVar54 = puVar44;
   puVar44[1] = puVar54;
   ...
   *(undefined8**)( this + 0x20 ) = puVar44;
   ...
   LAB_00109865:uVar38 = StringName::get_empty_hash();
}
lVar46 = *(long*)( this + 0x10 );if (uVar38 == 0) {
   uVar38 = 1;
}
uVar41 = (ulong)uVar38;uVar58 = 0;uVar39 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );uVar48 = CONCAT44(0, uVar39);lVar51 = *(long*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( this + 0x28 ) * 8 );auVar17._8_8_ = 0;auVar17._0_8_ = uVar41 * lVar51;auVar33._8_8_ = 0;auVar33._0_8_ = uVar48;lVar52 = SUB168(auVar17 * auVar33, 8);lVar50 = *(long*)( this + 8 );puVar1 = (uint*)( lVar46 + lVar52 * 4 );iVar49 = SUB164(auVar17 * auVar33, 8);uVar57 = *puVar1;while (uVar57 != 0) {
   auVar18._8_8_ = 0;
...
;*(undefined8**)( lVar50 + lVar52 * 8 ) = puVar44;*puVar1 = uVar38;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_00109811:local_a0 = (ServerInfo*)local_78;ServersDebugger::ServerInfo::~ServerInfo(local_a0);LAB_00108f7c:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return local_a8;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();while (true) {
   ...
   LAB_001090ca:plVar3 = (long*)*plVar40;
   if (plVar3 == (long*)0x0) goto LAB_00109156;
}
;Memory::free_static(plVar40, false);*(undefined8*)( lVar46 + 0x20 ) = 0;LAB_00109154:plVar40 = (long*)0x0;LAB_00109156:if (( plStack_70 != (long*)0x0 ) && ( pSVar56 = (StringName*)*plStack_70 ),pSVar56 != (StringName*)0x0) {
   if (plVar40 == (long*)0x0) {
      pauVar45 = (undefined1(*) [16])operator_new(0x18, DefaultAllocator::alloc);
...
LAB_00109239:local_a8 = (StringName*)( *(long*)( *(long*)( this + 8 ) + (ulong)uVar58 * 8 ) + 0x18 );goto LAB_00109811;}/* ServersDebugger::ServersProfiler::add(Array const&) */void ServersDebugger::ServersProfiler::add(ServersProfiler *this, Array *param_1) {
   uint uVar1;
   long *plVar2;
   undefined1 auVar3[16];
   ...
   if (( *(long*)( this + 0x1e0 ) == 0 ) || ( *(int*)( this + 0x204 ) == 0 )) {
      joined_r0x00109b9f:if (( StringName::configured != '\0' ) && ( local_58 != (undefined1[8])0x0 )) {
         StringName::unref();
      }
      ...
      uVar20 = 0;
      do {
         if (( uVar19 == uVar13 ) && ( ( undefined1[8] ) * (long*)( *(long*)( *(long*)( this + 0x1e0 ) + lVar17 * 8 ) + 0x10 ) == local_58 )) {
            bVar11 = true;
            goto LAB_00109d18;
         }
 ...
 while ( ( uVar19 != 0 ) && ( auVar5._8_8_ = 0 ),auVar5._0_8_ = (ulong)uVar19 * lVar14,auVar9._8_8_ = 0,auVar9._0_8_ = uVar22,auVar6._8_8_ = 0,auVar6._0_8_ = ( ulong )(( uVar1 + iVar21 ) - SUB164(auVar5 * auVar9, 8)) * lVar14,auVar10._8_8_ = 0,auVar10._0_8_ = uVar22,uVar20 <= SUB164(auVar6 * auVar10, 8) );
      bVar11 = false;
      LAB_00109d18:if (( StringName::configured != '\0' ) && ( local_58 != (undefined1[8])0x0 )) {
         StringName::unref();
      }
   ...
   StringName::StringName((StringName*)&local_60, (String*)&local_68, false);
   pSVar15 = (StringName*)HashMap<StringName,ServersDebugger::ServerInfo,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ServersDebugger::ServerInfo>>>::operator []((HashMap<StringName,ServersDebugger::ServerInfo,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ServersDebugger::ServerInfo>>>*)( this + 0x1d8 ), (StringName*)&local_60);
 ...
 while ( (int)plVar24[2] != 0 );
   ...
   plVar24 = (long*)0x0;
   LAB_00109cc0:if (( uStack_50 != (long*)0x0 ) && ( pSVar23 = (StringName*)*uStack_50 ),pSVar23 != (StringName*)0x0) {
      if (plVar24 == (long*)0x0) {
...
;
 ...
 while ( pSVar23 != (StringName*)0x0 );
   ...
   LAB_00109feb:if (( StringName::configured != '\0' ) && ( local_60 != 0 )) {
      StringName::unref();
   }

   ServerInfo::~ServerInfo((ServerInfo*)local_58);
   LAB_00109d35:StringName::StringName((StringName*)local_58, (String*)&local_68, false);
   lVar14 = HashMap<StringName,ServersDebugger::ServerInfo,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ServersDebugger::ServerInfo>>>::operator []((HashMap<StringName,ServersDebugger::ServerInfo,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,ServersDebugger::ServerInfo>>>*)( this + 0x1d8 ), (StringName*)local_58);
   if (( StringName::configured != '\0' ) && ( local_58 != (undefined1[8])0x0 )) {
      StringName::unref();
   }

   for (iVar21 = 1; iVar12 = Array::size(),lVar17 = local_68,iVar21 < iVar12 + -1; iVar21 = iVar21 + 2) {
...
/* List<ServersDebugger::ResourceInfo, DefaultAllocator>::~List() */void List<ServersDebugger::ResourceInfo,DefaultAllocator>::~List(List<ServersDebugger::ResourceInfo,DefaultAllocator> *this) {
   long *plVar1;
   long *plVar2;
   long lVar3;
   long lVar4;
...
/* List<RenderingServer::TextureInfo, DefaultAllocator>::~List() */void List<RenderingServer::TextureInfo,DefaultAllocator>::~List(List<RenderingServer::TextureInfo,DefaultAllocator> *this) {
   long *plVar1;
   void *pvVar2;
   long lVar3;
   long lVar4;
...
/* void List<ServersDebugger::ResourceInfo,
   DefaultAllocator>::sort_custom<Comparator<ServersDebugger::ResourceInfo> >() */void List<ServersDebugger::ResourceInfo,DefaultAllocator>::sort_custom<Comparator<ServersDebugger::ResourceInfo>>(List<ServersDebugger::ResourceInfo,DefaultAllocator> *this) {
   size_t __n;
   int iVar1;
   int iVar2;
   int iVar3;
   ...
   if (*(long**)this != (long*)0x0) {
      ppEVar7 = __src;
      for (pEVar12 = (Element*)**(long**)this; pEVar12 != (Element*)0x0; pEVar12 = *(Element**)( pEVar12 + 0x28 )) {
         *ppEVar7 = pEVar12;
         ppEVar7 = ppEVar7 + 1;
      }
 ...
 while ( pEVar12 != (Element*)0x1 );
   SortArray<List<ServersDebugger::ResourceInfo,DefaultAllocator>::Element*,List<ServersDebugger::ResourceInfo,DefaultAllocator>::AuxiliaryComparator<Comparator<ServersDebugger::ResourceInfo>>,true>::introsort(0, (long)pEVar10, __src, lVar9 * 2);
   if ((long)pEVar10 < 0x11) {
      ...
      do {
         while (true) {
            ...
            LAB_0010a674:ppEVar7 = __src + (long)pEVar12;
            while (true) {
               pEVar6 = ppEVar7[-1];
 ...
 while ( pEVar10 != pEVar12 );
      ...
      do {
         while (true) {
            ...
            LAB_0010a4f7:ppEVar7 = __src + lVar13;
            while (true) {
               pEVar6 = ppEVar7[-1];
...
;
            _err_print_error("unguarded_linear_insert", "./core/templates/sort_array.h", 0xff, "bad comparison function; sorting will be broken", 0, 0);
            *ppEVar7 = pEVar12;
            LAB_0010a530:lVar9 = lVar13 + 1;
            if (lVar13 + 1 == 0x10) goto LAB_0010a53a;
         }
;
         if (*(ulong*)( *__src + 0x18 ) <= *(ulong*)( pEVar12 + 0x18 )) goto LAB_0010a4f7;
         LAB_0010a4ba:memmove(__src + 1, __src, lVar13 * 8);
         *__src = pEVar12;
         lVar9 = lVar13 + 1;
      }
 while ( lVar13 + 1 != 0x10 );
      LAB_0010a53a:pEVar12 = (Element*)( lVar13 + 1 );
      do {
...
;
         _err_print_error("unguarded_linear_insert", "./core/templates/sort_array.h", 0xff, "bad comparison function; sorting will be broken", 0, 0);
         LAB_0010a5a0:pEVar12 = pEVar12 + 1;
 ...
 while ( pEVar10 != pEVar12 );
   ...
   LAB_0010a6c5:puVar5 = *(undefined8**)this;
   *puVar5 = pEVar11;
...
/* CowData<RenderingServer::FrameProfileArea>::_unref() */void CowData<RenderingServer::FrameProfileArea>::_unref(CowData<RenderingServer::FrameProfileArea> *this) {
   long *plVar1;
   long *plVar2;
   long lVar3;
   long lVar4;
...
/* CowData<RenderingServer::FrameProfileArea>::_realloc(long) */undefined8 CowData<RenderingServer::FrameProfileArea>::_realloc(CowData<RenderingServer::FrameProfileArea> *this, long param_1) {
   undefined8 *puVar1;
...
/* Vector<RenderingServer::FrameProfileArea>::append_array(Vector<RenderingServer::FrameProfileArea>)
    */void Vector<RenderingServer::FrameProfileArea>::append_array(Vector<RenderingServer::FrameProfileArea> *this, long param_2) {
   CowData *pCVar1;
   long lVar2;
   long lVar3;
   code *pcVar4;
   ...
   long lVar8;
   CowData<char32_t> *this_00;
   if (( *(long*)( param_2 + 8 ) != 0 ) && ( lVar2 = lVar2 != 0 )) {
      if (*(long*)( this + 8 ) == 0) {
         lVar7 = 0;
         lVar6 = lVar2;
      }
      ...
      CowData<RenderingServer::FrameProfileArea>::resize<false>((CowData<RenderingServer::FrameProfileArea>*)( this + 8 ), lVar6);
      if (0 < lVar2) {
         lVar6 = 0;
         lVar7 = lVar7 * 0x18;
         do {
            ...
            if (lVar3 == 0) {
               lVar8 = 0;
               LAB_0010a9e7:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar6, lVar8, "p_index", "size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
            ...
            CowData<RenderingServer::FrameProfileArea>::_copy_on_write((CowData<RenderingServer::FrameProfileArea>*)( this + 8 ));
...
/* ServersDebugger::VisualProfiler::tick(double, double, double, double) */void ServersDebugger::VisualProfiler::tick(double param_1, double param_2, double param_3, double param_4) {
   long lVar1;
   code *pcVar2;
   long *plVar3;
   long lVar4;
 ...
 while ( !bVar5 );
      ...
      LAB_0010ab30:Vector<RenderingServer::FrameProfileArea>::append_array(local_40, &local_58);
      CowData<RenderingServer::FrameProfileArea>::_unref((CowData<RenderingServer::FrameProfileArea>*)&local_50);
      ...
      CowData<RenderingServer::FrameProfileArea>::_unref((CowData<RenderingServer::FrameProfileArea>*)&local_38);
   }

   CowData<RenderingServer::FrameProfileArea>::_unref((CowData<RenderingServer::FrameProfileArea>*)&local_60);
   if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* CowData<ServersDebugger::ScriptFunctionInfo>::_unref() */void CowData<ServersDebugger::ScriptFunctionInfo>::_unref(CowData<ServersDebugger::ScriptFunctionInfo> *this) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   long *plVar4;
...
/* CowData<ServersDebugger::ScriptFunctionInfo>::_realloc(long) */undefined8 CowData<ServersDebugger::ScriptFunctionInfo>::_realloc(CowData<ServersDebugger::ScriptFunctionInfo> *this, long param_1) {
   undefined8 *puVar1;
   puVar1 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), param_1 + 0x10, false);
   if (puVar1 != (undefined8*)0x0) {
      *puVar1 = 1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<ServersDebugger::ScriptFunctionInfo>::resize<false>(long) */undefined8 CowData<ServersDebugger::ScriptFunctionInfo>::resize<false>(CowData<ServersDebugger::ScriptFunctionInfo> *this, long param_1) {
   code *pcVar1;
   undefined8 uVar2;
   undefined8 *puVar3;
   undefined8 *puVar4;
   ...
   if (param_1 * 0x28 == 0) {
      LAB_0010afd0:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
;
   ...
   if (lVar9 == lVar7) {
      LAB_0010af43:puVar6 = *(undefined8**)this;
      if (puVar6 == (undefined8*)0x0) {
         LAB_0010ae44:/* WARNING: Does not return */pcVar1 = (code*)invalidInstructionException();
         ( *pcVar1 )();
      }
 ...
 while ( puVar4 != puVar6 + param_1 * 5 );
   LAB_0010af20:puVar6[-1] = param_1;
   return 0;
}
/* CowData<ScriptLanguage::ProfilingInfo>::_unref() */void CowData<ScriptLanguage::ProfilingInfo>::_unref(CowData<ScriptLanguage::ProfilingInfo> *this) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   long *plVar4;
...
/* ServersDebugger::ScriptsProfiler::~ScriptsProfiler() */void ServersDebugger::ScriptsProfiler::~ScriptsProfiler(ScriptsProfiler *this) {
   long *plVar1;
   uint uVar2;
   long lVar3;
   void *pvVar4;
 ...
 while ( lVar3 != (ulong)uVar2 << 2 );
   ...
   LAB_0010b1a5:if (*(long*)( this + 0x1e8 ) != 0) {
      LOCK();
   ...
   CowData<ScriptLanguage::ProfilingInfo>::_unref((CowData<ScriptLanguage::ProfilingInfo>*)( this + 0x1d8 ));
   EngineProfiler::~EngineProfiler((EngineProfiler*)this);
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ServersDebugger::ScriptsProfiler::write_frame_data(Vector<ServersDebugger::ScriptFunctionInfo>&,
   unsigned long&, bool) */void ServersDebugger::ScriptsProfiler::write_frame_data(ScriptsProfiler *this, Vector *param_1, ulong *param_2, bool param_3) {
   uint uVar1;
   code *pcVar2;
   ...
   if (0 < (int)ScriptServer::_language_count) {
      ...
      if (param_3) {
         while (true) {
            ...
            iVar37 = iVar37 + 1;
            CowData<ScriptLanguage::ProfilingInfo>::_copy_on_write((CowData<ScriptLanguage::ProfilingInfo>*)( this + 0x1d8 ));
            iVar20 = ( *pcVar2 )(plVar22, *(long*)( this + 0x1d8 ) + (long)iVar31 * 0x28, (int)lVar23 - iVar31);
...
;
      ...
      lVar23 = 0;
      LAB_0010b421:_err_print_index_error("operator[]", "./core/templates/vector.h", 0x38, lVar38, lVar23, "p_index", "((Vector<T> *)(this))->_cowdata.size()", "", false, true);
      _err_flush_stdout();
      /* WARNING: Does not return */
      pcVar2 = (code*)invalidInstructionException();
      ( *pcVar2 )();
   ...
   CowData<ScriptLanguage::ProfilingInfo*>::_copy_on_write((CowData<ScriptLanguage::ProfilingInfo*>*)( this + 0x1e8 ));
   LAB_0010b627:uVar1 = *(uint*)( this + 0x220 );
   *param_2 = 0;
   uVar24 = (ulong)uVar1;
   if (0 < (int)uVar1) {
      uVar24 = 0;
   ...
   LAB_0010b645:CowData<ServersDebugger::ScriptFunctionInfo>::resize<false>((CowData<ServersDebugger::ScriptFunctionInfo>*)( param_1 + 8 ), (long)(int)uVar24);
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      CowData<ServersDebugger::ScriptFunctionInfo>::_copy_on_write((CowData<ServersDebugger::ScriptFunctionInfo>*)( param_1 + 8 ));
      return;
   }

   LAB_0010be7d:/* WARNING: Subroutine does not return */__stack_chk_fail();
   LAB_0010b448:lVar30 = (long)iVar31;
   if (iVar31 < 1) {
      CowData<ScriptLanguage::ProfilingInfo*>::_copy_on_write((CowData<ScriptLanguage::ProfilingInfo*>*)( this + 0x1e8 ));
 ...
 while ( lVar30 != lVar38 );
   ...
   __src = *(ProfilingInfo***)( this + 0x1e8 );
   if (lVar30 == 1) {
      SortArray<ScriptLanguage::ProfilingInfo*,ServersDebugger::ScriptsProfiler::ProfileInfoSort,true>::introsort(0, 1, __src, 0);
      uVar32 = 1;
   }
 else {
      LAB_0010b50f:lVar23 = 0;
      lVar38 = lVar30;
      do {
         lVar38 = lVar38 >> 1;
         lVar23 = lVar23 + 1;
 ...
 while ( lVar38 != 1 );
      SortArray<ScriptLanguage::ProfilingInfo*,ServersDebugger::ScriptsProfiler::ProfileInfoSort,true>::introsort(0, lVar30, __src, lVar23 * 2);
      lVar38 = 1;
      if (lVar30 < 0x11) {
         lVar38 = 1;
         do {
 ...
 while ( *(ulong*)( pPVar29 + 0x10 ) < uVar32 );
               ...
               LAB_0010b71d:*(ProfilingInfo**)( (long)__src + sVar27 ) = pPVar3;
            }
 ...
 while ( *(ulong*)( pPVar29 + 0x10 ) < uVar32 );
               ...
               LAB_0010b5e5:*(ProfilingInfo**)( (long)__src + sVar27 ) = pPVar3;
            }
   ...
   *param_2 = 0;
   ...
   if (0 < (int)uVar24) {
      ...
      if (lVar38 == 0) {
         local_c8 = 0;
         lVar23 = 0;
         LAB_0010ba22:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, local_c8, lVar23, "p_index", "size()", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar2 = (code*)invalidInstructionException();
         ( *pcVar2 )();
      ...
      do {
         ...
         if (( *(long*)( this + 0x1f8 ) != 0 ) && ( iVar31 != 0 )) {
            ...
            if (uVar36 != 0) {
               do {
                  if (( (uint)uVar34 == uVar21 ) && ( *(long*)( *(long*)( *(long*)( this + 0x1f8 ) + lVar28 * 8 ) + 0x10 ) == *plVar22 )) goto LAB_0010b8a5;
                  uVar35 = uVar35 + 1;
                  auVar4._8_8_ = 0;
 ...
 while ( ( uVar36 != 0 ) && ( auVar5._8_8_ = 0 ),auVar5._0_8_ = uVar34 * lVar23,auVar13._8_8_ = 0,auVar13._0_8_ = uVar32,auVar6._8_8_ = 0,auVar6._0_8_ = ( ulong )(( uVar1 + iVar31 ) - SUB164(auVar5 * auVar13, 8)) * lVar23,auVar14._8_8_ = 0,auVar14._0_8_ = uVar32,uVar35 <= SUB164(auVar6 * auVar14, 8) );
            }
            ...
            LAB_0010b9ff:lVar23 = 0;
            goto LAB_0010ba22;
         }

         LAB_0010b912:local_60 = -1;
         local_68 = 0;
         lVar23 = *(long*)( lVar38 + -8 );
         if (lVar23 <= (long)local_c8) goto LAB_0010ba22;
         ...
         lVar23 = *(long*)( lVar38 + -8 );
         if (lVar23 <= (long)local_c8) goto LAB_0010ba22;
         piVar25 = (int*)HashMap<StringName,int,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,int>>>::operator []((HashMap<StringName,int,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,int>>>*)( this + 0x1f0 ), *(StringName**)( lVar38 + lVar30 ));
         ...
         *piVar25 = iVar31;
         ...
         lVar38 = *(long*)( this + 0x1e8 );
         LAB_0010b8a5:if (lVar38 == 0) goto LAB_0010b9ff;
         lVar23 = *(long*)( lVar38 + -8 );
         if (lVar23 <= (long)local_c8) goto LAB_0010ba22;
         local_c8 = local_c8 + 1;
 ...
 while ( local_c8 != uVar24 );
      CowData<ServersDebugger::ScriptFunctionInfo>::resize<false>((CowData<ServersDebugger::ScriptFunctionInfo>*)( param_1 + 8 ), uVar24);
      local_c8 = 0;
      CowData<ServersDebugger::ScriptFunctionInfo>::_copy_on_write((CowData<ServersDebugger::ScriptFunctionInfo>*)( param_1 + 8 ));
      lVar38 = *(long*)( this + 0x1e8 );
      ...
      do {
         ...
         if (( *(long*)( this + 0x1f8 ) != 0 ) && ( *(int*)( this + 0x21c ) != 0 )) {
            ...
            if (uVar36 != 0) {
               uVar36 = 0;
               while (( (uint)uVar34 != uVar21 || ( *(long*)( *(long*)( *(long*)( this + 0x1f8 ) + lVar30 * 8 ) + 0x10 ) != *plVar22 ) )) {
                  uVar36 = uVar36 + 1;
                  auVar8._8_8_ = 0;
                  ...
                  if (( uVar35 == 0 ) || ( auVar9._8_8_ = 0 ),auVar9._0_8_ = uVar34 * lVar23,auVar17._8_8_ = 0,auVar17._0_8_ = uVar32,auVar10._8_8_ = 0,auVar10._0_8_ = ( ulong )(( uVar1 + iVar31 ) - SUB164(auVar9 * auVar17, 8)) * lVar23,auVar18._8_8_ = 0,auVar18._0_8_ = uVar32,SUB164(auVar10 * auVar18, 8) < uVar36) goto LAB_0010bd12;
               }
;
               if (lVar38 == 0) goto LAB_0010bde9;
               lVar23 = *(long*)( lVar38 + -8 );
               if (lVar23 <= (long)local_c8) goto LAB_0010ba22;
               puVar26 = (undefined4*)HashMap<StringName,int,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,int>>>::operator []((HashMap<StringName,int,HashMapHasherDefault,HashMapComparatorDefault<StringName>,DefaultTypedAllocator<HashMapElement<StringName,int>>>*)( this + 0x1f0 ), *(StringName**)( lVar38 + local_c8 * 8 ));
               lVar38 = *(long*)( this + 0x1e8 );
               *puVar40 = *puVar26;
            }

            LAB_0010bd12:if (lVar38 == 0) goto LAB_0010bde9;
            lVar23 = *(long*)( lVar38 + -8 );
            if (lVar23 <= (long)local_c8) goto LAB_0010ba22;
         }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ServersDebugger::ServersProfiler::_send_frame_data(bool) */void ServersDebugger::ServersProfiler::_send_frame_data(ServersProfiler *this, bool param_1) {
   undefined8 *puVar1;
   long *plVar2;
   long lVar3;
   code *pcVar4;
   ...
   do {
      if (puVar1 == (undefined8*)0x0) {
         local_b0 = 0;
         ScriptsProfiler::write_frame_data((ScriptsProfiler*)( this + 0x208 ), local_50, &local_b0, param_1);
         plVar6 = EngineDebugger::singleton;
         ...
         if (this[0x1d0] == (ServersProfiler)0x0) {
            ...
            CowData<ServersDebugger::ScriptFunctionInfo>::_unref((CowData<ServersDebugger::ScriptFunctionInfo>*)&local_48);
            List<ServersDebugger::ServerInfo,DefaultAllocator>::~List((List<ServersDebugger::ServerInfo,DefaultAllocator>*)&local_58);
         }
 else {
      ...
      if (!param_1) {
         List<ServersDebugger::ServerInfo,DefaultAllocator>::push_back((List<ServersDebugger::ServerInfo,DefaultAllocator>*)&local_58, (ServerInfo*)( puVar1 + 3 ));
      }
 ...
 while ( (int)plVar6[2] != 0 );
      ...
      LAB_0010bfda:puVar1 = (undefined8*)*puVar1;
   }
 while ( true );
}
/* ServersDebugger::ServersProfiler::tick(double, double, double, double) */void ServersDebugger::ServersProfiler::tick(ServersProfiler *this, double param_1, double param_2, double param_3, double param_4) {
...
/* ServersDebugger::ServersProfiler::toggle(bool, Array const&) */void ServersDebugger::ServersProfiler::toggle(ServersProfiler *this, bool param_1, Array *param_2) {
   uint uVar1;
   void *pvVar2;
   long lVar3;
   this[0x1d0] = (ServersProfiler)0x0;
...
/* ServersDebugger::ScriptsProfiler::~ScriptsProfiler() */void ServersDebugger::ScriptsProfiler::~ScriptsProfiler(ScriptsProfiler *this) {
 ...
 while ( lVar3 != (ulong)uVar2 << 2 );
   ...
   LAB_0010c405:if (*(long*)( this + 0x1e8 ) != 0) {
      LOCK();
      plVar1 = (long*)( *(long*)( this + 0x1e8 ) + -0x10 );
      *plVar1 = *plVar1 + -1;
      UNLOCK();
...
/* ServersDebugger::ServersProfiler::~ServersProfiler() */void ServersDebugger::ServersProfiler::~ServersProfiler(ServersProfiler *this) {
   long *plVar1;
   uint uVar2;
   long lVar3;
   void *pvVar4;
 ...
 while ( (ulong)uVar2 << 2 != lVar3 );
   ...
   LAB_0010c59a:if (*(long*)( this + 0x3f0 ) != 0) {
      LOCK();
   ...
   CowData<ScriptLanguage::ProfilingInfo>::_unref((CowData<ScriptLanguage::ProfilingInfo>*)( this + 0x3e0 ));
 ...
 while ( lVar3 != (ulong)uVar2 << 2 );
   ...
   LAB_0010c693:EngineProfiler::~EngineProfiler((EngineProfiler*)this);
   return;
}
/* ServersDebugger::ServersProfiler::~ServersProfiler() */void ServersDebugger::ServersProfiler::~ServersProfiler(ServersProfiler *this) {
   long *plVar1;
 ...
 while ( (ulong)uVar2 << 2 != lVar3 );
   ...
   LAB_0010c83a:if (*(long*)( this + 0x3f0 ) != 0) {
      LOCK();
      plVar1 = (long*)( *(long*)( this + 0x3f0 ) + -0x10 );
      *plVar1 = *plVar1 + -1;
      UNLOCK();
 ...
 while ( lVar3 != (ulong)uVar2 << 2 );
   ...
   LAB_0010c933:EngineProfiler::~EngineProfiler((EngineProfiler*)this);
   operator_delete(this, 0x450);
   return;
}
/* CowData<ScriptLanguage::ProfilingInfo>::_realloc(long) */undefined8 CowData<ScriptLanguage::ProfilingInfo>::_realloc(CowData<ScriptLanguage::ProfilingInfo> *this, long param_1) {
   undefined8 *puVar1;
   puVar1 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), param_1 + 0x10, false);
   if (puVar1 != (undefined8*)0x0) {
      *puVar1 = 1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* void Ref<ServersDebugger::ServersProfiler>::instantiate<>() */void Ref<ServersDebugger::ServersProfiler>::instantiate<>(Ref<ServersDebugger::ServersProfiler> *this) {
   long *plVar1;
                  ...
                  if ((long)uVar7 <= (long)uVar14) {
                     ...
                     while (lVar11 != 0) {
                        if (*(ulong*)( lVar11 + -8 ) <= uVar14) {
                           LAB_0010d136:if (lVar10 != local_78) {
...
;
                  ...
                  if (lVar10 == local_78) {
                     LAB_0010d2f7:puVar12 = *(undefined8**)( this_02 + 0x3e0 );
                     if (puVar12 == (undefined8*)0x0) {
                        LAB_0010ce97:/* WARNING: Does not return */pcVar3 = (code*)invalidInstructionException();
                        ( *pcVar3 )();
                     }

                     lVar10 = puVar12[-1];
                     if (lVar10 < (long)uVar7) goto LAB_0010d1db;
                     LAB_0010d220:puVar12[-1] = uVar7;
                  }
 else if (uVar14 == 0) {
                     ...
                     if (puVar8 != (undefined8*)0x0) {
                        ...
                        *(undefined8**)( this_02 + 0x3e0 ) = puVar12;
                        lVar10 = 0;
                        LAB_0010d1db:puVar18 = puVar12 + uVar7 * 5;
 ...
 while ( puVar18 != puVar8 );
   ...
   LAB_0010ceb0:if (Variant::needs_deinit[local_58[0]] != '\0') {
      Variant::_clear_internal();
   }
         ...
         if (lVar10 == 0) {
            ...
            if (lVar11 != lVar19) {
               ...
               LAB_0010cf7d:if (lVar11 * 8 != 0) {
                  ...
                  if (lVar16 != 0) {
                     if (lVar11 <= lVar19) {
                        if (( lVar16 == lVar10 ) || ( iVar6 = CowData<ScriptLanguage::ProfilingInfo*>::_realloc(this_01, lVar16) ),iVar6 == 0) {
                     ...
                     if (lVar16 == lVar10) {
                        LAB_0010d330:puVar12 = *(undefined8**)( this_02 + 0x3f0 );
                        if (puVar12 == (undefined8*)0x0) {
                           LAB_0010d16c:_DAT_00000000 = 0;
                           /* WARNING: Does not return */
                           pcVar3 = (code*)invalidInstructionException();
                           ( *pcVar3 )();
                        }

                        LAB_0010d01f:puVar12[-1] = lVar11;
                     }
 else if (lVar19 == 0) {
   ...
   LAB_0010d028:*(undefined1(*) [16])( this_02 + 0x430 ) = (undefined1[16])0x0;
   *(undefined1(*) [16])( this_02 + 0x440 ) = (undefined1[16])0x0;
   ...
   cVar5 = RefCounted::unreference();
   joined_r0x0010d0dd:if (( cVar5 != '\0' ) && ( cVar5 = cVar5 != '\0' )) {
...
LAB_0010d4e6:/* WARNING: Subroutine does not return */__stack_chk_fail();}/* WARNING: Control flow encountered bad instruction data *//* ServersDebugger::ServersProfiler::~ServersProfiler() */void ServersDebugger::ServersProfiler::~ServersProfiler(ServersProfiler *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* ServersDebugger::ScriptsProfiler::~ScriptsProfiler() */void ServersDebugger::ScriptsProfiler::~ScriptsProfiler(ScriptsProfiler *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* List<RenderingServer::TextureInfo, DefaultAllocator>::~List() */void List<RenderingServer::TextureInfo,DefaultAllocator>::~List(List<RenderingServer::TextureInfo,DefaultAllocator> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* List<ServersDebugger::ResourceInfo, DefaultAllocator>::~List() */void List<ServersDebugger::ResourceInfo,DefaultAllocator>::~List(List<ServersDebugger::ResourceInfo,DefaultAllocator> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* List<ServersDebugger::ServerInfo, DefaultAllocator>::~List() */void List<ServersDebugger::ServerInfo,DefaultAllocator>::~List(List<ServersDebugger::ServerInfo,DefaultAllocator> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* ServersDebugger::VisualProfiler::~VisualProfiler() */void ServersDebugger::VisualProfiler::~VisualProfiler(VisualProfiler *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* ServersDebugger::ServerInfo::~ServerInfo() */void ServersDebugger::ServerInfo::~ServerInfo(ServerInfo *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

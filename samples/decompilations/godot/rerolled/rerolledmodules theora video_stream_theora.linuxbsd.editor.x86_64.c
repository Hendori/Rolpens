/* VideoStreamPlaybackTheora::get_playback_position() const */double VideoStreamPlaybackTheora::get_playback_position(VideoStreamPlaybackTheora *this) {
   return *(double*)( this + 0x990 ) - *(double*)( this + 0x9a8 );
}
/* VideoStreamPlaybackTheora::is_playing() const */VideoStreamPlaybackTheora VideoStreamPlaybackTheora::is_playing(VideoStreamPlaybackTheora *this) {
   return this[0x984];
}
/* VideoStreamPlaybackTheora::set_paused(bool) */void VideoStreamPlaybackTheora::set_paused(VideoStreamPlaybackTheora *this, bool param_1) {
   this[0x986] = (VideoStreamPlaybackTheora)param_1;
   return;
}
/* VideoStreamPlaybackTheora::is_paused() const */VideoStreamPlaybackTheora VideoStreamPlaybackTheora::is_paused(VideoStreamPlaybackTheora *this) {
   return this[0x986];
}
/* VideoStreamPlaybackTheora::get_length() const */undefined8 VideoStreamPlaybackTheora::get_length(void) {
   return 0;
}
/* VideoStreamPlaybackTheora::get_channels() const */undefined4 VideoStreamPlaybackTheora::get_channels(VideoStreamPlaybackTheora *this) {
   return *(undefined4*)( this + 0x7bc );
}
/* VideoStreamPlaybackTheora::set_audio_track(int) */void VideoStreamPlaybackTheora::set_audio_track(VideoStreamPlaybackTheora *this, int param_1) {
   *(int*)( this + 0x9b8 ) = param_1;
   return;
}
/* VideoStreamPlaybackTheora::get_mix_rate() const */undefined4 VideoStreamPlaybackTheora::get_mix_rate(VideoStreamPlaybackTheora *this) {
   return *(undefined4*)( this + 0x7c0 );
}
/* ResourceFormatLoaderTheora::handles_type(String const&) const */undefined4 ResourceFormatLoaderTheora::handles_type(ResourceFormatLoaderTheora *this, String *param_1) {
   undefined4 uVar1;
   long in_FS_OFFSET;
   long local_30;
   long local_28;
   ...
   LAB_00100116:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar1;
   }
...
/* VideoStreamPlaybackTheora::seek(double) */void VideoStreamPlaybackTheora::seek(double param_1) {
   if (seek first_print) {
      return;
   }

   _err_print_error(&_LC4, "modules/theora/video_stream_theora.cpp", 0x1f0, "Seeking in Theora videos is not implemented yet (it\'s only supported for GDExtension-provided video streams).", 0, 1);
   seek(double)
   return;
}
...
/* VideoStreamPlaybackTheora::get_texture() const */void VideoStreamPlaybackTheora::get_texture(void) {
   char cVar1;
   long lVar2;
   long in_RSI;
   long *in_RDI;
...
/* ResourceFormatLoaderTheora::load(String const&, String const&, Error*, bool, float*,
   ResourceFormatLoader::CacheMode) */long *ResourceFormatLoaderTheora::load(long *param_1, undefined8 param_2, int param_3, undefined8 param_4, undefined4 *param_5) {
   char cVar1;
   VideoStream *this;
   long lVar2;
   long in_FS_OFFSET;
...
/* ResourceFormatLoaderTheora::get_resource_type(String const&) const */String *ResourceFormatLoaderTheora::get_resource_type(String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   char cVar4;
...
/* ResourceFormatLoaderTheora::get_recognized_extensions(List<String, DefaultAllocator>*) const */void ResourceFormatLoaderTheora::get_recognized_extensions(ResourceFormatLoaderTheora *this, List *param_1) {
   long *plVar1;
   long lVar2;
   long lVar3;
...
/* VideoStreamPlaybackTheora::buffer_data() */ulong VideoStreamPlaybackTheora::buffer_data(VideoStreamPlaybackTheora *this) {
   undefined8 uVar1;
   ulong uVar2;
...
/* VideoStreamPlaybackTheora::queue_page(ogg_page*) */undefined8 VideoStreamPlaybackTheora::queue_page(VideoStreamPlaybackTheora *this, ogg_page *param_1) {
   int iVar1;
   if (( *(int*)( this + 0x970 ) == 0 ) || ( ogg_stream_pagein(this + 0x5b8, param_1),*(int*)( this + 0x728 ) == 0 )) {
...
/* VideoStreamPlaybackTheora::clear() */void VideoStreamPlaybackTheora::clear(VideoStreamPlaybackTheora *this) {
   Object *pOVar1;
   char cVar2;
...
/* VideoStreamPlaybackTheora::~VideoStreamPlaybackTheora() */void VideoStreamPlaybackTheora::~VideoStreamPlaybackTheora(VideoStreamPlaybackTheora *this) {
   long *plVar1;
   long lVar2;
   Object *pOVar3;
   char cVar4;
...
/* VideoStreamPlaybackTheora::VideoStreamPlaybackTheora() */void VideoStreamPlaybackTheora::VideoStreamPlaybackTheora(VideoStreamPlaybackTheora *this) {
   ...
   *(undefined2*)( this + 0x988 ) = 0;
   for (int i = 0; i < 3; i++) {
      *(undefined1(*) [16])( this + ( 16*i + 1976 ) ) = (undefined1[16])0;
   }
   ...
   *(undefined1(*) [16])( this + 0x9a0 ) = (undefined1[16])0x0;
   ...
   if (cVar1 == '\0') {
      ...
      *(ImageTexture**)( this + 0x9b0 ) = this_00;
      ...
      if (( ( pOVar3 == (Object*)0x0 ) || ( cVar1 = RefCounted::unreference() ),cVar1 == '\0' )) goto LAB_00101016;
   }
   ...
   LAB_00101016:cVar1 = RefCounted::unreference();
...
/* VideoStreamTheora::_bind_methods() */void VideoStreamTheora::_bind_methods(void) {
   return;
}
/* WARNING: Removing unreachable block (ram,0x0010128d) *//* WARNING: Removing unreachable block (ram,0x001011db) *//* WARNING: Removing unreachable block (ram,0x00101811) *//* WARNING: Removing unreachable block (ram,0x00101821) *//* WARNING: Removing unreachable block (ram,0x00101fed) *//* VideoStreamPlaybackTheora::video_write(th_img_plane*) */void VideoStreamPlaybackTheora::video_write(VideoStreamPlaybackTheora *this, th_img_plane *param_1) {
   long *plVar1;
   byte bVar2;
   int iVar3;
   undefined4 uVar4;
   ...
   if (iVar26 == 3) {
      ...
      do {
         ...
         if ((int)uVar11 < 0) {
            ...
            puVar14 = puVar9;
            do {
               uVar27 = *(int*)( tables + (ulong)pbVar12[lVar13] * 4 + 0x400 ) + *(int*)( tables + (ulong)pbVar16[lVar13] * 4 + 0x800 ) + *(int*)( tables + (ulong)pbVar25[lVar13] * 4 );
               ...
               *puVar14 = (char)( uVar27 >> 0xb );
               ...
               uVar27 = *(int*)( tables + (ulong)pbVar16[lVar13 + 1] * 4 + 0x800 ) + *(int*)( tables + (ulong)pbVar12[lVar13 + 1] * 4 + 0x400 ) + *(int*)( tables + (ulong)pbVar25[lVar13 + 1] * 4 );
               uVar22 = uVar27 & 0x40080100;
               if (uVar22 != 0) {
                  uVar27 = uVar22 - ( (int)uVar22 >> 8 ) | uVar27;
                  uVar27 = ( ~(uVar27 >> 9) & 0x400801 ) + uVar27;
 ...
 while ( puVar9 + uVar15 * 8 != puVar10 );
         ...
         if (uVar11 >> 0x10 == 0) {
            ...
            pbVar16 = pbVar16 + 1;
            pbVar19 = pbVar25 + 1;
            uVar27 = *(int*)( tables + (ulong)bVar2 * 4 + 0x800 ) + *(int*)( tables + ( ulong ) * pbVar12 * 4 + 0x400 ) + *(int*)( tables + ( ulong ) * pbVar25 * 4 );
            uVar22 = uVar27 & 0x40080100;
            if (uVar22 != 0) {
         ...
         if ((int)uVar11 < 0) {
            ...
            do {
               uVar27 = *(int*)( tables + (ulong)pbVar18[lVar13] * 4 + 0x400 ) + *(int*)( tables + (ulong)pbVar16[lVar13] * 4 + 0x800 ) + *(int*)( tables + (ulong)pbVar19[lVar13] * 4 );
               uVar22 = uVar27 & 0x40080100;
               if (uVar22 != 0) {
                  uVar27 = uVar22 - ( (int)uVar22 >> 8 ) | uVar27;
                  uVar27 = ( ~(uVar27 >> 9) & 0x400801 ) + uVar27;
               ...
               *puVar14 = (char)( uVar27 >> 0xb );
               puVar14[1] = (char)( uVar27 >> 0x16 );
               uVar27 = *(int*)( tables + (ulong)pbVar18[lVar13 + 1] * 4 + 0x400 ) + *(int*)( tables + (ulong)pbVar16[lVar13 + 1] * 4 + 0x800 ) + *(int*)( tables + (ulong)pbVar19[lVar13 + 1] * 4 );
               uVar22 = uVar27 & 0x40080100;
               if (uVar22 != 0) {
                  uVar27 = uVar22 - ( (int)uVar22 >> 8 ) | uVar27;
                  uVar27 = ( ~(uVar27 >> 9) & 0x400801 ) + uVar27;
 ...
 while ( puVar9 != puVar10 );
         ...
         if (uVar11 >> 0x10 == 0) {
            ...
            pbVar16 = pbVar16 + 1;
            pbVar25 = pbVar19 + 1;
            uVar27 = *(int*)( tables + (ulong)bVar2 * 4 + 0x800 ) + *(int*)( tables + ( ulong ) * pbVar18 * 4 + 0x400 ) + *(int*)( tables + ( ulong ) * pbVar19 * 4 );
            uVar22 = uVar27 & 0x40080100;
            if (uVar22 != 0) {
               uVar27 = uVar27 | uVar22 - ( (int)uVar22 >> 8 );
               uVar27 = uVar27 + ( ~(uVar27 >> 9) & 0x400801 );
 ...
 while ( 0 < iVar26 );
      ...
      do {
         ...
         if ((int)uVar11 < 0) {
            ...
            puVar14 = puVar9;
            do {
               uVar22 = *(int*)( tables + (ulong)pbVar12[lVar13 * 2] * 4 ) + *(int*)( tables + (ulong)pbVar16[lVar13] * 4 + 0x800 ) + *(int*)( tables + (ulong)pbVar25[lVar13] * 4 + 0x400 );
               uVar27 = *(int*)( tables + (ulong)pbVar16[lVar13] * 4 + 0x800 ) + *(int*)( tables + (ulong)pbVar25[lVar13] * 4 + 0x400 ) + *(int*)( tables + (ulong)pbVar12[lVar13 * 2 + 1] * 4 );
 ...
 while ( puVar9 + uVar15 * 8 != puVar10 );
         ...
         if (uVar11 >> 0x10 == 0) {
            pbVar18 = pbVar12 + 1;
            uVar27 = *(int*)( tables + ( ulong ) * pbVar16 * 4 + 0x800 ) + *(int*)( tables + ( ulong ) * pbVar25 * 4 + 0x400 ) + *(int*)( tables + ( ulong ) * pbVar12 * 4 );
            uVar22 = uVar27 & 0x40080100;
            if (uVar22 != 0) {
               uVar27 = uVar27 | uVar22 - ( (int)uVar22 >> 8 );
               uVar27 = uVar27 + ( ~(uVar27 >> 9) & 0x400801 );
         ...
         if ((int)uVar11 < 0) {
            ...
            puVar10 = puVar14 + uVar15 * 8;
            do {
               uVar22 = *(int*)( tables + (ulong)pbVar18[lVar13 * 2] * 4 ) + *(int*)( tables + (ulong)pbVar16[lVar13] * 4 + 0x800 ) + *(int*)( tables + (ulong)pbVar25[lVar13] * 4 + 0x400 );
               uVar27 = *(int*)( tables + (ulong)pbVar16[lVar13] * 4 + 0x800 ) + *(int*)( tables + (ulong)pbVar25[lVar13] * 4 + 0x400 ) + *(int*)( tables + (ulong)pbVar18[lVar13 * 2 + 1] * 4 );
               uVar23 = uVar22 & 0x40080100;
               if (uVar23 != 0) {
                  uVar22 = uVar23 - ( (int)uVar23 >> 8 ) | uVar22;
                  uVar22 = ( ~(uVar22 >> 9) & 0x400801 ) + uVar22;
 ...
 while ( puVar10 != puVar9 );
         ...
         if (uVar11 >> 0x10 == 0) {
            pbVar12 = pbVar18 + 1;
            uVar27 = *(int*)( tables + ( ulong ) * pbVar16 * 4 + 0x800 ) + *(int*)( tables + ( ulong ) * pbVar25 * 4 + 0x400 ) + *(int*)( tables + ( ulong ) * pbVar18 * 4 );
            uVar22 = uVar27 & 0x40080100;
            if (uVar22 != 0) {
               uVar27 = uVar27 | uVar22 - ( (int)uVar22 >> 8 );
               uVar27 = uVar27 + ( ~(uVar27 >> 9) & 0x400801 );
      ...
      if (0 < iVar26) {
         ...
         do {
            ...
            if ((int)uVar11 < 0) {
               ...
               do {
                  iVar17 = *(int*)( tables + (ulong)pbVar25[lVar20] * 4 + 0x800 ) + *(int*)( tables + (ulong)pbVar16[lVar20] * 4 + 0x400 );
 ...
 while ( puVar9 + uVar15 * 8 != puVar8 );
            ...
            if (uVar11 >> 0x10 == 0) {
               pbVar18 = pbVar12 + 1;
               puVar10 = puVar9 + iVar24 * 4;
               uVar23 = *(int*)( tables + (ulong)pbVar12[lVar13] * 4 ) + *(int*)( tables + ( ulong ) * pbVar25 * 4 + 0x800 ) + *(int*)( tables + ( ulong ) * pbVar16 * 4 + 0x400 );
               uVar27 = *(int*)( tables + ( ulong ) * pbVar25 * 4 + 0x800 ) + *(int*)( tables + ( ulong ) * pbVar16 * 4 + 0x400 ) + *(int*)( tables + ( ulong ) * pbVar12 * 4 );
 ...
 while ( 0 < iVar26 );
      ...
      if (iVar26 == 0) {
         ...
         if ((int)uVar11 < 0) {
            ...
            puVar14 = puVar9;
            do {
               uVar23 = *(int*)( tables + (ulong)pbVar12[lVar13 * 2] * 4 ) + *(int*)( tables + (ulong)pbVar25[lVar13] * 4 + 0x800 ) + *(int*)( tables + (ulong)pbVar16[lVar13] * 4 + 0x400 );
               uVar27 = *(int*)( tables + (ulong)pbVar25[lVar13] * 4 + 0x800 ) + *(int*)( tables + (ulong)pbVar16[lVar13] * 4 + 0x400 ) + *(int*)( tables + (ulong)pbVar12[lVar13 * 2 + 1] * 4 );
               uVar22 = uVar23 & 0x40080100;
               if (uVar22 != 0) {
                  uVar23 = uVar22 - ( (int)uVar22 >> 8 ) | uVar23;
                  uVar23 = ( ~(uVar23 >> 9) & 0x400801 ) + uVar23;
 ...
 while ( puVar9 + uVar15 * 8 != puVar10 );
         ...
         if (uVar11 == 0) {
            uVar11 = *(int*)( tables + ( ulong ) * pbVar25 * 4 + 0x800 ) + *(int*)( tables + ( ulong ) * pbVar16 * 4 + 0x400 ) + *(int*)( tables + ( ulong ) * pbVar12 * 4 );
   ...
   puVar9 = *(undefined1**)( this + 0x3a0 );
   LAB_00101134:local_60 = (Object*)0x0;
 ...
 while ( !bVar28 );
   ...
   LAB_00101179:uVar4 = *(undefined4*)( this + 0x3d4 );
   ...
   if (cVar6 != '\0') {
      if (( pOVar7 != (Object*)0x0 ) && ( cVar6 = RefCounted::reference() ),local_60 = pOVar7,cVar6 == '\0') {
         local_60 = (Object*)0x0;
      }
   ...
   if (( local_60 != (Object*)0x0 ) && ( cVar6 = cVar6 != '\0' )) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* VideoStreamPlaybackTheora::set_file(String const&) */void VideoStreamPlaybackTheora::set_file(VideoStreamPlaybackTheora *this, String *param_1) {
   Image *pIVar1;
   long *plVar2;
   ...
   if (this[0x984] != (VideoStreamPlaybackTheora)0x0) {
      if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         _err_print_error("set_file", "modules/theora/video_stream_theora.cpp", 0x7a, "Condition \"playing\" is true.", 0, 0);
         return;
      }
   ...
   pOVar24 = pOVar9;
   if (local_208 == pOVar9) {
      LAB_001020cb:if (( ( pOVar24 != (Object*)0x0 ) && ( cVar13 = RefCounted::unreference() ),pOVar9 = local_208,cVar13 != '\0' )) &&( cVar13 = cVar13 != '\0' )(**(code**)( *(long*)pOVar9 + 0x140 ))(pOVar9);
   ...
   *(undefined2*)( this + 0x3d8 ) = 0;
   LAB_00102179:uVar16 = ogg_sync_buffer(pVVar3, 0x1000);
   uVar16 = ( **(code**)( **(long**)( this + 0x3b0 ) + 0x220 ) )(*(long**)( this + 0x3b0 ), uVar16, 0x1000);
   ogg_sync_wrote(pVVar3, uVar16);
   if ((int)uVar16 != 0) {
      LAB_001021c0:iVar14 = ogg_sync_pageout(pVVar3, pVVar6);
      if (0 < iVar14) {
         iVar14 = ogg_page_bos(pVVar6);
         while (true) {
            if (iVar14 == 0) {
               if (( *(int*)( this + 0x970 ) == 0 ) || ( ogg_stream_pagein(this + 0x5b8, pVVar6),*(int*)( this + 0x728 ) == 0 )) {
               ...
               if (( iVar14 != 0 ) && ( ogg_stream_pagein(this + 0x420, pVVar6),*(int*)( this + 0x590 ) != 0 )) {
                  this[0x3d9] = (VideoStreamPlaybackTheora)0x1;
               }
            ...
            if (( *(int*)( this + 0x970 ) == 0 ) && ( iVar14 = th_decode_headerin(pVVar5, pVVar4, &local_220, (String*)&local_208) ),-1 < iVar14) break;
            if (( *(int*)( this + 0x974 ) != 0 ) || ( iVar14 = vorbis_synthesis_headerin(pVVar7, pVVar8, (String*)&local_208) ),iVar14 < 0) {
...
;
         ...
         *(undefined8*)( this + 0x748 ) = local_48;
         puVar18 = (undefined8*)( (long)local_1d8 - (long)( this + ( 0x5b8 - (long)( ( ulong )(this + 0x5c0) & 0xfffffffffffffff8 ) ) ) );
         puVar21 = (undefined8*)( ( ulong )(this + 0x5c0) & 0xfffffffffffffff8 );
         for (uVar20 = ( ulong )((int)( this + ( 0x5b8 - (long)( ( ulong )(this + 0x5c0) & 0xfffffffffffffff8 ) ) ) + 0x198U >> 3); uVar20 != 0; uVar20 = uVar20 - 1) {
            *puVar21 = *puVar18;
      ...
      if (( iVar14 == 0 ) || ( 2 < iVar14 )) {
         if (( *(int*)( this + 0x974 ) == 0 ) || ( 2 < *(int*)( this + 0x974 ) )) {
            if (iVar14 == 0) {
               ...
               if (lVar22 < 0) {
                  ...
                  if (lVar10 == 0) {
                     if (lVar22 != 0) {
                        ...
                        LAB_00102c46:uVar20 = lVar22 - 1U >> 1 | lVar22 - 1U;
                        uVar20 = uVar20 | uVar20 >> 2;
                        uVar20 = uVar20 >> 4 | uVar20;
                        uVar20 = uVar20 | uVar20 >> 8;
                        puVar18 = (undefined8*)Memory::alloc_static(( uVar20 >> 0x10 | uVar20 ) + 0x11, false);
                     ...
                     if (lVar22 != lVar11) {
                        if (lVar22 == 0) {
                           ...
                           *plVar2 = *plVar2 + -1;
                           ...
                           if (lVar11 < lVar22) {
                              if (( uVar17 == uVar20 ) || ( iVar14 = CowData<unsigned_char>::_realloc(this_00, uVar20 + 1) ),pCVar23 = this_00,iVar14 == 0) {
 ...
 else if (( uVar17 == uVar20 ) || ( iVar14 = CowData<unsigned_char>::_realloc(this_00, uVar20 + 1) ),pCVar23 = this_00,iVar14 == 0) {
                              if (*(long*)( this + 0x3a0 ) == 0) {
                                 set_file((String*)pCVar23);
                                 return;
                              }
               ...
               *(double*)( this + 0x968 ) = (double)*(uint*)( this + 0x770 ) / (double)*(uint*)( this + 0x76c );
               if (( local_210 != (Image*)0x0 ) && ( cVar13 = cVar13 != '\0' )) {
         ...
         LAB_00102517:iVar14 = ogg_stream_packetout(this + 0x420, (String*)&local_208);
         if (*(int*)( this + 0x974 ) < 3 && *(int*)( this + 0x974 ) != 0) {
            while (iVar14 != 0) {
               if (( iVar14 < 0 ) || ( iVar14 = vorbis_synthesis_headerin(pVVar7, pVVar8, (String*)&local_208) ),iVar14 != 0) {
               ...
               *(int*)( this + 0x974 ) = iVar14 + 1;
               if (( iVar14 + 1 == 3 ) || ( iVar14 = ogg_stream_packetout(this + 0x420, (String*)&local_208) * (int*)( this + 0x974 ) == 0 || 2 < *(int*)( this + 0x974 ) )) break;
            }
;
         }
         ...
         if (( *(int*)( this + 0x970 ) < 3 ) && ( *(int*)( this + 0x970 ) != 0 )) {
            while (iVar14 != 0) {
               if (( iVar14 < 0 ) || ( iVar14 = th_decode_headerin(pVVar5, pVVar4, &local_220, (String*)&local_208) ),iVar14 == 0) {
...
;
      ...
      if (0 < iVar14) {
         ...
         if (( *(int*)( this + 0x974 ) != 0 ) && ( ogg_stream_pagein(this + 0x420, pVVar6),*(int*)( this + 0x590 ) != 0 )) {
            this[0x3d9] = (VideoStreamPlaybackTheora)0x1;
         }
...
else{*(Object**)( this + 0x3b0 ) = local_208;if (local_208 != (Object*)0x0) {
...
if (pOVar9 != (Object*)0x0) {
   LAB_001020b6:cVar13 = RefCounted::unreference();
   pOVar24 = local_208;
   if (( cVar13 != '\0' ) && ( cVar13 = predelete_handler(pOVar9) ),pOVar24 = local_208,cVar13 != '\0') {
...
LAB_001025d9:local_210 = (Image*)0x0;local_208 = (Object*)&_LC22;local_200 = 2;String::parse_latin1((StrRange*)&local_210);operator+((char *)&local_218,(String *)"Cannot open file \'");String::operator +((String*)&local_208, (String*)&local_218);_err_print_error("set_file", "modules/theora/video_stream_theora.cpp", 0x80, "Condition \"file.is_null()\" is true.", (String*)&local_208, 0, 0);pOVar9 = local_208;if (local_208 != (Object*)0x0) {
   LOCK();
...
lVar22 = local_218;if (local_218 != 0) {
   LOCK();
...
pIVar12 = local_210;if (local_210 != (Image*)0x0) {
   LOCK();
...
}LAB_0010237f:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return;
}
LAB_00102c0f:/* WARNING: Subroutine does not return */__stack_chk_fail();LAB_00102430:*(undefined8*)( this + 0x420 ) = local_1d8[0];lVar22 = (long)( this + 0x420 ) - (long)( ( ulong )(this + 0x428) & 0xfffffffffffffff8 );*(undefined8*)( this + 0x5b0 ) = local_48;puVar18 = (undefined8*)( (long)local_1d8 - lVar22 );puVar21 = (undefined8*)( ( ulong )(this + 0x428) & 0xfffffffffffffff8 );for (uVar20 = ( ulong )((int)lVar22 + 0x198U >> 3); uVar20 != 0; uVar20 = uVar20 - 1) {
   *puVar21 = *puVar18;
   puVar18 = puVar18 + (ulong)bVar25 * -2 + 1;
   puVar21 = puVar21 + (ulong)bVar25 * -2 + 1;
}
*(undefined4*)( this + 0x974 ) = 1;goto LAB_001021c0;}/* VideoStreamPlaybackTheora::stop() */void VideoStreamPlaybackTheora::stop(VideoStreamPlaybackTheora *this) {
   if (this[0x984] != (VideoStreamPlaybackTheora)0x0) {
      clear(this);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* VideoStreamPlaybackTheora::play() */void VideoStreamPlaybackTheora::play(VideoStreamPlaybackTheora *this) {
   long in_FS_OFFSET;
   double dVar1;
   long local_50;
   int local_48[6];
   ...
   *(undefined8*)( this + 0x990 ) = 0;
   LAB_00102d83:this[0x984] = (VideoStreamPlaybackTheora)0x1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* VideoStreamPlaybackTheora::update(double) [clone .part.0] */void VideoStreamPlaybackTheora::update(VideoStreamPlaybackTheora *this, double param_1) {
 ...
 while ( puVar16 + -0x1000 != local_4030 );
   ...
   *(double*)( puVar16 + -0x1070 ) = ( dVar20 + param_1 ) - *(double*)( this + 0x9a8 );
   LAB_00102eb2:if (VVar18 == (VideoStreamPlaybackTheora)0x0) goto LAB_0010300d;
   LAB_00102ebb:if (this[0x988] == (VideoStreamPlaybackTheora)0x0) goto code_r0x00102ec8;
   LAB_00103362:dVar20 = *(double*)( puVar16 + -0x1070 );
   LAB_00103368:if (*(double*)( this + 0x9a0 ) <= dVar20) {
   ...
   goto LAB_00103339;
   LAB_00103268:lVar15 = lVar15 + 4;
   if ((long)iVar11 * 4 == lVar15) goto LAB_001030e3;
   goto LAB_0010309d;
   LAB_001032dd:VVar18 = VVar8;
   VVar8 = this[0x989];
   goto LAB_00102ed7;
   code_r0x00102ec8:VVar8 = this[0x989];
   if (VVar8 == (VideoStreamPlaybackTheora)0x0) {
      LAB_00102ed7:do {
         if (VVar8 != (VideoStreamPlaybackTheora)0x0) {
            VVar8 = this[0x988];
            LAB_00102f8f:if (VVar18 == (VideoStreamPlaybackTheora)0x0) goto LAB_00103135;
            if (VVar8 == (VideoStreamPlaybackTheora)0x0) goto LAB_00103135;
            LAB_00102fa0:VVar18 = (VideoStreamPlaybackTheora)0x1;
            do {
               if (*(double*)( this + 0x998 ) - *(double*)( puVar16 + -0x1070 ) <= ( _LC36 * (double)*(uint*)( this + 0x770 ) ) / (double)*(uint*)( this + 0x76c )) {
                  if (*(double*)( this + 0x998 ) - *(double*)( puVar16 + -0x1070 ) < ( (double)*(uint*)( this + 0x770 ) * __LC37 ) / (double)*(uint*)( this + 0x76c )) {
                     ...
                     *(int*)( puVar16 + -0x105c ) = iVar9;
                     do {
                        ...
                        if (0 < iVar11) {
                           ...
                           lVar15 = 0;
                           LAB_0010309d:if (iVar12 < 1) goto LAB_00103268;
                           iVar17 = 0;
                           do {
                              lVar13 = 0;
                              do {
                                 *(undefined4*)( puVar16 + -0x1018 + lVar13 * 4 + (long)iVar17 * 4 ) = *(undefined4*)( *(long*)( lVar4 + lVar13 * 8 ) + lVar15 );
                                 lVar13 = lVar13 + 1;
                              }
 while ( iVar12 != lVar13 );
                              lVar15 = lVar15 + 4;
 ...
 while ( lVar15 != (long)iVar11 * 4 );
                        ...
                        LAB_001030e3:uVar14 = *(undefined8*)( this + 0x248 );
...
;
               ...
               LAB_00103135:pVVar1 = this + 0x3e0;
         ...
         *(undefined8*)( puVar16 + -0x1080 ) = 0x102f4a;
         ...
         if (uVar10 < 2) {
            ...
            *(double*)( this + 0x998 ) = dVar19;
            ...
            LAB_00102f8a:VVar8 = (VideoStreamPlaybackTheora)0x1;
            goto LAB_00102f8f;
         }

         LAB_00102ede:if (this[0x988] != (VideoStreamPlaybackTheora)0x0) goto LAB_00102f8a;
         VVar8 = this[0x989];
      }
 while ( true );
   }

   LAB_00103330:if (( this[0x989] != (VideoStreamPlaybackTheora)0x0 ) && ( this[0x98a] != (VideoStreamPlaybackTheora)0x0 )) {
      if (*(code**)( *(long*)this + 0x1c8 ) != stop) {
   ...
   LAB_00103339:if (*(long*)( puVar16 + 0x2ff0 ) == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }

   LAB_00103420:/* WARNING: Subroutine does not return */*(undefined**)( puVar16 + -0x1080 ) = &UNK_00103425;
   __stack_chk_fail();
}
/* VideoStreamPlaybackTheora::update(double) */void VideoStreamPlaybackTheora::update(VideoStreamPlaybackTheora *this, double param_1) {
   if (( ( *(long*)( this + 0x3b0 ) != 0 ) && ( this[0x984] != (VideoStreamPlaybackTheora)0x0 ) ) && ( this[0x986] == (VideoStreamPlaybackTheora)0x0 )) {
      update(this, param_1);
      return;
   }
...
/* RefCounted::is_class_ptr(void*) const */uint RefCounted::is_class_ptr(RefCounted *this, void *param_1) {
   return (uint)CONCAT71(0x1090, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1090, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr);
}
...
/* ResourceFormatLoader::is_class_ptr(void*) const */uint ResourceFormatLoader::is_class_ptr(ResourceFormatLoader *this, void *param_1) {
   return (uint)CONCAT71(0x1090, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1090, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1090, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
...
/* VideoStreamPlaybackTheora::is_class_ptr(void*) const */uint VideoStreamPlaybackTheora::is_class_ptr(VideoStreamPlaybackTheora *this, void *param_1) {
   return (uint)CONCAT71(0x1090, (undefined4*)param_1 == &VideoStreamPlayback::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x108f, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1090, (undefined4*)param_1 == &Resource::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1090, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1090, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* VideoStreamPlaybackTheora::_getv(StringName const&, Variant&) const */undefined8 VideoStreamPlaybackTheora::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* VideoStreamPlaybackTheora::_setv(StringName const&, Variant const&) */undefined8 VideoStreamPlaybackTheora::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* VideoStreamPlaybackTheora::_validate_propertyv(PropertyInfo&) const */void VideoStreamPlaybackTheora::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* VideoStreamPlaybackTheora::_property_can_revertv(StringName const&) const */undefined8 VideoStreamPlaybackTheora::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* VideoStreamPlaybackTheora::_property_get_revertv(StringName const&, Variant&) const */undefined8 VideoStreamPlaybackTheora::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* VideoStreamPlaybackTheora::_notificationv(int, bool) */void VideoStreamPlaybackTheora::_notificationv(int param_1, bool param_2) {
   return;
}
/* VideoStreamTheora::is_class_ptr(void*) const */uint VideoStreamTheora::is_class_ptr(VideoStreamTheora *this, void *param_1) {
   return (uint)CONCAT71(0x1090, (undefined4*)param_1 == &VideoStream::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x108f, (undefined4*)param_1 == &get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1090, (undefined4*)param_1 == &Resource::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1090, (undefined4*)param_1 == &RefCounted::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1090, (undefined4*)param_1 == &Object::get_class_ptr_static(), ::ptr);
}
/* VideoStreamTheora::_getv(StringName const&, Variant&) const */undefined8 VideoStreamTheora::_getv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* VideoStreamTheora::_setv(StringName const&, Variant const&) */undefined8 VideoStreamTheora::_setv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* VideoStreamTheora::_validate_propertyv(PropertyInfo&) const */void VideoStreamTheora::_validate_propertyv(PropertyInfo *param_1) {
   return;
}
/* VideoStreamTheora::_property_can_revertv(StringName const&) const */undefined8 VideoStreamTheora::_property_can_revertv(StringName *param_1) {
   return 0;
}
/* VideoStreamTheora::_property_get_revertv(StringName const&, Variant&) const */undefined8 VideoStreamTheora::_property_get_revertv(StringName *param_1, Variant *param_2) {
   return 0;
}
/* VideoStreamTheora::_notificationv(int, bool) */void VideoStreamTheora::_notificationv(int param_1, bool param_2) {
   return;
}
/* VideoStreamTheora::set_audio_track(int) */void VideoStreamTheora::set_audio_track(VideoStreamTheora *this, int param_1) {
   *(int*)( this + 0x260 ) = param_1;
   return;
}
/* VideoStreamTheora::~VideoStreamTheora() */void VideoStreamTheora::~VideoStreamTheora(VideoStreamTheora *this) {
   *(undefined***)this = &PTR__initialize_classv_00107dd8;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* VideoStreamPlaybackTheora::set_file(String const&) [clone .cold] */void VideoStreamPlaybackTheora::set_file(String *param_1) {
   code *pcVar1;
   _DAT_00000000 = 0;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
...
/* RefCounted::_get_class_namev() const */undefined8 *RefCounted::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00103b73:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00103b73;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "RefCounted");
   LAB_00103bde:return &_get_class_namev();
}
/* ResourceFormatLoader::_get_class_namev() const */undefined8 *ResourceFormatLoader::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00103c63:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00103c63;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "ResourceFormatLoader");
   LAB_00103cce:return &_get_class_namev();
}
/* VideoStreamTheora::_get_class_namev() const */undefined8 *VideoStreamTheora::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00103d53:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00103d53;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "VideoStreamTheora");
         goto LAB_00103dbe;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "VideoStreamTheora");
   LAB_00103dbe:return &_get_class_namev();
}
/* VideoStreamPlaybackTheora::_get_class_namev() const */undefined8 *VideoStreamPlaybackTheora::_get_class_namev(void) {
   int iVar1;
   if (( _get_class_namev() ) && ( iVar1 = __cxa_guard_acquire(&_get_class_namev(), ::_class_name_static) ),iVar1 != 0) {
      _get_class_namev()
      __cxa_atexit(StringName::~StringName, &_get_class_namev(), ::_class_name_static, &__dso_handle);
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      ...
      if (*(long*)( _get_class_namev() ) != 0) {
         ...
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "VideoStreamPlaybackTheora");
         goto LAB_00103eae;
      }
...
/* VideoStream::get_save_class() const */VideoStream * __thiscall VideoStream::get_save_class(VideoStream *this){
   long lVar1;
   long in_FS_OFFSET;
   lVar1 = *(long*)( in_FS_OFFSET + 0x28 );
   *(undefined8*)this = 0;
...
/* VideoStreamPlaybackTheora::get_class() const */void VideoStreamPlaybackTheora::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* VideoStreamTheora::get_class() const */void VideoStreamTheora::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* RefCounted::is_class(String const&) const */undefined8 RefCounted::is_class(RefCounted *this, String *param_1) {
 ...
 while ( !bVar9 );
      ...
      LAB_0010443f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
 ...
 while ( !bVar9 );
         ...
         LAB_001045a3:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
      ...
      LAB_001044f3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return 1;
      }
...
/* ResourceFormatLoader::is_class(String const&) const */undefined8 ResourceFormatLoader::is_class(ResourceFormatLoader *this, String *param_1) {
 ...
 while ( !bVar8 );
      ...
      LAB_001046cf:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
...
/* VideoStreamPlaybackTheora::_initialize_classv() */void VideoStreamPlaybackTheora::_initialize_classv(void) {
   long *plVar1;
   long lVar2;
   long in_FS_OFFSET;
   long local_60;
   ...
   local_30 = *(long*)( in_FS_OFFSET + 0x28 );
   if (initialize_class() == '\0') {
      if (VideoStreamPlayback::initialize_class() == '\0') {
         ...
         VideoStreamPlayback::initialize_class()::initialized =
         '\x01';
      }
...
/* VideoStreamTheora::_initialize_classv() */void VideoStreamTheora::_initialize_classv(void) {
   long *plVar1;
   long lVar2;
   long in_FS_OFFSET;
   long local_60;
   ...
   local_30 = *(long*)( in_FS_OFFSET + 0x28 );
   if (initialize_class() == '\0') {
      if (VideoStream::initialize_class() == '\0') {
         if (Resource::initialize_class() == '\0') {
            Resource::initialize_class();
         }
         ...
         VideoStream::initialize_class()::initialized =
         '\x01';
      }
...
/* ResourceFormatLoader::_initialize_classv() */void ResourceFormatLoader::_initialize_classv(void) {
   ...
   long local_40;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (initialize_class() != '\0') goto LAB_001058fb;
   if (RefCounted::initialize_class() == '\0') {
      Object::initialize_class();
      local_68 = 0;
      local_50 = 6;
      ...
      lVar2 = local_68;
      if (local_68 == 0) {
         LAB_00105a0a:if ((code*)PTR__bind_methods_0010c008 != RefCounted::_bind_methods) {
            LAB_00105a1a:RefCounted::_bind_methods();
         }
   ...
   initialize_class()::initialized =
   '\x01';
   LAB_001058fb:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* Resource::is_class(String const&) const */undefined8 Resource::is_class(Resource *this, String *param_1) {
 ...
 while ( !bVar8 );
      ...
      LAB_00105aff:cVar5 = String::operator ==(param_1, (String*)&local_60);
      lVar3 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
...
/* VideoStreamTheora::is_class(String const&) const */undefined8 VideoStreamTheora::is_class(VideoStreamTheora *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long lVar4;
 ...
 while ( !bVar9 );
      ...
      LAB_00105c7f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
 ...
 while ( !bVar9 );
         ...
         LAB_00105df3:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
   ...
   LAB_00105d33:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_00105e9c:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* VideoStreamPlaybackTheora::is_class(String const&) const */undefined8 VideoStreamPlaybackTheora::is_class(VideoStreamPlaybackTheora *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long lVar4;
 ...
 while ( !bVar9 );
      ...
      LAB_00105f1f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
 ...
 while ( !bVar9 );
         ...
         LAB_00106093:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
   ...
   LAB_00105fd3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0010613c:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* ResourceFormatLoader::~ResourceFormatLoader() */void ResourceFormatLoader::~ResourceFormatLoader(ResourceFormatLoader *this) {
   ...
   *(code**)this = ogg_sync_wrote;
   ...
   LAB_00106723:*(undefined***)this = &PTR__initialize_classv_00107c78;
   Object::~Object((Object*)this);
   return;
}
/* ResourceFormatLoaderTheora::~ResourceFormatLoaderTheora() */void ResourceFormatLoaderTheora::~ResourceFormatLoaderTheora(ResourceFormatLoaderTheora *this) {
...
/* VideoStreamPlayback::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void VideoStreamPlayback::_get_property_listv(VideoStreamPlayback *this, List *param_1, bool param_2) {
   long *plVar1;
   long lVar2;
   long lVar3;
   undefined1(*pauVar4)[16];
...
/* VideoStreamPlaybackTheora::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const
    */void VideoStreamPlaybackTheora::_get_property_listv(VideoStreamPlaybackTheora *this, List *param_1, bool param_2) {
   long *plVar1;
   long lVar2;
   long lVar3;
   undefined1(*pauVar4)[16];
...
/* VideoStream::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void VideoStream::_get_property_listv(VideoStream *this, List *param_1, bool param_2) {
   long *plVar1;
   long lVar2;
   long lVar3;
   undefined1(*pauVar4)[16];
...
/* VideoStreamTheora::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void VideoStreamTheora::_get_property_listv(VideoStreamTheora *this, List *param_1, bool param_2) {
   long *plVar1;
   long lVar2;
   long lVar3;
   undefined1(*pauVar4)[16];
...
/* VideoStreamTheora::instantiate_playback() */void VideoStreamTheora::instantiate_playback(void) {
   code *pcVar1;
   char cVar2;
   VideoStreamPlaybackTheora *this;
   long lVar3;
...
/* WARNING: Control flow encountered bad instruction data *//* ResourceFormatLoaderTheora::~ResourceFormatLoaderTheora() */void ResourceFormatLoaderTheora::~ResourceFormatLoaderTheora(ResourceFormatLoaderTheora *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* VideoStreamTheora::~VideoStreamTheora() */void VideoStreamTheora::~VideoStreamTheora(VideoStreamTheora *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

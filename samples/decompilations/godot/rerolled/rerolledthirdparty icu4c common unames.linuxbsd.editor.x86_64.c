/* icu_76_godot::isAcceptable(void*, char const*, char const*, UDataInfo const*) */bool icu_76_godot::isAcceptable(void *param_1, char *param_2, char *param_3, UDataInfo *param_4) {
   if (( ( ( 0x13 < *(ushort*)param_4 ) && ( *(short*)( param_4 + 4 ) == 0 ) ) && ( *(short*)( param_4 + 8 ) == 0x6e75 ) ) && ( *(short*)( param_4 + 10 ) == 0x6d61 )) {
...
/* icu_76_godot::expandName(icu_76_godot::UCharNames*, unsigned char const*, unsigned short,
   UCharNameChoice, char*, unsigned short) */int icu_76_godot::expandName(uint *param_1, ushort *param_2, short param_3, uint param_4, byte *param_5, short param_6) {
   ushort *puVar1;
   ushort uVar2;
   uint uVar3;
   ushort uVar4;
      ...
      LAB_0010008d:if (param_3 != 0) {
         ...
         do {
            ...
            if (bVar7 < uVar2) {
               ...
               sVar6 = param_3 + -1;
               if (uVar4 == 0xfffe) {
                  uVar4 = *(ushort*)( (long)param_1 + ( ulong )(ushort)(*param_2 << 8 | *param_2 >> 8) * 2 + 0x12 );
                  puVar1 = param_2 + 1;
                  sVar6 = param_3 + -2;
               }
               ...
               if (uVar4 == 0xffff) {
                  ...
                  if (( ( (short)iVar9 != 0 ) || ( param_4 != 2 ) ) || ( ( 0x3b < uVar2 && ( (short)param_1[0x22] != -1 ) ) )) break;
                  iVar9 = 0;
               }
 else {
 ...
 while ( 0 < (int)uVar8 );
   ...
   iVar9 = 0;
   LAB_00100134:if (param_6 != 0) {
      *param_5 = 0;
   }

   return iVar9;
}
/* icu_76_godot::getGroup(icu_76_godot::UCharNames*, unsigned int) */UCharNames *icu_76_godot::getGroup(UCharNames *param_1, uint param_2) {
   uint uVar1;
   UCharNames *pUVar2;
   uint uVar3;
   uint uVar4;
...
/* icu_76_godot::expandGroupLengths(unsigned char const*, unsigned short*, unsigned short*) */byte *icu_76_godot::expandGroupLengths(uchar *param_1, ushort *param_2, ushort *param_3) {
   byte bVar1;
   ushort *puVar2;
   ushort *puVar3;
   ushort uVar4;
   ...
   do {
      ...
      if ((ushort)uVar5 < 0xc) {
         ...
         *param_3 = (ushort)iVar7;
         ...
         LAB_00100264:iVar10 = iVar10 + uVar5;
         *param_2 = uVar9;
...
/* icu_76_godot::getName(icu_76_godot::UCharNames*, unsigned int, UCharNameChoice, char*, unsigned
   short) */undefined8 icu_76_godot::getName(UCharNames *param_1, uint param_2, undefined4 param_3, undefined1 *param_4, short param_5) {
   short *psVar1;
   long lVar2;
   undefined8 uVar3;
   long in_FS_OFFSET;
   ...
   if (*psVar1 == (short)( param_2 >> 5 )) {
      lVar2 = expandGroupLengths((uchar*)( param_1 + (long)CONCAT22(psVar1[1], psVar1[2]) + ( ulong ) * (uint*)( param_1 + 8 ) ), auStack_c8, local_78);
      if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         uVar3 = expandName(param_1, lVar2 + (ulong)auStack_c8[param_2 & 0x1f], local_78[param_2 & 0x1f], param_3, param_4, param_5);
         return uVar3;
      }
...
/* icu_76_godot::writeFactorSuffix(unsigned short const*, unsigned short, char const*, unsigned int,
   unsigned short*, char const**, char const**, char*, unsigned short) */int icu_76_godot::writeFactorSuffix(ushort *param_1, ushort param_2, char *param_3, uint param_4, ushort *param_5, char **param_6, char **param_7, char *param_8, ushort param_9) {
   ushort *puVar1;
   char cVar2;
   ushort uVar3;
   short sVar4;
   ...
   if (( ushort )(param_2 - 1) == 0) {
      ...
      do {
         ...
         *(short*)( (long)param_5 + lVar10 ) = (short)( uVar5 % ( ulong ) * (ushort*)( (long)param_1 + lVar10 ) );
...
/* icu_76_godot::getAlgName(icu_76_godot::AlgorithmicRange*, unsigned int, UCharNameChoice, char*,
   unsigned short) */int icu_76_godot::getAlgName(int *param_1, uint param_2, uint param_3, char *param_4, ushort param_5) {
   ushort *puVar1;
   byte bVar2;
   byte bVar3;
   int iVar4;
 ...
 while ( cVar10 != '\0' );
         ...
         iVar4 = writeFactorSuffix(puVar1, (ushort)bVar2, pcVar5, param_2 - *param_1, local_28, (char**)0x0, (char**)0x0, param_4, param_5);
         iVar4 = iVar4 + iVar7;
         goto LAB_001005f8;
      }
   ...
   iVar4 = 0;
   LAB_001005f8:if (local_10 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* icu_76_godot::enumAlgNames(icu_76_godot::AlgorithmicRange*, int, int, signed char (*)(void*, int,
   UCharNameChoice, char const*, int), void*, UCharNameChoice) */undefined8 icu_76_godot::enumAlgNames(int *param_1, ulong param_2, int param_3, code *param_4, undefined8 param_5, uint param_6) {
   ushort *puVar1;
   byte bVar2;
   char cVar3;
   short sVar4;
...
;
                  pcVar17[-1] = cVar3 + '\x01';
                  LAB_00100819:cVar3 = ( *param_4 )(param_5, uVar10, param_6, local_108, sVar4);
               }
 while ( cVar3 != '\0' );
            }
 ...
 while ( cVar3 != '\0' );
         ...
         iVar6 = writeFactorSuffix(puVar1, (ushort)bVar2, pcVar13, (int)param_2 - *param_1, local_198, local_188, local_148, pcVar17, uVar5);
 ...
 while ( cVar3 != '\0' );
         ...
         LAB_00100832:uVar7 = 0;
         goto LAB_00100733;
      }

   }

   LAB_0010072e:uVar7 = 1;
...
/* icu_76_godot::loadCharNames(UErrorCode&) */void icu_76_godot::loadCharNames(UErrorCode *param_1) {
...
/* icu_76_godot::unames_cleanup() */undefined8 icu_76_godot::unames_cleanup(void) {
   if (uCharNamesData != 0) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* makeTokenMap(UDataSwapper const*, short*, unsigned short, unsigned char*, UErrorCode*) */void makeTokenMap(UDataSwapper *param_1, short *param_2, ushort param_3, uchar *param_4, UErrorCode *param_5) {
   char cVar1;
   short sVar2;
   short sVar3;
   short sVar4;
   ...
   if (*(int*)param_5 < 1) {
      if (param_1[1] == param_1[3]) {
         ...
         do {
            ...
            *puVar25 = ( 0 < (short)uVar32 ) * ( (short)uVar32 < 0x100 ) * (char)uVar32 - ( 0xff < (short)uVar32 );
            puVar25[1] = ( 0 < (short)uVar33 ) * ( (short)uVar33 < 0x100 ) * (char)uVar33 - ( 0xff < (short)uVar33 );
            puVar25[2] = ( 0 < (short)uVar34 ) * ( (short)uVar34 < 0x100 ) * (char)uVar34 - ( 0xff < (short)uVar34 );
            puVar25[3] = ( 0 < (short)uVar35 ) * ( (short)uVar35 < 0x100 ) * (char)uVar35 - ( 0xff < (short)uVar35 );
            puVar25[4] = ( 0 < (short)uVar36 ) * ( (short)uVar36 < 0x100 ) * (char)uVar36 - ( 0xff < (short)uVar36 );
            puVar25[5] = ( 0 < (short)uVar37 ) * ( (short)uVar37 < 0x100 ) * (char)uVar37 - ( 0xff < (short)uVar37 );
            puVar25[6] = ( 0 < (short)uVar38 ) * ( (short)uVar38 < 0x100 ) * (char)uVar38 - ( 0xff < (short)uVar38 );
            puVar25[7] = ( 0 < (short)uVar39 ) * ( (short)uVar39 < 0x100 ) * (char)uVar39 - ( 0xff < (short)uVar39 );
            puVar25[8] = ( 0 < (short)uVar40 ) * ( (short)uVar40 < 0x100 ) * (char)uVar40 - ( 0xff < (short)uVar40 );
            puVar25[9] = ( 0 < (short)uVar41 ) * ( (short)uVar41 < 0x100 ) * (char)uVar41 - ( 0xff < (short)uVar41 );
            puVar25[10] = ( 0 < (short)uVar42 ) * ( (short)uVar42 < 0x100 ) * (char)uVar42 - ( 0xff < (short)uVar42 );
            puVar25[0xb] = ( 0 < (short)uVar43 ) * ( (short)uVar43 < 0x100 ) * (char)uVar43 - ( 0xff < (short)uVar43 );
            puVar25[0xc] = ( 0 < (short)uVar44 ) * ( (short)uVar44 < 0x100 ) * (char)uVar44 - ( 0xff < (short)uVar44 );
            puVar25[0xd] = ( 0 < (short)uVar45 ) * ( (short)uVar45 < 0x100 ) * (char)uVar45 - ( 0xff < (short)uVar45 );
            puVar25[0xe] = ( 0 < (short)uVar46 ) * ( (short)uVar46 < 0x100 ) * (char)uVar46 - ( 0xff < (short)uVar46 );
            puVar25[0xf] = ( 0 < (short)uVar47 ) * ( (short)uVar47 < 0x100 ) * (char)uVar47 - ( 0xff < (short)uVar47 );
            puVar25 = puVar26;
            uVar48 = uVar48 + sVar2;
            uVar49 = uVar49 + sVar3;
            uVar50 = uVar50 + sVar4;
 ...
 while ( param_4 + 0x100 != puVar26 );
         ...
         for (uVar27 = ( ulong )(( (int)param_4 - (int)(undefined8*)( ( ulong )(param_4 + 8) & 0xfffffffffffffff8 ) ) + 0x100U >> 3); uVar27 != 0; uVar27 = uVar27 - 1) {
            *puVar29 = 0;
            puVar29 = puVar29 + 1;
         }
         ...
         if (1 < param_3) {
            ...
            do {
               while (param_2[uVar27] == -1) {
                  ...
                  if (0 < *(int*)param_5) {
                     udata_printError_76_godot(param_1, "unames/makeTokenMap() finds variant character 0x%02x used (input charset family %d)\n", uVar27 & 0xffff, param_1[1]);
                     goto LAB_00100be1;
                  }
...
;
 ...
 while ( (ushort)lVar28 < uVar31 );
   ...
   LAB_00100be1:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* icu_76_godot::getExtName(unsigned int, char*, unsigned short) */int icu_76_godot::getExtName(uint param_1, char *param_2, ushort param_3) {
   byte bVar1;
   uint uVar2;
   int iVar3;
   uint uVar4;
   ...
   if ((int)param_1 < 0xfdd0) {
      ...
      if (bVar1 == 0x12) {
         ...
         LAB_00100ecc:if (param_3 == 0) goto LAB_00100f00;
         LAB_00100ed2:*param_2 = '<';
         cVar6 = *pcVar9;
         param_2 = param_2 + 1;
         param_3 = param_3 - 1;
         iVar5 = 2;
      ...
      LAB_00100f00:cVar6 = *pcVar9;
      param_3 = 0;
      if (cVar6 != '\0') goto LAB_00100dbe;
      iVar5 = 2;
      iVar7 = 3;
      joined_r0x00100f23:sVar8 = 0;
      iVar3 = 4;
      if (param_1 == 0) goto LAB_00100e71;
      LAB_00100e0a:iVar7 = 0;
      uVar2 = param_1;
      do {
         iVar7 = iVar7 + 1;
         uVar2 = (int)uVar2 >> 4;
 ...
 while ( sVar8 != 0 );
   ...
   LAB_00100e71:return iVar3 + iVar7;
}
/* icu_76_godot::enumGroupNames(icu_76_godot::UCharNames*, unsigned short const*, int, int, signed
   char (*)(void*, int, UCharNameChoice, char const*, int), void*, UCharNameChoice) */undefined8 icu_76_godot::enumGroupNames(uint *param_1, long param_2, uint param_3, int param_4, code *param_5, undefined8 *param_6, uint param_7) {
   byte bVar1;
   byte bVar2;
   ushort uVar3;
   byte *pbVar4;
   ...
   long local_40;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   lVar9 = expandGroupLengths((uchar*)( (long)CONCAT22(*(undefined2*)( param_2 + 2 ), *(undefined2*)( param_2 + 4 )) + (ulong)param_1[2] + (long)param_1 ), local_1a8, local_158);
   if (param_5 == (code*)0x0) {
      pbVar4 = (byte*)*param_6;
               ...
               joined_r0x0010117e:do {
                  ...
                  if ((uint)bVar2 < (uint)uVar6) {
                     ...
                     if (uVar3 == 0xfffe) {
                        uVar15 = uVar16 - 2;
                        puVar14 = puVar13 + 1;
                        uVar3 = *(ushort*)( (long)param_1 + ( ulong )(ushort)(*puVar13 << 8 | *puVar13 >> 8) * 2 + 0x12 );
                     }
...
;
                     ...
                     if (bVar2 == 0x3b) {
                        if (( ( pbVar4 != pbVar12 ) || ( param_7 != 2 ) ) || ( ( 0x3b < uVar6 && ( (short)param_1[0x22] != -1 ) ) )) goto LAB_0010114d;
                        goto joined_r0x0010117e;
                     }
 ...
 while ( 0 < (int)uVar8 );
            ...
            LAB_00101156:param_3 = param_3 + 1;
         }
 while ( (int)param_3 <= param_4 );
      ...
      do {
         uVar6 = expandName(param_1, (ulong)local_1a8[param_3 & 0x1f] + lVar9, local_158[param_3 & 0x1f], param_7, local_108, 200);
         if (uVar6 == 0) {
            if (param_7 == 2) {
            ...
            LAB_0010109b:cVar5 = ( *param_5 )(param_6, param_3, param_7, local_108, uVar6);
            if (cVar5 == '\0') {
               uVar10 = 0;
               goto LAB_001010c5;
            }
 ...
 while ( (int)param_3 <= param_4 );
   ...
   uVar10 = 1;
   LAB_001010c5:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* icu_76_godot::enumExtNames(int, int, signed char (*)(void*, int, UCharNameChoice, char const*,
   int), void*) */char icu_76_godot::enumExtNames(int param_1, int param_2, _func_signed_void_ptr_int_UCharNameChoice_char_ptr_int *param_3, void *param_4) {
   char cVar1;
   ushort uVar2;
   long in_FS_OFFSET;
   char acStack_f8[200];
   long local_30;
   local_30 = *(long*)( in_FS_OFFSET + 0x28 );
   if (( param_3 != (_func_signed_void_ptr_int_UCharNameChoice_char_ptr_int*)0x0 ) && ( param_1 <= param_2 )) {
      do {
 ...
 while ( param_1 <= param_2 );
   ...
   cVar1 = '\x01';
   LAB_00101363:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* icu_76_godot::enumNames(icu_76_godot::UCharNames*, int, int, signed char (*)(void*, int,
   UCharNameChoice, char const*, int), void*, UCharNameChoice) */undefined8 icu_76_godot::enumNames(UCharNames *param_1, uint param_2, uint param_3, _func_signed_void_ptr_int_UCharNameChoice_char_ptr_int *param_4, void *param_5, int param_6) {
   char cVar1;
   ushort uVar2;
   uint uVar3;
   uint uVar4;
   ...
   if (uVar10 < uVar2) {
      ...
      pUVar15 = param_1 + *(uint*)( param_1 + 4 ) + (long)(int)( ( uint ) * (ushort*)( param_1 + *(uint*)( param_1 + 4 ) ) * 3 + 1 ) * 2;
      LAB_0010141b:uVar9 = (uint)uVar7;
      pUVar13 = pUVar6;
      pUVar14 = pUVar6;
      if (pUVar6 < pUVar15) {
         LAB_00101428:while (true) {
            uVar9 = (uint)uVar7;
...
;
      ...
      if (uVar10 == local_48) {
         if (uVar2 == uVar10) {
            LAB_0010166c:uVar8 = enumGroupNames(param_1, pUVar6, uVar12 & 0xffffffff, uVar3, param_4, param_5, param_6);
            return uVar8;
         }
      ...
      LAB_001014cf:pUVar15 = param_1 + *(uint*)( param_1 + 4 ) + (long)(int)( ( uint ) * (ushort*)( param_1 + *(uint*)( param_1 + 4 ) ) * 3 + 1 ) * 2;
      uVar9 = (uint)uVar7;
      if (uVar10 == uVar2) {
         if (( uVar7 & 0x1f ) != 0) {
            cVar1 = enumGroupNames(param_1, pUVar6, uVar7, ( uVar5 & 0x1fffe0 ) + 0x1f, param_4, param_5, param_6);
            if (cVar1 == '\0') {
               return 0;
            }
   ...
   LAB_00101471:if (( param_6 != 2 ) || ( pUVar14 != pUVar15 )) {
      return 1;
   }
   ...
   LAB_00101493:uVar8 = enumExtNames(uVar5, uVar3, param_4, param_5);
   return uVar8;
}
/* icu_76_godot::calcNameSetLength(unsigned short const*, unsigned short, unsigned char const*,
   signed char*, unsigned int*, unsigned char const**, unsigned char const*) [clone .constprop.0] */int icu_76_godot::calcNameSetLength(ushort *param_1, ushort param_2, uchar *param_3, signed *param_4, uint *param_5, uchar **param_6, uchar *param_7) {
   char cVar1;
   ushort uVar2;
   uchar **ppuVar3;
   byte *pbVar4;
   ...
   while (ppuVar9 = ppuVar3,ppuVar3 != param_6) {
      ...
      if (bVar6 < param_2) {
         ...
         if (uVar2 == 0xffff) {
            iVar11 = iVar11 + 1;
            ( &gNameSet )[( byte )((byte)uVar5 >> 5)] = ( &gNameSet )[( byte )((byte)uVar5 >> 5)] | 1 << ( (byte)uVar5 & 0x1f );
         }
 ...
 while ( bVar6 != 0 );
            ...
            if (cVar1 == '\0') {
               ...
               if (*pbVar8 != 0) {
                  do {
                     pbVar10 = pbVar4;
                     ( &gNameSet )[( byte )((byte)uVar7 >> 5)] = ( &gNameSet )[( byte )((byte)uVar7 >> 5)] | 1 << ( (byte)uVar7 & 0x1f );
                     uVar7 = ( uint ) * pbVar10;
                     pbVar4 = pbVar10 + 1;
                  }
 while ( *pbVar10 != 0 );
...
/* icu_76_godot::calcNameSetsLengths(UErrorCode*) [clone .constprop.0] */undefined8 icu_76_godot::calcNameSetsLengths(UErrorCode *param_1) {
   byte bVar1;
   ushort uVar2;
   ushort uVar3;
   ushort uVar4;
   ...
   if (gMaxNameLength == 0) {
      if (*(int*)param_1 < 1) {
         if (( gCharNamesInitOnce == 2 ) || ( cVar8 = icu_76_godot::umtx_initImplPreInit((UInitOnce*)&gCharNamesInitOnce) ),cVar8 == '\0') {
            if (0 < DAT_0010324c) {
 ...
 while ( (byte*)pcVar17 != (byte*)0x1036c3 );
            ...
            puVar5 = charCatNames;
            for (iVar18 = *(int*)( (ulong)uCharNames[3] + (long)uCharNames ); charCatNames = puVar5,iVar18 != 0; iVar18 = iVar18 + -1) {
               if ((char)piVar22[2] == '\0') {
 ...
 while ( *pbVar20 != 0 );
            ...
            joined_r0x00101b70:ppuVar23 = ppuVar23 + 1;
            ...
            do {
               lVar30 = 0;
               lVar13 = expandGroupLengths((uchar*)( (long)CONCAT22(puVar16[1], puVar16[2]) + (ulong)puVar7[2] + (long)puVar7 ), local_d8, local_88);
               do {
                  ...
                  if (uVar4 != 0) {
                     ...
                     iVar18 = calcNameSetLength((ushort*)( (long)puVar6 + 0x12 ), uVar2, (uchar*)( (long)puVar6 + (ulong)uVar26 ), psVar11, (uint*)&local_e0, ppuVar24, in_stack_fffffffffffffed8);
                     if (iVar29 < iVar18) {
                        iVar29 = iVar18;
                     }

                     if (( ppuVar24 != local_e0 ) && ( iVar18 = calcNameSetLength((ushort*)( (long)puVar6 + 0x12 ), uVar2, (uchar*)( (long)puVar6 + (ulong)uVar26 ), psVar11, (uint*)&local_e0, ppuVar24, in_stack_fffffffffffffed8) ),iVar29 < iVar18) {
                        iVar29 = iVar18;
                     }
 ...
 while ( puVar16 != puVar12 + ( ulong )(uVar3 - 1) * 3 + 4 );
            if (psVar11 != (signed*)0x0) {
               LAB_00101cf5:uprv_free_76_godot(psVar11);
            }
      ...
      LAB_001018fe:gMaxNameLength = iVar29;
      uVar10 = 1;
   }

   LAB_00101903:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar10;
   }

   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   LAB_00101b83:if (iVar29 < 9) {
      iVar29 = 9;
   }

   goto joined_r0x00101b70;
}
/* charSetToUSet(unsigned int*, USetAdder const*) [clone .constprop.0] */void charSetToUSet(uint *param_1, USetAdder *param_2) {
   char cVar1;
   uint uVar2;
   long lVar3;
   int iVar4;
...
undefined8 u_charName_76_godot(uint param_1, int param_2, char *param_3, uint param_4, UErrorCode *param_5) {
   char cVar1;
   short sVar2;
   int iVar3;
   undefined8 uVar4;
   ...
   if (param_1 < 0x110000) {
      if (( icu_76_godot::gCharNamesInitOnce == 2 ) || ( cVar1 = icu_76_godot::umtx_initImplPreInit((UInitOnce*)&icu_76_godot::gCharNamesInitOnce) ),cVar1 == '\0') {
         if (0 < DAT_0010324c) {
      ...
      if (*(int*)param_5 < 1) {
         ...
         if (param_2 == 2) {
            ...
            sVar2 = icu_76_godot::getName(icu_76_godot::uCharNames, param_1, param_2, param_3, param_4 & 0xffff);
         }
   ...
   LAB_00101fc0:sVar2 = 0;
   LAB_00101fc5:uVar4 = u_terminateChars_76_godot(param_3, param_4, sVar2, param_5);
   return uVar4;
}
...
uint u_charFromName_76_godot(uint param_1, char *param_2, UErrorCode *param_3) {
   ...
   if (( param_3 != (UErrorCode*)0x0 ) && ( *(int*)param_3 < 1 )) {
      if (( (int)param_1 < 4 ) && ( ( param_2 != (char*)0x0 && ( *param_2 != '\0' ) ) )) {
         if (( icu_76_godot::gCharNamesInitOnce == 2 ) || ( cVar3 = icu_76_godot::umtx_initImplPreInit((UInitOnce*)&icu_76_godot::gCharNamesInitOnce) ),cVar3 == '\0') {
            if (0 < DAT_0010324c) {
         ...
         if (*(int*)param_3 < 1) {
            ...
            do {
               ...
               if (cVar3 == '\0') {
                  ...
                  if (bVar25) {
                     piVar20 = (int*)( ( ulong ) * (uint*)( icu_76_godot::uCharNames + 0xc ) + icu_76_godot::uCharNames );
                     iVar23 = *piVar20;
 ...
 while ( uVar19 != 0x78 );
   ...
   while (true) {
      ...
      iVar23 = iVar23 + -1;
      if (iVar23 == 0) break;
      LAB_00102252:if (( param_1 & 0xfffffffd ) == 0) {
         goto LAB_001022b0;
      }

   }
;
   LAB_00102498:local_218 = local_138;
   local_210 = 0xffff;
   ...
   goto LAB_0010216f;
   LAB_001022b0:if ((char)puVar21[2] == '\0') {
      puVar14 = puVar21 + 3;
      pcVar8 = local_138;
      do {
         uVar24 = *puVar14;
 ...
 while ( cVar3 == (char)uVar24 );
      ...
      do {
         ...
         if ((char)uVar2 == '\0') {
            uVar7 = puVar21[1];
            uVar24 = *puVar21;
            icu_76_godot::writeFactorSuffix((ushort*)puVar14, (ushort)bVar5, (char*)puVar11, 0, local_208, local_1f8, local_1b8, local_178, 0x40);
 ...
 while ( pcVar8 != pcVar13 );
   LAB_00102576:if (( ( *pcVar13 == '\0' ) && ( *puVar21 <= uVar24 ) ) && ( uVar24 <= puVar21[1] )) {
      LAB_001024e5:if (uVar24 != 0xffff) goto LAB_0010216f;
   }

   LAB_00102478:puVar21 = (uint*)( (long)puVar21 + ( ulong ) * (ushort*)( (long)puVar21 + 10 ) );
   iVar23 = iVar23 + -1;
 ...
 while ( cVar3 != '\0' );
      ...
      pcVar13 = pcVar8;
      if (uVar10 == 0) {
         LAB_001024e0:if (*pcVar13 == '\0') goto LAB_001024e5;
      }
 else {
         LAB_00102422:do {
...
;
 ...
 while ( uVar17 < uVar10 );
         LAB_00102460:if (uVar17 < 99) goto LAB_001024e0;
      }
 ...
 while ( uVar7 + 1 != uVar24 );
   ...
   while (true) {
      ...
      LAB_001025ad:uVar18 = (uint)uVar9;
      if (uVar18 < 3) {
...
;
 ...
 while ( uVar18 < uVar7 );
         ...
         bVar5 = 0x1e;
         if (( ( 0xfdef < (int)uVar24 ) && ( ( ~uVar24 & 0xfffe ) != 0 ) ) && ( bVar5 = bVar5 == 0x12 )) {
            bVar5 = 0x20;
         }
         ...
         uVar24 = 0;
         LAB_001026fe:bVar5 = u_charType_76_godot(uVar24);
         if (bVar5 == 0x12) {
 ...
 while ( lVar22 != 0x21 );
   ...
   LAB_0010227b:*(undefined4*)param_3 = 0xc;
   LAB_00102169:uVar24 = 0xffff;
   LAB_0010216f:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar24;
   }
...
void u_enumCharNames_76_godot(uint param_1, uint param_2, long param_3, undefined8 param_4, int param_5, UErrorCode *param_6) {
   char cVar1;
   uint uVar2;
   int *piVar3;
   uint *puVar4;
         ...
         if (*(int*)param_6 < 1) {
            ...
            for (iVar5 = *piVar3; iVar5 != 0; iVar5 = iVar5 + -1) {
               ...
               if (param_1 < uVar2) {
                  ...
                  cVar1 = icu_76_godot::enumNames(icu_76_godot::uCharNames, param_1, uVar2, param_3, param_4, param_5);
                  if (cVar1 == '\0') {
                     return;
                  }
...
int uchar_swapNames_76_godot(UDataSwapper *param_1, long param_2, int param_3, undefined4 *param_4, UErrorCode *param_5) {
   byte *pbVar1;
   short *psVar2;
   undefined2 *puVar3;
   undefined4 *puVar4;
   ...
   if (( param_5 != (UErrorCode*)0x0 ) && ( *(int*)param_5 < 1 )) {
      if (( *(short*)( param_2 + 0xc ) == 0x6e75 ) && ( ( *(short*)( param_2 + 0xe ) == 0x6d61 && ( *(char*)( param_2 + 0x10 ) == '\x01' ) ) )) {
 ...
 while ( iVar20 != iVar24 );
            ...
            LAB_00102fa5:iVar10 = uVar11 + iVar10;
            goto LAB_00102ef2;
         }

         uVar28 = param_3 - iVar10;
         if (( (int)uVar28 < 0x14 ) || ( uVar11 = uVar28 < uVar11 )) {
            udata_printError_76_godot(param_1, "uchar_swapNames(): too few bytes (%d after header) for unames.icu\n", uVar28);
         ...
         if (uVar7 == 0) {
            uVar19 = 0;
            uVar7 = 0;
            LAB_00102b56:lVar25 = (ulong)uVar19 * 2;
            ...
            if (uVar19 < 8) {
               ...
               *(undefined8*)( (long)&uStack_650 + (ulong)uVar19 + lVar25 ) = 0;
               ...
               for (uVar18 = ( ulong )(uVar19 + ( (int)psVar2 - (int)(undefined8*)( ( ulong )(auStack_640 + lVar25) & 0xfffffffffffffff8 ) ) >> 3); uVar18 != 0; uVar18 = uVar18 - 1) {
                  *puVar23 = 0;
            ...
            lVar25 = 0;
            do {
               sVar8 = udata_readInt16_76_godot(param_1, (int)*(short*)( (long)__src_00 + lVar25 * 2 + 0x12 ));
            ...
            if (__src == (void*)0x0) {
               ...
               *(undefined4*)param_5 = 7;
               ...
               if (uVar19 != 0) {
                  lVar29 = 1;
                  do {
                     ( **(code**)( param_1 + 0x30 ) )(param_1, lVar25, 2, (void*)( (long)__src + (ulong)local_249[lVar29] * 2 ), param_5);
 ...
 while ( lVar29 != 0x101 );
                  if (0x100 < uVar19) {
                     ...
                     do {
                        ...
                        uVar22 = uVar21 + 1;
                        uVar18 = (ulong)uVar22;
                        ( **(code**)( param_1 + 0x30 ) )(param_1, lVar25, 2, (void*)( (long)__src + ( (ulong)local_148[uVar16] + ( ulong )(uVar21 & 0xffffff00) ) * 2 ), param_5);
                        lVar25 = lVar25 + 2;
                     }
 while ( uVar22 != uVar19 );
                  }
               ...
               LAB_00102ca8:memcpy((void*)( (long)param_4 + 0x12 ), __src, (long)(int)( uVar19 * 2 ));
               uprv_free_76_godot(__src);
               udata_swapInvStringBlock_76_godot(param_1, (long)__src_00 + (ulong)uVar12, uVar13 - uVar12, (long)param_4 + (ulong)uVar12, param_5);
               if (*(int*)param_5 < 1) {
                  puVar3 = (undefined2*)( (long)__src_00 + (ulong)uVar13 );
                  uVar7 = ( **(code**)( param_1 + 8 ) )(*puVar3);
                  ( **(code**)( param_1 + 0x30 ) )(param_1, puVar3, ( (uint)uVar7 + (uint)uVar7 * 2 ) * 2 + 2, (long)param_4 + (ulong)uVar13, param_5);
                  if (param_1[1] != param_1[3]) {
                     uVar12 = uVar11 - uVar14;
                     pbVar1 = (byte*)( (long)__src_00 + (ulong)uVar14 );
                     pbVar27 = (byte*)( (ulong)uVar14 + (long)param_4 );
                     joined_r0x00102d5e:if (0x20 < uVar12) {
                        ...
                        for (; pbVar27 = pbVar26,pbVar1 = pbVar15,iVar20 != 0; iVar20 = iVar20 + -2) {
                           while (sVar8 = local_648[*pbVar15],*pbVar27 = local_249[( ulong ) * pbVar15 + 1],sVar8 != -2) {
                              iVar20 = iVar20 + -1;
                              pbVar15 = pbVar15 + 1;
                              pbVar27 = pbVar27 + 1;
                              pbVar1 = pbVar15;
...
;
                  ...
                  if (iVar20 != 0) {
                     ...
                     do {
                        if (uVar28 < uVar11) {
                           udata_printError_76_godot(param_1, "uchar_swapNames(): too few bytes (%d after header) for unames.icu algorithmic range %u\n", uVar28, iVar24);
                           *(undefined4*)param_5 = 8;
                           goto LAB_00102ef0;
                        }
                        ...
                        if (cVar5 == '\0') {
                           ...
                           ( **(code**)( param_1 + 0x48 ) )(param_1, (char*)( lVar25 + 0xc ), sVar17 & 0xffffffff, lVar29 + 0xc, param_5);
                           if (0 < *(int*)param_5) {
                              udata_printError_76_godot(param_1, "uchar_swapNames(prefix string of algorithmic range %u) failed\n", iVar24);
                              goto LAB_00102ef0;
                           }
                           ...
                           if (cVar5 != '\x01') {
                              udata_printError_76_godot(param_1, "uchar_swapNames(): unknown type %u of algorithmic range %u\n", cVar5, iVar24);
                              *(undefined4*)param_5 = 0x10;
                              goto LAB_00102ef0;
                           }

                           bVar30 = *(byte*)( lVar25 + 9 );
                           ( **(code**)( param_1 + 0x30 ) )(param_1, lVar25 + 0xc, (uint)bVar30 * 2, lVar29 + 0xc, param_5);
 ...
 while ( iVar20 != iVar24 );
         ...
         udata_printError_76_godot(param_1, "uchar_swapNames(): data format %02x.%02x.%02x.%02x (format version %02x) is not recognized as unames.icu\n", *(undefined1*)( param_2 + 0xc ), *(undefined1*)( param_2 + 0xd ), *(undefined1*)( param_2 + 0xe ), *(undefined1*)( param_2 + 0xf ), *(char*)( param_2 + 0x10 ));
         *(undefined4*)param_5 = 0x10;
      }

   }

   LAB_00102ef0:iVar10 = 0;
   LAB_00102ef2:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }

...
LAB_00119fe1:
  ...
  RendererSceneRenderRD::_process_compositor_effects();, RendererSceneRenderImplementation::RenderForwardMobile::_pre_opaque_render(unaff_RBP, unaff_RBX));
      if (*(int*)( unaff_RBX + 0x210 ) != 0) {
         iVar11 = 0;
         do {
            iVar11 = iVar11 + 1;
 ...
 while ( *(int*)( unaff_RBX + 0x210 ) != iVar11 );
   ...
   LAB_001182b4:if (in_stack_00000038 == '\0') {
      ...
      if (( in_stack_00000010 != (Object*)0x0 ) && ( in_stack_00000028 != '\0' )) {
         ...
         if ((const::{lambda()
         #2
         (iVar11 = __cxa_guard_acquire(&const::{lambda()
         #2
   ...
   RenderSceneBuffersRD::get_texture
                (pSVar3,(StringName *)&const::{lambda()
   #1
   RendererSceneRenderRD::_post_process_subpass();
}
...
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* WARNING: Removing unreachable block (ram,0x0011826b) *//* WARNING: Removing unreachable block (ram,0x00119bdb) *//* WARNING: Removing unreachable block (ram,0x0011827f) *//* WARNING: Removing unreachable block (ram,0x001194d2) *//* WARNING: Removing unreachable block (ram,0x001185b0) *//* WARNING: Removing unreachable block (ram,0x00118fb6) *//* WARNING: Removing unreachable block (ram,0x00119e15) *//* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void FUN_00119fc7(void) {
   long *plVar1;
   RenderForwardMobile *pRVar2;
   uint uVar3;
   StringName *pSVar4;
...
}RenderingDevice::get_singleton();RenderingDevice::draw_command_end_label();RendererSceneRenderRD::_process_compositor_effects();RendererSceneRenderImplementation::RenderForwardMobile::_pre_opaque_render(unaff_RBP, unaff_RBX);if (*(int*)( unaff_RBX + 0x210 ) != 0) {
   iVar12 = 0;
   do {
      iVar12 = iVar12 + 1;
   }
...
cVar8 = RendererSceneRender::is_environment();if (( cVar8 != '\0' ) && ( cVar8 = RendererSceneRender::environment_get_fog_enabled() ),cVar8 != '\0') {
   RendererSceneRender::environment_get_fog_aerial_perspective();
   RendererSceneRender::environment_get_fog_sun_scatter();
   RendererSceneRender::environment_get_fog_height_density();
   if (*(long*)( unaff_RBX + 0x1c0 ) != 0) {
...
uVar10 = RenderingDevice::get_singleton();in_stack_00000120 = 0;String::parse_latin1(unaff_R14);RenderingDevice::draw_command_begin_label(uVar10);lVar11 = in_stack_00000120;if (in_stack_00000120 != 0) {
   LOCK();
   plVar1 = (long*)( in_stack_00000120 + -0x10 );
   *plVar1 = *plVar1 + -1;
   UNLOCK();
...
*(undefined4*)( *(long*)( unaff_RBX + 0x180 ) + 0x3cc ) = *(undefined4*)( unaff_RBX + 0x210 );RendererSceneRenderImplementation::RenderForwardMobile::_update_render_base_uniform_set(unaff_RBP);RendererSceneRenderImplementation::RenderForwardMobile::_setup_environment(unaff_RBP, unaff_RBX, in_stack_00000098, in_stack_000000a8, in_stack_00000020, *(long*)( unaff_RBX + 0x178 ) != 0, false, 0);plVar1 = RenderingServerGlobals::utilities;if (in_stack_00000108._6_1_ == '\0') {
   if (in_stack_00000038 == '\0') {
      if ((char)RenderingServerGlobals::utilities[1] != '\0') {
         in_stack_00000020 = *(Color**)( *RenderingServerGlobals::utilities + 0x68 );
         LAB_0011863c:in_stack_00000120 = 0;
...
RendererSceneRenderImplementation::RenderForwardMobile::_setup_render_pass_uniform_set();fVar6 = _LC257;in_stack_00000128 = 0;if (_LC257 <= fStack0000000000000060) {
   powf((float)( ( (double)fStack0000000000000060 + __LC259 ) * __LC260 ), _LC261);
}
if (fVar6 <= fStack0000000000000064) {
   powf((float)( ( (double)fStack0000000000000064 + __LC259 ) * __LC260 ), _LC261);
...
auVar13 = Color::operator *(in_stack_00000018, in_stack_00000088);if (in_stack_00000010 == (Object*)0x0) {
...
uVar10 = RenderingDevice::get_singleton();Rect2i::operator_cast_to_Rect2((Rect2i*)( unaff_RBX + 0x224 ));pRStack0000000000000050 = (Rect2i*)( unaff_RBX + 0x224 );lVar11 = RenderingDevice::draw_list_begin(0, uVar10, in_stack_00000030, 0x10001);uVar10 = RenderingDevice::get_singleton();lVar9 = RenderingDevice::framebuffer_get_format(uVar10);uVar3 = *(uint*)( unaff_RBP + 0x2ef8 );if (uVar3 != 0) {
   RenderingDevice::get_singleton();
   RenderingDevice::draw_list_get_current_pass();
...
RenderingDevice::get_singleton();RenderingDevice::draw_command_end_label();if (cStack0000000000000078 == '\0') goto LAB_001182b4;uVar10 = RenderingDevice::get_singleton();in_stack_00000118 = 0;String::parse_latin1((StrRange*)&stack0x00000118);RenderingDevice::draw_command_begin_label(uVar10, (StrRange*)&stack0x00000118, in_stack_00000018);lVar7 = in_stack_00000118;if (in_stack_00000118 == 0) {
...
cVar8 = RefCounted::reference();pOVar14 = unaff_R12;if (cVar8 == '\0') {
   pOVar14 = (Object*)0x0;
}
RendererRD::SkyRD::draw_sky(uVar10, unaff_RBP + 0x210, lVar11, in_stack_00000008, *(undefined8*)( unaff_RBX + 0x1c0 ), in_stack_00000030);if (( ( pOVar14 != (Object*)0x0 ) && ( cVar8 = RefCounted::unreference() ),cVar8 != '\0' )) &&( cVar8 = cVar8 != '\0' )(**(code**)( *(long*)pOVar14 + 0x140 ))(pOVar14);Memory::free_static(pOVar14, false);}RenderingDevice::get_singleton();RenderingDevice::draw_command_end_label();LAB_001182b4:if (in_stack_00000038 == '\0') {
   RenderingDevice::get_singleton();
   RenderingDevice::draw_list_end();
   RenderingDevice::get_singleton();
   RenderingDevice::draw_command_end_label();
   ...
   if (( in_stack_00000010 != (Object*)0x0 ) && ( in_stack_00000028 != '\0' )) {
      ...
      if ((const::{lambda()
      #2
      (iVar12 = __cxa_guard_acquire(&const::{lambda()
      #2
      _scs_create((char *)&const::{lambda()
      #2
      __cxa_atexit(StringName::~StringName,&const::{lambda()
...
RenderSceneBuffersRD::get_texture
                (pSVar4,(StringName *)&const::{lambda()#1RendererSceneRenderRD::_post_process_subpass();}RenderingDevice::get_singleton();RenderingDevice::draw_command_end_label();RenderingDevice::get_singleton();RenderingDevice::draw_list_end();}lVar11 = in_stack_00000128;if (in_stack_00000128 != 0) {
   LOCK();
   plVar1 = (long*)( in_stack_00000128 + -0x10 );
   *plVar1 = *plVar1 + -1;
   UNLOCK();
...
return;}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RendererSceneRenderImplementation::RenderForwardMobile::_render_material(Transform3D const&,
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RendererSceneRenderImplementation::RenderForwardMobile::_render_uv2(PagedArray<RenderGeometryInstance*>
   const&, RID, Rect2i const&) */void RendererSceneRenderImplementation::RenderForwardMobile::_render_uv2(RenderForwardMobile *this, undefined8 param_1, undefined8 param_3, Rect2i *param_4) {
   long *plVar1;
   code *pcVar2;
   uint uVar3;
   int iVar4;
 ...
 while ( lVar9 != 5 );
   ...
   if (( _render_uv2(PagedArray<RenderGeometryInstance*>const&,RID,Rect2i_const&):: ) && ( iVar4 = __cxa_guard_acquire(&_render_uv2(PagedArray<RenderGeometryInstance*> & RID, Rect2i_const & ::uv_offsets), iVar4 != 0) ) {
      _DAT_0011c000 = 0;
      _render_uv2(PagedArray<RenderGeometryInstance*> const &, RID, Rect2i_const &) {
         LOCK();
         plVar1 = (long*)( local_7b0[0] + -0x10 );
         *plVar1 = *plVar1 + -1;
         UNLOCK();
...
cVar2 = RenderSceneBuffersRD::has_texture
                    ((StringName *)this,(StringName *)&const::{lambda()#1if (cVar2 == '\0') {
   if (const::{lambda()
   #6
   iVar3 = __cxa_guard_acquire(&const::{lambda()
   #6
...
if (const::{lambda()#5iVar3 = __cxa_guard_acquire(&const::{lambda()#5if (iVar3 != 0) {
   _scs_create((char *)&const::{lambda()
   #5
   __cxa_atexit(StringName::~StringName,&const::{lambda()
   #5
   ...
   #5
    ...
    cVar2 = RenderSceneBuffersRD::has_texture
                      ((StringName *)this,(StringName *)&const::{lambda()#5if (cVar2 == '\0') {
   if (lVar1 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 0;
   }
...
if (const::{lambda()#7iVar3 = __cxa_guard_acquire(&const::{lambda()#7if (iVar3 != 0) {
   _scs_create((char *)&const::{lambda()
   #7
   __cxa_atexit(StringName::~StringName,&const::{lambda()
   #7
...
if (const::{lambda()#3iVar3 = __cxa_guard_acquire(&const::{lambda()#3if (iVar3 != 0) {
   _scs_create((char *)&const::{lambda()
   #3
   __cxa_atexit(StringName::~StringName,&const::{lambda()
   #3
   ...
   pSVar5 = (StringName *)&const::{lambda()
   #3
   LAB_0012280f:uVar4 = RenderSceneBuffersRD::get_texture((StringName*)this, pSVar5);
   return uVar4;
}
}/* WARNING: Subroutine does not return */__stack_chk_fail();}/* RendererSceneRenderImplementation::RenderForwardMobile::RenderList::sort_by_key() */void RendererSceneRenderImplementation::RenderForwardMobile::RenderList::sort_by_key(RenderList *this) {
   ...
   if (uVar8 != 0) {
      if (uVar8 == 1) {
         SortArray<RendererSceneRenderImplementation::RenderForwardMobile::GeometryInstanceSurfaceDataCache*,RendererSceneRenderImplementation::RenderForwardMobile::RenderList::SortByKey,true>::introsort(0, 1, __src, 0);
         return;
      }
 ...
 while ( uVar5 != 1 );
      SortArray<RendererSceneRenderImplementation::RenderForwardMobile::GeometryInstanceSurfaceDataCache*,RendererSceneRenderImplementation::RenderForwardMobile::RenderList::SortByKey,true>::introsort(0, uVar8, __src, lVar4 * 2);
      ppGVar10 = __src + 1;
      lVar4 = 1;
      if (0x10 < uVar8) {
         LAB_00122c4b:do {
            ...
            if (uVar5 == uVar2) {
               if (*(ulong*)*__src <= *(ulong*)pGVar1) {
                  LAB_00122c66:ppGVar9 = __src + lVar6;
                  do {
                     pGVar3 = ppGVar9[-1];
                     if (uVar5 == *(ulong*)( pGVar3 + 8 )) {
                        if (*(ulong*)pGVar3 <= *(ulong*)pGVar1) {
                           LAB_00122c94:*ppGVar9 = pGVar1;
                           goto LAB_00122c97;
                        }
 ...
 while ( lVar6 + 1 != 0x10 );
      ...
      do {
         ...
         if (uVar2 == uVar7) {
            ...
            LAB_00122d55:ppGVar9 = __src + uVar5;
            while (true) {
               pGVar3 = ppGVar9[-1];
...
;
            ...
            *ppGVar9 = pGVar1;
            ...
            LAB_00122d1a:memmove(ppGVar10, __src, uVar5 * 8);
            *__src = pGVar1;
         }

         LAB_00122d31:uVar5 = uVar5 + 1;
      }
 while ( uVar8 != uVar5 );
   }

   return;
   LAB_00122d90:_err_print_error("unguarded_linear_insert", "./core/templates/sort_array.h", 0xff, "bad comparison function; sorting will be broken", 0, 0);
   *ppGVar9 = pGVar1;
   LAB_00122c97:lVar4 = lVar6 + 1;
   if (lVar6 + 1 == 0x10) {
      LAB_00122ca1:uVar5 = lVar6 + 1;
      do {
         pGVar1 = __src[uVar5];
...
;
         _err_print_error("unguarded_linear_insert", "./core/templates/sort_array.h", 0xff, "bad comparison function; sorting will be broken", 0, 0);
         *ppGVar10 = pGVar1;
         joined_r0x00122d03:uVar5 = uVar5 + 1;
         if (uVar8 == uVar5) {
            return;
         }
...
/* RendererSceneRenderImplementation::RenderForwardMobile::RenderList::sort_by_key_range(unsigned
   int, unsigned int) */void RendererSceneRenderImplementation::RenderForwardMobile::RenderList::sort_by_key_range(RenderList *this, uint param_1, uint param_2) {
   GeometryInstanceSurfaceDataCache **__src;
   GeometryInstanceSurfaceDataCache *pGVar1;
   ulong uVar2;
   GeometryInstanceSurfaceDataCache *pGVar3;
 ...
 while ( uVar5 != 1 );
      ...
      if (0x10 < uVar8) {
         LAB_00122ee3:do {
            ...
            if (uVar5 == uVar2) {
               if (*(ulong*)*__src <= *(ulong*)pGVar1) {
                  LAB_00122efe:ppGVar9 = __src + lVar6;
                  do {
                     pGVar3 = ppGVar9[-1];
                     if (uVar5 == *(ulong*)( pGVar3 + 8 )) {
                        if (*(ulong*)pGVar3 <= *(ulong*)pGVar1) {
                           LAB_00122f2c:*ppGVar9 = pGVar1;
                           goto LAB_00122f2f;
                        }
 ...
 while ( lVar6 + 1 != 0x10 );
      ...
      do {
         ...
         if (uVar2 == uVar7) {
            ...
            LAB_00122fe5:ppGVar9 = __src + uVar5;
            while (true) {
               pGVar3 = ppGVar9[-1];
               bVar11 = uVar2 < *(ulong*)( pGVar3 + 8 );
               if (uVar2 == *(ulong*)( pGVar3 + 8 )) {
...
;
            ...
            *ppGVar9 = pGVar1;
            ...
            LAB_00122faa:memmove(ppGVar10, __src, uVar5 * 8);
            *__src = pGVar1;
         }

         LAB_00122fc1:uVar5 = uVar5 + 1;
      }
 while ( uVar8 != uVar5 );
   }

   return;
   LAB_00123020:_err_print_error("unguarded_linear_insert", "./core/templates/sort_array.h", 0xff, "bad comparison function; sorting will be broken", 0, 0);
   *ppGVar9 = pGVar1;
   LAB_00122f2f:lVar4 = lVar6 + 1;
   if (lVar6 + 1 == 0x10) {
      LAB_00122f39:uVar5 = lVar6 + 1;
      do {
         pGVar1 = __src[uVar5];
         ppGVar10 = __src + uVar5;
         uVar2 = *(ulong*)( pGVar1 + 8 );
...
;
         _err_print_error("unguarded_linear_insert", "./core/templates/sort_array.h", 0xff, "bad comparison function; sorting will be broken", 0, 0);
         *ppGVar10 = pGVar1;
         joined_r0x00122f93:uVar5 = uVar5 + 1;
         if (uVar8 == uVar5) {
            return;
         }
...
/* RendererSceneRenderImplementation::RenderForwardMobile::RenderList::sort_by_reverse_depth_and_priority()
    */void RendererSceneRenderImplementation::RenderForwardMobile::RenderList::sort_by_reverse_depth_and_priority(RenderList *this) {
   float *pfVar1;
   GeometryInstanceSurfaceDataCache GVar2;
   GeometryInstanceSurfaceDataCache GVar3;
   GeometryInstanceSurfaceDataCache **__src;
   ...
   if (uVar10 != 0) {
      if (uVar10 == 1) {
         SortArray<RendererSceneRenderImplementation::RenderForwardMobile::GeometryInstanceSurfaceDataCache*,RendererSceneRenderImplementation::RenderForwardMobile::RenderList::SortByReverseDepthAndPriority,true>::introsort(0, 1, __src, 0);
         return;
      }
 ...
 while ( uVar7 != 1 );
      SortArray<RendererSceneRenderImplementation::RenderForwardMobile::GeometryInstanceSurfaceDataCache*,RendererSceneRenderImplementation::RenderForwardMobile::RenderList::SortByReverseDepthAndPriority,true>::introsort(0, uVar10, __src, lVar6 * 2);
      ppGVar12 = __src + 1;
      lVar6 = 1;
      if (0x10 < uVar10) {
         LAB_0012316b:do {
            ...
            if (GVar3 == GVar2) {
               ...
               if (*(float*)( *(long*)( pGVar4 + 0x60 ) + 0x10 ) < *pfVar1 || *(float*)( *(long*)( pGVar4 + 0x60 ) + 0x10 ) == *pfVar1) {
                  LAB_00123191:ppGVar11 = __src + lVar8;
                  do {
                     pGVar5 = ppGVar11[-1];
                     if (GVar3 == pGVar5[0xf]) {
                        if (*(float*)( *(long*)( pGVar4 + 0x60 ) + 0x10 ) < *(float*)( *(long*)( pGVar5 + 0x60 ) + 0x10 ) || *(float*)( *(long*)( pGVar4 + 0x60 ) + 0x10 ) == *(float*)( *(long*)( pGVar5 + 0x60 ) + 0x10 )) {
                           LAB_001231ce:*ppGVar11 = pGVar4;
                           goto LAB_001231d1;
                        }
 ...
 while ( lVar8 + 1 != 0x10 );
      ...
      do {
         ...
         if (GVar3 == GVar2) {
            pfVar1 = (float*)( *(long*)( *__src + 0x60 ) + 0x10 );
            if (*pfVar1 <= *(float*)( *(long*)( pGVar4 + 0x60 ) + 0x10 ) && *(float*)( *(long*)( pGVar4 + 0x60 ) + 0x10 ) != *pfVar1) goto LAB_00123262;
            LAB_001232a9:ppGVar11 = __src + uVar7;
            while (true) {
               pGVar5 = ppGVar11[-1];
               bVar13 = (byte)GVar3 < (byte)pGVar5[0xf];
               if (GVar3 == pGVar5[0xf]) {
                  bVar13 = *(float*)( *(long*)( pGVar5 + 0x60 ) + 0x10 ) <= *(float*)( *(long*)( pGVar4 + 0x60 ) + 0x10 ) && *(float*)( *(long*)( pGVar4 + 0x60 ) + 0x10 ) != *(float*)( *(long*)( pGVar5 + 0x60 ) + 0x10 );
               }
...
;
            ...
            *ppGVar11 = pGVar4;
            ...
            LAB_00123262:memmove(ppGVar12, __src, uVar7 * 8);
            *__src = pGVar4;
         }

         LAB_00123279:uVar7 = uVar7 + 1;
      }
 while ( uVar10 != uVar7 );
   }

   return;
   LAB_001232f0:_err_print_error("unguarded_linear_insert", "./core/templates/sort_array.h", 0xff, "bad comparison function; sorting will be broken", 0, 0);
   *ppGVar11 = pGVar4;
   LAB_001231d1:lVar6 = lVar8 + 1;
   if (lVar8 + 1 == 0x10) {
      LAB_001231db:uVar7 = lVar8 + 1;
      do {
         pGVar4 = __src[uVar7];
...
;
         _err_print_error("unguarded_linear_insert", "./core/templates/sort_array.h", 0xff, "bad comparison function; sorting will be broken", 0, 0);
         *ppGVar12 = pGVar4;
         joined_r0x00123246:uVar7 = uVar7 + 1;
         if (uVar10 == uVar7) {
            return;
         }
...
/* FramebufferCacheRD::_allocate_from_data(unsigned int, unsigned int, unsigned int, Vector<RID>
 ...
 while ( plVar3 + uVar5 != plVar17 );
   ...
   *(uint*)( this + 0x18c ) = uVar5;
   pauVar1 = *(undefined1(**) [16])( plVar18[uVar5 >> ( ( byte ) * (undefined4*)( this + 400 ) & 0x1f )] + ( ulong )(uVar5 & *(uint*)( this + 0x194 )) * 8 );
      ...
      if (uVar5 != 0) {
         ...
         *(uint*)pauVar1[2] = uVar5;
         if (lVar21 == 0) {
            uVar12 = 0;
            lVar15 = 0;
            LAB_0012386e:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, uVar12, lVar15, "p_index", "size()", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar4 = (code*)invalidInstructionException();
            ( *pcVar4 )();
 ...
 while ( uVar12 != ( uVar22 & 0xffffffff ) );
         ...
         do {
            ...
            for (int i = 0; i < 4; i++) {
               if (*(long*)( lVar21 + ( -16*i + 56 ) ) != 0) {
                  LOCK();
                  plVar18 = (long*)( *(long*)( lVar21 + ( -16*i + 56 ) ) + -16 );
                  *plVar18 = *plVar18 + -1;
                  UNLOCK();
                  if (*plVar18 == 0) {
                     lVar15 = *(long*)( lVar21 + ( -16*i + 56 ) );
                     *(undefined8*)( lVar21 + ( -16*i + 56 ) ) = 0;
 ...
 while ( uVar5 < *(uint*)pauVar1[3] );
         *(uint*)pauVar1[3] = local_48;
         uVar5 = local_48;
         LAB_001236ed:if (uVar5 != 0) {
            lVar11 = *(long*)( param_5 + 8 );
            LAB_00123799:uVar12 = 0;
            while (lVar11 != 0) {
               ...
               for (int i = 0; i < 4; i++) {
                  if (*(long*)( lVar21 + ( 16*i + 8 ) ) != *(long*)( lVar11 + ( 16*i + 8 ) )) {
                     CowData<int>::_ref((CowData<int>*)( lVar21 + ( 16*i + 8 ) ), (CowData*)( lVar11 + ( 16*i + 8 ) ));
                  }
...
;
   ...
   lVar11 = *(long*)( param_5 + 8 );
   if (( lVar11 != 0 ) && ( uVar22 = *(ulong*)( lVar11 + -8 ) & 0xffffffff ),(int)*(ulong*)( lVar11 + -8 ) != 0) {
      uVar5 = 0;
      LAB_0012372d:uVar6 = (uint)uVar22;
      uVar20 = uVar6 - 1;
 ...
 while ( lVar21 + 0x48 + ( (ulong)uVar5 + ( ulong )(uVar20 - uVar5) ) * 0x48 != lVar13 );
   ...
   LAB_001238f0:*(undefined8*)*pauVar1 = 0;
   ...
   *(int*)( this + 0x201c8 ) = *(int*)( this + 0x201c8 ) + 1;
   return lVar10;
   LAB_00123b2f:local_48 = LocalVector<RendererSceneRenderImplementation::RenderForwardMobile::SceneState::ShadowPass,unsigned_int,false,false>::resize((uint)pvVar19);
   LAB_00123b34:if (local_48 <= uVar5) goto LAB_001236ed;
   goto LAB_0012372d;
}
/* FramebufferCacheRD::get_cache_multipass(Vector<RID> const&,
   Vector<RenderingDevice::FramebufferPass> const&, unsigned int) */undefined8 FramebufferCacheRD::get_cache_multipass(FramebufferCacheRD *this, Vector *param_1, Vector *param_2, uint param_3) {
   undefined8 *puVar1;
   int *piVar2;
   uint uVar3;
   uint uVar4;
   ...
   if (puVar5 == (undefined8*)0x0) {
      ...
      uVar10 = ( (int)uVar16 * 0x16a88000 | ( uint )((int)uVar16 * -0x3361d2af) >> 0x11 ) * 0x1b873593 ^ uVar10;
      uVar10 = ( uVar10 << 0xd | uVar10 >> 0x13 ) * 5 + 0xe6546b64;
      if (0 < (long)uVar16) {
         puVar21 = puVar5;
         do {
            ...
            uVar10 = ( iVar12 * 0x16a88000 | ( uint )(iVar12 * -0x3361d2af) >> 0x11 ) * 0x1b873593 ^ ( uVar10 << 0xd | uVar10 >> 0x13 ) * 5 + 0xe6546b64;
            uVar10 = ( uVar10 << 0xd | uVar10 >> 0x13 ) * 5 + 0xe6546b64;
         }
 while ( puVar5 + uVar16 != puVar21 );
   ...
   if (lVar6 == 0) {
      ...
      if (0 < lVar23) {
         ...
         do {
            piVar24 = (int*)*puVar21;
            uVar10 = ( *(int*)( puVar21 + 7 ) * 0x16a88000 | ( uint )(*(int*)( puVar21 + 7 ) * -0x3361d2af) >> 0x11 ) * 0x1b873593 ^ uVar10;
            uVar10 = ( uVar10 << 0xd | uVar10 >> 0x13 ) * 5 + 0xe6546b64 ^ ( *(int*)( (long)puVar21 + 0x3c ) * 0x16a88000 | ( uint )(*(int*)( (long)puVar21 + 0x3c ) * -0x3361d2af) >> 0x11 ) * 0x1b873593;
            uVar10 = ( uVar10 << 0xd | uVar10 >> 0x13 ) * 5 + 0xe6546b64;
            if (piVar24 == (int*)0x0) {
               piVar24 = (int*)puVar21[4];
               uVar10 = ( uVar10 * 0x2000 | uVar10 >> 0x13 ) * 5 + 0xe6546b64;
               if (piVar24 != (int*)0x0) goto LAB_00123d2d;
               LAB_00123f7a:piVar24 = (int*)puVar21[6];
               uVar10 = ( uVar10 << 0xd | uVar10 >> 0x13 ) * 5 + 0xe6546b64;
               if (piVar24 != (int*)0x0) goto LAB_00123d95;
               LAB_00123f91:uVar10 = ( uVar10 << 0xd | uVar10 >> 0x13 ) * 5 + 0xe6546b64;
            }
 else {
               lVar7 = *(long*)( piVar24 + -2 );
               uVar10 = ( (int)lVar7 * 0x16a88000 | ( uint )((int)lVar7 * -0x3361d2af) >> 0x11 ) * 0x1b873593 ^ uVar10;
               uVar10 = ( uVar10 << 0xd | uVar10 >> 0x13 ) * 5 + 0xe6546b64;
               if (0 < lVar7) {
 ...
 while ( piVar2 != piVar24 );
               ...
               LAB_00123d2d:lVar7 = *(long*)( piVar24 + -2 );
               uVar10 = uVar10 ^ ( (int)lVar7 * 0x16a88000 | ( uint )((int)lVar7 * -0x3361d2af) >> 0x11 ) * 0x1b873593;
               uVar10 = ( uVar10 << 0xd | uVar10 >> 0x13 ) * 5 + 0xe6546b64;
               if (0 < lVar7) {
                  piVar2 = piVar24 + lVar7;
                  do {
 ...
 while ( piVar2 != piVar24 );
               ...
               LAB_00123d95:lVar7 = *(long*)( piVar24 + -2 );
               uVar10 = uVar10 ^ ( (int)lVar7 * 0x16a88000 | ( uint )((int)lVar7 * -0x3361d2af) >> 0x11 ) * 0x1b873593;
               uVar10 = ( uVar10 << 0xd | uVar10 >> 0x13 ) * 5 + 0xe6546b64;
               if (0 < lVar7) {
                  piVar2 = piVar24 + lVar7;
 ...
 while ( puVar1 != puVar21 );
   ...
   do {
      ...
      if (( *(uint*)( lVar7 + 0x10 ) == uVar10 ) && ( *(uint*)( lVar7 + 0x40 ) == param_3 )) {
         ...
         if (( uVar3 == (uint)uVar17 ) && ( uVar4 = uVar4 == local_50 )) {
            if ((long)uVar16 < 1) {
               LAB_00123fe0:if (lVar23 < 1) {
                  LAB_001241d7:return *(undefined8*)( lVar7 + 0x18 );
               }

               uVar3 = uVar4;
               if (uVar4 == 0) {
                  uVar17 = 0;
                  LAB_00123f1b:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xae, uVar17, (ulong)uVar3, "p_index", "count", "", false, true);
                  _err_flush_stdout();
                  /* WARNING: Does not return */
               ...
               while (( (int)plVar20[7] == (int)plVar18[7] && ( *(int*)( (long)plVar20 + 0x3c ) == *(int*)( (long)plVar18 + 0x3c ) ) )) {
                  lVar8 = *plVar20;
                  lVar19 = *plVar18;
                  if (lVar8 == 0) {
                     if (lVar19 != 0) {
                     ...
                     lVar15 = *(long*)( lVar8 + -8 );
                     if (lVar19 == 0) {
                        joined_r0x001241bf:if (lVar15 != 0) break;
                     }
 else {
                        ...
                        if (0 < lVar15) {
                           lVar14 = 0;
                           do {
                              if (*(int*)( lVar8 + lVar14 * 4 ) != *(int*)( lVar19 + lVar14 * 4 )) goto LAB_00123e70;
                              lVar14 = lVar14 + 1;
                           }
 while ( lVar15 != lVar14 );
                        }
                  ...
                  if (lVar8 == 0) {
                     ...
                     lVar15 = *(long*)( lVar8 + -8 );
                     if (lVar19 == 0) {
                        joined_r0x00124145:if (lVar15 != 0) break;
                     }
 else {
                        if (lVar15 != *(long*)( lVar19 + -8 )) break;
                        if (0 < lVar15) {
 ...
 while ( lVar15 != lVar14 );
                  ...
                  if (lVar8 == 0) {
                     ...
                     if (lVar19 == 0) {
                        ...
                        LAB_001240fa:if (*(long*)( lVar19 + -8 ) != lVar15) break;
                        if (0 < lVar15) {
                           lVar14 = 0;
                           do {
                              if (*(int*)( lVar8 + lVar14 * 4 ) != *(int*)( lVar19 + lVar14 * 4 )) goto LAB_00123e70;
...
;
      ...
      LAB_00123e70:lVar7 = *(long*)( lVar7 + 8 );
   }
 while ( true );
}
/* RenderDataRD::~RenderDataRD() */void RenderDataRD::~RenderDataRD(RenderDataRD *this) {
   Object *pOVar1;
   char cVar2;
   *(code**)this = RendererSceneRender::is_environment;
   for (int i = 0; i < 3; i++) {
      if (*(void**)( this + ( -16*i + 624 ) ) != (void*)0) {
         if (*(int*)( this + ( -16*i + 616 ) ) != 0) {
            *(undefined4*)( this + ( -16*i + 616 ) ) = 0;
         }

         Memory::free_static(*(void**)( this + ( -16*i + 624 ) ), false);
      }
...
/* WARNING: Removing unreachable block (ram,0x001244d0) *//* WARNING: Removing unreachable block (ram,0x00124600) *//* WARNING: Removing unreachable block (ram,0x00124779) *//* WARNING: Removing unreachable block (ram,0x0012460c) *//* WARNING: Removing unreachable block (ram,0x00124616) *//* WARNING: Removing unreachable block (ram,0x0012475b) *//* WARNING: Removing unreachable block (ram,0x00124622) *//* WARNING: Removing unreachable block (ram,0x0012462c) *//* WARNING: Removing unreachable block (ram,0x0012473d) *//* WARNING: Removing unreachable block (ram,0x00124638) *//* WARNING: Removing unreachable block (ram,0x00124642) *//* WARNING: Removing unreachable block (ram,0x0012471f) *//* WARNING: Removing unreachable block (ram,0x0012464e) *//* WARNING: Removing unreachable block (ram,0x00124658) *//* WARNING: Removing unreachable block (ram,0x00124701) *//* WARNING: Removing unreachable block (ram,0x00124664) *//* WARNING: Removing unreachable block (ram,0x0012466e) *//* WARNING: Removing unreachable block (ram,0x001246e3) *//* WARNING: Removing unreachable block (ram,0x00124676) *//* WARNING: Removing unreachable block (ram,0x00124680) *//* WARNING: Removing unreachable block (ram,0x001246c8) *//* WARNING: Removing unreachable block (ram,0x00124688) *//* WARNING: Removing unreachable block (ram,0x0012469e) *//* WARNING: Removing unreachable block (ram,0x001246aa) *//* String vformat<String, String>(String const&, String const, String const) */undefined8 *vformat<String,String>(undefined8 *param_1, bool *param_2, String *param_3, String *param_4) {
   Variant *pVVar1;
   Variant *pVVar2;
   int iVar3;
   long in_FS_OFFSET;
...

{
 ...
 while ( ( uVar43 != 0 ) && ( auVar6._8_8_ = 0 ),auVar6._0_8_ = (ulong)uVar43 * lVar46,auVar22._8_8_ = 0,auVar22._0_8_ = uVar55,auVar7._8_8_ = 0,auVar7._0_8_ = ( ulong )(( uVar53 + uVar47 ) - SUB164(auVar6 * auVar22, 8)) * lVar46,auVar23._8_8_ = 0,auVar23._0_8_ = uVar55,lVar45 = SUB168(auVar7 * auVar23, 8),uVar50 <= SUB164(auVar7 * auVar23, 8) );
   ...
   LAB_00124d73:uVar51 = CONCAT44(0, *(uint*)( hash_table_size_primes + uVar39 * 4 ));
   lVar46 = *(long*)( hash_table_size_primes_inv + uVar39 * 8 );
   uVar38 = lVar56 * 0x3ffff - 1;
   uVar38 = ( uVar38 ^ uVar38 >> 0x1f ) * 0x15;
   uVar38 = ( uVar38 ^ uVar38 >> 0xb ) * 0x41;
...
}LAB_001249bb:if ((float)uVar55 * __LC127 < (float)( iVar42 + 1 )) {
...
;*(undefined1(**) [16])( lVar46 + lStack_b0 * 8 ) = pauVar36;*puVar1 = uVar53;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_00124d54:auVar59._8_8_ = lStack_b0;auVar59._0_8_ = pauVar41[1] + 8;return auVar59;}/* PipelineHashMapRD<RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::PipelineKey,
   ...
   int) */void PipelineHashMapRD<RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::PipelineKey,RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData,void(RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::*)(RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::PipelineKey)>::wait_for_pipeline(PipelineHashMapRD<RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::PipelineKey,RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData,void(RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::*)(RendererSceneRenderImplementation::SceneShaderForwardMobile::ShaderData::PipelineKey)> *this, uint param_1) {
   ulong uVar1;
   undefined1 auVar2[16];
   undefined1 auVar3[16];
   undefined1 auVar4[16];
...
;
   ...
   LAB_00125055:pthread_mutex_unlock((pthread_mutex_t*)( this + 0xc0 ));
   return;
   LAB_0012514a:if (( uVar11 == uVar17 ) && ( *(uint*)( *(long*)( lVar12 + lVar15 * 8 ) + 0x10 ) == param_1 )) {
      lVar12 = *(long*)( lVar12 + (ulong)uVar13 * 8 );
      if (lVar12 != 0) {
         WorkerThreadPool::wait_for_task_completion(WorkerThreadPool::singleton);
         HashMap<unsigned_int,long,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,long>>>::erase((HashMap<unsigned_int,long,HashMapHasherDefault,HashMapComparatorDefault<unsigned_int>,DefaultTypedAllocator<HashMapElement<unsigned_int,long>>>*)( this + 0x90 ), (uint*)( lVar12 + 0x10 ));
      }
   ...
   if (( uVar11 == 0 ) || ( auVar4._8_8_ = 0 ),auVar4._0_8_ = uVar11 * uVar1,auVar8._8_8_ = 0,auVar8._0_8_ = uVar18,auVar5._8_8_ = 0,auVar5._0_8_ = ( ( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0xb8 ) * 4 ) + uVar13 ) - SUB164(auVar4 * auVar8, 8) ) * uVar1,auVar9._8_8_ = 0,auVar9._0_8_ = uVar18,SUB164(auVar5 * auVar9, 8) < uVar16) goto LAB_00125055;
   goto LAB_0012514a;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RendererSceneRenderImplementation::RenderForwardMobile::GeometryInstanceForwardMobile*
   PagedAllocator<RendererSceneRenderImplementation::RenderForwardMobile::GeometryInstanceForwardMobile,
   false, 4096u>::alloc<>() */GeometryInstanceForwardMobile * __thiscall
...
::alloc<>(PagedAllocator<RendererSceneRenderImplementation::RenderForwardMobile::GeometryInstanceForwardMobile,false,4096u>
 ...
 while ( plVar3 + uVar5 != plVar10 );
   ...
   *(uint*)( this + 0x14 ) = uVar5;
   pGVar1 = *(GeometryInstanceForwardMobile**)( plVar12[uVar5 >> ( ( byte ) * (undefined4*)( this + 0x18 ) & 0x1f )] + ( ulong )(uVar5 & *(uint*)( this + 0x1c )) * 8 );
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RendererSceneRenderImplementation::RenderForwardMobile::GeometryInstanceLightmapSH*
   PagedAllocator<RendererSceneRenderImplementation::RenderForwardMobile::GeometryInstanceLightmapSH,
   false, 4096u>::alloc<>() */GeometryInstanceLightmapSH * __thiscall
...
::alloc<>(PagedAllocator<RendererSceneRenderImplementation::RenderForwardMobile::GeometryInstanceLightmapSH,false,4096u>
 ...
 while ( plVar13 != plVar3 + uVar5 );
   ...
   uVar5 = iVar6 - 1;
   *(uint*)( this + 0x14 ) = uVar5;
   pGVar1 = *(GeometryInstanceLightmapSH**)( plVar15[uVar5 >> ( ( byte ) * (undefined4*)( this + 0x18 ) & 0x1f )] + ( ulong )(uVar5 & *(uint*)( this + 0x1c )) * 8 );
   *(undefined8*)pGVar1 = 0;
   *(undefined8*)( pGVar1 + 0x88 ) = 0;
   puVar16 = (undefined8*)( ( ulong )(pGVar1 + 8) & 0xfffffffffffffff8 );
   for (uVar10 = ( ulong )(( (int)pGVar1 - (int)(undefined8*)( ( ulong )(pGVar1 + 8) & 0xfffffffffffffff8 ) ) + 0x90U >> 3); pGVar7 = pGVar1,uVar10 != 0; uVar10 = uVar10 - 1) {
      *puVar16 = 0;
...
/* void memdelete<RenderGeometryInstanceBase::Data>(RenderGeometryInstanceBase::Data*) */void memdelete<RenderGeometryInstanceBase::Data>(Data *param_1) {
   long *plVar1;
   int iVar2;
   long lVar3;
   void *pvVar4;
   ...
   if (iVar2 == 0) {
      ...
      for (lVar5 = 0; local_48 = param_1 + 0x58,HashMap<DependencyTracker*,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<DependencyTracker*>,DefaultTypedAllocator<HashMapElement<DependencyTracker*,unsigned_int>>>::erase(*(HashMap<DependencyTracker*,unsigned_int,HashMapHasherDefault,HashMapComparatorDefault<DependencyTracker*>,DefaultTypedAllocator<HashMapElement<DependencyTracker*,unsigned_int>>>**)( lVar3 + lVar5 * 8 ), (DependencyTracker**)&local_48),(int)lVar5 + 1 < iVar2; lVar5 = lVar5 + 1) {}
      pvVar4 = *(void**)( param_1 + 0x78 );
      if (pvVar4 == (void*)0x0) goto LAB_0012563f;
      if (*(int*)( param_1 + 0x9c ) != 0) {
         if (*(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( param_1 + 0x98 ) * 4 ) != 0) {
            memset(*(void**)( param_1 + 0x90 ), 0, ( ulong ) * (uint*)( hash_table_size_primes + ( ulong ) * (uint*)( param_1 + 0x98 ) * 4 ) * 4);
         }
   ...
   LAB_0012563f:if (*(long*)( param_1 + 0x20 ) != 0) {
      LOCK();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<RID>::resize<false>(long) */undefined8 CowData<RID>::resize<false>(CowData<RID> *this, long param_1) {
   ...
   if (param_1 * 8 == 0) {
      LAB_00125a08:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
   ...
   if (param_1 <= lVar7) {
      ...
      if (uVar4 + 1 == lVar3) {
         ...
         if (puVar5 == (undefined8*)0x0) {
            LAB_00125a40:_err_print_error("_realloc", "./core/templates/cowdata.h", 0x1a9, "Parameter \"mem_new\" is null.", 0, 0);
            return 6;
         }

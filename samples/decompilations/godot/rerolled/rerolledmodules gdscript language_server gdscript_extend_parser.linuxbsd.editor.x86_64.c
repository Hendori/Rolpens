...
/* ExtendGDScriptParser::dump_class_api(GDScriptParser::ClassNode const*) const */ClassNode *ExtendGDScriptParser::dump_class_api(ClassNode *param_1) {
   ...
   if (( *(long*)( in_RDX + 0x128 ) == 0 ) || ( lVar9 = lVar9 == 0 )) {
      local_168 = (char*)0x0;
   }
 else {
      local_168 = (char*)0x0;
   ...
   for (lVar31 = 0; ( lVar28 != 0 && ( lVar31 < *(long*)( lVar28 + -8 ) ) ); lVar31 = lVar31 + 1) {
      ...
      if (*(code**)*puVar24 == GDScriptParser::Node::get_datatype) {
         ...
         if (pOVar8 != (Object*)local_100._0_8_) {
            ...
            if (( pOVar8 != (Object*)0x0 ) && ( cVar18 = cVar18 == '\0' )) {
               auVar34._8_8_ = 0;
...
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* ExtendGDScriptParser::parse_class_symbol(GDScriptParser::ClassNode const*, lsp::DocumentSymbol&)
   ...
   if (( *(long*)( param_1 + 0x128 ) != 0 ) && ( lVar32 = lVar32 != 0 )) {
      local_138 = (char*)0x0;
                        ...
                        do {
                           if (uVar29 == uVar34) {
                              ...
                              if (cVar28 != '\0') {
                                 ...
                                 if (( cVar28 == '\0' ) || ( cVar28 = cVar28 == '\0' )) goto LAB_0010ba51;
                                 goto LAB_0010ba3b;
                              }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<String, HashMap<String, lsp::DocumentSymbol const*, HashMapHasherDefault,
   ...
   HashMapComparatorDefault<String>, DefaultTypedAllocator<HashMapElement<String,
   lsp::DocumentSymbol const*> > > const&, bool) */String * HashMap<String,HashMap<String,lsp::DocumentSymbol_const*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,lsp::DocumentSymbol_const*>>>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,HashMap<String,lsp::DocumentSymbol_const*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,lsp::DocumentSymbol_const*>>>>>>::insert(String * param_1, HashMap * param_2, bool, param_3) < String * HashMapHasherDefault < String * *this ;uint *puVar1int *piVar2void *pvVar3void *__sundefined1 auVar4[16]undefined1 auVar5[16]undefined1 auVar6[16]undefined1 auVar7[16]undefined1 auVar8[16]undefined1 auVar9[16]undefined1 auVar10[16]undefined1 auVar11[16]undefined1 auVar12[16]undefined1 auVar13[16]undefined1 auVar14[16]undefined1 auVar15[16]undefined1 auVar16[16]undefined1 auVar17[16]undefined1 auVar18[16]undefined1 auVar19[16]undefined1 auVar20[16]undefined1 auVar21[16]undefined1 auVar22[16]undefined1 auVar23[16]undefined1 auVar24[16]undefined1 auVar25[16]undefined1 auVar26[16]undefined1 auVar27[16]long *plVar28char cVar29uint uVar30ulong uVar31undefined8 uVar32void *__s_00long *plVar33long lVar34int *piVar35void *pvVar36HashMap<String,lsp::DocumentSymbol_const*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,lsp::DocumentSymbol_const*>>> *in_RCXuint uVar37undefined7 in_register_00000011String *pSVar38long lVar39long lVar40uint uVar41int iVar42ulong uVar43int *piVar44undefined8 uVar45char in_R8Buint uVar46uint uVar47ulong uVar48long lVar49undefined8 *puVar50uint uVar51undefined8 *puVar52long *plVar53long in_FS_OFFSETString local_90[8]undefined1 local_88[16]long local_78DocumentSymbol *local_70undefined1 local_68[16]undefined1 local_58[16]undefined8 local_48long local_40pSVar38 = (String*)CONCAT71(in_register_00000011, param_3);local_40 = *(long*)( in_FS_OFFSET + 0x28 );uVar41 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( param_2 + 0x28 ) * 4 );if (*(long*)( param_2 + 8 ) == 0) {
   uVar43 = (ulong)uVar41;
   uVar31 = uVar43 * 4;
   uVar48 = uVar43 * 8;
...
local_78 = 0;local_88 = (undefined1[16])0x0;if (*(long*)pSVar38 != 0) {
   CowData<char32_t>::_ref((CowData<char32_t>*)&local_78, (CowData*)pSVar38);
}
local_48 = 0;local_68 = (undefined1[16])0x0;local_58 = (undefined1[16])0x0;uVar31 = 1;if (5 < *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( in_RCX + 0x28 ) * 4 )) {
   do {
      if (*(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( in_RCX + 0x28 ) * 4 ) <= *(uint*)( hash_table_size_primes + uVar31 * 4 )) {
...
puVar50 = (undefined8*)0x0;iVar42 = *(int*)( in_RCX + 0x2c );if (*(int*)( in_RCX + 0x2c ) != 0) {
...
LAB_00110b20:plVar33 = (long*)operator_new(0x48, "");plVar33[2] = 0;*plVar33 = local_88._0_8_;plVar33[1] = local_88._8_8_;if (local_78 != 0) {
   CowData<char32_t>::_ref((CowData<char32_t>*)( plVar33 + 2 ), (CowData*)&local_78);
}
plVar33[8] = 0;*(undefined1(*) [16])( plVar33 + 4 ) = (undefined1[16])0x0;uVar41 = *(uint*)( hash_table_size_primes + ( local_48 & 0xffffffff ) * 4 );*(undefined1(*) [16])( plVar33 + 6 ) = (undefined1[16])0x0;lVar34 = 1;if (5 < uVar41) {
   do {
...
CowData<char32_t>::_unref((CowData<char32_t>*)&local_78);puVar50 = *(undefined8**)( param_2 + 0x20 );if (puVar50 == (undefined8*)0x0) {
...
uVar30 = String::hash();uVar41 = 1;if (uVar30 != 0) {
   uVar41 = uVar30;
}
lVar34 = *(long*)( param_2 + 0x10 );uVar47 = 0;lVar49 = *(long*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( param_2 + 0x28 ) * 8 );uVar30 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( param_2 + 0x28 ) * 4 );uVar31 = CONCAT44(0, uVar30);auVar8._8_8_ = 0;auVar8._0_8_ = (ulong)uVar41 * lVar49;auVar20._8_8_ = 0;auVar20._0_8_ = uVar31;lVar40 = SUB168(auVar8 * auVar20, 8);lVar39 = *(long*)( param_2 + 8 );puVar1 = (uint*)( lVar34 + lVar40 * 4 );iVar42 = SUB164(auVar8 * auVar20, 8);uVar37 = *puVar1;plVar28 = plVar33;while (uVar37 != 0) {
   auVar9._8_8_ = 0;
...
;*(long**)( lVar39 + lVar40 * 8 ) = plVar28;*puVar1 = uVar41;*(int*)( param_2 + 0x2c ) = *(int*)( param_2 + 0x2c ) + 1;LAB_00110dc0:*(long**)param_1 = plVar33;if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return param_1;}/* CowData<lsp::DocumentSymbol>::_unref() */void CowData<lsp::DocumentSymbol>::_unref(CowData<lsp::DocumentSymbol> *this) {
   long *plVar1;
   long *plVar2;
   long lVar3;
   long lVar4;

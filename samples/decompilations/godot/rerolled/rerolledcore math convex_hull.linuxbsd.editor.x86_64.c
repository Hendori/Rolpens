/* LocalVector<ConvexHullInternal::Point32, unsigned int, false, false>::resize(unsigned int) [clone
   .part.0] */void LocalVector<ConvexHullInternal::Point32,unsigned_int,false,false>::resize(uint param_1) {
   code *pcVar1;
...
/* get_vertex_copy(ConvexHullInternal::Vertex*, LocalVector<ConvexHullInternal::Vertex*, unsigned
   int, false, false>&) [clone .part.0] */uint get_vertex_copy(Vertex *param_1, LocalVector *param_2) {
   uint uVar1;
   uint uVar2;
   code *pcVar3;
   void *pvVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ConvexHullInternal::Int128::to_scalar() const [clone .isra.0] */undefined8 ConvexHullInternal::Int128::to_scalar(void) {
   long lVar1;
   long in_RSI;
   ulong in_RDI;
...
/* ConvexHullInternal::Int128::mul(long, long) */undefined1[16];ConvexHullInternal::Int128::mul(long param_1, long param_2) {
   byte bVar1;
   ulong uVar2;
   long lVar3;
   ulong uVar4;
...
/* ConvexHullInternal::Int128::mul(unsigned long, unsigned long) */undefined1[16];ConvexHullInternal::Int128::mul(ulong param_1, ulong param_2) {
   ulong uVar1;
   ulong uVar2;
   long lVar3;
   ulong uVar4;
...
/* ConvexHullInternal::Int128::TEMPNAMEPLACEHOLDERVALUE(long) const */undefined1  [16] __thiscallConvexHullInternal::Int128::operator *(Int128 *this, long param_1) {
   ulong uVar1;
   long lVar2;
   long lVar3;
...
/* ConvexHullInternal::Rational64::compare(ConvexHullInternal::Rational64 const&) const */ulong ConvexHullInternal::Rational64::compare(Rational64 *this, Rational64 *param_1) {
   uint uVar1;
   ulong uVar2;
   undefined1 auVar3[16];
   undefined1 auVar4[16];
   ...
   if (uVar1 == *(uint*)( param_1 + 0x10 )) {
      if (uVar1 != 0) {
         ...
         LAB_001003e0:return ( ulong )(uint) - (int)uVar2;
      }
...
/* ConvexHullInternal::Rational128::compare(long) const */int ConvexHullInternal::Rational128::compare(Rational128 *this, long param_1) {
   int iVar1;
   int iVar2;
   undefined1 auVar3[16];
   iVar2 = *(int*)( this + 0x20 );
...
/* ConvexHullInternal::Rational128::compare(ConvexHullInternal::Rational128 const&) const */int ConvexHullInternal::Rational128::compare(Rational128 *this, Rational128 *param_1) {
   int iVar1;
   ulong uVar2;
   ulong uVar3;
   ulong uVar4;
   ...
   if (CARRY8(auVar15._8_8_, uVar10)) {
      uVar3 = uVar3 + 1;
      LAB_00100686:if (( uVar8 == 0 ) || ( uVar4 = uVar4 != 0 )) goto LAB_001006bc;
      ...
      uVar3 = uVar3 + 1;
      uVar4 = uVar4 + uVar8;
      LAB_001006bc:if (uVar11 < uVar3) goto LAB_00100710;
      if (uVar3 < uVar11) {
         return iVar1;
      }
   ...
   LAB_00100710:return -iVar1;
}
/* ConvexHullInternal::new_edge_pair(ConvexHullInternal::Vertex*, ConvexHullInternal::Vertex*) */undefined1 (*) [16] __thiscallConvexHullInternal::new_edge_pair(ConvexHullInternal *this, Vertex *param_1, Vertex *param_2) {
   undefined4 uVar1;
   ...
   if (( param_1 == (Vertex*)0x0 ) || ( param_2 == (Vertex*)0x0 )) {
      _err_print_error("new_edge_pair", "core/math/convex_hull.cpp", 0x32b, "Assertion \"p_from && p_to\" failed.", 0, 0);
      iVar7 = *(int*)( this + 0x94 );
   }
 else {
      iVar7 = *(int*)( this + 0x94 );
 ...
 while ( plVar5 + uVar6 != plVar10 );
   ...
   *(uint*)( this + 0x94 ) = uVar6;
   pauVar2 = *(undefined1(**) [16])( plVar12[uVar6 >> ( ( byte ) * (undefined4*)( this + 0x98 ) & 0x1f )] + ( ulong )(uVar6 & *(uint*)( this + 0x9c )) * 8 );
 ...
 while ( plVar10 != plVar5 + uVar6 );
   ...
   uVar6 = iVar7 - 1;
   *(uint*)( this + 0x94 ) = uVar6;
   pauVar3 = *(undefined1(**) [16])( plVar12[uVar6 >> ( ( byte ) * (undefined4*)( this + 0x98 ) & 0x1f )] + ( ulong )(uVar6 & *(uint*)( this + 0x9c )) * 8 );
...
/* ConvexHullInternal::merge_projection(ConvexHullInternal::IntermediateHull&,
   ...
   ConvexHullInternal::Vertex*&) */undefined8 ConvexHullInternal::merge_projection(ConvexHullInternal *this, IntermediateHull *param_1, IntermediateHull *param_2, Vertex **param_3, Vertex **param_4) {
   int iVar1;
   Vertex *pVVar2;
   Vertex *pVVar3;
   Vertex *pVVar4;
   ...
   if (*(long*)( pVVar2 + 0x68 ) == *(long*)( pVVar16 + 0x68 )) {
      if (*(int*)( pVVar16 + 0x70 ) <= *(int*)( pVVar2 + 0x70 )) {
         _err_print_error("merge_projection", "core/math/convex_hull.cpp", 0x341, "Assertion \"v0->point.z < v1->point.z\" failed.", 0);
      }
      ...
      if (pVVar16 == pVVar26) {
         *param_3 = pVVar2;
         ...
         if (plVar5 != (long*)0x0) {
            plVar14 = (long*)*plVar5;
            if (plVar5 != plVar14) {
               _err_print_error("merge_projection", "core/math/convex_hull.cpp", 0x346, "Assertion \"v1->edges->next == v1->edges\" failed.", 0, 0);
               plVar14 = *(long**)( pVVar16 + 0x10 );
            }

            pVVar16 = *(Vertex**)( (long)plVar14 + 0x18 );
            if (*(long**)( pVVar16 + 0x10 ) != (long*)**(long**)( pVVar16 + 0x10 )) {
               _err_print_error("merge_projection", "core/math/convex_hull.cpp", 0x348, "Assertion \"v1->edges->next == v1->edges\" failed.", 0, 0);
            }
      ...
      *(Vertex**)( pVVar2 + 8 ) = pVVar26;
      if (*(Vertex**)param_2 == pVVar16) {
         if (( *(int*)( pVVar2 + 0x68 ) < *(int*)( pVVar26 + 0x68 ) ) || ( ( *(int*)( pVVar2 + 0x68 ) == *(int*)( pVVar26 + 0x68 ) && ( *(int*)( pVVar2 + 0x6c ) < *(int*)( pVVar26 + 0x6c ) ) ) )) {
      ...
      if (pVVar3 == pVVar16) {
         ...
         if (iVar22 < iVar1) {
            ...
            if (( iVar1 != iVar22 ) || ( iVar12 = *(int*)( pVVar2 + 0x6c ) * (int*)( pVVar2 + 0x6c ) <= iVar20 )) {
   ...
   LAB_00100ad7:pVVar2 = *(Vertex**)param_2;
   ...
   do {
      ...
      if (0 < iVar12) {
         ...
         LAB_00100bd8:pVVar11 = *(Vertex**)pVVar9;
         pVVar8 = pVVar9;
         pVVar13 = pVVar19;
         if (( pVVar9 != pVVar11 ) && ( iVar17 = *(int*)( pVVar11 + 0x6c ) - iVar21 ),pVVar9 = pVVar11,iVar17 < 1) goto LAB_00100cc8;
         do {
            ...
            while (true) {
               ...
               if (( ( iVar24 < 1 ) || ( -1 < iVar25 ) ) || ( ( iVar20 = iVar17 ),iVar15 != 0 && ( ( -1 < iVar15 || ( iVar15 * iVar27 <= iVar25 * iVar12 ) ) ) )) goto LAB_00100c50;
               while (true) {
                  iVar12 = iVar24;
                  iVar27 = iVar20 - iVar21;
                  if (bVar7) goto LAB_00100bd8;
                  LAB_00100d1d:pVVar11 = *(Vertex**)( pVVar9 + 8 );
                  pVVar8 = pVVar9;
                  pVVar13 = pVVar19;
                  if (( pVVar9 == pVVar11 ) || ( iVar17 = *(int*)( pVVar11 + 0x6c ) - iVar21 ),pVVar9 = pVVar11,0 < iVar17) goto LAB_00100d30;
                  LAB_00100cc8:iVar24 = ( *(int*)( pVVar9 + 0x68 ) - *(int*)( pVVar8 + 0x68 ) ) * iVar23;
...
;
               pVVar13 = pVVar19;
               if (bVar7) break;
               LAB_00100d30:pVVar19 = *(Vertex**)( pVVar13 + 8 );
               pVVar9 = pVVar8;
            }
;
         }
 while ( true );
      ...
      if (iVar12 != 0) {
         ...
         LAB_00100d68:pVVar13 = *(Vertex**)( pVVar19 + 8 );
         ...
         do {
            ...
            while (true) {
               ...
               iVar17 = ( *(int*)( pVVar13 + 0x68 ) - *(int*)( pVVar11 + 0x68 ) ) * iVar23;
               if (( ( -1 < iVar17 ) || ( iVar25 < 1 ) ) || ( ( iVar21 = iVar24 ),iVar15 != 0 && ( ( -1 < iVar15 || ( iVar15 * iVar27 <= iVar25 * iVar12 ) ) ) )) goto LAB_00100c50;
               LAB_00100e03:iVar12 = iVar17;
               iVar27 = iVar20 - iVar21;
               pVVar19 = pVVar13;
               if (bVar7) goto LAB_00100d68;
               LAB_00100e12:pVVar13 = *(Vertex**)pVVar19;
               if (( pVVar19 != pVVar13 ) && ( iVar17 = -1 < iVar17 )) break;
               LAB_00100e25:pVVar9 = pVVar11;
...
;
 ...
 while ( ( ( pVVar11 != pVVar13 ) && ( iVar27 == *(int*)( pVVar13 + 0x68 ) ) ) && ( bVar6 = *(int*)( pVVar13 + 0x6c ) <= iVar21 ),iVar21 = *(int*)( pVVar13 + 0x6c ),bVar6 );
      do {
         pVVar13 = pVVar8;
         if (bVar7) {
 ...
 while ( ( iVar27 == *(int*)( pVVar8 + 0x68 ) ) && ( bVar6 = iVar20 <= *(int*)( pVVar8 + 0x6c ) ),iVar20 = *(int*)( pVVar8 + 0x6c ),bVar6 );
      LAB_00100c50:if (bVar7) break;
      LAB_00100e36:iVar20 = *(int*)( pVVar2 + 0x6c );
      bVar7 = true;
      iVar23 = -1;
      pVVar11 = pVVar4;
      pVVar18 = pVVar9;
 ...
 while ( true );
   LAB_00100c6d:*(Vertex**)( pVVar9 + 8 ) = pVVar13;
   ...
   *param_3 = pVVar18;
   uVar10 = 1;
   LAB_00100cac:*param_4 = pVVar16;
   return uVar10;
}
/* ConvexHullInternal::get_orientation(ConvexHullInternal::Edge const*, ConvexHullInternal::Edge
   const*, ConvexHullInternal::Point32 const&, ConvexHullInternal::Point32 const&) */bool ConvexHullInternal::get_orientation(Edge *param_1, Edge *param_2, Point32 *param_3, Point32 *param_4) {
   long lVar1;
   long lVar2;
   long lVar3;
   long lVar4;
   ...
   if (*(long*)( *(long*)( param_1 + 0x10 ) + 0x18 ) != *(long*)( *(long*)( param_2 + 0x10 ) + 0x18 )) {
      _err_print_error("get_orientation", "core/math/convex_hull.cpp", 0x46e, "Assertion \"p_prev->reverse->target == p_next->reverse->target\" failed.", 0, 0);
   }
   ...
   if (*(Edge**)param_1 == param_2) {
      ...
      if (( lVar8 == 0 && lVar3 == 0 ) && lVar5 == 0) {
         _err_print_error("get_orientation", "core/math/convex_hull.cpp", 0x473, "Assertion \"!m.is_zero()\" failed.", 0, 0);
      }
 else {
         lVar5 = lVar5 * ( (long)*(int*)( param_4 + 4 ) * (long)*(int*)( param_3 + 8 ) - (long)*(int*)( param_3 + 4 ) * (long)*(int*)( param_4 + 8 ) ) + lVar3 * ( (long)*(int*)param_3 * (long)*(int*)( param_4 + 8 ) - (long)*(int*)param_4 * (long)*(int*)( param_3 + 8 ) ) + lVar8 * ( (long)*(int*)param_4 * (long)*(int*)( param_3 + 4 ) - (long)*(int*)( param_4 + 4 ) * (long)*(int*)param_3 );
         if (lVar5 != 0) {
            if (lVar5 < 1) {
               return true;
            }
      ...
      _err_print_error("get_orientation", "core/math/convex_hull.cpp", 0x475, "Assertion \"dot != 0\" failed.", 0, 0);
      return true;
   }
...
/* ConvexHullInternal::find_max_angle(bool, ConvexHullInternal::Vertex const*,
   ...
   ConvexHullInternal::Point64 const&, ConvexHullInternal::Rational64&) */Edge * __thiscall
   ...
   if (pEVar4 == (Edge*)0x0) {
      ...
      do {
         while (true) {
            ...
            lVar5 = (long)iVar8;
            lVar2 = (long)iVar9;
            lStack_50 = *(long*)param_4 * lVar5 + *(long*)( param_4 + 8 ) * lVar2 + *(long*)( param_4 + 0x10 ) * lVar3;
            local_58 = *(long*)param_5 * lVar5 + *(long*)( param_5 + 8 ) * lVar2 + *(long*)( param_5 + 0x10 ) * lVar3;
            local_48 = 1;
            if (local_58 < 1) break;
            LAB_00101353:if (0 < lStack_50) goto LAB_0010136b;
            LAB_0010141e:if (lStack_50 != 0) {
               local_48 = -local_48;
               lStack_50 = -lStack_50;
               goto LAB_0010136b;
            }
            ...
            lVar2 = lVar2 * *(int*)( param_3 + 4 ) + *(int*)param_3 * lVar5 + *(int*)( param_3 + 8 ) * lVar3;
            if (param_1) {
               if (-1 < lVar2) {
                  LAB_001014bf:_err_print_error("find_max_angle", "core/math/convex_hull.cpp", 0x491, "Assertion \"p_ccw ? (t.dot(p_s) < 0) : (t.dot(p_s) > 0)\" failed.", 0, 0);
               }

            }
 else if (lVar2 < 1) goto LAB_001014bf;
            LAB_001012b0:pEVar4 = *(Edge**)pEVar4;
            pEVar6 = pEVar7;
...
;
         ...
         pEVar7 = pEVar6;
         if (( iVar8 != 0 ) || ( iVar8 = get_orientation(pEVar6, pEVar4, param_3, (Point32*)&local_68) ),pEVar7 = pEVar4,( iVar8 == 2 ) == param_1) goto LAB_001012b0;
         pEVar4 = *(Edge**)pEVar4;
         pEVar7 = pEVar6;
      }
 while ( *(Edge**)( param_2 + 0x10 ) != pEVar4 );
   ...
   LAB_001013d8:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
...
/* ConvexHullInternal::find_edge_for_coplanar_faces(ConvexHullInternal::Vertex*,
   ...
   ConvexHullInternal::Vertex const*, ConvexHullInternal::Vertex const*) */void ConvexHullInternal::find_edge_for_coplanar_faces(ConvexHullInternal *this, Vertex *param_1, Vertex *param_2, Edge **param_3, Edge **param_4, Vertex *param_5, Vertex *param_6) {
   int iVar1;
   int iVar2;
   int iVar3;
   int iVar4;
   ...
   if (( pEVar7 != (Edge*)0x0 ) && ( lVar21 = *(long*)( pEVar7 + 0x18 ) ),lVar20 != *(int*)( lVar21 + 0x68 ) * lVar15 + *(int*)( lVar21 + 0x6c ) * lVar12 + *(int*)( lVar21 + 0x70 ) * lVar24) {
      _err_print_error("find_edge_for_coplanar_faces", "core/math/convex_hull.cpp", 0x4b0, "Assertion \"!start1 || (start1->target->point.dot(normal) == dist)\" failed.", 0, 0);
   }
   ...
   if (( lVar21 == 0 && lVar26 == 0 ) && lVar27 == 0) {
      _err_print_error("find_edge_for_coplanar_faces", "core/math/convex_hull.cpp", 0x4b2, "Assertion \"!perp.is_zero()\" failed.", 0, 0);
   }
   ...
   if (( pEVar14 != (Edge*)0x0 ) && ( *(Vertex**)( pEVar14 + 0x18 ) != param_5 )) {
      while (true) {
         ...
         lVar16 = *(int*)( lVar16 + 0x68 ) * lVar15 + *(int*)( lVar16 + 0x6c ) * lVar12 + *(int*)( lVar16 + 0x70 ) * lVar24;
         if (lVar20 != lVar16 && lVar16 <= lVar20) break;
         if (lVar20 == lVar16) {
            if (*(int*)( pEVar14 + 0x28 ) == *(int*)( this + 0x160 )) break;
         }
 else {
            _err_print_error("find_edge_for_coplanar_faces", "core/math/convex_hull.cpp", 0x4bf, "Assertion \"e->target->point.dot(normal) == dist\" failed.", 0, 0);
            if (*(int*)( pEVar14 + 0x28 ) == *(int*)( this + 0x160 )) break;
         }
         ...
         if (( lVar16 <= lVar30 ) || ( *param_3 = pEVar14 ),lVar30 = lVar16,local_110 = iVar2,iVar9 = iVar4,iVar1 = iVar5,pVVar11 == param_5) break;
      }
;
   }
   ...
   if (( pEVar14 != (Edge*)0x0 ) && ( *(Vertex**)( pEVar14 + 0x18 ) != param_6 )) {
      while (true) {
         ...
         lVar17 = *(int*)( lVar17 + 0x68 ) * lVar15 + *(int*)( lVar17 + 0x6c ) * lVar12 + *(int*)( lVar17 + 0x70 ) * lVar24;
         if (lVar20 != lVar17 && lVar17 <= lVar20) break;
         if (lVar20 == lVar17) {
            if (*(int*)( pEVar14 + 0x28 ) == *(int*)( this + 0x160 )) break;
         }
 else {
            _err_print_error("find_edge_for_coplanar_faces", "core/math/convex_hull.cpp", 0x4d4, "Assertion \"e->target->point.dot(normal) == dist\" failed.", 0, 0);
            if (*(int*)( pEVar14 + 0x28 ) == *(int*)( this + 0x160 )) break;
         }
         ...
         if (( lVar17 <= lVar16 ) || ( *param_4 = pEVar14 ),lVar16 = lVar17,local_f8 = iVar2,iVar8 = iVar4,iVar3 = iVar5,pVVar11 == param_6) break;
      }
;
   }
   ...
   if (lVar16 < 1) {
      if (lVar16 != 0) {
         LAB_00101d2d:while (true) {
            lVar20 = ( local_f8 - local_110 ) * lVar25 + ( iVar8 - iVar9 ) * lVar28 + ( iVar3 - iVar1 ) * lVar29;
            pEVar14 = *param_4;
            if (( ( pEVar14 == (Edge*)0x0 ) || ( *(Vertex**)( pEVar14 + 0x18 ) == param_6 ) ) || ( pEVar22 = *(Edge**)( *(long*)( pEVar14 + 8 ) + 0x10 ) * (int*)( pEVar22 + 0x28 ) <= *(int*)( this + 0x160 ) )) break;
            ...
            if (lVar30 < 1) break;
            LAB_00101ee4:if (pEVar14 == pEVar7) {
               pEVar22 = (Edge*)0x0;
            }
...
;
         pEVar14 = *param_3;
         if (( ( pEVar14 == (Edge*)0x0 ) || ( *(Vertex**)( pEVar14 + 0x18 ) == param_5 ) ) || ( pEVar22 = *(Edge**)( *(long*)( pEVar14 + 0x10 ) + 8 ) * (int*)( pEVar22 + 0x28 ) <= *(int*)( this + 0x160 ) )) goto LAB_00101cc4;
         lVar30 = *(long*)( pEVar22 + 0x18 );
         iVar2 = *(int*)( lVar30 + 0x6c );
         iVar4 = *(int*)( lVar30 + 0x70 );
         iVar5 = *(int*)( lVar30 + 0x68 );
      ...
      LAB_00101cc4:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }

      LAB_00102567:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }

   LAB_00101a36:do {
      lVar20 = ( local_f8 - local_110 ) * lVar25 + ( iVar8 - iVar9 ) * lVar28 + ( iVar3 - iVar1 ) * lVar29;
      pEVar14 = *param_3;
      if (( ( pEVar14 != (Edge*)0x0 ) && ( *(Vertex**)( pEVar14 + 0x18 ) != param_5 ) ) && ( pEVar22 = *(Edge**)( *(long*)pEVar14 + 0x10 ) * (int*)( this + 0x160 ) < *(int*)( pEVar22 + 0x28 ) )) {
         lVar30 = *(long*)( pEVar22 + 0x18 );
         iVar2 = *(int*)( lVar30 + 0x6c );
         iVar4 = *(int*)( lVar30 + 0x70 );
         iVar5 = *(int*)( lVar30 + 0x68 );
         ...
         if (lVar17 == 0) {
            if (lVar30 < 0) {
               LAB_001021e4:lVar16 = ( local_f8 - iVar5 ) * lVar27 + ( iVar8 - iVar2 ) * lVar26 + ( iVar3 - iVar4 ) * lVar21;
               if (pEVar14 == pEVar6) {
                  pEVar22 = (Edge*)0x0;
               }
      ...
      pEVar14 = *param_4;
      if (( ( pEVar14 == (Edge*)0x0 ) || ( *(Vertex**)( pEVar14 + 0x18 ) == param_6 ) ) || ( pEVar22 = (Edge*)**(long**)( pEVar14 + 0x10 ) * (int*)( pEVar22 + 0x28 ) <= *(int*)( this + 0x160 ) )) goto LAB_00101cc4;
      lVar30 = *(long*)( pEVar22 + 0x18 );
      iVar2 = *(int*)( lVar30 + 0x6c );
      iVar4 = *(int*)( lVar30 + 0x70 );
      iVar5 = *(int*)( lVar30 + 0x68 );
      ...
      if (lVar23 != 0) {
         if (( pEVar14 != pEVar7 ) || ( -1 < lVar23 )) {
            if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
               ...
               LAB_0010243f:_err_print_error("find_edge_for_coplanar_faces", "core/math/convex_hull.cpp", uVar19, pcVar13, 0, 0);
               return;
            }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ConvexHullInternal::merge(ConvexHullInternal::IntermediateHull&,
   ConvexHullInternal::IntermediateHull&) [clone .part.0] */void ConvexHullInternal::merge(ConvexHullInternal *this, IntermediateHull *param_1, IntermediateHull *param_2) {
   uint uVar1;
   undefined4 uVar2;
   uint uVar3;
   Edge *pEVar4;
   ...
   *(int*)( this + 0x160 ) = *(int*)( this + 0x160 ) + -1;
   ...
   if (cVar12 == '\0') {
      ...
      iVar34 = (int)( ( ulong ) * (undefined8*)( local_e0 + 0x68 ) >> 0x20 ) - (int)( ( ulong ) * (undefined8*)( local_e8 + 0x68 ) >> 0x20 );
      ...
      if (( lVar25 == 0 && lVar29 == 0 ) && lVar28 == 0) {
         _err_print_error("merge", "core/math/convex_hull.cpp", 0x558, "Assertion \"!t.is_zero()\" failed.", 0);
      }
      ...
      if (*(Edge**)( pVVar27 + 0x10 ) == (Edge*)0x0) {
         ...
         do {
            while (true) {
               ...
               if (lVar23 < 1) break;
               _err_print_error("merge", "core/math/convex_hull.cpp", 0x55f, "Assertion \"dot <= 0\" failed.", 0);
               LAB_001026f0:pEVar16 = *(Edge**)pEVar18;
               if (*(Edge**)pEVar18 == *(Edge**)( pVVar27 + 0x10 )) goto LAB_00102770;
            }
;
            if (( lVar23 != 0 ) || ( lVar15 * lVar29 + lVar21 * lVar25 + ( *(int*)( lVar26 + 0x70 ) - *(int*)( pVVar27 + 0x70 ) ) * lVar28 < 1 )) goto LAB_001026f0;
            if (pEVar17 != (Edge*)0x0) {
 ...
 while ( *(Edge**)pEVar18 != *(Edge**)( pVVar27 + 0x10 ) );
         LAB_00102770:local_98 = (Edge*)0x0;
         pEVar16 = *(Edge**)( pVVar32 + 0x10 );
         pEVar18 = pEVar17;
         if (pEVar16 == (Edge*)0x0) {
            joined_r0x00103928:if (pEVar18 == (Edge*)0x0) goto LAB_00102919;
         }
 else {
            LAB_0010279f:local_130 = (Point32*)local_58;
            ...
            do {
               while (true) {
                  ...
                  lVar23 = lVar15 * lVar30 + lVar21 * lVar31;
                  if (lVar23 < 1) break;
                  _err_print_error("merge", "core/math/convex_hull.cpp", 0x56e, "Assertion \"dot <= 0\" failed.", 0);
                  LAB_001027f8:pEVar16 = *(Edge**)pEVar18;
                  if (*(Edge**)pEVar18 == *(Edge**)( pVVar32 + 0x10 )) goto LAB_00102880;
               }
;
               if (( lVar23 != 0 ) || ( lVar15 * lVar29 + lVar21 * lVar25 + ( *(int*)( lVar26 + 0x70 ) - *(int*)( pVVar32 + 0x70 ) ) * lVar28 < 1 )) goto LAB_001027f8;
 ...
 while ( *(Edge**)pEVar18 != *(Edge**)( pVVar32 + 0x10 ) );
            LAB_00102880:pEVar18 = local_98;
            if (pEVar17 == (Edge*)0x0) goto joined_r0x00103928;
         }

         find_edge_for_coplanar_faces(this, pVVar27, pVVar32, &local_b8, &local_98, (Vertex*)0x0, (Vertex*)0x0);
      ...
      LAB_00102919:local_c8 = *(int*)( local_100 + 0x68 );
   ...
   while (true) {
      ...
      pEVar17 = (Edge*)find_max_angle(this, false, pVVar27, (Point32*)&local_c8, local_178, local_170, (Rational64*)local_138);
      local_58 = (undefined1[16])0x0;
      local_48 = 0;
      pEVar18 = (Edge*)find_max_angle(this, true, pVVar32, (Point32*)&local_c8, local_178, local_170, (Rational64*)local_130);
      if (pEVar17 == (Edge*)0x0 && pEVar18 == (Edge*)0x0) break;
      if (pEVar17 == (Edge*)0x0) {
         iVar14 = 1;
         iVar11 = 1;
         if (bVar8) {
            LAB_00102cc0:pEVar19 = (Edge*)new_edge_pair(this, pVVar27, pVVar32);
            pEVar22 = pEVar19;
            ...
            *(Edge**)( pEVar22 + 8 ) = pEVar16;
            ...
            LAB_00102f8f:iVar14 = iVar11;
            if (( -1 < local_48 ) || ( local_58._8_8_ != 0 )) goto LAB_00102cc0;
            pEVar22 = pEVar16;
            if (iVar14 != 0) goto LAB_00102fc6;
            LAB_00102d2d:local_d8 = pEVar17;
            local_d0 = pEVar18;
            find_edge_for_coplanar_faces(this, pVVar27, pVVar32, &local_d8, &local_d0, (Vertex*)0x0, (Vertex*)0x0);
            iVar14 = 0;
            pEVar19 = local_d0;
            pEVar22 = pEVar16;
            if (local_d0 != (Edge*)0x0) {
               joined_r0x00102fdb:local_d0 = pEVar19;
               if (local_160 == (undefined8*)0x0) {
                  local_f8 = pEVar18;
                  if (pEVar22 != (Edge*)0x0) {
                     local_160 = *(undefined8**)( pEVar18 + 8 );
                     if (*(long*)( local_160[2] + 0x18 ) != *(long*)( *(long*)( local_128 + 0x10 ) + 0x18 )) {
                        _err_print_error(&_LC38, "core/math/convex_hull.cpp", 0x1e7, "Assertion \"reverse->target == n->reverse->target\" failed.", 0, 0);
                     }

                     *local_160 = local_128;
                     local_f8 = local_128;
                     LAB_00102dd2:lVar25 = *(long*)( pEVar18 + 0x10 );
                  ...
                  while (pEVar18 != pEVar16) {
                     ...
                     if (( lVar25 == 0 ) || ( lVar28 = lVar28 == 0 )) {
                        _err_print_error("remove_edge_pair", "core/math/convex_hull.cpp", 0x271, "Assertion \"p_edge->target && r->target\" failed.", 0, 0);
                        lVar28 = plVar6[3];
                        lVar25 = *(long*)( pEVar16 + 0x18 );
                     }
                     ...
                     *(long**)( lVar25 + 0x10 ) = plVar20;
                     ...
                     lVar25 = *(long*)( *(long*)( this + 0x88 ) + ( ulong )(uVar1 + 1 >> ( ( byte ) * (undefined4*)( this + 0x98 ) & 0x1f )) * 8 );
                     *(Edge**)( *(long*)( *(long*)( this + 0x88 ) + ( ulong )(uVar1 >> ( ( byte ) * (undefined4*)( this + 0x98 ) & 0x1f )) * 8 ) + ( ulong )(uVar1 & uVar3) * 8 ) = pEVar16;
...
;
            ...
            LAB_00102a29:if (local_d8 != (Edge*)0x0) {
               if (local_110 == 0) goto LAB_00102a3e;
               LAB_00103150:pEVar22 = local_d8;
               ...
               while (pEVar17 != pEVar18) {
                  ...
                  if (pEVar18 == pEVar4) {
                     ...
                     *(Edge**)( lVar28 + 0x10 ) = pEVar4;
                     ...
                     LAB_001031ac:puVar7 = (undefined8*)plVar6[1];
                  ...
                  *(long**)( lVar25 + 0x10 ) = plVar20;
                  ...
                  uVar3 = *(uint*)( this + 0x9c );
                  *(Edge**)( *(long*)( lVar25 + ( ulong )(uVar1 >> ( (byte)uVar2 & 0x1f )) * 8 ) + ( ulong )(uVar1 & uVar3) * 8 ) = pEVar18;
                  *(long**)( *(long*)( lVar25 + ( ulong )(uVar1 + 1 >> ( (byte)uVar2 & 0x1f )) * 8 ) + ( ulong )(uVar3 & uVar1 + 1) * 8 ) = plVar6;
                  *(int*)( this + 0x170 ) = *(int*)( this + 0x170 ) + -1;
                  *(uint*)( this + 0x94 ) = uVar1 + 2;
                  pEVar18 = pEVar19;
               }
;
               if (local_180 != (Edge*)0x0) {
                  if (*(long*)( *(long*)( local_108 + 0x10 ) + 0x18 ) != *(long*)( *(long*)( local_110 + 0x10 ) + 0x18 )) {
                     _err_print_error(&_LC38, "core/math/convex_hull.cpp", 0x1e7, "Assertion \"reverse->target == n->reverse->target\" failed.", 0, 0);
                  }
         ...
         iVar14 = -1;
         if (( bVar8 ) || ( iVar11 = -1 < local_68 )) goto LAB_00102cc0;
         LAB_00103116:iVar14 = iVar11;
         if (local_78._8_8_ != 0) goto LAB_00102cc0;
         local_d8 = pEVar17;
         local_d0 = pEVar18;
         if (local_110 != 0) goto LAB_00103150;
         LAB_00102a3e:pEVar22 = local_d8;
         local_f0 = pEVar17;
         if (local_180 != (Edge*)0x0) {
            lVar25 = *(long*)pEVar17;
            if (*(long*)( *(long*)( local_108 + 0x10 ) + 0x18 ) != *(long*)( *(long*)( lVar25 + 0x10 ) + 0x18 )) {
               _err_print_error(&_LC38, "core/math/convex_hull.cpp", 0x1e7, "Assertion \"reverse->target == n->reverse->target\" failed.", 0, 0);
            }
            ...
            *(Edge**)( lVar25 + 8 ) = local_108;
            LAB_00102a80:if (*(long*)( *(long*)( pEVar17 + 0x10 ) + 0x18 ) != *(long*)( *(long*)( local_180 + 0x10 ) + 0x18 )) {
               _err_print_error(&_LC38, "core/math/convex_hull.cpp", 0x1e7, "Assertion \"reverse->target == n->reverse->target\" failed.", 0, 0);
            }
         ...
         LAB_00102aaa:local_180 = (Edge*)0x0;
      ...
      joined_r0x00102e46:if (( local_120 == pVVar27 ) && ( local_100 == pVVar32 )) {
         if (local_110 != 0) {
            pEVar17 = *(Edge**)( local_110 + 8 );
            goto joined_r0x00102e96;
         }

         if (*(long*)( *(long*)( local_108 + 0x10 ) + 0x18 ) != *(long*)( *(long*)( local_180 + 0x10 ) + 0x18 )) {
            _err_print_error(&_LC38, "core/math/convex_hull.cpp", 0x1e7, "Assertion \"reverse->target == n->reverse->target\" failed.", 0, 0);
         }
...
;
   ...
   *(long*)( pVVar32 + 0x10 ) = lVar25;
   LAB_00103408:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }

   return;
   joined_r0x00102e96:if (pEVar17 == local_f0) goto LAB_00103687;
   ...
   if (pEVar17 == pEVar22) {
      ...
      *(Edge**)( lVar28 + 0x10 ) = pEVar22;
      ...
      LAB_00102ec4:puVar7 = (undefined8*)plVar6[1];
      plVar20[1] = (long)puVar7;
      *puVar7 = plVar20;
   }
   ...
   *(long**)( lVar25 + 0x10 ) = plVar20;
   ...
   lVar25 = *(long*)( this + 0x88 );
   uVar3 = *(uint*)( this + 0x9c );
   *(Edge**)( *(long*)( lVar25 + ( ulong )(uVar1 >> ( (byte)uVar2 & 0x1f )) * 8 ) + ( ulong )(uVar1 & uVar3) * 8 ) = pEVar17;
   *(long**)( *(long*)( lVar25 + ( ulong )(uVar1 + 1 >> ( (byte)uVar2 & 0x1f )) * 8 ) + ( ulong )(uVar3 & uVar1 + 1) * 8 ) = plVar6;
   *(int*)( this + 0x170 ) = *(int*)( this + 0x170 ) + -1;
   *(uint*)( this + 0x94 ) = uVar1 + 2;
   pEVar17 = pEVar18;
   goto joined_r0x00102e96;
   LAB_00103687:if (local_180 != (Edge*)0x0) {
      if (*(long*)( *(long*)( local_108 + 0x10 ) + 0x18 ) != *(long*)( *(long*)( local_110 + 0x10 ) + 0x18 )) {
         _err_print_error(&_LC38, "core/math/convex_hull.cpp", 0x1e7, "Assertion \"reverse->target == n->reverse->target\" failed.", 0, 0);
      }
      ...
      *(long*)local_108 = local_110;
      *(Edge**)( local_110 + 8 ) = local_108;
      if (*(long*)( *(long*)( local_f0 + 0x10 ) + 0x18 ) != *(long*)( *(long*)( local_180 + 0x10 ) + 0x18 )) {
         _err_print_error(&_LC38, "core/math/convex_hull.cpp", 0x1e7, "Assertion \"reverse->target == n->reverse->target\" failed.", 0, 0);
      }
   ...
   LAB_001036fd:if (local_160 == (undefined8*)0x0) {
...
;
      if (pEVar16 != (Edge*)0x0) {
         ...
         *local_160 = local_128;
         *(undefined8**)( local_128 + 8 ) = local_160;
         if (*(long*)( *(long*)( pEVar16 + 0x10 ) + 0x18 ) != *(long*)( *(long*)( local_f8 + 0x10 ) + 0x18 )) {
            _err_print_error(&_LC38, "core/math/convex_hull.cpp", 0x1e7, "Assertion \"reverse->target == n->reverse->target\" failed.", 0, 0);
         }
...
/* ConvexHullInternal::compute_internal(int, int, ConvexHullInternal::IntermediateHull&) */void ConvexHullInternal::compute_internal(ConvexHullInternal *this, int param_1, int param_2, IntermediateHull *param_3) {
   int iVar1;
   int iVar2;
   int iVar3;
   uint uVar4;
      ...
      if (iVar7 != 0) {
         ...
         if (uVar11 - 1 < uVar4) {
            ...
            if (param_2 <= (int)uVar11) {
               LAB_00103d08:compute_internal(this, param_1, uVar11, param_3);
               local_58 = (undefined1[16])0x0;
            ...
            if (uVar11 < uVar4) {
               ...
               do {
                  lVar9 = *plVar14;
                  if (( ( ( *(int*)( lVar5 + 0x68 ) != *(int*)( lVar9 + 0x68 ) ) || ( *(int*)( lVar5 + 0x6c ) != *(int*)( lVar9 + 0x6c ) ) ) || ( *(int*)( lVar5 + 0x70 ) != *(int*)( lVar9 + 0x70 ) ) ) || ( uVar16 = param_2 == uVar16 )) goto LAB_00103d08;
                  uVar10 = (ulong)uVar16;
                  plVar14 = plVar14 + 1;
               }
 while ( uVar16 < uVar4 );
   ...
   if (uVar4 <= (uint)param_1) {
      LAB_00103dd2:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, uVar10, uVar15, "p_index", "count", "", false, true);
      _err_flush_stdout();
      /* WARNING: Does not return */
   ...
   if (iVar7 == iVar1) {
      ...
      if (iVar1 == iVar7) {
         ...
         pVVar18 = pVVar13;
         if (( iVar7 <= *(int*)( pVVar17 + 0x70 ) ) && ( pVVar18 = pVVar17 ),pVVar8 = pVVar13,iVar7 == *(int*)( pVVar17 + 0x70 )) {
            _err_print_error("compute_internal", "core/math/convex_hull.cpp", 0x3eb, "Assertion \"v->point.z < w->point.z\" failed.", 0, 0);
         }
   ...
   *(long*)( pVVar17 + 0x10 ) = lVar5;
   LAB_00103b99:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* ConvexHullInternal::merge(ConvexHullInternal::IntermediateHull&,
   ConvexHullInternal::IntermediateHull&) */void ConvexHullInternal::merge(ConvexHullInternal *this, IntermediateHull *param_1, IntermediateHull *param_2) {
   undefined8 uVar1;
   if (*(long*)( param_2 + 8 ) == 0) {
      return;
   }
...
/* ConvexHullInternal::to_gd_vector(ConvexHullInternal::Point32 const&) */undefined1  [16] __thiscallConvexHullInternal::to_gd_vector(ConvexHullInternal *this, Point32 *param_1) {
   undefined8 uVar1;
   long in_FS_OFFSET;
   undefined1 auVar2[16];
   float local_30[6];
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ConvexHullInternal::get_gd_normal(ConvexHullInternal::Face*) */undefined1  [16] __thiscallConvexHullInternal::get_gd_normal(ConvexHullInternal *this, Face *param_1) {
   long lVar1;
   undefined8 uVar2;
   long in_FS_OFFSET;
   float fVar3;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ConvexHullInternal::get_coordinates(ConvexHullInternal::Vertex const*) */undefined1  [16] __thiscallConvexHullInternal::get_coordinates(ConvexHullInternal *this, Vertex *param_1) {
   undefined8 uVar1;
   ulong uVar2;
   long lVar3;
   ...
   auVar10._4_4_ = (float)( ( ulong ) * (undefined8*)( this + 0xc ) >> 0x20 ) + (float)( (ulong)uVar1 >> 0x20 ) * SUB84(local_30._0_8_, 4);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ConvexHullInternal::shift_face(ConvexHullInternal::Face*, float,
   LocalVector<ConvexHullInternal::Vertex*, unsigned int, false, false>&) */undefined8 ConvexHullInternal::shift_face(ConvexHullInternal *this, Face *param_1, float param_2, LocalVector *param_3) {
   undefined4 uVar1;
   Vertex *pVVar2;
   code *pcVar3;
   bool bVar4;
   ...
   if (( iVar34 != 0 || iVar33 != 0 ) || iVar20 != 0) {
      lVar30 = (long)*(int*)( param_1 + 0x28 ) * (long)*(int*)( param_1 + 0x3c ) - (long)*(int*)( param_1 + 0x2c ) * (long)*(int*)( param_1 + 0x38 );
      iVar34 = iVar34 + *(int*)( param_1 + 0x20 );
      lVar11 = (long)*(int*)( param_1 + 0x2c ) * (long)*(int*)( param_1 + 0x40 ) - (long)*(int*)( param_1 + 0x3c ) * (long)*(int*)( param_1 + 0x30 );
      lVar25 = (long)*(int*)( param_1 + 0x38 ) * (long)*(int*)( param_1 + 0x30 ) - (long)*(int*)( param_1 + 0x28 ) * (long)*(int*)( param_1 + 0x40 );
      iVar20 = iVar20 + *(int*)( param_1 + 0x18 );
      iVar33 = iVar33 + *(int*)( param_1 + 0x1c );
      lVar27 = *(int*)( param_1 + 0x18 ) * lVar11 + *(int*)( param_1 + 0x1c ) * lVar25 + *(int*)( param_1 + 0x20 ) * lVar30;
      lVar11 = lVar11 * iVar20 + iVar33 * lVar25 + iVar34 * lVar30;
      if (lVar27 < lVar11) {
         _err_print_error("shift_face", "core/math/convex_hull.cpp", 0x708, "Assertion \"shifted_dot <= orig_dot\" failed.", 0, 0);
      }
         ...
         if (iVar6 < 0) {
            do {
               ...
               if (0 < iVar6) {
                  _err_print_error("shift_face", "core/math/convex_hull.cpp", 0x73f, "Assertion \"dot.compare(orig_dot) <= 0\" failed.", 0, 0);
               }
 ...
 while ( lVar25 != *(long*)( lVar12 + 8 ) );
         ...
         do {
            while (true) {
               ...
               if (0 < iVar7) {
                  _err_print_error("shift_face", "core/math/convex_hull.cpp", 0x721, "Assertion \"dot.compare(orig_dot) <= 0\" failed.", 0, 0);
               }
...
;
 ...
 while ( lVar25 != *plVar13 );
      ...
      LAB_00104ac8:uVar19 = 0;
      goto LAB_00104aca;
   }

   LAB_00106b12:uVar19 = 1;
   LAB_00104aca:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar19;
   }

   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   LAB_00104c4b:if (iVar6 == 0) {
 ...
 while ( puVar16 != puVar28 );
      ...
      LAB_00104c9f:local_168 = (long*)0x0;
      local_1c8 = (long*)0x0;
      local_140 = 0;
      if (iVar6 == 0) goto LAB_001056ff;
      LAB_00104cd8:lVar25 = lVar30;
      lVar27 = lVar30;
      iVar7 = iVar6;
      if (local_140 == 0) goto LAB_00104cf2;
      LAB_00104ce9:lVar25 = lVar30;
      lVar27 = local_140;
      iVar7 = iVar6;
      if (lVar30 != local_140) {
         LAB_00104cf2:local_140 = lVar27;
         lVar27 = *(long*)( lVar25 + 0x10 );
         lVar30 = lVar27;
         while (true) {
            lVar30 = *(long*)( *(long*)( lVar30 + 0x10 ) + 8 );
            if (lVar30 == lVar27) {
               _err_print_error("shift_face", "core/math/convex_hull.cpp", 0x7b4, "Assertion \"e != intersection->reverse\" failed.", 0, 0);
            }
...
;
         if (iVar6 == 0) {
            if (iVar7 != 0) {
               ...
               LAB_0010583e:puVar16 = *(undefined8**)( lVar25 + 8 );
            ...
            lVar42 = (long)*(int*)( lVar12 + 0x28 ) * (long)*(int*)( lVar12 + 0x3c ) - (long)*(int*)( lVar12 + 0x2c ) * (long)*(int*)( lVar12 + 0x38 );
            lVar21 = (long)*(int*)( lVar12 + 0x40 ) * (long)*(int*)( lVar12 + 0x2c ) - (long)*(int*)( lVar12 + 0x3c ) * (long)*(int*)( lVar12 + 0x30 );
            lVar26 = plVar18[4];
            lVar41 = (long)*(int*)( lVar12 + 0x38 ) * (long)*(int*)( lVar12 + 0x30 ) - (long)*(int*)( lVar12 + 0x28 ) * (long)*(int*)( lVar12 + 0x40 );
            lVar36 = (long)*(int*)( lVar26 + 0x28 ) * (long)*(int*)( lVar26 + 0x3c ) - (long)*(int*)( lVar26 + 0x2c ) * (long)*(int*)( lVar26 + 0x38 );
            lVar35 = (long)*(int*)( lVar26 + 0x38 ) * (long)*(int*)( lVar26 + 0x30 ) - (long)*(int*)( lVar26 + 0x28 ) * (long)*(int*)( lVar26 + 0x40 );
            lVar31 = (long)*(int*)( lVar26 + 0x40 ) * (long)*(int*)( lVar26 + 0x2c ) - (long)*(int*)( lVar26 + 0x3c ) * (long)*(int*)( lVar26 + 0x30 );
            lVar22 = lVar41 * *(int*)( param_1 + 0x2c ) + lVar21 * *(int*)( param_1 + 0x28 ) + lVar42 * *(int*)( param_1 + 0x30 );
            lVar46 = lVar41 * *(int*)( param_1 + 0x3c ) + lVar21 * *(int*)( param_1 + 0x38 ) + lVar42 * *(int*)( param_1 + 0x40 );
            lVar32 = *(int*)( param_1 + 0x2c ) * lVar35 + *(int*)( param_1 + 0x28 ) * lVar31 + *(int*)( param_1 + 0x30 ) * lVar36;
            lVar27 = *(int*)( param_1 + 0x3c ) * lVar35 + *(int*)( param_1 + 0x38 ) * lVar31 + *(int*)( param_1 + 0x40 ) * lVar36;
            lVar21 = ( *(int*)( lVar12 + 0x20 ) - iVar34 ) * lVar42 + ( *(int*)( lVar12 + 0x1c ) - iVar33 ) * lVar41 + ( *(int*)( lVar12 + 0x18 ) - iVar20 ) * lVar21;
            lVar12 = ( *(int*)( lVar26 + 0x20 ) - iVar34 ) * lVar36 + ( *(int*)( lVar26 + 0x18 ) - iVar20 ) * lVar31 + ( *(int*)( lVar26 + 0x1c ) - iVar33 ) * lVar35;
            auVar50 = Int128::mul(lVar46, lVar32);
            auVar51 = Int128::mul(lVar22, lVar27);
            uVar23 = auVar51._0_8_ - auVar50._0_8_;
            lVar26 = ( ( auVar51._8_8_ + -1 ) - auVar50._8_8_ ) + ( ulong )(uVar23 < auVar51._0_8_) + ( ulong )(auVar50._0_8_ == 0);
            local_88 = uVar23;
            lStack_80 = lVar26;
            if (uVar23 == 0 && lVar26 == 0) {
               _err_print_error("shift_face", "core/math/convex_hull.cpp", 0x7db, "Assertion \"det.get_sign() != 0\" failed.", 0, 0);
            }
            ...
            if (iVar10 == 0) {
               ...
               *(undefined8*)( this + 0x18 ) = uVar19;
               uVar19 = Memory::realloc_static(*(void**)( this + 0x20 ), ( ulong ) * (uint*)( this + 0x28 ) << 3, false);
 ...
 while ( uVar37 != uVar8 );
            ...
            *(uint*)( this + 0x2c ) = uVar8;
            uVar5 = _UNK_0010b8a8;
            uVar19 = __LC53;
            pauVar40 = *(undefined1(**) [16])( plVar15[uVar8 >> ( ( byte ) * (undefined4*)( this + 0x30 ) & 0x1f )] + ( ulong )(uVar8 & *(uint*)( this + 0x34 )) * 8 );
            ...
            *(undefined8*)pauVar40[7] = uVar5;
            ...
            lVar35 = (ulong)CARRY8(auVar50._0_8_, uVar38) + (ulong)CARRY8(auVar52._0_8_, uVar37) + ( ( ( auVar52._8_8_ + -2 + auVar54._8_8_ + auVar50._8_8_ ) - auVar53._8_8_ ) - auVar51._8_8_ ) + ( ulong )(auVar51._0_8_ == 0) + ( ulong )(auVar53._0_8_ == 0) + ( ulong )(uVar37 < auVar54._0_8_) + ( ulong )(uVar38 < uVar43);
            ...
            lVar31 = (ulong)CARRY8(auVar50._0_8_, uVar38) + (ulong)CARRY8(auVar52._0_8_, uVar37) + ( ( ( auVar52._8_8_ + -2 + auVar54._8_8_ + auVar50._8_8_ ) - auVar53._8_8_ ) - auVar51._8_8_ ) + ( ulong )(auVar51._0_8_ == 0) + ( ulong )(auVar53._0_8_ == 0) + ( ulong )(uVar37 < auVar54._0_8_) + ( ulong )(uVar38 < uVar43);
            ...
            *(ulong*)( pauVar40[3] + 8 ) = uVar39;
            lVar27 = (ulong)CARRY8(auVar52._0_8_, uVar38) + ( ( ( auVar52._8_8_ + -2 + auVar54._8_8_ + auVar50._8_8_ ) - auVar53._8_8_ ) - auVar51._8_8_ ) + ( ulong )(auVar51._0_8_ == 0) + ( ulong )(auVar53._0_8_ == 0) + ( ulong )(uVar38 < auVar54._0_8_) + (ulong)CARRY8(auVar50._0_8_, uVar43) + ( ulong )(uVar43 < uVar44);
            ...
            *(undefined8*)( (long)pvVar17 + (ulong)uVar9 * 8 ) = 0;
            ...
            if (iVar7 == 0) {
               LAB_001057ea:plVar18 = *(long**)( lVar25 + 0x10 );
               plVar14 = (long*)plVar13[2];
               lVar27 = *plVar18;
               ...
               *(long**)( lVar27 + 8 ) = plVar13;
               if (lVar12 != *(long*)( lVar25 + 0x18 )) {
                  LAB_001063aa:_err_print_error(&_LC38, "core/math/convex_hull.cpp", 0x1e7, "Assertion \"reverse->target == n->reverse->target\" failed.", 0, 0);
                  plVar14 = (long*)plVar13[2];
               }
               ...
               *plVar18 = (long)plVar13;
               ...
               LAB_00105865:if (lVar27 != *(long*)( *(long*)( lVar25 + 0x10 ) + 0x18 )) {
                  LAB_00105e00:_err_print_error(&_LC38, "core/math/convex_hull.cpp", 0x1e7, "Assertion \"reverse->target == n->reverse->target\" failed.", 0, 0);
               }
               ...
               if (local_1c8 != (long*)0x0) {
                  ...
                  if (0 < iVar7) {
                     ...
                     if (*(long*)( lVar25 + 0x18 ) != *(long*)( plVar15[2] + 0x18 )) {
                        _err_print_error(&_LC38, "core/math/convex_hull.cpp", 0x1e7, "Assertion \"reverse->target == n->reverse->target\" failed.");
                        lVar25 = plVar13[2];
                     }
                  ...
                  LAB_001058da:if (plVar15 != plVar13) {
                     lVar25 = local_1c8[3];
                     pvVar17 = *(void**)( param_3 + 8 );
                     uVar8 = *(uint*)param_3;
                        ...
                        do {
                           ...
                           if (plVar18 == plVar15) {
                              *(undefined8*)( lVar27 + 0x10 ) = 0;
                              ...
                              LAB_0010595c:puVar16 = (undefined8*)plVar14[1];
                              plVar15[1] = (long)puVar16;
                              *puVar16 = plVar15;
                           }
 else {
                           ...
                           *(long**)( *(long*)( lVar27 + ( ulong )(uVar9 >> ( (byte)uVar1 & 0x1f )) * 8 ) + ( ulong )(uVar9 & uVar8) * 8 ) = plVar18;
                           pvVar17 = *(void**)( param_3 + 8 );
                           *(long**)( *(long*)( lVar27 + ( ulong )(uVar9 + 1 >> ( (byte)uVar1 & 0x1f )) * 8 ) + ( ulong )(uVar8 & uVar9 + 1) * 8 ) = plVar14;
                           *(int*)( this + 0x170 ) = *(int*)( this + 0x170 ) + -1;
 ...
 while ( plVar18 != (long*)local_1c8[2] );
               ...
               lVar25 = *(long*)( lVar30 + 0x10 );
               if (*(long*)( plVar14[2] + 0x18 ) != *(long*)( *(long*)( lVar25 + 0x10 ) + 0x18 )) goto LAB_00105e00;
               *plVar14 = lVar25;
               *(long**)( lVar25 + 8 ) = plVar14;
            }
         ...
         LAB_001056c1:local_1c8[4] = (long)param_1;
         *(undefined8*)( lVar25 + 0x20 ) = *(undefined8*)( lVar30 + 0x20 );
         ...
         LAB_001056ff:plVar13 = (long*)**(long**)( lVar30 + 0x10 );
         plVar15 = plVar13;
         while (true) {
            Vertex::dot((Point64*)&local_88);
            iVar7 = Rational128::compare((Rational128*)&local_88, lVar11);
...
;
            ...
            *(long*)( (long)pvVar17 + (ulong)uVar8 * 8 ) = lVar11;
            ...
            if (plVar13 != plVar15) {
               do {
                  ...
                  *(long**)( *(long*)( lVar25 + ( ulong )(uVar8 >> ( (byte)uVar1 & 0x1f )) * 8 ) + ( ulong )(uVar8 & uVar9) * 8 ) = plVar15;
                  pvVar17 = *(void**)( param_3 + 8 );
                  *(long**)( *(long*)( lVar25 + ( ulong )(uVar8 + 1 >> ( (byte)uVar1 & 0x1f )) * 8 ) + ( ulong )(uVar9 & uVar8 + 1) * 8 ) = plVar18;
                  *(int*)( this + 0x170 ) = *(int*)( this + 0x170 ) + -1;
 ...
 while ( plVar15 != (long*)local_1c8[2] );
            ...
            if (*(uint*)( param_3 + 4 ) == uVar9) {
               ...
               *(void**)( param_3 + 8 ) = pvVar17;
               if (pvVar17 == (void*)0x0) {
                  LAB_00105e9f:_err_print_error("push_back", "./core/templates/local_vector.h", 0x41, "FATAL: Condition \"!data\" is true.", "Out of memory", 0, 0);
                  _err_flush_stdout();
                  /* WARNING: Does not return */
                  pcVar3 = (code*)invalidInstructionException();
                  ( *pcVar3 )();
      ...
      if (uVar8 == 0) {
         _err_print_error("shift_face", "core/math/convex_hull.cpp", 0x82a, "Assertion \"p_stack.size() > 0\" failed.", 0, 0);
         uVar8 = *(uint*)param_3;
         if (uVar8 == 0) {
            uVar37 = 0;
            uVar23 = 0;
            LAB_00106a28:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, uVar23, uVar37, "p_index", "count", "", false, true);
            _err_flush_stdout();
            /* WARNING: Does not return */
            pcVar3 = (code*)invalidInstructionException();
            ( *pcVar3 )();
      ...
      *(undefined8*)( this + 0x178 ) = *puVar16;
      ...
      do {
         do {
            ...
            uVar45 = uVar24;
            if (uVar8 <= uVar24) {
               LAB_00106a0a:uVar23 = (ulong)uVar45;
               goto LAB_00106a28;
            }
            ...
            bVar4 = false;
            LAB_001066a5:lVar25 = *(long*)( (long)puVar16 + local_1d8 );
            if (lVar25 != 0) {
               ...
               for (; lVar27 != 0; lVar27 = *(long*)( lVar27 + 0x10 )) {
                  if (lVar25 != *(long*)( lVar27 + 8 )) {
                     _err_print_error("receive_nearby_faces", "core/math/convex_hull.cpp", 0x1d5, "Assertion \"f->nearby_vertex == p_src\" failed.", 0, 0);
                  }
               ...
               *(undefined1(*) [16])( lVar25 + 0x18 ) = (undefined1[16])0x0;
               ...
               do {
                  ...
                  *(long*)( (long)pvVar17 + uVar23 * 8 ) = lVar27;
                  ...
                  if (plVar13 == plVar18) {
                     *(undefined8*)( lVar30 + 0x10 ) = 0;
                     ...
                     LAB_00106773:puVar16 = (undefined8*)plVar15[1];
                  ...
                  *(long**)( *(long*)( lVar27 + ( ulong )(uVar8 >> ( (byte)uVar1 & 0x1f )) * 8 ) + ( ulong )(uVar8 & uVar29) * 8 ) = plVar13;
                  *(long**)( *(long*)( lVar27 + ( ulong )(uVar8 + 1 >> ( (byte)uVar1 & 0x1f )) * 8 ) + ( ulong )(uVar29 & uVar8 + 1) * 8 ) = plVar15;
                  *(int*)( this + 0x170 ) = *(int*)( this + 0x170 ) + -1;
                  lVar27 = *(long*)( lVar25 + 0x10 );
                  *(uint*)( this + 0x94 ) = uVar8 + 2;
 ...
 while ( uVar24 < uVar8 );
   ...
   goto LAB_00106b12;
   LAB_0010692a:bVar4 = true;
   LAB_0010692f:uVar37 = ( ulong ) * (uint*)param_3;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ConvexHullInternal::compute(Vector3 const*, int) */void ConvexHullInternal::compute(ConvexHullInternal *this, Vector3 *param_1, int param_2) {
...
;
 ...
 while ( param_2 != iVar22 );
   LAB_00106d91:fVar27 = in_XMM6._0_4_;
   ...
   *(int*)( this + 0x168 ) = 3 - iVar22;
   ...
   do {
      ...
      auVar28 = auVar29;
      LAB_00106e1d:fVar27 = auVar28._0_4_;
      *(float*)this = fVar27;
      *(float*)( this + 4 ) = fVar32;
      *(float*)( this + 8 ) = fVar33;
      if (fVar27 != 0.0) {
         ...
         *local_80 = __LC53;
         ...
         if (0 < param_2) {
            ...
            do {
               ...
               local_50 = CONCAT44(( local_50._4_4_ - in_XMM7_Da ) * fVar32, ( (float)local_50 - fVar25 ) * fVar27);
               if (param_2 == iVar9) {
                  uVar21 = (long)param_2;
                  goto LAB_001074c8;
               }
               ...
               *puVar10 = CONCAT44((int)*(float*)( (long)&local_50 + (long)*(int*)( this + 0x16c ) * 4 ), (int)*(float*)( (long)&local_50 + (long)iVar22 * 4 ));
 ...
 while ( param_2 != iVar12 );
      ...
      LocalVector<ConvexHullInternal::Point32,unsigned_int,false,false>::sort_custom<PointComparator>((LocalVector<ConvexHullInternal::Point32,unsigned_int,false,false>*)&local_88);
      if (*(int*)( this + 0x28 ) != 0) {
         lVar18 = 0;
         do {
 ...
 while ( (uint)lVar18 < *(uint*)( this + 0x28 ) );
         ...
         *(undefined1(*) [16])( this + 0x18 ) = (undefined1[16])0x0;
         ...
         LAB_0010714c:*(int*)( this + 0x150 ) = param_2;
         LAB_00107153:uVar5 = _UNK_0010b8a8;
         uVar4 = __LC53;
         iVar22 = (int)local_88;
      ...
      LAB_0010738e:if ((uint)param_2 <= uVar6) goto LAB_00107153;
      ...
      *(long*)( this + 0x158 ) = lVar18;
      ...
      LAB_00107400:fVar27 = in_XMM6._0_4_;
      if (fVar27 < in_XMM8_Da) {
         ...
         *(undefined4*)( this + 0x16c ) = 2;
         ...
         LAB_00107480:*(undefined4*)( this + 0x164 ) = uVar8;
      ...
      *(undefined4*)( this + 0x16c ) = 0;
      ...
      uVar7 = 2;
      if (in_XMM7_Da < in_XMM8_Da) {
         LAB_00107425:*(undefined4*)( this + 0x164 ) = uVar13;
      ...
      uVar13 = 2;
      uVar7 = 1;
      LAB_00107457:*(undefined4*)( this + 0x164 ) = uVar13;
      *(undefined4*)( this + 0x168 ) = uVar7;
   }
 while ( true );
   LAB_0010717d:iVar9 = *(int*)( this + 0x2c );
   if (iVar9 == 0) {
      ...
      *(undefined8*)( this + 0x18 ) = uVar11;
      uVar11 = Memory::realloc_static(*(void**)( this + 0x20 ), ( ulong ) * (uint*)( this + 0x28 ) << 3, false);
 ...
 while ( uVar15 != uVar6 );
   ...
   *(uint*)( this + 0x2c ) = uVar6;
   pauVar1 = *(undefined1(**) [16])( plVar19[uVar6 >> ( ( byte ) * (undefined4*)( this + 0x30 ) & 0x1f )] + ( ulong )(uVar6 & *(uint*)( this + 0x34 )) * 8 );
   *(undefined8*)pauVar1[2] = 0;
   *(undefined4*)( pauVar1[7] + 8 ) = 0xffffffff;
   *pauVar1 = (undefined1[16])0x0;
   pauVar1[1] = (undefined1[16])0x0;
   for (int i = 0; i < 4; i++) {
      *(undefined1(*) [16])( pauVar1[( i + 2 )] + 8 ) = (undefined1[16])0;
   }
   ...
   *(undefined8*)pauVar1[7] = uVar5;
   ...
   uVar21 = uVar23;
   if (uVar23 == uVar17) {
      LAB_001074c8:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, uVar15, uVar21, "p_index", "count", "", false, true);
      _err_flush_stdout();
      /* WARNING: Does not return */
      pcVar3 = (code*)invalidInstructionException();
      ( *pcVar3 )();
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ConvexHullInternal::shrink(float, float) */void ConvexHullInternal::shrink(ConvexHullInternal *this, float param_1, float param_2) {
   int iVar1;
   long *plVar2;
   float fVar3;
   float fVar4;
   ...
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (lVar22 == 0) {
      LAB_00107844:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
         /* WARNING: Subroutine does not return */
         __stack_chk_fail();
      }
      ...
      do {
         ...
         do {
            if ((int)uVar19 == 0) {
               ...
               if (( local_100 < 0 ) || ( _local_58 = auVar15 ),auVar38 = auVar16,local_100 == 0 && local_c8 == 0) goto LAB_0010780e;
               local_64[2] = 0.0;
               local_64[0] = 0.0;
               local_64[1] = 0.0;
               if (local_f8 < 0) {
               ...
               if (0.0 < param_2) {
                  ...
                  while (true) {
                     ...
                     fVar34 = ( (float)local_4c._0_4_ - fVar37 * fVar3 ) * (float)local_58._0_4_ + ( (float)local_4c._4_4_ - fVar35 * fVar4 ) * (float)local_58._4_4_ + ( auVar38._8_4_ - fVar33 * fVar32 ) * local_50;
                     if (fVar36 <= fVar34) {
                        fVar34 = fVar36;
                     }
...
;
                  if (fVar36 <= 0.0) {
                     LAB_00107813:_local_4c = auVar38;
                     ...
                     LAB_00108121:uVar21 = (ulong)uVar18;
                     ...
                     while (true) {
                        ...
                        *puVar26 = local_98[uVar19];
                        ...
                        if (uVar18 <= uVar29) {
                           LAB_00108198:_local_4c = auVar38;
                           _err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, (ulong)uVar29, uVar21, "p_index", "count", "", false, true);
                           _err_flush_stdout();
                           /* WARNING: Does not return */
...
;
                     LAB_0010780e:_local_4c = auVar38;
 ...
 while ( local_118 == (long*)0x0 );
         do {
            ...
            if (iVar1 != (int)local_118[5]) {
               pFVar20 = PagedAllocator<ConvexHullInternal::Face,false,4096u>::alloc<>((PagedAllocator<ConvexHullInternal::Face,false,4096u>*)( this + 0xe8 ));
               ...
               *(ulong*)( pFVar20 + 0x28 ) = CONCAT44((int)( (ulong)uVar13 >> 0x20 ) - (int)( (ulong)uVar5 >> 0x20 ), (int)uVar13 - (int)uVar5);
               ...
               *(Face**)( lVar27 + 0x20 ) = pFVar20;
               ...
               do {
                  ...
                  if (( lVar27 != 0 ) && ( lVar25 != 0 )) {
                     ...
                     uVar19 = (long)( local_104 - iVar6 ) * ( (long)( iVar28 - iVar7 ) * (long)( local_d8 - iVar8 ) - (long)( local_d4 - iVar7 ) * (long)( local_cc - iVar8 ) ) + ( (long)( local_cc - iVar8 ) * (long)( local_d0 - iVar6 ) - (long)( local_d8 - iVar8 ) * (long)( local_a0 - iVar6 ) ) * (long)( local_10c - iVar7 ) + ( (long)( local_a0 - iVar6 ) * (long)( local_d4 - iVar7 ) - (long)( local_d0 - iVar6 ) * (long)( iVar28 - iVar7 ) ) * (long)( local_108 - iVar8 );
                     if ((long)uVar19 < 0) {
                        _err_print_error("shrink", "core/math/convex_hull.cpp", 0x6ae, "Assertion \"vol >= 0\" failed.", 0);
                        local_d0 = *(int*)( lVar25 + 0x68 );
                        local_d8 = *(int*)( lVar25 + 0x70 );
                        local_104 = *(int*)( lVar22 + 0x68 );
                        local_a0 = *(int*)( lVar27 + 0x68 );
                  ...
                  if (iVar1 == (int)plVar24[5]) {
                     _err_print_error("shrink", "core/math/convex_hull.cpp", 0x6b6, "Assertion \"f->copy != stamp\" failed.", 0);
                  }
 ...
 while ( true );
   ...
   LAB_00108030:_err_print_error("push_back", "./core/templates/local_vector.h", 0x41, "FATAL: Condition \"!data\" is true.", "Out of memory", 0, 0);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar14 = (code*)invalidInstructionException();
   ( *pcVar14 )();
}
/* ConvexHullComputer::compute(Vector3 const*, int, float, float) [clone .part.0] */float ConvexHullComputer::compute(ConvexHullComputer *this, Vector3 *param_1, int param_2, float param_3, float param_4) {
   undefined8 *puVar1;
   Vertex *pVVar2;
   long *plVar3;
   code *pcVar4;
         ...
         if ((uint)local_1f8 != 0) {
            do {
               ...
               if (uVar17 == *(uint*)( this + 4 )) {
                  ...
                  *(void**)( this + 8 ) = pvVar8;
                  if (pvVar8 == (void*)0x0) {
                     LAB_001088e2:_err_print_error("push_back", "./core/templates/local_vector.h", 0x41, "FATAL: Condition \"!data\" is true.", "Out of memory", 0, 0);
                     _err_flush_stdout();
                     /* WARNING: Does not return */
               ...
               *(float*)( puVar1 + 1 ) = local_1d8;
               if (plVar3 != (long*)0x0) {
                  ...
                  do {
                     ...
                     joined_r0x0010874d:uVar10 = (ulong)uVar12;
                     uVar15 = uVar12;
                     if (-1 < (int)uVar19) {
 ...
 while ( plVar3 != plVar14 );
                  if (uVar17 <= uVar15) {
                     uVar10 = (ulong)uVar15;
                     LAB_001087c0:uVar13 = (ulong)uVar17;
                     break;
                  }
 ...
 while ( (uint)uVar18 < (uint)local_1f8 );
      ...
      LAB_00108a33:if (pvVar8 != (void*)0x0) {
         Memory::free_static(pvVar8, false);
      }

   }

   LAB_00108505:ConvexHullInternal::~ConvexHullInternal(local_1c8);
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   ...
   while (bVar21 = uVar20 != uVar13,uVar10 = uVar13,uVar20 = uVar20 + 1,bVar21) {
      LAB_00108951:plVar3 = *(long**)( *(long*)( (long)pvVar8 + uVar20 * 8 + -8 ) + 0x10 );
      plVar14 = plVar3;
      if (plVar3 != (long*)0x0) {
         do {
            lVar5 = plVar14[5];
...
;
   LAB_00108791:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, uVar10, uVar13, "p_index", "count", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar4 = (code*)invalidInstructionException();
   ( *pcVar4 )();
}
/* ConvexHullComputer::compute(Vector3 const*, int, float, float) */undefined8 ConvexHullComputer::compute(ConvexHullComputer *this, Vector3 *param_1, int param_2, float param_3, float param_4) {
   undefined8 uVar1;
   if (*(int*)this != 0) {
      *(undefined4*)this = 0;
   }
...
/* ConvexHullComputer::convex_hull(Vector<Vector3> const&, Geometry3D::MeshData&) */undefined8 ConvexHullComputer::convex_hull(Vector *param_1, MeshData *param_2) {
   int *piVar1;
   float *pfVar2;
   float *pfVar3;
   float *pfVar4;
   ...
   long local_40;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   LocalVector<Geometry3D::MeshData::Face,unsigned_int,false,false>::resize((LocalVector<Geometry3D::MeshData::Face,unsigned_int,false,false>*)param_2, 0);
   ...
   *(undefined8*)( param_2 + 0x20 ) = 0;
   ...
   if ((uint)local_78 < uVar15) {
      *(uint*)( param_2 + 0x20 ) = (uint)local_78;
      LAB_00108c0c:if ((uint)local_78 != 0) goto LAB_00108c10;
   }
 else {
      ...
      if (*(uint*)( param_2 + 0x24 ) < (uint)local_78) {
         ...
         *(long*)( param_2 + 0x28 ) = lVar20;
         ...
         LAB_00108cf5:memset((void*)( *(long*)( param_2 + 0x28 ) + (ulong)uVar15 * 0xc ), 0, ( ( ulong )(uVar13 - uVar15) * 3 + 3 ) * 4);
      }

      *(uint*)( param_2 + 0x20 ) = uVar12;
      LAB_00108c10:lVar20 = *(long*)( param_2 + 0x28 );
      lVar18 = 0;
      do {
 ...
 while ( uVar27 * 0xc != lVar18 );
   ...
   if ((uint)local_68 != 0) {
      ...
      pvVar19 = (void*)Memory::realloc_static((void*)0x0, ( ulong )(( uVar12 | uVar12 >> 0x10 ) + 1) << 2, false);
 ...
 while ( ( uVar27 & 0xffffffff ) != uVar22 );
   ...
   if ((uint)local_58 != 0) {
      ...
      do {
         ...
         if (uVar15 <= uVar13) {
            uVar31 = (ulong)uVar13;
            LAB_00108da6:uVar22 = uVar27 & 0xffffffff;
            goto LAB_00108dc4;
         }
 ...
 while ( uVar22 != ( local_58 & 0xffffffff ) );
   ...
   if (uVar13 < *(uint*)( param_2 + 0x10 )) {
      LAB_00108e2a:*(uint*)( param_2 + 0x10 ) = uVar13;
   }
      ...
      if (*(uint*)( param_2 + 0x14 ) < uVar13) {
         ...
         *(long*)( param_2 + 0x18 ) = lVar20;
         if (lVar20 == 0) {
            LAB_001090cb:_err_print_error("resize", "./core/templates/local_vector.h", 0xa3, "FATAL: Condition \"!data\" is true.", "Out of memory", 0, 0);
            _err_flush_stdout();
            /* WARNING: Does not return */
   ...
   if (uVar15 == 0) {
      ...
      if (( uVar27 & 0xffffffff ) == 0) {
         uVar22 = 0;
         uVar31 = 0;
         LAB_00108dc4:_err_print_index_error("operator[]", "./core/templates/local_vector.h", 0xb2, uVar31, uVar22, "p_index", "count", "", false, true);
         _err_flush_stdout();
         /* WARNING: Does not return */
         pcVar10 = (code*)invalidInstructionException();
         ( *pcVar10 )();
      ...
      do {
         ...
         if (iVar24 == -1) {
            _err_print_error("convex_hull", "core/math/convex_hull.cpp", 0x8e2, "Condition \"edge_faces[i] == -1\" is true. Continuing.", 0);
         }
 else {
            ...
            if (uVar14 < uVar8) {
               if (*(uint*)( param_2 + 0x10 ) <= uVar13) {
                  _err_print_error("convex_hull", "core/math/convex_hull.cpp", 0x8e7, "Condition \"edges_copied >= (uint32_t)r_mesh.edges.size()\" is true. Breaking.", 0, 0);
                  break;
               }
               ...
               *(undefined4*)( puVar23 + 1 ) = uVar7;
               local_a4 = uVar13;
               OAHashMap<unsigned_long,int,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>::insert((OAHashMap<unsigned_long,int,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>*)&local_98, &local_a0, (int*)&local_a4);
               uVar13 = uVar13 + 1;
            }
 else {
               ...
               if (uVar28 != 0) {
                  uVar29 = 0;
                  do {
                     if (( uVar28 == (uint)uVar30 ) && ( CONCAT44(uVar8, uVar14) == *(long*)( (long)local_90 + uVar22 * 8 ) )) {
 ...
 while ( ( uVar28 != 0 ) && ( uVar29 <= ( ( local_80 + (int)uVar22 ) - uVar28 % local_80 ) % local_80 ) );
               }
 ...
 while ( ( uVar27 & 0xffffffff ) != uVar31 );
   ...
   LocalVector<Geometry3D::MeshData::Face,unsigned_int,false,false>::resize((LocalVector<Geometry3D::MeshData::Face,unsigned_int,false,false>*)param_2, uVar12);
   lVar20 = local_50;
   if (uVar12 != 0) {
      uVar30 = 0;
      do {
 ...
 while ( piVar1 != piVar25 );
         fVar16 = pfVar26[4];
         if ((uint)fVar16 < 3) {
            LAB_00109341:_err_print_error("convex_hull", "core/math/convex_hull.cpp", 0x91d, "Too few vertices per face.", 0);
         }
 else {
            lVar18 = 0;
            do {
 ...
 while ( (uint)lVar18<(int)fVar16 - 1U> > 1 );
            ...
            fVar33 = ( fVar16 - pfVar2[1] ) * ( fVar5 - pfVar3[2] ) - ( fVar5 - pfVar2[2] ) * ( fVar16 - pfVar3[1] );
 ...
 while ( ( uVar11 & 0xffffffff ) != uVar30 );
   ...
   LAB_00108b6e:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar17;
   }
...
/* SortArray<ConvexHullInternal::Point32, PointComparator, true>::adjust_heap(long, long, long,
   ConvexHullInternal::Point32, ConvexHullInternal::Point32*) const [clone .isra.0] */void SortArray<ConvexHullInternal::Point32,PointComparator,true>::adjust_heap(SortArray<ConvexHullInternal::Point32,PointComparator,true> *this, long param_1, long param_2, undefined8 param_3, undefined8 param_5, long param_6) {
   undefined8 *puVar1;
   int iVar2;
   undefined8 uVar3;
   int *piVar4;
   ...
   if (lVar7 < param_2) {
      do {
         ...
         lVar5 = lVar7;
         if (( piVar4[1] <= piVar6[1] ) && ( ( piVar6[1] != piVar4[1] || ( ( *piVar4 <= *piVar6 && ( ( *piVar6 != *piVar4 || ( piVar4[2] <= piVar6[2] ) ) ) ) ) ) )) {
            lVar5 = lVar7 + 1;
            piVar4 = piVar6;
            lVar9 = lVar7;
         }
 ...
 while ( lVar7 < param_2 );
   ...
   do {
      ...
      if (iStack_14 == iVar2 || iStack_14 < iVar2) {
         if (iStack_14 != iVar2) {
            LAB_00109e87:piVar6 = (int*)( (long)( this + lVar9 ) * 0x10 + param_6 );
            goto LAB_00109e92;
         }
...
/* SortArray<ConvexHullInternal::Point32, PointComparator, true>::introsort(long, long,
   ConvexHullInternal::Point32*, long) const [clone .isra.0] */void SortArray<ConvexHullInternal::Point32,PointComparator,true>::introsort(long param_1, long param_2, Point32 *param_3, long param_4) {
   int iVar1;
   int iVar2;
   undefined8 uVar3;
   undefined8 uVar4;
   ...
   if (0x10 < lVar9) {
      if (param_4 != 0) {
         ...
         lVar14 = param_2;
         LAB_00109fa0:param_4 = param_4 + -1;
         pPVar10 = param_3 + lVar14 * 0x10 + -0x10;
         iVar13 = *(int*)( pPVar8 + 4 );
         pPVar7 = param_3 + ( ( lVar9 >> 1 ) + param_1 ) * 0x10;
         iVar1 = *(int*)( pPVar7 + 4 );
         iVar15 = iVar13;
         if (( iVar13 < iVar1 ) || ( ( iVar13 == iVar1 && ( ( *(int*)pPVar8 < *(int*)pPVar7 || ( ( *(int*)pPVar8 == *(int*)pPVar7 && ( *(int*)( pPVar8 + 8 ) < *(int*)( pPVar7 + 8 ) ) ) ) ) ) ) )) {
            iVar12 = *(int*)( pPVar10 + 4 );
            if (iVar1 < iVar12) {
               LAB_0010a228:iVar2 = *(int*)pPVar7;
               LAB_0010a22d:iVar15 = iVar1;
               iVar11 = *(int*)( pPVar7 + 8 );
               goto LAB_00109ff7;
            }
            ...
            if (iVar1 == iVar12) {
               ...
               if (( iVar2 == *(int*)pPVar10 ) && ( iVar15 = iVar1 ),iVar11 = *(int*)( pPVar7 + 8 ),*(int*)( pPVar7 + 8 ) < *(int*)( pPVar10 + 8 )) goto LAB_00109ff7;
            }
            ...
            if (iVar13 == iVar12) {
               ...
               if (( iVar2 == iVar13 ) && ( iVar11 = *(int*)( pPVar8 + 8 ) * (int*)( pPVar8 + 8 ) < *(int*)( pPVar10 + 8 ) )) goto LAB_00109ff7;
         ...
         LAB_00109ff7:param_2 = param_1;
         pPVar10 = pPVar8;
         lVar9 = lVar14;
         do {
            if (( *(int*)( pPVar10 + 4 ) < iVar15 ) || ( ( *(int*)( pPVar10 + 4 ) == iVar15 && ( ( *(int*)pPVar10 < iVar2 || ( ( *(int*)pPVar10 == iVar2 && ( *(int*)( pPVar10 + 8 ) < iVar11 ) ) ) ) ) ) )) {
               if (param_2 == lVar14 + -1) {
               ...
               LAB_0010a059:pPVar7 = param_3 + lVar9 * 0x10 + -0x10;
               while (true) {
                  lVar9 = lVar9 + -1;
                  if (( *(int*)( pPVar7 + 4 ) <= iVar15 ) && ( ( *(int*)( pPVar7 + 4 ) != iVar15 || ( ( *(int*)pPVar7 <= iVar2 && ( ( *(int*)pPVar7 != iVar2 || ( *(int*)( pPVar7 + 8 ) <= iVar11 ) ) ) ) ) ) )) goto joined_r0x0010a029;
...
;
               ...
               joined_r0x0010a029:if (lVar9 <= param_2) goto LAB_0010a170;
 ...
 while ( true );
      ...
      LAB_0010a238:lVar14 = lVar9 + -2 >> 1;
      pPVar8 = param_3 + ( param_1 + lVar14 ) * 0x10;
      while (true) {
         uVar3 = *(undefined8*)pPVar8;
         pPVar10 = pPVar8 + 8;
         pPVar8 = pPVar8 + -0x10;
         adjust_heap((SortArray<ConvexHullInternal::Point32,PointComparator,true>*)param_1, lVar14, lVar9, uVar3, *(undefined8*)pPVar10);
         if (lVar14 == 0) break;
         lVar14 = lVar14 + -1;
      }
;
      ...
      do {
         ...
         *(undefined8*)( pPVar8 + -8 ) = uVar6;
         adjust_heap((SortArray<ConvexHullInternal::Point32,PointComparator,true>*)param_1, 0, lVar9, uVar3, uVar4);
         bVar5 = 1 < lVar9;
         pPVar8 = pPVar8 + -0x10;
         lVar9 = lVar9 + -1;
      }
 while ( bVar5 );
   ...
   return;
   LAB_0010a170:introsort(param_2, lVar14, param_3, param_4);
   lVar9 = param_2 - param_1;
   if (lVar9 < 0x11) {
      return;
   }
...
/* ConvexHullInternal::~ConvexHullInternal() */void ConvexHullInternal::~ConvexHullInternal(ConvexHullInternal *this) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   int iVar4;
   ...
   local_30 = *(long*)( in_FS_OFFSET + 0x28 );
   for (int i = 0; i < 3; i++) {
      if (*(int*)( this + ( 104*i + 40 ) ) != 0) {
         lVar5 = 0;
         do {
            Memory::free_static(*(void**)( *(long*)( this + ( 104*i + 24 ) ) + lVar5 * 8 ), false);
            lVar2 = lVar5 * 8;
            lVar5 = lVar5 + 1;
            Memory::free_static(*(void**)( *(long*)( this + ( 104*i + 32 ) ) + lVar2 ), false);
         }
 while ( (uint)lVar5 < *(uint*)( this + ( 104*i + 40 ) ) );
         Memory::free_static(*(void**)( this + ( 104*i + 24 ) ), false);
         Memory::free_static(*(void**)( this + ( 104*i + 32 ) ), false);
         *(undefined8*)( this + ( 104*i + 40 ) ) = 0;
         *(undefined1(*) [16])( this + ( 104*i + 24 ) ) = (undefined1[16])0;
      }
 ...
 while ( (uint)lVar5 < *(uint*)( this + 0x90 ) );
      ...
      LAB_0010a625:if ((char)CoreGlobals::leak_reporting_enabled != '\0') {
         local_50 = 0;
         local_40 = 0x1d;
...
/* ConvexHullInternal::Vertex::dot(ConvexHullInternal::Point64 const&) const */Point64 *ConvexHullInternal::Vertex::dot(Point64 *param_1) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   long lVar4;
   ...
   if (*(int*)( in_RSI + 0x74 ) < 0) {
      ...
      *(undefined8*)( param_1 + 0x18 ) = extraout_XMM0_Qb;
      ...
      lVar4 = extraout_RDX + auVar10._8_8_ + auVar9._8_8_ + (ulong)CARRY8(uVar5, auVar10._0_8_) + (ulong)CARRY8(auVar9._0_8_, uVar6);
      if (lVar4 < 0) {
   ...
   lVar4 = *(int*)( in_RSI + 0x68 ) * lVar8 + *(int*)( in_RSI + 0x6c ) * lVar4 + (long)*(int*)( in_RSI + 0x70 ) * in_RDX[2];
   uVar7 = 1;
   if (lVar4 < 1) {
      if (lVar4 == 0) {
         uVar7 = 0;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ConvexHullInternal::ConvexHullInternal() */void ConvexHullInternal::ConvexHullInternal(ConvexHullInternal *this) {
   undefined8 uVar1;
   undefined8 uVar2;
   uVar2 = _UNK_0010b8b8;
   uVar1 = __LC57;
   ...
   *(undefined4*)( this + 0x14 ) = 0;
   for (int i = 0; i < 3; i++) {
      this[( 104*i + 60 )] = (ConvexHullInternal)0;
      *(undefined4*)( this + ( 104*i + 56 ) ) = 4096;
   }

   for (int i = 0; i < 6; i++) {
      *(undefined8*)( this + ( 8*i + 336 ) ) = 0;
   }

   for (int i = 0; i < 3; i++) {
      *(undefined1(*) [16])( this + ( 104*i + 24 ) ) = (undefined1[16])0;
      *(undefined8*)( this + ( 104*i + 40 ) ) = uVar1;
      *(undefined8*)( this + ( 104*i + 48 ) ) = uVar2;
   }

   return;
}
/* ConvexHullComputer::~ConvexHullComputer() */void ConvexHullComputer::~ConvexHullComputer(ConvexHullComputer *this) {
...
/* void LocalVector<ConvexHullInternal::Point32, unsigned int, false,
   false>::sort_custom<PointComparator>() */void LocalVector<ConvexHullInternal::Point32,unsigned_int,false,false>::sort_custom<PointComparator>(LocalVector<ConvexHullInternal::Point32,unsigned_int,false,false> *this) {
   uint uVar1;
   int iVar2;
   Point32 *__src;
   undefined8 uVar3;
...
;
         ...
         pPVar5 = pPVar14;
         uVar7 = uVar8;
         if (( *(int*)( __src + 4 ) == iVar2 ) && ( ( iVar12 < *(int*)__src || ( ( *(int*)__src == iVar12 && ( (int)uVar4 < *(int*)( __src + 8 ) ) ) ) ) )) goto LAB_0010aff2;
         while (true) {
            iVar11 = *(int*)( pPVar5 + -0xc );
            if (( iVar11 == iVar2 || iVar11 < iVar2 ) && ( ( iVar11 != iVar2 || ( ( *(int*)( pPVar5 + -0x10 ) <= iVar12 && ( ( *(int*)( pPVar5 + -0x10 ) != iVar12 || ( *(int*)( pPVar5 + -8 ) <= (int)uVar4 ) ) ) ) ) ) )) goto LAB_0010afcb;
            if (uVar7 - 1 == 0) break;
 ...
 while ( uVar10 != uVar8 );
      ...
      do {
         while (true) {
            ...
            iVar2 = *(int*)( pPVar14 + 4 );
            if (*(int*)( __src + 4 ) <= iVar2) break;
            LAB_0010aef3:pPVar14 = pPVar14 + 0x10;
...
;
         ...
         pPVar5 = pPVar14;
         lVar6 = lVar9;
         if (( *(int*)( __src + 4 ) == iVar2 ) && ( ( iVar12 < *(int*)__src || ( ( *(int*)__src == iVar12 && ( (int)uVar4 < *(int*)( __src + 8 ) ) ) ) ) )) goto LAB_0010aef3;
         while (true) {
            iVar11 = *(int*)( pPVar5 + -0xc );
            if (( iVar11 == iVar2 || iVar11 < iVar2 ) && ( ( iVar11 != iVar2 || ( ( *(int*)( pPVar5 + -0x10 ) <= iVar12 && ( ( *(int*)( pPVar5 + -0x10 ) != iVar12 || ( *(int*)( pPVar5 + -8 ) <= (int)uVar4 ) ) ) ) ) ) )) goto LAB_0010aecb;
            if (lVar6 == 1) break;
            *(undefined8*)pPVar5 = *(undefined8*)( pPVar5 + -0x10 );
            *(undefined8*)( pPVar5 + 8 ) = *(undefined8*)( pPVar5 + -8 );
            pPVar5 = pPVar5 + -0x10;
...
;
 ...
 while ( lVar9 + 1 != 0x10 );
      ...
      do {
         ...
         uVar7 = uVar8;
         while (true) {
            if (( *(int*)( pPVar14 + -0xc ) <= iVar12 ) && ( ( iVar12 != *(int*)( pPVar14 + -0xc ) || ( ( *(int*)( pPVar14 + -0x10 ) <= iVar11 && ( ( *(int*)( pPVar14 + -0x10 ) != iVar11 || ( *(int*)( pPVar14 + -8 ) <= iVar2 ) ) ) ) ) ) )) goto LAB_0010af46;
            uVar7 = uVar7 - 1;
            if (uVar7 == 0) break;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ConvexHullInternal::Face* PagedAllocator<ConvexHullInternal::Face, false, 4096u>::alloc<>() */Face * __thiscall
PagedAllocator<ConvexHullInternal::Face,false,4096u>::alloc<>
 ...
 while ( plVar3 + uVar5 != plVar10 );
   ...
   *(uint*)( this + 0x14 ) = uVar5;
   pFVar1 = *(Face**)( plVar12[uVar5 >> ( ( byte ) * (undefined4*)( this + 0x18 ) & 0x1f )] + ( ulong )(uVar5 & *(uint*)( this + 0x1c )) * 8 );
   *(undefined1(*) [16])pFVar1 = (undefined1[16])0x0;
   uVar4 = _UNK_0010b8a8;
   uVar7 = __LC53;
   *(undefined8*)( pFVar1 + 0x10 ) = 0;
   for (int i = 0; i < 3; i++) {
      *(undefined8*)( pFVar1 + ( 16*i + 24 ) ) = uVar7;
      *(undefined8*)( pFVar1 + ( 16*i + 32 ) ) = uVar4;
   }

   return pFVar1;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* OAHashMap<unsigned long, int, HashMapHasherDefault, HashMapComparatorDefault<unsigned long>
   >::insert(unsigned long const&, int const&) */void OAHashMap<unsigned_long,int,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>>::insert(OAHashMap<unsigned_long,int,HashMapHasherDefault,HashMapComparatorDefault<unsigned_long>> *this, ulong *param_1, int *param_2) {
   ulong *puVar1;
   uint *puVar2;
   undefined8 *puVar3;
   uint *puVar4;
      ...
      if (uVar16 == 0) {
         ...
         do {
            ...
            if (uVar16 != 0) {
               ...
               uVar8 = *local_70;
               while (uVar14 != 0) {
                  uVar15 = ( uint )(( ulong )(uint)(( (int)uVar11 + (int)uVar18 ) - (int)( (ulong)uVar14 % uVar18 )) % uVar18);
                  uVar19 = uVar12;
                  uVar26 = uVar8;
                  if (uVar15 < uVar22) {
                     *puVar2 = uVar16;
...
;
 ...
 while ( puVar20 != puVar4 + uVar17 );
   ...
   iVar10 = *param_2;
   while (uVar16 != 0) {
      uVar14 = ( uint )(( ulong )(uint)(( (int)uVar11 + (int)uVar17 ) - (int)( (ulong)uVar16 % uVar17 )) % uVar17);
      uVar24 = uVar9;
      iVar25 = iVar10;
      if (uVar14 < uVar22) {
...
/* LocalVector<Geometry3D::MeshData::Face, unsigned int, false, false>::resize(unsigned int) */void LocalVector<Geometry3D::MeshData::Face,unsigned_int,false,false>::resize(LocalVector<Geometry3D::MeshData::Face,unsigned_int,false,false> *this, uint param_1) {
 ...
 while ( puVar4 != (undefined8*)( lVar6 + 0x20 + ( ( ulong )(uVar5 - uVar7) + (ulong)uVar7 ) * 0x20 ) );
   ...
   LAB_0010b70b:*(uint*)this = param_1;
   return;
}
/* WARNING: Control flow encountered bad instruction data *//* ConvexHullInternal::~ConvexHullInternal() */void ConvexHullInternal::~ConvexHullInternal(ConvexHullInternal *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* ConvexHullComputer::~ConvexHullComputer() */void ConvexHullComputer::~ConvexHullComputer(ConvexHullComputer *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* ConvexHullInternal::ConvexHullInternal() */void ConvexHullInternal::ConvexHullInternal(ConvexHullInternal *this) {

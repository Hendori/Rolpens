/* EditorDockManager::_dock_split_dragged(int) */void EditorDockManager::_dock_split_dragged(int param_1) {
   EditorNode::save_editor_layout_delayed();
   return;
}
/* DockContextPopup::_dock_select_mouse_exited() */void DockContextPopup::_dock_select_mouse_exited(DockContextPopup *this) {
   *(undefined4*)( this + 0xe58 ) = 0xffffffff;
   CanvasItem::queue_redraw();
   return;
}
/* CowData<DockSplitContainer*>::_copy_on_write() [clone .isra.0] */void CowData<DockSplitContainer*>::_copy_on_write(CowData<DockSplitContainer*> *this) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   undefined8 *puVar4;
...
/* CowData<WindowWrapper*>::_copy_on_write() [clone .isra.0] */void CowData<WindowWrapper*>::_copy_on_write(CowData<WindowWrapper*> *this) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
   undefined8 *puVar4;
...
/* HashMap<Control*, EditorDockManager::DockInfo, HashMapHasherDefault,
   ...
   .isra.0] */undefined8 HashMap<Control*,EditorDockManager::DockInfo,HashMapHasherDefault,HashMapComparatorDefault<Control*>,DefaultTypedAllocator<HashMapElement<Control*,EditorDockManager::DockInfo>>>::_lookup_pos(HashMap<Control*,EditorDockManager::DockInfo,HashMapHasherDefault,HashMapComparatorDefault<Control*>,DefaultTypedAllocator<HashMapElement<Control*,EditorDockManager::DockInfo>>> *this, Control **param_1, uint *param_2) {
   long lVar1;
   ...
   if (*(int*)( this + 0x2c ) != 0) {
      ...
      if (uVar14 != 0) {
         uVar16 = 0;
         do {
            if (( (uint)uVar13 == uVar14 ) && ( *(Control***)( *(long*)( *(long*)( this + 8 ) + lVar12 * 8 ) + 0x10 ) == param_1 )) {
               *param_2 = uVar11;
               return 1;
            }
...
/* DockSplitContainer::_update_visibility() [clone .part.0] */void DockSplitContainer::_update_visibility(DockSplitContainer *this) {
   char cVar1;
   int iVar2;
   long lVar3;
   int iVar4;
   ...
   if (0 < iVar2) {
      do {
         ...
         if (( ( ( lVar3 != 0 ) && ( lVar3 = __dynamic_cast(lVar3, &Object::typeinfo, &Control::typeinfo, 0) ),lVar3 != 0 ) ) && ( cVar1 = cVar1 != '\0' )) &&( cVar1 = cVar1 == '\0' );
         iVar4 = iVar4 + 1;
         iVar2 = Node::get_child_count(bVar5);
      }
 while ( iVar4 < iVar2 );
...
/* DockSplitContainer::_update_visibility() */void DockSplitContainer::_update_visibility(DockSplitContainer *this) {
...
/* EditorDockManager::_dock_container_update_visibility(TabContainer*) */void EditorDockManager::_dock_container_update_visibility(EditorDockManager *this, TabContainer *param_1) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* DockContextPopup::_dock_select_draw() */void __thiscall DockContextPopup::_dock_select_draw(DockContextPopup *this)

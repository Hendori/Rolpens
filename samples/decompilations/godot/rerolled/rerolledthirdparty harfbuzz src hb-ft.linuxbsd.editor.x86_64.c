/* hb_ft_face_finalize(void*) */void hb_ft_face_finalize(void *param_1) {
   hb_face_destroy(*(undefined8*)( (long)param_1 + 0x58 ));
   return;
}
/* finalize_ft_library(void*) */void finalize_ft_library(void *param_1) {
   FT_Done_Library(*(undefined8*)( (long)param_1 + 0x58 ));
   return;
}
/* destroy_ft_library(void*) */void destroy_ft_library(void *param_1) {
   FT_Done_Library();
   return;
}
/* WARNING: Unknown calling convention -- yet parameter storage is locked *//* reference_ft_library() */long reference_ft_library(void) {
   int iVar1;
   long lVar2;
   long in_FS_OFFSET;
   bool bVar3;
   ...
   LAB_001001e6:do {
      ...
      if (bVar3) {
         lVar2 = 0;
         LAB_001001f5:iVar1 = FT_Reference_Library(lVar2);
         if (iVar1 != 0) {
            lVar2 = 0;
         }
...
void hb_ft_font_changed_part_0(long param_1) {
   ...
   hb_font_set_scale(param_1, uVar3 * *(long*)( lVar2 + 0x20 ) + 0x8000 >> 0x10, *(long*)( lVar2 + 0x28 ) * uVar3 + 0x8000 >> 0x10);
...
undefined8 hb_ft_hb_font_changed(long param_1) {
   ...
   if (*(int*)( param_1 + 0x10 ) != *(int*)( lVar1 + 0x38 )) {
      _hb_ft_hb_font_changed((hb_font_t*)( ulong ) * (uint*)( param_1 + 0x28 ), (FT_FaceRec_*)( ulong ) * (uint*)( param_1 + 0x2c ));
      puVar4 = (undefined8*)( lVar1 + 0x44U & 0xfffffffffffffff8 );
      *(undefined8*)( lVar1 + 0x3c ) = 0xffffffffffffffff;
      *(undefined8*)( lVar1 + 0x434 ) = 0xffffffffffffffff;
      uVar3 = ( ulong )(( (int)lVar1 - (int)puVar4 ) + 0x43cU >> 3);
...
undefined8 hb_ft_face_create_from_file_or_fail(undefined8 param_1, undefined4 param_2) {
   ...
   uVar4 = 0;
   LAB_00100a28:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar4;
   }
...
void hb_ft_font_set_funcs(hb_font_t *param_1) {
   ...
   hb_blob_destroy(uVar3);
   LAB_00100b6e:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* hb_ft_get_glyph_contour_point(hb_font_t*, void*, unsigned int, unsigned int, int*, int*, void*)
    */undefined8 hb_ft_get_glyph_contour_point(hb_font_t *param_1, void *param_2, uint param_3, uint param_4, int *param_5, int *param_6, void *param_7) {
   long lVar1;
   int iVar2;
   undefined8 *puVar3;
   undefined8 uVar4;
...
/* hb_ft_get_glyph_v_origin(hb_font_t*, void*, unsigned int, int*, int*, void*) */bool hb_ft_get_glyph_v_origin(hb_font_t *param_1, void *param_2, uint param_3, int *param_4, int *param_5, void *param_6) {
   long lVar1;
   int iVar2;
   float fVar3;
   float fVar4;
...
/* hb_ft_get_glyph_name(hb_font_t*, void*, unsigned int, char*, unsigned int, void*) */bool hb_ft_get_glyph_name(hb_font_t *param_1, void *param_2, uint param_3, char *param_4, uint param_5, void *param_6) {
   int iVar1;
   bool bVar2;
   pthread_mutex_lock((pthread_mutex_t*)( (long)param_2 + 8 ));
...
/* hb_ft_get_glyph_from_name(hb_font_t*, void*, char const*, int, unsigned int*, void*) */bool hb_ft_get_glyph_from_name(hb_font_t *param_1, void *param_2, char *param_3, int param_4, uint *param_5, void *param_6) {
   undefined8 uVar1;
   uint uVar2;
   int iVar3;
   char *pcVar4;
   ...
   bVar5 = uVar2 != 0;
   LAB_00100e88:pthread_mutex_unlock((pthread_mutex_t*)( (long)param_2 + 8 ));
...
/* hb_ft_get_glyph_extents(hb_font_t*, void*, unsigned int, hb_glyph_extents_t*, void*) */undefined8 hb_ft_get_glyph_extents(hb_font_t *param_1, void *param_2, uint param_3, hb_glyph_extents_t *param_4, void *param_5) {
   hb_font_t hVar1;
   long lVar2;
   int iVar3;
   undefined8 uVar4;
   ...
   if (iVar3 == 0) {
      ...
      if (fVar13 != 0.0) {
         ...
         fVar6 = fVar6 + (float)( ~-(uint)(fVar10 <= fVar13) & (uint)fVar13 | (uint)fVar10 & -(uint)(fVar10 <= fVar13) );
         fVar9 = fVar9 + (float)( (uint)fVar10 & -(uint)(fVar13 <= fVar10) | ~-(uint)(fVar13 <= fVar10) & (uint)fVar13 );
      }

      if ((float)( (uint)fVar6 & _LC5 ) < _LC3) {
         fVar6 = (float)( ( uint )((float)(int)fVar6 - (float)( -(uint)(fVar6 < (float)(int)fVar6) & (uint)_LC1 )) | ~_LC5 & (uint)fVar6 );
      }

      if ((float)( (uint)fVar9 & _LC5 ) < _LC3) {
         fVar9 = (float)( ( uint )((float)(int)fVar9 + (float)( -(uint)((float)(int)fVar9 < fVar9) & (uint)_LC1 )) | ~_LC5 & (uint)fVar9 );
      }
...
/* hb_ft_get_glyph_h_kerning(hb_font_t*, void*, unsigned int, unsigned int, void*) */undefined4 hb_ft_get_glyph_h_kerning(hb_font_t *param_1, void *param_2, uint param_3, uint param_4, void *param_5) {
   int iVar1;
   long in_FS_OFFSET;
   ...
   local_30 = *(long*)( in_FS_OFFSET + 0x28 );
   pthread_mutex_lock((pthread_mutex_t*)( (long)param_2 + 8 ));
   iVar1 = FT_Get_Kerning(*(undefined8*)( (long)param_2 + 0x30 ), param_3, param_4, *(int*)( param_1 + 0x68 ) == 0, local_48);
   if (iVar1 != 0) {
      local_48[0] = 0;
   }
...
/* hb_ft_get_glyph_v_advance(hb_font_t*, void*, unsigned int, void*) */int hb_ft_get_glyph_v_advance(hb_font_t *param_1, void *param_2, uint param_3, void *param_4) {
   int iVar1;
   int iVar2;
   long in_FS_OFFSET;
   float fVar3;
...
/* hb_ft_get_font_h_extents(hb_font_t*, void*, hb_font_extents_t*, void*) */undefined8 hb_ft_get_font_h_extents(hb_font_t *param_1, void *param_2, hb_font_extents_t *param_3, void *param_4) {
   short sVar1;
   long lVar2;
   long lVar3;
   int iVar4;
   ...
   *(ulong*)param_3 = CONCAT44((int)( (float)iVar4 * fVar8 ), (int)( (float)( iVar7 + *(int*)( param_1 + 0x40 ) ) * fVar8 ));
   *(int*)( param_3 + 8 ) = (int)( (float)iVar5 * fVar8 );
   pthread_mutex_unlock((pthread_mutex_t*)( (long)param_2 + 8 ));
   return 1;
}
/* hb_ft_get_variation_glyph(hb_font_t*, void*, unsigned int, unsigned int, unsigned int*, void*) */bool hb_ft_get_variation_glyph(hb_font_t *param_1, void *param_2, uint param_3, uint param_4, uint *param_5, void *param_6) {
   uint uVar1;
   pthread_mutex_lock((pthread_mutex_t*)( (long)param_2 + 8 ));
...
/* hb_ft_get_nominal_glyphs(hb_font_t*, void*, unsigned int, unsigned int const*, unsigned int,
   unsigned int*, unsigned int, void*) */uint hb_ft_get_nominal_glyphs(hb_font_t *param_1, void *param_2, uint param_3, uint *param_4, uint param_5, uint *param_6, uint param_7, void *param_8) {
   uint uVar1;
   uint uVar2;
   pthread_mutex_lock((pthread_mutex_t*)( (long)param_2 + 8 ));
   uVar2 = param_3;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* hb_ft_get_glyph_h_advances(hb_font_t*, void*, unsigned int, unsigned int const*, unsigned int,
   int*, unsigned int, void*) */void hb_ft_get_glyph_h_advances(hb_font_t *param_1, void *param_2, uint param_3, uint *param_4, uint param_5, int *param_6, uint param_7, void *param_8) {
   undefined4 uVar1;
   uint uVar2;
   uint uVar3;
   undefined8 uVar4;
...
/* hb_ft_draw_glyph(hb_font_t*, void*, unsigned int, hb_draw_funcs_t*, void*, void*) */void hb_ft_draw_glyph(hb_font_t *param_1, void *param_2, uint param_3, hb_draw_funcs_t *param_4, void *param_5, void *param_6) {
   ...
   if (*(int*)( param_1 + 0x3c ) != 0 || *(int*)( param_1 + 0x40 ) != 0) {
      ...
      LAB_00101b8e:lVar12 = *(long*)( lVar9 + 0x98 );
      if (uVar6 != 0) {
 ...
 while ( uVar10 < ( ( ulong )((long)( plVar2 + ( ulong )((int)sVar1 + 1) * 2 ) + ( -0x10 - (long)plVar2 )) >> 4 ) + 1 );
         }
   ...
   LAB_00101c09:FT_Outline_Decompose(lVar12 + 200, &local_b8, &local_88);
   pvVar4 = local_78;
   phVar3 = local_80;
   if (local_70._0_4_ != 0) {
   ...
   LAB_00101d13:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
   ...
   *(undefined4*)( this + 4 ) = 0;
   ...
   if (puVar4 == (undefined4*)0x0) {
      ...
      *(undefined4*)( this + 0x10 ) = 0xffffffff;
      _hb_font_funcs_set_nominal_glyph_func = CONCAT44(hb_font_funcs_set_nominal_glyph_func_4, _hb_font_funcs_create);
      __hb_CrapPool = uVar5;
      _hb_font_funcs_create = uVar6;
   }
 else {
...
/* hb_ft_font_funcs_lazy_loader_t::create() */undefined8 hb_ft_font_funcs_lazy_loader_t::create(void) {
   undefined8 uVar1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* hb_hashmap_t<unsigned int, unsigned int, true>::alloc(unsigned int) */hb_hashmap_t<unsigned_int,unsigned_int,true> hb_hashmap_t<unsigned_int,unsigned_int,true>::alloc(hb_hashmap_t<unsigned_int,unsigned_int,true> *this, uint param_1) {
   ...
   if (hVar10 == (hb_hashmap_t<unsigned_int,unsigned_int,true>)0x0) {
      LAB_00102ab3:hVar10 = (hb_hashmap_t<unsigned_int,unsigned_int,true>)0x0;
   }
 else {
      if (param_1 == 0) {
      ...
      if (uVar14 == 0) {
         ...
         iVar7 = 0xc;
         __size = 0xc;
         LAB_001027f9:pvVar4 = (void*)__memset_chk(pvVar4, 0, iVar7, __size);
      }
 else {
         iVar7 = 0x1f;
         if (uVar14 != 0) {
         ...
         if (pvVar4 == (void*)0x0) {
            LAB_00102aaf:this[0x10] = (hb_hashmap_t<unsigned_int,unsigned_int,true>)0x0;
            goto LAB_00102ab3;
         }
 ...
 while ( ( bVar1 & 2 ) != 0 );
                  if (uVar12 == 0xffffffff) {
                     LAB_00102a5a:uVar13 = uVar13 + 1;
                  }
 else {
                     LAB_00102974:lVar5 = (ulong)uVar12 * 0xc;
                     LAB_0010297f:piVar6 = (int*)( lVar2 + lVar5 );
            ...
            LAB_001028c0:piVar15 = piVar15 + 3;
         }
...
;
 ...
 while ( true );
      ...
      __mutex[1].__align = 0;
      *(undefined8*)( (long)__mutex + 0x30 ) = 0;
      LAB_00104908:pthread_mutex_destroy(__mutex);
      free(__mutex);
      *(undefined8*)( this + 8 ) = 0;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* hb_ft_paint_glyph_colr(hb_font_t*, void*, unsigned int, hb_paint_funcs_t*, void*, unsigned int,
   unsigned int, void*) [clone .isra.0] */bool hb_ft_paint_glyph_colr(hb_font_t *param_1, void *param_2, uint param_3, hb_paint_funcs_t *param_4, void *param_5, uint param_6, uint param_7, void *param_8) {
   byte bVar1;
   undefined8 uVar2;
 ...
 while ( cVar8 != '\0' );
      ...
      local_160 = param_5;
      local_150 = param_6;
      cVar8 = hb_hashmap_t<unsigned_int,unsigned_int,true>::alloc((hb_hashmap_t<unsigned_int,unsigned_int,true>*)&local_148, 0);
      uVar18 = _minus_1;
      if (cVar8 != '\0') {
 ...
 while ( ( bVar1 & 2 ) != 0 );
            if (uVar17 == 0xffffffff) {
               LAB_00104fda:local_134._4_4_ = local_134._4_4_ + 1;
            }
 else {
               LAB_00104c23:lVar11 = (ulong)uVar17 * 0xc;
               LAB_00104c2e:puVar12 = (uint*)( local_120 + lVar11 );
            ...
            *puVar12 = param_3;
            ...
            if (( local_136 < uVar14 ) && ( uVar5 < ( uint )(local_134._4_4_ << 3) )) {
               hb_hashmap_t<unsigned_int,unsigned_int,true>::alloc((hb_hashmap_t<unsigned_int,unsigned_int,true>*)&local_148, uVar5 - 8);
            }
      ...
      if (cVar8 == '\0') {
         ...
         hb_paint_extents_context_t::hb_paint_extents_context_t((hb_paint_extents_context_t*)local_1e8);
         local_b8 = local_200;
         local_ac = param_7;
         local_a8 = 1;
         local_a4 = 1;
         ...
         local_b0 = param_6;
         cVar8 = hb_hashmap_t<unsigned_int,unsigned_int,true>::alloc((hb_hashmap_t<unsigned_int,unsigned_int,true>*)&local_a8, 0);
         uVar18 = _minus_1;
         if (cVar8 != '\0') {
 ...
 while ( ( bVar1 & 2 ) != 0 );
               if (uVar17 == 0xffffffff) {
                  LAB_00105435:local_94._4_4_ = local_94._4_4_ + 1;
               }
 else {
                  LAB_00105210:lVar11 = (ulong)uVar17 * 0xc;
                  LAB_0010521b:puVar12 = (uint*)( lVar11 + local_80 );
               ...
               *puVar12 = param_3;
               ...
               if (( local_96 < uVar14 ) && ( uVar5 < ( uint )(local_94._4_4_ << 3) )) {
                  hb_hashmap_t<unsigned_int,unsigned_int,true>::alloc((hb_hashmap_t<unsigned_int,unsigned_int,true>*)&local_a8, uVar5 - 8);
               }
         ...
         hb_hashmap_t<unsigned_int,unsigned_int,true>::fini((hb_hashmap_t<unsigned_int,unsigned_int,true>*)&local_78);
         hb_hashmap_t<unsigned_int,unsigned_int,true>::fini((hb_hashmap_t<unsigned_int,unsigned_int,true>*)&local_a8);
         if (local_1c8 != 0) {
            free(local_1c0);
         }
         ...
         fVar19 = (float)( ( uint )((float)local_180 * fVar25) & uVar18 | ~uVar18 & ( uint )((float)local_190 * fVar25) ) + _LC8;
         if ((float)( (uint)fVar19 & _LC5 ) < _LC3) {
            fVar19 = (float)( ( uint )((float)(int)fVar19 - (float)( -(uint)(fVar19 < (float)(int)fVar19) & _LC1 )) | ~_LC5 & (uint)fVar19 );
         }
         ...
         fVar25 = (float)( ( uint )(fVar25 * auVar23._0_4_) & uVar18 | ~uVar18 & ( uint )((float)local_1a0 * fVar25) ) + _LC8;
         if ((float)( (uint)fVar25 & _LC5 ) < _LC3) {
            fVar25 = (float)( ( uint )((float)(int)fVar25 - (float)( -(uint)(fVar25 < (float)(int)fVar25) & _LC1 )) | ~_LC5 & (uint)fVar25 );
         }
         ...
         ( **(code**)( local_168 + 0x30 ) )(auVar20._0_8_, auVar23._0_8_, auVar24._0_8_, local_168, local_160, lVar11);
         bVar9 = true;
      }
      ...
      hb_hashmap_t<unsigned_int,unsigned_int,true>::fini((hb_hashmap_t<unsigned_int,unsigned_int,true>*)&local_118);
      hb_hashmap_t<unsigned_int,unsigned_int,true>::fini((hb_hashmap_t<unsigned_int,unsigned_int,true>*)&local_148);
   }

   bVar9 = true;
   LAB_00104a4e:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return bVar9;
   }
...
/* hb_ft_paint_glyph(hb_font_t*, void*, unsigned int, hb_paint_funcs_t*, void*, unsigned int,
   unsigned int, void*) */void hb_ft_paint_glyph(hb_font_t *param_1, void *param_2, uint param_3, hb_paint_funcs_t *param_4, void *param_5, uint param_6, uint param_7, void *param_8) {
   pthread_mutex_t *__mutex;
   char cVar1;
   int iVar2;
   undefined8 uVar3;
 ...
 else if (( ( *(int*)( lVar4 + 0x90 ) == 0x62697473 ) && ( *(char*)( lVar4 + 0xb2 ) == '\a' ) ) && ( *(int*)( lVar4 + 0xa0 ) == *(int*)( lVar4 + 0x9c ) << 2 )) {
         pthread_mutex_unlock(__mutex);
         uVar3 = hb_blob_create(*(undefined8*)( lVar4 + 0xa8 ), *(int*)( lVar4 + 0xa0 ) * *(int*)( lVar4 + 0x98 ), 0, 0, 0);
         iVar2 = hb_font_get_glyph_extents(param_1, param_3, local_58);
         if (iVar2 != 0) {
            ( **(code**)( param_4 + 0x48 ) )(*(undefined4*)( param_1 + 0x48 ), param_4, param_5, uVar3, *(undefined4*)( lVar4 + 0x9c ), *(undefined4*)( lVar4 + 0x98 ), 0x42475241, local_58);
         }
...
/* hb_table_lazy_loader_t<OT::OS2, 6u, true>::create(hb_face_t*) */undefined8 hb_table_lazy_loader_t<OT::OS2,6u,true>::create(hb_face_t *param_1) {
   uint uVar1;
   undefined8 uVar2;
   long lVar3;
   ushort uVar4;
...
/* hb_ft_get_nominal_glyph(hb_font_t*, void*, unsigned int, unsigned int*, void*) */undefined8 hb_ft_get_nominal_glyph(hb_font_t *param_1, void *param_2, uint param_3, uint *param_4, void *param_5) {
   long *plVar1;
   long lVar2;
   hb_face_t *phVar3;
   short sVar4;
   ...
   if (uVar5 == 0) {
      if (*(char*)( (long)param_2 + 4 ) == '\0') {
         LAB_001058d6:uVar9 = 0;
         goto LAB_001058b2;
      }

      lVar2 = *(long*)( param_1 + 0x20 );
      plVar1 = (long*)( lVar2 + 0xa0 );
      LAB_001058eb:lVar7 = *plVar1;
      if (lVar7 == 0) {
      ...
      if (*psVar6 == 0) {
         ...
         if (sVar4 == -0x4e00) {
            uVar10 = 0;
            if (param_3 < 0xfefd) {
               uVar10 = *(undefined2*)( _hb_arabic_u16 + ( ulong )(( param_3 & 7 ) + (uint)(byte)_hb_arabic_u8[( ( (int)(uint)(byte)_hb_arabic_u8[( ulong )(( ( (int)(uint)(byte)_hb_arabic_u8[param_3 >> 0xd] >> ( ( byte )(param_3 >> 10) & 6 ) & 3U ) << 4 | param_3 >> 7 & 0xf ) >> 1) + 8] >> ( sbyte )(( param_3 >> 7 & 1 ) << 2) & 0xfU ) << 4 | param_3 >> 3 & 0xf ) + 0x28] * 8) * 2 );
            }
            ...
            uVar10 = 0;
            if (param_3 < 0xfefd) {
               uVar10 = *(undefined2*)( _hb_arabic_u16 + ( ulong )(( param_3 & 3 ) + 0x140 + (uint)(byte)_hb_arabic_u8[( ( (int)(uint)(byte)_hb_arabic_u8[( ulong )(( ( (int)(uint)(byte)_hb_arabic_u8[( ulong )(param_3 >> 0xb) + 0x88] >> ( ( byte )(param_3 >> 8) & 4 ) & 0xfU ) << 4 | param_3 >> 6 & 0xf ) >> 1) + 0xa8] >> ( sbyte )(( param_3 >> 6 & 1 ) << 2) & 0xfU ) << 4 | param_3 >> 2 & 0xf ) + 0xd0] * 4) * 2 );
            }
         ...
         LAB_00105930:if (0xff < param_3) goto LAB_001058d6;
   ...
   *param_4 = uVar5;
   uVar9 = 1;
   LAB_001058b2:pthread_mutex_unlock((pthread_mutex_t*)( (long)param_2 + 8 ));
   return uVar9;
   code_r0x00105b07:if (lVar7 != 0) {
      LAB_00105aa9:lVar8 = hb_blob_get_empty();
      if (lVar7 != lVar8) {
...
/* WARNING: Control flow encountered bad instruction data *//* hb_paint_extents_context_t::hb_paint_extents_context_t() */void hb_paint_extents_context_t::hb_paint_extents_context_t(hb_paint_extents_context_t *this) {

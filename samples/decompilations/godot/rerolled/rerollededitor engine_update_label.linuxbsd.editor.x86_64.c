...
/* EngineUpdateLabel::_can_check_updates() const */bool EngineUpdateLabel::_can_check_updates(void) {
   long *plVar1;
   char cVar2;
   long lVar3;
   int iVar4;
...
/* EngineUpdateLabel::_set_message(String const&, Color const&) */void EngineUpdateLabel::_set_message(String *param_1, Color *param_2) {
   char cVar1;
   long in_FS_OFFSET;
   long local_38;
   long local_30;
   ...
   if (cVar1 == '\0') {
      Control::add_theme_color_override((StringName*)param_1, (Color*)( SceneStringNames::singleton + 0xb0 ));
   }
 else {
...
/* EngineUpdateLabel::_extract_sub_string(String const&) const */String *EngineUpdateLabel::_extract_sub_string(String *param_1) {
   long lVar1;
   wchar32 in_EDX;
   long in_FS_OFFSET;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* EngineUpdateLabel::EngineUpdateLabel() */void EngineUpdateLabel::EngineUpdateLabel(EngineUpdateLabel *this) {
   long *plVar1;
   char cVar2;
   code *pcVar3;
   undefined8 uVar4;
   ...
   *(undefined8*)( this + 0xb60 ) = 0;
   for (int i = 0; i < 4; i++) {
      *(undefined8*)( this + ( 16*i + 2832 ) ) = uVar4;
      *(undefined8*)( this + ( 16*i + 2840 ) ) = uVar5;
   }
...
/* EngineUpdateLabel::_bind_methods() */void EngineUpdateLabel::_bind_methods(void) {
   long *plVar1;
   long lVar2;
   code *pcVar3;
...
/* WARNING: Removing unreachable block (ram,0x00100b3e) *//* WARNING: Removing unreachable block (ram,0x00100e48) *//* WARNING: Removing unreachable block (ram,0x00100b4a) *//* WARNING: Removing unreachable block (ram,0x00100be1) *//* WARNING: Removing unreachable block (ram,0x00100e20) *//* WARNING: Removing unreachable block (ram,0x00100bed) *//* EngineUpdateLabel::_get_version_type(String const&, int*) const */undefined4 EngineUpdateLabel::_get_version_type(EngineUpdateLabel *this, String *param_1, int *param_2) {
   long *plVar1;
   undefined8 *puVar2;
   long lVar3;
   char cVar4;
   ...
   if (( _get_version_type(String_const&,int*):: ) && ( iVar5 = __cxa_guard_acquire(&_get_version_type(String_const & ::type_map), iVar5 != 0) ) {
      _get_version_type(String_const &, int *) {
         local_58 = local_48;
      }
...
uVar8 = 5;pcVar6 = local_58;joined_r0x00100b59:if (param_2 == (int*)0x0) {
   joined_r0x00100b5e:if (pcVar6 == (undefined*)0x0) goto LAB_00100b60;
}
 else {
...
LOCK();plVar1 = (long*)( pcVar6 + -0x10 );*plVar1 = *plVar1 + -1;UNLOCK();if (*plVar1 == 0) {
   Memory::free_static(local_58 + -0x10, false);
}
LAB_00100b60:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return uVar8;}/* EngineUpdateLabel::_set_status(EngineUpdateLabel::UpdateStatus) [clone .part.0] */void EngineUpdateLabel::_set_status(String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   int iVar4;
   ...
   LAB_001010eb:if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* EngineUpdateLabel::_set_status(EngineUpdateLabel::UpdateStatus) */void EngineUpdateLabel::_set_status(EngineUpdateLabel *this, int param_2) {
...
/* EngineUpdateLabel::_check_update() */void EngineUpdateLabel::_check_update(EngineUpdateLabel *this) {
   long *plVar1;
   undefined8 uVar2;
   long lVar3;
   long in_FS_OFFSET;
...
/* EngineUpdateLabel::_notification(int) */void EngineUpdateLabel::_notification(int param_1) {
   long *plVar1;
   long lVar2;
   char cVar3;
   String *pSVar4;
   ...
   if (in_ESI == 0x2d) {
      ...
      uVar6 = Control::get_theme_color((StringName*)this, (StringName*)( SceneStringNames::singleton + 0xb0 ));
      ...
      *(undefined8*)( this + 0xb28 ) = in_XMM1_Qa;
      ...
      LAB_0010160e:StringName::StringName((StringName*)&local_38, "error_color", false);
      ...
      *(undefined8*)( this + 0xb48 ) = in_XMM1_Qa;
      ...
      LAB_00101519:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
         return;
      }
      ...
      if (in_ESI == 10000) {
         ...
         cVar3 = _can_check_updates();
         if (cVar3 == '\0') {
            LAB_001016c0:*(undefined4*)( this + 0xb58 ) = 1;
            if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
               _set_status(this);
               return;
            }
   ...
   LAB_00101733:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* EngineUpdateLabel::pressed() */void EngineUpdateLabel::pressed(EngineUpdateLabel *this) {
   int iVar1;
   code *pcVar2;
   long lVar3;
   long *plVar4;
   ...
   if (iVar1 == 3) {
      ...
      if (iVar1 == 4) {
         ...
         operator+((char *)&
         local_50,(String*)"https://godotengine.org/download/archive/";
         ( *pcVar2 )(plVar4);
         lVar3 = local_50;
         if (local_50 != 0) {
            LOCK();
...
/* EngineUpdateLabel::_http_request_completed(int, int, Vector<String> const&, Vector<unsigned char>
   const&) */void EngineUpdateLabel::_http_request_completed(EngineUpdateLabel *this, int param_1, int param_2, Vector *param_3, Vector *param_4) {
   long *plVar1;
   code *pcVar2;
   char *pcVar3;
   char cVar4;
            ...
            if (local_78[0] == 0x1c) {
               ...
               if (local_c8[0] != local_d8) {
                  do {
                     ...
                     if (local_b0 == 0) {
                        lVar11 = 0;
                        LAB_00102493:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, 0, lVar11, "p_index", "size()", "", false, true);
                        _err_flush_stdout();
                        /* WARNING: Does not return */
                           ...
                           if (cVar4 == '\0') {
                              ...
                              if (( local_1b0 <= iVar8 ) && ( iVar9 <= iVar7 )) {
                                 ...
                                 if (( iVar10 <= iVar5 ) && ( ( iVar10 != iVar5 || ( local_12c < local_130 ) ) )) {
                                    ...
                                    vformat<String,String>((Variant*)&local_a8, (StrRange*)&local_f0, (CowData<char32_t>*)&local_e8, (CowData<char32_t>*)&local_e0);
                                    pcVar3 = local_a8;
                     ...
                     LAB_00101db8:CowData<String>::_unref((CowData<String>*)&local_b0);
                     lVar11 = local_110;
                     if (local_110 != 0) {
                        LOCK();
 ...
 while ( local_d8 != local_c8[0] );
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_d8);
   CowData<char32_t>::_unref((CowData<char32_t>*)local_c8);
   LAB_00101f30:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* CallableCustomMethodPointer<EngineUpdateLabel, void, int, int, Vector<String> const&,
   Vector<unsigned char> const&>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<EngineUpdateLabel,void,int,int,Vector<String>const&,Vector<unsigned_char>const&>::~CallableCustomMethodPointer(CallableCustomMethodPointer<EngineUpdateLabel,void,int,int,Vector<String>const&,Vector<unsigned_char>const&> *this) {
   return;
}
/* CallableCustomMethodPointer<EngineUpdateLabel, void, int, int, Vector<String> const&,
   Vector<unsigned char> const&>::get_argument_count(bool&) const */undefined8 CallableCustomMethodPointer<EngineUpdateLabel,void,int,int,Vector<String>const&,Vector<unsigned_char>const&>::get_argument_count(CallableCustomMethodPointer<EngineUpdateLabel,void,int,int,Vector<String>const&,Vector<unsigned_char>const&> *this, bool *param_1) {
   *param_1 = true;
   return 4;
}
...
/* EngineUpdateLabel::_property_get_revertv(StringName const&, Variant&) const */undefined8 EngineUpdateLabel::_property_get_revertv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
...
/* EngineUpdateLabel::_property_can_revertv(StringName const&) const */undefined8 EngineUpdateLabel::_property_can_revertv(StringName *param_1) {
   undefined8 uVar1;
...
/* EngineUpdateLabel::_get_class_namev() const */undefined8 *EngineUpdateLabel::_get_class_namev(void) {
   int iVar1;
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      ...
      if (*(long*)( _get_class_namev() ) != 0) {
         ...
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "EngineUpdateLabel");
         goto LAB_00102bbe;
      }
...
/* CallableCustomMethodPointer<EngineUpdateLabel, void, int, int, Vector<String> const&,
   Vector<unsigned char> const&>::get_object() const */undefined8 CallableCustomMethodPointer<EngineUpdateLabel,void,int,int,Vector<String>const&,Vector<unsigned_char>const&>::get_object(CallableCustomMethodPointer<EngineUpdateLabel,void,int,int,Vector<String>const&,Vector<unsigned_char>const&> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
...
/* EngineUpdateLabel::_validate_propertyv(PropertyInfo&) const */void EngineUpdateLabel::_validate_propertyv(PropertyInfo *param_1) {
...
/* EngineUpdateLabel::_setv(StringName const&, Variant const&) */undefined8 EngineUpdateLabel::_setv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
...
/* WARNING: Removing unreachable block (ram,0x00102ea8) *//* EngineUpdateLabel::_getv(StringName const&, Variant&) const */undefined8 EngineUpdateLabel::_getv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
...
/* EngineUpdateLabel::is_class_ptr(void*) const */uint EngineUpdateLabel::is_class_ptr(void *param_1) {
   uint uVar1;
   undefined4 in_EDX;
   undefined4 *in_RSI;
   uVar1 = 1;
   if (in_RSI != &get_class_ptr_static()::ptr) {
      uVar1 = (uint)CONCAT71(0x1083, in_RSI == &BaseButton::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1083, in_RSI == &LinkButton::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1083, in_RSI == &Control::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1083, in_RSI == &CanvasItem::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1083, in_RSI == &Node::get_class_ptr_static(), ::ptr) | CONCAT31(( int3 )((uint)in_EDX >> 8), in_RSI == &Object::get_class_ptr_static(), ::ptr);
   }
...
/* HashMap<String, EngineUpdateLabel::VersionType, HashMapHasherDefault,
   ...
   EngineUpdateLabel::VersionType> > >::~HashMap() */void HashMap<String,EngineUpdateLabel::VersionType,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,EngineUpdateLabel::VersionType>>>::~HashMap(HashMap<String,EngineUpdateLabel::VersionType,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,EngineUpdateLabel::VersionType>>> *this) {
   long *plVar1;
   uint uVar2;
   long lVar3;
   long lVar4;
...
/* EngineUpdateLabel::get_class() const */void EngineUpdateLabel::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* CanvasItem::is_class(String const&) const */undefined8 CanvasItem::is_class(CanvasItem *this, String *param_1) {
 ...
 while ( !bVar9 );
      ...
      LAB_001035df:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
 ...
 while ( !bVar9 );
         ...
         LAB_0010376b:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
 ...
 while ( !bVar9 );
            ...
            LAB_0010384b:cVar6 = String::operator ==(param_1, (String*)&local_60);
            lVar4 = local_60;
            if (local_60 != 0) {
               LOCK();
               plVar1 = (long*)( local_60 + -0x10 );
   ...
   LAB_00103693:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_001038f4:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* BaseButton::is_class(String const&) const */undefined8 BaseButton::is_class(BaseButton *this, String *param_1) {
 ...
 while ( !bVar9 );
      ...
      LAB_0010426f:cVar6 = String::operator ==(param_1, (String*)&local_60);
      lVar4 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
 ...
 while ( !bVar9 );
         ...
         LAB_001043e3:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
   ...
   LAB_00104323:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0010448c:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* EngineUpdateLabel::is_class(String const&) const */undefined8 EngineUpdateLabel::is_class(EngineUpdateLabel *this, String *param_1) {
   long *plVar1;
   long lVar2;
   char *pcVar3;
   long lVar4;
 ...
 while ( !bVar9 );
         ...
         LAB_00104683:cVar6 = String::operator ==(param_1, (String*)&local_60);
         lVar4 = local_60;
         if (local_60 != 0) {
            LOCK();
            plVar1 = (long*)( local_60 + -0x10 );
   ...
   LAB_0010472c:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* LinkButton::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void LinkButton::_get_property_listv(LinkButton *this, List *param_1, bool param_2) {
   long *plVar1;
   long lVar2;
   long lVar3;
   undefined1(*pauVar4)[16];
...
/* EngineUpdateLabel::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void EngineUpdateLabel::_get_property_listv(EngineUpdateLabel *this, List *param_1, bool param_2) {
   long *plVar1;
   long lVar2;
   long lVar3;
   undefined1(*pauVar4)[16];
...
/* LinkButton::~LinkButton() */void LinkButton::~LinkButton(LinkButton *this) {
   long *plVar1;
   long lVar2;
   Object *pOVar3;
   char cVar4;
...
/* EngineUpdateLabel::~EngineUpdateLabel() */void EngineUpdateLabel::~EngineUpdateLabel(EngineUpdateLabel *this) {
   long *plVar1;
   long lVar2;
   *(undefined***)this = &PTR__initialize_classv_00107fa0;
   if (*(long*)( this + 0xb60 ) != 0) {
...
/* EngineUpdateLabel::_bind_methods() [clone .cold] */void EngineUpdateLabel::_bind_methods(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<String, EngineUpdateLabel::VersionType, HashMapHasherDefault,
   HashMapComparatorDefault<String>, DefaultTypedAllocator<HashMapElement<String,
   EngineUpdateLabel::VersionType> > >::operator[](String const&) */undefined1 * __thiscallHashMap<String,EngineUpdateLabel::VersionType,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,EngineUpdateLabel::VersionType>>>::operator [](HashMap<String,EngineUpdateLabel::VersionType,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,EngineUpdateLabel::VersionType>>> * this, String * param_1) * plVar1 ;void *pvVar2void *__slong lVar3undefined1 auVar4[16]undefined1 auVar5[16]undefined1 auVar6[16]undefined1 auVar7[16]undefined1 auVar8[16]undefined1 auVar9[16]undefined1 auVar10[16]undefined1 auVar11[16]undefined1 auVar12[16]undefined1 auVar13[16]undefined1 auVar14[16]undefined1 auVar15[16]undefined1 auVar16[16]undefined1 auVar17[16]undefined1 auVar18[16]undefined1 auVar19[16]undefined1 auVar20[16]undefined1 auVar21[16]undefined1 auVar22[16]undefined1 auVar23[16]undefined1 auVar24[16]undefined1 auVar25[16]undefined1 auVar26[16]undefined1 auVar27[16]undefined1 auVar28[16]undefined1 auVar29[16]undefined1 auVar30[16]undefined1 auVar31[16]undefined1 auVar32[16]undefined1 auVar33[16]undefined1 auVar34[16]undefined1 auVar35[16]char cVar36uint uVar37uint uVar38ulong uVar39undefined8 uVar40void *__s_00undefined1(*pauVar41)[16];undefined8 *puVar42void *pvVar43ulong uVar44int iVar45long lVar46long lVar47ulong uVar48undefined8 uVar49uint *puVar50uint uVar51uint uVar52long lVar53uint uVar54uint uVar55undefined1(*pauVar56)[16];undefined1(*pauVar57)[16];long in_FS_OFFSETlong local_58undefined4 local_50long local_40local_40 = *(long*)( in_FS_OFFSET + 0x28 );uVar55 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );if (*(long*)( this + 8 ) == 0) {
   LAB_00106428:uVar39 = (ulong)uVar55;
   uVar44 = uVar39 * 4;
   uVar48 = uVar39 * 8;
 ...
 while ( uVar39 != uVar44 );
      ...
      LAB_001062be:if (iVar45 != 0) {
         LAB_001062c6:uVar37 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
 ...
 while ( ( uVar52 != 0 ) && ( auVar18._8_8_ = 0 ),auVar18._0_8_ = (ulong)uVar52 * lVar3,auVar34._8_8_ = 0,auVar34._0_8_ = uVar39,auVar19._8_8_ = 0,auVar19._0_8_ = ( ulong )(( uVar37 + uVar51 ) - SUB164(auVar18 * auVar34, 8)) * lVar3,auVar35._8_8_ = 0,auVar35._0_8_ = uVar39,uVar54 <= SUB164(auVar19 * auVar35, 8) );
   ...
   LAB_00105dda:uVar55 = *(uint*)( this + 0x28 );
   if (uVar55 == 0x1c) {
...
;
 ...
 while ( ( uVar38 != 0 ) && ( auVar14._8_8_ = 0 ),auVar14._0_8_ = (ulong)uVar38 * lVar3,auVar30._8_8_ = 0,auVar30._0_8_ = uVar39,auVar15._8_8_ = 0,auVar15._0_8_ = ( ulong )(( uVar52 + uVar55 ) - SUB164(auVar14 * auVar30, 8)) * lVar3,auVar31._8_8_ = 0,auVar31._0_8_ = uVar39,uVar51 <= SUB164(auVar15 * auVar31, 8) );
      ...
      LAB_001062ba:iVar45 = *(int*)( this + 0x2c );
      goto LAB_001062be;
   }

   LAB_00105db4:if ((float)uVar39 * __LC28 < (float)( iVar45 + 1 )) goto LAB_00105dda;
}
local_58 = 0;if (*(long*)param_1 == 0) {
   pauVar41 = (undefined1(*) [16])operator_new(0x20, "");
   *(undefined8*)pauVar41[1] = 0;
   *pauVar41 = (undefined1[16])0x0;
   LAB_001063fb:*(undefined4*)( pauVar41[1] + 8 ) = 0;
   LAB_00106061:puVar42 = *(undefined8**)( this + 0x20 );
   if (puVar42 != (undefined8*)0x0) goto LAB_0010606e;
   LAB_00106295:*(undefined1(**) [16])( this + 0x18 ) = pauVar41;
}
 else {
...
*(undefined1(**) [16])( lVar46 + lVar47 * 8 ) = pauVar57;*puVar50 = uVar55;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_00106173:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return pauVar41[1] + 8;
}
...
/* EngineUpdateLabel::_initialize_classv() */void EngineUpdateLabel::_initialize_classv(void) {
   long *plVar1;
   long lVar2;
   long in_FS_OFFSET;
   long local_70;
   ...
   if (initialize_class() == '\0') {
      if (LinkButton::initialize_class() == '\0') {
         ...
         LinkButton::initialize_class()::initialized =
         '\x01';
      }
...
/* WARNING: Removing unreachable block (ram,0x00106e58) *//* WARNING: Removing unreachable block (ram,0x00106f8d) *//* WARNING: Removing unreachable block (ram,0x001070c0) *//* WARNING: Removing unreachable block (ram,0x00106f99) *//* WARNING: Removing unreachable block (ram,0x00106fab) *//* WARNING: Removing unreachable block (ram,0x001070a0) *//* WARNING: Removing unreachable block (ram,0x00106fb7) *//* WARNING: Removing unreachable block (ram,0x00106fc1) *//* WARNING: Removing unreachable block (ram,0x00107080) *//* WARNING: Removing unreachable block (ram,0x00106fcd) *//* WARNING: Removing unreachable block (ram,0x00106fe1) *//* WARNING: Removing unreachable block (ram,0x00107060) *//* WARNING: Removing unreachable block (ram,0x00106fe9) *//* WARNING: Removing unreachable block (ram,0x00106fff) *//* WARNING: Removing unreachable block (ram,0x0010700b) *//* String vformat<int>(String const&, int const) */String *vformat<int>(String *param_1, int param_2) {
   char cVar1;
   Variant *this;
   int in_EDX;
...
/* WARNING: Removing unreachable block (ram,0x00107240) *//* WARNING: Removing unreachable block (ram,0x00107376) *//* WARNING: Removing unreachable block (ram,0x0010746d) *//* WARNING: Removing unreachable block (ram,0x00107382) *//* WARNING: Removing unreachable block (ram,0x0010738c) *//* WARNING: Removing unreachable block (ram,0x0010744f) *//* WARNING: Removing unreachable block (ram,0x00107398) *//* WARNING: Removing unreachable block (ram,0x001073aa) *//* WARNING: Removing unreachable block (ram,0x00107431) *//* WARNING: Removing unreachable block (ram,0x001073b2) *//* WARNING: Removing unreachable block (ram,0x001073c6) *//* WARNING: Removing unreachable block (ram,0x00107416) *//* WARNING: Removing unreachable block (ram,0x001073ce) *//* WARNING: Removing unreachable block (ram,0x001073ec) *//* WARNING: Removing unreachable block (ram,0x001073f8) *//* String vformat<String, String>(String const&, String const, String const) */undefined8 *vformat<String,String>(undefined8 *param_1, bool *param_2, String *param_3, String *param_4) {
   Variant *pVVar1;
   Variant *pVVar2;
   int iVar3;
   long in_FS_OFFSET;
...
/* WARNING: Removing unreachable block (ram,0x001075a8) *//* WARNING: Removing unreachable block (ram,0x001076df) *//* WARNING: Removing unreachable block (ram,0x00107850) *//* WARNING: Removing unreachable block (ram,0x001076eb) *//* WARNING: Removing unreachable block (ram,0x001076f5) *//* WARNING: Removing unreachable block (ram,0x00107830) *//* WARNING: Removing unreachable block (ram,0x00107701) *//* WARNING: Removing unreachable block (ram,0x0010770b) *//* WARNING: Removing unreachable block (ram,0x00107810) *//* WARNING: Removing unreachable block (ram,0x00107717) *//* WARNING: Removing unreachable block (ram,0x0010772b) *//* WARNING: Removing unreachable block (ram,0x001077f0) *//* WARNING: Removing unreachable block (ram,0x00107737) *//* WARNING: Removing unreachable block (ram,0x00107741) *//* WARNING: Removing unreachable block (ram,0x001077d0) *//* WARNING: Removing unreachable block (ram,0x0010774d) *//* WARNING: Removing unreachable block (ram,0x0010776b) *//* WARNING: Removing unreachable block (ram,0x00107777) *//* String vformat<String>(String const&, String const) */undefined8 *vformat<String>(undefined8 *param_1, bool *param_2, String *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* WARNING: Removing unreachable block (ram,0x001079d0) *//* EngineUpdateLabel::_notificationv(int, bool) */void EngineUpdateLabel::_notificationv(EngineUpdateLabel *this, int param_1, bool param_2) {
   int iVar1;
   iVar1 = (int)this;
   if (param_2) {
      _notification(iVar1);
...
/* CallableCustomMethodPointer<EngineUpdateLabel, void, int, int, Vector<String> const&,
    ...
    */void CallableCustomMethodPointer<EngineUpdateLabel,void,int,int,Vector<String>const&,Vector<unsigned_char>const&>::call(CallableCustomMethodPointer<EngineUpdateLabel,void,int,int,Vector<String>const&,Vector<unsigned_char>const&> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long *plVar1;
   long lVar2;
   long lVar3;
   ulong uVar4;
...
;
   ...
   _err_print_error(&_LC77, "./core/object/callable_method_pointer.h", 0x67, "Parameter \"ObjectDB::get_instance(ObjectID(data.object_id))\" is null.", (Variant*)&local_58, 0);
   pcVar6 = local_58;
   if (local_58 != (char*)0x0) {
      LOCK();
      plVar1 = (long*)( local_58 + -0x10 );
   ...
   LAB_00107bc4:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Control flow encountered bad instruction data *//* EngineUpdateLabel::~EngineUpdateLabel() */void EngineUpdateLabel::~EngineUpdateLabel(EngineUpdateLabel *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* LinkButton::~LinkButton() */void LinkButton::~LinkButton(LinkButton *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* HashMap<String, EngineUpdateLabel::VersionType, HashMapHasherDefault,
   HashMapComparatorDefault<String>, DefaultTypedAllocator<HashMapElement<String,
   EngineUpdateLabel::VersionType> > >::~HashMap() */void HashMap<String,EngineUpdateLabel::VersionType,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,EngineUpdateLabel::VersionType>>>::~HashMap(HashMap<String,EngineUpdateLabel::VersionType,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,EngineUpdateLabel::VersionType>>> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<EngineUpdateLabel, void, int, int, Vector<String> const&,
   Vector<unsigned char> const&>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<EngineUpdateLabel,void,int,int,Vector<String>const&,Vector<unsigned_char>const&>::~CallableCustomMethodPointer(CallableCustomMethodPointer<EngineUpdateLabel,void,int,int,Vector<String>const&,Vector<unsigned_char>const&> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

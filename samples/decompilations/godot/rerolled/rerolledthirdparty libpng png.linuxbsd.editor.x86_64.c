int png_fp_sub(int param_1, int param_2, undefined4 *param_3) {
   if (param_2 < 1) {
      ...
      LAB_0010002e:return param_1 - param_2;
   }
...
undefined8 png_colorspace_set_xy_and_XYZ(undefined8 param_1, long param_2, undefined8 *param_3, undefined8 *param_4, int param_5) {
   ushort uVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   undefined8 uVar4;
...
int png_compare_ICC_profile_with_sRGB(long param_1, uint *param_2, ulong param_3) {
   ...
   puVar4 = &DAT_00106f68;
   do {
      if (( ( ( puVar4[1] == ( uVar2 >> 0x18 | ( uVar2 & 0xff0000 ) >> 8 | ( uVar2 & 0xff00 ) << 8 | uVar2 << 0x18 ) ) && ( uVar3 = param_2[0x16] ),puVar4[2] == ( uVar3 >> 0x18 | ( uVar3 & 0xff0000 ) >> 8 | ( uVar3 & 0xff00 ) << 8 | uVar3 << 0x18 ) ) ) && ( uVar3 = param_2[0x17] ),puVar4[3] == ( uVar3 >> 0x18 | ( uVar3 & 0xff0000 ) >> 8 | ( uVar3 & 0xff00 ) << 8 | uVar3 << 0x18 )) {
         if (uVar10 == 0) {
            uVar9 = *param_2;
            uVar3 = param_2[0x10];
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void png_build_16bit_table(undefined8 param_1, ulong *param_2, int param_3, int param_4) {
   uint uVar1;
   char cVar2;
   uint uVar3;
   ulong uVar4;
 ...
 while ( lVar11 != 0x100 );
         ...
         do {
            ...
            if ((double)( _LC12 & (ulong)dVar12 ) < _LC10) {
               dVar12 = (double)( ( ulong )((double)(long)dVar12 - (double)( -(ulong)(dVar12 < (double)(long)dVar12) & (ulong)_LC1 )) | ~_LC12 & (ulong)dVar12 );
            }
...
undefined8 png_muldiv_part_0(int *param_1, int param_2, int param_3, int param_4) {
   ...
   if ((double)( (ulong)dVar1 & _LC12 ) < _LC10) {
      dVar1 = (double)( ( ulong )((double)(long)dVar1 - (double)( -(ulong)(dVar1 < (double)(long)dVar1) & _LC1 )) | ~_LC12 & (ulong)dVar1 );
   }
...
undefined8 png_safe_add(int *param_1, int param_2, int param_3) {
   ...
   LAB_00100cd8:*param_1 = param_3;
   return 0;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void png_build_8bit_table(undefined8 param_1, undefined8 *param_2, int param_3) {
   short sVar1;
   short sVar2;
   short sVar3;
   short sVar4;
 ...
 while ( pcVar41 != pcVar38 + 0x100 );
   ...
   do {
      ...
      if ((double)( (ulong)dVar43 & _LC12 ) < _LC10) {
         dVar43 = (double)( ( ulong )((double)(long)dVar43 - (double)( -(ulong)(dVar43 < (double)(long)dVar43) & _LC1 )) | ~_LC12 & (ulong)dVar43 );
      }
...
undefined8 png_icc_profile_error(undefined8 param_1, long param_2, undefined8 param_3, ulong param_4, undefined8 param_5) {
   uint uVar1;
   long lVar2;
   undefined8 uVar3;
   ulong uVar4;
   ...
   uVar4 = param_4 >> 0x18;
   if (( ( ( uVar4 - 0x30 < 10 ) || ( uVar4 == 0x20 ) ) || ( ( uVar4 & 0xffffffffffffffdf ) - 0x41 < 0x1a ) ) && ( ( ( uVar4 = param_4 >> 0x10 & 0xff ),uVar1 = ( uint )(param_4 >> 0x10),uVar4 - 0x30 < 10 || ( uVar4 == 0x20 ) ) || ( ( ulong )(uVar1 & 0xdf) - 0x41 < 0x1a ) )) {
      bVar7 = ( byte )(param_4 >> 8);
      if (( ( (ulong)bVar7 - 0x30 < 10 ) || ( (ulong)bVar7 == 0x20 ) ) || ( ( ulong )(( uint )(param_4 >> 8) & 0xdf) - 0x41 < 0x1a )) {
         if (( ( ( param_4 & 0xff ) - 0x30 < 10 ) || ( ( param_4 & 0xff ) == 0x20 ) ) || ( ( ulong )((uint)param_4 & 0xdf) - 0x41 < 0x1a )) {
   ...
   LAB_00101028:png_safecat(local_108, 0xc4, lVar5, param_5);
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */bool png_colorspace_check_gamma(undefined8 param_1, int *param_2, int param_3, int param_4) {
   double dVar1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */bool png_xy_from_XYZ(int *param_1, uint *param_2) {
   uint uVar1;
   int iVar2;
   uint uVar3;
   uint uVar4;
   ...
   if ((int)uVar1 < 1) {
      if (uVar1 == 0) {
         if ((int)uVar3 < 1) {
            LAB_001013b0:if (uVar3 == 0) {
               local_34 = uVar4;
               if (uVar4 != 0) {
                  iVar2 = 0;
                  LAB_0010140e:*param_1 = iVar2;
                  uVar3 = param_2[1];
                  if (uVar3 != 0) {
                     dVar8 = ( (double)(int)uVar3 * __LC26 ) / (double)(int)uVar4 + _LC9;
                     if ((double)( (ulong)dVar8 & _LC12 ) < _LC10) {
                        dVar8 = (double)( ( ulong )((double)(long)dVar8 - (double)( -(ulong)(dVar8 < (double)(long)dVar8) & _LC1 )) | ~_LC12 & (ulong)dVar8 );
                     }
            ...
            LAB_00101308:uVar4 = uVar4 + uVar3;
            local_34 = uVar4;
            if (uVar4 != 0) {
               dVar8 = ( (double)(int)uVar3 * __LC26 ) / (double)(int)uVar4 + _LC9;
               if ((double)( (ulong)dVar8 & _LC12 ) < _LC10) {
   ...
   LAB_001012cf:bVar7 = true;
   LAB_001012d4:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 png_user_version_check(long param_1, long param_2) {
 ...
 while ( true );
   ...
   *(uint*)( param_1 + 0x130 ) = uVar5 | 0x20000;
   LAB_00101a5c:uVar3 = png_safecat(auStack_a8, 0x80, 0, "Application built with libpng-");
   ...
   uVar3 = 0;
   LAB_00101a29:if (local_20 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar3;
   }

   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
   LAB_00101a1a:uVar3 = 1;
   if (( uVar5 & 0x20000 ) == 0) goto LAB_00101a29;
   goto LAB_00101a5c;
}
undefined8 *png_create_png_struct(undefined8 param_1, undefined8 param_2, undefined8 param_3, undefined8 param_4, undefined8 param_5, undefined8 param_6, undefined8 param_7) {
   int iVar1;
   undefined8 *puVar2;
   long lVar3;
   undefined8 *puVar4;
   ...
   LAB_00101c32:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
   ...
   if (param_1 != 0) {
      ...
      if (puVar1 != (undefined8*)0x0) {
         *puVar1 = 0;
         ...
         for (uVar2 = ( ulong )(( (int)puVar1 - (int)(undefined8*)( ( ulong )(puVar1 + 1) & 0xfffffffffffffff8 ) ) + 0x170U >> 3); uVar2 != 0; uVar2 = uVar2 - 1) {
            *puVar3 = 0;
...
void png_info_init_3(undefined8 *param_1, ulong param_2) {
   ...
   *puVar1 = 0;
   puVar1[0x2d] = 0;
   uVar2 = ( ulong )(( (int)puVar1 - (int)(undefined8*)( ( ulong )(puVar1 + 1) & 0xfffffffffffffff8 ) ) + 0x170U >> 3);
...
undefined8 png_convert_to_rfc1123_buffer(long param_1, ushort *param_2) {
   ...
   if (param_1 == 0) {
      ...
      uVar1 = 0;
      uVar3 = 0;
      if (( ( ( *param_2 < 10000 ) && ( ( byte )((char)param_2[1] - 1U) < 0xc ) ) && ( ( byte )(*(char*)( (long)param_2 + 3 ) - 1U) < 0x1f ) ) && ( ( ( uVar1 = uVar3 ),(byte)param_2[2] < 0x18 && ( *(byte*)( (long)param_2 + 5 ) < 0x3c ) ) && ( (byte)param_2[3] < 0x3d ) )) {
         local_31 = 0;
         local_35 = 0;
...
void png_build_grayscale_palette(int param_1, undefined2 *param_2) {
   ...
   undefined2 *puVar6;
   uint uVar7;
   if (( param_2 != (undefined2*)0x0 ) && ( uVar7 = uVar7 < 8 )) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 png_colorspace_set_sRGB(undefined8 param_1, undefined8 *param_2, uint param_3) {
   ushort uVar1;
   undefined8 uVar2;
   undefined8 uVar3;
   int iVar4;
...
undefined8 png_icc_check_length(long param_1, undefined8 param_2, undefined8 param_3, uint param_4) {
   ...
   if (( 0x83 < param_4 ) || ( uVar1 = png_icc_profile_error() ),(int)uVar1 != 0) {
      uVar1 = 1;
      if (( *(ulong*)( param_1 + 0x430 ) != 0 ) && ( uVar1 = 1 * (ulong*)( param_1 + 0x430 ) < (ulong)param_4 )) {
         uVar1 = png_icc_profile_error(param_1, param_2, param_3, (ulong)param_4, "exceeds application limits");
         return uVar1;
      }
...
undefined8 png_icc_check_header(undefined8 param_1, undefined8 param_2, undefined8 param_3, uint param_4, uint *param_5, uint param_6) {
   uint uVar1;
   undefined8 uVar2;
   uint uVar3;
   char *pcVar4;
   ...
   if (uVar1 != 0x72746e6d) {
      if (uVar3 < 0x6d6e7473) {
         ...
         LAB_00102874:pcVar4 = "unrecognized ICC profile class";
      }
 else {
         if (uVar1 != 0x6c636d6e) {
            if (( 0x6e6d636b < uVar3 ) && ( ( ( uVar1 == 0x726e6373 || ( uVar1 == 0x63617073 ) ) || ( uVar1 == 0x72747270 ) ) )) goto LAB_00102891;
            goto LAB_00102874;
         }
   ...
   LAB_00102779:uVar2 = png_icc_profile_error(param_1, param_2, param_3, uVar3, pcVar4);
   return uVar2;
}
undefined8 png_icc_check_tag_table(undefined8 param_1, undefined8 param_2, undefined8 param_3, uint param_4, long param_5) {
   uint uVar1;
   uint uVar2;
   undefined8 uVar3;
   uint uVar4;
   ...
   if (uVar7 != 0) {
      ...
      do {
         while (true) {
            ...
            if (( param_4 < uVar5 ) || ( param_4 - uVar5 < ( uVar2 >> 0x18 | ( uVar2 & 0xff0000 ) >> 8 | ( uVar2 & 0xff00 ) << 8 | uVar2 << 0x18 ) )) {
               uVar3 = png_icc_profile_error(param_1, param_2, param_3, uVar4, "ICC profile tag outside profile");
               return uVar3;
            }
...
void png_icc_set_sRGB(undefined8 param_1, undefined8 param_2, long param_3, undefined8 param_4) {
   ...
   png_colorspace_set_sRGB(param_1, param_2, uVar1 >> 0x18 | ( uVar1 & 0xff0000 ) >> 8 | ( uVar1 & 0xff00 ) << 8 | uVar1 << 0x18);
   return;
}
undefined8 png_colorspace_set_ICC(undefined8 param_1, long param_2, undefined8 param_3, uint param_4, long param_5, ulong param_6) {
   uint uVar1;
   int iVar2;
   ...
   if (( iVar2 != 0 ) && ( iVar2 = png_icc_check_tag_table(param_1, param_2, param_3, param_4, param_5) ),iVar2 != 0) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void png_colorspace_set_rgb_coefficients(long param_1) {
   uint uVar1;
   uint uVar2;
   uint uVar3;
   int iVar4;
   ...
   if (( (int)uVar1 < 0 ) || ( iVar4 < 1 )) {
      LAB_00102bd4:/* WARNING: Subroutine does not return */png_error(param_1, "internal error handling cHRM->XYZ");
   }

   if (uVar1 != 0) {
      dVar6 = ( (double)(int)uVar1 * __LC80 ) / (double)iVar4 + _LC9;
      if ((double)( (ulong)dVar6 & _LC12 ) < _LC10) {
         dVar6 = (double)( ( ulong )((double)(long)dVar6 - (double)( -(ulong)(dVar6 < (double)(long)dVar6) & _LC1 )) | ~_LC12 & (ulong)dVar6 );
      }

      if (( ( _LC13 < dVar6 ) || ( dVar6 < _LC14 ) ) || ( uVar1 = 0x8000 < uVar1 )) goto LAB_00102bd4;
   }
   ...
   if (uVar3 != 0) {
      ...
      if (( ( _LC13 < dVar6 ) || ( dVar6 < _LC14 ) ) || ( uVar3 = 0x8000 < uVar3 )) goto LAB_00102bd4;
   }
   ...
   if (uVar2 != 0) {
      ...
      if (( ( _LC13 < dVar6 ) || ( dVar6 < _LC14 ) ) || ( uVar2 = 0x8000 < uVar2 )) goto LAB_00102bd4;
   }
   ...
   if ((int)uVar3 < (int)uVar1) {
      if ((int)uVar1 < (int)uVar2) {
         LAB_00102da4:uVar2 = uVar2 + iVar5;
      }
 else {
         uVar1 = uVar1 + iVar5;
         iVar4 = uVar1 + uVar3;
   ...
   LAB_00102db1:*(short*)( param_1 + 0x3d2 ) = (short)uVar1;
   *(short*)( param_1 + 0x3d4 ) = (short)uVar3;
   return;
}
void png_check_IHDR(long param_1, uint param_2, uint param_3, ulong param_4, ulong param_5, int param_6, int param_7, int param_8) {
   uint uVar1;
   uint uVar2;
   bool bVar3;
   bVar3 = (int)param_2 < 0;
 ...
 else if (( ( uVar1 == 3 ) && ( 8 < (int)uVar2 ) ) || ( ( ( 0x54UL >> ( param_5 & 0x3f ) & 1 ) != 0 && ( (int)uVar2 < 8 ) ) )) {
      bVar3 = true;
   ...
   if (param_7 == 0) {
      if (( *(byte*)( param_1 + 0x12d ) & 0x10 ) == 0) {
         LAB_00102fbf:if (param_8 != 0) {
            LAB_00102fc7:if (( ( ( ( *(byte*)( param_1 + 0x3e0 ) & 4 ) == 0 ) || ( param_8 != 0x40 ) ) || ( ( *(byte*)( param_1 + 0x12d ) & 0x10 ) != 0 ) ) || ( ( uVar1 & 0xfffffffb ) != 2 )) goto LAB_00102f20;
         }
      ...
      if (( *(byte*)( param_1 + 0x12d ) & 0x10 ) == 0) {
         if (( param_8 == 0 ) || ( ( ( ( *(byte*)( param_1 + 0x3e0 ) & 4 ) != 0 && ( param_8 == 0x40 ) ) && ( ( uVar1 & 0xfffffffb ) == 2 ) ) )) goto LAB_00102f3c;
      }
 else {
         if (*(int*)( param_1 + 0x3e0 ) != 0) {
            png_warning(param_1, "MNG features are not allowed in a PNG datastream");
      ...
      LAB_00102f20:png_warning(param_1, "Unknown filter method in IHDR");
      if (( *(byte*)( param_1 + 0x12d ) & 0x10 ) != 0) {
   ...
   LAB_00102f3c:/* WARNING: Subroutine does not return */png_error(param_1, "Invalid IHDR data");
}
bool png_check_fp_number(long param_1, ulong param_2, uint *param_3, ulong *param_4) {
   ...
   uVar3 = *param_4;
   uVar4 = *param_3;
   if (( param_2 <= uVar3 ) || ( bVar1 = 0x3a < bVar1 )) {
      *param_3 = uVar4;
      *param_4 = uVar3;
      return ( uVar4 & 8 ) != 0;
   }
...
LAB_001031c5:
      ...
      *param_4 = uVar3;
      ...
      uVar3 = uVar3 + 1;
      if (( param_2 == uVar3 ) || ( bVar1 = 0x3a < bVar1 )) goto switchD_00103191_caseD_1;
   }
 while ( true );
}
ulong png_check_fp_string(long param_1, long param_2) {
   ...
   if (( (int)uVar1 != 0 ) && ( ( local_18 == param_2 || ( uVar1 = 0 * (char*)( param_1 + local_18 ) == '\0' ) ) )) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void png_ascii_from_fp(double param_1, undefined8 param_2, char *param_3, ulong param_4, uint param_5) {
   ulong uVar1;
   uint uVar2;
   uint uVar3;
   uint uVar4;
   ...
   if (param_4 < uVar16) {
      LAB_0010392d:/* WARNING: Subroutine does not return */png_error(param_2, "ASCII conversion buffer too small");
   }
   ...
   if (param_1 < _LC99) {
      ...
      while (true) {
         uVar14 = (uint)uVar16;
         cVar9 = (char)uVar8;
         if (( ( _LC99 <= dVar18 ) && ( param_1 <= dVar18 ) ) || ( dVar19 = _LC100 < dVar19 )) break;
         uVar8 = 1;
...
;
      ...
      do {
         ...
         if (uVar10 + 1 < uVar4) {
            ...
            dVar19 = _LC1;
            uVar16 = _LC12;
            LAB_00103754:if (local_58 != 0.0) {
               pcVar7 = param_3 + 1;
               cVar9 = (char)(int)local_58 + '0';
               LAB_00103604:iVar11 = uVar10 - uVar3;
               if (uVar15 != 0) {
                  bVar17 = false;
                  uVar13 = uVar14;
                  do {
 ...
 while ( uVar15 != 0 );
            ...
            uVar15 = uVar15 + 1;
            LAB_0010376c:uVar10 = uVar13 + uVar15;
            if (uVar13 == 0) {
               uVar3 = uVar3 + 1;
               uVar4 = uVar2 + uVar3;
               uVar15 = uVar10;
            ...
            if ((double)( (ulong)local_58 & uVar16 ) < _LC10) {
               local_58 = (double)( ( ulong )((double)(long)local_58 - (double)( -(ulong)(local_58 < (double)(long)local_58) & (ulong)dVar19 )) | ~uVar16 & (ulong)local_58 );
            }
 ...
 while ( 9 < iVar11 );
            if (bVar17) {
               LAB_00103883:uVar14 = uVar10;
               local_5c = uVar10;
               LAB_0010388a:if (9 < iVar11) goto LAB_00103858;
            }
            ...
            param_1 = 0.0;
            iVar11 = uVar13 - uVar3;
            LAB_00103656:if (uVar14 != 0xffffffff) {
               pcVar5 = pcVar7;
               if (uVar14 == 0) {
                  *param_3 = '.';
                  param_4 = param_4 - 1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int png_fixed(double param_1, int *param_2, int param_3, undefined8 param_4, int param_5) {
   int extraout_EDX;
   double dVar1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */bool png_XYZ_from_xy(long param_1, uint *param_2) {
   uint uVar1;
   uint uVar2;
   uint uVar3;
   uint uVar4;
   ...
   uVar12 = (ulong)uVar9;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   if (( ( ( ( uVar9 < 0x1adb1 ) && ( uVar13 = param_2[1] ),-1 < (int)uVar13 ) ) && ( (int)uVar13 <= (int)( 110000 - uVar9 ) ) ) && ( ( uVar1 = param_2[2] ),uVar1 < 0x1adb1 && ( uVar2 = -1 < (int)uVar2 ) )) {
      local_44 = 0;
      uVar13 = uVar13 - uVar4;
      uVar14 = (ulong)uVar13;
      iVar11 = uVar1 - uVar3;
      if (( iVar11 == 0 ) || ( uVar13 == 0 )) {
         ...
         if ((double)( (ulong)dVar18 & _LC12 ) < _LC10) {
            dVar18 = (double)( ( ulong )((double)(long)dVar18 - (double)( -(ulong)(dVar18 < (double)(long)dVar18) & _LC1 )) | ~_LC12 & (ulong)dVar18 );
         }
      ...
      if (( dVar18 <= _LC13 ) && ( _LC14 <= dVar18 )) {
         ...
         if (local_48 < 1) {
            ...
            LAB_00104088:iVar15 = local_4c - local_48;
            LAB_0010408b:iVar11 = png_muldiv_part_0(&local_4c, iVar11, uVar6 - uVar4, 8, param_2, param_1);
            if (iVar11 != 0) {
               iVar11 = png_muldiv_part_0(&local_48, iVar10, uVar5 - uVar3, 8);
               if (iVar11 != 0) {
                  iVar11 = png_fp_sub(local_4c, local_48, &local_44);
                  if (( ( ( ( iVar11 != 0 ) && ( iVar11 = png_muldiv_part_0(&local_54, uVar6, iVar15, iVar11) ),iVar11 != 0 ) ) && ( local_44 == 0 ) ) && ( ( ( (int)uVar6<local_54&&(iVar11 = png_muldiv_part_0(&local_4c, uVar14 & 0xffffffff, uVar5 - uVar3, 8), iVar11, != 0) ) && ( ( iVar11 = png_muldiv_part_0(&local_48, iVar16, uVar6 - uVar4) ),iVar11 != 0 && ( ( iVar11 = png_fp_sub(local_4c, local_48, &local_44) ),iVar11 != 0 && ( iVar11 = png_muldiv_part_0(&local_50, uVar6, iVar15, iVar11) ),iVar11 != 0 ) ) ) )) {
                     ...
                     uVar14 = (ulong)uVar9;
                     if (( ( ( local_44 == 0 ) && ( 0 < (int)uVar9 ) ) && ( iVar11 = png_muldiv_part_0(param_1, uVar12 & 0xffffffff, 100000, local_54) ),iVar11 != 0 )) {
                        iVar15 = 100000;
                        iVar11 = png_muldiv_part_0(param_1 + 8, ( 100000 - *param_2 ) - param_2[1]);
                        if (( ( ( iVar11 != 0 ) && ( iVar11 = png_muldiv_part_0(param_1 + 0xc, param_2[2], extraout_RDX, local_50) ),iVar11 != 0 ) ) && ( ( iVar11 = png_muldiv_part_0(param_1 + 0x10, param_2[3]) ),iVar11 != 0 && ( ( iVar11 = png_muldiv_part_0(param_1 + 0x14, ( iVar15 - param_2[2] ) - param_2[3]) ),iVar11 != 0 && ( iVar11 = png_muldiv_part_0(param_1 + 0x18, param_2[4], uVar14 & 0xffffffff, 100000) ),iVar11 != 0 ) )) {
   ...
   LAB_001042e0:bVar17 = true;
   LAB_001042e5:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */undefined8 png_colorspace_set_endpoints(undefined8 param_1, long param_2, undefined8 *param_3, undefined4 param_4) {
   undefined8 uVar1;
   undefined8 uVar2;
   int iVar3;
   undefined8 uVar4;
   ...
   if ((int)local_88 < 1) {
      ...
      LAB_001043e1:iVar5 = uStack_80._4_4_ + (int)local_88;
      LAB_001043e5:if (local_98._4_4_ < 1) {
         ...
         LAB_001043f9:iVar5 = iVar5 + local_98._4_4_;
         LAB_001043fc:if (iVar5 == 100000) {
            LAB_00104409:uStack_80 = uVar1;
            local_88 = uVar4;
            local_98 = uVar2;
   ...
   LAB_00104386:uStack_80 = uVar1;
   local_88 = uVar4;
   local_98 = uVar2;
   *(ushort*)( param_2 + 0x4a ) = *(ushort*)( param_2 + 0x4a ) | 0x8000;
   png_benign_error(param_1, "invalid end points");
   uVar4 = 0;
   LAB_0010439d:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
undefined8 png_colorspace_set_chromaticities(undefined8 param_1, long param_2, undefined8 param_3, undefined4 param_4) {
   int iVar1;
   undefined8 uVar2;
   long in_FS_OFFSET;
   ...
   *(ushort*)( param_2 + 0x4a ) = *(ushort*)( param_2 + 0x4a ) | 0x8000;
   ...
   uVar2 = 0;
   LAB_00104aa2:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return uVar2;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int png_gamma_8bit_correct(int param_1, int param_2) {
   double dVar1;
   if (0xfd < param_1 - 1U) {
      return param_1;
   }
   ...
   return (int)(double)( ( ulong )((double)(long)dVar1 - (double)( -(ulong)(dVar1 < (double)(long)dVar1) & _LC1 )) | ~_LC12 & (ulong)dVar1 );
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */int png_gamma_16bit_correct(int param_1, int param_2) {
   double dVar1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */uint png_gamma_correct(long param_1, uint param_2, int param_3) {
   double dVar1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */void png_build_gamma_table(long param_1, int param_2) {
   double dVar1;
   double dVar2;
   double dVar3;
   uint uVar4;
   ...
   if (param_2 < 9) {
      iVar12 = 100000;
      if (( 0 < iVar11 ) && ( iVar12 = iVar12 != 0 )) {
         dVar22 = ( _LC111 / (double)iVar12 ) / (double)iVar11 + _LC9;
         if ((double)( (ulong)dVar22 & _LC12 ) < _LC10) {
            dVar22 = (double)( ( ulong )((double)(long)dVar22 - (double)( -(ulong)(dVar22 < (double)(long)dVar22) & _LC1 )) | ~_LC12 & (ulong)dVar22 );
         }
      ...
      if ((double)( (ulong)dVar23 & _LC12 ) < _LC10) {
         dVar23 = (double)( ( ulong )((double)(long)dVar23 - (double)( -(ulong)(dVar23 < (double)(long)dVar23) & _LC1 )) | ~_LC12 & (ulong)dVar23 );
      }
      ...
      if (*(int*)( param_1 + 0x2a4 ) < 1) {
         ...
         if ((double)( (ulong)dVar22 & uVar9 ) < dVar1) {
            dVar22 = (double)( ( ulong )((double)(long)dVar22 - (double)( -(ulong)(dVar22 < (double)(long)dVar22) & _LC1 )) | ~uVar9 & (ulong)dVar22 );
         }
   ...
   if (( byte )(bVar20 - 1) < 0xf) {
      ...
      *(uint*)( param_1 + 0x2a0 ) = (uint)local_4c;
      ...
      if (uVar15 == 0) {
         local_4c = 0;
         uVar15 = 0;
         LAB_00105647:*(uint*)( param_1 + 0x2a0 ) = uVar15;
         uVar9 = 100000;
         if (0 < iVar11) {
 ...
 while ( (uint)lVar14 < uVar13 );
   ...
   do {
      ...
      if ((double)( (ulong)dVar22 & local_78 ) < local_68) {
         dVar22 = (double)( ( ulong )((double)(long)dVar22 - (double)( -(ulong)(dVar22 < (double)(long)dVar22) & _LC1 )) | ~local_78 & (ulong)dVar22 );
      }
      ...
      if (uVar13 < uVar18) {
         do {
            *(ushort*)( *(long*)( lVar16 + ( ulong )(uVar13 & uVar6) * 8 ) + ( ulong )(uVar13 >> ( bVar8 & 0x1f )) * 2 ) = uVar19 - 0x80;

...
LAB_00100e4b:loader_count = loader_count + 1;return;}/* ResourceLoader::remove_resource_format_loader(Ref<ResourceFormatLoader>) */void ResourceLoader::remove_resource_format_loader(long *param_1) {
 ...
 while ( iVar7 < iVar5 );
               ...
               if (( ( &loader )[iVar5] != 0 ) && ( cVar3 = cVar3 != '\0' )) {
   ...
   *(undefined4*)( this + 0x58 ) = *(undefined4*)( param_1 + 0x58 );
   if (pOVar4 != pOVar3) {
      *(Object**)( this + 0x60 ) = pOVar4;
      if (( pOVar4 != (Object*)0x0 ) && ( cVar8 = cVar8 == '\0' )) {
...
;
 ...
 while ( lVar35 != 0 );
   ...
   joined_r0x00102cd9:if (( path_remaps._8_8_ != 0 ) && ( local_2188 = path_remaps._44_4_ != 0 )) {
                  ...
                  do {
                     if (*(int*)( plVar50[5] + lVar42 ) != 0) {
                        ...
                        *(int*)( plVar50[5] + lVar42 ) = 0;
                        if (( *(long*)( (long)pvVar44 + 0x18 ) != 0 ) && ( cVar32 = cVar32 != '\0' )) {
   ...
   *in_FS_OFFSET = iVar3 + 1;
   ...
   if (param_5 != 0 && param_5 != 3) {
      ...
      if (cVar2 != '\0') {
         ...
         if (( this_00 != (Object*)0x0 ) && ( cVar2 = cVar2 != '\0' )) {
            cVar2 = RefCounted::reference();
            if (cVar2 != '\0') {
               cVar2 = RefCounted::unreference();
               pRVar7 = (RefCounted*)this_00;
               if (( cVar2 != '\0' ) && ( cVar2 = cVar2 != '\0' )) goto LAB_00111003;
               ...
               *puVar1 = pOVar5;
               ...
               if (cVar3 == '\0') {
                  *puVar1 = 0;
                  ...
                  cVar3 = RefCounted::unreference();
                  joined_r0x00112e1a:if (( cVar3 != '\0' ) && ( cVar3 = cVar3 != '\0' )) goto LAB_00112dd9;
               }
...
;
            remove_resource_format_loader(local_60);
            cVar3 = RefCounted::unreference();
            if (( cVar3 == '\0' ) || ( cVar3 = cVar3 == '\0' )) goto LAB_00112c99;
            lVar7 = lVar7 + 1;
            ( **(code**)( *(long*)pOVar5 + 0x140 ) )(pOVar5);
            Memory::free_static(pOVar5, false);
         }
                        ...
                        *(undefined1(*) [16])( (long)pvVar10 + 0x30 ) = (undefined1[16])0x0;
                        ...
                        do {
                           ...
                           if (*piVar7 != 0) {
                              ...
                              *piVar7 = 0;
                              if (( *(long*)( (long)pvVar9 + 0x18 ) != 0 ) && ( cVar6 = cVar6 != '\0' )) {
...
/* WARNING: Removing unreachable block (ram,0x00117f18) *//* String vformat<String>(String const&, String const) */undefined8 *vformat<String>(undefined8 *param_1, bool *param_2, String *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* WARNING: Removing unreachable block (ram,0x00118250) *//* String vformat<String, String>(String const&, String const, String const) */undefined8 *vformat<String,String>(undefined8 *param_1, bool *param_2, String *param_3, String *param_4) {
   Variant *pVVar1;
   Variant *pVVar2;
   int iVar3;
   long in_FS_OFFSET;
...
/* WARNING: Removing unreachable block (ram,0x00118550) *//* String vformat<String, int, String>(String const&, String const, int const, String const) */undefined8 *vformat<String,int,String>(undefined8 *param_1, bool *param_2, String *param_3, int param_4, String *param_5) {
   Variant *pVVar1;
   Variant *pVVar2;
   int iVar3;
   int iVar4;
...
/* WARNING: Removing unreachable block (ram,0x00118808) *//* String vformat<StringName>(String const&, StringName const) */undefined8 *vformat<StringName>(undefined8 *param_1, bool *param_2, StringName *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* ResourceLoader::ThreadLoadTask::~ThreadLoadTask() */void ResourceLoader::ThreadLoadTask::~ThreadLoadTask(ThreadLoadTask *this) {
   long *plVar1;
   long *plVar2;
   long lVar3;
   Object *pOVar4;
...
/* HashMap<String, ResourceLoader::ThreadLoadTask, HashMapHasherDefault,
   HashMapComparatorDefault<String>, DefaultTypedAllocator<HashMapElement<String,
   ResourceLoader::ThreadLoadTask> > >::~HashMap() */void HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>::~HashMap(HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>> *this) {
   long *plVar1;
   uint uVar2;
   long lVar3;
   long lVar4;
...
*(undefined1(**) [16])( lVar45 + lVar46 * 8 ) = pauVar56;*puVar49 = uVar54;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_0011911b:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return pauVar41[1] + 8;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<String, String, HashMapHasherDefault, HashMapComparatorDefault<String>,
   DefaultTypedAllocator<HashMapElement<String, String> > >::operator[](String const&) */CowData<char32_t> * __thiscall
...
/* CallableCustomMethodPointer<core_bind::Semaphore, void, int>::call(Variant const**, int,
   Variant&, Callable::CallError&) const */void CallableCustomMethodPointer<core_bind::Semaphore,void,int>::call(CallableCustomMethodPointer<core_bind::Semaphore,void,int> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long lVar1;
   long lVar2;
   ulong uVar3;
   undefined8 uVar4;
...
/* CallableCustomMethodPointer<Resource, void, Callable const&, unsigned int>::call(Variant const**,
   int, Variant&, Callable::CallError&) const */void CallableCustomMethodPointer<Resource,void,Callable_const&,unsigned_int>::call(CallableCustomMethodPointer<Resource,void,Callable_const&,unsigned_int> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long lVar1;
   long lVar2;
   ulong uVar3;
   undefined8 uVar4;
...
/* core_bind::Semaphore::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void core_bind::Semaphore::_get_property_listv(Semaphore *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   CowData<char32_t> *local_b0;
   long local_98;
   long local_90;
...
/* std::unique_lock<std::mutex>::unlock() */void std::unique_lock<std::mutex>::unlock(unique_lock<std::mutex> *this) {
...
/* HashMap<String, ResourceLoader::ThreadLoadTask, HashMapHasherDefault,
   HashMapComparatorDefault<String>, DefaultTypedAllocator<HashMapElement<String,
   ResourceLoader::ThreadLoadTask> > >::_lookup_pos(String const&, unsigned int&) const */undefined8 HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>::_lookup_pos(HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>> *this, String *param_1, uint *param_2) {
   uint uVar1;
   long lVar2;
   undefined1 auVar3[16];
   undefined1 auVar4[16];
...
uVar51 = 0;uVar39 = ( &hash_table_size_primes )[*(uint*)( this + 0x28 )];uVar41 = CONCAT44(0, uVar39);lVar53 = *(long*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( this + 0x28 ) * 8 );auVar9._8_8_ = 0;auVar9._0_8_ = (ulong)uVar55 * lVar53;auVar25._8_8_ = 0;auVar25._0_8_ = uVar41;lVar47 = SUB168(auVar9 * auVar25, 8);lVar46 = *(long*)( this + 8 );puVar1 = (uint*)( lVar4 + lVar47 * 4 );iVar45 = SUB164(auVar9 * auVar25, 8);uVar40 = *puVar1;pauVar37 = pauVar43;while (uVar40 != 0) {
   auVar10._8_8_ = 0;
...
;*(undefined1(**) [16])( lVar46 + lVar47 * 8 ) = pauVar37;*puVar1 = uVar55;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_0011c22b:CowData<String>::_unref((CowData<String>*)&local_70);LAB_0011c237:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return pauVar43[1] + 8;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* HashMap<String, Vector<String>, HashMapHasherDefault, HashMapComparatorDefault<String>,
   DefaultTypedAllocator<HashMapElement<String, Vector<String> > > >::~HashMap() */void HashMap<String,Vector<String>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Vector<String>>>>::~HashMap(HashMap<String,Vector<String>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Vector<String>>>> *this) {
   long *plVar1;
   uint uVar2;
   long lVar3;
   long lVar4;
...
/* HashMap<String, ResourceLoader::ThreadLoadTask, HashMapHasherDefault,
   HashMapComparatorDefault<String>, DefaultTypedAllocator<HashMapElement<String,
   ResourceLoader::ThreadLoadTask> > >::_resize_and_rehash(unsigned int) */void HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>::_resize_and_rehash(HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>> *this, uint param_1) {
   uint *puVar1;
   undefined8 *puVar2;
   uint uVar3;
   uint uVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<String, ResourceLoader::ThreadLoadTask, HashMapHasherDefault,
   HashMapComparatorDefault<String>, DefaultTypedAllocator<HashMapElement<String,
   ResourceLoader::ThreadLoadTask> > >::operator[](String const&) */ThreadLoadTask * __thiscallHashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>::operator [](HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>> * this, String * param_1) * puVar1 ;undefined8 *puVar2void *__sundefined1 auVar3[16]undefined1 auVar4[16]undefined1 auVar5[16]undefined1 auVar6[16]undefined1 auVar7[16]undefined1 auVar8[16]undefined1 auVar9[16]undefined1 auVar10[16]undefined1 auVar11[16]undefined1 auVar12[16]undefined1 auVar13[16]undefined1 auVar14[16]undefined1 auVar15[16]undefined1 auVar16[16]undefined1 auVar17[16]undefined1 auVar18[16]char cVar19uint uVar20uint uVar21undefined8 *puVar22undefined8 uVar23void *__s_00long lVar24long lVar25int iVar26uint uVar27long lVar28ulong uVar29ThreadLoadTask *pTVar30uint uVar31ulong uVar32long lVar33undefined8 *puVar34ulong uVar35uint uVar36long in_FS_OFFSETbyte bVar37uint local_1f8ThreadLoadTask *local_1d8ThreadLoadTask *local_1d0uint local_1bcThreadLoadTask local_1b8[36]undefined1 local_194undefined8 local_170undefined8 local_168undefined1 local_148[16]undefined1 local_138[16]undefined8 local_128undefined8 uStack_120undefined8 local_118undefined1 local_108[16]long local_f8ThreadLoadTask local_f0[176]long local_40bVar37 = 0;lVar24 = *(long*)( this + 8 );local_40 = *(long*)( in_FS_OFFSET + 0x28 );uVar20 = ( &hash_table_size_primes )[*(uint*)( this + 0x28 )];if (lVar24 == 0) {
...
local_1d8 = local_1b8;local_1bc = 0;cVar19 = _lookup_pos(this, param_1, &local_1bc);if (cVar19 == '\0') {
...
LAB_0011d7f0:ResourceLoader::ThreadLoadTask::~ThreadLoadTask(local_1d8);LAB_0011d7ff:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return local_1d0;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<String, ResourceLoader::ThreadLoadTask, HashMapHasherDefault,
   HashMapComparatorDefault<String>, DefaultTypedAllocator<HashMapElement<String,
   ResourceLoader::ThreadLoadTask> > >::insert(String const&, ResourceLoader::ThreadLoadTask const&,
   bool) */String * HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>
...
/* HashMap<String, Ref<Resource>, HashMapHasherDefault, HashMapComparatorDefault<String>,
   ...
   int) */void HashMap<String,Ref<Resource>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<Resource>>>>::_resize_and_rehash(HashMap<String,Ref<Resource>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<Resource>>>> *this, uint param_1) {
   uint *puVar1;
   undefined8 *puVar2;
   uint uVar3;
   uint uVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<String, Ref<Resource>, HashMapHasherDefault, HashMapComparatorDefault<String>,
   DefaultTypedAllocator<HashMapElement<String, Ref<Resource> > > >::operator[](String const&) */Ref<Resource> * __thiscallHashMap<String,Ref<Resource>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<Resource>>>>::operator [](HashMap<String,Ref<Resource>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<Resource>>>> * this, String * param_1) * puVar1 ;undefined8 *puVar2ulong __nlong lVar3void *__sundefined1 auVar4[16]undefined1 auVar5[16]undefined1 auVar6[16]undefined1 auVar7[16]undefined1 auVar8[16]undefined1 auVar9[16]undefined1 auVar10[16]undefined1 auVar11[16]undefined1 auVar12[16]undefined1 auVar13[16]undefined1 auVar14[16]undefined1 auVar15[16]undefined1 auVar16[16]undefined1 auVar17[16]undefined1 auVar18[16]undefined1 auVar19[16]undefined1 auVar20[16]undefined1 auVar21[16]undefined1 auVar22[16]undefined1 auVar23[16]undefined1 auVar24[16]undefined1 auVar25[16]undefined1 auVar26[16]undefined1 auVar27[16]Ref *pRVar28char cVar29uint uVar30uint uVar31undefined8 *puVar32undefined8 uVar33void *__s_00ulong uVar34int iVar35uint uVar36long lVar37long lVar38ulong uVar39uint uVar40long lVar41undefined8 *puVar42uint uVar43uint uVar44long in_FS_OFFSETuint local_88Ref<Resource> *local_70long local_58Ref *local_50[2]long local_40local_40 = *(long*)( in_FS_OFFSET + 0x28 );uVar30 = ( &hash_table_size_primes )[*(uint*)( this + 0x28 )];uVar39 = (ulong)uVar30;if (*(long*)( this + 8 ) == 0) {
...
local_50[0] = (Ref*)0x0;Ref<Resource>::operator =((Ref<Resource>*)local_50, (Ref*)0x0);puVar32 = (undefined8*)operator_new(0x20, "");puVar32[2] = 0;*puVar32 = 0;puVar32[1] = 0;if (local_58 != 0) {
   CowData<char32_t>::_ref((CowData<char32_t>*)( puVar32 + 2 ), (CowData*)&local_58);
}
pRVar28 = local_50[0];puVar32[3] = 0;local_70 = (Ref<Resource>*)( puVar32 + 3 );Ref<Resource>::operator =(local_70, local_50[0]);if (( ( pRVar28 != (Ref*)0x0 ) && ( cVar29 = RefCounted::unreference() ),cVar29 != '\0' )) &&( cVar29 = cVar29 != '\0' )(**(code**)( *(long*)pRVar28 + 0x140 ))(pRVar28);Memory::free_static(pRVar28, false);}CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);puVar42 = *(undefined8**)( this + 0x20 );if (puVar42 == (undefined8*)0x0) {
...
*(undefined8**)( this + 0x20 ) = puVar32;uVar30 = String::hash();lVar3 = *(long*)( this + 0x10 );uVar39 = 1;if (uVar30 != 0) {
   uVar39 = (ulong)uVar30;
}
uVar40 = 0;lVar41 = *(long*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( this + 0x28 ) * 8 );uVar31 = (uint)uVar39;uVar30 = ( &hash_table_size_primes )[*(uint*)( this + 0x28 )];uVar34 = CONCAT44(0, uVar30);auVar4._8_8_ = 0;auVar4._0_8_ = uVar39 * lVar41;auVar16._8_8_ = 0;auVar16._0_8_ = uVar34;lVar37 = SUB168(auVar4 * auVar16, 8);lVar38 = *(long*)( this + 8 );puVar1 = (uint*)( lVar3 + lVar37 * 4 );iVar35 = SUB164(auVar4 * auVar16, 8);uVar36 = *puVar1;while (uVar36 != 0) {
   auVar5._8_8_ = 0;
...
;*(undefined8**)( lVar38 + lVar37 * 8 ) = puVar32;*puVar1 = uVar31;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_0011e444:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return local_70;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* CowData<Ref<ResourceFormatLoader> >::_unref() */void CowData<Ref<ResourceFormatLoader>>::_unref(CowData<Ref<ResourceFormatLoader>> *this) {
   long *plVar1;
   long lVar2;
   Object *pOVar3;
   code *pcVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<String, Ref<Resource>, HashMapHasherDefault, HashMapComparatorDefault<String>,
   ...
   Ref<Resource> const&, bool) */String *HashMap<String,Ref<Resource>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<Resource>>>>::insert(String *param_1, Ref *param_2, bool param_3) {
   undefined8 *puVar1;
   long lVar2;
   void *__s;
   undefined1 auVar3[16];
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<int, HashMap<String, Ref<Resource>, HashMapHasherDefault,
   HashMapComparatorDefault<String>, DefaultTypedAllocator<HashMapElement<String, Ref<Resource> > >
   >, HashMapHasherDefault, HashMapComparatorDefault<int>, DefaultTypedAllocator<HashMapElement<int,
   HashMap<String, Ref<Resource>, HashMapHasherDefault, HashMapComparatorDefault<String>,
   DefaultTypedAllocator<HashMapElement<String, Ref<Resource> > > > > > >::operator[](int const&) */undefined1 * __thiscallHashMap<int,HashMap<String,Ref<Resource>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<Resource>>>>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,HashMap<String,Ref<Resource>,HashMapHasherDefault,HashMapComparatorDefault < String>,DefaultTypedAllocator<HashMapElement<String,Ref<Resource>>>>>> > ::operator [](HashMap<int,HashMap<String,Ref<Resource>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<Resource>>>>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator < HashMapElement<int,HashMap<String,Ref < Resource>,HashMapHasherDefault,HashMapComparatorDefault < String>,DefaultTypedAllocator<HashMapElement<String,Ref<Resource>>>> >> *this, int, *param_1) * puVar1 ;undefined8 *puVar2void *__svoid *pvVar3undefined1 auVar4[16]undefined1 auVar5[16]undefined1 auVar6[16]undefined1 auVar7[16]undefined1 auVar8[16]undefined1 auVar9[16]undefined1 auVar10[16]undefined1 auVar11[16]undefined1 auVar12[16]undefined1 auVar13[16]undefined1 auVar14[16]undefined1 auVar15[16]undefined1 auVar16[16]undefined1 auVar17[16]undefined1 auVar18[16]undefined1 auVar19[16]undefined1 auVar20[16]undefined1 auVar21[16]undefined1 auVar22[16]undefined1 auVar23[16]undefined1 auVar24[16]undefined1 auVar25[16]undefined1 auVar26[16]undefined1 auVar27[16]undefined1 auVar28[16]undefined1 auVar29[16]undefined1 auVar30[16]undefined1 auVar31[16]undefined1 auVar32[16]undefined1 auVar33[16]undefined1 auVar34[16]undefined1 auVar35[16]undefined1(*pauVar36)[16];uint uVar37uint uVar38uint uVar39ulong uVar40undefined8 uVar41void *__s_00undefined1(*pauVar42)[16];long lVar43int *piVar44ulong uVar45int iVar46long lVar47long lVar48long lVar49ulong uVar50undefined8 uVar51uint uVar52ulong uVar53ulong uVar54uint uVar55uint uVar56undefined1(*pauVar57)[16];void *local_70local_70 = *(void**)( this + 8 );uVar40 = ( ulong ) * (uint*)( this + 0x28 );uVar38 = *param_1;uVar39 = ( &hash_table_size_primes )[uVar40];uVar53 = CONCAT44(0, uVar39);if (local_70 == (void*)0x0) {
   uVar40 = uVar53 * 4;
   uVar50 = uVar53 * 8;
   uVar41 = Memory::alloc_static(uVar40, false);
   *(undefined8*)( this + 0x10 ) = uVar41;
...
uVar40 = 1;iVar46 = *param_1;do {
   if (0x16 < ( uint )(&hash_table_size_primes)[uVar40]) goto LAB_0011f568;
   uVar40 = uVar40 + 1;
}
 while ( uVar40 != 0x1d );uVar40 = 0;_err_print_error("reserve", "./core/templates/hash_map.h", 0x1b7, "Condition \"new_index + 1 == (uint32_t)HASH_TABLE_SIZE_MAX\" is true.", 0, 0, 0);LAB_0011f568:pauVar42 = (undefined1(*) [16])operator_new(0x48, "");*(int*)pauVar42[1] = iVar46;*(undefined8*)pauVar42[4] = 0;*pauVar42 = (undefined1[16])0x0;pauVar42[2] = (undefined1[16])0x0;pauVar42[3] = (undefined1[16])0x0;lVar43 = 1;if (5 < ( uint )(&hash_table_size_primes)[uVar40 & 0xffffffff]) {
   do {
...
puVar2 = *(undefined8**)( this + 0x20 );joined_r0x0011f8ca:if (puVar2 == (undefined8*)0x0) {
...
uVar55 = 0;lVar43 = *(long*)( this + 0x10 );lVar47 = *(long*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( this + 0x28 ) * 8 );uVar39 = ( &hash_table_size_primes )[*(uint*)( this + 0x28 )];uVar53 = CONCAT44(0, uVar39);auVar12._8_8_ = 0;auVar12._0_8_ = uVar40 * lVar47;auVar28._8_8_ = 0;auVar28._0_8_ = uVar53;lVar49 = SUB168(auVar12 * auVar28, 8);lVar48 = *(long*)( this + 8 );puVar1 = (uint*)( lVar43 + lVar49 * 4 );iVar46 = SUB164(auVar12 * auVar28, 8);uVar37 = *puVar1;pauVar36 = pauVar42;while (uVar37 != 0) {
   auVar13._8_8_ = 0;
...
;*(undefined1(**) [16])( lVar48 + lVar49 * 8 ) = pauVar36;*puVar1 = uVar38;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_0011f71f:return pauVar42[1] + 8;LAB_0011fa80:do {
 ...
 while ( (ulong)uVar39 << 2 != lVar47 );uVar38 = *(uint*)( lVar43 + 0x40 );*(undefined4*)( lVar43 + 0x44 ) = 0;*(undefined1(*) [16])( lVar43 + 0x30 ) = (undefined1[16])0x0;uVar39 = ( &hash_table_size_primes )[uVar38];LAB_0011f834:if (uVar39 < 0x17) {
...
LAB_0011f889:pauVar42 = *(undefined1(**) [16])( *(long*)( this + 8 ) + (ulong)uVar55 * 8 );goto LAB_0011f71f;}/* CowData<Ref<ResourceFormatLoader> >::_realloc(long) */undefined8 CowData<Ref<ResourceFormatLoader>>::_realloc(CowData<Ref<ResourceFormatLoader>> *this, long param_1) {
   undefined8 *puVar1;
   puVar1 = (undefined8*)Memory::realloc_static((void*)( *(long*)this + -0x10 ), param_1 + 0x10, false);
   if (puVar1 != (undefined8*)0x0) {
      *puVar1 = 1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Ref<ResourceFormatLoader> >::resize<false>(long) */undefined8 CowData<Ref<ResourceFormatLoader>>::resize<false>(CowData<Ref<ResourceFormatLoader>> *this, long param_1) {
   long *plVar1;
   Object *pOVar2;
   code *pcVar3;
   char cVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ResourceLoader::loader */void ResourceLoader::_GLOBAL__sub_I_loader(void) {
   undefined8 uVar1;
...
/* WARNING: Control flow encountered bad instruction data *//* HashMap<String, ResourceLoader::LoadToken*, HashMapHasherDefault,
   HashMapComparatorDefault<String>, DefaultTypedAllocator<HashMapElement<String,
   ResourceLoader::LoadToken*> > >::~HashMap() */void HashMap<String,ResourceLoader::LoadToken*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::LoadToken*>>>::~HashMap(HashMap<String,ResourceLoader::LoadToken*,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::LoadToken*>>> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* HashMap<int, HashMap<String, Ref<Resource>, HashMapHasherDefault,
   HashMapComparatorDefault<String>, DefaultTypedAllocator<HashMapElement<String, Ref<Resource> > >
   >, HashMapHasherDefault, HashMapComparatorDefault<int>, DefaultTypedAllocator<HashMapElement<int,
   HashMap<String, Ref<Resource>, HashMapHasherDefault, HashMapComparatorDefault<String>,
   DefaultTypedAllocator<HashMapElement<String, Ref<Resource> > > > > > >::~HashMap() */void HashMap<int,HashMap<String,Ref<Resource>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<Resource>>>>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,HashMap<String,Ref<Resource>,HashMapHasherDefault,HashMapComparatorDefault < String>,DefaultTypedAllocator<HashMapElement<String,Ref<Resource>>>>>>>::~HashMap(HashMap<int,HashMap<String,Ref<Resource>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Ref<Resource>>>>,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,HashMap<String,Ref < Resource>,HashMapHasherDefault,HashMapComparatorDefault < String>,DefaultTypedAllocator<HashMapElement<String,Ref<Resource>>>>> >> *this) {
...
/* WARNING: Control flow encountered bad instruction data *//* SafeBinaryMutex<1>::TLSData::~TLSData() */void SafeBinaryMutex<1>::TLSData::~TLSData(TLSData *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* core_bind::Semaphore::~Semaphore() */void core_bind::Semaphore::~Semaphore(Semaphore *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* SelfList<Resource>::List::~List() */void SelfList<Resource>::List::~List(List *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* SafeBinaryMutex<1>::~SafeBinaryMutex() */void SafeBinaryMutex<1>::~SafeBinaryMutex(SafeBinaryMutex<1> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<Resource, void, Callable const&, unsigned
   int>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<Resource,void,Callable_const&,unsigned_int>::~CallableCustomMethodPointer(CallableCustomMethodPointer<Resource,void,Callable_const&,unsigned_int> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<core_bind::Semaphore, void, int>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<core_bind::Semaphore,void,int>::~CallableCustomMethodPointer(CallableCustomMethodPointer<core_bind::Semaphore,void,int> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* HashMap<String, Vector<String>, HashMapHasherDefault, HashMapComparatorDefault<String>,
   DefaultTypedAllocator<HashMapElement<String, Vector<String> > > >::~HashMap() */void HashMap<String,Vector<String>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Vector<String>>>>::~HashMap(HashMap<String,Vector<String>,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,Vector<String>>>> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* HashMap<String, ResourceLoader::ThreadLoadTask, HashMapHasherDefault,
   HashMapComparatorDefault<String>, DefaultTypedAllocator<HashMapElement<String,
   ResourceLoader::ThreadLoadTask> > >::~HashMap() */void HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>>::~HashMap(HashMap<String,ResourceLoader::ThreadLoadTask,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,ResourceLoader::ThreadLoadTask>>> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* ResourceLoader::ThreadLoadTask::~ThreadLoadTask() */void ResourceLoader::ThreadLoadTask::~ThreadLoadTask(ThreadLoadTask *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* ResourceLoader::ThreadLoadTask::ThreadLoadTask(ResourceLoader::ThreadLoadTask const&) */void ResourceLoader::ThreadLoadTask::ThreadLoadTask(ThreadLoadTask *this, ThreadLoadTask *param_1) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

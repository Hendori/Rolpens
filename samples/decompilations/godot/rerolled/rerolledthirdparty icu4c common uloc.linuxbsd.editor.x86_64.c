...
LAB_00100696:
      ...
      gotoLAB_001005e5;} * param_4 = 1 * (undefined4*)( param_1 + 8 ) = 0x28 ;*(CharString**)param_1 = param_1 + 0xd;*(undefined4*)( param_1 + 0x38 ) = 0;*(undefined2*)( param_1 + 0xc ) = 0;LAB_001005e5:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return param_1;
}

/* ReplicationEditor::_update_value(NodePath const&, int, int) */void ReplicationEditor::_update_value(ReplicationEditor *this, NodePath *param_1, int param_2, int param_3) {
   char cVar1;
   long lVar2;
   long in_FS_OFFSET;
   Variant local_60[8];
   ...
   if (lVar2 != 0) {
      ...
      if (lVar2 != 0) {
         do {
            ...
            LAB_00100084:lVar2 = TreeItem::get_next();
         }
 while ( lVar2 != 0 );
      }
   ...
   LAB_00100186:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
...
/* ReplicationEditor::_notification(int) [clone .part.0] */void ReplicationEditor::_notification(int param_1) {
   code *pcVar1;
   Ref *pRVar2;
   Object *pOVar3;
   char cVar4;
  ...
  (*pcVar1)((StringName *)&local_48,pOVar6,SceneStringNames::singleton + 600,
            &_notification(int)::{lambda()#1}::operator()()::sname);, Control::add_theme_style_override(pSVar7, (Ref*)( SceneStringNames::singleton + 600 ))(( ( local_48 == (Object*)0x0 ) || ( cVar4 = RefCounted::unreference() ),pOVar3 = local_48,cVar4 == '\0' )) || ( cVar4 = predelete_handler(local_48) ), cVar4 == '\0'));
      {
         cVar4 = RefCounted::unreference();
      }

      else{( **(code**)( *(long*)pOVar3 + 0x140 ) )(pOVar3);
  ...
  Control::get_theme_icon((StringName *)&local_48,pSVar7);, Button::set_button_icon(pRVar2)(( ( local_48 != (Object*)0x0 ) && ( cVar4 = RefCounted::unreference() ),pOVar6 = local_48,cVar4 != '\0' )) && ( cVar4 = predelete_handler(local_48) ), cVar4 != '\0'))(**(code**)( *(long*)pOVar6 + 0x140 ))(pOVar6);
      Memory::free_static(pOVar6, false);
   }
  ...
  Control::get_theme_icon((StringName *)&local_48,pSVar7);, Button::set_button_icon(pRVar2)(( ( local_48 != (Object*)0x0 ) && ( cVar4 = RefCounted::unreference() ),cVar4 != '\0' )) && ( cVar4 = predelete_handler(local_48) ), cVar4 != '\0'))(**(code**)( *(long*)local_48 + 0x140 ))(local_48);
...
/* ReplicationEditor::_notification(int) */void ReplicationEditor::_notification(ReplicationEditor *this, int param_1) {
   char cVar1;
   if (param_1 != 10) {
      if (param_1 == 10000) {
   ...
   LAB_00100809:_notification((int)this);
   return;
}
/* ReplicationEditor::_pick_node_selected(NodePath) */void ReplicationEditor::_pick_node_selected(NodePath *param_1) {
   NodePath *pNVar1;
   Object *pOVar2;
   long lVar3;
   String *pSVar4;
   ...
   if (lVar3 == 0) {
      if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
         ...
         LAB_0010094a:_err_print_error("_pick_node_selected", "modules/multiplayer/editor/replication_editor.cpp", uVar6, pcVar5, 0, 0);
         return;
      }
...
/* ReplicationEditor::_pick_new_property() */void ReplicationEditor::_pick_new_property(ReplicationEditor *this) {
   NodePath *pNVar1;
   long lVar2;
   long in_FS_OFFSET;
   String *local_90;
   ...
   if (pNVar1 == (NodePath*)0x0) {
      ...
      if (lVar2 != 0) {
         SceneTreeDialog::popup_scenetree_dialog(*(Node**)( this + 0xa60 ), (Node*)0x0, SUB81(*(undefined8*)( this + 0xa10 ), 0), true);
         LineEdit::clear();
         if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            Control::grab_focus();
            return;
   ...
   LAB_00100c85:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* ReplicationEditor::_get_class_icon(Node const*) */Node *ReplicationEditor::_get_class_icon(Node *param_1) {
   char cVar1;
   int iVar2;
   long *in_RDX;
   StringName *in_RSI;
   ...
   if ((_get_class_icon(Node_const*)::{lambda()
   #1
   ( iVar2 = __cxa_guard_acquire(&_get_class_icon(Node_const * ::sname), iVar2 != 0) );
   {
      _scs_create((char *)&_get_class_icon(Node_const*)::{lambda()
      #1
      __cxa_atexit(StringName::~StringName,
                 &_get_class_icon(Node_const*)::{lambda()
      #1
      __cxa_guard_release(&_get_class_icon(Node_const*)::{lambda()
      #1
   }

   Control::get_theme_icon((StringName*)param_1, in_RSI);
   LAB_00100d80:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* ReplicationEditor::_can_drop_data_fw(Vector2 const&, Variant const&, Control*) const */ulong ReplicationEditor::_can_drop_data_fw(Vector2 *param_1, Variant *param_2, Control *param_3) {
   char cVar1;
   uint uVar2;
   Variant *this;
   Object *pOVar3;
   ...
   if (cVar1 == '\0') {
      ...
      LAB_00100f98:uVar5 = 0;
   }

   CowData<char32_t>::_unref((CowData<char32_t>*)local_50);
   LAB_00100ebe:Dictionary::~Dictionary((Dictionary*)aVStack_58);
   if (local_30 == *(long*)( in_FS_OFFSET + 0x28 )) {
...
/* ReplicationEditor::_tree_item_edited() */void ReplicationEditor::_tree_item_edited(ReplicationEditor *this) {
   Variant *pVVar1;
   StringName *pSVar2;
   String *pSVar3;
   bool bVar4;
   ...
   if (( lVar7 != 0 ) && ( *(long*)( this + 0xa40 ) != 0 )) {
      ...
      if (1 < iVar5 - 1U) {
         if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
            _err_print_error("_tree_item_edited", "modules/multiplayer/editor/replication_editor.cpp", 0x192, "Condition \"column < 1 || column > 2\" is true.", 0, 0);
            return;
         }
 ...
 while ( pVVar12 != (Variant*)local_a8 );
         ...
         EditorUndoRedoManager::add_do_methodp(pOVar8, (StringName*)this, (Variant**)&local_e0, (int)local_128);
         pVVar11 = pVVar12;
         do {
            pVVar1 = pVVar11 + -0x18;
            pVVar11 = pVVar11 + -0x18;
 ...
 while ( pVVar11 != (Variant*)local_a8 );
         ...
         local_c8 = (Variant*)local_a8;
         local_b8 = (Variant*)&local_78;
         EditorUndoRedoManager::add_undo_methodp(pOVar8, (StringName*)this, (Variant**)&local_e0, (int)local_128);
         do {
            pVVar11 = pVVar12 + -0x18;
            pVVar12 = pVVar12 + -0x18;
            if (Variant::needs_deinit[*(int*)pVVar11] != '\0') {
 ...
 while ( pVVar12 != (Variant*)local_a8 );
         ...
         if (iVar5 == 2) {
            ...
            if (( *plVar9 != 0 ) && ( 0x3f < *(int*)( *plVar9 + 0x10 ) )) {
               ...
               local_100 = 0;
               String::parse_latin1((String*)&local_100, "Each MultiplayerSynchronizer can have no more than 64 watched properties.");
 ...
 while ( pVVar11 != (Variant*)local_a8 );
         ...
         pVStack_c0 = local_90;
         local_b8 = (Variant*)&local_78;
         EditorUndoRedoManager::add_undo_methodp(pOVar8, (StringName*)this, (Variant**)&local_e0, iVar10);
         do {
            pVVar11 = pVVar12 + -0x18;
            pVVar12 = pVVar12 + -0x18;
            if (Variant::needs_deinit[*(int*)pVVar11] != '\0') {
 ...
 while ( pVVar12 != (Variant*)local_a8 );
   ...
   LAB_001014eb:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }

   LAB_00101b1d:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* ReplicationEditor::_tree_button_pressed(Object*, int, int, MouseButton) */void ReplicationEditor::_tree_button_pressed(ReplicationEditor *this, long param_1, undefined8 param_3, undefined8 param_4, int param_5) {
   undefined8 uVar1;
   long lVar2;
   long in_FS_OFFSET;
   String local_a8[8];
...
/* ReplicationEditor::_dialog_closed(bool) */void ReplicationEditor::_dialog_closed(ReplicationEditor *this, bool param_1) {
   Variant *pVVar1;
   StringName *pSVar2;
   char cVar3;
   bool bVar4;
...
/* ReplicationEditor::_add_property(NodePath const&, bool, SceneReplicationConfig::ReplicationMode)
    */void ReplicationEditor::_add_property(ReplicationEditor *this, undefined8 param_2, undefined8 param_3, int param_4) {
   Object *pOVar1;
   char cVar2;
   int iVar3;
   undefined8 uVar4;
      ...
      if (cVar2 == '\0') {
         ...
         if (pNVar5 != (NodePath*)0x0) {
            ...
            if (local_68 == local_e0) {
               LAB_00102c74:if (( ( pOVar9 != (Object*)0x0 ) && ( cVar2 = RefCounted::unreference() ),pOVar9 = local_68,cVar2 != '\0' )) &&( cVar2 = cVar2 != '\0' )(**(code**)( *(long*)pOVar9 + 0x140 ))(pOVar9);
            ...
            if (pOVar1 != (Object*)0x0) {
               cVar2 = RefCounted::unreference();
               pOVar9 = local_68;
               joined_r0x00102e03:local_68 = pOVar9;
               if (( cVar2 != '\0' ) && ( cVar2 = predelete_handler(pOVar1) ),pOVar9 = local_68,cVar2 != '\0') {
         ...
         if (local_80._0_1_ == (StrRange)0x0) {
            LAB_00102d18:TreeItem::set_icon(iVar7, (Ref*)0x0);
         }
 else {
            if (0x18 < local_58[0]) {
               if (local_58[0] == 0x1c) {
            ...
            LAB_00102e69:if (( _add_property(NodePath_const&,bool,SceneReplicationConfig::ReplicationMode)::
               {lambda()#1}::operator()() ) && ( iVar3 = __cxa_guard_acquire(&_add_property(NodePath_const&,bool,SceneReplicationConfig::ReplicationMode)
                                           ::, {
                  lambda()
                  #1
                  _scs_create((char *)&_add_property(NodePath_const&,bool,SceneReplicationConfig::ReplicationMode)
                                 ::{lambda()
                  #1
                  __cxa_atexit(StringName::~StringName, &_add_property(NodePath_const&,bool,SceneReplicationConfig::ReplicationMode)
                          ::, {
                        lambda()
                        #1
...
, Control::get_theme_icon((StringName *) & local_68,(StringName*)this;
                  ...
                  if (( ( local_68 != (Object*)0x0 ) && ( cVar2 = RefCounted::unreference() ),pOVar9 = local_68,cVar2 != '\0' )) &&( cVar2 = cVar2 != '\0' )(**(code**)( *(long*)pOVar9 + 0x140 ))(pOVar9);
                  Memory::free_static(pOVar9, false);
               }
, local_70 = 0;
   ...
   else{NodePath::~NodePath((NodePath*)&local_70);
   _get_class_icon((Node*)&local_e0);
}
}TreeItem::set_icon(iVar7, (Ref*)0x0);LAB_0010259e:local_128 = (String*)&local_88;local_130 = (StrRange*)&local_80;local_138 = local_98;local_140 = (StrRange*)&local_78;local_148 = (StrRange*)&local_90;local_70 = 0;local_68 = (Object*)&_LC14;local_60 = 0;String::parse_latin1((StrRange*)&local_70);if (( _add_property(NodePath_const&,bool,SceneReplicationConfig::ReplicationMode)::{lambda()#2}::
       operator()() ) && ( iVar3 = __cxa_guard_acquire(&_add_property(NodePath_const&,bool,SceneReplicationConfig::ReplicationMode)
  ...
  CowData<char32_t>::_unref((CowData<char32_t> *)local_130);
  CowData<char32_t>::_unref((CowData<char32_t> *)local_140);
  TreeItem::set_range(iVar7,(double)param_4);, TreeItem::set_editable(iVar7, true)(( ( local_e0 != (Object*)0x0 ) && ( cVar2 = RefCounted::unreference() ),pOVar9 = local_e0,cVar2 != '\0' )) && ( cVar2 = predelete_handler(local_e0) ), cVar2 != '\0') ) {
   ( **(code**)( *(long*)pOVar9 + 0x140 ) )(pOVar9);
   Memory::free_static(pOVar9, false);
}
CowData<char32_t>::_unref((CowData<char32_t>*)local_e8);if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
   /* WARNING: Subroutine does not return */
   __stack_chk_fail();
}
return;}/* ReplicationEditor::_update_config() */void ReplicationEditor::_update_config(ReplicationEditor *this) {
   undefined1 uVar1;
   int iVar2;
   undefined4 uVar3;
   int iVar4;
...
/* ReplicationEditor::edit(MultiplayerSynchronizer*) */void ReplicationEditor::edit(ReplicationEditor *this, MultiplayerSynchronizer *param_1) {
   long lVar1;
   Object *pOVar2;
   char cVar3;
   Object *pOVar4;
   ...
   *(MultiplayerSynchronizer**)( this + 0xa10 ) = param_1;
   if (param_1 == (MultiplayerSynchronizer*)0x0) {
      if (( *(long*)( this + 0xa40 ) != 0 ) && ( cVar3 = cVar3 != '\0' )) {
      ...
      *(undefined8*)( this + 0xa40 ) = 0;
      ...
      LAB_001032fb:if (( ( pOVar4 != (Object*)0x0 ) && ( cVar3 = RefCounted::unreference() ),cVar3 != '\0' )) &&( cVar3 = cVar3 != '\0' )(**(code**)( *(long*)local_28 + 0x140 ))(local_28);
      Memory::free_static(local_28, false);
   }

}
LAB_00103310:if (lVar1 == *(long*)( in_FS_OFFSET + 0x28 )) {
   _update_config(this);
   return;
}
LAB_00103423:/* WARNING: Subroutine does not return */__stack_chk_fail();}/* ReplicationEditor::_add_sync_property(String) */void ReplicationEditor::_add_sync_property(ReplicationEditor *this, String *param_2) {
   NodePath *pNVar1;
   StringName *pSVar2;
   Resource *pRVar3;
   String *pSVar4;
   ...
   if (local_98 == (Resource*)pOVar6) {
      LAB_001034c3:if (( ( pOVar7 != (Object*)0x0 ) && ( cVar5 = RefCounted::unreference() ),cVar5 != '\0' )) &&( cVar5 = cVar5 != '\0' )(**(code**)( *(long*)local_98 + 0x140 ))(local_98);
...
else{*(Resource**)( this + 0xa40 ) = local_98;if (local_98 != (Resource*)0x0) {
...
if (pOVar6 != (Object*)0x0) {
   LAB_001034ae:cVar5 = RefCounted::unreference();
   pOVar7 = (Object*)local_98;
   if (( cVar5 != '\0' ) && ( cVar5 = predelete_handler(pOVar6) ),pOVar7 = (Object*)local_98,cVar5 != '\0') {
      ( **(code**)( *(long*)pOVar6 + 0x140 ) )(pOVar6);
      Memory::free_static(pOVar6, false);
      pOVar7 = (Object*)local_98;
   }
...
}pOVar6 = (Object*)EditorUndoRedoManager::get_singleton();local_a0 = 0;local_98 = (Resource*)&_LC14;local_90 = 0;String::parse_latin1((StrRange*)&local_a0);local_98 = (Resource*)0x1070aa;local_a8 = 0;local_90 = 0x1c;String::parse_latin1((StrRange*)&local_a8);TTR((NodePath*)&local_98, (StrRange*)&local_a8);EditorUndoRedoManager::create_action(pOVar6, (NodePath*)&local_98, 0, 0, 0);CowData<char32_t>::_unref((CowData<char32_t>*)&local_98);CowData<char32_t>::_unref((CowData<char32_t>*)&local_a8);CowData<char32_t>::_unref((CowData<char32_t>*)&local_a0);if (*(long*)( this + 0xa40 ) == 0) {
   ...
   *(undefined1(*) [16])( this_00 + 0x250 ) = (undefined1[16])0x0;
   ...
   if (cVar5 == '\0') {
      ...
      LAB_00103d50:local_98 = (Resource*)0x0;
   }
 else {
      Ref<SceneReplicationConfig>::unref((Ref<SceneReplicationConfig>*)&local_98);
      ...
      local_98 = *(Resource**)( this + 0xa40 );
      LAB_00103b7f:uVar8 = *(undefined8*)( this + 0xa10 );
      if (( local_98 == (Resource*)0x0 ) || ( cVar5 = cVar5 == '\0' )) goto LAB_00103d50;
   }

   MultiplayerSynchronizer::set_replication_config(uVar8, (NodePath*)&local_98);
   Ref<SceneReplicationConfig>::unref((Ref<SceneReplicationConfig>*)&local_98);
   pOVar7 = *(Object**)( this + 0xa40 );
   if (( pOVar7 == (Object*)0x0 ) || ( local_98 = (Resource*)pOVar7 ),cVar5 = RefCounted::reference(),cVar5 == '\0') {
      local_98 = (Resource*)0x0;
      pOVar7 = (Object*)0x0;
   }
...
local_d8 = local_88;local_98 = (Resource*)0x0;if (*(long*)param_2 != 0) {
   CowData<char32_t>::_ref((CowData<char32_t>*)&local_98, (CowData*)param_2);
}
StringName::StringName((StringName*)&local_a0, "add_property", false);pSVar2 = *(StringName**)( this + 0xa40 );Variant::Variant((Variant*)local_78, (NodePath*)&local_98);local_60 = 0;local_58 = (undefined1[16])0x0;local_88[0] = (Variant*)local_78;EditorUndoRedoManager::add_do_methodp(pOVar6, pSVar2, (Variant**)&local_a0, (int)local_d8);if (Variant::needs_deinit[(int)local_60] != '\0') {
   Variant::_clear_internal();
}
if (Variant::needs_deinit[local_78[0]] != '\0') {
   Variant::_clear_internal();
...
CowData<char32_t>::_unref((CowData<char32_t>*)&local_98);local_98 = (Resource*)0x0;if (*(long*)param_2 != 0) {
   CowData<char32_t>::_ref((CowData<char32_t>*)&local_98, (CowData*)param_2);
}
StringName::StringName((StringName*)&local_a0, "remove_property", false);pSVar2 = *(StringName**)( this + 0xa40 );Variant::Variant((Variant*)local_78, (NodePath*)&local_98);local_60 = 0;local_58 = (undefined1[16])0x0;local_88[0] = (Variant*)local_78;EditorUndoRedoManager::add_undo_methodp(pOVar6, pSVar2, (Variant**)&local_a0, (int)local_d8);if (Variant::needs_deinit[(int)local_60] != '\0') {
   Variant::_clear_internal();
}
if (Variant::needs_deinit[local_78[0]] != '\0') {
   Variant::_clear_internal();
...
CowData<char32_t>::_unref((CowData<char32_t>*)&local_98);StringName::StringName((StringName*)&local_98, "_update_config", false);local_70 = (undefined1[16])0x0;local_78[0] = 0;local_78[1] = 0;EditorUndoRedoManager::add_do_methodp(pOVar6, (StringName*)this, (Variant**)&local_98, 0);if (Variant::needs_deinit[local_78[0]] != '\0') {
   Variant::_clear_internal();
}
if (( StringName::configured != '\0' ) && ( local_98 != (Resource*)0x0 )) {
   StringName::unref();
}
StringName::StringName((StringName*)&local_98, "_update_config", false);local_70 = (undefined1[16])0x0;local_78[0] = 0;local_78[1] = 0;EditorUndoRedoManager::add_undo_methodp(pOVar6, (StringName*)this, (Variant**)&local_98, 0);if (Variant::needs_deinit[local_78[0]] != '\0') {
   Variant::_clear_internal();
}
if (( StringName::configured != '\0' ) && ( local_98 != (Resource*)0x0 )) {
   StringName::unref();
...
LAB_00103df1:/* WARNING: Subroutine does not return */__stack_chk_fail();}/* ReplicationEditor::_pick_node_property_selected(String) */void ReplicationEditor::_pick_node_property_selected(ReplicationEditor *param_1) {
   long *plVar1;
   long lVar2;
   undefined *puVar3;
   long lVar4;
 ...
 while ( !bVar5 );
   ...
   LAB_00103ef0:_add_sync_property(param_1, (String*)&local_58);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_70);
   if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
...
/* ReplicationEditor::_drop_data_fw(Vector2 const&, Variant const&, Control*) */void ReplicationEditor::_drop_data_fw(Vector2 *param_1, Variant *param_2, Control *param_3) {
   NodePath *pNVar1;
   String *pSVar2;
   char cVar3;
   long lVar4;
   ...
   if (pNVar1 == (NodePath*)0x0) {
      ...
      if (lVar4 == 0) {
         ...
         local_90 = 0;
         String::parse_latin1((String*)&local_90, "Not possible to add a new property to synchronize without a root.");
   ...
   LAB_00104019:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* ReplicationEditor::_add_pressed() */void ReplicationEditor::_add_pressed(ReplicationEditor *this) {
   String *pSVar1;
   char cVar2;
   int iVar3;
   String *pSVar4;
   ...
   if (( local_a0 == (char*)0x0 ) || ( *(uint*)( local_a0 + -8 ) < 2 )) {
      ...
      pSVar4 = (String*)&_LC81;
      if (iVar3 == -1) {
         LAB_001048ff:operator + ( (char*)&local_58,pSVar4 );
   ...
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_a0);
   LAB_00104623:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* ReplicationEditor::_np_text_submitted(String const&) */void ReplicationEditor::_np_text_submitted(String *param_1) {
   _add_pressed((ReplicationEditor*)param_1);
   return;
}
/* ReplicationEditor::_bind_methods() */void ReplicationEditor::_bind_methods(void) {
   long lVar1;
   code *pcVar2;
   long *plVar3;
   MethodBind *pMVar4;
...
/* ReplicationEditor::_pick_node_select_recursive(TreeItem*, String const&, Vector<Node*>&) [clone
   .part.0] */void ReplicationEditor::_pick_node_select_recursive(ReplicationEditor *this, TreeItem *param_1, String *param_2, Vector *param_3) {
   char *__s;
   int iVar1;
   undefined8 uVar2;
   TreeItem *pTVar3;
   ...
   LAB_00104deb:pTVar3 = (TreeItem*)TreeItem::get_first_child();
...
/* ReplicationEditor::_pick_node_select_recursive(TreeItem*, String const&, Vector<Node*>&) */void ReplicationEditor::_pick_node_select_recursive(ReplicationEditor *this, TreeItem *param_1, String *param_2, Vector *param_3) {
...
/* ReplicationEditor::_pick_node_filter_text_changed(String const&) */void ReplicationEditor::_pick_node_filter_text_changed(String *param_1) {
   long *plVar1;
   char *pcVar2;
   long lVar3;
   code *pcVar4;
   ...
   if (local_60 == (undefined8*)0x0) {
      uVar10 = false;
      LAB_001052d5:SceneTreeEditor::set_selected(*(Node**)( *(long*)( param_1 + 0xa60 ) + 0xdc0 ), (bool)uVar10);
 ...
 while ( local_60 != (undefined8*)0x0 );
   lVar9 = 0;
   LAB_0010534e:_err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, 0, lVar9, "p_index", "size()", "", false, true);
   _err_flush_stdout();
   /* WARNING: Does not return */
   pcVar4 = (code*)invalidInstructionException();
   ( *pcVar4 )();
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* ReplicationEditor::ReplicationEditor() */void ReplicationEditor::ReplicationEditor(ReplicationEditor *this) {
   code *pcVar1;
   long *plVar2;
   String *pSVar3;
   undefined8 uVar4;
   ...
   *(undefined8*)( this + 0xa70 ) = 0;
   for (int i = 0; i < 5; i++) {
      *(undefined1(*) [16])( this + ( 16*i + 2592 ) ) = (undefined1[16])0;
   }
   ...
   *(ConfirmationDialog**)( this + 0xa18 ) = this_00;
   ...
   create_custom_callable_function_pointer<ReplicationEditor,bool>((ReplicationEditor*)&local_e8, (char*)this, (_func_void_bool*)"&ReplicationEditor::_dialog_closed");
   ...
   *(char**)( pCVar5 + 0x20 ) = "ReplicationEditor::_pick_node_selected";
   ...
   pcVar1 = *(code**)( *plVar2 + 0x108 );
   create_custom_callable_function_pointer<ReplicationEditor,String_const&>((ReplicationEditor*)&local_e8, (char*)this, (_func_void_String_ptr*)"&ReplicationEditor::_pick_node_filter_text_changed");
      ...
      *puVar6 = 1;
      ...
      do {
         if (local_130 == (undefined8*)0x0) {
            lVar13 = 0;
            LAB_00106783:_err_print_index_error("set", "./core/templates/cowdata.h", 0xcf, lVar14, lVar13, "p_index", "size()", "", false, false);
         }
 else {
            lVar13 = local_130[-1];
            ...
            local_130 = puVar6;
            *(undefined4*)( (long)local_130 + lVar14 * 4 ) = *(undefined4*)( (long)&local_d8 + lVar14 * 4 );
         }
 ...
 while ( lVar14 != 0x23 );
   ...
   *(Button**)( this + 0xa20 ) = pBVar7;
   ...
   pcVar1 = *(code**)( *plVar2 + 0x108 );
   create_custom_callable_function_pointer<ReplicationEditor>((ReplicationEditor*)&local_e8, (char*)this, (_func_void*)"&ReplicationEditor::_pick_new_property");
   ...
   *(LineEdit**)( this + 0xa30 ) = this_05;
   ...
   pcVar1 = *(code**)( *plVar2 + 0x108 );
   create_custom_callable_function_pointer<ReplicationEditor,String_const&>((ReplicationEditor*)&local_e8, (char*)this, (_func_void_String_ptr*)"&ReplicationEditor::_np_text_submitted");
   ...
   *(Button**)( this + 0xa28 ) = pBVar7;
   ...
   pcVar1 = *(code**)( *plVar2 + 0x108 );
   create_custom_callable_function_pointer<ReplicationEditor>((ReplicationEditor*)&local_e8, (char*)this, (_func_void*)"&ReplicationEditor::_add_pressed");
   ( *pcVar1 )(plVar2, SceneStringNames::singleton + 0x238, (ReplicationEditor*)&local_e8, 0);
   Callable::~Callable((Callable*)&local_e8);
   local_e8 = "";
   local_f8[0] = 0;
   ...
   *(char**)( pCVar5 + 0x20 ) = "ReplicationEditor::_tree_button_pressed";
   ...
   plVar2 = *(long**)( this + 0xa50 );
   pcVar1 = *(code**)( *plVar2 + 0x108 );
   create_custom_callable_function_pointer<ReplicationEditor>((ReplicationEditor*)&local_e8, (char*)this, (_func_void*)"&ReplicationEditor::_tree_item_edited");
   ...
   *(Label**)( this + 0xa38 ) = pLVar9;
   ...
   local_e0 = 0;
   String::parse_latin1((StrRange*)local_f8);
   local_e8 = "Add properties using the options above, or\ndrag them from the inspector and drop them here.";
   local_108[0] = 0;
   local_e0 = 0x5b;
   String::parse_latin1((StrRange*)local_108);
   TTR((ReplicationEditor*)&local_e8, (StringName*)local_108);
...
/* CallableCustomMethodPointer<ReplicationEditor, void, Vector2 const&, Variant const&,
   Control*>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<ReplicationEditor,void,Vector2_const&,Variant_const&,Control*>::~CallableCustomMethodPointer(CallableCustomMethodPointer<ReplicationEditor,void,Vector2_const&,Variant_const&,Control*> *this) {
   return;
}
/* CallableCustomMethodPointerC<ReplicationEditor, bool, Vector2 const&, Variant const&,
   Control*>::~CallableCustomMethodPointerC() */void CallableCustomMethodPointerC<ReplicationEditor,bool,Vector2_const&,Variant_const&,Control*>::~CallableCustomMethodPointerC(CallableCustomMethodPointerC<ReplicationEditor,bool,Vector2_const&,Variant_const&,Control*> *this) {
   return;
}
/* CallableCustomMethodPointer<ReplicationEditor, void, Object*, int, int,
   MouseButton>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<ReplicationEditor,void,Object*,int,int,MouseButton>::~CallableCustomMethodPointer(CallableCustomMethodPointer<ReplicationEditor,void,Object*,int,int,MouseButton> *this) {
   return;
}
/* CallableCustomMethodPointer<ReplicationEditor, void>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<ReplicationEditor,void>::~CallableCustomMethodPointer(CallableCustomMethodPointer<ReplicationEditor,void> *this) {
   return;
}
/* CallableCustomMethodPointer<ReplicationEditor, void, String>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<ReplicationEditor,void,String>::~CallableCustomMethodPointer(CallableCustomMethodPointer<ReplicationEditor,void,String> *this) {
   return;
}
/* CallableCustomMethodPointer<ReplicationEditor, void, String
   const&>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<ReplicationEditor,void,String_const&>::~CallableCustomMethodPointer(CallableCustomMethodPointer<ReplicationEditor,void,String_const&> *this) {
   return;
}
/* CallableCustomMethodPointer<ReplicationEditor, void, NodePath>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<ReplicationEditor,void,NodePath>::~CallableCustomMethodPointer(CallableCustomMethodPointer<ReplicationEditor,void,NodePath> *this) {
   return;
}
/* CallableCustomMethodPointer<ReplicationEditor, void, bool>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<ReplicationEditor,void,bool>::~CallableCustomMethodPointer(CallableCustomMethodPointer<ReplicationEditor,void,bool> *this) {
   return;
}
/* MethodBindT<NodePath const&, int, int>::get_argument_meta(int) const */byte MethodBindT<NodePath_const&,int,int>::get_argument_meta(MethodBindT<NodePath_const&,int,int> *this, int param_1) {
...
/* CallableCustomMethodPointer<ReplicationEditor, void, Vector2 const&, Variant const&,
   Control*>::get_argument_count(bool&) const */undefined8 CallableCustomMethodPointer<ReplicationEditor,void,Vector2_const&,Variant_const&,Control*>::get_argument_count(CallableCustomMethodPointer<ReplicationEditor,void,Vector2_const&,Variant_const&,Control*> *this, bool *param_1) {
   *param_1 = true;
   return 3;
}
/* CallableCustomMethodPointerC<ReplicationEditor, bool, Vector2 const&, Variant const&,
   Control*>::get_argument_count(bool&) const */undefined8 CallableCustomMethodPointerC<ReplicationEditor,bool,Vector2_const&,Variant_const&,Control*>::get_argument_count(CallableCustomMethodPointerC<ReplicationEditor,bool,Vector2_const&,Variant_const&,Control*> *this, bool *param_1) {
   *param_1 = true;
   return 3;
}
/* CallableCustomMethodPointer<ReplicationEditor, void, Object*, int, int,
   MouseButton>::get_argument_count(bool&) const */undefined8 CallableCustomMethodPointer<ReplicationEditor,void,Object*,int,int,MouseButton>::get_argument_count(CallableCustomMethodPointer<ReplicationEditor,void,Object*,int,int,MouseButton> *this, bool *param_1) {
   *param_1 = true;
   return 4;
}
/* CallableCustomMethodPointer<ReplicationEditor, void>::get_argument_count(bool&) const */undefined8 CallableCustomMethodPointer<ReplicationEditor,void>::get_argument_count(CallableCustomMethodPointer<ReplicationEditor,void> *this, bool *param_1) {
   *param_1 = true;
   return 0;
}
/* CallableCustomMethodPointer<ReplicationEditor, void, String>::get_argument_count(bool&) const */undefined8 CallableCustomMethodPointer<ReplicationEditor,void,String>::get_argument_count(CallableCustomMethodPointer<ReplicationEditor,void,String> *this, bool *param_1) {
   *param_1 = true;
   return 1;
}
/* CallableCustomMethodPointer<ReplicationEditor, void, String const&>::get_argument_count(bool&)
   const */undefined8 CallableCustomMethodPointer<ReplicationEditor,void,String_const&>::get_argument_count(CallableCustomMethodPointer<ReplicationEditor,void,String_const&> *this, bool *param_1) {
   *param_1 = true;
   return 1;
}
/* CallableCustomMethodPointer<ReplicationEditor, void, NodePath>::get_argument_count(bool&) const
    */undefined8 CallableCustomMethodPointer<ReplicationEditor,void,NodePath>::get_argument_count(CallableCustomMethodPointer<ReplicationEditor,void,NodePath> *this, bool *param_1) {
   *param_1 = true;
   return 1;
}
/* CallableCustomMethodPointer<ReplicationEditor, void, bool>::get_argument_count(bool&) const */undefined8 CallableCustomMethodPointer<ReplicationEditor,void,bool>::get_argument_count(CallableCustomMethodPointer<ReplicationEditor,void,bool> *this, bool *param_1) {
   *param_1 = true;
   return 1;
}
...
/* ReplicationEditor::_property_get_revertv(StringName const&, Variant&) const */undefined8 ReplicationEditor::_property_get_revertv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
   if ((code*)_GLOBAL_OFFSET_TABLE_ != Object::_property_get_revert) {
      uVar1 = Control::_property_get_revert(param_1, param_2);
      return uVar1;
...
/* ReplicationEditor::_property_can_revertv(StringName const&) const */undefined8 ReplicationEditor::_property_can_revertv(StringName *param_1) {
   undefined8 uVar1;
   if ((code*)PTR__property_can_revert_00115008 != Object::_property_can_revert) {
      uVar1 = Control::_property_can_revert(param_1);
      return uVar1;
...
/* MethodBindT<NodePath const&, int, int>::~MethodBindT() */void MethodBindT<NodePath_const&,int,int>::~MethodBindT(MethodBindT<NodePath_const&,int,int> *this) {
...
/* MethodBindT<NodePath const&, int, int>::_gen_argument_type(int) const */char MethodBindT<NodePath_const&,int,int>::_gen_argument_type(MethodBindT<NodePath_const&,int,int> *this, int param_1) {
   char cVar1;
   cVar1 = '\0';
   if ((uint)param_1 < 3) {
...
/* ReplicationEditor::_notification(int) [clone .part.0] [clone .cold] */void ReplicationEditor::_notification(int param_1) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* ReplicationEditor::_bind_methods() [clone .cold] */void ReplicationEditor::_bind_methods(void) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* ReplicationEditor::ReplicationEditor() [clone .cold] */void ReplicationEditor::ReplicationEditor(ReplicationEditor *this) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* CallableCustomMethodPointer<ReplicationEditor, void, NodePath>::get_object() const */undefined8 CallableCustomMethodPointer<ReplicationEditor,void,NodePath>::get_object(CallableCustomMethodPointer<ReplicationEditor,void,NodePath> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   uVar2 = 0;
   LAB_0010732d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* CallableCustomMethodPointer<ReplicationEditor, void, String const&>::get_object() const */undefined8 CallableCustomMethodPointer<ReplicationEditor,void,String_const&>::get_object(CallableCustomMethodPointer<ReplicationEditor,void,String_const&> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   uVar2 = 0;
   LAB_0010742d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* CallableCustomMethodPointer<ReplicationEditor, void, Object*, int, int,
   MouseButton>::get_object() const */undefined8 CallableCustomMethodPointer<ReplicationEditor,void,Object*,int,int,MouseButton>::get_object(CallableCustomMethodPointer<ReplicationEditor,void,Object*,int,int,MouseButton> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   uVar2 = 0;
   LAB_0010752d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* CallableCustomMethodPointerC<ReplicationEditor, bool, Vector2 const&, Variant const&,
   Control*>::get_object() const */undefined8 CallableCustomMethodPointerC<ReplicationEditor,bool,Vector2_const&,Variant_const&,Control*>::get_object(CallableCustomMethodPointerC<ReplicationEditor,bool,Vector2_const&,Variant_const&,Control*> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   uVar2 = 0;
   LAB_0010762d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* CallableCustomMethodPointer<ReplicationEditor, void, Vector2 const&, Variant const&,
   Control*>::get_object() const */undefined8 CallableCustomMethodPointer<ReplicationEditor,void,Vector2_const&,Variant_const&,Control*>::get_object(CallableCustomMethodPointer<ReplicationEditor,void,Vector2_const&,Variant_const&,Control*> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   uVar2 = 0;
   LAB_0010772d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* CallableCustomMethodPointer<ReplicationEditor, void, String>::get_object() const */undefined8 CallableCustomMethodPointer<ReplicationEditor,void,String>::get_object(CallableCustomMethodPointer<ReplicationEditor,void,String> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   uVar2 = 0;
   LAB_0010782d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* CallableCustomMethodPointer<ReplicationEditor, void, bool>::get_object() const */undefined8 CallableCustomMethodPointer<ReplicationEditor,void,bool>::get_object(CallableCustomMethodPointer<ReplicationEditor,void,bool> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   uVar2 = 0;
   LAB_0010792d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* CallableCustomMethodPointer<ReplicationEditor, void>::get_object() const */undefined8 CallableCustomMethodPointer<ReplicationEditor,void>::get_object(CallableCustomMethodPointer<ReplicationEditor,void> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   uVar2 = 0;
   LAB_00107a2d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* ReplicationEditor::_validate_propertyv(PropertyInfo&) const */void ReplicationEditor::_validate_propertyv(PropertyInfo *param_1) {
   for (int i = 0; i < 3; i++) {
...
/* ReplicationEditor::_setv(StringName const&, Variant const&) */undefined8 ReplicationEditor::_setv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
   uVar1 = CanvasItem::_set(param_1, param_2);
   if ((char)uVar1 == '\0') {
      if ((code*)PTR__set_00115018 != CanvasItem::_set) {
...
/* WARNING: Removing unreachable block (ram,0x00107df8) *//* ReplicationEditor::_getv(StringName const&, Variant&) const */undefined8 ReplicationEditor::_getv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
   if (( (code*)PTR__get_00115020 != CanvasItem::_get ) && ( uVar1 = Control::_get(param_1, param_2) ),(char)uVar1 != '\0') {
      return uVar1;
   }
...
/* WARNING: Removing unreachable block (ram,0x00107e68) *//* VBoxContainer::_getv(StringName const&, Variant&) const */undefined8 VBoxContainer::_getv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
   if (( (code*)PTR__get_00115020 != CanvasItem::_get ) && ( uVar1 = Control::_get(param_1, param_2) ),(char)uVar1 != '\0') {
      return uVar1;
   }
...
/* WARNING: Removing unreachable block (ram,0x00107ed8) *//* HBoxContainer::_getv(StringName const&, Variant&) const */undefined8 HBoxContainer::_getv(StringName *param_1, Variant *param_2) {
   undefined8 uVar1;
   if (( (code*)PTR__get_00115020 != CanvasItem::_get ) && ( uVar1 = Control::_get(param_1, param_2) ),(char)uVar1 != '\0') {
      return uVar1;
   }
...
/* VBoxContainer::is_class_ptr(void*) const */uint VBoxContainer::is_class_ptr(void *param_1) {
   ...
   if (in_RSI != &get_class_ptr_static()::ptr) {
      uVar1 = (uint)CONCAT71(0x1119, in_RSI == &Container::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1119, in_RSI == &BoxContainer::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1119, in_RSI == &Control::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1119, in_RSI == &CanvasItem::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1119, in_RSI == &Node::get_class_ptr_static(), ::ptr) | CONCAT31(( int3 )((uint)in_EDX >> 8), in_RSI == &Object::get_class_ptr_static(), ::ptr);
   }
...
/* ReplicationEditor::is_class_ptr(void*) const */ulong ReplicationEditor::is_class_ptr(void *param_1) {
   undefined4 in_EDX;
   undefined4 *in_RSI;
   if (in_RSI == &VBoxContainer::get_class_ptr_static() || in_RSI == &get_class_ptr_static()::ptr) {
      return CONCAT71(0x1118, in_RSI == &VBoxContainer::get_class_ptr_static() || in_RSI == &get_class_ptr_static(), ::ptr);
   }

   return ( ulong )((uint)CONCAT71(0x1119, in_RSI == &Container::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1119, in_RSI == &BoxContainer::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1119, in_RSI == &Control::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1119, in_RSI == &CanvasItem::get_class_ptr_static(), ::ptr) | (uint)CONCAT71(0x1119, in_RSI == &Node::get_class_ptr_static(), ::ptr) | CONCAT31(( int3 )((uint)in_EDX >> 8), in_RSI == &Object::get_class_ptr_static(), ::ptr));
}
/* HBoxContainer::~HBoxContainer() */void HBoxContainer::~HBoxContainer(HBoxContainer *this) {
   ...
   *(undefined8**)this = &EditorNode::singleton;
   ...
   LAB_001080b0:Control::~Control((Control*)this);
   return;
}
/* VBoxContainer::~VBoxContainer() */void VBoxContainer::~VBoxContainer(VBoxContainer *this) {
   ...
   *(undefined8**)this = &EditorNode::singleton;
   ...
   LAB_00108110:Control::~Control((Control*)this);
   return;
}
/* HBoxContainer::~HBoxContainer() */void HBoxContainer::~HBoxContainer(HBoxContainer *this) {
   bool bVar1;
   ...
   *(undefined8**)this = &EditorNode::singleton;
   ...
   LAB_00108170:Control::~Control((Control*)this);
...
/* VBoxContainer::~VBoxContainer() */void VBoxContainer::~VBoxContainer(VBoxContainer *this) {
   ...
   *(undefined8**)this = &EditorNode::singleton;
   ...
   LAB_001081e0:Control::~Control((Control*)this);
   operator_delete(this, 0xa10);
   return;
}
/* ReplicationEditor::~ReplicationEditor() */void ReplicationEditor::~ReplicationEditor(ReplicationEditor *this) {
   Object *pOVar1;
   char cVar2;
   bool bVar3;
   *(undefined***)this = &PTR__initialize_classv_00110fd8;
   ...
   *(undefined8**)this = &EditorNode::singleton;
   ...
   LAB_00108290:Control::~Control((Control*)this);
   return;
}
/* ReplicationEditor::~ReplicationEditor() */void ReplicationEditor::~ReplicationEditor(ReplicationEditor *this) {
   Object *pOVar1;
...
/* ReplicationEditor::_get_class_namev() const */undefined8 *ReplicationEditor::_get_class_namev(void) {
   int iVar1;
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00108463:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00108463;
         StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "ReplicationEditor");
         goto LAB_001084ce;
      }
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "ReplicationEditor");
   LAB_001084ce:return &_get_class_namev();
}
/* VBoxContainer::_get_class_namev() const */undefined8 *VBoxContainer::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00108553:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00108553;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "VBoxContainer");
   LAB_001085be:return &_get_class_namev();
}
/* HBoxContainer::_get_class_namev() const */undefined8 *HBoxContainer::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00108643:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00108643;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "HBoxContainer");
   LAB_001086ae:return &_get_class_namev();
}
/* ReplicationEditor::get_class() const */void ReplicationEditor::get_class(void) {
   long lVar1;
   long lVar2;
   char *__s;
   long in_RSI;
...
/* WARNING: Removing unreachable block (ram,0x00108aa0) *//* BoxContainer::_notificationv(int, bool) */void BoxContainer::_notificationv(BoxContainer *this, int param_1, bool param_2) {
   int iVar1;
   iVar1 = (int)this;
   if (param_2) {
...
/* ReplicationEditor::_notificationv(int, bool) */void ReplicationEditor::_notificationv(ReplicationEditor *this, int param_1, bool param_2) {
   char cVar1;
   if (!param_2) {
      BoxContainer::_notificationv((BoxContainer*)this, param_1, false);
      if (param_1 != 10) {
      ...
      LAB_00108b99:_notification((int)this);
      return;
   }
   ...
   LAB_00108b51:BoxContainer::_notificationv((BoxContainer*)this, param_1, true);
   return;
}
...
/* Callable create_custom_callable_function_pointer<ReplicationEditor, bool>(ReplicationEditor*,
   char const*, void (ReplicationEditor::*)(bool)) */ReplicationEditor *create_custom_callable_function_pointer<ReplicationEditor,bool>(ReplicationEditor *param_1, char *param_2, _func_void_bool *param_3) {
   undefined8 uVar1;
   CallableCustom *this;
   undefined8 in_RCX;
   undefined8 in_R8;
...
/* Callable create_custom_callable_function_pointer<ReplicationEditor, String
   const&>(ReplicationEditor*, char const*, void (ReplicationEditor::*)(String const&)) */ReplicationEditor *create_custom_callable_function_pointer<ReplicationEditor,String_const&>(ReplicationEditor *param_1, char *param_2, _func_void_String_ptr *param_3) {
   undefined8 uVar1;
   CallableCustom *this;
   undefined8 in_RCX;
   undefined8 in_R8;
...
/* Callable create_custom_callable_function_pointer<ReplicationEditor>(ReplicationEditor*, char
   const*, void (ReplicationEditor::*)()) */ReplicationEditor *create_custom_callable_function_pointer<ReplicationEditor>(ReplicationEditor *param_1, char *param_2, _func_void *param_3) {
   undefined8 uVar1;
   CallableCustom *this;
   undefined8 in_RCX;
   undefined8 in_R8;
...
/* Callable Callable::bind<Tree*>(Tree*) const */Tree *Callable::bind<Tree*>(Tree *param_1) {
   char cVar1;
   Object *in_RDX;
   int in_ESI;
   long in_FS_OFFSET;
...
/* Ref<SceneReplicationConfig>::unref() */void Ref<SceneReplicationConfig>::unref(Ref<SceneReplicationConfig> *this) {
   Object *pOVar1;
   char cVar2;
   if (*(long*)this != 0) {
      cVar2 = RefCounted::unreference();
...
/* WARNING: Removing unreachable block (ram,0x00109698) *//* String vformat<String>(String const&, String const) */undefined8 *vformat<String>(undefined8 *param_1, bool *param_2, String *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* PropertyListHelper::~PropertyListHelper() */void PropertyListHelper::~PropertyListHelper(PropertyListHelper *this) {
 ...
 while ( lVar4 != (ulong)uVar2 << 2 );
   ...
   LAB_001099c4:CowData<char32_t>::_unref((CowData<char32_t>*)this);
   return;
}
/* CallableCustomMethodPointer<ReplicationEditor, void>::call(Variant const**, int, Variant&,
   Callable::CallError&) const */void CallableCustomMethodPointer<ReplicationEditor,void>::call(CallableCustomMethodPointer<ReplicationEditor,void> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long lVar1;
   long lVar2;
   uint uVar3;
   ulong *puVar4;
...
;
      ...
      *(undefined4*)( param_4 + 8 ) = 0;
      ...
      _err_print_error(&_LC67, "./core/object/callable_method_pointer.h", 0x67, "Parameter \"ObjectDB::get_instance(ObjectID(data.object_id))\" is null.", (String*)&local_48, 0, 0);
   ...
   LAB_00109cd1:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* CallableCustomMethodPointer<ReplicationEditor, void, NodePath>::call(Variant const**, int,
   Variant&, Callable::CallError&) const */void CallableCustomMethodPointer<ReplicationEditor,void,NodePath>::call(CallableCustomMethodPointer<ReplicationEditor,void,NodePath> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long lVar1;
   long lVar2;
   ulong uVar3;
   undefined8 uVar4;
...
;
   ...
   local_58,(String*)"Invalid Object id \'";
   String::operator +((String*)&local_48, (String*)local_58);
   _err_print_error(&_LC67, "./core/object/callable_method_pointer.h", 0x67, "Parameter \"ObjectDB::get_instance(ObjectID(data.object_id))\" is null.", (Variant*)&local_48, 0, 0);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_48);
   CowData<char32_t>::_unref(local_58);
   CowData<char32_t>::_unref(local_60);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_50);
   LAB_00109dae:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
;
            ...
            *(undefined4*)param_4 = 0;
            ...
            if (cVar5 == '\0') {
               ...
               *(undefined8*)( param_4 + 4 ) = uVar4;
               ...
               if (( ( pOVar7 == (Object*)0x0 ) || ( lVar8 = __dynamic_cast(pOVar7, &Object::typeinfo, &Control::typeinfo, 0) ),lVar8 == 0 )) goto LAB_0010a09f;
            }
   ...
   _err_print_error(&_LC67, "./core/object/callable_method_pointer.h", 0x67, "Parameter \"ObjectDB::get_instance(ObjectID(data.object_id))\" is null.", (String*)&local_78, 0, 0);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_78);
   CowData<char32_t>::_unref(local_88);
   CowData<char32_t>::_unref(local_90);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_80);
   LAB_0010a015:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* CallableCustomMethodPointerC<ReplicationEditor, bool, Vector2 const&, Variant const&,
   Control*>::call(Variant const**, int, Variant&, Callable::CallError&) const */void CallableCustomMethodPointerC<ReplicationEditor,bool,Vector2_const&,Variant_const&,Control*>::call(CallableCustomMethodPointerC<ReplicationEditor,bool,Vector2_const&,Variant_const&,Control*> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long lVar1;
   long lVar2;
   Variant *this_00;
   ulong uVar3;
...
;
            ...
            *(undefined4*)param_4 = 0;
            ...
            if (cVar5 == '\0') {
               ...
               *(undefined8*)( param_4 + 4 ) = uVar4;
               ...
               pOVar6 = Variant::operator_cast_to_Object_(this_00);
               pOVar7 = Variant::operator_cast_to_Object_(this_00);
               if (( ( pOVar7 == (Object*)0x0 ) || ( lVar8 = __dynamic_cast(pOVar7, &Object::typeinfo, &Control::typeinfo, 0) ),lVar8 == 0 )) goto LAB_0010a41c;
            }
   ...
   operator+((char *)
   local_a8,(String*)"Invalid Object id \'";
   String::operator +((String*)&local_98, (String*)local_a8);
   _err_print_error(&_LC67, "./core/object/callable_method_pointer.h", 0xad, "Parameter \"ObjectDB::get_instance(ObjectID(data.object_id))\" is null.", (String*)&local_98, 0, 0);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_98);
   CowData<char32_t>::_unref(local_a8);
   CowData<char32_t>::_unref(local_b0);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_a0);
   LAB_0010a394:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* CallableCustomMethodPointer<ReplicationEditor, void, Object*, int, int,
   MouseButton>::call(Variant const**, int, Variant&, Callable::CallError&) const */void CallableCustomMethodPointer<ReplicationEditor,void,Object*,int,int,MouseButton>::call(CallableCustomMethodPointer<ReplicationEditor,void,Object*,int,int,MouseButton> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long lVar1;
   long lVar2;
   Variant *this_00;
   undefined8 uVar3;
...
;
      ...
      String::operator +((String*)&local_58, (String*)local_68);
      _err_print_error(&_LC67, "./core/object/callable_method_pointer.h", 0x67, "Parameter \"ObjectDB::get_instance(ObjectID(data.object_id))\" is null.", (String*)&local_58, 0, 0);
      CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
   ...
   LAB_0010a9cb:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* CallableCustomMethodPointer<ReplicationEditor, void, bool>::call(Variant const**, int, Variant&,
   Callable::CallError&) const */void CallableCustomMethodPointer<ReplicationEditor,void,bool>::call(CallableCustomMethodPointer<ReplicationEditor,void,bool> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long lVar1;
   long lVar2;
   ulong uVar3;
   undefined8 uVar4;
...
;
   ...
   LAB_0010ac4b:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* CallableCustomMethodPointer<ReplicationEditor, void, String const&>::call(Variant const**, int,
   Variant&, Callable::CallError&) const */void CallableCustomMethodPointer<ReplicationEditor,void,String_const&>::call(CallableCustomMethodPointer<ReplicationEditor,void,String_const&> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long lVar1;
   long lVar2;
   ulong uVar3;
   undefined8 uVar4;
...
;
   ...
   CowData<char32_t>::_unref(local_60);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_50);
   LAB_0010ad1e:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* CallableCustomMethodPointer<ReplicationEditor, void, String>::call(Variant const**, int,
   Variant&, Callable::CallError&) const */void CallableCustomMethodPointer<ReplicationEditor,void,String>::call(CallableCustomMethodPointer<ReplicationEditor,void,String> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long lVar1;
   long lVar2;
   ulong uVar3;
   undefined8 uVar4;
...
;
   ...
   CowData<char32_t>::_unref(local_60);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_50);
   LAB_0010af8e:if (local_30 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* CanvasItem::is_class(String const&) const */undefined8 CanvasItem::is_class(CanvasItem *this, String *param_1) {
 ...
 while ( !bVar9 );
      ...
      LAB_0010b1bf:cVar6 = String::operator ==((String*)param_1, (String*)&local_60);
      lVar5 = local_60;
      if (local_60 != 0) {
         LOCK();
   ...
   LAB_0010b273:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0010b458:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* Container::is_class(String const&) const */undefined8 Container::is_class(Container *this, String *param_1) {
 ...
 while ( !bVar9 );
      ...
      LAB_0010b4df:cVar6 = String::operator ==((String*)param_1, (String*)&local_60);
      lVar5 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   LAB_0010b593:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0010b6a5:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
         ...
         if (Container::initialize_class() == '\0') {
            if (Control::initialize_class() == '\0') {
               if (CanvasItem::initialize_class() == '\0') {
                  ...
                  if ((code*)PTR__bind_compatibility_methods_00115030 != Object::_bind_compatibility_methods) {
...
/* Node::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Node::_get_property_listv(List *param_1, bool param_2) {
   ...
   LAB_0010c49c:List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)CONCAT71(in_register_00000031, param_2), (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref((CowData<char32_t>*)&local_58);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
   }
...
/* CanvasItem::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void CanvasItem::_get_property_listv(CanvasItem *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_0010c701:local_b0 = (CowData<char32_t>*)&local_58;
...
/* Control::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Control::_get_property_listv(Control *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_0010c9d1:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* Container::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void Container::_get_property_listv(Container *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_0010cca1:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* BoxContainer::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void BoxContainer::_get_property_listv(BoxContainer *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_0010cf51:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* VBoxContainer::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void VBoxContainer::_get_property_listv(VBoxContainer *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_0010d201:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* ReplicationEditor::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void ReplicationEditor::_get_property_listv(ReplicationEditor *this, List *param_1, bool param_2) {
   long in_FS_OFFSET;
   CowData<char32_t> *local_b0;
   long local_98;
   long local_90;
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_0010d4b1:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* HBoxContainer::_get_property_listv(List<PropertyInfo, DefaultAllocator>*, bool) const */void HBoxContainer::_get_property_listv(HBoxContainer *this, List *param_1, bool param_2) {
   ...
   local_50 = 0x80;
   StringName::operator =((StringName*)&local_68, (StringName*)&local_88);
   LAB_0010d761:local_b0 = (CowData<char32_t>*)&local_58;
   List<PropertyInfo,DefaultAllocator>::push_back((List<PropertyInfo,DefaultAllocator>*)param_1, (PropertyInfo*)&local_78);
   CowData<char32_t>::_unref(local_b0);
   if (( StringName::configured != '\0' ) && ( local_68 != 0 )) {
      StringName::unref();
...
/* ReplicationEditor::is_class(String const&) const */undefined8 ReplicationEditor::is_class(ReplicationEditor *this, String *param_1) {
   long *plVar1;
   long lVar2;
   long lVar3;
   char *pcVar4;
 ...
 while ( !bVar9 );
      ...
      LAB_0010d90f:cVar6 = String::operator ==((String*)param_1, (String*)&local_60);
      lVar5 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   LAB_0010d9c3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0010dbb8:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* HBoxContainer::is_class(String const&) const */undefined8 HBoxContainer::is_class(HBoxContainer *this, String *param_1) {
 ...
 while ( !bVar9 );
      ...
      LAB_0010dc2f:cVar6 = String::operator ==((String*)param_1, (String*)&local_60);
      lVar5 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   LAB_0010dce3:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0010ddee:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* VBoxContainer::is_class(String const&) const */undefined8 VBoxContainer::is_class(VBoxContainer *this, String *param_1) {
 ...
 while ( !bVar9 );
      ...
      LAB_0010de6f:cVar6 = String::operator ==((String*)param_1, (String*)&local_60);
      lVar5 = local_60;
      if (local_60 != 0) {
         LOCK();
         plVar1 = (long*)( local_60 + -0x10 );
   ...
   LAB_0010df23:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return 1;
   }

   LAB_0010e02e:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBind* create_method_bind<ReplicationEditor>(void (ReplicationEditor::*)()) */MethodBind *create_method_bind<ReplicationEditor>(_func_void *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* MethodBind* create_method_bind<ReplicationEditor, NodePath const&, int, int>(void
   (ReplicationEditor::*)(NodePath const&, int, int)) */MethodBind *create_method_bind<ReplicationEditor,NodePath_const&,int,int>(_func_void_NodePath_ptr_int_int *param_1) {
   long *plVar1;
   long lVar2;
   MethodBind *this;
   undefined8 in_RSI;
...
/* ReplicationEditor::_initialize_classv() */void ReplicationEditor::_initialize_classv(void) {
   long in_FS_OFFSET;
   undefined8 local_70;
   long local_68;
   long local_60;
...
/* CowData<Node*>::_realloc(long) */undefined8 CowData<Node*>::_realloc(CowData<Node*> *this, long param_1) {
   undefined8 *puVar1;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* Error CowData<Node*>::resize<false>(long) */undefined8 CowData<Node*>::resize<false>(CowData<Node*> *this, long param_1) {
   long *plVar1;
   code *pcVar2;
   long lVar3;
   ulong uVar4;
   ...
   if (param_1 * 8 == 0) {
      LAB_0010eca0:_err_print_error("resize", "./core/templates/cowdata.h", 0x16a, "Condition \"!_get_alloc_size_checked(p_size, &alloc_size)\" is true. Returning: ERR_OUT_OF_MEMORY", 0, 0);
      return 6;
   }
...
/* WARNING: Removing unreachable block (ram,0x0010ee98) *//* String vformat<StringName>(String const&, StringName const) */undefined8 *vformat<StringName>(undefined8 *param_1, bool *param_2, StringName *param_3) {
   char cVar1;
   Variant *this;
   int iVar2;
   long in_FS_OFFSET;
...
/* MethodBindT<NodePath const&, int, int>::validated_call(Object*, Variant const**, Variant*) const
    */void MethodBindT<NodePath_const&,int,int>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   code *UNRECOVERED_JUMPTABLE;
   Variant *pVVar1;
   long in_FS_OFFSET;
   long local_58;
   ...
   LAB_0010f331:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<NodePath const&, int, int>::ptrcall(Object*, void const**, void*) const */void MethodBindT<NodePath_const&,int,int>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   code *UNRECOVERED_JUMPTABLE;
   long *plVar1;
   long in_FS_OFFSET;
   long local_58;
   ...
   LAB_0010f521:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<>::call(Object*, Variant const**, int, Callable::CallError&) const */Object *MethodBindT<>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   ...
   if (( ( plVar4 != (long*)0x0 ) && ( plVar4[1] != 0 ) ) && ( *(char*)( plVar4[1] + 0x2e ) != '\0' )) {
      ...
      if (local_48 == (char*)*plVar3) {
         ...
         String::parse_latin1((StrRange*)&local_50);
         vformat<StringName>((StringName*)&local_48, (StrRange*)&local_50, &local_58);
         _err_print_error(&_LC67, "./core/object/method_bind.h", 0x154, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: Variant()", (StringName*)&local_48, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_48);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_50);
         if (( StringName::configured != '\0' ) && ( local_58 != 0 )) {
            StringName::unref();
   ...
   LAB_0010f640:*(undefined4*)param_1 = 0;
...
/* MethodBindT<>::validated_call(Object*, Variant const**, Variant*) const */void MethodBindT<>::validated_call(Object *param_1, Variant **param_2, Variant *param_3) {
   ...
   LAB_0010f9bf:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<>::ptrcall(Object*, void const**, void*) const */void MethodBindT<>::ptrcall(Object *param_1, void **param_2, void *param_3) {
   ...
   LAB_0010fb7f:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* MethodBindT<NodePath const&, int, int>::call(Object*, Variant const**, int, Callable::CallError&)
   const */Object *MethodBindT<NodePath_const&,int,int>::call(Object *param_1, Variant **param_2, int param_3, CallError *param_4) {
   Variant *pVVar1;
   Variant *pVVar2;
   code *pcVar3;
   undefined8 uVar4;
   ...
   if (( ( plVar12 != (long*)0x0 ) && ( plVar12[1] != 0 ) ) && ( *(char*)( plVar12[1] + 0x2e ) != '\0' )) {
      ...
      if (local_68 == (char*)*plVar10) {
         ...
         _err_print_error(&_LC67, "./core/object/method_bind.h", 0x154, "Condition \"p_object && p_object->is_extension_placeholder() && p_object->get_class_name() == get_instance_class()\" is true. Returning: Variant()", (StringName*)&local_68, 0, 0);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_68);
         CowData<char32_t>::_unref((CowData<char32_t>*)&local_70);
         if (( StringName::configured != '\0' ) && ( local_78 != 0 )) {
            StringName::unref();
 ...
 while ( lVar9 != 3 );
   ...
   *in_R9 = uVar6;
   in_R9[2] = 3;
   LAB_0010fd12:*(undefined4*)param_1 = 0;
   *(undefined1(*) [16])( param_1 + 8 ) = (undefined1[16])0x0;
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return param_1;
   }
...
/* MethodBindT<NodePath const&, int, int>::_gen_argument_type_info(int) const */PropertyInfo *MethodBindT<NodePath_const&,int,int>::_gen_argument_type_info(int param_1) {
   undefined1 auVar1[16];
   undefined1 auVar2[16];
   undefined8 uVar3;
   long lVar4;
...
/* ReplicationEditor::_pick_node_filter_text_changed(String const&) */void ReplicationEditor::_GLOBAL__sub_I__pick_node_filter_text_changed(void) {
...
/* WARNING: Control flow encountered bad instruction data *//* ReplicationEditor::~ReplicationEditor() */void ReplicationEditor::~ReplicationEditor(ReplicationEditor *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* MethodBindT<NodePath const&, int, int>::~MethodBindT() */void MethodBindT<NodePath_const&,int,int>::~MethodBindT(MethodBindT<NodePath_const&,int,int> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
...
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<ReplicationEditor, void, bool>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<ReplicationEditor,void,bool>::~CallableCustomMethodPointer(CallableCustomMethodPointer<ReplicationEditor,void,bool> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<ReplicationEditor, void, NodePath>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<ReplicationEditor,void,NodePath>::~CallableCustomMethodPointer(CallableCustomMethodPointer<ReplicationEditor,void,NodePath> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<ReplicationEditor, void, String
   const&>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<ReplicationEditor,void,String_const&>::~CallableCustomMethodPointer(CallableCustomMethodPointer<ReplicationEditor,void,String_const&> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<ReplicationEditor, void, String>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<ReplicationEditor,void,String>::~CallableCustomMethodPointer(CallableCustomMethodPointer<ReplicationEditor,void,String> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<ReplicationEditor, void>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<ReplicationEditor,void>::~CallableCustomMethodPointer(CallableCustomMethodPointer<ReplicationEditor,void> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<ReplicationEditor, void, Object*, int, int,
   MouseButton>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<ReplicationEditor,void,Object*,int,int,MouseButton>::~CallableCustomMethodPointer(CallableCustomMethodPointer<ReplicationEditor,void,Object*,int,int,MouseButton> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointerC<ReplicationEditor, bool, Vector2 const&, Variant const&,
   Control*>::~CallableCustomMethodPointerC() */void CallableCustomMethodPointerC<ReplicationEditor,bool,Vector2_const&,Variant_const&,Control*>::~CallableCustomMethodPointerC(CallableCustomMethodPointerC<ReplicationEditor,bool,Vector2_const&,Variant_const&,Control*> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<ReplicationEditor, void, Vector2 const&, Variant const&,
   Control*>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<ReplicationEditor,void,Vector2_const&,Variant_const&,Control*>::~CallableCustomMethodPointer(CallableCustomMethodPointer<ReplicationEditor,void,Vector2_const&,Variant_const&,Control*> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

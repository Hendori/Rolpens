/* graphite2::vm::Machine::Code::~Code() */void graphite2::vm::Machine::Code::~Code(Code *this) {
...
/* graphite2::vm::Machine::Code::decoder::fetch_opcode(unsigned char const*) */byte graphite2::vm::Machine::Code::decoder::fetch_opcode(decoder *this, uchar *param_1) {
   decoder *pdVar1;
   byte bVar2;
   byte bVar3;
   char cVar4;
   ...
   if (puVar16 <= param_1 + uVar11) {
      LAB_0010018b:if (pauVar12[2][0xb] != '\0') {
         free(*(void**)*pauVar12);
      }
...
LAB_00100319:
   ...
   if (( ( uint ) * (ushort*)( this + 0xc ) <= *(uint*)( this + 8 ) ) || ( 0xfe < *(short*)( this + 0x32 ) )) {
      LAB_00100100:cVar4 = pauVar12[2][0xb];
      joined_r0x001001ff:pauVar13 = pauVar12;
      if (cVar4 != '\0') {
         free(*(void**)*pauVar12);
         pauVar13 = *(undefined1(**) [16])this;
      }
   ...
   switchD_001000ad_caseD_0:if (( *(long*)*pauVar12 != 0 ) && ( *(int*)( pauVar12[2] + 4 ) == 0 )) {
      return bVar2;
   }
...
/* graphite2::vm::Machine::Code::decoder::analyse_opcode(graphite2::vm::opcode, signed char const*)
    */void graphite2::vm::Machine::Code::decoder::analyse_opcode(decoder *this, undefined4 param_2, char *param_3) {
   short sVar1;
   undefined8 uVar2;
   uint uVar3;
   uint uVar4;
...
/* graphite2::vm::Machine::Code::decoder::emit_opcode(graphite2::vm::opcode, unsigned char const*&)
    */undefined4 graphite2::vm::Machine::Code::decoder::emit_opcode(decoder *this, int param_2, long *param_3) {
   byte bVar1;
   ...
   if (uVar9 < 8) {
      if (( uVar11 & 4 ) == 0) {
         if (uVar9 != 0) {
            ...
            *(undefined2*)( (long)puVar15 + ( uVar11 - 2 ) ) = *(undefined2*)( (long)puVar14 + ( uVar11 - 2 ) );
            plVar13 = *(long**)this;
         }
   ...
   *(ulong*)( this + 0x18 ) = *(long*)( this + 0x18 ) + uVar11;
   ...
   if (lVar10 == 0) {
      ...
      uVar8 = CONCAT31(( int3 )(( uint ) * (int*)( (long)plVar13 + 0x24 ) >> 8), *(int*)( (long)plVar13 + 0x24 ) == 0);
   }

   return uVar8;
}
/* graphite2::vm::Machine::Code::decoder::load(unsigned char const*, unsigned char const*) */undefined4 graphite2::vm::Machine::Code::decoder::load(decoder *this, uchar *param_1, uchar *param_2) {
   uchar *puVar1;
   int iVar2;
   uchar *puVar3;
   char cVar4;
...
/* graphite2::vm::Machine::Code::decoder::apply_analysis(void**, void**) */void graphite2::vm::Machine::Code::decoder::apply_analysis(decoder *this, void **param_1, void **param_2) {
   decoder *pdVar1;
   void **__src;
   void *pvVar2;
   long lVar3;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* graphite2::vm::Machine::Code::Code(bool, unsigned char const*, unsigned char const*, unsigned
   char, unsigned short, graphite2::Silf const&, graphite2::Face const&, graphite2::passtype,
   unsigned char**) */void graphite2::vm::Machine::Code::Code(Code *this, Code param_1, uchar *param_2, uchar *param_3, byte param_4, ushort param_5, long param_6, long param_7, undefined4 param_9, long *param_10) {
   ...
   *(undefined1(*) [16])( this + 0x10 ) = (undefined1[16])0x0;
   ...
   if (pvVar16 == (void*)0x0) {
      LAB_001015e1:this[0x2b] = (Code)0x0;
      ...
      *(undefined1(*) [16])this = (undefined1[16])0x0;
      ...
      auStack_2ce = SUB87(CONCAT62(CONCAT42(CONCAT22(*(undefined2*)( param_7 + 8 ), *(undefined2*)( *(long*)( param_7 + 0x78 ) + 0x2a )), *(undefined2*)( param_6 + 0x3c )), param_5), 0);
      ...
      do {
         ...
         auVar21[1] = ( 0 < (short)uVar23 ) * ( (short)uVar23 < 0x100 ) * (char)uVar23 - ( 0xff < (short)uVar23 );
         auVar21[0] = ( 0 < (short)uVar11 ) * ( (short)uVar11 < 0x100 ) * (char)uVar11 - ( 0xff < (short)uVar11 );
         auVar21[2] = ( 0 < (short)uVar24 ) * ( (short)uVar24 < 0x100 ) * (char)uVar24 - ( 0xff < (short)uVar24 );
         auVar21[3] = ( 0 < (short)uVar25 ) * ( (short)uVar25 < 0x100 ) * (char)uVar25 - ( 0xff < (short)uVar25 );
         auVar21[4] = ( 0 < (short)uVar26 ) * ( (short)uVar26 < 0x100 ) * (char)uVar26 - ( 0xff < (short)uVar26 );
         auVar21[5] = ( 0 < (short)uVar27 ) * ( (short)uVar27 < 0x100 ) * (char)uVar27 - ( 0xff < (short)uVar27 );
         auVar21[6] = ( 0 < (short)uVar28 ) * ( (short)uVar28 < 0x100 ) * (char)uVar28 - ( 0xff < (short)uVar28 );
         auVar21[7] = ( 0 < (short)uVar29 ) * ( (short)uVar29 < 0x100 ) * (char)uVar29 - ( 0xff < (short)uVar29 );
         auVar21[8] = ( 0 < (short)uVar30 ) * ( (short)uVar30 < 0x100 ) * (char)uVar30 - ( 0xff < (short)uVar30 );
         auVar21[9] = ( 0 < (short)uVar32 ) * ( (short)uVar32 < 0x100 ) * (char)uVar32 - ( 0xff < (short)uVar32 );
         auVar21[10] = ( 0 < (short)uVar33 ) * ( (short)uVar33 < 0x100 ) * (char)uVar33 - ( 0xff < (short)uVar33 );
         auVar21[0xb] = ( 0 < (short)uVar34 ) * ( (short)uVar34 < 0x100 ) * (char)uVar34 - ( 0xff < (short)uVar34 );
         auVar21[0xc] = ( 0 < (short)uVar35 ) * ( (short)uVar35 < 0x100 ) * (char)uVar35 - ( 0xff < (short)uVar35 );
         auVar21[0xd] = ( 0 < (short)uVar36 ) * ( (short)uVar36 < 0x100 ) * (char)uVar36 - ( 0xff < (short)uVar36 );
         auVar21[0xe] = ( 0 < (short)uVar37 ) * ( (short)uVar37 < 0x100 ) * (char)uVar37 - ( 0xff < (short)uVar37 );
         auVar21[0xf] = ( 0 < (short)uVar38 ) * ( (short)uVar38 < 0x100 ) * (char)uVar38 - ( 0xff < (short)uVar38 );
         auVar21 = auVar21 & __LC3;
         auVar22[1] = 0;
         auVar22[0] = auVar21[8];
         for (int i = 0; i < 7; i++) {
            auVar22[( 2*i + 2 )] = auVar21[( i + 9 )];
            auVar22[( 2*i + 3 )] = 0;
         }
 ...
 while ( pCVar14 != local_44 );
      ...
      if (( *(long*)( lVar15 + 0xa80 ) != lVar18 && *(long*)( lVar15 + 0xab8 ) != lVar18 ) && ( *(long*)( lVar15 + 0xaf0 ) != lVar18 )) {
         if (this[0x2b] != (Code)0x0) {
            free(*(void**)this);
         }
      ...
      decoder::apply_analysis((decoder*)&local_278, *(void***)this, *(void***)this + *(long*)( this + 0x18 ));
      this[0x20] = local_44[0];
      memmove((void*)( *(long*)this + 8 + *(long*)( this + 0x18 ) * 8 ), *(void**)( this + 8 ), *(size_t*)( this + 0x10 ));
      ...
      if (param_10 == (long*)0x0) {
         ...
         *param_10 = *param_10 + __size;
         LAB_00101663:pvVar17 = *(void**)this;
         *(void**)( this + 8 ) = (void*)( (long)pvVar17 + lVar18 * 8 );
         if (pvVar17 == (void*)0x0) goto LAB_001015e1;
      }

      *(undefined8*)( (long)pvVar17 + lVar15 * 8 ) = *(undefined8*)( lVar12 + 0xab8 + (ulong)(byte)this[0x28] * 8 );
   }

   LAB_00101560:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
...
/* graphite2::vm::Machine::Code::decoder::valid_upto(unsigned short, unsigned short) const */bool graphite2::vm::Machine::Code::decoder::valid_upto(decoder *this, ushort param_1, ushort param_2) {
...
/* graphite2::vm::Machine::Code::decoder::test_context() const */undefined8 graphite2::vm::Machine::Code::decoder::test_context(decoder *this) {
   undefined1(*pauVar1)[16];
...
/* graphite2::vm::Machine::Code::decoder::test_attr(gr_attrCode) const */undefined8 graphite2::vm::Machine::Code::decoder::test_attr(void) {
   return 1;
}
/* graphite2::vm::Machine::Code::release_buffers() */void graphite2::vm::Machine::Code::release_buffers(Code *this) {
   if (this[0x2b] == (Code)0x0) {
      this[0x2b] = (Code)0x0;
      *(undefined1(*) [16])this = (undefined1[16])0x0;
      return;
...
/* graphite2::vm::Machine::Code::run(graphite2::vm::Machine&, graphite2::Slot**&) const */undefined8 graphite2::vm::Machine::Code::run(Machine *param_1, Slot ***param_2) {
   Slot **ppSVar1;
   uint uVar2;
   undefined8 uVar3;
   ppSVar1 = *param_2;

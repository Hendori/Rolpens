/* TTS_Linux::speech_event_callback(unsigned long, unsigned long, SPDNotificationType) */void TTS_Linux::speech_event_callback(int param_1, undefined8 param_2, int param_3) {
   Variant *pVVar1;
   undefined8 uVar2;
   long lVar3;
   CallableCustom *this;
...
/* HashMap<int, int, HashMapHasherDefault, HashMapComparatorDefault<int>,
   DefaultTypedAllocator<HashMapElement<int, int> > >::erase(int const&) [clone .isra.0] */void HashMap<int,int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,int>>>::erase(HashMap<int,int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,int>>> *this, int *param_1) {
   uint *puVar1;
   undefined8 *puVar2;
   undefined8 *puVar3;
   long *plVar4;
...
/* TTS_Linux::speech_event_index_mark(unsigned long, unsigned long, SPDNotificationType, char*) */void TTS_Linux::speech_event_index_mark(int param_1, undefined8 param_2, int param_3, int param_4) {
   Variant *pVVar1;
   long *plVar2;
   undefined8 uVar3;
   long lVar4;
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* TTS_Linux::~TTS_Linux() */void TTS_Linux::~TTS_Linux(TTS_Linux *this) {
   long *plVar1;
   uint uVar2;
   long lVar3;
   long *plVar4;
            ...
            do {
               if (*(int*)( *(long*)( this + 0x200 ) + lVar5 ) != 0) {
                  ...
                  *(int*)( *(long*)( this + 0x200 ) + lVar5 ) = 0;
                  for (int i = 0; i < 3; i++) {
                     if (*(long*)( (long)pvVar6 + ( -8*i + 32 ) ) != 0) {
                        LOCK();
                        plVar7 = (long*)( *(long*)( (long)pvVar6 + ( -8*i + 32 ) ) + -16 );
                        *plVar7 = *plVar7 + -1;
                        UNLOCK();
                        if (*plVar7 == 0) {
                           lVar3 = *(long*)( (long)pvVar6 + ( -8*i + 32 ) );
                           *(undefined8*)( (long)pvVar6 + ( -8*i + 32 ) ) = 0;
 ...
 while ( (ulong)uVar2 << 2 != lVar5 );
   ...
   LAB_001007ba:pvVar6 = *(void**)( this + 0x1c0 );
   if (pvVar6 != (void*)0x0) {
      if (*(int*)( this + 0x1e4 ) != 0) {
 ...
 while ( lVar5 != (ulong)uVar2 << 2 );
   ...
   LAB_00100857:plVar7 = *(long**)( this + 0x1a0 );
   if (plVar7 != (long*)0x0) {
      do {
         plVar4 = (long*)*plVar7;
         if (plVar4 == (long*)0x0) {
 ...
 while ( (int)plVar7[2] != 0 );
   ...
   LAB_00100903:Object::~Object((Object*)this);
   return;
}
/* TTS_Linux::~TTS_Linux() */void TTS_Linux::~TTS_Linux(TTS_Linux *this) {
   ~TTS_Linux(this)
   ;;
   operator_delete(this, 0x230);
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* TTS_Linux::speech_init_thread_func(void*) */void TTS_Linux::speech_init_thread_func(void *param_1) {
   long *plVar1;
   code *pcVar2;
   long lVar3;
   long lVar4;
   ...
   if (iVar6 == 0) {
      if (( ( ( ( ( _spd_open_dylibloader_wrapper_speechd == (code*)0x0 ) || ( _spd_set_notification_on_dylibloader_wrapper_speechd == (code*)0x0 ) ) || ( _spd_list_synthesis_voices_dylibloader_wrapper_speechd == 0 ) ) || ( ( _free_spd_voices_dylibloader_wrapper_speechd == 0 || ( _spd_set_synthesis_voice_dylibloader_wrapper_speechd == 0 ) ) ) ) || ( ( _spd_set_volume_dylibloader_wrapper_speechd == 0 || ( ( _spd_set_voice_pitch_dylibloader_wrapper_speechd == 0 || ( _spd_set_voice_rate_dylibloader_wrapper_speechd == 0 ) ) ) ) ) ) || ( ( _spd_set_data_mode_dylibloader_wrapper_speechd == 0 || ( ( ( ( _spd_say_dylibloader_wrapper_speechd == 0 || ( _spd_pause_dylibloader_wrapper_speechd == 0 ) ) || ( _spd_resume_dylibloader_wrapper_speechd == 0 ) ) || ( _spd_cancel_dylibloader_wrapper_speechd == 0 ) ) ) ) )) {
         ...
         *(long*)( (long)param_1 + 0x1a8 ) = lVar8;
         if (lVar8 == 0) {
            ...
            *(undefined8*)( lVar8 + 0x10 ) = 0x100000;
            ...
            ( *_spd_set_notification_on_dylibloader_wrapper_speechd )(*(undefined8*)( (long)param_1 + 0x1a8 ), 8);
            cVar5 = is_print_verbose_enabled();
            pcVar9 = "Text-to-Speech: Speech Dispatcher initialized.";
            if (cVar5 != '\0') {
               LAB_00100e15:Variant::Variant((Variant*)local_58, pcVar9);
      ...
      if (cVar5 != '\0') {
         LAB_00100d7d:Variant::Variant((Variant*)local_58, pcVar9);
         stringify_variants((Variant*)&local_60);
         __print_line((String*)&local_60);
         lVar8 = local_60;
         if (local_60 != 0) {
   ...
   LAB_00100f23:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* TTS_Linux::is_speaking() const */TTS_Linux TTS_Linux::is_speaking(TTS_Linux *this) {
   return this[0x1b0];
}
/* TTS_Linux::is_paused() const */TTS_Linux TTS_Linux::is_paused(TTS_Linux *this) {
   return this[0x1b1];
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* TTS_Linux::pause() */void TTS_Linux::pause(TTS_Linux *this) {
   int iVar1;
   iVar1 = pthread_mutex_lock((pthread_mutex_t*)( this + 0x178 ));
   if (iVar1 == 0) {
      if (*(long*)( this + 0x1a8 ) == 0) {
         _err_print_error("pause", "platform/linuxbsd/tts_linux.cpp", 0xf2, "Parameter \"synth\" is null.", 0, 0);
      }
 else {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* TTS_Linux::resume() */void TTS_Linux::resume(TTS_Linux *this) {
   int iVar1;
   iVar1 = pthread_mutex_lock((pthread_mutex_t*)( this + 0x178 ));
   if (iVar1 == 0) {
      if (*(long*)( this + 0x1a8 ) == 0) {
         _err_print_error("resume", "platform/linuxbsd/tts_linux.cpp", 0xfb, "Parameter \"synth\" is null.", 0, 0);
      }
 else {
...
/* TTS_Linux::get_singleton() */undefined8 TTS_Linux::get_singleton(void) {
   return singleton;
}
/* TTS_Linux::TTS_Linux() */void TTS_Linux::TTS_Linux(TTS_Linux *this) {
   long lVar1;
...
/* TTS_Linux::_speech_index_mark(int, int, String const&) */void TTS_Linux::_speech_index_mark(int param_1, int param_2, String *param_3) {
   ulong uVar1;
   code *pcVar2;
   ...
   if (( *(long*)( lVar19 + 0x1c0 ) != 0 ) && ( *(int*)( lVar19 + 0x1e4 ) != 0 )) {
      ...
      if (uVar13 != 0) {
         uVar21 = 0;
         while (( uVar13 != uVar18 || ( local_3c[0] != *(uint*)( *(long*)( *(long*)( lVar19 + 0x1c0 ) + lVar17 * 8 ) + 0x10 ) ) )) {
            uVar21 = uVar21 + 1;
            auVar4._8_8_ = 0;
            ...
            if (( uVar13 == 0 ) || ( auVar5._8_8_ = 0 ),auVar5._0_8_ = uVar13 * uVar1,auVar9._8_8_ = 0,auVar9._0_8_ = uVar20,auVar6._8_8_ = 0,auVar6._0_8_ = ( ( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( lVar19 + 0x1e0 ) * 4 ) + iVar12 ) - SUB164(auVar5 * auVar9, 8) ) * uVar1,auVar10._8_8_ = 0,auVar10._0_8_ = uVar20,SUB164(auVar6 * auVar10, 8) < uVar21) goto LAB_001012d7;
         }
;
         pcVar2 = *(code**)( *DisplayServer::singleton + 0x338 );
         uVar14 = String::to_int();
         puVar15 = (undefined4*)HashMap<int,int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,int>>>::operator []((HashMap<int,int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,int>>>*)( lVar19 + 0x1b8 ), (int*)local_3c);
         ( *pcVar2 )(plVar11, 3, *puVar15, uVar14);
      }

   }

   LAB_001012d7:pthread_mutex_unlock((pthread_mutex_t*)( lVar19 + 0x178 ));
   return;
}
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* TTS_Linux::stop() */void TTS_Linux::stop(TTS_Linux *this) {
   long *plVar1;
   uint uVar2;
   long *plVar3;
   long lVar4;
   ...
   if (*(long*)( this + 0x1a8 ) == 0) {
      _err_print_error(&_LC39, "platform/linuxbsd/tts_linux.cpp", 0x103, "Parameter \"synth\" is null.", 0, 0);
   }
 else {
      if (*(long**)( this + 0x1a0 ) != (long*)0x0) {
         for (lVar21 = **(long**)( this + 0x1a0 ); lVar21 != 0; lVar21 = *(long*)( lVar21 + 0x20 )) {
            ( **(code**)( *DisplayServer::singleton + 0x338 ) )(DisplayServer::singleton, 2, *(undefined4*)( lVar21 + 0x1c ), 0);
         }
      ...
      if (( ( uVar2 != 0xffffffff ) && ( *(long*)( this + 0x1c0 ) != 0 ) ) && ( *(int*)( this + 0x1e4 ) != 0 )) {
         ...
         if (uVar16 != 0) {
            uVar20 = 0;
            while (( uVar22 != uVar16 || ( uVar2 != *(uint*)( *(long*)( *(long*)( this + 0x1c0 ) + lVar21 * 8 ) + 0x10 ) ) )) {
               uVar20 = uVar20 + 1;
               auVar8._8_8_ = 0;
               ...
               if (( uVar16 == 0 ) || ( auVar9._8_8_ = 0 ),auVar9._0_8_ = uVar16 * uVar5,auVar13._8_8_ = 0,auVar13._0_8_ = uVar19,auVar10._8_8_ = 0,auVar10._0_8_ = ( ( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x1e0 ) * 4 ) + iVar15 ) - SUB164(auVar9 * auVar13, 8) ) * uVar5,auVar14._8_8_ = 0,auVar14._0_8_ = uVar19,SUB164(auVar10 * auVar14, 8) < uVar20) goto LAB_00101397;
            }
;
            pcVar6 = *(code**)( *DisplayServer::singleton + 0x338 );
            puVar17 = (undefined4*)HashMap<int,int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,int>>>::operator []((HashMap<int,int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,int>>>*)( this + 0x1b8 ), (int*)( this + 0x1b4 ));
            ( *pcVar6 )(plVar23, 2, *puVar17, 0);
         }

      }

      LAB_00101397:plVar23 = *(long**)( this + 0x1a0 );
      if (plVar23 != (long*)0x0) {
         do {
            plVar3 = (long*)*plVar23;
 ...
 while ( (int)plVar23[2] != 0 );
      ...
      LAB_00101450:if (( *(long*)( this + 0x1c0 ) != 0 ) && ( *(int*)( this + 0x1e4 ) != 0 )) {
         lVar21 = 0;
         uVar2 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x1e0 ) * 4 );
         if (uVar2 != 0) {
            do {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* TTS_Linux::_load_voices() const [clone .part.0] */void TTS_Linux::_load_voices(TTS_Linux *this) {
   long *plVar1;
   long lVar2;
   long *plVar3;
   ...
   long local_40;
   local_40 = *(long*)( in_FS_OFFSET + 0x28 );
   plVar3 = (long*)( *_spd_list_synthesis_voices_dylibloader_wrapper_speechd )(*(undefined8*)( this + 0x1a8 ));
   if (plVar3 != (long*)0x0) {
      lVar5 = *plVar3;
      plVar4 = plVar3;
      while (lVar5 != 0) {
         ...
         this_00 = (CowData<char32_t>*)HashMap<String,TTS_Linux::VoiceInfo,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,TTS_Linux::VoiceInfo>>>::operator []((HashMap<String,TTS_Linux::VoiceInfo,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,TTS_Linux::VoiceInfo>>>*)( this + 0x1f0 ), (String*)&local_60);
...
/* TTS_Linux::_load_voices() const */void TTS_Linux::_load_voices(TTS_Linux *this) {
...
/* TTS_Linux::get_voices() const */Array *TTS_Linux::get_voices(void) {
   long *plVar1;
   long lVar2;
   undefined *puVar3;
   int iVar4;
   ...
   if (*(long*)( in_RSI + 0x1a8 ) == 0) {
      _err_print_error("get_voices", "platform/linuxbsd/tts_linux.cpp", 0xc3, "Parameter \"synth\" is null.", 0, 0);
      Array::Array(in_RDI);
   }
 else {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* TTS_Linux::_speech_event(int, int) */void TTS_Linux::_speech_event(TTS_Linux *this, int param_1, int param_2) {
   long *plVar1;
   HashMap<int,int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,int>>> *this_00;
   int iVar2;
   long *plVar3;
   long *plVar4;
   ulong uVar5;
   ...
   if (( ( this[0x1b1] == (TTS_Linux)0x0 ) && ( *(long*)( this + 0x1c0 ) != 0 ) ) && ( *(int*)( this + 0x1e4 ) != 0 )) {
      uVar5 = *(ulong*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( this + 0x1e0 ) * 8 );
      ...
      if (uVar26 != 0) {
         uVar27 = 0;
         while (( uVar26 != uVar38 || ( local_9c[0] != *(uint*)( *(long*)( *(long*)( this + 0x1c0 ) + lVar32 * 8 ) + 0x10 ) ) )) {
            uVar27 = uVar27 + 1;
            auVar7._8_8_ = 0;
            ...
            if (( uVar26 == 0 ) || ( auVar8._8_8_ = 0 ),auVar8._0_8_ = uVar26 * uVar5,auVar16._8_8_ = 0,auVar16._0_8_ = uVar36,auVar9._8_8_ = 0,auVar9._0_8_ = ( ( *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x1e0 ) * 4 ) + iVar24 ) - SUB164(auVar8 * auVar16, 8) ) * uVar5,auVar17._8_8_ = 0,auVar17._0_8_ = uVar36,SUB164(auVar9 * auVar17, 8) < uVar27) goto LAB_00101e3e;
         }
;
         this_00 = (HashMap<int,int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,int>>>*)( this + 0x1b8 );
         if (param_2 == 1) {
            pcVar39 = *(code**)( *DisplayServer::singleton + 0x338 );
            puVar29 = (undefined4*)HashMap<int,int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,int>>>::operator [](this_00, (int*)local_9c);
            uVar28 = 1;
            uVar25 = *puVar29;
         }
 else {
         ...
         HashMap<int,int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,int>>>::erase(this_00, (int*)local_9c);
   ...
   LAB_00101e3e:if (this[0x1b0] == (TTS_Linux)0x0) {
      LAB_00101e4b:plVar3 = *(long**)( this + 0x1a0 );
      if (( plVar3 != (long*)0x0 ) && ( 0 < (int)plVar3[2] )) {
         ...
         if (( *(long*)( this + 0x1f8 ) != 0 ) && ( *(int*)( this + 0x21c ) != 0 )) {
            ...
            if (uVar27 != 0) {
               ...
               do {
                  if (uVar38 == uVar27) {
                     cVar23 = String::operator ==((String*)( *(long*)( *(long*)( this + 0x1f8 ) + lVar33 * 8 ) + 0x10 ), (String*)( lVar32 + 8 ));
                     if (cVar23 != '\0') {
                  ...
                  if (( uVar27 == 0 ) || ( auVar12._8_8_ = 0 ),auVar12._0_8_ = (ulong)uVar27 * lVar41,auVar20._8_8_ = 0,auVar20._0_8_ = uVar5,auVar13._8_8_ = 0,auVar13._0_8_ = ( ulong )(( uVar26 + uVar30 ) - SUB164(auVar12 * auVar20, 8)) * lVar41,auVar21._8_8_ = 0,auVar21._0_8_ = uVar5,SUB164(auVar13 * auVar21, 8) < uVar40) break;
               }
 while ( true );
            }
         ...
         for (lVar41 = 1; ( _spd_set_synthesis_voice_dylibloader_wrapper_speechd = pcVar39 ),local_60 != 0 && ( lVar37 = lVar41 + -1 < lVar37 ); lVar41 = lVar41 + 2) {
            if (lVar37 <= lVar41) {
               _err_print_index_error("get", "./core/templates/cowdata.h", 0xdb, lVar41, lVar37, "p_index", "size()", "", false, true);
               _err_flush_stdout();
               /* WARNING: Does not return */
               pcVar39 = (code*)invalidInstructionException();
               ( *pcVar39 )();
         ...
         ( *_spd_set_volume_dylibloader_wrapper_speechd )(*(undefined8*)( this + 0x1a8 ), *(int*)( lVar32 + 0x10 ) * 2 + -100);
         ( *_spd_set_voice_pitch_dylibloader_wrapper_speechd )(*(undefined8*)( this + 0x1a8 ), (int)( ( *(float*)( lVar32 + 0x14 ) - _LC53 ) * __LC54 ));
         ...
         *(undefined4*)( this + 0x1b4 ) = uVar25;
         ...
         puVar29 = (undefined4*)HashMap<int,int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,int>>>::operator []((HashMap<int,int,HashMapHasherDefault,HashMapComparatorDefault<int>,DefaultTypedAllocator<HashMapElement<int,int>>>*)( this + 0x1b8 ), (int*)( this + 0x1b4 ));
         plVar3 = DisplayServer::singleton;
         *puVar29 = uVar25;
...
/* TTS_Linux::speak(String const&, String const&, int, float, float, int, bool) */void TTS_Linux::speak(TTS_Linux *this, String *param_1, String *param_2, int param_3, float param_4, float param_5, int param_6, bool param_7) {
   long *plVar1;
   int iVar2;
   CowData<char32_t> *this_00;
   long lVar3;
   ...
   if (*(long*)( this + 0x1a8 ) == 0) {
      _err_print_error("speak", "platform/linuxbsd/tts_linux.cpp", 0xd5, "Parameter \"synth\" is null.", 0, 0);
   }
 else {
      if (param_7) {
         stop(this);
 ...
 while ( !bVar7 );
         ...
         LAB_00102a67:lVar5 = *(long*)param_2;
         ...
         if (( _LC61 <= param_5 ) && ( local_6c = _LC62 < param_5 )) {
            local_6c = _LC62;
         }
...
/* CallableCustomMethodPointer<TTS_Linux, void, int, int>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<TTS_Linux,void,int,int>::~CallableCustomMethodPointer(CallableCustomMethodPointer<TTS_Linux,void,int,int> *this) {
   return;
}
/* CallableCustomMethodPointer<TTS_Linux, void, int, int, String
   const&>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<TTS_Linux,void,int,int,String_const&>::~CallableCustomMethodPointer(CallableCustomMethodPointer<TTS_Linux,void,int,int,String_const&> *this) {
   return;
}
/* CallableCustomMethodPointer<TTS_Linux, void, int, int>::get_argument_count(bool&) const */undefined8 CallableCustomMethodPointer<TTS_Linux,void,int,int>::get_argument_count(CallableCustomMethodPointer<TTS_Linux,void,int,int> *this, bool *param_1) {
   *param_1 = true;
   return 2;
}
/* CallableCustomMethodPointer<TTS_Linux, void, int, int, String const&>::get_argument_count(bool&)
   const */undefined8 CallableCustomMethodPointer<TTS_Linux,void,int,int,String_const&>::get_argument_count(CallableCustomMethodPointer<TTS_Linux,void,int,int,String_const&> *this, bool *param_1) {
   *param_1 = true;
   return 3;
}
...
/* Object::_get_class_namev() const */undefined8 *Object::_get_class_namev(void) {
   ...
   if (_get_class_namev()::_class_name_static != 0) {
      if (*(long*)( _get_class_namev() ) != 0) {
         LAB_00102fe3:return &_get_class_namev();
      }

      if (*(long*)( _get_class_namev() ) != 0) {
         if (1 < *(uint*)( *(long*)( _get_class_namev() ) + -8 )) goto LAB_00102fe3;
   ...
   StringName::assign_static_unique_class_name((StringName*)&_get_class_namev(), ::_class_name_static, "Object");
   LAB_0010304e:return &_get_class_namev();
}
/* CallableCustomMethodPointer<TTS_Linux, void, int, int, String const&>::get_object() const */undefined8 CallableCustomMethodPointer<TTS_Linux,void,int,int,String_const&>::get_object(CallableCustomMethodPointer<TTS_Linux,void,int,int,String_const&> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   uVar2 = 0;
   LAB_0010317d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* CallableCustomMethodPointer<TTS_Linux, void, int, int>::get_object() const */undefined8 CallableCustomMethodPointer<TTS_Linux,void,int,int>::get_object(CallableCustomMethodPointer<TTS_Linux,void,int,int> *this) {
   long lVar1;
   undefined8 uVar2;
   uint uVar3;
   ulong *puVar4;
...
;
   ...
   uVar2 = 0;
   LAB_0010327d:if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...
/* Object::is_class(String const&) const */ulong Object::is_class(Object *this, String *param_1) {
   ...
   do {
      if (lVar2 == 0) {
         ...
         LAB_0010358f:/* WARNING: Subroutine does not return */__stack_chk_fail();
      }
 ...
 while ( !bVar8 );
      ...
      LAB_001034a3:uVar5 = String::operator ==(param_1, (String*)&local_50);
      lVar3 = local_50;
      if (local_50 != 0) {
         LOCK();
...
/* CallableCustomMethodPointer<TTS_Linux, void, int, int>::call(Variant const**, int, Variant&,
   Callable::CallError&) const */void CallableCustomMethodPointer<TTS_Linux,void,int,int>::call(CallableCustomMethodPointer<TTS_Linux,void,int,int> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long *plVar1;
   long lVar2;
   long lVar3;
   ulong uVar4;
...
;
   ...
   LAB_00103b23:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* CallableCustomMethodPointer<TTS_Linux, void, int, int, String const&>::call(Variant const**, int,
   Variant&, Callable::CallError&) const */void CallableCustomMethodPointer<TTS_Linux,void,int,int,String_const&>::call(CallableCustomMethodPointer<TTS_Linux,void,int,int,String_const&> *this, Variant **param_1, int param_2, Variant *param_3, CallError *param_4) {
   long *plVar1;
   long lVar2;
   long lVar3;
   ulong uVar4;
...
;
   ...
   _err_print_error(&_LC16, "./core/object/callable_method_pointer.h", 0x67, "Parameter \"ObjectDB::get_instance(ObjectID(data.object_id))\" is null.", (Variant*)&local_58, 0);
   pcVar6 = local_58;
   if (local_58 != (char*)0x0) {
      LOCK();
      plVar1 = (long*)( local_58 + -0x10 );
   ...
   LAB_00103bf5:if (local_40 != *(long*)( in_FS_OFFSET + 0x28 )) {
      /* WARNING: Subroutine does not return */
      __stack_chk_fail();
   }
...

{
 ...
 while ( ( uVar37 != 0 ) && ( auVar6._8_8_ = 0 ),auVar6._0_8_ = uVar37 * uVar48,auVar22._8_8_ = 0,auVar22._0_8_ = uVar51,auVar7._8_8_ = 0,auVar7._0_8_ = ( ( uVar54 + uVar39 ) - SUB164(auVar6 * auVar22, 8) ) * uVar48,auVar23._8_8_ = 0,auVar23._0_8_ = uVar51,lVar47 = SUB168(auVar7 * auVar23, 8),uVar50 <= SUB164(auVar7 * auVar23, 8) );
   ...
   LAB_00104453:uVar45 = CONCAT44(0, *(uint*)( hash_table_size_primes + uVar40 * 4 ));
   uVar48 = *(ulong*)( hash_table_size_primes_inv + uVar40 * 8 );
...
}LAB_001040d3:if ((float)uVar51 * __LC34 < (float)( iVar44 + 1 )) {
...
;*(undefined1(**) [16])( lVar47 + lStack_90 * 8 ) = pauVar36;*puVar1 = uVar38;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;LAB_00104434:auVar57._8_8_ = lStack_90;auVar57._0_8_ = pauVar42[1] + 4;return auVar57;}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* HashMap<String, TTS_Linux::VoiceInfo, HashMapHasherDefault, HashMapComparatorDefault<String>,
   DefaultTypedAllocator<HashMapElement<String, TTS_Linux::VoiceInfo> > >::operator[](String const&)
    */undefined1 * __thiscallHashMap<String,TTS_Linux::VoiceInfo,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,TTS_Linux::VoiceInfo>>>::operator [](HashMap<String,TTS_Linux::VoiceInfo,HashMapHasherDefault,HashMapComparatorDefault<String>,DefaultTypedAllocator<HashMapElement<String,TTS_Linux::VoiceInfo>>> * this, String * param_1) * plVar1 ;void *pvVar2void *__sundefined1 auVar3[16]undefined1 auVar4[16]undefined1 auVar5[16]undefined1 auVar6[16]undefined1 auVar7[16]undefined1 auVar8[16]undefined1 auVar9[16]undefined1 auVar10[16]undefined1 auVar11[16]undefined1 auVar12[16]undefined1 auVar13[16]undefined1 auVar14[16]undefined1 auVar15[16]undefined1 auVar16[16]undefined1 auVar17[16]undefined1 auVar18[16]undefined1 auVar19[16]undefined1 auVar20[16]undefined1 auVar21[16]undefined1 auVar22[16]undefined1 auVar23[16]undefined1 auVar24[16]undefined1 auVar25[16]undefined1 auVar26[16]undefined1 auVar27[16]undefined1 auVar28[16]undefined1 auVar29[16]undefined1 auVar30[16]undefined1 auVar31[16]undefined1 auVar32[16]undefined1 auVar33[16]undefined1 auVar34[16]char cVar35uint uVar36uint uVar37ulong uVar38undefined8 uVar39void *__s_00undefined8 *puVar40void *pvVar41int iVar42long lVar43long lVar44ulong uVar45uint *puVar46undefined1 *puVar47long lVar48undefined8 uVar49uint uVar50uint uVar51ulong uVar52long lVar53long lVar54uint uVar55uint uVar56undefined1(*pauVar57)[16];undefined1(*pauVar58)[16];long in_FS_OFFSETundefined1(*local_a0)[16];undefined1 local_78[16]undefined1 local_68[16]long local_58undefined1 local_50[16]long local_40local_40 = *(long*)( in_FS_OFFSET + 0x28 );uVar56 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );if (*(long*)( this + 8 ) == 0) {
   LAB_00104da6:local_78 = (undefined1[16])0x0;
   uVar45 = (ulong)uVar56;
   uVar38 = uVar45 * 4;
   uVar52 = uVar45 * 8;
 ...
 while ( uVar45 != uVar38 );
      ...
      LAB_00104c84:iVar42 = *(int*)( this + 0x2c );
      if (iVar42 != 0) {
         LAB_00104c90:uVar36 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );
               ...
               if (uVar51 == uVar37) {
                  ...
                  if (cVar35 != '\0') {
                     ...
                     if (*(long*)( lVar48 + 0x20 ) != 0) {
                        CowData<char32_t>::_ref((CowData<char32_t>*)( lVar48 + 0x20 ), (CowData*)( local_78 + 8 ));
                     }
 ...
 while ( ( uVar51 != 0 ) && ( auVar17._8_8_ = 0 ),auVar17._0_8_ = (ulong)uVar51 * lVar48,auVar33._8_8_ = 0,auVar33._0_8_ = uVar38,auVar18._8_8_ = 0,auVar18._0_8_ = ( ulong )(( uVar36 + uVar50 ) - SUB164(auVar17 * auVar33, 8)) * lVar48,auVar34._8_8_ = 0,auVar34._0_8_ = uVar38,uVar55 <= SUB164(auVar18 * auVar34, 8) );
         }
   ...
   LAB_00104756:uVar56 = *(uint*)( this + 0x28 );
   if (uVar56 == 0x1c) {
      lVar48 = 0;
      _err_print_error("_insert", "./core/templates/hash_map.h", 0xdd, "Condition \"capacity_index + 1 == HASH_TABLE_SIZE_MAX\" is true. Returning: nullptr", "Hash table maximum capacity reached, aborting insertion.", 0, 0);
      LAB_00104c4d:puVar47 = (undefined1*)( lVar48 + 0x18 );
      goto LAB_00104b49;
   }
...
;
 ...
 while ( ( uVar37 != 0 ) && ( auVar13._8_8_ = 0 ),auVar13._0_8_ = (ulong)uVar37 * lVar48,auVar29._8_8_ = 0,auVar29._0_8_ = uVar38,auVar14._8_8_ = 0,auVar14._0_8_ = ( ulong )(( uVar51 + uVar56 ) - SUB164(auVar13 * auVar29, 8)) * lVar48,auVar30._8_8_ = 0,auVar30._0_8_ = uVar38,uVar50 <= SUB164(auVar14 * auVar30, 8) );
      }
   ...
   local_78 = (undefined1[16])0x0;
   iVar42 = 0;
   LAB_00104730:if ((float)uVar45 * __LC34 < (float)( iVar42 + 1 )) goto LAB_00104756;
}
local_58 = 0;local_68 = (undefined1[16])0x0;if (*(long*)param_1 == 0) {
   ...
   *plVar1 = *plVar1 + -1;
   ...
   LAB_001049fb:*puVar40 = local_a0;
   *(undefined8**)( *local_a0 + 8 ) = puVar40;
}
*(undefined1(**) [16])( this + 0x20 ) = local_a0;uVar36 = String::hash();lVar54 = *(long*)( this + 0x10 );uVar56 = 1;if (uVar36 != 0) {
   uVar56 = uVar36;
}
uVar36 = *(uint*)( hash_table_size_primes + ( ulong ) * (uint*)( this + 0x28 ) * 4 );uVar38 = CONCAT44(0, uVar36);lVar43 = *(long*)( hash_table_size_primes_inv + ( ulong ) * (uint*)( this + 0x28 ) * 8 );auVar7._8_8_ = 0;auVar7._0_8_ = (ulong)uVar56 * lVar43;auVar23._8_8_ = 0;auVar23._0_8_ = uVar38;lVar44 = SUB168(auVar7 * auVar23, 8);lVar53 = *(long*)( this + 8 );puVar46 = (uint*)( lVar54 + lVar44 * 4 );iVar42 = SUB164(auVar7 * auVar23, 8);uVar37 = *puVar46;pauVar58 = local_a0;if (uVar37 != 0) {
   uVar51 = 0;
   pauVar57 = local_a0;
   do {
      auVar8._8_8_ = 0;
...
*(undefined1(**) [16])( lVar53 + lVar44 * 8 ) = pauVar58;*puVar46 = uVar56;*(int*)( this + 0x2c ) = *(int*)( this + 0x2c ) + 1;puVar47 = local_a0[1] + 8;if (lVar48 != 0) {
   LOCK();
   plVar1 = (long*)( lVar48 + -0x10 );
   *plVar1 = *plVar1 + -1;
   UNLOCK();
...
LAB_00104b49:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return puVar47;
}
/* WARNING: Subroutine does not return */__stack_chk_fail();}/* TTS_Linux::_speech_event(int, int) [clone .cold] */void TTS_Linux::_speech_event(int param_1, int param_2) {
   code *pcVar1;
   /* WARNING: Does not return */
   pcVar1 = (code*)invalidInstructionException();
   ( *pcVar1 )();
}
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<TTS_Linux, void, int, int, String
   const&>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<TTS_Linux,void,int,int,String_const&>::~CallableCustomMethodPointer(CallableCustomMethodPointer<TTS_Linux,void,int,int,String_const&> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
/* WARNING: Control flow encountered bad instruction data *//* CallableCustomMethodPointer<TTS_Linux, void, int, int>::~CallableCustomMethodPointer() */void CallableCustomMethodPointer<TTS_Linux,void,int,int>::~CallableCustomMethodPointer(CallableCustomMethodPointer<TTS_Linux,void,int,int> *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}

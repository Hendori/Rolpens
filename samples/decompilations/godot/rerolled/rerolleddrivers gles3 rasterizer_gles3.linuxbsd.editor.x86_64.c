/* RasterizerGLES3::begin_frame(double) */void RasterizerGLES3::begin_frame(RasterizerGLES3 *this, double param_1) {
   double dVar1;
   long in_FS_OFFSET;
...
/* RasterizerGLES3::end_frame(bool) */void RasterizerGLES3::end_frame(bool param_1) {
   GLES3::Utilities::capture_timestamps_end();
   return;
}
/* RasterizerGLES3::finalize() */void RasterizerGLES3::finalize(RasterizerGLES3 *this) {
   long *plVar1;
   undefined8 *puVar2;
   PostEffects *this_00;
   Glow *this_01;
...
/* RasterizerGLES3::~RasterizerGLES3() */void RasterizerGLES3::~RasterizerGLES3(RasterizerGLES3 *this) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RasterizerGLES3::gl_end_frame(bool) */void RasterizerGLES3::gl_end_frame(RasterizerGLES3 *this, bool param_1) {
   if (param_1) {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RasterizerGLES3::set_boot_image(Ref<Image> const&, Color const&, bool, bool) */void RasterizerGLES3::set_boot_image(RasterizerGLES3 *this, Ref *param_1, Color *param_2, bool param_3, bool param_4) {
   long lVar1;
   ulong uVar2;
   code *pcVar3;
   char cVar4;
   ...
   if (( *(long*)param_1 == 0 ) || ( cVar4 = cVar4 != '\0' )) goto LAB_00100738;
   ...
   if (param_3) {
      ...
      local_58 = 0;
      local_60 = CONCAT44(( (float)local_68._4_4_ - fVar12 ) * _LC3._4_4_, ( (float)(int)local_68 - (float)local_50 ) * (float)_LC3);
   ...
   if (( uVar8 == 0 ) || ( *(uint*)( lVar1 + 0xf4 ) <= (uint)uVar8 )) {
      LAB_0010083c:lVar9 = 0;
   }
 else {
      lVar9 = ( ( uVar8 & 0xffffffff ) % ( ulong ) * (uint*)( lVar1 + 0xf0 ) ) * 0xf0 + *(long*)( *(long*)( lVar1 + 0xe0 ) + ( ( uVar8 & 0xffffffff ) / ( ulong ) * (uint*)( lVar1 + 0xf0 ) ) * 8 );
      ...
      if (iVar5 == (int)( uVar8 >> 0x20 )) {
         if (*(char*)( lVar9 + 8 ) != '\0') {
            if (*(long*)( lVar9 + 0x10 ) != 0) {
               ...
               if ((uint)uVar2 < *(uint*)( lVar1 + 0xf4 )) {
                  lVar9 = ( ( uVar2 & 0xffffffff ) % ( ulong ) * (uint*)( lVar1 + 0xf0 ) ) * 0xf0 + *(long*)( *(long*)( lVar1 + 0xe0 ) + ( ( uVar2 & 0xffffffff ) / ( ulong ) * (uint*)( lVar1 + 0xf0 ) ) * 8 );
                  iVar5 = *(int*)( lVar9 + 0xe8 );
         ...
         LAB_00100830:if (0x7ffffffe < iVar5 + 0x80000000U) goto LAB_0010083c;
         lVar9 = 0;
   ...
   LAB_00100644:lVar1 = GLES3::Config::singleton;
   if (param_4) {
      if (*(int*)( lVar9 + 0xe0 ) != 2) {
         uVar7 = 2;
         uVar10 = 0x2601;
         LAB_0010066a:*(undefined4*)( lVar9 + 0xe0 ) = uVar7;
   ...
   LAB_00100738:if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return;
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RasterizerGLES3::clear_depth(float) */void RasterizerGLES3::clear_depth(float param_1) {
   if (gles_over_gl == '\0') {
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RasterizerGLES3::RasterizerGLES3() */void RasterizerGLES3::RasterizerGLES3(RasterizerGLES3 *this) {
   long *plVar1;
   char *pcVar2;
   Object *pOVar3;
   char *pcVar4;
   ...
   *(undefined8*)( this + 0x20 ) = 0;
   ...
   singleton = this;
   for (int i = 0; i < 8; i++) {
      *(undefined1(*) [16])( this + ( 16*i + 48 ) ) = (undefined1[16])0;
   }

   if (bVar11) {
      if (pcVar9 == (code*)0x0) {
         LAB_00100f00:iVar6 = gladLoaderLoadGLES2();
      ...
      joined_r0x00100f15:if (gles_over_gl == '\0') {
         LAB_001009b6:OS::get_singleton();
         cVar5 = OS::is_stdout_verbose();
         if (( cVar5 != '\0' ) && ( ( pcVar9 = (code*)( *_glad_eglGetProcAddress )("glDebugMessageCallback") ),pcVar9 != (code*)0x0 || ( pcVar9 = (code*)( *_glad_eglGetProcAddress )("glDebugMessageCallbackKHR") ),pcVar9 != (code*)0x0 )) {
         ...
         if (( cVar5 != '\0' ) && ( _GLAD_GL_ARB_debug_output != 0 )) {
            for (int i = 0; i < 6; i++) {
               ( *_glad_glDebugMessageControlARB )(33350, ( i + 33356 ), 37190, 0, 0, 1);
            }
      ...
      if (local_78 == (Object*)0x0) {
         operator+((char *)&
         local_68,(String_conflict*)"Can\'t create shader cache folder, no shader caching will happen: ";
         uVar10 = 0x14f;
         LAB_00101098:_err_print_error("RasterizerGLES3", "drivers/gles3/rasterizer_gles3.cpp", uVar10, (String_conflict*)&local_68, 0, 0);
         pcVar2 = local_68;
         if (local_68 != (char*)0x0) {
            LOCK();
            plVar1 = (long*)( local_68 + -0x10 );
      ...
      if (( ( local_78 != (Object*)0x0 ) && ( cVar5 = RefCounted::unreference() ),cVar5 != '\0' )) &&( cVar5 = cVar5 != '\0' )(**(code**)( *(long*)local_78 + 0x140 ))(local_78);
...
LAB_00100e95:
    ...
    }iVar6 = gladLoaderLoadGL();if (iVar6 != 0) goto joined_r0x00100f15;LAB_00100eab:_err_print_error("RasterizerGLES3", "drivers/gles3/rasterizer_gles3.cpp", 0x118, "Condition \"!glad_loaded\" is true.", "Error initializing GLAD.", 0, 0);}if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
   return;
}
LAB_001013bd:/* WARNING: Subroutine does not return */__stack_chk_fail();}/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* RasterizerGLES3::_blit_render_target_to_screen(RID, int, Rect2 const&, unsigned int, bool) */void RasterizerGLES3::_blit_render_target_to_screen(RasterizerGLES3 *this, ulong param_2, undefined8 param_3, float *param_4, uint param_5, char param_6) {
   long lVar1;
   int iVar2;
   long lVar3;
   ulong uVar4;
   ...
   if (( param_2 != 0 ) && ( (uint)param_2 < *(uint*)( lVar3 + 0x194 ) )) {
      lVar3 = ( ( param_2 & 0xffffffff ) % ( ulong ) * (uint*)( lVar3 + 400 ) ) * 0xf0 + *(long*)( *(long*)( lVar3 + 0x180 ) + ( ( param_2 & 0xffffffff ) / ( ulong ) * (uint*)( lVar3 + 400 ) ) * 8 );
      if (*(int*)( lVar3 + 0xe8 ) == (int)( param_2 >> 0x20 )) {
         ...
         if (param_6 == '\0') {
            LAB_00101568:uVar13 = *(undefined8*)( param_4 + 2 );
         }
 else {
            if (( *param_4 != 0.0 ) || ( param_4[1] != 0.0 )) {
               LAB_00101520:uVar4 = ( **(code**)( *GLES3::Utilities::singleton + 0xe0 ) )();
               uVar6 = 0;
            ...
            if (( param_4[2] != (float)uVar12 ) || ( uVar13 = CONCAT44(param_4[3], param_4[2]) ),param_4[3] != (float)( (ulong)uVar12 >> 0x20 )) goto LAB_00101520;
         }

         local_48 = CONCAT44((float)( ( ulong ) * (undefined8*)param_4 >> 0x20 ) + (float)( (ulong)uVar13 >> 0x20 ), (float)*(undefined8*)param_4 + (float)uVar13);
         ...
         if (this[0x28] == (RasterizerGLES3)0x0) {
            ...
            if (lVar1 == 0) {
               ...
               fVar11 = *param_4;
               LAB_001015c6:fVar14 = (float)iVar5;
            }
 else {
               fVar14 = param_4[1];
               uVar10 = (uint)(float)iVar5;
               fVar11 = *param_4;
               LAB_001016c7:uVar4 = (ulong)uVar10;
            }
         ...
         ( *_glad_glBlitFramebuffer )(0, 0, *(undefined4*)( lVar3 + 8 ), *(undefined4*)( lVar3 + 0xc ), uVar8, uVar10, uVar7, uVar4, 0x4000, 0x2600);
         if (local_4c != 0) {
   ...
   if (local_40 == *(long*)( in_FS_OFFSET + 0x28 )) {
      _err_print_error("_blit_render_target_to_screen", "drivers/gles3/rasterizer_gles3.cpp", 0x184, "Parameter \"rt\" is null.", 0, 0);
      return;
   }

   LAB_0010177b:/* WARNING: Subroutine does not return */__stack_chk_fail();
}
/* RasterizerGLES3::blit_render_targets_to_screen(int, BlitToScreen const*, int) */void RasterizerGLES3::blit_render_targets_to_screen(int param_1, BlitToScreen *param_2, int param_3) {
   undefined8 uVar1;
   int in_ECX;
   ...
   if (0 < in_ECX) {
      ...
      do {
         ...
         this =
         this + 0x50;
         _blit_render_target_to_screen((RasterizerGLES3*)CONCAT44(in_register_0000003c, param_1), uVar1, (ulong)param_2 & 0xffffffff, local_58, uVar3, bVar4);
      }
 while ( in_ECX != iVar2 );
   }
...
/* RasterizerGLES3::initialize() */void RasterizerGLES3::initialize(RasterizerGLES3 *this) {
   long lVar1;
   char *pcVar2;
...
/* RasterizerGLES3::get_utilities() */undefined8 RasterizerGLES3::get_utilities(RasterizerGLES3 *this) {
   return *(undefined8*)( this + 0x38 );
}
/* RasterizerGLES3::get_light_storage() */undefined8 RasterizerGLES3::get_light_storage(RasterizerGLES3 *this) {
   return *(undefined8*)( this + 0x60 );
}
/* RasterizerGLES3::get_material_storage() */undefined8 RasterizerGLES3::get_material_storage(RasterizerGLES3 *this) {
   return *(undefined8*)( this + 0x48 );
}
/* RasterizerGLES3::get_mesh_storage() */undefined8 RasterizerGLES3::get_mesh_storage(RasterizerGLES3 *this) {
   return *(undefined8*)( this + 0x50 );
}
/* RasterizerGLES3::get_particles_storage() */undefined8 RasterizerGLES3::get_particles_storage(RasterizerGLES3 *this) {
   return *(undefined8*)( this + 0x58 );
}
/* RasterizerGLES3::get_texture_storage() */undefined8 RasterizerGLES3::get_texture_storage(RasterizerGLES3 *this) {
   return *(undefined8*)( this + 0x40 );
}
/* RasterizerGLES3::get_gi() */undefined8 RasterizerGLES3::get_gi(RasterizerGLES3 *this) {
   return *(undefined8*)( this + 0x68 );
}
/* RasterizerGLES3::get_fog() */undefined8 RasterizerGLES3::get_fog(RasterizerGLES3 *this) {
   return *(undefined8*)( this + 0x70 );
}
/* RasterizerGLES3::get_canvas() */undefined8 RasterizerGLES3::get_canvas(RasterizerGLES3 *this) {
   return *(undefined8*)( this + 0xa0 );
}
/* RasterizerGLES3::get_scene() */undefined8 RasterizerGLES3::get_scene(RasterizerGLES3 *this) {
   return *(undefined8*)( this + 0xa8 );
}
/* RasterizerGLES3::get_frame_number() const */undefined8 RasterizerGLES3::get_frame_number(RasterizerGLES3 *this) {
   return *(undefined8*)( this + 0x10 );
}
/* RasterizerGLES3::get_frame_delta_time() const */double RasterizerGLES3::get_frame_delta_time(RasterizerGLES3 *this) {
   return (double)*(float*)( this + 0x18 );
}
/* RasterizerGLES3::get_total_time() const */undefined8 RasterizerGLES3::get_total_time(RasterizerGLES3 *this) {
   return *(undefined8*)( this + 0x20 );
}
/* RasterizerGLES3::can_create_resources_async() const */undefined8 RasterizerGLES3::can_create_resources_async(void) {
   return 0;
}
/* WARNING: Removing unreachable block (ram,0x00102be8) *//* WARNING: Removing unreachable block (ram,0x00102d18) *//* WARNING: Removing unreachable block (ram,0x00102ee0) *//* WARNING: Removing unreachable block (ram,0x00102d24) *//* WARNING: Removing unreachable block (ram,0x00102d2e) *//* WARNING: Removing unreachable block (ram,0x00102ec0) *//* WARNING: Removing unreachable block (ram,0x00102d3a) *//* WARNING: Removing unreachable block (ram,0x00102d44) *//* WARNING: Removing unreachable block (ram,0x00102ea0) *//* WARNING: Removing unreachable block (ram,0x00102d50) *//* WARNING: Removing unreachable block (ram,0x00102d5a) *//* WARNING: Removing unreachable block (ram,0x00102e80) *//* WARNING: Removing unreachable block (ram,0x00102d66) *//* WARNING: Removing unreachable block (ram,0x00102d70) *//* WARNING: Removing unreachable block (ram,0x00102e60) *//* WARNING: Removing unreachable block (ram,0x00102d7c) *//* WARNING: Removing unreachable block (ram,0x00102d86) *//* WARNING: Removing unreachable block (ram,0x00102e40) *//* WARNING: Removing unreachable block (ram,0x00102d92) *//* WARNING: Removing unreachable block (ram,0x00102d9c) *//* WARNING: Removing unreachable block (ram,0x00102e20) *//* WARNING: Removing unreachable block (ram,0x00102da4) *//* WARNING: Removing unreachable block (ram,0x00102dba) *//* WARNING: Removing unreachable block (ram,0x00102dc6) *//* String vformat<unsigned int>(String const&, unsigned int const) */String_conflict *vformat<unsigned_int>(String_conflict *param_1, uint param_2) {
   char cVar1;
   Variant *this;
   uint in_EDX;
...
/* WARNING: Removing unreachable block (ram,0x00103078) *//* WARNING: Removing unreachable block (ram,0x001031a8) *//* WARNING: Removing unreachable block (ram,0x00103320) *//* WARNING: Removing unreachable block (ram,0x001031b4) *//* WARNING: Removing unreachable block (ram,0x001031be) *//* WARNING: Removing unreachable block (ram,0x00103302) *//* WARNING: Removing unreachable block (ram,0x001031ca) *//* WARNING: Removing unreachable block (ram,0x001031d4) *//* WARNING: Removing unreachable block (ram,0x001032e4) *//* WARNING: Removing unreachable block (ram,0x001031e0) *//* WARNING: Removing unreachable block (ram,0x001031ea) *//* WARNING: Removing unreachable block (ram,0x001032c6) *//* WARNING: Removing unreachable block (ram,0x001031f6) *//* WARNING: Removing unreachable block (ram,0x00103200) *//* WARNING: Removing unreachable block (ram,0x001032a8) *//* WARNING: Removing unreachable block (ram,0x0010320c) *//* WARNING: Removing unreachable block (ram,0x00103216) *//* WARNING: Removing unreachable block (ram,0x0010328a) *//* WARNING: Removing unreachable block (ram,0x0010321e) *//* WARNING: Removing unreachable block (ram,0x00103228) *//* WARNING: Removing unreachable block (ram,0x0010326f) *//* WARNING: Removing unreachable block (ram,0x00103230) *//* WARNING: Removing unreachable block (ram,0x00103245) *//* WARNING: Removing unreachable block (ram,0x00103251) *//* String vformat<String, String, String>(String const&, String const, String const, String const)

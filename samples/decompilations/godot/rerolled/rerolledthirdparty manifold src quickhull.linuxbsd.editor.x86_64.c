/* int& std::deque<int, std::allocator<int> >::emplace_back<int>(int&&) [clone .isra.0] */int *__thiscallstd::deque<int,std::allocator<int>>::emplace_back<int>(deque<int,std::allocator<int>> *this, int *param_1) {
   int iVar1;
   int *piVar2;
   long lVar3;
   int *piVar4;
   ...
   if (( (long)piVar2 - *(long*)( this + 0x38 ) >> 2 ) + ( ( lVar10 >> 3 ) + -1 + ( ulong )(plVar8 == (long*)0x0) ) * 0x80 + ( *(long*)( this + 0x20 ) - *(long*)( this + 0x10 ) >> 2 ) == 0x1fffffffffffffff) {
      LAB_0010026b:/* WARNING: Subroutine does not return */std::__throw_length_error("cannot create std::deque larger than max_size()");
   }
   ...
   if (uVar7 - ( (long)plVar8 - *(long*)this >> 3 ) < 2) {
      ...
      if (( ulong )((long)__dest * 2) < uVar7) {
         ...
         if (uVar7 == 0) {
            uVar7 = 0x18;
            uVar9 = 3;
            LAB_00100133:unaff_R15 = operator_new(uVar7);
            __src = *(long**)( this + 0x28 );
   ...
   *(int**)( this + 0x40 ) = piVar4 + 0x80;
   LAB_0010002e:*(int**)( this + 0x30 ) = piVar4;
   return piVar4;
}
/* manifold::defaultEps() */undefined8 manifold::defaultEps(void) {
   return _LC1;
}
/* manifold::MeshBuilder::addHalfedge() */long manifold::MeshBuilder::addHalfedge(MeshBuilder *this) {
   long lVar1;
   undefined4 *puVar2;
   ulong uVar3;
   undefined8 *puVar4;
   ...
   if (uVar3 != 0) {
      ...
      if (*(ulong*)( this + 0x88 ) < uVar7) {
         ...
         *(ulong*)( this + 0x80 ) = uVar7;
         ...
         LAB_0010044c:if (puVar4 == (undefined8*)0x0) goto LAB_00100455;
      }

      free(puVar4);
      LAB_00100455:*(undefined8**)( this + 0x78 ) = puVar6;
   ...
   if (uVar3 < uVar7) {
      ...
      *(undefined4*)( puVar4 + 1 ) = 0;
      ...
      LAB_0010039a:if (uVar3 == 0) {
         sVar8 = 0x200;
         uVar9 = 0x80;
         LAB_001004bb:puVar5 = (undefined4*)malloc(sVar8);
         puVar2 = *(undefined4**)( this + 0x30 );
         if (uVar7 == 0) {
            LAB_001004d0:if (puVar2 != (undefined4*)0x0) goto LAB_0010064d;
         }
 else {
            sVar8 = uVar7 * 4;
            if ((long)sVar8 < 5) {
      ...
      *(ulong*)( this + 0x38 ) = uVar7 + 1;
      ...
      if (uVar7 == 0) {
         sVar8 = 0x600;
         uVar9 = 0x80;
         LAB_0010047b:puVar4 = (undefined8*)malloc(sVar8);
         puVar6 = *(undefined8**)( this + 0x18 );
         if (uVar3 == 0) {
            LAB_00100490:if (puVar6 != (undefined8*)0x0) goto LAB_0010067a;
         }
 else {
            sVar8 = uVar3 * 0xc;
            if ((long)sVar8 < 0xd) {
      ...
      *(undefined4*)( puVar4 + 1 ) = 0;
      ...
      LAB_001002fa:*(ulong*)( this + 0x38 ) = uVar7 + 1;
      *(undefined4*)( *(long*)( this + 0x30 ) + uVar7 * 4 ) = 0;
      uVar7 = *(ulong*)( this + 0x50 );
      uVar3 = *(ulong*)( this + 0x58 );
      if (uVar3 <= uVar7) {
         LAB_001003d5:if (uVar3 == 0) {
            sVar8 = 0x200;
            uVar9 = 0x80;
            LAB_001004fb:puVar5 = (undefined4*)malloc(sVar8);
            puVar2 = *(undefined4**)( this + 0x48 );
            if (uVar7 == 0) {
               LAB_00100510:if (puVar2 != (undefined4*)0x0) goto LAB_0010061d;
            }
 else {
               sVar8 = uVar7 * 4;
               if ((long)sVar8 < 5) {
   ...
   *(undefined4*)( *(long*)( this + 0x48 ) + uVar7 * 4 ) = 0;
   LAB_00100331:return *(long*)( this + 0x20 ) + -1;
}
/* manifold::MeshBuilder::getVertexIndicesOfFace(manifold::MeshBuilder::Face const&) const */undefined8 manifold::MeshBuilder::getVertexIndicesOfFace(MeshBuilder *this, Face *param_1) {
   long lVar1;
   long lVar2;
   long lVar3;
   long in_FS_OFFSET;
   ...
   if (*(long*)( in_FS_OFFSET + 0x28 ) == *(long*)( in_FS_OFFSET + 0x28 )) {
      return CONCAT44(*(undefined4*)( lVar1 + 4 + lVar2 * 0xc ), *(undefined4*)( lVar1 + 4 + (long)*(int*)param_1 * 0xc ));
   }

   /* WARNING: Subroutine does not return */
   __stack_chk_fail(this, lVar3 * 3, *(undefined4*)( lVar1 + 4 + lVar3 * 0xc ));
}
/* manifold::QuickHull::getExtremeValues() */void manifold::QuickHull::getExtremeValues(void) {
   double dVar1;
   ulong uVar2;
   bool bVar3;
   bool bVar4;
...
/* manifold::QuickHull::reorderHorizonEdges(manifold::VecView<unsigned long>&) */undefined8 manifold::QuickHull::reorderHorizonEdges(QuickHull *this, VecView *param_1) {
   ulong uVar1;
   long lVar2;
   long lVar3;
   long *plVar4;
   ...
   if (1 < uVar1) {
      ...
      do {
         ...
         while (*(int*)( lVar2 + 4 + *plVar4 * 0xc ) != *(int*)( lVar2 + 4 + (long)*(int*)( lVar2 + 8 + *plVar5 * 0xc ) * 0xc )) {
            uVar6 = uVar6 + 1;
            plVar5 = plVar5 + 1;
            if (uVar1 <= uVar6) {
               return 0;
...
/* manifold::QuickHull::getScale(std::array<unsigned long, 6ul> const&) */void manifold::QuickHull::getScale(QuickHull *this, array *param_1) {
   ulong uVar1;
   ulong uVar2;
   double dVar3;
   double dVar4;
   ...
   do {
      uVar2 = uVar1 + 1;
      dVar3 = (double)( *(ulong*)( *(long*)( this + 0x38 ) + ( uVar1 >> 1 ) * 8 + *(long*)( param_1 + uVar1 * 8 ) * 0x18 ) & _LC3 );
      if (dVar3 <= dVar4) {
         dVar3 = dVar4;
      }
...
/* manifold::MeshBuilder::addFace() */long manifold::MeshBuilder::addFace(MeshBuilder *this) {
   size_t __n;
   ulong uVar1;
   ulong uVar2;
   undefined4 *puVar3;
   ...
   if (uVar2 == 0) {
      ...
      if (puVar3 == *(undefined4**)( this + 0x10 )) {
         std::vector<manifold::MeshBuilder::Face,std::allocator<manifold::MeshBuilder::Face>>::_M_realloc_insert<>();
         ...
         *(byte*)( puVar3 + 0x12 ) = *(byte*)( puVar3 + 0x12 ) & 0xe0;
         puVar7 = puVar3 + 0x16;
         for (int i = 0; i < 3; i++) {
            *(undefined1(*) [16])( puVar3 + ( 4*i + 2 ) ) = (undefined1[16])0;
         }
   ...
   *(undefined8*)( *(long*)this + lVar4 * 0x58 + 0x30 ) = 0;
   if (*(ulong*)( this + 0x70 ) < uVar1) {
      ...
      *(ulong*)( this + 0x68 ) = uVar1;
      ...
      puVar8 = *(undefined8**)( this + 0x60 );
      puVar6 = (undefined8*)0x0;
      LAB_00100af1:if (puVar8 == (undefined8*)0x0) goto LAB_00100afa;
   }

   free(puVar8);
   LAB_00100afa:*(undefined8**)( this + 0x60 ) = puVar6;
   *(undefined8*)( this + 0x70 ) = *(undefined8*)( this + 0x68 );
   return lVar4;
}
/* manifold::MeshBuilder::Face& std::vector<manifold::MeshBuilder::Face,
   std::allocator<manifold::MeshBuilder::Face> >::emplace_back<int>(int&&) [clone .isra.0] */Face * __thiscall
...
/* manifold::MeshBuilder::setup(int, int, int, int) */void manifold::MeshBuilder::setup(MeshBuilder *this, int param_1, int param_2, int param_3, int param_4) {
   byte bVar1;
   long lVar2;
   undefined8 uVar3;
   undefined4 *puVar4;
 ...
 while ( lVar23 != lVar22 );
   ...
   *(undefined8*)( this + 0x28 ) = uVar12;
   for (int i = 0; i < 4; i++) {
      ...
      *(undefined8*)( this + ( 24*i + 56 ) ) = 0;
      if (*(void**)( this + ( 24*i + 48 ) ) != (void*)0) {
         free(*(void**)( this + ( 24*i + 48 ) ));
         uVar12 = *(undefined8*)( this + ( 24*i + 56 ) );
      }

      *(undefined8*)( this + ( 24*i + 64 ) ) = uVar12;
   }
   ...
   *(undefined8*)( this + 0x78 ) = 0;
   if (( ulong )(*(long*)( this + 0x10 ) - lVar23) < 0x109) {
      ...
      *(undefined4**)( this + 0x10 ) = puVar13 + 0x58;
      ...
      LAB_00100ded:uVar18 = *(ulong*)( this + 0x20 );
      if (uVar18 < uVar16) {
         lVar23 = uVar18 * 2;
         goto LAB_00100dfe;
      }
      ...
      lVar23 = uVar18 * 2;
      if (uVar16 < uVar21) {
         LAB_001026dd:puVar17 = (undefined8*)malloc(( uVar21 + uVar16 ) * 8);
      ...
      *puVar14 = 0;
      ...
      LAB_00101507:puVar17 = (undefined8*)malloc(0x90);
      uVar18 = *(ulong*)( this + 0x20 );
      puVar15 = *(undefined8**)( this + 0x18 );
      if (uVar18 != 0) {
         sVar20 = uVar18 * 0xc;
      ...
      *(undefined8**)( this + 0x18 ) = puVar17;
      lVar23 = 0;
      *(undefined8*)( this + 0x28 ) = 0xc;
      LAB_00100dfe:*(ulong*)( this + 0x20 ) = uVar18 + 1;
   ...
   if (uVar16 < uVar18) {
      ...
      *(undefined4*)( *(long*)( this + 0x30 ) + uVar16 * 4 ) = 0;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x200;
         uVar21 = 0x80;
         LAB_001021e0:puVar14 = (undefined4*)malloc(sVar20);
         puVar4 = *(undefined4**)( this + 0x30 );
         if (uVar16 == 0) {
            LAB_001021ff:if (puVar4 != (undefined4*)0x0) goto LAB_00102881;
         }
 else {
            sVar20 = uVar16 * 4;
            if ((long)sVar20 < 5) {
   ...
   if (uVar16 < uVar18) {
      ...
      *(undefined4*)( *(long*)( this + 0x48 ) + uVar16 * 4 ) = 1;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x200;
         uVar21 = 0x80;
         LAB_00102184:puVar14 = (undefined4*)malloc(sVar20);
         puVar4 = *(undefined4**)( this + 0x48 );
         if (uVar16 == 0) {
            LAB_001021a3:if (puVar4 != (undefined4*)0x0) goto LAB_001028cd;
         }
 else {
            sVar20 = uVar16 * 4;
            if ((long)sVar20 < 5) {
   ...
   if (uVar16 < uVar18) {
      ...
      *puVar14 = 0;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x600;
         uVar21 = 0x80;
         LAB_00102113:puVar15 = (undefined8*)malloc(sVar20);
         puVar17 = *(undefined8**)( this + 0x18 );
         if (uVar16 == 0) {
            LAB_00102132:if (puVar17 != (undefined8*)0x0) goto LAB_00102916;
         }
 else {
            sVar20 = uVar16 * 0xc;
            if ((long)sVar20 < 0xd) {
   ...
   if (uVar16 < uVar18) {
      ...
      *(undefined4*)( *(long*)( this + 0x30 ) + uVar16 * 4 ) = 0;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x200;
         uVar21 = 0x80;
         LAB_001020b4:puVar14 = (undefined4*)malloc(sVar20);
         puVar4 = *(undefined4**)( this + 0x30 );
         if (uVar16 == 0) {
            LAB_001020d3:if (puVar4 != (undefined4*)0x0) goto LAB_00102962;
         }
 else {
            sVar20 = uVar16 * 4;
            if ((long)sVar20 < 5) {
   ...
   if (uVar16 < uVar18) {
      ...
      *(undefined4*)( *(long*)( this + 0x48 ) + uVar16 * 4 ) = 2;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x200;
         uVar21 = 0x80;
         LAB_00102054:puVar14 = (undefined4*)malloc(sVar20);
         puVar4 = *(undefined4**)( this + 0x48 );
         if (uVar16 == 0) {
            LAB_00102073:if (puVar4 != (undefined4*)0x0) goto LAB_00102d36;
         }
 else {
            sVar20 = uVar16 * 4;
            if ((long)sVar20 < 5) {
   ...
   if (uVar16 < uVar18) {
      ...
      *puVar14 = 0;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x600;
         uVar21 = 0x80;
         LAB_00101fe3:puVar15 = (undefined8*)malloc(sVar20);
         puVar17 = *(undefined8**)( this + 0x18 );
         if (uVar16 == 0) {
            LAB_00102002:if (puVar17 != (undefined8*)0x0) goto LAB_00102d7f;
         }
 else {
            sVar20 = uVar16 * 0xc;
            if ((long)sVar20 < 0xd) {
   ...
   if (uVar16 < uVar18) {
      ...
      *(undefined4*)( *(long*)( this + 0x30 ) + uVar16 * 4 ) = 0;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x200;
         uVar21 = 0x80;
         LAB_00101f84:puVar14 = (undefined4*)malloc(sVar20);
         puVar4 = *(undefined4**)( this + 0x30 );
         if (uVar16 == 0) {
            LAB_00101fa3:if (puVar4 != (undefined4*)0x0) goto LAB_00102dcb;
         }
 else {
            sVar20 = uVar16 * 4;
            if ((long)sVar20 < 5) {
   ...
   if (uVar16 < uVar18) {
      ...
      *(undefined4*)( *(long*)( this + 0x48 ) + uVar16 * 4 ) = 0;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x200;
         uVar21 = 0x80;
         LAB_00101f24:puVar14 = (undefined4*)malloc(sVar20);
         puVar4 = *(undefined4**)( this + 0x48 );
         if (uVar16 == 0) {
            LAB_00101f43:if (puVar4 != (undefined4*)0x0) goto LAB_00102e17;
         }
 else {
            sVar20 = uVar16 * 4;
            if ((long)sVar20 < 5) {
   ...
   if (uVar16 < uVar18) {
      ...
      *puVar14 = 0;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x600;
         uVar21 = 0x80;
         LAB_00101eb3:puVar15 = (undefined8*)malloc(sVar20);
         puVar17 = *(undefined8**)( this + 0x18 );
         if (uVar16 == 0) {
            LAB_00101ed2:if (puVar17 != (undefined8*)0x0) goto LAB_00102b15;
         }
 else {
            sVar20 = uVar16 * 0xc;
            if ((long)sVar20 < 0xd) {
   ...
   if (uVar16 < uVar18) {
      ...
      *(undefined4*)( *(long*)( this + 0x30 ) + uVar16 * 4 ) = 1;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x200;
         uVar21 = 0x80;
         LAB_00101e54:puVar14 = (undefined4*)malloc(sVar20);
         puVar4 = *(undefined4**)( this + 0x30 );
         if (uVar16 == 0) {
            LAB_00101e73:if (puVar4 != (undefined4*)0x0) goto LAB_00102b61;
         }
 else {
            sVar20 = uVar16 * 4;
            if ((long)sVar20 < 5) {
   ...
   if (uVar16 < uVar18) {
      ...
      *(undefined4*)( *(long*)( this + 0x48 ) + uVar16 * 4 ) = 4;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x200;
         uVar21 = 0x80;
         LAB_00101df4:puVar14 = (undefined4*)malloc(sVar20);
         puVar4 = *(undefined4**)( this + 0x48 );
         if (uVar16 == 0) {
            LAB_00101e13:if (puVar4 != (undefined4*)0x0) goto LAB_00102c09;
         }
 else {
            sVar20 = uVar16 * 4;
            if ((long)sVar20 < 5) {
   ...
   if (uVar16 < uVar18) {
      ...
      *puVar14 = 0;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x600;
         uVar21 = 0x80;
         LAB_00101d83:puVar15 = (undefined8*)malloc(sVar20);
         puVar17 = *(undefined8**)( this + 0x18 );
         if (uVar16 == 0) {
            LAB_00101da2:if (puVar17 != (undefined8*)0x0) goto LAB_00102c52;
         }
 else {
            sVar20 = uVar16 * 0xc;
            if ((long)sVar20 < 0xd) {
   ...
   if (uVar16 < uVar18) {
      ...
      *(undefined4*)( *(long*)( this + 0x30 ) + uVar16 * 4 ) = 1;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x200;
         uVar21 = 0x80;
         LAB_00101d24:puVar14 = (undefined4*)malloc(sVar20);
         puVar4 = *(undefined4**)( this + 0x30 );
         if (uVar16 == 0) {
            LAB_00101d43:if (puVar4 != (undefined4*)0x0) goto LAB_00102c9e;
         }
 else {
            sVar20 = uVar16 * 4;
            if ((long)sVar20 < 5) {
   ...
   if (uVar16 < uVar18) {
      ...
      *(undefined4*)( *(long*)( this + 0x48 ) + uVar16 * 4 ) = 5;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x200;
         uVar21 = 0x80;
         LAB_00101cc4:puVar14 = (undefined4*)malloc(sVar20);
         puVar4 = *(undefined4**)( this + 0x48 );
         if (uVar16 == 0) {
            LAB_00101ce3:if (puVar4 != (undefined4*)0x0) goto LAB_00102cea;
         }
 else {
            sVar20 = uVar16 * 4;
            if ((long)sVar20 < 5) {
   ...
   if (uVar16 < uVar18) {
      ...
      *puVar14 = 0;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x600;
         uVar21 = 0x80;
         LAB_00101c53:puVar15 = (undefined8*)malloc(sVar20);
         puVar17 = *(undefined8**)( this + 0x18 );
         if (uVar16 == 0) {
            LAB_00101c72:if (puVar17 != (undefined8*)0x0) goto LAB_00102e60;
         }
 else {
            sVar20 = uVar16 * 0xc;
            if ((long)sVar20 < 0xd) {
   ...
   if (uVar16 < uVar18) {
      ...
      *(undefined4*)( *(long*)( this + 0x30 ) + uVar16 * 4 ) = 1;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x200;
         uVar21 = 0x80;
         LAB_00101bf4:puVar14 = (undefined4*)malloc(sVar20);
         puVar4 = *(undefined4**)( this + 0x30 );
         if (uVar16 == 0) {
            LAB_00101c13:if (puVar4 != (undefined4*)0x0) goto LAB_00102eac;
         }
 else {
            sVar20 = uVar16 * 4;
            if ((long)sVar20 < 5) {
   ...
   if (uVar16 < uVar18) {
      ...
      *(undefined4*)( *(long*)( this + 0x48 ) + uVar16 * 4 ) = 3;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x200;
         uVar21 = 0x80;
         LAB_00101b94:puVar14 = (undefined4*)malloc(sVar20);
         puVar4 = *(undefined4**)( this + 0x48 );
         if (uVar16 == 0) {
            LAB_00101bb3:if (puVar4 != (undefined4*)0x0) goto LAB_00102ef8;
         }
 else {
            sVar20 = uVar16 * 4;
            if ((long)sVar20 < 5) {
   ...
   if (uVar16 < uVar18) {
      ...
      *puVar14 = 0;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x600;
         uVar21 = 0x80;
         LAB_00101b23:puVar15 = (undefined8*)malloc(sVar20);
         puVar17 = *(undefined8**)( this + 0x18 );
         if (uVar16 == 0) {
            LAB_00101b42:if (puVar17 != (undefined8*)0x0) goto LAB_00102f41;
         }
 else {
            sVar20 = uVar16 * 0xc;
            if ((long)sVar20 < 0xd) {
   ...
   if (uVar16 < uVar18) {
      ...
      *(undefined4*)( *(long*)( this + 0x30 ) + uVar16 * 4 ) = 2;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x200;
         uVar21 = 0x80;
         LAB_00101ad4:puVar14 = (undefined4*)malloc(sVar20);
         puVar4 = *(undefined4**)( this + 0x30 );
         if (uVar16 == 0) {
            LAB_00101ae9:if (puVar4 != (undefined4*)0x0) goto LAB_00102f83;
         }
 else {
            sVar20 = uVar16 * 4;
            if ((long)sVar20 < 5) {
   ...
   if (uVar16 < uVar18) {
      ...
      *(undefined4*)( *(long*)( this + 0x48 ) + uVar16 * 4 ) = 7;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x200;
         uVar21 = 0x80;
         LAB_00101a84:puVar14 = (undefined4*)malloc(sVar20);
         puVar4 = *(undefined4**)( this + 0x48 );
         if (uVar16 == 0) {
            LAB_00101a99:if (puVar4 != (undefined4*)0x0) goto LAB_00102fbb;
         }
 else {
            sVar20 = uVar16 * 4;
            if ((long)sVar20 < 5) {
   ...
   if (uVar16 < uVar18) {
      ...
      *puVar14 = 0;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x600;
         uVar21 = 0x80;
         LAB_00101a23:puVar15 = (undefined8*)malloc(sVar20);
         puVar17 = *(undefined8**)( this + 0x18 );
         if (uVar16 == 0) {
            LAB_00101a38:if (puVar17 != (undefined8*)0x0) goto LAB_00102ff3;
         }
 else {
            sVar20 = uVar16 * 0xc;
            if ((long)sVar20 < 0xd) {
   ...
   if (uVar16 < uVar18) {
      ...
      *(undefined4*)( *(long*)( this + 0x30 ) + uVar16 * 4 ) = 2;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x200;
         uVar21 = 0x80;
         LAB_001019d4:puVar14 = (undefined4*)malloc(sVar20);
         puVar4 = *(undefined4**)( this + 0x30 );
         if (uVar16 == 0) {
            LAB_001019e9:if (puVar4 != (undefined4*)0x0) goto LAB_0010302b;
         }
 else {
            sVar20 = uVar16 * 4;
            if ((long)sVar20 < 5) {
   ...
   if (uVar16 < uVar18) {
      ...
      *(undefined4*)( *(long*)( this + 0x48 ) + uVar16 * 4 ) = 8;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x200;
         uVar21 = 0x80;
         LAB_00101984:puVar14 = (undefined4*)malloc(sVar20);
         puVar4 = *(undefined4**)( this + 0x48 );
         if (uVar16 == 0) {
            LAB_00101999:if (puVar4 != (undefined4*)0x0) goto LAB_001029a4;
         }
 else {
            sVar20 = uVar16 * 4;
            if ((long)sVar20 < 5) {
   ...
   if (uVar16 < uVar18) {
      ...
      *puVar14 = 0;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x600;
         uVar21 = 0x80;
         LAB_00101923:puVar15 = (undefined8*)malloc(sVar20);
         puVar17 = *(undefined8**)( this + 0x18 );
         if (uVar16 == 0) {
            LAB_00101938:if (puVar17 != (undefined8*)0x0) goto LAB_001029dc;
         }
 else {
            sVar20 = uVar16 * 0xc;
            if ((long)sVar20 < 0xd) {
   ...
   if (uVar16 < uVar18) {
      ...
      *(undefined4*)( *(long*)( this + 0x30 ) + uVar16 * 4 ) = 2;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x200;
         uVar21 = 0x80;
         LAB_001018d4:puVar14 = (undefined4*)malloc(sVar20);
         puVar4 = *(undefined4**)( this + 0x30 );
         if (uVar16 == 0) {
            LAB_001018e9:if (puVar4 != (undefined4*)0x0) goto LAB_00102a14;
         }
 else {
            sVar20 = uVar16 * 4;
            if ((long)sVar20 < 5) {
   ...
   if (uVar16 < uVar18) {
      ...
      *(undefined4*)( *(long*)( this + 0x48 ) + uVar16 * 4 ) = 6;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x200;
         uVar21 = 0x80;
         LAB_00101884:puVar14 = (undefined4*)malloc(sVar20);
         puVar4 = *(undefined4**)( this + 0x48 );
         if (uVar16 == 0) {
            LAB_00101899:if (puVar4 != (undefined4*)0x0) goto LAB_00102a4c;
         }
 else {
            sVar20 = uVar16 * 4;
            if ((long)sVar20 < 5) {
   ...
   if (uVar16 < uVar18) {
      ...
      *puVar14 = 0;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x600;
         uVar21 = 0x80;
         LAB_00101823:puVar15 = (undefined8*)malloc(sVar20);
         puVar17 = *(undefined8**)( this + 0x18 );
         if (uVar16 == 0) {
            LAB_00101838:if (puVar17 != (undefined8*)0x0) goto LAB_001027b5;
         }
 else {
            sVar20 = uVar16 * 0xc;
            if ((long)sVar20 < 0xd) {
   ...
   if (uVar16 < uVar18) {
      ...
      *(undefined4*)( *(long*)( this + 0x30 ) + uVar16 * 4 ) = 3;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x200;
         uVar21 = 0x80;
         LAB_001017d4:puVar14 = (undefined4*)malloc(sVar20);
         puVar4 = *(undefined4**)( this + 0x30 );
         if (uVar16 == 0) {
            LAB_001017e9:if (puVar4 != (undefined4*)0x0) goto LAB_001027e3;
         }
 else {
            sVar20 = uVar16 * 4;
            if ((long)sVar20 < 5) {
   ...
   if (uVar16 < uVar18) {
      ...
      *(undefined4*)( *(long*)( this + 0x48 ) + uVar16 * 4 ) = 10;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x200;
         uVar21 = 0x80;
         LAB_0010177c:puVar14 = (undefined4*)malloc(sVar20);
         puVar4 = *(undefined4**)( this + 0x48 );
         if (uVar16 == 0) {
            LAB_00101791:if (puVar4 != (undefined4*)0x0) goto LAB_00102811;
         }
 else {
            sVar20 = uVar16 * 4;
            if ((long)sVar20 < 5) {
   ...
   if (uVar16 < uVar18) {
      ...
      *puVar14 = 0;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x600;
         uVar21 = 0x80;
         LAB_00101714:puVar15 = (undefined8*)malloc(sVar20);
         puVar17 = *(undefined8**)( this + 0x18 );
         if (uVar16 == 0) {
            LAB_00101729:if (puVar17 != (undefined8*)0x0) goto LAB_0010283f;
         }
 else {
            sVar20 = uVar16 * 0xc;
            if ((long)sVar20 < 0xd) {
   ...
   if (uVar16 < uVar18) {
      ...
      *(undefined4*)( *(long*)( this + 0x30 ) + uVar16 * 4 ) = 3;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x200;
         uVar21 = 0x80;
         LAB_001016c4:puVar14 = (undefined4*)malloc(sVar20);
         puVar4 = *(undefined4**)( this + 0x30 );
         if (uVar16 == 0) {
            LAB_001016d9:if (puVar4 != (undefined4*)0x0) goto LAB_00102b99;
         }
 else {
            sVar20 = uVar16 * 4;
            if ((long)sVar20 < 5) {
   ...
   if (uVar16 < uVar18) {
      ...
      *(undefined4*)( *(long*)( this + 0x48 ) + uVar16 * 4 ) = 0xb;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x200;
         uVar21 = 0x80;
         LAB_0010166c:puVar14 = (undefined4*)malloc(sVar20);
         puVar4 = *(undefined4**)( this + 0x48 );
         if (uVar16 == 0) {
            LAB_00101681:if (puVar4 != (undefined4*)0x0) goto LAB_00102bc7;
         }
 else {
            sVar20 = uVar16 * 4;
            if ((long)sVar20 < 5) {
   ...
   if (uVar16 < uVar18) {
      ...
      *puVar14 = 0;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x600;
         uVar21 = 0x80;
         LAB_00101604:puVar15 = (undefined8*)malloc(sVar20);
         puVar17 = *(undefined8**)( this + 0x18 );
         if (uVar16 == 0) {
            LAB_00101619:if (puVar17 != (undefined8*)0x0) goto LAB_00102ad6;
         }
 else {
            sVar20 = uVar16 * 0xc;
            if ((long)sVar20 < 0xd) {
   ...
   if (uVar16 < uVar18) {
      ...
      *(undefined4*)( *(long*)( this + 0x30 ) + uVar16 * 4 ) = 3;
      ...
      if (uVar18 == 0) {
         sVar20 = 0x200;
         uVar21 = 0x80;
         LAB_001015b4:puVar14 = (undefined4*)malloc(sVar20);
         puVar4 = *(undefined4**)( this + 0x30 );
         if (uVar16 == 0) {
            LAB_001015c9:if (puVar4 != (undefined4*)0x0) goto LAB_00102a7a;
         }
 else {
            sVar20 = uVar16 * 4;
            if ((long)sVar20 < 5) {
   ...
   if (uVar18 == 0) {
      sVar20 = 0x200;
      uVar21 = 0x80;
      LAB_0010155c:puVar14 = (undefined4*)malloc(sVar20);
      puVar4 = *(undefined4**)( this + 0x48 );
      if (uVar16 == 0) {
         LAB_00101571:if (puVar4 != (undefined4*)0x0) goto LAB_00102aa8;
      }
 else {
         sVar20 = uVar16 * 4;
         if ((long)sVar20 < 5) {
   ...
   *(ulong*)( this + 0x50 ) = uVar16 + 1;
   puVar14[uVar16] = 9;
   LAB_001013db:local_44 = 0;
   std::vector<manifold::MeshBuilder::Face,std::allocator<manifold::MeshBuilder::Face>>::emplace_back<int>((vector<manifold::MeshBuilder::Face,std::allocator<manifold::MeshBuilder::Face>>*)this, &local_44);
   for (int i = 0; i < 3; i++) {
      local_44 = ( 3*i + 3 );
      std::vector<manifold::MeshBuilder::Face,std::allocator<manifold::MeshBuilder::Face>>::emplace_back<int>((vector<manifold::MeshBuilder::Face,std::allocator<manifold::MeshBuilder::Face>>*)this, &local_44);
   }
...
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address *//* manifold::QuickHull::setupInitialTetrahedron() */void manifold::QuickHull::setupInitialTetrahedron(QuickHull *this) {
   long lVar1;
   char cVar2;
   long lVar3;
   double *pdVar4;
   ...
   if (4 < uVar26) {
      ...
      do {
         ...
         do {
            ...
            dVar27 = ( *pdVar5 - *pdVar13 ) * ( *pdVar5 - *pdVar13 ) + 0.0 + ( pdVar5[1] - pdVar13[1] ) * ( pdVar5[1] - pdVar13[1] ) + ( pdVar5[2] - pdVar13[2] ) * ( pdVar5[2] - pdVar13[2] );
            if (dVar33 < dVar27) {
 ...
 while ( lVar17 != 6 );
      ...
      do {
         ...
         dVar28 = ( dVar42 * dVar42 + dVar28 * dVar28 + dVar30 * dVar30 + 0.0 ) - dVar44 * dVar44 * ( _LC8 / ( dVar35 * dVar35 + 0.0 + dVar40 * dVar40 + dVar32 * dVar32 ) );
         if (dVar36 < dVar28) {
            uVar23 = uVar18;
            dVar36 = dVar28;
         }
 ...
 while ( uVar26 != uVar18 );
      if (dVar29 != dVar36) {
         ...
         dVar31 = *(double*)this;
         do {
            dVar44 = (double)( ( ulong )(pdVar5[2] * dVar43 + *pdVar5 * dVar42 + 0.0 + pdVar5[1] * dVar45 + dVar30) & _LC3 );
            if (dVar31 < dVar44) {
               uVar18 = uVar6;
               dVar31 = dVar44;
            }
 ...
 while ( uVar26 != uVar6 );
         ...
         MeshBuilder::setup((MeshBuilder*)( this + 0x48 ), (int)lVar17, (int)lVar14, (int)uVar23, (int)uVar18);
         ...
         if (pFVar24 != pFVar10) {
            ...
            do {
               ...
               dVar43 = SQRT(dVar31 * dVar31 + auVar38._0_8_ * auVar38._0_8_ + 0.0 + auVar38._8_8_ * auVar38._8_8_);
...
;
      ...
      if (0 < lVar19) {
         ...
         do {
            pdVar4 = pdVar13;
            if (( ( ( dVar33 != *pdVar4 ) || ( dVar27 != pdVar4[1] ) ) || ( dVar41 != pdVar4[2] ) ) && ( ( ( pdVar13 = pdVar4 ),dVar31 != *pdVar4 || ( dVar43 != pdVar4[1] ) ) || ( dVar45 != pdVar4[2] ) )) goto LAB_001038c0;
            pdVar13 = pdVar4 + 3;
            for (int i = 0; i < 3; i++) {
               if (( ( ( dVar33 != pdVar4[( 3*i + 3 )] ) || ( dVar27 != pdVar4[( 3*i + 4 )] ) ) || ( dVar41 != pdVar4[( 3*i + 5 )] ) ) && ( ( ( dVar31 != pdVar4[( 3*i + 3 )] || ( dVar43 != pdVar4[( 3*i + 4 )] ) ) || ( dVar45 != pdVar4[( 3*i + 5 )] ) ) )) goto LAB_001038c0;
               pdVar13 = pdVar4 + ( 3*i + 6 );
            }
 ...
 while ( pdVar13 != pdVar15 );
         ...
         if (lVar25 == 0x30) {
            LAB_00104801:if (( ( ( dVar33 == *pdVar15 ) && ( dVar27 == pdVar15[1] ) ) && ( dVar41 == pdVar15[2] ) ) || ( ( ( pdVar13 = pdVar15 ),dVar31 == *pdVar15 && ( dVar43 == pdVar15[1] ) ) && ( dVar45 == pdVar15[2] ) )) {
               pdVar15 = pdVar15 + 3;
               LAB_00104357:if (( ( ( dVar33 == *pdVar15 ) && ( dVar27 == pdVar15[1] ) ) && ( dVar41 == pdVar15[2] ) ) || ( ( ( pdVar13 = pdVar15 ),dVar31 == *pdVar15 && ( dVar43 == pdVar15[1] ) ) && ( dVar45 == pdVar15[2] ) )) goto LAB_001038e1;
            }

            LAB_001038c0:if (pdVar5 != pdVar13) {
            ...
            if (lVar25 == 0x48) {
               if (( ( ( dVar33 == *pdVar15 ) && ( dVar27 == pdVar15[1] ) ) && ( dVar41 == pdVar15[2] ) ) || ( ( ( dVar31 == *pdVar15 && ( dVar43 == pdVar4[0xd] ) ) && ( dVar45 == pdVar4[0xe] ) ) )) {
                  pdVar15 = pdVar4 + 0xf;
                  goto LAB_00104801;
               }
         ...
         LAB_001038e1:pdVar15 = pdVar22 + lVar17 * 3;
         pdVar13 = pdVar22;
         do {
            pdVar4 = pdVar13;
            dVar29 = *pdVar4;
            if (( ( ( dVar33 != dVar29 ) || ( dVar27 != pdVar4[1] ) ) || ( dVar41 != pdVar4[2] ) ) && ( ( ( dVar31 != dVar29 || ( dVar43 != pdVar4[1] ) ) || ( dVar45 != pdVar4[2] ) ) )) {
               pdVar13 = pdVar4;
            ...
            for (int i = 0; i < 3; i++) {
               dVar29 = pdVar4[( 3*i + 3 )];
               pdVar13 = pdVar4 + ( 3*i + 3 );
               if (( ( dVar33 != dVar29 ) || ( ( dVar27 != pdVar4[( 3*i + 4 )] || ( dVar41 != pdVar4[( 3*i + 5 )] ) ) ) ) && ( ( dVar31 != dVar29 || ( ( dVar43 != pdVar4[( 3*i + 4 )] || ( dVar45 != pdVar4[( 3*i + 5 )] ) ) ) ) )) {
                  if (dVar29 != *pdVar15) goto LAB_00103a40;
                  if (( pdVar4[( 3*i + 4 )] != pdVar15[1] ) || ( pdVar4[( 3*i + 5 )] != pdVar15[2] )) goto LAB_00103a40;
               }
 ...
 while ( pdVar22 + lVar19 * 0xc != pdVar13 );
         ...
         if (lVar19 == 0x30) {
            LAB_00104773:dVar29 = *pdVar13;
            if (( ( ( dVar33 == dVar29 ) && ( dVar27 == pdVar13[1] ) ) && ( dVar41 == pdVar13[2] ) ) || ( ( ( ( dVar31 == dVar29 && ( dVar43 == pdVar13[1] ) ) && ( dVar45 == pdVar13[2] ) ) || ( ( ( pdVar15 = pdVar22 + lVar17 * 3 ),dVar29 == *pdVar15 && ( pdVar13[1] == pdVar15[1] ) ) && ( pdVar13[2] == pdVar15[2] ) ) ) )) {
               pdVar13 = pdVar13 + 3;
               LAB_0010469e:dVar29 = *pdVar13;
               if (( ( ( ( dVar33 == dVar29 ) && ( dVar27 == pdVar13[1] ) ) && ( dVar41 == pdVar13[2] ) ) || ( ( ( dVar31 == dVar29 && ( dVar43 == pdVar13[1] ) ) && ( dVar45 == pdVar13[2] ) ) ) ) || ( ( ( pdVar15 = pdVar22 + lVar17 * 3 ),dVar29 == *pdVar15 && ( pdVar13[1] == pdVar15[1] ) ) && ( pdVar13[2] == pdVar15[2] ) )) goto LAB_00103a61;
            }
            ...
            dVar29 = *pdVar13;
            if (( ( ( ( dVar33 == dVar29 ) && ( dVar27 == pdVar4[0xd] ) ) && ( dVar41 == pdVar4[0xe] ) ) || ( ( ( dVar31 == dVar29 && ( dVar43 == pdVar4[0xd] ) ) && ( dVar45 == pdVar4[0xe] ) ) ) ) || ( ( ( pdVar15 = pdVar22 + lVar17 * 3 ),dVar29 == *pdVar15 && ( pdVar4[0xd] == pdVar15[1] ) ) && ( pdVar4[0xe] == pdVar15[2] ) )) {
               pdVar13 = pdVar4 + 0xf;
               goto LAB_00104773;
            }
         ...
         LAB_00103a40:if (pdVar5 != pdVar13) {
            lVar3 = ( (long)pdVar13 - (long)pdVar22 >> 3 ) * -0x5555555555555555;
         }

      }

      LAB_00103a61:iVar16 = (int)lVar3;
      iVar7 = (int)lVar17;
      if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) goto LAB_001049be;
      iVar8 = (int)lVar14;
      iVar11 = (int)lVar12;
   ...
   dVar29 = SQRT(auVar37._0_8_ * auVar37._0_8_ + 0.0 + auVar37._8_8_ * auVar37._8_8_ + dVar33 * dVar33);
   auVar34._8_8_ = dVar29;
   auVar34._0_8_ = dVar29;
   auVar39 = divpd(auVar37, auVar34);
   iVar11 = 0;
   iVar8 = iVar9;
   if (0.0 <= *pdVar5 * auVar39._0_8_ + 0.0 + pdVar5[1] * auVar39._8_8_ + pdVar5[2] * ( dVar33 / dVar29 ) + ( ( ( 0.0 - *pdVar22 * auVar39._0_8_ ) - auVar39._8_8_ * pdVar22[1] ) - ( dVar33 / dVar29 ) * pdVar22[2] )) {
      iVar8 = 0;
      iVar11 = iVar9;
   }

   if (lVar1 != *(long*)( in_FS_OFFSET + 0x28 )) {
      LAB_001049be:/* WARNING: Subroutine does not return */__stack_chk_fail();
   }

   LAB_00103ab0:MeshBuilder::setup((MeshBuilder*)( this + 0x48 ), iVar11, iVar8, iVar7, iVar16);
   return;
}
/* manifold::QuickHull::createConvexHalfedgeMesh() */void manifold::QuickHull::createConvexHalfedgeMesh(QuickHull *this) {
   int *piVar1;
   double *pdVar2;
   double *pdVar3;
   double *pdVar4;
   ...
   *(undefined8*)( this + 0x170 ) = 0;
   ...
   for (puVar33 = (undefined8*)( lVar46 + 8 ); puVar33 < (undefined8*)( lVar34 + 8U ); puVar33 = puVar33 + 1) {
   ...
   *(long*)( this + 0x1e8 ) = lVar46;
   do {
      ...
      if (( lVar40 != 0 ) && ( *(long*)( lVar40 + 8 ) != 0 )) {
         ...
         std::deque<int,std::allocator<int>>::emplace_back<int>((deque<int,std::allocator<int>>*)( this + 0x1a0 ), (int*)&local_58);
         ...
         *(undefined8*)( this + 0x148 ) = 0;
         if (*(void**)( this + 0x140 ) == (void*)0x0) {
            *(undefined8*)( this + 0x150 ) = 0;
            ...
            if (uVar32 == 0) {
               LAB_001062f5:if (puVar28 == (undefined8*)0x0) {
         ...
         do {
            ...
            if (*(ulong*)( this + 0x180 ) < uVar32) {
               ...
               *(ulong*)( this + 0x180 ) = uVar32;
               ...
               LAB_00104ef8:*(ulong*)( this + 0x178 ) = uVar32;
               if (uVar32 * 2 < uVar25) {
                  LAB_00104f08:sVar39 = uVar32 * 8;
                  ...
                  LAB_00104f3c:free(puVar33);
                  LAB_00104e5b:*(undefined8**)( this + 0x170 ) = puVar28;
               ...
               uVar49 = *(ulong*)( this + 0x178 );
               if (uVar49 < uVar32) {
                  LAB_00104eb0:puVar28 = puVar33 + uVar32;
 ...
 while ( puVar28 != puVar35 );
               ...
               *(ulong*)( this + 0x178 ) = uVar32;
               if (uVar32 * 2 < uVar25) {
                  ...
                  LAB_00104e52:if (puVar33 != (undefined8*)0x0) goto LAB_00104f3c;
                  goto LAB_00104e5b;
               }
            ...
            if (*(long*)( piVar30 + 0x10 ) == local_c8) {
               if (( *(byte*)( piVar30 + 0x12 ) & 1 ) == 0) {
                  LAB_00104d64:*(byte*)( piVar30 + 0x12 ) = *(byte*)( piVar30 + 0x12 ) & 0xfe;
                  ...
                  if (uVar25 < uVar32) {
                     ...
                     *(long*)( *(long*)( this + 0x158 ) + uVar25 * 8 ) = lVar46;
                     ...
                     if (uVar32 == 0) {
                        sVar39 = 0x400;
                        uVar49 = 0x80;
                        LAB_00105028:puVar33 = (undefined8*)malloc(sVar39);
                        puVar28 = *(undefined8**)( this + 0x158 );
                        if (uVar25 == 0) {
                           LAB_0010504a:if (puVar28 != (undefined8*)0x0) goto LAB_001060e1;
                        }
 else {
                           sVar39 = uVar25 * 8;
                           if ((long)sVar39 < 9) {
                  ...
                  *(byte*)( piVar30 + 0x12 ) = *(byte*)( piVar30 + 0x12 ) & 0xe3 | ( byte )(( ( uVar24 | *(byte*)( piVar30 + 0x12 ) >> 2 ) & 7 ) << 2);
               }
               ...
               *(long*)( piVar30 + 0x10 ) = local_c8;
               if (*(double*)( piVar30 + 2 ) * dVar54 + 0.0 + *(double*)( piVar30 + 4 ) * dVar53 + pdVar2[2] * *(double*)( piVar30 + 6 ) + *(double*)( piVar30 + 8 ) <= 0.0) goto LAB_00104d64;
               ...
               if (uVar25 < uVar32) {
                  ...
                  *(long*)( *(long*)( this + 0x140 ) + uVar25 * 8 ) = lVar40;
                  ...
                  if (uVar32 == 0) {
                     sVar39 = 0x400;
                     uVar49 = 0x80;
                     LAB_00106371:puVar33 = (undefined8*)malloc(sVar39);
                     puVar28 = *(undefined8**)( this + 0x140 );
                     if (uVar25 == 0) {
                        LAB_00106393:if (puVar28 != (undefined8*)0x0) goto LAB_00106717;
                     }
 else {
                        sVar39 = uVar25 * 8;
                        if ((long)sVar39 < 9) {
                     ...
                     if (uVar25 < uVar32) {
                        ...
                        *(undefined8*)( *(long*)( this + 0x170 ) + uVar25 * 8 ) = uVar27;
                        ...
                        if (uVar32 == 0) {
                           sVar39 = 0x400;
                           uVar49 = 0x80;
                           LAB_0010631c:puVar33 = (undefined8*)malloc(sVar39);
                           puVar28 = *(undefined8**)( this + 0x170 );
                           if (uVar25 == 0) {
                              LAB_0010634a:if (puVar28 != (undefined8*)0x0) goto LAB_0010666d;
                           }
 else {
                              sVar39 = uVar25 * 8;
                              if ((long)sVar39 < 9) {
 ...
 while ( &local_44 != piVar48 );
            ...
            uVar25 = *(ulong*)( this + 0x178 );
            joined_r0x00106153:}while (uVar25 != 0) ;;;
                           ...
                           if (uVar49 < uVar25) {
                              ...
                              if (uVar32 < uVar31) {
                                 ...
                                 *(long*)( *(long*)( this + 0x128 ) + uVar32 * 8 ) = lVar42;
                                 ...
                                 if (uVar31 == 0) {
                                    sVar39 = 0x400;
                                    uVar43 = 0x80;
                                    LAB_00105ead:puVar33 = (undefined8*)malloc(sVar39);
                                    puVar28 = *(undefined8**)( this + 0x128 );
                                    if (uVar32 == 0) {
                                       LAB_00105ef3:if (puVar28 == (undefined8*)0x0) {
                                 ...
                                 LAB_001058c8:*(ulong*)( this + 0x130 ) = uVar32 + 1;
                              ...
                              *(undefined4*)( *(long*)( this + 0x60 ) + lVar42 * 0xc + 8 ) = 0xffffffff;
                              ...
                              if (uVar31 == 0) {
                                 sVar39 = 0x400;
                                 uVar43 = 0x80;
                                 LAB_00105fa8:puVar33 = (undefined8*)malloc(sVar39);
                                 puVar28 = *(undefined8**)( this + 0xc0 );
                                 if (uVar32 == 0) {
                                    LAB_00105fee:if (puVar28 == (undefined8*)0x0) {
                              ...
                              LAB_00105897:*(ulong*)( this + 200 ) = uVar32 + 1;
                              puVar33[uVar32] = lVar42;
                           }

                        }

                        LAB_0010545e:lVar40 = lVar40 + 1;
                     }
 while ( lVar40 != 3 );
                     ...
                     if (uVar32 < uVar31) {
                        ...
                        *(long*)( *(long*)( this + 0xa8 ) + uVar32 * 8 ) = lVar37;
                        ...
                        if (uVar31 == 0) {
                           sVar39 = 0x400;
                           uVar43 = 0x80;
                           LAB_001058e7:puVar33 = (undefined8*)malloc(sVar39);
                           puVar28 = *(undefined8**)( this + 0xa8 );
                           if (uVar32 == 0) {
                              LAB_0010591d:if (puVar28 != (undefined8*)0x0) goto LAB_001061ef;
                           }
 else {
                              sVar39 = uVar32 * 8;
                              if ((long)sVar39 < 9) {
                     ...
                     *(undefined8*)( puVar47 + 0x14 ) = 0;
                     if (local_58 != (long*)0x0) {
                        ...
                        if (puVar33 == *(undefined8**)( this + 0x198 )) {
                           std::vector<std::unique_ptr<manifold::Vec<unsigned_long>,std::default_delete<manifold::Vec<unsigned_long>>>,std::allocator<std::unique_ptr<manifold::Vec<unsigned_long>,std::default_delete<manifold::Vec<unsigned_long>>>>>::_M_realloc_insert<std::unique_ptr<manifold::Vec<unsigned_long>,std::default_delete<manifold::Vec<unsigned_long>>>>((vector<std::unique_ptr<manifold::Vec<unsigned_long>,std::default_delete<manifold::Vec<unsigned_long>>>,std::allocator<std::unique_ptr<manifold::Vec<unsigned_long>,std::default_delete<manifold::Vec<unsigned_long>>>>>*)( this + 0x188 ), puVar33, &local_58);
                           plVar14 = local_58;
                           if (local_58 != (long*)0x0) {
                     ...
                     do {
                        while (true) {
                           ...
                           if (uVar43 == 0) {
                              sVar39 = 0x400;
                              uVar36 = 0x80;
                              LAB_00106467:puVar33 = (undefined8*)malloc(sVar39);
                              puVar28 = *(undefined8**)( this + 0x128 );
                              if (uVar31 == 0) {
                                 LAB_00106489:if (puVar28 == (undefined8*)0x0) {
                                    *(undefined8**)( this + 0x128 ) = puVar33;
...
;
               ...
               LAB_0010550e:if (lVar46 != 0) {
                  ...
                  do {
                     ...
                     if (uVar32 < uVar49) {
                        ...
                        *(long*)( *(long*)( this + 0x110 ) + uVar32 * 8 ) = lVar42;
                        ...
                        if (uVar49 == 0) {
                           sVar39 = 0x400;
                           uVar31 = 0x80;
                           LAB_00105943:puVar33 = (undefined8*)malloc(sVar39);
                           puVar28 = *(undefined8**)( this + 0x110 );
                           if (uVar32 == 0) {
                              LAB_00105983:if (puVar28 != (undefined8*)0x0) goto LAB_0010625a;
                           }
 else {
                              sVar39 = uVar32 * 8;
                              if ((long)sVar39 < 9) {
                     ...
                     *(undefined4*)( lVar12 + 4 ) = local_d8;
                     ...
                     dVar7 = *pdVar4;
                     *puVar47 = (int)lVar13;
                     auVar56._0_8_ = ( dVar55 - dVar53 ) * ( dVar19 - dVar15 ) - ( dVar17 - dVar15 ) * ( dVar58 - dVar53 );
                     auVar56._8_8_ = ( dVar6 - dVar54 ) * ( dVar20 - dVar16 ) - ( dVar18 - dVar16 ) * ( dVar7 - dVar54 );
                     dVar53 = ( dVar17 - dVar15 ) * ( dVar7 - dVar54 ) - ( dVar6 - dVar54 ) * ( dVar19 - dVar15 );
                     dVar55 = SQRT(auVar56._0_8_ * auVar56._0_8_ + 0.0 + auVar56._8_8_ * auVar56._8_8_ + dVar53 * dVar53);
                     ...
                     do {
                        ...
                        if (( lVar34 != lVar37 ) && ( lVar46 != 0 )) {
                           do {
                              ...
                              do {
                                 lVar42 = *(long*)( this + 0x48 ) + *(long*)( *(long*)( this + 0x110 ) + lVar40 * 8 ) * 0x58;
                                 dVar54 = *(double*)( lVar42 + 8 ) * *pdVar2 + 0.0 + *(double*)( lVar42 + 0x10 ) * pdVar2[1] + *(double*)( lVar42 + 0x18 ) * pdVar2[2] + *(double*)( lVar42 + 0x20 );
                                 if (( 0.0 < dVar54 ) && ( *(double*)( this + 8 ) * *(double*)( lVar42 + 0x28 ) < dVar54 * dVar54 )) {
                                    ...
                                    if (uVar25 < uVar32) {
                                       ...
                                       *(long*)( *plVar26 + uVar25 * 8 ) = lVar37;
                                       ...
                                       if (uVar32 == 0) {
                                          sVar39 = 0x400;
                                          uVar49 = 0x80;
                                          LAB_00105d5b:puVar33 = (undefined8*)malloc(sVar39);
                                          puVar28 = (undefined8*)*plVar26;
                                          if (uVar25 == 0) {
                                             LAB_00105d9e:if (puVar28 != (undefined8*)0x0) goto LAB_00105da3;
                                          }
 else {
                                             sVar39 = uVar25 * 8;
                                             if (8 < (long)sVar39) {
                                    ...
                                    if (*(double*)( lVar42 + 0x30 ) <= dVar54 && dVar54 != *(double*)( lVar42 + 0x30 )) {
 ...
 while ( lVar34 != lVar37 );
                        ...
                        LAB_00105b32:plVar50 = plVar50 + 1;
                     }
 while ( plVar14 != plVar50 );
                     LAB_00105b3f:plVar26 = (long*)*plVar51;
                     lVar37 = plVar26[1];
                  }
...
;
 ...
 while ( uVar25 < uVar32 );
               LAB_001050e7:if (iVar44 == 1) {
                  ...
                  if ((ulong)plVar38[2] < uVar25) {
                     ...
                     *plVar38 = (long)__dest;
                     ...
                     if (uVar49 < uVar32) {
                        LAB_00106605:sVar39 = uVar25 * 8;
                        puVar28 = (undefined8*)malloc(sVar39);
                        puVar33 = (undefined8*)*plVar38;
                        if ((long)sVar39 < 9) {
                           if (sVar39 != 8) goto LAB_001064fc;
                           *puVar28 = *puVar33;
                           LAB_00106501:free(puVar33);
                        }
 else {
                           memmove(puVar28, puVar33, sVar39);
                           puVar33 = (undefined8*)*plVar38;
                           LAB_001064fc:if (puVar33 != (undefined8*)0x0) goto LAB_00106501;
                        }
                     ...
                     if (uVar32 < uVar25) {
                        ...
                        LAB_00106784:memset(pvVar41, 0, (long)pvVar29 - (long)pvVar41);
                        plVar38[1] = uVar25;
            ...
            if (0x80 < (ulong)plVar38[2]) {
               ...
               LAB_00104ba0:piVar30 = *(int**)( this + 0x1b0 );
...
/* manifold::QuickHull::buildMesh(double) */undefined8 *manifold::QuickHull::buildMesh(double param_1) {
   undefined8 *puVar1;
   undefined8 *puVar2;
   size_t __n;
   int iVar3;
   ...
   *(undefined8*)( in_RSI + 0x100 ) = uStack_50;
   ...
   do {
      uVar5 = uVar20 + 1;
      dVar22 = (double)( *(ulong*)( *(long*)( in_RSI + 0x38 ) + ( uVar20 >> 1 ) * 8 + *(long*)( in_RSI + uVar20 * 8 + 0xd8 ) * 0x18 ) & uVar21 );
      if (dVar22 <= dVar23) {
         dVar22 = dVar23;
      }
 ...
 while ( uVar21 != uVar20 );
      ...
      if (uVar21 < local_d0) {
         ...
         if ((long)sVar19 < 0xd) {
            ...
            LAB_00107073:free(__src_00);
         }

         __src_00 = piVar12;
         for (piVar12 = __src_00 + uVar21 * 3; __src_00 + local_d0 * 3 != piVar12; piVar12 = piVar12 + 3) {
            for (int i = 0; i < 3; i++) {
               piVar12[i] = 0;
            }
         ...
         LAB_001072c4:__src_00 = (int*)malloc((size_t)local_b8);
         if ((long)local_b8 < 0xd) {
            ...
            LAB_00107308:free(piVar12);
         }

         uVar20 = local_d0;
         if (uVar21 < local_d0) {
            __s = (undefined4*)malloc(local_d0 * 4);
            LAB_0010735e:local_c8 = __s;
            sVar19 = uVar21 * 4;
            if ((long)sVar19 < 5) {
               if (sVar19 == 4) {
                  *local_c8 = *__src;
               ...
               LAB_00107393:free(__src);
            }

            LAB_001073af:puVar15 = local_c8 + local_d0;
            __s = (undefined4*)( (long)local_c8 + sVar19 );
            __src = local_c8;
            if (puVar15 != __s) goto LAB_001073c5;
         }

         joined_r0x001073e1:local_c8 = __src;
         if (uVar5 < uVar21) {
            local_98 = local_d0 * 4;
         ...
         if (uVar21 <= uVar5) {
            LAB_001070c7:if (local_d0 <= uVar21) goto LAB_00106ae0;
            __s = (undefined4*)malloc(local_d0 * 4);
            ...
            local_c8 = __s;
            LAB_001073c5:memset(__s, 0, (long)puVar15 - (long)__s);
            __src = local_c8;
         ...
         LAB_00106fad:if (__src != (undefined4*)0x0) {
            LAB_00106fb6:free(__src);
         }
      ...
      *(undefined8*)( in_RSI + 0x30 ) = uVar9;
      ...
      LAB_00106a75:lVar17 = ( *(long*)( in_RSI + 0x50 ) - *(long*)( in_RSI + 0x48 ) >> 3 ) * 0x2e8ba2e8ba2e8ba3;
      if (lVar17 == 0) {
         local_a8 = (void*)0x0;
         __ptr = (void*)0x0;
         piVar10 = (int*)0x0;
         ...
         __src_00 = (int*)0x0;
         piVar10 = (int*)0x0;
         LAB_00106fe1:local_a8 = malloc(lVar17 << 2);
   ...
   LAB_00106ae0:piVar18 = (int*)( (long)local_b8 + (long)__src_00 );
   ...
   if (uVar21 < uVar5) {
      ...
      if (uVar21 == 0) {
         ...
         if ((long)__n < 5) {
            ...
            LAB_0010747a:free(piVar10);
         }

         piVar10 = piVar12 + uVar21;
         if (piVar12 + uVar5 != piVar10) {
            LAB_001071ac:memset(piVar10, 0, (long)piVar12 + ( sVar19 - (long)piVar10 ));
         }
      ...
      if (uVar5 == 0) {
         piVar12 = (int*)0x0;
         LAB_00106b39:if (local_b8 == (int*)0x0) goto LAB_00106b45;
      }
 else {
         LAB_00107221:piVar12 = (int*)malloc(sVar19);
         if ((long)sVar19 < 5) {
   ...
   LAB_00106b45:piVar10 = piVar12 + uVar5;
   if (piVar10 == piVar12) {
 ...
 while ( piVar10 != piVar6 );
   ...
   LAB_00106be4:lVar17 = (long)piVar12[lVar17];
   pvVar11 = (void*)0x0;
   if (lVar17 != 0) {
 ...
 while ( piVar7 != piVar12 + lVar8 + 1 );
   ...
   *in_RDI = __src_00;
   ...
   LAB_0010697d:if (lVar4 == *(long*)( in_FS_OFFSET + 0x28 )) {
      return in_RDI;
   }
...
/* manifold::Manifold::Impl::Hull(manifold::VecView<linalg::vec<double, 3> >) */void manifold::Manifold::Impl::Hull(Impl *this, undefined8 *param_2) {
   void *pvVar1;
   long in_FS_OFFSET;
...
/* manifold::HalfEdgeMesh::HalfEdgeMesh(manifold::MeshBuilder const&,
   manifold::VecView<linalg::vec<double, 3> > const&) */void manifold::HalfEdgeMesh::HalfEdgeMesh(HalfEdgeMesh *this, MeshBuilder *param_1, VecView *param_2) {
   undefined8 *puVar1;
   long lVar2;
   int iVar3;
   int iVar4;
      ...
      do {
         ...
         if (*piVar27 != -1) {
            ...
            if (puVar15 == *(ulong**)( this + 0x28 )) {
               std::vector<unsigned_long,std::allocator<unsigned_long>>::_M_realloc_insert<unsigned_long>((vector<unsigned_long,std::allocator<unsigned_long>>*)( this + 0x18 ), puVar15, &local_110);
               puVar15 = *(ulong**)( this + 0x20 );
            }
 else {
               *puVar15 = uVar13;
            ...
            plVar14 = (long*)std::__detail::_Map_base<unsigned_long,std::pair<unsigned_long_const,unsigned_long>,std::allocator<std::pair<unsigned_long_const,unsigned_long>>,std::__detail::_Select1st,std::equal_to<unsigned_long>,std::hash<unsigned_long>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>,true>::operator []((_Map_base<unsigned_long,std::pair<unsigned_long_const,unsigned_long>,std::allocator<std::pair<unsigned_long_const,unsigned_long>>,std::__detail::_Select1st,std::equal_to<unsigned_long>,std::hash<unsigned_long>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>,true>*)&local_108, &local_118);
            ...
            LAB_00107b24:do {
               ...
               if (local_70 == 0) {
                  ...
                  if (plVar14 != (long*)0x0) {
                     ...
                     while (uVar13 != uVar19) {
                        plVar7 = (long*)*plVar12;
                        if (( plVar7 == (long*)0x0 ) || ( uVar19 = plVar7[1] ),plVar14 = plVar12,plVar12 = plVar7,uVar13 % local_80 != uVar19 % local_80) goto LAB_00107be8;
                     }
;
               ...
               LAB_00107be8:puVar18 = (undefined8*)( *(long*)param_2 + uVar13 * 0x18 );
               uVar19 = *(ulong*)( this + 8 );
               ...
               if (uVar19 < uVar26) {
                  ...
                  *puVar1 = uVar29;
                  ...
                  if (uVar26 == 0) {
                     sVar23 = 0xc00;
                     uVar25 = 0x80;
                     LAB_001080a1:puVar18 = (undefined8*)malloc(sVar23);
                     puVar1 = *(undefined8**)this;
                     if (uVar19 == 0) {
                        LAB_001080f5:if (puVar1 != (undefined8*)0x0) goto LAB_00108340;
                     }
 else {
                        sVar23 = uVar19 * 0x18;
                        if ((long)sVar23 < 0x19) {
               ...
               piVar28 = piVar28 + 1;
               local_110 = uVar13;
               puVar15 = (ulong*)std::__detail::_Map_base<unsigned_long,std::pair<unsigned_long_const,unsigned_long>,std::allocator<std::pair<unsigned_long_const,unsigned_long>>,std::__detail::_Select1st,std::equal_to<unsigned_long>,std::hash<unsigned_long>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>,true>::operator []((_Map_base<unsigned_long,std::pair<unsigned_long_const,unsigned_long>,std::allocator<std::pair<unsigned_long_const,unsigned_long>>,std::__detail::_Select1st,std::equal_to<unsigned_long>,std::hash<unsigned_long>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>,true>*)&local_88, &local_110);
               *puVar15 = uVar19;
            }
 while ( &local_44 != piVar28 );
         }

         LAB_00107a80:piVar27 = piVar27 + 0x16;
         uVar13 = uVar16 + 1;
         local_118 = uVar16;
      }
 while ( piVar5 != piVar27 );
   ...
   local_180 = (_Map_base<unsigned_long,std::pair<unsigned_long_const,unsigned_long>,std::allocator<std::pair<unsigned_long_const,unsigned_long>>,std::__detail::_Select1st,std::equal_to<unsigned_long>,std::hash<unsigned_long>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>,true>*)&local_88;
   ...
   do {
      ...
      if (lVar6 == lVar20) {
         ...
         for (puVar21 = *(ulong**)( this + 0x18 ); puVar15 != puVar21; puVar21 = puVar21 + 1) {
            puVar17 = (ulong*)std::__detail::_Map_base<unsigned_long,std::pair<unsigned_long_const,unsigned_long>,std::allocator<std::pair<unsigned_long_const,unsigned_long>>,std::__detail::_Select1st,std::equal_to<unsigned_long>,std::hash<unsigned_long>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>,true>::operator []((_Map_base<unsigned_long,std::pair<unsigned_long_const,unsigned_long>,std::allocator<std::pair<unsigned_long_const,unsigned_long>>,std::__detail::_Select1st,std::equal_to<unsigned_long>,std::hash<unsigned_long>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>,true>*)&local_c8, puVar21);
            *puVar21 = *puVar17;
         }
         ...
         if (*(long*)( this + 0x38 ) != 0) {
            do {
               ...
               puVar18 = (undefined8*)std::__detail::_Map_base<unsigned_long,std::pair<unsigned_long_const,unsigned_long>,std::allocator<std::pair<unsigned_long_const,unsigned_long>>,std::__detail::_Select1st,std::equal_to<unsigned_long>,std::hash<unsigned_long>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>,true>::operator []((_Map_base<unsigned_long,std::pair<unsigned_long_const,unsigned_long>,std::allocator<std::pair<unsigned_long_const,unsigned_long>>,std::__detail::_Select1st,std::equal_to<unsigned_long>,std::hash<unsigned_long>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>,true>*)&local_108, &local_110);
               *(int*)( *(long*)( this + 0x48 ) + uVar13 * 4 ) = (int)*puVar18;
               local_110 = ( ulong ) * (int*)( lVar6 + 8 );
               puVar18 = (undefined8*)std::__detail::_Map_base<unsigned_long,std::pair<unsigned_long_const,unsigned_long>,std::allocator<std::pair<unsigned_long_const,unsigned_long>>,std::__detail::_Select1st,std::equal_to<unsigned_long>,std::hash<unsigned_long>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>,true>::operator []((_Map_base<unsigned_long,std::pair<unsigned_long_const,unsigned_long>,std::allocator<std::pair<unsigned_long_const,unsigned_long>>,std::__detail::_Select1st,std::equal_to<unsigned_long>,std::hash<unsigned_long>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>,true>*)&local_c8, &local_110);
               ...
               *(int*)( *(long*)( this + 0x60 ) + uVar13 * 4 ) = (int)*puVar18;
               ...
               uVar13 = uVar13 + 1;
               puVar18 = (undefined8*)std::__detail::_Map_base<unsigned_long,std::pair<unsigned_long_const,unsigned_long>,std::allocator<std::pair<unsigned_long_const,unsigned_long>>,std::__detail::_Select1st,std::equal_to<unsigned_long>,std::hash<unsigned_long>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>,true>::operator [](local_180, &local_110);
               *(int*)( lVar6 + 4 ) = (int)*puVar18;
            }
 while ( uVar13 < *(ulong*)( this + 0x38 ) );
         }

         std::_Hashtable<unsigned_long,std::pair<unsigned_long_const,unsigned_long>,std::allocator<std::pair<unsigned_long_const,unsigned_long>>,std::__detail::_Select1st,std::equal_to<unsigned_long>,std::hash<unsigned_long>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>>::~_Hashtable((_Hashtable<unsigned_long,std::pair<unsigned_long_const,unsigned_long>,std::allocator<std::pair<unsigned_long_const,unsigned_long>>,std::__detail::_Select1st,std::equal_to<unsigned_long>,std::hash<unsigned_long>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>>*)local_180);
         std::_Hashtable<unsigned_long,std::pair<unsigned_long_const,unsigned_long>,std::allocator<std::pair<unsigned_long_const,unsigned_long>>,std::__detail::_Select1st,std::equal_to<unsigned_long>,std::hash<unsigned_long>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>>::~_Hashtable((_Hashtable<unsigned_long,std::pair<unsigned_long_const,unsigned_long>,std::allocator<std::pair<unsigned_long_const,unsigned_long>>,std::__detail::_Select1st,std::equal_to<unsigned_long>,std::hash<unsigned_long>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>>*)&local_c8);
      ...
      if (*(int*)( lVar20 + 8 ) != -1) {
         ...
         if (uVar16 < uVar19) {
            ...
            *puVar18 = uVar29;
            ...
            LAB_00107de0:if (uVar16 == 0) {
               sVar23 = 0x200;
               uVar26 = 0x80;
               LAB_0010803b:puVar22 = (undefined4*)malloc(sVar23);
               puVar8 = *(undefined4**)( this + 0x48 );
               if (uVar19 == 0) {
                  LAB_0010806e:if (puVar8 != (undefined4*)0x0) goto LAB_00108179;
               }
 else {
                  sVar23 = uVar19 * 4;
                  if ((long)sVar23 < 5) {
            ...
            *(ulong*)( this + 0x50 ) = uVar19 + 1;
            ...
            if (uVar19 == 0) {
               sVar23 = 0x600;
               uVar26 = 0x80;
               LAB_00107fcb:puVar18 = (undefined8*)malloc(sVar23);
               puVar1 = *(undefined8**)( this + 0x30 );
               if (uVar16 == 0) {
                  LAB_00108014:if (puVar1 != (undefined8*)0x0) goto LAB_00108255;
               }
 else {
                  sVar23 = uVar16 * 0xc;
                  if ((long)sVar23 < 0xd) {
            ...
            *puVar18 = uVar29;
            ...
            LAB_00107cf8:*(ulong*)( this + 0x50 ) = uVar19 + 1;
         ...
         if (uVar16 < uVar19) {
            ...
            *(undefined4*)( *(long*)( this + 0x60 ) + uVar16 * 4 ) = uVar24;
            ...
            if (uVar19 == 0) {
               sVar23 = 0x200;
               uVar26 = 0x80;
               LAB_00107f7b:puVar22 = (undefined4*)malloc(sVar23);
               puVar8 = *(undefined4**)( this + 0x60 );
               if (uVar16 == 0) {
                  LAB_00107fa2:if (puVar8 != (undefined4*)0x0) goto LAB_001081e1;
               }
 else {
                  sVar23 = uVar16 * 4;
                  if ((long)sVar23 < 5) {
         ...
         plVar14 = (long*)std::__detail::_Map_base<unsigned_long,std::pair<unsigned_long_const,unsigned_long>,std::allocator<std::pair<unsigned_long_const,unsigned_long>>,std::__detail::_Select1st,std::equal_to<unsigned_long>,std::hash<unsigned_long>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>,true>::operator []((_Map_base<unsigned_long,std::pair<unsigned_long_const,unsigned_long>,std::allocator<std::pair<unsigned_long_const,unsigned_long>>,std::__detail::_Select1st,std::equal_to<unsigned_long>,std::hash<unsigned_long>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>,true>*)&local_c8, &local_118);
         *plVar14 = lVar2 + -1;
      }
 ...
 while ( true );
   LAB_00107b6a:piVar28 = piVar28 + 1;
   if (&local_44 == piVar28) goto LAB_00107a80;
   goto LAB_00107b24;
}
/* manifold::QuickHull::addPointToFace(manifold::MeshBuilder::Face&, unsigned long) */undefined8 manifold::QuickHull::addPointToFace(QuickHull *this, Face *param_1, ulong param_2) {
   double *pdVar1;
   ulong uVar2;
   undefined8 *puVar3;
   long lVar4;
   ...
   dVar9 = *pdVar1 * *(double*)( param_1 + 8 ) + 0.0 + pdVar1[1] * *(double*)( param_1 + 0x10 ) + pdVar1[2] * *(double*)( param_1 + 0x18 ) + *(double*)( param_1 + 0x20 );
   ...
   if (uVar2 == 0) {
      sVar6 = 0x400;
      uVar8 = 0x80;
      LAB_00108524:puVar3 = (undefined8*)malloc(sVar6);
      __src = (undefined8*)*plVar5;
      if (uVar7 == 0) {
         LAB_00108545:if (__src != (undefined8*)0x0) goto LAB_0010854a;
      }
 else {
         sVar6 = uVar7 * 8;
         if (8 < (long)sVar6) {
   ...
   LAB_001084e8:if (*(double*)( param_1 + 0x30 ) <= dVar9 && dVar9 != *(double*)( param_1 + 0x30 )) {
...
/* manifold::QuickHull::~QuickHull() */void manifold::QuickHull::~QuickHull(QuickHull *this) {
   undefined8 *puVar1;
   long lVar2;
   undefined8 *puVar3;
   undefined8 *puVar4;
...
/* std::_Hashtable<unsigned long, std::pair<unsigned long const, unsigned long>,
   ...
   std::__detail::_Hashtable_traits<false, false, true> >::~_Hashtable() */void std::_Hashtable<unsigned_long,std::pair<unsigned_long_const,unsigned_long>,std::allocator<std::pair<unsigned_long_const,unsigned_long>>,std::__detail::_Select1st,std::equal_to<unsigned_long>,std::hash<unsigned_long>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>>::~_Hashtable(_Hashtable<unsigned_long,std::pair<unsigned_long_const,unsigned_long>,std::allocator<std::pair<unsigned_long_const,unsigned_long>>,std::__detail::_Select1st,std::equal_to<unsigned_long>,std::hash<unsigned_long>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>> *this) {
   undefined8 *puVar1;
   undefined8 *puVar2;
...
/* void std::vector<manifold::MeshBuilder::Face, std::allocator<manifold::MeshBuilder::Face>
   ...
   std::vector<manifold::MeshBuilder::Face, std::allocator<manifold::MeshBuilder::Face> > >) */void std::vector<manifold::MeshBuilder::Face,std::allocator<manifold::MeshBuilder::Face>>::_M_realloc_insert<>(vector<manifold::MeshBuilder::Face,std::allocator<manifold::MeshBuilder::Face>> *this, undefined4 *param_2) {
   undefined8 uVar1;
   byte bVar2;
   undefined4 *puVar3;
   undefined4 *puVar4;
   ...
   if (puVar4 == puVar3) {
      ...
      if (uVar16 < uVar13) {
         LAB_00108c10:uVar16 = 0x7ffffffffffffff8;
      }
 else {
         if (uVar16 == 0) {
   ...
   LAB_00108a5b:puVar14 = (undefined4*)( (long)puVar15 + ( (long)param_2 - (long)puVar4 ) );
   for (int i = 0; i < 3; i++) {
      *(undefined1(*) [16])( puVar14 + ( 4*i + 2 ) ) = (undefined1[16])0;
   }
 ...
 while ( param_2 != puVar19 );
      puVar19 = puVar15 + ( ( ( ulong )((long)param_2 + ( -0x58 - (long)puVar4 )) >> 3 ) * 0xe8ba2e8ba2e8ba3 & 0x1fffffffffffffff ) * 0x16 + 0x2c;
   }
 ...
 while ( puVar3 != puVar18 );
      puVar19 = puVar19 + ( ( ( ( ulong )((long)puVar3 + ( -0x58 - (long)param_2 )) >> 3 ) * 0xe8ba2e8ba2e8ba3 & 0x1fffffffffffffff ) + 1 ) * 0x16;
   }
...
/* void std::vector<manifold::MeshBuilder::Face, std::allocator<manifold::MeshBuilder::Face>
    ...
    */void std::vector<manifold::MeshBuilder::Face,std::allocator<manifold::MeshBuilder::Face>>::_M_realloc_insert<int>(vector<manifold::MeshBuilder::Face,std::allocator<manifold::MeshBuilder::Face>> *this, undefined4 *param_2, undefined4 *param_3) {
   undefined8 uVar1;
   byte bVar2;
   undefined4 uVar3;
   undefined4 *puVar4;
   ...
   if (puVar5 == puVar4) {
      ...
      if (uVar19 < uVar14) {
         LAB_00108ec0:uVar19 = 0x7ffffffffffffff8;
      }
 else {
         if (uVar19 == 0) {
   ...
   LAB_00108d0b:puVar15 = (undefined4*)( (long)puVar16 + ( (long)param_2 - (long)puVar5 ) );
   uVar3 = *param_3;
   for (int i = 0; i < 3; i++) {
      *(undefined1(*) [16])( puVar15 + ( 4*i + 2 ) ) = (undefined1[16])0;
   }
 ...
 while ( param_2 != puVar20 );
      puVar20 = puVar16 + ( ( ( ulong )((long)param_2 + ( -0x58 - (long)puVar5 )) >> 3 ) * 0xe8ba2e8ba2e8ba3 & 0x1fffffffffffffff ) * 0x16 + 0x2c;
   }
 ...
 while ( puVar4 != puVar18 );
      puVar20 = puVar20 + ( ( ( ( ulong )((long)puVar4 + ( -0x58 - (long)param_2 )) >> 3 ) * 0xe8ba2e8ba2e8ba3 & 0x1fffffffffffffff ) + 1 ) * 0x16;
   }
...
/* void std::vector<unsigned long, std::allocator<unsigned long> >::_M_realloc_insert<unsigned
   ...
   if (__src == pvVar1) {
      ...
      uVar3 = uVar3 << 3;
      LAB_0010901a:__dest_00 = operator_new(uVar3);
      lVar4 = uVar3 + (long)__dest_00;
   }
 else {
      uVar3 = uVar2 * 2;
      if (uVar3 < uVar2) {
         LAB_00109010:uVar3 = 0x7ffffffffffffff8;
         goto LAB_0010901a;
      }
   ...
   *(undefined8*)( (long)__dest_00 + __n ) = *param_3;
   ...
   LAB_00108fec:*(void**)this = __dest_00;
...
/* void std::vector<std::unique_ptr<manifold::Vec<unsigned long>,
   ...
   >&&) */void std::vector<std::unique_ptr<manifold::Vec<unsigned_long>,std::default_delete<manifold::Vec<unsigned_long>>>,std::allocator<std::unique_ptr<manifold::Vec<unsigned_long>,std::default_delete<manifold::Vec<unsigned_long>>>>>::_M_realloc_insert<std::unique_ptr<manifold::Vec<unsigned_long>,std::default_delete<manifold::Vec<unsigned_long>>>>(vector<std::unique_ptr<manifold::Vec<unsigned_long>,std::default_delete<manifold::Vec<unsigned_long>>>,std::allocator<std::unique_ptr<manifold::Vec<unsigned_long>,std::default_delete<manifold::Vec < unsigned_long>>>> > *this, undefined8 *param_2, undefined8 *param_3) {
   undefined8 *puVar1;
   undefined8 *puVar2;
   undefined8 uVar3;
   ulong uVar4;
   ...
   if (puVar2 == puVar1) {
      ...
      uVar8 = uVar8 << 3;
      LAB_001091ea:puVar5 = (undefined8*)operator_new(uVar8);
 ...
 while ( puVar6 != param_2 );
      ...
      uVar8 = uVar4 * 2;
      if (uVar8 < uVar4) {
         LAB_001091e0:uVar8 = 0x7ffffffffffffff8;
         goto LAB_001091ea;
      }
   ...
   LAB_001091a2:if (puVar2 != (undefined8*)0x0) {
...
/* WARNING: Control flow encountered bad instruction data *//* std::_Hashtable<unsigned long, std::pair<unsigned long const, unsigned long>,
   std::allocator<std::pair<unsigned long const, unsigned long> >, std::__detail::_Select1st,
   std::equal_to<unsigned long>, std::hash<unsigned long>, std::__detail::_Mod_range_hashing,
   std::__detail::_Default_ranged_hash, std::__detail::_Prime_rehash_policy,
   ...
   unsigned long) */ulong std::_Hashtable<unsigned_long,std::pair<unsigned_long_const,unsigned_long>,std::allocator<std::pair<unsigned_long_const,unsigned_long>>,std::__detail::_Select1st,std::equal_to<unsigned_long>,std::hash<unsigned_long>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>>::_M_insert_unique_node(ulong param_1, ulong param_2, _Hash_node *param_3, ulong param_4) {
   long *plVar1;
   undefined8 *puVar2;
   char cVar3;
   void *__s;
   ...
   long *plVar6;
   ulong uVar7;
   cVar3 = std::__detail::_Prime_rehash_policy::_M_need_rehash(param_1 + 0x20, *(ulong*)( param_1 + 8 ), *(ulong*)( param_1 + 0x18 ));
   if (cVar3 == '\0') {
      __s = *(void**)param_1;
...
;
      LAB_00109382:if (*(void**)param_1 != (void*)( param_1 + 0x30 )) {
   ...
   if (puVar2 == (undefined8*)0x0) {
      ...
      *(ulong*)( param_1 + 0x10 ) = param_4;
      if (*(long*)param_4 != 0) {
         *(ulong*)( (long)__s + ( *(ulong*)( *(long*)param_4 + 8 ) % *(ulong*)( param_1 + 8 ) ) * 8 ) = param_4;
      }
...
/* std::__detail::_Map_base<unsigned long, std::pair<unsigned long const, unsigned long>,
   ...
   std::equal_to<unsigned long>, std::hash<unsigned long>, std::__detail::_Mod_range_hashing,
   std::__detail::_Default_ranged_hash, std::__detail::_Prime_rehash_policy,
   std::__detail::_Hashtable_traits<false, false, true>, true>::operator[](unsigned long const&) */long std::__detail::_Map_base<unsigned_long,std::pair<unsigned_long_const,unsigned_long>,std::allocator<std::pair<unsigned_long_const,unsigned_long>>,std::__detail::_Select1st,std::equal_to<unsigned_long>,std::hash<unsigned_long>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>,true>::operator [](_Map_base<unsigned_long,std::pair<unsigned_long_const,unsigned_long>,std::allocator<std::pair<unsigned_long_const,unsigned_long>>,std::__detail::_Select1st,std::equal_to<unsigned_long>,std::hash<unsigned_long>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>,true> *this, ulong *param_1) {
   _Hash_node *p_Var1;
   long *plVar2;
   _Hash_node *p_Var3;
   long *plVar4;
   ...
   if (plVar2 != (long*)0x0) {
      ...
      while (p_Var1 != p_Var3) {
         plVar4 = (long*)*plVar6;
         if (( plVar4 == (long*)0x0 ) || ( p_Var3 = (_Hash_node*)plVar4[1] ),plVar2 = plVar6,plVar6 = plVar4,uVar9 != (ulong)p_Var3 % *(ulong*)( this + 8 )) goto LAB_001094c0;
      }
;
      if (*plVar2 != 0) {
         return *plVar2 + 0x10;
   ...
   LAB_001094c0:puVar7 = (undefined8*)operator_new(0x18);
   *puVar7 = 0;
   uVar5 = *param_1;
   puVar7[2] = 0;
   puVar7[1] = uVar5;
   lVar8 = _Hashtable<unsigned_long,std::pair<unsigned_long_const,unsigned_long>,std::allocator<std::pair<unsigned_long_const,unsigned_long>>,std::__detail::_Select1st,std::equal_to<unsigned_long>,std::hash<unsigned_long>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>>::_M_insert_unique_node((ulong)this, uVar9, p_Var1, (ulong)puVar7);
   return lVar8 + 0x10;
}
/* std::__detail::_Map_base<unsigned long, std::pair<unsigned long const, unsigned long>,
   std::allocator<std::pair<unsigned long const, unsigned long> >, std::__detail::_Select1st,
   std::equal_to<unsigned long>, std::hash<unsigned long>, std::__detail::_Mod_range_hashing,
   std::__detail::_Default_ranged_hash, std::__detail::_Prime_rehash_policy,
   std::__detail::_Hashtable_traits<false, false, true>, true>::operator[](unsigned long&&) */long std::__detail::_Map_base<unsigned_long,std::pair<unsigned_long_const,unsigned_long>,std::allocator<std::pair<unsigned_long_const,unsigned_long>>,std::__detail::_Select1st,std::equal_to<unsigned_long>,std::hash<unsigned_long>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>,true>::operator [](_Map_base<unsigned_long,std::pair<unsigned_long_const,unsigned_long>,std::allocator<std::pair<unsigned_long_const,unsigned_long>>,std::__detail::_Select1st,std::equal_to<unsigned_long>,std::hash<unsigned_long>,std::__detail::_Mod_range_hashing,std::__detail::_Default_ranged_hash,std::__detail::_Prime_rehash_policy,std::__detail::_Hashtable_traits<false,false,true>,true> *this, ulong *param_1) {
   _Hash_node *p_Var1;
   long *plVar2;
   _Hash_node *p_Var3;
   long *plVar4;
   ...
   if (plVar2 != (long*)0x0) {
      ...
      while (p_Var1 != p_Var3) {
         plVar4 = (long*)*plVar6;
         if (( plVar4 == (long*)0x0 ) || ( p_Var3 = (_Hash_node*)plVar4[1] ),plVar2 = plVar6,plVar6 = plVar4,uVar9 != (ulong)p_Var3 % *(ulong*)( this + 8 )) goto LAB_00109590;
      }
;
      if (*plVar2 != 0) {
         return *plVar2 + 0x10;
   ...
   LAB_00109590:puVar7 = (undefined8*)operator_new(0x18);
   *puVar7 = 0;
   uVar5 = *param_1;
   puVar7[2] = 0;
   puVar7[1] = uVar5;
...
/* WARNING: Control flow encountered bad instruction data *//* manifold::QuickHull::~QuickHull() */void manifold::QuickHull::~QuickHull(QuickHull *this) {
   /* WARNING: Bad instruction - Truncating control flow here */
   halt_baddata();
}
